; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/refbuf.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/refbuf.c"
...
entry:
  %0 = load i32, ptr @width_pad_cr, align 4
  %1 = load i32, ptr @chroma_shift_x, align 4
  %shr = ashr i32 %x, %1
  %cond.i.i = tail call i32 @llvm.smax.i32(i32 %shr, i32 0)
  %cond.i4.i = tail call i32 @llvm.smin.i32(i32 %cond.i.i, i32 %0)
  %2 = load i32, ptr @height_pad_cr, align 4
  %3 = load i32, ptr @chroma_shift_y, align 4
  %shr1 = ashr i32 %y, %3
  %cond.i.i13 = tail call i32 @llvm.smax.i32(i32 %shr1, i32 0)
  %cond.i4.i14 = tail call i32 @llvm.smin.i32(i32 %cond.i.i13, i32 %2)
  %4 = load i8, ptr @chroma_mask_mv_y, align 1
  %conv = zext i8 %4 to i32
  %and = and i32 %conv, %y
  %idxprom = zext i32 %and to i64
  %arrayidx = getelementptr inbounds ptr, ptr %Pic, i64 %idxprom
  %5 = load ptr, ptr %arrayidx, align 8
  %6 = load i8, ptr @chroma_mask_mv_x, align 1
...
entry:
  %0 = load i8, ptr @chroma_mask_mv_y, align 1
  %conv = zext i8 %0 to i32
  %and = and i32 %conv, %y
  %idxprom = zext i32 %and to i64
  %arrayidx = getelementptr inbounds ptr, ptr %Pic, i64 %idxprom
  %1 = load ptr, ptr %arrayidx, align 8
  %2 = load i8, ptr @chroma_mask_mv_x, align 1
  ...
  %4 = load i32, ptr @chroma_shift_y, align 4
  %shr = ashr i32 %y, %4
