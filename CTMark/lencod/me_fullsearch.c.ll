...
land.end:                                         ; preds = %land.lhs.true26, %land.lhs.true, %entry
  ...
  %14 = load i32, ptr %weighted_pred_flag, align 8
...
land.lhs.true33:                                  ; preds = %land.end
  ...
  %15 = load i32, ptr %type34, align 4
...
lor.lhs.false40:                                  ; preds = %land.lhs.true33, %land.end
  ...
  %16 = load i32, ptr %weighted_bipred_idc, align 4
...
land.lhs.true42:                                  ; preds = %lor.lhs.false40
  ...
  %17 = load i32, ptr %type43, align 4
...
land.rhs46:                                       ; preds = %land.lhs.true33, %land.lhs.true33, %land.lhs.true42
  ...
  %18 = load i32, ptr %UseWeightedReferenceME, align 8
...
land.end48:                                       ; preds = %land.rhs46, %land.lhs.true42, %lor.lhs.false40
  ...
  %20 = load ptr, ptr %imgY_sub, align 8
  store ptr %20, ptr @ref_pic_sub, align 8
  %size_x = getelementptr inbounds %struct.storable_picture, ptr %5, i64 0, i32 18
  %21 = load i32, ptr %size_x, align 8
  %conv52 = trunc i32 %21 to i16
  store i16 %conv52, ptr @img_width, align 2
  %size_y = getelementptr inbounds %struct.storable_picture, ptr %5, i64 0, i32 19
  %22 = load i32, ptr %size_y, align 4
  %conv53 = trunc i32 %22 to i16
  store i16 %conv53, ptr @img_height, align 2
...
if.then73:                                        ; preds = %if.then68
  ...
  %42 = load <2 x i32>, ptr %arrayidx79, align 4
  ...
  %46 = load <2 x i32>, ptr %arrayidx91, align 4
...
if.end119:                                        ; preds = %land.lhs.true111, %if.else
  ...
  %.pre274 = load ptr, ptr @spiral_search_x, align 8
  %.pre276 = load ptr, ptr @spiral_search_y, align 8
  %.pre278 = load ptr, ptr @mvbits, align 8
...
for.body.us:                                      ; preds = %if.end119, %for.inc.us
  ...
  %51 = load i16, ptr %arrayidx123.us, align 2
  ...
  %52 = load i16, ptr %arrayidx128.us, align 2
  ...
  %53 = load i32, ptr %arrayidx134.us, align 4
  ...
  %54 = load i32, ptr %arrayidx137.us, align 4
...
if.end155.us:                                     ; preds = %for.body.us
  %55 = load ptr, ptr %arrayidx157, align 8
  ...
  %.pre269 = load ptr, ptr @spiral_search_y, align 8
  %.pre271 = load ptr, ptr @mvbits, align 8
  br label %for.inc.us
...
for.body:                                         ; preds = %if.end119, %for.inc
  ...
  %63 = load i16, ptr %arrayidx123, align 2
...
if.end155:                                        ; preds = %for.body
  ...
  %.pre273 = load ptr, ptr @spiral_search_x, align 8
  %.pre275 = load ptr, ptr @spiral_search_y, align 8
  %.pre277 = load ptr, ptr @mvbits, align 8
  br label %for.inc
...
for.inc:                                          ; preds = %if.end155, %for.body
  ...
  br i1 %exitcond267.not, label %for.end, label %for.body
...
if.then167:                                       ; preds = %for.end
  ...
  %74 = load i16, ptr %arrayidx169, align 2
  %75 = load i16, ptr %mv_x, align 2
  %add172 = add i16 %75, %74
  store i16 %add172, ptr %mv_x, align 2
  %arrayidx175 = getelementptr inbounds i16, ptr %72, i64 %idxprom168
  %76 = load i16, ptr %arrayidx175, align 2
  %77 = load i16, ptr %mv_y, align 2
  %add178 = add i16 %77, %76
  store i16 %add178, ptr %mv_y, align 2
  br label %if.end180
...
cond.end76:                                       ; preds = %entry.cond.end76_crit_edge, %cond.true60, %cond.false67
  ...
  %28 = load ptr, ptr %arrayidx81, align 8
  ...
  %33 = load ptr, ptr %imgY_sub88, align 8
  ...
  store i16 %conv89, ptr @img_width, align 2
  ...
  store i16 %conv90, ptr @img_height, align 2
...
cond.true114:                                     ; preds = %if.then
  ...
  %40 = load ptr, ptr %arrayidx98, align 8
  ...
  %42 = load ptr, ptr %arrayidx119, align 8
...
cond.false122:                                    ; preds = %if.then
  ...
  %43 = load ptr, ptr %arrayidx104, align 8
  ...
  %45 = load ptr, ptr %arrayidx124, align 8
...
cond.end129:                                      ; preds = %cond.false122, %cond.true114
  ...
  %conv111.sink.in.in = load ptr, ptr %conv111.sink.in.in.in, align 8
  %conv111.sink.in = load i32, ptr %conv111.sink.in.in, align 4
  %conv111.sink = trunc i32 %conv111.sink.in to i16
  store i16 %conv111.sink, ptr @weight1, align 2
  %cond130.in = load ptr, ptr %cond130.in.in, align 8
  %cond130 = load i32, ptr %cond130.in, align 4
  %conv131 = trunc i32 %cond130 to i16
  store i16 %conv131, ptr @weight2, align 2
...
if.else:                                          ; preds = %cond.end76
  ...
  store i16 %conv138, ptr @weight1, align 2
  store i16 %conv138, ptr @weight2, align 2
  br label %if.end
...
if.end:                                           ; preds = %if.else, %cond.end129
  ...
  store i16 %storemerge551, ptr @offsetBi, align 2
...
if.then142:                                       ; preds = %if.end
  ...
  %52 = load ptr, ptr %arrayidx145, align 8
  ...
  %53 = load ptr, ptr %imgUV_sub146, align 8
  ...
  %55 = load ptr, ptr %arrayidx149, align 8
...
cond.true267:                                     ; preds = %if.then151
  ...
  %67 = load ptr, ptr %arrayidx242, align 8
...
cond.false282:                                    ; preds = %if.then151
  ...
  %76 = load ptr, ptr %arrayidx256, align 8
  br label %cond.end295
...
if.else298:                                       ; preds = %if.then142
  ...
  store i16 %conv300, ptr @weight1_cr, align 2
  store i16 %conv300, ptr getelementptr inbounds ([2 x i16], ptr @weight1_cr, i64 0, i64 1), align 2
  store i16 %conv300, ptr @weight2_cr, align 2
  store i16 %conv300, ptr getelementptr inbounds ([2 x i16], ptr @weight2_cr, i64 0, i64 1), align 2
...
if.end308.sink.split:                             ; preds = %if.else298, %cond.end295
  ...
  store i16 %conv297.sink, ptr getelementptr inbounds ([2 x i16], ptr @offsetBi_cr, i64 0, i64 1), align 2
  br label %if.end308
...
if.end332:                                        ; preds = %land.lhs.true322, %if.else331
  ...
  store i32 %storemerge556, ptr @bipred2_access_method, align 4
...
if.end358:                                        ; preds = %land.lhs.true348, %if.else357
  ...
  store i32 %storemerge557, ptr @bipred1_access_method, align 4
  ...
  %.pre603 = load ptr, ptr @spiral_search_x, align 8
  %.pre605 = load ptr, ptr @spiral_search_y, align 8
  %.pre607 = load ptr, ptr @mvbits, align 8
  br label %for.body
...
for.body:                                         ; preds = %if.end358, %for.inc
  ...
  %90 = load i16, ptr %arrayidx363, align 2
  ...
  %91 = load i16, ptr %arrayidx369, align 2
  ...
  %92 = load i32, ptr %arrayidx377, align 4
  ...
  %94 = load i32, ptr %arrayidx388, align 4
...
if.end399:                                        ; preds = %for.body
  %96 = load ptr, ptr @computeBiPred, align 8
  ...
  %.pre = load ptr, ptr @spiral_search_x, align 8
  %.pre604 = load ptr, ptr @spiral_search_y, align 8
  %.pre606 = load ptr, ptr @mvbits, align 8
  br label %for.inc
...
if.then415:                                       ; preds = %for.end
  ...
  %101 = load i16, ptr %arrayidx417, align 2
  %102 = load i16, ptr %mv_x, align 2
  %add420 = add i16 %102, %101
  store i16 %add420, ptr %mv_x, align 2
  %arrayidx423 = getelementptr inbounds i16, ptr %99, i64 %idxprom416
  %103 = load i16, ptr %arrayidx423, align 2
  %104 = load i16, ptr %mv_y, align 2
  %add426 = add i16 %104, %103
  store i16 %add426, ptr %mv_y, align 2
  br label %if.end428
...
land.end:                                         ; preds = %land.rhs, %land.lhs.true7, %land.lhs.true, %entry
  ...
  %7 = load i32, ptr @start_me_refinement_hp, align 4
  ...
  %10 = load i32, ptr %list_offset24, align 8
...
land.lhs.true26:                                  ; preds = %land.end
  ...
  %13 = load i32, ptr %type27, align 4
...
land.lhs.true35:                                  ; preds = %lor.lhs.false33
  ...
  %15 = load i32, ptr %type36, align 4
...
if.then69:                                        ; preds = %if.end
  ...
  %36 = load ptr, ptr %imgUV_sub, align 8
  %37 = load ptr, ptr %36, align 8
  store ptr %37, ptr getelementptr inbounds (%struct.SubImageContainer, ptr @ref_pic_sub, i64 0, i32 1), align 8
  %arrayidx72 = getelementptr inbounds ptr, ptr %36, i64 1
  %38 = load ptr, ptr %arrayidx72, align 8
  store ptr %38, ptr getelementptr inbounds (%struct.SubImageContainer, ptr @ref_pic_sub, i64 0, i32 1, i64 1), align 8
  %size_x_cr_pad = getelementptr inbounds %struct.storable_picture, ptr %20, i64 0, i32 24
  %39 = load i32, ptr %size_x_cr_pad, align 8
  store i32 %39, ptr @width_pad_cr, align 4
  %size_y_cr_pad = getelementptr inbounds %struct.storable_picture, ptr %20, i64 0, i32 25
  %40 = load i32, ptr %size_y_cr_pad, align 4
  store i32 %40, ptr @height_pad_cr, align 4
  br i1 %17, label %if.then74, label %if.end100

if.then74:                                        ; preds = %if.then69
  %41 = load ptr, ptr @wp_weight, align 8
  %arrayidx77 = getelementptr inbounds ptr, ptr %41, i64 %idxprom45
  %42 = load ptr, ptr %arrayidx77, align 8
  ...
  %44 = load <2 x i32>, ptr %arrayidx80, align 4
  store <2 x i32> %44, ptr @weight_cr, align 4
  %45 = load ptr, ptr @wp_offset, align 8
  ...
  %47 = load ptr, ptr %arrayidx91, align 8
  %arrayidx92 = getelementptr inbounds i32, ptr %47, i64 1
  %48 = load <2 x i32>, ptr %arrayidx92, align 4
  store <2 x i32> %48, ptr @offset_cr, align 4
  br label %if.end100

if.end100:                                        ; preds = %if.then69, %if.then74, %if.end
  %49 = load i16, ptr %mv_x, align 2
...
for.body.lr.ph:                                   ; preds = %if.end123
  ...
  %.pre427 = load ptr, ptr @spiral_hpel_search_x, align 8
  %.pre429 = load ptr, ptr @spiral_hpel_search_y, align 8
  %.pre431 = load ptr, ptr @mvbits, align 8
  br i1 %.fr, label %for.body, label %for.body.us
...
for.body.us:                                      ; preds = %for.body.lr.ph, %for.inc.us
  ...
  %59 = load i32, ptr %arrayidx139.us, align 4
  ...
  %60 = load i32, ptr %arrayidx143.us, align 4
...
if.end149.us:                                     ; preds = %for.body.us
  ...
  %61 = load ptr, ptr %arrayidx153, align 8
  ...
  %.pre420 = load ptr, ptr @spiral_hpel_search_x, align 8
  %.pre422 = load ptr, ptr @spiral_hpel_search_y, align 8
  %.pre424 = load ptr, ptr @mvbits, align 8
  br label %for.inc.us
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %72 = load i16, ptr %arrayidx133, align 2
  ...
  %73 = load i32, ptr %arrayidx139, align 4
...
if.end149:                                        ; preds = %for.body
  ...
  %75 = load ptr, ptr %arrayidx153, align 8
  ...
  %.pre426 = load ptr, ptr @spiral_hpel_search_x, align 8
  %.pre428 = load ptr, ptr @spiral_hpel_search_y, align 8
  %.pre430 = load ptr, ptr @mvbits, align 8
  br label %for.inc
...
for.inc:                                          ; preds = %if.end149, %for.body
  ...
  br i1 %exitcond414.not, label %for.end, label %for.body
...
for.end:                                          ; preds = %for.inc.us, %for.inc
  ...
  %.pre433 = load i16, ptr %mv_x, align 2
  br i1 %tobool170.not, label %if.end184, label %if.then171

if.then171:                                       ; preds = %for.end
  %81 = load ptr, ptr @spiral_hpel_search_x, align 8
  %idxprom172 = sext i32 %best_pos.0.lcssa to i64
  %arrayidx173 = getelementptr inbounds i16, ptr %81, i64 %idxprom172
  %82 = load i16, ptr %arrayidx173, align 2
  %add176 = add i16 %.pre433, %82
  store i16 %add176, ptr %mv_x, align 2
  %83 = load ptr, ptr @spiral_hpel_search_y, align 8
  %arrayidx179 = getelementptr inbounds i16, ptr %83, i64 %idxprom172
  %84 = load i16, ptr %arrayidx179, align 2
  %85 = load i16, ptr %mv_y, align 2
  %add182 = add i16 %85, %84
  store i16 %add182, ptr %mv_y, align 2
...
if.end184.sink.split:                             ; preds = %if.end123, %if.then171
  ...
  %.pre433443 = load i16, ptr %mv_x, align 2
  br label %if.end184
...
if.end209:                                        ; preds = %land.lhs.true197, %if.else208
  ...
  store i32 %storemerge384, ptr @ref_access_method, align 4
  %arrayidx212 = getelementptr inbounds i32, ptr %lambda, i64 2
  %89 = load i32, ptr %arrayidx212, align 4
...
for.body216.lr.ph:                                ; preds = %if.end209
  ...
  %.pre435 = load ptr, ptr @spiral_search_x, align 8
  %.pre437 = load ptr, ptr @spiral_search_y, align 8
  %.pre439 = load ptr, ptr @mvbits, align 8
...
for.body216:                                      ; preds = %for.body216.lr.ph, %for.inc253
  ...
  %98 = load i32, ptr %arrayidx230, align 4
  ...
  %99 = load i32, ptr %arrayidx234, align 4
...
if.end241:                                        ; preds = %for.body216
  ...
  %100 = load ptr, ptr %arrayidx245, align 8
  ...
  %.pre434 = load ptr, ptr @spiral_search_x, align 8
  %.pre436 = load ptr, ptr @spiral_search_y, align 8
  %.pre438 = load ptr, ptr @mvbits, align 8
  br label %for.inc253
...
for.inc253:                                       ; preds = %if.end241, %for.body216
  ...
  br i1 %exitcond419.not, label %for.end255, label %for.body216
...
if.then257:                                       ; preds = %for.end255
  %105 = load ptr, ptr @spiral_search_x, align 8
  %idxprom258 = sext i32 %best_pos.3 to i64
  %arrayidx259 = getelementptr inbounds i16, ptr %105, i64 %idxprom258
  %106 = load i16, ptr %arrayidx259, align 2
  %107 = load i16, ptr %mv_x, align 2
  %add262 = add i16 %107, %106
  store i16 %add262, ptr %mv_x, align 2
  %108 = load ptr, ptr @spiral_search_y, align 8
  %arrayidx265 = getelementptr inbounds i16, ptr %108, i64 %idxprom258
  %109 = load i16, ptr %arrayidx265, align 2
  %110 = load i16, ptr %mv_y, align 2
  %add268 = add i16 %110, %109
  store i16 %add268, ptr %mv_y, align 2
  br label %if.end270
...
cond.end37.sink.split:                            ; preds = %cond.false29, %cond.true22
  ...
  %cond16693.ph.in = load ptr, ptr %cond16693.ph.in.in, align 8
  %cond16693.ph = load i32, ptr %cond16693.ph.in, align 4
  %11 = load ptr, ptr %arrayidx27.sink, align 8
...
cond.end37:                                       ; preds = %cond.end37.sink.split, %entry
  ...
  %14 = load i32, ptr %arrayidx41, align 8
  ...
  %17 = load i16, ptr %s_mv_x, align 2
  %conv55 = sext i16 %17 to i32
  %add56 = add nsw i32 %shl, %conv55
  %18 = load i16, ptr %s_mv_y, align 2
  ...
  %21 = load ptr, ptr %arrayidx66, align 8
  %22 = load ptr, ptr %21, align 8
  %size_x = getelementptr inbounds %struct.storable_picture, ptr %20, i64 0, i32 18
  %23 = load i32, ptr %size_x, align 8
  %sub = sub nsw i32 %23, %14
  %add68 = shl i32 %sub, 2
  %shl69 = add i32 %add68, 160
  %size_y = getelementptr inbounds %struct.storable_picture, ptr %20, i64 0, i32 19
  %24 = load i32, ptr %size_y, align 4
  ...
  store ptr %26, ptr @ref_pic1_sub, align 8
  %imgY_sub74 = getelementptr inbounds %struct.storable_picture, ptr %22, i64 0, i32 30
  %27 = load ptr, ptr %imgY_sub74, align 8
  store ptr %27, ptr @ref_pic2_sub, align 8
  %conv76 = trunc i32 %23 to i16
  store i16 %conv76, ptr @img_width, align 2
  %conv78 = trunc i32 %24 to i16
  store i16 %conv78, ptr @img_height, align 2
  %size_x_pad = getelementptr inbounds %struct.storable_picture, ptr %20, i64 0, i32 22
  %28 = load i32, ptr %size_x_pad, align 8
  store i32 %28, ptr @width_pad, align 4
  %size_y_pad = getelementptr inbounds %struct.storable_picture, ptr %20, i64 0, i32 23
  %29 = load i32, ptr %size_y_pad, align 4
  store i32 %29, ptr @height_pad, align 4
  br i1 %cmp.not, label %if.else, label %if.then

if.then:                                          ; preds = %cond.end37
  %cmp80 = icmp eq i32 %list, 0
  %30 = load ptr, ptr @wbp_weight, align 8
...
cond.true102:                                     ; preds = %if.then
  ...
  %31 = load ptr, ptr %arrayidx84, align 8
...
cond.end117:                                      ; preds = %cond.false110, %cond.true102
  ...
  %conv99.sink.in.in = load ptr, ptr %conv99.sink.in.in.in, align 8
  %conv99.sink.in = load i32, ptr %conv99.sink.in.in, align 4
  %conv99.sink = trunc i32 %conv99.sink.in to i16
  store i16 %conv99.sink, ptr @weight1, align 2
  %cond118.in = load ptr, ptr %cond118.in.in, align 8
  %cond118 = load i32, ptr %cond118.in, align 4
  %conv119 = trunc i32 %cond118 to i16
  store i16 %conv119, ptr @weight2, align 2
...
if.else:                                          ; preds = %cond.end37
  %40 = load i32, ptr @luma_log_weight_denom, align 4
  %shl125 = shl nuw i32 1, %40
  %conv126 = trunc i32 %shl125 to i16
  store i16 %conv126, ptr @weight1, align 2
  store i16 %conv126, ptr @weight2, align 2
  br label %if.end
...
if.end:                                           ; preds = %if.else, %cond.end117
  ...
  store i16 %storemerge671, ptr @offsetBi, align 2
...
if.then130:                                       ; preds = %if.end
  %imgUV_sub = getelementptr inbounds %struct.storable_picture, ptr %20, i64 0, i32 32
  %42 = load ptr, ptr %imgUV_sub, align 8
  %43 = load ptr, ptr %42, align 8
  store ptr %43, ptr getelementptr inbounds (%struct.SubImageContainer, ptr @ref_pic1_sub, i64 0, i32 1), align 8
  %arrayidx133 = getelementptr inbounds ptr, ptr %42, i64 1
  %44 = load ptr, ptr %arrayidx133, align 8
  store ptr %44, ptr getelementptr inbounds (%struct.SubImageContainer, ptr @ref_pic1_sub, i64 0, i32 1, i64 1), align 8
  %imgUV_sub134 = getelementptr inbounds %struct.storable_picture, ptr %22, i64 0, i32 32
  %45 = load ptr, ptr %imgUV_sub134, align 8
  %46 = load ptr, ptr %45, align 8
  store ptr %46, ptr getelementptr inbounds (%struct.SubImageContainer, ptr @ref_pic2_sub, i64 0, i32 1), align 8
  %arrayidx137 = getelementptr inbounds ptr, ptr %45, i64 1
  %47 = load ptr, ptr %arrayidx137, align 8
  store ptr %47, ptr getelementptr inbounds (%struct.SubImageContainer, ptr @ref_pic2_sub, i64 0, i32 1, i64 1), align 8
  %size_x_cr_pad = getelementptr inbounds %struct.storable_picture, ptr %20, i64 0, i32 24
  %48 = load i32, ptr %size_x_cr_pad, align 8
  store i32 %48, ptr @width_pad_cr, align 4
  %size_y_cr_pad = getelementptr inbounds %struct.storable_picture, ptr %20, i64 0, i32 25
  %49 = load i32, ptr %size_y_cr_pad, align 4
  store i32 %49, ptr @height_pad_cr, align 4
  br i1 %cmp.not, label %if.else286, label %if.then139

if.then139:                                       ; preds = %if.then130
  %cmp140 = icmp eq i32 %list, 0
  %50 = load ptr, ptr @wbp_weight, align 8
...
cond.end283:                                      ; preds = %cond.false270, %cond.true255
  ...
  %.pn674712.pn = load ptr, ptr %.pn674712.pn.in, align 8
  %conv199.sink.in.in = getelementptr inbounds i32, ptr %.pn674712.pn, i64 1
  %73 = load <2 x i32>, ptr %conv199.sink.in.in, align 4
...
if.else286:                                       ; preds = %if.then130
  %76 = load i32, ptr @chroma_log_weight_denom, align 4
  %shl287 = shl nuw i32 1, %76
  %conv288 = trunc i32 %shl287 to i16
  store i16 %conv288, ptr @weight1_cr, align 2
  store i16 %conv288, ptr getelementptr inbounds ([2 x i16], ptr @weight1_cr, i64 0, i64 1), align 2
  store i16 %conv288, ptr @weight2_cr, align 2
  store i16 %conv288, ptr getelementptr inbounds ([2 x i16], ptr @weight2_cr, i64 0, i64 1), align 2
  store i16 0, ptr @offsetBi_cr, align 2
  br label %if.end296.sink.split

if.end296.sink.split:                             ; preds = %if.else286, %cond.end283
  %conv285.sink = phi i16 [ %conv285, %cond.end283 ], [ 0, %if.else286 ]
  store i16 %conv285.sink, ptr getelementptr inbounds ([2 x i16], ptr @offsetBi_cr, i64 0, i64 1), align 2
  br label %if.end296
...
if.end319:                                        ; preds = %land.lhs.true306, %if.else318
  ...
  store i32 %storemerge676, ptr @bipred2_access_method, align 4
  %79 = load i16, ptr %s_mv_x, align 2
...
land.lhs.true330:                                 ; preds = %if.end319
  %80 = load i16, ptr %s_mv_y, align 2
...
if.end343:                                        ; preds = %land.lhs.true330, %if.else342
  ...
  store i32 %storemerge677, ptr @bipred1_access_method, align 4
...
for.body.lr.ph:                                   ; preds = %if.end343
  ...
  %.pre741 = load ptr, ptr @spiral_hpel_search_x, align 8
  %.pre743 = load ptr, ptr @spiral_hpel_search_y, align 8
  %.pre745 = load ptr, ptr @mvbits, align 8
  br label %for.body
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %86 = load i16, ptr %arrayidx348, align 2
  ...
  %88 = load i16, ptr %arrayidx353, align 2
  ...
  %89 = load i32, ptr %arrayidx359, align 4
  ...
  %90 = load i32, ptr %arrayidx363, align 4
...
if.end369:                                        ; preds = %for.body
  ...
  %91 = load ptr, ptr @computeBiPred, align 8
  ...
  %.pre = load ptr, ptr @spiral_hpel_search_x, align 8
  %.pre742 = load ptr, ptr @spiral_hpel_search_y, align 8
  %.pre744 = load ptr, ptr @mvbits, align 8
  br label %for.inc
...
for.end:                                          ; preds = %for.inc
  %.pre747.pre = load i16, ptr %mv_x, align 2
  %tobool379.not = icmp eq i32 %best_pos.1, 0
  br i1 %tobool379.not, label %if.end393, label %if.then380

if.then380:                                       ; preds = %for.end
  %96 = load ptr, ptr @spiral_hpel_search_x, align 8
  %idxprom381 = sext i32 %best_pos.1 to i64
  %arrayidx382 = getelementptr inbounds i16, ptr %96, i64 %idxprom381
  %97 = load i16, ptr %arrayidx382, align 2
  %add385 = add i16 %.pre747.pre, %97
  store i16 %add385, ptr %mv_x, align 2
  %98 = load ptr, ptr @spiral_hpel_search_y, align 8
  %arrayidx388 = getelementptr inbounds i16, ptr %98, i64 %idxprom381
  %99 = load i16, ptr %arrayidx388, align 2
  %100 = load i16, ptr %mv_y, align 2
  %add391 = add i16 %100, %99
  store i16 %add391, ptr %mv_y, align 2
  %.pre746 = load i16, ptr %mv_x, align 2
  br label %if.end393
...
if.end393:                                        ; preds = %if.end343, %if.then380, %for.end
  ...
  store ptr %cond398, ptr @computeBiPred, align 8
...
if.end420:                                        ; preds = %land.lhs.true408, %if.else419
  ...
  store i32 %storemerge678, ptr @bipred2_access_method, align 4
  %105 = load i16, ptr %s_mv_x, align 2
...
land.lhs.true430:                                 ; preds = %if.end420
  %106 = load i16, ptr %s_mv_y, align 2
...
if.end442:                                        ; preds = %land.lhs.true430, %if.else441
  ...
  store i32 %storemerge679, ptr @bipred1_access_method, align 4
  %107 = load i32, ptr @start_me_refinement_qp, align 4
  ...
  %108 = load i32, ptr %arrayidx446, align 4
...
for.body450.lr.ph:                                ; preds = %if.end442
  ...
  %.pre749 = load ptr, ptr @spiral_search_x, align 8
  %.pre751 = load ptr, ptr @spiral_search_y, align 8
  %.pre753 = load ptr, ptr @mvbits, align 8
...
for.body450:                                      ; preds = %for.body450.lr.ph, %for.inc485
  ...
  %117 = load i32, ptr %arrayidx464, align 4
  ...
  %118 = load i32, ptr %arrayidx468, align 4
...
if.end475:                                        ; preds = %for.body450
  ...
  %119 = load ptr, ptr @computeBiPred, align 8
  ...
  %.pre748 = load ptr, ptr @spiral_search_x, align 8
  %.pre750 = load ptr, ptr @spiral_search_y, align 8
  %.pre752 = load ptr, ptr @mvbits, align 8
  br label %for.inc485
...
for.inc485:                                       ; preds = %if.end475, %for.body450
  ...
  br i1 %exitcond740.not, label %for.end487, label %for.body450
