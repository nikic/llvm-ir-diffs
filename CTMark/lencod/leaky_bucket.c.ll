; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/leaky_bucket.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/leaky_bucket.c"
...
if.end:
  ...
  %6 = load i32, ptr %NumberLeakyBuckets2, align 4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %9, align 8
  %10 = getelementptr inbounds i64, ptr %9, i64 2
  %wide.load258 = load <2 x i64>, ptr %10, align 8
...
for.end.loopexit:                                 ; preds = %for.body, %middle.block
  %add17.lcssa = phi i64 [ %14, %middle.block ], [ %add17, %for.body ]
  %16 = uitofp i64 %add17.lcssa to float
  br label %for.end

for.end:                                          ; preds = %for.end.loopexit, %if.end15
  %TotalRate.0.lcssa = phi float [ 0.000000e+00, %if.end15 ], [ %16, %for.end.loopexit ]
  %conv19 = uitofp i64 %7 to float
  %div = fdiv float %TotalRate.0.lcssa, %conv19
  %conv20 = fptoui float %div to i64
  %call21 = tail call i32 @get_LeakyBucketRate(i64 noundef %conv, ptr noundef %call4)
...
for.inc52.peel:                                   ; preds = %for.end
  ...
  %jumpd44 = getelementptr inbounds %struct.InputParameters, ptr %17, i64 0, i32 5
  %18 = load ptr, ptr @img, align 8
  %framerate42 = getelementptr inbounds %struct.ImageParameters, ptr %18, i64 0, i32 12
  %19 = load float, ptr %framerate42, align 8
  %mul.peel = fmul float %19, %conv32
  %conv33.peel = fptoui float %mul.peel to i64
  %20 = load i32, ptr %jumpd44, align 4
  %add34.peel = add nsw i32 %20, 1
  %conv35.peel = sext i32 %add34.peel to i64
  %div36.peel = udiv i64 %conv33.peel, %conv35.peel
  store i64 %div36.peel, ptr %call4, align 8
...
for.body28.peel.next:                             ; preds = %for.inc52.peel
  ...
  %22 = add nsw i64 %conv, -2
  %xtraiter = and i64 %21, 3
  %23 = icmp ult i64 %22, 3
  br i1 %23, label %if.end55.loopexit.unr-lcssa, label %for.body28.peel.next.new
...
for.inc52:                                        ; preds = %for.inc52, %for.body28.peel.next.new
  ...
  store i64 %conv49.3, ptr %arrayidx50.3, align 8
  %inc53.3 = add nuw i64 %iBucket.0236, 4
  %niter.next.3 = add i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %if.end55.loopexit.unr-lcssa, label %for.inc52
...
for.inc52.epil:                                   ; preds = %if.end55.loopexit.unr-lcssa, %for.inc52.epil
  ...
  store i64 %conv49.epil, ptr %arrayidx50.epil, align 8
  %inc53.epil = add nuw i64 %iBucket.0236.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %if.end55, label %for.inc52.epil
...
for.cond.loopexit.i:                              ; preds = %for.inc.i, %for.body.i
  ...
  br i1 %exitcond.not.i, label %Sort.exit, label %for.body.i
...
for.inc.i:                                        ; preds = %if.then.i, %for.body3.i
  ...
  br i1 %cmp2.i, label %for.body3.i, label %for.cond.loopexit.i
...
for.body60.lr.ph:                                 ; preds = %for.inc52.peel, %Sort.exit
  ...
  %jumpd62 = getelementptr inbounds %struct.InputParameters, ptr %26, i64 0, i32 5
  %27 = load i32, ptr %jumpd62, align 4
  %add63 = add nsw i32 %27, 1
  %conv64 = sext i32 %add63 to i64
  %28 = load ptr, ptr @img, align 8
  %framerate67 = getelementptr inbounds %struct.ImageParameters, ptr %28, i64 0, i32 12
  %29 = load float, ptr %framerate67, align 8
  %30 = load i64, ptr @total_frame_buffer, align 8
  %31 = load ptr, ptr @Bit_Buffer, align 8
  %32 = load i64, ptr %31, align 8
  %xtraiter261 = and i64 %30, 1
  %33 = icmp eq i64 %30, 1
  %unroll_iter266 = and i64 %30, -2
...
for.body74:                                       ; preds = %for.body60, %for.body74
  ...
  %niter267 = phi i64 [ %niter267.next.1, %for.body74 ], [ 0, %for.body60 ]
  %arrayidx76 = getelementptr inbounds i64, ptr %31, i64 %iFrame.1239
  %36 = load i64, ptr %arrayidx76, align 8
  %sub77 = sub nsw i64 %35, %36
  ...
  %arrayidx76.1 = getelementptr inbounds i64, ptr %31, i64 %add87
  %37 = load i64, ptr %arrayidx76.1, align 8
  %sub77.1 = sub nsw i64 %storemerge226, %37
  ...
  br i1 %niter267.ncmp.1, label %for.end99.loopexit.unr-lcssa, label %for.body74
...
for.end99.loopexit.unr-lcssa:                     ; preds = %for.body74, %for.body60
  ...
  br i1 %lcmp.mod263.not, label %for.end99, label %for.body74.epil

for.body74.epil:                                  ; preds = %for.end99.loopexit.unr-lcssa
  %arrayidx76.epil = getelementptr inbounds i64, ptr %31, i64 %iFrame.1239.unr
  %38 = load i64, ptr %arrayidx76.epil, align 8
  %sub77.epil = sub nsw i64 %.unr, %38
...
for.cond103:                                      ; preds = %for.body107, %for.end99
  %39 = phi i64 [ %32, %for.end99 ], [ %add121, %for.body107 ]
  %InitFullness.0 = phi i64 [ %32, %for.end99 ], [ %spec.select230, %for.body107 ]
...
for.body107:                                      ; preds = %for.cond103
  %arrayidx109 = getelementptr inbounds i64, ptr %31, i64 %iFrame.2
  %40 = load i64, ptr %arrayidx109, align 8
  %sub110 = sub nsw i64 %39, %40
  ...
  br i1 %cmp126, label %for.end132, label %for.cond103
...
for.end132:                                       ; preds = %for.body107, %for.cond103
  ...
  store i64 %sub100, ptr %arrayidx133, align 8
  %arrayidx134 = getelementptr inbounds i64, ptr %call12, i64 %iBucket.1245
  store i64 %InitFullness.2, ptr %arrayidx134, align 8
  %inc136 = add nuw i64 %iBucket.1245, 1
  %exitcond251.not = icmp eq i64 %inc136, %conv
  br i1 %exitcond251.not, label %for.end137, label %for.body60
