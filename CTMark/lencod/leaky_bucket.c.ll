...
for.inc52.peel:                                   ; preds = %for.end
  ...
  %19 = load float, ptr %framerate42, align 8, !tbaa !26
  %mul.peel = fmul float %19, %conv32
  %conv33.peel = fptoui float %mul.peel to i64
  %20 = load i32, ptr %jumpd44, align 4, !tbaa !30
...
for.body3.i:                                      ; preds = %for.inc.i, %for.body3.lr.ph.i
  ...
  %24 = load i64, ptr %arrayidx.i, align 8, !tbaa !9
  %arrayidx4.i = getelementptr inbounds i64, ptr %call4, i64 %j.030.i
  %25 = load i64, ptr %arrayidx4.i, align 8, !tbaa !9
  %cmp5.i = icmp ugt i64 %24, %25
  br i1 %cmp5.i, label %if.then.i, label %for.inc.i

if.then.i:                                        ; preds = %for.body3.i
  store i64 %25, ptr %arrayidx.i, align 8, !tbaa !9
  store i64 %24, ptr %arrayidx4.i, align 8, !tbaa !9
  br label %for.inc.i
...
for.body60.lr.ph:                                 ; preds = %for.inc52.peel, %Sort.exit
  ...
  %27 = load i32, ptr %jumpd62, align 4, !tbaa !30
  ...
  %29 = load float, ptr %framerate67, align 8, !tbaa !26
  %30 = load i64, ptr @total_frame_buffer, align 8, !tbaa !9
...
for.body60:                                       ; preds = %for.body60.lr.ph, %for.end132
  ...
  %34 = load i64, ptr %arrayidx61, align 8, !tbaa !9
...
for.body74:                                       ; preds = %for.body60, %for.body74
  ...
  %36 = load i64, ptr %arrayidx76, align 8, !tbaa !9
  ...
  %37 = load i64, ptr %arrayidx76.1, align 8, !tbaa !9
  ...
  br i1 %niter267.ncmp.1, label %for.end99.loopexit.unr-lcssa, label %for.body74, !llvm.loop !35
...
for.body74.epil:                                  ; preds = %for.end99.loopexit.unr-lcssa
  ...
  %38 = load i64, ptr %arrayidx76.epil, align 8, !tbaa !9
...
for.body107:                                      ; preds = %for.cond103
  ...
  %40 = load i64, ptr %arrayidx109, align 8, !tbaa !9
