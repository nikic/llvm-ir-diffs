; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/biariencode.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/biariencode.c"
...
entry:
  store i32 0, ptr @pic_bin_count, align 4
  ret void
}
...
entry:
  %0 = load i32, ptr @pic_bin_count, align 4
  ret i32 %0
}
...
entry:
  ...
  store i32 0, ptr %Ebits_to_follow, align 8
  %Ecodestrm = getelementptr inbounds %struct.EncodingEnvironment, ptr %eep, i64 0, i32 5
  store ptr %code_buffer, ptr %Ecodestrm, align 8
  %Ecodestrm_len = getelementptr inbounds %struct.EncodingEnvironment, ptr %eep, i64 0, i32 6
  store ptr %code_len, ptr %Ecodestrm_len, align 8
  store <4 x i32> <i32 0, i32 510, i32 0, i32 9>, ptr %eep, align 8
...
entry:
  %Ecodestrm_len = getelementptr inbounds %struct.EncodingEnvironment, ptr %eep, i64 0, i32 6
  %0 = load ptr, ptr %Ecodestrm_len, align 8
  %1 = load i32, ptr %0, align 4
  %mul = shl nsw i32 %1, 3
  %Ebits_to_follow = getelementptr inbounds %struct.EncodingEnvironment, ptr %eep, i64 0, i32 4
  %2 = load i32, ptr %Ebits_to_follow, align 8
  %Ebits_to_go = getelementptr inbounds %struct.EncodingEnvironment, ptr %eep, i64 0, i32 3
  %3 = load i32, ptr %Ebits_to_go, align 4
  %add = add i32 %2, 8
...
entry:
  ...
  %0 = load i32, ptr %Ebuffer, align 8
  %shl = shl i32 %0, 1
  %1 = load i32, ptr %eep, align 8
  %shr = lshr i32 %1, 9
  %conv = and i32 %shr, 1
  %or = or i32 %conv, %shl
  store i32 %or, ptr %Ebuffer, align 8
  %Ebits_to_go = getelementptr inbounds %struct.EncodingEnvironment, ptr %eep, i64 0, i32 3
  %2 = load i32, ptr %Ebits_to_go, align 4
  %dec = add i32 %2, -1
  store i32 %dec, ptr %Ebits_to_go, align 4
...
if.then:                                          ; preds = %entry
  ...
  %Ecodestrm = getelementptr inbounds %struct.EncodingEnvironment, ptr %eep, i64 0, i32 5
  %3 = load ptr, ptr %Ecodestrm, align 8
  %Ecodestrm_len = getelementptr inbounds %struct.EncodingEnvironment, ptr %eep, i64 0, i32 6
  %4 = load ptr, ptr %Ecodestrm_len, align 8
  ...
  %C = getelementptr inbounds %struct.EncodingEnvironment, ptr %eep, i64 0, i32 7
  %C.promoted = load i32, ptr %C, align 8
...
if.end:                                           ; preds = %if.then, %while.body.lr.ph, %entry
  ...
  %Ebits_to_follow = getelementptr inbounds %struct.EncodingEnvironment, ptr %eep, i64 0, i32 4
  %15 = load i32, ptr %Ebits_to_follow, align 8
...
while.body14:                                     ; preds = %while.body14.lr.ph, %if.end48
  ...
  %dec16 = add i32 %17, -1
  store i32 %dec16, ptr %Ebits_to_follow, align 8
  %18 = load i32, ptr %Ebuffer, align 8
  %shl18 = shl i32 %18, 1
  %19 = load i32, ptr %eep, align 8
  %20 = lshr i32 %19, 9
  %.lobit = and i32 %20, 1
  %21 = or i32 %.lobit, %shl18
  %or24 = xor i32 %21, 1
  store i32 %or24, ptr %Ebuffer, align 8
  %dec26 = add i32 %16, -1
  store i32 %dec26, ptr %Ebits_to_go, align 4
...
if.then29:                                        ; preds = %while.body14
  ...
  %22 = load ptr, ptr %Ecodestrm32, align 8
  %23 = load ptr, ptr %Ecodestrm_len33, align 8
  %24 = load i32, ptr %23, align 4
  %inc34 = add nsw i32 %24, 1
  store i32 %inc34, ptr %23, align 4
  %idxprom35 = sext i32 %24 to i64
  %arrayidx36 = getelementptr inbounds i8, ptr %22, i64 %idxprom35
  store i8 %conv31, ptr %arrayidx36, align 1
  store i32 8, ptr %Ebits_to_go, align 4
  %C39.promoted = load i32, ptr %C39, align 8
...
while.body42.lr.ph:                               ; preds = %if.then29
  %E45.promoted = load i32, ptr %E45, align 4
  ...
  %32 = add i32 %29, %27
  store i32 %31, ptr %C39, align 8
  store i32 %32, ptr %E45, align 4
  br label %if.end48

if.end48:                                         ; preds = %if.then29, %while.body42.lr.ph, %while.body14
  %33 = phi i32 [ 8, %if.then29 ], [ 8, %while.body42.lr.ph ], [ %dec26, %while.body14 ]
  %34 = load i32, ptr %Ebits_to_follow, align 8
  %cmp12.not = icmp eq i32 %34, 0
  br i1 %cmp12.not, label %while.end49, label %while.body14

while.end49:                                      ; preds = %if.end48, %if.end
  %35 = phi i32 [ %14, %if.end ], [ %33, %if.end48 ]
  %36 = load i32, ptr %Ebuffer, align 8
  %shl51 = shl i32 %36, 1
  %37 = load i32, ptr %eep, align 8
  %shr53 = lshr i32 %37, 8
  %and56 = and i32 %shr53, 1
  %or58 = or i32 %and56, %shl51
  store i32 %or58, ptr %Ebuffer, align 8
  %dec60 = add i32 %35, -1
  store i32 %dec60, ptr %Ebits_to_go, align 4
...
if.then63:                                        ; preds = %while.end49
  ...
  %C73.promoted = load i32, ptr %C73, align 8
...
while.body76.lr.ph:                               ; preds = %if.then63
  ...
  %E79.promoted = load i32, ptr %E79, align 4
  ...
  %48 = add i32 %45, 1
  store i32 %47, ptr %C73, align 8
  store i32 %48, ptr %E79, align 4
  br label %if.end82

if.end82:                                         ; preds = %if.then63, %while.body76.lr.ph, %while.end49
  %49 = phi i32 [ 8, %if.then63 ], [ 8, %while.body76.lr.ph ], [ %dec60, %while.end49 ]
  %50 = load i32, ptr %Ebuffer, align 8
  %shl84 = shl i32 %50, 1
  %or86 = or i32 %shl84, 1
  store i32 %or86, ptr %Ebuffer, align 8
  %dec88 = add i32 %49, -1
  store i32 %dec88, ptr %Ebits_to_go, align 4
...
while.body104.lr.ph:                              ; preds = %if.then91
  ...
  %E107.promoted = load i32, ptr %E107, align 4
  ...
  %61 = add i32 %58, 1
  store i32 %60, ptr %C101, align 8
  store i32 %61, ptr %E107, align 4
  br label %if.end110
...
if.end110:                                        ; preds = %if.then91, %while.body104.lr.ph, %if.end82
  ...
  %66 = load i64, ptr %arrayidx115, align 8
  %add = add nsw i64 %66, %conv113
  store i64 %add, ptr %arrayidx115, align 8
...
while.body120.lr.ph:                              ; preds = %if.end110
  ...
  %Ebuffer.promoted = load i32, ptr %Ebuffer, align 8
...
if.then129:                                       ; preds = %while.body120
  store i32 %shl122, ptr %Ebuffer, align 8
  store i32 %dec126, ptr %Ebits_to_go, align 4
  %conv131 = trunc i32 %shl122 to i8
  %68 = load ptr, ptr %Ecodestrm132, align 8
  %69 = load ptr, ptr %Ecodestrm_len133, align 8
  %70 = load i32, ptr %69, align 4
  %inc134 = add nsw i32 %70, 1
  store i32 %inc134, ptr %69, align 4
  %idxprom135 = sext i32 %70 to i64
  %arrayidx136 = getelementptr inbounds i8, ptr %68, i64 %idxprom135
  store i8 %conv131, ptr %arrayidx136, align 1
  store i32 8, ptr %Ebits_to_go, align 4
  %C139.promoted = load i32, ptr %C139, align 8
...
while.body142.lr.ph:                              ; preds = %if.then129
  %E145.promoted = load i32, ptr %E145, align 4
  ...
  %78 = add i32 %75, %73
  store i32 %77, ptr %C139, align 8
  store i32 %78, ptr %E145, align 4
...
entry:
  ...
  %0 = load i32, ptr %Erange, align 4
  %1 = load i32, ptr %eep, align 8
  %2 = load i16, ptr %bi_ct, align 8
  ...
  %sub = sub i32 %0, %conv
  %4 = load i32, ptr @cabac_encoding, align 4
...
if.end26.thread:                                  ; preds = %if.then13, %if.then
  ...
  %storemerge271 = load i16, ptr %storemerge.in270, align 2
  store i16 %storemerge271, ptr %bi_ct, align 8
...
if.end26:                                         ; preds = %entry
  ...
  store i16 %storemerge, ptr %bi_ct, align 8
...
if.then31:                                        ; preds = %while.body
  %9 = load i32, ptr %Ebuffer89, align 8
  %shl = shl i32 %9, 1
  %or = or i32 %shl, 1
  store i32 %or, ptr %Ebuffer89, align 8
  %10 = load i32, ptr %Ebits_to_go93, align 4
  %dec = add i32 %10, -1
  store i32 %dec, ptr %Ebits_to_go93, align 4
  %cmp33 = icmp eq i32 %dec, 0
  br i1 %cmp33, label %if.then35, label %if.end48

if.then35:                                        ; preds = %if.then31
  %conv37 = trunc i32 %or to i8
  %11 = load ptr, ptr %Ecodestrm100, align 8
  %12 = load ptr, ptr %Ecodestrm_len101, align 8
  ...
  store i32 8, ptr %Ebits_to_go93, align 4
  %C.promoted = load i32, ptr %C107, align 8
...
while.body44.lr.ph:                               ; preds = %if.then35
  %E.promoted = load i32, ptr %E113, align 4
...
while.body52:                                     ; preds = %if.end48, %if.end82
  ...
  %dec54 = add i32 %25, -1
  store i32 %dec54, ptr %Ebits_to_follow154, align 8
  %26 = load i32, ptr %Ebuffer89, align 8
  %shl56 = shl i32 %26, 1
  store i32 %shl56, ptr %Ebuffer89, align 8
  %dec60 = add i32 %24, -1
  store i32 %dec60, ptr %Ebits_to_go93, align 4
  %cmp61 = icmp eq i32 %dec60, 0
  br i1 %cmp61, label %if.then63, label %if.end82

if.then63:                                        ; preds = %while.body52
  %conv65 = trunc i32 %shl56 to i8
  %27 = load ptr, ptr %Ecodestrm100, align 8
  %28 = load ptr, ptr %Ecodestrm_len101, align 8
  %29 = load i32, ptr %28, align 4
  %inc68 = add nsw i32 %29, 1
  store i32 %inc68, ptr %28, align 4
  %idxprom69 = sext i32 %29 to i64
  %arrayidx70 = getelementptr inbounds i8, ptr %27, i64 %idxprom69
  store i8 %conv65, ptr %arrayidx70, align 1
  store i32 8, ptr %Ebits_to_go93, align 4
  %C73.promoted = load i32, ptr %C107, align 8
  %cmp74256 = icmp sgt i32 %C73.promoted, 7
  br i1 %cmp74256, label %while.body76.lr.ph, label %if.end82

while.body76.lr.ph:                               ; preds = %if.then63
  %E79.promoted = load i32, ptr %E113, align 4
  ...
  %37 = add i32 %34, %32
  store i32 %36, ptr %C107, align 8
  store i32 %37, ptr %E113, align 4
  br label %if.end82

if.end82:                                         ; preds = %if.then63, %while.body76.lr.ph, %while.body52
  %38 = phi i32 [ 8, %if.then63 ], [ 8, %while.body76.lr.ph ], [ %dec60, %while.body52 ]
  %39 = load i32, ptr %Ebits_to_follow154, align 8
  %cmp50.not = icmp eq i32 %39, 0
  br i1 %cmp50.not, label %while.end83, label %while.body52
...
if.then88:                                        ; preds = %if.else85
  %40 = load i32, ptr %Ebuffer89, align 8
  %shl90 = shl i32 %40, 1
  store i32 %shl90, ptr %Ebuffer89, align 8
  %41 = load i32, ptr %Ebits_to_go93, align 4
  %dec94 = add i32 %41, -1
  store i32 %dec94, ptr %Ebits_to_go93, align 4
...
if.then97:                                        ; preds = %if.then88
  ...
  %42 = load ptr, ptr %Ecodestrm100, align 8
  %43 = load ptr, ptr %Ecodestrm_len101, align 8
  %44 = load i32, ptr %43, align 4
  %inc102 = add nsw i32 %44, 1
  store i32 %inc102, ptr %43, align 4
  ...
  store i32 8, ptr %Ebits_to_go93, align 4
  %C107.promoted = load i32, ptr %C107, align 8
...
while.body110.lr.ph:                              ; preds = %if.then97
  %E113.promoted = load i32, ptr %E113, align 4
...
while.body121:                                    ; preds = %if.end116, %if.end151
  ...
  %dec123 = add i32 %56, -1
  store i32 %dec123, ptr %Ebits_to_follow154, align 8
  %57 = load i32, ptr %Ebuffer89, align 8
  %shl125 = shl i32 %57, 1
  %or127 = or i32 %shl125, 1
  store i32 %or127, ptr %Ebuffer89, align 8
  %dec129 = add i32 %55, -1
  store i32 %dec129, ptr %Ebits_to_go93, align 4
...
if.then132:                                       ; preds = %while.body121
  ...
  %58 = load ptr, ptr %Ecodestrm100, align 8
  %59 = load ptr, ptr %Ecodestrm_len101, align 8
  %60 = load i32, ptr %59, align 4
  %inc137 = add nsw i32 %60, 1
  store i32 %inc137, ptr %59, align 4
  %idxprom138 = sext i32 %60 to i64
  %arrayidx139 = getelementptr inbounds i8, ptr %58, i64 %idxprom138
  store i8 %conv134, ptr %arrayidx139, align 1
  store i32 8, ptr %Ebits_to_go93, align 4
  %C142.promoted = load i32, ptr %C107, align 8
...
while.body145.lr.ph:                              ; preds = %if.then132
  %E148.promoted = load i32, ptr %E113, align 4
  ...
  %68 = add i32 %65, %63
  store i32 %67, ptr %C107, align 8
  store i32 %68, ptr %E113, align 4
  br label %if.end151
...
if.end151:                                        ; preds = %if.then132, %while.body145.lr.ph, %while.body121
  ...
  %70 = load i32, ptr %Ebits_to_follow154, align 8
  %cmp119.not = icmp eq i32 %70, 0
  br i1 %cmp119.not, label %if.end158, label %while.body121

if.else153:                                       ; preds = %if.else85
  %71 = load i32, ptr %Ebits_to_follow154, align 8
  %inc155 = add i32 %71, 1
  store i32 %inc155, ptr %Ebits_to_follow154, align 8
...
if.end158:                                        ; preds = %if.end151, %if.end116, %if.else153, %while.end83
  ...
  br i1 %cmp27, label %while.body, label %while.end161
...
while.end161:                                     ; preds = %if.end158, %if.end26
  ...
  store i32 %range.1.lcssa, ptr %Erange, align 4
  store i32 %low.1.lcssa, ptr %eep, align 8
  %C164 = getelementptr inbounds %struct.EncodingEnvironment, ptr %eep, i64 0, i32 7
  %72 = load i32, ptr %C164, align 8
  %inc165 = add nsw i32 %72, 1
  store i32 %inc165, ptr %C164, align 8
  ret void
}
...
if.then4:                                         ; preds = %if.end
  %Ebuffer = getelementptr inbounds %struct.EncodingEnvironment, ptr %eep, i64 0, i32 2
  %2 = load i32, ptr %Ebuffer, align 8
  %shl5 = shl i32 %2, 1
  %or = or i32 %shl5, 1
  store i32 %or, ptr %Ebuffer, align 8
  %Ebits_to_go = getelementptr inbounds %struct.EncodingEnvironment, ptr %eep, i64 0, i32 3
...
if.then9:                                         ; preds = %if.then4
  ...
  %Ecodestrm = getelementptr inbounds %struct.EncodingEnvironment, ptr %eep, i64 0, i32 5
  %4 = load ptr, ptr %Ecodestrm, align 8
  %Ecodestrm_len = getelementptr inbounds %struct.EncodingEnvironment, ptr %eep, i64 0, i32 6
  %5 = load ptr, ptr %Ecodestrm_len, align 8
...
if.end17:                                         ; preds = %if.then9, %while.body.lr.ph, %if.then4
  ...
  %Ebits_to_follow = getelementptr inbounds %struct.EncodingEnvironment, ptr %eep, i64 0, i32 4
  %16 = load i32, ptr %Ebits_to_follow, align 8
...
while.body21:                                     ; preds = %while.body21.lr.ph, %if.end51
  ...
  %dec23 = add i32 %18, -1
  store i32 %dec23, ptr %Ebits_to_follow, align 8
  %19 = load i32, ptr %Ebuffer, align 8
  %shl25 = shl i32 %19, 1
  store i32 %shl25, ptr %Ebuffer, align 8
  %dec29 = add i32 %17, -1
  store i32 %dec29, ptr %Ebits_to_go, align 4
...
if.then32:                                        ; preds = %while.body21
  ...
  %20 = load ptr, ptr %Ecodestrm35, align 8
  %21 = load ptr, ptr %Ecodestrm_len36, align 8
  %22 = load i32, ptr %21, align 4
  %inc37 = add nsw i32 %22, 1
  store i32 %inc37, ptr %21, align 4
  ...
  store i32 8, ptr %Ebits_to_go, align 4
  %C42.promoted = load i32, ptr %C42, align 8
...
while.body45.lr.ph:                               ; preds = %if.then32
  %E48.promoted = load i32, ptr %E48, align 4
  ...
  %30 = add i32 %27, %25
  store i32 %29, ptr %C42, align 8
  store i32 %30, ptr %E48, align 4
  br label %if.end51

if.end51:                                         ; preds = %if.then32, %while.body45.lr.ph, %while.body21
  %31 = phi i32 [ 8, %if.then32 ], [ 8, %while.body45.lr.ph ], [ %dec29, %while.body21 ]
  %32 = load i32, ptr %Ebits_to_follow, align 8
  %cmp19.not = icmp eq i32 %32, 0
  br i1 %cmp19.not, label %while.end52, label %while.body21
...
if.then56:                                        ; preds = %if.else
  ...
  %33 = load i32, ptr %Ebuffer57, align 8
  %shl58 = shl i32 %33, 1
  store i32 %shl58, ptr %Ebuffer57, align 8
  %Ebits_to_go61 = getelementptr inbounds %struct.EncodingEnvironment, ptr %eep, i64 0, i32 3
  %34 = load i32, ptr %Ebits_to_go61, align 4
  %dec62 = add i32 %34, -1
  store i32 %dec62, ptr %Ebits_to_go61, align 4
...
while.body78.lr.ph:                               ; preds = %if.then65
  ...
  %E81.promoted = load i32, ptr %E81, align 4
  ...
  %45 = add i32 %42, 1
  store i32 %44, ptr %C75, align 8
  store i32 %45, ptr %E81, align 4
  br label %if.end84
...
if.end84:                                         ; preds = %if.then65, %while.body78.lr.ph, %if.then56
  ...
  %47 = load i32, ptr %Ebits_to_follow86, align 8
...
while.body89:                                     ; preds = %while.body89.lr.ph, %if.end119
  ...
  %dec91 = add i32 %49, -1
  store i32 %dec91, ptr %Ebits_to_follow86, align 8
  %50 = load i32, ptr %Ebuffer57, align 8
  %shl93 = shl i32 %50, 1
  %or95 = or i32 %shl93, 1
  store i32 %or95, ptr %Ebuffer57, align 8
  %dec97 = add i32 %48, -1
  store i32 %dec97, ptr %Ebits_to_go61, align 4
...
if.then100:                                       ; preds = %while.body89
  ...
  %51 = load ptr, ptr %Ecodestrm103, align 8
  %52 = load ptr, ptr %Ecodestrm_len104, align 8
  %53 = load i32, ptr %52, align 4
  %inc105 = add nsw i32 %53, 1
  store i32 %inc105, ptr %52, align 4
  ...
  store i32 8, ptr %Ebits_to_go61, align 4
  %C110.promoted = load i32, ptr %C110, align 8
...
while.body113.lr.ph:                              ; preds = %if.then100
  %E116.promoted = load i32, ptr %E116, align 4
  ...
  %60 = sub nsw i32 %59, %57
  %61 = add i32 %58, %56
  store i32 %60, ptr %C110, align 8
  store i32 %61, ptr %E116, align 4
  br label %if.end119
...
if.end119:                                        ; preds = %if.then100, %while.body113.lr.ph, %while.body89
  ...
  %63 = load i32, ptr %Ebits_to_follow86, align 8
  %cmp87.not = icmp eq i32 %63, 0
  br i1 %cmp87.not, label %if.end126, label %while.body89

if.else121:                                       ; preds = %if.else
  %Ebits_to_follow122 = getelementptr inbounds %struct.EncodingEnvironment, ptr %eep, i64 0, i32 4
  %64 = load i32, ptr %Ebits_to_follow122, align 8
  %inc123 = add i32 %64, 1
  store i32 %inc123, ptr %Ebits_to_follow122, align 8
...
if.then2:                                         ; preds = %while.body
  %2 = load i32, ptr %Ebuffer55, align 8
  %shl = shl i32 %2, 1
  %or = or i32 %shl, 1
  store i32 %or, ptr %Ebuffer55, align 8
  %3 = load i32, ptr %Ebits_to_go59, align 4
  %dec = add i32 %3, -1
  store i32 %dec, ptr %Ebits_to_go59, align 4
  %cmp4 = icmp eq i32 %dec, 0
  br i1 %cmp4, label %if.then5, label %if.end15

if.then5:                                         ; preds = %if.then2
  %conv = trunc i32 %or to i8
  %4 = load ptr, ptr %Ecodestrm66, align 8
  %5 = load ptr, ptr %Ecodestrm_len67, align 8
  %6 = load i32, ptr %5, align 4
  %inc = add nsw i32 %6, 1
  store i32 %inc, ptr %5, align 4
  %idxprom = sext i32 %6 to i64
...
while.body19:                                     ; preds = %if.end15, %if.end49
  ...
  %dec21 = add i32 %18, -1
  store i32 %dec21, ptr %Ebits_to_follow120, align 8
  %19 = load i32, ptr %Ebuffer55, align 8
  %shl23 = shl i32 %19, 1
  store i32 %shl23, ptr %Ebuffer55, align 8
  %dec27 = add i32 %17, -1
  store i32 %dec27, ptr %Ebits_to_go59, align 4
...
if.then30:                                        ; preds = %while.body19
  ...
  %20 = load ptr, ptr %Ecodestrm66, align 8
  %21 = load ptr, ptr %Ecodestrm_len67, align 8
  %22 = load i32, ptr %21, align 4
  %inc35 = add nsw i32 %22, 1
  store i32 %inc35, ptr %21, align 4
  %idxprom36 = sext i32 %22 to i64
  %arrayidx37 = getelementptr inbounds i8, ptr %20, i64 %idxprom36
  store i8 %conv32, ptr %arrayidx37, align 1
  store i32 8, ptr %Ebits_to_go59, align 4
  %C40.promoted = load i32, ptr %C73, align 8
...
while.body43.lr.ph:                               ; preds = %if.then30
  %E46.promoted = load i32, ptr %E79, align 4
  ...
  %29 = sub nsw i32 %28, %26
  %30 = add i32 %27, %25
  store i32 %29, ptr %C73, align 8
  store i32 %30, ptr %E79, align 4
  br label %if.end49

if.end49:                                         ; preds = %if.then30, %while.body43.lr.ph, %while.body19
  %31 = phi i32 [ 8, %if.then30 ], [ 8, %while.body43.lr.ph ], [ %dec27, %while.body19 ]
  %32 = load i32, ptr %Ebits_to_follow120, align 8
  %cmp17.not = icmp eq i32 %32, 0
  br i1 %cmp17.not, label %while.end50, label %while.body19
...
if.then54:                                        ; preds = %if.else
  %33 = load i32, ptr %Ebuffer55, align 8
  %shl56 = shl i32 %33, 1
  store i32 %shl56, ptr %Ebuffer55, align 8
  %34 = load i32, ptr %Ebits_to_go59, align 4
  %dec60 = add i32 %34, -1
  store i32 %dec60, ptr %Ebits_to_go59, align 4
  %cmp61 = icmp eq i32 %dec60, 0
  br i1 %cmp61, label %if.then63, label %if.end82

if.then63:                                        ; preds = %if.then54
  %conv65 = trunc i32 %shl56 to i8
  %35 = load ptr, ptr %Ecodestrm66, align 8
  %36 = load ptr, ptr %Ecodestrm_len67, align 8
  %37 = load i32, ptr %36, align 4
  %inc68 = add nsw i32 %37, 1
  store i32 %inc68, ptr %36, align 4
...
while.body87:                                     ; preds = %if.end82, %if.end117
  ...
  %dec89 = add i32 %49, -1
  store i32 %dec89, ptr %Ebits_to_follow120, align 8
  %50 = load i32, ptr %Ebuffer55, align 8
  %shl91 = shl i32 %50, 1
  %or93 = or i32 %shl91, 1
  store i32 %or93, ptr %Ebuffer55, align 8
  %dec95 = add i32 %48, -1
  store i32 %dec95, ptr %Ebits_to_go59, align 4
...
if.then98:                                        ; preds = %while.body87
  ...
  %51 = load ptr, ptr %Ecodestrm66, align 8
  %52 = load ptr, ptr %Ecodestrm_len67, align 8
  %53 = load i32, ptr %52, align 4
  %inc103 = add nsw i32 %53, 1
  store i32 %inc103, ptr %52, align 4
  %idxprom104 = sext i32 %53 to i64
  %arrayidx105 = getelementptr inbounds i8, ptr %51, i64 %idxprom104
  store i8 %conv100, ptr %arrayidx105, align 1
  store i32 8, ptr %Ebits_to_go59, align 4
  %C108.promoted = load i32, ptr %C73, align 8
...
while.body111.lr.ph:                              ; preds = %if.then98
  %E114.promoted = load i32, ptr %E79, align 4
  ...
  %60 = sub nsw i32 %59, %57
  %61 = add i32 %58, %56
  store i32 %60, ptr %C73, align 8
  store i32 %61, ptr %E79, align 4
  br label %if.end117
...
if.end117:                                        ; preds = %if.then98, %while.body111.lr.ph, %while.body87
  ...
  %63 = load i32, ptr %Ebits_to_follow120, align 8
  %cmp85.not = icmp eq i32 %63, 0
  br i1 %cmp85.not, label %if.end124, label %while.body87

if.else119:                                       ; preds = %if.else
  %64 = load i32, ptr %Ebits_to_follow120, align 8
  %inc121 = add i32 %64, 1
  store i32 %inc121, ptr %Ebits_to_follow120, align 8
...
if.end124:                                        ; preds = %if.end117, %if.end82, %if.else119, %while.end50
  ...
  br i1 %cmp, label %while.body, label %while.end127
...
while.end127:                                     ; preds = %if.end124, %entry
  ...
  %65 = load i32, ptr %C130, align 8
  %inc131 = add nsw i32 %65, 1
  store i32 %inc131, ptr %C130, align 8
  ret void
}
