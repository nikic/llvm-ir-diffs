; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/rdopt_coding_state.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/rdopt_coding_state.c"
...
if.end:                                           ; preds = %if.then2, %if.then
  ...
  %1 = load ptr, ptr %bitstream, align 8
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %2 = load i32, ptr %symbol_mode, align 8
...
if.then3:                                         ; preds = %if.end
  ...
  store ptr %call5, ptr %encenv, align 8
...
if.end11:                                         ; preds = %if.end, %if.then3, %if.then8
  ...
  store ptr %call14, ptr %bitstream, align 8
...
if.end18:                                         ; preds = %if.then17, %if.end11
  ...
  %4 = load i32, ptr %symbol_mode19, align 8
  %symbol_mode20 = getelementptr inbounds %struct.CSobj, ptr %call, i64 0, i32 3
  store i32 %4, ptr %symbol_mode20, align 8
...
entry:
  ...
  %1 = load ptr, ptr %currentPicture, align 8
...
if.end:                                           ; preds = %cond.end
  ...
  %9 = load i32, ptr %symbol_mode, align 8
  %cmp = icmp eq i32 %9, 1
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %11 = load ptr, ptr %encenv, align 8
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %arrayidx5, ptr noundef nonnull align 8 dereferenceable(48) %ee_cabac, i64 48, i1 false)
  %13 = load ptr, ptr %bitstream, align 8
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %arrayidx9, ptr noundef nonnull align 8 dereferenceable(48) %15, i64 48, i1 false)
  %indvars.iv.next70 = add nuw nsw i64 %indvars.iv69, 1
  %exitcond73.not = icmp eq i64 %indvars.iv.next70, %wide.trip.count72
  br i1 %exitcond73.not, label %for.end, label %for.body

for.end:                                          ; preds = %for.body, %for.cond.preheader
  %mot_ctx = getelementptr inbounds %struct.CSobj, ptr %cs, i64 0, i32 4
  %16 = load ptr, ptr %mot_ctx, align 8
  %mot_ctx14 = getelementptr inbounds %struct.Slice, ptr %4, i64 0, i32 7
  %17 = load ptr, ptr %mot_ctx14, align 8
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1504) %16, ptr noundef nonnull align 8 dereferenceable(1504) %17, i64 1504, i1 false)
  %tex_ctx = getelementptr inbounds %struct.CSobj, ptr %cs, i64 0, i32 5
  %18 = load ptr, ptr %tex_ctx, align 8
  %tex_ctx15 = getelementptr inbounds %struct.Slice, ptr %4, i64 0, i32 8
  %19 = load ptr, ptr %tex_ctx15, align 8
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(12128) %18, ptr noundef nonnull align 8 dereferenceable(12128) %19, i64 12128, i1 false)
  br label %if.end29
...
for.body18:                                       ; preds = %for.body18, %for.body18.lr.ph.new
  ...
  %20 = load ptr, ptr %bitstream19, align 8
  %arrayidx21 = getelementptr inbounds %struct.Bitstream, ptr %20, i64 %indvars.iv
  %21 = load ptr, ptr %partArr22, align 8
  %arrayidx24 = getelementptr inbounds %struct.datapartition, ptr %21, i64 %indvars.iv
  %22 = load ptr, ptr %arrayidx24, align 8
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %arrayidx21, ptr noundef nonnull align 8 dereferenceable(48) %22, i64 48, i1 false)
  %indvars.iv.next = or i64 %indvars.iv, 1
  %23 = load ptr, ptr %bitstream19, align 8
  %arrayidx21.1 = getelementptr inbounds %struct.Bitstream, ptr %23, i64 %indvars.iv.next
  %24 = load ptr, ptr %partArr22, align 8
  %arrayidx24.1 = getelementptr inbounds %struct.datapartition, ptr %24, i64 %indvars.iv.next
  %25 = load ptr, ptr %arrayidx24.1, align 8
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %arrayidx21.1, ptr noundef nonnull align 8 dereferenceable(48) %25, i64 48, i1 false)
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %if.end29.loopexit.unr-lcssa, label %for.body18
...
for.body18.epil:                                  ; preds = %if.end29.loopexit.unr-lcssa
  %26 = load ptr, ptr %bitstream19, align 8
  %arrayidx21.epil = getelementptr inbounds %struct.Bitstream, ptr %26, i64 %indvars.iv.unr
  %27 = load ptr, ptr %partArr22, align 8
  %arrayidx24.epil = getelementptr inbounds %struct.datapartition, ptr %27, i64 %indvars.iv.unr
  %28 = load ptr, ptr %arrayidx24.epil, align 8
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %arrayidx21.epil, ptr noundef nonnull align 8 dereferenceable(48) %28, i64 48, i1 false)
  br label %if.end29
...
if.end29:                                         ; preds = %for.body18.epil, %if.end29.loopexit.unr-lcssa, %for.cond16.preheader, %for.end
  ...
  %29 = load i64, ptr %cbp_bits, align 8
  %cbp_bits35 = getelementptr inbounds %struct.CSobj, ptr %cs, i64 0, i32 8
  store i64 %29, ptr %cbp_bits35, align 8
  br label %cleanup
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %12 = load ptr, ptr %encenv, align 8
  %arrayidx7 = getelementptr inbounds %struct.EncodingEnvironment, ptr %12, i64 %indvars.iv69
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %ee_cabac, ptr noundef nonnull align 8 dereferenceable(48) %arrayidx7, i64 48, i1 false)
  ...
  %15 = load ptr, ptr %bitstream11, align 8
  %arrayidx13 = getelementptr inbounds %struct.Bitstream, ptr %15, i64 %indvars.iv69
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %14, ptr noundef nonnull align 8 dereferenceable(48) %arrayidx13, i64 48, i1 false)
  %indvars.iv.next70 = add nuw nsw i64 %indvars.iv69, 1
  %exitcond73.not = icmp eq i64 %indvars.iv.next70, %wide.trip.count72
  br i1 %exitcond73.not, label %for.end, label %for.body
...
for.body18:                                       ; preds = %for.body18, %for.body18.lr.ph.new
  %indvars.iv = phi i64 [ 0, %for.body18.lr.ph.new ], [ %indvars.iv.next.1, %for.body18 ]
  %niter = phi i64 [ 0, %for.body18.lr.ph.new ], [ %niter.next.1, %for.body18 ]
  %20 = load ptr, ptr %partArr19, align 8
  %arrayidx21 = getelementptr inbounds %struct.datapartition, ptr %20, i64 %indvars.iv
  %21 = load ptr, ptr %arrayidx21, align 8
  %22 = load ptr, ptr %bitstream23, align 8
  %arrayidx25 = getelementptr inbounds %struct.Bitstream, ptr %22, i64 %indvars.iv
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %21, ptr noundef nonnull align 8 dereferenceable(48) %arrayidx25, i64 48, i1 false)
  %indvars.iv.next = or i64 %indvars.iv, 1
  %23 = load ptr, ptr %partArr19, align 8
  %arrayidx21.1 = getelementptr inbounds %struct.datapartition, ptr %23, i64 %indvars.iv.next
  %24 = load ptr, ptr %arrayidx21.1, align 8
  %25 = load ptr, ptr %bitstream23, align 8
  %arrayidx25.1 = getelementptr inbounds %struct.Bitstream, ptr %25, i64 %indvars.iv.next
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %24, ptr noundef nonnull align 8 dereferenceable(48) %arrayidx25.1, i64 48, i1 false)
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %if.end29.loopexit.unr-lcssa, label %for.body18
...
for.body18.epil:                                  ; preds = %if.end29.loopexit.unr-lcssa
  %26 = load ptr, ptr %partArr19, align 8
  %arrayidx21.epil = getelementptr inbounds %struct.datapartition, ptr %26, i64 %indvars.iv.unr
  %27 = load ptr, ptr %arrayidx21.epil, align 8
  %28 = load ptr, ptr %bitstream23, align 8
  %arrayidx25.epil = getelementptr inbounds %struct.Bitstream, ptr %28, i64 %indvars.iv.unr
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %27, ptr noundef nonnull align 8 dereferenceable(48) %arrayidx25.epil, i64 48, i1 false)
  br label %if.end29
