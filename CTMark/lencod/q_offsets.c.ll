...
for.inc:                                          ; preds = %for.cond34.preheader, %if.else201
  ...
  %22 = load ptr, ptr %arrayidx82.sink, align 8, !tbaa !5
  %arrayidx84 = getelementptr inbounds i16, ptr %22, i64 %15
  %23 = load i16, ptr %arrayidx84, align 2, !tbaa !19
  %conv85 = sext i16 %23 to i32
  %shl86 = shl i32 %conv85, %.sink393
  store i32 %shl86, ptr %21, align 4, !tbaa !14
...
for.inc.1:                                        ; preds = %if.else201.1, %for.inc
  ...
  %55 = load ptr, ptr %arrayidx82.sink.1, align 8, !tbaa !5
  %arrayidx84.1 = getelementptr inbounds i16, ptr %55, i64 %51
  %56 = load i16, ptr %arrayidx84.1, align 2, !tbaa !19
  %conv85.1 = sext i16 %56 to i32
  %shl86.1 = shl i32 %conv85.1, %.sink393.1
  store i32 %shl86.1, ptr %arrayidx132.1, align 4, !tbaa !14
...
for.inc.2:                                        ; preds = %if.else201.2, %for.inc.1
  ...
  %88 = load ptr, ptr %arrayidx82.sink.2, align 8, !tbaa !5
  %arrayidx84.2 = getelementptr inbounds i16, ptr %88, i64 %84
  %89 = load i16, ptr %arrayidx84.2, align 2, !tbaa !19
  %conv85.2 = sext i16 %89 to i32
  %shl86.2 = shl i32 %conv85.2, %.sink393.2
  store i32 %shl86.2, ptr %arrayidx132.2, align 4, !tbaa !14
  ...
  %117 = or i64 %15, 3
  %118 = load ptr, ptr %arrayidx87, align 8, !tbaa !5
  %arrayidx128.3 = getelementptr inbounds ptr, ptr %118, i64 %indvars.iv342
  %119 = load ptr, ptr %arrayidx128.3, align 8, !tbaa !5
  %arrayidx130.3 = getelementptr inbounds ptr, ptr %119, i64 %indvars.iv337
  %120 = load ptr, ptr %arrayidx130.3, align 8, !tbaa !5
...
for.inc.3:                                        ; preds = %if.else201.3, %for.inc.2
  ...
  %121 = load ptr, ptr %arrayidx82.sink.3, align 8, !tbaa !5
  %arrayidx84.3 = getelementptr inbounds i16, ptr %121, i64 %117
  %122 = load i16, ptr %arrayidx84.3, align 2, !tbaa !19
  %conv85.3 = sext i16 %122 to i32
  %shl86.3 = shl i32 %conv85.3, %.sink393.3
  store i32 %shl86.3, ptr %arrayidx132.3, align 4, !tbaa !14
...
if.end57:                                         ; preds = %for.cond12.preheader, %if.then31, %if.else44
  ...
  %14 = load ptr, ptr %arrayidx32.sink, align 8, !tbaa !5
  %arrayidx34 = getelementptr inbounds i16, ptr %14, i64 %7
  %15 = load i16, ptr %arrayidx34, align 2, !tbaa !19
  %conv35 = sext i16 %15 to i32
  %shl36 = shl i32 %conv35, %.sink
  store i32 %shl36, ptr %13, align 4, !tbaa !14
  ...
  %25 = load ptr, ptr %arrayidx52.1, align 8, !tbaa !5
  %arrayidx54.1 = getelementptr inbounds ptr, ptr %25, i64 %indvars.iv129
  %26 = load ptr, ptr %arrayidx54.1, align 8, !tbaa !5
...
if.end57.1:                                       ; preds = %if.else44.1, %if.then31.1, %if.end57
  ...
  %27 = load ptr, ptr %arrayidx32.sink.1, align 8, !tbaa !5
  %arrayidx34.1 = getelementptr inbounds i16, ptr %27, i64 %22
  %28 = load i16, ptr %arrayidx34.1, align 2, !tbaa !19
  %conv35.1 = sext i16 %28 to i32
  %shl36.1 = shl i32 %conv35.1, %.sink.1
  store i32 %shl36.1, ptr %arrayidx56.1, align 4, !tbaa !14
...
if.end57.2:                                       ; preds = %if.else44.2, %if.then31.2, %if.end57.1
  ...
  %40 = load ptr, ptr %arrayidx32.sink.2, align 8, !tbaa !5
  %arrayidx34.2 = getelementptr inbounds i16, ptr %40, i64 %35
  %41 = load i16, ptr %arrayidx34.2, align 2, !tbaa !19
  %conv35.2 = sext i16 %41 to i32
  %shl36.2 = shl i32 %conv35.2, %.sink.2
  store i32 %shl36.2, ptr %arrayidx56.2, align 4, !tbaa !14
...
if.end57.3:                                       ; preds = %if.else44.3, %if.then31.3, %if.end57.2
  ...
  %53 = load ptr, ptr %arrayidx32.sink.3, align 8, !tbaa !5
  %arrayidx34.3 = getelementptr inbounds i16, ptr %53, i64 %48
  %54 = load i16, ptr %arrayidx34.3, align 2, !tbaa !19
  %conv35.3 = sext i16 %54 to i32
  %shl36.3 = shl i32 %conv35.3, %.sink.3
  store i32 %shl36.3, ptr %arrayidx56.3, align 4, !tbaa !14
...
if.end57.4:                                       ; preds = %if.else44.4, %if.then31.4, %if.end57.3
  ...
  %66 = load ptr, ptr %arrayidx32.sink.4, align 8, !tbaa !5
  %arrayidx34.4 = getelementptr inbounds i16, ptr %66, i64 %61
  %67 = load i16, ptr %arrayidx34.4, align 2, !tbaa !19
  %conv35.4 = sext i16 %67 to i32
  %shl36.4 = shl i32 %conv35.4, %.sink.4
  store i32 %shl36.4, ptr %arrayidx56.4, align 4, !tbaa !14
...
if.end57.5:                                       ; preds = %if.else44.5, %if.then31.5, %if.end57.4
  ...
  %79 = load ptr, ptr %arrayidx32.sink.5, align 8, !tbaa !5
  %arrayidx34.5 = getelementptr inbounds i16, ptr %79, i64 %74
  %80 = load i16, ptr %arrayidx34.5, align 2, !tbaa !19
  %conv35.5 = sext i16 %80 to i32
  %shl36.5 = shl i32 %conv35.5, %.sink.5
  store i32 %shl36.5, ptr %arrayidx56.5, align 4, !tbaa !14
...
if.end57.6:                                       ; preds = %if.else44.6, %if.then31.6, %if.end57.5
  ...
  %92 = load ptr, ptr %arrayidx32.sink.6, align 8, !tbaa !5
  %arrayidx34.6 = getelementptr inbounds i16, ptr %92, i64 %87
  %93 = load i16, ptr %arrayidx34.6, align 2, !tbaa !19
  %conv35.6 = sext i16 %93 to i32
  %shl36.6 = shl i32 %conv35.6, %.sink.6
  store i32 %shl36.6, ptr %arrayidx56.6, align 4, !tbaa !14
  ...
  %102 = load ptr, ptr %arrayidx37, align 8, !tbaa !5
  %arrayidx52.7 = getelementptr inbounds ptr, ptr %102, i64 %indvars.iv134
  %103 = load ptr, ptr %arrayidx52.7, align 8, !tbaa !5
  %arrayidx54.7 = getelementptr inbounds ptr, ptr %103, i64 %indvars.iv129
  %104 = load ptr, ptr %arrayidx54.7, align 8, !tbaa !5
...
if.end57.7:                                       ; preds = %if.else44.7, %if.then31.7, %if.end57.6
  ...
  %105 = load ptr, ptr %arrayidx32.sink.7, align 8, !tbaa !5
  %arrayidx34.7 = getelementptr inbounds i16, ptr %105, i64 %100
  %106 = load i16, ptr %arrayidx34.7, align 2, !tbaa !19
  %conv35.7 = sext i16 %106 to i32
  %shl36.7 = shl i32 %conv35.7, %.sink.7
  store i32 %shl36.7, ptr %arrayidx56.7, align 4, !tbaa !14
