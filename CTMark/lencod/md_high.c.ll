; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/md_high.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/md_high.c"
...
cond.true:                                        ; preds = %lor.end22
  ...
  %9 = load ptr, ptr %mb_data28, align 8
...
cond.end:                                         ; preds = %lor.end22, %cond.true
  ...
  %11 = load i32, ptr %SearchMode, align 4
...
if.end37:                                         ; preds = %cond.end, %if.then36, %if.then
  ...
  %13 = load i32, ptr %current_mb_nr38, align 4
...
if.end48:                                         ; preds = %if.then47, %if.then45
  ...
  %17 = load i32, ptr %CtxAdptLagrangeMult, align 4
...
if.end52:                                         ; preds = %if.then51, %if.end48
  ...
  %arrayidx89.11009 = getelementptr inbounds [3 x i32], ptr %lambda_mf, i64 0, i64 1
...
for.cond68.preheader:                             ; preds = %if.then60, %for.inc203
  ...
  %cmp65950 = phi i1 [ false, %if.then60 ], [ true, %for.inc203 ]
...
cond.end86:                                       ; preds = %for.cond68.preheader
  ...
  %.pre978 = load i32, ptr %CtxAdptLagrangeMult72.1.phi.trans.insert, align 4
  store i32 %conv85, ptr %lambda_mf, align 4
...
cond.end86.1.thread:                              ; preds = %cond.end86, %cond.end86.thread
  %25 = load i32, ptr %arrayidx78.1, align 4
  store i32 %25, ptr %arrayidx89.11009, align 4
  br label %cond.true75.2

cond.end86.1:                                     ; preds = %cond.end86
  %26 = load i32, ptr %arrayidx82.1, align 4
  %conv83.1 = sitofp i32 %26 to double
  %27 = load double, ptr @lambda_mf_factor, align 8
  ...
  %.pre980 = load i32, ptr %CtxAdptLagrangeMult72.2.phi.trans.insert, align 4
  store i32 %conv85.1, ptr %arrayidx89.1, align 4
  %cmp73.2 = icmp eq i32 %.pre980, 0
  br i1 %cmp73.2, label %cond.true75.2, label %cond.false79.2

cond.false79.2:                                   ; preds = %cond.end86.1
  %28 = load i32, ptr %arrayidx82.2, align 8
...
if.then108:                                       ; preds = %cond.end86.2
  store i32 2147483647, ptr %arrayidx109, align 4
  ...
  %33 = load i32, ptr %BiPredMotionEstimation, align 8
  %tobool114 = icmp ne i32 %33, 0
  %or.cond = and i1 %cmp62, %tobool114
...
if.else121:                                       ; preds = %if.then108
  store i32 2147483647, ptr %arrayidx122, align 4
  store i32 2147483647, ptr %arrayidx123, align 16
  br label %if.end124
...
if.end124:                                        ; preds = %if.else121, %if.then118
  ...
  %.pre981 = load i8, ptr %best_pdir, align 1
  br label %if.end129

if.else127:                                       ; preds = %cond.end86.2
  store i8 0, ptr %best_pdir, align 1
  %34 = load i32, ptr %bmcost, align 16
  %35 = load i32, ptr %cost, align 4
...
if.end129:                                        ; preds = %if.else127, %if.end124
  ...
  %37 = load i16, ptr %list_offset, align 2
  %conv131 = sext i16 %37 to i32
  %38 = load i8, ptr %best_ref, align 2
  %conv133 = sext i8 %38 to i32
  %39 = load i8, ptr %arrayidx134, align 1
  ...
  %40 = load i8, ptr %best_ref, align 2
...
if.then139:                                       ; preds = %if.end129
  ...
  store i8 %40, ptr %arrayidx143, align 1
  %arrayidx145 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 3, i64 %indvars.iv
  store i8 %40, ptr %arrayidx145, align 1
  %42 = load i8, ptr %best_pdir, align 1
  %arrayidx148 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 3, i64 %41
  store i8 %42, ptr %arrayidx148, align 1
  %arrayidx150 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 3, i64 %indvars.iv
  store i8 %42, ptr %arrayidx150, align 1
  %43 = load i8, ptr %arrayidx134, align 1
  %arrayidx154 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 3, i64 %41
  store i8 %43, ptr %arrayidx154, align 1
  %arrayidx156 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 3, i64 %indvars.iv
  store i8 %43, ptr %arrayidx156, align 1
  br label %if.end190

if.then160:                                       ; preds = %if.end129
  %44 = shl nuw nsw i64 %indvars.iv, 1
  %45 = or i64 %44, 1
  %arrayidx165 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 2, i64 %45
  store i8 %40, ptr %arrayidx165, align 1
  %arrayidx168 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 2, i64 %44
  store i8 %40, ptr %arrayidx168, align 2
  %46 = load i8, ptr %best_pdir, align 1
  %arrayidx172 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 2, i64 %45
  store i8 %46, ptr %arrayidx172, align 1
  %arrayidx175 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 2, i64 %44
  store i8 %46, ptr %arrayidx175, align 2
  %47 = load i8, ptr %arrayidx134, align 1
  %arrayidx180 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 2, i64 %45
  store i8 %47, ptr %arrayidx180, align 1
  %arrayidx183 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 2, i64 %44
  store i8 %47, ptr %arrayidx183, align 2
  br label %if.end190

if.else184:                                       ; preds = %if.end129
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(4) getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 1), i8 %40, i64 4, i1 false)
  %48 = load i8, ptr %arrayidx134, align 1
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(4) getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 1), i8 %48, i64 4, i1 false)
  %49 = load i8, ptr %best_pdir, align 1
  %50 = insertelement <4 x i8> poison, i8 %49, i64 0
  %51 = shufflevector <4 x i8> %50, <4 x i8> poison, <4 x i32> zeroinitializer
  store <4 x i8> %51, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 1), align 4
  br label %if.end190

if.end190:                                        ; preds = %if.then160, %if.else184, %if.then139
  %52 = phi i8 [ %47, %if.then160 ], [ %48, %if.else184 ], [ %43, %if.then139 ]
  %53 = phi i8 [ %46, %if.then160 ], [ %49, %if.else184 ], [ %42, %if.then139 ]
  %or.cond719 = and i1 %cmp191, %cmp194
  br i1 %or.cond719, label %if.then196, label %for.inc203

if.then196:                                       ; preds = %if.end190
  %conv197 = sext i8 %53 to i32
  %conv199 = sext i8 %40 to i32
  %conv201 = sext i8 %52 to i32
...
for.inc203:                                       ; preds = %if.end190, %if.then196
  %cmp65.not = or i1 %cmp62, %cmp65950
  br i1 %cmp65.not, label %for.end205, label %for.cond68.preheader

for.end205:                                       ; preds = %for.inc203
  %54 = load i32, ptr %cost, align 4
  %cmp206 = icmp slt i32 %54, %min_cost.0940
  br i1 %cmp206, label %if.then208, label %for.inc217

if.then208:                                       ; preds = %for.end205
  %conv209 = trunc i64 %indvars.iv957 to i16
  store i16 %conv209, ptr @best_mode, align 2
  %55 = load ptr, ptr @input, align 8
  %CtxAdptLagrangeMult210 = getelementptr inbounds %struct.InputParameters, ptr %55, i64 0, i32 114
  %56 = load i32, ptr %CtxAdptLagrangeMult210, align 4
  %cmp211 = icmp eq i32 %56, 1
  br i1 %cmp211, label %if.then213, label %for.inc217

if.then213:                                       ; preds = %if.then208
  call void @adjust_mb16x16_cost(i32 noundef %54) #6
  br label %for.inc217

for.inc217:                                       ; preds = %for.body, %if.then208, %if.then213, %for.end205
  %min_cost.1 = phi i32 [ %54, %if.then213 ], [ %54, %if.then208 ], [ %min_cost.0940, %for.end205 ], [ %min_cost.0940, %for.body ]
  %indvars.iv.next958 = add nuw nsw i64 %indvars.iv957, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next958, 4
  br i1 %exitcond.not, label %for.end219, label %for.body

for.end219:                                       ; preds = %for.inc217
  %arrayidx221 = getelementptr inbounds %struct.RD_PARAMS, ptr %enc_mb, i64 0, i32 3, i64 8
  %57 = load i16, ptr %arrayidx221, align 4
...
if.then223:                                       ; preds = %for.end219
  ...
  %58 = load ptr, ptr @cs_mb, align 8
  call void @store_coding_state(ptr noundef %58) #6
  ...
  %Transform8x8Mode = getelementptr inbounds %struct.InputParameters, ptr %59, i64 0, i32 153
  %60 = load i32, ptr %Transform8x8Mode, align 4
...
if.end252:                                        ; preds = %if.then223
  ...
  store i32 0, ptr %cost_direct, align 4
  %61 = load ptr, ptr @cofAC_8x8ts, align 8
  %62 = load ptr, ptr %61, align 8
  call void @submacroblock_mode_decision(ptr noundef nonnull byval(%struct.RD_PARAMS) align 8 %enc_mb, ptr noundef nonnull @tr8x8, ptr noundef nonnull %arrayidx, ptr noundef %62, ptr noundef nonnull %have_direct, i16 noundef signext %conv5, i32 noundef 0, ptr noundef nonnull %cost_direct, ptr noundef nonnull %cost, ptr noundef nonnull %cost8x8_direct, i32 noundef 1) #6
  %63 = load i16, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 5, i64 0), align 4
  store i16 %63, ptr @best8x8mode, align 2
  %64 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 6, i64 0), align 4
  store i8 %64, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 8, i64 0), align 16
  %65 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 7, i64 0), align 4
  store i8 %65, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 8, i64 0), align 16
  %66 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 8, i64 0), align 4
  store i8 %66, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 8, i64 0), align 16
  %67 = load ptr, ptr @cofAC_8x8ts, align 8
  %arrayidx231.1 = getelementptr inbounds ptr, ptr %67, i64 1
  %68 = load ptr, ptr %arrayidx231.1, align 8
  call void @submacroblock_mode_decision(ptr noundef nonnull byval(%struct.RD_PARAMS) align 8 %enc_mb, ptr noundef nonnull @tr8x8, ptr noundef nonnull %arrayidx, ptr noundef %68, ptr noundef nonnull %have_direct, i16 noundef signext %conv5, i32 noundef 1, ptr noundef nonnull %cost_direct, ptr noundef nonnull %cost, ptr noundef nonnull %cost8x8_direct, i32 noundef 1) #6
  %69 = load i16, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 5, i64 1), align 2
  store i16 %69, ptr getelementptr inbounds ([4 x i16], ptr @best8x8mode, i64 0, i64 1), align 2
  %70 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 6, i64 1), align 1
  store i8 %70, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 8, i64 1), align 1
  %71 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 7, i64 1), align 1
  store i8 %71, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 8, i64 1), align 1
  %72 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 8, i64 1), align 1
  store i8 %72, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 8, i64 1), align 1
  %73 = load ptr, ptr @cofAC_8x8ts, align 8
  %arrayidx231.2 = getelementptr inbounds ptr, ptr %73, i64 2
  %74 = load ptr, ptr %arrayidx231.2, align 8
  call void @submacroblock_mode_decision(ptr noundef nonnull byval(%struct.RD_PARAMS) align 8 %enc_mb, ptr noundef nonnull @tr8x8, ptr noundef nonnull %arrayidx, ptr noundef %74, ptr noundef nonnull %have_direct, i16 noundef signext %conv5, i32 noundef 2, ptr noundef nonnull %cost_direct, ptr noundef nonnull %cost, ptr noundef nonnull %cost8x8_direct, i32 noundef 1) #6
  %75 = load i16, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 5, i64 2), align 4
  store i16 %75, ptr getelementptr inbounds ([4 x i16], ptr @best8x8mode, i64 0, i64 2), align 2
  %76 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 6, i64 2), align 2
  store i8 %76, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 8, i64 2), align 2
  %77 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 7, i64 2), align 2
  store i8 %77, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 8, i64 2), align 2
  %78 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 8, i64 2), align 2
  store i8 %78, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 8, i64 2), align 2
  %79 = load ptr, ptr @cofAC_8x8ts, align 8
  %arrayidx231.3 = getelementptr inbounds ptr, ptr %79, i64 3
  %80 = load ptr, ptr %arrayidx231.3, align 8
  call void @submacroblock_mode_decision(ptr noundef nonnull byval(%struct.RD_PARAMS) align 8 %enc_mb, ptr noundef nonnull @tr8x8, ptr noundef nonnull %arrayidx, ptr noundef %80, ptr noundef nonnull %have_direct, i16 noundef signext %conv5, i32 noundef 3, ptr noundef nonnull %cost_direct, ptr noundef nonnull %cost, ptr noundef nonnull %cost8x8_direct, i32 noundef 1) #6
  %81 = load i16, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 5, i64 3), align 2
  store i16 %81, ptr getelementptr inbounds ([4 x i16], ptr @best8x8mode, i64 0, i64 3), align 2
  %82 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 6, i64 3), align 1
  store i8 %82, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 8, i64 3), align 1
  %83 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 7, i64 3), align 1
  store i8 %83, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 8, i64 3), align 1
  %84 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 8, i64 3), align 1
  store i8 %84, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 8, i64 3), align 1
  %85 = load i32, ptr @cbp8x8, align 4
  store i32 %85, ptr @cbp8_8x8ts, align 4
  %86 = load i32, ptr @cbp_blk8x8, align 4
  %conv251 = sext i32 %86 to i64
  store i64 %conv251, ptr @cbp_blk8_8x8ts, align 8
  %87 = load i32, ptr @cnt_nonz_8x8, align 4
  store i32 %87, ptr @cnt_nonz8_8x8ts, align 4
...
if.then256:                                       ; preds = %if.then223, %if.end252
  ...
  store i32 0, ptr @cbp8x8, align 4
  store i32 0, ptr %cost_direct, align 4
  %88 = load ptr, ptr @cofAC8x8, align 8
  %89 = load ptr, ptr %88, align 8
  call void @submacroblock_mode_decision(ptr noundef nonnull byval(%struct.RD_PARAMS) align 8 %enc_mb, ptr noundef nonnull @tr4x4, ptr noundef nonnull %arrayidx, ptr noundef %89, ptr noundef nonnull %have_direct, i16 noundef signext %conv5, i32 noundef 0, ptr noundef nonnull %cost_direct, ptr noundef nonnull %cost, ptr noundef nonnull %cost8x8_direct, i32 noundef 0) #6
  %90 = load i16, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 5, i64 0), align 4
  store i16 %90, ptr @best8x8mode, align 2
  %91 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 6, i64 0), align 4
  store i8 %91, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 8, i64 0), align 16
  %92 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 7, i64 0), align 4
  store i8 %92, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 8, i64 0), align 16
  %93 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 8, i64 0), align 4
  store i8 %93, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 8, i64 0), align 16
  %94 = load ptr, ptr @cofAC8x8, align 8
  %arrayidx262.1 = getelementptr inbounds ptr, ptr %94, i64 1
  %95 = load ptr, ptr %arrayidx262.1, align 8
  call void @submacroblock_mode_decision(ptr noundef nonnull byval(%struct.RD_PARAMS) align 8 %enc_mb, ptr noundef nonnull @tr4x4, ptr noundef nonnull %arrayidx, ptr noundef %95, ptr noundef nonnull %have_direct, i16 noundef signext %conv5, i32 noundef 1, ptr noundef nonnull %cost_direct, ptr noundef nonnull %cost, ptr noundef nonnull %cost8x8_direct, i32 noundef 0) #6
  %96 = load i16, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 5, i64 1), align 2
  store i16 %96, ptr getelementptr inbounds ([4 x i16], ptr @best8x8mode, i64 0, i64 1), align 2
  %97 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 6, i64 1), align 1
  store i8 %97, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 8, i64 1), align 1
  %98 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 7, i64 1), align 1
  store i8 %98, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 8, i64 1), align 1
  %99 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 8, i64 1), align 1
  store i8 %99, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 8, i64 1), align 1
  %100 = load ptr, ptr @cofAC8x8, align 8
  %arrayidx262.2 = getelementptr inbounds ptr, ptr %100, i64 2
  %101 = load ptr, ptr %arrayidx262.2, align 8
  call void @submacroblock_mode_decision(ptr noundef nonnull byval(%struct.RD_PARAMS) align 8 %enc_mb, ptr noundef nonnull @tr4x4, ptr noundef nonnull %arrayidx, ptr noundef %101, ptr noundef nonnull %have_direct, i16 noundef signext %conv5, i32 noundef 2, ptr noundef nonnull %cost_direct, ptr noundef nonnull %cost, ptr noundef nonnull %cost8x8_direct, i32 noundef 0) #6
  %102 = load i16, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 5, i64 2), align 4
  store i16 %102, ptr getelementptr inbounds ([4 x i16], ptr @best8x8mode, i64 0, i64 2), align 2
  %103 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 6, i64 2), align 2
  store i8 %103, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 8, i64 2), align 2
  %104 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 7, i64 2), align 2
  store i8 %104, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 8, i64 2), align 2
  %105 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 8, i64 2), align 2
  store i8 %105, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 8, i64 2), align 2
  %106 = load ptr, ptr @cofAC8x8, align 8
  %arrayidx262.3 = getelementptr inbounds ptr, ptr %106, i64 3
  %107 = load ptr, ptr %arrayidx262.3, align 8
  call void @submacroblock_mode_decision(ptr noundef nonnull byval(%struct.RD_PARAMS) align 8 %enc_mb, ptr noundef nonnull @tr4x4, ptr noundef nonnull %arrayidx, ptr noundef %107, ptr noundef nonnull %have_direct, i16 noundef signext %conv5, i32 noundef 3, ptr noundef nonnull %cost_direct, ptr noundef nonnull %cost, ptr noundef nonnull %cost8x8_direct, i32 noundef 0) #6
  %108 = load i16, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 5, i64 3), align 2
  store i16 %108, ptr getelementptr inbounds ([4 x i16], ptr @best8x8mode, i64 0, i64 3), align 2
  %109 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 6, i64 3), align 1
  store i8 %109, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 8, i64 3), align 1
  %110 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 7, i64 3), align 1
  store i8 %110, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 8, i64 3), align 1
  %111 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 8, i64 3), align 1
  store i8 %111, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 8, i64 3), align 1
  br label %if.end282

if.end282:                                        ; preds = %if.then256, %if.end252
  %112 = load ptr, ptr @cs_mb, align 8
  call void @reset_coding_state(ptr noundef %112) #6
  %113 = load ptr, ptr @input, align 8
  %RCEnable = getelementptr inbounds %struct.InputParameters, ptr %113, i64 0, i32 157
  %114 = load i32, ptr %RCEnable, align 4
  %tobool283.not = icmp eq i32 %114, 0
  br i1 %tobool283.not, label %if.end286, label %if.then284

if.then284:                                       ; preds = %if.end282
  %115 = load ptr, ptr @img, align 8
  %opix_x = getelementptr inbounds %struct.ImageParameters, ptr %115, i64 0, i32 43
  %116 = load i32, ptr %opix_x, align 8
  %opix_y = getelementptr inbounds %struct.ImageParameters, ptr %115, i64 0, i32 44
  %117 = load i32, ptr %opix_y, align 4
  %mpr = getelementptr inbounds %struct.ImageParameters, ptr %115, i64 0, i32 51
  call void @rc_store_diff(i32 noundef %116, i32 noundef %117, ptr noundef nonnull %mpr) #6
  br label %if.end286
...
if.end293:                                        ; preds = %if.end37, %if.end288, %if.then290
  ...
  %BiPredMotionEstimation294 = getelementptr inbounds %struct.InputParameters, ptr %118, i64 0, i32 46
  %119 = load i32, ptr %BiPredMotionEstimation294, align 8
  %tobool295.not = icmp eq i32 %119, 0
  %.pre984 = load ptr, ptr @img, align 8
...
if.then296:                                       ; preds = %if.end293
  ...
  store i16 0, ptr %arrayidx298, align 2
  br label %if.end299

if.end299:                                        ; preds = %if.then296, %if.end293
  %yuv_format = getelementptr inbounds %struct.ImageParameters, ptr %.pre984, i64 0, i32 160
  %120 = load i32, ptr %yuv_format, align 8
  %cmp300.not = icmp eq i32 %120, 0
...
if.then302:                                       ; preds = %if.end299
  ...
  %FastCrIntraDecision = getelementptr inbounds %struct.InputParameters, ptr %121, i64 0, i32 115
  %122 = load i32, ptr %FastCrIntraDecision, align 8
  %tobool303.not = icmp eq i32 %122, 0
...
if.then304:                                       ; preds = %if.then302
  ...
  %123 = load i32, ptr %c_ipred_mode, align 8
  br label %if.end312

if.end312:                                        ; preds = %if.end299, %if.then302, %if.then304
  %min_chroma_pred_mode.0 = phi i32 [ %123, %if.then304 ], [ 0, %if.then302 ], [ 0, %if.end299 ]
  %max_chroma_pred_mode.0 = phi i32 [ %123, %if.then304 ], [ 3, %if.then302 ], [ 0, %if.end299 ]
  ...
  store i32 %conv313, ptr %c_ipred_mode, align 8
...
for.body320.lr.ph:                                ; preds = %if.end312
  ...
  %.pre992 = load ptr, ptr @img, align 8
  %.pre988.pre.pre.pre = load ptr, ptr @input, align 8
  br label %for.body320

for.body320:                                      ; preds = %for.body320.lr.ph, %for.inc577
  %.pre988.pre.pre = phi ptr [ %.pre988.pre.pre.pre, %for.body320.lr.ph ], [ %.pre988.pre.pre1001, %for.inc577 ]
  %.pre987 = phi ptr [ %.pre992, %for.body320.lr.ph ], [ %.pre987993, %for.inc577 ]
  %124 = phi ptr [ %.pre992, %for.body320.lr.ph ], [ %230, %for.inc577 ]
  %storemerge949 = phi i32 [ %conv313, %for.body320.lr.ph ], [ %inc579, %for.inc577 ]
  %yuv_format321 = getelementptr inbounds %struct.ImageParameters, ptr %124, i64 0, i32 160
  %125 = load i32, ptr %yuv_format321, align 8
  %cmp322.not = icmp eq i32 %125, 0
...
lor.lhs.false:                                    ; preds = %land.lhs.true324
  %IntraDisableInterOnly = getelementptr inbounds %struct.InputParameters, ptr %.pre988.pre.pre, i64 0, i32 84
  %126 = load i32, ptr %IntraDisableInterOnly, align 8
  %tobool326.not = icmp eq i32 %126, 0
  br i1 %tobool326.not, label %land.lhs.true327, label %lor.lhs.false334

land.lhs.true327:                                 ; preds = %lor.lhs.false, %land.lhs.true324
  %ChromaIntraDisable = getelementptr inbounds %struct.InputParameters, ptr %.pre988.pre.pre, i64 0, i32 90
  %127 = load i32, ptr %ChromaIntraDisable, align 8
  %cmp328 = icmp eq i32 %127, 1
...
lor.lhs.false334:                                 ; preds = %land.lhs.true327, %lor.lhs.false
  ...
  %128 = load i32, ptr %mb_available_up, align 4
  %tobool339 = icmp ne i32 %128, 0
...
lor.lhs.false340:                                 ; preds = %lor.lhs.false334
  ...
  %129 = load i32, ptr %mb_available_left, align 4
  %tobool345 = icmp ne i32 %129, 0
...
land.lhs.true350:                                 ; preds = %lor.lhs.false346
  ...
  %130 = load i32, ptr %mb_available_up_left, align 4
  %tobool355 = icmp ne i32 %130, 0
...
for.body361:                                      ; preds = %for.body361.preheader, %for.inc574
  %.pre988.pre.pre1004 = phi ptr [ %.pre988.pre.pre1002, %for.inc574 ], [ %.pre988.pre.pre, %for.body361.preheader ]
  %.pre988 = phi ptr [ %.pre988998, %for.inc574 ], [ %.pre988.pre.pre, %for.body361.preheader ]
  %.pre987996 = phi ptr [ %.pre987994, %for.inc574 ], [ %.pre987, %for.body361.preheader ]
  %131 = phi ptr [ %228, %for.inc574 ], [ %.pre987, %for.body361.preheader ]
  %132 = phi ptr [ %229, %for.inc574 ], [ %.pre987, %for.body361.preheader ]
  ...
  %133 = load i32, ptr %arrayidx363, align 4
  %cmp371 = icmp eq i32 %133, 1
  %or.cond724 = and i1 %cmp3, %cmp371
  br i1 %or.cond724, label %if.then376, label %if.end404

if.then376:                                       ; preds = %for.body361
  %conv377 = trunc i32 %ctr16x16.0946 to i8
  %BiPredMotionEstimation381 = getelementptr inbounds %struct.InputParameters, ptr %.pre988, i64 0, i32 46
  ...
  %134 = load i32, ptr %BiPredMotionEstimation381, align 8
  %tobool382 = icmp ne i32 %134, 0
...
land.lhs.true386:                                 ; preds = %if.then376
  %arrayidx389 = getelementptr inbounds %struct.ImageParameters, ptr %132, i64 0, i32 83, i64 1
  %135 = load i16, ptr %arrayidx389, align 2
  %cmp391 = icmp slt i16 %135, 2
...
if.end404:                                        ; preds = %if.end397, %for.body361
  %ctr16x16.2 = phi i32 [ %inc403, %if.end397 ], [ %ctr16x16.0946, %for.body361 ]
  %index.2 = phi i32 [ %spec.select919, %if.end397 ], [ %index.0947, %for.body361 ]
  %SkipIntraInInterSlices = getelementptr inbounds %struct.InputParameters, ptr %.pre988, i64 0, i32 67
  %136 = load i32, ptr %SkipIntraInInterSlices, align 8
  %tobool405 = icmp ne i32 %136, 0
  %cmp409 = icmp sgt i32 %133, 9
  %137 = and i1 %cmp409, %tobool405
  %or.cond728 = and i1 %tobool44, %137
  %138 = load i16, ptr @best_mode, align 2
  %cmp413 = icmp slt i16 %138, 4
...
land.lhs.true415:                                 ; preds = %if.end404
  %139 = load i32, ptr %cbp, align 4
  %cmp416 = icmp eq i32 %139, 0
...
land.lhs.true422:                                 ; preds = %if.end419
  %140 = load ptr, ptr @active_pps, align 8
  %weighted_bipred_idc = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %140, i64 0, i32 20
  %141 = load i32, ptr %weighted_bipred_idc, align 4
  %cmp423 = icmp eq i32 %141, 1
  %cmp426 = icmp slt i32 %133, 8
  %or.cond730 = and i1 %cmp426, %cmp423
  br i1 %or.cond730, label %for.cond429.preheader, label %if.end534

for.cond429.preheader:                            ; preds = %land.lhs.true422
  %idxprom433 = sext i32 %133 to i64
  %142 = load ptr, ptr @active_sps, align 8
  %chroma_format_idc = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %142, i64 0, i32 8
  %143 = load ptr, ptr @wbp_weight, align 8
  %arrayidx465 = getelementptr inbounds ptr, ptr %143, i64 1
  %arrayidx436 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 %idxprom433, i64 0
  %144 = load i8, ptr %arrayidx436, align 4
  %cmp438 = icmp eq i8 %144, 2
  br i1 %cmp438, label %for.cond441.preheader, label %for.inc498

for.cond441.preheader:                            ; preds = %for.cond429.preheader
  %145 = load i32, ptr %chroma_format_idc, align 4
  %cmp442.not = icmp eq i32 %145, 0
  %146 = load ptr, ptr %143, align 8
  %arrayidx452 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 %idxprom433, i64 0
  %147 = load i8, ptr %arrayidx452, align 4
  %idxprom454 = sext i8 %147 to i64
  %arrayidx455 = getelementptr inbounds ptr, ptr %146, i64 %idxprom454
  %148 = load ptr, ptr %arrayidx455, align 8
  %arrayidx459 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 %idxprom433, i64 0
  %149 = load i8, ptr %arrayidx459, align 4
  %idxprom461 = sext i8 %149 to i64
  %arrayidx462 = getelementptr inbounds ptr, ptr %148, i64 %idxprom461
  %150 = load ptr, ptr %arrayidx462, align 8
  %151 = load ptr, ptr %arrayidx465, align 8
  %arrayidx472 = getelementptr inbounds ptr, ptr %151, i64 %idxprom454
  %152 = load ptr, ptr %arrayidx472, align 8
  %arrayidx479 = getelementptr inbounds ptr, ptr %152, i64 %idxprom461
  %153 = load ptr, ptr %arrayidx479, align 8
  %154 = load i32, ptr %150, align 4
  %155 = load i32, ptr %153, align 4
  %add482 = add i32 %154, -128
  %156 = add i32 %add482, %155
  %or.cond731 = icmp ult i32 %156, -256
  br i1 %or.cond731, label %if.then503, label %for.cond441

for.cond441:                                      ; preds = %for.cond441.preheader
  br i1 %cmp442.not, label %for.inc498, label %for.body447.11028

for.body447.11028:                                ; preds = %for.cond441
  %arrayidx464.11024 = getelementptr inbounds i32, ptr %150, i64 1
  %157 = load i32, ptr %arrayidx464.11024, align 4
  %arrayidx481.11025 = getelementptr inbounds i32, ptr %153, i64 1
  %158 = load i32, ptr %arrayidx481.11025, align 4
  %add482.11026 = add i32 %157, -128
  %159 = add i32 %add482.11026, %158
  %or.cond731.11027 = icmp ult i32 %159, -256
  br i1 %or.cond731.11027, label %if.then503, label %for.cond441.11032

for.cond441.11032:                                ; preds = %for.body447.11028
  br i1 %cmp442.not, label %for.inc498, label %for.body447.21038

for.body447.21038:                                ; preds = %for.cond441.11032
  %arrayidx464.21034 = getelementptr inbounds i32, ptr %150, i64 2
  %160 = load i32, ptr %arrayidx464.21034, align 4
  %arrayidx481.21035 = getelementptr inbounds i32, ptr %153, i64 2
  %161 = load i32, ptr %arrayidx481.21035, align 4
  %add482.21036 = add i32 %160, -128
  %162 = add i32 %add482.21036, %161
  %or.cond731.21037 = icmp ult i32 %162, -256
  br i1 %or.cond731.21037, label %if.then503, label %for.inc498

for.inc498:                                       ; preds = %for.cond441, %for.cond441.11032, %for.body447.21038, %for.cond429.preheader
  %arrayidx436.1 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 %idxprom433, i64 1
  %163 = load i8, ptr %arrayidx436.1, align 1
  %cmp438.1 = icmp eq i8 %163, 2
  br i1 %cmp438.1, label %for.cond441.preheader.1, label %for.inc498.1

for.cond441.preheader.1:                          ; preds = %for.inc498
  %164 = load i32, ptr %chroma_format_idc, align 4
  %cmp442.1.not = icmp eq i32 %164, 0
  %165 = load ptr, ptr %143, align 8
  %arrayidx452.1 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 %idxprom433, i64 1
  %166 = load i8, ptr %arrayidx452.1, align 1
  %idxprom454.1 = sext i8 %166 to i64
  %arrayidx455.1 = getelementptr inbounds ptr, ptr %165, i64 %idxprom454.1
  %167 = load ptr, ptr %arrayidx455.1, align 8
  %arrayidx459.1 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 %idxprom433, i64 1
  %168 = load i8, ptr %arrayidx459.1, align 1
  %idxprom461.1 = sext i8 %168 to i64
  %arrayidx462.1 = getelementptr inbounds ptr, ptr %167, i64 %idxprom461.1
  %169 = load ptr, ptr %arrayidx462.1, align 8
  %170 = load ptr, ptr %arrayidx465, align 8
  %arrayidx472.1 = getelementptr inbounds ptr, ptr %170, i64 %idxprom454.1
  %171 = load ptr, ptr %arrayidx472.1, align 8
  %arrayidx479.1 = getelementptr inbounds ptr, ptr %171, i64 %idxprom461.1
  %172 = load ptr, ptr %arrayidx479.1, align 8
  %173 = load i32, ptr %169, align 4
  %174 = load i32, ptr %172, align 4
  %add482.1 = add i32 %173, -128
  %175 = add i32 %add482.1, %174
  %or.cond731.1 = icmp ult i32 %175, -256
  br i1 %or.cond731.1, label %if.then503, label %for.cond441.1

for.cond441.1:                                    ; preds = %for.cond441.preheader.1
  br i1 %cmp442.1.not, label %for.inc498.1, label %for.body447.1.1

for.body447.1.1:                                  ; preds = %for.cond441.1
  %arrayidx464.1.1 = getelementptr inbounds i32, ptr %169, i64 1
  %176 = load i32, ptr %arrayidx464.1.1, align 4
  %arrayidx481.1.1 = getelementptr inbounds i32, ptr %172, i64 1
  %177 = load i32, ptr %arrayidx481.1.1, align 4
  %add482.1.1 = add i32 %176, -128
  %178 = add i32 %add482.1.1, %177
  %or.cond731.1.1 = icmp ult i32 %178, -256
  br i1 %or.cond731.1.1, label %if.then503, label %for.cond441.1.1

for.cond441.1.1:                                  ; preds = %for.body447.1.1
  br i1 %cmp442.1.not, label %for.inc498.1, label %for.body447.1.2

for.body447.1.2:                                  ; preds = %for.cond441.1.1
  %arrayidx464.1.2 = getelementptr inbounds i32, ptr %169, i64 2
  %179 = load i32, ptr %arrayidx464.1.2, align 4
  %arrayidx481.1.2 = getelementptr inbounds i32, ptr %172, i64 2
  %180 = load i32, ptr %arrayidx481.1.2, align 4
  %add482.1.2 = add i32 %179, -128
  %181 = add i32 %add482.1.2, %180
  %or.cond731.1.2 = icmp ult i32 %181, -256
...
for.inc498.1:                                     ; preds = %for.cond441.1, %for.cond441.1.1, %for.body447.1.2, %for.inc498
  ...
  %182 = load i8, ptr %arrayidx436.2, align 2
  %cmp438.2 = icmp eq i8 %182, 2
  br i1 %cmp438.2, label %for.cond441.preheader.2, label %for.inc498.2

for.cond441.preheader.2:                          ; preds = %for.inc498.1
  %183 = load i32, ptr %chroma_format_idc, align 4
  %cmp442.2.not = icmp eq i32 %183, 0
  %184 = load ptr, ptr %143, align 8
  %arrayidx452.2 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 %idxprom433, i64 2
  %185 = load i8, ptr %arrayidx452.2, align 2
  %idxprom454.2 = sext i8 %185 to i64
  %arrayidx455.2 = getelementptr inbounds ptr, ptr %184, i64 %idxprom454.2
  %186 = load ptr, ptr %arrayidx455.2, align 8
  %arrayidx459.2 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 %idxprom433, i64 2
  %187 = load i8, ptr %arrayidx459.2, align 2
  %idxprom461.2 = sext i8 %187 to i64
  %arrayidx462.2 = getelementptr inbounds ptr, ptr %186, i64 %idxprom461.2
  %188 = load ptr, ptr %arrayidx462.2, align 8
  %189 = load ptr, ptr %arrayidx465, align 8
  %arrayidx472.2 = getelementptr inbounds ptr, ptr %189, i64 %idxprom454.2
  %190 = load ptr, ptr %arrayidx472.2, align 8
  %arrayidx479.2 = getelementptr inbounds ptr, ptr %190, i64 %idxprom461.2
  %191 = load ptr, ptr %arrayidx479.2, align 8
  %192 = load i32, ptr %188, align 4
  %193 = load i32, ptr %191, align 4
  %add482.2 = add i32 %192, -128
  %194 = add i32 %add482.2, %193
  %or.cond731.2 = icmp ult i32 %194, -256
  br i1 %or.cond731.2, label %if.then503, label %for.cond441.2

for.cond441.2:                                    ; preds = %for.cond441.preheader.2
  br i1 %cmp442.2.not, label %for.inc498.2, label %for.body447.2.1

for.body447.2.1:                                  ; preds = %for.cond441.2
  %arrayidx464.2.1 = getelementptr inbounds i32, ptr %188, i64 1
  %195 = load i32, ptr %arrayidx464.2.1, align 4
  %arrayidx481.2.1 = getelementptr inbounds i32, ptr %191, i64 1
  %196 = load i32, ptr %arrayidx481.2.1, align 4
  %add482.2.1 = add i32 %195, -128
  %197 = add i32 %add482.2.1, %196
  %or.cond731.2.1 = icmp ult i32 %197, -256
  br i1 %or.cond731.2.1, label %if.then503, label %for.cond441.2.1

for.cond441.2.1:                                  ; preds = %for.body447.2.1
  br i1 %cmp442.2.not, label %for.inc498.2, label %for.body447.2.2

for.body447.2.2:                                  ; preds = %for.cond441.2.1
  %arrayidx464.2.2 = getelementptr inbounds i32, ptr %188, i64 2
  %198 = load i32, ptr %arrayidx464.2.2, align 4
  %arrayidx481.2.2 = getelementptr inbounds i32, ptr %191, i64 2
  %199 = load i32, ptr %arrayidx481.2.2, align 4
  %add482.2.2 = add i32 %198, -128
  %200 = add i32 %add482.2.2, %199
  %or.cond731.2.2 = icmp ult i32 %200, -256
...
for.inc498.2:                                     ; preds = %for.cond441.2, %for.cond441.2.1, %for.body447.2.2, %for.inc498.1
  ...
  %201 = load i8, ptr %arrayidx436.3, align 1
  %cmp438.3 = icmp eq i8 %201, 2
  br i1 %cmp438.3, label %for.cond441.preheader.3, label %if.end534

for.cond441.preheader.3:                          ; preds = %for.inc498.2
  %202 = load i32, ptr %chroma_format_idc, align 4
  %cmp442.3.not = icmp eq i32 %202, 0
  %203 = load ptr, ptr %143, align 8
  %arrayidx452.3 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 %idxprom433, i64 3
  %204 = load i8, ptr %arrayidx452.3, align 1
  %idxprom454.3 = sext i8 %204 to i64
  %arrayidx455.3 = getelementptr inbounds ptr, ptr %203, i64 %idxprom454.3
  %205 = load ptr, ptr %arrayidx455.3, align 8
  %arrayidx459.3 = getelementptr inbounds [15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 %idxprom433, i64 3
  %206 = load i8, ptr %arrayidx459.3, align 1
  %idxprom461.3 = sext i8 %206 to i64
  %arrayidx462.3 = getelementptr inbounds ptr, ptr %205, i64 %idxprom461.3
  %207 = load ptr, ptr %arrayidx462.3, align 8
  %208 = load ptr, ptr %arrayidx465, align 8
  %arrayidx472.3 = getelementptr inbounds ptr, ptr %208, i64 %idxprom454.3
  %209 = load ptr, ptr %arrayidx472.3, align 8
  %arrayidx479.3 = getelementptr inbounds ptr, ptr %209, i64 %idxprom461.3
  %210 = load ptr, ptr %arrayidx479.3, align 8
  %211 = load i32, ptr %207, align 4
  %212 = load i32, ptr %210, align 4
  %add482.3 = add i32 %211, -128
  %213 = add i32 %add482.3, %212
  %or.cond731.3 = icmp ult i32 %213, -256
  br i1 %or.cond731.3, label %if.then503, label %for.cond441.3

for.cond441.3:                                    ; preds = %for.cond441.preheader.3
  br i1 %cmp442.3.not, label %if.end534, label %for.body447.3.1

for.body447.3.1:                                  ; preds = %for.cond441.3
  %arrayidx464.3.1 = getelementptr inbounds i32, ptr %207, i64 1
  %214 = load i32, ptr %arrayidx464.3.1, align 4
  %arrayidx481.3.1 = getelementptr inbounds i32, ptr %210, i64 1
  %215 = load i32, ptr %arrayidx481.3.1, align 4
  %add482.3.1 = add i32 %214, -128
  %216 = add i32 %add482.3.1, %215
  %or.cond731.3.1 = icmp ult i32 %216, -256
  br i1 %or.cond731.3.1, label %if.then503, label %for.cond441.3.1

for.cond441.3.1:                                  ; preds = %for.body447.3.1
  br i1 %cmp442.3.not, label %if.end534, label %for.body447.3.2

for.body447.3.2:                                  ; preds = %for.cond441.3.1
  %arrayidx464.3.2 = getelementptr inbounds i32, ptr %207, i64 2
  %217 = load i32, ptr %arrayidx464.3.2, align 4
  %arrayidx481.3.2 = getelementptr inbounds i32, ptr %210, i64 2
  %218 = load i32, ptr %arrayidx481.3.2, align 4
  %add482.3.2 = add i32 %217, -128
  %219 = add i32 %add482.3.2, %218
  %or.cond731.3.2 = icmp ult i32 %219, -256
  br i1 %or.cond731.3.2, label %if.then503, label %if.end534

if.then503:                                       ; preds = %for.cond441.preheader, %for.body447.11028, %for.body447.21038, %for.cond441.preheader.1, %for.body447.1.1, %for.body447.1.2, %for.cond441.preheader.2, %for.body447.2.1, %for.body447.2.2, %for.cond441.preheader.3, %for.body447.3.1, %for.body447.3.2
  %BiPredMotionEstimation504 = getelementptr inbounds %struct.InputParameters, ptr %.pre988, i64 0, i32 46
  %220 = load i32, ptr %BiPredMotionEstimation504, align 8
  %tobool505 = icmp ne i32 %220, 0
...
land.lhs.true509:                                 ; preds = %if.then503
  %arrayidx512 = getelementptr inbounds %struct.ImageParameters, ptr %132, i64 0, i32 83, i64 %idxprom433
  %221 = load i16, ptr %arrayidx512, align 2
  %cmp514 = icmp slt i16 %221, 2
  %or.cond733 = and i1 %cmp371, %cmp514
...
if.end534:                                        ; preds = %for.cond441.3, %for.cond441.3.1, %for.body447.3.2, %for.inc498.2, %land.lhs.true422, %if.end419
  %idxprom536 = sext i32 %133 to i64
  %arrayidx537 = getelementptr inbounds %struct.RD_PARAMS, ptr %enc_mb, i64 0, i32 3, i64 %idxprom536
  %222 = load i16, ptr %arrayidx537, align 2
  %tobool538.not = icmp eq i16 %222, 0
  br i1 %tobool538.not, label %if.end540, label %if.then539

if.then539:                                       ; preds = %if.end534
  call void @compute_mode_RD_cost(i32 noundef %133, ptr noundef %arrayidx, ptr noundef nonnull byval(%struct.RD_PARAMS) align 8 %enc_mb, ptr noundef nonnull %min_rdcost, ptr noundef nonnull %min_rate, i32 noundef 0, i16 noundef signext %conv5, ptr noundef nonnull %inter_skip) #6
  %.pre986 = load ptr, ptr @img, align 8
  %.pre989 = load ptr, ptr @input, align 8
  br label %if.end540

if.end540:                                        ; preds = %if.then539, %if.end534
  %.pre988.pre.pre1003 = phi ptr [ %.pre989, %if.then539 ], [ %.pre988.pre.pre1004, %if.end534 ]
  %.pre988999 = phi ptr [ %.pre989, %if.then539 ], [ %.pre988, %if.end534 ]
  %.pre987995 = phi ptr [ %.pre986, %if.then539 ], [ %.pre987996, %if.end534 ]
  %223 = phi ptr [ %.pre986, %if.then539 ], [ %131, %if.end534 ]
  %224 = phi ptr [ %.pre986, %if.then539 ], [ %132, %if.end534 ]
  %BiPredMotionEstimation541 = getelementptr inbounds %struct.InputParameters, ptr %.pre988999, i64 0, i32 46
  %225 = load i32, ptr %BiPredMotionEstimation541, align 8
  %tobool542 = icmp ne i32 %225, 0
...
land.lhs.true549:                                 ; preds = %if.end540
  %arrayidx552 = getelementptr inbounds %struct.ImageParameters, ptr %223, i64 0, i32 83, i64 %idxprom536
  %226 = load i16, ptr %arrayidx552, align 2
  %cmp554 = icmp slt i16 %226, 2
  %or.cond736 = and i1 %cmp371, %cmp554
  %227 = load i8, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 1), align 4
  %cmp561 = icmp eq i8 %227, 2
...
for.inc574.sink.split:                            ; preds = %land.lhs.true549, %land.lhs.true509
  %.sink = phi i16 [ %221, %land.lhs.true509 ], [ %226, %land.lhs.true549 ]
  %arrayidx512.sink = phi ptr [ %arrayidx512, %land.lhs.true509 ], [ %arrayidx552, %land.lhs.true549 ]
  %.pre988.pre.pre1002.ph = phi ptr [ %.pre988.pre.pre1004, %land.lhs.true509 ], [ %.pre988.pre.pre1003, %land.lhs.true549 ]
  %.pre988998.ph = phi ptr [ %.pre988, %land.lhs.true509 ], [ %.pre988999, %land.lhs.true549 ]
  %.pre987994.ph = phi ptr [ %.pre987996, %land.lhs.true509 ], [ %.pre987995, %land.lhs.true549 ]
  %.ph = phi ptr [ %131, %land.lhs.true509 ], [ %223, %land.lhs.true549 ]
  %.ph1015 = phi ptr [ %132, %land.lhs.true509 ], [ %223, %land.lhs.true549 ]
  %add524 = add nsw i16 %.sink, 1
  store i16 %add524, ptr %arrayidx512.sink, align 2
  br label %for.inc574

for.inc574:                                       ; preds = %for.inc574.sink.split, %if.then503, %land.lhs.true509, %if.end540, %land.lhs.true549, %land.lhs.true415
  %.pre988.pre.pre1002 = phi ptr [ %.pre988.pre.pre1004, %if.then503 ], [ %.pre988.pre.pre1004, %land.lhs.true509 ], [ %.pre988.pre.pre1003, %if.end540 ], [ %.pre988.pre.pre1003, %land.lhs.true549 ], [ %.pre988.pre.pre1004, %land.lhs.true415 ], [ %.pre988.pre.pre1002.ph, %for.inc574.sink.split ]
  %.pre988998 = phi ptr [ %.pre988, %if.then503 ], [ %.pre988, %land.lhs.true509 ], [ %.pre988999, %if.end540 ], [ %.pre988999, %land.lhs.true549 ], [ %.pre988, %land.lhs.true415 ], [ %.pre988998.ph, %for.inc574.sink.split ]
  ...
  %228 = phi ptr [ %131, %if.then503 ], [ %131, %land.lhs.true509 ], [ %223, %if.end540 ], [ %223, %land.lhs.true549 ], [ %131, %land.lhs.true415 ], [ %.ph, %for.inc574.sink.split ]
  %229 = phi ptr [ %132, %if.then503 ], [ %132, %land.lhs.true509 ], [ %224, %if.end540 ], [ %223, %land.lhs.true549 ], [ %132, %land.lhs.true415 ], [ %.ph1015, %for.inc574.sink.split ]
  %inc575 = add nsw i32 %index.2, 1
  %cmp359 = icmp slt i32 %index.2, 8
  br i1 %cmp359, label %for.body361, label %for.inc577.loopexit

for.inc577.loopexit:                              ; preds = %for.inc574
  %.pre990 = load i32, ptr %c_ipred_mode, align 8
  br label %for.inc577

for.inc577:                                       ; preds = %for.inc577.loopexit, %land.lhs.true330, %land.lhs.true350, %lor.lhs.false334, %lor.lhs.false340
  %.pre988.pre.pre1001 = phi ptr [ %.pre988.pre.pre1002, %for.inc577.loopexit ], [ %.pre988.pre.pre, %land.lhs.true330 ], [ %.pre988.pre.pre, %land.lhs.true350 ], [ %.pre988.pre.pre, %lor.lhs.false334 ], [ %.pre988.pre.pre, %lor.lhs.false340 ]
  ...
  %230 = phi ptr [ %228, %for.inc577.loopexit ], [ %124, %land.lhs.true330 ], [ %124, %land.lhs.true350 ], [ %124, %lor.lhs.false334 ], [ %124, %lor.lhs.false340 ]
  %231 = phi i32 [ %.pre990, %for.inc577.loopexit ], [ %storemerge949, %land.lhs.true330 ], [ 3, %land.lhs.true350 ], [ 2, %lor.lhs.false334 ], [ 1, %lor.lhs.false340 ]
  %inc579 = add nsw i32 %231, 1
  store i32 %inc579, ptr %c_ipred_mode, align 8
  %cmp318.not.not = icmp slt i32 %231, %conv317
  br i1 %cmp318.not.not, label %for.body320, label %for.end580
...
for.end580:                                       ; preds = %for.inc577, %if.end312
  ...
  %232 = load i32, ptr %mb_type, align 8
  %233 = add i32 %232, -9
  %switch.and = and i32 %233, -6
  %switch.selectcmp = icmp eq i32 %switch.and, 0
  %lor.ext596 = zext i1 %switch.selectcmp to i32
  %234 = load i32, ptr @cbp, align 4
  %cmp597 = icmp ne i32 %234, 0
  %235 = load i16, ptr @best_mode, align 2
  %cmp601 = icmp eq i16 %235, 10
  %or.cond738 = select i1 %cmp597, i1 true, i1 %cmp601
  %cmp605 = icmp ne i16 %235, 14
...
if.else608:                                       ; preds = %for.end580
  %cmp609 = icmp eq i32 %234, 0
  br i1 %cmp609, label %land.lhs.true611, label %lor.lhs.false614

land.lhs.true611:                                 ; preds = %if.else608
  %236 = load ptr, ptr @input, align 8
  %RCEnable612 = getelementptr inbounds %struct.InputParameters, ptr %236, i64 0, i32 157
  %237 = load i32, ptr %RCEnable612, align 4
  %tobool613 = icmp eq i32 %237, 0
  %cmp616 = icmp eq i16 %235, 14
...
if.end623:                                        ; preds = %if.end623.sink.split, %lor.lhs.false614, %land.lhs.true611
  ...
  %RCEnable624 = getelementptr inbounds %struct.InputParameters, ptr %241, i64 0, i32 157
  %242 = load i32, ptr %RCEnable624, align 4
  %tobool625.not = icmp eq i32 %242, 0
  br i1 %tobool625.not, label %if.end627, label %if.then626

if.then626:                                       ; preds = %if.end623
  %243 = load i16, ptr @best_mode, align 2
  call void @update_rc(ptr noundef nonnull %arrayidx, i16 noundef signext %243) #6
  br label %if.end627

if.end627:                                        ; preds = %if.then626, %if.end623
  %244 = load double, ptr %min_rdcost, align 8
  %245 = load ptr, ptr @rdopt, align 8
  store double %244, ptr %245, align 8
  %246 = load ptr, ptr @img, align 8
  %MbaffFrameFlag = getelementptr inbounds %struct.ImageParameters, ptr %246, i64 0, i32 100
  %247 = load i32, ptr %MbaffFrameFlag, align 4
  %tobool629.not = icmp eq i32 %247, 0
  br i1 %tobool629.not, label %if.end662, label %land.lhs.true630

land.lhs.true630:                                 ; preds = %if.end627
  %current_mb_nr631 = getelementptr inbounds %struct.ImageParameters, ptr %246, i64 0, i32 3
  %248 = load i32, ptr %current_mb_nr631, align 4
  %249 = and i32 %248, 1
  %tobool632.not = icmp eq i32 %249, 0
  br i1 %tobool632.not, label %if.end662, label %land.lhs.true633

land.lhs.true633:                                 ; preds = %land.lhs.true630
  %250 = load i32, ptr %mb_type, align 8
  %tobool635.not = icmp eq i32 %250, 0
...
cond.true640:                                     ; preds = %cond.false637
  ...
  %251 = load i32, ptr %cbp641, align 4
  %tobool642.not = icmp eq i32 %251, 0
...
land.lhs.true644:                                 ; preds = %cond.true640
  ...
  %252 = load i32, ptr %mb_type645, align 8
  %tobool646.not = icmp eq i32 %252, 0
...
land.lhs.true644.thread:                          ; preds = %cond.false637
  ...
  %253 = load i32, ptr %mb_type645936, align 8
  %tobool646.not937 = icmp eq i32 %253, 0
...
cond.true651:                                     ; preds = %land.lhs.true644
  ...
  %254 = load i32, ptr %cbp652, align 4
  %tobool653.not = icmp eq i32 %254, 0
...
land.lhs.true655:                                 ; preds = %land.lhs.true644.thread, %cond.true651
  ...
  %255 = load i16, ptr %curr_mb_field, align 2
  %conv657 = sext i16 %255 to i32
  %cmp658 = icmp eq i32 %call656, %conv657
  br i1 %cmp658, label %if.end662, label %if.then660

if.then660:                                       ; preds = %land.lhs.true655
  %256 = load ptr, ptr @rdopt, align 8
  store double 1.000000e+30, ptr %256, align 8
  br label %if.end662
...
if.end662:                                        ; preds = %land.lhs.true644.thread, %land.lhs.true644, %land.lhs.true633, %if.then660, %land.lhs.true655, %cond.true651, %cond.true640, %land.lhs.true630, %if.end627
  ...
  %RestrictRef = getelementptr inbounds %struct.InputParameters, ptr %257, i64 0, i32 128
  %258 = load i32, ptr %RestrictRef, align 4
  %tobool663.not = icmp eq i32 %258, 0
...
if.then664:                                       ; preds = %if.end662
  ...
  %.pre991 = load ptr, ptr @input, align 8
  br label %if.end666

if.end666:                                        ; preds = %if.then664, %if.end662
  %259 = phi ptr [ %.pre991, %if.then664 ], [ %257, %if.end662 ]
  %SearchMode667 = getelementptr inbounds %struct.InputParameters, ptr %259, i64 0, i32 169
  %260 = load i32, ptr %SearchMode667, align 4
  switch i32 %260, label %if.end687 [
    i32 1, label %if.then670
    i32 2, label %if.then680
  ]

if.then670:                                       ; preds = %if.end666
  %261 = load i16, ptr @best_mode, align 2
  %conv671 = sext i16 %261 to i32
  %list_offset672 = getelementptr inbounds %struct.RD_PARAMS, ptr %enc_mb, i64 0, i32 4
  %262 = load i16, ptr %list_offset672, align 2
  %idxprom674 = sext i16 %262 to i64
  %arrayidx675 = getelementptr inbounds [6 x i32], ptr @listXsize, i64 0, i64 %idxprom674
  %263 = load i32, ptr %arrayidx675, align 4
  call void @UMHEX_skip_intrabk_SAD(i32 noundef %conv671, i32 noundef %263) #6
  br label %if.end687

if.then680:                                       ; preds = %if.end666
  %264 = load i16, ptr @best_mode, align 2
  %conv681 = sext i16 %264 to i32
  %list_offset682 = getelementptr inbounds %struct.RD_PARAMS, ptr %enc_mb, i64 0, i32 4
  %265 = load i16, ptr %list_offset682, align 2
  %idxprom684 = sext i16 %265 to i64
  %arrayidx685 = getelementptr inbounds [6 x i32], ptr @listXsize, i64 0, i64 %idxprom684
  %266 = load i32, ptr %arrayidx685, align 4
  call void @smpUMHEX_skip_intrabk_SAD(i32 noundef %conv681, i32 noundef %266) #6
  br label %if.end687

if.end687:                                        ; preds = %if.end666, %if.then680, %if.then670
  %267 = load ptr, ptr @input, align 8
  %UseConstrainedIntraPred = getelementptr inbounds %struct.InputParameters, ptr %267, i64 0, i32 23
  %268 = load i32, ptr %UseConstrainedIntraPred, align 8
  %tobool688.not = icmp eq i32 %268, 0
  br i1 %tobool688.not, label %if.end718, label %land.lhs.true689

land.lhs.true689:                                 ; preds = %if.end687
  %269 = load ptr, ptr @img, align 8
  %type690 = getelementptr inbounds %struct.ImageParameters, ptr %269, i64 0, i32 5
  %270 = load i32, ptr %type690, align 4
  %switch920 = icmp ult i32 %270, 2
  br i1 %switch920, label %if.then697, label %if.end718

if.then697:                                       ; preds = %land.lhs.true689
  %271 = load i32, ptr %mb_type, align 8
  switch i32 %271, label %lor.rhs709 [
...
lor.rhs709:                                       ; preds = %if.then697
  %cmp711 = icmp eq i32 %271, 14
  %272 = zext i1 %cmp711 to i32
  br label %lor.end713

lor.end713:                                       ; preds = %if.then697, %if.then697, %if.then697, %lor.rhs709
  %lor.ext714 = phi i32 [ 1, %if.then697 ], [ %272, %lor.rhs709 ], [ 1, %if.then697 ], [ 1, %if.then697 ]
  %intra_block = getelementptr inbounds %struct.ImageParameters, ptr %269, i64 0, i32 63
  %273 = load ptr, ptr %intra_block, align 8
  %current_mb_nr715 = getelementptr inbounds %struct.ImageParameters, ptr %269, i64 0, i32 3
  %274 = load i32, ptr %current_mb_nr715, align 4
  %idxprom716 = sext i32 %274 to i64
  %arrayidx717 = getelementptr inbounds i32, ptr %273, i64 %idxprom716
  store i32 %lor.ext714, ptr %arrayidx717, align 4
  br label %if.end718
