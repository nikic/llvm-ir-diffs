; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/vlc.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/vlc.c"
...
for.body.i:                                       ; preds = %entry, %for.body.i
  ...
  br i1 %2, label %for.body.i, label %for.body.lr.ph.i
...
for.body.lr.ph.i:                                 ; preds = %for.body.i, %entry
  ...
  %sub.i12 = add nuw i32 %shl.i, 2147483647
  ...
  %.pre.i = load i8, ptr %byte_buf.i, align 8
  br label %for.body.i17

for.body.i17:                                     ; preds = %for.inc.i, %for.body.lr.ph.i
  ...
  %shl2.i = shl i8 %3, 1
  %and.i18 = and i32 %mask.030.i, %or.i
  %tobool.not.i = icmp ne i32 %and.i18, 0
  %4 = zext i1 %tobool.not.i to i8
  %spec.select = or i8 %shl2.i, %4
  store i8 %spec.select, ptr %byte_buf.i, align 8
  %5 = load i32, ptr %bits_to_go.i, align 4
  %dec.i = add nsw i32 %5, -1
  store i32 %dec.i, ptr %bits_to_go.i, align 4
  %shr.i = lshr i32 %mask.030.i, 1
  %cmp8.i = icmp eq i32 %dec.i, 0
  br i1 %cmp8.i, label %if.then10.i, label %for.inc.i

if.then10.i:                                      ; preds = %for.body.i17
  store i32 8, ptr %bits_to_go.i, align 4
  %6 = load ptr, ptr %streamBuffer.i, align 8
  %7 = load i32, ptr %bitstream, align 8
  %inc.i20 = add nsw i32 %7, 1
  store i32 %inc.i20, ptr %bitstream, align 8
...
for.inc.i:                                        ; preds = %if.then10.i, %for.body.i17
  %8 = phi i8 [ %spec.select, %for.body.i17 ], [ 0, %if.then10.i ]
  %inc15.i = add nuw nsw i32 %i.029.i, 1
  %exitcond.not = icmp eq i32 %inc15.i, %add3.i
  br i1 %exitcond.not, label %writeUVLC2buffer.exit, label %for.body.i17
...
for.end:                                          ; preds = %for.body, %entry
  ...
  store i32 %sub, ptr %info, align 4
  ret void
}
...
entry:
  ...
  store i32 %or, ptr %bitpattern, align 4
  ret i32 0
}
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %shl2 = shl i8 %2, 1
  store i8 %shl2, ptr %byte_buf, align 8
  %3 = load i32, ptr %bitpattern, align 4
...
if.then:                                          ; preds = %for.body
  %4 = or i8 %shl2, 1
  store i8 %4, ptr %byte_buf, align 8
  br label %if.end
...
if.then10:                                        ; preds = %if.end
  ...
  %7 = load ptr, ptr %streamBuffer, align 8
  %8 = load i32, ptr %currStream, align 8
  %inc = add nsw i32 %8, 1
  ...
  %.pre31 = load i32, ptr %len, align 4
  br label %for.inc
...
for.body.i:                                       ; preds = %for.body.i, %for.body.preheader.i
  ...
  br i1 %1, label %for.body.i, label %for.body.lr.ph.i
...
for.body.lr.ph.i:                                 ; preds = %for.body.i, %entry
  ...
  %sub.i14 = add nuw i32 %shl.i13, 2147483647
...
if.then10.i:                                      ; preds = %for.body.i19
  store i32 8, ptr %bits_to_go.i, align 4
  %5 = load ptr, ptr %streamBuffer.i, align 8
  %6 = load i32, ptr %bitstream, align 8
  %inc.i22 = add nsw i32 %6, 1
  store i32 %inc.i22, ptr %bitstream, align 8
...
for.inc.i:                                        ; preds = %if.then10.i, %for.body.i19
  %7 = phi i8 [ %spec.select, %for.body.i19 ], [ 0, %if.then10.i ]
  %inc15.i = add nuw nsw i32 %i.029.i, 1
  %exitcond.not = icmp eq i32 %inc15.i, %add.i
  br i1 %exitcond.not, label %writeUVLC2buffer.exit, label %for.body.i19
...
for.end:                                          ; preds = %for.body, %entry
  ...
  store i32 %add5, ptr %info, align 4
  ret void
}
...
for.body.lr.ph.i:
  ...
  %1 = and i8 %0, 1
  %2 = or i8 %shl2.i, %1
  store i8 %2, ptr %byte_buf.i, align 8
  %3 = load i32, ptr %bits_to_go.i, align 4
  %dec.i = add nsw i32 %3, -1
  store i32 %dec.i, ptr %bits_to_go.i, align 4
  %cmp8.i = icmp eq i32 %dec.i, 0
  br i1 %cmp8.i, label %for.inc.i.thread, label %writeUVLC2buffer.exit

for.inc.i.thread:                                 ; preds = %for.body.lr.ph.i
  %streamBuffer.i = getelementptr inbounds %struct.Bitstream, ptr %bitstream, i64 0, i32 9
  store i32 8, ptr %bits_to_go.i, align 4
  %4 = load ptr, ptr %streamBuffer.i, align 8
  %5 = load i32, ptr %bitstream, align 8
  %inc.i = add nsw i32 %5, 1
  store i32 %inc.i, ptr %bitstream, align 8
...
for.body.i:                                       ; preds = %for.inc.i, %for.body.lr.ph.i
  ...
  store i8 %spec.select, ptr %byte_buf.i, align 8
  %2 = load i32, ptr %bits_to_go.i, align 4
...
if.then10.i:                                      ; preds = %for.body.i
  ...
  %4 = load i32, ptr %bitstream, align 8
...
for.inc.i:                                        ; preds = %if.then10.i, %for.body.i
  ...
  br i1 %exitcond.not, label %writeUVLC2buffer.exit, label %for.body.i
...
for.body.i:                                       ; preds = %entry, %for.body.i
  ...
  br i1 %5, label %for.body.i, label %ue_linfo.exit
...
ue_linfo.exit:                                    ; preds = %for.body.i, %entry
  ...
  store i32 %sub.i, ptr %info, align 4
  ret void
}
...
for.end:                                          ; preds = %for.body, %if.end15
  ...
  store i32 %add22, ptr %info, align 4
  br label %cleanup
...
for.end:                                          ; preds = %for.body, %if.end19
  ...
  store i32 %add28, ptr %info, align 4
  br label %cleanup
...
for.body.i:                                       ; preds = %entry, %for.body.i
  ...
  br i1 %3, label %for.body.i, label %for.body.lr.ph.i
...
for.body.lr.ph.i:                                 ; preds = %for.body.i, %entry
  ...
  %shl.neg.i = shl nsw i32 -1, %i.0.lcssa.i
  %sub.i = add i32 %shl.neg.i, %add.i
  store i32 %sub.i, ptr %inf, align 4
  %shl.i = shl nuw nsw i32 1, %i.0.lcssa.i
  ...
  store i32 %or.i, ptr %bitpattern.i, align 4
...
for.body.i14:                                     ; preds = %for.inc.i, %for.body.lr.ph.i
  %5 = phi i32 [ %add3.i, %for.body.lr.ph.i ], [ %13, %for.inc.i ]
  %6 = phi i8 [ %.pre.i, %for.body.lr.ph.i ], [ %14, %for.inc.i ]
  %mask.030.i = phi i32 [ %shl.i12, %for.body.lr.ph.i ], [ %shr.i, %for.inc.i ]
  %i.029.i = phi i32 [ 0, %for.body.lr.ph.i ], [ %inc15.i, %for.inc.i ]
  %shl2.i = shl i8 %6, 1
  store i8 %shl2.i, ptr %byte_buf.i, align 8
  %7 = load i32, ptr %bitpattern.i, align 4
  %and.i15 = and i32 %7, %mask.030.i
  %tobool.not.i = icmp eq i32 %and.i15, 0
  br i1 %tobool.not.i, label %if.end.i, label %if.then.i

if.then.i:                                        ; preds = %for.body.i14
  %8 = or i8 %shl2.i, 1
  store i8 %8, ptr %byte_buf.i, align 8
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i, %for.body.i14
  %9 = phi i8 [ %8, %if.then.i ], [ %shl2.i, %for.body.i14 ]
  %10 = load i32, ptr %bits_to_go.i, align 4
...
if.then10.i:                                      ; preds = %if.end.i
  store i32 8, ptr %bits_to_go.i, align 4
  %11 = load ptr, ptr %streamBuffer.i, align 8
  %12 = load i32, ptr %4, align 8
  %inc.i17 = add nsw i32 %12, 1
  store i32 %inc.i17, ptr %4, align 8
  %idxprom.i = sext i32 %12 to i64
  %arrayidx.i = getelementptr inbounds i8, ptr %11, i64 %idxprom.i
  store i8 %9, ptr %arrayidx.i, align 1
  store i8 0, ptr %byte_buf.i, align 8
  %.pre31.i = load i32, ptr %len, align 4
  br label %for.inc.i
...
for.inc.i:                                        ; preds = %if.then10.i, %if.end.i
  ...
  %inc15.i = add nuw nsw i32 %i.029.i, 1
  %cmp.i16 = icmp slt i32 %inc15.i, %13
  br i1 %cmp.i16, label %for.body.i14, label %writeUVLC2buffer.exit

writeUVLC2buffer.exit:                            ; preds = %for.inc.i
  %15 = load i32, ptr %se, align 8
...
for.body.lr.ph.i:                                 ; preds = %for.body.i, %entry
  ...
  store i32 %add5.i, ptr %inf, align 4
...
for.body.i16:                                     ; preds = %for.inc.i, %for.body.lr.ph.i
  %4 = phi i32 [ %add.i, %for.body.lr.ph.i ], [ %12, %for.inc.i ]
  %5 = phi i8 [ %.pre.i, %for.body.lr.ph.i ], [ %13, %for.inc.i ]
  %mask.030.i = phi i32 [ %shl.i14, %for.body.lr.ph.i ], [ %shr.i, %for.inc.i ]
  %i.029.i = phi i32 [ 0, %for.body.lr.ph.i ], [ %inc15.i, %for.inc.i ]
  %shl2.i = shl i8 %5, 1
  store i8 %shl2.i, ptr %byte_buf.i, align 8
  %6 = load i32, ptr %bitpattern.i, align 4
  %and.i17 = and i32 %6, %mask.030.i
  %tobool.not.i = icmp eq i32 %and.i17, 0
  br i1 %tobool.not.i, label %if.end.i, label %if.then.i

if.then.i:                                        ; preds = %for.body.i16
  %7 = or i8 %shl2.i, 1
  store i8 %7, ptr %byte_buf.i, align 8
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i, %for.body.i16
  %8 = phi i8 [ %7, %if.then.i ], [ %shl2.i, %for.body.i16 ]
  %9 = load i32, ptr %bits_to_go.i, align 4
...
if.then10.i:                                      ; preds = %if.end.i
  store i32 8, ptr %bits_to_go.i, align 4
  %10 = load ptr, ptr %streamBuffer.i, align 8
  %11 = load i32, ptr %3, align 8
  %inc.i19 = add nsw i32 %11, 1
  store i32 %inc.i19, ptr %3, align 8
...
for.inc.i:                                        ; preds = %if.then10.i, %if.end.i
  ...
  %inc15.i = add nuw nsw i32 %i.029.i, 1
  %cmp.i18 = icmp slt i32 %inc15.i, %12
  br i1 %cmp.i18, label %for.body.i16, label %writeUVLC2buffer.exit

writeUVLC2buffer.exit:                            ; preds = %for.inc.i
  %14 = load i32, ptr %se, align 8
...
if.then:                                          ; preds = %entry, %entry, %entry
  ...
  %5 = load i32, ptr %yuv_format.i, align 8
  ...
  %6 = load i8, ptr %arrayidx2.i, align 2
...
for.body.i.i:                                     ; preds = %if.then, %for.body.i.i
  ...
  br i1 %9, label %for.body.i.i, label %cbp_linfo_intra.exit
...
if.else:                                          ; preds = %entry
  ...
  %11 = load i32, ptr %yuv_format.i27, align 8
  ...
  br i1 %cmp110.i.i33, label %for.body.i.i39, label %cbp_linfo_inter.exit

for.body.i.i39:                                   ; preds = %if.else, %for.body.i.i39
  %nn.0.in12.i.i40 = phi i32 [ %nn.0.i4.i42, %for.body.i.i39 ], [ %add.i.i32, %if.else ]
  %i.011.i.i41 = phi i32 [ %inc.i.i43, %for.body.i.i39 ], [ 0, %if.else ]
  %nn.0.i4.i42 = lshr i32 %nn.0.in12.i.i40, 1
  %inc.i.i43 = add nuw nsw i32 %i.011.i.i41, 1
  %cmp.i.i44 = icmp ult i32 %i.011.i.i41, 15
  %14 = add nsw i32 %nn.0.i4.i42, -2
  %cmp1.i.i45 = icmp ult i32 %14, -3
  %15 = select i1 %cmp.i.i44, i1 %cmp1.i.i45, i1 false
  br i1 %15, label %for.body.i.i39, label %cbp_linfo_inter.exit

cbp_linfo_inter.exit:                             ; preds = %for.body.i.i39, %if.else
  %i.0.lcssa.i.i34 = phi i32 [ 0, %if.else ], [ %inc.i.i43, %for.body.i.i39 ]
  %mul.i.i35 = shl nuw nsw i32 %i.0.lcssa.i.i34, 1
  %add3.i.i36 = or i32 %mul.i.i35, 1
  store i32 %add3.i.i36, ptr %len8, align 4
  %shl.neg.i.i37 = shl nsw i32 -1, %i.0.lcssa.i.i34
  %sub.i.i38 = add nsw i32 %shl.neg.i.i37, %add.i.i32
  store i32 %sub.i.i38, ptr %inf9, align 4
  br label %for.body.lr.ph.i

for.body.lr.ph.i:                                 ; preds = %cbp_linfo_intra.exit, %cbp_linfo_inter.exit
  %16 = phi i32 [ %sub.i.i38, %cbp_linfo_inter.exit ], [ %sub.i.i, %cbp_linfo_intra.exit ]
  %17 = phi i32 [ %add3.i.i36, %cbp_linfo_inter.exit ], [ %add3.i.i, %cbp_linfo_intra.exit ]
...
for.body.i:                                       ; preds = %for.inc.i, %for.body.lr.ph.i
  ...
  %shl2.i = shl i8 %20, 1
  store i8 %shl2.i, ptr %byte_buf.i, align 8
  %21 = load i32, ptr %bitpattern.i, align 4
...
if.then.i:                                        ; preds = %for.body.i
  %22 = or i8 %shl2.i, 1
  store i8 %22, ptr %byte_buf.i, align 8
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i, %for.body.i
  %23 = phi i8 [ %22, %if.then.i ], [ %shl2.i, %for.body.i ]
  %24 = load i32, ptr %bits_to_go.i, align 4
...
if.then10.i:                                      ; preds = %if.end.i
  store i32 8, ptr %bits_to_go.i, align 4
  %25 = load ptr, ptr %streamBuffer.i, align 8
  ...
  store i8 0, ptr %byte_buf.i, align 8
  %.pre31.i = load i32, ptr %len.i, align 4
  br label %for.inc.i
...
for.inc.i:                                        ; preds = %if.then10.i, %if.end.i
  ...
  br i1 %cmp.i, label %for.body.i, label %writeUVLC2buffer.exit

writeUVLC2buffer.exit:                            ; preds = %for.inc.i
  %29 = load i32, ptr %se, align 8
...
entry:
  ...
  %bitpattern = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 5
  store i32 %spec.select20, ptr %bitpattern, align 4
  %3 = load ptr, ptr %dp, align 8
...
for.body.i:                                       ; preds = %for.inc.i, %entry
  ...
  %shl2.i = shl i8 %5, 1
  store i8 %shl2.i, ptr %byte_buf.i, align 8
  %6 = load i32, ptr %bitpattern, align 4
...
if.then10.i:                                      ; preds = %if.end.i
  ...
  store i8 %8, ptr %arrayidx.i, align 1
  store i8 0, ptr %byte_buf.i, align 8
  %.pre31.i = load i32, ptr %1, align 4
  br label %for.inc.i
...
if.then10.i:                                      ; preds = %if.end.i
  store i32 8, ptr %bits_to_go.i, align 4
  %11 = load ptr, ptr %streamBuffer.i, align 8
  %12 = load i32, ptr %this_streamBuffer, align 8
  %inc.i = add nsw i32 %12, 1
  store i32 %inc.i, ptr %this_streamBuffer, align 8
  %idxprom.i = sext i32 %12 to i64
  %arrayidx.i = getelementptr inbounds i8, ptr %11, i64 %idxprom.i
  store i8 %9, ptr %arrayidx.i, align 1
  store i8 0, ptr %byte_buf.i, align 8
...
for.body.i:                                       ; preds = %for.inc.i, %for.body.lr.ph.i
  ...
  %shl2.i = shl i8 %2, 1
  store i8 %shl2.i, ptr %byte_buf.i, align 8
  %3 = load i32, ptr %bitpattern.i, align 4
...
if.then.i:                                        ; preds = %for.body.i
  %4 = or i8 %shl2.i, 1
  store i8 %4, ptr %byte_buf.i, align 8
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i, %for.body.i
  %5 = phi i8 [ %4, %if.then.i ], [ %shl2.i, %for.body.i ]
  %6 = load i32, ptr %bits_to_go.i, align 4
...
if.then10.i:                                      ; preds = %if.end.i
  store i32 8, ptr %bits_to_go.i, align 4
  %7 = load ptr, ptr %streamBuffer.i, align 8
  %8 = load i32, ptr %this_streamBuffer, align 8
...
for.body.lr.ph.i:
  ...
  %and = and i32 %0, 1
  %bitpattern = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 5
  store i32 %and, ptr %bitpattern, align 4
  ...
  store i32 %dec.i.peel, ptr %bits_to_go.i, align 4
...
for.inc.i.peel:                                   ; preds = %for.body.lr.ph.i
  ...
  store i32 %inc.i.peel, ptr %1, align 8
  %idxprom.i.peel = sext i32 %5 to i64
  %arrayidx.i.peel = getelementptr inbounds i8, ptr %4, i64 %idxprom.i.peel
  store i8 %spec.select, ptr %arrayidx.i.peel, align 1
  store i8 0, ptr %byte_buf.i, align 8
  %.pre31.i.peel = load i32, ptr %len, align 4
...
if.end.i:                                         ; preds = %for.inc.i.peel, %for.inc.i
  ...
  %shl2.i = shl i8 %7, 1
  store i8 %shl2.i, ptr %byte_buf.i, align 8
  %8 = load i32, ptr %bits_to_go.i, align 4
...
if.then10.i:                                      ; preds = %if.end.i
  ...
  store i8 %shl2.i, ptr %arrayidx.i, align 1
  store i8 0, ptr %byte_buf.i, align 8
  %.pre31.i = load i32, ptr %len, align 4
  br label %for.inc.i
...
for.inc.i:                                        ; preds = %if.then10.i, %if.end.i
  ...
  br i1 %cmp.i, label %if.end.i, label %writeUVLC2buffer.exit
...
for.body.lr.ph.i:
  ...
  %sub = xor i32 %and, 1
  %bitpattern = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 5
  store i32 %sub, ptr %bitpattern, align 4
  %1 = load ptr, ptr %dp, align 8
  %byte_buf.i = getelementptr inbounds %struct.Bitstream, ptr %1, i64 0, i32 2
  %bits_to_go.i = getelementptr inbounds %struct.Bitstream, ptr %1, i64 0, i32 1
  %streamBuffer.i = getelementptr inbounds %struct.Bitstream, ptr %1, i64 0, i32 9
...
for.body.i:                                       ; preds = %for.inc.i, %for.body.lr.ph.i
  ...
  %shl2.i = shl i8 %3, 1
  store i8 %shl2.i, ptr %byte_buf.i, align 8
  %4 = load i32, ptr %bitpattern.i, align 4
...
if.then.i:                                        ; preds = %for.body.i
  %5 = or i8 %shl2.i, 1
  store i8 %5, ptr %byte_buf.i, align 8
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i, %for.body.i
  %6 = phi i8 [ %5, %if.then.i ], [ %shl2.i, %for.body.i ]
  %7 = load i32, ptr %bits_to_go.i, align 4
...
while.body:                                       ; preds = %while.body, %while.body.lr.ph.new
  ...
  br i1 %niter.ncmp.3.not, label %while.end.loopexit.unr-lcssa, label %while.body
...
while.end:                                        ; preds = %while.end.loopexit.unr-lcssa, %while.body.epil, %entry
  ...
  %bitpattern = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 5
  store i32 %storemerge.lcssa, ptr %bitpattern, align 4
  ret i32 0
}
...
while.body.i.preheader:                           ; preds = %entry
  ...
  %2 = icmp ult i32 %1, 4
  br i1 %2, label %symbol2vlc.exit.unr-lcssa, label %while.body.i.preheader.new
...
symbol2vlc.exit.thread:                           ; preds = %entry
  ...
  store i32 0, ptr %bitpattern.i18, align 4
  br label %writeUVLC2buffer.exit
...
while.body.i:                                     ; preds = %while.body.i, %while.body.i.preheader.new
  ...
  %niter.next.3 = add i32 %niter, 4
  %niter.ncmp.3.not = icmp eq i32 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3.not, label %symbol2vlc.exit.unr-lcssa, label %while.body.i

symbol2vlc.exit.unr-lcssa:                        ; preds = %while.body.i, %while.body.i.preheader
  ...
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %symbol2vlc.exit, label %while.body.i.epil

while.body.i.epil:                                ; preds = %symbol2vlc.exit.unr-lcssa, %while.body.i.epil
  %info_len.011.i.epil = phi i32 [ %dec.i.epil, %while.body.i.epil ], [ %info_len.011.i.unr, %symbol2vlc.exit.unr-lcssa ]
  %storemerge10.i.epil = phi i32 [ %or.i.epil, %while.body.i.epil ], [ %storemerge10.i.unr, %symbol2vlc.exit.unr-lcssa ]
  %epil.iter = phi i32 [ %epil.iter.next, %while.body.i.epil ], [ 0, %symbol2vlc.exit.unr-lcssa ]
  ...
  %epil.iter.next = add i32 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %symbol2vlc.exit, label %while.body.i.epil

symbol2vlc.exit:                                  ; preds = %while.body.i.epil, %symbol2vlc.exit.unr-lcssa
  %or.i.lcssa = phi i32 [ %or.i.lcssa.ph, %symbol2vlc.exit.unr-lcssa ], [ %or.i.epil, %while.body.i.epil ]
  %bitpattern.i = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 5
  store i32 %or.i.lcssa, ptr %bitpattern.i, align 4
...
for.body.i:                                       ; preds = %for.inc.i, %symbol2vlc.exit
  %8 = phi i32 [ %1, %symbol2vlc.exit ], [ %16, %for.inc.i ]
  %9 = phi i8 [ %.pre.i, %symbol2vlc.exit ], [ %17, %for.inc.i ]
  %mask.030.i = phi i32 [ %shl.i12, %symbol2vlc.exit ], [ %shr.i, %for.inc.i ]
  %i.029.i = phi i32 [ 0, %symbol2vlc.exit ], [ %inc15.i, %for.inc.i ]
  %shl2.i = shl i8 %9, 1
  store i8 %shl2.i, ptr %byte_buf.i, align 8
  %10 = load i32, ptr %bitpattern.i, align 4
...
if.then.i:                                        ; preds = %for.body.i
  %11 = or i8 %shl2.i, 1
  store i8 %11, ptr %byte_buf.i, align 8
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i, %for.body.i
  %12 = phi i8 [ %11, %if.then.i ], [ %shl2.i, %for.body.i ]
  %13 = load i32, ptr %bits_to_go.i, align 4
  %dec.i15 = add nsw i32 %13, -1
  store i32 %dec.i15, ptr %bits_to_go.i, align 4
  %shr.i = lshr i32 %mask.030.i, 1
...
if.then10.i:                                      ; preds = %if.end.i
  store i32 8, ptr %bits_to_go.i, align 4
  %14 = load ptr, ptr %streamBuffer.i, align 8
...
symbol2vlc.exit.thread:                           ; preds = %if.end29
  ...
  store i32 0, ptr %bitpattern.i67, align 4
  br label %writeUVLC2buffer.exit
...
for.body.i:                                       ; preds = %for.inc.i, %symbol2vlc.exit
  %12 = phi i32 [ %10, %symbol2vlc.exit ], [ %20, %for.inc.i ]
  %13 = phi i8 [ %.pre.i, %symbol2vlc.exit ], [ %21, %for.inc.i ]
  %mask.030.i = phi i32 [ %shl.i61, %symbol2vlc.exit ], [ %shr.i, %for.inc.i ]
  %i.029.i = phi i32 [ 0, %symbol2vlc.exit ], [ %inc15.i, %for.inc.i ]
  %shl2.i = shl i8 %13, 1
  store i8 %shl2.i, ptr %byte_buf.i, align 8
  %14 = load i32, ptr %bitpattern.i, align 4
...
if.then.i:                                        ; preds = %for.body.i
  %15 = or i8 %shl2.i, 1
  store i8 %15, ptr %byte_buf.i, align 8
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i, %for.body.i
  %16 = phi i8 [ %15, %if.then.i ], [ %shl2.i, %for.body.i ]
  %17 = load i32, ptr %bits_to_go.i, align 4
  %dec.i64 = add nsw i32 %17, -1
  store i32 %dec.i64, ptr %bits_to_go.i, align 4
  %shr.i = lshr i32 %mask.030.i, 1
...
if.then10.i:                                      ; preds = %if.end.i
  store i32 8, ptr %bits_to_go.i, align 4
  %18 = load ptr, ptr %streamBuffer.i, align 8
...
for.inc.i:                                        ; preds = %if.then10.i, %if.end.i
  ...
  br i1 %cmp.i65, label %for.body.i, label %writeUVLC2buffer.exit

writeUVLC2buffer.exit:                            ; preds = %for.inc.i, %symbol2vlc.exit.thread
  %22 = phi i32 [ %6, %symbol2vlc.exit.thread ], [ %20, %for.inc.i ]
  %23 = load i32, ptr %se, align 8
...
while.body.i.preheader:                           ; preds = %if.end
  ...
  %6 = icmp ult i32 %4, 4
  br i1 %6, label %symbol2vlc.exit.unr-lcssa, label %while.body.i.preheader.new
...
symbol2vlc.exit.thread:                           ; preds = %if.end
  ...
  store i32 0, ptr %bitpattern.i43, align 4
  br label %writeUVLC2buffer.exit
...
for.body.i:                                       ; preds = %for.inc.i, %symbol2vlc.exit
  %12 = phi i32 [ %4, %symbol2vlc.exit ], [ %20, %for.inc.i ]
  %13 = phi i8 [ %.pre.i, %symbol2vlc.exit ], [ %21, %for.inc.i ]
  %mask.030.i = phi i32 [ %shl.i37, %symbol2vlc.exit ], [ %shr.i, %for.inc.i ]
  %i.029.i = phi i32 [ 0, %symbol2vlc.exit ], [ %inc15.i, %for.inc.i ]
  %shl2.i = shl i8 %13, 1
  store i8 %shl2.i, ptr %byte_buf.i, align 8
  %14 = load i32, ptr %bitpattern.i, align 4
...
if.end.i:                                         ; preds = %if.then.i, %for.body.i
  ...
  store i32 %dec.i40, ptr %bits_to_go.i, align 4
  %shr.i = lshr i32 %mask.030.i, 1
...
for.inc.i:                                        ; preds = %if.then10.i, %if.end.i
  ...
  br i1 %cmp.i41, label %for.body.i, label %writeUVLC2buffer.exit
...
while.body.i.preheader:                           ; preds = %if.end
  ...
  %4 = icmp ult i32 %2, 4
  br i1 %4, label %symbol2vlc.exit.unr-lcssa, label %while.body.i.preheader.new
...
symbol2vlc.exit.thread:                           ; preds = %if.end
  ...
  store i32 0, ptr %bitpattern.i36, align 4
  br label %writeUVLC2buffer.exit
...
for.body.i:                                       ; preds = %for.inc.i, %symbol2vlc.exit
  %10 = phi i32 [ %2, %symbol2vlc.exit ], [ %18, %for.inc.i ]
  %11 = phi i8 [ %.pre.i, %symbol2vlc.exit ], [ %19, %for.inc.i ]
  %mask.030.i = phi i32 [ %shl.i30, %symbol2vlc.exit ], [ %shr.i, %for.inc.i ]
  %i.029.i = phi i32 [ 0, %symbol2vlc.exit ], [ %inc15.i, %for.inc.i ]
  %shl2.i = shl i8 %11, 1
  store i8 %shl2.i, ptr %byte_buf.i, align 8
  %12 = load i32, ptr %bitpattern.i, align 4
...
if.then.i:                                        ; preds = %for.body.i
  %13 = or i8 %shl2.i, 1
  store i8 %13, ptr %byte_buf.i, align 8
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i, %for.body.i
  %14 = phi i8 [ %13, %if.then.i ], [ %shl2.i, %for.body.i ]
  %15 = load i32, ptr %bits_to_go.i, align 4
  %dec.i33 = add nsw i32 %15, -1
  store i32 %dec.i33, ptr %bits_to_go.i, align 4
  %shr.i = lshr i32 %mask.030.i, 1
...
if.then10.i:                                      ; preds = %if.end.i
  store i32 8, ptr %bits_to_go.i, align 4
  %16 = load ptr, ptr %streamBuffer.i, align 8
  %17 = load i32, ptr %9, align 8
  %inc.i = add nsw i32 %17, 1
  store i32 %inc.i, ptr %9, align 8
...
for.inc.i:                                        ; preds = %if.then10.i, %if.end.i
  ...
  br i1 %cmp.i34, label %for.body.i, label %writeUVLC2buffer.exit

writeUVLC2buffer.exit:                            ; preds = %for.inc.i, %symbol2vlc.exit.thread
  %20 = phi i32 [ %2, %symbol2vlc.exit.thread ], [ %18, %for.inc.i ]
  %21 = load i32, ptr %se, align 8
...
symbol2vlc.exit.thread:                           ; preds = %if.end
  ...
  store i32 0, ptr %bitpattern.i41, align 4
  br label %writeUVLC2buffer.exit
...
for.body.i:                                       ; preds = %for.inc.i, %symbol2vlc.exit
  %12 = phi i32 [ %4, %symbol2vlc.exit ], [ %20, %for.inc.i ]
  %13 = phi i8 [ %.pre.i, %symbol2vlc.exit ], [ %21, %for.inc.i ]
  %mask.030.i = phi i32 [ %shl.i35, %symbol2vlc.exit ], [ %shr.i, %for.inc.i ]
  %i.029.i = phi i32 [ 0, %symbol2vlc.exit ], [ %inc15.i, %for.inc.i ]
  %shl2.i = shl i8 %13, 1
  store i8 %shl2.i, ptr %byte_buf.i, align 8
  %14 = load i32, ptr %bitpattern.i, align 4
...
if.end.i:                                         ; preds = %if.then.i, %for.body.i
  ...
  store i32 %dec.i38, ptr %bits_to_go.i, align 4
  %shr.i = lshr i32 %mask.030.i, 1
...
for.inc.i:                                        ; preds = %if.then10.i, %if.end.i
  ...
  br i1 %cmp.i39, label %for.body.i, label %writeUVLC2buffer.exit
...
while.cond:                                       ; preds = %if.else8, %while.cond
  ...
  br i1 %cmp15, label %while.cond, label %if.end
...
if.end42:                                         ; preds = %cleanup.thread, %if.then
  ...
  store i32 %add19.sink, ptr %len34, align 4
  %inf35 = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 4
  store i32 %or26.sink, ptr %inf35, align 8
...
symbol2vlc.exit.thread:                           ; preds = %if.end42
  ...
  store i32 0, ptr %bitpattern.i91, align 4
  br label %writeUVLC2buffer.exit
...
for.body.i:                                       ; preds = %for.inc.i, %symbol2vlc.exit
  %6 = phi i32 [ %3, %symbol2vlc.exit ], [ %14, %for.inc.i ]
  %7 = phi i8 [ %.pre.i, %symbol2vlc.exit ], [ %15, %for.inc.i ]
  %mask.030.i = phi i32 [ %shl.i85, %symbol2vlc.exit ], [ %shr.i, %for.inc.i ]
  %i.029.i = phi i32 [ 0, %symbol2vlc.exit ], [ %inc15.i, %for.inc.i ]
  %shl2.i = shl i8 %7, 1
  store i8 %shl2.i, ptr %byte_buf.i, align 8
  %8 = load i32, ptr %bitpattern.i, align 4
...
if.then.i:                                        ; preds = %for.body.i
  %9 = or i8 %shl2.i, 1
  store i8 %9, ptr %byte_buf.i, align 8
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i, %for.body.i
  %10 = phi i8 [ %9, %if.then.i ], [ %shl2.i, %for.body.i ]
  %11 = load i32, ptr %bits_to_go.i, align 4
  %dec.i88 = add nsw i32 %11, -1
  store i32 %dec.i88, ptr %bits_to_go.i, align 4
  %shr.i = lshr i32 %mask.030.i, 1
...
if.then10.i:                                      ; preds = %if.end.i
  store i32 8, ptr %bits_to_go.i, align 4
  %12 = load ptr, ptr %streamBuffer.i, align 8
  ...
  store i8 0, ptr %byte_buf.i, align 8
  %.pre31.i = load i32, ptr %len.i94, align 4
  br label %for.inc.i
...
for.inc.i:                                        ; preds = %if.then10.i, %if.end.i
  ...
  br i1 %cmp.i89, label %for.body.i, label %writeUVLC2buffer.exit

writeUVLC2buffer.exit:                            ; preds = %for.inc.i, %symbol2vlc.exit.thread
  %16 = phi i32 [ %add19.sink, %symbol2vlc.exit.thread ], [ %14, %for.inc.i ]
  %17 = load i32, ptr %se, align 8
...
while.cond:                                       ; preds = %if.else, %while.cond
  ...
  br i1 %cmp17, label %while.cond, label %if.end
...
if.then32:                                        ; preds = %if.end
  ...
  %inf = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 4
  store i32 %or29, ptr %inf, align 8
  br label %cleanup44
...
if.end35:                                         ; preds = %if.end, %if.then
  ...
  store i32 %iLength.0, ptr %len36, align 4
  %inf37 = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 4
  store i32 %iCodeword.0, ptr %inf37, align 8
...
while.body.i.preheader:                           ; preds = %if.end35
  ...
  br i1 %3, label %symbol2vlc.exit.unr-lcssa, label %while.body.i.preheader.new
...
symbol2vlc.exit.thread:                           ; preds = %if.end35
  ...
  store i32 0, ptr %bitpattern.i95, align 4
  br label %writeUVLC2buffer.exit
...
for.body.i:                                       ; preds = %for.inc.i, %symbol2vlc.exit
  %9 = phi i32 [ %iLength.0, %symbol2vlc.exit ], [ %17, %for.inc.i ]
  %10 = phi i8 [ %.pre.i, %symbol2vlc.exit ], [ %18, %for.inc.i ]
  %mask.030.i = phi i32 [ %shl.i89, %symbol2vlc.exit ], [ %shr.i, %for.inc.i ]
  %i.029.i = phi i32 [ 0, %symbol2vlc.exit ], [ %inc15.i, %for.inc.i ]
  %shl2.i = shl i8 %10, 1
  store i8 %shl2.i, ptr %byte_buf.i, align 8
  %11 = load i32, ptr %bitpattern.i, align 4
...
if.then.i:                                        ; preds = %for.body.i
  %12 = or i8 %shl2.i, 1
  store i8 %12, ptr %byte_buf.i, align 8
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i, %for.body.i
  %13 = phi i8 [ %12, %if.then.i ], [ %shl2.i, %for.body.i ]
  %14 = load i32, ptr %bits_to_go.i, align 4
  %dec.i92 = add nsw i32 %14, -1
  store i32 %dec.i92, ptr %bits_to_go.i, align 4
  %shr.i = lshr i32 %mask.030.i, 1
...
if.then10.i:                                      ; preds = %if.end.i
  store i32 8, ptr %bits_to_go.i, align 4
  %15 = load ptr, ptr %streamBuffer.i, align 8
  ...
  store i8 0, ptr %byte_buf.i, align 8
  %.pre31.i = load i32, ptr %len36, align 4
  br label %for.inc.i
...
for.inc.i:                                        ; preds = %if.then10.i, %if.end.i
  ...
  br i1 %cmp.i93, label %for.body.i, label %writeUVLC2buffer.exit

writeUVLC2buffer.exit:                            ; preds = %for.inc.i, %symbol2vlc.exit.thread
  %19 = phi i32 [ %iLength.0, %symbol2vlc.exit.thread ], [ %17, %for.inc.i ]
  %20 = load i32, ptr %se, align 8
...
if.then:                                          ; preds = %entry
  ...
  store i8 %conv3, ptr %byte_buf, align 8
  ...
  store i8 %conv3, ptr %arrayidx9, align 1
  store i32 8, ptr %bits_to_go, align 4
  br label %if.end
...
attributes #4 = { nofree nosync nounwind memory(argmem: write) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
