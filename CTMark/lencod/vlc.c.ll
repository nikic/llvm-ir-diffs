...
if.then10.i:                                      ; preds = %for.body.i17
  ...
  store i32 %inc.i20, ptr %bitstream, align 8, !tbaa !15
...
for.inc.i:                                        ; preds = %if.then10.i, %for.body.i17
  ...
  br i1 %exitcond.not, label %writeUVLC2buffer.exit, label %for.body.i17, !llvm.loop !17
...
if.then10.i:                                      ; preds = %for.body.i19
  ...
  store i32 %inc.i22, ptr %bitstream, align 8, !tbaa !15
...
for.inc.i:                                        ; preds = %if.then10.i, %for.body.i19
  ...
  br i1 %exitcond.not, label %writeUVLC2buffer.exit, label %for.body.i19, !llvm.loop !17
...
for.body.i:                                       ; preds = %entry, %for.body.i
  ...
  br i1 %3, label %for.body.i, label %for.body.lr.ph.i, !llvm.loop !5
...
if.then10.i:                                      ; preds = %if.end.i
  ...
  store i32 %inc.i17, ptr %4, align 8, !tbaa !15
...
for.inc.i:                                        ; preds = %if.then10.i, %if.end.i
  ...
  br i1 %cmp.i16, label %for.body.i14, label %writeUVLC2buffer.exit, !llvm.loop !17
...
for.body.i:                                       ; preds = %for.body.i, %for.body.preheader.i
  ...
  br i1 %2, label %for.body.i, label %for.body.lr.ph.i, !llvm.loop !23
...
if.then10.i:                                      ; preds = %if.end.i
  ...
  store i32 %inc.i19, ptr %3, align 8, !tbaa !15
...
for.inc.i:                                        ; preds = %if.then10.i, %if.end.i
  ...
  br i1 %cmp.i18, label %for.body.i16, label %writeUVLC2buffer.exit, !llvm.loop !17
...
for.body.i.i39:                                   ; preds = %if.else, %for.body.i.i39
  ...
  br i1 %15, label %for.body.i.i39, label %cbp_linfo_inter.exit, !llvm.loop !5
...
cbp_linfo_inter.exit:                             ; preds = %for.body.i.i39, %if.else
  ...
  store i32 %add3.i.i36, ptr %len8, align 4, !tbaa !18
  %shl.neg.i.i37 = shl nsw i32 -1, %i.0.lcssa.i.i34
  %sub.i.i38 = add nsw i32 %shl.neg.i.i37, %add.i.i32
  store i32 %sub.i.i38, ptr %inf9, align 4, !tbaa !18
  br label %for.body.lr.ph.i
...
while.body.i:                                     ; preds = %while.body.i, %while.body.i.preheader.new
  ...
  %niter.next.3 = add i32 %niter, 4
  %niter.ncmp.3.not = icmp eq i32 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3.not, label %symbol2vlc.exit.unr-lcssa, label %while.body.i, !llvm.loop !48
...
while.body.i.epil:                                ; preds = %symbol2vlc.exit.unr-lcssa, %while.body.i.epil
  ...
  %epil.iter.next = add i32 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %symbol2vlc.exit, label %while.body.i.epil, !llvm.loop !51
...
while.body.i:                                     ; preds = %while.body.i, %while.body.lr.ph.i
  ...
  br i1 %cmp.i, label %while.body.i, label %symbol2vlc.exit, !llvm.loop !48
...
while.body.i.epil:                                ; preds = %symbol2vlc.exit.unr-lcssa, %while.body.i.epil
  ...
  %epil.iter.next = add i32 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %symbol2vlc.exit, label %while.body.i.epil, !llvm.loop !52
...
while.body.i.epil:                                ; preds = %symbol2vlc.exit.unr-lcssa, %while.body.i.epil
  ...
  %epil.iter.next = add i32 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %symbol2vlc.exit, label %while.body.i.epil, !llvm.loop !53
...
while.body.i.epil:                                ; preds = %symbol2vlc.exit.unr-lcssa, %while.body.i.epil
  ...
  %epil.iter.next = add i32 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %symbol2vlc.exit, label %while.body.i.epil, !llvm.loop !54
...
while.body.i.epil:                                ; preds = %symbol2vlc.exit.unr-lcssa, %while.body.i.epil
  ...
  %epil.iter.next = add i32 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %symbol2vlc.exit, label %while.body.i.epil, !llvm.loop !55
...
while.body.i.epil:                                ; preds = %symbol2vlc.exit.unr-lcssa, %while.body.i.epil
  ...
  %epil.iter.next = add i32 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %symbol2vlc.exit, label %while.body.i.epil, !llvm.loop !58
