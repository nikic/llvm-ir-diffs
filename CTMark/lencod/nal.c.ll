; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/nal.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/nal.c"
...
entry:
  ...
  %4 = load i32, ptr %currStream, align 8
  %inc = add nsw i32 %4, 1
...
entry:
  %0 = load ptr, ptr @NAL_Payload_buffer, align 8
  ...
  %cmp70 = icmp slt i32 %begin_bytepos, %end_bytepos
...
if.end:                                           ; preds = %if.then, %land.lhs.true, %for.body
  ...
  br i1 %exitcond.not, label %for.cond25.preheader, label %for.body
...
entry:
  ...
  %5 = load i32, ptr %auto_crop_bottom, align 4
  %6 = load ptr, ptr @NAL_Payload_buffer, align 8
...
FreeNalPayloadBuffer.exit:                        ; preds = %entry, %if.then.i
  ...
  store ptr %call, ptr @NAL_Payload_buffer, align 8
  ret void
}
...
if.then:                                          ; preds = %entry
  ...
  store ptr null, ptr @NAL_Payload_buffer, align 8
  br label %if.end
