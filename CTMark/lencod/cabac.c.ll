; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/cabac.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/cabac.c"
...
if.then:                                          ; preds = %entry
  ...
  %7 = load ptr, ptr %mb_data1, align 8
...
entry:
  ...
  %6 = load i32, ptr %mbAvailA, align 4
...
entry:
  ...
  %cmp = icmp eq i32 %1, 1
  %currentSlice = getelementptr inbounds %struct.ImageParameters, ptr %0, i64 0, i32 60
  %2 = load ptr, ptr %currentSlice, align 8
  ...
  %7 = load ptr, ptr %mb_available_up, align 8
...
if.else:                                          ; preds = %if.then
  ...
  %8 = load i32, ptr %skip_flag, align 8
...
if.end:                                           ; preds = %if.then, %if.else
  ...
  %9 = load ptr, ptr %mb_available_left, align 8
...
if.else10:                                        ; preds = %if.end
  ...
  %10 = load i32, ptr %skip_flag12, align 8
...
land.lhs.true:                                    ; preds = %if.end16
  ...
  %12 = load i32, ptr %value2, align 8
...
land.rhs:                                         ; preds = %if.end32
  ...
  %14 = load i32, ptr %value236, align 8
...
if.else46:                                        ; preds = %if.else41
  ...
  %15 = load i32, ptr %skip_flag48, align 8
...
if.end52:                                         ; preds = %if.else41, %if.else46
  ...
  %16 = load ptr, ptr %mb_available_left53, align 8
...
if.else57:                                        ; preds = %if.end52
  ...
  %17 = load i32, ptr %skip_flag59, align 8
...
if.end82:                                         ; preds = %if.end32, %land.rhs, %if.end63
  ...
  store i32 %cond80.sink, ptr %skip_flag81, align 8
  %context = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 6
...
entry:
  ...
  %5 = load ptr, ptr %mb_available_up, align 8
...
cond.end:                                         ; preds = %entry, %cond.false
  ...
  %7 = load ptr, ptr %mb_available_left, align 8
...
cond.false4:                                      ; preds = %cond.end
  ...
  %8 = load i32, ptr %luma_transform_size_8x8_flag6, align 8
  br label %cond.end7
...
cond.end7:                                        ; preds = %cond.end, %cond.false4
  ...
  %9 = load i32, ptr %luma_transform_size_8x8_flag9, align 8
  %context = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 6
  store i32 %add, ptr %context, align 8
...
if.end:                                           ; preds = %if.then, %if.else
  %b.0 = phi i32 [ %cond, %if.else ], [ 0, %if.then ]
  %mb_available_left = getelementptr inbounds %struct.macroblock, ptr %4, i64 %idxprom, i32 7
  %10 = load ptr, ptr %mb_available_left, align 8
...
if.else17:                                        ; preds = %if.end
  ...
  %11 = load i32, ptr %mb_type19, align 8
  %12 = and i32 %11, -5
...
if.then32:                                        ; preds = %if.end29
  tail call void @biari_encode_symbol(ptr noundef nonnull %ee_cabac, i16 noundef signext 0, ptr noundef %add.ptr48) #12
  br label %cleanup
...
if.then95:                                        ; preds = %entry
  ...
  %16 = load ptr, ptr %mb_available_up96, align 8
...
if.else100:                                       ; preds = %if.then95
  ...
  %17 = load i32, ptr %mb_type102, align 8
...
if.end106:                                        ; preds = %if.then95, %if.else100
  ...
  %18 = load ptr, ptr %mb_available_left107, align 8
...
if.else111:                                       ; preds = %if.end106
  ...
  %19 = load i32, ptr %mb_type113, align 8
...
if.else184:                                       ; preds = %if.else111, %if.end106
  ...
  store i32 %add118, ptr %context119, align 8
...
if.end336:                                        ; preds = %if.else250
  ...
  %25 = add i16 %24, -12
  %26 = lshr i16 %25, 3
  %conv298 = and i16 %26, 1
  %arrayidx301 = getelementptr inbounds [3 x [11 x %struct.BiContextType]], ptr %3, i64 0, i64 2, i64 6
  tail call void @biari_encode_symbol(ptr noundef nonnull %ee_cabac, i16 noundef signext %conv298, ptr noundef nonnull %arrayidx301) #12
  %27 = lshr i16 %25, 2
...
if.then339:                                       ; preds = %if.end336.thread650, %if.end336
  ...
  %cmp340 = icmp eq i32 %spec.select643655, 25
...
if.end345:                                        ; preds = %if.then339
  tail call void @biari_encode_symbol_final(ptr noundef nonnull %ee_cabac, i16 noundef signext 0) #12
  %div346 = sdiv i32 %spec.select643655, 12
  %conv347 = trunc i32 %div346 to i16
  ...
  %rem353 = srem i32 %spec.select643655, 12
  %rem353.off = add nsw i32 %rem353, 3
  %cmp355 = icmp ult i32 %rem353.off, 7
...
if.end377:                                        ; preds = %if.end345, %if.else363
  ...
  %rem378.lhs.trunc = trunc i32 %rem353 to i8
  %rem378656 = srem i8 %rem378.lhs.trunc, 4
  %div379657 = sdiv i8 %rem378656, 2
  %conv380 = sext i8 %div379657 to i16
  ...
  %rem386658 = srem i8 %rem378656, 2
  %conv387 = sext i8 %rem386658 to i16
...
cleanup:                                          ; preds = %if.then37, %if.end78, %if.then32, %if.end377, %if.end336, %if.then187, %if.then195, %if.then213, %if.then255, %sw.bb169, %sw.bb149, %sw.bb139, %sw.bb, %if.then129, %if.end336.thread, %if.then342
  ...
  store i32 1, ptr %write_flag396, align 8
  ...
  store i32 %sub398, ptr %len399, align 4
  ret void
}
...
cleanup:                                          ; preds = %if.then, %sw.bb19, %sw.bb9, %sw.bb2, %sw.bb, %if.then55, %if.else101, %if.then89, %if.then42, %if.then31
  ...
  store i32 1, ptr %write_flag127, align 8
  ...
  store i32 %sub129, ptr %len130, align 4
  ret void
}
...
entry:
  ...
  %2 = load ptr, ptr %tex_ctx, align 8
  %value1 = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 1
...
if.else:                                          ; preds = %entry
  ...
  %21 = load ptr, ptr %mb_data19, align 8
  ...
  %23 = load i32, ptr %mb_type, align 8
...
land.lhs.true:                                    ; preds = %if.else
  ...
  %24 = load i32, ptr %type24, align 4
...
if.else40:                                        ; preds = %lor.lhs.false
  ...
  %27 = load i32, ptr %MbaffFrameFlag, align 4
...
land.lhs.true45:                                  ; preds = %land.lhs.true42
  ...
  %29 = load i32, ptr %mb_field50, align 8
...
if.end73.sink.split:                              ; preds = %land.lhs.true45, %if.else61
  ...
  %30 = load i32, ptr %pos_y62, align 4
  ...
  %32 = load i32, ptr %pos_x65, align 4
  ...
  %34 = select i1 %cmp69, i32 2, i32 0
  br label %if.end73

if.end73:                                         ; preds = %if.end73.sink.split, %land.lhs.true, %lor.lhs.false, %entry
  %b.0.shrunk = phi i32 [ 0, %entry ], [ 0, %lor.lhs.false ], [ 0, %land.lhs.true ], [ %34, %if.end73.sink.split ]
  %35 = load i32, ptr %block_a, align 4
...
if.else77:                                        ; preds = %if.end73
  ...
  %mb_data78 = getelementptr inbounds %struct.ImageParameters, ptr %36, i64 0, i32 61
  %37 = load ptr, ptr %mb_data78, align 8
  %mb_addr79 = getelementptr inbounds %struct.pix_pos, ptr %block_a, i64 0, i32 1
  %38 = load i32, ptr %mb_addr79, align 4
  %idxprom80 = sext i32 %38 to i64
  %mb_type82 = getelementptr inbounds %struct.macroblock, ptr %37, i64 %idxprom80, i32 8
  %39 = load i32, ptr %mb_type82, align 8
  %cmp83 = icmp eq i32 %39, 0
  br i1 %cmp83, label %land.lhs.true85, label %lor.lhs.false91

land.lhs.true85:                                  ; preds = %if.else77
  %type86 = getelementptr inbounds %struct.ImageParameters, ptr %36, i64 0, i32 5
  %40 = load i32, ptr %type86, align 4
  %cmp87 = icmp ne i32 %40, 1
  %41 = load i32, ptr @giRDOpt_B8OnlyFlag, align 4
...
lor.lhs.false91:                                  ; preds = %land.lhs.true85, %if.else77
  ...
  %arrayidx98 = getelementptr inbounds %struct.macroblock, ptr %37, i64 %idxprom80, i32 14, i64 %idxprom97
  %42 = load i32, ptr %arrayidx98, align 4
  %cmp99 = icmp eq i32 %42, 0
...
if.else104:                                       ; preds = %lor.lhs.false91
  %MbaffFrameFlag105 = getelementptr inbounds %struct.ImageParameters, ptr %36, i64 0, i32 100
  %43 = load i32, ptr %MbaffFrameFlag105, align 4
  %tobool106.not = icmp eq i32 %43, 0
...
land.lhs.true107:                                 ; preds = %if.else104
  ...
  %44 = load i32, ptr %mb_field108, align 8
  %cmp109 = icmp eq i32 %44, 0
  br i1 %cmp109, label %land.lhs.true111, label %if.else130

land.lhs.true111:                                 ; preds = %land.lhs.true107
  %mb_field116 = getelementptr inbounds %struct.macroblock, ptr %37, i64 %idxprom80, i32 19
  %45 = load i32, ptr %mb_field116, align 8
  %cmp117 = icmp eq i32 %45, 1
...
if.end143.sink.split:                             ; preds = %land.lhs.true111, %if.else130
  ...
  %46 = load i32, ptr %pos_y131, align 4
  %idxprom132 = sext i32 %46 to i64
  ...
  %48 = load i32, ptr %pos_x134, align 4
  %idxprom135 = sext i32 %48 to i64
  %arrayidx136 = getelementptr inbounds i8, ptr %47, i64 %idxprom135
  %49 = load i8, ptr %arrayidx136, align 1
  %cmp138 = icmp sgt i8 %49, %.sink200
  %50 = zext i1 %cmp138 to i32
  br label %if.end143

if.end143:                                        ; preds = %if.end143.sink.split, %land.lhs.true85, %lor.lhs.false91, %if.end73
  %a.0.shrunk = phi i32 [ 0, %if.end73 ], [ 0, %lor.lhs.false91 ], [ 0, %land.lhs.true85 ], [ %50, %if.end143.sink.split ]
  %add145 = or i32 %b.0.shrunk, %a.0.shrunk
  %context = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 6
  store i32 %add145, ptr %context, align 8
  %value1 = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 1
  %51 = load i32, ptr %value1, align 4
  %cmp146 = icmp eq i32 %51, 0
...
while.body.i:                                     ; preds = %if.else.i, %while.body.i
  ...
  br i1 %cmp1.not.i, label %if.end164, label %while.body.i
...
if.end164:                                        ; preds = %while.body.i, %if.else.i, %if.else151, %if.end143
  ...
  %write_flag = getelementptr inbounds %struct.Bitstream, ptr %52, i64 0, i32 10
  store i32 1, ptr %write_flag, align 8
...
entry:
  ...
  %6 = load i32, ptr %prev_delta_qp, align 4
  store i32 %6, ptr @last_dquant, align 4
...
while.body.i:                                     ; preds = %if.else.i, %while.body.i
  ...
  %dec.i = add i32 %dec12.i, -1
  %cmp1.not.i = icmp eq i32 %dec.i, 0
  br i1 %cmp1.not.i, label %if.end14, label %while.body.i
...
entry:
  ...
  %0 = load ptr, ptr @img, align 8
  %subblock_x = getelementptr inbounds %struct.ImageParameters, ptr %0, i64 0, i32 24
  %1 = load i32, ptr %subblock_x, align 8
  %shl = shl i32 %1, 2
  %subblock_y = getelementptr inbounds %struct.ImageParameters, ptr %0, i64 0, i32 25
  %2 = load i32, ptr %subblock_y, align 4
  %shl1 = shl i32 %2, 2
  %value2 = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 2
  ...
  %6 = load ptr, ptr %mot_ctx, align 8
  %mb_data = getelementptr inbounds %struct.ImageParameters, ptr %0, i64 0, i32 61
  ...
  %8 = load i32, ptr %block_b, align 4
...
if.then:                                          ; preds = %entry
  ...
  %10 = load ptr, ptr %mb_data4, align 8
  %mb_addr = getelementptr inbounds %struct.pix_pos, ptr %block_b, i64 0, i32 1
...
land.lhs.true19:                                  ; preds = %if.then17
  ...
  %17 = load i32, ptr %mb_field24, align 8
...
land.lhs.true29:                                  ; preds = %if.then17
  ...
  %18 = load i32, ptr %mb_field34, align 8
  %cmp35 = icmp eq i32 %18, 0
  %div167171 = zext i1 %cmp35 to i32
  %spec.select168 = lshr i32 %cond.i, %div167171
  br label %if.end40
...
if.end40:                                         ; preds = %land.lhs.true29, %land.lhs.true19, %if.then17, %entry, %if.then
  ...
  %19 = load i32, ptr %block_a, align 4
...
if.then43:                                        ; preds = %if.end40
  ...
  %26 = load i32, ptr %MbaffFrameFlag60, align 4
...
if.then64:                                        ; preds = %if.then43
  ...
  %27 = load i32, ptr %mb_field65, align 8
...
land.lhs.true67:                                  ; preds = %if.then64
  ...
  %28 = load i32, ptr %mb_field72, align 8
...
land.lhs.true79:                                  ; preds = %if.then64
  ...
  %29 = load i32, ptr %mb_field84, align 8
  %cmp85 = icmp eq i32 %29, 0
  %div87166172 = zext i1 %cmp85 to i32
  %spec.select170 = lshr i32 %cond.i162, %div87166172
  br label %if.end92
...
if.end121:                                        ; preds = %if.else112, %if.then108
  ...
  %len = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 3
  store i32 %sub123, ptr %len, align 4
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %block_b) #12
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %block_a) #12
  ret void
}
...
land.rhs.preheader:                               ; preds = %if.else
  ...
  %spec.select = getelementptr inbounds %struct.BiContextType, ptr %ctx, i64 2
  %cmp7 = icmp eq i32 %max_bin, 2
  %ictx.2.idx = zext i1 %cmp7 to i64
  %ictx.2 = getelementptr inbounds %struct.BiContextType, ptr %spec.select, i64 %ictx.2.idx
  %cmp1.not = icmp eq i32 %symbol, 2
  br i1 %cmp1.not, label %cleanup.sink.split, label %land.rhs.1

land.rhs.1:                                       ; preds = %land.rhs.preheader
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef nonnull %ictx.2) #12
  %cmp7.1 = icmp eq i32 %max_bin, 3
  %ictx.2.idx.1 = zext i1 %cmp7.1 to i64
  %ictx.2.1 = getelementptr inbounds %struct.BiContextType, ptr %ictx.2, i64 %ictx.2.idx.1
  %cmp1.not.1 = icmp eq i32 %symbol, 3
  br i1 %cmp1.not.1, label %cleanup.sink.split, label %land.rhs.2

land.rhs.2:                                       ; preds = %land.rhs.1
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef nonnull %ictx.2.1) #12
  %cmp7.2 = icmp eq i32 %max_bin, 4
  %ictx.2.idx.2 = zext i1 %cmp7.2 to i64
  %ictx.2.2 = getelementptr inbounds %struct.BiContextType, ptr %ictx.2.1, i64 %ictx.2.idx.2
  %cmp1.not.2 = icmp eq i32 %symbol, 4
  br i1 %cmp1.not.2, label %cleanup.sink.split, label %land.rhs.3

land.rhs.3:                                       ; preds = %land.rhs.2
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef nonnull %ictx.2.2) #12
  %cmp7.3 = icmp eq i32 %max_bin, 5
  %ictx.2.idx.3 = zext i1 %cmp7.3 to i64
  %ictx.2.3 = getelementptr inbounds %struct.BiContextType, ptr %ictx.2.2, i64 %ictx.2.idx.3
  %cmp1.not.3 = icmp eq i32 %symbol, 5
  br i1 %cmp1.not.3, label %cleanup.sink.split, label %land.rhs.4

land.rhs.4:                                       ; preds = %land.rhs.3
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef nonnull %ictx.2.3) #12
  %cmp7.4 = icmp eq i32 %max_bin, 6
  %ictx.2.idx.4 = zext i1 %cmp7.4 to i64
  %ictx.2.4 = getelementptr inbounds %struct.BiContextType, ptr %ictx.2.3, i64 %ictx.2.idx.4
  %cmp1.not.4 = icmp eq i32 %symbol, 6
  br i1 %cmp1.not.4, label %cleanup.sink.split, label %land.rhs.5

land.rhs.5:                                       ; preds = %land.rhs.4
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef nonnull %ictx.2.4) #12
  %cmp7.5 = icmp eq i32 %max_bin, 7
  %ictx.2.idx.5 = zext i1 %cmp7.5 to i64
  %ictx.2.5 = getelementptr inbounds %struct.BiContextType, ptr %ictx.2.4, i64 %ictx.2.idx.5
  %cmp1.not.5 = icmp eq i32 %symbol, 7
  br i1 %cmp1.not.5, label %cleanup.sink.split, label %land.rhs.6
...
while.body3.i:                                    ; preds = %if.else.i, %while.body3.i
  ...
  br i1 %tobool.not.i, label %cleanup, label %while.body3.i
...
if.end:                                           ; preds = %entry, %if.else
  ...
  %mb_available_left = getelementptr inbounds %struct.macroblock, ptr %3, i64 %idxprom, i32 7
  %8 = load ptr, ptr %mb_available_left, align 8
...
if.else5:                                         ; preds = %if.end
  ...
  %9 = load i32, ptr %c_ipred_mode7, align 8
...
if.then22:                                        ; preds = %if.end20
  ...
  %.pre64 = load ptr, ptr @img, align 8
  br i1 %tobool.not, label %if.end49, label %if.then25

if.then25:                                        ; preds = %if.then22
  %mb_data = getelementptr inbounds %struct.ImageParameters, ptr %.pre64, i64 0, i32 61
  %10 = load ptr, ptr %mb_data, align 8
  %mb_addr = getelementptr inbounds %struct.pix_pos, ptr %block_a, i64 0, i32 1
  %11 = load i32, ptr %mb_addr, align 4
  %idxprom = sext i32 %11 to i64
  %mb_type26 = getelementptr inbounds %struct.macroblock, ptr %10, i64 %idxprom, i32 8
  %12 = load i32, ptr %mb_type26, align 8
  %cmp27 = icmp eq i32 %12, 14
  br i1 %cmp27, label %if.end49, label %if.else29

if.else29:                                        ; preds = %if.then25
  %cbp34 = getelementptr inbounds %struct.macroblock, ptr %10, i64 %idxprom, i32 12
  %13 = load i32, ptr %cbp34, align 4
  %y = getelementptr inbounds %struct.pix_pos, ptr %block_a, i64 0, i32 3
  %14 = load i32, ptr %y, align 4
  %add36 = or i32 %14, 1
  %15 = xor i32 %13, -1
  %16 = lshr i32 %15, %add36
  %cond40 = and i32 %16, 1
  br label %if.end49
...
if.end49:                                         ; preds = %if.then22, %if.then25, %if.else29, %if.else44
  %19 = phi ptr [ %.pre64, %if.else29 ], [ %.pre, %if.else44 ], [ %.pre64, %if.then25 ], [ %.pre64, %if.then22 ]
  %a.0 = phi i32 [ %cond40, %if.else29 ], [ %cond48, %if.else44 ], [ 0, %if.then25 ], [ 0, %if.then22 ]
  %conv = trunc i32 %bit to i16
  %currentSlice = getelementptr inbounds %struct.ImageParameters, ptr %19, i64 0, i32 60
  %20 = load ptr, ptr %currentSlice, align 8
  %tex_ctx = getelementptr inbounds %struct.Slice, ptr %20, i64 0, i32 8
  %21 = load ptr, ptr %tex_ctx, align 8
  %cbp_contexts = getelementptr inbounds %struct.TextureInfoContexts, ptr %21, i64 0, i32 2
...
if.then:                                          ; preds = %entry
  %mb_available_up = getelementptr inbounds %struct.macroblock, ptr %3, i64 %idxprom, i32 6
  %8 = load ptr, ptr %mb_available_up, align 8
...
if.then6:                                         ; preds = %if.then
  ...
  %9 = load i32, ptr %mb_type, align 8
...
if.else:                                          ; preds = %if.then6
  ...
  %10 = load i32, ptr %cbp11, align 4
  %cmp12 = icmp sgt i32 %10, 15
  %11 = select i1 %cmp12, i64 2, i64 0
  br label %if.end14

if.end14:                                         ; preds = %if.then6, %if.else, %if.then
  %b.0 = phi i64 [ %11, %if.else ], [ 0, %if.then ], [ 2, %if.then6 ]
  %mb_available_left = getelementptr inbounds %struct.macroblock, ptr %3, i64 %idxprom, i32 7
  %12 = load ptr, ptr %mb_available_left, align 8
  %cmp15.not = icmp eq ptr %12, null
  br i1 %cmp15.not, label %if.end27, label %if.then16

if.then16:                                        ; preds = %if.end14
  %mb_type18 = getelementptr inbounds %struct.macroblock, ptr %12, i64 0, i32 8
  %13 = load i32, ptr %mb_type18, align 8
  %cmp19 = icmp eq i32 %13, 14
  br i1 %cmp19, label %if.end27, label %if.else21

if.else21:                                        ; preds = %if.then16
  %cbp23 = getelementptr inbounds %struct.macroblock, ptr %12, i64 0, i32 12
  %14 = load i32, ptr %cbp23, align 4
  %cmp24 = icmp sgt i32 %14, 15
...
if.then33:                                        ; preds = %if.end27
  %15 = load ptr, ptr %mb_available_up, align 8
  %cmp35.not = icmp eq ptr %15, null
  br i1 %cmp35.not, label %if.end56, label %if.then37

if.then37:                                        ; preds = %if.then33
  %mb_type39 = getelementptr inbounds %struct.macroblock, ptr %15, i64 0, i32 8
  %16 = load i32, ptr %mb_type39, align 8
  %cmp40 = icmp eq i32 %16, 14
  br i1 %cmp40, label %if.end56, label %if.else43

if.else43:                                        ; preds = %if.then37
  %cbp45 = getelementptr inbounds %struct.macroblock, ptr %15, i64 0, i32 12
  %17 = load i32, ptr %cbp45, align 4
  %cmp46 = icmp sgt i32 %17, 15
  br i1 %cmp46, label %if.then48, label %if.end56

if.then48:                                        ; preds = %if.else43
  %shr.mask = and i32 %17, -16
  %cmp51 = icmp eq i32 %shr.mask, 32
  %18 = select i1 %cmp51, i64 2, i64 0
  br label %if.end56

if.end56:                                         ; preds = %if.then37, %if.then48, %if.else43, %if.then33
  %b.1 = phi i64 [ %18, %if.then48 ], [ 0, %if.else43 ], [ 0, %if.then33 ], [ 2, %if.then37 ]
  %19 = load ptr, ptr %mb_available_left, align 8
  %cmp58.not = icmp eq ptr %19, null
  br i1 %cmp58.not, label %if.end80, label %if.then60

if.then60:                                        ; preds = %if.end56
  %mb_type62 = getelementptr inbounds %struct.macroblock, ptr %19, i64 0, i32 8
  %20 = load i32, ptr %mb_type62, align 8
  %cmp63 = icmp eq i32 %20, 14
  br i1 %cmp63, label %if.end80, label %if.else66

if.else66:                                        ; preds = %if.then60
  %cbp68 = getelementptr inbounds %struct.macroblock, ptr %19, i64 0, i32 12
  %21 = load i32, ptr %cbp68, align 4
  %cmp69 = icmp sgt i32 %21, 15
  br i1 %cmp69, label %if.then71, label %if.end80

if.then71:                                        ; preds = %if.else66
  %shr74.mask = and i32 %21, -16
...
entry:
  ...
  switch i32 %type, label %entry.land.end38_crit_edge [
...
entry.land.end38_crit_edge:                       ; preds = %entry
  %.pre.pre = load ptr, ptr @img, align 8
  br label %land.end38
...
land.end15.thread:                                ; preds = %entry
  ...
  %2 = load i32, ptr %is_v_block, align 4
...
land.rhs35:                                       ; preds = %entry, %entry, %entry
  ...
  %4 = load i32, ptr %is_v_block29, align 4
  %tobool30.not = icmp eq i32 %4, 0
  %tobool37 = icmp ne i32 %4, 0
  br label %land.end38

land.end38:                                       ; preds = %entry.land.end38_crit_edge, %land.end15.thread, %land.rhs35
  %.pre = phi ptr [ %3, %land.rhs35 ], [ %1, %land.end15.thread ], [ %.pre.pre, %entry.land.end38_crit_edge ]
  %5 = phi i1 [ %tobool30.not, %land.rhs35 ], [ false, %land.end15.thread ], [ false, %entry.land.end38_crit_edge ]
  %6 = phi i1 [ false, %land.rhs35 ], [ %tobool14, %land.end15.thread ], [ false, %entry.land.end38_crit_edge ]
  %7 = phi i1 [ false, %land.rhs35 ], [ %tobool.not, %land.end15.thread ], [ false, %entry.land.end38_crit_edge ]
  %8 = phi i1 [ %tobool37, %land.rhs35 ], [ false, %land.end15.thread ], [ false, %entry.land.end38_crit_edge ]
...
cond.true50:                                      ; preds = %land.end38
  %subblock_y = getelementptr inbounds %struct.ImageParameters, ptr %.pre, i64 0, i32 25
  %9 = load i32, ptr %subblock_y, align 4
  %subblock_x = getelementptr inbounds %struct.ImageParameters, ptr %.pre, i64 0, i32 24
  %10 = load i32, ptr %subblock_x, align 8
  %11 = shl i32 %9, 2
  br label %cond.end52

cond.end52:                                       ; preds = %land.end38, %cond.true50
  %cond392 = phi i32 [ %11, %cond.true50 ], [ 0, %land.end38 ]
  %cond53 = phi i32 [ %10, %cond.true50 ], [ 0, %land.end38 ]
  %is_intra_block = getelementptr inbounds %struct.ImageParameters, ptr %.pre, i64 0, i32 26
  %12 = load i32, ptr %is_intra_block, align 8
  %tobool76.not = icmp ne i32 %12, 0
...
if.then:                                          ; preds = %cond.end52
  call void @getLuma4x4Neighbour(i32 noundef %13, i32 noundef %sub, i32 noundef %cond392, ptr noundef nonnull %block_a) #12
  %14 = load ptr, ptr @img, align 8
  %current_mb_nr82 = getelementptr inbounds %struct.ImageParameters, ptr %14, i64 0, i32 3
  %15 = load i32, ptr %current_mb_nr82, align 4
  call void @getLuma4x4Neighbour(i32 noundef %15, i32 noundef %shl, i32 noundef %sub85, ptr noundef nonnull %block_b) #12
  br i1 %spec.select, label %if.then87, label %cond.end161

if.then87:                                        ; preds = %if.then
  %16 = load i32, ptr %block_a, align 4
  %tobool88.not = icmp eq i32 %16, 0
  %y = getelementptr inbounds %struct.pix_pos, ptr %block_a, i64 0, i32 3
  ...
  %mul94 = shl nsw i32 %20, 2
  %x95 = getelementptr inbounds %struct.pix_pos, ptr %block_b, i64 0, i32 2
  %21 = load i32, ptr %x95, align 4
  %add96 = add nsw i32 %mul94, %21
...
if.else:                                          ; preds = %cond.end52
  call void @getChroma4x4Neighbour(i32 noundef %13, i32 noundef %sub, i32 noundef %cond392, ptr noundef nonnull %block_a) #12
  %22 = load ptr, ptr @img, align 8
  %current_mb_nr103 = getelementptr inbounds %struct.ImageParameters, ptr %22, i64 0, i32 3
  %23 = load i32, ptr %current_mb_nr103, align 4
  call void @getChroma4x4Neighbour(i32 noundef %23, i32 noundef %shl, i32 noundef %sub85, ptr noundef nonnull %block_b) #12
...
if.then110:                                       ; preds = %if.else
  ...
  %25 = load i32, ptr %y114, align 4
  %mul115 = shl nsw i32 %25, 2
  %x116 = getelementptr inbounds %struct.pix_pos, ptr %block_a, i64 0, i32 2
  %26 = load i32, ptr %x116, align 4
  %add117 = add nsw i32 %mul115, %26
...
if.then121:                                       ; preds = %if.then110
  ...
  %28 = load i32, ptr %y122, align 4
  %mul123 = shl nsw i32 %28, 2
  %x124 = getelementptr inbounds %struct.pix_pos, ptr %block_b, i64 0, i32 2
  %29 = load i32, ptr %x124, align 4
  %add125 = add nsw i32 %mul123, %29
...
if.then164:                                       ; preds = %cond.end161
  ...
  %30 = load i64, ptr %cbp_bits213, align 8
...
if.else210:                                       ; preds = %if.then164
  %or214 = or i64 %30, %shl212
  store i64 %or214, ptr %cbp_bits213, align 8
  br label %if.end218

cond.false221.thread:                             ; preds = %if.then187, %if.then200, %if.then167
  %shl194.pn = phi i64 [ %shl194, %if.then187 ], [ %shl207, %if.then200 ], [ %32, %if.then167 ]
  %or191.sink = or i64 %shl194.pn, %shl212
  %or196 = or i64 %or191.sink, %30
  store i64 %or196, ptr %cbp_bits213, align 8
...
if.then243:                                       ; preds = %if.end218, %cond.false227, %cond.end239
  ...
  %33 = load i32, ptr %block_b, align 4
  %tobool245.not = icmp eq i32 %33, 0
  %.pre409.pre = load ptr, ptr @img, align 8
  br i1 %tobool245.not, label %if.end263, label %if.then246

if.then246:                                       ; preds = %if.then243
  %mb_data = getelementptr inbounds %struct.ImageParameters, ptr %.pre409.pre, i64 0, i32 61
  %34 = load ptr, ptr %mb_data, align 8
  %mb_addr = getelementptr inbounds %struct.pix_pos, ptr %block_b, i64 0, i32 1
  %35 = load i32, ptr %mb_addr, align 4
  %idxprom = sext i32 %35 to i64
  %mb_type = getelementptr inbounds %struct.macroblock, ptr %34, i64 %idxprom, i32 8
  %36 = load i32, ptr %mb_type, align 8
  %cmp247 = icmp eq i32 %36, 14
  br i1 %cmp247, label %if.end263, label %if.else250

if.else250:                                       ; preds = %if.then246
  %cbp_bits255 = getelementptr inbounds %struct.macroblock, ptr %34, i64 %idxprom, i32 16
  %37 = load i64, ptr %cbp_bits255, align 8
  %add256 = add nsw i32 %cond240408, %bit_pos_b.0399
  %sh_prom257 = zext i32 %add256 to i64
  %shl258 = shl nuw i64 1, %sh_prom257
  %and = and i64 %37, %shl258
...
if.end263:                                        ; preds = %if.then246, %if.else250, %if.then243
  ...
  %38 = load i32, ptr %block_a, align 4
  %tobool265.not = icmp eq i32 %38, 0
  br i1 %tobool265.not, label %if.end290, label %if.then266

if.then266:                                       ; preds = %if.end263
  %mb_data267 = getelementptr inbounds %struct.ImageParameters, ptr %.pre409.pre, i64 0, i32 61
  %39 = load ptr, ptr %mb_data267, align 8
  %mb_addr268 = getelementptr inbounds %struct.pix_pos, ptr %block_a, i64 0, i32 1
  %40 = load i32, ptr %mb_addr268, align 4
  %idxprom269 = sext i32 %40 to i64
  %mb_type271 = getelementptr inbounds %struct.macroblock, ptr %39, i64 %idxprom269, i32 8
  %41 = load i32, ptr %mb_type271, align 8
  %cmp272 = icmp eq i32 %41, 14
  br i1 %cmp272, label %if.end290, label %if.else275

if.else275:                                       ; preds = %if.then266
  %cbp_bits280 = getelementptr inbounds %struct.macroblock, ptr %39, i64 %idxprom269, i32 16
  %42 = load i64, ptr %cbp_bits280, align 8
  %add281 = add nsw i32 %cond240408, %bit_pos_a.2397
  %sh_prom282 = zext i32 %add281 to i64
  %shl283 = shl nuw i64 1, %sh_prom282
  %and284 = and i64 %42, %shl283
  %shr287 = ashr i64 %and284, %sh_prom282
  %conv288 = trunc i64 %shr287 to i32
  br label %if.end290

if.end290:                                        ; preds = %if.then266, %if.else275, %if.end263
  %left_bit.0 = phi i32 [ %conv288, %if.else275 ], [ %cond77, %if.end263 ], [ 1, %if.then266 ]
  %mul291 = shl nsw i32 %upper_bit.0, 1
  %add292 = add nsw i32 %left_bit.0, %mul291
  %conv293 = trunc i32 %cbp_bit to i16
  %currentSlice = getelementptr inbounds %struct.ImageParameters, ptr %.pre409.pre, i64 0, i32 60
  %43 = load ptr, ptr %currentSlice, align 8
  %tex_ctx = getelementptr inbounds %struct.Slice, ptr %43, i64 0, i32 8
  %44 = load ptr, ptr %tex_ctx, align 8
  %idxprom294 = sext i32 %type to i64
  %arrayidx295 = getelementptr inbounds [10 x i32], ptr @type2ctx_bcbp, i64 0, i64 %idxprom294
  %45 = load i32, ptr %arrayidx295, align 4
  %idxprom296 = sext i32 %45 to i64
  %arrayidx297 = getelementptr inbounds %struct.TextureInfoContexts, ptr %44, i64 0, i32 3, i64 %idxprom296
...
entry:
  ...
  %3 = load ptr, ptr %tex_ctx1, align 8
...
if.then74:                                        ; preds = %for.body61
  ...
  %19 = load ptr, ptr %arrayidx80, align 8
...
for.inc89:                                        ; preds = %for.body61, %if.then74
  ...
  br i1 %exitcond158.not, label %cleanup, label %for.body61
...
if.then:                                          ; preds = %for.body
  ...
  %5 = load ptr, ptr %tex_ctx, align 8
...
if.then19:                                        ; preds = %if.then
  ...
  %9 = load ptr, ptr %currentSlice24, align 8
  %tex_ctx25 = getelementptr inbounds %struct.Slice, ptr %9, i64 0, i32 8
  %10 = load ptr, ptr %tex_ctx25, align 8
...
land.rhs.preheader:                               ; preds = %if.else
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not = icmp eq i32 %symbol, 2
  br i1 %cmp1.not, label %if.then4, label %land.rhs.1

land.rhs.1:                                       ; preds = %land.rhs.preheader
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not.1 = icmp eq i32 %symbol, 3
  br i1 %cmp1.not.1, label %if.then4, label %land.rhs.2

land.rhs.2:                                       ; preds = %land.rhs.1
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not.2 = icmp eq i32 %symbol, 4
  br i1 %cmp1.not.2, label %if.then4, label %land.rhs.3

land.rhs.3:                                       ; preds = %land.rhs.2
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not.3 = icmp eq i32 %symbol, 5
  br i1 %cmp1.not.3, label %if.then4, label %land.rhs.4

land.rhs.4:                                       ; preds = %land.rhs.3
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not.4 = icmp eq i32 %symbol, 6
  br i1 %cmp1.not.4, label %if.then4, label %land.rhs.5

land.rhs.5:                                       ; preds = %land.rhs.4
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not.5 = icmp eq i32 %symbol, 7
  br i1 %cmp1.not.5, label %if.then4, label %land.rhs.6

land.rhs.6:                                       ; preds = %land.rhs.5
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not.6 = icmp eq i32 %symbol, 8
  br i1 %cmp1.not.6, label %if.then4, label %land.rhs.7

land.rhs.7:                                       ; preds = %land.rhs.6
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not.7 = icmp eq i32 %symbol, 9
  br i1 %cmp1.not.7, label %if.then4, label %land.rhs.8

land.rhs.8:                                       ; preds = %land.rhs.7
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not.8 = icmp eq i32 %symbol, 10
  br i1 %cmp1.not.8, label %if.then4, label %land.rhs.9

land.rhs.9:                                       ; preds = %land.rhs.8
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not.9 = icmp eq i32 %symbol, 11
  br i1 %cmp1.not.9, label %if.then4, label %land.rhs.10

land.rhs.10:                                      ; preds = %land.rhs.9
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not.10 = icmp eq i32 %symbol, 12
  br i1 %cmp1.not.10, label %if.then4, label %land.rhs.11
...
if.then:                                          ; preds = %entry
  %value2 = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 2
  %1 = load i32, ptr %value2, align 8
  %2 = load i32, ptr @writeRunLevel_CABAC.pos, align 4
  %add = add nsw i32 %2, %1
  %inc = add nsw i32 %add, 1
  store i32 %inc, ptr @writeRunLevel_CABAC.pos, align 4
  %idxprom = sext i32 %add to i64
  %arrayidx = getelementptr inbounds [64 x i32], ptr @writeRunLevel_CABAC.coeff, i64 0, i64 %idxprom
  store i32 %0, ptr %arrayidx, align 4
  %3 = load i32, ptr @writeRunLevel_CABAC.coeff_ctr, align 4
  %inc2 = add nsw i32 %3, 1
  store i32 %inc2, ptr @writeRunLevel_CABAC.coeff_ctr, align 4
  br label %if.end11
...
if.else:                                          ; preds = %entry
  ...
  %7 = load i32, ptr @writeRunLevel_CABAC.coeff_ctr, align 4
...
if.then6:                                         ; preds = %if.else
  ...
  %9 = load i32, ptr %context, align 8
  %10 = load i32, ptr @writeRunLevel_CABAC.coeff_ctr, align 4
...
if.end:                                           ; preds = %if.else9, %if.then6
  store i32 0, ptr @writeRunLevel_CABAC.coeff_ctr, align 4
  store i32 0, ptr @writeRunLevel_CABAC.pos, align 4
...
while.body3:                                      ; preds = %if.else, %while.body3
  ...
  br i1 %tobool.not, label %while.end4, label %while.body3
