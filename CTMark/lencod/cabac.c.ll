...
if.end73:                                         ; preds = %if.end73.sink.split, %land.lhs.true, %lor.lhs.false, %entry
  ...
  %35 = load i32, ptr %block_a, align 4, !tbaa !17
...
land.lhs.true85:                                  ; preds = %if.else77
  ...
  %40 = load i32, ptr %type86, align 4, !tbaa !39
...
lor.lhs.false91:                                  ; preds = %land.lhs.true85, %if.else77
  ...
  %42 = load i32, ptr %arrayidx98, align 4, !tbaa !5
...
if.else104:                                       ; preds = %lor.lhs.false91
  ...
  %43 = load i32, ptr %MbaffFrameFlag105, align 4, !tbaa !53
...
land.lhs.true107:                                 ; preds = %if.else104
  ...
  %44 = load i32, ptr %mb_field108, align 8, !tbaa !29
...
land.lhs.true111:                                 ; preds = %land.lhs.true107
  ...
  %45 = load i32, ptr %mb_field116, align 8, !tbaa !29
...
if.end143:                                        ; preds = %if.end143.sink.split, %land.lhs.true85, %lor.lhs.false91, %if.end73
  ...
  %value1 = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 1
  %51 = load i32, ptr %value1, align 4, !tbaa !23
...
if.end164:                                        ; preds = %while.body.i, %if.else.i, %if.else151, %if.end143
  ...
  %52 = load ptr, ptr %dp, align 8, !tbaa !33
...
entry:
  ...
  %6 = load i32, ptr %prev_delta_qp, align 4, !tbaa !59
...
land.rhs.preheader:                               ; preds = %if.else
  ...
  br i1 %cmp1.not, label %cleanup.sink.split, label %land.rhs.1, !llvm.loop !60
...
land.rhs.1:                                       ; preds = %land.rhs.preheader
  ...
  br i1 %cmp1.not.1, label %cleanup.sink.split, label %land.rhs.2, !llvm.loop !60
...
land.rhs.2:                                       ; preds = %land.rhs.1
  ...
  br i1 %cmp1.not.2, label %cleanup.sink.split, label %land.rhs.3, !llvm.loop !60
...
land.rhs.3:                                       ; preds = %land.rhs.2
  ...
  br i1 %cmp1.not.3, label %cleanup.sink.split, label %land.rhs.4, !llvm.loop !60
...
land.rhs.4:                                       ; preds = %land.rhs.3
  ...
  br i1 %cmp1.not.4, label %cleanup.sink.split, label %land.rhs.5, !llvm.loop !60
...
land.rhs.5:                                       ; preds = %land.rhs.4
  ...
  br i1 %cmp1.not.5, label %cleanup.sink.split, label %land.rhs.6, !llvm.loop !60
...
while.body3.i:                                    ; preds = %if.else.i, %while.body3.i
  ...
  br i1 %tobool.not.i, label %cleanup, label %while.body3.i, !llvm.loop !61
...
if.else:                                          ; preds = %entry
  ...
  %7 = load i32, ptr %c_ipred_mode, align 8, !tbaa !62
...
if.else5:                                         ; preds = %if.end
  ...
  %9 = load i32, ptr %c_ipred_mode7, align 8, !tbaa !62
...
while.body.i:                                     ; preds = %if.else.i, %while.body.i
  ...
  %cmp1.not.i = icmp eq i32 %dec.i, 0
  br i1 %cmp1.not.i, label %while.end.i, label %while.body.i, !llvm.loop !63
...
while.body:                                       ; preds = %if.else, %while.body
  ...
  %dec = add i32 %dec16, -1
  %cmp1.not = icmp eq i32 %dec, 0
  br i1 %cmp1.not, label %while.end, label %while.body, !llvm.loop !63
...
if.then22:                                        ; preds = %if.end20
  ...
  %.pre64 = load ptr, ptr @img, align 8, !tbaa !9
...
if.then25:                                        ; preds = %if.then22
  ...
  %10 = load ptr, ptr %mb_data, align 8, !tbaa !16
  ...
  %12 = load i32, ptr %mb_type26, align 8, !tbaa !45
...
if.else29:                                        ; preds = %if.then25
  ...
  %13 = load i32, ptr %cbp34, align 4, !tbaa !64
  %y = getelementptr inbounds %struct.pix_pos, ptr %block_a, i64 0, i32 3
  %14 = load i32, ptr %y, align 4, !tbaa !52
  %add36 = or i32 %14, 1
  %15 = xor i32 %13, -1
...
if.end49:                                         ; preds = %if.then22, %if.then25, %if.else29, %if.else44
  ...
  %20 = load ptr, ptr %currentSlice, align 8, !tbaa !20
  %tex_ctx = getelementptr inbounds %struct.Slice, ptr %20, i64 0, i32 8
  %21 = load ptr, ptr %tex_ctx, align 8, !tbaa !46
...
entry:
  ...
  %7 = load i32, ptr %yuv_format, align 8, !tbaa !65
...
if.else:                                          ; preds = %if.then6
  ...
  %10 = load i32, ptr %cbp11, align 4, !tbaa !64
...
if.end14:                                         ; preds = %if.then6, %if.else, %if.then
  ...
  %mb_available_left = getelementptr inbounds %struct.macroblock, ptr %3, i64 %idxprom, i32 7
  %12 = load ptr, ptr %mb_available_left, align 8, !tbaa !42
...
if.then16:                                        ; preds = %if.end14
  ...
  %13 = load i32, ptr %mb_type18, align 8, !tbaa !45
...
if.else21:                                        ; preds = %if.then16
  ...
  %14 = load i32, ptr %cbp23, align 4, !tbaa !64
...
if.then33:                                        ; preds = %if.end27
  %15 = load ptr, ptr %mb_available_up, align 8, !tbaa !40
...
if.then37:                                        ; preds = %if.then33
  ...
  %16 = load i32, ptr %mb_type39, align 8, !tbaa !45
...
if.else43:                                        ; preds = %if.then37
  ...
  %17 = load i32, ptr %cbp45, align 4, !tbaa !64
...
if.end56:                                         ; preds = %if.then37, %if.then48, %if.else43, %if.then33
  ...
  %19 = load ptr, ptr %mb_available_left, align 8, !tbaa !42
...
if.then60:                                        ; preds = %if.end56
  ...
  %20 = load i32, ptr %mb_type62, align 8, !tbaa !45
...
if.else66:                                        ; preds = %if.then60
  ...
  %21 = load i32, ptr %cbp68, align 4, !tbaa !64
...
entry.land.end38_crit_edge:                       ; preds = %entry
  %.pre.pre = load ptr, ptr @img, align 8, !tbaa !9
  br label %land.end38
...
land.end15.thread:                                ; preds = %entry
  ...
  %2 = load i32, ptr %is_v_block, align 4, !tbaa !66
...
land.rhs35:                                       ; preds = %entry, %entry, %entry
  ...
  %4 = load i32, ptr %is_v_block29, align 4, !tbaa !66
...
cond.true50:                                      ; preds = %land.end38
  ...
  %9 = load i32, ptr %subblock_y, align 4, !tbaa !50
...
cond.end52:                                       ; preds = %land.end38, %cond.true50
  ...
  %12 = load i32, ptr %is_intra_block, align 8, !tbaa !67
  ...
  %13 = load i32, ptr %current_mb_nr, align 4, !tbaa !11
...
if.then:                                          ; preds = %cond.end52
  ...
  %15 = load i32, ptr %current_mb_nr82, align 4, !tbaa !11
...
if.then87:                                        ; preds = %if.then
  %16 = load i32, ptr %block_a, align 4, !tbaa !17
...
if.else:                                          ; preds = %cond.end52
  ...
  %23 = load i32, ptr %current_mb_nr103, align 4, !tbaa !11
...
if.then110:                                       ; preds = %if.else
  %24 = load i32, ptr %block_a, align 4, !tbaa !17
  ...
  %27 = load i32, ptr %block_b, align 4, !tbaa !17
...
if.then164:                                       ; preds = %cond.end161
  ...
  %30 = load i64, ptr %cbp_bits213, align 8, !tbaa !68
...
cond.false221.thread:                             ; preds = %if.then187, %if.then200, %if.then167
  ...
  store i64 %or196, ptr %cbp_bits213, align 8, !tbaa !68
...
if.then243:                                       ; preds = %if.end218, %cond.false227, %cond.end239
  ...
  %33 = load i32, ptr %block_b, align 4, !tbaa !17
  %tobool245.not = icmp eq i32 %33, 0
  %.pre409.pre = load ptr, ptr @img, align 8, !tbaa !9
...
if.then246:                                       ; preds = %if.then243
  ...
  %34 = load ptr, ptr %mb_data, align 8, !tbaa !16
  %mb_addr = getelementptr inbounds %struct.pix_pos, ptr %block_b, i64 0, i32 1
  %35 = load i32, ptr %mb_addr, align 4, !tbaa !19
  %idxprom = sext i32 %35 to i64
  %mb_type = getelementptr inbounds %struct.macroblock, ptr %34, i64 %idxprom, i32 8
  %36 = load i32, ptr %mb_type, align 8, !tbaa !45
...
if.else250:                                       ; preds = %if.then246
  ...
  %37 = load i64, ptr %cbp_bits255, align 8, !tbaa !68
...
if.end263:                                        ; preds = %if.then246, %if.else250, %if.then243
  ...
  %38 = load i32, ptr %block_a, align 4, !tbaa !17
...
if.else275:                                       ; preds = %if.then266
  ...
  %42 = load i64, ptr %cbp_bits280, align 8, !tbaa !68
...
entry:
  ...
  %4 = load i32, ptr %structure, align 8, !tbaa !69
...
for.inc:                                          ; preds = %for.body, %if.then43
  ...
  br i1 %exitcond.not, label %cleanup, label %for.body, !llvm.loop !70
...
for.inc89:                                        ; preds = %for.body61, %if.then74
  ...
  br i1 %exitcond158.not, label %cleanup, label %for.body61, !llvm.loop !71
...
land.rhs.preheader:                               ; preds = %if.else
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not = icmp eq i32 %symbol, 2
  br i1 %cmp1.not, label %if.then4, label %land.rhs.1, !llvm.loop !73

land.rhs.1:                                       ; preds = %land.rhs.preheader
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not.1 = icmp eq i32 %symbol, 3
  br i1 %cmp1.not.1, label %if.then4, label %land.rhs.2, !llvm.loop !73

land.rhs.2:                                       ; preds = %land.rhs.1
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not.2 = icmp eq i32 %symbol, 4
  br i1 %cmp1.not.2, label %if.then4, label %land.rhs.3, !llvm.loop !73

land.rhs.3:                                       ; preds = %land.rhs.2
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not.3 = icmp eq i32 %symbol, 5
  br i1 %cmp1.not.3, label %if.then4, label %land.rhs.4, !llvm.loop !73

land.rhs.4:                                       ; preds = %land.rhs.3
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not.4 = icmp eq i32 %symbol, 6
  br i1 %cmp1.not.4, label %if.then4, label %land.rhs.5, !llvm.loop !73

land.rhs.5:                                       ; preds = %land.rhs.4
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not.5 = icmp eq i32 %symbol, 7
  br i1 %cmp1.not.5, label %if.then4, label %land.rhs.6, !llvm.loop !73

land.rhs.6:                                       ; preds = %land.rhs.5
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not.6 = icmp eq i32 %symbol, 8
  br i1 %cmp1.not.6, label %if.then4, label %land.rhs.7, !llvm.loop !73

land.rhs.7:                                       ; preds = %land.rhs.6
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not.7 = icmp eq i32 %symbol, 9
  br i1 %cmp1.not.7, label %if.then4, label %land.rhs.8, !llvm.loop !73

land.rhs.8:                                       ; preds = %land.rhs.7
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not.8 = icmp eq i32 %symbol, 10
  br i1 %cmp1.not.8, label %if.then4, label %land.rhs.9, !llvm.loop !73

land.rhs.9:                                       ; preds = %land.rhs.8
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not.9 = icmp eq i32 %symbol, 11
  br i1 %cmp1.not.9, label %if.then4, label %land.rhs.10, !llvm.loop !73

land.rhs.10:                                      ; preds = %land.rhs.9
  tail call void @biari_encode_symbol(ptr noundef %eep_dp, i16 noundef signext 1, ptr noundef %ctx) #12
  %cmp1.not.10 = icmp eq i32 %symbol, 12
  br i1 %cmp1.not.10, label %if.then4, label %land.rhs.11, !llvm.loop !73
...
while.body3:                                      ; preds = %if.else, %while.body3
  ...
  br i1 %tobool.not, label %while.end4, label %while.body3, !llvm.loop !61
