; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/img_chroma.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/img_chroma.c"
...
entry:
  ...
  %0 = load i32, ptr %size_x_cr, align 8
  %sub = add i32 %0, -1
  ...
  %3 = load i32, ptr %yuv_format, align 8
...
if.end6:                                          ; preds = %entry, %if.then4, %if.else5
  ...
  %mul = shl i32 %4, 1
  %5 = load i32, ptr @img_pad_size_uv_y, align 4
  %sub29 = sub i32 0, %5
...
if.end6.split.us:                                 ; preds = %if.end6
  ...
  %6 = load ptr, ptr %imgUV_sub, align 8
...
for.body16.us.us:                                 ; preds = %for.end128.split.us.us.us, %if.end6.split.us
  ...
  %27 = load ptr, ptr %arrayidx37.us.us.us, align 8
...
for.body22.us.us.us:                              ; preds = %for.cond30.for.inc125_crit_edge.us.us.us, %for.body16.us.us
  ...
  %34 = load ptr, ptr %arrayidx39.us.us.us, align 8
...
for.body33.us.us.us:                              ; preds = %for.inc121.us.us.us, %for.body22.us.us.us
  ...
  %35 = load ptr, ptr %arrayidx41.us.us.us, align 8
  ...
  %36 = load ptr, ptr %arrayidx46.us.us.us, align 8
  ...
  %37 = load ptr, ptr %arrayidx51.us.us.us, align 8
...
vector.body324:                                   ; preds = %vector.body324, %vector.ph319
  ...
  store <8 x i16> %47, ptr %48, align 2
  %index.next334 = add nuw i64 %index325, 8
  %49 = icmp eq i64 %index.next334, %n.vec321
  br i1 %49, label %middle.block316, label %vector.body324
...
for.body55.us.us.us.prol:                         ; preds = %for.body55.us.us.us.preheader444
  ...
  store i16 %conv63.us.us.us.prol, ptr %arrayidx65.us.us.us.prol, align 2
...
for.inc121.us.us.us:                              ; preds = %for.body103.us.us.us, %middle.block, %for.cond99.preheader.us.us.us
  ...
  br i1 %exitcond239.not, label %for.cond30.for.inc125_crit_edge.us.us.us, label %for.body33.us.us.us
...
for.body103.us.us.us:                             ; preds = %for.body103.us.us.us.preheader, %for.body103.us.us.us
  ...
  %55 = load i16, ptr %arrayidx105.us.us.us, align 2
  %56 = load i16, ptr %arrayidx109.us.us.us, align 2
  ...
  store i16 %conv114.us.us.us, ptr %arrayidx116.us.us.us, align 2
  %inc118.us.us.us = add nsw i32 %i.2210.us.us.us, 1
  %indvars.iv.next232 = add nuw nsw i64 %indvars.iv231, 1
  %exitcond234.not = icmp eq i32 %inc118.us.us.us, %sub100
  br i1 %exitcond234.not, label %for.inc121.us.us.us, label %for.body103.us.us.us
...
for.body70.us.us.us:                              ; preds = %for.body70.us.us.us.preheader443, %for.body70.us.us.us
  ...
  %64 = load i16, ptr %arrayidx73.us.us.us, align 2
  ...
  %65 = load i16, ptr %arrayidx77.us.us.us, align 2
  ...
  %66 = load i16, ptr %arrayidx82.us.us.us, align 2
  ...
  %67 = load i16, ptr %arrayidx87.us.us.us, align 2
  ...
  store i16 %conv92.us.us.us, ptr %arrayidx94.us.us.us, align 2
  %indvars.iv.next223 = add nuw nsw i64 %indvars.iv222, 1
  %exitcond230.not = icmp eq i64 %indvars.iv.next225, %wide.trip.count229
  br i1 %exitcond230.not, label %for.cond99.preheader.us.us.us.loopexit, label %for.body70.us.us.us
...
for.body55.us.us.us:                              ; preds = %for.body55.us.us.us.prol.loopexit, %for.body55.us.us.us
  ...
  store i16 %conv63.us.us.us, ptr %arrayidx65.us.us.us, align 2
  ...
  store i16 %conv63.us.us.us.1453, ptr %arrayidx65.us.us.us.1454, align 2
  %indvars.iv.next.1455 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1455, %wide.trip.count
  br i1 %exitcond.not.1, label %for.cond67.preheader.us.us.us, label %for.body55.us.us.us
...
vector.body290:                                   ; preds = %vector.body290, %vector.ph283
  ...
  store <8 x i16> %97, ptr %98, align 2
  %index.next304 = add nuw i64 %index291, 8
  %99 = icmp eq i64 %index.next304, %n.vec285
  br i1 %99, label %middle.block280, label %vector.body290
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %102 = load i16, ptr %arrayidx105.us.us.us, align 2
  ...
  %105 = load i16, ptr %arrayidx109.us.us.us, align 2
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <8 x i16> %111, ptr %112, align 2
...
for.cond30.for.inc125_crit_edge.us.us.us:         ; preds = %for.inc121.us.us.us
  ...
  br i1 %exitcond244.not, label %for.end128.split.us.us.us, label %for.body22.us.us.us
...
for.inc133.split.us.us:                           ; preds = %for.end128.split.us.us.us
  ...
  %n.vec353 = and i64 %120, 8589934584
...
for.body16.us.us.1:                               ; preds = %for.end128.split.us.us.us.1, %for.inc133.split.us.us
  ...
  %132 = load ptr, ptr %arrayidx37.us.us.us.1, align 8
...
for.body22.us.us.us.1:                            ; preds = %for.cond30.for.inc125_crit_edge.us.us.us.1, %for.body16.us.us.1
  ...
  %139 = load ptr, ptr %arrayidx39.us.us.us.1, align 8
...
for.body33.us.us.us.1:                            ; preds = %for.inc121.us.us.us.1, %for.body22.us.us.us.1
  ...
  %140 = load ptr, ptr %arrayidx41.us.us.us.1, align 8
  ...
  %141 = load ptr, ptr %arrayidx46.us.us.us.1, align 8
  ...
  %142 = load ptr, ptr %arrayidx51.us.us.us.1, align 8
...
vector.body430:                                   ; preds = %vector.body430, %vector.ph425
  ...
  store <8 x i16> %152, ptr %153, align 2
  %index.next440 = add nuw i64 %index431, 8
  %154 = icmp eq i64 %index.next440, %n.vec427
  br i1 %154, label %middle.block422, label %vector.body430
...
for.body55.us.us.us.1.prol:                       ; preds = %for.body55.us.us.us.1.preheader441
  ...
  store i16 %conv63.us.us.us.1.prol, ptr %arrayidx65.us.us.us.1.prol, align 2
...
for.body55.us.us.us.1:                            ; preds = %for.body55.us.us.us.1.prol.loopexit, %for.body55.us.us.us.1
  ...
  store i16 %conv63.us.us.us.1, ptr %arrayidx65.us.us.us.1, align 2
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv.1, 1
  %163 = load i16, ptr %141, align 2
  %conv.us.us.us.1.1 = zext i16 %163 to i32
  %mul57.us.us.us.1.1 = mul nsw i32 %137, %conv.us.us.us.1.1
  %164 = load i16, ptr %142, align 2
  ...
  store i16 %conv63.us.us.us.1.1, ptr %arrayidx65.us.us.us.1.1, align 2
  %indvars.iv.next.1.1 = add nuw nsw i64 %indvars.iv.1, 2
  %exitcond.1.not.1 = icmp eq i64 %indvars.iv.next.1.1, %wide.trip.count.1
  br i1 %exitcond.1.not.1, label %for.cond67.preheader.us.us.us.1, label %for.body55.us.us.us.1
...
vector.body395:                                   ; preds = %vector.body395, %vector.ph388
  ...
  %wide.load398 = load <8 x i16>, ptr %168, align 2
  ...
  %wide.load401 = load <8 x i16>, ptr %171, align 2
  ...
  %wide.load404 = load <8 x i16>, ptr %174, align 2
  ...
  %wide.load405 = load <8 x i16>, ptr %177, align 2
  ...
  store <8 x i16> %187, ptr %188, align 2
  %index.next410 = add nuw i64 %index396, 8
  %189 = icmp eq i64 %index.next410, %n.vec390
  br i1 %189, label %middle.block385, label %vector.body395
...
for.body70.us.us.us.1:                            ; preds = %for.body70.us.us.us.1.preheader, %for.body70.us.us.us.1
  ...
  %190 = load i16, ptr %arrayidx73.us.us.us.1, align 2
  ...
  %191 = load i16, ptr %arrayidx77.us.us.us.1, align 2
  ...
  %192 = load i16, ptr %arrayidx82.us.us.us.1, align 2
  ...
  %193 = load i16, ptr %arrayidx87.us.us.us.1, align 2
  ...
  store i16 %conv92.us.us.us.1, ptr %arrayidx94.us.us.us.1, align 2
  ...
  br i1 %exitcond230.1.not, label %for.cond99.preheader.us.us.us.loopexit.1, label %for.body70.us.us.us.1
...
vector.ph351:                                     ; preds = %vector.memcheck335
  ...
  %198 = load i16, ptr %arrayidx105.us.us.us.1, align 2
  ...
  %201 = load i16, ptr %arrayidx109.us.us.us.1, align 2
...
vector.body360:                                   ; preds = %vector.body360, %vector.ph351
  ...
  store <8 x i16> %207, ptr %208, align 2
  %index.next371 = add nuw i64 %index361, 8
  %209 = icmp eq i64 %index.next371, %n.vec353
  br i1 %209, label %middle.block348, label %vector.body360
...
for.body103.us.us.us.1:                           ; preds = %for.body103.us.us.us.1.preheader, %for.body103.us.us.us.1
  ...
  %210 = load i16, ptr %arrayidx105.us.us.us.1, align 2
  %211 = load i16, ptr %arrayidx109.us.us.us.1, align 2
  ...
  store i16 %conv114.us.us.us.1, ptr %arrayidx116.us.us.us.1, align 2
  ...
  br i1 %exitcond234.1.not, label %for.inc121.us.us.us.1, label %for.body103.us.us.us.1
...
for.inc121.us.us.us.1:                            ; preds = %for.body103.us.us.us.1, %middle.block348, %for.cond99.preheader.us.us.us.1
  ...
  br i1 %exitcond239.1.not, label %for.cond30.for.inc125_crit_edge.us.us.us.1, label %for.body33.us.us.us.1
...
for.cond30.for.inc125_crit_edge.us.us.us.1:       ; preds = %for.inc121.us.us.us.1
  ...
  br i1 %exitcond244.1.not, label %for.end128.split.us.us.us.1, label %for.body22.us.us.us.1
...
for.end128.split.us.us.us.1:                      ; preds = %for.cond30.for.inc125_crit_edge.us.us.us.1
  ...
  br i1 %exitcond249.1.not, label %for.end135, label %for.body16.us.us.1
