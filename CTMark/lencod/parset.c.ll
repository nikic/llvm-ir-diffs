; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/parset.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/parset.c"
...
entry:
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(2048) @PicParSet, i8 0, i64 2048, i1 false)
  ...
  %1 = load i32, ptr %GenerateMultiplePPS, align 8
  %tobool.not = icmp eq i32 %1, 0
  %call13 = tail call ptr @AllocPPS() #12
  store ptr %call13, ptr @PicParSet, align 16
  br i1 %tobool.not, label %if.else12, label %if.then

if.then:                                          ; preds = %entry
  %call2 = tail call ptr @AllocPPS() #12
  store ptr %call2, ptr getelementptr inbounds ([256 x ptr], ptr @PicParSet, i64 0, i64 1), align 8
  %call3 = tail call ptr @AllocPPS() #12
  store ptr %call3, ptr getelementptr inbounds ([256 x ptr], ptr @PicParSet, i64 0, i64 2), align 16
  ...
  %3 = load ptr, ptr @PicParSet, align 16
...
if.else:                                          ; preds = %if.then
  ...
  %15 = load i32, ptr %chroma_qp_index_offset, align 8
  ...
  %16 = load ptr, ptr getelementptr inbounds ([256 x ptr], ptr @PicParSet, i64 0, i64 1), align 8
  %17 = load ptr, ptr @input, align 8
  %chroma_qp_index_offset10 = getelementptr inbounds %struct.InputParameters, ptr %17, i64 0, i32 105
  %18 = load i32, ptr %chroma_qp_index_offset10, align 8
  ...
  %19 = load ptr, ptr getelementptr inbounds ([256 x ptr], ptr @PicParSet, i64 0, i64 2), align 16
  %20 = load ptr, ptr @input, align 8
  %chroma_qp_index_offset11 = getelementptr inbounds %struct.InputParameters, ptr %20, i64 0, i32 105
  %21 = load i32, ptr %chroma_qp_index_offset11, align 8
...
if.else12:                                        ; preds = %entry
  ...
  %22 = load i32, ptr %profile_idc14, align 4
...
if.else19:                                        ; preds = %if.else12
  ...
  %28 = load i32, ptr %chroma_qp_index_offset22, align 8
...
if.end24:                                         ; preds = %if.then16, %if.else19, %if.then5, %if.else
  store ptr %call, ptr @active_sps, align 8
  %29 = load ptr, ptr @PicParSet, align 16
  store ptr %29, ptr @active_pps, align 8
  ret void
}
...
if.then:                                          ; preds = %entry
  store i32 11, ptr %level_idc, align 4
  br label %if.end
...
if.end:                                           ; preds = %entry, %if.then
  ...
  store i32 0, ptr %seq_parameter_set_id, align 4
  ...
  %7 = load <2 x i32>, ptr %BitDepthLuma, align 8
  %8 = add nsw <2 x i32> %7, <i32 -8, i32 -8>
  store <2 x i32> %8, ptr %bit_depth_luma_minus8, align 4
  %lossless_qpprime_y_zero_flag = getelementptr inbounds %struct.InputParameters, ptr %0, i64 0, i32 179
  %9 = load i32, ptr %lossless_qpprime_y_zero_flag, align 4
  ...
  store i32 %and, ptr %lossless_qpprime_flag, align 4
  ...
  %14 = load <4 x i32>, ptr %delta_pic_order_always_zero_flag, align 4
  store <4 x i32> %14, ptr %delta_pic_order_always_zero_flag21, align 4
...
for.body:                                         ; preds = %if.end, %for.body
  ...
  %17 = load i32, ptr %num_ref_frames_in_pic_order_cnt_cycle, align 8
...
for.end:                                          ; preds = %for.body, %if.end
  ...
  store i32 %sub41, ptr %pic_height_in_map_units_minus1, align 4
  ...
  %.pre231.pre = load i32, ptr %yuv_format53.phi.trans.insert.phi.trans.insert, align 8
...
lor.rhs49:                                        ; preds = %for.end
  ...
  %29 = load i32, ptr %Generate_SEIVUI, align 4
...
lor.end51:                                        ; preds = %for.end, %lor.rhs49
  ...
  store i32 %lor.ext52, ptr %vui_parameters_present_flag, align 4
  %chroma_format_idc = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 8
  store i32 %31, ptr %chroma_format_idc, align 4
  ...
  store ptr %call63, ptr @Co_located, align 8
...
if.then81.6:                                      ; preds = %if.else79.6
  ...
  %42 = load i32, ptr %arrayidx84.6, align 4
...
if.else79.7:                                      ; preds = %if.else79.6, %if.then81.6
  ...
  store i32 %and85.6.sink, ptr %arrayidx88.6, align 4
  %43 = load i32, ptr %Transform8x8Mode, align 4
...
if.else89.7:                                      ; preds = %if.else79.7
  ...
  store i32 0, ptr %arrayidx92.7, align 4
  br label %if.end110
...
if.then116:                                       ; preds = %if.end110
  ...
  %49 = load i32, ptr %arrayidx120, align 4
  ...
  store i32 %div121, ptr %frame_cropping_rect_right_offset, align 4
  ...
  %51 = load i32, ptr %frame_mbs_only_flag, align 4
  %sub127 = sub i32 2, %51
  ...
  store i32 %div129, ptr %frame_cropping_rect_bottom_offset, align 4
  %rem = srem i32 %46, %49
...
if.then135:                                       ; preds = %if.then116
  ...
  %.pre233 = load ptr, ptr @img, align 8
  %auto_crop_bottom137.phi.trans.insert = getelementptr inbounds %struct.ImageParameters, ptr %.pre233, i64 0, i32 167
  %.pre234 = load i32, ptr %auto_crop_bottom137.phi.trans.insert, align 4
  %.pre235 = load i32, ptr %chroma_format_idc, align 4
  ...
  %.pre236 = load i32, ptr %arrayidx140.phi.trans.insert, align 4
  %.pre237 = load i32, ptr %frame_mbs_only_flag, align 4
...
if.else148:                                       ; preds = %if.end110
  store i32 0, ptr %frame_cropping_flag149, align 4
  br label %if.end150
...
if.then:                                          ; preds = %entry
  ...
  store i32 %cond11, ptr %transform_8x8_mode_flag, align 8
  ...
  %8 = load <2 x i32>, ptr %ScalingMatrixPresentFlag, align 8
  ...
  %11 = load i32, ptr %arrayidx.us.1, align 4
  ...
  %13 = load i32, ptr %arrayidx.us.2, align 4
  ...
  %15 = load i32, ptr %arrayidx.us.3, align 4
  ...
  %17 = load i32, ptr %arrayidx.us.4, align 4
  ...
  %19 = load i32, ptr %arrayidx.us.5, align 4
...
for.inc.us.7:                                     ; preds = %if.then
  ...
  %21 = load i32, ptr %arrayidx24.us.6, align 4
  ...
  %23 = load i32, ptr %arrayidx24.us.7, align 4
...
if.else35:                                        ; preds = %entry
  ...
  store i32 0, ptr %Transform8x8Mode47, align 4
  br label %if.end48
...
if.then53:                                        ; preds = %if.end48
  ...
  store ptr %call55, ptr %slice_group_id, align 8
...
if.end59:                                         ; preds = %if.then58, %if.then53
  ...
  %33 = load i32, ptr %slice_group_map_type, align 4
...
sw.bb:                                            ; preds = %if.end59
  ...
  store i32 0, ptr %slice_group_map_type60, align 8
  %34 = load i32, ptr %num_slice_groups_minus150, align 4
  %run_length_minus1 = getelementptr inbounds %struct.InputParameters, ptr %32, i64 0, i32 145
  %35 = load ptr, ptr %run_length_minus1, align 8
  %36 = add i32 %34, 1
  %umax = tail call i32 @llvm.umax.i32(i32 %36, i32 1)
  %wide.trip.count256 = zext i32 %umax to i64
  %min.iters.check280 = icmp ult i32 %36, 8
...
for.body65.prol:                                  ; preds = %for.body65.preheader, %for.body65.prol
  ...
  br i1 %prol.iter.cmp.not, label %for.body65.prol.loopexit, label %for.body65.prol
...
sw.bb96:                                          ; preds = %if.end59, %if.end59, %if.end59
  ...
  store i32 %33, ptr %slice_group_map_type98, align 8
  ...
  %72 = load <2 x i32>, ptr %slice_group_change_direction_flag, align 8
  store <2 x i32> %72, ptr %slice_group_change_direction_flag99, align 4
  br label %if.end124
...
sw.bb101:                                         ; preds = %if.end59
  ...
  store i32 %sub108, ptr %pic_size_in_map_units_minus1, align 4
...
for.body113:                                      ; preds = %sw.bb101, %for.body113
  ...
  %80 = load ptr, ptr %slice_group_id114, align 8
  ...
  %82 = load ptr, ptr %slice_group_id, align 8
  %arrayidx119 = getelementptr inbounds i8, ptr %82, i64 %idxprom115
  store i8 %81, ptr %arrayidx119, align 1
  %inc121 = add i32 %i.4239, 1
  %83 = load i32, ptr %pic_size_in_map_units_minus1, align 4
  %cmp111.not = icmp ugt i32 %inc121, %83
  br i1 %cmp111.not, label %if.end124, label %for.body113
...
if.end124:                                        ; preds = %for.body113, %for.body82.prol.loopexit, %for.body82, %for.body65.prol.loopexit, %for.body65, %middle.block, %middle.block278, %sw.bb76, %sw.bb74, %sw.bb96, %sw.default, %if.end48
  ...
  %84 = load i32, ptr %frame_mbs_only_flag125, align 4
  ...
  %85 = load i32, ptr %num_ref_frames128, align 4
  ...
  store i32 %92, ptr %redundant_pic_cnt_present_flag, align 4
  ret void
}
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %4 = load i32, ptr %constrained_set3_flag, align 4
...
if.then26:                                        ; preds = %if.end, %if.end, %if.end, %if.end
  %chroma_format_idc = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 8
  %8 = load i32, ptr %chroma_format_idc, align 4
...
if.end33:                                         ; preds = %if.then30, %if.then26
  %bit_depth_luma_minus8 = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 11
  %11 = load i32, ptr %bit_depth_luma_minus8, align 4
  ...
  %12 = load i32, ptr %bit_depth_chroma_minus8, align 4
  ...
  %seq_scaling_matrix_present_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 9
  %15 = load i32, ptr %seq_scaling_matrix_present_flag, align 4
  %call40 = tail call i32 @u_1(ptr noundef nonnull @.str.19, i32 noundef %15, ptr noundef nonnull %call) #12
  %16 = load i32, ptr %seq_scaling_matrix_present_flag, align 4
...
for.body.us.i:                                    ; preds = %if.end28.thread.us.i, %if.then53
  %indvars.iv76.i = phi i64 [ %indvars.iv.next77.i, %if.end28.thread.us.i ], [ 0, %if.then53 ]
  %nextScale.073.us.i = phi i32 [ %nextScale.166.us.i, %if.end28.thread.us.i ], [ 8, %if.then53 ]
  %lastScale.072.us.i = phi i32 [ %23, %if.end28.thread.us.i ], [ 8, %if.then53 ]
  ...
  %cmp5.not.us.i = icmp eq i32 %nextScale.073.us.i, 0
  %.pre.i = zext i8 %cond.in.us.i to i64
  br i1 %cmp5.not.us.i, label %if.end28.thread.us.i, label %if.end28.us.i

if.end28.us.i:                                    ; preds = %for.body.us.i
  %arrayidx8.us.i = getelementptr inbounds i16, ptr %arrayidx55, i64 %.pre.i
  %19 = load i16, ptr %arrayidx8.us.i, align 2
  %conv9.us.i = sext i16 %19 to i32
  %sub.us.i = sub nsw i32 %conv9.us.i, %lastScale.072.us.i
  ...
  %20 = load i16, ptr %arrayidx8.us.i, align 2
  ...
  %22 = load i16, ptr %arrayidx60, align 2
  %or.us.i = or i16 %22, %land.ext.us.i
  store i16 %or.us.i, ptr %arrayidx60, align 2
  %spec.select68.us.i = select i1 %cmp24.us.i, i32 %lastScale.072.us.i, i32 %conv21.us.i
  br label %if.end28.thread.us.i

if.end28.thread.us.i:                             ; preds = %if.end28.us.i, %for.body.us.i
  %nextScale.166.us.i = phi i32 [ %conv21.us.i, %if.end28.us.i ], [ 0, %for.body.us.i ]
  %23 = phi i32 [ %spec.select68.us.i, %if.end28.us.i ], [ %lastScale.072.us.i, %for.body.us.i ]
  %conv35.us.i = trunc i32 %23 to i16
  %arrayidx37.us.i = getelementptr inbounds i16, ptr %arrayidx57, i64 %.pre.i
  store i16 %conv35.us.i, ptr %arrayidx37.us.i, align 2
  %indvars.iv.next77.i = add nuw nsw i64 %indvars.iv76.i, 1
  %exitcond80.not.i = icmp eq i64 %indvars.iv.next77.i, 16
  br i1 %exitcond80.not.i, label %for.inc, label %for.body.us.i
...
for.body.i:                                       ; preds = %if.end28.thread.i, %if.else
  %indvars.iv.i = phi i64 [ 0, %if.else ], [ %indvars.iv.next.i, %if.end28.thread.i ]
  %nextScale.073.i = phi i32 [ 8, %if.else ], [ %nextScale.166.i, %if.end28.thread.i ]
  %lastScale.072.i = phi i32 [ 8, %if.else ], [ %29, %if.end28.thread.i ]
  %arrayidx3.i = getelementptr inbounds [64 x i8], ptr @ZZ_SCAN8, i64 0, i64 %indvars.iv.i
  %cond.in.i = load i8, ptr %arrayidx3.i, align 1
  %cmp5.not.i = icmp eq i32 %nextScale.073.i, 0
  %.pre81.i = zext i8 %cond.in.i to i64
  br i1 %cmp5.not.i, label %if.end28.thread.i, label %if.end28.i

if.end28.i:                                       ; preds = %for.body.i
  %arrayidx8.i = getelementptr inbounds i16, ptr %arrayidx64, i64 %.pre81.i
  %25 = load i16, ptr %arrayidx8.i, align 2
  %conv9.i = sext i16 %25 to i32
  %sub.i = sub nsw i32 %conv9.i, %lastScale.072.i
  ...
  %28 = load i16, ptr %arrayidx72, align 2
  %or.i = or i16 %28, %land.ext.i
  store i16 %or.i, ptr %arrayidx72, align 2
  %spec.select68.i = select i1 %cmp24.i, i32 %lastScale.072.i, i32 %conv21.i
  br label %if.end28.thread.i

if.end28.thread.i:                                ; preds = %if.end28.i, %for.body.i
  %nextScale.166.i = phi i32 [ %conv21.i, %if.end28.i ], [ 0, %for.body.i ]
  %29 = phi i32 [ %spec.select68.i, %if.end28.i ], [ %lastScale.072.i, %for.body.i ]
  %conv35.i = trunc i32 %29 to i16
  %arrayidx37.i = getelementptr inbounds i16, ptr %arrayidx68, i64 %.pre81.i
  store i16 %conv35.i, ptr %arrayidx37.i, align 2
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 64
  br i1 %exitcond.not.i, label %for.inc, label %for.body.i

for.inc:                                          ; preds = %if.end28.thread.i, %if.end28.thread.us.i, %for.body
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 8
  br i1 %exitcond.not, label %if.end78, label %for.body

if.end78:                                         ; preds = %for.inc, %if.end, %if.end33
  %log2_max_frame_num_minus4 = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 13
  %30 = load i32, ptr %log2_max_frame_num_minus4, align 4
...
if.then85:                                        ; preds = %if.end78
  %log2_max_pic_order_cnt_lsb_minus4 = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 15
  %33 = load i32, ptr %log2_max_pic_order_cnt_lsb_minus4, align 4
...
if.then91:                                        ; preds = %if.end78
  ...
  %34 = load i32, ptr %delta_pic_order_always_zero_flag, align 4
  ...
  %35 = load i32, ptr %offset_for_non_ref_pic, align 4
  ...
  %36 = load i32, ptr %offset_for_top_to_bottom_field, align 4
  ...
  %37 = load i32, ptr %num_ref_frames_in_pic_order_cnt_cycle, align 4
  %call98 = tail call i32 @ue_v(ptr noundef nonnull @.str.27, i32 noundef %37, ptr noundef %call) #12
  %38 = load i32, ptr %num_ref_frames_in_pic_order_cnt_cycle, align 4
...
if.end128:                                        ; preds = %if.then125, %if.end112
  %direct_8x8_inference_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 27
  %49 = load i32, ptr %direct_8x8_inference_flag, align 4
...
if.end144:                                        ; preds = %if.then135, %if.end128
  %vui_parameters_present_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 33
  %56 = load i32, ptr %vui_parameters_present_flag, align 4
  %call145 = tail call i32 @u_1(ptr noundef nonnull @.str.41, i32 noundef %56, ptr noundef %call) #12
  %57 = load i32, ptr %vui_parameters_present_flag, align 4
...
if.then149:                                       ; preds = %if.end144
  ...
  %59 = load i32, ptr %rgb_input_flag.i, align 8
...
land.lhs.true.i:                                  ; preds = %if.then149
  ...
  %60 = load i32, ptr %yuv_format.i, align 8
...
if.else.i:                                        ; preds = %land.lhs.true.i, %if.then149
  ...
  %61 = load i32, ptr %Generate_SEIVUI.i, align 4
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %7 = load i32, ptr %num_slice_groups_minus1, align 4
...
for.cond27.preheader:                             ; preds = %if.then14
  %10 = load i32, ptr %num_slice_groups_minus1, align 4
...
for.body:                                         ; preds = %if.then14, %for.body
  ...
  br i1 %cmp21.not, label %if.end91, label %for.body
...
for.body30:                                       ; preds = %for.cond27.preheader, %for.body30
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %15 = load i32, ptr %num_slice_groups_minus1, align 4
  %16 = zext i32 %15 to i64
  %cmp29 = icmp ult i64 %indvars.iv.next, %16
  br i1 %cmp29, label %for.body30, label %if.end91
...
if.then50:                                        ; preds = %if.then14, %if.then14, %if.then14
  ...
  %17 = load i32, ptr %slice_group_change_direction_flag, align 4
...
if.end73:                                         ; preds = %if.else66, %if.else62, %if.then58
  ...
  %pic_size_in_map_units_minus1 = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 15
  %20 = load i32, ptr %pic_size_in_map_units_minus1, align 4
...
for.body79:                                       ; preds = %if.end73, %for.body79
  ...
  %21 = load ptr, ptr %slice_group_id, align 8
  ...
  %23 = load i32, ptr %pic_size_in_map_units_minus1, align 4
  %cmp78.not = icmp ugt i32 %inc85, %23
  br i1 %cmp78.not, label %if.end91, label %for.body79
...
for.body.us.i:                                    ; preds = %if.end28.thread.us.i, %if.then164
  %indvars.iv76.i = phi i64 [ %indvars.iv.next77.i, %if.end28.thread.us.i ], [ 0, %if.then164 ]
  %nextScale.073.us.i = phi i32 [ %nextScale.166.us.i, %if.end28.thread.us.i ], [ 8, %if.then164 ]
  %lastScale.072.us.i = phi i32 [ %45, %if.end28.thread.us.i ], [ 8, %if.then164 ]
  %arrayidx.us.i = getelementptr inbounds [16 x i8], ptr @ZZ_SCAN, i64 0, i64 %indvars.iv76.i
  %cond.in.us.i = load i8, ptr %arrayidx.us.i, align 1
  %cmp5.not.us.i = icmp eq i32 %nextScale.073.us.i, 0
  %.pre.i = zext i8 %cond.in.us.i to i64
...
if.end28.us.i:                                    ; preds = %for.body.us.i
  %arrayidx8.us.i = getelementptr inbounds i16, ptr %arrayidx166, i64 %.pre.i
  %41 = load i16, ptr %arrayidx8.us.i, align 2
  ...
  %delta_scale.0.us.i = select i1 %cmp10.us.i, i32 %sub13.us.i, i32 %spec.select.us.i
  %call.us.i = tail call i32 @se_v(ptr noundef nonnull @.str.4, i32 noundef %delta_scale.0.us.i, ptr noundef %call) #12
  %42 = load i16, ptr %arrayidx8.us.i, align 2
  ...
  %44 = load i16, ptr %arrayidx171, align 2
  %or.us.i = or i16 %44, %land.ext.us.i
  store i16 %or.us.i, ptr %arrayidx171, align 2
  %spec.select68.us.i = select i1 %cmp24.us.i, i32 %lastScale.072.us.i, i32 %conv21.us.i
  br label %if.end28.thread.us.i

if.end28.thread.us.i:                             ; preds = %if.end28.us.i, %for.body.us.i
  %nextScale.166.us.i = phi i32 [ %conv21.us.i, %if.end28.us.i ], [ 0, %for.body.us.i ]
  %45 = phi i32 [ %spec.select68.us.i, %if.end28.us.i ], [ %lastScale.072.us.i, %for.body.us.i ]
  %conv35.us.i = trunc i32 %45 to i16
  %arrayidx37.us.i = getelementptr inbounds i16, ptr %arrayidx168, i64 %.pre.i
  store i16 %conv35.us.i, ptr %arrayidx37.us.i, align 2
  %indvars.iv.next77.i = add nuw nsw i64 %indvars.iv76.i, 1
  %exitcond80.not.i = icmp eq i64 %indvars.iv.next77.i, 16
  br i1 %exitcond80.not.i, label %for.inc189, label %for.body.us.i
...
for.body.i:                                       ; preds = %if.end28.thread.i, %if.else174
  %indvars.iv.i = phi i64 [ 0, %if.else174 ], [ %indvars.iv.next.i, %if.end28.thread.i ]
  %nextScale.073.i = phi i32 [ 8, %if.else174 ], [ %nextScale.166.i, %if.end28.thread.i ]
  %lastScale.072.i = phi i32 [ 8, %if.else174 ], [ %51, %if.end28.thread.i ]
  %arrayidx3.i = getelementptr inbounds [64 x i8], ptr @ZZ_SCAN8, i64 0, i64 %indvars.iv.i
  %cond.in.i = load i8, ptr %arrayidx3.i, align 1
  %cmp5.not.i = icmp eq i32 %nextScale.073.i, 0
  %.pre81.i = zext i8 %cond.in.i to i64
...
if.end28.i:                                       ; preds = %for.body.i
  %arrayidx8.i = getelementptr inbounds i16, ptr %arrayidx176, i64 %.pre81.i
  ...
  %delta_scale.0.i = select i1 %cmp10.i, i32 %sub13.i, i32 %spec.select.i
  %call.i = tail call i32 @se_v(ptr noundef nonnull @.str.4, i32 noundef %delta_scale.0.i, ptr noundef %call) #12
  %48 = load i16, ptr %arrayidx8.i, align 2
  %.fr.i = freeze i16 %48
  %conv21.i = sext i16 %.fr.i to i32
  %cmp22.i = icmp eq i64 %indvars.iv.i, 0
  %cmp24.i = icmp eq i16 %.fr.i, 0
  ...
  %50 = load i16, ptr %arrayidx184, align 2
  %or.i = or i16 %50, %land.ext.i
  store i16 %or.i, ptr %arrayidx184, align 2
  %spec.select68.i = select i1 %cmp24.i, i32 %lastScale.072.i, i32 %conv21.i
  br label %if.end28.thread.i

if.end28.thread.i:                                ; preds = %if.end28.i, %for.body.i
  %nextScale.166.i = phi i32 [ %conv21.i, %if.end28.i ], [ 0, %for.body.i ]
  %51 = phi i32 [ %spec.select68.i, %if.end28.i ], [ %lastScale.072.i, %for.body.i ]
  %conv35.i = trunc i32 %51 to i16
  %arrayidx37.i = getelementptr inbounds i16, ptr %arrayidx180, i64 %.pre81.i
  store i16 %conv35.i, ptr %arrayidx37.i, align 2
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 64
  br i1 %exitcond.not.i, label %for.inc189, label %for.body.i

for.inc189:                                       ; preds = %if.end28.thread.i, %if.end28.thread.us.i, %for.body152
  %indvars.iv.next355 = add nuw nsw i64 %indvars.iv354, 1
  %52 = load i32, ptr %transform_8x8_mode_flag, align 8
  %shl = shl i32 %52, 1
  %add149 = add i32 %shl, 6
  %53 = zext i32 %add149 to i64
  %cmp150 = icmp ult i64 %indvars.iv.next355, %53
  br i1 %cmp150, label %for.body152, label %if.end192
...
if.end192:                                        ; preds = %for.inc189, %if.then146, %if.then140
  ...
  %54 = load i32, ptr %cr_qp_index_offset, align 8
...
entry:
  %cmp69 = icmp sgt i32 %sizeOfScalingList, 0
...
for.body.us:                                      ; preds = %for.body.lr.ph, %if.end28.thread.us
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %if.end28.thread.us ], [ 0, %for.body.lr.ph ]
  %nextScale.073.us = phi i32 [ %nextScale.166.us, %if.end28.thread.us ], [ 8, %for.body.lr.ph ]
  %lastScale.072.us = phi i32 [ %4, %if.end28.thread.us ], [ 8, %for.body.lr.ph ]
  %len.071.us = phi i32 [ %len.164.us, %if.end28.thread.us ], [ 0, %for.body.lr.ph ]
  %arrayidx.us = getelementptr inbounds [16 x i8], ptr @ZZ_SCAN, i64 0, i64 %indvars.iv76
  %cond.in.us = load i8, ptr %arrayidx.us, align 1
  %cmp5.not.us = icmp eq i32 %nextScale.073.us, 0
  %.pre = zext i8 %cond.in.us to i64
  br i1 %cmp5.not.us, label %if.end28.thread.us, label %if.end28.us

if.end28.us:                                      ; preds = %for.body.us
  %arrayidx8.us = getelementptr inbounds i16, ptr %scalingListinput, i64 %.pre
  %0 = load i16, ptr %arrayidx8.us, align 2
  %conv9.us = sext i16 %0 to i32
  %sub.us = sub nsw i32 %conv9.us, %lastScale.072.us
  ...
  %add18.us = add nsw i32 %call.us, %len.071.us
  %1 = load i16, ptr %arrayidx8.us, align 2
  %.fr.us = freeze i16 %1
  ...
  %3 = load i16, ptr %UseDefaultScalingMatrix, align 2
  %or.us = or i16 %3, %land.ext.us
  store i16 %or.us, ptr %UseDefaultScalingMatrix, align 2
  %spec.select68.us = select i1 %cmp24.us, i32 %lastScale.072.us, i32 %conv21.us
  br label %if.end28.thread.us

if.end28.thread.us:                               ; preds = %for.body.us, %if.end28.us
  %nextScale.166.us = phi i32 [ %conv21.us, %if.end28.us ], [ 0, %for.body.us ]
  %len.164.us = phi i32 [ %add18.us, %if.end28.us ], [ %len.071.us, %for.body.us ]
  %4 = phi i32 [ %spec.select68.us, %if.end28.us ], [ %lastScale.072.us, %for.body.us ]
  %conv35.us = trunc i32 %4 to i16
  %arrayidx37.us = getelementptr inbounds i16, ptr %scalingList, i64 %.pre
  store i16 %conv35.us, ptr %arrayidx37.us, align 2
  %indvars.iv.next77 = add nuw nsw i64 %indvars.iv76, 1
  %exitcond80.not = icmp eq i64 %indvars.iv.next77, 16
  br i1 %exitcond80.not, label %for.end, label %for.body.us

for.body:                                         ; preds = %for.body.preheader, %if.end28.thread
  %indvars.iv = phi i64 [ 0, %for.body.preheader ], [ %indvars.iv.next, %if.end28.thread ]
  %nextScale.073 = phi i32 [ 8, %for.body.preheader ], [ %nextScale.166, %if.end28.thread ]
  %lastScale.072 = phi i32 [ 8, %for.body.preheader ], [ %9, %if.end28.thread ]
  %len.071 = phi i32 [ 0, %for.body.preheader ], [ %len.164, %if.end28.thread ]
  %arrayidx3 = getelementptr inbounds [64 x i8], ptr @ZZ_SCAN8, i64 0, i64 %indvars.iv
  %cond.in = load i8, ptr %arrayidx3, align 1
  %cmp5.not = icmp eq i32 %nextScale.073, 0
  %.pre81 = zext i8 %cond.in to i64
  br i1 %cmp5.not, label %if.end28.thread, label %if.end28

if.end28:                                         ; preds = %for.body
  %arrayidx8 = getelementptr inbounds i16, ptr %scalingListinput, i64 %.pre81
  %5 = load i16, ptr %arrayidx8, align 2
  %conv9 = sext i16 %5 to i32
  %sub = sub nsw i32 %conv9, %lastScale.072
  ...
  %add18 = add nsw i32 %call, %len.071
  ...
  %8 = load i16, ptr %UseDefaultScalingMatrix, align 2
  %or = or i16 %8, %land.ext
  store i16 %or, ptr %UseDefaultScalingMatrix, align 2
  %spec.select68 = select i1 %cmp24, i32 %lastScale.072, i32 %conv21
  br label %if.end28.thread

if.end28.thread:                                  ; preds = %for.body, %if.end28
  %nextScale.166 = phi i32 [ %conv21, %if.end28 ], [ 0, %for.body ]
  %len.164 = phi i32 [ %add18, %if.end28 ], [ %len.071, %for.body ]
  %9 = phi i32 [ %spec.select68, %if.end28 ], [ %lastScale.072, %for.body ]
  %conv35 = trunc i32 %9 to i16
  %arrayidx37 = getelementptr inbounds i16, ptr %scalingList, i64 %.pre81
  store i16 %conv35, ptr %arrayidx37, align 2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.body

for.end:                                          ; preds = %if.end28.thread, %if.end28.thread.us, %entry
  %len.0.lcssa = phi i32 [ 0, %entry ], [ %len.164.us, %if.end28.thread.us ], [ %len.164, %if.end28.thread ]
  ret i32 %len.0.lcssa
}
...
while.end:                                        ; preds = %while.body, %if.end14.thread, %if.end14
  ...
  %3 = load i16, ptr %timezone, align 2
...
for.body:                                         ; preds = %while.end, %for.body
  ...
  %i.0107 = phi i32 [ %inc, %for.body ], [ 0, %while.end ]
