; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/ratectl.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/ratectl.c"
...
entry:
  ...
  %1 = load ptr, ptr %MADofMB, align 8
  ...
  %6 = load i32, ptr %FrameSizeInMbs, align 8
...
if.then:                                          ; preds = %entry
  ...
  %9 = load i64, ptr %TotalMADBasicUnit, align 8
  %add = add nsw i64 %9, %conv
  store i64 %add, ptr %TotalMADBasicUnit, align 8
...
if.end:                                           ; preds = %if.then, %if.else
  ...
  %14 = load i32, ptr %MbInterlace, align 4
...
if.then17:                                        ; preds = %if.end
  ...
  %19 = load i32, ptr %bot_MB, align 4
...
for.cond1.preheader:                              ; preds = %entry, %for.cond1.preheader
  ...
  %0 = load <16 x i32>, ptr %arrayidx5, align 16
  ...
  br i1 %exitcond.not, label %for.end8, label %for.cond1.preheader
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %3 = load ptr, ptr %MADofMB, align 8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i32>, ptr %4, align 4
  %5 = getelementptr inbounds i32, ptr %4, i64 2
  %wide.load13 = load <2 x i32>, ptr %5, align 4
...
entry:
  ...
  %0 = load ptr, ptr %MADofMB, align 8
  ...
  store ptr %0, ptr %MADofMB, align 8
  %MADofMB3 = getelementptr inbounds %struct.rc_generic, ptr %src, i64 0, i32 14
  %1 = load ptr, ptr %MADofMB3, align 8
  %2 = load ptr, ptr @img, align 8
  %FrameSizeInMbs = getelementptr inbounds %struct.ImageParameters, ptr %2, i64 0, i32 120
  %3 = load i32, ptr %FrameSizeInMbs, align 8
...
if.end:                                           ; preds = %entry
  ...
  store ptr null, ptr %MADofMB2, align 8
