...
if.then.i25:                                      ; preds = %if.end9
  ...
  %.pre.i26 = load ptr, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 3), align 8, !tbaa !46
  br label %if.end.i18
...
if.end.i18:                                       ; preds = %if.then.i25, %if.end9
  ...
  store ptr %call1.i19, ptr %streamBuffer.i20, align 8, !tbaa !18
...
if.then4.i22:                                     ; preds = %if.end.i18
  ...
  %.pre7.i23 = load ptr, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 3), align 8, !tbaa !46
  %streamBuffer6.phi.trans.insert.i = getelementptr inbounds %struct.Bitstream, ptr %.pre7.i23, i64 0, i32 9
  %.pre8.i24 = load ptr, ptr %streamBuffer6.phi.trans.insert.i, align 8, !tbaa !18
...
if.then.i38:                                      ; preds = %InitSceneInformation.exit
  ...
  %.pre.i39 = load ptr, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 5), align 8, !tbaa !47
  br label %if.end.i29
...
if.end.i29:                                       ; preds = %if.then.i38, %InitSceneInformation.exit
  ...
  store ptr %call1.i30, ptr %streamBuffer.i31, align 8, !tbaa !18
...
if.then4.i35:                                     ; preds = %if.end.i29
  ...
  %.pre7.i37 = load ptr, ptr %streamBuffer.i.phi.trans.insert.i36, align 8, !tbaa !18
...
if.then.i52:                                      ; preds = %InitPanScanRectInfo.exit
  ...
  %.pre.i53 = load ptr, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 4), align 8, !tbaa !50
  br label %if.end.i42
...
if.end.i42:                                       ; preds = %if.then.i52, %InitPanScanRectInfo.exit
  ...
  store ptr %call1.i43, ptr %streamBuffer.i44, align 8, !tbaa !18
...
if.then4.i48:                                     ; preds = %if.end.i42
  ...
  %.pre6.i49 = load ptr, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 4), align 8, !tbaa !50
  %streamBuffer.i.phi.trans.insert.i50 = getelementptr inbounds %struct.Bitstream, ptr %.pre6.i49, i64 0, i32 9
  %.pre7.i51 = load ptr, ptr %streamBuffer.i.phi.trans.insert.i50, align 8, !tbaa !18
...
if.then.i18:                                      ; preds = %CloseSparePicture.exit
  ...
  %7 = load ptr, ptr %streamBuffer.i19, align 8, !tbaa !18
...
if.then.i21:                                      ; preds = %CloseSceneInformation.exit
  ...
  %10 = load ptr, ptr %streamBuffer.i22, align 8, !tbaa !18
...
if.then.i24:                                      ; preds = %ClosePanScanRectInfo.exit
  ...
  %13 = load ptr, ptr %streamBuffer.i25, align 8, !tbaa !18
...
if.then.i27:                                      ; preds = %CloseUser_data_unregistered.exit
  ...
  %17 = load ptr, ptr %streamBuffer.i28, align 8, !tbaa !18
...
if.then.i33:                                      ; preds = %CloseUser_data_registered_itu_t_t35.exit
  ...
  %21 = load ptr, ptr %streamBuffer.i34, align 8, !tbaa !18
...
if.then15:                                        ; preds = %for.cond1.preheader
  ...
  %6 = load ptr, ptr %streamBuffer18, align 8, !tbaa !18
  %7 = load i32, ptr %dest, align 8, !tbaa !21
  %inc = add nsw i32 %7, 1
...
for.inc:                                          ; preds = %for.cond1.preheader, %if.then15
  ...
  %10 = load i8, ptr %arrayidx.1, align 1, !tbaa !24
  %11 = lshr i8 %10, 6
  %12 = and i8 %11, 1
  %spec.select122 = or i8 %shl.1, %12
  %13 = load i32, ptr %bits_to_go, align 4, !tbaa !20
...
if.then15.1:                                      ; preds = %for.inc
  store i32 8, ptr %bits_to_go, align 4, !tbaa !20
  %14 = load ptr, ptr %streamBuffer18, align 8, !tbaa !18
  %15 = load i32, ptr %dest, align 8, !tbaa !21
...
for.inc.1:                                        ; preds = %if.then15.1, %for.inc
  ...
  %18 = load i8, ptr %arrayidx.2, align 1, !tbaa !24
  %19 = lshr i8 %18, 5
  %20 = and i8 %19, 1
  %spec.select123 = or i8 %shl.2, %20
  %21 = load i32, ptr %bits_to_go, align 4, !tbaa !20
...
if.then15.2:                                      ; preds = %for.inc.1
  store i32 8, ptr %bits_to_go, align 4, !tbaa !20
  %22 = load ptr, ptr %streamBuffer18, align 8, !tbaa !18
  %23 = load i32, ptr %dest, align 8, !tbaa !21
...
for.inc.2:                                        ; preds = %if.then15.2, %for.inc.1
  ...
  %26 = load i8, ptr %arrayidx.3, align 1, !tbaa !24
  %27 = lshr i8 %26, 4
  %28 = and i8 %27, 1
  %spec.select124 = or i8 %shl.3, %28
  %29 = load i32, ptr %bits_to_go, align 4, !tbaa !20
...
if.then15.3:                                      ; preds = %for.inc.2
  store i32 8, ptr %bits_to_go, align 4, !tbaa !20
  %30 = load ptr, ptr %streamBuffer18, align 8, !tbaa !18
  %31 = load i32, ptr %dest, align 8, !tbaa !21
...
for.inc.3:                                        ; preds = %if.then15.3, %for.inc.2
  ...
  %34 = load i8, ptr %arrayidx.4, align 1, !tbaa !24
  %35 = lshr i8 %34, 3
  %36 = and i8 %35, 1
  %spec.select125 = or i8 %shl.4, %36
  %37 = load i32, ptr %bits_to_go, align 4, !tbaa !20
...
if.then15.4:                                      ; preds = %for.inc.3
  store i32 8, ptr %bits_to_go, align 4, !tbaa !20
  %38 = load ptr, ptr %streamBuffer18, align 8, !tbaa !18
  %39 = load i32, ptr %dest, align 8, !tbaa !21
...
for.inc.4:                                        ; preds = %if.then15.4, %for.inc.3
  ...
  %42 = load i8, ptr %arrayidx.5, align 1, !tbaa !24
  %43 = lshr i8 %42, 2
  %44 = and i8 %43, 1
  %spec.select126 = or i8 %shl.5, %44
  %45 = load i32, ptr %bits_to_go, align 4, !tbaa !20
...
if.then15.5:                                      ; preds = %for.inc.4
  store i32 8, ptr %bits_to_go, align 4, !tbaa !20
  %46 = load ptr, ptr %streamBuffer18, align 8, !tbaa !18
  %47 = load i32, ptr %dest, align 8, !tbaa !21
...
for.inc.5:                                        ; preds = %if.then15.5, %for.inc.4
  ...
  %50 = load i8, ptr %arrayidx.6, align 1, !tbaa !24
  %51 = lshr i8 %50, 1
  %52 = and i8 %51, 1
  %spec.select127 = or i8 %shl.6, %52
  %53 = load i32, ptr %bits_to_go, align 4, !tbaa !20
...
if.then15.6:                                      ; preds = %for.inc.5
  store i32 8, ptr %bits_to_go, align 4, !tbaa !20
  %54 = load ptr, ptr %streamBuffer18, align 8, !tbaa !18
  %55 = load i32, ptr %dest, align 8, !tbaa !21
...
for.inc.6:                                        ; preds = %if.then15.6, %for.inc.5
  ...
  %58 = load i8, ptr %arrayidx.7, align 1, !tbaa !24
  %59 = and i8 %58, 1
...
if.then.7:                                        ; preds = %for.inc.6
  %60 = or i8 %shl.7, 1
  store i8 %60, ptr %byte_buf, align 8, !tbaa !22
  br label %if.end.7

if.end.7:                                         ; preds = %if.then.7, %for.inc.6
  %61 = phi i8 [ %60, %if.then.7 ], [ %shl.7, %for.inc.6 ]
  %62 = load i32, ptr %bits_to_go, align 4, !tbaa !20
...
if.then15.7:                                      ; preds = %if.end.7
  store i32 8, ptr %bits_to_go, align 4, !tbaa !20
  %63 = load ptr, ptr %streamBuffer18, align 8, !tbaa !18
  %64 = load i32, ptr %dest, align 8, !tbaa !21
  ...
  store i8 %61, ptr %arrayidx21.7, align 1, !tbaa !24
...
for.inc.7:                                        ; preds = %if.then15.7, %if.end.7
  ...
  %66 = load i32, ptr %source, align 8, !tbaa !21
...
for.end27:                                        ; preds = %for.inc.7, %entry
  ...
  %68 = load i32, ptr %bits_to_go28, align 4, !tbaa !20
...
for.body38:                                       ; preds = %for.body38.lr.ph, %for.inc72
  ...
  %70 = load i8, ptr %byte_buf43, align 8, !tbaa !22
...
if.then48:                                        ; preds = %for.body38
  %71 = or i8 %shl41, 1
  store i8 %71, ptr %byte_buf39, align 8, !tbaa !22
  br label %if.end53

if.end53:                                         ; preds = %if.then48, %for.body38
  %72 = phi i8 [ %71, %if.then48 ], [ %shl41, %for.body38 ]
  %73 = load i32, ptr %bits_to_go54, align 4, !tbaa !20
...
if.then62:                                        ; preds = %if.end53
  ...
  %74 = load ptr, ptr %streamBuffer65, align 8, !tbaa !18
  %75 = load i32, ptr %dest, align 8, !tbaa !21
  ...
  store i8 %72, ptr %arrayidx69, align 1, !tbaa !24
...
if.end5:                                          ; preds = %if.then4, %if.end
  ...
  %6 = load i32, ptr getelementptr inbounds (%struct.spare_picture_struct, ptr @seiSparePicturePayload, i64 0, i32 1), align 4, !tbaa !56
...
if.then16:                                        ; preds = %if.end5
  ...
  store i32 8, ptr %bits_to_go, align 4, !tbaa !20
  %11 = load ptr, ptr %streamBuffer, align 8, !tbaa !18
  %12 = load i32, ptr %call, align 8, !tbaa !21
  %inc = add nsw i32 %12, 1
  store i32 %inc, ptr %call, align 8, !tbaa !21
  %idxprom = sext i32 %12 to i64
  %arrayidx = getelementptr inbounds i8, ptr %11, i64 %idxprom
  store i8 %10, ptr %arrayidx, align 1, !tbaa !24
  store i8 0, ptr %byte_buf, align 8, !tbaa !22
  br label %if.end38

if.end38:                                         ; preds = %if.then16, %if.end5
  %13 = load i32, ptr %call, align 8, !tbaa !21
  store i32 %13, ptr getelementptr inbounds (%struct.spare_picture_struct, ptr @seiSparePicturePayload, i64 0, i32 2), align 8, !tbaa !81
  store ptr %call, ptr getelementptr inbounds (%struct.spare_picture_struct, ptr @seiSparePicturePayload, i64 0, i32 3), align 8, !tbaa !14
  %streamBuffer40 = getelementptr inbounds %struct.Bitstream, ptr %2, i64 0, i32 9
  %14 = load ptr, ptr %streamBuffer40, align 8, !tbaa !18
...
if.end5.thread:                                   ; preds = %if.end
  ...
  store ptr %call611, ptr @seiUser_data_registered_itu_t_t35, align 8, !tbaa !63
  br label %if.end9
...
if.then8:                                         ; preds = %if.end5
  ...
  %.pre10 = load ptr, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 4), align 8, !tbaa !61
  br label %if.end9
