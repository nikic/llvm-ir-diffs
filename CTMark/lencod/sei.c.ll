; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/sei.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/sei.c"
...
entry:
  ...
  store ptr %call, ptr getelementptr inbounds ([2 x %struct.sei_struct], ptr @sei_message, i64 0, i64 0, i32 3), align 16
  %cmp4 = icmp eq ptr %call, null
  br i1 %cmp4, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  tail call void @no_mem_exit(ptr noundef nonnull @.str) #19
  %.pre = load ptr, ptr getelementptr inbounds ([2 x %struct.sei_struct], ptr @sei_message, i64 0, i64 0, i32 3), align 16
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %0 = phi ptr [ %.pre, %if.then ], [ %call, %entry ]
  store i8 5, ptr getelementptr inbounds ([2 x %struct.sei_struct], ptr @sei_message, i64 0, i64 0, i32 2), align 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(65496) %0, i8 0, i64 65496, i1 false)
  store i32 0, ptr getelementptr inbounds ([2 x %struct.sei_struct], ptr @sei_message, i64 0, i64 0, i32 1), align 4
  store i32 0, ptr @sei_message, align 16
  %call.1 = tail call noalias dereferenceable_or_null(65496) ptr @malloc(i64 noundef 65496) #18
  store ptr %call.1, ptr getelementptr inbounds ([2 x %struct.sei_struct], ptr @sei_message, i64 0, i64 1, i32 3), align 8
  %cmp4.1 = icmp eq ptr %call.1, null
  br i1 %cmp4.1, label %if.then.1, label %if.end.1

if.then.1:                                        ; preds = %if.end
  tail call void @no_mem_exit(ptr noundef nonnull @.str) #19
  %.pre56 = load ptr, ptr getelementptr inbounds ([2 x %struct.sei_struct], ptr @sei_message, i64 0, i64 1, i32 3), align 8
  br label %if.end.1

if.end.1:                                         ; preds = %if.then.1, %if.end
  %1 = phi ptr [ %.pre56, %if.then.1 ], [ %call.1, %if.end ]
  store i8 5, ptr getelementptr inbounds ([2 x %struct.sei_struct], ptr @sei_message, i64 0, i64 1, i32 2), align 16
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(65496) %1, i8 0, i64 65496, i1 false)
  store i32 0, ptr getelementptr inbounds ([2 x %struct.sei_struct], ptr @sei_message, i64 0, i64 1, i32 1), align 4
  store i32 0, ptr getelementptr inbounds ([2 x %struct.sei_struct], ptr @sei_message, i64 0, i64 1), align 8
  store ptr null, ptr getelementptr inbounds (%struct.spare_picture_struct, ptr @seiSparePicturePayload, i64 0, i32 3), align 8
  tail call void @InitSparePicture()
  %call.i = tail call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #18
  store ptr %call.i, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 10), align 8
  %cmp.i = icmp eq ptr %call.i, null
  br i1 %cmp.i, label %if.then.i, label %if.end.i

if.then.i:                                        ; preds = %if.end.1
  tail call void @no_mem_exit(ptr noundef nonnull @.str.7) #19
  %.pre.i = load ptr, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 10), align 8
  br label %if.end.i
...
if.end.i:                                         ; preds = %if.then.i, %if.end.1
  ...
  store ptr %call1.i, ptr %streamBuffer.i, align 8
...
if.then4.i:                                       ; preds = %if.end.i
  ...
  %.pre7.i = load ptr, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 10), align 8
  %streamBuffer.i.phi.trans.insert.i = getelementptr inbounds %struct.Bitstream, ptr %.pre7.i, i64 0, i32 9
  %.pre8.i = load ptr, ptr %streamBuffer.i.phi.trans.insert.i, align 8
...
InitSubseqChar.exit:                              ; preds = %if.end.i, %if.then4.i
  ...
  %4 = load ptr, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 10), align 8
  %bits_to_go.i.i = getelementptr inbounds %struct.Bitstream, ptr %4, i64 0, i32 1
  store i32 8, ptr %bits_to_go.i.i, align 4
  store i32 0, ptr %4, align 8
  %byte_buf.i.i = getelementptr inbounds %struct.Bitstream, ptr %4, i64 0, i32 2
  store i8 0, ptr %byte_buf.i.i, align 8
  store i32 0, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 11), align 8
  store i32 0, ptr @seiHasSubseqChar, align 4
  %5 = load ptr, ptr @img, align 8
  %layer.i = getelementptr inbounds %struct.ImageParameters, ptr %5, i64 0, i32 95
  %6 = load i32, ptr %layer.i, align 8
  store i32 %6, ptr @seiSubseqChar, align 8
  ...
  %7 = load i32, ptr %subseq_id.i, align 4
  store i32 %7, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 1), align 4
  store i32 0, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 2), align 8
  store i32 0, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 4), align 8
  store i32 0, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 7), align 4
  %8 = load ptr, ptr @input, align 8
  %NumFramesInELSubSeq = getelementptr inbounds %struct.InputParameters, ptr %8, i64 0, i32 129
  %9 = load i32, ptr %NumFramesInELSubSeq, align 8
  %cmp7.not = icmp eq i32 %9, 0
  br i1 %cmp7.not, label %if.end9, label %if.then8

if.then8:                                         ; preds = %InitSubseqChar.exit
  store i32 1, ptr @seiHasSubseqLayerInfo, align 4
  ...
  store i32 2, ptr getelementptr inbounds (%struct.subseq_layer_information_struct, ptr @seiSubseqLayerInfo, i64 0, i32 3), align 4
  br label %if.end9

if.end9:                                          ; preds = %if.then8, %InitSubseqChar.exit
  store i32 1, ptr @seiHasSceneInformation, align 4
  store i32 0, ptr @seiSceneInformation, align 8
  store i32 0, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 1), align 4
  store i32 -1, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 2), align 8
  %call.i16 = tail call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #18
  store ptr %call.i16, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 3), align 8
  %cmp.i17 = icmp eq ptr %call.i16, null
  br i1 %cmp.i17, label %if.then.i25, label %if.end.i18

if.then.i25:                                      ; preds = %if.end9
  tail call void @no_mem_exit(ptr noundef nonnull @.str.9) #19
  %.pre.i26 = load ptr, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 3), align 8
  br label %if.end.i18

if.end.i18:                                       ; preds = %if.then.i25, %if.end9
  %10 = phi ptr [ %.pre.i26, %if.then.i25 ], [ %call.i16, %if.end9 ]
  %call1.i19 = tail call noalias dereferenceable_or_null(65496) ptr @malloc(i64 noundef 65496) #18
  %streamBuffer.i20 = getelementptr inbounds %struct.Bitstream, ptr %10, i64 0, i32 9
  store ptr %call1.i19, ptr %streamBuffer.i20, align 8
  %cmp3.i21 = icmp eq ptr %call1.i19, null
  br i1 %cmp3.i21, label %if.then4.i22, label %InitSceneInformation.exit

if.then4.i22:                                     ; preds = %if.end.i18
  tail call void @no_mem_exit(ptr noundef nonnull @.str.10) #19
  %.pre7.i23 = load ptr, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 3), align 8
  %streamBuffer6.phi.trans.insert.i = getelementptr inbounds %struct.Bitstream, ptr %.pre7.i23, i64 0, i32 9
  %.pre8.i24 = load ptr, ptr %streamBuffer6.phi.trans.insert.i, align 8
  br label %InitSceneInformation.exit

InitSceneInformation.exit:                        ; preds = %if.end.i18, %if.then4.i22
  %11 = phi ptr [ %.pre8.i24, %if.then4.i22 ], [ %call1.i19, %if.end.i18 ]
  %12 = phi ptr [ %.pre7.i23, %if.then4.i22 ], [ %10, %if.end.i18 ]
  ...
  store ptr %call.i27, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 5), align 8
  %cmp.i28 = icmp eq ptr %call.i27, null
  br i1 %cmp.i28, label %if.then.i38, label %if.end.i29

if.then.i38:                                      ; preds = %InitSceneInformation.exit
  tail call void @no_mem_exit(ptr noundef nonnull @.str.11) #19
  %.pre.i39 = load ptr, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 5), align 8
  br label %if.end.i29

if.end.i29:                                       ; preds = %if.then.i38, %InitSceneInformation.exit
  %13 = phi ptr [ %.pre.i39, %if.then.i38 ], [ %call.i27, %InitSceneInformation.exit ]
  %call1.i30 = tail call noalias dereferenceable_or_null(65496) ptr @malloc(i64 noundef 65496) #18
  %streamBuffer.i31 = getelementptr inbounds %struct.Bitstream, ptr %13, i64 0, i32 9
  store ptr %call1.i30, ptr %streamBuffer.i31, align 8
  %cmp3.i32 = icmp eq ptr %call1.i30, null
  br i1 %cmp3.i32, label %if.then4.i35, label %InitPanScanRectInfo.exit

if.then4.i35:                                     ; preds = %if.end.i29
  tail call void @no_mem_exit(ptr noundef nonnull @.str.12) #19
  %.pre6.i = load ptr, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 5), align 8
  %streamBuffer.i.phi.trans.insert.i36 = getelementptr inbounds %struct.Bitstream, ptr %.pre6.i, i64 0, i32 9
  %.pre7.i37 = load ptr, ptr %streamBuffer.i.phi.trans.insert.i36, align 8
  br label %InitPanScanRectInfo.exit

InitPanScanRectInfo.exit:                         ; preds = %if.end.i29, %if.then4.i35
  %14 = phi ptr [ %.pre7.i37, %if.then4.i35 ], [ %call1.i30, %if.end.i29 ]
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(65496) %14, i8 0, i64 65496, i1 false)
  %15 = load ptr, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 5), align 8
  %bits_to_go.i.i33 = getelementptr inbounds %struct.Bitstream, ptr %15, i64 0, i32 1
  store i32 8, ptr %bits_to_go.i.i33, align 4
  store i32 0, ptr %15, align 8
  %byte_buf.i.i34 = getelementptr inbounds %struct.Bitstream, ptr %15, i64 0, i32 2
  store i8 0, ptr %byte_buf.i.i34, align 8
  store i32 0, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 6), align 8
  store i32 1, ptr @seiHasPanScanRectInfo, align 4
  ...
  store ptr %call.i40, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 4), align 8
  %cmp.i41 = icmp eq ptr %call.i40, null
  br i1 %cmp.i41, label %if.then.i52, label %if.end.i42

if.then.i52:                                      ; preds = %InitPanScanRectInfo.exit
  tail call void @no_mem_exit(ptr noundef nonnull @.str.19) #19
  %.pre.i53 = load ptr, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 4), align 8
  br label %if.end.i42

if.end.i42:                                       ; preds = %if.then.i52, %InitPanScanRectInfo.exit
  %16 = phi ptr [ %.pre.i53, %if.then.i52 ], [ %call.i40, %InitPanScanRectInfo.exit ]
  %call1.i43 = tail call noalias dereferenceable_or_null(65496) ptr @malloc(i64 noundef 65496) #18
  %streamBuffer.i44 = getelementptr inbounds %struct.Bitstream, ptr %16, i64 0, i32 9
  store ptr %call1.i43, ptr %streamBuffer.i44, align 8
  %cmp3.i45 = icmp eq ptr %call1.i43, null
  br i1 %cmp3.i45, label %if.then4.i48, label %InitRandomAccess.exit

if.then4.i48:                                     ; preds = %if.end.i42
  tail call void @no_mem_exit(ptr noundef nonnull @.str.20) #19
  %.pre6.i49 = load ptr, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 4), align 8
  %streamBuffer.i.phi.trans.insert.i50 = getelementptr inbounds %struct.Bitstream, ptr %.pre6.i49, i64 0, i32 9
  %.pre7.i51 = load ptr, ptr %streamBuffer.i.phi.trans.insert.i50, align 8
  br label %InitRandomAccess.exit

InitRandomAccess.exit:                            ; preds = %if.end.i42, %if.then4.i48
  %17 = phi ptr [ %.pre7.i51, %if.then4.i48 ], [ %call1.i43, %if.end.i42 ]
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(65496) %17, i8 0, i64 65496, i1 false)
  %18 = load ptr, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 4), align 8
  %bits_to_go.i.i46 = getelementptr inbounds %struct.Bitstream, ptr %18, i64 0, i32 1
  store i32 8, ptr %bits_to_go.i.i46, align 4
  store i32 0, ptr %18, align 8
  %byte_buf.i.i47 = getelementptr inbounds %struct.Bitstream, ptr %18, i64 0, i32 2
  store i8 0, ptr %byte_buf.i.i47, align 8
  store i32 0, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 5), align 8
  store i32 0, ptr @seiRecoveryPoint, align 8
  store i8 0, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 2), align 1
  store i8 0, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 1), align 4
  store i32 0, ptr @seiHasRecoveryPoint_info, align 4
  ret void
}
...
entry:
  ...
  store i32 0, ptr %payloadSize, align 4
...
entry:
  %0 = load ptr, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 10), align 8
...
if.then.i:                                        ; preds = %entry
  ...
  %2 = load ptr, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 10), align 8
  tail call void @free(ptr noundef %2) #19
  br label %CloseSubseqChar.exit

CloseSubseqChar.exit:                             ; preds = %entry, %if.then.i
  store ptr null, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 10), align 8
  %3 = load ptr, ptr getelementptr inbounds (%struct.spare_picture_struct, ptr @seiSparePicturePayload, i64 0, i32 3), align 8
  %streamBuffer.i14 = getelementptr inbounds %struct.Bitstream, ptr %3, i64 0, i32 9
  %4 = load ptr, ptr %streamBuffer.i14, align 8
...
if.then.i16:                                      ; preds = %CloseSubseqChar.exit
  ...
  %.pre.i = load ptr, ptr getelementptr inbounds (%struct.spare_picture_struct, ptr @seiSparePicturePayload, i64 0, i32 3), align 8
...
CloseSparePicture.exit:                           ; preds = %CloseSubseqChar.exit, %if.then.i16
  ...
  store ptr null, ptr getelementptr inbounds (%struct.spare_picture_struct, ptr @seiSparePicturePayload, i64 0, i32 3), align 8
  store i32 0, ptr getelementptr inbounds (%struct.spare_picture_struct, ptr @seiSparePicturePayload, i64 0, i32 1), align 4
  store i32 0, ptr @seiSparePicturePayload, align 8
  %6 = load ptr, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 3), align 8
  %tobool.not.i17 = icmp eq ptr %6, null
  br i1 %tobool.not.i17, label %CloseSceneInformation.exit, label %if.then.i18

if.then.i18:                                      ; preds = %CloseSparePicture.exit
  %streamBuffer.i19 = getelementptr inbounds %struct.Bitstream, ptr %6, i64 0, i32 9
  %7 = load ptr, ptr %streamBuffer.i19, align 8
  tail call void @free(ptr noundef %7) #19
  %8 = load ptr, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 3), align 8
  tail call void @free(ptr noundef %8) #19
  br label %CloseSceneInformation.exit

CloseSceneInformation.exit:                       ; preds = %CloseSparePicture.exit, %if.then.i18
  store ptr null, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 3), align 8
  %9 = load ptr, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 5), align 8
  %tobool.not.i20 = icmp eq ptr %9, null
  br i1 %tobool.not.i20, label %ClosePanScanRectInfo.exit, label %if.then.i21

if.then.i21:                                      ; preds = %CloseSceneInformation.exit
  %streamBuffer.i22 = getelementptr inbounds %struct.Bitstream, ptr %9, i64 0, i32 9
  %10 = load ptr, ptr %streamBuffer.i22, align 8
  tail call void @free(ptr noundef %10) #19
  %11 = load ptr, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 5), align 8
  tail call void @free(ptr noundef %11) #19
  br label %ClosePanScanRectInfo.exit

ClosePanScanRectInfo.exit:                        ; preds = %CloseSceneInformation.exit, %if.then.i21
  store ptr null, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 5), align 8
  %12 = load ptr, ptr getelementptr inbounds (%struct.user_data_unregistered_information_struct, ptr @seiUser_data_unregistered, i64 0, i32 2), align 8
  %tobool.not.i23 = icmp eq ptr %12, null
  br i1 %tobool.not.i23, label %if.end.i, label %if.then.i24

if.then.i24:                                      ; preds = %ClosePanScanRectInfo.exit
  %streamBuffer.i25 = getelementptr inbounds %struct.Bitstream, ptr %12, i64 0, i32 9
  %13 = load ptr, ptr %streamBuffer.i25, align 8
  tail call void @free(ptr noundef %13) #19
  %14 = load ptr, ptr getelementptr inbounds (%struct.user_data_unregistered_information_struct, ptr @seiUser_data_unregistered, i64 0, i32 2), align 8
  tail call void @free(ptr noundef %14) #19
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i24, %ClosePanScanRectInfo.exit
  store ptr null, ptr getelementptr inbounds (%struct.user_data_unregistered_information_struct, ptr @seiUser_data_unregistered, i64 0, i32 2), align 8
  %15 = load ptr, ptr @seiUser_data_unregistered, align 8
...
CloseUser_data_unregistered.exit:                 ; preds = %if.end.i, %if.then2.i
  %16 = load ptr, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 4), align 8
  %tobool.not.i26 = icmp eq ptr %16, null
  br i1 %tobool.not.i26, label %if.end.i29, label %if.then.i27

if.then.i27:                                      ; preds = %CloseUser_data_unregistered.exit
  %streamBuffer.i28 = getelementptr inbounds %struct.Bitstream, ptr %16, i64 0, i32 9
  %17 = load ptr, ptr %streamBuffer.i28, align 8
  tail call void @free(ptr noundef %17) #19
  %18 = load ptr, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 4), align 8
  tail call void @free(ptr noundef %18) #19
  br label %if.end.i29

if.end.i29:                                       ; preds = %if.then.i27, %CloseUser_data_unregistered.exit
  store ptr null, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 4), align 8
  %19 = load ptr, ptr @seiUser_data_registered_itu_t_t35, align 8
  %tobool1.not.i30 = icmp eq ptr %19, null
  br i1 %tobool1.not.i30, label %CloseUser_data_registered_itu_t_t35.exit, label %if.then2.i31
...
CloseUser_data_registered_itu_t_t35.exit:         ; preds = %if.end.i29, %if.then2.i31
  %20 = load ptr, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 4), align 8
  %tobool.not.i32 = icmp eq ptr %20, null
  br i1 %tobool.not.i32, label %CloseRandomAccess.exit, label %if.then.i33

if.then.i33:                                      ; preds = %CloseUser_data_registered_itu_t_t35.exit
  %streamBuffer.i34 = getelementptr inbounds %struct.Bitstream, ptr %20, i64 0, i32 9
  %21 = load ptr, ptr %streamBuffer.i34, align 8
  tail call void @free(ptr noundef %21) #19
  %22 = load ptr, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 4), align 8
  tail call void @free(ptr noundef %22) #19
  br label %CloseRandomAccess.exit

CloseRandomAccess.exit:                           ; preds = %CloseUser_data_registered_itu_t_t35.exit, %if.then.i33
  store ptr null, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 4), align 8
  %23 = load ptr, ptr getelementptr inbounds ([2 x %struct.sei_struct], ptr @sei_message, i64 0, i64 0, i32 3), align 16
...
if.end6:                                          ; preds = %if.then2, %CloseRandomAccess.exit
  store ptr null, ptr getelementptr inbounds ([2 x %struct.sei_struct], ptr @sei_message, i64 0, i64 0, i32 3), align 16
  %24 = load ptr, ptr getelementptr inbounds ([2 x %struct.sei_struct], ptr @sei_message, i64 0, i64 1, i32 3), align 8
...
if.end6.1:                                        ; preds = %if.then2.1, %if.end6
  store ptr null, ptr getelementptr inbounds ([2 x %struct.sei_struct], ptr @sei_message, i64 0, i64 1, i32 3), align 8
  ret void
}
...
entry:
  %0 = load i32, ptr getelementptr inbounds ([2 x %struct.sei_struct], ptr @sei_message, i64 0, i64 1), align 8
...
if.end8:                                          ; preds = %if.end3
  %.old27 = load i32, ptr @seiHasSubseqChar, align 4
...
if.end11:                                         ; preds = %land.lhs.true5, %if.end8
  %8 = load i32, ptr @seiHasSceneInformation, align 4
...
if.end23:                                         ; preds = %if.end11
  %12 = load i32, ptr @seiHasRecoveryPoint_info, align 4
...
entry:
  %idxprom = sext i32 %id to i64
  %payloadSize = getelementptr inbounds [2 x %struct.sei_struct], ptr @sei_message, i64 0, i64 %idxprom, i32 1
  %0 = load i32, ptr %payloadSize, align 4
...
while.body14:                                     ; preds = %while.body14.preheader, %while.body14
  ...
  br i1 %cmp12, label %while.body14, label %while.end22.loopexit
...
while.end22:                                      ; preds = %while.end22.loopexit, %while.end
  ...
  store i32 %add, ptr %payloadSize, align 4
  ret void
}
...
entry:
  ...
  %2 = load i32, ptr %payloadSize, align 4
  %inc = add nsw i32 %2, 1
  store i32 %inc, ptr %payloadSize, align 4
...
if.then15:                                        ; preds = %for.cond1.preheader
  ...
  %6 = load ptr, ptr %streamBuffer18, align 8
  %7 = load i32, ptr %dest, align 8
  %inc = add nsw i32 %7, 1
  store i32 %inc, ptr %dest, align 8
  %idxprom20 = sext i32 %7 to i64
  %arrayidx21 = getelementptr inbounds i8, ptr %6, i64 %idxprom20
  store i8 %spec.select, ptr %arrayidx21, align 1
  %.pre114 = load ptr, ptr %streamBuffer, align 8
  br label %for.inc

for.inc:                                          ; preds = %for.cond1.preheader, %if.then15
  %8 = phi ptr [ %2, %for.cond1.preheader ], [ %.pre114, %if.then15 ]
  %9 = phi i8 [ %spec.select, %for.cond1.preheader ], [ 0, %if.then15 ]
  %shl.1 = shl i8 %9, 1
  store i8 %shl.1, ptr %byte_buf, align 8
  %arrayidx.1 = getelementptr inbounds i8, ptr %8, i64 %indvars.iv
  %10 = load i8, ptr %arrayidx.1, align 1
  %11 = lshr i8 %10, 6
  %12 = and i8 %11, 1
  %spec.select122 = or i8 %shl.1, %12
  %13 = load i32, ptr %bits_to_go, align 4
  %dec.1 = add nsw i32 %13, -1
  store i32 %dec.1, ptr %bits_to_go, align 4
  %cmp13.1 = icmp eq i32 %dec.1, 0
  br i1 %cmp13.1, label %if.then15.1, label %for.inc.1

if.then15.1:                                      ; preds = %for.inc
  store i32 8, ptr %bits_to_go, align 4
  %14 = load ptr, ptr %streamBuffer18, align 8
  %15 = load i32, ptr %dest, align 8
  %inc.1 = add nsw i32 %15, 1
  store i32 %inc.1, ptr %dest, align 8
  %idxprom20.1 = sext i32 %15 to i64
  %arrayidx21.1 = getelementptr inbounds i8, ptr %14, i64 %idxprom20.1
  store i8 %spec.select122, ptr %arrayidx21.1, align 1
  %.pre115 = load ptr, ptr %streamBuffer, align 8
  br label %for.inc.1

for.inc.1:                                        ; preds = %if.then15.1, %for.inc
  %16 = phi ptr [ %.pre115, %if.then15.1 ], [ %8, %for.inc ]
  %17 = phi i8 [ 0, %if.then15.1 ], [ %spec.select122, %for.inc ]
  %shl.2 = shl i8 %17, 1
  store i8 %shl.2, ptr %byte_buf, align 8
  %arrayidx.2 = getelementptr inbounds i8, ptr %16, i64 %indvars.iv
  %18 = load i8, ptr %arrayidx.2, align 1
  %19 = lshr i8 %18, 5
  %20 = and i8 %19, 1
  %spec.select123 = or i8 %shl.2, %20
  %21 = load i32, ptr %bits_to_go, align 4
  %dec.2 = add nsw i32 %21, -1
  store i32 %dec.2, ptr %bits_to_go, align 4
  %cmp13.2 = icmp eq i32 %dec.2, 0
  br i1 %cmp13.2, label %if.then15.2, label %for.inc.2

if.then15.2:                                      ; preds = %for.inc.1
  store i32 8, ptr %bits_to_go, align 4
  %22 = load ptr, ptr %streamBuffer18, align 8
  %23 = load i32, ptr %dest, align 8
  %inc.2 = add nsw i32 %23, 1
  store i32 %inc.2, ptr %dest, align 8
  %idxprom20.2 = sext i32 %23 to i64
  %arrayidx21.2 = getelementptr inbounds i8, ptr %22, i64 %idxprom20.2
  store i8 %spec.select123, ptr %arrayidx21.2, align 1
  %.pre116 = load ptr, ptr %streamBuffer, align 8
  br label %for.inc.2

for.inc.2:                                        ; preds = %if.then15.2, %for.inc.1
  %24 = phi ptr [ %.pre116, %if.then15.2 ], [ %16, %for.inc.1 ]
  %25 = phi i8 [ 0, %if.then15.2 ], [ %spec.select123, %for.inc.1 ]
  %shl.3 = shl i8 %25, 1
  store i8 %shl.3, ptr %byte_buf, align 8
  %arrayidx.3 = getelementptr inbounds i8, ptr %24, i64 %indvars.iv
  %26 = load i8, ptr %arrayidx.3, align 1
  %27 = lshr i8 %26, 4
  %28 = and i8 %27, 1
  %spec.select124 = or i8 %shl.3, %28
  %29 = load i32, ptr %bits_to_go, align 4
  %dec.3 = add nsw i32 %29, -1
  store i32 %dec.3, ptr %bits_to_go, align 4
  %cmp13.3 = icmp eq i32 %dec.3, 0
  br i1 %cmp13.3, label %if.then15.3, label %for.inc.3

if.then15.3:                                      ; preds = %for.inc.2
  store i32 8, ptr %bits_to_go, align 4
  %30 = load ptr, ptr %streamBuffer18, align 8
  %31 = load i32, ptr %dest, align 8
  %inc.3 = add nsw i32 %31, 1
  store i32 %inc.3, ptr %dest, align 8
  %idxprom20.3 = sext i32 %31 to i64
  %arrayidx21.3 = getelementptr inbounds i8, ptr %30, i64 %idxprom20.3
  store i8 %spec.select124, ptr %arrayidx21.3, align 1
  %.pre117 = load ptr, ptr %streamBuffer, align 8
  br label %for.inc.3

for.inc.3:                                        ; preds = %if.then15.3, %for.inc.2
  %32 = phi ptr [ %.pre117, %if.then15.3 ], [ %24, %for.inc.2 ]
  %33 = phi i8 [ 0, %if.then15.3 ], [ %spec.select124, %for.inc.2 ]
  %shl.4 = shl i8 %33, 1
  store i8 %shl.4, ptr %byte_buf, align 8
  %arrayidx.4 = getelementptr inbounds i8, ptr %32, i64 %indvars.iv
  %34 = load i8, ptr %arrayidx.4, align 1
  %35 = lshr i8 %34, 3
  %36 = and i8 %35, 1
  %spec.select125 = or i8 %shl.4, %36
  %37 = load i32, ptr %bits_to_go, align 4
  %dec.4 = add nsw i32 %37, -1
  store i32 %dec.4, ptr %bits_to_go, align 4
  %cmp13.4 = icmp eq i32 %dec.4, 0
  br i1 %cmp13.4, label %if.then15.4, label %for.inc.4

if.then15.4:                                      ; preds = %for.inc.3
  store i32 8, ptr %bits_to_go, align 4
  %38 = load ptr, ptr %streamBuffer18, align 8
  %39 = load i32, ptr %dest, align 8
  %inc.4 = add nsw i32 %39, 1
  store i32 %inc.4, ptr %dest, align 8
  %idxprom20.4 = sext i32 %39 to i64
  %arrayidx21.4 = getelementptr inbounds i8, ptr %38, i64 %idxprom20.4
  store i8 %spec.select125, ptr %arrayidx21.4, align 1
  %.pre118 = load ptr, ptr %streamBuffer, align 8
  br label %for.inc.4

for.inc.4:                                        ; preds = %if.then15.4, %for.inc.3
  %40 = phi ptr [ %.pre118, %if.then15.4 ], [ %32, %for.inc.3 ]
  %41 = phi i8 [ 0, %if.then15.4 ], [ %spec.select125, %for.inc.3 ]
  %shl.5 = shl i8 %41, 1
  store i8 %shl.5, ptr %byte_buf, align 8
  %arrayidx.5 = getelementptr inbounds i8, ptr %40, i64 %indvars.iv
  %42 = load i8, ptr %arrayidx.5, align 1
  %43 = lshr i8 %42, 2
  %44 = and i8 %43, 1
  %spec.select126 = or i8 %shl.5, %44
  %45 = load i32, ptr %bits_to_go, align 4
  %dec.5 = add nsw i32 %45, -1
  store i32 %dec.5, ptr %bits_to_go, align 4
  %cmp13.5 = icmp eq i32 %dec.5, 0
  br i1 %cmp13.5, label %if.then15.5, label %for.inc.5

if.then15.5:                                      ; preds = %for.inc.4
  store i32 8, ptr %bits_to_go, align 4
  %46 = load ptr, ptr %streamBuffer18, align 8
  %47 = load i32, ptr %dest, align 8
  %inc.5 = add nsw i32 %47, 1
  store i32 %inc.5, ptr %dest, align 8
  %idxprom20.5 = sext i32 %47 to i64
  %arrayidx21.5 = getelementptr inbounds i8, ptr %46, i64 %idxprom20.5
  store i8 %spec.select126, ptr %arrayidx21.5, align 1
  %.pre119 = load ptr, ptr %streamBuffer, align 8
  br label %for.inc.5

for.inc.5:                                        ; preds = %if.then15.5, %for.inc.4
  %48 = phi ptr [ %.pre119, %if.then15.5 ], [ %40, %for.inc.4 ]
  %49 = phi i8 [ 0, %if.then15.5 ], [ %spec.select126, %for.inc.4 ]
  %shl.6 = shl i8 %49, 1
  store i8 %shl.6, ptr %byte_buf, align 8
  %arrayidx.6 = getelementptr inbounds i8, ptr %48, i64 %indvars.iv
  %50 = load i8, ptr %arrayidx.6, align 1
  %51 = lshr i8 %50, 1
  %52 = and i8 %51, 1
  %spec.select127 = or i8 %shl.6, %52
  %53 = load i32, ptr %bits_to_go, align 4
  %dec.6 = add nsw i32 %53, -1
  store i32 %dec.6, ptr %bits_to_go, align 4
  %cmp13.6 = icmp eq i32 %dec.6, 0
  br i1 %cmp13.6, label %if.then15.6, label %for.inc.6

if.then15.6:                                      ; preds = %for.inc.5
  store i32 8, ptr %bits_to_go, align 4
  %54 = load ptr, ptr %streamBuffer18, align 8
  %55 = load i32, ptr %dest, align 8
  %inc.6 = add nsw i32 %55, 1
  store i32 %inc.6, ptr %dest, align 8
  %idxprom20.6 = sext i32 %55 to i64
  %arrayidx21.6 = getelementptr inbounds i8, ptr %54, i64 %idxprom20.6
  store i8 %spec.select127, ptr %arrayidx21.6, align 1
  %.pre120 = load ptr, ptr %streamBuffer, align 8
  br label %for.inc.6

for.inc.6:                                        ; preds = %if.then15.6, %for.inc.5
  %56 = phi ptr [ %.pre120, %if.then15.6 ], [ %48, %for.inc.5 ]
  %57 = phi i8 [ 0, %if.then15.6 ], [ %spec.select127, %for.inc.5 ]
  %shl.7 = shl i8 %57, 1
  store i8 %shl.7, ptr %byte_buf, align 8
  %arrayidx.7 = getelementptr inbounds i8, ptr %56, i64 %indvars.iv
  %58 = load i8, ptr %arrayidx.7, align 1
  %59 = and i8 %58, 1
  %tobool.not.7 = icmp eq i8 %59, 0
  br i1 %tobool.not.7, label %if.end.7, label %if.then.7

if.then.7:                                        ; preds = %for.inc.6
  %60 = or i8 %shl.7, 1
  store i8 %60, ptr %byte_buf, align 8
  br label %if.end.7

if.end.7:                                         ; preds = %if.then.7, %for.inc.6
  %61 = phi i8 [ %60, %if.then.7 ], [ %shl.7, %for.inc.6 ]
  %62 = load i32, ptr %bits_to_go, align 4
  %dec.7 = add nsw i32 %62, -1
  store i32 %dec.7, ptr %bits_to_go, align 4
  %cmp13.7 = icmp eq i32 %dec.7, 0
  br i1 %cmp13.7, label %if.then15.7, label %for.inc.7

if.then15.7:                                      ; preds = %if.end.7
  store i32 8, ptr %bits_to_go, align 4
  %63 = load ptr, ptr %streamBuffer18, align 8
  %64 = load i32, ptr %dest, align 8
  %inc.7 = add nsw i32 %64, 1
  store i32 %inc.7, ptr %dest, align 8
  %idxprom20.7 = sext i32 %64 to i64
  %arrayidx21.7 = getelementptr inbounds i8, ptr %63, i64 %idxprom20.7
  store i8 %61, ptr %arrayidx21.7, align 1
  store i8 0, ptr %byte_buf, align 8
  br label %for.inc.7

for.inc.7:                                        ; preds = %if.then15.7, %if.end.7
  %65 = phi i8 [ 0, %if.then15.7 ], [ %61, %if.end.7 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %66 = load i32, ptr %source, align 8
...
for.end27:                                        ; preds = %for.inc.7, %entry
  ...
  %68 = load i32, ptr %bits_to_go28, align 4
  %cmp29 = icmp slt i32 %68, 8
...
for.body38.lr.ph:                                 ; preds = %for.end27
  ...
  %.pre121 = load i8, ptr %byte_buf39, align 8
  br label %for.body38

for.body38:                                       ; preds = %for.body38.lr.ph, %for.inc72
  %69 = phi i8 [ %.pre121, %for.body38.lr.ph ], [ %76, %for.inc72 ]
  %mask.1.in112 = phi i32 [ %shl33, %for.body38.lr.ph ], [ %shr57, %for.inc72 ]
  %j.1111 = phi i32 [ 0, %for.body38.lr.ph ], [ %inc73, %for.inc72 ]
  %shl41 = shl i8 %69, 1
  store i8 %shl41, ptr %byte_buf39, align 8
  %70 = load i8, ptr %byte_buf43, align 8
  %conv44 = zext i8 %70 to i32
...
if.then48:                                        ; preds = %for.body38
  %71 = or i8 %shl41, 1
  store i8 %71, ptr %byte_buf39, align 8
  br label %if.end53

if.end53:                                         ; preds = %if.then48, %for.body38
  %72 = phi i8 [ %71, %if.then48 ], [ %shl41, %for.body38 ]
  %73 = load i32, ptr %bits_to_go54, align 4
  %dec55 = add nsw i32 %73, -1
  store i32 %dec55, ptr %bits_to_go54, align 4
...
if.then62:                                        ; preds = %if.end53
  store i32 8, ptr %bits_to_go54, align 4
  %74 = load ptr, ptr %streamBuffer65, align 8
  %75 = load i32, ptr %dest, align 8
  %inc67 = add nsw i32 %75, 1
  store i32 %inc67, ptr %dest, align 8
  %idxprom68 = sext i32 %75 to i64
  %arrayidx69 = getelementptr inbounds i8, ptr %74, i64 %idxprom68
  store i8 %72, ptr %arrayidx69, align 1
  store i8 0, ptr %byte_buf39, align 8
  br label %for.inc72

for.inc72:                                        ; preds = %if.end53, %if.then62
  %76 = phi i8 [ %72, %if.end53 ], [ 0, %if.then62 ]
  %inc73 = add nuw nsw i32 %j.1111, 1
  %exitcond.not = icmp eq i32 %inc73, %smax
  br i1 %exitcond.not, label %if.end75, label %for.body38
...
entry:
  %0 = load ptr, ptr getelementptr inbounds (%struct.spare_picture_struct, ptr @seiSparePicturePayload, i64 0, i32 3), align 8
...
if.end:                                           ; preds = %CloseSparePicture.exit, %entry
  ...
  store ptr %call, ptr getelementptr inbounds (%struct.spare_picture_struct, ptr @seiSparePicturePayload, i64 0, i32 3), align 8
  %cmp1 = icmp eq ptr %call, null
  br i1 %cmp1, label %if.then2, label %if.end3

if.then2:                                         ; preds = %if.end
  tail call void @no_mem_exit(ptr noundef nonnull @.str.1) #19
  %.pre = load ptr, ptr getelementptr inbounds (%struct.spare_picture_struct, ptr @seiSparePicturePayload, i64 0, i32 3), align 8
  br label %if.end3
...
if.end3:                                          ; preds = %if.then2, %if.end
  ...
  store ptr %call4, ptr %streamBuffer, align 8
  %cmp6 = icmp eq ptr %call4, null
  br i1 %cmp6, label %if.then7, label %if.end8

if.then7:                                         ; preds = %if.end3
  tail call void @no_mem_exit(ptr noundef nonnull @.str.2) #19
  %.pre10 = load ptr, ptr getelementptr inbounds (%struct.spare_picture_struct, ptr @seiSparePicturePayload, i64 0, i32 3), align 8
  %streamBuffer9.phi.trans.insert = getelementptr inbounds %struct.Bitstream, ptr %.pre10, i64 0, i32 9
  %.pre11 = load ptr, ptr %streamBuffer9.phi.trans.insert, align 8
  br label %if.end8
...
if.end8:                                          ; preds = %if.then7, %if.end3
  ...
  store i32 0, ptr getelementptr inbounds (%struct.spare_picture_struct, ptr @seiSparePicturePayload, i64 0, i32 1), align 4
  store i32 0, ptr @seiSparePicturePayload, align 8
  %5 = load ptr, ptr getelementptr inbounds (%struct.spare_picture_struct, ptr @seiSparePicturePayload, i64 0, i32 3), align 8
...
for.cond11.preheader:                             ; preds = %for.cond11.preheader.lr.ph, %for.inc132
  ...
  %4 = load i32, ptr %width12266, align 4
...
if.else:                                          ; preds = %for.body15
  store i32 %noc.1269, ptr %value1, align 4
...
if.else54:                                        ; preds = %if.then49
  ...
  %8 = load i32, ptr %width55, align 4
  %div56 = sdiv i32 %8, 16
...
if.else109:                                       ; preds = %if.then104
  ...
  %10 = load i32, ptr %height110, align 4
...
for.inc:                                          ; preds = %if.then31, %if.then37, %if.else34, %if.then27, %if.then86, %if.then92, %if.else89, %if.then81, %if.then107, %if.else118, %if.then121, %if.then115, %if.else98, %if.then52, %if.else63, %if.then66, %if.then60
  ...
  %12 = load i32, ptr %width12, align 4
...
if.then137:                                       ; preds = %for.end134
  ...
  store i32 %noc.1.lcssa, ptr %value1138, align 4
...
for.cond151.preheader:                            ; preds = %for.cond151.preheader.lr.ph, %for.inc187
  ...
  %19 = load i32, ptr %width152305, align 4
...
for.inc184:                                       ; preds = %if.end169, %if.then175
  ...
  %33 = load i32, ptr %width152, align 4
...
for.inc187:                                       ; preds = %for.inc184, %for.cond151.preheader
  ...
  %37 = load i32, ptr %height146, align 4
...
entry:
  ...
  %mapping = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 7
  store ptr @ue_linfo, ptr %mapping, align 8
  %2 = load ptr, ptr getelementptr inbounds (%struct.spare_picture_struct, ptr @seiSparePicturePayload, i64 0, i32 3), align 8
  %call = tail call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #18
...
if.end:                                           ; preds = %if.then, %entry
  ...
  store ptr %call1, ptr %streamBuffer, align 8
...
if.end5:                                          ; preds = %if.then4, %if.end
  ...
  %3 = load i32, ptr @seiSparePicturePayload, align 8
  %sub = sub nsw i32 %rem, %3
  %4 = lshr i32 %sub, 23
  %5 = and i32 %4, 256
  %spec.select = add i32 %5, %sub
  %value1 = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 1
  ...
  %6 = load i32, ptr getelementptr inbounds (%struct.spare_picture_struct, ptr @seiSparePicturePayload, i64 0, i32 1), align 4
  %sub11 = add nsw i32 %6, -1
  store i32 %sub11, ptr %value1, align 4
  ...
  %7 = load i32, ptr %bits_to_go, align 4
  %cmp15.not = icmp eq i32 %7, 8
  br i1 %cmp15.not, label %if.end38, label %if.then16

if.then16:                                        ; preds = %if.end5
  %8 = load i8, ptr %byte_buf, align 8
  %shl = shl i8 %8, 1
  %9 = or i8 %shl, 1
  %dec = add nsw i32 %7, -1
  ...
  %10 = select i1 %cmp24.not, i8 %9, i8 %conv31
  store i32 8, ptr %bits_to_go, align 4
  %11 = load ptr, ptr %streamBuffer, align 8
...
if.end38:                                         ; preds = %if.then16, %if.end5
  ...
  store i32 %13, ptr getelementptr inbounds (%struct.spare_picture_struct, ptr @seiSparePicturePayload, i64 0, i32 2), align 8
  store ptr %call, ptr getelementptr inbounds (%struct.spare_picture_struct, ptr @seiSparePicturePayload, i64 0, i32 3), align 8
  %streamBuffer40 = getelementptr inbounds %struct.Bitstream, ptr %2, i64 0, i32 9
  %14 = load ptr, ptr %streamBuffer40, align 8
...
entry:
  store i32 1, ptr @seiHasSubseqInfo, align 4
...
if.then:                                          ; preds = %entry
  %idxprom = sext i32 %currLayer to i64
  %stored_frame_cnt = getelementptr inbounds [2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 %idxprom, i32 3
  %2 = load i32, ptr %stored_frame_cnt, align 4
  %inc = add i32 %2, 1
  %rem = and i32 %inc, 255
  store i32 %rem, ptr %stored_frame_cnt, align 4
  br label %if.end
...
if.then8:                                         ; preds = %if.end
  ...
  %5 = load i32, ptr %no_frames, align 8
  %sub = add nsw i32 %5, -1
  %cmp9 = icmp eq i32 %3, %sub
  br i1 %cmp9, label %if.then10, label %if.else

if.then10:                                        ; preds = %if.then8
  store i32 1, ptr getelementptr inbounds ([2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 0, i32 2), align 8
  br label %if.end48

if.else:                                          ; preds = %if.then8
  store i32 0, ptr getelementptr inbounds ([2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 0, i32 2), align 8
  br label %if.end48
...
land.lhs.true:                                    ; preds = %if.then19
  ...
  %10 = load i32, ptr %successive_Bframe, align 8
...
land.lhs.true36:                                  ; preds = %lor.lhs.false
  ...
  %11 = load i32, ptr %successive_Bframe37, align 8
  %cmp38 = icmp eq i32 %11, 0
  br i1 %cmp38, label %if.then39, label %if.else43

if.then39:                                        ; preds = %land.lhs.true, %land.lhs.true36
  store i32 1, ptr getelementptr inbounds ([2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 1, i32 2), align 8
  br label %if.end48

if.else43:                                        ; preds = %land.lhs.true36, %lor.lhs.false
  store i32 0, ptr getelementptr inbounds ([2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 1, i32 2), align 8
  br label %if.end48
...
entry:
  ...
  %stored_frame_cnt = getelementptr inbounds [2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 %idxprom, i32 3
  %4 = load i32, ptr %stored_frame_cnt, align 4
...
if.then:                                          ; preds = %entry
  ...
  %6 = load i8, ptr %byte_buf, align 8
  %shl = shl i8 %6, 1
  %7 = or i8 %shl, 1
  %dec = add nsw i32 %5, -1
...
if.end33:                                         ; preds = %if.then, %entry
  ...
  %payloadSize = getelementptr inbounds [2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 %idxprom, i32 4
  store i32 %11, ptr %payloadSize, align 16
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %sym) #19
  ret void
}
...
entry:
  store i32 0, ptr getelementptr inbounds (%struct.subseq_layer_information_struct, ptr @seiSubseqLayerInfo, i64 0, i32 4), align 4
  %0 = load i32, ptr getelementptr inbounds (%struct.subseq_layer_information_struct, ptr @seiSubseqLayerInfo, i64 0, i32 3), align 4
...
for.body:                                         ; preds = %for.body, %for.body.preheader.new
  ...
  %4 = load i16, ptr %arrayidx4, align 4
  ...
  store i16 %5, ptr %arrayidx2.1, align 4
...
for.body.epil:                                    ; preds = %for.cond.for.end_crit_edge.unr-lcssa
  ...
  %8 = load i16, ptr %arrayidx.epil, align 2
  ...
  store i16 %8, ptr %arrayidx2.epil, align 4
...
entry:
  %call = tail call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #18
  store ptr %call, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 10), align 8
  %cmp = icmp eq ptr %call, null
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  tail call void @no_mem_exit(ptr noundef nonnull @.str.7) #19
  %.pre = load ptr, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 10), align 8
  br label %if.end
...
if.then4:                                         ; preds = %if.end
  tail call void @no_mem_exit(ptr noundef nonnull @.str.8) #19
  %.pre7 = load ptr, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 10), align 8
  %streamBuffer.i.phi.trans.insert = getelementptr inbounds %struct.Bitstream, ptr %.pre7, i64 0, i32 9
  %.pre8 = load ptr, ptr %streamBuffer.i.phi.trans.insert, align 8
  br label %if.end5
...
if.end5:                                          ; preds = %if.then4, %if.end
  ...
  %4 = load i32, ptr %layer, align 8
  store i32 %4, ptr @seiSubseqChar, align 8
  %idxprom = sext i32 %4 to i64
  %subseq_id = getelementptr inbounds [2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 %idxprom, i32 1
  %5 = load i32, ptr %subseq_id, align 4
  store i32 %5, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 1), align 4
  store i32 0, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 2), align 8
  store i32 0, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 4), align 8
  store i32 0, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 7), align 4
  ret void
...
entry:
  ...
  %1 = load i32, ptr %layer, align 8
  store i32 %1, ptr @seiSubseqChar, align 8
  %idxprom = sext i32 %1 to i64
  %subseq_id = getelementptr inbounds [2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 %idxprom, i32 1
  %2 = load i32, ptr %subseq_id, align 4
  store i32 %2, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 1), align 4
  store i32 0, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 2), align 8
  store <4 x i32> <i32 0, i32 100, i32 30, i32 0>, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 4), align 8
  store i32 1, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 8), align 8
  store i32 2, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 9), align 4
  store i32 3, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 8, i64 1), align 4
  store i32 4, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 9, i64 1), align 8
  store i32 1, ptr @seiHasSubseqChar, align 4
  ret void
}
...
entry:
  ...
  %mapping = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 7
  store ptr @ue_linfo, ptr %mapping, align 8
  %1 = load i32, ptr @seiSubseqChar, align 8
  %value1 = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 1
  store i32 %1, ptr %value1, align 4
  %call = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %0) #19
  %2 = load i32, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 1), align 4
  store i32 %2, ptr %value1, align 4
  %call2 = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %0) #19
  %3 = load i32, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 2), align 8
  %bitpattern = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 5
  store i32 %3, ptr %bitpattern, align 4
  %len = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 3
  store i32 1, ptr %len, align 4
  %call3 = call i32 @writeSyntaxElement2Buf_Fixed(ptr noundef nonnull %sym, ptr noundef %0) #19
  %4 = load i32, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 2), align 8
  %tobool.not = icmp eq i32 %4, 0
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %5 = load i32, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 3), align 4
  store i32 %5, ptr %bitpattern, align 4
  store i32 32, ptr %len, align 4
  %call6 = call i32 @writeSyntaxElement2Buf_Fixed(ptr noundef nonnull %sym, ptr noundef %0) #19
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %6 = load i32, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 4), align 8
  store i32 %6, ptr %bitpattern, align 4
  store i32 1, ptr %len, align 4
  %call9 = call i32 @writeSyntaxElement2Buf_Fixed(ptr noundef nonnull %sym, ptr noundef %0) #19
  %7 = load i32, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 4), align 8
  %tobool10.not = icmp eq i32 %7, 0
  br i1 %tobool10.not, label %if.end18, label %if.then11

if.then11:                                        ; preds = %if.end
  %8 = load i32, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 5), align 4
  store i32 %8, ptr %bitpattern, align 4
  store i32 16, ptr %len, align 4
  %call14 = call i32 @writeSyntaxElement2Buf_Fixed(ptr noundef nonnull %sym, ptr noundef %0) #19
  %9 = load i32, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 6), align 8
  store i32 %9, ptr %bitpattern, align 4
  store i32 16, ptr %len, align 4
  %call17 = call i32 @writeSyntaxElement2Buf_Fixed(ptr noundef nonnull %sym, ptr noundef %0) #19
  br label %if.end18

if.end18:                                         ; preds = %if.then11, %if.end
  %10 = load i32, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 7), align 4
  store i32 %10, ptr %value1, align 4
  %call20 = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %0) #19
  %11 = load i32, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 7), align 4
...
for.body:                                         ; preds = %if.end18, %for.body
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %14 = load i32, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 7), align 4
...
if.then28:                                        ; preds = %for.end
  ...
  store i32 8, ptr %bits_to_go, align 4
  %streamBuffer = getelementptr inbounds %struct.Bitstream, ptr %0, i64 0, i32 9
  %20 = load ptr, ptr %streamBuffer, align 8
  %21 = load i32, ptr %0, align 8
  %inc46 = add nsw i32 %21, 1
  store i32 %inc46, ptr %0, align 8
  %idxprom47 = sext i32 %21 to i64
  %arrayidx48 = getelementptr inbounds i8, ptr %20, i64 %idxprom47
  store i8 %19, ptr %arrayidx48, align 1
  store i8 0, ptr %byte_buf, align 8
  br label %if.end50

if.end50:                                         ; preds = %if.then28, %for.end
  %22 = load i32, ptr %0, align 8
  store i32 %22, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 11), align 8
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %sym) #19
  ret void
}
...
entry:
  ...
  store i32 -1, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 2), align 8
  %call = tail call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #18
  store ptr %call, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 3), align 8
  %cmp = icmp eq ptr %call, null
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  tail call void @no_mem_exit(ptr noundef nonnull @.str.9) #19
  %.pre = load ptr, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 3), align 8
  br label %if.end
...
if.then4:                                         ; preds = %if.end
  tail call void @no_mem_exit(ptr noundef nonnull @.str.10) #19
  %.pre7 = load ptr, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 3), align 8
  %streamBuffer6.phi.trans.insert = getelementptr inbounds %struct.Bitstream, ptr %.pre7, i64 0, i32 9
  %.pre8 = load ptr, ptr %streamBuffer6.phi.trans.insert, align 8
  br label %if.end5
...
entry:
  %0 = load ptr, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 3), align 8
  %tobool.not = icmp eq ptr %0, null
  br i1 %tobool.not, label %if.end, label %if.then
...
if.then:                                          ; preds = %entry
  ...
  %1 = load ptr, ptr %streamBuffer, align 8
  tail call void @free(ptr noundef %1) #19
  %2 = load ptr, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 3), align 8
  tail call void @free(ptr noundef %2) #19
  br label %if.end
...
entry:
  ...
  %mapping = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 7
  store ptr @ue_linfo, ptr %mapping, align 8
  %1 = load i32, ptr @seiSceneInformation, align 8
  %bitpattern = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 5
  store i32 %1, ptr %bitpattern, align 4
  %len = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 3
  store i32 8, ptr %len, align 4
  %call = call i32 @writeSyntaxElement2Buf_Fixed(ptr noundef nonnull %sym, ptr noundef %0) #19
  %2 = load i32, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 1), align 4
  %value1 = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 1
  store i32 %2, ptr %value1, align 4
  %call1 = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %0) #19
  %3 = load i32, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 1), align 4
  %cmp = icmp sgt i32 %3, 3
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %4 = load i32, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 2), align 8
  store i32 %4, ptr %bitpattern, align 4
  store i32 8, ptr %len, align 4
...
if.end25:                                         ; preds = %if.then6, %if.end
  %11 = load i32, ptr %0, align 8
  store i32 %11, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 4), align 8
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %sym) #19
  ret void
}
...
entry:
  store i32 %HasSceneInformation, ptr @seiHasSceneInformation, align 4
  store i32 %sceneID, ptr @seiSceneInformation, align 8
  store i32 %sceneTransType, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 1), align 4
  %cmp = icmp sgt i32 %sceneTransType, 3
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  store i32 %secondSceneID, ptr getelementptr inbounds (%struct.scene_information_struct, ptr @seiSceneInformation, i64 0, i32 2), align 8
  br label %if.end
...
entry:
  %call = tail call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #18
  store ptr %call, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 5), align 8
  %cmp = icmp eq ptr %call, null
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  tail call void @no_mem_exit(ptr noundef nonnull @.str.11) #19
  %.pre = load ptr, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 5), align 8
  br label %if.end
...
if.then4:                                         ; preds = %if.end
  tail call void @no_mem_exit(ptr noundef nonnull @.str.12) #19
  %.pre6 = load ptr, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 5), align 8
  %streamBuffer.i.phi.trans.insert = getelementptr inbounds %struct.Bitstream, ptr %.pre6, i64 0, i32 9
  %.pre7 = load ptr, ptr %streamBuffer.i.phi.trans.insert, align 8
  br label %if.end5

if.end5:                                          ; preds = %if.then4, %if.end
  %1 = phi ptr [ %.pre7, %if.then4 ], [ %call1, %if.end ]
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(65496) %1, i8 0, i64 65496, i1 false)
  %2 = load ptr, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 5), align 8
  %bits_to_go.i = getelementptr inbounds %struct.Bitstream, ptr %2, i64 0, i32 1
  store i32 8, ptr %bits_to_go.i, align 4
  store i32 0, ptr %2, align 8
  %byte_buf.i = getelementptr inbounds %struct.Bitstream, ptr %2, i64 0, i32 2
...
entry:
  %0 = load ptr, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 5), align 8
  %streamBuffer = getelementptr inbounds %struct.Bitstream, ptr %0, i64 0, i32 9
  %1 = load ptr, ptr %streamBuffer, align 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(65496) %1, i8 0, i64 65496, i1 false)
  %2 = load ptr, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 5), align 8
...
entry:
  store <4 x i32> <i32 3, i32 10, i32 40, i32 20>, ptr @seiPanScanRectInfo, align 8
  store i32 32, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 4), align 8
  store i32 1, ptr @seiHasPanScanRectInfo, align 4
  ret void
}
...
entry:
  ...
  %mapping = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 7
  store ptr @ue_linfo, ptr %mapping, align 8
  %1 = load i32, ptr @seiPanScanRectInfo, align 8
  %value1 = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 1
  store i32 %1, ptr %value1, align 4
  %call = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %0) #19
  %2 = load i32, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 1), align 4
  store i32 %2, ptr %value1, align 4
  %call2 = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %0) #19
  %3 = load i32, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 2), align 8
  store i32 %3, ptr %value1, align 4
  %call4 = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %0) #19
  %4 = load i32, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 3), align 4
  store i32 %4, ptr %value1, align 4
  %call6 = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %0) #19
  %5 = load i32, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 4), align 8
  store i32 %5, ptr %value1, align 4
  %call8 = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %0) #19
  %bits_to_go = getelementptr inbounds %struct.Bitstream, ptr %0, i64 0, i32 1
  %6 = load i32, ptr %bits_to_go, align 4
  %cmp.not = icmp eq i32 %6, 8
  br i1 %cmp.not, label %if.end26, label %if.then

if.then:                                          ; preds = %entry
  %byte_buf = getelementptr inbounds %struct.Bitstream, ptr %0, i64 0, i32 2
  %7 = load i8, ptr %byte_buf, align 8
  %shl = shl i8 %7, 1
  %8 = or i8 %shl, 1
  %dec = add nsw i32 %6, -1
...
if.end26:                                         ; preds = %if.then, %entry
  ...
  store i32 %12, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 6), align 8
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %sym) #19
  ret void
}
...
entry:
  %call = tail call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #18
  store ptr %call, ptr getelementptr inbounds (%struct.user_data_unregistered_information_struct, ptr @seiUser_data_unregistered, i64 0, i32 2), align 8
  %cmp = icmp eq ptr %call, null
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  tail call void @no_mem_exit(ptr noundef nonnull @.str.13) #19
  %.pre = load ptr, ptr getelementptr inbounds (%struct.user_data_unregistered_information_struct, ptr @seiUser_data_unregistered, i64 0, i32 2), align 8
  br label %if.end
...
if.end5:                                          ; preds = %if.then4, %if.end
  ...
  store ptr %call6, ptr @seiUser_data_unregistered, align 8
...
if.end9:                                          ; preds = %if.then8, %if.end5
  %1 = load ptr, ptr getelementptr inbounds (%struct.user_data_unregistered_information_struct, ptr @seiUser_data_unregistered, i64 0, i32 2), align 8
  %streamBuffer.i = getelementptr inbounds %struct.Bitstream, ptr %1, i64 0, i32 9
  %2 = load ptr, ptr %streamBuffer.i, align 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(65496) %2, i8 0, i64 65496, i1 false)
  %3 = load ptr, ptr getelementptr inbounds (%struct.user_data_unregistered_information_struct, ptr @seiUser_data_unregistered, i64 0, i32 2), align 8
  ...
  store i8 0, ptr %byte_buf.i, align 8
  store i32 0, ptr getelementptr inbounds (%struct.user_data_unregistered_information_struct, ptr @seiUser_data_unregistered, i64 0, i32 3), align 8
  %4 = load ptr, ptr @seiUser_data_unregistered, align 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(65496) %4, i8 0, i64 65496, i1 false)
  store i32 0, ptr getelementptr inbounds (%struct.user_data_unregistered_information_struct, ptr @seiUser_data_unregistered, i64 0, i32 1), align 8
  store i32 1, ptr @seiHasUser_data_unregistered_info, align 4
  ret void
}
...
entry:
  %0 = load ptr, ptr getelementptr inbounds (%struct.user_data_unregistered_information_struct, ptr @seiUser_data_unregistered, i64 0, i32 2), align 8
  %streamBuffer = getelementptr inbounds %struct.Bitstream, ptr %0, i64 0, i32 9
  %1 = load ptr, ptr %streamBuffer, align 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(65496) %1, i8 0, i64 65496, i1 false)
  %2 = load ptr, ptr getelementptr inbounds (%struct.user_data_unregistered_information_struct, ptr @seiUser_data_unregistered, i64 0, i32 2), align 8
  %bits_to_go = getelementptr inbounds %struct.Bitstream, ptr %2, i64 0, i32 1
  store i32 8, ptr %bits_to_go, align 4
  store i32 0, ptr %2, align 8
  %byte_buf = getelementptr inbounds %struct.Bitstream, ptr %2, i64 0, i32 2
  store i8 0, ptr %byte_buf, align 8
  store i32 0, ptr getelementptr inbounds (%struct.user_data_unregistered_information_struct, ptr @seiUser_data_unregistered, i64 0, i32 3), align 8
  %3 = load ptr, ptr @seiUser_data_unregistered, align 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(65496) %3, i8 0, i64 65496, i1 false)
  store i32 0, ptr getelementptr inbounds (%struct.user_data_unregistered_information_struct, ptr @seiUser_data_unregistered, i64 0, i32 1), align 8
  store i32 1, ptr @seiHasUser_data_unregistered_info, align 4
  ret void
...
entry:
  %0 = load ptr, ptr @seiUser_data_unregistered, align 8
  store i8 0, ptr %0, align 1
  %1 = load ptr, ptr @seiUser_data_unregistered, align 8
  %arrayidx.1 = getelementptr inbounds i8, ptr %1, i64 1
  store i8 4, ptr %arrayidx.1, align 1
  %2 = load ptr, ptr @seiUser_data_unregistered, align 8
  ...
  %5 = load ptr, ptr @seiUser_data_unregistered, align 8
  %arrayidx.5 = getelementptr inbounds i8, ptr %5, i64 5
  store i8 20, ptr %arrayidx.5, align 1
  %6 = load ptr, ptr @seiUser_data_unregistered, align 8
  %arrayidx.6 = getelementptr inbounds i8, ptr %6, i64 6
  store i8 24, ptr %arrayidx.6, align 1
  store i32 7, ptr getelementptr inbounds (%struct.user_data_unregistered_information_struct, ptr @seiUser_data_unregistered, i64 0, i32 1), align 8
  ret void
}
...
entry:
  ...
  %mapping = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 7
  store ptr @ue_linfo, ptr %mapping, align 8
  %1 = load i32, ptr getelementptr inbounds (%struct.user_data_unregistered_information_struct, ptr @seiUser_data_unregistered, i64 0, i32 1), align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %call = call i32 @writeSyntaxElement2Buf_Fixed(ptr noundef nonnull %sym, ptr noundef %0) #19
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %4 = load i32, ptr getelementptr inbounds (%struct.user_data_unregistered_information_struct, ptr @seiUser_data_unregistered, i64 0, i32 1), align 8
  %5 = sext i32 %4 to i64
...
if.then:                                          ; preds = %for.end
  ...
  store i8 %9, ptr %arrayidx22, align 1
  store i8 0, ptr %byte_buf, align 8
  br label %if.end24

if.end24:                                         ; preds = %if.then, %for.end
  %12 = load i32, ptr %0, align 8
  store i32 %12, ptr getelementptr inbounds (%struct.user_data_unregistered_information_struct, ptr @seiUser_data_unregistered, i64 0, i32 3), align 8
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %sym) #19
  ret void
}
...
entry:
  %call = tail call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #18
  store ptr %call, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 4), align 8
  %cmp = icmp eq ptr %call, null
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  tail call void @no_mem_exit(ptr noundef nonnull @.str.16) #19
  %.pre = load ptr, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 4), align 8
  br label %if.end
...
if.end5.thread:                                   ; preds = %if.end
  %call611 = tail call noalias dereferenceable_or_null(65496) ptr @malloc(i64 noundef 65496) #18
  store ptr %call611, ptr @seiUser_data_registered_itu_t_t35, align 8
  br label %if.end9

if.end5:                                          ; preds = %if.end
  tail call void @no_mem_exit(ptr noundef nonnull @.str.17) #19
  %.pr = load ptr, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 4), align 8
  %call6 = tail call noalias dereferenceable_or_null(65496) ptr @malloc(i64 noundef 65496) #18
  store ptr %call6, ptr @seiUser_data_registered_itu_t_t35, align 8
  %cmp7 = icmp eq ptr %.pr, null
  br i1 %cmp7, label %if.then8, label %if.end9

if.then8:                                         ; preds = %if.end5
  tail call void @no_mem_exit(ptr noundef nonnull @.str.18) #19
  %.pre10 = load ptr, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 4), align 8
  br label %if.end9

if.end9:                                          ; preds = %if.end5.thread, %if.then8, %if.end5
  %1 = phi ptr [ %.pre10, %if.then8 ], [ %.pr, %if.end5 ], [ %0, %if.end5.thread ]
  %streamBuffer.i = getelementptr inbounds %struct.Bitstream, ptr %1, i64 0, i32 9
  %2 = load ptr, ptr %streamBuffer.i, align 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(65496) %2, i8 0, i64 65496, i1 false)
  %3 = load ptr, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 4), align 8
  %bits_to_go.i = getelementptr inbounds %struct.Bitstream, ptr %3, i64 0, i32 1
  store i32 8, ptr %bits_to_go.i, align 4
  store i32 0, ptr %3, align 8
  %byte_buf.i = getelementptr inbounds %struct.Bitstream, ptr %3, i64 0, i32 2
  store i8 0, ptr %byte_buf.i, align 8
  store i32 0, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 5), align 8
  %4 = load ptr, ptr @seiUser_data_registered_itu_t_t35, align 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(65496) %4, i8 0, i64 65496, i1 false)
  store i32 0, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 1), align 8
  store i32 0, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 2), align 4
  store i32 0, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 3), align 8
  store i32 1, ptr @seiHasUser_data_registered_itu_t_t35_info, align 4
  ret void
}
...
entry:
  %0 = load ptr, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 4), align 8
  %streamBuffer = getelementptr inbounds %struct.Bitstream, ptr %0, i64 0, i32 9
  %1 = load ptr, ptr %streamBuffer, align 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(65496) %1, i8 0, i64 65496, i1 false)
  %2 = load ptr, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 4), align 8
  %bits_to_go = getelementptr inbounds %struct.Bitstream, ptr %2, i64 0, i32 1
  store i32 8, ptr %bits_to_go, align 4
  store i32 0, ptr %2, align 8
  %byte_buf = getelementptr inbounds %struct.Bitstream, ptr %2, i64 0, i32 2
  store i8 0, ptr %byte_buf, align 8
  store i32 0, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 5), align 8
  %3 = load ptr, ptr @seiUser_data_registered_itu_t_t35, align 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(65496) %3, i8 0, i64 65496, i1 false)
  store i32 0, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 1), align 8
  store i32 0, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 2), align 4
  store i32 0, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 3), align 8
...
entry:
  store i32 82, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 2), align 4
  %0 = load ptr, ptr @seiUser_data_registered_itu_t_t35, align 8
  store i8 0, ptr %0, align 1
  %1 = load ptr, ptr @seiUser_data_registered_itu_t_t35, align 8
  %arrayidx.1 = getelementptr inbounds i8, ptr %1, i64 1
  store i8 3, ptr %arrayidx.1, align 1
  %2 = load ptr, ptr @seiUser_data_registered_itu_t_t35, align 8
  %arrayidx.2 = getelementptr inbounds i8, ptr %2, i64 2
  store i8 6, ptr %arrayidx.2, align 1
  %3 = load ptr, ptr @seiUser_data_registered_itu_t_t35, align 8
  %arrayidx.3 = getelementptr inbounds i8, ptr %3, i64 3
  store i8 9, ptr %arrayidx.3, align 1
  %4 = load ptr, ptr @seiUser_data_registered_itu_t_t35, align 8
  %arrayidx.4 = getelementptr inbounds i8, ptr %4, i64 4
  store i8 12, ptr %arrayidx.4, align 1
  %5 = load ptr, ptr @seiUser_data_registered_itu_t_t35, align 8
  %arrayidx.5 = getelementptr inbounds i8, ptr %5, i64 5
  store i8 15, ptr %arrayidx.5, align 1
  %6 = load ptr, ptr @seiUser_data_registered_itu_t_t35, align 8
  %arrayidx.6 = getelementptr inbounds i8, ptr %6, i64 6
  store i8 18, ptr %arrayidx.6, align 1
  store i32 7, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 1), align 8
  ret void
}
...
entry:
  ...
  %mapping = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 7
  store ptr @ue_linfo, ptr %mapping, align 8
  %1 = load i32, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 2), align 4
  %bitpattern = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 5
  store i32 %1, ptr %bitpattern, align 4
  %len = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 3
  store i32 8, ptr %len, align 4
  %call = call i32 @writeSyntaxElement2Buf_Fixed(ptr noundef nonnull %sym, ptr noundef %0) #19
  %2 = load i32, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 2), align 4
  %cmp = icmp eq i32 %2, 255
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %3 = load i32, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 3), align 8
  store i32 %3, ptr %bitpattern, align 4
  store i32 8, ptr %len, align 4
  %call3 = call i32 @writeSyntaxElement2Buf_Fixed(ptr noundef nonnull %sym, ptr noundef %0) #19
  br label %if.end
...
if.end:                                           ; preds = %if.then, %entry
  %4 = load i32, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 1), align 8
...
for.body:                                         ; preds = %if.end, %for.body
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %7 = load i32, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 1), align 8
  %8 = sext i32 %7 to i64
...
if.then10:                                        ; preds = %for.end
  ...
  store i32 8, ptr %bits_to_go, align 4
  %streamBuffer = getelementptr inbounds %struct.Bitstream, ptr %0, i64 0, i32 9
  %13 = load ptr, ptr %streamBuffer, align 8
  %14 = load i32, ptr %0, align 8
  %inc29 = add nsw i32 %14, 1
  store i32 %inc29, ptr %0, align 8
...
if.end33:                                         ; preds = %if.then10, %for.end
  ...
  store i32 %15, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 5), align 8
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %sym) #19
  ret void
}
...
entry:
  %call = tail call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #18
  store ptr %call, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 4), align 8
  %cmp = icmp eq ptr %call, null
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  tail call void @no_mem_exit(ptr noundef nonnull @.str.19) #19
  %.pre = load ptr, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 4), align 8
  br label %if.end
...
if.then4:                                         ; preds = %if.end
  tail call void @no_mem_exit(ptr noundef nonnull @.str.20) #19
  %.pre6 = load ptr, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 4), align 8
  %streamBuffer.i.phi.trans.insert = getelementptr inbounds %struct.Bitstream, ptr %.pre6, i64 0, i32 9
  %.pre7 = load ptr, ptr %streamBuffer.i.phi.trans.insert, align 8
  br label %if.end5
...
if.end5:                                          ; preds = %if.then4, %if.end
  %1 = phi ptr [ %.pre7, %if.then4 ], [ %call1, %if.end ]
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(65496) %1, i8 0, i64 65496, i1 false)
  %2 = load ptr, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 4), align 8
  %bits_to_go.i = getelementptr inbounds %struct.Bitstream, ptr %2, i64 0, i32 1
  store i32 8, ptr %bits_to_go.i, align 4
  store i32 0, ptr %2, align 8
  %byte_buf.i = getelementptr inbounds %struct.Bitstream, ptr %2, i64 0, i32 2
...
entry:
  %0 = load ptr, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 4), align 8
  %streamBuffer = getelementptr inbounds %struct.Bitstream, ptr %0, i64 0, i32 9
  %1 = load ptr, ptr %streamBuffer, align 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(65496) %1, i8 0, i64 65496, i1 false)
  %2 = load ptr, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 4), align 8
...
if.then:                                          ; preds = %entry
  store i32 0, ptr @seiRecoveryPoint, align 8
  store i8 1, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 1), align 4
  store i8 0, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 2), align 1
  br label %if.end

if.end:                                           ; preds = %entry, %if.then
  %storemerge = phi i32 [ 1, %if.then ], [ 0, %entry ]
  store i32 %storemerge, ptr @seiHasRecoveryPoint_info, align 4
  ret void
}
...
entry:
  %0 = load ptr, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 4), align 8
  %1 = load i32, ptr @seiRecoveryPoint, align 8
  %call = tail call i32 @ue_v(ptr noundef nonnull @.str.21, i32 noundef %1, ptr noundef %0) #19
  %2 = load i8, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 1), align 4
  %conv = zext i8 %2 to i32
  %call1 = tail call i32 @u_1(ptr noundef nonnull @.str.22, i32 noundef %conv, ptr noundef %0) #19
  %3 = load i8, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 2), align 1
  %conv2 = zext i8 %3 to i32
  %call3 = tail call i32 @u_1(ptr noundef nonnull @.str.23, i32 noundef %conv2, ptr noundef %0) #19
  %4 = load i8, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 3), align 2
...
if.end25:                                         ; preds = %if.then, %entry
  %11 = load i32, ptr %0, align 8
  store i32 %11, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 5), align 8
  ret void
}
...
attributes #14 = { mustprogress nofree nosync nounwind willreturn memory(readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
