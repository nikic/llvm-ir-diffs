; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/explicit_gop.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/explicit_gop.c"
...
entry:
  ...
  %2 = load i32, ptr %HierarchicalCoding, align 8
  %cmp = icmp eq i32 %2, 1
...
if.then4:                                         ; preds = %for.body
  ...
  %6 = or i32 %5, 1
  store i32 %6, ptr %display_no, align 4
  store i32 1, ptr %hierarchy_layer, align 4
  store i32 2, ptr %reference_idc, align 4
  %7 = load i32, ptr %qpB27, align 8
  %8 = load i32, ptr %HierarchyLevelQPEnable, align 4
  %tobool.not = icmp eq i32 %8, 0
  br i1 %tobool.not, label %cond.false, label %cond.end

cond.false:                                       ; preds = %if.then4
  %9 = load i32, ptr %qpBRSOffset, align 4
  br label %cond.end
...
if.else:                                          ; preds = %for.body
  ...
  store i32 %mul17, ptr %display_no20, align 4
  store i32 0, ptr %hierarchy_layer, align 4
  store i32 0, ptr %reference_idc, align 4
  %11 = load i32, ptr %qpB27, align 8
  br label %for.inc
...
while.end:                                        ; preds = %while.cond
  ...
  store i32 %GOPlevels.0, ptr %GopLevels37, align 4
...
for.body55:                                       ; preds = %for.body55.lr.ph, %for.body55
  ...
  store i32 %17, ptr %display_no58, align 4
...
for.body86.lr.ph:                                 ; preds = %for.body78
  %18 = load i32, ptr %qpB93, align 8
  %19 = load i32, ptr %HierarchyLevelQPEnable94, align 4
...
for.body86.lr.ph.split.us:                        ; preds = %for.body86.lr.ph
  %20 = load i32, ptr %qpBRSOffset99, align 4
...
for.inc111:                                       ; preds = %for.body86, %for.body86.us, %for.body78
  ...
  br i1 %exitcond221.not, label %for.cond114.preheader, label %for.body78
...
land.rhs:                                         ; preds = %while.cond118.preheader, %while.body130
  ...
  %29 = load i32, ptr %hierarchy_layer127, align 4
...
while.body130:                                    ; preds = %land.rhs
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(24) %tmp, ptr noundef nonnull align 4 dereferenceable(24) %arrayidx126, i64 24, i1 false)
  %arrayidx138 = getelementptr inbounds %struct.GOP_DATA, ptr %27, i64 %idxprom121
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(24) %arrayidx126, ptr noundef nonnull align 4 dereferenceable(24) %arrayidx138, i64 24, i1 false)
  %30 = load ptr, ptr @gop_structure, align 8
  %arrayidx140 = getelementptr inbounds %struct.GOP_DATA, ptr %30, i64 %idxprom121
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(24) %arrayidx140, ptr noundef nonnull align 4 dereferenceable(24) %tmp, i64 24, i1 false)
  %cmp119 = icmp sgt i32 %j.1207, 1
  br i1 %cmp119, label %land.rhs, label %for.inc142

for.inc142:                                       ; preds = %land.rhs, %while.body130
  %inc143 = add nuw nsw i32 %i33.2209, 1
  %exitcond222.not = icmp eq i32 %inc143, %1
  br i1 %exitcond222.not, label %if.end145, label %while.cond118.preheader
...
entry:
  %0 = load ptr, ptr @input, align 8
  %HierarchicalCoding = getelementptr inbounds %struct.InputParameters, ptr %0, i64 0, i32 69
  %1 = load i32, ptr %HierarchicalCoding, align 8
  ...
  store ptr %call1, ptr @gop_structure, align 8
...
entry:
  %0 = load ptr, ptr @gop_structure, align 8
...
entry:
  ...
  br i1 %cmp, label %for.cond.preheader, label %if.else196

for.cond.preheader:                               ; preds = %entry
  %sub176 = add nsw i32 %conv, -2
  br label %for.body

for.body:                                         ; preds = %for.cond.preheader, %for.inc193
  %coded_frame.0254 = phi i32 [ 0, %for.cond.preheader ], [ %coded_frame.1, %for.inc193 ]
  %qp_read.0253 = phi i32 [ 0, %for.cond.preheader ], [ %qp_read.1, %for.inc193 ]
  %stored_read.0252 = phi i32 [ 0, %for.cond.preheader ], [ %stored_read.1, %for.inc193 ]
  %order_read.0251 = phi i32 [ 0, %for.cond.preheader ], [ %order_read.1, %for.inc193 ]
  %slice_read.0250 = phi i32 [ 0, %for.cond.preheader ], [ %slice_read.1, %for.inc193 ]
  %i.0249 = phi i32 [ 0, %for.cond.preheader ], [ %inc194, %for.inc193 ]
  %cmp4 = icmp eq i32 %slice_read.0250, 0
  br i1 %cmp4, label %if.then6, label %if.else

if.then6:                                         ; preds = %for.body
  %1 = load ptr, ptr @input, align 8
  %idxprom = sext i32 %i.0249 to i64
...
sw.bb:                                            ; preds = %if.then6, %if.then6
  %3 = load ptr, ptr @gop_structure, align 8
  %idxprom9 = sext i32 %coded_frame.0254 to i64
  %arrayidx10 = getelementptr inbounds %struct.GOP_DATA, ptr %3, i64 %idxprom9
  store i32 0, ptr %arrayidx10, align 4
  br label %for.inc193

sw.bb11:                                          ; preds = %if.then6, %if.then6
  %4 = load ptr, ptr @gop_structure, align 8
  %idxprom12 = sext i32 %coded_frame.0254 to i64
...
sw.bb15:                                          ; preds = %if.then6, %if.then6
  %5 = load ptr, ptr @gop_structure, align 8
  %idxprom16 = sext i32 %coded_frame.0254 to i64
...
if.then30:                                        ; preds = %if.then22
  ...
  %11 = load i32, ptr %display_no, align 4
  %12 = load ptr, ptr @gop_structure, align 8
  %idxprom36 = sext i32 %coded_frame.0254 to i64
  %display_no38 = getelementptr inbounds %struct.GOP_DATA, ptr %12, i64 %idxprom36, i32 1
  store i32 %11, ptr %display_no38, align 4
  %13 = load i32, ptr %display_no, align 4
  ...
  %.pre256 = load i32, ptr %jumpd44.phi.trans.insert, align 4
  %cmp41.not = icmp slt i32 %13, %.pre256
  %or.cond262 = select i1 %cmp39, i1 %cmp41.not, i1 false
  br i1 %or.cond262, label %if.end, label %if.then43

if.then43:                                        ; preds = %if.then30
  %sub = add nsw i32 %.pre256, -1
...
if.end:                                           ; preds = %if.then30, %if.then43
  %cmp47247 = icmp sgt i32 %coded_frame.0254, 0
  br i1 %cmp47247, label %for.body49.preheader, label %for.inc193

for.body49.preheader:                             ; preds = %if.end
  %wide.trip.count = zext i32 %coded_frame.0254 to i64
  %.pre258 = load ptr, ptr @gop_structure, align 8
  br label %for.body49

for.body49:                                       ; preds = %for.body49.preheader, %for.inc
  %14 = phi ptr [ %.pre258, %for.body49.preheader ], [ %18, %for.inc ]
  ...
  %15 = load i32, ptr %display_no52, align 4
  %16 = load i32, ptr %display_no, align 4
  %cmp53 = icmp eq i32 %15, %16
  br i1 %cmp53, label %if.then55, label %for.inc

if.then55:                                        ; preds = %for.body49
  %17 = trunc i64 %indvars.iv to i32
  %call56 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.6, i32 noundef %15, i32 noundef %coded_frame.0254, i32 noundef %17) #13
  call void @error(ptr noundef nonnull @errortext, i32 noundef 400) #13
  %.pre257 = load ptr, ptr @gop_structure, align 8
  br label %for.inc

for.inc:                                          ; preds = %for.body49, %if.then55
  %18 = phi ptr [ %14, %for.body49 ], [ %.pre257, %if.then55 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.inc193, label %for.body49
...
sw.bb83:                                          ; preds = %if.then78, %if.then78
  %24 = load ptr, ptr @gop_structure, align 8
  %idxprom84 = sext i32 %coded_frame.0254 to i64
...
if.else98:                                        ; preds = %if.then64
  %cmp99 = icmp eq i32 %stored_read.0252, 1
  %cmp102 = icmp eq i32 %qp_read.0253, 0
...
if.then104:                                       ; preds = %if.else98
  ...
  %27 = load ptr, ptr %call105, align 8
...
if.then116:                                       ; preds = %if.then104
  ...
  %32 = load ptr, ptr @gop_structure, align 8
  %idxprom122 = sext i32 %coded_frame.0254 to i64
  ...
  %slice_qp143 = getelementptr inbounds %struct.GOP_DATA, ptr %32, i64 %idxprom122, i32 3
...
if.then136:                                       ; preds = %if.then116
  %qpN = getelementptr inbounds %struct.InputParameters, ptr %34, i64 0, i32 4
  br label %if.end145

if.else140:                                       ; preds = %if.then116
  %qpB = getelementptr inbounds %struct.InputParameters, ptr %34, i64 0, i32 42
  br label %if.end145

if.end145:                                        ; preds = %if.then136, %if.else140, %if.then127
  %.sink.in = phi ptr [ %qpN, %if.then136 ], [ %qpB, %if.else140 ], [ %qp0, %if.then127 ]
  %.sink = load i32, ptr %.sink.in, align 4
  store i32 %.sink, ptr %slice_qp143, align 4
  %35 = load ptr, ptr @img, align 8
  %bitdepth_luma_qp_scale = getelementptr inbounds %struct.ImageParameters, ptr %35, i64 0, i32 144
  %36 = load i32, ptr %bitdepth_luma_qp_scale, align 4
  %sub146 = sub nsw i32 0, %36
  %slice_qp149 = getelementptr inbounds %struct.GOP_DATA, ptr %32, i64 %idxprom122, i32 3
  %37 = load i32, ptr %dqp, align 4
  %add = add nsw i32 %37, %.sink
  %cond.i.i = call i32 @llvm.smax.i32(i32 %add, i32 %sub146)
  %cond.i4.i = call i32 @llvm.smin.i32(i32 %cond.i.i, i32 51)
  store i32 %cond.i4.i, ptr %slice_qp149, align 4
  br label %for.inc193
...
if.else157:                                       ; preds = %if.else98
  %cmp161 = icmp eq i32 %qp_read.0253, 1
...
land.lhs.true163:                                 ; preds = %if.else157
  ...
  %38 = load ptr, ptr %call164, align 8
  %39 = load ptr, ptr @input, align 8
  %ExplicitHierarchyFormat165 = getelementptr inbounds %struct.InputParameters, ptr %39, i64 0, i32 71
  %idx.ext167 = sext i32 %i.0249 to i64
  %add.ptr168 = getelementptr inbounds i8, ptr %ExplicitHierarchyFormat165, i64 %idx.ext167
  %40 = load i8, ptr %add.ptr168, align 1
  %idxprom170 = sext i8 %40 to i64
  %arrayidx171 = getelementptr inbounds i16, ptr %38, i64 %idxprom170
  %41 = load i16, ptr %arrayidx171, align 2
  %42 = and i16 %41, 2048
  %tobool174.not = icmp eq i16 %42, 0
  %cmp177 = icmp slt i32 %i.0249, %sub176
...
if.then179:                                       ; preds = %land.lhs.true163
  ...
  %inc180 = add nsw i32 %coded_frame.0254, 1
  %jumpd181 = getelementptr inbounds %struct.InputParameters, ptr %39, i64 0, i32 5
  %43 = load i32, ptr %jumpd181, align 4
  %cmp182.not = icmp slt i32 %inc180, %43
...
for.inc193:                                       ; preds = %for.inc, %land.lhs.true, %if.end, %sw.bb83, %sw.bb88, %sw.default95, %sw.bb, %sw.bb11, %sw.bb15, %sw.default, %if.else154, %if.end145, %if.then179, %if.then184, %land.lhs.true163, %if.else157, %if.else58
  %i.1 = phi i32 [ %i.0249, %if.else58 ], [ %i.0249, %if.end145 ], [ %i.0249, %if.else154 ], [ %i.0249, %land.lhs.true163 ], [ %dec, %if.then184 ], [ %dec, %if.then179 ], [ %i.0249, %if.else157 ], [ %i.0249, %sw.default ], [ %i.0249, %sw.bb15 ], [ %i.0249, %sw.bb11 ], [ %i.0249, %sw.bb ], [ %i.0249, %sw.default95 ], [ %i.0249, %sw.bb88 ], [ %i.0249, %sw.bb83 ], [ %i.0249, %if.end ], [ %i.0249, %land.lhs.true ], [ %i.0249, %for.inc ]
  ...
  %order_read.1 = phi i32 [ 0, %if.else58 ], [ 1, %if.end145 ], [ 1, %if.else154 ], [ 1, %land.lhs.true163 ], [ 0, %if.then184 ], [ 0, %if.then179 ], [ 1, %if.else157 ], [ %order_read.0251, %sw.default ], [ %order_read.0251, %sw.bb15 ], [ %order_read.0251, %sw.bb11 ], [ %order_read.0251, %sw.bb ], [ 1, %sw.default95 ], [ 1, %sw.bb88 ], [ 1, %sw.bb83 ], [ 1, %if.end ], [ 1, %land.lhs.true ], [ 1, %for.inc ]
  %stored_read.1 = phi i32 [ %stored_read.0252, %if.else58 ], [ 1, %if.end145 ], [ 1, %if.else154 ], [ 1, %land.lhs.true163 ], [ 0, %if.then184 ], [ 0, %if.then179 ], [ %stored_read.0252, %if.else157 ], [ %stored_read.0252, %sw.default ], [ %stored_read.0252, %sw.bb15 ], [ %stored_read.0252, %sw.bb11 ], [ %stored_read.0252, %sw.bb ], [ 1, %sw.default95 ], [ 1, %sw.bb88 ], [ 1, %sw.bb83 ], [ %stored_read.0252, %if.end ], [ 0, %land.lhs.true ], [ %stored_read.0252, %for.inc ]
  %qp_read.1 = phi i32 [ %qp_read.0253, %if.else58 ], [ 1, %if.end145 ], [ 0, %if.else154 ], [ 1, %land.lhs.true163 ], [ 0, %if.then184 ], [ 0, %if.then179 ], [ %qp_read.0253, %if.else157 ], [ %qp_read.0253, %sw.default ], [ %qp_read.0253, %sw.bb15 ], [ %qp_read.0253, %sw.bb11 ], [ %qp_read.0253, %sw.bb ], [ %qp_read.0253, %sw.default95 ], [ %qp_read.0253, %sw.bb88 ], [ %qp_read.0253, %sw.bb83 ], [ %qp_read.0253, %if.end ], [ %qp_read.0253, %land.lhs.true ], [ %qp_read.0253, %for.inc ]
  %coded_frame.1 = phi i32 [ %coded_frame.0254, %if.else58 ], [ %coded_frame.0254, %if.end145 ], [ %coded_frame.0254, %if.else154 ], [ %coded_frame.0254, %land.lhs.true163 ], [ %inc180, %if.then184 ], [ %inc180, %if.then179 ], [ %coded_frame.0254, %if.else157 ], [ %coded_frame.0254, %sw.default ], [ %coded_frame.0254, %sw.bb15 ], [ %coded_frame.0254, %sw.bb11 ], [ %coded_frame.0254, %sw.bb ], [ %coded_frame.0254, %sw.default95 ], [ %coded_frame.0254, %sw.bb88 ], [ %coded_frame.0254, %sw.bb83 ], [ %coded_frame.0254, %if.end ], [ %coded_frame.0254, %land.lhs.true ], [ %coded_frame.0254, %for.inc ]
  %inc194 = add nsw i32 %i.1, 1
  %cmp2 = icmp slt i32 %inc194, %conv
  br i1 %cmp2, label %for.body, label %if.end198.loopexit
...
if.end198.loopexit:                               ; preds = %for.inc193
  %44 = add nsw i32 %coded_frame.1, 1
  br label %if.end198

if.end198:                                        ; preds = %if.end198.loopexit, %if.else196
  %coded_frame.2 = phi i32 [ 1, %if.else196 ], [ %44, %if.end198.loopexit ]
  %45 = load ptr, ptr @input, align 8
  %successive_Bframe = getelementptr inbounds %struct.InputParameters, ptr %45, i64 0, i32 40
  store i32 %coded_frame.2, ptr %successive_Bframe, align 8
...
entry:
  ...
  %.pre343 = load ptr, ptr @img, align 8
  br i1 %cmp.not, label %if.end312, label %land.lhs.true

land.lhs.true:                                    ; preds = %entry
  %2 = load i32, ptr %.pre343, align 8
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %.pre = load i32, ptr %HierarchicalCoding15.phi.trans.insert, align 8
  br i1 %cmp9.not, label %if.end14, label %land.lhs.true10

land.lhs.true10:                                  ; preds = %if.then
  %cmp11 = icmp eq i32 %.pre, 0
  br i1 %cmp11, label %if.end14.thread, label %if.end14.thread347

if.end14.thread347:                               ; preds = %land.lhs.true10
  %nal_reference_idc348 = getelementptr inbounds %struct.ImageParameters, ptr %.pre343, i64 0, i32 122
  store i32 0, ptr %nal_reference_idc348, align 8
  br label %if.then17

if.end14.thread:                                  ; preds = %land.lhs.true10
  %frame_num = getelementptr inbounds %struct.ImageParameters, ptr %.pre343, i64 0, i32 115
  ...
  %rem = and i32 %inc, %11
  store i32 %rem, ptr %frame_num, align 4
  %nal_reference_idc345 = getelementptr inbounds %struct.ImageParameters, ptr %.pre343, i64 0, i32 122
  store i32 0, ptr %nal_reference_idc345, align 8
  br label %if.else179

if.end14:                                         ; preds = %if.then
  %nal_reference_idc = getelementptr inbounds %struct.ImageParameters, ptr %.pre343, i64 0, i32 122
  store i32 0, ptr %nal_reference_idc, align 8
  %tobool16.not = icmp eq i32 %.pre, 0
  br i1 %tobool16.not, label %if.else179, label %if.then17

if.then17:                                        ; preds = %if.end14.thread347, %if.end14
  %b_frame_to_code = getelementptr inbounds %struct.ImageParameters, ptr %.pre343, i64 0, i32 76
  store i32 1, ptr %b_frame_to_code, align 4
  %12 = load i32, ptr %successive_Bframe, align 8
...
for.body.preheader:                               ; preds = %if.then17
  %.pre331 = load ptr, ptr @gop_structure, align 8
  br label %for.body

for.body:                                         ; preds = %for.body.preheader, %for.inc
  %13 = phi ptr [ %42, %for.inc ], [ %.pre331, %for.body.preheader ]
  %14 = phi i32 [ %46, %for.inc ], [ %12, %for.body.preheader ]
  %15 = phi ptr [ %.pre336, %for.inc ], [ %0, %for.body.preheader ]
  %16 = phi i32 [ %inc177, %for.inc ], [ 1, %for.body.preheader ]
  %17 = phi ptr [ %43, %for.inc ], [ %.pre343, %for.body.preheader ]
  ...
  store i32 0, ptr %nal_reference_idc21, align 8
  ...
  store i32 %18, ptr %type24, align 4
...
if.end42:                                         ; preds = %if.end33, %if.then39
  ...
  %24 = load i32, ptr %HierarchicalCoding47, align 8
  ...
  %25 = load i32, ptr %intra_period, align 8
  %tobool53.not = icmp eq i32 %25, 0
  br i1 %tobool53.not, label %if.end42.if.else75_crit_edge, label %land.lhs.true54

if.end42.if.else75_crit_edge:                     ; preds = %if.end42
  %.pre332 = load i32, ptr %17, align 8
  %.pre334 = load i32, ptr @start_frame_no_in_this_IGOP, align 4
  br label %if.else75

land.lhs.true54:                                  ; preds = %if.end42
  %idr_enable = getelementptr inbounds %struct.InputParameters, ptr %15, i64 0, i32 32
  %26 = load i32, ptr %idr_enable, align 8
  %tobool55.not = icmp eq i32 %26, 0
  %.pre333 = load i32, ptr %17, align 8
  %.pre335 = load i32, ptr @start_frame_no_in_this_IGOP, align 4
  br i1 %tobool55.not, label %if.else75, label %if.then56

if.then56:                                        ; preds = %land.lhs.true54
  %sub58 = sub nsw i32 %.pre333, %.pre335
  %rem60 = srem i32 %sub58, %25
  %sub61 = add nsw i32 %rem60, -1
  br label %if.end95

if.else75:                                        ; preds = %if.end42.if.else75_crit_edge, %land.lhs.true54
  %27 = phi i32 [ %.pre334, %if.end42.if.else75_crit_edge ], [ %.pre335, %land.lhs.true54 ]
  %28 = phi i32 [ %.pre332, %if.end42.if.else75_crit_edge ], [ %.pre333, %land.lhs.true54 ]
  %29 = xor i32 %27, -1
  %sub78 = add i32 %28, %29
  br label %if.end95
...
if.end95:                                         ; preds = %if.else75, %if.then56
  ...
  %30 = phi i32 [ %27, %if.else75 ], [ %.pre335, %if.then56 ]
  %31 = phi i32 [ %28, %if.else75 ], [ %.pre333, %if.then56 ]
  %mul81 = mul nsw i32 %sub78.sink, %add43
  %display_no87 = getelementptr inbounds %struct.GOP_DATA, ptr %13, i64 %idxprom, i32 1
  %32 = load i32, ptr %display_no87, align 4
  %add88 = add nsw i32 %32, 1
  ...
  store i32 %mul93, ptr %toppoc94, align 4
  %cmp97 = icmp eq i32 %16, 1
  %33 = load i32, ptr @start_tr_in_this_IGOP, align 4
  br i1 %cmp97, label %if.then99, label %if.else110

if.then99:                                        ; preds = %if.end95
  %sub102 = sub nsw i32 %31, %30
  %mul105 = mul nsw i32 %sub102, %add43
  %add106 = add nsw i32 %mul105, %33
  br label %if.end135

if.else110:                                       ; preds = %if.end95
  %34 = xor i32 %30, -1
  %sub114 = add i32 %31, %34
  %mul117 = mul nsw i32 %sub114, %add43
  %add118 = add nsw i32 %mul117, %33
  ...
  %35 = load i32, ptr %display_no125, align 4
  %add126 = add nsw i32 %35, 1
...
if.end135:                                        ; preds = %if.else110, %if.then99
  ...
  %36 = sub nsw i32 %add92, %mul107.pn.in
  %sub132.sink = shl nsw i32 %36, 1
  %37 = getelementptr inbounds %struct.ImageParameters, ptr %17, i64 0, i32 109
  store i32 %sub132.sink, ptr %37, align 8
  %PicInterlace = getelementptr inbounds %struct.InputParameters, ptr %15, i64 0, i32 121
  %38 = load i32, ptr %PicInterlace, align 8
  %cmp136 = icmp eq i32 %38, 0
...
land.lhs.true138:                                 ; preds = %if.end135
  ...
  %39 = load i32, ptr %MbInterlace, align 4
  %cmp139 = icmp eq i32 %39, 0
...
if.end147:                                        ; preds = %land.lhs.true138, %if.else143
  ...
  store i32 %add145.sink, ptr %bottompoc146, align 8
  %framepoc = getelementptr inbounds %struct.ImageParameters, ptr %17, i64 0, i32 113
  store i32 %mul93, ptr %framepoc, align 4
  %arrayidx151 = getelementptr inbounds %struct.ImageParameters, ptr %17, i64 0, i32 109, i64 1
  store i32 0, ptr %arrayidx151, align 4
  %call152 = tail call i32 @encode_one_frame() #13
  %40 = load ptr, ptr @input, align 8
  %ReportFrameStats = getelementptr inbounds %struct.InputParameters, ptr %40, i64 0, i32 154
  %41 = load i32, ptr %ReportFrameStats, align 8
  %tobool153.not = icmp eq i32 %41, 0
  br i1 %tobool153.not, label %if.end155, label %if.then154

if.then154:                                       ; preds = %if.end147
  tail call void @report_frame_statistic() #13
  %.pre336.pre = load ptr, ptr @input, align 8
  br label %if.end155

if.end155:                                        ; preds = %if.then154, %if.end147
  %.pre336 = phi ptr [ %.pre336.pre, %if.then154 ], [ %40, %if.end147 ]
  %42 = load ptr, ptr @gop_structure, align 8
  %43 = load ptr, ptr @img, align 8
  %b_frame_to_code156 = getelementptr inbounds %struct.ImageParameters, ptr %43, i64 0, i32 76
  %44 = load i32, ptr %b_frame_to_code156, align 4
  %sub157 = add nsw i32 %44, -1
  %idxprom158 = sext i32 %sub157 to i64
  %reference_idc160 = getelementptr inbounds %struct.GOP_DATA, ptr %42, i64 %idxprom158, i32 2
  %45 = load i32, ptr %reference_idc160, align 4
  %cmp161 = icmp eq i32 %45, 2
  %successive_Bframe165 = getelementptr inbounds %struct.InputParameters, ptr %.pre336, i64 0, i32 40
  %46 = load i32, ptr %successive_Bframe165, align 8
  %cmp166 = icmp eq i32 %44, %46
...
for.inc.thread:                                   ; preds = %if.end155
  %frame_num169 = getelementptr inbounds %struct.ImageParameters, ptr %43, i64 0, i32 115
  %47 = load i32, ptr %frame_num169, align 4
  %inc170 = add i32 %47, 1
  %48 = load i32, ptr @log2_max_frame_num_minus4, align 4
  %add171 = add i32 %48, 4
  %notmask319 = shl nsw i32 -1, %add171
  %49 = xor i32 %notmask319, -1
  %rem174 = and i32 %inc170, %49
  store i32 %rem174, ptr %frame_num169, align 4
  %inc177350 = add nsw i32 %44, 1
  store i32 %inc177350, ptr %b_frame_to_code156, align 4
  br label %for.end

for.inc:                                          ; preds = %if.end155
  %inc177 = add nsw i32 %44, 1
  store i32 %inc177, ptr %b_frame_to_code156, align 4
  %cmp20.not.not = icmp slt i32 %44, %46
  br i1 %cmp20.not.not, label %for.body, label %for.end

for.end:                                          ; preds = %for.inc, %for.inc.thread, %if.then17
  %.lcssa = phi ptr [ %.pre343, %if.then17 ], [ %43, %for.inc.thread ], [ %43, %for.inc ]
  %b_frame_to_code18.le = getelementptr inbounds %struct.ImageParameters, ptr %.lcssa, i64 0, i32 76
  store i32 0, ptr %b_frame_to_code18.le, align 4
  br label %if.end312

if.else179:                                       ; preds = %if.end14.thread, %if.end14
  %b_frame_to_code180 = getelementptr inbounds %struct.ImageParameters, ptr %.pre343, i64 0, i32 76
  store i32 1, ptr %b_frame_to_code180, align 4
  %50 = load i32, ptr %successive_Bframe, align 8
  %cmp184.not328 = icmp slt i32 %50, 1
  br i1 %cmp184.not328, label %if.end312, label %for.body186

for.body186:                                      ; preds = %if.else179, %for.inc307
  %51 = phi i32 [ %81, %for.inc307 ], [ %50, %if.else179 ]
  %52 = phi ptr [ %78, %for.inc307 ], [ %0, %if.else179 ]
  %53 = phi i32 [ %inc309, %for.inc307 ], [ 1, %if.else179 ]
  %54 = phi ptr [ %79, %for.inc307 ], [ %.pre343, %if.else179 ]
  %nal_reference_idc187 = getelementptr inbounds %struct.ImageParameters, ptr %54, i64 0, i32 122
  store i32 0, ptr %nal_reference_idc187, align 8
  %BRefPictures188 = getelementptr inbounds %struct.InputParameters, ptr %52, i64 0, i32 68
  %55 = load i32, ptr %BRefPictures188, align 4
  %cmp189 = icmp eq i32 %55, 1
  br i1 %cmp189, label %if.then191, label %if.end199

if.then191:                                       ; preds = %for.body186
  store i32 1, ptr %nal_reference_idc187, align 8
  %frame_num193 = getelementptr inbounds %struct.ImageParameters, ptr %54, i64 0, i32 115
  %56 = load i32, ptr %frame_num193, align 4
  %inc194 = add i32 %56, 1
  %57 = load i32, ptr @log2_max_frame_num_minus4, align 4
  %add195 = add i32 %57, 4
  %notmask316 = shl nsw i32 -1, %add195
  %58 = xor i32 %notmask316, -1
  %rem198 = and i32 %inc194, %58
  store i32 %rem198, ptr %frame_num193, align 4
  br label %if.end199

if.end199:                                        ; preds = %if.then191, %for.body186
  %jumpd200 = getelementptr inbounds %struct.InputParameters, ptr %52, i64 0, i32 5
  %59 = load i32, ptr %jumpd200, align 4
  %add201 = add nsw i32 %59, 1
  %conv202 = sitofp i32 %add201 to double
  %conv204 = sitofp i32 %51 to double
  %add205 = fadd double %conv204, 1.000000e+00
  %div206 = fdiv double %conv202, %add205
  %b_interval207 = getelementptr inbounds %struct.ImageParameters, ptr %54, i64 0, i32 74
  %HierarchicalCoding208 = getelementptr inbounds %struct.InputParameters, ptr %52, i64 0, i32 69
  %60 = load i32, ptr %HierarchicalCoding208, align 8
  %cmp209 = icmp eq i32 %60, 3
  ...
  %intra_period214 = getelementptr inbounds %struct.InputParameters, ptr %52, i64 0, i32 30
  %61 = load i32, ptr %intra_period214, align 8
  %tobool215.not = icmp eq i32 %61, 0
  br i1 %tobool215.not, label %if.end199.if.else236_crit_edge, label %land.lhs.true216

if.end199.if.else236_crit_edge:                   ; preds = %if.end199
  %.pre338 = load i32, ptr %54, align 8
  %.pre340 = load i32, ptr @start_frame_no_in_this_IGOP, align 4
  br label %if.else236

land.lhs.true216:                                 ; preds = %if.end199
  %idr_enable217 = getelementptr inbounds %struct.InputParameters, ptr %52, i64 0, i32 32
  %62 = load i32, ptr %idr_enable217, align 8
  %tobool218.not = icmp eq i32 %62, 0
  %.pre339 = load i32, ptr %54, align 8
  %.pre341 = load i32, ptr @start_frame_no_in_this_IGOP, align 4
  br i1 %tobool218.not, label %if.else236, label %if.then219

if.then219:                                       ; preds = %land.lhs.true216
  %sub221 = sub nsw i32 %.pre339, %.pre341
  %rem223 = srem i32 %sub221, %61
  %sub224 = add nsw i32 %rem223, -1
  br label %if.end251

if.else236:                                       ; preds = %if.end199.if.else236_crit_edge, %land.lhs.true216
  %63 = phi i32 [ %.pre340, %if.end199.if.else236_crit_edge ], [ %.pre341, %land.lhs.true216 ]
  %64 = phi i32 [ %.pre338, %if.end199.if.else236_crit_edge ], [ %.pre339, %land.lhs.true216 ]
  %65 = xor i32 %63, -1
  %sub239 = add i32 %64, %65
  br label %if.end251
...
if.end251:                                        ; preds = %if.else236, %if.then219
  ...
  %conv245 = sitofp i32 %53 to double
  ...
  %toppoc250 = getelementptr inbounds %struct.ImageParameters, ptr %54, i64 0, i32 111
  store i32 %mul249, ptr %toppoc250, align 4
  %PicInterlace252 = getelementptr inbounds %struct.InputParameters, ptr %52, i64 0, i32 121
  %66 = load i32, ptr %PicInterlace252, align 8
  %cmp253 = icmp eq i32 %66, 0
  br i1 %cmp253, label %land.lhs.true255, label %if.else262

land.lhs.true255:                                 ; preds = %if.end251
  %MbInterlace256 = getelementptr inbounds %struct.InputParameters, ptr %52, i64 0, i32 122
  %67 = load i32, ptr %MbInterlace256, align 4
  %cmp257 = icmp eq i32 %67, 0
...
if.end266:                                        ; preds = %land.lhs.true255, %if.else262
  ...
  %bottompoc265 = getelementptr inbounds %struct.ImageParameters, ptr %54, i64 0, i32 112
  store i32 %add264.sink, ptr %bottompoc265, align 8
  %framepoc270 = getelementptr inbounds %struct.ImageParameters, ptr %54, i64 0, i32 113
  store i32 %mul249, ptr %framepoc270, align 4
  %sub276 = shl i32 %53, 1
  %mul277 = add i32 %sub276, -2
  %mul277.sink = select i1 %cmp189, i32 -2, i32 %mul277
  %68 = getelementptr inbounds %struct.ImageParameters, ptr %54, i64 0, i32 109
  store i32 %mul277.sink, ptr %68, align 8
  %arrayidx285 = getelementptr inbounds %struct.ImageParameters, ptr %54, i64 0, i32 109, i64 1
  store i32 0, ptr %arrayidx285, align 4
  %call286 = tail call i32 @encode_one_frame() #13
  %69 = load ptr, ptr @input, align 8
  %BRefPictures287 = getelementptr inbounds %struct.InputParameters, ptr %69, i64 0, i32 68
  %70 = load i32, ptr %BRefPictures287, align 4
  %cmp288 = icmp eq i32 %70, 1
  br i1 %cmp288, label %land.lhs.true290, label %if.end302

land.lhs.true290:                                 ; preds = %if.end266
  %71 = load ptr, ptr @img, align 8
  %b_frame_to_code291 = getelementptr inbounds %struct.ImageParameters, ptr %71, i64 0, i32 76
  %72 = load i32, ptr %b_frame_to_code291, align 4
  %successive_Bframe292 = getelementptr inbounds %struct.InputParameters, ptr %69, i64 0, i32 40
  %73 = load i32, ptr %successive_Bframe292, align 8
  %cmp293 = icmp eq i32 %72, %73
  br i1 %cmp293, label %if.then295, label %if.end302

if.then295:                                       ; preds = %land.lhs.true290
  %frame_num296 = getelementptr inbounds %struct.ImageParameters, ptr %71, i64 0, i32 115
  %74 = load i32, ptr %frame_num296, align 4
  %inc297 = add i32 %74, 1
  %75 = load i32, ptr @log2_max_frame_num_minus4, align 4
  %add298 = add i32 %75, 4
  %notmask317 = shl nsw i32 -1, %add298
  %76 = xor i32 %notmask317, -1
  %rem301 = and i32 %inc297, %76
  store i32 %rem301, ptr %frame_num296, align 4
  br label %if.end302

if.end302:                                        ; preds = %if.then295, %land.lhs.true290, %if.end266
  %ReportFrameStats303 = getelementptr inbounds %struct.InputParameters, ptr %69, i64 0, i32 154
  %77 = load i32, ptr %ReportFrameStats303, align 8
  %tobool304.not = icmp eq i32 %77, 0
  br i1 %tobool304.not, label %for.inc307, label %if.then305

if.then305:                                       ; preds = %if.end302
  tail call void @report_frame_statistic() #13
  %.pre342 = load ptr, ptr @input, align 8
  br label %for.inc307

for.inc307:                                       ; preds = %if.end302, %if.then305
  %78 = phi ptr [ %69, %if.end302 ], [ %.pre342, %if.then305 ]
  %79 = load ptr, ptr @img, align 8
  %b_frame_to_code308 = getelementptr inbounds %struct.ImageParameters, ptr %79, i64 0, i32 76
  %80 = load i32, ptr %b_frame_to_code308, align 4
  %inc309 = add nsw i32 %80, 1
  store i32 %inc309, ptr %b_frame_to_code308, align 4
  %successive_Bframe183 = getelementptr inbounds %struct.InputParameters, ptr %78, i64 0, i32 40
  %81 = load i32, ptr %successive_Bframe183, align 8
  %cmp184.not.not = icmp slt i32 %80, %81
  br i1 %cmp184.not.not, label %for.body186, label %if.end312

if.end312:                                        ; preds = %for.inc307, %if.else179, %for.end, %land.lhs.true, %entry
  %82 = phi ptr [ %.pre343, %if.else179 ], [ %.lcssa, %for.end ], [ %.pre343, %land.lhs.true ], [ %.pre343, %entry ], [ %79, %for.inc307 ]
  %b_frame_to_code313 = getelementptr inbounds %struct.ImageParameters, ptr %82, i64 0, i32 76
  store i32 0, ptr %b_frame_to_code313, align 4
  ret void
}
...
entry:
  ...
  %1 = load ptr, ptr %dec_ref_pic_marking_buffer, align 8
  %cmp.not = icmp eq ptr %1, null
  br i1 %cmp.not, label %if.end, label %cleanup

if.end:                                           ; preds = %entry
  %2 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 5), align 8
  %3 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 6), align 4
  %add = sub i32 0, %3
  %cmp1 = icmp eq i32 %2, %add
  br i1 %cmp1, label %cleanup, label %for.cond.preheader

for.cond.preheader:                               ; preds = %if.end
  %4 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 4), align 4
...
for.end.loopexit:                                 ; preds = %for.inc
  %13 = xor i32 %pic_num.1, -1
  br label %for.end

for.end:                                          ; preds = %for.end.loopexit, %for.cond.preheader
  %pic_num.0.lcssa = phi i32 [ -1, %for.cond.preheader ], [ %13, %for.end.loopexit ]
...
if.end27:                                         ; preds = %if.then26, %if.end23
  ...
  store ptr %call, ptr %Next28, align 8
  store i32 1, ptr %call24, align 8
  %sub30 = add i32 %pic_num.0.lcssa, %current_pic_num
  %difference_of_pic_nums_minus1 = getelementptr inbounds %struct.DecRefPicMarking_s, ptr %call24, i64 0, i32 1
  store i32 %sub30, ptr %difference_of_pic_nums_minus1, align 4
  ...
  store ptr %call24, ptr %dec_ref_pic_marking_buffer31, align 8
  br label %cleanup
