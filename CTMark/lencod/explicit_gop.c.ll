...
if.then30:                                        ; preds = %if.then22
  ...
  %.pre256 = load i32, ptr %jumpd44.phi.trans.insert, align 4, !tbaa !39
...
if.then55:                                        ; preds = %for.body49
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 400) #13
  %.pre257 = load ptr, ptr @gop_structure, align 8, !tbaa !5
  br label %for.inc
...
if.end145:                                        ; preds = %if.then136, %if.else140, %if.then127
  ...
  store i32 %.sink, ptr %slice_qp143, align 4, !tbaa !22
...
land.lhs.true163:                                 ; preds = %if.else157
  ...
  %38 = load ptr, ptr %call164, align 8, !tbaa !5
...
if.then179:                                       ; preds = %land.lhs.true163
  ...
  %43 = load i32, ptr %jumpd181, align 4, !tbaa !39
...
for.inc193:                                       ; preds = %for.inc, %land.lhs.true, %if.end, %sw.bb83, %sw.bb88, %sw.default95, %sw.bb, %sw.bb11, %sw.bb15, %sw.default, %if.else154, %if.end145, %if.then179, %if.then184, %land.lhs.true163, %if.else157, %if.else58
  ...
  br i1 %cmp2, label %for.body, label %if.end198.loopexit, !llvm.loop !42
...
if.end198:                                        ; preds = %if.end198.loopexit, %if.else196
  ...
  store i32 %coded_frame.2, ptr %successive_Bframe, align 8, !tbaa !9
...
entry:
  ...
  %.pre343 = load ptr, ptr @img, align 8, !tbaa !5
  br i1 %cmp.not, label %if.end312, label %land.lhs.true

land.lhs.true:                                    ; preds = %entry
  %2 = load i32, ptr %.pre343, align 8, !tbaa !43
...
if.end14.thread347:                               ; preds = %land.lhs.true10
  ...
  store i32 0, ptr %nal_reference_idc348, align 8, !tbaa !47
  br label %if.then17
...
if.end14.thread:                                  ; preds = %land.lhs.true10
  ...
  store i32 0, ptr %nal_reference_idc345, align 8, !tbaa !47
  br label %if.else179
...
if.end42.if.else75_crit_edge:                     ; preds = %if.end42
  %.pre332 = load i32, ptr %17, align 8, !tbaa !43
  %.pre334 = load i32, ptr @start_frame_no_in_this_IGOP, align 4, !tbaa !34
  br label %if.else75
...
land.lhs.true54:                                  ; preds = %if.end42
  ...
  %.pre333 = load i32, ptr %17, align 8, !tbaa !43
  %.pre335 = load i32, ptr @start_frame_no_in_this_IGOP, align 4, !tbaa !34
...
if.end95:                                         ; preds = %if.else75, %if.then56
  ...
  %32 = load i32, ptr %display_no87, align 4, !tbaa !16
  ...
  %33 = load i32, ptr @start_tr_in_this_IGOP, align 4, !tbaa !34
...
if.else110:                                       ; preds = %if.end95
  ...
  %35 = load i32, ptr %display_no125, align 4, !tbaa !16
...
if.end135:                                        ; preds = %if.else110, %if.then99
  ...
  %38 = load i32, ptr %PicInterlace, align 8, !tbaa !54
...
land.lhs.true138:                                 ; preds = %if.end135
  ...
  %39 = load i32, ptr %MbInterlace, align 4, !tbaa !55
...
if.end147:                                        ; preds = %land.lhs.true138, %if.else143
  ...
  %41 = load i32, ptr %ReportFrameStats, align 8, !tbaa !58
...
for.inc.thread:                                   ; preds = %if.end155
  ...
  %47 = load i32, ptr %frame_num169, align 4, !tbaa !48
  %inc170 = add i32 %47, 1
  %48 = load i32, ptr @log2_max_frame_num_minus4, align 4, !tbaa !34
  %add171 = add i32 %48, 4
  ...
  store i32 %inc177350, ptr %b_frame_to_code156, align 4, !tbaa !49
  br label %for.end
...
if.else179:                                       ; preds = %if.end14.thread, %if.end14
  ...
  %50 = load i32, ptr %successive_Bframe, align 8, !tbaa !9
...
for.body186:                                      ; preds = %if.else179, %for.inc307
  ...
  %55 = load i32, ptr %BRefPictures188, align 4, !tbaa !46
...
if.then191:                                       ; preds = %for.body186
  ...
  %56 = load i32, ptr %frame_num193, align 4, !tbaa !48
  %inc194 = add i32 %56, 1
  %57 = load i32, ptr @log2_max_frame_num_minus4, align 4, !tbaa !34
  %add195 = add i32 %57, 4
...
if.end199:                                        ; preds = %if.then191, %for.body186
  ...
  %59 = load i32, ptr %jumpd200, align 4, !tbaa !39
  ...
  %60 = load i32, ptr %HierarchicalCoding208, align 8, !tbaa !13
  ...
  %61 = load i32, ptr %intra_period214, align 8, !tbaa !51
...
if.end199.if.else236_crit_edge:                   ; preds = %if.end199
  %.pre338 = load i32, ptr %54, align 8, !tbaa !43
  %.pre340 = load i32, ptr @start_frame_no_in_this_IGOP, align 4, !tbaa !34
  br label %if.else236

land.lhs.true216:                                 ; preds = %if.end199
  %idr_enable217 = getelementptr inbounds %struct.InputParameters, ptr %52, i64 0, i32 32
  %62 = load i32, ptr %idr_enable217, align 8, !tbaa !52
  %tobool218.not = icmp eq i32 %62, 0
  %.pre339 = load i32, ptr %54, align 8, !tbaa !43
  %.pre341 = load i32, ptr @start_frame_no_in_this_IGOP, align 4, !tbaa !34
...
if.end251:                                        ; preds = %if.else236, %if.then219
  ...
  %66 = load i32, ptr %PicInterlace252, align 8, !tbaa !54
...
land.lhs.true255:                                 ; preds = %if.end251
  ...
  %67 = load i32, ptr %MbInterlace256, align 4, !tbaa !55
...
if.end266:                                        ; preds = %land.lhs.true255, %if.else262
  ...
  %70 = load i32, ptr %BRefPictures287, align 4, !tbaa !46
...
land.lhs.true290:                                 ; preds = %if.end266
  ...
  %72 = load i32, ptr %b_frame_to_code291, align 4, !tbaa !49
  %successive_Bframe292 = getelementptr inbounds %struct.InputParameters, ptr %69, i64 0, i32 40
  %73 = load i32, ptr %successive_Bframe292, align 8, !tbaa !9
...
if.then295:                                       ; preds = %land.lhs.true290
  ...
  %74 = load i32, ptr %frame_num296, align 4, !tbaa !48
  %inc297 = add i32 %74, 1
  %75 = load i32, ptr @log2_max_frame_num_minus4, align 4, !tbaa !34
  %add298 = add i32 %75, 4
...
for.inc307:                                       ; preds = %if.end302, %if.then305
  ...
  %80 = load i32, ptr %b_frame_to_code308, align 4, !tbaa !49
  ...
  %81 = load i32, ptr %successive_Bframe183, align 8, !tbaa !9
...
for.inc:                                          ; preds = %for.body, %land.lhs.true, %land.lhs.true8, %if.then12
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.end.loopexit, label %for.body, !llvm.loop !75
