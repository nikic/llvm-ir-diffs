; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/rtp.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/rtp.c"
...
entry:
  ...
  %10 = load i32, ptr %timestamp, align 4
  ...
  %16 = load i32, ptr %paylen, align 8
...
entry:
  ...
  store i32 -1, ptr %intime, align 4
  %packlen = getelementptr inbounds %struct.RTPpacket_t, ptr %p, i64 0, i32 12
...
if.end4:                                          ; preds = %if.end
  ...
  %1 = load i32, ptr %packlen, align 8
...
entry:
  ...
  %0 = load i32, ptr %forbidden_bit, align 4
  %shl = shl i32 %0, 7
  ...
  %2 = load i32, ptr %nal_unit_type, align 4
  %or2 = or i32 %or, %2
...
if.end:                                           ; preds = %if.then, %entry
  ...
  store ptr %call4, ptr %packet, align 8
...
if.end8:                                          ; preds = %if.then7, %if.end
  ...
  store ptr %call9, ptr %payload, align 8
...
if.end13:                                         ; preds = %if.then12, %if.end8
  ...
  store i32 305419896, ptr %ssrc, align 8
  ...
  store i32 %add.i, ptr %packlen.i, align 8
  %9 = load ptr, ptr @f, align 8
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %intime.i) #12
  store i32 -1, ptr %intime.i, align 4
...
WriteRTPPacket.exit.thread:                       ; preds = %if.end13, %if.end.i
  ...
  %.pre = load i32, ptr %packlen.i, align 8
  br label %if.then30

WriteRTPPacket.exit:                              ; preds = %if.end.i
  %10 = load ptr, ptr %packet, align 8
  %11 = load i32, ptr %packlen.i, align 8
...
entry:
  %0 = load i32, ptr @RTPUpdateTimestamp.oldtr, align 4
  %cmp = icmp eq i32 %0, -1
...
if.end:                                           ; preds = %entry
  ...
  %1 = load i32, ptr @CurrentRTPTimestamp, align 4
...
cleanup:                                          ; preds = %entry, %if.end
  ...
  store i32 %storemerge8, ptr @CurrentRTPTimestamp, align 4
  store i32 %storemerge, ptr @RTPUpdateTimestamp.oldtr, align 4
  ret void
}
