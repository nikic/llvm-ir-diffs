; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/configfile.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/configfile.c"
...
if.end20.i:                                       ; preds = %if.then13.i, %if.then.i, %while.body.i
  ...
  br i1 %cmp.not.i, label %InitEncoderParams.exit, label %while.body.i
...
if.then41:                                        ; preds = %if.end35
  ...
  %17 = load ptr, ptr %arrayidx43, align 8
...
while.cond97:                                     ; preds = %if.end110, %while.body91
  ...
  %26 = load i8, ptr %source.0, align 1
...
while.end112:                                     ; preds = %while.cond97
  ...
  br i1 %exitcond224.not, label %while.end114, label %while.body91
...
if.end124:                                        ; preds = %while.end114, %if.else119, %if.end48
  ...
  br i1 %cmp28, label %while.body, label %while.end125
...
while.end125:                                     ; preds = %if.end124, %if.end25
  ...
  %.pre886.i = load ptr, ptr @input, align 8
  br i1 %cmp.not228.i.i, label %TestEncoderParams.exit.i, label %while.body.lr.ph.i.i

while.body.lr.ph.i.i:                             ; preds = %while.end125
  %BitDepthLuma.i = getelementptr inbounds %struct.InputParameters, ptr %.pre886.i, i64 0, i32 172
  %28 = load i32, ptr %BitDepthLuma.i, align 8
  %29 = mul i32 %28, 6
  %mul.i = add i32 %29, -48
...
if.then.i.i:                                      ; preds = %while.body.i.i
  ...
  %32 = load i32, ptr %Type.i.i, align 8
...
if.then22.i.i:                                    ; preds = %if.then7.i.i
  %call.i.i = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.311, ptr noundef nonnull %30, i32 noundef %conv.i.i, i32 noundef %.pre234.i.i) #21
...
if.then57.i.i:                                    ; preds = %if.then39.i.i
  %call67.i.i = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.312, ptr noundef nonnull %30, double noundef %38, double noundef %.pre232.i.i) #21
  br label %if.end181.sink.split.i.i
...
if.then77.i.i:                                    ; preds = %while.body.i.i
  ...
  %39 = load i32, ptr %Type80.i.i, align 8
  switch i32 %39, label %if.end181.i.i [
...
if.then83.i.i:                                    ; preds = %if.then77.i.i
  ...
  %40 = load ptr, ptr %Place86.i.i, align 8
  %41 = load i32, ptr %40, align 4
  %min_limit89.i.i = getelementptr inbounds [225 x %struct.Mapping], ptr @Map, i64 0, i64 %indvars.iv.i.i, i32 5
  %42 = load double, ptr %min_limit89.i.i, align 8
  %conv90.i.i = fptosi double %42 to i32
  %cmp91.i.i = icmp slt i32 %41, %conv90.i.i
  br i1 %cmp91.i.i, label %if.then93.i.i, label %if.end181.i.i

if.then93.i.i:                                    ; preds = %if.then83.i.i
  %call101.i.i = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.313, ptr noundef nonnull %30, i32 noundef %conv90.i.i) #21
  br label %if.end181.sink.split.i.i
...
if.then118.i.i:                                   ; preds = %if.then109.i.i
  %call125.i.i = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.314, ptr noundef nonnull %30, double noundef %45) #21
  br label %if.end181.sink.split.i.i
...
if.then135.i.i:                                   ; preds = %while.body.i.i
  ...
  %46 = load i32, ptr %Type138.i.i, align 8
...
if.then162.i.i:                                   ; preds = %if.then141.i.i
  %call176.i.i = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.311, ptr noundef nonnull %30, i32 noundef %conv149.i.i, i32 noundef %.pre235.i.i) #21
  br label %if.end181.sink.split.i.i
...
if.end181.i.i:                                    ; preds = %if.end181.sink.split.i.i, %if.then141.i.i, %if.then135.i.i, %if.then109.i.i, %if.then83.i.i, %if.then77.i.i, %if.then39.i.i, %if.then7.i.i, %if.then.i.i, %while.body.i.i
  ...
  br i1 %cmp.not.i.i, label %TestEncoderParams.exit.loopexit.i, label %while.body.i.i

TestEncoderParams.exit.loopexit.i:                ; preds = %if.end181.i.i
  %.pre.i = load ptr, ptr @input, align 8
  br label %TestEncoderParams.exit.i

TestEncoderParams.exit.i:                         ; preds = %TestEncoderParams.exit.loopexit.i, %while.end125
  %51 = phi ptr [ %.pre.i, %TestEncoderParams.exit.loopexit.i ], [ %.pre886.i, %while.end125 ]
  %FrameRate.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 92
  %52 = load double, ptr %FrameRate.i, align 8
  %cmp.i = fcmp oeq double %52, 0.000000e+00
  br i1 %cmp.i, label %if.then.i196, label %if.end.i

if.then.i196:                                     ; preds = %TestEncoderParams.exit.i
  store double 3.000000e+01, ptr %FrameRate.i, align 8
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i196, %TestEncoderParams.exit.i
  %part_size.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 19
  store <4 x i32> <i32 4, i32 4, i32 4, i32 4>, ptr %part_size.i, align 8
  %arrayidx13.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 19, i64 2
  store <4 x i32> <i32 4, i32 2, i32 2, i32 4>, ptr %arrayidx13.i, align 8
  %arrayidx25.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 19, i64 4
  store <4 x i32> <i32 2, i32 2, i32 2, i32 1>, ptr %arrayidx25.i, align 8
  %arrayidx37.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 19, i64 6
  store <4 x i32> <i32 1, i32 2, i32 1, i32 1>, ptr %arrayidx37.i, align 8
  %blocktype_lut.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 20
  store i32 7, ptr %blocktype_lut.i, align 8
  %arrayidx52.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 20, i64 0, i64 1
  store i32 6, ptr %arrayidx52.i, align 4
  %arrayidx54.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 20, i64 1
  store i32 5, ptr %arrayidx54.i, align 8
  %arrayidx58.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 20, i64 1, i64 1
  store i32 4, ptr %arrayidx58.i, align 4
  %arrayidx61.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 20, i64 1, i64 3
  store i32 3, ptr %arrayidx61.i, align 4
  %arrayidx64.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 20, i64 3, i64 1
  store i32 2, ptr %arrayidx64.i, align 4
  %arrayidx67.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 20, i64 3, i64 3
  store i32 1, ptr %arrayidx67.i, align 4
  %arrayidx80.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 18, i64 0, i64 0
  store <4 x i32> <i32 16, i32 16, i32 16, i32 16>, ptr %arrayidx80.i, align 4
  %arrayidx80.2.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 18, i64 2, i64 0
  store <4 x i32> <i32 16, i32 8, i32 8, i32 16>, ptr %arrayidx80.2.i, align 4
  %arrayidx80.4.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 18, i64 4, i64 0
  store <4 x i32> <i32 8, i32 8, i32 8, i32 4>, ptr %arrayidx80.4.i, align 4
  %arrayidx80.6.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 18, i64 6, i64 0
  store <4 x i32> <i32 4, i32 8, i32 4, i32 4>, ptr %arrayidx80.6.i, align 4
  %BRefPictures.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 68
  %53 = load i32, ptr %BRefPictures.i, align 4
  %tobool.not.i190 = icmp eq i32 %53, 0
  br i1 %tobool.not.i190, label %cond.end.i, label %cond.true.i

cond.true.i:                                      ; preds = %if.end.i
  %successive_Bframe.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 40
  %54 = load i32, ptr %successive_Bframe.i, align 8
  %add.i = add nsw i32 %54, 1
  br label %cond.end.i

cond.end.i:                                       ; preds = %cond.true.i, %if.end.i
  %cond.i191 = phi i32 [ %add.i, %cond.true.i ], [ 1, %if.end.i ]
  %Log2MaxFNumMinus4.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 12
  %55 = load i32, ptr %Log2MaxFNumMinus4.i, align 8
  %cmp84.i = icmp eq i32 %55, -1
  br i1 %cmp84.i, label %if.then85.i, label %if.end91.i

if.then85.i:                                      ; preds = %cond.end.i
  %no_frames.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 2
  %56 = load i32, ptr %no_frames.i, align 8
  %mul86.i = mul nsw i32 %56, %cond.i191
  %sub.i832.i = add i32 %mul86.i, -1
  %cmp.not3.i.i = icmp eq i32 %sub.i832.i, 0
  br i1 %cmp.not3.i.i, label %CeilLog2.exit.i, label %while.body.i833.i

while.body.i833.i:                                ; preds = %if.then85.i, %while.body.i833.i
  %uiRet.05.i.i = phi i32 [ %inc.i.i, %while.body.i833.i ], [ 0, %if.then85.i ]
  %uiTmp.04.i.i = phi i32 [ %shr.i.i, %while.body.i833.i ], [ %sub.i832.i, %if.then85.i ]
  %shr.i.i = lshr i32 %uiTmp.04.i.i, 1
  %inc.i.i = add nuw nsw i32 %uiRet.05.i.i, 1
  %cmp.not.i834.i = icmp ult i32 %uiTmp.04.i.i, 2
  br i1 %cmp.not.i834.i, label %CeilLog2.exit.i, label %while.body.i833.i

CeilLog2.exit.i:                                  ; preds = %while.body.i833.i, %if.then85.i
  %uiRet.0.lcssa.i.i = phi i32 [ 0, %if.then85.i ], [ %inc.i.i, %while.body.i833.i ]
...
if.end91.i:                                       ; preds = %CeilLog2.exit.i, %cond.end.i
  %storemerge.i = phi i32 [ %cond.i4.i.i, %CeilLog2.exit.i ], [ %55, %cond.end.i ]
  store i32 %storemerge.i, ptr @log2_max_frame_num_minus4, align 4
  %cmp92.i = icmp eq i32 %storemerge.i, 0
  br i1 %cmp92.i, label %land.lhs.true.i, label %if.end98.i

land.lhs.true.i:                                  ; preds = %if.end91.i
  %num_ref_frames.i = getelementptr inbounds %struct.InputParameters, ptr %51, i64 0, i32 8
  %57 = load i32, ptr %num_ref_frames.i, align 8
  %cmp93.i = icmp eq i32 %57, 16
  br i1 %cmp93.i, label %if.then94.i, label %if.end98.i

if.then94.i:                                      ; preds = %land.lhs.true.i
  %call97.i = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.255, i32 noundef 16, i32 noundef %55) #21
  tail call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre887.i = load ptr, ptr @input, align 8
  br label %if.end98.i

if.end98.i:                                       ; preds = %if.then94.i, %land.lhs.true.i, %if.end91.i
  %58 = phi ptr [ %.pre887.i, %if.then94.i ], [ %51, %land.lhs.true.i ], [ %51, %if.end91.i ]
  %Log2MaxPOCLsbMinus4.i = getelementptr inbounds %struct.InputParameters, ptr %58, i64 0, i32 13
  %59 = load i32, ptr %Log2MaxPOCLsbMinus4.i, align 4
  %cmp99.i = icmp eq i32 %59, -1
  %jumpd.i = getelementptr inbounds %struct.InputParameters, ptr %58, i64 0, i32 5
  br i1 %cmp99.i, label %if.then100.i, label %if.end110.thread.i

if.then100.i:                                     ; preds = %if.end98.i
  %no_frames101.i = getelementptr inbounds %struct.InputParameters, ptr %58, i64 0, i32 2
  %60 = load i32, ptr %no_frames101.i, align 8
  %mul102.i = shl nsw i32 %60, 1
  %61 = load i32, ptr %jumpd.i, align 4
  %add103.i = add nsw i32 %61, 1
  %mul104.i = mul nsw i32 %mul102.i, %add103.i
  %sub.i835.i = add i32 %mul104.i, -1
  br label %while.body.i836.i

while.body.i836.i:                                ; preds = %while.body.i836.i, %if.then100.i
  %uiRet.05.i837.i = phi i32 [ %inc.i840.i, %while.body.i836.i ], [ 0, %if.then100.i ]
  %uiTmp.04.i838.i = phi i32 [ %shr.i839.i, %while.body.i836.i ], [ %sub.i835.i, %if.then100.i ]
  %shr.i839.i = lshr i32 %uiTmp.04.i838.i, 1
  %inc.i840.i = add nuw nsw i32 %uiRet.05.i837.i, 1
  %cmp.not.i841.i = icmp ult i32 %uiTmp.04.i838.i, 2
  br i1 %cmp.not.i841.i, label %if.end110.i, label %while.body.i836.i

if.end110.i:                                      ; preds = %while.body.i836.i
  %62 = tail call i32 @llvm.smax.i32(i32 %uiRet.05.i837.i, i32 3)
  %63 = tail call i32 @llvm.smin.i32(i32 %62, i32 15)
  %cond.i4.i845.i = add nsw i32 %63, -3
  store i32 %cond.i4.i845.i, ptr @log2_max_pic_order_cnt_lsb_minus4, align 4
  br label %if.end119.i

if.end110.thread.i:                               ; preds = %if.end98.i
  store i32 %59, ptr @log2_max_pic_order_cnt_lsb_minus4, align 4
  %add111857.i = add i32 %59, 3
  %shl858.i = shl nuw i32 1, %add111857.i
  %64 = load i32, ptr %jumpd.i, align 4
  %mul113860.i = shl nsw i32 %64, 2
...
if.then118.i:                                     ; preds = %if.end110.thread.i
  ...
  %.pre888.i = load ptr, ptr @input, align 8
  %jumpd121.phi.trans.insert.i = getelementptr inbounds %struct.InputParameters, ptr %.pre888.i, i64 0, i32 5
  %.pre889.i = load i32, ptr %jumpd121.phi.trans.insert.i, align 4
  br label %if.end119.i

if.end119.i:                                      ; preds = %if.then118.i, %if.end110.thread.i, %if.end110.i
  %65 = phi i32 [ %61, %if.end110.i ], [ %64, %if.end110.thread.i ], [ %.pre889.i, %if.then118.i ]
  %66 = phi ptr [ %58, %if.end110.i ], [ %58, %if.end110.thread.i ], [ %.pre888.i, %if.then118.i ]
  %successive_Bframe120.i = getelementptr inbounds %struct.InputParameters, ptr %66, i64 0, i32 40
  %67 = load i32, ptr %successive_Bframe120.i, align 8
  %cmp122.i = icmp sgt i32 %67, %65
  br i1 %cmp122.i, label %if.then123.i, label %if.end126.i

if.then123.i:                                     ; preds = %if.end119.i
  %call125.i = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.257, i32 noundef %67) #21
  tail call void @error(ptr noundef nonnull @errortext, i32 noundef 400) #21
  %.pre890.i = load ptr, ptr @input, align 8
  %successive_Bframe127.phi.trans.insert.i = getelementptr inbounds %struct.InputParameters, ptr %.pre890.i, i64 0, i32 40
  %.pre891.i = load i32, ptr %successive_Bframe127.phi.trans.insert.i, align 8
  br label %if.end126.i

if.end126.i:                                      ; preds = %if.then123.i, %if.end119.i
  %68 = phi i32 [ %.pre891.i, %if.then123.i ], [ %67, %if.end119.i ]
  %69 = phi ptr [ %.pre890.i, %if.then123.i ], [ %66, %if.end119.i ]
  %tobool128.not.i = icmp eq i32 %68, 0
  br i1 %tobool128.not.i, label %if.end137.i, label %land.lhs.true129.i

land.lhs.true129.i:                               ; preds = %if.end126.i
  %direct_spatial_mv_pred_flag.i = getelementptr inbounds %struct.InputParameters, ptr %69, i64 0, i32 44
  %70 = load i32, ptr %direct_spatial_mv_pred_flag.i, align 8
  %switch.i = icmp ult i32 %70, 2
  br i1 %switch.i, label %if.end137.i, label %if.then134.i

if.then134.i:                                     ; preds = %land.lhs.true129.i
  %call136.i = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.258, i32 noundef %70) #21
  tail call void @error(ptr noundef nonnull @errortext, i32 noundef 400) #21
  %.pre892.i = load ptr, ptr @input, align 8
  br label %if.end137.i

if.end137.i:                                      ; preds = %if.then134.i, %land.lhs.true129.i, %if.end126.i
  %71 = phi ptr [ %69, %land.lhs.true129.i ], [ %.pre892.i, %if.then134.i ], [ %69, %if.end126.i ]
  %PicInterlace.i = getelementptr inbounds %struct.InputParameters, ptr %71, i64 0, i32 121
  %72 = load i32, ptr %PicInterlace.i, align 8
  %cmp138.i = icmp sgt i32 %72, 0
  br i1 %cmp138.i, label %if.then140.i, label %lor.lhs.false.i

lor.lhs.false.i:                                  ; preds = %if.end137.i
  %MbInterlace.i = getelementptr inbounds %struct.InputParameters, ptr %71, i64 0, i32 122
  %73 = load i32, ptr %MbInterlace.i, align 4
  %cmp139.i = icmp sgt i32 %73, 0
  br i1 %cmp139.i, label %if.then140.i, label %if.end158.i

if.then140.i:                                     ; preds = %lor.lhs.false.i, %if.end137.i
  %directInferenceFlag.i = getelementptr inbounds %struct.InputParameters, ptr %71, i64 0, i32 45
  %74 = load i32, ptr %directInferenceFlag.i, align 4
  %cmp141.i = icmp eq i32 %74, 0
...
if.then142.i:                                     ; preds = %if.then140.i
  ...
  %.pre893.i = load ptr, ptr @input, align 8
  %PicInterlace147.phi.trans.insert.phi.trans.insert.i = getelementptr inbounds %struct.InputParameters, ptr %.pre893.i, i64 0, i32 121
  %.pre894.pre.i = load i32, ptr %PicInterlace147.phi.trans.insert.phi.trans.insert.i, align 8
  br label %if.end146.i

if.end146.i:                                      ; preds = %if.then142.i, %if.then140.i
  %.pre894.i = phi i32 [ %.pre894.pre.i, %if.then142.i ], [ %72, %if.then140.i ]
  %75 = phi ptr [ %.pre893.i, %if.then142.i ], [ %71, %if.then140.i ]
  %directInferenceFlag145.i = getelementptr inbounds %struct.InputParameters, ptr %75, i64 0, i32 45
  store i32 1, ptr %directInferenceFlag145.i, align 4
  %cmp148.i = icmp sgt i32 %.pre894.i, 0
  br i1 %cmp148.i, label %if.then149.i, label %if.end158.i

if.then149.i:                                     ; preds = %if.end146.i
  %IntraBottom.i = getelementptr inbounds %struct.InputParameters, ptr %75, i64 0, i32 123
  %76 = load i32, ptr %IntraBottom.i, align 8
  %switch828.i = icmp ult i32 %76, 2
  br i1 %switch828.i, label %if.end158.i, label %if.then154.i

if.then154.i:                                     ; preds = %if.then149.i
  %call156.i = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.260, i32 noundef %76) #21
  tail call void @error(ptr noundef nonnull @errortext, i32 noundef 400) #21
  %.pre895.i = load ptr, ptr @input, align 8
  br label %if.end158.i

if.end158.i:                                      ; preds = %if.then154.i, %if.then149.i, %if.end146.i, %lor.lhs.false.i
  %77 = phi ptr [ %75, %if.then149.i ], [ %.pre895.i, %if.then154.i ], [ %75, %if.end146.i ], [ %71, %lor.lhs.false.i ]
  %symbol_mode.i = getelementptr inbounds %struct.InputParameters, ptr %77, i64 0, i32 74
  %78 = load i32, ptr %symbol_mode.i, align 8
  %switch829.i = icmp ult i32 %78, 2
  br i1 %switch829.i, label %if.end166.i, label %if.then163.i

if.then163.i:                                     ; preds = %if.end158.i
  %call165.i = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.261, i32 noundef %78) #21
  tail call void @error(ptr noundef nonnull @errortext, i32 noundef 400) #21
  %.pre896.i = load ptr, ptr @input, align 8
  br label %if.end166.i

if.end166.i:                                      ; preds = %if.then163.i, %if.end158.i
  %79 = phi ptr [ %77, %if.end158.i ], [ %.pre896.i, %if.then163.i ]
  %infile.i = getelementptr inbounds %struct.InputParameters, ptr %79, i64 0, i32 25
  %call167.i = tail call i32 (ptr, i32, ...) @open64(ptr noundef nonnull %infile.i, i32 noundef 0) #21
  store i32 %call167.i, ptr @p_in, align 4
...
if.then169.i:                                     ; preds = %if.end166.i
  ...
  %infile170.i = getelementptr inbounds %struct.InputParameters, ptr %80, i64 0, i32 25
...
if.end173.i:                                      ; preds = %if.then169.i, %if.end166.i
  ...
  %ReconFile.i = getelementptr inbounds %struct.InputParameters, ptr %81, i64 0, i32 27
...
land.lhs.true177.i:                               ; preds = %if.end173.i
  ...
  store i32 %call180.i, ptr @p_dec, align 4
  %cmp181.i = icmp eq i32 %call180.i, -1
  %.pre898.i = load ptr, ptr @input, align 8
  br i1 %cmp181.i, label %if.then182.i, label %if.end186.i

if.then182.i:                                     ; preds = %land.lhs.true177.i
  %ReconFile183.i = getelementptr inbounds %struct.InputParameters, ptr %.pre898.i, i64 0, i32 27
  ...
  tail call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre897.i = load ptr, ptr @input, align 8
  br label %if.end186.i

if.end186.i:                                      ; preds = %if.then182.i, %land.lhs.true177.i, %if.end173.i
  %82 = phi ptr [ %.pre897.i, %if.then182.i ], [ %.pre898.i, %land.lhs.true177.i ], [ %81, %if.end173.i ]
  %img_width.i = getelementptr inbounds %struct.InputParameters, ptr %82, i64 0, i32 14
  %83 = load i32, ptr %img_width.i, align 8
  %rem.i = srem i32 %83, 16
  ...
  %auto_crop_right193.i = getelementptr inbounds %struct.ImageParameters, ptr %84, i64 0, i32 166
  store i32 %.sink.i, ptr %auto_crop_right193.i, align 8
  %PicInterlace195.i = getelementptr inbounds %struct.InputParameters, ptr %82, i64 0, i32 121
  %85 = load i32, ptr %PicInterlace195.i, align 8
  %tobool196.not.i = icmp eq i32 %85, 0
  br i1 %tobool196.not.i, label %lor.lhs.false197.i, label %if.then200.i

lor.lhs.false197.i:                               ; preds = %if.end186.i
  %MbInterlace198.i = getelementptr inbounds %struct.InputParameters, ptr %82, i64 0, i32 122
  %86 = load i32, ptr %MbInterlace198.i, align 4
  %tobool199.not.i = icmp eq i32 %86, 0
...
if.then200.i:                                     ; preds = %lor.lhs.false197.i, %if.end186.i
  ...
  %87 = load i32, ptr %img_height.i, align 4
  %88 = and i32 %87, 1
  %cmp202.not.i = icmp eq i32 %88, 0
...
if.then203.i:                                     ; preds = %if.then200.i
  ...
  %.pre899.i = load ptr, ptr @input, align 8
  %img_height205.phi.trans.insert.i = getelementptr inbounds %struct.InputParameters, ptr %.pre899.i, i64 0, i32 15
  %.pre900.i = load i32, ptr %img_height205.phi.trans.insert.i, align 4
  br label %if.end204.i

if.end204.i:                                      ; preds = %if.then203.i, %if.then200.i
  %89 = phi i32 [ %.pre900.i, %if.then203.i ], [ %87, %if.then200.i ]
  %90 = phi ptr [ %.pre899.i, %if.then203.i ], [ %82, %if.then200.i ]
  %rem206.i = srem i32 %89, 32
...
if.then208.i:                                     ; preds = %if.end204.i
  ...
  %auto_crop_right235.phi.trans.insert.i.phi.trans.insert = getelementptr inbounds %struct.ImageParameters, ptr %91, i64 0, i32 166
  %.pre901.i.pre = load i32, ptr %auto_crop_right235.phi.trans.insert.i.phi.trans.insert, align 8
  br label %if.end227.if.then233_crit_edge.i

if.else212.i:                                     ; preds = %if.end204.i
  %92 = load ptr, ptr @img, align 8
  %auto_crop_right231.i.phi.trans.insert = getelementptr inbounds %struct.ImageParameters, ptr %92, i64 0, i32 166
  %.pre = load i32, ptr %auto_crop_right231.i.phi.trans.insert, align 8
  br label %lor.lhs.false230.i

if.else215.i:                                     ; preds = %lor.lhs.false197.i
  %img_height216.i = getelementptr inbounds %struct.InputParameters, ptr %82, i64 0, i32 15
  %93 = load i32, ptr %img_height216.i, align 4
  %rem217.i = srem i32 %93, 16
...
if.end227.if.then233_crit_edge.i:                 ; preds = %if.then219.i, %if.then208.i
  %.pre901.i = phi i32 [ %.pre901.i.pre, %if.then208.i ], [ %.sink.i, %if.then219.i ]
  %.sink972.i = phi ptr [ %91, %if.then208.i ], [ %84, %if.then219.i ]
  %sub211.sink.i = phi i32 [ %sub211.i, %if.then208.i ], [ %sub222.i, %if.then219.i ]
  %94 = phi i32 [ %89, %if.then208.i ], [ %93, %if.then219.i ]
  %95 = phi ptr [ %90, %if.then208.i ], [ %82, %if.then219.i ]
  %auto_crop_bottom.i = getelementptr inbounds %struct.ImageParameters, ptr %.sink972.i, i64 0, i32 167
  store i32 %sub211.sink.i, ptr %auto_crop_bottom.i, align 4
  br label %if.then233.i

lor.lhs.false230.i:                               ; preds = %if.else215.i, %if.else212.i
  %96 = phi i32 [ %.pre, %if.else212.i ], [ %.sink.i, %if.else215.i ]
  %.sink973.i = phi ptr [ %92, %if.else212.i ], [ %84, %if.else215.i ]
  %.ph.i = phi i32 [ %89, %if.else212.i ], [ %93, %if.else215.i ]
  %.ph953.i = phi ptr [ %90, %if.else212.i ], [ %82, %if.else215.i ]
  %auto_crop_bottom225.i = getelementptr inbounds %struct.ImageParameters, ptr %.sink973.i, i64 0, i32 167
  store i32 0, ptr %auto_crop_bottom225.i, align 4
  %tobool232.not.i = icmp eq i32 %96, 0
...
if.then233.i:                                     ; preds = %lor.lhs.false230.i, %if.end227.if.then233_crit_edge.i
  %97 = phi i32 [ %sub211.sink.i, %if.end227.if.then233_crit_edge.i ], [ 0, %lor.lhs.false230.i ]
  %98 = phi ptr [ %95, %if.end227.if.then233_crit_edge.i ], [ %.ph953.i, %lor.lhs.false230.i ]
  %99 = phi i32 [ %94, %if.end227.if.then233_crit_edge.i ], [ %.ph.i, %lor.lhs.false230.i ]
  %100 = phi i32 [ %.pre901.i, %if.end227.if.then233_crit_edge.i ], [ %96, %lor.lhs.false230.i ]
  %101 = load ptr, ptr @stderr, align 8
  %img_width234.i = getelementptr inbounds %struct.InputParameters, ptr %98, i64 0, i32 14
  %102 = load i32, ptr %img_width234.i, align 8
  %add236.i = add nsw i32 %102, %100
  %add239.i = add nsw i32 %99, %97
  %call240.i = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %101, ptr noundef nonnull @.str.265, i32 noundef %add236.i, i32 noundef %add239.i) #18
  %.pre902.i = load ptr, ptr @input, align 8
  br label %if.end241.i

if.end241.i:                                      ; preds = %if.then233.i, %lor.lhs.false230.i
  %103 = phi ptr [ %.pre902.i, %if.then233.i ], [ %.ph953.i, %lor.lhs.false230.i ]
  %slice_mode.i = getelementptr inbounds %struct.InputParameters, ptr %103, i64 0, i32 21
  %104 = load i32, ptr %slice_mode.i, align 8
  %cmp242.i = icmp eq i32 %104, 1
  br i1 %cmp242.i, label %land.lhs.true243.i, label %if.end262.i

land.lhs.true243.i:                               ; preds = %if.end241.i
  %MbInterlace244.i = getelementptr inbounds %struct.InputParameters, ptr %103, i64 0, i32 122
  %105 = load i32, ptr %MbInterlace244.i, align 4
  %cmp245.not.i = icmp eq i32 %105, 0
  br i1 %cmp245.not.i, label %if.end262.i, label %if.then246.i

if.then246.i:                                     ; preds = %land.lhs.true243.i
  %slice_argument.i = getelementptr inbounds %struct.InputParameters, ptr %103, i64 0, i32 22
  %106 = load i32, ptr %slice_argument.i, align 4
  %107 = and i32 %106, 1
  %cmp248.not.i = icmp eq i32 %107, 0
  br i1 %cmp248.not.i, label %if.end262.i, label %if.then249.i

if.then249.i:                                     ; preds = %if.then246.i
  %108 = load ptr, ptr @stderr, align 8
  %109 = tail call i64 @fwrite(ptr nonnull @.str.266, i64 46, i64 1, ptr %108) #18
  %110 = load ptr, ptr @input, align 8
  %slice_argument251.i = getelementptr inbounds %struct.InputParameters, ptr %110, i64 0, i32 22
  %111 = load i32, ptr %slice_argument251.i, align 4
  %cmp252.i = icmp sgt i32 %111, 1
  %storemerge822.v.i = select i1 %cmp252.i, i32 -1, i32 1
  %storemerge822.i = add nsw i32 %storemerge822.v.i, %111
  store i32 %storemerge822.i, ptr %slice_argument251.i, align 4
  %112 = load ptr, ptr @stderr, align 8
  %call260.i = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %112, ptr noundef nonnull @.str.267, i32 noundef %storemerge822.i) #18
  %.pre903.i = load ptr, ptr @input, align 8
  br label %if.end262.i

if.end262.i:                                      ; preds = %if.then249.i, %if.then246.i, %land.lhs.true243.i, %if.end241.i
  %113 = phi ptr [ %103, %if.then246.i ], [ %.pre903.i, %if.then249.i ], [ %103, %land.lhs.true243.i ], [ %103, %if.end241.i ]
  %num_slice_groups_minus1.i = getelementptr inbounds %struct.InputParameters, ptr %113, i64 0, i32 140
  %114 = load i32, ptr %num_slice_groups_minus1.i, align 8
  %cmp263.not.i = icmp eq i32 %114, 0
  br i1 %cmp263.not.i, label %if.end408.i, label %land.lhs.true264.i

land.lhs.true264.i:                               ; preds = %if.end262.i
  %slice_group_map_type.i = getelementptr inbounds %struct.InputParameters, ptr %113, i64 0, i32 141
  %115 = load i32, ptr %slice_group_map_type.i, align 4
  switch i32 %115, label %if.end408.i [
...
if.then272.i:                                     ; preds = %land.lhs.true264.i, %land.lhs.true264.i, %land.lhs.true264.i
  %SliceGroupConfigFileName.i = getelementptr inbounds %struct.InputParameters, ptr %113, i64 0, i32 139
  %char0823.i = load i8, ptr %SliceGroupConfigFileName.i, align 1
  %cmp275.not.i = icmp eq i8 %char0823.i, 0
...
land.lhs.true276.i:                               ; preds = %if.then272.i
  ...
  %.pre904.i = load ptr, ptr @input, align 8
...
land.lhs.true276.if.else285_crit_edge.i:          ; preds = %land.lhs.true276.i
  %slice_group_map_type286.phi.trans.insert.i = getelementptr inbounds %struct.InputParameters, ptr %.pre904.i, i64 0, i32 141
  %.pre905.i = load i32, ptr %slice_group_map_type286.phi.trans.insert.i, align 4
  br label %if.else285.i

if.then281.i:                                     ; preds = %land.lhs.true276.i
  %SliceGroupConfigFileName282.i = getelementptr inbounds %struct.InputParameters, ptr %.pre904.i, i64 0, i32 139
...
if.else285.i:                                     ; preds = %land.lhs.true276.if.else285_crit_edge.i, %if.then272.i
  %116 = phi i32 [ %.pre905.i, %land.lhs.true276.if.else285_crit_edge.i ], [ %115, %if.then272.i ]
  %117 = phi ptr [ %.pre904.i, %land.lhs.true276.if.else285_crit_edge.i ], [ %113, %if.then272.i ]
  %sgfile.0.i = phi ptr [ %call279.i, %land.lhs.true276.if.else285_crit_edge.i ], [ null, %if.then272.i ]
  switch i32 %116, label %if.end405.i [
...
if.then288.i:                                     ; preds = %if.else285.i
  %num_slice_groups_minus1289.i = getelementptr inbounds %struct.InputParameters, ptr %117, i64 0, i32 140
  %118 = load i32, ptr %num_slice_groups_minus1289.i, align 8
  %add290.i = add nsw i32 %118, 1
  %conv.i194 = sext i32 %add290.i to i64
  %mul291.i = shl nsw i64 %conv.i194, 2
  %call292.i = tail call noalias ptr @malloc(i64 noundef %mul291.i) #22
  %run_length_minus1.i = getelementptr inbounds %struct.InputParameters, ptr %117, i64 0, i32 145
  store ptr %call292.i, ptr %run_length_minus1.i, align 8
...
if.then296.i:                                     ; preds = %if.then288.i
  ...
  %.pre909.i = load ptr, ptr @input, align 8
  %num_slice_groups_minus1299870.phi.trans.insert.i = getelementptr inbounds %struct.InputParameters, ptr %.pre909.i, i64 0, i32 140
  %.pre910.i = load i32, ptr %num_slice_groups_minus1299870.phi.trans.insert.i, align 8
  br label %if.end297.i

if.end297.i:                                      ; preds = %if.then296.i, %if.then288.i
  %119 = phi i32 [ %.pre910.i, %if.then296.i ], [ %118, %if.then288.i ]
  %120 = phi ptr [ %.pre909.i, %if.then296.i ], [ %117, %if.then288.i ]
  %cmp300.not871.i = icmp slt i32 %119, 0
...
for.body302.i:                                    ; preds = %if.end297.i, %for.body302.i
  ...
  %121 = phi ptr [ %123, %for.body302.i ], [ %120, %if.end297.i ]
  %run_length_minus1303.i = getelementptr inbounds %struct.InputParameters, ptr %121, i64 0, i32 145
  %122 = load ptr, ptr %run_length_minus1303.i, align 8
  %add.ptr.i195 = getelementptr inbounds i32, ptr %122, i64 %indvars.iv883.i
  %call304.i = tail call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %sgfile.0.i, ptr noundef nonnull @.str.245, ptr noundef %add.ptr.i195) #21
  ...
  %num_slice_groups_minus1299.i = getelementptr inbounds %struct.InputParameters, ptr %123, i64 0, i32 140
  %124 = load i32, ptr %num_slice_groups_minus1299.i, align 8
  %125 = sext i32 %124 to i64
  %cmp300.not.not.i = icmp slt i64 %indvars.iv883.i, %125
  br i1 %cmp300.not.not.i, label %for.body302.i, label %if.end405.i

if.then313.i:                                     ; preds = %if.else285.i
  %num_slice_groups_minus1314.i = getelementptr inbounds %struct.InputParameters, ptr %117, i64 0, i32 140
  %126 = load i32, ptr %num_slice_groups_minus1314.i, align 8
  %conv315.i = sext i32 %126 to i64
  %mul316.i = shl nsw i64 %conv315.i, 2
  %call317.i = tail call noalias ptr @malloc(i64 noundef %mul316.i) #22
  %top_left.i = getelementptr inbounds %struct.InputParameters, ptr %117, i64 0, i32 142
  store ptr %call317.i, ptr %top_left.i, align 8
  %call321.i = tail call noalias ptr @malloc(i64 noundef %mul316.i) #22
  %bottom_right.i = getelementptr inbounds %struct.InputParameters, ptr %117, i64 0, i32 143
  store ptr %call321.i, ptr %bottom_right.i, align 8
...
if.then325.i:                                     ; preds = %if.then313.i
  ...
  %.pre906.i = load ptr, ptr @input, align 8
  %bottom_right327.phi.trans.insert.i = getelementptr inbounds %struct.InputParameters, ptr %.pre906.i, i64 0, i32 143
  %.pre907.i = load ptr, ptr %bottom_right327.phi.trans.insert.i, align 8
  br label %if.end326.i

if.end326.i:                                      ; preds = %if.then325.i, %if.then313.i
  %127 = phi ptr [ %.pre907.i, %if.then325.i ], [ %call321.i, %if.then313.i ]
  %128 = phi ptr [ %.pre906.i, %if.then325.i ], [ %117, %if.then313.i ]
  %cmp328.i = icmp eq ptr %127, null
...
if.then330.i:                                     ; preds = %if.end326.i
  ...
  %.pre908.i = load ptr, ptr @input, align 8
  br label %if.end331.i

if.end331.i:                                      ; preds = %if.then330.i, %if.end326.i
  %129 = phi ptr [ %.pre908.i, %if.then330.i ], [ %128, %if.end326.i ]
  %num_slice_groups_minus1333867.i = getelementptr inbounds %struct.InputParameters, ptr %129, i64 0, i32 140
  %130 = load i32, ptr %num_slice_groups_minus1333867.i, align 8
  %cmp334868.i = icmp sgt i32 %130, 0
...
for.body336.i:                                    ; preds = %if.end331.i, %for.body336.i
  ...
  %131 = phi ptr [ %135, %for.body336.i ], [ %129, %if.end331.i ]
  %top_left337.i = getelementptr inbounds %struct.InputParameters, ptr %131, i64 0, i32 142
  %132 = load ptr, ptr %top_left337.i, align 8
  %add.ptr339.i = getelementptr inbounds i32, ptr %132, i64 %indvars.iv880.i
  ...
  %bottom_right342.i = getelementptr inbounds %struct.InputParameters, ptr %133, i64 0, i32 143
  %134 = load ptr, ptr %bottom_right342.i, align 8
  %add.ptr344.i = getelementptr inbounds i32, ptr %134, i64 %indvars.iv880.i
  ...
  %num_slice_groups_minus1333.i = getelementptr inbounds %struct.InputParameters, ptr %135, i64 0, i32 140
  %136 = load i32, ptr %num_slice_groups_minus1333.i, align 8
  %137 = sext i32 %136 to i64
  %cmp334.i = icmp slt i64 %indvars.iv.next881.i, %137
  br i1 %cmp334.i, label %for.body336.i, label %if.end405.i

if.then354.i:                                     ; preds = %if.else285.i
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %tmp.i) #21
  %PicInterlace355.i = getelementptr inbounds %struct.InputParameters, ptr %117, i64 0, i32 121
  %138 = load i32, ptr %PicInterlace355.i, align 8
  %tobool356.not.i = icmp eq i32 %138, 0
  br i1 %tobool356.not.i, label %lor.rhs.i, label %lor.end.i

lor.rhs.i:                                        ; preds = %if.then354.i
  %MbInterlace357.i = getelementptr inbounds %struct.InputParameters, ptr %117, i64 0, i32 122
  %139 = load i32, ptr %MbInterlace357.i, align 4
  %tobool358.i = icmp ne i32 %139, 0
  br label %lor.end.i

lor.end.i:                                        ; preds = %lor.rhs.i, %if.then354.i
  %140 = phi i1 [ true, %if.then354.i ], [ %tobool358.i, %lor.rhs.i ]
  %img_width359.i = getelementptr inbounds %struct.InputParameters, ptr %117, i64 0, i32 14
  %141 = load i32, ptr %img_width359.i, align 8
  %142 = load ptr, ptr @img, align 8
  %auto_crop_right360.i = getelementptr inbounds %struct.ImageParameters, ptr %142, i64 0, i32 166
  %143 = load i32, ptr %auto_crop_right360.i, align 8
  %add361.i = add nsw i32 %143, %141
  %shr.i = ashr i32 %add361.i, 4
  %img_height362.i = getelementptr inbounds %struct.InputParameters, ptr %117, i64 0, i32 15
  %144 = load i32, ptr %img_height362.i, align 4
  %auto_crop_bottom363.i = getelementptr inbounds %struct.ImageParameters, ptr %142, i64 0, i32 167
  %145 = load i32, ptr %auto_crop_bottom363.i, align 4
  %add364.i = add nsw i32 %145, %144
  %shr365.i = ashr i32 %add364.i, 4
  %cond.fr.i = freeze i1 %140
  ...
  %slice_group_id.i = getelementptr inbounds %struct.InputParameters, ptr %117, i64 0, i32 144
  store ptr %call371.i, ptr %slice_group_id.i, align 8
...
for.body381.i:                                    ; preds = %if.end398.i, %for.body381.preheader.i
  %indvars.iv.i192 = phi i64 [ 0, %for.body381.preheader.i ], [ %indvars.iv.next.i193, %if.end398.i ]
  ...
  %146 = load i32, ptr %tmp.i, align 4
  %conv383.i = trunc i32 %146 to i8
  %147 = load ptr, ptr @input, align 8
  %slice_group_id384.i = getelementptr inbounds %struct.InputParameters, ptr %147, i64 0, i32 144
  %148 = load ptr, ptr %slice_group_id384.i, align 8
  %arrayidx386.i = getelementptr inbounds i8, ptr %148, i64 %indvars.iv.i192
  store i8 %conv383.i, ptr %arrayidx386.i, align 1
  %149 = load ptr, ptr @input, align 8
  %slice_group_id387.i = getelementptr inbounds %struct.InputParameters, ptr %149, i64 0, i32 144
  %150 = load ptr, ptr %slice_group_id387.i, align 8
  %add.ptr389.i = getelementptr inbounds i8, ptr %150, i64 %indvars.iv.i192
  %151 = load i8, ptr %add.ptr389.i, align 1
  %conv390.i = zext i8 %151 to i32
  %num_slice_groups_minus1391.i = getelementptr inbounds %struct.InputParameters, ptr %149, i64 0, i32 140
  %152 = load i32, ptr %num_slice_groups_minus1391.i, align 8
  %cmp392.i = icmp slt i32 %152, %conv390.i
  br i1 %cmp392.i, label %if.then394.i, label %if.end398.i

if.then394.i:                                     ; preds = %for.body381.i
  %SliceGroupConfigFileName395.i = getelementptr inbounds %struct.InputParameters, ptr %149, i64 0, i32 139
...
if.end398.i:                                      ; preds = %if.then394.i, %for.body381.i
  ...
  br i1 %exitcond.not.i, label %for.end402.i, label %for.body381.i
...
if.end408.i:                                      ; preds = %if.end405.i, %if.then281.i, %land.lhs.true264.i, %if.end262.i
  %153 = load ptr, ptr @input, align 8
  %ReferenceReorder.i = getelementptr inbounds %struct.InputParameters, ptr %153, i64 0, i32 72
  %154 = load i32, ptr %ReferenceReorder.i, align 8
  %tobool409.not.i = icmp eq i32 %154, 0
  br i1 %tobool409.not.i, label %if.end418.i, label %land.lhs.true410.i

land.lhs.true410.i:                               ; preds = %if.end408.i
  %PicInterlace411.i = getelementptr inbounds %struct.InputParameters, ptr %153, i64 0, i32 121
  %155 = load i32, ptr %PicInterlace411.i, align 8
  %tobool412.not.i = icmp eq i32 %155, 0
  br i1 %tobool412.not.i, label %lor.lhs.false413.i, label %if.then416.i

lor.lhs.false413.i:                               ; preds = %land.lhs.true410.i
  %MbInterlace414.i = getelementptr inbounds %struct.InputParameters, ptr %153, i64 0, i32 122
  %156 = load i32, ptr %MbInterlace414.i, align 4
  %tobool415.not.i = icmp eq i32 %156, 0
...
if.then416.i:                                     ; preds = %lor.lhs.false413.i, %land.lhs.true410.i
  ...
  %.pre911.i = load ptr, ptr @input, align 8
  br label %if.end418.i

if.end418.i:                                      ; preds = %if.then416.i, %lor.lhs.false413.i, %if.end408.i
  %157 = phi ptr [ %.pre911.i, %if.then416.i ], [ %153, %lor.lhs.false413.i ], [ %153, %if.end408.i ]
  %PocMemoryManagement.i = getelementptr inbounds %struct.InputParameters, ptr %157, i64 0, i32 73
  %158 = load i32, ptr %PocMemoryManagement.i, align 4
  %tobool419.not.i = icmp eq i32 %158, 0
  br i1 %tobool419.not.i, label %if.end428.i, label %land.lhs.true420.i

land.lhs.true420.i:                               ; preds = %if.end418.i
  %PicInterlace421.i = getelementptr inbounds %struct.InputParameters, ptr %157, i64 0, i32 121
  %159 = load i32, ptr %PicInterlace421.i, align 8
  %tobool422.not.i = icmp eq i32 %159, 0
  br i1 %tobool422.not.i, label %lor.lhs.false423.i, label %if.then426.i

lor.lhs.false423.i:                               ; preds = %land.lhs.true420.i
  %MbInterlace424.i = getelementptr inbounds %struct.InputParameters, ptr %157, i64 0, i32 122
  %160 = load i32, ptr %MbInterlace424.i, align 4
  %tobool425.not.i = icmp eq i32 %160, 0
...
if.then426.i:                                     ; preds = %lor.lhs.false423.i, %land.lhs.true420.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 400) #21
  %.pre912.i = load ptr, ptr @input, align 8
  br label %if.end428.i

if.end428.i:                                      ; preds = %if.then426.i, %lor.lhs.false423.i, %if.end418.i
  %161 = phi ptr [ %.pre912.i, %if.then426.i ], [ %157, %lor.lhs.false423.i ], [ %157, %if.end418.i ]
  %PicInterlace429.i = getelementptr inbounds %struct.InputParameters, ptr %161, i64 0, i32 121
  %162 = load i32, ptr %PicInterlace429.i, align 8
  %switch830.i = icmp ult i32 %162, 3
  br i1 %switch830.i, label %if.end443.i, label %if.then440.i

if.then440.i:                                     ; preds = %if.end428.i
  %call442.i = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.276, i32 noundef %162) #21
  call void @error(ptr noundef nonnull @errortext, i32 noundef 400) #21
  %.pre913.i = load ptr, ptr @input, align 8
  br label %if.end443.i

if.end443.i:                                      ; preds = %if.then440.i, %if.end428.i
  %163 = phi ptr [ %161, %if.end428.i ], [ %.pre913.i, %if.then440.i ]
  %MbInterlace444.i = getelementptr inbounds %struct.InputParameters, ptr %163, i64 0, i32 122
  %164 = load i32, ptr %MbInterlace444.i, align 4
  %switch831.i = icmp ult i32 %164, 4
  br i1 %switch831.i, label %if.end462.i, label %if.then459.i

if.then459.i:                                     ; preds = %if.end443.i
  %call461.i = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.277, i32 noundef %164) #21
  call void @error(ptr noundef nonnull @errortext, i32 noundef 400) #21
  %.pre914.i = load ptr, ptr @input, align 8
  br label %if.end462.i

if.end462.i:                                      ; preds = %if.then459.i, %if.end443.i
  %165 = phi ptr [ %163, %if.end443.i ], [ %.pre914.i, %if.then459.i ]
  %rdopt.i = getelementptr inbounds %struct.InputParameters, ptr %165, i64 0, i32 113
  %166 = load i32, ptr %rdopt.i, align 8
  %tobool463.not.i = icmp eq i32 %166, 0
  br i1 %tobool463.not.i, label %land.lhs.true464.i, label %if.end469.i

land.lhs.true464.i:                               ; preds = %if.end462.i
  %MbInterlace465.i = getelementptr inbounds %struct.InputParameters, ptr %165, i64 0, i32 122
  %167 = load i32, ptr %MbInterlace465.i, align 4
  %tobool466.not.i = icmp eq i32 %167, 0
...
if.then467.i:                                     ; preds = %land.lhs.true464.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre915.i = load ptr, ptr @input, align 8
  %rdopt470.phi.trans.insert.i = getelementptr inbounds %struct.InputParameters, ptr %.pre915.i, i64 0, i32 113
  %.pre916.i = load i32, ptr %rdopt470.phi.trans.insert.i, align 8
  br label %if.end469.i

if.end469.i:                                      ; preds = %if.then467.i, %if.end462.i
  %168 = phi i32 [ %.pre916.i, %if.then467.i ], [ %166, %if.end462.i ]
  %169 = phi ptr [ %.pre915.i, %if.then467.i ], [ %165, %if.end462.i ]
  %cmp471.i = icmp eq i32 %168, 2
  br i1 %cmp471.i, label %land.lhs.true473.i, label %if.end478.i

land.lhs.true473.i:                               ; preds = %if.end469.i
  %170 = load i32, ptr %169, align 8
  %cmp474.i = icmp sgt i32 %170, 99
...
if.then476.i:                                     ; preds = %land.lhs.true473.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre917.i = load ptr, ptr @input, align 8
  br label %if.end478.i

if.end478.i:                                      ; preds = %if.then476.i, %land.lhs.true473.i, %if.end469.i, %land.lhs.true464.i
  %171 = phi ptr [ %.pre917.i, %if.then476.i ], [ %169, %land.lhs.true473.i ], [ %169, %if.end469.i ], [ %165, %land.lhs.true464.i ]
  %MEErrorMetric.i = getelementptr inbounds %struct.InputParameters, ptr %171, i64 0, i32 199
  %arrayidx479.i = getelementptr inbounds %struct.InputParameters, ptr %171, i64 0, i32 199, i64 2
  %172 = load i32, ptr %arrayidx479.i, align 4
  %cmp480.i = icmp eq i32 %172, 2
  br i1 %cmp480.i, label %land.lhs.true482.i, label %if.end501.i

land.lhs.true482.i:                               ; preds = %if.end478.i
  %arrayidx484.i = getelementptr inbounds %struct.InputParameters, ptr %171, i64 0, i32 199, i64 1
  %173 = load i32, ptr %arrayidx484.i, align 4
  %cmp485.i = icmp eq i32 %173, 0
  br i1 %cmp485.i, label %land.lhs.true487.i, label %if.end501.i

land.lhs.true487.i:                               ; preds = %land.lhs.true482.i
  %174 = load i32, ptr %MEErrorMetric.i, align 4
  %cmp490.i = icmp eq i32 %174, 0
  br i1 %cmp490.i, label %land.lhs.true492.i, label %if.end501.i

land.lhs.true492.i:                               ; preds = %land.lhs.true487.i
  %SearchMode.i = getelementptr inbounds %struct.InputParameters, ptr %171, i64 0, i32 169
  %175 = load i32, ptr %SearchMode.i, align 4
  %176 = add i32 %175, -1
...
if.then499.i:                                     ; preds = %land.lhs.true492.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre918.i = load ptr, ptr @input, align 8
  br label %if.end501.i

if.end501.i:                                      ; preds = %if.then499.i, %land.lhs.true492.i, %land.lhs.true487.i, %land.lhs.true482.i, %if.end478.i
  %177 = phi ptr [ %.pre918.i, %if.then499.i ], [ %171, %land.lhs.true492.i ], [ %171, %land.lhs.true487.i ], [ %171, %land.lhs.true482.i ], [ %171, %if.end478.i ]
  %NumFramesInELSubSeq.i = getelementptr inbounds %struct.InputParameters, ptr %177, i64 0, i32 129
  %178 = load i32, ptr %NumFramesInELSubSeq.i, align 8
  %num_ref_frames502.i = getelementptr inbounds %struct.InputParameters, ptr %177, i64 0, i32 8
  %179 = load i32, ptr %num_ref_frames502.i, align 8
  %cmp503.not.i = icmp sge i32 %178, %179
  %cmp507.i = icmp slt i32 %178, 0
...
if.then509.i:                                     ; preds = %if.end501.i
  %call512.i = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.281, i32 noundef %178, i32 noundef %179) #21
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre919.i = load ptr, ptr @input, align 8
  %NumFramesInELSubSeq514.phi.trans.insert.i = getelementptr inbounds %struct.InputParameters, ptr %.pre919.i, i64 0, i32 129
  %.pre920.i = load i32, ptr %NumFramesInELSubSeq514.phi.trans.insert.i, align 8
  br label %if.end513.i

if.end513.i:                                      ; preds = %if.then509.i, %if.end501.i
  %180 = phi i32 [ %178, %if.end501.i ], [ %.pre920.i, %if.then509.i ]
  %181 = phi ptr [ %177, %if.end501.i ], [ %.pre919.i, %if.then509.i ]
  %cmp515.i = icmp sgt i32 %180, 0
  br i1 %cmp515.i, label %land.lhs.true517.i, label %if.end522.i

land.lhs.true517.i:                               ; preds = %if.end513.i
  %of_mode.i = getelementptr inbounds %struct.InputParameters, ptr %181, i64 0, i32 75
  %182 = load i32, ptr %of_mode.i, align 4
  %cmp518.i = icmp eq i32 %182, 0
...
if.then520.i:                                     ; preds = %land.lhs.true517.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre921.i = load ptr, ptr @input, align 8
  br label %if.end522.i

if.end522.i:                                      ; preds = %if.then520.i, %land.lhs.true517.i, %if.end513.i
  %183 = phi ptr [ %.pre921.i, %if.then520.i ], [ %181, %land.lhs.true517.i ], [ %181, %if.end513.i ]
  %PicInterlace523.i = getelementptr inbounds %struct.InputParameters, ptr %183, i64 0, i32 121
  %184 = load i32, ptr %PicInterlace523.i, align 8
  %tobool524.not.i = icmp eq i32 %184, 0
  br i1 %tobool524.not.i, label %lor.lhs.false525.i, label %land.lhs.true528.i

lor.lhs.false525.i:                               ; preds = %if.end522.i
  %MbInterlace526.i = getelementptr inbounds %struct.InputParameters, ptr %183, i64 0, i32 122
  %185 = load i32, ptr %MbInterlace526.i, align 4
  %tobool527.not.i = icmp eq i32 %185, 0
  br i1 %tobool527.not.i, label %if.end533.i, label %land.lhs.true528.i

land.lhs.true528.i:                               ; preds = %lor.lhs.false525.i, %if.end522.i
  %SparePictureOption.i = getelementptr inbounds %struct.InputParameters, ptr %183, i64 0, i32 136
  %186 = load i32, ptr %SparePictureOption.i, align 4
  %cmp529.i = icmp eq i32 %186, 1
...
if.then531.i:                                     ; preds = %land.lhs.true528.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre922.i = load ptr, ptr @input, align 8
  br label %if.end533.i

if.end533.i:                                      ; preds = %if.then531.i, %land.lhs.true528.i, %lor.lhs.false525.i
  %187 = phi ptr [ %.pre922.i, %if.then531.i ], [ %183, %land.lhs.true528.i ], [ %183, %lor.lhs.false525.i ]
  %of_mode534.i = getelementptr inbounds %struct.InputParameters, ptr %187, i64 0, i32 75
  %188 = load i32, ptr %of_mode534.i, align 4
  %cmp535.not.i = icmp eq i32 %188, 1
  br i1 %cmp535.not.i, label %if.end543.i, label %land.lhs.true537.i

land.lhs.true537.i:                               ; preds = %if.end533.i
  %SparePictureOption538.i = getelementptr inbounds %struct.InputParameters, ptr %187, i64 0, i32 136
  %189 = load i32, ptr %SparePictureOption538.i, align 4
  %cmp539.i = icmp eq i32 %189, 1
...
if.then541.i:                                     ; preds = %land.lhs.true537.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre923.i = load ptr, ptr @input, align 8
  br label %if.end543.i

if.end543.i:                                      ; preds = %if.then541.i, %land.lhs.true537.i, %if.end533.i
  %190 = phi ptr [ %.pre923.i, %if.then541.i ], [ %187, %land.lhs.true537.i ], [ %187, %if.end533.i ]
  %WeightedPrediction.i = getelementptr inbounds %struct.InputParameters, ptr %190, i64 0, i32 59
  %191 = load i32, ptr %WeightedPrediction.i, align 8
  %cmp544.i = icmp sgt i32 %191, 0
  br i1 %cmp544.i, label %land.lhs.true549.i, label %lor.lhs.false546.i

lor.lhs.false546.i:                               ; preds = %if.end543.i
  %WeightedBiprediction.i = getelementptr inbounds %struct.InputParameters, ptr %190, i64 0, i32 60
  %192 = load i32, ptr %WeightedBiprediction.i, align 4
  %cmp547.i = icmp sgt i32 %192, 0
  br i1 %cmp547.i, label %land.lhs.true549.i, label %if.end554.i

land.lhs.true549.i:                               ; preds = %lor.lhs.false546.i, %if.end543.i
  %MbInterlace550.i = getelementptr inbounds %struct.InputParameters, ptr %190, i64 0, i32 122
  %193 = load i32, ptr %MbInterlace550.i, align 4
  %tobool551.not.i = icmp eq i32 %193, 0
...
if.then552.i:                                     ; preds = %land.lhs.true549.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre924.i = load ptr, ptr @input, align 8
  br label %if.end554.i

if.end554.i:                                      ; preds = %if.then552.i, %land.lhs.true549.i, %lor.lhs.false546.i
  %194 = phi ptr [ %.pre924.i, %if.then552.i ], [ %190, %land.lhs.true549.i ], [ %190, %lor.lhs.false546.i ]
  %NumFramesInELSubSeq555.i = getelementptr inbounds %struct.InputParameters, ptr %194, i64 0, i32 129
  %195 = load i32, ptr %NumFramesInELSubSeq555.i, align 8
  %cmp556.i = icmp sgt i32 %195, 0
  br i1 %cmp556.i, label %land.lhs.true558.i, label %if.end564.i

land.lhs.true558.i:                               ; preds = %if.end554.i
  %WeightedPrediction559.i = getelementptr inbounds %struct.InputParameters, ptr %194, i64 0, i32 59
  %196 = load i32, ptr %WeightedPrediction559.i, align 8
  %cmp560.i = icmp sgt i32 %196, 0
...
if.then562.i:                                     ; preds = %land.lhs.true558.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre925.i = load ptr, ptr @input, align 8
  br label %if.end564.i

if.end564.i:                                      ; preds = %if.then562.i, %land.lhs.true558.i, %if.end554.i
  %197 = phi ptr [ %.pre925.i, %if.then562.i ], [ %194, %land.lhs.true558.i ], [ %194, %if.end554.i ]
  %num_slice_groups_minus1565.i = getelementptr inbounds %struct.InputParameters, ptr %197, i64 0, i32 140
  %198 = load i32, ptr %num_slice_groups_minus1565.i, align 8
  %cmp566.i = icmp sgt i32 %198, 0
  br i1 %cmp566.i, label %if.then568.i, label %if.end579.i

if.then568.i:                                     ; preds = %if.end564.i
  %slice_group_map_type569.i = getelementptr inbounds %struct.InputParameters, ptr %197, i64 0, i32 141
  %199 = load i32, ptr %slice_group_map_type569.i, align 4
  %200 = add i32 %199, -3
  %or.cond825.i = icmp ult i32 %200, 3
  br i1 %or.cond825.i, label %if.then576.i, label %if.end579.i

if.then576.i:                                     ; preds = %if.then568.i
  store i32 1, ptr %num_slice_groups_minus1565.i, align 8
  br label %if.end579.i

if.end579.i:                                      ; preds = %if.then576.i, %if.then568.i, %if.end564.i
  %RCEnable.i = getelementptr inbounds %struct.InputParameters, ptr %197, i64 0, i32 157
  %201 = load i32, ptr %RCEnable.i, align 4
  %tobool580.not.i = icmp eq i32 %201, 0
  br i1 %tobool580.not.i, label %if.end607.i, label %if.then581.i

if.then581.i:                                     ; preds = %if.end579.i
  %img_height582.i = getelementptr inbounds %struct.InputParameters, ptr %197, i64 0, i32 15
  %202 = load i32, ptr %img_height582.i, align 4
  %203 = load ptr, ptr @img, align 8
  %auto_crop_bottom583.i = getelementptr inbounds %struct.ImageParameters, ptr %203, i64 0, i32 167
  %204 = load i32, ptr %auto_crop_bottom583.i, align 4
  %add584.i = add nsw i32 %204, %202
  %img_width585.i = getelementptr inbounds %struct.InputParameters, ptr %197, i64 0, i32 14
  %205 = load i32, ptr %img_width585.i, align 8
  %auto_crop_right586.i = getelementptr inbounds %struct.ImageParameters, ptr %203, i64 0, i32 166
  %206 = load i32, ptr %auto_crop_right586.i, align 8
  %add587.i = add nsw i32 %206, %205
  %mul588.i = mul nsw i32 %add587.i, %add584.i
  %div589.i = sdiv i32 %mul588.i, 256
  %basicunit.i = getelementptr inbounds %struct.InputParameters, ptr %197, i64 0, i32 160
  %207 = load i32, ptr %basicunit.i, align 8
  %rem590.i = urem i32 %div589.i, %207
...
if.then593.i:                                     ; preds = %if.then581.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre926.i = load ptr, ptr @input, align 8
  br label %if.end595.i

if.end595.i:                                      ; preds = %if.then593.i, %if.then581.i
  %208 = phi ptr [ %.pre926.i, %if.then593.i ], [ %197, %if.then581.i ]
  %successive_Bframe596.i = getelementptr inbounds %struct.InputParameters, ptr %208, i64 0, i32 40
  %209 = load i32, ptr %successive_Bframe596.i, align 8
  %tobool597.not.i = icmp eq i32 %209, 0
  br i1 %tobool597.not.i, label %lor.lhs.false598.i, label %land.lhs.true601.i

lor.lhs.false598.i:                               ; preds = %if.end595.i
  %jumpd599.i = getelementptr inbounds %struct.InputParameters, ptr %208, i64 0, i32 5
  %210 = load i32, ptr %jumpd599.i, align 4
  %tobool600.not.i = icmp eq i32 %210, 0
  br i1 %tobool600.not.i, label %if.end607.i, label %land.lhs.true601.i

land.lhs.true601.i:                               ; preds = %lor.lhs.false598.i, %if.end595.i
  %RCUpdateMode.i = getelementptr inbounds %struct.InputParameters, ptr %208, i64 0, i32 162
  %211 = load i32, ptr %RCUpdateMode.i, align 8
  %cmp602.i = icmp eq i32 %211, 1
...
if.then604.i:                                     ; preds = %land.lhs.true601.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre927.i = load ptr, ptr @input, align 8
  br label %if.end607.i

if.end607.i:                                      ; preds = %if.then604.i, %land.lhs.true601.i, %lor.lhs.false598.i, %if.end579.i
  %212 = phi ptr [ %208, %lor.lhs.false598.i ], [ %208, %land.lhs.true601.i ], [ %.pre927.i, %if.then604.i ], [ %197, %if.end579.i ]
  %successive_Bframe608.i = getelementptr inbounds %struct.InputParameters, ptr %212, i64 0, i32 40
  %213 = load i32, ptr %successive_Bframe608.i, align 8
  %tobool609.not.i = icmp eq i32 %213, 0
  br i1 %tobool609.not.i, label %if.end621.i, label %land.lhs.true610.i

land.lhs.true610.i:                               ; preds = %if.end607.i
  %BRefPictures611.i = getelementptr inbounds %struct.InputParameters, ptr %212, i64 0, i32 68
  %214 = load i32, ptr %BRefPictures611.i, align 4
  %tobool612.not.i = icmp eq i32 %214, 0
  br i1 %tobool612.not.i, label %if.end621.i, label %land.lhs.true613.i

land.lhs.true613.i:                               ; preds = %land.lhs.true610.i
  %idr_enable.i = getelementptr inbounds %struct.InputParameters, ptr %212, i64 0, i32 32
  %215 = load i32, ptr %idr_enable.i, align 8
  %tobool614.not.i = icmp eq i32 %215, 0
  br i1 %tobool614.not.i, label %if.end621.i, label %land.lhs.true615.i

land.lhs.true615.i:                               ; preds = %land.lhs.true613.i
  %intra_period.i = getelementptr inbounds %struct.InputParameters, ptr %212, i64 0, i32 30
  %216 = load i32, ptr %intra_period.i, align 8
  %tobool616.not.i = icmp eq i32 %216, 0
  br i1 %tobool616.not.i, label %if.end621.i, label %land.lhs.true617.i

land.lhs.true617.i:                               ; preds = %land.lhs.true615.i
  %pic_order_cnt_type.i = getelementptr inbounds %struct.InputParameters, ptr %212, i64 0, i32 150
  %217 = load i32, ptr %pic_order_cnt_type.i, align 8
  %cmp618.not.i = icmp eq i32 %217, 0
...
if.then620.i:                                     ; preds = %land.lhs.true617.i
  ...
  %.pre928.i = load ptr, ptr @input, align 8
...
if.end621.i:                                      ; preds = %if.then620.i, %land.lhs.true617.i, %land.lhs.true615.i, %land.lhs.true613.i, %land.lhs.true610.i, %if.end607.i
  %218 = phi ptr [ %.pre928.i, %if.then620.i ], [ %212, %land.lhs.true617.i ], [ %212, %land.lhs.true615.i ], [ %212, %land.lhs.true613.i ], [ %212, %land.lhs.true610.i ], [ %212, %if.end607.i ]
  %direct_spatial_mv_pred_flag622.i = getelementptr inbounds %struct.InputParameters, ptr %218, i64 0, i32 44
  %219 = load i32, ptr %direct_spatial_mv_pred_flag622.i, align 8
  %tobool623.not.i = icmp eq i32 %219, 0
  br i1 %tobool623.not.i, label %land.lhs.true624.i, label %if.end633.i

land.lhs.true624.i:                               ; preds = %if.end621.i
  %num_ref_frames625.i = getelementptr inbounds %struct.InputParameters, ptr %218, i64 0, i32 8
  %220 = load i32, ptr %num_ref_frames625.i, align 8
  %cmp626.i = icmp slt i32 %220, 2
  br i1 %cmp626.i, label %land.lhs.true628.i, label %if.end633.i

land.lhs.true628.i:                               ; preds = %land.lhs.true624.i
  %successive_Bframe629.i = getelementptr inbounds %struct.InputParameters, ptr %218, i64 0, i32 40
  %221 = load i32, ptr %successive_Bframe629.i, align 8
  %cmp630.i = icmp sgt i32 %221, 0
...
if.then632.i:                                     ; preds = %land.lhs.true628.i
  ...
  %.pre929.i = load ptr, ptr @input, align 8
  br label %if.end633.i

if.end633.i:                                      ; preds = %if.then632.i, %land.lhs.true628.i, %land.lhs.true624.i, %if.end621.i
  %222 = phi ptr [ %.pre929.i, %if.then632.i ], [ %218, %land.lhs.true628.i ], [ %218, %land.lhs.true624.i ], [ %218, %if.end621.i ]
  %Transform8x8Mode.i = getelementptr inbounds %struct.InputParameters, ptr %222, i64 0, i32 153
  %223 = load i32, ptr %Transform8x8Mode.i, align 4
  %tobool634.not.i = icmp eq i32 %223, 0
  br i1 %tobool634.not.i, label %if.end652.i, label %land.lhs.true635.i

land.lhs.true635.i:                               ; preds = %if.end633.i
  %sp_periodicity.i = getelementptr inbounds %struct.InputParameters, ptr %222, i64 0, i32 50
  %224 = load i32, ptr %sp_periodicity.i, align 8
  %tobool636.not.i = icmp eq i32 %224, 0
...
if.end639.i:                                      ; preds = %land.lhs.true635.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre930.i = load ptr, ptr @input, align 8
  %Transform8x8Mode640.phi.trans.insert.i = getelementptr inbounds %struct.InputParameters, ptr %.pre930.i, i64 0, i32 153
  %.pre931.i = load i32, ptr %Transform8x8Mode640.phi.trans.insert.i, align 4
  %tobool641.not.i = icmp eq i32 %.pre931.i, 0
  br i1 %tobool641.not.i, label %if.end652.i, label %land.lhs.true642.i

land.lhs.true642.i:                               ; preds = %if.end639.i, %land.lhs.true635.i
  %225 = phi ptr [ %.pre930.i, %if.end639.i ], [ %222, %land.lhs.true635.i ]
  %226 = load i32, ptr %225, align 8
  %227 = add i32 %226, -145
  %or.cond826.i = icmp ult i32 %227, -45
...
if.then650.i:                                     ; preds = %land.lhs.true642.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre932.i = load ptr, ptr @input, align 8
  br label %if.end652.i

if.end652.i:                                      ; preds = %if.then650.i, %land.lhs.true642.i, %if.end639.i, %if.end633.i
  %228 = phi ptr [ %225, %land.lhs.true642.i ], [ %.pre932.i, %if.then650.i ], [ %.pre930.i, %if.end639.i ], [ %222, %if.end633.i ]
  %ScalingMatrixPresentFlag.i = getelementptr inbounds %struct.InputParameters, ptr %228, i64 0, i32 167
  %229 = load i32, ptr %ScalingMatrixPresentFlag.i, align 8
  %tobool653.not.i = icmp eq i32 %229, 0
...
land.lhs.true654.i:                               ; preds = %if.end652.i
  ...
  %231 = add i32 %230, -145
  %or.cond827.i = icmp ult i32 %231, -45
...
if.then662.i:                                     ; preds = %land.lhs.true654.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre933.i = load ptr, ptr @input, align 8
  br label %if.end664.i

if.end664.i:                                      ; preds = %if.then662.i, %land.lhs.true654.i, %if.end652.i
  %232 = phi ptr [ %228, %land.lhs.true654.i ], [ %.pre933.i, %if.then662.i ], [ %228, %if.end652.i ]
  %yuv_format.i = getelementptr inbounds %struct.InputParameters, ptr %232, i64 0, i32 16
  %233 = load i32, ptr %yuv_format.i, align 8
  %cmp665.i = icmp eq i32 %233, 2
...
if.then671.i:                                     ; preds = %land.lhs.true667.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre934.i = load ptr, ptr @input, align 8
  %yuv_format674.phi.trans.insert.i = getelementptr inbounds %struct.InputParameters, ptr %.pre934.i, i64 0, i32 16
  %.pre935.i = load i32, ptr %yuv_format674.phi.trans.insert.i, align 8
  br label %if.end673.i

if.end673.i:                                      ; preds = %if.then671.i, %if.end664.i
  %235 = phi i32 [ %.pre935.i, %if.then671.i ], [ %233, %if.end664.i ]
  %236 = phi ptr [ %.pre934.i, %if.then671.i ], [ %232, %if.end664.i ]
  %cmp675.i = icmp eq i32 %235, 3
  br i1 %cmp675.i, label %land.lhs.true677.i, label %if.end683.i

land.lhs.true677.i:                               ; preds = %if.end673.i
  %237 = load i32, ptr %236, align 8
  %cmp679.i = icmp slt i32 %237, 144
...
if.then681.i:                                     ; preds = %land.lhs.true677.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre936.i = load ptr, ptr @input, align 8
  br label %if.end683.i

if.end683.i:                                      ; preds = %if.then681.i, %land.lhs.true677.i, %if.end673.i, %land.lhs.true667.i
  %238 = phi ptr [ %.pre936.i, %if.then681.i ], [ %236, %land.lhs.true677.i ], [ %236, %if.end673.i ], [ %232, %land.lhs.true667.i ]
  %successive_Bframe684.i = getelementptr inbounds %struct.InputParameters, ptr %238, i64 0, i32 40
  %239 = load i32, ptr %successive_Bframe684.i, align 8
  %tobool685.not.i = icmp eq i32 %239, 0
  br i1 %tobool685.not.i, label %if.end693.i, label %land.lhs.true686.i

land.lhs.true686.i:                               ; preds = %if.end683.i
  %BiPredMotionEstimation.i = getelementptr inbounds %struct.InputParameters, ptr %238, i64 0, i32 46
  %240 = load i32, ptr %BiPredMotionEstimation.i, align 8
  %tobool687.not.i = icmp eq i32 %240, 0
  br i1 %tobool687.not.i, label %if.end693.i, label %land.lhs.true688.i

land.lhs.true688.i:                               ; preds = %land.lhs.true686.i
  %search_range.i = getelementptr inbounds %struct.InputParameters, ptr %238, i64 0, i32 7
  %241 = load i32, ptr %search_range.i, align 4
  %BiPredMESearchRange.i = getelementptr inbounds %struct.InputParameters, ptr %238, i64 0, i32 48
  %242 = load i32, ptr %BiPredMESearchRange.i, align 8
  %cmp689.i = icmp slt i32 %241, %242
...
if.then691.i:                                     ; preds = %land.lhs.true688.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre937.i = load ptr, ptr @input, align 8
  br label %if.end693.i

if.end693.i:                                      ; preds = %if.then691.i, %land.lhs.true688.i, %land.lhs.true686.i, %if.end683.i
  %243 = phi ptr [ %.pre937.i, %if.then691.i ], [ %238, %land.lhs.true688.i ], [ %238, %land.lhs.true686.i ], [ %238, %if.end683.i ]
  %ChromaMEEnable.i = getelementptr inbounds %struct.InputParameters, ptr %243, i64 0, i32 198
  %244 = load i32, ptr %ChromaMEEnable.i, align 8
  %tobool694.not.i = icmp eq i32 %244, 0
  br i1 %tobool694.not.i, label %if.end709.i, label %land.lhs.true695.i

land.lhs.true695.i:                               ; preds = %if.end693.i
  %ChromaMCBuffer.i = getelementptr inbounds %struct.InputParameters, ptr %243, i64 0, i32 197
  %245 = load i32, ptr %ChromaMCBuffer.i, align 4
  %tobool696.not.i = icmp eq i32 %245, 0
...
if.end699.i:                                      ; preds = %land.lhs.true695.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre938.i = load ptr, ptr @input, align 8
  %ChromaMEEnable700.phi.trans.insert.i = getelementptr inbounds %struct.InputParameters, ptr %.pre938.i, i64 0, i32 198
  %.pre939.i = load i32, ptr %ChromaMEEnable700.phi.trans.insert.i, align 8
  %tobool701.not.i = icmp eq i32 %.pre939.i, 0
  br i1 %tobool701.not.i, label %if.end709.i, label %land.lhs.true702.i

land.lhs.true702.i:                               ; preds = %land.lhs.true695.i, %if.end699.i
  %246 = phi ptr [ %.pre938.i, %if.end699.i ], [ %243, %land.lhs.true695.i ]
  %yuv_format703.i = getelementptr inbounds %struct.InputParameters, ptr %246, i64 0, i32 16
  %247 = load i32, ptr %yuv_format703.i, align 8
  %cmp704.i = icmp eq i32 %247, 0
  br i1 %cmp704.i, label %if.then706.i, label %if.end709.i

if.then706.i:                                     ; preds = %land.lhs.true702.i
  %ChromaMEEnable700966.i = getelementptr inbounds %struct.InputParameters, ptr %246, i64 0, i32 198
  ...
  store i32 0, ptr %ChromaMEEnable700966.i, align 8
  br label %if.end709.i

if.end709.i:                                      ; preds = %if.then706.i, %land.lhs.true702.i, %if.end699.i, %if.end693.i
  %248 = phi ptr [ %246, %if.then706.i ], [ %246, %land.lhs.true702.i ], [ %.pre938.i, %if.end699.i ], [ %243, %if.end693.i ]
  %EnableOpenGOP.i = getelementptr inbounds %struct.InputParameters, ptr %248, i64 0, i32 31
  %249 = load i32, ptr %EnableOpenGOP.i, align 4
  %tobool710.not.i = icmp eq i32 %249, 0
  br i1 %tobool710.not.i, label %if.end721.i, label %land.lhs.true711.i

land.lhs.true711.i:                               ; preds = %if.end709.i
  %PicInterlace712.i = getelementptr inbounds %struct.InputParameters, ptr %248, i64 0, i32 121
  %250 = load i32, ptr %PicInterlace712.i, align 8
  %tobool713.not.i = icmp eq i32 %250, 0
...
if.end716.i:                                      ; preds = %land.lhs.true711.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre940.i = load ptr, ptr @input, align 8
  %EnableOpenGOP717.phi.trans.insert.i = getelementptr inbounds %struct.InputParameters, ptr %.pre940.i, i64 0, i32 31
  %.pre941.i = load i32, ptr %EnableOpenGOP717.phi.trans.insert.i, align 4
  %tobool718.not.i = icmp eq i32 %.pre941.i, 0
  br i1 %tobool718.not.i, label %if.end721.i, label %if.then719.i

if.then719.i:                                     ; preds = %if.end716.i, %land.lhs.true711.i
  %251 = phi ptr [ %.pre940.i, %if.end716.i ], [ %248, %land.lhs.true711.i ]
  %ReferenceReorder720.i = getelementptr inbounds %struct.InputParameters, ptr %251, i64 0, i32 72
  store i32 1, ptr %ReferenceReorder720.i, align 8
  br label %if.end721.i

if.end721.i:                                      ; preds = %if.then719.i, %if.end716.i, %if.end709.i
  %252 = phi ptr [ %251, %if.then719.i ], [ %.pre940.i, %if.end716.i ], [ %248, %if.end709.i ]
  %redundant_pic_flag.i = getelementptr inbounds %struct.InputParameters, ptr %252, i64 0, i32 149
  %253 = load i32, ptr %redundant_pic_flag.i, align 4
  %tobool722.not.i = icmp eq i32 %253, 0
  br i1 %tobool722.not.i, label %if.end754.i, label %if.then723.i

if.then723.i:                                     ; preds = %if.end721.i
  %PicInterlace724.i = getelementptr inbounds %struct.InputParameters, ptr %252, i64 0, i32 121
  %254 = load i32, ptr %PicInterlace724.i, align 8
  %tobool725.not.i = icmp eq i32 %254, 0
  br i1 %tobool725.not.i, label %lor.lhs.false726.i, label %if.then729.i

lor.lhs.false726.i:                               ; preds = %if.then723.i
  %MbInterlace727.i = getelementptr inbounds %struct.InputParameters, ptr %252, i64 0, i32 122
  %255 = load i32, ptr %MbInterlace727.i, align 4
  %tobool728.not.i = icmp eq i32 %255, 0
...
if.then729.i:                                     ; preds = %lor.lhs.false726.i, %if.then723.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre942.i = load ptr, ptr @input, align 8
  br label %if.end731.i

if.end731.i:                                      ; preds = %if.then729.i, %lor.lhs.false726.i
  %256 = phi ptr [ %.pre942.i, %if.then729.i ], [ %252, %lor.lhs.false726.i ]
  %RDPictureDecision.i = getelementptr inbounds %struct.InputParameters, ptr %256, i64 0, i32 62
  %257 = load i32, ptr %RDPictureDecision.i, align 4
  %tobool732.not.i = icmp eq i32 %257, 0
...
if.then733.i:                                     ; preds = %if.end731.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre943.i = load ptr, ptr @input, align 8
  br label %if.end735.i

if.end735.i:                                      ; preds = %if.then733.i, %if.end731.i
  %258 = phi ptr [ %.pre943.i, %if.then733.i ], [ %256, %if.end731.i ]
  %successive_Bframe736.i = getelementptr inbounds %struct.InputParameters, ptr %258, i64 0, i32 40
  %259 = load i32, ptr %successive_Bframe736.i, align 8
  %tobool737.not.i = icmp eq i32 %259, 0
...
if.then738.i:                                     ; preds = %if.end735.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre944.i = load ptr, ptr @input, align 8
  br label %if.end740.i

if.end740.i:                                      ; preds = %if.then738.i, %if.end735.i
  %260 = phi ptr [ %.pre944.i, %if.then738.i ], [ %258, %if.end735.i ]
  %PrimaryGOPLength.i = getelementptr inbounds %struct.InputParameters, ptr %260, i64 0, i32 195
  %261 = load i32, ptr %PrimaryGOPLength.i, align 4
  %NumRedundantHierarchy.i = getelementptr inbounds %struct.InputParameters, ptr %260, i64 0, i32 194
  %262 = load i32, ptr %NumRedundantHierarchy.i, align 8
  %shl741.i = shl nuw i32 1, %262
  %cmp742.i = icmp slt i32 %261, %shl741.i
...
if.then744.i:                                     ; preds = %if.end740.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre945.i = load ptr, ptr @input, align 8
  %PrimaryGOPLength748.phi.trans.insert.i = getelementptr inbounds %struct.InputParameters, ptr %.pre945.i, i64 0, i32 195
  %.pre946.i = load i32, ptr %PrimaryGOPLength748.phi.trans.insert.i, align 4
  br label %if.end746.i

if.end746.i:                                      ; preds = %if.then744.i, %if.end740.i
  %263 = phi i32 [ %.pre946.i, %if.then744.i ], [ %261, %if.end740.i ]
  %264 = phi ptr [ %.pre945.i, %if.then744.i ], [ %260, %if.end740.i ]
  %num_ref_frames747.i = getelementptr inbounds %struct.InputParameters, ptr %264, i64 0, i32 8
  %265 = load i32, ptr %num_ref_frames747.i, align 8
  %cmp749.i = icmp slt i32 %265, %263
...
if.then751.i:                                     ; preds = %if.end746.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre947.i = load ptr, ptr @input, align 8
  br label %if.end754.i

if.end754.i:                                      ; preds = %if.then751.i, %if.end746.i, %if.end721.i
  %266 = phi ptr [ %264, %if.end746.i ], [ %.pre947.i, %if.then751.i ], [ %252, %if.end721.i ]
  %num_ref_frames755.i = getelementptr inbounds %struct.InputParameters, ptr %266, i64 0, i32 8
  %267 = load i32, ptr %num_ref_frames755.i, align 8
  %cmp756.i = icmp eq i32 %267, 1
  br i1 %cmp756.i, label %land.lhs.true758.i, label %if.end765.i

land.lhs.true758.i:                               ; preds = %if.end754.i
  %successive_Bframe759.i = getelementptr inbounds %struct.InputParameters, ptr %266, i64 0, i32 40
  %268 = load i32, ptr %successive_Bframe759.i, align 8
  %tobool760.not.i = icmp eq i32 %268, 0
...
if.then761.i:                                     ; preds = %land.lhs.true758.i
  ...
  %270 = call i64 @fwrite(ptr nonnull @.str.305, i64 82, i64 1, ptr %269) #18
  %271 = load ptr, ptr @stderr, align 8
  %272 = call i64 @fwrite(ptr nonnull @.str.306, i64 55, i64 1, ptr %271) #18
  %273 = load ptr, ptr @stderr, align 8
  %274 = call i64 @fwrite(ptr nonnull @.str.307, i64 65, i64 1, ptr %273) #18
  %.pre948.i = load ptr, ptr @input, align 8
  br label %if.end765.i

if.end765.i:                                      ; preds = %if.then761.i, %land.lhs.true758.i, %if.end754.i
  %275 = phi ptr [ %.pre948.i, %if.then761.i ], [ %266, %land.lhs.true758.i ], [ %266, %if.end754.i ]
  %HierarchicalCoding.i = getelementptr inbounds %struct.InputParameters, ptr %275, i64 0, i32 69
  %276 = load i32, ptr %HierarchicalCoding.i, align 8
  %tobool766.not.i = icmp eq i32 %276, 0
  br i1 %tobool766.not.i, label %lor.lhs.false767.i, label %land.lhs.true770.i

lor.lhs.false767.i:                               ; preds = %if.end765.i
  %BRefPictures768.i = getelementptr inbounds %struct.InputParameters, ptr %275, i64 0, i32 68
  %277 = load i32, ptr %BRefPictures768.i, align 4
  %tobool769.not.i = icmp eq i32 %277, 0
  br i1 %tobool769.not.i, label %if.end777.i, label %land.lhs.true770.i

land.lhs.true770.i:                               ; preds = %lor.lhs.false767.i, %if.end765.i
  %successive_Bframe771.i = getelementptr inbounds %struct.InputParameters, ptr %275, i64 0, i32 40
  %278 = load i32, ptr %successive_Bframe771.i, align 8
  %tobool772.not.i = icmp eq i32 %278, 0
...
if.then773.i:                                     ; preds = %land.lhs.true770.i
  ...
  %280 = call i64 @fwrite(ptr nonnull @.str.308, i64 59, i64 1, ptr %279) #18
  %281 = load ptr, ptr @stderr, align 8
  %282 = call i64 @fwrite(ptr nonnull @.str.309, i64 61, i64 1, ptr %281) #18
  %283 = load ptr, ptr @stderr, align 8
  %284 = call i64 @fwrite(ptr nonnull @.str.310, i64 58, i64 1, ptr %283) #18
  %.pre949.i = load ptr, ptr @input, align 8
  br label %if.end777.i

if.end777.i:                                      ; preds = %if.then773.i, %land.lhs.true770.i, %lor.lhs.false767.i
  %285 = phi ptr [ %.pre949.i, %if.then773.i ], [ %275, %land.lhs.true770.i ], [ %275, %lor.lhs.false767.i ]
  %286 = load i32, ptr %285, align 8
  switch i32 %286, label %if.then.i848.i [
...
if.then.i848.i:                                   ; preds = %if.end777.i
  %call.i849.i = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.315, i32 noundef 100, i32 noundef 144) #21
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre.i850.i = load ptr, ptr @input, align 8
  br label %if.end.i.i

if.end.i.i:                                       ; preds = %if.then.i848.i, %if.end777.i, %if.end777.i, %if.end777.i, %if.end777.i, %if.end777.i, %if.end777.i, %if.end777.i
  %287 = phi ptr [ %285, %if.end777.i ], [ %285, %if.end777.i ], [ %285, %if.end777.i ], [ %285, %if.end777.i ], [ %285, %if.end777.i ], [ %285, %if.end777.i ], [ %285, %if.end777.i ], [ %.pre.i850.i, %if.then.i848.i ]
  %partition_mode.i.i = getelementptr inbounds %struct.InputParameters, ptr %287, i64 0, i32 76
  %288 = load i32, ptr %partition_mode.i.i, align 8
  %tobool.not.i.i = icmp eq i32 %288, 0
  br i1 %tobool.not.i.i, label %if.end22.i.i, label %land.lhs.true18.i.i

land.lhs.true18.i.i:                              ; preds = %if.end.i.i
  %symbol_mode.i.i = getelementptr inbounds %struct.InputParameters, ptr %287, i64 0, i32 74
  %289 = load i32, ptr %symbol_mode.i.i, align 8
  %cmp19.i.i = icmp eq i32 %289, 1
...
if.then20.i.i:                                    ; preds = %land.lhs.true18.i.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre103.i.i = load ptr, ptr @input, align 8
  br label %if.end22.i.i

if.end22.i.i:                                     ; preds = %if.then20.i.i, %land.lhs.true18.i.i, %if.end.i.i
  %290 = phi ptr [ %.pre103.i.i, %if.then20.i.i ], [ %287, %land.lhs.true18.i.i ], [ %287, %if.end.i.i ]
  %redundant_pic_flag.i.i = getelementptr inbounds %struct.InputParameters, ptr %290, i64 0, i32 149
  %291 = load i32, ptr %redundant_pic_flag.i.i, align 4
  %tobool23.not.i.i = icmp eq i32 %291, 0
...
if.then24.i.i:                                    ; preds = %if.end22.i.i
  ...
  %cmp26.not.i.i = icmp eq i32 %292, 66
...
if.then27.i.i:                                    ; preds = %if.then24.i.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre104.i.i = load ptr, ptr @input, align 8
  br label %if.end30.i.i

if.end30.i.i:                                     ; preds = %if.then27.i.i, %if.then24.i.i, %if.end22.i.i
  %293 = phi ptr [ %290, %if.then24.i.i ], [ %.pre104.i.i, %if.then27.i.i ], [ %290, %if.end22.i.i ]
  %partition_mode31.i.i = getelementptr inbounds %struct.InputParameters, ptr %293, i64 0, i32 76
  %294 = load i32, ptr %partition_mode31.i.i, align 8
  %tobool32.not.i.i = icmp eq i32 %294, 0
...
if.then33.i.i:                                    ; preds = %if.end30.i.i
  ...
  %cmp35.not.i.i = icmp eq i32 %295, 88
...
if.then36.i.i:                                    ; preds = %if.then33.i.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre105.i.i = load ptr, ptr @input, align 8
  br label %if.end39.i.i

if.end39.i.i:                                     ; preds = %if.then36.i.i, %if.then33.i.i, %if.end30.i.i
  %296 = phi ptr [ %293, %if.then33.i.i ], [ %.pre105.i.i, %if.then36.i.i ], [ %293, %if.end30.i.i ]
  %ChromaIntraDisable.i.i = getelementptr inbounds %struct.InputParameters, ptr %296, i64 0, i32 90
  %297 = load i32, ptr %ChromaIntraDisable.i.i, align 8
  %tobool40.not.i.i = icmp eq i32 %297, 0
  br i1 %tobool40.not.i.i, label %if.end48.i.i, label %land.lhs.true41.i.i

land.lhs.true41.i.i:                              ; preds = %if.end39.i.i
  %FastCrIntraDecision.i.i = getelementptr inbounds %struct.InputParameters, ptr %296, i64 0, i32 115
  %298 = load i32, ptr %FastCrIntraDecision.i.i, align 8
  %tobool42.not.i.i = icmp eq i32 %298, 0
...
if.then43.i.i:                                    ; preds = %land.lhs.true41.i.i
  ...
  %300 = call i64 @fwrite(ptr nonnull @.str.319, i64 84, i64 1, ptr %299) #18
  %301 = load ptr, ptr @stderr, align 8
  %302 = call i64 @fwrite(ptr nonnull @.str.320, i64 117, i64 1, ptr %301) #18
  %303 = load ptr, ptr @stderr, align 8
  %304 = call i64 @fwrite(ptr nonnull @.str.319, i64 84, i64 1, ptr %303) #18
  %305 = load ptr, ptr @input, align 8
  %FastCrIntraDecision47.i.i = getelementptr inbounds %struct.InputParameters, ptr %305, i64 0, i32 115
  store i32 0, ptr %FastCrIntraDecision47.i.i, align 8
  br label %if.end48.i.i

if.end48.i.i:                                     ; preds = %if.then43.i.i, %land.lhs.true41.i.i, %if.end39.i.i
  %306 = phi ptr [ %305, %if.then43.i.i ], [ %296, %land.lhs.true41.i.i ], [ %296, %if.end39.i.i ]
  %307 = load i32, ptr %306, align 8
  %cmp50.i.i = icmp eq i32 %307, 66
  br i1 %cmp50.i.i, label %if.then51.i.i, label %if.end76.i.i

if.then51.i.i:                                    ; preds = %if.end48.i.i
  %successive_Bframe.i.i = getelementptr inbounds %struct.InputParameters, ptr %306, i64 0, i32 40
  %308 = load i32, ptr %successive_Bframe.i.i, align 8
  %tobool52.not.i.i = icmp eq i32 %308, 0
  br i1 %tobool52.not.i.i, label %lor.lhs.false.i.i, label %land.lhs.true54.i.i

lor.lhs.false.i.i:                                ; preds = %if.then51.i.i
  %BRefPictures.i.i = getelementptr inbounds %struct.InputParameters, ptr %306, i64 0, i32 68
  %309 = load i32, ptr %BRefPictures.i.i, align 4
  %cmp53.i.i = icmp eq i32 %309, 2
  br i1 %cmp53.i.i, label %land.lhs.true54.i.i, label %if.end58.i.i

land.lhs.true54.i.i:                              ; preds = %lor.lhs.false.i.i, %if.then51.i.i
  %PReplaceBSlice.i.i = getelementptr inbounds %struct.InputParameters, ptr %306, i64 0, i32 41
  %310 = load i32, ptr %PReplaceBSlice.i.i, align 4
  %cmp55.i847.i = icmp eq i32 %310, 0
  br i1 %cmp55.i847.i, label %if.then56.i.i, label %if.end58.i.i
...
if.then56.i.i:                                    ; preds = %land.lhs.true54.i.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre106.i.i = load ptr, ptr @input, align 8
  br label %if.end58.i.i

if.end58.i.i:                                     ; preds = %if.then56.i.i, %land.lhs.true54.i.i, %lor.lhs.false.i.i
  %311 = phi ptr [ %.pre106.i.i, %if.then56.i.i ], [ %306, %land.lhs.true54.i.i ], [ %306, %lor.lhs.false.i.i ]
  %sp_periodicity.i.i = getelementptr inbounds %struct.InputParameters, ptr %311, i64 0, i32 50
  %312 = load i32, ptr %sp_periodicity.i.i, align 8
  %tobool59.not.i.i = icmp eq i32 %312, 0
...
if.then60.i.i:                                    ; preds = %if.end58.i.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre107.i.i = load ptr, ptr @input, align 8
  br label %if.end62.i.i

if.end62.i.i:                                     ; preds = %if.then60.i.i, %if.end58.i.i
  %313 = phi ptr [ %.pre107.i.i, %if.then60.i.i ], [ %311, %if.end58.i.i ]
  %WeightedPrediction.i.i = getelementptr inbounds %struct.InputParameters, ptr %313, i64 0, i32 59
  %314 = load i32, ptr %WeightedPrediction.i.i, align 8
  %tobool63.not.i.i = icmp eq i32 %314, 0
...
if.then64.i.i:                                    ; preds = %if.end62.i.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre108.i.i = load ptr, ptr @input, align 8
  br label %if.end66.i.i

if.end66.i.i:                                     ; preds = %if.then64.i.i, %if.end62.i.i
  %315 = phi ptr [ %.pre108.i.i, %if.then64.i.i ], [ %313, %if.end62.i.i ]
  %WeightedBiprediction.i.i = getelementptr inbounds %struct.InputParameters, ptr %315, i64 0, i32 60
  %316 = load i32, ptr %WeightedBiprediction.i.i, align 4
  %tobool67.not.i.i = icmp eq i32 %316, 0
  br i1 %tobool67.not.i.i, label %if.end70.i.i, label %if.then68.i.i

if.then68.i.i:                                    ; preds = %if.end66.i.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(48) @errortext, ptr noundef nonnull align 1 dereferenceable(48) @.str.323, i64 48, i1 false)
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre109.i.i = load ptr, ptr @input, align 8
  br label %if.end70.i.i

if.end70.i.i:                                     ; preds = %if.then68.i.i, %if.end66.i.i
  %317 = phi ptr [ %.pre109.i.i, %if.then68.i.i ], [ %315, %if.end66.i.i ]
  %symbol_mode71.i.i = getelementptr inbounds %struct.InputParameters, ptr %317, i64 0, i32 74
  %318 = load i32, ptr %symbol_mode71.i.i, align 8
  %cmp72.i.i = icmp eq i32 %318, 1
...
if.then73.i.i:                                    ; preds = %if.end70.i.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre110.i.i = load ptr, ptr @input, align 8
  br label %if.end76thread-pre-split.i.i

if.end76thread-pre-split.i.i:                     ; preds = %if.then73.i.i, %if.end70.i.i
  %.ph.i.i = phi ptr [ %.pre110.i.i, %if.then73.i.i ], [ %317, %if.end70.i.i ]
  %.pr.i.i = load i32, ptr %.ph.i.i, align 8
  br label %if.end76.i.i

if.end76.i.i:                                     ; preds = %if.end76thread-pre-split.i.i, %if.end48.i.i
  %319 = phi i32 [ %.pr.i.i, %if.end76thread-pre-split.i.i ], [ %307, %if.end48.i.i ]
  %320 = phi ptr [ %.ph.i.i, %if.end76thread-pre-split.i.i ], [ %306, %if.end48.i.i ]
  %cmp78.i.i = icmp eq i32 %319, 77
  br i1 %cmp78.i.i, label %if.then79.i.i, label %if.end89.i.i

if.then79.i.i:                                    ; preds = %if.end76.i.i
  %sp_periodicity80.i.i = getelementptr inbounds %struct.InputParameters, ptr %320, i64 0, i32 50
  %321 = load i32, ptr %sp_periodicity80.i.i, align 8
  %tobool81.not.i.i = icmp eq i32 %321, 0
...
if.then82.i.i:                                    ; preds = %if.then79.i.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre111.i.i = load ptr, ptr @input, align 8
  br label %if.end84.i.i

if.end84.i.i:                                     ; preds = %if.then82.i.i, %if.then79.i.i
  %322 = phi ptr [ %.pre111.i.i, %if.then82.i.i ], [ %320, %if.then79.i.i ]
  %num_slice_groups_minus1.i.i = getelementptr inbounds %struct.InputParameters, ptr %322, i64 0, i32 140
  %323 = load i32, ptr %num_slice_groups_minus1.i.i, align 8
  %tobool85.not.i.i = icmp eq i32 %323, 0
...
if.then86.i.i:                                    ; preds = %if.end84.i.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre112.i.i = load ptr, ptr @input, align 8
  br label %if.end89.i.i

if.end89.i.i:                                     ; preds = %if.then86.i.i, %if.end84.i.i, %if.end76.i.i
  %324 = phi ptr [ %322, %if.end84.i.i ], [ %.pre112.i.i, %if.then86.i.i ], [ %320, %if.end76.i.i ]
  %325 = load i32, ptr %324, align 8
  %cmp91.i846.i = icmp eq i32 %325, 88
  br i1 %cmp91.i846.i, label %if.then92.i.i, label %ProfileCheck.exit.i

if.then92.i.i:                                    ; preds = %if.end89.i.i
  %directInferenceFlag.i.i = getelementptr inbounds %struct.InputParameters, ptr %324, i64 0, i32 45
  %326 = load i32, ptr %directInferenceFlag.i.i, align 4
  %tobool93.not.i.i = icmp eq i32 %326, 0
...
if.then94.i.i:                                    ; preds = %if.then92.i.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre113.i.i = load ptr, ptr @input, align 8
  br label %if.end96.i.i

if.end96.i.i:                                     ; preds = %if.then94.i.i, %if.then92.i.i
  %327 = phi ptr [ %.pre113.i.i, %if.then94.i.i ], [ %324, %if.then92.i.i ]
  %symbol_mode97.i.i = getelementptr inbounds %struct.InputParameters, ptr %327, i64 0, i32 74
  %328 = load i32, ptr %symbol_mode97.i.i, align 8
  %cmp98.i.i = icmp eq i32 %328, 1
...
if.then99.i.i:                                    ; preds = %if.end96.i.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre950.i = load ptr, ptr @input, align 8
  br label %ProfileCheck.exit.i

ProfileCheck.exit.i:                              ; preds = %if.then99.i.i, %if.end96.i.i, %if.end89.i.i
  %329 = phi ptr [ %324, %if.end89.i.i ], [ %327, %if.end96.i.i ], [ %.pre950.i, %if.then99.i.i ]
  %LevelIDC.i.i = getelementptr inbounds %struct.InputParameters, ptr %329, i64 0, i32 1
  %330 = load i32, ptr %LevelIDC.i.i, align 4
  %cmp.i.i = icmp sgt i32 %330, 29
  br i1 %cmp.i.i, label %land.lhs.true.i.i, label %if.end.i851.i

land.lhs.true.i.i:                                ; preds = %ProfileCheck.exit.i
  %directInferenceFlag.i853.i = getelementptr inbounds %struct.InputParameters, ptr %329, i64 0, i32 45
  %331 = load i32, ptr %directInferenceFlag.i853.i, align 4
  %cmp1.i.i = icmp eq i32 %331, 0
  br i1 %cmp1.i.i, label %if.then.i854.i, label %if.end.i851.i

if.then.i854.i:                                   ; preds = %land.lhs.true.i.i
  %332 = load ptr, ptr @stderr, align 8
  %333 = call i64 @fwrite(ptr nonnull @.str.329, i64 106, i64 1, ptr %332) #18
  %334 = load ptr, ptr @input, align 8
  %directInferenceFlag2.i.i = getelementptr inbounds %struct.InputParameters, ptr %334, i64 0, i32 45
  store i32 1, ptr %directInferenceFlag2.i.i, align 4
  %LevelIDC3.phi.trans.insert.i.i = getelementptr inbounds %struct.InputParameters, ptr %334, i64 0, i32 1
  %.pre.i855.i = load i32, ptr %LevelIDC3.phi.trans.insert.i.i, align 4
  br label %if.end.i851.i

if.end.i851.i:                                    ; preds = %if.then.i854.i, %land.lhs.true.i.i, %ProfileCheck.exit.i
  %335 = phi i32 [ %.pre.i855.i, %if.then.i854.i ], [ %330, %land.lhs.true.i.i ], [ %330, %ProfileCheck.exit.i ]
  %336 = phi ptr [ %334, %if.then.i854.i ], [ %329, %land.lhs.true.i.i ], [ %329, %ProfileCheck.exit.i ]
  %337 = add i32 %335, -42
  %or.cond.i852.i = icmp ult i32 %337, -21
  br i1 %or.cond.i852.i, label %land.lhs.true7.i.i, label %PatchInp.exit

land.lhs.true7.i.i:                               ; preds = %if.end.i851.i
  %PicInterlace.i.i = getelementptr inbounds %struct.InputParameters, ptr %336, i64 0, i32 121
  %338 = load i32, ptr %PicInterlace.i.i, align 8
  %cmp8.i.i = icmp sgt i32 %338, 0
  br i1 %cmp8.i.i, label %if.then11.i.i, label %lor.lhs.false9.i.i

lor.lhs.false9.i.i:                               ; preds = %land.lhs.true7.i.i
  %MbInterlace.i.i = getelementptr inbounds %struct.InputParameters, ptr %336, i64 0, i32 122
  %339 = load i32, ptr %MbInterlace.i.i, align 4
  %cmp10.i.i = icmp sgt i32 %339, 0
...
PatchInp.exit:                                    ; preds = %if.end.i851.i, %lor.lhs.false9.i.i, %if.then11.i.i
  %340 = phi ptr [ %336, %if.end.i851.i ], [ %336, %lor.lhs.false9.i.i ], [ %.pre226, %if.then11.i.i ]
  %DisplayEncParams = getelementptr inbounds %struct.InputParameters, ptr %340, i64 0, i32 155
  %341 = load i32, ptr %DisplayEncParams, align 4
  %tobool.not = icmp eq i32 %341, 0
...
if.then127:                                       ; preds = %PatchInp.exit
  ...
  %342 = load ptr, ptr @Map, align 16
  %cmp.not54.i = icmp eq ptr %342, null
  br i1 %cmp.not54.i, label %DisplayEncoderParams.exit, label %while.body.i197

while.body.i197:                                  ; preds = %if.then127, %if.end38.i
  %indvars.iv.i198 = phi i64 [ %indvars.iv.next.i200, %if.end38.i ], [ 0, %if.then127 ]
  %343 = phi ptr [ %350, %if.end38.i ], [ %342, %if.then127 ]
  %Type.i199 = getelementptr inbounds [225 x %struct.Mapping], ptr @Map, i64 0, i64 %indvars.iv.i198, i32 2
  %344 = load i32, ptr %Type.i199, align 8
  switch i32 %344, label %if.end38.i [
    i32 0, label %if.then.i203
    i32 1, label %if.then16.i
    i32 2, label %if.then29.i
  ]

if.then.i203:                                     ; preds = %while.body.i197
  %Place.i204 = getelementptr inbounds [225 x %struct.Mapping], ptr @Map, i64 0, i64 %indvars.iv.i198, i32 1
  %345 = load ptr, ptr %Place.i204, align 8
  %346 = load i32, ptr %345, align 4
  %call11.i = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.252, ptr noundef nonnull %343, i32 noundef %346)
  br label %if.end38.i

if.then16.i:                                      ; preds = %while.body.i197
  %Place22.i = getelementptr inbounds [225 x %struct.Mapping], ptr @Map, i64 0, i64 %indvars.iv.i198, i32 1
  %347 = load ptr, ptr %Place22.i, align 8
  %call23.i = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.253, ptr noundef nonnull %343, ptr noundef %347)
  br label %if.end38.i

if.then29.i:                                      ; preds = %while.body.i197
  %Place35.i = getelementptr inbounds [225 x %struct.Mapping], ptr @Map, i64 0, i64 %indvars.iv.i198, i32 1
  %348 = load ptr, ptr %Place35.i, align 8
  %349 = load double, ptr %348, align 8
  %call36.i = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.254, ptr noundef nonnull %343, double noundef %349)
  br label %if.end38.i

if.end38.i:                                       ; preds = %if.then29.i, %if.then16.i, %if.then.i203, %while.body.i197
  %indvars.iv.next.i200 = add nuw i64 %indvars.iv.i198, 1
  %arrayidx.i201 = getelementptr inbounds [225 x %struct.Mapping], ptr @Map, i64 0, i64 %indvars.iv.next.i200
  %350 = load ptr, ptr %arrayidx.i201, align 8
  %cmp.not.i202 = icmp eq ptr %350, null
  br i1 %cmp.not.i202, label %DisplayEncoderParams.exit, label %while.body.i197
...
if.then25:                                        ; preds = %sw.default
  ...
  store ptr %p.0148, ptr %arrayidx28, align 8
  br label %if.end30
...
sw.bb53:                                          ; preds = %if.end50
  ...
  %12 = load ptr, ptr %arrayidx56, align 8
...
sw.bb71:                                          ; preds = %if.end50
  ...
  %15 = load ptr, ptr %Place74, align 8
...
sw.bb80:                                          ; preds = %if.end50
  ...
  %19 = load ptr, ptr %arrayidx83, align 8
...
if.then:                                          ; preds = %entry
  ...
  store i32 %add8, ptr %NumFrameIn2ndIGOP, align 4
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  store i32 %add1, ptr @FirstFrameIn2ndIGOP, align 4
  ret void
}
