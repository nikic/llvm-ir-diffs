; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/loopFilter.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/loopFilter.c"
...
for.body.epil:                                    ; preds = %for.cond5.preheader.unr-lcssa
  ...
  %3 = load i32, ptr %mb_type.epil, align 8
...
if.then.epil:                                     ; preds = %for.body.epil
  ...
  store i32 0, ptr %qp.epil, align 8
...
for.inc.1:                                        ; preds = %if.then.1, %for.inc
  ...
  br i1 %niter.ncmp.1, label %for.cond5.preheader.unr-lcssa, label %for.body
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %6 = load i32, ptr %PicSizeInMbs, align 4
...
if.end13:                                         ; preds = %land.lhs.true10, %entry
  %filterTopMbEdgeFlag.0.shrunk = phi i1 [ %cmp1, %entry ], [ %tobool11.not, %land.lhs.true10 ]
...
lor.end:                                          ; preds = %lor.rhs
  ...
  %7 = load i32, ptr %mb_field18, align 8
  %.fr = freeze i32 %7
...
lor.end.thread269:                                ; preds = %lor.rhs, %lor.end, %lor.end.thread
  ...
  %9 = load i32, ptr %LFDisableIdc, align 4
...
if.then31:                                        ; preds = %lor.end.thread269
  ...
  %10 = load i32, ptr %mbAvailA, align 4
...
land.lhs.true34:                                  ; preds = %if.then31
  ...
  %11 = load i32, ptr %mb_field35, align 8
...
if.else:                                          ; preds = %land.lhs.true34, %if.then31
  ...
  %12 = load i32, ptr %mbAvailB, align 8
  %13 = icmp ne i32 %12, 0
  br label %if.end41
...
if.end41:                                         ; preds = %land.lhs.true34, %lor.end.thread269, %if.else
  ...
  store i32 %MbQAddr, ptr %current_mb_nr, align 4
...
for.body:                                         ; preds = %if.end41, %for.inc149
  ...
  %indvars.iv283 = phi i64 [ 0, %if.end41 ], [ 1, %for.inc149 ]
...
lor.end52:                                        ; preds = %for.body, %lor.rhs47
  ...
  %16 = trunc i64 %indvars.iv283 to i32
  br label %for.body57

for.body57:                                       ; preds = %lor.end52, %for.inc146
  %indvars.iv280 = phi i64 [ 0, %lor.end52 ], [ %indvars.iv.next281, %for.inc146 ]
  %tobool58 = icmp ne i64 %indvars.iv280, 0
  %or.cond168 = select i1 %tobool58, i1 true, i1 %15
  br i1 %or.cond168, label %if.then60, label %for.inc146

if.then60:                                        ; preds = %for.body57
  %17 = load i32, ptr %yuv_format, align 8
  %idxprom65 = sext i32 %17 to i64
  %arrayidx66 = getelementptr inbounds [2 x [4 x [4 x i8]]], ptr @chroma_edge, i64 0, i64 %indvars.iv283, i64 %indvars.iv280, i64 %idxprom65
  %18 = load i8, ptr %arrayidx66, align 1
  %conv67 = sext i8 %18 to i32
  %19 = trunc i64 %indvars.iv280 to i32
  ...
  %StrengthSum.0.in271 = load i8, ptr %Strength, align 16
...
if.then93:                                        ; preds = %if.end87
  %24 = load ptr, ptr %imgUV, align 8
  %25 = load i32, ptr %LFAlphaC0Offset, align 8
  %26 = load i32, ptr %LFBetaOffset, align 4
  ...
  %28 = load ptr, ptr %arrayidx98, align 8
  %29 = load i32, ptr %LFAlphaC0Offset, align 8
  %30 = load i32, ptr %LFBetaOffset, align 4
  %31 = load i32, ptr %width_cr, align 8
...
land.lhs.true108:                                 ; preds = %if.end104
  %32 = load i32, ptr %mb_field109, align 8
...
if.end125:                                        ; preds = %land.lhs.true108
  store i32 2, ptr %DeblockCall, align 4
  ...
  %34 = load i32, ptr %LFAlphaC0Offset, align 8
  %35 = load i32, ptr %LFBetaOffset, align 4
...
if.then131:                                       ; preds = %if.end125
  %37 = load ptr, ptr %imgUV, align 8
  %38 = load i32, ptr %LFAlphaC0Offset, align 8
  %39 = load i32, ptr %LFBetaOffset, align 4
  %40 = load i32, ptr %width_cr, align 8
  ...
  %42 = load i32, ptr %LFAlphaC0Offset, align 8
  %43 = load i32, ptr %LFBetaOffset, align 4
  %44 = load i32, ptr %width_cr, align 8
...
for.inc146:                                       ; preds = %for.body57, %if.end142, %land.lhs.true108, %if.end104
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next281, 4
  br i1 %exitcond.not, label %for.inc149, label %for.body57

for.inc149:                                       ; preds = %for.inc146
  br i1 %tobool105, label %for.body, label %cleanup
...
entry:
  ...
  %7 = load ptr, ptr %ref_pic_id, align 8
...
land.lhs.true48:                                  ; preds = %land.rhs
  %22 = load i32, ptr %mb_field26, align 8
...
land.lhs.true51:                                  ; preds = %land.lhs.true48
  %23 = load i32, ptr %mb_field, align 8
...
land.end62.thread748:                             ; preds = %land.lhs.true, %land.lhs.true51, %if.then, %land.end62, %land.end62.thread
  ...
  store i8 %24, ptr %arrayidx66, align 1
  br label %for.inc
...
land.rhs69:                                       ; preds = %if.else
  %25 = load i32, ptr %MbaffFrameFlag70, align 4
...
land.lhs.true72:                                  ; preds = %land.rhs69
  %26 = load i32, ptr %structure73, align 8
...
land.lhs.true79:                                  ; preds = %land.rhs69
  %27 = load i32, ptr %mb_field26, align 8
...
land.lhs.true116:                                 ; preds = %land.end97.thread750
  %31 = load i32, ptr %mb_type117, align 8
...
if.then132:                                       ; preds = %land.lhs.true116
  %32 = load i64, ptr %cbp_blk, align 8
...
lor.lhs.false136:                                 ; preds = %if.then132
  ...
  %33 = load i64, ptr %cbp_blk137, align 8
...
if.then143:                                       ; preds = %lor.lhs.false136, %if.then132
  store i8 2, ptr %arrayidx101, align 1
  br label %for.inc

if.else146:                                       ; preds = %lor.lhs.false136
  %34 = load i8, ptr @mixedModeEdgeFlag, align 1
...
cond.false168:                                    ; preds = %if.else151
  ...
  %42 = load ptr, ptr %arrayidx170, align 8
...
cond.false183:                                    ; preds = %cond.end173
  ...
  %46 = load ptr, ptr %arrayidx185, align 8
  %arrayidx187 = getelementptr inbounds i64, ptr %46, i64 %idxprom177
  %47 = load i64, ptr %arrayidx187, align 8
...
cond.end188:                                      ; preds = %cond.end173, %cond.false183
  ...
  %48 = load ptr, ptr %arrayidx191, align 8
  %arrayidx193 = getelementptr inbounds i8, ptr %48, i64 %idxprom162
  %49 = load i8, ptr %arrayidx193, align 1
...
cond.false198:                                    ; preds = %cond.end188
  ...
  %50 = load ptr, ptr %arrayidx200, align 8
  %arrayidx202 = getelementptr inbounds i64, ptr %50, i64 %idxprom162
  %51 = load i64, ptr %arrayidx202, align 8
...
cond.end203:                                      ; preds = %cond.end188, %cond.false198
  ...
  %52 = load ptr, ptr %arrayidx206, align 8
  %arrayidx208 = getelementptr inbounds i8, ptr %52, i64 %idxprom177
  %53 = load i8, ptr %arrayidx208, align 1
...
cond.false213:                                    ; preds = %cond.end203
  ...
  %55 = load i64, ptr %arrayidx217, align 8
...
if.then231:                                       ; preds = %lor.lhs.false225, %cond.end218
  ...
  %56 = load ptr, ptr %arrayidx381, align 8
  %arrayidx383 = getelementptr inbounds ptr, ptr %56, i64 %idxprom162
  %57 = load ptr, ptr %arrayidx383, align 8
...
if.then236:                                       ; preds = %if.then231
  ...
  %61 = load ptr, ptr %arrayidx274, align 8
...
if.then239:                                       ; preds = %if.then236
  ...
  %63 = load ptr, ptr %arrayidx247, align 8
  %arrayidx249 = getelementptr inbounds ptr, ptr %63, i64 %idxprom177
  %64 = load ptr, ptr %arrayidx249, align 8
  ...
  %66 = load i16, ptr %arrayidx265, align 2
  ...
  %68 = load ptr, ptr %arrayidx280, align 8
...
if.else308:                                       ; preds = %if.then236
  ...
  %77 = load i16, ptr %arrayidx335, align 2
  ...
  %78 = load ptr, ptr %arrayidx349, align 8
  %arrayidx351 = getelementptr inbounds ptr, ptr %78, i64 %idxprom177
  %79 = load ptr, ptr %arrayidx351, align 8
...
land.end517:                                      ; preds = %land.rhs448, %if.else379
  ...
  store i8 %conv518, ptr %arrayidx101, align 1
  br label %for.inc
...
entry:
  ...
  %sub1.pn.in = load i32, ptr %sub1.pn.in.in, align 4
...
lor.rhs:                                          ; preds = %for.body
  ...
  %7 = load i32, ptr %mb_field32, align 8
...
lor.end:                                          ; preds = %lor.rhs, %for.body
  ...
  store i8 %conv, ptr @fieldModeFilteringFlag, align 1
...
land.lhs.true40:                                  ; preds = %cond.true37
  ...
  %10 = load i32, ptr %mb_field41, align 8
...
lor.lhs.false:                                    ; preds = %cond.end50
  ...
  %13 = load i32, ptr %LFDisableIdc, align 4
...
land.lhs.true74:                                  ; preds = %if.then55
  ...
  %15 = load i32, ptr %mb_field75, align 8
...
cond.end110:                                      ; preds = %cond.false105, %cond.true96
  ...
  %27 = load i8, ptr %arrayidx120, align 1
  ...
  %28 = load i16, ptr %arrayidx94, align 2
  ...
  %32 = load i16, ptr %arrayidx139, align 2
  ...
  %33 = load i16, ptr %arrayidx143, align 2
  ...
  %34 = load i16, ptr %arrayidx148, align 2
  ...
  %35 = load i16, ptr %arrayidx152, align 2
  ...
  %36 = load i8, ptr %arrayidx155, align 1
...
if.then163:                                       ; preds = %if.then158
  ...
  %37 = load i8, ptr %arrayidx165, align 1
...
if.then196:                                       ; preds = %if.end190
  ...
  store i16 %conv202, ptr %arrayidx88, align 2
  ...
  store i16 %conv209, ptr %arrayidx94, align 2
  br label %for.inc
...
cond.end232:                                      ; preds = %cond.false226, %cond.true219
  ...
  store i16 %conv234, ptr %arrayidx88, align 2
...
cond.end250:                                      ; preds = %cond.false244, %cond.true237
  ...
  store i16 %conv252, ptr %arrayidx94, align 2
...
cond.end262:                                      ; preds = %cond.end250, %cond.true255
  ...
  store i16 %conv264, ptr %arrayidx134, align 2
...
cond.end275:                                      ; preds = %cond.end262, %cond.true268
  ...
  store i16 %conv277, ptr %arrayidx131, align 2
...
cond.end291:                                      ; preds = %cond.end275, %cond.true282
  ...
  store i16 %conv293, ptr %arrayidx143, align 2
...
cond.true298:                                     ; preds = %cond.end291
  ...
  %add301 = add nuw nsw i32 %conv132, 4
  %add302 = add nuw nsw i32 %add301, %add191590
...
cond.end307:                                      ; preds = %cond.end291, %cond.true298
  ...
  store i16 %conv309, ptr %arrayidx139, align 2
  br label %for.inc
...
if.then343:                                       ; preds = %if.then332
  ...
  %40 = load i16, ptr %arrayidx131, align 2
  %41 = trunc i32 %cond.i4.i576 to i16
  %conv357 = add i16 %40, %41
  store i16 %conv357, ptr %arrayidx131, align 2
  br label %if.end358
