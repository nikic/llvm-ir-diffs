...
cond.end:                                         ; preds = %lor.end22, %cond.true
  ...
  store i16 0, ptr %intra_skip, align 2
  ...
  %16 = load i32, ptr %SearchMode, align 4
...
if.end42:                                         ; preds = %cond.end, %if.then41, %if.then
  ...
  %18 = load i32, ptr %current_mb_nr43, align 4
...
for.body69:                                       ; preds = %if.end65, %for.inc365
  ...
  %25 = load i16, ptr %arrayidx74, align 2
...
for.cond87.preheader:                             ; preds = %if.then79, %for.inc222
  ...
  %29 = load i32, ptr %CtxAdptLagrangeMult91, align 4
...
cond.end105.thread:                               ; preds = %for.cond87.preheader
  ...
  store i32 %30, ptr %lambda_mf, align 4
  br label %cond.end105.1.thread

cond.end105:                                      ; preds = %for.cond87.preheader
  %31 = load i32, ptr %arrayidx101, align 8
  ...
  %.pre1421 = load ptr, ptr @input, align 8
  %CtxAdptLagrangeMult91.1.phi.trans.insert = getelementptr inbounds %struct.InputParameters, ptr %.pre1421, i64 0, i32 114
  %.pre1422 = load i32, ptr %CtxAdptLagrangeMult91.1.phi.trans.insert, align 4
  store i32 %conv104, ptr %lambda_mf, align 4
...
cond.end105.1.thread:                             ; preds = %cond.end105, %cond.end105.thread
  %33 = load i32, ptr %arrayidx97.1, align 4
  store i32 %33, ptr %arrayidx108.11465, align 4
  br label %cond.true94.2

cond.end105.1:                                    ; preds = %cond.end105
  %34 = load i32, ptr %arrayidx101.1, align 4
...
if.then127:                                       ; preds = %cond.end105.2
  store i32 2147483647, ptr %arrayidx128, align 4
  ...
  %41 = load i32, ptr %BiPredMotionEstimation, align 8
...
if.else140:                                       ; preds = %if.then127
  store i32 2147483647, ptr %arrayidx141, align 4
  store i32 2147483647, ptr %arrayidx142, align 16
  br label %if.end143
...
if.end143:                                        ; preds = %if.else140, %if.then137
  ...
  %.pre1425 = load i8, ptr %best_pdir, align 1
  br label %if.end148

if.else146:                                       ; preds = %cond.end105.2
  store i8 0, ptr %best_pdir, align 1
  %42 = load i32, ptr %bmcost, align 16
  %43 = load i32, ptr %cost, align 4
...
if.end148:                                        ; preds = %if.else146, %if.end143
  ...
  %48 = load i8, ptr %best_ref, align 2
...
if.else203:                                       ; preds = %if.end148
  ...
  %57 = load i8, ptr %best_pdir, align 1
  %58 = insertelement <4 x i8> poison, i8 %57, i64 0
  %59 = shufflevector <4 x i8> %58, <4 x i8> poison, <4 x i32> zeroinitializer
  store <4 x i8> %59, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 1), align 4
  br label %if.end209
...
for.inc222:                                       ; preds = %if.end209, %if.then215
  ...
  br i1 %cmp84.not, label %for.end224, label %for.cond87.preheader
...
land.lhs.true317:                                 ; preds = %land.lhs.true308
  ...
  %76 = load ptr, ptr %arrayidx324, align 8
...
land.lhs.true331:                                 ; preds = %land.lhs.true317
  ...
  %79 = load i16, ptr %arrayidx340, align 2
  %80 = load i16, ptr %arrayidx342, align 2
...
if.end349:                                        ; preds = %for.end301.thread, %for.end301, %if.then303, %if.then346, %land.lhs.true331, %land.lhs.true317, %land.lhs.true308, %if.then305
  %81 = load double, ptr %min_rdcost, align 8
  %82 = load i16, ptr @best_mode, align 2
  br label %if.end351
...
if.end351:                                        ; preds = %if.end349, %for.end224
  ...
  %83 = load i16, ptr %inter_skip, align 2
...
for.inc365:                                       ; preds = %for.body69, %if.then356, %if.then361, %if.end351
  ...
  br i1 %exitcond.not, label %for.end367, label %for.body69

for.end367:                                       ; preds = %for.inc365
  %87 = load i16, ptr %inter_skip, align 2
...
if.then374:                                       ; preds = %for.end367
  ...
  %91 = load i32, ptr %Transform8x8Mode, align 4
...
if.end403:                                        ; preds = %if.then374
  ...
  store i32 0, ptr %cost_direct, align 4
  %92 = load ptr, ptr @cofAC_8x8ts, align 8
  ...
  %94 = load i16, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 5, i64 0), align 4
  store i16 %94, ptr @best8x8mode, align 2
  %95 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 6, i64 0), align 4
  store i8 %95, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 8, i64 0), align 16
  %96 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 7, i64 0), align 4
  store i8 %96, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 8, i64 0), align 16
  %97 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 8, i64 0), align 4
  store i8 %97, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 8, i64 0), align 16
  %98 = load ptr, ptr @cofAC_8x8ts, align 8
  %arrayidx382.1 = getelementptr inbounds ptr, ptr %98, i64 1
  %99 = load ptr, ptr %arrayidx382.1, align 8
  ...
  %100 = load i16, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 5, i64 1), align 2
  store i16 %100, ptr getelementptr inbounds ([4 x i16], ptr @best8x8mode, i64 0, i64 1), align 2
  %101 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 6, i64 1), align 1
  store i8 %101, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 8, i64 1), align 1
  %102 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 7, i64 1), align 1
  store i8 %102, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 8, i64 1), align 1
  %103 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 8, i64 1), align 1
  store i8 %103, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 8, i64 1), align 1
  %104 = load ptr, ptr @cofAC_8x8ts, align 8
  %arrayidx382.2 = getelementptr inbounds ptr, ptr %104, i64 2
  %105 = load ptr, ptr %arrayidx382.2, align 8
  ...
  %106 = load i16, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 5, i64 2), align 4
  store i16 %106, ptr getelementptr inbounds ([4 x i16], ptr @best8x8mode, i64 0, i64 2), align 2
  %107 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 6, i64 2), align 2
  store i8 %107, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 8, i64 2), align 2
  %108 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 7, i64 2), align 2
  store i8 %108, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 8, i64 2), align 2
  %109 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 8, i64 2), align 2
  store i8 %109, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 8, i64 2), align 2
  %110 = load ptr, ptr @cofAC_8x8ts, align 8
  %arrayidx382.3 = getelementptr inbounds ptr, ptr %110, i64 3
  %111 = load ptr, ptr %arrayidx382.3, align 8
  ...
  %112 = load i16, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 5, i64 3), align 2
  store i16 %112, ptr getelementptr inbounds ([4 x i16], ptr @best8x8mode, i64 0, i64 3), align 2
  %113 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 6, i64 3), align 1
  store i8 %113, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 8, i64 3), align 1
  %114 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 7, i64 3), align 1
  store i8 %114, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 8, i64 3), align 1
  %115 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr8x8, i64 0, i32 8, i64 3), align 1
  store i8 %115, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 8, i64 3), align 1
  %116 = load i32, ptr @cbp8x8, align 4
  store i32 %116, ptr @cbp8_8x8ts, align 4
  %117 = load i32, ptr @cbp_blk8x8, align 4
  %conv402 = sext i32 %117 to i64
  store i64 %conv402, ptr @cbp_blk8_8x8ts, align 8
  %118 = load i32, ptr @cnt_nonz_8x8, align 4
  store i32 %118, ptr @cnt_nonz8_8x8ts, align 4
  store i32 0, ptr %luma_transform_size_8x8_flag, align 8
  %.pre1426 = load ptr, ptr @input, align 8
  %Transform8x8Mode404.phi.trans.insert = getelementptr inbounds %struct.InputParameters, ptr %.pre1426, i64 0, i32 153
  %.pre1427 = load i32, ptr %Transform8x8Mode404.phi.trans.insert, align 4
...
if.then407:                                       ; preds = %if.then374, %if.end403
  ...
  store i32 0, ptr @cbp8x8, align 4
  store i32 0, ptr %cost_direct, align 4
  %119 = load ptr, ptr @cofAC8x8, align 8
  ...
  %121 = load i16, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 5, i64 0), align 4
  store i16 %121, ptr @best8x8mode, align 2
  %122 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 6, i64 0), align 4
  store i8 %122, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 8, i64 0), align 16
  %123 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 7, i64 0), align 4
  store i8 %123, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 8, i64 0), align 16
  %124 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 8, i64 0), align 4
  store i8 %124, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 8, i64 0), align 16
  %125 = load ptr, ptr @cofAC8x8, align 8
  %arrayidx413.1 = getelementptr inbounds ptr, ptr %125, i64 1
  %126 = load ptr, ptr %arrayidx413.1, align 8
  ...
  %127 = load i16, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 5, i64 1), align 2
  store i16 %127, ptr getelementptr inbounds ([4 x i16], ptr @best8x8mode, i64 0, i64 1), align 2
  %128 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 6, i64 1), align 1
  store i8 %128, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 8, i64 1), align 1
  %129 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 7, i64 1), align 1
  store i8 %129, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 8, i64 1), align 1
  %130 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 8, i64 1), align 1
  store i8 %130, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 8, i64 1), align 1
  %131 = load ptr, ptr @cofAC8x8, align 8
  %arrayidx413.2 = getelementptr inbounds ptr, ptr %131, i64 2
  %132 = load ptr, ptr %arrayidx413.2, align 8
  ...
  %133 = load i16, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 5, i64 2), align 4
  store i16 %133, ptr getelementptr inbounds ([4 x i16], ptr @best8x8mode, i64 0, i64 2), align 2
  %134 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 6, i64 2), align 2
  store i8 %134, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 8, i64 2), align 2
  %135 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 7, i64 2), align 2
  store i8 %135, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 8, i64 2), align 2
  %136 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 8, i64 2), align 2
  store i8 %136, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 8, i64 2), align 2
  %137 = load ptr, ptr @cofAC8x8, align 8
  %arrayidx413.3 = getelementptr inbounds ptr, ptr %137, i64 3
  %138 = load ptr, ptr %arrayidx413.3, align 8
  ...
  %139 = load i16, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 5, i64 3), align 2
  store i16 %139, ptr getelementptr inbounds ([4 x i16], ptr @best8x8mode, i64 0, i64 3), align 2
  %140 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 6, i64 3), align 1
  store i8 %140, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8pdir, i64 0, i64 8, i64 3), align 1
  %141 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 7, i64 3), align 1
  store i8 %141, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8fwref, i64 0, i64 8, i64 3), align 1
  %142 = load i8, ptr getelementptr inbounds (%struct.RD_8x8DATA, ptr @tr4x4, i64 0, i32 8, i64 3), align 1
  store i8 %142, ptr getelementptr inbounds ([15 x [4 x i8]], ptr @best8x8bwref, i64 0, i64 8, i64 3), align 1
  br label %if.end433

if.end433:                                        ; preds = %if.then407, %if.end403
  %143 = load ptr, ptr @cs_mb, align 8
  ...
  %145 = load i32, ptr %RCEnable, align 4
...
if.end441:                                        ; preds = %if.end42, %if.end437, %if.else438
  ...
  %149 = load i16, ptr %inter_skip, align 2
...
if.end450:                                        ; preds = %if.then443, %if.then447
  ...
  %.pre1428 = load ptr, ptr @input, align 8
...
land.end454:                                      ; preds = %if.end450
  ...
  %152 = load i32, ptr %SelectiveIntraEnable, align 4
  %.fr = freeze i32 %152
...
land.end454.thread:                               ; preds = %land.end454, %if.end450
  ...
  %155 = load i32, ptr %BiPredMotionEstimation456, align 8
...
if.then458:                                       ; preds = %land.end454.thread
  ...
  store i16 0, ptr %arrayidx460, align 2
  br label %if.end461
...
if.end461:                                        ; preds = %if.then458, %land.end454.thread
  ...
  %156 = load i32, ptr %yuv_format, align 8
...
if.then467:                                       ; preds = %if.end461
  ...
  %158 = load i32, ptr %FastCrIntraDecision, align 8
...
if.then469:                                       ; preds = %if.then467
  ...
  %159 = load i32, ptr %c_ipred_mode, align 8
  br label %if.end477
...
if.end477:                                        ; preds = %if.end461, %if.then467, %if.then469
  ...
  store i32 %conv478, ptr %c_ipred_mode, align 8
  %cmp483.not1378 = icmp sgt i32 %conv478, %conv482
  %.pre1435 = load ptr, ptr @img, align 8
...
for.body485:                                      ; preds = %if.end477, %for.inc754
  ...
  %161 = load i32, ptr %yuv_format486, align 8
...
land.lhs.true489:                                 ; preds = %for.body485
  %.pre1429 = load ptr, ptr @input, align 8
...
lor.lhs.false:                                    ; preds = %land.lhs.true489
  ...
  %162 = load i32, ptr %IntraDisableInterOnly, align 8
...
land.lhs.true492:                                 ; preds = %lor.lhs.false, %land.lhs.true489
  ...
  %163 = load i32, ptr %ChromaIntraDisable, align 8
...
if.end545:                                        ; preds = %if.then532, %for.body526
  ...
  %.pre1432 = load ptr, ptr @input, align 8
...
if.then551:                                       ; preds = %if.end545
  ...
  %171 = load i32, ptr %BiPredMotionEstimation556, align 8
...
land.lhs.true561:                                 ; preds = %if.then551
  ...
  %172 = load i16, ptr %arrayidx564, align 2
...
if.end580:                                        ; preds = %if.end573, %if.end545
  ...
  %173 = load i32, ptr %SkipIntraInInterSlices, align 8
...
land.lhs.true599:                                 ; preds = %if.end596
  ...
  %177 = load i32, ptr %weighted_bipred_idc, align 4
...
for.cond606.preheader:                            ; preds = %land.lhs.true599
  ...
  %180 = load i8, ptr %arrayidx613, align 4
...
for.cond618.preheader:                            ; preds = %for.cond606.preheader
  %181 = load i32, ptr %chroma_format_idc, align 4
...
for.inc675:                                       ; preds = %for.cond618, %for.cond618.11495, %for.body624.21501, %for.cond606.preheader
  ...
  %199 = load i8, ptr %arrayidx613.1, align 1
...
for.cond618.preheader.1:                          ; preds = %for.inc675
  %200 = load i32, ptr %chroma_format_idc, align 4
...
for.inc675.1:                                     ; preds = %for.cond618.1, %for.cond618.1.1, %for.body624.1.2, %for.inc675
  ...
  %218 = load i8, ptr %arrayidx613.2, align 2
...
for.cond618.preheader.2:                          ; preds = %for.inc675.1
  %219 = load i32, ptr %chroma_format_idc, align 4
...
for.inc675.2:                                     ; preds = %for.cond618.2, %for.cond618.2.1, %for.body624.2.2, %for.inc675.1
  ...
  %237 = load i8, ptr %arrayidx613.3, align 1
...
for.cond618.preheader.3:                          ; preds = %for.inc675.2
  %238 = load i32, ptr %chroma_format_idc, align 4
...
if.then680:                                       ; preds = %for.cond618.preheader, %for.body624.11491, %for.body624.21501, %for.cond618.preheader.1, %for.body624.1.1, %for.body624.1.2, %for.cond618.preheader.2, %for.body624.2.1, %for.body624.2.2, %for.cond618.preheader.3, %for.body624.3.1, %for.body624.3.2
  ...
  %256 = load i32, ptr %BiPredMotionEstimation681, align 8
...
land.lhs.true686:                                 ; preds = %if.then680
  ...
  %257 = load i16, ptr %arrayidx689, align 2
...
if.end711:                                        ; preds = %for.cond618.3, %for.cond618.3.1, %for.body624.3.2, %for.inc675.2, %land.lhs.true599, %if.end596
  ...
  %258 = load i16, ptr %arrayidx714, align 2
...
if.then716:                                       ; preds = %if.end711
  ...
  %.pre1430 = load ptr, ptr @img, align 8
  %.pre1433 = load ptr, ptr @input, align 8
  br label %if.end717
...
if.end717:                                        ; preds = %if.then716, %if.end711
  ...
  %262 = load i32, ptr %BiPredMotionEstimation718, align 8
...
land.lhs.true726:                                 ; preds = %if.end717
  ...
  %263 = load i16, ptr %arrayidx729, align 2
...
for.inc751.sink.split:                            ; preds = %land.lhs.true726, %land.lhs.true686
  ...
  store i16 %add701, ptr %arrayidx689.sink, align 2
  br label %for.inc751
...
for.inc751:                                       ; preds = %for.inc751.sink.split, %if.then680, %land.lhs.true686, %if.end717, %land.lhs.true726, %land.lhs.true591, %if.then532
  ...
  br i1 %cmp524, label %for.body526, label %for.inc754.loopexit

for.inc754.loopexit:                              ; preds = %for.inc751
  %.pre1434 = load i32, ptr %c_ipred_mode, align 8
  br label %for.inc754
...
for.inc754:                                       ; preds = %for.inc754.loopexit, %land.lhs.true495, %land.lhs.true515, %lor.lhs.false499, %lor.lhs.false505
  ...
  store i32 %inc756, ptr %c_ipred_mode, align 8
  %cmp483.not.not = icmp slt i32 %268, %conv482
  br i1 %cmp483.not.not, label %for.body485, label %for.end757
...
if.end784:                                        ; preds = %if.then769, %if.then773, %if.then776
  ...
  store i32 %conv785, ptr %c_ipred_mode, align 8
...
for.body792.preheader:                            ; preds = %if.end784
  %.pre1437.pre1455 = load ptr, ptr @input, align 8
...
for.body792:                                      ; preds = %for.body792.preheader, %for.inc882
  ...
  %286 = load i32, ptr %yuv_format793, align 8
...
lor.lhs.false798:                                 ; preds = %land.lhs.true796
  ...
  %287 = load i32, ptr %IntraDisableInterOnly799, align 8
...
land.lhs.true801:                                 ; preds = %lor.lhs.false798, %land.lhs.true796
  ...
  %288 = load i32, ptr %ChromaIntraDisable802, align 8
...
if.end832:                                        ; preds = %land.lhs.true805, %land.lhs.true825, %lor.lhs.false821, %for.body792
  ...
  %292 = load i32, ptr %SkipIntraInInterSlices839, align 8
...
if.end872:                                        ; preds = %land.lhs.true850, %if.end855
  %295 = load i16, ptr %arrayidx875, align 2
...
if.end855.1:                                      ; preds = %land.lhs.true850.1, %for.inc879
  ...
  %300 = load i32, ptr %yuv_format856.1, align 8
...
if.end872.1:                                      ; preds = %if.end855.1
  %301 = load i16, ptr %arrayidx875.1, align 2
...
if.end872.2:                                      ; preds = %if.end855.2
  %307 = load i16, ptr %arrayidx875.2, align 2
...
if.end872.3:                                      ; preds = %if.end855.3
  %313 = load i16, ptr %arrayidx875.3, align 2
...
if.then877.3:                                     ; preds = %if.end872.3
  ...
  %.pre1437.pre = load ptr, ptr @input, align 8
...
for.inc879.3:                                     ; preds = %if.end855.3, %if.then877.3, %if.end872.3, %land.lhs.true850.3
  ...
  %.pre1447 = load i32, ptr %c_ipred_mode, align 8
  br label %for.inc882
...
for.inc882:                                       ; preds = %for.inc879.3, %land.lhs.true805, %land.lhs.true825, %lor.lhs.false809, %lor.lhs.false815
  ...
  store i32 %inc884, ptr %c_ipred_mode, align 8
  %cmp790.not.not = icmp slt i32 %314, %conv789
  br i1 %cmp790.not.not, label %for.body792, label %if.end887
...
if.then891:                                       ; preds = %if.end441, %if.end887
  %315 = load i32, ptr %mb_type, align 8
  %316 = add i32 %315, -9
...
if.end942:                                        ; preds = %if.then941, %if.end938
  ...
  %330 = load i32, ptr %MbaffFrameFlag, align 4
...
land.lhs.true945:                                 ; preds = %if.end942
  ...
  %331 = load i32, ptr %current_mb_nr946, align 4
  %332 = and i32 %331, 1
...
land.lhs.true948:                                 ; preds = %land.lhs.true945
  %333 = load i32, ptr %mb_type, align 8
...
land.lhs.true959:                                 ; preds = %cond.true955
  ...
  %335 = load i32, ptr %mb_type960, align 8
...
land.lhs.true959.thread:                          ; preds = %cond.false952
  ...
  %336 = load i32, ptr %mb_type9601359, align 8
...
cond.true966:                                     ; preds = %land.lhs.true959
  ...
  %337 = load i32, ptr %cbp967, align 4
...
land.lhs.true970:                                 ; preds = %land.lhs.true959.thread, %cond.true966
  ...
  %338 = load i16, ptr %curr_mb_field, align 2
...
if.then975:                                       ; preds = %land.lhs.true970
  %339 = load ptr, ptr @rdopt, align 8
  store double 1.000000e+30, ptr %339, align 8
  br label %if.end977
...
if.then979:                                       ; preds = %if.end977
  ...
  %.pre1448 = load ptr, ptr @input, align 8
  br label %if.end981
...
if.end981:                                        ; preds = %if.then979, %if.end977
  ...
  %343 = load i32, ptr %SearchMode982, align 4
