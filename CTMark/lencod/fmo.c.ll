; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/fmo.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/fmo.c"
...
entry:
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) @FirstMBInSlice, i8 -1, i64 32, i1 false)
  %PicHeightInMapUnits.i = getelementptr inbounds %struct.ImageParameters, ptr %img, i64 0, i32 117
  %0 = load i32, ptr %PicHeightInMapUnits.i, align 4
  %PicWidthInMbs.i = getelementptr inbounds %struct.ImageParameters, ptr %img, i64 0, i32 116
  %1 = load i32, ptr %PicWidthInMbs.i, align 8
  %mul.i = mul i32 %1, %0
  store i32 %mul.i, ptr @PicSizeInMapUnits, align 4
  %slice_group_map_type.i = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 9
  %2 = load i32, ptr %slice_group_map_type.i, align 8
...
if.then.i:                                        ; preds = %entry
  ...
  %3 = load i32, ptr %pic_size_in_map_units_minus1.i, align 4
  %add.i = add i32 %3, 1
...
if.end3.i:                                        ; preds = %if.then2.i, %if.then.i, %entry
  %4 = load ptr, ptr @MapUnitToSliceGroupMap, align 8
...
if.end5.i:                                        ; preds = %if.then4.i, %if.end3.i
  ...
  store ptr %call.i, ptr @MapUnitToSliceGroupMap, align 8
...
if.end14.i:                                       ; preds = %if.end5.i
  ...
  %6 = load i32, ptr %num_slice_groups_minus1.i, align 4
...
if.end20.i:                                       ; preds = %if.end14.i
  %7 = load i32, ptr %slice_group_map_type.i, align 8
...
for.body7.i.i:                                    ; preds = %for.cond2.preheader.i.i, %land.rhs4.i.i
  ...
  %16 = load ptr, ptr @MapUnitToSliceGroupMap, align 8
  %arrayidx10.i.i = getelementptr inbounds i8, ptr %16, i64 %15
  store i8 %conv.i.i, ptr %arrayidx10.i.i, align 1
  %17 = load i32, ptr %arrayidx.i.i, align 4
  %18 = zext i32 %17 to i64
  %cmp3.not.not.i.i = icmp ult i64 %indvars.iv.i130.i, %18
  br i1 %cmp3.not.not.i.i, label %land.rhs4.i.i, label %for.body7.for.inc11_crit_edge.i.i
...
for.body.i.i:                                     ; preds = %sw.bb22.i, %for.body.i.i
  ...
  %22 = load i32, ptr %PicWidthInMbs.i, align 8
  %23 = trunc i64 %indvars.iv.i50.i to i32
  %rem.i.i = urem i32 %23, %22
  %div.i.i = udiv i32 %23, %22
  %24 = load i32, ptr %num_slice_groups_minus1.i, align 4
  ...
  %25 = load ptr, ptr @MapUnitToSliceGroupMap, align 8
  %arrayidx.i52.i = getelementptr inbounds i8, ptr %25, i64 %indvars.iv.i50.i
  store i8 %conv.i51.i, ptr %arrayidx.i52.i, align 1
  %indvars.iv.next.i53.i = add nuw nsw i64 %indvars.iv.i50.i, 1
  %26 = load i32, ptr @PicSizeInMapUnits, align 4
  %27 = zext i32 %26 to i64
  %cmp.i54.i = icmp ult i64 %indvars.iv.next.i53.i, %27
  br i1 %cmp.i54.i, label %for.body.i.i, label %FmoGenerateMapUnitToSliceGroupMap.exit

sw.bb23.i:                                        ; preds = %if.end20.i
  %cmp62.not.i.i = icmp eq i32 %5, 0
  br i1 %cmp62.not.i.i, label %for.end.i.i, label %for.body.i57.i

for.body.i57.i:                                   ; preds = %sw.bb23.i, %for.body.i57.i
  %indvars.iv.i58.i = phi i64 [ %indvars.iv.next.i61.i, %for.body.i57.i ], [ 0, %sw.bb23.i ]
  %28 = load i32, ptr %num_slice_groups_minus1.i, align 4
  %conv.i59.i = trunc i32 %28 to i8
  %29 = load ptr, ptr @MapUnitToSliceGroupMap, align 8
  %arrayidx.i60.i = getelementptr inbounds i8, ptr %29, i64 %indvars.iv.i58.i
  store i8 %conv.i59.i, ptr %arrayidx.i60.i, align 1
  %indvars.iv.next.i61.i = add nuw nsw i64 %indvars.iv.i58.i, 1
  %30 = load i32, ptr @PicSizeInMapUnits, align 4
  %31 = zext i32 %30 to i64
  %cmp.i62.i = icmp ult i64 %indvars.iv.next.i61.i, %31
  br i1 %cmp.i62.i, label %for.body.i57.i, label %for.end.i.loopexit.i

for.end.i.loopexit.i:                             ; preds = %for.body.i57.i
  %.pre.i = load i32, ptr %num_slice_groups_minus1.i, align 4
...
for.cond2.loopexit.i.i:                           ; preds = %for.cond25.for.inc36_crit_edge.i.i, %for.cond25.preheader.lr.ph.i.i, %for.body5.i.i
  ...
  br i1 %cmp3.i.i, label %for.body5.i.i, label %FmoGenerateMapUnitToSliceGroupMap.exit
...
for.body5.i.i:                                    ; preds = %for.cond2.loopexit.i.i, %for.body5.i.preheader.i
  ...
  %35 = load i32, ptr %PicWidthInMbs.i, align 8
  ...
  %36 = load i32, ptr %arrayidx13.i.i, align 4
...
for.body28.i.i:                                   ; preds = %for.body28.i.i, %for.cond25.preheader.i.i
  ...
  %37 = load ptr, ptr @MapUnitToSliceGroupMap, align 8
  %38 = load i32, ptr %PicWidthInMbs.i, align 8
  ...
  store i8 %conv29.i.i, ptr %arrayidx32.i.i, align 1
  %inc34.i.i = add i32 %x.065.i.i, 1
  %cmp26.not.i.i = icmp ugt i32 %inc34.i.i, %rem20.i.i
  br i1 %cmp26.not.i.i, label %for.cond25.for.inc36_crit_edge.i.i, label %for.body28.i.i
...
for.cond25.for.inc36_crit_edge.i.i:               ; preds = %for.body28.i.i
  ...
  br i1 %cmp22.not.i.i, label %for.cond2.loopexit.i.i, label %for.cond25.preheader.i.i
...
sw.bb24.i:                                        ; preds = %if.end20.i
  ...
  %39 = load i32, ptr %slice_group_change_rate_minus1.i.i, align 8
  %add.i68.i = add i32 %39, 1
  %slice_group_change_cycle.i.i = getelementptr inbounds %struct.ImageParameters, ptr %img, i64 0, i32 140
  %40 = load i32, ptr %slice_group_change_cycle.i.i, align 4
  %mul.i69.i = mul i32 %add.i68.i, %40
  %cond.i.i.i = tail call i32 @llvm.smin.i32(i32 %mul.i69.i, i32 %5)
  %cmp136.not.i.i = icmp eq i32 %5, 0
  br i1 %cmp136.not.i.i, label %FmoGenerateMapUnitToSliceGroupMap.exit, label %for.body.i70.i

for.body.i70.i:                                   ; preds = %sw.bb24.i, %for.body.i70.i
  %indvars.iv.i71.i = phi i64 [ %indvars.iv.next.i73.i, %for.body.i70.i ], [ 0, %sw.bb24.i ]
  %41 = load ptr, ptr @MapUnitToSliceGroupMap, align 8
  %arrayidx.i72.i = getelementptr inbounds i8, ptr %41, i64 %indvars.iv.i71.i
  store i8 2, ptr %arrayidx.i72.i, align 1
  %indvars.iv.next.i73.i = add nuw nsw i64 %indvars.iv.i71.i, 1
  %42 = load i32, ptr @PicSizeInMapUnits, align 4
  %43 = zext i32 %42 to i64
  %cmp.i74.i = icmp ult i64 %indvars.iv.next.i73.i, %43
  br i1 %cmp.i74.i, label %for.body.i70.i, label %for.end.i75.i

for.end.i75.i:                                    ; preds = %for.body.i70.i
  %44 = icmp eq i32 %42, 0
...
for.body9.preheader.i.i:                          ; preds = %for.end.i75.i
  %45 = load i32, ptr %slice_group_change_direction_flag.i.i, align 4
  %sub5.i.i = add i32 %45, -1
  %46 = load i32, ptr %PicHeightInMapUnits.i, align 4
  %sub2.i.i = sub i32 %46, %45
  %div3128.i.i = lshr i32 %sub2.i.i, 1
  %47 = load i32, ptr %PicWidthInMbs.i, align 8
  %sub.i.i = sub i32 %47, %45
  %div127.i.i = lshr i32 %sub.i.i, 1
  %.pre149.i.i = load ptr, ptr @MapUnitToSliceGroupMap, align 8
...
for.body9.i.i:                                    ; preds = %for.inc81.i.i, %for.body9.preheader.i.i
  ...
  %49 = load i32, ptr %PicWidthInMbs.i, align 8
...
if.then.i.i:                                      ; preds = %for.body9.i.i
  ...
  store i8 %conv19.i.i, ptr %arrayidx14.i.i, align 1
  %.pre.i77.i = load ptr, ptr @MapUnitToSliceGroupMap, align 8
  br label %if.end.i.i
...
if.then29.i.i:                                    ; preds = %if.end.i.i
  ...
  %53 = load i32, ptr %slice_group_change_direction_flag.i.i, align 4
...
if.then40.i.i:                                    ; preds = %if.else.i.i
  ...
  %54 = load i32, ptr %PicWidthInMbs.i, align 8
  %sub43.i.i = add nsw i32 %54, -1
  %cond.i133.i.i = tail call i32 @llvm.smin.i32(i32 %add41.i.i, i32 %sub43.i.i)
  %55 = load i32, ptr %slice_group_change_direction_flag.i.i, align 4
...
if.then54.i.i:                                    ; preds = %if.else48.i.i
  ...
  %57 = load i32, ptr %slice_group_change_direction_flag.i.i, align 4
...
if.then66.i.i:                                    ; preds = %if.else60.i.i
  ...
  %58 = load i32, ptr %PicHeightInMapUnits.i, align 4
  %sub69.i.i = add nsw i32 %58, -1
  %cond.i135.i.i = tail call i32 @llvm.smin.i32(i32 %add67.i.i, i32 %sub69.i.i)
  %59 = load i32, ptr %slice_group_change_direction_flag.i.i, align 4
...
for.inc81.i.i:                                    ; preds = %if.else74.i.i, %if.then66.i.i, %if.then54.i.i, %if.then40.i.i, %if.then29.i.i
  ...
  %60 = load i32, ptr @PicSizeInMapUnits, align 4
...
for.body.preheader.i.i:                           ; preds = %sw.bb25.i
  ...
  %img.val.i = load i32, ptr %61, align 4
  %62 = load i32, ptr %slice_group_change_direction_flag.i78.i, align 4
  ...
  %63 = load i32, ptr %slice_group_change_rate_minus1.i79.i, align 8
...
for.body.i84.i:                                   ; preds = %for.body.i84.i, %for.body.preheader.i.i
  %indvars.iv.i85.i = phi i64 [ 0, %for.body.preheader.i.i ], [ %indvars.iv.next.i89.i, %for.body.i84.i ]
  %cmp1.i86.i = icmp ult i64 %indvars.iv.i85.i, %64
  %65 = load i32, ptr %slice_group_change_direction_flag.i78.i, align 4
  %conv.i87.i = trunc i32 %65 to i8
  %conv5.i.i = sub i8 1, %conv.i87.i
  %conv.sink.i.i = select i1 %cmp1.i86.i, i8 %conv.i87.i, i8 %conv5.i.i
  %66 = load ptr, ptr @MapUnitToSliceGroupMap, align 8
  %arrayidx.i88.i = getelementptr inbounds i8, ptr %66, i64 %indvars.iv.i85.i
  store i8 %conv.sink.i.i, ptr %arrayidx.i88.i, align 1
  %indvars.iv.next.i89.i = add nuw nsw i64 %indvars.iv.i85.i, 1
  %67 = load i32, ptr @PicSizeInMapUnits, align 4
  %68 = zext i32 %67 to i64
  %cmp.i90.i = icmp ult i64 %indvars.iv.next.i89.i, %68
  br i1 %cmp.i90.i, label %for.body.i84.i, label %FmoGenerateMapUnitToSliceGroupMap.exit
...
sw.bb26.i:                                        ; preds = %if.end20.i
  ...
  %71 = load i32, ptr %slice_group_change_direction_flag.i97.i, align 4
  ...
  %72 = load i32, ptr %PicWidthInMbs.i, align 8
...
for.cond1.preheader.lr.ph.i.i:                    ; preds = %sw.bb26.i
  %73 = load i32, ptr %PicHeightInMapUnits.i, align 4
...
for.body3.i.i:                                    ; preds = %for.cond1.preheader.i.i, %for.body3.i.i
  ...
  %76 = load i32, ptr %slice_group_change_direction_flag.i97.i, align 4
  ...
  %77 = load ptr, ptr @MapUnitToSliceGroupMap, align 8
  %78 = load i32, ptr %PicWidthInMbs.i, align 8
  ...
  store i8 %conv.sink.i104.i, ptr %arrayidx.i106.i, align 1
  %inc17.i.i = add nuw i32 %i.036.i.i, 1
  %79 = load i32, ptr %PicHeightInMapUnits.i, align 4
...
for.inc18.loopexit.i.i:                           ; preds = %for.body3.i.i
  %.pre.i107.i = load i32, ptr %PicWidthInMbs.i, align 8
...
for.inc18.i.i:                                    ; preds = %for.inc18.loopexit.i.i, %for.cond1.preheader.i.i
  ...
  br i1 %cmp.i108.i, label %for.cond1.preheader.i.i, label %FmoGenerateMapUnitToSliceGroupMap.exit
...
for.body.i110.i:                                  ; preds = %for.body.i110.i, %for.body.lr.ph.i109.i
  %indvars.iv.i111.i = phi i64 [ 0, %for.body.lr.ph.i109.i ], [ %indvars.iv.next.i113.i, %for.body.i110.i ]
  %82 = load ptr, ptr %slice_group_id.i.i, align 8
  %arrayidx.i112.i = getelementptr inbounds i8, ptr %82, i64 %indvars.iv.i111.i
  %83 = load i8, ptr %arrayidx.i112.i, align 1
  %84 = load ptr, ptr @MapUnitToSliceGroupMap, align 8
  %arrayidx2.i.i = getelementptr inbounds i8, ptr %84, i64 %indvars.iv.i111.i
  store i8 %83, ptr %arrayidx2.i.i, align 1
  %indvars.iv.next.i113.i = add nuw nsw i64 %indvars.iv.i111.i, 1
  %85 = load i32, ptr @PicSizeInMapUnits, align 4
  %86 = zext i32 %85 to i64
  %cmp.i114.i = icmp ult i64 %indvars.iv.next.i113.i, %86
  br i1 %cmp.i114.i, label %for.body.i110.i, label %FmoGenerateMapUnitToSliceGroupMap.exit
...
FmoGenerateMapUnitToSliceGroupMap.exit:           ; preds = %for.body.i110.i, %for.inc18.i.i, %for.body.i84.i, %for.inc81.i.i, %for.cond2.loopexit.i.i, %for.body.i.i, %do.body.i.i, %do.cond.i.i, %if.then17.i, %sw.bb22.i, %for.end.i.i, %sw.bb24.i, %for.end.i75.i, %sw.bb25.i, %sw.bb26.i, %for.cond1.preheader.lr.ph.i.i, %sw.bb27.i
  %87 = load ptr, ptr @MBAmap, align 8
...
if.end.i:                                         ; preds = %if.then.i6, %FmoGenerateMapUnitToSliceGroupMap.exit
  ...
  %88 = load i32, ptr %PicSizeInMbs.i, align 4
  %conv.i7 = zext i32 %88 to i64
  %call.i8 = tail call noalias ptr @malloc(i64 noundef %conv.i7) #16
  store ptr %call.i8, ptr @MBAmap, align 8
  %cmp.i9 = icmp eq ptr %call.i8, null
  br i1 %cmp.i9, label %if.then2.i14, label %if.end8.i

if.then2.i14:                                     ; preds = %if.end.i
...
if.end8.i:                                        ; preds = %if.end.i
  ...
  %89 = load i32, ptr %frame_mbs_only_flag.i, align 4
...
lor.lhs.false.i:                                  ; preds = %if.end8.i
  ...
  %90 = load i32, ptr %field_picture.i, align 8
...
for.body.i:                                       ; preds = %if.then11.i, %for.body.i
  %indvars.iv.i10 = phi i64 [ %indvars.iv.next.i11, %for.body.i ], [ 0, %if.then11.i ]
  %91 = load ptr, ptr @MapUnitToSliceGroupMap, align 8
  %arrayidx.i = getelementptr inbounds i8, ptr %91, i64 %indvars.iv.i10
  %92 = load i8, ptr %arrayidx.i, align 1
  %93 = load ptr, ptr @MBAmap, align 8
  %arrayidx16.i = getelementptr inbounds i8, ptr %93, i64 %indvars.iv.i10
  store i8 %92, ptr %arrayidx16.i, align 1
  %indvars.iv.next.i11 = add nuw nsw i64 %indvars.iv.i10, 1
  %94 = load i32, ptr %PicSizeInMbs.i, align 4
  %95 = zext i32 %94 to i64
  %cmp13.i = icmp ult i64 %indvars.iv.next.i11, %95
  br i1 %cmp13.i, label %for.body.i, label %FmoGenerateMBAmap.exit

if.else.i:                                        ; preds = %lor.lhs.false.i
  %mb_adaptive_frame_field_flag.i = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 26
  %96 = load i32, ptr %mb_adaptive_frame_field_flag.i, align 4
...
for.body25.i:                                     ; preds = %for.cond21.preheader.i, %for.body25.i
  ...
  %97 = load ptr, ptr @MapUnitToSliceGroupMap, align 8
  ...
  %99 = load ptr, ptr @MBAmap, align 8
  %arrayidx29.i = getelementptr inbounds i8, ptr %99, i64 %indvars.iv87.i
  store i8 %98, ptr %arrayidx29.i, align 1
  %indvars.iv.next88.i = add nuw nsw i64 %indvars.iv87.i, 1
  %100 = load i32, ptr %PicSizeInMbs.i, align 4
  %101 = zext i32 %100 to i64
  %cmp23.i = icmp ult i64 %indvars.iv.next88.i, %101
  br i1 %cmp23.i, label %for.body25.i, label %FmoGenerateMBAmap.exit
...
for.body38.i:                                     ; preds = %for.cond34.preheader.i, %for.body38.i
  ...
  %102 = load ptr, ptr @MapUnitToSliceGroupMap, align 8
  %103 = load i32, ptr %PicWidthInMbs.i, align 8
  ...
  %105 = load i8, ptr %arrayidx45.i, align 1
  %106 = load ptr, ptr @MBAmap, align 8
  %arrayidx47.i = getelementptr inbounds i8, ptr %106, i64 %indvars.iv90.i
  store i8 %105, ptr %arrayidx47.i, align 1
  %indvars.iv.next91.i = add nuw nsw i64 %indvars.iv90.i, 1
  %107 = load i32, ptr %PicSizeInMbs.i, align 4
  %108 = zext i32 %107 to i64
  %cmp36.i = icmp ult i64 %indvars.iv.next91.i, %108
  br i1 %cmp36.i, label %for.body38.i, label %FmoGenerateMBAmap.exit
...
entry:
  %0 = load ptr, ptr @MBAmap, align 8
  %tobool.not = icmp eq ptr %0, null
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  tail call void @free(ptr noundef nonnull %0) #15
  store ptr null, ptr @MBAmap, align 8
  br label %if.end
...
land.rhs.i.us:                                    ; preds = %entry, %while.body.i.us
  ...
  %3 = load i8, ptr %arrayidx.i.i.us, align 1
...
while.body.i.us:                                  ; preds = %land.rhs.i.us
  ...
  br i1 %exitcond.not.i.us, label %FmoGetFirstMBOfSliceGroup.exit.us, label %land.rhs.i.us
...
FmoGetFirstMBOfSliceGroup.exit.us:                ; preds = %while.body.i.us, %while.end.loopexit.split.loop.exit12.i.us
  ...
  store i32 %i.0..i.us, ptr @FirstMBInSlice, align 16
...
land.rhs.i.us.1:                                  ; preds = %while.body.i.us.1, %FmoGetFirstMBOfSliceGroup.exit.us
  ...
  %5 = load i8, ptr %arrayidx.i.i.us.1, align 1
...
while.body.i.us.1:                                ; preds = %land.rhs.i.us.1
  ...
  br i1 %exitcond.not.i.us.1, label %FmoGetFirstMBOfSliceGroup.exit.us.1, label %land.rhs.i.us.1
...
FmoGetFirstMBOfSliceGroup.exit.us.1:              ; preds = %while.body.i.us.1, %while.end.loopexit.split.loop.exit12.i.us.1
  ...
  store i32 %i.0..i.us.1, ptr getelementptr inbounds ([8 x i32], ptr @FirstMBInSlice, i64 0, i64 1), align 4
...
land.rhs.i.us.2:                                  ; preds = %while.body.i.us.2, %FmoGetFirstMBOfSliceGroup.exit.us.1
  ...
  %7 = load i8, ptr %arrayidx.i.i.us.2, align 1
...
while.body.i.us.2:                                ; preds = %land.rhs.i.us.2
  ...
  br i1 %exitcond.not.i.us.2, label %FmoGetFirstMBOfSliceGroup.exit.us.2, label %land.rhs.i.us.2
...
FmoGetFirstMBOfSliceGroup.exit.us.2:              ; preds = %while.body.i.us.2, %while.end.loopexit.split.loop.exit12.i.us.2
  ...
  store i32 %i.0..i.us.2, ptr getelementptr inbounds ([8 x i32], ptr @FirstMBInSlice, i64 0, i64 2), align 8
...
land.rhs.i.us.3:                                  ; preds = %while.body.i.us.3, %FmoGetFirstMBOfSliceGroup.exit.us.2
  ...
  %9 = load i8, ptr %arrayidx.i.i.us.3, align 1
...
while.body.i.us.3:                                ; preds = %land.rhs.i.us.3
  ...
  br i1 %exitcond.not.i.us.3, label %FmoGetFirstMBOfSliceGroup.exit.us.3, label %land.rhs.i.us.3
...
FmoGetFirstMBOfSliceGroup.exit.us.3:              ; preds = %while.body.i.us.3, %while.end.loopexit.split.loop.exit12.i.us.3
  ...
  store i32 %i.0..i.us.3, ptr getelementptr inbounds ([8 x i32], ptr @FirstMBInSlice, i64 0, i64 3), align 4
...
land.rhs.i.us.4:                                  ; preds = %while.body.i.us.4, %FmoGetFirstMBOfSliceGroup.exit.us.3
  ...
  %11 = load i8, ptr %arrayidx.i.i.us.4, align 1
...
while.body.i.us.4:                                ; preds = %land.rhs.i.us.4
  ...
  br i1 %exitcond.not.i.us.4, label %FmoGetFirstMBOfSliceGroup.exit.us.4, label %land.rhs.i.us.4
...
FmoGetFirstMBOfSliceGroup.exit.us.4:              ; preds = %while.body.i.us.4, %while.end.loopexit.split.loop.exit12.i.us.4
  ...
  store i32 %i.0..i.us.4, ptr getelementptr inbounds ([8 x i32], ptr @FirstMBInSlice, i64 0, i64 4), align 16
...
land.rhs.i.us.5:                                  ; preds = %while.body.i.us.5, %FmoGetFirstMBOfSliceGroup.exit.us.4
  ...
  %13 = load i8, ptr %arrayidx.i.i.us.5, align 1
...
while.body.i.us.5:                                ; preds = %land.rhs.i.us.5
  ...
  br i1 %exitcond.not.i.us.5, label %FmoGetFirstMBOfSliceGroup.exit.us.5, label %land.rhs.i.us.5
...
FmoGetFirstMBOfSliceGroup.exit.us.5:              ; preds = %while.body.i.us.5, %while.end.loopexit.split.loop.exit12.i.us.5
  ...
  store i32 %i.0..i.us.5, ptr getelementptr inbounds ([8 x i32], ptr @FirstMBInSlice, i64 0, i64 5), align 4
...
land.rhs.i.us.6:                                  ; preds = %while.body.i.us.6, %FmoGetFirstMBOfSliceGroup.exit.us.5
  ...
  %15 = load i8, ptr %arrayidx.i.i.us.6, align 1
...
while.body.i.us.6:                                ; preds = %land.rhs.i.us.6
  ...
  br i1 %exitcond.not.i.us.6, label %FmoGetFirstMBOfSliceGroup.exit.us.6, label %land.rhs.i.us.6
...
FmoGetFirstMBOfSliceGroup.exit.us.6:              ; preds = %while.body.i.us.6, %while.end.loopexit.split.loop.exit12.i.us.6
  ...
  store i32 %i.0..i.us.6, ptr getelementptr inbounds ([8 x i32], ptr @FirstMBInSlice, i64 0, i64 6), align 8
...
land.rhs.i.us.7:                                  ; preds = %while.body.i.us.7, %FmoGetFirstMBOfSliceGroup.exit.us.6
  ...
  %17 = load i8, ptr %arrayidx.i.i.us.7, align 1
...
while.body.i.us.7:                                ; preds = %land.rhs.i.us.7
  ...
  br i1 %exitcond.not.i.us.7, label %FmoGetFirstMBOfSliceGroup.exit.us.7, label %land.rhs.i.us.7
...
FmoGetFirstMBOfSliceGroup.exit.us.7:              ; preds = %while.body.i.us.7, %while.end.loopexit.split.loop.exit12.i.us.7
  ...
  store i32 %i.0..i.us.7, ptr getelementptr inbounds ([8 x i32], ptr @FirstMBInSlice, i64 0, i64 7), align 4
  br label %for.end
...
land.rhs:                                         ; preds = %while.cond
  ...
  br i1 %cmp1.not, label %while.end.split.loop.exit11, label %while.cond
...
land.rhs:                                         ; preds = %while.cond
  ...
  br i1 %cmp1.not, label %while.end.split.loop.exit13, label %while.cond
...
for.body.epil:                                    ; preds = %for.end.loopexit.unr-lcssa, %for.body.epil
  ...
  %12 = load i8, ptr %arrayidx.i.epil, align 1
...
entry:
  ...
  %3 = load i32, ptr %PicSizeInMbs.i, align 4
  %4 = sext i32 %3 to i64
...
land.rhs.i:                                       ; preds = %while.cond.i
  ...
  br i1 %cmp1.not.i, label %while.end.split.loop.exit11.i, label %while.cond.i
