; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/parsetcommon.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/parsetcommon.c"
...
entry:
  %call = tail call noalias dereferenceable_or_null(240) ptr @calloc(i64 noundef 240, i64 noundef 1) #6
...
entry:
  %call = tail call noalias dereferenceable_or_null(2132) ptr @calloc(i64 noundef 2132, i64 noundef 1) #6
  %cmp = icmp eq ptr %call, null
  br i1 %cmp, label %if.then, label %if.end
...
if.end:                                           ; preds = %if.then, %entry
  tail call void @free(ptr noundef nonnull %pps) #7
  ret void
}
...
entry:
  tail call void @free(ptr noundef %sps) #7
  ret void
}
...
!5 = !{!6, !10, i64 176}
!6 = !{!"", !7, i64 0, !9, i64 4, !9, i64 8, !7, i64 12, !7, i64 16, !7, i64 20, !7, i64 24, !7, i64 56, !9, i64 60, !9, i64 64, !7, i64 68, !7, i64 100, !7, i64 132, !7, i64 164, !9, i64 168, !9, i64 172, !10, i64 176, !9, i64 184, !9, i64 188, !7, i64 192, !9, i64 196, !9, i64 200, !9, i64 204, !9, i64 208, !9, i64 212, !9, i64 216, !7, i64 220, !7, i64 224, !7, i64 228, !7, i64 232}
