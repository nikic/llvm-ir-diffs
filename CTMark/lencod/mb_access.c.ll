...
lor.lhs.false.i160:                               ; preds = %land.end
  ...
  %16 = load i32, ptr %PicSizeInMbs.i161, align 4, !tbaa !9
...
if.end.i164:                                      ; preds = %lor.lhs.false.i160
  ...
  %17 = load i32, ptr %DeblockCall.i165, align 4, !tbaa !15
...
mb_is_available.exit175:                          ; preds = %land.end, %lor.lhs.false.i160, %if.then2.i168, %if.end10.i167
  ...
  store i32 %retval.0.i163, ptr %mbAvailB, align 8, !tbaa !29
...
lor.lhs.false.i177:                               ; preds = %mb_is_available.exit175
  ...
  %21 = load i32, ptr %PicSizeInMbs.i178, align 4, !tbaa !9
...
if.end.i181:                                      ; preds = %lor.lhs.false.i177
  ...
  %22 = load i32, ptr %DeblockCall.i182, align 4, !tbaa !15
...
lor.lhs.false.i194:                               ; preds = %land.end26
  ...
  %30 = load i32, ptr %PicSizeInMbs.i195, align 4, !tbaa !9
...
if.end.i198:                                      ; preds = %lor.lhs.false.i194
  ...
  %31 = load i32, ptr %DeblockCall.i199, align 4, !tbaa !15
...
lor.lhs.false.i211:                               ; preds = %if.else
  ...
  %38 = load i32, ptr %PicSizeInMbs.i212, align 4, !tbaa !9
...
if.end.i215:                                      ; preds = %lor.lhs.false.i211
  ...
  %39 = load i32, ptr %DeblockCall.i216, align 4, !tbaa !15
...
lor.lhs.false.i228:                               ; preds = %land.end59
  ...
  %47 = load i32, ptr %PicSizeInMbs.i229, align 4, !tbaa !9
...
if.end.i232:                                      ; preds = %lor.lhs.false.i228
  ...
  %48 = load i32, ptr %DeblockCall.i233, align 4, !tbaa !15
...
mb_is_available.exit243.thread:                   ; preds = %if.then2.i236, %if.end10.i235
  ...
  store i32 %retval.0.i231.ph, ptr %mbAvailB64287, align 8, !tbaa !29
...
mb_is_available.exit243.lor.lhs.false.i245_crit_edge: ; preds = %mb_is_available.exit243
  ...
  %.pre = load i32, ptr %PicSizeInMbs.i246.phi.trans.insert, align 4, !tbaa !9
  br label %lor.lhs.false.i245
...
if.end.i249:                                      ; preds = %lor.lhs.false.i245
  ...
  %54 = load i32, ptr %DeblockCall.i250, align 4, !tbaa !15
...
lor.lhs.false.i262:                               ; preds = %land.end74
  ...
  %63 = load i32, ptr %PicSizeInMbs.i263, align 4, !tbaa !9
...
if.end.i266:                                      ; preds = %lor.lhs.false.i262
  ...
  %64 = load i32, ptr %DeblockCall.i267, align 4, !tbaa !15
...
if.else:                                          ; preds = %if.then19
  %mbAddrA = getelementptr inbounds %struct.macroblock, ptr %1, i64 %idxprom, i32 22
  %7 = load i32, ptr %mbAddrA, align 4, !tbaa !22
...
if.else41:                                        ; preds = %if.then18
  ...
  %10 = load i32, ptr %mbAddrD45, align 8, !tbaa !26
...
if.then76:                                        ; preds = %if.then16
  ...
  %14 = load i32, ptr %mbAddrA83, align 4, !tbaa !22
...
if.then218:                                       ; preds = %if.then214
  %mbAddrB = getelementptr inbounds %struct.macroblock, ptr %1, i64 %idxprom, i32 23
  %21 = load i32, ptr %mbAddrB, align 8, !tbaa !24
...
if.else243:                                       ; preds = %if.then211
  ...
  %25 = load i32, ptr %mbAddrB248, align 8, !tbaa !24
...
if.else318:                                       ; preds = %if.then304
  ...
  %34 = load i32, ptr %mbAddrC323, align 4, !tbaa !25
