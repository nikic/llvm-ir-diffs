; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/mb_access.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/mb_access.c"
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  %2 = load i32, ptr %DeblockCall, align 4
...
entry:
  ...
  %4 = load i32, ptr %MbaffFrameFlag, align 4
...
lor.lhs.false.i:                                  ; preds = %if.then
  ...
  %7 = load i32, ptr %PicSizeInMbs.i, align 4
...
if.end.i:                                         ; preds = %lor.lhs.false.i
  ...
  %8 = load i32, ptr %DeblockCall.i, align 4
...
if.then2.i:                                       ; preds = %if.end.i
  ...
  %9 = load ptr, ptr %mb_data.i, align 8
...
land.end:                                         ; preds = %if.then2.i, %if.then, %lor.lhs.false.i, %land.rhs
  ...
  br i1 %cmp.i159, label %mb_is_available.exit175, label %lor.lhs.false.i160

lor.lhs.false.i160:                               ; preds = %land.end
  %PicSizeInMbs.i161 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 119
  %16 = load i32, ptr %PicSizeInMbs.i161, align 4
  %cmp1.not.i162 = icmp sgt i32 %16, %mul2
  br i1 %cmp1.not.i162, label %if.end.i164, label %mb_is_available.exit175

if.end.i164:                                      ; preds = %lor.lhs.false.i160
  %DeblockCall.i165 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 136
  %17 = load i32, ptr %DeblockCall.i165, align 4
  %tobool.not.i166 = icmp eq i32 %17, 0
  br i1 %tobool.not.i166, label %if.then2.i168, label %if.end10.i167

if.then2.i168:                                    ; preds = %if.end.i164
  %mb_data.i169 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 61
  %18 = load ptr, ptr %mb_data.i169, align 8
  %idxprom.i170 = zext i32 %mul2 to i64
  %arrayidx.i171 = getelementptr inbounds %struct.macroblock, ptr %18, i64 %idxprom.i170
  %19 = load i32, ptr %arrayidx.i171, align 8
  %arrayidx5.i173 = getelementptr inbounds %struct.macroblock, ptr %18, i64 %idxprom
  %20 = load i32, ptr %arrayidx5.i173, align 8
  %cmp7.not.i174 = icmp eq i32 %19, %20
  br i1 %cmp7.not.i174, label %if.end10.i167, label %mb_is_available.exit175

if.end10.i167:                                    ; preds = %if.then2.i168, %if.end.i164
  br label %mb_is_available.exit175

mb_is_available.exit175:                          ; preds = %land.end, %lor.lhs.false.i160, %if.then2.i168, %if.end10.i167
  %retval.0.i163 = phi i32 [ 1, %if.end10.i167 ], [ 0, %lor.lhs.false.i160 ], [ 0, %land.end ], [ 0, %if.then2.i168 ]
  %mbAvailB = getelementptr inbounds %struct.macroblock, ptr %2, i64 %idxprom, i32 27
  store i32 %retval.0.i163, ptr %mbAvailB, align 8
  %cmp.i176 = icmp slt i32 %mul5, 0
  br i1 %cmp.i176, label %land.end26, label %lor.lhs.false.i177

lor.lhs.false.i177:                               ; preds = %mb_is_available.exit175
  %PicSizeInMbs.i178 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 119
  %21 = load i32, ptr %PicSizeInMbs.i178, align 4
  %cmp1.not.i179 = icmp sgt i32 %21, %mul5
  br i1 %cmp1.not.i179, label %if.end.i181, label %land.end26

if.end.i181:                                      ; preds = %lor.lhs.false.i177
  %DeblockCall.i182 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 136
  %22 = load i32, ptr %DeblockCall.i182, align 4
  %tobool.not.i183 = icmp eq i32 %22, 0
  br i1 %tobool.not.i183, label %if.then2.i185, label %land.rhs20

if.then2.i185:                                    ; preds = %if.end.i181
  %mb_data.i186 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 61
  %23 = load ptr, ptr %mb_data.i186, align 8
  %idxprom.i187 = zext i32 %mul5 to i64
  %arrayidx.i188 = getelementptr inbounds %struct.macroblock, ptr %23, i64 %idxprom.i187
  %24 = load i32, ptr %arrayidx.i188, align 8
  %arrayidx5.i190 = getelementptr inbounds %struct.macroblock, ptr %23, i64 %idxprom
  %25 = load i32, ptr %arrayidx5.i190, align 8
  %cmp7.not.i191 = icmp eq i32 %24, %25
  br i1 %cmp7.not.i191, label %land.rhs20, label %land.end26

land.rhs20:                                       ; preds = %if.then2.i185, %if.end.i181
  %26 = load ptr, ptr @PicPos, align 8
...
land.end26:                                       ; preds = %if.then2.i185, %mb_is_available.exit175, %lor.lhs.false.i177, %land.rhs20
  %land.ext27 = phi i32 [ %29, %land.rhs20 ], [ 0, %lor.lhs.false.i177 ], [ 0, %mb_is_available.exit175 ], [ 0, %if.then2.i185 ]
  %mbAvailC = getelementptr inbounds %struct.macroblock, ptr %2, i64 %idxprom, i32 28
  store i32 %land.ext27, ptr %mbAvailC, align 4
  %cmp.i193 = icmp slt i32 %mul9, 0
  br i1 %cmp.i193, label %if.end, label %lor.lhs.false.i194

lor.lhs.false.i194:                               ; preds = %land.end26
  %PicSizeInMbs.i195 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 119
  %30 = load i32, ptr %PicSizeInMbs.i195, align 4
  %cmp1.not.i196 = icmp sgt i32 %30, %mul9
  br i1 %cmp1.not.i196, label %if.end.i198, label %if.end

if.end.i198:                                      ; preds = %lor.lhs.false.i194
  %DeblockCall.i199 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 136
  %31 = load i32, ptr %DeblockCall.i199, align 4
  %tobool.not.i200 = icmp eq i32 %31, 0
  br i1 %tobool.not.i200, label %if.then2.i202, label %land.rhs31

if.then2.i202:                                    ; preds = %if.end.i198
  %mb_data.i203 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 61
  %32 = load ptr, ptr %mb_data.i203, align 8
  %idxprom.i204 = zext i32 %mul9 to i64
  %arrayidx.i205 = getelementptr inbounds %struct.macroblock, ptr %32, i64 %idxprom.i204
  %33 = load i32, ptr %arrayidx.i205, align 8
  %arrayidx5.i207 = getelementptr inbounds %struct.macroblock, ptr %32, i64 %idxprom
  %34 = load i32, ptr %arrayidx5.i207, align 8
  %cmp7.not.i208 = icmp eq i32 %33, %34
  br i1 %cmp7.not.i208, label %land.rhs31, label %if.end

land.rhs31:                                       ; preds = %if.then2.i202, %if.end.i198
...
if.else:                                          ; preds = %entry
  ...
  store i32 %sub38, ptr %mbAddrA39, align 4
  %PicWidthInMbs40 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 116
  %36 = load i32, ptr %PicWidthInMbs40, align 8
  %sub41 = sub i32 %1, %36
  %mbAddrB42 = getelementptr inbounds %struct.macroblock, ptr %2, i64 %idxprom, i32 23
  store i32 %sub41, ptr %mbAddrB42, align 8
  %add45 = add i32 %sub41, 1
  %mbAddrC46 = getelementptr inbounds %struct.macroblock, ptr %2, i64 %idxprom, i32 24
  store i32 %add45, ptr %mbAddrC46, align 4
  %37 = xor i32 %36, -1
  %sub49 = add i32 %1, %37
  %mbAddrD50 = getelementptr inbounds %struct.macroblock, ptr %2, i64 %idxprom, i32 25
  store i32 %sub49, ptr %mbAddrD50, align 8
  %cmp.i210 = icmp slt i32 %1, 1
  br i1 %cmp.i210, label %land.end59, label %lor.lhs.false.i211

lor.lhs.false.i211:                               ; preds = %if.else
  %PicSizeInMbs.i212 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 119
  %38 = load i32, ptr %PicSizeInMbs.i212, align 4
  %cmp1.not.i213.not = icmp slt i32 %38, %1
  br i1 %cmp1.not.i213.not, label %land.end59, label %if.end.i215

if.end.i215:                                      ; preds = %lor.lhs.false.i211
  %DeblockCall.i216 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 136
  %39 = load i32, ptr %DeblockCall.i216, align 4
  %tobool.not.i217 = icmp eq i32 %39, 0
  br i1 %tobool.not.i217, label %if.then2.i219, label %land.rhs54

if.then2.i219:                                    ; preds = %if.end.i215
  %mb_data.i220 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 61
  %40 = load ptr, ptr %mb_data.i220, align 8
  %idxprom.i221 = zext i32 %sub38 to i64
  %arrayidx.i222 = getelementptr inbounds %struct.macroblock, ptr %40, i64 %idxprom.i221
  %41 = load i32, ptr %arrayidx.i222, align 8
  %arrayidx5.i224 = getelementptr inbounds %struct.macroblock, ptr %40, i64 %idxprom
  %42 = load i32, ptr %arrayidx5.i224, align 8
  %cmp7.not.i225 = icmp eq i32 %41, %42
  br i1 %cmp7.not.i225, label %land.rhs54, label %land.end59

land.rhs54:                                       ; preds = %if.then2.i219, %if.end.i215
...
land.end59:                                       ; preds = %if.then2.i219, %if.else, %lor.lhs.false.i211, %land.rhs54
  %land.ext60 = phi i32 [ %46, %land.rhs54 ], [ 0, %lor.lhs.false.i211 ], [ 0, %if.else ], [ 0, %if.then2.i219 ]
  %mbAvailA61 = getelementptr inbounds %struct.macroblock, ptr %2, i64 %idxprom, i32 26
  store i32 %land.ext60, ptr %mbAvailA61, align 4
  %cmp.i227 = icmp slt i32 %sub41, 0
  br i1 %cmp.i227, label %mb_is_available.exit243, label %lor.lhs.false.i228

lor.lhs.false.i228:                               ; preds = %land.end59
  %PicSizeInMbs.i229 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 119
  %47 = load i32, ptr %PicSizeInMbs.i229, align 4
  %cmp1.not.i230 = icmp sgt i32 %47, %sub41
  br i1 %cmp1.not.i230, label %if.end.i232, label %mb_is_available.exit243

if.end.i232:                                      ; preds = %lor.lhs.false.i228
  %DeblockCall.i233 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 136
  %48 = load i32, ptr %DeblockCall.i233, align 4
  %tobool.not.i234 = icmp eq i32 %48, 0
  br i1 %tobool.not.i234, label %if.then2.i236, label %if.end10.i235

if.then2.i236:                                    ; preds = %if.end.i232
  %mb_data.i237 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 61
  %49 = load ptr, ptr %mb_data.i237, align 8
  %idxprom.i238 = zext i32 %sub41 to i64
  %arrayidx.i239 = getelementptr inbounds %struct.macroblock, ptr %49, i64 %idxprom.i238
  %50 = load i32, ptr %arrayidx.i239, align 8
  %arrayidx5.i241 = getelementptr inbounds %struct.macroblock, ptr %49, i64 %idxprom
  %51 = load i32, ptr %arrayidx5.i241, align 8
  %cmp7.not.i242 = icmp eq i32 %50, %51
  br i1 %cmp7.not.i242, label %if.end10.i235, label %mb_is_available.exit243.thread

if.end10.i235:                                    ; preds = %if.then2.i236, %if.end.i232
  br label %mb_is_available.exit243.thread

mb_is_available.exit243.thread:                   ; preds = %if.then2.i236, %if.end10.i235
  %retval.0.i231.ph = phi i32 [ 0, %if.then2.i236 ], [ 1, %if.end10.i235 ]
  %mbAvailB64287 = getelementptr inbounds %struct.macroblock, ptr %2, i64 %idxprom, i32 27
  store i32 %retval.0.i231.ph, ptr %mbAvailB64287, align 8
  br label %lor.lhs.false.i245

mb_is_available.exit243:                          ; preds = %land.end59, %lor.lhs.false.i228
  %mbAvailB64 = getelementptr inbounds %struct.macroblock, ptr %2, i64 %idxprom, i32 27
  store i32 0, ptr %mbAvailB64, align 8
  %cmp.i244 = icmp slt i32 %add45, 0
  br i1 %cmp.i244, label %land.end74, label %mb_is_available.exit243.lor.lhs.false.i245_crit_edge

mb_is_available.exit243.lor.lhs.false.i245_crit_edge: ; preds = %mb_is_available.exit243
  %PicSizeInMbs.i246.phi.trans.insert = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 119
  %.pre = load i32, ptr %PicSizeInMbs.i246.phi.trans.insert, align 4
  br label %lor.lhs.false.i245

lor.lhs.false.i245:                               ; preds = %mb_is_available.exit243.lor.lhs.false.i245_crit_edge, %mb_is_available.exit243.thread
  %52 = phi i32 [ 0, %mb_is_available.exit243.lor.lhs.false.i245_crit_edge ], [ %retval.0.i231.ph, %mb_is_available.exit243.thread ]
  %53 = phi i32 [ %.pre, %mb_is_available.exit243.lor.lhs.false.i245_crit_edge ], [ %47, %mb_is_available.exit243.thread ]
  %cmp1.not.i247 = icmp sgt i32 %53, %add45
  br i1 %cmp1.not.i247, label %if.end.i249, label %land.end74

if.end.i249:                                      ; preds = %lor.lhs.false.i245
  %DeblockCall.i250 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 136
  %54 = load i32, ptr %DeblockCall.i250, align 4
  %tobool.not.i251 = icmp eq i32 %54, 0
  br i1 %tobool.not.i251, label %if.then2.i253, label %land.rhs68

if.then2.i253:                                    ; preds = %if.end.i249
  %mb_data.i254 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 61
  %55 = load ptr, ptr %mb_data.i254, align 8
  %idxprom.i255 = zext i32 %add45 to i64
  %arrayidx.i256 = getelementptr inbounds %struct.macroblock, ptr %55, i64 %idxprom.i255
  %56 = load i32, ptr %arrayidx.i256, align 8
  %arrayidx5.i258 = getelementptr inbounds %struct.macroblock, ptr %55, i64 %idxprom
  %57 = load i32, ptr %arrayidx5.i258, align 8
  %cmp7.not.i259 = icmp eq i32 %56, %57
  br i1 %cmp7.not.i259, label %land.rhs68, label %land.end74

land.rhs68:                                       ; preds = %if.then2.i253, %if.end.i249
  %58 = load ptr, ptr @PicPos, align 8
...
land.end74:                                       ; preds = %if.then2.i253, %mb_is_available.exit243, %lor.lhs.false.i245, %land.rhs68
  %62 = phi i32 [ %52, %land.rhs68 ], [ %52, %lor.lhs.false.i245 ], [ 0, %mb_is_available.exit243 ], [ %52, %if.then2.i253 ]
  %land.ext75 = phi i32 [ %61, %land.rhs68 ], [ 0, %lor.lhs.false.i245 ], [ 0, %mb_is_available.exit243 ], [ 0, %if.then2.i253 ]
  %mbAvailC76 = getelementptr inbounds %struct.macroblock, ptr %2, i64 %idxprom, i32 28
  store i32 %land.ext75, ptr %mbAvailC76, align 4
  %cmp.i261 = icmp slt i32 %sub49, 0
  br i1 %cmp.i261, label %if.end, label %lor.lhs.false.i262

lor.lhs.false.i262:                               ; preds = %land.end74
  %PicSizeInMbs.i263 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 119
  %63 = load i32, ptr %PicSizeInMbs.i263, align 4
  %cmp1.not.i264 = icmp sgt i32 %63, %sub49
  br i1 %cmp1.not.i264, label %if.end.i266, label %if.end

if.end.i266:                                      ; preds = %lor.lhs.false.i262
  %DeblockCall.i267 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 136
  %64 = load i32, ptr %DeblockCall.i267, align 4
  %tobool.not.i268 = icmp eq i32 %64, 0
  br i1 %tobool.not.i268, label %if.then2.i270, label %land.rhs80

if.then2.i270:                                    ; preds = %if.end.i266
  %mb_data.i271 = getelementptr inbounds %struct.ImageParameters, ptr %3, i64 0, i32 61
  %65 = load ptr, ptr %mb_data.i271, align 8
  %idxprom.i272 = zext i32 %sub49 to i64
  %arrayidx.i273 = getelementptr inbounds %struct.macroblock, ptr %65, i64 %idxprom.i272
  %66 = load i32, ptr %arrayidx.i273, align 8
  %arrayidx5.i275 = getelementptr inbounds %struct.macroblock, ptr %65, i64 %idxprom
  %67 = load i32, ptr %arrayidx5.i275, align 8
  %cmp7.not.i276 = icmp eq i32 %66, %67
  br i1 %cmp7.not.i276, label %land.rhs80, label %if.end

land.rhs80:                                       ; preds = %if.then2.i270, %if.end.i266
...
if.end.sink.split:                                ; preds = %land.rhs31, %land.rhs80
  ...
  %.ph293 = phi i32 [ %62, %land.rhs80 ], [ %retval.0.i163, %land.rhs31 ]
  %.ph294 = phi i32 [ %sub38, %land.rhs80 ], [ %mul, %land.rhs31 ]
  %.ph295 = phi i32 [ %land.ext60, %land.rhs80 ], [ %land.ext, %land.rhs31 ]
  %69 = load ptr, ptr %arrayidx82.sink, align 8
  %70 = load i32, ptr %69, align 4
  %cmp84 = icmp ne i32 %70, 0
  %71 = zext i1 %cmp84 to i32
  br label %if.end

if.end:                                           ; preds = %if.end.sink.split, %lor.lhs.false.i262, %land.end74, %if.then2.i270, %lor.lhs.false.i194, %land.end26, %if.then2.i202
  %land.ext86.sink = phi i32 [ 0, %lor.lhs.false.i194 ], [ 0, %land.end26 ], [ 0, %if.then2.i202 ], [ 0, %lor.lhs.false.i262 ], [ 0, %land.end74 ], [ 0, %if.then2.i270 ], [ %71, %if.end.sink.split ]
  %72 = phi i32 [ %mul2, %lor.lhs.false.i194 ], [ %mul2, %land.end26 ], [ %mul2, %if.then2.i202 ], [ %sub41, %lor.lhs.false.i262 ], [ %sub41, %land.end74 ], [ %sub41, %if.then2.i270 ], [ %.ph, %if.end.sink.split ]
  %73 = phi i32 [ %retval.0.i163, %lor.lhs.false.i194 ], [ %retval.0.i163, %land.end26 ], [ %retval.0.i163, %if.then2.i202 ], [ %62, %lor.lhs.false.i262 ], [ %62, %land.end74 ], [ %62, %if.then2.i270 ], [ %.ph293, %if.end.sink.split ]
  %74 = phi i32 [ %mul, %lor.lhs.false.i194 ], [ %mul, %land.end26 ], [ %mul, %if.then2.i202 ], [ %sub38, %lor.lhs.false.i262 ], [ %sub38, %land.end74 ], [ %sub38, %if.then2.i270 ], [ %.ph294, %if.end.sink.split ]
  %75 = phi i32 [ %land.ext, %lor.lhs.false.i194 ], [ %land.ext, %land.end26 ], [ %land.ext, %if.then2.i202 ], [ %land.ext60, %lor.lhs.false.i262 ], [ %land.ext60, %land.end74 ], [ %land.ext60, %if.then2.i270 ], [ %.ph295, %if.end.sink.split ]
  %mbAvailD87 = getelementptr inbounds %struct.macroblock, ptr %2, i64 %idxprom, i32 29
  store i32 %land.ext86.sink, ptr %mbAvailD87, align 8
...
if.then:                                          ; preds = %entry
  ...
  store i32 %5, ptr %mb_addr, align 4
...
if.end49.thread122:                               ; preds = %if.else26
  ...
  store i32 %curr_mb_nr, ptr %mb_addr35, align 4
...
lor.lhs.false:                                    ; preds = %if.end49.thread, %if.end49
  %DeblockCall = getelementptr inbounds %struct.ImageParameters, ptr %0, i64 0, i32 136
  %10 = load i32, ptr %DeblockCall, align 4
...
lor.lhs.false.if.then52_crit_edge:                ; preds = %lor.lhs.false
  ...
  %.pre = load i32, ptr %mb_addr53.phi.trans.insert, align 4
  br label %if.then52
...
if.then52:                                        ; preds = %lor.lhs.false.if.then52_crit_edge, %if.end49.thread122, %if.end49
  ...
  store i32 %add63, ptr %pos_y, align 4
  br label %if.end64
...
if.else:                                          ; preds = %if.then19
  ...
  store i32 %7, ptr %mb_addr23, align 4
  %mbAvailA = getelementptr inbounds %struct.macroblock, ptr %1, i64 %idxprom, i32 26
...
if.then51:                                        ; preds = %if.then44
  ...
  %12 = load i32, ptr %mb_field56, align 8
...
if.then58:                                        ; preds = %if.then51
  ...
  store i32 %inc60, ptr %mb_addr46, align 4
...
if.then89:                                        ; preds = %if.then82
  ...
  %16 = load i32, ptr %mb_field94, align 8
...
if.else97:                                        ; preds = %if.then89
  ...
  store i32 %add101, ptr %mb_addr84, align 4
...
if.then112:                                       ; preds = %if.else105
  ...
  %17 = load i32, ptr %mb_field117, align 8
...
if.then119:                                       ; preds = %if.then112
  ...
  store i32 %inc121, ptr %mb_addr84, align 4
  br label %if.then358

if.else122:                                       ; preds = %if.then112
  %and123 = and i32 %yN, 1
  %add127 = add nsw i32 %14, %and123
  store i32 %add127, ptr %mb_addr84, align 4
...
if.then144:                                       ; preds = %if.then137
  ...
  %18 = load i32, ptr %mb_field149, align 8
...
if.else156:                                       ; preds = %if.then151
  ...
  store i32 %inc158, ptr %mb_addr84, align 4
...
if.then172:                                       ; preds = %if.else165
  ...
  %19 = load i32, ptr %mb_field177, align 8
...
if.else186:                                       ; preds = %if.then179
  ...
  store i32 %inc188, ptr %mb_addr84, align 4
...
if.else193:                                       ; preds = %if.then172
  ...
  store i32 %inc195, ptr %mb_addr84, align 4
  br label %if.then358
...
if.then211:                                       ; preds = %if.then208
  ...
  %20 = load i32, ptr %mb_field212, align 8
...
land.lhs.true224:                                 ; preds = %if.then221
  ...
  %24 = load i32, ptr %mb_field229, align 8
...
if.then231:                                       ; preds = %land.lhs.true224, %if.then221
  ...
  store i32 %add233, ptr %mb_addr219, align 4
  br label %if.end353
...
if.then247:                                       ; preds = %if.else243
  ...
  store i32 %25, ptr %mb_addr249, align 4
  %mbAvailB250 = getelementptr inbounds %struct.macroblock, ptr %1, i64 %idxprom, i32 27
  %26 = load i32, ptr %mbAvailB250, align 8
  store i32 %26, ptr %pix, align 4
...
if.then254:                                       ; preds = %if.then247
  ...
  %27 = load i32, ptr %mb_field259, align 8
...
if.then261:                                       ; preds = %if.then254
  ...
  store i32 %inc263, ptr %mb_addr249, align 4
...
land.lhs.true279:                                 ; preds = %if.else276
  ...
  %29 = load i32, ptr %DeblockCall280, align 4
...
if.then304:                                       ; preds = %if.else301
  ...
  %31 = load i32, ptr %mb_field305, align 8
...
if.then322:                                       ; preds = %if.else318
  ...
  store i32 %34, ptr %mb_addr324, align 4
  %mbAvailC325 = getelementptr inbounds %struct.macroblock, ptr %1, i64 %idxprom, i32 28
  %35 = load i32, ptr %mbAvailC325, align 4
  store i32 %35, ptr %pix, align 4
...
if.then329:                                       ; preds = %if.then322
  ...
  %36 = load i32, ptr %mb_field334, align 8
...
if.then336:                                       ; preds = %if.then329
  ...
  store i32 %inc338, ptr %mb_addr324, align 4
...
lor.lhs.false:                                    ; preds = %if.then307, %if.else301, %if.then137, %if.else165, %if.then82, %if.else105, %if.else, %if.then44, %if.then322, %if.then247, %if.end353
  ...
  %38 = load i32, ptr %DeblockCall356, align 4
...
if.then358:                                       ; preds = %if.then58, %if.else35, %if.then155, %if.else156, %if.else193, %if.then183, %if.else186, %if.else97, %if.else122, %if.then119, %if.then261, %if.then336, %if.then27, %if.then51, %if.then89, %if.then144, %if.then254, %if.then329, %if.else238, %if.then295, %if.then283, %lor.lhs.false, %if.end353
  ...
  %x = getelementptr inbounds %struct.pix_pos, ptr %pix, i64 0, i32 2
  store i32 %and360, ptr %x, align 4
  %and362 = and i32 %yM.0553, %sub
  %y = getelementptr inbounds %struct.pix_pos, ptr %pix, i64 0, i32 3
  store i32 %and362, ptr %y, align 4
  %mb_addr363 = getelementptr inbounds %struct.pix_pos, ptr %pix, i64 0, i32 1
  %39 = load i32, ptr %mb_addr363, align 4
  %pos_x = getelementptr inbounds %struct.pix_pos, ptr %pix, i64 0, i32 4
  %pos_y = getelementptr inbounds %struct.pix_pos, ptr %pix, i64 0, i32 5
  %40 = load ptr, ptr @get_mb_block_pos, align 8
  ...
  %43 = load i32, ptr %pos_x, align 4
  %mul.i = mul nsw i32 %43, %42
  store i32 %mul.i, ptr %pos_x, align 4
