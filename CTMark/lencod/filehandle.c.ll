; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/filehandle.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/filehandle.c"
...
entry:
  ...
  %0 = load ptr, ptr @WriteNALU, align 8
...
entry:
  ...
  %2 = load i32, ptr %of_mode, align 4
...
sw.epilog:                                        ; preds = %sw.bb1, %sw.bb
  ...
  store ptr %storemerge, ptr @WriteNALU, align 8
  %call5 = tail call ptr @GenerateSeq_parameter_set_NALU() #6
  %4 = load ptr, ptr @WriteNALU, align 8
...
for.body:                                         ; preds = %sw.epilog, %for.body
  ...
  %5 = load ptr, ptr @WriteNALU, align 8
...
if.end:                                           ; preds = %if.then, %for.end
  ...
  store i32 %len.1, ptr %bit_ctr_parametersets_n, align 4
  ret i32 0
}
...
entry:
  ...
  %2 = load ptr, ptr @WriteNALU, align 8
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %3 = load ptr, ptr @WriteNALU, align 8
...
for.end:                                          ; preds = %for.body
  ...
  %5 = load i32, ptr %Generate_SEIVUI, align 4
  %tobool3.not = icmp eq i32 %5, 0
  br i1 %tobool3.not, label %if.end, label %if.then

if.then:                                          ; preds = %for.end
  %call4 = tail call ptr (...) @GenerateSEImessage_NALU() #6
  %6 = load ptr, ptr @WriteNALU, align 8
...
entry:
  %0 = load ptr, ptr @input, align 8
  %of_mode = getelementptr inbounds %struct.InputParameters, ptr %0, i64 0, i32 75
  %1 = load i32, ptr %of_mode, align 4
