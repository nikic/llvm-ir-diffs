; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/intrarefresh.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/intrarefresh.c"
...
entry:
  ...
  store i32 %mul, ptr @NumberOfMBs, align 4
  store i32 %refresh, ptr @NumberIntraPerPicture, align 4
...
if.then:                                          ; preds = %entry
  ...
  store ptr %call, ptr @RefreshPattern, align 8
...
if.end:                                           ; preds = %if.then4, %if.then
  ...
  store ptr %call7, ptr @IntraMBs, align 8
...
if.end11:                                         ; preds = %if.then10, %if.end
  %0 = load i32, ptr @NumberOfMBs, align 4
...
do.body.preheader.preheader:                      ; preds = %if.end11
  %1 = load ptr, ptr @RefreshPattern, align 8
  %2 = zext i32 %0 to i64
  %3 = shl nuw nsw i64 %2, 2
  tail call void @llvm.memset.p0.i64(ptr align 4 %1, i8 -1, i64 %3, i1 false)
...
do.body:                                          ; preds = %do.body.preheader, %do.body
  ...
  %4 = load i32, ptr @NumberOfMBs, align 4
  %rem = srem i32 %call18, %4
  %5 = load ptr, ptr @RefreshPattern, align 8
...
do.end:                                           ; preds = %do.body
  ...
  store i32 %i.140, ptr %arrayidx20.le, align 4
  %inc26 = add nuw nsw i32 %i.140, 1
  %cmp15 = icmp slt i32 %inc26, %4
  br i1 %cmp15, label %do.body.preheader, label %if.end28

if.else:                                          ; preds = %entry
  store ptr null, ptr @RefreshPattern, align 8
  store ptr null, ptr @IntraMBs, align 8
  br label %if.end28
...
entry:
  %0 = load i32, ptr @NumberIntraPerPicture, align 4
  %cmp4 = icmp sgt i32 %0, 0
  br i1 %cmp4, label %for.body.lr.ph, label %cleanup

for.body.lr.ph:                                   ; preds = %entry
  %1 = load ptr, ptr @IntraMBs, align 8
...
entry:
  %0 = load i32, ptr @NumberIntraPerPicture, align 4
  %1 = load i32, ptr @WalkAround, align 4
  %add = add nsw i32 %1, %0
  store i32 %add, ptr @WalkAround, align 4
  %cmp7 = icmp sgt i32 %0, 0
  br i1 %cmp7, label %for.body.lr.ph, label %for.end

for.body.lr.ph:                                   ; preds = %entry
  %2 = load ptr, ptr @RefreshPattern, align 8
  %3 = load i32, ptr @NumberOfMBs, align 4
  %4 = load ptr, ptr @IntraMBs, align 8
  %wide.trip.count = zext i32 %0 to i64
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph.new
  ...
  store i32 %7, ptr %arrayidx2.1, align 4
...
for.body.epil:                                    ; preds = %for.end.loopexit.unr-lcssa
  ...
  %8 = load i32, ptr %arrayidx.epil, align 4
  %arrayidx2.epil = getelementptr inbounds i32, ptr %4, i64 %indvars.iv.unr
  store i32 %8, ptr %arrayidx2.epil, align 4
  br label %for.end
...
if.then:                                          ; preds = %entry
  ...
  %2 = load ptr, ptr @IntraMBs, align 8
