...
entry:
  ...
  store i32 0, ptr %ref_pic_list_reordering_flag_l0, align 8
  %ref_pic_list_reordering_flag_l1 = getelementptr inbounds %struct.Slice, ptr %1, i64 0, i32 13
  store i32 0, ptr %ref_pic_list_reordering_flag_l1, align 8
  ret void
}
...
if.end6.peel:
  ...
  store i32 0, ptr %write_flag.peel, align 8
  ...
  %.pre43 = load i32, ptr %symbol_mode.peel.phi.trans.insert, align 8
...
if.then8.peel:                                    ; preds = %if.end6.peel
  ...
  %10 = load i32, ptr %bits_to_go.peel, align 4
  ...
  %11 = load ptr, ptr %streamBuffer.peel, align 8
...
if.end6:                                          ; preds = %for.inc.peel
  %12 = load ptr, ptr %partArr, align 8
...
if.then8:                                         ; preds = %if.end6
  ...
  %15 = load i32, ptr %bits_to_go, align 4
  ...
  %16 = load ptr, ptr %streamBuffer, align 8
...
if.then8.1:                                       ; preds = %for.inc
  %19 = load ptr, ptr %partArr, align 8
  ...
  %20 = load i32, ptr %bits_to_go.1, align 4
  ...
  %21 = load ptr, ptr %streamBuffer.1, align 8
...
for.end:                                          ; preds = %if.else17.1, %if.then8.1, %for.inc.peel
  ...
  %23 = load i32, ptr %symbol_mode19, align 8
...
entry:
  ...
  %3 = load i32, ptr %symbol_mode, align 8
  %cmp = icmp eq i32 %3, 1
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %4 = load i32, ptr %max_part_nr, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %8 = load i32, ptr %symbol_mode2, align 8
...
if.then4:                                         ; preds = %for.body
  ...
  %10 = load ptr, ptr %streamBuffer, align 8
...
if.then18:                                        ; preds = %land.lhs.true
  ...
  %17 = load i32, ptr %bitdepth_luma, align 4
  ...
  %19 = load i32, ptr %chroma_format_idc, align 4
  ...
  %22 = load i32, ptr %bitdepth_chroma, align 8
  ...
  %25 = load i32, ptr %bytes_in_picture35, align 8
...
if.end43:                                         ; preds = %if.then18, %if.then37, %land.lhs.true, %if.else
  ...
  %26 = load ptr, ptr %streamBuffer44, align 8
  ...
  store i32 %call48, ptr %6, align 8
...
for.inc:                                          ; preds = %if.then4, %if.end43
  ...
  %29 = load ptr, ptr %em_prev_bits, align 8
  %30 = load i32, ptr %29, align 4
  %add = add nsw i32 %30, %mul
  store i32 %add, ptr %29, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %31 = load i32, ptr %max_part_nr, align 8
...
for.end:                                          ; preds = %for.inc, %if.end
  ...
  %34 = load i32, ptr %symbol_mode56, align 8
...
entry:
  ...
  store i32 0, ptr %end_of_slice, align 4
  ...
  %2 = load ptr, ptr %currentPicture.i, align 8
  %current_mb_nr.i = getelementptr inbounds %struct.ImageParameters, ptr %1, i64 0, i32 3
  store i32 %call, ptr %current_mb_nr.i, align 4
  %3 = load i32, ptr %2, align 8
  %inc.i = add nsw i32 %3, 1
  store i32 %inc.i, ptr %2, align 8
...
if.end.i:                                         ; preds = %if.then.i, %entry
  ...
  %5 = load i32, ptr %slice_mode.i.i, align 8
...
sw.bb.i.i:                                        ; preds = %if.end.i
  ...
  %6 = load i32, ptr %slice_argument.i.i, align 4
...
sw.bb1.i.i:                                       ; preds = %if.end.i
  ...
  %10 = load i32, ptr %bitdepth_chroma.i.i, align 8
...
sw.default.i.i:                                   ; preds = %if.end.i
  ...
  %14 = load i32, ptr %bitdepth_chroma11.i.i, align 8
...
if.then.i.i:                                      ; preds = %sw.epilog.i.i
  ...
  %.pre.i.i = load ptr, ptr @input, align 8
  br label %if.end.i.i
...
if.end.i.i:                                       ; preds = %if.then.i.i, %sw.epilog.i.i
  ...
  %16 = load i32, ptr %symbol_mode.i.i, align 8
...
if.then17.i.i:                                    ; preds = %if.end.i.i
  ...
  store ptr %call18.i.i, ptr %mot_ctx.i.i, align 8
  ...
  store ptr %call19.i.i, ptr %tex_ctx.i.i, align 8
  %.pre68.i.i = load ptr, ptr @input, align 8
...
if.end20.i.i:                                     ; preds = %if.then17.i.i, %if.end.i.i
  ...
  %18 = load i32, ptr %partition_mode.i.i, align 8
  ...
  %20 = load ptr, ptr %currentPicture.i.i, align 8
  %idr_flag.i.i = getelementptr inbounds %struct.Picture, ptr %20, i64 0, i32 1
  %21 = load i32, ptr %idr_flag.i.i, align 4
  ...
  store ptr @assignSE2partition_NoDP, ptr @assignSE2partition, align 16
  ...
  store ptr %storemerge.i.i, ptr getelementptr inbounds ([2 x ptr], ptr @assignSE2partition, i64 0, i64 1), align 8
  ...
  store ptr %call33.i.i, ptr %partArr.i.i, align 8
...
for.body.i.i:                                     ; preds = %for.inc.i.i, %if.end37.i.i
  ...
  store ptr %call42.i.i, ptr %arrayidx.i.i, align 8
...
if.then45.i.i:                                    ; preds = %for.body.i.i
  ...
  %.pre69.i.i = load ptr, ptr %arrayidx.i.i, align 8
...
if.end46.i.i:                                     ; preds = %if.then45.i.i, %for.body.i.i
  ...
  store ptr %call48.i.i, ptr %streamBuffer.i.i, align 8
...
for.inc.i.i:                                      ; preds = %if.then52.i.i, %if.end46.i.i
  ...
  br i1 %exitcond.not.i.i, label %malloc_slice.exit.i, label %for.body.i.i
...
for.body.lr.ph.i:                                 ; preds = %malloc_slice.exit.i
  %28 = load ptr, ptr %partArr.i.i, align 8
...
if.then16.i:                                      ; preds = %if.then14.i
  ...
  %42 = load i32, ptr %NumRefPrimary.i, align 8
...
if.end21.sink.split.i:                            ; preds = %if.then16.i, %if.then14.i
  ...
  store i32 %cond.i380.sink.i, ptr %num_ref_idx_l0_active.i, align 8
  br label %if.end21.i
...
land.lhs.true.i:                                  ; preds = %if.end21.i, %if.end21.i
  ...
  %45 = load i32, ptr %P_List0_refs.i, align 4
...
if.then37.i:                                      ; preds = %if.end33.i, %if.end21.i
  ...
  %50 = load i32, ptr %B_List0_refs.i, align 8
...
if.then39.i:                                      ; preds = %if.then37.i
  ...
  %51 = load i32, ptr %structure42.i, align 8
...
if.then51.i:                                      ; preds = %if.end49.i
  ...
  %54 = load i32, ptr %structure54.i, align 8
  ...
  store i32 %cond.i383.i, ptr %num_ref_idx_l1_active.i, align 4
  br label %if.end62.i
...
if.end62.i:                                       ; preds = %if.then51.i, %if.end49.i, %if.end33.i, %if.end21.i
  ...
  %56 = load i32, ptr %structure64.i, align 8
  ...
  %58 = load <2 x i32>, ptr @listXsize, align 16
  store <2 x i32> %58, ptr %num_ref_idx_l0_active65.i, align 8
  %nal_reference_idc.i = getelementptr inbounds %struct.ImageParameters, ptr %57, i64 0, i32 122
  %59 = load i32, ptr %nal_reference_idc.i, align 8
  %tobool67.not.i = icmp eq i32 %59, 0
  %.pre441.i = load ptr, ptr @input, align 8
...
land.lhs.true68.i:                                ; preds = %if.end62.i
  ...
  %60 = load i32, ptr %PocMemoryManagement.i, align 4
...
land.lhs.true70.i:                                ; preds = %land.lhs.true68.i
  %61 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 5), align 8
  ...
  %63 = load i32, ptr %num_ref_frames.i, align 4
...
if.then73.i:                                      ; preds = %land.lhs.true70.i
  ...
  %64 = load i32, ptr %frame_num.i, align 4
...
if.end74.i:                                       ; preds = %if.then73.i, %land.lhs.true70.i, %land.lhs.true68.i, %if.end62.i
  ...
  %66 = load i32, ptr %EnableOpenGOP.i, align 4
...
if.then89.i:                                      ; preds = %land.lhs.true85.i
  ...
  store i32 %cond.i384.i, ptr %num_ref_idx_l0_active91.i, align 8
  store i32 %cond.i384.i, ptr @listXsize, align 16
...
for.inc93.i:                                      ; preds = %land.lhs.true85.i, %for.body80.i
  ...
  br i1 %exitcond421.not.i, label %for.end95.i, label %for.body80.i

for.end95.i:                                      ; preds = %for.inc93.i, %if.then89.i, %for.cond77.preheader.i
  %74 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 1), align 4
...
for.body99.lr.ph.i:                               ; preds = %for.end95.i
  %75 = load ptr, ptr getelementptr inbounds ([6 x ptr], ptr @listX, i64 0, i64 1), align 8
  %last_valid_reference103.i = getelementptr inbounds %struct.ImageParameters, ptr %.pre443.pre.i, i64 0, i32 169
  %76 = load i32, ptr %last_valid_reference103.i, align 4
...
land.lhs.true106.i:                               ; preds = %for.body99.i
  %79 = load i32, ptr %ThisPOC107.i, align 8
...
if.then111.i:                                     ; preds = %land.lhs.true106.i
  ...
  store i32 %cond.i385.i, ptr %num_ref_idx_l1_active113.i, align 4
  store i32 %cond.i385.i, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 1), align 4
  br label %if.end118.i
...
for.inc115.i:                                     ; preds = %land.lhs.true106.i, %for.body99.i
  ...
  br i1 %exitcond426.not.i, label %if.end118.i, label %for.body99.i
...
land.lhs.true122.i:                               ; preds = %if.end118.i
  ...
  %84 = load i32, ptr %ReferenceReorder.i, align 8
...
if.then124.i:                                     ; preds = %land.lhs.true122.i
  ...
  %86 = load i32, ptr %type126.i, align 4
...
for.cond134.preheader.i:                          ; preds = %if.then124.i
  ...
  %87 = load i32, ptr %num_ref_idx_l0_active135.i, align 8
...
for.cond153.preheader.i:                          ; preds = %for.end148.i
  ...
  %95 = load i32, ptr %num_ref_idx_l1_active154.i, align 4
...
if.end169.i.if.then177.i_crit_edge:               ; preds = %if.end169.i
  ...
  %.pre = load i32, ptr %num_ref_idx_l0_active178.i.phi.trans.insert, align 8
...
if.then177.i:                                     ; preds = %if.end169.i.if.then177.i_crit_edge, %for.cond153.preheader.i
  ...
  %106 = load ptr, ptr @listX, align 16
  ...
  %108 = load i32, ptr %num_ref_idx_l0_active182.i, align 8
  %sub183.i = add nsw i32 %108, -1
  %109 = load ptr, ptr %reordering_of_pic_nums_idc_l0179.i, align 8
  %110 = load ptr, ptr %abs_diff_pic_num_minus1_l0180.i, align 8
  %111 = load ptr, ptr %long_term_pic_idx_l0181.i, align 8
  ...
  %113 = load i32, ptr %type187.i, align 4
...
if.then190.i:                                     ; preds = %if.then177.i
  ...
  %114 = load i32, ptr %num_ref_idx_l1_active191.i, align 4
  %115 = load ptr, ptr getelementptr inbounds ([6 x ptr], ptr @listX, i64 0, i64 1), align 8
  %reordering_of_pic_nums_idc_l1192.i = getelementptr inbounds %struct.Slice, ptr %call.i.i, i64 0, i32 14
  %116 = load ptr, ptr %reordering_of_pic_nums_idc_l1192.i, align 8
  %abs_diff_pic_num_minus1_l1193.i = getelementptr inbounds %struct.Slice, ptr %call.i.i, i64 0, i32 15
  %117 = load ptr, ptr %abs_diff_pic_num_minus1_l1193.i, align 8
  ...
  %118 = load ptr, ptr getelementptr inbounds ([6 x ptr], ptr @listX, i64 0, i64 1), align 8
  ...
  %120 = load i32, ptr %num_ref_idx_l1_active195.i, align 4
  %sub196.i = add nsw i32 %120, -1
  %121 = load ptr, ptr %reordering_of_pic_nums_idc_l1192.i, align 8
  %122 = load ptr, ptr %abs_diff_pic_num_minus1_l1193.i, align 8
  %123 = load ptr, ptr %long_term_pic_idx_l1194.i, align 8
  ...
  %.pre446.i = load ptr, ptr @img, align 8
...
if.end202.i:                                      ; preds = %if.then190.i, %if.then177.i, %if.end169.i, %if.end169.i, %land.lhs.true122.i, %if.end118.i
  ...
  %125 = load i32, ptr %structure203.i, align 8
...
if.then206.i:                                     ; preds = %if.end202.i
  ...
  %.pre447.i = load ptr, ptr @img, align 8
...
if.end207.i:                                      ; preds = %if.then206.i, %if.end202.i
  ...
  %127 = load i32, ptr %type208.i, align 4
...
lor.lhs.false214.i:                               ; preds = %land.lhs.true211.i
  ...
  %130 = load i32, ptr %weighted_bipred_idc.i, align 4
...
if.then229.i:                                     ; preds = %if.then221.i, %if.then221.i
  ...
  %132 = load i32, ptr %GenerateMultiplePPS.i, align 8
...
land.lhs.true231.i:                               ; preds = %if.then229.i
  ...
  %133 = load i32, ptr %RDPictureDecision.i, align 4
...
if.then233.i:                                     ; preds = %land.lhs.true231.i
  ...
  %135 = load ptr, ptr @enc_frame_picture2, align 8
...
if.end243.i:                                      ; preds = %if.else241.i, %if.else239.i, %if.else237.i, %if.then236.i, %lor.lhs.false214.i, %if.end207.i
  %136 = load i32, ptr @listXsize, align 16
...
for.body.lr.ph.i.i:                               ; preds = %if.end243.i
  %137 = load ptr, ptr @listX, align 16
...
for.cond21.preheader.i.i:                         ; preds = %for.body.i388.i, %if.end243.i
  %139 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 1), align 4
...
for.body24.lr.ph.i.i:                             ; preds = %for.cond21.preheader.i.i
  %140 = load ptr, ptr getelementptr inbounds ([6 x ptr], ptr @listX, i64 0, i64 1), align 8
  %141 = load ptr, ptr @enc_picture, align 8
...
for.body.i388.i:                                  ; preds = %for.body.i388.i, %for.body.lr.ph.i.i
  ...
  store i64 %conv.i394.i, ptr %arrayidx4.i.i, align 8
  %frame_poc.i.i = getelementptr inbounds %struct.storable_picture, ptr %142, i64 0, i32 4
  %145 = load i32, ptr %frame_poc.i.i, align 8
  ...
  store i64 %conv6.i.i, ptr %arrayidx9.i.i, align 8
  %top_poc.i.i = getelementptr inbounds %struct.storable_picture, ptr %142, i64 0, i32 2
  %146 = load i32, ptr %top_poc.i.i, align 8
  ...
  store i64 %conv11.i.i, ptr %arrayidx14.i.i, align 8
  %bottom_poc.i.i = getelementptr inbounds %struct.storable_picture, ptr %142, i64 0, i32 3
  %147 = load i32, ptr %bottom_poc.i.i, align 4
  ...
  store i64 %conv17.i.i, ptr %arrayidx20.i.i, align 8
  ...
  br i1 %exitcond.not.i396.i, label %for.cond21.preheader.i.i, label %for.body.i388.i
...
for.body24.i.i:                                   ; preds = %for.body24.i.i, %for.body24.lr.ph.i.i
  ...
  store i64 %conv34.i.i, ptr %arrayidx38.i.i, align 8
  %frame_poc39.i.i = getelementptr inbounds %struct.storable_picture, ptr %148, i64 0, i32 4
  %151 = load i32, ptr %frame_poc39.i.i, align 8
  ...
  store i64 %conv41.i.i, ptr %arrayidx45.i.i, align 8
  %top_poc46.i.i = getelementptr inbounds %struct.storable_picture, ptr %148, i64 0, i32 2
  %152 = load i32, ptr %top_poc46.i.i, align 8
  ...
  store i64 %conv48.i.i, ptr %arrayidx52.i.i, align 8
  %bottom_poc53.i.i = getelementptr inbounds %struct.storable_picture, ptr %148, i64 0, i32 3
  %153 = load i32, ptr %bottom_poc53.i.i, align 4
  ...
  store i64 %conv56.i.i, ptr %arrayidx60.i.i, align 8
...
land.lhs.true.i.i:                                ; preds = %for.end63.i.i
  ...
  %156 = load i32, ptr %structure64.i.i, align 8
...
for.cond67.preheader.i.i:                         ; preds = %land.lhs.true.i.i
  ...
  %158 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 2), align 8
...
for.body76.lr.ph.i.i:                             ; preds = %for.cond67.preheader.i.i
  %159 = load ptr, ptr getelementptr inbounds ([6 x ptr], ptr @listX, i64 0, i64 2), align 16
...
for.body76.i.i:                                   ; preds = %for.body76.i.i, %for.body76.lr.ph.i.i
  ...
  store i64 %conv88.i.i, ptr %arrayidx93.i.i, align 8
  %frame_poc94.i.i = getelementptr inbounds %struct.storable_picture, ptr %160, i64 0, i32 4
  %163 = load i32, ptr %frame_poc94.i.i, align 8
  ...
  store i64 %conv96.i.i, ptr %arrayidx101.i.i, align 8
  %top_poc102.i.i = getelementptr inbounds %struct.storable_picture, ptr %160, i64 0, i32 2
  %164 = load i32, ptr %top_poc102.i.i, align 8
  ...
  store i64 %conv104.i.i, ptr %arrayidx109.i.i, align 8
  %bottom_poc110.i.i = getelementptr inbounds %struct.storable_picture, ptr %160, i64 0, i32 3
  %165 = load i32, ptr %bottom_poc110.i.i, align 4
  ...
  store i64 %conv113.i.i, ptr %arrayidx118.i.i, align 8
  ...
  br i1 %exitcond183.not.i.i, label %for.inc122.i.i, label %for.body76.i.i

for.inc122.i.i:                                   ; preds = %for.body76.i.i, %for.cond67.preheader.i.i
  %166 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 3), align 4
...
for.body76.lr.ph.1.i.i:                           ; preds = %for.inc122.i.i
  %167 = load ptr, ptr getelementptr inbounds ([6 x ptr], ptr @listX, i64 0, i64 3), align 8
...
for.body76.1.i.i:                                 ; preds = %for.body76.1.i.i, %for.body76.lr.ph.1.i.i
  ...
  store i64 %conv88.1.i.i, ptr %arrayidx93.1.i.i, align 8
  %frame_poc94.1.i.i = getelementptr inbounds %struct.storable_picture, ptr %168, i64 0, i32 4
  %171 = load i32, ptr %frame_poc94.1.i.i, align 8
  ...
  store i64 %conv96.1.i.i, ptr %arrayidx101.1.i.i, align 8
  %top_poc102.1.i.i = getelementptr inbounds %struct.storable_picture, ptr %168, i64 0, i32 2
  %172 = load i32, ptr %top_poc102.1.i.i, align 8
  ...
  store i64 %conv104.1.i.i, ptr %arrayidx109.1.i.i, align 8
  %bottom_poc110.1.i.i = getelementptr inbounds %struct.storable_picture, ptr %168, i64 0, i32 3
  %173 = load i32, ptr %bottom_poc110.1.i.i, align 4
  ...
  store i64 %conv113.1.i.i, ptr %arrayidx118.1.i.i, align 8
  ...
  br i1 %exitcond183.1.not.i.i, label %for.inc122.1.i.i, label %for.body76.1.i.i

for.inc122.1.i.i:                                 ; preds = %for.body76.1.i.i, %for.inc122.i.i
  %174 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 4), align 16
...
for.body76.lr.ph.2.i.i:                           ; preds = %for.inc122.1.i.i
  %175 = load ptr, ptr getelementptr inbounds ([6 x ptr], ptr @listX, i64 0, i64 4), align 16
...
for.body76.2.i.i:                                 ; preds = %for.body76.2.i.i, %for.body76.lr.ph.2.i.i
  ...
  store i64 %conv88.2.i.i, ptr %arrayidx93.2.i.i, align 8
  %frame_poc94.2.i.i = getelementptr inbounds %struct.storable_picture, ptr %176, i64 0, i32 4
  %179 = load i32, ptr %frame_poc94.2.i.i, align 8
  ...
  store i64 %conv96.2.i.i, ptr %arrayidx101.2.i.i, align 8
  %top_poc102.2.i.i = getelementptr inbounds %struct.storable_picture, ptr %176, i64 0, i32 2
  %180 = load i32, ptr %top_poc102.2.i.i, align 8
  ...
  store i64 %conv104.2.i.i, ptr %arrayidx109.2.i.i, align 8
  %bottom_poc110.2.i.i = getelementptr inbounds %struct.storable_picture, ptr %176, i64 0, i32 3
  %181 = load i32, ptr %bottom_poc110.2.i.i, align 4
  ...
  store i64 %conv113.2.i.i, ptr %arrayidx118.2.i.i, align 8
  ...
  br i1 %exitcond183.2.not.i.i, label %for.inc122.2.i.i, label %for.body76.2.i.i

for.inc122.2.i.i:                                 ; preds = %for.body76.2.i.i, %for.inc122.1.i.i
  %182 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 5), align 4
...
for.body76.lr.ph.3.i.i:                           ; preds = %for.inc122.2.i.i
  %183 = load ptr, ptr getelementptr inbounds ([6 x ptr], ptr @listX, i64 0, i64 5), align 8
...
for.body76.3.i.i:                                 ; preds = %for.body76.3.i.i, %for.body76.lr.ph.3.i.i
  ...
  store i64 %conv88.3.i.i, ptr %arrayidx93.3.i.i, align 8
  %frame_poc94.3.i.i = getelementptr inbounds %struct.storable_picture, ptr %184, i64 0, i32 4
  %187 = load i32, ptr %frame_poc94.3.i.i, align 8
  ...
  store i64 %conv96.3.i.i, ptr %arrayidx101.3.i.i, align 8
  %top_poc102.3.i.i = getelementptr inbounds %struct.storable_picture, ptr %184, i64 0, i32 2
  %188 = load i32, ptr %top_poc102.3.i.i, align 8
  ...
  store i64 %conv104.3.i.i, ptr %arrayidx109.3.i.i, align 8
  %bottom_poc110.3.i.i = getelementptr inbounds %struct.storable_picture, ptr %184, i64 0, i32 3
  %189 = load i32, ptr %bottom_poc110.3.i.i, align 4
  ...
  store i64 %conv113.3.i.i, ptr %arrayidx118.3.i.i, align 8
  ...
  br i1 %exitcond183.3.not.i.i, label %set_ref_pic_num.exit.i, label %for.body76.3.i.i
...
if.end248.i:                                      ; preds = %if.then247.i, %set_ref_pic_num.exit.i
  ...
  %.pre452.i = load ptr, ptr @input, align 8
...
if.end256.i:                                      ; preds = %if.then255.i, %land.lhs.true252.i, %if.end248.i
  ...
  %196 = load i32, ptr %symbol_mode.i, align 8
  %cmp257.i = icmp eq i32 %196, 0
  br i1 %cmp257.i, label %if.then259.i, label %if.else279.i

if.then259.i:                                     ; preds = %if.end256.i
  store ptr @writeSE_UVLC, ptr @writeMB_typeInfo, align 8
  store ptr @writeIntraPredMode_CAVLC, ptr @writeIntraPredMode, align 8
  store ptr @writeSE_UVLC, ptr @writeB8_typeInfo, align 8
  %197 = load i32, ptr @listXsize, align 16
...
for.inc276.i:                                     ; preds = %if.then259.i, %switch.lookup
  ...
  store ptr %.sink.i, ptr @writeRefFrame, align 16
  %200 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 1), align 4
...
for.inc276.1.i:                                   ; preds = %for.inc276.i, %switch.lookup408
  ...
  store ptr %writeSE_UVLC.sink.i, ptr getelementptr inbounds ([6 x ptr], ptr @writeRefFrame, i64 0, i64 1), align 8
  %203 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 2), align 8
...
for.inc276.2.i:                                   ; preds = %for.inc276.1.i, %switch.lookup411
  ...
  store ptr %writeSE_UVLC.sink461.i, ptr getelementptr inbounds ([6 x ptr], ptr @writeRefFrame, i64 0, i64 2), align 16
  %206 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 3), align 4
...
for.inc276.3.i:                                   ; preds = %for.inc276.2.i, %switch.lookup414
  ...
  store ptr %writeSE_UVLC.sink462.i, ptr getelementptr inbounds ([6 x ptr], ptr @writeRefFrame, i64 0, i64 3), align 8
  %209 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 4), align 16
...
for.inc276.4.i:                                   ; preds = %for.inc276.3.i, %switch.lookup417
  ...
  store ptr %writeSE_UVLC.sink463.i, ptr getelementptr inbounds ([6 x ptr], ptr @writeRefFrame, i64 0, i64 4), align 16
  %212 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 5), align 4
  %213 = icmp ult i32 %212, 3
  br i1 %213, label %switch.lookup420, label %init_slice.exit

if.else279.i:                                     ; preds = %if.end256.i
  store ptr @writeMB_typeInfo_CABAC, ptr @writeMB_typeInfo, align 8
  store ptr @writeIntraPredMode_CABAC, ptr @writeIntraPredMode, align 8
  store ptr @writeB8_typeInfo_CABAC, ptr @writeB8_typeInfo, align 8
  ...
  store ptr %215, ptr @writeRefFrame, align 16
  %216 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 1), align 4
  %switch.i = icmp ult i32 %216, 2
  %spec.select.i = select i1 %switch.i, ptr @writeSE_Dummy, ptr @writeRefFrame_CABAC
  store ptr %spec.select.i, ptr getelementptr inbounds ([6 x ptr], ptr @writeRefFrame, i64 0, i64 1), align 8
  ...
  store ptr %218, ptr getelementptr inbounds ([6 x ptr], ptr @writeRefFrame, i64 0, i64 2), align 16
  ...
  store ptr %spec.select471.i, ptr getelementptr inbounds ([6 x ptr], ptr @writeRefFrame, i64 0, i64 3), align 8
  %220 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 4), align 16
  %switch.selectcmp467.i = icmp ult i32 %220, 2
  %221 = select i1 %switch.selectcmp467.i, ptr @writeSE_Dummy, ptr @writeRefFrame_CABAC
  store ptr %221, ptr getelementptr inbounds ([6 x ptr], ptr @writeRefFrame, i64 0, i64 4), align 16
  %222 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 5), align 4
...
init_slice.exit:                                  ; preds = %for.inc276.4.i, %switch.lookup420, %if.else279.i
  ...
  store ptr %writeSE_invFlag.sink.i, ptr getelementptr inbounds ([6 x ptr], ptr @writeRefFrame, i64 0, i64 5), align 8
  store ptr %storemerge379.i, ptr @writeMVD, align 8
  store ptr %storemerge378.i, ptr @writeCBP, align 8
  store ptr %storemerge377.i, ptr @writeDquant, align 8
  store ptr %storemerge376.i, ptr @writeCIPredMode, align 8
  store ptr %storemerge375.i, ptr @writeFieldModeInfo, align 8
  store ptr %storemerge.i, ptr @writeMB_transform_size, align 8
  %224 = load ptr, ptr @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, ptr %224, i64 0, i32 60
  %225 = load ptr, ptr %currentSlice, align 8
  %partArr = getelementptr inbounds %struct.Slice, ptr %225, i64 0, i32 6
  %226 = load ptr, ptr %partArr, align 8
  %227 = load ptr, ptr %226, align 8
  %228 = load i32, ptr %227, align 8
  store i32 %228, ptr @Bytes_After_Header, align 4
...
if.end:                                           ; preds = %if.then, %init_slice.exit
  ...
  %232 = load i32, ptr %rdopt, align 8
...
land.end:                                         ; preds = %if.end.land.end_crit_edge, %land.rhs, %land.lhs.true
  ...
  store i16 %conv, ptr %checkref, align 8
...
while.body:                                       ; preds = %if.end13, %if.end301
  ...
  %250 = load i32, ptr %AdaptiveRounding, align 4
...
land.lhs.true22:                                  ; preds = %while.body
  ...
  %252 = load i32, ptr %AdaptRndPeriod, align 8
...
land.lhs.true24:                                  ; preds = %land.lhs.true22
  ...
  %253 = load i32, ptr %current_mb_nr, align 4
...
if.end32:                                         ; preds = %if.then28, %if.then30, %land.lhs.true24, %land.lhs.true22, %while.body
  ...
  %257 = load i32, ptr %MbaffFrameFlag, align 4
...
if.then34:                                        ; preds = %if.end32
  ...
  store ptr @rddata_top_frame_mb, ptr @rdopt, align 8
  call void @start_macroblock(i32 noundef %CurrentMbAddr.0349, i32 noundef 0) #12
  %258 = load ptr, ptr @encode_one_macroblock, align 8
  call void %258() #12
  ...
  %259 = load i32, ptr %recode_macroblock, align 4
...
if.else:                                          ; preds = %if.then34
  ...
  %261 = load i32, ptr %current_mb_nr43, align 4
  ...
  store i32 %call44, ptr %current_mb_nr45, align 4
...
if.then59:                                        ; preds = %if.else53
  ...
  %266 = load i32, ptr %RCEnable61, align 4
...
land.lhs.true67:                                  ; preds = %if.then59
  ...
  %267 = load i32, ptr %NumberofCodedMacroBlocks, align 4
...
land.lhs.true70:                                  ; preds = %land.lhs.true67
  ...
  %268 = load i32, ptr %BasicUnit72, align 4
...
if.then76:                                        ; preds = %land.lhs.true70
  %269 = load ptr, ptr @quadratic_RC_init, align 8
  %270 = load ptr, ptr @quadratic_RC, align 8
  call void @copy_rc_jvt(ptr noundef %269, ptr noundef %270) #12
  %.pre358 = load ptr, ptr @input, align 8
  %RCEnable78.phi.trans.insert = getelementptr inbounds %struct.InputParameters, ptr %.pre358, i64 0, i32 157
  %.pre359 = load i32, ptr %RCEnable78.phi.trans.insert, align 4
  br label %if.end77
...
land.lhs.true80:                                  ; preds = %land.lhs.true67, %land.lhs.true70, %if.end77
  ...
  %274 = load i32, ptr %MbInterlace81, align 4
  %cmp82 = icmp eq i32 %274, 2
  br i1 %cmp82, label %if.then84, label %if.end85

if.then84:                                        ; preds = %land.lhs.true80
  %275 = load ptr, ptr @generic_RC_init, align 8
  %276 = load ptr, ptr @generic_RC, align 8
...
land.lhs.true91:                                  ; preds = %if.end85
  ...
  %284 = load i32, ptr %MbInterlace92, align 4
...
land.lhs.true95:                                  ; preds = %land.lhs.true91
  ...
  %286 = load i32, ptr %NumberofCodedMacroBlocks96, align 4
...
land.lhs.true99:                                  ; preds = %land.lhs.true95
  ...
  %287 = load i32, ptr %BasicUnit101, align 4
...
if.end106:                                        ; preds = %land.lhs.true99
  %288 = load ptr, ptr @quadratic_RC_best, align 8
  %289 = load ptr, ptr @quadratic_RC, align 8
  call void @copy_rc_jvt(ptr noundef %288, ptr noundef %289) #12
  %.pre360 = load ptr, ptr @input, align 8
  %RCEnable107.phi.trans.insert = getelementptr inbounds %struct.InputParameters, ptr %.pre360, i64 0, i32 157
  %.pre361 = load i32, ptr %RCEnable107.phi.trans.insert, align 4
...
land.lhs.true109:                                 ; preds = %land.lhs.true91, %land.lhs.true95, %land.lhs.true99, %if.end106
  ...
  %291 = load i32, ptr %MbInterlace110, align 4
  %cmp111 = icmp eq i32 %291, 2
  br i1 %cmp111, label %if.then113, label %if.end114

if.then113:                                       ; preds = %land.lhs.true109
  %292 = load ptr, ptr @generic_RC_best, align 8
  %293 = load ptr, ptr @generic_RC, align 8
  call void @copy_rc_generic(ptr noundef %292, ptr noundef %293) #12
  %.pre362.pre = load ptr, ptr @input, align 8
  br label %if.end114
...
if.end114:                                        ; preds = %if.end85, %if.then113, %land.lhs.true109, %if.end106
  ...
  %294 = load ptr, ptr @rdopt, align 8
  ...
  %.pre363 = load i32, ptr %MbInterlace118.phi.trans.insert, align 4
  %.pre367.pre = load ptr, ptr @img, align 8
  br label %if.end117
...
if.end165.thread:                                 ; preds = %if.end117
  ...
  store i32 0, ptr %write_mbaff_frame382, align 8
...
land.lhs.true139:                                 ; preds = %if.then125
  ...
  %302 = load i32, ptr %NumberofCodedMacroBlocks140, align 4
...
land.lhs.true143:                                 ; preds = %land.lhs.true139
  ...
  %303 = load i32, ptr %BasicUnit145, align 4
...
if.then149:                                       ; preds = %land.lhs.true143
  %304 = load ptr, ptr @quadratic_RC, align 8
  %305 = load ptr, ptr @quadratic_RC_init, align 8
  call void @copy_rc_jvt(ptr noundef %304, ptr noundef %305) #12
  %.pre364 = load ptr, ptr @input, align 8
  %RCEnable151.phi.trans.insert = getelementptr inbounds %struct.InputParameters, ptr %.pre364, i64 0, i32 157
  %.pre365 = load i32, ptr %RCEnable151.phi.trans.insert, align 4
  br label %if.end150
...
land.lhs.true153:                                 ; preds = %land.lhs.true139, %land.lhs.true143, %if.end150
  ...
  %309 = load i32, ptr %MbInterlace154, align 4
  %cmp155 = icmp eq i32 %309, 2
  br i1 %cmp155, label %if.then157, label %if.end165

if.then157:                                       ; preds = %land.lhs.true153
  %310 = load ptr, ptr @generic_RC, align 8
  %311 = load ptr, ptr @generic_RC_init, align 8
...
if.end188:                                        ; preds = %if.then176.thread, %if.then181
  ...
  %327 = load i32, ptr %RCEnable189, align 4
...
land.lhs.true195:                                 ; preds = %land.lhs.true191
  ...
  %328 = load i32, ptr %NumberofCodedMacroBlocks196, align 4
...
land.lhs.true199:                                 ; preds = %land.lhs.true195
  ...
  %329 = load i32, ptr %BasicUnit201, align 4
...
if.end206:                                        ; preds = %land.lhs.true199
  %330 = load ptr, ptr @quadratic_RC, align 8
  %331 = load ptr, ptr @quadratic_RC_best, align 8
  call void @copy_rc_jvt(ptr noundef %330, ptr noundef %331) #12
  %.pre370 = load ptr, ptr @input, align 8
  %RCEnable207.phi.trans.insert = getelementptr inbounds %struct.InputParameters, ptr %.pre370, i64 0, i32 157
  %.pre371 = load i32, ptr %RCEnable207.phi.trans.insert, align 4
...
if.end218:                                        ; preds = %if.end188, %if.end206, %land.lhs.true209, %if.then213
  ...
  store i32 1, ptr %write_mbaff_frame215, align 8
  %.pr = load i32, ptr @MBPairIsField, align 4
  %write_macroblock219 = getelementptr inbounds %struct.ImageParameters, ptr %336, i64 0, i32 133
  store i32 1, ptr %write_macroblock219, align 8
...
if.else254:                                       ; preds = %if.end237
  ...
  %347 = load i32, ptr %current_mb_nr255, align 4
...
if.else268:                                       ; preds = %if.end225
  ...
  %351 = load i32, ptr %current_mb_nr269, align 4
  ...
  store i32 %call270, ptr %current_mb_nr271, align 4
...
if.end278:                                        ; preds = %if.else268, %if.then275, %if.end252, %if.then264, %if.else254
  ...
  %353 = load i32, ptr @MBPairIsField, align 4
  %tobool279.not = icmp eq i32 %353, 0
  %.pre372 = load ptr, ptr @img, align 8
...
if.end301:                                        ; preds = %if.then293, %if.end42, %if.then49, %if.else
  ...
  %.pr395 = load i32, ptr %end_of_slice, align 4
...
while.end.loopexit:                               ; preds = %if.end289, %if.end301, %if.then298
  ...
  %.pre373 = load ptr, ptr @img, align 8
  br label %while.end
...
while.end:                                        ; preds = %while.end.loopexit, %if.end13
  ...
  %360 = load i32, ptr %PicSizeInMbs, align 4
...
entry:
  %0 = load i32, ptr %currPic, align 8
...
for.cond.preheader.i:                             ; preds = %for.body
  ...
  %3 = load i32, ptr %max_part_nr.i, align 8
...
if.end.i:                                         ; preds = %if.then3.i
  ...
  %.pr.i = load ptr, ptr %arrayidx.i, align 8
...
for.inc.i:                                        ; preds = %if.then10.i, %if.end.i, %for.body.i
  ...
  %10 = load i32, ptr %max_part_nr.i, align 8
  %11 = sext i32 %10 to i64
  %cmp1.i = icmp slt i64 %indvars.iv.next.i, %11
  br i1 %cmp1.i, label %for.bodythread-pre-split.i, label %for.end.i
...
for.end.i:                                        ; preds = %for.inc.i, %for.body.lr.ph.i, %for.cond.preheader.i
  ...
  %12 = load ptr, ptr %partArr14.i, align 8
...
if.end18.i:                                       ; preds = %if.then16.i, %for.end.i
  ...
  %14 = load i32, ptr %symbol_mode.i, align 8
...
if.then20.i:                                      ; preds = %if.end18.i
  ...
  %15 = load ptr, ptr %mot_ctx.i, align 8
  ...
  %16 = load ptr, ptr %tex_ctx.i, align 8
...
if.end21.i:                                       ; preds = %if.then20.i, %if.end18.i
  ...
  %.pre = load i32, ptr %currPic, align 8
...
for.body.epil:                                    ; preds = %for.cond7.preheader.loopexit.unr-lcssa, %for.body.epil
  ...
  %5 = load ptr, ptr %arrayidx.epil, align 8
  %pic_num.epil = getelementptr inbounds %struct.storable_picture, ptr %5, i64 0, i32 11
  %6 = load i32, ptr %pic_num.epil, align 4
  %arrayidx6.epil = getelementptr inbounds [32 x i32], ptr %default_order, i64 0, i64 %indvars.iv.epil
  store i32 %6, ptr %arrayidx6.epil, align 4
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %for.cond7.preheader, label %for.body.epil
...
for.body9.lr.ph:                                  ; preds = %for.cond7.preheader
  %8 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 1), align 8
...
for.body:                                         ; preds = %for.body, %for.body.preheader.new
  ...
  %17 = load i32, ptr %pic_num.3, align 4
  %arrayidx6.3 = getelementptr inbounds [32 x i32], ptr %default_order, i64 0, i64 %indvars.iv.next.2
  store i32 %17, ptr %arrayidx6.3, align 4
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %niter.next.3 = add i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %for.cond7.preheader.loopexit.unr-lcssa, label %for.body
...
for.body9:                                        ; preds = %for.body9.lr.ph, %for.inc55
  ...
  %21 = load i32, ptr %pic_num12, align 4
...
land.lhs.true:                                    ; preds = %for.body9
  ...
  %23 = load i32, ptr %used_for_reference, align 4
...
land.lhs.true21:                                  ; preds = %land.lhs.true
  ...
  %24 = load i32, ptr %is_long_term, align 8
...
if.then26:                                        ; preds = %land.lhs.true21
  ...
  %25 = load i32, ptr %poc, align 4
  %26 = load i32, ptr %poc30, align 4
  ...
  store i32 %cond.i, ptr %arrayidx32, align 4
  ...
  store i32 %cond50, ptr %arrayidx42, align 4
  br label %for.inc55
...
for.inc55:                                        ; preds = %if.then26, %for.body9, %land.lhs.true, %land.lhs.true21
  ...
  br i1 %exitcond366.not, label %for.cond58.preheader, label %for.body9
...
for.cond58.loopexit:                              ; preds = %for.inc108, %for.body61
  ...
  br i1 %exitcond377.not, label %for.cond114.preheader, label %for.body61
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load419 = load <4 x i32>, ptr %28, align 16
  %29 = getelementptr inbounds [32 x i32], ptr %re_order, i64 0, i64 %index
  %wide.load420 = load <4 x i32>, ptr %29, align 16
  %30 = getelementptr inbounds i32, ptr %29, i64 4
  %wide.load421 = load <4 x i32>, ptr %30, align 16
...
if.then82:                                        ; preds = %for.body65.if.then82_crit_edge, %land.lhs.true76
  ...
  store i32 %38, ptr %arrayidx67, align 4
  store i32 %37, ptr %arrayidx69, align 4
...
for.inc108:                                       ; preds = %lor.lhs.false, %land.lhs.true76, %if.then82
  ...
  br i1 %exitcond372.not, label %for.cond58.loopexit, label %for.body65
...
for.body116:                                      ; preds = %for.body116.preheader427, %for.body116
  ...
  br i1 %exitcond382.not, label %for.end126, label %for.body116
...
for.body131:                                      ; preds = %for.body203.preheader, %for.body131.lr.ph
  ...
  %51 = load i32, ptr %arrayidx133, align 4
  ...
  store i32 %51, ptr %arrayidx164, align 4
...
for.body167:                                      ; preds = %for.body131, %for.inc180
  ...
  %55 = load i32, ptr %arrayidx169, align 4
...
if.then173:                                       ; preds = %for.body167
  ...
  store i32 %55, ptr %arrayidx178, align 4
  br label %for.inc180
...
for.inc180:                                       ; preds = %for.body167, %if.then173
  ...
  br i1 %exitcond389.not, label %for.end182, label %for.body167
...
for.cond184:                                      ; preds = %for.body186
  ...
  br i1 %exitcond396.not, label %for.end213.loopexit, label %for.body186
...
for.body186:                                      ; preds = %for.end182, %for.cond184
  ...
  %56 = load i32, ptr %arrayidx188, align 4
...
for.body203.preheader:                            ; preds = %for.body186
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 %default_order, ptr nonnull align 16 %tmp_reorder, i64 %49, i1 false)
...
for.end225:                                       ; preds = %for.cond129.preheader, %for.end213
  ...
  store i32 1, ptr %ref_pic_list_reordering_flag_l0.sink, align 8
  br label %if.end231
...
entry:
  ...
  %2 = load i32, ptr %rdopt, align 8
  %tobool.not = icmp eq i32 %2, 0
  %.pre1069 = load ptr, ptr @img, align 8
...
for.body:                                         ; preds = %entry, %for.inc589
  ...
  %6 = load i32, ptr %bitdepth_luma_qp_scale, align 4
...
for.body6:                                        ; preds = %for.body6.lr.ph, %for.inc586
  ...
  %14 = load i32, ptr %bitdepth_luma_qp_scale8, align 4
  ...
  %16 = load i32, ptr %UseExplicitLambdaParams, align 8
...
if.then13:                                        ; preds = %for.body6
  ...
  %19 = load ptr, ptr %lambda_md, align 8
...
land.end.thread:                                  ; preds = %if.then13, %land.end, %24
  ...
  store double %mul32, ptr %arrayidx19, align 8
...
cond.false:                                       ; preds = %land.end.thread
  ...
  %.pre999 = load ptr, ptr @img, align 8
  %.pre1000 = load ptr, ptr @input, align 8
  br label %cond.end
...
cond.end:                                         ; preds = %land.end.thread, %cond.false
  ...
  %29 = load ptr, ptr %lambda_me, align 8
  ...
  store double %cond58, ptr %31, align 8
...
cond.end.1:                                       ; preds = %cond.end, %cond.false.1
  ...
  store double %cond58.1, ptr %arrayidx64.1, align 8
...
cond.end.2:                                       ; preds = %cond.end.1, %cond.false.2
  ...
  store double %cond58.2, ptr %arrayidx64.2, align 8
  ...
  store i32 %conv73.2, ptr %arrayidx79.2, align 4
...
land.end101:                                      ; preds = %if.then82
  ...
  %60 = load i32, ptr %arrayidx98, align 4
  %.fr927 = freeze i32 %60
...
cond.false126:                                    ; preds = %land.end101.thread
  ...
  %.pre1016 = load ptr, ptr @img, align 8
  %.pre1017 = load ptr, ptr @input, align 8
...
cond.end132:                                      ; preds = %land.end101.thread, %cond.false126
  ...
  %70 = load ptr, ptr %lambda_mf148, align 8
...
cond.end132.1:                                    ; preds = %cond.end132, %cond.false126.1
  ...
  store double %cond133.1, ptr %arrayidx139.1, align 8
...
cond.end132.2:                                    ; preds = %cond.end132.1, %cond.false126.2
  ...
  store double %cond133.2, ptr %arrayidx139.2, align 8
  ...
  store i32 %conv147.2, ptr %arrayidx153.2, align 4
  br label %for.inc586
...
land.end177:                                      ; preds = %if.then160
  ...
  %94 = load i32, ptr %arrayidx174, align 4
  %.fr = freeze i32 %94
...
cond.false205:                                    ; preds = %land.end177.thread
  ...
  %.pre975 = load ptr, ptr @img, align 8
...
cond.end212:                                      ; preds = %land.end177.thread, %cond.false205
  ...
  %102 = load ptr, ptr %lambda_me214, align 8
  ...
  %104 = load ptr, ptr %arrayidx218, align 8
  store double %cond213, ptr %104, align 8
  ...
  %112 = load double, ptr %arrayidx204.1, align 8
...
cond.end212.1:                                    ; preds = %cond.end212, %cond.false205.1
  ...
  store double %cond213.1, ptr %arrayidx220.1, align 8
...
cond.false205.2:                                  ; preds = %cond.end212.1
  ...
  %.pre985 = load ptr, ptr @img, align 8
...
land.end258:                                      ; preds = %if.then242
  ...
  %138 = load i32, ptr %arrayidx255, align 4
...
cond.end289:                                      ; preds = %land.end258.thread, %cond.false283
  ...
  %147 = load ptr, ptr %arrayidx292, align 8
  %arrayidx294 = getelementptr inbounds ptr, ptr %147, i64 %indvars.iv
  %148 = load ptr, ptr %arrayidx294, align 8
  store double %cond290, ptr %148, align 8
...
cond.end289.1:                                    ; preds = %cond.end289, %cond.false283.1
  ...
  store double %cond290.1, ptr %arrayidx296.1, align 8
...
cond.false283.2:                                  ; preds = %cond.end289.1
  ...
  %.pre998 = load ptr, ptr @img, align 8
...
if.end368:                                        ; preds = %cond.end360, %cond.end336
  ...
  %176 = load ptr, ptr %lambda_md363, align 8
  %arrayidx365 = getelementptr inbounds ptr, ptr %176, i64 %indvars.iv957
  %177 = load ptr, ptr %arrayidx365, align 8
  %arrayidx367 = getelementptr inbounds double, ptr %177, i64 %indvars.iv
  store double %mul362.sink, ptr %arrayidx367, align 8
  %178 = load ptr, ptr @input, align 8
...
land.end378:                                      ; preds = %if.end368
  ...
  %180 = load i32, ptr %arrayidx375, align 4
...
land.lhs.true:                                    ; preds = %land.end378.thread
  ...
  %183 = load i32, ptr %BRefPictures, align 4
...
land.end398:                                      ; preds = %land.lhs.true
  ...
  %184 = load i32, ptr %b_frame_to_code, align 4
...
if.then413:                                       ; preds = %land.lhs.true, %185, %land.end398
  ...
  store double %mul405, ptr %arrayidx384, align 8
  %arrayidx420 = getelementptr inbounds ptr, ptr %176, i64 5
  %187 = load ptr, ptr %arrayidx420, align 8
...
if.then425:                                       ; preds = %if.then413
  ...
  %191 = load i32, ptr %hierarchy_layer, align 4
...
cond.false465:                                    ; preds = %if.end445
  ...
  %.pre1033 = load ptr, ptr @img, align 8
  %.pre1034 = load ptr, ptr @input, align 8
...
cond.end471:                                      ; preds = %if.end445, %cond.false465
  ...
  %195 = load ptr, ptr %lambda_me473, align 8
  %arrayidx474 = getelementptr inbounds ptr, ptr %195, i64 5
  %196 = load ptr, ptr %arrayidx474, align 8
  %arrayidx476 = getelementptr inbounds ptr, ptr %196, i64 %indvars.iv
  %197 = load ptr, ptr %arrayidx476, align 8
  store double %cond472, ptr %197, align 8
...
cond.end471.1:                                    ; preds = %cond.end471, %cond.false465.1
  ...
  store double %cond472.1, ptr %arrayidx478.1, align 8
...
cond.end471.2:                                    ; preds = %cond.end471.1, %cond.false465.2
  ...
  store double %cond472.2, ptr %arrayidx478.2, align 8
  ...
  store i32 %conv486.2, ptr %arrayidx492.2, align 4
  br label %if.end503

if.else496:                                       ; preds = %land.end378.thread
  %mul502 = fmul double %sub, %mul385
  store double %mul502, ptr %arrayidx384, align 8
  br label %if.end503
...
cond.false519:                                    ; preds = %if.end503
  ...
  %.pre1051 = load ptr, ptr @img, align 8
  %.pre1052 = load ptr, ptr @input, align 8
...
cond.end526:                                      ; preds = %if.end503, %cond.false519
  ...
  %227 = load ptr, ptr %lambda_me528, align 8
  %arrayidx530 = getelementptr inbounds ptr, ptr %227, i64 %indvars.iv957
  %228 = load ptr, ptr %arrayidx530, align 8
  %arrayidx532 = getelementptr inbounds ptr, ptr %228, i64 %indvars.iv
  %229 = load ptr, ptr %arrayidx532, align 8
  store double %cond527, ptr %229, align 8
...
cond.end526.1:                                    ; preds = %cond.end526, %cond.false519.1
  ...
  store double %cond527.1, ptr %arrayidx534.1, align 8
...
cond.end526.2:                                    ; preds = %cond.end526.1, %cond.false519.2
  ...
  store double %cond527.2, ptr %arrayidx534.2, align 8
  ...
  store i32 %conv543.2, ptr %arrayidx550.2, align 4
  %CtxAdptLagrangeMult = getelementptr inbounds %struct.InputParameters, ptr %248, i64 0, i32 114
  %254 = load i32, ptr %CtxAdptLagrangeMult, align 4
...
land.lhs.true559:                                 ; preds = %if.then556
  ...
  %255 = load i32, ptr %RCEnable, align 4
...
cond.end567:                                      ; preds = %cond.false564, %cond.true561
  ...
  %259 = load ptr, ptr %arrayidx573, align 8
  %arrayidx574 = getelementptr inbounds double, ptr %259, i64 2
  %260 = load double, ptr %arrayidx574, align 8
...
for.inc586:                                       ; preds = %cond.end289.2, %cond.end132.2, %cond.end.2, %cond.end526.2, %cond.end567, %cond.end212.2
  ...
  br i1 %exitcond.not, label %for.inc589, label %for.body6
...
for.inc589:                                       ; preds = %for.inc586, %for.body
  ...
  br i1 %exitcond960.not, label %if.end712, label %for.body
...
for.body596:                                      ; preds = %entry, %for.inc709
  ...
  %272 = load i32, ptr %bitdepth_luma_qp_scale597, align 4
...
for.body602:                                      ; preds = %for.body602.lr.ph, %for.inc706
  ...
  store i32 %conv661, ptr %286, align 4
  %289 = load double, ptr %arrayidx612, align 8
  ...
  store i32 %conv661.1, ptr %arrayidx668.1, align 4
  %292 = load double, ptr %arrayidx612, align 8
  ...
  store i32 %conv661.2, ptr %arrayidx668.2, align 4
  %CtxAdptLagrangeMult672 = getelementptr inbounds %struct.InputParameters, ptr %274, i64 0, i32 114
  %295 = load i32, ptr %CtxAdptLagrangeMult672, align 4
...
land.lhs.true679:                                 ; preds = %if.then675
  ...
  %296 = load i32, ptr %RCEnable680, align 4
...
cond.end688:                                      ; preds = %cond.false685, %cond.true682
  ...
  %300 = load ptr, ptr %arrayidx694, align 8
  %arrayidx695 = getelementptr inbounds double, ptr %300, i64 2
  %301 = load double, ptr %arrayidx695, align 8
  ...
  %303 = load ptr, ptr %lambda_mf_factor700, align 8
  %arrayidx702 = getelementptr inbounds ptr, ptr %303, i64 %indvars.iv971
  %304 = load ptr, ptr %arrayidx702, align 8
  %arrayidx704 = getelementptr inbounds double, ptr %304, i64 %indvars.iv965
  store double %div699, ptr %arrayidx704, align 8
  %.pre1070 = load ptr, ptr @input, align 8
  br label %for.inc706
...
for.inc706:                                       ; preds = %for.body602, %cond.end688
  ...
  br i1 %exitcond970.not, label %for.inc709, label %for.body602
...
for.inc709:                                       ; preds = %for.inc706, %for.body596
  ...
  br i1 %exitcond974.not, label %if.end712, label %for.body596
