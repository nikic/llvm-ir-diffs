; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/lencod/memalloc.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/lencod/memalloc.c"
...
if.end:                                           ; preds = %if.then, %entry
  ...
  store ptr %call4, ptr %imgBotField, align 8
...
for.body.epil:                                    ; preds = %for.end.loopexit.unr-lcssa
  ...
  %15 = load ptr, ptr %arrayidx.epil, align 8
  %16 = load ptr, ptr %imgTopField, align 8
  %arrayidx13.epil = getelementptr inbounds ptr, ptr %16, i64 %indvars.iv.unr
  store ptr %15, ptr %arrayidx13.epil, align 8
  %17 = or i64 %14, 1
  %arrayidx16.epil = getelementptr inbounds ptr, ptr %imgFrame, i64 %17
  %18 = load ptr, ptr %arrayidx16.epil, align 8
  %19 = load ptr, ptr %imgBotField, align 8
  %arrayidx18.epil = getelementptr inbounds ptr, ptr %19, i64 %indvars.iv.unr
  store ptr %18, ptr %arrayidx18.epil, align 8
  br label %for.end
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph.new
  ...
  %8 = load ptr, ptr %arrayidx10.1, align 8
  %add.ptr.1 = getelementptr inbounds i16, ptr %8, i64 %idx.ext
  %arrayidx12.1 = getelementptr inbounds ptr, ptr %7, i64 %indvars.iv.next
  store ptr %add.ptr.1, ptr %arrayidx12.1, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %9 = load ptr, ptr %array2D, align 8
  %10 = add nuw nsw i64 %indvars.iv, 1
  %arrayidx10.2 = getelementptr inbounds ptr, ptr %9, i64 %10
  %11 = load ptr, ptr %arrayidx10.2, align 8
  %add.ptr.2 = getelementptr inbounds i16, ptr %11, i64 %idx.ext
  %arrayidx12.2 = getelementptr inbounds ptr, ptr %9, i64 %indvars.iv.next.1
  store ptr %add.ptr.2, ptr %arrayidx12.2, align 8
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %12 = load ptr, ptr %array2D, align 8
  %13 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx10.3 = getelementptr inbounds ptr, ptr %12, i64 %13
  %14 = load ptr, ptr %arrayidx10.3, align 8
  %add.ptr.3 = getelementptr inbounds i16, ptr %14, i64 %idx.ext
  %arrayidx12.3 = getelementptr inbounds ptr, ptr %12, i64 %indvars.iv.next.2
  store ptr %add.ptr.3, ptr %arrayidx12.3, align 8
...
for.body.epil:                                    ; preds = %for.end.loopexit.unr-lcssa, %for.body.epil
  ...
  %arrayidx10.epil = getelementptr inbounds ptr, ptr %15, i64 %16
  %17 = load ptr, ptr %arrayidx10.epil, align 8
  %add.ptr.epil = getelementptr inbounds i16, ptr %17, i64 %idx.ext
  %arrayidx12.epil = getelementptr inbounds ptr, ptr %15, i64 %indvars.iv.epil
  store ptr %add.ptr.epil, ptr %arrayidx12.epil, align 8
...
for.body.lr.ph:                                   ; preds = %if.end
  ...
  %mul.i23 = mul i32 %columns, %rows
  %conv2.i = sext i32 %mul.i23 to i64
  %idx.ext.i = sext i32 %columns to i64
  %wide.trip.count.i24 = zext i32 %rows to i64
...
for.body.us.us.preheader:                         ; preds = %for.body.lr.ph.split.us
  %0 = add nsw i64 %wide.trip.count.i24, -1
  %1 = add nsw i64 %wide.trip.count.i24, -2
...
for.body.us.us:                                   ; preds = %for.body.us.us.preheader, %get_mem3Dpel.exit.loopexit.split.us.us.us
  ...
  %3 = load ptr, ptr %array4D, align 8
  ...
  store ptr %call.i18.us.us, ptr %add.ptr.us.us, align 8
...
for.body.i.us.us.us:                              ; preds = %for.body.i.us.us.us.preheader, %get_mem2Dpel.exit.loopexit.us.us.us
  ...
  %4 = load ptr, ptr %add.ptr.us.us, align 8
  ...
  store ptr %call.i20.us.us.us, ptr %add.ptr.i.us.us.us, align 8
  %cmp.i21.us.us.us = icmp eq ptr %call.i20.us.us.us, null
  br i1 %cmp.i21.us.us.us, label %if.then.i30.us.us.us, label %if.end.i22.us.us.us

if.then.i30.us.us.us:                             ; preds = %for.body.i.us.us.us
  %call.i.i31.us.us.us = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.26, ptr noundef nonnull @.str.2) #7
  tail call void @error(ptr noundef nonnull @errortext, i32 noundef 100) #7
  %.pre.i.us.us.us = load ptr, ptr %add.ptr.i.us.us.us, align 8
  br label %if.end.i22.us.us.us

if.end.i22.us.us.us:                              ; preds = %if.then.i30.us.us.us, %for.body.i.us.us.us
  %5 = phi ptr [ %.pre.i.us.us.us, %if.then.i30.us.us.us ], [ %call.i20.us.us.us, %for.body.i.us.us.us ]
  %call3.i.us.us.us = tail call noalias ptr @calloc(i64 noundef %conv2.i, i64 noundef 2) #6
  store ptr %call3.i.us.us.us, ptr %5, align 8
  %cmp4.i.us.us.us = icmp eq ptr %call3.i.us.us.us, null
  br i1 %cmp4.i.us.us.us, label %if.then6.i.us.us.us, label %for.body.i25.us.us.us.preheader

if.then6.i.us.us.us:                              ; preds = %if.end.i22.us.us.us
  ...
  tail call void @error(ptr noundef nonnull @errortext, i32 noundef 100) #7
  br label %for.body.i25.us.us.us.preheader

for.body.i25.us.us.us.preheader:                  ; preds = %if.then6.i.us.us.us, %if.end.i22.us.us.us
  br i1 %2, label %get_mem2Dpel.exit.loopexit.us.us.us.unr-lcssa, label %for.body.i25.us.us.us

for.body.i25.us.us.us:                            ; preds = %for.body.i25.us.us.us.preheader, %for.body.i25.us.us.us
  %indvars.iv.i26.us.us.us = phi i64 [ %indvars.iv.next.i28.us.us.us.3, %for.body.i25.us.us.us ], [ 1, %for.body.i25.us.us.us.preheader ]
  %niter = phi i64 [ %niter.next.3, %for.body.i25.us.us.us ], [ 0, %for.body.i25.us.us.us.preheader ]
  %6 = load ptr, ptr %add.ptr.i.us.us.us, align 8
  %7 = add nsw i64 %indvars.iv.i26.us.us.us, -1
  %arrayidx10.i.us.us.us = getelementptr inbounds ptr, ptr %6, i64 %7
  %8 = load ptr, ptr %arrayidx10.i.us.us.us, align 8
  %add.ptr.i27.us.us.us = getelementptr inbounds i16, ptr %8, i64 %idx.ext.i
  %arrayidx12.i.us.us.us = getelementptr inbounds ptr, ptr %6, i64 %indvars.iv.i26.us.us.us
  store ptr %add.ptr.i27.us.us.us, ptr %arrayidx12.i.us.us.us, align 8
  %indvars.iv.next.i28.us.us.us = add nuw nsw i64 %indvars.iv.i26.us.us.us, 1
  %9 = load ptr, ptr %add.ptr.i.us.us.us, align 8
  %arrayidx10.i.us.us.us.1 = getelementptr inbounds ptr, ptr %9, i64 %indvars.iv.i26.us.us.us
  %10 = load ptr, ptr %arrayidx10.i.us.us.us.1, align 8
  %add.ptr.i27.us.us.us.1 = getelementptr inbounds i16, ptr %10, i64 %idx.ext.i
  %arrayidx12.i.us.us.us.1 = getelementptr inbounds ptr, ptr %9, i64 %indvars.iv.next.i28.us.us.us
  store ptr %add.ptr.i27.us.us.us.1, ptr %arrayidx12.i.us.us.us.1, align 8
  %indvars.iv.next.i28.us.us.us.1 = add nuw nsw i64 %indvars.iv.i26.us.us.us, 2
  %11 = load ptr, ptr %add.ptr.i.us.us.us, align 8
  %12 = add nuw nsw i64 %indvars.iv.i26.us.us.us, 1
  %arrayidx10.i.us.us.us.2 = getelementptr inbounds ptr, ptr %11, i64 %12
  %13 = load ptr, ptr %arrayidx10.i.us.us.us.2, align 8
  %add.ptr.i27.us.us.us.2 = getelementptr inbounds i16, ptr %13, i64 %idx.ext.i
  %arrayidx12.i.us.us.us.2 = getelementptr inbounds ptr, ptr %11, i64 %indvars.iv.next.i28.us.us.us.1
  store ptr %add.ptr.i27.us.us.us.2, ptr %arrayidx12.i.us.us.us.2, align 8
  %indvars.iv.next.i28.us.us.us.2 = add nuw nsw i64 %indvars.iv.i26.us.us.us, 3
  %14 = load ptr, ptr %add.ptr.i.us.us.us, align 8
  %15 = add nuw nsw i64 %indvars.iv.i26.us.us.us, 2
  %arrayidx10.i.us.us.us.3 = getelementptr inbounds ptr, ptr %14, i64 %15
  %16 = load ptr, ptr %arrayidx10.i.us.us.us.3, align 8
  %add.ptr.i27.us.us.us.3 = getelementptr inbounds i16, ptr %16, i64 %idx.ext.i
  %arrayidx12.i.us.us.us.3 = getelementptr inbounds ptr, ptr %14, i64 %indvars.iv.next.i28.us.us.us.2
  store ptr %add.ptr.i27.us.us.us.3, ptr %arrayidx12.i.us.us.us.3, align 8
  %indvars.iv.next.i28.us.us.us.3 = add nuw nsw i64 %indvars.iv.i26.us.us.us, 4
  %niter.next.3 = add nuw i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %get_mem2Dpel.exit.loopexit.us.us.us.unr-lcssa, label %for.body.i25.us.us.us

get_mem2Dpel.exit.loopexit.us.us.us.unr-lcssa:    ; preds = %for.body.i25.us.us.us, %for.body.i25.us.us.us.preheader
  %indvars.iv.i26.us.us.us.unr = phi i64 [ 1, %for.body.i25.us.us.us.preheader ], [ %indvars.iv.next.i28.us.us.us.3, %for.body.i25.us.us.us ]
  br i1 %lcmp.mod.not, label %get_mem2Dpel.exit.loopexit.us.us.us, label %for.body.i25.us.us.us.epil

for.body.i25.us.us.us.epil:                       ; preds = %get_mem2Dpel.exit.loopexit.us.us.us.unr-lcssa, %for.body.i25.us.us.us.epil
  %indvars.iv.i26.us.us.us.epil = phi i64 [ %indvars.iv.next.i28.us.us.us.epil, %for.body.i25.us.us.us.epil ], [ %indvars.iv.i26.us.us.us.unr, %get_mem2Dpel.exit.loopexit.us.us.us.unr-lcssa ]
  %epil.iter = phi i64 [ %epil.iter.next, %for.body.i25.us.us.us.epil ], [ 0, %get_mem2Dpel.exit.loopexit.us.us.us.unr-lcssa ]
  %17 = load ptr, ptr %add.ptr.i.us.us.us, align 8
  %18 = add nsw i64 %indvars.iv.i26.us.us.us.epil, -1
  %arrayidx10.i.us.us.us.epil = getelementptr inbounds ptr, ptr %17, i64 %18
  %19 = load ptr, ptr %arrayidx10.i.us.us.us.epil, align 8
  %add.ptr.i27.us.us.us.epil = getelementptr inbounds i16, ptr %19, i64 %idx.ext.i
  %arrayidx12.i.us.us.us.epil = getelementptr inbounds ptr, ptr %17, i64 %indvars.iv.i26.us.us.us.epil
  store ptr %add.ptr.i27.us.us.us.epil, ptr %arrayidx12.i.us.us.us.epil, align 8
  %indvars.iv.next.i28.us.us.us.epil = add nuw nsw i64 %indvars.iv.i26.us.us.us.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %get_mem2Dpel.exit.loopexit.us.us.us, label %for.body.i25.us.us.us.epil

get_mem2Dpel.exit.loopexit.us.us.us:              ; preds = %for.body.i25.us.us.us.epil, %get_mem2Dpel.exit.loopexit.us.us.us.unr-lcssa
  ...
  br i1 %exitcond.not.i.us.us.us, label %get_mem3Dpel.exit.loopexit.split.us.us.us, label %for.body.i.us.us.us

get_mem3Dpel.exit.loopexit.split.us.us.us:        ; preds = %get_mem2Dpel.exit.loopexit.us.us.us
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  %exitcond64.not = icmp eq i64 %indvars.iv.next61, %wide.trip.count63
  br i1 %exitcond64.not, label %for.end, label %for.body.us.us
...
for.body.us:                                      ; preds = %for.body.lr.ph.split.us, %get_mem3Dpel.exit.loopexit.split.us50
  ...
  %add.ptr.us = getelementptr inbounds ptr, ptr %20, i64 %indvars.iv55
  %call.i18.us = tail call noalias ptr @calloc(i64 noundef %conv.i, i64 noundef 8) #6
  store ptr %call.i18.us, ptr %add.ptr.us, align 8
...
for.body.i.us34:                                  ; preds = %for.body.i.us34.preheader, %if.end7.i.us47
  ...
  %21 = load ptr, ptr %add.ptr.us, align 8
  %add.ptr.i.us36 = getelementptr inbounds ptr, ptr %21, i64 %indvars.iv.i.us35
  %call.i20.us37 = tail call noalias ptr @calloc(i64 noundef %conv.i19, i64 noundef 8) #6
  store ptr %call.i20.us37, ptr %add.ptr.i.us36, align 8
  %cmp.i21.us38 = icmp eq ptr %call.i20.us37, null
  br i1 %cmp.i21.us38, label %if.then.i30.us39, label %if.end.i22.us42

if.then.i30.us39:                                 ; preds = %for.body.i.us34
  %call.i.i31.us40 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.26, ptr noundef nonnull @.str.2) #7
  tail call void @error(ptr noundef nonnull @errortext, i32 noundef 100) #7
  %.pre.i.us41 = load ptr, ptr %add.ptr.i.us36, align 8
  br label %if.end.i22.us42

if.end.i22.us42:                                  ; preds = %if.then.i30.us39, %for.body.i.us34
  %22 = phi ptr [ %.pre.i.us41, %if.then.i30.us39 ], [ %call.i20.us37, %for.body.i.us34 ]
  %call3.i.us43 = tail call noalias ptr @calloc(i64 noundef %conv2.i, i64 noundef 2) #6
  store ptr %call3.i.us43, ptr %22, align 8
  %cmp4.i.us44 = icmp eq ptr %call3.i.us43, null
  br i1 %cmp4.i.us44, label %if.then6.i.us45, label %if.end7.i.us47

if.then6.i.us45:                                  ; preds = %if.end.i22.us42
...
if.end7.i.us47:                                   ; preds = %if.then6.i.us45, %if.end.i22.us42
  ...
  br i1 %exitcond.not.i.us49, label %get_mem3Dpel.exit.loopexit.split.us50, label %for.body.i.us34
...
for.end:                                          ; preds = %if.end.i, %get_mem3Dpel.exit.loopexit.split.us50, %get_mem3Dpel.exit.loopexit.split.us.us.us, %if.end.for.end_crit_edge
  %mul.pre-phi = phi i32 [ %.pre, %if.end.for.end_crit_edge ], [ %mul.i23, %get_mem3Dpel.exit.loopexit.split.us.us.us ], [ %mul.i23, %get_mem3Dpel.exit.loopexit.split.us50 ], [ %mul.i23, %if.end.i ]
...
for.body.lr.ph:                                   ; preds = %for.cond.preheader
  ...
  %wide.trip.count.i10 = zext i32 %sub_y to i64
...
for.body.lr.ph.split.us:                          ; preds = %for.body.lr.ph
  %cmp5.i7 = icmp sgt i32 %sub_y, 0
  %wide.trip.count41 = zext i32 %dims to i64
  br i1 %cmp5.i7, label %for.body.us.us, label %for.body.us
...
for.body.us.us:                                   ; preds = %for.body.lr.ph.split.us, %free_mem4Dpel.exit.us.us
  ...
  %0 = load ptr, ptr %arrayidx.us.us, align 8
...
free_mem4Dpel.exit.us.us:                         ; preds = %for.end.i.loopexit.split.us.us.us, %if.else.i.us.us
  ...
  br i1 %exitcond42.not, label %for.end, label %for.body.us.us
...
for.body.i.us.us.us:                              ; preds = %for.body.us.us, %free_mem3Dpel.exit.us.us.us
  ...
  %1 = load ptr, ptr %arrayidx.i.us.us.us, align 8
  %tobool.not.i5.us.us.us = icmp eq ptr %1, null
  br i1 %tobool.not.i5.us.us.us, label %if.else.i16.us.us.us, label %for.body.i11.us.us.us

for.body.i11.us.us.us:                            ; preds = %for.body.i.us.us.us, %free_mem2Dpel.exit.i.us.us.us
  %indvars.iv.i12.us.us.us = phi i64 [ %indvars.iv.next.i14.us.us.us, %free_mem2Dpel.exit.i.us.us.us ], [ 0, %for.body.i.us.us.us ]
  %arrayidx.i13.us.us.us = getelementptr inbounds ptr, ptr %1, i64 %indvars.iv.i12.us.us.us
  %2 = load ptr, ptr %arrayidx.i13.us.us.us, align 8
...
if.then.i.i.us.us.us:                             ; preds = %for.body.i11.us.us.us
...
if.else4.i.i.us.us.us:                            ; preds = %for.body.i11.us.us.us
  tail call void @error(ptr noundef nonnull @.str.6, i32 noundef 100) #7
  br label %free_mem2Dpel.exit.i.us.us.us

free_mem2Dpel.exit.i.us.us.us:                    ; preds = %if.else4.i.i.us.us.us, %if.end.i.i.us.us.us
  %indvars.iv.next.i14.us.us.us = add nuw nsw i64 %indvars.iv.i12.us.us.us, 1
  %exitcond.not.i15.us.us.us = icmp eq i64 %indvars.iv.next.i14.us.us.us, %wide.trip.count.i10
  br i1 %exitcond.not.i15.us.us.us, label %for.end.i8.loopexit.us.us.us, label %for.body.i11.us.us.us

if.else.i16.us.us.us:                             ; preds = %for.body.i.us.us.us
  tail call void @error(ptr noundef nonnull @.str.7, i32 noundef 100) #7
  br label %free_mem3Dpel.exit.us.us.us

free_mem3Dpel.exit.us.us.us:                      ; preds = %for.end.i8.loopexit.us.us.us, %if.else.i16.us.us.us
  %indvars.iv.next.i.us.us.us = add nuw nsw i64 %indvars.iv.i.us.us.us, 1
  %exitcond.not.i.us.us.us = icmp eq i64 %indvars.iv.next.i.us.us.us, %wide.trip.count.i
  br i1 %exitcond.not.i.us.us.us, label %for.end.i.loopexit.split.us.us.us, label %for.body.i.us.us.us

for.end.i8.loopexit.us.us.us:                     ; preds = %free_mem2Dpel.exit.i.us.us.us
  tail call void @free(ptr noundef nonnull %1) #7
  br label %free_mem3Dpel.exit.us.us.us
...
for.body.i.us19:                                  ; preds = %for.body.us, %free_mem3Dpel.exit.us25
  ...
  %5 = load ptr, ptr %arrayidx.i.us21, align 8
  %tobool.not.i5.us22 = icmp eq ptr %5, null
  br i1 %tobool.not.i5.us22, label %if.else.i16.us24, label %for.cond.preheader.i6.us23

for.cond.preheader.i6.us23:                       ; preds = %for.body.i.us19
...
free_mem3Dpel.exit.us25:                          ; preds = %if.else.i16.us24, %for.cond.preheader.i6.us23
  ...
  br i1 %exitcond.not.i.us27, label %for.end.i.loopexit.split.us28, label %for.body.i.us19
...
free_mem4Dpel.exit.us:                            ; preds = %if.else.i.us, %for.end.i.loopexit.split.us28
  ...
  br i1 %exitcond37.not, label %for.end, label %for.body.us
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph.new
  ...
  %arrayidx10.3 = getelementptr inbounds ptr, ptr %12, i64 %13
  %14 = load ptr, ptr %arrayidx10.3, align 8
  %add.ptr.3 = getelementptr inbounds i8, ptr %14, i64 %idx.ext
  %arrayidx12.3 = getelementptr inbounds ptr, ptr %12, i64 %indvars.iv.next.2
  store ptr %add.ptr.3, ptr %arrayidx12.3, align 8
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %niter.next.3 = add nuw i64 %niter, 4
...
for.body.epil:                                    ; preds = %for.end.loopexit.unr-lcssa, %for.body.epil
  ...
  %arrayidx10.epil = getelementptr inbounds ptr, ptr %15, i64 %16
  %17 = load ptr, ptr %arrayidx10.epil, align 8
  %add.ptr.epil = getelementptr inbounds i8, ptr %17, i64 %idx.ext
  %arrayidx12.epil = getelementptr inbounds ptr, ptr %15, i64 %indvars.iv.epil
  store ptr %add.ptr.epil, ptr %arrayidx12.epil, align 8
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph.new
  ...
  %arrayidx10.2 = getelementptr inbounds ptr, ptr %9, i64 %10
  %11 = load ptr, ptr %arrayidx10.2, align 8
  %add.ptr.2 = getelementptr inbounds i32, ptr %11, i64 %idx.ext
  %arrayidx12.2 = getelementptr inbounds ptr, ptr %9, i64 %indvars.iv.next.1
  store ptr %add.ptr.2, ptr %arrayidx12.2, align 8
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %12 = load ptr, ptr %array2D, align 8
  ...
  %arrayidx10.3 = getelementptr inbounds ptr, ptr %12, i64 %13
  %14 = load ptr, ptr %arrayidx10.3, align 8
  %add.ptr.3 = getelementptr inbounds i32, ptr %14, i64 %idx.ext
  %arrayidx12.3 = getelementptr inbounds ptr, ptr %12, i64 %indvars.iv.next.2
  store ptr %add.ptr.3, ptr %arrayidx12.3, align 8
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %niter.next.3 = add nuw i64 %niter, 4
...
for.body.epil:                                    ; preds = %for.end.loopexit.unr-lcssa, %for.body.epil
  ...
  %arrayidx10.epil = getelementptr inbounds ptr, ptr %15, i64 %16
  %17 = load ptr, ptr %arrayidx10.epil, align 8
  %add.ptr.epil = getelementptr inbounds i32, ptr %17, i64 %idx.ext
  %arrayidx12.epil = getelementptr inbounds ptr, ptr %15, i64 %indvars.iv.epil
  store ptr %add.ptr.epil, ptr %arrayidx12.epil, align 8
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph.new
  ...
  %arrayidx10.2 = getelementptr inbounds ptr, ptr %9, i64 %10
  %11 = load ptr, ptr %arrayidx10.2, align 8
  %add.ptr.2 = getelementptr inbounds i64, ptr %11, i64 %idx.ext
  %arrayidx12.2 = getelementptr inbounds ptr, ptr %9, i64 %indvars.iv.next.1
  store ptr %add.ptr.2, ptr %arrayidx12.2, align 8
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %12 = load ptr, ptr %array2D, align 8
  ...
  %arrayidx10.3 = getelementptr inbounds ptr, ptr %12, i64 %13
  %14 = load ptr, ptr %arrayidx10.3, align 8
  %add.ptr.3 = getelementptr inbounds i64, ptr %14, i64 %idx.ext
  %arrayidx12.3 = getelementptr inbounds ptr, ptr %12, i64 %indvars.iv.next.2
  store ptr %add.ptr.3, ptr %arrayidx12.3, align 8
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %niter.next.3 = add nuw i64 %niter, 4
...
for.body.epil:                                    ; preds = %for.end.loopexit.unr-lcssa, %for.body.epil
  ...
  %arrayidx10.epil = getelementptr inbounds ptr, ptr %15, i64 %16
  %17 = load ptr, ptr %arrayidx10.epil, align 8
  %add.ptr.epil = getelementptr inbounds i64, ptr %17, i64 %idx.ext
  %arrayidx12.epil = getelementptr inbounds ptr, ptr %15, i64 %indvars.iv.epil
  store ptr %add.ptr.epil, ptr %arrayidx12.epil, align 8
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
...
if.then.i30.us.us.us:                             ; preds = %for.body.i.us.us.us
  %call.i.i31.us.us.us = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.26, ptr noundef nonnull @.str.11) #7
  tail call void @error(ptr noundef nonnull @errortext, i32 noundef 100) #7
  %.pre.i.us.us.us = load ptr, ptr %add.ptr.i.us.us.us, align 8
  br label %if.end.i22.us.us.us
...
for.body.i25.us.us.us.preheader:                  ; preds = %if.then6.i.us.us.us, %if.end.i22.us.us.us
  br i1 %2, label %get_mem2Dint.exit.loopexit.us.us.us.unr-lcssa, label %for.body.i25.us.us.us
...
for.body.i25.us.us.us:                            ; preds = %for.body.i25.us.us.us.preheader, %for.body.i25.us.us.us
  ...
  %arrayidx10.i.us.us.us = getelementptr inbounds ptr, ptr %6, i64 %7
  %8 = load ptr, ptr %arrayidx10.i.us.us.us, align 8
  %add.ptr.i27.us.us.us = getelementptr inbounds i32, ptr %8, i64 %idx.ext.i
  %arrayidx12.i.us.us.us = getelementptr inbounds ptr, ptr %6, i64 %indvars.iv.i26.us.us.us
  store ptr %add.ptr.i27.us.us.us, ptr %arrayidx12.i.us.us.us, align 8
  %indvars.iv.next.i28.us.us.us = add nuw nsw i64 %indvars.iv.i26.us.us.us, 1
  %9 = load ptr, ptr %add.ptr.i.us.us.us, align 8
  %arrayidx10.i.us.us.us.1 = getelementptr inbounds ptr, ptr %9, i64 %indvars.iv.i26.us.us.us
  %10 = load ptr, ptr %arrayidx10.i.us.us.us.1, align 8
  %add.ptr.i27.us.us.us.1 = getelementptr inbounds i32, ptr %10, i64 %idx.ext.i
  %arrayidx12.i.us.us.us.1 = getelementptr inbounds ptr, ptr %9, i64 %indvars.iv.next.i28.us.us.us
  store ptr %add.ptr.i27.us.us.us.1, ptr %arrayidx12.i.us.us.us.1, align 8
  %indvars.iv.next.i28.us.us.us.1 = add nuw nsw i64 %indvars.iv.i26.us.us.us, 2
  %11 = load ptr, ptr %add.ptr.i.us.us.us, align 8
  ...
  %arrayidx10.i.us.us.us.2 = getelementptr inbounds ptr, ptr %11, i64 %12
  %13 = load ptr, ptr %arrayidx10.i.us.us.us.2, align 8
  %add.ptr.i27.us.us.us.2 = getelementptr inbounds i32, ptr %13, i64 %idx.ext.i
  %arrayidx12.i.us.us.us.2 = getelementptr inbounds ptr, ptr %11, i64 %indvars.iv.next.i28.us.us.us.1
  store ptr %add.ptr.i27.us.us.us.2, ptr %arrayidx12.i.us.us.us.2, align 8
  %indvars.iv.next.i28.us.us.us.2 = add nuw nsw i64 %indvars.iv.i26.us.us.us, 3
  %14 = load ptr, ptr %add.ptr.i.us.us.us, align 8
  ...
  %arrayidx10.i.us.us.us.3 = getelementptr inbounds ptr, ptr %14, i64 %15
  %16 = load ptr, ptr %arrayidx10.i.us.us.us.3, align 8
  %add.ptr.i27.us.us.us.3 = getelementptr inbounds i32, ptr %16, i64 %idx.ext.i
  %arrayidx12.i.us.us.us.3 = getelementptr inbounds ptr, ptr %14, i64 %indvars.iv.next.i28.us.us.us.2
  store ptr %add.ptr.i27.us.us.us.3, ptr %arrayidx12.i.us.us.us.3, align 8
  %indvars.iv.next.i28.us.us.us.3 = add nuw nsw i64 %indvars.iv.i26.us.us.us, 4
  %niter.next.3 = add nuw i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %get_mem2Dint.exit.loopexit.us.us.us.unr-lcssa, label %for.body.i25.us.us.us

get_mem2Dint.exit.loopexit.us.us.us.unr-lcssa:    ; preds = %for.body.i25.us.us.us, %for.body.i25.us.us.us.preheader
  %indvars.iv.i26.us.us.us.unr = phi i64 [ 1, %for.body.i25.us.us.us.preheader ], [ %indvars.iv.next.i28.us.us.us.3, %for.body.i25.us.us.us ]
  br i1 %lcmp.mod.not, label %get_mem2Dint.exit.loopexit.us.us.us, label %for.body.i25.us.us.us.epil

for.body.i25.us.us.us.epil:                       ; preds = %get_mem2Dint.exit.loopexit.us.us.us.unr-lcssa, %for.body.i25.us.us.us.epil
  %indvars.iv.i26.us.us.us.epil = phi i64 [ %indvars.iv.next.i28.us.us.us.epil, %for.body.i25.us.us.us.epil ], [ %indvars.iv.i26.us.us.us.unr, %get_mem2Dint.exit.loopexit.us.us.us.unr-lcssa ]
  %epil.iter = phi i64 [ %epil.iter.next, %for.body.i25.us.us.us.epil ], [ 0, %get_mem2Dint.exit.loopexit.us.us.us.unr-lcssa ]
  %17 = load ptr, ptr %add.ptr.i.us.us.us, align 8
  %18 = add nsw i64 %indvars.iv.i26.us.us.us.epil, -1
  %arrayidx10.i.us.us.us.epil = getelementptr inbounds ptr, ptr %17, i64 %18
  %19 = load ptr, ptr %arrayidx10.i.us.us.us.epil, align 8
  %add.ptr.i27.us.us.us.epil = getelementptr inbounds i32, ptr %19, i64 %idx.ext.i
  %arrayidx12.i.us.us.us.epil = getelementptr inbounds ptr, ptr %17, i64 %indvars.iv.i26.us.us.us.epil
  store ptr %add.ptr.i27.us.us.us.epil, ptr %arrayidx12.i.us.us.us.epil, align 8
  %indvars.iv.next.i28.us.us.us.epil = add nuw nsw i64 %indvars.iv.i26.us.us.us.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %get_mem2Dint.exit.loopexit.us.us.us, label %for.body.i25.us.us.us.epil

get_mem2Dint.exit.loopexit.us.us.us:              ; preds = %for.body.i25.us.us.us.epil, %get_mem2Dint.exit.loopexit.us.us.us.unr-lcssa
  %indvars.iv.next.i.us.us.us = add nuw nsw i64 %indvars.iv.i.us.us.us, 1
  %exitcond.not.i.us.us.us = icmp eq i64 %indvars.iv.next.i.us.us.us, %wide.trip.count.i
  br i1 %exitcond.not.i.us.us.us, label %get_mem3Dint.exit.loopexit.split.us.us.us, label %for.body.i.us.us.us
...
if.then.i30.us39:                                 ; preds = %for.body.i.us34
  %call.i.i31.us40 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.26, ptr noundef nonnull @.str.11) #7
  tail call void @error(ptr noundef nonnull @errortext, i32 noundef 100) #7
  %.pre.i.us41 = load ptr, ptr %add.ptr.i.us36, align 8
  br label %if.end.i22.us42
...
if.end7.i.us47:                                   ; preds = %if.then6.i.us45, %if.end.i22.us42
  %indvars.iv.next.i.us48 = add nuw nsw i64 %indvars.iv.i.us35, 1
  %exitcond.not.i.us49 = icmp eq i64 %indvars.iv.next.i.us48, %wide.trip.count.i
  br i1 %exitcond.not.i.us49, label %get_mem3Dint.exit.loopexit.split.us50, label %for.body.i.us34
...
for.end:                                          ; preds = %if.end.i, %get_mem3Dint.exit.loopexit.split.us50, %get_mem3Dint.exit.loopexit.split.us.us.us, %if.end.for.end_crit_edge
  %mul.pre-phi = phi i32 [ %.pre, %if.end.for.end_crit_edge ], [ %mul.i23, %get_mem3Dint.exit.loopexit.split.us.us.us ], [ %mul.i23, %get_mem3Dint.exit.loopexit.split.us50 ], [ %mul.i23, %if.end.i ]
...
for.body.lr.ph:                                   ; preds = %for.cond.preheader
  ...
  %wide.trip.count.i10 = zext i32 %height to i64
  br i1 %cmp5.i, label %for.body.lr.ph.split.us, label %for.body.preheader
...
for.body.i11.us.us.us:                            ; preds = %for.body.i.us.us.us, %free_mem2Dint.exit.i.us.us.us
  %indvars.iv.i12.us.us.us = phi i64 [ %indvars.iv.next.i14.us.us.us, %free_mem2Dint.exit.i.us.us.us ], [ 0, %for.body.i.us.us.us ]
  %arrayidx.i13.us.us.us = getelementptr inbounds ptr, ptr %1, i64 %indvars.iv.i12.us.us.us
  %2 = load ptr, ptr %arrayidx.i13.us.us.us, align 8
  %tobool.not.i.i.us.us.us = icmp eq ptr %2, null
  br i1 %tobool.not.i.i.us.us.us, label %if.else4.i.i.us.us.us, label %if.then.i.i.us.us.us
...
free_mem3Dint.exit.us.us.us:                      ; preds = %for.end.i8.loopexit.us.us.us, %if.else.i16.us.us.us
  %indvars.iv.next.i.us.us.us = add nuw nsw i64 %indvars.iv.i.us.us.us, 1
  %exitcond.not.i.us.us.us = icmp eq i64 %indvars.iv.next.i.us.us.us, %wide.trip.count.i
  br i1 %exitcond.not.i.us.us.us, label %for.end.i.loopexit.split.us.us.us, label %for.body.i.us.us.us

for.end.i8.loopexit.us.us.us:                     ; preds = %free_mem2Dint.exit.i.us.us.us
  tail call void @free(ptr noundef nonnull %1) #7
  br label %free_mem3Dint.exit.us.us.us
...
free_mem3Dint.exit.us25:                          ; preds = %if.else.i16.us24, %for.cond.preheader.i6.us23
  %indvars.iv.next.i.us26 = add nuw nsw i64 %indvars.iv.i.us20, 1
  %exitcond.not.i.us27 = icmp eq i64 %indvars.iv.next.i.us26, %wide.trip.count.i
  br i1 %exitcond.not.i.us27, label %for.end.i.loopexit.split.us28, label %for.body.i.us19
...
if.then.i30.us.us.us:                             ; preds = %for.body.i.us.us.us
  %call.i.i31.us.us.us = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.26, ptr noundef nonnull @.str.27) #7
  tail call void @error(ptr noundef nonnull @errortext, i32 noundef 100) #7
  %.pre.i.us.us.us = load ptr, ptr %add.ptr.i.us.us.us, align 8
  br label %if.end.i22.us.us.us
...
for.body.i25.us.us.us.preheader:                  ; preds = %if.then6.i.us.us.us, %if.end.i22.us.us.us
  br i1 %2, label %get_mem2Dshort.exit.loopexit.us.us.us.unr-lcssa, label %for.body.i25.us.us.us
...
for.body.i25.us.us.us:                            ; preds = %for.body.i25.us.us.us.preheader, %for.body.i25.us.us.us
  ...
  %niter.next.3 = add nuw i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %get_mem2Dshort.exit.loopexit.us.us.us.unr-lcssa, label %for.body.i25.us.us.us

get_mem2Dshort.exit.loopexit.us.us.us.unr-lcssa:  ; preds = %for.body.i25.us.us.us, %for.body.i25.us.us.us.preheader
  %indvars.iv.i26.us.us.us.unr = phi i64 [ 1, %for.body.i25.us.us.us.preheader ], [ %indvars.iv.next.i28.us.us.us.3, %for.body.i25.us.us.us ]
  br i1 %lcmp.mod.not, label %get_mem2Dshort.exit.loopexit.us.us.us, label %for.body.i25.us.us.us.epil

for.body.i25.us.us.us.epil:                       ; preds = %get_mem2Dshort.exit.loopexit.us.us.us.unr-lcssa, %for.body.i25.us.us.us.epil
  %indvars.iv.i26.us.us.us.epil = phi i64 [ %indvars.iv.next.i28.us.us.us.epil, %for.body.i25.us.us.us.epil ], [ %indvars.iv.i26.us.us.us.unr, %get_mem2Dshort.exit.loopexit.us.us.us.unr-lcssa ]
  %epil.iter = phi i64 [ %epil.iter.next, %for.body.i25.us.us.us.epil ], [ 0, %get_mem2Dshort.exit.loopexit.us.us.us.unr-lcssa ]
  %17 = load ptr, ptr %add.ptr.i.us.us.us, align 8
  %18 = add nsw i64 %indvars.iv.i26.us.us.us.epil, -1
  %arrayidx10.i.us.us.us.epil = getelementptr inbounds ptr, ptr %17, i64 %18
  %19 = load ptr, ptr %arrayidx10.i.us.us.us.epil, align 8
  ...
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %get_mem2Dshort.exit.loopexit.us.us.us, label %for.body.i25.us.us.us.epil

get_mem2Dshort.exit.loopexit.us.us.us:            ; preds = %for.body.i25.us.us.us.epil, %get_mem2Dshort.exit.loopexit.us.us.us.unr-lcssa
  %indvars.iv.next.i.us.us.us = add nuw nsw i64 %indvars.iv.i.us.us.us, 1
  %exitcond.not.i.us.us.us = icmp eq i64 %indvars.iv.next.i.us.us.us, %wide.trip.count.i
  br i1 %exitcond.not.i.us.us.us, label %get_mem3Dshort.exit.loopexit.split.us.us.us, label %for.body.i.us.us.us
...
if.then.i30.us39:                                 ; preds = %for.body.i.us34
  %call.i.i31.us40 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.26, ptr noundef nonnull @.str.27) #7
  tail call void @error(ptr noundef nonnull @errortext, i32 noundef 100) #7
  %.pre.i.us41 = load ptr, ptr %add.ptr.i.us36, align 8
  br label %if.end.i22.us42
...
if.end7.i.us47:                                   ; preds = %if.then6.i.us45, %if.end.i22.us42
  %indvars.iv.next.i.us48 = add nuw nsw i64 %indvars.iv.i.us35, 1
  %exitcond.not.i.us49 = icmp eq i64 %indvars.iv.next.i.us48, %wide.trip.count.i
  br i1 %exitcond.not.i.us49, label %get_mem3Dshort.exit.loopexit.split.us50, label %for.body.i.us34
...
for.end:                                          ; preds = %if.end.i, %get_mem3Dshort.exit.loopexit.split.us50, %get_mem3Dshort.exit.loopexit.split.us.us.us, %if.end.for.end_crit_edge
  %mul.pre-phi = phi i32 [ %.pre, %if.end.for.end_crit_edge ], [ %mul.i23, %get_mem3Dshort.exit.loopexit.split.us.us.us ], [ %mul.i23, %get_mem3Dshort.exit.loopexit.split.us50 ], [ %mul.i23, %if.end.i ]
  %mul5 = shl i32 %mul.pre-phi, 1
  %mul6 = mul i32 %mul5, %idx
  %mul8 = mul i32 %mul6, %frames
  ret i32 %mul8
...
for.body.us:                                      ; preds = %for.body.lr.ph, %get_mem5Dshort.exit.loopexit.us
  ...
  store ptr %call.i22.us, ptr %add.ptr.us, align 8
...
for.body.i.us:                                    ; preds = %for.body.i.us.preheader, %for.body.i.us
  ...
  %1 = load ptr, ptr %add.ptr.us, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end.i
  ...
  store ptr %call.i22, ptr %add.ptr, align 8
...
for.body.i11.us.us.us:                            ; preds = %for.body.i.us.us.us, %free_mem2Dshort.exit.i.us.us.us
  %indvars.iv.i12.us.us.us = phi i64 [ %indvars.iv.next.i14.us.us.us, %free_mem2Dshort.exit.i.us.us.us ], [ 0, %for.body.i.us.us.us ]
  %arrayidx.i13.us.us.us = getelementptr inbounds ptr, ptr %1, i64 %indvars.iv.i12.us.us.us
  %2 = load ptr, ptr %arrayidx.i13.us.us.us, align 8
  %tobool.not.i.i.us.us.us = icmp eq ptr %2, null
  br i1 %tobool.not.i.i.us.us.us, label %if.else4.i.i.us.us.us, label %if.then.i.i.us.us.us
...
free_mem3Dshort.exit.us.us.us:                    ; preds = %for.end.i8.loopexit.us.us.us, %if.else.i16.us.us.us
  %indvars.iv.next.i.us.us.us = add nuw nsw i64 %indvars.iv.i.us.us.us, 1
  %exitcond.not.i.us.us.us = icmp eq i64 %indvars.iv.next.i.us.us.us, %wide.trip.count.i
  br i1 %exitcond.not.i.us.us.us, label %for.end.i.loopexit.split.us.us.us, label %for.body.i.us.us.us

for.end.i8.loopexit.us.us.us:                     ; preds = %free_mem2Dshort.exit.i.us.us.us
  tail call void @free(ptr noundef nonnull %1) #7
  br label %free_mem3Dshort.exit.us.us.us
...
free_mem3Dshort.exit.us25:                        ; preds = %if.else.i16.us24, %for.cond.preheader.i6.us23
  %indvars.iv.next.i.us26 = add nuw nsw i64 %indvars.iv.i.us20, 1
  %exitcond.not.i.us27 = icmp eq i64 %indvars.iv.next.i.us26, %wide.trip.count.i
  br i1 %exitcond.not.i.us27, label %for.end.i.loopexit.split.us28, label %for.body.i.us19
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph.new
  ...
  %arrayidx10.2 = getelementptr inbounds ptr, ptr %9, i64 %10
  %11 = load ptr, ptr %arrayidx10.2, align 8
  %add.ptr.2 = getelementptr inbounds double, ptr %11, i64 %idx.ext
  %arrayidx12.2 = getelementptr inbounds ptr, ptr %9, i64 %indvars.iv.next.1
  store ptr %add.ptr.2, ptr %arrayidx12.2, align 8
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %12 = load ptr, ptr %array2D, align 8
  ...
  %arrayidx10.3 = getelementptr inbounds ptr, ptr %12, i64 %13
  %14 = load ptr, ptr %arrayidx10.3, align 8
  %add.ptr.3 = getelementptr inbounds double, ptr %14, i64 %idx.ext
  %arrayidx12.3 = getelementptr inbounds ptr, ptr %12, i64 %indvars.iv.next.2
  store ptr %add.ptr.3, ptr %arrayidx12.3, align 8
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %niter.next.3 = add nuw i64 %niter, 4
...
for.body.epil:                                    ; preds = %for.end.loopexit.unr-lcssa, %for.body.epil
  ...
  %arrayidx10.epil = getelementptr inbounds ptr, ptr %15, i64 %16
  %17 = load ptr, ptr %arrayidx10.epil, align 8
  %add.ptr.epil = getelementptr inbounds double, ptr %17, i64 %idx.ext
  %arrayidx12.epil = getelementptr inbounds ptr, ptr %15, i64 %indvars.iv.epil
  store ptr %add.ptr.epil, ptr %arrayidx12.epil, align 8
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph.new
  ...
  store ptr %add.ptr13.1, ptr %arrayidx15.1, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %11 = load ptr, ptr %array2D, align 8
  %12 = add nuw nsw i64 %indvars.iv, 1
  %arrayidx11.2 = getelementptr inbounds ptr, ptr %11, i64 %12
  %13 = load ptr, ptr %arrayidx11.2, align 8
  %add.ptr13.2 = getelementptr inbounds double, ptr %13, i64 %idx.ext12
  %arrayidx15.2 = getelementptr inbounds ptr, ptr %11, i64 %indvars.iv.next.1
  store ptr %add.ptr13.2, ptr %arrayidx15.2, align 8
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %14 = load ptr, ptr %array2D, align 8
  %15 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx11.3 = getelementptr inbounds ptr, ptr %14, i64 %15
  %16 = load ptr, ptr %arrayidx11.3, align 8
  %add.ptr13.3 = getelementptr inbounds double, ptr %16, i64 %idx.ext12
  %arrayidx15.3 = getelementptr inbounds ptr, ptr %14, i64 %indvars.iv.next.2
  store ptr %add.ptr13.3, ptr %arrayidx15.3, align 8
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %niter.next.3 = add nuw i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %for.end.loopexit.unr-lcssa, label %for.body
...
for.body.epil:                                    ; preds = %for.end.loopexit.unr-lcssa, %for.body.epil
  ...
  %18 = add nsw i64 %indvars.iv.epil, -1
  %arrayidx11.epil = getelementptr inbounds ptr, ptr %17, i64 %18
  %19 = load ptr, ptr %arrayidx11.epil, align 8
  %add.ptr13.epil = getelementptr inbounds double, ptr %19, i64 %idx.ext12
  %arrayidx15.epil = getelementptr inbounds ptr, ptr %17, i64 %indvars.iv.epil
  store ptr %add.ptr13.epil, ptr %arrayidx15.epil, align 8
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %for.end, label %for.body.epil
...
for.body.epil:                                    ; preds = %for.cond16.preheader.loopexit.unr-lcssa, %for.body.epil
  ...
  %8 = load ptr, ptr %arrayidx11.epil, align 8
  ...
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %for.cond16.preheader, label %for.body.epil
...
for.body25.us:                                    ; preds = %for.body19.us, %for.inc36.us
  ...
  %12 = load ptr, ptr %arrayidx29.us, align 8
  %arrayidx31.us = getelementptr inbounds ptr, ptr %12, i64 %indvars.iv81
  store ptr %call27.us, ptr %arrayidx31.us, align 8
...
for.inc36.us:                                     ; preds = %if.then34.us, %for.body25.us
  ...
  br i1 %cmp23.us, label %for.body25.us, label %for.cond21.for.inc39_crit_edge.us

for.cond21.for.inc39_crit_edge.us:                ; preds = %for.inc36.us
  %indvars.iv.next85 = add nuw nsw i64 %indvars.iv84, 1
  %exitcond88.not = icmp eq i64 %indvars.iv.next85, %wide.trip.count87
  br i1 %exitcond88.not, label %for.end41, label %for.body19.us
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph.new
  ...
  %17 = load ptr, ptr %arrayidx11.1, align 8
  ...
  store ptr %add.ptr13.1, ptr %arrayidx15.1, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %18 = load ptr, ptr %array3D, align 8
  %19 = add nuw nsw i64 %indvars.iv, 1
  %arrayidx11.2 = getelementptr inbounds ptr, ptr %18, i64 %19
  %20 = load ptr, ptr %arrayidx11.2, align 8
  %add.ptr13.2 = getelementptr inbounds ptr, ptr %20, i64 %idx.ext12
  %arrayidx15.2 = getelementptr inbounds ptr, ptr %18, i64 %indvars.iv.next.1
  store ptr %add.ptr13.2, ptr %arrayidx15.2, align 8
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %21 = load ptr, ptr %array3D, align 8
  %22 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx11.3 = getelementptr inbounds ptr, ptr %21, i64 %22
  %23 = load ptr, ptr %arrayidx11.3, align 8
  %add.ptr13.3 = getelementptr inbounds ptr, ptr %23, i64 %idx.ext12
  %arrayidx15.3 = getelementptr inbounds ptr, ptr %21, i64 %indvars.iv.next.2
  store ptr %add.ptr13.3, ptr %arrayidx15.3, align 8
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %niter.next.3 = add nuw i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %for.cond16.preheader.loopexit.unr-lcssa, label %for.body
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph.new
  ...
  %arrayidx11.2 = getelementptr inbounds ptr, ptr %11, i64 %12
  %13 = load ptr, ptr %arrayidx11.2, align 8
  %add.ptr13.2 = getelementptr inbounds i32, ptr %13, i64 %idx.ext12
  %arrayidx15.2 = getelementptr inbounds ptr, ptr %11, i64 %indvars.iv.next.1
  store ptr %add.ptr13.2, ptr %arrayidx15.2, align 8
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %14 = load ptr, ptr %array2D, align 8
  ...
  %arrayidx11.3 = getelementptr inbounds ptr, ptr %14, i64 %15
  %16 = load ptr, ptr %arrayidx11.3, align 8
  %add.ptr13.3 = getelementptr inbounds i32, ptr %16, i64 %idx.ext12
  %arrayidx15.3 = getelementptr inbounds ptr, ptr %14, i64 %indvars.iv.next.2
  store ptr %add.ptr13.3, ptr %arrayidx15.3, align 8
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %niter.next.3 = add nuw i64 %niter, 4
...
for.body.epil:                                    ; preds = %for.end.loopexit.unr-lcssa, %for.body.epil
  ...
  %arrayidx11.epil = getelementptr inbounds ptr, ptr %17, i64 %18
  %19 = load ptr, ptr %arrayidx11.epil, align 8
  %add.ptr13.epil = getelementptr inbounds i32, ptr %19, i64 %idx.ext12
  %arrayidx15.epil = getelementptr inbounds ptr, ptr %17, i64 %indvars.iv.epil
  store ptr %add.ptr13.epil, ptr %arrayidx15.epil, align 8
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
