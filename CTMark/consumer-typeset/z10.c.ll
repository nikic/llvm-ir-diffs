; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z10.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z10.c"
...
entry:
  %0 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 140), align 1
...
if.then39:                                        ; preds = %if.then27
  ...
  store ptr %call40, ptr @zz_hold, align 8
  br label %if.end50

if.else41:                                        ; preds = %if.then27
  store ptr %7, ptr @zz_hold, align 8
  %9 = load ptr, ptr %7, align 8
  store ptr %9, ptr %arrayidx36, align 8
  br label %if.end50
...
if.then77:                                        ; preds = %if.end65
  ...
  %.pre = load ptr, ptr @RootCross, align 8
  br label %if.end88

if.else79:                                        ; preds = %if.end65
  store ptr %13, ptr @zz_hold, align 8
  %15 = load ptr, ptr %13, align 8
  store ptr %15, ptr %arrayidx74, align 8
  br label %if.end88
...
cond.end130:                                      ; preds = %if.end88
  ...
  store ptr %20, ptr %osucc123, align 8
  ...
  store ptr %24, ptr %osucc129, align 8
...
cond.end130.cond.false139_crit_edge:              ; preds = %cond.end130
  ...
  %.pre178 = load ptr, ptr %arrayidx144.phi.trans.insert, align 8
  br label %cond.false139
...
entry:
  %0 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 6), align 1
  %conv = zext i8 %0 to i32
  store i32 %conv, ptr @zz_size, align 4
  %conv1 = zext i8 %0 to i64
  %arrayidx = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv1
...
if.end13:                                         ; preds = %if.then5, %if.else7
  ...
  store i8 %conv25, ptr %ocross_type, align 1
  ...
  %5 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 2), align 1
  %conv27 = zext i8 %5 to i32
  store i32 %conv27, ptr @zz_size, align 4
...
if.then38:                                        ; preds = %if.end13
  ...
  store ptr %call39, ptr @zz_hold, align 8
  br label %if.end49

if.else40:                                        ; preds = %if.end13
  store ptr %6, ptr @zz_hold, align 8
  %8 = load ptr, ptr %6, align 8
  store ptr %8, ptr %arrayidx35, align 8
  br label %if.end49
...
if.end49:                                         ; preds = %if.then38, %if.else40
  ...
  store ptr %9, ptr %osucc54, align 8
  store ptr %9, ptr %arrayidx53, align 8
  %osucc60 = getelementptr inbounds %struct.LIST, ptr %9, i64 0, i32 1
  store ptr %9, ptr %osucc60, align 8
  store ptr %9, ptr %9, align 8
  %oactual = getelementptr inbounds %struct.closure_type, ptr %9, i64 0, i32 5
  store ptr %sym, ptr %oactual, align 8
  %10 = load i8, ptr @zz_lengths, align 1
  %conv64 = zext i8 %10 to i32
  store i32 %conv64, ptr @zz_size, align 4
...
if.else77:                                        ; preds = %if.end49
  ...
  store ptr %13, ptr %arrayidx72, align 8
  br label %cond.end128
...
cond.end128:                                      ; preds = %if.then75, %if.else77
  ...
  store ptr %17, ptr %osucc121, align 8
  ...
  store ptr %21, ptr %osucc127, align 8
  %23 = load ptr, ptr @xx_link, align 8
  store ptr %23, ptr @zz_res, align 8
...
if.else176:                                       ; preds = %cond.end161
  ...
  store ptr %30, ptr %arrayidx171, align 8
  br label %cond.end231
...
cond.false240:                                    ; preds = %cond.end231
  ...
  %41 = load ptr, ptr %arrayidx242, align 8
  store ptr %41, ptr @zz_tmp, align 8
  %arrayidx245 = getelementptr inbounds [2 x %struct.LIST], ptr %40, i64 0, i64 1
  %42 = load ptr, ptr %arrayidx245, align 8
  store ptr %42, ptr %arrayidx242, align 8
  %43 = load ptr, ptr %arrayidx245, align 8
  %osucc255 = getelementptr inbounds [2 x %struct.LIST], ptr %43, i64 0, i64 1, i32 1
  store ptr %val, ptr %osucc255, align 8
  store ptr %41, ptr %arrayidx245, align 8
  %osucc261 = getelementptr inbounds [2 x %struct.LIST], ptr %41, i64 0, i64 1, i32 1
  store ptr %40, ptr %osucc261, align 8
...
if.end8:                                          ; preds = %if.then5, %if.end
  ...
  %4 = load i32, ptr %ogall_seq10, align 4
  %inc = add nsw i32 %4, 1
  store i32 %inc, ptr %ogall_seq10, align 4
...
if.end17:                                         ; preds = %if.then14, %if.end8
  ...
  %6 = load i32, ptr %ogall_seq10, align 4
...
entry:
  ...
  %link.0613 = load ptr, ptr %osucc, align 8
...
land.lhs.true:                                    ; preds = %for.cond3
  ...
  %1 = load ptr, ptr %oactual, align 8
...
for.cond21:                                       ; preds = %for.cond21, %if.then
  %.pn = phi ptr [ %2, %if.then ], [ %y.0, %for.cond21 ]
...
cond.false79:                                     ; preds = %cond.end
  ...
  %8 = load ptr, ptr %link.0615, align 8
  ...
  store ptr %9, ptr %osucc94, align 8
  %osucc97 = getelementptr inbounds %struct.LIST, ptr %10, i64 0, i32 1
  store ptr %10, ptr %osucc97, align 8
  store ptr %10, ptr %10, align 8
...
for.inc140:                                       ; preds = %for.cond3, %land.lhs.true
  ...
  %link.0 = load ptr, ptr %osucc143, align 8
  %cmp.not = icmp eq ptr %link.0, %x
  br i1 %cmp.not, label %if.then147, label %for.cond3.preheader
...
if.then147:                                       ; preds = %for.inc140, %entry, %cond.end101, %if.then136, %for.end144
  ...
  %19 = load ptr, ptr %oactual148, align 8
  %link.2.in616 = getelementptr inbounds %struct.LIST, ptr %19, i64 0, i32 1
  %link.2617 = load ptr, ptr %link.2.in616, align 8
...
for.cond160:                                      ; preds = %for.cond160.preheader, %for.cond160
  ...
  %20 = load i8, ptr %ou1161, align 8
  %cmp164 = icmp eq i8 %20, 0
  br i1 %cmp164, label %for.cond160, label %for.end171
...
if.then210:                                       ; preds = %if.then199
  ...
  store ptr %call211, ptr @zz_hold, align 8
  br label %if.end221

if.else212:                                       ; preds = %if.then199
  store ptr %23, ptr @zz_hold, align 8
  %25 = load ptr, ptr %23, align 8
  store ptr %25, ptr %arrayidx207, align 8
  br label %if.end221
...
if.end221:                                        ; preds = %if.then210, %if.else212
  ...
  store i8 10, ptr %ou1222, align 8
...
if.end.i:                                         ; preds = %if.then.i, %if.end221
  ...
  %29 = load i16, ptr %ofile_num.i, align 2
...
CrossGenTag.exit:                                 ; preds = %if.end.i, %if.then4.i
  ...
  %31 = load i16, ptr %ofile_num9.i, align 2
...
if.else251:                                       ; preds = %CrossGenTag.exit
  ...
  store ptr %35, ptr %arrayidx246, align 8
  br label %cond.end306
...
cond.end306:                                      ; preds = %if.then249, %if.else251
  ...
  %39 = load ptr, ptr @zz_hold, align 8
  %40 = load ptr, ptr @zz_res, align 8
  %41 = load ptr, ptr %40, align 8
  %osucc297 = getelementptr inbounds %struct.LIST, ptr %41, i64 0, i32 1
  store ptr %39, ptr %osucc297, align 8
  %42 = load ptr, ptr @zz_tmp, align 8
  store ptr %42, ptr %40, align 8
  %43 = load ptr, ptr @zz_res, align 8
  %44 = load ptr, ptr @zz_tmp, align 8
  %osucc303 = getelementptr inbounds %struct.LIST, ptr %44, i64 0, i32 1
  store ptr %43, ptr %osucc303, align 8
  %45 = load ptr, ptr @xx_link, align 8
  store ptr %45, ptr @zz_res, align 8
  store ptr %call14.i, ptr @zz_hold, align 8
...
cond.false315:                                    ; preds = %cond.end306
  ...
  %46 = load ptr, ptr %arrayidx317, align 8
  store ptr %46, ptr @zz_tmp, align 8
  %arrayidx320 = getelementptr inbounds [2 x %struct.LIST], ptr %45, i64 0, i64 1
  %47 = load ptr, ptr %arrayidx320, align 8
  store ptr %47, ptr %arrayidx317, align 8
  %48 = load ptr, ptr %arrayidx320, align 8
  %osucc330 = getelementptr inbounds [2 x %struct.LIST], ptr %48, i64 0, i64 1, i32 1
  store ptr %call14.i, ptr %osucc330, align 8
  store ptr %46, ptr %arrayidx320, align 8
  %osucc336 = getelementptr inbounds [2 x %struct.LIST], ptr %46, i64 0, i64 1, i32 1
  store ptr %45, ptr %osucc336, align 8
  br label %cond.end339

cond.end339:                                      ; preds = %cond.end306, %cond.false315
  %49 = load i8, ptr %ou1161.le.le, align 8
...
for.cond397.preheader:                            ; preds = %cond.end339
  %link.3620 = load ptr, ptr %osucc, align 8
...
if.else441:                                       ; preds = %sw.epilog
  ...
  store ptr %59, ptr %arrayidx436, align 8
  br label %if.end450
...
cond.end496:                                      ; preds = %if.end450
  %61 = load ptr, ptr %link.4, align 8
  store ptr %61, ptr @zz_tmp, align 8
  %62 = load ptr, ptr %60, align 8
  store ptr %62, ptr %link.4, align 8
...
cond.end496.cond.false505_crit_edge:              ; preds = %cond.end496
  ...
  %.pre634 = load ptr, ptr %arrayidx510.phi.trans.insert, align 8
  br label %cond.false505
...
if.end58:                                         ; preds = %for.cond39, %if.then56
  ...
  %12 = load i8, ptr %ou159, align 8
  %13 = add i8 %12, -13
  %switch966 = icmp ult i8 %13, -2
  br i1 %switch966, label %if.then547.thread1022, label %cond.false
...
if.then547.thread1022:                            ; preds = %if.end58
...
sw.bb106:                                         ; preds = %cond.end99
  ...
  %14 = load ptr, ptr %ocross_sym, align 8
  %cmp107 = icmp eq ptr %14, null
  br i1 %cmp107, label %if.then109, label %if.end110

if.then109:                                       ; preds = %sw.bb106
  tail call void @CrossInit(ptr noundef nonnull %11)
  %.pre1020 = load ptr, ptr %ocross_sym, align 8
  br label %if.end110

if.end110:                                        ; preds = %if.then109, %sw.bb106
  %15 = phi ptr [ %.pre1020, %if.then109 ], [ %14, %sw.bb106 ]
  %16 = load ptr, ptr @MomentSym, align 8
...
if.end125:                                        ; preds = %if.then121, %if.else
  ...
  %18 = load ptr, ptr %osucc128, align 8
...
for.cond139:                                      ; preds = %for.cond132, %for.cond139
  ...
  %db.0 = load ptr, ptr %db.0.in, align 8
...
if.end164:                                        ; preds = %for.cond139, %for.cond139, %if.then162
  ...
  br i1 %tobool169.not, label %for.cond132, label %if.then170

if.then170:                                       ; preds = %if.end164
  call void @SwitchScope(ptr noundef null) #9
  store i32 0, ptr %count, align 4
  %21 = load ptr, ptr @OldCrossDb, align 8
...
if.end175:                                        ; preds = %if.then170, %if.then173
  %22 = load i16, ptr %dfnum, align 2
  %23 = load i64, ptr %dfpos, align 8
  %24 = load i32, ptr %dlnum, align 4
  %call176 = call ptr @ReadFromFile(i16 noundef zeroext %22, i64 noundef %23, i32 noundef %24) #9
  %25 = load i32, ptr %count, align 4
  %cmp178.not1009 = icmp slt i32 %25, 1
  br i1 %cmp178.not1009, label %for.end182, label %for.body180

for.body180:                                      ; preds = %if.end175, %for.body180
  %i.01010 = phi i32 [ %inc, %for.body180 ], [ 1, %if.end175 ]
  call void @PopScope() #9
  %inc = add nuw nsw i32 %i.01010, 1
  %26 = load i32, ptr %count, align 4
  %cmp178.not.not = icmp slt i32 %i.01010, %26
  br i1 %cmp178.not.not, label %for.body180, label %for.end182

for.end182:                                       ; preds = %for.body180, %if.end175
  call void @UnSwitchScope(ptr noundef null) #9
  %27 = load ptr, ptr @OldCrossDb, align 8
...
if.end221:                                        ; preds = %if.then219, %if.end213
  ...
  %34 = load i16, ptr %ofile_num, align 2
...
if.then255:                                       ; preds = %if.end231
  ...
  store ptr %call256, ptr @zz_hold, align 8
  br label %if.end266

if.else257:                                       ; preds = %if.end231
  store ptr %37, ptr @zz_hold, align 8
  %39 = load ptr, ptr %37, align 8
  store ptr %39, ptr %arrayidx252, align 8
  br label %if.end266
...
if.end266:                                        ; preds = %if.then255, %if.else257
  ...
  store i8 %trunc978, ptr %ou1268, align 8
...
if.else296:                                       ; preds = %if.end266
  ...
  store ptr %44, ptr %arrayidx291, align 8
  br label %cond.end351
...
if.then400:                                       ; preds = %if.then388
  ...
  store ptr %call401, ptr @zz_hold, align 8
  br label %if.end411

if.else402:                                       ; preds = %if.then388
  store ptr %60, ptr @zz_hold, align 8
  %62 = load ptr, ptr %60, align 8
  store ptr %62, ptr %arrayidx397, align 8
  br label %if.end411
...
if.then438:                                       ; preds = %if.end426
  ...
  store ptr %call439, ptr @zz_hold, align 8
  br label %if.end449

if.else440:                                       ; preds = %if.end426
  store ptr %65, ptr @zz_hold, align 8
  %67 = load ptr, ptr %65, align 8
  store ptr %67, ptr %arrayidx435, align 8
  br label %if.end449
...
cond.end495:                                      ; preds = %if.end449
  ...
  %72 = load ptr, ptr @zz_hold, align 8
  %73 = load ptr, ptr @zz_res, align 8
  %74 = load ptr, ptr %73, align 8
  %osucc486 = getelementptr inbounds %struct.LIST, ptr %74, i64 0, i32 1
  store ptr %72, ptr %osucc486, align 8
  ...
  store ptr %76, ptr %osucc492, align 8
  %.pr988 = load ptr, ptr @xx_link, align 8
  store ptr %.pr988, ptr @zz_res, align 8
  store ptr %40, ptr @zz_hold, align 8
...
land.lhs.true531:                                 ; preds = %cond.end528
  %83 = load ptr, ptr @OldCrossDb, align 8
...
if.then536:                                       ; preds = %land.lhs.true531
  call void @SwitchScope(ptr noundef null) #9
  %84 = load i16, ptr %dfnum, align 2
  %85 = load i64, ptr %dfpos, align 8
  %86 = load i32, ptr %dlnum, align 4
...
if.end581:                                        ; preds = %if.then570, %if.else572
  ...
  store i8 2, ptr %ou1582, align 8
  %osucc586 = getelementptr inbounds [2 x %struct.LIST], ptr %91, i64 0, i64 1, i32 1
  store ptr %91, ptr %osucc586, align 8
  %arrayidx588 = getelementptr inbounds [2 x %struct.LIST], ptr %91, i64 0, i64 1
  store ptr %91, ptr %arrayidx588, align 8
  %osucc592 = getelementptr inbounds %struct.LIST, ptr %91, i64 0, i32 1
  store ptr %91, ptr %osucc592, align 8
  store ptr %91, ptr %91, align 8
  %oactual596 = getelementptr inbounds %struct.closure_type, ptr %91, i64 0, i32 5
  store ptr %11, ptr %oactual596, align 8
  %oenclosing1012 = getelementptr inbounds %struct.symbol_type, ptr %11, i64 0, i32 3
  %92 = load ptr, ptr %oenclosing1012, align 8
  %93 = load ptr, ptr @StartSym, align 8
  %cmp598.not1013 = icmp eq ptr %92, %93
  br i1 %cmp598.not1013, label %while.end, label %while.body

while.body:                                       ; preds = %if.end581, %if.end622
  %oactual5971015 = phi ptr [ %oactual639, %if.end622 ], [ %oactual596, %if.end581 ]
  %y.11014 = phi ptr [ %98, %if.end622 ], [ %91, %if.end581 ]
  %94 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 2), align 1
  %conv600 = zext i8 %94 to i32
  store i32 %conv600, ptr @zz_size, align 4
  %conv601 = zext i8 %94 to i64
  %arrayidx608 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv601
  %95 = load ptr, ptr %arrayidx608, align 8
...
if.then611:                                       ; preds = %while.body
  ...
  store ptr %call612, ptr @zz_hold, align 8
  br label %if.end622

if.else613:                                       ; preds = %while.body
  store ptr %95, ptr @zz_hold, align 8
  %97 = load ptr, ptr %95, align 8
  store ptr %97, ptr %arrayidx608, align 8
  br label %if.end622
...
if.end663:                                        ; preds = %if.then652, %if.else654
  ...
  store i8 82, ptr %ou1664, align 8
...
if.else691:                                       ; preds = %if.end663
  ...
  store ptr %112, ptr %arrayidx686, align 8
  br label %cond.end746
...
cond.end746:                                      ; preds = %if.then689, %if.else691
  ...
  store ptr %116, ptr %osucc737, align 8
  ...
  store ptr %120, ptr %osucc743, align 8
...
cond.end844:                                      ; preds = %cond.end811.thread, %cond.false820
  ...
  %132 = load i8, ptr %ou1847, align 8
...
if.end854:                                        ; preds = %if.then852, %cond.end844
  ...
  %134 = load ptr, ptr %oactual855, align 8
...
entry:
  %0 = load ptr, ptr @crossref_tab, align 8
  %cmp = icmp eq ptr %0, null
...
crtab_new.exit:                                   ; preds = %if.then, %if.then.i
  ...
  store ptr %call.i, ptr @crossref_tab, align 8
  br label %if.end
...
if.end:                                           ; preds = %entry.if.end_crit_edge, %crtab_new.exit
  ...
  %x.02 = load ptr, ptr %arrayidx, align 8
...
for.body:                                         ; preds = %if.end, %for.inc
  ...
  %5 = load ptr, ptr %crtab_sym, align 8
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %6 = load i16, ptr %crtab_fnum, align 8
...
if.then10:                                        ; preds = %land.lhs.true
  ...
  %7 = load i32, ptr %crtab_value, align 4
  %inc = add nsw i32 %7, 1
  store i32 %inc, ptr %crtab_value, align 4
  br label %cleanup

for.inc:                                          ; preds = %for.body, %land.lhs.true
  %x.0 = load ptr, ptr %x.04, align 8
...
for.end:                                          ; preds = %for.inc, %if.end
  ...
  %8 = load i32, ptr %tab_count, align 4
...
for.body.preheader.i.i:                           ; preds = %if.end.i.i
  ...
  tail call void @llvm.memset.p0.i64(ptr align 8 %scevgep.i.i, i8 0, i64 %11, i1 false)
...
while.body.i:                                     ; preds = %for.body.i, %while.body.i
  ...
  %19 = load ptr, ptr %arrayidx5.i, align 8
  store ptr %19, ptr %p.025.i, align 8
  store ptr %p.025.i, ptr %arrayidx5.i, align 8
  %inc.i = add nsw i32 %14, 1
  %cmp1.not.i = icmp eq ptr %15, null
  br i1 %cmp1.not.i, label %while.cond.for.inc_crit_edge.i, label %while.body.i

while.cond.for.inc_crit_edge.i:                   ; preds = %while.body.i
  store i32 %inc.i, ptr %tab_count.i.i, align 4
  br label %for.inc.i
...
for.inc.i:                                        ; preds = %while.cond.for.inc_crit_edge.i, %for.body.i
  ...
  br i1 %exitcond.not.i, label %crtab_rehash.exit, label %for.body.i

crtab_rehash.exit:                                ; preds = %for.inc.i, %crtab_new.exit.i
  tail call void @free(ptr noundef nonnull %3) #9
  store ptr %call.i.i, ptr @crossref_tab, align 8
...
if.end23:                                         ; preds = %crtab_rehash.exit, %for.end
  ...
  store i32 24, ptr @zz_size, align 4
  %22 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @zz_free, i64 0, i64 24), align 8
...
if.then29:                                        ; preds = %if.end23
  ...
  %.pre6 = load ptr, ptr @crossref_tab, align 8
  br label %if.end38

if.else31:                                        ; preds = %if.end23
  store ptr %22, ptr @zz_hold, align 8
  %24 = load ptr, ptr %22, align 8
  store ptr %24, ptr getelementptr inbounds ([0 x ptr], ptr @zz_free, i64 0, i64 24), align 8
  br label %if.end38
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %dlnum) #9
  %0 = load i32, ptr @AllowCrossDb, align 4
...
if.end47:                                         ; preds = %if.then45, %if.end38
  %14 = load ptr, ptr %osucc16, align 8
  %osucc53 = getelementptr inbounds %struct.LIST, ptr %14, i64 0, i32 1
  %15 = load ptr, ptr %osucc53, align 8
  br label %for.cond57
...
for.cond57:                                       ; preds = %for.cond57, %if.end47
  ...
  %16 = load i8, ptr %ou158, align 8
  %cmp61 = icmp eq i8 %16, 0
  br i1 %cmp61, label %for.cond57, label %for.end68
...
for.end68:                                        ; preds = %for.cond57
  ...
  %17 = load ptr, ptr %osucc77, align 8
...
cond.false:                                       ; preds = %for.end68
  ...
  store ptr %17, ptr %osucc94, align 8
  store ptr %15, ptr %osucc77, align 8
  store ptr %15, ptr %arrayidx84, align 8
  br label %cond.end
...
cond.end:                                         ; preds = %for.end68, %cond.false
  ...
  %20 = load ptr, ptr %osucc103, align 8
...
cond.false107:                                    ; preds = %cond.end
  ...
  store ptr %23, ptr %osucc125, align 8
...
sw.bb:                                            ; preds = %if.end166, %if.end166, %if.end166
  %31 = load i8, ptr %ou158.le, align 8
...
if.end174:                                        ; preds = %if.then172, %sw.bb
  ...
  %33 = load ptr, ptr %oactual175, align 8
...
for.cond183.preheader:                            ; preds = %if.end174
  ...
  %link.02255 = load ptr, ptr %link.0.in2254, align 8
...
for.cond191:                                      ; preds = %for.cond191.preheader, %for.cond191
  ...
  %36 = load i8, ptr %ou1192, align 8
  %cmp195 = icmp eq i8 %36, 0
  br i1 %cmp195, label %for.cond191, label %for.end202
...
if.then209:                                       ; preds = %for.end202
  ...
  store ptr null, ptr %arrayidx211, align 8
  ...
  %38 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 2), align 1
  %conv214 = zext i8 %38 to i32
  store i32 %conv214, ptr @zz_size, align 4
  %conv215 = zext i8 %38 to i64
  %arrayidx221 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv215
  %39 = load ptr, ptr %arrayidx221, align 8
...
if.then224:                                       ; preds = %if.then209
  ...
  store ptr %call225, ptr @zz_hold, align 8
  br label %if.end235
...
if.then262:                                       ; preds = %if.end235
  ...
  store ptr %call263, ptr @zz_hold, align 8
  br label %if.end273

if.else264:                                       ; preds = %if.end235
  store ptr %44, ptr @zz_hold, align 8
  %46 = load ptr, ptr %44, align 8
  store ptr %46, ptr %arrayidx259, align 8
  br label %if.end273
...
if.end273:                                        ; preds = %if.then262, %if.else264
  ...
  %49 = load ptr, ptr %arrayidx296, align 8
...
if.else301:                                       ; preds = %if.end273
  ...
  store ptr %51, ptr %arrayidx296, align 8
  br label %cond.end356
...
cond.end356:                                      ; preds = %if.then299, %if.else301
  ...
  store ptr %55, ptr %osucc347, align 8
  ...
  store ptr %59, ptr %osucc353, align 8
...
if.then402:                                       ; preds = %cond.end389
  ...
  store ptr %call403, ptr @zz_hold, align 8
  br label %if.end413

if.else404:                                       ; preds = %cond.end389
  store ptr %66, ptr @zz_hold, align 8
  %68 = load ptr, ptr %66, align 8
  store ptr %68, ptr %arrayidx399, align 8
  br label %if.end413
...
if.end413:                                        ; preds = %if.then402, %if.else404
  ...
  store i8 82, ptr %ou1414, align 8
  ...
  store ptr %69, ptr %osucc418, align 8
  store ptr %69, ptr %arrayidx417, align 8
  %osucc424 = getelementptr inbounds %struct.LIST, ptr %69, i64 0, i32 1
  store ptr %69, ptr %osucc424, align 8
  ...
  %arrayidx436 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv429
  %71 = load ptr, ptr %arrayidx436, align 8
...
if.else441:                                       ; preds = %if.end413
  ...
  store ptr %73, ptr %arrayidx436, align 8
  br label %cond.end496
...
cond.end496:                                      ; preds = %if.then439, %if.else441
  ...
  store ptr %77, ptr %osucc487, align 8
...
if.then542:                                       ; preds = %cond.end529
  ...
  store ptr %call543, ptr @zz_hold, align 8
  br label %if.end553

if.else544:                                       ; preds = %cond.end529
  store ptr %88, ptr @zz_hold, align 8
  %90 = load ptr, ptr %88, align 8
  store ptr %90, ptr %arrayidx539, align 8
  br label %if.end553
...
if.else581:                                       ; preds = %if.end553
  ...
  store ptr %95, ptr %arrayidx576, align 8
  br label %cond.end636
...
cond.end636:                                      ; preds = %if.then579, %if.else581
  ...
  store ptr %99, ptr %osucc627, align 8
  ...
  store ptr %103, ptr %osucc633, align 8
...
cond.false645:                                    ; preds = %cond.end636
  %106 = load ptr, ptr %arrayidx417, align 8
  store ptr %106, ptr @zz_tmp, align 8
  %arrayidx650 = getelementptr inbounds [2 x %struct.LIST], ptr %105, i64 0, i64 1
  %107 = load ptr, ptr %arrayidx650, align 8
  store ptr %107, ptr %arrayidx417, align 8
  %108 = load ptr, ptr %arrayidx650, align 8
  %osucc660 = getelementptr inbounds [2 x %struct.LIST], ptr %108, i64 0, i64 1, i32 1
  store ptr %69, ptr %osucc660, align 8
  store ptr %106, ptr %arrayidx650, align 8
  %osucc666 = getelementptr inbounds [2 x %struct.LIST], ptr %106, i64 0, i64 1, i32 1
  store ptr %105, ptr %osucc666, align 8
...
cond.end669:                                      ; preds = %cond.end636, %cond.false645
  ...
  %109 = load ptr, ptr %osucc424, align 8
  store ptr %109, ptr @xx_link, align 8
  %osucc679 = getelementptr inbounds [2 x %struct.LIST], ptr %109, i64 0, i64 1, i32 1
  %110 = load ptr, ptr %osucc679, align 8
...
cond.false713:                                    ; preds = %cond.end705
  ...
  store ptr %115, ptr %osucc728, align 8
  %osucc731 = getelementptr inbounds %struct.LIST, ptr %116, i64 0, i32 1
  store ptr %116, ptr %osucc731, align 8
...
cond.end735:                                      ; preds = %cond.end705, %cond.false713
  ...
  %119 = load i8, ptr %ou1737, align 8
  ...
  %.pre2280 = load ptr, ptr %oactual175, align 8
  br label %for.inc769
...
for.inc769:                                       ; preds = %for.end202, %cond.end735
  ...
  br i1 %cmp185.not, label %if.end774, label %for.cond191.preheader
...
if.then779:                                       ; preds = %if.end774
  ...
  %124 = load i32, ptr %ogall_seq, align 4
  %inc = add nsw i32 %124, 1
  store i32 %inc, ptr %ogall_seq, align 4
...
if.else785:                                       ; preds = %if.end774
  ...
  %125 = load i8, ptr %ou1786, align 8
...
if.then816:                                       ; preds = %if.end813
  ...
  %126 = load ptr, ptr %ogall_tag, align 8
...
if.then822:                                       ; preds = %if.then816
  ...
  store ptr %call834, ptr %ogall_tag, align 8
  br label %if.end836
...
if.end836:                                        ; preds = %if.then822, %if.then816
  ...
  %128 = load i8, ptr %ou1838, align 8
...
land.lhs.true:                                    ; preds = %if.end836
  ...
  %strcmpload2185 = load i8, ptr %ostring851, align 1
  %cmp854 = icmp eq i8 %strcmpload2185, 0
...
if.else883:                                       ; preds = %if.else863
  ...
  store ptr %140, ptr %arrayidx878, align 8
  br label %if.end892
...
cond.end938.thread:                               ; preds = %if.end892
  store ptr %call865, ptr @zz_hold, align 8
...
cond.end938:                                      ; preds = %if.end892
  ...
  store ptr %144, ptr %osucc929, align 8
  ...
  store ptr %148, ptr %osucc935, align 8
  %.pre2281 = load ptr, ptr @xx_link, align 8
  store ptr %.pre2281, ptr @zz_res, align 8
  store ptr %call865, ptr @zz_hold, align 8
...
cond.false947:                                    ; preds = %cond.end938.thread, %cond.end938
  ...
  %151 = load ptr, ptr %arrayidx949, align 8
  store ptr %151, ptr @zz_tmp, align 8
  %arrayidx952 = getelementptr inbounds [2 x %struct.LIST], ptr %150, i64 0, i64 1
  %152 = load ptr, ptr %arrayidx952, align 8
  store ptr %152, ptr %arrayidx949, align 8
  %153 = load ptr, ptr %arrayidx952, align 8
  %osucc962 = getelementptr inbounds [2 x %struct.LIST], ptr %153, i64 0, i64 1, i32 1
  store ptr %call865, ptr %osucc962, align 8
  store ptr %151, ptr %arrayidx952, align 8
  %osucc968 = getelementptr inbounds [2 x %struct.LIST], ptr %151, i64 0, i64 1, i32 1
  store ptr %150, ptr %osucc968, align 8
  br label %if.end973
...
sw.bb980:                                         ; preds = %if.end166
  ...
  %154 = load ptr, ptr %ogall_tag981, align 8
...
if.end987:                                        ; preds = %if.then984, %sw.bb980
  %155 = load i8, ptr %ou158.le, align 8
...
lor.lhs.false999:                                 ; preds = %if.end987
  ...
  %strcmpload2180 = load i8, ptr %ostring1000, align 1
  %cmp1003 = icmp eq i8 %strcmpload2180, 0
...
if.end1011:                                       ; preds = %lor.lhs.false999, %if.then1005
  ...
  store ptr %storemerge, ptr %ogall_tag981, align 8
  %link.1.in2250 = getelementptr inbounds %struct.LIST, ptr %11, i64 0, i32 1
  %link.12251 = load ptr, ptr %link.1.in2250, align 8
...
for.cond1022:                                     ; preds = %for.cond1022.preheader, %for.cond1022
  ...
  %157 = load i8, ptr %ou11023, align 8
...
if.then1051:                                      ; preds = %for.cond1022, %land.lhs.true1045
  %158 = load ptr, ptr @no_fpos, align 8
...
if.end1053:                                       ; preds = %if.then1051, %land.lhs.true1045
  ...
  %159 = load i8, ptr %ou31054, align 8
...
if.end1083:                                       ; preds = %if.end1053, %if.end1053, %if.end1053
  %160 = load ptr, ptr @NewCrossDb, align 8
  %161 = load ptr, ptr %ogall_tag981, align 8
...
cond.end1160:                                     ; preds = %cond.end1130, %cond.false1138
  ...
  %177 = load i8, ptr %ou11162, align 8
...
for.inc1202:                                      ; preds = %sw.default, %if.then1197, %cond.end1160, %if.end1053, %if.end1053, %if.end1053, %if.end1053
  ...
  br i1 %cmp1016.not, label %cleanup, label %for.cond1022.preheader

sw.bb1207:                                        ; preds = %if.end166
  %otarget_state = getelementptr inbounds %struct.cr_type, ptr %11, i64 0, i32 2
  %184 = load i8, ptr %otarget_state, align 1
...
if.then1221:                                      ; preds = %sw.bb1207
  ...
  %185 = load ptr, ptr %otarget_val, align 8
  %otarget_file = getelementptr inbounds %struct.cr_type, ptr %11, i64 0, i32 3
  %186 = load i16, ptr %otarget_file, align 2
  ...
  %187 = load ptr, ptr %otarget_val, align 8
  %call1223 = tail call i32 @DisposeObject(ptr noundef %187) #9
  store ptr null, ptr %otarget_val, align 8
  store i8 2, ptr %otarget_state, align 1
  br label %if.end1226

if.end1226:                                       ; preds = %sw.bb1207, %if.then1221
  %188 = load i8, ptr %ou158.le, align 8
...
if.then1244:                                      ; preds = %if.end1226, %lor.lhs.false1238
  ...
  %189 = load ptr, ptr @no_fpos, align 8
...
if.end1247:                                       ; preds = %if.then1244, %lor.lhs.false1238
  ...
  %190 = load ptr, ptr @NewCrossDb, align 8
...
sw.bb1256:                                        ; preds = %if.end166, %if.end166
  %194 = load i8, ptr %ou158.le, align 8
...
if.then1268:                                      ; preds = %sw.bb1256
  ...
  %195 = load ptr, ptr %osymb, align 8
...
if.else1279:                                      ; preds = %if.else1272
  %196 = load i8, ptr @zz_lengths, align 1
  ...
  %197 = load ptr, ptr %arrayidx1288, align 8
...
if.else1293:                                      ; preds = %if.else1279
  store ptr %197, ptr @zz_hold, align 8
  %199 = load ptr, ptr %197, align 8
  store ptr %199, ptr %arrayidx1288, align 8
  br label %if.end1302
...
if.end1302:                                       ; preds = %if.then1291, %if.else1293
  ...
  store i8 0, ptr %ou11303, align 8
  %osucc1307 = getelementptr inbounds [2 x %struct.LIST], ptr %200, i64 0, i64 1, i32 1
  store ptr %200, ptr %osucc1307, align 8
  %arrayidx1309 = getelementptr inbounds [2 x %struct.LIST], ptr %200, i64 0, i64 1
  store ptr %200, ptr %arrayidx1309, align 8
  %osucc1313 = getelementptr inbounds %struct.LIST, ptr %200, i64 0, i32 1
  store ptr %200, ptr %osucc1313, align 8
  store ptr %200, ptr %200, align 8
  store ptr %200, ptr @xx_link, align 8
  store ptr %200, ptr @zz_res, align 8
  store ptr %11, ptr @zz_hold, align 8
...
cond.end1348:                                     ; preds = %if.end1302
  ...
  store ptr %201, ptr @zz_tmp, align 8
  %202 = load ptr, ptr %200, align 8
  store ptr %202, ptr %11, align 8
  %203 = load ptr, ptr @zz_hold, align 8
  %204 = load ptr, ptr @zz_res, align 8
  %205 = load ptr, ptr %204, align 8
  %osucc1339 = getelementptr inbounds %struct.LIST, ptr %205, i64 0, i32 1
  store ptr %203, ptr %osucc1339, align 8
  %206 = load ptr, ptr @zz_tmp, align 8
  store ptr %206, ptr %204, align 8
  %207 = load ptr, ptr @zz_res, align 8
  %208 = load ptr, ptr @zz_tmp, align 8
  ...
  store ptr %.pre2277, ptr @zz_res, align 8
  store ptr %tag.0, ptr @zz_hold, align 8
...
cond.false1357:                                   ; preds = %cond.end1348.thread, %cond.end1348
  ...
  %210 = load ptr, ptr %arrayidx1359, align 8
  store ptr %210, ptr @zz_tmp, align 8
  %arrayidx1362 = getelementptr inbounds [2 x %struct.LIST], ptr %209, i64 0, i64 1
  %211 = load ptr, ptr %arrayidx1362, align 8
  store ptr %211, ptr %arrayidx1359, align 8
  %212 = load ptr, ptr %arrayidx1362, align 8
  %osucc1372 = getelementptr inbounds [2 x %struct.LIST], ptr %212, i64 0, i64 1, i32 1
  store ptr %tag.0, ptr %osucc1372, align 8
  store ptr %210, ptr %arrayidx1362, align 8
  %osucc1378 = getelementptr inbounds [2 x %struct.LIST], ptr %210, i64 0, i64 1, i32 1
  store ptr %209, ptr %osucc1378, align 8
...
cond.end1381:                                     ; preds = %cond.end1348, %cond.false1357
  ...
  %213 = load i16, ptr %ofile_num, align 2
  ...
  store i16 %213, ptr %ocs_fnum1385, align 2
  store i8 %5, ptr %ou31384, align 8
  br label %cleanup

sw.bb1391:                                        ; preds = %if.end166
  %otarget_state1392 = getelementptr inbounds %struct.cr_type, ptr %11, i64 0, i32 2
  %214 = load i8, ptr %otarget_state1392, align 1
...
if.then1396:                                      ; preds = %sw.bb1391
  ...
  %215 = load ptr, ptr %otarget_val1397, align 8
...
if.end1399:                                       ; preds = %if.then1396, %sw.bb1391
  ...
  store ptr %tag.0, ptr %otarget_val1400, align 8
  %osucc1403 = getelementptr inbounds [2 x %struct.LIST], ptr %tag.0, i64 0, i64 1, i32 1
  %216 = load ptr, ptr %osucc1403, align 8
...
if.end1408:                                       ; preds = %if.then1406, %if.end1399
  ...
  store i16 %call1410, ptr %otarget_file1411, align 2
  store i8 1, ptr %otarget_state1392, align 1
  %218 = load ptr, ptr %otarget_val1400, align 8
  %ou11414 = getelementptr inbounds %struct.word_type, ptr %218, i64 0, i32 1
  %219 = load i8, ptr %ou11414, align 8
...
if.then1419:                                      ; preds = %if.end1408
  ...
  %.pre2274 = load ptr, ptr %otarget_val1400, align 8
  br label %if.end1421
...
if.end1421:                                       ; preds = %if.then1419, %if.end1408
  ...
  %link.32241 = load ptr, ptr %link.3.in2240, align 8
...
for.cond1434:                                     ; preds = %for.cond1434.preheader, %for.cond1434
  ...
  %222 = load i8, ptr %ou11435, align 8
...
if.then1451:                                      ; preds = %for.cond1434
  ...
  %223 = load ptr, ptr %osucc1454, align 8
...
if.end1459:                                       ; preds = %if.then1457, %if.then1451
  ...
  %225 = load ptr, ptr %oactual1460, align 8
...
for.end1484:                                      ; preds = %for.cond1473
  ...
  %228 = load i8, ptr %ou11486, align 8
...
if.then1497:                                      ; preds = %for.end1484
  %229 = load ptr, ptr %otarget_val1400, align 8
  %oactual1500 = getelementptr inbounds %struct.closure_type, ptr %229, i64 0, i32 5
  %230 = load ptr, ptr %oactual1500, align 8
...
if.else1510:                                      ; preds = %if.else1503
  ...
  %231 = load i16, ptr %ofile_num1512, align 2
  ...
  store i16 %231, ptr %ocs_fnum1514, align 2
  store i8 126, ptr %ou31513, align 8
  %232 = load i8, ptr @zz_lengths, align 1
  %conv1517 = zext i8 %232 to i32
  store i32 %conv1517, ptr @zz_size, align 4
  %conv1518 = zext i8 %232 to i64
  %arrayidx1525 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv1518
  %233 = load ptr, ptr %arrayidx1525, align 8
...
if.else1530:                                      ; preds = %if.else1510
  ...
  store ptr %235, ptr %arrayidx1525, align 8
  br label %if.end1539
...
for.cond1636:                                     ; preds = %for.cond1636, %if.then1629
  ...
  %250 = load i8, ptr %ou11637, align 8
...
sw.default1652:                                   ; preds = %for.cond1636
  ...
  %251 = load ptr, ptr %osucc1657, align 8
...
cond.end1683.thread:                              ; preds = %sw.default1652
  store ptr null, ptr @xx_tmp, align 8
  store ptr %call1654, ptr @zz_res, align 8
  store ptr null, ptr @zz_hold, align 8
...
cond.end1683:                                     ; preds = %sw.default1652
  ...
  %252 = load ptr, ptr %arrayidx1666, align 8
  %arrayidx1669 = getelementptr inbounds [2 x %struct.LIST], ptr %251, i64 0, i64 1
  store ptr %252, ptr %arrayidx1669, align 8
  %253 = load ptr, ptr %arrayidx1666, align 8
  %osucc1676 = getelementptr inbounds [2 x %struct.LIST], ptr %253, i64 0, i64 1, i32 1
  store ptr %251, ptr %osucc1676, align 8
  store ptr %y.2, ptr %osucc1657, align 8
  store ptr %y.2, ptr %arrayidx1666, align 8
  store ptr %251, ptr @xx_tmp, align 8
  store ptr %call1654, ptr @zz_res, align 8
...
cond.false1692:                                   ; preds = %cond.end1683
  %254 = load ptr, ptr %arrayidx1669, align 8
  store ptr %254, ptr @zz_tmp, align 8
  %arrayidx1697 = getelementptr inbounds [2 x %struct.LIST], ptr %call1654, i64 0, i64 1
  %255 = load ptr, ptr %arrayidx1697, align 8
  store ptr %255, ptr %arrayidx1669, align 8
  %256 = load ptr, ptr %arrayidx1697, align 8
  %osucc1707 = getelementptr inbounds [2 x %struct.LIST], ptr %256, i64 0, i64 1, i32 1
  store ptr %251, ptr %osucc1707, align 8
  store ptr %254, ptr %arrayidx1697, align 8
  %osucc1713 = getelementptr inbounds [2 x %struct.LIST], ptr %254, i64 0, i64 1, i32 1
  store ptr %call1654, ptr %osucc1713, align 8
  br label %cond.end1716
...
for.inc1723:                                      ; preds = %for.cond1434, %for.cond1636, %for.cond1636, %for.cond1636, %for.cond1636, %for.cond1636, %for.cond1636, %for.cond1636, %for.cond1636, %for.cond1636, %if.end1539, %if.else1622, %cond.end1716, %if.then1497, %cond.false1594, %if.else1503
  ...
  %257 = load ptr, ptr %otarget_val1400, align 8
  %cmp1428.not = icmp eq ptr %link.3, %257
  br i1 %cmp1428.not, label %for.end1727, label %for.cond1434.preheader
...
if.then1733:                                      ; preds = %for.end1727
  ...
  %260 = load ptr, ptr %otarget_val1400, align 8
  %call1739 = tail call i32 @DisposeObject(ptr noundef %260) #9
  store ptr null, ptr %otarget_val1400, align 8
  %link.42247 = load ptr, ptr %osucc1730, align 8
...
if.then1780:                                      ; preds = %if.then1780.loopexit, %land.lhs.true1774
  ...
  %262 = load ptr, ptr @no_fpos, align 8
...
if.end1782:                                       ; preds = %if.then1780, %land.lhs.true1774
  ...
  %263 = load i8, ptr %ou31783, align 8
...
sw.bb1786:                                        ; preds = %if.end1782, %if.end1782, %if.end1782
  %264 = load ptr, ptr @NewCrossDb, align 8
  %ostring1787 = getelementptr inbounds %struct.word_type, ptr %tag.3, i64 0, i32 4
  %265 = load i16, ptr %otarget_file1411, align 2
  %266 = load i32, ptr %otarget_pos1736, align 4
  %conv1792 = sext i32 %266 to i64
  %267 = load i32, ptr %otarget_lnum1737, align 8
...
cond.end1858:                                     ; preds = %cond.end1828, %cond.false1836
  ...
  %279 = load i8, ptr %ou11860, align 8
...
for.inc1902:                                      ; preds = %sw.default1899, %if.then1895, %cond.end1858, %if.end1782, %if.end1782, %if.end1782
  ...
  %link.4 = load ptr, ptr %osucc1905, align 8
  %cmp1745.not = icmp eq ptr %link.4, %11
  br i1 %cmp1745.not, label %for.end1906, label %for.cond1751.preheader

for.end1906:                                      ; preds = %for.inc1902, %if.then1733
  store i8 2, ptr %otarget_state1392, align 1
  br label %cleanup
...
if.end:                                           ; preds = %entry
  %1 = load ptr, ptr @RootCross, align 8
...
for.cond.preheader:                               ; preds = %if.end
  ...
  %link.0282 = load ptr, ptr %link.0.in281, align 8
...
for.cond.loopexit:                                ; preds = %for.inc166, %if.end18
  ...
  %link.0 = load ptr, ptr %link.0.in, align 8
  %2 = load ptr, ptr @RootCross, align 8
  %cmp2.not = icmp eq ptr %link.0, %2
  br i1 %cmp2.not, label %if.end176, label %for.cond5.preheader
...
if.end18:                                         ; preds = %if.then17, %for.end
  ...
  %ylink.0277 = load ptr, ptr %ylink.0.in276, align 8
...
sw.bb72:                                          ; preds = %if.end56
  %10 = load i8, ptr %otarget_state, align 1
...
if.then86:                                        ; preds = %sw.bb72
  %11 = load ptr, ptr %otarget_val, align 8
  %12 = load i16, ptr %otarget_file, align 2
  ...
  %13 = load ptr, ptr %otarget_val, align 8
...
if.end91:                                         ; preds = %sw.bb72, %if.then86
  %14 = load i8, ptr %ou130291, align 8
  %.off = add i8 %14, -11
  %switch = icmp ult i8 %.off, 2
...
lor.lhs.false103:                                 ; preds = %if.end91
  ...
  %strcmpload266 = load i8, ptr %ostring104, align 1
  %cmp107 = icmp eq i8 %strcmpload266, 0
...
if.end111:                                        ; preds = %if.then109, %lor.lhs.false103
  ...
  %16 = load ptr, ptr @NewCrossDb, align 8
  ...
  %17 = load i16, ptr %otarget_file, align 2
  %18 = load i32, ptr %otarget_pos, align 4
  %conv117 = sext i32 %18 to i64
  %19 = load i32, ptr %otarget_lnum, align 8
...
if.end134:                                        ; preds = %if.else127, %if.then130, %if.then122
  %21 = load ptr, ptr @NewCrossDb, align 8
...
sw.bb142:                                         ; preds = %if.end56
  %26 = load ptr, ptr %ogall_tag, align 8
...
for.inc166:                                       ; preds = %if.end71, %if.then76, %if.end111, %if.end134, %if.end152, %sw.default
  ...
  br i1 %cmp23.not, label %for.cond.loopexit, label %for.cond29.preheader

if.end176:                                        ; preds = %for.cond.loopexit, %for.cond.preheader, %if.end
  store i64 0, ptr %cont, align 8
  %35 = load ptr, ptr @OldCrossDb, align 8
...
if.then197:                                       ; preds = %if.end183
  %38 = load ptr, ptr @NewCrossDb, align 8
  %39 = load ptr, ptr %sym, align 8
  %40 = load ptr, ptr @no_fpos, align 8
  %41 = load i16, ptr %dfnum, align 2
  %42 = load i64, ptr %dfpos, align 8
  %43 = load i32, ptr %dlnum, align 4
...
while.cond.backedge:                              ; preds = %if.end183, %if.then197, %while.body
  %44 = load ptr, ptr @OldCrossDb, align 8
  ...
  br i1 %tobool180.not, label %while.end, label %while.body

while.end:                                        ; preds = %while.cond.backedge, %if.end176
  %45 = load ptr, ptr @OldCrossDb, align 8
  call void @DbClose(ptr noundef %45) #9
  %46 = load ptr, ptr @NewCrossDb, align 8
