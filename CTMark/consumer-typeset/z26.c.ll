; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z26.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z26.c"
...
entry:
  %0 = load i32, ptr @EchoLength.i, align 4
  %add = add nuw nsw i32 %0, 1
  %rem = and i32 %add, 7
  store i32 %rem, ptr @EchoLength.i, align 4
...
if.else:                                          ; preds = %entry
  ...
  %2 = load ptr, ptr %PrintLength, align 8
  ...
  %.pre = load i32, ptr @EchoLength.i, align 4
