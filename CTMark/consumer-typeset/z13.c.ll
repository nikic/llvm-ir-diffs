...
for.cond12.preheader.outer:                       ; preds = %if.end, %for.inc108.thread
  ...
  %b.promoted = load i32, ptr %b, align 4, !tbaa !21
  %f.promoted = load i32, ptr %f, align 4, !tbaa !21
...
for.cond12:                                       ; preds = %for.cond12.preheader, %for.cond12
  ...
  %y.0 = load ptr, ptr %y.0.in, align 8, !tbaa !12
  %ou1 = getelementptr inbounds %struct.word_type, ptr %y.0, i64 0, i32 1
  %10 = load i8, ptr %ou1, align 8, !tbaa !12
...
if.then39:                                        ; preds = %if.then36
  %12 = load ptr, ptr @no_fpos, align 8, !tbaa !13
...
if.then42:                                        ; preds = %if.end41
  store i32 %.221306, ptr %b, align 4, !tbaa !21
  store i32 %cond95308, ptr %f, align 4, !tbaa !21
...
for.inc108.thread:                                ; preds = %if.then54, %land.lhs.true46
  ...
  %link.0257 = load ptr, ptr %osucc111256, align 8, !tbaa !12
  %cmp9.not258 = icmp eq ptr %link.0257, %x
  br i1 %cmp9.not258, label %if.then115.thread279, label %for.cond12.preheader.outer, !llvm.loop !41
...
for.end112:                                       ; preds = %for.inc108
  store i32 %.221305, ptr %b, align 4, !tbaa !21
  store i32 %cond95307, ptr %f, align 4, !tbaa !21
...
if.else157:                                       ; preds = %if.then115, %if.end117
  ...
  %29 = load ptr, ptr %x, align 8, !tbaa !12
  ...
  %30 = load i32, ptr %b, align 4, !tbaa !21
  %ou3161 = getelementptr inbounds %struct.word_type, ptr %x, i64 0, i32 3
  store i32 %30, ptr %ou3161, align 8, !tbaa !12
  %31 = load i32, ptr %f, align 4, !tbaa !21
  br label %if.end167
