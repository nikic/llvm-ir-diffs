; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z13.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z13.c"
...
if.then:                                          ; preds = %land.lhs.true2, %land.lhs.true, %entry
  ...
  store i32 0, ptr %ofwd, align 8
  store i32 0, ptr %ou3, align 8
...
cond.end.thread:                                  ; preds = %if.then
  ...
  store ptr %call11, ptr @zz_res, align 8
...
cond.false41:                                     ; preds = %if.then
  ...
  store ptr %9, ptr %arrayidx22, align 8
  %10 = load ptr, ptr %arrayidx46, align 8
  %osucc56 = getelementptr inbounds [2 x %struct.LIST], ptr %10, i64 0, i64 1, i32 1
  store ptr %5, ptr %osucc56, align 8
  store ptr %8, ptr %arrayidx46, align 8
  %osucc62 = getelementptr inbounds [2 x %struct.LIST], ptr %8, i64 0, i64 1, i32 1
  store ptr %call11, ptr %osucc62, align 8
  br label %cond.end65
...
land.lhs.true73:                                  ; preds = %if.end
  ...
  %12 = load i32, ptr %ofwd78, align 8
...
sw.bb:                                            ; preds = %if.end89
  ...
  %15 = load i32, ptr %scale_avail, align 8
...
sw.bb189:                                         ; preds = %if.end89
  ...
  %25 = load i32, ptr %ou4190, align 8
  ...
  %26 = load ptr, ptr %osucc194, align 8
...
for.cond198:                                      ; preds = %for.cond198, %sw.bb189
  ...
  %27 = load i8, ptr %ou1199, align 8
  %cmp202 = icmp eq i8 %27, 0
  br i1 %cmp202, label %for.cond198, label %for.end209
...
for.end209:                                       ; preds = %for.cond198
  ...
  %28 = load i32, ptr %ou3211, align 8
  %29 = load i32, ptr %ou4190, align 8
  %mul = mul nsw i32 %29, %28
  %div216 = sdiv i32 %mul, 128
  store i32 %div216, ptr %ou368, align 8
  %ofwd221 = getelementptr inbounds %struct.word_type, ptr %call210, i64 0, i32 3, i32 1
  %30 = load i32, ptr %ofwd221, align 8
  ...
  store i32 %div226, ptr %ofwd228, align 8
  br label %sw.epilog
...
for.cond237:                                      ; preds = %for.cond237, %sw.bb230
  ...
  %32 = load i8, ptr %ou1238, align 8
  %cmp241 = icmp eq i8 %32, 0
  br i1 %cmp241, label %for.cond237, label %for.end248
...
if.then275:                                       ; preds = %if.then264
  ...
  store ptr %call276, ptr @zz_hold, align 8
  br label %if.end286

if.else277:                                       ; preds = %if.then264
  store ptr %36, ptr @zz_hold, align 8
  %38 = load ptr, ptr %36, align 8
  store ptr %38, ptr %arrayidx272, align 8
  br label %if.end286
...
if.end286:                                        ; preds = %if.then275, %if.else277
  ...
  store i16 %conv373, ptr %owidth, align 2
  ...
  store i16 0, ptr %owidth402, align 2
  ...
  %46 = load ptr, ptr %osucc463, align 8
...
if.else537:                                       ; preds = %cond.end522
  ...
  store ptr %55, ptr %arrayidx532, align 8
  br label %cond.end592
...
cond.end592:                                      ; preds = %if.then535, %if.else537
  ...
  store ptr %59, ptr %osucc583, align 8
  ...
  store ptr %63, ptr %osucc589, align 8
...
if.else628:                                       ; preds = %sw.bb262
  ...
  %70 = load i32, ptr %scale_avail629, align 8
...
for.end652:                                       ; preds = %for.cond641
  ...
  %73 = load i32, ptr %ou4654, align 8
...
sw.bb739:                                         ; preds = %if.end89
  ...
  %80 = load ptr, ptr %osucc743, align 8
...
for.cond747:                                      ; preds = %for.cond747, %sw.bb739
  ...
  %81 = load i8, ptr %ou1748, align 8
  %cmp751 = icmp eq i8 %81, 0
  br i1 %cmp751, label %for.cond747, label %for.end758
...
sw.bb780:                                         ; preds = %if.end89, %if.end89
  ...
  %85 = load i32, ptr %scale_avail781, align 8
...
for.end804:                                       ; preds = %for.cond793
  ...
  %88 = load i32, ptr %ou4812, align 8
...
sw.bb900:                                         ; preds = %if.end89, %if.end89, %if.end89, %if.end89, %if.end89, %if.end89, %if.end89, %if.end89, %if.end89, %if.end89, %if.end89, %if.end89, %if.end89
  ...
  %96 = load ptr, ptr %osucc903, align 8
...
if.then909:                                       ; preds = %sw.bb900
  ...
  %.pre1787 = load ptr, ptr %osucc903, align 8
...
for.cond918:                                      ; preds = %for.cond918.preheader, %for.cond918
  ...
  %99 = load i8, ptr %ou1919, align 8
  %cmp922 = icmp eq i8 %99, 0
  br i1 %cmp922, label %for.cond918, label %for.end929
...
for.cond950:                                      ; preds = %for.cond950, %sw.bb943
  ...
  %103 = load i8, ptr %ou1951, align 8
  %cmp954 = icmp eq i8 %103, 0
  br i1 %cmp954, label %for.cond950, label %for.end961
...
for.cond969:                                      ; preds = %for.cond969, %for.end961
  ...
  %105 = load i8, ptr %ou1970, align 8
  %cmp973 = icmp eq i8 %105, 0
  br i1 %cmp973, label %for.cond969, label %for.end980
...
for.cond1001:                                     ; preds = %for.cond1001, %sw.bb994
  ...
  %109 = load i8, ptr %ou11002, align 8
...
for.cond1057:                                     ; preds = %for.cond1057, %sw.bb1050
  ...
  %115 = load i8, ptr %ou11058, align 8
  %cmp1061 = icmp eq i8 %115, 0
  br i1 %cmp1061, label %for.cond1057, label %for.end1068
...
for.end1068:                                      ; preds = %for.cond1057
  ...
  store i32 %add1093, ptr %ofc1094, align 4
  ...
  %119 = load i32, ptr %ou31097, align 8
  ...
  store i32 %spec.select1774, ptr %ou368, align 8
  %ofwd1135 = getelementptr inbounds %struct.word_type, ptr %y.7, i64 0, i32 3, i32 1
  %120 = load i32, ptr %ofwd1135, align 8
  ...
  store i32 %cond1167, ptr %ofwd1169, align 8
  br label %sw.epilog
...
for.cond1179:                                     ; preds = %for.cond1179, %sw.bb1172
  ...
  %122 = load i8, ptr %ou11180, align 8
  %cmp1183 = icmp eq i8 %122, 0
  br i1 %cmp1183, label %for.cond1179, label %for.end1190
...
for.cond1211:                                     ; preds = %for.cond1211, %sw.bb1204
  ...
  %126 = load i8, ptr %ou11212, align 8
  %cmp1215 = icmp eq i8 %126, 0
  br i1 %cmp1215, label %for.cond1211, label %for.end1222
...
for.cond1243:                                     ; preds = %for.cond1243, %sw.bb1236
  ...
  %130 = load i8, ptr %ou11244, align 8
  %cmp1247 = icmp eq i8 %130, 0
  br i1 %cmp1247, label %for.cond1243, label %for.end1254
...
for.cond1304:                                     ; preds = %for.cond1304.preheader, %for.cond1304
  ...
  %134 = load i8, ptr %ou11305, align 8
...
for.inc1332:                                      ; preds = %for.cond1304, %land.lhs.true1321, %if.then1326
  ...
  br i1 %cmp1298.not, label %for.end1336.loopexit, label %for.cond1304.preheader

for.end1336.loopexit:                             ; preds = %for.inc1332
  %.pre = load i32, ptr %ou368, align 8
...
land.lhs.true1343:                                ; preds = %for.end1336
  %138 = load i32, ptr %ofwd1279, align 8
  %add1350 = add nsw i32 %138, %136
  %139 = load i32, ptr %obfc, align 4
...
sw.bb1372:                                        ; preds = %if.end89
  ...
  %141 = load ptr, ptr %osucc1375, align 8
...
sw.default:                                       ; preds = %if.end89
  ...
  %143 = load ptr, ptr @no_fpos, align 8
...
if.end1399:                                       ; preds = %if.then1397, %sw.epilog
  ...
  %146 = load i32, ptr %ofwd1401, align 8
...
if.then:                                          ; preds = %for.cond
  ...
  %.pre = load i8, ptr %ou1.le, align 8
  br label %if.end
...
if.then22:                                        ; preds = %if.end
  ...
  %.pre964 = load i8, ptr %ou1983, align 8
  br label %if.end24
...
if.end73:                                         ; preds = %for.cond54, %if.then71
  ...
  %10 = load ptr, ptr %osucc76, align 8
...
if.then79:                                        ; preds = %if.end73
  ...
  %.pre965 = load ptr, ptr %osucc76, align 8
...
if.then105:                                       ; preds = %for.cond88
  ...
  %.pre966 = load i8, ptr %ou189.le, align 8
  br label %if.end107
...
if.then119:                                       ; preds = %if.end107
  ...
  %.pre967 = load i8, ptr %ou189977, align 8
  br label %if.end121
...
if.end121:                                        ; preds = %if.then119, %if.end107
  ...
  store i32 %land.ext134, ptr %arrayidx137, align 4
...
if.then177:                                       ; preds = %land.lhs.true174, %land.lhs.true170, %for.end167
  ...
  %link.1931 = load ptr, ptr %osucc, align 8
...
for.inc250:                                       ; preds = %for.cond190, %if.then207
  ...
  %link.1 = load ptr, ptr %osucc253, align 8
  %cmp184.not = icmp eq ptr %link.1, %x
  br i1 %cmp184.not, label %if.end255, label %for.cond190.preheader
...
if.end308:                                        ; preds = %for.cond289, %if.then306
  ...
  %31 = load i32, ptr %arrayidx311, align 4
...
if.end333:                                        ; preds = %land.lhs.true313, %if.then325, %if.end308
  ...
  %34 = load ptr, ptr %osucc336, align 8
...
cond.true383:                                     ; preds = %cond.false
  ...
  %41 = load i32, ptr %ofwd385, align 8
  br label %cond.end
...
cond.false395:                                    ; preds = %cond.end390
  %43 = load ptr, ptr %succ_def, align 8
  %arrayidx398 = getelementptr inbounds i8, ptr %43, i64 52
  %44 = load i32, ptr %arrayidx398, align 4
...
cond.true400:                                     ; preds = %cond.false395
  ...
  %45 = load i32, ptr %ou3396, align 8
...
cond.end409:                                      ; preds = %cond.end390, %cond.end405
  ...
  %46 = load i32, ptr %obfc265, align 4
  %sub412 = sub i32 %46, %add264
  %div = sdiv i32 %sub412, %add256944
  %47 = load i32, ptr %mside, align 4
...
if.else612:                                       ; preds = %sw.epilog
  %60 = load i32, ptr %ou3584, align 8
  br label %if.end616
...
if.then619:                                       ; preds = %if.end616
  %62 = load ptr, ptr %succ_def, align 8
  %arrayidx622 = getelementptr inbounds i8, ptr %62, i64 52
  %63 = load i32, ptr %arrayidx622, align 4
...
cond.end640:                                      ; preds = %if.then619, %cond.true635
  ...
  %66 = load i32, ptr %ofwd643, align 8
...
sw.bb662:                                         ; preds = %if.end654
  %add663 = add i32 %beffect.0, %fwidth.4940
  %add664 = add i32 %add663, %feffect.0
...
sw.epilog668:                                     ; preds = %sw.default666, %sw.bb662, %sw.bb658, %sw.bb655
  ...
  br i1 %cmp257, label %land.rhs259, label %while.end
...
while.end:                                        ; preds = %land.rhs268, %land.rhs259, %land.lhs.true263, %sw.epilog668, %if.end255
  ...
  store i32 %bwidth.4.lcssa, ptr %ou3669, align 8
  %ofwd673 = getelementptr inbounds %struct.word_type, ptr %x, i64 0, i32 3, i32 1
  store i32 %fwidth.4.lcssa, ptr %ofwd673, align 8
...
for.inc37:                                        ; preds = %for.end, %if.end
  ...
  %4 = load ptr, ptr %osucc40, align 8
  %cmp.not = icmp eq ptr %4, %0
  br i1 %cmp.not, label %for.end41, label %for.cond3.preheader
...
for.end41:                                        ; preds = %for.inc37, %entry
  ...
  %obfc = getelementptr inbounds %struct.CONSTRAINT, ptr %c, i64 0, i32 1
  %6 = load i32, ptr %obfc, align 4
  %cond55 = tail call i32 @llvm.smin.i32(i32 %5, i32 %6)
  store i32 %cond55, ptr %yc, align 4
  %obfc58 = getelementptr inbounds %struct.CONSTRAINT, ptr %yc, i64 0, i32 1
  store i32 %6, ptr %obfc58, align 4
  %ofc = getelementptr inbounds %struct.CONSTRAINT, ptr %c, i64 0, i32 2
  %7 = load i32, ptr %ofc, align 4
  ...
  store i32 %cond69, ptr %ofc70, align 4
...
for.cond120:                                      ; preds = %for.cond120.preheader, %for.cond120
  ...
  %15 = load i8, ptr %ou1121, align 8
  %cmp124 = icmp eq i8 %15, 0
  br i1 %cmp124, label %for.cond120, label %for.end131
...
if.end146:                                        ; preds = %for.end131
  ...
  %17 = load i32, ptr %ou3148, align 8
  ...
  %18 = load i32, ptr %ofwd161, align 8
...
for.inc200:                                       ; preds = %for.end131, %if.end146
  ...
  %23 = load ptr, ptr %osucc203, align 8
  %cmp114.not = icmp eq ptr %23, %22
  br i1 %cmp114.not, label %for.end204, label %for.cond120.preheader
...
if.end232:                                        ; preds = %if.then216, %land.lhs.true212
  store i32 %b.2.lcssa, ptr %res_back, align 4
  store i32 %f.2.lcssa, ptr %res_fwd, align 4
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %yc) #4
  ret void
}
...
if.then:                                          ; preds = %entry
  ...
  %link.0223.pre = load ptr, ptr %osucc, align 8
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %link.0223 = phi ptr [ %link.0223.pre, %if.then ], [ %0, %entry ]
  store i32 8388607, ptr %tc, align 4
  %obfc = getelementptr inbounds %struct.CONSTRAINT, ptr %c, i64 0, i32 1
  %2 = load i32, ptr %obfc, align 4
  %ofc = getelementptr inbounds %struct.CONSTRAINT, ptr %c, i64 0, i32 2
  %3 = load i32, ptr %ofc, align 4
  %. = tail call i32 @llvm.smin.i32(i32 %2, i32 %3)
  %obfc4 = getelementptr inbounds %struct.CONSTRAINT, ptr %tc, i64 0, i32 1
  store i32 %., ptr %obfc4, align 4
  %ofc5 = getelementptr inbounds %struct.CONSTRAINT, ptr %tc, i64 0, i32 2
  store i32 8388607, ptr %ofc5, align 4
  %cmp9.not224 = icmp eq ptr %link.0223, %x
  br i1 %cmp9.not224, label %if.then115.thread, label %for.cond12.preheader.outer

if.then115.thread:                                ; preds = %if.end
  %4 = load ptr, ptr @no_fpos, align 8
  %call116278 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.12, i32 noundef 0, ptr noundef %4, ptr noundef nonnull @.str.30) #4
  unreachable

for.cond12.preheader.outer:                       ; preds = %if.end, %for.inc108.thread
  %.ph = phi i32 [ %22, %for.inc108.thread ], [ undef, %if.end ]
  %.ph285 = phi i32 [ %23, %for.inc108.thread ], [ undef, %if.end ]
  %link.0229.ph = phi ptr [ %link.0257, %for.inc108.thread ], [ %link.0223, %if.end ]
  %5 = phi i1 [ false, %for.inc108.thread ], [ true, %if.end ]
  %dble_fwd.0227.ph = phi i32 [ %cond63, %for.inc108.thread ], [ 0, %if.end ]
  %m.0226.ph = phi ptr [ %m.0226, %for.inc108.thread ], [ undef, %if.end ]
  %b.promoted = load i32, ptr %b, align 4
  %f.promoted = load i32, ptr %f, align 4
  br label %for.cond12.preheader

for.cond12.preheader:                             ; preds = %for.cond12.preheader.outer, %for.inc108
  %cond95308 = phi i32 [ %cond95307, %for.inc108 ], [ %f.promoted, %for.cond12.preheader.outer ]
  %.221306 = phi i32 [ %.221305, %for.inc108 ], [ %b.promoted, %for.cond12.preheader.outer ]
  %6 = phi i32 [ %18, %for.inc108 ], [ %.ph, %for.cond12.preheader.outer ]
  %7 = phi i32 [ %19, %for.inc108 ], [ %.ph285, %for.cond12.preheader.outer ]
  %8 = phi i32 [ %20, %for.inc108 ], [ %.ph, %for.cond12.preheader.outer ]
  %9 = phi i32 [ %21, %for.inc108 ], [ %.ph285, %for.cond12.preheader.outer ]
  %link.0229 = phi ptr [ %link.0, %for.inc108 ], [ %link.0229.ph, %for.cond12.preheader.outer ]
  %m.0226 = phi ptr [ %m.1, %for.inc108 ], [ %m.0226.ph, %for.cond12.preheader.outer ]
  %start_group.0225 = phi ptr [ %start_group.1, %for.inc108 ], [ null, %for.cond12.preheader.outer ]
  br label %for.cond12
...
for.cond12:                                       ; preds = %for.cond12.preheader, %for.cond12
  ...
  %y.0 = load ptr, ptr %y.0.in, align 8
  %ou1 = getelementptr inbounds %struct.word_type, ptr %y.0, i64 0, i32 1
  %10 = load i8, ptr %ou1, align 8
  %cmp13 = icmp eq i8 %10, 0
  br i1 %cmp13, label %for.cond12, label %for.end

for.end:                                          ; preds = %for.cond12
  %11 = add i8 %10, -119
  %or.cond = icmp ult i8 %11, 20
...
if.then39:                                        ; preds = %if.then36
  ...
  %call40 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.12, i32 noundef 0, ptr noundef %12, ptr noundef nonnull @.str.29) #4
  br label %if.end41
...
if.then42:                                        ; preds = %if.end41
  store i32 %.221306, ptr %b, align 4
  store i32 %cond95308, ptr %f, align 4
  %cmp44.not = icmp sgt i32 %9, 8388607
  br i1 %cmp44.not, label %if.then54, label %land.lhs.true46

land.lhs.true46:                                  ; preds = %if.then42
  %add = add nsw i32 %8, %9
  %cmp48.not = icmp sgt i32 %add, %.
  %cmp52.not = icmp sgt i32 %8, 8388607
  %or.cond220 = or i1 %cmp48.not, %cmp52.not
  br i1 %or.cond220, label %if.then54, label %for.inc108.thread
...
if.then67:                                        ; preds = %if.else
  ...
  %15 = load i32, ptr %ofwd, align 8
  br label %for.inc108

if.else71:                                        ; preds = %if.else
  %.221 = tail call i32 @llvm.smax.i32(i32 %9, i32 %14)
  %ofwd85 = getelementptr inbounds %struct.word_type, ptr %y.0, i64 0, i32 3, i32 1
  %16 = load i32, ptr %ofwd85, align 8
  %cond95 = tail call i32 @llvm.smax.i32(i32 %8, i32 %16)
  %ofwd100 = getelementptr inbounds %struct.word_type, ptr %m.0226, i64 0, i32 3, i32 1
  %17 = load i32, ptr %ofwd100, align 8
  %cmp102 = icmp sgt i32 %16, %17
  %spec.select = select i1 %cmp102, ptr %y.0, ptr %m.0226
  br label %for.inc108

for.inc108:                                       ; preds = %if.else71, %for.end, %if.end41, %if.then67
  %cond95307 = phi i32 [ %cond95308, %if.end41 ], [ %15, %if.then67 ], [ %cond95308, %for.end ], [ %cond95, %if.else71 ]
  %.221305 = phi i32 [ %.221306, %if.end41 ], [ %14, %if.then67 ], [ %.221306, %for.end ], [ %.221, %if.else71 ]
  %18 = phi i32 [ %6, %if.end41 ], [ %15, %if.then67 ], [ %6, %for.end ], [ %cond95, %if.else71 ]
  %19 = phi i32 [ %7, %if.end41 ], [ %14, %if.then67 ], [ %7, %for.end ], [ %.221, %if.else71 ]
  %20 = phi i32 [ %8, %if.end41 ], [ %15, %if.then67 ], [ %8, %for.end ], [ %cond95, %if.else71 ]
  %21 = phi i32 [ %9, %if.end41 ], [ %14, %if.then67 ], [ %9, %for.end ], [ %.221, %if.else71 ]
  %start_group.1 = phi ptr [ %start_group.0225, %if.end41 ], [ %link.0229, %if.then67 ], [ %start_group.0225, %for.end ], [ %start_group.0225, %if.else71 ]
  %m.1 = phi ptr [ %m.0226, %if.end41 ], [ %y.0, %if.then67 ], [ %m.0226, %for.end ], [ %spec.select, %if.else71 ]
  %osucc111 = getelementptr inbounds %struct.LIST, ptr %link.0229, i64 0, i32 1
  %link.0 = load ptr, ptr %osucc111, align 8
  %cmp9.not = icmp eq ptr %link.0, %x
  br i1 %cmp9.not, label %for.end112, label %for.cond12.preheader

for.inc108.thread:                                ; preds = %if.then54, %land.lhs.true46
  %22 = phi i32 [ %6, %land.lhs.true46 ], [ %.pre235, %if.then54 ]
  %23 = phi i32 [ %7, %land.lhs.true46 ], [ %.pre, %if.then54 ]
  %add56 = add nsw i32 %22, %23
  %cond63 = tail call i32 @llvm.smax.i32(i32 %dble_fwd.0227.ph, i32 %add56)
  %osucc111256 = getelementptr inbounds %struct.LIST, ptr %link.0229, i64 0, i32 1
  %link.0257 = load ptr, ptr %osucc111256, align 8
  %cmp9.not258 = icmp eq ptr %link.0257, %x
  br i1 %cmp9.not258, label %if.then115.thread279, label %for.cond12.preheader.outer

if.then115.thread279:                             ; preds = %for.inc108.thread
  %24 = load ptr, ptr @no_fpos, align 8
  %call116284 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.12, i32 noundef 0, ptr noundef %24, ptr noundef nonnull @.str.30) #4
  br label %if.then119

for.end112:                                       ; preds = %for.inc108
  store i32 %.221305, ptr %b, align 4
  store i32 %cond95307, ptr %f, align 4
...
if.then115:                                       ; preds = %for.end112
  ...
  %call116 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.12, i32 noundef 0, ptr noundef %25, ptr noundef nonnull @.str.30) #4
  br i1 %5, label %if.else157, label %if.then119

if.end117:                                        ; preds = %for.end112
  br i1 %5, label %if.else157, label %if.then119

if.then119:                                       ; preds = %if.then115.thread279, %if.then115, %if.end117
  %26 = phi i32 [ %18, %if.then115 ], [ %18, %if.end117 ], [ %22, %if.then115.thread279 ]
  %27 = phi i32 [ %19, %if.then115 ], [ %19, %if.end117 ], [ %23, %if.then115.thread279 ]
  %start_group.0.lcssa244273 = phi ptr [ null, %if.then115 ], [ %start_group.1, %if.end117 ], [ null, %if.then115.thread279 ]
  %m.0.lcssa246271 = phi ptr [ %m.1, %if.then115 ], [ %m.1, %if.end117 ], [ %m.0226, %if.then115.thread279 ]
  %dble_fwd.0.lcssa248269 = phi i32 [ %dble_fwd.0227.ph, %if.then115 ], [ %dble_fwd.0227.ph, %if.end117 ], [ %cond63, %if.then115.thread279 ]
  %cmp121.not = icmp sgt i32 %27, 8388607
  br i1 %cmp121.not, label %if.then132, label %land.lhs.true123

land.lhs.true123:                                 ; preds = %if.then119
  %add124 = add nsw i32 %26, %27
...
if.then132:                                       ; preds = %land.lhs.true123, %if.then119
  ...
  call fastcc void @BreakJoinedGroup(ptr noundef %start_group.0.lcssa244273, ptr noundef %28, ptr noundef %m.0.lcssa246271, ptr noundef nonnull %tc, ptr noundef nonnull %b, ptr noundef nonnull %f)
...
if.end136:                                        ; preds = %land.lhs.true123, %if.then132
  ...
  %cond144 = tail call i32 @llvm.smax.i32(i32 %dble_fwd.0.lcssa248269, i32 %add137.pre-phi)
  %ou3145 = getelementptr inbounds %struct.word_type, ptr %x, i64 0, i32 3
  store i32 0, ptr %ou3145, align 8
  %cond153 = tail call i32 @llvm.smin.i32(i32 %cond144, i32 8388607)
  br label %if.end167

if.else157:                                       ; preds = %if.then115, %if.end117
  %start_group.0.lcssa244272 = phi ptr [ null, %if.then115 ], [ %start_group.1, %if.end117 ]
  %29 = load ptr, ptr %x, align 8
  call fastcc void @BreakJoinedGroup(ptr noundef %start_group.0.lcssa244272, ptr noundef %29, ptr noundef %m.1, ptr noundef %c, ptr noundef nonnull %b, ptr noundef nonnull %f)
  %30 = load i32, ptr %b, align 4
  %ou3161 = getelementptr inbounds %struct.word_type, ptr %x, i64 0, i32 3
  store i32 %30, ptr %ou3161, align 8
  %31 = load i32, ptr %f, align 4
  br label %if.end167

if.end167:                                        ; preds = %if.else157, %if.end136
  %.sink = phi i32 [ %31, %if.else157 ], [ %cond153, %if.end136 ]
  %ofwd165 = getelementptr inbounds %struct.word_type, ptr %x, i64 0, i32 3, i32 1
  store i32 %.sink, ptr %ofwd165, align 8
