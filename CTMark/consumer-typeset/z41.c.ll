...
if.end19:                                         ; preds = %if.then17, %ETC
  ...
  %link.01043 = load ptr, ptr %link.0.in1042, align 8, !tbaa !9
...
land.lhs.true.i:                                  ; preds = %if.then78
  %16 = load ptr, ptr %oenclosing.i287, align 8, !tbaa !9
...
land.lhs.true.i286:                               ; preds = %if.then136
  %40 = load ptr, ptr %oenclosing.i287, align 8, !tbaa !9
...
need_lvis.exit292:                                ; preds = %land.lhs.true.i286
  ...
  %42 = load i8, ptr %ou1.i290, align 8, !tbaa !9
...
land.lhs.true.i297:                               ; preds = %if.then196
  ...
  %60 = load ptr, ptr %oenclosing.i298, align 8, !tbaa !9
  %61 = load ptr, ptr @StartSym, align 8, !tbaa !5
...
need_lvis.exit303:                                ; preds = %land.lhs.true.i297
  ...
  %62 = load i8, ptr %ou1.i301, align 8, !tbaa !9
