; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z41.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z41.c"
...
entry:
  ...
  %0 = load i16, ptr @last_write_fnum, align 2
...
if.then6:                                         ; preds = %if.then
  %1 = load ptr, ptr @last_write_fp, align 8
...
if.end14:                                         ; preds = %if.then11, %if.end
  ...
  store ptr %call20, ptr @last_write_fp, align 8
...
if.then:                                          ; preds = %sw.bb
  ...
  %2 = load ptr, ptr @last_write_fp, align 8
...
sw.bb9:                                           ; preds = %entry
  ...
  %3 = load ptr, ptr @last_write_fp, align 8
...
if.then17:                                        ; preds = %ETC
  %4 = load ptr, ptr @last_write_fp, align 8
  %fputc983 = tail call i32 @fputc(i32 123, ptr %4)
  br label %if.end19

if.end19:                                         ; preds = %if.then17, %ETC
  %link.0.in1042 = getelementptr inbounds %struct.LIST, ptr %x, i64 0, i32 1
  %link.01043 = load ptr, ptr %link.0.in1042, align 8
  %cmp20.not1044 = icmp eq ptr %link.01043, %x
  br i1 %cmp20.not1044, label %for.end205, label %for.cond24.preheader

for.cond24.preheader:                             ; preds = %if.end19, %for.inc201
  %link.01046 = phi ptr [ %link.0, %for.inc201 ], [ %link.01043, %if.end19 ]
  %last_prec.01045 = phi i32 [ %last_prec.1, %for.inc201 ], [ %prec.0, %if.end19 ]
  br label %for.cond24

for.cond24:                                       ; preds = %for.cond24.preheader, %for.cond24
  %link.0.pn = phi ptr [ %y.0, %for.cond24 ], [ %link.01046, %for.cond24.preheader ]
...
if.then39:                                        ; preds = %for.cond24
  ...
  %6 = load ptr, ptr %osucc42, align 8
...
for.body58:                                       ; preds = %if.end53, %for.body58
  ...
  %10 = load ptr, ptr @last_write_fp, align 8
  %fputc991 = tail call i32 @fputc(i32 10, ptr %10)
  %inc = add nuw nsw i32 %i.01037, 1
  %11 = load i8, ptr %ovspace, align 2
  %conv55 = zext i8 %11 to i32
  %cmp56.not.not = icmp ult i32 %i.01037, %conv55
  br i1 %cmp56.not.not, label %for.body58, label %for.end61

for.end61:                                        ; preds = %for.body58, %if.end53
  %conv55.lcssa = phi i32 [ 0, %if.end53 ], [ %conv55, %for.body58 ]
  %12 = load i32, ptr %linecount, align 4
  %add = add nsw i32 %12, %conv55.lcssa
  store i32 %add, ptr %linecount, align 4
  %ohspace = getelementptr inbounds i8, ptr %y.0, i64 41
  %13 = load i8, ptr %ohspace, align 1
  %cmp68.not1039 = icmp eq i8 %13, 0
  br i1 %cmp68.not1039, label %for.end74, label %for.body70

for.body70:                                       ; preds = %for.end61, %for.body70
  %i.11040 = phi i32 [ %inc73, %for.body70 ], [ 1, %for.end61 ]
  %14 = load ptr, ptr @last_write_fp, align 8
  %fputc990 = tail call i32 @fputc(i32 32, ptr %14)
  %inc73 = add nuw nsw i32 %i.11040, 1
  %15 = load i8, ptr %ohspace, align 1
  %conv67 = zext i8 %15 to i32
  %cmp68.not.not = icmp ult i32 %i.11040, %conv67
  br i1 %cmp68.not.not, label %for.body70, label %for.end74

for.end74:                                        ; preds = %for.body70, %for.end61
  %conv67.lcssa = phi i32 [ 0, %for.end61 ], [ %conv67, %for.body70 ]
  %16 = load i8, ptr %ovspace, align 2
  %conv77 = zext i8 %16 to i32
  %add81 = sub nsw i32 0, %conv67.lcssa
  %cmp82 = icmp eq i32 %conv77, %add81
  %cond = select i1 %cmp82, i32 103, i32 7
  br label %for.inc201

for.cond91:                                       ; preds = %if.then39, %for.cond91
  %.pn986 = phi ptr [ %gap_obj.0, %for.cond91 ], [ %6, %if.then39 ]
  %gap_obj.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn986, i64 0, i64 1
  %gap_obj.0 = load ptr, ptr %gap_obj.0.in, align 8
  %ou192 = getelementptr inbounds %struct.word_type, ptr %gap_obj.0, i64 0, i32 1
  %17 = load i8, ptr %ou192, align 8
...
for.end102:                                       ; preds = %for.cond91
  ...
  %19 = load ptr, ptr @last_write_fp, align 8
...
if.else110:                                       ; preds = %for.end102
  %fputc987 = tail call i32 @fputc(i32 10, ptr %19)
  %20 = load i32, ptr %linecount, align 4
  %add112 = add nsw i32 %20, 1
  store i32 %add112, ptr %linecount, align 4
  br label %if.end113

if.end113:                                        ; preds = %if.else110, %if.then108
  %21 = load i8, ptr %ou1, align 8
  ...
  %22 = load ptr, ptr @last_write_fp, align 8
  %call123 = tail call i32 @fputs(ptr noundef %call122, ptr noundef %22)
  %23 = load i8, ptr %ou192.le, align 8
  %.off = add i8 %23, -11
...
if.end141:                                        ; preds = %if.then140, %lor.lhs.false134
  %24 = load ptr, ptr @last_write_fp, align 8
  %fputc989 = tail call i32 @fputc(i32 32, ptr %24)
  br label %for.inc201

if.else144:                                       ; preds = %for.cond24
  %25 = load i8, ptr %ou1, align 8
  %cmp148 = icmp eq i8 %25, 17
  br i1 %cmp148, label %if.then150, label %if.else198

if.then150:                                       ; preds = %if.else144
  %osucc153 = getelementptr inbounds %struct.LIST, ptr %link.01046, i64 0, i32 1
  %26 = load ptr, ptr %osucc153, align 8
  %cmp154.not = icmp eq ptr %26, %x
  br i1 %cmp154.not, label %if.end194, label %for.cond163

for.cond163:                                      ; preds = %if.then150, %for.cond163
  %.pn985 = phi ptr [ %next_gap.0, %for.cond163 ], [ %26, %if.then150 ]
  %next_gap.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn985, i64 0, i64 1
  %next_gap.0 = load ptr, ptr %next_gap.0.in, align 8
  %ou1164 = getelementptr inbounds %struct.word_type, ptr %next_gap.0, i64 0, i32 1
  %27 = load i8, ptr %ou1164, align 8
...
if.end194:                                        ; preds = %if.then150, %if.end182
  ...
  %cond197 = tail call i32 @llvm.smax.i32(i32 %last_prec.01045, i32 %next_prec.0)
...
for.inc201:                                       ; preds = %if.end141, %for.end74, %if.else198, %if.end194
  %last_prec.1 = phi i32 [ %cond, %for.end74 ], [ %prec.0, %if.end141 ], [ %last_prec.01045, %if.end194 ], [ %last_prec.01045, %if.else198 ]
  %link.0.in = getelementptr inbounds %struct.LIST, ptr %link.01046, i64 0, i32 1
  %link.0 = load ptr, ptr %link.0.in, align 8
  %cmp20.not = icmp eq ptr %link.0, %x
  br i1 %cmp20.not, label %for.end205, label %for.cond24.preheader

for.end205:                                       ; preds = %for.inc201, %if.end19
  br i1 %cmp15, label %if.then208, label %sw.epilog

if.then208:                                       ; preds = %for.end205
  %31 = load ptr, ptr @last_write_fp, align 8
  %fputc984 = tail call i32 @fputc(i32 125, ptr %31)
  br label %sw.epilog

sw.bb211:                                         ; preds = %entry
  %osucc214 = getelementptr inbounds %struct.LIST, ptr %x, i64 0, i32 1
  %32 = load ptr, ptr %osucc214, align 8
  %cmp215 = icmp eq ptr %32, %x
  br i1 %cmp215, label %if.then217, label %if.else221

if.then217:                                       ; preds = %sw.bb211
  %33 = load ptr, ptr @last_write_fp, align 8
  %34 = tail call i64 @fwrite(ptr nonnull @.str.17, i64 3, i64 1, ptr %33)
  %35 = load ptr, ptr @last_write_fp, align 8
  %fputc982 = tail call i32 @fputc(i32 10, ptr %35)
  %36 = load i32, ptr %linecount, align 4
  %add220 = add nsw i32 %36, 1
  store i32 %add220, ptr %linecount, align 4
  br label %sw.epilog
...
if.else221:                                       ; preds = %sw.bb211
  ...
  %37 = load ptr, ptr @last_write_fp, align 8
...
if.then223:                                       ; preds = %if.else221
  ...
  %39 = load ptr, ptr @last_write_fp, align 8
...
if.end265:                                        ; preds = %for.cond246, %if.then263
  %49 = load ptr, ptr @last_write_fp, align 8
  %fputc971 = call i32 @fputc(i32 123, ptr %49)
  %50 = load ptr, ptr @last_write_fp, align 8
  %fputc972 = call i32 @fputc(i32 32, ptr %50)
  %51 = load ptr, ptr @last_write_fp, align 8
  %52 = call i64 @fwrite(ptr nonnull @.str.21, i64 3, i64 1, ptr %51)
  %53 = load ptr, ptr @last_write_fp, align 8
  %fputc973 = call i32 @fputc(i32 32, ptr %53)
  %54 = load ptr, ptr @last_write_fp, align 8
  %fputc974 = call i32 @fputc(i32 123, ptr %54)
  %55 = load ptr, ptr @last_write_fp, align 8
  ...
  %56 = load ptr, ptr @last_write_fp, align 8
  %fputc976 = call i32 @fputc(i32 32, ptr %56)
  %57 = load ptr, ptr @last_write_fp, align 8
  %fputc977 = call i32 @fputc(i32 125, ptr %57)
  %58 = load ptr, ptr @last_write_fp, align 8
  %fputc978 = call i32 @fputc(i32 32, ptr %58)
  %59 = load ptr, ptr @last_write_fp, align 8
  %fputc979 = call i32 @fputc(i32 125, ptr %59)
  %60 = load ptr, ptr @last_write_fp, align 8
  %fputc980 = call i32 @fputc(i32 10, ptr %60)
  %61 = load i32, ptr %linecount, align 4
  %add277 = add nsw i32 %61, 1
  store i32 %add277, ptr %linecount, align 4
  br label %sw.epilog
...
if.end304:                                        ; preds = %for.cond285, %if.then302
  %64 = load ptr, ptr @last_write_fp, align 8
  %fputc956 = call i32 @fputc(i32 123, ptr %64)
  %65 = load ptr, ptr @last_write_fp, align 8
  %fputc957 = call i32 @fputc(i32 32, ptr %65)
  %66 = load ptr, ptr @last_write_fp, align 8
  %67 = call i64 @fwrite(ptr nonnull @.str.23, i64 3, i64 1, ptr %66)
  %68 = load ptr, ptr @last_write_fp, align 8
  %fputc958 = call i32 @fputc(i32 32, ptr %68)
  %69 = load ptr, ptr @last_write_fp, align 8
  %fputc959 = call i32 @fputc(i32 123, ptr %69)
  %70 = load ptr, ptr @last_write_fp, align 8
  ...
  %71 = load ptr, ptr @last_write_fp, align 8
  %fputc961 = call i32 @fputc(i32 32, ptr %71)
  %72 = load ptr, ptr @last_write_fp, align 8
  %fputc962 = call i32 @fputc(i32 125, ptr %72)
  %73 = load ptr, ptr @last_write_fp, align 8
  %fputc963 = call i32 @fputc(i32 10, ptr %73)
  %74 = load i32, ptr %linecount, align 4
  %add314 = add nsw i32 %74, 1
  store i32 %add314, ptr %linecount, align 4
  %75 = load ptr, ptr %osucc214, align 8
...
if.end340:                                        ; preds = %for.cond321, %if.then338
  %78 = load ptr, ptr @last_write_fp, align 8
...
for.cond363:                                      ; preds = %sw.bb350, %for.cond363
  %.pn947 = phi ptr [ %y.3, %for.cond363 ], [ %85, %sw.bb350 ]
  %y.3.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn947, i64 0, i64 1
  %y.3 = load ptr, ptr %y.3.in, align 8
  %ou1364 = getelementptr inbounds %struct.word_type, ptr %y.3, i64 0, i32 1
  %86 = load i8, ptr %ou1364, align 8
...
if.end417.thread:                                 ; preds = %for.cond363
  %89 = load ptr, ptr @last_write_fp, align 8
  %90 = tail call i64 @fwrite(ptr nonnull @.str.25, i64 3, i64 1, ptr %89)
  %91 = load ptr, ptr @last_write_fp, align 8
  %fputc948 = tail call i32 @fputc(i32 32, ptr %91)
  %92 = load ptr, ptr @last_write_fp, align 8
  %fputc949 = tail call i32 @fputc(i32 123, ptr %92)
  %93 = load ptr, ptr @last_write_fp, align 8
  %fputc950 = tail call i32 @fputc(i32 10, ptr %93)
  %94 = load i32, ptr %linecount, align 4
  %add413 = add nsw i32 %94, 1
  store i32 %add413, ptr %linecount, align 4
  tail call fastcc void @WriteObject(ptr noundef nonnull %y.3, i32 noundef 0, ptr noundef %linecount, i16 noundef zeroext %fnum)
  %95 = load ptr, ptr @last_write_fp, align 8
  %fputc951 = tail call i32 @fputc(i32 125, ptr %95)
  %96 = load ptr, ptr @last_write_fp, align 8
  %fputc952 = tail call i32 @fputc(i32 10, ptr %96)
  %97 = load i32, ptr %linecount, align 4
  %add416 = add nsw i32 %97, 1
  store i32 %add416, ptr %linecount, align 4
  br label %if.then419
...
if.then419:                                       ; preds = %land.lhs.true390, %if.end417.thread, %if.end417
  ...
  %98 = load ptr, ptr @last_write_fp, align 8
  %fputc953 = tail call i32 @fputc(i32 123, ptr %98)
  ...
  %99 = load ptr, ptr @last_write_fp, align 8
  %fputc954 = tail call i32 @fputc(i32 125, ptr %99)
  br label %sw.epilog

sw.bb426:                                         ; preds = %entry, %entry
  %osucc429 = getelementptr inbounds %struct.LIST, ptr %x, i64 0, i32 1
  %100 = load ptr, ptr %osucc429, align 8
...
for.cond433:                                      ; preds = %for.cond433, %sw.bb426
  ...
  %101 = load i8, ptr %ou1434, align 8
...
if.then455:                                       ; preds = %if.end452
  %103 = load ptr, ptr @last_write_fp, align 8
  %fputc943 = tail call i32 @fputc(i32 123, ptr %103)
  br label %if.end457

if.end457:                                        ; preds = %if.then455, %if.end452
  %oactual458 = getelementptr inbounds %struct.closure_type, ptr %y.4, i64 0, i32 5
  %104 = load ptr, ptr %oactual458, align 8
...
land.lhs.true.i:                                  ; preds = %if.end457
  ...
  %106 = load ptr, ptr %oenclosing.i, align 8
  %107 = load ptr, ptr @StartSym, align 8
...
need_lvis.exit:                                   ; preds = %land.lhs.true.i
  ...
  %108 = load i8, ptr %ou1.i, align 8
  %cmp2.i.not = icmp eq i8 %108, -113
  br i1 %cmp2.i.not, label %if.then461, label %if.end464

if.then461:                                       ; preds = %need_lvis.exit
  %109 = load ptr, ptr @last_write_fp, align 8
  %110 = tail call i64 @fwrite(ptr nonnull @.str.27, i64 3, i64 1, ptr %109)
  %111 = load ptr, ptr @last_write_fp, align 8
  %fputc944 = tail call i32 @fputc(i32 32, ptr %111)
  %.pre = load ptr, ptr %oactual458, align 8
  br label %if.end464
...
for.cond481:                                      ; preds = %for.cond481, %if.end464
  %.pn945 = phi ptr [ %116, %if.end464 ], [ %y.5, %for.cond481 ]
  %y.5.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn945, i64 0, i64 1
  %y.5 = load ptr, ptr %y.5.in, align 8
  %ou1482 = getelementptr inbounds %struct.word_type, ptr %y.5, i64 0, i32 1
  %117 = load i8, ptr %ou1482, align 8
  %cmp485 = icmp eq i8 %117, 0
  br i1 %cmp485, label %for.cond481, label %for.end492
...
if.then495:                                       ; preds = %for.end492
  %118 = load ptr, ptr @last_write_fp, align 8
  %fputc946 = tail call i32 @fputc(i32 125, ptr %118)
  br label %sw.epilog
...
if.then568:                                       ; preds = %SETC
  %119 = load ptr, ptr @last_write_fp, align 8
  %fputc934 = tail call i32 @fputc(i32 123, ptr %119)
  br label %if.end570

if.end570:                                        ; preds = %if.then568, %SETC
  %osucc573 = getelementptr inbounds %struct.LIST, ptr %x, i64 0, i32 1
  %120 = load ptr, ptr %osucc573, align 8
...
for.cond586:                                      ; preds = %if.end570, %for.cond586
  %.pn935 = phi ptr [ %y.6, %for.cond586 ], [ %120, %if.end570 ]
  %y.6.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn935, i64 0, i64 1
  %y.6 = load ptr, ptr %y.6.in, align 8
  %ou1587 = getelementptr inbounds %struct.word_type, ptr %y.6, i64 0, i32 1
  %122 = load i8, ptr %ou1587, align 8
  %cmp590 = icmp eq i8 %122, 0
  br i1 %cmp590, label %for.cond586, label %for.end597
...
for.end597:                                       ; preds = %for.cond586
  ...
  %123 = load ptr, ptr @last_write_fp, align 8
  %fputc936 = tail call i32 @fputc(i32 32, ptr %123)
  br label %if.end599

if.end599:                                        ; preds = %for.end597, %if.end570
  %124 = load ptr, ptr @last_write_fp, align 8
...
for.cond613:                                      ; preds = %if.end599, %for.cond613
  %.pn937 = phi ptr [ %y.7, %for.cond613 ], [ %125, %if.end599 ]
  %y.7.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn937, i64 0, i64 1
  %y.7 = load ptr, ptr %y.7.in, align 8
  %ou1614 = getelementptr inbounds %struct.word_type, ptr %y.7, i64 0, i32 1
  %126 = load i8, ptr %ou1614, align 8
  %cmp617 = icmp eq i8 %126, 0
  br i1 %cmp617, label %for.cond613, label %for.end624

for.end624:                                       ; preds = %for.cond613
  %127 = load ptr, ptr @last_write_fp, align 8
  %fputc938 = tail call i32 @fputc(i32 32, ptr %127)
  %128 = load i8, ptr %ou1, align 8
  %cmp629 = icmp eq i8 %128, 92
  br i1 %cmp629, label %if.then631, label %if.else634

if.then631:                                       ; preds = %for.end624
  %129 = load ptr, ptr @last_write_fp, align 8
  %fputc939 = tail call i32 @fputc(i32 123, ptr %129)
  tail call fastcc void @WriteObject(ptr noundef nonnull %y.7, i32 noundef 0, ptr noundef %linecount, i16 noundef zeroext %fnum)
  %130 = load ptr, ptr @last_write_fp, align 8
  %fputc940 = tail call i32 @fputc(i32 125, ptr %130)
  br label %if.end636
...
for.cond659:                                      ; preds = %for.cond659, %sw.bb642
  ...
  %138 = load i8, ptr %ou1660, align 8
...
if.then676:                                       ; preds = %for.cond659
  ...
  %139 = load ptr, ptr @last_write_fp, align 8
  %call679 = tail call i32 @fputs(ptr noundef nonnull %ostring677, ptr noundef %139)
  %140 = load ptr, ptr @last_write_fp, align 8
  %fputc932 = tail call i32 @fputc(i32 32, ptr %140)
  br label %if.end737
...
if.end689:                                        ; preds = %for.cond659, %if.then687
  ...
  %link.11031 = load ptr, ptr %link.1.in1030, align 8
...
for.cond700:                                      ; preds = %for.cond700.preheader, %for.cond700
  ...
  %142 = load i8, ptr %ou1701, align 8
...
if.end726:                                        ; preds = %for.cond700, %if.then724
  ...
  %144 = load ptr, ptr @last_write_fp, align 8
  %call729 = tail call i32 @fputs(ptr noundef nonnull %ostring727, ptr noundef %144)
  %145 = load ptr, ptr @last_write_fp, align 8
  %fputc931 = tail call i32 @fputc(i32 10, ptr %145)
  %146 = load i32, ptr %linecount, align 4
  %add731 = add nsw i32 %146, 1
  store i32 %add731, ptr %linecount, align 4
  br label %for.inc732
...
for.inc49:                                        ; preds = %for.body18, %if.then43, %if.end37
  ...
  br i1 %cmp16.not, label %for.end51, label %for.body18
...
entry:
  ...
  %1 = load ptr, ptr %ouse_invocation, align 8
...
if.else:                                          ; preds = %entry
  ...
  %link.0313 = load ptr, ptr %link.0.in312, align 8
...
for.cond7.preheader.lr.ph:                        ; preds = %if.else
  ...
  %oenclosing.i287 = getelementptr inbounds %struct.symbol_type, ptr %0, i64 0, i32 3
...
sw.bb:                                            ; preds = %if.then19
  ...
  %7 = load ptr, ptr %osucc26, align 8
...
if.then29:                                        ; preds = %sw.bb
  ...
  %.pre320 = load ptr, ptr %osucc26, align 8
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.cond37
  ...
  %9 = load i8, ptr %ou138, align 8
  %cmp41 = icmp eq i8 %9, 0
  br i1 %cmp41, label %for.cond37, label %for.end48

for.end48:                                        ; preds = %for.cond37
  %10 = load i8, ptr %ou2170, align 8
  ...
  %11 = load ptr, ptr @last_write_fp, align 8
...
if.then57:                                        ; preds = %sw.bb51
  ...
  %.pre319 = load ptr, ptr %osucc54, align 8
...
for.cond66:                                       ; preds = %for.cond66.preheader, %for.cond66
  ...
  %14 = load i8, ptr %ou167, align 8
  %cmp70 = icmp eq i8 %14, 0
  br i1 %cmp70, label %for.cond66, label %for.end77
...
land.lhs.true.i:                                  ; preds = %if.then78
  %16 = load ptr, ptr %oenclosing.i287, align 8
...
if.then81:                                        ; preds = %need_lvis.exit
  ...
  %21 = load ptr, ptr @last_write_fp, align 8
  %fputc271 = tail call i32 @fputc(i32 32, ptr %21)
  br label %if.end84
...
if.end87:                                         ; preds = %if.end84, %for.end77
  %23 = load ptr, ptr @last_write_fp, align 8
  %fputc272 = tail call i32 @fputc(i32 10, ptr %23)
  %24 = load i32, ptr %linecount, align 4
  %add = add nsw i32 %24, 1
  store i32 %add, ptr %linecount, align 4
  %25 = load ptr, ptr @last_write_fp, align 8
  %fputc273 = tail call i32 @fputc(i32 32, ptr %25)
  %26 = load ptr, ptr @last_write_fp, align 8
  %fputc274 = tail call i32 @fputc(i32 32, ptr %26)
  %27 = load ptr, ptr %oactual20, align 8
  %onpar_code = getelementptr inbounds %struct.symbol_type, ptr %27, i64 0, i32 15
  %28 = load i8, ptr %onpar_code, align 1
  %cmp93.not = icmp eq i8 %28, 32
  br i1 %cmp93.not, label %if.else101, label %if.then95

if.then95:                                        ; preds = %if.end87
  %29 = load ptr, ptr @last_write_fp, align 8
  %fputc275 = tail call i32 @fputc(i32 92, ptr %29)
  %30 = load ptr, ptr @last_write_fp, align 8
  %31 = load ptr, ptr %oactual20, align 8
  %onpar_code98 = getelementptr inbounds %struct.symbol_type, ptr %31, i64 0, i32 15
  %32 = load i8, ptr %onpar_code98, align 1
  %conv99 = sext i8 %32 to i32
  %fputc276 = tail call i32 @fputc(i32 %conv99, ptr %30)
  br label %if.end105
...
if.end105:                                        ; preds = %if.else101, %if.then95
  %34 = load ptr, ptr @last_write_fp, align 8
  %fputc277 = tail call i32 @fputc(i32 123, ptr %34)
...
if.then114:                                       ; preds = %sw.bb108
  ...
  %.pre = load ptr, ptr %osucc111, align 8
...
for.cond123:                                      ; preds = %for.cond123.preheader, %for.cond123
  ...
  %38 = load i8, ptr %ou1124, align 8
  %cmp127 = icmp eq i8 %38, 0
  br i1 %cmp127, label %for.cond123, label %for.end134
...
if.then136:                                       ; preds = %for.end134
  ...
  br i1 %tobool.not.i284, label %land.lhs.true.i286, label %if.end142

land.lhs.true.i286:                               ; preds = %if.then136
  %40 = load ptr, ptr %oenclosing.i287, align 8
  %41 = load ptr, ptr @StartSym, align 8
  %cmp.not.i288 = icmp eq ptr %40, %41
  br i1 %cmp.not.i288, label %if.end142, label %need_lvis.exit292

need_lvis.exit292:                                ; preds = %land.lhs.true.i286
  %ou1.i290 = getelementptr inbounds %struct.word_type, ptr %40, i64 0, i32 1
  %42 = load i8, ptr %ou1.i290, align 8
  %cmp2.i291.not = icmp eq i8 %42, -113
  br i1 %cmp2.i291.not, label %if.then139, label %if.end142

if.then139:                                       ; preds = %need_lvis.exit292
  %43 = load ptr, ptr @last_write_fp, align 8
  %44 = tail call i64 @fwrite(ptr nonnull @.str.27, i64 3, i64 1, ptr %43)
  %45 = load ptr, ptr @last_write_fp, align 8
  %fputc263 = tail call i32 @fputc(i32 32, ptr %45)
  br label %if.end142

if.end142:                                        ; preds = %if.then136, %land.lhs.true.i286, %if.then139, %need_lvis.exit292
  %call143 = tail call ptr @SymName(ptr noundef nonnull %0) #8
  %46 = load ptr, ptr @last_write_fp, align 8
...
if.then172:                                       ; preds = %if.else169
  %52 = load ptr, ptr @last_write_fp, align 8
  %fputc266 = tail call i32 @fputc(i32 123, ptr %52)
  %53 = load ptr, ptr @last_write_fp, align 8
  %fputc267 = tail call i32 @fputc(i32 32, ptr %53)
  tail call fastcc void @WriteObject(ptr noundef nonnull %z.2, i32 noundef 0, ptr noundef %linecount, i16 noundef zeroext %fnum)
  %54 = load ptr, ptr @last_write_fp, align 8
  %fputc268 = tail call i32 @fputc(i32 32, ptr %54)
  %55 = load ptr, ptr @last_write_fp, align 8
  %fputc269 = tail call i32 @fputc(i32 125, ptr %55)
  br label %for.inc190

if.else177:                                       ; preds = %if.else169
  %56 = load i8, ptr %ou2170, align 8
...
for.inc190:                                       ; preds = %for.cond7, %if.end168, %if.else177, %if.then172, %sw.default, %if.end105, %for.end48
  ...
  br i1 %cmp4.not, label %for.end194, label %for.cond7.preheader

for.end194:                                       ; preds = %for.inc190
  %58 = icmp eq i32 %name_printed.3, 0
  br i1 %58, label %if.then196, label %if.end206
...
if.then196:                                       ; preds = %if.else, %for.end194
  ...
  %59 = and i24 %bf.load.i294, 65536
  %tobool.not.i295 = icmp eq i24 %59, 0
  br i1 %tobool.not.i295, label %land.lhs.true.i297, label %if.end206.sink.split

land.lhs.true.i297:                               ; preds = %if.then196
  %oenclosing.i298 = getelementptr inbounds %struct.symbol_type, ptr %0, i64 0, i32 3
  %60 = load ptr, ptr %oenclosing.i298, align 8
  %61 = load ptr, ptr @StartSym, align 8
  %cmp.not.i299 = icmp eq ptr %60, %61
  br i1 %cmp.not.i299, label %if.end206.sink.split, label %need_lvis.exit303

need_lvis.exit303:                                ; preds = %land.lhs.true.i297
  %ou1.i301 = getelementptr inbounds %struct.word_type, ptr %60, i64 0, i32 1
  %62 = load i8, ptr %ou1.i301, align 8
  %cmp2.i302.not = icmp eq i8 %62, -113
  br i1 %cmp2.i302.not, label %if.then199, label %if.end206.sink.split

if.then199:                                       ; preds = %need_lvis.exit303
  %63 = load ptr, ptr @last_write_fp, align 8
  %64 = tail call i64 @fwrite(ptr nonnull @.str.27, i64 3, i64 1, ptr %63)
  br label %if.end206.sink.split.sink.split

if.end206.sink.split.sink.split:                  ; preds = %if.then, %if.then199
  %65 = load ptr, ptr @last_write_fp, align 8
  %fputc = tail call i32 @fputc(i32 32, ptr %65)
  br label %if.end206.sink.split

if.end206.sink.split:                             ; preds = %if.end206.sink.split.sink.split, %need_lvis.exit303, %land.lhs.true.i297, %if.then196
  %call203 = tail call ptr @SymName(ptr noundef nonnull %0) #8
  %66 = load ptr, ptr @last_write_fp, align 8
  %call204 = tail call i32 @fputs(ptr noundef %call203, ptr noundef %66)
  br label %if.end206
...
for.cond.preheader:                               ; preds = %if.end
  ...
  %link.0136 = load ptr, ptr %link.0.in135, align 8
...
if.then25:                                        ; preds = %for.cond10
  ...
  %3 = load ptr, ptr %osucc28, align 8
  br label %for.cond32
...
if.then55:                                        ; preds = %for.cond32
  ...
  %tlink.0132 = load ptr, ptr %osucc58, align 8
...
for.body62:                                       ; preds = %if.then55, %for.inc88
  ...
  %5 = load ptr, ptr %osucc65, align 8
  br label %for.cond69
...
for.inc96:                                        ; preds = %for.cond10, %for.cond32, %for.inc88, %if.then55, %if.then49
  ...
  br i1 %cmp6.not, label %cleanup, label %for.cond10.preheader
...
cond.end.thread:                                  ; preds = %if.then2
  ...
  store ptr %call, ptr @zz_res, align 8
