; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z45.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z45.c"
...
if.end10:                                         ; preds = %if.then5, %if.end
  ...
  store ptr %call, ptr %lp.0, align 8
  %call12125 = tail call i32 @getc(ptr noundef %fp)
  %cmp13.not126 = icmp eq i32 %call12125, -1
  br i1 %cmp13.not126, label %while.end, label %while.body

while.body:                                       ; preds = %if.end10, %if.end69
  %call12134 = phi i32 [ %call12, %if.end69 ], [ %call12125, %if.end10 ]
  %buff.0133 = phi ptr [ %buff.1, %if.end69 ], [ %call, %if.end10 ]
  %lp.1132 = phi ptr [ %lp.3, %if.end69 ], [ %incdec.ptr11, %if.end10 ]
  %lines_top.0131 = phi ptr [ %lines_top.2, %if.end69 ], [ %arrayidx, %if.end10 ]
  %lines_length.0130 = phi i32 [ %lines_length.2, %if.end69 ], [ 2000, %if.end10 ]
  %lines.0129 = phi ptr [ %lines.2, %if.end69 ], [ %call2, %if.end10 ]
  %bp.0128 = phi ptr [ %bp.2, %if.end69 ], [ %call, %if.end10 ]
  %buff_top.0127 = phi ptr [ %buff_top.1, %if.end69 ], [ %add.ptr, %if.end10 ]
  %bp.0128142 = ptrtoint ptr %bp.0128 to i64
  %1 = ptrtoint ptr %buff.0133 to i64
  %2 = trunc i64 %1 to i32
  %3 = ptrtoint ptr %lines_top.0131 to i64
  %4 = trunc i64 %3 to i32
  %cmp15.not = icmp slt i32 %2, %4
  %5 = ptrtoint ptr %buff_top.0127 to i64
  %6 = trunc i64 %5 to i32
  %7 = ptrtoint ptr %lines.0129 to i64
...
if.end21:                                         ; preds = %if.then19, %while.body
  %cmp22 = icmp eq ptr %bp.0128, %buff_top.0127
...
if.then24:                                        ; preds = %if.end21
  ...
  %call25141 = ptrtoint ptr %call25 to i64
...
if.end30:                                         ; preds = %if.then28, %if.then24
  ...
  %add.ptr32 = getelementptr inbounds ptr, ptr %lp.1132, i64 -1
  %11 = load ptr, ptr %add.ptr32, align 8
  %cmp33.not120 = icmp eq ptr %11, %bp.0128
  br i1 %cmp33.not120, label %for.end.thread, label %for.inc.preheader

for.inc.preheader:                                ; preds = %if.end30
  %12 = ptrtoint ptr %11 to i64
  %13 = sub i64 %bp.0128142, %12
  %min.iters.check = icmp ult i64 %13, 32
  %14 = sub i64 %call25141, %12
  %diff.check = icmp ult i64 %14, 32
  %or.cond150 = or i1 %min.iters.check, %diff.check
  br i1 %or.cond150, label %for.inc.preheader151, label %vector.ph

vector.ph:                                        ; preds = %for.inc.preheader
  %n.vec = and i64 %13, -32
  %ind.end = getelementptr i8, ptr %call25, i64 %n.vec
  %ind.end143 = getelementptr i8, ptr %11, i64 %n.vec
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %next.gep = getelementptr i8, ptr %call25, i64 %index
  %next.gep147 = getelementptr i8, ptr %11, i64 %index
  %wide.load = load <16 x i8>, ptr %next.gep147, align 1
  %15 = getelementptr i8, ptr %next.gep147, i64 16
  %wide.load149 = load <16 x i8>, ptr %15, align 1
  store <16 x i8> %wide.load, ptr %next.gep, align 1
  %16 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load149, ptr %16, align 1
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.end, label %for.inc.preheader151

for.inc.preheader151:                             ; preds = %for.inc.preheader, %middle.block
  %p.0.ptr123.ph = phi ptr [ %call25, %for.inc.preheader ], [ %ind.end, %middle.block ]
  %q.0122.ph = phi ptr [ %11, %for.inc.preheader ], [ %ind.end143, %middle.block ]
  %p.0.idx121.ph = phi i64 [ 0, %for.inc.preheader ], [ %n.vec, %middle.block ]
  %q.0122.ph154 = ptrtoint ptr %q.0122.ph to i64
  %18 = sub i64 %bp.0128142, %q.0122.ph154
  %19 = xor i64 %q.0122.ph154, -1
  %20 = add i64 %19, %bp.0128142
  %xtraiter = and i64 %18, 7
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %for.inc.prol.loopexit, label %for.inc.prol

for.inc.prol:                                     ; preds = %for.inc.preheader151, %for.inc.prol
  %p.0.ptr123.prol = phi ptr [ %p.0.ptr.prol, %for.inc.prol ], [ %p.0.ptr123.ph, %for.inc.preheader151 ]
  %q.0122.prol = phi ptr [ %incdec.ptr35.prol, %for.inc.prol ], [ %q.0122.ph, %for.inc.preheader151 ]
  %p.0.idx121.prol = phi i64 [ %p.0.add.prol, %for.inc.prol ], [ %p.0.idx121.ph, %for.inc.preheader151 ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.inc.prol ], [ 0, %for.inc.preheader151 ]
  %incdec.ptr35.prol = getelementptr inbounds i8, ptr %q.0122.prol, i64 1
  %21 = load i8, ptr %q.0122.prol, align 1
  %p.0.add.prol = add nuw nsw i64 %p.0.idx121.prol, 1
  store i8 %21, ptr %p.0.ptr123.prol, align 1
  %p.0.ptr.prol = getelementptr inbounds i8, ptr %call25, i64 %p.0.add.prol
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.inc.prol.loopexit, label %for.inc.prol

for.inc.prol.loopexit:                            ; preds = %for.inc.prol, %for.inc.preheader151
  %p.0.add.lcssa153.unr = phi i64 [ undef, %for.inc.preheader151 ], [ %p.0.add.prol, %for.inc.prol ]
  %p.0.ptr.lcssa152.unr = phi ptr [ undef, %for.inc.preheader151 ], [ %p.0.ptr.prol, %for.inc.prol ]
  %p.0.ptr123.unr = phi ptr [ %p.0.ptr123.ph, %for.inc.preheader151 ], [ %p.0.ptr.prol, %for.inc.prol ]
  %q.0122.unr = phi ptr [ %q.0122.ph, %for.inc.preheader151 ], [ %incdec.ptr35.prol, %for.inc.prol ]
  %p.0.idx121.unr = phi i64 [ %p.0.idx121.ph, %for.inc.preheader151 ], [ %p.0.add.prol, %for.inc.prol ]
  %22 = icmp ult i64 %20, 7
  br i1 %22, label %for.end, label %for.inc

for.end.thread:                                   ; preds = %if.end30
  store i8 0, ptr %call25, align 1
  store ptr %call25, ptr %add.ptr32, align 8
  br label %if.end43

for.inc:                                          ; preds = %for.inc.prol.loopexit, %for.inc
  %p.0.ptr123 = phi ptr [ %p.0.ptr.7, %for.inc ], [ %p.0.ptr123.unr, %for.inc.prol.loopexit ]
  %q.0122 = phi ptr [ %incdec.ptr35.7, %for.inc ], [ %q.0122.unr, %for.inc.prol.loopexit ]
  %p.0.idx121 = phi i64 [ %p.0.add.7, %for.inc ], [ %p.0.idx121.unr, %for.inc.prol.loopexit ]
  %incdec.ptr35 = getelementptr inbounds i8, ptr %q.0122, i64 1
  %23 = load i8, ptr %q.0122, align 1
  %p.0.add = add nuw nsw i64 %p.0.idx121, 1
  store i8 %23, ptr %p.0.ptr123, align 1
  %p.0.ptr = getelementptr inbounds i8, ptr %call25, i64 %p.0.add
  %incdec.ptr35.1 = getelementptr inbounds i8, ptr %q.0122, i64 2
  %24 = load i8, ptr %incdec.ptr35, align 1
  %p.0.add.1 = add nuw nsw i64 %p.0.idx121, 2
  store i8 %24, ptr %p.0.ptr, align 1
  %p.0.ptr.1 = getelementptr inbounds i8, ptr %call25, i64 %p.0.add.1
  %incdec.ptr35.2 = getelementptr inbounds i8, ptr %q.0122, i64 3
  %25 = load i8, ptr %incdec.ptr35.1, align 1
  %p.0.add.2 = add nuw nsw i64 %p.0.idx121, 3
  store i8 %25, ptr %p.0.ptr.1, align 1
  %p.0.ptr.2 = getelementptr inbounds i8, ptr %call25, i64 %p.0.add.2
  %incdec.ptr35.3 = getelementptr inbounds i8, ptr %q.0122, i64 4
  %26 = load i8, ptr %incdec.ptr35.2, align 1
  %p.0.add.3 = add nuw nsw i64 %p.0.idx121, 4
  store i8 %26, ptr %p.0.ptr.2, align 1
  %p.0.ptr.3 = getelementptr inbounds i8, ptr %call25, i64 %p.0.add.3
  %incdec.ptr35.4 = getelementptr inbounds i8, ptr %q.0122, i64 5
  %27 = load i8, ptr %incdec.ptr35.3, align 1
  %p.0.add.4 = add nuw nsw i64 %p.0.idx121, 5
  store i8 %27, ptr %p.0.ptr.3, align 1
  %p.0.ptr.4 = getelementptr inbounds i8, ptr %call25, i64 %p.0.add.4
  %incdec.ptr35.5 = getelementptr inbounds i8, ptr %q.0122, i64 6
  %28 = load i8, ptr %incdec.ptr35.4, align 1
  %p.0.add.5 = add nuw nsw i64 %p.0.idx121, 6
  store i8 %28, ptr %p.0.ptr.4, align 1
  %p.0.ptr.5 = getelementptr inbounds i8, ptr %call25, i64 %p.0.add.5
  %incdec.ptr35.6 = getelementptr inbounds i8, ptr %q.0122, i64 7
  %29 = load i8, ptr %incdec.ptr35.5, align 1
  %p.0.add.6 = add nuw nsw i64 %p.0.idx121, 7
  store i8 %29, ptr %p.0.ptr.5, align 1
  %p.0.ptr.6 = getelementptr inbounds i8, ptr %call25, i64 %p.0.add.6
  %incdec.ptr35.7 = getelementptr inbounds i8, ptr %q.0122, i64 8
  %30 = load i8, ptr %incdec.ptr35.6, align 1
  %p.0.add.7 = add nuw nsw i64 %p.0.idx121, 8
  store i8 %30, ptr %p.0.ptr.6, align 1
  %p.0.ptr.7 = getelementptr inbounds i8, ptr %call25, i64 %p.0.add.7
  %cmp33.not.7 = icmp eq ptr %incdec.ptr35.7, %bp.0128
  br i1 %cmp33.not.7, label %for.end, label %for.inc

for.end:                                          ; preds = %for.inc.prol.loopexit, %for.inc, %middle.block
  %p.0.add.lcssa = phi i64 [ %n.vec, %middle.block ], [ %p.0.add.lcssa153.unr, %for.inc.prol.loopexit ], [ %p.0.add.7, %for.inc ]
  %p.0.ptr.lcssa = phi ptr [ %ind.end, %middle.block ], [ %p.0.ptr.lcssa152.unr, %for.inc.prol.loopexit ], [ %p.0.ptr.7, %for.inc ]
  store i8 0, ptr %p.0.ptr.lcssa, align 1
  store ptr %call25, ptr %add.ptr32, align 8
...
if.end43:                                         ; preds = %for.end.thread, %for.end, %if.then40, %if.end21
  %buff_top.1 = phi ptr [ %add.ptr31, %if.then40 ], [ %add.ptr31, %for.end ], [ %buff_top.0127, %if.end21 ], [ %add.ptr31, %for.end.thread ]
  %bp.1 = phi ptr [ %p.0.ptr.lcssa, %if.then40 ], [ %p.0.ptr.lcssa, %for.end ], [ %bp.0128, %if.end21 ], [ %call25, %for.end.thread ]
  %buff.1 = phi ptr [ %call25, %if.then40 ], [ %call25, %for.end ], [ %buff.0133, %if.end21 ], [ %call25, %for.end.thread ]
  %cmp44 = icmp eq i32 %call12134, 10
  br i1 %cmp44, label %if.then46, label %if.else

if.then46:                                        ; preds = %if.end43
  %incdec.ptr47 = getelementptr inbounds i8, ptr %bp.1, i64 1
  store i8 0, ptr %bp.1, align 1
  %cmp48 = icmp eq ptr %lp.1132, %lines_top.0131
  br i1 %cmp48, label %if.then50, label %if.end65

if.then50:                                        ; preds = %if.then46
  %mul51 = shl nsw i32 %lines_length.0130, 1
  %conv52 = sext i32 %mul51 to i64
  %mul53 = shl nsw i64 %conv52, 3
  %call54 = tail call ptr @realloc(ptr noundef %lines.0129, i64 noundef %mul53) #15
...
if.end59:                                         ; preds = %if.then57, %if.then50
  %idxprom60 = sext i32 %lines_length.0130 to i64
...
if.end65:                                         ; preds = %if.end59, %if.then46
  %lines.1 = phi ptr [ %call54, %if.end59 ], [ %lines.0129, %if.then46 ]
  %lines_length.1 = phi i32 [ %mul51, %if.end59 ], [ %lines_length.0130, %if.then46 ]
  %lines_top.1 = phi ptr [ %arrayidx64, %if.end59 ], [ %lines_top.0131, %if.then46 ]
  %lp.2 = phi ptr [ %arrayidx61, %if.end59 ], [ %lp.1132, %if.then46 ]
  %incdec.ptr66 = getelementptr inbounds ptr, ptr %lp.2, i64 1
  store ptr %incdec.ptr47, ptr %lp.2, align 8
  br label %if.end69

if.else:                                          ; preds = %if.end43
  %conv67 = trunc i32 %call12134 to i8
  %incdec.ptr68 = getelementptr inbounds i8, ptr %bp.1, i64 1
  store i8 %conv67, ptr %bp.1, align 1
  br label %if.end69

if.end69:                                         ; preds = %if.else, %if.end65
  %bp.2 = phi ptr [ %incdec.ptr47, %if.end65 ], [ %incdec.ptr68, %if.else ]
  %lines.2 = phi ptr [ %lines.1, %if.end65 ], [ %lines.0129, %if.else ]
  %lines_length.2 = phi i32 [ %lines_length.1, %if.end65 ], [ %lines_length.0130, %if.else ]
  %lines_top.2 = phi ptr [ %lines_top.1, %if.end65 ], [ %lines_top.0131, %if.else ]
  %lp.3 = phi ptr [ %incdec.ptr66, %if.end65 ], [ %lp.1132, %if.else ]
...
while.end:                                        ; preds = %if.end69, %if.end10
  ...
  %conv70 = add i32 %34, -1
  store i32 %conv70, ptr %len, align 4
...
entry:
  ...
  %0 = load i32, ptr @UseCollate, align 4
...
if.end6:                                          ; preds = %if.then4, %if.end
  ...
  %2 = load i32, ptr %lines_len, align 4
  %conv.i = sext i32 %2 to i64
  %3 = load i32, ptr @UseCollate, align 4
...
for.body.i:                                       ; preds = %for.body.i, %for.body.preheader.i
  ...
  br i1 %exitcond.not.i, label %WriteLines.exit, label %for.body.i
