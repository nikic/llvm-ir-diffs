...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %next.gep147, align 1, !tbaa !9
  %15 = getelementptr i8, ptr %next.gep147, i64 16
  %wide.load149 = load <16 x i8>, ptr %15, align 1, !tbaa !9
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !9
  %16 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load149, ptr %16, align 1, !tbaa !9
...
for.inc.prol:                                     ; preds = %for.inc.preheader151, %for.inc.prol
  ...
  %21 = load i8, ptr %q.0122.prol, align 1, !tbaa !9
  %p.0.add.prol = add nuw nsw i64 %p.0.idx121.prol, 1
  store i8 %21, ptr %p.0.ptr123.prol, align 1, !tbaa !9
...
for.inc:                                          ; preds = %for.inc.prol.loopexit, %for.inc
  ...
  %23 = load i8, ptr %q.0122, align 1, !tbaa !9
  %p.0.add = add nuw nsw i64 %p.0.idx121, 1
  store i8 %23, ptr %p.0.ptr123, align 1, !tbaa !9
