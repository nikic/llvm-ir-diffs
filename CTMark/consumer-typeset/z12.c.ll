; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z12.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z12.c"
...
if.end:                                           ; preds = %entry, %if.then
  ...
  %slink.0197 = load ptr, ptr %slink.0.in196, align 8
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.cond15
  ...
  %2 = load i8, ptr %ou116, align 8
  %cmp19 = icmp eq i8 %2, 0
  br i1 %cmp19, label %for.cond15, label %for.end
...
for.cond36:                                       ; preds = %for.cond36, %for.end
  ...
  %thr.0 = load ptr, ptr %thr.0.in, align 8
  %ou137 = getelementptr inbounds %struct.word_type, ptr %thr.0, i64 0, i32 1
  %3 = load i8, ptr %ou137, align 8
  %cmp40 = icmp eq i8 %3, 0
  br i1 %cmp40, label %for.cond36, label %for.end47
...
if.then53:                                        ; preds = %for.end47
  ...
  %4 = load i8, ptr %ocross_type, align 1
...
if.then62:                                        ; preds = %if.end59
  ...
  %6 = load i32, ptr %arrayidx63, align 4
...
for.cond.i:                                       ; preds = %for.cond.i, %if.else67
  ...
  %x.0.i = load ptr, ptr %x.0.in.i, align 8
  %ou1.i = getelementptr inbounds %struct.word_type, ptr %x.0.i, i64 0, i32 1
  %8 = load i8, ptr %ou1.i, align 8
  %cmp6.i = icmp eq i8 %8, 0
  br i1 %cmp6.i, label %for.cond.i, label %while.cond.preheader.i
...
land.rhs.thread.us.i:                             ; preds = %while.cond.us.i
  ...
  %10 = load ptr, ptr %osucc26180.us.i, align 8
...
land.rhs.us.i:                                    ; preds = %lor.lhs.false.us.i
  ...
  %13 = load ptr, ptr %osucc26.us.i, align 8
...
for.cond44.us.i:                                  ; preds = %for.cond44.us.i, %while.body.us.i
  ...
  %x.2.us.i = load ptr, ptr %x.2.in.us.i, align 8
  %ou145.us.i = getelementptr inbounds %struct.word_type, ptr %x.2.us.i, i64 0, i32 1
  %15 = load i8, ptr %ou145.us.i, align 8
  %cmp48.us.i = icmp eq i8 %15, 0
  br i1 %cmp48.us.i, label %for.cond44.us.i, label %while.cond.loopexit.us.i
...
land.rhs.i:                                       ; preds = %lor.lhs.false.i
  ...
  %19 = load ptr, ptr %osucc26.i, align 8
...
land.rhs.thread.i:                                ; preds = %while.cond.i
  ...
  %20 = load ptr, ptr %osucc26180.i, align 8
...
for.cond75.i:                                     ; preds = %for.cond75.i.preheader, %for.cond75.i
  ...
  %23 = load i8, ptr %ou176.i, align 8
...
if.then92.i:                                      ; preds = %for.cond75.i
  %24 = load ptr, ptr @no_fpos, align 8
...
for.cond117.i:                                    ; preds = %land.lhs.true101.i, %for.cond117.i
  ...
  %28 = load i8, ptr %ou1118.i, align 8
...
if.then134.i:                                     ; preds = %for.cond117.i
  %29 = load ptr, ptr @no_fpos, align 8
...
if.then69:                                        ; preds = %for.cond75.i, %if.end136.i, %if.then92.i
  ...
  %31 = load i32, ptr %arrayidx77, align 4
  ...
  %32 = load i32, ptr %arrayidx81, align 4
  ...
  %33 = load i32, ptr %arrayidx81, align 4
  br label %if.end117

if.else87:                                        ; preds = %land.lhs.true101.i, %land.lhs.true98.i, %if.else.i
  %34 = load i8, ptr %ou116.le, align 8
  ...
  %37 = load i32, ptr %arrayidx107, align 4
  br label %if.end117
...
if.end117:                                        ; preds = %if.then62, %if.else87, %if.then69, %if.else110
  ...
  %slink.0 = load ptr, ptr %slink.0.in, align 8
  %cmp11.not = icmp eq ptr %slink.0, %y
  br i1 %cmp11.not, label %for.end122, label %for.cond15.preheader
...
for.end122:                                       ; preds = %if.end117, %if.end
  ...
  store i32 %b.0.lcssa, ptr %resb, align 4
  store i32 %f.0.lcssa, ptr %resf, align 4
  ...
  store i32 %add123, ptr %obfc, align 4
...
if.end24:                                         ; preds = %if.then15, %if.else17
  ...
  store ptr %6, ptr %arrayidx30, align 8
  %osucc36 = getelementptr inbounds %struct.LIST, ptr %6, i64 0, i32 1
  store ptr %6, ptr %osucc36, align 8
  store ptr %6, ptr %6, align 8
  %oactual = getelementptr inbounds %struct.closure_type, ptr %6, i64 0, i32 5
  store ptr %x, ptr %oactual, align 8
  %8 = load i8, ptr @zz_lengths, align 1
  %conv40 = zext i8 %8 to i32
  store i32 %conv40, ptr @zz_size, align 4
...
if.else53:                                        ; preds = %if.end24
  ...
  store ptr %11, ptr %arrayidx48, align 8
  br label %cond.end104
...
cond.end104:                                      ; preds = %if.then51, %if.else53
  ...
  store ptr %15, ptr %osucc97, align 8
  ...
  store ptr %19, ptr %osucc103, align 8
  %21 = load ptr, ptr @xx_link, align 8
...
if.then150:                                       ; preds = %cond.end137
  ...
  store ptr %call151, ptr @zz_hold, align 8
  br label %if.end161

if.else152:                                       ; preds = %cond.end137
  store ptr %26, ptr @zz_hold, align 8
  %28 = load ptr, ptr %26, align 8
  store ptr %28, ptr %arrayidx147, align 8
  br label %if.end161
...
if.end161:                                        ; preds = %if.then150, %if.else152
  ...
  store i8 0, ptr %ou1162, align 8
  %osucc166 = getelementptr inbounds [2 x %struct.LIST], ptr %29, i64 0, i64 1, i32 1
  store ptr %29, ptr %osucc166, align 8
  %arrayidx168 = getelementptr inbounds [2 x %struct.LIST], ptr %29, i64 0, i64 1
  store ptr %29, ptr %arrayidx168, align 8
  %osucc172 = getelementptr inbounds %struct.LIST, ptr %29, i64 0, i32 1
  store ptr %29, ptr %osucc172, align 8
  store ptr %29, ptr %29, align 8
  store ptr %29, ptr @xx_link, align 8
  store ptr %29, ptr @zz_res, align 8
  %30 = load ptr, ptr %extras, align 8
...
cond.end207:                                      ; preds = %if.end161
  ...
  store ptr %31, ptr @zz_tmp, align 8
...
cond.end207.cond.false216_crit_edge:              ; preds = %cond.end207
  ...
  %.pre9459 = load ptr, ptr %arrayidx221.phi.trans.insert, align 8
  br label %cond.false216
...
cond.false216:                                    ; preds = %cond.end207.cond.false216_crit_edge, %cond.end207.thread
  ...
  store ptr %41, ptr @zz_tmp, align 8
  ...
  store ptr %6, ptr %osucc231, align 8
  store ptr %41, ptr %arrayidx221, align 8
  %osucc237 = getelementptr inbounds [2 x %struct.LIST], ptr %41, i64 0, i64 1, i32 1
  store ptr %40, ptr %osucc237, align 8
  br label %if.end242
...
if.end242:                                        ; preds = %cond.end207, %cond.false216, %sw.bb2
  ...
  store i32 0, ptr %arrayidx247, align 4
  br label %sw.epilog7697
...
if.then251:                                       ; preds = %sw.bb248
  %43 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 135), align 1
  %conv252 = zext i8 %43 to i32
  store i32 %conv252, ptr @zz_size, align 4
  %conv253 = zext i8 %43 to i64
  %arrayidx260 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv253
  %44 = load ptr, ptr %arrayidx260, align 8
...
if.then263:                                       ; preds = %if.then251
  ...
  store ptr %call264, ptr @zz_hold, align 8
  br label %if.end274

if.else265:                                       ; preds = %if.then251
  store ptr %44, ptr @zz_hold, align 8
  %46 = load ptr, ptr %44, align 8
  store ptr %46, ptr %arrayidx260, align 8
  br label %if.end274
...
if.end274:                                        ; preds = %if.then263, %if.else265
  ...
  store i8 -121, ptr %ou1275, align 8
...
if.else303:                                       ; preds = %if.end274
  ...
  store ptr %51, ptr %arrayidx298, align 8
  br label %cond.end358
...
cond.end358:                                      ; preds = %if.then301, %if.else303
  ...
  store ptr %55, ptr %osucc349, align 8
  ...
  store ptr %59, ptr %osucc355, align 8
...
if.then404:                                       ; preds = %cond.end391
  ...
  store ptr %call405, ptr @zz_hold, align 8
  br label %if.end415

if.else406:                                       ; preds = %cond.end391
  store ptr %66, ptr @zz_hold, align 8
  %68 = load ptr, ptr %66, align 8
  store ptr %68, ptr %arrayidx401, align 8
  br label %if.end415
...
cond.end461:                                      ; preds = %if.end415
  ...
  store ptr %73, ptr %osucc452, align 8
  ...
  store ptr %77, ptr %osucc458, align 8
  %.pr9125 = load ptr, ptr @xx_link, align 8
  store ptr %.pr9125, ptr @zz_res, align 8
  store ptr %47, ptr @zz_hold, align 8
...
cond.end461.cond.false470_crit_edge:              ; preds = %cond.end461
  ...
  %.pre9458 = load ptr, ptr %arrayidx475.phi.trans.insert, align 8
  br label %cond.false470
...
sw.bb505:                                         ; preds = %entry
  ...
  store i32 0, ptr %arrayidx509, align 4
...
if.then517:                                       ; preds = %sw.bb514
  %83 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 5), align 1
...
if.end540:                                        ; preds = %if.then529, %if.else531
  ...
  %89 = load ptr, ptr %osucc573, align 8
...
cond.false608:                                    ; preds = %if.end540
  %90 = load ptr, ptr %arrayidx572, align 8
  %arrayidx585 = getelementptr inbounds [2 x %struct.LIST], ptr %89, i64 0, i64 1
  store ptr %90, ptr %arrayidx585, align 8
  %91 = load ptr, ptr %arrayidx572, align 8
  %osucc592 = getelementptr inbounds [2 x %struct.LIST], ptr %91, i64 0, i64 1, i32 1
  store ptr %89, ptr %osucc592, align 8
  store ptr %x, ptr %osucc573, align 8
  store ptr %x, ptr %arrayidx572, align 8
  store ptr %89, ptr @xx_tmp, align 8
  store ptr %87, ptr @zz_res, align 8
  store ptr %89, ptr @zz_hold, align 8
  %92 = load ptr, ptr %arrayidx585, align 8
  store ptr %92, ptr @zz_tmp, align 8
  %93 = load ptr, ptr %arrayidx547, align 8
  store ptr %93, ptr %arrayidx585, align 8
  %94 = load ptr, ptr %arrayidx547, align 8
  %osucc623 = getelementptr inbounds [2 x %struct.LIST], ptr %94, i64 0, i64 1, i32 1
  store ptr %89, ptr %osucc623, align 8
  store ptr %92, ptr %arrayidx547, align 8
  %osucc629 = getelementptr inbounds [2 x %struct.LIST], ptr %92, i64 0, i64 1, i32 1
  store ptr %87, ptr %osucc629, align 8
  br label %cond.end632
...
cond.end632:                                      ; preds = %cond.end599.thread, %cond.false608
  ...
  %95 = load ptr, ptr %oactual634, align 8
...
for.cond:                                         ; preds = %for.cond, %if.end665
  ...
  %105 = load i8, ptr %ou1688, align 8
  %cmp691 = icmp eq i8 %105, 0
  br i1 %cmp691, label %for.cond, label %for.end

for.end:                                          ; preds = %for.cond
  %oux696 = getelementptr inbounds %struct.closure_type, ptr %x, i64 0, i32 6
  %106 = load ptr, ptr %oux696, align 8
  ...
  store ptr %call700, ptr %oactual701, align 8
  %107 = load i8, ptr @zz_lengths, align 1
  %conv702 = zext i8 %107 to i32
  store i32 %conv702, ptr @zz_size, align 4
  %conv703 = zext i8 %107 to i64
  %arrayidx710 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv703
  %108 = load ptr, ptr %arrayidx710, align 8
...
if.then713:                                       ; preds = %for.end
  ...
  store ptr %call714, ptr @zz_hold, align 8
  br label %if.end724

if.else715:                                       ; preds = %for.end
  store ptr %108, ptr @zz_hold, align 8
  %110 = load ptr, ptr %108, align 8
  store ptr %110, ptr %arrayidx710, align 8
  br label %if.end724
...
cond.end770:                                      ; preds = %if.end724
  ...
  store ptr %113, ptr @zz_tmp, align 8
  %114 = load ptr, ptr %111, align 8
  store ptr %114, ptr %112, align 8
  %115 = load ptr, ptr @zz_hold, align 8
  %116 = load ptr, ptr @zz_res, align 8
  %117 = load ptr, ptr %116, align 8
  %osucc761 = getelementptr inbounds %struct.LIST, ptr %117, i64 0, i32 1
  store ptr %115, ptr %osucc761, align 8
  %118 = load ptr, ptr @zz_tmp, align 8
  store ptr %118, ptr %116, align 8
  %119 = load ptr, ptr @zz_res, align 8
  %120 = load ptr, ptr @zz_tmp, align 8
  %osucc767 = getelementptr inbounds %struct.LIST, ptr %120, i64 0, i32 1
  store ptr %119, ptr %osucc767, align 8
  %.pr9129 = load ptr, ptr @xx_link, align 8
  store ptr %.pr9129, ptr @zz_res, align 8
  store ptr %102, ptr @zz_hold, align 8
...
cond.end770.cond.false779_crit_edge:              ; preds = %cond.end770
  ...
  %.pre9456 = load ptr, ptr %arrayidx784.phi.trans.insert, align 8
  br label %cond.false779
...
if.end829:                                        ; preds = %if.then818, %if.else820
  ...
  store i8 120, ptr %ou1830, align 8
...
cond.false921:                                    ; preds = %cond.end912
  %144 = load ptr, ptr %arrayidx572, align 8
  store ptr %144, ptr @zz_tmp, align 8
  %arrayidx926 = getelementptr inbounds [2 x %struct.LIST], ptr %143, i64 0, i64 1
  %145 = load ptr, ptr %arrayidx926, align 8
  store ptr %145, ptr %arrayidx572, align 8
  %146 = load ptr, ptr %arrayidx926, align 8
  %osucc936 = getelementptr inbounds [2 x %struct.LIST], ptr %146, i64 0, i64 1, i32 1
  store ptr %x, ptr %osucc936, align 8
  store ptr %144, ptr %arrayidx926, align 8
  %osucc942 = getelementptr inbounds [2 x %struct.LIST], ptr %144, i64 0, i64 1, i32 1
  store ptr %143, ptr %osucc942, align 8
...
cond.end945:                                      ; preds = %cond.end912, %cond.false921
  ...
  store ptr %87, ptr %oux947, align 8
  %147 = load i8, ptr @zz_lengths, align 1
  %conv948 = zext i8 %147 to i32
  store i32 %conv948, ptr @zz_size, align 4
  %conv949 = zext i8 %147 to i64
  %arrayidx956 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv949
  %148 = load ptr, ptr %arrayidx956, align 8
...
if.then959:                                       ; preds = %cond.end945
  ...
  store ptr %call960, ptr @zz_hold, align 8
  br label %if.end970

if.else961:                                       ; preds = %cond.end945
  store ptr %148, ptr @zz_hold, align 8
  %150 = load ptr, ptr %148, align 8
  store ptr %150, ptr %arrayidx956, align 8
  br label %if.end970
...
if.end970:                                        ; preds = %if.then959, %if.else961
  ...
  store i8 0, ptr %ou1971, align 8
  %osucc975 = getelementptr inbounds [2 x %struct.LIST], ptr %151, i64 0, i64 1, i32 1
  store ptr %151, ptr %osucc975, align 8
  %arrayidx977 = getelementptr inbounds [2 x %struct.LIST], ptr %151, i64 0, i64 1
  store ptr %151, ptr %arrayidx977, align 8
  %osucc981 = getelementptr inbounds %struct.LIST, ptr %151, i64 0, i32 1
  store ptr %151, ptr %osucc981, align 8
  store ptr %151, ptr %151, align 8
  store ptr %151, ptr @xx_link, align 8
  store ptr %151, ptr @zz_res, align 8
  %152 = load ptr, ptr %extras, align 8
  store ptr %152, ptr @zz_hold, align 8
...
cond.end1016:                                     ; preds = %if.end970
  ...
  store ptr %153, ptr @zz_tmp, align 8
  %154 = load ptr, ptr %151, align 8
  store ptr %154, ptr %152, align 8
  %155 = load ptr, ptr @zz_hold, align 8
  %156 = load ptr, ptr @zz_res, align 8
  %157 = load ptr, ptr %156, align 8
  %osucc1007 = getelementptr inbounds %struct.LIST, ptr %157, i64 0, i32 1
  store ptr %155, ptr %osucc1007, align 8
  %158 = load ptr, ptr @zz_tmp, align 8
  store ptr %158, ptr %156, align 8
  %159 = load ptr, ptr @zz_res, align 8
  %160 = load ptr, ptr @zz_tmp, align 8
  %osucc1013 = getelementptr inbounds %struct.LIST, ptr %160, i64 0, i32 1
  store ptr %159, ptr %osucc1013, align 8
  %.pr9131 = load ptr, ptr @xx_link, align 8
  store ptr %.pr9131, ptr @zz_res, align 8
  store ptr %129, ptr @zz_hold, align 8
...
cond.end1016.cond.false1025_crit_edge:            ; preds = %cond.end1016
  ...
  %.pre9457 = load ptr, ptr %arrayidx1030.phi.trans.insert, align 8
  br label %cond.false1025
...
cond.false1025:                                   ; preds = %cond.end1016.cond.false1025_crit_edge, %cond.end1016.thread
  ...
  %163 = load ptr, ptr %arrayidx833, align 8
  store ptr %163, ptr @zz_tmp, align 8
  %arrayidx1030 = getelementptr inbounds [2 x %struct.LIST], ptr %162, i64 0, i64 1
  store ptr %161, ptr %arrayidx833, align 8
  %164 = load ptr, ptr %arrayidx1030, align 8
  %osucc1040 = getelementptr inbounds [2 x %struct.LIST], ptr %164, i64 0, i64 1, i32 1
  store ptr %129, ptr %osucc1040, align 8
  store ptr %163, ptr %arrayidx1030, align 8
  %osucc1046 = getelementptr inbounds [2 x %struct.LIST], ptr %163, i64 0, i64 1, i32 1
  store ptr %162, ptr %osucc1046, align 8
  br label %if.end1051
...
if.end1051:                                       ; preds = %cond.end1016, %cond.false1025, %cond.end803
  ...
  store i32 0, ptr %ofwd1053, align 8
  store i32 0, ptr %ou31052, align 8
  br label %if.end1067
...
if.then1084:                                      ; preds = %sw.bb1076
  %167 = load ptr, ptr @no_fpos, align 8
...
if.then1089:                                      ; preds = %if.end1086
  %168 = load ptr, ptr %oactual1077, align 8
...
if.then1097:                                      ; preds = %if.then1089
  %170 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 121), align 1
  %conv1098 = zext i8 %170 to i32
  store i32 %conv1098, ptr @zz_size, align 4
  %conv1099 = zext i8 %170 to i64
  %arrayidx1106 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv1099
  %171 = load ptr, ptr %arrayidx1106, align 8
...
if.then1109:                                      ; preds = %if.then1097
  ...
  store ptr %call1110, ptr @zz_hold, align 8
  br label %if.end1120

if.else1111:                                      ; preds = %if.then1097
  store ptr %171, ptr @zz_hold, align 8
  %173 = load ptr, ptr %171, align 8
  store ptr %173, ptr %arrayidx1106, align 8
  br label %if.end1120
...
if.end1120:                                       ; preds = %if.then1109, %if.else1111
  ...
  store i8 121, ptr %ou11121, align 8
...
if.then1147:                                      ; preds = %if.end1120
  ...
  store ptr %call1148, ptr @zz_hold, align 8
  br label %if.end1158

if.else1149:                                      ; preds = %if.end1120
  store ptr %176, ptr @zz_hold, align 8
  %178 = load ptr, ptr %176, align 8
  store ptr %178, ptr %arrayidx1144, align 8
  br label %if.end1158
...
if.end1158:                                       ; preds = %if.then1147, %if.else1149
  ...
  store i8 0, ptr %ou11159, align 8
  %osucc1163 = getelementptr inbounds [2 x %struct.LIST], ptr %179, i64 0, i64 1, i32 1
  store ptr %179, ptr %osucc1163, align 8
  %arrayidx1165 = getelementptr inbounds [2 x %struct.LIST], ptr %179, i64 0, i64 1
  store ptr %179, ptr %arrayidx1165, align 8
  %osucc1169 = getelementptr inbounds %struct.LIST, ptr %179, i64 0, i32 1
  store ptr %179, ptr %osucc1169, align 8
  store ptr %179, ptr %179, align 8
  store ptr %179, ptr @xx_link, align 8
  store ptr %179, ptr @zz_res, align 8
  %180 = load ptr, ptr %extras, align 8
  store ptr %180, ptr @zz_hold, align 8
...
cond.end1204.thread:                              ; preds = %if.end1158
  store ptr %179, ptr @zz_res, align 8
  store ptr %174, ptr @zz_hold, align 8
  br label %cond.false1213

cond.end1204:                                     ; preds = %if.end1158
  %181 = load ptr, ptr %180, align 8
  store ptr %181, ptr @zz_tmp, align 8
  %182 = load ptr, ptr %179, align 8
  store ptr %182, ptr %180, align 8
  %183 = load ptr, ptr @zz_hold, align 8
  %184 = load ptr, ptr @zz_res, align 8
  %185 = load ptr, ptr %184, align 8
  %osucc1195 = getelementptr inbounds %struct.LIST, ptr %185, i64 0, i32 1
  store ptr %183, ptr %osucc1195, align 8
  %186 = load ptr, ptr @zz_tmp, align 8
  store ptr %186, ptr %184, align 8
  %187 = load ptr, ptr @zz_res, align 8
  %188 = load ptr, ptr @zz_tmp, align 8
  %osucc1201 = getelementptr inbounds %struct.LIST, ptr %188, i64 0, i32 1
  store ptr %187, ptr %osucc1201, align 8
  %.pr9133 = load ptr, ptr @xx_link, align 8
  store ptr %.pr9133, ptr @zz_res, align 8
  store ptr %174, ptr @zz_hold, align 8
...
cond.end1204.cond.false1213_crit_edge:            ; preds = %cond.end1204
  ...
  %.pre9454 = load ptr, ptr %arrayidx1218.phi.trans.insert, align 8
  br label %cond.false1213
...
cond.false1213:                                   ; preds = %cond.end1204.cond.false1213_crit_edge, %cond.end1204.thread
  ...
  %191 = load ptr, ptr %arrayidx1124, align 8
  store ptr %191, ptr @zz_tmp, align 8
  %arrayidx1218 = getelementptr inbounds [2 x %struct.LIST], ptr %190, i64 0, i64 1
  store ptr %189, ptr %arrayidx1124, align 8
  %192 = load ptr, ptr %arrayidx1218, align 8
  %osucc1228 = getelementptr inbounds [2 x %struct.LIST], ptr %192, i64 0, i64 1, i32 1
  store ptr %174, ptr %osucc1228, align 8
  store ptr %191, ptr %arrayidx1218, align 8
  %osucc1234 = getelementptr inbounds [2 x %struct.LIST], ptr %191, i64 0, i64 1, i32 1
  store ptr %190, ptr %osucc1234, align 8
  br label %if.end1404
...
if.end1270:                                       ; preds = %if.then1259, %if.else1261
  ...
  store i8 123, ptr %ou11271, align 8
...
if.end1308:                                       ; preds = %if.then1297, %if.else1299
  ...
  store i8 0, ptr %ou11309, align 8
  %osucc1313 = getelementptr inbounds [2 x %struct.LIST], ptr %203, i64 0, i64 1, i32 1
  store ptr %203, ptr %osucc1313, align 8
  %arrayidx1315 = getelementptr inbounds [2 x %struct.LIST], ptr %203, i64 0, i64 1
  store ptr %203, ptr %arrayidx1315, align 8
  %osucc1319 = getelementptr inbounds %struct.LIST, ptr %203, i64 0, i32 1
  store ptr %203, ptr %osucc1319, align 8
  store ptr %203, ptr %203, align 8
  store ptr %203, ptr @xx_link, align 8
  store ptr %203, ptr @zz_res, align 8
  %204 = load ptr, ptr %extras, align 8
  store ptr %204, ptr @zz_hold, align 8
...
cond.end1354:                                     ; preds = %if.end1308
  ...
  store ptr %205, ptr @zz_tmp, align 8
  %206 = load ptr, ptr %203, align 8
  store ptr %206, ptr %204, align 8
  %207 = load ptr, ptr @zz_hold, align 8
  %208 = load ptr, ptr @zz_res, align 8
  %209 = load ptr, ptr %208, align 8
  %osucc1345 = getelementptr inbounds %struct.LIST, ptr %209, i64 0, i32 1
  store ptr %207, ptr %osucc1345, align 8
  %210 = load ptr, ptr @zz_tmp, align 8
  store ptr %210, ptr %208, align 8
  %211 = load ptr, ptr @zz_res, align 8
  %212 = load ptr, ptr @zz_tmp, align 8
  %osucc1351 = getelementptr inbounds %struct.LIST, ptr %212, i64 0, i32 1
  store ptr %211, ptr %osucc1351, align 8
  %.pr9135 = load ptr, ptr @xx_link, align 8
  store ptr %.pr9135, ptr @zz_res, align 8
  store ptr %198, ptr @zz_hold, align 8
...
cond.end1354.cond.false1363_crit_edge:            ; preds = %cond.end1354
  ...
  %.pre9455 = load ptr, ptr %arrayidx1368.phi.trans.insert, align 8
  br label %cond.false1363
...
cond.false1363:                                   ; preds = %cond.end1354.cond.false1363_crit_edge, %cond.end1354.thread
  ...
  %215 = load ptr, ptr %arrayidx1274, align 8
  store ptr %215, ptr @zz_tmp, align 8
  %arrayidx1368 = getelementptr inbounds [2 x %struct.LIST], ptr %214, i64 0, i64 1
  store ptr %213, ptr %arrayidx1274, align 8
  %216 = load ptr, ptr %arrayidx1368, align 8
  %osucc1378 = getelementptr inbounds [2 x %struct.LIST], ptr %216, i64 0, i64 1, i32 1
  store ptr %198, ptr %osucc1378, align 8
  store ptr %215, ptr %arrayidx1368, align 8
  %osucc1384 = getelementptr inbounds [2 x %struct.LIST], ptr %215, i64 0, i64 1, i32 1
  store ptr %214, ptr %osucc1384, align 8
  br label %if.end1404
...
for.cond1420:                                     ; preds = %for.cond1420, %sw.bb1413
  ...
  %219 = load i8, ptr %ou11421, align 8
  %cmp1424 = icmp eq i8 %219, 0
  br i1 %cmp1424, label %for.cond1420, label %for.end1431
...
for.end1431:                                      ; preds = %for.cond1420
  ...
  %220 = load i32, ptr %arrayidx1436, align 4
  ...
  store i32 %220, ptr %arrayidx1440, align 4
  ...
  %221 = load i32, ptr %arrayidx1444, align 4
...
for.cond1456:                                     ; preds = %for.cond1456, %sw.bb1449
  ...
  %223 = load i8, ptr %ou11457, align 8
  %cmp1460 = icmp eq i8 %223, 0
  br i1 %cmp1460, label %for.cond1456, label %for.end1467
...
for.cond1475:                                     ; preds = %for.cond1475, %for.end1467
  ...
  %225 = load i8, ptr %ou11476, align 8
  %cmp1479 = icmp eq i8 %225, 0
  br i1 %cmp1479, label %for.cond1475, label %for.end1486
...
for.end1486:                                      ; preds = %for.cond1475
  ...
  %226 = load i32, ptr %arrayidx1491, align 4
  ...
  store i32 %226, ptr %arrayidx1495, align 4
  ...
  %227 = load i32, ptr %arrayidx1499, align 4
  ...
  store i32 %227, ptr %arrayidx1503, align 4
  br label %sw.epilog7697
...
if.end.i:                                         ; preds = %land.lhs.true, %lor.lhs.false1515
  ...
  %228 = load ptr, ptr %osucc.i, align 8
  br label %for.cond.i
...
for.cond.i:                                       ; preds = %for.cond.i, %if.end.i
  ...
  %spanobj.0.i = load ptr, ptr %spanobj.0.in.i, align 8
  %ou115.i = getelementptr inbounds %struct.word_type, ptr %spanobj.0.i, i64 0, i32 1
  %229 = load i8, ptr %ou115.i, align 8
  %cmp18.i = icmp eq i8 %229, 0
  br i1 %cmp18.i, label %for.cond.i, label %for.end.i
...
for.end.i:                                        ; preds = %for.cond.i
  ...
  %230 = load ptr, ptr %osucc25.i, align 8
  %231 = load ptr, ptr %arrayidx24.i, align 8
  %cmp29.i = icmp eq ptr %230, %231
  br i1 %cmp29.i, label %if.end33.i, label %if.then31.i

if.then31.i:                                      ; preds = %for.end.i
  %232 = load ptr, ptr @no_fpos, align 8
...
if.then131.i:                                     ; preds = %cond.end91.i, %cond.end91.i
  ...
  %248 = load ptr, ptr %osucc134.i, align 8
...
for.cond138.i:                                    ; preds = %for.cond138.i, %if.then131.i
  ...
  %hprnt.0.i = load ptr, ptr %hprnt.0.in.i, align 8
  %ou1139.i = getelementptr inbounds %struct.word_type, ptr %hprnt.0.i, i64 0, i32 1
  %249 = load i8, ptr %ou1139.i, align 8
...
if.end184.i:                                      ; preds = %if.else175.i, %if.then173.i
  ...
  store i8 13, ptr %ou1185.i, align 8
...
if.else231.i:                                     ; preds = %if.end184.i
  store ptr %257, ptr @zz_hold, align 8
  %259 = load ptr, ptr %257, align 8
  store ptr %259, ptr %arrayidx226.i, align 8
  br label %cond.end286.i
...
if.else334.i:                                     ; preds = %cond.end319.i
  store ptr %274, ptr @zz_hold, align 8
  %276 = load ptr, ptr %274, align 8
  store ptr %276, ptr %arrayidx329.i, align 8
  br label %cond.end389.i
...
cond.end389.i:                                    ; preds = %if.else334.i, %if.then332.i
  ...
  store i8 0, ptr %ou1344.i, align 8
  %osucc348.i = getelementptr inbounds [2 x %struct.LIST], ptr %277, i64 0, i64 1, i32 1
  store ptr %277, ptr %osucc348.i, align 8
  %arrayidx350.i = getelementptr inbounds [2 x %struct.LIST], ptr %277, i64 0, i64 1
  store ptr %277, ptr %arrayidx350.i, align 8
  %osucc354.i = getelementptr inbounds %struct.LIST, ptr %277, i64 0, i32 1
  store ptr %277, ptr %osucc354.i, align 8
  store ptr %277, ptr %277, align 8
  store ptr %277, ptr @xx_link, align 8
  store ptr %277, ptr @zz_res, align 8
  store ptr %254, ptr @zz_hold, align 8
  %278 = load ptr, ptr %254, align 8
  store ptr %278, ptr @zz_tmp, align 8
  %279 = load ptr, ptr %277, align 8
  store ptr %279, ptr %254, align 8
  %280 = load ptr, ptr @zz_hold, align 8
  %281 = load ptr, ptr @zz_res, align 8
  %282 = load ptr, ptr %281, align 8
  %osucc380.i = getelementptr inbounds %struct.LIST, ptr %282, i64 0, i32 1
  store ptr %280, ptr %osucc380.i, align 8
  %283 = load ptr, ptr @zz_tmp, align 8
  store ptr %283, ptr %281, align 8
  %284 = load ptr, ptr @zz_res, align 8
  %285 = load ptr, ptr @zz_tmp, align 8
  %osucc386.i = getelementptr inbounds %struct.LIST, ptr %285, i64 0, i32 1
  store ptr %284, ptr %osucc386.i, align 8
  %286 = load ptr, ptr @xx_link, align 8
  store ptr %286, ptr @zz_res, align 8
  store ptr %spanobj.0.i, ptr @zz_hold, align 8
...
cond.false398.i:                                  ; preds = %cond.end389.i
  %287 = load ptr, ptr %arrayidx24.i, align 8
  store ptr %287, ptr @zz_tmp, align 8
  %arrayidx403.i = getelementptr inbounds [2 x %struct.LIST], ptr %286, i64 0, i64 1
  %288 = load ptr, ptr %arrayidx403.i, align 8
  store ptr %288, ptr %arrayidx24.i, align 8
  %289 = load ptr, ptr %arrayidx403.i, align 8
  %osucc413.i = getelementptr inbounds [2 x %struct.LIST], ptr %289, i64 0, i64 1, i32 1
  store ptr %spanobj.0.i, ptr %osucc413.i, align 8
  store ptr %287, ptr %arrayidx403.i, align 8
  %osucc419.i = getelementptr inbounds [2 x %struct.LIST], ptr %287, i64 0, i64 1, i32 1
  store ptr %286, ptr %osucc419.i, align 8
  br label %cond.end422.i

cond.end422.i:                                    ; preds = %cond.false398.i, %cond.end389.i
  %290 = load ptr, ptr %arrayidx133.i, align 8
...
for.cond430.i:                                    ; preds = %for.cond430.i, %cond.end422.i
  ...
  %291 = load i8, ptr %ou1431.i, align 8
...
if.end462.i:                                      ; preds = %for.cond430.i, %if.then460.i, %if.end454.i
  ...
  %294 = load ptr, ptr %arrayidx133.i, align 8
  %osucc480.i = getelementptr inbounds %struct.LIST, ptr %294, i64 0, i32 1
  %295 = load ptr, ptr %osucc480.i, align 8
...
for.cond494.i:                                    ; preds = %for.cond494.i, %for.cond494.preheader.i
  ...
  %296 = load i8, ptr %ou1495.i, align 8
...
if.then511.i:                                     ; preds = %for.cond494.i
  ...
  %297 = load ptr, ptr %osucc514.i, align 8
...
for.inc542.loopexit.i:                            ; preds = %for.cond494.i
  ...
  %.pre1938.i = load ptr, ptr %osucc545.phi.trans.insert.i, align 8
  br label %for.inc542.i
...
for.inc542.i:                                     ; preds = %for.inc542.loopexit.i, %if.then511.i
  ...
  br i1 %cmp488.not.i, label %for.end546.i, label %for.cond494.preheader.i
...
if.else585.i:                                     ; preds = %for.end571.i
  store ptr %301, ptr @zz_hold, align 8
  %303 = load ptr, ptr %301, align 8
  store ptr %303, ptr %arrayidx580.i, align 8
  br label %if.end594.i
...
if.end594.i:                                      ; preds = %if.else585.i, %if.then583.i
  ...
  %306 = load ptr, ptr %osucc636.i, align 8
...
cond.false671.i:                                  ; preds = %if.end594.i
  ...
  %307 = load ptr, ptr %arrayidx645.i, align 8
  %arrayidx648.i = getelementptr inbounds [2 x %struct.LIST], ptr %306, i64 0, i64 1
  store ptr %307, ptr %arrayidx648.i, align 8
  %308 = load ptr, ptr %arrayidx645.i, align 8
  %osucc655.i = getelementptr inbounds [2 x %struct.LIST], ptr %308, i64 0, i64 1, i32 1
  store ptr %306, ptr %osucc655.i, align 8
  store ptr %y.1.i, ptr %osucc636.i, align 8
  store ptr %y.1.i, ptr %arrayidx645.i, align 8
  %309 = load ptr, ptr %arrayidx648.i, align 8
  store ptr %309, ptr @zz_tmp, align 8
  %310 = load ptr, ptr %arrayidx601.i, align 8
  store ptr %310, ptr %arrayidx648.i, align 8
  %311 = load ptr, ptr %arrayidx601.i, align 8
  %osucc686.i = getelementptr inbounds [2 x %struct.LIST], ptr %311, i64 0, i64 1, i32 1
  store ptr %306, ptr %osucc686.i, align 8
  store ptr %309, ptr %arrayidx601.i, align 8
  %osucc692.i = getelementptr inbounds [2 x %struct.LIST], ptr %309, i64 0, i64 1, i32 1
  store ptr %304, ptr %osucc692.i, align 8
  br label %cond.end695.i

cond.end695.i:                                    ; preds = %if.end594.i, %cond.false671.i
  %.sink9423 = phi ptr [ %306, %cond.false671.i ], [ null, %if.end594.i ]
...
if.else711.i:                                     ; preds = %cond.end695.i
  store ptr %313, ptr @zz_hold, align 8
  %315 = load ptr, ptr %313, align 8
  store ptr %315, ptr %arrayidx706.i, align 8
  br label %cond.end766.i
...
cond.false775.i:                                  ; preds = %cond.end766.i
  %326 = load ptr, ptr %arrayidx188.i, align 8
  store ptr %326, ptr @zz_tmp, align 8
  %arrayidx780.i = getelementptr inbounds [2 x %struct.LIST], ptr %325, i64 0, i64 1
  %327 = load ptr, ptr %arrayidx780.i, align 8
  store ptr %327, ptr %arrayidx188.i, align 8
  %328 = load ptr, ptr %arrayidx780.i, align 8
  %osucc790.i = getelementptr inbounds [2 x %struct.LIST], ptr %328, i64 0, i64 1, i32 1
  store ptr %254, ptr %osucc790.i, align 8
  store ptr %326, ptr %arrayidx780.i, align 8
  %osucc796.i = getelementptr inbounds [2 x %struct.LIST], ptr %326, i64 0, i64 1, i32 1
  store ptr %325, ptr %osucc796.i, align 8
...
if.else827.i:                                     ; preds = %if.else813.i
  store ptr %330, ptr @zz_hold, align 8
  %332 = load ptr, ptr %330, align 8
  store ptr %332, ptr %arrayidx822.i, align 8
  br label %cond.end882.i
...
cond.end882.i:                                    ; preds = %if.else827.i, %if.then825.i
  ...
  store i8 0, ptr %ou1837.i, align 8
  %osucc841.i = getelementptr inbounds [2 x %struct.LIST], ptr %333, i64 0, i64 1, i32 1
  store ptr %333, ptr %osucc841.i, align 8
  %arrayidx843.i = getelementptr inbounds [2 x %struct.LIST], ptr %333, i64 0, i64 1
  store ptr %333, ptr %arrayidx843.i, align 8
  %osucc847.i = getelementptr inbounds %struct.LIST, ptr %333, i64 0, i32 1
  store ptr %333, ptr %osucc847.i, align 8
  store ptr %333, ptr %333, align 8
  store ptr %333, ptr @xx_link, align 8
  store ptr %333, ptr @zz_res, align 8
  store ptr %x, ptr @zz_hold, align 8
  %334 = load ptr, ptr %x, align 8
  store ptr %334, ptr @zz_tmp, align 8
  %335 = load ptr, ptr %333, align 8
  store ptr %335, ptr %x, align 8
  %336 = load ptr, ptr @zz_hold, align 8
  %337 = load ptr, ptr @zz_res, align 8
  %338 = load ptr, ptr %337, align 8
  %osucc873.i = getelementptr inbounds %struct.LIST, ptr %338, i64 0, i32 1
  store ptr %336, ptr %osucc873.i, align 8
  %339 = load ptr, ptr @zz_tmp, align 8
  store ptr %339, ptr %337, align 8
  %340 = load ptr, ptr @zz_res, align 8
  %341 = load ptr, ptr @zz_tmp, align 8
  %osucc879.i = getelementptr inbounds %struct.LIST, ptr %341, i64 0, i32 1
  store ptr %340, ptr %osucc879.i, align 8
  %342 = load ptr, ptr @xx_link, align 8
  store ptr %342, ptr @zz_res, align 8
  store ptr %spanobj.0.i, ptr @zz_hold, align 8
  %cmp888.i = icmp eq ptr %342, null
  br i1 %cmp888.i, label %if.end917.i, label %cond.false891.i

cond.false891.i:                                  ; preds = %cond.end882.i
  %343 = load ptr, ptr %arrayidx24.i, align 8
  store ptr %343, ptr @zz_tmp, align 8
  %arrayidx896.i = getelementptr inbounds [2 x %struct.LIST], ptr %342, i64 0, i64 1
  %344 = load ptr, ptr %arrayidx896.i, align 8
  store ptr %344, ptr %arrayidx24.i, align 8
  %345 = load ptr, ptr %arrayidx896.i, align 8
  %osucc906.i = getelementptr inbounds [2 x %struct.LIST], ptr %345, i64 0, i64 1, i32 1
  store ptr %spanobj.0.i, ptr %osucc906.i, align 8
  store ptr %343, ptr %arrayidx896.i, align 8
  %osucc912.i = getelementptr inbounds [2 x %struct.LIST], ptr %343, i64 0, i64 1, i32 1
  store ptr %342, ptr %osucc912.i, align 8
  br label %if.end917.i

if.end917.i:                                      ; preds = %cond.end799.i, %cond.false891.i, %cond.end882.i, %for.end546.i
  %346 = load i8, ptr %ou1, align 8
...
if.then932.i:                                     ; preds = %if.end917.i
  ...
  %347 = load ptr, ptr %arrayidx934.i, align 8
...
for.cond939.i:                                    ; preds = %for.cond939.i, %if.then932.i
  ...
  %vprnt.0.i = load ptr, ptr %vprnt.0.in.i, align 8
  %ou1940.i = getelementptr inbounds %struct.word_type, ptr %vprnt.0.i, i64 0, i32 1
  %348 = load i8, ptr %ou1940.i, align 8
...
if.end986.i:                                      ; preds = %if.else977.i, %if.then975.i
  ...
  store i8 14, ptr %ou1987.i, align 8
...
if.else1043.i:                                    ; preds = %if.end986.i
  store ptr %356, ptr @zz_hold, align 8
  %358 = load ptr, ptr %356, align 8
  store ptr %358, ptr %arrayidx1038.i, align 8
  br label %cond.end1098.i
...
cond.end1098.i:                                   ; preds = %if.else1043.i, %if.then1041.i
  ...
  store i8 0, ptr %ou11053.i, align 8
  %osucc1057.i = getelementptr inbounds [2 x %struct.LIST], ptr %359, i64 0, i64 1, i32 1
  store ptr %359, ptr %osucc1057.i, align 8
  %arrayidx1059.i = getelementptr inbounds [2 x %struct.LIST], ptr %359, i64 0, i64 1
  store ptr %359, ptr %arrayidx1059.i, align 8
  %osucc1063.i = getelementptr inbounds %struct.LIST, ptr %359, i64 0, i32 1
  store ptr %359, ptr %osucc1063.i, align 8
  store ptr %359, ptr %359, align 8
  store ptr %359, ptr @xx_link, align 8
  store ptr %359, ptr @zz_res, align 8
  store ptr %x, ptr @zz_hold, align 8
  %360 = load ptr, ptr %x, align 8
  store ptr %360, ptr @zz_tmp, align 8
  %361 = load ptr, ptr %359, align 8
  store ptr %361, ptr %x, align 8
  %362 = load ptr, ptr @zz_hold, align 8
  %363 = load ptr, ptr @zz_res, align 8
  %364 = load ptr, ptr %363, align 8
  %osucc1089.i = getelementptr inbounds %struct.LIST, ptr %364, i64 0, i32 1
  store ptr %362, ptr %osucc1089.i, align 8
  %365 = load ptr, ptr @zz_tmp, align 8
  store ptr %365, ptr %363, align 8
  %366 = load ptr, ptr @zz_res, align 8
  %367 = load ptr, ptr @zz_tmp, align 8
  %osucc1095.i = getelementptr inbounds %struct.LIST, ptr %367, i64 0, i32 1
  store ptr %366, ptr %osucc1095.i, align 8
  %368 = load ptr, ptr @xx_link, align 8
  store ptr %368, ptr @zz_res, align 8
  store ptr %353, ptr @zz_hold, align 8
...
if.else1146.i:                                    ; preds = %cond.end1131.i
  ...
  store ptr %375, ptr %arrayidx1141.i, align 8
  br label %cond.end1201.i
...
cond.end1201.i:                                   ; preds = %if.else1146.i, %if.then1144.i
  ...
  store i8 0, ptr %ou11156.i, align 8
  %osucc1160.i = getelementptr inbounds [2 x %struct.LIST], ptr %376, i64 0, i64 1, i32 1
  store ptr %376, ptr %osucc1160.i, align 8
  %arrayidx1162.i = getelementptr inbounds [2 x %struct.LIST], ptr %376, i64 0, i64 1
  store ptr %376, ptr %arrayidx1162.i, align 8
  %osucc1166.i = getelementptr inbounds %struct.LIST, ptr %376, i64 0, i32 1
  store ptr %376, ptr %osucc1166.i, align 8
  store ptr %376, ptr %376, align 8
  store ptr %376, ptr @xx_link, align 8
  store ptr %376, ptr @zz_res, align 8
  store ptr %353, ptr @zz_hold, align 8
  %377 = load ptr, ptr %353, align 8
  store ptr %377, ptr @zz_tmp, align 8
  %378 = load ptr, ptr %376, align 8
  store ptr %378, ptr %353, align 8
  %379 = load ptr, ptr @zz_hold, align 8
  %380 = load ptr, ptr @zz_res, align 8
  %381 = load ptr, ptr %380, align 8
  %osucc1192.i = getelementptr inbounds %struct.LIST, ptr %381, i64 0, i32 1
  store ptr %379, ptr %osucc1192.i, align 8
  %382 = load ptr, ptr @zz_tmp, align 8
  store ptr %382, ptr %380, align 8
  %383 = load ptr, ptr @zz_res, align 8
  %384 = load ptr, ptr @zz_tmp, align 8
  %osucc1198.i = getelementptr inbounds %struct.LIST, ptr %384, i64 0, i32 1
  store ptr %383, ptr %osucc1198.i, align 8
  %385 = load ptr, ptr @xx_link, align 8
  store ptr %385, ptr @zz_res, align 8
  store ptr %spanobj.0.i, ptr @zz_hold, align 8
...
cond.false1210.i:                                 ; preds = %cond.end1201.i
  %386 = load ptr, ptr %arrayidx24.i, align 8
  store ptr %386, ptr @zz_tmp, align 8
  %arrayidx1215.i = getelementptr inbounds [2 x %struct.LIST], ptr %385, i64 0, i64 1
  %387 = load ptr, ptr %arrayidx1215.i, align 8
  store ptr %387, ptr %arrayidx24.i, align 8
  %388 = load ptr, ptr %arrayidx1215.i, align 8
  %osucc1225.i = getelementptr inbounds [2 x %struct.LIST], ptr %388, i64 0, i64 1, i32 1
  store ptr %spanobj.0.i, ptr %osucc1225.i, align 8
  store ptr %386, ptr %arrayidx1215.i, align 8
  %osucc1231.i = getelementptr inbounds [2 x %struct.LIST], ptr %386, i64 0, i64 1, i32 1
  store ptr %385, ptr %osucc1231.i, align 8
...
cond.end1234.i:                                   ; preds = %cond.false1210.i, %cond.end1201.i
  ...
  %389 = load ptr, ptr %osucc1238.i, align 8
...
for.cond1242.i:                                   ; preds = %for.cond1242.i, %cond.end1234.i
  ...
  %prnt.1.i = load ptr, ptr %prnt.1.in.i, align 8
  %ou11243.i = getelementptr inbounds %struct.word_type, ptr %prnt.1.i, i64 0, i32 1
  %390 = load i8, ptr %ou11243.i, align 8
...
if.then1259.i:                                    ; preds = %for.cond1242.i
  %391 = load ptr, ptr @no_fpos, align 8
...
if.end1261.i:                                     ; preds = %for.cond1242.i, %if.then1259.i
  ...
  %392 = load ptr, ptr %osucc1238.i, align 8
  %osucc1279.i = getelementptr inbounds %struct.LIST, ptr %392, i64 0, i32 1
  %393 = load ptr, ptr %osucc1279.i, align 8
...
if.then1310.i:                                    ; preds = %for.cond1293.i
  ...
  %395 = load ptr, ptr %osucc1313.i, align 8
...
for.inc1341.loopexit.i:                           ; preds = %for.cond1293.i
  ...
  %.pre1939.i = load ptr, ptr %osucc1344.phi.trans.insert.i, align 8
  br label %for.inc1341.i
...
for.inc1341.i:                                    ; preds = %for.inc1341.loopexit.i, %if.then1310.i
  ...
  br i1 %cmp1287.not.i, label %for.end1345.i, label %for.cond1293.preheader.i
...
for.cond1359.i:                                   ; preds = %for.cond1359.i, %for.cond1359.preheader.i
  ...
  %y.3.i = load ptr, ptr %y.3.in.i, align 8
  %ou11360.i = getelementptr inbounds %struct.word_type, ptr %y.3.i, i64 0, i32 1
  %397 = load i8, ptr %ou11360.i, align 8
  %cmp1363.i = icmp eq i8 %397, 0
  br i1 %cmp1363.i, label %for.cond1359.i, label %for.end1370.i

for.end1370.i:                                    ; preds = %for.cond1359.i
  %398 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 46), align 1
  %conv1371.i = zext i8 %398 to i32
  store i32 %conv1371.i, ptr @zz_size, align 4
  %conv1372.i = zext i8 %398 to i64
  %arrayidx1379.i = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv1372.i
  %399 = load ptr, ptr %arrayidx1379.i, align 8
...
if.else1384.i:                                    ; preds = %for.end1370.i
  ...
  store ptr %401, ptr %arrayidx1379.i, align 8
  br label %if.end1393.i
...
if.end1393.i:                                     ; preds = %if.else1384.i, %if.then1382.i
  ...
  %404 = load ptr, ptr %osucc1435.i, align 8
...
cond.false1470.i:                                 ; preds = %if.end1393.i
  ...
  %405 = load ptr, ptr %arrayidx1444.i, align 8
  %arrayidx1447.i = getelementptr inbounds [2 x %struct.LIST], ptr %404, i64 0, i64 1
  store ptr %405, ptr %arrayidx1447.i, align 8
  %406 = load ptr, ptr %arrayidx1444.i, align 8
  %osucc1454.i = getelementptr inbounds [2 x %struct.LIST], ptr %406, i64 0, i64 1, i32 1
  store ptr %404, ptr %osucc1454.i, align 8
  store ptr %y.3.i, ptr %osucc1435.i, align 8
  store ptr %y.3.i, ptr %arrayidx1444.i, align 8
  %407 = load ptr, ptr %arrayidx1447.i, align 8
  store ptr %407, ptr @zz_tmp, align 8
  %408 = load ptr, ptr %arrayidx1400.i, align 8
  store ptr %408, ptr %arrayidx1447.i, align 8
  %409 = load ptr, ptr %arrayidx1400.i, align 8
  %osucc1485.i = getelementptr inbounds [2 x %struct.LIST], ptr %409, i64 0, i64 1, i32 1
  store ptr %404, ptr %osucc1485.i, align 8
  store ptr %407, ptr %arrayidx1400.i, align 8
  %osucc1491.i = getelementptr inbounds [2 x %struct.LIST], ptr %407, i64 0, i64 1, i32 1
  store ptr %402, ptr %osucc1491.i, align 8
  br label %cond.end1494.i

cond.end1494.i:                                   ; preds = %if.end1393.i, %cond.false1470.i
  %.sink9425 = phi ptr [ %404, %cond.false1470.i ], [ null, %if.end1393.i ]
  store ptr %.sink9425, ptr @xx_tmp, align 8
  store ptr %402, ptr @zz_res, align 8
  store ptr %.sink9425, ptr @zz_hold, align 8
  %call1496.i = tail call i32 @DisposeObject(ptr noundef nonnull %y.3.i) #8
  %410 = load i8, ptr @zz_lengths, align 1
  %conv1497.i = zext i8 %410 to i32
  store i32 %conv1497.i, ptr @zz_size, align 4
  %conv1498.i = zext i8 %410 to i64
  %arrayidx1505.i = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv1498.i
  %411 = load ptr, ptr %arrayidx1505.i, align 8
  %cmp1506.i = icmp eq ptr %411, null
  br i1 %cmp1506.i, label %if.then1508.i, label %if.else1510.i

if.then1508.i:                                    ; preds = %cond.end1494.i
  %412 = load ptr, ptr @no_fpos, align 8
...
if.else1510.i:                                    ; preds = %cond.end1494.i
  store ptr %411, ptr @zz_hold, align 8
  %413 = load ptr, ptr %411, align 8
  store ptr %413, ptr %arrayidx1505.i, align 8
  br label %cond.end1565.i
...
cond.end1565.i:                                   ; preds = %if.else1510.i, %if.then1508.i
  ...
  store i8 0, ptr %ou11520.i, align 8
  %osucc1524.i = getelementptr inbounds [2 x %struct.LIST], ptr %414, i64 0, i64 1, i32 1
  store ptr %414, ptr %osucc1524.i, align 8
  %arrayidx1526.i = getelementptr inbounds [2 x %struct.LIST], ptr %414, i64 0, i64 1
  store ptr %414, ptr %arrayidx1526.i, align 8
  %osucc1530.i = getelementptr inbounds %struct.LIST, ptr %414, i64 0, i32 1
  store ptr %414, ptr %osucc1530.i, align 8
  store ptr %414, ptr %414, align 8
  store ptr %414, ptr @xx_link, align 8
  store ptr %414, ptr @zz_res, align 8
  store ptr %402, ptr @zz_hold, align 8
  %415 = load ptr, ptr %402, align 8
  store ptr %415, ptr @zz_tmp, align 8
  %416 = load ptr, ptr %414, align 8
  store ptr %416, ptr %402, align 8
  %417 = load ptr, ptr @zz_hold, align 8
  %418 = load ptr, ptr @zz_res, align 8
  %419 = load ptr, ptr %418, align 8
  %osucc1556.i = getelementptr inbounds %struct.LIST, ptr %419, i64 0, i32 1
  store ptr %417, ptr %osucc1556.i, align 8
  %420 = load ptr, ptr @zz_tmp, align 8
  store ptr %420, ptr %418, align 8
  %421 = load ptr, ptr @zz_res, align 8
  %422 = load ptr, ptr @zz_tmp, align 8
  %osucc1562.i = getelementptr inbounds %struct.LIST, ptr %422, i64 0, i32 1
  store ptr %421, ptr %osucc1562.i, align 8
  %423 = load ptr, ptr @xx_link, align 8
  store ptr %423, ptr @zz_res, align 8
  store ptr %353, ptr @zz_hold, align 8
...
cond.false1574.i:                                 ; preds = %cond.end1565.i
  %424 = load ptr, ptr %arrayidx990.i, align 8
  store ptr %424, ptr @zz_tmp, align 8
  %arrayidx1579.i = getelementptr inbounds [2 x %struct.LIST], ptr %423, i64 0, i64 1
  %425 = load ptr, ptr %arrayidx1579.i, align 8
  store ptr %425, ptr %arrayidx990.i, align 8
  %426 = load ptr, ptr %arrayidx1579.i, align 8
  %osucc1589.i = getelementptr inbounds [2 x %struct.LIST], ptr %426, i64 0, i64 1, i32 1
  store ptr %353, ptr %osucc1589.i, align 8
  store ptr %424, ptr %arrayidx1579.i, align 8
  %osucc1595.i = getelementptr inbounds [2 x %struct.LIST], ptr %424, i64 0, i64 1, i32 1
  store ptr %423, ptr %osucc1595.i, align 8
...
if.else1627.i:                                    ; preds = %if.else1613.i
  store ptr %428, ptr @zz_hold, align 8
  %430 = load ptr, ptr %428, align 8
  store ptr %430, ptr %arrayidx1622.i, align 8
  br label %cond.end1682.i
...
cond.end1682.i:                                   ; preds = %if.else1627.i, %if.then1625.i
  ...
  store i8 0, ptr %ou11637.i, align 8
  %osucc1641.i = getelementptr inbounds [2 x %struct.LIST], ptr %431, i64 0, i64 1, i32 1
  store ptr %431, ptr %osucc1641.i, align 8
  %arrayidx1643.i = getelementptr inbounds [2 x %struct.LIST], ptr %431, i64 0, i64 1
  store ptr %431, ptr %arrayidx1643.i, align 8
  %osucc1647.i = getelementptr inbounds %struct.LIST, ptr %431, i64 0, i32 1
  store ptr %431, ptr %osucc1647.i, align 8
  store ptr %431, ptr %431, align 8
  store ptr %431, ptr @xx_link, align 8
  store ptr %431, ptr @zz_res, align 8
  store ptr %x, ptr @zz_hold, align 8
  %432 = load ptr, ptr %x, align 8
  store ptr %432, ptr @zz_tmp, align 8
  %433 = load ptr, ptr %431, align 8
  store ptr %433, ptr %x, align 8
  %434 = load ptr, ptr @zz_hold, align 8
  %435 = load ptr, ptr @zz_res, align 8
  %436 = load ptr, ptr %435, align 8
  %osucc1673.i = getelementptr inbounds %struct.LIST, ptr %436, i64 0, i32 1
  store ptr %434, ptr %osucc1673.i, align 8
  %437 = load ptr, ptr @zz_tmp, align 8
  store ptr %437, ptr %435, align 8
  %438 = load ptr, ptr @zz_res, align 8
  %439 = load ptr, ptr @zz_tmp, align 8
  %osucc1679.i = getelementptr inbounds %struct.LIST, ptr %439, i64 0, i32 1
  store ptr %438, ptr %osucc1679.i, align 8
  %440 = load ptr, ptr @xx_link, align 8
  store ptr %440, ptr @zz_res, align 8
  store ptr %spanobj.0.i, ptr @zz_hold, align 8
...
cond.false1691.i:                                 ; preds = %cond.end1682.i
  %441 = load ptr, ptr %arrayidx24.i, align 8
  store ptr %441, ptr @zz_tmp, align 8
  %arrayidx1696.i = getelementptr inbounds [2 x %struct.LIST], ptr %440, i64 0, i64 1
  %442 = load ptr, ptr %arrayidx1696.i, align 8
  store ptr %442, ptr %arrayidx24.i, align 8
  %443 = load ptr, ptr %arrayidx1696.i, align 8
  %osucc1706.i = getelementptr inbounds [2 x %struct.LIST], ptr %443, i64 0, i64 1, i32 1
  store ptr %spanobj.0.i, ptr %osucc1706.i, align 8
  store ptr %441, ptr %arrayidx1696.i, align 8
  %osucc1712.i = getelementptr inbounds [2 x %struct.LIST], ptr %441, i64 0, i64 1, i32 1
  store ptr %440, ptr %osucc1712.i, align 8
  br label %if.end1599
...
cond.false1566:                                   ; preds = %cond.end1557
  %447 = load ptr, ptr %arrayidx1543, align 8
  store ptr %447, ptr @zz_tmp, align 8
  %arrayidx1571 = getelementptr inbounds [2 x %struct.LIST], ptr %call1528, i64 0, i64 1
  %448 = load ptr, ptr %arrayidx1571, align 8
  store ptr %448, ptr %arrayidx1543, align 8
  %449 = load ptr, ptr %arrayidx1571, align 8
  %osucc1581 = getelementptr inbounds [2 x %struct.LIST], ptr %449, i64 0, i64 1, i32 1
  store ptr %444, ptr %osucc1581, align 8
  store ptr %447, ptr %arrayidx1571, align 8
  %osucc1587 = getelementptr inbounds [2 x %struct.LIST], ptr %447, i64 0, i64 1, i32 1
  store ptr %call1528, ptr %osucc1587, align 8
  br label %cond.end1590
...
if.then1614:                                      ; preds = %lor.lhs.false1605, %land.lhs.true1611
  ...
  %451 = load ptr, ptr %osucc1617, align 8
...
if.then1638:                                      ; preds = %for.cond1621
  %453 = load ptr, ptr @no_fpos, align 8
...
if.end1646:                                       ; preds = %if.end1640, %land.lhs.true1611, %lor.lhs.false1605
  ...
  %cond1658 = load ptr, ptr %cond1658.in, align 8
...
for.cond1662:                                     ; preds = %for.cond1662, %if.end1646
  ...
  %456 = load i8, ptr %ou11663, align 8
  %cmp1666 = icmp eq i8 %456, 0
  br i1 %cmp1666, label %for.cond1662, label %for.end1673

for.end1673:                                      ; preds = %for.cond1662
  %457 = load i8, ptr %ou1, align 8
...
lor.lhs.false1685:                                ; preds = %for.end1673
  ...
  %or.cond9165.not = and i1 %cmp1695.not, %cmp1689
  br i1 %or.cond9165.not, label %if.then1697, label %if.end1716
...
if.then1755:                                      ; preds = %if.else1743
  ...
  %458 = load i32, ptr %arrayidx1760, align 4
  ...
  store i32 %458, ptr %arrayidx1764, align 4
  ...
  %459 = load i32, ptr %arrayidx1768, align 4
  ...
  store i32 %459, ptr %arrayidx1772, align 4
  br label %sw.epilog7697
...
if.then1788:                                      ; preds = %if.else1773
  ...
  store i32 0, ptr %arrayidx1796, align 4
  br label %sw.epilog7697
...
if.else1797:                                      ; preds = %if.else1773
  ...
  store i32 0, ptr %arrayidx1802, align 4
  ...
  %460 = load i32, ptr %arrayidx1806, align 4
  ...
  %461 = load i32, ptr %arrayidx1810, align 4
  ...
  store i32 %spec.select, ptr %arrayidx1831, align 4
  br label %sw.epilog7697
...
if.then1845:                                      ; preds = %sw.bb1835
  %463 = load ptr, ptr @no_fpos, align 8
...
if.end1847:                                       ; preds = %if.then1845, %sw.bb1835
  ...
  %464 = load ptr, ptr %osucc1850, align 8
...
for.cond1854:                                     ; preds = %for.cond1854, %if.end1847
  ...
  %465 = load i8, ptr %ou11855, align 8
  %cmp1858 = icmp eq i8 %465, 0
  br i1 %cmp1858, label %for.cond1854, label %for.end1865
...
for.end1865:                                      ; preds = %for.cond1854
  ...
  %466 = load i32, ptr %arrayidx1870, align 4
  ...
  store i32 %466, ptr %arrayidx1874, align 4
  ...
  %467 = load i32, ptr %arrayidx1878, align 4
...
for.cond1890:                                     ; preds = %for.cond1890, %sw.bb1883
  ...
  %469 = load i8, ptr %ou11891, align 8
  %cmp1894 = icmp eq i8 %469, 0
  br i1 %cmp1894, label %for.cond1890, label %for.end1901
...
for.end1901:                                      ; preds = %for.cond1890
  ...
  %470 = load i32, ptr %arrayidx1906, align 4
  ...
  store i32 %470, ptr %arrayidx1910, align 4
  ...
  %471 = load i32, ptr %arrayidx1914, align 4
  ...
  store i32 %471, ptr %arrayidx1918, align 4
  %cmp1919 = icmp eq i32 %dim, 1
  br i1 %cmp1919, label %if.then1921, label %sw.epilog7697

if.then1921:                                      ; preds = %for.end1901
  %472 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 138), align 1
...
if.else1935:                                      ; preds = %if.then1921
  store ptr %473, ptr @zz_hold, align 8
  %475 = load ptr, ptr %473, align 8
  store ptr %475, ptr %arrayidx1930, align 8
  br label %if.end1944
...
if.end1944:                                       ; preds = %if.then1933, %if.else1935
  ...
  store i8 -118, ptr %ou11945, align 8
...
if.end1982:                                       ; preds = %if.then1971, %if.else1973
  ...
  store i8 0, ptr %ou11983, align 8
  %osucc1987 = getelementptr inbounds [2 x %struct.LIST], ptr %481, i64 0, i64 1, i32 1
  store ptr %481, ptr %osucc1987, align 8
  %arrayidx1989 = getelementptr inbounds [2 x %struct.LIST], ptr %481, i64 0, i64 1
  store ptr %481, ptr %arrayidx1989, align 8
  %osucc1993 = getelementptr inbounds %struct.LIST, ptr %481, i64 0, i32 1
  store ptr %481, ptr %osucc1993, align 8
  store ptr %481, ptr %481, align 8
  store ptr %481, ptr @xx_link, align 8
  store ptr %481, ptr @zz_res, align 8
  %482 = load ptr, ptr %extras, align 8
  store ptr %482, ptr @zz_hold, align 8
...
cond.end2028.thread:                              ; preds = %if.end1982
  store ptr %481, ptr @zz_res, align 8
  store ptr %476, ptr @zz_hold, align 8
  br label %cond.false2037

cond.end2028:                                     ; preds = %if.end1982
  %483 = load ptr, ptr %482, align 8
  store ptr %483, ptr @zz_tmp, align 8
  %484 = load ptr, ptr %481, align 8
  store ptr %484, ptr %482, align 8
  %485 = load ptr, ptr @zz_hold, align 8
  %486 = load ptr, ptr @zz_res, align 8
  %487 = load ptr, ptr %486, align 8
  %osucc2019 = getelementptr inbounds %struct.LIST, ptr %487, i64 0, i32 1
  store ptr %485, ptr %osucc2019, align 8
  %488 = load ptr, ptr @zz_tmp, align 8
  store ptr %488, ptr %486, align 8
  %489 = load ptr, ptr @zz_res, align 8
  %490 = load ptr, ptr @zz_tmp, align 8
  %osucc2025 = getelementptr inbounds %struct.LIST, ptr %490, i64 0, i32 1
  store ptr %489, ptr %osucc2025, align 8
  %.pr9143 = load ptr, ptr @xx_link, align 8
  store ptr %.pr9143, ptr @zz_res, align 8
  store ptr %476, ptr @zz_hold, align 8
...
cond.end2028.cond.false2037_crit_edge:            ; preds = %cond.end2028
  ...
  %.pre9436 = load ptr, ptr %arrayidx2042.phi.trans.insert, align 8
  br label %cond.false2037
...
for.cond2079:                                     ; preds = %for.cond2079, %sw.bb2064
  ...
  %496 = load i8, ptr %ou12080, align 8
  %cmp2083 = icmp eq i8 %496, 0
  br i1 %cmp2083, label %for.cond2079, label %for.end2090
...
for.cond2106:                                     ; preds = %for.cond2106, %sw.bb2099
  ...
  %y.7 = load ptr, ptr %y.7.in, align 8
  %ou12107 = getelementptr inbounds %struct.word_type, ptr %y.7, i64 0, i32 1
  %498 = load i8, ptr %ou12107, align 8
  %cmp2110 = icmp eq i8 %498, 0
  br i1 %cmp2110, label %for.cond2106, label %for.end2117
...
for.end2117:                                      ; preds = %for.cond2106
  ...
  %499 = load i32, ptr %arrayidx2122, align 4
  ...
  store i32 %499, ptr %arrayidx2126, align 4
  ...
  %500 = load i32, ptr %arrayidx2130, align 4
  ...
  store i32 %500, ptr %arrayidx2134, align 4
  br label %sw.epilog7697

sw.bb2135:                                        ; preds = %entry, %entry, %entry, %entry
  %501 = load ptr, ptr %x, align 8
...
for.cond2142:                                     ; preds = %for.cond2142, %sw.bb2135
  ...
  %502 = load i8, ptr %ou12143, align 8
  %cmp2146 = icmp eq i8 %502, 0
  br i1 %cmp2146, label %for.cond2142, label %for.end2153
...
for.end2153:                                      ; preds = %for.cond2142
  ...
  %503 = load i32, ptr %arrayidx2158, align 4
  ...
  store i32 %503, ptr %arrayidx2162, align 4
  ...
  %504 = load i32, ptr %arrayidx2166, align 4
...
for.cond2178:                                     ; preds = %for.cond2178, %sw.bb2171
  ...
  %506 = load i8, ptr %ou12179, align 8
  %cmp2182 = icmp eq i8 %506, 0
  br i1 %cmp2182, label %for.cond2178, label %for.end2189
...
if.else2209:                                      ; preds = %for.end2189
  ...
  %508 = load i32, ptr %arrayidx2213, align 4
  ...
  store i32 %508, ptr %arrayidx2217, align 4
  ...
  %509 = load i32, ptr %arrayidx2221, align 4
  ...
  store i32 %509, ptr %arrayidx2225, align 4
  br label %if.end2226
...
if.end2252:                                       ; preds = %if.then2241, %if.else2243
  ...
  store i8 -119, ptr %ou12253, align 8
...
if.end2290:                                       ; preds = %if.then2279, %if.else2281
  ...
  store i8 0, ptr %ou12291, align 8
  %osucc2295 = getelementptr inbounds [2 x %struct.LIST], ptr %519, i64 0, i64 1, i32 1
  store ptr %519, ptr %osucc2295, align 8
  %arrayidx2297 = getelementptr inbounds [2 x %struct.LIST], ptr %519, i64 0, i64 1
  store ptr %519, ptr %arrayidx2297, align 8
  %osucc2301 = getelementptr inbounds %struct.LIST, ptr %519, i64 0, i32 1
  store ptr %519, ptr %osucc2301, align 8
  store ptr %519, ptr %519, align 8
  store ptr %519, ptr @xx_link, align 8
  store ptr %519, ptr @zz_res, align 8
  %520 = load ptr, ptr %extras, align 8
...
cond.end2336.thread:                              ; preds = %if.end2290
  store ptr %519, ptr @zz_res, align 8
  store ptr %514, ptr @zz_hold, align 8
  br label %cond.false2345

cond.end2336:                                     ; preds = %if.end2290
  %521 = load ptr, ptr %520, align 8
  store ptr %521, ptr @zz_tmp, align 8
  %522 = load ptr, ptr %519, align 8
  store ptr %522, ptr %520, align 8
  %523 = load ptr, ptr @zz_hold, align 8
  %524 = load ptr, ptr @zz_res, align 8
  %525 = load ptr, ptr %524, align 8
  %osucc2327 = getelementptr inbounds %struct.LIST, ptr %525, i64 0, i32 1
  store ptr %523, ptr %osucc2327, align 8
  %526 = load ptr, ptr @zz_tmp, align 8
  store ptr %526, ptr %524, align 8
  %527 = load ptr, ptr @zz_res, align 8
  %528 = load ptr, ptr @zz_tmp, align 8
  %osucc2333 = getelementptr inbounds %struct.LIST, ptr %528, i64 0, i32 1
  store ptr %527, ptr %osucc2333, align 8
  %.pr9145 = load ptr, ptr @xx_link, align 8
  store ptr %.pr9145, ptr @zz_res, align 8
  store ptr %514, ptr @zz_hold, align 8
...
cond.end2336.cond.false2345_crit_edge:            ; preds = %cond.end2336
  ...
  %.pre9435 = load ptr, ptr %arrayidx2350.phi.trans.insert, align 8
  br label %cond.false2345
...
for.cond2379:                                     ; preds = %for.cond2379, %sw.bb2372
  ...
  %534 = load i8, ptr %ou12380, align 8
  %cmp2383 = icmp eq i8 %534, 0
  br i1 %cmp2383, label %for.cond2379, label %for.end2390
...
if.else2410:                                      ; preds = %for.end2390
  ...
  %536 = load i32, ptr %arrayidx2414, align 4
  ...
  store i32 %536, ptr %arrayidx2418, align 4
  ...
  %537 = load i32, ptr %arrayidx2422, align 4
...
for.cond2435:                                     ; preds = %for.cond2435, %sw.bb2428
  ...
  %539 = load i8, ptr %ou12436, align 8
  %cmp2439 = icmp eq i8 %539, 0
  br i1 %cmp2439, label %for.cond2435, label %for.end2446
...
if.end2473:                                       ; preds = %if.then2462, %if.else2464
  ...
  %545 = load i32, ptr %osparec, align 4
...
if.else2503:                                      ; preds = %for.end2446
  ...
  %546 = load ptr, ptr %oux2504, align 8
  %osucc2507 = getelementptr inbounds %struct.LIST, ptr %546, i64 0, i32 1
  %547 = load ptr, ptr %osucc2507, align 8
  %548 = load ptr, ptr %extras, align 8
...
if.end2519:                                       ; preds = %if.then2517, %if.then2511
  store ptr %547, ptr @zz_res, align 8
  store ptr %546, ptr @zz_hold, align 8
  %551 = load ptr, ptr %546, align 8
  store ptr %551, ptr @zz_tmp, align 8
  %552 = load ptr, ptr %547, align 8
  store ptr %552, ptr %546, align 8
  %553 = load ptr, ptr @zz_hold, align 8
  %554 = load ptr, ptr @zz_res, align 8
  %555 = load ptr, ptr %554, align 8
  %osucc2542 = getelementptr inbounds %struct.LIST, ptr %555, i64 0, i32 1
  store ptr %553, ptr %osucc2542, align 8
  %556 = load ptr, ptr @zz_tmp, align 8
  store ptr %556, ptr %554, align 8
  %557 = load ptr, ptr @zz_res, align 8
  %558 = load ptr, ptr @zz_tmp, align 8
  %osucc2548 = getelementptr inbounds %struct.LIST, ptr %558, i64 0, i32 1
  store ptr %557, ptr %osucc2548, align 8
  store ptr %547, ptr @zz_res, align 8
  store ptr %548, ptr @zz_hold, align 8
...
cond.false2560:                                   ; preds = %if.end2519
  ...
  store ptr %559, ptr @zz_tmp, align 8
  %560 = load ptr, ptr %547, align 8
  store ptr %560, ptr %548, align 8
  %561 = load ptr, ptr @zz_hold, align 8
  %562 = load ptr, ptr @zz_res, align 8
  %563 = load ptr, ptr %562, align 8
  %osucc2575 = getelementptr inbounds %struct.LIST, ptr %563, i64 0, i32 1
  store ptr %561, ptr %osucc2575, align 8
  %564 = load ptr, ptr @zz_tmp, align 8
  store ptr %564, ptr %562, align 8
  %565 = load ptr, ptr @zz_res, align 8
  %566 = load ptr, ptr @zz_tmp, align 8
  %osucc2581 = getelementptr inbounds %struct.LIST, ptr %566, i64 0, i32 1
  store ptr %565, ptr %osucc2581, align 8
  br label %if.end2586

if.end2586:                                       ; preds = %if.end2519, %cond.false2560, %if.else2503
  %567 = load ptr, ptr %oux2504, align 8
  store ptr %567, ptr @zz_hold, align 8
  %ou12588 = getelementptr inbounds %struct.word_type, ptr %567, i64 0, i32 1
  %568 = load i8, ptr %ou12588, align 8
...
for.cond2625:                                     ; preds = %for.cond2625, %sw.bb2618
  ...
  %573 = load i8, ptr %ou12626, align 8
  %cmp2629 = icmp eq i8 %573, 0
  br i1 %cmp2629, label %for.cond2625, label %for.end2636
...
if.end2690:                                       ; preds = %if.then2679, %if.else2681
  ...
  store i8 -120, ptr %ou12691, align 8
...
if.end2728:                                       ; preds = %if.then2717, %if.else2719
  ...
  store i8 0, ptr %ou12729, align 8
  %osucc2733 = getelementptr inbounds [2 x %struct.LIST], ptr %586, i64 0, i64 1, i32 1
  store ptr %586, ptr %osucc2733, align 8
  %arrayidx2735 = getelementptr inbounds [2 x %struct.LIST], ptr %586, i64 0, i64 1
  store ptr %586, ptr %arrayidx2735, align 8
  %osucc2739 = getelementptr inbounds %struct.LIST, ptr %586, i64 0, i32 1
  store ptr %586, ptr %osucc2739, align 8
  store ptr %586, ptr %586, align 8
  store ptr %586, ptr @xx_link, align 8
  store ptr %586, ptr @zz_res, align 8
  %587 = load ptr, ptr %extras, align 8
...
cond.end2774:                                     ; preds = %if.end2728
  ...
  store ptr %588, ptr @zz_tmp, align 8
  %589 = load ptr, ptr %586, align 8
  store ptr %589, ptr %587, align 8
  %590 = load ptr, ptr @zz_hold, align 8
  %591 = load ptr, ptr @zz_res, align 8
  %592 = load ptr, ptr %591, align 8
  %osucc2765 = getelementptr inbounds %struct.LIST, ptr %592, i64 0, i32 1
  store ptr %590, ptr %osucc2765, align 8
  %593 = load ptr, ptr @zz_tmp, align 8
  store ptr %593, ptr %591, align 8
  %594 = load ptr, ptr @zz_res, align 8
  %595 = load ptr, ptr @zz_tmp, align 8
  %osucc2771 = getelementptr inbounds %struct.LIST, ptr %595, i64 0, i32 1
  store ptr %594, ptr %osucc2771, align 8
  %.pr9147 = load ptr, ptr @xx_link, align 8
  store ptr %.pr9147, ptr @zz_res, align 8
  store ptr %581, ptr @zz_hold, align 8
...
cond.end2774.cond.false2783_crit_edge:            ; preds = %cond.end2774
  ...
  %.pre9434 = load ptr, ptr %arrayidx2788.phi.trans.insert, align 8
  br label %cond.false2783
...
cond.false2783:                                   ; preds = %cond.end2774.cond.false2783_crit_edge, %cond.end2774.thread
  ...
  %598 = load ptr, ptr %arrayidx2694, align 8
  store ptr %598, ptr @zz_tmp, align 8
  %arrayidx2788 = getelementptr inbounds [2 x %struct.LIST], ptr %597, i64 0, i64 1
  store ptr %596, ptr %arrayidx2694, align 8
  %599 = load ptr, ptr %arrayidx2788, align 8
  %osucc2798 = getelementptr inbounds [2 x %struct.LIST], ptr %599, i64 0, i64 1, i32 1
  store ptr %581, ptr %osucc2798, align 8
  store ptr %598, ptr %arrayidx2788, align 8
  %osucc2804 = getelementptr inbounds [2 x %struct.LIST], ptr %598, i64 0, i64 1, i32 1
  store ptr %597, ptr %osucc2804, align 8
...
if.else2814:                                      ; preds = %for.end2636
  ...
  store i32 %div2822, ptr %arrayidx2826, align 4
  ...
  %602 = load i32, ptr %arrayidx2830, align 4
  %603 = load i32, ptr %ofc2820, align 8
  ...
  store i32 %div2834, ptr %arrayidx2838, align 4
...
for.cond2852:                                     ; preds = %for.cond2852, %sw.bb2845
  ...
  %605 = load i8, ptr %ou12853, align 8
  %cmp2856 = icmp eq i8 %605, 0
  br i1 %cmp2856, label %for.cond2852, label %for.end2863
...
for.cond2890:                                     ; preds = %for.cond2890, %if.then2867
  ...
  %609 = load i8, ptr %ou12891, align 8
  %cmp2894 = icmp eq i8 %609, 0
  br i1 %cmp2894, label %for.cond2890, label %while.cond
...
while.body:                                       ; preds = %while.cond
  ...
  %611 = load ptr, ptr %osucc2909, align 8
...
for.cond2945:                                     ; preds = %for.cond2945, %if.end2938
  ...
  %615 = load i8, ptr %ou12946, align 8
  %cmp2949 = icmp eq i8 %615, 0
  br i1 %cmp2949, label %for.cond2945, label %while.cond2957
...
for.cond2970:                                     ; preds = %for.cond2970, %while.body2963
  ...
  %618 = load i8, ptr %ou12971, align 8
  %cmp2974 = icmp eq i8 %618, 0
  br i1 %cmp2974, label %for.cond2970, label %while.cond2957.loopexit
...
if.end3000:                                       ; preds = %while.cond2957, %while.cond2957
  ...
  %619 = load i8, ptr %arrayidx2999, align 1
...
if.then3008:                                      ; preds = %if.end3000
  ...
  store i32 %add3017, ptr %ofwd2881, align 4
  br label %sw.epilog7697
...
if.else3019:                                      ; preds = %for.end2863
  ...
  %620 = load i32, ptr %arrayidx3023, align 4
  ...
  store i32 %620, ptr %arrayidx3027, align 4
  ...
  %621 = load i32, ptr %arrayidx3031, align 4
...
for.cond3044:                                     ; preds = %for.cond3044, %sw.bb3037
  ...
  %623 = load i8, ptr %ou13045, align 8
  %cmp3048 = icmp eq i8 %623, 0
  br i1 %cmp3048, label %for.cond3044, label %for.end3055
...
if.then3059:                                      ; preds = %for.end3055
  ...
  %624 = load i32, ptr %ou33062, align 4
  %625 = load i32, ptr %ou43060, align 8
...
land.lhs.true3084:                                ; preds = %land.lhs.true3070
  ...
  %628 = load i32, ptr %ofc3090, align 8
...
if.then3093:                                      ; preds = %land.lhs.true3084, %land.lhs.true3070, %if.then3059
  %629 = load ptr, ptr @no_fpos, align 8
  ...
  %.pre9431 = load i32, ptr %ou33062, align 4
  br label %if.end3095
...
if.else3121:                                      ; preds = %for.end3055
  ...
  %632 = load i32, ptr %arrayidx3125, align 4
  ...
  store i32 %632, ptr %arrayidx3129, align 4
  ...
  %633 = load i32, ptr %arrayidx3133, align 4
...
for.cond3146:                                     ; preds = %for.cond3146, %sw.bb3139
  ...
  %635 = load i8, ptr %ou13147, align 8
  %cmp3150 = icmp eq i8 %635, 0
  br i1 %cmp3150, label %for.cond3146, label %for.end3157
...
if.then3161:                                      ; preds = %for.end3157
  ...
  %636 = load i32, ptr %arrayidx3165, align 4
  %ou43166 = getelementptr inbounds %struct.closure_type, ptr %x, i64 0, i32 4
  %637 = load i32, ptr %ou43166, align 8
...
if.then3161.if.then3193_crit_edge:                ; preds = %if.then3161
  ...
  %.pre9429 = load i32, ptr %obfc3196.phi.trans.insert, align 4
...
land.lhs.true3184:                                ; preds = %land.lhs.true3170
  ...
  %640 = load i32, ptr %ofc3190, align 8
...
if.then3193:                                      ; preds = %if.then3161.if.then3193_crit_edge, %land.lhs.true3184, %land.lhs.true3170
  ...
  store i32 8388607, ptr %ou43166, align 8
  %644 = load i32, ptr %arrayidx3165, align 4
  %645 = load i32, ptr %arrayidx3205, align 4
  %add3219 = add nsw i32 %645, %644
  store i32 %add3219, ptr %obfc3196, align 4
  %ofc3223 = getelementptr inbounds %struct.closure_type, ptr %x, i64 0, i32 4, i32 0, i32 2
  store i32 8388607, ptr %ofc3223, align 8
  %.pre9430 = load i32, ptr %arrayidx3165, align 4
  br label %if.end3224
...
if.else3250:                                      ; preds = %for.end3157
  ...
  %648 = load i32, ptr %arrayidx3254, align 4
  ...
  store i32 %648, ptr %arrayidx3258, align 4
  ...
  %649 = load i32, ptr %arrayidx3262, align 4
...
for.cond3275:                                     ; preds = %for.cond3275, %sw.bb3268
  ...
  %651 = load i8, ptr %ou13276, align 8
  %cmp3279 = icmp eq i8 %651, 0
  br i1 %cmp3279, label %for.cond3275, label %for.end3286
...
if.then3297:                                      ; preds = %for.end3286
  ...
  store i32 %call3298, ptr %f, align 4
  ...
  %653 = load i32, ptr %arrayidx3302, align 4
  %add3303 = add nsw i32 %653, %call3298
  %spec.select9035 = tail call i32 @llvm.smax.i32(i32 %add3303, i32 0)
  %spec.select9166 = tail call i32 @llvm.smin.i32(i32 %spec.select9035, i32 8388607)
  ...
  store i32 %spec.select9166, ptr %arrayidx3340, align 4
  ...
  %654 = load i32, ptr %arrayidx3344, align 4
  ...
  store i32 %cond3378, ptr %arrayidx3382, align 4
  br label %sw.epilog7697
...
if.else3383:                                      ; preds = %for.end3286
  ...
  %655 = load i32, ptr %arrayidx3387, align 4
  ...
  store i32 %655, ptr %arrayidx3391, align 4
  ...
  %656 = load i32, ptr %arrayidx3395, align 4
  ...
  store i32 %656, ptr %arrayidx3399, align 4
  br label %sw.epilog7697
...
sw.bb3401:                                        ; preds = %entry
  ...
  %cond3413 = load ptr, ptr %cond3413.in, align 8
...
for.cond3417:                                     ; preds = %for.cond3417, %sw.bb3401
  ...
  %657 = load i8, ptr %ou13418, align 8
  %cmp3421 = icmp eq i8 %657, 0
  br i1 %cmp3421, label %for.cond3417, label %for.end3428
...
for.end3428:                                      ; preds = %for.cond3417
  ...
  %658 = load i32, ptr %arrayidx3433, align 4
  ...
  store i32 %658, ptr %arrayidx3437, align 4
  ...
  %659 = load i32, ptr %arrayidx3441, align 4
  ...
  store i32 %659, ptr %arrayidx3445, align 4
  br label %sw.epilog7697
...
for.cond3457.preheader:                           ; preds = %sw.bb3446
  %osucc34609255 = getelementptr inbounds %struct.LIST, ptr %x, i64 0, i32 1
  %661 = load ptr, ptr %osucc34609255, align 8
  %cmp3461.not9256 = icmp eq ptr %661, %x
  br i1 %cmp3461.not9256, label %sw.bb5279, label %for.cond3470.preheader

for.cond3470.preheader:                           ; preds = %for.cond3457.preheader, %for.inc3680
  %662 = phi ptr [ %701, %for.inc3680 ], [ %661, %for.cond3457.preheader ]
  %link.09257 = phi ptr [ %700, %for.inc3680 ], [ %x, %for.cond3457.preheader ]
...
for.cond3470:                                     ; preds = %for.cond3470.preheader, %for.cond3470
  ...
  %663 = load i8, ptr %ou13471, align 8
...
if.then3487:                                      ; preds = %for.cond3470
  ...
  %664 = load ptr, ptr %osucc3491, align 8
...
cond.end3539:                                     ; preds = %if.then3505, %if.then3499
  store ptr %664, ptr @zz_res, align 8
  store ptr %y.24, ptr @zz_hold, align 8
  %667 = load ptr, ptr %y.24, align 8
  store ptr %667, ptr @zz_tmp, align 8
  %668 = load ptr, ptr %664, align 8
  store ptr %668, ptr %y.24, align 8
  %669 = load ptr, ptr @zz_hold, align 8
  %670 = load ptr, ptr @zz_res, align 8
  %671 = load ptr, ptr %670, align 8
  %osucc3530 = getelementptr inbounds %struct.LIST, ptr %671, i64 0, i32 1
  store ptr %669, ptr %osucc3530, align 8
  %672 = load ptr, ptr @zz_tmp, align 8
  store ptr %672, ptr %670, align 8
  %673 = load ptr, ptr @zz_res, align 8
  %674 = load ptr, ptr @zz_tmp, align 8
  %osucc3536 = getelementptr inbounds %struct.LIST, ptr %674, i64 0, i32 1
  store ptr %673, ptr %osucc3536, align 8
  store ptr %664, ptr @zz_res, align 8
  store ptr %662, ptr @zz_hold, align 8
...
cond.false3548:                                   ; preds = %cond.end3539
  ...
  store ptr %675, ptr @zz_tmp, align 8
  %676 = load ptr, ptr %664, align 8
  store ptr %676, ptr %662, align 8
  %677 = load ptr, ptr @zz_hold, align 8
  %678 = load ptr, ptr @zz_res, align 8
  %679 = load ptr, ptr %678, align 8
  %osucc3563 = getelementptr inbounds %struct.LIST, ptr %679, i64 0, i32 1
  store ptr %677, ptr %osucc3563, align 8
  %680 = load ptr, ptr @zz_tmp, align 8
  store ptr %680, ptr %678, align 8
  %681 = load ptr, ptr @zz_res, align 8
  %682 = load ptr, ptr @zz_tmp, align 8
  %osucc3569 = getelementptr inbounds %struct.LIST, ptr %682, i64 0, i32 1
  store ptr %681, ptr %osucc3569, align 8
  br label %if.end3574
...
cond.false3614:                                   ; preds = %cond.end3606
  ...
  store ptr %689, ptr %osucc3629, align 8
  %osucc3632 = getelementptr inbounds %struct.LIST, ptr %690, i64 0, i32 1
  store ptr %690, ptr %osucc3632, align 8
...
cond.end3636:                                     ; preds = %cond.end3606, %cond.false3614
  ...
  %693 = load i8, ptr %ou13638, align 8
...
if.end3675:                                       ; preds = %if.then3673, %cond.end3636
  %699 = load ptr, ptr %link.09257, align 8
  br label %for.inc3680

for.inc3680:                                      ; preds = %for.cond3470, %if.end3675
  %link.1 = phi ptr [ %699, %if.end3675 ], [ %link.09257, %for.cond3470 ]
  %osucc3683 = getelementptr inbounds %struct.LIST, ptr %link.1, i64 0, i32 1
  %700 = load ptr, ptr %osucc3683, align 8
  %osucc3460 = getelementptr inbounds %struct.LIST, ptr %700, i64 0, i32 1
  %701 = load ptr, ptr %osucc3460, align 8
  %cmp3461.not = icmp eq ptr %701, %x
  br i1 %cmp3461.not, label %for.end3684, label %for.cond3470.preheader

for.end3684:                                      ; preds = %for.inc3680
  %link.29258.pre = load ptr, ptr %osucc34609255, align 8
  %cmp3689.not9259 = icmp eq ptr %link.29258.pre, %x
  br i1 %cmp3689.not9259, label %sw.bb5279, label %for.cond3695.preheader

for.cond3695.preheader:                           ; preds = %for.end3684, %for.inc3745
  %link.29261 = phi ptr [ %link.2, %for.inc3745 ], [ %link.29258.pre, %for.end3684 ]
  br label %for.cond3695

for.cond3695:                                     ; preds = %for.cond3695.preheader, %for.cond3695
  %link.2.pn = phi ptr [ %y.25, %for.cond3695 ], [ %link.29261, %for.cond3695.preheader ]
  %y.25.in = getelementptr inbounds [2 x %struct.LIST], ptr %link.2.pn, i64 0, i64 1
  %y.25 = load ptr, ptr %y.25.in, align 8
  %ou13696 = getelementptr inbounds %struct.word_type, ptr %y.25, i64 0, i32 1
  %702 = load i8, ptr %ou13696, align 8
...
for.inc3745:                                      ; preds = %for.cond3695, %cond.false3728, %cond.true3725
  %osucc3748 = getelementptr inbounds %struct.LIST, ptr %link.29261, i64 0, i32 1
  %link.2 = load ptr, ptr %osucc3748, align 8
  %cmp3689.not = icmp eq ptr %link.2, %x
  br i1 %cmp3689.not, label %sw.bb5279, label %for.cond3695.preheader

for.cond3756.preheader:                           ; preds = %cond.true3725, %cond.false3728
  %link.3.in9263 = getelementptr inbounds %struct.LIST, ptr %link.29261, i64 0, i32 1
  %link.39264 = load ptr, ptr %link.3.in9263, align 8
  %cmp3757.not9265 = icmp eq ptr %link.39264, %x
  br i1 %cmp3757.not9265, label %sw.bb5279, label %for.cond3763.preheader

for.cond3763.preheader:                           ; preds = %for.cond3756.preheader, %for.inc3822
  %link.39268 = phi ptr [ %link.3, %for.inc3822 ], [ %link.39264, %for.cond3756.preheader ]
  %g3455.09266 = phi ptr [ %g3455.1, %for.inc3822 ], [ null, %for.cond3756.preheader ]
  br label %for.cond3763

for.cond3763:                                     ; preds = %for.cond3763.preheader, %for.cond3763
  %link.3.pn = phi ptr [ %y.26, %for.cond3763 ], [ %link.39268, %for.cond3763.preheader ]
  ...
  %704 = load i8, ptr %ou13764, align 8
...
if.then3814:                                      ; preds = %cond.false3800, %cond.true3797
  %cmp3815.not = icmp eq ptr %g3455.09266, null
...
for.inc3822:                                      ; preds = %for.cond3763, %cond.false3800, %cond.true3797
  %g3455.1 = phi ptr [ %g3455.09266, %cond.true3797 ], [ %g3455.09266, %cond.false3800 ], [ %y.26, %for.cond3763 ]
  %link.3.in = getelementptr inbounds %struct.LIST, ptr %link.39268, i64 0, i32 1
  %link.3 = load ptr, ptr %link.3.in, align 8
  %cmp3757.not = icmp eq ptr %link.3, %x
  br i1 %cmp3757.not, label %sw.bb5279, label %for.cond3763.preheader

for.end3826:                                      ; preds = %if.then3814, %if.then3817
  %cmp3828.not9278 = icmp eq ptr %link.39268, %x
  br i1 %cmp3828.not9278, label %sw.bb5279, label %while.body3830.lr.ph
...
while.body3830:                                   ; preds = %while.body3830.lr.ph, %for.end5168
  %link.49281 = phi ptr [ %link.39268, %while.body3830.lr.ph ], [ %link.59275, %for.end5168 ]
  %res.09280 = phi ptr [ null, %while.body3830.lr.ph ], [ %res.2, %for.end5168 ]
  %g3455.29279 = phi ptr [ %g3455.09266, %while.body3830.lr.ph ], [ %g3455.39273, %for.end5168 ]
  %ogap3831 = getelementptr inbounds %struct.gapobj_type, ptr %g3455.29279, i64 0, i32 3
...
land.lhs.true3837:                                ; preds = %while.body3830
  %ovspace = getelementptr inbounds i8, ptr %g3455.29279, i64 42
  %707 = load i8, ptr %ovspace, align 2
...
land.lhs.true3850:                                ; preds = %lor.lhs.false3842
  %owidth = getelementptr inbounds %struct.gapobj_type, ptr %g3455.29279, i64 0, i32 3, i32 1
  %709 = load i16, ptr %owidth, align 2
...
if.end3881:                                       ; preds = %if.then3870, %if.else3872
  ...
  store ptr %x, ptr @zz_hold, align 8
  %715 = load ptr, ptr %osucc3902, align 8
...
cond.end3928.thread:                              ; preds = %if.end3881
  store ptr null, ptr @xx_tmp, align 8
  store ptr %714, ptr @zz_res, align 8
  store ptr null, ptr @zz_hold, align 8
  br label %if.end3963

cond.false3937:                                   ; preds = %if.end3881
  %716 = load ptr, ptr %arrayidx3911, align 8
  %arrayidx3914 = getelementptr inbounds [2 x %struct.LIST], ptr %715, i64 0, i64 1
  store ptr %716, ptr %arrayidx3914, align 8
  %717 = load ptr, ptr %arrayidx3911, align 8
  %osucc3921 = getelementptr inbounds [2 x %struct.LIST], ptr %717, i64 0, i64 1, i32 1
  store ptr %715, ptr %osucc3921, align 8
  store ptr %x, ptr %osucc3902, align 8
  store ptr %x, ptr %arrayidx3911, align 8
  store ptr %715, ptr @xx_tmp, align 8
  store ptr %714, ptr @zz_res, align 8
  store ptr %715, ptr @zz_hold, align 8
  %718 = load ptr, ptr %arrayidx3914, align 8
  store ptr %718, ptr @zz_tmp, align 8
  %719 = load ptr, ptr %arrayidx3888, align 8
  store ptr %719, ptr %arrayidx3914, align 8
  %720 = load ptr, ptr %arrayidx3888, align 8
  %osucc3952 = getelementptr inbounds [2 x %struct.LIST], ptr %720, i64 0, i64 1, i32 1
  store ptr %715, ptr %osucc3952, align 8
  store ptr %718, ptr %arrayidx3888, align 8
  %osucc3958 = getelementptr inbounds [2 x %struct.LIST], ptr %718, i64 0, i64 1, i32 1
  store ptr %714, ptr %osucc3958, align 8
  br label %if.end3963

if.end3963:                                       ; preds = %cond.end3928.thread, %cond.false3937, %if.then3855
  %721 = phi ptr [ %714, %cond.false3937 ], [ %res.09280, %if.then3855 ], [ %714, %cond.end3928.thread ]
  %722 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 17), align 1
  %conv3964 = zext i8 %722 to i32
  store i32 %conv3964, ptr @zz_size, align 4
  %conv3965 = zext i8 %722 to i64
  %arrayidx3972 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv3965
  %723 = load ptr, ptr %arrayidx3972, align 8
  %cmp3973 = icmp eq ptr %723, null
  br i1 %cmp3973, label %if.then3975, label %if.else3977

if.then3975:                                      ; preds = %if.end3963
  %724 = load ptr, ptr @no_fpos, align 8
  %call3976 = tail call ptr @GetMemory(i32 noundef %conv3964, ptr noundef %724) #8
  store ptr %call3976, ptr @zz_hold, align 8
  br label %if.end3986

if.else3977:                                      ; preds = %if.end3963
  store ptr %723, ptr @zz_hold, align 8
  ...
  store ptr %725, ptr %arrayidx3984, align 8
  br label %if.end3986
...
if.end3986:                                       ; preds = %if.then3975, %if.else3977
  ...
  store i8 17, ptr %ou13987, align 8
  ...
  store ptr %726, ptr %osucc3991, align 8
  store ptr %726, ptr %arrayidx3990, align 8
  %osucc3997 = getelementptr inbounds %struct.LIST, ptr %726, i64 0, i32 1
  store ptr %726, ptr %osucc3997, align 8
  store ptr %726, ptr %726, align 8
  %727 = load ptr, ptr %osucc34609255, align 8
  %osucc4008 = getelementptr inbounds [2 x %struct.LIST], ptr %g3455.29279, i64 0, i64 1, i32 1
  %728 = load ptr, ptr %osucc4008, align 8
...
if.end4020:                                       ; preds = %if.then4018, %if.then4012
  store ptr %727, ptr @zz_res, align 8
  store ptr %728, ptr @zz_hold, align 8
...
cond.false4028:                                   ; preds = %if.end4020
  ...
  store ptr %731, ptr @zz_tmp, align 8
  %732 = load ptr, ptr %727, align 8
  store ptr %732, ptr %728, align 8
  %733 = load ptr, ptr @zz_hold, align 8
  %734 = load ptr, ptr @zz_res, align 8
  %735 = load ptr, ptr %734, align 8
  %osucc4043 = getelementptr inbounds %struct.LIST, ptr %735, i64 0, i32 1
  store ptr %733, ptr %osucc4043, align 8
  %736 = load ptr, ptr @zz_tmp, align 8
  store ptr %736, ptr %734, align 8
  %737 = load ptr, ptr @zz_res, align 8
  %738 = load ptr, ptr @zz_tmp, align 8
  %osucc4049 = getelementptr inbounds %struct.LIST, ptr %738, i64 0, i32 1
  store ptr %737, ptr %osucc4049, align 8
  br label %cond.false4061

cond.false4061:                                   ; preds = %cond.false4028, %if.end4020
  store ptr %727, ptr @zz_res, align 8
  store ptr %726, ptr @zz_hold, align 8
  %739 = load ptr, ptr %726, align 8
  store ptr %739, ptr @zz_tmp, align 8
  %740 = load ptr, ptr %727, align 8
  store ptr %740, ptr %726, align 8
  %741 = load ptr, ptr @zz_hold, align 8
  %742 = load ptr, ptr @zz_res, align 8
  %743 = load ptr, ptr %742, align 8
  %osucc4076 = getelementptr inbounds %struct.LIST, ptr %743, i64 0, i32 1
  store ptr %741, ptr %osucc4076, align 8
  %744 = load ptr, ptr @zz_tmp, align 8
  store ptr %744, ptr %742, align 8
  %745 = load ptr, ptr @zz_res, align 8
  %746 = load ptr, ptr @zz_tmp, align 8
  %osucc4082 = getelementptr inbounds %struct.LIST, ptr %746, i64 0, i32 1
  store ptr %745, ptr %osucc4082, align 8
  br label %if.end4087
...
if.else4440:                                      ; preds = %if.end4087
  ...
  store ptr %756, ptr %arrayidx4447, align 8
  br label %cond.end4495
...
cond.end4495:                                     ; preds = %if.then4438, %if.else4440
  ...
  store i8 0, ptr %ou14450, align 8
  %osucc4454 = getelementptr inbounds [2 x %struct.LIST], ptr %757, i64 0, i64 1, i32 1
  store ptr %757, ptr %osucc4454, align 8
  %arrayidx4456 = getelementptr inbounds [2 x %struct.LIST], ptr %757, i64 0, i64 1
  store ptr %757, ptr %arrayidx4456, align 8
  %osucc4460 = getelementptr inbounds %struct.LIST, ptr %757, i64 0, i32 1
  store ptr %757, ptr %osucc4460, align 8
  store ptr %757, ptr %757, align 8
  store ptr %757, ptr @xx_link, align 8
  store ptr %757, ptr @zz_res, align 8
  store ptr %721, ptr @zz_hold, align 8
  %758 = load ptr, ptr %721, align 8
  store ptr %758, ptr @zz_tmp, align 8
  %759 = load ptr, ptr %757, align 8
  store ptr %759, ptr %721, align 8
  %760 = load ptr, ptr @zz_hold, align 8
  %761 = load ptr, ptr @zz_res, align 8
  %762 = load ptr, ptr %761, align 8
  %osucc4486 = getelementptr inbounds %struct.LIST, ptr %762, i64 0, i32 1
  store ptr %760, ptr %osucc4486, align 8
  %763 = load ptr, ptr @zz_tmp, align 8
  store ptr %763, ptr %761, align 8
  %764 = load ptr, ptr @zz_res, align 8
  %765 = load ptr, ptr @zz_tmp, align 8
  %osucc4492 = getelementptr inbounds %struct.LIST, ptr %765, i64 0, i32 1
  store ptr %764, ptr %osucc4492, align 8
  %766 = load ptr, ptr @xx_link, align 8
  store ptr %766, ptr @zz_res, align 8
  store ptr %726, ptr @zz_hold, align 8
  %cmp4501 = icmp eq ptr %766, null
  br i1 %cmp4501, label %cond.end4528, label %cond.false4504

cond.false4504:                                   ; preds = %cond.end4495
  %767 = load ptr, ptr %arrayidx3990, align 8
  store ptr %767, ptr @zz_tmp, align 8
  %arrayidx4509 = getelementptr inbounds [2 x %struct.LIST], ptr %766, i64 0, i64 1
  %768 = load ptr, ptr %arrayidx4509, align 8
  store ptr %768, ptr %arrayidx3990, align 8
  %769 = load ptr, ptr %arrayidx4509, align 8
  %osucc4519 = getelementptr inbounds [2 x %struct.LIST], ptr %769, i64 0, i64 1, i32 1
  store ptr %726, ptr %osucc4519, align 8
  store ptr %767, ptr %arrayidx4509, align 8
  %osucc4525 = getelementptr inbounds [2 x %struct.LIST], ptr %767, i64 0, i64 1, i32 1
  store ptr %766, ptr %osucc4525, align 8
  br label %cond.end4528

cond.end4528:                                     ; preds = %cond.end4495, %cond.false4504
  %ohspace = getelementptr inbounds i8, ptr %g3455.29279, i64 41
  %770 = load i8, ptr %ohspace, align 1
  %cmp4532.not = icmp eq i8 %770, 0
  br i1 %cmp4532.not, label %if.end4941, label %if.then4534

if.then4534:                                      ; preds = %cond.end4528
  %ou14535 = getelementptr inbounds %struct.word_type, ptr %g3455.29279, i64 0, i32 1
  ...
  %771 = lshr i32 %bf.load4570, 1
  %bf.shl4576 = and i32 %771, 528482304
  ...
  store i32 0, ptr %ofwd4597, align 8
  store i32 0, ptr %ou34596, align 8
  %772 = load i8, ptr @zz_lengths, align 1
  %conv4602 = zext i8 %772 to i32
  store i32 %conv4602, ptr @zz_size, align 4
  %conv4603 = zext i8 %772 to i64
  %arrayidx4610 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv4603
  %773 = load ptr, ptr %arrayidx4610, align 8
  %cmp4611 = icmp eq ptr %773, null
  br i1 %cmp4611, label %if.then4613, label %if.else4615

if.then4613:                                      ; preds = %if.then4534
  %774 = load ptr, ptr @no_fpos, align 8
  %call4614 = tail call ptr @GetMemory(i32 noundef %conv4602, ptr noundef %774) #8
  br label %if.end4624

if.else4615:                                      ; preds = %if.then4534
  store ptr %773, ptr @zz_hold, align 8
  %775 = load ptr, ptr %773, align 8
  %idxprom4621 = zext i8 %772 to i64
  %arrayidx4622 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom4621
  store ptr %775, ptr %arrayidx4622, align 8
  br label %if.end4624

if.end4624:                                       ; preds = %if.then4613, %if.else4615
  %776 = phi ptr [ %call4614, %if.then4613 ], [ %773, %if.else4615 ]
  %ou14625 = getelementptr inbounds %struct.word_type, ptr %776, i64 0, i32 1
  store i8 0, ptr %ou14625, align 8
  %osucc4629 = getelementptr inbounds [2 x %struct.LIST], ptr %776, i64 0, i64 1, i32 1
  store ptr %776, ptr %osucc4629, align 8
  %arrayidx4631 = getelementptr inbounds [2 x %struct.LIST], ptr %776, i64 0, i64 1
  store ptr %776, ptr %arrayidx4631, align 8
  %osucc4635 = getelementptr inbounds %struct.LIST, ptr %776, i64 0, i32 1
  store ptr %776, ptr %osucc4635, align 8
  store ptr %776, ptr %776, align 8
  store ptr %776, ptr @xx_link, align 8
  store ptr %776, ptr @zz_res, align 8
  %777 = load ptr, ptr %osucc34609255, align 8
  store ptr %777, ptr @zz_hold, align 8
  %cmp4642 = icmp eq ptr %777, null
  br i1 %cmp4642, label %cond.end4673.thread, label %cond.end4673

cond.end4673.thread:                              ; preds = %if.end4624
  store ptr %call4536, ptr @zz_hold, align 8
  br label %cond.false4682

cond.end4673:                                     ; preds = %if.end4624
  %778 = load ptr, ptr %777, align 8
  store ptr %778, ptr @zz_tmp, align 8
  %779 = load ptr, ptr %776, align 8
  store ptr %779, ptr %777, align 8
  %780 = load ptr, ptr @zz_hold, align 8
  %781 = load ptr, ptr @zz_res, align 8
  %782 = load ptr, ptr %781, align 8
  %osucc4664 = getelementptr inbounds %struct.LIST, ptr %782, i64 0, i32 1
  store ptr %780, ptr %osucc4664, align 8
  %783 = load ptr, ptr @zz_tmp, align 8
  store ptr %783, ptr %781, align 8
  %784 = load ptr, ptr @zz_res, align 8
  %785 = load ptr, ptr @zz_tmp, align 8
  %osucc4670 = getelementptr inbounds %struct.LIST, ptr %785, i64 0, i32 1
  store ptr %784, ptr %osucc4670, align 8
  %.pre9427 = load ptr, ptr @xx_link, align 8
  store ptr %.pre9427, ptr @zz_res, align 8
  store ptr %call4536, ptr @zz_hold, align 8
  %cmp4679 = icmp eq ptr %.pre9427, null
  br i1 %cmp4679, label %cond.end4706, label %cond.false4682

cond.false4682:                                   ; preds = %cond.end4673.thread, %cond.end4673
  %786 = phi ptr [ %776, %cond.end4673.thread ], [ %.pre9427, %cond.end4673 ]
  %arrayidx4684 = getelementptr inbounds [2 x %struct.LIST], ptr %call4536, i64 0, i64 1
  %787 = load ptr, ptr %arrayidx4684, align 8
  store ptr %787, ptr @zz_tmp, align 8
  %arrayidx4687 = getelementptr inbounds [2 x %struct.LIST], ptr %786, i64 0, i64 1
  %788 = load ptr, ptr %arrayidx4687, align 8
  store ptr %788, ptr %arrayidx4684, align 8
  %789 = load ptr, ptr %arrayidx4687, align 8
  %osucc4697 = getelementptr inbounds [2 x %struct.LIST], ptr %789, i64 0, i64 1, i32 1
  store ptr %call4536, ptr %osucc4697, align 8
  store ptr %787, ptr %arrayidx4687, align 8
  %osucc4703 = getelementptr inbounds [2 x %struct.LIST], ptr %787, i64 0, i64 1, i32 1
  store ptr %786, ptr %osucc4703, align 8
  br label %cond.end4706

cond.end4706:                                     ; preds = %cond.end4673, %cond.false4682
  %790 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 1), align 1
  %conv4708 = zext i8 %790 to i32
  store i32 %conv4708, ptr @zz_size, align 4
  %conv4709 = zext i8 %790 to i64
  %arrayidx4716 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv4709
  %791 = load ptr, ptr %arrayidx4716, align 8
  %cmp4717 = icmp eq ptr %791, null
  br i1 %cmp4717, label %if.then4719, label %if.else4721

if.then4719:                                      ; preds = %cond.end4706
  %792 = load ptr, ptr @no_fpos, align 8
  %call4720 = tail call ptr @GetMemory(i32 noundef %conv4708, ptr noundef %792) #8
  store ptr %call4720, ptr @zz_hold, align 8
  br label %if.end4730

if.else4721:                                      ; preds = %cond.end4706
  store ptr %791, ptr @zz_hold, align 8
  %793 = load ptr, ptr %791, align 8
  %idxprom4727 = zext i8 %790 to i64
  %arrayidx4728 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom4727
  store ptr %793, ptr %arrayidx4728, align 8
  br label %if.end4730

if.end4730:                                       ; preds = %if.then4719, %if.else4721
  %794 = phi ptr [ %call4720, %if.then4719 ], [ %791, %if.else4721 ]
  %ou14731 = getelementptr inbounds %struct.word_type, ptr %794, i64 0, i32 1
  store i8 1, ptr %ou14731, align 8
  %arrayidx4734 = getelementptr inbounds [2 x %struct.LIST], ptr %794, i64 0, i64 1
  %osucc4735 = getelementptr inbounds [2 x %struct.LIST], ptr %794, i64 0, i64 1, i32 1
  store ptr %794, ptr %osucc4735, align 8
  store ptr %794, ptr %arrayidx4734, align 8
  %osucc4741 = getelementptr inbounds %struct.LIST, ptr %794, i64 0, i32 1
  store ptr %794, ptr %osucc4741, align 8
  store ptr %794, ptr %794, align 8
  %795 = load i8, ptr %ohspace, align 1
  %ou24747 = getelementptr inbounds %struct.word_type, ptr %794, i64 0, i32 2
  %ohspace4748 = getelementptr inbounds i8, ptr %794, i64 41
  store i8 %795, ptr %ohspace4748, align 1
  %ovspace4750 = getelementptr inbounds i8, ptr %794, i64 42
  store i8 0, ptr %ovspace4750, align 2
  ...
  %ogap4761 = getelementptr inbounds %struct.gapobj_type, ptr %794, i64 0, i32 3
  ...
  %796 = load i16, ptr %owidth4286, align 2
  %owidth4823 = getelementptr inbounds %struct.gapobj_type, ptr %794, i64 0, i32 3, i32 1
  %797 = trunc i32 %bf.load4752 to i16
  %798 = lshr i16 %797, 8
  %mul4830 = mul i16 %796, %798
  store i16 %mul4830, ptr %owidth4823, align 2
  %799 = load i8, ptr @zz_lengths, align 1
  %conv4832 = zext i8 %799 to i32
  store i32 %conv4832, ptr @zz_size, align 4
  %conv4833 = zext i8 %799 to i64
  %arrayidx4840 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv4833
  %800 = load ptr, ptr %arrayidx4840, align 8
  %cmp4841 = icmp eq ptr %800, null
  br i1 %cmp4841, label %if.then4843, label %if.else4845

if.then4843:                                      ; preds = %if.end4730
  %801 = load ptr, ptr @no_fpos, align 8
  %call4844 = tail call ptr @GetMemory(i32 noundef %conv4832, ptr noundef %801) #8
  br label %if.end4854

if.else4845:                                      ; preds = %if.end4730
  store ptr %800, ptr @zz_hold, align 8
  %802 = load ptr, ptr %800, align 8
  %idxprom4851 = zext i8 %799 to i64
  %arrayidx4852 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom4851
  store ptr %802, ptr %arrayidx4852, align 8
  br label %if.end4854

if.end4854:                                       ; preds = %if.then4843, %if.else4845
  %803 = phi ptr [ %call4844, %if.then4843 ], [ %800, %if.else4845 ]
  %ou14855 = getelementptr inbounds %struct.word_type, ptr %803, i64 0, i32 1
  store i8 0, ptr %ou14855, align 8
  %osucc4859 = getelementptr inbounds [2 x %struct.LIST], ptr %803, i64 0, i64 1, i32 1
  store ptr %803, ptr %osucc4859, align 8
  %arrayidx4861 = getelementptr inbounds [2 x %struct.LIST], ptr %803, i64 0, i64 1
  store ptr %803, ptr %arrayidx4861, align 8
  %osucc4865 = getelementptr inbounds %struct.LIST, ptr %803, i64 0, i32 1
  store ptr %803, ptr %osucc4865, align 8
  store ptr %803, ptr %803, align 8
  store ptr %803, ptr @xx_link, align 8
  store ptr %803, ptr @zz_res, align 8
  %804 = load ptr, ptr %osucc34609255, align 8
  %osucc4874 = getelementptr inbounds %struct.LIST, ptr %804, i64 0, i32 1
  %805 = load ptr, ptr %osucc4874, align 8
  store ptr %805, ptr @zz_hold, align 8
  %cmp4875 = icmp eq ptr %805, null
  br i1 %cmp4875, label %cond.false4915, label %cond.end4906

cond.end4906:                                     ; preds = %if.end4854
  %806 = load ptr, ptr %805, align 8
  store ptr %806, ptr @zz_tmp, align 8
  %807 = load ptr, ptr %803, align 8
  store ptr %807, ptr %805, align 8
  %808 = load ptr, ptr @zz_hold, align 8
  %809 = load ptr, ptr @zz_res, align 8
  %810 = load ptr, ptr %809, align 8
  %osucc4897 = getelementptr inbounds %struct.LIST, ptr %810, i64 0, i32 1
  store ptr %808, ptr %osucc4897, align 8
  %811 = load ptr, ptr @zz_tmp, align 8
  store ptr %811, ptr %809, align 8
  %812 = load ptr, ptr @zz_res, align 8
  %813 = load ptr, ptr @zz_tmp, align 8
  %osucc4903 = getelementptr inbounds %struct.LIST, ptr %813, i64 0, i32 1
  store ptr %812, ptr %osucc4903, align 8
  %.pre9428 = load ptr, ptr @xx_link, align 8
  %cmp4912 = icmp eq ptr %.pre9428, null
  br i1 %cmp4912, label %if.end4941, label %cond.false4915

cond.false4915:                                   ; preds = %if.end4854, %cond.end4906
  %814 = phi ptr [ %.pre9428, %cond.end4906 ], [ %803, %if.end4854 ]
  %815 = load ptr, ptr %arrayidx4734, align 8
  store ptr %815, ptr @zz_tmp, align 8
  %arrayidx4920 = getelementptr inbounds [2 x %struct.LIST], ptr %814, i64 0, i64 1
  %816 = load ptr, ptr %arrayidx4920, align 8
  store ptr %816, ptr %arrayidx4734, align 8
  %817 = load ptr, ptr %arrayidx4920, align 8
  %osucc4930 = getelementptr inbounds [2 x %struct.LIST], ptr %817, i64 0, i64 1, i32 1
  store ptr %794, ptr %osucc4930, align 8
  store ptr %815, ptr %arrayidx4920, align 8
  %osucc4936 = getelementptr inbounds [2 x %struct.LIST], ptr %815, i64 0, i64 1, i32 1
  store ptr %814, ptr %osucc4936, align 8
  br label %if.end4941

if.end4941:                                       ; preds = %cond.end4906, %cond.false4915, %cond.end4528
  %818 = load ptr, ptr %osucc4008, align 8
  store ptr %818, ptr @xx_link, align 8
  store ptr %818, ptr @zz_hold, align 8
  %osucc4947 = getelementptr inbounds %struct.LIST, ptr %818, i64 0, i32 1
  %819 = load ptr, ptr %osucc4947, align 8
  %cmp4948 = icmp eq ptr %819, %818
  br i1 %cmp4948, label %cond.end4973.thread, label %cond.end4973

cond.end4973.thread:                              ; preds = %if.end4941
  store ptr %818, ptr @zz_res, align 8
  store ptr %721, ptr @zz_hold, align 8
  br label %cond.false4982

cond.end4973:                                     ; preds = %if.end4941
  store ptr %819, ptr @zz_res, align 8
  %820 = load ptr, ptr %818, align 8
  store ptr %820, ptr %819, align 8
  %821 = load ptr, ptr @zz_res, align 8
  %822 = load ptr, ptr @zz_hold, align 8
  %823 = load ptr, ptr %822, align 8
  %osucc4966 = getelementptr inbounds %struct.LIST, ptr %823, i64 0, i32 1
  store ptr %821, ptr %osucc4966, align 8
  %osucc4969 = getelementptr inbounds %struct.LIST, ptr %822, i64 0, i32 1
  store ptr %822, ptr %osucc4969, align 8
  store ptr %822, ptr %822, align 8
  %.pr9155 = load ptr, ptr @xx_link, align 8
  store ptr %.pr9155, ptr @zz_res, align 8
  store ptr %721, ptr @zz_hold, align 8
  %cmp4979 = icmp eq ptr %.pr9155, null
  br i1 %cmp4979, label %cond.end5006, label %cond.false4982

cond.false4982:                                   ; preds = %cond.end4973.thread, %cond.end4973
  %824 = phi ptr [ %818, %cond.end4973.thread ], [ %.pr9155, %cond.end4973 ]
  %825 = load ptr, ptr %721, align 8
  store ptr %825, ptr @zz_tmp, align 8
  %826 = load ptr, ptr %824, align 8
  store ptr %826, ptr %721, align 8
  %827 = load ptr, ptr @zz_hold, align 8
  %828 = load ptr, ptr @zz_res, align 8
  %829 = load ptr, ptr %828, align 8
  %osucc4997 = getelementptr inbounds %struct.LIST, ptr %829, i64 0, i32 1
  store ptr %827, ptr %osucc4997, align 8
  %830 = load ptr, ptr @zz_tmp, align 8
  store ptr %830, ptr %828, align 8
  %831 = load ptr, ptr @zz_res, align 8
  %832 = load ptr, ptr @zz_tmp, align 8
  %osucc5003 = getelementptr inbounds %struct.LIST, ptr %832, i64 0, i32 1
  store ptr %831, ptr %osucc5003, align 8
...
cond.end5006:                                     ; preds = %cond.end4973, %cond.false4982
  ...
  %833 = load i16, ptr %owidth4157, align 2
  %owidth5076 = getelementptr inbounds %struct.gapobj_type, ptr %g3455.29279, i64 0, i32 3, i32 1
  %834 = load i8, ptr %ovspace, align 2
  %narrow = tail call i8 @llvm.umax.i8(i8 %834, i8 1)
  %spec.select9040 = zext i8 %narrow to i16
  %mul5092 = mul i16 %833, %spec.select9040
  store i16 %mul5092, ptr %owidth5076, align 2
  br label %if.end5094

if.end5094:                                       ; preds = %cond.end5006, %land.lhs.true3850, %lor.lhs.false3842, %while.body3830
  %res.2 = phi ptr [ %721, %cond.end5006 ], [ %res.09280, %land.lhs.true3850 ], [ %res.09280, %lor.lhs.false3842 ], [ %res.09280, %while.body3830 ]
  %link.5.in9270 = getelementptr inbounds %struct.LIST, ptr %link.49281, i64 0, i32 1
  %link.59271 = load ptr, ptr %link.5.in9270, align 8
  %cmp5099.not9272 = icmp eq ptr %link.59271, %x
  br i1 %cmp5099.not9272, label %while.end5169, label %for.cond5105.preheader

for.cond5105.preheader:                           ; preds = %if.end5094, %for.inc5164
  %link.59275 = phi ptr [ %link.5, %for.inc5164 ], [ %link.59271, %if.end5094 ]
  %g3455.39273 = phi ptr [ %g3455.4, %for.inc5164 ], [ null, %if.end5094 ]
  br label %for.cond5105

for.cond5105:                                     ; preds = %for.cond5105.preheader, %for.cond5105
  %link.5.pn = phi ptr [ %y.27, %for.cond5105 ], [ %link.59275, %for.cond5105.preheader ]
  ...
  %835 = load i8, ptr %ou15106, align 8
  switch i8 %835, label %cond.false5142 [
...
cond.false5142:                                   ; preds = %for.cond5105
  %836 = add i8 %835, -9
  %or.cond9041 = icmp ult i8 %836, 91
  br i1 %or.cond9041, label %if.then5156, label %for.inc5164

if.then5156:                                      ; preds = %cond.false5142, %cond.true5139
  %cmp5157.not = icmp eq ptr %g3455.39273, null
  br i1 %cmp5157.not, label %if.then5159, label %for.end5168

if.then5159:                                      ; preds = %if.then5156
  %837 = load ptr, ptr @no_fpos, align 8
  %call5160 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %837, ptr noundef nonnull @.str.16) #8
  br label %for.end5168

for.inc5164:                                      ; preds = %for.cond5105, %cond.false5142, %cond.true5139
  %g3455.4 = phi ptr [ %g3455.39273, %cond.true5139 ], [ %g3455.39273, %cond.false5142 ], [ %y.27, %for.cond5105 ]
  %link.5.in = getelementptr inbounds %struct.LIST, ptr %link.59275, i64 0, i32 1
  %link.5 = load ptr, ptr %link.5.in, align 8
  %cmp5099.not = icmp eq ptr %link.5, %x
  br i1 %cmp5099.not, label %while.end5169, label %for.cond5105.preheader

for.end5168:                                      ; preds = %if.then5156, %if.then5159
  %cmp3828.not = icmp eq ptr %link.59275, %x
  br i1 %cmp3828.not, label %while.end5169, label %while.body3830
...
if.then5172:                                      ; preds = %while.end5169
  %838 = load i8, ptr @zz_lengths, align 1
  %conv5173 = zext i8 %838 to i32
  store i32 %conv5173, ptr @zz_size, align 4
  %conv5174 = zext i8 %838 to i64
  %arrayidx5181 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv5174
  %839 = load ptr, ptr %arrayidx5181, align 8
  %cmp5182 = icmp eq ptr %839, null
  br i1 %cmp5182, label %if.then5184, label %if.else5186

if.then5184:                                      ; preds = %if.then5172
  %840 = load ptr, ptr @no_fpos, align 8
  %call5185 = tail call ptr @GetMemory(i32 noundef %conv5173, ptr noundef %840) #8
  br label %cond.end5241

if.else5186:                                      ; preds = %if.then5172
  store ptr %839, ptr @zz_hold, align 8
  %841 = load ptr, ptr %839, align 8
  store ptr %841, ptr %arrayidx5181, align 8
  br label %cond.end5241

cond.end5241:                                     ; preds = %if.then5184, %if.else5186
  %842 = phi ptr [ %call5185, %if.then5184 ], [ %839, %if.else5186 ]
  %ou15196 = getelementptr inbounds %struct.word_type, ptr %842, i64 0, i32 1
  store i8 0, ptr %ou15196, align 8
  %osucc5200 = getelementptr inbounds [2 x %struct.LIST], ptr %842, i64 0, i64 1, i32 1
  store ptr %842, ptr %osucc5200, align 8
  %arrayidx5202 = getelementptr inbounds [2 x %struct.LIST], ptr %842, i64 0, i64 1
  store ptr %842, ptr %arrayidx5202, align 8
  %osucc5206 = getelementptr inbounds %struct.LIST, ptr %842, i64 0, i32 1
  store ptr %842, ptr %osucc5206, align 8
  store ptr %842, ptr %842, align 8
  store ptr %842, ptr @xx_link, align 8
  store ptr %842, ptr @zz_res, align 8
  store ptr %res.2, ptr @zz_hold, align 8
  %843 = load ptr, ptr %res.2, align 8
  store ptr %843, ptr @zz_tmp, align 8
  %844 = load ptr, ptr %842, align 8
  store ptr %844, ptr %res.2, align 8
  %845 = load ptr, ptr @zz_hold, align 8
  %846 = load ptr, ptr @zz_res, align 8
  %847 = load ptr, ptr %846, align 8
  %osucc5232 = getelementptr inbounds %struct.LIST, ptr %847, i64 0, i32 1
  store ptr %845, ptr %osucc5232, align 8
  %848 = load ptr, ptr @zz_tmp, align 8
  store ptr %848, ptr %846, align 8
  %849 = load ptr, ptr @zz_res, align 8
  %850 = load ptr, ptr @zz_tmp, align 8
  %osucc5238 = getelementptr inbounds %struct.LIST, ptr %850, i64 0, i32 1
  store ptr %849, ptr %osucc5238, align 8
  %851 = load ptr, ptr @xx_link, align 8
  store ptr %851, ptr @zz_res, align 8
  store ptr %x, ptr @zz_hold, align 8
  %cmp5243 = icmp eq ptr %x, null
  %cmp5247 = icmp eq ptr %851, null
...
cond.false5250:                                   ; preds = %cond.end5241
  ...
  %852 = load ptr, ptr %arrayidx5252, align 8
  store ptr %852, ptr @zz_tmp, align 8
  %arrayidx5255 = getelementptr inbounds [2 x %struct.LIST], ptr %851, i64 0, i64 1
  %853 = load ptr, ptr %arrayidx5255, align 8
  store ptr %853, ptr %arrayidx5252, align 8
  %854 = load ptr, ptr %arrayidx5255, align 8
  %osucc5265 = getelementptr inbounds [2 x %struct.LIST], ptr %854, i64 0, i64 1, i32 1
  store ptr %x, ptr %osucc5265, align 8
  store ptr %852, ptr %arrayidx5255, align 8
  %osucc5271 = getelementptr inbounds [2 x %struct.LIST], ptr %852, i64 0, i64 1, i32 1
  store ptr %851, ptr %osucc5271, align 8
  br label %sw.bb5279
...
sw.bb5279:                                        ; preds = %for.inc3745, %for.inc3822, %for.cond3756.preheader, %for.end3826, %for.cond3457.preheader, %for.end3684, %entry, %entry, %while.end5169, %cond.end5241, %cond.false5250, %sw.bb3446
  ...
  %855 = load i8, ptr %ou15282, align 8
  %cmp5285 = icmp ne i8 %855, 19
...
for.cond6491.preheader:                           ; preds = %sw.bb5279
  %link.8.in9283 = getelementptr inbounds %struct.LIST, ptr %x.addr.2, i64 0, i32 1
  %link.89284 = load ptr, ptr %link.8.in9283, align 8
  %cmp6492.not9285 = icmp eq ptr %link.89284, %x.addr.2
  br i1 %cmp6492.not9285, label %if.then6892.thread, label %for.cond6498.preheader.lr.ph

if.then6892.thread:                               ; preds = %for.cond6491.preheader
  %856 = load ptr, ptr @no_fpos, align 8
  %call68939505 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %856, ptr noundef nonnull @.str.23) #8
  br label %if.else6919
...
for.cond6498.preheader.lr.ph:                     ; preds = %for.cond6491.preheader
  ...
  br label %for.cond6498.preheader.outer

for.cond6498.preheader.outer:                     ; preds = %for.inc6886.thread, %for.cond6498.preheader.lr.ph
  %link.89289.ph = phi ptr [ %link.89493, %for.inc6886.thread ], [ %link.89284, %for.cond6498.preheader.lr.ph ]
  %dble_fwd.09288.ph = phi i32 [ %cond6821, %for.inc6886.thread ], [ 0, %for.cond6498.preheader.lr.ph ]
  %857 = phi i1 [ false, %for.inc6886.thread ], [ true, %for.cond6498.preheader.lr.ph ]
  %.ph = phi i32 [ %1024, %for.inc6886.thread ], [ %b.promoted, %for.cond6498.preheader.lr.ph ]
  %.ph9510 = phi i32 [ %1025, %for.inc6886.thread ], [ %f.promoted, %for.cond6498.preheader.lr.ph ]
...
if.then5289:                                      ; preds = %sw.bb5279
  ...
  %link.6.in9294 = getelementptr inbounds %struct.LIST, ptr %x.addr.2, i64 0, i32 1
  %link.69295 = load ptr, ptr %link.6.in9294, align 8
  %cmp5298.not9296 = icmp eq ptr %link.69295, %x.addr.2
  br i1 %cmp5298.not9296, label %if.then6447, label %for.cond5304.preheader.lr.ph
...
for.cond5304.preheader:                           ; preds = %for.cond5304.preheader.lr.ph, %for.inc6440
  %858 = phi ptr [ %link.69295, %for.cond5304.preheader.lr.ph ], [ %link.6, %for.inc6440 ]
  %prev.09299 = phi ptr [ null, %for.cond5304.preheader.lr.ph ], [ %prev.1, %for.inc6440 ]
  %g.09298 = phi ptr [ null, %for.cond5304.preheader.lr.ph ], [ %g.1, %for.inc6440 ]
  %will_expand.09297 = phi i32 [ 0, %for.cond5304.preheader.lr.ph ], [ %will_expand.3, %for.inc6440 ]
  br label %for.cond5304

for.cond5304:                                     ; preds = %for.cond5304.preheader, %for.cond5304
  %link.6.pn = phi ptr [ %y.28, %for.cond5304 ], [ %858, %for.cond5304.preheader ]
  ...
  %859 = load i8, ptr %ou15305, align 8
  %cmp5308 = icmp eq i8 %859, 0
  br i1 %cmp5308, label %for.cond5304, label %for.end5315

for.end5315:                                      ; preds = %for.cond5304
  %ou15305.le = getelementptr inbounds %struct.word_type, ptr %y.28, i64 0, i32 1
  %860 = add i8 %859, -119
  %or.cond9042 = icmp ult i8 %860, 20
...
if.then5330:                                      ; preds = %if.then5327
  ...
  %osucc5336 = getelementptr inbounds %struct.LIST, ptr %861, i64 0, i32 1
  %862 = load ptr, ptr %osucc5336, align 8
  store ptr %862, ptr @xx_link, align 8
  store ptr %862, ptr @zz_hold, align 8
  %osucc5339 = getelementptr inbounds %struct.LIST, ptr %862, i64 0, i32 1
  %863 = load ptr, ptr %osucc5339, align 8
  %cmp5340 = icmp eq ptr %863, %862
  br i1 %cmp5340, label %cond.end5365, label %cond.false5343

cond.false5343:                                   ; preds = %if.then5330
  store ptr %863, ptr @zz_res, align 8
  %864 = load ptr, ptr %862, align 8
  store ptr %864, ptr %863, align 8
  %865 = load ptr, ptr @zz_res, align 8
  %866 = load ptr, ptr @zz_hold, align 8
  %867 = load ptr, ptr %866, align 8
  %osucc5358 = getelementptr inbounds %struct.LIST, ptr %867, i64 0, i32 1
  store ptr %865, ptr %osucc5358, align 8
  %osucc5361 = getelementptr inbounds %struct.LIST, ptr %866, i64 0, i32 1
  store ptr %866, ptr %osucc5361, align 8
  store ptr %866, ptr %866, align 8
  %.pre9448 = load ptr, ptr @xx_link, align 8
  br label %cond.end5365

cond.end5365:                                     ; preds = %if.then5330, %cond.false5343
  %868 = phi ptr [ %862, %if.then5330 ], [ %.pre9448, %cond.false5343 ]
  store ptr %868, ptr @zz_res, align 8
  %869 = load ptr, ptr %extras, align 8
  store ptr %869, ptr @zz_hold, align 8
  %cmp5367 = icmp eq ptr %869, null
  %cmp5371 = icmp eq ptr %868, null
...
cond.false5374:                                   ; preds = %cond.end5365
  ...
  store ptr %870, ptr @zz_tmp, align 8
  %871 = load ptr, ptr %868, align 8
  store ptr %871, ptr %869, align 8
  %872 = load ptr, ptr @zz_hold, align 8
  %873 = load ptr, ptr @zz_res, align 8
  %874 = load ptr, ptr %873, align 8
  %osucc5389 = getelementptr inbounds %struct.LIST, ptr %874, i64 0, i32 1
  store ptr %872, ptr %osucc5389, align 8
  %875 = load ptr, ptr @zz_tmp, align 8
  store ptr %875, ptr %873, align 8
  %876 = load ptr, ptr @zz_res, align 8
  %877 = load ptr, ptr @zz_tmp, align 8
  %osucc5395 = getelementptr inbounds %struct.LIST, ptr %877, i64 0, i32 1
  store ptr %876, ptr %osucc5395, align 8
  br label %for.inc6440

if.else5401:                                      ; preds = %for.end5315
  %878 = load i8, ptr %ou15282, align 8
  %cmp5408 = icmp eq i8 %859, %878
...
if.then5410:                                      ; preds = %if.else5401
  ...
  %880 = load ptr, ptr %osucc5417, align 8
  %osucc5422 = getelementptr inbounds %struct.LIST, ptr %879, i64 0, i32 1
  %881 = load ptr, ptr %osucc5422, align 8
  %cmp5423.not = icmp eq ptr %880, %y.28
  br i1 %cmp5423.not, label %if.end5500, label %if.then5425

if.then5425:                                      ; preds = %if.then5410
  %ou15426 = getelementptr inbounds %struct.word_type, ptr %880, i64 0, i32 1
  %882 = load i8, ptr %ou15426, align 8
  %cmp5429 = icmp eq i8 %882, 0
  br i1 %cmp5429, label %cond.end5465, label %if.then5431

if.then5431:                                      ; preds = %if.then5425
  %883 = load ptr, ptr @no_fpos, align 8
  %call5432 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %883, ptr noundef nonnull @.str.12) #8
  br label %cond.end5465

cond.end5465:                                     ; preds = %if.then5431, %if.then5425
  store ptr %880, ptr @zz_res, align 8
  store ptr %y.28, ptr @zz_hold, align 8
  %884 = load ptr, ptr %y.28, align 8
  store ptr %884, ptr @zz_tmp, align 8
  %885 = load ptr, ptr %880, align 8
  store ptr %885, ptr %y.28, align 8
  %886 = load ptr, ptr @zz_hold, align 8
  %887 = load ptr, ptr @zz_res, align 8
  %888 = load ptr, ptr %887, align 8
  %osucc5456 = getelementptr inbounds %struct.LIST, ptr %888, i64 0, i32 1
  store ptr %886, ptr %osucc5456, align 8
  %889 = load ptr, ptr @zz_tmp, align 8
  store ptr %889, ptr %887, align 8
  %890 = load ptr, ptr @zz_res, align 8
  %891 = load ptr, ptr @zz_tmp, align 8
  %osucc5462 = getelementptr inbounds %struct.LIST, ptr %891, i64 0, i32 1
  store ptr %890, ptr %osucc5462, align 8
  store ptr %880, ptr @zz_res, align 8
  store ptr %881, ptr @zz_hold, align 8
  %cmp5467 = icmp eq ptr %881, null
  br i1 %cmp5467, label %if.end5500, label %cond.false5474

cond.false5474:                                   ; preds = %cond.end5465
  %892 = load ptr, ptr %881, align 8
  store ptr %892, ptr @zz_tmp, align 8
  %893 = load ptr, ptr %880, align 8
  store ptr %893, ptr %881, align 8
  %894 = load ptr, ptr @zz_hold, align 8
  %895 = load ptr, ptr @zz_res, align 8
  %896 = load ptr, ptr %895, align 8
  %osucc5489 = getelementptr inbounds %struct.LIST, ptr %896, i64 0, i32 1
  store ptr %894, ptr %osucc5489, align 8
  %897 = load ptr, ptr @zz_tmp, align 8
  store ptr %897, ptr %895, align 8
  %898 = load ptr, ptr @zz_res, align 8
  %899 = load ptr, ptr @zz_tmp, align 8
  %osucc5495 = getelementptr inbounds %struct.LIST, ptr %899, i64 0, i32 1
  store ptr %898, ptr %osucc5495, align 8
  br label %if.end5500
...
if.end5500:                                       ; preds = %cond.end5465, %cond.false5474, %if.then5410
  ...
  %900 = load ptr, ptr %osucc5503, align 8
  store ptr %900, ptr @xx_link, align 8
  %osucc5506 = getelementptr inbounds [2 x %struct.LIST], ptr %900, i64 0, i64 1, i32 1
  %901 = load ptr, ptr %osucc5506, align 8
  %cmp5507 = icmp eq ptr %901, %900
  br i1 %cmp5507, label %cond.end5532, label %cond.false5510

cond.false5510:                                   ; preds = %if.end5500
  store ptr %901, ptr @zz_res, align 8
  %arrayidx5515 = getelementptr inbounds [2 x %struct.LIST], ptr %900, i64 0, i64 1
  %902 = load ptr, ptr %arrayidx5515, align 8
  %arrayidx5518 = getelementptr inbounds [2 x %struct.LIST], ptr %901, i64 0, i64 1
  store ptr %902, ptr %arrayidx5518, align 8
  %903 = load ptr, ptr %arrayidx5515, align 8
  %osucc5525 = getelementptr inbounds [2 x %struct.LIST], ptr %903, i64 0, i64 1, i32 1
  store ptr %901, ptr %osucc5525, align 8
  store ptr %900, ptr %osucc5506, align 8
  store ptr %900, ptr %arrayidx5515, align 8
  br label %cond.end5532

cond.end5532:                                     ; preds = %if.end5500, %cond.false5510
  %cond5533 = phi ptr [ %901, %cond.false5510 ], [ null, %if.end5500 ]
  store ptr %cond5533, ptr @xx_tmp, align 8
  store ptr %900, ptr @zz_hold, align 8
  %osucc5536 = getelementptr inbounds %struct.LIST, ptr %900, i64 0, i32 1
  %904 = load ptr, ptr %osucc5536, align 8
  %cmp5537 = icmp eq ptr %904, %900
  br i1 %cmp5537, label %cond.end5562, label %cond.false5540

cond.false5540:                                   ; preds = %cond.end5532
  store ptr %904, ptr @zz_res, align 8
  %905 = load ptr, ptr %900, align 8
  store ptr %905, ptr %904, align 8
  %906 = load ptr, ptr @zz_res, align 8
  %907 = load ptr, ptr @zz_hold, align 8
  %908 = load ptr, ptr %907, align 8
  %osucc5555 = getelementptr inbounds %struct.LIST, ptr %908, i64 0, i32 1
  store ptr %906, ptr %osucc5555, align 8
  %osucc5558 = getelementptr inbounds %struct.LIST, ptr %907, i64 0, i32 1
  store ptr %907, ptr %osucc5558, align 8
  store ptr %907, ptr %907, align 8
  %.pre9447 = load ptr, ptr @xx_link, align 8
  br label %cond.end5562

cond.end5562:                                     ; preds = %cond.end5532, %cond.false5540
  %909 = phi ptr [ %900, %cond.end5532 ], [ %.pre9447, %cond.false5540 ]
  store ptr %909, ptr @zz_hold, align 8
  %ou15564 = getelementptr inbounds %struct.word_type, ptr %909, i64 0, i32 1
  %910 = load i8, ptr %ou15564, align 8
  %.off9103 = add i8 %910, -11
  %switch9104 = icmp ult i8 %.off9103, 2
  %orec_size5577 = getelementptr inbounds %struct.word_type, ptr %909, i64 0, i32 1, i32 0, i32 1
  %idxprom5582 = zext i8 %910 to i64
  ...
  %cond5586.in = load i8, ptr %cond5586.in.in, align 1
  %cond5586 = zext i8 %cond5586.in to i32
  store i32 %cond5586, ptr @zz_size, align 4
  %idxprom5587 = zext i8 %cond5586.in to i64
  %arrayidx5588 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom5587
  %911 = load ptr, ptr %arrayidx5588, align 8
  store ptr %911, ptr %909, align 8
  %912 = load ptr, ptr @zz_hold, align 8
  %913 = load i32, ptr @zz_size, align 4
  %idxprom5592 = sext i32 %913 to i64
  %arrayidx5593 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom5592
  store ptr %912, ptr %arrayidx5593, align 8
  %914 = load ptr, ptr @xx_tmp, align 8
  %osucc5596 = getelementptr inbounds [2 x %struct.LIST], ptr %914, i64 0, i64 1, i32 1
  %915 = load ptr, ptr %osucc5596, align 8
  %cmp5597 = icmp eq ptr %915, %914
  br i1 %cmp5597, label %if.then5599, label %for.inc6440

if.then5599:                                      ; preds = %cond.end5562
  %call5600 = tail call i32 @DisposeObject(ptr noundef nonnull %914) #8
  br label %for.inc6440

if.else5602:                                      ; preds = %if.else5401
  switch i8 %859, label %if.else6258 [
...
if.then5624:                                      ; preds = %if.then5621
  %cmp5625.not = icmp eq ptr %prev.09299, null
  br i1 %cmp5625.not, label %if.end6256, label %land.lhs.true5627

land.lhs.true5627:                                ; preds = %if.then5624
  %owidth5629 = getelementptr inbounds %struct.gapobj_type, ptr %g.09298, i64 0, i32 3, i32 1
  %916 = load i16, ptr %owidth5629, align 2
  %cmp5631 = icmp eq i16 %916, 0
  br i1 %cmp5631, label %land.lhs.true5633, label %if.end6256

land.lhs.true5633:                                ; preds = %land.lhs.true5627
  %ogap5628 = getelementptr inbounds %struct.gapobj_type, ptr %g.09298, i64 0, i32 3
  %bf.load5635 = load i16, ptr %ogap5628, align 4
  %917 = and i16 %bf.load5635, 128
  %tobool5639.not = icmp ne i16 %917, 0
  %cmp5644 = icmp eq i8 %878, 17
  %or.cond9167 = and i1 %cmp5644, %tobool5639.not
  br i1 %or.cond9167, label %land.lhs.true5646, label %if.end6256

land.lhs.true5646:                                ; preds = %land.lhs.true5633
  %ou15647 = getelementptr inbounds %struct.word_type, ptr %prev.09299, i64 0, i32 1
  %918 = load i8, ptr %ou15647, align 8
  %.off9105 = add i8 %918, -11
...
land.lhs.true5658:                                ; preds = %land.lhs.true5646
  %ovspace5660 = getelementptr inbounds i8, ptr %g.09298, i64 42
  %919 = load i8, ptr %ovspace5660, align 2
  %conv5661 = zext i8 %919 to i32
  %ohspace5663 = getelementptr inbounds i8, ptr %g.09298, i64 41
  %920 = load i8, ptr %ohspace5663, align 1
  %conv5664 = zext i8 %920 to i32
  %add5665 = sub nsw i32 0, %conv5664
  %cmp5666 = icmp eq i32 %conv5661, %add5665
  %921 = and i16 %bf.load5635, -768
  %or.cond9044 = icmp eq i16 %921, 9216
  %or.cond9173 = and i1 %or.cond9044, %cmp5666
  br i1 %or.cond9173, label %land.lhs.true5690, label %if.end6256

land.lhs.true5690:                                ; preds = %land.lhs.true5658
  %ou25691 = getelementptr inbounds %struct.word_type, ptr %prev.09299, i64 0, i32 2
  ...
  %or.cond9171 = icmp eq i32 %923, 0
  br i1 %or.cond9171, label %land.lhs.true5743, label %if.end6256

land.lhs.true5743:                                ; preds = %land.lhs.true5690
  %osucc5746 = getelementptr inbounds [2 x %struct.LIST], ptr %prev.09299, i64 0, i64 1, i32 1
  %924 = load ptr, ptr %osucc5746, align 8
  %osucc5749 = getelementptr inbounds %struct.LIST, ptr %924, i64 0, i32 1
  %925 = load ptr, ptr %osucc5749, align 8
  %osucc5752 = getelementptr inbounds %struct.LIST, ptr %925, i64 0, i32 1
  %926 = load ptr, ptr %osucc5752, align 8
  %cmp5753 = icmp eq ptr %926, %858
  br i1 %cmp5753, label %if.then5755, label %if.end6256

if.then5755:                                      ; preds = %land.lhs.true5743
  %ostring5756 = getelementptr inbounds %struct.word_type, ptr %prev.09299, i64 0, i32 4
...
if.else5860:                                      ; preds = %929
  ...
  store ptr %934, ptr %arrayidx5867, align 8
  br label %if.end5869
...
if.end5869:                                       ; preds = %if.then5858, %if.else5860
  ...
  store i8 0, ptr %ou15870, align 8
  %osucc5874 = getelementptr inbounds [2 x %struct.LIST], ptr %935, i64 0, i64 1, i32 1
  store ptr %935, ptr %osucc5874, align 8
  %arrayidx5876 = getelementptr inbounds [2 x %struct.LIST], ptr %935, i64 0, i64 1
  store ptr %935, ptr %arrayidx5876, align 8
  %osucc5880 = getelementptr inbounds %struct.LIST, ptr %935, i64 0, i32 1
  store ptr %935, ptr %osucc5880, align 8
  store ptr %935, ptr %935, align 8
  store ptr %935, ptr @xx_link, align 8
  store ptr %935, ptr @zz_res, align 8
  %936 = load ptr, ptr %osucc5746, align 8
  store ptr %936, ptr @zz_hold, align 8
...
cond.end5918.thread:                              ; preds = %if.end5869
  store ptr %call5789, ptr @zz_hold, align 8
  br label %cond.false5927

cond.end5918:                                     ; preds = %if.end5869
  %937 = load ptr, ptr %936, align 8
  store ptr %937, ptr @zz_tmp, align 8
  %938 = load ptr, ptr %935, align 8
  store ptr %938, ptr %936, align 8
  %939 = load ptr, ptr @zz_hold, align 8
  %940 = load ptr, ptr @zz_res, align 8
  %941 = load ptr, ptr %940, align 8
  %osucc5909 = getelementptr inbounds %struct.LIST, ptr %941, i64 0, i32 1
  store ptr %939, ptr %osucc5909, align 8
  %942 = load ptr, ptr @zz_tmp, align 8
  store ptr %942, ptr %940, align 8
  %943 = load ptr, ptr @zz_res, align 8
  %944 = load ptr, ptr @zz_tmp, align 8
  %osucc5915 = getelementptr inbounds %struct.LIST, ptr %944, i64 0, i32 1
  store ptr %943, ptr %osucc5915, align 8
  %.pre9440 = load ptr, ptr @xx_link, align 8
  store ptr %.pre9440, ptr @zz_res, align 8
...
cond.false5927:                                   ; preds = %cond.end5918.thread, %cond.end5918
  %945 = phi ptr [ %935, %cond.end5918.thread ], [ %.pre9440, %cond.end5918 ]
  %arrayidx5929 = getelementptr inbounds [2 x %struct.LIST], ptr %call5789, i64 0, i64 1
  %946 = load ptr, ptr %arrayidx5929, align 8
  store ptr %946, ptr @zz_tmp, align 8
  %arrayidx5932 = getelementptr inbounds [2 x %struct.LIST], ptr %945, i64 0, i64 1
  %947 = load ptr, ptr %arrayidx5932, align 8
  store ptr %947, ptr %arrayidx5929, align 8
  %948 = load ptr, ptr %arrayidx5932, align 8
  %osucc5942 = getelementptr inbounds [2 x %struct.LIST], ptr %948, i64 0, i64 1, i32 1
  store ptr %call5789, ptr %osucc5942, align 8
  store ptr %946, ptr %arrayidx5932, align 8
  %osucc5948 = getelementptr inbounds [2 x %struct.LIST], ptr %946, i64 0, i64 1, i32 1
  store ptr %945, ptr %osucc5948, align 8
  br label %cond.end5951

cond.end5951:                                     ; preds = %cond.end5918, %cond.false5927
  %949 = load ptr, ptr %osucc5746, align 8
  store ptr %949, ptr @xx_link, align 8
  %osucc5958 = getelementptr inbounds [2 x %struct.LIST], ptr %949, i64 0, i64 1, i32 1
  %950 = load ptr, ptr %osucc5958, align 8
...
if.end6154:                                       ; preds = %if.then6152, %cond.end6115
  store ptr %858, ptr @xx_link, align 8
  %osucc6157 = getelementptr inbounds [2 x %struct.LIST], ptr %858, i64 0, i64 1, i32 1
  %981 = load ptr, ptr %osucc6157, align 8
  %cmp6158 = icmp eq ptr %981, %858
  br i1 %cmp6158, label %cond.end6183, label %cond.false6161

cond.false6161:                                   ; preds = %if.end6154
  store ptr %981, ptr @zz_res, align 8
  %arrayidx6166 = getelementptr inbounds [2 x %struct.LIST], ptr %858, i64 0, i64 1
  %982 = load ptr, ptr %arrayidx6166, align 8
  %arrayidx6169 = getelementptr inbounds [2 x %struct.LIST], ptr %981, i64 0, i64 1
  store ptr %982, ptr %arrayidx6169, align 8
  %983 = load ptr, ptr %arrayidx6166, align 8
  %osucc6176 = getelementptr inbounds [2 x %struct.LIST], ptr %983, i64 0, i64 1, i32 1
  store ptr %981, ptr %osucc6176, align 8
  store ptr %858, ptr %osucc6157, align 8
  store ptr %858, ptr %arrayidx6166, align 8
  br label %cond.end6183

cond.end6183:                                     ; preds = %if.end6154, %cond.false6161
  %cond6184 = phi ptr [ %981, %cond.false6161 ], [ null, %if.end6154 ]
  store ptr %cond6184, ptr @xx_tmp, align 8
  store ptr %858, ptr @zz_hold, align 8
  %osucc6187 = getelementptr inbounds %struct.LIST, ptr %858, i64 0, i32 1
  %984 = load ptr, ptr %osucc6187, align 8
  %cmp6188 = icmp eq ptr %984, %858
  br i1 %cmp6188, label %cond.end6213, label %cond.false6191

cond.false6191:                                   ; preds = %cond.end6183
  store ptr %984, ptr @zz_res, align 8
  %985 = load ptr, ptr %858, align 8
  store ptr %985, ptr %984, align 8
  %986 = load ptr, ptr @zz_res, align 8
  %987 = load ptr, ptr @zz_hold, align 8
  %988 = load ptr, ptr %987, align 8
  %osucc6206 = getelementptr inbounds %struct.LIST, ptr %988, i64 0, i32 1
  store ptr %986, ptr %osucc6206, align 8
  %osucc6209 = getelementptr inbounds %struct.LIST, ptr %987, i64 0, i32 1
  store ptr %987, ptr %osucc6209, align 8
  store ptr %987, ptr %987, align 8
  %.pre9443 = load ptr, ptr @xx_link, align 8
  br label %cond.end6213

cond.end6213:                                     ; preds = %cond.end6183, %cond.false6191
  %989 = phi ptr [ %858, %cond.end6183 ], [ %.pre9443, %cond.false6191 ]
  store ptr %989, ptr @zz_hold, align 8
  %ou16215 = getelementptr inbounds %struct.word_type, ptr %989, i64 0, i32 1
  %990 = load i8, ptr %ou16215, align 8
  %.off9113 = add i8 %990, -11
...
if.end6252:                                       ; preds = %if.then6250, %cond.end6213
  ...
  %996 = load ptr, ptr %osucc6255, align 8
  br label %for.inc6440
...
if.then6300:                                      ; preds = %land.lhs.true6292
  ...
  %owidth6308 = getelementptr inbounds %struct.gapobj_type, ptr %g.09298, i64 0, i32 3, i32 1
  store i16 0, ptr %owidth6308, align 2
  br label %for.inc6440

if.else6310:                                      ; preds = %if.end6260
  %cmp6311 = icmp eq ptr %prev.09299, null
...
if.then6313:                                      ; preds = %if.else6310
  ...
  %1001 = load i32, ptr %arrayidx6317, align 4
  store i32 %1001, ptr %b, align 4
  store i32 0, ptr %f, align 4
  br label %for.inc6440

if.else6318:                                      ; preds = %if.else6310
  %ofwd6320 = getelementptr inbounds %struct.word_type, ptr %prev.09299, i64 0, i32 3, i32 1
  %arrayidx6322 = getelementptr inbounds [2 x i32], ptr %ofwd6320, i64 0, i64 %idxprom6321
  %1002 = load i32, ptr %arrayidx6322, align 4
  ...
  %1003 = load i32, ptr %arrayidx6326, align 4
  ...
  %1004 = load i32, ptr %arrayidx6330, align 4
  %ogap6331 = getelementptr inbounds %struct.gapobj_type, ptr %g.09298, i64 0, i32 3
  %call6332 = tail call i32 @MinGap(i32 noundef %1002, i32 noundef %1003, i32 noundef %1004, ptr noundef nonnull %ogap6331) #8
  %cmp6333.not = icmp eq ptr %g.09298, null
...
if.then6342:                                      ; preds = %land.lhs.true6335, %if.else6318
  %1005 = load ptr, ptr @no_fpos, align 8
...
if.end6344:                                       ; preds = %if.then6342, %land.lhs.true6335
  ...
  %or.cond9046 = icmp eq i16 %1006, -15360
  br i1 %or.cond9046, label %if.then6359, label %if.else6384

if.then6359:                                      ; preds = %if.end6344
  %owidth6361 = getelementptr inbounds %struct.gapobj_type, ptr %g.09298, i64 0, i32 3, i32 1
  %1007 = load i16, ptr %owidth6361, align 2
  %conv6362 = sext i16 %1007 to i32
  %1008 = load i32, ptr %arrayidx6326, align 4
  %add6367 = add nsw i32 %1008, %conv6362
  %1009 = load i32, ptr %f, align 4
...
if.end6386:                                       ; preds = %if.else6384, %if.then6359
  ...
  store i32 %1011, ptr %f, align 4
  %1012 = and i16 %bf.load6388, 7168
  %cmp6392 = icmp eq i16 %1012, 2048
  br i1 %cmp6392, label %if.end6401.thread, label %if.end6401

if.end6401.thread:                                ; preds = %if.end6386
  %owidth6396 = getelementptr inbounds %struct.gapobj_type, ptr %g.09298, i64 0, i32 3, i32 1
  %1013 = load i16, ptr %owidth6396, align 2
  %cmp6398 = icmp sgt i16 %1013, 4096
  %spec.select9047 = select i1 %cmp6398, i32 1, i32 %will_expand.09297
  br label %if.end6425

if.end6401:                                       ; preds = %if.end6386
  %1014 = and i16 %bf.load6388, 7424
  %or.cond9048.not = icmp eq i16 %1014, 3328
  br i1 %or.cond9048.not, label %land.lhs.true6416, label %if.end6425

land.lhs.true6416:                                ; preds = %if.end6401
  %owidth6418 = getelementptr inbounds %struct.gapobj_type, ptr %g.09298, i64 0, i32 3, i32 1
  %1015 = load i16, ptr %owidth6418, align 2
  %cmp6420 = icmp sgt i16 %1015, 0
  br i1 %cmp6420, label %if.then6422, label %if.end6425

if.then6422:                                      ; preds = %land.lhs.true6416
  %ou16423 = getelementptr inbounds %struct.word_type, ptr %g.09298, i64 0, i32 1
...
if.end6425:                                       ; preds = %if.end6401.thread, %if.then6422, %land.lhs.true6416, %if.end6401
  ...
  %will_expand.19162 = phi i32 [ %spec.select9047, %if.end6401.thread ], [ %will_expand.09297, %if.then6422 ], [ %will_expand.09297, %land.lhs.true6416 ], [ %will_expand.09297, %if.end6401 ]
  %1016 = and i16 %bf.load6427, 256
  %tobool6431.not = icmp eq i16 %1016, 0
  br i1 %tobool6431.not, label %for.inc6440, label %if.then6432

if.then6432:                                      ; preds = %if.end6425
  %1017 = load i32, ptr %b, align 4
  %add6433 = add nsw i32 %1017, %1011
  store i32 %add6433, ptr %b, align 4
  store i32 0, ptr %f, align 4
  br label %for.inc6440
...
for.inc6440:                                      ; preds = %if.then6272, %if.then6313, %if.then6432, %if.end6425, %if.else5602, %cond.end5365, %land.lhs.true6292, %if.then6300, %cond.end5562, %if.then5599, %if.then5327, %cond.false5374, %if.end6252
  %will_expand.3 = phi i32 [ %will_expand.09297, %cond.false5374 ], [ %will_expand.09297, %if.then5327 ], [ %will_expand.09297, %if.then5599 ], [ %will_expand.09297, %cond.end5562 ], [ %will_expand.09297, %if.then6300 ], [ %will_expand.09297, %land.lhs.true6292 ], [ %will_expand.09297, %if.end6252 ], [ %will_expand.09297, %cond.end5365 ], [ %will_expand.09297, %if.else5602 ], [ %will_expand.09297, %if.then6313 ], [ %will_expand.19162, %if.then6432 ], [ %will_expand.19162, %if.end6425 ], [ %will_expand.09297, %if.then6272 ]
  %g.1 = phi ptr [ %g.09298, %cond.false5374 ], [ %g.09298, %if.then5327 ], [ %g.09298, %if.then5599 ], [ %g.09298, %cond.end5562 ], [ %g.09298, %if.then6300 ], [ %g.09298, %land.lhs.true6292 ], [ %g.09298, %if.end6252 ], [ %g.09298, %cond.end5365 ], [ %y.28, %if.else5602 ], [ %g.09298, %if.then6313 ], [ %g.09298, %if.then6432 ], [ %g.09298, %if.end6425 ], [ null, %if.then6272 ]
  %prev.1 = phi ptr [ %prev.09299, %cond.false5374 ], [ %prev.09299, %if.then5327 ], [ %prev.09299, %if.then5599 ], [ %prev.09299, %cond.end5562 ], [ %prev.09299, %if.then6300 ], [ %prev.09299, %land.lhs.true6292 ], [ %call5789, %if.end6252 ], [ %prev.09299, %cond.end5365 ], [ %prev.09299, %if.else5602 ], [ %y.29, %if.then6313 ], [ %y.29, %if.then6432 ], [ %y.29, %if.end6425 ], [ %prev.09299, %if.then6272 ]
  %link.7 = phi ptr [ %861, %cond.false5374 ], [ %858, %if.then5327 ], [ %879, %if.then5599 ], [ %879, %cond.end5562 ], [ %858, %if.then6300 ], [ %858, %land.lhs.true6292 ], [ %996, %if.end6252 ], [ %861, %cond.end5365 ], [ %858, %if.else5602 ], [ %858, %if.then6313 ], [ %858, %if.then6432 ], [ %858, %if.end6425 ], [ %858, %if.then6272 ]
  %link.6.in = getelementptr inbounds %struct.LIST, ptr %link.7, i64 0, i32 1
  %link.6 = load ptr, ptr %link.6.in, align 8
  %cmp5298.not = icmp eq ptr %link.6, %x.addr.2
  br i1 %cmp5298.not, label %for.end6444, label %for.cond5304.preheader

for.end6444:                                      ; preds = %for.inc6440
  %1018 = icmp ne i32 %will_expand.3, 0
...
if.then6447:                                      ; preds = %if.then5289, %for.end6444
  %will_expand.0.lcssa9480 = phi i1 [ %1018, %for.end6444 ], [ false, %if.then5289 ]
...
if.end6454:                                       ; preds = %if.else6448, %if.then6447
  ...
  store i32 %cond6460, ptr %arrayidx6464, align 4
  %1022 = load i32, ptr %f, align 4
  %cond6470 = tail call i32 @llvm.smin.i32(i32 %1022, i32 8388607)
  ...
  store i32 %cond6470, ptr %arrayidx6474, align 4
  %1023 = load i8, ptr %ou15282, align 8
  %cmp6478 = icmp eq i8 %1023, 17
  %or.cond7725 = select i1 %cmp6478, i1 %will_expand.0.lcssa9479, i1 false
  br i1 %or.cond7725, label %if.then6482, label %sw.epilog7697

if.then6482:                                      ; preds = %if.end6454
  store i32 8388607, ptr %ofwd6472, align 8
  br label %sw.epilog7697

for.cond6498.preheader:                           ; preds = %for.cond6498.preheader.outer, %for.inc6886
  %link.89289 = phi ptr [ %link.8, %for.inc6886 ], [ %link.89289.ph, %for.cond6498.preheader.outer ]
  %found.09286 = phi i32 [ %found.1, %for.inc6886 ], [ 0, %for.cond6498.preheader.outer ]
  %1024 = phi i32 [ %1089, %for.inc6886 ], [ %.ph, %for.cond6498.preheader.outer ]
  %1025 = phi i32 [ %1088, %for.inc6886 ], [ %.ph9510, %for.cond6498.preheader.outer ]
  br label %for.cond6498

for.cond6498:                                     ; preds = %for.cond6498.preheader, %for.cond6498
  %link.8.pn = phi ptr [ %y.30, %for.cond6498 ], [ %link.89289, %for.cond6498.preheader ]
  ...
  %1026 = load i8, ptr %ou16499, align 8
  %cmp6502 = icmp eq i8 %1026, 0
  br i1 %cmp6502, label %for.cond6498, label %for.end6509

for.end6509:                                      ; preds = %for.cond6498
  %1027 = add i8 %1026, -119
  %or.cond9049 = icmp ult i8 %1027, 20
...
if.then6524:                                      ; preds = %if.then6521
  %1028 = load ptr, ptr %link.89289, align 8
  %osucc6530 = getelementptr inbounds %struct.LIST, ptr %1028, i64 0, i32 1
  %1029 = load ptr, ptr %osucc6530, align 8
  store ptr %1029, ptr @xx_link, align 8
  store ptr %1029, ptr @zz_hold, align 8
  %osucc6533 = getelementptr inbounds %struct.LIST, ptr %1029, i64 0, i32 1
  %1030 = load ptr, ptr %osucc6533, align 8
  %cmp6534 = icmp eq ptr %1030, %1029
  br i1 %cmp6534, label %cond.end6559, label %cond.false6537

cond.false6537:                                   ; preds = %if.then6524
  store ptr %1030, ptr @zz_res, align 8
  %1031 = load ptr, ptr %1029, align 8
  store ptr %1031, ptr %1030, align 8
  %1032 = load ptr, ptr @zz_res, align 8
  %1033 = load ptr, ptr @zz_hold, align 8
  %1034 = load ptr, ptr %1033, align 8
  %osucc6552 = getelementptr inbounds %struct.LIST, ptr %1034, i64 0, i32 1
  store ptr %1032, ptr %osucc6552, align 8
  %osucc6555 = getelementptr inbounds %struct.LIST, ptr %1033, i64 0, i32 1
  store ptr %1033, ptr %osucc6555, align 8
  store ptr %1033, ptr %1033, align 8
  %.pre9438 = load ptr, ptr @xx_link, align 8
  br label %cond.end6559

cond.end6559:                                     ; preds = %if.then6524, %cond.false6537
  %1035 = phi ptr [ %1029, %if.then6524 ], [ %.pre9438, %cond.false6537 ]
  store ptr %1035, ptr @zz_res, align 8
  %1036 = load ptr, ptr %extras, align 8
  store ptr %1036, ptr @zz_hold, align 8
  %cmp6561 = icmp eq ptr %1036, null
  %cmp6565 = icmp eq ptr %1035, null
...
cond.false6568:                                   ; preds = %cond.end6559
  ...
  store ptr %1037, ptr @zz_tmp, align 8
  %1038 = load ptr, ptr %1035, align 8
  store ptr %1038, ptr %1036, align 8
  %1039 = load ptr, ptr @zz_hold, align 8
  %1040 = load ptr, ptr @zz_res, align 8
  %1041 = load ptr, ptr %1040, align 8
  %osucc6583 = getelementptr inbounds %struct.LIST, ptr %1041, i64 0, i32 1
  store ptr %1039, ptr %osucc6583, align 8
  %1042 = load ptr, ptr @zz_tmp, align 8
  store ptr %1042, ptr %1040, align 8
  %1043 = load ptr, ptr @zz_res, align 8
  %1044 = load ptr, ptr @zz_tmp, align 8
  %osucc6589 = getelementptr inbounds %struct.LIST, ptr %1044, i64 0, i32 1
  store ptr %1043, ptr %osucc6589, align 8
  br label %for.inc6886

if.else6595:                                      ; preds = %for.end6509
  %1045 = load i8, ptr %ou15282, align 8
  %cmp6602 = icmp eq i8 %1026, %1045
  br i1 %cmp6602, label %if.then6604, label %if.else6796

if.then6604:                                      ; preds = %if.else6595
  %1046 = load ptr, ptr %link.89289, align 8
  %osucc6611 = getelementptr inbounds %struct.LIST, ptr %y.30, i64 0, i32 1
  %1047 = load ptr, ptr %osucc6611, align 8
  %osucc6616 = getelementptr inbounds %struct.LIST, ptr %1046, i64 0, i32 1
  %1048 = load ptr, ptr %osucc6616, align 8
  %cmp6617.not = icmp eq ptr %1047, %y.30
  br i1 %cmp6617.not, label %if.end6694, label %if.then6619

if.then6619:                                      ; preds = %if.then6604
  %ou16620 = getelementptr inbounds %struct.word_type, ptr %1047, i64 0, i32 1
  %1049 = load i8, ptr %ou16620, align 8
  %cmp6623 = icmp eq i8 %1049, 0
  br i1 %cmp6623, label %cond.end6659, label %if.then6625

if.then6625:                                      ; preds = %if.then6619
  %1050 = load ptr, ptr @no_fpos, align 8
  %call6626 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %1050, ptr noundef nonnull @.str.12) #8
  br label %cond.end6659

cond.end6659:                                     ; preds = %if.then6625, %if.then6619
  store ptr %1047, ptr @zz_res, align 8
  store ptr %y.30, ptr @zz_hold, align 8
  %1051 = load ptr, ptr %y.30, align 8
  store ptr %1051, ptr @zz_tmp, align 8
  %1052 = load ptr, ptr %1047, align 8
  store ptr %1052, ptr %y.30, align 8
  %1053 = load ptr, ptr @zz_hold, align 8
  %1054 = load ptr, ptr @zz_res, align 8
  %1055 = load ptr, ptr %1054, align 8
  %osucc6650 = getelementptr inbounds %struct.LIST, ptr %1055, i64 0, i32 1
  store ptr %1053, ptr %osucc6650, align 8
  %1056 = load ptr, ptr @zz_tmp, align 8
  store ptr %1056, ptr %1054, align 8
  %1057 = load ptr, ptr @zz_res, align 8
  %1058 = load ptr, ptr @zz_tmp, align 8
  %osucc6656 = getelementptr inbounds %struct.LIST, ptr %1058, i64 0, i32 1
  store ptr %1057, ptr %osucc6656, align 8
  store ptr %1047, ptr @zz_res, align 8
  store ptr %1048, ptr @zz_hold, align 8
  %cmp6661 = icmp eq ptr %1048, null
  br i1 %cmp6661, label %if.end6694, label %cond.false6668

cond.false6668:                                   ; preds = %cond.end6659
  %1059 = load ptr, ptr %1048, align 8
  store ptr %1059, ptr @zz_tmp, align 8
  %1060 = load ptr, ptr %1047, align 8
  store ptr %1060, ptr %1048, align 8
  %1061 = load ptr, ptr @zz_hold, align 8
  %1062 = load ptr, ptr @zz_res, align 8
  %1063 = load ptr, ptr %1062, align 8
  %osucc6683 = getelementptr inbounds %struct.LIST, ptr %1063, i64 0, i32 1
  store ptr %1061, ptr %osucc6683, align 8
  %1064 = load ptr, ptr @zz_tmp, align 8
  store ptr %1064, ptr %1062, align 8
  %1065 = load ptr, ptr @zz_res, align 8
  %1066 = load ptr, ptr @zz_tmp, align 8
  %osucc6689 = getelementptr inbounds %struct.LIST, ptr %1066, i64 0, i32 1
  store ptr %1065, ptr %osucc6689, align 8
  br label %if.end6694
...
if.end6694:                                       ; preds = %cond.end6659, %cond.false6668, %if.then6604
  ...
  %1067 = load ptr, ptr %osucc6697, align 8
  store ptr %1067, ptr @xx_link, align 8
  %osucc6700 = getelementptr inbounds [2 x %struct.LIST], ptr %1067, i64 0, i64 1, i32 1
  %1068 = load ptr, ptr %osucc6700, align 8
  %cmp6701 = icmp eq ptr %1068, %1067
  br i1 %cmp6701, label %cond.end6726, label %cond.false6704

cond.false6704:                                   ; preds = %if.end6694
  store ptr %1068, ptr @zz_res, align 8
  %arrayidx6709 = getelementptr inbounds [2 x %struct.LIST], ptr %1067, i64 0, i64 1
  %1069 = load ptr, ptr %arrayidx6709, align 8
  %arrayidx6712 = getelementptr inbounds [2 x %struct.LIST], ptr %1068, i64 0, i64 1
  store ptr %1069, ptr %arrayidx6712, align 8
  %1070 = load ptr, ptr %arrayidx6709, align 8
  %osucc6719 = getelementptr inbounds [2 x %struct.LIST], ptr %1070, i64 0, i64 1, i32 1
  store ptr %1068, ptr %osucc6719, align 8
  store ptr %1067, ptr %osucc6700, align 8
  store ptr %1067, ptr %arrayidx6709, align 8
  br label %cond.end6726

cond.end6726:                                     ; preds = %if.end6694, %cond.false6704
  %cond6727 = phi ptr [ %1068, %cond.false6704 ], [ null, %if.end6694 ]
  store ptr %cond6727, ptr @xx_tmp, align 8
  store ptr %1067, ptr @zz_hold, align 8
  %osucc6730 = getelementptr inbounds %struct.LIST, ptr %1067, i64 0, i32 1
  %1071 = load ptr, ptr %osucc6730, align 8
  %cmp6731 = icmp eq ptr %1071, %1067
  br i1 %cmp6731, label %cond.end6756, label %cond.false6734

cond.false6734:                                   ; preds = %cond.end6726
  store ptr %1071, ptr @zz_res, align 8
  %1072 = load ptr, ptr %1067, align 8
  store ptr %1072, ptr %1071, align 8
  %1073 = load ptr, ptr @zz_res, align 8
  %1074 = load ptr, ptr @zz_hold, align 8
  %1075 = load ptr, ptr %1074, align 8
  %osucc6749 = getelementptr inbounds %struct.LIST, ptr %1075, i64 0, i32 1
  store ptr %1073, ptr %osucc6749, align 8
  %osucc6752 = getelementptr inbounds %struct.LIST, ptr %1074, i64 0, i32 1
  store ptr %1074, ptr %osucc6752, align 8
  store ptr %1074, ptr %1074, align 8
  %.pre9437 = load ptr, ptr @xx_link, align 8
  br label %cond.end6756

cond.end6756:                                     ; preds = %cond.end6726, %cond.false6734
  %1076 = phi ptr [ %1067, %cond.end6726 ], [ %.pre9437, %cond.false6734 ]
  store ptr %1076, ptr @zz_hold, align 8
  %ou16758 = getelementptr inbounds %struct.word_type, ptr %1076, i64 0, i32 1
  %1077 = load i8, ptr %ou16758, align 8
  %.off9118 = add i8 %1077, -11
  %switch9119 = icmp ult i8 %.off9118, 2
  %orec_size6771 = getelementptr inbounds %struct.word_type, ptr %1076, i64 0, i32 1, i32 0, i32 1
  %idxprom6776 = zext i8 %1077 to i64
  ...
  %cond6780.in = load i8, ptr %cond6780.in.in, align 1
  %cond6780 = zext i8 %cond6780.in to i32
  store i32 %cond6780, ptr @zz_size, align 4
  %idxprom6781 = zext i8 %cond6780.in to i64
  %arrayidx6782 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom6781
  %1078 = load ptr, ptr %arrayidx6782, align 8
  store ptr %1078, ptr %1076, align 8
  %1079 = load ptr, ptr @zz_hold, align 8
  %1080 = load i32, ptr @zz_size, align 4
  %idxprom6786 = sext i32 %1080 to i64
  %arrayidx6787 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom6786
  store ptr %1079, ptr %arrayidx6787, align 8
  %1081 = load ptr, ptr @xx_tmp, align 8
  %osucc6790 = getelementptr inbounds [2 x %struct.LIST], ptr %1081, i64 0, i64 1, i32 1
  %1082 = load ptr, ptr %osucc6790, align 8
  %cmp6791 = icmp eq ptr %1082, %1081
  br i1 %cmp6791, label %if.then6793, label %for.inc6886

if.then6793:                                      ; preds = %cond.end6756
  %call6794 = tail call i32 @DisposeObject(ptr noundef nonnull %1081) #8
  br label %for.inc6886

if.else6796:                                      ; preds = %if.else6595
  switch i8 %1026, label %if.else6840 [
...
if.then6802:                                      ; preds = %if.else6796
  %tobool6803.not = icmp eq i32 %found.09286, 0
  br i1 %tobool6803.not, label %if.then6804, label %if.end6806

if.then6804:                                      ; preds = %if.then6802
  %1083 = load ptr, ptr @no_fpos, align 8
  %call6805 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %1083, ptr noundef nonnull @.str.22) #8
  br label %if.end6806
...
if.end6806:                                       ; preds = %if.then6804, %if.then6802
  ...
  %1084 = and i16 %bf.load6808, 512
  %tobool6812.not = icmp eq i16 %1084, 0
  br i1 %tobool6812.not, label %for.inc6886.thread, label %for.inc6886
...
if.end6842:                                       ; preds = %if.then6835, %if.then6838, %if.else6840
  ...
  %tobool6843.not = icmp eq i32 %found.09286, 0
  ...
  %1085 = load i32, ptr %arrayidx6877, align 4
  br i1 %tobool6843.not, label %if.else6873, label %if.then6844

if.then6844:                                      ; preds = %if.end6842
  %. = tail call i32 @llvm.smax.i32(i32 %1024, i32 %1085)
  store i32 %., ptr %b, align 4
  ...
  %1086 = load i32, ptr %arrayidx6862, align 4
  %cond6872 = tail call i32 @llvm.smax.i32(i32 %1025, i32 %1086)
  store i32 %cond6872, ptr %f, align 4
  br label %for.inc6886

if.else6873:                                      ; preds = %if.end6842
  store i32 %1085, ptr %b, align 4
  ...
  %1087 = load i32, ptr %arrayidx6881, align 4
  store i32 %1087, ptr %f, align 4
  br label %for.inc6886

for.inc6886:                                      ; preds = %cond.end6559, %if.end6806, %if.else6873, %if.then6844, %cond.end6756, %if.then6793, %if.then6521, %cond.false6568
  %1088 = phi i32 [ %1025, %cond.false6568 ], [ %1025, %if.then6521 ], [ %1025, %if.then6793 ], [ %1025, %cond.end6756 ], [ %1025, %if.end6806 ], [ %cond6872, %if.then6844 ], [ %1087, %if.else6873 ], [ %1025, %cond.end6559 ]
  %1089 = phi i32 [ %1024, %cond.false6568 ], [ %1024, %if.then6521 ], [ %1024, %if.then6793 ], [ %1024, %cond.end6756 ], [ %1024, %if.end6806 ], [ %., %if.then6844 ], [ %1085, %if.else6873 ], [ %1024, %cond.end6559 ]
  %found.1 = phi i32 [ %found.09286, %cond.false6568 ], [ %found.09286, %if.then6521 ], [ %found.09286, %if.then6793 ], [ %found.09286, %cond.end6756 ], [ %found.09286, %if.end6806 ], [ 1, %if.then6844 ], [ 1, %if.else6873 ], [ %found.09286, %cond.end6559 ]
  %link.9 = phi ptr [ %1028, %cond.false6568 ], [ %link.89289, %if.then6521 ], [ %1046, %if.then6793 ], [ %1046, %cond.end6756 ], [ %link.89289, %if.end6806 ], [ %link.89289, %if.then6844 ], [ %link.89289, %if.else6873 ], [ %1028, %cond.end6559 ]
  %link.8.in = getelementptr inbounds %struct.LIST, ptr %link.9, i64 0, i32 1
  %link.8 = load ptr, ptr %link.8.in, align 8
  %cmp6492.not = icmp eq ptr %link.8, %x.addr.2
  br i1 %cmp6492.not, label %for.end6890, label %for.cond6498.preheader

for.inc6886.thread:                               ; preds = %if.end6806
  %add6814 = add nsw i32 %1025, %1024
  %cond6821 = tail call i32 @llvm.smax.i32(i32 %dble_fwd.09288.ph, i32 %add6814)
  %link.8.in9492 = getelementptr inbounds %struct.LIST, ptr %link.89289, i64 0, i32 1
  %link.89493 = load ptr, ptr %link.8.in9492, align 8
  %cmp6492.not9494 = icmp eq ptr %link.89493, %x.addr.2
  br i1 %cmp6492.not9494, label %if.then6892.thread9506, label %for.cond6498.preheader.outer

if.then6892.thread9506:                           ; preds = %for.inc6886.thread
  %1090 = load ptr, ptr @no_fpos, align 8
  %call68939509 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %1090, ptr noundef nonnull @.str.23) #8
  br label %if.then6896

for.end6890:                                      ; preds = %for.inc6886
  %1091 = icmp eq i32 %found.1, 0
  br i1 %1091, label %if.then6892, label %if.end6894

if.then6892:                                      ; preds = %for.end6890
  %1092 = load ptr, ptr @no_fpos, align 8
  %call6893 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %1092, ptr noundef nonnull @.str.23) #8
  br i1 %857, label %if.else6919, label %if.then6896

if.end6894:                                       ; preds = %for.end6890
  br i1 %857, label %if.else6919, label %if.then6896

if.then6896:                                      ; preds = %if.then6892.thread9506, %if.then6892, %if.end6894
  %dble_fwd.0.lcssa94869502 = phi i32 [ %dble_fwd.09288.ph, %if.then6892 ], [ %dble_fwd.09288.ph, %if.end6894 ], [ %cond6821, %if.then6892.thread9506 ]
  ...
  store i32 0, ptr %arrayidx6900, align 4
  %1093 = load i32, ptr %b, align 4
  %1094 = load i32, ptr %f, align 4
  %add6901 = add nsw i32 %1094, %1093
  %cond6908 = tail call i32 @llvm.smax.i32(i32 %dble_fwd.0.lcssa94869502, i32 %add6901)
  ...
  store i32 %cond6914, ptr %arrayidx6918, align 4
  br label %sw.epilog7697

if.else6919:                                      ; preds = %if.then6892.thread, %if.then6892, %if.end6894
  ...
  store i32 %1095, ptr %arrayidx6923, align 4
  %1096 = load i32, ptr %f, align 4
  ...
  store i32 %1096, ptr %arrayidx6927, align 4
  br label %sw.epilog7697
...
if.then6933:                                      ; preds = %sw.bb6930
  %1097 = load ptr, ptr @no_fpos, align 8
  %call6934 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %1097, ptr noundef nonnull @.str.24) #8
  br label %if.end6935

if.end6935:                                       ; preds = %if.then6933, %sw.bb6930
  %ocross_type6937 = getelementptr inbounds i8, ptr %x, i64 41
  %1098 = load i8, ptr %ocross_type6937, align 1
  %cmp6939 = icmp eq i8 %1098, 0
...
if.then6941:                                      ; preds = %if.end6935
  ...
  %1099 = load ptr, ptr %osucc6944, align 8
  %cmp6945.not = icmp eq ptr %1099, %x
  br i1 %cmp6945.not, label %if.then6947, label %if.end6949

if.then6947:                                      ; preds = %if.then6941
  %1100 = load ptr, ptr @no_fpos, align 8
  %call6948 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %1100, ptr noundef nonnull @.str.25) #8
  %link.109310.pre = load ptr, ptr %osucc6944, align 8
  br label %if.end6949

if.end6949:                                       ; preds = %if.then6947, %if.then6941
  %link.109310 = phi ptr [ %link.109310.pre, %if.then6947 ], [ %1099, %if.then6941 ]
  %cmp6954.not9311 = icmp eq ptr %link.109310, %x
  %.pre9462 = sext i32 %dim to i64
  br i1 %cmp6954.not9311, label %for.end7038, label %for.cond6960.preheader

for.cond6960.preheader:                           ; preds = %if.end6949, %for.inc7034
  %link.109314 = phi ptr [ %link.10, %for.inc7034 ], [ %link.109310, %if.end6949 ]
  %.905093069313 = phi i32 [ %.90509305, %for.inc7034 ], [ 0, %if.end6949 ]
  %cond703293099312 = phi i32 [ %cond70329308, %for.inc7034 ], [ 0, %if.end6949 ]
  br label %for.cond6960

for.cond6960:                                     ; preds = %for.cond6960.preheader, %for.cond6960
  %link.10.pn = phi ptr [ %y.32, %for.cond6960 ], [ %link.109314, %for.cond6960.preheader ]
  ...
  %1101 = load i8, ptr %ou16961, align 8
  switch i8 %1101, label %if.end6979 [
...
if.then6977:                                      ; preds = %for.cond6960
  ...
  %1102 = load ptr, ptr @no_fpos, align 8
  %call6978 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %1102, ptr noundef nonnull @.str.26) #8
  %.pr9163 = load i8, ptr %ou16961.le, align 8
  br label %if.end6979

if.end6979:                                       ; preds = %for.cond6960, %if.then6977
  %1103 = phi i8 [ %.pr9163, %if.then6977 ], [ %1101, %for.cond6960 ]
  switch i8 %1103, label %if.then7003 [
...
if.then7003:                                      ; preds = %if.end6979
  ...
  %1104 = load i32, ptr %arrayidx7008, align 4
  %.9050 = tail call i32 @llvm.smax.i32(i32 %.905093069313, i32 %1104)
  ...
  %1105 = load i32, ptr %arrayidx7022, align 4
  %cond7032 = tail call i32 @llvm.smax.i32(i32 %cond703293099312, i32 %1105)
  br label %for.inc7034

for.inc7034:                                      ; preds = %if.end6979, %if.end6979, %if.end6979, %if.end6979, %if.then7003
  %cond70329308 = phi i32 [ %cond703293099312, %if.end6979 ], [ %cond703293099312, %if.end6979 ], [ %cond703293099312, %if.end6979 ], [ %cond703293099312, %if.end6979 ], [ %cond7032, %if.then7003 ]
  %.90509305 = phi i32 [ %.905093069313, %if.end6979 ], [ %.905093069313, %if.end6979 ], [ %.905093069313, %if.end6979 ], [ %.905093069313, %if.end6979 ], [ %.9050, %if.then7003 ]
  %osucc7037 = getelementptr inbounds %struct.LIST, ptr %link.109314, i64 0, i32 1
  %link.10 = load ptr, ptr %osucc7037, align 8
  %cmp6954.not = icmp eq ptr %link.10, %x
  br i1 %cmp6954.not, label %for.end7038, label %for.cond6960.preheader

for.end7038:                                      ; preds = %for.inc7034, %if.end6949
  %cond70329309.lcssa = phi i32 [ 0, %if.end6949 ], [ %cond70329308, %for.inc7034 ]
  %.90509306.lcssa = phi i32 [ 0, %if.end6949 ], [ %.90509305, %for.inc7034 ]
  ...
  store i32 %.90509306.lcssa, ptr %arrayidx7042, align 4
  ...
  store i32 %cond70329309.lcssa, ptr %arrayidx7046, align 4
  store i8 1, ptr %ocross_type6937, align 1
  %link.119324 = load ptr, ptr %osucc6944, align 8
  %cmp7053.not9325 = icmp eq ptr %link.119324, %x
  br i1 %cmp7053.not9325, label %for.end7137, label %for.cond7059.preheader

for.cond7059.preheader:                           ; preds = %for.end7038, %for.inc7133
  %link.119328 = phi ptr [ %link.11, %for.inc7133 ], [ %link.119324, %for.end7038 ]
  %.905193209327 = phi i32 [ %.90519319, %for.inc7133 ], [ %.90509306.lcssa, %for.end7038 ]
  %cond713193239326 = phi i32 [ %cond71319322, %for.inc7133 ], [ %cond70329309.lcssa, %for.end7038 ]
  br label %for.cond7059

for.cond7059:                                     ; preds = %for.cond7059.preheader, %for.cond7059
  %link.11.pn = phi ptr [ %y.33, %for.cond7059 ], [ %link.119328, %for.cond7059.preheader ]
  ...
  %1106 = load i8, ptr %ou17060, align 8
  switch i8 %1106, label %if.end7078 [
...
if.then7076:                                      ; preds = %for.cond7059
  ...
  %1107 = load ptr, ptr @no_fpos, align 8
  %call7077 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %1107, ptr noundef nonnull @.str.26) #8
  %.pr9164 = load i8, ptr %ou17060.le, align 8
  br label %if.end7078

if.end7078:                                       ; preds = %for.cond7059, %if.then7076
  %1108 = phi i8 [ %.pr9164, %if.then7076 ], [ %1106, %for.cond7059 ]
  switch i8 %1108, label %for.inc7133 [
...
if.then7102:                                      ; preds = %if.end7078, %if.end7078, %if.end7078, %if.end7078
  ...
  %1109 = load i32, ptr %arrayidx7107, align 4
  %.9051 = tail call i32 @llvm.smax.i32(i32 %.905193209327, i32 %1109)
  ...
  %1110 = load i32, ptr %arrayidx7121, align 4
  %cond7131 = tail call i32 @llvm.smax.i32(i32 %cond713193239326, i32 %1110)
  br label %for.inc7133

for.inc7133:                                      ; preds = %if.end7078, %if.then7102
  %cond71319322 = phi i32 [ %cond713193239326, %if.end7078 ], [ %cond7131, %if.then7102 ]
  %.90519319 = phi i32 [ %.905193209327, %if.end7078 ], [ %.9051, %if.then7102 ]
  %osucc7136 = getelementptr inbounds %struct.LIST, ptr %link.119328, i64 0, i32 1
  %link.11 = load ptr, ptr %osucc7136, align 8
  %cmp7053.not = icmp eq ptr %link.11, %x
  br i1 %cmp7053.not, label %for.end7137, label %for.cond7059.preheader

for.end7137:                                      ; preds = %for.inc7133, %for.end7038
  %cond71319323.lcssa = phi i32 [ %cond70329309.lcssa, %for.end7038 ], [ %cond71319322, %for.inc7133 ]
  %.90519320.lcssa = phi i32 [ %.90509306.lcssa, %for.end7038 ], [ %.90519319, %for.inc7133 ]
  store i32 %.90519320.lcssa, ptr %b, align 4
  store i32 %cond71319323.lcssa, ptr %f, align 4
  store i32 %.90519320.lcssa, ptr %arrayidx7042, align 4
  store i32 %cond71319323.lcssa, ptr %arrayidx7046, align 4
  br label %sw.epilog7697
...
if.then7150:                                      ; preds = %sw.bb7147
  %1111 = load ptr, ptr @no_fpos, align 8
  %call7151 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %1111, ptr noundef nonnull @.str.27) #8
  br label %if.end7152

if.end7152:                                       ; preds = %if.then7150, %sw.bb7147
  %ocross_type7154 = getelementptr inbounds i8, ptr %x, i64 41
  %1112 = load i8, ptr %ocross_type7154, align 1
  %cmp7156 = icmp eq i8 %1112, 0
...
if.then7158:                                      ; preds = %if.end7152
  ...
  %1113 = load ptr, ptr %osucc7161, align 8
  %cmp7162.not = icmp eq ptr %1113, %x
  br i1 %cmp7162.not, label %if.then7164, label %if.end7166

if.then7164:                                      ; preds = %if.then7158
  %1114 = load ptr, ptr @no_fpos, align 8
  %call7165 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %1114, ptr noundef nonnull @.str.28) #8
  %link.129340.pre = load ptr, ptr %osucc7161, align 8
  br label %if.end7166

if.end7166:                                       ; preds = %if.then7164, %if.then7158
  %link.129340 = phi ptr [ %link.129340.pre, %if.then7164 ], [ %1113, %if.then7158 ]
  %cmp7171.not9341 = icmp eq ptr %link.129340, %x
  %.pre9461 = sext i32 %dim to i64
  br i1 %cmp7171.not9341, label %for.end7255, label %for.cond7177.preheader

for.cond7177.preheader:                           ; preds = %if.end7166, %for.inc7251
  %link.129344 = phi ptr [ %link.12, %for.inc7251 ], [ %link.129340, %if.end7166 ]
  %.905293369343 = phi i32 [ %.90529335, %for.inc7251 ], [ 0, %if.end7166 ]
  %cond724993399342 = phi i32 [ %cond72499338, %for.inc7251 ], [ 0, %if.end7166 ]
  br label %for.cond7177

for.cond7177:                                     ; preds = %for.cond7177.preheader, %for.cond7177
  %link.12.pn = phi ptr [ %y.34, %for.cond7177 ], [ %link.129344, %for.cond7177.preheader ]
  ...
  %1115 = load i8, ptr %ou17178, align 8
  switch i8 %1115, label %if.end7196 [
...
if.then7194:                                      ; preds = %for.cond7177
  ...
  %1116 = load ptr, ptr @no_fpos, align 8
  %call7195 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %1116, ptr noundef nonnull @.str.29) #8
  %.pre9452 = load i8, ptr %ou17178.le, align 8
  br label %if.end7196

if.end7196:                                       ; preds = %for.cond7177, %if.then7194
  %1117 = phi i8 [ %.pre9452, %if.then7194 ], [ %1115, %for.cond7177 ]
  %.off9120 = add i8 %1117, -43
...
if.then7220:                                      ; preds = %if.end7196
  ...
  %1118 = load i32, ptr %arrayidx7225, align 4
  %.9052 = tail call i32 @llvm.smax.i32(i32 %.905293369343, i32 %1118)
  ...
  %1119 = load i32, ptr %arrayidx7239, align 4
  %cond7249 = tail call i32 @llvm.smax.i32(i32 %cond724993399342, i32 %1119)
  br label %for.inc7251

for.inc7251:                                      ; preds = %if.end7196, %if.then7220
  %cond72499338 = phi i32 [ %cond724993399342, %if.end7196 ], [ %cond7249, %if.then7220 ]
  %.90529335 = phi i32 [ %.905293369343, %if.end7196 ], [ %.9052, %if.then7220 ]
  %osucc7254 = getelementptr inbounds %struct.LIST, ptr %link.129344, i64 0, i32 1
  %link.12 = load ptr, ptr %osucc7254, align 8
  %cmp7171.not = icmp eq ptr %link.12, %x
  br i1 %cmp7171.not, label %for.end7255, label %for.cond7177.preheader

for.end7255:                                      ; preds = %for.inc7251, %if.end7166
  %cond72499339.lcssa = phi i32 [ 0, %if.end7166 ], [ %cond72499338, %for.inc7251 ]
  %.90529336.lcssa = phi i32 [ 0, %if.end7166 ], [ %.90529335, %for.inc7251 ]
  store i32 %.90529336.lcssa, ptr %b, align 4
  store i32 %cond72499339.lcssa, ptr %f, align 4
  ...
  store i32 %.90529336.lcssa, ptr %arrayidx7259, align 4
  ...
  store i32 %cond72499339.lcssa, ptr %arrayidx7263, align 4
  store i8 1, ptr %ocross_type7154, align 1
  %link.139350 = load ptr, ptr %osucc7161, align 8
  %cmp7270.not9351 = icmp eq ptr %link.139350, %x
  br i1 %cmp7270.not9351, label %sw.epilog7697, label %for.cond7276.preheader

for.cond7276.preheader:                           ; preds = %for.end7255, %for.inc7374
  %link.139352 = phi ptr [ %link.13, %for.inc7374 ], [ %link.139350, %for.end7255 ]
  br label %for.cond7276

for.cond7276:                                     ; preds = %for.cond7276.preheader, %for.cond7276
  %link.13.pn = phi ptr [ %y.35, %for.cond7276 ], [ %link.139352, %for.cond7276.preheader ]
  ...
  %1120 = load i8, ptr %ou17277, align 8
  switch i8 %1120, label %if.end7295 [
...
if.then7293:                                      ; preds = %for.cond7276
  ...
  %call7294 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %1121, ptr noundef nonnull @.str.29) #8
  %.pre9453 = load i8, ptr %ou17277.le, align 8
  br label %if.end7295

if.end7295:                                       ; preds = %for.cond7276, %if.then7293
  %1122 = phi i8 [ %.pre9453, %if.then7293 ], [ %1120, %for.cond7276 ]
  %.off9122 = add i8 %1122, -43
...
if.then7319:                                      ; preds = %if.end7295
  ...
  %1123 = load i32, ptr %arrayidx7259, align 4
  ...
  %1124 = load i32, ptr %arrayidx7328, align 4
  %.9053 = tail call i32 @llvm.smax.i32(i32 %1123, i32 %1124)
  store i32 %.9053, ptr %arrayidx7259, align 4
  %1125 = load i32, ptr %arrayidx7263, align 4
  ...
  %1126 = load i32, ptr %arrayidx7354, align 4
  %cond7368 = tail call i32 @llvm.smax.i32(i32 %1125, i32 %1126)
  store i32 %cond7368, ptr %arrayidx7263, align 4
  br label %for.inc7374

for.inc7374:                                      ; preds = %if.end7295, %if.then7319
  %osucc7377 = getelementptr inbounds %struct.LIST, ptr %link.139352, i64 0, i32 1
  %link.13 = load ptr, ptr %osucc7377, align 8
  %cmp7270.not = icmp eq ptr %link.13, %x
  br i1 %cmp7270.not, label %sw.epilog7697, label %for.cond7276.preheader
...
if.end7384:                                       ; preds = %sw.bb7380
  ...
  %1127 = load ptr, ptr %osucc7387, align 8
  br label %for.cond7391

for.cond7391:                                     ; preds = %for.cond7391, %if.end7384
  %.pn = phi ptr [ %1127, %if.end7384 ], [ %y.36, %for.cond7391 ]
  ...
  %1128 = load i8, ptr %ou17392, align 8
  %cmp7395 = icmp eq i8 %1128, 0
  br i1 %cmp7395, label %for.cond7391, label %for.end7402
...
for.end7402:                                      ; preds = %for.cond7391
  ...
  %spec.select9172 = zext i1 %cmp7409 to i32
  br label %while.cond7413.outer

while.cond7413.outer:                             ; preds = %if.then7450, %for.end7402
  %tobool7426.not.ph = phi i1 [ true, %if.then7450 ], [ false, %for.end7402 ]
  %status.1.ph = phi i32 [ 4, %if.then7450 ], [ %spec.select9172, %for.end7402 ]
  %.ph9698 = phi <4 x i32> [ %1139, %if.then7450 ], [ undef, %for.end7402 ]
...
while.body7416:                                   ; preds = %while.cond7413
  ...
  %1129 = add i32 %call7418, 1
  %or.cond7727 = icmp ult i32 %1129, 2
...
if.else7432:                                      ; preds = %land.lhs.true7427, %if.end7425
  %1130 = load i8, ptr %buff, align 16
  %cmp7435 = icmp eq i8 %1130, 37
...
if.then7450:                                      ; preds = %if.then7445
  %1131 = load float, ptr %fllx, align 4
  %1132 = load float, ptr %flly, align 4
  %1133 = load float, ptr %furx, align 4
  %1134 = load float, ptr %fury, align 4
  %1135 = insertelement <4 x float> poison, float %1131, i64 0
  %1136 = insertelement <4 x float> %1135, float %1132, i64 1
  %1137 = insertelement <4 x float> %1136, float %1133, i64 2
  %1138 = insertelement <4 x float> %1137, float %1134, i64 3
  %1139 = fptosi <4 x float> %1138 to <4 x i32>
  br label %while.cond7413.outer

sw.bb7460:                                        ; preds = %while.cond7413
  %1140 = load i8, ptr %ou1, align 8
  %cmp7465 = icmp eq i8 %1140, 94
  %cond7467 = select i1 %cmp7465, ptr @.str.36, ptr @.str.37
  %1141 = load ptr, ptr %full_name, align 8
  %ostring7468 = getelementptr inbounds %struct.word_type, ptr %1141, i64 0, i32 4
  ...
  store i8 0, ptr %ocross_type7472, align 1
...
sw.bb7485:                                        ; preds = %while.body7416
  %1142 = load i8, ptr %ou1, align 8
  %cmp7490 = icmp eq i8 %1142, 94
  %cond7492 = select i1 %cmp7490, ptr @.str.36, ptr @.str.37
  %1143 = load ptr, ptr %full_name, align 8
  %ostring7493 = getelementptr inbounds %struct.word_type, ptr %1143, i64 0, i32 4
  ...
  store i8 1, ptr %ocross_type7521, align 1
  %call7522 = call i32 @fclose(ptr noundef %call7408)
  %1144 = load i32, ptr %cp, align 4
  %tobool7523.not = icmp eq i32 %1144, 0
...
sw.bb7527:                                        ; preds = %while.cond7413
  %1145 = load i8, ptr %ou1, align 8
  %cmp7532 = icmp eq i8 %1145, 94
  %cond7534 = select i1 %cmp7532, ptr @.str.36, ptr @.str.37
  %1146 = load ptr, ptr %full_name, align 8
  %ostring7535 = getelementptr inbounds %struct.word_type, ptr %1146, i64 0, i32 4
  ...
  store i8 0, ptr %ocross_type7539, align 1
  ...
  %1147 = load i32, ptr %cp, align 4
  %tobool7553.not = icmp eq i32 %1147, 0
...
sw.bb7557:                                        ; preds = %while.cond7413
  %1148 = load i8, ptr %ou1, align 8
  %cmp7562 = icmp eq i8 %1148, 94
  %cond7564 = select i1 %cmp7562, ptr @.str.36, ptr @.str.37
  %1149 = load ptr, ptr %full_name, align 8
  %ostring7565 = getelementptr inbounds %struct.word_type, ptr %1149, i64 0, i32 4
  ...
  store i8 1, ptr %ocross_type7593, align 1
  %call7594 = call i32 @fclose(ptr noundef %call7408)
  %1150 = load i32, ptr %cp, align 4
  %tobool7595.not = icmp eq i32 %1150, 0
...
sw.bb7599:                                        ; preds = %while.cond7413
  %1151 = load ptr, ptr %osucc7387, align 8
  br label %for.cond7606

for.cond7606:                                     ; preds = %for.cond7606, %sw.bb7599
  %.pn9000 = phi ptr [ %1151, %sw.bb7599 ], [ %y.37, %for.cond7606 ]
  ...
  %1152 = load i8, ptr %ou17607, align 8
  %cmp7610 = icmp eq i8 %1152, 0
  br i1 %cmp7610, label %for.cond7606, label %for.end7617

for.end7617:                                      ; preds = %for.cond7606
  %ou37618 = getelementptr inbounds %struct.word_type, ptr %y.37, i64 0, i32 3
  store <4 x i32> %.ph9698, ptr %ou37618, align 8
  %ou37651 = getelementptr inbounds %struct.word_type, ptr %x, i64 0, i32 3
  %1153 = shufflevector <4 x i32> %.ph9698, <4 x i32> poison, <2 x i32> <i32 2, i32 3>
  %1154 = shufflevector <4 x i32> %.ph9698, <4 x i32> poison, <2 x i32> <i32 0, i32 1>
  %1155 = sub nsw <2 x i32> %1153, %1154
  %1156 = mul nsw <2 x i32> %1155, <i32 20, i32 20>
  %1157 = call <2 x i32> @llvm.smax.v2i32(<2 x i32> %1156, <2 x i32> zeroinitializer)
  %1158 = call <2 x i32> @llvm.umin.v2i32(<2 x i32> %1157, <2 x i32> <i32 8388607, i32 8388607>)
  %1159 = extractelement <2 x i32> %1158, i64 1
  store i32 %1159, ptr %b, align 4
  %1160 = lshr <2 x i32> %1158, <i32 1, i32 1>
  %1161 = shufflevector <2 x i32> %1160, <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  store <4 x i32> %1161, ptr %ou37651, align 8
  %ocross_type7685 = getelementptr inbounds i8, ptr %x, i64 41
  store i8 1, ptr %ocross_type7685, align 1
  %call7686 = call i32 @fclose(ptr noundef %call7408)
  %1162 = load i32, ptr %cp, align 4
  %tobool7687.not = icmp eq i32 %1162, 0
...
sw.epilog:                                        ; preds = %while.cond7413, %for.end7617, %if.then7688, %sw.bb7557, %if.then7596, %sw.bb7527, %if.then7554, %sw.bb7485, %if.then7524, %sw.bb7460
  %1163 = load ptr, ptr %full_name, align 8
  %call7691 = call i32 @DisposeObject(ptr noundef %1163) #8
  br label %sw.epilog7697

sw.default:                                       ; preds = %entry
  %conv = zext i8 %0 to i32
  %1164 = load ptr, ptr @no_fpos, align 8
  %call7695 = tail call ptr @Image(i32 noundef %conv) #8
  %call7696 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 3, ptr noundef nonnull @.str.42, i32 noundef 0, ptr noundef %1164, ptr noundef nonnull @.str.43, ptr noundef %call7695) #8
  br label %sw.epilog7697
...
sw.epilog7697:                                    ; preds = %while.cond2957, %for.inc7374, %for.end7255, %if.end3000, %if.then3008, %cond.end2336, %cond.end2028, %sw.bb7380, %if.end7152, %if.end6935, %for.end7137, %if.then6482, %if.end6454, %if.else6919, %if.then6896, %if.then3297, %if.else3383, %if.end3224, %if.else3250, %if.end3095, %if.else3121, %if.else3019, %if.else2814, %cond.end2807, %if.then2640, %if.end2473, %if.end2586, %if.then2401, %if.else2410, %if.end2226, %cond.false2345, %for.end1901, %cond.false2037, %if.then1734, %if.then1788, %if.else1797, %if.then1755, %sw.bb, %if.then, %sw.default, %sw.epilog, %for.end3428, %for.end2153, %for.end2117, %for.end2090, %for.end1865, %if.end1707, %cond.end1590, %for.end1486, %for.end1431, %if.end1404, %if.end1067, %sw.bb505, %if.end496, %if.end242
  ...
  %1165 = load i32, ptr %arrayidx7701, align 4
  %cmp7702 = icmp sgt i32 %1165, -1
  br i1 %cmp7702, label %if.end7706, label %if.then7704

if.then7704:                                      ; preds = %sw.epilog7697
  %1166 = load ptr, ptr @no_fpos, align 8
  %call7705 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %1166, ptr noundef nonnull @.str.44) #8
  br label %if.end7706
...
if.end7706:                                       ; preds = %if.then7704, %sw.epilog7697
  ...
  %1167 = load i32, ptr %arrayidx7710, align 4
  %cmp7711 = icmp sgt i32 %1167, -1
  br i1 %cmp7711, label %if.end7715, label %if.then7713

if.then7713:                                      ; preds = %if.end7706
  %1168 = load ptr, ptr @no_fpos, align 8
  %call7714 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %1168, ptr noundef nonnull @.str.45) #8
  br label %if.end7715
...
entry:
  ...
  %1 = load ptr, ptr %font_table, align 8
  ...
  %5 = load ptr, ptr %kern_table, align 8
...
if.else:                                          ; preds = %entry
  ...
  %7 = load ptr, ptr %kern_chars, align 8
  %8 = zext i16 %6 to i64
  br label %for.cond
...
for.cond:                                         ; preds = %for.cond, %if.else
  ...
  br i1 %cmp20, label %for.cond, label %for.end
...
cond.true:                                        ; preds = %for.end
  ...
  %13 = load i16, ptr %arrayidx34, align 2
