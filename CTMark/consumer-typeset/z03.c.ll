...
if.end.i:                                         ; preds = %if.then.i184, %if.then
  ...
  store i32 0, ptr %filetab_count.i183, align 4, !tbaa !14
...
FullFileName.exit:                                ; preds = %if.end15.i, %if.end51.i
  ...
  %.pre43 = load i32, ptr @bp, align 4, !tbaa !8
...
if.then10:                                        ; preds = %if.then
  ...
  %.pre174.pre = load i32, ptr @bp, align 4, !tbaa !8
  br label %if.end
...
if.end:                                           ; preds = %if.then10, %if.then
  ...
  %.pre176 = load ptr, ptr @MsgCat, align 8, !tbaa !10
...
cond.true:                                        ; preds = %if.then14
  ...
  %.pre = load i32, ptr @bp, align 4, !tbaa !8
  %.pre175.pre = load ptr, ptr @MsgCat, align 8, !tbaa !10
...
cond.true29:                                      ; preds = %if.end24
  ...
  %.pre177 = load i32, ptr @bp, align 4, !tbaa !8
...
cond.end32:                                       ; preds = %if.end24, %cond.true29
  ...
  %7 = load ptr, ptr @file_tab, align 8, !tbaa !10
...
if.end.i:                                         ; preds = %if.then.i, %cond.end32
  ...
  %10 = load ptr, ptr %osucc29.i, align 8, !tbaa !5
...
for.cond.i:                                       ; preds = %if.then1.i, %for.cond.i
  ...
  %x.0.i = load ptr, ptr %x.0.in.i, align 8, !tbaa !5
  %ou1.i = getelementptr inbounds %struct.word_type, ptr %x.0.i, i64 0, i32 1
  %11 = load i8, ptr %ou1.i, align 8, !tbaa !5
  %cmp10.i = icmp eq i8 %11, 0
  br i1 %cmp10.i, label %for.cond.i, label %if.end15.i, !llvm.loop !32

if.end15.i:                                       ; preds = %for.cond.i, %if.then1.i
  %x.1.i = phi ptr [ %8, %if.then1.i ], [ %x.0.i, %for.cond.i ]
  %12 = load i32, ptr @FullFileName.ffbp, align 4, !tbaa !8
  %13 = and i32 %12, 1
  %rem.i = xor i32 %13, 1
  store i32 %rem.i, ptr @FullFileName.ffbp, align 4, !tbaa !8
  %idxprom16.i = zext i32 %rem.i to i64
...
for.cond39.i:                                     ; preds = %if.else.i, %for.cond39.i
  ...
  %x.2.i = load ptr, ptr %x.2.in.i, align 8, !tbaa !5
  %ou140.i = getelementptr inbounds %struct.word_type, ptr %x.2.i, i64 0, i32 1
  %14 = load i8, ptr %ou140.i, align 8, !tbaa !5
...
FullFileName.exit:                                ; preds = %if.end15.i, %if.end51.i
  ...
  %15 = load i32, ptr @bp, align 4, !tbaa !8
  ...
  %16 = load i16, ptr %ofile_num, align 2, !tbaa !5
...
cond.true70:                                      ; preds = %for.cond
  ...
  %.pre179 = load ptr, ptr @MsgCat, align 8, !tbaa !10
...
cond.true101:                                     ; preds = %cond.end73
  ...
  %.pre180 = load i32, ptr @bp, align 4, !tbaa !8
...
cond.end104:                                      ; preds = %cond.end73, %cond.true101
  ...
  %23 = load i16, ptr %ofile_num120, align 2, !tbaa !5
