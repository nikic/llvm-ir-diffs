; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z03.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z03.c"
...
if.end14:                                         ; preds = %if.then6, %if.else8
  ...
  store ptr %4, ptr %arrayidx18, align 8
...
entry:
  %0 = load i8, ptr @zz_lengths, align 1
  %conv = zext i8 %0 to i32
  store i32 %conv, ptr @zz_size, align 4
  %conv1 = zext i8 %0 to i64
  %arrayidx = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv1
...
cond.end54:                                       ; preds = %if.end13, %cond.false32
  ...
  store ptr %dirname, ptr @zz_hold, align 8
...
if.end29:                                         ; preds = %if.then27, %if.end22
  ...
  %2 = load i8, ptr @zz_lengths, align 1
...
if.else42:                                        ; preds = %if.end29
  ...
  store ptr %5, ptr %arrayidx37, align 8
  br label %if.end49
...
if.end49:                                         ; preds = %if.then40, %if.else42
  ...
  store ptr %6, ptr %arrayidx53, align 8
  %osucc57 = getelementptr inbounds %struct.LIST, ptr %6, i64 0, i32 1
  store ptr %6, ptr %osucc57, align 8
  store ptr %6, ptr %6, align 8
  store ptr %6, ptr @xx_link, align 8
...
cond.false99:                                     ; preds = %cond.end90
  ...
  %18 = load ptr, ptr %arrayidx104, align 8
  store ptr %18, ptr %arrayidx101, align 8
  %19 = load ptr, ptr %arrayidx104, align 8
  %osucc114 = getelementptr inbounds [2 x %struct.LIST], ptr %19, i64 0, i64 1, i32 1
  store ptr %call30, ptr %osucc114, align 8
  store ptr %17, ptr %arrayidx104, align 8
...
cond.end123:                                      ; preds = %cond.end90, %cond.false99
  ...
  store i32 %fpath, ptr %ou3, align 8
...
entry:
  ...
  %1 = load i32, ptr %filetab_count, align 4
...
if.then:                                          ; preds = %entry
  ...
  br i1 %cmp.i, label %if.then.i184, label %if.end.i

if.then.i184:                                     ; preds = %if.then
...
if.end.i:                                         ; preds = %if.then.i184, %if.then
  store i32 %mul, ptr %call.i182, align 8
  %filetab_count.i183 = getelementptr inbounds %struct.anon.14, ptr %call.i182, i64 0, i32 1
  store i32 0, ptr %filetab_count.i183, align 4
...
ftab_new.exit:                                    ; preds = %if.end.i, %for.body.preheader.i
  store ptr %call.i182, ptr %NewS.i, align 8
  %6 = load i32, ptr %filetab_count, align 4
...
for.body.i:                                       ; preds = %ftab_new.exit, %for.body.i
  ...
  %9 = load i32, ptr %filetab_count, align 4
  %10 = sext i32 %9 to i64
  %cmp.not.i.not = icmp slt i64 %indvars.iv, %10
  br i1 %cmp.not.i.not, label %for.body.i, label %for.cond1.i.preheader
...
for.body3.i:                                      ; preds = %for.cond1.i.preheader, %for.inc13.i
  ...
  %12 = load ptr, ptr %by_name_hash.i, align 8
...
for.inc13.i:                                      ; preds = %if.then.i, %for.body3.i
  ...
  br i1 %cmp2.i, label %for.body3.i, label %ftab_rehash.exit

ftab_rehash.exit:                                 ; preds = %for.inc13.i, %for.cond1.i.preheader
  tail call void @free(ptr noundef nonnull %0) #16
  %15 = load ptr, ptr %NewS.i, align 8
  ...
  %.pre196 = load i32, ptr %filetab_count2.phi.trans.insert, align 4
  br label %if.end
...
if.end:                                           ; preds = %ftab_rehash.exit, %entry
  ...
  store i32 %inc, ptr %filetab_count2, align 4
...
if.end6:                                          ; preds = %if.then4, %if.end
  ...
  %18 = load i8, ptr %ostring, align 1
...
while.body:                                       ; preds = %if.end6, %while.body
  ...
  %21 = load i8, ptr %incdec.ptr7, align 1
...
while.end:                                        ; preds = %while.body, %if.end6
  ...
  %24 = load ptr, ptr %by_name_hash, align 8
...
if.then12:                                        ; preds = %while.end
  ...
  store i32 %conv13, ptr @zz_size, align 4
...
if.then23:                                        ; preds = %if.then12
  ...
  store ptr %call24, ptr @zz_hold, align 8
  br label %if.end32
...
if.then61:                                        ; preds = %if.end49
  ...
  store ptr %call62, ptr @zz_hold, align 8
  br label %if.end72
...
if.end72:                                         ; preds = %if.then61, %if.else63
  ...
  %37 = load ptr, ptr %by_name_hash90, align 8
...
cond.false96:                                     ; preds = %if.end72
  ...
  store ptr %40, ptr %osucc111, align 8
  ...
  store ptr %44, ptr %osucc117, align 8
  %.pre197 = load ptr, ptr @xx_link, align 8
...
cond.false127:                                    ; preds = %cond.end118
  ...
  %48 = load ptr, ptr %arrayidx132, align 8
  store ptr %48, ptr %arrayidx129, align 8
  %49 = load ptr, ptr %arrayidx132, align 8
  %osucc142 = getelementptr inbounds [2 x %struct.LIST], ptr %49, i64 0, i64 1, i32 1
  store ptr %x, ptr %osucc142, align 8
  store ptr %47, ptr %arrayidx132, align 8
  %osucc148 = getelementptr inbounds [2 x %struct.LIST], ptr %47, i64 0, i64 1, i32 1
  store ptr %46, ptr %osucc148, align 8
...
cond.end151:                                      ; preds = %cond.end118, %cond.false127
  ...
  store ptr %x, ptr %arrayidx155, align 8
  ret void
}
...
entry:
  %0 = load ptr, ptr @file_tab, align 8
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %1 = load ptr, ptr @file_tab, align 8
  %2 = load i8, ptr %buff, align 16
...
while.end.i:                                      ; preds = %while.cond.i
  ...
  %5 = load ptr, ptr %by_name_hash.i, align 8
...
for.end.i:                                        ; preds = %for.cond9.i
  ...
  br i1 %cmp17.i, label %cond.false, label %for.cond.i
...
entry:
  %.pre50 = load ptr, ptr @file_tab, align 8
...
tailrecurse:                                      ; preds = %tailrecurse.backedge, %entry
  ...
  %1 = load i16, ptr %ofile_num, align 2
...
if.end.i:                                         ; preds = %tailrecurse, %tailrecurse
  ...
  %3 = load ptr, ptr %osucc.i, align 8
...
for.cond.i:                                       ; preds = %if.end.i, %for.cond.i
  ...
  %4 = load i8, ptr %ou1.i, align 8
  %cmp9.i = icmp eq i8 %4, 0
  br i1 %cmp9.i, label %for.cond.i, label %FileName.exit
...
sw.bb5:                                           ; preds = %tailrecurse
  ...
  %5 = load i16, ptr %ofile_num6, align 2
...
sw.bb15:                                          ; preds = %tailrecurse
  ...
  %7 = load i16, ptr %ofile_num17, align 2
...
if.then21:                                        ; preds = %sw.bb15
  ...
  %.pre = load ptr, ptr @file_tab, align 8
...
for.cond:                                         ; preds = %if.end, %for.cond
  ...
  %4 = load i8, ptr %ou1, align 8
  %cmp9 = icmp eq i8 %4, 0
  br i1 %cmp9, label %for.cond, label %if.end14
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %3 = load ptr, ptr %osucc29, align 8
...
for.cond:                                         ; preds = %if.then1, %for.cond
  ...
  br i1 %cmp10, label %for.cond, label %if.end15

if.end15:                                         ; preds = %for.cond, %if.then1
  %x.1 = phi ptr [ %1, %if.then1 ], [ %x.0, %for.cond ]
  %5 = load i32, ptr @FullFileName.ffbp, align 4
  %6 = and i32 %5, 1
  %rem = xor i32 %6, 1
  store i32 %rem, ptr @FullFileName.ffbp, align 4
...
for.cond39:                                       ; preds = %if.else, %for.cond39
  ...
  %7 = load i8, ptr %ou140, align 8
  %cmp43 = icmp eq i8 %7, 0
  br i1 %cmp43, label %for.cond39, label %if.end51
...
if.end16:                                         ; preds = %if.then11, %if.then4
  ...
  %strlen = tail call i64 @strlen(ptr nonnull dereferenceable(1) %arrayidx18)
  %endptr = getelementptr inbounds i8, ptr %arrayidx18, i64 %strlen
  store i16 32, ptr %endptr, align 1
  %strlen93 = tail call i64 @strlen(ptr nonnull dereferenceable(1) %arrayidx18)
  %endptr94 = getelementptr inbounds i8, ptr %arrayidx18, i64 %strlen93
  store i16 47, ptr %endptr94, align 1
  br label %if.end25
...
if.then36:                                        ; preds = %if.end25
  ...
  %.pre106 = load i32, ptr @bp, align 4
...
if.end41:                                         ; preds = %if.then36, %if.end25
  ...
  store i16 32, ptr %endptr96, align 1
  ...
  store i16 34, ptr %endptr98, align 1
  ...
  %strlen99 = tail call i64 @strlen(ptr nonnull dereferenceable(1) %arrayidx43)
  %endptr100 = getelementptr inbounds i8, ptr %arrayidx43, i64 %strlen99
  store i16 34, ptr %endptr100, align 1
...
if.then62:                                        ; preds = %if.end41
  %strlen101 = tail call i64 @strlen(ptr nonnull dereferenceable(1) %arrayidx43)
  %endptr102 = getelementptr inbounds i8, ptr %arrayidx43, i64 %strlen101
  ...
  %10 = load i32, ptr @bp, align 4
  %idxprom75 = zext i32 %10 to i64
  %arrayidx76 = getelementptr inbounds [2 x [512 x i8]], ptr @buff, i64 0, i64 %idxprom75
  %strlen103 = tail call i64 @strlen(ptr nonnull dereferenceable(1) %arrayidx76)
  %endptr104 = getelementptr inbounds i8, ptr %arrayidx76, i64 %strlen103
  store i16 44, ptr %endptr104, align 1
...
if.then:                                          ; preds = %entry
  %3 = load ptr, ptr @file_tab, align 8
...
if.end.i:                                         ; preds = %if.then.i, %if.then
  ...
  %6 = load ptr, ptr %osucc29.i, align 8
...
for.cond.i:                                       ; preds = %if.then1.i, %for.cond.i
  ...
  %x.0.i = load ptr, ptr %x.0.in.i, align 8
  %ou1.i = getelementptr inbounds %struct.word_type, ptr %x.0.i, i64 0, i32 1
  %7 = load i8, ptr %ou1.i, align 8
  %cmp10.i = icmp eq i8 %7, 0
  br i1 %cmp10.i, label %for.cond.i, label %if.end15.i

if.end15.i:                                       ; preds = %for.cond.i, %if.then1.i
  %x.1.i = phi ptr [ %4, %if.then1.i ], [ %x.0.i, %for.cond.i ]
  %8 = load i32, ptr @FullFileName.ffbp, align 4
  %9 = and i32 %8, 1
  %rem.i = xor i32 %9, 1
  store i32 %rem.i, ptr @FullFileName.ffbp, align 4
...
for.cond39.i:                                     ; preds = %if.else.i, %for.cond39.i
  ...
  %10 = load i8, ptr %ou140.i, align 8
  %cmp43.i = icmp eq i8 %10, 0
  br i1 %cmp43.i, label %for.cond39.i, label %if.end51.i
...
if.end33:                                         ; preds = %FullFileName.exit, %if.then10, %entry
  %12 = phi i32 [ %.pre43, %FullFileName.exit ], [ %.pre, %if.then10 ], [ %rem, %entry ]
...
if.then:                                          ; preds = %entry
  ...
  store i16 32, ptr %endptr, align 1
  %2 = load ptr, ptr @file_tab, align 8
...
if.then10:                                        ; preds = %if.then
  ...
  %.pre174.pre = load i32, ptr @bp, align 4
  br label %if.end

if.end:                                           ; preds = %if.then10, %if.then
  %.pre174 = phi i32 [ %.pre174.pre, %if.then10 ], [ %rem, %if.then ]
  %ou2 = getelementptr inbounds %struct.word_type, ptr %3, i64 0, i32 2
  %bf.load = load i32, ptr %ou2, align 8
  %5 = and i32 %bf.load, 4190208
  %cmp12 = icmp eq i32 %5, 40960
  %.pre176 = load ptr, ptr @MsgCat, align 8
  %idxprom15 = zext i32 %.pre174 to i64
...
if.then14:                                        ; preds = %if.end
  ...
  %tobool.not = icmp eq ptr %.pre176, null
  br i1 %tobool.not, label %cond.end, label %cond.true

cond.true:                                        ; preds = %if.then14
  %call18 = tail call ptr @catgets(ptr noundef nonnull %.pre176, i32 noundef 3, i32 noundef 11, ptr noundef nonnull @.str.16) #16
  %.pre = load i32, ptr @bp, align 4
  %.pre175.pre = load ptr, ptr @MsgCat, align 8
  %.pre183 = zext i32 %.pre to i64
  br label %cond.end

cond.end:                                         ; preds = %if.then14, %cond.true
  %idxprom20.pre-phi = phi i64 [ %idxprom15, %if.then14 ], [ %.pre183, %cond.true ]
  %.pre175 = phi ptr [ null, %if.then14 ], [ %.pre175.pre, %cond.true ]
  ...
  %strlen150 = tail call i64 @strlen(ptr nonnull dereferenceable(1) %arrayidx21)
  %endptr151 = getelementptr inbounds i8, ptr %arrayidx21, i64 %strlen150
...
if.end24:                                         ; preds = %if.end, %cond.end
  ...
  %6 = phi ptr [ %.pre175, %cond.end ], [ %.pre176, %if.end ]
...
cond.true29:                                      ; preds = %if.end24
  %call30 = tail call ptr @catgets(ptr noundef nonnull %6, i32 noundef 3, i32 noundef 12, ptr noundef nonnull @.str.17) #16
  %.pre177 = load i32, ptr @bp, align 4
  %.pre184 = zext i32 %.pre177 to i64
  br label %cond.end32

cond.end32:                                       ; preds = %if.end24, %cond.true29
  %idxprom35.pre-phi = phi i64 [ %idxprom25.pre-phi, %if.end24 ], [ %.pre184, %cond.true29 ]
  ...
  store i16 32, ptr %endptr153, align 1
  %strlen154 = tail call i64 @strlen(ptr nonnull dereferenceable(1) %arrayidx36)
  %endptr155 = getelementptr inbounds i8, ptr %arrayidx36, i64 %strlen154
  store i16 34, ptr %endptr155, align 1
  %7 = load ptr, ptr @file_tab, align 8
  %arrayidx.i = getelementptr inbounds %struct.anon.14, ptr %7, i64 0, i32 2, i64 %idxprom6
  %8 = load ptr, ptr %arrayidx.i, align 8
...
if.then.i:                                        ; preds = %cond.end32
  %9 = load ptr, ptr @no_fpos, align 8
  %call.i = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.2, i32 noundef 0, ptr noundef %9, ptr noundef nonnull @.str.11) #16
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i, %cond.end32
  %ou2.i = getelementptr inbounds %struct.word_type, ptr %8, i64 0, i32 2
  %bf.load.i = load i32, ptr %ou2.i, align 8
  %tobool.not.i = icmp sgt i32 %bf.load.i, -1
  %osucc29.i = getelementptr inbounds %struct.LIST, ptr %8, i64 0, i32 1
  %10 = load ptr, ptr %osucc29.i, align 8
  %cmp30.not.i = icmp eq ptr %10, %8
  br i1 %tobool.not.i, label %if.else.i, label %if.then1.i
...
for.cond.i:                                       ; preds = %if.then1.i, %for.cond.i
  %.pn69.i = phi ptr [ %x.0.i, %for.cond.i ], [ %10, %if.then1.i ]
  %x.0.in.i = getelementptr inbounds [2 x %struct.LIST], ptr %.pn69.i, i64 0, i64 1
  %x.0.i = load ptr, ptr %x.0.in.i, align 8
  %ou1.i = getelementptr inbounds %struct.word_type, ptr %x.0.i, i64 0, i32 1
  %11 = load i8, ptr %ou1.i, align 8
  %cmp10.i = icmp eq i8 %11, 0
  br i1 %cmp10.i, label %for.cond.i, label %if.end15.i

if.end15.i:                                       ; preds = %for.cond.i, %if.then1.i
  %x.1.i = phi ptr [ %8, %if.then1.i ], [ %x.0.i, %for.cond.i ]
  %12 = load i32, ptr @FullFileName.ffbp, align 4
  %13 = and i32 %12, 1
  %rem.i = xor i32 %13, 1
  store i32 %rem.i, ptr @FullFileName.ffbp, align 4
  %idxprom16.i = zext i32 %rem.i to i64
...
for.cond39.i:                                     ; preds = %if.else.i, %for.cond39.i
  %.pn.i = phi ptr [ %x.2.i, %for.cond39.i ], [ %10, %if.else.i ]
  %x.2.in.i = getelementptr inbounds [2 x %struct.LIST], ptr %.pn.i, i64 0, i64 1
  %x.2.i = load ptr, ptr %x.2.in.i, align 8
  %ou140.i = getelementptr inbounds %struct.word_type, ptr %x.2.i, i64 0, i32 1
  %14 = load i8, ptr %ou140.i, align 8
  %cmp43.i = icmp eq i8 %14, 0
  br i1 %cmp43.i, label %for.cond39.i, label %if.end51.i

if.end51.i:                                       ; preds = %for.cond39.i, %if.else.i
  %x.3.i = phi ptr [ %8, %if.else.i ], [ %x.2.i, %for.cond39.i ]
  %ostring52.i = getelementptr inbounds %struct.word_type, ptr %x.3.i, i64 0, i32 4
  br label %FullFileName.exit
...
FullFileName.exit:                                ; preds = %if.end15.i, %if.end51.i
  ...
  store i16 34, ptr %endptr157, align 1
  %ofile_num = getelementptr inbounds %struct.word_type, ptr %3, i64 0, i32 1, i32 0, i32 2
  %16 = load i16, ptr %ofile_num, align 2
  %cmp53.not = icmp eq i16 %16, 0
  br i1 %cmp53.not, label %if.end135, label %if.then55

if.then55:                                        ; preds = %FullFileName.exit
  %strlen158 = tail call i64 @strlen(ptr nonnull dereferenceable(1) %arrayidx49)
  %endptr159 = getelementptr inbounds i8, ptr %arrayidx49, i64 %strlen158
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(3) %endptr159, ptr noundef nonnull align 1 dereferenceable(3) @.str.19, i64 3, i1 false)
  br label %for.cond

for.cond:                                         ; preds = %if.end125, %if.then55
  %17 = phi i32 [ %15, %if.then55 ], [ %24, %if.end125 ]
  %x.0 = phi ptr [ %3, %if.then55 ], [ %20, %if.end125 ]
  %18 = load ptr, ptr @file_tab, align 8
  %ofile_num62 = getelementptr inbounds %struct.word_type, ptr %x.0, i64 0, i32 1, i32 0, i32 2
  %19 = load i16, ptr %ofile_num62, align 2
  %idxprom63 = zext i16 %19 to i64
  %arrayidx64 = getelementptr inbounds %struct.anon.14, ptr %18, i64 0, i32 2, i64 %idxprom63
  %20 = load ptr, ptr %arrayidx64, align 8
  %idxprom66 = zext i32 %17 to i64
  %arrayidx67 = getelementptr inbounds [2 x [512 x i8]], ptr @buff, i64 0, i64 %idxprom66
  %21 = load ptr, ptr @MsgCat, align 8
  %tobool69.not = icmp eq ptr %21, null
  br i1 %tobool69.not, label %cond.end73, label %cond.true70

cond.true70:                                      ; preds = %for.cond
  %call71 = tail call ptr @catgets(ptr noundef nonnull %21, i32 noundef 3, i32 noundef 13, ptr noundef nonnull @.str.20) #16
  %.pre178 = load i32, ptr @bp, align 4
  %.pre179 = load ptr, ptr @MsgCat, align 8
  %.pre185 = zext i32 %.pre178 to i64
  br label %cond.end73

cond.end73:                                       ; preds = %for.cond, %cond.true70
  %idxprom76.pre-phi = phi i64 [ %idxprom66, %for.cond ], [ %.pre185, %cond.true70 ]
  %22 = phi ptr [ null, %for.cond ], [ %.pre179, %cond.true70 ]
  ...
  store i16 32, ptr %endptr161, align 1
  ...
  %ostring = getelementptr inbounds %struct.word_type, ptr %20, i64 0, i32 4
  ...
  store i16 34, ptr %endptr165, align 1
  %strlen166 = tail call i64 @strlen(ptr nonnull dereferenceable(1) %arrayidx77)
  %endptr167 = getelementptr inbounds i8, ptr %arrayidx77, i64 %strlen166
...
cond.true101:                                     ; preds = %cond.end73
  %call102 = tail call ptr @catgets(ptr noundef nonnull %22, i32 noundef 3, i32 noundef 14, ptr noundef nonnull @.str.21) #16
  %.pre180 = load i32, ptr @bp, align 4
  %.pre186 = zext i32 %.pre180 to i64
  br label %cond.end104

cond.end104:                                      ; preds = %cond.end73, %cond.true101
  %idxprom107.pre-phi = phi i64 [ %idxprom76.pre-phi, %cond.end73 ], [ %.pre186, %cond.true101 ]
  ...
  %strlen168 = tail call i64 @strlen(ptr nonnull dereferenceable(1) %arrayidx108)
  %endptr169 = getelementptr inbounds i8, ptr %arrayidx108, i64 %strlen168
  store i16 32, ptr %endptr169, align 1
  ...
  %ofile_num120 = getelementptr inbounds %struct.word_type, ptr %20, i64 0, i32 1, i32 0, i32 2
  %23 = load i16, ptr %ofile_num120, align 2
  %cmp122 = icmp eq i16 %23, 0
  %24 = load i32, ptr @bp, align 4
  %idxprom130 = zext i32 %24 to i64
  %arrayidx131 = getelementptr inbounds [2 x [512 x i8]], ptr @buff, i64 0, i64 %idxprom130
  %strlen172 = tail call i64 @strlen(ptr nonnull dereferenceable(1) %arrayidx131)
  %endptr173 = getelementptr inbounds i8, ptr %arrayidx131, i64 %strlen172
  br i1 %cmp122, label %for.end, label %if.end125

if.end125:                                        ; preds = %cond.end104
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(3) %endptr173, ptr noundef nonnull align 1 dereferenceable(3) @.str.22, i64 3, i1 false)
  br label %for.cond

for.end:                                          ; preds = %cond.end104
  store i16 41, ptr %endptr173, align 1
  br label %if.end135

if.end135:                                        ; preds = %FullFileName.exit, %for.end, %entry
  %idxprom136.pre-phi = phi i64 [ %idxprom48, %FullFileName.exit ], [ %idxprom130, %for.end ], [ %idxprom, %entry ]
...
if.else:                                          ; preds = %entry
  ...
  %6 = load ptr, ptr %full_name, align 8
...
if.then29:                                        ; preds = %if.else
  ...
  store i32 %conv30, ptr @zz_size, align 4
...
if.else43:                                        ; preds = %if.then29
  ...
  store ptr %10, ptr %arrayidx38, align 8
  br label %cond.end93
...
cond.end93:                                       ; preds = %if.then41, %if.else43
  ...
  store ptr %11, ptr %arrayidx58, align 8
  %osucc62 = getelementptr inbounds %struct.LIST, ptr %11, i64 0, i32 1
  store ptr %11, ptr %osucc62, align 8
  ...
  store ptr %14, ptr %osucc86, align 8
  ...
  store ptr %18, ptr %osucc92, align 8
...
cond.false102:                                    ; preds = %cond.end93
  ...
  store ptr %22, ptr %arrayidx104, align 8
  %23 = load ptr, ptr %arrayidx107, align 8
  %osucc117 = getelementptr inbounds [2 x %struct.LIST], ptr %23, i64 0, i64 1, i32 1
  store ptr %6, ptr %osucc117, align 8
  store ptr %21, ptr %arrayidx107, align 8
...
if.end128:                                        ; preds = %cond.end93, %cond.false102, %if.else
  %24 = load i32, ptr %used_source_suffix, align 4
...
if.end:                                           ; preds = %entry
  ...
  %link.0189 = load ptr, ptr %link.0.in188, align 8
...
for.cond6:                                        ; preds = %for.cond6.preheader, %for.cond6
  ...
  %2 = load i8, ptr %ou1, align 8
  %cmp7 = icmp eq i8 %2, 0
  br i1 %cmp7, label %for.cond6, label %for.end
...
if.then84:                                        ; preds = %land.lhs.true79
  ...
  %4 = load i64, ptr %st_mtim85, align 8
...
for.inc118.thread:                                ; preds = %if.then108, %if.then111
  store i32 1, ptr %used_source_suffix, align 4
...
for.inc118:                                       ; preds = %if.end96, %if.then98
  ...
  br i1 %5, label %for.cond6.preheader, label %for.end122
...
cond.end134:                                      ; preds = %if.end, %for.end122, %lor.lhs.false, %cond.false131
  ...
  store ptr %cond135, ptr %full_name, align 8
  br label %cleanup136
...
for.cond.2:                                       ; preds = %for.cond.1
  %7 = load ptr, ptr %full_name, align 8
...
for.cond.3:                                       ; preds = %for.cond.2
  %8 = load ptr, ptr %full_name, align 8
...
if.then26:                                        ; preds = %for.cond.4, %for.cond.3, %for.cond.2, %for.cond.1, %for.cond, %for.body.preheader
  ...
  %11 = load i32, ptr @SafeExecution, align 4
