; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z31.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z31.c"
...
entry:
  store i8 0, ptr getelementptr inbounds ([150 x i8], ptr @zz_lengths, i64 0, i64 12), align 4
  store i8 5, ptr @zz_lengths, align 16
  ...
  store <4 x i8> <i8 21, i8 12, i8 12, i8 0>, ptr getelementptr inbounds ([150 x i8], ptr @zz_lengths, i64 0, i64 8), align 8
  store i8 12, ptr getelementptr inbounds ([150 x i8], ptr @zz_lengths, i64 0, i64 149), align 1
  store i8 12, ptr getelementptr inbounds ([150 x i8], ptr @zz_lengths, i64 0, i64 148), align 4
  ...
  store i8 9, ptr getelementptr inbounds ([150 x i8], ptr @zz_lengths, i64 0, i64 1), align 1
  store i8 9, ptr getelementptr inbounds ([150 x i8], ptr @zz_lengths, i64 0, i64 101), align 1
  store i8 9, ptr getelementptr inbounds ([150 x i8], ptr @zz_lengths, i64 0, i64 100), align 4
  store i8 11, ptr getelementptr inbounds ([150 x i8], ptr @zz_lengths, i64 0, i64 141), align 1
  store i8 11, ptr getelementptr inbounds ([150 x i8], ptr @zz_lengths, i64 0, i64 140), align 4
  store i8 8, ptr getelementptr inbounds ([150 x i8], ptr @zz_lengths, i64 0, i64 147), align 1
  ret void
}
...
entry:
  %0 = load ptr, ptr @GetMemory.next_free, align 8
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %1 = load ptr, ptr @GetMemory.top_free, align 8
...
if.then:                                          ; preds = %lor.lhs.false, %entry
  ...
  store ptr %call, ptr @GetMemory.next_free, align 8
...
if.then2:                                         ; preds = %if.then
  ...
  %.pre = load ptr, ptr @GetMemory.next_free, align 8
  br label %if.end

if.end:                                           ; preds = %if.then2, %if.then
  %2 = phi ptr [ %.pre, %if.then2 ], [ %call, %if.then ]
  %arrayidx4 = getelementptr inbounds ptr, ptr %2, i64 1020
  store ptr %arrayidx4, ptr @GetMemory.top_free, align 8
...
if.end5:                                          ; preds = %if.end, %lor.lhs.false
  ...
  store ptr %arrayidx7, ptr @GetMemory.next_free, align 8
  ret ptr %3
}
