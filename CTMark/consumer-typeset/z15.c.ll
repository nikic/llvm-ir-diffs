; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z15.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z15.c"
...
entry:
  %0 = load <2 x i32>, ptr %xc, align 4
  %1 = load <2 x i32>, ptr %yc, align 4
  %2 = tail call <2 x i32> @llvm.smin.v2i32(<2 x i32> %0, <2 x i32> %1)
  store <2 x i32> %2, ptr %xc, align 4
  ...
  %4 = load i32, ptr %ofc14, align 4
  %cond21 = tail call i32 @llvm.smin.i32(i32 %3, i32 %4)
  store i32 %cond21, ptr %ofc, align 4
  ret void
}
...
cond.end9:                                        ; preds = %cond.false, %if.end
  ...
  store i32 %cond10, ptr %yc, align 4
...
cond.end26:                                       ; preds = %cond.false14, %cond.end9
  ...
  store i32 %cond27, ptr %obfc28, align 4
  %ofc = getelementptr inbounds %struct.CONSTRAINT, ptr %xc, i64 0, i32 2
  %3 = load i32, ptr %ofc, align 4
...
cond.end43:                                       ; preds = %cond.false31, %cond.end26
  ...
  store i32 %cond44, ptr %ofc45, align 4
  ret void
}
...
while.body11:                                     ; preds = %while.cond7.preheader, %while.body11
  ...
  br i1 %cmp9, label %while.end14, label %while.body11
...
if.end90:                                         ; preds = %if.then36, %if.else72, %if.then56, %if.then23
  ...
  %c1.sroa.14.0 = load i32, ptr %c1.sroa.14.0.in, align 4
  %c1.sroa.8.0 = load i32, ptr %c1.sroa.8.0.in, align 4
  %c1.sroa.0.0 = load i32, ptr %c1.sroa.0.0.in, align 4
  %c2.sroa.14.0 = load i32, ptr %c2.sroa.14.0.in, align 4
  %c2.sroa.8.0 = load i32, ptr %c2.sroa.8.0.in, align 4
  %c2.sroa.0.0 = load i32, ptr %c2.sroa.0.0.in, align 4
...
if.then96:                                        ; preds = %if.end90
  ...
  %2 = load i32, ptr %arrayidx98, align 4
...
SemiRotateConstraint.exit:                        ; preds = %if.then96, %if.else.i
  ...
  %26 = load i32, ptr %arrayidx98, align 4
  ...
  br i1 %cmp.i177, label %if.end124, label %if.else.i178

if.else.i178:                                     ; preds = %SemiRotateConstraint.exit
  %conv4.i179 = fptrunc double %call3.i176 to float
  %conv8.i180 = sitofp i32 %c2.sroa.14.0 to float
  %conv9.i181 = sitofp i32 %26 to float
  %neg.i182 = fneg float %conv9.i181
  %30 = tail call float @llvm.fmuladd.f32(float %neg.i182, float %conv4.i179, float %conv8.i180)
  %div.i183 = fdiv float %30, %conv1.i175
  %.inv.i184 = fcmp oge float %div.i183, 0x415FFFFFC0000000
  %cond89.i185 = select i1 %.inv.i184, float 0x415FFFFFC0000000, float %div.i183
  %cond.i186 = fptosi float %cond89.i185 to i32
  %conv20.i188 = sitofp i32 %c2.sroa.8.0 to float
  %31 = tail call float @llvm.fmuladd.f32(float %neg.i182, float %conv4.i179, float %conv20.i188)
  %conv23.i189 = sitofp i32 %27 to float
  %neg24.i190 = fneg float %conv23.i189
  %conv42.i196 = sitofp i32 %c2.sroa.0.0 to float
  %32 = insertelement <2 x float> poison, float %neg24.i190, i64 0
  %33 = shufflevector <2 x float> %32, <2 x float> poison, <2 x i32> zeroinitializer
  %34 = insertelement <2 x float> poison, float %conv4.i179, i64 0
  %35 = shufflevector <2 x float> %34, <2 x float> poison, <2 x i32> zeroinitializer
  %36 = insertelement <2 x float> poison, float %31, i64 0
  %37 = insertelement <2 x float> %36, float %conv42.i196, i64 1
...
if.else111:                                       ; preds = %if.end90
  ...
  br i1 %cmp.i209, label %SemiRotateConstraint.exit236, label %if.else.i210

if.else.i210:                                     ; preds = %if.else111
  %conv4.i211 = fptrunc double %call3.i208 to float
  %conv8.i212 = sitofp i32 %c1.sroa.0.0 to float
  %49 = insertelement <2 x i32> poison, i32 %45, i64 0
  %50 = insertelement <2 x i32> %49, i32 %46, i64 1
  %51 = sitofp <2 x i32> %50 to <2 x float>
  %conv20.i220 = sitofp i32 %c1.sroa.8.0 to float
  %52 = fneg <2 x float> %51
  %53 = extractelement <2 x float> %52, i64 0
  %54 = tail call float @llvm.fmuladd.f32(float %53, float %conv4.i211, float %conv20.i220)
  %55 = insertelement <2 x float> poison, float %conv4.i211, i64 0
  %56 = shufflevector <2 x float> %55, <2 x float> poison, <2 x i32> zeroinitializer
  %57 = insertelement <2 x float> poison, float %conv8.i212, i64 0
  ...
  %conv42.i228 = sitofp i32 %c1.sroa.14.0 to float
  %66 = extractelement <2 x float> %52, i64 1
  %67 = tail call float @llvm.fmuladd.f32(float %66, float %conv4.i211, float %conv42.i228)
  %div45.i229 = fdiv float %67, %conv1.i207
  %.inv93.i230 = fcmp oge float %div45.i229, 0x415FFFFFC0000000
  %cond5692.i231 = select i1 %.inv93.i230, float 0x415FFFFFC0000000, float %div45.i229
  %cond56.i232 = fptosi float %cond5692.i231 to i32
  br label %SemiRotateConstraint.exit236

SemiRotateConstraint.exit236:                     ; preds = %if.else111, %if.else.i210
  %cond56.sink.i235 = phi i32 [ %cond56.i232, %if.else.i210 ], [ 8388607, %if.else111 ]
  %68 = phi <2 x i32> [ %65, %if.else.i210 ], [ <i32 8388607, i32 8388607>, %if.else111 ]
  ...
  %70 = load i32, ptr %ofwd116, align 8
  %71 = load i32, ptr %ou3112, align 8
  ...
  br i1 %cmp.i241, label %if.end124, label %if.else.i242

if.else.i242:                                     ; preds = %SemiRotateConstraint.exit236
  %conv4.i243 = fptrunc double %call3.i240 to float
  %conv8.i244 = sitofp i32 %c2.sroa.0.0 to float
  %conv9.i245 = sitofp i32 %70 to float
  %neg.i246 = fneg float %conv9.i245
  %74 = tail call float @llvm.fmuladd.f32(float %neg.i246, float %conv4.i243, float %conv8.i244)
  %div.i247 = fdiv float %74, %conv1.i239
  %.inv.i248 = fcmp oge float %div.i247, 0x415FFFFFC0000000
  %cond89.i249 = select i1 %.inv.i248, float 0x415FFFFFC0000000, float %div.i247
  %cond.i250 = fptosi float %cond89.i249 to i32
  %conv20.i252 = sitofp i32 %c2.sroa.8.0 to float
  %75 = tail call float @llvm.fmuladd.f32(float %neg.i246, float %conv4.i243, float %conv20.i252)
  %conv23.i253 = sitofp i32 %71 to float
  %neg24.i254 = fneg float %conv23.i253
  %conv42.i260 = sitofp i32 %c2.sroa.14.0 to float
  %76 = insertelement <2 x float> poison, float %neg24.i254, i64 0
  %77 = shufflevector <2 x float> %76, <2 x float> poison, <2 x i32> zeroinitializer
  %78 = insertelement <2 x float> poison, float %conv4.i243, i64 0
  %79 = shufflevector <2 x float> %78, <2 x float> poison, <2 x i32> zeroinitializer
  %80 = insertelement <2 x float> poison, float %75, i64 0
  %81 = insertelement <2 x float> %80, float %conv42.i260, i64 1
...
if.end124:                                        ; preds = %if.else.i242, %SemiRotateConstraint.exit236, %if.else.i178, %SemiRotateConstraint.exit
  %cond.sink.i265.sink = phi i32 [ %cond.i186, %if.else.i178 ], [ 8388607, %SemiRotateConstraint.exit ], [ %cond.i250, %if.else.i242 ], [ 8388607, %SemiRotateConstraint.exit236 ]
  %.sink298 = phi ptr [ %25, %if.else.i178 ], [ %25, %SemiRotateConstraint.exit ], [ %69, %if.else.i242 ], [ %69, %SemiRotateConstraint.exit236 ]
  %89 = phi <2 x i32> [ %44, %if.else.i178 ], [ <i32 8388607, i32 8388607>, %SemiRotateConstraint.exit ], [ %88, %if.else.i242 ], [ <i32 8388607, i32 8388607>, %SemiRotateConstraint.exit236 ]
...
if.then:                                          ; preds = %ScaleToConstraint.exit
  %5 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 34), align 1
...
if.then13:                                        ; preds = %if.then
  ...
  store ptr %call14, ptr @zz_hold, align 8
  br label %if.end21
...
if.end21:                                         ; preds = %if.then13, %if.else15
  ...
  %16 = load ptr, ptr %osucc94, align 8
...
cond.false129:                                    ; preds = %if.end21
  %17 = load ptr, ptr %arrayidx93, align 8
  ...
  store ptr %16, ptr %osucc113, align 8
  store ptr %x, ptr %osucc94, align 8
  store ptr %x, ptr %arrayidx93, align 8
  store ptr %16, ptr @xx_tmp, align 8
  store ptr %9, ptr @zz_res, align 8
...
if.else168:                                       ; preds = %cond.end153
  ...
  store ptr %25, ptr %arrayidx163, align 8
  br label %cond.end223
...
cond.end223:                                      ; preds = %if.then166, %if.else168
  ...
  store ptr %29, ptr %osucc214, align 8
  ...
  store ptr %33, ptr %osucc220, align 8
...
cond.false232:                                    ; preds = %cond.end223
  ...
  %37 = load ptr, ptr %arrayidx237, align 8
  store ptr %37, ptr %arrayidx93, align 8
  %38 = load ptr, ptr %arrayidx237, align 8
  %osucc247 = getelementptr inbounds [2 x %struct.LIST], ptr %38, i64 0, i64 1, i32 1
  store ptr %x, ptr %osucc247, align 8
  store ptr %36, ptr %arrayidx237, align 8
  %osucc253 = getelementptr inbounds [2 x %struct.LIST], ptr %36, i64 0, i64 1, i32 1
  store ptr %35, ptr %osucc253, align 8
  br label %cleanup
...
land.lhs.true:                                    ; preds = %if.end
  ...
  %or.cond1121 = select i1 %cmp3, i1 true, i1 %tobool.not
  %4 = and i16 %bf.load, 8
  %tobool11.not = icmp eq i16 %4, 0
  %or.cond1122 = select i1 %or.cond1121, i1 %tobool11.not, i1 false
  br i1 %or.cond1122, label %if.end13, label %if.then12

if.then12:                                        ; preds = %land.lhs.true
  store i32 8388607, ptr %xc, align 4
  %obfc = getelementptr inbounds %struct.CONSTRAINT, ptr %xc, i64 0, i32 1
...
if.end13:                                         ; preds = %land.lhs.true, %if.end
  ...
  %cond = load ptr, ptr %osucc.arrayidx, align 8
...
if.else:                                          ; preds = %sw.bb63
  ...
  store i32 8388607, ptr %obfc75, align 4
  %ofc76 = getelementptr inbounds %struct.CONSTRAINT, ptr %xc, i64 0, i32 2
  store i32 8388607, ptr %ofc76, align 4
  br label %cleanup
...
if.else89:                                        ; preds = %sw.bb78
  ...
  store i32 8388607, ptr %obfc91, align 4
  %ofc92 = getelementptr inbounds %struct.CONSTRAINT, ptr %xc, i64 0, i32 2
  store i32 8388607, ptr %ofc92, align 4
  br label %cleanup
...
sw.bb117:                                         ; preds = %for.cond
  ...
  %9 = load i32, ptr %osparec, align 4
...
sw.bb119:                                         ; preds = %for.cond, %for.cond
  %ou124.le1119 = getelementptr inbounds %struct.word_type, ptr %tlink.0, i64 0, i32 1
  tail call void @Constrained(ptr noundef nonnull %tlink.0, ptr noundef %xc, i32 noundef %dim, ptr noundef %why)
  %10 = load i8, ptr %ou124.le1119, align 8
...
if.then142:                                       ; preds = %sw.bb132
  ...
  %16 = load i32, ptr %arrayidx143, align 4
  store i32 %16, ptr %xc, align 4
  ...
  store i32 %add, ptr %obfc152, align 4
  %ofc157 = getelementptr inbounds %struct.CONSTRAINT, ptr %xc, i64 0, i32 2
  %.sink1174 = load i32, ptr %arrayidx151, align 4
  store i32 %.sink1174, ptr %ofc157, align 4
  %osucc1611176 = getelementptr inbounds [2 x %struct.LIST], ptr %tlink.0, i64 0, i64 1, i32 1
  %19 = load ptr, ptr %osucc1611176, align 8
  %cmp162.not1177 = icmp eq ptr %19, %tlink.0
  br i1 %cmp162.not1177, label %while.end, label %while.body

while.body:                                       ; preds = %if.then142, %sw.epilog
  %20 = phi ptr [ %29, %sw.epilog ], [ %19, %if.then142 ]
  %tlink.0.pn1179 = phi ptr [ %z.1, %sw.epilog ], [ %tlink.0, %if.then142 ]
  br i1 %cmp14, label %for.cond179.preheader, label %cond.false170

cond.false170:                                    ; preds = %while.body
  %arrayidx1601178 = getelementptr inbounds [2 x %struct.LIST], ptr %tlink.0.pn1179, i64 0, i64 1
  %21 = load ptr, ptr %arrayidx1601178, align 8
...
sw.bb215:                                         ; preds = %for.cond179, %for.cond179
  ...
  %23 = load i32, ptr %ou4216, align 8
  store i32 %23, ptr %xc, align 4
  %obfc220 = getelementptr inbounds %struct.closure_type, ptr %z.1, i64 0, i32 4, i32 0, i32 1
  %24 = load i32, ptr %obfc220, align 4
  store i32 %24, ptr %obfc152, align 4
  %ofc223 = getelementptr inbounds %struct.closure_type, ptr %z.1, i64 0, i32 4, i32 0, i32 2
  %25 = load i32, ptr %ofc223, align 8
  store i32 %25, ptr %ofc157, align 4
  br label %while.end
...
sw.epilog:                                        ; preds = %for.cond179, %for.cond179, %for.cond179, %for.cond179, %for.cond179, %for.cond179, %for.cond179, %for.cond179, %for.cond179, %for.cond179, %for.cond179
  ...
  %26 = load i32, ptr %arrayidx198, align 4
  store i32 %26, ptr %xc, align 4
  %27 = load i32, ptr %arrayidx198, align 4
  ...
  %28 = load i32, ptr %arrayidx207, align 4
  %add208 = add nsw i32 %28, %27
  store i32 %add208, ptr %obfc152, align 4
  %.sink = load i32, ptr %arrayidx207, align 4
  store i32 %.sink, ptr %ofc157, align 4
  %osucc161 = getelementptr inbounds [2 x %struct.LIST], ptr %z.1, i64 0, i64 1, i32 1
  %29 = load ptr, ptr %osucc161, align 8
  %cmp162.not = icmp eq ptr %29, %z.1
  br i1 %cmp162.not, label %while.end, label %while.body
...
if.then247:                                       ; preds = %sw.bb237
  ...
  store i32 %add272, ptr %ofc273, align 4
  br label %cleanup
...
if.end306:                                        ; preds = %if.then304, %sw.bb294
  ...
  %40 = load i32, ptr %obfc307, align 4
...
cond.false332:                                    ; preds = %if.end306
  ...
  %42 = load i32, ptr %arrayidx316, align 4
  ...
  %44 = load i32, ptr %arrayidx337, align 4
...
if.then.i:                                        ; preds = %if.then363
  %cond.i = load ptr, ptr %osucc.arrayidx, align 8
...
cond.end21.i:                                     ; preds = %cond.false15.i, %cond.end11.i
  ...
  %55 = load i8, ptr %ou1, align 8
  %56 = add i8 %55, -2
  %or.cond585.i = icmp ult i8 %56, 7
  %57 = load ptr, ptr %pg.i, align 8
...
cond.false34.i:                                   ; preds = %if.then30.i
  %58 = load ptr, ptr %prec_def.i, align 8
...
cond.false46.i:                                   ; preds = %cond.end41.i
  ...
  %62 = load i32, ptr %arrayidx50.i, align 4
  ...
  %63 = load i32, ptr %arrayidx54.i, align 4
...
cond.end57.i:                                     ; preds = %cond.false46.i, %cond.end41.i
  ...
  %64 = load ptr, ptr %pg.i, align 8
  %cmp59.i = icmp eq ptr %64, null
  %65 = load ptr, ptr %sg.i, align 8
...
cond.false65.i:                                   ; preds = %cond.true61.i
  ...
  %67 = load i32, ptr %arrayidx69.i, align 4
  br label %cond.end97.i

cond.false72.i:                                   ; preds = %cond.end57.i
  %68 = load ptr, ptr %prec_def.i, align 8
...
cond.false80.i:                                   ; preds = %cond.false72.i
  ...
  %71 = load i32, ptr %arrayidx88.i, align 4
  ...
  %72 = load i32, ptr %arrayidx92.i, align 4
...
cond.end97.i:                                     ; preds = %cond.false72.i, %cond.false80.i, %cond.false65.i, %cond.true61.i
  ...
  %73 = load i32, ptr %side.i, align 4
...
sw.bb.i:                                          ; preds = %cond.end97.i
  ...
  %74 = load i32, ptr %arrayidx102.i, align 4
  ...
  %75 = load i32, ptr %arrayidx107.i, align 4
  br label %if.end.i
...
sw.bb108.i:                                       ; preds = %cond.end97.i
  ...
  %76 = load i32, ptr %arrayidx112.i, align 4
...
sw.bb114.i:                                       ; preds = %cond.end97.i
  ...
  %77 = load i32, ptr %arrayidx118.i, align 4
...
cond.true128.i:                                   ; preds = %if.else.i
  ...
  %79 = load i32, ptr %arrayidx132.i, align 4
  br label %cond.end155.i

cond.false133.i:                                  ; preds = %if.else.i
  %80 = load ptr, ptr %prec_def.i, align 8
  ...
  %81 = load i32, ptr %arrayidx137.i, align 4
  ...
  %82 = load i32, ptr %arrayidx141.i, align 4
  ...
  %83 = load i32, ptr %arrayidx145.i, align 4
  ...
  %84 = load ptr, ptr %prec_def.i, align 8
  ...
  %85 = load i32, ptr %arrayidx151.i, align 4
  %86 = load ptr, ptr %pg.i, align 8
...
cond.false164.i:                                  ; preds = %cond.end155.i
  ...
  %90 = load i32, ptr %arrayidx172.i, align 4
  ...
  %91 = load i32, ptr %arrayidx176.i, align 4
  ...
  %93 = load i32, ptr %arrayidx182.i, align 4
  ...
  %94 = load i32, ptr %arrayidx186.i, align 4
  %95 = load ptr, ptr %sg.i, align 8
...
cond.end190.i:                                    ; preds = %cond.end155.i, %cond.false164.i
  ...
  %96 = load i32, ptr %side.i, align 4
...
sw.bb192.i:                                       ; preds = %cond.end190.i
  ...
  %97 = load i32, ptr %arrayidx196.i, align 4
  ...
  %99 = load i32, ptr %arrayidx202.i, align 4
  br label %if.end.i
...
sw.bb203.i:                                       ; preds = %cond.end190.i
  ...
  %100 = load i32, ptr %arrayidx207.i, align 4
  ...
  %101 = load i32, ptr %arrayidx212.i, align 4
...
sw.bb214.i:                                       ; preds = %cond.end190.i
  ...
  %102 = load i32, ptr %arrayidx218.i, align 4
  ...
  %103 = load i32, ptr %arrayidx222.i, align 4
...
if.end.i:                                         ; preds = %sw.bb214.i, %sw.bb203.i, %sw.bb192.i, %sw.bb114.i, %sw.bb108.i, %sw.bb.i
  ...
  %cmp227.not.i = icmp sgt i32 %backy.0.i, %108
...
land.lhs.true229.i:                               ; preds = %if.end.i.thread, %if.end.i
  ...
  %111 = load i32, ptr %obfc.i901, align 4
  %cmp232.not.i = icmp sgt i32 %add230.i, %111
...
land.lhs.true234.i:                               ; preds = %land.lhs.true229.i
  ...
  %cmp236.not.i = icmp sgt i32 %fwdy.0.i910, %112
...
CatConstrained.exit.sink.split:                   ; preds = %if.then363, %if.end.i, %land.lhs.true229.i, %land.lhs.true234.i, %sw.bb368.i, %sw.bb298.i, %sw.bb243.i
  %.sink1125 = phi i32 [ %cond276.i, %sw.bb243.i ], [ %cond346.i, %sw.bb298.i ], [ %cond401.i, %sw.bb368.i ], [ -1, %land.lhs.true234.i ], [ -1, %land.lhs.true229.i ], [ -1, %if.end.i ], [ 8388607, %if.then363 ]
  %.sink1124 = phi i32 [ %cond286.i, %sw.bb243.i ], [ %cond356.i, %sw.bb298.i ], [ %cond411.i, %sw.bb368.i ], [ -1, %land.lhs.true234.i ], [ -1, %land.lhs.true229.i ], [ -1, %if.end.i ], [ 8388607, %if.then363 ]
  %.sink1123 = phi i32 [ %cond294.i, %sw.bb243.i ], [ %cond364.i, %sw.bb298.i ], [ %cond419.i, %sw.bb368.i ], [ -1, %land.lhs.true234.i ], [ -1, %land.lhs.true229.i ], [ -1, %if.end.i ], [ 8388607, %if.then363 ]
  store i32 %.sink1125, ptr %xc, align 4
  %obfc240.i = getelementptr inbounds %struct.CONSTRAINT, ptr %xc, i64 0, i32 1
  store i32 %.sink1124, ptr %obfc240.i, align 4
  %ofc241.i = getelementptr inbounds %struct.CONSTRAINT, ptr %xc, i64 0, i32 2
  store i32 %.sink1123, ptr %ofc241.i, align 4
...
if.then376:                                       ; preds = %if.end364
  ...
  store i32 8388607, ptr %obfc378, align 4
  %ofc379 = getelementptr inbounds %struct.CONSTRAINT, ptr %xc, i64 0, i32 2
  store i32 8388607, ptr %ofc379, align 4
  br label %cleanup
...
REST_OF_HEAD:                                     ; preds = %if.end364, %if.else283
  ...
  %ou1241090 = getelementptr inbounds %struct.word_type, ptr %tlink.0, i64 0, i32 1
  %lp.0979 = load ptr, ptr %cond, align 8
...
for.cond391:                                      ; preds = %for.cond391.preheader, %for.cond391
  %lp.0.pn = phi ptr [ %z.2, %for.cond391 ], [ %lp.0981, %for.cond391.preheader ]
  %z.2.in = getelementptr inbounds [2 x %struct.LIST], ptr %lp.0.pn, i64 0, i64 1
  %z.2 = load ptr, ptr %z.2.in, align 8
  %ou1392 = getelementptr inbounds %struct.word_type, ptr %z.2, i64 0, i32 1
  %119 = load i8, ptr %ou1392, align 8
...
for.inc417:                                       ; preds = %for.cond391, %land.lhs.true408
  %lp.0 = load ptr, ptr %lp.0981, align 8
  %cmp385.not = icmp eq ptr %lp.0, %tlink.0
  br i1 %cmp385.not, label %for.end421, label %for.cond391.preheader
...
for.end421:                                       ; preds = %for.inc417, %land.lhs.true408, %REST_OF_HEAD
  ...
  %rp.0986 = load ptr, ptr %osucc23, align 8
...
for.cond432:                                      ; preds = %for.cond432.preheader, %for.cond432
  ...
  %121 = load i8, ptr %ou1433, align 8
...
for.inc458:                                       ; preds = %for.cond432, %land.lhs.true449
  ...
  %rp.0 = load ptr, ptr %osucc461, align 8
  %cmp426.not = icmp eq ptr %rp.0, %tlink.0
  br i1 %cmp426.not, label %for.end462, label %for.cond432.preheader
...
land.lhs.true468:                                 ; preds = %for.end462
  %123 = load i8, ptr %ou1241090, align 8
...
cond.false507:                                    ; preds = %if.then481
  ...
  %125 = load i32, ptr %arrayidx491, align 4
  ...
  %126 = load i32, ptr %arrayidx512, align 4
...
for.cond539:                                      ; preds = %for.cond539.preheader, %for.cond539
  ...
  %127 = load i8, ptr %ou1540, align 8
...
if.end569:                                        ; preds = %lor.lhs.false556
  ...
  %129 = load i32, ptr %arrayidx573, align 4
  ...
  %130 = load i32, ptr %arrayidx587, align 4
...
for.inc598:                                       ; preds = %for.cond539, %lor.lhs.false556, %if.end569
  ...
  %cmp533.not = icmp eq ptr %link.0, %rp.0.lcssa1055
  br i1 %cmp533.not, label %for.end602, label %for.cond539.preheader
