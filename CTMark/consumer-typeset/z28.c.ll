; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z28.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z28.c"
...
if.else:                                          ; preds = %while.end
  ...
  %12 = load ptr, ptr @MsgCat, align 8
...
while.body30:                                     ; preds = %while.cond27.preheader, %while.body30
  call void @LeaveErrorBlock(i32 noundef 1)
  %13 = load i32, ptr @block_top, align 4
  %cmp28 = icmp sgt i32 %13, 0
  br i1 %cmp28, label %while.body30, label %while.end31

while.end31:                                      ; preds = %while.body30, %while.cond27.preheader
  %14 = load i32, ptr @AltErrorFormat, align 4
...
if.then33:                                        ; preds = %while.end31
  ...
  %16 = load ptr, ptr @MsgCat, align 8
...
sw.bb56:                                          ; preds = %if.end
  %20 = load i32, ptr @block_top, align 4
...
if.then60:                                        ; preds = %lor.lhs.false, %sw.bb56
  %22 = load i32, ptr @AltErrorFormat, align 4
...
if.else66:                                        ; preds = %if.then60
  ...
  %23 = load i16, ptr %ofile_num67, align 2
  %conv68 = zext i16 %23 to i32
  %24 = load i32, ptr @PrintFileBanner.CurrentFileNum, align 4
...
if.then.i:                                        ; preds = %if.else66
  ...
  store i32 %conv68, ptr @PrintFileBanner.CurrentFileNum, align 4
...
if.else85:                                        ; preds = %if.then76
  ...
  %28 = load i16, ptr %ofile_num86, align 2
  ...
  store i32 %inc90, ptr @mess_top, align 4
...
entry:
  %0 = load i32, ptr @block_top, align 4
...
if.then:                                          ; preds = %entry
  ...
  %arrayidx = getelementptr inbounds [20 x i32], ptr @print_block, i64 0, i64 %idxprom
  store i32 %ok_to_print, ptr %arrayidx, align 4
  %1 = load i32, ptr @mess_top, align 4
  %arrayidx2 = getelementptr inbounds [20 x i32], ptr @start_block, i64 0, i64 %idxprom
  store i32 %1, ptr %arrayidx2, align 4
  %inc = add nsw i32 %0, 1
  store i32 %inc, ptr @block_top, align 4
  br label %if.end
...
lor.lhs.false:                                    ; preds = %if.end
  %2 = load i32, ptr @block_top, align 4
  %sub = add nsw i32 %2, -1
  %idxprom = sext i32 %sub to i64
  %arrayidx = getelementptr inbounds [20 x i32], ptr @print_block, i64 0, i64 %idxprom
...
for.body:                                         ; preds = %for.body.preheader, %for.inc
  ...
  %10 = load i32, ptr @AltErrorFormat, align 4
...
if.then15:                                        ; preds = %for.body
  ...
  %11 = load ptr, ptr @fp, align 8
  %call18 = tail call i32 @fputs(ptr noundef nonnull %arrayidx17, ptr noundef %11)
  br label %for.inc

if.else:                                          ; preds = %for.body
  %arrayidx20 = getelementptr inbounds [20 x i32], ptr @message_fnum, i64 0, i64 %indvars.iv
  %12 = load i32, ptr %arrayidx20, align 4
  %13 = load i32, ptr @PrintFileBanner.CurrentFileNum, align 4
  %cmp.not.i = icmp eq i32 %13, %12
  %.pre37 = load ptr, ptr @fp, align 8
  br i1 %cmp.not.i, label %PrintFileBanner.exit, label %if.then.i

if.then.i:                                        ; preds = %if.else
  %conv.i = trunc i32 %12 to i16
  %call.i = tail call ptr @EchoFileSource(i16 noundef zeroext %conv.i) #8
  %call1.i = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %.pre37, ptr noundef nonnull @.str.16, ptr noundef %call.i)
  store i32 %12, ptr @PrintFileBanner.CurrentFileNum, align 4
  %.pre = load ptr, ptr @fp, align 8
  br label %PrintFileBanner.exit

PrintFileBanner.exit:                             ; preds = %if.else, %if.then.i
  %14 = phi ptr [ %.pre37, %if.else ], [ %.pre, %if.then.i ]
  %arrayidx22 = getelementptr inbounds [20 x [512 x i8]], ptr @message, i64 0, i64 %indvars.iv
  %call24 = tail call i32 @fputs(ptr noundef nonnull %arrayidx22, ptr noundef %14)
  br label %for.inc

for.inc:                                          ; preds = %if.then15, %PrintFileBanner.exit
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
  %15 = load i32, ptr @mess_top, align 4
  %16 = sext i32 %15 to i64
  %cmp13 = icmp slt i64 %indvars.iv.next, %16
  br i1 %cmp13, label %for.body, label %if.end26.loopexit

if.end26.loopexit:                                ; preds = %for.inc
  %.pre38 = load i32, ptr @block_top, align 4
  br label %if.end26

if.end26:                                         ; preds = %if.end26.loopexit, %if.then9, %if.end7
  %17 = phi i32 [ %.pre38, %if.end26.loopexit ], [ %.pre39, %if.then9 ], [ %.pre39, %if.end7 ]
  %dec = add nsw i32 %17, -1
  store i32 %dec, ptr @block_top, align 4
  ...
  store i32 %18, ptr @mess_top, align 4
  ret void
}
...
entry:
  %0 = load i32, ptr @PrintFileBanner.CurrentFileNum, align 4
...
if.then:                                          ; preds = %entry
  ...
  store i32 %fnum, ptr @PrintFileBanner.CurrentFileNum, align 4
  br label %if.end
