...
if.end7:                                          ; preds = %if.then6, %if.end4
  %.pre39 = load i32, ptr @block_top, align 4, !tbaa !9
...
if.then9:                                         ; preds = %if.end7
  ...
  %8 = load i32, ptr @mess_top, align 4, !tbaa !9
...
for.body:                                         ; preds = %for.body.preheader, %for.inc
  ...
  %10 = load i32, ptr @AltErrorFormat, align 4, !tbaa !9
...
if.else:                                          ; preds = %for.body
  ...
  %.pre37 = load ptr, ptr @fp, align 8, !tbaa !5
  br i1 %cmp.not.i, label %PrintFileBanner.exit, label %if.then.i
...
for.inc:                                          ; preds = %if.then15, %PrintFileBanner.exit
  ...
  %15 = load i32, ptr @mess_top, align 4, !tbaa !9
  %16 = sext i32 %15 to i64
  %cmp13 = icmp slt i64 %indvars.iv.next, %16
  br i1 %cmp13, label %for.body, label %if.end26.loopexit, !llvm.loop !17

if.end26.loopexit:                                ; preds = %for.inc
  %.pre38 = load i32, ptr @block_top, align 4, !tbaa !9
  br label %if.end26
...
if.end26:                                         ; preds = %if.end26.loopexit, %if.then9, %if.end7
  ...
  %18 = load i32, ptr %arrayidx28, align 4, !tbaa !9
  store i32 %18, ptr @mess_top, align 4, !tbaa !9
  ret void
}
