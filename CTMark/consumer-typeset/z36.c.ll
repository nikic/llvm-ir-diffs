; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z36.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z36.c"
...
if.end13:                                         ; preds = %if.then, %lor.lhs.false
  ...
  %2 = load i32, ptr @InitializeAll, align 4
  %tobool.not = icmp eq i32 %2, 0
...
land.lhs.true:                                    ; preds = %lor.lhs.false37
  %bcmp353 = call i32 @bcmp(ptr noundef nonnull dereferenceable(30) %str, ptr noundef nonnull dereferenceable(30) @.str.12, i64 30)
  %cmp44 = icmp eq i32 %bcmp353, 0
...
if.end49:                                         ; preds = %if.then46, %land.lhs.true, %lor.lhs.false37
  %bcmp354 = call i32 @bcmp(ptr noundef nonnull dereferenceable(30) %str, ptr noundef nonnull dereferenceable(30) @.str.11, i64 30)
  %cmp52 = icmp eq i32 %bcmp354, 0
...
NewTrie.exit:                                     ; preds = %if.end55, %if.then.i
  store i32 5361534, ptr %call.i, align 8
  %class_count.i = getelementptr inbounds %struct.trie_rec, ptr %call.i, i64 0, i32 1
  store i32 1, ptr %class_count.i, align 4
  %scevgep.i = getelementptr i8, ptr %call.i, i64 8
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(256) %scevgep.i, i8 0, i64 256, i1 false)
  ...
  store ptr %arrayidx11.i, ptr %string_mem.i, align 8
  %string_first.i = getelementptr inbounds %struct.trie_rec, ptr %call.i, i64 0, i32 8
  store i32 32767, ptr %string_first.i, align 4
  %string_lim12.i = getelementptr inbounds %struct.trie_rec, ptr %call.i, i64 0, i32 7
  store i32 32767, ptr %string_lim12.i, align 8
  store i32 0, ptr %length_limit, align 4
  %call58410 = call ptr @fgets(ptr noundef nonnull %buff, i32 noundef 512, ptr noundef nonnull %call26)
  %cmp59.not411 = icmp eq ptr %call58410, null
  br i1 %cmp59.not411, label %if.then259, label %while.body

while.cond.loopexit:                              ; preds = %sw.epilog, %while.body
  %state.1.lcssa = phi i32 [ %state.0412, %while.body ], [ %state.2, %sw.epilog ]
  ...
  br i1 %cmp59.not, label %while.end256, label %while.body

while.body:                                       ; preds = %NewTrie.exit, %while.cond.loopexit
  %hline_num.0413 = phi i32 [ %inc, %while.cond.loopexit ], [ 1, %NewTrie.exit ]
  %state.0412 = phi i32 [ %state.1.lcssa, %while.cond.loopexit ], [ 0, %NewTrie.exit ]
  %inc = add nuw nsw i32 %hline_num.0413, 1
  %call63404 = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef nonnull %buff, ptr noundef nonnull @.str.14, ptr noundef nonnull %str, ptr noundef nonnull %bcount) #11
  %cmp64405 = icmp eq i32 %call63404, 1
  %6 = load i8, ptr %str, align 16
  %cmp68406 = icmp ne i8 %6, 37
  %7 = select i1 %cmp64405, i1 %cmp68406, i1 false
...
while.body70:                                     ; preds = %while.body, %sw.epilog
  ...
  %bpos.0408 = phi i32 [ %add, %sw.epilog ], [ 0, %while.body ]
  %state.1407 = phi i32 [ %state.2, %sw.epilog ], [ %state.0412, %while.body ]
  %9 = load i32, ptr %bcount, align 4
...
for.cond.preheader.i:                             ; preds = %while.cond.i
  %add.ptr.i363 = getelementptr inbounds i8, ptr %q.0.i, i64 1
  %call.i364393 = call i32 @StringBeginsWith(ptr noundef nonnull %add.ptr.i363, ptr noundef nonnull @.str.28) #11
  %tobool.not.i394 = icmp eq i32 %call.i364393, 0
...
for.body.i:                                       ; preds = %for.inc.i
  ...
  %12 = load ptr, ptr %arrayidx10.i, align 8
  %call.i364 = call i32 @StringBeginsWith(ptr noundef nonnull %add.ptr.i363, ptr noundef %12) #11
  %tobool.not.i = icmp eq i32 %call.i364, 0
...
for.inc.i:                                        ; preds = %for.cond.preheader.i, %for.body.i
  ...
  br i1 %cmp7.not.i, label %if.else.i, label %for.body.i
...
for.end.i:                                        ; preds = %for.body.i, %for.cond.preheader.i
  ...
  %.pr.i = load i8, ptr %.lcssa382, align 1
...
if.then19.i:                                      ; preds = %for.end.i
  ...
  %16 = load ptr, ptr %arrayidx31.i, align 8
...
if.end39.i:                                       ; preds = %if.else37.i, %if.else.i, %if.then19.i
  ...
  %.pre = load i8, ptr %q.1.i, align 1
  br label %while.cond.i

DecodeEscapes.exit:                               ; preds = %while.cond.i
  %add = add nsw i32 %9, %bpos.0408
  store i8 0, ptr %p.0.i, align 1
  switch i32 %state.1407, label %sw.default [
    i32 0, label %sw.bb
    i32 1, label %sw.bb82
...
for.cond193.preheader:                            ; preds = %DecodeEscapes.exit
  ...
  %cmp197.not398 = icmp eq i8 %18, 0
  br i1 %cmp197.not398, label %for.end227, label %for.body199

sw.bb:                                            ; preds = %DecodeEscapes.exit
  %bcmp361 = call i32 @bcmp(ptr noundef nonnull dereferenceable(9) %str, ptr noundef nonnull dereferenceable(9) @.str.15, i64 9)
  %cmp76 = icmp eq i32 %bcmp361, 0
...
sw.bb82:                                          ; preds = %DecodeEscapes.exit
  %bcmp358 = call i32 @bcmp(ptr noundef nonnull dereferenceable(12) %str, ptr noundef nonnull dereferenceable(12) @.str.17, i64 12)
  %cmp85 = icmp eq i32 %bcmp358, 0
  br i1 %cmp85, label %sw.epilog, label %if.else88

if.else88:                                        ; preds = %sw.bb82
  %bcmp359 = call i32 @bcmp(ptr noundef nonnull dereferenceable(10) %str, ptr noundef nonnull dereferenceable(10) @.str.18, i64 10)
  %cmp91 = icmp eq i32 %bcmp359, 0
  br i1 %cmp91, label %sw.epilog, label %if.else94

if.else94:                                        ; preds = %if.else88
  %bcmp360 = call i32 @bcmp(ptr noundef nonnull dereferenceable(13) %str, ptr noundef nonnull dereferenceable(13) @.str.19, i64 13)
  %cmp97 = icmp eq i32 %bcmp360, 0
  br i1 %cmp97, label %sw.epilog, label %if.else100

if.else100:                                       ; preds = %if.else94
  %20 = load i32, ptr %string_first.i, align 4
  %21 = load i32, ptr %string_lim12.i, align 8
  %cmp.i366 = icmp eq i32 %20, %21
  br i1 %cmp.i366, label %if.end.i, label %if.then.i367

if.then.i367:                                     ; preds = %if.else100
  %22 = load ptr, ptr @no_fpos, align 8
  %call.i368 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %22, ptr noundef nonnull @.str.163) #11
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i367, %if.else100
  %23 = load i8, ptr %str, align 16
  %cmp1.not37.i = icmp eq i8 %23, 0
  br i1 %cmp1.not37.i, label %AddClassToTrie.exit, label %for.body.i370

for.body.i370:                                    ; preds = %if.end.i, %for.inc.i373
  %indvars.iv.i371 = phi i64 [ %indvars.iv.next.i374, %for.inc.i373 ], [ 0, %if.end.i ]
  %24 = phi i8 [ %28, %for.inc.i373 ], [ %23, %if.end.i ]
  ...
  br i1 %cmp8.i, label %if.then10.i, label %if.else.i372

if.then10.i:                                      ; preds = %for.body.i370
  %26 = load i32, ptr %class_count.i, align 4
  %conv11.i = trunc i32 %26 to i8
  store i8 %conv11.i, ptr %arrayidx6.i, align 1
  br label %for.inc.i373

if.else.i372:                                     ; preds = %for.body.i370
...
for.inc.i373:                                     ; preds = %if.else.i372, %if.then10.i
  %indvars.iv.next.i374 = add nuw i64 %indvars.iv.i371, 1
  %arrayidx.i375 = getelementptr inbounds i8, ptr %str, i64 %indvars.iv.next.i374
  %28 = load i8, ptr %arrayidx.i375, align 1
  %cmp1.not.i = icmp eq i8 %28, 0
  br i1 %cmp1.not.i, label %AddClassToTrie.exit, label %for.body.i370

AddClassToTrie.exit:                              ; preds = %for.inc.i373, %if.end.i
  %29 = load i32, ptr %class_count.i, align 4
  %inc23.i = add nsw i32 %29, 1
  store i32 %inc23.i, ptr %class_count.i, align 4
  br label %sw.epilog

sw.bb105:                                         ; preds = %DecodeEscapes.exit
  %bcmp356 = call i32 @bcmp(ptr noundef nonnull dereferenceable(10) %str, ptr noundef nonnull dereferenceable(10) @.str.18, i64 10)
  %cmp108 = icmp eq i32 %bcmp356, 0
  br i1 %cmp108, label %sw.epilog, label %if.else111

if.else111:                                       ; preds = %sw.bb105
  %bcmp357 = call i32 @bcmp(ptr noundef nonnull dereferenceable(13) %str, ptr noundef nonnull dereferenceable(13) @.str.19, i64 13)
  %cmp114 = icmp eq i32 %bcmp357, 0
  br i1 %cmp114, label %sw.epilog, label %if.else117

if.else117:                                       ; preds = %if.else111
  store i8 46, ptr %key, align 16
  store i8 56, ptr %value, align 16
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %if.else117
  %indvars.iv422 = phi i64 [ %indvars.iv.next423, %for.inc ], [ 0, %if.else117 ]
  %prev.0 = phi i32 [ %prev.1, %for.inc ], [ 56, %if.else117 ]
  %j.0 = phi i32 [ %j.1, %for.inc ], [ 1, %if.else117 ]
  %arrayidx125 = getelementptr inbounds [512 x i8], ptr %str, i64 0, i64 %indvars.iv422
  %30 = load i8, ptr %arrayidx125, align 1
...
if.else135:                                       ; preds = %for.cond
  ...
  store i8 %30, ptr %arrayidx139, align 1
  ...
  store i8 %conv140, ptr %arrayidx143, align 1
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  ...
  store i8 46, ptr %arrayidx147, align 1
  ...
  store i8 %conv148, ptr %arrayidx151, align 1
  ...
  store i8 56, ptr %arrayidx156, align 1
  ...
  %call164 = call fastcc i32 @TrieInsert(ptr noundef nonnull %key, ptr noundef nonnull %value, ptr noundef nonnull %call.i, ptr noundef nonnull %ostring, i32 noundef %inc)
...
sw.bb174:                                         ; preds = %DecodeEscapes.exit
  %bcmp355 = call i32 @bcmp(ptr noundef nonnull dereferenceable(10) %str, ptr noundef nonnull dereferenceable(10) @.str.18, i64 10)
  %cmp177 = icmp eq i32 %bcmp355, 0
...
for.body199:                                      ; preds = %for.cond193.preheader, %for.inc225
  ...
  %j.2401 = phi i32 [ %j.3, %for.inc225 ], [ 0, %for.cond193.preheader ]
  %prev.2399 = phi i32 [ %prev.3, %for.inc225 ], [ 48, %for.cond193.preheader ]
...
if.else215:                                       ; preds = %for.body199
  %idxprom218 = sext i32 %j.2401 to i64
  %arrayidx219 = getelementptr inbounds [512 x i8], ptr %key, i64 0, i64 %idxprom218
  store i8 %31, ptr %arrayidx219, align 1
  %conv220 = trunc i32 %prev.2399 to i8
  %inc221 = add nsw i32 %j.2401, 1
  %arrayidx223 = getelementptr inbounds [512 x i8], ptr %value, i64 0, i64 %idxprom218
  store i8 %conv220, ptr %arrayidx223, align 1
  br label %for.inc225

for.inc225:                                       ; preds = %for.body199, %if.else215
  %prev.3 = phi i32 [ 48, %if.else215 ], [ %conv196, %for.body199 ]
  %j.3 = phi i32 [ %inc221, %if.else215 ], [ %j.2401, %for.body199 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx195 = getelementptr inbounds [512 x i8], ptr %str, i64 0, i64 %indvars.iv.next
  %33 = load i8, ptr %arrayidx195, align 1
  %cmp197.not = icmp eq i8 %33, 0
  br i1 %cmp197.not, label %for.end227, label %for.body199
...
for.end227:                                       ; preds = %for.inc225, %for.cond193.preheader
  ...
  %34 = load i32, ptr %length_limit, align 4
  %cmp236 = icmp ne i32 %34, 0
  %cmp239.not = icmp sgt i32 %j.2.lcssa, %34
  %or.cond362 = and i1 %cmp236, %cmp239.not
  br i1 %or.cond362, label %sw.epilog, label %if.then241

if.then241:                                       ; preds = %for.end227
  %call246 = call fastcc i32 @TrieInsert(ptr noundef nonnull %key, ptr noundef nonnull %value, ptr noundef nonnull %call.i, ptr noundef nonnull %ostring, i32 noundef %inc)
...
sw.epilog:                                        ; preds = %for.end227, %sw.bb174, %if.else111, %sw.bb105, %if.else94, %if.else88, %sw.bb82, %sw.bb, %if.then78, %if.then241, %if.else180, %for.end, %AddClassToTrie.exit, %sw.default
  %state.2 = phi i32 [ %state.1407, %sw.default ], [ 4, %if.then241 ], [ 3, %if.else180 ], [ 2, %for.end ], [ 1, %AddClassToTrie.exit ], [ 1, %if.then78 ], [ 1, %sw.bb ], [ 2, %sw.bb82 ], [ 4, %if.else88 ], [ 3, %if.else94 ], [ 4, %sw.bb105 ], [ 3, %if.else111 ], [ 4, %sw.bb174 ], [ 4, %for.end227 ]
  ...
  br i1 %37, label %while.body70, label %while.cond.loopexit

while.end256:                                     ; preds = %while.cond.loopexit
  %38 = icmp eq i32 %state.1.lcssa, 4
  br i1 %38, label %cleanup, label %if.then259
...
if.then259:                                       ; preds = %NewTrie.exit, %while.end256
  ...
  %call261 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 36, i32 noundef 13, ptr noundef nonnull @.str.24, i32 noundef 1, ptr noundef %39, ptr noundef %call260) #11
  br label %cleanup
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %link.01603 = load ptr, ptr %link.0.in1602, align 8
...
if.end57:                                         ; preds = %if.then53, %if.end46
  ...
  %4 = load ptr, ptr %arrayidx58, align 8
...
if.then61:                                        ; preds = %if.end57
  ...
  %5 = load i32, ptr %arrayidx63, align 4
...
if.end71:                                         ; preds = %if.then61
  ...
  store ptr %call66, ptr %arrayidx58, align 8
...
for.cond81:                                       ; preds = %for.cond81, %if.end76
  ...
  %6 = load i8, ptr %arrayidx83, align 1
  ...
  br i1 %cmp87, label %for.cond81, label %for.cond92
...
for.cond92:                                       ; preds = %for.cond81, %for.cond92
  ...
  br i1 %cmp98, label %for.cond92, label %for.end103
...
if.else192:                                       ; preds = %if.end116
  ...
  store ptr %14, ptr %arrayidx187, align 8
  br label %if.end201
...
cond.end246.thread:                               ; preds = %if.end201
  store ptr %call124, ptr @zz_hold, align 8
...
cond.end246:                                      ; preds = %if.end201
  ...
  store ptr %19, ptr %osucc239, align 8
...
if.then292:                                       ; preds = %cond.end279
  ...
  store ptr %call293, ptr @zz_hold, align 8
  br label %if.end303

if.else294:                                       ; preds = %cond.end279
  store ptr %30, ptr @zz_hold, align 8
  %32 = load ptr, ptr %30, align 8
  store ptr %32, ptr %arrayidx289, align 8
  br label %if.end303
...
if.end303:                                        ; preds = %if.then292, %if.else294
  ...
  store ptr %33, ptr %osucc308, align 8
  store ptr %33, ptr %arrayidx307, align 8
  %osucc314 = getelementptr inbounds %struct.LIST, ptr %33, i64 0, i32 1
  store ptr %33, ptr %osucc314, align 8
...
if.else364:                                       ; preds = %if.end303
  ...
  store ptr %37, ptr %arrayidx359, align 8
  br label %if.end373
...
cond.end422:                                      ; preds = %if.end373
  ...
  store ptr %42, ptr %osucc413, align 8
  ...
  store ptr %46, ptr %osucc419, align 8
...
cond.end455:                                      ; preds = %cond.end422, %cond.false431
  ...
  %53 = load ptr, ptr %arrayidx465, align 8
...
if.else470:                                       ; preds = %cond.end455
  ...
  store ptr %55, ptr %arrayidx465, align 8
  br label %cond.end525
...
cond.end525:                                      ; preds = %if.then468, %if.else470
  ...
  store ptr %63, ptr %osucc522, align 8
  ...
  store ptr %call528, ptr @zz_hold, align 8
...
cond.false536:                                    ; preds = %cond.end525
  ...
  %67 = load ptr, ptr %arrayidx538, align 8
  store ptr %67, ptr @zz_tmp, align 8
  %arrayidx541 = getelementptr inbounds [2 x %struct.LIST], ptr %66, i64 0, i64 1
  %68 = load ptr, ptr %arrayidx541, align 8
  store ptr %68, ptr %arrayidx538, align 8
  %69 = load ptr, ptr %arrayidx541, align 8
  %osucc551 = getelementptr inbounds [2 x %struct.LIST], ptr %69, i64 0, i64 1, i32 1
  store ptr %call528, ptr %osucc551, align 8
  store ptr %67, ptr %arrayidx541, align 8
...
cond.end560:                                      ; preds = %cond.end525, %cond.false536
  ...
  %70 = load ptr, ptr %osucc119, align 8
  br label %for.inc1325
...
for.body594.preheader:                            ; preds = %if.end572
  store i8 1, ptr %str, align 16
  store i8 48, ptr %rate, align 16
  call void @llvm.memset.p0.i64(ptr nonnull align 1 %scevgep, i8 48, i64 %indvar, i1 false)
...
for.body594:                                      ; preds = %for.body594, %for.body594.preheader.new
  ...
  store i8 %87, ptr %arrayidx602.3, align 4
  %niter.next.3 = add i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %for.end608.unr-lcssa, label %for.body594
...
for.body594.epil:                                 ; preds = %for.end608.unr-lcssa, %for.body594.epil
  ...
  store i8 %90, ptr %arrayidx602.epil, align 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %for.end608, label %for.body594.epil
...
for.end608:                                       ; preds = %for.body594.epil, %for.end608.unr-lcssa
  ...
  store i8 48, ptr %arrayidx620, align 1
  ...
  store i8 0, ptr %arrayidx623, align 1
...
do.body:                                          ; preds = %do.cond769, %for.end608
  ...
  %.pre = load ptr, ptr %node_mem, align 8
...
for.cond625:                                      ; preds = %if.end766, %do.body
  ...
  %92 = load i16, ptr %arrayidx627, align 2
...
for.body649.preheader:                            ; preds = %for.body642
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %q.01573, i8 48, i64 %umax, i1 false)
...
for.end652:                                       ; preds = %for.body649.preheader, %for.body642
  ...
  store i8 %sub655, ptr %q.1.lcssa, align 1
  %incdec.ptr659 = getelementptr inbounds i8, ptr %p632.01572, i64 1
  %100 = load i8, ptr %incdec.ptr659, align 1
  %cmp640.not = icmp eq i8 %100, 0
  br i1 %cmp640.not, label %for.end660, label %for.body642
...
if.end681:                                        ; preds = %if.end676
  ...
  %107 = load i16, ptr %arrayidx686, align 2
...
if.then694:                                       ; preds = %if.end691
  %108 = load ptr, ptr %string_mem, align 8
...
for.cond711.preheader:                            ; preds = %do.body699
  ...
  %110 = load i8, ptr %p704.01582, align 1
...
for.body724.preheader:                            ; preds = %for.body715
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %q705.01584, i8 48, i64 %umax1626, i1 false)
...
do.cond769:                                       ; preds = %if.end676, %if.end681, %do.cond, %if.end755, %for.end736
  ...
  %122 = load i8, ptr %add.ptr771, align 1
  %cmp773.not = icmp eq i8 %122, 1
  br i1 %cmp773.not, label %do.end775, label %do.body

do.end775:                                        ; preds = %do.cond769
  %123 = load ptr, ptr @finfo, align 8
  ...
  %124 = load ptr, ptr %lig_table, align 8
  %125 = load i8, ptr %ostring, align 1
...
for.body785:                                      ; preds = %do.end775, %for.inc840
  ...
  %127 = load i8, ptr %arrayidx787, align 1
...
if.then791:                                       ; preds = %for.body785
  ...
  %128 = load i8, ptr %arrayidx797, align 1
  %cmp8021590 = icmp eq i8 %128, %126
  br i1 %cmp8021590, label %while.body804, label %for.inc840

while.body804:                                    ; preds = %if.then791, %while.end835
  %a.01591 = phi ptr [ %incdec.ptr836, %while.end835 ], [ %arrayidx797, %if.then791 ]
  %incdec.ptr799 = getelementptr inbounds i8, ptr %a.01591, i64 1
  %.pre1636 = load i8, ptr %incdec.ptr799, align 1
  br label %while.cond806

while.cond806:                                    ; preds = %land.lhs.true811, %while.body804
  %129 = phi i8 [ %.pre1636, %while.body804 ], [ %131, %land.lhs.true811 ]
  %a.1 = phi ptr [ %incdec.ptr799, %while.body804 ], [ %add.ptr812, %land.lhs.true811 ]
  %p.0.pn = phi ptr [ %p.01593, %while.body804 ], [ %b.0, %land.lhs.true811 ]
  %b.0 = getelementptr inbounds i8, ptr %p.0.pn, i64 1
  %130 = load i8, ptr %b.0, align 1
  %cmp809 = icmp eq i8 %129, %130
  %add.ptr812 = getelementptr inbounds i8, ptr %a.1, i64 1
  %131 = load i8, ptr %add.ptr812, align 1
...
land.lhs.true811:                                 ; preds = %while.cond806
  ...
  br i1 %or.cond1537, label %while.end822, label %while.cond806
...
if.then827:                                       ; preds = %while.end822
  ...
  store i8 48, ptr %arrayidx829, align 1
  br label %for.inc840
...
while.cond831:                                    ; preds = %while.end822, %while.cond831
  ...
  %132 = load i8, ptr %incdec.ptr832, align 1
  %tobool833.not = icmp eq i8 %132, 0
  br i1 %tobool833.not, label %while.end835, label %while.cond831

while.end835:                                     ; preds = %while.cond831
  %incdec.ptr836 = getelementptr inbounds i8, ptr %a.2, i64 2
  %133 = load i8, ptr %incdec.ptr836, align 1
  %cmp802 = icmp eq i8 %133, %126
  br i1 %cmp802, label %while.body804, label %for.inc840
...
for.body852:                                      ; preds = %for.body852.lr.ph, %for.inc1317
  ...
  %137 = load i8, ptr %arrayidx854, align 1
  %138 = and i8 %137, 1
...
if.else935:                                       ; preds = %if.then858
  ...
  store ptr %142, ptr %arrayidx930, align 8
  br label %if.end944
...
cond.end993.thread:                               ; preds = %if.end944
  store ptr %call864, ptr @zz_hold, align 8
...
cond.end993:                                      ; preds = %if.end944
  ...
  store ptr %147, ptr %osucc984, align 8
  ...
  store ptr %151, ptr %osucc990, align 8
  %.pre1638 = load ptr, ptr @xx_link, align 8
  store ptr %.pre1638, ptr @zz_res, align 8
  store ptr %call864, ptr @zz_hold, align 8
  %cmp999 = icmp eq ptr %.pre1638, null
  br i1 %cmp999, label %cond.end1026, label %cond.false1002

cond.false1002:                                   ; preds = %cond.end993.thread, %cond.end993
  %153 = phi ptr [ %143, %cond.end993.thread ], [ %.pre1638, %cond.end993 ]
  %arrayidx1004 = getelementptr inbounds [2 x %struct.LIST], ptr %call864, i64 0, i64 1
  %154 = load ptr, ptr %arrayidx1004, align 8
  store ptr %154, ptr @zz_tmp, align 8
  %arrayidx1007 = getelementptr inbounds [2 x %struct.LIST], ptr %153, i64 0, i64 1
  %155 = load ptr, ptr %arrayidx1007, align 8
  store ptr %155, ptr %arrayidx1004, align 8
  %156 = load ptr, ptr %arrayidx1007, align 8
  %osucc1017 = getelementptr inbounds [2 x %struct.LIST], ptr %156, i64 0, i64 1, i32 1
  store ptr %call864, ptr %osucc1017, align 8
  store ptr %154, ptr %arrayidx1007, align 8
  %osucc1023 = getelementptr inbounds [2 x %struct.LIST], ptr %154, i64 0, i64 1, i32 1
  store ptr %153, ptr %osucc1023, align 8
...
cond.end1026:                                     ; preds = %cond.end993, %cond.false1002
  ...
  %158 = load ptr, ptr %arrayidx1036, align 8
...
if.else1041:                                      ; preds = %cond.end1026
  ...
  store ptr %160, ptr %arrayidx1036, align 8
  br label %if.end1050
...
if.end1050:                                       ; preds = %if.then1039, %if.else1041
  ...
  store i8 1, ptr %ou11051, align 8
  ...
  store ptr %161, ptr %osucc1055, align 8
  store ptr %161, ptr %arrayidx1054, align 8
  %osucc1061 = getelementptr inbounds %struct.LIST, ptr %161, i64 0, i32 1
  store ptr %161, ptr %osucc1061, align 8
  ...
  store i8 0, ptr %ovspace1066, align 2
  %ohspace1068 = getelementptr inbounds i8, ptr %161, i64 41
  store i8 0, ptr %ohspace1068, align 1
  ...
  store i16 0, ptr %owidth1090, align 2
...
if.else1114:                                      ; preds = %if.end1050
  store ptr %163, ptr @zz_hold, align 8
  %165 = load ptr, ptr %163, align 8
  store ptr %165, ptr %arrayidx1109, align 8
  br label %if.end1123
...
cond.end1172:                                     ; preds = %if.end1123
  ...
  store ptr %170, ptr %osucc1163, align 8
  ...
  store ptr %174, ptr %osucc1169, align 8
  %.pr1554 = load ptr, ptr @xx_link, align 8
  store ptr %.pr1554, ptr @zz_res, align 8
  store ptr %161, ptr @zz_hold, align 8
...
cond.end1172.cond.false1181_crit_edge:            ; preds = %cond.end1172
  ...
  %.pre1639 = load ptr, ptr %arrayidx1186.phi.trans.insert, align 8
  br label %cond.false1181

cond.false1181:                                   ; preds = %cond.end1172.cond.false1181_crit_edge, %cond.end1172.thread
  %176 = phi ptr [ %166, %cond.end1172.thread ], [ %.pre1639, %cond.end1172.cond.false1181_crit_edge ]
  %177 = phi ptr [ %166, %cond.end1172.thread ], [ %.pr1554, %cond.end1172.cond.false1181_crit_edge ]
  %178 = load ptr, ptr %arrayidx1054, align 8
  store ptr %178, ptr @zz_tmp, align 8
  %arrayidx1186 = getelementptr inbounds [2 x %struct.LIST], ptr %177, i64 0, i64 1
  store ptr %176, ptr %arrayidx1054, align 8
  %179 = load ptr, ptr %arrayidx1186, align 8
  %osucc1196 = getelementptr inbounds [2 x %struct.LIST], ptr %179, i64 0, i64 1, i32 1
  store ptr %161, ptr %osucc1196, align 8
  store ptr %178, ptr %arrayidx1186, align 8
  %osucc1202 = getelementptr inbounds [2 x %struct.LIST], ptr %178, i64 0, i64 1, i32 1
  store ptr %177, ptr %osucc1202, align 8
...
if.else1220:                                      ; preds = %cond.end1205
  ...
  store ptr %183, ptr %arrayidx1215, align 8
  br label %cond.end1275
...
cond.end1275:                                     ; preds = %if.then1218, %if.else1220
  ...
  store ptr %187, ptr %osucc1266, align 8
  ...
  store ptr %191, ptr %osucc1272, align 8
  ...
  store ptr %call1278, ptr @zz_hold, align 8
...
for.inc1317:                                      ; preds = %for.body852, %cond.end1310
  ...
  br i1 %cmp850, label %for.body852, label %for.end1318
...
for.inc1325:                                      ; preds = %for.cond6, %for.end843, %if.then61, %lor.lhs.false26, %lor.lhs.false31, %if.end572, %for.end1318, %if.then1320, %if.end568, %if.then109, %if.end71, %land.lhs.true, %if.then42, %cond.end560
  ...
  br i1 %cmp2.not, label %for.end1329, label %for.cond6.preheader
...
if.then.i:                                        ; preds = %if.then
  ...
  %.pre.i = load i32, ptr %node_free, align 4
  %.pre20.i = load i32, ptr %class_count, align 4
...
if.end.i:                                         ; preds = %if.then.i, %if.then
  ...
  store i32 %add4.pre-phi.i, ptr %node_free, align 4
...
for.body.lr.ph.i:                                 ; preds = %if.end.i
  ...
  %6 = load ptr, ptr %node_mem.i, align 8
  %7 = sext i32 %5 to i64
  %8 = shl nsw i64 %7, 1
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 2 dereferenceable(1) %scevgep.i, i8 0, i64 %14, i1 false)
  br label %if.end
...
for.cond.if.then10_crit_edge:                     ; preds = %for.cond
  %.pre294 = ptrtoint ptr %q.0 to i64
  %.pre295 = ptrtoint ptr %prev.0 to i64
  %.pre296 = xor i64 %.pre295, -1
  %.pre297 = add i64 %.pre296, %.pre294
  br label %if.then10
...
if.then10:                                        ; preds = %for.cond.if.then10_crit_edge, %lor.lhs.false
  %sub14.pre-phi = phi i64 [ %.pre297, %for.cond.if.then10_crit_edge ], [ %sub7, %lor.lhs.false ]
  ...
  store i8 %conv19, ptr %p.0, align 1
  br label %for.inc
...
if.then36:                                        ; preds = %for.body28
  ...
  store i8 %19, ptr %arrayidx43, align 1
  br label %for.inc49
...
for.inc49:                                        ; preds = %if.then36, %if.else
  ...
  br i1 %cmp26.not, label %for.end50, label %for.body28
...
for.end50.if.then59_crit_edge:                    ; preds = %for.end50
  %.pre290 = load ptr, ptr %node_mem.phi.trans.insert, align 8
  br label %if.then59
...
if.end82.lr.ph:                                   ; preds = %for.end50
  ...
  %.pre = load ptr, ptr %node_mem.phi.trans.insert, align 8
  br label %if.end82

if.then59.loopexit:                               ; preds = %if.end152
  %23 = sext i32 %mul153.pre-phi to i64
  br label %if.then59

if.then59:                                        ; preds = %for.end50.if.then59_crit_edge, %if.then59.loopexit
  %24 = phi ptr [ %.pre290, %for.end50.if.then59_crit_edge ], [ %62, %if.then59.loopexit ]
  %curr_node.0.lcssa = phi i64 [ 0, %for.end50.if.then59_crit_edge ], [ %23, %if.then59.loopexit ]
  %node_mem = getelementptr inbounds %struct.trie_rec, ptr %T, i64 0, i32 3
  %arrayidx61 = getelementptr inbounds i16, ptr %24, i64 %curr_node.0.lcssa
...
if.else67:                                        ; preds = %if.then59
  ...
  %27 = load i32, ptr %string_first.i, align 4
...
if.end74:                                         ; preds = %if.else67
  ...
  store i32 %conv3.i, ptr %string_first.i, align 4
  %string_mem.i = getelementptr inbounds %struct.trie_rec, ptr %T, i64 0, i32 6
  %30 = load ptr, ptr %string_mem.i, align 8
  ...
  %31 = load ptr, ptr %node_mem, align 8
  %arrayidx80 = getelementptr inbounds i16, ptr %31, i64 %curr_node.0.lcssa
  store i16 %sub76, ptr %arrayidx80, align 2
  br label %cleanup

if.end82:                                         ; preds = %if.end82.lr.ph, %if.end152
  %.pre289291 = phi ptr [ %.pre, %if.end82.lr.ph ], [ %.pre289292, %if.end152 ]
  %32 = phi ptr [ %.pre, %if.end82.lr.ph ], [ %62, %if.end152 ]
  %indvars.iv287 = phi i64 [ 0, %if.end82.lr.ph ], [ %indvars.iv.next288, %if.end152 ]
  %33 = phi i8 [ %22, %if.end82.lr.ph ], [ %63, %if.end152 ]
...
if.end100:                                        ; preds = %if.then93
  ...
  %conv3.i230 = and i32 %38, 65535
  store i32 %conv3.i230, ptr %string_first, align 4
  %39 = load ptr, ptr %string_mem, align 8
  %sext.i232 = shl i64 %sub1.i225, 48
  %idxprom.i233 = ashr exact i64 %sext.i232, 48
  %arrayidx.i234 = getelementptr inbounds i8, ptr %39, i64 %idxprom.i233
  %call7.i235 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %arrayidx.i234, ptr noundef nonnull dereferenceable(1) %compressed_value) #11
  ...
  %40 = load i32, ptr %string_first, align 4
...
if.end109:                                        ; preds = %if.end100
  ...
  %conv3.i245 = and i32 %42, 65535
  store i32 %conv3.i245, ptr %string_first, align 4
  %43 = load ptr, ptr %string_mem, align 8
  %sext.i247 = shl i64 %sub1.i240, 48
  %idxprom.i248 = ashr exact i64 %sext.i247, 48
  %arrayidx.i249 = getelementptr inbounds i8, ptr %43, i64 %idxprom.i248
  %call7.i250 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %arrayidx.i249, ptr noundef nonnull dereferenceable(1) %arrayidx103) #11
  %sub111 = sub nsw i16 0, %conv2.i241
  %44 = load ptr, ptr %node_mem.phi.trans.insert, align 8
  %arrayidx119 = getelementptr inbounds i16, ptr %44, i64 %idxprom88
  store i16 %sub111, ptr %arrayidx119, align 2
  br label %cleanup
...
if.then130:                                       ; preds = %if.then123
  ...
  store i32 %inc132, ptr %string_first, align 4
  br label %if.end133

if.end133:                                        ; preds = %if.then130, %if.then123
  %48 = load i32, ptr %node_free, align 4
  %49 = load i32, ptr %class_count.i253, align 4
  %add.i254 = add i32 %49, %48
  %50 = load i32, ptr %node_lim.i255, align 8
  %cmp.i256 = icmp sgt i32 %add.i254, %50
  br i1 %cmp.i256, label %if.then.i264, label %if.end.i257

if.then.i264:                                     ; preds = %if.end133
  %51 = load ptr, ptr @no_fpos, align 8
  %call.i265 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 36, i32 noundef 5, ptr noundef nonnull @.str.167, i32 noundef 0, ptr noundef %51) #11
  %.pre.i266 = load i32, ptr %node_free, align 4
  %.pre20.i267 = load i32, ptr %class_count.i253, align 4
  %.pre21.i268 = add i32 %.pre20.i267, %.pre.i266
  %.pre289.pre = load ptr, ptr %node_mem.phi.trans.insert, align 8
  br label %if.end.i257

if.end.i257:                                      ; preds = %if.then.i264, %if.end133
  %.pre289 = phi ptr [ %.pre289.pre, %if.then.i264 ], [ %.pre289291, %if.end133 ]
  %add4.pre-phi.i258 = phi i32 [ %.pre21.i268, %if.then.i264 ], [ %add.i254, %if.end133 ]
  %52 = phi i32 [ %.pre20.i267, %if.then.i264 ], [ %49, %if.end133 ]
  %53 = phi i32 [ %.pre.i266, %if.then.i264 ], [ %48, %if.end133 ]
  store i32 %add4.pre-phi.i258, ptr %node_free, align 4
  %cmp617.i259 = icmp sgt i32 %52, 0
  br i1 %cmp617.i259, label %for.body.lr.ph.i260, label %NewTrieNode.exit269

for.body.lr.ph.i260:                              ; preds = %if.end.i257
  %54 = sext i32 %53 to i64
  %55 = shl nsw i64 %54, 1
  %scevgep.i262 = getelementptr i8, ptr %.pre289, i64 %55
  %56 = add i32 %53, 1
  %smax.i263 = tail call i32 @llvm.smax.i32(i32 %add4.pre-phi.i258, i32 %56)
  %57 = xor i32 %53, -1
  %58 = add i32 %smax.i263, %57
  %59 = zext i32 %58 to i64
  %60 = shl nuw nsw i64 %59, 1
  %61 = add nuw nsw i64 %60, 2
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 2 dereferenceable(1) %scevgep.i262, i8 0, i64 %61, i1 false)
  br label %NewTrieNode.exit269

NewTrieNode.exit269:                              ; preds = %if.end.i257, %for.body.lr.ph.i260
  %div135 = sdiv i32 %53, 4
  %conv136 = trunc i32 %div135 to i16
  %arrayidx143 = getelementptr inbounds i16, ptr %.pre289, i64 %idxprom88
  store i16 %conv136, ptr %arrayidx143, align 2
  %add144.neg = add i16 %34, -1
  %mul148 = shl nsw i32 %div135, 2
  %add149 = add nsw i32 %mul148, %conv127
  %idxprom150 = sext i32 %add149 to i64
  %arrayidx151 = getelementptr inbounds i16, ptr %.pre289, i64 %idxprom150
  store i16 %add144.neg, ptr %arrayidx151, align 2
  br label %if.end152

if.end152:                                        ; preds = %if.end120.if.end152_crit_edge, %NewTrieNode.exit269
  %mul153.pre-phi = phi i32 [ %.pre298, %if.end120.if.end152_crit_edge ], [ %mul148, %NewTrieNode.exit269 ]
  %.pre289292 = phi ptr [ %.pre289291, %if.end120.if.end152_crit_edge ], [ %.pre289, %NewTrieNode.exit269 ]
  %62 = phi ptr [ %32, %if.end120.if.end152_crit_edge ], [ %.pre289, %NewTrieNode.exit269 ]
  ...
  br i1 %cmp57, label %if.then59.loopexit, label %if.end82
...
entry:
  ...
  store i32 %0, ptr %node_lim, align 8
  %cmp72 = icmp sgt i32 %0, 0
  %node_mem = getelementptr inbounds %struct.trie_rec, ptr %T, i64 0, i32 3
  %1 = load ptr, ptr %node_mem, align 8
...
if.then:                                          ; preds = %for.body
  %5 = load i32, ptr %string_first, align 4
...
if.then.1:                                        ; preds = %for.inc
  %8 = load i32, ptr %string_first, align 4
  %9 = trunc i32 %8 to i16
  %conv10.1 = add i16 %7, %9
  store i16 %conv10.1, ptr %arrayidx.1, align 2
  br label %for.inc.1
...
for.end:                                          ; preds = %for.end.loopexit.unr-lcssa, %if.then.epil, %for.body.epil, %entry
  ...
  %13 = load i32, ptr %string_first18, align 4
  %string_lim = getelementptr inbounds %struct.trie_rec, ptr %T, i64 0, i32 7
  %14 = load i32, ptr %string_lim, align 8
...
iter.check:                                       ; preds = %for.end
  %15 = load ptr, ptr %string_mem, align 8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load87 = load <16 x i8>, ptr %25, align 1
  store <16 x i8> %wide.load, ptr %next.gep85, align 1
  %26 = getelementptr i8, ptr %next.gep85, i64 16
  store <16 x i8> %wide.load87, ptr %26, align 1
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load105 = load <8 x i8>, ptr %next.gep103, align 1
  store <8 x i8> %wide.load105, ptr %next.gep104, align 1
...
for.end30:                                        ; preds = %for.end30.loopexit, %for.end
  ...
  store ptr %arrayidx34, ptr %string_mem, align 8
  store i32 0, ptr %string_first18, align 4
  store i32 %sub22, ptr %string_lim, align 8
  ret void
}
