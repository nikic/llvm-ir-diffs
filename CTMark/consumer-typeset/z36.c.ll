...
for.inc.i373:                                     ; preds = %if.else.i372, %if.then10.i
  ...
  %28 = load i8, ptr %arrayidx.i375, align 1, !tbaa !11
  %cmp1.not.i = icmp eq i8 %28, 0
  br i1 %cmp1.not.i, label %AddClassToTrie.exit, label %for.body.i370, !llvm.loop !25
...
cond.end246:                                      ; preds = %if.end201
  ...
  %.pre1640 = load ptr, ptr @xx_link, align 8, !tbaa !5
  store ptr %.pre1640, ptr @zz_res, align 8, !tbaa !5
  store ptr %call124, ptr @zz_hold, align 8, !tbaa !5
...
cond.end422.cond.false431_crit_edge:              ; preds = %cond.end422
  ...
  %.pre1641 = load ptr, ptr %arrayidx436.phi.trans.insert, align 8, !tbaa !11
  br label %cond.false431
...
while.body804:                                    ; preds = %if.then791, %while.end835
  ...
  %.pre1636 = load i8, ptr %incdec.ptr799, align 1, !tbaa !11
...
land.lhs.true811:                                 ; preds = %while.cond806
  ...
  br i1 %or.cond1537, label %while.end822, label %while.cond806, !llvm.loop !45
...
while.end835:                                     ; preds = %while.cond831
  ...
  br i1 %cmp802, label %while.body804, label %for.inc840, !llvm.loop !47
...
for.inc840:                                       ; preds = %while.end835, %if.then791, %for.body785, %if.then827
  ...
  br i1 %cmp783.not, label %for.end843, label %for.body785, !llvm.loop !48
...
cond.end993:                                      ; preds = %if.end944
  ...
  %.pre1638 = load ptr, ptr @xx_link, align 8, !tbaa !5
  store ptr %.pre1638, ptr @zz_res, align 8, !tbaa !5
  store ptr %call864, ptr @zz_hold, align 8, !tbaa !5
...
cond.end1172.cond.false1181_crit_edge:            ; preds = %cond.end1172
  ...
  %.pre1639 = load ptr, ptr %arrayidx1186.phi.trans.insert, align 8, !tbaa !11
  br label %cond.false1181
...
for.inc1317:                                      ; preds = %for.body852, %cond.end1310
  ...
  br i1 %cmp850, label %for.body852, label %for.end1318, !llvm.loop !49
...
for.inc1325:                                      ; preds = %for.cond6, %for.end843, %if.then61, %lor.lhs.false26, %lor.lhs.false31, %if.end572, %for.end1318, %if.then1320, %if.end568, %if.then109, %if.end71, %land.lhs.true, %if.then42, %cond.end560
  ...
  br i1 %cmp2.not, label %for.end1329, label %for.cond6.preheader, !llvm.loop !50
...
for.inc49:                                        ; preds = %if.then36, %if.else
  ...
  br i1 %cmp26.not, label %for.end50, label %for.body28, !llvm.loop !52
...
if.then59:                                        ; preds = %for.end50.if.then59_crit_edge, %if.then59.loopexit
  ...
  %25 = load i16, ptr %arrayidx61, align 2, !tbaa !35
...
if.end82:                                         ; preds = %if.end82.lr.ph, %if.end152
  ...
  %34 = load i16, ptr %arrayidx89, align 2, !tbaa !35
...
if.end100:                                        ; preds = %if.then93
  ...
  store i32 %conv3.i230, ptr %string_first, align 4, !tbaa !19
...
if.end109:                                        ; preds = %if.end100
  ...
  store i32 %conv3.i245, ptr %string_first, align 4, !tbaa !19
...
if.then.i264:                                     ; preds = %if.end133
  ...
  %.pre.i266 = load i32, ptr %node_free, align 4, !tbaa !17
  %.pre20.i267 = load i32, ptr %class_count.i253, align 4, !tbaa !14
  %.pre21.i268 = add i32 %.pre20.i267, %.pre.i266
  %.pre289.pre = load ptr, ptr %node_mem.phi.trans.insert, align 8, !tbaa !15
...
if.end.i257:                                      ; preds = %if.then.i264, %if.end133
  ...
  store i32 %add4.pre-phi.i258, ptr %node_free, align 4, !tbaa !17
...
for.body.lr.ph.i260:                              ; preds = %if.end.i257
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 2 dereferenceable(1) %scevgep.i262, i8 0, i64 %61, i1 false), !tbaa !35
...
for.inc.1:                                        ; preds = %if.then.1, %for.inc
  ...
  br i1 %niter.ncmp.1, label %for.end.loopexit.unr-lcssa, label %for.body, !llvm.loop !53
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %27, label %middle.block, label %vector.body, !llvm.loop !54
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %28, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !57
...
for.body26.prol:                                  ; preds = %for.body26.preheader, %for.body26.prol
  ...
  br i1 %prol.iter.cmp.not, label %for.body26.prol.loopexit, label %for.body26.prol, !llvm.loop !58
...
for.body26:                                       ; preds = %for.body26.prol.loopexit, %for.body26
  ...
  br i1 %exitcond79.not.7, label %for.end30.loopexit, label %for.body26, !llvm.loop !59
