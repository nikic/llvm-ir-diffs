...
for.end3470.thread:                               ; preds = %if.end3395
  ...
  %390 = load i32, ptr %ou334716832, align 4, !tbaa !5
  %ou334766833 = getelementptr inbounds %struct.word_type, ptr %y.44.lcssa, i64 0, i32 3
  %391 = load i32, ptr %ou334766833, align 4, !tbaa !5
...
for.cond3412:                                     ; preds = %for.cond3412.preheader, %for.cond3412
  ...
  %392 = load i8, ptr %ou13413, align 8, !tbaa !5
...
for.end3470:                                      ; preds = %for.inc3466, %cond.true3446, %cond.false3449
  ...
  %394 = load i32, ptr %ou33471, align 4, !tbaa !5
  %ou33476 = getelementptr inbounds %struct.word_type, ptr %y.51, i64 0, i32 3
  %395 = load i32, ptr %ou33476, align 4, !tbaa !5
...
for.cond3492:                                     ; preds = %for.cond3492.preheader, %for.cond3492
  ...
  %396 = load i8, ptr %ou13493, align 8, !tbaa !5
...
if.then3546:                                      ; preds = %if.then3543
  %398 = load ptr, ptr @no_fpos, align 8, !tbaa !14
...
if.then3568:                                      ; preds = %if.then3566
  ...
  %400 = load i8, ptr %ou13569, align 8, !tbaa !5
  ...
  %401 = load i32, ptr %ou33614, align 4, !tbaa !5
...
if.then3626:                                      ; preds = %if.end3619
  %403 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 3), align 1, !tbaa !5
...
if.else3640:                                      ; preds = %if.then3626
  store ptr %404, ptr @zz_hold, align 8, !tbaa !14
  %406 = load ptr, ptr %404, align 8, !tbaa !5
  store ptr %406, ptr %arrayidx3635, align 8, !tbaa !14
  br label %if.end3649
...
if.end3649:                                       ; preds = %if.then3638, %if.else3640
  ...
  store ptr %407, ptr %osucc3654, align 8, !tbaa !5
  store ptr %407, ptr %arrayidx3653, align 8, !tbaa !5
  %osucc3660 = getelementptr inbounds %struct.LIST, ptr %407, i64 0, i32 1
  store ptr %407, ptr %osucc3660, align 8, !tbaa !5
  ...
  %408 = load i32, ptr %ofwd3668, align 4, !tbaa !5
...
if.end3703:                                       ; preds = %if.then3692, %if.else3694
  ...
  store ptr %413, ptr %osucc3708, align 8, !tbaa !5
  %arrayidx3710 = getelementptr inbounds [2 x %struct.LIST], ptr %413, i64 0, i64 1
  store ptr %413, ptr %arrayidx3710, align 8, !tbaa !5
  %osucc3714 = getelementptr inbounds %struct.LIST, ptr %413, i64 0, i32 1
  store ptr %413, ptr %osucc3714, align 8, !tbaa !5
  store ptr %413, ptr %413, align 8, !tbaa !5
  store ptr %413, ptr @xx_link, align 8, !tbaa !14
  store ptr %413, ptr @zz_res, align 8, !tbaa !14
  %osucc3720 = getelementptr inbounds [2 x %struct.LIST], ptr %prev.96535, i64 0, i64 1, i32 1
  %414 = load ptr, ptr %osucc3720, align 8, !tbaa !5
  store ptr %414, ptr @zz_hold, align 8, !tbaa !14
...
land.lhs.true3790:                                ; preds = %if.end3788
  ...
  %427 = load i16, ptr %owidth3792, align 2, !tbaa !5
...
if.then3796:                                      ; preds = %land.lhs.true3790
  ...
  %430 = load i16, ptr %osave_actual_gap3812, align 2, !tbaa !5
...
if.else3817:                                      ; preds = %land.lhs.true3790, %if.end3788
  ...
  %433 = load i16, ptr %osave_actual_gap3827, align 2, !tbaa !5
...
for.cond3849:                                     ; preds = %for.cond3849.preheader, %for.cond3849
  ...
  %434 = load i8, ptr %ou13850, align 8, !tbaa !5
...
for.inc3908:                                      ; preds = %for.cond3849, %cond.false3886, %cond.true3883
  ...
  br i1 %cmp3843.not, label %while.end3913.loopexit, label %for.cond3849.preheader, !llvm.loop !88

for.end3912:                                      ; preds = %if.then3900, %if.then3903
  %cmp3557.not = icmp eq ptr %link.176527, %x
  br i1 %cmp3557.not, label %while.end3913.loopexit, label %while.body3559, !llvm.loop !89
