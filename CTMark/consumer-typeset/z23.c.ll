; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z23.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z23.c"
...
sw.bb:                                            ; preds = %entry, %entry, %entry, %entry, %entry
  store i32 %xb, ptr %actual_back, align 4
  store i32 %xf, ptr %actual_fwd, align 4
...
if.then:                                          ; preds = %for.cond, %for.cond
  ...
  %2 = load ptr, ptr %osucc29, align 8
  br label %for.cond33
...
for.cond33:                                       ; preds = %for.cond33, %if.then
  ...
  %3 = load i8, ptr %ou134, align 8
  %cmp37 = icmp eq i8 %3, 0
  br i1 %cmp37, label %for.cond33, label %for.end44
...
for.end44:                                        ; preds = %for.cond33
  ...
  %cond56 = load ptr, ptr %cond56.in, align 8
  br label %for.cond60
...
for.cond60:                                       ; preds = %for.cond60, %for.end44
  ...
  %4 = load i8, ptr %ou161, align 8
  %cmp64 = icmp eq i8 %4, 0
  br i1 %cmp64, label %for.cond60, label %for.end71
...
for.end71:                                        ; preds = %for.cond60
  ...
  %5 = load i32, ptr %arrayidx72, align 4
...
if.then85:                                        ; preds = %for.end71
  ...
  %7 = load i32, ptr %arrayidx91, align 4
...
if.end:                                           ; preds = %if.then85, %for.end71
  ...
  %10 = load i32, ptr %arrayidx135, align 4
  store i32 %10, ptr %actual_back, align 4
  ...
  %11 = load i32, ptr %arrayidx139, align 4
  store i32 %11, ptr %actual_fwd, align 4
  br label %sw.epilog4616
...
if.then152:                                       ; preds = %sw.bb142
  ...
  %cond164 = load ptr, ptr %cond164.in, align 8
...
if.then210:                                       ; preds = %if.end194
  ...
  %14 = load ptr, ptr %osucc213, align 8
...
for.cond217:                                      ; preds = %for.cond217, %if.then210
  ...
  %15 = load i8, ptr %ou1218, align 8
  %cmp221 = icmp eq i8 %15, 0
  br i1 %cmp221, label %for.cond217, label %for.end228
...
for.end228:                                       ; preds = %for.cond217
  ...
  %16 = load i32, ptr %oux230, align 8
  ...
  %17 = load i32, ptr %arrayidx235, align 4
  ...
  %20 = load i32, ptr %arrayidx278, align 4
  store i32 %20, ptr %actual_back, align 4
  ...
  %21 = load i32, ptr %arrayidx282, align 4
  store i32 %21, ptr %actual_fwd, align 4
...
if.then292:                                       ; preds = %sw.bb289
  ...
  store i32 %xmk, ptr %oword_save_mark, align 4
  %ostring = getelementptr inbounds %struct.word_type, ptr %x, i64 0, i32 4
  %22 = load i8, ptr %ostring, align 8
...
if.then298:                                       ; preds = %if.then292
  ...
  %24 = load ptr, ptr %original_face, align 8
  %ofont_page = getelementptr inbounds i8, ptr %24, i64 42
  %25 = load i16, ptr %ofont_page, align 2
  %conv305 = zext i16 %25 to i32
  %26 = load i32, ptr @font_curr_page, align 4
...
if.else311:                                       ; preds = %sw.bb289
  ...
  %27 = load i8, ptr %ostring312, align 8
...
sw.bb323:                                         ; preds = %entry, %entry
  ...
  %31 = load ptr, ptr %osucc326, align 8
...
for.cond330:                                      ; preds = %for.cond330, %sw.bb323
  ...
  %32 = load i8, ptr %ou1331, align 8
  %cmp334 = icmp eq i8 %32, 0
  %inc341 = add nuw nsw i32 %count.addr.2, 1
  br i1 %cmp334, label %for.cond330, label %for.end342
...
if.then352:                                       ; preds = %for.end342
  ...
  %33 = load i32, ptr %obfc354, align 4
  ...
  %34 = load i32, ptr %arrayidx358, align 4
...
sw.bb368:                                         ; preds = %entry, %entry
  ...
  %35 = load ptr, ptr %osucc371, align 8
...
for.cond375:                                      ; preds = %for.cond375, %sw.bb368
  ...
  %36 = load i8, ptr %ou1376, align 8
  %cmp379 = icmp eq i8 %36, 0
  %inc386 = add nuw nsw i32 %count.addr.3, 1
  br i1 %cmp379, label %for.cond375, label %for.end387
...
if.then397:                                       ; preds = %for.end387
  ...
  store i32 %spec.select, ptr %actual_back, align 4
  ...
  store i32 %cond461, ptr %actual_fwd, align 4
  br label %sw.epilog4616
...
sw.bb465:                                         ; preds = %entry, %entry
  ...
  %39 = load ptr, ptr %osucc468, align 8
...
for.cond472:                                      ; preds = %for.cond472, %sw.bb465
  ...
  %40 = load i8, ptr %ou1473, align 8
  %cmp476 = icmp eq i8 %40, 0
  %inc483 = add nuw nsw i32 %count.addr.4, 1
  br i1 %cmp476, label %for.cond472, label %for.end484
...
if.then494:                                       ; preds = %for.end484
  ...
  %41 = load i32, ptr %arrayidx498, align 4
...
sw.bb507:                                         ; preds = %entry, %entry, %entry, %entry, %entry, %entry
  ...
  %43 = load ptr, ptr %osucc510, align 8
...
for.cond514:                                      ; preds = %for.cond514, %sw.bb507
  ...
  %44 = load i8, ptr %ou1515, align 8
  %cmp518 = icmp eq i8 %44, 0
  %inc525 = add nuw nsw i32 %count.addr.5, 1
  br i1 %cmp518, label %for.cond514, label %for.end526
...
sw.bb546:                                         ; preds = %entry
  ...
  %45 = load ptr, ptr %osucc549, align 8
...
for.cond553:                                      ; preds = %for.cond553, %sw.bb546
  ...
  %46 = load i8, ptr %ou1554, align 8
  %cmp557 = icmp eq i8 %46, 0
  %inc564 = add nuw nsw i32 %count.addr.6, 1
  br i1 %cmp557, label %for.cond553, label %for.end565
...
for.end565:                                       ; preds = %for.cond553
  ...
  %48 = load i32, ptr %scale_avail, align 8
...
if.then583:                                       ; preds = %if.else571
  ...
  %51 = load ptr, ptr %SaveGraphicState, align 8
  ...
  %53 = load ptr, ptr %CoordTranslate, align 8
  %54 = load i32, ptr %arrayidx575, align 4
  ...
  %58 = load ptr, ptr %CoordScale, align 8
  tail call void %58(float noundef 1.000000e+00, float noundef %cond6.i) #5
  %59 = load i32, ptr %arrayidx575, align 4
  %60 = load i32, ptr %arrayidx578, align 4
  ...
  %62 = load ptr, ptr %RestoreGraphicState, align 8
  call void %62() #5
  br label %if.end623
...
lor.lhs.false611:                                 ; preds = %if.else599
  ...
  %63 = load i8, ptr %ostring612, align 8
...
sw.bb624:                                         ; preds = %entry
  ...
  %64 = load ptr, ptr %osucc627, align 8
...
for.cond631:                                      ; preds = %for.cond631, %sw.bb624
  ...
  %65 = load i8, ptr %ou1632, align 8
  %cmp635 = icmp eq i8 %65, 0
  %inc642 = add nuw nsw i32 %count.addr.7, 1
  br i1 %cmp635, label %for.cond631, label %for.end643
...
for.end643:                                       ; preds = %for.cond631
  ...
  %67 = load i32, ptr %scale_avail644, align 8
...
if.else672:                                       ; preds = %if.then649
  %70 = load i8, ptr %ou1632.le, align 8
...
lor.lhs.false684:                                 ; preds = %if.else672
  ...
  %71 = load i8, ptr %ostring685, align 8
...
if.then711:                                       ; preds = %if.else695
  ...
  %76 = load ptr, ptr %SaveGraphicState712, align 8
  ...
  %78 = load ptr, ptr %CoordTranslate713, align 8
  %oux714 = getelementptr inbounds %struct.closure_type, ptr %x, i64 0, i32 6
  %79 = load i32, ptr %oux714, align 8
  %80 = load i32, ptr %ou4696, align 8
  %sub717 = sub i32 %79, %80
  %81 = load i32, ptr %ou3701, align 8
...
sw.bb731:                                         ; preds = %entry
  ...
  %86 = load ptr, ptr %osucc734, align 8
...
for.cond738:                                      ; preds = %for.cond738, %sw.bb731
  ...
  %87 = load i8, ptr %ou1739, align 8
  %cmp742 = icmp eq i8 %87, 0
  %inc749 = add nuw nsw i32 %count.addr.8, 1
  br i1 %cmp742, label %for.cond738, label %for.end750
...
for.end750:                                       ; preds = %for.cond738
  ...
  %89 = load i32, ptr %scale_avail751, align 8
...
if.then756:                                       ; preds = %if.then753
  %90 = load i32, ptr %ou4757, align 8
...
if.then761:                                       ; preds = %if.then756
  ...
  %.pre6799 = load i32, ptr %ou4757, align 8
  br label %if.end763
...
if.end763:                                        ; preds = %if.then761, %if.then756
  ...
  store i32 %xmk, ptr %oux764, align 8
...
if.else773:                                       ; preds = %if.then753
  ...
  %93 = load i32, ptr %ofc775, align 8
...
if.then778:                                       ; preds = %if.else773
  ...
  %.pre6797 = load i32, ptr %ofc775, align 8
  %.pre6798 = load ptr, ptr @BackEnd, align 8
  br label %if.end780
...
if.end780:                                        ; preds = %if.then778, %if.else773
  ...
  %97 = load ptr, ptr %SaveGraphicState789, align 8
...
land.lhs.true:                                    ; preds = %if.else805
  ...
  %108 = load i32, ptr %ofc811, align 8
...
for.cond825:                                      ; preds = %for.cond825, %sw.bb818
  ...
  %110 = load i8, ptr %ou1826, align 8
  %cmp829 = icmp eq i8 %110, 0
  %inc836 = add nuw nsw i32 %count.addr.9, 1
  br i1 %cmp829, label %for.cond825, label %for.end837
...
if.then840:                                       ; preds = %for.end837
  ...
  %113 = load i32, ptr %ou3850, align 4
  store i32 %113, ptr %actual_back, align 4
  %ofwd855 = getelementptr inbounds %struct.word_type, ptr %x, i64 0, i32 3, i32 1
  %114 = load i32, ptr %ofwd855, align 4
  store i32 %114, ptr %actual_fwd, align 4
  br label %sw.epilog4616
...
sw.bb861:                                         ; preds = %entry
  ...
  %115 = load ptr, ptr %osucc864, align 8
...
for.cond868:                                      ; preds = %for.cond868, %sw.bb861
  ...
  %116 = load i8, ptr %ou1869, align 8
  %cmp872 = icmp eq i8 %116, 0
  %inc879 = add nuw nsw i32 %count.addr.10, 1
  br i1 %cmp872, label %for.cond868, label %for.end880
...
for.cond888:                                      ; preds = %for.cond888, %for.end880
  ...
  %118 = load i8, ptr %ou1889, align 8
  %cmp892 = icmp eq i8 %118, 0
  %inc899 = add nuw nsw i32 %count.addr.11, 1
  br i1 %cmp892, label %for.cond888, label %for.end900
...
for.end900:                                       ; preds = %for.cond888
  ...
  %119 = load i32, ptr %arrayidx905, align 4
  store i32 %119, ptr %actual_back, align 4
  ...
  %120 = load i32, ptr %arrayidx909, align 4
  store i32 %120, ptr %actual_fwd, align 4
  br label %sw.epilog4616

sw.bb910:                                         ; preds = %entry
  %osucc913 = getelementptr inbounds %struct.LIST, ptr %x, i64 0, i32 1
  %121 = load ptr, ptr %osucc913, align 8
...
if.else993:                                       ; preds = %for.end929
  ...
  %148 = load i32, ptr %osparec995, align 4
...
if.else1042:                                      ; preds = %if.then1023
  ...
  %153 = load ptr, ptr %osucc1045, align 8
...
for.cond1049:                                     ; preds = %for.cond1049, %if.else1042
  ...
  %154 = load i8, ptr %ou11050, align 8
...
if.then1066:                                      ; preds = %for.cond1049
  ...
  %155 = load ptr, ptr %osucc1069, align 8
...
for.cond1073:                                     ; preds = %for.cond1073, %if.then1066
  ...
  %pre.0 = load ptr, ptr %pre.0.in, align 8
  %ou11074 = getelementptr inbounds %struct.word_type, ptr %pre.0, i64 0, i32 1
  %156 = load i8, ptr %ou11074, align 8
  %cmp1077 = icmp eq i8 %156, 0
  br i1 %cmp1077, label %for.cond1073, label %for.end1084

for.end1084:                                      ; preds = %for.cond1073
  %157 = load ptr, ptr %tmp.0, align 8
...
for.cond1091:                                     ; preds = %for.cond1091, %for.end1084
  ...
  %post.0 = load ptr, ptr %post.0.in, align 8
  %ou11092 = getelementptr inbounds %struct.word_type, ptr %post.0, i64 0, i32 1
  %158 = load i8, ptr %ou11092, align 8
  %cmp1095 = icmp eq i8 %158, 0
  br i1 %cmp1095, label %for.cond1091, label %if.end1104
...
if.end1104:                                       ; preds = %for.cond1049, %for.cond1091
  ...
  store i32 %xb, ptr %arrayidx1108, align 4
...
if.then1123:                                      ; preds = %if.end1104
  ...
  %163 = load ptr, ptr %PrintPlainGraphic1124, align 8
  %164 = load i32, ptr %oux1113, align 8
  %165 = load i32, ptr %arrayidx1108, align 4
...
if.then1167:                                      ; preds = %if.then1161
  %170 = load ptr, ptr @finfo, align 8
  ...
  %171 = load ptr, ptr %original_face1174, align 8
  %ofont_page1176 = getelementptr inbounds i8, ptr %171, i64 42
  %172 = load i16, ptr %ofont_page1176, align 2
  %conv1177 = zext i16 %172 to i32
  %173 = load i32, ptr @font_curr_page, align 4
...
if.else1197:                                      ; preds = %if.then1158
  ...
  %174 = load ptr, ptr %osucc1203, align 8
...
for.cond1207:                                     ; preds = %for.cond1207, %if.else1197
  ...
  %tmp1198.0 = load ptr, ptr %tmp1198.0.in, align 8
  %ou11208 = getelementptr inbounds %struct.word_type, ptr %tmp1198.0, i64 0, i32 1
  %175 = load i8, ptr %ou11208, align 8
...
if.then1224:                                      ; preds = %for.cond1207
  ...
  %176 = load ptr, ptr %osucc1227, align 8
...
for.cond1231:                                     ; preds = %for.cond1231, %if.then1224
  ...
  %pre1199.0 = load ptr, ptr %pre1199.0.in, align 8
  %ou11232 = getelementptr inbounds %struct.word_type, ptr %pre1199.0, i64 0, i32 1
  %177 = load i8, ptr %ou11232, align 8
  %cmp1235 = icmp eq i8 %177, 0
  br i1 %cmp1235, label %for.cond1231, label %for.end1242

for.end1242:                                      ; preds = %for.cond1231
  %178 = load ptr, ptr %tmp1198.0, align 8
...
for.cond1249:                                     ; preds = %for.cond1249, %for.end1242
  ...
  %post1200.0 = load ptr, ptr %post1200.0.in, align 8
  %ou11250 = getelementptr inbounds %struct.word_type, ptr %post1200.0, i64 0, i32 1
  %179 = load i8, ptr %ou11250, align 8
  %cmp1253 = icmp eq i8 %179, 0
  br i1 %cmp1253, label %for.cond1249, label %if.end1262
...
if.end1262:                                       ; preds = %for.cond1207, %for.cond1249
  ...
  store i32 %xb, ptr %arrayidx1266, align 4
...
for.cond1297:                                     ; preds = %for.cond1297, %sw.bb1290
  ...
  %194 = load i8, ptr %ou11298, align 8
  %cmp1301 = icmp eq i8 %194, 0
  %inc1308 = add nuw nsw i32 %count.addr.15, 1
  br i1 %cmp1301, label %for.cond1297, label %for.end1309
...
for.end1332:                                      ; preds = %for.cond1321
  ...
  %200 = load i32, ptr %ofwd1348, align 8
...
if.then1338:                                      ; preds = %for.end1332
  ...
  %201 = load ptr, ptr %LinkSource, align 8
...
if.else1353:                                      ; preds = %for.end1332
  ...
  %202 = load ptr, ptr %LinkDest, align 8
...
if.then1399:                                      ; preds = %if.then1395
  ...
  %207 = load ptr, ptr %original_face1406, align 8
  %ofont_page1408 = getelementptr inbounds i8, ptr %207, i64 42
  %208 = load i16, ptr %ofont_page1408, align 2
  %conv1409 = zext i16 %208 to i32
  %209 = load i32, ptr @font_curr_page, align 4
...
if.else1415:                                      ; preds = %if.then1392
  ...
  %210 = load i8, ptr %ocross_type1417, align 1
...
if.then1419:                                      ; preds = %if.else1415
  ...
  %211 = load ptr, ptr %PrintGraphicInclude, align 8
  %oux1420 = getelementptr inbounds %struct.closure_type, ptr %x, i64 0, i32 6
  %212 = load i32, ptr %oux1420, align 8
...
sw.bb1425:                                        ; preds = %entry
  ...
  %cond1437 = load ptr, ptr %cond1437.in, align 8
...
for.cond1441:                                     ; preds = %for.cond1441, %sw.bb1425
  ...
  %213 = load i8, ptr %ou11442, align 8
  %cmp1445 = icmp eq i8 %213, 0
  %inc1452 = add nuw nsw i32 %count.addr.17, 1
  br i1 %cmp1445, label %for.cond1441, label %for.end1453
...
for.end1453:                                      ; preds = %for.cond1441
  ...
  %214 = load i32, ptr %arrayidx1457, align 4
  ...
  %215 = load i32, ptr %arrayidx1471, align 4
...
if.then1493:                                      ; preds = %sw.bb1483
  ...
  %link.06599 = load ptr, ptr %osucc1496, align 8
...
for.cond1504:                                     ; preds = %for.cond1504.preheader, %for.cond1504
  %link.0.pn = phi ptr [ %prev.1, %for.cond1504 ], [ %link.06602, %for.cond1504.preheader ]
  %prev.1.in = getelementptr inbounds [2 x %struct.LIST], ptr %link.0.pn, i64 0, i64 1
  %prev.1 = load ptr, ptr %prev.1.in, align 8
  %ou11505 = getelementptr inbounds %struct.word_type, ptr %prev.1, i64 0, i32 1
  %216 = load i8, ptr %ou11505, align 8
...
for.inc1553:                                      ; preds = %for.cond1504, %cond.false1536, %cond.true1533
  ...
  %link.0 = load ptr, ptr %osucc1556, align 8
  %cmp1498.not = icmp eq ptr %link.0, %x
  br i1 %cmp1498.not, label %if.else2072, label %for.cond1504.preheader
...
for.cond1564.preheader:                           ; preds = %cond.true1533, %cond.false1536
  ...
  %link.16605 = load ptr, ptr %link.1.in6604, align 8
...
for.cond1571:                                     ; preds = %for.cond1571.preheader, %for.cond1571
  ...
  %218 = load i8, ptr %ou11572, align 8
...
for.inc1630:                                      ; preds = %for.cond1571, %cond.false1608, %cond.true1605
  ...
  br i1 %cmp1565.not, label %if.end1680, label %for.cond1571.preheader
...
land.lhs.true1652:                                ; preds = %land.lhs.true1637
  ...
  %222 = load i16, ptr %owidth, align 2
...
if.then1657:                                      ; preds = %land.lhs.true1652
  ...
  %223 = load i32, ptr %arrayidx1661, align 4
  ...
  %224 = load i32, ptr %arrayidx1666, align 4
  %add1667 = add nsw i32 %sub1662, %224
  store i32 %add1667, ptr %arrayidx1666, align 4
  store i32 %xb, ptr %arrayidx1661, align 4
...
if.end1680:                                       ; preds = %for.inc1630, %for.cond1564.preheader, %if.then1657, %land.lhs.true1652, %land.lhs.true1637
  %link.26612 = load ptr, ptr %osucc1496, align 8
...
for.cond1691:                                     ; preds = %for.cond1691.preheader, %for.cond1691
  %link.2.pn = phi ptr [ %prev.4, %for.cond1691 ], [ %link.26615, %for.cond1691.preheader ]
  %prev.4.in = getelementptr inbounds [2 x %struct.LIST], ptr %link.2.pn, i64 0, i64 1
  %prev.4 = load ptr, ptr %prev.4.in, align 8
  %ou11692 = getelementptr inbounds %struct.word_type, ptr %prev.4, i64 0, i32 1
  %225 = load i8, ptr %ou11692, align 8
...
for.inc1745:                                      ; preds = %for.cond1691, %cond.false1728, %cond.true1725
  ...
  %link.2 = load ptr, ptr %osucc1748, align 8
  %cmp1685.not = icmp eq ptr %link.2, %x
  br i1 %cmp1685.not, label %for.end1749, label %for.cond1691.preheader
...
for.end1749:                                      ; preds = %for.inc1745, %cond.true1725, %cond.false1728, %if.end1680
  ...
  %227 = load i32, ptr %arrayidx1753, align 4
...
for.cond1787:                                     ; preds = %for.cond1787.preheader, %for.cond1787
  ...
  %230 = load i8, ptr %ou11788, align 8
...
for.inc1846:                                      ; preds = %for.cond1787, %cond.false1824, %cond.true1821
  ...
  br i1 %cmp1781.not, label %for.end1850.thread, label %for.cond1787.preheader
...
land.lhs.true1867:                                ; preds = %while.body
  ...
  %234 = load i16, ptr %owidth1869, align 2
...
if.then1873:                                      ; preds = %land.lhs.true1867
  ...
  %235 = load i32, ptr %arrayidx1877, align 4
  ...
  %236 = load i32, ptr %arrayidx1881, align 4
  ...
  %237 = load i32, ptr %arrayidx1887, align 4
  ...
  %238 = load i32, ptr %arrayidx1891, align 4
...
if.else1917:                                      ; preds = %land.lhs.true1867, %while.body
  ...
  %240 = load i32, ptr %arrayidx1921, align 4
  ...
  %241 = load i32, ptr %arrayidx1925, align 4
...
if.end1928:                                       ; preds = %if.else1917, %if.then1873
  ...
  %243 = load i32, ptr %arrayidx1932, align 4
  ...
  %244 = load i32, ptr %arrayidx1936, align 4
  ...
  %link.56632 = load ptr, ptr %link.5.in6631, align 8
...
for.cond1951:                                     ; preds = %for.cond1951.preheader, %for.cond1951
  ...
  %245 = load i8, ptr %ou11952, align 8
...
if.then2005:                                      ; preds = %if.then2002
  %247 = load ptr, ptr @no_fpos, align 8
...
for.inc2010:                                      ; preds = %for.cond1951, %cond.false1988, %cond.true1985
  ...
  br i1 %cmp1945.not, label %for.end2014.thread, label %for.cond1951.preheader
...
for.end2014:                                      ; preds = %if.then2002, %if.then2005
  ...
  br i1 %cmp1851.not, label %while.end, label %while.body
...
while.end:                                        ; preds = %for.end2014, %for.end2014.thread, %for.end1850.thread, %for.end1850
  ...
  %248 = load i32, ptr %arrayidx2020, align 4
  ...
  %249 = load i32, ptr %arrayidx2024, align 4
...
if.end2050:                                       ; preds = %while.end, %if.else2026
  ...
  %250 = load i32, ptr %arrayidx1753, align 4
  %xb.6203 = call i32 @llvm.smax.i32(i32 %250, i32 %xb)
  store i32 %xb.6203, ptr %actual_back, align 4
...
if.else2074:                                      ; preds = %sw.bb1483
  ...
  %link.66554 = load ptr, ptr %link.6.in6553, align 8
...
for.cond2086:                                     ; preds = %for.cond2086.preheader, %for.cond2086
  %link.6.pn = phi ptr [ %y.29, %for.cond2086 ], [ %link.66557, %for.cond2086.preheader ]
  %y.29.in = getelementptr inbounds [2 x %struct.LIST], ptr %link.6.pn, i64 0, i64 1
  %y.29 = load ptr, ptr %y.29.in, align 8
  %ou12087 = getelementptr inbounds %struct.word_type, ptr %y.29, i64 0, i32 1
  %253 = load i8, ptr %ou12087, align 8
...
for.inc2140:                                      ; preds = %land.end2112, %cond.false2123, %cond.true2120
  ...
  br i1 %cmp2080.not, label %if.end2610, label %for.cond2086.preheader
...
if.then2147:                                      ; preds = %cond.true2120, %cond.false2123
  ...
  %257 = load i32, ptr %arrayidx2151, align 4
  store i32 %257, ptr %b, align 4
  ...
  %258 = load i32, ptr %arrayidx2155, align 4
  store i32 %258, ptr %f2075, align 4
  ...
  %link.76560 = load ptr, ptr %link.7.in6559, align 8
...
for.cond2167:                                     ; preds = %for.cond2167.preheader, %for.cond2167
  ...
  %259 = load i8, ptr %ou12168, align 8
...
for.inc2226:                                      ; preds = %land.end2193, %cond.false2204, %cond.true2201
  ...
  br i1 %cmp2161.not, label %while.end2452, label %for.cond2167.preheader
...
if.then2236:                                      ; preds = %while.body2234
  ...
  %266 = load i32, ptr %arrayidx2243, align 4
  store i32 %266, ptr %b, align 4
  ...
  %267 = load i32, ptr %arrayidx2247, align 4
...
if.end2283:                                       ; preds = %for.end2267
  ...
  %272 = load i32, ptr %arrayidx2290, align 4
  ...
  %273 = load i32, ptr %arrayidx2304, align 4
...
for.inc2315:                                      ; preds = %for.end2267, %if.end2283
  ...
  %276 = load ptr, ptr %osucc2318, align 8
  %cmp2249.not = icmp eq ptr %276, %link.86586
  br i1 %cmp2249.not, label %for.end2319, label %for.cond2255.preheader
...
for.end2319:                                      ; preds = %for.inc2315, %if.then2236
  ...
  %279 = load i32, ptr %arrayidx2331, align 4
  store i32 %279, ptr %b, align 4
  ...
  %280 = load i32, ptr %arrayidx2335, align 4
  store i32 %280, ptr %f2075, align 4
  br label %if.end2377
...
if.else2336:                                      ; preds = %while.body2234
  ...
  %281 = load i32, ptr %arrayidx2340, align 4
  %.6208 = call i32 @llvm.smax.i32(i32 %265, i32 %281)
  store i32 %.6208, ptr %b, align 4
  ...
  %282 = load i32, ptr %arrayidx2354, align 4
  %cond2364 = call i32 @llvm.smax.i32(i32 %264, i32 %282)
  store i32 %cond2364, ptr %f2075, align 4
  %283 = load i32, ptr %arrayidx2354, align 4
  ...
  %284 = load i32, ptr %arrayidx2372, align 4
...
if.end2377:                                       ; preds = %if.else2336, %for.end2319
  ...
  %link.96572 = load ptr, ptr %link.9.in6571, align 8
...
for.cond2388:                                     ; preds = %for.cond2388.preheader, %for.cond2388
  ...
  %287 = load i8, ptr %ou12389, align 8
...
for.inc2447:                                      ; preds = %land.end2414, %cond.false2425, %cond.true2422
  ...
  br i1 %cmp2382.not, label %while.end2452, label %for.cond2388.preheader

for.end2451:                                      ; preds = %if.then2439, %if.then2442
  %cmp2232.not = icmp eq ptr %link.96576, %x
  br i1 %cmp2232.not, label %while.end2452, label %while.body2234
...
if.then2461:                                      ; preds = %if.end2457
  ...
  %295 = load i32, ptr %arrayidx2468, align 4
  store i32 %295, ptr %b, align 4
  ...
  %296 = load i32, ptr %arrayidx2472, align 4
...
if.end2508:                                       ; preds = %for.end2492
  ...
  %301 = load i32, ptr %arrayidx2515, align 4
  ...
  %302 = load i32, ptr %arrayidx2529, align 4
...
for.inc2540:                                      ; preds = %for.end2492, %if.end2508
  ...
  %305 = load ptr, ptr %osucc2543, align 8
  %cmp2474.not = icmp eq ptr %305, %x
  br i1 %cmp2474.not, label %for.end2544, label %for.cond2480.preheader
...
for.end2544:                                      ; preds = %for.inc2540, %if.then2461
  ...
  store i32 0, ptr %actual_back, align 4
...
for.cond2562:                                     ; preds = %for.cond2562, %for.cond2562.preheader
  ...
  %308 = load i8, ptr %ou12563, align 8
  %cmp2566 = icmp eq i8 %308, 0
  %inc2573 = add nuw nsw i32 %count.addr.23, 1
  br i1 %cmp2566, label %for.cond2562, label %for.end2574
...
if.end2590:                                       ; preds = %for.end2574
  ...
  %311 = load i32, ptr %aback, align 4
  %cond2597 = call i32 @llvm.smax.i32(i32 %310, i32 %311)
  store i32 %cond2597, ptr %b, align 4
  %312 = load i32, ptr %f2075, align 4
  %313 = load i32, ptr %afwd, align 4
  %cond2603 = call i32 @llvm.smax.i32(i32 %312, i32 %313)
  store i32 %cond2603, ptr %f2075, align 4
...
for.inc2604:                                      ; preds = %for.end2574, %if.end2590
  ...
  %314 = load ptr, ptr %osucc2607, align 8
  %cmp2556.not = icmp eq ptr %314, %x
  br i1 %cmp2556.not, label %for.end2608, label %for.cond2562.preheader

for.end2608:                                      ; preds = %for.inc2604, %if.else2553
  %315 = load i32, ptr %b, align 4
  store i32 %315, ptr %actual_back, align 4
  %316 = load i32, ptr %f2075, align 4
  br label %if.end2610.sink.split

if.end2610.sink.split:                            ; preds = %for.end2608, %for.end2544
  %cond2552.sink = phi i32 [ %cond2552, %for.end2544 ], [ %316, %for.end2608 ]
  store i32 %cond2552.sink, ptr %actual_fwd, align 4
  br label %if.end2610
...
sw.bb2612:                                        ; preds = %entry
  ...
  %link.106467 = load ptr, ptr %osucc2621, align 8
...
for.cond2629:                                     ; preds = %for.cond2629.preheader, %for.cond2629
  %link.10.pn = phi ptr [ %y.39, %for.cond2629 ], [ %link.106470, %for.cond2629.preheader ]
  %y.39.in = getelementptr inbounds [2 x %struct.LIST], ptr %link.10.pn, i64 0, i64 1
  %y.39 = load ptr, ptr %y.39.in, align 8
  %ou12630 = getelementptr inbounds %struct.word_type, ptr %y.39, i64 0, i32 1
  %317 = load i8, ptr %ou12630, align 8
...
for.inc2683:                                      ; preds = %for.cond2629, %cond.false2666, %cond.true2663
  ...
  %link.10 = load ptr, ptr %osucc2686, align 8
  %cmp2623.not = icmp eq ptr %link.10, %x
  br i1 %cmp2623.not, label %cleanup, label %for.cond2629.preheader
...
if.end2699:                                       ; preds = %cond.true2663, %cond.false2666
  ...
  %319 = load i32, ptr %ou32701, align 4
  ...
  %link.116473 = load ptr, ptr %link.11.in6472, align 8
...
for.inc2776:                                      ; preds = %for.cond2717, %cond.false2754, %cond.true2751
  ...
  %link.11 = load ptr, ptr %link.11.in, align 8
  %cmp2711.not = icmp eq ptr %link.11, %x
  br i1 %cmp2711.not, label %while.end2911, label %for.cond2717.preheader
...
while.body2784:                                   ; preds = %for.end2780, %for.end2910
  ...
  store i16 %conv2800, ptr %osave_actual_gap, align 2
...
if.else2827:                                      ; preds = %while.body2784
  ...
  %327 = load i16, ptr %owidth2829, align 2
...
if.end2836:                                       ; preds = %if.else2827, %while.body2784
  ...
  %link.136482 = load ptr, ptr %link.13.in6481, align 8
...
for.inc2906:                                      ; preds = %for.cond2847, %cond.false2884, %cond.true2881
  ...
  %link.13 = load ptr, ptr %link.13.in, align 8
  %cmp2841.not = icmp eq ptr %link.13, %x
  br i1 %cmp2841.not, label %while.end2911, label %for.cond2847.preheader

for.end2910:                                      ; preds = %if.then2898, %if.then2901
  %cmp2782.not = icmp eq ptr %link.136486, %x
  br i1 %cmp2782.not, label %while.end2911, label %while.body2784
...
while.end2911:                                    ; preds = %for.inc2776, %if.end2836, %for.end2910, %for.inc2906, %if.end2699, %for.end2780
  ...
  %331 = load i32, ptr %ofwd2913, align 4
  %add2916 = sub i32 %mk.1.lcssa, %sub2700
  %sub2917 = add i32 %add2916, %331
  %cmp2918 = icmp sgt i32 %sub2917, %add2706
...
if.then2923:                                      ; preds = %while.end2911
  ...
  store i32 %add2706, ptr %obfc2925, align 4
  %ofc2926 = getelementptr inbounds %struct.CONSTRAINT, ptr %c, i64 0, i32 2
  store i32 %add2706, ptr %ofc2926, align 4
  ...
  store i32 %sub2917, ptr %ofwd2928, align 4
  %332 = load ptr, ptr @BackEnd, align 8
  %scale_avail2931 = getelementptr inbounds %struct.back_end_rec, ptr %332, i64 0, i32 2
  %333 = load i32, ptr %scale_avail2931, align 8
...
land.lhs.true2933.if.else3036_crit_edge:          ; preds = %land.lhs.true2933
  %.pre6795 = load i32, ptr %ofwd2928, align 8
...
if.then2936:                                      ; preds = %land.lhs.true2933
  ...
  %334 = load ptr, ptr %osucc2939, align 8
...
for.cond2943:                                     ; preds = %for.cond2943, %if.then2936
  ...
  %335 = load i8, ptr %ou12944, align 8
  %cmp2947 = icmp eq i8 %335, 0
  br i1 %cmp2947, label %for.cond2943, label %for.end2954

for.end2954:                                      ; preds = %for.cond2943
  %336 = load ptr, ptr %osucc2621, align 8
...
for.cond2961:                                     ; preds = %for.cond2961, %for.end2954
  ...
  %y.48 = load ptr, ptr %y.48.in, align 8
  %ou12962 = getelementptr inbounds %struct.word_type, ptr %y.48, i64 0, i32 1
  %337 = load i8, ptr %ou12962, align 8
  %cmp2965 = icmp eq i8 %337, 0
  br i1 %cmp2965, label %for.cond2961, label %for.end2972
...
if.then2998:                                      ; preds = %if.else2977
  ...
  %339 = load i32, ptr %ou43001, align 8
...
if.else3008:                                      ; preds = %if.else2977
  %340 = load i32, ptr %ou32927, align 8
  %341 = load i32, ptr %ofwd2928, align 8
  ...
  %342 = load i32, ptr %ou43018, align 8
...
if.else3036:                                      ; preds = %land.lhs.true2933.if.else3036_crit_edge, %if.then2923
  ...
  %346 = load i32, ptr %ou32927, align 8
...
if.end3049:                                       ; preds = %if.then3046, %if.else3036
  %347 = load ptr, ptr %osucc2621, align 8
...
if.else3094:                                      ; preds = %for.end3067
  %350 = load i32, ptr %ou32927, align 8
  %351 = load i32, ptr %ofwd2928, align 8
...
if.end3106:                                       ; preds = %if.else3094, %if.then3088
  %352 = load ptr, ptr %osucc2621, align 8
...
while.body3113:                                   ; preds = %if.end3106, %if.end3213
  ...
  %354 = load ptr, ptr %osucc3119, align 8
...
cond.false3123:                                   ; preds = %while.body3113
  ...
  %355 = load ptr, ptr %arrayidx3128, align 8
  %arrayidx3131 = getelementptr inbounds [2 x %struct.LIST], ptr %354, i64 0, i64 1
  store ptr %355, ptr %arrayidx3131, align 8
  %356 = load ptr, ptr %arrayidx3128, align 8
  %osucc3138 = getelementptr inbounds [2 x %struct.LIST], ptr %356, i64 0, i64 1, i32 1
  store ptr %354, ptr %osucc3138, align 8
  store ptr %353, ptr %osucc3119, align 8
  store ptr %353, ptr %arrayidx3128, align 8
...
cond.false3153:                                   ; preds = %cond.end3145
  ...
  store ptr %359, ptr %osucc3168, align 8
  %osucc3171 = getelementptr inbounds %struct.LIST, ptr %360, i64 0, i32 1
  store ptr %360, ptr %osucc3171, align 8
  store ptr %360, ptr %360, align 8
  %.pre6796 = load ptr, ptr @xx_link, align 8
...
cond.end3175:                                     ; preds = %cond.end3145, %cond.false3153
  ...
  %363 = load i8, ptr %ou13177, align 8
  ...
  store ptr %365, ptr %arrayidx3205, align 8
  %367 = load ptr, ptr @xx_tmp, align 8
  %osucc3208 = getelementptr inbounds [2 x %struct.LIST], ptr %367, i64 0, i64 1, i32 1
  %368 = load ptr, ptr %osucc3208, align 8
...
if.end3213:                                       ; preds = %if.then3211, %cond.end3175
  %369 = load ptr, ptr %osucc2621, align 8
  %cmp3111.not = icmp eq ptr %369, %x
  br i1 %cmp3111.not, label %while.end3214, label %while.body3113
...
if.else3230:                                      ; preds = %while.end3214
  store ptr %371, ptr @zz_hold, align 8
  %373 = load ptr, ptr %371, align 8
  store ptr %373, ptr %arrayidx3225, align 8
  br label %cond.end3285
...
cond.end3285:                                     ; preds = %if.then3228, %if.else3230
  ...
  store i8 0, ptr %ou13240, align 8
  %osucc3244 = getelementptr inbounds [2 x %struct.LIST], ptr %374, i64 0, i64 1, i32 1
  store ptr %374, ptr %osucc3244, align 8
  %arrayidx3246 = getelementptr inbounds [2 x %struct.LIST], ptr %374, i64 0, i64 1
  store ptr %374, ptr %arrayidx3246, align 8
  %osucc3250 = getelementptr inbounds %struct.LIST, ptr %374, i64 0, i32 1
  store ptr %374, ptr %osucc3250, align 8
  store ptr %374, ptr %374, align 8
  store ptr %374, ptr @xx_link, align 8
  store ptr %374, ptr @zz_res, align 8
  store ptr %x, ptr @zz_hold, align 8
  %375 = load ptr, ptr %x, align 8
  store ptr %375, ptr @zz_tmp, align 8
  %376 = load ptr, ptr %374, align 8
  store ptr %376, ptr %x, align 8
  %377 = load ptr, ptr @zz_hold, align 8
  %378 = load ptr, ptr @zz_res, align 8
  %379 = load ptr, ptr %378, align 8
  %osucc3276 = getelementptr inbounds %struct.LIST, ptr %379, i64 0, i32 1
  store ptr %377, ptr %osucc3276, align 8
  %380 = load ptr, ptr @zz_tmp, align 8
  store ptr %380, ptr %378, align 8
  %381 = load ptr, ptr @zz_res, align 8
  %382 = load ptr, ptr @zz_tmp, align 8
  %osucc3282 = getelementptr inbounds %struct.LIST, ptr %382, i64 0, i32 1
  store ptr %381, ptr %osucc3282, align 8
  %383 = load ptr, ptr @xx_link, align 8
  store ptr %383, ptr @zz_res, align 8
  store ptr %call3216, ptr @zz_hold, align 8
...
cond.false3294:                                   ; preds = %cond.end3285
  ...
  %384 = load ptr, ptr %arrayidx3296, align 8
  store ptr %384, ptr @zz_tmp, align 8
  %arrayidx3299 = getelementptr inbounds [2 x %struct.LIST], ptr %383, i64 0, i64 1
  %385 = load ptr, ptr %arrayidx3299, align 8
  store ptr %385, ptr %arrayidx3296, align 8
  %386 = load ptr, ptr %arrayidx3299, align 8
  %osucc3309 = getelementptr inbounds [2 x %struct.LIST], ptr %386, i64 0, i64 1, i32 1
  store ptr %call3216, ptr %osucc3309, align 8
  store ptr %384, ptr %arrayidx3299, align 8
  %osucc3315 = getelementptr inbounds [2 x %struct.LIST], ptr %384, i64 0, i64 1, i32 1
  store ptr %383, ptr %osucc3315, align 8
...
if.else3347:                                      ; preds = %if.else3333
  ...
  switch i32 %bf.cast3352, label %if.end3374 [
...
sw.bb3353:                                        ; preds = %if.else3347
  %bf.set3358 = or i16 %bf.load3377.pre, 2048
  store i16 %bf.set3358, ptr %oadjust_cat3376.phi.trans.insert, align 2
  br label %if.end3374

sw.bb3359:                                        ; preds = %if.else3347
  %bf.clear3363 = and i16 %bf.load3377.pre, -2049
  store i16 %bf.clear3363, ptr %oadjust_cat3376.phi.trans.insert, align 2
  %sub3365 = sub nsw i32 %add2706, %sub2917
  %div3366 = sdiv i32 %sub3365, 2
  br label %if.end3374

sw.bb3367:                                        ; preds = %if.else3347
  %bf.clear3371 = and i16 %bf.load3377.pre, -2049
  store i16 %bf.clear3371, ptr %oadjust_cat3376.phi.trans.insert, align 2
  %sub3373 = sub nsw i32 %add2706, %sub2917
  br label %if.end3374

if.end3374:                                       ; preds = %if.else3347, %sw.bb3353, %sw.bb3359, %sw.bb3367, %if.end3341
  %bf.load3377 = phi i16 [ %bf.set3346, %if.end3341 ], [ %bf.clear3371, %sw.bb3367 ], [ %bf.clear3363, %sw.bb3359 ], [ %bf.set3358, %sw.bb3353 ], [ %bf.load3377.pre, %if.else3347 ]
  %adjust_indent.0 = phi i32 [ 0, %if.end3341 ], [ %sub3373, %sw.bb3367 ], [ %div3366, %sw.bb3359 ], [ 0, %sw.bb3353 ], [ 0, %if.else3347 ]
  %388 = and i16 %bf.load3377, 2048
  %tobool3381 = icmp ne i16 %388, 0
...
if.end3395:                                       ; preds = %if.end3374, %if.then3385
  ...
  %link.146503 = load ptr, ptr %osucc2621, align 8
...
for.end3470.thread:                               ; preds = %if.end3395
  ...
  %390 = load i32, ptr %ou334716832, align 4
  %ou334766833 = getelementptr inbounds %struct.word_type, ptr %y.44.lcssa, i64 0, i32 3
  %391 = load i32, ptr %ou334766833, align 4
  %sub34756834 = add i32 %adjust_indent.0, %xmk
  %add34806835 = sub i32 %sub34756834, %390
  %add34816836 = add i32 %add34806835, %391
...
for.cond3412:                                     ; preds = %for.cond3412.preheader, %for.cond3412
  %link.14.pn = phi ptr [ %y.51, %for.cond3412 ], [ %link.146506, %for.cond3412.preheader ]
  %y.51.in = getelementptr inbounds [2 x %struct.LIST], ptr %link.14.pn, i64 0, i64 1
  %y.51 = load ptr, ptr %y.51.in, align 8
  %ou13413 = getelementptr inbounds %struct.word_type, ptr %y.51, i64 0, i32 1
  %392 = load i8, ptr %ou13413, align 8
  switch i8 %392, label %cond.false3449 [
...
cond.false3449:                                   ; preds = %for.cond3412
  %393 = add i8 %392, -9
  %or.cond6219 = icmp ult i8 %393, 91
...
for.inc3466:                                      ; preds = %for.cond3412, %cond.false3449, %cond.true3446
  ...
  %link.14 = load ptr, ptr %osucc3469, align 8
  %cmp3406.not = icmp eq ptr %link.14, %x
  br i1 %cmp3406.not, label %for.end3470, label %for.cond3412.preheader
...
for.end3470:                                      ; preds = %for.inc3466, %cond.true3446, %cond.false3449
  ...
  %link.156514.pre = load ptr, ptr %link.15.in6513.phi.trans.insert, align 8
  %ou33471 = getelementptr inbounds %struct.word_type, ptr %x, i64 0, i32 3
  %394 = load i32, ptr %ou33471, align 4
  %ou33476 = getelementptr inbounds %struct.word_type, ptr %y.51, i64 0, i32 3
  %395 = load i32, ptr %ou33476, align 4
  %sub3475 = add i32 %adjust_indent.0, %xmk
  %add3480 = sub i32 %sub3475, %394
  %add3481 = add i32 %add3480, %395
...
for.cond3492:                                     ; preds = %for.cond3492.preheader, %for.cond3492
  ...
  %y.54 = load ptr, ptr %y.54.in, align 8
  %ou13493 = getelementptr inbounds %struct.word_type, ptr %y.54, i64 0, i32 1
  %396 = load i8, ptr %ou13493, align 8
  switch i8 %396, label %cond.false3529 [
...
cond.false3529:                                   ; preds = %for.cond3492
  %397 = add i8 %396, -9
  %or.cond6220 = icmp ult i8 %397, 91
...
if.then3546:                                      ; preds = %if.then3543
  ...
  %call3547 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %398, ptr noundef nonnull @.str.6) #5
...
for.inc3551:                                      ; preds = %for.cond3492, %cond.false3529, %cond.true3526
  ...
  %link.15 = load ptr, ptr %link.15.in, align 8
  %cmp3486.not = icmp eq ptr %link.15, %x
  br i1 %cmp3486.not, label %while.end3913, label %for.cond3492.preheader
...
while.body3559:                                   ; preds = %while.body3559.lr.ph, %for.end3912
  ...
  %399 = and i32 %bf.load3561, 1610612736
  %cmp3564 = icmp eq i32 %399, 1073741824
...
if.then3568:                                      ; preds = %if.then3566
  ...
  %400 = load i8, ptr %ou13569, align 8
  %.off6240 = add i8 %400, -11
  ...
  %401 = load i32, ptr %ou33614, align 4
  %sub3618 = sub nsw i32 %mk.26532, %401
  br label %if.end3619
...
if.end3619:                                       ; preds = %if.then3568, %if.then3566
  ...
  %402 = and i32 %bf.load3621, 1610612736
  %cmp3624 = icmp eq i32 %402, 536870912
  br i1 %cmp3624, label %if.then3626, label %if.end3788

if.then3626:                                      ; preds = %if.end3619
  %403 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 3), align 1
  %conv3627 = zext i8 %403 to i32
  store i32 %conv3627, ptr @zz_size, align 4
  %conv3628 = zext i8 %403 to i64
  %arrayidx3635 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv3628
  %404 = load ptr, ptr %arrayidx3635, align 8
  %cmp3636 = icmp eq ptr %404, null
  br i1 %cmp3636, label %if.then3638, label %if.else3640

if.then3638:                                      ; preds = %if.then3626
  %405 = load ptr, ptr @no_fpos, align 8
  %call3639 = call ptr @GetMemory(i32 noundef %conv3627, ptr noundef %405) #5
  store ptr %call3639, ptr @zz_hold, align 8
  br label %if.end3649

if.else3640:                                      ; preds = %if.then3626
  store ptr %404, ptr @zz_hold, align 8
  %406 = load ptr, ptr %404, align 8
  store ptr %406, ptr %arrayidx3635, align 8
  br label %if.end3649

if.end3649:                                       ; preds = %if.then3638, %if.else3640
  %407 = phi ptr [ %call3639, %if.then3638 ], [ %404, %if.else3640 ]
  %ou13650 = getelementptr inbounds %struct.word_type, ptr %407, i64 0, i32 1
  store i8 3, ptr %ou13650, align 8
  %arrayidx3653 = getelementptr inbounds [2 x %struct.LIST], ptr %407, i64 0, i64 1
  %osucc3654 = getelementptr inbounds [2 x %struct.LIST], ptr %407, i64 0, i64 1, i32 1
  store ptr %407, ptr %osucc3654, align 8
  store ptr %407, ptr %arrayidx3653, align 8
  %osucc3660 = getelementptr inbounds %struct.LIST, ptr %407, i64 0, i32 1
  store ptr %407, ptr %osucc3660, align 8
  store ptr %407, ptr %407, align 8
  %ou33664 = getelementptr inbounds %struct.word_type, ptr %407, i64 0, i32 3
  store i32 %underline_xstart.1, ptr %ou33664, align 8
  %ofwd3668 = getelementptr inbounds %struct.word_type, ptr %prev.96535, i64 0, i32 3, i32 1
  %408 = load i32, ptr %ofwd3668, align 4
  %add3671 = add nsw i32 %408, %mk.26532
  %ofwd3673 = getelementptr inbounds %struct.word_type, ptr %407, i64 0, i32 3, i32 1
  store i32 %add3671, ptr %ofwd3673, align 8
  %arrayidx3677 = getelementptr inbounds i8, ptr %407, i64 52
  store i32 %underline_font.1, ptr %arrayidx3677, align 4
  %arrayidx3680 = getelementptr inbounds %struct.word_type, ptr %407, i64 0, i32 3, i32 1, i64 4
  store i32 %underline_colour.1, ptr %arrayidx3680, align 4
  %409 = load i8, ptr @zz_lengths, align 1
  %conv3681 = zext i8 %409 to i32
  store i32 %conv3681, ptr @zz_size, align 4
  %conv3682 = zext i8 %409 to i64
  %arrayidx3689 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv3682
  %410 = load ptr, ptr %arrayidx3689, align 8
  %cmp3690 = icmp eq ptr %410, null
  br i1 %cmp3690, label %if.then3692, label %if.else3694

if.then3692:                                      ; preds = %if.end3649
  %411 = load ptr, ptr @no_fpos, align 8
  %call3693 = call ptr @GetMemory(i32 noundef %conv3681, ptr noundef %411) #5
  br label %if.end3703

if.else3694:                                      ; preds = %if.end3649
  store ptr %410, ptr @zz_hold, align 8
  %412 = load ptr, ptr %410, align 8
  store ptr %412, ptr %arrayidx3689, align 8
  br label %if.end3703

if.end3703:                                       ; preds = %if.then3692, %if.else3694
  %413 = phi ptr [ %call3693, %if.then3692 ], [ %410, %if.else3694 ]
  %ou13704 = getelementptr inbounds %struct.word_type, ptr %413, i64 0, i32 1
  store i8 0, ptr %ou13704, align 8
  %osucc3708 = getelementptr inbounds [2 x %struct.LIST], ptr %413, i64 0, i64 1, i32 1
  store ptr %413, ptr %osucc3708, align 8
  %arrayidx3710 = getelementptr inbounds [2 x %struct.LIST], ptr %413, i64 0, i64 1
  store ptr %413, ptr %arrayidx3710, align 8
  %osucc3714 = getelementptr inbounds %struct.LIST, ptr %413, i64 0, i32 1
  store ptr %413, ptr %osucc3714, align 8
  store ptr %413, ptr %413, align 8
  store ptr %413, ptr @xx_link, align 8
  store ptr %413, ptr @zz_res, align 8
  %osucc3720 = getelementptr inbounds [2 x %struct.LIST], ptr %prev.96535, i64 0, i64 1, i32 1
  %414 = load ptr, ptr %osucc3720, align 8
  store ptr %414, ptr @zz_hold, align 8
  %cmp3721 = icmp eq ptr %414, null
...
cond.end3752:                                     ; preds = %if.end3703
  ...
  %osucc3743 = getelementptr inbounds %struct.LIST, ptr %419, i64 0, i32 1
  store ptr %417, ptr %osucc3743, align 8
  ...
  %osucc3749 = getelementptr inbounds %struct.LIST, ptr %422, i64 0, i32 1
  store ptr %421, ptr %osucc3749, align 8
  %.pre6792 = load ptr, ptr @xx_link, align 8
  store ptr %.pre6792, ptr @zz_res, align 8
  store ptr %407, ptr @zz_hold, align 8
...
cond.false3761:                                   ; preds = %cond.end3752.thread, %cond.end3752
  %423 = phi ptr [ %413, %cond.end3752.thread ], [ %.pre6792, %cond.end3752 ]
  %424 = load ptr, ptr %arrayidx3653, align 8
  store ptr %424, ptr @zz_tmp, align 8
  %arrayidx3766 = getelementptr inbounds [2 x %struct.LIST], ptr %423, i64 0, i64 1
  %425 = load ptr, ptr %arrayidx3766, align 8
  store ptr %425, ptr %arrayidx3653, align 8
  %426 = load ptr, ptr %arrayidx3766, align 8
  %osucc3776 = getelementptr inbounds [2 x %struct.LIST], ptr %426, i64 0, i64 1, i32 1
  store ptr %407, ptr %osucc3776, align 8
  store ptr %424, ptr %arrayidx3766, align 8
  %osucc3782 = getelementptr inbounds [2 x %struct.LIST], ptr %424, i64 0, i64 1, i32 1
  store ptr %423, ptr %osucc3782, align 8
  br label %if.end3788
...
land.lhs.true3790:                                ; preds = %if.end3788
  ...
  %427 = load i16, ptr %owidth3792, align 2
  %cmp3794 = icmp sgt i16 %427, 0
...
if.then3796:                                      ; preds = %land.lhs.true3790
  ...
  %428 = load i32, ptr %ou33798, align 4
  %ofwd3803 = getelementptr inbounds %struct.word_type, ptr %prev.96535, i64 0, i32 3, i32 1
  %429 = load i32, ptr %ofwd3803, align 4
  %add3806 = add nsw i32 %429, %inc2618.0
  %call3807 = call ptr @FixAndPrintObject(ptr noundef nonnull %prev.96535, i32 noundef %mk.26532, i32 noundef %428, i32 noundef %add3806, i32 noundef 0, i32 noundef 0, i32 noundef %pg, i32 noundef %count, ptr noundef nonnull %aback, ptr noundef nonnull %afwd)
  ...
  %430 = load i16, ptr %osave_actual_gap3812, align 2
  %conv3813 = sext i16 %430 to i32
...
if.else3817:                                      ; preds = %land.lhs.true3790, %if.end3788
  ...
  %431 = load i32, ptr %ou33818, align 4
  %ofwd3823 = getelementptr inbounds %struct.word_type, ptr %prev.96535, i64 0, i32 3, i32 1
  %432 = load i32, ptr %ofwd3823, align 4
  %call3826 = call ptr @FixAndPrintObject(ptr noundef nonnull %prev.96535, i32 noundef %mk.26532, i32 noundef %431, i32 noundef %432, i32 noundef 0, i32 noundef 0, i32 noundef %pg, i32 noundef %count, ptr noundef nonnull %aback, ptr noundef nonnull %afwd)
  %osave_actual_gap3827 = getelementptr inbounds %struct.gapobj_type, ptr %g.186534, i64 0, i32 6
  %433 = load i16, ptr %osave_actual_gap3827, align 2
  %conv3828 = sext i16 %433 to i32
  br label %if.end3830
...
if.end3830:                                       ; preds = %if.else3817, %if.then3796
  ...
  %link.176523 = load ptr, ptr %link.17.in6522, align 8
  %cmp3843.not6524 = icmp eq ptr %link.176523, %x
  br i1 %cmp3843.not6524, label %while.end3913.loopexit, label %for.cond3849.preheader
...
for.cond3849:                                     ; preds = %for.cond3849.preheader, %for.cond3849
  ...
  %y.58 = load ptr, ptr %y.58.in, align 8
  %ou13850 = getelementptr inbounds %struct.word_type, ptr %y.58, i64 0, i32 1
  %434 = load i8, ptr %ou13850, align 8
  switch i8 %434, label %cond.false3886 [
...
cond.false3886:                                   ; preds = %for.cond3849
  %435 = add i8 %434, -9
  %or.cond6222 = icmp ult i8 %435, 91
...
if.then3903:                                      ; preds = %if.then3900
  ...
  %call3904 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %436, ptr noundef nonnull @.str.6) #5
...
for.inc3908:                                      ; preds = %for.cond3849, %cond.false3886, %cond.true3883
  ...
  %link.17 = load ptr, ptr %link.17.in, align 8
  %cmp3843.not = icmp eq ptr %link.17, %x
  br i1 %cmp3843.not, label %while.end3913.loopexit, label %for.cond3849.preheader

for.end3912:                                      ; preds = %if.then3900, %if.then3903
  %cmp3557.not = icmp eq ptr %link.176527, %x
  br i1 %cmp3557.not, label %while.end3913.loopexit, label %while.body3559

while.end3913.loopexit:                           ; preds = %if.end3830, %for.end3912, %for.inc3908
  %437 = icmp eq i32 %underlining.2, 0
  br label %while.end3913

while.end3913:                                    ; preds = %for.inc3551, %for.end3470.thread, %for.end3470, %while.end3913.loopexit, %for.end3555
  %ou3347168396848 = phi ptr [ %ou33471, %for.end3555 ], [ %ou33471, %while.end3913.loopexit ], [ %ou334716832, %for.end3470.thread ], [ %ou33471, %for.end3470 ], [ %ou33471, %for.inc3551 ]
  %mk.2.lcssa = phi i32 [ %add3481, %for.end3555 ], [ %mk.3, %while.end3913.loopexit ], [ %add34816836, %for.end3470.thread ], [ %add3481, %for.end3470 ], [ %add3481, %for.inc3551 ]
  %prev.9.lcssa = phi ptr [ %y.51, %for.end3555 ], [ %y.566537, %while.end3913.loopexit ], [ %y.44.lcssa, %for.end3470.thread ], [ %y.51, %for.end3470 ], [ %y.51, %for.inc3551 ]
  %underlining.0.lcssa = phi i1 [ true, %for.end3555 ], [ %437, %while.end3913.loopexit ], [ true, %for.end3470.thread ], [ true, %for.end3470 ], [ true, %for.inc3551 ]
  %underline_xstart.0.lcssa = phi i32 [ undef, %for.end3555 ], [ %underline_xstart.2, %while.end3913.loopexit ], [ undef, %for.end3470.thread ], [ undef, %for.end3470 ], [ undef, %for.inc3551 ]
  %underline_font.0.lcssa = phi i32 [ undef, %for.end3555 ], [ %underline_font.2, %while.end3913.loopexit ], [ undef, %for.end3470.thread ], [ undef, %for.end3470 ], [ undef, %for.inc3551 ]
  %underline_colour.0.lcssa = phi i32 [ undef, %for.end3555 ], [ %underline_colour.2, %while.end3913.loopexit ], [ undef, %for.end3470.thread ], [ undef, %for.end3470 ], [ undef, %for.inc3551 ]
...
if.then3927:                                      ; preds = %while.end3913
  %438 = load ptr, ptr @no_fpos, align 8
...
if.then3938:                                      ; preds = %if.then3936
  ...
  %441 = load i32, ptr %ou33985, align 4
...
if.end3990:                                       ; preds = %if.then3938, %if.then3936
  ...
  %442 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 3), align 1
  %conv3991 = zext i8 %442 to i32
  store i32 %conv3991, ptr @zz_size, align 4
  %conv3992 = zext i8 %442 to i64
  %arrayidx3999 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv3992
  %443 = load ptr, ptr %arrayidx3999, align 8
...
if.then4002:                                      ; preds = %if.end3990
  ...
  store ptr %call4003, ptr @zz_hold, align 8
  br label %if.end4013

if.else4004:                                      ; preds = %if.end3990
  store ptr %443, ptr @zz_hold, align 8
  %445 = load ptr, ptr %443, align 8
  store ptr %445, ptr %arrayidx3999, align 8
  br label %if.end4013
...
if.end4013:                                       ; preds = %if.then4002, %if.else4004
  ...
  store i8 3, ptr %ou14014, align 8
...
if.else4058:                                      ; preds = %if.end4013
  store ptr %449, ptr @zz_hold, align 8
  %451 = load ptr, ptr %449, align 8
  store ptr %451, ptr %arrayidx4053, align 8
  br label %if.end4067
...
cond.end4116:                                     ; preds = %if.end4067
  ...
  store ptr %456, ptr %osucc4107, align 8
  ...
  store ptr %460, ptr %osucc4113, align 8
  %.pre6794 = load ptr, ptr @xx_link, align 8
  store ptr %.pre6794, ptr @zz_res, align 8
  store ptr %446, ptr @zz_hold, align 8
...
cond.false4125:                                   ; preds = %cond.end4116.thread, %cond.end4116
  ...
  %463 = load ptr, ptr %arrayidx4017, align 8
  store ptr %463, ptr @zz_tmp, align 8
  %arrayidx4130 = getelementptr inbounds [2 x %struct.LIST], ptr %462, i64 0, i64 1
  %464 = load ptr, ptr %arrayidx4130, align 8
  store ptr %464, ptr %arrayidx4017, align 8
  %465 = load ptr, ptr %arrayidx4130, align 8
  %osucc4140 = getelementptr inbounds [2 x %struct.LIST], ptr %465, i64 0, i64 1, i32 1
  store ptr %446, ptr %osucc4140, align 8
  store ptr %463, ptr %arrayidx4130, align 8
  %osucc4146 = getelementptr inbounds [2 x %struct.LIST], ptr %463, i64 0, i64 1, i32 1
  store ptr %462, ptr %osucc4146, align 8
  br label %if.end4151
...
if.end4151:                                       ; preds = %cond.end4116, %cond.false4125, %if.end3929
  ...
  %466 = load i32, ptr %ou34152, align 4
  %467 = load i32, ptr %ou3347168396848, align 4
...
cleanup:                                          ; preds = %for.inc2683, %if.then2615
  ...
  %469 = load i32, ptr %ou32691, align 4
  store i32 %469, ptr %actual_back, align 4
  %ofwd2696 = getelementptr inbounds %struct.word_type, ptr %x, i64 0, i32 3, i32 1
  %470 = load i32, ptr %ofwd2696, align 4
  store i32 %470, ptr %actual_fwd, align 4
  br label %sw.epilog4616
...
for.cond4192:                                     ; preds = %for.cond4192.preheader, %for.cond4192
  ...
  %y.60 = load ptr, ptr %y.60.in, align 8
  %ou14193 = getelementptr inbounds %struct.word_type, ptr %y.60, i64 0, i32 1
  %471 = load i8, ptr %ou14193, align 8
  %cmp4196 = icmp eq i8 %471, 0
  br i1 %cmp4196, label %for.cond4192, label %for.end4203
...
if.then4221:                                      ; preds = %if.then4215
  ...
  %475 = load i32, ptr %arrayidx4224, align 4
...
for.inc4342:                                      ; preds = %if.then4215, %if.then4336, %cond.end4299, %if.end4340
  ...
  %link.18 = load ptr, ptr %link.18.in, align 8
  %cmp4186.not = icmp eq ptr %link.18, %x
  br i1 %cmp4186.not, label %if.end4347, label %for.cond4192.preheader
...
for.cond4367:                                     ; preds = %for.cond4367.preheader, %for.cond4367
  ...
  %link.20 = load ptr, ptr %link.20.in, align 8
  %uplink.0 = load ptr, ptr %uplink.0.in, align 8
  ...
  br i1 %or.cond6225, label %for.cond4367, label %for.end4387
...
if.end4395:                                       ; preds = %for.end4387, %if.then4393
  ...
  %y.616456 = load ptr, ptr %arrayidx4397, align 8
  %ou144006457 = getelementptr inbounds %struct.word_type, ptr %y.616456, i64 0, i32 1
  %498 = load i8, ptr %ou144006457, align 8
...
for.inc4406:                                      ; preds = %if.end4395, %for.inc4406
  ...
  %y.61 = load ptr, ptr %arrayidx4408, align 8
  %ou14400 = getelementptr inbounds %struct.word_type, ptr %y.61, i64 0, i32 1
  %499 = load i8, ptr %ou14400, align 8
  %cmp4403 = icmp eq i8 %499, 0
  br i1 %cmp4403, label %for.inc4406, label %for.end4411
...
cond.end4533:                                     ; preds = %cond.end4503, %cond.false4511
  ...
  %515 = load i8, ptr %ou14535, align 8
...
if.end4572:                                       ; preds = %if.then4570, %cond.end4533
  ...
  %521 = load i8, ptr %ocross_type4574, align 1
...
if.then4578:                                      ; preds = %if.end4572
  ...
  store i32 %xb, ptr %arrayidx4582, align 4
  ...
  store i32 %xf, ptr %arrayidx4586, align 4
  store i8 2, ptr %ocross_type4574, align 1
  br label %if.end4589
...
if.end4589:                                       ; preds = %if.end4572.if.end4589_crit_edge, %if.then4578
  ...
  %522 = load i32, ptr %arrayidx4593, align 4
  ...
  %523 = load i32, ptr %arrayidx4597, align 4
...
entry:
  ...
  %link.0356 = load ptr, ptr %link.0.in355, align 8
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.cond3
  %link.0.pn = phi ptr [ %prev.1, %for.cond3 ], [ %link.0359, %for.cond3.preheader ]
  %prev.1.in = getelementptr inbounds [2 x %struct.LIST], ptr %link.0.pn, i64 0, i64 1
  %prev.1 = load ptr, ptr %prev.1.in, align 8
...
for.inc37:                                        ; preds = %for.cond3, %cond.false, %cond.true
  ...
  br i1 %cmp.not, label %cleanup, label %for.cond3.preheader
...
if.then44:                                        ; preds = %cond.true, %cond.false
  ...
  %2 = load i32, ptr %arrayidx45, align 4
  %link.1.in361 = getelementptr inbounds %struct.LIST, ptr %link.0359, i64 0, i32 1
  %link.1362 = load ptr, ptr %link.1.in361, align 8
...
for.inc115:                                       ; preds = %for.cond56, %cond.false93, %cond.true90
  ...
  br i1 %cmp50.not, label %cleanup, label %for.cond56.preheader
...
if.end144:                                        ; preds = %while.body
  ...
  %7 = load i32, ptr %arrayidx147, align 4
  ...
  %8 = load i32, ptr %arrayidx151, align 4
  ...
  %9 = load i32, ptr %arrayidx155, align 4
  ...
  %link.3370 = load ptr, ptr %link.3.in369, align 8
...
for.inc228:                                       ; preds = %for.cond169, %cond.false206, %cond.true203
  ...
  br i1 %cmp163.not, label %cond.false241, label %for.cond169.preheader

for.end232:                                       ; preds = %if.then220, %if.then223
  %cmp120.not = icmp eq ptr %link.3374, %x
  br i1 %cmp120.not, label %cond.false241, label %while.body
...
cond.false241:                                    ; preds = %if.end144, %for.end232, %for.inc228
  ...
  %13 = load i32, ptr %arrayidx236, align 4
  %14 = add i32 %add, %13
