...
if.end7:                                          ; preds = %if.else, %if.then4, %if.then1
  ...
  %9 = load ptr, ptr %arrayidx11, align 8, !tbaa !21
...
if.end341:                                        ; preds = %if.then330, %if.else332, %if.then323
  ...
  store ptr %66, ptr %arrayidx351, align 8, !tbaa !5
...
if.end560:                                        ; preds = %if.then549, %if.else551
  ...
  store ptr %102, ptr %arrayidx567, align 8, !tbaa !5
...
if.end768:                                        ; preds = %if.then757, %if.else759, %if.then750
  ...
  store i8 12, ptr %ou1772, align 8, !tbaa !5
  ...
  store ptr %124, ptr %arrayidx778, align 8, !tbaa !5
...
if.end860:                                        ; preds = %if.then849, %if.else851, %if.then842
  ...
  store i8 12, ptr %ou1864, align 8, !tbaa !5
  ...
  store ptr %142, ptr %arrayidx870, align 8, !tbaa !5
...
if.end965:                                        ; preds = %if.then954, %if.else956, %if.then947
  ...
  store i8 12, ptr %ou1969, align 8, !tbaa !5
  ...
  store ptr %163, ptr %arrayidx975, align 8, !tbaa !5
...
if.end12.if.end20_crit_edge:                      ; preds = %if.end12
  ...
  %.pre58.pre = load ptr, ptr @buf, align 8, !tbaa !13
  br label %if.end20
...
if.then27:                                        ; preds = %if.end20
  ...
  store i8 10, ptr @last_char, align 1, !tbaa !5
  %10 = load i16, ptr @ftype, align 2, !tbaa !28
...
if.then34:                                        ; preds = %if.then27
  ...
  %.pre57 = load ptr, ptr @buf, align 8, !tbaa !13
  %.pre59 = load i32, ptr @blksize, align 4, !tbaa !11
  br label %if.end43
...
if.end43:                                         ; preds = %if.then27, %if.then34, %if.end20
  ...
  store ptr %12, ptr @frst, align 8, !tbaa !13
  ...
  %.pre60 = load ptr, ptr @chpt, align 8, !tbaa !13
  br label %if.end46
...
if.then49:                                        ; preds = %if.end46
  %15 = load ptr, ptr @buf, align 8, !tbaa !13
  store ptr %15, ptr @limit, align 8, !tbaa !13
  store ptr %15, ptr @chpt, align 8, !tbaa !13
