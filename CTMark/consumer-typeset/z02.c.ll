; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z02.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z02.c"
...
for.cond14:                                       ; preds = %entry, %for.cond14
  ...
  br i1 %cmp20, label %for.cond14, label %for.end25
...
entry:
  store i8 1, ptr getelementptr inbounds ([256 x i8], ptr @chtbl, i64 0, i64 95), align 1
  ...
  store i8 2, ptr getelementptr inbounds ([256 x i8], ptr @chtbl, i64 0, i64 34), align 2
  store i8 3, ptr getelementptr inbounds ([256 x i8], ptr @chtbl, i64 0, i64 92), align 4
  store i8 4, ptr getelementptr inbounds ([256 x i8], ptr @chtbl, i64 0, i64 35), align 1
  store i8 5, ptr getelementptr inbounds ([256 x i8], ptr @chtbl, i64 0, i64 32), align 16
  store i8 6, ptr getelementptr inbounds ([256 x i8], ptr @chtbl, i64 0, i64 12), align 4
  store i8 7, ptr getelementptr inbounds ([256 x i8], ptr @chtbl, i64 0, i64 9), align 1
  store i8 8, ptr getelementptr inbounds ([256 x i8], ptr @chtbl, i64 0, i64 10), align 2
  store i8 9, ptr @chtbl, align 16
  store i32 -1, ptr @stack_free, align 4
  ret void
}
...
entry:
  %0 = load i32, ptr @stack_free, align 4
...
if.end:                                           ; preds = %if.else, %if.then2
  %1 = load i32, ptr @stack_free, align 4
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %4 = load i16, ptr %this_file, align 8
...
for.end:                                          ; preds = %for.body, %if.end
  ...
  %.pr = load i32, ptr @stack_free, align 4
  br label %if.end12
...
if.then64:                                        ; preds = %if.end61
  ...
  %.pre = load ptr, ptr @mem_block, align 8
  br label %if.end68
...
if.end68:                                         ; preds = %if.then64, %if.end61
  ...
  store ptr %arrayidx69, ptr @chpt, align 8
  store ptr %arrayidx69, ptr @buf, align 8
  store i8 10, ptr @last_char, align 1
  store i16 %x, ptr @this_file, align 2
  store i32 %offs, ptr @offset, align 4
  store i32 %lnum, ptr @first_line_num, align 4
  store i32 %same, ptr @same_file, align 4
  %conv = trunc i32 %ftyp to i16
  store i16 %conv, ptr @ftype, align 2
  store ptr null, ptr @next_token, align 8
...
if.then70:                                        ; preds = %if.end68
  ...
  %25 = load i32, ptr @stack_free, align 4
  ...
  store i64 %call71, ptr %save_ftell, align 8
  br label %if.end76
...
if.then:                                          ; preds = %entry
  ...
  %.pre = load i32, ptr @stack_free, align 4
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %2 = phi i32 [ %.pre, %if.then ], [ %0, %entry ]
  %dec = add nsw i32 %2, -1
  store i32 %dec, ptr @stack_free, align 4
  %3 = load i32, ptr @same_file, align 4
...
if.then1:                                         ; preds = %if.end
  ...
  %5 = load i64, ptr %save_ftell, align 8
...
if.end7:                                          ; preds = %if.else, %if.then4, %if.then1
  ...
  %21 = load i32, ptr %first_line_num, align 4
  store i32 %21, ptr @first_line_num, align 4
  %same_file = getelementptr inbounds [10 x %struct.anon], ptr @lex_stack, i64 0, i64 %idxprom8, i32 14
  %22 = load i32, ptr %same_file, align 8
  store i32 %22, ptr @same_file, align 4
  %ofile_num = getelementptr inbounds [10 x %struct.anon], ptr @lex_stack, i64 0, i64 %idxprom8, i32 9, i32 2
  %23 = load i16, ptr %ofile_num, align 2
  store i16 %23, ptr getelementptr inbounds (%struct.FILE_POS, ptr @file_pos, i64 0, i32 2), align 2
...
entry:
  %0 = load ptr, ptr @next_token, align 8
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %3 = load ptr, ptr @chpt, align 8
  %sub.ptr.lhs.cast = ptrtoint ptr %2 to i64
  %sub.ptr.rhs.cast = ptrtoint ptr %3 to i64
  %4 = load ptr, ptr @buf, align 8
  %5 = load ptr, ptr @frst, align 8
...
cond.false:                                       ; preds = %if.then
  store ptr %1, ptr @zz_res, align 8
  ...
  store ptr %1, ptr %osucc15, align 8
  store ptr %0, ptr %osucc, align 8
  store ptr %0, ptr %arrayidx6, align 8
  br label %cond.end

cond.end:                                         ; preds = %if.then, %cond.false
  %cond = phi ptr [ %1, %cond.false ], [ null, %if.then ]
  store ptr %cond, ptr @next_token, align 8
  br label %cleanup1093

if.end:                                           ; preds = %entry
  %4 = load ptr, ptr @chpt, align 8
  br label %do.body
...
if.then37:                                        ; preds = %land.lhs.true33
  %11 = load ptr, ptr @StartSym, align 8
...
if.else:                                          ; preds = %land.lhs.true33, %land.lhs.true, %sw.bb
  %12 = load ptr, ptr @startline, align 8
...
if.then55:                                        ; preds = %while.cond
  store ptr %incdec.ptr47, ptr @chpt, align 8
  ...
  %15 = load ptr, ptr @chpt, align 8
  %add.ptr65 = getelementptr inbounds i8, ptr %15, i64 -1
  store ptr %add.ptr65, ptr @startline, align 8
  br label %do.cond1074
...
sw.bb72:                                          ; preds = %do.body
  store ptr %incdec.ptr, ptr @chpt, align 8
  call fastcc void @srcnext()
  ...
  %16 = load ptr, ptr @chpt, align 8
  %add.ptr84 = getelementptr inbounds i8, ptr %16, i64 -1
  store ptr %add.ptr84, ptr @startline, align 8
  br label %do.cond1074

sw.bb85:                                          ; preds = %do.body
  %17 = load i32, ptr @same_file, align 4
...
cond.end98:                                       ; preds = %if.then89, %cond.true94
  ...
  store i16 %cond99, ptr @this_file, align 2
  br label %if.end101
...
while.body106:                                    ; preds = %if.end101, %cond.end127
  ...
  store i16 %21, ptr getelementptr inbounds (%struct.FILE_POS, ptr @file_pos, i64 0, i32 2), align 2
...
if.then137:                                       ; preds = %if.then134
  ...
  %27 = load i32, ptr @first_line_num, align 4
...
if.end144:                                        ; preds = %if.then137, %if.then134
  ...
  store ptr %28, ptr @chpt, align 8
  store ptr %28, ptr @limit, align 8
  store ptr %28, ptr @frst, align 8
  store i32 0, ptr @blksize, align 4
  store i8 10, ptr @last_char, align 1
  call fastcc void @srcnext()
  %29 = load ptr, ptr @chpt, align 8
  %add.ptr145 = getelementptr inbounds i8, ptr %29, i64 -1
  store ptr %add.ptr145, ptr @startline, align 8
  br label %do.cond1074

if.else146:                                       ; preds = %if.end131
  %30 = load i16, ptr @ftype, align 2
...
sw.bb148:                                         ; preds = %if.else146, %if.else146
  %31 = load ptr, ptr @StartSym, align 8
  ...
  store ptr %call150, ptr @next_token, align 8
  store ptr %p.0, ptr @startline, align 8
  br label %do.cond1074

sw.bb152:                                         ; preds = %if.else146
  %32 = load ptr, ptr @FilterOutSym, align 8
...
sw.bb158:                                         ; preds = %do.body
  %35 = load ptr, ptr @startline, align 8
...
do.body182:                                       ; preds = %do.body182, %while.end177
  ...
  br i1 %39, label %do.body182, label %MORE

sw.bb191:                                         ; preds = %do.body
  %40 = load ptr, ptr @startline, align 8
...
if.then219:                                       ; preds = %MORE
  ...
  store i32 %conv229, ptr @zz_size, align 4
...
if.then233:                                       ; preds = %if.then219
  ...
  %.pre1416 = load ptr, ptr @zz_hold, align 8
  br label %if.end251
...
if.else235:                                       ; preds = %if.then219
  ...
  %44 = load ptr, ptr %arrayidx237, align 8
...
if.then240:                                       ; preds = %if.else235
  ...
  store ptr %call241, ptr @zz_hold, align 8
  br label %if.end251

if.else242:                                       ; preds = %if.else235
  store ptr %44, ptr @zz_hold, align 8
  %45 = load ptr, ptr %44, align 8
  store ptr %45, ptr %arrayidx237, align 8
  br label %if.end251
...
vector.body1592:                                  ; preds = %vector.body1592, %vector.ph1588
  ...
  %wide.load1594 = load <16 x i8>, ptr %52, align 1
  %53 = getelementptr inbounds i8, ptr %52, i64 16
  %wide.load1595 = load <16 x i8>, ptr %53, align 1
  %54 = getelementptr inbounds %struct.word_type, ptr %46, i64 0, i32 4, i64 %index1593
  store <16 x i8> %wide.load1594, ptr %54, align 1
  %55 = getelementptr inbounds i8, ptr %54, i64 16
  store <16 x i8> %wide.load1595, ptr %55, align 1
  %index.next1596 = add nuw i64 %index1593, 32
  %56 = icmp eq i64 %index.next1596, %n.vec1590
  br i1 %56, label %middle.block1582, label %vector.body1592
...
vec.epilog.vector.body1608:                       ; preds = %vec.epilog.vector.body1608, %vec.epilog.ph1600
  ...
  %wide.load1610 = load <8 x i8>, ptr %57, align 1
  %58 = getelementptr inbounds %struct.word_type, ptr %46, i64 0, i32 4, i64 %index1609
  store <8 x i8> %wide.load1610, ptr %58, align 1
  %index.next1611 = add nuw i64 %index1609, 8
  %59 = icmp eq i64 %index.next1611, %n.vec1605
  br i1 %59, label %vec.epilog.middle.block1597, label %vec.epilog.vector.body1608
...
if.then306:                                       ; preds = %if.then301
  ...
  store i32 %conv319, ptr @zz_size, align 4
...
if.then323:                                       ; preds = %if.then306
  ...
  %.pre1415 = load ptr, ptr @zz_hold, align 8
  br label %if.end341
...
if.else325:                                       ; preds = %if.then306
  ...
  %64 = load ptr, ptr %arrayidx327, align 8
...
if.then330:                                       ; preds = %if.else325
  ...
  store ptr %call331, ptr @zz_hold, align 8
  br label %if.end341

if.else332:                                       ; preds = %if.else325
  store ptr %64, ptr @zz_hold, align 8
  %65 = load ptr, ptr %64, align 8
  store ptr %65, ptr %arrayidx327, align 8
  br label %if.end341

if.end341:                                        ; preds = %if.then330, %if.else332, %if.then323
  %66 = phi ptr [ %call331, %if.then330 ], [ %64, %if.else332 ], [ %.pre1415, %if.then323 ]
  %67 = ptrtoint ptr %66 to i64
  %68 = load i32, ptr @zz_size, align 4
  %conv342 = trunc i32 %68 to i8
  %orec_size344 = getelementptr inbounds %struct.word_type, ptr %66, i64 0, i32 1, i32 0, i32 1
  store i8 %conv342, ptr %orec_size344, align 1
  %ou1345 = getelementptr inbounds %struct.word_type, ptr %66, i64 0, i32 1
  store i8 11, ptr %ou1345, align 8
  %osucc349 = getelementptr inbounds [2 x %struct.LIST], ptr %66, i64 0, i64 1, i32 1
  store ptr %66, ptr %osucc349, align 8
  %arrayidx351 = getelementptr inbounds [2 x %struct.LIST], ptr %66, i64 0, i64 1
  store ptr %66, ptr %arrayidx351, align 8
  %osucc355 = getelementptr inbounds %struct.LIST, ptr %66, i64 0, i32 1
  store ptr %66, ptr %osucc355, align 8
  store ptr %66, ptr %66, align 8
  %69 = load i16, ptr getelementptr inbounds (%struct.FILE_POS, ptr @file_pos, i64 0, i32 2), align 2
  %ofile_num360 = getelementptr inbounds %struct.word_type, ptr %66, i64 0, i32 1, i32 0, i32 2
  store i16 %69, ptr %ofile_num360, align 2
...
vector.body1560:                                  ; preds = %vector.body1560, %vector.ph1556
  ...
  %wide.load1562 = load <16 x i8>, ptr %72, align 1
  %73 = getelementptr inbounds i8, ptr %72, i64 16
  %wide.load1563 = load <16 x i8>, ptr %73, align 1
  %74 = getelementptr inbounds %struct.word_type, ptr %66, i64 0, i32 4, i64 %index1561
  store <16 x i8> %wide.load1562, ptr %74, align 1
  %75 = getelementptr inbounds i8, ptr %74, i64 16
  store <16 x i8> %wide.load1563, ptr %75, align 1
  %index.next1564 = add nuw i64 %index1561, 32
  %76 = icmp eq i64 %index.next1564, %n.vec1558
  br i1 %76, label %middle.block1550, label %vector.body1560
...
vec.epilog.vector.body1576:                       ; preds = %vec.epilog.vector.body1576, %vec.epilog.ph1568
  ...
  %wide.load1578 = load <8 x i8>, ptr %77, align 1
  %78 = getelementptr inbounds %struct.word_type, ptr %66, i64 0, i32 4, i64 %index1577
  store <8 x i8> %wide.load1578, ptr %78, align 1
  %index.next1579 = add nuw i64 %index1577, 8
  %79 = icmp eq i64 %index.next1579, %n.vec1573
  br i1 %79, label %vec.epilog.middle.block1565, label %vec.epilog.vector.body1576
...
if.then471:                                       ; preds = %if.then451, %land.end463
  ...
  %90 = load ptr, ptr %arrayidx499, align 8
  store ptr %90, ptr %88, align 8
  %91 = load ptr, ptr @zz_hold, align 8
  %92 = load i32, ptr @zz_size, align 4
  %idxprom503 = sext i32 %92 to i64
  %arrayidx504 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom503
  store ptr %91, ptr %arrayidx504, align 8
  br label %cleanup
...
if.then549:                                       ; preds = %if.then507
  ...
  store ptr %call550, ptr @zz_hold, align 8
  br label %if.end560

if.else551:                                       ; preds = %if.then507
  store ptr %99, ptr @zz_hold, align 8
  %101 = load ptr, ptr %99, align 8
  store ptr %101, ptr %arrayidx546, align 8
  br label %if.end560
...
if.end560:                                        ; preds = %if.then549, %if.else551
  ...
  store i8 102, ptr %ou1561, align 8
  %osucc565 = getelementptr inbounds [2 x %struct.LIST], ptr %102, i64 0, i64 1, i32 1
  store ptr %102, ptr %osucc565, align 8
  %arrayidx567 = getelementptr inbounds [2 x %struct.LIST], ptr %102, i64 0, i64 1
  store ptr %102, ptr %arrayidx567, align 8
  %osucc571 = getelementptr inbounds %struct.LIST, ptr %102, i64 0, i32 1
  store ptr %102, ptr %osucc571, align 8
  store ptr %102, ptr %102, align 8
  store ptr %102, ptr %t, align 8
  br label %if.end575
...
if.end580:                                        ; preds = %if.then579, %if.end575
  ...
  %104 = load i8, ptr %ou1581, align 8
...
if.then592:                                       ; preds = %if.end580
  ...
  store ptr %call577, ptr @zz_hold, align 8
  %105 = load i8, ptr %ou1581, align 8
  ...
  %cond617.in = load i8, ptr %cond617.in.in, align 1
  %cond617 = zext i8 %cond617.in to i32
  store i32 %cond617, ptr @zz_size, align 4
  %idxprom618 = zext i8 %cond617.in to i64
  %arrayidx619 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom618
  %106 = load ptr, ptr %arrayidx619, align 8
  store ptr %106, ptr %call577, align 8
  ...
  store ptr %107, ptr %arrayidx624, align 8
  br label %cleanup
...
if.end645:                                        ; preds = %if.then640, %land.lhs.true633, %if.end625
  %110 = load i16, ptr %opredefined, align 8
  ...
  store ptr %call577, ptr @zz_hold, align 8
  %111 = load i8, ptr %ou1581, align 8
  ...
  %cond677.in = load i8, ptr %cond677.in.in, align 1
  %cond677 = zext i8 %cond677.in to i32
  store i32 %cond677, ptr @zz_size, align 4
  %idxprom678 = zext i8 %cond677.in to i64
  %arrayidx679 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom678
  %112 = load ptr, ptr %arrayidx679, align 8
  store ptr %112, ptr %call577, align 8
  ...
  store ptr %113, ptr %arrayidx684, align 8
...
if.then696:                                       ; preds = %if.else435
  ...
  %116 = load i8, ptr %ou2699, align 8
...
if.else702:                                       ; preds = %if.else435
  ...
  %117 = load i8, ptr %ou2705, align 8
...
sw.bb713:                                         ; preds = %do.body
  %118 = load ptr, ptr @startline, align 8
...
sw.bb731:                                         ; preds = %do.body724, %do.body724
  ...
  store i32 %conv746, ptr @zz_size, align 4
...
if.then750:                                       ; preds = %sw.bb731
  ...
  %.pre1414 = load ptr, ptr @zz_hold, align 8
  br label %if.end768
...
if.else752:                                       ; preds = %sw.bb731
  ...
  %122 = load ptr, ptr %arrayidx754, align 8
...
if.then757:                                       ; preds = %if.else752
  ...
  store ptr %call758, ptr @zz_hold, align 8
  br label %if.end768

if.else759:                                       ; preds = %if.else752
  store ptr %122, ptr @zz_hold, align 8
  %123 = load ptr, ptr %122, align 8
  store ptr %123, ptr %arrayidx754, align 8
  br label %if.end768

if.end768:                                        ; preds = %if.then757, %if.else759, %if.then750
  %124 = phi ptr [ %call758, %if.then757 ], [ %122, %if.else759 ], [ %.pre1414, %if.then750 ]
  %125 = ptrtoint ptr %124 to i64
  %126 = load i32, ptr @zz_size, align 4
  %conv769 = trunc i32 %126 to i8
  %orec_size771 = getelementptr inbounds %struct.word_type, ptr %124, i64 0, i32 1, i32 0, i32 1
  store i8 %conv769, ptr %orec_size771, align 1
  %ou1772 = getelementptr inbounds %struct.word_type, ptr %124, i64 0, i32 1
  store i8 12, ptr %ou1772, align 8
  %osucc776 = getelementptr inbounds [2 x %struct.LIST], ptr %124, i64 0, i64 1, i32 1
  store ptr %124, ptr %osucc776, align 8
  %arrayidx778 = getelementptr inbounds [2 x %struct.LIST], ptr %124, i64 0, i64 1
  store ptr %124, ptr %arrayidx778, align 8
  %osucc782 = getelementptr inbounds %struct.LIST, ptr %124, i64 0, i32 1
  store ptr %124, ptr %osucc782, align 8
  store ptr %124, ptr %124, align 8
  %127 = load i16, ptr getelementptr inbounds (%struct.FILE_POS, ptr @file_pos, i64 0, i32 2), align 2
  %ofile_num787 = getelementptr inbounds %struct.word_type, ptr %124, i64 0, i32 1, i32 0, i32 2
  store i16 %127, ptr %ofile_num787, align 2
...
vector.body1528:                                  ; preds = %vector.body1528, %vector.ph1524
  ...
  %wide.load1530 = load <16 x i8>, ptr %130, align 1
  %131 = getelementptr inbounds i8, ptr %130, i64 16
  %wide.load1531 = load <16 x i8>, ptr %131, align 1
  %132 = getelementptr inbounds %struct.word_type, ptr %124, i64 0, i32 4, i64 %index1529
  store <16 x i8> %wide.load1530, ptr %132, align 1
  %133 = getelementptr inbounds i8, ptr %132, i64 16
  store <16 x i8> %wide.load1531, ptr %133, align 1
  %index.next1532 = add nuw i64 %index1529, 32
  %134 = icmp eq i64 %index.next1532, %n.vec1526
  br i1 %134, label %middle.block1518, label %vector.body1528
...
vec.epilog.vector.body1544:                       ; preds = %vec.epilog.vector.body1544, %vec.epilog.ph1536
  ...
  %wide.load1546 = load <8 x i8>, ptr %135, align 1
  %136 = getelementptr inbounds %struct.word_type, ptr %124, i64 0, i32 4, i64 %index1545
  store <8 x i8> %wide.load1546, ptr %136, align 1
  %index.next1547 = add nuw i64 %index1545, 8
  %137 = icmp eq i64 %index.next1547, %n.vec1541
  br i1 %137, label %vec.epilog.middle.block1533, label %vec.epilog.vector.body1544
...
for.end821:                                       ; preds = %for.body813, %middle.block1518, %vec.epilog.middle.block1533, %if.end768
  ...
  store i8 0, ptr %arrayidx824, align 1
  br label %do.end1077
...
sw.bb825:                                         ; preds = %do.body724
  ...
  store i32 %conv838, ptr @zz_size, align 4
...
if.then842:                                       ; preds = %sw.bb825
  ...
  %.pre1413 = load ptr, ptr @zz_hold, align 8
  br label %if.end860
...
if.else844:                                       ; preds = %sw.bb825
  ...
  %140 = load ptr, ptr %arrayidx846, align 8
...
if.then849:                                       ; preds = %if.else844
  ...
  store ptr %call850, ptr @zz_hold, align 8
  br label %if.end860

if.else851:                                       ; preds = %if.else844
  store ptr %140, ptr @zz_hold, align 8
  %141 = load ptr, ptr %140, align 8
  store ptr %141, ptr %arrayidx846, align 8
  br label %if.end860

if.end860:                                        ; preds = %if.then849, %if.else851, %if.then842
  %142 = phi ptr [ %call850, %if.then849 ], [ %140, %if.else851 ], [ %.pre1413, %if.then842 ]
  %143 = ptrtoint ptr %142 to i64
  %144 = load i32, ptr @zz_size, align 4
  %conv861 = trunc i32 %144 to i8
  %orec_size863 = getelementptr inbounds %struct.word_type, ptr %142, i64 0, i32 1, i32 0, i32 1
  store i8 %conv861, ptr %orec_size863, align 1
  %ou1864 = getelementptr inbounds %struct.word_type, ptr %142, i64 0, i32 1
  store i8 12, ptr %ou1864, align 8
  %osucc868 = getelementptr inbounds [2 x %struct.LIST], ptr %142, i64 0, i64 1, i32 1
  store ptr %142, ptr %osucc868, align 8
  %arrayidx870 = getelementptr inbounds [2 x %struct.LIST], ptr %142, i64 0, i64 1
  store ptr %142, ptr %arrayidx870, align 8
  %osucc874 = getelementptr inbounds %struct.LIST, ptr %142, i64 0, i32 1
  store ptr %142, ptr %osucc874, align 8
  store ptr %142, ptr %142, align 8
  %145 = load i16, ptr getelementptr inbounds (%struct.FILE_POS, ptr @file_pos, i64 0, i32 2), align 2
  %ofile_num879 = getelementptr inbounds %struct.word_type, ptr %142, i64 0, i32 1, i32 0, i32 2
  store i16 %145, ptr %ofile_num879, align 2
...
vector.body1496:                                  ; preds = %vector.body1496, %vector.ph1492
  ...
  %wide.load1498 = load <16 x i8>, ptr %148, align 1
  %149 = getelementptr inbounds i8, ptr %148, i64 16
  %wide.load1499 = load <16 x i8>, ptr %149, align 1
  %150 = getelementptr inbounds %struct.word_type, ptr %142, i64 0, i32 4, i64 %index1497
  store <16 x i8> %wide.load1498, ptr %150, align 1
  %151 = getelementptr inbounds i8, ptr %150, i64 16
  store <16 x i8> %wide.load1499, ptr %151, align 1
  %index.next1500 = add nuw i64 %index1497, 32
  %152 = icmp eq i64 %index.next1500, %n.vec1494
  br i1 %152, label %middle.block1486, label %vector.body1496
...
vec.epilog.vector.body1512:                       ; preds = %vec.epilog.vector.body1512, %vec.epilog.ph1504
  ...
  %wide.load1514 = load <8 x i8>, ptr %153, align 1
  %154 = getelementptr inbounds %struct.word_type, ptr %142, i64 0, i32 4, i64 %index1513
  store <8 x i8> %wide.load1514, ptr %154, align 1
  %index.next1515 = add nuw i64 %index1513, 8
  %155 = icmp eq i64 %index.next1515, %n.vec1509
  br i1 %155, label %vec.epilog.middle.block1501, label %vec.epilog.vector.body1512
...
if.then930:                                       ; preds = %sw.bb917
  ...
  store i32 %conv943, ptr @zz_size, align 4
...
if.else949:                                       ; preds = %if.then930
  ...
  %161 = load ptr, ptr %arrayidx951, align 8
...
if.then954:                                       ; preds = %if.else949
  ...
  store ptr %call955, ptr @zz_hold, align 8
  br label %if.end965

if.else956:                                       ; preds = %if.else949
  store ptr %161, ptr @zz_hold, align 8
  %162 = load ptr, ptr %161, align 8
  store ptr %162, ptr %arrayidx951, align 8
  br label %if.end965
...
if.end965:                                        ; preds = %if.then954, %if.else956, %if.then947
  ...
  store i8 %conv966, ptr %orec_size968, align 1
  %ou1969 = getelementptr inbounds %struct.word_type, ptr %163, i64 0, i32 1
  store i8 12, ptr %ou1969, align 8
  %osucc973 = getelementptr inbounds [2 x %struct.LIST], ptr %163, i64 0, i64 1, i32 1
  store ptr %163, ptr %osucc973, align 8
  %arrayidx975 = getelementptr inbounds [2 x %struct.LIST], ptr %163, i64 0, i64 1
  store ptr %163, ptr %arrayidx975, align 8
  %osucc979 = getelementptr inbounds %struct.LIST, ptr %163, i64 0, i32 1
  store ptr %163, ptr %osucc979, align 8
  store ptr %163, ptr %163, align 8
  %166 = load i16, ptr getelementptr inbounds (%struct.FILE_POS, ptr @file_pos, i64 0, i32 2), align 2
  %ofile_num984 = getelementptr inbounds %struct.word_type, ptr %163, i64 0, i32 1, i32 0, i32 2
  store i16 %166, ptr %ofile_num984, align 2
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load1482 = load <8 x i8>, ptr %174, align 1
  %175 = getelementptr inbounds %struct.word_type, ptr %163, i64 0, i32 4, i64 %index1481
  store <8 x i8> %wide.load1482, ptr %175, align 1
...
for.end1017:                                      ; preds = %for.body1009, %middle.block, %vec.epilog.middle.block, %if.end965
  ...
  store i8 0, ptr %arrayidx1020, align 1
  br label %do.end1077
...
do.body1030:                                      ; preds = %if.else1021
  ...
  %179 = load i8, ptr %incdec.ptr1032, align 1
  %cmp1039 = icmp ugt i8 %179, 47
  %cmp1043 = icmp ult i8 %179, 56
  %or.cond = and i1 %cmp1039, %cmp1043
  br i1 %or.cond, label %do.body1030.1, label %do.end1050
...
do.body1030.1:                                    ; preds = %do.body1030
  ...
  %180 = load i8, ptr %incdec.ptr1032.1, align 1
  %cmp1039.1 = icmp ugt i8 %180, 47
  %cmp1043.1 = icmp ult i8 %180, 56
  %or.cond1668 = and i1 %cmp1039.1, %cmp1043.1
  br i1 %or.cond1668, label %do.body1030.2, label %do.end1050
...
sw.default1071:                                   ; preds = %do.body
  %181 = load ptr, ptr @no_fpos, align 8
...
do.cond1074:                                      ; preds = %while.cond, %if.else397, %cleanup, %sw.bb69, %sw.bb71, %sw.bb72, %sw.default1071, %if.else, %if.then37, %if.then55, %sw.bb148, %sw.bb152, %sw.bb155, %sw.default, %if.end144, %if.else702, %if.then696, %if.then439
  ...
  br i1 %cmp1075, label %do.body, label %do.end1077
...
do.end1077:                                       ; preds = %do.cond1074, %for.end821, %for.end913, %for.end1017, %cond.end430, %for.end393, %for.end
  ...
  %182 = load ptr, ptr @startline, align 8
...
if.end1088:                                       ; preds = %if.then1083, %do.end1077
  store ptr %p.101317, ptr @chpt, align 8
  %ovspace = getelementptr inbounds i8, ptr %res.51314, i64 42
  store i8 %vcount.21315, ptr %ovspace, align 2
  %ohspace = getelementptr inbounds i8, ptr %res.51314, i64 41
  store i8 %hcount.11316, ptr %ohspace, align 1
  br label %cleanup1093
...
entry:
  %0 = load i32, ptr @blksize, align 4
  %cmp.not = icmp ne i32 %0, 0
  %.pre = load ptr, ptr @chpt, align 8
  %.pre55 = load ptr, ptr @limit, align 8
  %cmp1 = icmp ult ptr %.pre, %.pre55
  %or.cond62 = select i1 %cmp.not, i1 %cmp1, i1 false
  br i1 %or.cond62, label %if.then, label %if.end
...
while.end:                                        ; preds = %while.cond
  store ptr %col.0, ptr @frst, align 8
  store ptr %incdec.ptr54, ptr @limit, align 8
  store i32 0, ptr @blksize, align 4
  br label %if.end
...
if.end12:                                         ; preds = %if.then11, %if.then8
  %4 = load ptr, ptr @frst, align 8
  store ptr %4, ptr @chpt, align 8
  ...
  store i32 %conv14, ptr @blksize, align 4
...
if.end12.if.end20_crit_edge:                      ; preds = %if.end12
  ...
  %.pre58.pre = load ptr, ptr @buf, align 8
  br label %if.end20
...
if.then17:                                        ; preds = %if.end12
  ...
  store i8 %8, ptr @last_char, align 1
  br label %if.end20

if.end20:                                         ; preds = %if.end12.if.end20_crit_edge, %if.then17
  %.pre58 = phi ptr [ %.pre58.pre, %if.end12.if.end20_crit_edge ], [ %7, %if.then17 ]
...
if.then27:                                        ; preds = %if.end20
  ...
  store i32 %inc, ptr @blksize, align 4
  %idx.ext28 = sext i32 %inc to i64
  %add.ptr29 = getelementptr inbounds i8, ptr %.pre58, i64 %idx.ext28
  %add.ptr30 = getelementptr inbounds i8, ptr %add.ptr29, i64 -1
  store i8 10, ptr %add.ptr30, align 1
  store i8 10, ptr @last_char, align 1
  %10 = load i16, ptr @ftype, align 2
  %cmp32 = icmp eq i16 %10, 3
...
if.then34:                                        ; preds = %if.then27
  ...
  %.pre57 = load ptr, ptr @buf, align 8
  %.pre59 = load i32, ptr @blksize, align 4
  br label %if.end43

if.end43:                                         ; preds = %if.then27, %if.then34, %if.end20
  %11 = phi i32 [ %inc, %if.then27 ], [ %.pre59, %if.then34 ], [ %conv14, %if.end20 ]
  %12 = phi ptr [ %.pre58, %if.then27 ], [ %.pre57, %if.then34 ], [ %.pre58, %if.end20 ]
  store ptr %12, ptr @frst, align 8
  %idx.ext44 = sext i32 %11 to i64
  %add.ptr45 = getelementptr inbounds i8, ptr %12, i64 %idx.ext44
  store ptr %add.ptr45, ptr @limit, align 8
  store i8 10, ptr %add.ptr45, align 1
  %.pre60 = load ptr, ptr @chpt, align 8
  br label %if.end46

if.end46:                                         ; preds = %if.end43, %if.end
  %13 = phi ptr [ %add.ptr45, %if.end43 ], [ %3, %if.end ]
  %14 = phi ptr [ %.pre60, %if.end43 ], [ %.pre, %if.end ]
  %cmp47.not = icmp ult ptr %14, %13
  br i1 %cmp47.not, label %if.end50, label %if.then49

if.then49:                                        ; preds = %if.end46
  %15 = load ptr, ptr @buf, align 8
  store ptr %15, ptr @limit, align 8
  store ptr %15, ptr @chpt, align 8
...
if.end:                                           ; preds = %if.then, %entry
  %1 = load ptr, ptr @chpt, align 8
  store i32 0, ptr %bufftop, align 4
...
if.then5:                                         ; preds = %for.body
  %4 = load i32, ptr %bufftop, align 4
...
if.else:                                          ; preds = %if.then8
  %inc = add nsw i32 %4, 1
  store i32 %inc, ptr %bufftop, align 4
...
for.inc:                                          ; preds = %if.else24, %if.then16, %if.else, %if.then5
  ...
  br i1 %exitcond1000.not, label %for.end, label %for.body
...
if.then70:                                        ; preds = %for.body67
  %12 = load i32, ptr %bufftop, align 4
...
if.then73:                                        ; preds = %if.then70
  ...
  %14 = load i8, ptr %arrayidx77, align 1
...
for.inc98:                                        ; preds = %if.else92, %if.then81, %if.else84, %if.then70
  ...
  br i1 %exitcond995.not, label %if.end101.loopexit, label %for.body67

if.end101.loopexit:                               ; preds = %for.inc98
  %.pre1001 = load i8, ptr %p.0943, align 1
  br label %if.end101
...
if.end101:                                        ; preds = %if.end101.loopexit, %if.then59
  ...
  store i8 %16, ptr %arrayidx105, align 1
  br label %while.body.backedge
...
if.then120:                                       ; preds = %for.body117
  %17 = load i32, ptr %bufftop, align 4
...
if.then123:                                       ; preds = %if.then120
  ...
  %18 = load i8, ptr %arrayidx125, align 1
...
for.inc148:                                       ; preds = %if.else142, %if.then131, %if.else134, %if.then120
  ...
  br i1 %exitcond991.not, label %if.end151.loopexit, label %for.body117

if.end151.loopexit:                               ; preds = %for.inc148
  %.pre = load i8, ptr %p.0943, align 1
  br label %if.end151
...
if.end151:                                        ; preds = %if.end151.loopexit, %if.then109
  ...
  store i8 %21, ptr %arrayidx155, align 1
  br label %if.end156
...
if.end156:                                        ; preds = %if.end151, %sw.bb107
  ...
  %22 = load ptr, ptr @chpt, align 8
  %add.ptr166 = getelementptr inbounds i8, ptr %22, i64 -1
  store ptr %add.ptr166, ptr @startline, align 8
  br label %while.body.backedge
...
if.then189:                                       ; preds = %for.body186
  %23 = load i32, ptr %bufftop, align 4
...
if.then192:                                       ; preds = %if.then189
  ...
  %24 = load i8, ptr %arrayidx194, align 1
...
for.inc217:                                       ; preds = %if.else211, %if.then200, %if.else203, %if.then189
  ...
  br i1 %exitcond982.not, label %for.end219, label %for.body186
...
if.then267:                                       ; preds = %for.body264
  %31 = load i32, ptr %bufftop, align 4
...
for.inc295:                                       ; preds = %if.else289, %if.then278, %if.else281, %if.then267
  ...
  br i1 %exitcond977.not, label %for.end297, label %for.body264
...
if.then334:                                       ; preds = %for.body331
  %39 = load i32, ptr %bufftop, align 4
...
for.inc362:                                       ; preds = %if.else356, %if.then345, %if.else348, %if.then334
  ...
  br i1 %exitcond987.not, label %for.end364, label %for.body331
...
for.body619.us:                                   ; preds = %for.body619.lr.ph, %for.inc650.us
  ...
  %47 = load i32, ptr %bufftop, align 4
...
for.inc650.us:                                    ; preds = %if.then633.us, %if.else636.us, %for.body619.us
  ...
  br i1 %exitcond952.not, label %for.end652, label %for.body619.us
...
for.body553.us:                                   ; preds = %for.body553.lr.ph, %for.inc584.us
  ...
  %50 = load i32, ptr %bufftop, align 4
...
for.inc584.us:                                    ; preds = %if.then567.us, %if.else570.us, %for.body553.us
  ...
  br i1 %exitcond972.not, label %for.end586, label %for.body553.us
...
for.body417.us:                                   ; preds = %for.body417.lr.ph, %for.inc448.us
  ...
  %53 = load i32, ptr %bufftop, align 4
...
for.inc448.us:                                    ; preds = %if.then431.us, %if.else434.us, %for.body417.us
  ...
  br i1 %exitcond962.not, label %for.end450, label %for.body417.us
...
for.body417:                                      ; preds = %for.body417.lr.ph, %for.body417
  ...
  %56 = load i8, ptr %arrayidx444, align 1
  ...
  br i1 %exitcond957.not, label %for.end450, label %for.body417
...
if.end480:                                        ; preds = %if.end463, %if.then477
  ...
  store ptr %call465, ptr @zz_hold, align 8
  %60 = load i8, ptr %ou1466, align 8
  %.off898 = add i8 %60, -11
...
if.then525:                                       ; preds = %while.body522
  %64 = load i32, ptr %bufftop, align 4
...
if.then528:                                       ; preds = %if.then525
  ...
  %65 = load i8, ptr %arrayidx530, align 1
...
if.end546:                                        ; preds = %if.then525, %if.else537, %if.then534, %if.else544
  ...
  br i1 %cmp520.not, label %while.end, label %while.body522
...
for.body553:                                      ; preds = %for.body553.lr.ph, %for.body553
  ...
  %66 = load i8, ptr %arrayidx580, align 1
  ...
  br i1 %exitcond967.not, label %for.end586, label %for.body553
...
for.body619:                                      ; preds = %for.body619.lr.ph, %for.body619
  ...
  %71 = load i8, ptr %arrayidx646, align 1
  ...
  br i1 %exitcond.not, label %for.end652, label %for.body619
...
if.then688:                                       ; preds = %while.end685
  %77 = load i32, ptr %bufftop, align 4
...
if.end706:                                        ; preds = %if.then688, %if.then695, %if.else704
  ...
  %79 = load ptr, ptr @startline, align 8
...
if.end714:                                        ; preds = %if.then709, %if.end706
  store ptr %p.0943, ptr @chpt, align 8
...
entry:
  %0 = load i32, ptr %bufftop, align 4
  %sub = add i32 %0, 68
  %1 = ashr i32 %sub, 3
...
for.body:                                         ; preds = %if.end18, %for.body
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %9 = load i32, ptr %bufftop, align 4
...
if.else54:                                        ; preds = %for.end
  ...
  %12 = load i8, ptr %ou155, align 8
  %cmp58 = icmp eq i8 %12, 11
  br i1 %cmp58, label %if.then60, label %if.end223

if.then60:                                        ; preds = %if.else54
  %13 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 19), align 1
  %conv61 = zext i8 %13 to i32
  store i32 %conv61, ptr @zz_size, align 4
...
if.then72:                                        ; preds = %if.then60
  ...
  store ptr %call73, ptr @zz_hold, align 8
  br label %if.end83

if.else74:                                        ; preds = %if.then60
  store ptr %14, ptr @zz_hold, align 8
  %16 = load ptr, ptr %14, align 8
  store ptr %16, ptr %arrayidx69, align 8
  br label %if.end83
...
if.end83:                                         ; preds = %if.then72, %if.else74
  ...
  store ptr %17, ptr %arrayidx90, align 8
...
cond.end187:                                      ; preds = %if.then134, %if.else136
  ...
  store ptr %23, ptr %osucc156, align 8
  store ptr %23, ptr %23, align 8
  store ptr %23, ptr @xx_link, align 8
  ...
  store ptr %26, ptr %osucc180, align 8
  ...
  store ptr %30, ptr %osucc186, align 8
  %32 = load ptr, ptr @xx_link, align 8
  store ptr %32, ptr @zz_res, align 8
  store ptr %current, ptr @zz_hold, align 8
...
if.end223:                                        ; preds = %if.else54, %cond.end187, %cond.false196
  ...
  %37 = load ptr, ptr %arrayidx232, align 8
...
if.else237:                                       ; preds = %if.end223
  ...
  store ptr %39, ptr %arrayidx232, align 8
  br label %if.end246
...
if.end246:                                        ; preds = %if.then235, %if.else237
  ...
  store ptr %40, ptr %osucc251, align 8
  store ptr %40, ptr %arrayidx250, align 8
  %osucc257 = getelementptr inbounds %struct.LIST, ptr %40, i64 0, i32 1
  store ptr %40, ptr %osucc257, align 8
  ...
  %41 = load i16, ptr getelementptr inbounds (%struct.FILE_POS, ptr @file_pos, i64 0, i32 2), align 2
  %ofile_num269 = getelementptr inbounds %struct.word_type, ptr %40, i64 0, i32 1, i32 0, i32 2
  store i16 %41, ptr %ofile_num269, align 2
  ...
  %42 = load i8, ptr @zz_lengths, align 1
  ...
  %43 = load ptr, ptr %arrayidx296, align 8
...
if.else301:                                       ; preds = %if.end246
  ...
  store ptr %45, ptr %arrayidx296, align 8
  br label %cond.end356
...
cond.end356:                                      ; preds = %if.then299, %if.else301
  ...
  store ptr %49, ptr %osucc347, align 8
  ...
  store ptr %53, ptr %osucc353, align 8
  %55 = load ptr, ptr @xx_link, align 8
...
cond.false365:                                    ; preds = %cond.end356
  ...
  %56 = load ptr, ptr %arrayidx367, align 8
  store ptr %56, ptr @zz_tmp, align 8
  %arrayidx370 = getelementptr inbounds [2 x %struct.LIST], ptr %55, i64 0, i64 1
  %57 = load ptr, ptr %arrayidx370, align 8
  store ptr %57, ptr %arrayidx367, align 8
...
cond.end389:                                      ; preds = %cond.end356, %cond.false365
  ...
  %60 = load ptr, ptr %arrayidx399, align 8
...
if.else404:                                       ; preds = %cond.end389
  ...
  store ptr %62, ptr %arrayidx399, align 8
  br label %cond.end459
...
cond.end459:                                      ; preds = %if.then402, %if.else404
  ...
  %64 = load ptr, ptr %res.0, align 8
  store ptr %64, ptr @zz_tmp, align 8
  %65 = load ptr, ptr %63, align 8
  store ptr %65, ptr %res.0, align 8
  ...
  store ptr %66, ptr %osucc450, align 8
  ...
  store ptr %70, ptr %osucc456, align 8
  %72 = load ptr, ptr @xx_link, align 8
...
if.else507:                                       ; preds = %cond.end492
  ...
  store ptr %79, ptr %arrayidx502, align 8
  br label %cond.end562
...
cond.end562:                                      ; preds = %if.then505, %if.else507
  ...
  store ptr %83, ptr %osucc553, align 8
  ...
  store ptr %87, ptr %osucc559, align 8
