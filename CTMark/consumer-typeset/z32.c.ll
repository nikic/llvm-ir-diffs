...
for.inc38:                                        ; preds = %land.rhs21
  ...
  br i1 %cmp19, label %land.rhs21, label %for.end40.loopexit, !llvm.loop !10
...
cond.false158:                                    ; preds = %if.end71
  store ptr %12, ptr @zz_res, align 8, !tbaa !13
  %arrayidx135 = getelementptr inbounds [2 x %struct.LIST], ptr %x, i64 0, i64 1
  %13 = load ptr, ptr %arrayidx135, align 8, !tbaa !5
  %arrayidx137 = getelementptr inbounds [2 x %struct.LIST], ptr %12, i64 0, i64 1
  store ptr %13, ptr %arrayidx137, align 8, !tbaa !5
  %14 = load ptr, ptr %arrayidx135, align 8, !tbaa !5
  %osucc144 = getelementptr inbounds [2 x %struct.LIST], ptr %14, i64 0, i64 1, i32 1
  store ptr %12, ptr %osucc144, align 8, !tbaa !5
  store ptr %x, ptr %osucc, align 8, !tbaa !5
  store ptr %x, ptr %arrayidx135, align 8, !tbaa !5
  store ptr %12, ptr @xx_tmp, align 8, !tbaa !13
  %15 = load ptr, ptr %arrayidx137, align 8, !tbaa !5
  store ptr %15, ptr @zz_tmp, align 8, !tbaa !13
  %arrayidx163 = getelementptr inbounds [2 x %struct.LIST], ptr %call77, i64 0, i64 1
  %16 = load ptr, ptr %arrayidx163, align 8, !tbaa !5
  store ptr %16, ptr %arrayidx137, align 8, !tbaa !5
  %17 = load ptr, ptr %arrayidx163, align 8, !tbaa !5
  %osucc173 = getelementptr inbounds [2 x %struct.LIST], ptr %17, i64 0, i64 1, i32 1
  store ptr %12, ptr %osucc173, align 8, !tbaa !5
  store ptr %15, ptr %arrayidx163, align 8, !tbaa !5
...
cond.end182:                                      ; preds = %cond.end.thread, %cond.false158
  ...
  %18 = load ptr, ptr %osucc186, align 8, !tbaa !5
...
cond.end212:                                      ; preds = %cond.end182
  store ptr %18, ptr @zz_res, align 8, !tbaa !13
  %19 = load ptr, ptr %x, align 8, !tbaa !5
  store ptr %19, ptr %18, align 8, !tbaa !5
  %20 = load ptr, ptr @zz_res, align 8, !tbaa !13
  %21 = load ptr, ptr @zz_hold, align 8, !tbaa !13
  %22 = load ptr, ptr %21, align 8, !tbaa !5
  %osucc205 = getelementptr inbounds %struct.LIST, ptr %22, i64 0, i32 1
  store ptr %20, ptr %osucc205, align 8, !tbaa !5
  %osucc208 = getelementptr inbounds %struct.LIST, ptr %21, i64 0, i32 1
  store ptr %21, ptr %osucc208, align 8, !tbaa !5
  store ptr %21, ptr %21, align 8, !tbaa !5
  %23 = load ptr, ptr @zz_res, align 8, !tbaa !13
  %.pre = load ptr, ptr @xx_res, align 8, !tbaa !13
  store ptr %23, ptr @xx_tmp, align 8, !tbaa !13
...
cond.false221:                                    ; preds = %cond.end212
  ...
  %25 = load ptr, ptr %.pre, align 8, !tbaa !5
  ...
  store ptr %26, ptr %osucc236, align 8, !tbaa !5
  ...
  store ptr %30, ptr %osucc242, align 8, !tbaa !5
  br label %cond.end245

cond.end245:                                      ; preds = %cond.end212.thread, %cond.end212, %cond.false221
  %32 = load ptr, ptr @xx_hold, align 8, !tbaa !13
  store ptr %32, ptr @zz_hold, align 8, !tbaa !13
  %ou1247 = getelementptr inbounds %struct.word_type, ptr %32, i64 0, i32 1
  %33 = load i8, ptr %ou1247, align 8, !tbaa !5
  %.off = add i8 %33, -11
  ...
  %34 = load ptr, ptr %arrayidx269, align 8, !tbaa !13
  store ptr %34, ptr %32, align 8, !tbaa !5
  %35 = load ptr, ptr @zz_hold, align 8, !tbaa !13
  %36 = load i32, ptr @zz_size, align 4, !tbaa !11
  %idxprom273 = sext i32 %36 to i64
  %arrayidx274 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom273
  store ptr %35, ptr %arrayidx274, align 8, !tbaa !13
...
for.cond283:                                      ; preds = %for.cond283, %sw.bb276
  ...
  %38 = load i8, ptr %ou1284, align 8, !tbaa !5
...
sw.bb296:                                         ; preds = %entry, %entry, %entry, %entry, %entry
  %39 = load ptr, ptr %x, align 8, !tbaa !5
...
while.cond.outer.split:                           ; preds = %sw.bb296, %if.end338
  ...
  %40 = load i32, ptr %done, align 4, !tbaa !11
...
for.cond308:                                      ; preds = %while.cond.outer.split, %for.cond308.backedge
  ...
  %41 = load i8, ptr %ou1309, align 8, !tbaa !5
...
sw.default:                                       ; preds = %entry
  ...
  %45 = load ptr, ptr @no_fpos, align 8, !tbaa !13
