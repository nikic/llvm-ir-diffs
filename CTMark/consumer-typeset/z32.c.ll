; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z32.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z32.c"
...
land.rhs:                                         ; preds = %for.cond
  ...
  br i1 %spec.select, label %if.end, label %for.cond
...
land.rhs21:                                       ; preds = %land.rhs21.preheader, %for.inc38
  ...
  br i1 %or.cond, label %for.inc38, label %for.end40.loopexit

for.inc38:                                        ; preds = %land.rhs21
  %dec39 = add nsw i32 %l.0416, -1
  %cmp19 = icmp sgt i32 %l.0416, 0
  br i1 %cmp19, label %land.rhs21, label %for.end40.loopexit

for.end40.loopexit:                               ; preds = %for.inc38, %land.rhs21
  %l.0.lcssa.ph = phi i32 [ %l.0416, %land.rhs21 ], [ -1, %for.inc38 ]
  %8 = add nsw i32 %l.0.lcssa.ph, 1
  %9 = zext i32 %8 to i64
  br label %for.end40

for.end40:                                        ; preds = %for.end40.loopexit, %if.end
  %l.0.lcssa = phi i64 [ 0, %if.end ], [ %9, %for.end40.loopexit ]
  %arrayidx43 = getelementptr inbounds %struct.word_type, ptr %x, i64 0, i32 4, i64 %l.0.lcssa
...
if.end71:                                         ; preds = %if.then67, %for.end40
  ...
  store ptr %call77, ptr @xx_res, align 8
...
cond.false158:                                    ; preds = %if.end71
  ...
  %13 = load ptr, ptr %arrayidx135, align 8
  %arrayidx137 = getelementptr inbounds [2 x %struct.LIST], ptr %12, i64 0, i64 1
  store ptr %13, ptr %arrayidx137, align 8
  %14 = load ptr, ptr %arrayidx135, align 8
  %osucc144 = getelementptr inbounds [2 x %struct.LIST], ptr %14, i64 0, i64 1, i32 1
  store ptr %12, ptr %osucc144, align 8
  store ptr %x, ptr %osucc, align 8
  store ptr %x, ptr %arrayidx135, align 8
  store ptr %12, ptr @xx_tmp, align 8
  %15 = load ptr, ptr %arrayidx137, align 8
  store ptr %15, ptr @zz_tmp, align 8
  %arrayidx163 = getelementptr inbounds [2 x %struct.LIST], ptr %call77, i64 0, i64 1
  %16 = load ptr, ptr %arrayidx163, align 8
  store ptr %16, ptr %arrayidx137, align 8
  %17 = load ptr, ptr %arrayidx163, align 8
  %osucc173 = getelementptr inbounds [2 x %struct.LIST], ptr %17, i64 0, i64 1, i32 1
  store ptr %12, ptr %osucc173, align 8
  store ptr %15, ptr %arrayidx163, align 8
  %osucc179 = getelementptr inbounds [2 x %struct.LIST], ptr %15, i64 0, i64 1, i32 1
  store ptr %call77, ptr %osucc179, align 8
  br label %cond.end182
...
cond.end212:                                      ; preds = %cond.end182
  ...
  %osucc205 = getelementptr inbounds %struct.LIST, ptr %22, i64 0, i32 1
  store ptr %20, ptr %osucc205, align 8
  %osucc208 = getelementptr inbounds %struct.LIST, ptr %21, i64 0, i32 1
  store ptr %21, ptr %osucc208, align 8
  store ptr %21, ptr %21, align 8
  %23 = load ptr, ptr @zz_res, align 8
  %.pre = load ptr, ptr @xx_res, align 8
  store ptr %23, ptr @xx_tmp, align 8
  store ptr %.pre, ptr @zz_res, align 8
  store ptr %23, ptr @zz_hold, align 8
  %cmp214 = icmp eq ptr %23, null
...
cond.false221:                                    ; preds = %cond.end212
  ...
  %osucc236 = getelementptr inbounds %struct.LIST, ptr %28, i64 0, i32 1
  store ptr %26, ptr %osucc236, align 8
  %29 = load ptr, ptr @zz_tmp, align 8
  store ptr %29, ptr %27, align 8
  %30 = load ptr, ptr @zz_res, align 8
  %31 = load ptr, ptr @zz_tmp, align 8
  %osucc242 = getelementptr inbounds %struct.LIST, ptr %31, i64 0, i32 1
  store ptr %30, ptr %osucc242, align 8
  br label %cond.end245

cond.end245:                                      ; preds = %cond.end212.thread, %cond.end212, %cond.false221
  %32 = load ptr, ptr @xx_hold, align 8
  store ptr %32, ptr @zz_hold, align 8
  %ou1247 = getelementptr inbounds %struct.word_type, ptr %32, i64 0, i32 1
  %33 = load i8, ptr %ou1247, align 8
  %.off = add i8 %33, -11
  %switch = icmp ult i8 %.off, 2
  %orec_size = getelementptr inbounds %struct.word_type, ptr %32, i64 0, i32 1, i32 0, i32 1
  %idxprom263 = zext i8 %33 to i64
...
for.cond283:                                      ; preds = %for.cond283, %sw.bb276
  %.pn = phi ptr [ %37, %sw.bb276 ], [ %y.0, %for.cond283 ]
  ...
  %38 = load i8, ptr %ou1284, align 8
  %cmp287 = icmp eq i8 %38, 0
  br i1 %cmp287, label %for.cond283, label %for.end294
...
for.cond308:                                      ; preds = %while.cond.outer.split, %for.cond308.backedge
  ...
  %41 = load i8, ptr %ou1309, align 8
  %cmp312 = icmp eq i8 %41, 0
...
if.end331:                                        ; preds = %for.end319
  ...
  %tobool333.not = icmp eq i32 %43, 0
  br i1 %tobool333.not, label %if.then334, label %if.end338

if.then334:                                       ; preds = %if.end331
  %44 = load ptr, ptr %link.0.ph433, align 8
  br label %if.end338

if.end338:                                        ; preds = %if.then334, %if.end331
  %link.1 = phi ptr [ %link.0.ph433, %if.end331 ], [ %44, %if.then334 ]
  %cmp300.not = icmp eq ptr %link.1, %x
  br i1 %cmp300.not, label %sw.epilog, label %while.cond.outer.split

sw.default:                                       ; preds = %entry
  %conv = zext i8 %0 to i32
  %45 = load ptr, ptr @no_fpos, align 8
  %call342 = tail call ptr @Image(i32 noundef %conv) #6
  %call343 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 3, ptr noundef nonnull @.str.2, i32 noundef 0, ptr noundef %45, ptr noundef nonnull @.str.3, ptr noundef %call342) #6
  br label %sw.epilog
