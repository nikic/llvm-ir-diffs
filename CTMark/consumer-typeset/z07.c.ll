...
if.end.i1855:                                     ; preds = %for.cond83
  ...
  %14 = load ptr, ptr %osucc.i1856, align 8, !tbaa !5
...
for.cond.i1857:                                   ; preds = %for.cond.i1857, %if.end.i1855
  ...
  %y1.0.i1860 = load ptr, ptr %y1.0.in.i1859, align 8, !tbaa !5
  %ou14.i1861 = getelementptr inbounds %struct.word_type, ptr %y1.0.i1860, i64 0, i32 1
  %15 = load i8, ptr %ou14.i1861, align 8, !tbaa !5
  %cmp7.i1862 = icmp eq i8 %15, 0
  br i1 %cmp7.i1862, label %for.cond.i1857, label %for.end.i1863, !llvm.loop !10
...
for.cond18.i1864:                                 ; preds = %for.cond18.i1864, %for.end.i1863
  ...
  %y2.0.i1867 = load ptr, ptr %y2.0.in.i1866, align 8, !tbaa !5
  %ou119.i1868 = getelementptr inbounds %struct.word_type, ptr %y2.0.i1867, i64 0, i32 1
  %17 = load i8, ptr %ou119.i1868, align 8, !tbaa !5
  %cmp22.i1869 = icmp eq i8 %17, 0
  br i1 %cmp22.i1869, label %for.cond18.i1864, label %SplitIsDefinite.exit1873, !llvm.loop !12
...
if.end.i1878:                                     ; preds = %for.cond160
  ...
  %25 = load ptr, ptr %osucc.i1879, align 8, !tbaa !5
...
for.cond.i1880:                                   ; preds = %for.cond.i1880, %if.end.i1878
  ...
  %y1.0.i1883 = load ptr, ptr %y1.0.in.i1882, align 8, !tbaa !5
  %ou14.i1884 = getelementptr inbounds %struct.word_type, ptr %y1.0.i1883, i64 0, i32 1
  %26 = load i8, ptr %ou14.i1884, align 8, !tbaa !5
  %cmp7.i1885 = icmp eq i8 %26, 0
  br i1 %cmp7.i1885, label %for.cond.i1880, label %for.end.i1886, !llvm.loop !10
...
for.cond18.i1887:                                 ; preds = %for.cond18.i1887, %for.end.i1886
  ...
  %y2.0.i1890 = load ptr, ptr %y2.0.in.i1889, align 8, !tbaa !5
  %ou119.i1891 = getelementptr inbounds %struct.word_type, ptr %y2.0.i1890, i64 0, i32 1
  %28 = load i8, ptr %ou119.i1891, align 8, !tbaa !5
  %cmp22.i1892 = icmp eq i8 %28, 0
  br i1 %cmp22.i1892, label %for.cond18.i1887, label %SplitIsDefinite.exit1896, !llvm.loop !12
...
if.end.i1901:                                     ; preds = %for.cond244
  ...
  %34 = load ptr, ptr %osucc.i1902, align 8, !tbaa !5
...
for.cond.i1903:                                   ; preds = %for.cond.i1903, %if.end.i1901
  ...
  %y1.0.i1906 = load ptr, ptr %y1.0.in.i1905, align 8, !tbaa !5
  %ou14.i1907 = getelementptr inbounds %struct.word_type, ptr %y1.0.i1906, i64 0, i32 1
  %35 = load i8, ptr %ou14.i1907, align 8, !tbaa !5
  %cmp7.i1908 = icmp eq i8 %35, 0
  br i1 %cmp7.i1908, label %for.cond.i1903, label %for.end.i1909, !llvm.loop !10
...
for.cond18.i1910:                                 ; preds = %for.cond18.i1910, %for.end.i1909
  ...
  %y2.0.i1913 = load ptr, ptr %y2.0.in.i1912, align 8, !tbaa !5
  %ou119.i1914 = getelementptr inbounds %struct.word_type, ptr %y2.0.i1913, i64 0, i32 1
  %37 = load i8, ptr %ou119.i1914, align 8, !tbaa !5
  %cmp22.i1915 = icmp eq i8 %37, 0
  br i1 %cmp22.i1915, label %for.cond18.i1910, label %SplitIsDefinite.exit1919, !llvm.loop !12
