; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z29.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z29.c"
...
entry:
  store i32 0, ptr @scope_top, align 4
  store i1 false, ptr @suppress_scope, align 4
  store i32 0, ptr @suppress_visible, align 4
  br label %for.body
...
for.body:                                         ; preds = %for.body.1, %entry
  ...
  store ptr %arrayidx, ptr %f2, align 8
  store ptr %arrayidx, ptr %arrayidx, align 16
...
for.body.1:                                       ; preds = %for.body
  ...
  store ptr %arrayidx.1, ptr %f2.1, align 8
  store ptr %arrayidx.1, ptr %arrayidx.1, align 16
...
if.end:                                           ; preds = %if.then, %entry
  %1 = load i32, ptr @scope_top, align 4
...
if.then2:                                         ; preds = %if.end
  ...
  %.pre = load i32, ptr @scope_top, align 4
  br label %if.end4
...
entry:
  %0 = load i32, ptr @scope_top, align 4
...
if.end4:                                          ; preds = %if.then2, %if.end
  %3 = load i32, ptr @scope_top, align 4
  %dec = add nsw i32 %3, -1
  store i32 %dec, ptr @scope_top, align 4
  ret void
}
...
entry:
  store i32 1, ptr @suppress_visible, align 4
  ret void
}
...
entry:
  ...
  %0 = load ptr, ptr @StartSym, align 8
...
if.end.i:                                         ; preds = %if.then.i, %if.then
  %2 = load i32, ptr @scope_top, align 4
...
if.then2.i:                                       ; preds = %if.end.i
  ...
  %.pre.i = load i32, ptr @scope_top, align 4
...
PushScope.exit:                                   ; preds = %if.end.i, %if.then2.i
  ...
  store i32 %inc.i, ptr @scope_top, align 4
  br label %if.end
...
while.body:                                       ; preds = %while.cond.preheader, %while.body
  ...
  %6 = load ptr, ptr %oenclosing, align 8
  ...
  br i1 %cmp1.not, label %while.cond3.preheader, label %while.body
...
while.body5:                                      ; preds = %while.body5.preheader, %PushScope.exit29
  ...
  br i1 %.b.i14, label %if.then.i27, label %if.end.i15

if.then.i27:                                      ; preds = %while.body5
  %8 = load ptr, ptr @no_fpos, align 8
  %call.i28 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %8, ptr noundef nonnull @.str.1) #13
  br label %if.end.i15

if.end.i15:                                       ; preds = %if.then.i27, %while.body5
  %9 = load i32, ptr @scope_top, align 4
  %cmp1.i16 = icmp sgt i32 %9, 299
  br i1 %cmp1.i16, label %if.then2.i23, label %PushScope.exit29

if.then2.i23:                                     ; preds = %if.end.i15
  %ou1.i24 = getelementptr inbounds %struct.word_type, ptr %7, i64 0, i32 1
  %call3.i25 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 29, i32 noundef 2, ptr noundef nonnull @.str.2, i32 noundef 0, ptr noundef nonnull %ou1.i24) #13
  %.pre.i26 = load i32, ptr @scope_top, align 4
  br label %PushScope.exit29

PushScope.exit29:                                 ; preds = %if.end.i15, %if.then2.i23
  %10 = phi i32 [ %.pre.i26, %if.then2.i23 ], [ %9, %if.end.i15 ]
  %idxprom.i17 = sext i32 %10 to i64
  %arrayidx.i18 = getelementptr inbounds [300 x ptr], ptr @scope, i64 0, i64 %idxprom.i17
  store ptr %7, ptr %arrayidx.i18, align 8
  %arrayidx6.i19 = getelementptr inbounds [300 x i32], ptr @npars_only, i64 0, i64 %idxprom.i17
  store i32 0, ptr %arrayidx6.i19, align 4
  %arrayidx8.i20 = getelementptr inbounds [300 x i32], ptr @vis_only, i64 0, i64 %idxprom.i17
  store i32 0, ptr %arrayidx8.i20, align 4
  %arrayidx10.i21 = getelementptr inbounds [300 x i32], ptr @body_ok, i64 0, i64 %idxprom.i17
  store i32 0, ptr %arrayidx10.i21, align 4
  %inc.i22 = add nsw i32 %10, 1
  store i32 %inc.i22, ptr @scope_top, align 4
  %cmp4 = icmp ugt i64 %indvars.iv36, 1
  br i1 %cmp4, label %while.body5, label %if.end
...
PopScope.exit:                                    ; preds = %if.end.i, %if.then2.i
  %4 = load i32, ptr @scope_top, align 4
  %dec.i = add nsw i32 %4, -1
  store i32 %dec.i, ptr @scope_top, align 4
  br label %if.end

while.body:                                       ; preds = %while.body.preheader, %PopScope.exit12
  %5 = phi i32 [ %dec.i9, %PopScope.exit12 ], [ %.pre, %while.body.preheader ]
  %sym.addr.014 = phi ptr [ %9, %PopScope.exit12 ], [ %sym, %while.body.preheader ]
  %cmp.i4 = icmp sgt i32 %5, 0
  br i1 %cmp.i4, label %if.end.i7, label %if.then.i5

if.then.i5:                                       ; preds = %while.body
  %6 = load ptr, ptr @no_fpos, align 8
  %call.i6 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %6, ptr noundef nonnull @.str.3) #13
  br label %if.end.i7

if.end.i7:                                        ; preds = %if.then.i5, %while.body
  %.b.i8 = load i1, ptr @suppress_scope, align 4
  br i1 %.b.i8, label %if.then2.i10, label %PopScope.exit12

if.then2.i10:                                     ; preds = %if.end.i7
  %7 = load ptr, ptr @no_fpos, align 8
  %call3.i11 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %7, ptr noundef nonnull @.str.4) #13
  br label %PopScope.exit12

PopScope.exit12:                                  ; preds = %if.end.i7, %if.then2.i10
  %8 = load i32, ptr @scope_top, align 4
  %dec.i9 = add nsw i32 %8, -1
  store i32 %dec.i9, ptr @scope_top, align 4
  %oenclosing = getelementptr inbounds %struct.symbol_type, ptr %sym.addr.014, i64 0, i32 3
  %9 = load ptr, ptr %oenclosing, align 8
  %10 = load ptr, ptr @StartSym, align 8
  %cmp1.not = icmp eq ptr %9, %10
  br i1 %cmp1.not, label %if.end, label %while.body
...
if.end13:                                         ; preds = %if.then5, %if.else7
  ...
  %5 = load i32, ptr @scope_top, align 4
  ...
  %6 = load ptr, ptr %arrayidx26315, align 8
  %7 = load ptr, ptr @StartSym, align 8
...
for.body:                                         ; preds = %if.end13, %cond.end268
  ...
  %8 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 149), align 1
  %conv29 = zext i8 %8 to i32
  store i32 %conv29, ptr @zz_size, align 4
...
if.then40:                                        ; preds = %for.body
  ...
  store ptr %call41, ptr @zz_hold, align 8
  br label %if.end51
...
if.end51:                                         ; preds = %if.then40, %if.else42
  ...
  store i8 -107, ptr %ou152, align 8
...
if.else79:                                        ; preds = %if.end51
  ...
  store ptr %16, ptr %arrayidx74, align 8
  br label %cond.end130
...
if.else178:                                       ; preds = %cond.end163
  ...
  store ptr %33, ptr %arrayidx173, align 8
  br label %cond.end233
...
cond.end233:                                      ; preds = %if.then176, %if.else178
  ...
  store ptr %37, ptr %osucc224, align 8
  ...
  store ptr %41, ptr %osucc230, align 8
  %43 = load ptr, ptr @xx_link, align 8
  store ptr %43, ptr @zz_res, align 8
  %44 = load ptr, ptr %arrayidx26319, align 8
...
cond.end268:                                      ; preds = %cond.end233, %cond.false244
  ...
  %48 = load i32, ptr %arrayidx271, align 4
  ...
  %50 = load i32, ptr %arrayidx280, align 4
...
if.end:                                           ; preds = %if.then, %entry
  %2 = load ptr, ptr @StartSym, align 8
  %.b.i = load i1, ptr @suppress_scope, align 4
  br i1 %.b.i, label %if.then.i, label %if.end.i
...
PushScope.exit:                                   ; preds = %if.end.i, %if.then2.i
  ...
  store i32 %inc.i, ptr @scope_top, align 4
  %link.095 = load ptr, ptr %ss, align 8
...
for.cond30:                                       ; preds = %for.cond30, %if.end24
  ...
  %sym.0 = load ptr, ptr %sym.0.in, align 8
  %ou131 = getelementptr inbounds %struct.word_type, ptr %sym.0, i64 0, i32 1
  %9 = load i8, ptr %ou131, align 8
  %cmp34 = icmp eq i8 %9, 0
  br i1 %cmp34, label %for.cond30, label %for.end41
...
for.end41:                                        ; preds = %for.cond30
  ...
  br i1 %.b.i76, label %if.then.i89, label %if.end.i77

if.then.i89:                                      ; preds = %for.end41
  %10 = load ptr, ptr @no_fpos, align 8
  %call.i90 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %10, ptr noundef nonnull @.str.1) #13
  br label %if.end.i77

if.end.i77:                                       ; preds = %if.then.i89, %for.end41
  %11 = load i32, ptr @scope_top, align 4
  %cmp1.i78 = icmp sgt i32 %11, 299
  br i1 %cmp1.i78, label %if.then2.i85, label %PushScope.exit91

if.then2.i85:                                     ; preds = %if.end.i77
  %call3.i87 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 29, i32 noundef 2, ptr noundef nonnull @.str.2, i32 noundef 0, ptr noundef nonnull %ou131.le) #13
  %.pre.i88 = load i32, ptr @scope_top, align 4
  br label %PushScope.exit91

PushScope.exit91:                                 ; preds = %if.end.i77, %if.then2.i85
  %12 = phi i32 [ %.pre.i88, %if.then2.i85 ], [ %11, %if.end.i77 ]
  %idxprom.i79 = sext i32 %12 to i64
  %arrayidx.i80 = getelementptr inbounds [300 x ptr], ptr @scope, i64 0, i64 %idxprom.i79
  store ptr %sym.0, ptr %arrayidx.i80, align 8
  %arrayidx6.i81 = getelementptr inbounds [300 x i32], ptr @npars_only, i64 0, i64 %idxprom.i79
  store i32 %bf.clear, ptr %arrayidx6.i81, align 4
  %arrayidx8.i82 = getelementptr inbounds [300 x i32], ptr @vis_only, i64 0, i64 %idxprom.i79
  store i32 %bf.clear44, ptr %arrayidx8.i82, align 4
  %arrayidx10.i83 = getelementptr inbounds [300 x i32], ptr @body_ok, i64 0, i64 %idxprom.i79
  store i32 0, ptr %arrayidx10.i83, align 4
  %inc.i84 = add nsw i32 %12, 1
  store i32 %inc.i84, ptr @scope_top, align 4
  %bf.load46 = load i32, ptr %ou2, align 8
  %bf.lshr47 = lshr i32 %bf.load46, 22
  %bf.clear48 = and i32 %bf.lshr47, 1
  store i32 %bf.clear48, ptr %arrayidx10.i83, align 4
  %link.0 = load ptr, ptr %link.097, align 8
  %cmp2.not = icmp eq ptr %link.0, %ss
  br i1 %cmp2.not, label %for.end54, label %for.cond7.preheader

for.end54:                                        ; preds = %PushScope.exit91, %PushScope.exit
  %13 = load i32, ptr @suppress_visible, align 4
  ...
  store i32 %bf.clear58, ptr @suppress_visible, align 4
...
entry:
  %0 = load ptr, ptr @StartSym, align 8
  %scope_top.promoted = load i32, ptr @scope_top, align 4
...
if.end20:                                         ; preds = %if.then11, %if.else13
  ...
  store i16 %5, ptr %ofile_num33, align 2
  ...
  store i8 %xprecedence, ptr %ou2, align 8
  ...
  store i16 %conv70, ptr %opredefined, align 8
  %oenclosing = getelementptr inbounds %struct.symbol_type, ptr %4, i64 0, i32 3
  store ptr %xenclosing, ptr %oenclosing, align 8
  %osym_body = getelementptr inbounds %struct.symbol_type, ptr %4, i64 0, i32 4
  store ptr %xbody, ptr %osym_body, align 8
  %obase_uses = getelementptr inbounds %struct.symbol_type, ptr %4, i64 0, i32 5
  %op.rdx1394 = or i24 %bf.shl60, %bf.shl66
  %op.rdx = or i24 %bf.set55, %op.rdx1394
  %op.rdx1395 = or i24 %op.rdx, 2097168
  ...
  store i16 0, ptr %ohas_compulsory, align 2
  ...
  store i8 0, ptr %ouses_count, align 4
  store i24 %op.rdx1395, ptr %ohas_body, align 1
...
if.then107:                                       ; preds = %land.lhs.true
  ...
  %.pre = load i8, ptr %ou1, align 8
  br label %if.end119

if.end119:                                        ; preds = %if.then107, %land.lhs.true, %if.end20
  %9 = phi i8 [ %.pre, %if.then107 ], [ %xtype, %land.lhs.true ], [ %xtype, %if.end20 ]
  %bf.load121 = phi i24 [ %bf.set118, %if.then107 ], [ %op.rdx1395, %land.lhs.true ], [ %op.rdx1395, %if.end20 ]
...
if.end150:                                        ; preds = %if.end119
  %11 = load ptr, ptr %oenclosing, align 8
...
if.then169:                                       ; preds = %if.end163
  ...
  %.pr1347.pre = load i8, ptr %ou1, align 8
  br label %if.end176

if.end176:                                        ; preds = %if.then169, %if.end163
  %.pr1347 = phi i8 [ %.pr1347.pre, %if.then169 ], [ %13, %if.end163 ]
  %cmp180 = icmp eq i8 %.pr1347, -111
  br i1 %cmp180, label %if.then182, label %if.end233

if.then182:                                       ; preds = %if.end176
  %15 = load ptr, ptr %oenclosing, align 8
...
for.cond:                                         ; preds = %if.then182, %for.cond
  %.pn = phi ptr [ %tmp.0, %for.cond ], [ %16, %if.then182 ]
...
if.then211:                                       ; preds = %for.cond
  ...
  %18 = load i8, ptr %onpar_code, align 1
...
if.end233.sink.split:                             ; preds = %for.cond, %if.then182, %if.then211, %if.then211, %if.else221
  ...
  store i8 %.sink, ptr %onpar_code231, align 1
  br label %if.end233
...
if.else250:                                       ; preds = %if.end233
  %19 = load ptr, ptr %oenclosing, align 8
  ...
  %20 = load ptr, ptr %oenclosing, align 8
...
if.end331:                                        ; preds = %for.cond299, %land.lhs.true271, %if.then316, %if.else250, %if.then283, %if.then245
  ...
  %29 = load ptr, ptr %oenclosing, align 8
...
if.then381:                                       ; preds = %if.then377
  ...
  %31 = load ptr, ptr %oenclosing, align 8
...
if.then403:                                       ; preds = %if.end399
  %32 = load ptr, ptr %oenclosing, align 8
...
if.then417:                                       ; preds = %if.end413
  %33 = load ptr, ptr %oenclosing, align 8
  ...
  %34 = load ptr, ptr %oenclosing, align 8
  ...
  %35 = load ptr, ptr %oenclosing, align 8
  %link.0.in1352 = getelementptr inbounds %struct.LIST, ptr %35, i64 0, i32 1
  %link.01353 = load ptr, ptr %link.0.in1352, align 8
  %cmp441.not1354 = icmp eq ptr %link.01353, %35
  br i1 %cmp441.not1354, label %if.end530, label %for.cond447.preheader

for.cond447.preheader:                            ; preds = %if.then417, %for.inc525
  %36 = phi ptr [ %46, %for.inc525 ], [ %35, %if.then417 ]
  %link.01355 = phi ptr [ %link.0, %for.inc525 ], [ %link.01353, %if.then417 ]
  br label %for.cond447

for.cond447:                                      ; preds = %for.cond447.preheader, %for.cond447
  %link.0.pn = phi ptr [ %p.0, %for.cond447 ], [ %link.01355, %for.cond447.preheader ]
...
land.lhs.true466:                                 ; preds = %for.end458
  ...
  %39 = load ptr, ptr %osym_body467, align 8
...
if.then484:                                       ; preds = %land.lhs.true470
  ...
  %42 = load ptr, ptr %osucc489, align 8
  br label %for.cond493

for.cond493:                                      ; preds = %for.cond493, %if.then484
  %.pn1327 = phi ptr [ %42, %if.then484 ], [ %sym485.0, %for.cond493 ]
  %sym485.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn1327, i64 0, i64 1
  %sym485.0 = load ptr, ptr %sym485.0.in, align 8
  %ou1494 = getelementptr inbounds %struct.word_type, ptr %sym485.0, i64 0, i32 1
  %43 = load i8, ptr %ou1494, align 8
...
if.then510:                                       ; preds = %for.cond493
  ...
  %44 = load ptr, ptr %oactual511, align 8
  ...
  %45 = load ptr, ptr %oactual511, align 8
  ...
  %.pre1373 = load ptr, ptr %oenclosing, align 8
  br label %for.inc525

for.inc525:                                       ; preds = %for.cond493, %land.lhs.true470, %if.then510, %for.end458, %land.lhs.true466
  %46 = phi ptr [ %36, %land.lhs.true470 ], [ %.pre1373, %if.then510 ], [ %36, %for.end458 ], [ %36, %land.lhs.true466 ], [ %36, %for.cond493 ]
  %link.0.in = getelementptr inbounds %struct.LIST, ptr %link.01355, i64 0, i32 1
  %link.0 = load ptr, ptr %link.0.in, align 8
  %cmp441.not = icmp eq ptr %link.0, %46
  br i1 %cmp441.not, label %if.end530, label %for.cond447.preheader
...
if.then534:                                       ; preds = %if.end530
  %47 = load ptr, ptr %oenclosing, align 8
...
if.then548:                                       ; preds = %if.end544
  %48 = load ptr, ptr %oenclosing, align 8
...
if.else588:                                       ; preds = %if.else576
  ...
  store ptr %4, ptr %ofilter590, align 8
  %53 = load ptr, ptr %oenclosing, align 8
  %ou2592 = getelementptr inbounds %struct.word_type, ptr %53, i64 0, i32 2
  store i8 104, ptr %ou2592, align 8
  br label %if.end596

if.end596:                                        ; preds = %if.then573, %if.else588, %if.then585, %if.end559
  %54 = load i8, ptr %ou1, align 8
...
if.end674:                                        ; preds = %if.end596, %if.then671, %lor.lhs.false665, %land.lhs.true641, %if.end635
  ...
  %61 = load i8, ptr %str, align 1
  %conv677 = zext i8 %61 to i32
  %dec1356 = add nsw i32 %conv676, -1
  %tobool678.not1357 = icmp eq i32 %dec1356, 0
  br i1 %tobool678.not1357, label %while.end, label %while.body.preheader

while.body.preheader:                             ; preds = %if.end674
  %62 = zext i32 %dec1356 to i64
  %min.iters.check = icmp ult i32 %dec1356, 8
  br i1 %min.iters.check, label %while.body.preheader1397, label %vector.ph

vector.ph:                                        ; preds = %while.body.preheader
  %n.vec = and i64 %62, 4294967288
  %.cast = trunc i64 %n.vec to i32
  %ind.end = sub i32 %dec1356, %.cast
  %ind.end1389 = getelementptr i8, ptr %str, i64 %n.vec
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi1391 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %69, %vector.body ]
  %next.gep = getelementptr i8, ptr %str, i64 %index
  %64 = getelementptr inbounds i8, ptr %next.gep, i64 1
  %wide.load = load <4 x i8>, ptr %64, align 1
  %65 = getelementptr inbounds i8, ptr %next.gep, i64 5
  %wide.load1393 = load <4 x i8>, ptr %65, align 1
  %66 = zext <4 x i8> %wide.load to <4 x i32>
  %67 = zext <4 x i8> %wide.load1393 to <4 x i32>
  %68 = add <4 x i32> %vec.phi, %66
  %69 = add <4 x i32> %vec.phi1391, %67
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %while.end, label %while.body.preheader1397

while.body.preheader1397:                         ; preds = %while.body.preheader, %middle.block
  %dec1360.ph = phi i32 [ %dec1356, %while.body.preheader ], [ %ind.end, %middle.block ]
  %sum.01359.ph = phi i32 [ %conv677, %while.body.preheader ], [ %71, %middle.block ]
  %str.pn1358.ph = phi ptr [ %str, %while.body.preheader ], [ %ind.end1389, %middle.block ]
  br label %while.body

while.body:                                       ; preds = %while.body.preheader1397, %while.body
  %dec1360 = phi i32 [ %dec, %while.body ], [ %dec1360.ph, %while.body.preheader1397 ]
  %sum.01359 = phi i32 [ %add681, %while.body ], [ %sum.01359.ph, %while.body.preheader1397 ]
  %str.pn1358 = phi ptr [ %x.0, %while.body ], [ %str.pn1358.ph, %while.body.preheader1397 ]
  %x.0 = getelementptr inbounds i8, ptr %str.pn1358, i64 1
  %72 = load i8, ptr %x.0, align 1
  %conv680 = zext i8 %72 to i32
  %add681 = add nuw nsw i32 %sum.01359, %conv680
  %dec = add nsw i32 %dec1360, -1
  %tobool678.not = icmp eq i32 %dec, 0
  br i1 %tobool678.not, label %while.end, label %while.body
...
while.end:                                        ; preds = %while.body, %middle.block, %if.end674
  ...
  %plink.0.in1361 = getelementptr inbounds %struct.LIST, ptr %arrayidx683, i64 0, i32 1
  %plink.01362 = load ptr, ptr %plink.0.in1361, align 8
  %cmp688.not1363 = icmp eq ptr %plink.01362, %arrayidx683
  br i1 %cmp688.not1363, label %for.end763, label %for.cond694.preheader

for.cond694.preheader:                            ; preds = %while.end, %for.inc759
  %plink.01364 = phi ptr [ %plink.0, %for.inc759 ], [ %plink.01362, %while.end ]
  br label %for.cond694

for.cond694:                                      ; preds = %for.cond694.preheader, %for.cond694
  %plink.0.pn = phi ptr [ %p.1, %for.cond694 ], [ %plink.01364, %for.cond694.preheader ]
  ...
  %73 = load i8, ptr %ou1695, align 8
  %cmp698 = icmp eq i8 %73, 0
  br i1 %cmp698, label %for.cond694, label %for.end705
...
for.cond726:                                      ; preds = %for.cond719, %for.cond726
  ...
  %74 = load i8, ptr %ou1727, align 8
  %cmp730 = icmp eq i8 %74, 0
  br i1 %cmp730, label %for.cond726, label %for.end737
...
for.end737:                                       ; preds = %for.cond726
  ...
  %76 = load ptr, ptr %oenclosing739, align 8
  %cmp740 = icmp eq ptr %75, %76
  br i1 %cmp740, label %if.then742, label %for.cond719
...
if.then742:                                       ; preds = %for.end737
  ...
  %77 = load i32, ptr @AltErrorFormat, align 4
...
for.inc759:                                       ; preds = %for.end705, %land.lhs.true711
  %plink.0.in = getelementptr inbounds %struct.LIST, ptr %plink.01364, i64 0, i32 1
  %plink.0 = load ptr, ptr %plink.0.in, align 8
  %cmp688.not = icmp eq ptr %plink.0, %arrayidx683
  br i1 %cmp688.not, label %for.end763, label %for.cond694.preheader

for.end763:                                       ; preds = %for.inc759, %while.end
  %sub = shl i64 %call675, 32
  %sext = add i64 %sub, 292057776128
  %conv768 = ashr exact i64 %sext, 32
  %div1326 = lshr i64 %conv768, 3
  %78 = trunc i64 %div1326 to i32
  %conv770 = add i32 %78, 1
  store i32 %conv770, ptr @zz_size, align 4
...
if.then774:                                       ; preds = %for.end763
  ...
  %.pre1375 = load ptr, ptr @zz_hold, align 8
  br label %if.end792
...
if.else776:                                       ; preds = %for.end763
  ...
  %79 = load ptr, ptr %arrayidx778, align 8
...
if.then781:                                       ; preds = %if.else776
  ...
  store ptr %call782, ptr @zz_hold, align 8
  br label %if.end792

if.else783:                                       ; preds = %if.else776
  store ptr %79, ptr @zz_hold, align 8
  %80 = load ptr, ptr %79, align 8
  store ptr %80, ptr %arrayidx778, align 8
  br label %if.end792

if.end792:                                        ; preds = %if.then781, %if.else783, %if.then774
  %81 = phi ptr [ %call782, %if.then781 ], [ %79, %if.else783 ], [ %.pre1375, %if.then774 ]
  ...
  store i8 %conv793, ptr %orec_size, align 1
  %ou1795 = getelementptr inbounds %struct.word_type, ptr %81, i64 0, i32 1
  store i8 11, ptr %ou1795, align 8
  ...
  store ptr %81, ptr %osucc799, align 8
  store ptr %81, ptr %arrayidx798, align 8
  %osucc805 = getelementptr inbounds %struct.LIST, ptr %81, i64 0, i32 1
  store ptr %81, ptr %osucc805, align 8
...
if.then828:                                       ; preds = %if.end792
  ...
  br label %cond.false886

if.else830:                                       ; preds = %if.end792
  store ptr %84, ptr @zz_hold, align 8
  %86 = load ptr, ptr %84, align 8
  store ptr %86, ptr %arrayidx825, align 8
  br label %cond.false886

cond.false886:                                    ; preds = %if.else830, %if.then828
  %87 = phi ptr [ %84, %if.else830 ], [ %call829, %if.then828 ]
  %ou1840 = getelementptr inbounds %struct.word_type, ptr %87, i64 0, i32 1
  store i8 0, ptr %ou1840, align 8
  %osucc844 = getelementptr inbounds [2 x %struct.LIST], ptr %87, i64 0, i64 1, i32 1
  store ptr %87, ptr %osucc844, align 8
  %arrayidx846 = getelementptr inbounds [2 x %struct.LIST], ptr %87, i64 0, i64 1
  store ptr %87, ptr %arrayidx846, align 8
  %osucc850 = getelementptr inbounds %struct.LIST, ptr %87, i64 0, i32 1
  store ptr %87, ptr %osucc850, align 8
  store ptr %87, ptr %87, align 8
  store ptr %87, ptr @xx_link, align 8
  store ptr %87, ptr @zz_res, align 8
  store ptr %arrayidx683, ptr @zz_hold, align 8
  %88 = load ptr, ptr %arrayidx683, align 16
  store ptr %88, ptr @zz_tmp, align 8
  %89 = load ptr, ptr %87, align 8
  store ptr %89, ptr %arrayidx683, align 16
  %90 = load ptr, ptr %87, align 8
  %osucc874 = getelementptr inbounds %struct.LIST, ptr %90, i64 0, i32 1
  store ptr %arrayidx683, ptr %osucc874, align 8
  ...
  store ptr %91, ptr %osucc880, align 8
  %93 = load ptr, ptr @xx_link, align 8
...
cond.false890:                                    ; preds = %cond.false886
  %94 = load ptr, ptr %arrayidx798, align 8
  store ptr %94, ptr @zz_tmp, align 8
  %arrayidx895 = getelementptr inbounds [2 x %struct.LIST], ptr %93, i64 0, i64 1
  %95 = load ptr, ptr %arrayidx895, align 8
  store ptr %95, ptr %arrayidx798, align 8
  %96 = load ptr, ptr %arrayidx895, align 8
  %osucc905 = getelementptr inbounds [2 x %struct.LIST], ptr %96, i64 0, i64 1, i32 1
  store ptr %81, ptr %osucc905, align 8
  store ptr %94, ptr %arrayidx895, align 8
  %osucc911 = getelementptr inbounds [2 x %struct.LIST], ptr %94, i64 0, i64 1, i32 1
  store ptr %93, ptr %osucc911, align 8
  br label %wrapup

wrapup:                                           ; preds = %for.cond719, %cond.false886, %cond.false890, %if.then748, %if.then742
  %p.2 = phi ptr [ %p.1, %if.then748 ], [ %p.1, %if.then742 ], [ %81, %cond.false890 ], [ %81, %cond.false886 ], [ %p.1, %for.cond719 ]
  %97 = load i8, ptr @zz_lengths, align 1
  %conv916 = zext i8 %97 to i32
  store i32 %conv916, ptr @zz_size, align 4
  %conv917 = zext i8 %97 to i64
  %arrayidx924 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv917
  %98 = load ptr, ptr %arrayidx924, align 8
...
if.else929:                                       ; preds = %wrapup
  ...
  store ptr %100, ptr %arrayidx924, align 8
  br label %if.end938
...
if.end938:                                        ; preds = %if.then927, %if.else929
  ...
  store i8 0, ptr %ou1939, align 8
  %osucc943 = getelementptr inbounds [2 x %struct.LIST], ptr %101, i64 0, i64 1, i32 1
  store ptr %101, ptr %osucc943, align 8
  %arrayidx945 = getelementptr inbounds [2 x %struct.LIST], ptr %101, i64 0, i64 1
  store ptr %101, ptr %arrayidx945, align 8
  %osucc949 = getelementptr inbounds %struct.LIST, ptr %101, i64 0, i32 1
  store ptr %101, ptr %osucc949, align 8
  store ptr %101, ptr %101, align 8
  store ptr %101, ptr @xx_link, align 8
  store ptr %101, ptr @zz_res, align 8
  store ptr %p.2, ptr @zz_hold, align 8
...
cond.end984:                                      ; preds = %if.end938
  %102 = load ptr, ptr %p.2, align 8
  store ptr %102, ptr @zz_tmp, align 8
  %103 = load ptr, ptr %101, align 8
  store ptr %103, ptr %p.2, align 8
  %104 = load ptr, ptr @zz_hold, align 8
  %105 = load ptr, ptr @zz_res, align 8
  %106 = load ptr, ptr %105, align 8
  %osucc975 = getelementptr inbounds %struct.LIST, ptr %106, i64 0, i32 1
  store ptr %104, ptr %osucc975, align 8
  %107 = load ptr, ptr @zz_tmp, align 8
  store ptr %107, ptr %105, align 8
  %108 = load ptr, ptr @zz_res, align 8
  %109 = load ptr, ptr @zz_tmp, align 8
  %osucc981 = getelementptr inbounds %struct.LIST, ptr %109, i64 0, i32 1
  store ptr %108, ptr %osucc981, align 8
  %.pr1343 = load ptr, ptr @xx_link, align 8
  store ptr %.pr1343, ptr @zz_res, align 8
  store ptr %4, ptr @zz_hold, align 8
  %cmp990 = icmp eq ptr %.pr1343, null
...
cond.end984.cond.false993_crit_edge:              ; preds = %cond.end984
  %arrayidx998.phi.trans.insert = getelementptr inbounds [2 x %struct.LIST], ptr %.pr1343, i64 0, i64 1
  %.pre1376 = load ptr, ptr %arrayidx998.phi.trans.insert, align 8
  br label %cond.false993

cond.false993:                                    ; preds = %cond.end984.cond.false993_crit_edge, %cond.end984.thread
  %110 = phi ptr [ %101, %cond.end984.thread ], [ %.pre1376, %cond.end984.cond.false993_crit_edge ]
  %111 = phi ptr [ %101, %cond.end984.thread ], [ %.pr1343, %cond.end984.cond.false993_crit_edge ]
  %112 = load ptr, ptr %arrayidx22, align 8
  store ptr %112, ptr @zz_tmp, align 8
  %arrayidx998 = getelementptr inbounds [2 x %struct.LIST], ptr %111, i64 0, i64 1
  store ptr %110, ptr %arrayidx22, align 8
  %113 = load ptr, ptr %arrayidx998, align 8
  %osucc1008 = getelementptr inbounds [2 x %struct.LIST], ptr %113, i64 0, i64 1, i32 1
  store ptr %4, ptr %osucc1008, align 8
  store ptr %112, ptr %arrayidx998, align 8
  %osucc1014 = getelementptr inbounds [2 x %struct.LIST], ptr %112, i64 0, i64 1, i32 1
  store ptr %111, ptr %osucc1014, align 8
  br label %cond.end1017

cond.end1017:                                     ; preds = %cond.end984, %cond.false993
  %114 = load ptr, ptr %oenclosing, align 8
  %cmp1020.not = icmp eq ptr %114, null
  br i1 %cmp1020.not, label %if.end1127, label %if.then1022

if.then1022:                                      ; preds = %cond.end1017
  %115 = load i8, ptr @zz_lengths, align 1
  %conv1023 = zext i8 %115 to i32
  store i32 %conv1023, ptr @zz_size, align 4
  %conv1024 = zext i8 %115 to i64
  %arrayidx1031 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv1024
  %116 = load ptr, ptr %arrayidx1031, align 8
...
if.else1036:                                      ; preds = %if.then1022
  ...
  store ptr %118, ptr %arrayidx1031, align 8
  br label %if.end1045
...
if.end1045:                                       ; preds = %if.then1034, %if.else1036
  ...
  store i8 0, ptr %ou11046, align 8
  %osucc1050 = getelementptr inbounds [2 x %struct.LIST], ptr %119, i64 0, i64 1, i32 1
  store ptr %119, ptr %osucc1050, align 8
  %arrayidx1052 = getelementptr inbounds [2 x %struct.LIST], ptr %119, i64 0, i64 1
  store ptr %119, ptr %arrayidx1052, align 8
  %osucc1056 = getelementptr inbounds %struct.LIST, ptr %119, i64 0, i32 1
  store ptr %119, ptr %osucc1056, align 8
  store ptr %119, ptr %119, align 8
  store ptr %119, ptr @xx_link, align 8
  store ptr %119, ptr @zz_res, align 8
  %120 = load ptr, ptr %oenclosing, align 8
...
cond.end1092:                                     ; preds = %if.end1045
  ...
  store ptr %123, ptr %osucc1083, align 8
  ...
  store ptr %127, ptr %osucc1089, align 8
  %.pr1345 = load ptr, ptr @xx_link, align 8
  store ptr %.pr1345, ptr @zz_res, align 8
  store ptr %4, ptr @zz_hold, align 8
  %cmp1098 = icmp eq ptr %.pr1345, null
...
cond.end1092.cond.false1101_crit_edge:            ; preds = %cond.end1092
  %arrayidx1106.phi.trans.insert = getelementptr inbounds [2 x %struct.LIST], ptr %.pr1345, i64 0, i64 1
  %.pre1377 = load ptr, ptr %arrayidx1106.phi.trans.insert, align 8
  br label %cond.false1101

cond.false1101:                                   ; preds = %cond.end1092.cond.false1101_crit_edge, %cond.end1092.thread
  %129 = phi ptr [ %119, %cond.end1092.thread ], [ %.pre1377, %cond.end1092.cond.false1101_crit_edge ]
  %130 = phi ptr [ %119, %cond.end1092.thread ], [ %.pr1345, %cond.end1092.cond.false1101_crit_edge ]
  %131 = load ptr, ptr %arrayidx22, align 8
  store ptr %131, ptr @zz_tmp, align 8
  %arrayidx1106 = getelementptr inbounds [2 x %struct.LIST], ptr %130, i64 0, i64 1
  store ptr %129, ptr %arrayidx22, align 8
  %132 = load ptr, ptr %arrayidx1106, align 8
  %osucc1116 = getelementptr inbounds [2 x %struct.LIST], ptr %132, i64 0, i64 1, i32 1
  store ptr %4, ptr %osucc1116, align 8
  store ptr %131, ptr %arrayidx1106, align 8
  %osucc1122 = getelementptr inbounds [2 x %struct.LIST], ptr %131, i64 0, i64 1, i32 1
  store ptr %130, ptr %osucc1122, align 8
  br label %if.end1127
...
entry:
  ...
  %dec351 = add nsw i32 %conv, -1
  %tobool.not352 = icmp eq i32 %dec351, 0
  br i1 %tobool.not352, label %while.end, label %while.body.preheader

while.body.preheader:                             ; preds = %entry
  %1 = zext i32 %dec351 to i64
  %min.iters.check = icmp ult i32 %dec351, 8
  br i1 %min.iters.check, label %while.body.preheader372, label %vector.ph

vector.ph:                                        ; preds = %while.body.preheader
  %n.vec = and i64 %1, 4294967288
  %.cast = trunc i64 %n.vec to i32
  %ind.end = sub i32 %dec351, %.cast
  %ind.end366 = getelementptr i8, ptr %str, i64 %n.vec
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi368 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %8, %vector.body ]
  %next.gep = getelementptr i8, ptr %str, i64 %index
  ...
  %wide.load370 = load <4 x i8>, ptr %4, align 1
  %5 = zext <4 x i8> %wide.load to <4 x i32>
  %6 = zext <4 x i8> %wide.load370 to <4 x i32>
  %7 = add <4 x i32> %vec.phi, %5
  %8 = add <4 x i32> %vec.phi368, %6
  %index.next = add nuw i64 %index, 8
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %while.end.loopexit, label %while.body.preheader372

while.body.preheader372:                          ; preds = %while.body.preheader, %middle.block
  %dec355.ph = phi i32 [ %dec351, %while.body.preheader ], [ %ind.end, %middle.block ]
  %sum.0354.ph = phi i32 [ %conv2, %while.body.preheader ], [ %10, %middle.block ]
  %str.pn353.ph = phi ptr [ %str, %while.body.preheader ], [ %ind.end366, %middle.block ]
  br label %while.body

while.body:                                       ; preds = %while.body.preheader372, %while.body
  %dec355 = phi i32 [ %dec, %while.body ], [ %dec355.ph, %while.body.preheader372 ]
  %sum.0354 = phi i32 [ %add, %while.body ], [ %sum.0354.ph, %while.body.preheader372 ]
  %str.pn353 = phi ptr [ %x.0, %while.body ], [ %str.pn353.ph, %while.body.preheader372 ]
  %x.0 = getelementptr inbounds i8, ptr %str.pn353, i64 1
  %11 = load i8, ptr %x.0, align 1
  %conv4 = zext i8 %11 to i32
  %add = add nuw nsw i32 %sum.0354, %conv4
  %dec = add nsw i32 %dec355, -1
...
while.end:                                        ; preds = %while.end.loopexit, %entry
  ...
  %plink.0.in356 = getelementptr inbounds %struct.LIST, ptr %arrayidx, i64 0, i32 1
  %plink.0357 = load ptr, ptr %plink.0.in356, align 8
  %cmp.not358 = icmp eq ptr %plink.0357, %arrayidx
  br i1 %cmp.not358, label %for.end62, label %for.cond9.preheader

for.cond9.preheader:                              ; preds = %while.end, %for.inc58
  %plink.0359 = phi ptr [ %plink.0, %for.inc58 ], [ %plink.0357, %while.end ]
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond9.preheader, %for.cond9
  %plink.0.pn = phi ptr [ %p.0, %for.cond9 ], [ %plink.0359, %for.cond9.preheader ]
  ...
  %13 = load i8, ptr %ou1, align 8
  %cmp11 = icmp eq i8 %13, 0
  br i1 %cmp11, label %for.cond9, label %for.end
...
for.cond32:                                       ; preds = %for.cond25, %for.cond32
  ...
  %14 = load i8, ptr %ou133, align 8
  %cmp36 = icmp eq i8 %14, 0
  br i1 %cmp36, label %for.cond32, label %for.end43

for.end43:                                        ; preds = %for.cond32
  %15 = load ptr, ptr %oenclosing, align 8
  %oenclosing44 = getelementptr inbounds %struct.symbol_type, ptr %q.0, i64 0, i32 3
  %16 = load ptr, ptr %oenclosing44, align 8
  %cmp45 = icmp eq ptr %15, %16
  br i1 %cmp45, label %if.then47, label %for.cond25
...
for.inc58:                                        ; preds = %for.end, %land.lhs.true
  %plink.0.in = getelementptr inbounds %struct.LIST, ptr %plink.0359, i64 0, i32 1
  %plink.0 = load ptr, ptr %plink.0.in, align 8
  %cmp.not = icmp eq ptr %plink.0, %arrayidx
  br i1 %cmp.not, label %for.end62, label %for.cond9.preheader
...
if.else:                                          ; preds = %for.end62
  ...
  %18 = load ptr, ptr %arrayidx76, align 8
...
if.then79:                                        ; preds = %if.else
  ...
  store ptr %call80, ptr @zz_hold, align 8
  br label %if.end90

if.else81:                                        ; preds = %if.else
  store ptr %18, ptr @zz_hold, align 8
  %19 = load ptr, ptr %18, align 8
  store ptr %19, ptr %arrayidx76, align 8
  br label %if.end90
...
if.end90:                                         ; preds = %if.then79, %if.else81, %if.then73
  ...
  store i8 %conv91, ptr %orec_size, align 1
  %ou193 = getelementptr inbounds %struct.word_type, ptr %20, i64 0, i32 1
  store i8 11, ptr %ou193, align 8
  ...
  %22 = load i8, ptr @zz_lengths, align 1
...
if.else126:                                       ; preds = %if.end90
  ...
  store ptr %25, ptr %arrayidx121, align 8
  br label %cond.false182

cond.false182:                                    ; preds = %if.else126, %if.then124
  %26 = phi ptr [ %23, %if.else126 ], [ %call125, %if.then124 ]
  ...
  store ptr %26, ptr %osucc140, align 8
  %arrayidx142 = getelementptr inbounds [2 x %struct.LIST], ptr %26, i64 0, i64 1
  store ptr %26, ptr %arrayidx142, align 8
  %osucc146 = getelementptr inbounds %struct.LIST, ptr %26, i64 0, i32 1
  store ptr %26, ptr %osucc146, align 8
  store ptr %26, ptr %26, align 8
  store ptr %26, ptr @xx_link, align 8
  store ptr %26, ptr @zz_res, align 8
  store ptr %arrayidx, ptr @zz_hold, align 8
  %27 = load ptr, ptr %arrayidx, align 16
  store ptr %27, ptr @zz_tmp, align 8
  %28 = load ptr, ptr %26, align 8
  store ptr %28, ptr %arrayidx, align 16
  %29 = load ptr, ptr %26, align 8
  %osucc170 = getelementptr inbounds %struct.LIST, ptr %29, i64 0, i32 1
  store ptr %arrayidx, ptr %osucc170, align 8
  store ptr %27, ptr %26, align 8
  %30 = load ptr, ptr @zz_res, align 8
  %31 = load ptr, ptr @zz_tmp, align 8
  %osucc176 = getelementptr inbounds %struct.LIST, ptr %31, i64 0, i32 1
  store ptr %30, ptr %osucc176, align 8
  %32 = load ptr, ptr @xx_link, align 8
...
cond.false186:                                    ; preds = %cond.false182
  %33 = load ptr, ptr %arrayidx96, align 8
  ...
  store ptr %34, ptr %arrayidx96, align 8
  %35 = load ptr, ptr %arrayidx191, align 8
  %osucc201 = getelementptr inbounds [2 x %struct.LIST], ptr %35, i64 0, i64 1, i32 1
  store ptr %20, ptr %osucc201, align 8
  store ptr %33, ptr %arrayidx191, align 8
  %osucc207 = getelementptr inbounds [2 x %struct.LIST], ptr %33, i64 0, i64 1, i32 1
  store ptr %32, ptr %osucc207, align 8
  br label %wrapup

wrapup:                                           ; preds = %for.cond25, %cond.false182, %cond.false186, %if.then47
  %p.1 = phi ptr [ %p.0, %if.then47 ], [ %20, %cond.false186 ], [ %20, %cond.false182 ], [ %p.0, %for.cond25 ]
  %36 = load i8, ptr @zz_lengths, align 1
  %conv212 = zext i8 %36 to i32
  store i32 %conv212, ptr @zz_size, align 4
  %conv213 = zext i8 %36 to i64
  %arrayidx220 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv213
  %37 = load ptr, ptr %arrayidx220, align 8
...
cond.false256:                                    ; preds = %if.end234
  ...
  store ptr %43, ptr %osucc271, align 8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i8>, ptr %3, align 1
  %4 = getelementptr inbounds i8, ptr %next.gep, i64 5
  %wide.load222 = load <4 x i8>, ptr %4, align 1
  %5 = zext <4 x i8> %wide.load to <4 x i32>
...
while.end:                                        ; preds = %while.end.loopexit, %entry
  ...
  %plink.0189 = load ptr, ptr %plink.0.in188, align 8
...
for.cond8:                                        ; preds = %for.cond8.preheader, %for.cond8
  ...
  %p.0 = load ptr, ptr %p.0.in, align 8
  %ou1 = getelementptr inbounds %struct.word_type, ptr %p.0, i64 0, i32 1
  %17 = load i8, ptr %ou1, align 8
  %cmp10 = icmp eq i8 %17, 0
  br i1 %cmp10, label %for.cond8, label %for.end
...
do.body:                                          ; preds = %land.rhs, %if.then
  ...
  %18 = load i8, ptr %x.1, align 1
  %19 = load i8, ptr %y.0, align 1
...
land.rhs:                                         ; preds = %do.body
  ...
  br i1 %tobool25.not, label %if.then28, label %do.body
...
if.then28:                                        ; preds = %land.rhs, %do.end
  ...
  %link.0184 = load ptr, ptr %link.0.in183, align 8
...
land.lhs.true76.us:                               ; preds = %lor.lhs.false69.us, %land.lhs.true65.us
  %26 = load i32, ptr %arrayidx78, align 4
  %tobool79.not.us = icmp eq i32 %26, 0
  %cmp84.not.us = icmp eq i8 %21, -110
  %or.cond175.us = and i1 %cmp84.not.us, %tobool79.not.us
  br i1 %or.cond175.us, label %lor.lhs.false86.us, label %land.lhs.true96.us
...
for.inc110.us:                                    ; preds = %lor.lhs.false103.us, %lor.lhs.false86.us, %lor.lhs.false69.us, %land.lhs.true.us, %for.end52.us
  ...
  %link.0.us = load ptr, ptr %link.0.in.us, align 8
  %cmp35.not.us = icmp eq ptr %link.0.us, %p.0
  br i1 %cmp35.not.us, label %for.cond34.do.cond115_crit_edge, label %for.cond41.preheader.us
...
for.cond41:                                       ; preds = %for.cond41.preheader, %for.cond41
  ...
  %28 = load i8, ptr %ou142, align 8
  %cmp45 = icmp eq i8 %28, 0
  br i1 %cmp45, label %for.cond41, label %for.end52
...
land.lhs.true:                                    ; preds = %for.end52
  %30 = load i32, ptr %arrayidx58, align 4
...
land.lhs.true76:                                  ; preds = %lor.lhs.false69, %land.lhs.true65
  ...
  %or.cond175 = and i1 %cmp84.not, %tobool79.not
  br i1 %or.cond175, label %lor.lhs.false86, label %cleanup
...
for.inc110:                                       ; preds = %land.lhs.true, %for.end52, %lor.lhs.false69, %lor.lhs.false86
  ...
  br i1 %cmp35.not, label %for.cond34.do.cond115_crit_edge, label %for.cond41.preheader

for.cond34.do.cond115_crit_edge:                  ; preds = %for.inc110, %for.inc110.us
  %cmp118.not = icmp eq ptr %20, %15
  br i1 %cmp118.not, label %if.end122, label %do.body29
...
if.end122:                                        ; preds = %for.cond34.do.cond115_crit_edge, %if.then28, %do.end, %for.end
  ...
  %plink.0 = load ptr, ptr %plink.0.in, align 8
  %cmp.not = icmp eq ptr %plink.0, %arrayidx
  br i1 %cmp.not, label %cleanup, label %for.cond8.preheader
...
if.end:                                           ; preds = %entry
  ...
  %0 = load ptr, ptr %oenclosing, align 8
...
if.end3:                                          ; preds = %if.end
  ...
  %.pre = load ptr, ptr %oenclosing, align 8
...
if.end.i:                                         ; preds = %for.body11
  ...
  %8 = load ptr, ptr %osucc.i, align 8
  br label %for.cond.i
...
SymName.exit:                                     ; preds = %for.body11, %if.end19.i
  ...
  store ptr %retval.0.i, ptr @FullSymName.sname, align 8
...
if.then20:                                        ; preds = %SymName.exit
  ...
  %.pre86 = load ptr, ptr @FullSymName.sname, align 8
  br label %if.end22
...
for.end27:                                        ; preds = %if.end22, %for.end.thread, %for.end
  ...
  %12 = load ptr, ptr %stack, align 16
  %cmp.i53 = icmp eq ptr %12, null
  br i1 %cmp.i53, label %SymName.exit65, label %if.end.i54

if.end.i54:                                       ; preds = %for.end27
  %osucc.i55 = getelementptr inbounds [2 x %struct.LIST], ptr %12, i64 0, i64 1, i32 1
  %13 = load ptr, ptr %osucc.i55, align 8
  br label %for.cond.i56

for.cond.i56:                                     ; preds = %for.cond.i56, %if.end.i54
  %p.0.in.i57 = phi ptr [ %13, %if.end.i54 ], [ %p.0.i58, %for.cond.i56 ]
  %p.0.i58 = load ptr, ptr %p.0.in.i57, align 8
  %ou1.i59 = getelementptr inbounds %struct.word_type, ptr %p.0.i58, i64 0, i32 1
  %14 = load i8, ptr %ou1.i59, align 8
  switch i8 %14, label %if.then18.i63 [
    i8 0, label %for.cond.i56
    i8 11, label %if.end19.i60
    i8 12, label %if.end19.i60
  ]

if.then18.i63:                                    ; preds = %for.cond.i56
  %15 = load ptr, ptr @no_fpos, align 8
  %call.i64 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %15, ptr noundef nonnull @.str.26) #13
  br label %if.end19.i60

if.end19.i60:                                     ; preds = %for.cond.i56, %for.cond.i56, %if.then18.i63
  %ostring.i61 = getelementptr inbounds %struct.word_type, ptr %p.0.i58, i64 0, i32 4
  br label %SymName.exit65

SymName.exit65:                                   ; preds = %for.end27, %if.end19.i60
  %retval.0.i62 = phi ptr [ %ostring.i61, %if.end19.i60 ], [ @.str.25, %for.end27 ]
  store ptr %retval.0.i62, ptr @FullSymName.sname, align 8
  %call30 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %retval.0.i62) #14
...
if.then34:                                        ; preds = %SymName.exit65
  ...
  %.pre87 = load ptr, ptr @FullSymName.sname, align 8
  br label %if.end37

if.end37:                                         ; preds = %if.then34, %SymName.exit65
  %16 = phi ptr [ %.pre87, %if.then34 ], [ %retval.0.i62, %SymName.exit65 ]
...
entry:
  ...
  %link.040 = load ptr, ptr %link.0.in39, align 8
...
land.lhs.true:                                    ; preds = %for.end
  ...
  %1 = load ptr, ptr %oenclosing, align 8
...
for.inc17:                                        ; preds = %for.end, %land.lhs.true
  ...
  br i1 %cmp.not, label %for.end21, label %for.cond3.preheader
...
if.end.i:                                         ; preds = %for.end21.thread, %for.end21
  ...
  %2 = load ptr, ptr %osucc.i, align 8
  br label %for.cond.i
...
entry:
  ...
  %link.050 = load ptr, ptr %link.0.in49, align 8
...
land.lhs.true:                                    ; preds = %for.cond4
  %oenclosing = getelementptr inbounds %struct.symbol_type, ptr %y.0, i64 0, i32 3
  %2 = load ptr, ptr %oenclosing, align 8
...
land.lhs.true19:                                  ; preds = %land.lhs.true
  ...
  %3 = load i8, ptr %onpar_code, align 1
...
for.inc24:                                        ; preds = %for.cond4, %land.lhs.true, %land.lhs.true19
  ...
  br i1 %cmp.not, label %for.end28, label %for.cond4.preheader
