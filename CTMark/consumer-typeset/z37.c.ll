; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z37.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z37.c"
...
entry:
  store i32 1, ptr @font_curr_page, align 4
  store i32 0, ptr @font_count, align 4
...
if.then5:                                         ; preds = %entry
  ...
  store ptr %call6, ptr @zz_hold, align 8
  br label %if.end13
...
if.then36:                                        ; preds = %if.end13
  ...
  store ptr %call37, ptr @zz_hold, align 8
  br label %if.end47

if.else38:                                        ; preds = %if.end13
  store ptr %6, ptr @zz_hold, align 8
  %8 = load ptr, ptr %6, align 8
  store ptr %8, ptr %arrayidx33, align 8
  br label %if.end47
...
if.end47:                                         ; preds = %if.then36, %if.else38
  ...
  store i8 17, ptr %ou148, align 8
  %osucc52 = getelementptr inbounds [2 x %struct.LIST], ptr %9, i64 0, i64 1, i32 1
  store ptr %9, ptr %osucc52, align 8
  %arrayidx54 = getelementptr inbounds [2 x %struct.LIST], ptr %9, i64 0, i64 1
  store ptr %9, ptr %arrayidx54, align 8
  %osucc58 = getelementptr inbounds %struct.LIST, ptr %9, i64 0, i32 1
  store ptr %9, ptr %osucc58, align 8
  store ptr %9, ptr %9, align 8
  store ptr %9, ptr @font_used, align 8
  store i32 0, ptr @font_seqnum, align 4
  %call62 = tail call noalias dereferenceable_or_null(9600) ptr @malloc(i64 noundef 9600) #15
  store ptr %call62, ptr @finfo, align 8
  store i32 100, ptr @finfo_size, align 4
  %10 = load ptr, ptr @StartSym, align 8
  ...
  store ptr %call1.i, ptr @FontDefSym, align 8
  ...
  %13 = load i16, ptr %ohas_compulsory.i, align 2
  %inc.i = add i16 %13, 1
  store i16 %inc.i, ptr %ohas_compulsory.i, align 2
  ...
  store ptr %call1.i74, ptr @fd_tag, align 8
  %14 = load ptr, ptr @FontDefSym, align 8
  ...
  %16 = load i16, ptr %ohas_compulsory.i80, align 2
  %inc.i81 = add i16 %16, 1
  store i16 %inc.i81, ptr %ohas_compulsory.i80, align 2
  ...
  store ptr %call1.i76, ptr @fd_family, align 8
  %17 = load ptr, ptr @FontDefSym, align 8
  ...
  %19 = load i16, ptr %ohas_compulsory.i90, align 2
  %inc.i91 = add i16 %19, 1
  store i16 %inc.i91, ptr %ohas_compulsory.i90, align 2
  ...
  store ptr %call1.i86, ptr @fd_face, align 8
  %20 = load ptr, ptr @FontDefSym, align 8
  %21 = load ptr, ptr @no_fpos, align 8
  ...
  %22 = load i16, ptr %ohas_compulsory.i100, align 2
  %inc.i101 = add i16 %22, 1
  store i16 %inc.i101, ptr %ohas_compulsory.i100, align 2
  ...
  store ptr %call1.i96, ptr @fd_name, align 8
  %23 = load ptr, ptr @FontDefSym, align 8
  ...
  %25 = load i16, ptr %ohas_compulsory.i110, align 2
  %inc.i111 = add i16 %25, 1
  store i16 %inc.i111, ptr %ohas_compulsory.i110, align 2
  ...
  store ptr %call1.i106, ptr @fd_metrics, align 8
  %26 = load ptr, ptr @FontDefSym, align 8
  ...
  store ptr %call1.i116, ptr @fd_extra_metrics, align 8
  %28 = load ptr, ptr @FontDefSym, align 8
  ...
  %30 = load i16, ptr %ohas_compulsory.i125, align 2
  %inc.i126 = add i16 %30, 1
  store i16 %inc.i126, ptr %ohas_compulsory.i125, align 2
  ...
  store ptr %call1.i121, ptr @fd_mapping, align 8
  %31 = load ptr, ptr @FontDefSym, align 8
  ...
  store ptr %call1.i131, ptr @fd_recode, align 8
  ret void
}
...
entry:
  ...
  %0 = load i32, ptr @font_count, align 4
...
for.cond.preheader:                               ; preds = %if.end
  %link.0.in1744 = getelementptr inbounds %struct.LIST, ptr %x, i64 0, i32 1
  %link.01745 = load ptr, ptr %link.0.in1744, align 8
  %cmp51.not1746 = icmp eq ptr %link.01745, %x
  br i1 %cmp51.not1746, label %cleanup, label %for.cond55.preheader
...
if.else32:                                        ; preds = %if.else21
  %strcmpload1621 = load i8, ptr %ostring, align 1
  %cmp36 = icmp eq i8 %strcmpload1621, 0
  br i1 %cmp36, label %cleanup, label %if.end148.thread

if.end148.thread:                                 ; preds = %if.else32
  store ptr %x, ptr %par, align 16
  br label %for.body159.preheader

for.cond55.preheader:                             ; preds = %for.cond.preheader, %for.inc134
  %link.01748 = phi ptr [ %link.0, %for.inc134 ], [ %link.01745, %for.cond.preheader ]
  %num.01747 = phi i32 [ %num.1, %for.inc134 ], [ 0, %for.cond.preheader ]
  br label %for.cond55

for.cond55:                                       ; preds = %for.cond55.preheader, %for.cond55
  %link.0.pn = phi ptr [ %y.1, %for.cond55 ], [ %link.01748, %for.cond55.preheader ]
...
if.then117:                                       ; preds = %if.else111
  %cmp118 = icmp sgt i32 %num.01747, 2
...
if.end123:                                        ; preds = %if.then117
  %inc124 = add nsw i32 %num.01747, 1
  %idxprom125 = sext i32 %num.01747 to i64
  %arrayidx126 = getelementptr inbounds [3 x ptr], ptr %par, i64 0, i64 %idxprom125
  store ptr %y.1, ptr %arrayidx126, align 8
  br label %for.inc134
...
for.inc134:                                       ; preds = %for.cond55, %for.cond55, %if.then106, %if.end123, %if.else111, %if.then95
  %num.1 = phi i32 [ %num.01747, %if.then95 ], [ %num.01747, %if.then106 ], [ %num.01747, %if.else111 ], [ %inc124, %if.end123 ], [ %num.01747, %for.cond55 ], [ %num.01747, %for.cond55 ]
  %link.0.in = getelementptr inbounds %struct.LIST, ptr %link.01748, i64 0, i32 1
  %link.0 = load ptr, ptr %link.0.in, align 8
  %cmp51.not = icmp eq ptr %link.0, %x
  br i1 %cmp51.not, label %if.end144, label %for.cond55.preheader
...
if.end155:                                        ; preds = %if.end148
  ...
  %cmp1571754 = icmp sgt i32 %num.1, 0
  br i1 %cmp1571754, label %for.body159.preheader, label %for.end193

for.body159.preheader:                            ; preds = %if.end148, %if.end148.thread, %if.end155
  %num.31755.ph = phi i32 [ %num.1, %if.end155 ], [ 1, %if.end148.thread ], [ %num.1, %if.end148 ]
  br label %for.body159

for.body159:                                      ; preds = %for.body159.preheader, %for.inc191
  %i.01757 = phi i32 [ %inc192, %for.inc191 ], [ 0, %for.body159.preheader ]
  %requested_size.01756 = phi ptr [ %requested_size.1, %for.inc191 ], [ null, %for.body159.preheader ]
  %num.31755 = phi i32 [ %num.4, %for.inc191 ], [ %num.31755.ph, %for.body159.preheader ]
  %idxprom160 = sext i32 %i.01757 to i64
  %arrayidx161 = getelementptr inbounds [3 x ptr], ptr %par, i64 0, i64 %idxprom160
  %5 = load ptr, ptr %arrayidx161, align 8
  %ostring162 = getelementptr inbounds %struct.word_type, ptr %5, i64 0, i32 4
  %6 = load i8, ptr %ostring162, align 8
...
if.then176:                                       ; preds = %for.body159, %for.body159, %lor.lhs.false170
  %i.11749 = add nsw i32 %i.01757, 1
  %cmp1801750 = icmp slt i32 %i.11749, %num.31755
  br i1 %cmp1801750, label %for.body182.preheader, label %for.end189

for.body182.preheader:                            ; preds = %if.then176
  %8 = sext i32 %i.11749 to i64
  %9 = add i32 %num.31755, -2
  %10 = sub i32 %9, %i.01757
  %11 = zext i32 %10 to i64
  %12 = add nuw nsw i64 %11, 1
  %min.iters.check = icmp ult i32 %10, 19
  %13 = add i32 %num.31755, -2
  %14 = icmp slt i32 %13, %i.01757
  %or.cond1955 = select i1 %min.iters.check, i1 true, i1 %14
  br i1 %or.cond1955, label %for.body182.preheader2003, label %vector.memcheck

vector.memcheck:                                  ; preds = %for.body182.preheader
  %15 = sext i32 %i.01757 to i64
  %16 = shl nsw i64 %15, 3
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.end189, label %for.body182.preheader2003

for.body182.preheader2003:                        ; preds = %vector.memcheck, %for.body182.preheader, %middle.block
  %indvars.iv.ph = phi i64 [ %8, %vector.memcheck ], [ %8, %for.body182.preheader ], [ %ind.end, %middle.block ]
  %i.1.in1751.ph = phi i32 [ %i.01757, %vector.memcheck ], [ %i.01757, %for.body182.preheader ], [ %ind.end1949, %middle.block ]
  %27 = trunc i64 %indvars.iv.ph to i32
  %28 = sub i32 %num.31755, %27
  %29 = xor i32 %27, -1
  %30 = add i32 %num.31755, %29
  %xtraiter = and i32 %28, 3
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %for.body182.prol.loopexit, label %for.body182.prol

for.body182.prol:                                 ; preds = %for.body182.preheader2003, %for.body182.prol
  %indvars.iv.prol = phi i64 [ %indvars.iv.next.prol, %for.body182.prol ], [ %indvars.iv.ph, %for.body182.preheader2003 ]
  %i.1.in1751.prol = phi i32 [ %32, %for.body182.prol ], [ %i.1.in1751.ph, %for.body182.preheader2003 ]
  %prol.iter = phi i32 [ %prol.iter.next, %for.body182.prol ], [ 0, %for.body182.preheader2003 ]
  %arrayidx184.prol = getelementptr inbounds [3 x ptr], ptr %par, i64 0, i64 %indvars.iv.prol
  %31 = load ptr, ptr %arrayidx184.prol, align 8
  %idxprom185.prol = sext i32 %i.1.in1751.prol to i64
  %arrayidx186.prol = getelementptr inbounds [3 x ptr], ptr %par, i64 0, i64 %idxprom185.prol
  store ptr %31, ptr %arrayidx186.prol, align 8
  %indvars.iv.next.prol = add nsw i64 %indvars.iv.prol, 1
  %32 = trunc i64 %indvars.iv.prol to i32
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body182.prol.loopexit, label %for.body182.prol

for.body182.prol.loopexit:                        ; preds = %for.body182.prol, %for.body182.preheader2003
  %indvars.iv.unr = phi i64 [ %indvars.iv.ph, %for.body182.preheader2003 ], [ %indvars.iv.next.prol, %for.body182.prol ]
  %i.1.in1751.unr = phi i32 [ %i.1.in1751.ph, %for.body182.preheader2003 ], [ %32, %for.body182.prol ]
...
for.body182:                                      ; preds = %for.body182.prol.loopexit, %for.body182
  ...
  %i.1.in1751 = phi i32 [ %38, %for.body182 ], [ %i.1.in1751.unr, %for.body182.prol.loopexit ]
  %arrayidx184 = getelementptr inbounds [3 x ptr], ptr %par, i64 0, i64 %indvars.iv
  %34 = load ptr, ptr %arrayidx184, align 8
  %idxprom185 = sext i32 %i.1.in1751 to i64
  %arrayidx186 = getelementptr inbounds [3 x ptr], ptr %par, i64 0, i64 %idxprom185
  store ptr %34, ptr %arrayidx186, align 8
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
  %arrayidx184.1 = getelementptr inbounds [3 x ptr], ptr %par, i64 0, i64 %indvars.iv.next
  %35 = load ptr, ptr %arrayidx184.1, align 8
  %sext = shl i64 %indvars.iv, 32
  %idxprom185.1 = ashr exact i64 %sext, 32
  %arrayidx186.1 = getelementptr inbounds [3 x ptr], ptr %par, i64 0, i64 %idxprom185.1
  store ptr %35, ptr %arrayidx186.1, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %arrayidx184.2 = getelementptr inbounds [3 x ptr], ptr %par, i64 0, i64 %indvars.iv.next.1
  %36 = load ptr, ptr %arrayidx184.2, align 8
  %sext2008 = shl i64 %indvars.iv.next, 32
  %idxprom185.2 = ashr exact i64 %sext2008, 32
  %arrayidx186.2 = getelementptr inbounds [3 x ptr], ptr %par, i64 0, i64 %idxprom185.2
  store ptr %36, ptr %arrayidx186.2, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %arrayidx184.3 = getelementptr inbounds [3 x ptr], ptr %par, i64 0, i64 %indvars.iv.next.2
  %37 = load ptr, ptr %arrayidx184.3, align 8
  %sext2009 = shl i64 %indvars.iv.next.1, 32
  %idxprom185.3 = ashr exact i64 %sext2009, 32
  %arrayidx186.3 = getelementptr inbounds [3 x ptr], ptr %par, i64 0, i64 %idxprom185.3
  store ptr %37, ptr %arrayidx186.3, align 8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %38 = trunc i64 %indvars.iv.next.2 to i32
  %lftr.wideiv.3 = trunc i64 %indvars.iv.next.3 to i32
  %exitcond.not.3 = icmp eq i32 %num.31755, %lftr.wideiv.3
  br i1 %exitcond.not.3, label %for.end189, label %for.body182

for.end189:                                       ; preds = %for.body182.prol.loopexit, %for.body182, %middle.block, %if.then176
  %i.1.lcssa = phi i32 [ %i.11749, %if.then176 ], [ %num.31755, %middle.block ], [ %num.31755, %for.body182 ], [ %num.31755, %for.body182.prol.loopexit ]
  %dec = add nsw i32 %num.31755, -1
  br label %for.inc191

for.inc191:                                       ; preds = %lor.lhs.false170, %for.end189
  %num.4 = phi i32 [ %dec, %for.end189 ], [ %num.31755, %lor.lhs.false170 ]
  %requested_size.1 = phi ptr [ %5, %for.end189 ], [ %requested_size.01756, %lor.lhs.false170 ]
  %i.2 = phi i32 [ %i.1.lcssa, %for.end189 ], [ %i.01757, %lor.lhs.false170 ]
  %inc192 = add nsw i32 %i.2, 1
  %cmp157 = icmp slt i32 %inc192, %num.4
  br i1 %cmp157, label %for.body159, label %for.end193
...
sw.bb194:                                         ; preds = %for.end193
  %39 = load ptr, ptr %par, align 16
  br label %sw.epilog

sw.bb196:                                         ; preds = %for.end193
  %40 = load ptr, ptr %par, align 16
  %arrayidx198 = getelementptr inbounds [3 x ptr], ptr %par, i64 0, i64 1
  %41 = load ptr, ptr %arrayidx198, align 8
  br label %sw.epilog
...
if.then221:                                       ; preds = %land.lhs.true206, %if.end218
  %42 = load ptr, ptr @font_root, align 8
...
for.cond225:                                      ; preds = %for.end243, %if.then221
  %.pn = phi ptr [ %42, %if.then221 ], [ %link.1, %for.end243 ]
...
for.cond232:                                      ; preds = %for.cond225, %for.cond232
  ...
  %43 = load i8, ptr %ou1233, align 8
  %cmp236 = icmp eq i8 %43, 0
  br i1 %cmp236, label %for.cond232, label %for.end243
...
for.end243:                                       ; preds = %for.cond232
  ...
  br i1 %cmp249, label %if.then363, label %for.cond225

if.else262:                                       ; preds = %if.end218
  %44 = load ptr, ptr @finfo, align 8
...
if.then279:                                       ; preds = %if.else262
  ...
  %.pre = load ptr, ptr @finfo, align 8
  %bf.load283.pre = load i32, ptr %ofont, align 4
  %.pre1841 = and i32 %bf.load283.pre, 4095
  %.pre1842 = zext i32 %.pre1841 to i64
  br label %if.end281

if.end281:                                        ; preds = %if.then279, %if.else262
  %idxprom285.pre-phi = phi i64 [ %.pre1842, %if.then279 ], [ %idxprom266, %if.else262 ]
...
if.end319:                                        ; preds = %for.cond294, %for.cond294, %if.then317
  ...
  %53 = load ptr, ptr %osucc322, align 8
...
if.then325:                                       ; preds = %if.end319
  ...
  %.pre1834 = load ptr, ptr %osucc322, align 8
  br label %for.cond334.preheader

for.cond334.preheader:                            ; preds = %if.then325, %if.end319
  %family.0.in.ph = phi ptr [ %53, %if.end319 ], [ %.pre1834, %if.then325 ]
...
for.cond377:                                      ; preds = %for.cond370, %for.cond377
  ...
  %57 = load i8, ptr %ou1378, align 8
  %cmp381 = icmp eq i8 %57, 0
  br i1 %cmp381, label %for.cond377, label %for.end388
...
for.end388:                                       ; preds = %for.cond377
  ...
  br i1 %cmp394, label %if.end536, label %for.cond370

if.else407:                                       ; preds = %if.then363
  %58 = load ptr, ptr @finfo, align 8
...
if.end.i:                                         ; preds = %if.then.i, %if.end471
  ...
  %69 = load ptr, ptr %osucc.i, align 8
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.end.i, %if.end.i
  %.pn.i = phi ptr [ %69, %if.end.i ], [ %link.0.i, %for.end.i ]
  %link.0.in.i = getelementptr inbounds [2 x %struct.LIST], ptr %.pn.i, i64 0, i64 1, i32 1
  %link.0.i = load ptr, ptr %link.0.in.i, align 8
...
for.cond9.i:                                      ; preds = %for.cond.i, %for.cond9.i
  ...
  %db.0.i = load ptr, ptr %db.0.in.i, align 8
  %ou1.i = getelementptr inbounds %struct.word_type, ptr %db.0.i, i64 0, i32 1
  %70 = load i8, ptr %ou1.i, align 8
  %cmp10.i = icmp eq i8 %70, 0
  br i1 %cmp10.i, label %for.cond9.i, label %for.end.i

for.end.i:                                        ; preds = %for.cond9.i
  %71 = load ptr, ptr @FontDefSym, align 8
  ...
  br i1 %tobool.not.i, label %for.cond.i, label %if.end29.i

if.end29.i:                                       ; preds = %for.end.i
  call void @SwitchScope(ptr noundef null) #14
  %72 = load i16, ptr %dfnum.i, align 2
  %73 = load i64, ptr %dfpos.i, align 8
  %74 = load i32, ptr %dlnum.i, align 4
...
if.then33.i:                                      ; preds = %if.end29.i
  %75 = load ptr, ptr @no_fpos, align 8
...
if.end36.i:                                       ; preds = %if.then33.i, %if.end29.i
  %ylink.0.in2113.i = getelementptr inbounds %struct.LIST, ptr %call30.i, i64 0, i32 1
  %ylink.02114.i = load ptr, ptr %ylink.0.in2113.i, align 8
  %cmp41.not2115.i = icmp eq ptr %ylink.02114.i, %call30.i
  br i1 %cmp41.not2115.i, label %for.end371.i, label %for.cond47.preheader.lr.ph.i
...
for.cond47.preheader.i:                           ; preds = %for.inc367.i, %for.cond47.preheader.lr.ph.i
  %ylink.02123.i = phi ptr [ %ylink.02114.i, %for.cond47.preheader.lr.ph.i ], [ %ylink.0.i, %for.inc367.i ]
  %family.02122.i = phi ptr [ null, %for.cond47.preheader.lr.ph.i ], [ %family.2.i, %for.inc367.i ]
  %face.02121.i = phi ptr [ null, %for.cond47.preheader.lr.ph.i ], [ %face.2.i, %for.inc367.i ]
  %font_name.02120.i = phi ptr [ null, %for.cond47.preheader.lr.ph.i ], [ %font_name.2.i, %for.inc367.i ]
  %AFMfilename.02119.i = phi ptr [ null, %for.cond47.preheader.lr.ph.i ], [ %AFMfilename.2.i, %for.inc367.i ]
  %Extrafilename.02118.i = phi ptr [ null, %for.cond47.preheader.lr.ph.i ], [ %Extrafilename.2.i, %for.inc367.i ]
  %LCMfilename.02117.i = phi ptr [ null, %for.cond47.preheader.lr.ph.i ], [ %LCMfilename.2.i, %for.inc367.i ]
  %recode.02116.i = phi ptr [ null, %for.cond47.preheader.lr.ph.i ], [ %recode.2.i, %for.inc367.i ]
  br label %for.cond47.i

for.cond47.i:                                     ; preds = %for.cond47.i, %for.cond47.preheader.i
  %ylink.0.pn.i = phi ptr [ %y.0.i, %for.cond47.i ], [ %ylink.02123.i, %for.cond47.preheader.i ]
  ...
  %76 = load i8, ptr %ou148.i, align 8
...
if.then64.i:                                      ; preds = %for.cond47.i
  %77 = load ptr, ptr @no_fpos, align 8
...
if.then73.i:                                      ; preds = %if.else.i
  ...
  %81 = load ptr, ptr %osucc76.i, align 8
  br label %for.cond80.i

for.cond80.i:                                     ; preds = %for.cond80.i, %if.then73.i
  %.pn2061.i = phi ptr [ %81, %if.then73.i ], [ %family.1.i, %for.cond80.i ]
  %family.1.in.i = getelementptr inbounds [2 x %struct.LIST], ptr %.pn2061.i, i64 0, i64 1
  %family.1.i = load ptr, ptr %family.1.in.i, align 8
  %ou181.i = getelementptr inbounds %struct.word_type, ptr %family.1.i, i64 0, i32 1
  %82 = load i8, ptr %ou181.i, align 8
...
if.else114.i:                                     ; preds = %if.else.i
  %83 = load ptr, ptr @fd_face, align 8
...
if.then118.i:                                     ; preds = %if.else114.i
  ...
  %84 = load ptr, ptr %osucc121.i, align 8
  br label %for.cond125.i

for.cond125.i:                                    ; preds = %for.cond125.i, %if.then118.i
  %.pn2060.i = phi ptr [ %84, %if.then118.i ], [ %face.1.i, %for.cond125.i ]
  %face.1.in.i = getelementptr inbounds [2 x %struct.LIST], ptr %.pn2060.i, i64 0, i64 1
  %face.1.i = load ptr, ptr %face.1.in.i, align 8
  %ou1126.i = getelementptr inbounds %struct.word_type, ptr %face.1.i, i64 0, i32 1
  %85 = load i8, ptr %ou1126.i, align 8
...
if.else161.i:                                     ; preds = %if.else114.i
  %86 = load ptr, ptr @fd_name, align 8
...
if.then165.i:                                     ; preds = %if.else161.i
  ...
  %87 = load ptr, ptr %osucc168.i, align 8
  br label %for.cond172.i

for.cond172.i:                                    ; preds = %for.cond172.i, %if.then165.i
  %.pn2059.i = phi ptr [ %87, %if.then165.i ], [ %font_name.1.i, %for.cond172.i ]
  %font_name.1.in.i = getelementptr inbounds [2 x %struct.LIST], ptr %.pn2059.i, i64 0, i64 1
  %font_name.1.i = load ptr, ptr %font_name.1.in.i, align 8
  %ou1173.i = getelementptr inbounds %struct.word_type, ptr %font_name.1.i, i64 0, i32 1
  %88 = load i8, ptr %ou1173.i, align 8
  %cmp176.i = icmp eq i8 %88, 0
  br i1 %cmp176.i, label %for.cond172.i, label %for.end183.i
...
for.end183.i:                                     ; preds = %for.cond172.i
  ...
  %89 = load i8, ptr %ou1185.i, align 8
  %.off.i = add i8 %89, -11
...
if.else200.i:                                     ; preds = %if.else161.i
  %90 = load ptr, ptr @fd_metrics, align 8
...
if.then204.i:                                     ; preds = %if.else200.i
  ...
  %91 = load ptr, ptr %osucc207.i, align 8
  br label %for.cond211.i

for.cond211.i:                                    ; preds = %for.cond211.i, %if.then204.i
  %.pn2058.i = phi ptr [ %91, %if.then204.i ], [ %AFMfilename.1.i, %for.cond211.i ]
  %AFMfilename.1.in.i = getelementptr inbounds [2 x %struct.LIST], ptr %.pn2058.i, i64 0, i64 1
  %AFMfilename.1.i = load ptr, ptr %AFMfilename.1.in.i, align 8
  %ou1212.i = getelementptr inbounds %struct.word_type, ptr %AFMfilename.1.i, i64 0, i32 1
  %92 = load i8, ptr %ou1212.i, align 8
  %cmp215.i = icmp eq i8 %92, 0
  br i1 %cmp215.i, label %for.cond211.i, label %for.end222.i
...
for.end222.i:                                     ; preds = %for.cond211.i
  ...
  %93 = load i8, ptr %ou1224.i, align 8
  %.off2064.i = add i8 %93, -11
  %switch2065.i = icmp ult i8 %.off2064.i, 2
  br i1 %switch2065.i, label %for.inc367.i, label %if.then235.i
...
if.else239.i:                                     ; preds = %if.else200.i
  %94 = load ptr, ptr @fd_extra_metrics, align 8
...
if.then243.i:                                     ; preds = %if.else239.i
  ...
  %95 = load ptr, ptr %osucc246.i, align 8
  br label %for.cond250.i

for.cond250.i:                                    ; preds = %for.cond250.i, %if.then243.i
  %.pn2057.i = phi ptr [ %95, %if.then243.i ], [ %Extrafilename.1.i, %for.cond250.i ]
  %Extrafilename.1.in.i = getelementptr inbounds [2 x %struct.LIST], ptr %.pn2057.i, i64 0, i64 1
  %Extrafilename.1.i = load ptr, ptr %Extrafilename.1.in.i, align 8
  %ou1251.i = getelementptr inbounds %struct.word_type, ptr %Extrafilename.1.i, i64 0, i32 1
  %96 = load i8, ptr %ou1251.i, align 8
  %cmp254.i = icmp eq i8 %96, 0
  br i1 %cmp254.i, label %for.cond250.i, label %for.end261.i
...
for.end261.i:                                     ; preds = %for.cond250.i
  ...
  %97 = load i8, ptr %ou1263.i, align 8
  %.off2066.i = add i8 %97, -11
  %switch2067.i = icmp ult i8 %.off2066.i, 2
  br i1 %switch2067.i, label %for.inc367.i, label %if.then274.i
...
if.else278.i:                                     ; preds = %if.else239.i
  %98 = load ptr, ptr @fd_mapping, align 8
...
if.then282.i:                                     ; preds = %if.else278.i
  ...
  %99 = load ptr, ptr %osucc285.i, align 8
  br label %for.cond289.i

for.cond289.i:                                    ; preds = %for.cond289.i, %if.then282.i
  %.pn2056.i = phi ptr [ %99, %if.then282.i ], [ %LCMfilename.1.i, %for.cond289.i ]
  %LCMfilename.1.in.i = getelementptr inbounds [2 x %struct.LIST], ptr %.pn2056.i, i64 0, i64 1
  %LCMfilename.1.i = load ptr, ptr %LCMfilename.1.in.i, align 8
  %ou1290.i = getelementptr inbounds %struct.word_type, ptr %LCMfilename.1.i, i64 0, i32 1
  %100 = load i8, ptr %ou1290.i, align 8
  %cmp293.i = icmp eq i8 %100, 0
  br i1 %cmp293.i, label %for.cond289.i, label %for.end300.i
...
for.end300.i:                                     ; preds = %for.cond289.i
  ...
  %101 = load i8, ptr %ou1302.i, align 8
  %.off2068.i = add i8 %101, -11
  %switch2069.i = icmp ult i8 %.off2068.i, 2
  br i1 %switch2069.i, label %for.inc367.i, label %if.then313.i
...
if.else317.i:                                     ; preds = %if.else278.i
  %102 = load ptr, ptr @fd_recode, align 8
...
if.then321.i:                                     ; preds = %if.else317.i
  ...
  %103 = load ptr, ptr %osucc324.i, align 8
  br label %for.cond328.i

for.cond328.i:                                    ; preds = %for.cond328.i, %if.then321.i
  %.pn2055.i = phi ptr [ %103, %if.then321.i ], [ %recode.1.i, %for.cond328.i ]
  %recode.1.in.i = getelementptr inbounds [2 x %struct.LIST], ptr %.pn2055.i, i64 0, i64 1
  %recode.1.i = load ptr, ptr %recode.1.in.i, align 8
  %ou1329.i = getelementptr inbounds %struct.word_type, ptr %recode.1.i, i64 0, i32 1
  %104 = load i8, ptr %ou1329.i, align 8
  %cmp332.i = icmp eq i8 %104, 0
  br i1 %cmp332.i, label %for.cond328.i, label %for.end339.i
...
for.end339.i:                                     ; preds = %for.cond328.i
  ...
  %105 = load i8, ptr %ou1341.i, align 8
  %.off2070.i = add i8 %105, -11
  %switch2071.i = icmp ult i8 %.off2070.i, 2
  br i1 %switch2071.i, label %for.inc367.i, label %if.then352.i

if.then352.i:                                     ; preds = %for.end339.i
  %106 = load ptr, ptr @fd_recode, align 8
...
if.else357.i:                                     ; preds = %if.else317.i
  %107 = load ptr, ptr @no_fpos, align 8
...
for.inc367.i:                                     ; preds = %if.else357.i, %if.then352.i, %for.end339.i, %if.then313.i, %for.end300.i, %if.then274.i, %for.end261.i, %if.then235.i, %for.end222.i, %if.then196.i, %for.end183.i, %if.then154.i, %lor.lhs.false148.i, %if.then107.i, %lor.lhs.false102.i, %if.end66.i
  %recode.2.i = phi ptr [ %recode.02116.i, %if.end66.i ], [ %recode.02116.i, %lor.lhs.false102.i ], [ %recode.02116.i, %if.then107.i ], [ %recode.02116.i, %lor.lhs.false148.i ], [ %recode.02116.i, %if.then154.i ], [ %recode.02116.i, %if.then196.i ], [ %recode.02116.i, %if.then235.i ], [ %recode.02116.i, %if.then274.i ], [ %recode.02116.i, %if.then313.i ], [ %call340.i, %if.then352.i ], [ %recode.02116.i, %if.else357.i ], [ %recode.02116.i, %for.end183.i ], [ %recode.02116.i, %for.end222.i ], [ %recode.02116.i, %for.end261.i ], [ %recode.02116.i, %for.end300.i ], [ %call340.i, %for.end339.i ]
  %LCMfilename.2.i = phi ptr [ %LCMfilename.02117.i, %if.end66.i ], [ %LCMfilename.02117.i, %lor.lhs.false102.i ], [ %LCMfilename.02117.i, %if.then107.i ], [ %LCMfilename.02117.i, %lor.lhs.false148.i ], [ %LCMfilename.02117.i, %if.then154.i ], [ %LCMfilename.02117.i, %if.then196.i ], [ %LCMfilename.02117.i, %if.then235.i ], [ %LCMfilename.02117.i, %if.then274.i ], [ %call301.i, %if.then313.i ], [ %LCMfilename.02117.i, %if.then352.i ], [ %LCMfilename.02117.i, %if.else357.i ], [ %LCMfilename.02117.i, %for.end183.i ], [ %LCMfilename.02117.i, %for.end222.i ], [ %LCMfilename.02117.i, %for.end261.i ], [ %call301.i, %for.end300.i ], [ %LCMfilename.02117.i, %for.end339.i ]
  %Extrafilename.2.i = phi ptr [ %Extrafilename.02118.i, %if.end66.i ], [ %Extrafilename.02118.i, %lor.lhs.false102.i ], [ %Extrafilename.02118.i, %if.then107.i ], [ %Extrafilename.02118.i, %lor.lhs.false148.i ], [ %Extrafilename.02118.i, %if.then154.i ], [ %Extrafilename.02118.i, %if.then196.i ], [ %Extrafilename.02118.i, %if.then235.i ], [ %call262.i, %if.then274.i ], [ %Extrafilename.02118.i, %if.then313.i ], [ %Extrafilename.02118.i, %if.then352.i ], [ %Extrafilename.02118.i, %if.else357.i ], [ %Extrafilename.02118.i, %for.end183.i ], [ %Extrafilename.02118.i, %for.end222.i ], [ %call262.i, %for.end261.i ], [ %Extrafilename.02118.i, %for.end300.i ], [ %Extrafilename.02118.i, %for.end339.i ]
  %AFMfilename.2.i = phi ptr [ %AFMfilename.02119.i, %if.end66.i ], [ %AFMfilename.02119.i, %lor.lhs.false102.i ], [ %AFMfilename.02119.i, %if.then107.i ], [ %AFMfilename.02119.i, %lor.lhs.false148.i ], [ %AFMfilename.02119.i, %if.then154.i ], [ %AFMfilename.02119.i, %if.then196.i ], [ %call223.i, %if.then235.i ], [ %AFMfilename.02119.i, %if.then274.i ], [ %AFMfilename.02119.i, %if.then313.i ], [ %AFMfilename.02119.i, %if.then352.i ], [ %AFMfilename.02119.i, %if.else357.i ], [ %AFMfilename.02119.i, %for.end183.i ], [ %call223.i, %for.end222.i ], [ %AFMfilename.02119.i, %for.end261.i ], [ %AFMfilename.02119.i, %for.end300.i ], [ %AFMfilename.02119.i, %for.end339.i ]
  %font_name.2.i = phi ptr [ %font_name.02120.i, %if.end66.i ], [ %font_name.02120.i, %lor.lhs.false102.i ], [ %font_name.02120.i, %if.then107.i ], [ %font_name.02120.i, %lor.lhs.false148.i ], [ %font_name.02120.i, %if.then154.i ], [ %call184.i, %if.then196.i ], [ %font_name.02120.i, %if.then235.i ], [ %font_name.02120.i, %if.then274.i ], [ %font_name.02120.i, %if.then313.i ], [ %font_name.02120.i, %if.then352.i ], [ %font_name.02120.i, %if.else357.i ], [ %call184.i, %for.end183.i ], [ %font_name.02120.i, %for.end222.i ], [ %font_name.02120.i, %for.end261.i ], [ %font_name.02120.i, %for.end300.i ], [ %font_name.02120.i, %for.end339.i ]
  %face.2.i = phi ptr [ %face.02121.i, %if.end66.i ], [ %face.02121.i, %lor.lhs.false102.i ], [ %face.02121.i, %if.then107.i ], [ %face.1.i, %lor.lhs.false148.i ], [ %face.1.i, %if.then154.i ], [ %face.02121.i, %if.then196.i ], [ %face.02121.i, %if.then235.i ], [ %face.02121.i, %if.then274.i ], [ %face.02121.i, %if.then313.i ], [ %face.02121.i, %if.then352.i ], [ %face.02121.i, %if.else357.i ], [ %face.02121.i, %for.end183.i ], [ %face.02121.i, %for.end222.i ], [ %face.02121.i, %for.end261.i ], [ %face.02121.i, %for.end300.i ], [ %face.02121.i, %for.end339.i ]
  %family.2.i = phi ptr [ %family.02122.i, %if.end66.i ], [ %family.1.i, %lor.lhs.false102.i ], [ %family.1.i, %if.then107.i ], [ %family.02122.i, %lor.lhs.false148.i ], [ %family.02122.i, %if.then154.i ], [ %family.02122.i, %if.then196.i ], [ %family.02122.i, %if.then235.i ], [ %family.02122.i, %if.then274.i ], [ %family.02122.i, %if.then313.i ], [ %family.02122.i, %if.then352.i ], [ %family.02122.i, %if.else357.i ], [ %family.02122.i, %for.end183.i ], [ %family.02122.i, %for.end222.i ], [ %family.02122.i, %for.end261.i ], [ %family.02122.i, %for.end300.i ], [ %family.02122.i, %for.end339.i ]
  %ylink.0.in.i = getelementptr inbounds %struct.LIST, ptr %ylink.02123.i, i64 0, i32 1
  %ylink.0.i = load ptr, ptr %ylink.0.in.i, align 8
  %cmp41.not.i = icmp eq ptr %ylink.0.i, %call30.i
  br i1 %cmp41.not.i, label %for.end371.i, label %for.cond47.preheader.i
...
if.end387.i:                                      ; preds = %for.end371.i
  %108 = load ptr, ptr @font_root, align 8
...
for.cond391.i:                                    ; preds = %for.end409.i, %if.end387.i
  %.pn2042.i = phi ptr [ %108, %if.end387.i ], [ %link.1.i, %for.end409.i ]
  %link.1.in.i = getelementptr inbounds %struct.LIST, ptr %.pn2042.i, i64 0, i32 1
...
for.cond398.i:                                    ; preds = %for.cond391.i, %for.cond398.i
  ...
  %109 = load i8, ptr %ou1399.i, align 8
  %cmp402.i = icmp eq i8 %109, 0
  br i1 %cmp402.i, label %for.cond398.i, label %for.end409.i
...
if.then426.i:                                     ; preds = %for.cond391.i
  ...
  %111 = load ptr, ptr %osucc432.i, align 8
...
cond.false.i:                                     ; preds = %if.then426.i
  ...
  %113 = load ptr, ptr @zz_res, align 8
  %114 = load ptr, ptr @zz_hold, align 8
  %115 = load ptr, ptr %114, align 8
  %osucc449.i = getelementptr inbounds %struct.LIST, ptr %115, i64 0, i32 1
  store ptr %113, ptr %osucc449.i, align 8
  %osucc452.i = getelementptr inbounds %struct.LIST, ptr %114, i64 0, i32 1
  store ptr %114, ptr %osucc452.i, align 8
  store ptr %114, ptr %114, align 8
  %.pre.i = load ptr, ptr @xx_link, align 8
  %.pre2212.i = load ptr, ptr @font_root, align 8
  br label %cond.end.i

cond.end.i:                                       ; preds = %cond.false.i, %if.then426.i
  %116 = phi ptr [ %108, %if.then426.i ], [ %.pre2212.i, %cond.false.i ]
  %117 = phi ptr [ %110, %if.then426.i ], [ %.pre.i, %cond.false.i ]
  store ptr %117, ptr @zz_res, align 8
  store ptr %116, ptr @zz_hold, align 8
  %cmp456.i = icmp eq ptr %116, null
  %cmp460.i = icmp eq ptr %117, null
  %or.cond2072.i = select i1 %cmp456.i, i1 true, i1 %cmp460.i
  br i1 %or.cond2072.i, label %if.end489.i, label %cond.false463.i

cond.false463.i:                                  ; preds = %cond.end.i
  %118 = load ptr, ptr %116, align 8
  store ptr %118, ptr @zz_tmp, align 8
  %119 = load ptr, ptr %117, align 8
  store ptr %119, ptr %116, align 8
  %120 = load ptr, ptr @zz_hold, align 8
  %121 = load ptr, ptr @zz_res, align 8
  %122 = load ptr, ptr %121, align 8
  %osucc478.i = getelementptr inbounds %struct.LIST, ptr %122, i64 0, i32 1
  store ptr %120, ptr %osucc478.i, align 8
  %123 = load ptr, ptr @zz_tmp, align 8
  ...
  store ptr %124, ptr %osucc484.i, align 8
  br label %if.end489.i

if.end489.i:                                      ; preds = %for.end409.i, %cond.false463.i, %cond.end.i
  %family.32081.i = phi ptr [ %family.0.lcssa.i, %cond.end.i ], [ %family.0.lcssa.i, %cond.false463.i ], [ %y.1.i, %for.end409.i ]
...
for.cond493.i:                                    ; preds = %for.end511.i, %if.end489.i
  %family.3.pn.i = phi ptr [ %family.32081.i, %if.end489.i ], [ %link.2.i, %for.end511.i ]
  %link.2.in.i = getelementptr inbounds %struct.LIST, ptr %family.3.pn.i, i64 0, i32 1
  %link.2.i = load ptr, ptr %link.2.in.i, align 8
  %cmp494.not.i = icmp eq ptr %link.2.i, %family.32081.i
...
for.cond500.i:                                    ; preds = %for.cond493.i, %for.cond500.i
  ...
  %126 = load i8, ptr %ou1501.i, align 8
  %cmp504.i = icmp eq i8 %126, 0
  br i1 %cmp504.i, label %for.cond500.i, label %for.end511.i
...
for.end511.i:                                     ; preds = %for.cond500.i
  ...
  br i1 %cmp517.i, label %FontRead.exit.thread1682, label %for.cond493.i
...
FontRead.exit.thread1682:                         ; preds = %for.end511.i
  ...
  %ostring521.i = getelementptr inbounds %struct.word_type, ptr %family.32081.i, i64 0, i32 4
...
for.end534.i:                                     ; preds = %for.cond493.i
  ...
  %127 = load ptr, ptr %osucc537.i, align 8
  store ptr %127, ptr @xx_link, align 8
  store ptr %127, ptr @zz_hold, align 8
  %osucc540.i = getelementptr inbounds %struct.LIST, ptr %127, i64 0, i32 1
  %128 = load ptr, ptr %osucc540.i, align 8
...
cond.false544.i:                                  ; preds = %for.end534.i
  ...
  %131 = load ptr, ptr @zz_hold, align 8
  %132 = load ptr, ptr %131, align 8
  %osucc559.i = getelementptr inbounds %struct.LIST, ptr %132, i64 0, i32 1
  store ptr %130, ptr %osucc559.i, align 8
  %osucc562.i = getelementptr inbounds %struct.LIST, ptr %131, i64 0, i32 1
  store ptr %131, ptr %osucc562.i, align 8
  store ptr %131, ptr %131, align 8
  %.pre2213.i = load ptr, ptr @xx_link, align 8
  br label %cond.end566.i

cond.end566.i:                                    ; preds = %cond.false544.i, %for.end534.i
  %133 = phi ptr [ %127, %for.end534.i ], [ %.pre2213.i, %cond.false544.i ]
  store ptr %133, ptr @zz_res, align 8
  store ptr %family.32081.i, ptr @zz_hold, align 8
  %cmp568.i = icmp eq ptr %family.32081.i, null
  %cmp572.i = icmp eq ptr %133, null
  %or.cond2073.i = select i1 %cmp568.i, i1 true, i1 %cmp572.i
  br i1 %or.cond2073.i, label %cond.end599.i, label %cond.false575.i

cond.false575.i:                                  ; preds = %cond.end566.i
  %134 = load ptr, ptr %family.32081.i, align 8
  store ptr %134, ptr @zz_tmp, align 8
  %135 = load ptr, ptr %133, align 8
  store ptr %135, ptr %family.32081.i, align 8
  %136 = load ptr, ptr @zz_hold, align 8
  %137 = load ptr, ptr @zz_res, align 8
  %138 = load ptr, ptr %137, align 8
  %osucc590.i = getelementptr inbounds %struct.LIST, ptr %138, i64 0, i32 1
  store ptr %136, ptr %osucc590.i, align 8
  %139 = load ptr, ptr @zz_tmp, align 8
  store ptr %139, ptr %137, align 8
  %140 = load ptr, ptr @zz_res, align 8
  %141 = load ptr, ptr @zz_tmp, align 8
  %osucc596.i = getelementptr inbounds %struct.LIST, ptr %141, i64 0, i32 1
  store ptr %140, ptr %osucc596.i, align 8
  br label %cond.end599.i

cond.end599.i:                                    ; preds = %cond.false575.i, %cond.end566.i
  %142 = load i8, ptr @zz_lengths, align 1
  %conv601.i = zext i8 %142 to i32
  store i32 %conv601.i, ptr @zz_size, align 4
  %conv602.i = zext i8 %142 to i64
  %arrayidx608.i = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv602.i
  %143 = load ptr, ptr %arrayidx608.i, align 8
  %cmp609.i = icmp eq ptr %143, null
  br i1 %cmp609.i, label %if.then611.i, label %if.else613.i

if.then611.i:                                     ; preds = %cond.end599.i
  %144 = load ptr, ptr @no_fpos, align 8
  %call612.i = call ptr @GetMemory(i32 noundef %conv601.i, ptr noundef %144) #14
  br label %cond.end668.i

if.else613.i:                                     ; preds = %cond.end599.i
  store ptr %143, ptr @zz_hold, align 8
  %145 = load ptr, ptr %143, align 8
  store ptr %145, ptr %arrayidx608.i, align 8
  br label %cond.end668.i

cond.end668.i:                                    ; preds = %if.else613.i, %if.then611.i
  %146 = phi ptr [ %call612.i, %if.then611.i ], [ %143, %if.else613.i ]
  %ou1623.i = getelementptr inbounds %struct.word_type, ptr %146, i64 0, i32 1
  store i8 0, ptr %ou1623.i, align 8
  %osucc627.i = getelementptr inbounds [2 x %struct.LIST], ptr %146, i64 0, i64 1, i32 1
  store ptr %146, ptr %osucc627.i, align 8
  %arrayidx629.i = getelementptr inbounds [2 x %struct.LIST], ptr %146, i64 0, i64 1
  store ptr %146, ptr %arrayidx629.i, align 8
  %osucc633.i = getelementptr inbounds %struct.LIST, ptr %146, i64 0, i32 1
  store ptr %146, ptr %osucc633.i, align 8
  store ptr %146, ptr %146, align 8
  store ptr %146, ptr @xx_link, align 8
  store ptr %146, ptr @zz_res, align 8
  store ptr %face.0.lcssa.i, ptr @zz_hold, align 8
  %147 = load ptr, ptr %face.0.lcssa.i, align 8
  store ptr %147, ptr @zz_tmp, align 8
  %148 = load ptr, ptr %146, align 8
  store ptr %148, ptr %face.0.lcssa.i, align 8
  %149 = load ptr, ptr @zz_hold, align 8
  %150 = load ptr, ptr @zz_res, align 8
  %151 = load ptr, ptr %150, align 8
  %osucc659.i = getelementptr inbounds %struct.LIST, ptr %151, i64 0, i32 1
  store ptr %149, ptr %osucc659.i, align 8
  %152 = load ptr, ptr @zz_tmp, align 8
  store ptr %152, ptr %150, align 8
  %153 = load ptr, ptr @zz_res, align 8
  %154 = load ptr, ptr @zz_tmp, align 8
  %osucc665.i = getelementptr inbounds %struct.LIST, ptr %154, i64 0, i32 1
  store ptr %153, ptr %osucc665.i, align 8
  %155 = load ptr, ptr @xx_link, align 8
  store ptr %155, ptr @zz_res, align 8
  store ptr %font_name.0.lcssa.i, ptr @zz_hold, align 8
  %cmp674.i = icmp eq ptr %155, null
  br i1 %cmp674.i, label %cond.end701.i, label %cond.false677.i

cond.false677.i:                                  ; preds = %cond.end668.i
  %arrayidx679.i = getelementptr inbounds [2 x %struct.LIST], ptr %font_name.0.lcssa.i, i64 0, i64 1
  %156 = load ptr, ptr %arrayidx679.i, align 8
  store ptr %156, ptr @zz_tmp, align 8
  %arrayidx682.i = getelementptr inbounds [2 x %struct.LIST], ptr %155, i64 0, i64 1
  %157 = load ptr, ptr %arrayidx682.i, align 8
  store ptr %157, ptr %arrayidx679.i, align 8
  %158 = load ptr, ptr %arrayidx682.i, align 8
  %osucc692.i = getelementptr inbounds [2 x %struct.LIST], ptr %158, i64 0, i64 1, i32 1
  store ptr %font_name.0.lcssa.i, ptr %osucc692.i, align 8
  store ptr %156, ptr %arrayidx682.i, align 8
  %osucc698.i = getelementptr inbounds [2 x %struct.LIST], ptr %156, i64 0, i64 1, i32 1
  store ptr %155, ptr %osucc698.i, align 8
  br label %cond.end701.i

cond.end701.i:                                    ; preds = %cond.false677.i, %cond.end668.i
  %159 = load i8, ptr @zz_lengths, align 1
  %conv703.i = zext i8 %159 to i32
  store i32 %conv703.i, ptr @zz_size, align 4
  %conv704.i = zext i8 %159 to i64
  %arrayidx711.i = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv704.i
  %160 = load ptr, ptr %arrayidx711.i, align 8
...
if.then714.i:                                     ; preds = %cond.end701.i
  ...
  br label %cond.end771.i

if.else716.i:                                     ; preds = %cond.end701.i
  store ptr %160, ptr @zz_hold, align 8
  %162 = load ptr, ptr %160, align 8
  store ptr %162, ptr %arrayidx711.i, align 8
  br label %cond.end771.i

cond.end771.i:                                    ; preds = %if.else716.i, %if.then714.i
  %163 = phi ptr [ %call715.i, %if.then714.i ], [ %160, %if.else716.i ]
  %ou1726.i = getelementptr inbounds %struct.word_type, ptr %163, i64 0, i32 1
  store i8 0, ptr %ou1726.i, align 8
  %osucc730.i = getelementptr inbounds [2 x %struct.LIST], ptr %163, i64 0, i64 1, i32 1
  store ptr %163, ptr %osucc730.i, align 8
  %arrayidx732.i = getelementptr inbounds [2 x %struct.LIST], ptr %163, i64 0, i64 1
  store ptr %163, ptr %arrayidx732.i, align 8
  %osucc736.i = getelementptr inbounds %struct.LIST, ptr %163, i64 0, i32 1
  store ptr %163, ptr %osucc736.i, align 8
  store ptr %163, ptr %163, align 8
  store ptr %163, ptr @xx_link, align 8
  store ptr %163, ptr @zz_res, align 8
  store ptr %face.0.lcssa.i, ptr @zz_hold, align 8
  %164 = load ptr, ptr %face.0.lcssa.i, align 8
  store ptr %164, ptr @zz_tmp, align 8
  %165 = load ptr, ptr %163, align 8
  store ptr %165, ptr %face.0.lcssa.i, align 8
  %166 = load ptr, ptr @zz_hold, align 8
  %167 = load ptr, ptr @zz_res, align 8
  %168 = load ptr, ptr %167, align 8
  %osucc762.i = getelementptr inbounds %struct.LIST, ptr %168, i64 0, i32 1
  store ptr %166, ptr %osucc762.i, align 8
  %169 = load ptr, ptr @zz_tmp, align 8
  store ptr %169, ptr %167, align 8
  %170 = load ptr, ptr @zz_res, align 8
  %171 = load ptr, ptr @zz_tmp, align 8
  %osucc768.i = getelementptr inbounds %struct.LIST, ptr %171, i64 0, i32 1
  store ptr %170, ptr %osucc768.i, align 8
  %172 = load ptr, ptr @xx_link, align 8
  store ptr %172, ptr @zz_res, align 8
  store ptr %AFMfilename.0.lcssa.i, ptr @zz_hold, align 8
  %cmp777.i = icmp eq ptr %172, null
  br i1 %cmp777.i, label %cond.end804.i, label %cond.false780.i

cond.false780.i:                                  ; preds = %cond.end771.i
...
if.then808.i:                                     ; preds = %cond.end804.i
  %176 = load i8, ptr @zz_lengths, align 1
  %conv809.i = zext i8 %176 to i32
  store i32 %conv809.i, ptr @zz_size, align 4
  %conv810.i = zext i8 %176 to i64
  %arrayidx817.i = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv810.i
  %177 = load ptr, ptr %arrayidx817.i, align 8
  %cmp818.i = icmp eq ptr %177, null
  br i1 %cmp818.i, label %if.then820.i, label %if.else822.i

if.then820.i:                                     ; preds = %if.then808.i
  %178 = load ptr, ptr @no_fpos, align 8
  %call821.i = call ptr @GetMemory(i32 noundef %conv809.i, ptr noundef %178) #14
  br label %cond.end877.i

if.else822.i:                                     ; preds = %if.then808.i
  store ptr %177, ptr @zz_hold, align 8
  %179 = load ptr, ptr %177, align 8
  store ptr %179, ptr %arrayidx817.i, align 8
  br label %cond.end877.i

cond.end877.i:                                    ; preds = %if.else822.i, %if.then820.i
  %180 = phi ptr [ %call821.i, %if.then820.i ], [ %177, %if.else822.i ]
  %ou1832.i = getelementptr inbounds %struct.word_type, ptr %180, i64 0, i32 1
  store i8 0, ptr %ou1832.i, align 8
  %osucc836.i = getelementptr inbounds [2 x %struct.LIST], ptr %180, i64 0, i64 1, i32 1
  store ptr %180, ptr %osucc836.i, align 8
  %arrayidx838.i = getelementptr inbounds [2 x %struct.LIST], ptr %180, i64 0, i64 1
  store ptr %180, ptr %arrayidx838.i, align 8
  %osucc842.i = getelementptr inbounds %struct.LIST, ptr %180, i64 0, i32 1
  store ptr %180, ptr %osucc842.i, align 8
  store ptr %180, ptr %180, align 8
  store ptr %180, ptr @xx_link, align 8
  store ptr %180, ptr @zz_res, align 8
  store ptr %AFMfilename.0.lcssa.i, ptr @zz_hold, align 8
  %181 = load ptr, ptr %AFMfilename.0.lcssa.i, align 8
  store ptr %181, ptr @zz_tmp, align 8
  %182 = load ptr, ptr %180, align 8
  store ptr %182, ptr %AFMfilename.0.lcssa.i, align 8
  ...
  store ptr %183, ptr %osucc868.i, align 8
  ...
  store ptr %187, ptr %osucc874.i, align 8
  %189 = load ptr, ptr @xx_link, align 8
  store ptr %189, ptr @zz_res, align 8
  store ptr %Extrafilename.0.lcssa.i, ptr @zz_hold, align 8
  %cmp883.i = icmp eq ptr %189, null
  br i1 %cmp883.i, label %if.end912.i, label %cond.false886.i

cond.false886.i:                                  ; preds = %cond.end877.i
  %arrayidx888.i = getelementptr inbounds [2 x %struct.LIST], ptr %Extrafilename.0.lcssa.i, i64 0, i64 1
  %190 = load ptr, ptr %arrayidx888.i, align 8
  store ptr %190, ptr @zz_tmp, align 8
  %arrayidx891.i = getelementptr inbounds [2 x %struct.LIST], ptr %189, i64 0, i64 1
  %191 = load ptr, ptr %arrayidx891.i, align 8
  store ptr %191, ptr %arrayidx888.i, align 8
  %192 = load ptr, ptr %arrayidx891.i, align 8
  %osucc901.i = getelementptr inbounds [2 x %struct.LIST], ptr %192, i64 0, i64 1, i32 1
  store ptr %Extrafilename.0.lcssa.i, ptr %osucc901.i, align 8
  store ptr %190, ptr %arrayidx891.i, align 8
  %osucc907.i = getelementptr inbounds [2 x %struct.LIST], ptr %190, i64 0, i64 1, i32 1
  store ptr %189, ptr %osucc907.i, align 8
  br label %if.end912.i

if.end912.i:                                      ; preds = %cond.false886.i, %cond.end877.i, %cond.end804.i
...
if.end953.i:                                      ; preds = %if.else949.i, %if.then935.i, %if.then920.i
  ...
  store i16 0, ptr %ofont_page.i, align 2
  %195 = load i32, ptr @font_count, align 4
  %inc.i = add i32 %195, 1
  store i32 %inc.i, ptr @font_count, align 4
  %196 = load i32, ptr @finfo_size, align 4
...
if.then959.i:                                     ; preds = %if.then956.i
  ...
  %.pre2214.i = load i32, ptr @finfo_size, align 4
  br label %if.end962.i

if.end962.i:                                      ; preds = %if.then959.i, %if.then956.i
  %197 = phi i32 [ %.pre2214.i, %if.then959.i ], [ %196, %if.then956.i ]
  %mul.i = shl nsw i32 %197, 1
  store i32 %mul.i, ptr @finfo_size, align 4
  %198 = load ptr, ptr @finfo, align 8
  ...
  store ptr %call965.i, ptr @finfo, align 8
...
if.then987.i:                                     ; preds = %if.end972.i
  ...
  br label %cond.end1044.i

if.else989.i:                                     ; preds = %if.end972.i
  store ptr %202, ptr @zz_hold, align 8
  %204 = load ptr, ptr %202, align 8
  store ptr %204, ptr %arrayidx984.i, align 8
  br label %cond.end1044.i

cond.end1044.i:                                   ; preds = %if.else989.i, %if.then987.i
  %205 = phi ptr [ %call988.i, %if.then987.i ], [ %202, %if.else989.i ]
  %ou1999.i = getelementptr inbounds %struct.word_type, ptr %205, i64 0, i32 1
  store i8 0, ptr %ou1999.i, align 8
  %osucc1003.i = getelementptr inbounds [2 x %struct.LIST], ptr %205, i64 0, i64 1, i32 1
  store ptr %205, ptr %osucc1003.i, align 8
  %arrayidx1005.i = getelementptr inbounds [2 x %struct.LIST], ptr %205, i64 0, i64 1
  store ptr %205, ptr %arrayidx1005.i, align 8
  %osucc1009.i = getelementptr inbounds %struct.LIST, ptr %205, i64 0, i32 1
  store ptr %205, ptr %osucc1009.i, align 8
  store ptr %205, ptr %205, align 8
  store ptr %205, ptr @xx_link, align 8
  store ptr %205, ptr @zz_res, align 8
  store ptr %face.0.lcssa.i, ptr @zz_hold, align 8
  %206 = load ptr, ptr %face.0.lcssa.i, align 8
  store ptr %206, ptr @zz_tmp, align 8
  %207 = load ptr, ptr %205, align 8
  store ptr %207, ptr %face.0.lcssa.i, align 8
  %208 = load ptr, ptr @zz_hold, align 8
  %209 = load ptr, ptr @zz_res, align 8
  %210 = load ptr, ptr %209, align 8
  %osucc1035.i = getelementptr inbounds %struct.LIST, ptr %210, i64 0, i32 1
  store ptr %208, ptr %osucc1035.i, align 8
  %211 = load ptr, ptr @zz_tmp, align 8
  store ptr %211, ptr %209, align 8
  %212 = load ptr, ptr @zz_res, align 8
  %213 = load ptr, ptr @zz_tmp, align 8
  %osucc1041.i = getelementptr inbounds %struct.LIST, ptr %213, i64 0, i32 1
  store ptr %212, ptr %osucc1041.i, align 8
  %214 = load ptr, ptr @xx_link, align 8
  store ptr %214, ptr @zz_res, align 8
  store ptr %call975.i, ptr @zz_hold, align 8
  %cmp1046.i = icmp eq ptr %call975.i, null
  %cmp1050.i = icmp eq ptr %214, null
  %or.cond2074.i = select i1 %cmp1046.i, i1 true, i1 %cmp1050.i
  br i1 %or.cond2074.i, label %cond.end1077.i, label %cond.false1053.i

cond.false1053.i:                                 ; preds = %cond.end1044.i
  %arrayidx1055.i = getelementptr inbounds [2 x %struct.LIST], ptr %call975.i, i64 0, i64 1
  %215 = load ptr, ptr %arrayidx1055.i, align 8
  store ptr %215, ptr @zz_tmp, align 8
  %arrayidx1058.i = getelementptr inbounds [2 x %struct.LIST], ptr %214, i64 0, i64 1
  %216 = load ptr, ptr %arrayidx1058.i, align 8
  store ptr %216, ptr %arrayidx1055.i, align 8
  %217 = load ptr, ptr %arrayidx1058.i, align 8
  %osucc1068.i = getelementptr inbounds [2 x %struct.LIST], ptr %217, i64 0, i64 1, i32 1
  store ptr %call975.i, ptr %osucc1068.i, align 8
  store ptr %215, ptr %arrayidx1058.i, align 8
  %osucc1074.i = getelementptr inbounds [2 x %struct.LIST], ptr %215, i64 0, i64 1, i32 1
  store ptr %214, ptr %osucc1074.i, align 8
  br label %cond.end1077.i

cond.end1077.i:                                   ; preds = %cond.false1053.i, %cond.end1044.i
  %218 = load i32, ptr @font_count, align 4
  ...
  store i32 %cond1089.i, ptr %ou31090.i, align 8
...
if.end1170.i:                                     ; preds = %if.then1166.i, %if.end1162.i
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(256) %call1163.i, i8 1, i64 256, i1 false)
  store i32 258, ptr %ligtop.i, align 4
...
if.end1195.i:                                     ; preds = %if.then1191.i, %if.end1187.i
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 2 dereferenceable(512) %call1180.i, i8 0, i64 512, i1 false)
...
if.end1212.i:                                     ; preds = %if.then1208.i, %if.end1195.i
  ...
  %call12232154.i = call ptr @fgets(ptr noundef nonnull %buff.i, i32 noundef 512, ptr noundef %call1127.i)
  %cond20752155.i = icmp eq ptr %call12232154.i, null
  br i1 %cond20752155.i, label %if.then1585.i, label %land.rhs.lr.ph.i
...
land.rhs.i:                                       ; preds = %sw.epilog.i, %land.rhs.lr.ph.i
  %ks.02166.i = phi ptr [ null, %land.rhs.lr.ph.i ], [ %ks.1.i, %sw.epilog.i ]
  %kv.02165.i = phi ptr [ null, %land.rhs.lr.ph.i ], [ %kv.1.i, %sw.epilog.i ]
  %kc.02164.i = phi ptr [ null, %land.rhs.lr.ph.i ], [ %kc.1.i, %sw.epilog.i ]
  %font_name_found.02163.i = phi i32 [ 0, %land.rhs.lr.ph.i ], [ %font_name_found.1.i, %sw.epilog.i ]
  %fixed_pitch.02162.i = phi i32 [ 0, %land.rhs.lr.ph.i ], [ %fixed_pitch.1.i, %sw.epilog.i ]
  %xhfound.02161.i = phi i32 [ 0, %land.rhs.lr.ph.i ], [ %xhfound.1.i, %sw.epilog.i ]
  %utfound.02160.i = phi i32 [ 0, %land.rhs.lr.ph.i ], [ %utfound.1.i, %sw.epilog.i ]
  %upfound.02159.i = phi i32 [ 0, %land.rhs.lr.ph.i ], [ %upfound.1.i, %sw.epilog.i ]
  %under_thick.02158.i = phi i32 [ 0, %land.rhs.lr.ph.i ], [ %under_thick.1.i, %sw.epilog.i ]
  %under_pos.02157.i = phi i32 [ 0, %land.rhs.lr.ph.i ], [ %under_pos.1.i, %sw.epilog.i ]
  %xheight2.02156.i = phi i32 [ 0, %land.rhs.lr.ph.i ], [ %xheight2.2.i, %sw.epilog.i ]
  %223 = load i8, ptr %buff.i, align 16
  %cmp1228.i = icmp eq i8 %223, 69
  br i1 %cmp1228.i, label %land.rhs1230.i, label %while.body.i

land.rhs1230.i:                                   ; preds = %land.rhs.i
  %bcmp2043.i = call i32 @bcmp(ptr noundef nonnull dereferenceable(16) %buff.i, ptr noundef nonnull dereferenceable(16) @.str.96, i64 16)
  %cmp1233.i = icmp eq i32 %bcmp2043.i, 0
  br i1 %cmp1233.i, label %if.end1589.i, label %while.body.i

while.body.i:                                     ; preds = %land.rhs1230.i, %land.rhs.i
  %224 = load i32, ptr %lnum.i, align 4
  %inc1236.i = add nsw i32 %224, 1
  store i32 %inc1236.i, ptr %lnum.i, align 4
  ...
  %225 = load i8, ptr %command.i, align 16
...
sw.bb.i:                                          ; preds = %while.body.i
  %bcmp2053.i = call i32 @bcmp(ptr noundef nonnull dereferenceable(18) %command.i, ptr noundef nonnull dereferenceable(18) @.str.97, i64 18)
  %cmp1244.i = icmp eq i32 %bcmp2053.i, 0
  br i1 %cmp1244.i, label %if.then1246.i, label %if.else1255.i

if.then1246.i:                                    ; preds = %sw.bb.i
  %tobool1247.not.i = icmp eq i32 %upfound.02159.i, 0
...
if.end1251.i:                                     ; preds = %if.then1248.i, %if.then1246.i
  ...
  %226 = load float, ptr %fl_under_pos.i, align 4
  %conv1254.i = fptosi float %226 to i32
  br label %sw.epilog.i

if.else1255.i:                                    ; preds = %sw.bb.i
  %bcmp2054.i = call i32 @bcmp(ptr noundef nonnull dereferenceable(19) %command.i, ptr noundef nonnull dereferenceable(19) @.str.100, i64 19)
  %cmp1258.i = icmp eq i32 %bcmp2054.i, 0
  br i1 %cmp1258.i, label %if.then1260.i, label %sw.epilog.i

if.then1260.i:                                    ; preds = %if.else1255.i
  %tobool1261.not.i = icmp eq i32 %utfound.02160.i, 0
...
if.end1265.i:                                     ; preds = %if.then1262.i, %if.then1260.i
  ...
  %227 = load float, ptr %fl_under_thick.i, align 4
...
if.then1276.i:                                    ; preds = %sw.bb1271.i
  %tobool1277.not.i = icmp eq i32 %xhfound.02161.i, 0
...
if.end1281.i:                                     ; preds = %if.then1278.i, %if.then1276.i
  ...
  %228 = load float, ptr %fl_xheight2.i, align 4
  %div.i = fmul float %228, 5.000000e-01
  %conv1284.i = fptosi float %div.i to i32
  br label %sw.epilog.i

sw.bb1286.i:                                      ; preds = %while.body.i
  %bcmp2050.i = call i32 @bcmp(ptr noundef nonnull dereferenceable(9) %command.i, ptr noundef nonnull dereferenceable(9) @.str.106, i64 9)
  %cmp1289.i = icmp eq i32 %bcmp2050.i, 0
  br i1 %cmp1289.i, label %if.then1291.i, label %sw.epilog.i

if.then1291.i:                                    ; preds = %sw.bb1286.i
  %tobool1292.not.i = icmp eq i32 %font_name_found.02163.i, 0
...
if.end1309.i:                                     ; preds = %if.then1305.i, %if.end1297.i
  %229 = load ptr, ptr %osucc1312.i, align 8
  br label %for.cond1316.i

for.cond1316.i:                                   ; preds = %for.cond1316.i, %if.end1309.i
  %.pn2051.i = phi ptr [ %229, %if.end1309.i ], [ %y.3.i, %for.cond1316.i ]
  %y.3.in.i = getelementptr inbounds [2 x %struct.LIST], ptr %.pn2051.i, i64 0, i64 1
  %y.3.i = load ptr, ptr %y.3.in.i, align 8
  %ou11317.i = getelementptr inbounds %struct.word_type, ptr %y.3.i, i64 0, i32 1
  %230 = load i8, ptr %ou11317.i, align 8
  %cmp1320.i = icmp eq i8 %230, 0
  br i1 %cmp1320.i, label %for.cond1316.i, label %for.end1327.i
...
sw.bb1342.i:                                      ; preds = %while.body.i
  %bcmp2048.i = call i32 @bcmp(ptr noundef nonnull dereferenceable(13) %command.i, ptr noundef nonnull dereferenceable(13) @.str.111, i64 13)
  %cmp1345.i = icmp eq i32 %bcmp2048.i, 0
...
if.then1347.i:                                    ; preds = %sw.bb1342.i
  ...
  %bcmp2049.i = call i32 @bcmp(ptr noundef nonnull dereferenceable(5) %command.i, ptr noundef nonnull dereferenceable(5) @.str.113, i64 5)
  %cmp1353.i = icmp eq i32 %bcmp2049.i, 0
  %spec.select.i = select i1 %cmp1353.i, i32 1, i32 %fixed_pitch.02162.i
  br label %sw.epilog.i

sw.bb1358.i:                                      ; preds = %while.body.i
  %bcmp2046.i = call i32 @bcmp(ptr noundef nonnull dereferenceable(17) %command.i, ptr noundef nonnull dereferenceable(17) @.str.114, i64 17)
  %cmp1361.i = icmp eq i32 %bcmp2046.i, 0
  br i1 %cmp1361.i, label %if.then1363.i, label %if.else1373.i

if.then1363.i:                                    ; preds = %sw.bb1358.i
  %tobool1364.not.i = icmp eq i32 %font_name_found.02163.i, 0
...
if.end1369.i:                                     ; preds = %if.then1365.i, %if.then1363.i
  %tobool1370.not.i = icmp eq i32 %xhfound.02161.i, 0
  %spec.select2062.i = select i1 %tobool1370.not.i, i32 250, i32 %xheight2.02156.i
  call fastcc void @ReadCharMetrics(ptr noundef nonnull %face.0.lcssa.i, i32 noundef %fixed_pitch.02162.i, i32 noundef %spec.select2062.i, ptr noundef %call1163.i, ptr noundef nonnull %ligtop.i, i16 noundef zeroext %call1126.i, ptr noundef %call1155.i, ptr noundef nonnull %lnum.i, ptr noundef %call1127.i)
  br label %sw.epilog.i
...
if.else1373.i:                                    ; preds = %sw.bb1358.i
  ...
  %232 = load i32, ptr %uses_font_metrics1374.i, align 8
...
land.lhs.true1378.i:                              ; preds = %if.else1373.i
  %bcmp2047.i = call i32 @bcmp(ptr noundef nonnull dereferenceable(15) %command.i, ptr noundef nonnull dereferenceable(15) @.str.116, i64 15)
  %cmp1381.i = icmp eq i32 %bcmp2047.i, 0
...
if.end1392.i:                                     ; preds = %if.then1388.i, %if.then1383.i
  %234 = load i32, ptr %num_pairs.i, align 4
  ...
  %call140621342148.i = call ptr @fgets(ptr noundef nonnull %buff.i, i32 noundef 512, ptr noundef %call1127.i)
  %cmp140821352149.i = icmp eq ptr %call140621342148.i, %buff.i
  br i1 %cmp140821352149.i, label %land.rhs1410.lr.ph.i, label %while.end.i

land.rhs1410.lr.ph.i:                             ; preds = %if.end1392.i, %if.end1577.i
  %235 = phi i32 [ %inc1417.i, %if.end1577.i ], [ %inc1236.i, %if.end1392.i ]
  %ks_top.0.ph2152.i = phi i32 [ %ks_top.2.i, %if.end1577.i ], [ 1, %if.end1392.i ]
  %kc_top.0.ph2151.i = phi i32 [ %kc_top.2.i, %if.end1577.i ], [ 1, %if.end1392.i ]
  %last_ch1.0.ph2150.i = phi i8 [ %last_ch1.1.i, %if.end1577.i ], [ 0, %if.end1392.i ]
  br label %land.rhs1410.i

land.rhs1410.i:                                   ; preds = %while.cond1404.backedge.i, %land.rhs1410.lr.ph.i
  %236 = phi i32 [ %235, %land.rhs1410.lr.ph.i ], [ %inc1417.i, %while.cond1404.backedge.i ]
...
while.body1416.i:                                 ; preds = %land.rhs1410.i
  %inc1417.i = add nsw i32 %236, 1
  store i32 %inc1417.i, ptr %lnum.i, align 4
...
if.end1433.i:                                     ; preds = %if.then1428.i, %if.then1421.i
  %237 = load float, ptr %fl_ksize.i, align 4
  %conv1434.i = fptosi float %237 to i32
...
if.end1462.i:                                     ; preds = %if.end1450.i
  %cmp1465.not.i = icmp eq i8 %call1445.i, %last_ch1.0.ph2150.i
...
land.lhs.true1467.i:                              ; preds = %if.end1462.i
  ...
  %238 = load i16, ptr %arrayidx1469.i, align 2
  %cmp1471.not.i = icmp eq i16 %238, 0
...
while.cond1404.backedge.i:                        ; preds = %if.then1473.i, %if.end1450.i, %if.end1438.i, %if.end1433.i
  ...
  br i1 %cmp1408.i, label %land.rhs1410.i, label %while.end.i

if.end1479.i:                                     ; preds = %if.end1462.i
  %idxprom1480.phi.trans.insert.i = zext i8 %last_ch1.0.ph2150.i to i64
  %arrayidx1481.phi.trans.insert.i = getelementptr inbounds i16, ptr %calloc.i, i64 %idxprom1480.phi.trans.insert.i
  %.pre2215.i = load i16, ptr %arrayidx1481.phi.trans.insert.i, align 2
  %cmp1483.i = icmp eq i16 %.pre2215.i, 0
  br i1 %cmp1483.i, label %if.then1485.i, label %if.end1494.i

if.then1485.i:                                    ; preds = %land.lhs.true1467.i, %if.end1479.i
  %call1445.lcssa2222.i = phi i8 [ %last_ch1.0.ph2150.i, %if.end1479.i ], [ %call1445.i, %land.lhs.true1467.i ]
  %idxprom1480.pre-phi2220.i = phi i64 [ %idxprom1480.phi.trans.insert.i, %if.end1479.i ], [ %idxprom1468.i, %land.lhs.true1467.i ]
  %arrayidx1481.i = getelementptr inbounds i16, ptr %calloc.i, i64 %idxprom1480.pre-phi2220.i
  %conv1486.i = trunc i32 %kc_top.0.ph2151.i to i16
  store i16 %conv1486.i, ptr %arrayidx1481.i, align 2
  %idxprom1489.i = sext i32 %kc_top.0.ph2151.i to i64
  %arrayidx1490.i = getelementptr inbounds i8, ptr %call1396.i, i64 %idxprom1489.i
  store i8 0, ptr %arrayidx1490.i, align 1
  %arrayidx1492.i = getelementptr inbounds i8, ptr %call1400.i, i64 %idxprom1489.i
  store i8 0, ptr %arrayidx1492.i, align 1
  %inc1493.i = add nsw i32 %kc_top.0.ph2151.i, 1
  br label %if.end1494.i

if.end1494.i:                                     ; preds = %if.then1485.i, %if.end1479.i
  %call1445.lcssa2221.i = phi i8 [ %call1445.lcssa2222.i, %if.then1485.i ], [ %last_ch1.0.ph2150.i, %if.end1479.i ]
  %239 = phi i16 [ %conv1486.i, %if.then1485.i ], [ %.pre2215.i, %if.end1479.i ]
  %kc_top.1.i = phi i32 [ %inc1493.i, %if.then1485.i ], [ %kc_top.0.ph2151.i, %if.end1479.i ]
  %cmp14962139.i = icmp sgt i32 %ks_top.0.ph2152.i, 1
  br i1 %cmp14962139.i, label %for.body1498.preheader.i, label %for.end1508.i

for.body1498.preheader.i:                         ; preds = %if.end1494.i
  %wide.trip.count.i = zext i32 %ks_top.0.ph2152.i to i64
...
for.body1498.i:                                   ; preds = %for.inc1506.i, %for.body1498.preheader.i
  ...
  %240 = load i16, ptr %arrayidx1500.i, align 2
  %conv1501.i = sext i16 %240 to i32
...
for.inc1506.i:                                    ; preds = %for.body1498.i
  ...
  br i1 %exitcond.not.i, label %if.then1511.i, label %for.body1498.i
...
for.end1508.i:                                    ; preds = %for.end1508.loopexit.i, %if.end1494.i
  %pos.0.lcssa.i = phi i32 [ 1, %if.end1494.i ], [ %241, %for.end1508.loopexit.i ]
  %cmp1509.i = icmp eq i32 %pos.0.lcssa.i, %ks_top.0.ph2152.i
  br i1 %cmp1509.i, label %if.then1511.i, label %if.end1523.i

if.then1511.i:                                    ; preds = %for.inc1506.i, %for.end1508.i
  %242 = load i32, ptr %num_pairs.i, align 4
  %cmp1512.i = icmp eq i32 %ks_top.0.ph2152.i, %242
...
if.end1518.i:                                     ; preds = %if.then1514.i, %if.then1511.i
  ...
  %idxprom1520.i = zext i32 %ks_top.0.ph2152.i to i64
  %arrayidx1521.i = getelementptr inbounds i16, ptr %call1403.i, i64 %idxprom1520.i
  store i16 %conv1519.i, ptr %arrayidx1521.i, align 2
  %inc1522.i = add nsw i32 %ks_top.0.ph2152.i, 1
  br label %if.end1523.i

if.end1523.i:                                     ; preds = %if.end1518.i, %for.end1508.i
  %pos.0.lcssa2225.i = phi i32 [ %ks_top.0.ph2152.i, %if.end1518.i ], [ %pos.0.lcssa.i, %for.end1508.i ]
  %ks_top.1.i = phi i32 [ %inc1522.i, %if.end1518.i ], [ %ks_top.0.ph2152.i, %for.end1508.i ]
  %conv1527.i = zext i16 %239 to i32
  %cmp1528.not.not2144.i = icmp sgt i32 %kc_top.1.i, %conv1527.i
  br i1 %cmp1528.not.not2144.i, label %land.rhs1530.preheader.i, label %if.end1568.i

land.rhs1530.preheader.i:                         ; preds = %if.end1523.i
  %243 = sext i32 %kc_top.1.i to i64
  %244 = zext i16 %239 to i64
  br label %land.rhs1530.i

land.rhs1530.i:                                   ; preds = %for.body1538.i, %land.rhs1530.preheader.i
  %indvars.iv2206.i = phi i64 [ %243, %land.rhs1530.preheader.i ], [ %indvars.iv.next2207.i, %for.body1538.i ]
  %indvars.iv.next2207.i = add nsw i64 %indvars.iv2206.i, -1
  %idxprom1531.i = and i64 %indvars.iv.next2207.i, 4294967295
  %arrayidx1532.i = getelementptr inbounds i8, ptr %call1396.i, i64 %idxprom1531.i
  %245 = load i8, ptr %arrayidx1532.i, align 1
  %cmp1535.i = icmp ult i8 %245, %call1457.i
  br i1 %cmp1535.i, label %for.body1538.i, label %land.lhs.true1555.i

for.body1538.i:                                   ; preds = %land.rhs1530.i
  %arrayidx1542.i = getelementptr inbounds i8, ptr %call1396.i, i64 %indvars.iv2206.i
  store i8 %245, ptr %arrayidx1542.i, align 1
  %arrayidx1544.i = getelementptr inbounds i8, ptr %call1400.i, i64 %idxprom1531.i
  %246 = load i8, ptr %arrayidx1544.i, align 1
  %arrayidx1547.i = getelementptr inbounds i8, ptr %call1400.i, i64 %indvars.iv2206.i
  store i8 %246, ptr %arrayidx1547.i, align 1
  %cmp1528.not.not.i = icmp sgt i64 %indvars.iv.next2207.i, %244
  br i1 %cmp1528.not.not.i, label %land.rhs1530.i, label %if.end1568.loopexit.i

land.lhs.true1555.i:                              ; preds = %land.rhs1530.i
  %247 = trunc i64 %indvars.iv2206.i to i32
  %cmp1560.i = icmp eq i8 %245, %call1457.i
...
if.end1568.loopexit.i:                            ; preds = %for.body1538.i
  %248 = trunc i64 %indvars.iv.next2207.i to i32
  br label %if.end1568.i

if.end1568.i:                                     ; preds = %if.end1568.loopexit.i, %if.then1562.i, %land.lhs.true1555.i, %if.end1523.i
  %i.3.in2090.i = phi i32 [ %247, %if.then1562.i ], [ %247, %land.lhs.true1555.i ], [ %kc_top.1.i, %if.end1523.i ], [ %248, %if.end1568.loopexit.i ]
  %idxprom1570.i = sext i32 %i.3.in2090.i to i64
  %arrayidx1571.i = getelementptr inbounds i8, ptr %call1396.i, i64 %idxprom1570.i
  store i8 %call1457.i, ptr %arrayidx1571.i, align 1
  %conv1572.i = trunc i32 %pos.0.lcssa2225.i to i8
  %arrayidx1575.i = getelementptr inbounds i8, ptr %call1400.i, i64 %idxprom1570.i
  store i8 %conv1572.i, ptr %arrayidx1575.i, align 1
  %inc1576.i = add nsw i32 %kc_top.1.i, 1
  br label %if.end1577.i

if.end1577.i:                                     ; preds = %while.body1416.i, %if.end1568.i
  %last_ch1.1.i = phi i8 [ %call1445.lcssa2221.i, %if.end1568.i ], [ %last_ch1.0.ph2150.i, %while.body1416.i ]
  %kc_top.2.i = phi i32 [ %inc1576.i, %if.end1568.i ], [ %kc_top.0.ph2151.i, %while.body1416.i ]
  %ks_top.2.i = phi i32 [ %ks_top.1.i, %if.end1568.i ], [ %ks_top.0.ph2152.i, %while.body1416.i ]
  %call14062134.i = call ptr @fgets(ptr noundef nonnull %buff.i, i32 noundef 512, ptr noundef %call1127.i)
  %cmp14082135.i = icmp eq ptr %call14062134.i, %buff.i
  br i1 %cmp14082135.i, label %land.rhs1410.lr.ph.i, label %while.end.i

while.end.i:                                      ; preds = %if.end1577.i, %while.cond1404.backedge.i, %land.rhs1410.i, %if.end1392.i
  %ks_top.0.ph.lcssa.i = phi i32 [ 1, %if.end1392.i ], [ %ks_top.0.ph2152.i, %land.rhs1410.i ], [ %ks_top.0.ph2152.i, %while.cond1404.backedge.i ], [ %ks_top.2.i, %if.end1577.i ]
  %conv1578.i = trunc i32 %ks_top.0.ph.lcssa.i to i16
  store i16 %conv1578.i, ptr %call1403.i, align 2
...
sw.epilog.i:                                      ; preds = %while.end.i, %land.lhs.true1378.i, %if.else1373.i, %if.end1369.i, %if.then1347.i, %sw.bb1342.i, %if.then1334.i, %for.end1327.i, %sw.bb1286.i, %if.end1281.i, %sw.bb1271.i, %if.end1265.i, %if.else1255.i, %if.end1251.i, %while.body.i
  %xheight2.2.i = phi i32 [ %xheight2.02156.i, %while.body.i ], [ %spec.select2062.i, %if.end1369.i ], [ %xheight2.02156.i, %while.end.i ], [ %xheight2.02156.i, %land.lhs.true1378.i ], [ %xheight2.02156.i, %if.else1373.i ], [ %xheight2.02156.i, %sw.bb1342.i ], [ %xheight2.02156.i, %sw.bb1286.i ], [ %conv1284.i, %if.end1281.i ], [ %xheight2.02156.i, %sw.bb1271.i ], [ %xheight2.02156.i, %if.end1251.i ], [ %xheight2.02156.i, %if.end1265.i ], [ %xheight2.02156.i, %if.else1255.i ], [ %xheight2.02156.i, %if.then1334.i ], [ %xheight2.02156.i, %for.end1327.i ], [ %xheight2.02156.i, %if.then1347.i ]
  %under_pos.1.i = phi i32 [ %under_pos.02157.i, %while.body.i ], [ %under_pos.02157.i, %if.end1369.i ], [ %under_pos.02157.i, %while.end.i ], [ %under_pos.02157.i, %land.lhs.true1378.i ], [ %under_pos.02157.i, %if.else1373.i ], [ %under_pos.02157.i, %sw.bb1342.i ], [ %under_pos.02157.i, %sw.bb1286.i ], [ %under_pos.02157.i, %if.end1281.i ], [ %under_pos.02157.i, %sw.bb1271.i ], [ %conv1254.i, %if.end1251.i ], [ %under_pos.02157.i, %if.end1265.i ], [ %under_pos.02157.i, %if.else1255.i ], [ %under_pos.02157.i, %if.then1334.i ], [ %under_pos.02157.i, %for.end1327.i ], [ %under_pos.02157.i, %if.then1347.i ]
  %under_thick.1.i = phi i32 [ %under_thick.02158.i, %while.body.i ], [ %under_thick.02158.i, %if.end1369.i ], [ %under_thick.02158.i, %while.end.i ], [ %under_thick.02158.i, %land.lhs.true1378.i ], [ %under_thick.02158.i, %if.else1373.i ], [ %under_thick.02158.i, %sw.bb1342.i ], [ %under_thick.02158.i, %sw.bb1286.i ], [ %under_thick.02158.i, %if.end1281.i ], [ %under_thick.02158.i, %sw.bb1271.i ], [ %under_thick.02158.i, %if.end1251.i ], [ %conv1268.i, %if.end1265.i ], [ %under_thick.02158.i, %if.else1255.i ], [ %under_thick.02158.i, %if.then1334.i ], [ %under_thick.02158.i, %for.end1327.i ], [ %under_thick.02158.i, %if.then1347.i ]
  %upfound.1.i = phi i32 [ %upfound.02159.i, %while.body.i ], [ %upfound.02159.i, %if.end1369.i ], [ %upfound.02159.i, %while.end.i ], [ %upfound.02159.i, %land.lhs.true1378.i ], [ %upfound.02159.i, %if.else1373.i ], [ %upfound.02159.i, %sw.bb1342.i ], [ %upfound.02159.i, %sw.bb1286.i ], [ %upfound.02159.i, %if.end1281.i ], [ %upfound.02159.i, %sw.bb1271.i ], [ 1, %if.end1251.i ], [ %upfound.02159.i, %if.end1265.i ], [ %upfound.02159.i, %if.else1255.i ], [ %upfound.02159.i, %if.then1334.i ], [ %upfound.02159.i, %for.end1327.i ], [ %upfound.02159.i, %if.then1347.i ]
  %utfound.1.i = phi i32 [ %utfound.02160.i, %while.body.i ], [ %utfound.02160.i, %if.end1369.i ], [ %utfound.02160.i, %while.end.i ], [ %utfound.02160.i, %land.lhs.true1378.i ], [ %utfound.02160.i, %if.else1373.i ], [ %utfound.02160.i, %sw.bb1342.i ], [ %utfound.02160.i, %sw.bb1286.i ], [ %utfound.02160.i, %if.end1281.i ], [ %utfound.02160.i, %sw.bb1271.i ], [ %utfound.02160.i, %if.end1251.i ], [ 1, %if.end1265.i ], [ %utfound.02160.i, %if.else1255.i ], [ %utfound.02160.i, %if.then1334.i ], [ %utfound.02160.i, %for.end1327.i ], [ %utfound.02160.i, %if.then1347.i ]
  %xhfound.1.i = phi i32 [ %xhfound.02161.i, %while.body.i ], [ %xhfound.02161.i, %if.end1369.i ], [ %xhfound.02161.i, %while.end.i ], [ %xhfound.02161.i, %land.lhs.true1378.i ], [ %xhfound.02161.i, %if.else1373.i ], [ %xhfound.02161.i, %sw.bb1342.i ], [ %xhfound.02161.i, %sw.bb1286.i ], [ 1, %if.end1281.i ], [ %xhfound.02161.i, %sw.bb1271.i ], [ %xhfound.02161.i, %if.end1251.i ], [ %xhfound.02161.i, %if.end1265.i ], [ %xhfound.02161.i, %if.else1255.i ], [ %xhfound.02161.i, %if.then1334.i ], [ %xhfound.02161.i, %for.end1327.i ], [ %xhfound.02161.i, %if.then1347.i ]
  %fixed_pitch.1.i = phi i32 [ %fixed_pitch.02162.i, %while.body.i ], [ %fixed_pitch.02162.i, %if.end1369.i ], [ %fixed_pitch.02162.i, %while.end.i ], [ %fixed_pitch.02162.i, %land.lhs.true1378.i ], [ %fixed_pitch.02162.i, %if.else1373.i ], [ %fixed_pitch.02162.i, %sw.bb1342.i ], [ %fixed_pitch.02162.i, %sw.bb1286.i ], [ %fixed_pitch.02162.i, %if.end1281.i ], [ %fixed_pitch.02162.i, %sw.bb1271.i ], [ %fixed_pitch.02162.i, %if.end1251.i ], [ %fixed_pitch.02162.i, %if.end1265.i ], [ %fixed_pitch.02162.i, %if.else1255.i ], [ %fixed_pitch.02162.i, %if.then1334.i ], [ %fixed_pitch.02162.i, %for.end1327.i ], [ %spec.select.i, %if.then1347.i ]
  %font_name_found.1.i = phi i32 [ %font_name_found.02163.i, %while.body.i ], [ %font_name_found.02163.i, %if.end1369.i ], [ %font_name_found.02163.i, %while.end.i ], [ %font_name_found.02163.i, %land.lhs.true1378.i ], [ %font_name_found.02163.i, %if.else1373.i ], [ %font_name_found.02163.i, %sw.bb1342.i ], [ %font_name_found.02163.i, %sw.bb1286.i ], [ %font_name_found.02163.i, %if.end1281.i ], [ %font_name_found.02163.i, %sw.bb1271.i ], [ %font_name_found.02163.i, %if.end1251.i ], [ %font_name_found.02163.i, %if.end1265.i ], [ %font_name_found.02163.i, %if.else1255.i ], [ 1, %if.then1334.i ], [ 1, %for.end1327.i ], [ %font_name_found.02163.i, %if.then1347.i ]
  %kc.1.i = phi ptr [ %kc.02164.i, %while.body.i ], [ %kc.02164.i, %if.end1369.i ], [ %call1396.i, %while.end.i ], [ %kc.02164.i, %land.lhs.true1378.i ], [ %kc.02164.i, %if.else1373.i ], [ %kc.02164.i, %sw.bb1342.i ], [ %kc.02164.i, %sw.bb1286.i ], [ %kc.02164.i, %if.end1281.i ], [ %kc.02164.i, %sw.bb1271.i ], [ %kc.02164.i, %if.end1251.i ], [ %kc.02164.i, %if.end1265.i ], [ %kc.02164.i, %if.else1255.i ], [ %kc.02164.i, %if.then1334.i ], [ %kc.02164.i, %for.end1327.i ], [ %kc.02164.i, %if.then1347.i ]
  %kv.1.i = phi ptr [ %kv.02165.i, %while.body.i ], [ %kv.02165.i, %if.end1369.i ], [ %call1400.i, %while.end.i ], [ %kv.02165.i, %land.lhs.true1378.i ], [ %kv.02165.i, %if.else1373.i ], [ %kv.02165.i, %sw.bb1342.i ], [ %kv.02165.i, %sw.bb1286.i ], [ %kv.02165.i, %if.end1281.i ], [ %kv.02165.i, %sw.bb1271.i ], [ %kv.02165.i, %if.end1251.i ], [ %kv.02165.i, %if.end1265.i ], [ %kv.02165.i, %if.else1255.i ], [ %kv.02165.i, %if.then1334.i ], [ %kv.02165.i, %for.end1327.i ], [ %kv.02165.i, %if.then1347.i ]
  %ks.1.i = phi ptr [ %ks.02166.i, %while.body.i ], [ %ks.02166.i, %if.end1369.i ], [ %call1403.i, %while.end.i ], [ %ks.02166.i, %land.lhs.true1378.i ], [ %ks.02166.i, %if.else1373.i ], [ %ks.02166.i, %sw.bb1342.i ], [ %ks.02166.i, %sw.bb1286.i ], [ %ks.02166.i, %if.end1281.i ], [ %ks.02166.i, %sw.bb1271.i ], [ %ks.02166.i, %if.end1251.i ], [ %ks.02166.i, %if.end1265.i ], [ %ks.02166.i, %if.else1255.i ], [ %ks.02166.i, %if.then1334.i ], [ %ks.02166.i, %for.end1327.i ], [ %ks.02166.i, %if.then1347.i ]
  %call1223.i = call ptr @fgets(ptr noundef nonnull %buff.i, i32 noundef 512, ptr noundef %call1127.i)
  %cond2075.i = icmp eq ptr %call1223.i, null
  br i1 %cond2075.i, label %if.then1585.i, label %land.rhs.i

if.then1585.i:                                    ; preds = %sw.epilog.i, %if.end1212.i
  %xheight2.0.lcssa.i = phi i32 [ 0, %if.end1212.i ], [ %xheight2.2.i, %sw.epilog.i ]
  %under_pos.0.lcssa.i = phi i32 [ 0, %if.end1212.i ], [ %under_pos.1.i, %sw.epilog.i ]
  %under_thick.0.lcssa.i = phi i32 [ 0, %if.end1212.i ], [ %under_thick.1.i, %sw.epilog.i ]
  %fixed_pitch.0.lcssa.i = phi i32 [ 0, %if.end1212.i ], [ %fixed_pitch.1.i, %sw.epilog.i ]
  %kc.0.lcssa.i = phi ptr [ null, %if.end1212.i ], [ %kc.1.i, %sw.epilog.i ]
  %kv.0.lcssa.i = phi ptr [ null, %if.end1212.i ], [ %kv.1.i, %sw.epilog.i ]
  %ks.0.lcssa.i = phi ptr [ null, %if.end1212.i ], [ %ks.1.i, %sw.epilog.i ]
...
if.end1589.i:                                     ; preds = %land.rhs1230.i, %if.then1585.i
  %xheight2.02104.i = phi i32 [ %xheight2.0.lcssa.i, %if.then1585.i ], [ %xheight2.02156.i, %land.rhs1230.i ]
  %under_pos.02102.i = phi i32 [ %under_pos.0.lcssa.i, %if.then1585.i ], [ %under_pos.02157.i, %land.rhs1230.i ]
  %under_thick.02100.i = phi i32 [ %under_thick.0.lcssa.i, %if.then1585.i ], [ %under_thick.02158.i, %land.rhs1230.i ]
  %fixed_pitch.02098.i = phi i32 [ %fixed_pitch.0.lcssa.i, %if.then1585.i ], [ %fixed_pitch.02162.i, %land.rhs1230.i ]
  %kc.02096.i = phi ptr [ %kc.0.lcssa.i, %if.then1585.i ], [ %kc.02164.i, %land.rhs1230.i ]
  %kv.02094.i = phi ptr [ %kv.0.lcssa.i, %if.then1585.i ], [ %kv.02165.i, %land.rhs1230.i ]
  %ks.02092.i = phi ptr [ %ks.0.lcssa.i, %if.then1585.i ], [ %ks.02166.i, %land.rhs1230.i ]
  %call1590.i = call i32 @fclose(ptr noundef %call1127.i)
  %249 = load ptr, ptr @BackEnd, align 8
  %uses_font_metrics1591.i = getelementptr inbounds %struct.back_end_rec, ptr %249, i64 0, i32 8
  %250 = load i32, ptr %uses_font_metrics1591.i, align 8
  %tobool1592.not.i = icmp eq i32 %250, 0
  br i1 %tobool1592.not.i, label %cond.false1594.i, label %cond.end1596.i

cond.false1594.i:                                 ; preds = %if.end1589.i
  %251 = load i32, ptr @PlainCharHeight, align 4
  %div1595.i = sdiv i32 %251, 4
  br label %cond.end1596.i

cond.end1596.i:                                   ; preds = %cond.false1594.i, %if.end1589.i
  %cond1597.i = phi i32 [ %div1595.i, %cond.false1594.i ], [ %xheight2.02104.i, %if.end1589.i ]
  %ofont_xheight2.i = getelementptr inbounds i8, ptr %call975.i, i64 52
  store i32 %cond1597.i, ptr %ofont_xheight2.i, align 4
...
cond.false1609.i:                                 ; preds = %cond.end1596.i
  ...
  %252 = load i16, ptr %right.i, align 2
  %conv1612.i = sext i16 %252 to i32
...
cond.end1613.i:                                   ; preds = %cond.false1609.i, %cond.end1596.i
  ...
  store i32 %cond1614.i, ptr %ofont_spacewidth.i, align 8
...
if.end1630.i:                                     ; preds = %if.then1626.i, %if.then1618.i
  store i32 0, ptr %lnum.i, align 4
  %call16332174.i = call ptr @fgets(ptr noundef nonnull %buff.i, i32 noundef 512, ptr noundef %call1623.i)
  %cmp1634.not2175.i = icmp eq ptr %call16332174.i, null
  br i1 %cmp1634.not2175.i, label %while.end1660.i, label %while.body1636.i

while.body1636.i:                                 ; preds = %if.end1630.i, %if.end1659.i
  %cmptop.02176.i = phi i32 [ %cmptop.6.i, %if.end1659.i ], [ 1, %if.end1630.i ]
  %253 = load i32, ptr %lnum.i, align 4
  %inc1637.i = add nsw i32 %253, 1
  store i32 %inc1637.i, ptr %lnum.i, align 4
  ...
  %254 = load i8, ptr %command.i, align 16
  %cmp1643.i = icmp eq i8 %254, 83
  br i1 %cmp1643.i, label %if.then1645.i, label %if.end1659.i

if.then1645.i:                                    ; preds = %while.body1636.i
  %bcmp2044.i = call i32 @bcmp(ptr noundef nonnull dereferenceable(22) %command.i, ptr noundef nonnull dereferenceable(22) @.str.129, i64 22)
  %cmp1648.i = icmp eq i32 %bcmp2044.i, 0
  br i1 %cmp1648.i, label %if.then1650.i, label %if.else1651.i

if.then1650.i:                                    ; preds = %if.then1645.i
  call fastcc void @ReadCharMetrics(ptr noundef nonnull %face.0.lcssa.i, i32 noundef %fixed_pitch.02098.i, i32 noundef %xheight2.02104.i, ptr noundef %call1163.i, ptr noundef nonnull %ligtop.i, i16 noundef zeroext %call1622.i, ptr noundef %call1155.i, ptr noundef nonnull %lnum.i, ptr noundef %call1623.i)
  br label %if.end1659.i

if.else1651.i:                                    ; preds = %if.then1645.i
  %bcmp2045.i = call i32 @bcmp(ptr noundef nonnull dereferenceable(21) %command.i, ptr noundef nonnull dereferenceable(21) @.str.130, i64 21)
  %cmp1654.i = icmp eq i32 %bcmp2045.i, 0
...
if.then1656.i:                                    ; preds = %if.else1651.i
  ...
  %call203.i.i = call ptr @fgets(ptr noundef nonnull %buff.i.i, i32 noundef 512, ptr noundef %call1623.i)
...
land.rhs.i.i:                                     ; preds = %if.then1656.i, %if.end132.i.i
  %255 = phi i32 [ %inc.i.i, %if.end132.i.i ], [ %inc1637.i, %if.then1656.i ]
  %cmptop.1.i = phi i32 [ %inc136.i.i, %if.end132.i.i ], [ %cmptop.02176.i, %if.then1656.i ]
...
while.body.i.i:                                   ; preds = %land.rhs.i.i
  %inc.i.i = add nsw i32 %255, 1
  store i32 %inc.i.i, ptr %lnum.i, align 4
...
for.cond.i.i:                                     ; preds = %for.cond.i.i.preheader, %for.inc.i.i
  ...
  %256 = load i8, ptr %arrayidx.i.i, align 1
  switch i8 %256, label %for.inc.i.i [
...
if.end45.i.i:                                     ; preds = %if.then41.i.i, %if.end34.i.i
  ...
  store i16 %conv46.i.i, ptr %arrayidx48.i.i, align 2
  %257 = load i32, ptr %composite_num.i.i, align 4
  %cmp50200.i.i = icmp sgt i32 %257, 0
  br i1 %cmp50200.i.i, label %for.body52.i.preheader.i, label %for.end125.i.i

for.body52.i.preheader.i:                         ; preds = %if.end45.i.i
  %258 = sext i32 %cmptop.1.i to i64
  br label %for.body52.i.i

for.body52.i.i:                                   ; preds = %if.end104.i.i, %for.body52.i.preheader.i
  %indvars.iv2209.i = phi i64 [ %258, %for.body52.i.preheader.i ], [ %indvars.iv.next2210.i, %if.end104.i.i ]
...
if.end63.i.i:                                     ; preds = %if.then59.i.i, %for.body52.i.i
  %259 = ashr exact i64 %i.1202.i.i, 32
  br label %for.cond64.i.i

for.cond64.i.i:                                   ; preds = %for.cond64.i.i, %if.end63.i.i
  %indvars.iv210.in.i.i = phi i64 [ %259, %if.end63.i.i ], [ %indvars.iv210.i.i, %for.cond64.i.i ]
  ...
  %260 = load i8, ptr %arrayidx66.i.i, align 1
  switch i8 %260, label %for.cond64.i.i [
...
if.end96.i.i:                                     ; preds = %for.cond64.i.i, %if.then92.i.i
  %cmp98.i.i = icmp sgt i64 %indvars.iv2209.i, 255
...
if.end104.i.i:                                    ; preds = %if.then100.i.i, %if.end96.i.i
  ...
  %arrayidx113.i.i = getelementptr inbounds %struct.composite_rec, ptr %call1188.i, i64 %indvars.iv2209.i
  store i8 %call111.i.i, ptr %arrayidx113.i.i, align 2
  %261 = load i32, ptr %x_offset.i.i, align 4
  %conv114.i.i = trunc i32 %261 to i16
  %x_offset117.i.i = getelementptr inbounds %struct.composite_rec, ptr %call1188.i, i64 %indvars.iv2209.i, i32 1
  store i16 %conv114.i.i, ptr %x_offset117.i.i, align 2
  %262 = load i32, ptr %y_offset.i.i, align 4
  %conv118.i.i = trunc i32 %262 to i16
  %y_offset121.i.i = getelementptr inbounds %struct.composite_rec, ptr %call1188.i, i64 %indvars.iv2209.i, i32 2
  store i16 %conv118.i.i, ptr %y_offset121.i.i, align 2
  %indvars.iv.next2210.i = add nsw i64 %indvars.iv2209.i, 1
  %inc124.i.i = add nuw nsw i32 %count.0201.i.i, 1
  %263 = load i32, ptr %composite_num.i.i, align 4
  %cmp50.i.i = icmp slt i32 %inc124.i.i, %263
  br i1 %cmp50.i.i, label %for.body52.i.i, label %for.end125.i.loopexit.i

for.end125.i.loopexit.i:                          ; preds = %if.end104.i.i
  %264 = trunc i64 %indvars.iv.next2210.i to i32
  br label %for.end125.i.i

for.end125.i.i:                                   ; preds = %for.end125.i.loopexit.i, %if.end45.i.i
  %cmptop.3.i = phi i32 [ %cmptop.1.i, %if.end45.i.i ], [ %264, %for.end125.i.loopexit.i ]
...
if.end132.i.i:                                    ; preds = %if.then128.i.i, %for.end125.i.i
  ...
  store i8 0, ptr %arrayidx134.i.i, align 2
  ...
  br i1 %cond.i.i, label %if.then142.i.i, label %land.rhs.i.i
...
if.then142.i.i:                                   ; preds = %if.end132.i.i, %lor.lhs.false.i.i, %if.then1656.i
  %265 = phi i32 [ %inc1637.i, %if.then1656.i ], [ %255, %lor.lhs.false.i.i ], [ %inc.i.i, %if.end132.i.i ]
  %cmptop.4.i = phi i32 [ %cmptop.02176.i, %if.then1656.i ], [ %cmptop.1.i, %lor.lhs.false.i.i ], [ %inc136.i.i, %if.end132.i.i ]
  %call144.i.i = call ptr @FileName(i16 noundef zeroext %call1622.i) #14
  %call145.i.i = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 37, i32 noundef 9, ptr noundef nonnull @.str.151, i32 noundef 1, ptr noundef nonnull %ou11621.i, ptr noundef %call144.i.i, i32 noundef %265) #14
...
if.end1659.i:                                     ; preds = %ReadCompositeMetrics.exit.i, %if.else1651.i, %if.then1650.i, %while.body1636.i
  %cmptop.6.i = phi i32 [ %cmptop.02176.i, %if.then1650.i ], [ %cmptop.5.i, %ReadCompositeMetrics.exit.i ], [ %cmptop.02176.i, %if.else1651.i ], [ %cmptop.02176.i, %while.body1636.i ]
  ...
  br i1 %cmp1634.not.i, label %while.end1660.i, label %while.body1636.i
...
FontRead.exit.thread:                             ; preds = %for.cond.i, %for.end371.i
  ...
  call void @llvm.lifetime.end.p0(i64 100, ptr nonnull %seq.i) #14
  call void @llvm.lifetime.end.p0(i64 100, ptr nonnull %tag.i) #14
  %266 = load ptr, ptr @font_root, align 8
  br label %for.cond487

FontRead.exit:                                    ; preds = %cond.end1613.i, %while.end1660.i
  %cmptop.7.i = phi i32 [ 1, %cond.end1613.i ], [ %cmptop.0.lcssa.i, %while.end1660.i ]
  %267 = load ptr, ptr @finfo, align 8
  %268 = load i32, ptr @font_count, align 4
  %idxprom1663.i = zext i32 %268 to i64
  %font_table.i = getelementptr inbounds %struct.font_rec, ptr %267, i64 %idxprom1663.i, i32 5
  store ptr %call975.i, ptr %font_table.i, align 8
  %269 = load ptr, ptr @finfo, align 8
  %original_face.i = getelementptr inbounds %struct.font_rec, ptr %269, i64 %idxprom1663.i, i32 6
  store ptr %face.0.lcssa.i, ptr %original_face.i, align 8
  %sub1667.i = sub nsw i32 %xheight2.02104.i, %under_pos.02102.i
  %conv1668.i = trunc i32 %sub1667.i to i16
  %270 = load ptr, ptr @finfo, align 8
  %underline_pos.i = getelementptr inbounds %struct.font_rec, ptr %270, i64 %idxprom1663.i, i32 7
  store i16 %conv1668.i, ptr %underline_pos.i, align 8
  %conv1671.i = trunc i32 %under_thick.02100.i to i16
  %underline_thick.i = getelementptr inbounds %struct.font_rec, ptr %270, i64 %idxprom1663.i, i32 8
  store i16 %conv1671.i, ptr %underline_thick.i, align 2
  %arrayidx1675.i = getelementptr inbounds %struct.font_rec, ptr %270, i64 %idxprom1663.i
  store ptr %call1155.i, ptr %arrayidx1675.i, align 8
  %271 = load ptr, ptr @finfo, align 8
  %lig_table.i = getelementptr inbounds %struct.font_rec, ptr %271, i64 %idxprom1663.i, i32 1
  store ptr %call1163.i, ptr %lig_table.i, align 8
  %272 = load ptr, ptr @finfo, align 8
  %composite1680.i = getelementptr inbounds %struct.font_rec, ptr %272, i64 %idxprom1663.i, i32 2
  store ptr %call1180.i, ptr %composite1680.i, align 8
  %273 = load ptr, ptr @finfo, align 8
  %cmp_table.i = getelementptr inbounds %struct.font_rec, ptr %273, i64 %idxprom1663.i, i32 3
  store ptr %call1188.i, ptr %cmp_table.i, align 8
  %274 = load ptr, ptr @finfo, align 8
  %cmp_top.i = getelementptr inbounds %struct.font_rec, ptr %274, i64 %idxprom1663.i, i32 4
  store i32 %cmptop.7.i, ptr %cmp_top.i, align 8
  %kern_table.i = getelementptr inbounds %struct.font_rec, ptr %274, i64 %idxprom1663.i, i32 9
  store ptr %calloc.i, ptr %kern_table.i, align 8
  %275 = load ptr, ptr @finfo, align 8
  %kern_chars.i = getelementptr inbounds %struct.font_rec, ptr %275, i64 %idxprom1663.i, i32 10
  store ptr %kc.02096.i, ptr %kern_chars.i, align 8
  %276 = load ptr, ptr @finfo, align 8
  %kern_value.i = getelementptr inbounds %struct.font_rec, ptr %276, i64 %idxprom1663.i, i32 11
  store ptr %kv.02094.i, ptr %kern_value.i, align 8
  %277 = load ptr, ptr @finfo, align 8
  %kern_sizes.i = getelementptr inbounds %struct.font_rec, ptr %277, i64 %idxprom1663.i, i32 12
  store ptr %ks.02092.i, ptr %kern_sizes.i, align 8
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %fl_under_thick.i) #14
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %fl_under_pos.i) #14
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %fl_xheight2.i) #14
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %ligtop.i) #14
...
for.cond487:                                      ; preds = %for.end505, %FontRead.exit.thread
  %.pn1626 = phi ptr [ %266, %FontRead.exit.thread ], [ %link.3, %for.end505 ]
  %link.3.in = getelementptr inbounds %struct.LIST, ptr %.pn1626, i64 0, i32 1
  %link.3 = load ptr, ptr %link.3.in, align 8
  %cmp488.not = icmp eq ptr %link.3, %266
...
for.cond494:                                      ; preds = %for.cond487, %for.cond494
  ...
  %278 = load i8, ptr %ou1495, align 8
  %cmp498 = icmp eq i8 %278, 0
  br i1 %cmp498, label %for.cond494, label %for.end505
...
for.end505:                                       ; preds = %for.cond494
  ...
  br i1 %cmp511, label %if.then522, label %for.cond487
...
if.end536:                                        ; preds = %for.end388, %FontRead.exit, %if.then451, %if.end445, %FontRead.exit.thread1682
  ...
  %279 = load ptr, ptr %osucc539, align 8
  %cmp540.not = icmp eq ptr %279, %face.2
  br i1 %cmp540.not, label %if.then542, label %if.end544

if.then542:                                       ; preds = %if.end536
  %280 = load ptr, ptr @no_fpos, align 8
  %call543 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.10, i32 noundef 0, ptr noundef %280, ptr noundef nonnull @.str.29) #14
  %.pre1835 = load ptr, ptr %osucc539, align 8
  br label %if.end544

if.end544:                                        ; preds = %if.then542, %if.end536
  %281 = phi ptr [ %.pre1835, %if.then542 ], [ %279, %if.end536 ]
  %osucc550 = getelementptr inbounds %struct.LIST, ptr %281, i64 0, i32 1
  %282 = load ptr, ptr %osucc550, align 8
  %cmp551.not = icmp eq ptr %282, %face.2
  br i1 %cmp551.not, label %if.then553, label %if.end555

if.then553:                                       ; preds = %if.end544
  %283 = load ptr, ptr @no_fpos, align 8
  %call554 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.10, i32 noundef 0, ptr noundef %283, ptr noundef nonnull @.str.30) #14
  %.pre1836 = load ptr, ptr %osucc539, align 8
  %osucc561.phi.trans.insert = getelementptr inbounds %struct.LIST, ptr %.pre1836, i64 0, i32 1
  %.pre1837 = load ptr, ptr %osucc561.phi.trans.insert, align 8
  br label %if.end555

if.end555:                                        ; preds = %if.then553, %if.end544
  %284 = phi ptr [ %.pre1837, %if.then553 ], [ %282, %if.end544 ]
  %osucc564 = getelementptr inbounds %struct.LIST, ptr %284, i64 0, i32 1
  %285 = load ptr, ptr %osucc564, align 8
  %cmp565.not = icmp eq ptr %285, %face.2
  br i1 %cmp565.not, label %if.then567, label %if.end569

if.then567:                                       ; preds = %if.end555
  %286 = load ptr, ptr @no_fpos, align 8
  %call568 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.10, i32 noundef 0, ptr noundef %286, ptr noundef nonnull @.str.31) #14
  br label %if.end569
...
if.then572:                                       ; preds = %if.end569
  %287 = load ptr, ptr @finfo, align 8
  %bf.load574 = load i32, ptr %ofont, align 4
  %bf.clear575 = and i32 %bf.load574, 4095
  %idxprom576 = zext i32 %bf.clear575 to i64
  %font_table578 = getelementptr inbounds %struct.font_rec, ptr %287, i64 %idxprom576, i32 5
  %288 = load ptr, ptr %font_table578, align 8
  %ou3 = getelementptr inbounds %struct.word_type, ptr %288, i64 0, i32 3
  %289 = load i32, ptr %ou3, align 8
  %conv579 = trunc i32 %289 to i16
  br label %if.end660
...
if.else580:                                       ; preds = %if.end569
  ...
  %290 = and i16 %bf.load581, -1024
  %or.cond1629 = icmp eq i16 %290, 9216
...
if.then591:                                       ; preds = %if.else580
  ...
  %291 = load ptr, ptr @finfo, align 8
  %bf.load597 = load i32, ptr %ofont, align 4
  %bf.clear598 = and i32 %bf.load597, 4095
  %idxprom599 = zext i32 %bf.clear598 to i64
  %font_table601 = getelementptr inbounds %struct.font_rec, ptr %291, i64 %idxprom599, i32 5
  %292 = load ptr, ptr %font_table601, align 8
  %ou3602 = getelementptr inbounds %struct.word_type, ptr %292, i64 0, i32 3
  %293 = load i32, ptr %ou3602, align 8
  %conv604 = trunc i32 %293 to i16
  br label %if.end660

if.else605:                                       ; preds = %if.else580
  %294 = load i32, ptr %inc, align 4
  %cmp606 = icmp eq i32 %294, 158
...
if.then608:                                       ; preds = %if.else605
  ...
  %295 = load i16, ptr %owidth, align 2
  br label %if.end660
...
if.else620:                                       ; preds = %if.else609
  switch i32 %294, label %if.else652 [
    i32 159, label %if.then623
    i32 160, label %if.then639
  ]

if.then623:                                       ; preds = %if.else620
  %296 = load ptr, ptr @finfo, align 8
  %idxprom627 = zext i32 %bf.clear612 to i64
  %font_table629 = getelementptr inbounds %struct.font_rec, ptr %296, i64 %idxprom627, i32 5
  %297 = load ptr, ptr %font_table629, align 8
  %ou3630 = getelementptr inbounds %struct.word_type, ptr %297, i64 0, i32 3
  %298 = load i32, ptr %ou3630, align 8
  %owidth632 = getelementptr inbounds %struct.GAP, ptr %gp, i64 0, i32 1
  %299 = load i16, ptr %owidth632, align 2
  %300 = trunc i32 %298 to i16
  %conv635 = add i16 %299, %300
  br label %if.end660

if.then639:                                       ; preds = %if.else620
  %301 = load ptr, ptr @finfo, align 8
  %idxprom643 = zext i32 %bf.clear612 to i64
  %font_table645 = getelementptr inbounds %struct.font_rec, ptr %301, i64 %idxprom643, i32 5
  %302 = load ptr, ptr %font_table645, align 8
  %ou3646 = getelementptr inbounds %struct.word_type, ptr %302, i64 0, i32 3
  %303 = load i32, ptr %ou3646, align 8
  %owidth648 = getelementptr inbounds %struct.GAP, ptr %gp, i64 0, i32 1
  %304 = load i16, ptr %owidth648, align 2
  %305 = trunc i32 %303 to i16
  %conv651 = sub i16 %305, %304
  br label %if.end660

if.else652:                                       ; preds = %if.else620
  %call654 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 37, i32 noundef 49, ptr noundef nonnull @.str.34, i32 noundef 0, ptr noundef nonnull %ou1, i32 noundef %294) #14
  br label %if.end669

if.end660:                                        ; preds = %if.then591, %if.then639, %if.then623, %if.then608, %if.then572
  %flen.0 = phi i16 [ %conv579, %if.then572 ], [ %conv604, %if.then591 ], [ %295, %if.then608 ], [ %conv635, %if.then623 ], [ %conv651, %if.then639 ]
...
if.end669:                                        ; preds = %if.else652, %if.then615, %if.end660
  ...
  %uses_font_metrics = getelementptr inbounds %struct.back_end_rec, ptr %306, i64 0, i32 8
  %307 = load i32, ptr %uses_font_metrics, align 8
  %tobool.not = icmp eq i32 %307, 0
  %308 = load i32, ptr @PlainCharHeight, align 4
  %conv671 = trunc i32 %308 to i16
  %flen.1 = select i1 %tobool.not, i16 %conv671, i16 %flen.01687
  %309 = load ptr, ptr %osucc539, align 8
  %osucc678 = getelementptr inbounds %struct.LIST, ptr %309, i64 0, i32 1
  %310 = load ptr, ptr %osucc678, align 8
  %conv703 = sext i16 %flen.1 to i32
  br label %for.cond682

for.cond682:                                      ; preds = %for.end700, %if.end669
  %.pn1625 = phi ptr [ %310, %if.end669 ], [ %link.4, %for.end700 ]
  %link.4.in = getelementptr inbounds %struct.LIST, ptr %.pn1625, i64 0, i32 1
  %link.4 = load ptr, ptr %link.4.in, align 8
...
for.cond689:                                      ; preds = %for.cond682, %for.cond689
  ...
  %fsize.0 = load ptr, ptr %fsize.0.in, align 8
  %ou1690 = getelementptr inbounds %struct.word_type, ptr %fsize.0, i64 0, i32 1
  %311 = load i8, ptr %ou1690, align 8
  %cmp693 = icmp eq i8 %311, 0
  br i1 %cmp693, label %for.cond689, label %for.end700

for.end700:                                       ; preds = %for.cond689
  %ou3701 = getelementptr inbounds %struct.word_type, ptr %fsize.0, i64 0, i32 3
  %312 = load i32, ptr %ou3701, align 8
  %cmp704 = icmp eq i32 %312, %conv703
  br i1 %cmp704, label %if.then706, label %for.cond682
...
if.then706:                                       ; preds = %for.end700
  ...
  %313 = and i16 %bf.load707, 4095
  %bf.value = zext i16 %313 to i32
  ...
  %314 = load i32, ptr %ofont_spacewidth, align 8
  %conv740 = trunc i32 %314 to i16
  %owidth742 = getelementptr inbounds %struct.STYLE, ptr %style, i64 0, i32 1, i32 0, i32 1
  store i16 %conv740, ptr %owidth742, align 2
  br label %cleanup

for.end748:                                       ; preds = %for.cond682
  %315 = load i32, ptr @font_count, align 4
  %inc749 = add i32 %315, 1
  store i32 %inc749, ptr @font_count, align 4
  %316 = load i32, ptr @finfo_size, align 4
  %cmp750.not = icmp ult i32 %inc749, %316
...
if.then755:                                       ; preds = %if.then752
  ...
  %.pre1838 = load i32, ptr @finfo_size, align 4
  br label %if.end758

if.end758:                                        ; preds = %if.then755, %if.then752
  %317 = phi i32 [ %.pre1838, %if.then755 ], [ %316, %if.then752 ]
  %mul = shl nsw i32 %317, 1
  store i32 %mul, ptr @finfo_size, align 4
  %318 = load ptr, ptr @finfo, align 8
  %conv759 = sext i32 %mul to i64
  %mul760 = mul nsw i64 %conv759, 96
  %call761 = call ptr @realloc(ptr noundef %318, i64 noundef %mul760) #17
  store ptr %call761, ptr @finfo, align 8
...
if.end768:                                        ; preds = %if.end758, %if.then764, %for.end748
  %319 = load ptr, ptr %osucc539, align 8
  %osucc774 = getelementptr inbounds %struct.LIST, ptr %319, i64 0, i32 1
  %320 = load ptr, ptr %osucc774, align 8
  %osucc777 = getelementptr inbounds %struct.LIST, ptr %320, i64 0, i32 1
  %321 = load ptr, ptr %osucc777, align 8
  br label %for.cond781

for.cond781:                                      ; preds = %for.cond781, %if.end768
  %.pn1624 = phi ptr [ %321, %if.end768 ], [ %old.0, %for.cond781 ]
  %old.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn1624, i64 0, i64 1
  %old.0 = load ptr, ptr %old.0.in, align 8
  %ou1782 = getelementptr inbounds %struct.word_type, ptr %old.0, i64 0, i32 1
  %322 = load i8, ptr %ou1782, align 8
  switch i8 %322, label %if.then804 [
...
if.then804:                                       ; preds = %for.cond781
  ...
  %call805 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.10, i32 noundef 0, ptr noundef %323, ptr noundef nonnull @.str.38) #14
  br label %if.end806
...
if.end806:                                        ; preds = %for.cond781, %for.cond781, %if.then804
  ...
  %call809 = call ptr @MakeWord(i32 noundef 11, ptr noundef nonnull %ostring807, ptr noundef %324) #14
  %325 = load i8, ptr @zz_lengths, align 1
  %conv810 = zext i8 %325 to i32
  store i32 %conv810, ptr @zz_size, align 4
  %conv811 = zext i8 %325 to i64
  %arrayidx818 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv811
  %326 = load ptr, ptr %arrayidx818, align 8
  %cmp819 = icmp eq ptr %326, null
  br i1 %cmp819, label %if.then821, label %if.else823

if.then821:                                       ; preds = %if.end806
  %327 = load ptr, ptr @no_fpos, align 8
  %call822 = call ptr @GetMemory(i32 noundef %conv810, ptr noundef %327) #14
  br label %cond.end874

if.else823:                                       ; preds = %if.end806
  store ptr %326, ptr @zz_hold, align 8
  %328 = load ptr, ptr %326, align 8
  store ptr %328, ptr %arrayidx818, align 8
  br label %cond.end874

cond.end874:                                      ; preds = %if.then821, %if.else823
  %329 = phi ptr [ %call822, %if.then821 ], [ %326, %if.else823 ]
  %ou1833 = getelementptr inbounds %struct.word_type, ptr %329, i64 0, i32 1
  store i8 0, ptr %ou1833, align 8
  %osucc837 = getelementptr inbounds [2 x %struct.LIST], ptr %329, i64 0, i64 1, i32 1
  store ptr %329, ptr %osucc837, align 8
  %arrayidx839 = getelementptr inbounds [2 x %struct.LIST], ptr %329, i64 0, i64 1
  store ptr %329, ptr %arrayidx839, align 8
  %osucc843 = getelementptr inbounds %struct.LIST, ptr %329, i64 0, i32 1
  store ptr %329, ptr %osucc843, align 8
  store ptr %329, ptr %329, align 8
  store ptr %329, ptr @xx_link, align 8
  store ptr %329, ptr @zz_res, align 8
  store ptr %face.2, ptr @zz_hold, align 8
  %330 = load ptr, ptr %face.2, align 8
  store ptr %330, ptr @zz_tmp, align 8
  %331 = load ptr, ptr %329, align 8
  store ptr %331, ptr %face.2, align 8
  %332 = load ptr, ptr @zz_hold, align 8
  %333 = load ptr, ptr @zz_res, align 8
  %334 = load ptr, ptr %333, align 8
  %osucc867 = getelementptr inbounds %struct.LIST, ptr %334, i64 0, i32 1
  store ptr %332, ptr %osucc867, align 8
  %335 = load ptr, ptr @zz_tmp, align 8
  store ptr %335, ptr %333, align 8
  %336 = load ptr, ptr @zz_res, align 8
  %337 = load ptr, ptr @zz_tmp, align 8
  %osucc873 = getelementptr inbounds %struct.LIST, ptr %337, i64 0, i32 1
  store ptr %336, ptr %osucc873, align 8
  %338 = load ptr, ptr @xx_link, align 8
  store ptr %338, ptr @zz_res, align 8
  store ptr %call809, ptr @zz_hold, align 8
  %cmp876 = icmp eq ptr %call809, null
  %cmp880 = icmp eq ptr %338, null
  %or.cond1630 = select i1 %cmp876, i1 true, i1 %cmp880
  br i1 %or.cond1630, label %cond.end907, label %cond.false883

cond.false883:                                    ; preds = %cond.end874
  %arrayidx885 = getelementptr inbounds [2 x %struct.LIST], ptr %call809, i64 0, i64 1
  %339 = load ptr, ptr %arrayidx885, align 8
  store ptr %339, ptr @zz_tmp, align 8
  %arrayidx888 = getelementptr inbounds [2 x %struct.LIST], ptr %338, i64 0, i64 1
  %340 = load ptr, ptr %arrayidx888, align 8
  store ptr %340, ptr %arrayidx885, align 8
  %341 = load ptr, ptr %arrayidx888, align 8
  %osucc898 = getelementptr inbounds [2 x %struct.LIST], ptr %341, i64 0, i64 1, i32 1
  store ptr %call809, ptr %osucc898, align 8
  store ptr %339, ptr %arrayidx888, align 8
  %osucc904 = getelementptr inbounds [2 x %struct.LIST], ptr %339, i64 0, i64 1, i32 1
  store ptr %338, ptr %osucc904, align 8
  br label %cond.end907

cond.end907:                                      ; preds = %cond.end874, %cond.false883
  %342 = load i32, ptr @font_count, align 4
  %ou2909 = getelementptr inbounds %struct.word_type, ptr %call809, i64 0, i32 2
  %343 = trunc i32 %342 to i16
  %bf.load910 = load i16, ptr %ou2909, align 8
  %bf.value911 = and i16 %343, 4095
  %bf.clear912 = and i16 %bf.load910, -4096
  %bf.set913 = or i16 %bf.clear912, %bf.value911
  store i16 %bf.set913, ptr %ou2909, align 8
  %344 = load ptr, ptr @BackEnd, align 8
  %uses_font_metrics915 = getelementptr inbounds %struct.back_end_rec, ptr %344, i64 0, i32 8
  %345 = load i32, ptr %uses_font_metrics915, align 8
  %tobool916.not = icmp eq i32 %345, 0
...
cond.end922:                                      ; preds = %cond.end907, %cond.false919
  ...
  %347 = load i32, ptr %ofont_xheight2, align 4
  %mul929 = mul nsw i32 %347, %cond923
  %348 = load i32, ptr %ou3926, align 8
  %div = sdiv i32 %mul929, %348
  %ofont_xheight2933 = getelementptr inbounds i8, ptr %call809, i64 52
  store i32 %div, ptr %ofont_xheight2933, align 4
  ...
  %349 = load i32, ptr %ofont_spacewidth958, align 8
  %mul961 = mul nsw i32 %349, %cond923
  %350 = load i32, ptr %ou3926, align 8
  %div964 = sdiv i32 %mul961, %350
  %ofont_spacewidth966 = getelementptr inbounds %struct.word_type, ptr %call809, i64 0, i32 3, i32 1
  store i32 %div964, ptr %ofont_spacewidth966, align 8
  %351 = load ptr, ptr @finfo, align 8
  %idxprom967 = zext i32 %342 to i64
  %font_table969 = getelementptr inbounds %struct.font_rec, ptr %351, i64 %idxprom967, i32 5
  store ptr %call809, ptr %font_table969, align 8
  %352 = load ptr, ptr @finfo, align 8
  %original_face = getelementptr inbounds %struct.font_rec, ptr %352, i64 %idxprom967, i32 6
  store ptr %face.2, ptr %original_face, align 8
  %353 = load ptr, ptr @finfo, align 8
  ...
  %underline_pos = getelementptr inbounds %struct.font_rec, ptr %353, i64 %idxprom976, i32 7
  %354 = load i16, ptr %underline_pos, align 8
  %conv978 = sext i16 %354 to i32
  %355 = load i32, ptr %ou3924, align 8
  %mul981 = mul nsw i32 %355, %conv978
  %356 = load i32, ptr %ou3926, align 8
  %div984 = sdiv i32 %mul981, %356
  %conv985 = trunc i32 %div984 to i16
  %underline_pos988 = getelementptr inbounds %struct.font_rec, ptr %353, i64 %idxprom967, i32 7
  store i16 %conv985, ptr %underline_pos988, align 8
  %bf.load990 = load i16, ptr %ou2972, align 8
  %bf.clear991 = and i16 %bf.load990, 4095
  %idxprom993 = zext i16 %bf.clear991 to i64
  %underline_thick = getelementptr inbounds %struct.font_rec, ptr %353, i64 %idxprom993, i32 8
  %357 = load i16, ptr %underline_thick, align 2
  %conv995 = sext i16 %357 to i32
  %358 = load i32, ptr %ou3924, align 8
  %mul998 = mul nsw i32 %358, %conv995
  %359 = load i32, ptr %ou3926, align 8
  %div1001 = sdiv i32 %mul998, %359
  %conv1002 = trunc i32 %div1001 to i16
  %underline_thick1005 = getelementptr inbounds %struct.font_rec, ptr %353, i64 %idxprom967, i32 8
  store i16 %conv1002, ptr %underline_thick1005, align 2
  %call1006 = call noalias dereferenceable_or_null(2560) ptr @malloc(i64 noundef 2560) #15
  %arrayidx1008 = getelementptr inbounds %struct.font_rec, ptr %353, i64 %idxprom967
  store ptr %call1006, ptr %arrayidx1008, align 8
  %360 = load ptr, ptr @finfo, align 8
  %arrayidx1010 = getelementptr inbounds %struct.font_rec, ptr %360, i64 %idxprom967
  %361 = load ptr, ptr %arrayidx1010, align 8
  %cmp1012 = icmp eq ptr %361, null
...
if.then1014:                                      ; preds = %cond.end922
  ...
  %.pre1839 = load ptr, ptr @finfo, align 8
  %.pre1840 = load i32, ptr @font_count, align 4
  %.pre1843 = zext i32 %.pre1840 to i64
  br label %if.end1017

if.end1017:                                       ; preds = %if.then1014, %cond.end922
  %idxprom1024.pre-phi = phi i64 [ %.pre1843, %if.then1014 ], [ %idxprom967, %cond.end922 ]
  %362 = phi ptr [ %.pre1839, %if.then1014 ], [ %360, %cond.end922 ]
  %bf.load1019 = load i16, ptr %ou2972, align 8
  %bf.clear1020 = and i16 %bf.load1019, 4095
  %idxprom1022 = zext i16 %bf.clear1020 to i64
  %lig_table = getelementptr inbounds %struct.font_rec, ptr %362, i64 %idxprom1022, i32 1
  %363 = load ptr, ptr %lig_table, align 8
  %lig_table1026 = getelementptr inbounds %struct.font_rec, ptr %362, i64 %idxprom1024.pre-phi, i32 1
  store ptr %363, ptr %lig_table1026, align 8
  %364 = load ptr, ptr @finfo, align 8
  %bf.load1028 = load i16, ptr %ou2909, align 8
  %bf.clear1029 = and i16 %bf.load1028, 4095
  %idxprom1031 = zext i16 %bf.clear1029 to i64
  %arrayidx1032 = getelementptr inbounds %struct.font_rec, ptr %364, i64 %idxprom1031
  %365 = load ptr, ptr %arrayidx1032, align 8
  %bf.load1035 = load i16, ptr %ou2972, align 8
  %bf.clear1036 = and i16 %bf.load1035, 4095
  %idxprom1038 = zext i16 %bf.clear1036 to i64
  %arrayidx1039 = getelementptr inbounds %struct.font_rec, ptr %364, i64 %idxprom1038
  %366 = load ptr, ptr %arrayidx1039, align 8
  br label %for.body1044

for.body1044:                                     ; preds = %if.end1017, %for.inc1117
  %indvars.iv1820 = phi i64 [ 0, %if.end1017 ], [ %indvars.iv.next1821, %for.inc1117 ]
  %arrayidx1046 = getelementptr inbounds i8, ptr %363, i64 %indvars.iv1820
  %367 = load i8, ptr %arrayidx1046, align 1
  %cmp1048.not = icmp eq i8 %367, 1
  br i1 %cmp1048.not, label %for.inc1117, label %if.then1050

if.then1050:                                      ; preds = %for.body1044
  %arrayidx1052 = getelementptr inbounds %struct.metrics, ptr %366, i64 %indvars.iv1820
  %left = getelementptr inbounds %struct.metrics, ptr %366, i64 %indvars.iv1820, i32 2
  %368 = load i16, ptr %left, align 2
  %conv1053 = sext i16 %368 to i32
  %369 = load i32, ptr %ou3924, align 8
  %mul1056 = mul nsw i32 %369, %conv1053
  %370 = load i32, ptr %ou3926, align 8
  %div1059 = sdiv i32 %mul1056, %370
  %conv1060 = trunc i32 %div1059 to i16
  %arrayidx1062 = getelementptr inbounds %struct.metrics, ptr %365, i64 %indvars.iv1820
  %left1063 = getelementptr inbounds %struct.metrics, ptr %365, i64 %indvars.iv1820, i32 2
  store i16 %conv1060, ptr %left1063, align 2
  %right = getelementptr inbounds %struct.metrics, ptr %366, i64 %indvars.iv1820, i32 3
  %371 = load i16, ptr %right, align 2
  %conv1066 = sext i16 %371 to i32
  %372 = load i32, ptr %ou3924, align 8
  %mul1069 = mul nsw i32 %372, %conv1066
  %373 = load i32, ptr %ou3926, align 8
  %div1072 = sdiv i32 %mul1069, %373
  %conv1073 = trunc i32 %div1072 to i16
  %right1076 = getelementptr inbounds %struct.metrics, ptr %365, i64 %indvars.iv1820, i32 3
  store i16 %conv1073, ptr %right1076, align 2
  %down = getelementptr inbounds %struct.metrics, ptr %366, i64 %indvars.iv1820, i32 1
  %374 = load i16, ptr %down, align 2
  %conv1079 = sext i16 %374 to i32
  %375 = load i32, ptr %ou3924, align 8
  %mul1082 = mul nsw i32 %375, %conv1079
  %376 = load i32, ptr %ou3926, align 8
  %div1085 = sdiv i32 %mul1082, %376
  %conv1086 = trunc i32 %div1085 to i16
  %down1089 = getelementptr inbounds %struct.metrics, ptr %365, i64 %indvars.iv1820, i32 1
  store i16 %conv1086, ptr %down1089, align 2
  %377 = load i16, ptr %arrayidx1052, align 2
  %conv1092 = sext i16 %377 to i32
  %378 = load i32, ptr %ou3924, align 8
  %mul1095 = mul nsw i32 %378, %conv1092
  %379 = load i32, ptr %ou3926, align 8
  %div1098 = sdiv i32 %mul1095, %379
  %conv1099 = trunc i32 %div1098 to i16
  store i16 %conv1099, ptr %arrayidx1062, align 2
  %last_adjust = getelementptr inbounds %struct.metrics, ptr %366, i64 %indvars.iv1820, i32 4
  %380 = load i16, ptr %last_adjust, align 2
  %conv1105 = sext i16 %380 to i32
  %381 = load i32, ptr %ou3924, align 8
  %mul1108 = mul nsw i32 %381, %conv1105
  %382 = load i32, ptr %ou3926, align 8
  %div1111 = sdiv i32 %mul1108, %382
  %conv1112 = trunc i32 %div1111 to i16
  %last_adjust1115 = getelementptr inbounds %struct.metrics, ptr %365, i64 %indvars.iv1820, i32 4
  store i16 %conv1112, ptr %last_adjust1115, align 2
  br label %for.inc1117

for.inc1117:                                      ; preds = %for.body1044, %if.then1050
  %indvars.iv.next1821 = add nuw nsw i64 %indvars.iv1820, 1
  %exitcond1823.not = icmp eq i64 %indvars.iv.next1821, 256
  br i1 %exitcond1823.not, label %for.end1119, label %for.body1044
...
for.end1119:                                      ; preds = %for.inc1117
  ...
  %composite = getelementptr inbounds %struct.font_rec, ptr %364, i64 %idxprom1124, i32 2
  %383 = load ptr, ptr %composite, align 8
  %composite1128 = getelementptr inbounds %struct.font_rec, ptr %364, i64 %idxprom1024.pre-phi, i32 2
  store ptr %383, ptr %composite1128, align 8
  %384 = load ptr, ptr @finfo, align 8
  %bf.load1130 = load i16, ptr %ou2972, align 8
  %bf.clear1131 = and i16 %bf.load1130, 4095
  %idxprom1133 = zext i16 %bf.clear1131 to i64
  %cmp_top = getelementptr inbounds %struct.font_rec, ptr %384, i64 %idxprom1133, i32 4
  %385 = load i32, ptr %cmp_top, align 8
  %cmp_top1137 = getelementptr inbounds %struct.font_rec, ptr %384, i64 %idxprom1024.pre-phi, i32 4
  store i32 %385, ptr %cmp_top1137, align 8
  %bf.load1139 = load i16, ptr %ou2972, align 8
  %bf.clear1140 = and i16 %bf.load1139, 4095
  %idxprom1142 = zext i16 %bf.clear1140 to i64
  %cmp_table = getelementptr inbounds %struct.font_rec, ptr %384, i64 %idxprom1142, i32 3
  %386 = load ptr, ptr %cmp_table, align 8
  %conv1144 = sext i32 %385 to i64
...
if.end1152:                                       ; preds = %if.then1149, %for.end1119
  %cmp11541762 = icmp sgt i32 %385, 1
  br i1 %cmp11541762, label %for.body1156.preheader, label %for.end1198

for.body1156.preheader:                           ; preds = %if.end1152
  %wide.trip.count = zext i32 %385 to i64
  br label %for.body1156

for.body1156:                                     ; preds = %for.body1156.preheader, %for.inc1196
  %indvars.iv1824 = phi i64 [ 1, %for.body1156.preheader ], [ %indvars.iv.next1825, %for.inc1196 ]
  %arrayidx1158 = getelementptr inbounds %struct.composite_rec, ptr %386, i64 %indvars.iv1824
  %387 = load i8, ptr %arrayidx1158, align 2
  %arrayidx1160 = getelementptr inbounds %struct.composite_rec, ptr %call1146, i64 %indvars.iv1824
  store i8 %387, ptr %arrayidx1160, align 2
  %cmp1166.not = icmp eq i8 %387, 0
  br i1 %cmp1166.not, label %for.inc1196, label %if.then1168

if.then1168:                                      ; preds = %for.body1156
  %x_offset = getelementptr inbounds %struct.composite_rec, ptr %386, i64 %indvars.iv1824, i32 1
  %388 = load i16, ptr %x_offset, align 2
  %conv1171 = sext i16 %388 to i32
  %389 = load i32, ptr %ou3924, align 8
  %mul1174 = mul nsw i32 %389, %conv1171
  %390 = load i32, ptr %ou3926, align 8
  %div1177 = sdiv i32 %mul1174, %390
  %conv1178 = trunc i32 %div1177 to i16
  %x_offset1181 = getelementptr inbounds %struct.composite_rec, ptr %call1146, i64 %indvars.iv1824, i32 1
  store i16 %conv1178, ptr %x_offset1181, align 2
  %y_offset = getelementptr inbounds %struct.composite_rec, ptr %386, i64 %indvars.iv1824, i32 2
  %391 = load i16, ptr %y_offset, align 2
  %conv1184 = sext i16 %391 to i32
  %392 = load i32, ptr %ou3924, align 8
  %mul1187 = mul nsw i32 %392, %conv1184
  %393 = load i32, ptr %ou3926, align 8
  %div1190 = sdiv i32 %mul1187, %393
  %conv1191 = trunc i32 %div1190 to i16
  %y_offset1194 = getelementptr inbounds %struct.composite_rec, ptr %call1146, i64 %indvars.iv1824, i32 2
  store i16 %conv1191, ptr %y_offset1194, align 2
  br label %for.inc1196

for.inc1196:                                      ; preds = %for.body1156, %if.then1168
  %indvars.iv.next1825 = add nuw nsw i64 %indvars.iv1824, 1
  %exitcond1827.not = icmp eq i64 %indvars.iv.next1825, %wide.trip.count
  br i1 %exitcond1827.not, label %for.end1198, label %for.body1156

for.end1198:                                      ; preds = %for.inc1196, %if.end1152
  %394 = load ptr, ptr @finfo, align 8
  %395 = load i32, ptr @font_count, align 4
  %idxprom1199 = zext i32 %395 to i64
  %cmp_table1201 = getelementptr inbounds %struct.font_rec, ptr %394, i64 %idxprom1199, i32 3
  store ptr %call1146, ptr %cmp_table1201, align 8
  %396 = load ptr, ptr @finfo, align 8
  %bf.load1203 = load i16, ptr %ou2972, align 8
  %bf.clear1204 = and i16 %bf.load1203, 4095
  %idxprom1206 = zext i16 %bf.clear1204 to i64
  %kern_table = getelementptr inbounds %struct.font_rec, ptr %396, i64 %idxprom1206, i32 9
  %397 = load ptr, ptr %kern_table, align 8
  %kern_table1210 = getelementptr inbounds %struct.font_rec, ptr %396, i64 %idxprom1199, i32 9
  store ptr %397, ptr %kern_table1210, align 8
  %398 = load ptr, ptr @finfo, align 8
  %bf.load1212 = load i16, ptr %ou2972, align 8
  %bf.clear1213 = and i16 %bf.load1212, 4095
  %idxprom1215 = zext i16 %bf.clear1213 to i64
  %kern_chars = getelementptr inbounds %struct.font_rec, ptr %398, i64 %idxprom1215, i32 10
  %399 = load ptr, ptr %kern_chars, align 8
  %kern_chars1219 = getelementptr inbounds %struct.font_rec, ptr %398, i64 %idxprom1199, i32 10
  store ptr %399, ptr %kern_chars1219, align 8
  %400 = load ptr, ptr @finfo, align 8
  %bf.load1221 = load i16, ptr %ou2972, align 8
  %bf.clear1222 = and i16 %bf.load1221, 4095
  %idxprom1224 = zext i16 %bf.clear1222 to i64
  %kern_value = getelementptr inbounds %struct.font_rec, ptr %400, i64 %idxprom1224, i32 11
  %401 = load ptr, ptr %kern_value, align 8
  %kern_value1228 = getelementptr inbounds %struct.font_rec, ptr %400, i64 %idxprom1199, i32 11
  store ptr %401, ptr %kern_value1228, align 8
  %402 = load ptr, ptr @finfo, align 8
  %bf.load1230 = load i16, ptr %ou2972, align 8
  %bf.clear1231 = and i16 %bf.load1230, 4095
  %idxprom1233 = zext i16 %bf.clear1231 to i64
  %kern_sizes = getelementptr inbounds %struct.font_rec, ptr %402, i64 %idxprom1233, i32 12
  %403 = load ptr, ptr %kern_sizes, align 8
  %cmp1235.not = icmp eq ptr %403, null
  br i1 %cmp1235.not, label %if.else1273, label %if.then1237

if.then1237:                                      ; preds = %for.end1198
  %404 = load i16, ptr %403, align 2
  %conv1239 = sext i16 %404 to i64
  %conv1240 = sext i16 %404 to i64
  %mul1241 = shl nsw i64 %conv1240, 1
  %call1242 = call noalias ptr @malloc(i64 noundef %mul1241) #15
  %kern_sizes1245 = getelementptr inbounds %struct.font_rec, ptr %402, i64 %idxprom1199, i32 12
  store ptr %call1242, ptr %kern_sizes1245, align 8
...
if.end1251:                                       ; preds = %if.then1248, %if.then1237
  store i16 %404, ptr %call1242, align 2
  %cmp12551764 = icmp sgt i16 %404, 1
  br i1 %cmp12551764, label %for.body1257.preheader, label %if.end1277

for.body1257.preheader:                           ; preds = %if.end1251
  %wide.trip.count1831 = and i64 %conv1239, 4294967295
  %405 = add nsw i64 %wide.trip.count1831, -1
  %xtraiter2006 = and i64 %405, 1
  %406 = icmp eq i64 %wide.trip.count1831, 2
  br i1 %406, label %if.end1277.loopexit.unr-lcssa, label %for.body1257.preheader.new

for.body1257.preheader.new:                       ; preds = %for.body1257.preheader
  %unroll_iter = and i64 %405, -2
  br label %for.body1257

for.body1257:                                     ; preds = %for.body1257, %for.body1257.preheader.new
  %indvars.iv1828 = phi i64 [ 1, %for.body1257.preheader.new ], [ %indvars.iv.next1829.1, %for.body1257 ]
  %niter = phi i64 [ 0, %for.body1257.preheader.new ], [ %niter.next.1, %for.body1257 ]
  %arrayidx1259 = getelementptr inbounds i16, ptr %403, i64 %indvars.iv1828
  %407 = load i16, ptr %arrayidx1259, align 2
  %conv1260 = sext i16 %407 to i32
  %408 = load i32, ptr %ou3924, align 8
  %mul1263 = mul nsw i32 %408, %conv1260
  %409 = load i32, ptr %ou3926, align 8
  %div1266 = sdiv i32 %mul1263, %409
  %conv1267 = trunc i32 %div1266 to i16
  %arrayidx1269 = getelementptr inbounds i16, ptr %call1242, i64 %indvars.iv1828
  store i16 %conv1267, ptr %arrayidx1269, align 2
  %indvars.iv.next1829 = add nuw nsw i64 %indvars.iv1828, 1
  %arrayidx1259.1 = getelementptr inbounds i16, ptr %403, i64 %indvars.iv.next1829
  %410 = load i16, ptr %arrayidx1259.1, align 2
  %conv1260.1 = sext i16 %410 to i32
  %411 = load i32, ptr %ou3924, align 8
  %mul1263.1 = mul nsw i32 %411, %conv1260.1
  %412 = load i32, ptr %ou3926, align 8
  %div1266.1 = sdiv i32 %mul1263.1, %412
  %conv1267.1 = trunc i32 %div1266.1 to i16
  %arrayidx1269.1 = getelementptr inbounds i16, ptr %call1242, i64 %indvars.iv.next1829
  store i16 %conv1267.1, ptr %arrayidx1269.1, align 2
  %indvars.iv.next1829.1 = add nuw nsw i64 %indvars.iv1828, 2
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %if.end1277.loopexit.unr-lcssa, label %for.body1257

if.else1273:                                      ; preds = %for.end1198
  %kern_sizes1276 = getelementptr inbounds %struct.font_rec, ptr %402, i64 %idxprom1199, i32 12
  store ptr null, ptr %kern_sizes1276, align 8
  br label %if.end1277

if.end1277.loopexit.unr-lcssa:                    ; preds = %for.body1257, %for.body1257.preheader
  %indvars.iv1828.unr = phi i64 [ 1, %for.body1257.preheader ], [ %indvars.iv.next1829.1, %for.body1257 ]
  %lcmp.mod2007.not = icmp eq i64 %xtraiter2006, 0
  br i1 %lcmp.mod2007.not, label %if.end1277, label %for.body1257.epil

for.body1257.epil:                                ; preds = %if.end1277.loopexit.unr-lcssa
  %arrayidx1259.epil = getelementptr inbounds i16, ptr %403, i64 %indvars.iv1828.unr
  %413 = load i16, ptr %arrayidx1259.epil, align 2
  %conv1260.epil = sext i16 %413 to i32
  %414 = load i32, ptr %ou3924, align 8
  %mul1263.epil = mul nsw i32 %414, %conv1260.epil
  %415 = load i32, ptr %ou3926, align 8
  %div1266.epil = sdiv i32 %mul1263.epil, %415
  %conv1267.epil = trunc i32 %div1266.epil to i16
  %arrayidx1269.epil = getelementptr inbounds i16, ptr %call1242, i64 %indvars.iv1828.unr
  store i16 %conv1267.epil, ptr %arrayidx1269.epil, align 2
  br label %if.end1277

if.end1277:                                       ; preds = %for.body1257.epil, %if.end1277.loopexit.unr-lcssa, %if.end1251, %if.else1273
  %416 = load i32, ptr @font_count, align 4
  %bf.load1279 = load i32, ptr %ofont, align 4
  %bf.value1280 = and i32 %416, 4095
  ...
  %417 = load i32, ptr %ofont_spacewidth966, align 8
  %conv1313 = trunc i32 %417 to i16
  %owidth1315 = getelementptr inbounds %struct.STYLE, ptr %style, i64 0, i32 1, i32 0, i32 1
  store i16 %conv1313, ptr %owidth1315, align 2
  br label %cleanup
...
land.lhs.true:                                    ; preds = %if.end22
  ...
  %8 = load i32, ptr %colour_avail, align 4
...
if.end46:                                         ; preds = %if.then41, %if.end34
  ...
  %.pre = load i8, ptr %ostring, align 1
  br label %do.body

do.body:                                          ; preds = %if.end204, %if.end46
  %15 = phi i8 [ %.pre, %if.end46 ], [ %47, %if.end204 ]
...
if.then91:                                        ; preds = %if.then80
  ...
  store i16 %19, ptr %arrayidx97, align 2
...
if.else:                                          ; preds = %if.then80
  ...
  store i8 32, ptr %q.0, align 1
  store i8 32, ptr %p.0, align 1
  %.pre472.pre = load i8, ptr %q.0, align 1
  br label %if.end136

if.end136:                                        ; preds = %if.else, %if.then91
  %.pre472 = phi i8 [ %.pre472.pre, %if.else ], [ %17, %if.then91 ]
  store ptr %call82, ptr @zz_hold, align 8
  %ou1137 = getelementptr inbounds %struct.word_type, ptr %call82, i64 0, i32 1
  %28 = load i8, ptr %ou1137, align 8
  %.off447 = add i8 %28, -11
  ...
  %29 = load ptr, ptr %arrayidx156, align 8
  store ptr %29, ptr %call82, align 8
  %30 = load ptr, ptr @zz_hold, align 8
  %31 = load i32, ptr @zz_size, align 4
  %idxprom158 = sext i32 %31 to i64
  %arrayidx159 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom158
  store ptr %30, ptr %arrayidx159, align 8
  br label %if.end204

if.else160:                                       ; preds = %do.body
  %32 = load i8, ptr %p.0, align 1
  ...
  %34 = load i8, ptr %arrayidx166, align 1
  %cmp171458 = icmp eq i8 %34, %32
  br i1 %cmp171458, label %while.body.lr.ph, label %if.end204

while.body.lr.ph:                                 ; preds = %if.else160
  %35 = load i8, ptr %incdec.ptr, align 1
  br label %while.body

while.body:                                       ; preds = %while.body.lr.ph, %while.end199
  %a.0459 = phi ptr [ %arrayidx166, %while.body.lr.ph ], [ %incdec.ptr200, %while.end199 ]
  %incdec.ptr167 = getelementptr inbounds i8, ptr %a.0459, i64 1
  %36 = load i8, ptr %incdec.ptr167, align 1
  %cmp176450 = icmp eq i8 %36, %35
  br i1 %cmp176450, label %land.lhs.true178, label %while.end

land.lhs.true178:                                 ; preds = %while.body, %while.body186
  %37 = phi i8 [ %38, %while.body186 ], [ %35, %while.body ]
  %a.1452 = phi ptr [ %add.ptr179, %while.body186 ], [ %incdec.ptr167, %while.body ]
  %b.0451 = phi ptr [ %incdec.ptr188, %while.body186 ], [ %incdec.ptr, %while.body ]
  %add.ptr179 = getelementptr inbounds i8, ptr %a.1452, i64 1
  %38 = load i8, ptr %add.ptr179, align 1
...
while.body186:                                    ; preds = %land.lhs.true178
  %incdec.ptr188 = getelementptr inbounds i8, ptr %b.0451, i64 1
  %39 = load i8, ptr %incdec.ptr188, align 1
  %cmp176 = icmp eq i8 %38, %39
  br i1 %cmp176, label %land.lhs.true178, label %while.end

while.end:                                        ; preds = %while.body186, %land.lhs.true178, %while.body
  %b.0.lcssa = phi ptr [ %incdec.ptr, %while.body ], [ %b.0451, %land.lhs.true178 ], [ %incdec.ptr188, %while.body186 ]
  %a.1.lcssa = phi ptr [ %incdec.ptr167, %while.body ], [ %a.1452, %land.lhs.true178 ], [ %add.ptr179, %while.body186 ]
  %.lcssa449 = phi i8 [ %36, %while.body ], [ %37, %land.lhs.true178 ], [ %38, %while.body186 ]
  %add.ptr189 = getelementptr inbounds i8, ptr %a.1.lcssa, i64 1
  %40 = load i8, ptr %add.ptr189, align 1
  %cmp191 = icmp eq i8 %40, 0
  br i1 %cmp191, label %if.then193, label %while.cond195

if.then193:                                       ; preds = %while.end
  store i8 %.lcssa449, ptr %q.0, align 1
  br label %if.end204
...
while.cond195:                                    ; preds = %while.end, %while.cond195
  ...
  %41 = load i8, ptr %incdec.ptr196, align 1
  %tobool197.not = icmp eq i8 %41, 0
  br i1 %tobool197.not, label %while.end199, label %while.cond195

while.end199:                                     ; preds = %while.cond195
  %incdec.ptr200 = getelementptr inbounds i8, ptr %a.2, i64 2
  %42 = load i8, ptr %incdec.ptr200, align 1
  %cmp171 = icmp eq i8 %42, %32
  br i1 %cmp171, label %while.body, label %if.end204

if.end204:                                        ; preds = %while.end199, %if.else160, %do.body, %if.end136, %if.then193
  %43 = phi i8 [ %.pre472, %if.end136 ], [ %.lcssa449, %if.then193 ], [ %15, %do.body ], [ %15, %if.else160 ], [ %15, %while.end199 ]
  %p.1 = phi ptr [ %incdec.ptr, %if.end136 ], [ %b.0.lcssa, %if.then193 ], [ %incdec.ptr, %do.body ], [ %incdec.ptr, %if.else160 ], [ %incdec.ptr, %while.end199 ]
  %idxprom205 = zext i8 %43 to i64
  %arrayidx206 = getelementptr inbounds %struct.metrics, ptr %11, i64 %idxprom205
  %44 = load i16, ptr %arrayidx206, align 2
  %conv208 = sext i16 %44 to i32
  ...
  %45 = load i16, ptr %down219, align 2
  %conv220 = sext i16 %45 to i32
  ...
  %46 = load i16, ptr %right232, align 2
  %conv233 = sext i16 %46 to i32
  %add234 = add nsw i32 %r.0, %conv233
  %47 = load i8, ptr %p.1, align 1
  %tobool235.not = icmp eq i8 %47, 0
  br i1 %tobool235.not, label %do.end, label %do.body

do.end:                                           ; preds = %if.end204
  store i8 0, ptr %incdec.ptr229, align 1
  %last_adjust239 = getelementptr inbounds %struct.metrics, ptr %11, i64 %idxprom205, i32 4
  %48 = load i16, ptr %last_adjust239, align 2
  %conv240 = sext i16 %48 to i32
  %add241 = add nsw i32 %add234, %conv240
  %q.1460 = getelementptr inbounds i8, ptr %buff, i64 1
  %49 = load i8, ptr %q.1460, align 1
  %tobool244.not461 = icmp eq i8 %49, 0
  br i1 %tobool244.not461, label %for.end304, label %for.body.lr.ph
...
for.body.lr.ph:                                   ; preds = %do.end
  ...
  %kern_table = getelementptr inbounds %struct.font_rec, ptr %50, i64 %idxprom254, i32 9
  %51 = load ptr, ptr %kern_table, align 8
  %kern_chars = getelementptr inbounds %struct.font_rec, ptr %50, i64 %idxprom254, i32 10
  %kern_sizes = getelementptr inbounds %struct.font_rec, ptr %50, i64 %idxprom254, i32 12
  %kern_value = getelementptr inbounds %struct.font_rec, ptr %50, i64 %idxprom254, i32 11
  br label %for.body

for.body:                                         ; preds = %for.body.lr.ph, %if.end299
  %52 = phi i8 [ %49, %for.body.lr.ph ], [ %64, %if.end299 ]
  %q.1464 = phi ptr [ %q.1460, %for.body.lr.ph ], [ %q.1, %if.end299 ]
  %p.2463 = phi ptr [ %buff, %for.body.lr.ph ], [ %incdec.ptr302, %if.end299 ]
  %r.1462 = phi i32 [ %add241, %for.body.lr.ph ], [ %add300, %if.end299 ]
  %53 = load i8, ptr %p.2463, align 1
  %idxprom245 = zext i8 %53 to i64
  %arrayidx246 = getelementptr inbounds i8, ptr %arrayidx64, i64 %idxprom245
  %54 = load i8, ptr %arrayidx246, align 1
  %idxprom248 = zext i8 %52 to i64
  %arrayidx249 = getelementptr inbounds i8, ptr %arrayidx64, i64 %idxprom248
  %55 = load i8, ptr %arrayidx249, align 1
  %idxprom256 = zext i8 %54 to i64
  %arrayidx257 = getelementptr inbounds i16, ptr %51, i64 %idxprom256
  %56 = load i16, ptr %arrayidx257, align 2
  %cmp259 = icmp eq i16 %56, 0
  br i1 %cmp259, label %if.end299, label %if.else262

if.else262:                                       ; preds = %for.body
  %57 = load ptr, ptr %kern_chars, align 8
  %58 = zext i16 %56 to i64
  br label %for.cond268

for.cond268:                                      ; preds = %for.cond268, %if.else262
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.cond268 ], [ %58, %if.else262 ]
  %arrayidx270 = getelementptr inbounds i8, ptr %57, i64 %indvars.iv
  %59 = load i8, ptr %arrayidx270, align 1
  %cmp272 = icmp ugt i8 %59, %55
  %indvars.iv.next = add nuw i64 %indvars.iv, 1
  br i1 %cmp272, label %for.cond268, label %for.end

for.end:                                          ; preds = %for.cond268
  %cmp278 = icmp eq i8 %59, %55
  br i1 %cmp278, label %cond.true280, label %if.end299

cond.true280:                                     ; preds = %for.end
  %60 = load ptr, ptr %kern_sizes, align 8
  %61 = load ptr, ptr %kern_value, align 8
  %arrayidx292 = getelementptr inbounds i8, ptr %61, i64 %indvars.iv
  %62 = load i8, ptr %arrayidx292, align 1
  %idxprom293 = zext i8 %62 to i64
  %arrayidx294 = getelementptr inbounds i16, ptr %60, i64 %idxprom293
  %63 = load i16, ptr %arrayidx294, align 2
  %conv295 = sext i16 %63 to i32
  br label %if.end299

if.end299:                                        ; preds = %cond.true280, %for.end, %for.body
  %ksize.0 = phi i32 [ 0, %for.body ], [ %conv295, %cond.true280 ], [ 0, %for.end ]
  %add300 = add nsw i32 %ksize.0, %r.1462
  %incdec.ptr302 = getelementptr inbounds i8, ptr %p.2463, i64 1
  %q.1 = getelementptr inbounds i8, ptr %q.1464, i64 1
  %64 = load i8, ptr %q.1, align 1
  %tobool244.not = icmp eq i8 %64, 0
  br i1 %tobool244.not, label %for.end304, label %for.body
...
for.cond:                                         ; preds = %for.cond, %if.end
  ...
  %5 = load i8, ptr %ou1, align 8
  %cmp4 = icmp eq i8 %5, 0
  br i1 %cmp4, label %for.cond, label %for.end

for.end:                                          ; preds = %for.cond
  %osucc11 = getelementptr inbounds [2 x %struct.LIST], ptr %face.0, i64 0, i64 1, i32 1
  %6 = load ptr, ptr %osucc11, align 8
  br label %for.cond15
...
for.cond15:                                       ; preds = %for.cond15, %for.end
  ...
  %7 = load i8, ptr %ou116, align 8
  %cmp19 = icmp eq i8 %7, 0
  br i1 %cmp19, label %for.cond15, label %for.end26
...
if.then34:                                        ; preds = %for.end26
  %9 = load ptr, ptr @no_fpos, align 8
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %4 = load i32, ptr %ofont_xheight2, align 4
  ret i32 %4
}
...
entry:
  %0 = load ptr, ptr @font_root, align 8
...
for.cond.loopexit:                                ; preds = %for.inc188, %if.end29
  ...
  %link.0 = load ptr, ptr %link.0.in, align 8
  %4 = load ptr, ptr @font_root, align 8
  %cmp3.not = icmp eq ptr %link.0, %4
  br i1 %cmp3.not, label %for.end197, label %for.cond7.preheader
...
if.end29:                                         ; preds = %for.cond7, %for.cond7, %if.then27
  ...
  %flink.0251 = load ptr, ptr %flink.0.in250, align 8
...
if.end65:                                         ; preds = %for.cond40, %for.cond40, %if.then63
  ...
  %9 = load ptr, ptr %osucc68, align 8
...
land.lhs.true71:                                  ; preds = %if.end65
  ...
  %10 = load ptr, ptr %osucc77, align 8
...
land.lhs.true80:                                  ; preds = %land.lhs.true71
  ...
  %11 = load ptr, ptr %osucc89, align 8
...
if.then92:                                        ; preds = %land.lhs.true80, %land.lhs.true71, %if.end65
  ...
  %.pre266 = load ptr, ptr %osucc68, align 8
  br label %if.end94
...
for.cond101:                                      ; preds = %for.cond101, %if.end94
  ...
  %ps_name.0 = load ptr, ptr %ps_name.0.in, align 8
  %ou1102 = getelementptr inbounds %struct.word_type, ptr %ps_name.0, i64 0, i32 1
  %14 = load i8, ptr %ou1102, align 8
...
if.then124:                                       ; preds = %for.cond101
  ...
  %.pre267 = load ptr, ptr %osucc68, align 8
  br label %if.end126
...
if.end126:                                        ; preds = %for.cond101, %for.cond101, %if.then124
  ...
  %17 = load ptr, ptr %osucc132, align 8
  %osucc135 = getelementptr inbounds %struct.LIST, ptr %17, i64 0, i32 1
  %18 = load ptr, ptr %osucc135, align 8
...
for.cond139:                                      ; preds = %for.cond139, %if.end126
  ...
  %first_size.0 = load ptr, ptr %first_size.0.in, align 8
  %ou1140 = getelementptr inbounds %struct.word_type, ptr %first_size.0, i64 0, i32 1
  %19 = load i8, ptr %ou1140, align 8
...
for.inc188:                                       ; preds = %if.then165, %if.else
  ...
  %flink.0 = load ptr, ptr %flink.0.in, align 8
  %cmp34.not = icmp eq ptr %flink.0, %family.0
  br i1 %cmp34.not, label %for.cond.loopexit, label %for.cond40.preheader
...
if.end:                                           ; preds = %if.then, %land.lhs.true
  %3 = load ptr, ptr @font_used, align 8
...
if.then11:                                        ; preds = %land.lhs.true5, %if.end
  ...
  %.pre = load ptr, ptr @font_used, align 8
  br label %if.end13
...
if.end13:                                         ; preds = %if.then11, %land.lhs.true5
  ...
  %link.0154 = load ptr, ptr %link.0.in153, align 8
...
if.end40:                                         ; preds = %for.cond18, %for.cond18, %if.then38
  ...
  %9 = load ptr, ptr %osucc43, align 8
...
if.then46:                                        ; preds = %if.end40
  ...
  %.pre163 = load ptr, ptr %osucc43, align 8
  br label %if.end48
...
if.end48:                                         ; preds = %if.then46, %if.end40
  ...
  %12 = load ptr, ptr %osucc54, align 8
  %osucc57 = getelementptr inbounds %struct.LIST, ptr %12, i64 0, i32 1
  %13 = load ptr, ptr %osucc57, align 8
  br label %for.cond61
...
if.then84:                                        ; preds = %for.cond61
  ...
  %.pre164 = load ptr, ptr %osucc43, align 8
...
if.then116:                                       ; preds = %for.cond93
  %17 = load ptr, ptr @no_fpos, align 8
...
if.end118:                                        ; preds = %for.cond93, %for.cond93, %if.then116
  ...
  %19 = load ptr, ptr %PrintPageSetupForFont, align 8
  %20 = load i32, ptr @font_curr_page, align 4
  %ostring = getelementptr inbounds %struct.word_type, ptr %ps_name.0, i64 0, i32 4
  ...
  %link.0 = load ptr, ptr %link.0.in, align 8
  %21 = load ptr, ptr @font_used, align 8
  %cmp14.not = icmp eq ptr %link.0, %21
  br i1 %cmp14.not, label %for.end125, label %for.cond18.preheader
...
if.end13:                                         ; preds = %if.then11, %land.lhs.true5
  %6 = phi ptr [ %.pre, %if.then11 ], [ %3, %land.lhs.true5 ]
  %link.0.in175 = getelementptr inbounds %struct.LIST, ptr %6, i64 0, i32 1
  %link.0176 = load ptr, ptr %link.0.in175, align 8
  %cmp14.not177 = icmp eq ptr %link.0176, %6
  br i1 %cmp14.not177, label %for.end143, label %for.cond18.preheader

for.cond18.preheader:                             ; preds = %if.end13, %for.inc139
  %link.0179 = phi ptr [ %link.0, %for.inc139 ], [ %link.0176, %if.end13 ]
  %first.0178 = phi i32 [ %first.1, %for.inc139 ], [ 1, %if.end13 ]
  br label %for.cond18

for.cond18:                                       ; preds = %for.cond18.preheader, %for.cond18
  %link.0.pn = phi ptr [ %face.0, %for.cond18 ], [ %link.0179, %for.cond18.preheader ]
  %face.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %link.0.pn, i64 0, i64 1
  %face.0 = load ptr, ptr %face.0.in, align 8
  %ou119 = getelementptr inbounds %struct.word_type, ptr %face.0, i64 0, i32 1
  %7 = load i8, ptr %ou119, align 8
...
if.then46:                                        ; preds = %if.end40
  %10 = load ptr, ptr @no_fpos, align 8
  %call47 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.10, i32 noundef 0, ptr noundef %10, ptr noundef nonnull @.str.56) #14
  %.pre185 = load ptr, ptr %osucc43, align 8
  br label %for.cond55.preheader

for.cond55.preheader:                             ; preds = %if.then46, %if.end40
  %.pn.ph = phi ptr [ %9, %if.end40 ], [ %.pre185, %if.then46 ]
  br label %for.cond55
...
if.end80:                                         ; preds = %for.cond55, %for.cond55, %if.then78
  %13 = load ptr, ptr @font_used, align 8
  %ostring121 = getelementptr inbounds %struct.word_type, ptr %ps_name.0, i64 0, i32 4
  br label %for.cond84

for.cond84:                                       ; preds = %for.end120, %if.end80
  %.pn168 = phi ptr [ %13, %if.end80 ], [ %plink.0, %for.end120 ]
  %plink.0.in = getelementptr inbounds %struct.LIST, ptr %.pn168, i64 0, i32 1
  %plink.0 = load ptr, ptr %plink.0.in, align 8
  %cmp85.not = icmp eq ptr %plink.0, %link.0179
...
for.cond91:                                       ; preds = %for.cond84, %for.cond91
  ...
  %pface.0 = load ptr, ptr %pface.0.in, align 8
  %ou192 = getelementptr inbounds %struct.word_type, ptr %pface.0, i64 0, i32 1
  %14 = load i8, ptr %ou192, align 8
  %cmp95 = icmp eq i8 %14, 0
  br i1 %cmp95, label %for.cond91, label %for.end102

for.end102:                                       ; preds = %for.cond91
  %osucc105 = getelementptr inbounds %struct.LIST, ptr %pface.0, i64 0, i32 1
  %15 = load ptr, ptr %osucc105, align 8
  br label %for.cond109

for.cond109:                                      ; preds = %for.cond109, %for.end102
  %.pn167 = phi ptr [ %15, %for.end102 ], [ %pname.0, %for.cond109 ]
  %pname.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn167, i64 0, i64 1
  %pname.0 = load ptr, ptr %pname.0.in, align 8
  %ou1110 = getelementptr inbounds %struct.word_type, ptr %pname.0, i64 0, i32 1
  %16 = load i8, ptr %ou1110, align 8
  %cmp113 = icmp eq i8 %16, 0
  br i1 %cmp113, label %for.cond109, label %for.end120
...
for.end120:                                       ; preds = %for.cond109
  ...
  br i1 %cmp124, label %for.inc139, label %for.cond84

if.then135:                                       ; preds = %for.cond84
  %17 = load ptr, ptr @BackEnd, align 8
  %PrintPageResourceForFont = getelementptr inbounds %struct.back_end_rec, ptr %17, i64 0, i32 13
  %18 = load ptr, ptr %PrintPageResourceForFont, align 8
  tail call void %18(ptr noundef nonnull %ostring121, i32 noundef %first.0178) #14
  %.pre186 = load ptr, ptr @font_used, align 8
  br label %for.inc139

for.inc139:                                       ; preds = %for.end120, %if.then135
  %19 = phi ptr [ %.pre186, %if.then135 ], [ %13, %for.end120 ]
  %first.1 = phi i32 [ 0, %if.then135 ], [ %first.0178, %for.end120 ]
  %link.0.in = getelementptr inbounds %struct.LIST, ptr %link.0179, i64 0, i32 1
  %link.0 = load ptr, ptr %link.0.in, align 8
  %cmp14.not = icmp eq ptr %link.0, %19
  br i1 %cmp14.not, label %for.end143, label %for.cond18.preheader
...
entry:
  %0 = load ptr, ptr @font_used, align 8
  %osucc = getelementptr inbounds %struct.LIST, ptr %0, i64 0, i32 1
  %1 = load ptr, ptr %osucc, align 8
...
cond.end55:                                       ; preds = %cond.end, %cond.false33
  ...
  %cond73.in = load i8, ptr %cond73.in.in, align 1
  %cond73 = zext i8 %cond73.in to i32
  store i32 %cond73, ptr @zz_size, align 4
  ...
  store ptr %14, ptr %arrayidx80, align 8
  %16 = load ptr, ptr %osucc, align 8
  %cmp.not = icmp eq ptr %16, %0
  br i1 %cmp.not, label %while.end, label %while.body

while.end:                                        ; preds = %cond.end55, %entry
  %17 = load i32, ptr @font_curr_page, align 4
  %inc = add nsw i32 %17, 1
  store i32 %inc, ptr @font_curr_page, align 4
  ret void
}
...
entry:
  ...
  %0 = load i16, ptr %ofont_page, align 2
  %conv = zext i16 %0 to i32
  %1 = load i32, ptr @font_curr_page, align 4
...
if.end:                                           ; preds = %if.then, %entry
  %3 = load i8, ptr @zz_lengths, align 1
...
cond.end58.thread:                                ; preds = %if.end19
  store ptr %face, ptr @zz_hold, align 8
  br label %cond.false67

cond.end58:                                       ; preds = %if.end19
  %9 = load ptr, ptr %8, align 8
  store ptr %9, ptr @zz_tmp, align 8
  ...
  store ptr %11, ptr %osucc51, align 8
  %14 = load ptr, ptr @zz_tmp, align 8
  store ptr %14, ptr %12, align 8
  %15 = load ptr, ptr @zz_res, align 8
  %16 = load ptr, ptr @zz_tmp, align 8
  %osucc57 = getelementptr inbounds %struct.LIST, ptr %16, i64 0, i32 1
  store ptr %15, ptr %osucc57, align 8
  %.pre = load ptr, ptr @xx_link, align 8
...
entry:
  ...
  %link.094 = load ptr, ptr %link.0.in93, align 8
...
for.cond.loopexit:                                ; preds = %for.cond.loopexit.loopexit, %for.cond13.preheader
  ...
  br i1 %cmp.not, label %for.end70, label %for.cond3.preheader
...
if.end:                                           ; preds = %for.cond38, %for.cond38, %if.then
  ...
  br i1 %cmp14.not, label %for.cond.loopexit.loopexit, label %for.cond20.preheader
...
while.body:                                       ; preds = %land.rhs
  ...
  %inc = add nsw i32 %6, 1
  store i32 %inc, ptr %lnum, align 4
...
while.cond17:                                     ; preds = %while.cond17, %while.body
  ...
  %indvars.iv.next = add nuw i64 %indvars.iv, 1
  br i1 %cmp20, label %while.cond17, label %while.cond24.preheader
...
while.cond24.preheader:                           ; preds = %while.cond17
  ...
  %8 = load i8, ptr %arrayidx26398, align 1
...
if.then49:                                        ; preds = %if.else
  ...
  %10 = load float, ptr %fl_wx, align 4
...
if.then59:                                        ; preds = %if.else54
  ...
  %11 = load float, ptr %fl_llx, align 4
  %12 = load float, ptr %fl_lly, align 4
  %13 = load float, ptr %fl_urx, align 4
  %14 = load float, ptr %fl_ury, align 4
...
land.lhs.true72:                                  ; preds = %if.else54
  ...
  %21 = load i32, ptr %uses_font_metrics, align 8
...
if.then84:                                        ; preds = %if.then78
  %23 = load i32, ptr %ligtop, align 4
  %conv85 = trunc i32 %23 to i8
  store i8 %conv85, ptr %arrayidx80, align 1
  br label %if.end

if.end:                                           ; preds = %if.then84, %if.then78
  %24 = load i32, ptr %ligtop, align 4
  %inc88 = add nsw i32 %24, 1
  store i32 %inc88, ptr %ligtop, align 4
  %idxprom89 = sext i32 %24 to i64
  %arrayidx90 = getelementptr inbounds i8, ptr %lig, i64 %idxprom89
  store i8 %ch.0400, ptr %arrayidx90, align 1
  %sext444 = shl i64 %i.1401.in, 32
  %25 = ashr exact i64 %sext444, 32
...
while.cond92:                                     ; preds = %while.cond92, %if.end
  ...
  %26 = load i8, ptr %arrayidx94, align 1
  %cmp96 = icmp eq i8 %26, 32
  br i1 %cmp96, label %while.cond92, label %while.cond101
...
if.else133:                                       ; preds = %while.body114
  ...
  store i8 1, ptr %arrayidx80, align 1
  br label %if.end140

if.end140:                                        ; preds = %if.else133, %if.then129
  %30 = load i32, ptr %ligtop, align 4
...
while.cond148:                                    ; preds = %while.cond148.preheader, %while.body161
  ...
  %32 = load i8, ptr %arrayidx150, align 1
...
while.cond164:                                    ; preds = %while.cond164.preheader, %while.cond164
  ...
  %33 = load i8, ptr %arrayidx166, align 1
  %cmp168 = icmp eq i8 %33, 32
  %indvars.iv.next434 = add i64 %indvars.iv433, 1
  br i1 %cmp168, label %while.cond164, label %while.cond101.loopexit

while.end173:                                     ; preds = %while.cond101, %while.cond101
  %34 = load i32, ptr %ligtop, align 4
  %inc174 = add nsw i32 %34, 1
  store i32 %inc174, ptr %ligtop, align 4
...
if.end180:                                        ; preds = %if.else54, %if.then49, %land.lhs.true72, %while.end173, %if.then59, %if.then
  ...
  %i.6.in = phi i64 [ %i.1401.in, %if.then ], [ %i.1401.in, %if.then49 ], [ %i.1401.in, %if.then59 ], [ %i.3.in, %while.end173 ], [ %i.1401.in, %land.lhs.true72 ], [ %i.1401.in, %if.else54 ]
  ...
  %sext445 = shl i64 %i.6.in, 32
  %36 = ashr exact i64 %sext445, 32
...
if.end213:                                        ; preds = %while.cond181, %while.cond204
  ...
  br i1 %cmp28.not, label %while.end214, label %while.body30
...
if.then245:                                       ; preds = %if.end230
  %43 = load i32, ptr %ligtop, align 4
  %inc246 = add nsw i32 %43, 1
  store i32 %inc246, ptr %ligtop, align 4
...
if.end250.sink.split:                             ; preds = %if.end230, %if.then245
  ...
  store i8 0, ptr %arrayidx248.sink, align 1
  br label %if.end250
...
if.end250:                                        ; preds = %if.end250.sink.split, %if.end230
  ...
  %45 = load i32, ptr %uses_font_metrics251, align 8
...
if.else278:                                       ; preds = %if.end250
  ...
  store i16 0, ptr %left281, align 2
  %52 = load i32, ptr @PlainCharHeight, align 4
  %div = sdiv i32 %52, -2
  %conv283 = trunc i32 %div to i16
  store i16 %conv283, ptr %down286, align 2
  %53 = load i32, ptr @PlainCharWidth, align 4
  %conv287 = trunc i32 %53 to i16
  %right290 = getelementptr inbounds %struct.metrics, ptr %fnt, i64 %idxprom231, i32 3
  store i16 %conv287, ptr %right290, align 2
  %div291 = sdiv i32 %52, 2
  %conv292 = trunc i32 %div291 to i16
  store i16 %conv292, ptr %arrayidx280, align 2
  br label %if.end300.sink.split
...
if.end300.sink.split:                             ; preds = %if.else278, %if.then253
  ...
  store i16 %conv275.sink, ptr %last_adjust, align 2
  br label %if.end300
...
if.end300:                                        ; preds = %if.end300.sink.split, %while.cond24.preheader, %while.end214
  ...
  br i1 %cmp10.not, label %while.end301, label %land.lhs.true
