; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z09.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z09.c"
...
if.end40:                                         ; preds = %if.then38, %if.end32
  %8 = load ptr, ptr %env.addr.0, align 8
...
for.cond58:                                       ; preds = %for.cond58.preheader, %for.cond58
  ...
  %env.addr.1 = load ptr, ptr %env.addr.1.in, align 8
  %ou159 = getelementptr inbounds %struct.word_type, ptr %env.addr.1, i64 0, i32 1
  %11 = load i8, ptr %ou159, align 8
  %cmp62 = icmp eq i8 %11, 0
  br i1 %cmp62, label %for.cond58, label %for.cond.loopexit
...
if.end12:                                         ; preds = %if.then10, %lor.lhs.false, %if.end
  %4 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 82), align 1
...
if.then21:                                        ; preds = %if.end12
  ...
  store ptr %call22, ptr @zz_hold, align 8
  br label %if.end30
...
if.end30:                                         ; preds = %if.then21, %if.else23
  ...
  store ptr %8, ptr %arrayidx36, align 8
  %osucc40 = getelementptr inbounds %struct.LIST, ptr %8, i64 0, i32 1
  store ptr %8, ptr %osucc40, align 8
  store ptr %8, ptr %8, align 8
  %9 = load i8, ptr @zz_lengths, align 1
  %conv44 = zext i8 %9 to i32
  store i32 %conv44, ptr @zz_size, align 4
...
if.else57:                                        ; preds = %if.end30
  ...
  store ptr %12, ptr %arrayidx52, align 8
  br label %cond.end108
...
cond.end108:                                      ; preds = %if.then55, %if.else57
  ...
  store ptr %13, ptr %arrayidx73, align 8
  %osucc77 = getelementptr inbounds %struct.LIST, ptr %13, i64 0, i32 1
  store ptr %13, ptr %osucc77, align 8
  store ptr %13, ptr %13, align 8
  store ptr %13, ptr @xx_link, align 8
  ...
  store ptr %16, ptr %osucc101, align 8
  ...
  store ptr %20, ptr %osucc107, align 8
  %22 = load ptr, ptr @xx_link, align 8
...
if.then145:                                       ; preds = %cond.end141
  %26 = load i8, ptr @zz_lengths, align 1
...
if.else159:                                       ; preds = %if.then145
  ...
  store ptr %29, ptr %arrayidx154, align 8
  br label %cond.end214
...
cond.end214:                                      ; preds = %if.then157, %if.else159
  ...
  store ptr %33, ptr %osucc205, align 8
  ...
  %39 = load ptr, ptr @xx_link, align 8
...
if.end15:                                         ; preds = %if.end, %if.end, %if.then13
  %4 = load i8, ptr @zz_lengths, align 1
  %conv16 = zext i8 %4 to i32
  store i32 %conv16, ptr @zz_size, align 4
...
cond.end74:                                       ; preds = %if.then24, %if.else26
  ...
  store ptr %15, ptr %osucc73, align 8
  %17 = load ptr, ptr @xx_link, align 8
...
cond.false83:                                     ; preds = %cond.end74
  ...
  %18 = load ptr, ptr %arrayidx85, align 8
  ...
  store ptr %19, ptr %arrayidx85, align 8
  %20 = load ptr, ptr %arrayidx88, align 8
  %osucc98 = getelementptr inbounds [2 x %struct.LIST], ptr %20, i64 0, i64 1, i32 1
  store ptr %env, ptr %osucc98, align 8
  store ptr %18, ptr %arrayidx88, align 8
  %osucc104 = getelementptr inbounds [2 x %struct.LIST], ptr %18, i64 0, i64 1, i32 1
  store ptr %17, ptr %osucc104, align 8
...
for.cond:                                         ; preds = %for.cond, %if.end6
  ...
  %env.0 = load ptr, ptr %env.0.in, align 8
  %ou113 = getelementptr inbounds %struct.word_type, ptr %env.0, i64 0, i32 1
  %5 = load i8, ptr %ou113, align 8
  %cmp16 = icmp eq i8 %5, 0
  br i1 %cmp16, label %for.cond, label %for.end
...
cond.end:                                         ; preds = %for.end, %cond.false
  ...
  %9 = load ptr, ptr %osucc51, align 8
...
cond.false55:                                     ; preds = %cond.end
  ...
  %.pre123 = load ptr, ptr @xx_link, align 8
  br label %cond.end77
...
cond.end77:                                       ; preds = %cond.end, %cond.false55
  ...
  %cond98.in = load i8, ptr %cond98.in.in, align 1
  %cond98 = zext i8 %cond98.in to i32
  store i32 %cond98, ptr @zz_size, align 4
  ...
  store ptr %17, ptr %arrayidx105, align 8
  %19 = load i8, ptr %ou113.le, align 8
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %3 = load i16, ptr %opredefined, align 8
...
if.then20:                                        ; preds = %land.lhs.true
  ...
  %11 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 131), align 1
...
if.then32:                                        ; preds = %if.then20
  ...
  store ptr %call33, ptr @zz_hold, align 8
  br label %if.end41
...
if.end41:                                         ; preds = %if.then32, %if.else34
  ...
  store i8 -125, ptr %ou142, align 8
...
if.else69:                                        ; preds = %if.end41
  ...
  store ptr %19, ptr %arrayidx64, align 8
  br label %cond.end120
...
cond.end120:                                      ; preds = %if.then67, %if.else69
  ...
  store ptr %23, ptr %osucc113, align 8
  ...
  store ptr %27, ptr %osucc119, align 8
  %29 = load ptr, ptr @xx_link, align 8
  store ptr %29, ptr @zz_res, align 8
  store ptr %call23, ptr @zz_hold, align 8
...
if.then169:                                       ; preds = %if.then157
  ...
  store ptr %call170, ptr @zz_hold, align 8
  br label %if.end180

if.else171:                                       ; preds = %if.then157
  store ptr %35, ptr @zz_hold, align 8
  %37 = load ptr, ptr %35, align 8
  store ptr %37, ptr %arrayidx166, align 8
  br label %if.end180
...
cond.end264:                                      ; preds = %if.end218
  ...
  store ptr %47, ptr %osucc255, align 8
  ...
  store ptr %51, ptr %osucc261, align 8
...
cond.end264.cond.false273_crit_edge:              ; preds = %cond.end264
  ...
  %.pre927 = load ptr, ptr %arrayidx278.phi.trans.insert, align 8
  br label %cond.false273
...
if.then313:                                       ; preds = %if.end299
  ...
  %60 = load ptr, ptr %oenclosing, align 8
...
if.end.i:                                         ; preds = %if.then.i, %if.then318
  %63 = load ptr, ptr %call315, align 8
...
if.then4.i:                                       ; preds = %if.end.i
  ...
  %.pre.i = load ptr, ptr %call315, align 8
...
land.lhs.true343:                                 ; preds = %for.cond328
  ...
  %68 = load ptr, ptr %oactual344, align 8
  %69 = load ptr, ptr %oactual, align 8
...
if.then348:                                       ; preds = %land.lhs.true343
  ...
  %70 = load ptr, ptr %osucc351, align 8
...
if.then354:                                       ; preds = %if.then348
  ...
  %.pre928 = load ptr, ptr %osucc351, align 8
  br label %if.end356
...
if.else391:                                       ; preds = %lor.lhs.false
  ...
  %79 = load ptr, ptr %osucc397, align 8
...
cond.false401:                                    ; preds = %if.else391
  ...
  %80 = load ptr, ptr %arrayidx406, align 8
  %arrayidx409 = getelementptr inbounds [2 x %struct.LIST], ptr %79, i64 0, i64 1
  store ptr %80, ptr %arrayidx409, align 8
  %81 = load ptr, ptr %arrayidx406, align 8
  %osucc416 = getelementptr inbounds [2 x %struct.LIST], ptr %81, i64 0, i64 1, i32 1
  store ptr %79, ptr %osucc416, align 8
  store ptr %72, ptr %osucc397, align 8
  store ptr %72, ptr %arrayidx406, align 8
...
cond.end423:                                      ; preds = %if.else391, %cond.false401
  ...
  %82 = load ptr, ptr %osucc427, align 8
...
cond.false431:                                    ; preds = %cond.end423
  ...
  store ptr %84, ptr %osucc446, align 8
  ...
  %.pre929 = load ptr, ptr @xx_link, align 8
...
cond.end453:                                      ; preds = %cond.end423, %cond.false431
  ...
  store ptr %90, ptr %arrayidx483, align 8
  ...
  %93 = load ptr, ptr %arrayidx494, align 8
...
if.else499:                                       ; preds = %cond.end453
  ...
  store ptr %95, ptr %arrayidx494, align 8
  br label %cond.end554
...
cond.end554:                                      ; preds = %if.then497, %if.else499
  ...
  %97 = load ptr, ptr %par.0, align 8
  store ptr %97, ptr @zz_tmp, align 8
  %98 = load ptr, ptr %96, align 8
  store ptr %98, ptr %par.0, align 8
  ...
  store ptr %99, ptr %osucc545, align 8
  ...
  store ptr %103, ptr %osucc551, align 8
...
cond.false563:                                    ; preds = %cond.end554
  ...
  %106 = load ptr, ptr %arrayidx565, align 8
  store ptr %106, ptr @zz_tmp, align 8
  %arrayidx568 = getelementptr inbounds [2 x %struct.LIST], ptr %105, i64 0, i64 1
  %107 = load ptr, ptr %arrayidx568, align 8
  store ptr %107, ptr %arrayidx565, align 8
  %108 = load ptr, ptr %arrayidx568, align 8
  %osucc578 = getelementptr inbounds [2 x %struct.LIST], ptr %108, i64 0, i64 1, i32 1
  store ptr %call485, ptr %osucc578, align 8
  store ptr %106, ptr %arrayidx568, align 8
  %osucc584 = getelementptr inbounds [2 x %struct.LIST], ptr %106, i64 0, i64 1, i32 1
  store ptr %105, ptr %osucc584, align 8
  br label %if.end589
...
if.end589:                                        ; preds = %cond.end554, %cond.false563, %if.then389
  ...
  %109 = load ptr, ptr %osucc592, align 8
...
cond.end618.thread:                               ; preds = %if.end589
  ...
  store ptr %res.1, ptr @zz_res, align 8
...
cond.end618:                                      ; preds = %if.end589
  ...
  %110 = load ptr, ptr %arrayidx601, align 8
  %arrayidx604 = getelementptr inbounds [2 x %struct.LIST], ptr %109, i64 0, i64 1
  store ptr %110, ptr %arrayidx604, align 8
  %111 = load ptr, ptr %arrayidx601, align 8
  %osucc611 = getelementptr inbounds [2 x %struct.LIST], ptr %111, i64 0, i64 1, i32 1
  store ptr %109, ptr %osucc611, align 8
  store ptr %x, ptr %osucc592, align 8
  store ptr %x, ptr %arrayidx601, align 8
  store ptr %109, ptr @xx_tmp, align 8
  store ptr %res.1, ptr @zz_res, align 8
...
land.lhs.true659:                                 ; preds = %cond.end651
  ...
  %117 = load ptr, ptr %oenclosing661, align 8
...
if.then668:                                       ; preds = %land.lhs.true659
  ...
  store ptr %call669, ptr %res_env, align 8
...
if.then686:                                       ; preds = %land.lhs.true678
  ...
  store ptr %call687, ptr %res_env, align 8
  br label %if.end714
...
if.else688:                                       ; preds = %cond.end651, %land.lhs.true659, %land.lhs.true678
  ...
  store ptr %call689, ptr %res_env, align 8
  br label %if.end714
...
for.inc693:                                       ; preds = %for.cond328, %land.lhs.true343
  ...
  br i1 %cmp323.not, label %if.then717, label %for.cond328.preheader

if.else698:                                       ; preds = %if.then313
  %120 = load ptr, ptr %oactual, align 8
  %osym_body = getelementptr inbounds %struct.symbol_type, ptr %120, i64 0, i32 4
  %121 = load ptr, ptr %osym_body, align 8
...
if.end730:                                        ; preds = %if.else725, %if.then722
  ...
  %126 = load ptr, ptr %osucc733, align 8
...
cond.end759:                                      ; preds = %if.end730
  ...
  %127 = load ptr, ptr %arrayidx742, align 8
  %arrayidx745 = getelementptr inbounds [2 x %struct.LIST], ptr %126, i64 0, i64 1
  store ptr %127, ptr %arrayidx745, align 8
  %128 = load ptr, ptr %arrayidx742, align 8
  %osucc752 = getelementptr inbounds [2 x %struct.LIST], ptr %128, i64 0, i64 1, i32 1
  store ptr %126, ptr %osucc752, align 8
  store ptr %x, ptr %osucc733, align 8
  store ptr %x, ptr %arrayidx742, align 8
...
cond.false768:                                    ; preds = %cond.end759
  %129 = load ptr, ptr %arrayidx745, align 8
  store ptr %129, ptr @zz_tmp, align 8
  %arrayidx773 = getelementptr inbounds [2 x %struct.LIST], ptr %res.3, i64 0, i64 1
  %130 = load ptr, ptr %arrayidx773, align 8
  store ptr %130, ptr %arrayidx745, align 8
  %131 = load ptr, ptr %arrayidx773, align 8
  %osucc783 = getelementptr inbounds [2 x %struct.LIST], ptr %131, i64 0, i64 1, i32 1
  store ptr %126, ptr %osucc783, align 8
  store ptr %129, ptr %arrayidx773, align 8
  %osucc789 = getelementptr inbounds [2 x %struct.LIST], ptr %129, i64 0, i64 1, i32 1
  store ptr %res.3, ptr %osucc789, align 8
  br label %cond.end792
...
cond.end792:                                      ; preds = %cond.end759.thread, %cond.end759, %cond.false768
  ...
  store ptr %call794, ptr %res_env, align 8
  br label %if.end795

if.end795thread-pre-split:                        ; preds = %if.end714
  %.pr914 = load ptr, ptr %res_env, align 8
  br label %if.end795
...
land.lhs.true798:                                 ; preds = %if.end795
  ...
  %133 = load i8, ptr %ou1799, align 8
...
entry:
  ...
  %.pre = load i8, ptr %ou1.phi.trans.insert, align 8
  %0 = icmp eq i8 %.pre, 2
...
if.end:                                           ; preds = %if.then, %tailrecurse
  ...
  %3 = load ptr, ptr %oenclosing, align 8
...
GetEnv.exit:                                      ; preds = %for.cond.i, %if.then26.i
  ...
  %link.0158 = load ptr, ptr %link.0.in157, align 8
...
land.lhs.true:                                    ; preds = %for.cond12
  ...
  %11 = load ptr, ptr %oactual27, align 8
  %12 = load ptr, ptr %oactual, align 8
...
if.then31:                                        ; preds = %land.lhs.true
  ...
  %13 = load ptr, ptr %osucc34, align 8
...
if.then37:                                        ; preds = %if.then31
  ...
  %.pre167 = load ptr, ptr %osucc34, align 8
...
for.inc70:                                        ; preds = %for.cond12, %land.lhs.true
  ...
  br i1 %cmp8.not, label %for.end74, label %for.cond12.preheader

for.end74:                                        ; preds = %for.inc70, %GetEnv.exit
  %17 = load ptr, ptr %oactual, align 8
  %osym_body = getelementptr inbounds %struct.symbol_type, ptr %17, i64 0, i32 4
  %18 = load ptr, ptr %osym_body, align 8
