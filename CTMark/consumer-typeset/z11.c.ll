; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z11.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z11.c"
...
for.cond.preheader:                               ; preds = %entry
  ...
  %link.079 = load ptr, ptr %link.0.in78, align 8
...
for.inc52:                                        ; preds = %for.cond7, %for.cond7, %if.then39, %if.then45, %if.else47
  ...
  br i1 %cmp3.not, label %sw.epilog, label %for.cond7.preheader
...
if.else74:                                        ; preds = %if.end
  ...
  %4 = load i32, ptr %gap_inc, align 4
...
cond.end139:                                      ; preds = %cond.false121, %cond.true115, %if.else91.thread
  ...
  store i16 %conv141, ptr %owidth143, align 2
  br label %if.end145
...
if.else216:                                       ; preds = %entry
  call void @GetGap(ptr noundef nonnull %x, ptr noundef %style, ptr noundef nonnull %res_gap, ptr noundef nonnull %gap_inc) #5
  %2 = load i32, ptr %gap_inc, align 4
...
cond.end281:                                      ; preds = %cond.false263, %cond.true257, %if.else233.thread
  ...
  store i16 %conv283, ptr %owidth285, align 2
  br label %if.end287
...
if.else:                                          ; preds = %entry
  %1 = load i32, ptr %gap_inc, align 4
...
if.else10:                                        ; preds = %if.else
  ...
  store i16 %spec.select, ptr %oyunit11, align 4
  br label %if.end25
...
if.then2:                                         ; preds = %if.else
  ...
  store i16 %2, ptr %ozunit, align 2
  br label %if.end25
...
if.then5:                                         ; preds = %if.else
  ...
  %4 = load i16, ptr %ozunit7, align 2
  %add = add i16 %4, %3
  store i16 %add, ptr %ozunit7, align 2
  br label %if.end25

if.else10:                                        ; preds = %if.else
  %ozunit11 = getelementptr inbounds %struct.STYLE, ptr %style, i64 0, i32 3
  %5 = load i16, ptr %ozunit11, align 2
  %conv12 = sext i16 %5 to i32
  %owidth13 = getelementptr inbounds %struct.GAP, ptr %res_gap, i64 0, i32 1
  %6 = load i16, ptr %owidth13, align 2
  %conv14 = sext i16 %6 to i32
  ...
  %spec.select32 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
  %spec.select = trunc i32 %spec.select32 to i16
  store i16 %spec.select, ptr %ozunit11, align 2
  br label %if.end25
