; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z39.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z39.c"
...
while.cond:                                       ; preds = %while.body, %entry
  ...
  %0 = load i8, ptr %sp.0, align 1
  %cmp.not = icmp eq i8 %0, 0
  %.pre = load i8, ptr %pp.0, align 1
  %cmp3.not = icmp eq i8 %.pre, 0
...
while.body:                                       ; preds = %while.cond
  ...
  br i1 %cmp8.not, label %while.cond, label %cleanup

while.end:                                        ; preds = %while.cond
  %cmp11 = icmp eq i8 %.pre, 0
  %conv12 = zext i1 %cmp11 to i32
  br label %cleanup

cleanup:                                          ; preds = %while.body, %while.end
  %retval.0 = phi i32 [ %conv12, %while.end ], [ 0, %while.body ]
  ret i32 %retval.0
}
...
while.body:                                       ; preds = %while.cond
  ...
  br i1 %cmp13.not, label %while.cond, label %cleanup

while.end:                                        ; preds = %while.cond
  %cmp18 = icmp eq i8 %.pre, 0
  %conv19 = zext i1 %cmp18 to i32
  br label %cleanup

cleanup:                                          ; preds = %while.body, %entry, %while.end
  %retval.0 = phi i32 [ %conv19, %while.end ], [ 0, %entry ], [ 0, %while.body ]
  ret i32 %retval.0
}
...
entry:
  ...
  br i1 %cmp.not7, label %cleanup, label %while.cond.i.preheader

while.cond.i.preheader:                           ; preds = %entry, %for.inc
  %sp.08 = phi ptr [ %incdec.ptr, %for.inc ], [ %str, %entry ]
  br label %while.cond.i

while.cond.i:                                     ; preds = %while.cond.i.preheader, %while.body.i
  %sp.0.i = phi ptr [ %incdec.ptr.i, %while.body.i ], [ %sp.08, %while.cond.i.preheader ]
  %pp.0.i = phi ptr [ %incdec.ptr6.i, %while.body.i ], [ %pattern, %while.cond.i.preheader ]
  %1 = load i8, ptr %sp.0.i, align 1
  %cmp.not.i = icmp eq i8 %1, 0
  %.pre.i = load i8, ptr %pp.0.i, align 1
  %cmp3.not.i = icmp eq i8 %.pre.i, 0
  %or.cond.i = select i1 %cmp.not.i, i1 true, i1 %cmp3.not.i
  br i1 %or.cond.i, label %StringBeginsWith.exit, label %while.body.i

while.body.i:                                     ; preds = %while.cond.i
  %incdec.ptr.i = getelementptr inbounds i8, ptr %sp.0.i, i64 1
  %incdec.ptr6.i = getelementptr inbounds i8, ptr %pp.0.i, i64 1
  %cmp8.not.i = icmp eq i8 %1, %.pre.i
  br i1 %cmp8.not.i, label %while.cond.i, label %for.inc

StringBeginsWith.exit:                            ; preds = %while.cond.i
  br i1 %cmp3.not.i, label %cleanup, label %for.inc

for.inc:                                          ; preds = %while.body.i, %StringBeginsWith.exit
  %incdec.ptr = getelementptr inbounds i8, ptr %sp.08, i64 1
  %2 = load i8, ptr %incdec.ptr, align 1
  %cmp.not = icmp eq i8 %2, 0
  br i1 %cmp.not, label %cleanup, label %while.cond.i.preheader

cleanup:                                          ; preds = %StringBeginsWith.exit, %for.inc, %entry
  %retval.0 = phi i32 [ 0, %entry ], [ 0, %for.inc ], [ 1, %StringBeginsWith.exit ]
  ret i32 %retval.0
}
...
if.end:                                           ; preds = %if.then, %entry
  store i8 34, ptr @StringQuotedWord.buff, align 16
...
for.inc:                                          ; preds = %for.body, %for.inc
  ...
  store i8 %6, ptr %q.125, align 1
  %7 = load i8, ptr %incdec.ptr10, align 1
  %cmp7.not = icmp eq i8 %7, 0
  br i1 %cmp7.not, label %for.inc12, label %for.inc
...
for.inc12:                                        ; preds = %for.inc, %for.body
  ...
  br i1 %cmp3.not, label %for.end14, label %for.body
...
for.end14:                                        ; preds = %for.inc12, %if.end
  ...
  store i8 34, ptr %q.0.lcssa, align 1
