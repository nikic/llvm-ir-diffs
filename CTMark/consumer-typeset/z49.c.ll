...
if.then.i77:                                      ; preds = %PS_SaveGraphicState.exit
  ...
  %.pre.i80 = load i32, ptr @gs_stack_top, align 4, !tbaa !9
...
PS_SaveGraphicState.exit81:                       ; preds = %PS_SaveGraphicState.exit, %if.then.i77
  ...
  store i32 %17, ptr %arrayidx.i72, align 4, !tbaa !11
  ...
  store i32 %18, ptr %gs_colour.i73, align 4, !tbaa !14
  ...
  store i32 %19, ptr %gs_cpexists.i74, align 4, !tbaa !15
  ...
  store i32 %20, ptr %gs_currenty.i75, align 4, !tbaa !16
  ...
  store i16 %21, ptr %gs_xheight2.i76, align 4, !tbaa !17
  br label %if.end
...
if.end:                                           ; preds = %for.cond5, %for.cond5, %if.then22
  ...
  %link.0 = load ptr, ptr %link.0.in, align 8, !tbaa !19
  %10 = load ptr, ptr @needs, align 8, !tbaa !5
...
for.end30:                                        ; preds = %if.end, %if.then
  ...
  %12 = load ptr, ptr @supplied, align 8, !tbaa !5
...
for.cond42:                                       ; preds = %for.cond42.preheader, %for.cond42
  ...
  %13 = load i8, ptr %ou143, align 8, !tbaa !19
...
for.end53:                                        ; preds = %for.cond42
  ...
  %15 = load ptr, ptr @supplied, align 8, !tbaa !5
...
for.end61:                                        ; preds = %for.end53, %for.end30
  ...
  %17 = load ptr, ptr @out_fp, align 8, !tbaa !5
  %18 = load i32, ptr @pagecount, align 4, !tbaa !9
...
while.body:                                       ; preds = %while.body.lr.ph, %while.end92
  ...
  %19 = load i8, ptr %incdec.ptr60, align 1, !tbaa !19
...
while.body78:                                     ; preds = %land.lhs.true
  ...
  %22 = load i8, ptr %incdec.ptr80, align 1, !tbaa !19
...
while.end:                                        ; preds = %while.body78, %land.lhs.true, %while.body
  ...
  %23 = load i8, ptr %add.ptr81, align 1, !tbaa !19
...
while.cond88:                                     ; preds = %while.end, %while.cond88
  ...
  %24 = load i8, ptr %incdec.ptr89, align 1, !tbaa !19
...
while.end92:                                      ; preds = %while.cond88
  ...
  %25 = load i8, ptr %incdec.ptr93, align 1, !tbaa !19
  %cmp64 = icmp eq i8 %25, %15
  br i1 %cmp64, label %while.body, label %do.cond, !llvm.loop !41
...
do.end:                                           ; preds = %do.cond
  ...
  %27 = load ptr, ptr @finfo, align 8, !tbaa !5
  ...
  %28 = load ptr, ptr %cmp_table, align 8, !tbaa !43
  %composite109 = getelementptr inbounds %struct.font_rec, ptr %27, i64 %idxprom102, i32 2
  %29 = load ptr, ptr %composite109, align 8, !tbaa !44
  %30 = load i16, ptr @currentxheight2, align 2, !tbaa !18
  %conv110 = sext i16 %30 to i32
  %sub = sub nsw i32 %vpos, %conv110
  %31 = load i32, ptr @cpexists, align 4, !tbaa !9
...
if.else119:                                       ; preds = %if.then115
  ...
  %33 = load ptr, ptr @out_fp, align 8, !tbaa !5
...
do.body133:                                       ; preds = %do.body133.preheader, %do.body133
  ...
  %36 = load i8, ptr %arrayidx135, align 1, !tbaa !19
...
do.body169:                                       ; preds = %do.body169.preheader, %do.body169
  ...
  %43 = load i8, ptr %arrayidx172, align 1, !tbaa !19
...
do.end177:                                        ; preds = %do.body169
  ...
  %47 = load i32, ptr @currenty, align 4, !tbaa !9
...
do.body201:                                       ; preds = %do.body201.preheader, %do.body201
  ...
  %51 = load i8, ptr %arrayidx204, align 1, !tbaa !19
...
if.then223:                                       ; preds = %if.end216
  ...
  %62 = load i8, ptr %arrayidx228, align 2, !tbaa !51
...
while.body.i:                                     ; preds = %while.body.i, %while.body.lr.ph.i
  ...
  %67 = load i8, ptr %incdec.ptr.i, align 2, !tbaa !51
...
PrintComposite.exit.loopexit:                     ; preds = %while.body.i
  %.pre670 = load i8, ptr %ostring, align 1, !tbaa !19
...
PrintComposite.exit:                              ; preds = %PrintComposite.exit.loopexit, %if.then223
  ...
  %68 = load ptr, ptr @finfo, align 8, !tbaa !5
  ...
  %69 = load ptr, ptr %arrayidx240, align 8, !tbaa !56
  %right = getelementptr inbounds %struct.metrics, ptr %69, i64 %idxprom241.pre-phi, i32 3
  %70 = load i16, ptr %right, align 2, !tbaa !57
...
do.body283:                                       ; preds = %do.body283.preheader, %do.body283
  ...
  %74 = load i8, ptr %arrayidx286, align 1, !tbaa !19
...
if.else299:                                       ; preds = %if.end216
  ...
  %79 = load ptr, ptr %arrayidx301, align 8, !tbaa !5
  %80 = load ptr, ptr @out_fp, align 8, !tbaa !5
...
if.end303:                                        ; preds = %if.else299, %do.end291
  ...
  %81 = load ptr, ptr @finfo, align 8, !tbaa !5
  ...
  %82 = load ptr, ptr %font_table, align 8, !tbaa !61
  ...
  %83 = load ptr, ptr %arrayidx312, align 8, !tbaa !5
  ...
  %84 = load i8, ptr %incdec.ptr315, align 1, !tbaa !19
...
if.else336:                                       ; preds = %for.body
  ...
  %92 = load ptr, ptr %kern_chars, align 8, !tbaa !63
...
for.cond342:                                      ; preds = %for.cond342, %if.else336
  ...
  %94 = load i8, ptr %arrayidx344, align 1, !tbaa !19
...
if.then374:                                       ; preds = %if.end371
  ...
  %100 = load i32, ptr @wordcount, align 4, !tbaa !9
  ...
  %.pre672 = load i8, ptr %p.2625, align 1, !tbaa !19
...
if.end384:                                        ; preds = %for.end, %for.body, %if.then374, %if.end371
  ...
  %102 = load i16, ptr %arrayidx386, align 2, !tbaa !18
...
while.body.i596:                                  ; preds = %while.body.i596, %while.body.lr.ph.i593
  ...
  %112 = load i8, ptr %incdec.ptr.i604, align 2, !tbaa !51
  %cmp.not.i605 = icmp eq i8 %112, 0
  br i1 %cmp.not.i605, label %PrintComposite.exit606.loopexit, label %while.body.i596, !llvm.loop !55

PrintComposite.exit606.loopexit:                  ; preds = %while.body.i596
  %.pre673 = load i8, ptr %p.2625, align 1, !tbaa !19
...
PrintComposite.exit606:                           ; preds = %PrintComposite.exit606.loopexit, %if.then388
  ...
  %113 = load ptr, ptr @finfo, align 8, !tbaa !5
  ...
  %114 = load ptr, ptr %arrayidx405, align 8, !tbaa !56
  %right409 = getelementptr inbounds %struct.metrics, ptr %114, i64 %idxprom407.pre-phi, i32 3
  %115 = load i16, ptr %right409, align 2, !tbaa !57
...
do.body450:                                       ; preds = %do.body450.preheader, %do.body450
  ...
  %119 = load i8, ptr %arrayidx453, align 1, !tbaa !19
...
if.else466:                                       ; preds = %if.end384
  ...
  %124 = load ptr, ptr %arrayidx468, align 8, !tbaa !5
...
for.inc471:                                       ; preds = %do.end458, %if.else466
  ...
  %126 = load i8, ptr %incdec.ptr472, align 1, !tbaa !19
...
for.end473:                                       ; preds = %for.inc471, %if.end303
  ...
  %127 = load i32, ptr @wordcount, align 4, !tbaa !9
...
if.end.i:                                         ; preds = %if.then.i217, %if.then
  store i32 %mul, ptr %call.i216, align 8, !tbaa !25
...
ltab_new.exit:                                    ; preds = %if.end.i, %for.body.preheader.i
  store ptr %call.i216, ptr %NewS.i, align 8, !tbaa !5
...
if.end42:                                         ; preds = %if.end27, %while.end
  ...
  %link.0225 = load ptr, ptr %link.0.in224, align 8, !tbaa !19
