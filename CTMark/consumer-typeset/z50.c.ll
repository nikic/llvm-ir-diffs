...
if.then.i12:                                      ; preds = %PDF_CoordTranslate.exit
  ...
  %.pre.i15 = load i32, ptr @gs_stack_top, align 4, !tbaa !9
...
PDF_SaveGraphicState.exit16:                      ; preds = %PDF_CoordTranslate.exit, %if.then.i12
  ...
  store i32 %13, ptr %arrayidx.i7, align 4, !tbaa !11
  ...
  store i32 %14, ptr %gs_colour.i8, align 4, !tbaa !14
  ...
  store i32 %15, ptr %gs_cpexists.i9, align 4, !tbaa !15
  ...
  store i32 %16, ptr %gs_currenty.i10, align 4, !tbaa !16
  ...
  store i16 %17, ptr %gs_xheight2.i11, align 4, !tbaa !18
  ret void
}
...
while.body:                                       ; preds = %while.body.lr.ph, %while.end88
  ...
  %18 = load i8, ptr %incdec.ptr55, align 1, !tbaa !19
...
while.body74:                                     ; preds = %land.lhs.true66
  ...
  %21 = load i8, ptr %incdec.ptr76, align 1, !tbaa !19
...
while.end:                                        ; preds = %while.body74, %land.lhs.true66, %while.body
  ...
  %22 = load i8, ptr %add.ptr77, align 1, !tbaa !19
...
while.cond84:                                     ; preds = %while.end, %while.cond84
  ...
  %23 = load i8, ptr %incdec.ptr85, align 1, !tbaa !19
...
while.end88:                                      ; preds = %while.cond84
  ...
  br i1 %cmp59, label %while.body, label %do.cond, !llvm.loop !30
...
do.cond:                                          ; preds = %while.end88, %if.else48, %do.body, %if.then81
  ...
  %25 = load i8, ptr %p.1, align 1, !tbaa !19
...
do.end:                                           ; preds = %do.cond
  ...
  %26 = load i8, ptr %command.0, align 1, !tbaa !19
...
sw.bb99:                                          ; preds = %do.end
  ...
  %29 = load i32, ptr @PDF_PrintWord.last_hpos, align 4, !tbaa !9
...
sw.epilog:                                        ; preds = %sw.epilog.sink.split, %do.end
  ...
  %34 = load ptr, ptr %font_table, align 8, !tbaa !32
  ...
  %35 = load ptr, ptr %arrayidx118, align 8, !tbaa !5
  ...
  %36 = load i8, ptr %incdec.ptr121, align 1, !tbaa !19
...
for.body:                                         ; preds = %sw.epilog, %if.end206
  ...
  %42 = load ptr, ptr %original_face, align 8, !tbaa !33
...
if.else147:                                       ; preds = %for.body
  ...
  %45 = load ptr, ptr %kern_chars, align 8, !tbaa !35
...
for.cond160:                                      ; preds = %for.cond160, %if.else147
  ...
  %47 = load i8, ptr %arrayidx162, align 1, !tbaa !19
...
if.then205:                                       ; preds = %if.end202
  ...
  %.pre290 = load i8, ptr %p.2285, align 1, !tbaa !19
