; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z50.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z50.c"
...
entry:
  ...
  %1 = load i32, ptr @gs_stack_top, align 4
  %inc = add nsw i32 %1, 1
...
entry:
  ...
  store i32 %2, ptr @currentfont, align 4
  %gs_colour = getelementptr inbounds [50 x %struct.GRAPHICS_STATE], ptr @gs_stack, i64 0, i64 %idxprom, i32 1
  %3 = load i32, ptr %gs_colour, align 4
  store i32 %3, ptr @currentcolour, align 4
  %gs_cpexists = getelementptr inbounds [50 x %struct.GRAPHICS_STATE], ptr @gs_stack, i64 0, i64 %idxprom, i32 2
  %4 = load i32, ptr %gs_cpexists, align 4
  store i32 %4, ptr @cpexists, align 4
  %gs_currenty = getelementptr inbounds [50 x %struct.GRAPHICS_STATE], ptr @gs_stack, i64 0, i64 %idxprom, i32 3
  %5 = load i32, ptr %gs_currenty, align 4
  store i32 %5, ptr @currenty, align 4
  %gs_xheight2 = getelementptr inbounds [50 x %struct.GRAPHICS_STATE], ptr @gs_stack, i64 0, i64 %idxprom, i32 4
  %6 = load i16, ptr %gs_xheight2, align 4
  store i16 %6, ptr @currentxheight2, align 2
  %dec = add nsw i32 %1, -1
...
for.cond.preheader:                               ; preds = %entry
  ...
  %link.0103 = load ptr, ptr %link.0.in102, align 8
...
if.then23:                                        ; preds = %if.end17
  store i32 %bf.clear20, ptr @currentcolour, align 4
...
PDF_CoordTranslate.exit:                          ; preds = %PDF_SaveGraphicState.exit, %if.then.i3
  ...
  %11 = load i32, ptr @gs_stack_top, align 4
  %inc.i4 = add nsw i32 %11, 1
  store i32 %inc.i4, ptr @gs_stack_top, align 4
  %cmp.i5 = icmp sgt i32 %11, 48
  br i1 %cmp.i5, label %if.then.i12, label %PDF_SaveGraphicState.exit16

if.then.i12:                                      ; preds = %PDF_CoordTranslate.exit
  %ou1.i13 = getelementptr inbounds %struct.word_type, ptr %x, i64 0, i32 1
  %call.i14 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 50, i32 noundef 1, ptr noundef nonnull @.str, i32 noundef 1, ptr noundef nonnull %ou1.i13, i32 noundef 50) #7
  %.pre.i15 = load i32, ptr @gs_stack_top, align 4
  br label %PDF_SaveGraphicState.exit16

PDF_SaveGraphicState.exit16:                      ; preds = %PDF_CoordTranslate.exit, %if.then.i12
  %12 = phi i32 [ %.pre.i15, %if.then.i12 ], [ %inc.i4, %PDF_CoordTranslate.exit ]
  %13 = load i32, ptr @currentfont, align 4
  %idxprom.i6 = sext i32 %12 to i64
  %arrayidx.i7 = getelementptr inbounds [50 x %struct.GRAPHICS_STATE], ptr @gs_stack, i64 0, i64 %idxprom.i6
  store i32 %13, ptr %arrayidx.i7, align 4
  %14 = load i32, ptr @currentcolour, align 4
  %gs_colour.i8 = getelementptr inbounds [50 x %struct.GRAPHICS_STATE], ptr @gs_stack, i64 0, i64 %idxprom.i6, i32 1
  store i32 %14, ptr %gs_colour.i8, align 4
  %15 = load i32, ptr @cpexists, align 4
  %gs_cpexists.i9 = getelementptr inbounds [50 x %struct.GRAPHICS_STATE], ptr @gs_stack, i64 0, i64 %idxprom.i6, i32 2
  store i32 %15, ptr %gs_cpexists.i9, align 4
  %16 = load i32, ptr @currenty, align 4
  %gs_currenty.i10 = getelementptr inbounds [50 x %struct.GRAPHICS_STATE], ptr @gs_stack, i64 0, i64 %idxprom.i6, i32 3
  store i32 %16, ptr %gs_currenty.i10, align 4
  %17 = load i16, ptr @currentxheight2, align 2
  %gs_xheight2.i11 = getelementptr inbounds [50 x %struct.GRAPHICS_STATE], ptr @gs_stack, i64 0, i64 %idxprom.i6, i32 4
  store i16 %17, ptr %gs_xheight2.i11, align 4
  ret void
}
...
define internal void @PDF_PrintPageResourceForFont(ptr nocapture readnone %font_name, i32 %first) #5 {
entry:
  ret void
}
...
if.then12:                                        ; preds = %if.end
  store i32 %bf.clear9, ptr @currentcolour, align 4
...
if.end24:                                         ; preds = %if.then12, %if.then19, %if.end
  ...
  %8 = load i32, ptr @cpexists, align 4
...
if.end32:                                         ; preds = %land.lhs.true28, %if.else
  ...
  %11 = load ptr, ptr %lig_table, align 8
  %ostring = getelementptr inbounds %struct.word_type, ptr %x, i64 0, i32 4
  %.pre = load i8, ptr %ostring, align 1
  br label %do.body

do.body:                                          ; preds = %do.cond, %if.end32
  %12 = phi i8 [ %.pre, %if.end32 ], [ %25, %do.cond ]
...
if.else48:                                        ; preds = %do.body
  ...
  %cmp59282 = icmp eq i8 %16, %14
  br i1 %cmp59282, label %while.body.lr.ph, label %do.cond

while.body.lr.ph:                                 ; preds = %if.else48
  %17 = load i8, ptr %incdec.ptr, align 1
  br label %while.body

while.body:                                       ; preds = %while.body.lr.ph, %while.end88
  %a.0283 = phi ptr [ %arrayidx54, %while.body.lr.ph ], [ %incdec.ptr89, %while.end88 ]
  %incdec.ptr55 = getelementptr inbounds i8, ptr %a.0283, i64 1
  %18 = load i8, ptr %incdec.ptr55, align 1
  %cmp64274 = icmp eq i8 %18, %17
  br i1 %cmp64274, label %land.lhs.true66, label %while.end

land.lhs.true66:                                  ; preds = %while.body, %while.body74
  %19 = phi i8 [ %20, %while.body74 ], [ %17, %while.body ]
  %a.1276 = phi ptr [ %add.ptr67, %while.body74 ], [ %incdec.ptr55, %while.body ]
  %b.0275 = phi ptr [ %incdec.ptr76, %while.body74 ], [ %incdec.ptr, %while.body ]
  %add.ptr67 = getelementptr inbounds i8, ptr %a.1276, i64 1
  %20 = load i8, ptr %add.ptr67, align 1
...
while.body74:                                     ; preds = %land.lhs.true66
  %incdec.ptr76 = getelementptr inbounds i8, ptr %b.0275, i64 1
  %21 = load i8, ptr %incdec.ptr76, align 1
  %cmp64 = icmp eq i8 %20, %21
  br i1 %cmp64, label %land.lhs.true66, label %while.end

while.end:                                        ; preds = %while.body74, %land.lhs.true66, %while.body
  %b.0.lcssa = phi ptr [ %incdec.ptr, %while.body ], [ %b.0275, %land.lhs.true66 ], [ %incdec.ptr76, %while.body74 ]
  %a.1.lcssa = phi ptr [ %incdec.ptr55, %while.body ], [ %a.1276, %land.lhs.true66 ], [ %add.ptr67, %while.body74 ]
  %.lcssa273 = phi i8 [ %18, %while.body ], [ %19, %land.lhs.true66 ], [ %20, %while.body74 ]
  %add.ptr77 = getelementptr inbounds i8, ptr %a.1.lcssa, i64 1
  %22 = load i8, ptr %add.ptr77, align 1
  %cmp79 = icmp eq i8 %22, 0
  br i1 %cmp79, label %if.then81, label %while.cond84

if.then81:                                        ; preds = %while.end
  store i8 %.lcssa273, ptr %q.0, align 1
  br label %do.cond
...
while.cond84:                                     ; preds = %while.end, %while.cond84
  ...
  %tobool86.not = icmp eq i8 %23, 0
  br i1 %tobool86.not, label %while.end88, label %while.cond84

while.end88:                                      ; preds = %while.cond84
  %incdec.ptr89 = getelementptr inbounds i8, ptr %a.2, i64 2
  %24 = load i8, ptr %incdec.ptr89, align 1
  %cmp59 = icmp eq i8 %24, %14
  br i1 %cmp59, label %while.body, label %do.cond
...
do.cond:                                          ; preds = %while.end88, %if.else48, %do.body, %if.then81
  ...
  %tobool94.not = icmp eq i8 %25, 0
  br i1 %tobool94.not, label %do.end, label %do.body

do.end:                                           ; preds = %do.cond
  store i8 0, ptr %incdec.ptr37, align 1
  %26 = load i8, ptr %command.0, align 1
  %conv96 = sext i8 %26 to i32
...
sw.bb:                                            ; preds = %do.end
  %27 = load ptr, ptr @out_fp, align 8
  call void @PDFText_OpenXY(ptr noundef %27, i32 noundef %hpos, i32 noundef %sub) #7
  br label %sw.epilog.sink.split

sw.bb99:                                          ; preds = %do.end
  %28 = load ptr, ptr @out_fp, align 8
  %29 = load i32, ptr @PDF_PrintWord.last_hpos, align 4
  %sub100 = sub nsw i32 %hpos, %29
  call void @PDFText_OpenX(ptr noundef %28, i32 noundef %sub100) #7
  br label %sw.epilog.sink.split

sw.epilog.sink.split:                             ; preds = %sw.bb, %sw.bb99
  store i32 %hpos, ptr @PDF_PrintWord.last_hpos, align 4
  br label %sw.epilog

sw.epilog:                                        ; preds = %sw.epilog.sink.split, %do.end
  %30 = load ptr, ptr @out_fp, align 8
  %31 = load i8, ptr %ostring, align 1
  %idxprom107 = zext i8 %31 to i64
  %arrayidx108 = getelementptr inbounds [0 x ptr], ptr @EightBitToPrintForm, i64 0, i64 %idxprom107
  %32 = load ptr, ptr %arrayidx108, align 8
  call void @PDFPage_Write(ptr noundef %30, ptr noundef %32) #7
  %33 = load ptr, ptr @finfo, align 8
  %bf.load110 = load i32, ptr %ou2, align 8
  %bf.clear111 = and i32 %bf.load110, 4095
  %idxprom112 = zext i32 %bf.clear111 to i64
  %font_table = getelementptr inbounds %struct.font_rec, ptr %33, i64 %idxprom112, i32 5
  %34 = load ptr, ptr %font_table, align 8
  %ofont_mapping = getelementptr inbounds %struct.word_type, ptr %34, i64 0, i32 3, i32 1, i64 4
  ...
  %35 = load ptr, ptr %arrayidx118, align 8
  %arrayidx119 = getelementptr inbounds %struct.mapvec, ptr %35, i64 0, i32 7, i64 2
  %incdec.ptr121 = getelementptr inbounds %struct.word_type, ptr %x, i64 0, i32 4, i64 1
  %36 = load i8, ptr %incdec.ptr121, align 1
  %tobool122.not284 = icmp eq i8 %36, 0
  br i1 %tobool122.not284, label %for.end211, label %for.body

for.body:                                         ; preds = %sw.epilog, %if.end206
  %37 = phi i8 [ %55, %if.end206 ], [ %36, %sw.epilog ]
  %p.2285 = phi ptr [ %incdec.ptr210, %if.end206 ], [ %incdec.ptr121, %sw.epilog ]
  %add.ptr123 = getelementptr inbounds i8, ptr %p.2285, i64 -1
  %38 = load i8, ptr %add.ptr123, align 1
  %idxprom124 = zext i8 %38 to i64
  %arrayidx125 = getelementptr inbounds i8, ptr %arrayidx119, i64 %idxprom124
  %39 = load i8, ptr %arrayidx125, align 1
  %idxprom127 = zext i8 %37 to i64
  ...
  %original_face = getelementptr inbounds %struct.font_rec, ptr %41, i64 %idxprom133, i32 6
  %42 = load ptr, ptr %original_face, align 8
  %ou2135 = getelementptr inbounds %struct.word_type, ptr %42, i64 0, i32 2
  %bf.load136 = load i16, ptr %ou2135, align 8
  %bf.clear137 = and i16 %bf.load136, 4095
  %idxprom139 = zext i16 %bf.clear137 to i64
  %kern_table = getelementptr inbounds %struct.font_rec, ptr %41, i64 %idxprom139, i32 9
  %43 = load ptr, ptr %kern_table, align 8
  %idxprom141 = zext i8 %39 to i64
  %arrayidx142 = getelementptr inbounds i16, ptr %43, i64 %idxprom141
  %44 = load i16, ptr %arrayidx142, align 2
  %cmp144 = icmp eq i16 %44, 0
  br i1 %cmp144, label %if.end206, label %if.else147

if.else147:                                       ; preds = %for.body
  %kern_chars = getelementptr inbounds %struct.font_rec, ptr %41, i64 %idxprom139, i32 10
  %45 = load ptr, ptr %kern_chars, align 8
  %46 = zext i16 %44 to i64
  br label %for.cond160

for.cond160:                                      ; preds = %for.cond160, %if.else147
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.cond160 ], [ %46, %if.else147 ]
  %arrayidx162 = getelementptr inbounds i8, ptr %45, i64 %indvars.iv
  %47 = load i8, ptr %arrayidx162, align 1
  %cmp164 = icmp ugt i8 %47, %40
  %indvars.iv.next = add nuw i64 %indvars.iv, 1
  br i1 %cmp164, label %for.cond160, label %for.end

for.end:                                          ; preds = %for.cond160
  %cmp171 = icmp eq i8 %47, %40
  br i1 %cmp171, label %if.end202, label %if.end206

if.end202:                                        ; preds = %for.end
  %kern_sizes = getelementptr inbounds %struct.font_rec, ptr %41, i64 %idxprom139, i32 12
  %48 = load ptr, ptr %kern_sizes, align 8
  %kern_value = getelementptr inbounds %struct.font_rec, ptr %41, i64 %idxprom139, i32 11
  %49 = load ptr, ptr %kern_value, align 8
  %arrayidx198 = getelementptr inbounds i8, ptr %49, i64 %indvars.iv
  %50 = load i8, ptr %arrayidx198, align 1
  %idxprom199 = zext i8 %50 to i64
  %arrayidx200 = getelementptr inbounds i16, ptr %48, i64 %idxprom199
  %51 = load i16, ptr %arrayidx200, align 2
  %cmp203.not = icmp eq i16 %51, 0
  br i1 %cmp203.not, label %if.end206, label %if.then205

if.then205:                                       ; preds = %if.end202
  %conv201 = sext i16 %51 to i32
  %52 = load ptr, ptr @out_fp, align 8
  call void @PDFText_Kern(ptr noundef %52, i32 noundef %conv201) #7
  %.pre290 = load i8, ptr %p.2285, align 1
  %.pre291 = zext i8 %.pre290 to i64
  br label %if.end206

if.end206:                                        ; preds = %for.end, %for.body, %if.then205, %if.end202
  %idxprom207.pre-phi = phi i64 [ %idxprom127, %for.end ], [ %idxprom127, %for.body ], [ %.pre291, %if.then205 ], [ %idxprom127, %if.end202 ]
  %53 = load ptr, ptr @out_fp, align 8
  %arrayidx208 = getelementptr inbounds [0 x ptr], ptr @EightBitToPrintForm, i64 0, i64 %idxprom207.pre-phi
  %54 = load ptr, ptr %arrayidx208, align 8
  call void @PDFPage_Write(ptr noundef %53, ptr noundef %54) #7
  %incdec.ptr210 = getelementptr inbounds i8, ptr %p.2285, i64 1
  %55 = load i8, ptr %incdec.ptr210, align 1
  %tobool122.not = icmp eq i8 %55, 0
  br i1 %tobool122.not, label %for.end211, label %for.body

for.end211:                                       ; preds = %if.end206, %sw.epilog
  %56 = load ptr, ptr @out_fp, align 8
  call void @PDFText_Close(ptr noundef %56) #7
  ret void
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define internal void @PDF_LinkSource(ptr nocapture readnone %name, i32 %llx, i32 %lly, i32 %urx, i32 %ury) #5 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define internal void @PDF_LinkDest(ptr nocapture readnone %name, i32 %llx, i32 %lly, i32 %urx, i32 %ury) #5 {
entry:
  ret void
}
