; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z44.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z44.c"
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %link.01919 = load ptr, ptr %link.0.in1918, align 8
...
if.then35:                                        ; preds = %for.cond6, %for.cond6
  ...
  %4 = load ptr, ptr %osucc38, align 8
  br label %for.cond42

for.cond42:                                       ; preds = %for.cond42, %if.then35
  %.pn1806 = phi ptr [ %4, %if.then35 ], [ %s2.0, %for.cond42 ]
  %s2.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn1806, i64 0, i64 1
  %s2.0 = load ptr, ptr %s2.0.in, align 8
  %ou143 = getelementptr inbounds %struct.word_type, ptr %s2.0, i64 0, i32 1
  %5 = load i8, ptr %ou143, align 8
  %cmp46 = icmp eq i8 %5, 0
  br i1 %cmp46, label %for.cond42, label %if.end54
...
if.end61:                                         ; preds = %if.end54
  ...
  %7 = load ptr, ptr %osucc64, align 8
  br label %for.cond68

for.cond68:                                       ; preds = %for.cond68, %if.end61
  %.pn1807 = phi ptr [ %7, %if.end61 ], [ %sh.0, %for.cond68 ]
  %sh.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn1807, i64 0, i64 1
  %sh.0 = load ptr, ptr %sh.0.in, align 8
  %ou169 = getelementptr inbounds %struct.word_type, ptr %sh.0, i64 0, i32 1
  %8 = load i8, ptr %ou169, align 8
  %cmp72 = icmp eq i8 %8, 0
  br i1 %cmp72, label %for.cond68, label %for.end79

for.end79:                                        ; preds = %for.cond68
  %9 = load ptr, ptr %s2.1, align 8
  br label %for.cond86

for.cond86:                                       ; preds = %for.cond86, %for.end79
  %.pn1808 = phi ptr [ %9, %for.end79 ], [ %sv.0, %for.cond86 ]
  %sv.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn1808, i64 0, i64 1
  %sv.0 = load ptr, ptr %sv.0.in, align 8
  %ou187 = getelementptr inbounds %struct.word_type, ptr %sv.0, i64 0, i32 1
  %10 = load i8, ptr %ou187, align 8
...
for.cond119:                                      ; preds = %for.cond119, %if.end112
  ...
  %shp.0 = load ptr, ptr %shp.0.in, align 8
  %ou1120 = getelementptr inbounds %struct.word_type, ptr %shp.0, i64 0, i32 1
  %12 = load i8, ptr %ou1120, align 8
  %cmp123 = icmp eq i8 %12, 0
  br i1 %cmp123, label %for.cond119, label %for.end130
...
if.then140:                                       ; preds = %if.end134
  ...
  %13 = load i32, ptr %arrayidx141, align 4
...
for.inc154:                                       ; preds = %if.else147, %if.then140, %if.then21
  ...
  br i1 %cmp2.not, label %for.end158, label %for.cond6.preheader
...
if.end162:                                        ; preds = %for.end158
  ...
  %link.11929 = load ptr, ptr %osucc165, align 8
...
for.inc224:                                       ; preds = %for.cond173, %cond.false207, %cond.true204
  ...
  %link.1 = load ptr, ptr %osucc227, align 8
  %cmp167.not = icmp eq ptr %link.1, %large_comp.1
  br i1 %cmp167.not, label %cleanup, label %for.cond173.preheader
...
while.body:                                       ; preds = %land.rhs231
  ...
  %17 = load ptr, ptr %osucc241, align 8
...
if.end252:                                        ; preds = %if.then250, %if.then244
  ...
  store ptr %prev.31950, ptr @zz_hold, align 8
  %20 = load ptr, ptr %prev.31950, align 8
  store ptr %20, ptr @zz_tmp, align 8
  %21 = load ptr, ptr %17, align 8
  store ptr %21, ptr %prev.31950, align 8
  ...
  store ptr %22, ptr %osucc275, align 8
  %25 = load ptr, ptr @zz_tmp, align 8
...
cond.false293:                                    ; preds = %if.end252
  ...
  store ptr %30, ptr %osucc308, align 8
...
cond.false356:                                    ; preds = %cond.end348
  ...
  %40 = load ptr, ptr %link.21951, align 8
  ...
  store ptr %41, ptr %osucc371, align 8
  %osucc374 = getelementptr inbounds %struct.LIST, ptr %42, i64 0, i32 1
  store ptr %42, ptr %osucc374, align 8
  store ptr %42, ptr %42, align 8
  %.pre2058 = load ptr, ptr @xx_link, align 8
...
if.end415:                                        ; preds = %if.then413, %cond.end378
  %link.31939 = load ptr, ptr %osucc165, align 8
...
for.inc480:                                       ; preds = %for.cond426, %cond.false463, %cond.true460
  ...
  %link.3 = load ptr, ptr %osucc483, align 8
  %cmp420.not = icmp eq ptr %link.3, %large_comp.1
  br i1 %cmp420.not, label %cleanup, label %for.cond426.preheader

for.end484:                                       ; preds = %cond.true460, %cond.false463
  %cmp229.not = icmp eq ptr %link.31942, %large_comp.1
  br i1 %cmp229.not, label %cleanup, label %land.rhs231
...
if.end504:                                        ; preds = %if.then498, %lor.lhs.false487
  %55 = load ptr, ptr %link.21951, align 8
  %link.4.in1952 = getelementptr inbounds %struct.LIST, ptr %link.21951, i64 0, i32 1
  %link.41953 = load ptr, ptr %link.4.in1952, align 8
...
for.inc579:                                       ; preds = %for.cond520, %cond.false557, %cond.true554
  ...
  br i1 %cmp514.not, label %cleanup, label %for.cond520.preheader
...
while.body595:                                    ; preds = %land.rhs587
  ...
  %ylink.01961 = load ptr, ptr %osucc598, align 8
...
for.inc660:                                       ; preds = %for.cond606, %cond.false643, %cond.true640
  ...
  %ylink.0 = load ptr, ptr %osucc663, align 8
  %cmp600.not = icmp eq ptr %ylink.0, %nxt.31976
  br i1 %cmp600.not, label %if.end842, label %for.cond606.preheader

land.lhs.true667:                                 ; preds = %cond.true640, %cond.false643
  %62 = load ptr, ptr %ylink.01964, align 8
...
for.cond680:                                      ; preds = %land.lhs.true667, %for.cond680
  %.pn1804 = phi ptr [ %yg.0, %for.cond680 ], [ %62, %land.lhs.true667 ]
  %yg.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn1804, i64 0, i64 1
  %yg.0 = load ptr, ptr %yg.0.in, align 8
  %ou1681 = getelementptr inbounds %struct.word_type, ptr %yg.0, i64 0, i32 1
  %63 = load i8, ptr %ou1681, align 8
...
if.then704:                                       ; preds = %for.cond680, %land.lhs.true697
  ...
  %.pre2054 = load ptr, ptr %ylink.01964, align 8
  br label %if.end706
...
if.end706:                                        ; preds = %if.then704, %land.lhs.true697
  ...
  %66 = load ptr, ptr %osucc712, align 8
...
cond.end774:                                      ; preds = %cond.end738, %cond.false750
  ...
  %82 = load ptr, ptr %osucc781, align 8
...
cond.end807.thread:                               ; preds = %cond.end774
  ...
  store ptr %ylink.01964, ptr @zz_hold, align 8
  br label %cond.false816

cond.end807:                                      ; preds = %cond.end774
  store ptr %82, ptr @zz_res, align 8
  ...
  store ptr %84, ptr %osucc800, align 8
  %osucc803 = getelementptr inbounds %struct.LIST, ptr %85, i64 0, i32 1
  store ptr %85, ptr %osucc803, align 8
...
cond.false816:                                    ; preds = %cond.end807.thread, %cond.end807
  ...
  %88 = load ptr, ptr %ylink.01964, align 8
  store ptr %88, ptr @zz_tmp, align 8
  %89 = load ptr, ptr %87, align 8
  store ptr %89, ptr %ylink.01964, align 8
  %90 = load ptr, ptr @zz_hold, align 8
  %91 = load ptr, ptr @zz_res, align 8
  %92 = load ptr, ptr %91, align 8
  %osucc831 = getelementptr inbounds %struct.LIST, ptr %92, i64 0, i32 1
  store ptr %90, ptr %osucc831, align 8
  %93 = load ptr, ptr @zz_tmp, align 8
  store ptr %93, ptr %91, align 8
  %94 = load ptr, ptr @zz_res, align 8
  %95 = load ptr, ptr @zz_tmp, align 8
  %osucc837 = getelementptr inbounds %struct.LIST, ptr %95, i64 0, i32 1
  store ptr %94, ptr %osucc837, align 8
  br label %if.end842
...
if.end1024:                                       ; preds = %if.then1022, %cond.end985
  %130 = load ptr, ptr %osucc1027, align 8
  %link.6.in1966 = getelementptr inbounds %struct.LIST, ptr %130, i64 0, i32 1
  %link.61967 = load ptr, ptr %link.6.in1966, align 8
...
if.then1092:                                      ; preds = %if.then1089
  %133 = load ptr, ptr @no_fpos, align 8
...
for.inc1097:                                      ; preds = %for.cond1038, %cond.false1075, %cond.true1072
  ...
  br i1 %cmp1032.not, label %cleanup, label %for.cond1038.preheader

for.end1101:                                      ; preds = %if.then1089, %if.then1092
  %cmp585.not = icmp eq ptr %link.61971, %large_comp.1
  br i1 %cmp585.not, label %cleanup, label %land.rhs587
...
if.then1129:                                      ; preds = %lor.lhs.false1122
  %136 = load ptr, ptr @no_fpos, align 8
...
if.end1135:                                       ; preds = %lor.lhs.false1122, %if.then1129
  ...
  %137 = load i32, ptr %arrayidx1138, align 4
...
for.cond1173.preheader:                           ; preds = %if.end1135
  %link.71979 = load ptr, ptr %osucc165, align 8
...
for.cond1180:                                     ; preds = %for.cond1180.preheader, %for.cond1180
  ...
  %143 = load i8, ptr %ou11181, align 8
...
for.inc1213:                                      ; preds = %for.cond1180, %land.lhs.true1197
  ...
  %link.7 = load ptr, ptr %osucc1216, align 8
  %cmp1174.not = icmp eq ptr %link.7, %large_comp.1
  br i1 %cmp1174.not, label %for.end1217, label %for.cond1180.preheader
...
for.end1217:                                      ; preds = %for.inc1213, %for.cond1173.preheader
  ...
  %145 = load ptr, ptr %osucc1220, align 8
  %link.8.in1982 = getelementptr inbounds %struct.LIST, ptr %145, i64 0, i32 1
  %link.81983 = load ptr, ptr %link.8.in1982, align 8
...
cond.end1323:                                     ; preds = %if.then1289, %if.then1283
  store ptr %148, ptr @zz_res, align 8
  store ptr %large_comp.1, ptr @zz_hold, align 8
  %153 = load ptr, ptr %large_comp.1, align 8
  store ptr %153, ptr @zz_tmp, align 8
  %154 = load ptr, ptr %148, align 8
  store ptr %154, ptr %large_comp.1, align 8
  ...
  store ptr %155, ptr %osucc1314, align 8
  ...
  store ptr %159, ptr %osucc1320, align 8
  store ptr %148, ptr @zz_res, align 8
...
for.cond1436:                                     ; preds = %for.cond1436.preheader, %for.cond1436
  ...
  %index.1 = load ptr, ptr %index.1.in, align 8
  %ou11437 = getelementptr inbounds %struct.word_type, ptr %index.1, i64 0, i32 1
  %176 = load i8, ptr %ou11437, align 8
  %cmp1440 = icmp eq i8 %176, 0
  br i1 %cmp1440, label %for.cond1436, label %for.end1447
...
if.then1459:                                      ; preds = %for.end1447
  ...
  %.pre = load i8, ptr %ou11437.le, align 8
  br label %if.end1461
...
FindTarget.exit:                                  ; preds = %sw.bb1.i, %sw.bb2.i
  ...
  %res.0.i = load ptr, ptr %res.0.i.in, align 8
...
if.then1465:                                      ; preds = %FindTarget.exit
  ...
  %181 = load ptr, ptr %osucc25.i, align 8
...
while.cond.loopexit.i:                            ; preds = %for.cond.i
  ...
  %182 = load ptr, ptr %osucc.i, align 8
  %cmp.not.i = icmp eq ptr %182, %prnt.0.i
  br i1 %cmp.not.i, label %if.else1542, label %for.cond.preheader.i
...
for.cond.i:                                       ; preds = %for.cond.i, %for.cond.preheader.i
  ...
  %184 = load i8, ptr %ou1.i1830, align 8
...
if.then1472:                                      ; preds = %WhichComponent.exit
  %185 = load ptr, ptr %osucc14231990, align 8
  store ptr %185, ptr @xx_link, align 8
  store ptr %185, ptr @zz_hold, align 8
  %osucc1478 = getelementptr inbounds %struct.LIST, ptr %185, i64 0, i32 1
  %186 = load ptr, ptr %osucc1478, align 8
...
cond.end1504:                                     ; preds = %if.then1472, %cond.false1482
  ...
  store ptr %192, ptr @zz_res, align 8
  store ptr %191, ptr @zz_hold, align 8
...
cond.false1516:                                   ; preds = %cond.end1504
  ...
  store ptr %193, ptr @zz_tmp, align 8
  %194 = load ptr, ptr %192, align 8
  store ptr %194, ptr %191, align 8
  %195 = load ptr, ptr @zz_hold, align 8
  %196 = load ptr, ptr @zz_res, align 8
  %197 = load ptr, ptr %196, align 8
  %osucc1531 = getelementptr inbounds %struct.LIST, ptr %197, i64 0, i32 1
  store ptr %195, ptr %osucc1531, align 8
  %198 = load ptr, ptr @zz_tmp, align 8
  store ptr %198, ptr %196, align 8
  %199 = load ptr, ptr @zz_res, align 8
  %200 = load ptr, ptr @zz_tmp, align 8
  %osucc1537 = getelementptr inbounds %struct.LIST, ptr %200, i64 0, i32 1
  store ptr %199, ptr %osucc1537, align 8
  br label %if.end1551

if.else1542:                                      ; preds = %while.cond.loopexit.i, %if.then1465.thread, %if.then1465, %WhichComponent.exit
  %201 = load ptr, ptr %osucc14231990, align 8
  br label %if.end1551
...
if.else1547:                                      ; preds = %if.end1461, %if.end1461, %if.end1461, %if.end1461, %if.end1461, %if.end1461, %if.end1461, %if.end1461, %if.end1461, %FindTarget.exit
  %202 = load ptr, ptr %osucc14231990, align 8
  br label %if.end1551
...
if.end1551:                                       ; preds = %cond.end1504, %if.else1542, %cond.false1516, %if.else1547
  ...
  %203 = load ptr, ptr %osucc1423, align 8
  %204 = load ptr, ptr %osucc1277, align 8
  %cmp1427.not = icmp eq ptr %203, %204
  br i1 %cmp1427.not, label %cleanup, label %for.cond1436.preheader
...
if.end:                                           ; preds = %if.then, %entry
  %2 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 18), align 1
...
if.end19:                                         ; preds = %if.then9, %if.else11
  ...
  store ptr %6, ptr %osucc22, align 8
  store ptr %6, ptr %arrayidx21, align 8
  %osucc28 = getelementptr inbounds %struct.LIST, ptr %6, i64 0, i32 1
  store ptr %6, ptr %osucc28, align 8
...
cond.end92:                                       ; preds = %if.end19, %cond.false
  ...
  store ptr %10, ptr %arrayidx21, align 8
  %12 = load ptr, ptr %arrayidx73, align 8
  %osucc83 = getelementptr inbounds [2 x %struct.LIST], ptr %12, i64 0, i64 1, i32 1
  store ptr %6, ptr %osucc83, align 8
  store ptr %11, ptr %arrayidx73, align 8
  %osucc89 = getelementptr inbounds [2 x %struct.LIST], ptr %11, i64 0, i64 1, i32 1
  store ptr %7, ptr %osucc89, align 8
  %13 = load ptr, ptr %osucc, align 8
...
if.end101:                                        ; preds = %if.then99, %cond.end92
  ...
  store i16 %15, ptr %ofile_num104, align 2
  ...
  store i32 %18, ptr %arrayidx135, align 4
  ...
  %19 = load i32, ptr %arrayidx138, align 4
  %arrayidx141 = getelementptr inbounds %struct.word_type, ptr %6, i64 0, i32 3, i32 1, i64 4
  store i32 %19, ptr %arrayidx141, align 4
  %20 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 15), align 1
  %conv142 = zext i8 %20 to i32
  store i32 %conv142, ptr @zz_size, align 4
  %conv143 = zext i8 %20 to i64
  %arrayidx150 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv143
  %21 = load ptr, ptr %arrayidx150, align 8
...
if.then153:                                       ; preds = %if.end101
  ...
  store ptr %call154, ptr @zz_hold, align 8
  br label %if.end164

if.else155:                                       ; preds = %if.end101
  store ptr %21, ptr @zz_hold, align 8
  %23 = load ptr, ptr %21, align 8
  store ptr %23, ptr %arrayidx150, align 8
  br label %if.end164
...
if.end164:                                        ; preds = %if.then153, %if.else155
  ...
  store i8 15, ptr %ou1165, align 8
  ...
  store ptr %24, ptr %osucc169, align 8
  store ptr %24, ptr %arrayidx168, align 8
  %osucc175 = getelementptr inbounds %struct.LIST, ptr %24, i64 0, i32 1
  store ptr %24, ptr %osucc175, align 8
  ...
  store i32 %25, ptr %arrayidx184, align 4
...
if.then215:                                       ; preds = %for.cond200
  %28 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 1), align 1
  %conv216 = zext i8 %28 to i32
  store i32 %conv216, ptr @zz_size, align 4
  %conv217 = zext i8 %28 to i64
  %arrayidx224 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv217
  %29 = load ptr, ptr %arrayidx224, align 8
...
if.then227:                                       ; preds = %if.then215
  ...
  store ptr %call228, ptr @zz_hold, align 8
  br label %if.end238

if.else229:                                       ; preds = %if.then215
  store ptr %29, ptr @zz_hold, align 8
  %31 = load ptr, ptr %29, align 8
  store ptr %31, ptr %arrayidx224, align 8
  br label %if.end238
...
if.end238:                                        ; preds = %if.then227, %if.else229
  ...
  %38 = load ptr, ptr %arrayidx351, align 8
...
if.else356:                                       ; preds = %if.end238
  ...
  store ptr %40, ptr %arrayidx351, align 8
  br label %cond.end411
...
cond.end411:                                      ; preds = %if.then354, %if.else356
  ...
  store ptr %44, ptr %osucc402, align 8
  ...
  store ptr %48, ptr %osucc408, align 8
...
cond.false420:                                    ; preds = %cond.end411
  ...
  %52 = load ptr, ptr %arrayidx425, align 8
  store ptr %52, ptr %arrayidx242, align 8
  %53 = load ptr, ptr %arrayidx425, align 8
  %osucc435 = getelementptr inbounds [2 x %struct.LIST], ptr %53, i64 0, i64 1, i32 1
  store ptr %32, ptr %osucc435, align 8
  store ptr %51, ptr %arrayidx425, align 8
...
if.then457:                                       ; preds = %for.cond200, %for.cond200
  ...
  %54 = load ptr, ptr %osucc460, align 8
  br label %for.cond464

for.cond464:                                      ; preds = %for.cond464, %if.then457
  %.pn = phi ptr [ %54, %if.then457 ], [ %s2.0, %for.cond464 ]
  ...
  %55 = load i8, ptr %ou1465, align 8
  %cmp468 = icmp eq i8 %55, 0
  br i1 %cmp468, label %for.cond464, label %if.end477
...
if.end485:                                        ; preds = %if.then483, %if.end477
  ...
  %58 = load ptr, ptr %osucc488, align 8
  br label %for.cond492

for.cond492:                                      ; preds = %for.cond492, %if.end485
  %.pn1665 = phi ptr [ %58, %if.end485 ], [ %sh.0, %for.cond492 ]
  %sh.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn1665, i64 0, i64 1
  %sh.0 = load ptr, ptr %sh.0.in, align 8
  %ou1493 = getelementptr inbounds %struct.word_type, ptr %sh.0, i64 0, i32 1
  %59 = load i8, ptr %ou1493, align 8
  %cmp496 = icmp eq i8 %59, 0
  br i1 %cmp496, label %for.cond492, label %for.end503

for.end503:                                       ; preds = %for.cond492
  %ou1493.le = getelementptr inbounds %struct.word_type, ptr %sh.0, i64 0, i32 1
  %60 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 9), align 1
  %conv504 = zext i8 %60 to i32
  store i32 %conv504, ptr @zz_size, align 4
  %conv505 = zext i8 %60 to i64
  %arrayidx512 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv505
  %61 = load ptr, ptr %arrayidx512, align 8
...
if.then515:                                       ; preds = %for.end503
  ...
  store ptr %call516, ptr @zz_hold, align 8
  br label %if.end526

if.else517:                                       ; preds = %for.end503
  store ptr %61, ptr @zz_hold, align 8
  %63 = load ptr, ptr %61, align 8
  store ptr %63, ptr %arrayidx512, align 8
  br label %if.end526
...
if.else649:                                       ; preds = %if.end595
  ...
  store ptr %80, ptr %arrayidx644, align 8
  br label %cond.end704
...
if.else752:                                       ; preds = %cond.end737
  ...
  store ptr %97, ptr %arrayidx747, align 8
  br label %cond.end807
...
cond.end807:                                      ; preds = %if.then750, %if.else752
  ...
  store ptr %101, ptr %osucc798, align 8
  %104 = load ptr, ptr @zz_tmp, align 8
  store ptr %104, ptr %102, align 8
  %105 = load ptr, ptr @zz_res, align 8
  %106 = load ptr, ptr @zz_tmp, align 8
  %osucc804 = getelementptr inbounds %struct.LIST, ptr %106, i64 0, i32 1
  store ptr %105, ptr %osucc804, align 8
  %107 = load ptr, ptr @xx_link, align 8
...
if.else856:                                       ; preds = %if.else842
  ...
  store ptr %114, ptr %arrayidx851, align 8
  br label %cond.end911
...
cond.false920:                                    ; preds = %cond.end911
  %125 = load ptr, ptr %arrayidx530, align 8
  store ptr %125, ptr @zz_tmp, align 8
  %arrayidx925 = getelementptr inbounds [2 x %struct.LIST], ptr %124, i64 0, i64 1
  %126 = load ptr, ptr %arrayidx925, align 8
  store ptr %126, ptr %arrayidx530, align 8
  %127 = load ptr, ptr %arrayidx925, align 8
  %osucc935 = getelementptr inbounds [2 x %struct.LIST], ptr %127, i64 0, i64 1, i32 1
  store ptr %64, ptr %osucc935, align 8
  store ptr %125, ptr %arrayidx925, align 8
  br label %if.end946.sink.split
...
if.end946.sink.split:                             ; preds = %cond.false816, %cond.false920
  ...
  store ptr %.sink, ptr %osucc941, align 8
  br label %if.end946
...
if.then949:                                       ; preds = %if.end946
  ...
  %128 = load i32, ptr %ou3950, align 8
  store i32 %128, ptr %ou3130, align 8
  %ofwd957 = getelementptr inbounds %struct.word_type, ptr %s2.1, i64 0, i32 3, i32 1
  %129 = load i32, ptr %ofwd957, align 8
  store i32 %129, ptr %ofwd137, align 8
  br label %if.end1178

if.else962:                                       ; preds = %if.end946
  %130 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 26), align 1
  %conv963 = zext i8 %130 to i32
  store i32 %conv963, ptr @zz_size, align 4
  %conv964 = zext i8 %130 to i64
  %arrayidx971 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv964
  %131 = load ptr, ptr %arrayidx971, align 8
...
if.then974:                                       ; preds = %if.else962
  ...
  store ptr %call975, ptr @zz_hold, align 8
  br label %if.end985

if.else976:                                       ; preds = %if.else962
  store ptr %131, ptr @zz_hold, align 8
  %133 = load ptr, ptr %131, align 8
  store ptr %133, ptr %arrayidx971, align 8
  br label %if.end985
...
if.else1088:                                      ; preds = %if.end985
  ...
  store ptr %145, ptr %arrayidx1083, align 8
  br label %cond.end1143
...
cond.end1143:                                     ; preds = %if.then1086, %if.else1088
  ...
  store ptr %149, ptr %osucc1134, align 8
  ...
  store ptr %153, ptr %osucc1140, align 8
  %155 = load ptr, ptr @xx_link, align 8
  store ptr %155, ptr @zz_res, align 8
  store ptr %call1058, ptr @zz_hold, align 8
...
cond.false1152:                                   ; preds = %cond.end1143
  ...
  %156 = load ptr, ptr %arrayidx1154, align 8
  store ptr %156, ptr @zz_tmp, align 8
  %arrayidx1157 = getelementptr inbounds [2 x %struct.LIST], ptr %155, i64 0, i64 1
  %157 = load ptr, ptr %arrayidx1157, align 8
  store ptr %157, ptr %arrayidx1154, align 8
  %158 = load ptr, ptr %arrayidx1157, align 8
  %osucc1167 = getelementptr inbounds [2 x %struct.LIST], ptr %158, i64 0, i64 1, i32 1
  store ptr %call1058, ptr %osucc1167, align 8
  store ptr %156, ptr %arrayidx1157, align 8
  %osucc1173 = getelementptr inbounds [2 x %struct.LIST], ptr %156, i64 0, i64 1, i32 1
  store ptr %155, ptr %osucc1173, align 8
  br label %if.end1178
...
if.else1192:                                      ; preds = %if.end1178
  ...
  store ptr %162, ptr %arrayidx1187, align 8
  br label %cond.end1247
...
cond.end1247:                                     ; preds = %if.then1190, %if.else1192
  ...
  store ptr %166, ptr %osucc1238, align 8
  ...
  store ptr %170, ptr %osucc1244, align 8
  %172 = load ptr, ptr @xx_link, align 8
  store ptr %172, ptr @zz_res, align 8
  store ptr %new_sh.0, ptr @zz_hold, align 8
...
cond.false1256:                                   ; preds = %cond.end1247
  ...
  %173 = load ptr, ptr %arrayidx1258, align 8
  store ptr %173, ptr @zz_tmp, align 8
  %arrayidx1261 = getelementptr inbounds [2 x %struct.LIST], ptr %172, i64 0, i64 1
  %174 = load ptr, ptr %arrayidx1261, align 8
  store ptr %174, ptr %arrayidx1258, align 8
  %175 = load ptr, ptr %arrayidx1261, align 8
  %osucc1271 = getelementptr inbounds [2 x %struct.LIST], ptr %175, i64 0, i64 1, i32 1
  store ptr %new_sh.0, ptr %osucc1271, align 8
  store ptr %173, ptr %arrayidx1261, align 8
  %osucc1277 = getelementptr inbounds [2 x %struct.LIST], ptr %173, i64 0, i64 1, i32 1
  store ptr %172, ptr %osucc1277, align 8
...
if.else1307:                                      ; preds = %cond.end1280
  ...
  store ptr %181, ptr %arrayidx1302, align 8
  br label %cond.end1362
...
if.else1422:                                      ; preds = %cond.end1395
  ...
  store ptr %200, ptr %arrayidx1417, align 8
  br label %cond.end1477
...
cond.end1477:                                     ; preds = %if.then1420, %if.else1422
  ...
  store i8 0, ptr %ou11432, align 8
  %osucc1436 = getelementptr inbounds [2 x %struct.LIST], ptr %201, i64 0, i64 1, i32 1
  store ptr %201, ptr %osucc1436, align 8
  %arrayidx1438 = getelementptr inbounds [2 x %struct.LIST], ptr %201, i64 0, i64 1
  store ptr %201, ptr %arrayidx1438, align 8
  %osucc1442 = getelementptr inbounds %struct.LIST, ptr %201, i64 0, i32 1
  store ptr %201, ptr %osucc1442, align 8
  store ptr %201, ptr %201, align 8
  store ptr %201, ptr @xx_link, align 8
  store ptr %201, ptr @zz_res, align 8
  store ptr %24, ptr @zz_hold, align 8
  %202 = load ptr, ptr %24, align 8
  store ptr %202, ptr @zz_tmp, align 8
  %203 = load ptr, ptr %201, align 8
  store ptr %203, ptr %24, align 8
  %204 = load ptr, ptr @zz_hold, align 8
  %205 = load ptr, ptr @zz_res, align 8
  %206 = load ptr, ptr %205, align 8
  %osucc1468 = getelementptr inbounds %struct.LIST, ptr %206, i64 0, i32 1
  store ptr %204, ptr %osucc1468, align 8
  %207 = load ptr, ptr @zz_tmp, align 8
  ...
  store ptr %208, ptr %osucc1474, align 8
  %210 = load ptr, ptr @xx_link, align 8
  store ptr %210, ptr @zz_res, align 8
  store ptr %new_sh.0, ptr @zz_hold, align 8
...
cond.false1486:                                   ; preds = %cond.end1477
  ...
  %211 = load ptr, ptr %arrayidx1488, align 8
  store ptr %211, ptr @zz_tmp, align 8
  %arrayidx1491 = getelementptr inbounds [2 x %struct.LIST], ptr %210, i64 0, i64 1
  %212 = load ptr, ptr %arrayidx1491, align 8
  store ptr %212, ptr %arrayidx1488, align 8
  %213 = load ptr, ptr %arrayidx1491, align 8
  %osucc1501 = getelementptr inbounds [2 x %struct.LIST], ptr %213, i64 0, i64 1, i32 1
  store ptr %new_sh.0, ptr %osucc1501, align 8
  store ptr %211, ptr %arrayidx1491, align 8
  br label %for.inc1512.sink.split
...
for.inc1512.sink.split:                           ; preds = %cond.false420, %cond.false1486
  ...
  store ptr %.sink1716, ptr %osucc1507, align 8
...
for.inc1512:                                      ; preds = %for.inc1512.sink.split, %cond.end1477, %cond.end411
  ...
  br i1 %cmp195.not, label %for.end1516, label %for.cond200.preheader
...
for.end24.cond.end_crit_edge:                     ; preds = %for.end24
  ...
  %.pre = load ptr, ptr %arrayidx66.phi.trans.insert, align 8
  br label %cond.end
...
cond.false:                                       ; preds = %for.end24
  ...
  store ptr %5, ptr %arrayidx40, align 8
  %6 = load ptr, ptr %arrayidx37, align 8
  %osucc47 = getelementptr inbounds [2 x %struct.LIST], ptr %6, i64 0, i64 1, i32 1
  store ptr %4, ptr %osucc47, align 8
  store ptr %0, ptr %osucc30, align 8
  store ptr %0, ptr %arrayidx37, align 8
  br label %cond.end
...
cond.false96:                                     ; preds = %cond.end
  ...
  %12 = load ptr, ptr %arrayidx101, align 8
  %arrayidx104 = getelementptr inbounds [2 x %struct.LIST], ptr %11, i64 0, i64 1
  store ptr %12, ptr %arrayidx104, align 8
  %13 = load ptr, ptr %arrayidx101, align 8
  %osucc111 = getelementptr inbounds [2 x %struct.LIST], ptr %13, i64 0, i64 1, i32 1
  store ptr %11, ptr %osucc111, align 8
  store ptr %10, ptr %osucc92, align 8
  store ptr %10, ptr %arrayidx101, align 8
...
cond.false126:                                    ; preds = %cond.end118
  ...
  store ptr %16, ptr %osucc141, align 8
  %osucc144 = getelementptr inbounds %struct.LIST, ptr %17, i64 0, i32 1
  store ptr %17, ptr %osucc144, align 8
  store ptr %17, ptr %17, align 8
  %.pre538 = load ptr, ptr @xx_link, align 8
...
cond.false186:                                    ; preds = %cond.end148
  ...
  store ptr %.pre539, ptr %arrayidx194, align 8
  %26 = load ptr, ptr %arrayidx222.phi.trans.insert, align 8
  ...
  store ptr %24, ptr %arrayidx222.phi.trans.insert, align 8
...
for.inc250:                                       ; preds = %cond.end208, %for.inc250
  ...
  %link.0 = load ptr, ptr %osucc253, align 8
  %cmp247.not = icmp eq ptr %link.0, %x
  br i1 %cmp247.not, label %for.end254, label %for.inc250
...
if.end:                                           ; preds = %if.then, %land.lhs.true
  ...
  store ptr %35, ptr %arrayidx295, align 8
  %osucc298 = getelementptr inbounds %struct.LIST, ptr %call, i64 0, i32 1
  %37 = load ptr, ptr %osucc298, align 8
...
for.cond302:                                      ; preds = %for.cond302, %if.end
  ...
  %obj.0 = load ptr, ptr %obj.0.in, align 8
  %ou1303 = getelementptr inbounds %struct.word_type, ptr %obj.0, i64 0, i32 1
  %38 = load i8, ptr %ou1303, align 8
  %cmp306 = icmp eq i8 %38, 0
  br i1 %cmp306, label %for.cond302, label %for.end313
...
for.end313:                                       ; preds = %for.cond302
  ...
  %39 = load ptr, ptr %osucc319, align 8
...
cond.end345:                                      ; preds = %for.end313
  ...
  store ptr %41, ptr %osucc338, align 8
  %osucc341 = getelementptr inbounds %struct.LIST, ptr %42, i64 0, i32 1
  store ptr %42, ptr %osucc341, align 8
  store ptr %42, ptr %42, align 8
  %.pre540 = load ptr, ptr @xx_link, align 8
  store ptr %.pre540, ptr @zz_res, align 8
  store ptr %res.0, ptr @zz_hold, align 8
...
cond.false354:                                    ; preds = %cond.end345.thread, %cond.end345
  ...
  store ptr %51, ptr %osucc375, align 8
  br label %cond.end378

cond.end378:                                      ; preds = %cond.end345, %cond.false354
  %53 = load ptr, ptr %call, align 8
  ...
  %54 = load ptr, ptr %osucc385, align 8
...
cond.false420:                                    ; preds = %cond.end411.thread, %cond.end411
  ...
  %60 = load ptr, ptr %obj.0, align 8
  store ptr %60, ptr @zz_tmp, align 8
  %61 = load ptr, ptr %59, align 8
  store ptr %61, ptr %obj.0, align 8
  %62 = load ptr, ptr @zz_hold, align 8
  %63 = load ptr, ptr @zz_res, align 8
  %64 = load ptr, ptr %63, align 8
  %osucc435 = getelementptr inbounds %struct.LIST, ptr %64, i64 0, i32 1
  store ptr %62, ptr %osucc435, align 8
  ...
  store ptr %66, ptr %osucc441, align 8
  br label %cond.end444

cond.end444:                                      ; preds = %cond.end411, %cond.false420
  %68 = load ptr, ptr %osucc298, align 8
...
land.lhs.true451:                                 ; preds = %cond.end444
  ...
  %69 = load ptr, ptr %osucc454, align 8
...
if.end459:                                        ; preds = %if.then457, %land.lhs.true451
  ...
  %cond482.in = load i8, ptr %cond482.in.in, align 1
  %cond482 = zext i8 %cond482.in to i32
  store i32 %cond482, ptr @zz_size, align 4
...
if.then:                                          ; preds = %entry
  %0 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 81), align 1
...
for.cond:                                         ; preds = %for.cond, %if.end15
  ...
  %6 = load i8, ptr %ou133, align 8
  %cmp36 = icmp eq i8 %6, 0
  br i1 %cmp36, label %for.cond, label %for.end
...
for.end:                                          ; preds = %for.cond
  ...
  %7 = load ptr, ptr %osucc46, align 8
...
cond.false77:                                     ; preds = %cond.end.thread, %cond.end
  ...
  store ptr %15, ptr %osucc92, align 8
  ...
  store ptr %19, ptr %osucc98, align 8
  br label %cond.end101

cond.end101:                                      ; preds = %cond.end, %cond.false77
  %21 = load i8, ptr %ou133.le, align 8
...
if.else113:                                       ; preds = %entry
  ...
  %26 = load ptr, ptr %act, align 8
  %link.0.in994 = getelementptr inbounds %struct.LIST, ptr %26, i64 0, i32 1
  %link.0995 = load ptr, ptr %link.0.in994, align 8
...
for.cond120:                                      ; preds = %for.end138
  ...
  br i1 %cmp121.not, label %for.end150, label %for.cond127.preheader
...
for.cond127:                                      ; preds = %for.cond127.preheader, %for.cond127
  ...
  %27 = load i8, ptr %ou1128, align 8
  %cmp131 = icmp eq i8 %27, 0
  br i1 %cmp131, label %for.cond127, label %for.end138
...
for.end138:                                       ; preds = %for.cond127
  ...
  br i1 %tobool143.not, label %for.cond120, label %for.end150
...
if.end155:                                        ; preds = %if.then153, %for.end150
  ...
  %30 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 2), align 1
  %conv156 = zext i8 %30 to i32
  store i32 %conv156, ptr @zz_size, align 4
  %conv157 = zext i8 %30 to i64
  %arrayidx164 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv157
  %31 = load ptr, ptr %arrayidx164, align 8
...
if.then167:                                       ; preds = %if.end155
  ...
  store ptr %call168, ptr @zz_hold, align 8
  br label %if.end178

if.else169:                                       ; preds = %if.end155
  store ptr %31, ptr @zz_hold, align 8
  %33 = load ptr, ptr %31, align 8
  store ptr %33, ptr %arrayidx164, align 8
  br label %if.end178
...
if.end178:                                        ; preds = %if.then167, %if.else169
  ...
  store ptr %34, ptr %osucc183, align 8
  store ptr %34, ptr %arrayidx182, align 8
  %osucc189 = getelementptr inbounds %struct.LIST, ptr %34, i64 0, i32 1
  store ptr %34, ptr %osucc189, align 8
  store ptr %34, ptr %34, align 8
  %oactual193 = getelementptr inbounds %struct.closure_type, ptr %34, i64 0, i32 5
  store ptr %y.31002, ptr %oactual193, align 8
  %35 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 10), align 1
  %conv194 = zext i8 %35 to i32
  store i32 %conv194, ptr @zz_size, align 4
  %conv195 = zext i8 %35 to i64
  %arrayidx202 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv195
  %36 = load ptr, ptr %arrayidx202, align 8
...
if.then205:                                       ; preds = %if.end178
  ...
  store ptr %call206, ptr @zz_hold, align 8
  br label %if.end216

if.else207:                                       ; preds = %if.end178
  store ptr %36, ptr @zz_hold, align 8
  %38 = load ptr, ptr %36, align 8
  store ptr %38, ptr %arrayidx202, align 8
  br label %if.end216
...
if.end216:                                        ; preds = %if.then205, %if.else207
  ...
  store i8 10, ptr %ou1217, align 8
  ...
  store ptr %39, ptr %osucc221, align 8
  store ptr %39, ptr %arrayidx220, align 8
  %osucc227 = getelementptr inbounds %struct.LIST, ptr %39, i64 0, i32 1
  store ptr %39, ptr %osucc227, align 8
...
if.else246:                                       ; preds = %if.end216
  ...
  %43 = load ptr, ptr %41, align 8
  store ptr %43, ptr %arrayidx241, align 8
  br label %cond.end301
...
cond.end301:                                      ; preds = %if.then244, %if.else246
  ...
  store ptr %47, ptr %osucc292, align 8
  %50 = load ptr, ptr @zz_tmp, align 8
  store ptr %50, ptr %48, align 8
  %51 = load ptr, ptr @zz_res, align 8
  %52 = load ptr, ptr @zz_tmp, align 8
  %osucc298 = getelementptr inbounds %struct.LIST, ptr %52, i64 0, i32 1
  store ptr %51, ptr %osucc298, align 8
...
cond.false310:                                    ; preds = %cond.end301
  ...
  %55 = load ptr, ptr %arrayidx315, align 8
  store ptr %55, ptr %arrayidx220, align 8
  %56 = load ptr, ptr %arrayidx315, align 8
  %osucc325 = getelementptr inbounds [2 x %struct.LIST], ptr %56, i64 0, i64 1, i32 1
  store ptr %39, ptr %osucc325, align 8
  store ptr %54, ptr %arrayidx315, align 8
  %osucc331 = getelementptr inbounds [2 x %struct.LIST], ptr %54, i64 0, i64 1, i32 1
  store ptr %53, ptr %osucc331, align 8
...
if.else349:                                       ; preds = %cond.end334
  ...
  store ptr %60, ptr %arrayidx344, align 8
  br label %cond.end404
...
cond.false413:                                    ; preds = %cond.end404
  ...
  %71 = load ptr, ptr %arrayidx415, align 8
  ...
  store ptr %72, ptr %arrayidx415, align 8
  %73 = load ptr, ptr %arrayidx418, align 8
  %osucc428 = getelementptr inbounds [2 x %struct.LIST], ptr %73, i64 0, i64 1, i32 1
  store ptr %call114, ptr %osucc428, align 8
  store ptr %71, ptr %arrayidx418, align 8
  %osucc434 = getelementptr inbounds [2 x %struct.LIST], ptr %71, i64 0, i64 1, i32 1
  store ptr %70, ptr %osucc434, align 8
  br label %cond.end437

cond.end437:                                      ; preds = %cond.end404, %cond.false413
  %74 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 10), align 1
  %conv439 = zext i8 %74 to i32
  store i32 %conv439, ptr @zz_size, align 4
...
if.end461:                                        ; preds = %if.then450, %if.else452
  ...
  store i8 10, ptr %ou1462, align 8
  ...
  store ptr %78, ptr %osucc466, align 8
  store ptr %78, ptr %arrayidx465, align 8
  %osucc472 = getelementptr inbounds %struct.LIST, ptr %78, i64 0, i32 1
  store ptr %78, ptr %osucc472, align 8
  ...
  store ptr %call476, ptr %oactual477, align 8
  %79 = load i8, ptr @zz_lengths, align 1
  %conv478 = zext i8 %79 to i32
  store i32 %conv478, ptr @zz_size, align 4
  %conv479 = zext i8 %79 to i64
  %arrayidx486 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv479
  %80 = load ptr, ptr %arrayidx486, align 8
...
if.else491:                                       ; preds = %if.end461
  ...
  store ptr %82, ptr %arrayidx486, align 8
  br label %cond.end546
...
cond.end546:                                      ; preds = %if.then489, %if.else491
  ...
  %86 = load ptr, ptr @zz_hold, align 8
  %87 = load ptr, ptr @zz_res, align 8
  %88 = load ptr, ptr %87, align 8
  %osucc537 = getelementptr inbounds %struct.LIST, ptr %88, i64 0, i32 1
  store ptr %86, ptr %osucc537, align 8
  %89 = load ptr, ptr @zz_tmp, align 8
  store ptr %89, ptr %87, align 8
  %90 = load ptr, ptr @zz_res, align 8
  %91 = load ptr, ptr @zz_tmp, align 8
  %osucc543 = getelementptr inbounds %struct.LIST, ptr %91, i64 0, i32 1
  store ptr %90, ptr %osucc543, align 8
  %92 = load ptr, ptr @xx_link, align 8
...
if.else594:                                       ; preds = %cond.end579
  ...
  store ptr %99, ptr %arrayidx589, align 8
  br label %cond.end649
...
if.else734:                                       ; preds = %if.end706
  ...
  store ptr %121, ptr %arrayidx729, align 8
  br label %cond.end789
...
if.else837:                                       ; preds = %cond.end822
  ...
  store ptr %138, ptr %arrayidx832, align 8
  br label %cond.end892
...
cond.false901:                                    ; preds = %cond.end892
  ...
  %150 = load ptr, ptr %arrayidx903, align 8
  store ptr %150, ptr @zz_tmp, align 8
  %arrayidx906 = getelementptr inbounds [2 x %struct.LIST], ptr %148, i64 0, i64 1
  %151 = load ptr, ptr %arrayidx906, align 8
  store ptr %151, ptr %arrayidx903, align 8
  %152 = load ptr, ptr %arrayidx906, align 8
  %osucc916 = getelementptr inbounds [2 x %struct.LIST], ptr %152, i64 0, i64 1, i32 1
  store ptr %149, ptr %osucc916, align 8
  store ptr %150, ptr %arrayidx906, align 8
  %osucc922 = getelementptr inbounds [2 x %struct.LIST], ptr %150, i64 0, i64 1, i32 1
  store ptr %148, ptr %osucc922, align 8
  br label %if.end927
...
entry:
  ...
  %link.0739 = load ptr, ptr %link.0.in738, align 8
...
for.cond:                                         ; preds = %for.end
  ...
  br i1 %cmp.not, label %if.then19, label %for.cond4.preheader
...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.cond4
  ...
  %sym.1 = load ptr, ptr %sym.1.in, align 8
  %ou1 = getelementptr inbounds %struct.word_type, ptr %sym.1, i64 0, i32 1
  %1 = load i8, ptr %ou1, align 8
  %cmp5 = icmp eq i8 %1, 0
  br i1 %cmp5, label %for.cond4, label %for.end
...
if.end20:                                         ; preds = %for.end, %if.then19
  ...
  %link.1746 = load ptr, ptr %link.1.in745, align 8
...
for.inc58:                                        ; preds = %for.cond31, %sw.bb48, %if.then54, %sw.bb
  ...
  br i1 %cmp25.not, label %for.end62, label %for.cond31.preheader
...
if.end68:                                         ; preds = %if.then65, %for.end62
  ...
  %6 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 2), align 1
...
if.then78:                                        ; preds = %if.end68
  ...
  store ptr %call79, ptr @zz_hold, align 8
  br label %if.end89

if.else80:                                        ; preds = %if.end68
  store ptr %7, ptr @zz_hold, align 8
  %9 = load ptr, ptr %7, align 8
  store ptr %9, ptr %arrayidx75, align 8
  br label %if.end89
...
if.end89:                                         ; preds = %if.then78, %if.else80
  ...
  store ptr %10, ptr %osucc94, align 8
  store ptr %10, ptr %arrayidx93, align 8
  %osucc100 = getelementptr inbounds %struct.LIST, ptr %10, i64 0, i32 1
  store ptr %10, ptr %osucc100, align 8
  store ptr %10, ptr %10, align 8
  ...
  store ptr %sym.2728, ptr %oactual123, align 8
  %12 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 10), align 1
  %conv124 = zext i8 %12 to i32
  store i32 %conv124, ptr @zz_size, align 4
  %conv125 = zext i8 %12 to i64
  %arrayidx132 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv125
  %13 = load ptr, ptr %arrayidx132, align 8
...
if.then135:                                       ; preds = %if.end89
  ...
  store ptr %call136, ptr @zz_hold, align 8
  br label %if.end146
...
if.end146:                                        ; preds = %if.then135, %if.else137
  ...
  store i8 10, ptr %ou1147, align 8
  ...
  store ptr %16, ptr %osucc151, align 8
  store ptr %16, ptr %arrayidx150, align 8
  %osucc157 = getelementptr inbounds %struct.LIST, ptr %16, i64 0, i32 1
  store ptr %16, ptr %osucc157, align 8
  store ptr %16, ptr %16, align 8
  %17 = load i16, ptr %ofile_num, align 2
  %ofile_num164 = getelementptr inbounds %struct.word_type, ptr %16, i64 0, i32 1, i32 0, i32 2
  store i16 %17, ptr %ofile_num164, align 2
...
if.else200:                                       ; preds = %if.end146
  ...
  store ptr %21, ptr %arrayidx195, align 8
  br label %cond.end251
...
cond.end251:                                      ; preds = %if.then198, %if.else200
  ...
  store ptr %25, ptr %osucc244, align 8
  ...
  store ptr %29, ptr %osucc250, align 8
...
if.else301:                                       ; preds = %cond.end284
  store ptr %36, ptr @zz_hold, align 8
  %38 = load ptr, ptr %36, align 8
  store ptr %38, ptr %arrayidx296, align 8
  br label %cond.end356
...
cond.end356:                                      ; preds = %if.then299, %if.else301
  ...
  store ptr %42, ptr %osucc347, align 8
  %45 = load ptr, ptr @zz_tmp, align 8
  store ptr %45, ptr %43, align 8
  %46 = load ptr, ptr @zz_res, align 8
  %47 = load ptr, ptr @zz_tmp, align 8
  %osucc353 = getelementptr inbounds %struct.LIST, ptr %47, i64 0, i32 1
  store ptr %46, ptr %osucc353, align 8
  %48 = load ptr, ptr @xx_link, align 8
  store ptr %48, ptr @zz_res, align 8
  store ptr %call287, ptr @zz_hold, align 8
...
cond.false365:                                    ; preds = %cond.end356
  ...
  %49 = load ptr, ptr %arrayidx367, align 8
  store ptr %49, ptr @zz_tmp, align 8
  %arrayidx370 = getelementptr inbounds [2 x %struct.LIST], ptr %48, i64 0, i64 1
  %50 = load ptr, ptr %arrayidx370, align 8
  store ptr %50, ptr %arrayidx367, align 8
  %51 = load ptr, ptr %arrayidx370, align 8
  %osucc380 = getelementptr inbounds [2 x %struct.LIST], ptr %51, i64 0, i64 1, i32 1
  store ptr %call287, ptr %osucc380, align 8
  store ptr %49, ptr %arrayidx370, align 8
  %osucc386 = getelementptr inbounds [2 x %struct.LIST], ptr %49, i64 0, i64 1, i32 1
  store ptr %48, ptr %osucc386, align 8
...
cond.end389:                                      ; preds = %cond.end356, %cond.false365
  ...
  %52 = load ptr, ptr %osucc393, align 8
  br label %for.cond397

for.cond397:                                      ; preds = %for.cond397, %cond.end389
  %.pn719 = phi ptr [ %52, %cond.end389 ], [ %y.1, %for.cond397 ]
  %y.1.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn719, i64 0, i64 1
  %y.1 = load ptr, ptr %y.1.in, align 8
  %ou1398 = getelementptr inbounds %struct.word_type, ptr %y.1, i64 0, i32 1
  %53 = load i8, ptr %ou1398, align 8
...
if.end416:                                        ; preds = %for.cond397, %if.then414
  ...
  %55 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 81), align 1
  %conv420 = zext i8 %55 to i32
  store i32 %conv420, ptr @zz_size, align 4
  %conv421 = zext i8 %55 to i64
  %arrayidx428 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv421
  %56 = load ptr, ptr %arrayidx428, align 8
...
if.then431:                                       ; preds = %if.end416
  ...
  store ptr %call432, ptr @zz_hold, align 8
  br label %if.end442

if.else433:                                       ; preds = %if.end416
  store ptr %56, ptr @zz_hold, align 8
  %58 = load ptr, ptr %56, align 8
  store ptr %58, ptr %arrayidx428, align 8
  br label %if.end442
...
if.else470:                                       ; preds = %if.end442
  store ptr %61, ptr @zz_hold, align 8
  %63 = load ptr, ptr %61, align 8
  store ptr %63, ptr %arrayidx465, align 8
  br label %cond.end525
...
cond.end525:                                      ; preds = %if.then468, %if.else470
  ...
  store ptr %67, ptr %osucc516, align 8
  ...
  store ptr %71, ptr %osucc522, align 8
...
cond.end558:                                      ; preds = %cond.end525, %cond.false534
  ...
  %78 = load ptr, ptr %arrayidx568, align 8
...
if.else573:                                       ; preds = %cond.end558
  store ptr %78, ptr @zz_hold, align 8
  %80 = load ptr, ptr %78, align 8
  store ptr %80, ptr %arrayidx568, align 8
  br label %cond.end628
...
cond.end628:                                      ; preds = %if.then571, %if.else573
  ...
  store ptr %84, ptr %osucc619, align 8
  %87 = load ptr, ptr @zz_tmp, align 8
  store ptr %87, ptr %85, align 8
  %88 = load ptr, ptr @zz_res, align 8
  %89 = load ptr, ptr @zz_tmp, align 8
  %osucc625 = getelementptr inbounds %struct.LIST, ptr %89, i64 0, i32 1
  store ptr %88, ptr %osucc625, align 8
  %90 = load ptr, ptr @xx_link, align 8
  store ptr %90, ptr @zz_res, align 8
  store ptr %call419, ptr @zz_hold, align 8
...
cond.false637:                                    ; preds = %cond.end628
  ...
  %91 = load ptr, ptr %arrayidx639, align 8
  store ptr %91, ptr @zz_tmp, align 8
  %arrayidx642 = getelementptr inbounds [2 x %struct.LIST], ptr %90, i64 0, i64 1
  %92 = load ptr, ptr %arrayidx642, align 8
  store ptr %92, ptr %arrayidx639, align 8
  %93 = load ptr, ptr %arrayidx642, align 8
  %osucc652 = getelementptr inbounds [2 x %struct.LIST], ptr %93, i64 0, i64 1, i32 1
  store ptr %call419, ptr %osucc652, align 8
  store ptr %91, ptr %arrayidx642, align 8
  %osucc658 = getelementptr inbounds [2 x %struct.LIST], ptr %91, i64 0, i64 1, i32 1
  store ptr %90, ptr %osucc658, align 8
