...
if.then1961:                                      ; preds = %if.end1951
  ...
  %.pre8077 = load ptr, ptr @FillObject.hyph_word, align 8, !tbaa !8
  br label %if.end1996
...
cond.end4601.cond.false4610_crit_edge:            ; preds = %cond.end4601
  ...
  %.pre8078 = load ptr, ptr %arrayidx4615.phi.trans.insert, align 8, !tbaa !5
...
cond.false4642:                                   ; preds = %cond.end4634
  ...
  %.pre8079 = load ptr, ptr @xx_link, align 8, !tbaa !8
...
cond.end4955:                                     ; preds = %if.end4906
  ...
  store ptr %.pre8081, ptr @zz_res, align 8, !tbaa !8
  store ptr %x.addr.0, ptr @zz_hold, align 8, !tbaa !8
...
if.then5156:                                      ; preds = %if.end5147
  ...
  %.pre8087 = load ptr, ptr %254, align 8, !tbaa !5
  br label %if.end5158
...
cond.false5198:                                   ; preds = %cond.end5190
  ...
  %.pre8088 = load ptr, ptr @xx_link, align 8, !tbaa !8
...
if.then5290:                                      ; preds = %for.cond5267, %land.lhs.true5284
  ...
  %.pre8082 = load ptr, ptr %y.10, align 8, !tbaa !5
  br label %if.end5292
...
cond.false5332:                                   ; preds = %cond.end5324
  ...
  %.pre8083 = load ptr, ptr @xx_link, align 8, !tbaa !8
...
if.then5417:                                      ; preds = %for.cond5400
  ...
  %.pre8084 = load ptr, ptr %y.10, align 8, !tbaa !5
  br label %if.end5419
...
cond.false5459:                                   ; preds = %cond.end5451
  ...
  %.pre8085 = load ptr, ptr @xx_link, align 8, !tbaa !8
...
if.end5521:                                       ; preds = %if.end5521.sink.split, %cond.end5481, %cond.end5220
  ...
  %.pre8091.pre8096 = load ptr, ptr %254, align 8, !tbaa !5
...
if.end5565:                                       ; preds = %for.cond5546, %if.then5563
  ...
  %.pre8091.pre = load ptr, ptr %254, align 8, !tbaa !5
  br label %if.end5570
...
if.then5586:                                      ; preds = %land.lhs.true5577
  %550 = load ptr, ptr %.pre8091, align 8, !tbaa !5
...
for.cond5596:                                     ; preds = %for.cond5596, %if.then5586
  ...
  %551 = load i8, ptr %ou15597, align 8, !tbaa !5
...
if.end5615:                                       ; preds = %for.cond5596, %if.then5613
  ...
  %.pre8090 = load ptr, ptr %254, align 8, !tbaa !5
  br label %if.end5620
...
if.then5626:                                      ; preds = %if.end5620
  ...
  %.pre8092 = load ptr, ptr %254, align 8, !tbaa !5
...
for.cond5635:                                     ; preds = %for.cond5635.preheader, %for.cond5635
  ...
  %555 = load i8, ptr %ou15636, align 8, !tbaa !5
...
for.cond5657:                                     ; preds = %for.cond5657.preheader, %for.cond5657
  ...
  %556 = load i8, ptr %ou15658, align 8, !tbaa !5
...
if.end5720:                                       ; preds = %cond.true5691, %cond.false5694, %if.then5718
  ...
  %559 = load i32, ptr %ou35721, align 8, !tbaa !5
...
for.cond5734:                                     ; preds = %for.cond5734.preheader, %for.cond5734
  ...
  %560 = load i8, ptr %ou15735, align 8, !tbaa !5
...
for.cond5824:                                     ; preds = %for.cond5824.preheader, %for.cond5824
  ...
  %566 = load i8, ptr %ou15825, align 8, !tbaa !5
...
if.then5878:                                      ; preds = %if.then5875
  %568 = load ptr, ptr @no_fpos, align 8, !tbaa !8
...
while.end5888:                                    ; preds = %for.inc5793, %while.body5801, %for.end5887, %for.inc5883, %if.end5720, %for.end5797
  ...
  %569 = load i32, ptr %ofwd5890, align 8, !tbaa !5
  ...
  %570 = load i32, ptr %ou35903, align 8, !tbaa !5
...
if.end5923:                                       ; preds = %while.end5888, %if.then5915, %cond.end2987, %cond.false2996, %if.then2807
  ...
  %571 = load i32, ptr %hyph_used, align 4, !tbaa !10
...
land.lhs.true5925:                                ; preds = %if.end5923
  ...
  %572 = load i8, ptr %ou15926, align 8, !tbaa !5
...
for.cond5935.preheader:                           ; preds = %land.lhs.true5925
  ...
  %link.87957 = load ptr, ptr %link.8.in7956, align 8, !tbaa !5
...
for.cond5942:                                     ; preds = %for.cond5942.preheader, %for.cond5942
  ...
  %573 = load i8, ptr %ou15943, align 8, !tbaa !5
...
for.cond5963.preheader:                           ; preds = %for.cond5942
  ...
  %ylink.07953 = load ptr, ptr %ylink.0.in7952, align 8, !tbaa !5
...
for.cond5970:                                     ; preds = %for.cond5970.preheader, %for.cond5970
  ...
  %574 = load i8, ptr %ou15971, align 8, !tbaa !5
...
land.lhs.true5987:                                ; preds = %for.cond5970
  ...
  %575 = load i16, ptr %owidth5989, align 2, !tbaa !5
...
if.then6000:                                      ; preds = %land.lhs.true5993
  %576 = load ptr, ptr %ylink.07955, align 8, !tbaa !5
...
for.cond6007:                                     ; preds = %for.cond6007, %if.then6000
  ...
  %577 = load i8, ptr %ou16008, align 8, !tbaa !5
...
for.end6018:                                      ; preds = %for.cond6007
  ...
  %578 = load ptr, ptr %osucc6021, align 8, !tbaa !5
...
for.cond6025:                                     ; preds = %for.cond6025, %for.end6018
  ...
  %579 = load i8, ptr %ou16026, align 8, !tbaa !5
  %.fr = freeze i8 %579
...
if.then6113:                                      ; preds = %land.lhs.true6060
  ...
  store ptr %ylink.07955, ptr @zz_hold, align 8, !tbaa !8
  ...
  %.pre8093 = load ptr, ptr %arrayidx6230.phi.trans.insert, align 8, !tbaa !5
...
cond.false6194:                                   ; preds = %if.then6113
  ...
  store ptr %.pre8093, ptr %arrayidx6202, align 8, !tbaa !5
  %585 = load ptr, ptr %arrayidx6230.phi.trans.insert, align 8, !tbaa !5
  %osucc6209 = getelementptr inbounds [2 x %struct.LIST], ptr %585, i64 0, i64 1, i32 1
  store ptr %584, ptr %osucc6209, align 8, !tbaa !5
  store ptr %ylink.07955, ptr %osucc6190, align 8, !tbaa !5
  store ptr %ylink.07955, ptr %arrayidx6230.phi.trans.insert, align 8, !tbaa !5
...
cond.end6249:                                     ; preds = %if.then6113, %cond.false6194
  ...
  store ptr %ylink.07955, ptr @zz_res, align 8, !tbaa !8
  ...
  %588 = load ptr, ptr %arrayidx6230, align 8, !tbaa !5
  ...
  store ptr %587, ptr %arrayidx6230, align 8, !tbaa !5
  %osucc6246 = getelementptr inbounds [2 x %struct.LIST], ptr %587, i64 0, i64 1, i32 1
  store ptr %ylink.07955, ptr %osucc6246, align 8, !tbaa !5
...
cond.false6260:                                   ; preds = %cond.end6249
  ...
  store ptr %589, ptr %arrayidx6265, align 8, !tbaa !5
...
cond.false6361:                                   ; preds = %if.end6351
  ...
  store ptr %605, ptr %arrayidx6366, align 8, !tbaa !5
...
cond.false6391:                                   ; preds = %cond.end6383
  ...
  %.pre8095 = load ptr, ptr @xx_link, align 8, !tbaa !8
