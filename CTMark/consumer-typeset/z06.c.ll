; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z06.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z06.c"
...
for.cond:                                         ; preds = %for.cond, %if.end
  ...
  %s2.0 = load ptr, ptr %s2.0.in, align 8
  %ou15 = getelementptr inbounds %struct.word_type, ptr %s2.0, i64 0, i32 1
  %3 = load i8, ptr %ou15, align 8
  %cmp8 = icmp eq i8 %3, 0
  br i1 %cmp8, label %for.cond, label %for.end

for.end:                                          ; preds = %for.cond
  store i32 1, ptr %all_literals, align 4
  store ptr null, ptr %res_yield, align 8
...
for.cond27.preheader:                             ; preds = %for.end
  ...
  %link.0204 = load ptr, ptr %link.0.in203, align 8
...
if.then18:                                        ; preds = %for.end
  ...
  %.pre210 = load i32, ptr %all_literals, align 4
  br label %if.end68
...
for.inc61:                                        ; preds = %for.cond34, %if.then58
  ...
  br i1 %7, label %for.cond34.preheader, label %if.end68
...
cond.end148:                                      ; preds = %cond.end, %cond.false126
  ...
  %cond169.in = load i8, ptr %cond169.in.in, align 1
  %cond169 = zext i8 %cond169.in to i32
  store i32 %cond169, ptr @zz_size, align 4
  %idxprom170 = zext i8 %cond169.in to i64
  %arrayidx171 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom170
  %23 = load ptr, ptr %arrayidx171, align 8
  store ptr %23, ptr %21, align 8
  %24 = load ptr, ptr @zz_hold, align 8
  %25 = load i32, ptr @zz_size, align 4
...
for.cond:                                         ; preds = %for.cond, %entry
  ...
  %s1.0 = load ptr, ptr %s1.0.in, align 8
...
for.cond39.preheader:                             ; preds = %for.cond
  ...
  %link.0134 = load ptr, ptr %link.0.in133, align 8
...
if.then25:                                        ; preds = %lor.lhs.false19, %if.then
  %4 = load ptr, ptr %res_yield, align 8
...
for.inc97:                                        ; preds = %for.cond46, %if.then89, %if.then92, %lor.lhs.false83
  ...
  br i1 %cmp40.not, label %if.end104, label %for.cond46.preheader

if.end104.sink.split.sink.split:                  ; preds = %for.cond, %for.cond46
  store i32 0, ptr %all_literals, align 4
...
if.end104.sink.split:                             ; preds = %if.end104.sink.split.sink.split, %if.then25
  ...
  store ptr %.sink, ptr %res_yield, align 8
  br label %if.end104
...
for.cond:                                         ; preds = %if.end, %for.cond
  ...
  %3 = load i8, ptr %ou111, align 8
  %cmp14 = icmp eq i8 %3, 0
  br i1 %cmp14, label %for.cond, label %for.end

for.end:                                          ; preds = %for.cond
  %4 = load ptr, ptr %y.0, align 8
  %cmp22.not = icmp eq ptr %4, %y.0
  br i1 %cmp22.not, label %if.then24, label %if.end26

if.then24:                                        ; preds = %for.end
  %5 = load ptr, ptr @no_fpos, align 8
...
for.cond44:                                       ; preds = %for.cond44.preheader, %for.cond44
  ...
  %yenv.0 = load ptr, ptr %yenv.0.in, align 8
...
if.then61:                                        ; preds = %for.cond44
  %10 = load ptr, ptr @no_fpos, align 8
...
if.then:                                          ; preds = %entry
  %0 = load ptr, ptr @no_fpos, align 8
...
if.end:                                           ; preds = %if.then, %entry
  ...
  store ptr %call2, ptr @cross_name, align 8
  %2 = load i32, ptr @ttop, align 4
  %inc = add nsw i32 %2, 1
  store i32 %inc, ptr @ttop, align 4
  %cmp3 = icmp slt i32 %2, 99
  br i1 %cmp3, label %if.then4, label %if.else

if.then4:                                         ; preds = %if.end
  %3 = load ptr, ptr @no_fpos, align 8
  %4 = load ptr, ptr @StartSym, align 8
...
if.then121:                                       ; preds = %if.end117
  ...
  store ptr %5, ptr %arrayidx123, align 8
  br label %if.end130
...
if.else124:                                       ; preds = %if.end117
  ...
  %6 = load ptr, ptr %arrayidx127, align 8
...
if.end130:                                        ; preds = %if.else124, %if.then121
  ...
  store ptr %call131, ptr %t, align 8
...
if.then279:                                       ; preds = %if.end266, %if.end266
  ...
  %22 = load ptr, ptr %osucc282, align 8
...
if.end307:                                        ; preds = %if.then304, %if.then300
  ...
  %26 = load ptr, ptr %res_env, align 8
  ...
  store ptr %call308, ptr %env, align 8
  br label %if.end335
...
if.then322:                                       ; preds = %if.then319
  ...
  %.pre = load ptr, ptr %oactual, align 8
  br label %if.end327
...
if.end327:                                        ; preds = %if.then322, %if.then319
  ...
  store ptr %call267, ptr %ouse_invocation329, align 8
  ...
  store ptr %call330, ptr %env, align 8
  br label %if.end335
...
if.then439:                                       ; preds = %for.end437
  ...
  store ptr %call443, ptr @NewCrossDb, align 8
  %46 = load ptr, ptr @cross_name, align 8
  %47 = load i32, ptr @InMemoryDbIndexes, align 4
...
sw.bb:                                            ; preds = %for.cond449
  ...
  %51 = load i8, ptr %ostring453, align 8
...
if.then471:                                       ; preds = %lor.lhs.false461, %land.lhs.true458
  ...
  %54 = load i32, ptr @unknown_count, align 4
  %inc476 = add nsw i32 %54, 1
  store i32 %inc476, ptr @unknown_count, align 4
...
if.end483.if.then485_crit_edge:                   ; preds = %if.end483
  %.pre8316 = load ptr, ptr %t, align 8
  %ohspace489.phi.trans.insert = getelementptr inbounds i8, ptr %.pre8316, i64 41
  %.pre8317 = load i8, ptr %ohspace489.phi.trans.insert, align 1
  %ovspace492.phi.trans.insert = getelementptr inbounds i8, ptr %.pre8316, i64 42
  %.pre8318 = load i8, ptr %ovspace492.phi.trans.insert, align 2
  %.pre8321 = zext i8 %.pre8317 to i32
  %.pre8322 = zext i8 %.pre8318 to i32
  br label %if.then485

if.then485:                                       ; preds = %if.end483.if.then485_crit_edge, %lor.lhs.false461
  %conv493.pre-phi = phi i32 [ %.pre8322, %if.end483.if.then485_crit_edge ], [ %conv464, %lor.lhs.false461 ]
  %conv490.pre-phi = phi i32 [ %.pre8321, %if.end483.if.then485_crit_edge ], [ %conv467, %lor.lhs.false461 ]
  %56 = phi ptr [ %.pre8316, %if.end483.if.then485_crit_edge ], [ %49, %lor.lhs.false461 ]
...
if.then540:                                       ; preds = %if.then526
  ...
  store ptr %call541, ptr @zz_hold, align 8
  %.pre8319 = load i32, ptr @ttop, align 4
  br label %if.end551

if.else542:                                       ; preds = %if.then526
  store ptr %62, ptr @zz_hold, align 8
  %64 = load ptr, ptr %62, align 8
  store ptr %64, ptr %arrayidx537, align 8
  br label %if.end551

if.end551:                                        ; preds = %if.then540, %if.else542
  %65 = phi i32 [ %.pre8319, %if.then540 ], [ %58, %if.else542 ]
  ...
  store i32 %inc611, ptr @ttop, align 4
...
if.then614:                                       ; preds = %if.end551
  ...
  store ptr %66, ptr %arrayidx616, align 8
  br label %if.end625
...
if.else617:                                       ; preds = %if.end551
  ...
  %71 = load ptr, ptr %arrayidx620, align 8
...
if.end625:                                        ; preds = %while.body522, %if.else617, %if.then614, %if.end483
  ...
  %73 = load i32, ptr @otop, align 4
  %inc626 = add nsw i32 %73, 1
  store i32 %inc626, ptr @otop, align 4
...
if.then629:                                       ; preds = %if.end625
  ...
  store ptr %72, ptr %arrayidx631, align 8
  br label %if.end638
...
if.else632:                                       ; preds = %if.end625
  ...
  %74 = load ptr, ptr %arrayidx635, align 8
...
if.end638:                                        ; preds = %if.else632, %if.then629
  ...
  store ptr %call639, ptr %t, align 8
...
if.end708:                                        ; preds = %if.then697, %if.else699
  ...
  store i32 %inc768, ptr @ttop, align 4
...
if.then771:                                       ; preds = %if.end708
  ...
  store ptr %87, ptr %arrayidx773, align 8
  br label %if.end782
...
if.else774:                                       ; preds = %if.end708
  ...
  %92 = load ptr, ptr %arrayidx777, align 8
...
if.end782:                                        ; preds = %while.body679, %if.else774, %if.then771, %sw.bb640
  ...
  %94 = load i32, ptr @otop, align 4
  %inc783 = add nsw i32 %94, 1
  store i32 %inc783, ptr @otop, align 4
...
if.then786:                                       ; preds = %if.end782
  ...
  store ptr %93, ptr %arrayidx788, align 8
  br label %if.end795
...
if.else789:                                       ; preds = %if.end782
  ...
  %95 = load ptr, ptr %arrayidx792, align 8
...
if.end795:                                        ; preds = %if.else789, %if.then786
  ...
  store ptr %call796, ptr %t, align 8
  br label %for.cond449.backedge
...
if.then800:                                       ; preds = %for.cond798
  ...
  store ptr %call802, ptr @zz_hold, align 8
  %97 = load i32, ptr @otop, align 4
  %inc803 = add nsw i32 %97, 1
  store i32 %inc803, ptr @otop, align 4
...
if.then806:                                       ; preds = %if.then800
  ...
  store ptr %call802, ptr %arrayidx808, align 8
...
if.else809:                                       ; preds = %if.then800
  ...
  %98 = load ptr, ptr %arrayidx812, align 8
...
for.end839:                                       ; preds = %if.else816
  ...
  store i32 %inc840, ptr @ttop, align 4
...
if.then843:                                       ; preds = %for.end839
  ...
  store ptr %102, ptr %arrayidx845, align 8
  br label %if.end852
...
land.lhs.true854:                                 ; preds = %if.end852
  ...
  %107 = load i8, ptr %ou1855, align 8
...
land.lhs.true860:                                 ; preds = %land.lhs.true854
  ...
  %108 = load ptr, ptr %oactual861, align 8
...
if.end902:                                        ; preds = %if.then891, %if.else893
  ...
  store ptr %119, ptr @zz_hold, align 8
  %122 = load i32, ptr @otop, align 4
  %inc942 = add nsw i32 %122, 1
  store i32 %inc942, ptr @otop, align 4
...
if.then945:                                       ; preds = %if.end902
  ...
  store ptr %119, ptr %arrayidx947, align 8
  br label %if.end955
...
if.else948:                                       ; preds = %if.end902
  ...
  %123 = load ptr, ptr %arrayidx951, align 8
...
if.end978:                                        ; preds = %if.then967, %if.else969
  ...
  %130 = load ptr, ptr %oactual993, align 8
  ...
  %131 = load ptr, ptr %oactual993, align 8
  ...
  %135 = load i32, ptr @ttop, align 4
  %inc1196 = add nsw i32 %135, 1
  store i32 %inc1196, ptr @ttop, align 4
...
if.then1199:                                      ; preds = %if.end978
  ...
  store ptr %128, ptr %arrayidx1201, align 8
  br label %if.end1208
...
if.else1202:                                      ; preds = %if.end978
  ...
  %136 = load ptr, ptr %arrayidx1205, align 8
...
if.end1377:                                       ; preds = %if.end1208
  ...
  store ptr %call1379, ptr @zz_hold, align 8
  %139 = load i32, ptr @otop, align 4
  %inc1380 = add nsw i32 %139, 1
  store i32 %inc1380, ptr @otop, align 4
...
if.then1383:                                      ; preds = %if.end1377
  ...
  store ptr %call1379, ptr %arrayidx1385, align 8
  br label %for.cond449.backedge
...
if.else1386:                                      ; preds = %if.end1377
  ...
  %140 = load ptr, ptr %arrayidx1389, align 8
...
sw.bb1394:                                        ; preds = %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449
  ...
  %141 = load ptr, ptr %oactual1395, align 8
...
if.then1405:                                      ; preds = %for.cond1403
  ...
  store ptr %call1407, ptr @zz_hold, align 8
  %144 = load i32, ptr @otop, align 4
  %inc1408 = add nsw i32 %144, 1
  store i32 %inc1408, ptr @otop, align 4
...
if.then1411:                                      ; preds = %if.then1405
  ...
  store ptr %call1407, ptr %arrayidx1413, align 8
...
if.else1414:                                      ; preds = %if.then1405
  ...
  %145 = load ptr, ptr %arrayidx1417, align 8
...
if.end1514:                                       ; preds = %if.then1503, %if.else1505
  ...
  store i32 %inc1574, ptr @ttop, align 4
...
if.then1577:                                      ; preds = %if.end1514
  ...
  store ptr %165, ptr %arrayidx1579, align 8
  br label %if.end1589
...
if.else1580:                                      ; preds = %if.end1514
  ...
  %170 = load ptr, ptr %arrayidx1583, align 8
...
if.end1589:                                       ; preds = %if.else1421, %while.body1485, %if.else1580, %if.then1577, %if.else1446
  %171 = load i32, ptr @ttop, align 4
  %inc1590 = add nsw i32 %171, 1
  store i32 %inc1590, ptr @ttop, align 4
...
if.then1593:                                      ; preds = %if.end1589
  ...
  store ptr %172, ptr %arrayidx1595, align 8
  br label %if.end1602
...
if.else1596:                                      ; preds = %if.end1589
  ...
  %173 = load ptr, ptr %arrayidx1599, align 8
...
if.else1611:                                      ; preds = %if.end1602
  %call1612 = call fastcc i32 @Reduce()
  %177 = load i32, ptr @ttop, align 4
...
if.then1634:                                      ; preds = %for.cond1632
  ...
  store ptr %call1636, ptr @zz_hold, align 8
  %181 = load i32, ptr @otop, align 4
  %inc1637 = add nsw i32 %181, 1
  store i32 %inc1637, ptr @otop, align 4
...
if.then1640:                                      ; preds = %if.then1634
  ...
  store ptr %call1636, ptr %arrayidx1642, align 8
...
if.else1643:                                      ; preds = %if.then1634
  ...
  %182 = load ptr, ptr %arrayidx1646, align 8
...
if.end1743:                                       ; preds = %if.then1732, %if.else1734
  ...
  store i32 %inc1803, ptr @ttop, align 4
...
if.then1806:                                      ; preds = %if.end1743
  ...
  store ptr %202, ptr %arrayidx1808, align 8
  br label %if.end1818
...
if.else1809:                                      ; preds = %if.end1743
  ...
  %207 = load ptr, ptr %arrayidx1812, align 8
...
if.end1818:                                       ; preds = %if.else1650, %while.body1714, %if.else1809, %if.then1806, %if.else1675
  %208 = load i32, ptr @ttop, align 4
  %inc1819 = add nsw i32 %208, 1
  store i32 %inc1819, ptr @ttop, align 4
...
if.then1822:                                      ; preds = %if.end1818
  ...
  store ptr %209, ptr %arrayidx1824, align 8
  br label %if.end1831
...
if.else1825:                                      ; preds = %if.end1818
  ...
  %210 = load ptr, ptr %arrayidx1828, align 8
...
if.else1841:                                      ; preds = %if.end1831
  %call1842 = call fastcc i32 @Reduce()
  %214 = load i32, ptr @ttop, align 4
...
if.then1863:                                      ; preds = %if.end1850
  ...
  %.pre8310 = load ptr, ptr %t, align 8
  br label %if.end1866

if.end1866:                                       ; preds = %if.end1850, %if.end1850, %if.then1863
  %216 = phi ptr [ %call1851, %if.end1850 ], [ %call1851, %if.end1850 ], [ %.pre8310, %if.then1863 ]
  %217 = load i8, ptr %ou1450, align 8
  ...
  store ptr %cond1875, ptr %oactual1876, align 8
...
if.else1891:                                      ; preds = %if.then1878
  ...
  %222 = load i8, ptr %ou11892, align 8
...
while.body1915:                                   ; preds = %land.rhs1906
  %call1916 = call fastcc i32 @Reduce()
  %tobool1905.not = icmp eq i32 %call1916, 0
  br i1 %tobool1905.not, label %if.end2018, label %land.rhs1906
...
if.end1944:                                       ; preds = %if.then1933, %if.else1935
  ...
  store i32 %inc2004, ptr @ttop, align 4
...
if.then2007:                                      ; preds = %if.end1944
  ...
  store ptr %231, ptr %arrayidx2009, align 8
  br label %if.end2018
...
if.else2010:                                      ; preds = %if.end1944
  ...
  %236 = load ptr, ptr %arrayidx2013, align 8
...
if.end2018:                                       ; preds = %while.body1915, %if.else2010, %if.then2007, %if.end1866
  %237 = load i32, ptr @ttop, align 4
  %inc2019 = add nsw i32 %237, 1
  store i32 %inc2019, ptr @ttop, align 4
...
if.then2022:                                      ; preds = %if.end2018
  ...
  store ptr %238, ptr %arrayidx2024, align 8
  br label %if.end2031
...
if.else2025:                                      ; preds = %if.end2018
  ...
  %239 = load ptr, ptr %arrayidx2028, align 8
...
if.end2031:                                       ; preds = %if.else2025, %if.then2022
  ...
  store ptr %call2043, ptr @zz_hold, align 8
  %243 = load i32, ptr @otop, align 4
  %inc2186 = add nsw i32 %243, 1
  store i32 %inc2186, ptr @otop, align 4
...
if.then2189:                                      ; preds = %if.end2031
  ...
  store ptr %call2043, ptr %arrayidx2191, align 8
  br label %if.end2198
...
if.else2192:                                      ; preds = %if.end2031
  ...
  %244 = load ptr, ptr %arrayidx2195, align 8
...
if.then2212:                                      ; preds = %for.cond2210
  ...
  store ptr %call2214, ptr @zz_hold, align 8
  %248 = load i32, ptr @otop, align 4
  %inc2215 = add nsw i32 %248, 1
  store i32 %inc2215, ptr @otop, align 4
...
if.then2218:                                      ; preds = %if.then2212
  ...
  store ptr %call2214, ptr %arrayidx2220, align 8
...
if.else2221:                                      ; preds = %if.then2212
  ...
  %249 = load ptr, ptr %arrayidx2224, align 8
...
if.end2321:                                       ; preds = %if.then2310, %if.else2312
  ...
  store i32 %inc2381, ptr @ttop, align 4
...
if.then2384:                                      ; preds = %if.end2321
  ...
  store ptr %269, ptr %arrayidx2386, align 8
  br label %if.end2396
...
if.else2387:                                      ; preds = %if.end2321
  ...
  %274 = load ptr, ptr %arrayidx2390, align 8
...
if.end2396:                                       ; preds = %if.else2228, %while.body2292, %if.else2387, %if.then2384, %if.else2253
  %275 = load i32, ptr @ttop, align 4
  %inc2397 = add nsw i32 %275, 1
  store i32 %inc2397, ptr @ttop, align 4
...
if.then2400:                                      ; preds = %if.end2396
  ...
  store ptr %276, ptr %arrayidx2402, align 8
  br label %if.end2409
...
if.else2403:                                      ; preds = %if.end2396
  ...
  %277 = load ptr, ptr %arrayidx2406, align 8
...
if.else2419:                                      ; preds = %if.end2409
  %call2420 = call fastcc i32 @Reduce()
  %281 = load i32, ptr @ttop, align 4
...
if.end2428:                                       ; preds = %if.end2409, %if.else2419
  ...
  store ptr %call2429, ptr %t, align 8
  br label %for.cond449.backedge
...
sw.bb2433:                                        ; preds = %for.cond449
  ...
  %282 = load ptr, ptr %oactual2434, align 8
...
if.then2437:                                      ; preds = %sw.bb2433
  ...
  store i8 102, ptr %ou12440, align 8
  br label %sw.bb2443
...
while.body2482:                                   ; preds = %land.rhs2473
  %call2483 = call fastcc i32 @Reduce()
  %tobool2472.not = icmp eq i32 %call2483, 0
  br i1 %tobool2472.not, label %if.end2585, label %land.rhs2473
...
if.end2511:                                       ; preds = %if.then2500, %if.else2502
  ...
  store i32 %inc2571, ptr @ttop, align 4
...
if.then2574:                                      ; preds = %if.end2511
  ...
  store ptr %295, ptr %arrayidx2576, align 8
  br label %if.end2585
...
if.else2577:                                      ; preds = %if.end2511
  ...
  %300 = load ptr, ptr %arrayidx2580, align 8
...
if.else2592:                                      ; preds = %if.end2585
  ...
  %303 = load ptr, ptr %arrayidx2595, align 8
...
if.then2604:                                      ; preds = %sw.bb2600
  ...
  %305 = load i8, ptr %ou12606, align 8
...
if.then2611:                                      ; preds = %if.then2604
  ...
  %306 = load ptr, ptr %oactual2612, align 8
  %307 = load ptr, ptr %t, align 8
  %oactual2613 = getelementptr inbounds %struct.closure_type, ptr %307, i64 0, i32 5
  store ptr %306, ptr %oactual2613, align 8
  store ptr %call2605, ptr @zz_hold, align 8
  %308 = load i8, ptr %ou12606, align 8
...
if.then2732:                                      ; preds = %land.lhs.true2726
  ...
  store ptr null, ptr %oactual2737, align 8
  store ptr %call2605, ptr @zz_hold, align 8
  %326 = load i8, ptr %ou12606, align 8
...
if.then2780:                                      ; preds = %for.cond2778
  ...
  store ptr %call2782, ptr @zz_hold, align 8
  %332 = load i32, ptr @otop, align 4
  %inc2783 = add nsw i32 %332, 1
  store i32 %inc2783, ptr @otop, align 4
...
if.then2786:                                      ; preds = %if.then2780
  ...
  store ptr %call2782, ptr %arrayidx2788, align 8
...
if.else2789:                                      ; preds = %if.then2780
  ...
  %333 = load ptr, ptr %arrayidx2792, align 8
...
if.then2824:                                      ; preds = %for.end2820
  ...
  store ptr %337, ptr %arrayidx2826, align 8
  br label %if.end2833
...
if.end2833:                                       ; preds = %if.else2827, %if.then2824
  %call2834 = call fastcc i32 @Reduce()
  %341 = load i32, ptr @ttop, align 4
...
cond.end2847:                                     ; preds = %if.end2841, %cond.false2845
  ...
  store ptr %cond2848, ptr %t, align 8
  br label %for.cond449.backedge
...
if.then2852:                                      ; preds = %for.cond2850
  ...
  store ptr %call2854, ptr @zz_hold, align 8
  %343 = load i32, ptr @otop, align 4
  %inc2855 = add nsw i32 %343, 1
  store i32 %inc2855, ptr @otop, align 4
...
if.then2858:                                      ; preds = %if.then2852
  ...
  store ptr %call2854, ptr %arrayidx2860, align 8
...
if.else2861:                                      ; preds = %if.then2852
  ...
  %344 = load ptr, ptr %arrayidx2864, align 8
...
for.end2892:                                      ; preds = %if.else2868
  ...
  store i32 %inc2893, ptr @ttop, align 4
...
if.then2896:                                      ; preds = %for.end2892
  ...
  store ptr %348, ptr %arrayidx2898, align 8
  br label %if.end2905
...
if.end2905:                                       ; preds = %if.else2899, %if.then2896
  %call2906 = call fastcc i32 @Reduce()
  %352 = load i32, ptr @ttop, align 4
...
if.end2913:                                       ; preds = %if.end2905
  ...
  store ptr %call2914, ptr %t, align 8
  br label %for.cond449.backedge
...
sw.bb2915:                                        ; preds = %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449, %for.cond449
  ...
  %353 = load ptr, ptr %oactual2917, align 8
...
if.else2936:                                      ; preds = %if.then2923
  ...
  %356 = load i8, ptr %ou12937, align 8
...
while.body2960:                                   ; preds = %land.rhs2951
  %call2961 = call fastcc i32 @Reduce()
  %tobool2950.not = icmp eq i32 %call2961, 0
  br i1 %tobool2950.not, label %if.end3063, label %land.rhs2951
...
if.end2989:                                       ; preds = %if.then2978, %if.else2980
  ...
  store i32 %inc3049, ptr @ttop, align 4
...
if.then3052:                                      ; preds = %if.end2989
  ...
  store ptr %365, ptr %arrayidx3054, align 8
  br label %if.end3063
...
if.else3055:                                      ; preds = %if.end2989
  ...
  %369 = load ptr, ptr %arrayidx3058, align 8
...
if.end3063:                                       ; preds = %while.body2960, %if.else3055, %if.then3052, %sw.bb2920
  store ptr %call2921, ptr @zz_hold, align 8
  %370 = load i32, ptr @otop, align 4
  %inc3064 = add nsw i32 %370, 1
  store i32 %inc3064, ptr @otop, align 4
...
if.then3067:                                      ; preds = %if.end3063
  ...
  store ptr %call2921, ptr %arrayidx3069, align 8
  br label %if.end3076
...
if.else3070:                                      ; preds = %if.end3063
  ...
  %371 = load ptr, ptr %arrayidx3073, align 8
...
if.end3076:                                       ; preds = %if.else3070, %if.then3067
  ...
  store ptr %call3077, ptr %t, align 8
  br label %for.cond449.backedge
...
sw.bb3078:                                        ; preds = %for.cond449
  ...
  store ptr %376, ptr %arrayidx3113, align 8
  %call3114 = call ptr @LexGetToken() #6
  store ptr %call3114, ptr %t, align 8
  ...
  store ptr %call3116, ptr %env, align 8
...
if.else3131:                                      ; preds = %if.then3118
  ...
  %380 = load i8, ptr %ou13132, align 8
...
while.body3155:                                   ; preds = %land.rhs3146
  %call3156 = call fastcc i32 @Reduce()
  %tobool3145.not = icmp eq i32 %call3156, 0
  br i1 %tobool3145.not, label %if.end3258, label %land.rhs3146
...
if.then3173:                                      ; preds = %if.then3159
  ...
  store ptr %call3174, ptr @zz_hold, align 8
  %.pre8303 = load i32, ptr @ttop, align 4
  br label %if.end3184

if.else3175:                                      ; preds = %if.then3159
  store ptr %385, ptr @zz_hold, align 8
  %387 = load ptr, ptr %385, align 8
  store ptr %387, ptr %arrayidx3170, align 8
  br label %if.end3184

if.end3184:                                       ; preds = %if.then3173, %if.else3175
  %388 = phi i32 [ %.pre8303, %if.then3173 ], [ %381, %if.else3175 ]
  ...
  store i32 %inc3244, ptr @ttop, align 4
...
if.then3247:                                      ; preds = %if.end3184
  ...
  store ptr %389, ptr %arrayidx3249, align 8
  br label %if.end3258
...
if.else3250:                                      ; preds = %if.end3184
  ...
  %394 = load ptr, ptr %arrayidx3253, align 8
...
if.end3258:                                       ; preds = %while.body3155, %if.else3250, %if.then3247, %sw.bb3078
  %395 = load ptr, ptr %env, align 8
  store ptr %395, ptr @zz_hold, align 8
  %396 = load i32, ptr @otop, align 4
  %inc3259 = add nsw i32 %396, 1
  store i32 %inc3259, ptr @otop, align 4
...
if.then3262:                                      ; preds = %if.end3258
  ...
  store ptr %395, ptr %arrayidx3264, align 8
  br label %if.end3271
...
if.else3265:                                      ; preds = %if.end3258
  ...
  %397 = load ptr, ptr %arrayidx3268, align 8
...
if.else3330:                                      ; preds = %if.then3317
  ...
  %410 = load i8, ptr %ou13331, align 8
...
while.body3354:                                   ; preds = %land.rhs3345
  %call3355 = call fastcc i32 @Reduce()
  %tobool3344.not = icmp eq i32 %call3355, 0
  br i1 %tobool3344.not, label %if.end3457, label %land.rhs3345
...
if.end3383:                                       ; preds = %if.then3372, %if.else3374
  ...
  store i32 %inc3443, ptr @ttop, align 4
...
if.then3446:                                      ; preds = %if.end3383
  ...
  store ptr %419, ptr %arrayidx3448, align 8
  br label %if.end3457
...
if.else3449:                                      ; preds = %if.end3383
  ...
  %424 = load ptr, ptr %arrayidx3452, align 8
...
if.end3457:                                       ; preds = %while.body3354, %if.else3449, %if.then3446, %sw.bb3275
  %425 = load ptr, ptr %env, align 8
  store ptr %425, ptr @zz_hold, align 8
  %426 = load i32, ptr @otop, align 4
  %inc3458 = add nsw i32 %426, 1
  store i32 %inc3458, ptr @otop, align 4
...
if.then3461:                                      ; preds = %if.end3457
  ...
  store ptr %425, ptr %arrayidx3463, align 8
  br label %if.end3470
...
if.else3464:                                      ; preds = %if.end3457
  ...
  %427 = load ptr, ptr %arrayidx3467, align 8
...
if.end3470:                                       ; preds = %if.else3464, %if.then3461
  ...
  store ptr %call3471, ptr %t, align 8
  %ofile_num3473 = getelementptr inbounds %struct.word_type, ptr %call3471, i64 0, i32 1, i32 0, i32 2
  %428 = load i16, ptr %ofile_num3473, align 2
  %429 = load i32, ptr %offset, align 4
...
if.end3610:                                       ; preds = %if.then3599, %if.else3601
  ...
  store i32 %inc3670, ptr @ttop, align 4
...
if.then3673:                                      ; preds = %if.end3610
  ...
  store ptr %451, ptr %arrayidx3675, align 8
  br label %if.end3684
...
if.else3676:                                      ; preds = %if.end3610
  ...
  %455 = load ptr, ptr %arrayidx3679, align 8
...
if.end3684:                                       ; preds = %while.body3581, %if.else3676, %if.then3673, %if.end3528
  store ptr %438, ptr @zz_hold, align 8
  %456 = load i32, ptr @otop, align 4
  %inc3685 = add nsw i32 %456, 1
  store i32 %inc3685, ptr @otop, align 4
...
if.then3688:                                      ; preds = %if.end3684
  ...
  store ptr %438, ptr %arrayidx3690, align 8
  br label %for.cond449.backedge
...
if.else3691:                                      ; preds = %if.end3684
  ...
  %457 = load ptr, ptr %arrayidx3694, align 8
...
sw.bb3698:                                        ; preds = %for.cond449
  store ptr %49, ptr @zz_hold, align 8
  %cond3721.in = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 86), align 1
  %cond3721 = zext i8 %cond3721.in to i32
  store i32 %cond3721, ptr @zz_size, align 4
  %idxprom3722 = zext i8 %cond3721.in to i64
  %arrayidx3723 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom3722
  %458 = load ptr, ptr %arrayidx3723, align 8
...
lor.lhs.false3735.if.then3741_crit_edge:          ; preds = %lor.lhs.false3735
  %.pre8299 = load ptr, ptr %t, align 8
  br label %if.then3741

if.then3741:                                      ; preds = %lor.lhs.false3735.if.then3741_crit_edge, %sw.bb3698
  %462 = phi ptr [ %.pre8299, %lor.lhs.false3735.if.then3741_crit_edge ], [ %call3729, %sw.bb3698 ]
...
if.end3744:                                       ; preds = %if.then3741, %lor.lhs.false3735
  %463 = load ptr, ptr %t, align 8
  %ofile_num3746 = getelementptr inbounds %struct.word_type, ptr %463, i64 0, i32 1, i32 0, i32 2
  %464 = load i16, ptr %ofile_num3746, align 2
  %465 = load i32, ptr %offset, align 4
...
if.then3749:                                      ; preds = %if.end3744
  ...
  %467 = load i16, ptr %ofile_num3751, align 2
  %468 = load i32, ptr %offset, align 4
  %469 = load i32, ptr %lnum, align 4
...
if.else3830:                                      ; preds = %if.then3817
  ...
  %482 = load i8, ptr %ou13831, align 8
...
while.body3854:                                   ; preds = %land.rhs3845
  %call3855 = call fastcc i32 @Reduce()
  %tobool3844.not = icmp eq i32 %call3855, 0
  br i1 %tobool3844.not, label %if.end3957, label %land.rhs3845
...
if.end3883:                                       ; preds = %if.then3872, %if.else3874
  ...
  store i32 %inc3943, ptr @ttop, align 4
...
if.then3946:                                      ; preds = %if.end3883
  ...
  store ptr %491, ptr %arrayidx3948, align 8
  br label %if.end3957
...
if.else3949:                                      ; preds = %if.end3883
  ...
  %496 = load ptr, ptr %arrayidx3952, align 8
...
if.end3957:                                       ; preds = %while.body3854, %if.else3949, %if.then3946, %if.end3815
  %497 = load ptr, ptr %env, align 8
  store ptr %497, ptr @zz_hold, align 8
  %498 = load i32, ptr @otop, align 4
  %inc3958 = add nsw i32 %498, 1
  store i32 %inc3958, ptr @otop, align 4
...
if.then3961:                                      ; preds = %if.end3957
  ...
  store ptr %497, ptr %arrayidx3963, align 8
  br label %if.end3970
...
if.else3964:                                      ; preds = %if.end3957
  ...
  %499 = load ptr, ptr %arrayidx3967, align 8
...
if.end3970:                                       ; preds = %if.else3964, %if.then3961
  ...
  store ptr %call3971, ptr %t, align 8
  br label %for.cond449.backedge

sw.bb3972:                                        ; preds = %for.cond449
  store ptr %49, ptr @zz_hold, align 8
  %cond3995.in = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 87), align 1
  %cond3995 = zext i8 %cond3995.in to i32
  store i32 %cond3995, ptr @zz_size, align 4
  %idxprom3996 = zext i8 %cond3995.in to i64
  %arrayidx3997 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom3996
  %500 = load ptr, ptr %arrayidx3997, align 8
  store ptr %500, ptr %49, align 8
  %501 = load ptr, ptr @zz_hold, align 8
  %502 = load i32, ptr @zz_size, align 4
  %idxprom4001 = sext i32 %502 to i64
  %arrayidx4002 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom4001
  store ptr %501, ptr %arrayidx4002, align 8
  %call4003 = call ptr @LexGetToken() #6
  store ptr %call4003, ptr %t, align 8
  %call4004 = call ptr @Parse(ptr noundef nonnull %t, ptr noundef %encl, i32 noundef 0, i32 noundef 0)
  store ptr %call4004, ptr %env, align 8
  store i32 0, ptr %scope_count, align 4
  call void @SetScope(ptr noundef %call4004, ptr noundef nonnull %scope_count, i32 noundef 0)
  %call4005 = call ptr @LexGetToken() #6
  store ptr %call4005, ptr %t, align 8
  %call4006 = call ptr @Parse(ptr noundef nonnull %t, ptr noundef %encl, i32 noundef 0, i32 noundef 0)
  %503 = load i32, ptr %scope_count, align 4
  %cmp40088225 = icmp sgt i32 %503, 0
  br i1 %cmp40088225, label %for.body4010, label %for.end4013

for.body4010:                                     ; preds = %sw.bb3972, %for.body4010
  %i.08226 = phi i32 [ %inc4012, %for.body4010 ], [ 0, %sw.bb3972 ]
  call void @PopScope() #6
  %inc4012 = add nuw nsw i32 %i.08226, 1
  %exitcond8282.not = icmp eq i32 %inc4012, %503
  br i1 %exitcond8282.not, label %for.end4013, label %for.body4010

for.end4013:                                      ; preds = %for.body4010, %sw.bb3972
  %504 = load ptr, ptr %env, align 8
...
if.else4028:                                      ; preds = %if.then4015
  ...
  %507 = load i8, ptr %ou14029, align 8
...
while.body4052:                                   ; preds = %land.rhs4043
  %call4053 = call fastcc i32 @Reduce()
  %tobool4042.not = icmp eq i32 %call4053, 0
  br i1 %tobool4042.not, label %if.end4155, label %land.rhs4043
...
if.end4081:                                       ; preds = %if.then4070, %if.else4072
  ...
  store i32 %inc4141, ptr @ttop, align 4
...
if.then4144:                                      ; preds = %if.end4081
  ...
  store ptr %516, ptr %arrayidx4146, align 8
  br label %if.end4155
...
if.else4147:                                      ; preds = %if.end4081
  ...
  %520 = load ptr, ptr %arrayidx4150, align 8
...
if.end4155:                                       ; preds = %while.body4052, %if.else4147, %if.then4144, %for.end4013
  store ptr %call4006, ptr @zz_hold, align 8
  %521 = load i32, ptr @otop, align 4
  %inc4156 = add nsw i32 %521, 1
  store i32 %inc4156, ptr @otop, align 4
...
if.then4159:                                      ; preds = %if.end4155
  ...
  store ptr %call4006, ptr %arrayidx4161, align 8
  br label %if.end4168
...
if.else4162:                                      ; preds = %if.end4155
  ...
  %522 = load ptr, ptr %arrayidx4165, align 8
...
if.then4215:                                      ; preds = %if.end4210
  ...
  %.pre8295 = load ptr, ptr %ouse_invocation4212, align 8
  br label %if.end4218

if.end4218:                                       ; preds = %if.then4215, %if.end4210
  %530 = phi ptr [ %.pre8295, %if.then4215 ], [ %529, %if.end4210 ]
  %531 = load ptr, ptr @no_fpos, align 8
  %call4220 = call ptr @CopyObject(ptr noundef %530, ptr noundef %531) #6
  %link.08221 = load ptr, ptr %call4220, align 8
  %cmp4225.not8222 = icmp eq ptr %link.08221, %call4220
  br i1 %cmp4225.not8222, label %for.end4344, label %for.cond4231.preheader

for.cond4224.loopexit:                            ; preds = %for.cond4231
  %link.0 = load ptr, ptr %link.08223, align 8
  %cmp4225.not = icmp eq ptr %link.0, %call4220
  br i1 %cmp4225.not, label %for.end4344, label %for.cond4231.preheader

for.cond4231.preheader:                           ; preds = %if.end4218, %for.cond4224.loopexit
  %link.08223 = phi ptr [ %link.0, %for.cond4224.loopexit ], [ %link.08221, %if.end4218 ]
  br label %for.cond4231

for.cond4231:                                     ; preds = %for.cond4231.preheader, %for.cond4231
  %link.0.pn = phi ptr [ %y.2, %for.cond4231 ], [ %link.08223, %for.cond4231.preheader ]
  ...
  %532 = load i8, ptr %ou14232, align 8
...
if.then4248:                                      ; preds = %for.cond4231
  store ptr %link.08223, ptr @xx_link, align 8
  %osucc4251 = getelementptr inbounds [2 x %struct.LIST], ptr %link.08223, i64 0, i64 1, i32 1
  %533 = load ptr, ptr %osucc4251, align 8
  %cmp4252 = icmp eq ptr %533, %link.08223
  br i1 %cmp4252, label %cond.end4277, label %cond.false4255

cond.false4255:                                   ; preds = %if.then4248
  store ptr %533, ptr @zz_res, align 8
  %arrayidx4260 = getelementptr inbounds [2 x %struct.LIST], ptr %link.08223, i64 0, i64 1
  %534 = load ptr, ptr %arrayidx4260, align 8
  %arrayidx4263 = getelementptr inbounds [2 x %struct.LIST], ptr %533, i64 0, i64 1
  store ptr %534, ptr %arrayidx4263, align 8
  %535 = load ptr, ptr %arrayidx4260, align 8
  %osucc4270 = getelementptr inbounds [2 x %struct.LIST], ptr %535, i64 0, i64 1, i32 1
  store ptr %533, ptr %osucc4270, align 8
  store ptr %link.08223, ptr %osucc4251, align 8
  store ptr %link.08223, ptr %arrayidx4260, align 8
  br label %cond.end4277

cond.end4277:                                     ; preds = %if.then4248, %cond.false4255
  store ptr %link.08223, ptr @zz_hold, align 8
  %osucc4281 = getelementptr inbounds %struct.LIST, ptr %link.08223, i64 0, i32 1
  %536 = load ptr, ptr %osucc4281, align 8
  %cmp4282 = icmp eq ptr %536, %link.08223
  br i1 %cmp4282, label %cond.end4307, label %cond.false4285

cond.false4285:                                   ; preds = %cond.end4277
  store ptr %536, ptr @zz_res, align 8
  %537 = load ptr, ptr %link.08223, align 8
  store ptr %537, ptr %536, align 8
  %538 = load ptr, ptr @zz_res, align 8
  %539 = load ptr, ptr @zz_hold, align 8
  %540 = load ptr, ptr %539, align 8
  %osucc4300 = getelementptr inbounds %struct.LIST, ptr %540, i64 0, i32 1
  store ptr %538, ptr %osucc4300, align 8
  %osucc4303 = getelementptr inbounds %struct.LIST, ptr %539, i64 0, i32 1
  store ptr %539, ptr %osucc4303, align 8
  store ptr %539, ptr %539, align 8
  %.pre8296 = load ptr, ptr @xx_link, align 8
  br label %cond.end4307

cond.end4307:                                     ; preds = %cond.end4277, %cond.false4285
  %541 = phi ptr [ %link.08223, %cond.end4277 ], [ %.pre8296, %cond.false4285 ]
  store ptr %541, ptr @zz_hold, align 8
  %ou14309 = getelementptr inbounds %struct.word_type, ptr %541, i64 0, i32 1
  %542 = load i8, ptr %ou14309, align 8
...
if.else4359:                                      ; preds = %if.then4346
  ...
  %548 = load i8, ptr %ou14360, align 8
...
while.body4383:                                   ; preds = %land.rhs4374
  %call4384 = call fastcc i32 @Reduce()
  %tobool4373.not = icmp eq i32 %call4384, 0
  br i1 %tobool4373.not, label %if.end4486, label %land.rhs4374
...
if.end4412:                                       ; preds = %if.then4401, %if.else4403
  ...
  store i32 %inc4472, ptr @ttop, align 4
...
if.then4475:                                      ; preds = %if.end4412
  ...
  store ptr %557, ptr %arrayidx4477, align 8
  br label %if.end4486
...
if.else4478:                                      ; preds = %if.end4412
  ...
  %561 = load ptr, ptr %arrayidx4481, align 8
...
if.end4486:                                       ; preds = %while.body4383, %if.else4478, %if.then4475, %for.end4344
  store ptr %call4220, ptr @zz_hold, align 8
  %562 = load i32, ptr @otop, align 4
  %inc4487 = add nsw i32 %562, 1
  store i32 %inc4487, ptr @otop, align 4
...
if.then4490:                                      ; preds = %if.end4486
  ...
  store ptr %call4220, ptr %arrayidx4492, align 8
  br label %if.end4499
...
if.else4493:                                      ; preds = %if.end4486
  ...
  %563 = load ptr, ptr %arrayidx4496, align 8
...
if.else4610:                                      ; preds = %if.then4597
  ...
  %582 = load i8, ptr %ou14611, align 8
...
while.body4634:                                   ; preds = %land.rhs4625
  %call4635 = call fastcc i32 @Reduce()
  %tobool4624.not = icmp eq i32 %call4635, 0
  br i1 %tobool4624.not, label %if.end4737, label %land.rhs4625
...
if.end4663:                                       ; preds = %if.then4652, %if.else4654
  ...
  store i32 %inc4723, ptr @ttop, align 4
...
if.then4726:                                      ; preds = %if.end4663
  ...
  store ptr %591, ptr %arrayidx4728, align 8
  br label %if.end4737
...
if.else4729:                                      ; preds = %if.end4663
  ...
  %595 = load ptr, ptr %arrayidx4732, align 8
...
if.end4737:                                       ; preds = %while.body4634, %if.else4729, %if.then4726, %if.then4595
  store ptr %571, ptr @zz_hold, align 8
  %596 = load i32, ptr @otop, align 4
  %inc4738 = add nsw i32 %596, 1
  store i32 %inc4738, ptr @otop, align 4
...
if.then4741:                                      ; preds = %if.end4737
  ...
  store ptr %571, ptr %arrayidx4743, align 8
  br label %for.cond449.backedge
...
if.else4744:                                      ; preds = %if.end4737
  ...
  %597 = load ptr, ptr %arrayidx4747, align 8
...
if.then4762:                                      ; preds = %for.cond4760
  ...
  store ptr %call4764, ptr @zz_hold, align 8
  %599 = load i32, ptr @otop, align 4
  %inc4765 = add nsw i32 %599, 1
  store i32 %inc4765, ptr @otop, align 4
...
if.then4768:                                      ; preds = %if.then4762
  ...
  store ptr %call4764, ptr %arrayidx4770, align 8
...
if.else4771:                                      ; preds = %if.then4762
  ...
  %600 = load ptr, ptr %arrayidx4774, align 8
...
if.then4795:                                      ; preds = %if.else4778
  %call4796 = call fastcc i32 @Reduce()
  %605 = load i32, ptr @ttop, align 4
...
if.else4823:                                      ; preds = %if.then4810
  ...
  %608 = load i8, ptr %ou14824, align 8
...
while.body4847:                                   ; preds = %land.rhs4838
  %call4848 = call fastcc i32 @Reduce()
  %tobool4837.not = icmp eq i32 %call4848, 0
  br i1 %tobool4837.not, label %if.end4951, label %land.rhs4838
...
if.end4876:                                       ; preds = %if.then4865, %if.else4867
  ...
  store i32 %inc4936, ptr @ttop, align 4
...
if.then4939:                                      ; preds = %if.end4876
  ...
  store ptr %617, ptr %arrayidx4941, align 8
  br label %if.end4951
...
if.else4942:                                      ; preds = %if.end4876
  ...
  %621 = load ptr, ptr %arrayidx4945, align 8
...
if.end4951:                                       ; preds = %if.else4778, %while.body4847, %if.else4942, %if.then4939, %if.else4808
  %622 = load i32, ptr @ttop, align 4
  %inc4952 = add nsw i32 %622, 1
  store i32 %inc4952, ptr @ttop, align 4
...
if.then4955:                                      ; preds = %if.end4951
  ...
  store ptr %571, ptr %arrayidx4957, align 8
  br label %if.end4964
...
if.else4958:                                      ; preds = %if.end4951
  ...
  %623 = load ptr, ptr %arrayidx4961, align 8
...
if.else4973:                                      ; preds = %if.end4964
  %call4974 = call fastcc i32 @Reduce()
  %625 = load i32, ptr @ttop, align 4
...
if.end4982:                                       ; preds = %if.end4964, %if.else4973
  ...
  %626 = load ptr, ptr @StartSym, align 8
...
while.cond5027:                                   ; preds = %cleanup, %if.end5026
  ...
  %633 = load i8, ptr %ou15028, align 8
  switch i8 %633, label %while.end5438 [
...
cleanup.thread:                                   ; preds = %if.then5065
  ...
  %639 = load ptr, ptr %oactual5034.le, align 8
  ...
  store ptr %632, ptr @zz_hold, align 8
  %640 = load i8, ptr %ou15028, align 8
...
if.else5108:                                      ; preds = %land.rhs5050
  ...
  store i8 3, ptr %ou25118, align 8
  br label %if.end5120
...
for.cond5128.preheader:                           ; preds = %if.end5120
  ...
  %link.18205 = load ptr, ptr %link.1.in8204, align 8
  %cmp5129.not8206 = icmp eq ptr %link.18205, %648
  br i1 %cmp5129.not8206, label %if.end5154.loopexit, label %for.cond5135.preheader
...
for.end5146:                                      ; preds = %for.cond5135
  ...
  br i1 %cmp5129.not, label %if.end5154.loopexit.loopexit, label %for.cond5135.preheader

if.end5154.loopexit.loopexit:                     ; preds = %for.end5146
  %.pre8284.pre = load ptr, ptr %oactual5121, align 8
  br label %if.end5154.loopexit

if.end5154.loopexit:                              ; preds = %if.end5154.loopexit.loopexit, %for.cond5128.preheader
  %.pre8284 = phi ptr [ %647, %for.cond5128.preheader ], [ %.pre8284.pre, %if.end5154.loopexit.loopexit ]
  %inc51488203.lcssa = phi i32 [ 0, %for.cond5128.preheader ], [ %inc5148, %if.end5154.loopexit.loopexit ]
  store i32 %inc51488203.lcssa, ptr %scope_count, align 4
  br label %if.end5154

if.end5154:                                       ; preds = %if.end5154.loopexit, %if.end5120
  %651 = phi i32 [ %inc51488203.lcssa, %if.end5154.loopexit ], [ 0, %if.end5120 ]
  %652 = phi ptr [ %.pre8284, %if.end5154.loopexit ], [ %647, %if.end5120 ]
  call void @PushScope(ptr noundef %652, i32 noundef 0, i32 noundef 0) #6
  ...
  store i8 10, ptr %ou15157, align 8
  %653 = load i8, ptr @zz_lengths, align 1
  %conv5159 = zext i8 %653 to i32
  store i32 %conv5159, ptr @zz_size, align 4
  %conv5160 = zext i8 %653 to i64
  %arrayidx5167 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv5160
  %654 = load ptr, ptr %arrayidx5167, align 8
  %cmp5168 = icmp eq ptr %654, null
  br i1 %cmp5168, label %if.then5170, label %if.else5172

if.then5170:                                      ; preds = %if.end5154
  %655 = load ptr, ptr @no_fpos, align 8
  %call5171 = call ptr @GetMemory(i32 noundef %conv5159, ptr noundef %655) #6
  br label %cond.end5227

if.else5172:                                      ; preds = %if.end5154
  store ptr %654, ptr @zz_hold, align 8
  %656 = load ptr, ptr %654, align 8
  store ptr %656, ptr %arrayidx5167, align 8
  br label %cond.end5227

cond.end5227:                                     ; preds = %if.then5170, %if.else5172
  %657 = phi ptr [ %call5171, %if.then5170 ], [ %654, %if.else5172 ]
  %ou15182 = getelementptr inbounds %struct.word_type, ptr %657, i64 0, i32 1
  store i8 0, ptr %ou15182, align 8
  %osucc5186 = getelementptr inbounds [2 x %struct.LIST], ptr %657, i64 0, i64 1, i32 1
  store ptr %657, ptr %osucc5186, align 8
  %arrayidx5188 = getelementptr inbounds [2 x %struct.LIST], ptr %657, i64 0, i64 1
  store ptr %657, ptr %arrayidx5188, align 8
  %osucc5192 = getelementptr inbounds %struct.LIST, ptr %657, i64 0, i32 1
  store ptr %657, ptr %osucc5192, align 8
  store ptr %657, ptr %657, align 8
  store ptr %657, ptr @xx_link, align 8
  store ptr %657, ptr @zz_res, align 8
  store ptr %new_par.0, ptr @zz_hold, align 8
  %658 = load ptr, ptr %new_par.0, align 8
  store ptr %658, ptr @zz_tmp, align 8
  %659 = load ptr, ptr %657, align 8
  store ptr %659, ptr %new_par.0, align 8
  %660 = load ptr, ptr @zz_hold, align 8
  %661 = load ptr, ptr @zz_res, align 8
  %662 = load ptr, ptr %661, align 8
  %osucc5218 = getelementptr inbounds %struct.LIST, ptr %662, i64 0, i32 1
  store ptr %660, ptr %osucc5218, align 8
  %663 = load ptr, ptr @zz_tmp, align 8
  store ptr %663, ptr %661, align 8
  %664 = load ptr, ptr @zz_res, align 8
  %665 = load ptr, ptr @zz_tmp, align 8
  %osucc5224 = getelementptr inbounds %struct.LIST, ptr %665, i64 0, i32 1
  store ptr %664, ptr %osucc5224, align 8
  %666 = load ptr, ptr @xx_link, align 8
  store ptr %666, ptr @zz_res, align 8
  store ptr %call5156, ptr @zz_hold, align 8
  %cmp5229 = icmp eq ptr %call5156, null
  %cmp5233 = icmp eq ptr %666, null
...
cond.false5236:                                   ; preds = %cond.end5227
  ...
  %667 = load ptr, ptr %arrayidx5238, align 8
  store ptr %667, ptr @zz_tmp, align 8
  %arrayidx5241 = getelementptr inbounds [2 x %struct.LIST], ptr %666, i64 0, i64 1
  %668 = load ptr, ptr %arrayidx5241, align 8
  store ptr %668, ptr %arrayidx5238, align 8
  %669 = load ptr, ptr %arrayidx5241, align 8
  %osucc5251 = getelementptr inbounds [2 x %struct.LIST], ptr %669, i64 0, i64 1, i32 1
  store ptr %call5156, ptr %osucc5251, align 8
  store ptr %667, ptr %arrayidx5241, align 8
  %osucc5257 = getelementptr inbounds [2 x %struct.LIST], ptr %667, i64 0, i64 1, i32 1
  store ptr %666, ptr %osucc5257, align 8
  br label %cond.end5260

cond.end5260:                                     ; preds = %cond.end5227, %cond.false5236
  %cmp52638209 = icmp sgt i32 %651, 0
...
for.body5265:                                     ; preds = %cond.end5260, %for.body5265
  ...
  %exitcond.not = icmp eq i32 %inc5267, %651
  br i1 %exitcond.not, label %for.cond5272.preheader, label %for.body5265
...
for.cond5272:                                     ; preds = %for.cond5272.preheader, %if.end5298
  %.pn8062 = phi ptr [ %link.2, %if.end5298 ], [ %571, %for.cond5272.preheader ]
  %link.2.in = getelementptr inbounds %struct.LIST, ptr %.pn8062, i64 0, i32 1
...
for.cond5279:                                     ; preds = %for.cond5272, %for.cond5279
  ...
  %670 = load i8, ptr %ou15280, align 8
  switch i8 %670, label %if.then5296 [
...
if.then5296:                                      ; preds = %for.cond5279
  ...
  %call5297 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %671, ptr noundef nonnull @.str.45) #6
  br label %if.end5298

if.end5298:                                       ; preds = %for.cond5279, %if.then5296
  %672 = load ptr, ptr %oactual5121, align 8
  %oactual5300 = getelementptr inbounds %struct.closure_type, ptr %y.4, i64 0, i32 5
  %673 = load ptr, ptr %oactual5300, align 8
  %cmp5301 = icmp eq ptr %672, %673
  br i1 %cmp5301, label %for.end5316.thread, label %for.cond5272

for.end5316.thread:                               ; preds = %if.end5298
  %call5306 = call ptr @SymName(ptr noundef %672) #6
  %674 = load ptr, ptr %oactual4543, align 8
  %call5308 = call ptr @SymName(ptr noundef %674) #6
...
if.then5319:                                      ; preds = %for.cond5272
  %675 = load ptr, ptr %oactual5121, align 8
  %ois_compulsory = getelementptr inbounds %struct.symbol_type, ptr %675, i64 0, i32 16
  %bf.load5321 = load i8, ptr %ois_compulsory, align 2
  %676 = lshr i8 %bf.load5321, 6
  %677 = and i8 %676, 1
  %678 = zext i8 %677 to i32
  %spec.select = add i32 %compulsory_count.0, %678
  %679 = load i8, ptr @zz_lengths, align 1
  %conv5329 = zext i8 %679 to i32
  store i32 %conv5329, ptr @zz_size, align 4
  %conv5330 = zext i8 %679 to i64
  %arrayidx5337 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv5330
  %680 = load ptr, ptr %arrayidx5337, align 8
  %cmp5338 = icmp eq ptr %680, null
  br i1 %cmp5338, label %if.then5340, label %if.else5342

if.then5340:                                      ; preds = %if.then5319
  %681 = load ptr, ptr @no_fpos, align 8
  %call5341 = call ptr @GetMemory(i32 noundef %conv5329, ptr noundef %681) #6
  br label %if.end5351

if.else5342:                                      ; preds = %if.then5319
  store ptr %680, ptr @zz_hold, align 8
  %682 = load ptr, ptr %680, align 8
  store ptr %682, ptr %arrayidx5337, align 8
  br label %if.end5351

if.end5351:                                       ; preds = %if.then5340, %if.else5342
  %683 = phi ptr [ %call5341, %if.then5340 ], [ %680, %if.else5342 ]
  %ou15352 = getelementptr inbounds %struct.word_type, ptr %683, i64 0, i32 1
  store i8 0, ptr %ou15352, align 8
  %osucc5356 = getelementptr inbounds [2 x %struct.LIST], ptr %683, i64 0, i64 1, i32 1
  store ptr %683, ptr %osucc5356, align 8
  %arrayidx5358 = getelementptr inbounds [2 x %struct.LIST], ptr %683, i64 0, i64 1
  store ptr %683, ptr %arrayidx5358, align 8
  %osucc5362 = getelementptr inbounds %struct.LIST, ptr %683, i64 0, i32 1
  store ptr %683, ptr %osucc5362, align 8
  store ptr %683, ptr %683, align 8
  store ptr %683, ptr @xx_link, align 8
  store ptr %683, ptr @zz_res, align 8
  store ptr %571, ptr @zz_hold, align 8
...
cond.end5397:                                     ; preds = %if.end5351
  %684 = load ptr, ptr %571, align 8
  store ptr %684, ptr @zz_tmp, align 8
  %685 = load ptr, ptr %683, align 8
  store ptr %685, ptr %571, align 8
  %686 = load ptr, ptr @zz_hold, align 8
  %687 = load ptr, ptr @zz_res, align 8
  %688 = load ptr, ptr %687, align 8
  %osucc5388 = getelementptr inbounds %struct.LIST, ptr %688, i64 0, i32 1
  store ptr %686, ptr %osucc5388, align 8
  %689 = load ptr, ptr @zz_tmp, align 8
  store ptr %689, ptr %687, align 8
  %690 = load ptr, ptr @zz_res, align 8
  %691 = load ptr, ptr @zz_tmp, align 8
  %osucc5394 = getelementptr inbounds %struct.LIST, ptr %691, i64 0, i32 1
  store ptr %690, ptr %osucc5394, align 8
  %.pr8145 = load ptr, ptr @xx_link, align 8
  store ptr %.pr8145, ptr @zz_res, align 8
  store ptr %new_par.0, ptr @zz_hold, align 8
...
cond.end5397.cond.false5406_crit_edge:            ; preds = %cond.end5397
  ...
  %.pre8285 = load ptr, ptr %arrayidx5411.phi.trans.insert, align 8
  br label %cond.false5406

cond.false5406:                                   ; preds = %cond.end5397.cond.false5406_crit_edge, %cond.end5397.thread
  %692 = phi ptr [ %683, %cond.end5397.thread ], [ %.pre8285, %cond.end5397.cond.false5406_crit_edge ]
  %693 = phi ptr [ %683, %cond.end5397.thread ], [ %.pr8145, %cond.end5397.cond.false5406_crit_edge ]
  %arrayidx5408 = getelementptr inbounds [2 x %struct.LIST], ptr %new_par.0, i64 0, i64 1
  %694 = load ptr, ptr %arrayidx5408, align 8
  store ptr %694, ptr @zz_tmp, align 8
  %arrayidx5411 = getelementptr inbounds [2 x %struct.LIST], ptr %693, i64 0, i64 1
  store ptr %692, ptr %arrayidx5408, align 8
  %695 = load ptr, ptr %arrayidx5411, align 8
  %osucc5421 = getelementptr inbounds [2 x %struct.LIST], ptr %695, i64 0, i64 1, i32 1
  store ptr %new_par.0, ptr %osucc5421, align 8
  store ptr %694, ptr %arrayidx5411, align 8
  %osucc5427 = getelementptr inbounds [2 x %struct.LIST], ptr %694, i64 0, i64 1, i32 1
  store ptr %693, ptr %osucc5427, align 8
  br label %if.end5432
...
while.end5438:                                    ; preds = %while.cond5027, %land.lhs.true5033, %land.lhs.true5037, %land.rhs5050, %cleanup.thread
  %ohas_compulsory = getelementptr inbounds %struct.symbol_type, ptr %572, i64 0, i32 13
  %697 = load i16, ptr %ohas_compulsory, align 2
  %conv5439 = zext i16 %697 to i32
...
for.cond5446.preheader:                           ; preds = %while.end5438
  %xlink.0.in8216 = getelementptr inbounds %struct.LIST, ptr %572, i64 0, i32 1
  %xlink.08217 = load ptr, ptr %xlink.0.in8216, align 8
  %cmp5447.not8218 = icmp eq ptr %xlink.08217, %572
  br i1 %cmp5447.not8218, label %if.end5530, label %for.cond5453.preheader.lr.ph

for.cond5453.preheader.lr.ph:                     ; preds = %for.cond5446.preheader
  %link.3.in8211 = getelementptr inbounds %struct.LIST, ptr %571, i64 0, i32 1
...
for.cond5453.preheader:                           ; preds = %for.cond5453.preheader.lr.ph, %for.inc5525
  %xlink.08219 = phi ptr [ %xlink.08217, %for.cond5453.preheader.lr.ph ], [ %xlink.0, %for.inc5525 ]
  br label %for.cond5453

for.cond5453:                                     ; preds = %for.cond5453.preheader, %for.cond5453
  %xlink.0.pn = phi ptr [ %tmp.0, %for.cond5453 ], [ %xlink.08219, %for.cond5453.preheader ]
  ...
  %698 = load i8, ptr %ou15454, align 8
  switch i8 %698, label %for.inc5525 [
...
land.lhs.true5470:                                ; preds = %for.cond5453
  ...
  %699 = and i8 %bf.load5472, 64
  %tobool5476.not = icmp eq i8 %699, 0
  br i1 %tobool5476.not, label %for.inc5525, label %for.cond5481.preheader

for.cond5481.preheader:                           ; preds = %land.lhs.true5470
  %link.38212 = load ptr, ptr %link.3.in8211, align 8
  %cmp5482.not8213 = icmp eq ptr %link.38212, %571
  br i1 %cmp5482.not8213, label %if.then5518, label %for.cond5488.preheader

for.cond5488.preheader:                           ; preds = %for.cond5481.preheader, %for.inc5511
  %link.38214 = phi ptr [ %link.3, %for.inc5511 ], [ %link.38212, %for.cond5481.preheader ]
  br label %for.cond5488

for.cond5488:                                     ; preds = %for.cond5488.preheader, %for.cond5488
  %link.3.pn = phi ptr [ %y.5, %for.cond5488 ], [ %link.38214, %for.cond5488.preheader ]
  ...
  %700 = load i8, ptr %ou15489, align 8
  switch i8 %700, label %for.inc5511 [
...
land.lhs.true5505:                                ; preds = %for.cond5488
  ...
  %701 = load ptr, ptr %oactual5506, align 8
  %cmp5507 = icmp eq ptr %701, %tmp.0
  br i1 %cmp5507, label %for.inc5525, label %for.inc5511

for.inc5511:                                      ; preds = %for.cond5488, %land.lhs.true5505
  %link.3.in = getelementptr inbounds %struct.LIST, ptr %link.38214, i64 0, i32 1
  %link.3 = load ptr, ptr %link.3.in, align 8
  %cmp5482.not = icmp eq ptr %link.3, %571
  br i1 %cmp5482.not, label %if.then5518, label %for.cond5488.preheader
...
for.inc5525:                                      ; preds = %for.cond5453, %land.lhs.true5505, %land.lhs.true5470, %if.then5518
  %xlink.0.in = getelementptr inbounds %struct.LIST, ptr %xlink.08219, i64 0, i32 1
  %xlink.0 = load ptr, ptr %xlink.0.in, align 8
  %cmp5447.not = icmp eq ptr %xlink.0, %572
  br i1 %cmp5447.not, label %if.end5530, label %for.cond5453.preheader

if.end5530:                                       ; preds = %for.inc5525, %for.cond5446.preheader, %while.end5438
  %702 = load ptr, ptr %t, align 8
  %ou15531 = getelementptr inbounds %struct.word_type, ptr %702, i64 0, i32 1
  %703 = load i8, ptr %ou15531, align 8
  %cmp5534 = icmp eq i8 %703, 104
...
if.then5536:                                      ; preds = %if.end5530
  ...
  %704 = and i24 %bf.load5539, 8
  %tobool5543.not = icmp eq i24 %704, 0
...
if.else5548:                                      ; preds = %if.then5536
  %oactual5549 = getelementptr inbounds %struct.closure_type, ptr %702, i64 0, i32 5
  store ptr %572, ptr %oactual5549, align 8
  br label %if.end5551
...
land.lhs.true5553:                                ; preds = %if.end5551
  ...
  %705 = and i24 %bf.load5556, 16448
  %or.cond = icmp eq i24 %705, 64
...
land.lhs.true5568:                                ; preds = %land.lhs.true5553
  ...
  %706 = load ptr, ptr %ofilter, align 8
  %cmp5569 = icmp eq ptr %706, null
  br i1 %cmp5569, label %if.then5571, label %if.end6511

if.then5571:                                      ; preds = %land.lhs.true5568
  %707 = and i24 %bf.load5556, 8
  %tobool5578.not = icmp eq i24 %707, 0
...
lor.lhs.false5579:                                ; preds = %if.then5571
  ...
  %708 = load i8, ptr %ouses_count, align 4
  %cmp5582 = icmp ult i8 %708, 2
...
if.then5584:                                      ; preds = %lor.lhs.false5579.if.then5584_crit_edge, %if.then5571
  ...
  %709 = load i32, ptr @ttop, align 4
  %710 = shl i24 %bf.load5587, 20
  %sext = ashr i24 %710, 23
  %sub5593 = sext i24 %sext to i32
  %cond5596 = add i32 %709, %sub5593
  %711 = sext i32 %cond5596 to i64
  br label %while.cond5597

while.cond5597:                                   ; preds = %while.cond5597, %if.then5584
  %indvars.iv = phi i64 [ %indvars.iv.next, %while.cond5597 ], [ %711, %if.then5584 ]
  %arrayidx5599 = getelementptr inbounds [100 x ptr], ptr @tok_stack, i64 0, i64 %indvars.iv
  %712 = load ptr, ptr %arrayidx5599, align 8
  %ou15600 = getelementptr inbounds %struct.word_type, ptr %712, i64 0, i32 1
  %713 = load i8, ptr %ou15600, align 8
  %or.cond8153 = icmp ult i8 %713, 102
  %indvars.iv.next = add i64 %indvars.iv, -1
  br i1 %or.cond8153, label %while.cond5597, label %while.end5633

while.end5633:                                    ; preds = %while.cond5597
  switch i8 %713, label %if.end6511 [
...
land.lhs.true5649:                                ; preds = %while.end5633, %while.end5633
  ...
  %sext8323 = add i64 %sub5650, -4294967296
  %idxprom5651 = ashr exact i64 %sext8323, 32
  %arrayidx5652 = getelementptr inbounds [100 x ptr], ptr @tok_stack, i64 0, i64 %idxprom5651
  %714 = load ptr, ptr %arrayidx5652, align 8
  %ou15653 = getelementptr inbounds %struct.word_type, ptr %714, i64 0, i32 1
  %715 = load i8, ptr %ou15653, align 8
  %cmp5656 = icmp eq i8 %715, 110
  br i1 %cmp5656, label %if.then5658, label %if.end6511

if.then5658:                                      ; preds = %land.lhs.true5649
  %716 = and i24 %bf.load5587, 8
  %tobool5665.not = icmp eq i24 %716, 0
  br i1 %tobool5665.not, label %if.end5886, label %if.then5666

if.then5666:                                      ; preds = %if.then5658
  %717 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 2), align 1
  %conv5667 = zext i8 %717 to i32
  store i32 %conv5667, ptr @zz_size, align 4
  %conv5668 = zext i8 %717 to i64
  %arrayidx5675 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv5668
  %718 = load ptr, ptr %arrayidx5675, align 8
  %cmp5676 = icmp eq ptr %718, null
  br i1 %cmp5676, label %if.then5678, label %if.else5680

if.then5678:                                      ; preds = %if.then5666
  %719 = load ptr, ptr @no_fpos, align 8
  %call5679 = call ptr @GetMemory(i32 noundef %conv5667, ptr noundef %719) #6
  store ptr %call5679, ptr @zz_hold, align 8
  br label %if.end5689

if.else5680:                                      ; preds = %if.then5666
  store ptr %718, ptr @zz_hold, align 8
  %720 = load ptr, ptr %718, align 8
  store ptr %720, ptr %arrayidx5675, align 8
  br label %if.end5689

if.end5689:                                       ; preds = %if.then5678, %if.else5680
  %721 = phi ptr [ %call5679, %if.then5678 ], [ %718, %if.else5680 ]
  %ou15690 = getelementptr inbounds %struct.word_type, ptr %721, i64 0, i32 1
  store i8 2, ptr %ou15690, align 8
  %osucc5694 = getelementptr inbounds [2 x %struct.LIST], ptr %721, i64 0, i64 1, i32 1
  store ptr %721, ptr %osucc5694, align 8
  %arrayidx5696 = getelementptr inbounds [2 x %struct.LIST], ptr %721, i64 0, i64 1
  store ptr %721, ptr %arrayidx5696, align 8
  %osucc5700 = getelementptr inbounds %struct.LIST, ptr %721, i64 0, i32 1
  store ptr %721, ptr %osucc5700, align 8
  store ptr %721, ptr %721, align 8
  %722 = load ptr, ptr @InputSym, align 8
  %oactual5704 = getelementptr inbounds %struct.closure_type, ptr %721, i64 0, i32 5
  store ptr %722, ptr %oactual5704, align 8
  %723 = load ptr, ptr %t, align 8
  %ofile_num5706 = getelementptr inbounds %struct.word_type, ptr %723, i64 0, i32 1, i32 0, i32 2
  %724 = load i16, ptr %ofile_num5706, align 2
  %ofile_num5708 = getelementptr inbounds %struct.word_type, ptr %721, i64 0, i32 1, i32 0, i32 2
  store i16 %724, ptr %ofile_num5708, align 2
  %oline_num5710 = getelementptr inbounds %struct.word_type, ptr %723, i64 0, i32 1, i32 0, i32 3
  %bf.load5711 = load i32, ptr %oline_num5710, align 4
  %bf.clear5712 = and i32 %bf.load5711, 1048575
  %oline_num5714 = getelementptr inbounds %struct.word_type, ptr %721, i64 0, i32 1, i32 0, i32 3
...
if.then5731:                                      ; preds = %if.end5689
  %ohspace5735 = getelementptr inbounds i8, ptr %721, i64 41
  %725 = load i8, ptr %ohspace5735, align 1
  %conv5736 = zext i8 %725 to i32
  %ovspace5738 = getelementptr inbounds i8, ptr %721, i64 42
  %726 = load i8, ptr %ovspace5738, align 2
  %conv5739 = zext i8 %726 to i32
  ...
  %727 = select i1 %cmp5751, i8 7, i8 103
  %728 = select i1 %cmp5741.not, i8 %727, i8 7
  br label %land.rhs5759

land.rhs5759:                                     ; preds = %if.then5731, %while.body5768
  %729 = load i32, ptr @ttop, align 4
  %idxprom5760 = sext i32 %729 to i64
  %arrayidx5761 = getelementptr inbounds [100 x ptr], ptr @tok_stack, i64 0, i64 %idxprom5760
  %730 = load ptr, ptr %arrayidx5761, align 8
  %ou25762 = getelementptr inbounds %struct.word_type, ptr %730, i64 0, i32 2
  %731 = load i8, ptr %ou25762, align 8
  %cmp5765.not = icmp ugt i8 %728, %731
  br i1 %cmp5765.not, label %if.then5772, label %while.body5768

while.body5768:                                   ; preds = %land.rhs5759
  %call5769 = call fastcc i32 @Reduce()
  %tobool5758.not = icmp eq i32 %call5769, 0
  br i1 %tobool5758.not, label %if.end5871, label %land.rhs5759
...
if.then5772:                                      ; preds = %land.rhs5759
  ...
  %732 = load i8, ptr %arrayidx5774, align 1
  %conv5775 = zext i8 %732 to i32
  store i32 %conv5775, ptr @zz_size, align 4
  %conv5776 = zext i8 %732 to i64
  %arrayidx5783 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv5776
  %733 = load ptr, ptr %arrayidx5783, align 8
  %cmp5784 = icmp eq ptr %733, null
  br i1 %cmp5784, label %if.then5786, label %if.else5788

if.then5786:                                      ; preds = %if.then5772
  %734 = load ptr, ptr @no_fpos, align 8
  %call5787 = call ptr @GetMemory(i32 noundef %conv5775, ptr noundef %734) #6
  store ptr %call5787, ptr @zz_hold, align 8
  %.pre8287 = load i32, ptr @ttop, align 4
  br label %if.end5797

if.else5788:                                      ; preds = %if.then5772
  store ptr %733, ptr @zz_hold, align 8
  %735 = load ptr, ptr %733, align 8
  store ptr %735, ptr %arrayidx5783, align 8
  br label %if.end5797

if.end5797:                                       ; preds = %if.then5786, %if.else5788
  %736 = phi i32 [ %.pre8287, %if.then5786 ], [ %729, %if.else5788 ]
  %737 = phi ptr [ %call5787, %if.then5786 ], [ %733, %if.else5788 ]
  %conv5798 = trunc i32 %typ5732.0 to i8
  %ou15799 = getelementptr inbounds %struct.word_type, ptr %737, i64 0, i32 1
  store i8 %conv5798, ptr %ou15799, align 8
  %osucc5803 = getelementptr inbounds [2 x %struct.LIST], ptr %737, i64 0, i64 1, i32 1
  store ptr %737, ptr %osucc5803, align 8
  %arrayidx5805 = getelementptr inbounds [2 x %struct.LIST], ptr %737, i64 0, i64 1
  store ptr %737, ptr %arrayidx5805, align 8
  %osucc5809 = getelementptr inbounds %struct.LIST, ptr %737, i64 0, i32 1
  store ptr %737, ptr %osucc5809, align 8
  store ptr %737, ptr %737, align 8
  %ou25814 = getelementptr inbounds %struct.word_type, ptr %737, i64 0, i32 2
  store i8 %728, ptr %ou25814, align 8
  %ogap5824 = getelementptr inbounds %struct.gapobj_type, ptr %737, i64 0, i32 3
  ...
  %inc5857 = add nsw i32 %736, 1
  store i32 %inc5857, ptr @ttop, align 4
  %cmp5858 = icmp slt i32 %736, 99
...
if.then5860:                                      ; preds = %if.end5797
  ...
  store ptr %737, ptr %arrayidx5862, align 8
  br label %if.end5871

if.else5863:                                      ; preds = %if.end5797
  %idxprom5865 = zext i32 %736 to i64
  %arrayidx5866 = getelementptr inbounds [100 x ptr], ptr @tok_stack, i64 0, i64 %idxprom5865
  %738 = load ptr, ptr %arrayidx5866, align 8
  %ou15867 = getelementptr inbounds %struct.word_type, ptr %738, i64 0, i32 1
...
if.end5871:                                       ; preds = %while.body5768, %if.else5863, %if.then5860, %if.end5689
  %tmp.2 = phi ptr [ %721, %if.end5689 ], [ %737, %if.then5860 ], [ %737, %if.else5863 ], [ %721, %while.body5768 ]
  store ptr %tmp.2, ptr @zz_hold, align 8
  %739 = load i32, ptr @otop, align 4
  %inc5872 = add nsw i32 %739, 1
  store i32 %inc5872, ptr @otop, align 4
  %cmp5873 = icmp slt i32 %739, 99
...
if.then5875:                                      ; preds = %if.end5871
  ...
  store ptr %tmp.2, ptr %arrayidx5877, align 8
  br label %if.end5884

if.else5878:                                      ; preds = %if.end5871
  %idxprom5880 = zext i32 %739 to i64
  %arrayidx5881 = getelementptr inbounds [100 x ptr], ptr @obj_stack, i64 0, i64 %idxprom5880
  %740 = load ptr, ptr %arrayidx5881, align 8
  %ou15882 = getelementptr inbounds %struct.word_type, ptr %740, i64 0, i32 1
...
if.end5884:                                       ; preds = %if.else5878, %if.then5875
  %call5885 = call fastcc i32 @Reduce()
  br label %if.end5886

if.end5886:                                       ; preds = %if.end5884, %if.then5658
  %741 = load i32, ptr @otop, align 4
  %dec5887 = add nsw i32 %741, -1
  store i32 %dec5887, ptr @otop, align 4
  %idxprom5888 = sext i32 %741 to i64
  %arrayidx5889 = getelementptr inbounds [100 x ptr], ptr @obj_stack, i64 0, i64 %idxprom5888
  %742 = load ptr, ptr %arrayidx5889, align 8
  %call5890 = call ptr @TransferBegin(ptr noundef %742) #6
  %ou15891 = getelementptr inbounds %struct.word_type, ptr %call5890, i64 0, i32 1
  %743 = load i8, ptr %ou15891, align 8
  %cmp5894 = icmp eq i8 %743, 2
...
if.then5896:                                      ; preds = %if.end5886
  ...
  %744 = and i24 %bf.load5899, 8
  %tobool5903.not = icmp eq i24 %744, 0
  br i1 %tobool5903.not, label %if.else6319, label %if.then5904

if.then5904:                                      ; preds = %if.then5896
  %745 = load ptr, ptr %call5890, align 8
  br label %for.cond5911

for.cond5911:                                     ; preds = %for.cond5911, %if.then5904
  %.pn8064 = phi ptr [ %745, %if.then5904 ], [ %tmp.3, %for.cond5911 ]
  %tmp.3.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn8064, i64 0, i64 1
  %tmp.3 = load ptr, ptr %tmp.3.in, align 8
  %ou15912 = getelementptr inbounds %struct.word_type, ptr %tmp.3, i64 0, i32 1
  %746 = load i8, ptr %ou15912, align 8
  switch i8 %746, label %if.then5935 [
...
land.lhs.true5928:                                ; preds = %for.cond5911
  ...
  %747 = load ptr, ptr %oactual5929, align 8
  %ou15930 = getelementptr inbounds %struct.word_type, ptr %747, i64 0, i32 1
  %748 = load i8, ptr %ou15930, align 8
  %cmp5933 = icmp eq i8 %748, -110
  br i1 %cmp5933, label %if.end5937, label %if.then5935

if.then5935:                                      ; preds = %for.cond5911, %land.lhs.true5928
  %749 = load ptr, ptr @no_fpos, align 8
  %call5936 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %749, ptr noundef nonnull @.str.49) #6
  %.pre8288 = load ptr, ptr %call5890, align 8
  br label %if.end5937

if.end5937:                                       ; preds = %if.then5935, %land.lhs.true5928
  %750 = phi ptr [ %.pre8288, %if.then5935 ], [ %745, %land.lhs.true5928 ]
  store ptr %750, ptr @xx_link, align 8
  %osucc5943 = getelementptr inbounds [2 x %struct.LIST], ptr %750, i64 0, i64 1, i32 1
  %751 = load ptr, ptr %osucc5943, align 8
  %cmp5944 = icmp eq ptr %751, %750
  br i1 %cmp5944, label %cond.end5969, label %cond.false5947

cond.false5947:                                   ; preds = %if.end5937
  store ptr %751, ptr @zz_res, align 8
  %arrayidx5952 = getelementptr inbounds [2 x %struct.LIST], ptr %750, i64 0, i64 1
  %752 = load ptr, ptr %arrayidx5952, align 8
  %arrayidx5955 = getelementptr inbounds [2 x %struct.LIST], ptr %751, i64 0, i64 1
  store ptr %752, ptr %arrayidx5955, align 8
  %753 = load ptr, ptr %arrayidx5952, align 8
  %osucc5962 = getelementptr inbounds [2 x %struct.LIST], ptr %753, i64 0, i64 1, i32 1
  store ptr %751, ptr %osucc5962, align 8
  store ptr %750, ptr %osucc5943, align 8
  store ptr %750, ptr %arrayidx5952, align 8
  br label %cond.end5969

cond.end5969:                                     ; preds = %if.end5937, %cond.false5947
  %cond5970 = phi ptr [ %751, %cond.false5947 ], [ null, %if.end5937 ]
  store ptr %cond5970, ptr @xx_tmp, align 8
  store ptr %750, ptr @zz_hold, align 8
  %osucc5973 = getelementptr inbounds %struct.LIST, ptr %750, i64 0, i32 1
  %754 = load ptr, ptr %osucc5973, align 8
  %cmp5974 = icmp eq ptr %754, %750
  br i1 %cmp5974, label %cond.end5999, label %cond.false5977

cond.false5977:                                   ; preds = %cond.end5969
  store ptr %754, ptr @zz_res, align 8
  %755 = load ptr, ptr %750, align 8
  store ptr %755, ptr %754, align 8
  %756 = load ptr, ptr @zz_res, align 8
  %757 = load ptr, ptr @zz_hold, align 8
  %758 = load ptr, ptr %757, align 8
  %osucc5992 = getelementptr inbounds %struct.LIST, ptr %758, i64 0, i32 1
  store ptr %756, ptr %osucc5992, align 8
  %osucc5995 = getelementptr inbounds %struct.LIST, ptr %757, i64 0, i32 1
  store ptr %757, ptr %osucc5995, align 8
  store ptr %757, ptr %757, align 8
  %.pre8289 = load ptr, ptr @xx_link, align 8
  br label %cond.end5999

cond.end5999:                                     ; preds = %cond.end5969, %cond.false5977
  %759 = phi ptr [ %750, %cond.end5969 ], [ %.pre8289, %cond.false5977 ]
  store ptr %759, ptr @zz_hold, align 8
  %ou16001 = getelementptr inbounds %struct.word_type, ptr %759, i64 0, i32 1
  %760 = load i8, ptr %ou16001, align 8
  %.off8133 = add i8 %760, -11
  %switch8134 = icmp ult i8 %.off8133, 2
  %orec_size6014 = getelementptr inbounds %struct.word_type, ptr %759, i64 0, i32 1, i32 0, i32 1
  %idxprom6019 = zext i8 %760 to i64
  ...
  %cond6023.in = load i8, ptr %cond6023.in.in, align 1
  %cond6023 = zext i8 %cond6023.in to i32
  store i32 %cond6023, ptr @zz_size, align 4
  %idxprom6024 = zext i8 %cond6023.in to i64
  %arrayidx6025 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom6024
  %761 = load ptr, ptr %arrayidx6025, align 8
  store ptr %761, ptr %759, align 8
  %762 = load ptr, ptr @zz_hold, align 8
  %763 = load i32, ptr @zz_size, align 4
  %idxprom6029 = sext i32 %763 to i64
  %arrayidx6030 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom6029
  store ptr %762, ptr %arrayidx6030, align 8
  %764 = load ptr, ptr @xx_tmp, align 8
  %osucc6033 = getelementptr inbounds [2 x %struct.LIST], ptr %764, i64 0, i64 1, i32 1
  %765 = load ptr, ptr %osucc6033, align 8
  %cmp6034 = icmp eq ptr %765, %764
  br i1 %cmp6034, label %if.then6036, label %if.end6038

if.then6036:                                      ; preds = %cond.end5999
  %call6037 = call i32 @DisposeObject(ptr noundef nonnull %764) #6
  br label %if.end6038

if.end6038:                                       ; preds = %if.then6036, %cond.end5999
  %bf.load6041 = load i24, ptr %ohas_lpar4753, align 1
  %766 = and i24 %bf.load6041, 4
  %tobool6045.not = icmp eq i24 %766, 0
...
if.then6046:                                      ; preds = %if.end6038
  ...
  %767 = load ptr, ptr %osucc6049, align 8
  br label %for.cond6053

for.cond6053:                                     ; preds = %for.cond6053, %if.then6046
  %.pn8065 = phi ptr [ %767, %if.then6046 ], [ %tmp.4, %for.cond6053 ]
  %tmp.4.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn8065, i64 0, i64 1
  %tmp.4 = load ptr, ptr %tmp.4.in, align 8
  %ou16054 = getelementptr inbounds %struct.word_type, ptr %tmp.4, i64 0, i32 1
  %768 = load i8, ptr %ou16054, align 8
  switch i8 %768, label %if.then6077 [
...
land.lhs.true6070:                                ; preds = %for.cond6053
  ...
  %769 = load ptr, ptr %oactual6071, align 8
  %ou16072 = getelementptr inbounds %struct.word_type, ptr %769, i64 0, i32 1
  %770 = load i8, ptr %ou16072, align 8
  %cmp6075 = icmp eq i8 %770, -112
  br i1 %cmp6075, label %if.end6079, label %if.then6077

if.then6077:                                      ; preds = %for.cond6053, %land.lhs.true6070
  %771 = load ptr, ptr @no_fpos, align 8
  %call6078 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %771, ptr noundef nonnull @.str.50) #6
  br label %if.end6079

if.end6079:                                       ; preds = %if.then6077, %land.lhs.true6070
  %osucc6082 = getelementptr inbounds %struct.LIST, ptr %tmp.4, i64 0, i32 1
  %772 = load ptr, ptr %osucc6082, align 8
  br label %for.cond6086

for.cond6086:                                     ; preds = %for.cond6086, %if.end6079
  %.pn8066 = phi ptr [ %772, %if.end6079 ], [ %tmp.5, %for.cond6086 ]
  %tmp.5.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn8066, i64 0, i64 1
  %tmp.5 = load ptr, ptr %tmp.5.in, align 8
  %ou16087 = getelementptr inbounds %struct.word_type, ptr %tmp.5, i64 0, i32 1
  %773 = load i8, ptr %ou16087, align 8
  %cmp6090 = icmp eq i8 %773, 0
  br i1 %cmp6090, label %for.cond6086, label %for.end6097

for.end6097:                                      ; preds = %for.cond6086
  store ptr %tmp.5, ptr @zz_hold, align 8
  %774 = load i32, ptr @otop, align 4
  %inc6098 = add nsw i32 %774, 1
  store i32 %inc6098, ptr @otop, align 4
  %cmp6099 = icmp slt i32 %774, 99
...
if.then6101:                                      ; preds = %for.end6097
  ...
  store ptr %tmp.5, ptr %arrayidx6103, align 8
  br label %if.end6110

if.else6104:                                      ; preds = %for.end6097
  %idxprom6106 = zext i32 %774 to i64
  %arrayidx6107 = getelementptr inbounds [100 x ptr], ptr @obj_stack, i64 0, i64 %idxprom6106
  %775 = load ptr, ptr %arrayidx6107, align 8
  %ou16108 = getelementptr inbounds %struct.word_type, ptr %775, i64 0, i32 1
...
if.end6110:                                       ; preds = %if.else6104, %if.then6101
  ...
  %776 = load ptr, ptr %osucc6113, align 8
  store ptr %776, ptr @xx_link, align 8
  %osucc6116 = getelementptr inbounds [2 x %struct.LIST], ptr %776, i64 0, i64 1, i32 1
  %777 = load ptr, ptr %osucc6116, align 8
  %cmp6117 = icmp eq ptr %777, %776
  br i1 %cmp6117, label %cond.end6142, label %cond.false6120

cond.false6120:                                   ; preds = %if.end6110
  store ptr %777, ptr @zz_res, align 8
  %arrayidx6125 = getelementptr inbounds [2 x %struct.LIST], ptr %776, i64 0, i64 1
  %778 = load ptr, ptr %arrayidx6125, align 8
  %arrayidx6128 = getelementptr inbounds [2 x %struct.LIST], ptr %777, i64 0, i64 1
  store ptr %778, ptr %arrayidx6128, align 8
  %779 = load ptr, ptr %arrayidx6125, align 8
  %osucc6135 = getelementptr inbounds [2 x %struct.LIST], ptr %779, i64 0, i64 1, i32 1
  store ptr %777, ptr %osucc6135, align 8
  store ptr %776, ptr %osucc6116, align 8
  store ptr %776, ptr %arrayidx6125, align 8
  br label %cond.end6142

cond.end6142:                                     ; preds = %if.end6110, %cond.false6120
  store ptr %776, ptr @zz_hold, align 8
  %osucc6146 = getelementptr inbounds %struct.LIST, ptr %776, i64 0, i32 1
  %780 = load ptr, ptr %osucc6146, align 8
  %cmp6147 = icmp eq ptr %780, %776
  br i1 %cmp6147, label %cond.end6172, label %cond.false6150

cond.false6150:                                   ; preds = %cond.end6142
  store ptr %780, ptr @zz_res, align 8
  %781 = load ptr, ptr %776, align 8
  store ptr %781, ptr %780, align 8
  %782 = load ptr, ptr @zz_res, align 8
  %783 = load ptr, ptr @zz_hold, align 8
  %784 = load ptr, ptr %783, align 8
  %osucc6165 = getelementptr inbounds %struct.LIST, ptr %784, i64 0, i32 1
  store ptr %782, ptr %osucc6165, align 8
  %osucc6168 = getelementptr inbounds %struct.LIST, ptr %783, i64 0, i32 1
  store ptr %783, ptr %osucc6168, align 8
  store ptr %783, ptr %783, align 8
  %.pre8290 = load ptr, ptr @xx_link, align 8
  br label %cond.end6172

cond.end6172:                                     ; preds = %cond.end6142, %cond.false6150
  %785 = phi ptr [ %776, %cond.end6142 ], [ %.pre8290, %cond.false6150 ]
  store ptr %785, ptr @zz_hold, align 8
  %ou16174 = getelementptr inbounds %struct.word_type, ptr %785, i64 0, i32 1
  %786 = load i8, ptr %ou16174, align 8
  %.off8135 = add i8 %786, -11
  %switch8136 = icmp ult i8 %.off8135, 2
  %orec_size6187 = getelementptr inbounds %struct.word_type, ptr %785, i64 0, i32 1, i32 0, i32 1
  %idxprom6192 = zext i8 %786 to i64
  ...
  %cond6196.in = load i8, ptr %cond6196.in.in, align 1
  %cond6196 = zext i8 %cond6196.in to i32
  store i32 %cond6196, ptr @zz_size, align 4
  %idxprom6197 = zext i8 %cond6196.in to i64
  %arrayidx6198 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom6197
  %787 = load ptr, ptr %arrayidx6198, align 8
  store ptr %787, ptr %785, align 8
  %788 = load ptr, ptr @zz_hold, align 8
  %789 = load i32, ptr @zz_size, align 4
  %idxprom6202 = sext i32 %789 to i64
  %arrayidx6203 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom6202
  store ptr %788, ptr %arrayidx6203, align 8
  %790 = load ptr, ptr %osucc6049, align 8
  store ptr %790, ptr @xx_link, align 8
  %osucc6209 = getelementptr inbounds [2 x %struct.LIST], ptr %790, i64 0, i64 1, i32 1
  %791 = load ptr, ptr %osucc6209, align 8
  %cmp6210 = icmp eq ptr %791, %790
  br i1 %cmp6210, label %cond.end6235, label %cond.false6213

cond.false6213:                                   ; preds = %cond.end6172
  store ptr %791, ptr @zz_res, align 8
  %arrayidx6218 = getelementptr inbounds [2 x %struct.LIST], ptr %790, i64 0, i64 1
  %792 = load ptr, ptr %arrayidx6218, align 8
  %arrayidx6221 = getelementptr inbounds [2 x %struct.LIST], ptr %791, i64 0, i64 1
  store ptr %792, ptr %arrayidx6221, align 8
  %793 = load ptr, ptr %arrayidx6218, align 8
  %osucc6228 = getelementptr inbounds [2 x %struct.LIST], ptr %793, i64 0, i64 1, i32 1
  store ptr %791, ptr %osucc6228, align 8
  store ptr %790, ptr %osucc6209, align 8
  store ptr %790, ptr %arrayidx6218, align 8
  br label %cond.end6235

cond.end6235:                                     ; preds = %cond.end6172, %cond.false6213
  %cond6236 = phi ptr [ %791, %cond.false6213 ], [ null, %cond.end6172 ]
  store ptr %cond6236, ptr @xx_tmp, align 8
  store ptr %790, ptr @zz_hold, align 8
  %osucc6239 = getelementptr inbounds %struct.LIST, ptr %790, i64 0, i32 1
  %794 = load ptr, ptr %osucc6239, align 8
  %cmp6240 = icmp eq ptr %794, %790
  br i1 %cmp6240, label %cond.end6265, label %cond.false6243

cond.false6243:                                   ; preds = %cond.end6235
  store ptr %794, ptr @zz_res, align 8
  %795 = load ptr, ptr %790, align 8
  store ptr %795, ptr %794, align 8
  %796 = load ptr, ptr @zz_res, align 8
  %797 = load ptr, ptr @zz_hold, align 8
  %798 = load ptr, ptr %797, align 8
  %osucc6258 = getelementptr inbounds %struct.LIST, ptr %798, i64 0, i32 1
  store ptr %796, ptr %osucc6258, align 8
  %osucc6261 = getelementptr inbounds %struct.LIST, ptr %797, i64 0, i32 1
  store ptr %797, ptr %osucc6261, align 8
  store ptr %797, ptr %797, align 8
  %.pre8291 = load ptr, ptr @xx_link, align 8
  br label %cond.end6265

cond.end6265:                                     ; preds = %cond.end6235, %cond.false6243
  %799 = phi ptr [ %790, %cond.end6235 ], [ %.pre8291, %cond.false6243 ]
  store ptr %799, ptr @zz_hold, align 8
  %ou16267 = getelementptr inbounds %struct.word_type, ptr %799, i64 0, i32 1
  %800 = load i8, ptr %ou16267, align 8
  %.off8137 = add i8 %800, -11
  %switch8138 = icmp ult i8 %.off8137, 2
  %orec_size6280 = getelementptr inbounds %struct.word_type, ptr %799, i64 0, i32 1, i32 0, i32 1
  %idxprom6285 = zext i8 %800 to i64
  ...
  %cond6289.in = load i8, ptr %cond6289.in.in, align 1
  %cond6289 = zext i8 %cond6289.in to i32
  store i32 %cond6289, ptr @zz_size, align 4
  %idxprom6290 = zext i8 %cond6289.in to i64
  %arrayidx6291 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom6290
  %801 = load ptr, ptr %arrayidx6291, align 8
  store ptr %801, ptr %799, align 8
  %802 = load ptr, ptr @zz_hold, align 8
  %803 = load i32, ptr @zz_size, align 4
  %idxprom6295 = sext i32 %803 to i64
  %arrayidx6296 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom6295
  store ptr %802, ptr %arrayidx6296, align 8
  %804 = load ptr, ptr @xx_tmp, align 8
  %osucc6299 = getelementptr inbounds [2 x %struct.LIST], ptr %804, i64 0, i64 1, i32 1
  %805 = load ptr, ptr %osucc6299, align 8
  %cmp6300 = icmp eq ptr %805, %804
  br i1 %cmp6300, label %if.then6302, label %if.end6305

if.then6302:                                      ; preds = %cond.end6265
  %call6303 = call i32 @DisposeObject(ptr noundef nonnull %804) #6
  br label %if.end6305

if.end6305:                                       ; preds = %cond.end6265, %if.then6302, %if.end6038
  %806 = load i32, ptr @ttop, align 4
  %inc6306 = add nsw i32 %806, 1
  store i32 %inc6306, ptr @ttop, align 4
  %cmp6307 = icmp slt i32 %806, 99
...
if.then6309:                                      ; preds = %if.end6305
  ...
  store ptr %call5890, ptr %arrayidx6311, align 8
  br label %if.end6511

if.else6312:                                      ; preds = %if.end6305
  %idxprom6314 = zext i32 %806 to i64
  %arrayidx6315 = getelementptr inbounds [100 x ptr], ptr @tok_stack, i64 0, i64 %idxprom6314
  %807 = load ptr, ptr %arrayidx6315, align 8
  %ou16316 = getelementptr inbounds %struct.word_type, ptr %807, i64 0, i32 1
...
if.else6319:                                      ; preds = %if.then5896
  store ptr %call5890, ptr @zz_hold, align 8
  %808 = load i32, ptr @otop, align 4
  %inc6320 = add nsw i32 %808, 1
  store i32 %inc6320, ptr @otop, align 4
  %cmp6321 = icmp slt i32 %808, 99
...
if.then6323:                                      ; preds = %if.else6319
  ...
  store ptr %call5890, ptr %arrayidx6325, align 8
  br label %if.end6511

if.else6326:                                      ; preds = %if.else6319
  %idxprom6328 = zext i32 %808 to i64
  %arrayidx6329 = getelementptr inbounds [100 x ptr], ptr @obj_stack, i64 0, i64 %idxprom6328
  %809 = load ptr, ptr %arrayidx6329, align 8
  %ou16330 = getelementptr inbounds %struct.word_type, ptr %809, i64 0, i32 1
...
if.end6476:                                       ; preds = %if.end5886
  %810 = load i32, ptr @ttop, align 4
  %inc6477 = add nsw i32 %810, 1
  store i32 %inc6477, ptr @ttop, align 4
  %cmp6478 = icmp slt i32 %810, 99
...
if.then6480:                                      ; preds = %if.end6476
  ...
  store ptr %call5890, ptr %arrayidx6482, align 8
  br label %if.end6489

if.else6483:                                      ; preds = %if.end6476
  %idxprom6485 = zext i32 %810 to i64
  %arrayidx6486 = getelementptr inbounds [100 x ptr], ptr @tok_stack, i64 0, i64 %idxprom6485
  %811 = load ptr, ptr %arrayidx6486, align 8
  %ou16487 = getelementptr inbounds %struct.word_type, ptr %811, i64 0, i32 1
...
if.end6489:                                       ; preds = %if.else6483, %if.then6480
  ...
  %812 = and i24 %bf.load6492, 8
  %tobool6496.not = icmp eq i24 %812, 0
  br i1 %tobool6496.not, label %if.else6498, label %if.end6511

if.else6498:                                      ; preds = %if.end6489
  %call6499 = call fastcc i32 @Reduce()
  %813 = load i32, ptr @ttop, align 4
  %cmp6500 = icmp eq i32 %813, %0
...
if.end6511:                                       ; preds = %if.end6489, %if.then6323, %if.else6326, %if.then6309, %if.else6312, %while.end5633, %lor.lhs.false5579, %if.else6498, %land.lhs.true5649, %land.lhs.true5568, %land.lhs.true5553, %if.end5551
  ...
  %814 = load ptr, ptr %ofilter6512, align 8
  %cmp6513.not = icmp eq ptr %814, null
  br i1 %cmp6513.not, label %if.else6851, label %if.then6515

if.then6515:                                      ; preds = %if.end6511
  %815 = load ptr, ptr %t, align 8
  %ou16516 = getelementptr inbounds %struct.word_type, ptr %815, i64 0, i32 1
  %816 = load i8, ptr %ou16516, align 8
  switch i8 %816, label %if.else6846 [
    i8 104, label %if.then6527
    i8 102, label %if.then6527
  ]

if.then6527:                                      ; preds = %if.then6515, %if.then6515
  %cmp6531 = icmp eq i8 %816, 104
...
if.then6536:                                      ; preds = %if.then6527
  %817 = load ptr, ptr %t, align 8
  %ohspace6540 = getelementptr inbounds i8, ptr %817, i64 41
  %818 = load i8, ptr %ohspace6540, align 1
  %conv6541 = zext i8 %818 to i32
  %ovspace6543 = getelementptr inbounds i8, ptr %817, i64 42
  %819 = load i8, ptr %ovspace6543, align 2
  %conv6544 = zext i8 %819 to i32
...
if.else6549:                                      ; preds = %if.then6536
  %ou16550 = getelementptr inbounds %struct.word_type, ptr %817, i64 0, i32 1
  %820 = load i8, ptr %ou16550, align 8
  %cmp6553 = icmp eq i8 %820, 102
...
land.rhs6564:                                     ; preds = %if.end6561, %while.body6573
  %821 = load i32, ptr @ttop, align 4
  %idxprom6565 = sext i32 %821 to i64
  %arrayidx6566 = getelementptr inbounds [100 x ptr], ptr @tok_stack, i64 0, i64 %idxprom6565
  %822 = load ptr, ptr %arrayidx6566, align 8
  %ou26567 = getelementptr inbounds %struct.word_type, ptr %822, i64 0, i32 2
  %823 = load i8, ptr %ou26567, align 8
  %cmp6570.not = icmp ugt i8 %prec6538.0, %823
  br i1 %cmp6570.not, label %if.then6577, label %while.body6573

while.body6573:                                   ; preds = %land.rhs6564
  %call6574 = call fastcc i32 @Reduce()
  %tobool6563.not = icmp eq i32 %call6574, 0
  br i1 %tobool6563.not, label %if.end6676, label %land.rhs6564
...
if.then6577:                                      ; preds = %land.rhs6564
  ...
  %824 = load i8, ptr %arrayidx6579, align 1
  %conv6580 = zext i8 %824 to i32
  store i32 %conv6580, ptr @zz_size, align 4
  %conv6581 = zext i8 %824 to i64
  %arrayidx6588 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv6581
  %825 = load ptr, ptr %arrayidx6588, align 8
  %cmp6589 = icmp eq ptr %825, null
  br i1 %cmp6589, label %if.then6591, label %if.else6593

if.then6591:                                      ; preds = %if.then6577
  %826 = load ptr, ptr @no_fpos, align 8
  %call6592 = call ptr @GetMemory(i32 noundef %conv6580, ptr noundef %826) #6
  store ptr %call6592, ptr @zz_hold, align 8
  %.pre8292 = load i32, ptr @ttop, align 4
  br label %if.end6602

if.else6593:                                      ; preds = %if.then6577
  store ptr %825, ptr @zz_hold, align 8
  %827 = load ptr, ptr %825, align 8
  store ptr %827, ptr %arrayidx6588, align 8
  br label %if.end6602

if.end6602:                                       ; preds = %if.then6591, %if.else6593
  %828 = phi i32 [ %.pre8292, %if.then6591 ], [ %821, %if.else6593 ]
  %829 = phi ptr [ %call6592, %if.then6591 ], [ %825, %if.else6593 ]
  %conv6603 = trunc i32 %typ6537.0 to i8
  %ou16604 = getelementptr inbounds %struct.word_type, ptr %829, i64 0, i32 1
  store i8 %conv6603, ptr %ou16604, align 8
  %osucc6608 = getelementptr inbounds [2 x %struct.LIST], ptr %829, i64 0, i64 1, i32 1
  store ptr %829, ptr %osucc6608, align 8
  %arrayidx6610 = getelementptr inbounds [2 x %struct.LIST], ptr %829, i64 0, i64 1
  store ptr %829, ptr %arrayidx6610, align 8
  %osucc6614 = getelementptr inbounds %struct.LIST, ptr %829, i64 0, i32 1
  store ptr %829, ptr %osucc6614, align 8
  store ptr %829, ptr %829, align 8
  %ou26619 = getelementptr inbounds %struct.word_type, ptr %829, i64 0, i32 2
  store i8 %prec6538.0, ptr %ou26619, align 8
  %830 = load ptr, ptr %t, align 8
  %ovspace6622 = getelementptr inbounds i8, ptr %830, i64 42
  %831 = load i8, ptr %ovspace6622, align 2
  %ovspace6624 = getelementptr inbounds i8, ptr %829, i64 42
  store i8 %831, ptr %ovspace6624, align 2
  %ohspace6626 = getelementptr inbounds i8, ptr %830, i64 41
  %832 = load i8, ptr %ohspace6626, align 1
  %ohspace6628 = getelementptr inbounds i8, ptr %829, i64 41
  store i8 %832, ptr %ohspace6628, align 1
  %ogap6629 = getelementptr inbounds %struct.gapobj_type, ptr %829, i64 0, i32 3
  ...
  %ofile_num6638 = getelementptr inbounds %struct.word_type, ptr %830, i64 0, i32 1, i32 0, i32 2
  %833 = load i16, ptr %ofile_num6638, align 2
  %ofile_num6640 = getelementptr inbounds %struct.word_type, ptr %829, i64 0, i32 1, i32 0, i32 2
  store i16 %833, ptr %ofile_num6640, align 2
  %oline_num6642 = getelementptr inbounds %struct.word_type, ptr %830, i64 0, i32 1, i32 0, i32 3
  %bf.load6643 = load i32, ptr %oline_num6642, align 4
  %bf.clear6644 = and i32 %bf.load6643, 1048575
  %oline_num6646 = getelementptr inbounds %struct.word_type, ptr %829, i64 0, i32 1, i32 0, i32 3
  ...
  %inc6662 = add nsw i32 %828, 1
  store i32 %inc6662, ptr @ttop, align 4
  %cmp6663 = icmp slt i32 %828, 99
...
if.then6665:                                      ; preds = %if.end6602
  ...
  store ptr %829, ptr %arrayidx6667, align 8
  br label %if.end6676

if.else6668:                                      ; preds = %if.end6602
  %idxprom6670 = zext i32 %828 to i64
  %arrayidx6671 = getelementptr inbounds [100 x ptr], ptr @tok_stack, i64 0, i64 %idxprom6670
  %834 = load ptr, ptr %arrayidx6671, align 8
  %ou16672 = getelementptr inbounds %struct.word_type, ptr %834, i64 0, i32 1
...
if.end6676:                                       ; preds = %while.body6573, %if.else6668, %if.then6665, %if.then6527
  %tmp.7 = phi ptr [ %call6534, %if.then6527 ], [ %829, %if.then6665 ], [ %829, %if.else6668 ], [ %call6534, %while.body6573 ]
  %835 = load i32, ptr @ttop, align 4
  %inc6677 = add nsw i32 %835, 1
  store i32 %inc6677, ptr @ttop, align 4
  %cmp6678 = icmp slt i32 %835, 99
  br i1 %cmp6678, label %if.then6680, label %if.else6683

if.then6680:                                      ; preds = %if.end6676
  %836 = load ptr, ptr %t, align 8
  %idxprom6681 = sext i32 %inc6677 to i64
  %arrayidx6682 = getelementptr inbounds [100 x ptr], ptr @tok_stack, i64 0, i64 %idxprom6681
  store ptr %836, ptr %arrayidx6682, align 8
  br label %if.end6831

if.else6683:                                      ; preds = %if.end6676
  %idxprom6685 = zext i32 %835 to i64
  %arrayidx6686 = getelementptr inbounds [100 x ptr], ptr @tok_stack, i64 0, i64 %idxprom6685
  %837 = load ptr, ptr %arrayidx6686, align 8
  %ou16687 = getelementptr inbounds %struct.word_type, ptr %837, i64 0, i32 1
...
if.end6831:                                       ; preds = %if.then6680, %if.else6683
  store ptr %tmp.7, ptr @zz_hold, align 8
  %838 = load i32, ptr @otop, align 4
  %inc6832 = add nsw i32 %838, 1
  store i32 %inc6832, ptr @otop, align 4
  %cmp6833 = icmp slt i32 %838, 99
...
if.then6835:                                      ; preds = %if.end6831
  ...
  store ptr %tmp.7, ptr %arrayidx6837, align 8
  br label %if.end6844

if.else6838:                                      ; preds = %if.end6831
  %idxprom6840 = zext i32 %838 to i64
  %arrayidx6841 = getelementptr inbounds [100 x ptr], ptr @obj_stack, i64 0, i64 %idxprom6840
  %839 = load ptr, ptr %arrayidx6841, align 8
  %ou16842 = getelementptr inbounds %struct.word_type, ptr %839, i64 0, i32 1
...
if.end6844:                                       ; preds = %if.else6838, %if.then6835
  ...
  store ptr %call6845, ptr %t, align 8
  br label %for.cond449.backedge
...
if.else6851:                                      ; preds = %if.end6511
  ...
  %840 = and i24 %bf.load6853, 256
  %tobool6857.not = icmp eq i24 %840, 0
  br i1 %tobool6857.not, label %for.cond449.backedge, label %if.then6858

if.then6858:                                      ; preds = %if.else6851
  %841 = load ptr, ptr %t, align 8
  %ou16859 = getelementptr inbounds %struct.word_type, ptr %841, i64 0, i32 1
  %842 = load i8, ptr %ou16859, align 8
  switch i8 %842, label %if.else6892 [
...
if.then6870:                                      ; preds = %if.then6858, %if.then6858
  ...
  store ptr %call6872, ptr @zz_hold, align 8
  %843 = load i32, ptr @otop, align 4
  %inc6873 = add nsw i32 %843, 1
  store i32 %inc6873, ptr @otop, align 4
  %cmp6874 = icmp slt i32 %843, 99
...
if.then6876:                                      ; preds = %if.then6870
  ...
  store ptr %call6872, ptr %arrayidx6878, align 8
  br label %if.end6885

if.else6879:                                      ; preds = %if.then6870
  %idxprom6881 = zext i32 %843 to i64
  %arrayidx6882 = getelementptr inbounds [100 x ptr], ptr @obj_stack, i64 0, i64 %idxprom6881
  %844 = load ptr, ptr %arrayidx6882, align 8
  %ou16883 = getelementptr inbounds %struct.word_type, ptr %844, i64 0, i32 1
...
if.end6885:                                       ; preds = %if.else6879, %if.then6876
  %call6886 = call fastcc i32 @Reduce()
  call void @PopScope() #6
  call void @PopScope() #6
  %845 = load ptr, ptr %t, align 8
  %cmp6887 = icmp eq ptr %845, null
  br i1 %cmp6887, label %if.then6889, label %for.cond449.backedge

if.then6889:                                      ; preds = %if.end6885
  %call6890 = call ptr @LexGetToken() #6
  store ptr %call6890, ptr %t, align 8
  br label %for.cond449.backedge
...
if.then6902:                                      ; preds = %for.cond6900
  %846 = load ptr, ptr %t, align 8
  %ou16903 = getelementptr inbounds %struct.word_type, ptr %846, i64 0, i32 1
  %call6904 = call ptr @MakeWord(i32 noundef 11, ptr noundef nonnull @.str.27, ptr noundef nonnull %ou16903) #6
  store ptr %call6904, ptr @zz_hold, align 8
  %847 = load i32, ptr @otop, align 4
  %inc6905 = add nsw i32 %847, 1
  store i32 %inc6905, ptr @otop, align 4
  %cmp6906 = icmp slt i32 %847, 99
...
if.then6908:                                      ; preds = %if.then6902
  ...
  store ptr %call6904, ptr %arrayidx6910, align 8
...
if.else6911:                                      ; preds = %if.then6902
  %idxprom6913 = zext i32 %847 to i64
  %arrayidx6914 = getelementptr inbounds [100 x ptr], ptr @obj_stack, i64 0, i64 %idxprom6913
  %848 = load ptr, ptr %arrayidx6914, align 8
  %ou16915 = getelementptr inbounds %struct.word_type, ptr %848, i64 0, i32 1
...
if.else6918:                                      ; preds = %for.cond6900
  %849 = load i32, ptr @ttop, align 4
  %idxprom6919 = sext i32 %849 to i64
  %arrayidx6920 = getelementptr inbounds [100 x ptr], ptr @tok_stack, i64 0, i64 %idxprom6919
  %850 = load ptr, ptr %arrayidx6920, align 8
  %ou26921 = getelementptr inbounds %struct.word_type, ptr %850, i64 0, i32 2
  %851 = load i8, ptr %ou26921, align 8
  %852 = load ptr, ptr %t, align 8
  %ou26924 = getelementptr inbounds %struct.word_type, ptr %852, i64 0, i32 2
  %853 = load i8, ptr %ou26924, align 8
  %cmp6928.not.not = icmp ult i8 %853, %851
  br i1 %cmp6928.not.not, label %if.then6930, label %for.end6942

if.then6930:                                      ; preds = %if.else6918
  %call6931 = call fastcc i32 @Reduce()
  %854 = load i32, ptr @ttop, align 4
  %cmp6932 = icmp eq i32 %854, %0
  br i1 %cmp6932, label %if.then6934, label %for.cond6900.backedge

if.then6934:                                      ; preds = %if.then6930
  %855 = load ptr, ptr %t, align 8
  br label %cleanup7215

for.end6942:                                      ; preds = %if.else6918
  %inc6943 = add nsw i32 %849, 1
  store i32 %inc6943, ptr @ttop, align 4
  %cmp6944 = icmp slt i32 %849, 99
...
if.then6946:                                      ; preds = %for.end6942
  ...
  store ptr %852, ptr %arrayidx6948, align 8
  br label %if.end6955

if.else6949:                                      ; preds = %for.end6942
  %ou16953 = getelementptr inbounds %struct.word_type, ptr %850, i64 0, i32 1
...
if.end6955:                                       ; preds = %if.else6949, %if.then6946
  %856 = load i32, ptr @otop, align 4
  %idxprom6956 = sext i32 %856 to i64
  %arrayidx6957 = getelementptr inbounds [100 x ptr], ptr @obj_stack, i64 0, i64 %idxprom6956
  %857 = load ptr, ptr %arrayidx6957, align 8
  %ou16958 = getelementptr inbounds %struct.word_type, ptr %857, i64 0, i32 1
  %858 = load i8, ptr %ou16958, align 8
  switch i8 %858, label %if.end7023.thread [
...
land.lhs.true6983:                                ; preds = %if.end6955, %if.end6955
  %osucc6988 = getelementptr inbounds %struct.LIST, ptr %857, i64 0, i32 1
  %859 = load ptr, ptr %osucc6988, align 8
  %cmp6991.not = icmp eq ptr %859, %857
  br i1 %cmp6991.not, label %if.end7023.thread, label %for.cond7002

for.cond7002:                                     ; preds = %land.lhs.true6983, %for.cond7002
  %.pn = phi ptr [ %tmp.10, %for.cond7002 ], [ %859, %land.lhs.true6983 ]
  %tmp.10.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn, i64 0, i64 1
  %tmp.10 = load ptr, ptr %tmp.10.in, align 8
  %ou17003 = getelementptr inbounds %struct.word_type, ptr %tmp.10, i64 0, i32 1
  %860 = load i8, ptr %ou17003, align 8
  switch i8 %860, label %if.end7023.thread [
...
if.else7030:                                      ; preds = %if.end7023
  ...
  %861 = load i8, ptr %ou17031, align 8
  switch i8 %861, label %if.then7042 [
...
if.else7045:                                      ; preds = %if.else7030, %if.else7030
  ...
  store ptr %call7046, ptr @zz_hold, align 8
  %862 = load i32, ptr @otop, align 4
  %inc7189 = add nsw i32 %862, 1
  store i32 %inc7189, ptr @otop, align 4
  %cmp7190 = icmp slt i32 %862, 99
...
if.then7192:                                      ; preds = %if.else7045
  ...
  store ptr %call7046, ptr %arrayidx7194, align 8
  br label %if.end7201

if.else7195:                                      ; preds = %if.else7045
  %idxprom7197 = zext i32 %862 to i64
  %arrayidx7198 = getelementptr inbounds [100 x ptr], ptr @obj_stack, i64 0, i64 %idxprom7197
  %863 = load ptr, ptr %arrayidx7198, align 8
  %ou17199 = getelementptr inbounds %struct.word_type, ptr %863, i64 0, i32 1
...
if.end7201:                                       ; preds = %if.else7195, %if.then7192
  call void @PopScope() #6
  %864 = load ptr, ptr %t, align 8
  %cmp7202 = icmp eq ptr %864, null
  br i1 %cmp7202, label %if.then7204, label %if.end7206

if.then7204:                                      ; preds = %if.end7201
  %call7205 = call ptr @LexGetToken() #6
  store ptr %call7205, ptr %t, align 8
  br label %if.end7206

if.end7206:                                       ; preds = %if.then7204, %if.end7201
  %call7207 = call fastcc i32 @Reduce()
  br label %for.cond449.backedge

sw.default:                                       ; preds = %for.cond449
  %conv452 = zext i8 %50 to i32
  %865 = load ptr, ptr @no_fpos, align 8
  %call7213 = call ptr @Image(i32 noundef %conv452) #6
  %call7214 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 3, ptr noundef nonnull @.str.55, i32 noundef 0, ptr noundef %865, ptr noundef nonnull @.str.56, ptr noundef %call7213) #6
  br label %for.cond449.backedge
...
cleanup7215:                                      ; preds = %if.else6498, %if.else4973, %if.end2905, %if.end2833, %if.else2419, %if.else1841, %if.else1611, %if.then4795, %if.then6934, %if.then2884, %if.then2812, %if.then2244, %if.then1666, %if.then1437, %if.then832
  %.sink = phi ptr [ %855, %if.then6934 ], [ %351, %if.then2884 ], [ %340, %if.then2812 ], [ %256, %if.then2244 ], [ %189, %if.then1666 ], [ %152, %if.then1437 ], [ %105, %if.then832 ], [ %571, %if.then4795 ], [ null, %if.else1611 ], [ null, %if.else1841 ], [ null, %if.else2419 ], [ null, %if.end2833 ], [ null, %if.end2905 ], [ null, %if.else4973 ], [ null, %if.else6498 ]
  store ptr %.sink, ptr %token, align 8
  %866 = load i32, ptr @otop, align 4
  %dec6935 = add nsw i32 %866, -1
  store i32 %dec6935, ptr @otop, align 4
  %idxprom6936 = sext i32 %866 to i64
  %arrayidx6937 = getelementptr inbounds [100 x ptr], ptr @obj_stack, i64 0, i64 %idxprom6936
  %retval.0 = load ptr, ptr %arrayidx6937, align 8
...
entry:
  %0 = load i32, ptr @ttop, align 4
  %dec = add nsw i32 %0, -1
  store i32 %dec, ptr @ttop, align 4
...
sw.bb:                                            ; preds = %entry, %entry
  %3 = load i32, ptr @otop, align 4
  %dec1 = add nsw i32 %3, -1
  store i32 %dec1, ptr @otop, align 4
  ...
  %5 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 5), align 1
  %conv4 = zext i8 %5 to i32
  store i32 %conv4, ptr @zz_size, align 4
...
if.end19:                                         ; preds = %if.then11, %if.else13
  ...
  store ptr %9, ptr %osucc29, align 8
  store ptr %9, ptr %9, align 8
  store ptr %9, ptr @zz_hold, align 8
  %10 = load i32, ptr @otop, align 4
  %inc = add nsw i32 %10, 1
  store i32 %inc, ptr @otop, align 4
...
if.then35:                                        ; preds = %if.end19
  ...
  store ptr %9, ptr %arrayidx37, align 8
  br label %if.end43
...
if.end43:                                         ; preds = %if.else38, %if.then35
  ...
  %13 = load ptr, ptr %arrayidx62, align 8
  store ptr %13, ptr %1, align 8
  %14 = load ptr, ptr @zz_hold, align 8
  %15 = load i32, ptr @zz_size, align 4
  %idxprom66 = sext i32 %15 to i64
  %arrayidx67 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom66
  store ptr %14, ptr %arrayidx67, align 8
  br label %sw.epilog

sw.bb68:                                          ; preds = %entry
  %16 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 5), align 1
  %conv69 = zext i8 %16 to i32
  store i32 %conv69, ptr @zz_size, align 4
  %conv70 = zext i8 %16 to i64
  %arrayidx77 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv70
  %17 = load ptr, ptr %arrayidx77, align 8
...
if.else82:                                        ; preds = %sw.bb68
  ...
  store ptr %19, ptr %arrayidx77, align 8
  br label %if.end91
...
if.then109:                                       ; preds = %if.end91
  ...
  store ptr %20, ptr %arrayidx111, align 8
  br label %if.end118
...
sw.bb149:                                         ; preds = %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry, %entry
  ...
  %27 = load ptr, ptr %oactual, align 8
...
if.else167:                                       ; preds = %if.then150
  ...
  store ptr %34, ptr %arrayidx162, align 8
  br label %cond.end222
...
if.else282:                                       ; preds = %if.then265
  ...
  store ptr %55, ptr %arrayidx277, align 8
  br label %if.end291
...
if.end291:                                        ; preds = %if.then280, %if.else282
  ...
  %57 = load ptr, ptr %osucc308, align 8
...
cond.false316:                                    ; preds = %if.end291
  ...
  store ptr %60, ptr %osucc331, align 8
  ...
  store ptr %64, ptr %osucc337, align 8
  %.pre2828 = load ptr, ptr @xx_link, align 8
...
if.then379:                                       ; preds = %if.end375
  ...
  store ptr %1, ptr %arrayidx381, align 8
  br label %sw.epilog
...
if.else382:                                       ; preds = %if.end375
  ...
  %71 = load ptr, ptr %arrayidx385, align 8
...
sw.bb389:                                         ; preds = %entry
  ...
  %72 = load ptr, ptr %oactual390, align 8
...
if.else415:                                       ; preds = %if.then398
  ...
  store ptr %79, ptr %arrayidx410, align 8
  br label %cond.end470
...
cond.end470:                                      ; preds = %if.then413, %if.else415
  ...
  store i8 0, ptr %ou1425, align 8
  %osucc429 = getelementptr inbounds [2 x %struct.LIST], ptr %80, i64 0, i64 1, i32 1
  store ptr %80, ptr %osucc429, align 8
  %arrayidx431 = getelementptr inbounds [2 x %struct.LIST], ptr %80, i64 0, i64 1
  store ptr %80, ptr %arrayidx431, align 8
  %osucc435 = getelementptr inbounds %struct.LIST, ptr %80, i64 0, i32 1
  store ptr %80, ptr %osucc435, align 8
  store ptr %80, ptr %80, align 8
  store ptr %80, ptr @xx_link, align 8
  store ptr %80, ptr @zz_res, align 8
  store ptr %1, ptr @zz_hold, align 8
  %81 = load ptr, ptr %1, align 8
  store ptr %81, ptr @zz_tmp, align 8
  %82 = load ptr, ptr %80, align 8
  store ptr %82, ptr %1, align 8
  %83 = load ptr, ptr @zz_hold, align 8
  %84 = load ptr, ptr @zz_res, align 8
  %85 = load ptr, ptr %84, align 8
  %osucc461 = getelementptr inbounds %struct.LIST, ptr %85, i64 0, i32 1
  store ptr %83, ptr %osucc461, align 8
  %86 = load ptr, ptr @zz_tmp, align 8
  store ptr %86, ptr %84, align 8
  %87 = load ptr, ptr @zz_res, align 8
  %88 = load ptr, ptr @zz_tmp, align 8
  %osucc467 = getelementptr inbounds %struct.LIST, ptr %88, i64 0, i32 1
  store ptr %87, ptr %osucc467, align 8
  %89 = load ptr, ptr @xx_link, align 8
  store ptr %89, ptr @zz_res, align 8
  store ptr %75, ptr @zz_hold, align 8
...
cond.false479:                                    ; preds = %cond.end470
  ...
  %90 = load ptr, ptr %arrayidx481, align 8
  store ptr %90, ptr @zz_tmp, align 8
  %arrayidx484 = getelementptr inbounds [2 x %struct.LIST], ptr %89, i64 0, i64 1
  %91 = load ptr, ptr %arrayidx484, align 8
  store ptr %91, ptr %arrayidx481, align 8
  %92 = load ptr, ptr %arrayidx484, align 8
  %osucc494 = getelementptr inbounds [2 x %struct.LIST], ptr %92, i64 0, i64 1, i32 1
  store ptr %75, ptr %osucc494, align 8
  store ptr %90, ptr %arrayidx484, align 8
  %osucc500 = getelementptr inbounds [2 x %struct.LIST], ptr %90, i64 0, i64 1, i32 1
  store ptr %89, ptr %osucc500, align 8
  br label %if.end505

if.end505:                                        ; preds = %cond.end470, %cond.false479, %sw.bb389
  %93 = load ptr, ptr %oactual390, align 8
...
if.else531:                                       ; preds = %if.then514
  ...
  store ptr %100, ptr %arrayidx526, align 8
  br label %if.end540
...
cond.false565:                                    ; preds = %if.end540
  ...
  %105 = load ptr, ptr @zz_hold, align 8
  %106 = load ptr, ptr @zz_res, align 8
  %107 = load ptr, ptr %106, align 8
  %osucc580 = getelementptr inbounds %struct.LIST, ptr %107, i64 0, i32 1
  store ptr %105, ptr %osucc580, align 8
  %108 = load ptr, ptr @zz_tmp, align 8
  store ptr %108, ptr %106, align 8
  %109 = load ptr, ptr @zz_res, align 8
  %110 = load ptr, ptr @zz_tmp, align 8
  %osucc586 = getelementptr inbounds %struct.LIST, ptr %110, i64 0, i32 1
  store ptr %109, ptr %osucc586, align 8
  %.pre2827 = load ptr, ptr @xx_link, align 8
...
cond.false598:                                    ; preds = %cond.end589
  ...
  %112 = load ptr, ptr %arrayidx600, align 8
  store ptr %112, ptr @zz_tmp, align 8
  %arrayidx603 = getelementptr inbounds [2 x %struct.LIST], ptr %111, i64 0, i64 1
  %113 = load ptr, ptr %arrayidx603, align 8
  store ptr %113, ptr %arrayidx600, align 8
  %114 = load ptr, ptr %arrayidx603, align 8
  %osucc613 = getelementptr inbounds [2 x %struct.LIST], ptr %114, i64 0, i64 1, i32 1
  store ptr %96, ptr %osucc613, align 8
  store ptr %112, ptr %arrayidx603, align 8
  %osucc619 = getelementptr inbounds [2 x %struct.LIST], ptr %112, i64 0, i64 1, i32 1
  store ptr %111, ptr %osucc619, align 8
...
cond.end622:                                      ; preds = %cond.end589, %cond.false598
  ...
  %115 = load i8, ptr %ou1624, align 8
...
if.end632:                                        ; preds = %cond.end622, %if.then629, %if.end505
  ...
  store ptr %op.0, ptr @zz_hold, align 8
  %116 = load i32, ptr @otop, align 4
  %inc633 = add nsw i32 %116, 1
  store i32 %inc633, ptr @otop, align 4
...
if.then636:                                       ; preds = %if.end632
  ...
  store ptr %op.0, ptr %arrayidx638, align 8
  br label %sw.epilog
...
if.else639:                                       ; preds = %if.end632
  ...
  %117 = load ptr, ptr %arrayidx642, align 8
...
cond.end718:                                      ; preds = %if.then661, %if.else663
  ...
  %128 = load ptr, ptr @zz_res, align 8
  %129 = load ptr, ptr %128, align 8
  %osucc709 = getelementptr inbounds %struct.LIST, ptr %129, i64 0, i32 1
  store ptr %127, ptr %osucc709, align 8
  %130 = load ptr, ptr @zz_tmp, align 8
  store ptr %130, ptr %128, align 8
  %131 = load ptr, ptr @zz_res, align 8
  %132 = load ptr, ptr @zz_tmp, align 8
  %osucc715 = getelementptr inbounds %struct.LIST, ptr %132, i64 0, i32 1
  store ptr %131, ptr %osucc715, align 8
  %133 = load ptr, ptr @xx_link, align 8
...
if.else769:                                       ; preds = %cond.end751
  ...
  store ptr %142, ptr %arrayidx764, align 8
  br label %if.end778
...
cond.false836:                                    ; preds = %cond.end827
  ...
  %154 = load ptr, ptr %arrayidx838, align 8
  store ptr %154, ptr @zz_tmp, align 8
  %arrayidx841 = getelementptr inbounds [2 x %struct.LIST], ptr %153, i64 0, i64 1
  %155 = load ptr, ptr %arrayidx841, align 8
  store ptr %155, ptr %arrayidx838, align 8
  %156 = load ptr, ptr %arrayidx841, align 8
  %osucc851 = getelementptr inbounds [2 x %struct.LIST], ptr %156, i64 0, i64 1, i32 1
  store ptr %138, ptr %osucc851, align 8
  store ptr %154, ptr %arrayidx841, align 8
  %osucc857 = getelementptr inbounds [2 x %struct.LIST], ptr %154, i64 0, i64 1, i32 1
  store ptr %153, ptr %osucc857, align 8
...
if.end874:                                        ; preds = %if.then867, %cond.end860
  store ptr %1, ptr @zz_hold, align 8
  %159 = load i32, ptr @otop, align 4
  %inc875 = add nsw i32 %159, 1
  store i32 %inc875, ptr @otop, align 4
...
if.then878:                                       ; preds = %if.end874
  ...
  store ptr %1, ptr %arrayidx880, align 8
  br label %sw.epilog
...
if.else881:                                       ; preds = %if.end874
  ...
  %160 = load ptr, ptr %arrayidx884, align 8
...
sw.bb888:                                         ; preds = %entry
  ...
  %161 = load ptr, ptr %oactual889, align 8
...
if.end920:                                        ; preds = %if.then909, %if.else911
  ...
  store i8 10, ptr %ou1921, align 8
  ...
  store ptr %167, ptr %osucc925, align 8
  store ptr %167, ptr %arrayidx924, align 8
  %osucc931 = getelementptr inbounds %struct.LIST, ptr %167, i64 0, i32 1
  store ptr %167, ptr %osucc931, align 8
  store ptr %167, ptr %167, align 8
  %168 = load i32, ptr @otop, align 4
  %dec935 = add nsw i32 %168, -1
  store i32 %dec935, ptr @otop, align 4
  %idxprom936 = sext i32 %168 to i64
  %arrayidx937 = getelementptr inbounds [100 x ptr], ptr @obj_stack, i64 0, i64 %idxprom936
  %169 = load ptr, ptr %arrayidx937, align 8
  %170 = load i8, ptr @zz_lengths, align 1
  %conv938 = zext i8 %170 to i32
  store i32 %conv938, ptr @zz_size, align 4
  %conv939 = zext i8 %170 to i64
  %arrayidx946 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv939
  %171 = load ptr, ptr %arrayidx946, align 8
...
if.else951:                                       ; preds = %if.end920
  store ptr %171, ptr @zz_hold, align 8
  %173 = load ptr, ptr %171, align 8
  store ptr %173, ptr %arrayidx946, align 8
  br label %cond.end1006
...
cond.end1006:                                     ; preds = %if.then949, %if.else951
  ...
  store i8 0, ptr %ou1961, align 8
  %osucc965 = getelementptr inbounds [2 x %struct.LIST], ptr %174, i64 0, i64 1, i32 1
  store ptr %174, ptr %osucc965, align 8
  %arrayidx967 = getelementptr inbounds [2 x %struct.LIST], ptr %174, i64 0, i64 1
  store ptr %174, ptr %arrayidx967, align 8
  %osucc971 = getelementptr inbounds %struct.LIST, ptr %174, i64 0, i32 1
  store ptr %174, ptr %osucc971, align 8
  store ptr %174, ptr %174, align 8
  store ptr %174, ptr @xx_link, align 8
  store ptr %174, ptr @zz_res, align 8
  store ptr %167, ptr @zz_hold, align 8
  %175 = load ptr, ptr %167, align 8
  store ptr %175, ptr @zz_tmp, align 8
  %176 = load ptr, ptr %174, align 8
  store ptr %176, ptr %167, align 8
  %177 = load ptr, ptr @zz_hold, align 8
  %178 = load ptr, ptr @zz_res, align 8
  %179 = load ptr, ptr %178, align 8
  %osucc997 = getelementptr inbounds %struct.LIST, ptr %179, i64 0, i32 1
  store ptr %177, ptr %osucc997, align 8
  %180 = load ptr, ptr @zz_tmp, align 8
  store ptr %180, ptr %178, align 8
  %181 = load ptr, ptr @zz_res, align 8
  %182 = load ptr, ptr @zz_tmp, align 8
  %osucc1003 = getelementptr inbounds %struct.LIST, ptr %182, i64 0, i32 1
  store ptr %181, ptr %osucc1003, align 8
  %183 = load ptr, ptr @xx_link, align 8
  store ptr %183, ptr @zz_res, align 8
...
cond.false1015:                                   ; preds = %cond.end1006
  ...
  %184 = load ptr, ptr %arrayidx1017, align 8
  store ptr %184, ptr @zz_tmp, align 8
  %arrayidx1020 = getelementptr inbounds [2 x %struct.LIST], ptr %183, i64 0, i64 1
  %185 = load ptr, ptr %arrayidx1020, align 8
  store ptr %185, ptr %arrayidx1017, align 8
  %186 = load ptr, ptr %arrayidx1020, align 8
  %osucc1030 = getelementptr inbounds [2 x %struct.LIST], ptr %186, i64 0, i64 1, i32 1
  store ptr %169, ptr %osucc1030, align 8
  store ptr %184, ptr %arrayidx1020, align 8
  %osucc1036 = getelementptr inbounds [2 x %struct.LIST], ptr %184, i64 0, i64 1, i32 1
  store ptr %183, ptr %osucc1036, align 8
...
cond.end1039:                                     ; preds = %cond.end1006, %cond.false1015
  ...
  %188 = load ptr, ptr %oactual889, align 8
...
if.else1076:                                      ; preds = %cond.end1039
  store ptr %190, ptr @zz_hold, align 8
  %192 = load ptr, ptr %190, align 8
  store ptr %192, ptr %arrayidx1071, align 8
  br label %cond.end1131
...
cond.end1131:                                     ; preds = %if.then1074, %if.else1076
  ...
  store i8 0, ptr %ou11086, align 8
  %osucc1090 = getelementptr inbounds [2 x %struct.LIST], ptr %193, i64 0, i64 1, i32 1
  store ptr %193, ptr %osucc1090, align 8
  %arrayidx1092 = getelementptr inbounds [2 x %struct.LIST], ptr %193, i64 0, i64 1
  store ptr %193, ptr %arrayidx1092, align 8
  %osucc1096 = getelementptr inbounds %struct.LIST, ptr %193, i64 0, i32 1
  store ptr %193, ptr %osucc1096, align 8
  store ptr %193, ptr %193, align 8
  store ptr %193, ptr @xx_link, align 8
  store ptr %193, ptr @zz_res, align 8
  store ptr %1, ptr @zz_hold, align 8
  %194 = load ptr, ptr %1, align 8
  store ptr %194, ptr @zz_tmp, align 8
  %195 = load ptr, ptr %193, align 8
  store ptr %195, ptr %1, align 8
  %196 = load ptr, ptr @zz_hold, align 8
  %197 = load ptr, ptr @zz_res, align 8
  %198 = load ptr, ptr %197, align 8
  %osucc1122 = getelementptr inbounds %struct.LIST, ptr %198, i64 0, i32 1
  store ptr %196, ptr %osucc1122, align 8
  %199 = load ptr, ptr @zz_tmp, align 8
  store ptr %199, ptr %197, align 8
  %200 = load ptr, ptr @zz_res, align 8
  %201 = load ptr, ptr @zz_tmp, align 8
  %osucc1128 = getelementptr inbounds %struct.LIST, ptr %201, i64 0, i32 1
  store ptr %200, ptr %osucc1128, align 8
  %202 = load ptr, ptr @xx_link, align 8
  store ptr %202, ptr @zz_res, align 8
  store ptr %167, ptr @zz_hold, align 8
  %cmp1137 = icmp eq ptr %202, null
  br i1 %cmp1137, label %if.end1166, label %cond.false1140

cond.false1140:                                   ; preds = %cond.end1131
  %203 = load ptr, ptr %arrayidx924, align 8
  store ptr %203, ptr @zz_tmp, align 8
  %arrayidx1145 = getelementptr inbounds [2 x %struct.LIST], ptr %202, i64 0, i64 1
  %204 = load ptr, ptr %arrayidx1145, align 8
  store ptr %204, ptr %arrayidx924, align 8
  %205 = load ptr, ptr %arrayidx1145, align 8
  %osucc1155 = getelementptr inbounds [2 x %struct.LIST], ptr %205, i64 0, i64 1, i32 1
  store ptr %167, ptr %osucc1155, align 8
  store ptr %203, ptr %arrayidx1145, align 8
  %osucc1161 = getelementptr inbounds [2 x %struct.LIST], ptr %203, i64 0, i64 1, i32 1
  store ptr %202, ptr %osucc1161, align 8
  br label %if.end1166

if.end1166:                                       ; preds = %cond.end1131, %cond.false1140, %sw.bb888
  %206 = load ptr, ptr %oactual889, align 8
...
if.then1175:                                      ; preds = %if.end1166
  %208 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 10), align 1
  %conv1176 = zext i8 %208 to i32
  store i32 %conv1176, ptr @zz_size, align 4
  %conv1177 = zext i8 %208 to i64
  %arrayidx1184 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv1177
  %209 = load ptr, ptr %arrayidx1184, align 8
...
if.then1187:                                      ; preds = %if.then1175
  ...
  store ptr %call1188, ptr @zz_hold, align 8
  br label %if.end1198

if.else1189:                                      ; preds = %if.then1175
  store ptr %209, ptr @zz_hold, align 8
  %211 = load ptr, ptr %209, align 8
  store ptr %211, ptr %arrayidx1184, align 8
  br label %if.end1198
...
if.end1198:                                       ; preds = %if.then1187, %if.else1189
  ...
  store i8 10, ptr %ou11199, align 8
...
if.else1229:                                      ; preds = %if.end1198
  store ptr %216, ptr @zz_hold, align 8
  %218 = load ptr, ptr %216, align 8
  store ptr %218, ptr %arrayidx1224, align 8
  br label %cond.end1284
...
cond.end1284:                                     ; preds = %if.then1227, %if.else1229
  ...
  store i8 0, ptr %ou11239, align 8
  %osucc1243 = getelementptr inbounds [2 x %struct.LIST], ptr %219, i64 0, i64 1, i32 1
  store ptr %219, ptr %osucc1243, align 8
  %arrayidx1245 = getelementptr inbounds [2 x %struct.LIST], ptr %219, i64 0, i64 1
  store ptr %219, ptr %arrayidx1245, align 8
  %osucc1249 = getelementptr inbounds %struct.LIST, ptr %219, i64 0, i32 1
  store ptr %219, ptr %osucc1249, align 8
  store ptr %219, ptr %219, align 8
  store ptr %219, ptr @xx_link, align 8
  store ptr %219, ptr @zz_res, align 8
  store ptr %212, ptr @zz_hold, align 8
  %220 = load ptr, ptr %212, align 8
  store ptr %220, ptr @zz_tmp, align 8
  %221 = load ptr, ptr %219, align 8
  store ptr %221, ptr %212, align 8
  %222 = load ptr, ptr @zz_hold, align 8
  %223 = load ptr, ptr @zz_res, align 8
  %224 = load ptr, ptr %223, align 8
  %osucc1275 = getelementptr inbounds %struct.LIST, ptr %224, i64 0, i32 1
  store ptr %222, ptr %osucc1275, align 8
  %225 = load ptr, ptr @zz_tmp, align 8
  store ptr %225, ptr %223, align 8
  %226 = load ptr, ptr @zz_res, align 8
  %227 = load ptr, ptr @zz_tmp, align 8
  %osucc1281 = getelementptr inbounds %struct.LIST, ptr %227, i64 0, i32 1
  store ptr %226, ptr %osucc1281, align 8
  %228 = load ptr, ptr @xx_link, align 8
  store ptr %228, ptr @zz_res, align 8
  store ptr %214, ptr @zz_hold, align 8
...
cond.false1293:                                   ; preds = %cond.end1284
  ...
  %229 = load ptr, ptr %arrayidx1295, align 8
  store ptr %229, ptr @zz_tmp, align 8
  %arrayidx1298 = getelementptr inbounds [2 x %struct.LIST], ptr %228, i64 0, i64 1
  %230 = load ptr, ptr %arrayidx1298, align 8
  store ptr %230, ptr %arrayidx1295, align 8
  %231 = load ptr, ptr %arrayidx1298, align 8
  %osucc1308 = getelementptr inbounds [2 x %struct.LIST], ptr %231, i64 0, i64 1, i32 1
  store ptr %214, ptr %osucc1308, align 8
  store ptr %229, ptr %arrayidx1298, align 8
  %osucc1314 = getelementptr inbounds [2 x %struct.LIST], ptr %229, i64 0, i64 1, i32 1
  store ptr %228, ptr %osucc1314, align 8
...
cond.end1317:                                     ; preds = %cond.end1284, %cond.false1293
  ...
  %233 = load ptr, ptr %oactual889, align 8
...
cond.end1418:                                     ; preds = %if.end1369
  ...
  store ptr %240, ptr @zz_tmp, align 8
  %241 = load ptr, ptr %238, align 8
  store ptr %241, ptr %239, align 8
  %242 = load ptr, ptr @zz_hold, align 8
  %243 = load ptr, ptr @zz_res, align 8
  %244 = load ptr, ptr %243, align 8
  %osucc1409 = getelementptr inbounds %struct.LIST, ptr %244, i64 0, i32 1
  store ptr %242, ptr %osucc1409, align 8
  %245 = load ptr, ptr @zz_tmp, align 8
  store ptr %245, ptr %243, align 8
  %246 = load ptr, ptr @zz_res, align 8
  %247 = load ptr, ptr @zz_tmp, align 8
  %osucc1415 = getelementptr inbounds %struct.LIST, ptr %247, i64 0, i32 1
  store ptr %246, ptr %osucc1415, align 8
  %.pre2825 = load ptr, ptr @xx_link, align 8
  store ptr %.pre2825, ptr @zz_res, align 8
...
cond.false1427:                                   ; preds = %cond.end1418.thread, %cond.end1418
  ...
  %249 = load ptr, ptr %arrayidx1202, align 8
  store ptr %249, ptr @zz_tmp, align 8
  %arrayidx1432 = getelementptr inbounds [2 x %struct.LIST], ptr %248, i64 0, i64 1
  %250 = load ptr, ptr %arrayidx1432, align 8
  store ptr %250, ptr %arrayidx1202, align 8
  %251 = load ptr, ptr %arrayidx1432, align 8
  %osucc1442 = getelementptr inbounds [2 x %struct.LIST], ptr %251, i64 0, i64 1, i32 1
  store ptr %212, ptr %osucc1442, align 8
  store ptr %249, ptr %arrayidx1432, align 8
  %osucc1448 = getelementptr inbounds [2 x %struct.LIST], ptr %249, i64 0, i64 1, i32 1
  store ptr %248, ptr %osucc1448, align 8
  br label %if.end1453

if.end1453:                                       ; preds = %cond.end1418, %cond.false1427, %if.end1166
  store ptr %1, ptr @zz_hold, align 8
  %252 = load i32, ptr @otop, align 4
  %inc1454 = add nsw i32 %252, 1
  store i32 %inc1454, ptr @otop, align 4
...
if.then1457:                                      ; preds = %if.end1453
  ...
  store ptr %1, ptr %arrayidx1459, align 8
  br label %sw.epilog
...
if.else1460:                                      ; preds = %if.end1453
  ...
  %253 = load ptr, ptr %arrayidx1463, align 8
...
sw.bb1467:                                        ; preds = %entry
  ...
  store ptr %256, ptr %arrayidx1499, align 8
  br label %sw.epilog

sw.bb1500:                                        ; preds = %entry
  %258 = load ptr, ptr @no_fpos, align 8
...
sw.bb1502:                                        ; preds = %entry
  ...
  %259 = load ptr, ptr %arrayidx1504, align 8
  %ou11505 = getelementptr inbounds %struct.word_type, ptr %259, i64 0, i32 1
  %260 = load i8, ptr %ou11505, align 8
...
if.else1571:                                      ; preds = %sw.bb1502
  %265 = load ptr, ptr @no_fpos, align 8
...
cond.false1649:                                   ; preds = %if.then1641
  ...
  %.pre2824 = load ptr, ptr %arrayidx1657.phi.trans.insert, align 8
...
cond.end1813:                                     ; preds = %if.then1756, %if.else1758
  ...
  store i8 0, ptr %ou11768, align 8
  %osucc1772 = getelementptr inbounds [2 x %struct.LIST], ptr %300, i64 0, i64 1, i32 1
  store ptr %300, ptr %osucc1772, align 8
  %arrayidx1774 = getelementptr inbounds [2 x %struct.LIST], ptr %300, i64 0, i64 1
  store ptr %300, ptr %arrayidx1774, align 8
  %osucc1778 = getelementptr inbounds %struct.LIST, ptr %300, i64 0, i32 1
  store ptr %300, ptr %osucc1778, align 8
  store ptr %300, ptr %300, align 8
  store ptr %300, ptr @xx_link, align 8
  store ptr %300, ptr @zz_res, align 8
  store ptr %1, ptr @zz_hold, align 8
  %301 = load ptr, ptr %1, align 8
  store ptr %301, ptr @zz_tmp, align 8
  %302 = load ptr, ptr %300, align 8
  store ptr %302, ptr %1, align 8
  %303 = load ptr, ptr @zz_hold, align 8
  %304 = load ptr, ptr @zz_res, align 8
  %305 = load ptr, ptr %304, align 8
  %osucc1804 = getelementptr inbounds %struct.LIST, ptr %305, i64 0, i32 1
  store ptr %303, ptr %osucc1804, align 8
  %306 = load ptr, ptr @zz_tmp, align 8
  store ptr %306, ptr %304, align 8
  %307 = load ptr, ptr @zz_res, align 8
  %308 = load ptr, ptr @zz_tmp, align 8
  %osucc1810 = getelementptr inbounds %struct.LIST, ptr %308, i64 0, i32 1
  store ptr %307, ptr %osucc1810, align 8
  %309 = load ptr, ptr @xx_link, align 8
  store ptr %309, ptr @zz_res, align 8
...
cond.false1822:                                   ; preds = %cond.end1813
  ...
  %310 = load ptr, ptr %arrayidx1824, align 8
  store ptr %310, ptr @zz_tmp, align 8
  %arrayidx1827 = getelementptr inbounds [2 x %struct.LIST], ptr %309, i64 0, i64 1
  %311 = load ptr, ptr %arrayidx1827, align 8
  store ptr %311, ptr %arrayidx1824, align 8
  %312 = load ptr, ptr %arrayidx1827, align 8
  %osucc1837 = getelementptr inbounds [2 x %struct.LIST], ptr %312, i64 0, i64 1, i32 1
  store ptr %295, ptr %osucc1837, align 8
  store ptr %310, ptr %arrayidx1827, align 8
  %osucc1843 = getelementptr inbounds [2 x %struct.LIST], ptr %310, i64 0, i64 1, i32 1
  store ptr %309, ptr %osucc1843, align 8
  br label %cond.end1846

cond.end1846:                                     ; preds = %cond.end1813, %cond.false1822
  store ptr %1, ptr @zz_hold, align 8
  %313 = load i32, ptr @otop, align 4
  %inc1848 = add nsw i32 %313, 1
  store i32 %inc1848, ptr @otop, align 4
...
if.then1851:                                      ; preds = %cond.end1846
  ...
  store ptr %1, ptr %arrayidx1853, align 8
  br label %sw.epilog
...
if.else1854:                                      ; preds = %cond.end1846
  ...
  %314 = load ptr, ptr %arrayidx1857, align 8
...
sw.bb1861:                                        ; preds = %entry, %entry, %entry
  ...
  %316 = load ptr, ptr %arrayidx1864, align 8
...
if.else1924:                                      ; preds = %if.else1910
  store ptr %324, ptr @zz_hold, align 8
  %326 = load ptr, ptr %324, align 8
  store ptr %326, ptr %arrayidx1919, align 8
  br label %cond.end1979
...
cond.end1979:                                     ; preds = %if.then1922, %if.else1924
  ...
  store i8 0, ptr %ou11934, align 8
  %osucc1938 = getelementptr inbounds [2 x %struct.LIST], ptr %327, i64 0, i64 1, i32 1
  store ptr %327, ptr %osucc1938, align 8
  %arrayidx1940 = getelementptr inbounds [2 x %struct.LIST], ptr %327, i64 0, i64 1
  store ptr %327, ptr %arrayidx1940, align 8
  %osucc1944 = getelementptr inbounds %struct.LIST, ptr %327, i64 0, i32 1
  store ptr %327, ptr %osucc1944, align 8
  store ptr %327, ptr %327, align 8
  store ptr %327, ptr @xx_link, align 8
  store ptr %327, ptr @zz_res, align 8
  store ptr %1, ptr @zz_hold, align 8
  %328 = load ptr, ptr %1, align 8
  store ptr %328, ptr @zz_tmp, align 8
  %329 = load ptr, ptr %327, align 8
  store ptr %329, ptr %1, align 8
  %330 = load ptr, ptr @zz_hold, align 8
  %331 = load ptr, ptr @zz_res, align 8
  %332 = load ptr, ptr %331, align 8
  %osucc1970 = getelementptr inbounds %struct.LIST, ptr %332, i64 0, i32 1
  store ptr %330, ptr %osucc1970, align 8
  %333 = load ptr, ptr @zz_tmp, align 8
  store ptr %333, ptr %331, align 8
  %334 = load ptr, ptr @zz_res, align 8
  %335 = load ptr, ptr @zz_tmp, align 8
  %osucc1976 = getelementptr inbounds %struct.LIST, ptr %335, i64 0, i32 1
  store ptr %334, ptr %osucc1976, align 8
  %336 = load ptr, ptr @xx_link, align 8
  store ptr %336, ptr @zz_res, align 8
  store ptr %318, ptr @zz_hold, align 8
...
if.else2028:                                      ; preds = %if.end2014
  store ptr %341, ptr @zz_hold, align 8
  %343 = load ptr, ptr %341, align 8
  store ptr %343, ptr %arrayidx2023, align 8
  br label %cond.end2083
...
cond.end2083:                                     ; preds = %if.then2026, %if.else2028
  ...
  store i8 0, ptr %ou12038, align 8
  %osucc2042 = getelementptr inbounds [2 x %struct.LIST], ptr %344, i64 0, i64 1, i32 1
  store ptr %344, ptr %osucc2042, align 8
  %arrayidx2044 = getelementptr inbounds [2 x %struct.LIST], ptr %344, i64 0, i64 1
  store ptr %344, ptr %arrayidx2044, align 8
  %osucc2048 = getelementptr inbounds %struct.LIST, ptr %344, i64 0, i32 1
  store ptr %344, ptr %osucc2048, align 8
  store ptr %344, ptr %344, align 8
  store ptr %344, ptr @xx_link, align 8
  store ptr %344, ptr @zz_res, align 8
  store ptr %p1.0, ptr @zz_hold, align 8
  %345 = load ptr, ptr %p1.0, align 8
  store ptr %345, ptr @zz_tmp, align 8
  %346 = load ptr, ptr %344, align 8
  store ptr %346, ptr %p1.0, align 8
  %347 = load ptr, ptr @zz_hold, align 8
  %348 = load ptr, ptr @zz_res, align 8
  %349 = load ptr, ptr %348, align 8
  %osucc2074 = getelementptr inbounds %struct.LIST, ptr %349, i64 0, i32 1
  store ptr %347, ptr %osucc2074, align 8
  %350 = load ptr, ptr @zz_tmp, align 8
  store ptr %350, ptr %348, align 8
  %351 = load ptr, ptr @zz_res, align 8
  %352 = load ptr, ptr @zz_tmp, align 8
  %osucc2080 = getelementptr inbounds %struct.LIST, ptr %352, i64 0, i32 1
  store ptr %351, ptr %osucc2080, align 8
  %353 = load ptr, ptr @xx_link, align 8
  store ptr %353, ptr @zz_res, align 8
  store ptr %317, ptr @zz_hold, align 8
...
if.else2131:                                      ; preds = %cond.end2116
  store ptr %358, ptr @zz_hold, align 8
  %360 = load ptr, ptr %358, align 8
  store ptr %360, ptr %arrayidx2126, align 8
  br label %cond.end2186
...
cond.end2186:                                     ; preds = %if.then2129, %if.else2131
  ...
  store i8 0, ptr %ou12141, align 8
  %osucc2145 = getelementptr inbounds [2 x %struct.LIST], ptr %361, i64 0, i64 1, i32 1
  store ptr %361, ptr %osucc2145, align 8
  %arrayidx2147 = getelementptr inbounds [2 x %struct.LIST], ptr %361, i64 0, i64 1
  store ptr %361, ptr %arrayidx2147, align 8
  %osucc2151 = getelementptr inbounds %struct.LIST, ptr %361, i64 0, i32 1
  store ptr %361, ptr %osucc2151, align 8
  store ptr %361, ptr %361, align 8
  store ptr %361, ptr @xx_link, align 8
  store ptr %361, ptr @zz_res, align 8
  store ptr %p1.0, ptr @zz_hold, align 8
  %362 = load ptr, ptr %p1.0, align 8
  store ptr %362, ptr @zz_tmp, align 8
  %363 = load ptr, ptr %361, align 8
  store ptr %363, ptr %p1.0, align 8
  %364 = load ptr, ptr @zz_hold, align 8
  %365 = load ptr, ptr @zz_res, align 8
  %366 = load ptr, ptr %365, align 8
  %osucc2177 = getelementptr inbounds %struct.LIST, ptr %366, i64 0, i32 1
  store ptr %364, ptr %osucc2177, align 8
  %367 = load ptr, ptr @zz_tmp, align 8
  store ptr %367, ptr %365, align 8
  %368 = load ptr, ptr @zz_res, align 8
  %369 = load ptr, ptr @zz_tmp, align 8
  %osucc2183 = getelementptr inbounds %struct.LIST, ptr %369, i64 0, i32 1
  store ptr %368, ptr %osucc2183, align 8
  %370 = load ptr, ptr @xx_link, align 8
  store ptr %370, ptr @zz_res, align 8
...
cond.false2195:                                   ; preds = %cond.end2186
  ...
  %371 = load ptr, ptr %arrayidx2197, align 8
  store ptr %371, ptr @zz_tmp, align 8
  %arrayidx2200 = getelementptr inbounds [2 x %struct.LIST], ptr %370, i64 0, i64 1
  %372 = load ptr, ptr %arrayidx2200, align 8
  store ptr %372, ptr %arrayidx2197, align 8
  %373 = load ptr, ptr %arrayidx2200, align 8
  %osucc2210 = getelementptr inbounds [2 x %struct.LIST], ptr %373, i64 0, i64 1, i32 1
  store ptr %316, ptr %osucc2210, align 8
  store ptr %371, ptr %arrayidx2200, align 8
  %osucc2216 = getelementptr inbounds [2 x %struct.LIST], ptr %371, i64 0, i64 1, i32 1
  store ptr %370, ptr %osucc2216, align 8
  br label %cond.end2219

cond.end2219:                                     ; preds = %cond.end2186, %cond.false2195
  store ptr %p1.0, ptr @zz_hold, align 8
  %374 = load i32, ptr @otop, align 4
  %inc2221 = add nsw i32 %374, 1
  store i32 %inc2221, ptr @otop, align 4
...
if.then2224:                                      ; preds = %cond.end2219
  ...
  store ptr %p1.0, ptr %arrayidx2226, align 8
  br label %sw.epilog
...
if.else2227:                                      ; preds = %cond.end2219
  ...
  %375 = load ptr, ptr %arrayidx2230, align 8
...
cond.end2352:                                     ; preds = %if.then2295, %if.else2297
  ...
  store i8 0, ptr %ou12307, align 8
  %osucc2311 = getelementptr inbounds [2 x %struct.LIST], ptr %389, i64 0, i64 1, i32 1
  store ptr %389, ptr %osucc2311, align 8
  %arrayidx2313 = getelementptr inbounds [2 x %struct.LIST], ptr %389, i64 0, i64 1
  store ptr %389, ptr %arrayidx2313, align 8
  %osucc2317 = getelementptr inbounds %struct.LIST, ptr %389, i64 0, i32 1
  store ptr %389, ptr %osucc2317, align 8
  store ptr %389, ptr %389, align 8
  store ptr %389, ptr @xx_link, align 8
  store ptr %389, ptr @zz_res, align 8
  store ptr %384, ptr @zz_hold, align 8
  %390 = load ptr, ptr %384, align 8
  store ptr %390, ptr @zz_tmp, align 8
  %391 = load ptr, ptr %389, align 8
  store ptr %391, ptr %384, align 8
  %392 = load ptr, ptr @zz_hold, align 8
  %393 = load ptr, ptr @zz_res, align 8
  %394 = load ptr, ptr %393, align 8
  %osucc2343 = getelementptr inbounds %struct.LIST, ptr %394, i64 0, i32 1
  store ptr %392, ptr %osucc2343, align 8
  %395 = load ptr, ptr @zz_tmp, align 8
  store ptr %395, ptr %393, align 8
  %396 = load ptr, ptr @zz_res, align 8
  %397 = load ptr, ptr @zz_tmp, align 8
  %osucc2349 = getelementptr inbounds %struct.LIST, ptr %397, i64 0, i32 1
  store ptr %396, ptr %osucc2349, align 8
  %398 = load ptr, ptr @xx_link, align 8
  store ptr %398, ptr @zz_res, align 8
...
cond.false2361:                                   ; preds = %cond.end2352
  ...
  %399 = load ptr, ptr %arrayidx2363, align 8
  store ptr %399, ptr @zz_tmp, align 8
  %arrayidx2366 = getelementptr inbounds [2 x %struct.LIST], ptr %398, i64 0, i64 1
  %400 = load ptr, ptr %arrayidx2366, align 8
  store ptr %400, ptr %arrayidx2363, align 8
  %401 = load ptr, ptr %arrayidx2366, align 8
  %osucc2376 = getelementptr inbounds [2 x %struct.LIST], ptr %401, i64 0, i64 1, i32 1
  store ptr %378, ptr %osucc2376, align 8
  store ptr %399, ptr %arrayidx2366, align 8
  %osucc2382 = getelementptr inbounds [2 x %struct.LIST], ptr %399, i64 0, i64 1, i32 1
  store ptr %398, ptr %osucc2382, align 8
...
if.end2412:                                       ; preds = %cond.end2385, %sw.bb2234
  ...
  store i8 1, ptr %ou1, align 8
  %403 = load i8, ptr @zz_lengths, align 1
  %conv2415 = zext i8 %403 to i32
  store i32 %conv2415, ptr @zz_size, align 4
  %conv2416 = zext i8 %403 to i64
  %arrayidx2423 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv2416
  %404 = load ptr, ptr %arrayidx2423, align 8
...
if.else2428:                                      ; preds = %if.end2412
  ...
  store ptr %406, ptr %arrayidx2423, align 8
  br label %cond.end2483
...
cond.end2483:                                     ; preds = %if.then2426, %if.else2428
  ...
  store i8 0, ptr %ou12438, align 8
  %osucc2442 = getelementptr inbounds [2 x %struct.LIST], ptr %407, i64 0, i64 1, i32 1
  store ptr %407, ptr %osucc2442, align 8
  %arrayidx2444 = getelementptr inbounds [2 x %struct.LIST], ptr %407, i64 0, i64 1
  store ptr %407, ptr %arrayidx2444, align 8
  %osucc2448 = getelementptr inbounds %struct.LIST, ptr %407, i64 0, i32 1
  store ptr %407, ptr %osucc2448, align 8
  store ptr %407, ptr %407, align 8
  store ptr %407, ptr @xx_link, align 8
  store ptr %407, ptr @zz_res, align 8
  store ptr %p1.1, ptr @zz_hold, align 8
  %408 = load ptr, ptr %p1.1, align 8
  store ptr %408, ptr @zz_tmp, align 8
  %409 = load ptr, ptr %407, align 8
  store ptr %409, ptr %p1.1, align 8
  %410 = load ptr, ptr @zz_hold, align 8
  %411 = load ptr, ptr @zz_res, align 8
  %412 = load ptr, ptr %411, align 8
  %osucc2474 = getelementptr inbounds %struct.LIST, ptr %412, i64 0, i32 1
  store ptr %410, ptr %osucc2474, align 8
  %413 = load ptr, ptr @zz_tmp, align 8
  store ptr %413, ptr %411, align 8
  %414 = load ptr, ptr @zz_res, align 8
  %415 = load ptr, ptr @zz_tmp, align 8
  %osucc2480 = getelementptr inbounds %struct.LIST, ptr %415, i64 0, i32 1
  store ptr %414, ptr %osucc2480, align 8
  %416 = load ptr, ptr @xx_link, align 8
  store ptr %416, ptr @zz_res, align 8
  store ptr %1, ptr @zz_hold, align 8
...
if.else2531:                                      ; preds = %cond.end2516
  store ptr %421, ptr @zz_hold, align 8
  %423 = load ptr, ptr %421, align 8
  store ptr %423, ptr %arrayidx2526, align 8
  br label %cond.end2586
...
cond.end2586:                                     ; preds = %if.then2529, %if.else2531
  ...
  store i8 0, ptr %ou12541, align 8
  %osucc2545 = getelementptr inbounds [2 x %struct.LIST], ptr %424, i64 0, i64 1, i32 1
  store ptr %424, ptr %osucc2545, align 8
  %arrayidx2547 = getelementptr inbounds [2 x %struct.LIST], ptr %424, i64 0, i64 1
  store ptr %424, ptr %arrayidx2547, align 8
  %osucc2551 = getelementptr inbounds %struct.LIST, ptr %424, i64 0, i32 1
  store ptr %424, ptr %osucc2551, align 8
  store ptr %424, ptr %424, align 8
  store ptr %424, ptr @xx_link, align 8
  store ptr %424, ptr @zz_res, align 8
  store ptr %p1.1, ptr @zz_hold, align 8
  %425 = load ptr, ptr %p1.1, align 8
  store ptr %425, ptr @zz_tmp, align 8
  %426 = load ptr, ptr %424, align 8
  store ptr %426, ptr %p1.1, align 8
  %427 = load ptr, ptr @zz_hold, align 8
  %428 = load ptr, ptr @zz_res, align 8
  %429 = load ptr, ptr %428, align 8
  %osucc2577 = getelementptr inbounds %struct.LIST, ptr %429, i64 0, i32 1
  store ptr %427, ptr %osucc2577, align 8
  %430 = load ptr, ptr @zz_tmp, align 8
  store ptr %430, ptr %428, align 8
  %431 = load ptr, ptr @zz_res, align 8
  %432 = load ptr, ptr @zz_tmp, align 8
  %osucc2583 = getelementptr inbounds %struct.LIST, ptr %432, i64 0, i32 1
  store ptr %431, ptr %osucc2583, align 8
  %433 = load ptr, ptr @xx_link, align 8
  store ptr %433, ptr @zz_res, align 8
...
cond.false2595:                                   ; preds = %cond.end2586
  ...
  %434 = load ptr, ptr %arrayidx2597, align 8
  store ptr %434, ptr @zz_tmp, align 8
  %arrayidx2600 = getelementptr inbounds [2 x %struct.LIST], ptr %433, i64 0, i64 1
  %435 = load ptr, ptr %arrayidx2600, align 8
  store ptr %435, ptr %arrayidx2597, align 8
  %436 = load ptr, ptr %arrayidx2600, align 8
  %osucc2610 = getelementptr inbounds [2 x %struct.LIST], ptr %436, i64 0, i64 1, i32 1
  store ptr %377, ptr %osucc2610, align 8
  store ptr %434, ptr %arrayidx2600, align 8
  %osucc2616 = getelementptr inbounds [2 x %struct.LIST], ptr %434, i64 0, i64 1, i32 1
  store ptr %433, ptr %osucc2616, align 8
  br label %cond.end2619

cond.end2619:                                     ; preds = %cond.end2586, %cond.false2595
  store ptr %p1.1, ptr @zz_hold, align 8
  %437 = load i32, ptr @otop, align 4
  %inc2621 = add nsw i32 %437, 1
  store i32 %inc2621, ptr @otop, align 4
...
if.then2624:                                      ; preds = %cond.end2619
  ...
  store ptr %p1.1, ptr %arrayidx2626, align 8
  br label %sw.epilog
...
if.else2627:                                      ; preds = %cond.end2619
  ...
  %438 = load ptr, ptr %arrayidx2630, align 8
...
sw.default:                                       ; preds = %entry
  ...
  %439 = load ptr, ptr @no_fpos, align 8
...
entry:
  ...
  %.pn594618 = load ptr, ptr @CommandOptions, align 8
  %colink.0.in619 = getelementptr inbounds %struct.LIST, ptr %.pn594618, i64 0, i32 1
  %colink.0620 = load ptr, ptr %colink.0.in619, align 8
  %cmp.not621 = icmp eq ptr %colink.0620, %.pn594618
...
for.cond16:                                       ; preds = %for.cond16, %for.end
  ...
  %coval.0 = load ptr, ptr %coval.0.in, align 8
  %ou117 = getelementptr inbounds %struct.word_type, ptr %coval.0, i64 0, i32 1
  %3 = load i8, ptr %ou117, align 8
  %cmp20 = icmp eq i8 %3, 0
  br i1 %cmp20, label %for.cond16, label %for.cond31.preheader

for.cond31.preheader:                             ; preds = %for.cond16
  %link.0609 = load ptr, ptr %link.0.in608, align 8
...
for.inc58:                                        ; preds = %for.cond38, %land.lhs.true
  ...
  br i1 %cmp32.not, label %for.inc547, label %for.cond38.preheader

for.cond67.preheader:                             ; preds = %land.lhs.true
  %link.1614 = load ptr, ptr %link.1.in613, align 8
...
land.lhs.true91:                                  ; preds = %for.cond74
  ...
  %6 = load ptr, ptr %oactual92, align 8
...
cond.false:                                       ; preds = %if.then103
  ...
  %9 = load ptr, ptr %arrayidx116, align 8
  %arrayidx119 = getelementptr inbounds [2 x %struct.LIST], ptr %8, i64 0, i64 1
  store ptr %9, ptr %arrayidx119, align 8
  %10 = load ptr, ptr %arrayidx116, align 8
  %osucc126 = getelementptr inbounds [2 x %struct.LIST], ptr %10, i64 0, i64 1, i32 1
  store ptr %8, ptr %osucc126, align 8
  store ptr %7, ptr %osucc109, align 8
  store ptr %7, ptr %arrayidx116, align 8
  br label %cond.end
...
if.else210:                                       ; preds = %if.end197
  ...
  store ptr %26, ptr %arrayidx205, align 8
  br label %cond.end265
...
cond.end265:                                      ; preds = %if.then208, %if.else210
  ...
  store ptr %30, ptr %osucc256, align 8
  ...
  store ptr %34, ptr %osucc262, align 8
  %36 = load ptr, ptr @xx_link, align 8
  store ptr %36, ptr @zz_res, align 8
  store ptr %coval.0, ptr @zz_hold, align 8
...
if.then312:                                       ; preds = %if.else300
  ...
  store ptr %call313, ptr @zz_hold, align 8
  br label %if.end323

if.else314:                                       ; preds = %if.else300
  store ptr %41, ptr @zz_hold, align 8
  %43 = load ptr, ptr %41, align 8
  store ptr %43, ptr %arrayidx309, align 8
  br label %if.end323
...
if.end323:                                        ; preds = %if.then312, %if.else314
  ...
  store i8 10, ptr %ou1324, align 8
...
if.else351:                                       ; preds = %if.end323
  ...
  store ptr %48, ptr %arrayidx346, align 8
  br label %if.end360
...
cond.end406.cond.false415_crit_edge:              ; preds = %if.end360
  ...
  %.pre628 = load ptr, ptr %arrayidx420.phi.trans.insert, align 8
  %58 = load ptr, ptr %arrayidx327, align 8
  store ptr %58, ptr @zz_tmp, align 8
  %arrayidx420 = getelementptr inbounds [2 x %struct.LIST], ptr %.pr, i64 0, i64 1
  store ptr %.pre628, ptr %arrayidx327, align 8
  %59 = load ptr, ptr %arrayidx420, align 8
  %osucc430 = getelementptr inbounds [2 x %struct.LIST], ptr %59, i64 0, i64 1, i32 1
  store ptr %44, ptr %osucc430, align 8
  store ptr %58, ptr %arrayidx420, align 8
  %osucc436 = getelementptr inbounds [2 x %struct.LIST], ptr %58, i64 0, i64 1, i32 1
  store ptr %.pr, ptr %osucc436, align 8
...
if.else455:                                       ; preds = %cond.end439
  ...
  store ptr %63, ptr %arrayidx450, align 8
  br label %cond.end510
...
cond.end510:                                      ; preds = %if.then453, %if.else455
  ...
  store ptr %67, ptr %osucc501, align 8
  ...
  store ptr %71, ptr %osucc507, align 8
  %73 = load ptr, ptr @xx_link, align 8
...
cond.false519:                                    ; preds = %cond.end510
  ...
  %74 = load ptr, ptr %arrayidx521, align 8
  store ptr %74, ptr @zz_tmp, align 8
  %arrayidx524 = getelementptr inbounds [2 x %struct.LIST], ptr %73, i64 0, i64 1
  %75 = load ptr, ptr %arrayidx524, align 8
  store ptr %75, ptr %arrayidx521, align 8
  %76 = load ptr, ptr %arrayidx524, align 8
  %osucc534 = getelementptr inbounds [2 x %struct.LIST], ptr %76, i64 0, i64 1, i32 1
  store ptr %coval.0, ptr %osucc534, align 8
  store ptr %74, ptr %arrayidx524, align 8
  br label %for.inc547.sink.split
...
for.inc547.sink.split:                            ; preds = %cond.false274, %cond.false519
  ...
  store ptr %.sink, ptr %osucc540, align 8
  br label %for.inc547

for.inc547:                                       ; preds = %for.inc58, %for.inc547.sink.split, %for.cond31.preheader, %cond.end510, %cond.end265
  %.pn594 = load ptr, ptr %osucc12, align 8
  %colink.0.in = getelementptr inbounds %struct.LIST, ptr %.pn594, i64 0, i32 1
  %colink.0 = load ptr, ptr %colink.0.in, align 8
  %77 = load ptr, ptr @CommandOptions, align 8
  %cmp.not = icmp eq ptr %colink.0, %77
  br i1 %cmp.not, label %for.end554, label %for.cond3.preheader
...
while.end:                                        ; preds = %while.cond
  store ptr %storemerge381, ptr @zz_hold, align 8
  %cond.in = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 88), align 1
  %cond = zext i8 %cond.in to i32
  store i32 %cond, ptr @zz_size, align 4
...
while.cond187.preheader.loopexit:                 ; preds = %cond.end154
  ...
  %.pre370 = load ptr, ptr %osucc190364.phi.trans.insert, align 8
...
cond.false102:                                    ; preds = %while.body92
  ...
  %17 = load ptr, ptr %arrayidx107, align 8
  %arrayidx110 = getelementptr inbounds [2 x %struct.LIST], ptr %16, i64 0, i64 1
  store ptr %17, ptr %arrayidx110, align 8
  %18 = load ptr, ptr %arrayidx107, align 8
  %osucc117 = getelementptr inbounds [2 x %struct.LIST], ptr %18, i64 0, i64 1, i32 1
  store ptr %16, ptr %osucc117, align 8
  store ptr %15, ptr %osucc98, align 8
  store ptr %15, ptr %arrayidx107, align 8
...
cond.end225:                                      ; preds = %while.body193, %cond.false203
  ...
  %35 = load ptr, ptr %osucc229, align 8
...
while.end287:                                     ; preds = %cond.end255, %while.cond187.preheader
  ...
  %cond310.in = load i8, ptr %cond310.in.in, align 1
  %cond310 = zext i8 %cond310.in to i32
  store i32 %cond310, ptr @zz_size, align 4
  %idxprom311 = zext i8 %cond310.in to i64
  %arrayidx312 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom311
  %48 = load ptr, ptr %arrayidx312, align 8
  store ptr %48, ptr %.lcssa, align 8
  %49 = load ptr, ptr @zz_hold, align 8
  %50 = load i32, ptr @zz_size, align 4
  %idxprom316 = sext i32 %50 to i64
  %arrayidx317 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom316
  store ptr %49, ptr %arrayidx317, align 8
  %51 = load i8, ptr %ou175.le, align 8
