; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z40.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z40.c"
...
entry:
  store i32 0, ptr @filter_count, align 4
...
entry:
  ...
  %0 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 57), align 1
  %conv = zext i8 %0 to i32
  store i32 %conv, ptr @zz_size, align 4
  %conv1 = zext i8 %0 to i64
  %arrayidx = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv1
...
if.end13:                                         ; preds = %if.then5, %if.else7
  ...
  store i16 %5, ptr %ofile_num26, align 2
  ...
  %6 = load i32, ptr @filter_count, align 4
  %inc = add nsw i32 %6, 1
...
if.else67:                                        ; preds = %if.end46
  ...
  store ptr %10, ptr %arrayidx62, align 8
  br label %cond.end118

cond.end118:                                      ; preds = %if.then65, %if.else67
  %11 = phi ptr [ %call66, %if.then65 ], [ %8, %if.else67 ]
  %ou177 = getelementptr inbounds %struct.word_type, ptr %11, i64 0, i32 1
  store i8 0, ptr %ou177, align 8
  %osucc81 = getelementptr inbounds [2 x %struct.LIST], ptr %11, i64 0, i64 1, i32 1
  store ptr %11, ptr %osucc81, align 8
  %arrayidx83 = getelementptr inbounds [2 x %struct.LIST], ptr %11, i64 0, i64 1
  store ptr %11, ptr %arrayidx83, align 8
  %osucc87 = getelementptr inbounds %struct.LIST, ptr %11, i64 0, i32 1
  store ptr %11, ptr %osucc87, align 8
  ...
  store ptr %14, ptr %osucc111, align 8
  ...
  store ptr %18, ptr %osucc117, align 8
  %20 = load ptr, ptr @xx_link, align 8
  store ptr %20, ptr @zz_res, align 8
  store ptr %call48, ptr @zz_hold, align 8
...
cond.false127:                                    ; preds = %cond.end118
  ...
  %21 = load ptr, ptr %arrayidx129, align 8
  store ptr %21, ptr @zz_tmp, align 8
  %arrayidx132 = getelementptr inbounds [2 x %struct.LIST], ptr %20, i64 0, i64 1
  %22 = load ptr, ptr %arrayidx132, align 8
  store ptr %22, ptr %arrayidx129, align 8
  %23 = load ptr, ptr %arrayidx132, align 8
  %osucc142 = getelementptr inbounds [2 x %struct.LIST], ptr %23, i64 0, i64 1, i32 1
  store ptr %call48, ptr %osucc142, align 8
...
cond.end151:                                      ; preds = %cond.end118, %cond.false127
  ...
  %25 = load ptr, ptr %arrayidx161, align 8
...
if.else166:                                       ; preds = %cond.end151
  ...
  store ptr %27, ptr %arrayidx161, align 8
  br label %if.end175
...
if.end175:                                        ; preds = %if.then164, %if.else166
  ...
  store i8 0, ptr %ou1176, align 8
  %osucc180 = getelementptr inbounds [2 x %struct.LIST], ptr %28, i64 0, i64 1, i32 1
  store ptr %28, ptr %osucc180, align 8
  %arrayidx182 = getelementptr inbounds [2 x %struct.LIST], ptr %28, i64 0, i64 1
  store ptr %28, ptr %arrayidx182, align 8
  %osucc186 = getelementptr inbounds %struct.LIST, ptr %28, i64 0, i32 1
  store ptr %28, ptr %osucc186, align 8
  store ptr %28, ptr %28, align 8
  store ptr %28, ptr @xx_link, align 8
  store ptr %28, ptr @zz_res, align 8
  %29 = load ptr, ptr @filter_active, align 8
...
cond.end221:                                      ; preds = %if.end175
  ...
  store ptr %32, ptr %osucc212, align 8
  ...
  store ptr %36, ptr %osucc218, align 8
...
cond.false230:                                    ; preds = %cond.end221.thread, %cond.end221
  ...
  %39 = load ptr, ptr %arrayidx232, align 8
  store ptr %39, ptr @zz_tmp, align 8
  %arrayidx235 = getelementptr inbounds [2 x %struct.LIST], ptr %38, i64 0, i64 1
  %40 = load ptr, ptr %arrayidx235, align 8
  store ptr %40, ptr %arrayidx232, align 8
  %41 = load ptr, ptr %arrayidx235, align 8
  %osucc245 = getelementptr inbounds [2 x %struct.LIST], ptr %41, i64 0, i64 1, i32 1
  store ptr %call48, ptr %osucc245, align 8
  store ptr %39, ptr %arrayidx235, align 8
...
cond.end254:                                      ; preds = %cond.end221, %cond.false230
  ...
  %42 = load i32, ptr @filter_count, align 4
...
if.else275:                                       ; preds = %cond.end254
  ...
  store ptr %46, ptr %arrayidx270, align 8
  br label %cond.end330

cond.end330:                                      ; preds = %if.then273, %if.else275
  %47 = phi ptr [ %call274, %if.then273 ], [ %44, %if.else275 ]
  %ou1285 = getelementptr inbounds %struct.word_type, ptr %47, i64 0, i32 1
  store i8 0, ptr %ou1285, align 8
  %osucc289 = getelementptr inbounds [2 x %struct.LIST], ptr %47, i64 0, i64 1, i32 1
  store ptr %47, ptr %osucc289, align 8
  %arrayidx291 = getelementptr inbounds [2 x %struct.LIST], ptr %47, i64 0, i64 1
  store ptr %47, ptr %arrayidx291, align 8
  ...
  store ptr %48, ptr @zz_tmp, align 8
  ...
  store ptr %50, ptr %osucc321, align 8
  ...
  store ptr %54, ptr %osucc327, align 8
  %56 = load ptr, ptr @xx_link, align 8
  store ptr %56, ptr @zz_res, align 8
  store ptr %call261, ptr @zz_hold, align 8
  %cmp332 = icmp eq ptr %call261, null
  %cmp336 = icmp eq ptr %56, null
  %or.cond517 = select i1 %cmp332, i1 true, i1 %cmp336
  br i1 %or.cond517, label %cond.end363, label %cond.false339

cond.false339:                                    ; preds = %cond.end330
  %arrayidx341 = getelementptr inbounds [2 x %struct.LIST], ptr %call261, i64 0, i64 1
  %57 = load ptr, ptr %arrayidx341, align 8
  ...
  store ptr %58, ptr %arrayidx341, align 8
  %59 = load ptr, ptr %arrayidx344, align 8
  %osucc354 = getelementptr inbounds [2 x %struct.LIST], ptr %59, i64 0, i64 1, i32 1
  store ptr %call261, ptr %osucc354, align 8
  store ptr %57, ptr %arrayidx344, align 8
...
cond.end363:                                      ; preds = %cond.end330, %cond.false339
...
if.else394:                                       ; preds = %if.end380
  ...
  store ptr %65, ptr %arrayidx389, align 8
  br label %cond.end449

cond.end449:                                      ; preds = %if.then392, %if.else394
  %66 = phi ptr [ %call393, %if.then392 ], [ %63, %if.else394 ]
  %ou1404 = getelementptr inbounds %struct.word_type, ptr %66, i64 0, i32 1
  store i8 0, ptr %ou1404, align 8
  %osucc408 = getelementptr inbounds [2 x %struct.LIST], ptr %66, i64 0, i64 1, i32 1
  store ptr %66, ptr %osucc408, align 8
  %arrayidx410 = getelementptr inbounds [2 x %struct.LIST], ptr %66, i64 0, i64 1
  store ptr %66, ptr %arrayidx410, align 8
  ...
  store ptr %66, ptr @xx_link, align 8
  ...
  store ptr %69, ptr %osucc440, align 8
  ...
  store ptr %73, ptr %osucc446, align 8
  %75 = load ptr, ptr @xx_link, align 8
  store ptr %75, ptr @zz_res, align 8
  store ptr %call371, ptr @zz_hold, align 8
  %cmp451 = icmp eq ptr %call371, null
  %cmp455 = icmp eq ptr %75, null
  %or.cond519 = select i1 %cmp451, i1 true, i1 %cmp455
  br i1 %or.cond519, label %cond.end482, label %cond.false458

cond.false458:                                    ; preds = %cond.end449
  %arrayidx460 = getelementptr inbounds [2 x %struct.LIST], ptr %call371, i64 0, i64 1
  %76 = load ptr, ptr %arrayidx460, align 8
  store ptr %76, ptr @zz_tmp, align 8
  %arrayidx463 = getelementptr inbounds [2 x %struct.LIST], ptr %75, i64 0, i64 1
  %77 = load ptr, ptr %arrayidx463, align 8
  store ptr %77, ptr %arrayidx460, align 8
  %78 = load ptr, ptr %arrayidx463, align 8
  %osucc473 = getelementptr inbounds [2 x %struct.LIST], ptr %78, i64 0, i64 1, i32 1
  store ptr %call371, ptr %osucc473, align 8
  store ptr %76, ptr %arrayidx463, align 8
  %osucc479 = getelementptr inbounds [2 x %struct.LIST], ptr %76, i64 0, i64 1, i32 1
  store ptr %75, ptr %osucc479, align 8
  br label %cond.end482

cond.end482:                                      ; preds = %cond.end449, %cond.false458
...
if.end56:                                         ; preds = %for.cond37, %if.then54
  %11 = load ptr, ptr @FilterOutSym, align 8
  %osym_body57 = getelementptr inbounds %struct.symbol_type, ptr %11, i64 0, i32 4
  store ptr %y.1, ptr %osym_body57, align 8
  ret void
}
...
if.end9:                                          ; preds = %if.then7, %if.end
  %4 = load ptr, ptr @filter_in_filename, align 8
  %5 = load ptr, ptr @FilterInSym, align 8
  %osym_body = getelementptr inbounds %struct.symbol_type, ptr %5, i64 0, i32 4
  store ptr %4, ptr %osym_body, align 8
  %6 = load i32, ptr @SafeExecution, align 4
...
if.else:                                          ; preds = %if.end20
  ...
  store i32 %add39, ptr %linecount, align 4
...
if.end53:                                         ; preds = %while.end51, %while.end
  %fputc88 = tail call i32 @fputc(i32 10, ptr %fp)
  %12 = load i32, ptr %linecount, align 4
  %add55 = add nsw i32 %12, 1
  store i32 %add55, ptr %linecount, align 4
...
entry:
  %0 = load ptr, ptr @filter_active, align 8
  %osucc = getelementptr inbounds %struct.LIST, ptr %0, i64 0, i32 1
  %1 = load ptr, ptr %osucc, align 8
  %cmp.not124 = icmp eq ptr %1, %0
  br i1 %cmp.not124, label %for.end114, label %for.cond3.preheader.lr.ph

for.cond3.preheader.lr.ph:                        ; preds = %entry
  %tobool.not = icmp eq i32 %all, 0
  br label %for.cond3.preheader

for.cond3.preheader:                              ; preds = %for.cond3.preheader.lr.ph, %for.inc113
  %link.0125 = phi ptr [ %1, %for.cond3.preheader.lr.ph ], [ %3, %for.inc113 ]
  br label %for.cond3

for.cond3:                                        ; preds = %for.cond3.preheader, %for.cond3
  %link.0.pn = phi ptr [ %y.0, %for.cond3 ], [ %link.0125, %for.cond3.preheader ]
...
for.end:                                          ; preds = %for.cond3
  ...
  %3 = load ptr, ptr %osucc12, align 8
  br i1 %tobool.not, label %lor.lhs.false, label %if.then

lor.lhs.false:                                    ; preds = %for.end
  %arrayidx14 = getelementptr inbounds [2 x %struct.LIST], ptr %y.0, i64 0, i64 1
  %osucc15 = getelementptr inbounds [2 x %struct.LIST], ptr %y.0, i64 0, i64 1, i32 1
  %4 = load ptr, ptr %osucc15, align 8
...
cond.false53:                                     ; preds = %cond.end
  ...
  %10 = load ptr, ptr %link.0125, align 8
  ...
  store ptr %11, ptr %osucc68, align 8
  %osucc71 = getelementptr inbounds %struct.LIST, ptr %12, i64 0, i32 1
  store ptr %12, ptr %osucc71, align 8
...
cond.end75:                                       ; preds = %cond.end, %cond.false53
  ...
  %20 = load ptr, ptr %osucc107, align 8
...
for.inc113:                                       ; preds = %lor.lhs.false, %if.then110, %cond.end75
  %21 = load ptr, ptr @filter_active, align 8
  %cmp.not = icmp eq ptr %3, %21
  br i1 %cmp.not, label %for.end114, label %for.cond3.preheader
