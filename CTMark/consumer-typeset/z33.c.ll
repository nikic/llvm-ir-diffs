...
for.inc141:                                       ; preds = %if.end133, %if.end122
  ...
  br i1 %cmp95.not, label %if.then148.loopexit, label %for.cond99.preheader, !llvm.loop !17
...
if.then148:                                       ; preds = %if.then148.loopexit, %if.end93
  ...
  %28 = load ptr, ptr %ocross_sym, align 8, !tbaa !5
...
if.end152:                                        ; preds = %if.then151, %if.then148
  ...
  %30 = load ptr, ptr %arrayidx160, align 8, !tbaa !8
...
if.else165:                                       ; preds = %if.end152
  ...
  store ptr %32, ptr %arrayidx160, align 8, !tbaa !8
  br label %if.end174
...
cond.false194:                                    ; preds = %if.end174
  ...
  store ptr %35, ptr %db, align 8, !tbaa !5
  ...
  store ptr %36, ptr %osucc209, align 8, !tbaa !5
  ...
  store ptr %40, ptr %osucc215, align 8, !tbaa !5
...
cond.end216:                                      ; preds = %if.end174, %cond.false194
  ...
  %43 = load ptr, ptr %ocross_sym, align 8, !tbaa !5
...
if.end269:                                        ; preds = %if.then262, %if.end258
  ...
  %49 = load ptr, ptr %ou349, align 8, !tbaa !5
  %50 = load i32, ptr @DbInsert.extra_seq, align 4, !tbaa !18
...
while.cond:                                       ; preds = %if.end200, %if.then12
  %call17.pn = phi ptr [ %call17, %if.then12 ], [ %call207, %if.end200 ]
  %db.0 = phi ptr [ null, %if.then12 ], [ %db.1, %if.end200 ]
  %dfpos.0 = phi i64 [ 0, %if.then12 ], [ %call206, %if.end200 ]
  store ptr %call17.pn, ptr %t, align 8, !tbaa !8
  %dlnum.0.in.in = getelementptr inbounds %struct.word_type, ptr %call17.pn, i64 0, i32 1, i32 0, i32 3
  %dlnum.0.in = load i32, ptr %dlnum.0.in.in, align 4
  %dlnum.0 = and i32 %dlnum.0.in, 1048575
  %ou119 = getelementptr inbounds %struct.word_type, ptr %call17.pn, i64 0, i32 1
...
if.then217:                                       ; preds = %while.cond
  %ou119.le = getelementptr inbounds %struct.word_type, ptr %call17.pn, i64 0, i32 1
...
if.end36.i:                                       ; preds = %if.then33.i, %cond.false.i282, %cond.true.i277
  ...
  br i1 %cmp.not.i, label %while.end.i280, label %while.body.i270, !llvm.loop !43
