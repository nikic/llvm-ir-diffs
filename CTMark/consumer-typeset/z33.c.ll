; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z33.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z33.c"
...
if.end:                                           ; preds = %entry, %if.then
  ...
  store i8 0, ptr %oreading, align 2
  %ou3 = getelementptr inbounds %struct.word_type, ptr %x, i64 0, i32 3
  store ptr null, ptr %ou3, align 8
  ret ptr %x
}
...
if.end19:                                         ; preds = %if.then17, %if.end12
  ...
  %6 = load i8, ptr %oreading, align 2
...
if.then24.if.end28_crit_edge:                     ; preds = %if.then24
  %.pre = load ptr, ptr @DbCheckTable, align 8
  br label %if.end28
...
dtab_new.exit:                                    ; preds = %if.then26, %if.then.i
  store i32 107, ptr %call.i, align 8
  ...
  store ptr %call.i, ptr @DbCheckTable, align 8
...
for.cond.preheader.i:                             ; preds = %while.end.i
  ...
  %link.049.i = load ptr, ptr %link.0.in48.i, align 8
...
for.inc22.i:                                      ; preds = %land.lhs.true.i, %for.end.i
  ...
  br i1 %cmp4.not.i, label %if.then32, label %for.cond8.preheader.i
...
if.else:                                          ; preds = %land.lhs.true.i
  ...
  %18 = load i16, ptr %ofile_num, align 2
...
if.end60:                                         ; preds = %if.then56, %if.then52
  ...
  store ptr %call68, ptr %ou349, align 8
...
if.end93:                                         ; preds = %if.else90, %if.then82
  ...
  %link.0346 = load ptr, ptr %link.0.in345, align 8
...
if.then120:                                       ; preds = %for.cond99
  ...
  %.pr = load i8, ptr %ou1100.le, align 8
  br label %if.end122
...
for.inc141:                                       ; preds = %if.end133, %if.end122
  ...
  br i1 %cmp95.not, label %if.then148.loopexit, label %for.cond99.preheader

if.then148.loopexit:                              ; preds = %for.inc141
  %26 = trunc i32 %count.1 to i8
  %27 = add i8 %26, 1
  br label %if.then148

if.then148:                                       ; preds = %if.then148.loopexit, %if.end93
  %count.0342 = phi i8 [ 1, %if.end93 ], [ %27, %if.then148.loopexit ]
  %ocross_sym = getelementptr inbounds %struct.symbol_type, ptr %sym, i64 0, i32 8
  %28 = load ptr, ptr %ocross_sym, align 8
  %cmp149 = icmp eq ptr %28, null
...
if.end152:                                        ; preds = %if.then151, %if.then148
  %29 = load i8, ptr @zz_lengths, align 1
  %conv153 = zext i8 %29 to i32
  store i32 %conv153, ptr @zz_size, align 4
  %conv154 = zext i8 %29 to i64
  %arrayidx160 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv154
  %30 = load ptr, ptr %arrayidx160, align 8
  %cmp161 = icmp eq ptr %30, null
  br i1 %cmp161, label %if.then163, label %if.else165

if.then163:                                       ; preds = %if.end152
  %31 = load ptr, ptr @no_fpos, align 8
  %call164 = call ptr @GetMemory(i32 noundef %conv153, ptr noundef %31) #12
  br label %if.end174

if.else165:                                       ; preds = %if.end152
  store ptr %30, ptr @zz_hold, align 8
  %32 = load ptr, ptr %30, align 8
  store ptr %32, ptr %arrayidx160, align 8
  br label %if.end174

if.end174:                                        ; preds = %if.then163, %if.else165
  %33 = phi ptr [ %call164, %if.then163 ], [ %30, %if.else165 ]
  %ou1175 = getelementptr inbounds %struct.word_type, ptr %33, i64 0, i32 1
  store i8 0, ptr %ou1175, align 8
  %osucc179 = getelementptr inbounds [2 x %struct.LIST], ptr %33, i64 0, i64 1, i32 1
  store ptr %33, ptr %osucc179, align 8
  %arrayidx181 = getelementptr inbounds [2 x %struct.LIST], ptr %33, i64 0, i64 1
  store ptr %33, ptr %arrayidx181, align 8
  %osucc185 = getelementptr inbounds %struct.LIST, ptr %33, i64 0, i32 1
  store ptr %33, ptr %osucc185, align 8
  store ptr %33, ptr %33, align 8
  store ptr %33, ptr @xx_link, align 8
  store ptr %33, ptr @zz_res, align 8
  store ptr %db, ptr @zz_hold, align 8
...
cond.false194:                                    ; preds = %if.end174
  ...
  store ptr %35, ptr %db, align 8
  %36 = load ptr, ptr @zz_hold, align 8
  %37 = load ptr, ptr @zz_res, align 8
  %38 = load ptr, ptr %37, align 8
  %osucc209 = getelementptr inbounds %struct.LIST, ptr %38, i64 0, i32 1
  store ptr %36, ptr %osucc209, align 8
  %39 = load ptr, ptr @zz_tmp, align 8
  store ptr %39, ptr %37, align 8
  %40 = load ptr, ptr @zz_res, align 8
  %41 = load ptr, ptr @zz_tmp, align 8
  %osucc215 = getelementptr inbounds %struct.LIST, ptr %41, i64 0, i32 1
  store ptr %40, ptr %osucc215, align 8
  %.pre358 = load ptr, ptr @xx_link, align 8
  br label %cond.end216

cond.end216:                                      ; preds = %if.end174, %cond.false194
  %42 = phi ptr [ %33, %if.end174 ], [ %.pre358, %cond.false194 ]
  store ptr %42, ptr @zz_res, align 8
  %43 = load ptr, ptr %ocross_sym, align 8
  store ptr %43, ptr @zz_hold, align 8
  %cmp219 = icmp eq ptr %43, null
  %cmp223 = icmp eq ptr %42, null
...
cond.false226:                                    ; preds = %cond.end216
  %arrayidx228 = getelementptr inbounds [2 x %struct.LIST], ptr %43, i64 0, i64 1
  %44 = load ptr, ptr %arrayidx228, align 8
  store ptr %44, ptr @zz_tmp, align 8
  %arrayidx231 = getelementptr inbounds [2 x %struct.LIST], ptr %42, i64 0, i64 1
  %45 = load ptr, ptr %arrayidx231, align 8
  store ptr %45, ptr %arrayidx228, align 8
  %46 = load ptr, ptr %arrayidx231, align 8
  %osucc241 = getelementptr inbounds [2 x %struct.LIST], ptr %46, i64 0, i64 1, i32 1
  store ptr %43, ptr %osucc241, align 8
  store ptr %44, ptr %arrayidx231, align 8
  %osucc247 = getelementptr inbounds [2 x %struct.LIST], ptr %44, i64 0, i64 1, i32 1
  store ptr %42, ptr %osucc247, align 8
  br label %cond.end250

cond.end250:                                      ; preds = %cond.end216, %cond.false226
  %47 = load ptr, ptr %db, align 8
  %onumber257 = getelementptr inbounds %struct.link_type, ptr %47, i64 0, i32 2
  store i8 %count.0342, ptr %onumber257, align 1
  %odb_targ = getelementptr inbounds %struct.link_type, ptr %47, i64 0, i32 3
  store i8 0, ptr %odb_targ, align 2
  br label %if.end258

if.end258:                                        ; preds = %if.end129, %cond.end250
  %48 = phi i8 [ %count.0342, %cond.end250 ], [ %.pre359, %if.end129 ]
  %link.1 = phi ptr [ %47, %cond.end250 ], [ %link.0349, %if.end129 ]
...
if.then262:                                       ; preds = %if.end258
  ...
  store i8 1, ptr %odb_targ268, align 2
  br label %if.end269

if.end269:                                        ; preds = %if.then262, %if.end258
  %cond272 = phi ptr [ @.str.17, %if.then262 ], [ @.str.12, %if.end258 ]
  %conv260 = zext i8 %48 to i32
  %49 = load ptr, ptr %ou349, align 8
  %50 = load i32, ptr @DbInsert.extra_seq, align 4
  %inc = add nsw i32 %50, 1
  store i32 %inc, ptr @DbInsert.extra_seq, align 4
  %call273 = call ptr @StringFiveInt(i32 noundef %inc) #12
  %call275 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %49, ptr noundef nonnull @.str.16, ptr noundef nonnull %cond272, i32 noundef %conv260, ptr noundef nonnull %tag, ptr noundef nonnull %seq, ptr noundef %call273, i64 noundef %dfpos, i32 noundef %dlnum, ptr noundef nonnull %buff)
...
entry:
  ...
  %1 = load i32, ptr %dbchecktab_count, align 4
...
if.then:                                          ; preds = %entry
  ...
  br i1 %cmp.i212, label %if.then.i215, label %if.end.i213

if.then.i215:                                     ; preds = %if.then
  %3 = load ptr, ptr @no_fpos, align 8
...
dtab_new.exit:                                    ; preds = %if.end.i213, %for.body.preheader.i
  store ptr %call.i211, ptr %NewS.i, align 8
...
if.end.i:                                         ; preds = %if.then7.i, %if.then.i
  ...
  %link.0.i217 = load ptr, ptr %link.0.in.i216, align 8
...
for.cond16.i:                                     ; preds = %for.cond16.i.preheader, %for.cond16.i
  ...
  %11 = load i8, ptr %ou117.i, align 8
  %cmp20.i = icmp eq i8 %11, 0
  br i1 %cmp20.i, label %for.cond16.i, label %for.end.i
...
for.end.i:                                        ; preds = %for.cond16.i
  ...
  br i1 %cmp11.not.i, label %for.end30.i, label %for.cond16.i.preheader
...
for.inc33.i:                                      ; preds = %for.end30.i, %for.body.i
  ...
  br i1 %cmp.i, label %for.body.i, label %dtab_rehash.exit.loopexit

dtab_rehash.exit.loopexit:                        ; preds = %for.inc33.i
  %.pre230 = load ptr, ptr %NewS.i, align 8
...
dtab_rehash.exit:                                 ; preds = %dtab_rehash.exit.loopexit, %dtab_new.exit
  ...
  %.pre231 = load i32, ptr %dbchecktab_count2.phi.trans.insert, align 4
  br label %if.end
...
if.end:                                           ; preds = %dtab_rehash.exit, %entry
  ...
  store i32 %inc, ptr %dbchecktab_count2, align 4
  %ostring = getelementptr inbounds %struct.word_type, ptr %x, i64 0, i32 4
  %ou3 = getelementptr inbounds %struct.word_type, ptr %x, i64 0, i32 3
  %17 = load ptr, ptr %ou3, align 8
  %18 = ptrtoint ptr %17 to i64
  %19 = load i8, ptr %ostring, align 1
...
if.then7:                                         ; preds = %while.end
  %24 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 17), align 1
...
if.then17:                                        ; preds = %if.then7
  ...
  store ptr %call18, ptr @zz_hold, align 8
  br label %if.end26

if.else19:                                        ; preds = %if.then7
  store ptr %25, ptr @zz_hold, align 8
  %27 = load ptr, ptr %25, align 8
  store ptr %27, ptr %arrayidx14, align 8
  br label %if.end26
...
if.end40:                                         ; preds = %if.end26, %while.end
  ...
  %link.0226 = load ptr, ptr %link.0.in225, align 8
...
for.cond51:                                       ; preds = %for.cond51.preheader, %for.cond51
  ...
  %31 = load i8, ptr %ou152, align 8
  %cmp55 = icmp eq i8 %31, 0
  br i1 %cmp55, label %for.cond51, label %for.end

for.end:                                          ; preds = %for.cond51
  %32 = load ptr, ptr %ou3, align 8
  %ou362 = getelementptr inbounds %struct.word_type, ptr %y.0, i64 0, i32 3
  %33 = load ptr, ptr %ou362, align 8
...
for.inc75:                                        ; preds = %for.end, %land.lhs.true, %if.then72
  ...
  br i1 %cmp46.not, label %for.end79, label %for.cond51.preheader
...
if.then91:                                        ; preds = %for.end79
  ...
  store ptr %call92, ptr @zz_hold, align 8
  br label %if.end102

if.else93:                                        ; preds = %for.end79
  store ptr %36, ptr @zz_hold, align 8
  %38 = load ptr, ptr %36, align 8
  store ptr %38, ptr %arrayidx88, align 8
  br label %if.end102
...
cond.false124:                                    ; preds = %if.end102
  ...
  store ptr %44, ptr %osucc139, align 8
  ...
  store ptr %48, ptr %osucc145, align 8
  %.pre234 = load ptr, ptr @xx_link, align 8
...
cond.false155:                                    ; preds = %cond.end146
  ...
  %51 = load ptr, ptr %arrayidx157, align 8
  ...
  store ptr %52, ptr %arrayidx157, align 8
  %53 = load ptr, ptr %arrayidx160, align 8
  %osucc170 = getelementptr inbounds [2 x %struct.LIST], ptr %53, i64 0, i64 1, i32 1
  store ptr %x, ptr %osucc170, align 8
  store ptr %51, ptr %arrayidx160, align 8
  %osucc176 = getelementptr inbounds [2 x %struct.LIST], ptr %51, i64 0, i64 1, i32 1
  store ptr %50, ptr %osucc176, align 8
...
entry:
  ...
  %oreading = getelementptr inbounds i8, ptr %db, i64 42
  %0 = load i8, ptr %oreading, align 2
...
if.then11:                                        ; preds = %if.end
  ...
  %link.0334 = load ptr, ptr %link.0.in333, align 8
...
if.then34.us:                                     ; preds = %for.cond17.us
  ...
  %.pr.us = load i8, ptr %ou1.us.le, align 8
...
for.inc54.us:                                     ; preds = %if.end43.us, %if.end36.us
  ...
  br i1 %cmp14.not.us, label %for.end58, label %for.cond17.preheader.us
...
for.inc54:                                        ; preds = %if.end36, %if.end43
  ...
  br i1 %cmp14.not, label %for.end58, label %for.cond17.preheader
...
while.cond164.preheader:                          ; preds = %cond.end134, %if.end65
  ...
  %20 = load ptr, ptr %osucc167339, align 8
...
cond.false82:                                     ; preds = %while.body
  ...
  store ptr %23, ptr %arrayidx90, align 8
  %24 = load ptr, ptr %arrayidx87, align 8
  %osucc97 = getelementptr inbounds [2 x %struct.LIST], ptr %24, i64 0, i64 1, i32 1
  store ptr %22, ptr %osucc97, align 8
  store ptr %21, ptr %osucc78, align 8
  store ptr %21, ptr %arrayidx87, align 8
...
cond.end104:                                      ; preds = %while.body, %cond.false82
  ...
  %25 = load ptr, ptr %osucc108, align 8
...
cond.false112:                                    ; preds = %cond.end104
  ...
  store ptr %27, ptr %osucc127, align 8
  %osucc130 = getelementptr inbounds %struct.LIST, ptr %28, i64 0, i32 1
  store ptr %28, ptr %osucc130, align 8
  store ptr %28, ptr %28, align 8
...
cond.end134:                                      ; preds = %cond.end104, %cond.false112
  ...
  %cond156.in = load i8, ptr %cond156.in.in, align 1
  %cond156 = zext i8 %cond156.in to i32
  store i32 %cond156, ptr @zz_size, align 4
  ...
  store ptr %33, ptr %arrayidx163, align 8
  %35 = load ptr, ptr @xx_hold, align 8
  %osucc70 = getelementptr inbounds [2 x %struct.LIST], ptr %35, i64 0, i64 1, i32 1
  %36 = load ptr, ptr %osucc70, align 8
  %cmp71.not = icmp eq ptr %36, %35
  br i1 %cmp71.not, label %while.cond164.preheader, label %while.body
...
while.body170:                                    ; preds = %while.cond164.preheader, %cond.end232
  ...
  %38 = load ptr, ptr %osucc176, align 8
...
cond.end202:                                      ; preds = %while.body170, %cond.false180
  ...
  %41 = load ptr, ptr %osucc206, align 8
...
cond.false210:                                    ; preds = %cond.end202
  ...
  store ptr %43, ptr %osucc225, align 8
  %osucc228 = getelementptr inbounds %struct.LIST, ptr %44, i64 0, i32 1
  store ptr %44, ptr %osucc228, align 8
  store ptr %44, ptr %44, align 8
  %.pre351 = load ptr, ptr @xx_link, align 8
...
cond.end232:                                      ; preds = %cond.end202, %cond.false210
  ...
  store ptr %49, ptr %arrayidx263, align 8
  %51 = load ptr, ptr @xx_hold, align 8
  %osucc167 = getelementptr inbounds %struct.LIST, ptr %51, i64 0, i32 1
  %52 = load ptr, ptr %osucc167, align 8
  %cmp168.not = icmp eq ptr %52, %51
  br i1 %cmp168.not, label %while.end264, label %while.body170
...
while.end264:                                     ; preds = %cond.end232, %while.cond164.preheader
  ...
  %cond287.in = load i8, ptr %cond287.in.in, align 1
  %cond287 = zext i8 %cond287.in to i32
  store i32 %cond287, ptr @zz_size, align 4
  %idxprom288 = zext i8 %cond287.in to i64
  %arrayidx289 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom288
  %54 = load ptr, ptr %arrayidx289, align 8
  store ptr %54, ptr %.lcssa, align 8
  ...
  store ptr %55, ptr %arrayidx294, align 8
...
land.lhs.true:                                    ; preds = %entry
  ...
  %0 = load i8, ptr %oin_memory, align 1
  %tobool.not = icmp eq i8 %0, 0
  br i1 %tobool.not, label %land.lhs.true1, label %if.end

land.lhs.true1:                                   ; preds = %land.lhs.true
  %ou3 = getelementptr inbounds %struct.word_type, ptr %db, i64 0, i32 3
  %1 = load ptr, ptr %ou3, align 8
...
while.cond:                                       ; preds = %if.end200, %if.then12
  ...
  store ptr %storemerge, ptr %t, align 8
...
for.cond.preheader:                               ; preds = %if.end35
  %link.0898 = load ptr, ptr %link.0.in897, align 8
...
land.lhs.true64:                                  ; preds = %for.cond49
  ...
  %7 = load ptr, ptr %oactual65, align 8
...
for.inc70:                                        ; preds = %for.cond49, %land.lhs.true64
  ...
  br i1 %cmp45.not, label %if.then77, label %for.cond49.preheader
...
if.then77:                                        ; preds = %for.inc70, %for.cond.preheader
  ...
  %8 = load ptr, ptr %oactual79, align 8
...
if.end83:                                         ; preds = %land.lhs.true64, %if.then38, %if.then77
  ...
  %link.1903 = load ptr, ptr %link.1.in902, align 8
...
land.lhs.true111:                                 ; preds = %for.cond94
  ...
  %10 = load ptr, ptr %oactual112, align 8
...
land.lhs.true116:                                 ; preds = %land.lhs.true111
  ...
  %11 = load ptr, ptr %osucc119, align 8
...
for.cond129:                                      ; preds = %land.lhs.true116, %for.cond129
  ...
  %12 = load i8, ptr %ou1130, align 8
  %cmp133 = icmp eq i8 %12, 0
  br i1 %cmp133, label %for.cond129, label %if.end154
...
for.inc142:                                       ; preds = %for.cond94, %land.lhs.true111, %land.lhs.true116
  ...
  br i1 %cmp88.not, label %if.then149, label %for.cond94.preheader
...
if.then149:                                       ; preds = %for.inc142, %if.end83
  ...
  %13 = load ptr, ptr %oactual151, align 8
...
if.end200:                                        ; preds = %DbCreate.exit, %if.end179
  ...
  %19 = load ptr, ptr %oactual201, align 8
...
if.end235:                                        ; preds = %if.then233, %if.then223
  ...
  %22 = load i8, ptr %ou1.i861, align 8
  %.off.i862 = add i8 %22, -11
  %switch.i863 = icmp ult i8 %.off.i862, 2
  br i1 %switch.i863, label %DbCreate.exit868, label %if.then.i864

if.then.i864:                                     ; preds = %if.end235
  %23 = load ptr, ptr @no_fpos, align 8
  %call.i865 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %23, ptr noundef nonnull @.str.1) #12
  br label %DbCreate.exit868

DbCreate.exit868:                                 ; preds = %if.end235, %if.then.i864
  %oreading.i866 = getelementptr inbounds i8, ptr %call241, i64 42
  store i8 0, ptr %oreading.i866, align 2
  %ou3.i867 = getelementptr inbounds %struct.word_type, ptr %call241, i64 0, i32 3
  store ptr null, ptr %ou3.i867, align 8
  br label %if.end243
...
if.else306:                                       ; preds = %if.end293
  ...
  store ptr %31, ptr %arrayidx301, align 8
  br label %cond.end357
...
cond.end357:                                      ; preds = %if.then304, %if.else306
  ...
  store ptr %35, ptr %osucc350, align 8
  ...
  store ptr %39, ptr %osucc356, align 8
  %41 = load ptr, ptr @xx_link, align 8
  store ptr %41, ptr @zz_res, align 8
  store ptr %symbs, ptr @zz_hold, align 8
...
cond.false366:                                    ; preds = %cond.end357
  ...
  %42 = load ptr, ptr %arrayidx368, align 8
  store ptr %42, ptr @zz_tmp, align 8
  %arrayidx371 = getelementptr inbounds [2 x %struct.LIST], ptr %41, i64 0, i64 1
  %43 = load ptr, ptr %arrayidx371, align 8
  store ptr %43, ptr %arrayidx368, align 8
  %44 = load ptr, ptr %arrayidx371, align 8
  %osucc381 = getelementptr inbounds [2 x %struct.LIST], ptr %44, i64 0, i64 1, i32 1
  store ptr %symbs, ptr %osucc381, align 8
  store ptr %42, ptr %arrayidx371, align 8
  %osucc387 = getelementptr inbounds [2 x %struct.LIST], ptr %42, i64 0, i64 1, i32 1
  store ptr %41, ptr %osucc387, align 8
  br label %if.end392
...
while.body403:                                    ; preds = %if.end667
  ...
  br i1 %or.cond718, label %while.end670.thread.loopexit, label %if.end414
...
for.cond423:                                      ; preds = %for.inc435, %if.end414
  ...
  %49 = load i8, ptr %arrayidx425, align 1
...
while.cond441:                                    ; preds = %while.body454, %if.then440
  ...
  %52 = load i8, ptr %arrayidx443, align 1
...
for.body475:                                      ; preds = %while.end471, %for.body475
  ...
  br i1 %exitcond.not, label %if.end529, label %for.body475
...
if.end514:                                        ; preds = %for.cond495, %if.then512
  ...
  %56 = load ptr, ptr %oactual516, align 8
...
if.then535:                                       ; preds = %if.end529
  ...
  %59 = load ptr, ptr %ocross_sym, align 8
...
if.else553:                                       ; preds = %if.end539
  ...
  store ptr %63, ptr %arrayidx548, align 8
  br label %if.end562
...
if.end562:                                        ; preds = %if.then551, %if.else553
  ...
  store ptr %67, ptr %osucc599, align 8
  ...
  store ptr %71, ptr %osucc605, align 8
  %.pre = load ptr, ptr @xx_link, align 8
  store ptr %.pre, ptr @zz_res, align 8
  %73 = load ptr, ptr %ocross_sym, align 8
...
if.end667:                                        ; preds = %cond.end642, %if.then650
  ...
  br i1 %cmp401.not, label %while.end670.loopexit, label %while.body403
...
while.end670:                                     ; preds = %while.end670.loopexit, %if.end397
  ...
  %79 = load i8, ptr %oin_memory, align 1
...
while.end670.thread:                              ; preds = %while.end670.thread.loopexit, %while.body403.lr.ph
  ...
  %80 = load i8, ptr %oin_memory, align 1
...
if.then677:                                       ; preds = %while.end670
  ...
  store ptr null, ptr %ou3678, align 8
  br label %if.end690
...
if.else679:                                       ; preds = %while.end670.thread
  ...
  store ptr %call682, ptr %ou3683, align 8
  %81 = load i32, ptr %len, align 4
  %conv684 = trunc i32 %81 to i16
  store i16 %conv684, ptr %ou2280, align 8
...
if.else691:                                       ; preds = %while.end670.thread, %while.end670
  ...
  store ptr %fp.1, ptr %ou3692, align 8
  store i16 %leftp.0888, ptr %ou2280, align 8
  br label %cleanup
...
for.cond.preheader:                               ; preds = %lor.lhs.false
  ...
  %link.0301 = load ptr, ptr %link.0.in300, align 8
...
if.else65:                                        ; preds = %if.end53
  ...
  store ptr %10, ptr %arrayidx60, align 8
  br label %if.end74
...
if.end74:                                         ; preds = %if.then63, %if.else65
  ...
  store ptr %11, ptr %arrayidx81, align 8
  %osucc85 = getelementptr inbounds %struct.LIST, ptr %11, i64 0, i32 1
  store ptr %11, ptr %osucc85, align 8
...
cond.false94:                                     ; preds = %if.end74
  ...
  store ptr %14, ptr %osucc109, align 8
  ...
  store ptr %18, ptr %osucc115, align 8
  %.pre = load ptr, ptr @xx_link, align 8
...
cond.end116:                                      ; preds = %if.end74, %cond.false94
  ...
  %21 = load ptr, ptr %ocross_sym, align 8
  store ptr %21, ptr @zz_hold, align 8
...
cond.false126:                                    ; preds = %cond.end116
  ...
  %22 = load ptr, ptr %arrayidx128, align 8
...
cond.end150:                                      ; preds = %cond.end116, %cond.false126
  ...
  store i8 %conv155, ptr %onumber156, align 1
...
while.body.lr.ph.i:                               ; preds = %if.then165
  ...
  %31 = load i32, ptr @UseCollate, align 4
  %32 = icmp eq i32 %31, 0
...
while.body.us.i:                                  ; preds = %while.body.lr.ph.i, %while.body.us.i
  ...
  %33 = load ptr, ptr %arrayidx4.us.i, align 8
  ...
  br i1 %cmp1.not.us.i, label %while.end.i, label %while.body.us.i
...
cond.true.i:                                      ; preds = %while.body.i
  ...
  %.pre.i = load i32, ptr @UseCollate, align 4
...
while.end.i:                                      ; preds = %if.end10.i, %while.body.us.i, %if.then165
  ...
  %39 = load ptr, ptr %arrayidx12.i, align 8
...
if.end173:                                        ; preds = %while.end.i
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %buff.i) #12
  %40 = load ptr, ptr %ou3, align 8
  %arrayidx176 = getelementptr inbounds ptr, ptr %40, i64 %idxprom11.i
  %41 = load ptr, ptr %arrayidx176, align 8
...
if.else181:                                       ; preds = %if.end157
  ...
  %42 = load ptr, ptr %ou3, align 8
  %43 = load i16, ptr %ou2, align 8
  ...
  br i1 %cmp.not79.i.not, label %while.body.i270, label %while.end.i280

while.body.i270:                                  ; preds = %if.else181, %if.end36.i
  %l.081.i = phi i32 [ %l.1.i279, %if.end36.i ], [ %conv187, %if.else181 ]
  %r.080.i = phi i32 [ %r.1.i278, %if.end36.i ], [ %sub191, %if.else181 ]
  %add.i271 = add nsw i32 %r.080.i, %l.081.i
  %div.i272 = sdiv i32 %add.i271, 2
  %conv.i = sext i32 %div.i272 to i64
  %call.i273 = call i32 @fseek(ptr noundef %42, i64 noundef %conv.i, i32 noundef 0)
  br label %do.body.i

do.body.i:                                        ; preds = %do.body.i, %while.body.i270
  %mid.0.i = phi i32 [ %div.i272, %while.body.i270 ], [ %inc.i, %do.body.i ]
  %inc.i = add nsw i32 %mid.0.i, 1
  %call1.i = call i32 @getc(ptr noundef %42)
  %cmp2.not.i = icmp eq i32 %call1.i, 10
  br i1 %cmp2.not.i, label %do.end.i, label %do.body.i

do.end.i:                                         ; preds = %do.body.i
  %cmp5.i = icmp eq i32 %mid.0.i, %r.080.i
  br i1 %cmp5.i, label %if.then.i, label %if.end.i274
...
if.end.i274:                                      ; preds = %if.then.i, %do.end.i
  ...
  %sub.i275 = add nsw i32 %conv11.i, -1
  %cmp12.not.i = icmp sgt i32 %l.081.i, %mid.1.i
  br i1 %cmp12.not.i, label %if.then14.i, label %if.end16.i

if.then14.i:                                      ; preds = %if.end.i274
  %44 = load ptr, ptr @no_fpos, align 8
  %call15.i283 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %44, ptr noundef nonnull @.str.59) #12
  br label %if.end16.i

if.end16.i:                                       ; preds = %if.then14.i, %if.end.i274
  %cmp17.i = icmp slt i32 %mid.1.i, %sub.i275
...
if.end21.i:                                       ; preds = %if.then19.i, %if.end16.i
  %cmp22.not.i = icmp sgt i32 %sub.i275, %r.080.i
...
if.end26.i:                                       ; preds = %if.then24.i, %if.end21.i
  %47 = load i32, ptr @UseCollate, align 4
  %tobool.not.i276 = icmp eq i32 %47, 0
  br i1 %tobool.not.i276, label %cond.false.i282, label %cond.true.i277

cond.true.i277:                                   ; preds = %if.end26.i
...
cond.false.i282:                                  ; preds = %if.end26.i
...
if.then33.i:                                      ; preds = %cond.false.i282, %cond.true.i277
  %sub34.i = add nsw i32 %mid.1.i, -1
  br label %if.end36.i

if.end36.i:                                       ; preds = %if.then33.i, %cond.false.i282, %cond.true.i277
  %r.1.i278 = phi i32 [ %sub34.i, %if.then33.i ], [ %r.080.i, %cond.false.i282 ], [ %r.080.i, %cond.true.i277 ]
  %l.1.i279 = phi i32 [ %l.081.i, %if.then33.i ], [ %conv11.i, %cond.false.i282 ], [ %conv11.i, %cond.true.i277 ]
  %cmp.not.i = icmp sgt i32 %l.1.i279, %r.1.i278
  br i1 %cmp.not.i, label %while.end.i280, label %while.body.i270

while.end.i280:                                   ; preds = %if.end36.i, %if.else181
  %l.0.lcssa.i281 = phi i32 [ %conv187, %if.else181 ], [ %l.1.i279, %if.end36.i ]
  %cmp37.i = icmp slt i32 %l.0.lcssa.i281, %sub191
  br i1 %cmp37.i, label %SearchFile.exit, label %SearchFile.exit.thread

SearchFile.exit.thread:                           ; preds = %while.end.i280
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %buff.i269) #12
  br label %cleanup

SearchFile.exit:                                  ; preds = %while.end.i280
  %conv40.i = sext i32 %l.0.lcssa.i281 to i64
...
if.end203:                                        ; preds = %if.end197, %if.end173
  ...
  store i64 %storemerge, ptr %cont, align 8
...
if.end212:                                        ; preds = %if.then208, %if.end203
  ...
  store i16 %call214, ptr %dfnum, align 2
...
if.then218:                                       ; preds = %if.end212
  ...
  store i16 %call221, ptr %dfnum, align 2
  br label %cleanup
...
if.end2:                                          ; preds = %if.end
  %oin_memory = getelementptr inbounds i8, ptr %db, i64 43
  %3 = load i8, ptr %oin_memory, align 1
  %tobool4.not = icmp eq i8 %3, 0
  %4 = load i64, ptr %cont, align 8
  br i1 %tobool4.not, label %if.else, label %if.then5

if.then5:                                         ; preds = %if.end2
  %5 = load i16, ptr %ou2, align 8
...
if.end10:                                         ; preds = %if.then5
  ...
  store i32 %cond, ptr %gall, align 4
...
if.end32:                                         ; preds = %cond.end
  ...
  store i32 %cond37, ptr %gall, align 4
...
if.end53:                                         ; preds = %if.then49, %if.end44
  ...
  store i16 %call55, ptr %dfnum, align 2
...
for.inc87:                                        ; preds = %for.cond68, %land.lhs.true
  ...
  br i1 %cmp64.not, label %if.end96, label %for.cond68.preheader
...
if.end96:                                         ; preds = %for.inc87, %if.end62
  ...
  %.pre = load i8, ptr %ou197.phi.trans.insert, align 8
