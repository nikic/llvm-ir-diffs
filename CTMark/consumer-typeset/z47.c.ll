; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z47.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z47.c"
...
entry:
  store i32 0, ptr @stat_reads, align 4
  store i32 0, ptr @stat_read_hits, align 4
  store i32 0, ptr @stat_writes, align 4
  store i32 0, ptr @stat_write_hits, align 4
...
if.end13:                                         ; preds = %if.then5, %if.else7
  ...
  store ptr %4, ptr @env_cache, align 8
  store i32 0, ptr @cache_count, align 4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(1688) @tab, i8 0, i64 1688, i1 false)
  ret void
}
...
entry:
  %0 = load i32, ptr @stat_writes, align 4
  %inc = add nsw i32 %0, 1
  store i32 %inc, ptr @stat_writes, align 4
...
for.cond.preheader:                               ; preds = %entry
  ...
  %link.0142 = load ptr, ptr %link.0.in141, align 8
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.cond11
  ...
  br i1 %cmp13, label %for.cond11, label %for.end

for.end:                                          ; preds = %for.cond11
  %osucc21 = getelementptr inbounds %struct.LIST, ptr %y.0, i64 0, i32 1
  %5 = load ptr, ptr %osucc21, align 8
  br label %for.cond25
...
for.cond25:                                       ; preds = %for.cond25, %for.end
  ...
  %6 = load i8, ptr %ou126, align 8
  %cmp29 = icmp eq i8 %6, 0
  br i1 %cmp29, label %for.cond25, label %for.end36
...
if.then45:                                        ; preds = %land.lhs.true44
  ...
  %10 = load ptr, ptr %osucc51, align 8
...
cond.false:                                       ; preds = %if.then45
  ...
  store ptr %13, ptr %osucc71, align 8
...
cond.end:                                         ; preds = %if.then45, %cond.false
  ...
  %16 = load ptr, ptr @env_cache, align 8
...
cond.false82:                                     ; preds = %cond.end
  ...
  store ptr %19, ptr %osucc97, align 8
  ...
  store ptr %23, ptr %osucc103, align 8
...
cond.end106:                                      ; preds = %cond.end, %cond.false82
  ...
  store i32 %bf.clear111, ptr %lnum, align 4
  %26 = load i32, ptr @stat_write_hits, align 4
  %inc112 = add nsw i32 %26, 1
  store i32 %inc112, ptr @stat_write_hits, align 4
  br label %cleanup
...
for.inc113:                                       ; preds = %for.end36, %land.lhs.true44
  ...
  br i1 %cmp7.not, label %cleanup, label %for.cond11.preheader
...
entry:
  %0 = load i32, ptr @cache_count, align 4
  %cmp = icmp sgt i32 %0, 179
  br i1 %cmp, label %if.then, label %if.end193

if.then:                                          ; preds = %entry
  %1 = load ptr, ptr @env_cache, align 8
...
cond.end:                                         ; preds = %for.end, %cond.false
  ...
  %8 = load ptr, ptr %osucc39, align 8
...
cond.false43:                                     ; preds = %cond.end
  ...
  store ptr %10, ptr %osucc58, align 8
  %osucc61 = getelementptr inbounds %struct.LIST, ptr %11, i64 0, i32 1
  store ptr %11, ptr %osucc61, align 8
...
cond.end65:                                       ; preds = %cond.end, %cond.false43
  ...
  store ptr %16, ptr %arrayidx93, align 8
  %18 = load ptr, ptr %osucc10, align 8
  store ptr %18, ptr @xx_link, align 8
  %osucc99 = getelementptr inbounds [2 x %struct.LIST], ptr %18, i64 0, i64 1, i32 1
  %19 = load ptr, ptr %osucc99, align 8
...
cond.end155:                                      ; preds = %cond.end125, %cond.false133
  ...
  store ptr %30, ptr %arrayidx186, align 8
  %32 = load ptr, ptr @xx_tmp, align 8
  %osucc189 = getelementptr inbounds [2 x %struct.LIST], ptr %32, i64 0, i64 1, i32 1
  %33 = load ptr, ptr %osucc189, align 8
...
if.end193:                                        ; preds = %if.end, %entry
  ...
  %37 = load ptr, ptr %arrayidx196, align 8
...
if.else212:                                       ; preds = %if.then199
  ...
  store ptr %41, ptr %arrayidx207, align 8
  br label %if.end221
...
if.end221:                                        ; preds = %if.then210, %if.else212
  ...
  store i8 17, ptr %ou1222, align 8
  ...
  store ptr %42, ptr %arrayidx228, align 8
  %osucc232 = getelementptr inbounds %struct.LIST, ptr %42, i64 0, i32 1
  store ptr %42, ptr %osucc232, align 8
  store ptr %42, ptr %42, align 8
  store ptr %42, ptr %arrayidx196, align 8
  br label %if.end238
...
if.end238:                                        ; preds = %if.end221, %if.end193
  ...
  store i32 %conv239, ptr @zz_size, align 4
...
if.then250:                                       ; preds = %if.end238
  ...
  store ptr %call251, ptr @zz_hold, align 8
  br label %if.end261

if.else252:                                       ; preds = %if.end238
  store ptr %44, ptr @zz_hold, align 8
  %46 = load ptr, ptr %44, align 8
  store ptr %46, ptr %arrayidx247, align 8
  br label %if.end261
...
if.end261:                                        ; preds = %if.then250, %if.else252
  ...
  store i8 17, ptr %ou1262, align 8
...
if.else295:                                       ; preds = %if.end261
  ...
  store ptr %51, ptr %arrayidx290, align 8
  br label %if.end304
...
if.end304:                                        ; preds = %if.then293, %if.else295
  ...
  %53 = load ptr, ptr %arrayidx196, align 8
...
cond.end352:                                      ; preds = %if.end304
  ...
  store ptr %56, ptr %osucc343, align 8
  ...
  store ptr %60, ptr %osucc349, align 8
...
cond.end352.cond.false361_crit_edge:              ; preds = %cond.end352
  ...
  %.pre630 = load ptr, ptr %arrayidx366.phi.trans.insert, align 8
  br label %cond.false361
...
if.else400:                                       ; preds = %cond.end385
  ...
  store ptr %69, ptr %arrayidx395, align 8
  br label %if.end409
...
cond.end455:                                      ; preds = %if.end409
  ...
  store ptr %74, ptr %osucc446, align 8
  ...
  store ptr %78, ptr %osucc452, align 8
  %.pr626 = load ptr, ptr @xx_link, align 8
  store ptr %.pr626, ptr @zz_res, align 8
  store ptr %47, ptr @zz_hold, align 8
...
cond.end455.cond.false464_crit_edge:              ; preds = %cond.end455
  ...
  %.pre631 = load ptr, ptr %arrayidx469.phi.trans.insert, align 8
  br label %cond.false464
...
if.else503:                                       ; preds = %cond.end488
  ...
  store ptr %87, ptr %arrayidx498, align 8
  br label %cond.end558
...
cond.end558:                                      ; preds = %if.then501, %if.else503
  ...
  store ptr %95, ptr %osucc555, align 8
  %97 = load ptr, ptr @xx_link, align 8
  store ptr %97, ptr @zz_res, align 8
...
cond.false567:                                    ; preds = %cond.end558
  ...
  %98 = load ptr, ptr %arrayidx569, align 8
  store ptr %98, ptr @zz_tmp, align 8
  %arrayidx572 = getelementptr inbounds [2 x %struct.LIST], ptr %97, i64 0, i64 1
  %99 = load ptr, ptr %arrayidx572, align 8
  store ptr %99, ptr %arrayidx569, align 8
  %100 = load ptr, ptr %arrayidx572, align 8
  %osucc582 = getelementptr inbounds [2 x %struct.LIST], ptr %100, i64 0, i64 1, i32 1
  store ptr %env, ptr %osucc582, align 8
  store ptr %98, ptr %arrayidx572, align 8
  %osucc588 = getelementptr inbounds [2 x %struct.LIST], ptr %98, i64 0, i64 1, i32 1
  store ptr %97, ptr %osucc588, align 8
  br label %cond.end591

cond.end591:                                      ; preds = %cond.end558, %cond.false567
  %101 = load i32, ptr @cache_count, align 4
  %inc = add nsw i32 %101, 1
  store i32 %inc, ptr @cache_count, align 4
  ret void
}
...
entry:
  %0 = load i32, ptr @stat_reads, align 4
  %inc = add nsw i32 %0, 1
  store i32 %inc, ptr @stat_reads, align 4
  %conv = zext i16 %fnum to i32
...
for.cond.preheader:                               ; preds = %entry
  ...
  %link.0160 = load ptr, ptr %link.0.in159, align 8
...
for.end:                                          ; preds = %for.cond11
  %ofile_num = getelementptr inbounds %struct.word_type, ptr %y.0, i64 0, i32 1, i32 0, i32 2
  %3 = load i16, ptr %ofile_num, align 2
...
land.lhs.true:                                    ; preds = %for.end
  ...
  %4 = load i32, ptr %arrayidx42, align 4
...
if.then46:                                        ; preds = %land.lhs.true45
  ...
  %7 = load ptr, ptr %osucc52, align 8
...
cond.false:                                       ; preds = %if.then46
  ...
  store ptr %9, ptr %osucc69, align 8
  %osucc72 = getelementptr inbounds %struct.LIST, ptr %10, i64 0, i32 1
  store ptr %10, ptr %osucc72, align 8
...
cond.end:                                         ; preds = %if.then46, %cond.false
  ...
  %13 = load ptr, ptr @env_cache, align 8
  store ptr %13, ptr @zz_hold, align 8
...
cond.false83:                                     ; preds = %cond.end
  ...
  store ptr %16, ptr %osucc98, align 8
  ...
  store ptr %20, ptr %osucc104, align 8
  br label %cond.end107

cond.end107:                                      ; preds = %cond.end, %cond.false83
  %22 = load ptr, ptr %osucc21.le, align 8
...
for.cond115:                                      ; preds = %for.cond115, %cond.end107
  ...
  store ptr %storemerge, ptr %env, align 8
  %ou1116 = getelementptr inbounds %struct.word_type, ptr %storemerge, i64 0, i32 1
  %23 = load i8, ptr %ou1116, align 8
  %cmp119 = icmp eq i8 %23, 0
  br i1 %cmp119, label %for.cond115, label %for.end126

for.end126:                                       ; preds = %for.cond115
  %24 = load i32, ptr @stat_read_hits, align 4
  %inc127 = add nsw i32 %24, 1
  store i32 %inc127, ptr @stat_read_hits, align 4
  br label %cleanup
...
cond.false133:                                    ; preds = %cond.end125
  ...
  store ptr %25, ptr %osucc151, align 8
  store ptr %25, ptr %25, align 8
  %.pre623 = load ptr, ptr @xx_link, align 8
  br label %cond.end155
...
if.then192:                                       ; preds = %cond.end155
  %call = tail call i32 @DisposeObject(ptr noundef nonnull %32) #4
  %.pre624 = load i32, ptr @cache_count, align 4
  br label %if.end
...
if.end193:                                        ; preds = %if.end, %entry
  ...
  %arrayidx196 = getelementptr inbounds [211 x ptr], ptr @tab, i64 0, i64 %idxprom195
  %35 = load ptr, ptr %arrayidx196, align 8
  %cmp197 = icmp eq ptr %35, null
  br i1 %cmp197, label %if.then199, label %if.end238

if.then199:                                       ; preds = %if.end193
  %36 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 17), align 1
  %conv200 = zext i8 %36 to i32
  store i32 %conv200, ptr @zz_size, align 4
  %conv201 = zext i8 %36 to i64
  %arrayidx207 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv201
  %37 = load ptr, ptr %arrayidx207, align 8
...
if.else212:                                       ; preds = %if.then199
  ...
  store ptr %39, ptr %arrayidx207, align 8
  br label %if.end221
...
if.end221:                                        ; preds = %if.then210, %if.else212
  ...
  store ptr %40, ptr %osucc226, align 8
  %arrayidx228 = getelementptr inbounds [2 x %struct.LIST], ptr %40, i64 0, i64 1
  store ptr %40, ptr %arrayidx228, align 8
  %osucc232 = getelementptr inbounds %struct.LIST, ptr %40, i64 0, i32 1
  store ptr %40, ptr %osucc232, align 8
  store ptr %40, ptr %40, align 8
  store ptr %40, ptr %arrayidx196, align 8
  br label %if.end238

if.end238:                                        ; preds = %if.end221, %if.end193
  %41 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 17), align 1
  %conv239 = zext i8 %41 to i32
  store i32 %conv239, ptr @zz_size, align 4
  %conv240 = zext i8 %41 to i64
  %arrayidx247 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv240
  %42 = load ptr, ptr %arrayidx247, align 8
...
if.else252:                                       ; preds = %if.end238
  ...
  store ptr %44, ptr %arrayidx247, align 8
  br label %if.end261
...
if.end261:                                        ; preds = %if.then250, %if.else252
  ...
  store ptr %45, ptr %osucc266, align 8
  store ptr %45, ptr %arrayidx265, align 8
  %osucc272 = getelementptr inbounds %struct.LIST, ptr %45, i64 0, i32 1
  store ptr %45, ptr %osucc272, align 8
...
if.else291:                                       ; preds = %if.end261
  ...
  store ptr %49, ptr %arrayidx286, align 8
  br label %if.end300
...
cond.end348:                                      ; preds = %if.end300
  ...
  store ptr %52, ptr @zz_tmp, align 8
  ...
  store ptr %54, ptr %osucc339, align 8
  ...
  store ptr %58, ptr %osucc345, align 8
  %.pr = load ptr, ptr @xx_link, align 8
  store ptr %.pr, ptr @zz_res, align 8
  store ptr %45, ptr @zz_hold, align 8
...
cond.end348.cond.false357_crit_edge:              ; preds = %cond.end348
  ...
  %.pre625 = load ptr, ptr %arrayidx362.phi.trans.insert, align 8
  br label %cond.false357
...
if.else396:                                       ; preds = %cond.end381
  ...
  store ptr %67, ptr %arrayidx391, align 8
  br label %if.end405
...
cond.end451:                                      ; preds = %if.end405
  ...
  store ptr %72, ptr %osucc442, align 8
  ...
  store ptr %76, ptr %osucc448, align 8
  %.pr621 = load ptr, ptr @xx_link, align 8
  store ptr %.pr621, ptr @zz_res, align 8
  store ptr %45, ptr @zz_hold, align 8
...
cond.end451.cond.false460_crit_edge:              ; preds = %cond.end451
  ...
  %.pre626 = load ptr, ptr %arrayidx465.phi.trans.insert, align 8
  br label %cond.false460
...
if.else499:                                       ; preds = %cond.end484
  ...
  store ptr %85, ptr %arrayidx494, align 8
  br label %cond.end554
...
cond.end554:                                      ; preds = %if.then497, %if.else499
  ...
  store ptr %89, ptr %osucc545, align 8
  ...
  store ptr %93, ptr %osucc551, align 8
  %95 = load ptr, ptr @xx_link, align 8
...
cond.false563:                                    ; preds = %cond.end554
  ...
  %96 = load ptr, ptr %arrayidx565, align 8
  store ptr %96, ptr @zz_tmp, align 8
  %arrayidx568 = getelementptr inbounds [2 x %struct.LIST], ptr %95, i64 0, i64 1
  %97 = load ptr, ptr %arrayidx568, align 8
  store ptr %97, ptr %arrayidx565, align 8
  %98 = load ptr, ptr %arrayidx568, align 8
  %osucc578 = getelementptr inbounds [2 x %struct.LIST], ptr %98, i64 0, i64 1, i32 1
  store ptr %env, ptr %osucc578, align 8
  store ptr %96, ptr %arrayidx568, align 8
...
cond.end587:                                      ; preds = %cond.end554, %cond.false563
  %99 = load i32, ptr @cache_count, align 4
