; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z18.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z18.c"
...
entry:
  ...
  store i32 8388606, ptr @initial_constraint, align 4
  store i32 8388606, ptr getelementptr inbounds (%struct.CONSTRAINT, ptr @initial_constraint, i64 0, i32 1), align 4
  store i32 8388606, ptr getelementptr inbounds (%struct.CONSTRAINT, ptr @initial_constraint, i64 0, i32 2), align 4
  store ptr %InitEnv, ptr @InitialEnvironment, align 8
  ...
  store i16 360, ptr getelementptr inbounds (%struct.STYLE, ptr @InitialStyle, i64 0, i32 0, i32 0, i32 1), align 2
  ...
  store i16 120, ptr getelementptr inbounds (%struct.STYLE, ptr @InitialStyle, i64 0, i32 1, i32 0, i32 1), align 2
  ...
  %0 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 8), align 1
...
if.then74:                                        ; preds = %entry
  ...
  store ptr %call75, ptr @zz_hold, align 8
  br label %if.end82
...
if.end82:                                         ; preds = %if.then74, %if.else76
  ...
  store ptr %4, ptr %arrayidx86, align 8
  %osucc90 = getelementptr inbounds %struct.LIST, ptr %4, i64 0, i32 1
  store ptr %4, ptr %osucc90, align 8
  ...
  store ptr null, ptr %oactual, align 8
  ...
  %5 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 122), align 1
  %conv101 = zext i8 %5 to i32
  store i32 %conv101, ptr @zz_size, align 4
  %conv102 = zext i8 %5 to i64
  %arrayidx109 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv102
  %6 = load ptr, ptr %arrayidx109, align 8
...
if.then112:                                       ; preds = %if.end82
  ...
  store ptr %call113, ptr @zz_hold, align 8
  br label %if.end123

if.else114:                                       ; preds = %if.end82
  store ptr %6, ptr @zz_hold, align 8
  %8 = load ptr, ptr %6, align 8
  store ptr %8, ptr %arrayidx109, align 8
  br label %if.end123
...
if.end123:                                        ; preds = %if.then112, %if.else114
  ...
  store i8 122, ptr %ou1124, align 8
  ...
  store ptr %9, ptr %osucc128, align 8
  store ptr %9, ptr %arrayidx127, align 8
  %osucc134 = getelementptr inbounds %struct.LIST, ptr %9, i64 0, i32 1
  store ptr %9, ptr %osucc134, align 8
  store ptr %9, ptr %9, align 8
  %10 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 2), align 1
  %conv138 = zext i8 %10 to i32
  store i32 %conv138, ptr @zz_size, align 4
  %conv139 = zext i8 %10 to i64
  %arrayidx146 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv139
  %11 = load ptr, ptr %arrayidx146, align 8
...
if.then149:                                       ; preds = %if.end123
  ...
  store ptr %call150, ptr @zz_hold, align 8
  br label %if.end160

if.else151:                                       ; preds = %if.end123
  store ptr %11, ptr @zz_hold, align 8
  %13 = load ptr, ptr %11, align 8
  store ptr %13, ptr %arrayidx146, align 8
  br label %if.end160
...
if.end160:                                        ; preds = %if.then149, %if.else151
  ...
  %17 = load ptr, ptr %arrayidx201, align 8
...
if.else206:                                       ; preds = %if.end160
  ...
  store ptr %19, ptr %arrayidx201, align 8
  br label %cond.end257
...
cond.end257:                                      ; preds = %if.then204, %if.else206
  ...
  store ptr %23, ptr %osucc250, align 8
  ...
  store ptr %27, ptr %osucc256, align 8
...
cond.false266:                                    ; preds = %cond.end257
  ...
  %31 = load ptr, ptr %arrayidx271, align 8
  store ptr %31, ptr %arrayidx127, align 8
  %32 = load ptr, ptr %arrayidx271, align 8
  %osucc281 = getelementptr inbounds [2 x %struct.LIST], ptr %32, i64 0, i64 1, i32 1
  store ptr %9, ptr %osucc281, align 8
  store ptr %30, ptr %arrayidx271, align 8
  %osucc287 = getelementptr inbounds [2 x %struct.LIST], ptr %30, i64 0, i64 1, i32 1
  store ptr %29, ptr %osucc287, align 8
  br label %cond.end290

cond.end290:                                      ; preds = %cond.end257, %cond.false266
  %33 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 8), align 1
  %conv292 = zext i8 %33 to i32
  store i32 %conv292, ptr @zz_size, align 4
  %conv293 = zext i8 %33 to i64
  %arrayidx300 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv293
  %34 = load ptr, ptr %arrayidx300, align 8
...
if.then303:                                       ; preds = %cond.end290
  ...
  store ptr %call304, ptr @zz_hold, align 8
  br label %if.end314

if.else305:                                       ; preds = %cond.end290
  store ptr %34, ptr @zz_hold, align 8
  %36 = load ptr, ptr %34, align 8
  store ptr %36, ptr %arrayidx300, align 8
  br label %if.end314
...
if.end314:                                        ; preds = %if.then303, %if.else305
  ...
  store i8 -127, ptr %ou2370, align 8
  %40 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 2), align 1
  %conv371 = zext i8 %40 to i32
  store i32 %conv371, ptr @zz_size, align 4
  %conv372 = zext i8 %40 to i64
  %arrayidx379 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv372
  %41 = load ptr, ptr %arrayidx379, align 8
...
if.then382:                                       ; preds = %if.end314
  ...
  store ptr %call383, ptr @zz_hold, align 8
  br label %if.end393

if.else384:                                       ; preds = %if.end314
  store ptr %41, ptr @zz_hold, align 8
  %42 = load ptr, ptr %41, align 8
  store ptr %42, ptr %arrayidx379, align 8
  br label %if.end393
...
if.end393:                                        ; preds = %if.then382, %if.else384
  ...
  store ptr %43, ptr %osucc398, align 8
  store ptr %43, ptr %arrayidx397, align 8
  %osucc404 = getelementptr inbounds %struct.LIST, ptr %43, i64 0, i32 1
  store ptr %43, ptr %osucc404, align 8
...
if.else422:                                       ; preds = %if.end393
  ...
  store ptr %48, ptr %arrayidx417, align 8
  br label %if.end431
...
cond.end477:                                      ; preds = %if.end431
  ...
  store ptr %53, ptr %osucc468, align 8
  ...
  store ptr %57, ptr %osucc474, align 8
...
cond.end477.cond.false486_crit_edge:              ; preds = %cond.end477
  ...
  %.pre = load ptr, ptr %arrayidx491.phi.trans.insert, align 8
  br label %cond.false486
...
if.end516:                                        ; preds = %if.then514, %cond.end510
  %65 = load ptr, ptr %inners, align 8
...
if.else535:                                       ; preds = %if.end521
  ...
  store ptr %70, ptr %arrayidx530, align 8
  br label %cond.end590
...
cond.end590:                                      ; preds = %if.then533, %if.else535
  ...
  store ptr %74, ptr %osucc581, align 8
  ...
  store ptr %78, ptr %osucc587, align 8
  %80 = load ptr, ptr @xx_link, align 8
  store ptr %80, ptr @zz_res, align 8
  %81 = load ptr, ptr @root_galley, align 8
...
cond.end623:                                      ; preds = %cond.end590, %cond.false599
  ...
  %85 = load ptr, ptr %osucc627, align 8
  br label %for.cond
...
land.lhs.true650:                                 ; preds = %land.lhs.true
  ...
  %89 = load ptr, ptr %oactual652, align 8
  %90 = load ptr, ptr @InputSym, align 8
...
if.then655:                                       ; preds = %for.cond, %land.lhs.true650, %land.lhs.true
  ...
  %.pre873 = load ptr, ptr %oactual658.phi.trans.insert, align 8
  br label %if.end657
...
if.end666:                                        ; preds = %if.then664, %if.end657
  ...
  store i32 0, ptr @itop, align 4
  %95 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 17), align 1
  %conv672 = zext i8 %95 to i32
  store i32 %conv672, ptr @zz_size, align 4
  %conv673 = zext i8 %95 to i64
  %arrayidx680 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv673
  %96 = load ptr, ptr %arrayidx680, align 8
...
if.then683:                                       ; preds = %if.end666
  ...
  store ptr %call684, ptr @zz_hold, align 8
  %.pre874 = load i32, ptr @itop, align 4
...
if.else685:                                       ; preds = %if.end666
  ...
  store ptr %99, ptr %arrayidx680, align 8
  br label %if.end694
...
if.then722:                                       ; preds = %if.end694
  ...
  %.pre875 = load i32, ptr @itop, align 4
  ...
  %.pre876 = load ptr, ptr %arrayidx749.phi.trans.insert, align 8
  br label %if.end733
...
cond.end781:                                      ; preds = %if.end733
  ...
  store ptr %109, ptr %osucc772, align 8
  ...
  store ptr %113, ptr %osucc778, align 8
  %.pre877 = load ptr, ptr @xx_link, align 8
  store ptr %.pre877, ptr @zz_res, align 8
  store ptr %y.0, ptr @zz_hold, align 8
...
cond.false790:                                    ; preds = %cond.end781.thread, %cond.end781
  ...
  %116 = load ptr, ptr %arrayidx792, align 8
  store ptr %116, ptr @zz_tmp, align 8
  %arrayidx795 = getelementptr inbounds [2 x %struct.LIST], ptr %115, i64 0, i64 1
  %117 = load ptr, ptr %arrayidx795, align 8
  store ptr %117, ptr %arrayidx792, align 8
  %118 = load ptr, ptr %arrayidx795, align 8
  %osucc805 = getelementptr inbounds [2 x %struct.LIST], ptr %118, i64 0, i64 1, i32 1
  store ptr %y.0, ptr %osucc805, align 8
  store ptr %116, ptr %arrayidx795, align 8
  %osucc811 = getelementptr inbounds [2 x %struct.LIST], ptr %116, i64 0, i64 1, i32 1
  store ptr %115, ptr %osucc811, align 8
...
cond.end814:                                      ; preds = %cond.end781, %cond.false790
  ...
  %119 = load ptr, ptr %oactual658, align 8
...
if.then9:                                         ; preds = %if.end3
  ...
  %.pre1435 = load ptr, ptr %arrayidx16.phi.trans.insert, align 8
  %osucc19.phi.trans.insert = getelementptr inbounds %struct.LIST, ptr %.pre1435, i64 0, i32 1
  %.pre1436 = load ptr, ptr %osucc19.phi.trans.insert, align 8
...
if.end42:                                         ; preds = %for.end, %if.then39
  ...
  %13 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 17), align 1
...
if.else56:                                        ; preds = %if.end42
  ...
  store ptr %16, ptr %arrayidx51, align 8
  br label %if.end65
...
if.else93:                                        ; preds = %if.end65
  ...
  store ptr %21, ptr %arrayidx88, align 8
  br label %cond.end144
...
cond.end144:                                      ; preds = %if.then91, %if.else93
  ...
  store ptr %25, ptr %osucc137, align 8
  %28 = load ptr, ptr @zz_tmp, align 8
  ...
  store ptr %29, ptr %osucc143, align 8
  %31 = load ptr, ptr @xx_link, align 8
  store ptr %31, ptr @zz_res, align 8
  store ptr %new_env.0, ptr @zz_hold, align 8
...
cond.false153:                                    ; preds = %cond.end144
  ...
  store ptr %new_env.0, ptr %osucc168, align 8
  store ptr %32, ptr %arrayidx158, align 8
...
cond.end177:                                      ; preds = %cond.end144, %cond.false153
  %35 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 120), align 1
  %conv179 = zext i8 %35 to i32
  store i32 %conv179, ptr @zz_size, align 4
...
if.then190:                                       ; preds = %cond.end177
  ...
  store ptr %call191, ptr @zz_hold, align 8
  br label %if.end201

if.else192:                                       ; preds = %cond.end177
  store ptr %36, ptr @zz_hold, align 8
  %38 = load ptr, ptr %36, align 8
  store ptr %38, ptr %arrayidx187, align 8
  br label %if.end201
...
if.end201:                                        ; preds = %if.then190, %if.else192
  ...
  store i8 120, ptr %ou1202, align 8
  ...
  store ptr %39, ptr %osucc206, align 8
  store ptr %39, ptr %arrayidx205, align 8
  %osucc212 = getelementptr inbounds %struct.LIST, ptr %39, i64 0, i32 1
  store ptr %39, ptr %osucc212, align 8
  ...
  %40 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 8), align 1
  ...
  %41 = load ptr, ptr %arrayidx224, align 8
...
if.else229:                                       ; preds = %if.end201
  ...
  store ptr %43, ptr %arrayidx224, align 8
  br label %if.end238
...
if.end238:                                        ; preds = %if.then227, %if.else229
  ...
  store ptr %9, ptr %oactual272, align 8
...
if.else298:                                       ; preds = %if.end238
  ...
  store ptr %49, ptr %arrayidx293, align 8
  br label %cond.end353
...
cond.end353:                                      ; preds = %if.then296, %if.else298
  ...
  store ptr %53, ptr %osucc344, align 8
  %56 = load ptr, ptr @zz_tmp, align 8
  store ptr %56, ptr %54, align 8
  %57 = load ptr, ptr @zz_res, align 8
  %58 = load ptr, ptr @zz_tmp, align 8
  %osucc350 = getelementptr inbounds %struct.LIST, ptr %58, i64 0, i32 1
  store ptr %57, ptr %osucc350, align 8
  %59 = load ptr, ptr @xx_link, align 8
  store ptr %59, ptr @zz_res, align 8
...
cond.false362:                                    ; preds = %cond.end353
  ...
  %61 = load ptr, ptr %arrayidx367, align 8
  store ptr %61, ptr %arrayidx242, align 8
  %62 = load ptr, ptr %arrayidx367, align 8
  %osucc377 = getelementptr inbounds [2 x %struct.LIST], ptr %62, i64 0, i64 1, i32 1
  store ptr %44, ptr %osucc377, align 8
  store ptr %60, ptr %arrayidx367, align 8
  %osucc383 = getelementptr inbounds [2 x %struct.LIST], ptr %60, i64 0, i64 1, i32 1
  store ptr %59, ptr %osucc383, align 8
...
if.else401:                                       ; preds = %cond.end386
  ...
  store ptr %66, ptr %arrayidx396, align 8
  br label %cond.end456
...
cond.end456:                                      ; preds = %if.then399, %if.else401
  ...
  store ptr %70, ptr %osucc447, align 8
  ...
  store ptr %74, ptr %osucc453, align 8
...
cond.false465:                                    ; preds = %cond.end456
  ...
  %77 = load ptr, ptr %arrayidx467, align 8
  store ptr %77, ptr @zz_tmp, align 8
  %arrayidx470 = getelementptr inbounds [2 x %struct.LIST], ptr %76, i64 0, i64 1
  %78 = load ptr, ptr %arrayidx470, align 8
  store ptr %78, ptr %arrayidx467, align 8
  %79 = load ptr, ptr %arrayidx470, align 8
  %osucc480 = getelementptr inbounds [2 x %struct.LIST], ptr %79, i64 0, i64 1, i32 1
  store ptr %x, ptr %osucc480, align 8
  store ptr %77, ptr %arrayidx470, align 8
  %osucc486 = getelementptr inbounds [2 x %struct.LIST], ptr %77, i64 0, i64 1, i32 1
  store ptr %76, ptr %osucc486, align 8
...
cond.end489:                                      ; preds = %cond.end456, %cond.false465
  ...
  %80 = load ptr, ptr %oactual272, align 8
...
cond.end500:                                      ; preds = %cond.end489, %cond.true497
  ...
  store ptr %cond501, ptr %oenclose_obj, align 8
...
if.else515:                                       ; preds = %cond.end500
  ...
  store ptr %85, ptr %arrayidx510, align 8
  br label %if.end524
...
cond.end573:                                      ; preds = %if.end524
  ...
  store ptr %90, ptr %osucc564, align 8
  ...
  store ptr %94, ptr %osucc570, align 8
  %.pre1437 = load ptr, ptr @xx_link, align 8
  store ptr %.pre1437, ptr @zz_res, align 8
  store ptr %39, ptr @zz_hold, align 8
...
cond.end606:                                      ; preds = %cond.end573, %cond.false582
  ...
  %100 = load ptr, ptr %oux608, align 8
...
if.end619:                                        ; preds = %if.then618, %lor.lhs.false
  %102 = load ptr, ptr %osucc243, align 8
...
for.cond626:                                      ; preds = %for.cond626, %if.end619
  ...
  %103 = load i8, ptr %ou1627, align 8
...
while.cond748.preheader:                          ; preds = %cond.end717, %if.then650
  ...
  %107 = load ptr, ptr %osucc7511425, align 8
...
cond.false665:                                    ; preds = %while.body
  ...
  %110 = load ptr, ptr %arrayidx670, align 8
  %arrayidx673 = getelementptr inbounds [2 x %struct.LIST], ptr %109, i64 0, i64 1
  store ptr %110, ptr %arrayidx673, align 8
  %111 = load ptr, ptr %arrayidx670, align 8
  %osucc680 = getelementptr inbounds [2 x %struct.LIST], ptr %111, i64 0, i64 1, i32 1
  store ptr %109, ptr %osucc680, align 8
  store ptr %108, ptr %osucc661, align 8
  store ptr %108, ptr %arrayidx670, align 8
...
cond.false695:                                    ; preds = %cond.end687
  ...
  store ptr %114, ptr %osucc710, align 8
  %osucc713 = getelementptr inbounds %struct.LIST, ptr %115, i64 0, i32 1
  store ptr %115, ptr %osucc713, align 8
  store ptr %115, ptr %115, align 8
  %.pre1438 = load ptr, ptr @xx_link, align 8
...
cond.end717:                                      ; preds = %cond.end687, %cond.false695
  ...
  %118 = load i8, ptr %ou1719, align 8
  %.off = add i8 %118, -11
...
while.body754:                                    ; preds = %while.cond748.preheader, %cond.end816
  ...
  %125 = load ptr, ptr %osucc760, align 8
...
cond.false764:                                    ; preds = %while.body754
  ...
  %126 = load ptr, ptr %arrayidx769, align 8
  %arrayidx772 = getelementptr inbounds [2 x %struct.LIST], ptr %125, i64 0, i64 1
  store ptr %126, ptr %arrayidx772, align 8
  %127 = load ptr, ptr %arrayidx769, align 8
  %osucc779 = getelementptr inbounds [2 x %struct.LIST], ptr %127, i64 0, i64 1, i32 1
  store ptr %125, ptr %osucc779, align 8
  store ptr %124, ptr %osucc760, align 8
  store ptr %124, ptr %arrayidx769, align 8
  br label %cond.end786

cond.end786:                                      ; preds = %while.body754, %cond.false764
  store ptr %124, ptr @zz_hold, align 8
  %osucc790 = getelementptr inbounds %struct.LIST, ptr %124, i64 0, i32 1
  %128 = load ptr, ptr %osucc790, align 8
...
cond.false794:                                    ; preds = %cond.end786
  ...
  store ptr %130, ptr %osucc809, align 8
  %osucc812 = getelementptr inbounds %struct.LIST, ptr %131, i64 0, i32 1
  store ptr %131, ptr %osucc812, align 8
  store ptr %131, ptr %131, align 8
  %.pre1439 = load ptr, ptr @xx_link, align 8
...
cond.end816:                                      ; preds = %cond.end786, %cond.false794
  ...
  %134 = load i8, ptr %ou1818, align 8
...
for.cond892:                                      ; preds = %while.end848, %for.cond892
  %.pn1400 = phi ptr [ %env.0, %for.cond892 ], [ %144, %while.end848 ]
  %env.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn1400, i64 0, i64 1
  %env.0 = load ptr, ptr %env.0.in, align 8
  %ou1893 = getelementptr inbounds %struct.word_type, ptr %env.0, i64 0, i32 1
  %145 = load i8, ptr %ou1893, align 8
...
if.end1013:                                       ; preds = %for.cond626, %land.lhs.true
  %161 = load ptr, ptr %oactual272, align 8
...
if.then1021:                                      ; preds = %if.end1013
  %163 = load i32, ptr @itop, align 4
  %inc = add nsw i32 %163, 1
  store i32 %inc, ptr @itop, align 4
...
for.cond1077:                                     ; preds = %for.cond1077.preheader, %for.cond1077
  ...
  %171 = load i8, ptr %ou11078, align 8
...
if.then1099:                                      ; preds = %land.lhs.true1094
  ...
  %175 = load i32, ptr %arrayidx1104, align 16
...
if.then1129:                                      ; preds = %if.then1117
  ...
  %.pre1441 = load i32, ptr @itop, align 4
...
if.else1131:                                      ; preds = %if.then1117
  ...
  store ptr %181, ptr %arrayidx1126, align 8
  br label %if.end1140
...
if.end1140:                                       ; preds = %if.then1129, %if.else1131
  ...
  %183 = load ptr, ptr %arrayidx1156, align 8
...
cond.end1188:                                     ; preds = %if.end1140
  ...
  %186 = load ptr, ptr @zz_hold, align 8
  %187 = load ptr, ptr @zz_res, align 8
  %188 = load ptr, ptr %187, align 8
  %osucc1179 = getelementptr inbounds %struct.LIST, ptr %188, i64 0, i32 1
  store ptr %186, ptr %osucc1179, align 8
  %189 = load ptr, ptr @zz_tmp, align 8
  store ptr %189, ptr %187, align 8
  %190 = load ptr, ptr @zz_res, align 8
  %191 = load ptr, ptr @zz_tmp, align 8
  %osucc1185 = getelementptr inbounds %struct.LIST, ptr %191, i64 0, i32 1
  store ptr %190, ptr %osucc1185, align 8
  %.pre1442 = load ptr, ptr @xx_link, align 8
  store ptr %.pre1442, ptr @zz_res, align 8
  store ptr %y.0, ptr @zz_hold, align 8
...
for.inc1233:                                      ; preds = %for.cond1077, %land.lhs.true1094
  ...
  br i1 %cmp1071.not, label %if.then1248, label %for.cond1077.preheader

lor.lhs.false1240:                                ; preds = %cond.end1188, %cond.false1197
  %197 = load ptr, ptr %oactual1095.le, align 8
  %call1224 = call ptr @DetachEnv(ptr noundef %197) #4
  %198 = load ptr, ptr %oactual1095.le, align 8
  call void @AttachEnv(ptr noundef %new_env.0, ptr noundef %198) #4
  %199 = load ptr, ptr %oactual1095.le, align 8
...
if.else1268:                                      ; preds = %if.else1251
  %206 = load ptr, ptr @no_fpos, align 8
  %207 = load i8, ptr %ou233, align 8
...
if.else1274:                                      ; preds = %if.end1013
  %208 = load ptr, ptr @no_fpos, align 8
  %209 = load i8, ptr %ou233, align 8
...
if.end18:                                         ; preds = %if.then16, %for.end
  %7 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 8), align 1
  %conv19 = zext i8 %7 to i32
  store i32 %conv19, ptr @zz_size, align 4
...
if.then29:                                        ; preds = %if.end18
  ...
  store ptr %call30, ptr @zz_hold, align 8
  br label %if.end40
...
if.end40:                                         ; preds = %if.then29, %if.else31
  ...
  store i8 -127, ptr %ou255, align 8
  ...
  store i32 %conv92, ptr @zz_size, align 4
...
if.else105:                                       ; preds = %if.end40
  store ptr %14, ptr @zz_hold, align 8
  %16 = load ptr, ptr %14, align 8
  store ptr %16, ptr %arrayidx100, align 8
  br label %cond.end156
...
cond.end156:                                      ; preds = %if.then103, %if.else105
  ...
  store ptr %20, ptr %osucc149, align 8
  ...
  store ptr %24, ptr %osucc155, align 8
...
if.end203:                                        ; preds = %if.then202, %cond.end189
  ...
  store ptr %11, ptr @xx_hold, align 8
  %37 = load ptr, ptr %osucc45, align 8
...
while.cond309.preheader:                          ; preds = %cond.end279, %if.end203
  ...
  %39 = load ptr, ptr %osucc312848, align 8
...
while.body:                                       ; preds = %if.end203, %cond.end279
  ...
  %41 = load ptr, ptr %osucc223, align 8
...
cond.end249:                                      ; preds = %while.body, %cond.false227
  ...
  %44 = load ptr, ptr %osucc253, align 8
...
cond.false257:                                    ; preds = %cond.end249
  ...
  store ptr %46, ptr %osucc272, align 8
  %osucc275 = getelementptr inbounds %struct.LIST, ptr %47, i64 0, i32 1
  store ptr %47, ptr %osucc275, align 8
...
cond.end279:                                      ; preds = %cond.end249, %cond.false257
  ...
  store ptr %52, ptr %arrayidx308, align 8
  %54 = load ptr, ptr @xx_hold, align 8
  %osucc215 = getelementptr inbounds [2 x %struct.LIST], ptr %54, i64 0, i64 1, i32 1
  %55 = load ptr, ptr %osucc215, align 8
  %cmp216.not = icmp eq ptr %55, %54
  br i1 %cmp216.not, label %while.cond309.preheader, label %while.body
...
while.body315:                                    ; preds = %while.cond309.preheader, %cond.end377
  ...
  %57 = load ptr, ptr %osucc321, align 8
...
cond.false325:                                    ; preds = %while.body315
  ...
  %58 = load ptr, ptr %arrayidx330, align 8
  %arrayidx333 = getelementptr inbounds [2 x %struct.LIST], ptr %57, i64 0, i64 1
  store ptr %58, ptr %arrayidx333, align 8
  %59 = load ptr, ptr %arrayidx330, align 8
  %osucc340 = getelementptr inbounds [2 x %struct.LIST], ptr %59, i64 0, i64 1, i32 1
  store ptr %57, ptr %osucc340, align 8
  store ptr %56, ptr %osucc321, align 8
  store ptr %56, ptr %arrayidx330, align 8
...
cond.end347:                                      ; preds = %while.body315, %cond.false325
  ...
  %60 = load ptr, ptr %osucc351, align 8
...
cond.false355:                                    ; preds = %cond.end347
  ...
  store ptr %62, ptr %osucc370, align 8
  %osucc373 = getelementptr inbounds %struct.LIST, ptr %63, i64 0, i32 1
  store ptr %63, ptr %osucc373, align 8
  store ptr %63, ptr %63, align 8
  %.pre854 = load ptr, ptr @xx_link, align 8
...
cond.end377:                                      ; preds = %cond.end347, %cond.false355
  ...
  store ptr %68, ptr %arrayidx408, align 8
  %70 = load ptr, ptr @xx_hold, align 8
  %osucc312 = getelementptr inbounds %struct.LIST, ptr %70, i64 0, i32 1
  %71 = load ptr, ptr %osucc312, align 8
  %cmp313.not = icmp eq ptr %71, %70
  br i1 %cmp313.not, label %while.end409, label %while.body315
...
if.then457:                                       ; preds = %if.then445
  ...
  store ptr %call458, ptr @zz_hold, align 8
  br label %if.end468

if.else459:                                       ; preds = %if.then445
  store ptr %78, ptr @zz_hold, align 8
  %80 = load ptr, ptr %78, align 8
  store ptr %80, ptr %arrayidx454, align 8
  br label %if.end468
...
if.end468:                                        ; preds = %if.then457, %if.else459
  ...
  store ptr %81, ptr %osucc479, align 8
  store ptr %81, ptr %81, align 8
  %82 = load ptr, ptr %osucc442, align 8
...
if.end515:                                        ; preds = %for.cond496, %if.then513
  ...
  %85 = load ptr, ptr %oopt_components516, align 8
...
if.then519:                                       ; preds = %if.end515
  ...
  store ptr null, ptr %oopt_components516, align 8
  br label %if.end523
...
if.end523:                                        ; preds = %if.then519, %if.end515
  ...
  %86 = load ptr, ptr %osucc526, align 8
...
for.cond530:                                      ; preds = %for.cond530, %if.end523
  ...
  %87 = load i8, ptr %ou1531, align 8
  %cmp534 = icmp eq i8 %87, 0
  br i1 %cmp534, label %for.cond530, label %for.end541
...
for.end541:                                       ; preds = %for.cond530
  ...
  %88 = load ptr, ptr %osucc544, align 8
  store ptr %88, ptr @xx_link, align 8
  store ptr %88, ptr @zz_hold, align 8
  %osucc547 = getelementptr inbounds %struct.LIST, ptr %88, i64 0, i32 1
  %89 = load ptr, ptr %osucc547, align 8
...
cond.false551:                                    ; preds = %for.end541
  ...
  store ptr %91, ptr %osucc566, align 8
  %osucc569 = getelementptr inbounds %struct.LIST, ptr %92, i64 0, i32 1
  store ptr %92, ptr %osucc569, align 8
  store ptr %92, ptr %92, align 8
  %.pre855 = load ptr, ptr @xx_link, align 8
...
cond.end573:                                      ; preds = %for.end541, %cond.false551
  ...
  %95 = load ptr, ptr %osucc577, align 8
...
cond.end609:                                      ; preds = %cond.end573, %cond.false585
  ...
  %105 = load ptr, ptr %arrayidx619, align 8
...
if.else624:                                       ; preds = %cond.end609
  store ptr %105, ptr @zz_hold, align 8
  %107 = load ptr, ptr %105, align 8
  store ptr %107, ptr %arrayidx619, align 8
  br label %cond.end679
...
if.end715:                                        ; preds = %while.end714, %while.end409
  %122 = load ptr, ptr %inners, align 8
...
if.then726:                                       ; preds = %if.end719
  ...
  %124 = load ptr, ptr %osucc206, align 8
...
for.cond738:                                      ; preds = %for.cond738, %if.then726
  ...
  %125 = load i8, ptr %ou1739, align 8
  %cmp742 = icmp eq i8 %125, 0
  br i1 %cmp742, label %for.cond738, label %for.end749
...
if.then:                                          ; preds = %entry
  %call = tail call i32 @DisposeObject(ptr noundef %x) #4
  %3 = load i32, ptr @itop, align 4
  %dec = add nsw i32 %3, -1
  store i32 %dec, ptr @itop, align 4
...
for.end:                                          ; preds = %for.cond
  %6 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @zz_lengths, i64 0, i64 8), align 1
...
if.else31:                                        ; preds = %for.end
  ...
  store ptr %9, ptr %arrayidx26, align 8
  br label %if.end40
...
if.end40:                                         ; preds = %if.then29, %if.else31
  ...
  store i16 %11, ptr %ofile_num57, align 2
  %oline_num = getelementptr inbounds %struct.word_type, ptr %x, i64 0, i32 1, i32 0, i32 3
  ...
  %13 = load ptr, ptr %arrayidx95, align 8
...
if.else100:                                       ; preds = %if.end40
  ...
  store ptr %15, ptr %arrayidx95, align 8
  br label %cond.end151
...
cond.end151:                                      ; preds = %if.then98, %if.else100
  ...
  store ptr %16, ptr %osucc114, align 8
  %arrayidx116 = getelementptr inbounds [2 x %struct.LIST], ptr %16, i64 0, i64 1
  store ptr %16, ptr %arrayidx116, align 8
  ...
  store ptr %23, ptr %osucc150, align 8
...
cond.end184:                                      ; preds = %cond.end151, %cond.false160
  ...
  %29 = load ptr, ptr %oactual186, align 8
...
if.end243:                                        ; preds = %for.end236, %if.end202
  ...
  store ptr %10, ptr @xx_hold, align 8
  %41 = load ptr, ptr %osucc45, align 8
...
while.cond340.preheader:                          ; preds = %cond.end310, %if.end243
  ...
  %43 = load ptr, ptr %osucc3431383, align 8
...
while.body:                                       ; preds = %if.end243, %cond.end310
  ...
  %45 = load ptr, ptr %osucc254, align 8
...
cond.false258:                                    ; preds = %while.body
  ...
  %46 = load ptr, ptr %arrayidx263, align 8
  %arrayidx266 = getelementptr inbounds [2 x %struct.LIST], ptr %45, i64 0, i64 1
  store ptr %46, ptr %arrayidx266, align 8
  %47 = load ptr, ptr %arrayidx263, align 8
  %osucc273 = getelementptr inbounds [2 x %struct.LIST], ptr %47, i64 0, i64 1, i32 1
  store ptr %45, ptr %osucc273, align 8
  store ptr %44, ptr %osucc254, align 8
  store ptr %44, ptr %arrayidx263, align 8
...
cond.end280:                                      ; preds = %while.body, %cond.false258
  ...
  %48 = load ptr, ptr %osucc284, align 8
...
cond.false288:                                    ; preds = %cond.end280
  ...
  store ptr %50, ptr %osucc303, align 8
  %osucc306 = getelementptr inbounds %struct.LIST, ptr %51, i64 0, i32 1
  store ptr %51, ptr %osucc306, align 8
...
while.body346:                                    ; preds = %while.cond340.preheader, %cond.end408
  ...
  %61 = load ptr, ptr %osucc352, align 8
...
cond.false356:                                    ; preds = %while.body346
  ...
  %62 = load ptr, ptr %arrayidx361, align 8
  %arrayidx364 = getelementptr inbounds [2 x %struct.LIST], ptr %61, i64 0, i64 1
  store ptr %62, ptr %arrayidx364, align 8
  %63 = load ptr, ptr %arrayidx361, align 8
  %osucc371 = getelementptr inbounds [2 x %struct.LIST], ptr %63, i64 0, i64 1, i32 1
  store ptr %61, ptr %osucc371, align 8
  store ptr %60, ptr %osucc352, align 8
  store ptr %60, ptr %arrayidx361, align 8
...
cond.end378:                                      ; preds = %while.body346, %cond.false356
  ...
  %64 = load ptr, ptr %osucc382, align 8
...
cond.false386:                                    ; preds = %cond.end378
  ...
  store ptr %66, ptr %osucc401, align 8
  %osucc404 = getelementptr inbounds %struct.LIST, ptr %67, i64 0, i32 1
  store ptr %67, ptr %osucc404, align 8
  store ptr %67, ptr %67, align 8
  %.pre1401 = load ptr, ptr @xx_link, align 8
...
while.end440:                                     ; preds = %cond.end408, %while.cond340.preheader
  ...
  %cond463.in = load i8, ptr %cond463.in.in, align 1
  %cond463 = zext i8 %cond463.in to i32
  store i32 %cond463, ptr @zz_size, align 4
...
if.then488:                                       ; preds = %if.then476
  ...
  store ptr %call489, ptr @zz_hold, align 8
  br label %if.end499
...
if.end546:                                        ; preds = %for.cond527, %if.then544
  ...
  %89 = load ptr, ptr %oopt_components547, align 8
...
for.cond561:                                      ; preds = %for.cond561, %if.end554
  ...
  %91 = load i8, ptr %ou1562, align 8
  %cmp565 = icmp eq i8 %91, 0
  br i1 %cmp565, label %for.cond561, label %for.end572
...
for.end572:                                       ; preds = %for.cond561
  ...
  %92 = load ptr, ptr %osucc575, align 8
  ...
  %93 = load ptr, ptr %osucc578, align 8
...
cond.false582:                                    ; preds = %for.end572
  ...
  store ptr %95, ptr %osucc597, align 8
  %osucc600 = getelementptr inbounds %struct.LIST, ptr %96, i64 0, i32 1
  store ptr %96, ptr %osucc600, align 8
  store ptr %96, ptr %96, align 8
  %.pre1402 = load ptr, ptr @xx_link, align 8
...
cond.end604:                                      ; preds = %for.end572, %cond.false582
  ...
  %99 = load ptr, ptr %osucc608, align 8
...
cond.false616:                                    ; preds = %cond.end604
  ...
  store ptr %102, ptr %osucc631, align 8
...
if.else655:                                       ; preds = %cond.end640
  ...
  store ptr %111, ptr %arrayidx650, align 8
  br label %cond.end710
...
cond.end710:                                      ; preds = %if.then653, %if.else655
  ...
  store ptr %115, ptr %osucc701, align 8
  ...
  store ptr %119, ptr %osucc707, align 8
  %121 = load ptr, ptr @xx_link, align 8
...
cond.false719:                                    ; preds = %cond.end710
  ...
  %123 = load ptr, ptr %arrayidx724, align 8
  store ptr %123, ptr %arrayidx574, align 8
  %124 = load ptr, ptr %arrayidx724, align 8
  %osucc734 = getelementptr inbounds [2 x %struct.LIST], ptr %124, i64 0, i64 1, i32 1
  store ptr %index.0, ptr %osucc734, align 8
  store ptr %122, ptr %arrayidx724, align 8
  %osucc740 = getelementptr inbounds [2 x %struct.LIST], ptr %122, i64 0, i64 1, i32 1
  store ptr %121, ptr %osucc740, align 8
  br label %cond.end743

cond.end743:                                      ; preds = %cond.end710, %cond.false719
  %125 = load ptr, ptr %osucc473, align 8
...
if.end746:                                        ; preds = %while.end745, %while.end440
  %126 = load ptr, ptr %inners, align 8
...
if.then757:                                       ; preds = %if.end750
  %128 = load ptr, ptr %osucc205, align 8
...
for.cond764:                                      ; preds = %for.cond764, %if.then757
  ...
  %129 = load i8, ptr %ou1765, align 8
  %cmp768 = icmp eq i8 %129, 0
  br i1 %cmp768, label %for.cond764, label %for.end775

for.end775:                                       ; preds = %for.cond764
  store ptr %dest_index.0, ptr @xx_hold, align 8
...
while.cond877.preheader:                          ; preds = %cond.end844, %for.end775
  ...
  %131 = load ptr, ptr %osucc8801388, align 8
...
while.body782:                                    ; preds = %for.end775, %cond.end844
  ...
  %133 = load ptr, ptr %osucc788, align 8
...
cond.false792:                                    ; preds = %while.body782
  ...
  %134 = load ptr, ptr %arrayidx797, align 8
  %arrayidx800 = getelementptr inbounds [2 x %struct.LIST], ptr %133, i64 0, i64 1
  store ptr %134, ptr %arrayidx800, align 8
  %135 = load ptr, ptr %arrayidx797, align 8
  %osucc807 = getelementptr inbounds [2 x %struct.LIST], ptr %135, i64 0, i64 1, i32 1
  store ptr %133, ptr %osucc807, align 8
  store ptr %132, ptr %osucc788, align 8
  store ptr %132, ptr %arrayidx797, align 8
  br label %cond.end814
...
cond.end814:                                      ; preds = %while.body782, %cond.false792
  ...
  %136 = load ptr, ptr %osucc818, align 8
...
cond.false822:                                    ; preds = %cond.end814
  ...
  store ptr %138, ptr %osucc837, align 8
  %osucc840 = getelementptr inbounds %struct.LIST, ptr %139, i64 0, i32 1
  store ptr %139, ptr %osucc840, align 8
  store ptr %139, ptr %139, align 8
  %.pre1403 = load ptr, ptr @xx_link, align 8
...
cond.end844:                                      ; preds = %cond.end814, %cond.false822
  ...
  %142 = load i8, ptr %ou1846, align 8
...
cond.false893:                                    ; preds = %while.body883
  ...
  %150 = load ptr, ptr %arrayidx898, align 8
  %arrayidx901 = getelementptr inbounds [2 x %struct.LIST], ptr %149, i64 0, i64 1
  store ptr %150, ptr %arrayidx901, align 8
  %151 = load ptr, ptr %arrayidx898, align 8
  %osucc908 = getelementptr inbounds [2 x %struct.LIST], ptr %151, i64 0, i64 1, i32 1
  store ptr %149, ptr %osucc908, align 8
  store ptr %148, ptr %osucc889, align 8
  store ptr %148, ptr %arrayidx898, align 8
...
cond.end915:                                      ; preds = %while.body883, %cond.false893
  ...
  %152 = load ptr, ptr %osucc919, align 8
...
while.cond1110.preheader:                         ; preds = %cond.end1077, %if.else1008
  ...
  %170 = load ptr, ptr %osucc11131393, align 8
...
while.body1015:                                   ; preds = %if.else1008, %cond.end1077
  ...
  %172 = load ptr, ptr %osucc1021, align 8
...
cond.false1025:                                   ; preds = %while.body1015
  ...
  %173 = load ptr, ptr %arrayidx1030, align 8
  %arrayidx1033 = getelementptr inbounds [2 x %struct.LIST], ptr %172, i64 0, i64 1
  store ptr %173, ptr %arrayidx1033, align 8
  %174 = load ptr, ptr %arrayidx1030, align 8
  %osucc1040 = getelementptr inbounds [2 x %struct.LIST], ptr %174, i64 0, i64 1, i32 1
  store ptr %172, ptr %osucc1040, align 8
  store ptr %171, ptr %osucc1021, align 8
  store ptr %171, ptr %arrayidx1030, align 8
...
cond.end1047:                                     ; preds = %while.body1015, %cond.false1025
  ...
  %175 = load ptr, ptr %osucc1051, align 8
...
cond.false1055:                                   ; preds = %cond.end1047
  ...
  store ptr %177, ptr %osucc1070, align 8
  %osucc1073 = getelementptr inbounds %struct.LIST, ptr %178, i64 0, i32 1
  store ptr %178, ptr %osucc1073, align 8
  store ptr %178, ptr %178, align 8
  %.pre1405 = load ptr, ptr @xx_link, align 8
...
cond.end1077:                                     ; preds = %cond.end1047, %cond.false1055
  ...
  %181 = load i8, ptr %ou11079, align 8
  ...
  store ptr %183, ptr %arrayidx1108, align 8
  %185 = load ptr, ptr @xx_hold, align 8
  %osucc1012 = getelementptr inbounds [2 x %struct.LIST], ptr %185, i64 0, i64 1, i32 1
  %186 = load ptr, ptr %osucc1012, align 8
  %cmp1013.not = icmp eq ptr %186, %185
  br i1 %cmp1013.not, label %while.cond1110.preheader, label %while.body1015
...
cond.end1148:                                     ; preds = %while.body1116, %cond.false1126
  ...
  %191 = load ptr, ptr %osucc1152, align 8
...
while.end1210:                                    ; preds = %cond.end1178, %while.cond1110.preheader
  ...
  %203 = load i8, ptr %ou11211, align 8
...
entry:
  %inners = alloca ptr, align 8
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %inners) #4
  %0 = load ptr, ptr @root_galley, align 8
...
if.end:                                           ; preds = %if.then2, %if.then
  %3 = load ptr, ptr @root_galley, align 8
