; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z04.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z04.c"
...
if.then7:                                         ; preds = %entry
  ...
  store ptr %call8, ptr @zz_hold, align 8
  br label %if.end15
...
if.end15:                                         ; preds = %if.then7, %if.else9
  ...
  store i16 %5, ptr %ofile_num28, align 2
  ...
  store i8 %xvspace, ptr %ovspace, align 2
  %ohspace = getelementptr inbounds i8, ptr %4, i64 41
  store i8 %xhspace, ptr %ohspace, align 1
  store i8 %xprec, ptr %ou2, align 8
  %oactual = getelementptr inbounds %struct.closure_type, ptr %4, i64 0, i32 5
  store ptr %xactual, ptr %oactual, align 8
  ret ptr %4
}
...
cond.false30:                                     ; preds = %cond.false
  ...
  store ptr %z.0, ptr %osucc, align 8
  store ptr %13, ptr %arrayidx32, align 8
  %osucc47 = getelementptr inbounds [2 x %struct.LIST], ptr %13, i64 0, i64 1, i32 1
  store ptr %res.0, ptr %osucc47, align 8
  br label %cond.end48
...
cond.end48:                                       ; preds = %cond.false, %cond.false30
  ...
  %16 = load ptr, ptr %osucc52, align 8
  %cmp53.not = icmp eq ptr %16, %x
  br i1 %cmp53.not, label %if.end55, label %do.body
