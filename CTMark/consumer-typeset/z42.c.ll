; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z42.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z42.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.anon.14 = type { i32, i32, [1 x %struct.coltab_rec] }
...
if.then11:                                        ; preds = %if.end
  ...
  %2 = load i32, ptr %colour_avail, align 4
...
if.end23:                                         ; preds = %if.end16
  %3 = load ptr, ptr @col_tab, align 8
...
while.end.i:                                      ; preds = %while.cond.i
  ...
  %by_name_hash.i = getelementptr inbounds %struct.anon.14, ptr %3, i64 0, i32 2, i64 %idxprom.i, i32 1
  %6 = load ptr, ptr %by_name_hash.i, align 8
...
entry:
  ...
  %coltab_count = getelementptr inbounds %struct.anon.14, ptr %0, i64 0, i32 1
  %1 = load i32, ptr %coltab_count, align 4
...
if.end.i:                                         ; preds = %if.then.i184, %if.then
  ...
  %coltab_count.i183 = getelementptr inbounds %struct.anon.14, ptr %call.i182, i64 0, i32 1
  store i32 0, ptr %coltab_count.i183, align 4
...
ctab_new.exit:                                    ; preds = %if.end.i, %for.body.preheader.i
  ...
  %6 = load i32, ptr %coltab_count, align 4
...
for.body.i:                                       ; preds = %ctab_new.exit, %for.body.i
  ...
  %9 = load i32, ptr %coltab_count, align 4
...
for.inc13.i:                                      ; preds = %if.then.i, %for.body3.i
  ...
  br i1 %cmp2.i, label %for.body3.i, label %ctab_rehash.exit
...
ctab_rehash.exit:                                 ; preds = %for.inc13.i, %for.cond1.i.preheader
  ...
  %coltab_count2.phi.trans.insert = getelementptr inbounds %struct.anon.14, ptr %15, i64 0, i32 1
  %.pre196 = load i32, ptr %coltab_count2.phi.trans.insert, align 4
  br label %if.end

if.end:                                           ; preds = %ctab_rehash.exit, %entry
  %16 = phi i32 [ %.pre196, %ctab_rehash.exit ], [ %1, %entry ]
  %17 = phi ptr [ %15, %ctab_rehash.exit ], [ %0, %entry ]
  %coltab_count2 = getelementptr inbounds %struct.anon.14, ptr %17, i64 0, i32 1
  %inc = add nsw i32 %16, 1
  store i32 %inc, ptr %coltab_count2, align 4
...
land.lhs.true:                                    ; preds = %entry
  %0 = load ptr, ptr @col_tab, align 8
  %coltab_count = getelementptr inbounds %struct.anon.14, ptr %0, i64 0, i32 1
  %1 = load i32, ptr %coltab_count, align 4
...
if.then:                                          ; preds = %land.lhs.true, %entry
  ...
  %.pre = load ptr, ptr @col_tab, align 8
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true
  %3 = phi ptr [ %.pre, %if.then ], [ %0, %land.lhs.true ]
  %idxprom = zext i32 %cnum to i64
  %arrayidx = getelementptr inbounds %struct.anon.14, ptr %3, i64 0, i32 2, i64 %idxprom
