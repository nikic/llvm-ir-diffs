; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z17.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z17.c"
...
entry:
  ...
  store i32 158, ptr %res_inc, align 4
...
if.end29.sink.split:                              ; preds = %if.end, %if.then26
  ...
  store i32 %.sink, ptr %res_inc, align 4
...
while.cond:                                       ; preds = %if.end29, %while.cond
  ...
  br i1 %or.cond340, label %while.cond, label %while.end
...
while.body146:                                    ; preds = %if.end141, %while.body146
  %20 = phi float [ %conv148, %while.body146 ], [ %.pr, %if.end141 ]
  %conv148 = fadd float %20, -3.600000e+02
  %cmp144 = fcmp ogt float %conv148, 1.800000e+02
  br i1 %cmp144, label %while.body146, label %while.cond142.while.cond150thread-pre-split_crit_edge

while.cond142.while.cond150thread-pre-split_crit_edge: ; preds = %while.body146
  store float %conv148, ptr %num, align 4
...
while.body154:                                    ; preds = %while.cond150thread-pre-split, %while.body154
  %21 = phi float [ %conv156, %while.body154 ], [ %.pr338, %while.cond150thread-pre-split ]
  %conv156 = fadd float %21, 3.600000e+02
  %cmp152 = fcmp olt float %conv156, -1.800000e+02
  br i1 %cmp152, label %while.body154, label %while.cond150.while.end157_crit_edge

while.cond150.while.end157_crit_edge:             ; preds = %while.body154
  store float %conv156, ptr %num, align 4
...
if.then165:                                       ; preds = %while.end157
  ...
  %call166 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.7, i32 noundef 0, ptr noundef %22, ptr noundef nonnull @.str.8) #5
  %.pre = load float, ptr %num, align 4
  br label %if.end167

if.end167:                                        ; preds = %while.end157, %if.then165
  %23 = phi float [ %.lcssa, %while.end157 ], [ %.pre, %if.then165 ]
  %mul168 = fmul float %23, 1.280000e+02
  br label %sw.epilog.thread
...
sw.epilog:                                        ; preds = %while.end
  %24 = load float, ptr %num, align 4
  %mul132 = fmul float %24, 4.096000e+03
...
if.then184:                                       ; preds = %sw.epilog
  %25 = load float, ptr %num, align 4
  %conv186 = fpext float %25 to double
...
if.end188:                                        ; preds = %sw.epilog.thread, %if.then184, %sw.epilog
  ...
  store i16 %conv189, ptr %owidth, align 2
  %26 = load i8, ptr %incdec.ptr50, align 1
  switch i8 %26, label %sw.default226 [
...
sw.epilog231:                                     ; preds = %sw.bb221, %sw.bb216, %sw.bb211, %sw.bb206, %sw.bb201, %sw.bb196, %sw.bb192
  ...
  %27 = load i8, ptr %str.2, align 1
  %cmp233 = icmp eq i8 %27, 117
...
if.end250:                                        ; preds = %if.else246, %if.then241
  ...
  %.pr339 = load i8, ptr %incdec.ptr251, align 1
  br label %if.end252

if.end252:                                        ; preds = %if.end250, %sw.epilog231
  %28 = phi i8 [ %.pr339, %if.end250 ], [ %27, %sw.epilog231 ]
  %cmp254.not = icmp eq i8 %28, 0
...
sw.bb3:                                           ; preds = %entry
  ...
  %1 = load i16, ptr %owidth4, align 2
...
sw.bb17:                                          ; preds = %sw.epilog
  ...
  %5 = load i32, ptr %fractional_spacing_avail, align 4
...
sw.bb5:                                           ; preds = %cond.end
  ...
  %4 = load i32, ptr %fractional_spacing_avail, align 4
...
sw.bb1:                                           ; preds = %entry
  ...
  %1 = load i16, ptr %owidth2, align 2
...
sw.bb7:                                           ; preds = %entry
  ...
  %2 = load i16, ptr %owidth8, align 2
...
sw.bb15:                                          ; preds = %entry
  ...
  %4 = load i16, ptr %owidth16, align 2
...
sw.bb29:                                          ; preds = %sw.epilog
  ...
  %9 = load i32, ptr %fractional_spacing_avail, align 4
