; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z43.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z43.c"
...
ltab_new.exit:                                    ; preds = %entry, %if.then.i
  ...
  %langtab_count.i = getelementptr inbounds %struct.anon.14, ptr %call.i, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(804) %langtab_count.i, i8 0, i64 804, i1 false)
  store ptr %call.i, ptr @names_tab, align 8
  store i32 0, ptr @lang_count, align 4
  store i32 100, ptr @lang_tabsize, align 4
  %call1 = tail call noalias dereferenceable_or_null(800) ptr @malloc(i64 noundef 800) #8
  store ptr %call1, ptr @hyph_tab, align 8
  %call2 = tail call noalias dereferenceable_or_null(800) ptr @malloc(i64 noundef 800) #8
  store ptr %call2, ptr @canonical_tab, align 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(1024) @LanguageSentenceEnds, i8 0, i64 1024, i1 false)
  ret void
}
...
if.end7:                                          ; preds = %if.then5, %if.end
  %4 = load i32, ptr @lang_count, align 4
  %inc = add nsw i32 %4, 1
  store i32 %inc, ptr @lang_count, align 4
  %5 = load i32, ptr @lang_tabsize, align 4
  %cmp8.not = icmp slt i32 %inc, %5
  br i1 %cmp8.not, label %if.end17, label %if.then10

if.then10:                                        ; preds = %if.end7
  %mul = shl nsw i32 %5, 1
  store i32 %mul, ptr @lang_tabsize, align 4
  %6 = load ptr, ptr @hyph_tab, align 8
  %conv11 = sext i32 %mul to i64
  %mul12 = shl nsw i64 %conv11, 3
  %call13 = tail call ptr @realloc(ptr noundef %6, i64 noundef %mul12) #10
  store ptr %call13, ptr @hyph_tab, align 8
  %7 = load ptr, ptr @canonical_tab, align 8
  %call16 = tail call ptr @realloc(ptr noundef %7, i64 noundef %mul12) #10
  store ptr %call16, ptr @canonical_tab, align 8
  br label %if.end17

if.end17:                                         ; preds = %if.then10, %if.end7
  %link.0662 = load ptr, ptr %osucc, align 8
  %cmp21.not663 = icmp eq ptr %link.0662, %names
  br i1 %cmp21.not663, label %for.cond59.preheader, label %for.cond25.preheader

for.cond25.preheader:                             ; preds = %if.end17, %if.end47
  %link.0664 = phi ptr [ %link.0, %if.end47 ], [ %link.0662, %if.end17 ]
  br label %for.cond25

for.cond25:                                       ; preds = %for.cond25.preheader, %for.cond25
  %link.0.pn = phi ptr [ %y.0, %for.cond25 ], [ %link.0664, %for.cond25.preheader ]
...
if.end47:                                         ; preds = %for.cond25, %for.cond25, %if.then45
  %10 = load i32, ptr @lang_count, align 4
  ...
  %osucc51 = getelementptr inbounds %struct.LIST, ptr %link.0664, i64 0, i32 1
  %link.0 = load ptr, ptr %osucc51, align 8
  %cmp21.not = icmp eq ptr %link.0, %names
  br i1 %cmp21.not, label %for.end52.loopexit, label %for.cond25.preheader
...
for.cond59:                                       ; preds = %for.cond59.preheader, %for.cond59
  ...
  %11 = load i8, ptr %ou160, align 8
  %cmp63 = icmp eq i8 %11, 0
  br i1 %cmp63, label %for.cond59, label %for.end70

for.end70:                                        ; preds = %for.cond59
  %12 = load ptr, ptr @canonical_tab, align 8
  %13 = load i32, ptr @lang_count, align 4
  %idxprom = sext i32 %13 to i64
  %arrayidx71 = getelementptr inbounds ptr, ptr %12, i64 %idxprom
  store ptr %y.1, ptr %arrayidx71, align 8
  %ou172 = getelementptr inbounds %struct.word_type, ptr %inside, i64 0, i32 1
  %14 = load i8, ptr %ou172, align 8
...
if.then88:                                        ; preds = %if.then77
  ...
  store ptr %call89, ptr @zz_hold, align 8
  br label %if.end99

if.else90:                                        ; preds = %if.then77
  store ptr %16, ptr @zz_hold, align 8
  %18 = load ptr, ptr %16, align 8
  store ptr %18, ptr %arrayidx85, align 8
  br label %if.end99
...
if.else148:                                       ; preds = %if.end99
  ...
  store ptr %24, ptr %arrayidx143, align 8
  br label %cond.end199
...
cond.end199:                                      ; preds = %if.then146, %if.else148
  ...
  store ptr %32, ptr %osucc198, align 8
  %34 = load ptr, ptr @xx_link, align 8
...
for.cond241:                                      ; preds = %for.cond241, %if.end234
  %.pn646 = phi ptr [ %38, %if.end234 ], [ %hyph_file.0, %for.cond241 ]
  %hyph_file.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn646, i64 0, i64 1
  %hyph_file.0 = load ptr, ptr %hyph_file.0.in, align 8
  %ou1242 = getelementptr inbounds %struct.word_type, ptr %hyph_file.0, i64 0, i32 1
  %39 = load i8, ptr %ou1242, align 8
  %cmp245 = icmp eq i8 %39, 0
  br i1 %cmp245, label %for.cond241, label %for.end252
...
for.end252:                                       ; preds = %for.cond241
  ...
  %40 = load ptr, ptr %osucc258, align 8
...
cond.false262:                                    ; preds = %for.end252
  ...
  %41 = load ptr, ptr %arrayidx267, align 8
  %arrayidx270 = getelementptr inbounds [2 x %struct.LIST], ptr %40, i64 0, i64 1
  store ptr %41, ptr %arrayidx270, align 8
  %42 = load ptr, ptr %arrayidx267, align 8
  %osucc277 = getelementptr inbounds [2 x %struct.LIST], ptr %42, i64 0, i64 1, i32 1
  store ptr %40, ptr %osucc277, align 8
  store ptr %38, ptr %osucc258, align 8
  store ptr %38, ptr %arrayidx267, align 8
...
cond.end284:                                      ; preds = %for.end252, %cond.false262
  ...
  %43 = load ptr, ptr %osucc288, align 8
...
cond.end314:                                      ; preds = %cond.end284, %cond.false292
  ...
  %cond337.in = load i8, ptr %cond337.in.in, align 1
  %cond337 = zext i8 %cond337.in to i32
  store i32 %cond337, ptr @zz_size, align 4
  %idxprom338 = zext i8 %cond337.in to i64
  %arrayidx339 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom338
  %50 = load ptr, ptr %arrayidx339, align 8
  store ptr %50, ptr %48, align 8
  %51 = load ptr, ptr @zz_hold, align 8
  %52 = load i32, ptr @zz_size, align 4
  %idxprom343 = sext i32 %52 to i64
  %arrayidx344 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom343
  store ptr %51, ptr %arrayidx344, align 8
  %53 = load i8, ptr %ou1242.le, align 8
  %.off652 = add i8 %53, -11
  %switch653 = icmp ult i8 %.off652, 2
  br i1 %switch653, label %if.end359, label %if.then356
...
if.end359:                                        ; preds = %cond.end314, %if.then356
  %ostring = getelementptr inbounds %struct.word_type, ptr %hyph_file.0, i64 0, i32 4
  %strcmpload = load i8, ptr %ostring, align 1
  %cmp361 = icmp eq i8 %strcmpload, 0
  br i1 %cmp361, label %if.end359.if.then369_crit_edge, label %lor.lhs.false363

if.end359.if.then369_crit_edge:                   ; preds = %if.end359
  %.pre678 = load i32, ptr @lang_count, align 4
  br label %if.then369
...
lor.lhs.false363:                                 ; preds = %if.end359
  ...
  %.pre679 = load i32, ptr @lang_count, align 4
  br i1 %cmp367, label %if.then369, label %if.else402

if.then369:                                       ; preds = %if.end359.if.then369_crit_edge, %lor.lhs.false363
  %54 = phi i32 [ %.pre678, %if.end359.if.then369_crit_edge ], [ %.pre679, %lor.lhs.false363 ]
  store ptr %hyph_file.0, ptr @zz_hold, align 8
  %55 = load i8, ptr %ou1242.le, align 8
  %.off648 = add i8 %55, -11
  %switch649 = icmp ult i8 %.off648, 2
  %orec_size383 = getelementptr inbounds %struct.word_type, ptr %hyph_file.0, i64 0, i32 1, i32 0, i32 1
  %idxprom388 = zext i8 %55 to i64
  %arrayidx389 = getelementptr inbounds [0 x i8], ptr @zz_lengths, i64 0, i64 %idxprom388
  %cond392.in.in = select i1 %switch649, ptr %orec_size383, ptr %arrayidx389
  %cond392.in = load i8, ptr %cond392.in.in, align 1
  %cond392 = zext i8 %cond392.in to i32
  store i32 %cond392, ptr @zz_size, align 4
  %idxprom393 = zext i8 %cond392.in to i64
  %arrayidx394 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom393
  %56 = load ptr, ptr %arrayidx394, align 8
  store ptr %56, ptr %hyph_file.0, align 8
  %57 = load ptr, ptr @zz_hold, align 8
  %58 = load i32, ptr @zz_size, align 4
  %idxprom398 = sext i32 %58 to i64
  %arrayidx399 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom398
  store ptr %57, ptr %arrayidx399, align 8
  %59 = load ptr, ptr @hyph_tab, align 8
  %idxprom400 = sext i32 %54 to i64
  %arrayidx401 = getelementptr inbounds ptr, ptr %59, i64 %idxprom400
  store ptr null, ptr %arrayidx401, align 8
  br label %if.end405

if.else402:                                       ; preds = %lor.lhs.false363
  %60 = load ptr, ptr @hyph_tab, align 8
  %idxprom403 = sext i32 %.pre679 to i64
  %arrayidx404 = getelementptr inbounds ptr, ptr %60, i64 %idxprom403
  store ptr %hyph_file.0, ptr %arrayidx404, align 8
  br label %if.end405
...
if.end405:                                        ; preds = %if.else402, %if.then369
  ...
  store ptr %inside.addr.0, ptr %arrayidx407, align 8
  %link.1669 = load ptr, ptr %osucc237, align 8
  %cmp412.not670 = icmp eq ptr %link.1669, %inside.addr.0
  br i1 %cmp412.not670, label %for.end575, label %for.cond418.preheader

for.cond418.preheader:                            ; preds = %if.end405, %for.inc571
  %link.1671 = phi ptr [ %link.1, %for.inc571 ], [ %link.1669, %if.end405 ]
  br label %for.cond418

for.cond418:                                      ; preds = %for.cond418.preheader, %for.cond418
  %link.1.pn = phi ptr [ %y.2, %for.cond418 ], [ %link.1671, %for.cond418.preheader ]
  ...
  %61 = load i8, ptr %ou1419, align 8
  switch i8 %61, label %if.then552 [
...
if.then435:                                       ; preds = %for.cond418
  %62 = load ptr, ptr %link.1671, align 8
  %osucc441 = getelementptr inbounds %struct.LIST, ptr %62, i64 0, i32 1
  %63 = load ptr, ptr %osucc441, align 8
  store ptr %63, ptr @xx_link, align 8
  %osucc444 = getelementptr inbounds [2 x %struct.LIST], ptr %63, i64 0, i64 1, i32 1
  %64 = load ptr, ptr %osucc444, align 8
  %cmp445 = icmp eq ptr %64, %63
  br i1 %cmp445, label %cond.end470, label %cond.false448

cond.false448:                                    ; preds = %if.then435
  store ptr %64, ptr @zz_res, align 8
  %arrayidx453 = getelementptr inbounds [2 x %struct.LIST], ptr %63, i64 0, i64 1
  %65 = load ptr, ptr %arrayidx453, align 8
  %arrayidx456 = getelementptr inbounds [2 x %struct.LIST], ptr %64, i64 0, i64 1
  store ptr %65, ptr %arrayidx456, align 8
  %66 = load ptr, ptr %arrayidx453, align 8
  %osucc463 = getelementptr inbounds [2 x %struct.LIST], ptr %66, i64 0, i64 1, i32 1
  store ptr %64, ptr %osucc463, align 8
  store ptr %63, ptr %osucc444, align 8
  store ptr %63, ptr %arrayidx453, align 8
  br label %cond.end470

cond.end470:                                      ; preds = %if.then435, %cond.false448
  %cond471 = phi ptr [ %64, %cond.false448 ], [ null, %if.then435 ]
  store ptr %cond471, ptr @xx_tmp, align 8
  store ptr %63, ptr @zz_hold, align 8
  %osucc474 = getelementptr inbounds %struct.LIST, ptr %63, i64 0, i32 1
  %67 = load ptr, ptr %osucc474, align 8
  %cmp475 = icmp eq ptr %67, %63
...
cond.false478:                                    ; preds = %cond.end470
  ...
  %osucc493 = getelementptr inbounds %struct.LIST, ptr %71, i64 0, i32 1
  store ptr %69, ptr %osucc493, align 8
  %osucc496 = getelementptr inbounds %struct.LIST, ptr %70, i64 0, i32 1
  store ptr %70, ptr %osucc496, align 8
  store ptr %70, ptr %70, align 8
  %.pre680 = load ptr, ptr @xx_link, align 8
  br label %cond.end500

cond.end500:                                      ; preds = %cond.end470, %cond.false478
  %72 = phi ptr [ %63, %cond.end470 ], [ %.pre680, %cond.false478 ]
  store ptr %72, ptr @zz_hold, align 8
  %ou1502 = getelementptr inbounds %struct.word_type, ptr %72, i64 0, i32 1
  %73 = load i8, ptr %ou1502, align 8
  %.off650 = add i8 %73, -11
  %switch651 = icmp ult i8 %.off650, 2
  %orec_size515 = getelementptr inbounds %struct.word_type, ptr %72, i64 0, i32 1, i32 0, i32 1
  %idxprom520 = zext i8 %73 to i64
  %arrayidx521 = getelementptr inbounds [0 x i8], ptr @zz_lengths, i64 0, i64 %idxprom520
  %cond524.in.in = select i1 %switch651, ptr %orec_size515, ptr %arrayidx521
  %cond524.in = load i8, ptr %cond524.in.in, align 1
  %cond524 = zext i8 %cond524.in to i32
  store i32 %cond524, ptr @zz_size, align 4
  ...
  %idxprom530 = sext i32 %76 to i64
  %arrayidx531 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom530
  store ptr %75, ptr %arrayidx531, align 8
  %77 = load ptr, ptr @xx_tmp, align 8
  %osucc534 = getelementptr inbounds [2 x %struct.LIST], ptr %77, i64 0, i64 1, i32 1
  %78 = load ptr, ptr %osucc534, align 8
  %cmp535 = icmp eq ptr %78, %77
  br i1 %cmp535, label %if.then537, label %for.inc571

if.then537:                                       ; preds = %cond.end500
  %call538 = tail call i32 @DisposeObject(ptr noundef nonnull %77) #9
  br label %for.inc571

if.then552:                                       ; preds = %for.cond418
  %ou1419.le691 = getelementptr inbounds %struct.word_type, ptr %y.2, i64 0, i32 1
  %call554 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 43, i32 noundef 4, ptr noundef nonnull @.str.8, i32 noundef 1, ptr noundef nonnull %ou1419.le691) #9
  br label %if.end555
...
if.end555:                                        ; preds = %if.end555.loopexit, %if.then552
  %ou1419683 = phi ptr [ %ou1419.le, %if.end555.loopexit ], [ %ou1419.le691, %if.then552 ]
  ...
  %79 = and i64 %call558, 4294967295
  %cmp560 = icmp eq i64 %79, 0
...
if.end565:                                        ; preds = %if.then562, %if.end555
  ...
  %80 = load i8, ptr %arrayidx568, align 1
  %idxprom569 = zext i8 %80 to i64
  %arrayidx570 = getelementptr inbounds [256 x i32], ptr @LanguageSentenceEnds, i64 0, i64 %idxprom569
  store i32 1, ptr %arrayidx570, align 4
  br label %for.inc571

for.inc571:                                       ; preds = %cond.end500, %if.then537, %if.end565
  %link.2 = phi ptr [ %62, %if.then537 ], [ %62, %cond.end500 ], [ %link.1671, %if.end565 ]
  %osucc574 = getelementptr inbounds %struct.LIST, ptr %link.2, i64 0, i32 1
  %link.1 = load ptr, ptr %osucc574, align 8
  %cmp412.not = icmp eq ptr %link.1, %inside.addr.0
  br i1 %cmp412.not, label %for.end575, label %for.cond418.preheader

for.end575:                                       ; preds = %for.inc571, %if.end405
  %81 = load i32, ptr @InitializeAll, align 4
  %tobool.not = icmp eq i32 %81, 0
  br i1 %tobool.not, label %if.end584, label %if.then576

if.then576:                                       ; preds = %for.end575
  %82 = load ptr, ptr @hyph_tab, align 8
  %83 = load i32, ptr @lang_count, align 4
  %idxprom577 = sext i32 %83 to i64
  %arrayidx578 = getelementptr inbounds ptr, ptr %82, i64 %idxprom577
  %84 = load ptr, ptr %arrayidx578, align 8
  %cmp579.not = icmp eq ptr %84, null
  br i1 %cmp579.not, label %if.end584, label %if.then581

if.then581:                                       ; preds = %if.then576
  %call582 = tail call i32 @ReadHyphTable(i32 noundef %83) #9
  br label %if.end584
...
entry:
  ...
  %langtab_count = getelementptr inbounds %struct.anon.14, ptr %0, i64 0, i32 1
  %1 = load i32, ptr %langtab_count, align 4
...
if.then:                                          ; preds = %entry
  ...
  %call.i216 = tail call noalias ptr @malloc(i64 noundef %add.i) #8
...
if.end.i:                                         ; preds = %if.then.i217, %if.then
  ...
  %langtab_count.i = getelementptr inbounds %struct.anon.14, ptr %call.i216, i64 0, i32 1
  store i32 0, ptr %langtab_count.i, align 4
...
if.end:                                           ; preds = %entry, %if.then
  ...
  %link.075 = load ptr, ptr %link.0.in74, align 8
...
for.cond12.us:                                    ; preds = %for.cond12.us, %for.cond12.preheader.us
  ...
  %3 = load i8, ptr %ou113.us, align 8
  %cmp16.us = icmp eq i8 %3, 0
  br i1 %cmp16.us, label %for.cond12.us, label %for.end.us
...
for.inc52.us:                                     ; preds = %for.end.us
  ...
  br i1 %cmp8.not.us, label %cleanup, label %for.cond12.preheader.us
...
for.cond12:                                       ; preds = %for.cond12.preheader, %for.cond12
  ...
  %4 = load i8, ptr %ou113, align 8
  %cmp16 = icmp eq i8 %4, 0
  br i1 %cmp16, label %for.cond12, label %for.end
...
for.inc52:                                        ; preds = %for.end, %land.lhs.true, %if.then25
  ...
  br i1 %cmp8.not, label %cleanup, label %for.cond12.preheader
...
if.end12:                                         ; preds = %if.end
  %1 = load ptr, ptr @names_tab, align 8
...
while.end.i:                                      ; preds = %while.cond.i
  ...
  %arrayidx.i = getelementptr inbounds %struct.anon.14, ptr %1, i64 0, i32 2, i64 %idxprom.i
...
if.end:                                           ; preds = %entry, %if.then
  %4 = load ptr, ptr @canonical_tab, align 8
...
if.end:                                           ; preds = %entry, %if.then
  %4 = load ptr, ptr @hyph_tab, align 8
  %idxprom = zext i32 %lnum to i64
  %arrayidx = getelementptr inbounds ptr, ptr %4, i64 %idxprom
  %5 = load ptr, ptr %arrayidx, align 8
  ret ptr %5
