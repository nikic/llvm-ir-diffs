...
if.end17:                                         ; preds = %if.then10, %if.end7
  %link.0662 = load ptr, ptr %osucc, align 8, !tbaa !13
...
cond.false292:                                    ; preds = %cond.end284
  ...
  %.pre677 = load ptr, ptr @xx_link, align 8, !tbaa !5
...
if.end359.if.then369_crit_edge:                   ; preds = %if.end359
  %.pre678 = load i32, ptr @lang_count, align 4, !tbaa !12
  br label %if.then369
...
lor.lhs.false363:                                 ; preds = %if.end359
  ...
  %.pre679 = load i32, ptr @lang_count, align 4, !tbaa !12
...
if.then369:                                       ; preds = %if.end359.if.then369_crit_edge, %lor.lhs.false363
  ...
  %56 = load ptr, ptr %arrayidx394, align 8, !tbaa !5
  store ptr %56, ptr %hyph_file.0, align 8, !tbaa !13
  %57 = load ptr, ptr @zz_hold, align 8, !tbaa !5
  %58 = load i32, ptr @zz_size, align 4, !tbaa !12
  %idxprom398 = sext i32 %58 to i64
  %arrayidx399 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom398
  store ptr %57, ptr %arrayidx399, align 8, !tbaa !5
  %59 = load ptr, ptr @hyph_tab, align 8, !tbaa !5
...
if.else402:                                       ; preds = %lor.lhs.false363
  ...
  store ptr %hyph_file.0, ptr %arrayidx404, align 8, !tbaa !5
  br label %if.end405
...
if.end405:                                        ; preds = %if.else402, %if.then369
  ...
  %link.1669 = load ptr, ptr %osucc237, align 8, !tbaa !13
...
for.cond418:                                      ; preds = %for.cond418.preheader, %for.cond418
  ...
  %61 = load i8, ptr %ou1419, align 8, !tbaa !13
...
cond.end470:                                      ; preds = %if.then435, %cond.false448
  ...
  store ptr %63, ptr @zz_hold, align 8, !tbaa !5
  %osucc474 = getelementptr inbounds %struct.LIST, ptr %63, i64 0, i32 1
  %67 = load ptr, ptr %osucc474, align 8, !tbaa !13
...
cond.false478:                                    ; preds = %cond.end470
  ...
  %68 = load ptr, ptr %63, align 8, !tbaa !13
  store ptr %68, ptr %67, align 8, !tbaa !13
  %69 = load ptr, ptr @zz_res, align 8, !tbaa !5
  ...
  store ptr %69, ptr %osucc493, align 8, !tbaa !13
  %osucc496 = getelementptr inbounds %struct.LIST, ptr %70, i64 0, i32 1
  store ptr %70, ptr %osucc496, align 8, !tbaa !13
...
cond.end500:                                      ; preds = %cond.end470, %cond.false478
  ...
  store ptr %72, ptr @zz_hold, align 8, !tbaa !5
  %ou1502 = getelementptr inbounds %struct.word_type, ptr %72, i64 0, i32 1
  %73 = load i8, ptr %ou1502, align 8, !tbaa !13
  %.off650 = add i8 %73, -11
  ...
  %74 = load ptr, ptr %arrayidx526, align 8, !tbaa !5
  store ptr %74, ptr %72, align 8, !tbaa !13
  %75 = load ptr, ptr @zz_hold, align 8, !tbaa !5
  %76 = load i32, ptr @zz_size, align 4, !tbaa !12
  %idxprom530 = sext i32 %76 to i64
  %arrayidx531 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom530
  store ptr %75, ptr %arrayidx531, align 8, !tbaa !5
  %77 = load ptr, ptr @xx_tmp, align 8, !tbaa !5
  %osucc534 = getelementptr inbounds [2 x %struct.LIST], ptr %77, i64 0, i64 1, i32 1
  %78 = load ptr, ptr %osucc534, align 8, !tbaa !13
...
if.end565:                                        ; preds = %if.then562, %if.end555
  ...
  %80 = load i8, ptr %arrayidx568, align 1, !tbaa !13
...
if.end.i:                                         ; preds = %if.then.i217, %if.then
  store i32 %mul, ptr %call.i216, align 8, !tbaa !9
...
if.end106:                                        ; preds = %if.then95, %if.else97
  ...
  store ptr %31, ptr %arrayidx113, align 8, !tbaa !13
