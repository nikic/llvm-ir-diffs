; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z51.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z51.c"
...
define internal void @Plain_PrintPageSetupForFont(ptr nocapture readnone %face, i32 %font_curr_page, ptr nocapture readnone %font_name, ptr nocapture readnone %first_size_str) #4 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define internal void @Plain_PrintPageResourceForFont(ptr nocapture readnone %font_name, i32 %first) #4 {
entry:
  ret void
}
...
entry:
  %sub = add nsw i32 %h, -1
  %0 = load i32, ptr @PlainCharWidth, align 4
  %div = sdiv i32 %sub, %0
  %add = add nsw i32 %div, 1
  store i32 %add, ptr @hsize, align 4
  %sub1 = add nsw i32 %v, -1
  %1 = load i32, ptr @PlainCharHeight, align 4
  %div2 = sdiv i32 %sub1, %1
  %add3 = add i32 %div2, 1
  store i32 %add3, ptr @vsize, align 4
...
for.cond6.preheader.preheader:                    ; preds = %entry
  ...
  tail call void @llvm.memset.p0.i64(ptr align 1 %call, i8 32, i64 %5, i1 false)
  br label %for.end14
...
for.body10:                                       ; preds = %for.end, %for.body10
  ...
  br i1 %exitcond.not, label %for.end17, label %for.body10
...
for.end21:                                        ; preds = %for.end17, %entry
  %13 = load i32, ptr @PlainFormFeed, align 4
...
if.end:                                           ; preds = %if.then, %for.end21
  ...
  %15 = load i32, ptr @PlainCharWidth, align 4
  %div = sdiv i32 %sub23, %15
  %add24 = add nsw i32 %div, 1
  %sub25 = add nsw i32 %v, -1
  %16 = load i32, ptr @PlainCharHeight, align 4
...
for.cond42.preheader.us.preheader:                ; preds = %if.end37
  ...
  tail call void @llvm.memset.p0.i64(ptr align 1 %21, i8 32, i64 %24, i1 false)
  br label %for.end55
...
entry:
  ...
  %1 = load i32, ptr @PlainCharWidth, align 4
  ...
  %2 = load i32, ptr @PlainCharHeight, align 4
...
if.then26:                                        ; preds = %if.end
  ...
  %.pre = load i32, ptr @vsize, align 4
  br label %if.end33
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  br i1 %cmp44.not, label %if.end53, label %for.body
...
for.body68.us.prol:                               ; preds = %for.cond65.preheader.us
  ...
  %19 = load i8, ptr %arrayidx74.us.prol, align 1
  %20 = add nsw i64 %18, %10
  %arrayidx77.us.prol = getelementptr inbounds i8, ptr %9, i64 %20
  store i8 %19, ptr %arrayidx77.us.prol, align 1
...
for.body68.us:                                    ; preds = %for.body68.us.prol.loopexit, %for.body68.us
  ...
  %23 = load i8, ptr %arrayidx74.us.1, align 1
  %24 = add nsw i64 %indvars.iv.next, %18
  %arrayidx77.us.1 = getelementptr inbounds i8, ptr %9, i64 %24
  store i8 %23, ptr %arrayidx77.us.1, align 1
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1, %wide.trip.count
  br i1 %exitcond.not.1, label %for.cond65.for.cond.loopexit_crit_edge.us, label %for.body68.us
...
for.cond65.for.cond.loopexit_crit_edge.us:        ; preds = %for.body68.us, %for.body68.us.prol.loopexit
  ...
  br i1 %cmp63.not.not.us, label %for.cond65.preheader.us, label %cleanup
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define internal void @Plain_LinkSource(ptr nocapture readnone %name, i32 %llx, i32 %lly, i32 %urx, i32 %ury) #4 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define internal void @Plain_LinkDest(ptr nocapture readnone %name, i32 %llx, i32 %lly, i32 %urx, i32 %ury) #4 {
entry:
  ret void
}
