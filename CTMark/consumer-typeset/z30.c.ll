; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z30.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z30.c"
...
land.lhs.true7:                                   ; preds = %land.lhs.true
  ...
  %2 = load i16, ptr %opredefined, align 8
  %tobool.not = icmp eq i16 %2, 0
  br i1 %tobool.not, label %if.then, label %if.end31

if.then:                                          ; preds = %land.lhs.true7
  store i32 2, ptr @zz_size, align 4
  %3 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @zz_free, i64 0, i64 2), align 8
...
if.else23:                                        ; preds = %if.end19
  ...
  %7 = load ptr, ptr %onext25, align 8
  %onext26 = getelementptr inbounds %struct.uses_type, ptr %tmp.0, i64 0, i32 1
  store ptr %7, ptr %onext26, align 8
  %8 = load ptr, ptr %obase_uses, align 8
  br label %if.end29
...
if.end29:                                         ; preds = %if.end19, %if.else23
  ...
  store ptr %tmp.0, ptr %onext28, align 8
  store ptr %tmp.0, ptr %obase_uses, align 8
  br label %if.end31
...
if.then43:                                        ; preds = %if.end31
  ...
  %12 = load i8, ptr %ouses_count, align 4
  %add = add i8 %cond, %12
  store i8 %add, ptr %ouses_count, align 4
...
entry:
  ...
  %link.031 = load ptr, ptr %link.0.in30, align 8
...
if.end:                                           ; preds = %for.cond3, %if.then
  ...
  br i1 %cmp.not, label %for.end19, label %for.cond3.preheader
...
if.end:                                           ; preds = %do.body
  ...
  %6 = load ptr, ptr %onext12, align 8
  store ptr %6, ptr %cont, align 8
  %7 = load ptr, ptr %ouses, align 8
  %onext14 = getelementptr inbounds %struct.uses_type, ptr %7, i64 0, i32 1
  %8 = load ptr, ptr %onext14, align 8
  %cmp15.not = icmp eq ptr %6, %8
  br i1 %cmp15.not, label %if.end17, label %do.body
...
entry:
  %obase_uses = getelementptr inbounds %struct.symbol_type, ptr %x, i64 0, i32 5
  %0 = load ptr, ptr %obase_uses, align 8
  %cmp.not = icmp eq ptr %0, null
...
do.body:                                          ; preds = %if.end55, %if.then
  ...
  %3 = load ptr, ptr %omarker, align 8
...
if.then5:                                         ; preds = %if.then3
  store ptr %sym, ptr %omarker, align 8
  store i32 2, ptr @zz_size, align 4
  %4 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @zz_free, i64 0, i64 2), align 8
...
if.else11:                                        ; preds = %if.then5
  ...
  store ptr %6, ptr getelementptr inbounds ([0 x ptr], ptr @zz_free, i64 0, i64 2), align 8
  br label %if.end17

if.end17:                                         ; preds = %if.then9, %if.else11
  %tmp.0 = phi ptr [ %call10, %if.then9 ], [ %4, %if.else11 ]
  store ptr %2, ptr %tmp.0, align 8
  %7 = load ptr, ptr %ouses, align 8
...
if.else22:                                        ; preds = %if.end17
  ...
  %8 = load ptr, ptr %onext24, align 8
  %onext25 = getelementptr inbounds %struct.uses_type, ptr %tmp.0, i64 0, i32 1
  store ptr %8, ptr %onext25, align 8
  %9 = load ptr, ptr %ouses, align 8
  br label %if.end28
...
if.end28:                                         ; preds = %if.end17, %if.else22
  ...
  store ptr %tmp.0, ptr %onext27, align 8
  store ptr %tmp.0, ptr %ouses, align 8
...
if.end55:                                         ; preds = %if.end48, %if.else49, %do.body
  ...
  %12 = load ptr, ptr %onext56, align 8
  %13 = load ptr, ptr %obase_uses, align 8
  %onext58 = getelementptr inbounds %struct.uses_type, ptr %13, i64 0, i32 1
  %14 = load ptr, ptr %onext58, align 8
  %cmp59.not = icmp eq ptr %12, %14
  br i1 %cmp59.not, label %if.end60, label %do.body
