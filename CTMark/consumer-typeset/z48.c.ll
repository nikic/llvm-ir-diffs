; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z48.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/consumer-typeset/z48.c"
...
if.end6:                                          ; preds = %if.then4, %entry
  ...
  store ptr %call8, ptr %m_font_encoding, align 8
...
if.end13:                                         ; preds = %if.then11, %if.end6
  ...
  store ptr %call3, ptr @g_font_encoding_list, align 8
  ret void
}
...
entry:
  ...
  br i1 %cmp.i, label %PDFFont_FindFontEncoding.exit, label %while.cond.i5

while.cond.i5:                                    ; preds = %entry, %while.body.i8
  %entry1.0.in.i6 = phi ptr [ %entry1.0.i7, %while.body.i8 ], [ @g_font_encoding_list, %entry ]
  %entry1.0.i7 = load ptr, ptr %entry1.0.in.i6, align 8
  %cmp2.not.i = icmp eq ptr %entry1.0.i7, null
  br i1 %cmp2.not.i, label %PDFFont_FindFontEncoding.exit, label %while.body.i8

while.body.i8:                                    ; preds = %while.cond.i5
  %m_font_encoding.i = getelementptr inbounds %struct.t_font_encoding_entry, ptr %entry1.0.i7, i64 0, i32 2
  %0 = load ptr, ptr %m_font_encoding.i, align 8
  %call.i9 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %in_font_encoding_name, ptr noundef nonnull dereferenceable(1) %0) #22
  %cmp3.i = icmp eq i32 %call.i9, 0
  br i1 %cmp3.i, label %cond.true.i, label %while.cond.i5

cond.true.i:                                      ; preds = %while.body.i8
  %m_object_num.i = getelementptr inbounds %struct.t_font_encoding_entry, ptr %entry1.0.i7, i64 0, i32 1
  %1 = load i32, ptr %m_object_num.i, align 8
  br label %PDFFont_FindFontEncoding.exit

PDFFont_FindFontEncoding.exit:                    ; preds = %while.cond.i5, %entry, %cond.true.i
  %retval.0.i = phi i32 [ 0, %entry ], [ %1, %cond.true.i ], [ 0, %while.cond.i5 ]
...
while.cond.i10:                                   ; preds = %while.cond.i10, %PDFFont_FindFontEncoding.exit
  ...
  %new_entry.0.i = load ptr, ptr %new_entry.0.in.i, align 8
  %cmp.not.i11 = icmp eq ptr %new_entry.0.i, null
  %inc.i = add i32 %next_font_num.0.i, 1
  br i1 %cmp.not.i11, label %while.end.i, label %while.cond.i10
...
if.end.i:                                         ; preds = %if.then.i, %while.end.i
  ...
  store ptr %call9.i, ptr %m_PDF_font_name.i, align 8
...
if.end14.i:                                       ; preds = %if.then12.i, %if.end.i
  ...
  store ptr %call20.i, ptr %m_short_font_name.i, align 8
...
if.end25.i:                                       ; preds = %if.then23.i, %if.end14.i
  ...
  store ptr %call30.i, ptr %m_actual_font_name.i13, align 8
...
PDFFont_NewListEntry.exit:                        ; preds = %if.end25.i, %if.then33.i
  ...
  store i32 %retval.0.i, ptr %m_font_encoding_obj.i, align 8
  %m_pdf_object_number.i = getelementptr inbounds %struct.t_font_list_entry, ptr %call.i12, i64 0, i32 5
  store i32 0, ptr %m_pdf_object_number.i, align 4
  %m_font_resource_in_pdf.i = getelementptr inbounds %struct.t_font_list_entry, ptr %call.i12, i64 0, i32 6
  store i32 0, ptr %m_font_resource_in_pdf.i, align 8
  %7 = load ptr, ptr @g_font_list, align 8
  store ptr %7, ptr %call.i12, align 8
  store ptr %call.i12, ptr @g_font_list, align 8
...
entry:
  store i32 %xsize, ptr @g_graphics_vars, align 16
  store i32 %ysize, ptr getelementptr inbounds ([4 x i32], ptr @g_graphics_vars, i64 0, i64 1), align 4
  store i32 %xmark, ptr getelementptr inbounds ([4 x i32], ptr @g_graphics_vars, i64 0, i64 2), align 8
  store i32 %ymark, ptr getelementptr inbounds ([4 x i32], ptr @g_graphics_vars, i64 0, i64 3), align 4
  store i32 %loutf, ptr getelementptr inbounds ([7 x i32], ptr @g_units, i64 0, i64 4), align 16
  store i32 %loutv, ptr getelementptr inbounds ([7 x i32], ptr @g_units, i64 0, i64 5), align 4
  store i32 %louts, ptr getelementptr inbounds ([7 x i32], ptr @g_units, i64 0, i64 6), align 8
  ret void
}
...
entry:
  ...
  %0 = load i8, ptr %in_str, align 1
  %cmp = icmp eq i8 %0, 0
  br i1 %cmp, label %if.end17, label %if.end

if.end:                                           ; preds = %entry
  %1 = load i32, ptr @g_page_contents_obj_num, align 4
...
if.then.i:                                        ; preds = %if.end
  ...
  store i32 %call.i.i, ptr @g_page_contents_obj_num, align 4
  %call3.i = tail call fastcc i32 @PDFObject_New()
  store i32 %call3.i, ptr @g_page_length_obj_num, align 4
  %2 = tail call i64 @fwrite(ptr nonnull @.str.72, i64 11, i64 1, ptr %in_fp)
  %3 = load i32, ptr @g_page_length_obj_num, align 4
  ...
  store i32 %conv.i, ptr @g_page_start_offset, align 4
  %5 = load float, ptr @g_page_h_scale_factor, align 4
  %conv7.i = fpext float %5 to double
  %6 = load float, ptr @g_page_v_scale_factor, align 4
...
PDFPage_WriteStream.exit.i:                       ; preds = %if.end.i.i, %if.then.i
  %8 = load i32, ptr @g_page_line_width, align 4
  ...
  %9 = load i8, ptr %str.i, align 16
  %cmp.i24.i = icmp eq i8 %9, 0
  br i1 %cmp.i24.i, label %PDFPage_WriteStream.exit27.i, label %if.end.i25.i

if.end.i25.i:                                     ; preds = %PDFPage_WriteStream.exit.i
  %call.i26.i = call i32 @fputs(ptr noundef nonnull %str.i, ptr noundef %in_fp)
  br label %PDFPage_WriteStream.exit27.i

PDFPage_WriteStream.exit27.i:                     ; preds = %if.end.i25.i, %PDFPage_WriteStream.exit.i
...
if.then2:                                         ; preds = %PDFPage_Begin.exit
  ...
  %10 = load i32, ptr @g_buffer_pos, align 4
...
if.then.i30:                                      ; preds = %if.then2
  ...
  %.pr.i = load ptr, ptr @g_qsave_marking_stack, align 8
...
while.body.i:                                     ; preds = %if.then.i30, %while.body.i
  ...
  store ptr %12, ptr @g_qsave_marking_stack, align 8
...
while.end.i:                                      ; preds = %while.body.i, %if.then.i30
  %13 = load i8, ptr @g_buffer, align 16
  %cmp.i.i31 = icmp eq i8 %13, 0
  br i1 %cmp.i.i31, label %PDFPage_FlushBuffer.exit, label %if.end.i.i32

if.end.i.i32:                                     ; preds = %while.end.i
  %call.i.i33 = tail call i32 @fputs(ptr noundef nonnull @g_buffer, ptr noundef %in_fp)
  br label %PDFPage_FlushBuffer.exit

PDFPage_FlushBuffer.exit:                         ; preds = %while.end.i, %if.end.i.i32
  %14 = load i8, ptr %in_str, align 1
...
if.else:                                          ; preds = %if.then2
  ...
  store i32 %add, ptr @g_buffer_pos, align 4
  br label %if.end17
...
if.end16:                                         ; preds = %if.then15, %if.end13
  %17 = load i8, ptr %in_str, align 1
  %cmp.i39 = icmp eq i8 %17, 0
  br i1 %cmp.i39, label %if.end17, label %if.end.i40

if.end.i40:                                       ; preds = %if.end16
  %call.i41 = tail call i32 @fputs(ptr noundef nonnull %in_str, ptr noundef %in_fp)
  br label %if.end17

if.end17:                                         ; preds = %if.end.i40, %if.end16, %if.end.i, %PDFPage_FlushBuffer.exit, %if.else, %entry
  ret void
}
...
if.end:                                           ; preds = %if.then, %entry
  %1 = load i32, ptr @g_page_h_origin, align 4
  %m_page_h_origin = getelementptr inbounds %struct.t_qsave_entry, ptr %call, i64 0, i32 1
  store i32 %1, ptr %m_page_h_origin, align 8
  %2 = load i32, ptr @g_page_v_origin, align 4
  %m_page_v_origin = getelementptr inbounds %struct.t_qsave_entry, ptr %call, i64 0, i32 2
  store i32 %2, ptr %m_page_v_origin, align 4
  %3 = load ptr, ptr @g_qsave_stack, align 8
  store ptr %3, ptr %call, align 8
  store ptr %call, ptr @g_qsave_stack, align 8
  %.b = load i1, ptr @g_in_buffering_mode, align 4
...
if.end9:                                          ; preds = %if.then7, %if.then3
  %5 = load ptr, ptr @g_qsave_marking_stack, align 8
  store ptr %5, ptr %call5, align 8
  %6 = load i32, ptr @g_buffer_pos, align 4
  %m_buffer_pos = getelementptr inbounds %struct.t_qsave_marking_entry, ptr %call5, i64 0, i32 1
  store i32 %6, ptr %m_buffer_pos, align 8
  store ptr %call5, ptr @g_qsave_marking_stack, align 8
  br label %if.end11
...
entry:
  %0 = load ptr, ptr @g_qsave_stack, align 8
  %m_page_h_origin = getelementptr inbounds %struct.t_qsave_entry, ptr %0, i64 0, i32 1
  %1 = load i32, ptr %m_page_h_origin, align 8
  store i32 %1, ptr @g_page_h_origin, align 4
  %m_page_v_origin = getelementptr inbounds %struct.t_qsave_entry, ptr %0, i64 0, i32 2
  %2 = load i32, ptr %m_page_v_origin, align 4
  store i32 %2, ptr @g_page_v_origin, align 4
  %3 = load ptr, ptr %0, align 8
  store ptr %3, ptr @g_qsave_stack, align 8
  tail call void @free(ptr noundef %0) #21
  %.b = load i1, ptr @g_in_buffering_mode, align 4
  %4 = load ptr, ptr @g_qsave_marking_stack, align 8
...
Assert.exit:                                      ; preds = %if.then, %if.then2.i
  ...
  store ptr %6, ptr @g_qsave_marking_stack, align 8
  %m_buffer_pos = getelementptr inbounds %struct.t_qsave_marking_entry, ptr %4, i64 0, i32 1
  %7 = load i32, ptr %m_buffer_pos, align 8
  store i32 %7, ptr @g_buffer_pos, align 4
...
if.else:                                          ; preds = %entry
  br i1 %cmp.not, label %Assert.exit15, label %if.then2.i13

if.then2.i13:                                     ; preds = %if.else
  %8 = load ptr, ptr @no_fpos, align 8
  %call.i14 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.75, i32 noundef 0, ptr noundef %8, ptr noundef %8) #21
  br label %Assert.exit15

Assert.exit15:                                    ; preds = %if.else, %if.then2.i13
...
while.cond.i:                                     ; preds = %while.body.i, %entry
  ...
  %entry1.0.i = load ptr, ptr %entry1.0.in.i, align 8
...
while.body.i:                                     ; preds = %while.cond.i
  ...
  %0 = load ptr, ptr %m_short_font_name.i, align 8
...
if.end:                                           ; preds = %while.body.i, %if.then
  ...
  %2 = load ptr, ptr %m_PDF_font_name, align 8
...
if.end5:                                          ; preds = %if.then4, %if.end
  ...
  store i32 1, ptr %m_in_use, align 4
...
if.then.i.i:                                      ; preds = %entry
  store i1 false, ptr @g_in_buffering_mode, align 4
  %.pr.i.i = load ptr, ptr @g_qsave_marking_stack, align 8
...
while.body.i.i:                                   ; preds = %if.then.i.i, %while.body.i.i
  ...
  store ptr %2, ptr @g_qsave_marking_stack, align 8
  tail call void @free(ptr noundef nonnull %1) #21
  %cmp.not.i.i = icmp eq ptr %2, null
  br i1 %cmp.not.i.i, label %while.end.i.i, label %while.body.i.i

while.end.i.i:                                    ; preds = %while.body.i.i, %if.then.i.i
  %3 = load i8, ptr @g_buffer, align 16
...
PDFText_OpenBT.exit:                              ; preds = %if.then2.i3, %if.else.i
  ...
  br i1 %.b.i4, label %if.then.i7, label %if.else.i5

if.then.i7:                                       ; preds = %PDFText_OpenBT.exit
  store i1 false, ptr @g_TJ_pending, align 4
  br label %if.end

if.else.i5:                                       ; preds = %PDFText_OpenBT.exit
  tail call void @PDFPage_Write(ptr noundef %in_fp, ptr noundef nonnull @.str.79)
  br label %if.end

if.end:                                           ; preds = %if.else.i5, %if.then.i7, %Assert.exit
  ret void
}
...
entry:
  %0 = load i32, ptr @g_page_contents_obj_num, align 4
...
entry:
  ...
  call void @PDFPage_Write(ptr noundef %in_fp, ptr noundef nonnull %str)
  %0 = load float, ptr @g_page_h_scale_factor, align 4
  %mul = fmul float %0, %in_h_scale_factor
  store float %mul, ptr @g_page_h_scale_factor, align 4
  %1 = load float, ptr @g_page_v_scale_factor, align 4
  %mul3 = fmul float %1, %in_v_scale_factor
  store float %mul3, ptr @g_page_v_scale_factor, align 4
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %str) #21
  ret void
}
...
if.end:                                           ; preds = %entry
  %1 = load i32, ptr @g_expr_depth, align 4
...
if.then4:                                         ; preds = %if.end
  ...
  %2 = load i32, ptr %hasResult, align 4
...
if.end10:                                         ; preds = %if.end9, %if.end
  ...
  %4 = load i32, ptr @g_link_depth, align 4
...
if.end15:                                         ; preds = %if.then13, %if.end10
  ...
  %5 = load i8, ptr %charPtr.1, align 1
...
if.then2.i:                                       ; preds = %while.body
  ...
  %.pre = load i8, ptr %charPtr.2240, align 1
  br label %Assert.exit
...
if.else:                                          ; preds = %for.inc.i.2
  %bcmp.i188 = call i32 @bcmp(ptr noundef nonnull dereferenceable(14) @.str.113, ptr noundef nonnull dereferenceable(14) %add.ptr32, i64 14)
  %cmp5.i189 = icmp eq i32 %bcmp.i188, 0
  br i1 %cmp5.i189, label %if.then48, label %for.inc.i190

for.inc.i190:                                     ; preds = %if.else
  %bcmp.i188.1 = call i32 @bcmp(ptr noundef nonnull dereferenceable(16) @.str.114, ptr noundef nonnull dereferenceable(16) %add.ptr32, i64 16)
  %cmp5.i189.1 = icmp eq i32 %bcmp.i188.1, 0
  br i1 %cmp5.i189.1, label %if.then48, label %for.inc.i190.1

for.inc.i190.1:                                   ; preds = %for.inc.i190
  %bcmp.i188.2 = call i32 @bcmp(ptr noundef nonnull dereferenceable(11) @.str.115, ptr noundef nonnull dereferenceable(11) %add.ptr32, i64 11)
  %cmp5.i189.2 = icmp eq i32 %bcmp.i188.2, 0
  br i1 %cmp5.i189.2, label %if.then48, label %for.inc.i190.2

for.inc.i190.2:                                   ; preds = %for.inc.i190.1
  %bcmp.i188.3 = call i32 @bcmp(ptr noundef nonnull dereferenceable(14) @.str.116, ptr noundef nonnull dereferenceable(14) %add.ptr32, i64 14)
  %cmp5.i189.3 = icmp eq i32 %bcmp.i188.3, 0
  br i1 %cmp5.i189.3, label %if.then48, label %for.inc.i190.3

for.inc.i190.3:                                   ; preds = %for.inc.i190.2
  %bcmp.i188.4 = call i32 @bcmp(ptr noundef nonnull dereferenceable(25) @.str.117, ptr noundef nonnull dereferenceable(25) %add.ptr32, i64 25)
  %cmp5.i189.4 = icmp eq i32 %bcmp.i188.4, 0
  br i1 %cmp5.i189.4, label %if.then48, label %if.else62

if.then48:                                        ; preds = %if.else, %for.inc.i190, %for.inc.i190.1, %for.inc.i190.2, %for.inc.i190.3
  %indvars.iv.i184.lcssa = phi i64 [ 0, %if.else ], [ 1, %for.inc.i190 ], [ 2, %for.inc.i190.1 ], [ 3, %for.inc.i190.2 ], [ 4, %for.inc.i190.3 ]
  %12 = trunc i64 %indvars.iv.i184.lcssa to i32
  %reltable.shift = shl i64 %indvars.iv.i184.lcssa, 2
  ...
  %13 = load ptr, ptr %call54, align 8
...
while.cond53:                                     ; preds = %while.cond53, %if.then48
  ...
  %14 = load i8, ptr %charPtr.3, align 1
  %idxprom56 = zext i8 %14 to i64
  %arrayidx57 = getelementptr inbounds i16, ptr %13, i64 %idxprom56
  %15 = load i16, ptr %arrayidx57, align 2
  %16 = and i16 %15, 8192
  %tobool59.not = icmp eq i16 %16, 0
  %incdec.ptr = getelementptr inbounds i8, ptr %charPtr.3, i64 1
  br i1 %tobool59.not, label %while.end, label %while.cond53

while.end:                                        ; preds = %while.cond53
  store i32 0, ptr @g_link_index, align 4
  %17 = load i32, ptr @g_link_depth, align 4
  %inc = add nsw i32 %17, 1
  store i32 %inc, ptr @g_link_depth, align 4
  store i32 %12, ptr @g_link_keyword, align 4
  %call61 = call fastcc ptr @PDFPage_CollectLink(ptr noundef nonnull %charPtr.3)
  br label %if.end126

if.else62:                                        ; preds = %for.inc.i190.3
  %bcmp.i201 = call i32 @bcmp(ptr noundef nonnull dereferenceable(7) @.str.118, ptr noundef nonnull dereferenceable(7) %add.ptr32, i64 7)
  %cmp5.i202 = icmp eq i32 %bcmp.i201, 0
  br i1 %cmp5.i202, label %sw.bb.i, label %for.inc.i203

for.inc.i203:                                     ; preds = %if.else62
  %bcmp.i201.1 = call i32 @bcmp(ptr noundef nonnull dereferenceable(6) @.str.119, ptr noundef nonnull dereferenceable(6) %add.ptr32, i64 6)
  %cmp5.i202.1 = icmp eq i32 %bcmp.i201.1, 0
  br i1 %cmp5.i202.1, label %sw.bb7.i, label %for.inc.i203.1

for.inc.i203.1:                                   ; preds = %for.inc.i203
  %bcmp.i201.2 = call i32 @bcmp(ptr noundef nonnull dereferenceable(8) @.str.120, ptr noundef nonnull dereferenceable(8) %add.ptr32, i64 8)
  %cmp5.i202.2 = icmp eq i32 %bcmp.i201.2, 0
  br i1 %cmp5.i202.2, label %sw.bb20.i, label %for.inc.i203.2

for.inc.i203.2:                                   ; preds = %for.inc.i203.1
  %bcmp.i201.3 = call i32 @bcmp(ptr noundef nonnull dereferenceable(9) @.str.121, ptr noundef nonnull dereferenceable(9) %add.ptr32, i64 9)
  %cmp5.i202.3 = icmp eq i32 %bcmp.i201.3, 0
  br i1 %cmp5.i202.3, label %sw.bb33.i, label %if.else72

sw.bb.i:                                          ; preds = %if.else62
  %add.ptr70251 = getelementptr inbounds i8, ptr %charPtr.2240, i64 9
  %18 = load ptr, ptr @g_doc_author, align 8
...
if.end.i:                                         ; preds = %if.then.i, %sw.bb.i
  ...
  store ptr %call1.i, ptr @g_doc_author, align 8
...
sw.bb7.i:                                         ; preds = %for.inc.i203
  %add.ptr70258 = getelementptr inbounds i8, ptr %charPtr.2240, i64 8
  %20 = load ptr, ptr @g_doc_title, align 8
...
if.end10.i:                                       ; preds = %if.then9.i, %sw.bb7.i
  ...
  store ptr %call13.i, ptr @g_doc_title, align 8
...
sw.bb20.i:                                        ; preds = %for.inc.i203.1
  %add.ptr70264 = getelementptr inbounds i8, ptr %charPtr.2240, i64 10
  %22 = load ptr, ptr @g_doc_subject, align 8
...
if.end23.i:                                       ; preds = %if.then22.i, %sw.bb20.i
  ...
  store ptr %call26.i, ptr @g_doc_subject, align 8
...
sw.bb33.i:                                        ; preds = %for.inc.i203.2
  %add.ptr70 = getelementptr inbounds i8, ptr %charPtr.2240, i64 11
  %24 = load ptr, ptr @g_doc_keywords, align 8
...
if.end36.i:                                       ; preds = %if.then35.i, %sw.bb33.i
  ...
  store ptr %call39.i, ptr @g_doc_keywords, align 8
...
if.else72:                                        ; preds = %for.inc.i203.2
  %bcmp.i215 = call i32 @bcmp(ptr noundef nonnull dereferenceable(3) @.str.126, ptr noundef nonnull dereferenceable(3) %add.ptr32, i64 3)
  %cmp5.i216 = icmp eq i32 %bcmp.i215, 0
  br i1 %cmp5.i216, label %if.then76, label %for.inc.i217

for.inc.i217:                                     ; preds = %if.else72
  %bcmp.i215.1 = call i32 @bcmp(ptr noundef nonnull dereferenceable(3) @.str.127, ptr noundef nonnull dereferenceable(3) %add.ptr32, i64 3)
  %cmp5.i216.1 = icmp eq i32 %bcmp.i215.1, 0
  br i1 %cmp5.i216.1, label %if.then76, label %for.inc.i217.1

for.inc.i217.1:                                   ; preds = %for.inc.i217
  %bcmp.i215.2 = call i32 @bcmp(ptr noundef nonnull dereferenceable(3) @.str.128, ptr noundef nonnull dereferenceable(3) %add.ptr32, i64 3)
  %cmp5.i216.2 = icmp eq i32 %bcmp.i215.2, 0
  br i1 %cmp5.i216.2, label %if.then76, label %for.inc.i217.2

for.inc.i217.2:                                   ; preds = %for.inc.i217.1
  %bcmp.i215.3 = call i32 @bcmp(ptr noundef nonnull dereferenceable(3) @.str.129, ptr noundef nonnull dereferenceable(3) %add.ptr32, i64 3)
  %cmp5.i216.3 = icmp eq i32 %bcmp.i215.3, 0
  br i1 %cmp5.i216.3, label %if.then76, label %for.inc.i217.3

for.inc.i217.3:                                   ; preds = %for.inc.i217.2
  %bcmp.i215.4 = call i32 @bcmp(ptr noundef nonnull dereferenceable(3) @.str.130, ptr noundef nonnull dereferenceable(3) %add.ptr32, i64 3)
  %cmp5.i216.4 = icmp eq i32 %bcmp.i215.4, 0
  br i1 %cmp5.i216.4, label %if.then76, label %for.inc.i217.4

for.inc.i217.4:                                   ; preds = %for.inc.i217.3
  %bcmp.i215.5 = call i32 @bcmp(ptr noundef nonnull dereferenceable(3) @.str.131, ptr noundef nonnull dereferenceable(3) %add.ptr32, i64 3)
  %cmp5.i216.5 = icmp eq i32 %bcmp.i215.5, 0
  br i1 %cmp5.i216.5, label %if.then76, label %for.inc.i217.5

for.inc.i217.5:                                   ; preds = %for.inc.i217.4
  %bcmp.i215.6 = call i32 @bcmp(ptr noundef nonnull dereferenceable(4) @.str.132, ptr noundef nonnull dereferenceable(4) %add.ptr32, i64 4)
  %cmp5.i216.6 = icmp eq i32 %bcmp.i215.6, 0
  br i1 %cmp5.i216.6, label %if.then76, label %if.else115

if.then76:                                        ; preds = %if.else72, %for.inc.i217, %for.inc.i217.1, %for.inc.i217.2, %for.inc.i217.3, %for.inc.i217.4, %for.inc.i217.5
  %indvars.iv.i211.lcssa = phi i64 [ 0, %if.else72 ], [ 1, %for.inc.i217 ], [ 2, %for.inc.i217.1 ], [ 3, %for.inc.i217.2 ], [ 4, %for.inc.i217.3 ], [ 5, %for.inc.i217.4 ], [ 6, %for.inc.i217.5 ]
  %arrayidx78 = getelementptr inbounds [7 x ptr], ptr @g_arithmetic_keywords, i64 0, i64 %indvars.iv.i211.lcssa
  ...
  %27 = load ptr, ptr %call85, align 8
...
while.cond84:                                     ; preds = %while.cond84, %if.then76
  ...
  %28 = load i8, ptr %charPtr.4, align 1
  ...
  br i1 %tobool91.not, label %while.end94, label %while.cond84
...
if.end100:                                        ; preds = %if.then98, %while.end94
  ...
  store i32 %conv103, ptr @g_expr_index, align 4
  %32 = load i32, ptr @g_expr_depth, align 4
  %inc104 = add nsw i32 %32, 1
  store i32 %inc104, ptr @g_expr_depth, align 4
...
if.else115:                                       ; preds = %for.inc.i217.5
  ...
  store i8 95, ptr %strPtr.2.ptr242, align 1
  %incdec.ptr117.add = add nsw i64 %strPtr.2.idx241, 2
  store i8 95, ptr %incdec.ptr117.ptr, align 1
  br label %if.end126
...
if.else123:                                       ; preds = %land.lhs.true, %Assert.exit
  ...
  store i8 %8, ptr %strPtr.2.ptr242, align 1
  br label %if.end126
...
if.end126:                                        ; preds = %if.then36, %PDFPage_ProcessDocInfoKeyword.exit, %if.else115, %if.end114, %while.end, %if.else123
  ...
  %36 = load i8, ptr %charPtr.5, align 1
  %cmp17.not = icmp eq i8 %36, 0
  br i1 %cmp17.not, label %while.end127, label %while.body

while.end127:                                     ; preds = %if.end126, %if.end15
  %strPtr.2.ptr.lcssa = phi ptr [ %strPtr.2.ptr238, %if.end15 ], [ %strPtr.2.ptr, %if.end126 ]
  store i8 0, ptr %strPtr.2.ptr.lcssa, align 1
  %.b.i = load i1, ptr @g_in_buffering_mode, align 4
  br i1 %.b.i, label %if.then.i224, label %PDFPage_FlushBuffer.exit

if.then.i224:                                     ; preds = %while.end127
  store i1 false, ptr @g_in_buffering_mode, align 4
  %.pr.i = load ptr, ptr @g_qsave_marking_stack, align 8
  %cmp.not3.i = icmp eq ptr %.pr.i, null
  br i1 %cmp.not3.i, label %while.end.i, label %while.body.i

while.body.i:                                     ; preds = %if.then.i224, %while.body.i
  %37 = phi ptr [ %38, %while.body.i ], [ %.pr.i, %if.then.i224 ]
  %38 = load ptr, ptr %37, align 8
  store ptr %38, ptr @g_qsave_marking_stack, align 8
  call void @free(ptr noundef nonnull %37) #21
  %cmp.not.i225 = icmp eq ptr %38, null
  br i1 %cmp.not.i225, label %while.end.i, label %while.body.i

while.end.i:                                      ; preds = %while.body.i, %if.then.i224
  %39 = load i8, ptr @g_buffer, align 16
...
entry:
  store i32 0, ptr %outHasResult, align 4
  %0 = load i8, ptr %charPtr, align 1
  %cmp.not32 = icmp eq i8 %0, 0
  br i1 %cmp.not32, label %while.end, label %while.body.preheader

while.body.preheader:                             ; preds = %entry
  %.pre35 = load i32, ptr @g_expr_index, align 4
  br label %while.body
...
if.then:                                          ; preds = %while.body
  ...
  %.pr = load i8, ptr %charPtr.addr.033, align 1
  %.pre36 = load i32, ptr @g_expr_index, align 4
  br label %if.end
...
if.end:                                           ; preds = %if.then, %while.body
  ...
  %inc = add nsw i32 %4, 1
  store i32 %inc, ptr @g_expr_index, align 4
...
if.then8:                                         ; preds = %if.end
  %6 = load i32, ptr @g_expr_depth, align 4
  %inc9 = add nsw i32 %6, 1
  store i32 %inc9, ptr @g_expr_depth, align 4
  br label %cleanup

if.then13:                                        ; preds = %if.end
  %7 = load i32, ptr @g_expr_depth, align 4
...
if.then2.i:                                       ; preds = %if.then13
  ...
  %.pre = load i32, ptr @g_expr_index, align 4
  %.pre37 = load i32, ptr @g_expr_depth, align 4
  br label %Assert.exit
...
Assert.exit:                                      ; preds = %if.then13, %if.then2.i
  ...
  %dec = add nsw i32 %9, -1
  store i32 %dec, ptr @g_expr_depth, align 4
...
cleanup.thread:                                   ; preds = %Assert.exit
  ...
  store i32 1, ptr %outHasResult, align 4
  br label %while.end
...
while.body.preheader:                             ; preds = %entry
  %.pre = load i32, ptr @g_link_index, align 4
  br label %while.body
...
if.then:                                          ; preds = %while.body
  ...
  %.pr = load i8, ptr %charPtr.addr.059, align 1
  %.pre63 = load i32, ptr @g_link_index, align 4
  br label %if.end
...
if.end:                                           ; preds = %if.then, %while.body
  ...
  %inc = add nsw i32 %4, 1
  store i32 %inc, ptr @g_link_index, align 4
  %idxprom = sext i32 %4 to i64
...
if.then11:                                        ; preds = %land.lhs.true
  ...
  store i32 %inc13, ptr @g_link_index, align 4
  %idxprom14 = sext i32 %inc to i64
  %arrayidx15 = getelementptr inbounds [512 x i8], ptr @g_link, i64 0, i64 %idxprom14
  store i8 60, ptr %arrayidx15, align 1
  %7 = load i32, ptr @g_link_depth, align 4
  %inc16 = add nsw i32 %7, 1
  store i32 %inc16, ptr @g_link_depth, align 4
...
if.then24:                                        ; preds = %land.lhs.true20
  %9 = load i32, ptr @g_link_depth, align 4
...
if.then29:                                        ; preds = %Assert.exit
  ...
  %13 = load i32, ptr @g_link_keyword, align 4
  %14 = load i8, ptr @g_link, align 16
...
land.rhs.lr.ph.i:                                 ; preds = %if.then29
  ...
  %15 = load ptr, ptr %call.i50, align 8
  br label %land.rhs.i
...
land.rhs.i:                                       ; preds = %while.body.i, %land.rhs.lr.ph.i
  ...
  %.pre.i = load i8, ptr %incdec.ptr.phi.trans.insert.i, align 1
...
while.body.i:                                     ; preds = %land.rhs9.i, %land.rhs.i
  ...
  br i1 %cmp.not.i, label %.loopexit.i, label %land.rhs.i
...
while.cond19.i:                                   ; preds = %while.cond19.i, %while.end.i
  ...
  %22 = load i8, ptr %charPtr.2.i, align 1
  %cmp21.not.i = icmp eq i8 %22, 0
  %incdec.ptr24.i = getelementptr inbounds i8, ptr %charPtr.2.i, i64 1
  br i1 %cmp21.not.i, label %while.end25.i, label %while.cond19.i
...
if.else.i:                                        ; preds = %while.end25.i
  %24 = load i32, ptr @g_page_h_origin, align 4
  %25 = load float, ptr @g_page_h_scale_factor, align 4
  %26 = load i32, ptr @g_page_v_origin, align 4
  %27 = load float, ptr @g_page_v_scale_factor, align 4
  %28 = load <2 x i32>, ptr @g_graphics_vars, align 16
  %29 = insertelement <2 x i32> poison, i32 %24, i64 0
  %30 = insertelement <2 x i32> %29, i32 %26, i64 1
  %31 = add nsw <2 x i32> %28, %30
  %32 = insertelement <4 x i32> poison, i32 %24, i64 0
  %33 = insertelement <4 x i32> %32, i32 %26, i64 1
  %34 = shufflevector <2 x i32> %31, <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %35 = shufflevector <4 x i32> %33, <4 x i32> %34, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  %36 = sitofp <4 x i32> %35 to <4 x float>
  %37 = insertelement <4 x float> poison, float %25, i64 0
  %38 = insertelement <4 x float> %37, float %27, i64 1
...
while.cond53.i:                                   ; preds = %for.inc.i.6.i, %while.cond53.i
  ...
  %42 = load i8, ptr %charPtr.3.i, align 1
  %cmp55.not.i = icmp eq i8 %42, 0
  %incdec.ptr58.i = getelementptr inbounds i8, ptr %charPtr.3.i, i64 1
  br i1 %cmp55.not.i, label %while.end59.i, label %while.cond53.i
...
if.end63.i:                                       ; preds = %while.end59.i, %for.inc.i.6.i, %for.inc.i.5.i, %for.inc.i.4.i, %for.inc.i.3.i, %for.inc.i.2.i, %for.inc.i.1.i, %for.inc.i.i, %for.body.i.preheader.i, %sw.bb.i
  %j.0.i = phi i32 [ 0, %while.end59.i ], [ 0, %sw.bb.i ], [ 6, %for.inc.i.5.i ], [ 5, %for.inc.i.4.i ], [ 4, %for.inc.i.3.i ], [ 3, %for.inc.i.2.i ], [ 2, %for.inc.i.1.i ], [ 1, %for.inc.i.i ], [ 0, %for.body.i.preheader.i ], [ 7, %for.inc.i.6.i ]
  %link_len.1.i = phi i32 [ %conv60.i, %while.end59.i ], [ %link_len.0.lcssa190.i, %sw.bb.i ], [ %link_len.0.lcssa190.i, %for.inc.i.5.i ], [ %link_len.0.lcssa190.i, %for.inc.i.4.i ], [ %link_len.0.lcssa190.i, %for.inc.i.3.i ], [ %link_len.0.lcssa190.i, %for.inc.i.2.i ], [ %link_len.0.lcssa190.i, %for.inc.i.1.i ], [ %link_len.0.lcssa190.i, %for.inc.i.i ], [ %link_len.0.lcssa190.i, %for.body.i.preheader.i ], [ %link_len.0.lcssa190.i, %for.inc.i.6.i ]
...
if.then69.i:                                      ; preds = %sw.bb65.i
  br i1 %cmp.not.lcssa193.i, label %if.then86.i, label %for.body.i151.preheader.i

for.body.i151.preheader.i:                        ; preds = %if.then69.i
  %bcmp.i156.i = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(10) @.str.107, ptr noundef nonnull dereferenceable(10) %incdec.ptr18195.i, i64 10)
  %cmp5.i157.i = icmp eq i32 %bcmp.i156.i, 0
  br i1 %cmp5.i157.i, label %if.end83.i, label %if.then86.i

if.end83.i:                                       ; preds = %for.body.i151.preheader.i
  %add.ptr79.i = getelementptr inbounds i8, ptr %incdec.ptr18195.i, i64 10
...
if.then86.i:                                      ; preds = %if.end83.i, %for.body.i151.preheader.i, %if.then69.i
...
if.else88.i:                                      ; preds = %if.end83.i
  ...
  store ptr %call91.i, ptr %m_file_spec.i, align 8
...
if.then95.i:                                      ; preds = %if.else88.i
  ...
  %.pre185.i = load ptr, ptr %m_file_spec.i, align 8
  br label %if.end97.i
...
if.end.i.i:                                       ; preds = %if.then.i.i, %sw.bb102.i
  ...
  store ptr %call3.i.i, ptr %m_name.i.i, align 8
...
if.end9.i.i:                                      ; preds = %if.then7.i.i, %if.end.i.i
  ...
  store i8 0, ptr %arrayidx.i166.i, align 1
  %59 = load i32, ptr @g_page_contents_obj_num, align 4
...
Assert.exit.i.i:                                  ; preds = %if.then2.i.i.i, %if.end9.i.i
  %61 = load i32, ptr @g_page_object_num, align 4
  %m_page_object_num.i.i = getelementptr inbounds %struct.t_target_annot_entry, ptr %call.i164.i, i64 0, i32 2
  store i32 %61, ptr %m_page_object_num.i.i, align 8
  %m_ll_x.i.i = getelementptr inbounds %struct.t_target_annot_entry, ptr %call.i164.i, i64 0, i32 3
  store <4 x i32> %41, ptr %m_ll_x.i.i, align 4
  %m_for_export.i.i = getelementptr inbounds %struct.t_target_annot_entry, ptr %call.i164.i, i64 0, i32 7
  store i32 %conv104.i, ptr %m_for_export.i.i, align 4
  %62 = load ptr, ptr @g_target_annot_list, align 8
  store ptr %62, ptr %call.i164.i, align 8
  store ptr %call.i164.i, ptr @g_target_annot_list, align 8
...
if.else34:                                        ; preds = %Assert.exit
  ...
  %64 = load i32, ptr @g_link_index, align 4
  %inc36 = add nsw i32 %64, 1
  store i32 %inc36, ptr @g_link_index, align 4
...
cleanupthread-pre-split:                          ; preds = %if.end, %if.else34, %if.then11
  ...
  %.pr65 = load i8, ptr %charPtr.addr.2.ph, align 1
  br label %cleanup
...
entry:
  ...
  store i32 0, ptr @g_page_contents_obj_num, align 4
  store i32 0, ptr @g_page_length_obj_num, align 4
  store i32 0, ptr @g_page_start_offset, align 4
  store float %in_scale_factor, ptr @g_page_v_scale_factor, align 4
  store float %in_scale_factor, ptr @g_page_h_scale_factor, align 4
  store i32 0, ptr @g_page_v_origin, align 4
  store i32 0, ptr @g_page_h_origin, align 4
  store i32 %in_line_width, ptr @g_page_line_width, align 4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) @g_graphics_vars, i8 0, i64 16, i1 false)
  store i32 0, ptr getelementptr inbounds ([7 x i32], ptr @g_units, i64 0, i64 4), align 16
  store i32 0, ptr getelementptr inbounds ([7 x i32], ptr @g_units, i64 0, i64 5), align 4
  store i32 0, ptr getelementptr inbounds ([7 x i32], ptr @g_units, i64 0, i64 6), align 8
  store i1 false, ptr @g_ET_pending, align 4
  store i1 false, ptr @g_TJ_pending, align 4
  store i1 false, ptr @g_valid_text_matrix, align 4
  %entry1.04 = load ptr, ptr @g_font_list, align 8
...
while.body:                                       ; preds = %entry, %while.body
  ...
  store i32 0, ptr %m_in_use, align 4
  %entry1.0 = load ptr, ptr %entry1.06, align 8
  %cmp.not = icmp eq ptr %entry1.0, null
  br i1 %cmp.not, label %while.end, label %while.body

while.end:                                        ; preds = %while.body, %entry
  store ptr null, ptr @g_qsave_stack, align 8
  store ptr null, ptr @g_qsave_marking_stack, align 8
  store i32 0, ptr @g_buffer_pos, align 4
  store i8 0, ptr @g_buffer, align 16
  store i1 true, ptr @g_in_buffering_mode, align 4
  %0 = load i32, ptr @g_page_count, align 4
  %inc = add i32 %0, 1
  store i32 %inc, ptr @g_page_count, align 4
  %call = tail call fastcc i32 @PDFObject_New()
  store i32 %call, ptr @g_page_object_num, align 4
  ret void
}
...
Assert.exit:                                      ; preds = %entry, %if.then2.i
  %2 = load i32, ptr @g_page_contents_obj_num, align 4
...
while.body.i.i:                                   ; preds = %if.then.i.i, %while.body.i.i
  ...
  store ptr %4, ptr @g_qsave_marking_stack, align 8
  tail call void @free(ptr noundef nonnull %3) #21
  %cmp.not.i.i = icmp eq ptr %4, null
  br i1 %cmp.not.i.i, label %while.end.i.i, label %while.body.i.i

while.end.i.i:                                    ; preds = %while.body.i.i
  %.pr.i = load i8, ptr @g_buffer, align 16
...
if.end.i:                                         ; preds = %if.end.i.i.i, %while.end.i.i, %if.then.i.i
  %.pr = load i32, ptr @g_page_contents_obj_num, align 4
...
PDFPage_End.exit:                                 ; preds = %if.then, %if.end.i, %if.then2.i.i
  ...
  %entry6.0232 = load ptr, ptr @g_font_list, align 8
...
if.then.i.i208:                                   ; preds = %if.then.i
  %call.i.i209 = tail call fastcc i32 @PDFObject_New()
  store i32 %call.i.i209, ptr %m_pdf_object_number.i.i, align 4
  br label %PDFFont_WriteObject.exit.i

PDFFont_WriteObject.exit.i:                       ; preds = %if.then.i.i208, %if.then.i
  %12 = phi i32 [ %call.i.i209, %if.then.i.i208 ], [ %11, %if.then.i ]
  ...
  %14 = load ptr, ptr %m_PDF_font_name.i, align 8
  ...
  %15 = load ptr, ptr %m_actual_font_name6.i, align 8
  ...
  %16 = load i32, ptr %m_font_encoding_obj.i, align 8
  %cmp.not.i207 = icmp eq i32 %16, 0
  br i1 %cmp.not.i207, label %if.end17.i, label %if.then13.i

if.then13.i:                                      ; preds = %PDFFont_WriteObject.exit.i
  %17 = tail call i64 @fwrite(ptr nonnull @.str.140, i64 10, i64 1, ptr %in_fp)
  %18 = load i32, ptr %m_font_encoding_obj.i, align 8
...
PDFFont_WriteFontResource.exit:                   ; preds = %while.body, %if.end17.i
  %entry6.0 = load ptr, ptr %entry6.0234, align 8
  %cmp7.not = icmp eq ptr %entry6.0, null
  br i1 %cmp7.not, label %if.end9, label %while.body

if.end9:                                          ; preds = %PDFFont_WriteFontResource.exit, %PDFPage_End.exit, %Assert.exit
  %source.0235 = load ptr, ptr @g_source_annot_list, align 8
...
while.body13.preheader:                           ; preds = %if.end9
  %.pre244 = load i32, ptr @g_page_object_num, align 4
...
while.body13:                                     ; preds = %while.body13.preheader, %if.end17
  ...
  %21 = load i32, ptr %m_this_page_object_num, align 4
...
if.then16:                                        ; preds = %while.body13
  ...
  %.pre = load i32, ptr @g_page_object_num, align 4
  br label %if.end17
...
if.end17:                                         ; preds = %if.then16, %while.body13
  ...
  %source.0 = load ptr, ptr %source.0238, align 8
  %cmp11.not = icmp eq ptr %source.0, null
  br i1 %cmp11.not, label %while.end18, label %while.body13

while.end18:                                      ; preds = %if.end17, %if.end9
  %hasAnnot.0.lcssa = phi i32 [ 0, %if.end9 ], [ %hasAnnot.1, %if.end17 ]
  %23 = load i32, ptr @g_page_count, align 4
  %sub = add i32 %23, -1
  %rem = and i32 %sub, 63
...
if.then31:                                        ; preds = %if.end28
  %25 = load ptr, ptr @g_page_block_list, align 8
  %cmp32.not = icmp eq ptr %25, null
  br i1 %cmp32.not, label %if.end36, label %if.then2.i211

if.then2.i211:                                    ; preds = %if.then31
  %26 = load ptr, ptr @no_fpos, align 8
  %call.i212 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.75, i32 noundef 0, ptr noundef %26, ptr noundef %26) #21
  br label %if.end36

if.else:                                          ; preds = %if.end28
  %27 = load ptr, ptr @g_cur_page_block, align 8
  %cmp34.not = icmp eq ptr %27, null
  br i1 %cmp34.not, label %if.then2.i215, label %if.end36

if.then2.i215:                                    ; preds = %if.else
  %28 = load ptr, ptr @no_fpos, align 8
  %call.i216 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.75, i32 noundef 0, ptr noundef %28, ptr noundef %28) #21
  %.pre245 = load ptr, ptr @g_cur_page_block, align 8
  br label %if.end36

if.end36:                                         ; preds = %if.then2.i215, %if.else, %if.then2.i211, %if.then31
  %.sink = phi ptr [ @g_page_block_list, %if.then31 ], [ @g_page_block_list, %if.then2.i211 ], [ %27, %if.else ], [ %.pre245, %if.then2.i215 ]
  store ptr %call23, ptr %.sink, align 8
  store ptr null, ptr %call23, align 8
  store ptr %call23, ptr @g_cur_page_block, align 8
  br label %if.end45

if.else38:                                        ; preds = %while.end18
  %29 = load ptr, ptr @g_cur_page_block, align 8
  %cmp39.not = icmp eq ptr %29, null
  br i1 %cmp39.not, label %if.then2.i219, label %if.end45

if.then2.i219:                                    ; preds = %if.else38
  %30 = load ptr, ptr @no_fpos, align 8
  %call.i220 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.75, i32 noundef 0, ptr noundef %30, ptr noundef %30) #21
  unreachable

if.end45:                                         ; preds = %if.else38, %if.end36
  %the_block.0 = phi ptr [ %call23, %if.end36 ], [ %29, %if.else38 ]
  %31 = load i32, ptr @g_page_object_num, align 4
  ...
  %33 = load i32, ptr @g_doc_h_bound, align 4
  %34 = load i32, ptr @g_doc_v_bound, align 4
  ...
  %36 = load i32, ptr @g_pages_root, align 4
  ...
  %37 = load i32, ptr @g_page_contents_obj_num, align 4
...
if.then64:                                        ; preds = %if.then60
  %41 = load ptr, ptr @g_font_list, align 8
...
while.body70:                                     ; preds = %if.then64, %if.end74
  ...
  %43 = load i32, ptr %m_in_use, align 4
...
if.then72:                                        ; preds = %while.body70
  ...
  %44 = load ptr, ptr %m_PDF_font_name, align 8
  ...
  %45 = load i32, ptr %m_pdf_object_number.i, align 4
  %cmp.not.i224 = icmp eq i32 %45, 0
  br i1 %cmp.not.i224, label %if.then2.i.i225, label %PDFFont_WriteObjectRef.exit

if.then2.i.i225:                                  ; preds = %if.then72
  %46 = load ptr, ptr @no_fpos, align 8
  %call.i.i226 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.75, i32 noundef 0, ptr noundef %46, ptr noundef %46) #21
  %.pre.i = load i32, ptr %m_pdf_object_number.i, align 4
  br label %PDFFont_WriteObjectRef.exit

PDFFont_WriteObjectRef.exit:                      ; preds = %if.then72, %if.then2.i.i225
  %47 = phi i32 [ %45, %if.then72 ], [ %.pre.i, %if.then2.i.i225 ]
...
if.end74:                                         ; preds = %PDFFont_WriteObjectRef.exit, %while.body70
  %48 = load ptr, ptr %entry65.0240, align 8
  %cmp68.not = icmp eq ptr %48, null
  br i1 %cmp68.not, label %while.end76, label %while.body70
...
if.then99:                                        ; preds = %if.end97
  %54 = load ptr, ptr @g_source_annot_list, align 8
...
if.then109:                                       ; preds = %while.body105
  ...
  %59 = load i32, ptr %m_written_to_PDF_file, align 8
  %tobool111.not = icmp eq i32 %59, 0
  %60 = load ptr, ptr %entry100.0242, align 8
  br i1 %tobool111.not, label %if.end129, label %if.then112

if.then112:                                       ; preds = %if.then109
  %61 = load ptr, ptr @g_source_annot_list, align 8
  %cmp114 = icmp eq ptr %61, %entry100.0242
  br i1 %cmp114, label %if.then116, label %if.end117

if.then116:                                       ; preds = %if.then112
  store ptr %60, ptr @g_source_annot_list, align 8
  br label %if.end117
...
if.then120:                                       ; preds = %if.end117
  store ptr %60, ptr %previous_entry.0243, align 8
  br label %if.end122
...
if.end122:                                        ; preds = %if.then120, %if.end117
  ...
  %62 = load ptr, ptr %m_name.i, align 8
...
if.end.i230:                                      ; preds = %if.then.i229, %if.end122
  ...
  %63 = load ptr, ptr %m_file_spec.i, align 8
...
if.else127:                                       ; preds = %while.body105
  %64 = load ptr, ptr %entry100.0242, align 8
  br label %if.end129
...
if.end129:                                        ; preds = %if.then109, %PDFSourceAnnot_Dispose.exit, %if.else127
  ...
  br i1 %cmp103.not, label %while.end130, label %while.body105
...
entry:
  ...
  %0 = load ptr, ptr @g_obj_offset_list, align 8
...
while.body.i:                                     ; preds = %Assert.exit.i, %Assert.exit21.i
  ...
  br i1 %cmp4.not.i, label %if.then2.i19.i, label %Assert.exit21.i

if.then2.i19.i:                                   ; preds = %while.body.i
  %3 = load ptr, ptr @no_fpos, align 8
  %call.i20.i = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.75, i32 noundef 0, ptr noundef %3, ptr noundef %3) #21
  br label %Assert.exit21.i

Assert.exit21.i:                                  ; preds = %if.then2.i19.i, %while.body.i
  %4 = load ptr, ptr %the_block.028.i, align 8
...
if.then2.i23.i:                                   ; preds = %while.end.i
  %5 = load ptr, ptr @no_fpos, align 8
  %call.i24.i = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.75, i32 noundef 0, ptr noundef %5, ptr noundef %5) #21
...
entry:
  ...
  %1 = load i32, ptr %m_link_type, align 4
...
if.end7:                                          ; preds = %entry
  ...
  %2 = load i32, ptr %m_this_object_num, align 8
  ...
  %7 = load i32, ptr %m_link_type, align 4
...
sw.bb:                                            ; preds = %if.end7
  ...
  %11 = load i32, ptr %m_dest_option, align 8
...
sw.bb16:                                          ; preds = %sw.bb
  ...
  %14 = load i32, ptr %m_ur_y17, align 8
...
sw.bb19:                                          ; preds = %sw.bb
  ...
  %15 = load i32, ptr %m_ll_x20, align 4
...
sw.bb30:                                          ; preds = %sw.bb
  ...
  %21 = load i32, ptr %m_ur_y31, align 8
...
sw.bb33:                                          ; preds = %sw.bb
  ...
  %22 = load i32, ptr %m_ll_x34, align 4
...
sw.bb41:                                          ; preds = %if.end7
  ...
  %27 = load ptr, ptr %m_name42, align 8
...
sw.epilog45:                                      ; preds = %if.end7, %sw.bb41, %sw.bb38, %sw.epilog
  ...
  store i32 1, ptr %m_written_to_PDF_file, align 8
  br label %cleanup
...
entry:
  ...
  store i32 1, ptr @g_next_objnum, align 4
  store ptr null, ptr @g_obj_offset_list, align 8
  store ptr null, ptr @g_cur_obj_offset_block, align 8
  store ptr null, ptr @g_font_list, align 8
  store ptr null, ptr @g_font_encoding_list, align 8
  store i32 0, ptr @g_page_count, align 4
  store ptr null, ptr @g_page_block_list, align 8
  store ptr null, ptr @g_cur_page_block, align 8
  %call2 = tail call fastcc i32 @PDFObject_New()
  store i32 %call2, ptr @g_pages_root, align 4
  store i32 %in_h_bound, ptr @g_doc_h_bound, align 4
  store i32 %in_v_bound, ptr @g_doc_v_bound, align 4
  store ptr null, ptr @g_doc_author, align 8
  store ptr null, ptr @g_doc_title, align 8
  store ptr null, ptr @g_doc_subject, align 8
  store ptr null, ptr @g_doc_keywords, align 8
  store ptr null, ptr @g_target_annot_list, align 8
  store i1 false, ptr @g_has_exported_targets, align 4
  store ptr null, ptr @g_source_annot_list, align 8
  store i32 %in_IN, ptr @g_units, align 16
  store i32 %in_CM, ptr getelementptr inbounds ([7 x i32], ptr @g_units, i64 0, i64 1), align 4
  store i32 %in_PT, ptr getelementptr inbounds ([7 x i32], ptr @g_units, i64 0, i64 2), align 8
  store i32 %in_EM, ptr getelementptr inbounds ([7 x i32], ptr @g_units, i64 0, i64 3), align 4
  ret void
}
...
entry:
  ...
  %str = alloca [512 x i8], align 16
  %source.0232 = load ptr, ptr @g_source_annot_list, align 8
  %cmp.not233 = icmp eq ptr %source.0232, null
  br i1 %cmp.not233, label %while.end, label %while.body

while.body:                                       ; preds = %entry, %if.end
  %source.0234 = phi ptr [ %source.0, %if.end ], [ %source.0232, %entry ]
  %m_target = getelementptr inbounds %struct.t_source_annot_entry, ptr %source.0234, i64 0, i32 1
  %0 = load ptr, ptr %m_target, align 8
...
Assert.exit:                                      ; preds = %while.body, %if.then2.i
  %m_name = getelementptr inbounds %struct.t_source_annot_entry, ptr %source.0234, i64 0, i32 2
...
while.body.i:                                     ; preds = %while.cond.i
  ...
  %3 = load ptr, ptr %m_name.i, align 8
  %call.i207 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %2, ptr noundef nonnull dereferenceable(1) %3) #22
  %cmp2.i = icmp eq i32 %call.i207, 0
  br i1 %cmp2.i, label %if.then, label %while.cond.i

if.then:                                          ; preds = %while.body.i
  store ptr %entry1.0.i, ptr %m_target, align 8
  tail call fastcc void @PDFSourceAnnot_Write(ptr noundef %in_fp, ptr noundef nonnull %source.0234)
  br label %if.end

if.end:                                           ; preds = %while.cond.i, %if.then
  %source.0 = load ptr, ptr %source.0234, align 8
  %cmp.not = icmp eq ptr %source.0, null
  br i1 %cmp.not, label %while.end, label %while.body

while.end:                                        ; preds = %if.end, %entry
  %4 = load ptr, ptr @g_page_block_list, align 8
  %5 = load i32, ptr @g_pages_root, align 4
  ...
  %9 = load i32, ptr @g_page_count, align 4
...
if.then5.i:                                       ; preds = %for.body.i
  %11 = load ptr, ptr %the_block.025.i, align 8
  br label %if.end6.i
...
if.end6.i:                                        ; preds = %if.then5.i, %for.body.i
  ...
  %12 = load i32, ptr @g_page_count, align 4
  %cmp.i = icmp ult i32 %inc.i, %12
  br i1 %cmp.i, label %for.body.i, label %PDFFile_WritePagesObject.exit
...
PDFFile_WritePagesObject.exit:                    ; preds = %if.end6.i, %while.end
  ...
  %13 = load i32, ptr @g_doc_h_bound, align 4
  %14 = load i32, ptr @g_doc_v_bound, align 4
...
if.then5:                                         ; preds = %PDFFile_WritePagesObject.exit
  %16 = load ptr, ptr @g_target_annot_list, align 8
  %cmp7.not = icmp eq ptr %16, null
  br i1 %cmp7.not, label %if.then2.i209, label %Assert.exit211

if.then2.i209:                                    ; preds = %if.then5
  %17 = load ptr, ptr @no_fpos, align 8
  %call.i210 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.75, i32 noundef 0, ptr noundef %17, ptr noundef %17) #21
  br label %Assert.exit211

Assert.exit211:                                   ; preds = %if.then5, %if.then2.i209
  %call.i212 = tail call fastcc i32 @PDFObject_New()
  tail call fastcc void @PDFObject_WriteObj(ptr noundef %in_fp, i32 noundef %call.i212)
  %18 = tail call i64 @fwrite(ptr nonnull @.str.45, i64 3, i64 1, ptr %in_fp)
  br i1 %cmp7.not, label %while.end26, label %while.body18

while.body18:                                     ; preds = %Assert.exit211, %if.end24
  %entry6.0236 = phi ptr [ %23, %if.end24 ], [ %16, %Assert.exit211 ]
  %m_for_export = getelementptr inbounds %struct.t_target_annot_entry, ptr %entry6.0236, i64 0, i32 7
  %19 = load i32, ptr %m_for_export, align 4
  %tobool19.not = icmp eq i32 %19, 0
  br i1 %tobool19.not, label %if.end24, label %if.then20

if.then20:                                        ; preds = %while.body18
  %m_name21 = getelementptr inbounds %struct.t_target_annot_entry, ptr %entry6.0236, i64 0, i32 1
  %20 = load ptr, ptr %m_name21, align 8
  %call22 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %in_fp, ptr noundef nonnull @.str.46, ptr noundef %20)
  %m_page_object_num = getelementptr inbounds %struct.t_target_annot_entry, ptr %entry6.0236, i64 0, i32 2
  %21 = load i32, ptr %m_page_object_num, align 8
  %call.i213 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %in_fp, ptr noundef nonnull @.str.169, i32 noundef %21)
  %22 = tail call i64 @fwrite(ptr nonnull @.str.47, i64 23, i64 1, ptr %in_fp)
  br label %if.end24

if.end24:                                         ; preds = %if.then20, %while.body18
  %23 = load ptr, ptr %entry6.0236, align 8
  %cmp16.not = icmp eq ptr %23, null
  br i1 %cmp16.not, label %while.end26, label %while.body18

while.end26:                                      ; preds = %if.end24, %Assert.exit211
...
if.end32:                                         ; preds = %PDFFile_WritePagesObject.exit, %while.end26
  %dests_obj_num.0 = phi i32 [ %call.i212, %while.end26 ], [ undef, %PDFFile_WritePagesObject.exit ]
  %call.i214 = tail call fastcc i32 @PDFObject_New()
  tail call fastcc void @PDFObject_WriteObj(ptr noundef %in_fp, i32 noundef %call.i214)
  ...
  %28 = load i32, ptr @g_pages_root, align 4
  %call.i215 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %in_fp, ptr noundef nonnull @.str.169, i32 noundef %28)
  %fputc = tail call i32 @fputc(i32 10, ptr %in_fp)
...
if.then39:                                        ; preds = %if.end32
  ...
  %call.i216 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %in_fp, ptr noundef nonnull @.str.169, i32 noundef %dests_obj_num.0)
...
if.end42:                                         ; preds = %if.then39, %if.end32
  ...
  %call.i217 = tail call fastcc i32 @PDFObject_New()
  tail call fastcc void @PDFObject_WriteObj(ptr noundef %in_fp, i32 noundef %call.i217)
  ...
  store i64 %call52, ptr %now, align 8
  ...
  %33 = load ptr, ptr @g_doc_author, align 8
...
if.end59:                                         ; preds = %if.then57, %if.end42
  %34 = load ptr, ptr @g_doc_title, align 8
...
if.end64:                                         ; preds = %if.then62, %if.end59
  %35 = load ptr, ptr @g_doc_subject, align 8
...
if.end69:                                         ; preds = %if.then67, %if.end64
  %36 = load ptr, ptr @g_doc_keywords, align 8
...
if.end74:                                         ; preds = %if.then72, %if.end69
  ...
  %42 = load i32, ptr @g_next_objnum, align 4
  %cmp.i218 = icmp ne i32 %42, 1
  %cmp6.i = icmp eq ptr %38, null
  %.not.i = select i1 %cmp.i218, i1 %cmp6.i, i1 false
  br i1 %.not.i, label %if.then2.i.i, label %Assert.exit.i

if.then2.i.i:                                     ; preds = %if.end74
  %43 = load ptr, ptr @no_fpos, align 8
  %call.i.i224 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.75, i32 noundef 0, ptr noundef %43, ptr noundef %43) #21
  %.pre.i = load i32, ptr @g_next_objnum, align 4
  br label %Assert.exit.i

Assert.exit.i:                                    ; preds = %if.then2.i.i, %if.end74
  %44 = phi i32 [ %42, %if.end74 ], [ %.pre.i, %if.then2.i.i ]
  %cmp842.i = icmp ugt i32 %44, 1
  br i1 %cmp842.i, label %for.body.i219, label %PDFFile_WriteXREF.exit

for.body.i219:                                    ; preds = %Assert.exit.i, %if.end28.i
  ...
  %idxprom.i220 = zext i32 %rem.urem.i to i64
  %arrayidx.i221 = getelementptr inbounds %struct.t_offset_block, ptr %the_block.043.i, i64 0, i32 1, i64 %idxprom.i220
  %45 = load i32, ptr %arrayidx.i221, align 4
  %call10.i = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %in_fp, ptr noundef nonnull @.str.179, i32 noundef %45)
  %46 = load i32, ptr %arrayidx.i221, align 4
  %cmp14.i = icmp eq i32 %46, 0
  br i1 %cmp14.i, label %if.then16.i, label %if.end24.i

if.then16.i:                                      ; preds = %for.body.i219
  call void @llvm.lifetime.start.p0(i64 512, ptr nonnull %str.i) #21
...
if.end28.i:                                       ; preds = %if.then27.i, %if.end24.i
  ...
  %49 = load i32, ptr @g_next_objnum, align 4
  %cmp8.i = icmp ult i32 %inc.i223, %49
  br i1 %cmp8.i, label %for.body.i219, label %PDFFile_WriteXREF.exit
...
PDFFile_WriteXREF.exit:                           ; preds = %if.end28.i, %Assert.exit.i
  ...
  %51 = load i32, ptr @g_next_objnum, align 4
  ...
  %call.i225 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %in_fp, ptr noundef nonnull @.str.169, i32 noundef %call.i214)
  %53 = call i64 @fwrite(ptr nonnull @.str.64, i64 7, i64 1, ptr %in_fp)
  %call.i226 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %in_fp, ptr noundef nonnull @.str.169, i32 noundef %call.i217)
  ...
  %.pr = load ptr, ptr @g_obj_offset_list, align 8
  %cmp84.not237 = icmp eq ptr %.pr, null
  br i1 %cmp84.not237, label %while.cond88.preheader, label %while.body86

while.cond88.preheader:                           ; preds = %while.body86, %PDFFile_WriteXREF.exit
  %55 = load ptr, ptr @g_font_encoding_list, align 8
  %cmp89.not238 = icmp eq ptr %55, null
  br i1 %cmp89.not238, label %while.cond95.preheader, label %while.body91

while.body86:                                     ; preds = %PDFFile_WriteXREF.exit, %while.body86
  %56 = phi ptr [ %57, %while.body86 ], [ %.pr, %PDFFile_WriteXREF.exit ]
  %57 = load ptr, ptr %56, align 8
  store ptr %57, ptr @g_obj_offset_list, align 8
  call void @free(ptr noundef nonnull %56) #21
  %cmp84.not = icmp eq ptr %57, null
  br i1 %cmp84.not, label %while.cond88.preheader, label %while.body86

while.cond95.preheader:                           ; preds = %while.body91, %while.cond88.preheader
  %58 = load ptr, ptr @g_font_list, align 8
  %cmp96.not239 = icmp eq ptr %58, null
  br i1 %cmp96.not239, label %while.cond101thread-pre-split, label %while.body98

while.body91:                                     ; preds = %while.cond88.preheader, %while.body91
  %59 = phi ptr [ %62, %while.body91 ], [ %55, %while.cond88.preheader ]
  %60 = load ptr, ptr %59, align 8
  store ptr %60, ptr @g_font_encoding_list, align 8
  %m_font_encoding = getelementptr inbounds %struct.t_font_encoding_entry, ptr %59, i64 0, i32 2
  %61 = load ptr, ptr %m_font_encoding, align 8
  call void @free(ptr noundef %61) #21
  call void @free(ptr noundef nonnull %59) #21
  %62 = load ptr, ptr @g_font_encoding_list, align 8
  %cmp89.not = icmp eq ptr %62, null
  br i1 %cmp89.not, label %while.cond95.preheader, label %while.body91

while.body98:                                     ; preds = %while.cond95.preheader, %while.body98
  %63 = phi ptr [ %68, %while.body98 ], [ %58, %while.cond95.preheader ]
  %64 = load ptr, ptr %63, align 8
  store ptr %64, ptr @g_font_list, align 8
  %m_PDF_font_name = getelementptr inbounds %struct.t_font_list_entry, ptr %63, i64 0, i32 1
  %65 = load ptr, ptr %m_PDF_font_name, align 8
  call void @free(ptr noundef %65) #21
  %m_short_font_name = getelementptr inbounds %struct.t_font_list_entry, ptr %63, i64 0, i32 2
  %66 = load ptr, ptr %m_short_font_name, align 8
  call void @free(ptr noundef %66) #21
  %m_actual_font_name = getelementptr inbounds %struct.t_font_list_entry, ptr %63, i64 0, i32 3
  %67 = load ptr, ptr %m_actual_font_name, align 8
  call void @free(ptr noundef %67) #21
  call void @free(ptr noundef nonnull %63) #21
  %68 = load ptr, ptr @g_font_list, align 8
  %cmp96.not = icmp eq ptr %68, null
  br i1 %cmp96.not, label %while.cond101thread-pre-split, label %while.body98

while.cond101thread-pre-split:                    ; preds = %while.body98, %while.cond95.preheader
  %.pr229 = load ptr, ptr @g_page_block_list, align 8
  %cmp102.not240 = icmp eq ptr %.pr229, null
  br i1 %cmp102.not240, label %while.cond108thread-pre-split, label %while.body104

while.body104:                                    ; preds = %while.cond101thread-pre-split, %while.body104
  %69 = phi ptr [ %70, %while.body104 ], [ %.pr229, %while.cond101thread-pre-split ]
  %70 = load ptr, ptr %69, align 8
  store ptr %70, ptr @g_page_block_list, align 8
  call void @free(ptr noundef nonnull %69) #21
  %cmp102.not = icmp eq ptr %70, null
  br i1 %cmp102.not, label %while.cond108thread-pre-split, label %while.body104

while.cond108thread-pre-split:                    ; preds = %while.body104, %while.cond101thread-pre-split
  %.pr230 = load ptr, ptr @g_source_annot_list, align 8
  %cmp109.not241 = icmp eq ptr %.pr230, null
  br i1 %cmp109.not241, label %while.cond126.preheader, label %while.body111

while.cond126.preheader:                          ; preds = %PDFSourceAnnot_Dispose.exit, %while.cond108thread-pre-split
  %71 = load ptr, ptr @g_target_annot_list, align 8
  %cmp127.not242 = icmp eq ptr %71, null
  br i1 %cmp127.not242, label %while.end133, label %while.body129

while.body111:                                    ; preds = %while.cond108thread-pre-split, %PDFSourceAnnot_Dispose.exit
  %72 = phi ptr [ %76, %PDFSourceAnnot_Dispose.exit ], [ %.pr230, %while.cond108thread-pre-split ]
  %m_target113 = getelementptr inbounds %struct.t_source_annot_entry, ptr %72, i64 0, i32 1
  %73 = load ptr, ptr %m_target113, align 8
...
if.then116:                                       ; preds = %while.body111
  ...
  %74 = load ptr, ptr %m_name119, align 8
...
if.end123:                                        ; preds = %if.then116, %while.body111
  ...
  %m_name.i227 = getelementptr inbounds %struct.t_source_annot_entry, ptr %72, i64 0, i32 2
  %77 = load ptr, ptr %m_name.i227, align 8
  %cmp.not.i228 = icmp eq ptr %77, null
  br i1 %cmp.not.i228, label %if.end.i, label %if.then.i
...
if.end.i:                                         ; preds = %if.then.i, %if.end123
  ...
  %78 = load ptr, ptr %m_file_spec.i, align 8
...
while.body12:                                     ; preds = %while.cond2, %while.body12
  ...
  %.pr = load i8, ptr %incdec.ptr13, align 1
...
while.end14:                                      ; preds = %while.cond2, %while.body12
  ...
  %or.cond198 = or i1 %cmp23, %tobool21.not
...
while.cond.i:                                     ; preds = %while.cond.i, %while.cond.preheader.i
  ...
  %8 = load i8, ptr %in_str.addr.0.i, align 1
...
while.cond11.i:                                   ; preds = %while.cond11.i.preheader, %while.cond11.i
  ...
  %11 = load i8, ptr %in_str.addr.2.i, align 1
  ...
  br i1 %or.cond.i, label %while.cond11.i, label %if.end147
...
if.then29:                                        ; preds = %if.else
  ...
  %15 = load float, ptr %val, align 4
  %fneg = fneg float %15
  store float %fneg, ptr %outValue, align 4
...
while.cond40:                                     ; preds = %while.cond40, %if.then36
  ...
  br i1 %tobool47.not, label %while.end50, label %while.cond40
...
if.then66:                                        ; preds = %if.end
  %22 = load float, ptr %val1, align 4
...
do.cond:                                          ; preds = %if.end78, %do.cond
  ...
  %27 = load i8, ptr %call80256, align 1
  %cmp84 = icmp eq i8 %27, 44
  %spec.select.idx = zext i1 %cmp84 to i64
  %spec.select = getelementptr inbounds i8, ptr %call80256, i64 %spec.select.idx
...
sw.bb:                                            ; preds = %if.end97
  ...
  %31 = load float, ptr %val2, align 4
  %add = fadd float %30, %31
  br label %sw.epilog.sink.split

sw.bb99:                                          ; preds = %if.end97
  %32 = load float, ptr %val1, align 4
  %33 = load float, ptr %val2, align 4
  %sub = fsub float %32, %33
  br label %sw.epilog.sink.split

sw.bb100:                                         ; preds = %if.end97
  %34 = load float, ptr %val1, align 4
  %35 = load float, ptr %val2, align 4
  %mul = fmul float %34, %35
  br label %sw.epilog.sink.split

sw.bb101:                                         ; preds = %if.end97
  %36 = load float, ptr %val2, align 4
  %cmp102 = fcmp oeq float %36, 0.000000e+00
  br i1 %cmp102, label %if.then2.i204, label %Assert.exit206

if.then2.i204:                                    ; preds = %sw.bb101
  %37 = load ptr, ptr @no_fpos, align 8
  %call.i205 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.75, i32 noundef 0, ptr noundef %37, ptr noundef %37) #21
  %.pre = load float, ptr %val2, align 4
  br label %Assert.exit206

Assert.exit206:                                   ; preds = %sw.bb101, %if.then2.i204
  %38 = phi float [ %36, %sw.bb101 ], [ %.pre, %if.then2.i204 ]
  %39 = load float, ptr %val1, align 4
  %div = fdiv float %39, %38
  br label %sw.epilog.sink.split

sw.bb104:                                         ; preds = %if.end97
  %40 = load float, ptr %val1, align 4
...
sw.bb110:                                         ; preds = %if.end97
  %41 = load float, ptr %val1, align 4
...
sw.bb116:                                         ; preds = %if.end97
  %42 = load float, ptr %val2, align 4
  br label %sw.epilog.sink.split
...
sw.epilog.sink.split:                             ; preds = %sw.bb, %sw.bb99, %sw.bb100, %Assert.exit206, %sw.bb104, %sw.bb110, %sw.bb116
  ...
  store float %.sink, ptr %outValue, align 4
  br label %sw.epilog
...
if.else117:                                       ; preds = %for.inc.i.5
  %bcmp.i212 = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(5) @.str.109, ptr noundef nonnull dereferenceable(5) %chp.2.lcssa, i64 5)
  %cmp5.i213 = icmp eq i32 %bcmp.i212, 0
  br i1 %cmp5.i213, label %if.then121, label %for.inc.i214

for.inc.i214:                                     ; preds = %if.else117
  %bcmp.i212.1 = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(5) @.str.110, ptr noundef nonnull dereferenceable(5) %chp.2.lcssa, i64 5)
  %cmp5.i213.1 = icmp eq i32 %bcmp.i212.1, 0
  br i1 %cmp5.i213.1, label %if.then121, label %for.inc.i214.1

for.inc.i214.1:                                   ; preds = %for.inc.i214
  %bcmp.i212.2 = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(5) @.str.111, ptr noundef nonnull dereferenceable(5) %chp.2.lcssa, i64 5)
  %cmp5.i213.2 = icmp eq i32 %bcmp.i212.2, 0
  br i1 %cmp5.i213.2, label %if.then121, label %for.inc.i214.2

for.inc.i214.2:                                   ; preds = %for.inc.i214.1
  %bcmp.i212.3 = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(5) @.str.112, ptr noundef nonnull dereferenceable(5) %chp.2.lcssa, i64 5)
  %cmp5.i213.3 = icmp eq i32 %bcmp.i212.3, 0
  br i1 %cmp5.i213.3, label %if.then121, label %if.else129

if.then121:                                       ; preds = %if.else117, %for.inc.i214, %for.inc.i214.1, %for.inc.i214.2
  %indvars.iv.i208.lcssa = phi i64 [ 0, %if.else117 ], [ 1, %for.inc.i214 ], [ 2, %for.inc.i214.1 ], [ 3, %for.inc.i214.2 ]
  %arrayidx123 = getelementptr inbounds [4 x ptr], ptr @g_graphic_keywords, i64 0, i64 %indvars.iv.i208.lcssa
  ...
  %arrayidx127 = getelementptr inbounds [4 x i32], ptr @g_graphics_vars, i64 0, i64 %indvars.iv.i208.lcssa
  %44 = load i32, ptr %arrayidx127, align 4
  %conv128 = sitofp i32 %44 to float
  store float %conv128, ptr %outValue, align 4
  br label %if.end147

if.else129:                                       ; preds = %for.inc.i214.2
  %bcmp.i225 = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(2) @.str.87, ptr noundef nonnull dereferenceable(2) %chp.2.lcssa, i64 2)
  %cmp5.i226 = icmp eq i32 %bcmp.i225, 0
  br i1 %cmp5.i226, label %if.then133, label %for.inc.i227

for.inc.i227:                                     ; preds = %if.else129
  %bcmp.i225.1 = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(2) @.str.88, ptr noundef nonnull dereferenceable(2) %chp.2.lcssa, i64 2)
  %cmp5.i226.1 = icmp eq i32 %bcmp.i225.1, 0
  br i1 %cmp5.i226.1, label %if.then133, label %for.inc.i227.1

for.inc.i227.1:                                   ; preds = %for.inc.i227
  %bcmp.i225.2 = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(2) @.str.89, ptr noundef nonnull dereferenceable(2) %chp.2.lcssa, i64 2)
  %cmp5.i226.2 = icmp eq i32 %bcmp.i225.2, 0
  br i1 %cmp5.i226.2, label %if.then133, label %for.inc.i227.2

for.inc.i227.2:                                   ; preds = %for.inc.i227.1
  %bcmp.i225.3 = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(2) @.str.90, ptr noundef nonnull dereferenceable(2) %chp.2.lcssa, i64 2)
  %cmp5.i226.3 = icmp eq i32 %bcmp.i225.3, 0
  br i1 %cmp5.i226.3, label %if.then133, label %for.inc.i227.3

for.inc.i227.3:                                   ; preds = %for.inc.i227.2
  %bcmp.i225.4 = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(5) @.str.91, ptr noundef nonnull dereferenceable(5) %chp.2.lcssa, i64 5)
  %cmp5.i226.4 = icmp eq i32 %bcmp.i225.4, 0
  br i1 %cmp5.i226.4, label %if.then133, label %for.inc.i227.4

for.inc.i227.4:                                   ; preds = %for.inc.i227.3
  %bcmp.i225.5 = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(5) @.str.92, ptr noundef nonnull dereferenceable(5) %chp.2.lcssa, i64 5)
  %cmp5.i226.5 = icmp eq i32 %bcmp.i225.5, 0
  br i1 %cmp5.i226.5, label %if.then133, label %for.inc.i227.5

for.inc.i227.5:                                   ; preds = %for.inc.i227.4
  %bcmp.i225.6 = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(5) @.str.93, ptr noundef nonnull dereferenceable(5) %chp.2.lcssa, i64 5)
  %cmp5.i226.6 = icmp eq i32 %bcmp.i225.6, 0
  br i1 %cmp5.i226.6, label %if.then133, label %if.else141

if.then133:                                       ; preds = %if.else129, %for.inc.i227, %for.inc.i227.1, %for.inc.i227.2, %for.inc.i227.3, %for.inc.i227.4, %for.inc.i227.5
  %indvars.iv.i221.lcssa = phi i64 [ 0, %if.else129 ], [ 1, %for.inc.i227 ], [ 2, %for.inc.i227.1 ], [ 3, %for.inc.i227.2 ], [ 4, %for.inc.i227.3 ], [ 5, %for.inc.i227.4 ], [ 6, %for.inc.i227.5 ]
  %reltable.shift = shl i64 %indvars.iv.i221.lcssa, 2
  ...
  %arrayidx139 = getelementptr inbounds [7 x i32], ptr @g_units, i64 0, i64 %indvars.iv.i221.lcssa
  %45 = load i32, ptr %arrayidx139, align 4
  %conv140 = sitofp i32 %45 to float
  store float %conv140, ptr %outValue, align 4
  br label %if.end147

if.else141:                                       ; preds = %for.inc.i227.5
  %46 = load ptr, ptr @no_fpos, align 8
...
while.body.i:                                     ; preds = %while.cond.i
  ...
  br i1 %cmp2.i, label %if.then11, label %while.cond.i
...
if.else:                                          ; preds = %while.cond.i, %Assert.exit
  ...
  store ptr null, ptr %m_target12, align 8
  ...
  store ptr %call13, ptr %m_name14, align 8
...
if.end24:                                         ; preds = %if.end20, %if.then11
  %5 = load ptr, ptr @g_source_annot_list, align 8
  store ptr %5, ptr %call, align 8
  store ptr %call, ptr @g_source_annot_list, align 8
  ret ptr %call
}
...
entry:
  %0 = load i32, ptr @g_next_objnum, align 4
  %sub = add i32 %0, -1
  %rem = and i32 %sub, 255
...
if.then6:                                         ; preds = %if.end
  %2 = load ptr, ptr @g_obj_offset_list, align 8
...
if.else:                                          ; preds = %if.end
  %4 = load ptr, ptr @g_cur_obj_offset_block, align 8
  %cmp8.not = icmp eq ptr %4, null
  br i1 %cmp8.not, label %if.then2.i25, label %if.end10

if.then2.i25:                                     ; preds = %if.else
  %5 = load ptr, ptr @no_fpos, align 8
  %call.i26 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.75, i32 noundef 0, ptr noundef %5, ptr noundef %5) #21
  %.pre = load ptr, ptr @g_cur_obj_offset_block, align 8
  br label %if.end10
...
if.end10:                                         ; preds = %if.then2.i25, %if.else, %if.then2.i, %if.then6
  ...
  store ptr %call, ptr @g_cur_obj_offset_block, align 8
  br label %if.end15

if.else12:                                        ; preds = %entry
  %6 = load ptr, ptr @g_cur_obj_offset_block, align 8
  %cmp13.not = icmp eq ptr %6, null
  br i1 %cmp13.not, label %if.then2.i29, label %if.end15

if.then2.i29:                                     ; preds = %if.else12
  %7 = load ptr, ptr @no_fpos, align 8
  %call.i30 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str.75, i32 noundef 0, ptr noundef %7, ptr noundef %7) #21
  unreachable
...
if.end15:                                         ; preds = %if.else12, %if.end10
  ...
  %inc = add i32 %8, 1
  store i32 %inc, ptr @g_next_objnum, align 4
  ret i32 %8
}
