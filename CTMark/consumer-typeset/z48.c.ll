...
while.cond.i5:                                    ; preds = %entry, %while.body.i8
  ...
  %entry1.0.i7 = load ptr, ptr %entry1.0.in.i6, align 8, !tbaa !5
...
while.body.i8:                                    ; preds = %while.cond.i5
  ...
  br i1 %cmp3.i, label %cond.true.i, label %while.cond.i5, !llvm.loop !14
...
while.cond.i10:                                   ; preds = %while.cond.i10, %PDFFont_FindFontEncoding.exit
  ...
  br i1 %cmp.not.i11, label %while.end.i, label %while.cond.i10, !llvm.loop !16
...
while.body.i:                                     ; preds = %if.then.i224, %while.body.i
  ...
  br i1 %cmp.not.i225, label %while.end.i, label %while.body.i, !llvm.loop !31
...
if.else.i:                                        ; preds = %while.end25.i
  ...
  %25 = load float, ptr @g_page_h_scale_factor, align 4, !tbaa !27
  %26 = load i32, ptr @g_page_v_origin, align 4, !tbaa !25
  %27 = load float, ptr @g_page_v_scale_factor, align 4, !tbaa !27
  %28 = load <2 x i32>, ptr @g_graphics_vars, align 16, !tbaa !25
...
if.then.i.i208:                                   ; preds = %if.then.i
  ...
  store i32 %call.i.i209, ptr %m_pdf_object_number.i.i, align 4, !tbaa !22
...
entry:
  ...
  %str = alloca [512 x i8], align 16
  %source.0232 = load ptr, ptr @g_source_annot_list, align 8, !tbaa !5
...
if.end:                                           ; preds = %while.cond.i, %if.then
  %source.0 = load ptr, ptr %source.0234, align 8, !tbaa !5
...
if.end24:                                         ; preds = %if.then20, %while.body18
  %23 = load ptr, ptr %entry6.0236, align 8, !tbaa !53
...
if.end28.i:                                       ; preds = %if.then27.i, %if.end24.i
  ...
  br i1 %cmp8.i, label %for.body.i219, label %PDFFile_WriteXREF.exit, !llvm.loop !86
...
while.cond101thread-pre-split:                    ; preds = %while.body98, %while.cond95.preheader
  %.pr229 = load ptr, ptr @g_page_block_list, align 8, !tbaa !5
...
while.cond108thread-pre-split:                    ; preds = %while.body104, %while.cond101thread-pre-split
  %.pr230 = load ptr, ptr @g_source_annot_list, align 8, !tbaa !5
...
if.end123:                                        ; preds = %if.then116, %while.body111
  ...
  %77 = load ptr, ptr %m_name.i227, align 8, !tbaa !64
