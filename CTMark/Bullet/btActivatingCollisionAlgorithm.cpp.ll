; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btActivatingCollisionAlgorithm.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btActivatingCollisionAlgorithm.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [7 x ptr] }, ptr @_ZTV30btActivatingCollisionAlgorithm, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !5
  ret void
}
...
; Function Attrs: uwtable
define dso_local void @_ZN30btActivatingCollisionAlgorithmC2ERK36btCollisionAlgorithmConstructionInfoP17btCollisionObjectS4_(ptr noundef nonnull align 8 dereferenceable(16) %this, ptr noundef nonnull align 8 dereferenceable(16) %ci, ptr nocapture noundef readnone %colObj0, ptr nocapture noundef readnone %colObj1) unnamed_addr #0 align 2 {
entry:
  tail call void @_ZN20btCollisionAlgorithmC2ERK36btCollisionAlgorithmConstructionInfo(ptr noundef nonnull align 8 dereferenceable(16) %this, ptr noundef nonnull align 8 dereferenceable(16) %ci)
  store ptr getelementptr inbounds ({ [7 x ptr] }, ptr @_ZTV30btActivatingCollisionAlgorithm, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !5
  ret void
