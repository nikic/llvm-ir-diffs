; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btOverlappingPairCache.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btOverlappingPairCache.cpp"
...
if.then.i:
  store ptr getelementptr inbounds ({ [19 x ptr] }, ptr @_ZTV28btHashedOverlappingPairCache, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  ...
  %2 = load <2 x ptr>, ptr %arrayidx3.i.i, align 8
  store <2 x ptr> %2, ptr %arrayidx.i.i, align 8
  ...
  %3 = load ptr, ptr %m_algorithm4.i.i.i, align 8
  store ptr %3, ptr %m_algorithm.i.i.i, align 8
...
invoke.cont8:                                     ; preds = %if.then3.i.i, %_ZNK20btAlignedObjectArrayI16btBroadphasePairE4copyEiiPS0_.exit.i
  store i8 1, ptr %m_ownsMemory.i.i, align 8
  store ptr %call.i.i.i32, ptr %m_data.i.i, align 8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load128 = load <4 x i32>, ptr %9, align 4
  store <4 x i32> %wide.load, ptr %7, align 4
  %10 = getelementptr inbounds i32, ptr %7, i64 4
  store <4 x i32> %wide.load128, ptr %10, align 4
...
for.body10.lr.ph.i:                               ; preds = %if.then5.i.for.body10.lr.ph.i_crit_edge, %if.end.i, %if.end.thread36.i
  ...
  %26 = load i32, ptr %m_size.i.i54, align 4
  %cmp4.i57 = icmp slt i32 %26, %0
  br i1 %cmp4.i57, label %if.then5.i58, label %_ZN20btAlignedObjectArrayIiE6resizeEiRKi.exit98

if.then5.i58:                                     ; preds = %for.body10.lr.ph.i
  %m_capacity.i.i.i59 = getelementptr inbounds %class.btHashedOverlappingPairCache, ptr %this, i64 0, i32 6, i32 3
  %27 = load i32, ptr %m_capacity.i.i.i59, align 8
  %cmp.i.i60 = icmp slt i32 %27, %0
  br i1 %cmp.i.i60, label %if.then.i.i69, label %if.then5.i58.for.body10.lr.ph.i61_crit_edge

if.then5.i58.for.body10.lr.ph.i61_crit_edge:      ; preds = %if.then5.i58
  %m_data11.i62.phi.trans.insert = getelementptr inbounds %class.btHashedOverlappingPairCache, ptr %this, i64 0, i32 6, i32 5
  %.pre126 = load ptr, ptr %m_data11.i62.phi.trans.insert, align 8
  br label %for.body10.lr.ph.i61

if.then.i.i69:                                    ; preds = %if.then5.i58
  %tobool.not.i.i.i70 = icmp eq i32 %0, 0
  br i1 %tobool.not.i.i.i70, label %_ZN20btAlignedObjectArrayIiE8allocateEi.exit.i.i76, label %if.then.i.i.i71

if.then.i.i.i71:                                  ; preds = %if.then.i.i69
  %call.i.i.i.i74 = tail call noundef ptr @_Z22btAlignedAllocInternalmi(i64 noundef %24, i32 noundef 16)
  %.pre.i75 = load i32, ptr %m_size.i.i54, align 4
  br label %_ZN20btAlignedObjectArrayIiE8allocateEi.exit.i.i76

_ZN20btAlignedObjectArrayIiE8allocateEi.exit.i.i76: ; preds = %if.then.i.i.i71, %if.then.i.i69
  %28 = phi i32 [ %.pre.i75, %if.then.i.i.i71 ], [ %26, %if.then.i.i69 ]
  %retval.0.i.i.i77 = phi ptr [ %call.i.i.i.i74, %if.then.i.i.i71 ], [ null, %if.then.i.i69 ]
  %cmp7.i.i.i78 = icmp sgt i32 %28, 0
  %m_data.i.i.i79 = getelementptr inbounds %class.btHashedOverlappingPairCache, ptr %this, i64 0, i32 6, i32 5
  %29 = load ptr, ptr %m_data.i.i.i79, align 8
  br i1 %cmp7.i.i.i78, label %for.body.lr.ph.i.i.i90, label %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i80

for.body.lr.ph.i.i.i90:                           ; preds = %_ZN20btAlignedObjectArrayIiE8allocateEi.exit.i.i76
  %30 = ptrtoint ptr %29 to i64
  %retval.0.i.i.i77130 = ptrtoint ptr %retval.0.i.i.i77 to i64
  %wide.trip.count.i.i.i91 = zext i32 %28 to i64
  %min.iters.check134 = icmp ult i32 %28, 8
  %31 = sub i64 %retval.0.i.i.i77130, %30
  %diff.check131 = icmp ult i64 %31, 32
  %or.cond145 = select i1 %min.iters.check134, i1 true, i1 %diff.check131
  br i1 %or.cond145, label %for.body.i.i.i92.preheader, label %vector.ph135

vector.ph135:                                     ; preds = %for.body.lr.ph.i.i.i90
  %n.vec137 = and i64 %wide.trip.count.i.i.i91, 4294967288
...
vector.body140:                                   ; preds = %vector.body140, %vector.ph135
  ...
  %32 = getelementptr inbounds i32, ptr %retval.0.i.i.i77, i64 %index141
  %33 = getelementptr inbounds i32, ptr %29, i64 %index141
  %wide.load142 = load <4 x i32>, ptr %33, align 4
  %34 = getelementptr inbounds i32, ptr %33, i64 4
  %wide.load143 = load <4 x i32>, ptr %34, align 4
  store <4 x i32> %wide.load142, ptr %32, align 4
  %35 = getelementptr inbounds i32, ptr %32, i64 4
  store <4 x i32> %wide.load143, ptr %35, align 4
  %index.next144 = add nuw i64 %index141, 8
  %36 = icmp eq i64 %index.next144, %n.vec137
  br i1 %36, label %middle.block132, label %vector.body140

middle.block132:                                  ; preds = %vector.body140
  %cmp.n139 = icmp eq i64 %n.vec137, %wide.trip.count.i.i.i91
  br i1 %cmp.n139, label %if.then.i11.i.i82, label %for.body.i.i.i92.preheader

for.body.i.i.i92.preheader:                       ; preds = %for.body.lr.ph.i.i.i90, %middle.block132
  %indvars.iv.i.i.i93.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i90 ], [ %n.vec137, %middle.block132 ]
  %37 = xor i64 %indvars.iv.i.i.i93.ph, -1
  %38 = add nsw i64 %37, %wide.trip.count.i.i.i91
  %xtraiter146 = and i64 %wide.trip.count.i.i.i91, 3
  %lcmp.mod147.not = icmp eq i64 %xtraiter146, 0
  br i1 %lcmp.mod147.not, label %for.body.i.i.i92.prol.loopexit, label %for.body.i.i.i92.prol

for.body.i.i.i92.prol:                            ; preds = %for.body.i.i.i92.preheader, %for.body.i.i.i92.prol
  %indvars.iv.i.i.i93.prol = phi i64 [ %indvars.iv.next.i.i.i96.prol, %for.body.i.i.i92.prol ], [ %indvars.iv.i.i.i93.ph, %for.body.i.i.i92.preheader ]
  %prol.iter148 = phi i64 [ %prol.iter148.next, %for.body.i.i.i92.prol ], [ 0, %for.body.i.i.i92.preheader ]
  %arrayidx.i.i.i94.prol = getelementptr inbounds i32, ptr %retval.0.i.i.i77, i64 %indvars.iv.i.i.i93.prol
  %arrayidx3.i.i.i95.prol = getelementptr inbounds i32, ptr %29, i64 %indvars.iv.i.i.i93.prol
  %39 = load i32, ptr %arrayidx3.i.i.i95.prol, align 4
  store i32 %39, ptr %arrayidx.i.i.i94.prol, align 4
  %indvars.iv.next.i.i.i96.prol = add nuw nsw i64 %indvars.iv.i.i.i93.prol, 1
  %prol.iter148.next = add i64 %prol.iter148, 1
  %prol.iter148.cmp.not = icmp eq i64 %prol.iter148.next, %xtraiter146
  br i1 %prol.iter148.cmp.not, label %for.body.i.i.i92.prol.loopexit, label %for.body.i.i.i92.prol

for.body.i.i.i92.prol.loopexit:                   ; preds = %for.body.i.i.i92.prol, %for.body.i.i.i92.preheader
  %indvars.iv.i.i.i93.unr = phi i64 [ %indvars.iv.i.i.i93.ph, %for.body.i.i.i92.preheader ], [ %indvars.iv.next.i.i.i96.prol, %for.body.i.i.i92.prol ]
  %40 = icmp ult i64 %38, 3
  br i1 %40, label %if.then.i11.i.i82, label %for.body.i.i.i92

for.body.i.i.i92:                                 ; preds = %for.body.i.i.i92.prol.loopexit, %for.body.i.i.i92
  %indvars.iv.i.i.i93 = phi i64 [ %indvars.iv.next.i.i.i96.3, %for.body.i.i.i92 ], [ %indvars.iv.i.i.i93.unr, %for.body.i.i.i92.prol.loopexit ]
  %arrayidx.i.i.i94 = getelementptr inbounds i32, ptr %retval.0.i.i.i77, i64 %indvars.iv.i.i.i93
  %arrayidx3.i.i.i95 = getelementptr inbounds i32, ptr %29, i64 %indvars.iv.i.i.i93
  %41 = load i32, ptr %arrayidx3.i.i.i95, align 4
  store i32 %41, ptr %arrayidx.i.i.i94, align 4
  %indvars.iv.next.i.i.i96 = add nuw nsw i64 %indvars.iv.i.i.i93, 1
  %arrayidx.i.i.i94.1 = getelementptr inbounds i32, ptr %retval.0.i.i.i77, i64 %indvars.iv.next.i.i.i96
  %arrayidx3.i.i.i95.1 = getelementptr inbounds i32, ptr %29, i64 %indvars.iv.next.i.i.i96
  %42 = load i32, ptr %arrayidx3.i.i.i95.1, align 4
  store i32 %42, ptr %arrayidx.i.i.i94.1, align 4
  %indvars.iv.next.i.i.i96.1 = add nuw nsw i64 %indvars.iv.i.i.i93, 2
  %arrayidx.i.i.i94.2 = getelementptr inbounds i32, ptr %retval.0.i.i.i77, i64 %indvars.iv.next.i.i.i96.1
  %arrayidx3.i.i.i95.2 = getelementptr inbounds i32, ptr %29, i64 %indvars.iv.next.i.i.i96.1
  %43 = load i32, ptr %arrayidx3.i.i.i95.2, align 4
  store i32 %43, ptr %arrayidx.i.i.i94.2, align 4
  %indvars.iv.next.i.i.i96.2 = add nuw nsw i64 %indvars.iv.i.i.i93, 3
  %arrayidx.i.i.i94.3 = getelementptr inbounds i32, ptr %retval.0.i.i.i77, i64 %indvars.iv.next.i.i.i96.2
  %arrayidx3.i.i.i95.3 = getelementptr inbounds i32, ptr %29, i64 %indvars.iv.next.i.i.i96.2
  %44 = load i32, ptr %arrayidx3.i.i.i95.3, align 4
  store i32 %44, ptr %arrayidx.i.i.i94.3, align 4
  %indvars.iv.next.i.i.i96.3 = add nuw nsw i64 %indvars.iv.i.i.i93, 4
  %exitcond.not.i.i.i97.3 = icmp eq i64 %indvars.iv.next.i.i.i96.3, %wide.trip.count.i.i.i91
  br i1 %exitcond.not.i.i.i97.3, label %if.then.i11.i.i82, label %for.body.i.i.i92

_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i80: ; preds = %_ZN20btAlignedObjectArrayIiE8allocateEi.exit.i.i76
  %tobool.not.i10.i.i81 = icmp eq ptr %29, null
  br i1 %tobool.not.i10.i.i81, label %if.end.thread36.i88, label %if.then.i11.i.i82

if.end.thread36.i88:                              ; preds = %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i80
  %m_ownsMemory.i37.i89 = getelementptr inbounds %class.btHashedOverlappingPairCache, ptr %this, i64 0, i32 6, i32 6
  store i8 1, ptr %m_ownsMemory.i37.i89, align 8
  store ptr %retval.0.i.i.i77, ptr %m_data.i.i.i79, align 8
  store i32 %0, ptr %m_capacity.i.i.i59, align 8
  br label %for.body10.lr.ph.i61

if.then.i11.i.i82:                                ; preds = %for.body.i.i.i92.prol.loopexit, %for.body.i.i.i92, %middle.block132, %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i80
  %m_ownsMemory.i.i.i83 = getelementptr inbounds %class.btHashedOverlappingPairCache, ptr %this, i64 0, i32 6, i32 6
  %45 = load i8, ptr %m_ownsMemory.i.i.i83, align 8
  %tobool2.not.i.i.i84 = icmp eq i8 %45, 0
  br i1 %tobool2.not.i.i.i84, label %if.end.i86, label %if.then3.i.i.i85

if.then3.i.i.i85:                                 ; preds = %if.then.i11.i.i82
  tail call void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %29)
  br label %if.end.i86

if.end.i86:                                       ; preds = %if.then3.i.i.i85, %if.then.i11.i.i82
  store i8 1, ptr %m_ownsMemory.i.i.i83, align 8
  store ptr %retval.0.i.i.i77, ptr %m_data.i.i.i79, align 8
  store i32 %0, ptr %m_capacity.i.i.i59, align 8
  br label %for.body10.lr.ph.i61

for.body10.lr.ph.i61:                             ; preds = %if.then5.i58.for.body10.lr.ph.i61_crit_edge, %if.end.i86, %if.end.thread36.i88
  %46 = phi ptr [ %.pre126, %if.then5.i58.for.body10.lr.ph.i61_crit_edge ], [ %retval.0.i.i.i77, %if.end.i86 ], [ %retval.0.i.i.i77, %if.end.thread36.i88 ]
  %47 = sext i32 %26 to i64
  %48 = shl nsw i64 %47, 2
  %scevgep122 = getelementptr i8, ptr %46, i64 %48
  %49 = sub nsw i64 %24, %48
  tail call void @llvm.memset.p0.i64(ptr align 4 %scevgep122, i8 0, i64 %49, i1 false)
  br label %_ZN20btAlignedObjectArrayIiE6resizeEiRKi.exit98

_ZN20btAlignedObjectArrayIiE6resizeEiRKi.exit98:  ; preds = %for.body10.lr.ph.i61, %for.body10.lr.ph.i
...
for.body12.lr.ph:                                 ; preds = %_ZN20btAlignedObjectArrayIiE6resizeEiRKi.exit98
  ...
  %53 = load ptr, ptr %m_data.i99, align 8
...
for.body20.lr.ph:                                 ; preds = %for.cond18.preheader
  ...
  %56 = load ptr, ptr %m_data.i102, align 8
  ...
  %58 = load ptr, ptr %m_data.i110, align 8
...
for.body20:                                       ; preds = %for.body20.lr.ph, %for.body20
  ...
  %63 = load i32, ptr %m_capacity.i, align 8
  ...
  %64 = load i32, ptr %arrayidx.i109, align 4
  %arrayidx.i112 = getelementptr inbounds i32, ptr %58, i64 %indvars.iv
  store i32 %64, ptr %arrayidx.i112, align 4
  %65 = trunc i64 %indvars.iv to i32
  store i32 %65, ptr %arrayidx.i109, align 4
...
invoke.cont:                                      ; preds = %entry, %if.then3.i.i.i
  ...
  %2 = load ptr, ptr %m_data.i.i.i16, align 8
...
define dso_local noundef ptr @_ZN28btHashedOverlappingPairCache8findPairEP17btBroadphaseProxyS1_(ptr nocapture noundef nonnull readonly align 8 dereferenceable(128) %this, ptr nocapture noundef readonly %proxy0, ptr nocapture noundef readonly %proxy1) unnamed_addr #4 align 2 {
entry:
  %0 = load i32, ptr @gFindPairs, align 4
  %inc = add nsw i32 %0, 1
  store i32 %inc, ptr @gFindPairs, align 4
  ...
  %2 = load i32, ptr %m_uniqueId2, align 8
...
if.end9:                                          ; preds = %entry
  ...
  %index.046 = load i32, ptr %arrayidx.i, align 4
...
land.rhs:                                         ; preds = %land.rhs.lr.ph, %while.body
  ...
  %11 = load i32, ptr %m_uniqueId.i.i, align 8
...
_ZN28btHashedOverlappingPairCache10equalsPairERK16btBroadphasePairii.exit: ; preds = %land.rhs
  ...
  %13 = load i32, ptr %m_uniqueId.i5.i, align 8
...
while.body:                                       ; preds = %land.rhs, %_ZN28btHashedOverlappingPairCache10equalsPairERK16btBroadphasePairii.exit
  ...
  %index.0 = load i32, ptr %arrayidx.i39, align 4
...
entry:
  ...
  %3 = load i32, ptr %m_uniqueId.i49, align 8
  %shl.i = shl i32 %3, 16
  %or.i = or i32 %shl.i, %2
  %shl2.i = shl i32 %or.i, 15
  %not.i = xor i32 %shl2.i, -1
  ...
  %index.027.i = load i32, ptr %arrayidx.i.i, align 4
...
land.rhs.lr.ph.i:                                 ; preds = %entry
  ...
  %6 = load ptr, ptr %m_data.i18.i, align 8
...
_ZN28btHashedOverlappingPairCache10equalsPairERK16btBroadphasePairii.exit.i: ; preds = %land.rhs.i
  ...
  %11 = load i32, ptr %m_uniqueId.i5.i.i, align 8
...
while.body.i:                                     ; preds = %_ZN28btHashedOverlappingPairCache10equalsPairERK16btBroadphasePairii.exit.i, %land.rhs.i
  ...
  %index.0.i = load i32, ptr %arrayidx.i23.i, align 4
...
if.end29:                                         ; preds = %if.then23, %if.end19
  ...
  %17 = load i32, ptr %m_uniqueId.i, align 8
  %18 = load i32, ptr %m_uniqueId.i49, align 8
...
_ZN20btAlignedObjectArrayI16btBroadphasePairE10deallocateEv.exit.i: ; preds = %if.then3.i.i, %_ZNK20btAlignedObjectArrayI16btBroadphasePairE4copyEiiPS0_.exit.i
  ...
  %.pre13 = load i32, ptr %m_size.i, align 4
  br label %if.end
...
if.end:                                           ; preds = %_ZN20btAlignedObjectArrayI16btBroadphasePairE10deallocateEv.exit.i, %if.then, %entry
  ...
  %13 = load <2 x ptr>, ptr %fillValue, align 8
  store <2 x ptr> %13, ptr %arrayidx, align 8
  ...
  %14 = load ptr, ptr %m_algorithm4.i, align 8
  store ptr %14, ptr %m_algorithm.i, align 8
...
entry:
  %0 = load i32, ptr @gRemovePairs, align 4
  %inc = add nsw i32 %0, 1
  store i32 %inc, ptr @gRemovePairs, align 4
  %m_uniqueId = getelementptr inbounds %struct.btBroadphaseProxy, ptr %proxy0, i64 0, i32 5
  %1 = load i32, ptr %m_uniqueId, align 8
  %m_uniqueId2 = getelementptr inbounds %struct.btBroadphaseProxy, ptr %proxy1, i64 0, i32 5
  %2 = load i32, ptr %m_uniqueId2, align 8
  ...
  %4 = load i32, ptr %m_uniqueId.i117, align 8
  %shl.i = shl i32 %4, 16
  %or.i = or i32 %shl.i, %3
  %shl2.i = shl i32 %or.i, 15
  %not.i = xor i32 %shl2.i, -1
...
land.rhs.lr.ph.i:                                 ; preds = %entry
  %m_data.i18.i = getelementptr inbounds %class.btHashedOverlappingPairCache, ptr %this, i64 0, i32 1, i32 5
  %7 = load ptr, ptr %m_data.i18.i, align 8
  %m_data.i21.i = getelementptr inbounds %class.btHashedOverlappingPairCache, ptr %this, i64 0, i32 6, i32 5
...
_ZN28btHashedOverlappingPairCache10equalsPairERK16btBroadphasePairii.exit.i: ; preds = %land.rhs.i
  ...
  %12 = load i32, ptr %m_uniqueId.i5.i.i, align 8
...
if.end9:                                          ; preds = %_ZN28btHashedOverlappingPairCache10equalsPairERK16btBroadphasePairii.exit.i
  ...
  %16 = load ptr, ptr %m_data.i18.i, align 8
  ...
  %index.0204 = load i32, ptr %arrayidx.i, align 4
...
while.body.lr.ph:                                 ; preds = %if.end9
  %19 = load ptr, ptr %m_data.i21.i, align 8
  br label %while.body
...
while.body:                                       ; preds = %while.body.lr.ph, %while.body
  ...
  %index.0 = load i32, ptr %arrayidx.i121, align 4
...
if.end25:                                         ; preds = %if.else, %if.then16
  ...
  %m_ghostPairCallback = getelementptr inbounds %class.btHashedOverlappingPairCache, ptr %this, i64 0, i32 7
  %25 = load ptr, ptr %m_ghostPairCallback, align 8
...
if.end38:                                         ; preds = %if.end34
  ...
  %index.1207 = load i32, ptr %arrayidx.i158, align 4
...
while.body52.lr.ph:                               ; preds = %if.end38
  %34 = load ptr, ptr %m_data.i21.i, align 8
...
while.body52:                                     ; preds = %while.body52.lr.ph, %while.body52
  ...
  %index.1 = load i32, ptr %arrayidx.i161, align 4
...
if.then57:                                        ; preds = %while.end55
  %35 = load ptr, ptr %m_data.i21.i, align 8
  %arrayidx.i164 = getelementptr inbounds i32, ptr %35, i64 %idxprom.i136
  %36 = load i32, ptr %arrayidx.i164, align 4
  %idxprom.i166 = sext i32 %index.1209 to i64
  %arrayidx.i167 = getelementptr inbounds i32, ptr %35, i64 %idxprom.i166
  store i32 %36, ptr %arrayidx.i167, align 4
  br label %if.end67

if.else62:                                        ; preds = %if.end38, %while.end55
  %37 = load ptr, ptr %m_data.i21.i, align 8
  %arrayidx.i170 = getelementptr inbounds i32, ptr %37, i64 %idxprom.i136
  %38 = load i32, ptr %arrayidx.i170, align 4
  store i32 %38, ptr %arrayidx.i158, align 4
  br label %if.end67

if.end67:                                         ; preds = %if.else62, %if.then57
  %sext201 = shl i64 %sub.ptr.sub, 27
  %idxprom.i178 = ashr i64 %sext201, 32
  %arrayidx.i179 = getelementptr inbounds %struct.btBroadphasePair, ptr %27, i64 %idxprom.i178
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %arrayidx.i179, ptr noundef nonnull align 8 dereferenceable(32) %arrayidx.i137, i64 32, i1 false)
  ...
  %41 = load ptr, ptr %m_data.i21.i, align 8
  %arrayidx.i185 = getelementptr inbounds i32, ptr %41, i64 %idxprom.i178
  store i32 %40, ptr %arrayidx.i185, align 4
  store i32 %conv, ptr %arrayidx.i182, align 4
...
if.then:                                          ; preds = %for.body
  ...
  %6 = load i32, ptr @gOverlappingPairs, align 4
  %dec = add nsw i32 %6, -1
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i
  ...
  %5 = load <2 x ptr>, ptr %arrayidx3.i.i.i, align 8
  store <2 x ptr> %5, ptr %arrayidx.i.i.i, align 8
  ...
  %6 = load ptr, ptr %m_algorithm4.i.i.i.i, align 8
  store ptr %6, ptr %m_algorithm.i.i.i.i, align 8
...
_ZN20btAlignedObjectArrayI16btBroadphasePairE10deallocateEv.exit.i.i: ; preds = %if.then3.i.i.i, %_ZNK20btAlignedObjectArrayI16btBroadphasePairE4copyEiiPS0_.exit.i.i
  ...
  %.pre9.i = load i32, ptr %m_size.i.i, align 4
  br label %for.inc
...
for.inc:                                          ; preds = %_ZN20btAlignedObjectArrayI16btBroadphasePairE10deallocateEv.exit.i.i, %if.then.i, %for.body
  ...
  %14 = load <2 x ptr>, ptr %arrayidx.i, align 8
  store <2 x ptr> %14, ptr %arrayidx.i69, align 8
  ...
  %15 = load ptr, ptr %m_algorithm4.i.i, align 8
  store ptr %15, ptr %m_algorithm.i.i, align 8
...
for.body24:                                       ; preds = %for.body24.lr.ph, %for.body24
  ...
  store i32 -1, ptr %arrayidx.i88, align 4
  %indvars.iv.next130 = add nuw nsw i64 %indvars.iv129, 1
  %30 = load i32, ptr %m_size.i85, align 4
...
for.end30.loopexit:                               ; preds = %for.body24
  %.pre135 = load i32, ptr %m_size.i.i, align 4
  br label %for.end30
...
if.then.i91._ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI29btBroadphasePairSortPredicateEEvT_.exit_crit_edge: ; preds = %if.then.i91
  %.pre136 = load i32, ptr %m_size.i.i, align 4
...
for.body36:                                       ; preds = %_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI29btBroadphasePairSortPredicateEEvT_.exit, %for.inc47
  ...
  %36 = load ptr, ptr %m_pProxy142, align 8
...
if.then5:                                         ; preds = %_ZNK20btAlignedObjectArrayI16btBroadphasePairE16findLinearSearchERKS0_.exit
  %9 = load i32, ptr @gOverlappingPairs, align 4
  %dec = add nsw i32 %9, -1
  store i32 %dec, ptr @gOverlappingPairs, align 4
...
cleanup:                                          ; preds = %if.then5, %if.then10
  ...
  %17 = load <2 x ptr>, ptr %arrayidx.i32, align 8
  %18 = load <2 x ptr>, ptr %m_algorithm4.i.i, align 8
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %arrayidx.i32, ptr noundef nonnull align 8 dereferenceable(32) %arrayidx4.i, i64 32, i1 false)
...
_ZNK28btSortedOverlappingPairCache24needsBroadphaseCollisionEP17btBroadphaseProxyS1_.exit: ; preds = %if.end.i
  ...
  %4 = load i16, ptr %m_collisionFilterGroup5.i, align 8
  %m_collisionFilterMask7.i = getelementptr inbounds %struct.btBroadphaseProxy, ptr %proxy0, i64 0, i32 2
  %5 = load i16, ptr %m_collisionFilterMask7.i, align 2
...
if.end:                                           ; preds = %if.then.i, %_ZNK28btSortedOverlappingPairCache24needsBroadphaseCollisionEP17btBroadphaseProxyS1_.exit
  ...
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %ref.tmp) #14
  %m_uniqueId.i = getelementptr inbounds %struct.btBroadphaseProxy, ptr %proxy0, i64 0, i32 5
  %6 = load i32, ptr %m_uniqueId.i, align 8
  %m_uniqueId2.i = getelementptr inbounds %struct.btBroadphaseProxy, ptr %proxy1, i64 0, i32 5
  %7 = load i32, ptr %m_uniqueId2.i, align 8
  ...
  %9 = load i32, ptr @gOverlappingPairs, align 4
  %inc = add nsw i32 %9, 1
  store i32 %inc, ptr @gOverlappingPairs, align 4
  %10 = load i32, ptr @gAddedPairs, align 4
  %inc5 = add nsw i32 %10, 1
  store i32 %inc5, ptr @gAddedPairs, align 4
  %m_ghostPairCallback = getelementptr inbounds %class.btSortedOverlappingPairCache, ptr %this, i64 0, i32 5
...
if.then:                                          ; preds = %for.body
  ...
  %6 = load <2 x ptr>, ptr %arrayidx.i20, align 8
  %7 = load <2 x ptr>, ptr %m_algorithm4.i.i, align 8
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %arrayidx.i20, ptr noundef nonnull align 8 dereferenceable(32) %arrayidx4.i, i64 32, i1 false)
  ...
  store i32 %dec.i, ptr %m_size.i, align 4
  %10 = load i32, ptr @gOverlappingPairs, align 4
...
if.then.i:
  store ptr getelementptr inbounds ({ [19 x ptr] }, ptr @_ZTV28btSortedOverlappingPairCache, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %m_overlappingPairArray = getelementptr inbounds %class.btSortedOverlappingPairCache, ptr %this, i64 0, i32 1
...
if.then:                                          ; preds = %entry
  ...
  tail call void %3(ptr noundef nonnull align 8 dereferenceable(8) %dispatcher, ptr noundef %2)
  store ptr null, ptr %m_algorithm, align 8
  %4 = load i32, ptr @gRemovePairs, align 4
  %dec = add nsw i32 %4, -1
  store i32 %dec, ptr @gRemovePairs, align 4
  br label %if.end
...
define dso_local void @_ZN28btSortedOverlappingPairCache20sortOverlappingPairsEP12btDispatcher(ptr nocapture nonnull readnone align 8 %this, ptr nocapture readnone %dispatcher) unnamed_addr #8 align 2 {
entry:
  ret void
}
...
entry:
  %0 = load i32, ptr @gAddedPairs, align 4
  %inc = add nsw i32 %0, 1
  store i32 %inc, ptr @gAddedPairs, align 4
...
if.end.i:                                         ; preds = %entry
  %m_collisionFilterGroup.i = getelementptr inbounds %struct.btBroadphaseProxy, ptr %proxy0, i64 0, i32 1
  %3 = load i16, ptr %m_collisionFilterGroup.i, align 8
  %m_collisionFilterMask.i = getelementptr inbounds %struct.btBroadphaseProxy, ptr %proxy1, i64 0, i32 2
  %4 = load i16, ptr %m_collisionFilterMask.i, align 2
  %and18.i = and i16 %4, %3
  %cmp.not.i = icmp eq i16 %and18.i, 0
...
_ZNK28btHashedOverlappingPairCache24needsBroadphaseCollisionEP17btBroadphaseProxyS1_.exit: ; preds = %if.end.i
  %m_collisionFilterGroup5.i = getelementptr inbounds %struct.btBroadphaseProxy, ptr %proxy1, i64 0, i32 1
  %5 = load i16, ptr %m_collisionFilterGroup5.i, align 8
  %m_collisionFilterMask7.i = getelementptr inbounds %struct.btBroadphaseProxy, ptr %proxy0, i64 0, i32 2
  %6 = load i16, ptr %m_collisionFilterMask7.i, align 2
