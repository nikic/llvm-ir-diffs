...
if.then5.i58:                                     ; preds = %for.body10.lr.ph.i
  ...
  %27 = load i32, ptr %m_capacity.i.i.i59, align 8, !tbaa !28
...
if.then5.i58.for.body10.lr.ph.i61_crit_edge:      ; preds = %if.then5.i58
  ...
  %.pre126 = load ptr, ptr %m_data11.i62.phi.trans.insert, align 8, !tbaa !26
...
if.then.i.i.i71:                                  ; preds = %if.then.i.i69
  ...
  %.pre.i75 = load i32, ptr %m_size.i.i54, align 4, !tbaa !27
...
_ZN20btAlignedObjectArrayIiE8allocateEi.exit.i.i76: ; preds = %if.then.i.i.i71, %if.then.i.i69
  ...
  %29 = load ptr, ptr %m_data.i.i.i79, align 8, !tbaa !26
...
for.body.i.i.i92.prol:                            ; preds = %for.body.i.i.i92.preheader, %for.body.i.i.i92.prol
  ...
  %39 = load i32, ptr %arrayidx3.i.i.i95.prol, align 4, !tbaa !35
  store i32 %39, ptr %arrayidx.i.i.i94.prol, align 4, !tbaa !35
  ...
  br i1 %prol.iter148.cmp.not, label %for.body.i.i.i92.prol.loopexit, label %for.body.i.i.i92.prol, !llvm.loop !44
...
for.body.i.i.i92:                                 ; preds = %for.body.i.i.i92.prol.loopexit, %for.body.i.i.i92
  ...
  %41 = load i32, ptr %arrayidx3.i.i.i95, align 4, !tbaa !35
  store i32 %41, ptr %arrayidx.i.i.i94, align 4, !tbaa !35
  ...
  %42 = load i32, ptr %arrayidx3.i.i.i95.1, align 4, !tbaa !35
  store i32 %42, ptr %arrayidx.i.i.i94.1, align 4, !tbaa !35
  ...
  %43 = load i32, ptr %arrayidx3.i.i.i95.2, align 4, !tbaa !35
  store i32 %43, ptr %arrayidx.i.i.i94.2, align 4, !tbaa !35
  ...
  %44 = load i32, ptr %arrayidx3.i.i.i95.3, align 4, !tbaa !35
  store i32 %44, ptr %arrayidx.i.i.i94.3, align 4, !tbaa !35
  ...
  br i1 %exitcond.not.i.i.i97.3, label %if.then.i11.i.i82, label %for.body.i.i.i92, !llvm.loop !45
...
if.end.thread36.i88:                              ; preds = %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i80
  ...
  store i8 1, ptr %m_ownsMemory.i37.i89, align 8, !tbaa !25
  store ptr %retval.0.i.i.i77, ptr %m_data.i.i.i79, align 8, !tbaa !26
  store i32 %0, ptr %m_capacity.i.i.i59, align 8, !tbaa !28
  br label %for.body10.lr.ph.i61
...
if.then.i11.i.i82:                                ; preds = %for.body.i.i.i92.prol.loopexit, %for.body.i.i.i92, %middle.block132, %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i80
  ...
  %45 = load i8, ptr %m_ownsMemory.i.i.i83, align 8, !tbaa !25, !range !34, !noundef !42
...
if.end.i86:                                       ; preds = %if.then3.i.i.i85, %if.then.i11.i.i82
  store i8 1, ptr %m_ownsMemory.i.i.i83, align 8, !tbaa !25
  store ptr %retval.0.i.i.i77, ptr %m_data.i.i.i79, align 8, !tbaa !26
  store i32 %0, ptr %m_capacity.i.i.i59, align 8, !tbaa !28
  br label %for.body10.lr.ph.i61
...
cond.true5.i50:                                   ; preds = %cond.end.i47
  ...
  %17 = load i32, ptr %m_uniqueId7.i51, align 8, !tbaa !47
...
cond.end16.i58:                                   ; preds = %cond.true12.i56, %cond.end9.i52
  ...
  %19 = load ptr, ptr %m_pProxy118.i60, align 8, !tbaa !51
...
cond.true20.i62:                                  ; preds = %cond.end16.i58
  ...
  %20 = load i32, ptr %m_uniqueId22.i63, align 8, !tbaa !47
...
land.rhs.i75:                                     ; preds = %land.lhs.true33.i73
  ...
  %21 = load ptr, ptr %m_algorithm37.i77, align 8, !tbaa !31
