; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btTriangleShapeEx.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btTriangleShapeEx.cpp"
...
if.end18.sink.split:                              ; preds = %if.then12, %if.then5
  ...
  store i32 %.sink, ptr %m_point_count, align 4
  br label %if.end18
...
for.body23:                                       ; preds = %for.body23, %for.body23.preheader.new
  ...
  %14 = load i32, ptr %arrayidx25, align 8
  ...
  %15 = load i32, ptr %arrayidx25.1, align 4
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx29.1, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx27.1, i64 16, i1 false)
...
for.body23.epil:                                  ; preds = %for.end32.loopexit.unr-lcssa
  ...
  %16 = load i32, ptr %arrayidx25.epil, align 4
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx29.epil, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx27.epil, i64 16, i1 false)
  br label %for.end32
...
entry:
  ...
  %16 = load float, ptr %arrayidx5.i.i65, align 4
  %mul8.i.i67 = fmul float %7, %16
  %17 = tail call float @llvm.fmuladd.f32(float %15, float %4, float %mul8.i.i67)
  %arrayidx10.i.i68 = getelementptr inbounds [3 x %class.btVector3], ptr %other, i64 0, i64 2, i32 0, i64 2
  %18 = load float, ptr %arrayidx10.i.i68, align 4
  %19 = tail call float @llvm.fmuladd.f32(float %18, float %10, float %17)
  %sub.i71 = fsub float %19, %11
...
if.end:                                           ; preds = %entry
  ...
  %43 = load <4 x float>, ptr %arrayidx5.i.i72, align 4
  ...
  %45 = load float, ptr %arrayidx7.i.i73, align 4
  %arrayidx10.i.i75 = getelementptr inbounds [4 x float], ptr %this, i64 0, i64 2
  %46 = load <4 x float>, ptr %arrayidx10.i.i75, align 4
  ...
  %54 = load float, ptr %arrayidx5.i.i86, align 4
  %mul8.i.i88 = fmul float %45, %54
  %55 = tail call float @llvm.fmuladd.f32(float %53, float %42, float %mul8.i.i88)
  %arrayidx10.i.i89 = getelementptr inbounds [3 x %class.btVector3], ptr %this, i64 0, i64 2, i32 0, i64 2
  %56 = load float, ptr %arrayidx10.i.i89, align 4
  %57 = tail call float @llvm.fmuladd.f32(float %56, float %48, float %55)
  %sub.i92 = fsub float %57, %49
  ...
  %shift93 = shufflevector <2 x i1> %74, <2 x i1> poison, <2 x i32> <i32 1, i32 poison>
  %75 = or <2 x i1> %74, %shift93
  %or.cond42.not = extractelement <2 x i1> %75, i64 0
...
entry:
  ...
  %6 = load <2 x float>, ptr %arrayidx7.i13.i.i, align 4
  ...
  store float %mul7.i.i.i.i.i, ptr %arrayidx5.i22.i.i, align 8
  %arrayidx7.i23.i.i = getelementptr inbounds [4 x float], ptr %edgeplane, i64 0, i64 3
  store float %29, ptr %arrayidx7.i23.i.i, align 4
...
if.end:                                           ; preds = %entry
  ...
  %30 = load float, ptr %arrayidx4.i30, align 4
  ...
  %33 = load <2 x float>, ptr %arrayidx5.i.i.i33, align 4
  %34 = load <2 x float>, ptr %arrayidx5.i.i.i, align 4
  %35 = fsub <2 x float> %33, %34
  %36 = load <2 x float>, ptr %arrayidx7.i13.i.i, align 4
  ...
  %45 = fneg float %44
  %neg30.i.i.i43 = fmul float %32, %45
  ...
  store float %mul7.i.i.i.i.i49, ptr %arrayidx5.i22.i.i, align 8
  store float %59, ptr %arrayidx7.i23.i.i, align 4
...
if.end18:                                         ; preds = %if.end
  ...
  %61 = load float, ptr %arrayidx4.i30, align 4
  %sub.i.i.i56 = fsub float %60, %61
  %62 = load float, ptr %m_plane.i, align 4
  %63 = load <2 x float>, ptr %arrayidx7.i.i.i, align 4
  %64 = load <2 x float>, ptr %arrayidx5.i.i.i33, align 4
  %65 = fsub <2 x float> %63, %64
  %66 = load <2 x float>, ptr %arrayidx7.i13.i.i, align 4
  ...
  %75 = fneg float %74
  %neg30.i.i.i67 = fmul float %62, %75
  ...
  store float %mul7.i.i.i.i.i73, ptr %arrayidx5.i22.i.i, align 8
  store float %89, ptr %arrayidx7.i23.i.i, align 4
...
if.then:                                          ; preds = %entry
  ...
  %.pre119 = load float, ptr %arrayidx7.i.i, align 4
  %.pre120 = load float, ptr %arrayidx12.i.i, align 4
  %.pre121 = load float, ptr %arrayidx.i, align 4
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %9 = phi float [ %8, %entry ], [ %.pre121, %if.then ]
  %10 = phi float [ %6, %entry ], [ %.pre120, %if.then ]
  %11 = phi float [ %3, %entry ], [ %.pre119, %if.then ]
  ...
  %17 = load float, ptr %arrayidx10.i.i25, align 4
...
if.then.i:                                        ; preds = %if.end
  ...
  %20 = load <2 x float>, ptr %point0, align 4
  ...
  store <2 x float> %27, ptr %arrayidx.i30, align 4
  %ref.tmp.sroa.4.0..sroa_idx.i.i = getelementptr inbounds i8, ptr %arrayidx.i30, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i.i, ptr %ref.tmp.sroa.4.0..sroa_idx.i.i, align 4
...
_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit: ; preds = %if.end.i, %if.then7.i
  ...
  %28 = load float, ptr %plane, align 4
  %29 = load <2 x float>, ptr %point2, align 4
  %30 = load float, ptr %arrayidx7.i.i, align 4
  ...
  %34 = load float, ptr %arrayidx10.i.i34, align 4
  ...
  br i1 %cmp5.not.i40, label %if.end.i66, label %if.then.i41

if.then.i41:                                      ; preds = %_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit
  %fneg.i42 = fneg float %sub.i28
  %sub.i43 = fsub float %sub.i37, %sub.i28
  %div.i44 = fdiv float %fneg.i42, %sub.i43
  %idxprom.i45 = zext i32 %clipped_count.2 to i64
  %arrayidx.i46 = getelementptr inbounds %class.btVector3, ptr %clipped, i64 %idxprom.i45
  %sub.i.i47 = fsub float 1.000000e+00, %div.i44
  %38 = load float, ptr %arrayidx10.i.i25, align 4
  %mul8.i.i.i.i52 = fmul float %sub.i.i47, %38
  %mul8.i.i12.i.i57 = fmul float %34, %div.i44
  %39 = load <2 x float>, ptr %point1, align 4
  %40 = insertelement <2 x float> poison, float %sub.i.i47, i64 0
  %41 = shufflevector <2 x float> %40, <2 x float> poison, <2 x i32> zeroinitializer
  %42 = fmul <2 x float> %41, %39
  %43 = insertelement <2 x float> poison, float %div.i44, i64 0
  %44 = shufflevector <2 x float> %43, <2 x float> poison, <2 x i32> zeroinitializer
  %45 = fmul <2 x float> %29, %44
  %46 = fadd <2 x float> %45, %42
  %add14.i.i.i60 = fadd float %mul8.i.i12.i.i57, %mul8.i.i.i.i52
  %retval.sroa.3.12.vec.insert.i.i.i63 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i.i.i60, i64 0
  store <2 x float> %46, ptr %arrayidx.i46, align 4
  %ref.tmp.sroa.4.0..sroa_idx.i.i64 = getelementptr inbounds i8, ptr %arrayidx.i46, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i.i63, ptr %ref.tmp.sroa.4.0..sroa_idx.i.i64, align 4
  %inc.i65 = add nuw nsw i32 %clipped_count.2, 1
  br label %if.end.i66

if.end.i66:                                       ; preds = %if.then.i41, %_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit
  %clipped_count.3 = phi i32 [ %clipped_count.2, %_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit ], [ %inc.i65, %if.then.i41 ]
  br i1 %cmp1.i39, label %_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit71, label %if.then7.i67

if.then7.i67:                                     ; preds = %if.end.i66
  %idxprom8.i68 = zext i32 %clipped_count.3 to i64
  %arrayidx9.i69 = getelementptr inbounds %class.btVector3, ptr %clipped, i64 %idxprom8.i68
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx9.i69, ptr noundef nonnull align 4 dereferenceable(16) %point2, i64 16, i1 false)
  %inc10.i70 = add nuw nsw i32 %clipped_count.3, 1
  br label %_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit71

_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit71: ; preds = %if.end.i66, %if.then7.i67
  %clipped_count.4 = phi i32 [ %clipped_count.3, %if.end.i66 ], [ %inc10.i70, %if.then7.i67 ]
  %cmp.i72 = fcmp ule float %sub.i37, 0x3E80000000000000
  %cmp5.not.i74 = xor i1 %cmp, %cmp.i72
  br i1 %cmp5.not.i74, label %if.end.i100, label %if.then.i75

if.then.i75:                                      ; preds = %_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit71
  %fneg.i76 = fneg float %sub.i37
  %sub.i77 = fsub float %sub.i, %sub.i37
  %div.i78 = fdiv float %fneg.i76, %sub.i77
  %idxprom.i79 = zext i32 %clipped_count.4 to i64
  %arrayidx.i80 = getelementptr inbounds %class.btVector3, ptr %clipped, i64 %idxprom.i79
  %sub.i.i81 = fsub float 1.000000e+00, %div.i78
  %47 = load float, ptr %arrayidx10.i.i34, align 4
  %mul8.i.i.i.i86 = fmul float %sub.i.i81, %47
  %48 = load float, ptr %arrayidx10.i.i, align 4
  %mul8.i.i12.i.i91 = fmul float %div.i78, %48
  %49 = load <2 x float>, ptr %point2, align 4
  %50 = insertelement <2 x float> poison, float %sub.i.i81, i64 0
  %51 = shufflevector <2 x float> %50, <2 x float> poison, <2 x i32> zeroinitializer
  %52 = fmul <2 x float> %51, %49
  %53 = load <2 x float>, ptr %point0, align 4
  %54 = insertelement <2 x float> poison, float %div.i78, i64 0
  %55 = shufflevector <2 x float> %54, <2 x float> poison, <2 x i32> zeroinitializer
  %56 = fmul <2 x float> %55, %53
  %57 = fadd <2 x float> %52, %56
  %add14.i.i.i94 = fadd float %mul8.i.i.i.i86, %mul8.i.i12.i.i91
  %retval.sroa.3.12.vec.insert.i.i.i97 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i.i.i94, i64 0
  store <2 x float> %57, ptr %arrayidx.i80, align 4
  %ref.tmp.sroa.4.0..sroa_idx.i.i98 = getelementptr inbounds i8, ptr %arrayidx.i80, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i.i97, ptr %ref.tmp.sroa.4.0..sroa_idx.i.i98, align 4
  %inc.i99 = add nuw nsw i32 %clipped_count.4, 1
  br label %if.end.i100

if.end.i100:                                      ; preds = %if.then.i75, %_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit71
  %clipped_count.5 = phi i32 [ %clipped_count.4, %_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit71 ], [ %inc.i99, %if.then.i75 ]
  br i1 %cmp, label %_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit105, label %if.then7.i101

if.then7.i101:                                    ; preds = %if.end.i100
  %idxprom8.i102 = zext i32 %clipped_count.5 to i64
  %arrayidx9.i103 = getelementptr inbounds %class.btVector3, ptr %clipped, i64 %idxprom8.i102
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx9.i103, ptr noundef nonnull align 4 dereferenceable(16) %point0, i64 16, i1 false)
  %inc10.i104 = add nuw nsw i32 %clipped_count.5, 1
  br label %_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit105

_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit105: ; preds = %if.end.i100, %if.then7.i101
  %clipped_count.6 = phi i32 [ %clipped_count.5, %if.end.i100 ], [ %inc10.i104, %if.then7.i101 ]
...
if.end:                                           ; preds = %if.then, %entry
  %clipped_count.0 = phi i32 [ 0, %entry ], [ 1, %if.then ]
  %cmp386 = icmp sgt i32 %polygon_point_count, 1
  br i1 %cmp386, label %for.body.preheader, label %for.cond.cleanup
...
if.then.i:                                        ; preds = %for.cond.cleanup
  ...
  %retval.sroa.3.12.vec.insert.i.i.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i.i.i, i64 0
  store <2 x float> %19, ptr %arrayidx.i35, align 4
...
if.then7.i:                                       ; preds = %if.end.i
  ...
  %arrayidx9.i = getelementptr inbounds %class.btVector3, ptr %clipped, i64 %idxprom8.i
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx9.i, ptr noundef nonnull align 4 dereferenceable(16) %polygon_points, i64 16, i1 false)
...
for.body:                                         ; preds = %for.body.preheader, %_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit76
  ...
  %olddist.089 = phi float [ %sub.i, %for.body.preheader ], [ %sub.i42, %_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit76 ]
  %clipped_count.187 = phi i32 [ %clipped_count.0, %for.body.preheader ], [ %clipped_count.5, %_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit76 ]
  %arrayidx5 = getelementptr inbounds %class.btVector3, ptr %polygon_points, i64 %indvars.iv
  %20 = load float, ptr %plane, align 4
  %21 = load <2 x float>, ptr %arrayidx5, align 4
  ...
  %26 = load float, ptr %arrayidx10.i.i39, align 4
  ...
  %cmp.i43 = fcmp ule float %olddist.089, 0x3E80000000000000
  %cmp1.i44 = fcmp ogt float %sub.i42, 0x3E80000000000000
  %cmp5.not.i45 = xor i1 %cmp.i43, %cmp1.i44
  br i1 %cmp5.not.i45, label %if.end.i71, label %if.then.i46
...
if.then.i46:                                      ; preds = %for.body
  ...
  %fneg.i47 = fneg float %olddist.089
  %sub.i48 = fsub float %sub.i42, %olddist.089
  %div.i49 = fdiv float %fneg.i47, %sub.i48
  %idxprom.i50 = sext i32 %clipped_count.187 to i64
  %arrayidx.i51 = getelementptr inbounds %class.btVector3, ptr %clipped, i64 %idxprom.i50
  %sub.i.i52 = fsub float 1.000000e+00, %div.i49
  %arrayidx7.i.i.i.i56 = getelementptr inbounds [4 x float], ptr %arrayidx8, i64 0, i64 2
  %31 = load float, ptr %arrayidx7.i.i.i.i56, align 4
  %mul8.i.i.i.i57 = fmul float %sub.i.i52, %31
  %mul8.i.i12.i.i62 = fmul float %26, %div.i49
  %32 = load <2 x float>, ptr %arrayidx8, align 4
  %33 = insertelement <2 x float> poison, float %sub.i.i52, i64 0
  %34 = shufflevector <2 x float> %33, <2 x float> poison, <2 x i32> zeroinitializer
  %35 = fmul <2 x float> %34, %32
  %36 = insertelement <2 x float> poison, float %div.i49, i64 0
  %37 = shufflevector <2 x float> %36, <2 x float> poison, <2 x i32> zeroinitializer
  %38 = fmul <2 x float> %21, %37
  %39 = fadd <2 x float> %38, %35
  %add14.i.i.i65 = fadd float %mul8.i.i12.i.i62, %mul8.i.i.i.i57
  %retval.sroa.3.12.vec.insert.i.i.i68 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i.i.i65, i64 0
  store <2 x float> %39, ptr %arrayidx.i51, align 4
  %ref.tmp.sroa.4.0..sroa_idx.i.i69 = getelementptr inbounds i8, ptr %arrayidx.i51, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i.i68, ptr %ref.tmp.sroa.4.0..sroa_idx.i.i69, align 4
  %inc.i70 = add nsw i32 %clipped_count.187, 1
  br label %if.end.i71

if.end.i71:                                       ; preds = %if.then.i46, %for.body
  %clipped_count.4 = phi i32 [ %clipped_count.187, %for.body ], [ %inc.i70, %if.then.i46 ]
  br i1 %cmp1.i44, label %_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit76, label %if.then7.i72

if.then7.i72:                                     ; preds = %if.end.i71
  %idxprom8.i73 = sext i32 %clipped_count.4 to i64
  %arrayidx9.i74 = getelementptr inbounds %class.btVector3, ptr %clipped, i64 %idxprom8.i73
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx9.i74, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx5, i64 16, i1 false)
  %inc10.i75 = add nsw i32 %clipped_count.4, 1
  br label %_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit76

_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit76: ; preds = %if.end.i71, %if.then7.i72
  %clipped_count.5 = phi i32 [ %clipped_count.4, %if.end.i71 ], [ %inc10.i75, %if.then7.i72 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
...
for.cond20.preheader.i:                           ; preds = %if.end18.i
  store float %add.i110.ph, ptr %contacts1, align 4
...
for.body23.preheader.i.new:                       ; preds = %for.body23.preheader.i
  %unroll_iter = and i64 %wide.trip.count56.i, 2147483646
...
if.end18.i.thread:                                ; preds = %if.then.i
  ...
  store i32 %15, ptr %point_indices.i, align 16
...
for.body23.i:                                     ; preds = %for.body23.i, %for.body23.preheader.i.new
  ...
  %16 = load i32, ptr %arrayidx25.i, align 8
  ...
  %17 = load i32, ptr %arrayidx25.i.1, align 4
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx29.i.1, ptr noundef nonnull align 16 dereferenceable(16) %arrayidx27.i.1, i64 16, i1 false)
...
for.body23.i.epil:                                ; preds = %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit.loopexit.unr-lcssa
  ...
  %18 = load i32, ptr %arrayidx25.i.epil, align 4
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx29.i.epil, ptr noundef nonnull align 16 dereferenceable(16) %arrayidx27.i.epil, i64 16, i1 false)
...
if.end16:                                         ; preds = %if.end7
  ...
  br i1 %cmp47.i41, label %for.body.lr.ph.i42, label %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86.thread
...
for.body.lr.ph.i42:                               ; preds = %if.end16
  %arrayidx7.i.i.i43 = getelementptr inbounds %struct.GIM_TRIANGLE_CONTACT, ptr %contacts2, i64 0, i32 2, i32 0, i32 0, i64 1
  %arrayidx12.i.i.i44 = getelementptr inbounds %struct.GIM_TRIANGLE_CONTACT, ptr %contacts2, i64 0, i32 2, i32 0, i32 0, i64 2
  %arrayidx.i.i45 = getelementptr inbounds %struct.GIM_TRIANGLE_CONTACT, ptr %contacts2, i64 0, i32 2, i32 0, i32 0, i64 3
  %wide.trip.count.i46 = zext i32 %call13 to i64
  %21 = load float, ptr %m_separating_normal11, align 4
  %22 = load float, ptr %arrayidx7.i.i.i43, align 4
  %23 = load float, ptr %arrayidx12.i.i.i44, align 4
  %24 = load float, ptr %arrayidx.i.i45, align 4
  br label %for.body.i47.outer

for.body.i47.outer:                               ; preds = %if.end18.i69.thread, %for.body.lr.ph.i42
  %.sink.i67118.ph = phi i32 [ 1, %if.end18.i69.thread ], [ 0, %for.body.lr.ph.i42 ]
  %add.i55115.ph = phi float [ %add.i55, %if.end18.i69.thread ], [ -1.000000e+03, %for.body.lr.ph.i42 ]
  %indvars.iv.i48.ph = phi i64 [ %indvars.iv.next.i71138, %if.end18.i69.thread ], [ 0, %for.body.lr.ph.i42 ]
  br label %for.body.i47

for.cond20.preheader.i73:                         ; preds = %if.end18.i69
  store float %add.i55115.ph, ptr %contacts2, align 4
  store i32 %.pr107, ptr %m_point_count.i40, align 4
  %cmp2250.i74 = icmp sgt i32 %inc45.i70, 0
  br i1 %cmp2250.i74, label %for.body23.preheader.i75, label %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86

for.body23.preheader.i75:                         ; preds = %for.cond20.preheader.i73.thread, %for.cond20.preheader.i73
  %.pr107140147 = phi i32 [ 1, %for.cond20.preheader.i73.thread ], [ %.pr107, %for.cond20.preheader.i73 ]
  %25 = phi float [ %add.i55, %for.cond20.preheader.i73.thread ], [ %add.i55115.ph, %for.cond20.preheader.i73 ]
  %inc45.i70141145 = phi i32 [ 1, %for.cond20.preheader.i73.thread ], [ %inc45.i70, %for.cond20.preheader.i73 ]
  %wide.trip.count56.i76 = zext i32 %inc45.i70141145 to i64
  %xtraiter167 = and i64 %wide.trip.count56.i76, 1
  %26 = icmp eq i32 %inc45.i70141145, 1
  br i1 %26, label %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86.loopexit.unr-lcssa, label %for.body23.preheader.i75.new

for.body23.preheader.i75.new:                     ; preds = %for.body23.preheader.i75
  %unroll_iter169 = and i64 %wide.trip.count56.i76, 2147483646
  br label %for.body23.i77

for.body.i47:                                     ; preds = %for.body.i47.outer, %if.end18.i69
  %.sink.i67118 = phi i32 [ %.pr107, %if.end18.i69 ], [ %.sink.i67118.ph, %for.body.i47.outer ]
  %indvars.iv.i48 = phi i64 [ %indvars.iv.next.i71, %if.end18.i69 ], [ %indvars.iv.i48.ph, %for.body.i47.outer ]
  %inc4648.i49 = phi i32 [ %inc45.i70, %if.end18.i69 ], [ %.sink.i67118.ph, %for.body.i47.outer ]
  %arrayidx.i50 = getelementptr inbounds %class.btVector3, ptr %clipped_points, i64 %indvars.iv.i48
  %27 = load float, ptr %arrayidx.i50, align 16
  %arrayidx5.i.i.i51 = getelementptr inbounds [4 x float], ptr %arrayidx.i50, i64 0, i64 1
  %28 = load float, ptr %arrayidx5.i.i.i51, align 4
  %mul8.i.i.i52 = fmul float %28, %22
  %29 = call float @llvm.fmuladd.f32(float %27, float %21, float %mul8.i.i.i52)
  %arrayidx10.i.i.i53 = getelementptr inbounds [4 x float], ptr %arrayidx.i50, i64 0, i64 2
  %30 = load float, ptr %arrayidx10.i.i.i53, align 8
  %31 = call float @llvm.fmuladd.f32(float %30, float %23, float %29)
  %sub.i.i54 = fsub float %31, %24
  %add.i55 = fsub float %add, %sub.i.i54
  %cmp2.i56 = fcmp ult float %add.i55, 0.000000e+00
  br i1 %cmp2.i56, label %if.end18.i69, label %if.then.i57

if.then.i57:                                      ; preds = %for.body.i47
  %cmp4.i58 = fcmp ogt float %add.i55, %add.i55115.ph
  br i1 %cmp4.i58, label %if.end18.i69.thread, label %if.else.i59

if.else.i59:                                      ; preds = %if.then.i57
  %add9.i60 = fadd float %add.i55, 0x3E80000000000000
  %cmp11.i61 = fcmp ult float %add9.i60, %add.i55115.ph
  br i1 %cmp11.i61, label %if.end18.i69, label %if.then12.i62

if.then12.i62:                                    ; preds = %if.else.i59
  %idxprom14.i63 = sext i32 %inc4648.i49 to i64
  %arrayidx15.i64 = getelementptr inbounds [16 x i32], ptr %point_indices.i39, i64 0, i64 %idxprom14.i63
  %32 = trunc i64 %indvars.iv.i48 to i32
  store i32 %32, ptr %arrayidx15.i64, align 4
  %inc.i65 = add nsw i32 %inc4648.i49, 1
  br label %if.end18.i69

if.end18.i69:                                     ; preds = %if.then12.i62, %if.else.i59, %for.body.i47
  %.pr107 = phi i32 [ %.sink.i67118, %if.else.i59 ], [ %.sink.i67118, %for.body.i47 ], [ %inc.i65, %if.then12.i62 ]
  %inc45.i70 = phi i32 [ %inc4648.i49, %if.else.i59 ], [ %inc4648.i49, %for.body.i47 ], [ %inc.i65, %if.then12.i62 ]
  %indvars.iv.next.i71 = add nuw nsw i64 %indvars.iv.i48, 1
  %exitcond.not.i72 = icmp eq i64 %indvars.iv.next.i71, %wide.trip.count.i46
  br i1 %exitcond.not.i72, label %for.cond20.preheader.i73, label %for.body.i47

if.end18.i69.thread:                              ; preds = %if.then.i57
  %33 = trunc i64 %indvars.iv.i48 to i32
  store i32 %33, ptr %point_indices.i39, align 16
  %indvars.iv.next.i71138 = add nuw nsw i64 %indvars.iv.i48, 1
  %exitcond.not.i72139 = icmp eq i64 %indvars.iv.next.i71138, %wide.trip.count.i46
  br i1 %exitcond.not.i72139, label %for.cond20.preheader.i73.thread, label %for.body.i47.outer

for.cond20.preheader.i73.thread:                  ; preds = %if.end18.i69.thread
  store float %add.i55, ptr %contacts2, align 4
  store i32 1, ptr %m_point_count.i40, align 4
  br label %for.body23.preheader.i75

for.body23.i77:                                   ; preds = %for.body23.i77, %for.body23.preheader.i75.new
  %indvars.iv53.i78 = phi i64 [ 0, %for.body23.preheader.i75.new ], [ %indvars.iv.next54.i83.1, %for.body23.i77 ]
  %niter170 = phi i64 [ 0, %for.body23.preheader.i75.new ], [ %niter170.next.1, %for.body23.i77 ]
  %arrayidx25.i79 = getelementptr inbounds [16 x i32], ptr %point_indices.i39, i64 0, i64 %indvars.iv53.i78
  %34 = load i32, ptr %arrayidx25.i79, align 8
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx29.i82, ptr noundef nonnull align 16 dereferenceable(16) %arrayidx27.i81, i64 16, i1 false)
  ...
  %35 = load i32, ptr %arrayidx25.i79.1, align 4
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx29.i82.1, ptr noundef nonnull align 16 dereferenceable(16) %arrayidx27.i81.1, i64 16, i1 false)
  ...
  br i1 %niter170.ncmp.1, label %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86.loopexit.unr-lcssa, label %for.body23.i77

_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86.loopexit.unr-lcssa: ; preds = %for.body23.i77, %for.body23.preheader.i75
  %indvars.iv53.i78.unr = phi i64 [ 0, %for.body23.preheader.i75 ], [ %indvars.iv.next54.i83.1, %for.body23.i77 ]
  %lcmp.mod168.not = icmp eq i64 %xtraiter167, 0
  br i1 %lcmp.mod168.not, label %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86, label %for.body23.i77.epil

for.body23.i77.epil:                              ; preds = %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86.loopexit.unr-lcssa
  %arrayidx25.i79.epil = getelementptr inbounds [16 x i32], ptr %point_indices.i39, i64 0, i64 %indvars.iv53.i78.unr
  %36 = load i32, ptr %arrayidx25.i79.epil, align 4
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx29.i82.epil, ptr noundef nonnull align 16 dereferenceable(16) %arrayidx27.i81.epil, i64 16, i1 false)
  br label %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86

_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86: ; preds = %for.body23.i77.epil, %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86.loopexit.unr-lcssa, %for.cond20.preheader.i73
  %.pr107140146 = phi i32 [ %.pr107, %for.cond20.preheader.i73 ], [ %.pr107140147, %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86.loopexit.unr-lcssa ], [ %.pr107140147, %for.body23.i77.epil ]
  %37 = phi float [ %add.i55115.ph, %for.cond20.preheader.i73 ], [ %25, %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86.loopexit.unr-lcssa ], [ %25, %for.body23.i77.epil ]
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %point_indices.i39) #9
...
while.body.preheader.i:                           ; preds = %if.end22
  ...
  store i32 %.pr107140146, ptr %m_point_count4.i, align 4
...
while.body.preheader.i96:                         ; preds = %if.end22
  ...
  store i32 %.pr128134, ptr %m_point_count4.i, align 4
...
entry:
  ...
  %sub.i24.i = fsub float %8, %3
  %arrayidx5.i25.i = getelementptr inbounds %class.btTriangleShape, ptr %this, i64 0, i32 1, i64 2, i32 0, i64 1
  %9 = load float, ptr %arrayidx5.i25.i, align 4
  %sub8.i27.i = fsub float %9, %5
  %arrayidx11.i28.i = getelementptr inbounds %class.btTriangleShape, ptr %this, i64 0, i32 1, i64 2, i32 0, i64 2
  %10 = load float, ptr %arrayidx11.i28.i, align 8
  %sub14.i30.i = fsub float %10, %7
  %11 = fneg float %sub14.i.i
  %neg.i.i = fmul float %sub8.i27.i, %11
  %12 = tail call float @llvm.fmuladd.f32(float %sub8.i.i, float %sub14.i30.i, float %neg.i.i)
  %13 = fneg float %sub.i.i
  %neg19.i.i = fmul float %sub14.i30.i, %13
  %14 = tail call float @llvm.fmuladd.f32(float %sub14.i.i, float %sub.i24.i, float %neg19.i.i)
  %15 = fneg float %sub8.i.i
  %neg30.i.i = fmul float %sub.i24.i, %15
  ...
  %m_vertices1.i56 = getelementptr inbounds %class.btTriangleShape, ptr %other, i64 0, i32 1
  %arrayidx.i57 = getelementptr inbounds %class.btTriangleShape, ptr %other, i64 0, i32 1, i64 1
  %19 = load float, ptr %arrayidx.i57, align 8
  %20 = load float, ptr %m_vertices1.i56, align 8
  %arrayidx6.i65 = getelementptr inbounds %class.btTriangleShape, ptr %other, i64 0, i32 1, i64 2
  %21 = load float, ptr %arrayidx6.i65, align 8
  %arrayidx5.i.i84 = getelementptr inbounds %class.btTriangleShape, ptr %other, i64 0, i32 1, i64 0, i32 0, i64 1
  %22 = load float, ptr %arrayidx5.i.i84, align 4
  ...
  %sub.i101 = extractelement <2 x float> %43, i64 0
  ...
  %shift139 = shufflevector <2 x i1> %58, <2 x i1> poison, <2 x i32> <i32 1, i32 poison>
  %59 = and <2 x i1> %58, %shift139
  %or.cond = extractelement <2 x i1> %59, i64 0
  %cmp16 = fcmp ogt float %sub13, 0.000000e+00
  %or.cond41 = and i1 %cmp16, %or.cond
  br i1 %or.cond41, label %cleanup, label %if.end

if.end:                                           ; preds = %entry
  %sub.i.i58 = fsub float %19, %20
  %sub8.i27.i68 = fsub float %26, %22
  %sub.i24.i66 = fsub float %21, %20
  %sub8.i.i61 = fsub float %24, %22
  %60 = fneg float %sub8.i.i61
  %neg30.i.i73 = fmul float %sub.i24.i66, %60
  %61 = tail call float @llvm.fmuladd.f32(float %sub.i.i58, float %sub8.i27.i68, float %neg30.i.i73)
  %sub14.i30.i70 = fsub float %27, %23
  %sub14.i.i64 = fsub float %25, %23
  %62 = fneg float %sub14.i.i64
  %neg.i.i71 = fmul float %sub8.i27.i68, %62
  %63 = tail call float @llvm.fmuladd.f32(float %sub8.i.i61, float %sub14.i30.i70, float %neg.i.i71)
  %64 = fneg float %sub.i.i58
  %neg19.i.i72 = fmul float %sub14.i30.i70, %64
  %65 = tail call float @llvm.fmuladd.f32(float %sub14.i.i64, float %sub.i24.i66, float %neg19.i.i72)
  %mul8.i.i.i.i.i74 = fmul float %65, %65
  %66 = tail call float @llvm.fmuladd.f32(float %63, float %63, float %mul8.i.i.i.i.i74)
  %67 = tail call float @llvm.fmuladd.f32(float %61, float %61, float %66)
  %sqrt.i.i.i75 = tail call float @llvm.sqrt.f32(float %67)
  %div.i.i.i76 = fdiv float 1.000000e+00, %sqrt.i.i.i75
  %mul7.i.i.i.i79 = fmul float %61, %div.i.i.i76
  %mul.i.i.i.i77 = fmul float %63, %div.i.i.i76
  %mul4.i.i.i.i78 = fmul float %65, %div.i.i.i76
  %68 = insertelement <2 x float> poison, float %9, i64 0
  %69 = insertelement <2 x float> %68, float %22, i64 1
  %70 = insertelement <2 x float> poison, float %mul4.i.i.i.i78, i64 0
  %71 = shufflevector <2 x float> %70, <2 x float> poison, <2 x i32> zeroinitializer
  %72 = fmul <2 x float> %69, %71
  %73 = insertelement <2 x float> poison, float %8, i64 0
  %74 = insertelement <2 x float> %73, float %20, i64 1
  %75 = insertelement <2 x float> poison, float %mul.i.i.i.i77, i64 0
  ...
  %80 = insertelement <2 x float> poison, float %mul7.i.i.i.i79, i64 0
  %81 = shufflevector <2 x float> %80, <2 x float> poison, <2 x i32> zeroinitializer
  %82 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %79, <2 x float> %81, <2 x float> %77)
  %shift140 = shufflevector <2 x float> %82, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %83 = fsub <2 x float> %82, %shift140
  %sub.i122 = extractelement <2 x float> %83, i64 0
  ...
  %shift141 = shufflevector <2 x i1> %96, <2 x i1> poison, <2 x i32> <i32 1, i32 poison>
  %97 = and <2 x i1> %96, %shift141
  %or.cond42 = extractelement <2 x i1> %97, i64 0
  %cmp33 = fcmp ogt float %sub28, 0.000000e+00
  %or.cond43 = and i1 %cmp33, %or.cond42
  %not.or.cond43 = xor i1 %or.cond43, true
  br label %cleanup

cleanup:                                          ; preds = %if.end, %entry
  %retval.0 = phi i1 [ false, %entry ], [ %not.or.cond43, %if.end ]
  ret i1 %retval.0
}
...
attributes #5 = { inlinehint uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
