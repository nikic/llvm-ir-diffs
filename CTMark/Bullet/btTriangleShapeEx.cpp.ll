...
entry:
  ...
  %4 = load float, ptr %m_plane, align 4, !tbaa !14
  ...
  %7 = load float, ptr %arrayidx7.i.i, align 4, !tbaa !14
  ...
  %10 = load float, ptr %arrayidx12.i.i, align 4, !tbaa !14
  ...
  %18 = load float, ptr %arrayidx10.i.i68, align 4, !tbaa !14
...
if.end:                                           ; preds = %entry
  ...
  %42 = load float, ptr %m_plane16, align 4, !tbaa !14
  ...
  %45 = load float, ptr %arrayidx7.i.i73, align 4, !tbaa !14
  ...
  %56 = load float, ptr %arrayidx10.i.i89, align 4, !tbaa !14
...
entry:
  ...
  %2 = load float, ptr %m_plane.i, align 4, !tbaa !14
  %3 = load <2 x float>, ptr %arrayidx5.i.i.i, align 4, !tbaa !14
  %4 = load <2 x float>, ptr %arrayidx7.i.i.i, align 4, !tbaa !14
  %5 = fsub <2 x float> %3, %4
  %6 = load <2 x float>, ptr %arrayidx7.i13.i.i, align 4, !tbaa !14
...
if.end:                                           ; preds = %entry
  ...
  %32 = load float, ptr %m_plane.i, align 4, !tbaa !14
  %33 = load <2 x float>, ptr %arrayidx5.i.i.i33, align 4, !tbaa !14
  %34 = load <2 x float>, ptr %arrayidx5.i.i.i, align 4, !tbaa !14
  %35 = fsub <2 x float> %33, %34
  %36 = load <2 x float>, ptr %arrayidx7.i13.i.i, align 4, !tbaa !14
...
if.end18:                                         ; preds = %if.end
  ...
  %62 = load float, ptr %m_plane.i, align 4, !tbaa !14
  %63 = load <2 x float>, ptr %arrayidx7.i.i.i, align 4, !tbaa !14
  %64 = load <2 x float>, ptr %arrayidx5.i.i.i33, align 4, !tbaa !14
  %65 = fsub <2 x float> %63, %64
  %66 = load <2 x float>, ptr %arrayidx7.i13.i.i, align 4, !tbaa !14
...
if.then:                                          ; preds = %entry
  ...
  %.pre119 = load float, ptr %arrayidx7.i.i, align 4, !tbaa !14
  %.pre120 = load float, ptr %arrayidx12.i.i, align 4, !tbaa !14
  %.pre121 = load float, ptr %arrayidx.i, align 4, !tbaa !14
  br label %if.end
...
if.then.i41:                                      ; preds = %_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit
  ...
  store <2 x float> %46, ptr %arrayidx.i46, align 4, !tbaa.struct !16
  %ref.tmp.sroa.4.0..sroa_idx.i.i64 = getelementptr inbounds i8, ptr %arrayidx.i46, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i.i63, ptr %ref.tmp.sroa.4.0..sroa_idx.i.i64, align 4, !tbaa.struct !20
...
if.then7.i67:                                     ; preds = %if.end.i66
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx9.i69, ptr noundef nonnull align 4 dereferenceable(16) %point2, i64 16, i1 false), !tbaa.struct !16
...
if.then.i75:                                      ; preds = %_Z29bt_plane_clip_polygon_collectRK9btVector3S1_ffPS_Ri.exit71
  ...
  store <2 x float> %57, ptr %arrayidx.i80, align 4, !tbaa.struct !16
  %ref.tmp.sroa.4.0..sroa_idx.i.i98 = getelementptr inbounds i8, ptr %arrayidx.i80, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i.i97, ptr %ref.tmp.sroa.4.0..sroa_idx.i.i98, align 4, !tbaa.struct !20
...
if.then7.i101:                                    ; preds = %if.end.i100
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx9.i103, ptr noundef nonnull align 4 dereferenceable(16) %point0, i64 16, i1 false), !tbaa.struct !16
...
if.then.i46:                                      ; preds = %for.body
  ...
  %31 = load float, ptr %arrayidx7.i.i.i.i56, align 4, !tbaa !14
  ...
  store <2 x float> %39, ptr %arrayidx.i51, align 4, !tbaa.struct !16
  %ref.tmp.sroa.4.0..sroa_idx.i.i69 = getelementptr inbounds i8, ptr %arrayidx.i51, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i.i68, ptr %ref.tmp.sroa.4.0..sroa_idx.i.i69, align 4, !tbaa.struct !20
...
if.then7.i72:                                     ; preds = %if.end.i71
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx9.i74, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx5, i64 16, i1 false), !tbaa.struct !16
...
for.body.lr.ph.i42:                               ; preds = %if.end16
  ...
  %22 = load float, ptr %arrayidx7.i.i.i43, align 4, !tbaa !14
  %23 = load float, ptr %arrayidx12.i.i.i44, align 4, !tbaa !14
  %24 = load float, ptr %arrayidx.i.i45, align 4, !tbaa !14
...
for.cond20.preheader.i73:                         ; preds = %if.end18.i69
  store float %add.i55115.ph, ptr %contacts2, align 4, !tbaa !13
...
for.body.i47:                                     ; preds = %for.body.i47.outer, %if.end18.i69
  ...
  %27 = load float, ptr %arrayidx.i50, align 16, !tbaa !14
  %arrayidx5.i.i.i51 = getelementptr inbounds [4 x float], ptr %arrayidx.i50, i64 0, i64 1
  %28 = load float, ptr %arrayidx5.i.i.i51, align 4, !tbaa !14
  ...
  %30 = load float, ptr %arrayidx10.i.i.i53, align 8, !tbaa !14
...
if.then12.i62:                                    ; preds = %if.else.i59
  ...
  store i32 %32, ptr %arrayidx15.i64, align 4, !tbaa !15
...
for.cond20.preheader.i73.thread:                  ; preds = %if.end18.i69.thread
  store float %add.i55, ptr %contacts2, align 4, !tbaa !13
...
entry:
  ...
  %3 = load float, ptr %m_vertices1.i, align 8, !tbaa !14
  ...
  %9 = load float, ptr %arrayidx5.i25.i, align 4, !tbaa !14
  ...
  %10 = load float, ptr %arrayidx11.i28.i, align 8, !tbaa !14
