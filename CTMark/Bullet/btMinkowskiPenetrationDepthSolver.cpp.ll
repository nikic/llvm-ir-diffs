; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btMinkowskiPenetrationDepthSolver.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btMinkowskiPenetrationDepthSolver.cpp"
...
land.rhs:                                         ; preds = %entry
  %m_shapeType.i.i343 = getelementptr inbounds %class.btCollisionShape, ptr %convexB, i64 0, i32 1
  %3 = load i32, ptr %m_shapeType.i.i343, align 8
  %4 = add i32 %3, -17
  %5 = icmp ult i32 %4, 2
  br label %land.end
...
land.end:                                         ; preds = %land.rhs, %entry
  ...
  %9 = load <2 x float>, ptr %arrayidx9.i.i, align 4
  %arrayidx.i.i12.i = getelementptr inbounds [4 x float], ptr %transA, i64 0, i64 2
  %10 = load float, ptr %arrayidx.i.i12.i, align 4
  %arrayidx.i14.i13.i = getelementptr inbounds [3 x %class.btVector3], ptr %transA, i64 0, i64 1, i32 0, i64 2
  %11 = load float, ptr %arrayidx.i14.i13.i, align 4
  %arrayidx.i16.i16.i = getelementptr inbounds [3 x %class.btVector3], ptr %transA, i64 0, i64 2, i32 0, i64 2
  %12 = load float, ptr %arrayidx.i16.i16.i, align 4
  %arrayidx4.i.i351 = getelementptr inbounds [3 x %class.btVector3], ptr %transB, i64 0, i64 1
  %arrayidx9.i.i354 = getelementptr inbounds [3 x %class.btVector3], ptr %transB, i64 0, i64 2
  %arrayidx.i.i9.i356 = getelementptr inbounds [4 x float], ptr %transB, i64 0, i64 1
  %arrayidx.i14.i10.i357 = getelementptr inbounds [3 x %class.btVector3], ptr %transB, i64 0, i64 1, i32 0, i64 1
  %arrayidx.i16.i.i359 = getelementptr inbounds [3 x %class.btVector3], ptr %transB, i64 0, i64 2, i32 0, i64 1
  %13 = load <2 x float>, ptr %transB, align 4
  %14 = load <2 x float>, ptr %arrayidx4.i.i351, align 4
  %15 = load <2 x float>, ptr %arrayidx9.i.i354, align 4
  %arrayidx.i.i12.i360 = getelementptr inbounds [4 x float], ptr %transB, i64 0, i64 2
  %16 = load float, ptr %arrayidx.i.i12.i360, align 4
  %arrayidx.i14.i13.i361 = getelementptr inbounds [3 x %class.btVector3], ptr %transB, i64 0, i64 1, i32 0, i64 2
  %17 = load float, ptr %arrayidx.i14.i13.i361, align 4
  %arrayidx.i16.i16.i363 = getelementptr inbounds [3 x %class.btVector3], ptr %transB, i64 0, i64 2, i32 0, i64 2
  %18 = load float, ptr %arrayidx.i16.i16.i363, align 4
  br label %for.body
...
for.body:                                         ; preds = %land.end, %for.body
  ...
  %norm.sroa.5.0.copyload = load float, ptr %norm.sroa.5.0.arrayidx.sroa_idx, align 4
  %norm.sroa.7.0.arrayidx.sroa_idx = getelementptr inbounds i8, ptr %arrayidx, i64 8
  %norm.sroa.7.0.copyload = load float, ptr %norm.sroa.7.0.arrayidx.sroa_idx, align 8
  ...
  %retval.sroa.3.12.vec.insert.i348 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %29, i64 0
  %arrayidx33 = getelementptr inbounds [62 x %class.btVector3], ptr %seperatingAxisInABatch, i64 0, i64 %indvars.iv
  store <2 x float> %27, ptr %arrayidx33, align 16
  %ref.tmp26.sroa.4.0.arrayidx33.sroa_idx = getelementptr inbounds i8, ptr %arrayidx33, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i348, ptr %ref.tmp26.sroa.4.0.arrayidx33.sroa_idx, align 8
  ...
  %mul7.i15.i362 = fmul float %norm.sroa.5.0.copyload, %17
  %39 = tail call float @llvm.fmuladd.f32(float %16, float %norm.sroa.0.0.copyload, float %mul7.i15.i362)
  %40 = tail call float @llvm.fmuladd.f32(float %18, float %norm.sroa.7.0.copyload, float %39)
  %retval.sroa.3.12.vec.insert.i366 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %40, i64 0
  %arrayidx39 = getelementptr inbounds [62 x %class.btVector3], ptr %seperatingAxisInBBatch, i64 0, i64 %indvars.iv
  store <2 x float> %38, ptr %arrayidx39, align 16
  %ref.tmp34.sroa.4.0.arrayidx39.sroa_idx = getelementptr inbounds i8, ptr %arrayidx39, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i366, ptr %ref.tmp34.sroa.4.0.arrayidx39.sroa_idx, align 8
...
for.end:                                          ; preds = %for.body
  ...
  %cmp43670 = icmp sgt i32 %call40, 0
  br i1 %cmp43670, label %for.body44.lr.ph, label %if.end
...
for.body44:                                       ; preds = %for.body44.lr.ph, %for.body44
  %indvars.iv695 = phi i64 [ 42, %for.body44.lr.ph ], [ %indvars.iv.next696, %for.body44 ]
  %i41.0671 = phi i32 [ 0, %for.body44.lr.ph ], [ %inc71, %for.body44 ]
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %norm45) #12
  %vtable46 = load ptr, ptr %convexA, align 8
  %vfn47 = getelementptr inbounds ptr, ptr %vtable46, i64 17
  %42 = load ptr, ptr %vfn47, align 8
  call void %42(ptr noundef nonnull align 8 dereferenceable(24) %convexA, i32 noundef %i41.0671, ptr noundef nonnull align 4 dereferenceable(16) %norm45)
  %43 = load <4 x float>, ptr %transA, align 4
  %44 = shufflevector <4 x float> %43, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %45 = load float, ptr %norm45, align 8
  %46 = load <4 x float>, ptr %arrayidx.i.i9.i, align 4
  %47 = shufflevector <4 x float> %46, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %48 = load float, ptr %arrayidx7.i.i, align 4
  %49 = load <4 x float>, ptr %arrayidx.i.i12.i, align 4
  ...
  %53 = load float, ptr %arrayidx.i14.i10.i, align 4
  %54 = load float, ptr %arrayidx.i14.i13.i, align 4
  ...
  %68 = load float, ptr %arrayidx.i16.i.i, align 4
  %mul8.i20.i = fmul float %48, %68
  %69 = call float @llvm.fmuladd.f32(float %67, float %45, float %mul8.i20.i)
  %70 = load float, ptr %arrayidx.i16.i16.i, align 4
  %71 = call float @llvm.fmuladd.f32(float %70, float %51, float %69)
  %retval.sroa.3.12.vec.insert.i371 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %71, i64 0
  store <2 x float> %66, ptr %norm45, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i371, ptr %arrayidx12.i.i, align 8
  %arrayidx53 = getelementptr inbounds [62 x %class.btVector3], ptr @_ZL22sPenetrationDirections, i64 0, i64 %indvars.iv695
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %arrayidx53, ptr noundef nonnull align 8 dereferenceable(16) %norm45, i64 16, i1 false)
  %72 = extractelement <2 x float> %66, i64 0
  %fneg.i374 = fneg float %72
  %73 = extractelement <2 x float> %66, i64 1
  %fneg4.i376 = fneg float %73
  %fneg8.i378 = fneg float %71
  %74 = load <2 x float>, ptr %transA, align 4
  %75 = load <2 x float>, ptr %arrayidx4.i.i, align 4
  %76 = insertelement <2 x float> poison, float %fneg4.i376, i64 0
  %77 = shufflevector <2 x float> %76, <2 x float> poison, <2 x i32> zeroinitializer
  %78 = fmul <2 x float> %75, %77
  %79 = insertelement <2 x float> poison, float %fneg.i374, i64 0
  %80 = shufflevector <2 x float> %79, <2 x float> poison, <2 x i32> zeroinitializer
  %81 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %74, <2 x float> %80, <2 x float> %78)
  %82 = load <2 x float>, ptr %arrayidx9.i.i, align 4
  %83 = insertelement <2 x float> poison, float %fneg8.i378, i64 0
  %84 = shufflevector <2 x float> %83, <2 x float> poison, <2 x i32> zeroinitializer
  %85 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %82, <2 x float> %84, <2 x float> %81)
  %86 = load float, ptr %arrayidx.i.i12.i, align 4
  %87 = load float, ptr %arrayidx.i14.i13.i, align 4
  %mul7.i15.i395 = fmul float %87, %fneg4.i376
  %88 = call float @llvm.fmuladd.f32(float %86, float %fneg.i374, float %mul7.i15.i395)
  %89 = load float, ptr %arrayidx.i16.i16.i, align 4
  %90 = call float @llvm.fmuladd.f32(float %89, float %fneg8.i378, float %88)
  %retval.sroa.3.12.vec.insert.i399 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %90, i64 0
  %arrayidx62 = getelementptr inbounds [62 x %class.btVector3], ptr %seperatingAxisInABatch, i64 0, i64 %indvars.iv695
  store <2 x float> %85, ptr %arrayidx62, align 16
  %ref.tmp54.sroa.4.0.arrayidx62.sroa_idx = getelementptr inbounds i8, ptr %arrayidx62, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i399, ptr %ref.tmp54.sroa.4.0.arrayidx62.sroa_idx, align 8
  %91 = load <2 x float>, ptr %transB, align 4
  %92 = load <2 x float>, ptr %arrayidx4.i.i351, align 4
  ...
  %97 = load <2 x float>, ptr %arrayidx9.i.i354, align 4
  ...
  %101 = load float, ptr %arrayidx.i.i12.i360, align 4
  %102 = load float, ptr %arrayidx.i14.i13.i361, align 4
  %mul7.i15.i413 = fmul float %73, %102
  %103 = call float @llvm.fmuladd.f32(float %101, float %72, float %mul7.i15.i413)
  %104 = load float, ptr %arrayidx.i16.i16.i363, align 4
  %105 = call float @llvm.fmuladd.f32(float %104, float %71, float %103)
  %retval.sroa.3.12.vec.insert.i417 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %105, i64 0
  %arrayidx68 = getelementptr inbounds [62 x %class.btVector3], ptr %seperatingAxisInBBatch, i64 0, i64 %indvars.iv695
  store <2 x float> %100, ptr %arrayidx68, align 16
  %ref.tmp63.sroa.4.0.arrayidx68.sroa_idx = getelementptr inbounds i8, ptr %arrayidx68, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i417, ptr %ref.tmp63.sroa.4.0.arrayidx68.sroa_idx, align 8
  %indvars.iv.next696 = add nuw nsw i64 %indvars.iv695, 1
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %norm45) #12
  %inc71 = add nuw nsw i32 %i41.0671, 1
  %exitcond698.not = icmp eq i32 %inc71, %call40
  br i1 %exitcond698.not, label %if.end.loopexit, label %for.body44

if.end.loopexit:                                  ; preds = %for.body44
  %106 = trunc i64 %indvars.iv.next696 to i32
  br label %if.end

if.end:                                           ; preds = %if.end.loopexit, %for.end
  %numSampleDirections.1 = phi i32 [ 42, %for.end ], [ %106, %if.end.loopexit ]
  %vtable73 = load ptr, ptr %convexB, align 8
  ...
  %cmp80673 = icmp sgt i32 %call75, 0
  br i1 %cmp80673, label %for.body82.lr.ph, label %if.end111

for.body82.lr.ph:                                 ; preds = %if.end
  %arrayidx7.i.i421 = getelementptr inbounds [4 x float], ptr %norm83, i64 0, i64 1
  %arrayidx12.i.i424 = getelementptr inbounds [4 x float], ptr %norm83, i64 0, i64 2
  %108 = zext i32 %numSampleDirections.1 to i64
  br label %for.body82

for.body82:                                       ; preds = %for.body82.lr.ph, %for.body82
  %indvars.iv699 = phi i64 [ %108, %for.body82.lr.ph ], [ %indvars.iv.next700, %for.body82 ]
  %i78.0674 = phi i32 [ 0, %for.body82.lr.ph ], [ %inc109, %for.body82 ]
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %norm83) #12
  %vtable84 = load ptr, ptr %convexB, align 8
  %vfn85 = getelementptr inbounds ptr, ptr %vtable84, i64 17
  %109 = load ptr, ptr %vfn85, align 8
  call void %109(ptr noundef nonnull align 8 dereferenceable(24) %convexB, i32 noundef %i78.0674, ptr noundef nonnull align 4 dereferenceable(16) %norm83)
  %110 = load <4 x float>, ptr %transB, align 4
  %111 = shufflevector <4 x float> %110, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %112 = load float, ptr %norm83, align 8
  %113 = load <4 x float>, ptr %arrayidx.i.i9.i356, align 4
  %114 = shufflevector <4 x float> %113, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %115 = load float, ptr %arrayidx7.i.i421, align 4
  %116 = load <4 x float>, ptr %arrayidx.i.i12.i360, align 4
  %117 = shufflevector <4 x float> %116, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %118 = load float, ptr %arrayidx12.i.i424, align 8
  %119 = load float, ptr %arrayidx4.i.i351, align 4
  %120 = load float, ptr %arrayidx.i14.i10.i357, align 4
  %121 = load float, ptr %arrayidx.i14.i13.i361, align 4
  %122 = insertelement <2 x float> poison, float %115, i64 0
  %123 = shufflevector <2 x float> %122, <2 x float> poison, <2 x i32> zeroinitializer
  %124 = insertelement <2 x float> %114, float %120, i64 1
  %125 = fmul <2 x float> %123, %124
  %126 = insertelement <2 x float> %111, float %119, i64 1
  %127 = insertelement <2 x float> poison, float %112, i64 0
  ...
  %130 = insertelement <2 x float> %117, float %121, i64 1
  %131 = insertelement <2 x float> poison, float %118, i64 0
  %132 = shufflevector <2 x float> %131, <2 x float> poison, <2 x i32> zeroinitializer
  %133 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %130, <2 x float> %132, <2 x float> %129)
  %134 = load float, ptr %arrayidx9.i.i354, align 4
  %135 = load float, ptr %arrayidx.i16.i.i359, align 4
  %mul8.i20.i431 = fmul float %115, %135
  %136 = call float @llvm.fmuladd.f32(float %134, float %112, float %mul8.i20.i431)
  %137 = load float, ptr %arrayidx.i16.i16.i363, align 4
  %138 = call float @llvm.fmuladd.f32(float %137, float %118, float %136)
  %retval.sroa.3.12.vec.insert.i435 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %138, i64 0
  store <2 x float> %133, ptr %norm83, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i435, ptr %arrayidx12.i.i424, align 8
  %arrayidx91 = getelementptr inbounds [62 x %class.btVector3], ptr @_ZL22sPenetrationDirections, i64 0, i64 %indvars.iv699
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %arrayidx91, ptr noundef nonnull align 8 dereferenceable(16) %norm83, i64 16, i1 false)
  %139 = extractelement <2 x float> %133, i64 0
  %fneg.i438 = fneg float %139
  %140 = extractelement <2 x float> %133, i64 1
  %fneg4.i440 = fneg float %140
  %fneg8.i442 = fneg float %138
  %141 = load <2 x float>, ptr %transA, align 4
  %142 = load <2 x float>, ptr %arrayidx4.i.i, align 4
  %143 = insertelement <2 x float> poison, float %fneg4.i440, i64 0
  %144 = shufflevector <2 x float> %143, <2 x float> poison, <2 x i32> zeroinitializer
  %145 = fmul <2 x float> %142, %144
  %146 = insertelement <2 x float> poison, float %fneg.i438, i64 0
  ...
  %149 = load <2 x float>, ptr %arrayidx9.i.i, align 4
  %150 = insertelement <2 x float> poison, float %fneg8.i442, i64 0
  ...
  %153 = load float, ptr %arrayidx.i.i12.i, align 4
  %154 = load float, ptr %arrayidx.i14.i13.i, align 4
  %mul7.i15.i459 = fmul float %154, %fneg4.i440
  %155 = call float @llvm.fmuladd.f32(float %153, float %fneg.i438, float %mul7.i15.i459)
  %156 = load float, ptr %arrayidx.i16.i16.i, align 4
  %157 = call float @llvm.fmuladd.f32(float %156, float %fneg8.i442, float %155)
  %retval.sroa.3.12.vec.insert.i463 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %157, i64 0
  %arrayidx100 = getelementptr inbounds [62 x %class.btVector3], ptr %seperatingAxisInABatch, i64 0, i64 %indvars.iv699
  store <2 x float> %152, ptr %arrayidx100, align 16
  %ref.tmp92.sroa.4.0.arrayidx100.sroa_idx = getelementptr inbounds i8, ptr %arrayidx100, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i463, ptr %ref.tmp92.sroa.4.0.arrayidx100.sroa_idx, align 8
  %158 = load <2 x float>, ptr %transB, align 4
  %159 = load <2 x float>, ptr %arrayidx4.i.i351, align 4
  ...
  %164 = load <2 x float>, ptr %arrayidx9.i.i354, align 4
  ...
  %168 = load float, ptr %arrayidx.i.i12.i360, align 4
  %169 = load float, ptr %arrayidx.i14.i13.i361, align 4
  %mul7.i15.i477 = fmul float %140, %169
  %170 = call float @llvm.fmuladd.f32(float %168, float %139, float %mul7.i15.i477)
  %171 = load float, ptr %arrayidx.i16.i16.i363, align 4
  %172 = call float @llvm.fmuladd.f32(float %171, float %138, float %170)
  %retval.sroa.3.12.vec.insert.i481 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %172, i64 0
  %arrayidx106 = getelementptr inbounds [62 x %class.btVector3], ptr %seperatingAxisInBBatch, i64 0, i64 %indvars.iv699
  store <2 x float> %167, ptr %arrayidx106, align 16
  %ref.tmp101.sroa.4.0.arrayidx106.sroa_idx = getelementptr inbounds i8, ptr %arrayidx106, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i481, ptr %ref.tmp101.sroa.4.0.arrayidx106.sroa_idx, align 8
  %indvars.iv.next700 = add nuw nsw i64 %indvars.iv699, 1
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %norm83) #12
  %inc109 = add nuw nsw i32 %i78.0674, 1
  %exitcond702.not = icmp eq i32 %inc109, %call75
  br i1 %exitcond702.not, label %if.end111.loopexit, label %for.body82

if.end111.loopexit:                               ; preds = %for.body82
  %173 = trunc i64 %indvars.iv.next700 to i32
  br label %if.end111
...
if.end111:                                        ; preds = %if.end111.loopexit, %if.end
  ...
  %vtable113 = load ptr, ptr %convexA, align 8
  ...
  %vtable117 = load ptr, ptr %convexB, align 8
  ...
  %cmp120677 = icmp sgt i32 %numSampleDirections.3, 0
  br i1 %cmp120677, label %for.body121.lr.ph, label %for.end164
...
for.body121.lr.ph:                                ; preds = %if.end111
  ...
  %180 = load float, ptr %arrayidx4.i.i, align 4
  %181 = load float, ptr %arrayidx.i14.i10.i, align 4
  %182 = load float, ptr %arrayidx.i14.i13.i, align 4
  %arrayidx.i25.i = getelementptr inbounds %class.btTransform, ptr %transA, i64 0, i32 1, i32 0, i64 1
  %183 = load float, ptr %arrayidx.i25.i, align 4
  %184 = load float, ptr %arrayidx9.i.i, align 4
  %185 = load float, ptr %arrayidx.i16.i.i, align 4
  %186 = load float, ptr %arrayidx.i16.i16.i, align 4
  %arrayidx.i32.i = getelementptr inbounds %class.btTransform, ptr %transA, i64 0, i32 1, i32 0, i64 2
  %187 = load float, ptr %arrayidx.i32.i, align 4
  %188 = load <4 x float>, ptr %transB, align 4
  %189 = shufflevector <4 x float> %188, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %190 = load <4 x float>, ptr %arrayidx.i.i9.i356, align 4
  %191 = shufflevector <4 x float> %190, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %192 = load <4 x float>, ptr %arrayidx.i.i12.i360, align 4
  %193 = shufflevector <4 x float> %192, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %m_origin.i503 = getelementptr inbounds %class.btTransform, ptr %transB, i64 0, i32 1
  %194 = load <4 x float>, ptr %m_origin.i503, align 4
  %195 = shufflevector <4 x float> %194, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %196 = load <4 x float>, ptr %arrayidx4.i.i351, align 4
  %197 = shufflevector <4 x float> %196, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %198 = load <4 x float>, ptr %arrayidx.i14.i10.i357, align 4
  %199 = shufflevector <4 x float> %198, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %200 = load <4 x float>, ptr %arrayidx.i14.i13.i361, align 4
  %201 = shufflevector <4 x float> %200, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %arrayidx.i25.i509 = getelementptr inbounds %class.btTransform, ptr %transB, i64 0, i32 1, i32 0, i64 1
  %202 = load float, ptr %arrayidx.i25.i509, align 4
  %203 = load <4 x float>, ptr %arrayidx9.i.i354, align 4
  %204 = shufflevector <4 x float> %203, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %205 = load <4 x float>, ptr %arrayidx.i16.i.i359, align 4
  %206 = shufflevector <4 x float> %205, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %207 = load <4 x float>, ptr %arrayidx.i16.i16.i363, align 4
  %208 = shufflevector <4 x float> %207, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %arrayidx.i32.i515 = getelementptr inbounds %class.btTransform, ptr %transB, i64 0, i32 1, i32 0, i64 2
  %209 = load float, ptr %arrayidx.i32.i515, align 4
  %wide.trip.count = zext i32 %numSampleDirections.3 to i64
  %210 = insertelement <2 x float> poison, float %209, i64 0
  %211 = insertelement <2 x float> %210, float %187, i64 1
  %212 = insertelement <2 x float> %208, float %186, i64 1
  %213 = insertelement <2 x float> %204, float %184, i64 1
  %214 = insertelement <2 x float> %206, float %185, i64 1
  %215 = insertelement <2 x float> %195, float %179, i64 1
  %216 = insertelement <2 x float> %193, float %178, i64 1
  %217 = insertelement <2 x float> %189, float %176, i64 1
  %218 = insertelement <2 x float> %191, float %177, i64 1
  %219 = insertelement <2 x float> poison, float %202, i64 0
  %220 = insertelement <2 x float> %219, float %183, i64 1
  %221 = insertelement <2 x float> %201, float %182, i64 1
  %222 = insertelement <2 x float> %197, float %180, i64 1
  %223 = insertelement <2 x float> %199, float %181, i64 1
  br label %for.body121

for.body121:                                      ; preds = %for.body121.lr.ph, %if.end161
  %indvars.iv703 = phi i64 [ 0, %for.body121.lr.ph ], [ %indvars.iv.next704, %if.end161 ]
  %minProj.0687 = phi float [ 0x43ABC16D60000000, %for.body121.lr.ph ], [ %minProj.2, %if.end161 ]
  %minNorm.sroa.31.0685 = phi float [ 0.000000e+00, %for.body121.lr.ph ], [ %minNorm.sroa.31.1, %if.end161 ]
  %minNorm.sroa.22.0684 = phi float [ 0.000000e+00, %for.body121.lr.ph ], [ %minNorm.sroa.22.1, %if.end161 ]
  %224 = phi <2 x float> [ zeroinitializer, %for.body121.lr.ph ], [ %254, %if.end161 ]
  %arrayidx124 = getelementptr inbounds [62 x %class.btVector3], ptr @_ZL22sPenetrationDirections, i64 0, i64 %indvars.iv703
  ...
  %norm122.sroa.8.0.copyload = load float, ptr %norm122.sroa.8.0.arrayidx124.sroa_idx, align 8
  %norm122.sroa.11.0.arrayidx124.sroa_idx = getelementptr inbounds i8, ptr %arrayidx124, i64 12
  %norm122.sroa.11.0.copyload = load float, ptr %norm122.sroa.11.0.arrayidx124.sroa_idx, align 4
  %norm122.sroa.8.0 = select i1 %6, float 0.000000e+00, float %norm122.sroa.8.0.copyload
  %226 = extractelement <2 x float> %225, i64 1
  %mul8.i.i485 = fmul float %226, %226
  %227 = extractelement <2 x float> %225, i64 0
  %228 = call float @llvm.fmuladd.f32(float %227, float %227, float %mul8.i.i485)
...
if.then132:                                       ; preds = %for.body121
  %arrayidx138 = getelementptr inbounds [62 x %class.btVector3], ptr %supportVerticesABatch, i64 0, i64 %indvars.iv703
  %pInA.sroa.0.0.copyload = load float, ptr %arrayidx138, align 16
  %pInA.sroa.5.0.arrayidx138.sroa_idx = getelementptr inbounds i8, ptr %arrayidx138, i64 4
  %pInA.sroa.5.0.copyload = load float, ptr %pInA.sroa.5.0.arrayidx138.sroa_idx, align 4
  %pInA.sroa.6.0.arrayidx138.sroa_idx = getelementptr inbounds i8, ptr %arrayidx138, i64 8
  %pInA.sroa.6.0.copyload = load float, ptr %pInA.sroa.6.0.arrayidx138.sroa_idx, align 8
  %arrayidx140 = getelementptr inbounds [62 x %class.btVector3], ptr %supportVerticesBBatch, i64 0, i64 %indvars.iv703
  %qInB.sroa.0.0.copyload = load float, ptr %arrayidx140, align 16
  %qInB.sroa.5.0.arrayidx140.sroa_idx = getelementptr inbounds i8, ptr %arrayidx140, i64 4
  %qInB.sroa.5.0.copyload = load float, ptr %qInB.sroa.5.0.arrayidx140.sroa_idx, align 4
  %qInB.sroa.6.0.arrayidx140.sroa_idx = getelementptr inbounds i8, ptr %arrayidx140, i64 8
  %qInB.sroa.6.0.copyload = load float, ptr %qInB.sroa.6.0.arrayidx140.sroa_idx, align 8
  ...
  %shift709 = shufflevector <2 x float> %243, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %249 = fsub <2 x float> %243, %shift709
  %sub8.i = extractelement <2 x float> %249, i64 0
  %shift710 = shufflevector <2 x float> %247, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %250 = fsub <2 x float> %247, %shift710
  ...
  %cmp158 = fcmp olt float %253, %minProj.0687
...
if.end161:                                        ; preds = %if.then132, %if.then159, %for.body121
  %minNorm.sroa.22.1 = phi float [ %norm122.sroa.8.0, %if.then159 ], [ %minNorm.sroa.22.0684, %if.then132 ], [ %minNorm.sroa.22.0684, %for.body121 ]
  %minNorm.sroa.31.1 = phi float [ %norm122.sroa.11.0.copyload, %if.then159 ], [ %minNorm.sroa.31.0685, %if.then132 ], [ %minNorm.sroa.31.0685, %for.body121 ]
  %minProj.2 = phi float [ %253, %if.then159 ], [ %minProj.0687, %if.then132 ], [ %minProj.0687, %for.body121 ]
  %254 = phi <2 x float> [ %225, %if.then159 ], [ %224, %if.then132 ], [ %224, %for.body121 ]
  %indvars.iv.next704 = add nuw nsw i64 %indvars.iv703, 1
  %exitcond706.not = icmp eq i64 %indvars.iv.next704, %wide.trip.count
  br i1 %exitcond706.not, label %for.end164, label %for.body121

for.end164:                                       ; preds = %if.end161, %if.end111
  %minNorm.sroa.22.0.lcssa = phi float [ 0.000000e+00, %if.end111 ], [ %minNorm.sroa.22.1, %if.end161 ]
  %minNorm.sroa.31.0.lcssa = phi float [ 0.000000e+00, %if.end111 ], [ %minNorm.sroa.31.1, %if.end161 ]
  ...
  br i1 %cmp177, label %cleanup, label %invoke.cont205

invoke.cont205:                                   ; preds = %for.end164
  ...
  %mul8.i564 = fmul float %minNorm.sroa.22.0.lcssa, %add183
  ...
  store ptr null, ptr %m_stackAlloc.i, align 8
  %m_origin.i570 = getelementptr inbounds %class.btTransform, ptr %transA, i64 0, i32 1
  %256 = insertelement <2 x float> poison, float %add183, i64 0
  %257 = shufflevector <2 x float> %256, <2 x float> poison, <2 x i32> zeroinitializer
  %258 = fmul <2 x float> %255, %257
  %259 = load <2 x float>, ptr %m_origin.i570, align 4
  %260 = fadd <2 x float> %258, %259
  %arrayidx11.i575 = getelementptr inbounds %class.btTransform, ptr %transA, i64 0, i32 1, i32 0, i64 2
  %261 = load float, ptr %arrayidx11.i575, align 4
  %add14.i = fadd float %mul8.i564, %261
  %retval.sroa.3.12.vec.insert.i579 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i, i64 0
  ...
  %arrayidx7.i.i587 = getelementptr inbounds [3 x %class.btVector3], ptr %input, i64 0, i64 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx7.i.i587, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx4.i.i, i64 16, i1 false)
  ...
  %m_origin3.i590 = getelementptr inbounds %class.btTransform, ptr %input, i64 0, i32 1
  store <2 x float> %260, ptr %m_origin3.i590, align 8
  %displacedTrans.sroa.12.48.m_origin3.i590.sroa_idx = getelementptr inbounds %class.btTransform, ptr %input, i64 0, i32 1, i32 0, i64 2
  store <2 x float> %retval.sroa.3.12.vec.insert.i579, ptr %displacedTrans.sroa.12.48.m_origin3.i590.sroa_idx, align 8
  %m_transformB = getelementptr inbounds %"struct.btDiscreteCollisionDetectorInterface::ClosestPointInput", ptr %input, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_transformB, ptr noundef nonnull align 4 dereferenceable(16) %transB, i64 16, i1 false)
  %arrayidx7.i.i592 = getelementptr inbounds %"struct.btDiscreteCollisionDetectorInterface::ClosestPointInput", ptr %input, i64 0, i32 1, i32 0, i32 0, i64 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx7.i.i592, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx4.i.i351, i64 16, i1 false)
  %arrayidx11.i.i594 = getelementptr inbounds %"struct.btDiscreteCollisionDetectorInterface::ClosestPointInput", ptr %input, i64 0, i32 1, i32 0, i32 0, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx11.i.i594, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx9.i.i354, i64 16, i1 false)
  %m_origin.i595 = getelementptr inbounds %class.btTransform, ptr %transB, i64 0, i32 1
  %m_origin3.i596 = getelementptr inbounds %"struct.btDiscreteCollisionDetectorInterface::ClosestPointInput", ptr %input, i64 0, i32 1, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_origin3.i596, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i595, i64 16, i1 false)
  ...
  store ptr getelementptr inbounds ({ [7 x ptr] }, ptr @_ZTVZN33btMinkowskiPenetrationDepthSolver12calcPenDepthER22btVoronoiSimplexSolverPK13btConvexShapeS4_RK11btTransformS7_R9btVector3S9_S9_P12btIDebugDrawP12btStackAllocE20btIntermediateResult, i64 0, inrange i32 0, i64 2), ptr %res, align 8
  ...
  %fneg8.i601 = fneg float %minNorm.sroa.22.0.lcssa
  %retval.sroa.3.12.vec.insert.i604 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %fneg8.i601, i64 0
  %m_cachedSeparatingAxis.i = getelementptr inbounds %class.btGjkPairDetector, ptr %gjkdet, i64 0, i32 1
  store <2 x float> %262, ptr %m_cachedSeparatingAxis.i, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i604, ptr %ref.tmp203.sroa.5.0.m_cachedSeparatingAxis.i.sroa_idx, align 8
  ...
  %263 = load i8, ptr %m_hasResult.i, align 4
  %tobool214.not = icmp eq i8 %263, 0
  br i1 %tobool214.not, label %if.end226, label %invoke.cont222

invoke.cont222:                                   ; preds = %invoke.cont205
  %m_depth = getelementptr inbounds %struct.btIntermediateResult, ptr %res, i64 0, i32 3
  %264 = load float, ptr %m_depth, align 8
  %sub = fsub float %add183, %264
  %m_pointInWorld = getelementptr inbounds %struct.btIntermediateResult, ptr %res, i64 0, i32 2
  %mul8.i614 = fmul float %minNorm.sroa.22.0.lcssa, %sub
  %265 = insertelement <2 x float> poison, float %sub, i64 0
  %266 = shufflevector <2 x float> %265, <2 x float> poison, <2 x i32> zeroinitializer
  %267 = fmul <2 x float> %255, %266
  %268 = load <2 x float>, ptr %m_pointInWorld, align 8
  %269 = fsub <2 x float> %268, %267
  %arrayidx11.i624 = getelementptr inbounds %struct.btIntermediateResult, ptr %res, i64 0, i32 2, i32 0, i64 2
  %270 = load float, ptr %arrayidx11.i624, align 8
  %sub14.i626 = fsub float %270, %mul8.i614
  %retval.sroa.3.12.vec.insert.i629 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %sub14.i626, i64 0
  store <2 x float> %269, ptr %pa, align 4
  %ref.tmp216.sroa.5.0..sroa_idx = getelementptr inbounds i8, ptr %pa, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i629, ptr %ref.tmp216.sroa.5.0..sroa_idx, align 4
  ...
  store float %271, ptr %v, align 4
  %minNorm.sroa.13.0.v.sroa_idx = getelementptr inbounds i8, ptr %v, i64 4
  %272 = extractelement <2 x float> %255, i64 1
  store float %272, ptr %minNorm.sroa.13.0.v.sroa_idx, align 4
  %minNorm.sroa.22.0.v.sroa_idx = getelementptr inbounds i8, ptr %v, i64 8
  store float %minNorm.sroa.22.0.lcssa, ptr %minNorm.sroa.22.0.v.sroa_idx, align 4
  %minNorm.sroa.31.0.v.sroa_idx = getelementptr inbounds i8, ptr %v, i64 12
  store float %minNorm.sroa.31.0.lcssa, ptr %minNorm.sroa.31.0.v.sroa_idx, align 4
  br label %if.end226

if.end226:                                        ; preds = %invoke.cont222, %invoke.cont205
...
attributes #9 = { mustprogress nofree nosync nounwind willreturn memory(argmem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
