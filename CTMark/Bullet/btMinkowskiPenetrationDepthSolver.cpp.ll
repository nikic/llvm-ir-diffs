...
land.rhs:                                         ; preds = %entry
  ...
  %3 = load i32, ptr %m_shapeType.i.i343, align 8, !tbaa !5
  %4 = add i32 %3, -17
  %5 = icmp ult i32 %4, 2
  br label %land.end
...
for.body:                                         ; preds = %land.end, %for.body
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i348, ptr %ref.tmp26.sroa.4.0.arrayidx33.sroa_idx, align 8, !tbaa.struct !16
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i366, ptr %ref.tmp34.sroa.4.0.arrayidx39.sroa_idx, align 8, !tbaa.struct !16
...
for.body44:                                       ; preds = %for.body44.lr.ph, %for.body44
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i371, ptr %arrayidx12.i.i, align 8, !tbaa.struct !16
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i399, ptr %ref.tmp54.sroa.4.0.arrayidx62.sroa_idx, align 8, !tbaa.struct !16
  %91 = load <2 x float>, ptr %transB, align 4, !tbaa !11
  %92 = load <2 x float>, ptr %arrayidx4.i.i351, align 4, !tbaa !11
  ...
  %97 = load <2 x float>, ptr %arrayidx9.i.i354, align 4, !tbaa !11
  ...
  %101 = load float, ptr %arrayidx.i.i12.i360, align 4, !tbaa !11
  %102 = load float, ptr %arrayidx.i14.i13.i361, align 4, !tbaa !11
  %mul7.i15.i413 = fmul float %73, %102
  %103 = call float @llvm.fmuladd.f32(float %101, float %72, float %mul7.i15.i413)
  %104 = load float, ptr %arrayidx.i16.i16.i363, align 4, !tbaa !11
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i417, ptr %ref.tmp63.sroa.4.0.arrayidx68.sroa_idx, align 8, !tbaa.struct !16
...
for.body82:                                       ; preds = %for.body82.lr.ph, %for.body82
  ...
  %112 = load float, ptr %norm83, align 8, !tbaa !11
  ...
  %115 = load float, ptr %arrayidx7.i.i421, align 4, !tbaa !11
  ...
  %118 = load float, ptr %arrayidx12.i.i424, align 8, !tbaa !11
  %119 = load float, ptr %arrayidx4.i.i351, align 4, !tbaa !11
  %120 = load float, ptr %arrayidx.i14.i10.i357, align 4, !tbaa !11
  %121 = load float, ptr %arrayidx.i14.i13.i361, align 4, !tbaa !11
  ...
  %134 = load float, ptr %arrayidx9.i.i354, align 4, !tbaa !11
  %135 = load float, ptr %arrayidx.i16.i.i359, align 4, !tbaa !11
  %mul8.i20.i431 = fmul float %115, %135
  %136 = call float @llvm.fmuladd.f32(float %134, float %112, float %mul8.i20.i431)
  %137 = load float, ptr %arrayidx.i16.i16.i363, align 4, !tbaa !11
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i435, ptr %arrayidx12.i.i424, align 8, !tbaa.struct !16
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i463, ptr %ref.tmp92.sroa.4.0.arrayidx100.sroa_idx, align 8, !tbaa.struct !16
  %158 = load <2 x float>, ptr %transB, align 4, !tbaa !11
  %159 = load <2 x float>, ptr %arrayidx4.i.i351, align 4, !tbaa !11
  ...
  %164 = load <2 x float>, ptr %arrayidx9.i.i354, align 4, !tbaa !11
  ...
  %168 = load float, ptr %arrayidx.i.i12.i360, align 4, !tbaa !11
  %169 = load float, ptr %arrayidx.i14.i13.i361, align 4, !tbaa !11
  %mul7.i15.i477 = fmul float %140, %169
  %170 = call float @llvm.fmuladd.f32(float %168, float %139, float %mul7.i15.i477)
  %171 = load float, ptr %arrayidx.i16.i16.i363, align 4, !tbaa !11
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i481, ptr %ref.tmp101.sroa.4.0.arrayidx106.sroa_idx, align 8, !tbaa.struct !16
...
invoke.cont205:                                   ; preds = %for.end164
  ...
  store <2 x float> %260, ptr %m_origin3.i590, align 8, !tbaa.struct !13
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i579, ptr %displacedTrans.sroa.12.48.m_origin3.i590.sroa_idx, align 8, !tbaa.struct !16
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx7.i.i592, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx4.i.i351, i64 16, i1 false), !tbaa.struct !13
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx11.i.i594, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx9.i.i354, i64 16, i1 false), !tbaa.struct !13
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_origin3.i596, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i595, i64 16, i1 false), !tbaa.struct !13
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i604, ptr %ref.tmp203.sroa.5.0.m_cachedSeparatingAxis.i.sroa_idx, align 8, !tbaa.struct !16
...
invoke.cont222:                                   ; preds = %invoke.cont205
  ...
  %268 = load <2 x float>, ptr %m_pointInWorld, align 8, !tbaa !11
  ...
  %270 = load float, ptr %arrayidx11.i624, align 8, !tbaa !11
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i629, ptr %ref.tmp216.sroa.5.0..sroa_idx, align 4, !tbaa.struct !16
