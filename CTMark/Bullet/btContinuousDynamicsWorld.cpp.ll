...
if.then:                                          ; preds = %for.body
  ...
  store float 0.000000e+00, ptr %ref.tmp.sroa.6.0.temporalAabbMin.sroa_idx, align 4, !tbaa.struct !40
  store float 0.000000e+00, ptr %ref.tmp41.sroa.6.0.temporalAabbMax.sroa_idx, align 4, !tbaa.struct !40
  ...
  store <2 x float> %20, ptr %temporalAabbMin, align 8, !tbaa !39
  store float %temporalAabbMinz.0, ptr %arrayidx.i64, align 8, !tbaa !39
  ...
  %26 = load ptr, ptr %m_broadphaseHandle.i, align 8, !tbaa !42
...
entry:
  ...
  store ptr %debugDrawer, ptr %m_debugDrawer, align 8, !tbaa !43
  ret void
}
...
entry:
  %m_debugDrawer = getelementptr inbounds %class.btCollisionWorld, ptr %this, i64 0, i32 6
  %0 = load ptr, ptr %m_debugDrawer, align 8, !tbaa !43
  ret ptr %0
}
