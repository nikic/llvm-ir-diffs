; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btContinuousDynamicsWorld.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btContinuousDynamicsWorld.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [43 x ptr] }, ptr @_ZTV25btContinuousDynamicsWorld, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  ret void
}
...
if.end:                                           ; preds = %if.then, %entry
  ...
  store ptr %call7, ptr %m_debugDraw, align 8
  ...
  store float %timeStep, ptr %m_timeStep13, align 4
  ...
  %8 = load float, ptr %m_timeOfImpact, align 4
...
if.end22:                                         ; preds = %if.then20, %if.end
  ...
  %10 = load ptr, ptr %m_internalTickCallback, align 8
...
entry:
  ...
  store float %timeStep, ptr %m_dispatchInfo.i, align 8
  %m_timeOfImpact = getelementptr inbounds %class.btCollisionWorld, ptr %this, i64 0, i32 3, i32 3
  store float 1.000000e+00, ptr %m_timeOfImpact, align 4
  %m_stepCount = getelementptr inbounds %class.btCollisionWorld, ptr %this, i64 0, i32 3, i32 1
  store i32 0, ptr %m_stepCount, align 4
  %m_dispatchFunc = getelementptr inbounds %class.btCollisionWorld, ptr %this, i64 0, i32 3, i32 2
  store i32 2, ptr %m_dispatchFunc, align 8
...
if.then:                                          ; preds = %entry
  ...
  %vtable4 = load ptr, ptr %0, align 8
...
if.end:                                           ; preds = %if.then, %entry
  store i32 1, ptr %m_dispatchFunc, align 8
  ret void
}
...
for.cond.cleanup:                                 ; preds = %if.end47, %entry
  ...
  %3 = load ptr, ptr %m_broadphasePairCache48, align 8
  %m_dispatcher149 = getelementptr inbounds %class.btCollisionWorld, ptr %this, i64 0, i32 2
  %4 = load ptr, ptr %m_dispatcher149, align 8
  %vtable50 = load ptr, ptr %3, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end47
  ...
  %tobool.not = or i1 %tobool.not108, %cmp.i
...
if.then:                                          ; preds = %for.body
  ...
  %12 = load float, ptr %arrayidx.i62, align 8
  %13 = load float, ptr %arrayidx.i64, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp.sroa.6.0.temporalAabbMin.sroa_idx, align 4
  store float 0.000000e+00, ptr %ref.tmp41.sroa.6.0.temporalAabbMax.sroa_idx, align 4
  %15 = load <2 x float>, ptr %temporalAabbMin, align 8
  %16 = load <2 x float>, ptr %m_linearVelocity.i, align 4
  ...
  store float %temporalAabbMinz.0, ptr %arrayidx.i64, align 8
  %21 = load <2 x float>, ptr %temporalAabbMax, align 8
  ...
  store <2 x float> %24, ptr %temporalAabbMax, align 8
  %add13.i = fadd float %temporalAabbMaxz.0, 0.000000e+00
  store float %add13.i, ptr %arrayidx.i62, align 8
  %25 = load ptr, ptr %m_broadphasePairCache, align 8
  %m_broadphaseHandle.i = getelementptr inbounds %class.btCollisionObject, ptr %8, i64 0, i32 8
  %26 = load ptr, ptr %m_broadphaseHandle.i, align 8
  %27 = load ptr, ptr %m_dispatcher1, align 8
