...
entry:
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %child.sroa.0.16.arrayidx7.i.i.sroa_idx, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx5.i.i, i64 16, i1 false), !tbaa.struct !28
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %child.sroa.0.32.arrayidx11.i.i.sroa_idx, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx9.i.i, i64 16, i1 false), !tbaa.struct !28
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %child.sroa.0.48.m_origin3.i.sroa_idx, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i, i64 16, i1 false), !tbaa.struct !28
...
_ZN20btAlignedObjectArrayI20btCompoundShapeChildE9push_backERKS0_.exit: ; preds = %if.end39, %if.then.i, %_ZN20btAlignedObjectArrayI20btCompoundShapeChildE10deallocateEv.exit.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx8.i.i.i.i, ptr noundef nonnull align 8 dereferenceable(16) %child.sroa.0.16.arrayidx7.i.i.sroa_idx, i64 16, i1 false), !tbaa.struct !28
  %arrayidx12.i.i.i.i = getelementptr inbounds [3 x %class.btVector3], ptr %arrayidx.i, i64 0, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx12.i.i.i.i, ptr noundef nonnull align 8 dereferenceable(16) %child.sroa.0.32.arrayidx11.i.i.sroa_idx, i64 16, i1 false), !tbaa.struct !28
  %m_origin.i.i.i = getelementptr inbounds %class.btTransform, ptr %arrayidx.i, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_origin.i.i.i, ptr noundef nonnull align 8 dereferenceable(16) %child.sroa.0.48.m_origin3.i.sroa_idx, i64 16, i1 false), !tbaa.struct !28
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %23 = load float, ptr %arrayidx.i46.i, align 4, !tbaa !20
  ...
  %25 = load float, ptr %arrayidx.i47.i, align 4, !tbaa !20
  ...
  %29 = load float, ptr %arrayidx.i32.i, align 4, !tbaa !20
...
for.body24:                                       ; preds = %for.body24.lr.ph, %for.body24
  ...
  %39 = load float, ptr %arrayidx.i162, align 4, !tbaa !20, !noalias !37
  %40 = load float, ptr %arrayidx3.i171, align 4, !tbaa !20, !noalias !37
  %41 = load float, ptr %arrayidx6.i, align 4, !tbaa !20, !noalias !37
  %42 = load float, ptr %arrayidx.i.i, align 4, !tbaa !20, !noalias !37
  %43 = load float, ptr %arrayidx.i26.i, align 4, !tbaa !20, !noalias !37
  %44 = load float, ptr %arrayidx.i27.i, align 4, !tbaa !20, !noalias !37
  %45 = load float, ptr %arrayidx.i28.i, align 4, !tbaa !20, !noalias !37
  %46 = load float, ptr %arrayidx.i29.i, align 4, !tbaa !20, !noalias !37
  %47 = load float, ptr %arrayidx.i30.i, align 4, !tbaa !20, !noalias !37
  %48 = load float, ptr %i, align 4, !tbaa !20
  %mul7.i = fmul float %41, %48
  %49 = load float, ptr %arrayidx41, align 4, !tbaa !20
  %mul7.i183 = fmul float %44, %49
  %50 = load float, ptr %arrayidx45, align 4, !tbaa !20
  ...
  %53 = load float, ptr %arrayidx5.i10.i.i, align 8, !tbaa !20
  %add13.i230 = fadd float %52, %53
  %54 = fmul float %sub14.i, %sub14.i
  %55 = load float, ptr %arrayidx28, align 4, !tbaa !20
  %56 = load <2 x float>, ptr %m_origin.i163, align 4, !tbaa !20
  ...
  store <2 x float> %91, ptr %tensor, align 8, !tbaa !20
  ...
  store <2 x float> %104, ptr %arrayidx3.i.i156, align 8, !tbaa !20
