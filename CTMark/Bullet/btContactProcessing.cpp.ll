; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btContactProcessing.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btContactProcessing.cpp"
...
_ZN20btAlignedObjectArrayI17CONTACT_KEY_TOKENE7reserveEi.exit: ; preds = %if.end6
  store i8 1, ptr %m_ownsMemory.i.i125, align 8
  store ptr %call.i.i.i137, ptr %m_data.i.i126, align 8
  store i32 %2, ptr %m_capacity.i.i128, align 8
...
invoke.cont15:                                    ; preds = %invoke.cont15.lr.ph, %invoke.cont18
  ...
  %7 = load ptr, ptr %m_data.i139, align 8
  ...
  br i1 %cmp.i142, label %if.then.i146, label %invoke.cont18

if.then.i146:                                     ; preds = %invoke.cont15
  %tobool.not.i.i147 = icmp eq i32 %6, 0
  %mul.i.i = shl nsw i32 %6, 1
  %cond.i.i = select i1 %tobool.not.i.i147, i32 1, i32 %mul.i.i
  %cmp.i.i = icmp slt i32 %6, %cond.i.i
  br i1 %cmp.i.i, label %if.then.i.i148, label %invoke.cont18

if.then.i.i148:                                   ; preds = %if.then.i146
...
_ZN20btAlignedObjectArrayI17CONTACT_KEY_TOKENE8allocateEi.exit.i.i: ; preds = %if.then.i.i.i, %if.then.i.i148
  %retval.0.i.i.i = phi ptr [ null, %if.then.i.i148 ], [ %call.i.i.i.i151, %if.then.i.i.i ]
...
vector.memcheck:                                  ; preds = %for.body.lr.ph.i.i.i
  ...
  %scevgep211 = getelementptr i8, ptr %scevgep, i64 %13
  %scevgep212 = getelementptr i8, ptr %5, i64 -4
  %scevgep213 = getelementptr i8, ptr %scevgep212, i64 %13
  %scevgep214 = getelementptr i8, ptr %retval.0.i.i.i, i64 4
  %scevgep215 = getelementptr i8, ptr %retval.0.i.i.i, i64 %13
  %scevgep216 = getelementptr i8, ptr %5, i64 4
  %scevgep217 = getelementptr i8, ptr %5, i64 %13
  %bound0 = icmp ult ptr %retval.0.i.i.i, %scevgep213
  %bound1 = icmp ult ptr %5, %scevgep211
  %found.conflict = and i1 %bound0, %bound1
  %bound0218 = icmp ult ptr %scevgep214, %scevgep217
  %bound1219 = icmp ult ptr %scevgep216, %scevgep215
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <4 x i32>, ptr %15, align 4
  %wide.vec221 = load <4 x i32>, ptr %16, align 4
  ...
  store <4 x i32> %wide.vec, ptr %17, align 4
  store <4 x i32> %wide.vec221, ptr %18, align 4
...
for.body.i.i.i.prol:                              ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i.prol
  ...
  %22 = load <2 x i32>, ptr %arrayidx3.i.i.i.prol, align 4
  store <2 x i32> %22, ptr %arrayidx.i.i.i.prol, align 4
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  ...
  %24 = load <2 x i32>, ptr %arrayidx3.i.i.i, align 4
  store <2 x i32> %24, ptr %arrayidx.i.i.i, align 4
  ...
  %25 = load <2 x i32>, ptr %arrayidx3.i.i.i.1, align 4
  store <2 x i32> %25, ptr %arrayidx.i.i.i.1, align 4
  ...
  %26 = load <2 x i32>, ptr %arrayidx3.i.i.i.2, align 4
  store <2 x i32> %26, ptr %arrayidx.i.i.i.2, align 4
  ...
  %27 = load <2 x i32>, ptr %arrayidx3.i.i.i.3, align 4
  store <2 x i32> %27, ptr %arrayidx.i.i.i.3, align 4
...
_ZNK20btAlignedObjectArrayI17CONTACT_KEY_TOKENE4copyEiiPS0_.exit.i.i: ; preds = %_ZN20btAlignedObjectArrayI17CONTACT_KEY_TOKENE8allocateEi.exit.i.i
  ...
  %or.cond.i149 = select i1 %tobool.not.i10.i.i, i1 true, i1 %tobool2.not.i.i.i
  br i1 %or.cond.i149, label %_ZN20btAlignedObjectArrayI17CONTACT_KEY_TOKENE10deallocateEv.exit.i.i, label %if.then3.i.i.i

if.then.i11.i.i:                                  ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i, %middle.block
  %.old.i = load i8, ptr %m_ownsMemory.i.i125, align 8
...
_ZN20btAlignedObjectArrayI17CONTACT_KEY_TOKENE10deallocateEv.exit.i.i: ; preds = %if.then3.i.i.i, %if.then.i11.i.i, %_ZNK20btAlignedObjectArrayI17CONTACT_KEY_TOKENE4copyEiiPS0_.exit.i.i
  store i8 1, ptr %m_ownsMemory.i.i125, align 8
  store ptr %retval.0.i.i.i, ptr %m_data.i.i126, align 8
  store i32 %cond.i.i, ptr %m_capacity.i.i128, align 8
  %.pre205 = load i32, ptr %m_size.i, align 4
  br label %invoke.cont18

invoke.cont18:                                    ; preds = %_ZN20btAlignedObjectArrayI17CONTACT_KEY_TOKENE10deallocateEv.exit.i.i, %if.then.i146, %invoke.cont15
  %29 = phi i32 [ %.pre205, %_ZN20btAlignedObjectArrayI17CONTACT_KEY_TOKENE10deallocateEv.exit.i.i ], [ %4, %if.then.i146 ], [ %4, %invoke.cont15 ]
  %30 = phi ptr [ %retval.0.i.i.i, %_ZN20btAlignedObjectArrayI17CONTACT_KEY_TOKENE10deallocateEv.exit.i.i ], [ %5, %if.then.i146 ], [ %5, %invoke.cont15 ]
  %31 = phi i32 [ %cond.i.i, %_ZN20btAlignedObjectArrayI17CONTACT_KEY_TOKENE10deallocateEv.exit.i.i ], [ %6, %if.then.i146 ], [ %6, %invoke.cont15 ]
  %idxprom.i144 = zext i32 %.pre7.pre.pre.i to i64
  %arrayidx.i145 = getelementptr inbounds %struct.CONTACT_KEY_TOKEN, ptr %30, i64 %idxprom.i144
  store i32 %add15.i, ptr %arrayidx.i145, align 4
  %m_value3.i.i = getelementptr inbounds %struct.CONTACT_KEY_TOKEN, ptr %30, i64 %idxprom.i144, i32 1
  %32 = trunc i64 %indvars.iv to i32
  store i32 %32, ptr %m_value3.i.i, align 4
  %inc.i = add nuw nsw i32 %.pre7.pre.pre.i, 1
  store i32 %inc.i, ptr %m_size.i.i127, align 4
...
if.then.i155.invoke.cont19_crit_edge:             ; preds = %if.then.i155
  %.pre206 = load ptr, ptr %m_data.i.i126, align 8
...
invoke.cont30:                                    ; preds = %invoke.cont19
  %40 = load i32, ptr %m_size.i.i127, align 4
...
if.then49:                                        ; preds = %for.body38
  ...
  %47 = load float, ptr %m_depth, align 4
  %sub = fadd float %47, 0xBEE4F8B580000000
  %m_depth50 = getelementptr inbounds %class.GIM_CONTACT, ptr %46, i64 %idxprom.i171, i32 2
  %48 = load float, ptr %m_depth50, align 4
  %cmp51 = fcmp ogt float %sub, %48
  br i1 %cmp51, label %if.then52, label %if.else

if.then52:                                        ; preds = %if.then49
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(48) %pcontact.0199, ptr noundef nonnull align 4 dereferenceable(48) %arrayidx.i172, i64 48, i1 false)
  br label %if.end80
...
for.body.i.epil:                                  ; preds = %for.cond.cleanup.i.unr-lcssa, %for.body.i.epil
  ...
  %arrayidx.i174.epil = getelementptr inbounds %class.btVector3, ptr %coincident_normals, i64 %indvars.iv.i.epil
  %55 = load <2 x float>, ptr %arrayidx.i174.epil, align 16
  %56 = fadd <2 x float> %54, %55
  %arrayidx10.i.i.epil = getelementptr inbounds [4 x float], ptr %arrayidx.i174.epil, i64 0, i64 2
  %57 = load float, ptr %arrayidx10.i.i.epil, align 8
...
for.body.i:                                       ; preds = %for.body.i, %for.body.preheader.i.new
  ...
  %arrayidx.i174 = getelementptr inbounds %class.btVector3, ptr %coincident_normals, i64 %indvars.iv.i
  %63 = load <2 x float>, ptr %arrayidx.i174, align 16
  %64 = fadd <2 x float> %62, %63
  %arrayidx10.i.i = getelementptr inbounds [4 x float], ptr %arrayidx.i174, i64 0, i64 2
  %65 = load float, ptr %arrayidx10.i.i, align 8
  %add13.i.i = fadd float %vec_sum.sroa.11.022.i, %65
  %indvars.iv.next.i = or i64 %indvars.iv.i, 1
  %arrayidx.i174.1 = getelementptr inbounds %class.btVector3, ptr %coincident_normals, i64 %indvars.iv.next.i
  %66 = load <2 x float>, ptr %arrayidx.i174.1, align 16
  %67 = fadd <2 x float> %64, %66
  %arrayidx10.i.i.1 = getelementptr inbounds [4 x float], ptr %arrayidx.i174.1, i64 0, i64 2
  %68 = load float, ptr %arrayidx10.i.i.1, align 8
  %add13.i.i.1 = fadd float %add13.i.i, %68
  %indvars.iv.next.i.1 = or i64 %indvars.iv.i, 2
  %arrayidx.i174.2 = getelementptr inbounds %class.btVector3, ptr %coincident_normals, i64 %indvars.iv.next.i.1
  %69 = load <2 x float>, ptr %arrayidx.i174.2, align 16
  %70 = fadd <2 x float> %67, %69
  %arrayidx10.i.i.2 = getelementptr inbounds [4 x float], ptr %arrayidx.i174.2, i64 0, i64 2
  %71 = load float, ptr %arrayidx10.i.i.2, align 8
  %add13.i.i.2 = fadd float %add13.i.i.1, %71
  %indvars.iv.next.i.2 = or i64 %indvars.iv.i, 3
  %arrayidx.i174.3 = getelementptr inbounds %class.btVector3, ptr %coincident_normals, i64 %indvars.iv.next.i.2
  %72 = load <2 x float>, ptr %arrayidx.i174.3, align 16
  %73 = fadd <2 x float> %70, %72
  %arrayidx10.i.i.3 = getelementptr inbounds [4 x float], ptr %arrayidx.i174.3, i64 0, i64 2
  %74 = load float, ptr %arrayidx10.i.i.3, align 8
...
if.end.i:                                         ; preds = %for.cond.cleanup.i
  ...
  store <2 x float> %77, ptr %m_normal.i, align 4
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i.i, ptr %vec_sum.sroa.11.0.m_normal.sroa_idx.i, align 4
  br label %if.end73
...
invoke.cont74:                                    ; preds = %if.end73
  ...
  %.pre207 = load i32, ptr %m_size.i.i127, align 4
  br label %if.end80
...
for.end83:                                        ; preds = %if.end80, %invoke.cont30
  ...
  %82 = load ptr, ptr %m_data.i.i126, align 8
...
ehcleanup88:                                      ; preds = %ehcleanup84, %lpad12, %lpad
  %.pn122 = phi { ptr, i32 } [ %35, %lpad12 ], [ %.pn, %ehcleanup84 ], [ %34, %lpad ]
  %84 = load ptr, ptr %m_data.i.i126, align 8
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  ...
  %5 = load <2 x i32>, ptr %m_feature15.i.i.i, align 4
  store <2 x i32> %5, ptr %m_feature1.i.i.i, align 4
...
if.end:                                           ; preds = %_ZN20btAlignedObjectArrayI11GIM_CONTACTE10deallocateEv.exit.i, %if.then, %entry
  ...
  %10 = load float, ptr %m_depth4.i, align 4
  store float %10, ptr %m_depth.i, align 4
  ...
  %11 = load <2 x i32>, ptr %m_feature15.i, align 4
  store <2 x i32> %11, ptr %m_feature1.i, align 4
