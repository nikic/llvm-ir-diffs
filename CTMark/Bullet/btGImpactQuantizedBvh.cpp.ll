; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btGImpactQuantizedBvh.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btGImpactQuantizedBvh.cpp"
...
for.cond.cleanup:                                 ; preds = %for.body, %entry
  ...
  store <2 x float> %6, ptr %m_global_bound, align 8
  %ref.tmp.sroa.4.0..sroa_idx.i = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 3, i32 0, i32 0, i64 2
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i, ptr %ref.tmp.sroa.4.0..sroa_idx.i, align 8
  ...
  store <2 x float> %7, ptr %m_max, align 8
  %ref.tmp1.sroa.4.0..sroa_idx.i = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 3, i32 1, i32 0, i64 2
  store <2 x float> %retval.sroa.3.12.vec.insert.i23.i, ptr %ref.tmp1.sroa.4.0..sroa_idx.i, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i47.i, ptr %ref.tmp6.sroa.4.0..sroa_idx.i, align 8
  ret void
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %15 = load float, ptr %arrayidx39.i, align 4
  ...
  %19 = load float, ptr %arrayidx98.i, align 4
...
entry:
  ...
  %cmp165 = icmp slt i32 %startIndex, %endIndex
...
for.body.prol:                                    ; preds = %for.body.lr.ph
  ...
  %4 = load float, ptr %m_max.prol, align 4
  ...
  %6 = load <2 x float>, ptr %arrayidx5.i69.prol, align 4
  %7 = load <2 x float>, ptr %arrayidx7.i70.prol, align 4
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  ...
  %14 = load float, ptr %m_max, align 4
  ...
  %16 = load <2 x float>, ptr %arrayidx5.i69, align 4
  %17 = load <2 x float>, ptr %arrayidx7.i70, align 4
  ...
  %21 = load float, ptr %m_max.1, align 4
  %22 = load float, ptr %arrayidx.i.1, align 4
  ...
  %23 = load <2 x float>, ptr %arrayidx5.i69.1, align 4
  %24 = load <2 x float>, ptr %arrayidx7.i70.1, align 4
...
for.body19.lr.ph:                                 ; preds = %for.end
  %m_data.i76 = getelementptr inbounds %class.btAlignedObjectArray, ptr %primitive_boxes, i64 0, i32 5
  %31 = load ptr, ptr %m_data.i76, align 8
...
for.body19:                                       ; preds = %for.body19.lr.ph, %for.body19
  ...
  %34 = load float, ptr %m_max25, align 4
  %35 = load float, ptr %arrayidx.i78, align 4
  ...
  %36 = load <2 x float>, ptr %arrayidx5.i83, align 4
  %37 = load <2 x float>, ptr %arrayidx7.i84, align 4
...
entry:
  ...
  %cmp121 = icmp slt i32 %startIndex, %endIndex
...
for.body.prol:                                    ; preds = %for.body.lr.ph
  ...
  %5 = load float, ptr %arrayidx11.i.prol, align 4
  %arrayidx13.i.prol = getelementptr inbounds [4 x float], ptr %arrayidx.i.prol, i64 0, i64 2
  %6 = load float, ptr %arrayidx13.i.prol, align 4
  %add14.i.prol = fadd float %5, %6
  %7 = load <2 x float>, ptr %m_max.prol, align 4
  %8 = load <2 x float>, ptr %arrayidx.i.prol, align 4
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  ...
  %18 = load <2 x float>, ptr %m_max, align 4
  %19 = load <2 x float>, ptr %arrayidx.i, align 4
  ...
  %23 = load float, ptr %arrayidx11.i.1, align 4
  %arrayidx13.i.1 = getelementptr inbounds [4 x float], ptr %arrayidx.i.1, i64 0, i64 2
  %24 = load float, ptr %arrayidx13.i.1, align 4
  %add14.i.1 = fadd float %23, %24
  %25 = load <2 x float>, ptr %m_max.1, align 4
  %26 = load <2 x float>, ptr %arrayidx.i.1, align 4
...
for.end:                                          ; preds = %for.body.prol.loopexit, %for.body, %entry
  ...
  store <2 x float> %33, ptr %means, align 8
...
for.body17.lr.ph:                                 ; preds = %for.end
  %m_data.i85 = getelementptr inbounds %class.btAlignedObjectArray, ptr %primitive_boxes, i64 0, i32 5
...
for.body17:                                       ; preds = %for.body17.lr.ph, %if.end
  ...
  %38 = load float, ptr %arrayidx11.i95, align 4
  %arrayidx13.i96 = getelementptr inbounds [4 x float], ptr %arrayidx.i87, i64 0, i64 2
  %39 = load float, ptr %arrayidx13.i96, align 4
  %add14.i97 = fadd float %38, %39
  %40 = load <2 x float>, ptr %m_max23, align 4
  %41 = load <2 x float>, ptr %arrayidx.i87, align 4
  ...
  %44 = load float, ptr %arrayidx33, align 4
...
if.then:                                          ; preds = %for.body17
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %temp.sroa.0.i, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx.i87, i64 16, i1 false)
  ...
  %45 = load i32, ptr %m_data3.i.i, align 4
  %idxprom3.i = sext i32 %splitIndex.0127 to i64
  %arrayidx4.i = getelementptr inbounds %struct.GIM_BVH_DATA, ptr %37, i64 %idxprom3.i
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(36) %arrayidx.i87, ptr noundef nonnull align 4 dereferenceable(36) %arrayidx4.i, i64 36, i1 false)
  %46 = load ptr, ptr %m_data.i85, align 8
  %arrayidx10.i116 = getelementptr inbounds %struct.GIM_BVH_DATA, ptr %46, i64 %idxprom3.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(32) %arrayidx10.i116, ptr noundef nonnull align 8 dereferenceable(32) %temp.sroa.0.i, i64 32, i1 false)
  %temp.sroa.5.0.arrayidx10.sroa_idx.i = getelementptr inbounds i8, ptr %arrayidx10.i116, i64 32
  store i32 %45, ptr %temp.sroa.5.0.arrayidx10.sroa_idx.i, align 4
...
if.then:                                          ; preds = %entry
  ...
  %clampedPoint.sroa.13.0.copyload.i.i = load float, ptr %clampedPoint.sroa.13.0.point.sroa_idx.i.i, align 4
  ...
  %arrayidx11.i20.i.i = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 3, i32 1, i32 0, i64 2
  %4 = load float, ptr %arrayidx11.i20.i.i, align 8
  %cmp.i20.i21.i.i = fcmp olt float %4, %clampedPoint.sroa.13.0.i.i
  %clampedPoint.sroa.13.1.i.i = select i1 %cmp.i20.i21.i.i, float %4, float %clampedPoint.sroa.13.0.i.i
  ...
  %5 = load float, ptr %arrayidx13.i36.i.i, align 8
  ...
  %clampedPoint.sroa.13.0.copyload.i22.i = load float, ptr %clampedPoint.sroa.13.0.point.sroa_idx.i21.i, align 4
  ...
  %cmp.i20.i21.i37.i = fcmp olt float %4, %clampedPoint.sroa.13.0.i30.i
  %clampedPoint.sroa.13.1.i38.i = select i1 %cmp.i20.i21.i37.i, float %4, float %clampedPoint.sroa.13.0.i30.i
  ...
  store <2 x i16> %26, ptr %m_quantizedAabbMax.i, align 2
...
if.end:                                           ; preds = %entry
  ...
  %cmp7137 = icmp slt i32 %startIndex, %endIndex
  br i1 %cmp7137, label %for.body.lr.ph, label %for.cond.cleanup

for.body.lr.ph:                                   ; preds = %if.end
  %m_data.i126 = getelementptr inbounds %class.btAlignedObjectArray, ptr %primitive_boxes, i64 0, i32 5
  %28 = load ptr, ptr %m_data.i126, align 8
...
for.cond.cleanup:                                 ; preds = %for.body, %if.end
  ...
  %32 = load ptr, ptr %m_data.i.i46, align 8
  ...
  %arrayidx7.i17.i.i67 = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 3, i32 1, i32 0, i64 1
  ...
  %36 = load <2 x float>, ptr %arrayidx7.i.i.i59, align 4
  %37 = load <2 x float>, ptr %arrayidx7.i17.i.i67, align 4
  %38 = load <2 x float>, ptr %arrayidx7.i34.i.i77, align 4
  ...
  %64 = load ptr, ptr %m_data.i.i46, align 8
  %65 = load i32, ptr %this, align 8
  %sub14.neg = sub nsw i32 %0, %65
  %m_escapeIndexOrDataIndex.i125 = getelementptr inbounds %struct.BT_QUANTIZED_BVH_NODE, ptr %64, i64 %idxprom.i.i47, i32 2
  store i32 %sub14.neg, ptr %m_escapeIndexOrDataIndex.i125, align 4
  br label %common.ret153
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %69 = load <2 x float>, ptr %arrayidx19.i, align 4
  ...
  %79 = load <2 x float>, ptr %arrayidx78.i, align 4
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  %2 = phi <4 x float> [ <float 0x47EFFFFFE0000000, float 0xC7EFFFFFE0000000, float 0x47EFFFFFE0000000, float 0x47EFFFFFE0000000>, %for.body.lr.ph.i ], [ %16, %for.body.i ]
  %3 = phi <2 x float> [ <float 0xC7EFFFFFE0000000, float 0xC7EFFFFFE0000000>, %for.body.lr.ph.i ], [ %19, %for.body.i ]
  ...
  %5 = load float, ptr %arrayidx39.i.i, align 4
  %m_max56.i.i = getelementptr inbounds %class.btAABB, ptr %arrayidx.i.i, i64 0, i32 1
  %6 = load float, ptr %m_max56.i.i, align 4
  %7 = insertelement <4 x float> poison, float %5, i64 0
  %8 = insertelement <4 x float> %7, float %6, i64 1
  %9 = shufflevector <2 x float> %4, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %10 = shufflevector <4 x float> %8, <4 x float> %9, <4 x i32> <i32 0, i32 1, i32 5, i32 4>
  %11 = fcmp ogt <4 x float> %2, %10
  %12 = fcmp olt <4 x float> %2, %10
  %13 = shufflevector <4 x i1> %11, <4 x i1> %12, <4 x i32> <i32 0, i32 5, i32 2, i32 3>
  %14 = shufflevector <2 x float> %4, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 poison, i32 poison>
  %15 = shufflevector <4 x float> %8, <4 x float> %14, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  %16 = select <4 x i1> %13, <4 x float> %15, <4 x float> %2
  %arrayidx78.i.i = getelementptr inbounds %class.btAABB, ptr %arrayidx.i.i, i64 0, i32 1, i32 0, i64 1
  %17 = load <2 x float>, ptr %arrayidx78.i.i, align 4
  %18 = fcmp olt <2 x float> %3, %17
  %19 = select <2 x i1> %18, <2 x float> %17, <2 x float> %3
...
_ZN18btQuantizedBvhTree17calc_quantizationER18GIM_BVH_DATA_ARRAYf.exit.loopexit: ; preds = %for.body.i
  %20 = fadd <4 x float> %16, <float -1.000000e+00, float 1.000000e+00, float -1.000000e+00, float -1.000000e+00>
...
_ZN18btQuantizedBvhTree17calc_quantizationER18GIM_BVH_DATA_ARRAYf.exit: ; preds = %_ZN18btQuantizedBvhTree17calc_quantizationER18GIM_BVH_DATA_ARRAYf.exit.loopexit, %entry
  %global_bound.sroa.20.0.lcssa.i = phi float [ 0xC7EFFFFFE0000000, %entry ], [ %22, %_ZN18btQuantizedBvhTree17calc_quantizationER18GIM_BVH_DATA_ARRAYf.exit.loopexit ]
  %global_bound.sroa.25.0.lcssa.i = phi float [ 0xC7EFFFFFE0000000, %entry ], [ %24, %_ZN18btQuantizedBvhTree17calc_quantizationER18GIM_BVH_DATA_ARRAYf.exit.loopexit ]
  %25 = phi <4 x float> [ <float 0x47EFFFFFE0000000, float 0xC7EFFFFFE0000000, float 0x47EFFFFFE0000000, float 0x47EFFFFFE0000000>, %entry ], [ %20, %_ZN18btQuantizedBvhTree17calc_quantizationER18GIM_BVH_DATA_ARRAYf.exit.loopexit ]
  %m_global_bound.i = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 3
  %m_max.i = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 3, i32 1
  %m_bvhQuantization.i = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 4
  %26 = shufflevector <4 x float> %25, <4 x float> poison, <2 x i32> <i32 3, i32 2>
  %27 = shufflevector <4 x float> %25, <4 x float> poison, <2 x i32> <i32 0, i32 1>
  %28 = insertelement <2 x float> %27, float 0.000000e+00, i64 1
  store <2 x float> %26, ptr %m_global_bound.i, align 8
  %ref.tmp.sroa.4.0..sroa_idx.i.i = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 3, i32 0, i32 0, i64 2
  store <2 x float> %28, ptr %ref.tmp.sroa.4.0..sroa_idx.i.i, align 8
  %29 = shufflevector <4 x float> %25, <4 x float> poison, <2 x i32> <i32 1, i32 poison>
  %retval.sroa.0.4.vec.insert.i22.i.i = insertelement <2 x float> %29, float %global_bound.sroa.20.0.lcssa.i, i64 1
  %retval.sroa.3.12.vec.insert.i23.i.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %global_bound.sroa.25.0.lcssa.i, i64 0
  store <2 x float> %retval.sroa.0.4.vec.insert.i22.i.i, ptr %m_max.i, align 8
  %ref.tmp1.sroa.4.0..sroa_idx.i.i = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 3, i32 1, i32 0, i64 2
  store <2 x float> %retval.sroa.3.12.vec.insert.i23.i.i, ptr %ref.tmp1.sroa.4.0..sroa_idx.i.i, align 8
  %30 = extractelement <4 x float> %25, i64 0
  %sub14.i32.i.i = fsub float %global_bound.sroa.25.0.lcssa.i, %30
  %31 = insertelement <2 x float> %27, float %global_bound.sroa.20.0.lcssa.i, i64 0
  %32 = shufflevector <4 x float> %25, <4 x float> poison, <2 x i32> <i32 2, i32 3>
  %33 = fsub <2 x float> %31, %32
  %34 = fdiv <2 x float> <float 6.553500e+04, float 6.553500e+04>, %33
  ...
  store <2 x float> %35, ptr %m_bvhQuantization.i, align 8
  %ref.tmp6.sroa.4.0..sroa_idx.i.i = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 4, i32 0, i64 2
  store <2 x float> %retval.sroa.3.12.vec.insert.i47.i.i, ptr %ref.tmp6.sroa.4.0..sroa_idx.i.i, align 8
  ...
  %37 = load i32, ptr %m_size.i.i6, align 4
  %cmp4.i = icmp slt i32 %37, %mul
...
_ZN20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE8allocateEi.exit.i.i: ; preds = %if.then.i.i.i, %if.then.i.i
  %39 = phi i32 [ %.pre.i, %if.then.i.i.i ], [ %37, %if.then.i.i ]
...
for.body.lr.ph.i.i.i:                             ; preds = %_ZN20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE8allocateEi.exit.i.i
  ...
  %40 = icmp eq i32 %39, 1
  br i1 %40, label %_ZNK20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa, label %for.body.lr.ph.i.i.i.new
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i.new
  ...
  %41 = load ptr, ptr %m_data.i.i.i, align 8
  %arrayidx3.i.i.i = getelementptr inbounds %struct.BT_QUANTIZED_BVH_NODE, ptr %41, i64 %indvars.iv.i.i.i
  ...
  %arrayidx3.i.i.i.1 = getelementptr inbounds %struct.BT_QUANTIZED_BVH_NODE, ptr %42, i64 %indvars.iv.next.i.i.i
...
for.body.i.i.i.epil:                              ; preds = %_ZNK20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa
  ...
  %arrayidx3.i.i.i.epil = getelementptr inbounds %struct.BT_QUANTIZED_BVH_NODE, ptr %43, i64 %indvars.iv.i.i.i.unr
...
_ZNK20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE4copyEiiPS0_.exit.i.i: ; preds = %for.body.i.i.i.epil, %_ZNK20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa, %_ZN20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE8allocateEi.exit.i.i
  ...
  %44 = load ptr, ptr %m_data.i9.i.i, align 8
  %tobool.not.i10.i.i = icmp eq ptr %44, null
  ...
  %tobool2.not.i.i.i = icmp eq i8 %45, 0
...
for.body10.lr.ph.i:                               ; preds = %if.end.i, %if.then5.i
  ...
  %47 = sub nsw i64 %wide.trip.count.i8, %46
  %48 = xor i64 %46, -1
  %49 = add nsw i64 %48, %wide.trip.count.i8
  %xtraiter14 = and i64 %47, 3
...
for.body10.i.prol:                                ; preds = %for.body10.lr.ph.i, %for.body10.i.prol
  %indvars.iv.i9.prol = phi i64 [ %indvars.iv.next.i10.prol, %for.body10.i.prol ], [ %46, %for.body10.lr.ph.i ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body10.i.prol ], [ 0, %for.body10.lr.ph.i ]
  %50 = load ptr, ptr %m_data11.i, align 8
  %ref.tmp.sroa.3.0.arrayidx13.i.sroa_idx.prol = getelementptr inbounds %struct.BT_QUANTIZED_BVH_NODE, ptr %50, i64 %indvars.iv.i9.prol, i32 2
  store i32 0, ptr %ref.tmp.sroa.3.0.arrayidx13.i.sroa_idx.prol, align 4
...
for.body10.i.prol.loopexit:                       ; preds = %for.body10.i.prol, %for.body10.lr.ph.i
  %indvars.iv.i9.unr = phi i64 [ %46, %for.body10.lr.ph.i ], [ %indvars.iv.next.i10.prol, %for.body10.i.prol ]
  %51 = icmp ult i64 %49, 3
  br i1 %51, label %_ZN20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE6resizeEiRKS0_.exit.loopexit, label %for.body10.i
...
for.body10.i:                                     ; preds = %for.body10.i.prol.loopexit, %for.body10.i
  ...
  %52 = load ptr, ptr %m_data11.i, align 8
  %ref.tmp.sroa.3.0.arrayidx13.i.sroa_idx = getelementptr inbounds %struct.BT_QUANTIZED_BVH_NODE, ptr %52, i64 %indvars.iv.i9, i32 2
  store i32 0, ptr %ref.tmp.sroa.3.0.arrayidx13.i.sroa_idx, align 4
  %indvars.iv.next.i10 = add nsw i64 %indvars.iv.i9, 1
  %53 = load ptr, ptr %m_data11.i, align 8
  %ref.tmp.sroa.3.0.arrayidx13.i.sroa_idx.1 = getelementptr inbounds %struct.BT_QUANTIZED_BVH_NODE, ptr %53, i64 %indvars.iv.next.i10, i32 2
  store i32 0, ptr %ref.tmp.sroa.3.0.arrayidx13.i.sroa_idx.1, align 4
  %indvars.iv.next.i10.1 = add nsw i64 %indvars.iv.i9, 2
  %54 = load ptr, ptr %m_data11.i, align 8
  %ref.tmp.sroa.3.0.arrayidx13.i.sroa_idx.2 = getelementptr inbounds %struct.BT_QUANTIZED_BVH_NODE, ptr %54, i64 %indvars.iv.next.i10.1, i32 2
  store i32 0, ptr %ref.tmp.sroa.3.0.arrayidx13.i.sroa_idx.2, align 4
  %indvars.iv.next.i10.2 = add nsw i64 %indvars.iv.i9, 3
  %55 = load ptr, ptr %m_data11.i, align 8
  %ref.tmp.sroa.3.0.arrayidx13.i.sroa_idx.3 = getelementptr inbounds %struct.BT_QUANTIZED_BVH_NODE, ptr %55, i64 %indvars.iv.next.i10.2, i32 2
  store i32 0, ptr %ref.tmp.sroa.3.0.arrayidx13.i.sroa_idx.3, align 4
...
_ZN20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE6resizeEiRKS0_.exit: ; preds = %_ZN20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE6resizeEiRKS0_.exit.loopexit, %_ZN18btQuantizedBvhTree17calc_quantizationER18GIM_BVH_DATA_ARRAYf.exit
  %56 = phi i32 [ %.pre, %_ZN20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE6resizeEiRKS0_.exit.loopexit ], [ %36, %_ZN18btQuantizedBvhTree17calc_quantizationER18GIM_BVH_DATA_ARRAYf.exit ]
  store i32 %mul, ptr %m_size.i.i6, align 4
  tail call void @_ZN18btQuantizedBvhTree15_build_sub_treeER18GIM_BVH_DATA_ARRAYii(ptr noundef nonnull align 8 dereferenceable(88) %this, ptr noundef nonnull align 8 dereferenceable(25) %primitive_boxes, i32 noundef 0, i32 noundef %56)
  ret void
}
...
while.body.lr.ph:                                 ; preds = %entry
  ...
  %arrayidx7.i17.i.i.i129 = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 3, i32 1, i32 0, i64 1
  %arrayidx11.i20.i.i.i132 = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 3, i32 1, i32 0, i64 2
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end11
  %2 = phi ptr [ %.pre, %while.body.lr.ph ], [ %99, %if.end11 ]
...
if.then:                                          ; preds = %while.body
  ...
  %clampedPoint.sroa.13.0.copyload.i.i.i = load float, ptr %clampedPoint.sroa.13.0.point.sroa_idx.i.i.i, align 8
  ...
  %8 = load float, ptr %arrayidx11.i20.i.i.i132, align 8
  %cmp.i20.i21.i.i.i = fcmp olt float %8, %clampedPoint.sroa.13.0.i.i.i
  %clampedPoint.sroa.13.1.i.i.i = select i1 %cmp.i20.i21.i.i.i, float %8, float %clampedPoint.sroa.13.0.i.i.i
  %sub14.i.i.i.i = fsub float %clampedPoint.sroa.13.1.i.i.i, %7
  %9 = load float, ptr %arrayidx.i16.i.i.i, align 8
  %mul14.i.i.i.i = fmul float %sub14.i.i.i.i, %9
  %10 = load <2 x float>, ptr %leafbox, align 8
  %11 = load <2 x float>, ptr %m_global_bound.i.i29, align 8
  %12 = fcmp olt <2 x float> %10, %11
  %13 = select <2 x i1> %12, <2 x float> %11, <2 x float> %10
  %14 = load <2 x float>, ptr %m_max.i.i112, align 8
  %15 = fcmp olt <2 x float> %14, %13
  %16 = select <2 x i1> %15, <2 x float> %14, <2 x float> %13
  %17 = fsub <2 x float> %16, %11
  %18 = load <2 x float>, ptr %m_bvhQuantization.i.i30, align 8
  ...
  %clampedPoint.sroa.13.0.copyload.i22.i.i = load float, ptr %clampedPoint.sroa.13.0.point.sroa_idx.i21.i.i, align 8
  ...
  %cmp.i20.i21.i37.i.i = fcmp olt float %8, %clampedPoint.sroa.13.0.i30.i.i
  %clampedPoint.sroa.13.1.i38.i.i = select i1 %cmp.i20.i21.i37.i.i, float %8, float %clampedPoint.sroa.13.0.i30.i.i
  ...
  store <2 x i16> %30, ptr %m_quantizedAabbMax.i.i, align 2
  ...
  store i16 %conv10.i53.i.i, ptr %arrayidx11.i54.i.i, align 2
...
if.end:                                           ; preds = %while.body
  ...
  %31 = load float, ptr %m_bvhQuantization.i.i30, align 8
  ...
  %33 = load <2 x float>, ptr %arrayidx.i.i.i.i, align 4
  %34 = load <4 x i16>, ptr %arrayidx.i.i.i28, align 2
  %35 = uitofp <4 x i16> %34 to <4 x float>
  %36 = shufflevector <2 x float> %33, <2 x float> poison, <4 x i32> <i32 poison, i32 0, i32 1, i32 poison>
  ...
  %40 = load <2 x float>, ptr %arrayidx5.i17.i.i.i, align 4
  %41 = load <2 x i16>, ptr %arrayidx2.i20.i.i, align 2
  ...
  %46 = shufflevector <4 x float> %32, <4 x float> %45, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %47 = shufflevector <4 x float> %46, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 0>
  ...
  %55 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i38, align 4
...
if.then9:                                         ; preds = %if.end
  ...
  %58 = load <4 x i16>, ptr %arrayidx.i.i.i41, align 2
  ...
  %61 = load <2 x i16>, ptr %arrayidx2.i20.i.i65, align 2
...
if.end10:                                         ; preds = %if.then9, %if.end
  ...
  %78 = insertelement <4 x float> poison, float %31, i64 0
  %79 = shufflevector <2 x float> %33, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  ...
  %82 = load <2 x float>, ptr %arrayidx7.i17.i.i.i129, align 4
  %83 = select <2 x i1> %76, <2 x float> %40, <2 x float> %73
  %84 = fcmp olt <2 x float> %82, %83
  %85 = select <2 x i1> %84, <2 x float> %82, <2 x float> %83
  %86 = fsub <2 x float> %85, %40
  %87 = fmul <2 x float> %33, %86
  %88 = shufflevector <2 x float> %82, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %89 = shufflevector <4 x float> %75, <4 x float> %88, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %90 = shufflevector <4 x float> %89, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 0>
  %91 = fcmp olt <4 x float> %90, %77
  %92 = select <4 x i1> %91, <4 x float> %90, <4 x float> %77
  %93 = fsub <4 x float> %92, %47
  %94 = fmul <4 x float> %81, %93
  %95 = fadd <4 x float> %94, <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>
  %96 = fptoui <4 x float> %95 to <4 x i16>
  store <4 x i16> %96, ptr %arrayidx.i.i.i110, align 2
  %97 = fadd <2 x float> %87, <float 5.000000e-01, float 5.000000e-01>
  %98 = fptoui <2 x float> %97 to <2 x i16>
  store <2 x i16> %98, ptr %arrayidx7.i51.i.i180, align 2
  br label %if.end11

if.end11:                                         ; preds = %if.end10, %if.then
  %99 = phi ptr [ %2, %if.end10 ], [ %6, %if.then ]
...
if.then.i.i.i:                                    ; preds = %invoke.cont3
  ...
  store i8 1, ptr %m_ownsMemory.i.i.i, align 8
  store ptr %call.i.i.i.i29, ptr %m_data.i.i.i, align 8
...
for.body10.i:                                     ; preds = %for.body10.i, %if.then.i.i.i.new
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %m_max.i.i.i.1, ptr noundef nonnull align 8 dereferenceable(16) %ref.tmp.sroa.0.16.m_max3.i.i.i.sroa_idx, i64 16, i1 false)
  %m_data.i.i.1 = getelementptr inbounds %struct.GIM_BVH_DATA, ptr %4, i64 %indvars.iv.next.i, i32 1
  store i32 0, ptr %m_data.i.i.1, align 4
...
for.body10.i.epil:                                ; preds = %invoke.cont4.unr-lcssa
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %m_max.i.i.i.epil, ptr noundef nonnull align 8 dereferenceable(16) %ref.tmp.sroa.0.16.m_max3.i.i.i.sroa_idx, i64 16, i1 false)
  %m_data.i.i.epil = getelementptr inbounds %struct.GIM_BVH_DATA, ptr %5, i64 %indvars.iv.i.unr, i32 1
  store i32 0, ptr %m_data.i.i.epil, align 4
...
lpad:                                             ; preds = %for.cond.cleanup, %entry
  %7 = landingpad { ptr, i32 }
          cleanup
  %.pre54 = load ptr, ptr %m_data.i.i.i, align 8
  br label %ehcleanup
...
for.body:                                         ; preds = %for.body.preheader, %invoke.cont13
  ...
  %9 = load ptr, ptr %m_primitive_manager, align 8
...
entry:
  ...
  %clampedPoint.sroa.8.0.copyload.i.i = load float, ptr %clampedPoint.sroa.8.0.point.sroa_idx.i.i, align 4
  ...
  %arrayidx7.i17.i.i = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 3, i32 1, i32 0, i64 1
  %5 = load float, ptr %arrayidx7.i17.i.i, align 4
  %cmp.i17.i18.i.i = fcmp olt float %5, %clampedPoint.sroa.8.0.i.i
  %clampedPoint.sroa.8.1.i.i = select i1 %cmp.i17.i18.i.i, float %5, float %clampedPoint.sroa.8.0.i.i
  %arrayidx11.i20.i.i = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 3, i32 1, i32 0, i64 2
  %6 = load float, ptr %arrayidx11.i20.i.i, align 8
  %cmp.i20.i21.i.i = fcmp olt float %6, %clampedPoint.sroa.13.0.i.i
  %clampedPoint.sroa.13.1.i.i = select i1 %cmp.i20.i21.i.i, float %6, float %clampedPoint.sroa.13.0.i.i
  ...
  %8 = load float, ptr %arrayidx7.i34.i.i, align 4
  %mul8.i.i.i = fmul float %sub8.i.i.i, %8
  %arrayidx13.i36.i.i = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 4, i32 0, i64 2
  %9 = load float, ptr %arrayidx13.i36.i.i, align 8
  ...
  %clampedPoint.sroa.0.0.copyload.i.i38 = load float, ptr %m_max, align 4
  %clampedPoint.sroa.8.0.point.sroa_idx.i.i39 = getelementptr inbounds %class.btAABB, ptr %box, i64 0, i32 1, i32 0, i64 1
  %clampedPoint.sroa.8.0.copyload.i.i40 = load float, ptr %clampedPoint.sroa.8.0.point.sroa_idx.i.i39, align 4
  %clampedPoint.sroa.13.0.point.sroa_idx.i.i41 = getelementptr inbounds %class.btAABB, ptr %box, i64 0, i32 1, i32 0, i64 2
  %clampedPoint.sroa.13.0.copyload.i.i42 = load float, ptr %clampedPoint.sroa.13.0.point.sroa_idx.i.i41, align 4
  ...
  %cmp.i17.i18.i.i54 = fcmp olt float %5, %clampedPoint.sroa.8.0.i.i47
  %clampedPoint.sroa.8.1.i.i55 = select i1 %cmp.i17.i18.i.i54, float %5, float %clampedPoint.sroa.8.0.i.i47
  %cmp.i20.i21.i.i57 = fcmp olt float %6, %clampedPoint.sroa.13.0.i.i50
  %clampedPoint.sroa.13.1.i.i58 = select i1 %cmp.i20.i21.i.i57, float %6, float %clampedPoint.sroa.13.0.i.i50
...
lor.lhs.false9.i.i:                               ; preds = %lor.lhs.false.i.i
  ...
  %13 = load i16, ptr %arrayidx11.i.i75, align 2
...
_ZNK18btQuantizedBvhTree24testQuantizedBoxOverlappEiPtS0_.exit.thread: ; preds = %lor.lhs.false23.i.i, %lor.lhs.false16.i.i, %lor.lhs.false9.i.i, %lor.lhs.false.i.i, %while.body
  ...
  %16 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i86, align 4
...
_ZN20btAlignedObjectArrayIiE8allocateEi.exit.i.i: ; preds = %if.then.i.i.i, %if.then.i.i
  ...
  %22 = load ptr, ptr %m_data.i.i.i80, align 8
...
for.body.i.i.i.prol:                              ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i.prol
  ...
  %32 = load i32, ptr %arrayidx3.i.i.i.prol, align 4
  store i32 %32, ptr %arrayidx.i.i.i.prol, align 4
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  ...
  %34 = load i32, ptr %arrayidx3.i.i.i, align 4
  store i32 %34, ptr %arrayidx.i.i.i, align 4
  ...
  %35 = load i32, ptr %arrayidx3.i.i.i.1, align 4
  store i32 %35, ptr %arrayidx.i.i.i.1, align 4
  %indvars.iv.next.i.i.i.1 = add nuw nsw i64 %indvars.iv.i.i.i, 2
  ...
  %36 = load i32, ptr %arrayidx3.i.i.i.2, align 4
  store i32 %36, ptr %arrayidx.i.i.i.2, align 4
  ...
  %37 = load i32, ptr %arrayidx3.i.i.i.3, align 4
  store i32 %37, ptr %arrayidx.i.i.i.3, align 4
...
_ZN20btAlignedObjectArrayIiE10deallocateEv.exit.i.i: ; preds = %if.end.i.i.i, %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i
  ...
  store i8 1, ptr %m_ownsMemory.i.i.i, align 8
  store ptr %retval.0.i.i.i, ptr %m_data.i.i.i80, align 8
...
if.else:                                          ; preds = %if.end
  ...
  %43 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i83, align 4
...
while.body.lr.ph:                                 ; preds = %entry
  ...
  %m_size.i.i = getelementptr inbounds %class.btAlignedObjectArray.4, ptr %collided_results, i64 0, i32 2
  %m_capacity.i.i = getelementptr inbounds %class.btAlignedObjectArray.4, ptr %collided_results, i64 0, i32 3
  %m_data.i.i.i36 = getelementptr inbounds %class.btAlignedObjectArray.4, ptr %collided_results, i64 0, i32 5
  %m_ownsMemory.i.i.i = getelementptr inbounds %class.btAlignedObjectArray.4, ptr %collided_results, i64 0, i32 6
  br label %while.body
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end11
  ...
  %7 = load float, ptr %arrayidx.i16.i.i.i, align 8
  %div10.i.i.i = fdiv float %conv8.i.i.i, %7
  %8 = load <4 x float>, ptr %m_global_bound.i.i, align 8
  %9 = load float, ptr %arrayidx5.i17.i.i.i, align 4
  ...
  %12 = load i16, ptr %arrayidx2.i20.i.i, align 2
  %conv3.i21.i.i = uitofp i16 %12 to float
  %div5.i23.i.i = fdiv float %conv3.i21.i.i, %5
  %arrayidx7.i24.i.i = getelementptr inbounds i16, ptr %m_quantizedAabbMax.i.i, i64 2
  %13 = load i16, ptr %arrayidx7.i24.i.i, align 2
  %conv8.i25.i.i = uitofp i16 %13 to float
  %div10.i27.i.i = fdiv float %conv8.i25.i.i, %7
  %14 = insertelement <2 x i16> poison, i16 %2, i64 0
  %15 = insertelement <2 x i16> %14, i16 %11, i64 1
  %16 = uitofp <2 x i16> %15 to <2 x float>
  %17 = shufflevector <4 x float> %3, <4 x float> poison, <2 x i32> zeroinitializer
  %18 = fdiv <2 x float> %16, %17
  %19 = shufflevector <4 x float> %8, <4 x float> poison, <2 x i32> zeroinitializer
  %20 = fadd <2 x float> %18, %19
  %add8.i.i30.i.i = fadd float %9, %div5.i23.i.i
  %add13.i.i33.i.i = fadd float %10, %div10.i27.i.i
  ...
  %23 = load float, ptr %ray_origin, align 4
...
land.lhs.true.i:                                  ; preds = %while.body
  %25 = load float, ptr %ray_dir, align 4
...
land.lhs.true19.i:                                ; preds = %if.end.i
  %28 = load float, ptr %arrayidx21.i, align 4
...
if.end41.i:                                       ; preds = %if.end25.i
  %32 = load float, ptr %arrayidx21.i, align 4
  %33 = fneg float %31
...
if.end63.i:                                       ; preds = %if.end41.i
  %39 = load float, ptr %ray_dir, align 4
  %40 = fneg float %39
...
_ZNK6btAABB11collide_rayERK9btVector3S2_.exit.thread: ; preds = %land.lhs.true.i, %land.lhs.true19.i, %if.end41.i, %if.end63.i, %if.end25.i
  ...
  %45 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i43, align 4
...
_ZNK6btAABB11collide_rayERK9btVector3S2_.exit:    ; preds = %if.end63.i
  ...
  %50 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i, align 4
...
if.then:                                          ; preds = %_ZNK6btAABB11collide_rayERK9btVector3S2_.exit
  ...
  %52 = load i32, ptr %m_capacity.i.i, align 8
...
_ZN20btAlignedObjectArrayIiE8allocateEi.exit.i.i: ; preds = %if.then.i.i.i, %if.then.i.i
  ...
  %54 = load ptr, ptr %m_data.i.i.i36, align 8
  br i1 %cmp7.i.i.i, label %for.body.lr.ph.i.i.i, label %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load56 = load <4 x i32>, ptr %59, align 4
  store <4 x i32> %wide.load, ptr %57, align 4
  %60 = getelementptr inbounds i32, ptr %57, i64 4
  store <4 x i32> %wide.load56, ptr %60, align 4
  %index.next = add nuw i64 %index, 8
...
for.body.i.i.i.prol:                              ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i.prol
  %indvars.iv.i.i.i.prol = phi i64 [ %indvars.iv.next.i.i.i.prol, %for.body.i.i.i.prol ], [ %indvars.iv.i.i.i.ph, %for.body.i.i.i.preheader ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body.i.i.i.prol ], [ 0, %for.body.i.i.i.preheader ]
  %arrayidx.i.i.i37.prol = getelementptr inbounds i32, ptr %retval.0.i.i.i, i64 %indvars.iv.i.i.i.prol
  %arrayidx3.i.i.i.prol = getelementptr inbounds i32, ptr %54, i64 %indvars.iv.i.i.i.prol
  %64 = load i32, ptr %arrayidx3.i.i.i.prol, align 4
  store i32 %64, ptr %arrayidx.i.i.i37.prol, align 4
  %indvars.iv.next.i.i.i.prol = add nuw nsw i64 %indvars.iv.i.i.i.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body.i.i.i.prol.loopexit, label %for.body.i.i.i.prol
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  %indvars.iv.i.i.i = phi i64 [ %indvars.iv.next.i.i.i.3, %for.body.i.i.i ], [ %indvars.iv.i.i.i.unr, %for.body.i.i.i.prol.loopexit ]
  %arrayidx.i.i.i37 = getelementptr inbounds i32, ptr %retval.0.i.i.i, i64 %indvars.iv.i.i.i
  %arrayidx3.i.i.i = getelementptr inbounds i32, ptr %54, i64 %indvars.iv.i.i.i
  %66 = load i32, ptr %arrayidx3.i.i.i, align 4
  store i32 %66, ptr %arrayidx.i.i.i37, align 4
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1
  %arrayidx.i.i.i37.1 = getelementptr inbounds i32, ptr %retval.0.i.i.i, i64 %indvars.iv.next.i.i.i
  %arrayidx3.i.i.i.1 = getelementptr inbounds i32, ptr %54, i64 %indvars.iv.next.i.i.i
  %67 = load i32, ptr %arrayidx3.i.i.i.1, align 4
  store i32 %67, ptr %arrayidx.i.i.i37.1, align 4
  %indvars.iv.next.i.i.i.1 = add nuw nsw i64 %indvars.iv.i.i.i, 2
  %arrayidx.i.i.i37.2 = getelementptr inbounds i32, ptr %retval.0.i.i.i, i64 %indvars.iv.next.i.i.i.1
  %arrayidx3.i.i.i.2 = getelementptr inbounds i32, ptr %54, i64 %indvars.iv.next.i.i.i.1
  %68 = load i32, ptr %arrayidx3.i.i.i.2, align 4
  store i32 %68, ptr %arrayidx.i.i.i37.2, align 4
  %indvars.iv.next.i.i.i.2 = add nuw nsw i64 %indvars.iv.i.i.i, 3
  %arrayidx.i.i.i37.3 = getelementptr inbounds i32, ptr %retval.0.i.i.i, i64 %indvars.iv.next.i.i.i.2
  %arrayidx3.i.i.i.3 = getelementptr inbounds i32, ptr %54, i64 %indvars.iv.next.i.i.i.2
  %69 = load i32, ptr %arrayidx3.i.i.i.3, align 4
  store i32 %69, ptr %arrayidx.i.i.i37.3, align 4
  %indvars.iv.next.i.i.i.3 = add nuw nsw i64 %indvars.iv.i.i.i, 4
  %exitcond.not.i.i.i.3 = icmp eq i64 %indvars.iv.next.i.i.i.3, %wide.trip.count.i.i.i
  br i1 %exitcond.not.i.i.i.3, label %if.then.i11.i.i, label %for.body.i.i.i
...
if.end.thread:                                    ; preds = %_ZN20btAlignedObjectArrayIiE10deallocateEv.exit.i.i, %if.then.i, %if.then
  ...
  %73 = load i32, ptr %m_size.i.i, align 4
...
if.else:                                          ; preds = %if.end
  ...
  %75 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i40, align 4
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  %13 = load float, ptr %m_origin.i6.i, align 4
  %arrayidx7.i.i.i.i = getelementptr inbounds %class.btTransform, ptr %trans1, i64 0, i32 1, i32 0, i64 1
  %14 = load float, ptr %arrayidx7.i.i.i.i, align 4
  %arrayidx12.i.i.i.i = getelementptr inbounds %class.btTransform, ptr %trans1, i64 0, i32 1, i32 0, i64 2
  %15 = load float, ptr %arrayidx12.i.i.i.i, align 4
  %16 = load <2 x float>, ptr %trans0, align 4
  %17 = load <2 x float>, ptr %arrayidx3.i.i.i, align 4
  %18 = load <2 x float>, ptr %arrayidx6.i.i.i, align 4
  ...
  store <2 x float> %47, ptr %trans_cache_1to0, align 8
  %temp_trans.sroa.43.48.this.sroa_idx.i = getelementptr inbounds i8, ptr %trans_cache_1to0, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i.i5, ptr %temp_trans.sroa.43.48.this.sroa_idx.i, align 8
  ...
  store float %32, ptr %temp_trans.sroa.9.0.m_R1to0.sroa_idx.i, align 8
  ...
  store float 0.000000e+00, ptr %temp_trans.sroa.12.0.m_R1to0.sroa_idx.i, align 4
  ...
  store float %37, ptr %temp_trans.sroa.21.16.arrayidx7.i.sroa_idx.i, align 8
  ...
  store float 0.000000e+00, ptr %temp_trans.sroa.24.16.arrayidx7.i.sroa_idx.i, align 4
  ...
  store float %12, ptr %temp_trans.sroa.33.32.arrayidx11.i.sroa_idx.i, align 8
  ...
  store float 0.000000e+00, ptr %temp_trans.sroa.36.32.arrayidx11.i.sroa_idx.i, align 4
  %m_AR.i.i = getelementptr inbounds %class.BT_BOX_BOX_TRANSFORM_CACHE, ptr %trans_cache_1to0, i64 0, i32 2
  %61 = load <2 x float>, ptr %trans1, align 4
  %62 = load <2 x float>, ptr %arrayidx4.i.i.i.i, align 4
  ...
  %67 = load <2 x float>, ptr %arrayidx9.i.i.i.i, align 4
  ...
  store <2 x float> %71, ptr %m_AR.i.i, align 8
  ...
  store float %add.2.i.i, ptr %arrayidx10.2.i.i, align 8
  ...
  store <2 x float> %80, ptr %arrayidx.i21.1.i.i, align 8
  ...
  store float %add.2.1.i.i, ptr %arrayidx10.2.1.i.i, align 8
  ...
  store <2 x float> %86, ptr %arrayidx.i21.2.i.i, align 8
  ...
  store float %add.2.2.i.i, ptr %arrayidx10.2.2.i.i, align 8
...
entry:
  ...
  %1 = load i16, ptr %arrayidx7.i.i.i.i, align 2
  ...
  %2 = load float, ptr %arrayidx.i16.i.i.i.i, align 4
  %div10.i.i.i.i = fdiv float %conv8.i.i.i.i, %2
  %3 = load <2 x i16>, ptr %arrayidx.i.i.i.i, align 2
  %4 = uitofp <2 x i16> %3 to <2 x float>
  %5 = load <2 x float>, ptr %m_bvhQuantization.i.i.i, align 4
  %6 = fdiv <2 x float> %4, %5
  %7 = load <2 x float>, ptr %m_global_bound.i.i.i, align 4
  %8 = fadd <2 x float> %6, %7
  %arrayidx10.i.i.i.i.i = getelementptr inbounds %class.btQuantizedBvhTree, ptr %boxset0, i64 0, i32 3, i32 0, i32 0, i64 2
  %9 = load float, ptr %arrayidx10.i.i.i.i.i, align 4
  ...
  store <2 x float> %8, ptr %box0.i, align 8
  %ref.tmp.sroa.4.0.m_min3.sroa_idx.i.i.i = getelementptr inbounds i8, ptr %box0.i, i64 8
  store <2 x float> %retval.sroa.7.8.vec.insert29.i.i.i.i, ptr %ref.tmp.sroa.4.0.m_min3.sroa_idx.i.i.i, align 8
  ...
  %10 = load i16, ptr %arrayidx7.i24.i.i.i, align 2
  %conv8.i25.i.i.i = uitofp i16 %10 to float
  %div10.i27.i.i.i = fdiv float %conv8.i25.i.i.i, %2
  %11 = load <2 x i16>, ptr %m_quantizedAabbMax.i.i.i, align 2
  ...
  store <2 x float> %14, ptr %m_max.i.i.i, align 8
  %ref.tmp4.sroa.4.0.m_max.sroa_idx.i.i.i = getelementptr inbounds %class.btAABB, ptr %box0.i, i64 0, i32 1, i32 0, i64 2
  store <2 x float> %retval.sroa.7.8.vec.insert29.i34.i.i.i, ptr %ref.tmp4.sroa.4.0.m_max.sroa_idx.i.i.i, align 8
  ...
  %15 = load ptr, ptr %m_data.i.i.i1.i, align 8
  ...
  %16 = load i16, ptr %arrayidx7.i.i.i12.i, align 2
  ...
  %17 = load float, ptr %arrayidx.i16.i.i.i14.i, align 4
  %div10.i.i.i15.i = fdiv float %conv8.i.i.i13.i, %17
  %18 = load <2 x i16>, ptr %arrayidx.i.i.i3.i, align 2
  %19 = uitofp <2 x i16> %18 to <2 x float>
  %20 = load <2 x float>, ptr %m_bvhQuantization.i.i5.i, align 4
  %21 = fdiv <2 x float> %19, %20
  %22 = load <2 x float>, ptr %m_global_bound.i.i4.i, align 4
  ...
  %24 = load float, ptr %arrayidx10.i.i.i.i20.i, align 4
  ...
  store <2 x float> %23, ptr %box1.i, align 8
  %ref.tmp.sroa.4.0.m_min3.sroa_idx.i.i23.i = getelementptr inbounds i8, ptr %box1.i, i64 8
  store <2 x float> %retval.sroa.7.8.vec.insert29.i.i.i22.i, ptr %ref.tmp.sroa.4.0.m_min3.sroa_idx.i.i23.i, align 8
  ...
  %25 = load i16, ptr %arrayidx7.i24.i.i30.i, align 2
  %conv8.i25.i.i31.i = uitofp i16 %25 to float
  %div10.i27.i.i32.i = fdiv float %conv8.i25.i.i31.i, %17
  %26 = load <2 x i16>, ptr %m_quantizedAabbMax.i.i24.i, align 2
  ...
  store <2 x float> %29, ptr %m_max.i.i38.i, align 8
  %ref.tmp4.sroa.4.0.m_max.sroa_idx.i.i39.i = getelementptr inbounds %class.btAABB, ptr %box1.i, i64 0, i32 1, i32 0, i64 2
  store <2 x float> %retval.sroa.7.8.vec.insert29.i34.i.i37.i, ptr %ref.tmp4.sroa.4.0.m_max.sroa_idx.i.i39.i, align 8
...
if.end:                                           ; preds = %entry
  ...
  %31 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i, align 4
  %cmp.i.i.i = icmp sgt i32 %31, -1
  %32 = load ptr, ptr %m_data.i.i.i1.i, align 8
  %m_escapeIndexOrDataIndex.i.i.i98 = getelementptr inbounds %struct.BT_QUANTIZED_BVH_NODE, ptr %32, i64 %idxprom.i.i.i2.i, i32 2
  %33 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i98, align 4
...
_ZN20btAlignedObjectArrayI8GIM_PAIRE8allocateEi.exit.i.i.i: ; preds = %if.then.i.i.i.i, %if.then.i.i.i
  ...
  %37 = load ptr, ptr %m_data.i.i.i.i107, align 8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <4 x i32>, ptr %41, align 4
  %wide.vec170 = load <4 x i32>, ptr %42, align 4
  ...
  store <4 x i32> %wide.vec, ptr %43, align 4
  store <4 x i32> %wide.vec170, ptr %44, align 4
...
for.body.i.i.i.i.prol:                            ; preds = %for.body.i.i.i.i.preheader, %for.body.i.i.i.i.prol
  ...
  %48 = load <2 x i32>, ptr %arrayidx3.i.i.i.i.prol, align 4
  store <2 x i32> %48, ptr %arrayidx.i.i.i.i108.prol, align 4
...
for.body.i.i.i.i:                                 ; preds = %for.body.i.i.i.i.prol.loopexit, %for.body.i.i.i.i
  ...
  %50 = load <2 x i32>, ptr %arrayidx3.i.i.i.i, align 4
  store <2 x i32> %50, ptr %arrayidx.i.i.i.i108, align 4
  ...
  %51 = load <2 x i32>, ptr %arrayidx3.i.i.i.i.1, align 4
  store <2 x i32> %51, ptr %arrayidx.i.i.i.i108.1, align 4
  ...
  %52 = load <2 x i32>, ptr %arrayidx3.i.i.i.i.2, align 4
  store <2 x i32> %52, ptr %arrayidx.i.i.i.i108.2, align 4
  ...
  %53 = load <2 x i32>, ptr %arrayidx3.i.i.i.i.3, align 4
  store <2 x i32> %53, ptr %arrayidx.i.i.i.i108.3, align 4
...
if.then.i11.i.i.i:                                ; preds = %for.body.i.i.i.i.prol.loopexit, %for.body.i.i.i.i, %middle.block
  ...
  %.old.i.i = load i8, ptr %m_ownsMemory.i.i.old.i.i, align 8
...
_ZN20btAlignedObjectArrayI8GIM_PAIRE10deallocateEv.exit.i.i.i: ; preds = %if.then3.i.i.i.i, %if.then.i11.i.i.i, %_ZNK20btAlignedObjectArrayI8GIM_PAIRE4copyEiiPS0_.exit.i.i.i
  ...
  store i8 1, ptr %m_ownsMemory.i.i.i, align 8
  store ptr %retval.0.i.i.i.i, ptr %m_data.i.i.i.i107, align 8
...
_ZN9btPairSet9push_pairEii.exit:                  ; preds = %if.then4, %if.then.i.i, %_ZN20btAlignedObjectArrayI8GIM_PAIRE10deallocateEv.exit.i.i.i
  ...
  store i32 %33, ptr %m_index23.i.i.i, align 4
...
if.else:                                          ; preds = %if.then2
  ...
  %57 = load ptr, ptr %m_data.i.i.i1.i, align 8
  ...
  %58 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i112, align 4
...
if.then12:                                        ; preds = %if.else10
  ...
  %59 = load ptr, ptr %m_data.i.i.i.i, align 8
  ...
  %60 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i121, align 4
...
if.else15:                                        ; preds = %if.else10
  ...
  %61 = load ptr, ptr %m_data.i.i.i1.i, align 8
  ...
  %62 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i132, align 4
  ...
  %63 = load ptr, ptr %m_data.i.i.i.i, align 8
  ...
  %64 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i140, align 4
...
entry:
  ...
  %6 = load float, ptr %m_max.i179, align 4
  ...
  %12 = load float, ptr %m_R1to0, align 4
  ...
  %17 = load float, ptr %transcache, align 4
  %add = fadd float %17, %16
  %sub = fsub float %add, %mul.i.i
  %18 = load float, ptr %m_AR, align 4
  ...
  %19 = load float, ptr %arrayidx5.i203, align 4
  ...
  %21 = load float, ptr %arrayidx10.i206, align 4
...
for.cond:                                         ; preds = %entry
  ...
  %27 = load float, ptr %arrayidx10.i.1, align 4
  ...
  %29 = load float, ptr %arrayidx.1, align 4
  ...
  %30 = load float, ptr %arrayidx.i202.1, align 4
  ...
  %31 = load float, ptr %arrayidx5.i203.1, align 4
  ...
  %33 = load float, ptr %arrayidx10.i206.1, align 4
...
for.cond.1:                                       ; preds = %for.cond
  ...
  %39 = load float, ptr %arrayidx10.i.2, align 4
  ...
  %41 = load float, ptr %arrayidx.2, align 4
  ...
  %42 = load float, ptr %arrayidx.i202.2, align 4
  ...
  %43 = load float, ptr %arrayidx5.i203.2, align 4
  ...
  %45 = load float, ptr %arrayidx10.i206.2, align 4
...
attributes #0 = { nofree norecurse nosync nounwind memory(read, argmem: readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #4 = { nofree nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
