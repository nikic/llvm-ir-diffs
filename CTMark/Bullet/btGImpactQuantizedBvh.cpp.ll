...
for.body.prol:                                    ; preds = %for.body.lr.ph
  ...
  %3 = load float, ptr %m_max.prol, align 4, !tbaa !17
  %4 = load float, ptr %arrayidx.i.prol, align 4, !tbaa !17
  %add.i.prol = fadd float %3, %4
  ...
  %5 = load <2 x float>, ptr %arrayidx5.i69.prol, align 4, !tbaa !17
  %6 = load <2 x float>, ptr %arrayidx7.i70.prol, align 4, !tbaa !17
  ...
  %9 = fadd <2 x float> %8, zeroinitializer
...
for.body.prol.loopexit:                           ; preds = %for.body.prol, %for.body.lr.ph
  ...
  %.lcssa195.unr = phi <2 x float> [ undef, %for.body.lr.ph ], [ %9, %for.body.prol ]
  ...
  %.unr = phi <2 x float> [ zeroinitializer, %for.body.lr.ph ], [ %9, %for.body.prol ]
...
for.body.prol:                                    ; preds = %for.body.lr.ph
  ...
  %4 = load float, ptr %arrayidx11.i.prol, align 4, !tbaa !17
  %arrayidx13.i.prol = getelementptr inbounds [4 x float], ptr %arrayidx.i.prol, i64 0, i64 2
  %5 = load float, ptr %arrayidx13.i.prol, align 4, !tbaa !17
  %add14.i.prol = fadd float %4, %5
  %6 = load <2 x float>, ptr %m_max.prol, align 4, !tbaa !17
  %7 = load <2 x float>, ptr %arrayidx.i.prol, align 4, !tbaa !17
...
for.body.prol.loopexit:                           ; preds = %for.body.prol, %for.body.lr.ph
  %.lcssa.unr = phi <2 x float> [ undef, %for.body.lr.ph ], [ %10, %for.body.prol ]
  ...
  %.unr136 = phi <2 x float> [ zeroinitializer, %for.body.lr.ph ], [ %10, %for.body.prol ]
...
if.then:                                          ; preds = %entry
  ...
  %4 = load float, ptr %arrayidx11.i20.i.i, align 8, !tbaa !17
...
for.cond.cleanup:                                 ; preds = %for.body, %if.end
  ...
  %37 = load <2 x float>, ptr %arrayidx7.i17.i.i67, align 4, !tbaa !17
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  %5 = load float, ptr %arrayidx39.i.i, align 4, !tbaa !17
  ...
  %17 = load <2 x float>, ptr %arrayidx78.i.i, align 4, !tbaa !17
...
_ZN18btQuantizedBvhTree17calc_quantizationER18GIM_BVH_DATA_ARRAYf.exit: ; preds = %_ZN18btQuantizedBvhTree17calc_quantizationER18GIM_BVH_DATA_ARRAYf.exit.loopexit, %entry
  ...
  store <2 x float> %26, ptr %m_global_bound.i, align 8, !tbaa.struct !14
  %ref.tmp.sroa.4.0..sroa_idx.i.i = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 3, i32 0, i32 0, i64 2
  store <2 x float> %28, ptr %ref.tmp.sroa.4.0..sroa_idx.i.i, align 8, !tbaa.struct !16
  ...
  store <2 x float> %retval.sroa.0.4.vec.insert.i22.i.i, ptr %m_max.i, align 8, !tbaa.struct !14
  %ref.tmp1.sroa.4.0..sroa_idx.i.i = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 3, i32 1, i32 0, i64 2
  store <2 x float> %retval.sroa.3.12.vec.insert.i23.i.i, ptr %ref.tmp1.sroa.4.0..sroa_idx.i.i, align 8, !tbaa.struct !16
  ...
  store <2 x float> %35, ptr %m_bvhQuantization.i, align 8, !tbaa.struct !14
...
if.then5.i:                                       ; preds = %_ZN18btQuantizedBvhTree17calc_quantizationER18GIM_BVH_DATA_ARRAYf.exit
  ...
  %38 = load i32, ptr %m_capacity.i.i.i, align 8, !tbaa !37
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i.new
  ...
  %41 = load ptr, ptr %m_data.i.i.i, align 8, !tbaa !31
  ...
  %42 = load ptr, ptr %m_data.i.i.i, align 8, !tbaa !31
...
for.body.i.i.i.epil:                              ; preds = %_ZNK20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa
  ...
  %43 = load ptr, ptr %m_data.i.i.i, align 8, !tbaa !31
...
_ZNK20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE4copyEiiPS0_.exit.i.i: ; preds = %for.body.i.i.i.epil, %_ZNK20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa, %_ZN20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE8allocateEi.exit.i.i
  ...
  %44 = load ptr, ptr %m_data.i9.i.i, align 8, !tbaa !31
  ...
  %45 = load i8, ptr %m_ownsMemory.i.i.i, align 8, !range !39
...
for.body10.i:                                     ; preds = %for.body10.i.prol.loopexit, %for.body10.i
  ...
  %52 = load ptr, ptr %m_data11.i, align 8, !tbaa !31
  ...
  %53 = load ptr, ptr %m_data11.i, align 8, !tbaa !31
  ...
  %54 = load ptr, ptr %m_data11.i, align 8, !tbaa !31
  ...
  %55 = load ptr, ptr %m_data11.i, align 8, !tbaa !31
...
if.then:                                          ; preds = %while.body
  ...
  %8 = load float, ptr %arrayidx11.i20.i.i.i132, align 8, !tbaa !17
...
if.end10:                                         ; preds = %if.then9, %if.end
  ...
  %82 = load <2 x float>, ptr %arrayidx7.i17.i.i.i129, align 4, !tbaa !17
  ...
  store <4 x i16> %96, ptr %arrayidx.i.i.i110, align 2, !tbaa !32
  %97 = fadd <2 x float> %87, <float 5.000000e-01, float 5.000000e-01>
  %98 = fptoui <2 x float> %97 to <2 x i16>
  store <2 x i16> %98, ptr %arrayidx7.i51.i.i180, align 2, !tbaa !32
  br label %if.end11
...
entry:
  ...
  %5 = load float, ptr %arrayidx7.i17.i.i, align 4, !tbaa !17
  ...
  %arrayidx11.i20.i.i = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 3, i32 1, i32 0, i64 2
  %6 = load float, ptr %arrayidx11.i20.i.i, align 8, !tbaa !17
  ...
  %clampedPoint.sroa.8.0.copyload.i.i40 = load float, ptr %clampedPoint.sroa.8.0.point.sroa_idx.i.i39, align 4, !tbaa.struct !49
...
lor.lhs.false16.i.i:                              ; preds = %lor.lhs.false9.i.i
  ...
  %14 = load i16, ptr %arrayidx18.i.i, align 2, !tbaa !32
...
if.then:                                          ; preds = %_ZNK18btQuantizedBvhTree24testQuantizedBoxOverlappEiPtS0_.exit
  %19 = load i32, ptr %m_size.i.i, align 4, !tbaa !50
  %20 = load i32, ptr %m_capacity.i.i, align 8, !tbaa !53
...
_ZN20btAlignedObjectArrayIiE8allocateEi.exit.i.i: ; preds = %if.then.i.i.i, %if.then.i.i
  ...
  %22 = load ptr, ptr %m_data.i.i.i80, align 8, !tbaa !54
...
if.then.i11.i.i:                                  ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i, %middle.block, %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i
  %38 = load i8, ptr %m_ownsMemory.i.i.i, align 8, !tbaa !60, !range !39, !noundef !61
...
_ZN20btAlignedObjectArrayIiE10deallocateEv.exit.i.i: ; preds = %if.end.i.i.i, %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i
  ...
  store ptr %retval.0.i.i.i, ptr %m_data.i.i.i80, align 8, !tbaa !54
...
if.end.thread:                                    ; preds = %_ZN20btAlignedObjectArrayIiE10deallocateEv.exit.i.i, %if.then.i, %if.then
  ...
  %40 = load ptr, ptr %m_data.i.i.i80, align 8, !tbaa !54
  ...
  %41 = load i32, ptr %m_size.i.i, align 4, !tbaa !50
...
while.end:                                        ; preds = %if.end16, %entry
  ...
  %44 = load i32, ptr %m_size.i, align 4, !tbaa !50
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end11
  ...
  %11 = load i16, ptr %m_quantizedAabbMax.i.i, align 2, !tbaa !32
  %arrayidx2.i20.i.i = getelementptr inbounds i16, ptr %m_quantizedAabbMax.i.i, i64 1
  %12 = load i16, ptr %arrayidx2.i20.i.i, align 2, !tbaa !32
  ...
  %13 = load i16, ptr %arrayidx7.i24.i.i, align 2, !tbaa !32
...
if.then:                                          ; preds = %_ZNK6btAABB11collide_rayERK9btVector3S2_.exit
  %51 = load i32, ptr %m_size.i.i, align 4, !tbaa !50
  %52 = load i32, ptr %m_capacity.i.i, align 8, !tbaa !53
...
_ZN20btAlignedObjectArrayIiE8allocateEi.exit.i.i: ; preds = %if.then.i.i.i, %if.then.i.i
  ...
  %54 = load ptr, ptr %m_data.i.i.i36, align 8, !tbaa !54
  br i1 %cmp7.i.i.i, label %for.body.lr.ph.i.i.i, label %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i
...
for.body.i.i.i.prol:                              ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i.prol
  ...
  store i32 %64, ptr %arrayidx.i.i.i37.prol, align 4, !tbaa !24
  %indvars.iv.next.i.i.i.prol = add nuw nsw i64 %indvars.iv.i.i.i.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  ...
  store i32 %66, ptr %arrayidx.i.i.i37, align 4, !tbaa !24
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1
  ...
  store i32 %67, ptr %arrayidx.i.i.i37.1, align 4, !tbaa !24
  %indvars.iv.next.i.i.i.1 = add nuw nsw i64 %indvars.iv.i.i.i, 2
  ...
  store i32 %68, ptr %arrayidx.i.i.i37.2, align 4, !tbaa !24
  %indvars.iv.next.i.i.i.2 = add nuw nsw i64 %indvars.iv.i.i.i, 3
  ...
  store i32 %69, ptr %arrayidx.i.i.i37.3, align 4, !tbaa !24
  %indvars.iv.next.i.i.i.3 = add nuw nsw i64 %indvars.iv.i.i.i, 4
  %exitcond.not.i.i.i.3 = icmp eq i64 %indvars.iv.next.i.i.i.3, %wide.trip.count.i.i.i
...
if.then.i11.i.i:                                  ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i, %middle.block, %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i
  %70 = load i8, ptr %m_ownsMemory.i.i.i, align 8, !tbaa !60, !range !39, !noundef !61
...
_ZN20btAlignedObjectArrayIiE10deallocateEv.exit.i.i: ; preds = %if.end.i.i.i, %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i
  ...
  store i8 1, ptr %m_ownsMemory.i.i.i, align 8, !tbaa !60
  store ptr %retval.0.i.i.i, ptr %m_data.i.i.i36, align 8, !tbaa !54
  store i32 %cond.i.i, ptr %m_capacity.i.i, align 8, !tbaa !53
  br label %if.end.thread

if.end.thread:                                    ; preds = %_ZN20btAlignedObjectArrayIiE10deallocateEv.exit.i.i, %if.then.i, %if.then
  %71 = phi i32 [ %.pre7.i, %_ZN20btAlignedObjectArrayIiE10deallocateEv.exit.i.i ], [ %51, %if.then.i ], [ %51, %if.then ]
  %72 = load ptr, ptr %m_data.i.i.i36, align 8, !tbaa !54
  ...
  %73 = load i32, ptr %m_size.i.i, align 4, !tbaa !50
...
while.end:                                        ; preds = %if.end11, %entry
  %m_size.i = getelementptr inbounds %class.btAlignedObjectArray.4, ptr %collided_results, i64 0, i32 2
  %76 = load i32, ptr %m_size.i, align 4, !tbaa !50
...
entry:
  ...
  %2 = load float, ptr %arrayidx.i16.i.i.i.i, align 4, !tbaa !17
  ...
  %5 = load <2 x float>, ptr %m_bvhQuantization.i.i.i, align 4, !tbaa !17
  %6 = fdiv <2 x float> %4, %5
  %7 = load <2 x float>, ptr %m_global_bound.i.i.i, align 4, !tbaa !17
  %8 = fadd <2 x float> %6, %7
  %arrayidx10.i.i.i.i.i = getelementptr inbounds %class.btQuantizedBvhTree, ptr %boxset0, i64 0, i32 3, i32 0, i32 0, i64 2
  %9 = load float, ptr %arrayidx10.i.i.i.i.i, align 4, !tbaa !17
  ...
  %17 = load float, ptr %arrayidx.i16.i.i.i14.i, align 4, !tbaa !17
  ...
  %20 = load <2 x float>, ptr %m_bvhQuantization.i.i5.i, align 4, !tbaa !17
  %21 = fdiv <2 x float> %19, %20
  %22 = load <2 x float>, ptr %m_global_bound.i.i4.i, align 4, !tbaa !17
  ...
  %24 = load float, ptr %arrayidx10.i.i.i.i20.i, align 4, !tbaa !17
