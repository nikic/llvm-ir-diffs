...
entry:
  ...
  %.pre = load float, ptr %pt, align 8, !tbaa !18
...
entry.if.then27_crit_edge:                        ; preds = %entry
  ...
  %.pre246 = load float, ptr %arrayidx5.i125.phi.trans.insert, align 4, !tbaa !18
  ...
  %5 = load <2 x float>, ptr %arrayidx35.phi.trans.insert, align 8, !tbaa !18
  %6 = load <2 x float>, ptr %arrayidx38.phi.trans.insert, align 8, !tbaa !18
...
if.then9:                                         ; preds = %entry
  ...
  %17 = load <2 x float>, ptr %arrayidx15, align 8, !tbaa !18
  %18 = load <2 x float>, ptr %arrayidx18, align 8, !tbaa !18
...
if.then9.if.then48_crit_edge:                     ; preds = %if.then9
  ...
  %36 = load <2 x float>, ptr %m_pointCache50.phi.trans.insert, align 8, !tbaa !18
...
if.then27:                                        ; preds = %entry.if.then27_crit_edge, %if.then9
  ...
  %51 = load <2 x float>, ptr %m_pointCache29, align 8, !tbaa !18
  ...
  %55 = load float, ptr %arrayidx13.i129, align 8, !tbaa !18
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %8 = load float, ptr %arrayidx7.i.i, align 4, !tbaa !18
  ...
  %11 = load float, ptr %arrayidx12.i.i, align 8, !tbaa !18
  %12 = load float, ptr %arrayidx.i.i, align 4, !tbaa !18
  %13 = load float, ptr %arrayidx5.i20.i, align 4, !tbaa !18
  %14 = load float, ptr %arrayidx10.i23.i, align 4, !tbaa !18
  ...
  %37 = load float, ptr %m_localPointB, align 8, !tbaa !18
  ...
  %40 = load float, ptr %arrayidx7.i.i69, align 4, !tbaa !18
  ...
  %43 = load float, ptr %arrayidx12.i.i72, align 8, !tbaa !18
  %44 = load float, ptr %arrayidx.i.i75, align 4, !tbaa !18
  %45 = load float, ptr %arrayidx5.i20.i76, align 4, !tbaa !18
  %46 = load float, ptr %arrayidx10.i23.i78, align 4, !tbaa !18
...
if.then.i150:                                     ; preds = %_ZN20btPersistentManifold14clearUserCacheER15btManifoldPoint.exit.i146
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(172) %arrayidx20, ptr noundef nonnull align 8 dereferenceable(172) %arrayidx4.i152, i64 172, i1 false), !tbaa.struct !25
  ...
  store ptr null, ptr %m_userPersistentData.i153, align 8, !tbaa !10
  %m_appliedImpulse.i154 = getelementptr inbounds %class.btPersistentManifold, ptr %this, i64 0, i32 2, i64 %idxprom3.i151, i32 14
  store float 0.000000e+00, ptr %m_appliedImpulse.i154, align 8, !tbaa !16
  ...
  store i8 0, ptr %m_lateralFrictionInitialized.i155, align 4, !tbaa !17
  ...
  store <2 x float> zeroinitializer, ptr %m_appliedImpulseLateral1.i156, align 8, !tbaa !18
  %m_lifeTime.i158 = getelementptr inbounds %class.btPersistentManifold, ptr %this, i64 0, i32 2, i64 %idxprom3.i151, i32 19
  store i32 0, ptr %m_lifeTime.i158, align 8, !tbaa !19
  %.pre.i159 = load i32, ptr %m_cachedPoints.i, align 8, !tbaa !23
