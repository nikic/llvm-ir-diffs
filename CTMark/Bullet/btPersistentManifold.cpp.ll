; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btPersistentManifold.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btPersistentManifold.cpp"
...
entry:
  ...
  store i8 0, ptr %m_lateralFrictionInitialized.i, align 4
  %m_appliedImpulseLateral1.i = getelementptr inbounds %class.btPersistentManifold, ptr %this, i64 0, i32 2, i64 0, i32 17
  store <2 x float> zeroinitializer, ptr %m_appliedImpulseLateral1.i, align 8
...
entry:
  ...
  %1 = load float, ptr %m_distance1.i103, align 8
  ...
  %2 = load float, ptr %m_distance1.i103.1, align 8
  ...
  %3 = load float, ptr %m_distance1.i103.2, align 8
  ...
  %4 = load float, ptr %m_distance1.i103.3, align 8
  ...
  %.pre = load float, ptr %pt, align 8
  br i1 %cond, label %entry.if.then27_crit_edge, label %if.then9

entry.if.then27_crit_edge:                        ; preds = %entry
  %arrayidx5.i125.phi.trans.insert = getelementptr inbounds [4 x float], ptr %pt, i64 0, i64 1
  %.pre246 = load float, ptr %arrayidx5.i125.phi.trans.insert, align 4
  %arrayidx11.i128.phi.trans.insert = getelementptr inbounds [4 x float], ptr %pt, i64 0, i64 2
  %.pre247 = load float, ptr %arrayidx11.i128.phi.trans.insert, align 8
  ...
  %5 = load <2 x float>, ptr %arrayidx35.phi.trans.insert, align 8
  %6 = load <2 x float>, ptr %arrayidx38.phi.trans.insert, align 8
  ...
  %.pre252 = load float, ptr %arrayidx11.i140.phi.trans.insert, align 8
  ...
  %.pre253 = load float, ptr %arrayidx13.i141.phi.trans.insert, align 8
...
if.then9:                                         ; preds = %entry
  ...
  %12 = load float, ptr %arrayidx11, align 8
  %sub.i = fsub float %.pre, %12
  ...
  %17 = load <2 x float>, ptr %arrayidx15, align 8
  %18 = load <2 x float>, ptr %arrayidx18, align 8
  ...
  %20 = load float, ptr %arrayidx11.i109, align 8
  %arrayidx13.i110 = getelementptr inbounds %class.btPersistentManifold, ptr %this, i64 0, i32 2, i64 2, i32 0, i32 0, i64 2
  %21 = load float, ptr %arrayidx13.i110, align 8
  %sub14.i111 = fsub float %20, %21
  %22 = fneg float %sub14.i
  %23 = extractelement <2 x float> %19, i64 1
  %neg.i = fmul float %23, %22
  %24 = tail call float @llvm.fmuladd.f32(float %sub8.i, float %sub14.i111, float %neg.i)
  %25 = fneg float %sub.i
  %neg19.i = fmul float %sub14.i111, %25
...
if.then9.if.then48_crit_edge:                     ; preds = %if.then9
  ...
  %.pre256 = load float, ptr %arrayidx13.i168.phi.trans.insert, align 8
  %36 = load <2 x float>, ptr %m_pointCache50.phi.trans.insert, align 8
  %37 = insertelement <2 x float> poison, float %.pre, i64 0
  %38 = insertelement <2 x float> %37, float %13, i64 1
  %39 = fsub <2 x float> %38, %36
  %.pre270 = fsub float %15, %.pre256
  %.pre271 = fneg float %.pre270
  %40 = extractelement <2 x float> %39, i64 0
  %.pre273 = fneg float %40
  %41 = extractelement <2 x float> %39, i64 1
  %.pre275 = fneg float %41
  br label %if.then48
...
if.then27:                                        ; preds = %entry.if.then27_crit_edge, %if.then9
  ...
  %42 = phi float [ %.pre253, %entry.if.then27_crit_edge ], [ %21, %if.then9 ]
  %43 = phi float [ %.pre252, %entry.if.then27_crit_edge ], [ %20, %if.then9 ]
  %44 = phi float [ %11, %entry.if.then27_crit_edge ], [ %35, %if.then9 ]
  %45 = phi float [ %9, %entry.if.then27_crit_edge ], [ %33, %if.then9 ]
  %46 = phi float [ %10, %entry.if.then27_crit_edge ], [ %34, %if.then9 ]
  %47 = phi float [ %8, %entry.if.then27_crit_edge ], [ %32, %if.then9 ]
  %48 = phi float [ %.pre247, %entry.if.then27_crit_edge ], [ %15, %if.then9 ]
  %49 = phi float [ %.pre246, %entry.if.then27_crit_edge ], [ %13, %if.then9 ]
  %res0.0 = phi float [ 0.000000e+00, %entry.if.then27_crit_edge ], [ %31, %if.then9 ]
  %50 = phi <2 x float> [ %7, %entry.if.then27_crit_edge ], [ %19, %if.then9 ]
  %m_pointCache29 = getelementptr inbounds %class.btPersistentManifold, ptr %this, i64 0, i32 2
  %51 = load <2 x float>, ptr %m_pointCache29, align 8
  %52 = insertelement <2 x float> poison, float %.pre, i64 0
  ...
  %55 = load float, ptr %arrayidx13.i129, align 8
  %sub14.i130 = fsub float %48, %55
  %56 = fneg float %sub14.i130
  %57 = extractelement <2 x float> %50, i64 1
  %neg.i152 = fmul float %57, %56
  %58 = extractelement <2 x float> %54, i64 1
  %59 = tail call float @llvm.fmuladd.f32(float %58, float %sub14.i142.pre-phi, float %neg.i152)
  %60 = extractelement <2 x float> %54, i64 0
  %61 = fneg float %60
  %neg19.i153 = fmul float %sub14.i142.pre-phi, %61
  %62 = extractelement <2 x float> %50, i64 0
  %63 = tail call float @llvm.fmuladd.f32(float %sub14.i130, float %62, float %neg19.i153)
  %64 = fneg float %58
  %neg30.i154 = fmul float %62, %64
  %65 = tail call float @llvm.fmuladd.f32(float %60, float %57, float %neg30.i154)
  %mul8.i.i161 = fmul float %63, %63
  %66 = tail call float @llvm.fmuladd.f32(float %59, float %59, float %mul8.i.i161)
  %67 = tail call float @llvm.fmuladd.f32(float %65, float %65, float %66)
  ...
  %.pre260 = load float, ptr %arrayidx80.phi.trans.insert, align 8
  ...
  %.pre261 = load float, ptr %arrayidx7.i216.phi.trans.insert, align 4
  ...
  %.pre262 = load float, ptr %arrayidx13.i219.phi.trans.insert, align 8
  br i1 %cond102, label %if.then69, label %if.then48

if.then48:                                        ; preds = %if.then27, %if.then9.if.then48_crit_edge
  %.pre-phi276 = phi float [ %.pre275, %if.then9.if.then48_crit_edge ], [ %64, %if.then27 ]
  %.pre-phi274 = phi float [ %.pre273, %if.then9.if.then48_crit_edge ], [ %61, %if.then27 ]
  %.pre-phi272 = phi float [ %.pre271, %if.then9.if.then48_crit_edge ], [ %56, %if.then27 ]
  %sub14.i169.pre-phi = phi float [ %.pre270, %if.then9.if.then48_crit_edge ], [ %sub14.i130, %if.then27 ]
  %68 = phi float [ %21, %if.then9.if.then48_crit_edge ], [ %42, %if.then27 ]
  %69 = phi float [ %35, %if.then9.if.then48_crit_edge ], [ %44, %if.then27 ]
  %70 = phi float [ %34, %if.then9.if.then48_crit_edge ], [ %46, %if.then27 ]
  %71 = phi float [ %16, %if.then9.if.then48_crit_edge ], [ %.pre262, %if.then27 ]
  %72 = phi float [ %20, %if.then9.if.then48_crit_edge ], [ %43, %if.then27 ]
  %73 = phi float [ %14, %if.then9.if.then48_crit_edge ], [ %.pre261, %if.then27 ]
  %74 = phi float [ %33, %if.then9.if.then48_crit_edge ], [ %45, %if.then27 ]
  %75 = phi float [ %12, %if.then9.if.then48_crit_edge ], [ %.pre260, %if.then27 ]
  %76 = phi float [ %32, %if.then9.if.then48_crit_edge ], [ %47, %if.then27 ]
  %res1.0 = phi float [ 0.000000e+00, %if.then9.if.then48_crit_edge ], [ %67, %if.then27 ]
  %res0.1 = phi float [ %31, %if.then9.if.then48_crit_edge ], [ %res0.0, %if.then27 ]
  %77 = phi <2 x float> [ %39, %if.then9.if.then48_crit_edge ], [ %54, %if.then27 ]
  %sub.i175 = fsub float %76, %75
  %sub8.i178 = fsub float %74, %73
  %sub14.i181 = fsub float %72, %71
  %neg.i191 = fmul float %sub8.i178, %.pre-phi272
  %78 = extractelement <2 x float> %77, i64 1
  %79 = tail call float @llvm.fmuladd.f32(float %78, float %sub14.i181, float %neg.i191)
  %neg19.i192 = fmul float %sub14.i181, %.pre-phi274
  %80 = tail call float @llvm.fmuladd.f32(float %sub14.i169.pre-phi, float %sub.i175, float %neg19.i192)
  %neg30.i193 = fmul float %sub.i175, %.pre-phi276
  %81 = extractelement <2 x float> %77, i64 0
  %82 = tail call float @llvm.fmuladd.f32(float %81, float %sub8.i178, float %neg30.i193)
  %mul8.i.i200 = fmul float %80, %80
  %83 = tail call float @llvm.fmuladd.f32(float %79, float %79, float %mul8.i.i200)
...
if.then69:                                        ; preds = %if.then27, %if.then48
  %.pre-phi267 = phi float [ %.pre-phi276, %if.then48 ], [ %64, %if.then27 ]
  %.pre-phi266 = phi float [ %.pre-phi274, %if.then48 ], [ %61, %if.then27 ]
  %.pre-phi = phi float [ %.pre-phi272, %if.then48 ], [ %56, %if.then27 ]
  %sub14.i208.pre-phi = phi float [ %sub14.i169.pre-phi, %if.then48 ], [ %sub14.i130, %if.then27 ]
  %sub8.i205.pre-phi = phi float [ %78, %if.then48 ], [ %58, %if.then27 ]
  %sub.i202.pre-phi = phi float [ %81, %if.then48 ], [ %60, %if.then27 ]
  %85 = phi float [ %71, %if.then48 ], [ %.pre262, %if.then27 ]
  %86 = phi float [ %68, %if.then48 ], [ %42, %if.then27 ]
  %87 = phi float [ %73, %if.then48 ], [ %.pre261, %if.then27 ]
  %88 = phi float [ %69, %if.then48 ], [ %44, %if.then27 ]
  %89 = phi float [ %75, %if.then48 ], [ %.pre260, %if.then27 ]
  %90 = phi float [ %70, %if.then48 ], [ %46, %if.then27 ]
  %res2.0 = phi float [ %84, %if.then48 ], [ 0.000000e+00, %if.then27 ]
  %res1.1 = phi float [ %res1.0, %if.then48 ], [ %67, %if.then27 ]
  %res0.2 = phi float [ %res0.1, %if.then48 ], [ %res0.0, %if.then27 ]
  %sub.i214 = fsub float %90, %89
  %sub8.i217 = fsub float %88, %87
  %sub14.i220 = fsub float %86, %85
  %neg.i230 = fmul float %sub8.i217, %.pre-phi
  %91 = tail call float @llvm.fmuladd.f32(float %sub8.i205.pre-phi, float %sub14.i220, float %neg.i230)
  %neg19.i231 = fmul float %sub14.i220, %.pre-phi266
  %92 = tail call float @llvm.fmuladd.f32(float %sub14.i208.pre-phi, float %sub.i214, float %neg19.i231)
  %neg30.i232 = fmul float %sub.i214, %.pre-phi267
  %93 = tail call float @llvm.fmuladd.f32(float %sub.i202.pre-phi, float %sub8.i217, float %neg30.i232)
  %mul8.i.i239 = fmul float %92, %92
  %94 = tail call float @llvm.fmuladd.f32(float %91, float %91, float %mul8.i.i239)
  %95 = tail call float @llvm.fmuladd.f32(float %93, float %93, float %94)
  br label %if.end88

if.end88:                                         ; preds = %if.then69, %if.then48
  %res3.0 = phi float [ %95, %if.then69 ], [ 0.000000e+00, %if.then48 ]
  %res2.1 = phi float [ %res2.0, %if.then69 ], [ %84, %if.then48 ]
  %res1.2 = phi float [ %res1.1, %if.then69 ], [ %res1.0, %if.then48 ]
  %res0.3 = phi float [ %res0.2, %if.then69 ], [ %res0.1, %if.then48 ]
  %96 = tail call float @llvm.fabs.f32(float %res0.3)
  %97 = tail call float @llvm.fabs.f32(float %res1.2)
  %98 = tail call float @llvm.fabs.f32(float %res2.1)
  %99 = tail call float @llvm.fabs.f32(float %res3.0)
  %cmp.i.i = fcmp ule float %96, 0xC3ABC16D60000000
  %maxIndex.0.i.i = sext i1 %cmp.i.i to i32
  %maxVal.0.i.i = select i1 %cmp.i.i, float 0xC3ABC16D60000000, float %96
  %cmp6.i.i = fcmp ogt float %97, %maxVal.0.i.i
  %maxIndex.1.i.i = select i1 %cmp6.i.i, i32 1, i32 %maxIndex.0.i.i
  %maxVal.1.i.i = select i1 %cmp6.i.i, float %97, float %maxVal.0.i.i
  %cmp13.i.i = fcmp ogt float %98, %maxVal.1.i.i
  %maxIndex.2.i.i = select i1 %cmp13.i.i, i32 2, i32 %maxIndex.1.i.i
  %maxVal.2.i.i = select i1 %cmp13.i.i, float %98, float %maxVal.1.i.i
  %cmp20.i.i = fcmp ogt float %99, %maxVal.2.i.i
...
if.end:                                           ; preds = %if.then5.i, %if.then.i, %if.then, %if.else
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(172) %arrayidx8, ptr noundef nonnull align 8 dereferenceable(172) %newPoint, i64 172, i1 false)
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %3 = load <4 x float>, ptr %trA, align 4
  ...
  %14 = load float, ptr %arrayidx10.i23.i, align 4
  ...
  %27 = load <2 x float>, ptr %m_origin.i, align 4
  %28 = fadd <2 x float> %26, %27
  %29 = load float, ptr %arrayidx.i26.i, align 4
  %30 = load float, ptr %arrayidx5.i27.i, align 4
  %mul8.i29.i = fmul float %8, %30
  %31 = tail call float @llvm.fmuladd.f32(float %29, float %5, float %mul8.i29.i)
  %32 = load float, ptr %arrayidx10.i30.i, align 4
  %33 = tail call float @llvm.fmuladd.f32(float %32, float %11, float %31)
  %34 = load float, ptr %arrayidx.i32.i, align 4
  ...
  %40 = load float, ptr %arrayidx7.i.i69, align 4
  %41 = load <4 x float>, ptr %arrayidx10.i.i71, align 4
  ...
  %43 = load float, ptr %arrayidx12.i.i72, align 8
  %44 = load float, ptr %arrayidx.i.i75, align 4
  %45 = load float, ptr %arrayidx5.i20.i76, align 4
  %46 = load float, ptr %arrayidx10.i23.i78, align 4
  %47 = insertelement <2 x float> poison, float %40, i64 0
  %48 = shufflevector <2 x float> %47, <2 x float> poison, <2 x i32> zeroinitializer
  %49 = insertelement <2 x float> %39, float %45, i64 1
  %50 = fmul <2 x float> %48, %49
  %51 = insertelement <2 x float> %36, float %44, i64 1
  ...
  %55 = insertelement <2 x float> %42, float %46, i64 1
  ...
  %59 = load <2 x float>, ptr %m_origin.i73, align 4
  %60 = fadd <2 x float> %58, %59
  %61 = load float, ptr %arrayidx.i26.i81, align 4
  %62 = load float, ptr %arrayidx5.i27.i82, align 4
  %mul8.i29.i83 = fmul float %40, %62
  %63 = tail call float @llvm.fmuladd.f32(float %61, float %37, float %mul8.i29.i83)
  %64 = load float, ptr %arrayidx10.i30.i84, align 4
  %65 = tail call float @llvm.fmuladd.f32(float %64, float %43, float %63)
  %66 = load float, ptr %arrayidx.i32.i85, align 4
  ...
  store <2 x float> %60, ptr %m_positionWorldOnB, align 8
  %ref.tmp3.sroa.4.0.m_positionWorldOnB.sroa_idx = getelementptr inbounds i8, ptr %m_positionWorldOnB, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i89, ptr %ref.tmp3.sroa.4.0.m_positionWorldOnB.sroa_idx, align 8
  ...
  %70 = load float, ptr %arrayidx7.i98, align 4
...
if.then.i:                                        ; preds = %_ZN20btPersistentManifold14clearUserCacheER15btManifoldPoint.exit.i
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(172) %arrayidx20, ptr noundef nonnull align 8 dereferenceable(172) %arrayidx4.i, i64 172, i1 false)
...
_ZN20btPersistentManifold18removeContactPointEi.exit: ; preds = %_ZN20btPersistentManifold14clearUserCacheER15btManifoldPoint.exit.i, %if.then.i
  ...
  store i32 %dec.pre-phi.i, ptr %m_cachedPoints.i, align 8
  br label %if.end44
...
if.then39:                                        ; preds = %if.else
  ...
  %92 = load ptr, ptr %m_userPersistentData.i.i140, align 8
  %tobool.not.i.i141 = icmp eq ptr %92, null
  br i1 %tobool.not.i.i141, label %_ZN20btPersistentManifold14clearUserCacheER15btManifoldPoint.exit.i146, label %if.then.i.i142

if.then.i.i142:                                   ; preds = %if.then39
  %93 = load ptr, ptr @gContactDestroyedCallback, align 8
  %tobool4.not.i.i143 = icmp eq ptr %93, null
  br i1 %tobool4.not.i.i143, label %_ZN20btPersistentManifold14clearUserCacheER15btManifoldPoint.exit.i146, label %if.then5.i.i144

if.then5.i.i144:                                  ; preds = %if.then.i.i142
  %call.i.i145 = tail call noundef zeroext i1 %93(ptr noundef nonnull %92)
  store ptr null, ptr %m_userPersistentData.i.i140, align 8
  br label %_ZN20btPersistentManifold14clearUserCacheER15btManifoldPoint.exit.i146

_ZN20btPersistentManifold14clearUserCacheER15btManifoldPoint.exit.i146: ; preds = %if.then5.i.i144, %if.then.i.i142, %if.then39
  %94 = load i32, ptr %m_cachedPoints.i, align 8
  %sub.i148 = add nsw i32 %94, -1
  %95 = zext i32 %94 to i64
  %cmp.not.i149 = icmp eq i64 %indvars.iv176, %95
  br i1 %cmp.not.i149, label %_ZN20btPersistentManifold18removeContactPointEi.exit162, label %if.then.i150

if.then.i150:                                     ; preds = %_ZN20btPersistentManifold14clearUserCacheER15btManifoldPoint.exit.i146
  %idxprom3.i151 = sext i32 %sub.i148 to i64
  %arrayidx4.i152 = getelementptr inbounds %class.btPersistentManifold, ptr %this, i64 0, i32 2, i64 %idxprom3.i151
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(172) %arrayidx20, ptr noundef nonnull align 8 dereferenceable(172) %arrayidx4.i152, i64 172, i1 false)
  %m_userPersistentData.i153 = getelementptr inbounds %class.btPersistentManifold, ptr %this, i64 0, i32 2, i64 %idxprom3.i151, i32 13
  store ptr null, ptr %m_userPersistentData.i153, align 8
  %m_appliedImpulse.i154 = getelementptr inbounds %class.btPersistentManifold, ptr %this, i64 0, i32 2, i64 %idxprom3.i151, i32 14
  store float 0.000000e+00, ptr %m_appliedImpulse.i154, align 8
  %m_lateralFrictionInitialized.i155 = getelementptr inbounds %class.btPersistentManifold, ptr %this, i64 0, i32 2, i64 %idxprom3.i151, i32 15
  store i8 0, ptr %m_lateralFrictionInitialized.i155, align 4
  %m_appliedImpulseLateral1.i156 = getelementptr inbounds %class.btPersistentManifold, ptr %this, i64 0, i32 2, i64 %idxprom3.i151, i32 17
  store <2 x float> zeroinitializer, ptr %m_appliedImpulseLateral1.i156, align 8
  %m_lifeTime.i158 = getelementptr inbounds %class.btPersistentManifold, ptr %this, i64 0, i32 2, i64 %idxprom3.i151, i32 19
  store i32 0, ptr %m_lifeTime.i158, align 8
  %.pre.i159 = load i32, ptr %m_cachedPoints.i, align 8
  %.pre35.i160 = add nsw i32 %.pre.i159, -1
  br label %_ZN20btPersistentManifold18removeContactPointEi.exit162

_ZN20btPersistentManifold18removeContactPointEi.exit162: ; preds = %_ZN20btPersistentManifold14clearUserCacheER15btManifoldPoint.exit.i146, %if.then.i150
  %dec.pre-phi.i161 = phi i32 [ %.pre35.i160, %if.then.i150 ], [ %sub.i148, %_ZN20btPersistentManifold14clearUserCacheER15btManifoldPoint.exit.i146 ]
  store i32 %dec.pre-phi.i161, ptr %m_cachedPoints.i, align 8
  br label %if.end44

if.else40:                                        ; preds = %if.else
  %96 = load ptr, ptr @gContactProcessedCallback, align 8
  %tobool.not = icmp eq ptr %96, null
  br i1 %tobool.not, label %if.end44, label %if.then41

if.then41:                                        ; preds = %if.else40
  %97 = load ptr, ptr %m_body0, align 8
  %98 = load ptr, ptr %m_body1, align 8
...
attributes #2 = { mustprogress nofree nosync nounwind willreturn memory(argmem: read) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #3 = { nofree nosync nounwind memory(argmem: read) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
