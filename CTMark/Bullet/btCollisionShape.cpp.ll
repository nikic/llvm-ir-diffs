; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btCollisionShape.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btCollisionShape.cpp"
...
entry:
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i22, ptr %ref.tmp3.sroa.4.0..sroa_idx, align 4
...
entry:
  ...
  %1 = load float, ptr @gContactThresholdFactor, align 4
...
entry:
  ...
  store float %temporalAabbMinz.0, ptr %arrayidx.i50, align 4
  ...
  store float %temporalAabbMaxz.0, ptr %arrayidx.i48, align 4
  %ref.tmp35.sroa.6.0.temporalAabbMax.sroa_idx = getelementptr inbounds i8, ptr %temporalAabbMax, i64 12
  store float 0.000000e+00, ptr %ref.tmp35.sroa.6.0.temporalAabbMax.sroa_idx, align 4
