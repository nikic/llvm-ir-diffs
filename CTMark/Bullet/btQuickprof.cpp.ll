; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btQuickprof.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btQuickprof.cpp"
...
tailrecurse:                                      ; preds = %if.end, %entry
  ...
  store i32 0, ptr %TotalCalls, align 8
  %TotalTime = getelementptr inbounds %class.CProfileNode, ptr %this.tr, i64 0, i32 2
  store float 0.000000e+00, ptr %TotalTime, align 4
...
; Function Attrs: uwtable
define dso_local noundef nonnull ptr @_ZN12CProfileNode12Get_Sub_NodeEPKc(ptr noundef nonnull align 8 dereferenceable(56) %this, ptr noundef %name) local_unnamed_addr #2 align 2 personality ptr @__gxx_personality_v0 {
entry:
  %Child = getelementptr inbounds %class.CProfileNode, ptr %this, i64 0, i32 6
  %child.013 = load ptr, ptr %Child, align 8
...
invoke.cont:                                      ; preds = %if.end, %entry
  ...
  store ptr %1, ptr %Sibling3, align 8
...
entry:
  ...
  %TotalCalls = getelementptr inbounds %class.CProfileNode, ptr %this, i64 0, i32 1
  %0 = load i32, ptr %TotalCalls, align 8
  %inc = add nsw i32 %0, 1
  store i32 %inc, ptr %TotalCalls, align 8
  %RecursionCounter = getelementptr inbounds %class.CProfileNode, ptr %this, i64 0, i32 4
  %1 = load i32, ptr %RecursionCounter, align 8
  %inc2 = add nsw i32 %1, 1
  store i32 %inc2, ptr %RecursionCounter, align 8
  %cmp = icmp eq i32 %1, 0
...
if.then:                                          ; preds = %entry
  ...
  %2 = load i64, ptr %currentTime.i.i, align 8
  %3 = load i64, ptr @_ZL13gProfileClock, align 8
  ...
  %5 = load i64, ptr getelementptr inbounds (%class.btClock, ptr @_ZL13gProfileClock, i64 0, i32 0, i32 1), align 8
  ...
  store i64 %add.i.i, ptr %StartTime, align 8
  br label %if.end
...
entry:
  %currentTime.i.i = alloca %struct.timeval, align 8
  %RecursionCounter = getelementptr inbounds %class.CProfileNode, ptr %this, i64 0, i32 4
  %0 = load i32, ptr %RecursionCounter, align 8
  %dec = add nsw i32 %0, -1
  store i32 %dec, ptr %RecursionCounter, align 8
...
if.then:                                          ; preds = %entry
  ...
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %currentTime.i.i) #16
  %StartTime = getelementptr inbounds %class.CProfileNode, ptr %this, i64 0, i32 3
  %6 = load i64, ptr %StartTime, align 8
  ...
  %8 = load float, ptr %TotalTime, align 4
  %add = fadd float %8, %div
  store float %add, ptr %TotalTime, align 4
  %.pre = load i32, ptr %RecursionCounter, align 8
  br label %if.end
...
entry:
  ...
  store ptr %0, ptr %CurrentChild, align 8
  ret void
}
...
entry:
  ...
  %CurrentChild = getelementptr inbounds %class.CProfileIterator, ptr %this, i64 0, i32 1
  store ptr %1, ptr %CurrentChild, align 8
  ret void
}
...
entry:
  ...
  %Child.i = getelementptr inbounds %class.CProfileNode, ptr %0, i64 0, i32 6
  %CurrentChild = getelementptr inbounds %class.CProfileIterator, ptr %this, i64 0, i32 1
  %storemerge16 = load ptr, ptr %Child.i, align 8
  store ptr %storemerge16, ptr %CurrentChild, align 8
...
while.body:                                       ; preds = %entry, %while.body
  ...
  %storemerge = load ptr, ptr %Sibling.i, align 8
  store ptr %storemerge, ptr %CurrentChild, align 8
...
if.then:                                          ; preds = %while.end
  store ptr %storemerge.lcssa, ptr %this, align 8
  %Child.i15 = getelementptr inbounds %class.CProfileNode, ptr %storemerge.lcssa, i64 0, i32 6
  %3 = load ptr, ptr %Child.i15, align 8
  store ptr %3, ptr %CurrentChild, align 8
  br label %if.end
...
entry:
  ...
  %0 = load ptr, ptr @_ZN15CProfileManager11CurrentNodeE, align 8
...
if.then:                                          ; preds = %entry
  %Child.i = getelementptr inbounds %class.CProfileNode, ptr %0, i64 0, i32 6
  %child.013.i = load ptr, ptr %Child.i, align 8
...
while.body.i:                                     ; preds = %if.then, %if.end.i
  ...
  %2 = load ptr, ptr %child.015.i, align 8
...
invoke.cont.i:                                    ; preds = %if.end.i, %if.then
  ...
  store ptr %3, ptr %Sibling3.i, align 8
...
_ZN12CProfileNode12Get_Sub_NodeEPKc.exit:         ; preds = %while.body.i, %invoke.cont.i
  ...
  store ptr %retval.0.i, ptr @_ZN15CProfileManager11CurrentNodeE, align 8
  br label %if.end

if.end:                                           ; preds = %_ZN12CProfileNode12Get_Sub_NodeEPKc.exit, %entry
  %4 = phi ptr [ %retval.0.i, %_ZN12CProfileNode12Get_Sub_NodeEPKc.exit ], [ %0, %entry ]
  %TotalCalls.i = getelementptr inbounds %class.CProfileNode, ptr %4, i64 0, i32 1
  %5 = load i32, ptr %TotalCalls.i, align 8
  %inc.i = add nsw i32 %5, 1
  store i32 %inc.i, ptr %TotalCalls.i, align 8
  %RecursionCounter.i = getelementptr inbounds %class.CProfileNode, ptr %4, i64 0, i32 4
  %6 = load i32, ptr %RecursionCounter.i, align 8
  %inc2.i = add nsw i32 %6, 1
  store i32 %inc2.i, ptr %RecursionCounter.i, align 8
  %cmp.i3 = icmp eq i32 %6, 0
  br i1 %cmp.i3, label %if.then.i, label %_ZN12CProfileNode4CallEv.exit

if.then.i:                                        ; preds = %if.end
  %StartTime.i = getelementptr inbounds %class.CProfileNode, ptr %4, i64 0, i32 3
  ...
  %7 = load i64, ptr %currentTime.i.i.i, align 8
  %8 = load i64, ptr @_ZL13gProfileClock, align 8
  %sub.i.i.i = sub nsw i64 %7, %8
  ...
  %10 = load i64, ptr getelementptr inbounds (%class.btClock, ptr @_ZL13gProfileClock, i64 0, i32 0, i32 1), align 8
  %sub5.i.i.i = sub i64 %9, %10
  %add.i.i.i = add nsw i64 %sub5.i.i.i, %mul.i.i.i
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %currentTime.i.i.i) #16
  store i64 %add.i.i.i, ptr %StartTime.i, align 8
...
entry:
  ...
  %1 = load i32, ptr %RecursionCounter.i, align 8
  %dec.i = add nsw i32 %1, -1
  store i32 %dec.i, ptr %RecursionCounter.i, align 8
...
if.then.i:                                        ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %currentTime.i.i.i) #16
  %call.i.i.i = call i32 @gettimeofday(ptr noundef nonnull %currentTime.i.i.i, ptr noundef null) #16
  %3 = load i64, ptr %currentTime.i.i.i, align 8
  %4 = load i64, ptr @_ZL13gProfileClock, align 8
  %sub.i.i.i = sub nsw i64 %3, %4
  %mul.i.i.i = mul nsw i64 %sub.i.i.i, 1000000
  %tv_usec.i.i.i = getelementptr inbounds %struct.timeval, ptr %currentTime.i.i.i, i64 0, i32 1
  %5 = load i64, ptr %tv_usec.i.i.i, align 8
  %6 = load i64, ptr getelementptr inbounds (%class.btClock, ptr @_ZL13gProfileClock, i64 0, i32 0, i32 1), align 8
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %currentTime.i.i.i) #16
  %StartTime.i = getelementptr inbounds %class.CProfileNode, ptr %0, i64 0, i32 3
  %7 = load i64, ptr %StartTime.i, align 8
  ...
  %9 = load float, ptr %TotalTime.i, align 4
  %add.i = fadd float %9, %div.i
  store float %add.i, ptr %TotalTime.i, align 4
  %.pre.i = load i32, ptr %RecursionCounter.i, align 8
...
if.then:                                          ; preds = %_ZN12CProfileNode6ReturnEv.exit
  %11 = load ptr, ptr @_ZN15CProfileManager11CurrentNodeE, align 8
  %Parent.i = getelementptr inbounds %class.CProfileNode, ptr %11, i64 0, i32 5
  %12 = load ptr, ptr %Parent.i, align 8
  store ptr %12, ptr @_ZN15CProfileManager11CurrentNodeE, align 8
  br label %if.end
...
entry:
  ...
  %0 = load i32, ptr getelementptr inbounds (%class.CProfileNode, ptr @_ZN15CProfileManager4RootE, i64 0, i32 1), align 8
  %inc.i = add nsw i32 %0, 1
  store i32 %inc.i, ptr getelementptr inbounds (%class.CProfileNode, ptr @_ZN15CProfileManager4RootE, i64 0, i32 1), align 8
  %1 = load i32, ptr getelementptr inbounds (%class.CProfileNode, ptr @_ZN15CProfileManager4RootE, i64 0, i32 4), align 8
  %inc2.i = add nsw i32 %1, 1
  store i32 %inc2.i, ptr getelementptr inbounds (%class.CProfileNode, ptr @_ZN15CProfileManager4RootE, i64 0, i32 4), align 8
...
if.then.i:                                        ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %currentTime.i.i.i) #16
  %call.i.i.i = call i32 @gettimeofday(ptr noundef nonnull %currentTime.i.i.i, ptr noundef null) #16
  %2 = load i64, ptr %currentTime.i.i.i, align 8
  %3 = load i64, ptr @_ZL13gProfileClock, align 8
  %sub.i.i.i = sub nsw i64 %2, %3
  %mul.i.i.i = mul nsw i64 %sub.i.i.i, 1000000
  %tv_usec.i.i.i = getelementptr inbounds %struct.timeval, ptr %currentTime.i.i.i, i64 0, i32 1
  %4 = load i64, ptr %tv_usec.i.i.i, align 8
  %5 = load i64, ptr getelementptr inbounds (%class.btClock, ptr @_ZL13gProfileClock, i64 0, i32 0, i32 1), align 8
  %sub5.i.i.i = sub i64 %4, %5
  %add.i.i.i = add nsw i64 %sub5.i.i.i, %mul.i.i.i
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %currentTime.i.i.i) #16
  store i64 %add.i.i.i, ptr getelementptr inbounds (%class.CProfileNode, ptr @_ZN15CProfileManager4RootE, i64 0, i32 3), align 8
  br label %_ZN12CProfileNode4CallEv.exit

_ZN12CProfileNode4CallEv.exit:                    ; preds = %entry, %if.then.i
  store i32 0, ptr @_ZN15CProfileManager12FrameCounterE, align 4
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %currentTime.i.i) #16
  %call.i.i = call i32 @gettimeofday(ptr noundef nonnull %currentTime.i.i, ptr noundef null) #16
  %6 = load i64, ptr %currentTime.i.i, align 8
  %7 = load i64, ptr @_ZL13gProfileClock, align 8
  %sub.i.i = sub nsw i64 %6, %7
  %mul.i.i = mul nsw i64 %sub.i.i, 1000000
  %tv_usec.i.i = getelementptr inbounds %struct.timeval, ptr %currentTime.i.i, i64 0, i32 1
  %8 = load i64, ptr %tv_usec.i.i, align 8
  %9 = load i64, ptr getelementptr inbounds (%class.btClock, ptr @_ZL13gProfileClock, i64 0, i32 0, i32 1), align 8
  %sub5.i.i = sub i64 %8, %9
  %add.i.i = add nsw i64 %sub5.i.i, %mul.i.i
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %currentTime.i.i) #16
  store i64 %add.i.i, ptr @_ZN15CProfileManager9ResetTimeE, align 8
  ret void
}
...
entry:
  %0 = load i32, ptr @_ZN15CProfileManager12FrameCounterE, align 4
  %inc = add nsw i32 %0, 1
  store i32 %inc, ptr @_ZN15CProfileManager12FrameCounterE, align 4
  ret void
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %currentTime.i.i) #16
  %call.i.i = call i32 @gettimeofday(ptr noundef nonnull %currentTime.i.i, ptr noundef null) #16
  %0 = load i64, ptr %currentTime.i.i, align 8
  %1 = load i64, ptr @_ZL13gProfileClock, align 8
  %sub.i.i = sub nsw i64 %0, %1
  %mul.i.i = mul nsw i64 %sub.i.i, 1000000
  %tv_usec.i.i = getelementptr inbounds %struct.timeval, ptr %currentTime.i.i, i64 0, i32 1
  %2 = load i64, ptr %tv_usec.i.i, align 8
  %3 = load i64, ptr getelementptr inbounds (%class.btClock, ptr @_ZL13gProfileClock, i64 0, i32 0, i32 1), align 8
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %currentTime.i.i) #16
  %4 = load i64, ptr @_ZN15CProfileManager9ResetTimeE, align 8
...
entry:
  %currentTime.i.i.i = alloca %struct.timeval, align 8
  %0 = load ptr, ptr %profileIterator, align 8
  ...
  store ptr %1, ptr %CurrentChild.i, align 8
...
cond.true:                                        ; preds = %if.end
  ...
  %6 = load i64, ptr getelementptr inbounds (%class.btClock, ptr @_ZL13gProfileClock, i64 0, i32 0, i32 1), align 8
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %currentTime.i.i.i) #16
  %7 = load i64, ptr @_ZN15CProfileManager9ResetTimeE, align 8
...
cond.false:                                       ; preds = %if.end
  ...
  %9 = load float, ptr %TotalTime.i.i, align 4
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi float [ %div.i, %cond.true ], [ %9, %cond.false ]
  %10 = load i32, ptr @_ZN15CProfileManager12FrameCounterE, align 4
  %cmp138 = icmp sgt i32 %spacing, 0
  br i1 %cmp138, label %for.body, label %for.end.thread

for.end.thread:                                   ; preds = %cond.end
  %puts159 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str)
  br label %for.end13
...
for.end13:                                        ; preds = %for.body9, %for.end.thread, %for.end
  %11 = load ptr, ptr %profileIterator, align 8
  ...
  %.pr = load ptr, ptr %CurrentChild.i, align 8
...
for.body18.lr.ph:                                 ; preds = %for.end13
  ...
  br i1 %cmp138, label %for.body18.us, label %for.body18

for.body18.us:                                    ; preds = %for.body18.lr.ph, %for.cond27.for.end33_crit_edge.us
  ...
  %14 = load float, ptr %TotalTime.i.i124.us, align 4
...
for.cond27.for.end33_crit_edge.us:                ; preds = %for.body29.us
  %inc43.us = add nuw i32 %i.2146.us, 1
  %add.us = fadd float %accumulated_time.0147.us, %14
  %cond25.us = select i1 %cmp21, float %mul.us, float 0.000000e+00
  %15 = load ptr, ptr %CurrentChild.i, align 8
  %16 = load ptr, ptr %15, align 8
  %conv35.us = fpext float %cond25.us to double
  ...
  %17 = load i32, ptr %TotalCalls.i.i.us, align 8
  ...
  %18 = load ptr, ptr %CurrentChild.i, align 8
  %Sibling.i.i.us = getelementptr inbounds %class.CProfileNode, ptr %18, i64 0, i32 7
  %19 = load ptr, ptr %Sibling.i.i.us, align 8
  store ptr %19, ptr %CurrentChild.i, align 8
...
for.body18:                                       ; preds = %for.body18.lr.ph, %for.body18
  ...
  %21 = load float, ptr %TotalTime.i.i124, align 4
  %add = fadd float %accumulated_time.0147, %21
  %div = fdiv float %21, %cond
  %mul = fmul float %div, 1.000000e+02
  %cond25 = select i1 %cmp21, float %mul, float 0.000000e+00
  %22 = load ptr, ptr %20, align 8
  %conv35 = fpext float %cond25 to double
  %conv36 = fpext float %21 to double
  %div38 = fdiv double %conv36, %conv37
  %TotalCalls.i.i = getelementptr inbounds %class.CProfileNode, ptr %20, i64 0, i32 1
  %23 = load i32, ptr %TotalCalls.i.i, align 8
  %call40 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, i32 noundef %i.2146, ptr noundef %22, double noundef %conv35, double noundef %div38, i32 noundef %23)
  %24 = load ptr, ptr %CurrentChild.i, align 8
  %Sibling.i.i = getelementptr inbounds %class.CProfileNode, ptr %24, i64 0, i32 7
  %25 = load ptr, ptr %Sibling.i.i, align 8
  store ptr %25, ptr %CurrentChild.i, align 8
...
for.end44:                                        ; preds = %for.body18, %for.cond27.for.end33_crit_edge.us, %for.end13
  ...
  %accumulated_time.0.lcssa = phi float [ 0.000000e+00, %for.end13 ], [ %add.us, %for.cond27.for.end33_crit_edge.us ], [ %add, %for.body18 ]
  %cmp45 = fcmp olt float %cond, %accumulated_time.0.lcssa
...
for.body51:                                       ; preds = %if.end48, %for.body51
  ...
  %exitcond157.not = icmp eq i32 %inc54, %spacing
  br i1 %exitcond157.not, label %for.end55, label %for.body51

for.end55:                                        ; preds = %for.body51, %if.end48
  %cmp56 = fcmp ogt float %cond, 0x3E80000000000000
  %sub = fsub float %cond, %accumulated_time.0.lcssa
  %div58 = fdiv float %sub, %cond
  %mul59 = fmul float %div58, 1.000000e+02
  %26 = fpext float %mul59 to double
  %cond62 = select i1 %cmp56, double %26, double 0.000000e+00
...
for.body69.lr.ph:                                 ; preds = %for.end55
  ...
  %.pre = load ptr, ptr %profileIterator, align 8
  br label %for.body69
...
for.body69:                                       ; preds = %for.body69.lr.ph, %_ZN16CProfileIterator12Enter_ParentEv.exit
  ...
  %storemerge16.i = load ptr, ptr %Child.i.i128, align 8
  store ptr %storemerge16.i, ptr %CurrentChild.i, align 8
  %cmp17.i = icmp ne ptr %storemerge16.i, null
  %cmp318.i = icmp ne i32 %i.4153, 0
  %28 = and i1 %cmp318.i, %cmp17.i
...
while.body.i:                                     ; preds = %for.body69, %while.body.i
  ...
  %storemerge.i = load ptr, ptr %Sibling.i.i130, align 8
  store ptr %storemerge.i, ptr %CurrentChild.i, align 8
...
if.then.i:                                        ; preds = %while.end.i
  store ptr %storemerge.lcssa.i, ptr %profileIterator, align 8
  %Child.i15.i = getelementptr inbounds %class.CProfileNode, ptr %storemerge.lcssa.i, i64 0, i32 6
  %30 = load ptr, ptr %Child.i15.i, align 8
  store ptr %30, ptr %CurrentChild.i, align 8
...
_ZN16CProfileIterator11Enter_ChildEi.exit:        ; preds = %while.end.i, %if.then.i
  ...
  %31 = load ptr, ptr %profileIterator, align 8
  %Parent.i.i132 = getelementptr inbounds %class.CProfileNode, ptr %31, i64 0, i32 5
  %32 = load ptr, ptr %Parent.i.i132, align 8
...
if.then.i133:                                     ; preds = %_ZN16CProfileIterator11Enter_ChildEi.exit
  store ptr %32, ptr %profileIterator, align 8
...
_ZN16CProfileIterator12Enter_ParentEv.exit:       ; preds = %_ZN16CProfileIterator11Enter_ChildEi.exit, %if.then.i133
  ...
  %34 = load ptr, ptr %Child.i.i134, align 8
  store ptr %34, ptr %CurrentChild.i, align 8
  %inc72 = add nuw i32 %i.4153, 1
  %exitcond158.not = icmp eq i32 %inc72, %numChildren.0.lcssa
  br i1 %exitcond158.not, label %return, label %for.body69
...
entry:
  ...
  store ptr @_ZN15CProfileManager4RootE, ptr %call.i, align 8
  %0 = load ptr, ptr getelementptr inbounds (%class.CProfileNode, ptr @_ZN15CProfileManager4RootE, i64 0, i32 6), align 8
  %CurrentChild.i.i = getelementptr inbounds %class.CProfileIterator, ptr %call.i, i64 0, i32 1
  store ptr %0, ptr %CurrentChild.i.i, align 8
...
entry:
  ...
  store ptr @.str, ptr @_ZN15CProfileManager4RootE, align 8
