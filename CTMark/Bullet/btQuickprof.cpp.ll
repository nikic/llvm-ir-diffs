...
invoke.cont:                                      ; preds = %if.end, %entry
  ...
  %1 = load ptr, ptr %Child, align 8, !tbaa !16
  %Sibling3 = getelementptr inbounds %class.CProfileNode, ptr %call, i64 0, i32 7
  store ptr %1, ptr %Sibling3, align 8, !tbaa !17
...
invoke.cont.i:                                    ; preds = %if.end.i, %if.then
  ...
  store ptr %3, ptr %Sibling3.i, align 8, !tbaa !17
...
if.end:                                           ; preds = %_ZN12CProfileNode12Get_Sub_NodeEPKc.exit, %entry
  ...
  %5 = load i32, ptr %TotalCalls.i, align 8, !tbaa !14
  ...
  %6 = load i32, ptr %RecursionCounter.i, align 8, !tbaa !19
...
if.then.i:                                        ; preds = %if.end
  ...
  %7 = load i64, ptr %currentTime.i.i.i, align 8, !tbaa !20
  %8 = load i64, ptr @_ZL13gProfileClock, align 8, !tbaa !22
  ...
  %9 = load i64, ptr %tv_usec.i.i.i, align 8, !tbaa !24
  %10 = load i64, ptr getelementptr inbounds (%class.btClock, ptr @_ZL13gProfileClock, i64 0, i32 0, i32 1), align 8, !tbaa !25
...
for.cond27.for.end33_crit_edge.us:                ; preds = %for.body29.us
  ...
  %15 = load ptr, ptr %CurrentChild.i, align 8, !tbaa !30
...
for.body18:                                       ; preds = %for.body18.lr.ph, %for.body18
  ...
  %23 = load i32, ptr %TotalCalls.i.i, align 8, !tbaa !14
  ...
  %24 = load ptr, ptr %CurrentChild.i, align 8, !tbaa !30
...
for.body69.lr.ph:                                 ; preds = %for.end55
  ...
  %.pre = load ptr, ptr %profileIterator, align 8, !tbaa !28
  br label %for.body69
...
if.then.i:                                        ; preds = %while.end.i
  ...
  %30 = load ptr, ptr %Child.i15.i, align 8, !tbaa !16
  store ptr %30, ptr %CurrentChild.i, align 8, !tbaa !30
