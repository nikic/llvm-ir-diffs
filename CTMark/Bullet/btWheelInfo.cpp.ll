; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btWheelInfo.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btWheelInfo.cpp"
...
if.else:                                          ; preds = %if.then
  ...
  %17 = load float, ptr %arrayidx11.i.i, align 8
  ...
  %20 = load float, ptr %arrayidx5.i.i, align 8
  %21 = fneg float %20
  ...
  %23 = load float, ptr %m_linearVelocity.i, align 8
...
if.else15:                                        ; preds = %entry
  ...
  %32 = load float, ptr %arrayidx7.i38, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i41, ptr %ref.tmp19.sroa.4.0.m_contactNormalWS25.sroa_idx, align 8
  br label %if.end27
...
attributes #1 = { mustprogress nofree nosync nounwind willreturn memory(argmem: readwrite) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
