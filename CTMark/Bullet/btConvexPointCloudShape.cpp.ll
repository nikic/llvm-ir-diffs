; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btConvexPointCloudShape.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btConvexPointCloudShape.cpp"
...
for.body.lr.ph:                                   ; preds = %if.end
  ...
  %3 = load ptr, ptr %m_unscaledPoints.i, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %8 = load float, ptr %arrayidx11.i.i, align 4
...
for.cond4.preheader:                              ; preds = %for.body.epil, %for.cond4.preheader.unr-lcssa
  %m_numPoints = getelementptr inbounds %class.btConvexPointCloudShape, ptr %this, i64 0, i32 3
  %1 = load i32, ptr %m_numPoints, align 8
...
for.body7.us:                                     ; preds = %for.body7.us.preheader, %for.cond9.for.cond.cleanup11_crit_edge.us
  ...
  %2 = load ptr, ptr %m_unscaledPoints.i, align 8
  %arrayidx.i.us = getelementptr inbounds %class.btVector3, ptr %2, i64 %indvars.iv60
  %3 = load <2 x float>, ptr %arrayidx.i.us, align 4
  %4 = load <2 x float>, ptr %m_localScaling.i, align 8
...
for.body12.us:                                    ; preds = %for.body7.us, %if.end.us
  ...
  %10 = load float, ptr %arrayidx14.us, align 4
...
if.then.us:                                       ; preds = %for.body12.us
  store <2 x float> %5, ptr %arrayidx17.us, align 4
  %vtx.sroa.6.0.arrayidx17.sroa_idx.us = getelementptr inbounds i8, ptr %arrayidx17.us, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i.us, ptr %vtx.sroa.6.0.arrayidx17.sroa_idx.us, align 4
  store float %14, ptr %arrayidx19.us, align 4
  br label %if.end.us
...
for.cond9.for.cond.cleanup11_crit_edge.us:        ; preds = %if.end.us
  ...
  %16 = load i32, ptr %m_numPoints, align 8
...
attributes #3 = { nofree nosync nounwind memory(read, inaccessiblemem: none) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
