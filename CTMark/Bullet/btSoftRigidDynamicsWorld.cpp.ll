; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSoftRigidDynamicsWorld.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSoftRigidDynamicsWorld.cpp"
...
invoke.cont3:
  ...
  store ptr getelementptr inbounds ({ [42 x ptr] }, ptr @_ZTV24btSoftRigidDynamicsWorld, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
invoke.cont11:                                    ; preds = %while.end.i, %invoke.cont8
  ...
  store float 2.500000e-01, ptr %voxelsz.i, align 8
  %puid.i = getelementptr inbounds %class.btSoftRigidDynamicsWorld, ptr %this, i64 0, i32 7, i32 7, i32 2
  store <4 x i32> <i32 0, i32 0, i32 1, i32 1>, ptr %puid.i, align 4
  ret void
...
if.then5.i:                                       ; preds = %entry
  %m_capacity.i.i.i = getelementptr inbounds %class.btAlignedObjectArray.16, ptr %this, i64 0, i32 3
...
for.body.lr.ph.i.i.i:                             ; preds = %_ZN20btAlignedObjectArrayIPN11btSparseSdfILi3EE4CellEE8allocateEi.exit.i.i
  %m_data.i.i.i = getelementptr inbounds %class.btAlignedObjectArray.16, ptr %this, i64 0, i32 5
...
for.body.i.i.i.epil:                              ; preds = %_ZNK20btAlignedObjectArrayIPN11btSparseSdfILi3EE4CellEE4copyEiiPS3_.exit.i.i.loopexit.unr-lcssa, %for.body.i.i.i.epil
  ...
  br i1 %epil.iter.cmp.not, label %_ZNK20btAlignedObjectArrayIPN11btSparseSdfILi3EE4CellEE4copyEiiPS3_.exit.i.i, label %for.body.i.i.i.epil
...
_ZNK20btAlignedObjectArrayIPN11btSparseSdfILi3EE4CellEE4copyEiiPS3_.exit.i.i: ; preds = %_ZNK20btAlignedObjectArrayIPN11btSparseSdfILi3EE4CellEE4copyEiiPS3_.exit.i.i.loopexit.unr-lcssa, %for.body.i.i.i.epil, %_ZN20btAlignedObjectArrayIPN11btSparseSdfILi3EE4CellEE8allocateEi.exit.i.i
  %m_data.i9.i.i = getelementptr inbounds %class.btAlignedObjectArray.16, ptr %this, i64 0, i32 5
  %14 = load ptr, ptr %m_data.i9.i.i, align 8
  %tobool.not.i10.i.i = icmp eq ptr %14, null
  %m_ownsMemory.i.i.i = getelementptr inbounds %class.btAlignedObjectArray.16, ptr %this, i64 0, i32 6
...
for.body10.lr.ph.i:                               ; preds = %if.end.i, %if.then5.i
  %m_data11.i = getelementptr inbounds %class.btAlignedObjectArray.16, ptr %this, i64 0, i32 5
...
for.body10.i:                                     ; preds = %for.body10.i.prol.loopexit, %for.body10.i
  ...
  %22 = load ptr, ptr %m_data11.i, align 8
  ...
  %24 = load ptr, ptr %m_data11.i, align 8
...
for.cond.cleanup:                                 ; preds = %for.body, %_ZN24btSoftRigidDynamicsWorld26solveSoftBodiesConstraintsEv.exit
  ...
  br i1 %cmp13.i, label %for.body.lr.ph.i8, label %_ZN24btSoftRigidDynamicsWorld16updateSoftBodiesEv.exit

for.body.lr.ph.i8:                                ; preds = %for.cond.cleanup
  %m_data.i.i9 = getelementptr inbounds %class.btSoftRigidDynamicsWorld, ptr %this, i64 0, i32 2, i32 5
  br label %for.body.i10

for.body.i10:                                     ; preds = %invoke.cont6.i, %for.body.lr.ph.i8
  %indvars.iv.i11 = phi i64 [ 0, %for.body.lr.ph.i8 ], [ %indvars.iv.next.i14, %invoke.cont6.i ]
  %12 = load ptr, ptr %m_data.i.i9, align 8
  %arrayidx.i.i12 = getelementptr inbounds ptr, ptr %12, i64 %indvars.iv.i11
...
invoke.cont6.i:                                   ; preds = %for.body.i10
  %indvars.iv.next.i14 = add nuw nsw i64 %indvars.iv.i11, 1
  %14 = load i32, ptr %m_size.i.i, align 4
  %15 = sext i32 %14 to i64
  %cmp.i15 = icmp slt i64 %indvars.iv.next.i14, %15
  br i1 %cmp.i15, label %for.body.i10, label %_ZN24btSoftRigidDynamicsWorld16updateSoftBodiesEv.exit

lpad3.i:                                          ; preds = %for.body.i10
  %16 = landingpad { ptr, i32 }
          cleanup
  invoke void @_ZN15CProfileManager12Stop_ProfileEv()
          to label %common.resume unwind label %terminate.lpad.i13

terminate.lpad.i13:                               ; preds = %lpad3.i
...
for.body.i.i.i.epil:                              ; preds = %_ZNK20btAlignedObjectArrayIP10btSoftBodyE4copyEiiPS1_.exit.i.i.loopexit.unr-lcssa, %for.body.i.i.i.epil
  ...
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %_ZNK20btAlignedObjectArrayIP10btSoftBodyE4copyEiiPS1_.exit.i.i, label %for.body.i.i.i.epil
...
if.then.i.i:                                      ; preds = %_ZNK20btAlignedObjectArrayIP10btSoftBodyE16findLinearSearchERKS1_.exit.i.i
  ...
  %5 = load ptr, ptr %arrayidx.i7.i.i, align 8
  ...
  store ptr %6, ptr %arrayidx.i7.i.i, align 8
  ...
  store i32 %sub.i.i, ptr %m_size.i.i.i.i, align 4
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end25
  ...
  %6 = load i32, ptr %m_drawFlags, align 8
...
if.then13:                                        ; preds = %land.lhs.true
  %9 = load i8, ptr %m_drawNodeTree, align 4
...
if.end:                                           ; preds = %if.then15, %if.then13
  %11 = load i8, ptr %m_drawFaceTree, align 1
...
if.end20:                                         ; preds = %if.then18, %if.end
  %13 = load i8, ptr %m_drawClusterTree, align 2
