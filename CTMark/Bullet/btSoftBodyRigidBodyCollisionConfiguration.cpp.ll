; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSoftBodyRigidBodyCollisionConfiguration.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSoftBodyRigidBodyCollisionConfiguration.cpp"
...
invoke.cont3:                                     ; preds = %invoke.cont2
  ...
  store i8 0, ptr %m_swapped.i.i55, align 8
...
invoke.cont6:                                     ; preds = %invoke.cont3
  ...
  store i8 1, ptr %m_swapped.i.i56, align 8
...
invoke.cont10:                                    ; preds = %invoke.cont6
  ...
  store i8 0, ptr %m_swapped.i.i57, align 8
...
invoke.cont13:                                    ; preds = %invoke.cont10
  ...
  store i8 1, ptr %m_swapped.i.i58, align 8
...
invoke.cont30:                                    ; preds = %if.then28
  %4 = load ptr, ptr %m_collisionAlgorithmPool, align 8
...
invoke.cont35:                                    ; preds = %invoke.cont32
  ...
  %5 = load i32, ptr %m_defaultMaxCollisionAlgorithmPoolSize, align 4
  store i32 248, ptr %call36, align 8
  %m_maxElements.i = getelementptr inbounds %class.btPoolAllocator, ptr %call36, i64 0, i32 1
  store i32 %5, ptr %m_maxElements.i, align 4
...
invoke.cont37:                                    ; preds = %while.body.i.prol.loopexit, %while.body.i, %call.i.noexc
  ...
  store ptr %call36, ptr %m_collisionAlgorithmPool, align 8
  br label %if.end43
...
invoke.cont18:                                    ; preds = %invoke.cont16
  ...
  %vtable19 = load ptr, ptr %12, align 8
