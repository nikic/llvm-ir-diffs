; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btCollisionDispatcher.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btCollisionDispatcher.cpp"
...
invoke.cont3:
  store ptr getelementptr inbounds ({ [16 x ptr] }, ptr @_ZTV21btCollisionDispatcher, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  ...
  store i8 1, ptr %m_useIslands, align 8
  %m_staticWarningReported = getelementptr inbounds %class.btCollisionDispatcher, ptr %this, i64 0, i32 5
  store i8 0, ptr %m_staticWarningReported, align 1
  %m_defaultManifoldResult = getelementptr inbounds %class.btCollisionDispatcher, ptr %this, i64 0, i32 6
  store ptr getelementptr inbounds ({ [7 x ptr] }, ptr @_ZTV16btManifoldResult, i64 0, inrange i32 0, i64 2), ptr %m_defaultManifoldResult, align 8
...
invoke.cont6:                                     ; preds = %invoke.cont3
  ...
  %vtable7 = load ptr, ptr %collisionConfiguration, align 8
...
invoke.cont9:                                     ; preds = %invoke.cont6
  ...
  store ptr %call10, ptr %m_persistentManifoldPoolAllocator, align 8
...
for.body13:                                       ; preds = %for.cond11.preheader, %invoke.cont18
  ...
  %4 = load ptr, ptr %m_collisionConfiguration, align 8
...
if.then:                                          ; preds = %entry
  ...
  %5 = load ptr, ptr %m_algorithm, align 8
  %tobool.not = icmp eq ptr %5, null
  br i1 %tobool.not, label %if.end, label %if.then9

if.end:                                           ; preds = %if.then
  %vtable3 = load ptr, ptr %dispatcher, align 8
  ...
  store ptr %call5, ptr %m_algorithm, align 8
...
if.then9:                                         ; preds = %if.then, %if.end
  ...
  %7 = load i32, ptr %m_dispatchFunc, align 8
  %cmp = icmp eq i32 %7, 1
  %8 = load ptr, ptr %m_algorithm, align 8
...
if.else:                                          ; preds = %if.then9
  ...
  %11 = load float, ptr %m_timeOfImpact, align 4
  %cmp20 = fcmp ogt float %11, %call19
  br i1 %cmp20, label %if.then21, label %if.end24

if.then21:                                        ; preds = %if.else
  store float %call19, ptr %m_timeOfImpact, align 4
  br label %if.end24
...
entry:
  %0 = load i32, ptr @gNumManifold, align 4
  %inc = add nsw i32 %0, 1
  store i32 %inc, ptr @gNumManifold, align 4
  ...
  %3 = load ptr, ptr %m_collisionShape.i27, align 8
  ...
  %5 = load float, ptr %m_contactProcessingThreshold.i, align 4
  %m_contactProcessingThreshold.i28 = getelementptr inbounds %class.btCollisionObject, ptr %b1, i64 0, i32 7
  %6 = load float, ptr %m_contactProcessingThreshold.i28, align 4
...
invoke.cont:                                      ; preds = %if.then, %if.else
  ...
  store <2 x float> %12, ptr %m_contactBreakingThreshold.i, align 4
  ...
  store i32 %17, ptr %m_index1a, align 4
  %m_capacity.i.i = getelementptr inbounds %class.btCollisionDispatcher, ptr %this, i64 0, i32 3, i32 3
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i.new
  ...
  %24 = load ptr, ptr %arrayidx3.i.i.i.1, align 8
  store ptr %24, ptr %arrayidx.i.i.i.1, align 8
  ...
  %26 = load ptr, ptr %arrayidx3.i.i.i.2, align 8
  store ptr %26, ptr %arrayidx.i.i.i.2, align 8
  ...
  %28 = load ptr, ptr %arrayidx3.i.i.i.3, align 8
  store ptr %28, ptr %arrayidx.i.i.i.3, align 8
...
for.body.i.i.i.epil:                              ; preds = %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i.loopexit.unr-lcssa, %for.body.i.i.i.epil
  ...
  %30 = load ptr, ptr %arrayidx3.i.i.i.epil, align 8
  store ptr %30, ptr %arrayidx.i.i.i.epil, align 8
...
_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i: ; preds = %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i.loopexit.unr-lcssa, %for.body.i.i.i.epil, %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE8allocateEi.exit.i.i
  ...
  %31 = load ptr, ptr %m_data.i9.i.i, align 8
...
if.then.i:
  %0 = load i32, ptr @gNumManifold, align 4
  %dec = add nsw i32 %0, -1
  store i32 %dec, ptr @gNumManifold, align 4
  ...
  %2 = load i32, ptr %m_index1a, align 4
  %m_size.i = getelementptr inbounds %class.btCollisionDispatcher, ptr %this, i64 0, i32 3, i32 2
  ...
  store i32 %2, ptr %m_index1a5, align 4
...
entry:
  ...
  %2 = load ptr, ptr %m_collisionShape.i10, align 8
  %m_shapeType.i11 = getelementptr inbounds %class.btCollisionShape, ptr %2, i64 0, i32 1
  %3 = load i32, ptr %m_shapeType.i11, align 8
...
land.rhs:                                         ; preds = %entry
  ...
  %1 = load i32, ptr %m_collisionFlags.i12, align 8
  %and.i13 = and i32 %1, 4
...
entry:
  ...
  %0 = load i32, ptr %m_activationState1.i.i, align 4
...
land.lhs.true:                                    ; preds = %entry, %entry
  ...
  %1 = load i32, ptr %m_activationState1.i.i8, align 4
...
if.else:                                          ; preds = %land.lhs.true, %entry
  ...
  %2 = load i8, ptr %m_checkCollideWith.i, align 8
...
entry:
  ...
  %1 = load i32, ptr %m_freeCount.i, align 8
  %tobool.not = icmp eq i32 %1, 0
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %m_firstFree.i = getelementptr inbounds %class.btPoolAllocator, ptr %0, i64 0, i32 3
  %2 = load ptr, ptr %m_firstFree.i, align 8
  %3 = load ptr, ptr %2, align 8
  store ptr %3, ptr %m_firstFree.i, align 8
