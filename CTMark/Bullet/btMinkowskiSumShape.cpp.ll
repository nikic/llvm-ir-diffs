; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btMinkowskiSumShape.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btMinkowskiSumShape.cpp"
...
invoke.cont6:
  ...
  store ptr getelementptr inbounds ({ [20 x ptr] }, ptr @_ZTV19btMinkowskiSumShape, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  ...
  store float 1.000000e+00, ptr %arrayidx5.i10.i.i.i, align 8
  ...
  store float 1.000000e+00, ptr %arrayidx3.i6.i.i.i10, align 4
  ...
  store float 1.000000e+00, ptr %arrayidx5.i10.i.i.i12, align 8
...
entry:
  ...
  %3 = load float, ptr %arrayidx.i14.i.i, align 4
  ...
  %19 = load float, ptr %arrayidx.i16.i16.i, align 8
  ...
  %27 = load <4 x float>, ptr %arrayidx.i.i9.i, align 4
  %28 = shufflevector <4 x float> %27, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %29 = load <4 x float>, ptr %arrayidx.i.i12.i, align 8
  ...
  %39 = load float, ptr %arrayidx9.i.i, align 8
  %40 = load float, ptr %arrayidx.i16.i.i, align 4
  %41 = load float, ptr %arrayidx.i16.i16.i, align 8
  ...
  %45 = load float, ptr %arrayidx.i14.i.i, align 4
  ...
  %47 = load <2 x float>, ptr %arrayidx4.i.i38, align 8
  ...
  %54 = load <2 x float>, ptr %arrayidx9.i.i41, align 8
  ...
  %58 = load float, ptr %arrayidx.i.i12.i47, align 8
  %arrayidx.i14.i13.i48 = getelementptr inbounds %class.btMinkowskiSumShape, ptr %this, i64 0, i32 2, i32 0, i32 0, i64 1, i32 0, i64 2
  %59 = load float, ptr %arrayidx.i14.i13.i48, align 8
  %mul7.i15.i49 = fmul float %59, %fneg4.i
  %60 = call float @llvm.fmuladd.f32(float %58, float %fneg.i, float %mul7.i15.i49)
  %arrayidx.i16.i16.i50 = getelementptr inbounds %class.btMinkowskiSumShape, ptr %this, i64 0, i32 2, i32 0, i32 0, i64 2, i32 0, i64 2
  %61 = load float, ptr %arrayidx.i16.i16.i50, align 8
  %62 = call float @llvm.fmuladd.f32(float %61, float %fneg8.i, float %60)
  %retval.sroa.3.12.vec.insert.i53 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %62, i64 0
  store <2 x float> %57, ptr %ref.tmp10, align 8
  %63 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp10, i64 0, i32 1
  store <2 x float> %retval.sroa.3.12.vec.insert.i53, ptr %63, align 8
  ...
  %66 = insertelement <2 x float> %36, float %40, i64 1
  %67 = fmul <2 x float> %65, %66
  %68 = insertelement <2 x float> %34, float %39, i64 1
  %69 = shufflevector <2 x float> %23, <2 x float> poison, <2 x i32> zeroinitializer
  %70 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %68, <2 x float> %69, <2 x float> %67)
  %71 = insertelement <2 x float> %38, float %41, i64 1
  %72 = shufflevector <2 x float> %24, <2 x float> poison, <2 x i32> zeroinitializer
  %73 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %71, <2 x float> %72, <2 x float> %70)
  %74 = load <2 x float>, ptr %arrayidx.i25.i, align 4
  %75 = fadd <2 x float> %74, %73
  %call20 = call { <2 x float>, <2 x float> } %64(ptr noundef nonnull align 8 dereferenceable(24) %42, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp10)
  ...
  %79 = load float, ptr %arrayidx.i.i9.i43, align 4
  %80 = load float, ptr %arrayidx.i.i12.i47, align 8
  %81 = load float, ptr %m_origin.i61, align 8
  %82 = insertelement <2 x float> %28, float %79, i64 1
  %83 = shufflevector <2 x float> %23, <2 x float> %76, <2 x i32> <i32 1, i32 3>
  %84 = fmul <2 x float> %82, %83
  %85 = insertelement <2 x float> %26, float %78, i64 1
  %86 = shufflevector <2 x float> %23, <2 x float> %76, <2 x i32> <i32 0, i32 2>
  %87 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %85, <2 x float> %86, <2 x float> %84)
  %88 = insertelement <2 x float> %30, float %80, i64 1
  %89 = shufflevector <2 x float> %24, <2 x float> %77, <2 x i32> <i32 0, i32 2>
  %90 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %88, <2 x float> %89, <2 x float> %87)
  %91 = insertelement <2 x float> %32, float %81, i64 1
  ...
  %99 = load float, ptr %arrayidx9.i.i41, align 8
  %100 = load float, ptr %arrayidx.i16.i.i46, align 4
  ...
  %107 = load float, ptr %arrayidx.i16.i16.i50, align 8
  ...
  %111 = load <2 x float>, ptr %arrayidx.i25.i67, align 4
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  store <2 x float> %2, ptr %ref.tmp.sroa.4.0.arrayidx3.sroa_idx, align 4
...
attributes #5 = { mustprogress nofree nosync nounwind willreturn memory(argmem: write) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
