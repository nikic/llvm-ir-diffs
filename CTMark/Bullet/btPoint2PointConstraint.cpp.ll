; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btPoint2PointConstraint.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btPoint2PointConstraint.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [9 x ptr] }, ptr @_ZTV23btPoint2PointConstraint, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  ...
  store <2 x float> <float 0x3FD3333340000000, float 1.000000e+00>, ptr %m_setting, align 8
  %m_impulseClamp.i = getelementptr inbounds %class.btPoint2PointConstraint, ptr %this, i64 0, i32 6, i32 2
  store float 0.000000e+00, ptr %m_impulseClamp.i, align 8
  ret void
}
...
entry:
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayctor.end, ptr noundef nonnull align 4 dereferenceable(16) %pivotInA, i64 16, i1 false)
...
entry:
  ...
  %0 = load <4 x float>, ptr %m_worldTransform.i, align 8
  %1 = shufflevector <4 x float> %0, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %2 = load float, ptr %pivotInA, align 4
  ...
  %11 = load float, ptr %arrayidx10.i23.i, align 8
  ...
  %24 = load <2 x float>, ptr %m_origin.i, align 8
  ...
  %26 = load float, ptr %arrayidx.i26.i, align 8
  ...
  %29 = load float, ptr %arrayidx10.i30.i, align 8
  ...
  %31 = load float, ptr %arrayidx.i32.i, align 8
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %2 = load float, ptr %arrayidx.i28.i, align 4
  %3 = load float, ptr %arrayidx.i29.i, align 4
  %4 = load float, ptr %arrayidx.i30.i, align 4
  %5 = load float, ptr %arrayidx.i28.i53, align 4
  %6 = load float, ptr %arrayidx.i29.i54, align 4
  %7 = load float, ptr %arrayidx.i30.i55, align 4
  %8 = load float, ptr %m_pivotInA, align 4
  %9 = load float, ptr %arrayidx7.i.i.i, align 8
  %10 = load float, ptr %arrayidx12.i.i.i, align 4
  %11 = load float, ptr %m_origin.i.i, align 4
  %12 = load float, ptr %arrayidx.i25.i.i, align 4
  %13 = load float, ptr %arrayidx.i32.i.i, align 4
  %14 = load float, ptr %m_pivotInB, align 4
  %15 = load float, ptr %arrayidx7.i.i.i74, align 8
  %16 = load float, ptr %arrayidx12.i.i.i77, align 4
  %17 = load float, ptr %m_origin.i.i78, align 4
  %18 = load float, ptr %arrayidx.i25.i.i84, align 4
  %19 = load float, ptr %arrayidx.i32.i.i90, align 4
  %20 = load float, ptr %m_inverseMass.i, align 8
  %21 = load float, ptr %m_inverseMass.i111, align 8
  ...
  %23 = load <2 x float>, ptr %arrayidx3.i46, align 4
  ...
  %40 = load <2 x float>, ptr %m_worldTransform.i47, align 4
  %41 = load <2 x float>, ptr %arrayidx3.i48, align 4
  %42 = load <2 x float>, ptr %arrayidx6.i49, align 4
  ...
  %89 = load <2 x float>, ptr %m_invInertiaLocal.i110, align 4
  %90 = fmul <2 x float> %83, %89
  %91 = load float, ptr %arrayidx11.i89.i, align 4
...
entry:
  ...
  %0 = load i8, ptr %m_useSolveConstraintObsolete.i, align 4
...
entry:
  ...
  %2 = load float, ptr %body0_trans, align 4
  %3 = load float, ptr %m_pivotInA.i, align 4
  ...
  store float %fneg4.i, ptr %arrayidx5.i.i119, align 4
  %arrayidx7.i.i120 = getelementptr inbounds [4 x float], ptr %20, i64 0, i64 3
  store float 0.000000e+00, ptr %arrayidx7.i.i120, align 4
  ...
  %32 = load float, ptr %arrayidx10.i15.i130, align 4
  ...
  %37 = load float, ptr %arrayidx10.i21.i134, align 4
  %38 = tail call float @llvm.fmuladd.f32(float %37, float %27, float %36)
  %fneg.i140 = fneg float %28
  %fneg4.i142 = fneg float %33
  %fneg8.i144 = fneg float %38
  ...
  %48 = load float, ptr %arrayidx53.2, align 4
...
for.inc74:                                        ; preds = %entry
  %52 = load ptr, ptr %m_lowerLimit, align 8
  store float %fneg, ptr %52, align 4
  %53 = load ptr, ptr %m_upperLimit, align 8
  store float %50, ptr %53, align 4
  %.pre = load float, ptr %m_impulseClamp, align 8
  %cmp65.1 = fcmp ogt float %.pre, 0.000000e+00
  br i1 %cmp65.1, label %if.then.1, label %for.inc74.1

if.then.1:                                        ; preds = %for.inc74
  %54 = load ptr, ptr %m_lowerLimit, align 8
  %arrayidx69.1 = getelementptr inbounds float, ptr %54, i64 %idx.ext
  store float %fneg, ptr %arrayidx69.1, align 4
  %55 = load ptr, ptr %m_upperLimit, align 8
  %arrayidx73.1 = getelementptr inbounds float, ptr %55, i64 %idx.ext
  store float %50, ptr %arrayidx73.1, align 4
  %.pre190 = load float, ptr %m_impulseClamp, align 8
...
if.then.2:                                        ; preds = %for.inc74.1
  %57 = load ptr, ptr %m_lowerLimit, align 8
  %arrayidx69.2 = getelementptr inbounds float, ptr %57, i64 %49
  store float %fneg, ptr %arrayidx69.2, align 4
  %58 = load ptr, ptr %m_upperLimit, align 8
  %arrayidx73.2 = getelementptr inbounds float, ptr %58, i64 %49
  store float %50, ptr %arrayidx73.2, align 4
  br label %for.end76
...
if.then:                                          ; preds = %entry
  ...
  %3 = load float, ptr %m_pivotInA, align 4
  ...
  %20 = insertelement <2 x float> %19, float %4, i64 1
  ...
  %30 = insertelement <2 x float> %29, float %6, i64 1
  ...
  %60 = insertelement <2 x float> poison, float %51, i64 0
  %61 = insertelement <2 x float> %60, float %38, i64 1
  ...
  %66 = insertelement <2 x float> %65, float %42, i64 1
  ...
  %m_linearVelocity.i.i140 = getelementptr inbounds %class.btRigidBody, ptr %74, i64 0, i32 2
  %arrayidx11.i.i145 = getelementptr inbounds %class.btRigidBody, ptr %74, i64 0, i32 2, i32 0, i64 2
  %m_angularVelocity.i.i148 = getelementptr inbounds %class.btRigidBody, ptr %74, i64 0, i32 3
  %arrayidx5.i20.i151 = getelementptr inbounds %class.btRigidBody, ptr %74, i64 0, i32 3, i32 0, i64 1
  br label %for.body
...
for.body:                                         ; preds = %if.then, %if.end47
  ...
  store float 1.000000e+00, ptr %arrayidx, align 4
  %m_Adiag.i = getelementptr inbounds %class.btPoint2PointConstraint, ptr %this, i64 0, i32 1, i64 %indvars.iv, i32 5
  %77 = load float, ptr %m_Adiag.i, align 4
  %div = fdiv float 1.000000e+00, %77
  %78 = load float, ptr %m_origin.i.i, align 4
  %79 = load float, ptr %arrayidx.i25.i.i, align 4
  %sub8.i = fsub float %add10.i.i, %79
  %80 = load float, ptr %arrayidx.i32.i.i, align 4
  %81 = insertelement <2 x float> poison, float %80, i64 0
  %82 = insertelement <2 x float> %81, float %78, i64 1
  %83 = fsub <2 x float> %36, %82
  %84 = load float, ptr %m_origin.i.i101, align 4
  %85 = load float, ptr %arrayidx.i25.i.i107, align 4
  %sub8.i127 = fsub float %add10.i.i108, %85
  %86 = load float, ptr %arrayidx.i32.i.i113, align 4
...
if.then.i:                                        ; preds = %for.body
  ...
  %91 = load float, ptr %arrayidx12.i.i252, align 8
  %add14.i.i = fadd float %90, %91
  %92 = load float, ptr %m_angularVelocity.i.i, align 4
  %93 = load float, ptr %m_deltaAngularVelocity.i258, align 8
  %add.i19.i = fadd float %92, %93
  %94 = load <2 x float>, ptr %m_linearVelocity.i.i, align 4
  %95 = load <2 x float>, ptr %bodyA, align 8
  %96 = fadd <2 x float> %94, %95
  %97 = load <2 x float>, ptr %arrayidx5.i20.i, align 4
  %98 = load <2 x float>, ptr %arrayidx7.i22.i, align 4
...
_ZNK12btSolverBody31getVelocityInLocalPointObsoleteERK9btVector3RS0_.exit: ; preds = %for.body, %if.then.i
  ...
  br i1 %tobool.not.i138, label %_ZNK12btSolverBody31getVelocityInLocalPointObsoleteERK9btVector3RS0_.exit170, label %if.then.i139

if.then.i139:                                     ; preds = %_ZNK12btSolverBody31getVelocityInLocalPointObsoleteERK9btVector3RS0_.exit
  %112 = load float, ptr %arrayidx11.i.i145, align 4
  %113 = load float, ptr %arrayidx12.i.i297, align 8
  %add14.i.i147 = fadd float %112, %113
  %114 = load float, ptr %m_angularVelocity.i.i148, align 4
  %115 = load float, ptr %m_deltaAngularVelocity.i310, align 8
  %add.i19.i150 = fadd float %114, %115
  %116 = load <2 x float>, ptr %m_linearVelocity.i.i140, align 4
  %117 = load <2 x float>, ptr %bodyB, align 8
  %118 = fadd <2 x float> %116, %117
  %119 = load <2 x float>, ptr %arrayidx5.i20.i151, align 4
  %120 = load <2 x float>, ptr %arrayidx7.i22.i312, align 4
  %121 = fadd <2 x float> %119, %120
  %122 = shufflevector <2 x float> %121, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %123 = insertelement <2 x float> %122, float %add.i19.i150, i64 1
  ...
  %neg30.i.i161 = fmul float %131, %130
  %132 = tail call float @llvm.fmuladd.f32(float %add.i19.i150, float %sub8.i127, float %neg30.i.i161)
  %133 = fadd <2 x float> %118, %128
  %add14.i44.i164 = fadd float %add14.i.i147, %132
  %retval.sroa.3.12.vec.insert.i47.i167 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i44.i164, i64 0
  br label %_ZNK12btSolverBody31getVelocityInLocalPointObsoleteERK9btVector3RS0_.exit170

_ZNK12btSolverBody31getVelocityInLocalPointObsoleteERK9btVector3RS0_.exit170: ; preds = %_ZNK12btSolverBody31getVelocityInLocalPointObsoleteERK9btVector3RS0_.exit, %if.then.i139
  %vel2.sroa.0.1 = phi <2 x float> [ %133, %if.then.i139 ], [ zeroinitializer, %_ZNK12btSolverBody31getVelocityInLocalPointObsoleteERK9btVector3RS0_.exit ]
  %vel2.sroa.6.1 = phi <2 x float> [ %retval.sroa.3.12.vec.insert.i47.i167, %if.then.i139 ], [ zeroinitializer, %_ZNK12btSolverBody31getVelocityInLocalPointObsoleteERK9btVector3RS0_.exit ]
  ...
  %137 = load <2 x float>, ptr %normal, align 8
  ...
  %142 = load float, ptr %arrayidx5.i, align 8
...
if.end47:                                         ; preds = %if.else, %if.then41, %if.then35
  ...
  store float %.sink, ptr %m_appliedImpulse, align 8
  ...
  %169 = load float, ptr %m_inverseMass.i, align 8
  %mul8.i234 = fmul float %142, %169
  %170 = load float, ptr %m_invInertiaTensorWorld.i, align 4
  %171 = load float, ptr %arrayidx5.i.i240, align 4
  %172 = load float, ptr %arrayidx10.i.i, align 4
  %173 = load float, ptr %arrayidx.i.i, align 4
  %174 = load float, ptr %arrayidx5.i12.i, align 4
  %175 = load float, ptr %arrayidx10.i15.i, align 4
  %176 = load float, ptr %arrayidx.i17.i, align 4
  %177 = load float, ptr %arrayidx5.i18.i, align 4
  %mul8.i20.i = fmul float %158, %177
  %178 = tail call float @llvm.fmuladd.f32(float %176, float %155, float %mul8.i20.i)
  %179 = load float, ptr %arrayidx10.i21.i, align 4
  %180 = tail call float @llvm.fmuladd.f32(float %179, float %160, float %178)
  %mul8.i.i249 = fmul float %deltaImpulse.0, %mul8.i234
  %181 = insertelement <2 x float> poison, float %169, i64 0
  %182 = shufflevector <2 x float> %181, <2 x float> poison, <2 x i32> zeroinitializer
  %183 = fmul <2 x float> %137, %182
  %184 = insertelement <2 x float> poison, float %deltaImpulse.0, i64 0
  %185 = shufflevector <2 x float> %184, <2 x float> poison, <2 x i32> zeroinitializer
  %186 = fmul <2 x float> %185, %183
  %187 = load <2 x float>, ptr %bodyA, align 8
  %188 = fadd <2 x float> %186, %187
  store <2 x float> %188, ptr %bodyA, align 8
  %189 = load float, ptr %arrayidx12.i.i252, align 8
  %add13.i.i = fadd float %mul8.i.i249, %189
  store float %add13.i.i, ptr %arrayidx12.i.i252, align 8
  %190 = load float, ptr %arrayidx7.i.i.i253, align 8
  %mul8.i.i.i254 = fmul float %deltaImpulse.0, %190
  %mul14.i.i = fmul float %180, %mul8.i.i.i254
  %191 = insertelement <2 x float> poison, float %158, i64 0
  %192 = shufflevector <2 x float> %191, <2 x float> poison, <2 x i32> zeroinitializer
  %193 = insertelement <2 x float> poison, float %171, i64 0
  %194 = insertelement <2 x float> %193, float %174, i64 1
  %195 = fmul <2 x float> %192, %194
  %196 = insertelement <2 x float> poison, float %170, i64 0
  %197 = insertelement <2 x float> %196, float %173, i64 1
  %198 = insertelement <2 x float> poison, float %155, i64 0
  %199 = shufflevector <2 x float> %198, <2 x float> poison, <2 x i32> zeroinitializer
  %200 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %197, <2 x float> %199, <2 x float> %195)
  %201 = insertelement <2 x float> poison, float %172, i64 0
  %202 = insertelement <2 x float> %201, float %175, i64 1
  ...
  %205 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %202, <2 x float> %204, <2 x float> %200)
  %206 = load <2 x float>, ptr %m_angularFactor.i, align 8
  %207 = fmul <2 x float> %185, %206
  %208 = fmul <2 x float> %205, %207
  %209 = load <2 x float>, ptr %m_deltaAngularVelocity.i258, align 8
  %210 = fadd <2 x float> %208, %209
  store <2 x float> %210, ptr %m_deltaAngularVelocity.i258, align 8
  %211 = load float, ptr %arrayidx12.i25.i, align 8
  %add13.i26.i = fadd float %mul14.i.i, %211
  store float %add13.i26.i, ptr %arrayidx12.i25.i, align 8
  %212 = load float, ptr %m_inverseMass.i259, align 8
  %mul8.i264 = fmul float %142, %212
  %213 = load float, ptr %m_invInertiaTensorWorld.i270, align 4
  %214 = load float, ptr %arrayidx5.i.i271, align 4
  %215 = load float, ptr %arrayidx10.i.i274, align 4
  %216 = load float, ptr %arrayidx.i.i276, align 4
  %217 = load float, ptr %arrayidx5.i12.i277, align 4
  %218 = load float, ptr %arrayidx10.i15.i279, align 4
  %219 = load float, ptr %arrayidx.i17.i280, align 4
  %220 = load float, ptr %arrayidx5.i18.i281, align 4
  %mul8.i20.i282 = fmul float %166, %220
  %221 = tail call float @llvm.fmuladd.f32(float %219, float %163, float %mul8.i20.i282)
  %222 = load float, ptr %arrayidx10.i21.i283, align 4
  %223 = tail call float @llvm.fmuladd.f32(float %222, float %168, float %221)
  %fneg76 = fneg float %deltaImpulse.0
  %224 = insertelement <2 x float> poison, float %212, i64 0
  %225 = shufflevector <2 x float> %224, <2 x float> poison, <2 x i32> zeroinitializer
  %226 = fmul <2 x float> %137, %225
  %227 = load <2 x float>, ptr %bodyB, align 8
  %228 = fmul <2 x float> %185, %226
  %229 = fsub <2 x float> %227, %228
  store <2 x float> %229, ptr %bodyB, align 8
  %230 = load float, ptr %arrayidx12.i.i297, align 8
  %231 = fmul float %deltaImpulse.0, %mul8.i264
  %add13.i.i298 = fsub float %230, %231
  store float %add13.i.i298, ptr %arrayidx12.i.i297, align 8
  %232 = load float, ptr %arrayidx7.i.i.i303, align 8
  %mul8.i.i.i304 = fmul float %232, %fneg76
  %mul14.i.i309 = fmul float %223, %mul8.i.i.i304
  %233 = insertelement <2 x float> poison, float %166, i64 0
  %234 = shufflevector <2 x float> %233, <2 x float> poison, <2 x i32> zeroinitializer
  %235 = insertelement <2 x float> poison, float %214, i64 0
  %236 = insertelement <2 x float> %235, float %217, i64 1
  %237 = fmul <2 x float> %234, %236
  %238 = insertelement <2 x float> poison, float %213, i64 0
  %239 = insertelement <2 x float> %238, float %216, i64 1
  %240 = insertelement <2 x float> poison, float %163, i64 0
  ...
  %244 = insertelement <2 x float> %243, float %218, i64 1
  ...
  %248 = load <2 x float>, ptr %m_angularFactor.i299, align 8
  ...
  %253 = load <2 x float>, ptr %m_deltaAngularVelocity.i310, align 8
  %254 = fadd <2 x float> %252, %253
  store <2 x float> %254, ptr %m_deltaAngularVelocity.i310, align 8
  %255 = load float, ptr %arrayidx12.i25.i314, align 8
  %add13.i26.i315 = fadd float %mul14.i.i309, %255
  store float %add13.i26.i315, ptr %arrayidx12.i25.i314, align 8
  store float 0.000000e+00, ptr %arrayidx, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 3
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.body
...
define dso_local void @_ZN23btPoint2PointConstraint9updateRHSEf(ptr nocapture noundef nonnull readnone align 8 dereferenceable(396) %this, float noundef %timeStep) local_unnamed_addr #10 align 2 {
entry:
  ret void
}
...
attributes #4 = { nofree nosync nounwind memory(read, argmem: readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #8 = { mustprogress nofree nosync nounwind willreturn memory(write, argmem: readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
