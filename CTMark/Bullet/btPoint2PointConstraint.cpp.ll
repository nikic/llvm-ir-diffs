...
entry:
  ...
  %2 = load float, ptr %pivotInA, align 4, !tbaa !19
  ...
  %24 = load <2 x float>, ptr %m_origin.i, align 8, !tbaa !19
  ...
  %29 = load float, ptr %arrayidx10.i30.i, align 8, !tbaa !19
  ...
  %31 = load float, ptr %arrayidx.i32.i, align 8, !tbaa !19
...
entry:
  ...
  store float %fneg8.i144, ptr %arrayidx3.i.i153, align 4, !tbaa !19
  ...
  store float %fneg.i140, ptr %arrayidx5.i17.i158, align 4, !tbaa !19
  ...
  store float %fneg4.i142, ptr %add.ptr37, align 4, !tbaa !19
...
if.then:                                          ; preds = %entry
  ...
  %14 = load float, ptr %arrayidx.i25.i.i, align 4, !tbaa !19
  ...
  %17 = load float, ptr %arrayidx10.i30.i.i, align 4, !tbaa !19
  ...
  %48 = load float, ptr %arrayidx10.i23.i.i106, align 4, !tbaa !19
  ...
  %50 = load float, ptr %arrayidx.i25.i.i107, align 4, !tbaa !19
  ...
  %53 = load float, ptr %arrayidx10.i30.i.i112, align 4, !tbaa !19
  %arrayidx.i32.i.i113 = getelementptr inbounds %class.btCollisionObject, ptr %37, i64 0, i32 1, i32 1, i32 0, i64 2
  %54 = load float, ptr %arrayidx.i32.i.i113, align 4, !tbaa !19
...
for.body:                                         ; preds = %if.then, %if.end47
  ...
  %78 = load float, ptr %m_origin.i.i, align 4, !tbaa !19
  %79 = load float, ptr %arrayidx.i25.i.i, align 4, !tbaa !19
  ...
  %84 = load float, ptr %m_origin.i.i101, align 4, !tbaa !19
  %85 = load float, ptr %arrayidx.i25.i.i107, align 4, !tbaa !19
...
if.end47:                                         ; preds = %if.else, %if.then41, %if.then35
  ...
  %170 = load float, ptr %m_invInertiaTensorWorld.i, align 4, !tbaa !19
  %171 = load float, ptr %arrayidx5.i.i240, align 4, !tbaa !19
  %172 = load float, ptr %arrayidx10.i.i, align 4, !tbaa !19
  %173 = load float, ptr %arrayidx.i.i, align 4, !tbaa !19
  %174 = load float, ptr %arrayidx5.i12.i, align 4, !tbaa !19
  %175 = load float, ptr %arrayidx10.i15.i, align 4, !tbaa !19
  %176 = load float, ptr %arrayidx.i17.i, align 4, !tbaa !19
  %177 = load float, ptr %arrayidx5.i18.i, align 4, !tbaa !19
  %mul8.i20.i = fmul float %158, %177
  %178 = tail call float @llvm.fmuladd.f32(float %176, float %155, float %mul8.i20.i)
  %179 = load float, ptr %arrayidx10.i21.i, align 4, !tbaa !19
  ...
  %187 = load <2 x float>, ptr %bodyA, align 8, !tbaa !19
  %188 = fadd <2 x float> %186, %187
  store <2 x float> %188, ptr %bodyA, align 8, !tbaa !19
  %189 = load float, ptr %arrayidx12.i.i252, align 8, !tbaa !19
  %add13.i.i = fadd float %mul8.i.i249, %189
  store float %add13.i.i, ptr %arrayidx12.i.i252, align 8, !tbaa !19
  %190 = load float, ptr %arrayidx7.i.i.i253, align 8, !tbaa !19
  ...
  %213 = load float, ptr %m_invInertiaTensorWorld.i270, align 4, !tbaa !19
  %214 = load float, ptr %arrayidx5.i.i271, align 4, !tbaa !19
  %215 = load float, ptr %arrayidx10.i.i274, align 4, !tbaa !19
  %216 = load float, ptr %arrayidx.i.i276, align 4, !tbaa !19
  %217 = load float, ptr %arrayidx5.i12.i277, align 4, !tbaa !19
  %218 = load float, ptr %arrayidx10.i15.i279, align 4, !tbaa !19
  %219 = load float, ptr %arrayidx.i17.i280, align 4, !tbaa !19
  %220 = load float, ptr %arrayidx5.i18.i281, align 4, !tbaa !19
  %mul8.i20.i282 = fmul float %166, %220
  %221 = tail call float @llvm.fmuladd.f32(float %219, float %163, float %mul8.i20.i282)
  %222 = load float, ptr %arrayidx10.i21.i283, align 4, !tbaa !19
  ...
  %227 = load <2 x float>, ptr %bodyB, align 8, !tbaa !19
  %228 = fmul <2 x float> %185, %226
  %229 = fsub <2 x float> %227, %228
  store <2 x float> %229, ptr %bodyB, align 8, !tbaa !19
  %230 = load float, ptr %arrayidx12.i.i297, align 8, !tbaa !19
  ...
  %232 = load float, ptr %arrayidx7.i.i.i303, align 8, !tbaa !19
