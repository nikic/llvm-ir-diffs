; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/gim_box_set.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/gim_box_set.cpp"
...
entry:
  ...
  %cmp163 = icmp ult i32 %startIndex, %endIndex
...
for.body.prol:                                    ; preds = %for.body.lr.ph
  ...
  %6 = load <2 x float>, ptr %arrayidx5.i71.prol, align 4
  %7 = load <2 x float>, ptr %arrayidx7.i72.prol, align 4
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  ...
  %16 = load <2 x float>, ptr %arrayidx5.i71, align 4
  %17 = load <2 x float>, ptr %arrayidx7.i72, align 4
  ...
  %23 = load <2 x float>, ptr %arrayidx5.i71.1, align 4
  %24 = load <2 x float>, ptr %arrayidx7.i72.1, align 4
...
for.body21.lr.ph:                                 ; preds = %for.end
  %31 = load ptr, ptr %primitive_boxes, align 8
...
for.body21:                                       ; preds = %for.body21.lr.ph, %for.body21
  ...
  %34 = load float, ptr %m_max28, align 4
  ...
  %36 = load <2 x float>, ptr %arrayidx5.i81, align 4
  %37 = load <2 x float>, ptr %arrayidx7.i82, align 4
...
entry:
  ...
  %sub = sub i32 %endIndex, %startIndex
  %cmp77 = icmp ult i32 %startIndex, %endIndex
...
for.body.prol:                                    ; preds = %for.body.lr.ph
  ...
  %4 = load float, ptr %arrayidx.prol, align 4
  %arrayidx8.prol = getelementptr inbounds float, ptr %arrayidx.i.prol, i64 %idxprom
  %5 = load float, ptr %arrayidx8.prol, align 4
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  ...
  %13 = load float, ptr %arrayidx8.1, align 4
...
for.body12:                                       ; preds = %for.body12.lr.ph, %if.end
  ...
  %16 = load ptr, ptr %primitive_boxes, align 8
...
if.then:                                          ; preds = %for.body12
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %_e_tmp_.sroa.0.i.i, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx.i75, i64 16, i1 false)
  ...
  %19 = load i32, ptr %m_data3.i.i.i, align 4
  %arrayidx1.i.i = getelementptr inbounds %struct.GIM_AABB_DATA, ptr %16, i64 %conv2.i
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(36) %arrayidx.i75, ptr noundef nonnull align 4 dereferenceable(36) %arrayidx1.i.i, i64 36, i1 false)
  ...
  store i32 %19, ptr %_e_tmp_.sroa.5.0.arrayidx1.sroa_idx.i.i, align 4
...
if.then:                                          ; preds = %entry
  ...
  %2 = load ptr, ptr %primitive_boxes, align 8
  %arrayidx.i84 = getelementptr inbounds %struct.GIM_AABB_DATA, ptr %2, i64 %conv8
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(32) %arrayidx.i, ptr noundef nonnull align 4 dereferenceable(32) %arrayidx.i84, i64 32, i1 false)
  %3 = load ptr, ptr %primitive_boxes, align 8
  %m_data = getelementptr inbounds %struct.GIM_AABB_DATA, ptr %3, i64 %conv8, i32 1
  %4 = load i32, ptr %m_data, align 4
  %5 = load ptr, ptr %m_node_array, align 8
  %m_data19 = getelementptr inbounds %struct.GIM_BOX_TREE_NODE, ptr %5, i64 %conv, i32 4
  store i32 %4, ptr %m_data19, align 4
  br label %common.ret106

if.end:                                           ; preds = %entry
  %arrayidx4.i = getelementptr inbounds float, ptr %arrayidx.i, i64 1
  store <2 x float> <float 0x47EFFFFFE0000000, float 0x47EFFFFFE0000000>, ptr %arrayidx.i, align 4
  ...
  %cmp2498 = icmp ult i32 %startIndex, %endIndex
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  store float %cond.i, ptr %arrayidx.i, align 4
  ...
  store float %cond30.i, ptr %arrayidx4.i, align 4
  %arrayidx39.i = getelementptr inbounds float, ptr %arrayidx.i90, i64 2
  %16 = load float, ptr %arrayidx39.i, align 4
  ...
  %18 = load float, ptr %arrayidx78.i, align 4
  ...
  store float %cond89.i, ptr %arrayidx12.i, align 4
...
for.body.lr.ph.i:                                 ; preds = %for.end
  %20 = load ptr, ptr %primitive_boxes, align 8
...
for.body.i.prol:                                  ; preds = %for.body.lr.ph.i
  ...
  %24 = load float, ptr %arrayidx.i93.prol, align 4
  %arrayidx8.i.prol = getelementptr inbounds float, ptr %arrayidx.i.i.prol, i64 %idxprom.i
  %25 = load float, ptr %arrayidx8.i.prol, align 4
...
for.body.i:                                       ; preds = %for.body.i.prol.loopexit, %for.body.i
  ...
  %29 = load float, ptr %arrayidx.i93, align 4
  %arrayidx8.i = getelementptr inbounds float, ptr %arrayidx.i.i, i64 %idxprom.i
  %30 = load float, ptr %arrayidx8.i, align 4
  ...
  %32 = load float, ptr %arrayidx.i93.1, align 4
  %arrayidx8.i.1 = getelementptr inbounds float, ptr %arrayidx.i.i.1, i64 %idxprom.i
  %33 = load float, ptr %arrayidx8.i.1, align 4
...
for.body12.i:                                     ; preds = %if.end.i, %for.body12.lr.ph.i
  ...
  %36 = load float, ptr %arrayidx19.i94, align 4
  %arrayidx26.i = getelementptr inbounds float, ptr %arrayidx.i75.i, i64 %idxprom.i
  %37 = load float, ptr %arrayidx26.i, align 4
...
if.then.i:                                        ; preds = %for.body12.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %_e_tmp_.sroa.0.i.i.i, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx.i75.i, i64 16, i1 false)
  ...
  %38 = load i32, ptr %m_data3.i.i.i.i, align 4
  %arrayidx1.i.i.i = getelementptr inbounds %struct.GIM_AABB_DATA, ptr %35, i64 %conv2.i.i
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(36) %arrayidx.i75.i, ptr noundef nonnull align 4 dereferenceable(36) %arrayidx1.i.i.i, i64 36, i1 false)
  ...
  store i32 %38, ptr %_e_tmp_.sroa.5.0.arrayidx1.sroa_idx.i.i.i, align 4
...
_ZN12GIM_BOX_TREE30_sort_and_calc_splitting_indexER9gim_arrayI13GIM_AABB_DATAEjjj.exit.loopexit: ; preds = %if.end.i
  %.pre102 = load i32, ptr %this, align 8
  %.pre103 = load ptr, ptr %m_node_array, align 8
  br label %_ZN12GIM_BOX_TREE30_sort_and_calc_splitting_indexER9gim_arrayI13GIM_AABB_DATAEjjj.exit
...
_ZN12GIM_BOX_TREE30_sort_and_calc_splitting_indexER9gim_arrayI13GIM_AABB_DATAEjjj.exit: ; preds = %for.end.thread, %_ZN12GIM_BOX_TREE30_sort_and_calc_splitting_indexER9gim_arrayI13GIM_AABB_DATAEjjj.exit.loopexit, %for.end
  ...
  store i32 %41, ptr %m_left39, align 4
  ...
  %sub46 = sub i32 %46, %0
  %47 = load ptr, ptr %m_node_array, align 8
...
entry:
  ...
  %1 = load i32, ptr %m_size.i5, align 8
...
_ZN9gim_arrayI17GIM_BOX_TREE_NODEE10resizeDataEj.exit.i.i: ; preds = %if.else.i.i.i, %if.then3.i.i.i
  ...
  %.pre = load i32, ptr %m_size.i5, align 8
...
_ZN9gim_arrayI17GIM_BOX_TREE_NODEE7reserveEj.exit.i: ; preds = %_ZN9gim_arrayI17GIM_BOX_TREE_NODEE10resizeDataEj.exit.i.i, %if.then.i
  ...
  %obj.i.32.obj.i.32.obj.i.32.obj.32.obj.32.m_left.i.sroa_idx = getelementptr inbounds i8, ptr %obj.i, i64 32
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %obj.i.32.obj.i.32.obj.i.32.obj.32.obj.32.m_left.i.sroa_idx, i8 0, i64 16, i1 false)
...
while.body.i:                                     ; preds = %_ZN9gim_arrayI17GIM_BOX_TREE_NODEE7reserveEj.exit.i, %while.body.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(48) %arrayidx.i, ptr noundef nonnull align 4 dereferenceable(48) %obj.i, i64 48, i1 false)
  %7 = load i32, ptr %m_size.i5, align 8
  %inc.i = add i32 %7, 1
  store i32 %inc.i, ptr %m_size.i5, align 8
...
while.end.i:                                      ; preds = %while.body.i, %_ZN9gim_arrayI17GIM_BOX_TREE_NODEE7reserveEj.exit.i
  ...
  %.pre7 = load i32, ptr %m_size.i, align 8
