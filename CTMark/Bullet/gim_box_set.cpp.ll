...
for.body.prol:                                    ; preds = %for.body.lr.ph
  ...
  %3 = load float, ptr %m_max.prol, align 4, !tbaa !11
  %4 = load float, ptr %arrayidx.i.prol, align 4, !tbaa !11
  ...
  %5 = load <2 x float>, ptr %arrayidx5.i71.prol, align 4, !tbaa !11
  %6 = load <2 x float>, ptr %arrayidx7.i72.prol, align 4, !tbaa !11
...
for.body.prol.loopexit:                           ; preds = %for.body.prol, %for.body.lr.ph
  ...
  %.lcssa193.unr = phi <2 x float> [ undef, %for.body.lr.ph ], [ %9, %for.body.prol ]
...
for.body.prol:                                    ; preds = %for.body.lr.ph
  ...
  %3 = load float, ptr %arrayidx.prol, align 4, !tbaa !11
  %arrayidx8.prol = getelementptr inbounds float, ptr %arrayidx.i.prol, i64 %idxprom
  %4 = load float, ptr %arrayidx8.prol, align 4, !tbaa !11
  %add.prol = fadd float %3, %4
  %5 = tail call float @llvm.fmuladd.f32(float %add.prol, float 5.000000e-01, float 0.000000e+00)
  %indvars.iv.next.prol = add nuw nsw i64 %1, 1
  br label %for.body.prol.loopexit

for.body.prol.loopexit:                           ; preds = %for.body.prol, %for.body.lr.ph
  %.lcssa.unr = phi float [ undef, %for.body.lr.ph ], [ %5, %for.body.prol ]
  %indvars.iv.unr = phi i64 [ %1, %for.body.lr.ph ], [ %indvars.iv.next.prol, %for.body.prol ]
  %splitValue.078.unr = phi float [ 0.000000e+00, %for.body.lr.ph ], [ %5, %for.body.prol ]
...
if.then:                                          ; preds = %for.body12
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %_e_tmp_.sroa.0.16.m_max.i.i.sroa_idx.i.i, ptr noundef nonnull align 4 dereferenceable(16) %m_max16, i64 16, i1 false), !tbaa.struct !13
...
for.body.i.prol:                                  ; preds = %for.body.lr.ph.i
  ...
  %23 = load float, ptr %arrayidx.i93.prol, align 4, !tbaa !11
  %arrayidx8.i.prol = getelementptr inbounds float, ptr %arrayidx.i.i.prol, i64 %idxprom.i
  %24 = load float, ptr %arrayidx8.i.prol, align 4, !tbaa !11
  %add.i.prol = fadd float %23, %24
  %25 = tail call float @llvm.fmuladd.f32(float %add.i.prol, float 5.000000e-01, float 0.000000e+00)
...
for.body.i.prol.loopexit:                         ; preds = %for.body.i.prol, %for.body.lr.ph.i
  %.lcssa.unr = phi float [ undef, %for.body.lr.ph.i ], [ %25, %for.body.i.prol ]
  %indvars.iv.i.unr = phi i64 [ %21, %for.body.lr.ph.i ], [ %indvars.iv.next.i.prol, %for.body.i.prol ]
  %splitValue.078.i.unr = phi float [ 0.000000e+00, %for.body.lr.ph.i ], [ %25, %for.body.i.prol ]
...
if.then.i:                                        ; preds = %for.body12.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %_e_tmp_.sroa.0.16.m_max.i.i.sroa_idx.i.i.i, ptr noundef nonnull align 4 dereferenceable(16) %m_max16.i, i64 16, i1 false), !tbaa.struct !13
...
while.end.i:                                      ; preds = %while.body.i, %_ZN9gim_arrayI17GIM_BOX_TREE_NODEE7reserveEj.exit.i
  ...
  %.pre7 = load i32, ptr %m_size.i, align 8, !tbaa !32
