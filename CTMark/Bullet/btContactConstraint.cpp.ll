; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btContactConstraint.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btContactConstraint.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [9 x ptr] }, ptr @_ZTV19btContactConstraint, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local void @_ZN19btContactConstraint8getInfo1EPN17btTypedConstraint17btConstraintInfo1E(ptr nocapture nonnull readnone align 8 %this, ptr nocapture readnone %info) unnamed_addr #3 align 2 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local void @_ZN19btContactConstraint8getInfo2EPN17btTypedConstraint17btConstraintInfo2E(ptr nocapture nonnull readnone align 8 %this, ptr nocapture readnone %info) unnamed_addr #3 align 2 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local void @_ZN19btContactConstraint13buildJacobianEv(ptr nocapture nonnull readnone align 8 %this) unnamed_addr #3 align 2 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local void @_ZN19btContactConstraint23solveConstraintObsoleteER12btSolverBodyS1_f(ptr nocapture nonnull readnone align 8 %this, ptr nocapture nonnull readnone align 8 %bodyA, ptr nocapture nonnull readnone align 8 %bodyB, float %timeStep) unnamed_addr #3 align 2 {
entry:
  ret void
}
...
if.end:                                           ; preds = %entry
  ...
  %24 = load <4 x float>, ptr %arrayidx5.i.i72, align 8
  %25 = shufflevector <4 x float> %24, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %26 = load <4 x float>, ptr %m_angularVelocity.i, align 8
  %27 = shufflevector <4 x float> %26, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %28 = load <4 x float>, ptr %m_linearVelocity.i, align 8
  ...
  %30 = load <4 x float>, ptr %arrayidx5.i5.i, align 4
  ...
  %32 = load <4 x float>, ptr %arrayidx11.i.i, align 8
  ...
  %34 = load float, ptr %arrayidx.i.i75, align 4
  %arrayidx5.i.i77 = getelementptr inbounds %class.btRigidBody, ptr %body2, i64 0, i32 3, i32 0, i64 2
  %35 = load float, ptr %arrayidx5.i.i77, align 8
  %36 = load float, ptr %m_angularVelocity.i74, align 8
  %37 = load float, ptr %m_linearVelocity.i73, align 8
  %arrayidx5.i5.i83 = getelementptr inbounds %class.btRigidBody, ptr %body2, i64 0, i32 2, i32 0, i64 1
  %38 = load float, ptr %arrayidx5.i5.i83, align 4
  %arrayidx11.i.i85 = getelementptr inbounds %class.btRigidBody, ptr %body2, i64 0, i32 2, i32 0, i64 2
  %39 = load float, ptr %arrayidx11.i.i85, align 8
  %40 = insertelement <2 x float> %6, float %16, i64 1
  %41 = insertelement <2 x float> %8, float %17, i64 1
  %42 = fsub <2 x float> %40, %41
  %43 = insertelement <2 x float> %9, float %18, i64 1
  %44 = insertelement <2 x float> %11, float %19, i64 1
  %45 = fsub <2 x float> %43, %44
  %46 = insertelement <2 x float> %23, float %34, i64 1
  %47 = fneg <2 x float> %46
  %48 = fmul <2 x float> %42, %47
  %49 = insertelement <2 x float> %27, float %36, i64 1
  %50 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %49, <2 x float> %45, <2 x float> %48)
  %51 = insertelement <2 x float> %13, float %20, i64 1
  %52 = insertelement <2 x float> %15, float %21, i64 1
  %53 = fsub <2 x float> %51, %52
  %54 = insertelement <2 x float> %25, float %35, i64 1
  %55 = fneg <2 x float> %54
  %56 = fmul <2 x float> %45, %55
  %57 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %46, <2 x float> %53, <2 x float> %56)
  %58 = insertelement <2 x float> %29, float %37, i64 1
  %59 = fadd <2 x float> %57, %58
  %60 = fneg <2 x float> %49
  %61 = fmul <2 x float> %53, %60
  %62 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %54, <2 x float> %42, <2 x float> %61)
  %63 = insertelement <2 x float> %31, float %38, i64 1
  %64 = fadd <2 x float> %63, %62
  %65 = insertelement <2 x float> %33, float %39, i64 1
  %66 = fadd <2 x float> %50, %65
  %shift = shufflevector <2 x float> %59, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %67 = fsub <2 x float> %59, %shift
  %sub.i92 = extractelement <2 x float> %67, i64 0
  %shift240 = shufflevector <2 x float> %64, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %68 = fsub <2 x float> %64, %shift240
  ...
  %70 = load float, ptr %m_worldTransform.i, align 8
  %71 = load float, ptr %arrayidx3.i, align 8
  %72 = load float, ptr %arrayidx6.i, align 8
  %73 = load float, ptr %arrayidx.i.i104, align 4
  %74 = load float, ptr %arrayidx.i26.i, align 4
  %75 = load float, ptr %arrayidx.i27.i, align 4
  %76 = load float, ptr %arrayidx.i28.i, align 8
  %77 = load float, ptr %arrayidx.i29.i, align 8
  %78 = load float, ptr %arrayidx.i30.i, align 8
  ...
  %79 = load float, ptr %m_worldTransform.i105, align 8
  %80 = load float, ptr %arrayidx3.i106, align 8
  %81 = load float, ptr %arrayidx6.i107, align 8
  %82 = load float, ptr %arrayidx.i.i108, align 4
  %83 = load float, ptr %arrayidx.i26.i109, align 4
  %84 = load float, ptr %arrayidx.i27.i110, align 4
  %85 = load float, ptr %arrayidx.i28.i111, align 8
  %86 = load float, ptr %arrayidx.i29.i112, align 8
  %87 = load float, ptr %arrayidx.i30.i113, align 8
  ...
  %88 = load float, ptr %m_inverseMass.i, align 8
  ...
  %89 = load float, ptr %m_inverseMass.i126, align 8
  %90 = extractelement <2 x float> %53, i64 0
  %91 = fneg float %90
  %neg.i.i131 = fmul float %1, %91
  %92 = extractelement <2 x float> %45, i64 0
  %93 = tail call float @llvm.fmuladd.f32(float %92, float %3, float %neg.i.i131)
  %94 = extractelement <2 x float> %42, i64 0
  %95 = fneg float %94
  %neg19.i.i132 = fmul float %3, %95
  %96 = tail call float @llvm.fmuladd.f32(float %90, float %0, float %neg19.i.i132)
  %97 = fneg float %92
  %neg30.i.i133 = fmul float %0, %97
  %98 = tail call float @llvm.fmuladd.f32(float %94, float %1, float %neg30.i.i133)
  %mul8.i.i.i = fmul float %96, %71
  ...
  %105 = extractelement <2 x float> %53, i64 1
  %neg.i52.i = fmul float %1, %105
  %106 = extractelement <2 x float> %45, i64 1
  %107 = tail call float @llvm.fmuladd.f32(float %106, float %fneg8.i.i, float %neg.i52.i)
  %108 = extractelement <2 x float> %42, i64 1
  %neg19.i53.i = fmul float %3, %108
  ...
  %mul8.i.i62.i = fmul float %109, %80
  ...
  %mul8.i14.i67.i = fmul float %109, %83
  ...
  %mul8.i20.i71.i = fmul float %109, %86
  ...
  %117 = load float, ptr %m_invInertiaLocal.i, align 4
  %mul.i.i = fmul float %100, %117
  %arrayidx5.i78.i = getelementptr inbounds %class.btRigidBody, ptr %body1, i64 0, i32 9, i32 0, i64 1
  %118 = load float, ptr %arrayidx5.i78.i, align 8
  %mul8.i.i135 = fmul float %102, %118
  %arrayidx11.i.i136 = getelementptr inbounds %class.btRigidBody, ptr %body1, i64 0, i32 9, i32 0, i64 2
  %119 = load float, ptr %arrayidx11.i.i136, align 4
  %mul14.i.i = fmul float %104, %119
  %120 = load float, ptr %m_invInertiaLocal.i125, align 4
  %mul.i85.i = fmul float %112, %120
  %arrayidx5.i86.i = getelementptr inbounds %class.btRigidBody, ptr %body2, i64 0, i32 9, i32 0, i64 1
  %121 = load float, ptr %arrayidx5.i86.i, align 8
  %mul8.i88.i = fmul float %114, %121
  %arrayidx11.i89.i = getelementptr inbounds %class.btRigidBody, ptr %body2, i64 0, i32 9, i32 0, i64 2
  %122 = load float, ptr %arrayidx11.i89.i, align 4
  ...
  %add35.i = fadd float %add31.i, %126
...
attributes #7 = { mustprogress nofree nosync nounwind willreturn memory(argmem: readwrite) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
