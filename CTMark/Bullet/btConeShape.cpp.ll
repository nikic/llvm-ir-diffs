...
entry:
  ...
  %1 = load float, ptr %aabbMax, align 16, !tbaa !22
  %2 = load float, ptr %aabbMin, align 16, !tbaa !22
  %arrayidx5.i = getelementptr inbounds [4 x float], ptr %aabbMax, i64 0, i64 1
  %3 = load float, ptr %arrayidx5.i, align 4, !tbaa !22
  %arrayidx7.i = getelementptr inbounds [4 x float], ptr %aabbMin, i64 0, i64 1
  %4 = load float, ptr %arrayidx7.i, align 4, !tbaa !22
