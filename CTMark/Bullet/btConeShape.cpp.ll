; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btConeShape.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btConeShape.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [20 x ptr] }, ptr @_ZTV11btConeShape, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
entry:
  ...
  store ptr getelementptr inbounds ({ [20 x ptr] }, ptr @_ZTV12btConeShapeZ, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  store i32 0, ptr %m_coneIndices14.i.i, align 4
  store i32 2, ptr %arrayidx17.i.i, align 8
  store i32 1, ptr %arrayidx19.i.i, align 4
  ret void
}
...
entry:
  ...
  %m_sinAngle.i = getelementptr inbounds %class.btConeShape, ptr %this, i64 0, i32 1
  store float %div.i, ptr %m_sinAngle.i, align 8
  store ptr getelementptr inbounds ({ [20 x ptr] }, ptr @_ZTV12btConeShapeX, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  store i32 1, ptr %m_coneIndices14.i.i, align 4
  store i32 0, ptr %arrayidx17.i.i, align 8
  store i32 2, ptr %arrayidx19.i.i, align 4
  ret void
}
...
cleanup89:                                        ; preds = %if.then44, %if.else72, %if.then
  ...
  store float %mul66.sink, ptr %arrayidx71, align 4
...
_ZNK11btConeShape16coneLocalSupportERK9btVector3.exit: ; preds = %if.then.i, %if.then44.i, %if.else72.i
  ...
  store float %mul66.sink.i, ptr %arrayidx71.i, align 4
...
_ZNK11btConeShape16coneLocalSupportERK9btVector3.exit: ; preds = %if.then.i, %if.then44.i, %if.else72.i
  ...
  store <2 x float> %.fca.1.load.i, ptr %ref.tmp.sroa.4.0.arrayidx3.sroa_idx, align 4
...
if.then:                                          ; preds = %_ZNK11btConeShape16coneLocalSupportERK9btVector3.exit
  %vecnorm.sroa.13.0.copyload = load float, ptr %arrayidx10.i.i.i.i, align 4
...
entry:
  ...
  %call7 = call noundef float %9(ptr noundef nonnull align 8 dereferenceable(64) %this)
...
attributes #7 = { mustprogress nofree nosync nounwind willreturn memory(argmem: read) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #8 = { nofree nosync nounwind memory(argmem: readwrite) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #9 = { uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
