...
if.then:                                          ; preds = %land.lhs.true4
  ...
  %36 = load float, ptr %arrayidx10.i30.i, align 4, !tbaa !39
  ...
  %38 = load float, ptr %arrayidx.i32.i, align 4, !tbaa !39
  ...
  %40 = load float, ptr %m_worldTransform.i, align 4, !tbaa !39
  %41 = load float, ptr %arrayidx16, align 4, !tbaa !39
  %42 = load float, ptr %arrayidx5.i.i, align 4, !tbaa !39
  %arrayidx7.i.i108 = getelementptr inbounds %class.btVector3, ptr %triangle, i64 1, i32 0, i64 1
  %43 = load float, ptr %arrayidx7.i.i108, align 4, !tbaa !39
  %arrayidx12.i.i111 = getelementptr inbounds %class.btVector3, ptr %triangle, i64 1, i32 0, i64 2
  %44 = load float, ptr %arrayidx12.i.i111, align 4, !tbaa !39
  ...
  %65 = load float, ptr %m_worldTransform.i, align 4, !tbaa !39
  %66 = load float, ptr %arrayidx16, align 4, !tbaa !39
  %67 = load float, ptr %arrayidx5.i.i, align 4, !tbaa !39
  %68 = load float, ptr %arrayidx7.i.i108, align 4, !tbaa !39
  %69 = load float, ptr %arrayidx10.i.i, align 4, !tbaa !39
  %70 = load float, ptr %arrayidx12.i.i111, align 4, !tbaa !39
  %71 = load float, ptr %arrayidx.i.i, align 4, !tbaa !39
  %72 = load float, ptr %arrayidx5.i20.i, align 4, !tbaa !39
  %73 = load float, ptr %arrayidx10.i23.i, align 4, !tbaa !39
  ...
  %89 = load <2 x float>, ptr %m_origin.i, align 4, !tbaa !39
  %90 = fadd <2 x float> %88, %89
  %91 = load float, ptr %arrayidx.i26.i, align 4, !tbaa !39
  %92 = load float, ptr %arrayidx5.i27.i, align 4, !tbaa !39
  %mul8.i29.i146 = fmul float %68, %92
  %93 = call float @llvm.fmuladd.f32(float %91, float %66, float %mul8.i29.i146)
  %94 = load float, ptr %arrayidx10.i30.i, align 4, !tbaa !39
  %95 = call float @llvm.fmuladd.f32(float %94, float %70, float %93)
  %96 = load float, ptr %arrayidx.i32.i, align 4, !tbaa !39
  ...
  %98 = load float, ptr %m_worldTransform.i, align 4, !tbaa !39
  %99 = load float, ptr %arrayidx28, align 4, !tbaa !39
  %100 = load float, ptr %arrayidx5.i.i, align 4, !tbaa !39
  %arrayidx7.i.i156 = getelementptr inbounds %class.btVector3, ptr %triangle, i64 2, i32 0, i64 1
  %101 = load float, ptr %arrayidx7.i.i156, align 4, !tbaa !39
  %arrayidx12.i.i159 = getelementptr inbounds %class.btVector3, ptr %triangle, i64 2, i32 0, i64 2
  %102 = load float, ptr %arrayidx12.i.i159, align 4, !tbaa !39
  ...
  %123 = load float, ptr %m_worldTransform.i, align 4, !tbaa !39
  %124 = load float, ptr %arrayidx28, align 4, !tbaa !39
  %125 = load float, ptr %arrayidx5.i.i, align 4, !tbaa !39
  %126 = load float, ptr %arrayidx7.i.i156, align 4, !tbaa !39
  %127 = load float, ptr %arrayidx10.i.i, align 4, !tbaa !39
  %128 = load float, ptr %arrayidx12.i.i159, align 4, !tbaa !39
  %129 = load float, ptr %arrayidx.i.i, align 4, !tbaa !39
  %130 = load float, ptr %arrayidx5.i20.i, align 4, !tbaa !39
  %131 = load float, ptr %arrayidx10.i23.i, align 4, !tbaa !39
  ...
  %147 = load <2 x float>, ptr %m_origin.i, align 4, !tbaa !39
  %148 = fadd <2 x float> %146, %147
  %149 = load float, ptr %arrayidx.i26.i, align 4, !tbaa !39
  %150 = load float, ptr %arrayidx5.i27.i, align 4, !tbaa !39
  %mul8.i29.i194 = fmul float %126, %150
  %151 = call float @llvm.fmuladd.f32(float %149, float %124, float %mul8.i29.i194)
  %152 = load float, ptr %arrayidx10.i30.i, align 4, !tbaa !39
  %153 = call float @llvm.fmuladd.f32(float %152, float %128, float %151)
  %154 = load float, ptr %arrayidx.i32.i, align 4, !tbaa !39
  ...
  %156 = load float, ptr %m_worldTransform.i, align 4, !tbaa !39
  %157 = load float, ptr %triangle, align 4, !tbaa !39
  %158 = load float, ptr %arrayidx5.i.i, align 4, !tbaa !39
  %159 = load float, ptr %arrayidx7.i.i, align 4, !tbaa !39
  %160 = load float, ptr %arrayidx12.i.i, align 4, !tbaa !39
...
if.end:                                           ; preds = %entry
  ...
  %83 = load <2 x float>, ptr %m_interpolationWorldTransform.i, align 4, !tbaa !39, !noalias !90
  %84 = load <2 x float>, ptr %arrayidx4.i.i.i99, align 4, !tbaa !39, !noalias !90
  %85 = load <2 x float>, ptr %arrayidx9.i.i.i102, align 4, !tbaa !39, !noalias !90
...
if.then19:                                        ; preds = %if.end
  ...
  store <2 x float> %82, ptr %rayAabbMin, align 8, !tbaa.struct !46
...
if.then.i.i:                                      ; preds = %if.then19
  store float %126, ptr %rayAabbMin, align 8, !tbaa !39
...
if.then.i18.i:                                    ; preds = %_Z8btSetMinIfEvRT_RKS0_.exit.i
  ...
  store float %129, ptr %arrayidx5.i154, align 4, !tbaa !39
...
_Z8btSetMinIfEvRT_RKS0_.exit19.i:                 ; preds = %if.then.i18.i, %_Z8btSetMinIfEvRT_RKS0_.exit.i
  ...
  store <2 x float> %82, ptr %m_origin.i.i190, align 8, !tbaa.struct !46
  ...
  store float %93, ptr %convexToLocal.sroa.6.0.m_ccdSphereToTrans.i.sroa_idx, align 8, !tbaa.struct !65
  ...
  store float %98, ptr %convexToLocal.sroa.11.16.arrayidx8.i.i7.i.sroa_idx, align 8, !tbaa.struct !65
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i138231, ptr %convexToLocal.sroa.24.48.m_origin.i10.i.sroa_idx, align 8, !tbaa.struct !65
