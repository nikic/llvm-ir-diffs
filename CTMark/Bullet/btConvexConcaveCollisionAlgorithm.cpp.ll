; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btConvexConcaveCollisionAlgorithm.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btConvexConcaveCollisionAlgorithm.cpp"
...
entry:
  ...
  store ptr %cond.i, ptr %m_convexBody.i, align 8
  ...
  store ptr %cond7.i, ptr %m_triBody.i, align 8
...
invoke.cont11.i:                                  ; preds = %entry
  ...
  store ptr %call.i, ptr %m_manifoldPtr.i, align 8
...
entry:
  ...
  store ptr %cond, ptr %m_convexBody, align 8
  ...
  store ptr %cond7, ptr %m_triBody, align 8
...
entry:
  ...
  %0 = load ptr, ptr %m_dispatcher, align 8
  %m_triBody = getelementptr inbounds %class.btConvexTriangleCallback, ptr %this, i64 0, i32 2
  %1 = load ptr, ptr %m_triBody, align 8
  %m_dispatchInfoPtr = getelementptr inbounds %class.btConvexTriangleCallback, ptr %this, i64 0, i32 7
...
if.then:                                          ; preds = %land.lhs.true4
  ...
  %mul8.i29.i122 = fmul float %34, %43
  %59 = tail call float @llvm.fmuladd.f32(float %33, float %41, float %mul8.i29.i122)
  %60 = tail call float @llvm.fmuladd.f32(float %36, float %44, float %59)
  %add17.i125 = fadd float %38, %60
  ...
  %68 = load float, ptr %arrayidx7.i.i108, align 4
  %69 = load float, ptr %arrayidx10.i.i, align 4
  %70 = load float, ptr %arrayidx12.i.i111, align 4
  ...
  %mul8.i29.i146 = fmul float %68, %92
  %93 = call float @llvm.fmuladd.f32(float %91, float %66, float %mul8.i29.i146)
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i152, ptr %97, align 8
  ...
  %101 = load float, ptr %arrayidx7.i.i156, align 4
  %arrayidx12.i.i159 = getelementptr inbounds %class.btVector3, ptr %triangle, i64 2, i32 0, i64 2
  %102 = load float, ptr %arrayidx12.i.i159, align 4
  ...
  %mul8.i29.i170 = fmul float %92, %101
  %117 = call float @llvm.fmuladd.f32(float %91, float %99, float %mul8.i29.i170)
  %118 = call float @llvm.fmuladd.f32(float %94, float %102, float %117)
  %add17.i173 = fadd float %96, %118
  ...
  %126 = load float, ptr %arrayidx7.i.i156, align 4
  %127 = load float, ptr %arrayidx10.i.i, align 4
  %128 = load float, ptr %arrayidx12.i.i159, align 4
  ...
  %mul8.i29.i194 = fmul float %126, %150
  %151 = call float @llvm.fmuladd.f32(float %149, float %124, float %mul8.i29.i194)
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i200, ptr %155, align 8
  ...
  %mul8.i29.i218 = fmul float %150, %159
  %175 = call float @llvm.fmuladd.f32(float %149, float %157, float %mul8.i29.i218)
  %176 = call float @llvm.fmuladd.f32(float %152, float %160, float %175)
  %add17.i221 = fadd float %154, %176
...
if.then47:                                        ; preds = %if.end
  ...
  store ptr getelementptr inbounds ({ [28 x ptr] }, ptr @_ZTV15btTriangleShape, i64 0, inrange i32 0, i64 2), ptr %tm, align 8
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx4.i, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx49, i64 16, i1 false)
  %arrayidx6.i = getelementptr inbounds %class.btTriangleShape, ptr %tm, i64 0, i32 1, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx6.i, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx50, i64 16, i1 false)
  %m_collisionMarginTriangle = getelementptr inbounds %class.btConvexTriangleCallback, ptr %this, i64 0, i32 8
  %182 = load float, ptr %m_collisionMarginTriangle, align 8
  %m_collisionMargin.i = getelementptr inbounds %class.btConvexInternalShape, ptr %tm, i64 0, i32 3
  store float %182, ptr %m_collisionMargin.i, align 8
  %m_collisionShape.i227 = getelementptr inbounds %class.btCollisionObject, ptr %1, i64 0, i32 9
  %183 = load ptr, ptr %m_collisionShape.i227, align 8
  store ptr %tm, ptr %m_collisionShape.i227, align 8
  %184 = load ptr, ptr %m_convexBody, align 8
  %185 = load ptr, ptr %m_triBody, align 8
  %m_manifoldPtr = getelementptr inbounds %class.btConvexTriangleCallback, ptr %this, i64 0, i32 10
  %186 = load ptr, ptr %m_manifoldPtr, align 8
...
invoke.cont61:                                    ; preds = %if.then47
  ...
  %vtable63 = load ptr, ptr %188, align 8
...
invoke.cont65:                                    ; preds = %invoke.cont61
  %190 = load ptr, ptr %m_convexBody, align 8
  %191 = load ptr, ptr %m_triBody, align 8
  %192 = load ptr, ptr %m_dispatchInfoPtr, align 8
  %193 = load ptr, ptr %m_resultOut, align 8
  %vtable70 = load ptr, ptr %call62, align 8
...
invoke.cont72:                                    ; preds = %invoke.cont65
  %vtable73 = load ptr, ptr %call62, align 8
...
invoke.cont75:                                    ; preds = %invoke.cont72
  %vtable77 = load ptr, ptr %0, align 8
...
invoke.cont79:                                    ; preds = %invoke.cont75
  store ptr %183, ptr %m_collisionShape.i227, align 8
...
entry:
  ...
  %m_convexBody = getelementptr inbounds %class.btConvexTriangleCallback, ptr %this, i64 0, i32 1
  %7 = load ptr, ptr %m_convexBody, align 8
  ...
  %13 = load float, ptr %m_origin.i14, align 4
  ...
  %16 = load <2 x float>, ptr %m_worldTransform.i, align 4
  %17 = load <2 x float>, ptr %arrayidx3.i.i, align 4
  %18 = load <2 x float>, ptr %arrayidx6.i.i, align 4
  ...
  %61 = load <2 x float>, ptr %m_worldTransform.i12, align 4
  %62 = load <2 x float>, ptr %arrayidx4.i.i.i, align 4
  ...
  %67 = load <2 x float>, ptr %arrayidx9.i.i.i, align 4
  ...
  store float %32, ptr %ref.tmp.sroa.5.0.convexInTriangleSpace.sroa_idx, align 8
  %ref.tmp.sroa.6.0.convexInTriangleSpace.sroa_idx = getelementptr inbounds i8, ptr %convexInTriangleSpace, i64 12
  store float 0.000000e+00, ptr %ref.tmp.sroa.6.0.convexInTriangleSpace.sroa_idx, align 4
  ...
  store float %37, ptr %ref.tmp.sroa.10.16.arrayidx7.i.i18.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp.sroa.11.16.arrayidx7.i.i18.sroa_idx, align 4
  ...
  store float %12, ptr %ref.tmp.sroa.15.32.arrayidx11.i.i.sroa_idx, align 8
  ...
  store <2 x float> %47, ptr %m_origin3.i, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i31, ptr %ref.tmp.sroa.19.48.m_origin3.i.sroa_idx, align 8
  %m_collisionShape.i = getelementptr inbounds %class.btCollisionObject, ptr %7, i64 0, i32 9
  %79 = load ptr, ptr %m_collisionShape.i, align 8
...
if.then:                                          ; preds = %entry
  ...
  %5 = load ptr, ptr %m_collisionShape.i34, align 8
  %m_shapeType.i.i35 = getelementptr inbounds %class.btCollisionShape, ptr %5, i64 0, i32 1
  %6 = load i32, ptr %m_shapeType.i.i35, align 8
...
if.end.i:                                         ; preds = %if.then12
  ...
  %14 = load ptr, ptr %m_body0.i37, align 8
