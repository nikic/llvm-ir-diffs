; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btMultiSphereShape.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btMultiSphereShape.cpp"
...
invoke.cont3:
  ...
  store ptr getelementptr inbounds ({ [20 x ptr] }, ptr @_ZTV18btMultiSphereShape, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
for.body10.lr.ph.i:                               ; preds = %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i, %if.then3.i.i.i
  store i8 1, ptr %m_ownsMemory.i.i, align 8
  store ptr %call.i.i.i.i43, ptr %m_data.i.i, align 8
  store i32 %numSpheres, ptr %m_capacity.i.i, align 8
  %.pre = load i32, ptr %m_size.i.i40, align 4
...
invoke.cont7:                                     ; preds = %for.body10.lr.ph.i, %invoke.cont3
  ...
  %cmp4.i47 = icmp slt i32 %6, %numSpheres
  br i1 %cmp4.i47, label %if.then5.i48, label %invoke.cont11

if.then5.i48:                                     ; preds = %invoke.cont7
  %7 = load i32, ptr %m_capacity.i.i41, align 8
  %cmp.i.i50 = icmp slt i32 %7, %numSpheres
  br i1 %cmp.i.i50, label %if.then.i.i59, label %if.then5.i48.for.body10.lr.ph.i51_crit_edge

if.then5.i48.for.body10.lr.ph.i51_crit_edge:      ; preds = %if.then5.i48
  %.pre92 = load ptr, ptr %m_data.i.i39, align 8
  br label %for.body10.lr.ph.i51

if.then.i.i59:                                    ; preds = %if.then5.i48
  %tobool.not.i.i.i60 = icmp eq i32 %numSpheres, 0
  br i1 %tobool.not.i.i.i60, label %_ZN20btAlignedObjectArrayIfE8allocateEi.exit.i.i, label %if.then.i.i.i61

if.then.i.i.i61:                                  ; preds = %if.then.i.i59
  %conv.i.i.i.i62 = sext i32 %numSpheres to i64
  %mul.i.i.i.i63 = shl nsw i64 %conv.i.i.i.i62, 2
  %call.i.i.i.i83 = invoke noundef ptr @_Z22btAlignedAllocInternalmi(i64 noundef %mul.i.i.i.i63, i32 noundef 16)
          to label %call.i.i.i.i.noexc82 unwind label %lpad10

call.i.i.i.i.noexc82:                             ; preds = %if.then.i.i.i61
  %.pre.i64 = load i32, ptr %m_size.i.i40, align 4
  br label %_ZN20btAlignedObjectArrayIfE8allocateEi.exit.i.i

_ZN20btAlignedObjectArrayIfE8allocateEi.exit.i.i: ; preds = %call.i.i.i.i.noexc82, %if.then.i.i59
  %8 = phi i32 [ %.pre.i64, %call.i.i.i.i.noexc82 ], [ %6, %if.then.i.i59 ]
  %retval.0.i.i.i65 = phi ptr [ %call.i.i.i.i83, %call.i.i.i.i.noexc82 ], [ null, %if.then.i.i59 ]
  %cmp7.i.i.i66 = icmp sgt i32 %8, 0
  %9 = load ptr, ptr %m_data.i.i39, align 8
  br i1 %cmp7.i.i.i66, label %for.body.lr.ph.i.i.i74, label %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i

for.body.lr.ph.i.i.i74:                           ; preds = %_ZN20btAlignedObjectArrayIfE8allocateEi.exit.i.i
  %10 = ptrtoint ptr %9 to i64
  %retval.0.i.i.i6593 = ptrtoint ptr %retval.0.i.i.i65 to i64
  %wide.trip.count.i.i.i75 = zext i32 %8 to i64
  %min.iters.check = icmp ult i32 %8, 8
  %11 = sub i64 %retval.0.i.i.i6593, %10
  %diff.check = icmp ult i64 %11, 32
  %or.cond95 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond95, label %for.body.i.i.i76.preheader, label %vector.ph

vector.ph:                                        ; preds = %for.body.lr.ph.i.i.i74
  %n.vec = and i64 %wide.trip.count.i.i.i75, 4294967288
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %12 = getelementptr inbounds float, ptr %retval.0.i.i.i65, i64 %index
  %13 = getelementptr inbounds float, ptr %9, i64 %index
  %wide.load = load <4 x float>, ptr %13, align 4
  %14 = getelementptr inbounds float, ptr %13, i64 4
  %wide.load94 = load <4 x float>, ptr %14, align 4
  store <4 x float> %wide.load, ptr %12, align 4
  %15 = getelementptr inbounds float, ptr %12, i64 4
  store <4 x float> %wide.load94, ptr %15, align 4
  %index.next = add nuw i64 %index, 8
  %16 = icmp eq i64 %index.next, %n.vec
  br i1 %16, label %middle.block, label %vector.body

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.vec, %wide.trip.count.i.i.i75
  br i1 %cmp.n, label %if.then.i11.i.i, label %for.body.i.i.i76.preheader

for.body.i.i.i76.preheader:                       ; preds = %for.body.lr.ph.i.i.i74, %middle.block
  %indvars.iv.i.i.i77.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i74 ], [ %n.vec, %middle.block ]
  %17 = xor i64 %indvars.iv.i.i.i77.ph, -1
  %18 = add nsw i64 %17, %wide.trip.count.i.i.i75
  %xtraiter96 = and i64 %wide.trip.count.i.i.i75, 3
  %lcmp.mod97.not = icmp eq i64 %xtraiter96, 0
  br i1 %lcmp.mod97.not, label %for.body.i.i.i76.prol.loopexit, label %for.body.i.i.i76.prol

for.body.i.i.i76.prol:                            ; preds = %for.body.i.i.i76.preheader, %for.body.i.i.i76.prol
  %indvars.iv.i.i.i77.prol = phi i64 [ %indvars.iv.next.i.i.i80.prol, %for.body.i.i.i76.prol ], [ %indvars.iv.i.i.i77.ph, %for.body.i.i.i76.preheader ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body.i.i.i76.prol ], [ 0, %for.body.i.i.i76.preheader ]
  %arrayidx.i.i.i78.prol = getelementptr inbounds float, ptr %retval.0.i.i.i65, i64 %indvars.iv.i.i.i77.prol
  %arrayidx3.i.i.i79.prol = getelementptr inbounds float, ptr %9, i64 %indvars.iv.i.i.i77.prol
  %19 = load float, ptr %arrayidx3.i.i.i79.prol, align 4
  store float %19, ptr %arrayidx.i.i.i78.prol, align 4
  %indvars.iv.next.i.i.i80.prol = add nuw nsw i64 %indvars.iv.i.i.i77.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter96
  br i1 %prol.iter.cmp.not, label %for.body.i.i.i76.prol.loopexit, label %for.body.i.i.i76.prol

for.body.i.i.i76.prol.loopexit:                   ; preds = %for.body.i.i.i76.prol, %for.body.i.i.i76.preheader
  %indvars.iv.i.i.i77.unr = phi i64 [ %indvars.iv.i.i.i77.ph, %for.body.i.i.i76.preheader ], [ %indvars.iv.next.i.i.i80.prol, %for.body.i.i.i76.prol ]
  %20 = icmp ult i64 %18, 3
  br i1 %20, label %if.then.i11.i.i, label %for.body.i.i.i76

for.body.i.i.i76:                                 ; preds = %for.body.i.i.i76.prol.loopexit, %for.body.i.i.i76
  %indvars.iv.i.i.i77 = phi i64 [ %indvars.iv.next.i.i.i80.3, %for.body.i.i.i76 ], [ %indvars.iv.i.i.i77.unr, %for.body.i.i.i76.prol.loopexit ]
  %arrayidx.i.i.i78 = getelementptr inbounds float, ptr %retval.0.i.i.i65, i64 %indvars.iv.i.i.i77
  %arrayidx3.i.i.i79 = getelementptr inbounds float, ptr %9, i64 %indvars.iv.i.i.i77
  %21 = load float, ptr %arrayidx3.i.i.i79, align 4
  store float %21, ptr %arrayidx.i.i.i78, align 4
  %indvars.iv.next.i.i.i80 = add nuw nsw i64 %indvars.iv.i.i.i77, 1
  %arrayidx.i.i.i78.1 = getelementptr inbounds float, ptr %retval.0.i.i.i65, i64 %indvars.iv.next.i.i.i80
  %arrayidx3.i.i.i79.1 = getelementptr inbounds float, ptr %9, i64 %indvars.iv.next.i.i.i80
  %22 = load float, ptr %arrayidx3.i.i.i79.1, align 4
  store float %22, ptr %arrayidx.i.i.i78.1, align 4
  %indvars.iv.next.i.i.i80.1 = add nuw nsw i64 %indvars.iv.i.i.i77, 2
  %arrayidx.i.i.i78.2 = getelementptr inbounds float, ptr %retval.0.i.i.i65, i64 %indvars.iv.next.i.i.i80.1
  %arrayidx3.i.i.i79.2 = getelementptr inbounds float, ptr %9, i64 %indvars.iv.next.i.i.i80.1
  %23 = load float, ptr %arrayidx3.i.i.i79.2, align 4
  store float %23, ptr %arrayidx.i.i.i78.2, align 4
  %indvars.iv.next.i.i.i80.2 = add nuw nsw i64 %indvars.iv.i.i.i77, 3
  %arrayidx.i.i.i78.3 = getelementptr inbounds float, ptr %retval.0.i.i.i65, i64 %indvars.iv.next.i.i.i80.2
  %arrayidx3.i.i.i79.3 = getelementptr inbounds float, ptr %9, i64 %indvars.iv.next.i.i.i80.2
  %24 = load float, ptr %arrayidx3.i.i.i79.3, align 4
  store float %24, ptr %arrayidx.i.i.i78.3, align 4
  %indvars.iv.next.i.i.i80.3 = add nuw nsw i64 %indvars.iv.i.i.i77, 4
  %exitcond.not.i.i.i81.3 = icmp eq i64 %indvars.iv.next.i.i.i80.3, %wide.trip.count.i.i.i75
  br i1 %exitcond.not.i.i.i81.3, label %if.then.i11.i.i, label %for.body.i.i.i76
...
if.end.thread36.i:                                ; preds = %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i
  store i8 1, ptr %m_ownsMemory.i.i38, align 8
  store ptr %retval.0.i.i.i65, ptr %m_data.i.i39, align 8
  store i32 %numSpheres, ptr %m_capacity.i.i41, align 8
  br label %for.body10.lr.ph.i51

if.then.i11.i.i:                                  ; preds = %for.body.i.i.i76.prol.loopexit, %for.body.i.i.i76, %middle.block, %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i
  %25 = load i8, ptr %m_ownsMemory.i.i38, align 8
...
if.then3.i.i.i71:                                 ; preds = %if.then.i11.i.i
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %9)
          to label %if.end.i72 unwind label %lpad10

if.end.i72:                                       ; preds = %if.then3.i.i.i71, %if.then.i11.i.i
  store i8 1, ptr %m_ownsMemory.i.i38, align 8
  store ptr %retval.0.i.i.i65, ptr %m_data.i.i39, align 8
  store i32 %numSpheres, ptr %m_capacity.i.i41, align 8
  br label %for.body10.lr.ph.i51

for.body10.lr.ph.i51:                             ; preds = %if.then5.i48.for.body10.lr.ph.i51_crit_edge, %if.end.i72, %if.end.thread36.i
  %26 = phi ptr [ %.pre92, %if.then5.i48.for.body10.lr.ph.i51_crit_edge ], [ %retval.0.i.i.i65, %if.end.i72 ], [ %retval.0.i.i.i65, %if.end.thread36.i ]
  %27 = sext i32 %6 to i64
  %wide.trip.count.i53 = sext i32 %numSpheres to i64
  %28 = shl nsw i64 %27, 2
  %scevgep = getelementptr i8, ptr %26, i64 %28
  %29 = sub nsw i64 %wide.trip.count.i53, %27
  %30 = shl nsw i64 %29, 2
  tail call void @llvm.memset.p0.i64(ptr align 4 %scevgep, i8 0, i64 %30, i1 false)
  br label %invoke.cont11

invoke.cont11:                                    ; preds = %for.body10.lr.ph.i51, %invoke.cont7
  store i32 %numSpheres, ptr %m_size.i.i40, align 4
...
for.body.epil:                                    ; preds = %for.cond.cleanup.loopexit.unr-lcssa
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx.i.epil, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx.epil, i64 16, i1 false)
  %arrayidx16.epil = getelementptr inbounds float, ptr %radi, i64 %indvars.iv.unr
  %33 = load float, ptr %arrayidx16.epil, align 4
  %34 = load ptr, ptr %m_data.i.i39, align 8
  %arrayidx.i87.epil = getelementptr inbounds float, ptr %34, i64 %indvars.iv.unr
  store float %33, ptr %arrayidx.i87.epil, align 4
...
lpad10:                                           ; preds = %if.then3.i.i.i71, %if.then.i.i.i61
...
for.body:                                         ; preds = %for.body, %for.body.preheader.new
  ...
  %38 = load float, ptr %arrayidx16, align 4
  %39 = load ptr, ptr %m_data.i.i39, align 8
  %arrayidx.i87 = getelementptr inbounds float, ptr %39, i64 %indvars.iv
  store float %38, ptr %arrayidx.i87, align 4
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx.i.1, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx.1, i64 16, i1 false)
  %arrayidx16.1 = getelementptr inbounds float, ptr %radi, i64 %indvars.iv.next
  %41 = load float, ptr %arrayidx16.1, align 4
  %42 = load ptr, ptr %m_data.i.i39, align 8
  %arrayidx.i87.1 = getelementptr inbounds float, ptr %42, i64 %indvars.iv.next
  store float %41, ptr %arrayidx.i87.1, align 4
...
entry:
  ...
  %vec.sroa.17.0.copyload = load float, ptr %vec.sroa.17.0.vec0.sroa_idx, align 4
...
for.body.lr.ph:                                   ; preds = %if.end
  ...
  %10 = load ptr, ptr %m_data.i45, align 8
...
for.body8.lr.ph:                                  ; preds = %for.body
  %3 = load ptr, ptr %m_data.i41, align 8
...
for.cond.cleanup7:                                ; preds = %for.inc, %for.body
  ...
  br i1 %exitcond90.not, label %for.cond.cleanup, label %for.bodythread-pre-split
...
for.body8:                                        ; preds = %for.body8.lr.ph, %for.inc
  ...
  %16 = load <2 x float>, ptr %pos.082, align 4
...
if.then:                                          ; preds = %for.body8
  ...
  store <2 x float> %23, ptr %arrayidx28, align 4
  store <2 x float> %retval.sroa.3.12.vec.insert.i75, ptr %vtx.sroa.6.0.arrayidx28.sroa_idx, align 4
  br label %for.inc
...
entry:
  ...
  %localAabbMin.sroa.5.0.copyload = load float, ptr %localAabbMin.sroa.5.0.m_localAabbMin.i.sroa_idx, align 8
  ...
  %localAabbMax.sroa.5.0.copyload = load float, ptr %localAabbMax.sroa.5.0.m_localAabbMax.i.sroa_idx, align 8
  ...
  store float %mul23, ptr %arrayidx5.i43, align 4
  %arrayidx7.i44 = getelementptr inbounds [4 x float], ptr %inertia, i64 0, i64 3
  store float 0.000000e+00, ptr %arrayidx7.i44, align 4
  ret void
}
...
invoke.cont:                                      ; preds = %entry, %if.then3.i.i.i
  ...
  %2 = load ptr, ptr %m_data.i.i.i9, align 8
...
invoke.cont3:                                     ; preds = %invoke.cont, %if.then3.i.i.i14
  ...
  store i8 1, ptr %m_ownsMemory.i.i.i11, align 8
  store ptr null, ptr %m_data.i.i.i9, align 8
...
invoke.cont.i:                                    ; preds = %if.then3.i.i.i.i, %entry
  ...
  %2 = load ptr, ptr %m_data.i.i.i9.i, align 8
...
invoke.cont3.i:                                   ; preds = %if.then3.i.i.i14.i, %invoke.cont.i
  ...
  store i8 1, ptr %m_ownsMemory.i.i.i11.i, align 8
  store ptr null, ptr %m_data.i.i.i9.i, align 8
  store i32 0, ptr %m_size.i.i.i15.i, align 4
  %m_capacity.i.i.i16.i = getelementptr inbounds %class.btMultiSphereShape, ptr %this, i64 0, i32 2, i32 3
  store i32 0, ptr %m_capacity.i.i.i16.i, align 8
  invoke void @_ZN13btConvexShapeD2Ev(ptr noundef nonnull align 8 dereferenceable(97) %this)
          to label %invoke.cont unwind label %lpad
...
!41 = !{!42, !30, i64 56}
!42 = !{!"_ZTS21btConvexInternalShape", !43, i64 0, !44, i64 24, !44, i64 40, !30, i64 56, !30, i64 60}
