...
_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i: ; preds = %for.body.i.i.i.epil, %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa, %_ZN20btAlignedObjectArrayI9btVector3E8allocateEi.exit.i.i
  ...
  %5 = load i8, ptr %m_ownsMemory.i.i, align 8, !range !28
...
call.i.i.i.i.noexc82:                             ; preds = %if.then.i.i.i61
  %.pre.i64 = load i32, ptr %m_size.i.i40, align 4, !tbaa !22
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %13, align 4, !tbaa !29
  %14 = getelementptr inbounds float, ptr %13, i64 4
  %wide.load94 = load <4 x float>, ptr %14, align 4, !tbaa !29
  store <4 x float> %wide.load, ptr %12, align 4, !tbaa !29
  %15 = getelementptr inbounds float, ptr %12, i64 4
  store <4 x float> %wide.load94, ptr %15, align 4, !tbaa !29
  %index.next = add nuw i64 %index, 8
  %16 = icmp eq i64 %index.next, %n.vec
  br i1 %16, label %middle.block, label %vector.body, !llvm.loop !31
...
for.body.i.i.i76.prol:                            ; preds = %for.body.i.i.i76.preheader, %for.body.i.i.i76.prol
  ...
  %19 = load float, ptr %arrayidx3.i.i.i79.prol, align 4, !tbaa !29
  store float %19, ptr %arrayidx.i.i.i78.prol, align 4, !tbaa !29
  ...
  br i1 %prol.iter.cmp.not, label %for.body.i.i.i76.prol.loopexit, label %for.body.i.i.i76.prol, !llvm.loop !34
...
for.body.i.i.i76:                                 ; preds = %for.body.i.i.i76.prol.loopexit, %for.body.i.i.i76
  ...
  %21 = load float, ptr %arrayidx3.i.i.i79, align 4, !tbaa !29
  store float %21, ptr %arrayidx.i.i.i78, align 4, !tbaa !29
  ...
  %22 = load float, ptr %arrayidx3.i.i.i79.1, align 4, !tbaa !29
  store float %22, ptr %arrayidx.i.i.i78.1, align 4, !tbaa !29
  ...
  %23 = load float, ptr %arrayidx3.i.i.i79.2, align 4, !tbaa !29
  store float %23, ptr %arrayidx.i.i.i78.2, align 4, !tbaa !29
  ...
  %24 = load float, ptr %arrayidx3.i.i.i79.3, align 4, !tbaa !29
  store float %24, ptr %arrayidx.i.i.i78.3, align 4, !tbaa !29
  ...
  br i1 %exitcond.not.i.i.i81.3, label %if.then.i11.i.i, label %for.body.i.i.i76, !llvm.loop !36
...
if.end.thread36.i:                                ; preds = %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i
  store i8 1, ptr %m_ownsMemory.i.i38, align 8, !tbaa !18
  store ptr %retval.0.i.i.i65, ptr %m_data.i.i39, align 8, !tbaa !21
...
if.then.i11.i.i:                                  ; preds = %for.body.i.i.i76.prol.loopexit, %for.body.i.i.i76, %middle.block, %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i
  %25 = load i8, ptr %m_ownsMemory.i.i38, align 8, !tbaa !18, !range !28, !noundef !37
...
for.body10.lr.ph.i51:                             ; preds = %if.then5.i48.for.body10.lr.ph.i51_crit_edge, %if.end.i72, %if.end.thread36.i
  ...
  %30 = shl nsw i64 %29, 2
  tail call void @llvm.memset.p0.i64(ptr align 4 %scevgep, i8 0, i64 %30, i1 false), !tbaa !29
...
entry:
  ...
  store <2 x float> %14, ptr %inertia, align 4, !tbaa !29
  %arrayidx5.i43 = getelementptr inbounds [4 x float], ptr %inertia, i64 0, i64 2
  store float %mul23, ptr %arrayidx5.i43, align 4, !tbaa !29
  %arrayidx7.i44 = getelementptr inbounds [4 x float], ptr %inertia, i64 0, i64 3
  store float 0.000000e+00, ptr %arrayidx7.i44, align 4, !tbaa !29
  ret void
}
...
entry:
  ...
  %1 = load i8, ptr %m_ownsMemory.i.i.i.i, align 8, !range !28
...
invoke.cont.i:                                    ; preds = %if.then3.i.i.i.i, %entry
  ...
  %3 = load i8, ptr %m_ownsMemory.i.i.i11.i, align 8, !range !28
