...
entry:
  ...
  %3 = load <2 x float>, ptr %arrayidx5.i126, align 4, !tbaa !37
  %4 = load float, ptr %rayTo, align 4, !tbaa !37
  %sub.i137 = fsub float %4, %mul.i115
  %arrayidx5.i138 = getelementptr inbounds [4 x float], ptr %rayTo, i64 0, i64 1
  %5 = load <2 x float>, ptr %arrayidx5.i138, align 4, !tbaa !37
  ...
  %6 = load <2 x float>, ptr %arrayidx5.i, align 4, !tbaa !37
  %7 = load <2 x float>, ptr %arrayidx7.i, align 4, !tbaa !37
...
if.then:                                          ; preds = %entry
  %32 = load float, ptr %param, align 4, !tbaa !37
...
entry:
  ...
  %0 = load float, ptr %arrayidx3.i.i, align 4, !tbaa !37, !noalias !44
