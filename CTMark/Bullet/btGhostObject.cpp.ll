; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btGhostObject.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btGhostObject.cpp"
...
invoke.cont:
  ...
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV13btGhostObject, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  ...
  store i32 3, ptr %m_internalType, align 8
  ret void
}
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i.new
  ...
  %11 = load ptr, ptr %arrayidx3.i.i.i.1, align 8
  store ptr %11, ptr %arrayidx.i.i.i.1, align 8
  ...
  %13 = load ptr, ptr %arrayidx3.i.i.i.2, align 8
  store ptr %13, ptr %arrayidx.i.i.i.2, align 8
  ...
  %15 = load ptr, ptr %arrayidx3.i.i.i.3, align 8
  store ptr %15, ptr %arrayidx.i.i.i.3, align 8
...
for.body.i.i.i.epil:                              ; preds = %_ZNK20btAlignedObjectArrayIP17btCollisionObjectE4copyEiiPS1_.exit.i.i.loopexit.unr-lcssa, %for.body.i.i.i.epil
  ...
  %17 = load ptr, ptr %arrayidx3.i.i.i.epil, align 8
  store ptr %17, ptr %arrayidx.i.i.i.epil, align 8
...
entry:
  ...
  store i32 3, ptr %m_internalType.i, align 8
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV24btPairCachingGhostObject, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
_ZN20btAlignedObjectArrayIP17btCollisionObjectE9push_backERKS1_.exit: ; preds = %if.then, %if.then.i, %_ZN20btAlignedObjectArrayIP17btCollisionObjectE10deallocateEv.exit.i.i
  ...
  store ptr %1, ptr %arrayidx.i11, align 8
  %inc.i = add nsw i32 %21, 1
  store i32 %inc.i, ptr %m_size.i.i, align 4
  %m_hashPairCache = getelementptr inbounds %class.btPairCachingGhostObject, ptr %this, i64 0, i32 1
  %23 = load ptr, ptr %m_hashPairCache, align 8
...
if.then:                                          ; preds = %_ZNK20btAlignedObjectArrayIP17btCollisionObjectE16findLinearSearchERKS1_.exit
  ...
  store ptr %6, ptr %arrayidx.i21, align 8
  store i32 %sub, ptr %m_size.i.i, align 4
  %m_hashPairCache = getelementptr inbounds %class.btPairCachingGhostObject, ptr %this, i64 0, i32 1
...
entry:
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx7.i.i33, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx5.i.i32, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx11.i.i35, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx9.i.i34, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %m_origin3.i37, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i36, i64 16, i1 false)
  ...
  %0 = load <2 x float>, ptr %m_origin3.i37, align 4
  ...
  %3 = load float, ptr %arrayidx11.i.i40, align 4
  ...
  %10 = load float, ptr %arrayidx7.i15.i, align 8
  ...
  store float %sub.i.i45, ptr %R, align 4
...
if.then:                                          ; preds = %for.body
  ...
  %25 = load float, ptr %arrayidx11.i.i53, align 8
  %26 = load float, ptr %arrayidx13.i.i54, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i, ptr %arrayidx11.i.i53, align 8
  ...
  %30 = load float, ptr %arrayidx11.i10.i, align 8
  %31 = load float, ptr %arrayidx13.i11.i, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i15.i, ptr %arrayidx11.i10.i, align 8
...
entry:
  ...
  %3 = load <2 x float>, ptr %arrayidx5.i126, align 4
  %4 = load float, ptr %rayTo, align 4
  %sub.i137 = fsub float %4, %mul.i115
  %arrayidx5.i138 = getelementptr inbounds [4 x float], ptr %rayTo, i64 0, i64 1
  %5 = load <2 x float>, ptr %arrayidx5.i138, align 4
  ...
  %13 = shufflevector <2 x float> %5, <2 x float> %3, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %14 = fsub <4 x float> %13, %12
  %15 = shufflevector <2 x float> %9, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  ...
  %21 = or i32 %cond10.i, %or.i
  %or16.i = or i32 %21, %cond15.i
  %22 = extractelement <4 x i1> %17, i64 3
  %cond21.i = select i1 %22, i32 0, i32 4
  %23 = extractelement <4 x float> %14, i64 3
  %24 = extractelement <2 x float> %9, i64 1
  %cmp25.i = fcmp ule float %23, %24
  %cond26.i = select i1 %cmp25.i, i32 0, i32 32
  %25 = or i32 %cond21.i, %or16.i
  %or27.i = or i32 %25, %cond26.i
  %26 = extractelement <4 x i1> %17, i64 0
  %cond10.i159 = select i1 %26, i32 0, i32 2
  %27 = extractelement <4 x float> %14, i64 0
  %cmp14.i161 = fcmp ule float %27, %20
  %cond15.i162 = select i1 %cmp14.i161, i32 0, i32 16
  %28 = or i32 %cond10.i159, %or.i154
  %or16.i163 = or i32 %28, %cond15.i162
  %29 = extractelement <4 x i1> %17, i64 1
  %cond21.i168 = select i1 %29, i32 0, i32 4
  %30 = extractelement <4 x float> %14, i64 1
  %cmp25.i170 = fcmp ule float %30, %24
  %cond26.i171 = select i1 %cmp25.i170, i32 0, i32 32
  %31 = or i32 %cond21.i168, %or16.i163
  %or27.i172 = or i32 %31, %cond26.i171
  %and = and i32 %or27.i, %or27.i172
  %cmp = icmp eq i32 %and, 0
  br i1 %cmp, label %if.then, label %cleanup73

if.then:                                          ; preds = %entry
  %32 = load float, ptr %param, align 4
  %sub.i173 = fsub float %sub.i137, %sub.i125
  %sub8.i176 = fsub float %27, %19
  %sub14.i179 = fsub float %30, %23
  br i1 %cmp.i, label %if.then26, label %if.else

if.then26:                                        ; preds = %if.then
  %fneg = fneg float %sub.i125
  %33 = fsub float %fneg, %mul.i
  %div = fdiv float %33, %sub.i173
...
if.then44:                                        ; preds = %if.else
  ...
  %34 = fsub float %fneg49, %mul.i
  %div57 = fdiv float %34, %sub.i173
  %cmp.i191 = fcmp olt float %div57, %32
...
if.end59:                                         ; preds = %if.then.i, %if.then44, %if.then26, %if.then35, %if.else
  ...
  %lambda_exit.3 = phi float [ %32, %if.else ], [ %div57, %if.then.i ], [ %32, %if.then44 ], [ %32, %if.then26 ], [ %32, %if.then35 ]
...
if.then26.1:                                      ; preds = %if.end59
  ...
  %35 = fsub float %fneg.1, %20
  %div.1 = fdiv float %35, %sub8.i176
...
if.else.1:                                        ; preds = %if.end59
  br i1 %26, label %if.end59.1, label %if.then44.1

if.then44.1:                                      ; preds = %if.else.1
  %fneg49.1 = fneg float %19
  %36 = fsub float %fneg49.1, %20
  %div57.1 = fdiv float %36, %sub8.i176
...
if.end59.1:                                       ; preds = %if.then.i.1, %if.then44.1, %if.else.1, %if.then35.1, %if.then26.1
  ...
  br i1 %22, label %if.else.2, label %if.then26.2

if.then26.2:                                      ; preds = %if.end59.1
  %fneg.2 = fneg float %23
  %37 = fsub float %fneg.2, %24
  %div.2 = fdiv float %37, %sub14.i179
...
if.else.2:                                        ; preds = %if.end59.1
  br i1 %29, label %if.end59.2, label %if.then44.2

if.then44.2:                                      ; preds = %if.else.2
  %fneg49.2 = fneg float %23
  %38 = fsub float %fneg49.2, %24
  %div57.2 = fdiv float %38, %sub14.i179
...
if.then26.1221:                                   ; preds = %if.end59.2
  ...
  %39 = tail call float @llvm.fmuladd.f32(float %fneg.i, float -1.000000e+00, float %fneg.1217)
  %div.1219 = fdiv float %39, %sub.i173
...
if.then44.1230:                                   ; preds = %if.else.1225
  ...
  %40 = tail call float @llvm.fmuladd.f32(float %fneg.i, float -1.000000e+00, float %fneg49.1226)
  %div57.1228 = fdiv float %40, %sub.i173
...
if.then26.1.1:                                    ; preds = %if.end59.1235
  ...
  %41 = extractelement <4 x float> %16, i64 0
  %42 = tail call float @llvm.fmuladd.f32(float %41, float -1.000000e+00, float %fneg.1.1)
  %div.1.1 = fdiv float %42, %sub8.i176
...
if.then44.1.1:                                    ; preds = %if.else.1.1
  ...
  %43 = extractelement <4 x float> %16, i64 0
  %44 = tail call float @llvm.fmuladd.f32(float %43, float -1.000000e+00, float %fneg49.1.1)
  %div57.1.1 = fdiv float %44, %sub8.i176
...
if.end59.1.1:                                     ; preds = %if.then.i.1.1, %if.then44.1.1, %if.else.1.1, %if.then35.1.1, %if.then26.1.1
  ...
  br i1 %cmp25.i, label %if.else.2.1, label %if.then26.2.1

if.then26.2.1:                                    ; preds = %if.end59.1.1
  %fneg.2.1 = fneg float %23
  %45 = extractelement <4 x float> %16, i64 1
  %46 = tail call float @llvm.fmuladd.f32(float %45, float -1.000000e+00, float %fneg.2.1)
  %div.2.1 = fdiv float %46, %sub14.i179
...
if.else.2.1:                                      ; preds = %if.end59.1.1
  br i1 %cmp25.i170, label %if.end59.2.1, label %if.then44.2.1

if.then44.2.1:                                    ; preds = %if.else.2.1
  %fneg49.2.1 = fneg float %23
  %47 = extractelement <4 x float> %16, i64 1
  %48 = tail call float @llvm.fmuladd.f32(float %47, float -1.000000e+00, float %fneg49.2.1)
  %div57.2.1 = fdiv float %48, %sub14.i179
...
if.then64:                                        ; preds = %if.end59.2.1
  store float %lambda_enter.3.2.1, ptr %param, align 4
  store float %hitNormal.sroa.0.5, ptr %normal, align 4
  %hitNormal.sroa.13.0.normal.sroa_idx = getelementptr inbounds i8, ptr %normal, i64 4
  store float %hitNormal.sroa.13.5, ptr %hitNormal.sroa.13.0.normal.sroa_idx, align 4
  %hitNormal.sroa.22.0.normal.sroa_idx = getelementptr inbounds i8, ptr %normal, i64 8
  store float %hitNormal.sroa.22.5, ptr %hitNormal.sroa.22.0.normal.sroa_idx, align 4
  %hitNormal.sroa.31.0.normal.sroa_idx = getelementptr inbounds i8, ptr %normal, i64 12
  store float 0.000000e+00, ptr %hitNormal.sroa.31.0.normal.sroa_idx, align 4
  br label %cleanup73
...
entry:
  ...
  store float 1.000000e+00, ptr %arrayidx3.i6.i.i.i15, align 4
  ...
  store float 1.000000e+00, ptr %arrayidx5.i10.i.i.i17, align 4
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i19, ptr noundef nonnull align 4 dereferenceable(16) %rayToWorld, i64 16, i1 false)
  %m_size.i = getelementptr inbounds %class.btGhostObject, ptr %this, i64 0, i32 1, i32 2
...
attributes #6 = { inlinehint uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
