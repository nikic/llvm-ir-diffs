; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btConvexInternalShape.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btConvexInternalShape.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [20 x ptr] }, ptr @_ZTV21btConvexInternalShape, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
entry:
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i, ptr %ref.tmp.sroa.4.0.m_localScaling.sroa_idx, align 8
  ret void
}
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %19 = load float, ptr %arrayidx.i.i12.i, align 4
  %20 = load float, ptr %arrayidx.i14.i13.i, align 4
  %mul7.i15.i = fmul float %5, %20
  %21 = call float @llvm.fmuladd.f32(float %19, float %4, float %mul7.i15.i)
  %22 = load float, ptr %arrayidx.i16.i16.i, align 4
  ...
  %34 = load float, ptr %arrayidx.i14.i10.i, align 4
  %35 = load float, ptr %arrayidx.i14.i13.i, align 4
  %36 = shufflevector <2 x float> %25, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %37 = insertelement <2 x float> %30, float %34, i64 1
  %38 = fmul <2 x float> %36, %37
  %39 = insertelement <2 x float> %28, float %33, i64 1
  %40 = shufflevector <2 x float> %25, <2 x float> poison, <2 x i32> zeroinitializer
  %41 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %39, <2 x float> %40, <2 x float> %38)
  %42 = insertelement <2 x float> %32, float %35, i64 1
  %43 = shufflevector <2 x float> %26, <2 x float> poison, <2 x i32> zeroinitializer
  %44 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %42, <2 x float> %43, <2 x float> %41)
  %45 = load <2 x float>, ptr %m_origin.i, align 4
  %46 = fadd <2 x float> %45, %44
  %47 = load float, ptr %arrayidx9.i.i, align 4
  %48 = load float, ptr %arrayidx.i16.i.i, align 4
  ...
  %50 = load float, ptr %arrayidx.i16.i16.i, align 4
  %51 = call float @llvm.fmuladd.f32(float %50, float %sv.sroa.5.8.vec.extract, float %49)
  %52 = load float, ptr %arrayidx.i32.i, align 4
  ...
  %69 = load float, ptr %arrayidx.i.i12.i, align 4
  %70 = load float, ptr %arrayidx.i14.i13.i, align 4
  %mul7.i15.i68 = fmul float %55, %70
  %71 = call float @llvm.fmuladd.f32(float %69, float %54, float %mul7.i15.i68)
  %72 = load float, ptr %arrayidx.i16.i16.i, align 4
  ...
  %84 = load float, ptr %arrayidx.i14.i10.i, align 4
  %85 = load float, ptr %arrayidx.i14.i13.i, align 4
  %86 = insertelement <2 x float> %80, float %84, i64 1
  %87 = shufflevector <2 x float> %75, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %88 = fmul <2 x float> %86, %87
  %89 = insertelement <2 x float> %78, float %83, i64 1
  %90 = shufflevector <2 x float> %75, <2 x float> poison, <2 x i32> zeroinitializer
  %91 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %89, <2 x float> %90, <2 x float> %88)
  %92 = insertelement <2 x float> %82, float %85, i64 1
  ...
  %95 = load <2 x float>, ptr %m_origin.i, align 4
  %96 = fadd <2 x float> %95, %94
  %97 = load float, ptr %arrayidx9.i.i, align 4
  %98 = load float, ptr %arrayidx.i16.i.i, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i96, ptr %2, align 8
...
entry:
  ...
  store ptr getelementptr inbounds ({ [20 x ptr] }, ptr @_ZTV32btConvexInternalAabbCachingShape, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
entry:
  ...
  %11 = load <4 x float>, ptr %arrayidx.i43.i.i.i, align 4
  ...
  %18 = load float, ptr %arrayidx.i46.i.i.i, align 4
  ...
  %20 = load float, ptr %arrayidx.i47.i.i.i, align 4
  %21 = tail call float @llvm.fabs.f32(float %20)
  %m_origin.i.i.i = getelementptr inbounds %class.btTransform, ptr %trans, i64 0, i32 1
  %mul8.i29.i.i.i = fmul float %mul4.i.i50.i.i, %18
  %22 = tail call float @llvm.fmuladd.f32(float %16, float %mul.i.i48.i.i, float %mul8.i29.i.i.i)
  %23 = tail call float @llvm.fmuladd.f32(float %20, float %mul8.i.i52.i.i, float %22)
  %arrayidx.i32.i.i.i = getelementptr inbounds %class.btTransform, ptr %trans, i64 0, i32 1, i32 0, i64 2
  %24 = load float, ptr %arrayidx.i32.i.i.i, align 4
  %add17.i.i.i = fadd float %23, %24
  %mul8.i79.i.i = fmul float %add8.i.i.i, %19
  %25 = tail call float @llvm.fmuladd.f32(float %17, float %add.i.i.i, float %mul8.i79.i.i)
  %26 = tail call float @llvm.fmuladd.f32(float %21, float %add13.i.i.i, float %25)
  ...
  %38 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %27, <2 x float> %37, <2 x float> %35)
  ...
  %sub14.i91.i.i = fsub float %add17.i.i.i, %26
  ...
  %add14.i103.i.i = fadd float %26, %add17.i.i.i
...
entry:
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i, ptr %ref.tmp.sroa.4.0.m_localScaling.sroa_idx.i, align 8
...
init.end:                                         ; preds = %init, %init.check, %entry
  ...
  store float %sub.2, ptr %arrayidx80.2, align 8
