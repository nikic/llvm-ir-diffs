; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btStridingMeshInterface.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btStridingMeshInterface.cpp"
...
entry:
  ...
  %meshScaling.sroa.27.0.copyload = load float, ptr %meshScaling.sroa.27.0.m_scaling.i.sroa_idx, align 8
...
for.body8:                                        ; preds = %for.cond6.preheader, %for.body8
  ...
  %13 = load <2 x float>, ptr %add.ptr12, align 4
  %14 = fmul <2 x float> %1, %13
  store <2 x float> %14, ptr %triangle, align 16
  store float %mul24, ptr %arrayidx5.i401, align 8
  store float 0.000000e+00, ptr %arrayidx7.i402, align 4
  ...
  %17 = load <2 x float>, ptr %add.ptr28, align 4
  %18 = fmul <2 x float> %1, %17
  store <2 x float> %18, ptr %arrayidx238, align 16
  store float %mul41, ptr %arrayidx5.i406, align 8
  store float 0.000000e+00, ptr %arrayidx7.i407, align 4
  ...
  %20 = load float, ptr %arrayidx56, align 4
  %mul58 = fmul float %meshScaling.sroa.27.0.copyload, %20
  %21 = load <2 x float>, ptr %add.ptr45, align 4
  %22 = fmul <2 x float> %1, %21
  store <2 x float> %22, ptr %arrayidx259, align 16
  store float %mul58, ptr %arrayidx5.i411, align 8
  store float 0.000000e+00, ptr %arrayidx7.i412, align 4
...
for.body64:                                       ; preds = %for.cond62.preheader, %for.body64
  ...
  %30 = load float, ptr %arrayidx83, align 4
  %mul85 = fmul float %meshScaling.sroa.27.0.copyload, %30
  %31 = load <2 x float>, ptr %add.ptr72, align 4
  %32 = fmul <2 x float> %1, %31
  store <2 x float> %32, ptr %triangle, align 16
  store float %mul85, ptr %arrayidx5.i401, align 8
  store float 0.000000e+00, ptr %arrayidx7.i402, align 4
  ...
  %34 = load float, ptr %arrayidx101, align 4
  %mul103 = fmul float %meshScaling.sroa.27.0.copyload, %34
  %35 = load <2 x float>, ptr %add.ptr90, align 4
  %36 = fmul <2 x float> %1, %35
  store <2 x float> %36, ptr %arrayidx238, align 16
  store float %mul103, ptr %arrayidx5.i406, align 8
  store float 0.000000e+00, ptr %arrayidx7.i407, align 4
  ...
  %38 = load float, ptr %arrayidx119, align 4
  %mul121 = fmul float %meshScaling.sroa.27.0.copyload, %38
  %39 = load <2 x float>, ptr %add.ptr108, align 4
  %40 = fmul <2 x float> %1, %39
  store <2 x float> %40, ptr %arrayidx259, align 16
  store float %mul121, ptr %arrayidx5.i411, align 8
  store float 0.000000e+00, ptr %arrayidx7.i412, align 4
...
sw.bb128:                                         ; preds = %for.body
  %43 = load i32, ptr %gfxindextype, align 4
...
for.cond131.preheader:                            ; preds = %sw.bb128
  %45 = load i32, ptr %numtriangles, align 4
...
for.body133:                                      ; preds = %for.cond131.preheader, %for.body133
  ...
  %46 = load ptr, ptr %indexbase, align 8
  ...
  %48 = load ptr, ptr %vertexbase, align 8
  %49 = load i32, ptr %add.ptr137, align 4
  %50 = load i32, ptr %stride, align 4
  ...
  %61 = load double, ptr %arrayidx194, align 8
  %conv195 = fptrunc double %61 to float
  %mul197 = fmul float %meshScaling.sroa.27.0.copyload, %conv195
  %62 = load <2 x double>, ptr %add.ptr181, align 8
  %63 = fptrunc <2 x double> %62 to <2 x float>
  %64 = fmul <2 x float> %1, %63
  store <2 x float> %64, ptr %arrayidx259, align 16
  store float %mul197, ptr %arrayidx5.i411, align 8
  store float 0.000000e+00, ptr %arrayidx7.i412, align 4
  %vtable199 = load ptr, ptr %callback, align 8
...
for.body207:                                      ; preds = %for.cond205.preheader, %for.body207
  ...
  %67 = load ptr, ptr %indexbase, align 8
  %68 = load i32, ptr %indexstride, align 4
  ...
  %69 = load ptr, ptr %vertexbase, align 8
  %70 = load i16, ptr %add.ptr211, align 2
  %conv213 = zext i16 %70 to i32
  %71 = load i32, ptr %stride, align 4
  ...
  %82 = load double, ptr %arrayidx271, align 8
  %conv272 = fptrunc double %82 to float
  %mul274 = fmul float %meshScaling.sroa.27.0.copyload, %conv272
  %83 = load <2 x double>, ptr %add.ptr258, align 8
  %84 = fptrunc <2 x double> %83 to <2 x float>
  %85 = fmul <2 x float> %1, %84
  store <2 x float> %85, ptr %arrayidx259, align 16
  store float %mul274, ptr %arrayidx5.i411, align 8
  store float 0.000000e+00, ptr %arrayidx7.i412, align 4
  %vtable276 = load ptr, ptr %callback, align 8
  ...
  %87 = load i32, ptr %numtriangles, align 4
...
_ZN9btVector36setMinERKS_.exit:                   ; preds = %_Z8btSetMinIfEvRT_RKS0_.exit22.i, %if.then.i24.i
  ...
  br i1 %cmp.i.i16, label %if.then.i.i29, label %_Z8btSetMaxIfEvRT_RKS0_.exit.i

if.then.i.i29:                                    ; preds = %_ZN9btVector36setMinERKS_.exit
  store float %13, ptr %m_aabbMax, align 8
  br label %_Z8btSetMaxIfEvRT_RKS0_.exit.i

_Z8btSetMaxIfEvRT_RKS0_.exit.i:                   ; preds = %if.then.i.i29, %_ZN9btVector36setMinERKS_.exit
  %14 = phi float [ %13, %if.then.i.i29 ], [ %12, %_ZN9btVector36setMinERKS_.exit ]
  %arrayidx5.i17 = getelementptr inbounds %struct.AabbCalculationCallback, ptr %this, i64 0, i32 2, i32 0, i64 1
  %15 = load float, ptr %arrayidx5.i17, align 4
  %16 = load float, ptr %arrayidx7.i, align 4
  %cmp.i17.i19 = fcmp olt float %15, %16
  br i1 %cmp.i17.i19, label %if.then.i18.i28, label %_Z8btSetMaxIfEvRT_RKS0_.exit19.i

if.then.i18.i28:                                  ; preds = %_Z8btSetMaxIfEvRT_RKS0_.exit.i
  store float %16, ptr %arrayidx5.i17, align 4
  br label %_Z8btSetMaxIfEvRT_RKS0_.exit19.i

_Z8btSetMaxIfEvRT_RKS0_.exit19.i:                 ; preds = %if.then.i18.i28, %_Z8btSetMaxIfEvRT_RKS0_.exit.i
  %17 = phi float [ %16, %if.then.i18.i28 ], [ %15, %_Z8btSetMaxIfEvRT_RKS0_.exit.i ]
  %arrayidx9.i20 = getelementptr inbounds %struct.AabbCalculationCallback, ptr %this, i64 0, i32 2, i32 0, i64 2
  %18 = load float, ptr %arrayidx9.i20, align 8
  %19 = load float, ptr %arrayidx11.i, align 4
  %cmp.i20.i22 = fcmp olt float %18, %19
  br i1 %cmp.i20.i22, label %if.then.i21.i27, label %_Z8btSetMaxIfEvRT_RKS0_.exit22.i

if.then.i21.i27:                                  ; preds = %_Z8btSetMaxIfEvRT_RKS0_.exit19.i
  store float %19, ptr %arrayidx9.i20, align 8
  br label %_Z8btSetMaxIfEvRT_RKS0_.exit22.i

_Z8btSetMaxIfEvRT_RKS0_.exit22.i:                 ; preds = %if.then.i21.i27, %_Z8btSetMaxIfEvRT_RKS0_.exit19.i
  %20 = phi float [ %19, %if.then.i21.i27 ], [ %18, %_Z8btSetMaxIfEvRT_RKS0_.exit19.i ]
  %arrayidx13.i23 = getelementptr inbounds %struct.AabbCalculationCallback, ptr %this, i64 0, i32 2, i32 0, i64 3
  %21 = load float, ptr %arrayidx13.i23, align 4
  %22 = load float, ptr %arrayidx.i.i, align 4
  %cmp.i23.i25 = fcmp olt float %21, %22
  br i1 %cmp.i23.i25, label %if.then.i24.i26, label %_ZN9btVector36setMaxERKS_.exit

if.then.i24.i26:                                  ; preds = %_Z8btSetMaxIfEvRT_RKS0_.exit22.i
  store float %22, ptr %arrayidx13.i23, align 4
  br label %_ZN9btVector36setMaxERKS_.exit

_ZN9btVector36setMaxERKS_.exit:                   ; preds = %_Z8btSetMaxIfEvRT_RKS0_.exit22.i, %if.then.i24.i26
  %23 = phi float [ %21, %_Z8btSetMaxIfEvRT_RKS0_.exit22.i ], [ %22, %if.then.i24.i26 ]
  ...
  br i1 %cmp.i.i30, label %if.then.i.i46, label %_Z8btSetMinIfEvRT_RKS0_.exit.i31

if.then.i.i46:                                    ; preds = %_ZN9btVector36setMaxERKS_.exit
  store float %24, ptr %m_aabbMin, align 8
  br label %_Z8btSetMinIfEvRT_RKS0_.exit.i31

_Z8btSetMinIfEvRT_RKS0_.exit.i31:                 ; preds = %if.then.i.i46, %_ZN9btVector36setMaxERKS_.exit
  %25 = phi float [ %24, %if.then.i.i46 ], [ %2, %_ZN9btVector36setMaxERKS_.exit ]
  %arrayidx7.i33 = getelementptr inbounds %class.btVector3, ptr %triangle, i64 1, i32 0, i64 1
  %26 = load float, ptr %arrayidx7.i33, align 4
  %cmp.i17.i34 = fcmp olt float %26, %5
  br i1 %cmp.i17.i34, label %if.then.i18.i45, label %_Z8btSetMinIfEvRT_RKS0_.exit19.i35

if.then.i18.i45:                                  ; preds = %_Z8btSetMinIfEvRT_RKS0_.exit.i31
  store float %26, ptr %arrayidx5.i, align 4
  br label %_Z8btSetMinIfEvRT_RKS0_.exit19.i35

_Z8btSetMinIfEvRT_RKS0_.exit19.i35:               ; preds = %if.then.i18.i45, %_Z8btSetMinIfEvRT_RKS0_.exit.i31
  %27 = phi float [ %26, %if.then.i18.i45 ], [ %5, %_Z8btSetMinIfEvRT_RKS0_.exit.i31 ]
  %arrayidx11.i37 = getelementptr inbounds %class.btVector3, ptr %triangle, i64 1, i32 0, i64 2
  %28 = load float, ptr %arrayidx11.i37, align 4
  %cmp.i20.i38 = fcmp olt float %28, %8
  br i1 %cmp.i20.i38, label %if.then.i21.i44, label %_Z8btSetMinIfEvRT_RKS0_.exit22.i39

if.then.i21.i44:                                  ; preds = %_Z8btSetMinIfEvRT_RKS0_.exit19.i35
  store float %28, ptr %arrayidx9.i, align 8
  br label %_Z8btSetMinIfEvRT_RKS0_.exit22.i39

_Z8btSetMinIfEvRT_RKS0_.exit22.i39:               ; preds = %if.then.i21.i44, %_Z8btSetMinIfEvRT_RKS0_.exit19.i35
  %29 = phi float [ %28, %if.then.i21.i44 ], [ %8, %_Z8btSetMinIfEvRT_RKS0_.exit19.i35 ]
  %arrayidx.i.i41 = getelementptr inbounds %class.btVector3, ptr %triangle, i64 1, i32 0, i64 3
  %30 = load float, ptr %arrayidx.i.i41, align 4
  %cmp.i23.i42 = fcmp olt float %30, %11
  br i1 %cmp.i23.i42, label %if.then.i24.i43, label %_ZN9btVector36setMinERKS_.exit47

if.then.i24.i43:                                  ; preds = %_Z8btSetMinIfEvRT_RKS0_.exit22.i39
  store float %30, ptr %arrayidx13.i, align 4
  br label %_ZN9btVector36setMinERKS_.exit47

_ZN9btVector36setMinERKS_.exit47:                 ; preds = %_Z8btSetMinIfEvRT_RKS0_.exit22.i39, %if.then.i24.i43
  %31 = phi float [ %11, %_Z8btSetMinIfEvRT_RKS0_.exit22.i39 ], [ %30, %if.then.i24.i43 ]
  %32 = load float, ptr %arrayidx4, align 4
  %cmp.i.i48 = fcmp olt float %14, %32
  br i1 %cmp.i.i48, label %if.then.i.i64, label %_Z8btSetMaxIfEvRT_RKS0_.exit.i49

if.then.i.i64:                                    ; preds = %_ZN9btVector36setMinERKS_.exit47
  store float %32, ptr %m_aabbMax, align 8
  br label %_Z8btSetMaxIfEvRT_RKS0_.exit.i49

_Z8btSetMaxIfEvRT_RKS0_.exit.i49:                 ; preds = %if.then.i.i64, %_ZN9btVector36setMinERKS_.exit47
  %33 = phi float [ %32, %if.then.i.i64 ], [ %14, %_ZN9btVector36setMinERKS_.exit47 ]
  %34 = load float, ptr %arrayidx7.i33, align 4
  %cmp.i17.i52 = fcmp olt float %17, %34
  br i1 %cmp.i17.i52, label %if.then.i18.i63, label %_Z8btSetMaxIfEvRT_RKS0_.exit19.i53

if.then.i18.i63:                                  ; preds = %_Z8btSetMaxIfEvRT_RKS0_.exit.i49
  store float %34, ptr %arrayidx5.i17, align 4
  br label %_Z8btSetMaxIfEvRT_RKS0_.exit19.i53

_Z8btSetMaxIfEvRT_RKS0_.exit19.i53:               ; preds = %if.then.i18.i63, %_Z8btSetMaxIfEvRT_RKS0_.exit.i49
  %35 = phi float [ %34, %if.then.i18.i63 ], [ %17, %_Z8btSetMaxIfEvRT_RKS0_.exit.i49 ]
  %36 = load float, ptr %arrayidx11.i37, align 4
  %cmp.i20.i56 = fcmp olt float %20, %36
  br i1 %cmp.i20.i56, label %if.then.i21.i62, label %_Z8btSetMaxIfEvRT_RKS0_.exit22.i57

if.then.i21.i62:                                  ; preds = %_Z8btSetMaxIfEvRT_RKS0_.exit19.i53
  store float %36, ptr %arrayidx9.i20, align 8
  br label %_Z8btSetMaxIfEvRT_RKS0_.exit22.i57

_Z8btSetMaxIfEvRT_RKS0_.exit22.i57:               ; preds = %if.then.i21.i62, %_Z8btSetMaxIfEvRT_RKS0_.exit19.i53
  %37 = phi float [ %36, %if.then.i21.i62 ], [ %20, %_Z8btSetMaxIfEvRT_RKS0_.exit19.i53 ]
  %38 = load float, ptr %arrayidx.i.i41, align 4
  %cmp.i23.i60 = fcmp olt float %23, %38
  br i1 %cmp.i23.i60, label %if.then.i24.i61, label %_ZN9btVector36setMaxERKS_.exit65

if.then.i24.i61:                                  ; preds = %_Z8btSetMaxIfEvRT_RKS0_.exit22.i57
  store float %38, ptr %arrayidx13.i23, align 4
  br label %_ZN9btVector36setMaxERKS_.exit65

_ZN9btVector36setMaxERKS_.exit65:                 ; preds = %_Z8btSetMaxIfEvRT_RKS0_.exit22.i57, %if.then.i24.i61
  %39 = phi float [ %23, %_Z8btSetMaxIfEvRT_RKS0_.exit22.i57 ], [ %38, %if.then.i24.i61 ]
  ...
  br i1 %cmp.i.i66, label %if.then.i.i82, label %_Z8btSetMinIfEvRT_RKS0_.exit.i67

if.then.i.i82:                                    ; preds = %_ZN9btVector36setMaxERKS_.exit65
  store float %40, ptr %m_aabbMin, align 8
  br label %_Z8btSetMinIfEvRT_RKS0_.exit.i67

_Z8btSetMinIfEvRT_RKS0_.exit.i67:                 ; preds = %if.then.i.i82, %_ZN9btVector36setMaxERKS_.exit65
  %arrayidx7.i69 = getelementptr inbounds %class.btVector3, ptr %triangle, i64 2, i32 0, i64 1
  %41 = load float, ptr %arrayidx7.i69, align 4
  %cmp.i17.i70 = fcmp olt float %41, %27
  br i1 %cmp.i17.i70, label %if.then.i18.i81, label %_Z8btSetMinIfEvRT_RKS0_.exit19.i71

if.then.i18.i81:                                  ; preds = %_Z8btSetMinIfEvRT_RKS0_.exit.i67
  store float %41, ptr %arrayidx5.i, align 4
  br label %_Z8btSetMinIfEvRT_RKS0_.exit19.i71

_Z8btSetMinIfEvRT_RKS0_.exit19.i71:               ; preds = %if.then.i18.i81, %_Z8btSetMinIfEvRT_RKS0_.exit.i67
  %arrayidx11.i73 = getelementptr inbounds %class.btVector3, ptr %triangle, i64 2, i32 0, i64 2
  %42 = load float, ptr %arrayidx11.i73, align 4
  %cmp.i20.i74 = fcmp olt float %42, %29
  br i1 %cmp.i20.i74, label %if.then.i21.i80, label %_Z8btSetMinIfEvRT_RKS0_.exit22.i75

if.then.i21.i80:                                  ; preds = %_Z8btSetMinIfEvRT_RKS0_.exit19.i71
  store float %42, ptr %arrayidx9.i, align 8
  br label %_Z8btSetMinIfEvRT_RKS0_.exit22.i75

_Z8btSetMinIfEvRT_RKS0_.exit22.i75:               ; preds = %if.then.i21.i80, %_Z8btSetMinIfEvRT_RKS0_.exit19.i71
  %arrayidx.i.i77 = getelementptr inbounds %class.btVector3, ptr %triangle, i64 2, i32 0, i64 3
  %43 = load float, ptr %arrayidx.i.i77, align 4
  %cmp.i23.i78 = fcmp olt float %43, %31
  br i1 %cmp.i23.i78, label %if.then.i24.i79, label %_ZN9btVector36setMinERKS_.exit83

if.then.i24.i79:                                  ; preds = %_Z8btSetMinIfEvRT_RKS0_.exit22.i75
  store float %43, ptr %arrayidx13.i, align 4
  br label %_ZN9btVector36setMinERKS_.exit83

_ZN9btVector36setMinERKS_.exit83:                 ; preds = %_Z8btSetMinIfEvRT_RKS0_.exit22.i75, %if.then.i24.i79
  %44 = load float, ptr %arrayidx8, align 4
  %cmp.i.i84 = fcmp olt float %33, %44
  br i1 %cmp.i.i84, label %if.then.i.i100, label %_Z8btSetMaxIfEvRT_RKS0_.exit.i85

if.then.i.i100:                                   ; preds = %_ZN9btVector36setMinERKS_.exit83
  store float %44, ptr %m_aabbMax, align 8
  br label %_Z8btSetMaxIfEvRT_RKS0_.exit.i85

_Z8btSetMaxIfEvRT_RKS0_.exit.i85:                 ; preds = %if.then.i.i100, %_ZN9btVector36setMinERKS_.exit83
  %45 = load float, ptr %arrayidx7.i69, align 4
  %cmp.i17.i88 = fcmp olt float %35, %45
  br i1 %cmp.i17.i88, label %if.then.i18.i99, label %_Z8btSetMaxIfEvRT_RKS0_.exit19.i89

if.then.i18.i99:                                  ; preds = %_Z8btSetMaxIfEvRT_RKS0_.exit.i85
  store float %45, ptr %arrayidx5.i17, align 4
  br label %_Z8btSetMaxIfEvRT_RKS0_.exit19.i89

_Z8btSetMaxIfEvRT_RKS0_.exit19.i89:               ; preds = %if.then.i18.i99, %_Z8btSetMaxIfEvRT_RKS0_.exit.i85
  %46 = load float, ptr %arrayidx11.i73, align 4
  %cmp.i20.i92 = fcmp olt float %37, %46
  br i1 %cmp.i20.i92, label %if.then.i21.i98, label %_Z8btSetMaxIfEvRT_RKS0_.exit22.i93

if.then.i21.i98:                                  ; preds = %_Z8btSetMaxIfEvRT_RKS0_.exit19.i89
  store float %46, ptr %arrayidx9.i20, align 8
  br label %_Z8btSetMaxIfEvRT_RKS0_.exit22.i93

_Z8btSetMaxIfEvRT_RKS0_.exit22.i93:               ; preds = %if.then.i21.i98, %_Z8btSetMaxIfEvRT_RKS0_.exit19.i89
  %47 = load float, ptr %arrayidx.i.i77, align 4
  %cmp.i23.i96 = fcmp olt float %39, %47
  br i1 %cmp.i23.i96, label %if.then.i24.i97, label %_ZN9btVector36setMaxERKS_.exit101

if.then.i24.i97:                                  ; preds = %_Z8btSetMaxIfEvRT_RKS0_.exit22.i93
  store float %47, ptr %arrayidx13.i23, align 4
  br label %_ZN9btVector36setMaxERKS_.exit101

_ZN9btVector36setMaxERKS_.exit101:                ; preds = %_Z8btSetMaxIfEvRT_RKS0_.exit22.i93, %if.then.i24.i97
  ret void
}
...
attributes #1 = { noreturn nounwind memory(inaccessiblemem: write) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
