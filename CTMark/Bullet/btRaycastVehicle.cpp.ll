; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btRaycastVehicle.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btRaycastVehicle.cpp"
...
entry:
  store ptr getelementptr inbounds ({ [6 x ptr] }, ptr @_ZTV11btRigidBody, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
invoke.cont:                                      ; preds = %entry, %if.then3.i.i.i
  ...
  %2 = load ptr, ptr %m_data.i.i.i30, align 8
...
invoke.cont3:                                     ; preds = %invoke.cont, %if.then3.i.i.i35
  ...
  %4 = load ptr, ptr %m_data.i.i.i39, align 8
...
invoke.cont7:                                     ; preds = %invoke.cont3, %if.then3.i.i.i44
  ...
  store i8 1, ptr %m_ownsMemory.i.i.i41, align 8
  ...
  %6 = load ptr, ptr %m_data.i.i.i49, align 8
...
invoke.cont11:                                    ; preds = %invoke.cont7, %if.then3.i.i.i54
  ...
  store i8 1, ptr %m_ownsMemory.i.i.i51, align 8
  ...
  %8 = load ptr, ptr %m_data.i.i.i58, align 8
...
invoke.cont16:                                    ; preds = %if.then3.i.i.i63, %invoke.cont11
  ...
  store i8 1, ptr %m_ownsMemory.i.i.i60, align 8
...
entry:
  ...
  %4 = shufflevector <4 x float> %0, <4 x float> %1, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %5 = insertelement <4 x float> %4, float %2, i64 3
  store <4 x float> %5, ptr %m_suspensionStiffness3.i, align 4
  ...
  store <2 x float> zeroinitializer, ptr %m_engineForce.i, align 4
  ...
  store i8 %frombool, ptr %m_bIsFrontWheel12.i, align 4
  ...
  %8 = load ptr, ptr %m_chassisBody.i.i.i, align 8
  ...
  %chassisTrans.i.sroa.619.16.copyload = load float, ptr %arrayidx6.i.i.i, align 4
  ...
  %chassisTrans.i.sroa.1020.32.copyload = load float, ptr %arrayidx10.i.i.i, align 4
  ...
  %9 = load float, ptr %m_chassisConnectionPointCS.i15, align 4
  ...
  %11 = load float, ptr %arrayidx12.i.i28.i, align 4
  %12 = load <2 x float>, ptr %m_origin3.i.i, align 4
  %13 = insertelement <2 x float> poison, float %chassisTrans.i.sroa.4.0.copyload, i64 0
  %14 = insertelement <2 x float> %13, float %chassisTrans.i.sroa.8.16.copyload, i64 1
  %15 = insertelement <2 x float> poison, float %10, i64 0
  %16 = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> zeroinitializer
  %17 = fmul <2 x float> %14, %16
  %18 = insertelement <2 x float> poison, float %chassisTrans.i.sroa.0.0.copyload, i64 0
  %19 = insertelement <2 x float> %18, float %chassisTrans.i.sroa.619.16.copyload, i64 1
  %20 = insertelement <2 x float> poison, float %9, i64 0
  %21 = shufflevector <2 x float> %20, <2 x float> poison, <2 x i32> zeroinitializer
  %22 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %19, <2 x float> %21, <2 x float> %17)
  %23 = insertelement <2 x float> poison, float %chassisTrans.i.sroa.5.0.copyload, i64 0
  %24 = insertelement <2 x float> %23, float %chassisTrans.i.sroa.9.16.copyload, i64 1
  ...
  %28 = fadd <2 x float> %12, %27
  %mul8.i29.i.i = fmul float %chassisTrans.i.sroa.12.32.copyload, %10
  %29 = call float @llvm.fmuladd.f32(float %chassisTrans.i.sroa.1020.32.copyload, float %9, float %mul8.i29.i.i)
  %30 = call float @llvm.fmuladd.f32(float %chassisTrans.i.sroa.13.32.copyload, float %11, float %29)
  %add17.i.i = fadd float %chassisTrans.i.sroa.17.48.copyload, %30
  ...
  store <2 x float> %28, ptr %m_hardPointWS.i, align 4
  ...
  %42 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %24, <2 x float> %41, <2 x float> %39)
  %mul8.i20.i.i = fmul float %chassisTrans.i.sroa.12.32.copyload, %32
  %43 = call float @llvm.fmuladd.f32(float %chassisTrans.i.sroa.1020.32.copyload, float %31, float %mul8.i20.i.i)
  %44 = call float @llvm.fmuladd.f32(float %chassisTrans.i.sroa.13.32.copyload, float %33, float %43)
  %retval.sroa.3.12.vec.insert.i38.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %44, i64 0
  %m_wheelDirectionWS.i = getelementptr inbounds %"struct.btWheelInfo::RaycastInfo", ptr %arrayidx.i, i64 0, i32 4
  store <2 x float> %42, ptr %m_wheelDirectionWS.i, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i38.i, ptr %ref.tmp9.sroa.4.0.m_wheelDirectionWS.sroa_idx.i, align 4
  %m_wheelAxleCS.i17 = getelementptr inbounds %struct.btWheelInfo, ptr %7, i64 %idxprom.i, i32 4
  %45 = load float, ptr %m_wheelAxleCS.i17, align 4
  %arrayidx7.i.i42.i = getelementptr inbounds %struct.btWheelInfo, ptr %7, i64 %idxprom.i, i32 4, i32 0, i64 1
  %46 = load float, ptr %arrayidx7.i.i42.i, align 4
  %arrayidx12.i.i45.i = getelementptr inbounds %struct.btWheelInfo, ptr %7, i64 %idxprom.i, i32 4, i32 0, i64 2
  %47 = load float, ptr %arrayidx12.i.i45.i, align 4
  %48 = insertelement <2 x float> poison, float %46, i64 0
  %49 = shufflevector <2 x float> %48, <2 x float> poison, <2 x i32> zeroinitializer
  %50 = fmul <2 x float> %14, %49
  %51 = insertelement <2 x float> poison, float %45, i64 0
  %52 = shufflevector <2 x float> %51, <2 x float> poison, <2 x i32> zeroinitializer
  %53 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %19, <2 x float> %52, <2 x float> %50)
  %54 = insertelement <2 x float> poison, float %47, i64 0
  %55 = shufflevector <2 x float> %54, <2 x float> poison, <2 x i32> zeroinitializer
  %56 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %24, <2 x float> %55, <2 x float> %53)
  %mul8.i20.i52.i = fmul float %chassisTrans.i.sroa.12.32.copyload, %46
  %57 = call float @llvm.fmuladd.f32(float %chassisTrans.i.sroa.1020.32.copyload, float %45, float %mul8.i20.i52.i)
  %58 = call float @llvm.fmuladd.f32(float %chassisTrans.i.sroa.13.32.copyload, float %47, float %57)
  ...
  store <2 x float> %56, ptr %m_wheelAxleWS.i, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i56.i, ptr %ref.tmp14.sroa.4.0.m_wheelAxleWS.sroa_idx.i, align 4
...
_ZNK20btAlignedObjectArrayI11btWheelInfoE4copyEiiPS0_.exit.i: ; preds = %for.body.i.i, %_ZN20btAlignedObjectArrayI11btWheelInfoE8allocateEi.exit.i
  ...
  %4 = load ptr, ptr %m_data.i9.i, align 8
...
_ZN20btAlignedObjectArrayI11btWheelInfoE10deallocateEv.exit.i: ; preds = %if.then3.i.i, %_ZNK20btAlignedObjectArrayI11btWheelInfoE4copyEiiPS0_.exit.i
  store i8 1, ptr %m_ownsMemory.i.i, align 8
  store ptr %retval.0.i.i, ptr %m_data.i9.i, align 8
  store i32 %cond.i, ptr %m_capacity.i, align 8
  %.pre7 = load i32, ptr %m_size.i, align 4
  br label %if.end
...
if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  ...
  %9 = load <4 x float>, ptr %arrayidx10.i.i27, align 8
  ...
  %11 = load float, ptr %arrayidx12.i.i28, align 8
  ...
  %13 = load float, ptr %arrayidx5.i20.i, align 4
  %arrayidx10.i23.i = getelementptr inbounds [3 x %class.btVector3], ptr %chassisTrans, i64 0, i64 1, i32 0, i64 2
  %14 = load float, ptr %arrayidx10.i23.i, align 8
  %15 = insertelement <2 x float> poison, float %8, i64 0
  %16 = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> zeroinitializer
  %17 = insertelement <2 x float> %7, float %13, i64 1
  %18 = fmul <2 x float> %16, %17
  %19 = insertelement <2 x float> %4, float %12, i64 1
  %20 = insertelement <2 x float> poison, float %5, i64 0
  %21 = shufflevector <2 x float> %20, <2 x float> poison, <2 x i32> zeroinitializer
  %22 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %19, <2 x float> %21, <2 x float> %18)
  %23 = insertelement <2 x float> %10, float %14, i64 1
  %24 = insertelement <2 x float> poison, float %11, i64 0
  %25 = shufflevector <2 x float> %24, <2 x float> poison, <2 x i32> zeroinitializer
  %26 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %23, <2 x float> %25, <2 x float> %22)
  %27 = load <2 x float>, ptr %m_origin.i, align 16
  %28 = fadd <2 x float> %26, %27
  %29 = load float, ptr %arrayidx12.i.i, align 16
  %arrayidx5.i27.i = getelementptr inbounds [3 x %class.btVector3], ptr %chassisTrans, i64 0, i64 2, i32 0, i64 1
  %30 = load float, ptr %arrayidx5.i27.i, align 4
  %mul8.i29.i = fmul float %8, %30
  %31 = call float @llvm.fmuladd.f32(float %29, float %5, float %mul8.i29.i)
  %arrayidx10.i30.i = getelementptr inbounds [3 x %class.btVector3], ptr %chassisTrans, i64 0, i64 2, i32 0, i64 2
  %32 = load float, ptr %arrayidx10.i30.i, align 8
  %33 = call float @llvm.fmuladd.f32(float %32, float %11, float %31)
  %arrayidx.i32.i = getelementptr inbounds %class.btTransform, ptr %chassisTrans, i64 0, i32 1, i32 0, i64 2
  %34 = load float, ptr %arrayidx.i32.i, align 8
  ...
  store <2 x float> %28, ptr %m_hardPointWS, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i, ptr %ref.tmp.sroa.4.0.m_hardPointWS.sroa_idx, align 4
  ...
  %43 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %19, <2 x float> %42, <2 x float> %40)
  %44 = insertelement <2 x float> poison, float %37, i64 0
  %45 = shufflevector <2 x float> %44, <2 x float> poison, <2 x i32> zeroinitializer
  %46 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %23, <2 x float> %45, <2 x float> %43)
  %mul8.i20.i = fmul float %30, %36
  %47 = call float @llvm.fmuladd.f32(float %29, float %35, float %mul8.i20.i)
  %48 = call float @llvm.fmuladd.f32(float %32, float %37, float %47)
  %retval.sroa.3.12.vec.insert.i38 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %48, i64 0
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i38, ptr %ref.tmp9.sroa.4.0.m_wheelDirectionWS.sroa_idx, align 4
  ...
  %57 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %19, <2 x float> %56, <2 x float> %54)
  %58 = insertelement <2 x float> poison, float %51, i64 0
  %59 = shufflevector <2 x float> %58, <2 x float> poison, <2 x i32> zeroinitializer
  %60 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %23, <2 x float> %59, <2 x float> %57)
  %mul8.i20.i52 = fmul float %30, %50
  %61 = call float @llvm.fmuladd.f32(float %29, float %49, float %mul8.i20.i52)
  %62 = call float @llvm.fmuladd.f32(float %32, float %51, float %61)
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i56, ptr %ref.tmp14.sroa.4.0.m_wheelAxleWS.sroa_idx, align 4
...
entry:
  ...
  %11 = tail call float @llvm.fmuladd.f32(float %9, float %9, float %10)
  ...
  %15 = load float, ptr %arrayidx7.i52, align 4
  %16 = load float, ptr %arrayidx3.i51, align 4
  %mul.i.i72 = fmul float %13, -5.000000e-01
  %call.i.i.i73 = tail call float @sinf(float noundef %mul.i.i72) #20
  %17 = load float, ptr %arrayidx3.i51, align 4
  ...
  %30 = insertelement <2 x float> %29, float %call.i.i.i73, i64 1
  ...
  %72 = load float, ptr %arrayidx7.i52, align 4
  %73 = load float, ptr %arrayidx3.i51, align 4
  ...
  store float %95, ptr %ref.tmp24.sroa.5.0.m_worldTransform.sroa_idx, align 4
  %ref.tmp24.sroa.6.0.m_worldTransform.sroa_idx = getelementptr inbounds i8, ptr %m_worldTransform, i64 12
  store float 0.000000e+00, ptr %ref.tmp24.sroa.6.0.m_worldTransform.sroa_idx, align 4
  ...
  store float %97, ptr %ref.tmp24.sroa.10.16.arrayidx7.i.i.sroa_idx, align 4
  ...
  store float 0.000000e+00, ptr %ref.tmp24.sroa.11.16.arrayidx7.i.i.sroa_idx, align 4
  ...
  store float %99, ptr %ref.tmp24.sroa.15.32.arrayidx11.i.i.sroa_idx, align 4
  ...
  store float 0.000000e+00, ptr %ref.tmp24.sroa.16.32.arrayidx11.i.i.sroa_idx, align 4
  ...
  %133 = load float, ptr %m_wheelDirectionWS, align 4
  %134 = load float, ptr %m_suspensionLength, align 4
  %135 = load float, ptr %arrayidx3.i, align 4
  %136 = load float, ptr %arrayidx7.i, align 4
  %mul8.i = fmul float %134, %136
  ...
  %142 = load <2 x float>, ptr %m_hardPointWS, align 4
  ...
  %144 = load float, ptr %arrayidx11.i, align 4
  ...
  store <2 x float> %143, ptr %m_origin.i, align 4
  %ref.tmp27.sroa.4.0.m_origin.i.sroa_idx = getelementptr inbounds i8, ptr %m_origin.i, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i187, ptr %ref.tmp27.sroa.4.0.m_origin.i.sroa_idx, align 4
  ret void
}
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i, ptr %ref.tmp.sroa.4.0.m_contactNormalWS.sroa_idx, align 8
...
entry:
  ...
  %chassisTrans.i.sroa.6152.16.copyload = load float, ptr %arrayidx6.i.i.i, align 4
  ...
  %chassisTrans.i.sroa.10153.32.copyload = load float, ptr %arrayidx10.i.i.i, align 4
  ...
  %3 = load float, ptr %arrayidx12.i.i28.i, align 8
  %4 = load <2 x float>, ptr %m_origin3.i.i, align 4
  %5 = insertelement <2 x float> poison, float %chassisTrans.i.sroa.4.0.copyload, i64 0
  %6 = insertelement <2 x float> %5, float %chassisTrans.i.sroa.8.16.copyload, i64 1
  %7 = insertelement <2 x float> poison, float %2, i64 0
  %8 = shufflevector <2 x float> %7, <2 x float> poison, <2 x i32> zeroinitializer
  %9 = fmul <2 x float> %6, %8
  %10 = insertelement <2 x float> poison, float %chassisTrans.i.sroa.0.0.copyload, i64 0
  %11 = insertelement <2 x float> %10, float %chassisTrans.i.sroa.6152.16.copyload, i64 1
  ...
  %15 = insertelement <2 x float> poison, float %chassisTrans.i.sroa.5.0.copyload, i64 0
  %16 = insertelement <2 x float> %15, float %chassisTrans.i.sroa.9.16.copyload, i64 1
  ...
  %21 = tail call float @llvm.fmuladd.f32(float %chassisTrans.i.sroa.10153.32.copyload, float %1, float %mul8.i29.i.i)
  %22 = tail call float @llvm.fmuladd.f32(float %chassisTrans.i.sroa.13.32.copyload, float %3, float %21)
  %add17.i.i = fadd float %chassisTrans.i.sroa.17.48.copyload, %22
  %retval.sroa.3.12.vec.insert.i.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add17.i.i, i64 0
  %m_hardPointWS.i = getelementptr inbounds %"struct.btWheelInfo::RaycastInfo", ptr %wheel, i64 0, i32 3
  store <2 x float> %20, ptr %m_hardPointWS.i, align 4
  ...
  %31 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %11, <2 x float> %30, <2 x float> %28)
  ...
  %mul8.i20.i.i = fmul float %chassisTrans.i.sroa.12.32.copyload, %24
  %35 = tail call float @llvm.fmuladd.f32(float %chassisTrans.i.sroa.10153.32.copyload, float %23, float %mul8.i20.i.i)
  %36 = tail call float @llvm.fmuladd.f32(float %chassisTrans.i.sroa.13.32.copyload, float %25, float %35)
  %retval.sroa.3.12.vec.insert.i38.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %36, i64 0
  ...
  %38 = load float, ptr %arrayidx7.i.i42.i, align 4
  %arrayidx12.i.i45.i = getelementptr inbounds %struct.btWheelInfo, ptr %wheel, i64 0, i32 4, i32 0, i64 2
  %39 = load float, ptr %arrayidx12.i.i45.i, align 8
  %40 = insertelement <2 x float> poison, float %38, i64 0
  %41 = shufflevector <2 x float> %40, <2 x float> poison, <2 x i32> zeroinitializer
  %42 = fmul <2 x float> %6, %41
  %43 = insertelement <2 x float> poison, float %37, i64 0
  %44 = shufflevector <2 x float> %43, <2 x float> poison, <2 x i32> zeroinitializer
  %45 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %11, <2 x float> %44, <2 x float> %42)
  %46 = insertelement <2 x float> poison, float %39, i64 0
  %47 = shufflevector <2 x float> %46, <2 x float> poison, <2 x i32> zeroinitializer
  %48 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %16, <2 x float> %47, <2 x float> %45)
  %mul8.i20.i52.i = fmul float %chassisTrans.i.sroa.12.32.copyload, %38
  %49 = tail call float @llvm.fmuladd.f32(float %chassisTrans.i.sroa.10153.32.copyload, float %37, float %mul8.i20.i52.i)
  %50 = tail call float @llvm.fmuladd.f32(float %chassisTrans.i.sroa.13.32.copyload, float %39, float %49)
  ...
  %52 = load float, ptr %ref.tmp9.sroa.4.0.m_wheelDirectionWS.sroa_idx.i, align 4
  ...
  %59 = load float, ptr %ref.tmp.sroa.4.0.m_hardPointWS.sroa_idx.i, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i120, ptr %ref.tmp.sroa.4.0.m_contactPointWS.sroa_idx, align 8
...
if.then:                                          ; preds = %entry
  ...
  store ptr @_ZL13s_fixedObject, ptr %m_groundObject, align 8
...
72:                                               ; preds = %if.then, %71
  ...
  %75 = load float, ptr %arrayidx5.i123, align 4
  ...
  %79 = load float, ptr %ref.tmp9.sroa.4.0.m_wheelDirectionWS.sroa_idx.i, align 4
...
if.else:                                          ; preds = %72
  ...
  %86 = load float, ptr %m_origin.i.i126, align 4
  ...
  %91 = load float, ptr %ref.tmp.sroa.4.0.m_contactPointWS.sroa_idx, align 8
  %arrayidx13.i130 = getelementptr inbounds %class.btCollisionObject, ptr %81, i64 0, i32 1, i32 1, i32 0, i64 2
  %92 = load float, ptr %arrayidx13.i130, align 4
  ...
  %97 = load float, ptr %arrayidx5.i5.i, align 4
  %98 = fneg float %82
  ...
  store float %mul58, ptr %m_suspensionRelativeVelocity59, align 4
  br label %if.end75
...
if.else62:                                        ; preds = %entry
  ...
  store float %call63, ptr %m_suspensionLength65, align 8
  %m_suspensionRelativeVelocity66 = getelementptr inbounds %struct.btWheelInfo, ptr %wheel, i64 0, i32 21
  store float 0.000000e+00, ptr %m_suspensionRelativeVelocity66, align 4
  %102 = load <2 x float>, ptr %m_wheelDirectionWS.i, align 4
  %103 = fneg <2 x float> %102
  %104 = load float, ptr %ref.tmp9.sroa.4.0.m_wheelDirectionWS.sroa_idx.i, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i147, ptr %ref.tmp67.sroa.4.0.m_contactNormalWS73.sroa_idx, align 8
  br label %if.end75
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit, %entry
  %cmp30246 = phi i1 [ %1, %for.cond.cleanup.loopexit ], [ false, %entry ]
  %m_chassisBody.i = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 11
  %2 = load ptr, ptr %m_chassisBody.i, align 8
  %m_linearVelocity.i = getelementptr inbounds %class.btRigidBody, ptr %2, i64 0, i32 2
  %3 = load float, ptr %m_linearVelocity.i, align 4
  ...
  %m_indexForwardAxis = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 14
  %8 = load i32, ptr %m_indexForwardAxis, align 8
  ...
  %12 = load float, ptr %m_linearVelocity.i, align 4
  %13 = load float, ptr %arrayidx5.i.i.i, align 4
  %mul8.i = fmul float %10, %13
  %14 = tail call float @llvm.fmuladd.f32(float %9, float %12, float %mul8.i)
  %15 = load float, ptr %arrayidx10.i.i.i, align 4
...
for.end37:                                        ; preds = %for.body31
  ...
  %22 = load float, ptr %m_inverseMass.i.i, align 8
  %div.i = fdiv float 1.000000e+00, %22
  br i1 %21, label %for.body.lr.ph.i, label %for.end59
...
if.then.i:                                        ; preds = %for.body.i
  ...
  %m_clippedInvContactDotSuspension.i = getelementptr inbounds %struct.btWheelInfo, ptr %23, i64 %indvars.iv.i, i32 20
  %27 = load float, ptr %m_clippedInvContactDotSuspension.i, align 8
  %mul6.i = fmul float %mul.i, %27
  %m_suspensionRelativeVelocity.i = getelementptr inbounds %struct.btWheelInfo, ptr %23, i64 %indvars.iv.i, i32 21
...
if.end18.i:                                       ; preds = %if.then.i, %for.body.i
  ...
  %30 = getelementptr inbounds %struct.btWheelInfo, ptr %23, i64 %indvars.iv.i, i32 22
  store float %storemerge.sink.i, ptr %30, align 8
...
_ZN16btRaycastVehicle16updateSuspensionEf.exit:   ; preds = %if.end18.i
  ...
  br i1 %33, label %for.body42.lr.ph, label %for.end59
...
for.body42:                                       ; preds = %for.body42.lr.ph, %for.body42
  ...
  %38 = load ptr, ptr %m_data.i154, align 8
  %arrayidx.i156 = getelementptr inbounds %struct.btWheelInfo, ptr %38, i64 %indvars.iv253
  %m_wheelsSuspensionForce = getelementptr inbounds %struct.btWheelInfo, ptr %38, i64 %indvars.iv253, i32 22
  %39 = load float, ptr %m_wheelsSuspensionForce, align 8
  %cmp45 = fcmp ogt float %39, 6.000000e+03
  %storemerge = select i1 %cmp45, float 6.000000e+03, float %39
  ...
  %40 = load float, ptr %arrayidx7.i159, align 4
  %mul8.i160 = fmul float %storemerge, %40
  %41 = load <2 x float>, ptr %arrayidx.i156, align 4
  %42 = insertelement <2 x float> poison, float %storemerge, i64 0
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i168, ptr %34, align 8
  ...
  %m_origin.i.i = getelementptr inbounds %class.btCollisionObject, ptr %46, i64 0, i32 1, i32 1
  ...
  %arrayidx13.i = getelementptr inbounds %class.btCollisionObject, ptr %46, i64 0, i32 1, i32 1, i32 0, i64 2
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i177, ptr %35, align 8
  call void @_ZN11btRigidBody12applyImpulseERK9btVector3S2_(ptr noundef nonnull align 8 dereferenceable(564) %46, ptr noundef nonnull align 4 dereferenceable(16) %impulse, ptr noundef nonnull align 4 dereferenceable(16) %relpos)
  ...
  %cmp41 = icmp slt i64 %indvars.iv.next254, %53
...
for.body64.lr.ph:                                 ; preds = %for.end59
  ...
  %56 = load ptr, ptr %m_data.i182, align 8
  %57 = load ptr, ptr %m_chassisBody.i, align 8
  %m_angularVelocity.i = getelementptr inbounds %class.btRigidBody, ptr %57, i64 0, i32 3
  %arrayidx7.i189 = getelementptr inbounds %class.btCollisionObject, ptr %57, i64 0, i32 1, i32 1, i32 0, i64 1
  %m_origin.i.i186 = getelementptr inbounds %class.btCollisionObject, ptr %57, i64 0, i32 1, i32 1
  %arrayidx.i.i201 = getelementptr inbounds %class.btRigidBody, ptr %57, i64 0, i32 3, i32 0, i64 1
  %arrayidx11.i.i = getelementptr inbounds %class.btRigidBody, ptr %57, i64 0, i32 2, i32 0, i64 2
  %arrayidx5.i5.i = getelementptr inbounds %class.btRigidBody, ptr %57, i64 0, i32 2, i32 0, i64 1
  %arrayidx5.i.i = getelementptr inbounds %class.btRigidBody, ptr %57, i64 0, i32 3, i32 0, i64 2
  %arrayidx13.i192 = getelementptr inbounds %class.btCollisionObject, ptr %57, i64 0, i32 1, i32 1, i32 0, i64 2
  %m_linearVelocity.i200 = getelementptr inbounds %class.btRigidBody, ptr %57, i64 0, i32 2
  %m_worldTransform.i.i203 = getelementptr inbounds %class.btCollisionObject, ptr %57, i64 0, i32 1
  %58 = load i32, ptr %m_indexForwardAxis, align 8
  %idxprom84 = sext i32 %58 to i64
  %arrayidx85 = getelementptr inbounds float, ptr %m_worldTransform.i.i203, i64 %idxprom84
  %arrayidx.i204 = getelementptr inbounds %class.btCollisionObject, ptr %57, i64 0, i32 1, i32 0, i32 0, i64 1
  %arrayidx91 = getelementptr inbounds float, ptr %arrayidx.i204, i64 %idxprom84
  %arrayidx.i205 = getelementptr inbounds %class.btCollisionObject, ptr %57, i64 0, i32 1, i32 0, i32 0, i64 2
...
for.body64:                                       ; preds = %for.body64.lr.ph, %if.end113
  ...
  %arrayidx.i184 = getelementptr inbounds %struct.btWheelInfo, ptr %56, i64 %indvars.iv256
  %m_isInContact = getelementptr inbounds %"struct.btWheelInfo::RaycastInfo", ptr %arrayidx.i184, i64 0, i32 6
  %59 = load i8, ptr %m_isInContact, align 4
  %tobool.not = icmp eq i8 %59, 0
  br i1 %tobool.not, label %if.else, label %if.then78

if.then78:                                        ; preds = %for.body64
  %60 = load float, ptr %m_angularVelocity.i, align 4
  %arrayidx5.i188 = getelementptr inbounds %"struct.btWheelInfo::RaycastInfo", ptr %arrayidx.i184, i64 0, i32 3, i32 0, i64 1
  %61 = load float, ptr %arrayidx5.i188, align 4
  %62 = load float, ptr %arrayidx7.i189, align 4
  %sub8.i190 = fsub float %61, %62
  %m_hardPointWS = getelementptr inbounds %"struct.btWheelInfo::RaycastInfo", ptr %arrayidx.i184, i64 0, i32 3
  %63 = load float, ptr %m_hardPointWS, align 4
  %64 = load float, ptr %m_origin.i.i186, align 4
  %sub.i187 = fsub float %63, %64
  %65 = load float, ptr %arrayidx.i.i201, align 4
  %66 = fneg float %65
  %neg30.i.i = fmul float %sub.i187, %66
  %67 = call float @llvm.fmuladd.f32(float %60, float %sub8.i190, float %neg30.i.i)
  %68 = load float, ptr %arrayidx11.i.i, align 4
  %add14.i.i = fadd float %68, %67
  %69 = load float, ptr %arrayidx5.i5.i, align 4
  %70 = load float, ptr %arrayidx5.i.i, align 4
  %arrayidx11.i191 = getelementptr inbounds %"struct.btWheelInfo::RaycastInfo", ptr %arrayidx.i184, i64 0, i32 3, i32 0, i64 2
  %71 = load float, ptr %arrayidx11.i191, align 4
  %72 = load float, ptr %arrayidx13.i192, align 4
  %sub14.i193 = fsub float %71, %72
  %73 = fneg float %60
  %neg19.i.i = fmul float %sub14.i193, %73
  %74 = call float @llvm.fmuladd.f32(float %70, float %sub.i187, float %neg19.i.i)
  %add8.i.i = fadd float %69, %74
  %75 = fneg float %70
  %neg.i.i = fmul float %sub8.i190, %75
  %76 = call float @llvm.fmuladd.f32(float %65, float %sub14.i193, float %neg.i.i)
  %77 = load float, ptr %m_linearVelocity.i200, align 4
  %add.i.i = fadd float %77, %76
  %78 = load float, ptr %arrayidx85, align 4
  %79 = load float, ptr %arrayidx91, align 4
  %80 = load float, ptr %arrayidx97, align 4
  %81 = load float, ptr %arrayidx.i184, align 4
  %arrayidx7.i210 = getelementptr inbounds [4 x float], ptr %arrayidx.i184, i64 0, i64 1
  %82 = load float, ptr %arrayidx7.i210, align 4
  %mul8.i211 = fmul float %79, %82
  %83 = call float @llvm.fmuladd.f32(float %78, float %81, float %mul8.i211)
  %arrayidx12.i213 = getelementptr inbounds [4 x float], ptr %arrayidx.i184, i64 0, i64 2
  %84 = load float, ptr %arrayidx12.i213, align 4
  %85 = call float @llvm.fmuladd.f32(float %80, float %84, float %83)
  %mul.i214 = fmul float %81, %85
  %mul4.i216 = fmul float %82, %85
  %mul8.i218 = fmul float %84, %85
  %sub.i224 = fsub float %78, %mul.i214
  %sub8.i227 = fsub float %79, %mul4.i216
  %sub13.i = fsub float %80, %mul8.i218
  %mul8.i232 = fmul float %add8.i.i, %sub8.i227
  %86 = call float @llvm.fmuladd.f32(float %sub.i224, float %add.i.i, float %mul8.i232)
  %87 = call float @llvm.fmuladd.f32(float %sub13.i, float %add14.i.i, float %86)
  %mul108 = fmul float %87, %step
  %m_wheelsRadius = getelementptr inbounds %struct.btWheelInfo, ptr %56, i64 %indvars.iv256, i32 7
  %88 = load float, ptr %m_wheelsRadius, align 8
  %div = fdiv float %mul108, %88
  %m_rotation = getelementptr inbounds %struct.btWheelInfo, ptr %56, i64 %indvars.iv256, i32 13
  %89 = load float, ptr %m_rotation, align 8
  br label %if.end113

if.else:                                          ; preds = %for.body64
  %m_deltaRotation110 = getelementptr inbounds %struct.btWheelInfo, ptr %56, i64 %indvars.iv256, i32 14
  %90 = load float, ptr %m_deltaRotation110, align 4
  %m_rotation111 = getelementptr inbounds %struct.btWheelInfo, ptr %56, i64 %indvars.iv256, i32 13
  %91 = load float, ptr %m_rotation111, align 8
  br label %if.end113

if.end113:                                        ; preds = %if.else, %if.then78
  %.sink265 = phi float [ %91, %if.else ], [ %div, %if.then78 ]
  %.sink = phi float [ %90, %if.else ], [ %89, %if.then78 ]
  %m_rotation111.sink = phi ptr [ %m_rotation111, %if.else ], [ %m_rotation, %if.then78 ]
  %92 = phi float [ %90, %if.else ], [ %div, %if.then78 ]
  %add112 = fadd float %.sink, %.sink265
  store float %add112, ptr %m_rotation111.sink, align 8
  %m_deltaRotation114 = getelementptr inbounds %struct.btWheelInfo, ptr %56, i64 %indvars.iv256, i32 14
  %mul115 = fmul float %92, 0x3FEFAE1480000000
  store float %mul115, ptr %m_deltaRotation114, align 4
...
entry:
  ...
  %0 = load float, ptr %m_inverseMass, align 8
...
if.then2:                                         ; preds = %entry
  ...
  %2 = load float, ptr %arrayidx13.i.i, align 4
  ...
  %4 = load <2 x float>, ptr %m_linearFactor.i, align 4
  %5 = fmul <2 x float> %3, %4
  %6 = insertelement <2 x float> poison, float %0, i64 0
  %7 = shufflevector <2 x float> %6, <2 x float> poison, <2 x i32> zeroinitializer
  %8 = fmul <2 x float> %7, %5
  %9 = load <2 x float>, ptr %m_linearVelocity.i, align 8
  %10 = fadd <2 x float> %8, %9
  store <2 x float> %10, ptr %m_linearVelocity.i, align 8
  ...
  %18 = load float, ptr %arrayidx5.i9, align 4
  %19 = fneg float %18
  ...
  %26 = load <4 x float>, ptr %m_invInertiaTensorWorld.i, align 8
  ...
  %28 = load <4 x float>, ptr %arrayidx5.i.i.i, align 4
  ...
  %30 = load <4 x float>, ptr %arrayidx10.i.i.i, align 8
  ...
  %53 = load <2 x float>, ptr %m_angularFactor, align 4
  %54 = fmul <2 x float> %52, %53
  %55 = load <2 x float>, ptr %m_angularVelocity.i, align 8
  %56 = fadd <2 x float> %54, %55
  store <2 x float> %56, ptr %m_angularVelocity.i, align 8
  %arrayidx12.i.i23 = getelementptr inbounds %class.btRigidBody, ptr %this, i64 0, i32 3, i32 0, i64 2
  %57 = load float, ptr %arrayidx12.i.i23, align 8
  %add13.i.i24 = fadd float %mul14.i.i20, %57
  store float %add13.i.i24, ptr %arrayidx12.i.i23, align 8
  br label %if.end7
...
entry:
  ...
  store float %force, ptr %m_engineForce, align 4
  ret void
}
...
entry:
  ...
  store float %brake, ptr %m_brake, align 8
  ret void
}
...
entry:
  ...
  %m_origin.i.i23 = getelementptr inbounds %class.btCollisionObject, ptr %7, i64 0, i32 1, i32 1
  %8 = load float, ptr %m_origin.i.i23, align 4
  %arrayidx7.i26 = getelementptr inbounds %class.btCollisionObject, ptr %7, i64 0, i32 1, i32 1, i32 0, i64 1
  %9 = load float, ptr %arrayidx7.i26, align 4
  %arrayidx13.i29 = getelementptr inbounds %class.btCollisionObject, ptr %7, i64 0, i32 1, i32 1, i32 0, i64 2
  %10 = load float, ptr %arrayidx13.i29, align 4
  ...
  %16 = load float, ptr %arrayidx5.i5.i, align 4
  ...
  %m_linearVelocity.i36 = getelementptr inbounds %class.btRigidBody, ptr %7, i64 0, i32 2
  %m_angularVelocity.i37 = getelementptr inbounds %class.btRigidBody, ptr %7, i64 0, i32 3
  %arrayidx.i.i38 = getelementptr inbounds %class.btRigidBody, ptr %7, i64 0, i32 3, i32 0, i64 1
  %18 = load float, ptr %arrayidx.i.i38, align 4
  %arrayidx5.i.i40 = getelementptr inbounds %class.btRigidBody, ptr %7, i64 0, i32 3, i32 0, i64 2
  %19 = load float, ptr %arrayidx5.i.i40, align 4
  %20 = load float, ptr %m_angularVelocity.i37, align 4
  %21 = load float, ptr %m_linearVelocity.i36, align 4
  %arrayidx5.i5.i46 = getelementptr inbounds %class.btRigidBody, ptr %7, i64 0, i32 2, i32 0, i64 1
  %22 = load float, ptr %arrayidx5.i5.i46, align 4
  %arrayidx11.i.i48 = getelementptr inbounds %class.btRigidBody, ptr %7, i64 0, i32 2, i32 0, i64 2
  %23 = load float, ptr %arrayidx11.i.i48, align 4
  ...
  %shift74 = shufflevector <2 x float> %56, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %61 = fsub <2 x float> %56, %shift74
  ...
  %64 = load float, ptr %arrayidx5.i67, align 4
  ...
  %cmp.i = fcmp olt float %11, %mul
  %j1.0 = select i1 %cmp.i, float %11, float %mul
...
if.end:                                           ; preds = %entry
  ...
  %1 = load i32, ptr %m_size.i.i316, align 4
...
_ZN20btAlignedObjectArrayI9btVector3E8allocateEi.exit.i.i: ; preds = %if.then5.i
  ...
  %.pre.i = load i32, ptr %m_size.i.i316, align 4
...
_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i: ; preds = %for.body.i.i.i.epil, %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa, %_ZN20btAlignedObjectArrayI9btVector3E8allocateEi.exit.i.i
  ...
  %7 = load ptr, ptr %m_data.i9.i.i, align 8
...
if.end.i:                                         ; preds = %if.then3.i.i.i, %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i
  store i8 1, ptr %m_ownsMemory.i.i.i, align 8
  store ptr %call.i.i.i.i, ptr %m_data.i9.i.i, align 8
  store i32 %0, ptr %m_capacity.i.i.i, align 8
...
_ZN20btAlignedObjectArrayI9btVector3E6resizeEiRKS0_.exit: ; preds = %if.then5.i, %if.end.i, %if.end
  store i32 %0, ptr %m_size.i.i316, align 4
  %m_size.i.i317 = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 2, i32 2
  %9 = load i32, ptr %m_size.i.i317, align 4
  %cmp4.i320 = icmp slt i32 %9, %0
  br i1 %cmp4.i320, label %if.then5.i321, label %_ZN20btAlignedObjectArrayI9btVector3E6resizeEiRKS0_.exit359

if.then5.i321:                                    ; preds = %_ZN20btAlignedObjectArrayI9btVector3E6resizeEiRKS0_.exit
  %m_capacity.i.i.i322 = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 2, i32 3
  %10 = load i32, ptr %m_capacity.i.i.i322, align 8
  %cmp.i.i323 = icmp slt i32 %10, %0
  br i1 %cmp.i.i323, label %_ZN20btAlignedObjectArrayI9btVector3E8allocateEi.exit.i.i339, label %_ZN20btAlignedObjectArrayI9btVector3E6resizeEiRKS0_.exit359

_ZN20btAlignedObjectArrayI9btVector3E8allocateEi.exit.i.i339: ; preds = %if.then5.i321
  %conv.i.i.i.i335 = sext i32 %0 to i64
  %mul.i.i.i.i336 = shl nsw i64 %conv.i.i.i.i335, 4
  %call.i.i.i.i337 = tail call noundef ptr @_Z22btAlignedAllocInternalmi(i64 noundef %mul.i.i.i.i336, i32 noundef 16)
  %.pre.i338 = load i32, ptr %m_size.i.i317, align 4
  %cmp7.i.i.i341 = icmp sgt i32 %.pre.i338, 0
  br i1 %cmp7.i.i.i341, label %for.body.lr.ph.i.i.i350, label %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i342

for.body.lr.ph.i.i.i350:                          ; preds = %_ZN20btAlignedObjectArrayI9btVector3E8allocateEi.exit.i.i339
  %m_data.i.i.i351 = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 2, i32 5
  %wide.trip.count.i.i.i352 = zext i32 %.pre.i338 to i64
  %xtraiter739 = and i64 %wide.trip.count.i.i.i352, 1
  %11 = icmp eq i32 %.pre.i338, 1
  br i1 %11, label %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i342.loopexit.unr-lcssa, label %for.body.lr.ph.i.i.i350.new

for.body.lr.ph.i.i.i350.new:                      ; preds = %for.body.lr.ph.i.i.i350
  %unroll_iter741 = and i64 %wide.trip.count.i.i.i352, 4294967294
  br label %for.body.i.i.i353

for.body.i.i.i353:                                ; preds = %for.body.i.i.i353, %for.body.lr.ph.i.i.i350.new
  %indvars.iv.i.i.i354 = phi i64 [ 0, %for.body.lr.ph.i.i.i350.new ], [ %indvars.iv.next.i.i.i357.1, %for.body.i.i.i353 ]
  %niter742 = phi i64 [ 0, %for.body.lr.ph.i.i.i350.new ], [ %niter742.next.1, %for.body.i.i.i353 ]
  %arrayidx.i.i.i355 = getelementptr inbounds %class.btVector3, ptr %call.i.i.i.i337, i64 %indvars.iv.i.i.i354
  %12 = load ptr, ptr %m_data.i.i.i351, align 8
  %arrayidx3.i.i.i356 = getelementptr inbounds %class.btVector3, ptr %12, i64 %indvars.iv.i.i.i354
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx.i.i.i355, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx3.i.i.i356, i64 16, i1 false)
  %indvars.iv.next.i.i.i357 = or i64 %indvars.iv.i.i.i354, 1
  %arrayidx.i.i.i355.1 = getelementptr inbounds %class.btVector3, ptr %call.i.i.i.i337, i64 %indvars.iv.next.i.i.i357
  %13 = load ptr, ptr %m_data.i.i.i351, align 8
  %arrayidx3.i.i.i356.1 = getelementptr inbounds %class.btVector3, ptr %13, i64 %indvars.iv.next.i.i.i357
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx.i.i.i355.1, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx3.i.i.i356.1, i64 16, i1 false)
  %indvars.iv.next.i.i.i357.1 = add nuw nsw i64 %indvars.iv.i.i.i354, 2
  %niter742.next.1 = add i64 %niter742, 2
  %niter742.ncmp.1 = icmp eq i64 %niter742.next.1, %unroll_iter741
  br i1 %niter742.ncmp.1, label %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i342.loopexit.unr-lcssa, label %for.body.i.i.i353

_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i342.loopexit.unr-lcssa: ; preds = %for.body.i.i.i353, %for.body.lr.ph.i.i.i350
  %indvars.iv.i.i.i354.unr = phi i64 [ 0, %for.body.lr.ph.i.i.i350 ], [ %indvars.iv.next.i.i.i357.1, %for.body.i.i.i353 ]
  %lcmp.mod740.not = icmp eq i64 %xtraiter739, 0
  br i1 %lcmp.mod740.not, label %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i342, label %for.body.i.i.i353.epil

for.body.i.i.i353.epil:                           ; preds = %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i342.loopexit.unr-lcssa
  %arrayidx.i.i.i355.epil = getelementptr inbounds %class.btVector3, ptr %call.i.i.i.i337, i64 %indvars.iv.i.i.i354.unr
  %14 = load ptr, ptr %m_data.i.i.i351, align 8
  %arrayidx3.i.i.i356.epil = getelementptr inbounds %class.btVector3, ptr %14, i64 %indvars.iv.i.i.i354.unr
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx.i.i.i355.epil, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx3.i.i.i356.epil, i64 16, i1 false)
  br label %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i342

_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i342: ; preds = %for.body.i.i.i353.epil, %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i342.loopexit.unr-lcssa, %_ZN20btAlignedObjectArrayI9btVector3E8allocateEi.exit.i.i339
  %m_data.i9.i.i343 = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 2, i32 5
  %15 = load ptr, ptr %m_data.i9.i.i343, align 8
  ...
  br i1 %or.cond.i.i347, label %if.end.i349, label %if.then3.i.i.i348

if.then3.i.i.i348:                                ; preds = %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i342
  tail call void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %15)
  br label %if.end.i349

if.end.i349:                                      ; preds = %if.then3.i.i.i348, %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i342
  store i8 1, ptr %m_ownsMemory.i.i.i345, align 8
  store ptr %call.i.i.i.i337, ptr %m_data.i9.i.i343, align 8
  store i32 %0, ptr %m_capacity.i.i.i322, align 8
  br label %_ZN20btAlignedObjectArrayI9btVector3E6resizeEiRKS0_.exit359

_ZN20btAlignedObjectArrayI9btVector3E6resizeEiRKS0_.exit359: ; preds = %if.then5.i321, %if.end.i349, %_ZN20btAlignedObjectArrayI9btVector3E6resizeEiRKS0_.exit
  store i32 %0, ptr %m_size.i.i317, align 4
  %m_size.i.i360 = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 3, i32 2
  %17 = load i32, ptr %m_size.i.i360, align 4
  %cmp4.i363 = icmp slt i32 %17, %0
  br i1 %cmp4.i363, label %if.then5.i364, label %_ZN20btAlignedObjectArrayIfE6resizeEiRKf.exit

if.then5.i364:                                    ; preds = %_ZN20btAlignedObjectArrayI9btVector3E6resizeEiRKS0_.exit359
  %m_capacity.i.i.i365 = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 3, i32 3
  %18 = load i32, ptr %m_capacity.i.i.i365, align 8
  %cmp.i.i366 = icmp slt i32 %18, %0
  br i1 %cmp.i.i366, label %_ZN20btAlignedObjectArrayIfE8allocateEi.exit.i.i, label %if.then5.i364.for.body10.lr.ph.i367_crit_edge

if.then5.i364.for.body10.lr.ph.i367_crit_edge:    ; preds = %if.then5.i364
  %m_data11.i368.phi.trans.insert = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 3, i32 5
  %.pre = load ptr, ptr %m_data11.i368.phi.trans.insert, align 8
  %.pre686 = sext i32 %0 to i64
  %.pre687 = shl nsw i64 %.pre686, 2
  br label %for.body10.lr.ph.i367

_ZN20btAlignedObjectArrayIfE8allocateEi.exit.i.i: ; preds = %if.then5.i364
  %conv.i.i.i.i378 = sext i32 %0 to i64
  %mul.i.i.i.i379 = shl nsw i64 %conv.i.i.i.i378, 2
  %call.i.i.i.i380 = tail call noundef ptr @_Z22btAlignedAllocInternalmi(i64 noundef %mul.i.i.i.i379, i32 noundef 16)
  %.pre.i381 = load i32, ptr %m_size.i.i360, align 4
  %cmp7.i.i.i383 = icmp sgt i32 %.pre.i381, 0
  %m_data.i.i.i384 = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 3, i32 5
  %19 = load ptr, ptr %m_data.i.i.i384, align 8
  br i1 %cmp7.i.i.i383, label %for.body.lr.ph.i.i.i390, label %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i

for.body.lr.ph.i.i.i390:                          ; preds = %_ZN20btAlignedObjectArrayIfE8allocateEi.exit.i.i
  %20 = ptrtoint ptr %19 to i64
  %call.i.i.i.i380700 = ptrtoint ptr %call.i.i.i.i380 to i64
  %wide.trip.count.i.i.i391 = zext i32 %.pre.i381 to i64
  %min.iters.check = icmp ult i32 %.pre.i381, 8
  %21 = sub i64 %call.i.i.i.i380700, %20
  %diff.check = icmp ult i64 %21, 32
  %or.cond731 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond731, label %for.body.i.i.i392.preheader, label %vector.ph

vector.ph:                                        ; preds = %for.body.lr.ph.i.i.i390
  %n.vec = and i64 %wide.trip.count.i.i.i391, 4294967288
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %22 = getelementptr inbounds float, ptr %call.i.i.i.i380, i64 %index
  %23 = getelementptr inbounds float, ptr %19, i64 %index
  %wide.load = load <4 x float>, ptr %23, align 4
  %24 = getelementptr inbounds float, ptr %23, i64 4
  %wide.load701 = load <4 x float>, ptr %24, align 4
  store <4 x float> %wide.load, ptr %22, align 4
  %25 = getelementptr inbounds float, ptr %22, i64 4
  store <4 x float> %wide.load701, ptr %25, align 4
  %index.next = add nuw i64 %index, 8
  %26 = icmp eq i64 %index.next, %n.vec
  br i1 %26, label %middle.block, label %vector.body

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.vec, %wide.trip.count.i.i.i391
  br i1 %cmp.n, label %if.then.i11.i.i, label %for.body.i.i.i392.preheader

for.body.i.i.i392.preheader:                      ; preds = %for.body.lr.ph.i.i.i390, %middle.block
  %indvars.iv.i.i.i393.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i390 ], [ %n.vec, %middle.block ]
  %27 = xor i64 %indvars.iv.i.i.i393.ph, -1
  %28 = add nsw i64 %27, %wide.trip.count.i.i.i391
  %xtraiter743 = and i64 %wide.trip.count.i.i.i391, 3
  %lcmp.mod744.not = icmp eq i64 %xtraiter743, 0
  br i1 %lcmp.mod744.not, label %for.body.i.i.i392.prol.loopexit, label %for.body.i.i.i392.prol

for.body.i.i.i392.prol:                           ; preds = %for.body.i.i.i392.preheader, %for.body.i.i.i392.prol
  %indvars.iv.i.i.i393.prol = phi i64 [ %indvars.iv.next.i.i.i396.prol, %for.body.i.i.i392.prol ], [ %indvars.iv.i.i.i393.ph, %for.body.i.i.i392.preheader ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body.i.i.i392.prol ], [ 0, %for.body.i.i.i392.preheader ]
  %arrayidx.i.i.i394.prol = getelementptr inbounds float, ptr %call.i.i.i.i380, i64 %indvars.iv.i.i.i393.prol
  %arrayidx3.i.i.i395.prol = getelementptr inbounds float, ptr %19, i64 %indvars.iv.i.i.i393.prol
  %29 = load float, ptr %arrayidx3.i.i.i395.prol, align 4
  store float %29, ptr %arrayidx.i.i.i394.prol, align 4
  ...
  br i1 %prol.iter.cmp.not, label %for.body.i.i.i392.prol.loopexit, label %for.body.i.i.i392.prol

for.body.i.i.i392.prol.loopexit:                  ; preds = %for.body.i.i.i392.prol, %for.body.i.i.i392.preheader
  %indvars.iv.i.i.i393.unr = phi i64 [ %indvars.iv.i.i.i393.ph, %for.body.i.i.i392.preheader ], [ %indvars.iv.next.i.i.i396.prol, %for.body.i.i.i392.prol ]
  %30 = icmp ult i64 %28, 3
  br i1 %30, label %if.then.i11.i.i, label %for.body.i.i.i392

for.body.i.i.i392:                                ; preds = %for.body.i.i.i392.prol.loopexit, %for.body.i.i.i392
  %indvars.iv.i.i.i393 = phi i64 [ %indvars.iv.next.i.i.i396.3, %for.body.i.i.i392 ], [ %indvars.iv.i.i.i393.unr, %for.body.i.i.i392.prol.loopexit ]
  %arrayidx.i.i.i394 = getelementptr inbounds float, ptr %call.i.i.i.i380, i64 %indvars.iv.i.i.i393
  %arrayidx3.i.i.i395 = getelementptr inbounds float, ptr %19, i64 %indvars.iv.i.i.i393
  %31 = load float, ptr %arrayidx3.i.i.i395, align 4
  store float %31, ptr %arrayidx.i.i.i394, align 4
  %indvars.iv.next.i.i.i396 = add nuw nsw i64 %indvars.iv.i.i.i393, 1
  %arrayidx.i.i.i394.1 = getelementptr inbounds float, ptr %call.i.i.i.i380, i64 %indvars.iv.next.i.i.i396
  %arrayidx3.i.i.i395.1 = getelementptr inbounds float, ptr %19, i64 %indvars.iv.next.i.i.i396
  %32 = load float, ptr %arrayidx3.i.i.i395.1, align 4
  store float %32, ptr %arrayidx.i.i.i394.1, align 4
  %indvars.iv.next.i.i.i396.1 = add nuw nsw i64 %indvars.iv.i.i.i393, 2
  %arrayidx.i.i.i394.2 = getelementptr inbounds float, ptr %call.i.i.i.i380, i64 %indvars.iv.next.i.i.i396.1
  %arrayidx3.i.i.i395.2 = getelementptr inbounds float, ptr %19, i64 %indvars.iv.next.i.i.i396.1
  %33 = load float, ptr %arrayidx3.i.i.i395.2, align 4
  store float %33, ptr %arrayidx.i.i.i394.2, align 4
  %indvars.iv.next.i.i.i396.2 = add nuw nsw i64 %indvars.iv.i.i.i393, 3
  %arrayidx.i.i.i394.3 = getelementptr inbounds float, ptr %call.i.i.i.i380, i64 %indvars.iv.next.i.i.i396.2
  %arrayidx3.i.i.i395.3 = getelementptr inbounds float, ptr %19, i64 %indvars.iv.next.i.i.i396.2
  %34 = load float, ptr %arrayidx3.i.i.i395.3, align 4
  store float %34, ptr %arrayidx.i.i.i394.3, align 4
  ...
  br i1 %exitcond.not.i.i.i397.3, label %if.then.i11.i.i, label %for.body.i.i.i392
...
if.end.thread36.i:                                ; preds = %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i
  ...
  store ptr %call.i.i.i.i380, ptr %m_data.i.i.i384, align 8
  store i32 %0, ptr %m_capacity.i.i.i365, align 8
  br label %for.body10.lr.ph.i367

if.then.i11.i.i:                                  ; preds = %for.body.i.i.i392.prol.loopexit, %for.body.i.i.i392, %middle.block, %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i
  %m_ownsMemory.i.i.i386 = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 3, i32 6
  %35 = load i8, ptr %m_ownsMemory.i.i.i386, align 8
...
if.end.i389:                                      ; preds = %if.then3.i.i.i388, %if.then.i11.i.i
  store i8 1, ptr %m_ownsMemory.i.i.i386, align 8
  store ptr %call.i.i.i.i380, ptr %m_data.i.i.i384, align 8
  store i32 %0, ptr %m_capacity.i.i.i365, align 8
  br label %for.body10.lr.ph.i367

for.body10.lr.ph.i367:                            ; preds = %if.then5.i364.for.body10.lr.ph.i367_crit_edge, %if.end.i389, %if.end.thread36.i
  %.pre-phi = phi i64 [ %.pre687, %if.then5.i364.for.body10.lr.ph.i367_crit_edge ], [ %mul.i.i.i.i379, %if.end.i389 ], [ %mul.i.i.i.i379, %if.end.thread36.i ]
  %36 = phi ptr [ %.pre, %if.then5.i364.for.body10.lr.ph.i367_crit_edge ], [ %call.i.i.i.i380, %if.end.i389 ], [ %call.i.i.i.i380, %if.end.thread36.i ]
  %37 = sext i32 %17 to i64
  %38 = shl nsw i64 %37, 2
  %scevgep = getelementptr i8, ptr %36, i64 %38
  %39 = sub nsw i64 %.pre-phi, %38
  tail call void @llvm.memset.p0.i64(ptr align 4 %scevgep, i8 0, i64 %39, i1 false)
  br label %_ZN20btAlignedObjectArrayIfE6resizeEiRKf.exit

_ZN20btAlignedObjectArrayIfE6resizeEiRKf.exit:    ; preds = %for.body10.lr.ph.i367, %_ZN20btAlignedObjectArrayI9btVector3E6resizeEiRKS0_.exit359
  store i32 %0, ptr %m_size.i.i360, align 4
  %m_size.i.i398 = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 4, i32 2
  %40 = load i32, ptr %m_size.i.i398, align 4
  %cmp4.i401 = icmp slt i32 %40, %0
  br i1 %cmp4.i401, label %if.then5.i402, label %_ZN20btAlignedObjectArrayIfE6resizeEiRKf.exit442

if.then5.i402:                                    ; preds = %_ZN20btAlignedObjectArrayIfE6resizeEiRKf.exit
  %m_capacity.i.i.i403 = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 4, i32 3
  %41 = load i32, ptr %m_capacity.i.i.i403, align 8
  %cmp.i.i404 = icmp slt i32 %41, %0
  br i1 %cmp.i.i404, label %_ZN20btAlignedObjectArrayIfE8allocateEi.exit.i.i420, label %if.then5.i402.for.body10.lr.ph.i405_crit_edge

if.then5.i402.for.body10.lr.ph.i405_crit_edge:    ; preds = %if.then5.i402
  %m_data11.i406.phi.trans.insert = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 4, i32 5
  %.pre682 = load ptr, ptr %m_data11.i406.phi.trans.insert, align 8
  %.pre688 = sext i32 %0 to i64
  %.pre689 = shl nsw i64 %.pre688, 2
  br label %for.body10.lr.ph.i405

_ZN20btAlignedObjectArrayIfE8allocateEi.exit.i.i420: ; preds = %if.then5.i402
  %conv.i.i.i.i416 = sext i32 %0 to i64
  %mul.i.i.i.i417 = shl nsw i64 %conv.i.i.i.i416, 2
  %call.i.i.i.i418 = tail call noundef ptr @_Z22btAlignedAllocInternalmi(i64 noundef %mul.i.i.i.i417, i32 noundef 16)
  %.pre.i419 = load i32, ptr %m_size.i.i398, align 4
  %cmp7.i.i.i422 = icmp sgt i32 %.pre.i419, 0
  %m_data.i.i.i423 = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 4, i32 5
  %42 = load ptr, ptr %m_data.i.i.i423, align 8
  br i1 %cmp7.i.i.i422, label %for.body.lr.ph.i.i.i434, label %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i424

for.body.lr.ph.i.i.i434:                          ; preds = %_ZN20btAlignedObjectArrayIfE8allocateEi.exit.i.i420
  %43 = ptrtoint ptr %42 to i64
  %call.i.i.i.i418703 = ptrtoint ptr %call.i.i.i.i418 to i64
  %wide.trip.count.i.i.i435 = zext i32 %.pre.i419 to i64
  %min.iters.check707 = icmp ult i32 %.pre.i419, 8
  %44 = sub i64 %call.i.i.i.i418703, %43
  %diff.check704 = icmp ult i64 %44, 32
  %or.cond732 = select i1 %min.iters.check707, i1 true, i1 %diff.check704
  br i1 %or.cond732, label %for.body.i.i.i436.preheader, label %vector.ph708

vector.ph708:                                     ; preds = %for.body.lr.ph.i.i.i434
  %n.vec710 = and i64 %wide.trip.count.i.i.i435, 4294967288
  br label %vector.body713

vector.body713:                                   ; preds = %vector.body713, %vector.ph708
  %index714 = phi i64 [ 0, %vector.ph708 ], [ %index.next717, %vector.body713 ]
  %45 = getelementptr inbounds float, ptr %call.i.i.i.i418, i64 %index714
  %46 = getelementptr inbounds float, ptr %42, i64 %index714
  %wide.load715 = load <4 x float>, ptr %46, align 4
  %47 = getelementptr inbounds float, ptr %46, i64 4
  %wide.load716 = load <4 x float>, ptr %47, align 4
  store <4 x float> %wide.load715, ptr %45, align 4
  %48 = getelementptr inbounds float, ptr %45, i64 4
  store <4 x float> %wide.load716, ptr %48, align 4
  %index.next717 = add nuw i64 %index714, 8
  %49 = icmp eq i64 %index.next717, %n.vec710
  br i1 %49, label %middle.block705, label %vector.body713

middle.block705:                                  ; preds = %vector.body713
  %cmp.n712 = icmp eq i64 %n.vec710, %wide.trip.count.i.i.i435
  br i1 %cmp.n712, label %if.then.i11.i.i426, label %for.body.i.i.i436.preheader

for.body.i.i.i436.preheader:                      ; preds = %for.body.lr.ph.i.i.i434, %middle.block705
  %indvars.iv.i.i.i437.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i434 ], [ %n.vec710, %middle.block705 ]
  %50 = xor i64 %indvars.iv.i.i.i437.ph, -1
  %51 = add nsw i64 %50, %wide.trip.count.i.i.i435
  %xtraiter745 = and i64 %wide.trip.count.i.i.i435, 3
  %lcmp.mod746.not = icmp eq i64 %xtraiter745, 0
  br i1 %lcmp.mod746.not, label %for.body.i.i.i436.prol.loopexit, label %for.body.i.i.i436.prol

for.body.i.i.i436.prol:                           ; preds = %for.body.i.i.i436.preheader, %for.body.i.i.i436.prol
  %indvars.iv.i.i.i437.prol = phi i64 [ %indvars.iv.next.i.i.i440.prol, %for.body.i.i.i436.prol ], [ %indvars.iv.i.i.i437.ph, %for.body.i.i.i436.preheader ]
  %prol.iter747 = phi i64 [ %prol.iter747.next, %for.body.i.i.i436.prol ], [ 0, %for.body.i.i.i436.preheader ]
  %arrayidx.i.i.i438.prol = getelementptr inbounds float, ptr %call.i.i.i.i418, i64 %indvars.iv.i.i.i437.prol
  %arrayidx3.i.i.i439.prol = getelementptr inbounds float, ptr %42, i64 %indvars.iv.i.i.i437.prol
  %52 = load float, ptr %arrayidx3.i.i.i439.prol, align 4
  store float %52, ptr %arrayidx.i.i.i438.prol, align 4
  %indvars.iv.next.i.i.i440.prol = add nuw nsw i64 %indvars.iv.i.i.i437.prol, 1
  %prol.iter747.next = add i64 %prol.iter747, 1
  %prol.iter747.cmp.not = icmp eq i64 %prol.iter747.next, %xtraiter745
  br i1 %prol.iter747.cmp.not, label %for.body.i.i.i436.prol.loopexit, label %for.body.i.i.i436.prol

for.body.i.i.i436.prol.loopexit:                  ; preds = %for.body.i.i.i436.prol, %for.body.i.i.i436.preheader
  %indvars.iv.i.i.i437.unr = phi i64 [ %indvars.iv.i.i.i437.ph, %for.body.i.i.i436.preheader ], [ %indvars.iv.next.i.i.i440.prol, %for.body.i.i.i436.prol ]
  %53 = icmp ult i64 %51, 3
  br i1 %53, label %if.then.i11.i.i426, label %for.body.i.i.i436

for.body.i.i.i436:                                ; preds = %for.body.i.i.i436.prol.loopexit, %for.body.i.i.i436
  %indvars.iv.i.i.i437 = phi i64 [ %indvars.iv.next.i.i.i440.3, %for.body.i.i.i436 ], [ %indvars.iv.i.i.i437.unr, %for.body.i.i.i436.prol.loopexit ]
  %arrayidx.i.i.i438 = getelementptr inbounds float, ptr %call.i.i.i.i418, i64 %indvars.iv.i.i.i437
  %arrayidx3.i.i.i439 = getelementptr inbounds float, ptr %42, i64 %indvars.iv.i.i.i437
  %54 = load float, ptr %arrayidx3.i.i.i439, align 4
  store float %54, ptr %arrayidx.i.i.i438, align 4
  %indvars.iv.next.i.i.i440 = add nuw nsw i64 %indvars.iv.i.i.i437, 1
  %arrayidx.i.i.i438.1 = getelementptr inbounds float, ptr %call.i.i.i.i418, i64 %indvars.iv.next.i.i.i440
  %arrayidx3.i.i.i439.1 = getelementptr inbounds float, ptr %42, i64 %indvars.iv.next.i.i.i440
  %55 = load float, ptr %arrayidx3.i.i.i439.1, align 4
  store float %55, ptr %arrayidx.i.i.i438.1, align 4
  %indvars.iv.next.i.i.i440.1 = add nuw nsw i64 %indvars.iv.i.i.i437, 2
  %arrayidx.i.i.i438.2 = getelementptr inbounds float, ptr %call.i.i.i.i418, i64 %indvars.iv.next.i.i.i440.1
  %arrayidx3.i.i.i439.2 = getelementptr inbounds float, ptr %42, i64 %indvars.iv.next.i.i.i440.1
  %56 = load float, ptr %arrayidx3.i.i.i439.2, align 4
  store float %56, ptr %arrayidx.i.i.i438.2, align 4
  %indvars.iv.next.i.i.i440.2 = add nuw nsw i64 %indvars.iv.i.i.i437, 3
  %arrayidx.i.i.i438.3 = getelementptr inbounds float, ptr %call.i.i.i.i418, i64 %indvars.iv.next.i.i.i440.2
  %arrayidx3.i.i.i439.3 = getelementptr inbounds float, ptr %42, i64 %indvars.iv.next.i.i.i440.2
  %57 = load float, ptr %arrayidx3.i.i.i439.3, align 4
  store float %57, ptr %arrayidx.i.i.i438.3, align 4
  %indvars.iv.next.i.i.i440.3 = add nuw nsw i64 %indvars.iv.i.i.i437, 4
  %exitcond.not.i.i.i441.3 = icmp eq i64 %indvars.iv.next.i.i.i440.3, %wide.trip.count.i.i.i435
  br i1 %exitcond.not.i.i.i441.3, label %if.then.i11.i.i426, label %for.body.i.i.i436

_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i424: ; preds = %_ZN20btAlignedObjectArrayIfE8allocateEi.exit.i.i420
  %tobool.not.i10.i.i425 = icmp eq ptr %42, null
  br i1 %tobool.not.i10.i.i425, label %if.end.thread36.i432, label %if.then.i11.i.i426

if.end.thread36.i432:                             ; preds = %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i424
  %m_ownsMemory.i37.i433 = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 4, i32 6
  store i8 1, ptr %m_ownsMemory.i37.i433, align 8
  store ptr %call.i.i.i.i418, ptr %m_data.i.i.i423, align 8
  store i32 %0, ptr %m_capacity.i.i.i403, align 8
  br label %for.body10.lr.ph.i405

if.then.i11.i.i426:                               ; preds = %for.body.i.i.i436.prol.loopexit, %for.body.i.i.i436, %middle.block705, %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i424
  %m_ownsMemory.i.i.i427 = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 4, i32 6
  %58 = load i8, ptr %m_ownsMemory.i.i.i427, align 8
  %tobool2.not.i.i.i428 = icmp eq i8 %58, 0
  br i1 %tobool2.not.i.i.i428, label %if.end.i430, label %if.then3.i.i.i429

if.then3.i.i.i429:                                ; preds = %if.then.i11.i.i426
  tail call void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %42)
  br label %if.end.i430

if.end.i430:                                      ; preds = %if.then3.i.i.i429, %if.then.i11.i.i426
  store i8 1, ptr %m_ownsMemory.i.i.i427, align 8
  store ptr %call.i.i.i.i418, ptr %m_data.i.i.i423, align 8
  store i32 %0, ptr %m_capacity.i.i.i403, align 8
  br label %for.body10.lr.ph.i405

for.body10.lr.ph.i405:                            ; preds = %if.then5.i402.for.body10.lr.ph.i405_crit_edge, %if.end.i430, %if.end.thread36.i432
  %.pre-phi690 = phi i64 [ %.pre689, %if.then5.i402.for.body10.lr.ph.i405_crit_edge ], [ %mul.i.i.i.i417, %if.end.i430 ], [ %mul.i.i.i.i417, %if.end.thread36.i432 ]
  %59 = phi ptr [ %.pre682, %if.then5.i402.for.body10.lr.ph.i405_crit_edge ], [ %call.i.i.i.i418, %if.end.i430 ], [ %call.i.i.i.i418, %if.end.thread36.i432 ]
  %60 = sext i32 %40 to i64
  %61 = shl nsw i64 %60, 2
  %scevgep667 = getelementptr i8, ptr %59, i64 %61
  %62 = sub nsw i64 %.pre-phi690, %61
  tail call void @llvm.memset.p0.i64(ptr align 4 %scevgep667, i8 0, i64 %62, i1 false)
  br label %_ZN20btAlignedObjectArrayIfE6resizeEiRKf.exit442

_ZN20btAlignedObjectArrayIfE6resizeEiRKf.exit442: ; preds = %for.body10.lr.ph.i405, %_ZN20btAlignedObjectArrayIfE6resizeEiRKf.exit
  store i32 %0, ptr %m_size.i.i398, align 4
...
for.body.lr.ph:                                   ; preds = %_ZN20btAlignedObjectArrayIfE6resizeEiRKf.exit442
  ...
  %64 = load ptr, ptr %m_data.i444, align 8
  %m_data.i447 = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 3, i32 5
  %65 = load ptr, ptr %m_data.i447, align 8
  %wide.trip.count = zext i32 %63 to i64
  %min.iters.check722 = icmp ult i32 %63, 8
  %66 = ptrtoint ptr %65 to i64
  %67 = ptrtoint ptr %64 to i64
  %68 = sub i64 %66, %67
  %diff.check719 = icmp ult i64 %68, 32
  %or.cond735 = select i1 %min.iters.check722, i1 true, i1 %diff.check719
  br i1 %or.cond735, label %for.body.preheader, label %vector.ph723

vector.ph723:                                     ; preds = %for.body.lr.ph
  %n.vec725 = and i64 %wide.trip.count, 4294967288
  br label %vector.body728

vector.body728:                                   ; preds = %vector.body728, %vector.ph723
  %index729 = phi i64 [ 0, %vector.ph723 ], [ %index.next730, %vector.body728 ]
  %69 = getelementptr inbounds float, ptr %64, i64 %index729
  store <4 x float> zeroinitializer, ptr %69, align 4
  %70 = getelementptr inbounds float, ptr %69, i64 4
  store <4 x float> zeroinitializer, ptr %70, align 4
  %71 = getelementptr inbounds float, ptr %65, i64 %index729
  store <4 x float> zeroinitializer, ptr %71, align 4
  %72 = getelementptr inbounds float, ptr %71, i64 4
  store <4 x float> zeroinitializer, ptr %72, align 4
  %index.next730 = add nuw i64 %index729, 8
  %73 = icmp eq i64 %index.next730, %n.vec725
  br i1 %73, label %middle.block720, label %vector.body728

middle.block720:                                  ; preds = %vector.body728
  %cmp.n727 = icmp eq i64 %n.vec725, %wide.trip.count
  br i1 %cmp.n727, label %for.cond16.preheader, label %for.body.preheader

for.body.preheader:                               ; preds = %for.body.lr.ph, %middle.block720
  %indvars.iv.ph = phi i64 [ 0, %for.body.lr.ph ], [ %n.vec725, %middle.block720 ]
  %74 = xor i64 %indvars.iv.ph, -1
  %75 = add nsw i64 %74, %wide.trip.count
  %xtraiter748 = and i64 %wide.trip.count, 3
  %lcmp.mod749.not = icmp eq i64 %xtraiter748, 0
  br i1 %lcmp.mod749.not, label %for.body.prol.loopexit, label %for.body.prol

for.body.prol:                                    ; preds = %for.body.preheader, %for.body.prol
  %indvars.iv.prol = phi i64 [ %indvars.iv.next.prol, %for.body.prol ], [ %indvars.iv.ph, %for.body.preheader ]
  %prol.iter750 = phi i64 [ %prol.iter750.next, %for.body.prol ], [ 0, %for.body.preheader ]
  %arrayidx.i446.prol = getelementptr inbounds float, ptr %64, i64 %indvars.iv.prol
  store float 0.000000e+00, ptr %arrayidx.i446.prol, align 4
  %arrayidx.i449.prol = getelementptr inbounds float, ptr %65, i64 %indvars.iv.prol
  store float 0.000000e+00, ptr %arrayidx.i449.prol, align 4
  %indvars.iv.next.prol = add nuw nsw i64 %indvars.iv.prol, 1
  %prol.iter750.next = add i64 %prol.iter750, 1
  %prol.iter750.cmp.not = icmp eq i64 %prol.iter750.next, %xtraiter748
  br i1 %prol.iter750.cmp.not, label %for.body.prol.loopexit, label %for.body.prol
...
for.cond16.preheader:                             ; preds = %for.body.prol.loopexit, %for.body, %middle.block720
...
for.body87.lr.ph:                                 ; preds = %for.cond83.preheader
  ...
  %.pre684 = load ptr, ptr %m_data.i518, align 8
  br label %for.body87
...
for.body20:                                       ; preds = %for.body20.lr.ph, %if.end79
  ...
  %78 = load ptr, ptr %m_data.i451, align 8
  ...
  %79 = load ptr, ptr %m_groundObject26, align 8
...
if.then28:                                        ; preds = %for.body20
  ...
  %80 = load i32, ptr %m_indexRightAxis, align 8
  ...
  %81 = load float, ptr %arrayidx, align 4
  %82 = load float, ptr %arrayidx38, align 4
  %83 = load float, ptr %arrayidx43, align 4
  %84 = load ptr, ptr %m_data.i456, align 8
  %arrayidx.i458 = getelementptr inbounds %class.btVector3, ptr %84, i64 %indvars.iv669
  store float %81, ptr %arrayidx.i458, align 4
  %ref.tmp31.sroa.4.0.arrayidx.i458.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i458, i64 4
  store float %82, ptr %ref.tmp31.sroa.4.0.arrayidx.i458.sroa_idx, align 4
  %ref.tmp31.sroa.5.0.arrayidx.i458.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i458, i64 8
  store float %83, ptr %ref.tmp31.sroa.5.0.arrayidx.i458.sroa_idx, align 4
  %ref.tmp31.sroa.6.0.arrayidx.i458.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i458, i64 12
  store float 0.000000e+00, ptr %ref.tmp31.sroa.6.0.arrayidx.i458.sroa_idx, align 4
  %85 = load ptr, ptr %m_data.i456, align 8
  ...
  %86 = load float, ptr %arrayidx10.i464, align 4
  %arrayidx12.i465 = getelementptr inbounds [4 x float], ptr %arrayidx.i453, i64 0, i64 2
  %87 = load float, ptr %arrayidx12.i465, align 4
  %88 = load <2 x float>, ptr %arrayidx.i461, align 4
  %89 = load <2 x float>, ptr %arrayidx.i453, align 4
  ...
  store <2 x float> %105, ptr %arrayidx.i461, align 4
  %mul7.i.i.i = fmul float %sub13.i, %div.i.i
  store float %mul7.i.i.i, ptr %arrayidx10.i464, align 4
  %106 = extractelement <2 x float> %105, i64 1
  %107 = load float, ptr %arrayidx.i453, align 4
  %108 = extractelement <2 x float> %105, i64 0
  %109 = load <2 x float>, ptr %arrayidx7.i463, align 4
  ...
  %121 = load ptr, ptr %m_data.i494, align 8
  %arrayidx.i496 = getelementptr inbounds %class.btVector3, ptr %121, i64 %indvars.iv669
  store <2 x float> %117, ptr %arrayidx.i496, align 4
  %ref.tmp60.sroa.4.0.call66.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i496, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i491, ptr %ref.tmp60.sroa.4.0.call66.sroa_idx, align 4
  %122 = load ptr, ptr %m_data.i494, align 8
  ...
  %123 = load float, ptr %arrayidx10.i.i.i.i502, align 4
  %124 = load <2 x float>, ptr %arrayidx.i499, align 4
  ...
  %135 = load float, ptr @sideFrictionStiffness2, align 4
  %136 = load ptr, ptr %m_data.i511, align 8
  %arrayidx.i516 = getelementptr inbounds float, ptr %136, i64 %indvars.iv669
  %137 = load float, ptr %arrayidx.i516, align 4
  %mul = fmul float %135, %137
  store float %mul, ptr %arrayidx.i516, align 4
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %wheelBasis0) #20
  %.pre683 = load i32, ptr %m_size.i.i, align 4
  br label %if.end79
...
for.cond.cleanup86:                               ; preds = %if.end140
  ...
  %cmp149662 = icmp sgt i32 %236, 0
  %or.cond = and i1 %141, %cmp149662
...
for.body87:                                       ; preds = %for.body87.lr.ph, %if.end140
  ...
  %147 = phi ptr [ %.pre684, %for.body87.lr.ph ], [ %235, %if.end140 ]
  ...
  %arrayidx.i520 = getelementptr inbounds %struct.btWheelInfo, ptr %147, i64 %indvars.iv672
  %m_groundObject93 = getelementptr inbounds %"struct.btWheelInfo::RaycastInfo", ptr %arrayidx.i520, i64 0, i32 7
  %148 = load ptr, ptr %m_groundObject93, align 8
  %tobool94.not = icmp eq ptr %148, null
  br i1 %tobool94.not, label %if.end109, label %if.then95

if.then95:                                        ; preds = %for.body87
  %m_engineForce = getelementptr inbounds %struct.btWheelInfo, ptr %147, i64 %indvars.iv672, i32 16
  %149 = load float, ptr %m_engineForce, align 4
  %cmp96 = fcmp une float %149, 0.000000e+00
  br i1 %cmp96, label %if.then97, label %if.else

if.then97:                                        ; preds = %if.then95
  %mul99 = fmul float %149, %timeStep
  br label %if.then115

if.else:                                          ; preds = %if.then95
  %m_brake = getelementptr inbounds %struct.btWheelInfo, ptr %147, i64 %indvars.iv672, i32 17
  %150 = load float, ptr %m_brake, align 8
  %tobool100.inv = fcmp oeq float %150, 0.000000e+00
  %. = select i1 %tobool100.inv, float 0.000000e+00, float %150
  call void @llvm.lifetime.start.p0(i64 56, ptr nonnull %contactPt) #20
  %151 = load ptr, ptr %m_chassisBody102, align 8
  %m_contactPointWS104 = getelementptr inbounds %"struct.btWheelInfo::RaycastInfo", ptr %arrayidx.i520, i64 0, i32 1
  %152 = load ptr, ptr %m_data.i521, align 8
  %arrayidx.i523 = getelementptr inbounds %class.btVector3, ptr %152, i64 %indvars.iv672
  call void @_ZN19btWheelContactPointC2EP11btRigidBodyS1_RK9btVector3S4_f(ptr noundef nonnull align 8 dereferenceable(56) %contactPt, ptr noundef %151, ptr noundef nonnull %148, ptr noundef nonnull align 4 dereferenceable(16) %m_contactPointWS104, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx.i523, float noundef %.)
  %153 = load ptr, ptr %contactPt, align 8
  %m_origin.i.i.i = getelementptr inbounds %class.btCollisionObject, ptr %153, i64 0, i32 1, i32 1
  %154 = load <4 x float>, ptr %m_frictionPositionWorld.i, align 8
  %155 = load float, ptr %m_origin.i.i.i, align 4
  %156 = load <4 x float>, ptr %arrayidx5.i.i, align 4
  %arrayidx7.i.i = getelementptr inbounds %class.btCollisionObject, ptr %153, i64 0, i32 1, i32 1, i32 0, i64 1
  %157 = load float, ptr %arrayidx7.i.i, align 4
  %158 = load <4 x float>, ptr %arrayidx11.i.i, align 8
  %arrayidx13.i.i = getelementptr inbounds %class.btCollisionObject, ptr %153, i64 0, i32 1, i32 1, i32 0, i64 2
  %159 = load float, ptr %arrayidx13.i.i, align 4
  %160 = load ptr, ptr %m_body1.i, align 8
  %m_origin.i.i23.i = getelementptr inbounds %class.btCollisionObject, ptr %160, i64 0, i32 1, i32 1
  %161 = load float, ptr %m_origin.i.i23.i, align 4
  %arrayidx7.i26.i = getelementptr inbounds %class.btCollisionObject, ptr %160, i64 0, i32 1, i32 1, i32 0, i64 1
  %162 = load float, ptr %arrayidx7.i26.i, align 4
  %arrayidx13.i29.i = getelementptr inbounds %class.btCollisionObject, ptr %160, i64 0, i32 1, i32 1, i32 0, i64 2
  %163 = load float, ptr %arrayidx13.i29.i, align 4
  %164 = load float, ptr %m_maxImpulse.i, align 4
  %m_linearVelocity.i.i = getelementptr inbounds %class.btRigidBody, ptr %153, i64 0, i32 2
  %m_angularVelocity.i.i = getelementptr inbounds %class.btRigidBody, ptr %153, i64 0, i32 3
  %arrayidx.i.i.i524 = getelementptr inbounds %class.btRigidBody, ptr %153, i64 0, i32 3, i32 0, i64 1
  %165 = load float, ptr %arrayidx.i.i.i524, align 4
  %arrayidx5.i.i.i = getelementptr inbounds %class.btRigidBody, ptr %153, i64 0, i32 3, i32 0, i64 2
  %166 = load float, ptr %arrayidx5.i.i.i, align 4
  %167 = load float, ptr %m_angularVelocity.i.i, align 4
  %168 = load float, ptr %m_linearVelocity.i.i, align 4
  %arrayidx5.i5.i.i = getelementptr inbounds %class.btRigidBody, ptr %153, i64 0, i32 2, i32 0, i64 1
  %169 = load float, ptr %arrayidx5.i5.i.i, align 4
  %arrayidx11.i.i.i = getelementptr inbounds %class.btRigidBody, ptr %153, i64 0, i32 2, i32 0, i64 2
  %170 = load float, ptr %arrayidx11.i.i.i, align 4
  %m_linearVelocity.i36.i = getelementptr inbounds %class.btRigidBody, ptr %160, i64 0, i32 2
  %m_angularVelocity.i37.i = getelementptr inbounds %class.btRigidBody, ptr %160, i64 0, i32 3
  %arrayidx.i.i38.i = getelementptr inbounds %class.btRigidBody, ptr %160, i64 0, i32 3, i32 0, i64 1
  %171 = load float, ptr %arrayidx.i.i38.i, align 4
  %arrayidx5.i.i40.i = getelementptr inbounds %class.btRigidBody, ptr %160, i64 0, i32 3, i32 0, i64 2
  %172 = load float, ptr %arrayidx5.i.i40.i, align 4
  %173 = load float, ptr %m_angularVelocity.i37.i, align 4
  %174 = load float, ptr %m_linearVelocity.i36.i, align 4
  %arrayidx5.i5.i46.i = getelementptr inbounds %class.btRigidBody, ptr %160, i64 0, i32 2, i32 0, i64 1
  %175 = load float, ptr %arrayidx5.i5.i46.i, align 4
  %arrayidx11.i.i48.i = getelementptr inbounds %class.btRigidBody, ptr %160, i64 0, i32 2, i32 0, i64 2
  %176 = load float, ptr %arrayidx11.i.i48.i, align 4
  %177 = shufflevector <4 x float> %154, <4 x float> poison, <2 x i32> zeroinitializer
  %178 = insertelement <2 x float> poison, float %155, i64 0
  %179 = insertelement <2 x float> %178, float %161, i64 1
  %180 = fsub <2 x float> %177, %179
  %181 = shufflevector <4 x float> %156, <4 x float> poison, <2 x i32> zeroinitializer
  ...
  %185 = insertelement <2 x float> poison, float %165, i64 0
  %186 = insertelement <2 x float> %185, float %171, i64 1
  %187 = fneg <2 x float> %186
  %188 = fmul <2 x float> %180, %187
  %189 = insertelement <2 x float> poison, float %167, i64 0
  %190 = insertelement <2 x float> %189, float %173, i64 1
  %191 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %190, <2 x float> %184, <2 x float> %188)
  %192 = shufflevector <4 x float> %158, <4 x float> poison, <2 x i32> zeroinitializer
  %193 = insertelement <2 x float> poison, float %159, i64 0
  %194 = insertelement <2 x float> %193, float %163, i64 1
  %195 = fsub <2 x float> %192, %194
  %196 = insertelement <2 x float> poison, float %166, i64 0
  %197 = insertelement <2 x float> %196, float %172, i64 1
  %198 = fneg <2 x float> %197
  %199 = fmul <2 x float> %184, %198
  %200 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %186, <2 x float> %195, <2 x float> %199)
  %201 = insertelement <2 x float> poison, float %168, i64 0
  %202 = insertelement <2 x float> %201, float %174, i64 1
  %203 = fadd <2 x float> %200, %202
  %204 = fneg <2 x float> %190
  %205 = fmul <2 x float> %195, %204
  %206 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %197, <2 x float> %180, <2 x float> %205)
  %207 = insertelement <2 x float> poison, float %169, i64 0
  %208 = insertelement <2 x float> %207, float %175, i64 1
  %209 = fadd <2 x float> %208, %206
  %210 = insertelement <2 x float> poison, float %170, i64 0
  %211 = insertelement <2 x float> %210, float %176, i64 1
  %212 = fadd <2 x float> %191, %211
  %shift = shufflevector <2 x float> %203, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %213 = fsub <2 x float> %203, %shift
  %sub.i55.i = extractelement <2 x float> %213, i64 0
  %shift736 = shufflevector <2 x float> %209, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %214 = fsub <2 x float> %209, %shift736
  %sub8.i58.i = extractelement <2 x float> %214, i64 0
  %shift737 = shufflevector <2 x float> %212, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %215 = fsub <2 x float> %212, %shift737
  %sub14.i61.i = extractelement <2 x float> %215, i64 0
  %216 = load float, ptr %m_frictionDirectionWorld.i, align 8
  %217 = load float, ptr %arrayidx5.i67.i, align 4
  %mul8.i.i = fmul float %sub8.i58.i, %217
  %218 = call float @llvm.fmuladd.f32(float %216, float %sub.i55.i, float %mul8.i.i)
  %219 = load float, ptr %arrayidx10.i.i, align 8
  %220 = call float @llvm.fmuladd.f32(float %219, float %sub14.i61.i, float %218)
  %fneg.i = fneg float %220
  %221 = load float, ptr %m_jacDiagABInv.i, align 8
  %mul.i525 = fmul float %221, %fneg.i
  %cmp.i.i526 = fcmp olt float %164, %mul.i525
  %j1.0.i = select i1 %cmp.i.i526, float %164, float %mul.i525
  %fneg14.i = fneg float %164
  ...
  %.pre685 = load ptr, ptr %m_data.i518, align 8
  br label %if.then115

if.end109:                                        ; preds = %for.body87
  %222 = load ptr, ptr %m_data.i527644, align 8
  %arrayidx.i529 = getelementptr inbounds float, ptr %222, i64 %indvars.iv672
  store float 0.000000e+00, ptr %arrayidx.i529, align 4
  %m_skidInfo = getelementptr inbounds %struct.btWheelInfo, ptr %145, i64 %indvars.iv672, i32 23
...
if.then115:                                       ; preds = %if.then97, %if.else
  ...
  %225 = phi ptr [ %.pre685, %if.else ], [ %147, %if.then97 ]
  %rollingFriction.0.ph = phi float [ %j1.1.i, %if.else ], [ %mul99, %if.then97 ]
  %226 = load ptr, ptr %m_data.i527644, align 8
  %arrayidx.i529645 = getelementptr inbounds float, ptr %226, i64 %indvars.iv672
  store float 0.000000e+00, ptr %arrayidx.i529645, align 4
  %m_skidInfo647 = getelementptr inbounds %struct.btWheelInfo, ptr %225, i64 %indvars.iv672, i32 23
  store float 1.000000e+00, ptr %m_skidInfo647, align 4
  %m_wheelsSuspensionForce = getelementptr inbounds %struct.btWheelInfo, ptr %147, i64 %indvars.iv672, i32 22
  %227 = load float, ptr %m_wheelsSuspensionForce, align 8
  %mul119 = fmul float %227, %timeStep
  %m_frictionSlip = getelementptr inbounds %struct.btWheelInfo, ptr %147, i64 %indvars.iv672, i32 11
  %228 = load float, ptr %m_frictionSlip, align 8
  %mul120 = fmul float %mul119, %228
  %mul121 = fmul float %mul120, %mul120
  store float %rollingFriction.0.ph, ptr %arrayidx.i529645, align 4
  %mul126 = fmul float %rollingFriction.0.ph, 5.000000e-01
  %229 = load ptr, ptr %m_data.i542, align 8
  %arrayidx.i544 = getelementptr inbounds float, ptr %229, i64 %indvars.iv672
  %230 = load float, ptr %arrayidx.i544, align 4
  %mul131 = fmul float %230, %230
  %231 = call float @llvm.fmuladd.f32(float %mul126, float %mul126, float %mul131)
  %cmp132 = fcmp ogt float %231, %mul121
  br i1 %cmp132, label %if.then133, label %if.end140

if.then133:                                       ; preds = %if.then115
  %sqrt = call float @llvm.sqrt.f32(float %231)
  %div = fdiv float %mul120, %sqrt
  %m_skidInfo137 = getelementptr inbounds %struct.btWheelInfo, ptr %224, i64 %indvars.iv672, i32 23
  %232 = load float, ptr %m_skidInfo137, align 4
  %mul138 = fmul float %div, %232
  store float %mul138, ptr %m_skidInfo137, align 4
  br label %if.end140

if.end140:                                        ; preds = %if.end109, %if.then115, %if.then133
  %233 = phi ptr [ %145, %if.end109 ], [ %223, %if.then133 ], [ %223, %if.then115 ]
  %234 = phi ptr [ %145, %if.end109 ], [ %224, %if.then133 ], [ %224, %if.then115 ]
  %235 = phi ptr [ %145, %if.end109 ], [ %224, %if.then133 ], [ %225, %if.then115 ]
  ...
  %cmp85 = icmp slt i64 %indvars.iv.next673, %237
...
for.body151:                                      ; preds = %for.body151.lr.ph, %for.inc175
  ...
  %arrayidx.i551 = getelementptr inbounds float, ptr %142, i64 %indvars.iv674
  %238 = load float, ptr %arrayidx.i551, align 4
  %cmp154 = fcmp une float %238, 0.000000e+00
  br i1 %cmp154, label %if.then155, label %for.inc175

if.then155:                                       ; preds = %for.body151
  %m_skidInfo158 = getelementptr inbounds %struct.btWheelInfo, ptr %143, i64 %indvars.iv674, i32 23
  %239 = load float, ptr %m_skidInfo158, align 4
  %cmp159 = fcmp olt float %239, 1.000000e+00
  br i1 %cmp159, label %if.then160, label %for.inc175

if.then160:                                       ; preds = %if.then155
  %arrayidx.i560 = getelementptr inbounds float, ptr %144, i64 %indvars.iv674
  %240 = load float, ptr %arrayidx.i560, align 4
  %mul166 = fmul float %239, %240
  store float %mul166, ptr %arrayidx.i560, align 4
  %241 = load float, ptr %m_skidInfo158, align 4
  %242 = load float, ptr %arrayidx.i551, align 4
  %mul172 = fmul float %241, %242
  store float %mul172, ptr %arrayidx.i551, align 4
  br label %for.inc175
...
for.body184.lr.ph:                                ; preds = %if.end178
  ...
  %243 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %rel_pos, i64 0, i32 1
  ...
  %244 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp199, i64 0, i32 1
  %m_data.i600 = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 4, i32 5
  %245 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %rel_pos2, i64 0, i32 1
  %m_data.i619 = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 2, i32 5
  %246 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %sideImp, i64 0, i32 1
  %m_indexUpAxis = getelementptr inbounds %class.btRaycastVehicle, ptr %this, i64 0, i32 13
  %247 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp232, i64 0, i32 1
...
for.body184:                                      ; preds = %for.body184.lr.ph, %if.end235
  ...
  %248 = load ptr, ptr %m_data.i568, align 8
  %arrayidx.i570 = getelementptr inbounds %struct.btWheelInfo, ptr %248, i64 %indvars.iv679
  ...
  %249 = load ptr, ptr %m_chassisBody190, align 8
  %m_origin.i.i = getelementptr inbounds %class.btCollisionObject, ptr %249, i64 0, i32 1, i32 1
  %250 = load <2 x float>, ptr %m_contactPointWS189, align 4
  %251 = load <2 x float>, ptr %m_origin.i.i, align 4
  %252 = fsub <2 x float> %250, %251
  %arrayidx11.i = getelementptr inbounds %"struct.btWheelInfo::RaycastInfo", ptr %arrayidx.i570, i64 0, i32 1, i32 0, i64 2
  %253 = load float, ptr %arrayidx11.i, align 4
  %arrayidx13.i575 = getelementptr inbounds %class.btCollisionObject, ptr %249, i64 0, i32 1, i32 1, i32 0, i64 2
  %254 = load float, ptr %arrayidx13.i575, align 4
  %sub14.i = fsub float %253, %254
  %retval.sroa.3.12.vec.insert.i578 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %sub14.i, i64 0
  store <2 x float> %252, ptr %rel_pos, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i578, ptr %243, align 8
  %255 = load ptr, ptr %m_data.i581, align 8
  %arrayidx.i583 = getelementptr inbounds float, ptr %255, i64 %indvars.iv679
  %256 = load float, ptr %arrayidx.i583, align 4
  %cmp196 = fcmp une float %256, 0.000000e+00
...
if.then197:                                       ; preds = %for.body184
  ...
  %257 = load ptr, ptr %m_data.i584, align 8
  %arrayidx.i586 = getelementptr inbounds %class.btVector3, ptr %257, i64 %indvars.iv679
  %258 = load <2 x float>, ptr %arrayidx.i586, align 4
  ...
  %262 = load float, ptr %arrayidx7.i593, align 4
  %mul8.i594 = fmul float %256, %262
  %retval.sroa.3.12.vec.insert.i597 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %mul8.i594, i64 0
  store <2 x float> %261, ptr %ref.tmp199, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i597, ptr %244, align 8
  call void @_ZN11btRigidBody12applyImpulseERK9btVector3S2_(ptr noundef nonnull align 8 dereferenceable(564) %249, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp199, ptr noundef nonnull align 4 dereferenceable(16) %rel_pos)
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp199) #20
  br label %if.end206

if.end206:                                        ; preds = %if.then197, %for.body184
  %263 = load ptr, ptr %m_data.i600, align 8
  %arrayidx.i602 = getelementptr inbounds float, ptr %263, i64 %indvars.iv679
  %264 = load float, ptr %arrayidx.i602, align 4
  %cmp209 = fcmp une float %264, 0.000000e+00
  br i1 %cmp209, label %if.then210, label %if.end235

if.then210:                                       ; preds = %if.end206
  %265 = load ptr, ptr %m_data.i568, align 8
  %m_groundObject215 = getelementptr inbounds %struct.btWheelInfo, ptr %265, i64 %indvars.iv679, i32 0, i32 7
  %266 = load ptr, ptr %m_groundObject215, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %rel_pos2) #20
  %m_origin.i.i606 = getelementptr inbounds %class.btCollisionObject, ptr %266, i64 0, i32 1, i32 1
  %267 = load <2 x float>, ptr %m_contactPointWS189, align 4
  %268 = load <2 x float>, ptr %m_origin.i.i606, align 4
  %269 = fsub <2 x float> %267, %268
  %270 = load float, ptr %arrayidx11.i, align 4
  %arrayidx13.i612 = getelementptr inbounds %class.btCollisionObject, ptr %266, i64 0, i32 1, i32 1, i32 0, i64 2
  %271 = load float, ptr %arrayidx13.i612, align 4
  %sub14.i613 = fsub float %270, %271
  %retval.sroa.3.12.vec.insert.i616 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %sub14.i613, i64 0
  store <2 x float> %269, ptr %rel_pos2, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i616, ptr %245, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %sideImp) #20
  %272 = load ptr, ptr %m_data.i619, align 8
  %arrayidx.i621 = getelementptr inbounds %class.btVector3, ptr %272, i64 %indvars.iv679
  %273 = load float, ptr %arrayidx.i602, align 4
  %274 = load <2 x float>, ptr %arrayidx.i621, align 4
  ...
  %278 = load float, ptr %arrayidx7.i628, align 4
  %mul8.i629 = fmul float %273, %278
  %retval.sroa.3.12.vec.insert.i632 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %mul8.i629, i64 0
  store <2 x float> %277, ptr %sideImp, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i632, ptr %246, align 8
  %m_rollInfluence = getelementptr inbounds %struct.btWheelInfo, ptr %248, i64 %indvars.iv679, i32 15
  %279 = load float, ptr %m_rollInfluence, align 8
  %280 = load i32, ptr %m_indexUpAxis, align 4
  %idxprom228 = sext i32 %280 to i64
  %arrayidx229 = getelementptr inbounds float, ptr %rel_pos, i64 %idxprom228
  %281 = load float, ptr %arrayidx229, align 4
  %mul230 = fmul float %279, %281
  store float %mul230, ptr %arrayidx229, align 4
  %282 = load ptr, ptr %m_chassisBody190, align 8
  call void @_ZN11btRigidBody12applyImpulseERK9btVector3S2_(ptr noundef nonnull align 8 dereferenceable(564) %282, ptr noundef nonnull align 4 dereferenceable(16) %sideImp, ptr noundef nonnull align 4 dereferenceable(16) %rel_pos)
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp232) #20
  %283 = load <2 x float>, ptr %sideImp, align 8
  %284 = fneg <2 x float> %283
  %285 = load float, ptr %246, align 8
  %fneg8.i = fneg float %285
  %retval.sroa.3.12.vec.insert.i640 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %fneg8.i, i64 0
  store <2 x float> %284, ptr %ref.tmp232, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i640, ptr %247, align 8
  call void @_ZN11btRigidBody12applyImpulseERK9btVector3S2_(ptr noundef nonnull align 8 dereferenceable(564) %266, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp232, ptr noundef nonnull align 4 dereferenceable(16) %rel_pos2)
...
if.end235:                                        ; preds = %if.then210, %if.end206
  ...
  %286 = load i32, ptr %m_size.i.i, align 4
  %287 = sext i32 %286 to i64
  %cmp182 = icmp slt i64 %indvars.iv.next680, %287
...
entry:
  ...
  %7 = load float, ptr %arrayidx7.i13.i, align 4
  ...
  %23 = load float, ptr %arrayidx.i16.i.i.i, align 4
  ...
  %28 = load float, ptr %arrayidx.i16.i16.i.i, align 4
  ...
  %36 = load float, ptr %m_inverseMass.i, align 8
  ...
  %39 = load float, ptr %m_origin.i.i.i9, align 4
  ...
  %40 = load float, ptr %arrayidx7.i.i12, align 4
  ...
  %41 = load float, ptr %arrayidx13.i.i15, align 4
  ...
  %48 = load float, ptr %m_invInertiaTensorWorld.i.i22, align 4
  %arrayidx4.i.i.i23 = getelementptr inbounds %class.btRigidBody, ptr %body1, i64 0, i32 1, i32 0, i64 1
  %49 = load float, ptr %arrayidx4.i.i.i23, align 4
  ...
  %51 = load float, ptr %arrayidx9.i.i.i25, align 4
  ...
  %56 = load float, ptr %arrayidx.i16.i.i.i29, align 4
  ...
  %61 = load float, ptr %arrayidx.i16.i16.i.i33, align 4
  ...
  %69 = load float, ptr %m_inverseMass.i37, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  store <2 x float> <float 0.000000e+00, float 2.550000e+02>, ptr %arrayidx3.i, align 4
...
entry:
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_rayFromWorld.i, ptr noundef nonnull align 4 dereferenceable(16) %from, i64 16, i1 false)
  %m_rayToWorld.i = getelementptr inbounds %"struct.btCollisionWorld::ClosestRayResultCallback", ptr %rayCallback, i64 0, i32 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_rayToWorld.i, ptr noundef nonnull align 4 dereferenceable(16) %to, i64 16, i1 false)
...
invoke.cont4:                                     ; preds = %entry
  ...
  %2 = load i32, ptr %m_internalType.i.i, align 8
...
invoke.cont10:                                    ; preds = %land.lhs.true
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %result, ptr noundef nonnull align 8 dereferenceable(16) %m_hitPointWorld, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %m_hitNormalInWorld, ptr noundef nonnull align 8 dereferenceable(16) %m_hitNormalWorld, i64 16, i1 false)
  ...
  %4 = load float, ptr %arrayidx10.i.i.i.i, align 4
  %5 = load <2 x float>, ptr %m_hitNormalInWorld, align 4
...
if.then:                                          ; preds = %entry
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_hitNormalWorld, ptr noundef nonnull align 8 dereferenceable(16) %m_hitNormalLocal, i64 16, i1 false)
  br label %if.end
...
if.else:                                          ; preds = %entry
  ...
  %27 = load float, ptr %arrayidx5.i18.i, align 4
  %mul8.i20.i = fmul float %5, %27
  %28 = tail call float @llvm.fmuladd.f32(float %26, float %3, float %mul8.i20.i)
  %arrayidx10.i21.i = getelementptr inbounds %class.btCollisionObject, ptr %1, i64 0, i32 1, i32 0, i32 0, i64 2, i32 0, i64 2
  %29 = load float, ptr %arrayidx10.i21.i, align 4
  %30 = tail call float @llvm.fmuladd.f32(float %29, float %7, float %28)
  ...
  store <2 x float> %25, ptr %m_hitNormalWorld7, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i, ptr %ref.tmp.sroa.4.0.m_hitNormalWorld7.sroa_idx, align 8
  br label %if.end
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %32 = load <2 x float>, ptr %m_rayFromWorld, align 8
  %33 = load <2 x float>, ptr %m_rayToWorld, align 8
  ...
  store float %42, ptr %arrayidx20.i, align 8
...
attributes #7 = { uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #14 = { mustprogress nofree nosync nounwind willreturn memory(read, inaccessiblemem: none) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!49 = !{!48, !34, i64 12}
!50 = !{!51, !34, i64 208}
!51 = !{!"_ZTS11btWheelInfo", !52, i64 0, !54, i64 96, !53, i64 160, !53, i64 176, !53, i64 192, !34, i64 208, !34, i64 212, !34, i64 216, !34, i64 220, !34, i64 224, !34, i64 228, !34, i64 232, !34, i64 236, !34, i64 240, !34, i64 244, !34, i64 248, !34, i64 252, !34, i64 256, !14, i64 260, !13, i64 264, !34, i64 272, !34, i64 276, !34, i64 280, !34, i64 284}
!52 = !{!"_ZTSN11btWheelInfo11RaycastInfoE", !53, i64 0, !53, i64 16, !34, i64 32, !53, i64 36, !53, i64 52, !53, i64 68, !14, i64 84, !13, i64 88}
!53 = !{!"_ZTS9btVector3", !12, i64 0}
!54 = !{!"_ZTS11btTransform", !55, i64 0, !53, i64 48}
!55 = !{!"_ZTS11btMatrix3x3", !12, i64 0}
!56 = !{!51, !34, i64 212}
!57 = !{!51, !34, i64 216}
!58 = !{!51, !14, i64 260}
!59 = !{!51, !14, i64 84}
...
!66 = !{!13, !13, i64 0}
!67 = !{!68, !13, i64 512}
!68 = !{!"_ZTS11btRigidBody", !69, i64 0, !55, i64 280, !53, i64 328, !53, i64 344, !34, i64 360, !53, i64 364, !53, i64 380, !53, i64 396, !53, i64 412, !53, i64 428, !53, i64 444, !53, i64 460, !34, i64 476, !34, i64 480, !14, i64 484, !34, i64 488, !34, i64 492, !34, i64 496, !34, i64 500, !34, i64 504, !34, i64 508, !13, i64 512, !9, i64 520, !11, i64 552, !11, i64 556, !11, i64 560}
!69 = !{!"_ZTS17btCollisionObject", !54, i64 8, !54, i64 72, !53, i64 136, !53, i64 152, !53, i64 168, !14, i64 184, !34, i64 188, !13, i64 192, !13, i64 200, !13, i64 208, !11, i64 216, !11, i64 220, !11, i64 224, !11, i64 228, !34, i64 232, !34, i64 236, !34, i64 240, !13, i64 248, !11, i64 256, !34, i64 260, !34, i64 264, !34, i64 268, !14, i64 272, !12, i64 273}
!70 = !{!51, !34, i64 236}
!71 = !{!51, !34, i64 240}
!72 = !{i64 0, i64 4, !61}
!73 = !{!51, !34, i64 32}
!74 = !{!75, !34, i64 32}
!75 = !{!"_ZTSN18btVehicleRaycaster24btVehicleRaycasterResultE", !53, i64 0, !53, i64 16, !34, i64 32}
!76 = !{!51, !13, i64 88}
!77 = !{!51, !34, i64 276}
!78 = !{!51, !34, i64 272}
!79 = !{!68, !34, i64 360}
...
!85 = !{!51, !34, i64 256}
!86 = !{!87, !13, i64 0}
!87 = !{!"_ZTS19btWheelContactPoint", !13, i64 0, !13, i64 8, !53, i64 16, !53, i64 32, !34, i64 48, !34, i64 52}
!88 = !{!87, !13, i64 8}
!89 = !{!87, !34, i64 52}
!90 = !{!87, !34, i64 48}
...
!117 = !{!69, !11, i64 216}
!118 = !{!119, !108, i64 8}
!119 = !{!"_ZTS17btBroadphaseProxy", !13, i64 0, !108, i64 8, !108, i64 10, !13, i64 16, !11, i64 24, !53, i64 28, !53, i64 44}
!120 = !{!119, !108, i64 10}
!121 = !{!122, !34, i64 32}
!122 = !{!"_ZTSN16btCollisionWorld14LocalRayResultE", !13, i64 0, !13, i64 8, !53, i64 16, !34, i64 32}
!123 = !{!122, !13, i64 0}
