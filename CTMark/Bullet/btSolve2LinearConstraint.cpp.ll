...
if.end:                                           ; preds = %entry
  ...
  %8 = load float, ptr %arrayidx5.i.i, align 4, !tbaa !5
  %9 = fneg float %8
  %10 = load float, ptr %rel_posA1, align 4, !tbaa !5
  %11 = fneg float %10
  %12 = fneg float %7
  %13 = load float, ptr %world2A, align 4, !tbaa !5
  %arrayidx5.i.i.i78 = getelementptr inbounds [4 x float], ptr %world2A, i64 0, i64 1
  %14 = load float, ptr %arrayidx5.i.i.i78, align 4, !tbaa !5
  %arrayidx10.i.i.i80 = getelementptr inbounds [4 x float], ptr %world2A, i64 0, i64 2
  %15 = load float, ptr %arrayidx10.i.i.i80, align 4, !tbaa !5
  ...
  %24 = load float, ptr %arrayidx5.i18.i.i, align 4, !tbaa !5
  %arrayidx10.i21.i.i = getelementptr inbounds [3 x %class.btVector3], ptr %world2A, i64 0, i64 2, i32 0, i64 2
  %25 = load float, ptr %arrayidx10.i21.i.i, align 4, !tbaa !5
  ...
  %38 = load float, ptr %arrayidx10.i21.i72.i, align 4, !tbaa !5
  %39 = load float, ptr %invInertiaADiag, align 4, !tbaa !5
  %arrayidx5.i78.i = getelementptr inbounds [4 x float], ptr %invInertiaADiag, i64 0, i64 1
  %40 = load float, ptr %arrayidx5.i78.i, align 4, !tbaa !5
  %arrayidx11.i.i = getelementptr inbounds [4 x float], ptr %invInertiaADiag, i64 0, i64 2
  %41 = load float, ptr %arrayidx11.i.i, align 4, !tbaa !5
  %42 = load float, ptr %invInertiaBDiag, align 4, !tbaa !5
  %arrayidx5.i86.i = getelementptr inbounds [4 x float], ptr %invInertiaBDiag, i64 0, i64 1
  %43 = load float, ptr %arrayidx5.i86.i, align 4, !tbaa !5
  %arrayidx11.i89.i = getelementptr inbounds [4 x float], ptr %invInertiaBDiag, i64 0, i64 2
  %44 = load float, ptr %arrayidx11.i89.i, align 4, !tbaa !5
  ...
  %45 = load float, ptr %arrayidx.i.i85, align 4, !tbaa !5
  %arrayidx5.i.i87 = getelementptr inbounds [4 x float], ptr %rel_posB1, i64 0, i64 2
  %46 = load float, ptr %arrayidx5.i.i87, align 4, !tbaa !5
  %47 = fneg float %46
  %48 = load float, ptr %rel_posB1, align 4, !tbaa !5
  %49 = fneg float %48
  %50 = fneg float %45
  ...
  %51 = load float, ptr %arrayidx.i48.i110, align 4, !tbaa !5
  %arrayidx5.i50.i111 = getelementptr inbounds [4 x float], ptr %rel_posB2, i64 0, i64 2
  %52 = load float, ptr %arrayidx5.i50.i111, align 4, !tbaa !5
  %53 = load float, ptr %rel_posB2, align 4, !tbaa !5
  ...
  %54 = load float, ptr %arrayidx.i.i154, align 4, !tbaa !5
  %arrayidx5.i.i156 = getelementptr inbounds %class.btRigidBody, ptr %body1, i64 0, i32 3, i32 0, i64 2
  %55 = load float, ptr %arrayidx5.i.i156, align 4, !tbaa !5
  %56 = load float, ptr %m_angularVelocity.i, align 4, !tbaa !5
  %57 = load float, ptr %m_linearVelocity.i, align 4, !tbaa !5
  %arrayidx5.i5.i = getelementptr inbounds %class.btRigidBody, ptr %body1, i64 0, i32 2, i32 0, i64 1
  %58 = load float, ptr %arrayidx5.i5.i, align 4, !tbaa !5
  %arrayidx11.i.i161 = getelementptr inbounds %class.btRigidBody, ptr %body1, i64 0, i32 2, i32 0, i64 2
  %59 = load float, ptr %arrayidx11.i.i161, align 4, !tbaa !5
  ...
  %60 = load float, ptr %arrayidx.i.i164, align 4, !tbaa !5
  %arrayidx5.i.i166 = getelementptr inbounds %class.btRigidBody, ptr %body2, i64 0, i32 3, i32 0, i64 2
  %61 = load float, ptr %arrayidx5.i.i166, align 4, !tbaa !5
  %62 = load float, ptr %m_angularVelocity.i163, align 4, !tbaa !5
  %63 = load float, ptr %m_linearVelocity.i162, align 4, !tbaa !5
  ...
  %78 = load float, ptr %arrayidx5.i5.i172, align 4, !tbaa !5
  ...
  %89 = load float, ptr %arrayidx11.i.i174, align 4, !tbaa !5
  ...
  store float %269, ptr %imp0, align 4, !tbaa !5
  ...
  store float %270, ptr %imp1, align 4, !tbaa !5
  br label %cleanup
...
if.end:                                           ; preds = %entry
  ...
  %14 = load float, ptr %arrayidx5.i.i.i110, align 4, !tbaa !5
  %arrayidx10.i.i.i112 = getelementptr inbounds [4 x float], ptr %world2A, i64 0, i64 2
  %15 = load float, ptr %arrayidx10.i.i.i112, align 4, !tbaa !5
  %arrayidx.i.i.i = getelementptr inbounds [3 x %class.btVector3], ptr %world2A, i64 0, i64 1
  %16 = load <4 x float>, ptr %arrayidx.i.i.i, align 4
  %17 = shufflevector <4 x float> %16, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %arrayidx5.i12.i.i = getelementptr inbounds [3 x %class.btVector3], ptr %world2A, i64 0, i64 1, i32 0, i64 1
  ...
  %45 = load float, ptr %arrayidx.i.i117, align 4, !tbaa !5
  %arrayidx5.i.i119 = getelementptr inbounds [4 x float], ptr %rel_posB1, i64 0, i64 2
  %46 = load float, ptr %arrayidx5.i.i119, align 4, !tbaa !5
  %47 = fneg float %46
  %48 = load float, ptr %rel_posB1, align 4, !tbaa !5
  %49 = fneg float %48
  %50 = fneg float %45
  ...
  %60 = load float, ptr %arrayidx.i.i196, align 4, !tbaa !5
  %arrayidx5.i.i198 = getelementptr inbounds %class.btRigidBody, ptr %body2, i64 0, i32 3, i32 0, i64 2
  %61 = load float, ptr %arrayidx5.i.i198, align 4, !tbaa !5
  %62 = load float, ptr %m_angularVelocity.i195, align 4, !tbaa !5
  %63 = load float, ptr %m_linearVelocity.i194, align 4, !tbaa !5
  %64 = insertelement <2 x float> poison, float %55, i64 0
  %65 = insertelement <2 x float> %64, float %61, i64 1
  %66 = fneg <2 x float> %65
  %67 = insertelement <2 x float> poison, float %7, i64 0
  ...
  %78 = load float, ptr %arrayidx5.i5.i204, align 4, !tbaa !5
  %79 = insertelement <2 x float> poison, float %56, i64 0
  %80 = insertelement <2 x float> %79, float %62, i64 1
  %81 = fneg <2 x float> %80
  %82 = fmul <2 x float> %73, %81
  ...
  %89 = load float, ptr %arrayidx11.i.i206, align 4, !tbaa !5
  %90 = fneg <2 x float> %71
  %91 = fmul <2 x float> %84, %90
  %92 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %80, <2 x float> %68, <2 x float> %91)
  %93 = insertelement <2 x float> poison, float %59, i64 0
  ...
  store float %270, ptr %imp1, align 4, !tbaa !5
  %271 = load float, ptr %imp0, align 4, !tbaa !5
