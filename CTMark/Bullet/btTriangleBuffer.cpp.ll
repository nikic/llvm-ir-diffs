; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btTriangleBuffer.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btTriangleBuffer.cpp"
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i.new
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(56) %arrayidx.i.i.i.1, ptr noundef nonnull align 4 dereferenceable(56) %arrayidx3.i.i.i.1, i64 56, i1 false)
...
for.body.i.i.i.epil:                              ; preds = %_ZNK20btAlignedObjectArrayI10btTriangleE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(56) %arrayidx.i.i.i.epil, ptr noundef nonnull align 4 dereferenceable(56) %arrayidx3.i.i.i.epil, i64 56, i1 false)
...
_ZN20btAlignedObjectArrayI10btTriangleE9push_backERKS0_.exit: ; preds = %entry, %if.then.i, %_ZN20btAlignedObjectArrayI10btTriangleE10deallocateEv.exit.i.i
  ...
  store i32 %partId, ptr %tri.sroa.6.0.arrayidx.i.sroa_idx, align 4
  %tri.sroa.7.0.arrayidx.i.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i, i64 52
  store i32 %triangleIndex, ptr %tri.sroa.7.0.arrayidx.i.sroa_idx, align 4
...
attributes #3 = { inlinehint uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
