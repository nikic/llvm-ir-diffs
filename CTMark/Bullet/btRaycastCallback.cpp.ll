...
entry:
  ...
  %34 = load float, ptr %arrayidx12.i134, align 8, !tbaa !18
...
entry:
  ...
  %3 = load float, ptr %arrayidx5.i, align 4, !tbaa !18
  ...
  %6 = load float, ptr %arrayidx10.i, align 4, !tbaa !18
  ...
  %11 = load float, ptr %arrayidx12.i19, align 8, !tbaa !18
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %11 = load float, ptr %arrayidx12.i26, align 8, !tbaa !18
  %12 = insertelement <2 x float> poison, float %3, i64 0
  %13 = shufflevector <2 x float> %12, <2 x float> poison, <2 x i32> zeroinitializer
  %14 = insertelement <2 x float> %5, float %10, i64 1
  %15 = fmul <2 x float> %13, %14
...
entry:
  ...
  %6 = load <2 x float>, ptr %arrayidx5.i.i, align 4, !tbaa !18
  %7 = load <2 x float>, ptr %arrayidx7.i.i, align 4, !tbaa !18
...
entry:
  ...
  %sub.i.i = fsub float %0, %1
  %arrayidx5.i.i = getelementptr inbounds %class.btTriangleShape, ptr %this, i64 0, i32 1, i64 1, i32 0, i64 1
  %2 = load float, ptr %arrayidx5.i.i, align 4, !tbaa !18
  %arrayidx7.i.i = getelementptr inbounds %class.btTriangleShape, ptr %this, i64 0, i32 1, i64 0, i32 0, i64 1
  %3 = load float, ptr %arrayidx7.i.i, align 4, !tbaa !18
  ...
  %4 = load float, ptr %arrayidx11.i.i, align 8, !tbaa !18
  %arrayidx13.i.i = getelementptr inbounds %class.btTriangleShape, ptr %this, i64 0, i32 1, i64 0, i32 0, i64 2
  %5 = load float, ptr %arrayidx13.i.i, align 8, !tbaa !18
  %sub14.i.i = fsub float %4, %5
  %arrayidx7.i = getelementptr inbounds %class.btTriangleShape, ptr %this, i64 0, i32 1, i64 2
  %6 = load float, ptr %arrayidx7.i, align 8, !tbaa !18
  %sub.i16.i = fsub float %6, %1
  %arrayidx5.i17.i = getelementptr inbounds %class.btTriangleShape, ptr %this, i64 0, i32 1, i64 2, i32 0, i64 1
  %7 = load float, ptr %arrayidx5.i17.i, align 4, !tbaa !18
  %sub8.i19.i = fsub float %7, %3
  %arrayidx11.i20.i = getelementptr inbounds %class.btTriangleShape, ptr %this, i64 0, i32 1, i64 2, i32 0, i64 2
  %8 = load float, ptr %arrayidx11.i20.i, align 8, !tbaa !18
...
for.cond.preheader:                               ; preds = %entry
  ...
  %36 = load float, ptr %pa, align 4, !tbaa !18
  %sub.i = fsub float %35, %36
  %37 = load float, ptr %arrayidx5.i40, align 4, !tbaa !18
  %38 = load float, ptr %arrayidx7.i41, align 4, !tbaa !18
  %sub8.i = fsub float %37, %38
  %39 = load float, ptr %arrayidx11.i, align 4, !tbaa !18
...
for.cond:                                         ; preds = %for.cond.preheader
  ...
  %68 = load float, ptr %pa, align 4, !tbaa !18
  %sub.i.1 = fsub float %67, %68
  %69 = load float, ptr %arrayidx5.i40, align 4, !tbaa !18
  %70 = load float, ptr %arrayidx7.i41, align 4, !tbaa !18
  %sub8.i.1 = fsub float %69, %70
  %71 = load float, ptr %arrayidx11.i, align 4, !tbaa !18
...
for.cond.1:                                       ; preds = %for.cond
  ...
  %100 = load float, ptr %pa, align 4, !tbaa !18
  %sub.i.2 = fsub float %99, %100
  %101 = load float, ptr %arrayidx5.i40, align 4, !tbaa !18
  %102 = load float, ptr %arrayidx7.i41, align 4, !tbaa !18
  %sub8.i.2 = fsub float %101, %102
  %103 = load float, ptr %arrayidx11.i, align 4, !tbaa !18
