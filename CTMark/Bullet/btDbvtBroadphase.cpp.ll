; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btDbvtBroadphase.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btDbvtBroadphase.cpp"
...
entry:
  store ptr getelementptr inbounds ({ [15 x ptr] }, ptr @_ZTV16btDbvtBroadphase, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
cond.end:                                         ; preds = %invoke.cont.1, %invoke.cont5
  ...
  %arrayctor.end = getelementptr inbounds %struct.btDbvtBroadphase, ptr %this, i64 0, i32 2
  %m_paircache = getelementptr inbounds %struct.btDbvtBroadphase, ptr %this, i64 0, i32 3
  store ptr %cond7, ptr %m_paircache, align 8
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %arrayctor.end, i8 0, i64 24, i1 false)
  ret void
...
lpad4:                                            ; preds = %invoke.cont5, %cond.false
  %1 = landingpad { ptr, i32 }
          cleanup
  %arraydestroy.element12 = getelementptr inbounds %struct.btDbvtBroadphase, ptr %this, i64 0, i32 1, i64 1
...
invoke.cont13:                                    ; preds = %lpad4
  %arraydestroy.element12.1 = getelementptr inbounds %struct.btDbvtBroadphase, ptr %this, i64 0, i32 1
...
invoke.cont:
  ...
  store i16 %collisionFilterGroup, ptr %m_collisionFilterGroup.i.i, align 8
  %m_collisionFilterMask.i.i = getelementptr inbounds %struct.btBroadphaseProxy, ptr %call, i64 0, i32 2
  store i16 %collisionFilterMask, ptr %m_collisionFilterMask.i.i, align 2
  ...
  %5 = load i32, ptr %m_stageCurrent, align 4
  ...
  store ptr %6, ptr %arrayidx2.i, align 8
...
_ZL10listappendI11btDbvtProxyEvPT_RS2_.exit:      ; preds = %invoke.cont, %if.then.i
  store ptr %call, ptr %arrayidx8, align 8
  %m_deferedcollide = getelementptr inbounds %struct.btDbvtBroadphase, ptr %this, i64 0, i32 18
  %8 = load i8, ptr %m_deferedcollide, align 1
...
if.then:                                          ; preds = %_ZL10listappendI11btDbvtProxyEvPT_RS2_.exit
  ...
  store ptr getelementptr inbounds ({ [9 x ptr] }, ptr @_ZTV18btDbvtTreeCollider, i64 0, inrange i32 0, i64 2), ptr %collider, align 8
  ...
  store ptr %call, ptr %proxy9, align 8
  %9 = load ptr, ptr %m_sets, align 8
...
if.end21:                                         ; preds = %do.body, %land.lhs.true.i, %land.lhs.true7.i, %land.lhs.true13.i, %land.lhs.true19.i, %_ZN20btAlignedObjectArrayIPK10btDbvtNodeE9push_backERKS2_.exit167, %if.else, %invoke.cont11
  ...
  %stack.sroa.3.1 = phi i32 [ %inc.i130, %_ZN20btAlignedObjectArrayIPK10btDbvtNodeE9push_backERKS2_.exit167 ], [ %sub, %if.else ], [ %sub, %invoke.cont11 ], [ %sub, %land.lhs.true19.i ], [ %sub, %land.lhs.true13.i ], [ %sub, %land.lhs.true7.i ], [ %sub, %land.lhs.true.i ], [ %sub, %do.body ]
...
if.then.i.i:                                      ; preds = %entry
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1024) %0, i8 0, i64 1016, i1 false)
  store ptr %root, ptr %call.i.i.i.i69, align 8
...
invoke.cont16:                                    ; preds = %if.then.i.i, %if.end41
  ...
  store <2 x float> %4, ptr %bounds, align 16
  store <2 x float> %retval.sroa.3.12.vec.insert.i, ptr %ref.tmp5.sroa.5.0.arrayidx.sroa_idx, align 8
  %mx.i = getelementptr inbounds %struct.btDbvtAabbMm, ptr %1, i64 0, i32 1
  %7 = load <2 x float>, ptr %mx.i, align 4
  %8 = load <2 x float>, ptr %aabbMax, align 4
  %9 = fadd <2 x float> %7, %8
  %arrayidx11.i76 = getelementptr inbounds %struct.btDbvtAabbMm, ptr %1, i64 0, i32 1, i32 0, i64 2
  %10 = load float, ptr %arrayidx11.i76, align 4
  %11 = load float, ptr %arrayidx13.i77, align 4
  ...
  store <2 x float> %9, ptr %arrayidx19, align 16
  store <2 x float> %retval.sroa.3.12.vec.insert.i81, ptr %ref.tmp11.sroa.5.0.arrayidx19.sroa_idx, align 8
  %12 = load i32, ptr %signs, align 4
  %idxprom.i84 = zext i32 %12 to i64
  %arrayidx1.i = getelementptr inbounds %class.btVector3, ptr %bounds, i64 %idxprom.i84
  %13 = load float, ptr %arrayidx1.i, align 16
  %sub5.i = sub i32 1, %12
  %idxprom6.i = zext i32 %sub5.i to i64
  %arrayidx7.i85 = getelementptr inbounds %class.btVector3, ptr %bounds, i64 %idxprom6.i
  %14 = load float, ptr %arrayidx7.i85, align 16
  %15 = load i32, ptr %arrayidx13.i86, align 4
  ...
  %17 = load float, ptr %arrayidx.i114.i, align 4
  %18 = load <2 x float>, ptr %rayFrom, align 4
  %19 = insertelement <2 x float> poison, float %14, i64 0
  %20 = insertelement <2 x float> %19, float %16, i64 1
  %21 = fsub <2 x float> %20, %18
  %22 = load <2 x float>, ptr %rayDirectionInverse, align 4
  %23 = fmul <2 x float> %22, %21
  %24 = insertelement <2 x float> poison, float %13, i64 0
  %25 = insertelement <2 x float> %24, float %17, i64 1
  %26 = fsub <2 x float> %25, %18
...
if.end.i88:                                       ; preds = %invoke.cont16
  ...
  %37 = load i32, ptr %arrayidx37.i, align 4
  ...
  %38 = load float, ptr %arrayidx.i117.i, align 8
  %39 = load float, ptr %arrayidx.i118.i, align 4
  %sub42.i = fsub float %38, %39
  %40 = load float, ptr %arrayidx.i119.i, align 4
  ...
  %41 = load float, ptr %arrayidx.i120.i, align 8
...
if.then28:                                        ; preds = %if.then27
  ...
  %cmp4.i94 = icmp slt i32 %stack.sroa.3.0, %mul
  br i1 %cmp4.i94, label %if.then5.i95, label %invoke.cont32

if.then5.i95:                                     ; preds = %if.then28
  %cmp.i.i97 = icmp slt i32 %stack.sroa.14.2, %mul
  br i1 %cmp.i.i97, label %if.then.i.i105, label %for.body10.lr.ph.i98

if.then.i.i105:                                   ; preds = %if.then5.i95
  %tobool.not.i.i.i = icmp eq i32 %stack.sroa.3.0, 0
  br i1 %tobool.not.i.i.i, label %if.then3.i.i.i114, label %if.then.i.i.i
...
_ZN20btAlignedObjectArrayIPK10btDbvtNodeE8allocateEi.exit.i.i: ; preds = %if.then.i.i.i
  %cmp7.i.i.i107 = icmp sgt i32 %stack.sroa.3.0, 0
  br i1 %cmp7.i.i.i107, label %for.body.lr.ph.i.i.i116, label %if.then3.i.i.i114

for.body.lr.ph.i.i.i116:                          ; preds = %_ZN20btAlignedObjectArrayIPK10btDbvtNodeE8allocateEi.exit.i.i
  %call.i.i.i.i126197 = ptrtoint ptr %call.i.i.i.i126 to i64
  %wide.trip.count.i.i.i118 = zext i32 %stack.sroa.3.0 to i64
  %min.iters.check = icmp ult i32 %stack.sroa.3.0, 6
  %45 = sub i64 %call.i.i.i.i126197, %stack.sroa.21159.2198
  %diff.check = icmp ult i64 %45, 32
  %or.cond = or i1 %min.iters.check, %diff.check
  br i1 %or.cond, label %for.body.i.i.i119.preheader, label %vector.ph

vector.ph:                                        ; preds = %for.body.lr.ph.i.i.i116
  %n.vec = and i64 %wide.trip.count.i.i.i118, 4294967292
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x ptr>, ptr %47, align 8
  %48 = getelementptr inbounds ptr, ptr %47, i64 2
  %wide.load199 = load <2 x ptr>, ptr %48, align 8
  store <2 x ptr> %wide.load, ptr %46, align 8
  %49 = getelementptr inbounds ptr, ptr %46, i64 2
  store <2 x ptr> %wide.load199, ptr %49, align 8
  %index.next = add nuw i64 %index, 4
  %50 = icmp eq i64 %index.next, %n.vec
  br i1 %50, label %middle.block, label %vector.body

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.vec, %wide.trip.count.i.i.i118
  br i1 %cmp.n, label %if.then3.i.i.i114, label %for.body.i.i.i119.preheader

for.body.i.i.i119.preheader:                      ; preds = %for.body.lr.ph.i.i.i116, %middle.block
  %indvars.iv.i.i.i120.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i116 ], [ %n.vec, %middle.block ]
  %51 = xor i64 %indvars.iv.i.i.i120.ph, -1
  %52 = add nsw i64 %51, %wide.trip.count.i.i.i118
  %xtraiter = and i64 %wide.trip.count.i.i.i118, 3
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
...
for.body.i.i.i119.prol:                           ; preds = %for.body.i.i.i119.preheader, %for.body.i.i.i119.prol
  %indvars.iv.i.i.i120.prol = phi i64 [ %indvars.iv.next.i.i.i123.prol, %for.body.i.i.i119.prol ], [ %indvars.iv.i.i.i120.ph, %for.body.i.i.i119.preheader ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body.i.i.i119.prol ], [ 0, %for.body.i.i.i119.preheader ]
  %arrayidx.i.i.i121.prol = getelementptr inbounds ptr, ptr %call.i.i.i.i126, i64 %indvars.iv.i.i.i120.prol
  %arrayidx3.i.i.i122.prol = getelementptr inbounds ptr, ptr %stack.sroa.21159.2, i64 %indvars.iv.i.i.i120.prol
  %53 = load ptr, ptr %arrayidx3.i.i.i122.prol, align 8
  store ptr %53, ptr %arrayidx.i.i.i121.prol, align 8
  %indvars.iv.next.i.i.i123.prol = add nuw nsw i64 %indvars.iv.i.i.i120.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body.i.i.i119.prol.loopexit, label %for.body.i.i.i119.prol

for.body.i.i.i119.prol.loopexit:                  ; preds = %for.body.i.i.i119.prol, %for.body.i.i.i119.preheader
  %indvars.iv.i.i.i120.unr = phi i64 [ %indvars.iv.i.i.i120.ph, %for.body.i.i.i119.preheader ], [ %indvars.iv.next.i.i.i123.prol, %for.body.i.i.i119.prol ]
  %54 = icmp ult i64 %52, 3
  br i1 %54, label %if.then3.i.i.i114, label %for.body.i.i.i119

for.body.i.i.i119:                                ; preds = %for.body.i.i.i119.prol.loopexit, %for.body.i.i.i119
  %indvars.iv.i.i.i120 = phi i64 [ %indvars.iv.next.i.i.i123.3, %for.body.i.i.i119 ], [ %indvars.iv.i.i.i120.unr, %for.body.i.i.i119.prol.loopexit ]
  %arrayidx.i.i.i121 = getelementptr inbounds ptr, ptr %call.i.i.i.i126, i64 %indvars.iv.i.i.i120
  %arrayidx3.i.i.i122 = getelementptr inbounds ptr, ptr %stack.sroa.21159.2, i64 %indvars.iv.i.i.i120
  %55 = load ptr, ptr %arrayidx3.i.i.i122, align 8
  store ptr %55, ptr %arrayidx.i.i.i121, align 8
  %indvars.iv.next.i.i.i123 = add nuw nsw i64 %indvars.iv.i.i.i120, 1
  %arrayidx.i.i.i121.1 = getelementptr inbounds ptr, ptr %call.i.i.i.i126, i64 %indvars.iv.next.i.i.i123
  %arrayidx3.i.i.i122.1 = getelementptr inbounds ptr, ptr %stack.sroa.21159.2, i64 %indvars.iv.next.i.i.i123
  %56 = load ptr, ptr %arrayidx3.i.i.i122.1, align 8
  store ptr %56, ptr %arrayidx.i.i.i121.1, align 8
  %indvars.iv.next.i.i.i123.1 = add nuw nsw i64 %indvars.iv.i.i.i120, 2
  %arrayidx.i.i.i121.2 = getelementptr inbounds ptr, ptr %call.i.i.i.i126, i64 %indvars.iv.next.i.i.i123.1
  %arrayidx3.i.i.i122.2 = getelementptr inbounds ptr, ptr %stack.sroa.21159.2, i64 %indvars.iv.next.i.i.i123.1
  %57 = load ptr, ptr %arrayidx3.i.i.i122.2, align 8
  store ptr %57, ptr %arrayidx.i.i.i121.2, align 8
  %indvars.iv.next.i.i.i123.2 = add nuw nsw i64 %indvars.iv.i.i.i120, 3
  %arrayidx.i.i.i121.3 = getelementptr inbounds ptr, ptr %call.i.i.i.i126, i64 %indvars.iv.next.i.i.i123.2
  %arrayidx3.i.i.i122.3 = getelementptr inbounds ptr, ptr %stack.sroa.21159.2, i64 %indvars.iv.next.i.i.i123.2
  %58 = load ptr, ptr %arrayidx3.i.i.i122.3, align 8
  store ptr %58, ptr %arrayidx.i.i.i121.3, align 8
  %indvars.iv.next.i.i.i123.3 = add nuw nsw i64 %indvars.iv.i.i.i120, 4
  %exitcond.not.i.i.i124.3 = icmp eq i64 %indvars.iv.next.i.i.i123.3, %wide.trip.count.i.i.i118
  br i1 %exitcond.not.i.i.i124.3, label %if.then3.i.i.i114, label %for.body.i.i.i119

if.then3.i.i.i114:                                ; preds = %for.body.i.i.i119.prol.loopexit, %for.body.i.i.i119, %middle.block, %if.then.i.i105, %_ZN20btAlignedObjectArrayIPK10btDbvtNodeE8allocateEi.exit.i.i
  %retval.0.i.i.i190 = phi ptr [ %call.i.i.i.i126, %_ZN20btAlignedObjectArrayIPK10btDbvtNodeE8allocateEi.exit.i.i ], [ null, %if.then.i.i105 ], [ %call.i.i.i.i126, %middle.block ], [ %call.i.i.i.i126, %for.body.i.i.i119 ], [ %call.i.i.i.i126, %for.body.i.i.i119.prol.loopexit ]
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %stack.sroa.21159.2)
          to label %for.body10.lr.ph.i98 unwind label %lpad31

for.body10.lr.ph.i98:                             ; preds = %if.then3.i.i.i114, %if.then5.i95
  %stack.sroa.14.3 = phi i32 [ %stack.sroa.14.2, %if.then5.i95 ], [ %mul, %if.then3.i.i.i114 ]
  %stack.sroa.21159.3 = phi ptr [ %stack.sroa.21159.2, %if.then5.i95 ], [ %retval.0.i.i.i190, %if.then3.i.i.i114 ]
  ...
  %62 = shl nsw i64 %61, 3
  tail call void @llvm.memset.p0.i64(ptr align 8 %scevgep, i8 0, i64 %62, i1 false)
  br label %invoke.cont32

invoke.cont32:                                    ; preds = %for.body10.lr.ph.i98, %if.then28
  %stack.sroa.14.4 = phi i32 [ %stack.sroa.14.2, %if.then28 ], [ %stack.sroa.14.3, %for.body10.lr.ph.i98 ]
  %stack.sroa.21159.4 = phi ptr [ %stack.sroa.21159.2, %if.then28 ], [ %stack.sroa.21159.3, %for.body10.lr.ph.i98 ]
...
lpad31:                                           ; preds = %if.then3.i.i.i114, %if.then.i.i.i
...
if.end:                                           ; preds = %invoke.cont32, %if.then27
  ...
  store ptr %66, ptr %arrayidx.i132, align 8
  %67 = load ptr, ptr %arrayidx.i.i89, align 8
  ...
  store ptr %67, ptr %arrayidx.i135, align 8
  br label %if.end41
...
land.lhs.true.i:                                  ; preds = %if.else
  ...
  %7 = load float, ptr %mx2.i109, align 4
...
land.lhs.true7.i:                                 ; preds = %land.lhs.true.i
  ...
  %10 = load float, ptr %arrayidx.i40.i, align 4
...
land.lhs.true13.i:                                ; preds = %land.lhs.true7.i
  ...
  %11 = load float, ptr %arrayidx.i41.i, align 4
  %arrayidx.i42.i = getelementptr inbounds [4 x float], ptr %aabb, i64 0, i64 1
  %12 = load float, ptr %arrayidx.i42.i, align 4
...
_Z9IntersectRK12btDbvtAabbMmS1_.exit:             ; preds = %land.lhs.true19.i
  ...
  %15 = load float, ptr %arrayidx.i45.i, align 4
  %arrayidx.i46.i = getelementptr inbounds [4 x float], ptr %aabb, i64 0, i64 2
  %16 = load float, ptr %arrayidx.i46.i, align 4
...
if.then7:                                         ; preds = %_Z9IntersectRK12btDbvtAabbMmS1_.exit
  ...
  %21 = load float, ptr %arrayidx11.i114, align 4
...
if.then50:                                        ; preds = %if.end45
  ...
  %35 = load i32, ptr %m_updates_done, align 8
  %inc51 = add i32 %35, 1
...
if.else53:                                        ; preds = %if.else, %land.lhs.true.i, %land.lhs.true7.i, %land.lhs.true13.i, %land.lhs.true19.i, %_Z9IntersectRK12btDbvtAabbMmS1_.exit
  ...
  %36 = load i32, ptr %m_updates_done57, align 8
  %inc58 = add i32 %36, 1
...
if.end60:                                         ; preds = %if.end52, %if.else53, %if.then
  ...
  %arrayidx8.i = getelementptr inbounds %struct.btDbvtProxy, ptr %absproxy, i64 0, i32 3, i64 1
  %39 = load ptr, ptr %arrayidx8.i, align 8
  ...
  store ptr %39, ptr %list.sink.i, align 8
...
if.then70:                                        ; preds = %_ZL10listappendI11btDbvtProxyEvPT_RS2_.exit
  ...
  store i8 1, ptr %m_needcleanup, align 2
  %m_deferedcollide = getelementptr inbounds %struct.btDbvtBroadphase, ptr %this, i64 0, i32 18
  %45 = load i8, ptr %m_deferedcollide, align 1
...
_ZNK20btAlignedObjectArrayIN6btDbvt6sStkNNEE4copyEiiPS1_.exit.i.i: ; preds = %for.body.i.i.i.epil, %_ZNK20btAlignedObjectArrayIN6btDbvt6sStkNNEE4copyEiiPS1_.exit.i.i.loopexit.unr-lcssa, %if.then.i.i
  ...
  %6 = load ptr, ptr %m_data.i9.i.i, align 8
...
_ZN20btAlignedObjectArrayIN6btDbvt6sStkNNEE6resizeEiRKS1_.exit: ; preds = %if.end.i, %if.then5.i, %if.then
  ...
  store ptr %root0, ptr %8, align 8
  %ref.tmp3.sroa.4.0..sroa_idx = getelementptr inbounds i8, ptr %8, i64 8
  store ptr %root1, ptr %ref.tmp3.sroa.4.0..sroa_idx, align 8
  %m_capacity.i.i.i179 = getelementptr inbounds %struct.btDbvt, ptr %this, i64 0, i32 6, i32 3
  %m_ownsMemory.i.i.i195 = getelementptr inbounds %struct.btDbvt, ptr %this, i64 0, i32 6, i32 6
  br label %do.body
...
do.body:                                          ; preds = %if.end125, %_ZN20btAlignedObjectArrayIN6btDbvt6sStkNNEE6resizeEiRKS1_.exit
  ...
  %p.sroa.22.0.copyload = load ptr, ptr %p.sroa.22.0.call6.sroa_idx, align 8
  %cmp = icmp sgt i32 %dec, %treshold.0
...
if.then7:                                         ; preds = %do.body
  ...
  %cmp4.i177 = icmp slt i32 %10, %mul
  %11 = load i32, ptr %m_capacity.i.i.i179, align 8
  %cmp.i.i180 = icmp slt i32 %11, %mul
  %or.cond269 = select i1 %cmp4.i177, i1 %cmp.i.i180, i1 false
  br i1 %or.cond269, label %if.then.i.i188, label %_ZN20btAlignedObjectArrayIN6btDbvt6sStkNNEE6resizeEiRKS1_.exit209

if.then.i.i188:                                   ; preds = %if.then7
  %tobool.not.i.i.i = icmp eq i32 %10, 0
  br i1 %tobool.not.i.i.i, label %_ZNK20btAlignedObjectArrayIN6btDbvt6sStkNNEE4copyEiiPS1_.exit.i.i192, label %_ZN20btAlignedObjectArrayIN6btDbvt6sStkNNEE8allocateEi.exit.i.i

_ZN20btAlignedObjectArrayIN6btDbvt6sStkNNEE8allocateEi.exit.i.i: ; preds = %if.then.i.i188
  %conv.i.i.i.i = sext i32 %mul to i64
  %mul.i.i.i.i = shl nsw i64 %conv.i.i.i.i, 4
  %call.i.i.i.i189 = tail call noundef ptr @_Z22btAlignedAllocInternalmi(i64 noundef %mul.i.i.i.i, i32 noundef 16)
  %.pre.i190 = load i32, ptr %m_size.i.i, align 4
  %cmp7.i.i.i191 = icmp sgt i32 %.pre.i190, 0
  br i1 %cmp7.i.i.i191, label %for.body.lr.ph.i.i.i200, label %_ZNK20btAlignedObjectArrayIN6btDbvt6sStkNNEE4copyEiiPS1_.exit.i.i192

for.body.lr.ph.i.i.i200:                          ; preds = %_ZN20btAlignedObjectArrayIN6btDbvt6sStkNNEE8allocateEi.exit.i.i
  %wide.trip.count.i.i.i202 = zext i32 %.pre.i190 to i64
  %xtraiter270 = and i64 %wide.trip.count.i.i.i202, 1
  %12 = icmp eq i32 %.pre.i190, 1
  br i1 %12, label %_ZNK20btAlignedObjectArrayIN6btDbvt6sStkNNEE4copyEiiPS1_.exit.i.i192.loopexit.unr-lcssa, label %for.body.lr.ph.i.i.i200.new

for.body.lr.ph.i.i.i200.new:                      ; preds = %for.body.lr.ph.i.i.i200
  %unroll_iter272 = and i64 %wide.trip.count.i.i.i202, 4294967294
  br label %for.body.i.i.i203

for.body.i.i.i203:                                ; preds = %for.body.i.i.i203, %for.body.lr.ph.i.i.i200.new
  %indvars.iv.i.i.i204 = phi i64 [ 0, %for.body.lr.ph.i.i.i200.new ], [ %indvars.iv.next.i.i.i207.1, %for.body.i.i.i203 ]
  %niter273 = phi i64 [ 0, %for.body.lr.ph.i.i.i200.new ], [ %niter273.next.1, %for.body.i.i.i203 ]
  %arrayidx.i.i.i205 = getelementptr inbounds %"struct.btDbvt::sStkNN", ptr %call.i.i.i.i189, i64 %indvars.iv.i.i.i204
  %13 = load ptr, ptr %m_data.i, align 8
  %arrayidx3.i.i.i206 = getelementptr inbounds %"struct.btDbvt::sStkNN", ptr %13, i64 %indvars.iv.i.i.i204
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx.i.i.i205, ptr noundef nonnull align 8 dereferenceable(16) %arrayidx3.i.i.i206, i64 16, i1 false)
  %indvars.iv.next.i.i.i207 = or i64 %indvars.iv.i.i.i204, 1
  %arrayidx.i.i.i205.1 = getelementptr inbounds %"struct.btDbvt::sStkNN", ptr %call.i.i.i.i189, i64 %indvars.iv.next.i.i.i207
  %14 = load ptr, ptr %m_data.i, align 8
  %arrayidx3.i.i.i206.1 = getelementptr inbounds %"struct.btDbvt::sStkNN", ptr %14, i64 %indvars.iv.next.i.i.i207
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx.i.i.i205.1, ptr noundef nonnull align 8 dereferenceable(16) %arrayidx3.i.i.i206.1, i64 16, i1 false)
  %indvars.iv.next.i.i.i207.1 = add nuw nsw i64 %indvars.iv.i.i.i204, 2
  %niter273.next.1 = add i64 %niter273, 2
  %niter273.ncmp.1 = icmp eq i64 %niter273.next.1, %unroll_iter272
  br i1 %niter273.ncmp.1, label %_ZNK20btAlignedObjectArrayIN6btDbvt6sStkNNEE4copyEiiPS1_.exit.i.i192.loopexit.unr-lcssa, label %for.body.i.i.i203

_ZNK20btAlignedObjectArrayIN6btDbvt6sStkNNEE4copyEiiPS1_.exit.i.i192.loopexit.unr-lcssa: ; preds = %for.body.i.i.i203, %for.body.lr.ph.i.i.i200
  %indvars.iv.i.i.i204.unr = phi i64 [ 0, %for.body.lr.ph.i.i.i200 ], [ %indvars.iv.next.i.i.i207.1, %for.body.i.i.i203 ]
  %lcmp.mod271.not = icmp eq i64 %xtraiter270, 0
  br i1 %lcmp.mod271.not, label %_ZNK20btAlignedObjectArrayIN6btDbvt6sStkNNEE4copyEiiPS1_.exit.i.i192, label %for.body.i.i.i203.epil

for.body.i.i.i203.epil:                           ; preds = %_ZNK20btAlignedObjectArrayIN6btDbvt6sStkNNEE4copyEiiPS1_.exit.i.i192.loopexit.unr-lcssa
  %arrayidx.i.i.i205.epil = getelementptr inbounds %"struct.btDbvt::sStkNN", ptr %call.i.i.i.i189, i64 %indvars.iv.i.i.i204.unr
  %15 = load ptr, ptr %m_data.i, align 8
  %arrayidx3.i.i.i206.epil = getelementptr inbounds %"struct.btDbvt::sStkNN", ptr %15, i64 %indvars.iv.i.i.i204.unr
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx.i.i.i205.epil, ptr noundef nonnull align 8 dereferenceable(16) %arrayidx3.i.i.i206.epil, i64 16, i1 false)
  br label %_ZNK20btAlignedObjectArrayIN6btDbvt6sStkNNEE4copyEiiPS1_.exit.i.i192

_ZNK20btAlignedObjectArrayIN6btDbvt6sStkNNEE4copyEiiPS1_.exit.i.i192: ; preds = %for.body.i.i.i203.epil, %_ZNK20btAlignedObjectArrayIN6btDbvt6sStkNNEE4copyEiiPS1_.exit.i.i192.loopexit.unr-lcssa, %if.then.i.i188, %_ZN20btAlignedObjectArrayIN6btDbvt6sStkNNEE8allocateEi.exit.i.i
  %retval.0.i.i.i268 = phi ptr [ %call.i.i.i.i189, %_ZN20btAlignedObjectArrayIN6btDbvt6sStkNNEE8allocateEi.exit.i.i ], [ null, %if.then.i.i188 ], [ %call.i.i.i.i189, %_ZNK20btAlignedObjectArrayIN6btDbvt6sStkNNEE4copyEiiPS1_.exit.i.i192.loopexit.unr-lcssa ], [ %call.i.i.i.i189, %for.body.i.i.i203.epil ]
  %16 = load ptr, ptr %m_data.i, align 8
  %tobool.not.i10.i.i194 = icmp eq ptr %16, null
  %17 = load i8, ptr %m_ownsMemory.i.i.i195, align 8
  %tobool2.not.i.i.i196 = icmp eq i8 %17, 0
  %or.cond.i.i197 = select i1 %tobool.not.i10.i.i194, i1 true, i1 %tobool2.not.i.i.i196
  br i1 %or.cond.i.i197, label %if.end.i199, label %if.then3.i.i.i198

if.then3.i.i.i198:                                ; preds = %_ZNK20btAlignedObjectArrayIN6btDbvt6sStkNNEE4copyEiiPS1_.exit.i.i192
  tail call void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %16)
  br label %if.end.i199

if.end.i199:                                      ; preds = %if.then3.i.i.i198, %_ZNK20btAlignedObjectArrayIN6btDbvt6sStkNNEE4copyEiiPS1_.exit.i.i192
  store i8 1, ptr %m_ownsMemory.i.i.i195, align 8
  store ptr %retval.0.i.i.i268, ptr %m_data.i, align 8
  store i32 %mul, ptr %m_capacity.i.i.i179, align 8
  br label %_ZN20btAlignedObjectArrayIN6btDbvt6sStkNNEE6resizeEiRKS1_.exit209

_ZN20btAlignedObjectArrayIN6btDbvt6sStkNNEE6resizeEiRKS1_.exit209: ; preds = %if.end.i199, %if.then7
...
if.then18:                                        ; preds = %if.then15
  ...
  store ptr %20, ptr %arrayidx.i215, align 8
  %ref.tmp19.sroa.4.0.arrayidx.i215.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i215, i64 8
  store ptr %20, ptr %ref.tmp19.sroa.4.0.arrayidx.i215.sroa_idx, align 8
  ...
  store ptr %22, ptr %arrayidx.i219, align 8
  %ref.tmp25.sroa.4.0.arrayidx.i219.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i219, i64 8
  store ptr %22, ptr %ref.tmp25.sroa.4.0.arrayidx.i219.sroa_idx, align 8
...
land.lhs.true.i:                                  ; preds = %if.else
  ...
  %29 = load float, ptr %p.sroa.22.0.copyload, align 4
...
if.then46:                                        ; preds = %_Z9IntersectRK12btDbvtAabbMmS1_.exit
  ...
  %38 = load ptr, ptr %arrayidx.i.i226, align 8
  ...
  %39 = load ptr, ptr %arrayidx.i.i254, align 8
...
if.then52:                                        ; preds = %if.then49
  ...
  store ptr %41, ptr %arrayidx.i233, align 8
  %ref.tmp53.sroa.4.0.arrayidx.i233.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i233, i64 8
  store ptr %43, ptr %ref.tmp53.sroa.4.0.arrayidx.i233.sroa_idx, align 8
  %45 = load ptr, ptr %arrayidx.i.i226, align 8
  ...
  store ptr %45, ptr %arrayidx.i237, align 8
  %ref.tmp61.sroa.4.0.arrayidx.i237.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i237, i64 8
  store ptr %46, ptr %ref.tmp61.sroa.4.0.arrayidx.i237.sroa_idx, align 8
  %48 = load ptr, ptr %40, align 8
  %49 = load ptr, ptr %arrayidx.i.i254, align 8
  ...
  store ptr %48, ptr %arrayidx.i241, align 8
  %ref.tmp69.sroa.4.0.arrayidx.i241.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i241, i64 8
  store ptr %49, ptr %ref.tmp69.sroa.4.0.arrayidx.i241.sroa_idx, align 8
  %51 = load ptr, ptr %arrayidx.i.i226, align 8
  %52 = load ptr, ptr %arrayidx.i.i254, align 8
  ...
  store ptr %51, ptr %arrayidx.i245, align 8
  %ref.tmp77.sroa.4.0.arrayidx.i245.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i245, i64 8
  store ptr %52, ptr %ref.tmp77.sroa.4.0.arrayidx.i245.sroa_idx, align 8
  br label %if.end125
...
if.else85:                                        ; preds = %if.then49
  ...
  store ptr %41, ptr %arrayidx.i249, align 8
  %ref.tmp86.sroa.4.0.arrayidx.i249.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i249, i64 8
  store ptr %p.sroa.22.0.copyload, ptr %ref.tmp86.sroa.4.0.arrayidx.i249.sroa_idx, align 8
  %55 = load ptr, ptr %arrayidx.i.i226, align 8
  ...
  store ptr %55, ptr %arrayidx.i253, align 8
  %ref.tmp93.sroa.4.0.arrayidx.i253.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i253, i64 8
  store ptr %p.sroa.22.0.copyload, ptr %ref.tmp93.sroa.4.0.arrayidx.i253.sroa_idx, align 8
  br label %if.end125
...
if.then104:                                       ; preds = %if.else101
  ...
  store ptr %p.sroa.0.0.copyload, ptr %arrayidx.i259, align 8
  %ref.tmp105.sroa.4.0.arrayidx.i259.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i259, i64 8
  store ptr %58, ptr %ref.tmp105.sroa.4.0.arrayidx.i259.sroa_idx, align 8
  %60 = load ptr, ptr %arrayidx.i.i254, align 8
  ...
  store ptr %p.sroa.0.0.copyload, ptr %arrayidx.i263, align 8
  %ref.tmp112.sroa.4.0.arrayidx.i263.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i263, i64 8
  store ptr %60, ptr %ref.tmp112.sroa.4.0.arrayidx.i263.sroa_idx, align 8
  br label %if.end125
...
if.then:                                          ; preds = %entry
  ...
  store i32 %.sroa.speculated191, ptr %m_fixedleft, align 8
  br label %if.end
...
_ZL10listappendI11btDbvtProxyEvPT_RS2_.exit:      ; preds = %_ZL10listremoveI11btDbvtProxyEvPT_RS2_.exit, %if.then.i
  ...
  store ptr %call43, ptr %leaf, align 8
...
do.end:                                           ; preds = %_ZL10listappendI11btDbvtProxyEvPT_RS2_.exit
  ...
  %16 = load i32, ptr %m_leaves49, align 4
  store i32 %16, ptr %m_fixedleft, align 8
  %m_needcleanup = getelementptr inbounds %struct.btDbvtBroadphase, ptr %this, i64 0, i32 19
  store i8 1, ptr %m_needcleanup, align 2
  br label %if.end54
...
if.end54:                                         ; preds = %do.end, %if.end
  ...
  store ptr getelementptr inbounds ({ [9 x ptr] }, ptr @_ZTV18btDbvtTreeCollider, i64 0, inrange i32 0, i64 2), ptr %collider55, align 8
  %pbp.i177 = getelementptr inbounds %struct.btDbvtTreeCollider, ptr %collider55, i64 0, i32 1
  store ptr %this, ptr %pbp.i177, align 8
  %m_deferedcollide = getelementptr inbounds %struct.btDbvtBroadphase, ptr %this, i64 0, i32 18
...
if.then57:                                        ; preds = %if.end54
  ...
  %.pr = load i8, ptr %m_deferedcollide, align 1
...
if.then89:                                        ; preds = %if.then86
  ...
  %25 = load i32, ptr %m_cupdates, align 8
...
land.lhs.true.i:                                  ; preds = %for.body
  ...
  %37 = load float, ptr %mx2.i187, align 4
...
land.lhs.true7.i:                                 ; preds = %land.lhs.true.i
  ...
  %40 = load float, ptr %arrayidx.i40.i, align 4
...
land.lhs.true13.i:                                ; preds = %land.lhs.true7.i
  ...
  %41 = load float, ptr %arrayidx.i41.i, align 4
  %arrayidx.i42.i = getelementptr inbounds [4 x float], ptr %34, i64 0, i64 1
  %42 = load float, ptr %arrayidx.i42.i, align 4
...
_Z9IntersectRK12btDbvtAabbMmS1_.exit:             ; preds = %land.lhs.true19.i
  ...
  %46 = load float, ptr %arrayidx.i46.i, align 4
...
if.end125:                                        ; preds = %if.then86, %if.else, %if.then116, %if.end80
  ...
  %.pre198 = load i32, ptr %m_updates_done137.phi.trans.insert, align 8
  ...
  %div138173 = lshr i32 %.pre198, 1
  store i32 %div138173, ptr %m_updates_done137, align 8
  %div140174 = lshr i32 %52, 1
  store i32 %div140174, ptr %m_updates_call, align 4
  ret void
}
...
land.lhs.true7.i:                                 ; preds = %land.lhs.true.i
  ...
  %18 = load float, ptr %arrayidx.i40.i, align 4
...
land.lhs.true13.i:                                ; preds = %land.lhs.true7.i
  ...
  %19 = load float, ptr %arrayidx.i41.i, align 4
  %arrayidx.i42.i = getelementptr inbounds [4 x float], ptr %12, i64 0, i64 1
  %20 = load float, ptr %arrayidx.i42.i, align 4
...
_Z9IntersectRK12btDbvtAabbMmS1_.exit:             ; preds = %land.lhs.true19.i
  ...
  %23 = load float, ptr %arrayidx.i45.i, align 4
  %arrayidx.i46.i = getelementptr inbounds [4 x float], ptr %12, i64 0, i64 2
  %24 = load float, ptr %arrayidx.i46.i, align 4
...
if.then21:                                        ; preds = %if.then9, %land.lhs.true.i, %land.lhs.true7.i, %land.lhs.true13.i, %land.lhs.true19.i, %for.body, %_Z9IntersectRK12btDbvtAabbMmS1_.exit
  ...
  %.pre63 = load i32, ptr %m_size.i.i, align 4
  br label %if.end27
...
for.end:                                          ; preds = %if.end27
  ...
  br i1 %cmp.i49, label %if.then.i50, label %_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI29btBroadphasePairSortPredicateEEvT_.exit52

if.then.i50:                                      ; preds = %for.end
  %sub.i51 = add nsw i32 %27, -1
  tail call void @_ZN20btAlignedObjectArrayI16btBroadphasePairE17quickSortInternalI29btBroadphasePairSortPredicateEEvT_ii(ptr noundef nonnull align 8 dereferenceable(25) %call5, i32 noundef 0, i32 noundef %sub.i51)
  %.pre64 = load i32, ptr %m_size.i.i, align 4
  br label %_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI29btBroadphasePairSortPredicateEEvT_.exit52

_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI29btBroadphasePairSortPredicateEEvT_.exit52: ; preds = %_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI29btBroadphasePairSortPredicateEEvT_.exit, %for.end, %if.then.i50
  %invalidPair.0.lcssa68 = phi i32 [ %invalidPair.1, %for.end ], [ %invalidPair.1, %if.then.i50 ], [ 0, %_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI29btBroadphasePairSortPredicateEEvT_.exit ]
  %29 = phi i32 [ %27, %for.end ], [ %.pre64, %if.then.i50 ], [ %5, %_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI29btBroadphasePairSortPredicateEEvT_.exit ]
...
if.else:                                          ; preds = %if.then
  %bounds.sroa.0.0.copyload = load <2 x float>, ptr %0, align 8
  %bounds.sroa.8.0..sroa_idx = getelementptr inbounds i8, ptr %0, i64 8
  %bounds.sroa.8.0.copyload = load <2 x float>, ptr %bounds.sroa.8.0..sroa_idx, align 8
  %bounds.sroa.10.0..sroa_idx = getelementptr inbounds i8, ptr %0, i64 16
  %bounds.sroa.10.0.copyload = load <2 x float>, ptr %bounds.sroa.10.0..sroa_idx, align 8
  %bounds.sroa.14.0..sroa_idx = getelementptr inbounds i8, ptr %0, i64 24
  %bounds.sroa.14.0.copyload = load <2 x float>, ptr %bounds.sroa.14.0..sroa_idx, align 8
  br label %if.end31
...
if.then20:                                        ; preds = %if.else16
  %bounds.sroa.0.0.copyload37 = load <2 x float>, ptr %1, align 8
  %bounds.sroa.8.0..sroa_idx39 = getelementptr inbounds i8, ptr %1, i64 8
  %bounds.sroa.8.0.copyload40 = load <2 x float>, ptr %bounds.sroa.8.0..sroa_idx39, align 8
  %bounds.sroa.10.0..sroa_idx42 = getelementptr inbounds i8, ptr %1, i64 16
  %bounds.sroa.10.0.copyload43 = load <2 x float>, ptr %bounds.sroa.10.0..sroa_idx42, align 8
  %bounds.sroa.14.0..sroa_idx44 = getelementptr inbounds i8, ptr %1, i64 24
  %bounds.sroa.14.0.copyload45 = load <2 x float>, ptr %bounds.sroa.14.0..sroa_idx44, align 8
  br label %if.end31
...
if.end31:                                         ; preds = %if.else16, %if.then20, %if.then5, %if.else
  ...
  store <2 x float> %bounds.sroa.0.0, ptr %aabbMin, align 4
  %bounds.sroa.8.0.aabbMin.sroa_idx = getelementptr inbounds i8, ptr %aabbMin, i64 8
  store <2 x float> %bounds.sroa.8.0, ptr %bounds.sroa.8.0.aabbMin.sroa_idx, align 4
  store <2 x float> %bounds.sroa.10.0, ptr %aabbMax, align 4
  %bounds.sroa.14.16.aabbMax.sroa_idx = getelementptr inbounds i8, ptr %aabbMax, i64 8
  store <2 x float> %bounds.sroa.14.0, ptr %bounds.sroa.14.16.aabbMax.sroa_idx, align 4
  ret void
}
...
define dso_local void @_ZN16btDbvtBroadphase10printStatsEv(ptr nocapture nonnull readnone align 8 %this) unnamed_addr #13 align 2 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local void @_ZN16btDbvtBroadphase9benchmarkEP21btBroadphaseInterface(ptr nocapture noundef readnone %0) local_unnamed_addr #13 align 2 {
entry:
  ret void
}
...
attributes #10 = { uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #11 = { mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #12 = { mustprogress nofree norecurse nosync nounwind willreturn memory(read, argmem: readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
