; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/gim_memory.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/gim_memory.cpp"
...
entry:
  store ptr %fn, ptr @_ZL9g_allocfn, align 8, !tbaa !5
  ret void
}
...
entry:
  store ptr %fn, ptr @_ZL10g_allocafn, align 8, !tbaa !5
  ret void
}
...
entry:
  store ptr %fn, ptr @_ZL11g_reallocfn, align 8, !tbaa !5
  ret void
}
...
entry:
  store ptr %fn, ptr @_ZL8g_freefn, align 8, !tbaa !5
  ret void
}
...
entry:
  %0 = load ptr, ptr @_ZL9g_allocfn, align 8, !tbaa !5
  ret ptr %0
}
...
entry:
  %0 = load ptr, ptr @_ZL10g_allocafn, align 8, !tbaa !5
  ret ptr %0
}
...
entry:
  %0 = load ptr, ptr @_ZL11g_reallocfn, align 8, !tbaa !5
  ret ptr %0
}
...
entry:
  %0 = load ptr, ptr @_ZL8g_freefn, align 8, !tbaa !5
  ret ptr %0
}
