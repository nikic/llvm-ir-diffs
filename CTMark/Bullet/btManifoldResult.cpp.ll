...
if.end23:                                         ; preds = %if.else, %if.then8
  ...
  %.pn211 = load float, ptr %.pn211.in, align 4, !tbaa !25
  %sub14.i.i151.sink204 = fsub float %11, %.pn211
  %.pn210 = load float, ptr %.pn210.in, align 4, !tbaa !25
  ...
  %58 = load float, ptr %m_rootTransB20.sink, align 4, !tbaa !25, !noalias !32
  %59 = load float, ptr %arrayidx3.i.i152.sink, align 4, !tbaa !25, !noalias !32
  %60 = load float, ptr %arrayidx6.i.i153.sink, align 4, !tbaa !25, !noalias !32
  %61 = load float, ptr %arrayidx.i.i.i154.sink, align 4, !tbaa !25, !noalias !32
  %62 = load float, ptr %arrayidx.i26.i.i155.sink, align 4, !tbaa !25, !noalias !32
  %63 = load float, ptr %arrayidx.i27.i.i156.sink, align 4, !tbaa !25, !noalias !32
  %64 = load float, ptr %arrayidx.i28.i.i157.sink, align 4, !tbaa !25, !noalias !32
  %65 = load float, ptr %arrayidx.i29.i.i158.sink, align 4, !tbaa !25, !noalias !32
  %66 = load float, ptr %arrayidx.i30.i.i159.sink, align 4, !tbaa !25, !noalias !32
...
lor.lhs.false:                                    ; preds = %land.lhs.true
  ...
  %102 = load i32, ptr %m_collisionFlags.i174, align 8, !tbaa !50
  %and60 = and i32 %102, 8
...
if.then62:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %103 = load ptr, ptr %m_manifoldPtr, align 8, !tbaa !8
  ...
  %104 = load i32, ptr %90, align 4, !tbaa !51
  %105 = load i32, ptr %92, align 4, !tbaa !52
  %106 = load i32, ptr %91, align 8, !tbaa !53
  %107 = load i32, ptr %93, align 8, !tbaa !54
