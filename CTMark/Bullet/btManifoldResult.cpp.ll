; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btManifoldResult.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btManifoldResult.cpp"
...
invoke.cont10:
  ...
  store ptr %body0, ptr %m_body0, align 8
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_rootTransA, ptr noundef nonnull align 4 dereferenceable(16) %m_worldTransform.i, i64 16, i1 false)
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_rootTransB, ptr noundef nonnull align 4 dereferenceable(16) %m_worldTransform.i16, i64 16, i1 false)
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx7.i.i18, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx5.i.i17, i64 16, i1 false)
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx11.i.i20, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx9.i.i19, i64 16, i1 false)
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_origin3.i22, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i21, i64 16, i1 false)
  ret void
}
...
if.then8:                                         ; preds = %if.end
  ...
  %12 = load float, ptr %m_origin.i, align 8
  ...
  %16 = load float, ptr %arrayidx13.i.i, align 8
  ...
  %17 = load float, ptr %arrayidx.i28.i.i, align 8
  %18 = load float, ptr %arrayidx.i29.i.i, align 8
  %19 = load float, ptr %arrayidx.i30.i.i, align 8
  %20 = load <2 x float>, ptr %m_rootTransB, align 8
  %21 = load <2 x float>, ptr %arrayidx3.i.i, align 8
  %22 = load <2 x float>, ptr %arrayidx6.i.i, align 8
...
if.else:                                          ; preds = %if.end
  ...
  %34 = load float, ptr %m_origin.i120, align 8
  ...
  %36 = load float, ptr %arrayidx7.i.i123, align 4
  ...
  %38 = load float, ptr %arrayidx13.i.i126, align 8
  ...
  %39 = load float, ptr %arrayidx.i28.i.i133, align 8
  %40 = load float, ptr %arrayidx.i29.i.i134, align 8
  %41 = load float, ptr %arrayidx.i30.i.i135, align 8
  %42 = load <2 x float>, ptr %m_rootTransA16, align 8
  %43 = load <2 x float>, ptr %arrayidx3.i.i128, align 8
  %44 = load <2 x float>, ptr %arrayidx6.i.i129, align 8
...
if.end23:                                         ; preds = %if.else, %if.then8
  ...
  %.pn210.in = phi ptr [ %m_origin.i144, %if.else ], [ %m_origin.i96, %if.then8 ]
  %.pn211.in = phi ptr [ %arrayidx13.i.i150, %if.else ], [ %arrayidx13.i.i102, %if.then8 ]
  ...
  %.pn211 = load float, ptr %.pn211.in, align 4
  %sub14.i.i151.sink204 = fsub float %11, %.pn211
  %.pn210 = load float, ptr %.pn210.in, align 4
  %56 = extractelement <2 x float> %9, i64 0
  %sub.i.i145.sink207 = fsub float %56, %.pn210
  %.pn = load float, ptr %.pn.in, align 4
  %57 = extractelement <2 x float> %9, i64 1
  %sub8.i.i148.sink208 = fsub float %57, %.pn
  %58 = load float, ptr %m_rootTransB20.sink, align 4
  %59 = load float, ptr %arrayidx3.i.i152.sink, align 4
  %60 = load float, ptr %arrayidx6.i.i153.sink, align 4
  %61 = load float, ptr %arrayidx.i.i.i154.sink, align 4
  %62 = load float, ptr %arrayidx.i26.i.i155.sink, align 4
  %63 = load float, ptr %arrayidx.i27.i.i156.sink, align 4
  %64 = load float, ptr %arrayidx.i28.i.i157.sink, align 4
  %65 = load float, ptr %arrayidx.i29.i.i158.sink, align 4
  %66 = load float, ptr %arrayidx.i30.i.i159.sink, align 4
  %67 = insertelement <2 x float> poison, float %sub8.i.i148.sink208, i64 0
  ...
  %74 = insertelement <2 x float> poison, float %sub.i.i145.sink207, i64 0
  ...
  %79 = insertelement <2 x float> poison, float %sub14.i.i151.sink204, i64 0
  %80 = shufflevector <2 x float> %79, <2 x float> poison, <2 x i32> zeroinitializer
  %81 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %78, <2 x float> %80, <2 x float> %76)
  %mul8.i20.i.i162 = fmul float %sub8.i.i148.sink208, %65
  %82 = tail call float @llvm.fmuladd.f32(float %64, float %sub.i.i145.sink207, float %mul8.i20.i.i162)
  %83 = tail call float @llvm.fmuladd.f32(float %66, float %sub14.i.i151.sink204, float %82)
  ...
  store <2 x float> %localA.sroa.5.0, ptr %localA.sroa.5.0.newPt.sroa_idx, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i8.i165, ptr %localB.sroa.5.0.m_localPointB.i.sroa_idx, align 8
  ...
  store <2 x float> zeroinitializer, ptr %m_combinedFriction.i, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i93, ptr %pointA.sroa.8.0.m_positionWorldOnA.sroa_idx, align 8
  %m_positionWorldOnB = getelementptr inbounds %class.btManifoldPoint, ptr %newPt, i64 0, i32 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_positionWorldOnB, ptr noundef nonnull align 4 dereferenceable(16) %pointInWorld, i64 16, i1 false)
  ...
  store float %friction.1.i, ptr %m_combinedFriction.i, align 4
  %m_restitution.i.i = getelementptr inbounds %class.btCollisionObject, ptr %84, i64 0, i32 17
  %88 = load float, ptr %m_restitution.i.i, align 8
  %m_restitution.i2.i = getelementptr inbounds %class.btCollisionObject, ptr %85, i64 0, i32 17
  %89 = load float, ptr %m_restitution.i2.i, align 8
  %mul.i169 = fmul float %88, %89
  store float %mul.i169, ptr %m_combinedRestitution.i, align 8
...
if.end46:                                         ; preds = %if.else37, %if.then32
  ...
  %.sink187 = load i32, ptr %.sink187.in, align 4
  ...
  %94 = load ptr, ptr %m_manifoldPtr, align 8
...
if.then48:                                        ; preds = %if.end46
  ...
  %97 = load ptr, ptr %m_userPersistentData.i173, align 8
  %98 = load <2 x float>, ptr %m_appliedImpulseLateral1.i171, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(172) %arrayidx.i, ptr noundef nonnull align 8 dereferenceable(172) %newPt, i64 172, i1 false)
  store ptr %97, ptr %m_userPersistentData.i173, align 8
  store float %96, ptr %m_appliedImpulse.i170, align 8
  store <2 x float> %98, ptr %m_appliedImpulseLateral1.i171, align 8
  store i32 %95, ptr %m_lifeTime.i.i, align 8
  br label %if.end53
...
if.end53:                                         ; preds = %if.else50, %if.then48
  ...
  %99 = load ptr, ptr @gContactAddedCallback, align 8
...
land.lhs.true:                                    ; preds = %if.end53
  ...
  %101 = load i32, ptr %m_collisionFlags.i, align 8
  %and = and i32 %101, 8
  %tobool57.not = icmp eq i32 %and, 0
  %m_body1.val.pre = load ptr, ptr %m_body1, align 8
  br i1 %tobool57.not, label %lor.lhs.false, label %if.then62

lor.lhs.false:                                    ; preds = %land.lhs.true
  %m_collisionFlags.i174 = getelementptr inbounds %class.btCollisionObject, ptr %m_body1.val.pre, i64 0, i32 11
  %102 = load i32, ptr %m_collisionFlags.i174, align 8
  %and60 = and i32 %102, 8
  %tobool61.not = icmp eq i32 %and60, 0
  br i1 %tobool61.not, label %if.end80, label %if.then62

if.then62:                                        ; preds = %lor.lhs.false, %land.lhs.true
  %cond = select i1 %cmp4.not, ptr %100, ptr %m_body1.val.pre
  %cond72 = select i1 %cmp4.not, ptr %m_body1.val.pre, ptr %100
  %103 = load ptr, ptr %m_manifoldPtr, align 8
  %idxprom.i175 = sext i32 %insertIndex.0 to i64
  %arrayidx.i176 = getelementptr inbounds %class.btPersistentManifold, ptr %103, i64 0, i32 2, i64 %idxprom.i175
  %104 = load i32, ptr %90, align 4
  %105 = load i32, ptr %92, align 4
  %106 = load i32, ptr %91, align 8
  %107 = load i32, ptr %93, align 8
  %call79 = call noundef zeroext i1 %99(ptr noundef nonnull align 8 dereferenceable(172) %arrayidx.i176, ptr noundef %cond, i32 noundef %104, i32 noundef %105, ptr noundef %cond72, i32 noundef %106, i32 noundef %107)
  br label %if.end80
