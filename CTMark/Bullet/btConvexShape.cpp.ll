; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btConvexShape.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btConvexShape.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [20 x ptr] }, ptr @_ZTV13btConvexShape, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  ret void
}
...
sw.bb22:                                          ; preds = %entry
  ...
  %9 = load float, ptr %arrayidx.i315, align 4
  %10 = load float, ptr %arrayidx.i316, align 4
  ...
  %35 = load float, ptr %arrayidx12.i331, align 8
  ...
  %sup.sroa.5.0.copyload = load float, ptr %sup.sroa.5.0.arrayidx36.sroa_idx, align 8
...
sw.bb40:                                          ; preds = %entry
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %halfExtents41, ptr noundef nonnull align 8 dereferenceable(16) %m_implicitShapeDimensions.i343, i64 16, i1 false)
  ...
  %42 = load float, ptr %arrayidx.i345, align 4
  %arrayidx5.i347 = getelementptr inbounds [4 x float], ptr %v, i64 0, i64 2
  store float %42, ptr %arrayidx5.i347, align 8
  %arrayidx7.i348 = getelementptr inbounds [4 x float], ptr %v, i64 0, i64 3
  store float 0.000000e+00, ptr %arrayidx7.i348, align 4
...
sw.epilog:                                        ; preds = %sw.bb40, %sw.bb49, %sw.bb48
  ...
  %44 = load float, ptr %arrayidx52, align 4
  ...
  %46 = load float, ptr %arrayidx58, align 4
...
if.then:                                          ; preds = %sw.epilog
  ...
  store float %mul, ptr %arrayidx75, align 4
  %arrayidx78 = getelementptr inbounds float, ptr %v, i64 %YY.0
  %49 = load float, ptr %arrayidx78, align 4
...
sw.bb127:                                         ; preds = %entry
  ...
  %52 = load <2 x float>, ptr %localDir, align 4
  %53 = load float, ptr %arrayidx.i360, align 4
  ...
  %56 = load float, ptr %arrayidx.i371, align 4
...
if.end:                                           ; preds = %sw.bb127, %if.else145
  ...
  store float %55, ptr %arrayidx154, align 4
  ...
  %65 = load float, ptr %arrayidx13.i, align 8
  %mul14.i = fmul float %vec.sroa.23.0, %65
  %mul8.i391 = fmul float %56, %mul14.i
  %66 = load float, ptr %arrayidx5.i381, align 8
  ...
  store float %fneg180, ptr %arrayidx183, align 4
  %84 = load float, ptr %arrayidx5.i432, align 8
  %add14.i463 = fadd float %mul8.i391, %84
  %85 = load <2 x float>, ptr %pos176, align 8
...
sw.bb220:                                         ; preds = %entry
  ...
  %95 = load float, ptr %arrayidx5.i.i503, align 4
  %96 = load <2 x float>, ptr %m_localScaling.i502, align 8
  ...
  %99 = load float, ptr %arrayidx11.i.i, align 4
...
for.body.i:                                       ; preds = %for.body.i, %for.body.preheader.i
  ...
  %102 = load float, ptr %arrayidx.i505, align 4
  %arrayidx7.i27.i = getelementptr inbounds [4 x float], ptr %arrayidx.i505, i64 0, i64 1
  %103 = load float, ptr %arrayidx7.i27.i, align 4
  ...
  %105 = load float, ptr %arrayidx12.i.i, align 4
...
sw.bb229:                                         ; preds = %entry
  ...
  %118 = load float, ptr %arrayidx11.i.i511, align 4
  %arrayidx13.i.i512 = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 1, i32 0, i64 2
  %119 = load float, ptr %arrayidx13.i.i512, align 8
  %mul14.i.i513 = fmul float %118, %119
  %cmp29.i514 = icmp sgt i32 %112, 0
  br i1 %cmp29.i514, label %for.body.preheader.i527, label %_ZL17convexHullSupportRK9btVector3PS0_iS1_.exit543

for.body.preheader.i527:                          ; preds = %sw.bb229
  %wide.trip.count.i528 = zext i32 %112 to i64
  br label %for.body.i529

for.cond.cleanup.loopexit.i542:                   ; preds = %for.body.i529
  %120 = sext i32 %ptIndex.1.i539 to i64
  br label %_ZL17convexHullSupportRK9btVector3PS0_iS1_.exit543

for.body.i529:                                    ; preds = %for.body.i529, %for.body.preheader.i527
  %indvars.iv.i530 = phi i64 [ 0, %for.body.preheader.i527 ], [ %indvars.iv.next.i540, %for.body.i529 ]
  %ptIndex.031.i531 = phi i32 [ -1, %for.body.preheader.i527 ], [ %ptIndex.1.i539, %for.body.i529 ]
  %maxDot.030.i532 = phi float [ 0xC3ABC16D60000000, %for.body.preheader.i527 ], [ %maxDot.1.i538, %for.body.i529 ]
  %arrayidx.i533 = getelementptr inbounds %class.btVector3, ptr %111, i64 %indvars.iv.i530
  %121 = load float, ptr %arrayidx.i533, align 4
  %arrayidx7.i27.i534 = getelementptr inbounds [4 x float], ptr %arrayidx.i533, i64 0, i64 1
  %122 = load float, ptr %arrayidx7.i27.i534, align 4
  ...
  %124 = load float, ptr %arrayidx12.i.i536, align 4
  ...
  %exitcond.not.i541 = icmp eq i64 %indvars.iv.next.i540, %wide.trip.count.i528
  br i1 %exitcond.not.i541, label %for.cond.cleanup.loopexit.i542, label %for.body.i529

_ZL17convexHullSupportRK9btVector3PS0_iS1_.exit543: ; preds = %sw.bb229, %for.cond.cleanup.loopexit.i542
  %ptIndex.0.lcssa.i515 = phi i64 [ -1, %sw.bb229 ], [ %120, %for.cond.cleanup.loopexit.i542 ]
  %arrayidx4.i516 = getelementptr inbounds %class.btVector3, ptr %111, i64 %ptIndex.0.lcssa.i515
  %127 = load <2 x float>, ptr %arrayidx4.i516, align 4
  %128 = fmul <2 x float> %115, %127
  %arrayidx11.i18.i520 = getelementptr inbounds [4 x float], ptr %arrayidx4.i516, i64 0, i64 2
  %129 = load float, ptr %arrayidx11.i18.i520, align 4
  %mul14.i20.i521 = fmul float %119, %129
  %retval.sroa.3.12.vec.insert.i23.i524 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %mul14.i20.i521, i64 0
  br label %return
...
return:                                           ; preds = %entry, %sw.default240, %_ZL17convexHullSupportRK9btVector3PS0_iS1_.exit543, %_ZL17convexHullSupportRK9btVector3PS0_iS1_.exit, %if.end, %cleanup, %sw.bb22, %sw.bb4
  ...
  %retval.sroa.16.1 = phi <2 x float> [ %132, %sw.default240 ], [ %retval.sroa.3.12.vec.insert.i23.i524, %_ZL17convexHullSupportRK9btVector3PS0_iS1_.exit543 ], [ %retval.sroa.3.12.vec.insert.i23.i, %_ZL17convexHullSupportRK9btVector3PS0_iS1_.exit ], [ %retval.sroa.16.12.vec.insert627, %if.end ], [ %retval.sroa.16.12.vec.insert625, %cleanup ], [ %retval.sroa.16.12.vec.insert621, %sw.bb22 ], [ %retval.sroa.16.12.vec.insert619, %sw.bb4 ], [ zeroinitializer, %entry ]
...
sw.bb10.i:                                        ; preds = %if.end, %if.end
  ...
  %22 = load float, ptr %m_collisionMargin.i16.i, align 8
  br label %_ZNK13btConvexShape19getMarginNonVirtualEv.exit
...
_ZNK13btConvexShape19getMarginNonVirtualEv.exit:  ; preds = %sw.bb.i, %sw.bb2.i, %sw.bb4.i, %sw.bb6.i, %sw.bb8.i, %sw.bb10.i, %sw.default.i
  ...
  %26 = load float, ptr %localDirNorm, align 8
  ...
  %27 = load <2 x float>, ptr %arrayidx5.i.i, align 4
...
entry:
  ...
  switch i32 %0, label %sw.default [
    ...
    i32 4, label %sw.bb10.i490
    i32 5, label %sw.bb10.i490
  ]
...
_ZNK13btConvexShape19getMarginNonVirtualEv.exit:  ; preds = %entry
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i, ptr %ref.tmp.sroa.4.0..sroa_idx, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i169, ptr %ref.tmp6.sroa.4.0..sroa_idx, align 4
  br label %sw.epilog

_ZNK13btConvexShape19getMarginNonVirtualEv.exit192: ; preds = %entry, %entry
  %retval.0.i175.in = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 3
  %retval.0.i175 = load float, ptr %retval.0.i175.in, align 8
  %m_implicitShapeDimensions.i193 = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 2
  %halfExtents.sroa.0.0.copyload = load float, ptr %m_implicitShapeDimensions.i193, align 8
  ...
  %halfExtents.sroa.8.0.copyload = load float, ptr %halfExtents.sroa.8.0.m_implicitShapeDimensions.i193.sroa_idx, align 4
  ...
  %halfExtents.sroa.13.0.copyload = load float, ptr %halfExtents.sroa.13.0.m_implicitShapeDimensions.i193.sroa_idx, align 8
  %add.i197 = fadd float %retval.0.i175, %halfExtents.sroa.0.0.copyload
  %add8.i200 = fadd float %retval.0.i175, %halfExtents.sroa.8.0.copyload
  %add13.i = fadd float %retval.0.i175, %halfExtents.sroa.13.0.copyload
  ...
  %15 = load <4 x float>, ptr %arrayidx.i43.i, align 4
  ...
  %22 = load float, ptr %arrayidx.i46.i, align 4
  ...
  %24 = load float, ptr %arrayidx.i47.i, align 4
  ...
  %center16.sroa.7.0.copyload = load float, ptr %center16.sroa.7.0.m_origin.i201.sroa_idx, align 4
  %mul8.i214 = fmul float %add8.i200, %23
  %26 = tail call float @llvm.fmuladd.f32(float %21, float %add.i197, float %mul8.i214)
  %27 = tail call float @llvm.fmuladd.f32(float %25, float %add13.i, float %26)
  ...
  %40 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %29, <2 x float> %39, <2 x float> %37)
  ...
  %sub14.i226 = fsub float %center16.sroa.7.0.copyload, %27
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i229, ptr %ref.tmp28.sroa.4.0..sroa_idx, align 4
  %45 = fadd <2 x float> %43, %34
  %add14.i238 = fadd float %center16.sroa.7.0.copyload, %27
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i241, ptr %ref.tmp31.sroa.4.0..sroa_idx, align 4
  br label %sw.epilog

_ZNK13btConvexShape19getMarginNonVirtualEv.exit264: ; preds = %entry
  %m_collisionMargin.i13.i253 = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 3
  %46 = load float, ptr %m_collisionMargin.i13.i253, align 8
...
for.body:                                         ; preds = %_ZNK13btConvexShape19getMarginNonVirtualEv.exit264, %for.body
  ...
  %51 = load float, ptr %arrayidx3.i265, align 4
  %52 = load float, ptr %arrayidx5.i266, align 4
  ...
  %65 = load float, ptr %arrayidx.i.i12.i, align 4
  %66 = load float, ptr %arrayidx.i14.i13.i, align 4
  %mul7.i15.i = fmul float %51, %66
  %67 = call float @llvm.fmuladd.f32(float %65, float %50, float %mul7.i15.i)
  %68 = load float, ptr %arrayidx.i16.i16.i, align 4
  ...
  %79 = load float, ptr %arrayidx.i14.i10.i, align 4
  %80 = load float, ptr %arrayidx.i14.i13.i, align 4
  %81 = shufflevector <2 x float> %70, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %82 = insertelement <2 x float> %75, float %79, i64 1
  %83 = fmul <2 x float> %81, %82
  %84 = insertelement <2 x float> %73, float %78, i64 1
  %85 = shufflevector <2 x float> %70, <2 x float> poison, <2 x i32> zeroinitializer
  %86 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %84, <2 x float> %85, <2 x float> %83)
  %87 = insertelement <2 x float> %77, float %80, i64 1
  ...
  %90 = load <2 x float>, ptr %m_origin.i273, align 4
  %91 = fadd <2 x float> %90, %89
  %92 = load float, ptr %arrayidx9.i.i, align 4
  %93 = load float, ptr %arrayidx.i16.i.i, align 4
  ...
  %95 = load float, ptr %arrayidx.i16.i16.i, align 4
  %96 = call float @llvm.fmuladd.f32(float %95, float %sv.sroa.5.8.vec.extract, float %94)
  %97 = load float, ptr %arrayidx.i32.i, align 4
  ...
  store float %add52, ptr %arrayidx55, align 4
  store float -1.000000e+00, ptr %arrayidx, align 4
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp61) #13
  %99 = load float, ptr %vec, align 4
  %100 = load float, ptr %arrayidx3.i265, align 4
  %101 = load float, ptr %arrayidx5.i266, align 4
  ...
  %114 = load float, ptr %arrayidx.i.i12.i, align 4
  %115 = load float, ptr %arrayidx.i14.i13.i, align 4
  %mul7.i15.i292 = fmul float %100, %115
  %116 = call float @llvm.fmuladd.f32(float %114, float %99, float %mul7.i15.i292)
  %117 = load float, ptr %arrayidx.i16.i16.i, align 4
  ...
  %128 = load float, ptr %arrayidx.i14.i10.i, align 4
  %129 = load float, ptr %arrayidx.i14.i13.i, align 4
  %130 = insertelement <2 x float> %124, float %128, i64 1
  %131 = shufflevector <2 x float> %119, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %132 = fmul <2 x float> %130, %131
  %133 = insertelement <2 x float> %122, float %127, i64 1
  %134 = shufflevector <2 x float> %119, <2 x float> poison, <2 x i32> zeroinitializer
  %135 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %133, <2 x float> %134, <2 x float> %132)
  %136 = insertelement <2 x float> %126, float %129, i64 1
  ...
  %139 = load <2 x float>, ptr %m_origin.i273, align 4
  %140 = fadd <2 x float> %139, %138
  %141 = load float, ptr %arrayidx9.i.i, align 4
  %142 = load float, ptr %arrayidx.i16.i.i, align 4
  ...
  store <2 x float> %140, ptr %tmp, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i320, ptr %48, align 8
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp61) #13
  %147 = load float, ptr %arrayidx51, align 4
  %sub = fsub float %147, %46
  %arrayidx74 = getelementptr inbounds float, ptr %aabbMin, i64 %indvars.iv
  store float %sub, ptr %arrayidx74, align 4
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %tmp) #13
...
_ZNK13btConvexShape19getMarginNonVirtualEv.exit414: ; preds = %entry
  ...
  %149 = load float, ptr %arrayidx.i325, align 4
  store float %149, ptr %halfExtents76, align 4
  %arrayidx3.i338 = getelementptr inbounds [4 x float], ptr %halfExtents76, i64 0, i64 1
  store float %149, ptr %arrayidx3.i338, align 4
  %arrayidx5.i339 = getelementptr inbounds [4 x float], ptr %halfExtents76, i64 0, i64 2
  store float %149, ptr %arrayidx5.i339, align 4
  ...
  %150 = load float, ptr %arrayidx.i351, align 4
  %add86 = fadd float %149, %150
  %arrayidx89 = getelementptr inbounds float, ptr %halfExtents76, i64 %idxprom.i350
  store float %add86, ptr %arrayidx89, align 4
  %m_collisionMargin.i15.i357 = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 3
  %151 = load float, ptr %m_collisionMargin.i15.i357, align 8
  %152 = load float, ptr %halfExtents76, align 4
  %add.i418 = fadd float %151, %152
  %153 = load float, ptr %arrayidx3.i338, align 4
  %add8.i421 = fadd float %151, %153
  %154 = load float, ptr %arrayidx5.i339, align 4
  %add13.i424 = fadd float %151, %154
  %155 = load <4 x float>, ptr %t, align 4
  ...
  %157 = load <4 x float>, ptr %arrayidx.i.i425, align 4
  %158 = shufflevector <4 x float> %157, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %arrayidx.i43.i426 = getelementptr inbounds [4 x float], ptr %t, i64 0, i64 2
  %159 = load <4 x float>, ptr %arrayidx.i43.i426, align 4
  %160 = shufflevector <4 x float> %159, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %arrayidx15.i427 = getelementptr inbounds [3 x %class.btVector3], ptr %t, i64 0, i64 1
  %161 = load float, ptr %arrayidx15.i427, align 4
  %arrayidx.i44.i428 = getelementptr inbounds [3 x %class.btVector3], ptr %t, i64 0, i64 1, i32 0, i64 1
  %162 = load float, ptr %arrayidx.i44.i428, align 4
  %arrayidx.i45.i429 = getelementptr inbounds [3 x %class.btVector3], ptr %t, i64 0, i64 1, i32 0, i64 2
  %163 = load float, ptr %arrayidx.i45.i429, align 4
  %arrayidx30.i430 = getelementptr inbounds [3 x %class.btVector3], ptr %t, i64 0, i64 2
  %164 = load float, ptr %arrayidx30.i430, align 4
  ...
  %166 = load float, ptr %arrayidx.i46.i431, align 4
  ...
  %168 = load float, ptr %arrayidx.i47.i432, align 4
  ...
  %center100.sroa.7.0.copyload = load float, ptr %center100.sroa.7.0.m_origin.i444.sroa_idx, align 4
  %mul8.i459 = fmul float %add8.i421, %167
  %170 = tail call float @llvm.fmuladd.f32(float %165, float %add.i418, float %mul8.i459)
  %171 = tail call float @llvm.fmuladd.f32(float %169, float %add13.i424, float %170)
  %172 = insertelement <2 x float> %156, float %161, i64 1
  %173 = tail call <2 x float> @llvm.fabs.v2f32(<2 x float> %172)
  %174 = insertelement <2 x float> %158, float %162, i64 1
  %175 = tail call <2 x float> @llvm.fabs.v2f32(<2 x float> %174)
  %176 = insertelement <2 x float> %160, float %163, i64 1
  ...
  %184 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %173, <2 x float> %183, <2 x float> %181)
  ...
  %sub14.i471 = fsub float %center100.sroa.7.0.copyload, %171
  %retval.sroa.3.12.vec.insert.i474 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %sub14.i471, i64 0
  store <2 x float> %188, ptr %aabbMin, align 4
  %ref.tmp112.sroa.4.0..sroa_idx = getelementptr inbounds i8, ptr %aabbMin, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i474, ptr %ref.tmp112.sroa.4.0..sroa_idx, align 4
  %189 = fadd <2 x float> %187, %178
  %add14.i483 = fadd float %center100.sroa.7.0.copyload, %171
  %retval.sroa.3.12.vec.insert.i486 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i483, i64 0
  store <2 x float> %189, ptr %aabbMax, align 4
  %ref.tmp115.sroa.4.0..sroa_idx = getelementptr inbounds i8, ptr %aabbMax, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i486, ptr %ref.tmp115.sroa.4.0..sroa_idx, align 4
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %halfExtents76) #13
  br label %sw.epilog

sw.bb10.i490:                                     ; preds = %entry, %entry
  %m_collisionMargin.i16.i491 = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 3
  %190 = load float, ptr %m_collisionMargin.i16.i491, align 8
  ...
  %191 = load float, ptr %m_localAabbMax.i, align 8
  %192 = load float, ptr %m_localAabbMin.i, align 8
  ...
  %193 = load float, ptr %arrayidx5.i.i.i510, align 4
  ...
  %197 = load <4 x float>, ptr %t, align 4
  ...
  %199 = load <4 x float>, ptr %arrayidx.i.i.i.i, align 4
  ...
  %201 = load <4 x float>, ptr %arrayidx.i43.i.i.i, align 4
  ...
  %210 = load float, ptr %arrayidx.i47.i.i.i, align 4
  %211 = tail call float @llvm.fabs.f32(float %210)
  %m_origin.i.i.i = getelementptr inbounds %class.btTransform, ptr %t, i64 0, i32 1
  %mul8.i29.i.i.i = fmul float %mul4.i.i50.i.i, %208
  %212 = tail call float @llvm.fmuladd.f32(float %206, float %mul.i.i48.i.i, float %mul8.i29.i.i.i)
  %213 = tail call float @llvm.fmuladd.f32(float %210, float %mul8.i.i52.i.i, float %212)
  %arrayidx.i32.i.i.i = getelementptr inbounds %class.btTransform, ptr %t, i64 0, i32 1, i32 0, i64 2
  %214 = load float, ptr %arrayidx.i32.i.i.i, align 4
  %add17.i.i.i = fadd float %213, %214
  %mul8.i79.i.i = fmul float %add8.i.i.i, %209
  %215 = tail call float @llvm.fmuladd.f32(float %207, float %add.i.i.i, float %mul8.i79.i.i)
  %216 = tail call float @llvm.fmuladd.f32(float %211, float %add13.i.i.i, float %215)
  %217 = insertelement <2 x float> %198, float %203, i64 1
  %218 = tail call <2 x float> @llvm.fabs.v2f32(<2 x float> %217)
  %219 = insertelement <2 x float> %200, float %204, i64 1
  %220 = tail call <2 x float> @llvm.fabs.v2f32(<2 x float> %219)
  %221 = insertelement <2 x float> %202, float %205, i64 1
  ...
  %228 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %217, <2 x float> %227, <2 x float> %225)
  ...
  %232 = load <2 x float>, ptr %m_origin.i.i.i, align 4
  ...
  %239 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %218, <2 x float> %238, <2 x float> %236)
...
sw.epilog:                                        ; preds = %for.body, %sw.default, %sw.bb10.i490, %_ZNK13btConvexShape19getMarginNonVirtualEv.exit414, %_ZNK13btConvexShape19getMarginNonVirtualEv.exit192, %_ZNK13btConvexShape19getMarginNonVirtualEv.exit
  ret void
}
...
attributes #2 = { noreturn nounwind memory(inaccessiblemem: write) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
