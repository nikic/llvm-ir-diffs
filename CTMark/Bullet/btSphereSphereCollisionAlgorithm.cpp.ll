; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSphereSphereCollisionAlgorithm.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSphereSphereCollisionAlgorithm.cpp"
...
if.end:                                           ; preds = %entry
  ...
  %2 = load ptr, ptr %m_collisionShape.i43, align 8
  ...
  %4 = load <2 x float>, ptr %m_origin.i45, align 4
...
if.then12:                                        ; preds = %if.end
  ...
  %16 = load i32, ptr %m_cachedPoints.i.i, align 8
...
if.end.i:                                         ; preds = %if.then12
  ...
  %17 = load ptr, ptr %m_body0.i.i, align 8
...
if.then18:                                        ; preds = %if.end13
  ...
  store <2 x float> %21, ptr %normalOnSurfaceB, align 16
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i, ptr %arrayidx5.i50, align 8
  br label %if.end22
...
if.end22:                                         ; preds = %if.then18, %if.end13
  ...
  %30 = load ptr, ptr %m_manifoldPtr.i, align 8
  %m_cachedPoints.i.i74 = getelementptr inbounds %class.btPersistentManifold, ptr %30, i64 0, i32 5
  %31 = load i32, ptr %m_cachedPoints.i.i74, align 8
  %tobool.not.i75 = icmp eq i32 %31, 0
  br i1 %tobool.not.i75, label %_ZN16btManifoldResult20refreshContactPointsEv.exit86, label %if.end.i76

if.end.i76:                                       ; preds = %if.end22
  %m_body0.i.i77 = getelementptr inbounds %class.btPersistentManifold, ptr %30, i64 0, i32 3
  %32 = load ptr, ptr %m_body0.i.i77, align 8
  %m_body0.i78 = getelementptr inbounds %class.btManifoldResult, ptr %resultOut, i64 0, i32 4
  %33 = load ptr, ptr %m_body0.i78, align 8
  %cmp.not.i79 = icmp eq ptr %32, %33
  br i1 %cmp.not.i79, label %if.else.i83, label %if.then5.i80

if.then5.i80:                                     ; preds = %if.end.i76
  %m_rootTransB.i81 = getelementptr inbounds %class.btManifoldResult, ptr %resultOut, i64 0, i32 3
  %m_rootTransA.i82 = getelementptr inbounds %class.btManifoldResult, ptr %resultOut, i64 0, i32 2
  call void @_ZN20btPersistentManifold20refreshContactPointsERK11btTransformS2_(ptr noundef nonnull align 8 dereferenceable(744) %30, ptr noundef nonnull align 4 dereferenceable(64) %m_rootTransB.i81, ptr noundef nonnull align 4 dereferenceable(64) %m_rootTransA.i82)
  br label %_ZN16btManifoldResult20refreshContactPointsEv.exit86

if.else.i83:                                      ; preds = %if.end.i76
  %m_rootTransA8.i84 = getelementptr inbounds %class.btManifoldResult, ptr %resultOut, i64 0, i32 2
  %m_rootTransB9.i85 = getelementptr inbounds %class.btManifoldResult, ptr %resultOut, i64 0, i32 3
  call void @_ZN20btPersistentManifold20refreshContactPointsERK11btTransformS2_(ptr noundef nonnull align 8 dereferenceable(744) %30, ptr noundef nonnull align 4 dereferenceable(64) %m_rootTransA8.i84, ptr noundef nonnull align 4 dereferenceable(64) %m_rootTransB9.i85)
  br label %_ZN16btManifoldResult20refreshContactPointsEv.exit86

_ZN16btManifoldResult20refreshContactPointsEv.exit86: ; preds = %if.end22, %if.then5.i80, %if.else.i83
