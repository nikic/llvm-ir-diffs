; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btUniformScalingShape.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btUniformScalingShape.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [20 x ptr] }, ptr @_ZTV21btUniformScalingShape, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph.new
  ...
  %3 = load float, ptr %m_uniformScalingFactor, align 8
  ...
  %retval.sroa.3.12.vec.insert.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %mul8.i, i64 0
  store <2 x float> %7, ptr %arrayidx, align 4
  ...
  %9 = load float, ptr %m_uniformScalingFactor, align 8
  %10 = load <2 x float>, ptr %arrayidx.1, align 4
  ...
  %14 = load float, ptr %arrayidx7.i.1, align 4
  ...
  store <2 x float> %13, ptr %arrayidx.1, align 4
  store <2 x float> %retval.sroa.3.12.vec.insert.i.1, ptr %arrayidx7.i.1, align 4
...
for.body.epil:                                    ; preds = %for.end.loopexit.unr-lcssa
  ...
  %15 = load float, ptr %m_uniformScalingFactor, align 8
  %16 = load <2 x float>, ptr %arrayidx.epil, align 4
  ...
  %20 = load float, ptr %arrayidx7.i.epil, align 4
  ...
  store <2 x float> %19, ptr %arrayidx.epil, align 4
  store <2 x float> %retval.sroa.3.12.vec.insert.i.epil, ptr %arrayidx7.i.epil, align 4
  br label %for.end
...
entry:
  ...
  store <2 x float> %14, ptr %aabbMin, align 4
  store <2 x float> %retval.sroa.3.12.vec.insert.i70, ptr %arrayidx13.i, align 4
  ...
  store <2 x float> %15, ptr %aabbMax, align 4
  store <2 x float> %retval.sroa.3.12.vec.insert.i82, ptr %arrayidx11.i, align 4
  ret void
}
