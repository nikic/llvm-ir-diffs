; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btBoxShape.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btBoxShape.cpp"
...
entry:
  ...
  %2 = load float, ptr %arrayidx5.i19.i, align 4
  ...
  %8 = load <4 x float>, ptr %arrayidx.i43.i.i, align 4
  ...
  %15 = load float, ptr %arrayidx.i46.i.i, align 4
  ...
  %17 = load float, ptr %arrayidx.i47.i.i, align 4
  ...
  %center.sroa.7.0.copyload.i = load float, ptr %center.sroa.7.0.m_origin.i.sroa_idx.i, align 4
  %mul8.i31.i = fmul float %add8.i.i, %16
  %19 = tail call float @llvm.fmuladd.f32(float %14, float %add.i.i, float %mul8.i31.i)
  %20 = tail call float @llvm.fmuladd.f32(float %18, float %add14.i.i, float %19)
  ...
  %33 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %22, <2 x float> %32, <2 x float> %30)
  ...
  %sub14.i.i = fsub float %center.sroa.7.0.copyload.i, %20
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i43.i, ptr %ref.tmp12.sroa.4.0..sroa_idx.i, align 4
  %38 = fadd <2 x float> %36, %27
  %add14.i52.i = fadd float %center.sroa.7.0.copyload.i, %20
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i55.i, ptr %ref.tmp15.sroa.4.0..sroa_idx.i, align 4
  ret void
}

; Function Attrs: uwtable
define dso_local void @_ZNK10btBoxShape21calculateLocalInertiaEfR9btVector3(ptr noundef nonnull align 8 dereferenceable(64) %this, float noundef %mass, ptr nocapture noundef nonnull writeonly align 4 dereferenceable(16) %inertia) unnamed_addr #0 align 2 {
entry:
...
define linkonce_odr dso_local void @_ZN10btBoxShapeD0Ev(ptr noundef nonnull align 8 dereferenceable(64) %this) unnamed_addr #4 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
...
; Function Attrs: uwtable
define linkonce_odr dso_local void @_ZN10btBoxShape15setLocalScalingERK9btVector3(ptr noundef nonnull align 8 dereferenceable(64) %this, ptr noundef nonnull align 4 dereferenceable(16) %scaling) unnamed_addr #0 comdat align 2 {
entry:
  %vtable = load ptr, ptr %this, align 8
  %vfn = getelementptr inbounds ptr, ptr %vtable, i64 11
  %0 = load ptr, ptr %vfn, align 8
  ...
  %4 = load float, ptr %arrayidx13.i26, align 8
  ...
  %13 = load float, ptr %arrayidx13.i26, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i47, ptr %arrayidx11.i, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local noundef ptr @_ZNK10btBoxShape7getNameEv(ptr noundef nonnull align 8 dereferenceable(64) %this) unnamed_addr #5 comdat align 2 {
entry:
  ret ptr @.str
}

; Function Attrs: uwtable
define linkonce_odr dso_local void @_ZN10btBoxShape9setMarginEf(ptr noundef nonnull align 8 dereferenceable(64) %this, float noundef %collisionMargin) unnamed_addr #0 comdat align 2 {
entry:
  %vtable = load ptr, ptr %this, align 8
  %vfn = getelementptr inbounds ptr, ptr %vtable, i64 11
  %0 = load ptr, ptr %vfn, align 8
...
; Function Attrs: uwtable
define linkonce_odr dso_local { <2 x float>, <2 x float> } @_ZNK10btBoxShape24localGetSupportingVertexERK9btVector3(ptr noundef nonnull align 8 dereferenceable(64) %this, ptr noundef nonnull align 4 dereferenceable(16) %vec) unnamed_addr #6 comdat align 2 {
entry:
  %m_implicitShapeDimensions.i = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 2
...
; Function Attrs: inlinehint uwtable
define linkonce_odr dso_local { <2 x float>, <2 x float> } @_ZNK10btBoxShape37localGetSupportingVertexWithoutMarginERK9btVector3(ptr noundef nonnull align 8 dereferenceable(64) %this, ptr noundef nonnull align 4 dereferenceable(16) %vec) unnamed_addr #4 comdat align 2 {
entry:
  %m_implicitShapeDimensions.i = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 2
  ...
  %3 = load <2 x float>, ptr %arrayidx.i25, align 4
  %4 = fneg <2 x float> %3
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZNK10btBoxShape49batchedUnitVectorGetSupportingVertexWithoutMarginEPK9btVector3PS0_i(ptr noundef nonnull align 8 dereferenceable(64) %this, ptr noundef %vectors, ptr noundef %supportVerticesOut, i32 noundef %numVectors) unnamed_addr #5 comdat align 2 {
entry:
  %m_implicitShapeDimensions.i = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 2
...
vector.memcheck:                                  ; preds = %for.body.lr.ph
  ...
  %scevgep43 = getelementptr inbounds i8, ptr %this, i64 52
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <16 x float> %interleaved.vec, ptr %55, align 4
  %index.next = add nuw i64 %index, 4
  %58 = icmp eq i64 %index.next, %n.vec
  br i1 %58, label %for.body.preheader, label %vector.body
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local noundef i32 @_ZNK10btBoxShape36getNumPreferredPenetrationDirectionsEv(ptr noundef nonnull align 8 dereferenceable(64) %this) unnamed_addr #5 comdat align 2 {
entry:
  ret i32 6
}

; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZNK10btBoxShape32getPreferredPenetrationDirectionEiR9btVector3(ptr noundef nonnull align 8 dereferenceable(64) %this, i32 noundef %index, ptr noundef nonnull align 4 dereferenceable(16) %penetrationVector) unnamed_addr #5 comdat align 2 {
entry:
...
switch.lookup:                                    ; preds = %entry
  ...
  %switch.gep = getelementptr inbounds [6 x float], ptr @switch.table._ZNK10btBoxShape32getPreferredPenetrationDirectionEiR9btVector3, i64 0, i64 %1
  %switch.load = load float, ptr %switch.gep, align 4
  %2 = sext i32 %index to i64
  %switch.gep46 = getelementptr inbounds [6 x float], ptr @switch.table._ZNK10btBoxShape32getPreferredPenetrationDirectionEiR9btVector3.1, i64 0, i64 %2
  %switch.load47 = load float, ptr %switch.gep46, align 4
  %3 = sext i32 %index to i64
  %switch.gep48 = getelementptr inbounds [6 x float], ptr @switch.table._ZNK10btBoxShape32getPreferredPenetrationDirectionEiR9btVector3.2, i64 0, i64 %3
  ...
  store float %switch.load47, ptr %arrayidx3.i41, align 4
  %arrayidx5.i42 = getelementptr inbounds [4 x float], ptr %penetrationVector, i64 0, i64 2
  store float %switch.load49, ptr %arrayidx5.i42, align 4
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local noundef i32 @_ZNK10btBoxShape14getNumVerticesEv(ptr noundef nonnull align 8 dereferenceable(64) %this) unnamed_addr #5 comdat align 2 {
entry:
  ret i32 8
}

; Function Attrs: nounwind uwtable
define linkonce_odr dso_local noundef i32 @_ZNK10btBoxShape11getNumEdgesEv(ptr noundef nonnull align 8 dereferenceable(64) %this) unnamed_addr #5 comdat align 2 {
entry:
  ret i32 12
}

; Function Attrs: uwtable
define linkonce_odr dso_local void @_ZNK10btBoxShape7getEdgeEiR9btVector3S1_(ptr noundef nonnull align 8 dereferenceable(64) %this, i32 noundef %i, ptr noundef nonnull align 4 dereferenceable(16) %pa, ptr noundef nonnull align 4 dereferenceable(16) %pb) unnamed_addr #6 comdat align 2 {
entry:
  %0 = icmp ult i32 %i, 12
  br i1 %0, label %switch.lookup, label %sw.epilog
...
switch.lookup:                                    ; preds = %entry
  %1 = sext i32 %i to i64
  %switch.gep = getelementptr inbounds [12 x i32], ptr @switch.table._ZNK10btBoxShape7getEdgeEiR9btVector3S1_, i64 0, i64 %1
  %switch.load = load i32, ptr %switch.gep, align 4
  %2 = sext i32 %i to i64
  %switch.gep15 = getelementptr inbounds [12 x i32], ptr @switch.table._ZNK10btBoxShape7getEdgeEiR9btVector3S1_.3, i64 0, i64 %2
...
sw.epilog:                                        ; preds = %switch.lookup, %entry
  ...
  tail call void %3(ptr noundef nonnull align 8 dereferenceable(64) %this, i32 noundef %edgeVert0.0, ptr noundef nonnull align 4 dereferenceable(16) %pa)
  %vtable13 = load ptr, ptr %this, align 8
  %vfn14 = getelementptr inbounds ptr, ptr %vtable13, i64 21
  %4 = load ptr, ptr %vfn14, align 8
  tail call void %4(ptr noundef nonnull align 8 dereferenceable(64) %this, i32 noundef %edgeVert1.0, ptr noundef nonnull align 4 dereferenceable(16) %pb)
  ret void
}

; Function Attrs: uwtable
define linkonce_odr dso_local void @_ZNK10btBoxShape9getVertexEiR9btVector3(ptr noundef nonnull align 8 dereferenceable(64) %this, i32 noundef %i, ptr noundef nonnull align 4 dereferenceable(16) %vtx) unnamed_addr #6 comdat align 2 {
entry:
  %m_implicitShapeDimensions.i = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 2
  ...
  %halfExtents.sroa.7.0.copyload = load float, ptr %halfExtents.sroa.7.0.m_implicitShapeDimensions.i.sroa_idx, align 8
  %and10 = lshr i32 %i, 1
  %and21 = lshr i32 %i, 2
  ...
  store float %1, ptr %ref.tmp.sroa.5.0.vtx.sroa_idx, align 4
  %ref.tmp.sroa.6.0.vtx.sroa_idx = getelementptr inbounds i8, ptr %vtx, i64 12
  store float 0.000000e+00, ptr %ref.tmp.sroa.6.0.vtx.sroa_idx, align 4
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr dso_local noundef i32 @_ZNK10btBoxShape12getNumPlanesEv(ptr noundef nonnull align 8 dereferenceable(64) %this) unnamed_addr #5 comdat align 2 {
entry:
  ret i32 6
}

; Function Attrs: uwtable
define linkonce_odr dso_local void @_ZNK10btBoxShape8getPlaneER9btVector3S1_i(ptr noundef nonnull align 8 dereferenceable(64) %this, ptr noundef nonnull align 4 dereferenceable(16) %planeNormal, ptr noundef nonnull align 4 dereferenceable(16) %planeSupport, i32 noundef %i) unnamed_addr #0 comdat align 2 {
entry:
  ...
  %0 = load ptr, ptr %vfn, align 8
  call void %0(ptr noundef nonnull align 8 dereferenceable(64) %this, ptr noundef nonnull align 4 dereferenceable(16) %plane, i32 noundef %i)
  %arrayidx.i12 = getelementptr inbounds [4 x float], ptr %plane, i64 0, i64 2
  %1 = load float, ptr %arrayidx.i12, align 8
  ...
  store float %1, ptr %ref.tmp.sroa.5.0.planeNormal.sroa_idx, align 4
  %ref.tmp.sroa.6.0.planeNormal.sroa_idx = getelementptr inbounds i8, ptr %planeNormal, i64 12
  store float 0.000000e+00, ptr %ref.tmp.sroa.6.0.planeNormal.sroa_idx, align 4
  ...
  %call9 = call { <2 x float>, <2 x float> } %5(ptr noundef nonnull align 8 dereferenceable(64) %this, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp5)
  ...
  store <2 x float> %7, ptr %ref.tmp4.sroa.4.0..sroa_idx, align 4
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local noundef zeroext i1 @_ZNK10btBoxShape8isInsideERK9btVector3f(ptr noundef nonnull align 8 dereferenceable(64) %this, ptr noundef nonnull align 4 dereferenceable(16) %pt, float noundef %tolerance) unnamed_addr #5 comdat align 2 {
entry:
  %m_implicitShapeDimensions.i = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 2
  %halfExtents.sroa.0.0.copyload = load float, ptr %m_implicitShapeDimensions.i, align 8
...
land.lhs.true18:                                  ; preds = %land.lhs.true12
  ...
  %2 = load float, ptr %arrayidx.i41, align 4
...
; Function Attrs: uwtable
define linkonce_odr dso_local void @_ZNK10btBoxShape16getPlaneEquationER9btVector4i(ptr noundef nonnull align 8 dereferenceable(64) %this, ptr noundef nonnull align 4 dereferenceable(16) %plane, i32 noundef %i) unnamed_addr #6 comdat align 2 {
entry:
  %m_implicitShapeDimensions.i = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 2
  %halfExtents.sroa.0.0.copyload = load float, ptr %m_implicitShapeDimensions.i, align 8
  %halfExtents.sroa.5.0.m_implicitShapeDimensions.i.sroa_idx = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 2, i32 0, i64 1
...
sw.epilog.sink.split:                             ; preds = %entry, %sw.bb6, %sw.bb13, %sw.bb20, %sw.bb27, %sw.bb34
  ...
  store float %.sink, ptr %arrayidx5.i62, align 4
  %arrayidx7.i63 = getelementptr inbounds [4 x float], ptr %plane, i64 0, i64 3
  store float %fneg40, ptr %arrayidx7.i63, align 4
  br label %sw.epilog
