; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btScaledBvhTriangleMeshShape.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btScaledBvhTriangleMeshShape.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [15 x ptr] }, ptr @_ZTV28btScaledBvhTriangleMeshShape, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
entry:
  ...
  %0 = load float, ptr %arrayidx.i187, align 4
  ...
  store float %cond87, ptr %arrayidx90, align 8
  ...
  store float %cond165, ptr %arrayidx168, align 8
  %m_bvhTriMeshShape = getelementptr inbounds %class.btScaledBvhTriangleMeshShape, ptr %this, i64 0, i32 2
...
entry:
  ...
  %localAabbMin.sroa.7.0.copyload = load float, ptr %localAabbMin.sroa.7.0.m_localAabbMin.i.sroa_idx, align 4
  ...
  %localAabbMin.sroa.11.0.copyload = load float, ptr %localAabbMin.sroa.11.0.m_localAabbMin.i.sroa_idx, align 4
  ...
  %localAabbMax.sroa.7.0.copyload = load float, ptr %localAabbMax.sroa.7.0.m_localAabbMax.i.sroa_idx, align 4
  ...
  %localAabbMax.sroa.11.0.copyload = load float, ptr %localAabbMax.sroa.11.0.m_localAabbMax.i.sroa_idx, align 4
  %m_localScaling = getelementptr inbounds %class.btScaledBvhTriangleMeshShape, ptr %this, i64 0, i32 1
  ...
  %9 = load <4 x float>, ptr %arrayidx.i43.i, align 4
  ...
  %12 = load float, ptr %arrayidx.i44.i, align 4
  ...
  %18 = load float, ptr %arrayidx.i47.i, align 4
  %19 = tail call float @llvm.fabs.f32(float %18)
  %m_origin.i = getelementptr inbounds %class.btTransform, ptr %trans, i64 0, i32 1
  %mul8.i29.i = fmul float %mul4.i.i160, %16
  %20 = tail call float @llvm.fmuladd.f32(float %14, float %mul.i.i158, float %mul8.i29.i)
  %21 = tail call float @llvm.fmuladd.f32(float %18, float %mul8.i.i162, float %20)
  %arrayidx.i32.i = getelementptr inbounds %class.btTransform, ptr %trans, i64 0, i32 1, i32 0, i64 2
  %22 = load float, ptr %arrayidx.i32.i, align 4
  %add17.i = fadd float %21, %22
  %mul8.i191 = fmul float %add8.i, %17
  %23 = tail call float @llvm.fmuladd.f32(float %15, float %add.i, float %mul8.i191)
  %24 = tail call float @llvm.fmuladd.f32(float %19, float %add13.i, float %23)
  ...
  %36 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %25, <2 x float> %35, <2 x float> %33)
  ...
  %sub14.i203 = fsub float %add17.i, %24
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i206, ptr %ref.tmp112.sroa.4.0..sroa_idx, align 4
  %52 = fadd <2 x float> %50, %41
  %add14.i215 = fadd float %24, %add17.i
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i218, ptr %ref.tmp115.sroa.4.0..sroa_idx, align 4
  ret void
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local void @_ZNK28btScaledBvhTriangleMeshShape21calculateLocalInertiaEfR9btVector3(ptr nocapture nonnull readnone align 8 %this, float %mass, ptr nocapture nonnull readnone align 4 %inertia) unnamed_addr #8 align 2 {
entry:
  ret void
}
...
entry:
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i, ptr %ref.tmp.sroa.4.0.arrayidx2.sroa_idx, align 8
  ...
  %7 = load float, ptr %arrayidx11.i22, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i27, ptr %ref.tmp3.sroa.4.0.arrayidx8.sroa_idx, align 8
  ...
  %10 = load float, ptr %arrayidx11.i34, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i39, ptr %ref.tmp9.sroa.4.0.arrayidx14.sroa_idx, align 8
