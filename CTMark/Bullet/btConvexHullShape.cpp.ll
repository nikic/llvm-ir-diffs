; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btConvexHullShape.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btConvexHullShape.cpp"
...
for.body.epil:                                    ; preds = %for.cond.cleanup.loopexit.unr-lcssa
  ...
  store float %7, ptr %ref.tmp6.sroa.5.0.arrayidx.i.sroa_idx.epil, align 4, !tbaa.struct !25
  %ref.tmp6.sroa.6.0.arrayidx.i.sroa_idx.epil = getelementptr inbounds i8, ptr %arrayidx.i.epil, i64 12
  store float 0.000000e+00, ptr %ref.tmp6.sroa.6.0.arrayidx.i.sroa_idx.epil, align 4, !tbaa.struct !26
  br label %for.cond.cleanup
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph.new
  ...
  store float %11, ptr %ref.tmp6.sroa.5.0.arrayidx.i.sroa_idx, align 4, !tbaa.struct !25
  %ref.tmp6.sroa.6.0.arrayidx.i.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i, i64 12
  store float 0.000000e+00, ptr %ref.tmp6.sroa.6.0.arrayidx.i.sroa_idx, align 4, !tbaa.struct !26
  ...
  store float %14, ptr %ref.tmp6.sroa.5.0.arrayidx.i.sroa_idx.1, align 4, !tbaa.struct !25
  %ref.tmp6.sroa.6.0.arrayidx.i.sroa_idx.1 = getelementptr inbounds i8, ptr %arrayidx.i.1, i64 12
  store float 0.000000e+00, ptr %ref.tmp6.sroa.6.0.arrayidx.i.sroa_idx.1, align 4, !tbaa.struct !26
...
_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i: ; preds = %for.body.i.i.i.epil, %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa, %_ZN20btAlignedObjectArrayI9btVector3E8allocateEi.exit.i.i
  ...
  %8 = load i8, ptr %m_ownsMemory.i.i.i, align 8, !range !22
...
entry:
  ...
  %vec.sroa.8.0.copyload = load float, ptr %vec.sroa.8.0.vec0.sroa_idx, align 4, !tbaa.struct !27
  %vec.sroa.13.0.vec0.sroa_idx = getelementptr inbounds i8, ptr %vec0, i64 8
  %vec.sroa.13.0.copyload = load float, ptr %vec.sroa.13.0.vec0.sroa_idx, align 4, !tbaa.struct !25
...
for.body.lr.ph:                                   ; preds = %if.end
  ...
  %m_localScaling = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 1
  %4 = load <2 x float>, ptr %m_localScaling, align 8, !tbaa !23
  %arrayidx13.i = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 1, i32 0, i64 2
  %5 = load float, ptr %arrayidx13.i, align 8, !tbaa !23
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %6 = load <2 x float>, ptr %arrayidx.i, align 4, !tbaa !23
  %7 = fmul <2 x float> %6, %4
  %arrayidx11.i = getelementptr inbounds [4 x float], ptr %arrayidx.i, i64 0, i64 2
  %8 = load float, ptr %arrayidx11.i, align 4, !tbaa !23
...
for.body.epil:                                    ; preds = %for.cond4.preheader.unr-lcssa, %for.body.epil
  ...
  store float 0xC3ABC16D60000000, ptr %arrayidx2.epil, align 4, !tbaa !23
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %for.cond4.preheader, label %for.body.epil, !llvm.loop !28
...
for.body8.us:                                     ; preds = %for.body8.us.preheader, %for.cond10.for.cond.cleanup12_crit_edge.us
  ...
  %3 = load <2 x float>, ptr %arrayidx.i.i.us, align 4, !tbaa !23
  %4 = load <2 x float>, ptr %m_localScaling.i, align 8, !tbaa !23
  %5 = fmul <2 x float> %3, %4
  %arrayidx11.i.i.us = getelementptr inbounds [4 x float], ptr %arrayidx.i.i.us, i64 0, i64 2
  %6 = load float, ptr %arrayidx11.i.i.us, align 4, !tbaa !23
  %7 = load float, ptr %arrayidx13.i.i, align 8, !tbaa !23
...
for.body13.us:                                    ; preds = %for.body8.us, %if.end.us
  ...
  %10 = load float, ptr %arrayidx15.us, align 4, !tbaa !23
  %arrayidx5.i.us = getelementptr inbounds [4 x float], ptr %arrayidx15.us, i64 0, i64 1
  %11 = load float, ptr %arrayidx5.i.us, align 4, !tbaa !23
  ...
  %13 = load float, ptr %arrayidx10.i.us, align 4, !tbaa !23
  ...
  %15 = load float, ptr %arrayidx20.us, align 4, !tbaa !23
...
if.then.us:                                       ; preds = %for.body13.us
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i.us, ptr %vtx.sroa.6.0.arrayidx18.sroa_idx.us, align 4, !tbaa.struct !25
  store float %14, ptr %arrayidx20.us, align 4, !tbaa !23
  br label %if.end.us
...
if.then:                                          ; preds = %entry
  ...
  %vecnorm.sroa.13.0.copyload = load float, ptr %vecnorm.sroa.13.0.vec.sroa_idx, align 4, !tbaa.struct !25
...
entry:
  ...
  %m_localScaling.i = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 1
  %2 = load <2 x float>, ptr %arrayidx.i.i, align 4, !tbaa !23
  %3 = load <2 x float>, ptr %m_localScaling.i, align 8, !tbaa !23
  %4 = fmul <2 x float> %2, %3
  %arrayidx11.i.i = getelementptr inbounds [4 x float], ptr %arrayidx.i.i, i64 0, i64 2
  %5 = load float, ptr %arrayidx11.i.i, align 4, !tbaa !23
  %arrayidx13.i.i = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 1, i32 0, i64 2
  %6 = load float, ptr %arrayidx13.i.i, align 8, !tbaa !23
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i, ptr %ref.tmp.sroa.4.0..sroa_idx, align 4, !tbaa.struct !25
  ...
  %8 = load <2 x float>, ptr %arrayidx.i.i13, align 4, !tbaa !23
  %9 = load <2 x float>, ptr %m_localScaling.i, align 8, !tbaa !23
  %10 = fmul <2 x float> %8, %9
  %arrayidx11.i.i19 = getelementptr inbounds [4 x float], ptr %arrayidx.i.i13, i64 0, i64 2
  %11 = load float, ptr %arrayidx11.i.i19, align 4, !tbaa !23
  %12 = load float, ptr %arrayidx13.i.i, align 8, !tbaa !23
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i24, ptr %ref.tmp6.sroa.4.0..sroa_idx, align 4, !tbaa.struct !25
  ret void
}
...
entry:
  ...
  %m_localScaling.i = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 1
  %1 = load <2 x float>, ptr %arrayidx.i.i, align 4, !tbaa !23
  %2 = load <2 x float>, ptr %m_localScaling.i, align 8, !tbaa !23
  %3 = fmul <2 x float> %1, %2
  %arrayidx11.i.i = getelementptr inbounds [4 x float], ptr %arrayidx.i.i, i64 0, i64 2
  %4 = load float, ptr %arrayidx11.i.i, align 4, !tbaa !23
  %arrayidx13.i.i = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 1, i32 0, i64 2
  %5 = load float, ptr %arrayidx13.i.i, align 8, !tbaa !23
...
entry:
  ...
  store float %margin, ptr %m_collisionMargin, align 8, !tbaa !30
  ret void
}
...
entry:
  %m_collisionMargin = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 3
  %0 = load float, ptr %m_collisionMargin, align 8, !tbaa !30
  ret float %0
}
...
attributes #4 = { nofree nosync nounwind memory(read, inaccessiblemem: none) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!30 = !{!31, !24, i64 56}
!31 = !{!"_ZTS21btConvexInternalShape", !32, i64 0, !33, i64 24, !33, i64 40, !24, i64 56, !24, i64 60}
!32 = !{!"_ZTS13btConvexShape", !19, i64 0}
