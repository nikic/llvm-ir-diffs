...
invoke.cont:
  ...
  store ptr getelementptr inbounds ({ [27 x ptr] }, ptr @_ZTV17btConvexHullShape, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
for.body10.lr.ph.i:                               ; preds = %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i, %if.then3.i.i.i
  store i8 1, ptr %m_ownsMemory.i.i, align 8
  store ptr %call.i.i.i.i29, ptr %m_data.i.i, align 8
...
for.body.epil:                                    ; preds = %for.cond.cleanup.loopexit.unr-lcssa
  ...
  store float %7, ptr %ref.tmp6.sroa.5.0.arrayidx.i.sroa_idx.epil, align 4
  %ref.tmp6.sroa.6.0.arrayidx.i.sroa_idx.epil = getelementptr inbounds i8, ptr %arrayidx.i.epil, i64 12
  store float 0.000000e+00, ptr %ref.tmp6.sroa.6.0.arrayidx.i.sroa_idx.epil, align 4
  br label %for.cond.cleanup
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph.new
  ...
  %13 = load <2 x float>, ptr %pointsAddress.031, align 4
  ...
  store float %11, ptr %ref.tmp6.sroa.5.0.arrayidx.i.sroa_idx, align 4
  %ref.tmp6.sroa.6.0.arrayidx.i.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i, i64 12
  store float 0.000000e+00, ptr %ref.tmp6.sroa.6.0.arrayidx.i.sroa_idx, align 4
  ...
  store float %14, ptr %ref.tmp6.sroa.5.0.arrayidx.i.sroa_idx.1, align 4
  %ref.tmp6.sroa.6.0.arrayidx.i.sroa_idx.1 = getelementptr inbounds i8, ptr %arrayidx.i.1, i64 12
  store float 0.000000e+00, ptr %ref.tmp6.sroa.6.0.arrayidx.i.sroa_idx.1, align 4
...
for.body.epil:                                    ; preds = %for.cond4.preheader.unr-lcssa, %for.body.epil
  ...
  br i1 %epil.iter.cmp.not, label %for.cond4.preheader, label %for.body.epil
...
for.body8.us:                                     ; preds = %for.body8.us.preheader, %for.cond10.for.cond.cleanup12_crit_edge.us
  ...
  %3 = load <2 x float>, ptr %arrayidx.i.i.us, align 4
  ...
  %6 = load float, ptr %arrayidx11.i.i.us, align 4
...
for.body13.us:                                    ; preds = %for.body8.us, %if.end.us
  ...
  %10 = load float, ptr %arrayidx15.us, align 4
  %arrayidx5.i.us = getelementptr inbounds [4 x float], ptr %arrayidx15.us, i64 0, i64 1
  %11 = load float, ptr %arrayidx5.i.us, align 4
  ...
  %13 = load float, ptr %arrayidx10.i.us, align 4
  ...
  %15 = load float, ptr %arrayidx20.us, align 4
  %cmp21.us = fcmp ogt float %14, %15
  br i1 %cmp21.us, label %if.then.us, label %if.end.us

if.then.us:                                       ; preds = %for.body13.us
  store <2 x float> %5, ptr %arrayidx18.us, align 4
  %vtx.sroa.6.0.arrayidx18.sroa_idx.us = getelementptr inbounds i8, ptr %arrayidx18.us, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i.us, ptr %vtx.sroa.6.0.arrayidx18.sroa_idx.us, align 4
  store float %14, ptr %arrayidx20.us, align 4
  br label %if.end.us
...
entry:
  ...
  %8 = load <2 x float>, ptr %arrayidx.i.i13, align 4
  ...
  %11 = load float, ptr %arrayidx11.i.i19, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i24, ptr %ref.tmp6.sroa.4.0..sroa_idx, align 4
  ret void
}
