; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btGeneric6DofSpringConstraint.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btGeneric6DofSpringConstraint.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [10 x ptr] }, ptr @_ZTV29btGeneric6DofSpringConstraint, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %scevgep = getelementptr inbounds i8, ptr %this, i64 1266
  ...
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00>, ptr %arrayidx7, align 8
  %arrayidx7.4 = getelementptr inbounds %class.btGeneric6DofSpringConstraint, ptr %this, i64 0, i32 4, i64 4
  store <2 x float> <float 1.000000e+00, float 1.000000e+00>, ptr %arrayidx7.4, align 8
  ret void
}
...
entry:
  ...
  %5 = load <2 x float>, ptr %arrayidx11.1, align 4
  store <2 x float> %5, ptr %arrayidx14.1, align 8
  ret void
}
...
if.then:                                          ; preds = %entry
  ...
  store float %mul14, ptr %m_targetVelocity, align 8
  %7 = tail call float @llvm.fabs.f32(float %mul)
  %8 = load float, ptr %info, align 8
  %div20 = fdiv float %7, %8
  store float %div20, ptr %m_maxMotorForce, align 8
  br label %for.inc
...
if.then.1:                                        ; preds = %for.inc
  ...
  %14 = load float, ptr %arrayidx12.1, align 4
  ...
  store float %mul14.1, ptr %arrayidx17.1, align 4
  %16 = tail call float @llvm.fabs.f32(float %mul.1)
  %17 = load float, ptr %info, align 8
...
if.then.2:                                        ; preds = %for.inc.1
  ...
  store float %mul14.2, ptr %arrayidx17.2, align 8
  %25 = tail call float @llvm.fabs.f32(float %mul.2)
  %26 = load float, ptr %info, align 8
  ...
  store float %div20.2, ptr %arrayidx24.2, align 8
  br label %for.inc.2
...
if.then32:                                        ; preds = %for.inc.2
  %m_calculatedAxisAngleDiff = getelementptr inbounds %class.btGeneric6DofConstraint, ptr %this, i64 0, i32 10
  %28 = load float, ptr %m_calculatedAxisAngleDiff, align 8
  ...
  %30 = load float, ptr %arrayidx47, align 4
  %mul48 = fmul float %30, %fneg
  %31 = load float, ptr %info, align 8
  ...
  %33 = load i32, ptr %m_numIterations, align 8
  ...
  store float %mul59, ptr %m_targetVelocity62, align 4
  ...
  store float %div65, ptr %m_maxMotorForce69, align 8
  br label %for.inc71
...
for.inc71:                                        ; preds = %for.inc.2, %if.then32
  ...
  %35 = load i8, ptr %arrayidx30.1, align 2
...
if.then32.1:                                      ; preds = %for.inc71
  ...
  %38 = load float, ptr %arrayidx47.1, align 8
  ...
  %40 = load float, ptr %arrayidx54.1, align 8
  %mul55.1 = fmul float %39, %40
  %41 = load i32, ptr %m_numIterations, align 8
  ...
  store float %mul59.1, ptr %m_targetVelocity62.1, align 4
  ...
  store float %div65.1, ptr %m_maxMotorForce69.1, align 8
...
for.inc71.1:                                      ; preds = %if.then32.1, %for.inc71
  ...
  %43 = load i8, ptr %arrayidx30.2, align 1
...
if.then32.2:                                      ; preds = %for.inc71.1
  ...
  store float %mul59.2, ptr %m_targetVelocity62.2, align 4
  ...
  store float %div65.2, ptr %m_maxMotorForce69.2, align 8
