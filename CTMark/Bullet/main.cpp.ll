; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/main.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/main.cpp"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%class.BenchmarkDemo1 = type { %class.BenchmarkDemo }
%class.BenchmarkDemo = type { %class.DemoApplication, %class.btAlignedObjectArray, %class.btAlignedObjectArray.0, ptr, ptr, ptr, ptr, i32, ptr, ptr }
...
invoke.cont10:
  ...
  store i8 1, ptr @gDisableDeactivation, align 1
  ...
  store i32 1, ptr %m_benchmark.i.i, align 8
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV14BenchmarkDemo1, i64 0, inrange i32 0, i64 2), ptr %benchmarkDemo1, align 8
  ...
  store i8 1, ptr %m_ownsMemory.i.i.i.i130, align 8
...
for.body20.1:                                     ; preds = %for.cond.cleanup, %if.end.1
  ...
  %vtable.1 = load ptr, ptr %benchmarkDemo2, align 8
...
for.body20.2:                                     ; preds = %for.cond.cleanup.1, %if.end.2
  ...
  %vtable.2 = load ptr, ptr %benchmarkDemo3, align 8
...
for.body20.3:                                     ; preds = %for.cond.cleanup.2, %if.end.3
  ...
  %vtable.3 = load ptr, ptr %benchmarkDemo4, align 8
...
for.body20.4:                                     ; preds = %for.cond.cleanup.3, %if.end.4
  ...
  %vtable.4 = load ptr, ptr %benchmarkDemo5, align 8
...
for.body20.5:                                     ; preds = %for.cond.cleanup.4, %if.end.5
  ...
  %vtable.5 = load ptr, ptr %benchmarkDemo6, align 8
...
for.body20.6:                                     ; preds = %for.cond.cleanup.5, %if.end.6
  ...
  %vtable.6 = load ptr, ptr %benchmarkDemo7, align 8
...
for.body20:                                       ; preds = %invoke.cont10, %if.end
  ...
  %vtable = load ptr, ptr %benchmarkDemo1, align 8
...
define linkonce_odr dso_local void @_ZN13BenchmarkDemoD2Ev(ptr noundef nonnull align 8 dereferenceable(136) %this) unnamed_addr #5 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV13BenchmarkDemo, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
; Function Attrs: uwtable
define linkonce_odr dso_local void @_ZN20btAlignedObjectArrayIP16btCollisionShapeED2Ev(ptr noundef nonnull align 8 dereferenceable(25) %this) unnamed_addr #5 comdat align 2 {
entry:
...
; Function Attrs: uwtable
define linkonce_odr dso_local void @_ZN20btAlignedObjectArrayIP7RagDollED2Ev(ptr noundef nonnull align 8 dereferenceable(25) %this) unnamed_addr #5 comdat align 2 {
entry:
