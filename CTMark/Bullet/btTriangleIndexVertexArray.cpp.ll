; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btTriangleIndexVertexArray.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btTriangleIndexVertexArray.cpp"
...
invoke.cont:
  ...
  store ptr getelementptr inbounds ({ [15 x ptr] }, ptr @_ZTV26btTriangleIndexVertexArray, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
_ZN20btAlignedObjectArrayI13btIndexedMeshE10deallocateEv.exit.i.i.i: ; preds = %if.then3.i.i.i.i, %_ZNK20btAlignedObjectArrayI13btIndexedMeshE4copyEiiPS0_.exit.i.i.i
  store i8 1, ptr %m_ownsMemory.i.i, align 8
  store ptr %call.i.i.i.i.i15, ptr %m_data.i.i, align 8
  store i32 1, ptr %m_capacity.i.i, align 8
  %.pre8.i.i = load i32, ptr %m_size.i.i, align 4
  ...
  store i32 2, ptr %m_indexType.i14, align 4
  ret void
