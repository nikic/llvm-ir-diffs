; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSimpleBroadphase.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSimpleBroadphase.cpp"
...
entry:
  store ptr getelementptr inbounds ({ [15 x ptr] }, ptr @_ZTV18btSimpleBroadphase, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
if.end:                                           ; preds = %if.then, %entry
  ...
  store ptr %call7, ptr %m_pHandlesRawPtr, align 8
...
arrayctor.cont:                                   ; preds = %invoke.cont12
  ...
  store ptr %call7, ptr %m_pHandles, align 8
...
for.body.epil:                                    ; preds = %for.cond.cleanup.loopexit.unr-lcssa
  ...
  %2 = add i32 %1, 1
  store i32 %2, ptr %m_nextFree.i39.epil, align 4
  ...
  %4 = add i32 %3, 2
  store i32 %4, ptr %m_uniqueId.epil, align 8
  br label %for.cond.cleanup
...
for.cond.cleanup:                                 ; preds = %for.body.epil, %for.cond.cleanup.loopexit.unr-lcssa, %arrayctor.cont.thread, %arrayctor.cont
  ...
  store i32 0, ptr %m_nextFree.i, align 4
  ret void
...
_ZN18btSimpleBroadphase11allocHandleEv.exit:      ; preds = %if.end, %if.then.i
  ...
  store ptr %multiSapProxy, ptr %m_multiSapParentProxy.i.i, align 8
  br label %return
...
entry:
  ...
  %m_LastHandleIndex.i = getelementptr inbounds %class.btSimpleBroadphase, ptr %this, i64 0, i32 3
  %2 = load i32, ptr %m_LastHandleIndex.i, align 8
...
_ZN18btSimpleBroadphase10freeHandleEP23btSimpleBroadphaseProxy.exit: ; preds = %entry, %if.then.i
  ...
  store i32 %3, ptr %m_nextFree.i.i, align 4
  ...
  %4 = load i32, ptr %m_numHandles.i, align 8
...
land.lhs.true:                                    ; preds = %for.end49
  ...
  %36 = load ptr, ptr %m_pairCache52, align 8
...
if.then56:                                        ; preds = %land.lhs.true
  %38 = load ptr, ptr %m_pairCache52, align 8
  %vtable58 = load ptr, ptr %38, align 8
...
land.lhs.true10.i.i:                              ; preds = %land.lhs.true.i.i
  ...
  %55 = load float, ptr %arrayidx16.i.i, align 4
...
if.then82:                                        ; preds = %if.then70, %land.lhs.true.i.i, %land.lhs.true10.i.i, %land.lhs.true18.i.i, %land.lhs.true26.i.i, %for.body66, %_ZN18btSimpleBroadphase15testAabbOverlapEP17btBroadphaseProxyS1_.exit
  %62 = load ptr, ptr %m_pairCache52, align 8
  %vtable84 = load ptr, ptr %62, align 8
  ...
  %64 = load i32, ptr %m_invalidPair, align 4
  %inc89 = add nsw i32 %64, 1
  store i32 %inc89, ptr %m_invalidPair, align 4
  %65 = load i32, ptr @gOverlappingPairs, align 4
  %dec = add nsw i32 %65, -1
  store i32 %dec, ptr @gOverlappingPairs, align 4
  %.pre165 = load i32, ptr %m_size.i.i, align 4
  br label %if.end90
...
for.end93:                                        ; preds = %if.end90
  ...
  br i1 %cmp.i139, label %if.then.i140, label %_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI29btBroadphasePairSortPredicateEEvT_.exit142

if.then.i140:                                     ; preds = %for.end93
  %sub.i141 = add nsw i32 %67, -1
  call void @_ZN20btAlignedObjectArrayI16btBroadphasePairE17quickSortInternalI29btBroadphasePairSortPredicateEEvT_ii(ptr noundef nonnull align 8 dereferenceable(25) %call60, i32 noundef 0, i32 noundef %sub.i141)
  %.pre166 = load i32, ptr %m_size.i.i, align 4
  %.pre167 = load i32, ptr %m_invalidPair, align 4
  br label %_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI29btBroadphasePairSortPredicateEEvT_.exit142

_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI29btBroadphasePairSortPredicateEEvT_.exit142: ; preds = %_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI29btBroadphasePairSortPredicateEEvT_.exit, %for.end93, %if.then.i140
  %69 = phi i32 [ %66, %for.end93 ], [ %.pre167, %if.then.i140 ], [ 0, %_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI29btBroadphasePairSortPredicateEEvT_.exit ]
  %70 = phi i32 [ %67, %for.end93 ], [ %.pre166, %if.then.i140 ], [ %43, %_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI29btBroadphasePairSortPredicateEEvT_.exit ]
