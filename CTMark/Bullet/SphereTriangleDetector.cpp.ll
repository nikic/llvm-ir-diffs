...
if.then3:                                         ; preds = %if.then
  ...
  %65 = load float, ptr %normal, align 4, !tbaa !16
  ...
  %68 = load float, ptr %arrayidx7.i.i33, align 4, !tbaa !16
  ...
  %71 = load float, ptr %arrayidx12.i.i, align 4, !tbaa !16
  %72 = load float, ptr %arrayidx5.i9.i, align 8, !tbaa !16
  %73 = load float, ptr %arrayidx.i189.i.i, align 4, !tbaa !16
  %74 = load float, ptr %arrayidx.i210.i.i, align 8, !tbaa !16
  %75 = load float, ptr %arrayidx11.i10.i, align 8, !tbaa !16
  %76 = load float, ptr %arrayidx.i191.i.i, align 4, !tbaa !16
  %mul8.i20.i = fmul float %68, %76
  %77 = tail call float @llvm.fmuladd.f32(float %75, float %65, float %mul8.i20.i)
  %78 = load float, ptr %arrayidx.i212.i.i, align 8, !tbaa !16
  ...
  %99 = load float, ptr %arrayidx13.i.i, align 8, !tbaa !16
  %add17.i.i = fadd float %98, %99
  %100 = load float, ptr %depth, align 4, !tbaa !16
...
if.else:                                          ; preds = %if.then
  ...
  %120 = load float, ptr %normal, align 4, !tbaa !16
  ...
  %123 = load float, ptr %arrayidx7.i.i56, align 4, !tbaa !16
  ...
  %126 = load float, ptr %arrayidx12.i.i59, align 4, !tbaa !16
  %127 = load float, ptr %arrayidx5.i9.i, align 8, !tbaa !16
  %128 = load float, ptr %arrayidx.i189.i.i, align 4, !tbaa !16
  %129 = load float, ptr %arrayidx.i210.i.i, align 8, !tbaa !16
  ...
  %142 = load float, ptr %arrayidx11.i10.i, align 8, !tbaa !16
  %143 = load float, ptr %arrayidx.i191.i.i, align 4, !tbaa !16
  %mul8.i20.i66 = fmul float %123, %143
  %144 = tail call float @llvm.fmuladd.f32(float %142, float %120, float %mul8.i20.i66)
  %145 = load float, ptr %arrayidx.i212.i.i, align 8, !tbaa !16
  ...
  %148 = load float, ptr %point, align 4, !tbaa !16
  %arrayidx7.i.i.i74 = getelementptr inbounds [4 x float], ptr %point, i64 0, i64 1
  %149 = load float, ptr %arrayidx7.i.i.i74, align 4, !tbaa !16
  %arrayidx12.i.i.i77 = getelementptr inbounds [4 x float], ptr %point, i64 0, i64 2
  %150 = load float, ptr %arrayidx12.i.i.i77, align 4, !tbaa !16
...
entry:
  ...
  %2 = load float, ptr %m_implicitShapeDimensions.i, align 4, !tbaa !16
  %m_localScaling.i = getelementptr inbounds %class.btConvexInternalShape, ptr %1, i64 0, i32 1
  %3 = load float, ptr %m_localScaling.i, align 4, !tbaa !16
  ...
  %6 = load float, ptr %arrayidx9, align 4, !tbaa !16
  %arrayidx5.i112 = getelementptr inbounds %class.btTriangleShape, ptr %0, i64 0, i32 1, i64 2, i32 0, i64 1
  %7 = load float, ptr %arrayidx5.i112, align 4, !tbaa !16
  %arrayidx11.i115 = getelementptr inbounds %class.btTriangleShape, ptr %0, i64 0, i32 1, i64 2, i32 0, i64 2
  %8 = load float, ptr %arrayidx11.i115, align 4, !tbaa !16
  %9 = load <2 x float>, ptr %arrayidx5.i109, align 4, !tbaa !16
  %10 = load <2 x float>, ptr %arrayidx7.i110, align 4, !tbaa !16
...
if.else:                                          ; preds = %if.then30
  ...
  %vtable255 = load ptr, ptr %0, align 8, !tbaa !5
...
for.cond.cleanup.if.then55_crit_edge:             ; preds = %for.cond.cleanup
  %56 = load <2 x float>, ptr %sphereCenter, align 4, !tbaa !16
  %.pre266 = load float, ptr %arrayidx11.i136, align 4, !tbaa !16
  br label %if.then55
...
for.body:                                         ; preds = %for.body.lr.ph, %_Z18SegmentSqrDistanceRK9btVector3S1_S1_RS_.exit
  ...
  %57 = load ptr, ptr %m_triangle, align 8, !tbaa !14
  %vtable46 = load ptr, ptr %57, align 8, !tbaa !5
  ...
  %59 = load float, ptr %arrayidx11.i136, align 4, !tbaa !16
  %60 = load float, ptr %arrayidx13.i.i, align 8, !tbaa !16
  ...
  %61 = load <2 x float>, ptr %pa, align 8, !tbaa !16
  %62 = load <2 x float>, ptr %sphereCenter, align 4, !tbaa !16
  %63 = fsub <2 x float> %62, %61
  %64 = load <2 x float>, ptr %pb, align 8, !tbaa !16
  %65 = fsub <2 x float> %64, %61
  %66 = load float, ptr %arrayidx11.i27.i, align 8, !tbaa !16
...
_Z18SegmentSqrDistanceRK9btVector3S1_S1_RS_.exit: ; preds = %for.body, %if.then6.i, %if.else.i
  ...
  %87 = load ptr, ptr %m_triangle, align 8, !tbaa !14
  %vtable = load ptr, ptr %87, align 8, !tbaa !5
...
if.then63:                                        ; preds = %if.then55
  ...
  store <2 x float> %contactPoint.sroa.0.2, ptr %point, align 4, !tbaa.struct !26
  %contactPoint.sroa.8.0.point.sroa_idx = getelementptr inbounds i8, ptr %point, i64 8
  store <2 x float> %contactPoint.sroa.8.2, ptr %contactPoint.sroa.8.0.point.sroa_idx, align 4, !tbaa.struct !23
...
if.end71:                                         ; preds = %if.end67
  ...
  store <2 x float> %contactPoint.sroa.8.2, ptr %contactPoint.sroa.8.0.point.sroa_idx212, align 4, !tbaa.struct !23
...
entry:
  ...
  %0 = load float, ptr %arrayidx2, align 4, !tbaa !16
  %1 = load float, ptr %vertices, align 4, !tbaa !16
  ...
  %12 = load float, ptr %arrayidx3.i, align 4, !tbaa !16
  %arrayidx7.i124 = getelementptr inbounds [4 x float], ptr %normal, i64 0, i64 1
  %13 = load float, ptr %arrayidx7.i124, align 4, !tbaa !16
  %14 = load float, ptr %normal, align 4, !tbaa !16
