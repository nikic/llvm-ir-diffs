; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/SphereTriangleDetector.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/SphereTriangleDetector.cpp"
...
entry:
  ...
  %0 = load float, ptr %m_origin.i.i, align 8
  ...
  %9 = load float, ptr %arrayidx.i209.i.i, align 8
  ...
  %10 = load float, ptr %arrayidx.i210.i.i, align 8
  ...
  %11 = load float, ptr %arrayidx.i212.i.i, align 8
  ...
  %38 = load <2 x float>, ptr %input, align 8
  %39 = load <2 x float>, ptr %arrayidx.i.i.i, align 8
  ...
  %44 = load <2 x float>, ptr %arrayidx.i177.i.i, align 8
  ...
  store <2 x float> %46, ptr %sphereInTr, align 8
  %ref.tmp.sroa.5.0.agg.result.sroa_idx.i = getelementptr inbounds i8, ptr %sphereInTr, i64 8
  store float %21, ptr %ref.tmp.sroa.5.0.agg.result.sroa_idx.i, align 8
  ...
  store <2 x float> %52, ptr %arrayidx8.i.i.i, align 8
  ...
  store float %26, ptr %ref.tmp.sroa.10.16.arrayidx8.i.i.sroa_idx.i, align 8
  ...
  store <2 x float> %61, ptr %arrayidx12.i.i.i, align 8
  ...
  store float %13, ptr %ref.tmp.sroa.15.32.arrayidx12.i.i.sroa_idx.i, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp.sroa.16.32.arrayidx12.i.i.sroa_idx.i, align 4
  %m_origin.i16.i = getelementptr inbounds %class.btTransform, ptr %sphereInTr, i64 0, i32 1
  store <2 x float> %35, ptr %m_origin.i16.i, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i13.i, ptr %ref.tmp4.sroa.4.0.m_origin.i16.sroa_idx.i, align 8
  %m_contactBreakingThreshold = getelementptr inbounds %struct.SphereTriangleDetector, ptr %this, i64 0, i32 3
...
if.then3:                                         ; preds = %if.then
  ...
  %68 = load float, ptr %arrayidx7.i.i33, align 4
  %69 = load <4 x float>, ptr %arrayidx.i209.i.i, align 8
  ...
  %72 = load float, ptr %arrayidx5.i9.i, align 8
  %73 = load float, ptr %arrayidx.i189.i.i, align 4
  %74 = load float, ptr %arrayidx.i210.i.i, align 8
  %75 = load float, ptr %arrayidx11.i10.i, align 8
  %76 = load float, ptr %arrayidx.i191.i.i, align 4
  %mul8.i20.i = fmul float %68, %76
  %77 = tail call float @llvm.fmuladd.f32(float %75, float %65, float %mul8.i20.i)
  %78 = load float, ptr %arrayidx.i212.i.i, align 8
  %79 = tail call float @llvm.fmuladd.f32(float %78, float %71, float %77)
  ...
  %82 = insertelement <2 x float> %67, float %73, i64 1
  %83 = fmul <2 x float> %81, %82
  %84 = insertelement <2 x float> %64, float %72, i64 1
  %85 = insertelement <2 x float> poison, float %65, i64 0
  %86 = shufflevector <2 x float> %85, <2 x float> poison, <2 x i32> zeroinitializer
  %87 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %84, <2 x float> %86, <2 x float> %83)
  %88 = insertelement <2 x float> %70, float %74, i64 1
  %89 = insertelement <2 x float> poison, float %71, i64 0
  %90 = shufflevector <2 x float> %89, <2 x float> poison, <2 x i32> zeroinitializer
  %91 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %88, <2 x float> %90, <2 x float> %87)
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i36, ptr %93, align 8
  ...
  %96 = load float, ptr %arrayidx12.i.i.i39, align 4
  %mul8.i29.i.i = fmul float %76, %95
  %97 = tail call float @llvm.fmuladd.f32(float %75, float %94, float %mul8.i29.i.i)
  %98 = tail call float @llvm.fmuladd.f32(float %78, float %96, float %97)
  %99 = load float, ptr %arrayidx13.i.i, align 8
  %add17.i.i = fadd float %98, %99
  %100 = load float, ptr %depth, align 4
  %mul8.i = fmul float %79, %100
  ...
  %106 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %84, <2 x float> %105, <2 x float> %103)
  %107 = insertelement <2 x float> poison, float %96, i64 0
  %108 = shufflevector <2 x float> %107, <2 x float> poison, <2 x i32> zeroinitializer
  %109 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %88, <2 x float> %108, <2 x float> %106)
  %110 = load <2 x float>, ptr %m_origin.i, align 8
  %111 = fadd <2 x float> %110, %109
  %112 = insertelement <2 x float> poison, float %100, i64 0
  %113 = shufflevector <2 x float> %112, <2 x float> poison, <2 x i32> zeroinitializer
  %114 = fmul <2 x float> %91, %113
...
if.else:                                          ; preds = %if.then
  ...
  %118 = load <4 x float>, ptr %m_transformB, align 8
  %119 = shufflevector <4 x float> %118, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %120 = load float, ptr %normal, align 4
  %121 = load <4 x float>, ptr %arrayidx.i188.i.i, align 4
  ...
  %123 = load float, ptr %arrayidx7.i.i56, align 4
  %124 = load <4 x float>, ptr %arrayidx.i209.i.i, align 8
  ...
  %126 = load float, ptr %arrayidx12.i.i59, align 4
  %127 = load float, ptr %arrayidx5.i9.i, align 8
  %128 = load float, ptr %arrayidx.i189.i.i, align 4
  %129 = load float, ptr %arrayidx.i210.i.i, align 8
  %130 = insertelement <2 x float> poison, float %123, i64 0
  %131 = shufflevector <2 x float> %130, <2 x float> poison, <2 x i32> zeroinitializer
  %132 = insertelement <2 x float> %122, float %128, i64 1
  %133 = fmul <2 x float> %131, %132
  %134 = insertelement <2 x float> %119, float %127, i64 1
  %135 = insertelement <2 x float> poison, float %120, i64 0
  %136 = shufflevector <2 x float> %135, <2 x float> poison, <2 x i32> zeroinitializer
  %137 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %134, <2 x float> %136, <2 x float> %133)
  %138 = insertelement <2 x float> %125, float %129, i64 1
  ...
  %142 = load float, ptr %arrayidx11.i10.i, align 8
  %143 = load float, ptr %arrayidx.i191.i.i, align 4
  %mul8.i20.i66 = fmul float %123, %143
  %144 = tail call float @llvm.fmuladd.f32(float %142, float %120, float %mul8.i20.i66)
  %145 = load float, ptr %arrayidx.i212.i.i, align 8
  %146 = tail call float @llvm.fmuladd.f32(float %145, float %126, float %144)
  %retval.sroa.3.12.vec.insert.i70 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %146, i64 0
  store <2 x float> %141, ptr %ref.tmp15, align 8
  %147 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp15, i64 0, i32 1
  store <2 x float> %retval.sroa.3.12.vec.insert.i70, ptr %147, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp19) #13
  %148 = load float, ptr %point, align 4
  %arrayidx7.i.i.i74 = getelementptr inbounds [4 x float], ptr %point, i64 0, i64 1
  %149 = load float, ptr %arrayidx7.i.i.i74, align 4
  %arrayidx12.i.i.i77 = getelementptr inbounds [4 x float], ptr %point, i64 0, i64 2
  %150 = load float, ptr %arrayidx12.i.i.i77, align 4
  ...
  %153 = fmul <2 x float> %132, %152
  %154 = insertelement <2 x float> poison, float %148, i64 0
  %155 = shufflevector <2 x float> %154, <2 x float> poison, <2 x i32> zeroinitializer
  %156 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %134, <2 x float> %155, <2 x float> %153)
  ...
  %159 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %138, <2 x float> %158, <2 x float> %156)
  %160 = load <2 x float>, ptr %m_origin.i, align 8
  %161 = fadd <2 x float> %160, %159
  %mul8.i29.i.i88 = fmul float %143, %149
  %162 = tail call float @llvm.fmuladd.f32(float %142, float %148, float %mul8.i29.i.i88)
  %163 = tail call float @llvm.fmuladd.f32(float %145, float %150, float %162)
  %164 = load float, ptr %arrayidx13.i.i, align 8
  ...
  %166 = load float, ptr %depth, align 4
...
entry:
  ...
  %7 = load float, ptr %arrayidx5.i112, align 4
  %arrayidx11.i115 = getelementptr inbounds %class.btTriangleShape, ptr %0, i64 0, i32 1, i64 2, i32 0, i64 2
  %8 = load float, ptr %arrayidx11.i115, align 4
  %9 = load <2 x float>, ptr %arrayidx5.i109, align 4
  %10 = load <2 x float>, ptr %arrayidx7.i110, align 4
  %11 = fsub <2 x float> %9, %10
  %12 = extractelement <2 x float> %10, i64 0
  %sub8.i114 = fsub float %7, %12
  ...
  %38 = load float, ptr %arrayidx11.i136, align 4
  %39 = extractelement <2 x float> %10, i64 1
  %sub14.i138 = fsub float %38, %39
  %shift271 = shufflevector <2 x float> %34, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %40 = fmul <2 x float> %37, %shift271
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %or.cond.not254 = or i1 %cmp23, %cmp26
  %cmp22 = fcmp olt float %distanceFromPlane.0, %add
  %or.cond253 = and i1 %cmp22, %or.cond.not254
  br i1 %or.cond253, label %if.then30, label %cleanup76
...
if.then30:                                        ; preds = %if.end
  ...
  store <2 x float> %normal.sroa.18.0, ptr %normal.sroa.18.0.lnormal.i.sroa_idx, align 8
  ...
  br i1 %call.i, label %if.then32, label %if.else
...
if.else:                                          ; preds = %if.then30
  ...
  %vtable255 = load ptr, ptr %0, align 8
  %vfn256 = getelementptr inbounds ptr, ptr %vtable255, i64 19
  %53 = load ptr, ptr %vfn256, align 8
  %call43257 = tail call noundef i32 %53(ptr noundef nonnull align 8 dereferenceable(112) %0)
  %cmp44258 = icmp sgt i32 %call43257, 0
  br i1 %cmp44258, label %for.body.lr.ph, label %cleanup76
...
for.cond.cleanup:                                 ; preds = %_Z18SegmentSqrDistanceRK9btVector3S1_S1_RS_.exit
  %54 = and i8 %hasContact.1, 1
  %55 = icmp eq i8 %54, 0
  br i1 %55, label %cleanup76, label %for.cond.cleanup.if.then55_crit_edge

for.cond.cleanup.if.then55_crit_edge:             ; preds = %for.cond.cleanup
  %56 = load <2 x float>, ptr %sphereCenter, align 4
  %.pre266 = load float, ptr %arrayidx11.i136, align 4
  br label %if.then55

for.body:                                         ; preds = %for.body.lr.ph, %_Z18SegmentSqrDistanceRK9btVector3S1_S1_RS_.exit
  %hasContact.0262 = phi i8 [ 0, %for.body.lr.ph ], [ %hasContact.1, %_Z18SegmentSqrDistanceRK9btVector3S1_S1_RS_.exit ]
  %i.0261 = phi i32 [ 0, %for.body.lr.ph ], [ %inc, %_Z18SegmentSqrDistanceRK9btVector3S1_S1_RS_.exit ]
  %contactPoint.sroa.8.0260 = phi <2 x float> [ undef, %for.body.lr.ph ], [ %contactPoint.sroa.8.1, %_Z18SegmentSqrDistanceRK9btVector3S1_S1_RS_.exit ]
  %contactPoint.sroa.0.0259 = phi <2 x float> [ undef, %for.body.lr.ph ], [ %contactPoint.sroa.0.1, %_Z18SegmentSqrDistanceRK9btVector3S1_S1_RS_.exit ]
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %pa) #13
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %pb) #13
  %57 = load ptr, ptr %m_triangle, align 8
  %vtable46 = load ptr, ptr %57, align 8
  %vfn47 = getelementptr inbounds ptr, ptr %vtable46, i64 20
  %58 = load ptr, ptr %vfn47, align 8
  call void %58(ptr noundef nonnull align 8 dereferenceable(112) %57, i32 noundef %i.0261, ptr noundef nonnull align 4 dereferenceable(16) %pa, ptr noundef nonnull align 4 dereferenceable(16) %pb)
  %59 = load float, ptr %arrayidx11.i136, align 4
  %60 = load float, ptr %arrayidx13.i.i, align 8
  %sub14.i.i = fsub float %59, %60
  %retval.sroa.3.12.vec.insert.i.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %sub14.i.i, i64 0
  %61 = load <2 x float>, ptr %pa, align 8
  %62 = load <2 x float>, ptr %sphereCenter, align 4
  %63 = fsub <2 x float> %62, %61
  %64 = load <2 x float>, ptr %pb, align 8
  %65 = fsub <2 x float> %64, %61
  %66 = load float, ptr %arrayidx11.i27.i, align 8
  %sub14.i29.i = fsub float %66, %60
  %67 = fmul <2 x float> %63, %65
  %mul8.i.i = extractelement <2 x float> %67, i64 1
  %68 = extractelement <2 x float> %65, i64 0
  %69 = extractelement <2 x float> %63, i64 0
  %70 = call float @llvm.fmuladd.f32(float %68, float %69, float %mul8.i.i)
  %71 = call float @llvm.fmuladd.f32(float %sub14.i29.i, float %sub14.i.i, float %70)
  %cmp.i = fcmp ogt float %71, 0.000000e+00
...
if.then.i:                                        ; preds = %for.body
  ...
  %mul8.i39.i = fmul float %72, %72
  %73 = call float @llvm.fmuladd.f32(float %68, float %68, float %mul8.i39.i)
  %74 = call float @llvm.fmuladd.f32(float %sub14.i29.i, float %sub14.i29.i, float %73)
  %cmp5.i = fcmp olt float %71, %74
  br i1 %cmp5.i, label %if.then6.i, label %if.else.i

if.then6.i:                                       ; preds = %if.then.i
  %div.i = fdiv float %71, %74
...
_Z18SegmentSqrDistanceRK9btVector3S1_S1_RS_.exit: ; preds = %for.body, %if.then6.i, %if.else.i
  ...
  %diff.sroa.0.0.i = phi <2 x float> [ %78, %if.then6.i ], [ %79, %if.else.i ], [ %63, %for.body ]
  ...
  %80 = insertelement <2 x float> poison, float %t.0.i, i64 0
  %81 = shufflevector <2 x float> %80, <2 x float> poison, <2 x i32> zeroinitializer
  %82 = fmul <2 x float> %65, %81
  %mul8.i.i59.i = fmul float %sub14.i29.i, %t.0.i
  %83 = fadd <2 x float> %61, %82
  %add14.i.i = fadd float %60, %mul8.i.i59.i
  ...
  %84 = fmul <2 x float> %diff.sroa.0.0.i, %diff.sroa.0.0.i
  %mul8.i76.i = extractelement <2 x float> %84, i64 1
  %85 = call float @llvm.fmuladd.f32(float %diff.sroa.0.0.vec.extract119.i, float %diff.sroa.0.0.vec.extract119.i, float %mul8.i76.i)
  %diff.sroa.17.8.vec.extract141.i = extractelement <2 x float> %diff.sroa.17.0.i, i64 0
  %86 = call float @llvm.fmuladd.f32(float %diff.sroa.17.8.vec.extract141.i, float %diff.sroa.17.8.vec.extract141.i, float %85)
  %cmp49 = fcmp olt float %86, %mul41
  %contactPoint.sroa.0.1 = select i1 %cmp49, <2 x float> %83, <2 x float> %contactPoint.sroa.0.0259
  %contactPoint.sroa.8.1 = select i1 %cmp49, <2 x float> %retval.sroa.3.12.vec.insert.i71.i, <2 x float> %contactPoint.sroa.8.0260
  %hasContact.1 = select i1 %cmp49, i8 1, i8 %hasContact.0262
  ...
  %87 = load ptr, ptr %m_triangle, align 8
  %vtable = load ptr, ptr %87, align 8
  %vfn = getelementptr inbounds ptr, ptr %vtable, i64 19
  %88 = load ptr, ptr %vfn, align 8
  %call43 = call noundef i32 %88(ptr noundef nonnull align 8 dereferenceable(112) %87)
  %cmp44 = icmp slt i32 %inc, %call43
  br i1 %cmp44, label %for.body, label %for.cond.cleanup

if.then55:                                        ; preds = %for.cond.cleanup.if.then55_crit_edge, %if.then32
  %89 = phi float [ %38, %if.then32 ], [ %.pre266, %for.cond.cleanup.if.then55_crit_edge ]
  %contactPoint.sroa.0.2 = phi <2 x float> [ %52, %if.then32 ], [ %contactPoint.sroa.0.1, %for.cond.cleanup.if.then55_crit_edge ]
  %contactPoint.sroa.8.2 = phi <2 x float> [ %retval.sroa.3.12.vec.insert.i172, %if.then32 ], [ %contactPoint.sroa.8.1, %for.cond.cleanup.if.then55_crit_edge ]
  %90 = phi <2 x float> [ %35, %if.then32 ], [ %56, %for.cond.cleanup.if.then55_crit_edge ]
  %91 = fsub <2 x float> %90, %contactPoint.sroa.0.2
  %contactPoint.sroa.8.8.vec.extract = extractelement <2 x float> %contactPoint.sroa.8.2, i64 0
...
if.then63:                                        ; preds = %if.then55
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i186, ptr %contactToCentre.sroa.8.0.resultNormal.sroa_idx, align 4
  ...
  %100 = fmul <2 x float> %91, %99
  store <2 x float> %100, ptr %resultNormal, align 4
  %mul7.i.i.i199 = fmul float %sub14.i183, %div.i.i196
  store float %mul7.i.i.i199, ptr %contactToCentre.sroa.8.0.resultNormal.sroa_idx, align 4
  store <2 x float> %contactPoint.sroa.0.2, ptr %point, align 4
  %contactPoint.sroa.8.0.point.sroa_idx = getelementptr inbounds i8, ptr %point, i64 8
  store <2 x float> %contactPoint.sroa.8.2, ptr %contactPoint.sroa.8.0.point.sroa_idx, align 4
...
if.end71:                                         ; preds = %if.end67
  ...
  store <2 x float> %contactPoint.sroa.8.2, ptr %contactPoint.sroa.8.0.point.sroa_idx212, align 4
  store float 0.000000e+00, ptr %timeOfImpact, align 4
  br label %cleanup76

cleanup76:                                        ; preds = %if.else, %for.cond.cleanup, %if.end67, %if.end71, %if.then63, %if.end
  %retval.2 = phi i1 [ false, %if.end ], [ false, %for.cond.cleanup ], [ true, %if.then63 ], [ true, %if.end71 ], [ false, %if.end67 ], [ false, %if.else ]
  ret i1 %retval.2
}
...
entry:
  ...
  %7 = load float, ptr %arrayidx11.i27, align 4
...
if.end12:                                         ; preds = %entry, %if.then6, %if.else
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i71, ptr %ref.tmp13.sroa.4.0..sroa_idx, align 4
...
entry:
  ...
  %7 = load float, ptr %arrayidx5.i64, align 4
  %arrayidx11.i67 = getelementptr inbounds %class.btVector3, ptr %vertices, i64 2, i32 0, i64 2
  %8 = load float, ptr %arrayidx11.i67, align 4
  %sub.i75 = fsub float %1, %6
  %sub8.i78 = fsub float %3, %7
  %sub14.i81 = fsub float %5, %8
  %9 = load float, ptr %p, align 4
  %arrayidx5.i88 = getelementptr inbounds [4 x float], ptr %p, i64 0, i64 1
  %10 = load float, ptr %arrayidx5.i88, align 4
  %arrayidx11.i91 = getelementptr inbounds [4 x float], ptr %p, i64 0, i64 2
  %11 = load float, ptr %arrayidx11.i91, align 4
  %sub.i111 = fsub float %9, %6
  %sub8.i114 = fsub float %10, %7
  %sub14.i117 = fsub float %11, %8
  ...
  %13 = load float, ptr %arrayidx7.i124, align 4
  %14 = load float, ptr %normal, align 4
  %15 = fneg float %sub14.i81
  %neg.i146 = fmul float %13, %15
  %16 = tail call float @llvm.fmuladd.f32(float %sub8.i78, float %12, float %neg.i146)
  %17 = fneg float %sub.i75
  %neg19.i147 = fmul float %12, %17
  %18 = tail call float @llvm.fmuladd.f32(float %sub14.i81, float %14, float %neg19.i147)
  %19 = fneg float %sub8.i78
  %neg30.i148 = fmul float %14, %19
  %20 = tail call float @llvm.fmuladd.f32(float %sub.i75, float %13, float %neg30.i148)
  ...
  %mul8.i163 = fmul float %sub8.i114, %18
  %63 = tail call float @llvm.fmuladd.f32(float %16, float %sub.i111, float %mul8.i163)
  %64 = tail call float @llvm.fmuladd.f32(float %20, float %sub14.i117, float %63)
...
define linkonce_odr dso_local void @_ZN36btDiscreteCollisionDetectorInterfaceD2Ev(ptr noundef nonnull align 8 dereferenceable(8) %this) unnamed_addr #7 comdat align 2 {
entry:
  ret void
}

; Function Attrs: uwtable
define linkonce_odr dso_local void @_ZN22SphereTriangleDetectorD0Ev(ptr noundef nonnull align 8 dereferenceable(28) %this) unnamed_addr #8 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
...
attributes #6 = { mustprogress nofree nosync nounwind willreturn memory(argmem: read) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
