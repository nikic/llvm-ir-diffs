...
entry:
  ...
  %2 = load float, ptr %aabbMax, align 16, !tbaa !13
  %3 = load float, ptr %aabbMin, align 16, !tbaa !13
  %arrayidx5.i = getelementptr inbounds [4 x float], ptr %aabbMax, i64 0, i64 1
  %4 = load float, ptr %arrayidx5.i, align 4, !tbaa !13
  %arrayidx7.i = getelementptr inbounds [4 x float], ptr %aabbMin, i64 0, i64 1
  %5 = load float, ptr %arrayidx7.i, align 4, !tbaa !13
...
init.end:                                         ; preds = %init, %init.check, %entry
  ...
  %9 = load float, ptr %arrayidx67.1, align 4, !tbaa !13
  ...
  store <2 x float> %13, ptr %m_localAabbMax, align 8, !tbaa !13
...
entry:
  ...
  %18 = load float, ptr %arrayidx.i46.i.i.i, align 4, !tbaa !13
  ...
  %20 = load float, ptr %arrayidx.i47.i.i.i, align 4, !tbaa !13
  ...
  %24 = load float, ptr %arrayidx.i32.i.i.i, align 4, !tbaa !13
