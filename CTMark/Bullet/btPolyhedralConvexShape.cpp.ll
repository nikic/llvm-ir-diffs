; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btPolyhedralConvexShape.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btPolyhedralConvexShape.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [27 x ptr] }, ptr @_ZTV23btPolyhedralConvexShape, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  ret void
}
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %4 = load float, ptr %vtx, align 8
  %5 = load float, ptr %arrayidx7.i26, align 4
...
if.then:                                          ; preds = %for.body11
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx16, ptr noundef nonnull align 4 dereferenceable(16) %vtx, i64 12, i1 false)
...
entry:
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i, ptr %ref.tmp19.sroa.4.0..sroa_idx, align 4
...
entry:
  tail call void @_ZN21btConvexInternalShapeC2Ev(ptr noundef nonnull align 8 dereferenceable(64) %this)
  store ptr getelementptr inbounds ({ [27 x ptr] }, ptr @_ZTV34btPolyhedralConvexAabbCachingShape, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %m_localAabbMin = getelementptr inbounds %class.btPolyhedralConvexAabbCachingShape, ptr %this, i64 0, i32 1
