...
entry:
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_vertices, ptr noundef nonnull align 4 dereferenceable(16) %pt0, i64 16, i1 false), !tbaa.struct !22
