; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btOptimizedBvh.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btOptimizedBvh.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV14btOptimizedBvh, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  ret void
}
...
for.body10.i.prol:                                ; preds = %for.body10.lr.ph.i, %for.body10.i.prol
  ...
  %15 = load ptr, ptr %m_data11.i, align 8
  ...
  br i1 %prol.iter183.cmp.not, label %for.body10.i.prol.loopexit, label %for.body10.i.prol
...
for.body10.i:                                     ; preds = %for.body10.i.prol.loopexit, %for.body10.i
  ...
  %20 = load ptr, ptr %m_data11.i, align 8
...
if.else:                                          ; preds = %entry
  ...
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTVZN14btOptimizedBvh5buildEP23btStridingMeshInterfacebRK9btVector3S4_E20NodeTriangleCallback, i64 0, inrange i32 0, i64 2), ptr %callback11, align 8
  %m_triangleNodes.i79 = getelementptr inbounds %struct.NodeTriangleCallback, ptr %callback11, i64 0, i32 1
  store ptr %m_leafNodes, ptr %m_triangleNodes.i79, align 8
  ...
  %vtable28 = load ptr, ptr %triangles, align 8
...
invoke.cont38:                                    ; preds = %if.else
  ...
  %24 = load i32, ptr %m_size.i83, align 4
  %mul35 = shl nsw i32 %24, 1
  %m_size.i.i84 = getelementptr inbounds %class.btQuantizedBvh, ptr %this, i64 0, i32 9, i32 2
  %25 = load i32, ptr %m_size.i.i84, align 4
  %cmp4.i87 = icmp slt i32 %25, %mul35
  br i1 %cmp4.i87, label %if.then5.i88, label %invoke.cont39

if.then5.i88:                                     ; preds = %invoke.cont38
  %m_capacity.i.i.i89 = getelementptr inbounds %class.btQuantizedBvh, ptr %this, i64 0, i32 9, i32 3
  %26 = load i32, ptr %m_capacity.i.i.i89, align 8
  %cmp.i.i90 = icmp slt i32 %26, %mul35
  br i1 %cmp.i.i90, label %if.then.i.i99, label %for.body10.lr.ph.i91

if.then.i.i99:                                    ; preds = %if.then5.i88
  %tobool.not.i.i.i100 = icmp eq i32 %24, 0
  br i1 %tobool.not.i.i.i100, label %_ZN20btAlignedObjectArrayI18btOptimizedBvhNodeE8allocateEi.exit.i.i, label %if.then.i.i.i101

if.then.i.i.i101:                                 ; preds = %if.then.i.i99
  %conv.i.i.i.i102 = sext i32 %mul35 to i64
  %mul.i.i.i.i103 = shl nsw i64 %conv.i.i.i.i102, 6
  %call.i.i.i.i124 = invoke noundef ptr @_Z22btAlignedAllocInternalmi(i64 noundef %mul.i.i.i.i103, i32 noundef 16)
          to label %call.i.i.i.i.noexc123 unwind label %lpad37

call.i.i.i.i.noexc123:                            ; preds = %if.then.i.i.i101
  %.pre.i104 = load i32, ptr %m_size.i.i84, align 4
  br label %_ZN20btAlignedObjectArrayI18btOptimizedBvhNodeE8allocateEi.exit.i.i

_ZN20btAlignedObjectArrayI18btOptimizedBvhNodeE8allocateEi.exit.i.i: ; preds = %call.i.i.i.i.noexc123, %if.then.i.i99
  %27 = phi i32 [ %.pre.i104, %call.i.i.i.i.noexc123 ], [ %25, %if.then.i.i99 ]
  %retval.0.i.i.i105 = phi ptr [ %call.i.i.i.i124, %call.i.i.i.i.noexc123 ], [ null, %if.then.i.i99 ]
  %cmp7.i.i.i106 = icmp sgt i32 %27, 0
  br i1 %cmp7.i.i.i106, label %for.body.lr.ph.i.i.i114, label %_ZNK20btAlignedObjectArrayI18btOptimizedBvhNodeE4copyEiiPS0_.exit.i.i

for.body.lr.ph.i.i.i114:                          ; preds = %_ZN20btAlignedObjectArrayI18btOptimizedBvhNodeE8allocateEi.exit.i.i
  %m_data.i.i.i115 = getelementptr inbounds %class.btQuantizedBvh, ptr %this, i64 0, i32 9, i32 5
  %wide.trip.count.i.i.i116 = zext i32 %27 to i64
  %xtraiter = and i64 %wide.trip.count.i.i.i116, 1
  %28 = icmp eq i32 %27, 1
  br i1 %28, label %_ZNK20btAlignedObjectArrayI18btOptimizedBvhNodeE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa, label %for.body.lr.ph.i.i.i114.new

for.body.lr.ph.i.i.i114.new:                      ; preds = %for.body.lr.ph.i.i.i114
  %unroll_iter = and i64 %wide.trip.count.i.i.i116, 4294967294
  br label %for.body.i.i.i117

for.body.i.i.i117:                                ; preds = %for.body.i.i.i117, %for.body.lr.ph.i.i.i114.new
  %indvars.iv.i.i.i118 = phi i64 [ 0, %for.body.lr.ph.i.i.i114.new ], [ %indvars.iv.next.i.i.i121.1, %for.body.i.i.i117 ]
  %niter = phi i64 [ 0, %for.body.lr.ph.i.i.i114.new ], [ %niter.next.1, %for.body.i.i.i117 ]
  %arrayidx.i.i.i119 = getelementptr inbounds %struct.btOptimizedBvhNode, ptr %retval.0.i.i.i105, i64 %indvars.iv.i.i.i118
  %29 = load ptr, ptr %m_data.i.i.i115, align 8
  %arrayidx3.i.i.i120 = getelementptr inbounds %struct.btOptimizedBvhNode, ptr %29, i64 %indvars.iv.i.i.i118
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(64) %arrayidx.i.i.i119, ptr noundef nonnull align 4 dereferenceable(64) %arrayidx3.i.i.i120, i64 64, i1 false)
  %indvars.iv.next.i.i.i121 = or i64 %indvars.iv.i.i.i118, 1
  %arrayidx.i.i.i119.1 = getelementptr inbounds %struct.btOptimizedBvhNode, ptr %retval.0.i.i.i105, i64 %indvars.iv.next.i.i.i121
  %30 = load ptr, ptr %m_data.i.i.i115, align 8
  %arrayidx3.i.i.i120.1 = getelementptr inbounds %struct.btOptimizedBvhNode, ptr %30, i64 %indvars.iv.next.i.i.i121
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(64) %arrayidx.i.i.i119.1, ptr noundef nonnull align 4 dereferenceable(64) %arrayidx3.i.i.i120.1, i64 64, i1 false)
  %indvars.iv.next.i.i.i121.1 = add nuw nsw i64 %indvars.iv.i.i.i118, 2
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %_ZNK20btAlignedObjectArrayI18btOptimizedBvhNodeE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa, label %for.body.i.i.i117

_ZNK20btAlignedObjectArrayI18btOptimizedBvhNodeE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa: ; preds = %for.body.i.i.i117, %for.body.lr.ph.i.i.i114
  %indvars.iv.i.i.i118.unr = phi i64 [ 0, %for.body.lr.ph.i.i.i114 ], [ %indvars.iv.next.i.i.i121.1, %for.body.i.i.i117 ]
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %_ZNK20btAlignedObjectArrayI18btOptimizedBvhNodeE4copyEiiPS0_.exit.i.i, label %for.body.i.i.i117.epil

for.body.i.i.i117.epil:                           ; preds = %_ZNK20btAlignedObjectArrayI18btOptimizedBvhNodeE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa
  %arrayidx.i.i.i119.epil = getelementptr inbounds %struct.btOptimizedBvhNode, ptr %retval.0.i.i.i105, i64 %indvars.iv.i.i.i118.unr
  %31 = load ptr, ptr %m_data.i.i.i115, align 8
  %arrayidx3.i.i.i120.epil = getelementptr inbounds %struct.btOptimizedBvhNode, ptr %31, i64 %indvars.iv.i.i.i118.unr
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(64) %arrayidx.i.i.i119.epil, ptr noundef nonnull align 4 dereferenceable(64) %arrayidx3.i.i.i120.epil, i64 64, i1 false)
  br label %_ZNK20btAlignedObjectArrayI18btOptimizedBvhNodeE4copyEiiPS0_.exit.i.i

_ZNK20btAlignedObjectArrayI18btOptimizedBvhNodeE4copyEiiPS0_.exit.i.i: ; preds = %for.body.i.i.i117.epil, %_ZNK20btAlignedObjectArrayI18btOptimizedBvhNodeE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa, %_ZN20btAlignedObjectArrayI18btOptimizedBvhNodeE8allocateEi.exit.i.i
  %m_data.i9.i.i107 = getelementptr inbounds %class.btQuantizedBvh, ptr %this, i64 0, i32 9, i32 5
  %32 = load ptr, ptr %m_data.i9.i.i107, align 8
  %tobool.not.i10.i.i108 = icmp eq ptr %32, null
  %m_ownsMemory.i.i.i109 = getelementptr inbounds %class.btQuantizedBvh, ptr %this, i64 0, i32 9, i32 6
  %33 = load i8, ptr %m_ownsMemory.i.i.i109, align 8
  %tobool2.not.i.i.i110 = icmp eq i8 %33, 0
  %or.cond.i.i111 = select i1 %tobool.not.i10.i.i108, i1 true, i1 %tobool2.not.i.i.i110
  br i1 %or.cond.i.i111, label %if.end.i113, label %if.then3.i.i.i112

if.then3.i.i.i112:                                ; preds = %_ZNK20btAlignedObjectArrayI18btOptimizedBvhNodeE4copyEiiPS0_.exit.i.i
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %32)
          to label %if.end.i113 unwind label %lpad37

if.end.i113:                                      ; preds = %if.then3.i.i.i112, %_ZNK20btAlignedObjectArrayI18btOptimizedBvhNodeE4copyEiiPS0_.exit.i.i
  store i8 1, ptr %m_ownsMemory.i.i.i109, align 8
  store ptr %retval.0.i.i.i105, ptr %m_data.i9.i.i107, align 8
  store i32 %mul35, ptr %m_capacity.i.i.i89, align 8
  br label %for.body10.lr.ph.i91

for.body10.lr.ph.i91:                             ; preds = %if.end.i113, %if.then5.i88
  %m_data11.i92 = getelementptr inbounds %class.btQuantizedBvh, ptr %this, i64 0, i32 9, i32 5
  %34 = sext i32 %25 to i64
  %wide.trip.count.i93 = sext i32 %mul35 to i64
  %35 = sub nsw i64 %wide.trip.count.i93, %34
  %36 = xor i64 %34, -1
  %37 = add nsw i64 %36, %wide.trip.count.i93
  %xtraiter175 = and i64 %35, 3
  %lcmp.mod176.not = icmp eq i64 %xtraiter175, 0
  br i1 %lcmp.mod176.not, label %for.body10.i94.prol.loopexit, label %for.body10.i94.prol

for.body10.i94.prol:                              ; preds = %for.body10.lr.ph.i91, %for.body10.i94.prol
  %indvars.iv.i95.prol = phi i64 [ %indvars.iv.next.i97.prol, %for.body10.i94.prol ], [ %34, %for.body10.lr.ph.i91 ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body10.i94.prol ], [ 0, %for.body10.lr.ph.i91 ]
  %38 = load ptr, ptr %m_data11.i92, align 8
  %arrayidx13.i96.prol = getelementptr inbounds %struct.btOptimizedBvhNode, ptr %38, i64 %indvars.iv.i95.prol
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(64) %arrayidx13.i96.prol, i8 0, i64 64, i1 false)
  %indvars.iv.next.i97.prol = add nsw i64 %indvars.iv.i95.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter175
  br i1 %prol.iter.cmp.not, label %for.body10.i94.prol.loopexit, label %for.body10.i94.prol

for.body10.i94.prol.loopexit:                     ; preds = %for.body10.i94.prol, %for.body10.lr.ph.i91
  %indvars.iv.i95.unr = phi i64 [ %34, %for.body10.lr.ph.i91 ], [ %indvars.iv.next.i97.prol, %for.body10.i94.prol ]
  %39 = icmp ult i64 %37, 3
  br i1 %39, label %invoke.cont39, label %for.body10.i94

for.body10.i94:                                   ; preds = %for.body10.i94.prol.loopexit, %for.body10.i94
  %indvars.iv.i95 = phi i64 [ %indvars.iv.next.i97.3, %for.body10.i94 ], [ %indvars.iv.i95.unr, %for.body10.i94.prol.loopexit ]
  %40 = load ptr, ptr %m_data11.i92, align 8
  %arrayidx13.i96 = getelementptr inbounds %struct.btOptimizedBvhNode, ptr %40, i64 %indvars.iv.i95
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(64) %arrayidx13.i96, i8 0, i64 64, i1 false)
  %indvars.iv.next.i97 = add nsw i64 %indvars.iv.i95, 1
  %41 = load ptr, ptr %m_data11.i92, align 8
  %arrayidx13.i96.1 = getelementptr inbounds %struct.btOptimizedBvhNode, ptr %41, i64 %indvars.iv.next.i97
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(64) %arrayidx13.i96.1, i8 0, i64 64, i1 false)
  %indvars.iv.next.i97.1 = add nsw i64 %indvars.iv.i95, 2
  %42 = load ptr, ptr %m_data11.i92, align 8
  %arrayidx13.i96.2 = getelementptr inbounds %struct.btOptimizedBvhNode, ptr %42, i64 %indvars.iv.next.i97.1
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(64) %arrayidx13.i96.2, i8 0, i64 64, i1 false)
  %indvars.iv.next.i97.2 = add nsw i64 %indvars.iv.i95, 3
  %43 = load ptr, ptr %m_data11.i92, align 8
  %arrayidx13.i96.3 = getelementptr inbounds %struct.btOptimizedBvhNode, ptr %43, i64 %indvars.iv.next.i97.2
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(64) %arrayidx13.i96.3, i8 0, i64 64, i1 false)
  %indvars.iv.next.i97.3 = add nsw i64 %indvars.iv.i95, 4
  %exitcond.not.i98.3 = icmp eq i64 %indvars.iv.next.i97.3, %wide.trip.count.i93
  br i1 %exitcond.not.i98.3, label %invoke.cont39, label %for.body10.i94

invoke.cont39:                                    ; preds = %for.body10.i94.prol.loopexit, %for.body10.i94, %invoke.cont38
  store i32 %mul35, ptr %m_size.i.i84, align 4
...
lpad37:                                           ; preds = %if.then3.i.i.i112, %if.then.i.i.i101
...
if.end:                                           ; preds = %invoke.cont39, %invoke.cont8
  ...
  %46 = load i8, ptr %m_useQuantization, align 8
...
land.lhs.true:                                    ; preds = %if.end
  ...
  %47 = load i32, ptr %m_size.i126, align 4
...
_ZN20btAlignedObjectArrayI16btBvhSubtreeInfoE8allocateEi.exit.i.i: ; preds = %if.then50
  ...
  %.pre.i136 = load i32, ptr %m_size.i126, align 4
  %cmp7.i.i.i138 = icmp sgt i32 %.pre.i136, 0
  br i1 %cmp7.i.i.i138, label %for.body.lr.ph.i.i.i145, label %_ZNK20btAlignedObjectArrayI16btBvhSubtreeInfoE4copyEiiPS0_.exit.i.i

for.body.lr.ph.i.i.i145:                          ; preds = %_ZN20btAlignedObjectArrayI16btBvhSubtreeInfoE8allocateEi.exit.i.i
  %m_data.i.i.i146 = getelementptr inbounds %class.btQuantizedBvh, ptr %this, i64 0, i32 14, i32 5
  %wide.trip.count.i.i.i147 = zext i32 %.pre.i136 to i64
  %xtraiter184 = and i64 %wide.trip.count.i.i.i147, 1
  %49 = icmp eq i32 %.pre.i136, 1
  br i1 %49, label %_ZNK20btAlignedObjectArrayI16btBvhSubtreeInfoE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa, label %for.body.lr.ph.i.i.i145.new

for.body.lr.ph.i.i.i145.new:                      ; preds = %for.body.lr.ph.i.i.i145
  %unroll_iter186 = and i64 %wide.trip.count.i.i.i147, 4294967294
  br label %for.body.i.i.i148

for.body.i.i.i148:                                ; preds = %for.body.i.i.i148, %for.body.lr.ph.i.i.i145.new
  %indvars.iv.i.i.i149 = phi i64 [ 0, %for.body.lr.ph.i.i.i145.new ], [ %indvars.iv.next.i.i.i152.1, %for.body.i.i.i148 ]
  %niter187 = phi i64 [ 0, %for.body.lr.ph.i.i.i145.new ], [ %niter187.next.1, %for.body.i.i.i148 ]
  %arrayidx.i.i.i150 = getelementptr inbounds %class.btBvhSubtreeInfo, ptr %call.i.i.i.i, i64 %indvars.iv.i.i.i149
  %50 = load ptr, ptr %m_data.i.i.i146, align 8
  %arrayidx3.i.i.i151 = getelementptr inbounds %class.btBvhSubtreeInfo, ptr %50, i64 %indvars.iv.i.i.i149
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(32) %arrayidx.i.i.i150, ptr noundef nonnull align 4 dereferenceable(32) %arrayidx3.i.i.i151, i64 32, i1 false)
  %indvars.iv.next.i.i.i152 = or i64 %indvars.iv.i.i.i149, 1
  %arrayidx.i.i.i150.1 = getelementptr inbounds %class.btBvhSubtreeInfo, ptr %call.i.i.i.i, i64 %indvars.iv.next.i.i.i152
  %51 = load ptr, ptr %m_data.i.i.i146, align 8
  %arrayidx3.i.i.i151.1 = getelementptr inbounds %class.btBvhSubtreeInfo, ptr %51, i64 %indvars.iv.next.i.i.i152
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(32) %arrayidx.i.i.i150.1, ptr noundef nonnull align 4 dereferenceable(32) %arrayidx3.i.i.i151.1, i64 32, i1 false)
  %indvars.iv.next.i.i.i152.1 = add nuw nsw i64 %indvars.iv.i.i.i149, 2
  %niter187.next.1 = add i64 %niter187, 2
  %niter187.ncmp.1 = icmp eq i64 %niter187.next.1, %unroll_iter186
  br i1 %niter187.ncmp.1, label %_ZNK20btAlignedObjectArrayI16btBvhSubtreeInfoE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa, label %for.body.i.i.i148

_ZNK20btAlignedObjectArrayI16btBvhSubtreeInfoE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa: ; preds = %for.body.i.i.i148, %for.body.lr.ph.i.i.i145
  %indvars.iv.i.i.i149.unr = phi i64 [ 0, %for.body.lr.ph.i.i.i145 ], [ %indvars.iv.next.i.i.i152.1, %for.body.i.i.i148 ]
  %lcmp.mod185.not = icmp eq i64 %xtraiter184, 0
  br i1 %lcmp.mod185.not, label %_ZNK20btAlignedObjectArrayI16btBvhSubtreeInfoE4copyEiiPS0_.exit.i.i, label %for.body.i.i.i148.epil

for.body.i.i.i148.epil:                           ; preds = %_ZNK20btAlignedObjectArrayI16btBvhSubtreeInfoE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa
  %arrayidx.i.i.i150.epil = getelementptr inbounds %class.btBvhSubtreeInfo, ptr %call.i.i.i.i, i64 %indvars.iv.i.i.i149.unr
  %52 = load ptr, ptr %m_data.i.i.i146, align 8
  %arrayidx3.i.i.i151.epil = getelementptr inbounds %class.btBvhSubtreeInfo, ptr %52, i64 %indvars.iv.i.i.i149.unr
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(32) %arrayidx.i.i.i150.epil, ptr noundef nonnull align 4 dereferenceable(32) %arrayidx3.i.i.i151.epil, i64 32, i1 false)
  br label %_ZNK20btAlignedObjectArrayI16btBvhSubtreeInfoE4copyEiiPS0_.exit.i.i

_ZNK20btAlignedObjectArrayI16btBvhSubtreeInfoE4copyEiiPS0_.exit.i.i: ; preds = %for.body.i.i.i148.epil, %_ZNK20btAlignedObjectArrayI16btBvhSubtreeInfoE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa, %_ZN20btAlignedObjectArrayI16btBvhSubtreeInfoE8allocateEi.exit.i.i
  %m_data.i9.i.i139 = getelementptr inbounds %class.btQuantizedBvh, ptr %this, i64 0, i32 14, i32 5
  %53 = load ptr, ptr %m_data.i9.i.i139, align 8
  %tobool.not.i10.i.i140 = icmp eq ptr %53, null
  %m_ownsMemory.i.i.i141 = getelementptr inbounds %class.btQuantizedBvh, ptr %this, i64 0, i32 14, i32 6
  %54 = load i8, ptr %m_ownsMemory.i.i.i141, align 8
  %tobool2.not.i.i.i142 = icmp eq i8 %54, 0
  %or.cond.i.i143 = select i1 %tobool.not.i10.i.i140, i1 true, i1 %tobool2.not.i.i.i142
  br i1 %or.cond.i.i143, label %_ZN20btAlignedObjectArrayI16btBvhSubtreeInfoE10deallocateEv.exit.i.i, label %if.then3.i.i.i144

if.then3.i.i.i144:                                ; preds = %_ZNK20btAlignedObjectArrayI16btBvhSubtreeInfoE4copyEiiPS0_.exit.i.i
...
_ZN20btAlignedObjectArrayI16btBvhSubtreeInfoE10deallocateEv.exit.i.i: ; preds = %if.then3.i.i.i144, %_ZNK20btAlignedObjectArrayI16btBvhSubtreeInfoE4copyEiiPS0_.exit.i.i
  store i8 1, ptr %m_ownsMemory.i.i.i141, align 8
  store ptr %call.i.i.i.i, ptr %m_data.i9.i.i139, align 8
  store i32 1, ptr %m_capacity.i.i, align 8
  %.pre12.i = load i32, ptr %m_size.i126, align 4
...
_ZN20btAlignedObjectArrayI16btBvhSubtreeInfoE6expandERKS0_.exit: ; preds = %if.then50, %_ZN20btAlignedObjectArrayI16btBvhSubtreeInfoE10deallocateEv.exit.i.i
  ...
  store i32 %inc.i, ptr %m_size.i126, align 4
  ...
  %64 = load i32, ptr %m_escapeIndexOrTriangleIndex.i, align 4
...
_ZN20btAlignedObjectArrayI18btOptimizedBvhNodeE5clearEv.exit: ; preds = %_ZN20btAlignedObjectArrayI18btQuantizedBvhNodeE5clearEv.exit, %if.then3.i.i170
  ...
  store ptr null, ptr %m_data.i.i165, align 8
  store i32 0, ptr %m_size.i.i171, align 4
  %m_capacity.i.i173 = getelementptr inbounds %class.btQuantizedBvh, ptr %this, i64 0, i32 8, i32 3
  store i32 0, ptr %m_capacity.i.i173, align 8
  ret void
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %6 = load i16, ptr %arrayidx.i10, align 4
...
if.end12.split.us:                                ; preds = %if.end12
  %13 = load float, ptr %arrayidx.i328, align 4
  %14 = load float, ptr %arrayidx.i329, align 4
...
cond.end.us:                                      ; preds = %cond.true.us, %cond.false.us
  ...
  %17 = load <2 x float>, ptr %add.ptr23.us, align 4
  ...
  %21 = load float, ptr %arrayidx33.us, align 4
...
cond.true.us.2:                                   ; preds = %cond.end.us.1
  %28 = load i16, ptr %add.ptr, align 2
...
if.end12.split:                                   ; preds = %if.end12
  ...
  %36 = load float, ptr %arrayidx.i329, align 4
...
for.cond.cleanup:                                 ; preds = %cond.end.2, %cond.end.us.2
  ...
  %cmp.i20.i229 = fcmp ogt float %triangleVerts.sroa.8.0, 0xC3ABC16D60000000
  %aabbMax.sroa.18.0 = select i1 %cmp.i20.i229, float %triangleVerts.sroa.8.0, float 0xC3ABC16D60000000
  ...
  %41 = load float, ptr %arrayidx13.i.i, align 8
  %sub14.i.i = fsub float %aabbMin.sroa.18.2, %41
  %42 = load float, ptr %arrayidx13.i46.i, align 8
  ...
  %49 = load <2 x float>, ptr %m_bvhAabbMin.i, align 8
  %50 = fsub <2 x float> %48, %49
  %51 = load <2 x float>, ptr %m_bvhQuantization.i, align 8
  ...
  %56 = load float, ptr %arrayidx13.i.i, align 8
  %sub14.i.i316 = fsub float %aabbMax.sroa.18.2, %56
  %57 = load float, ptr %arrayidx13.i46.i, align 8
  ...
  %65 = load <2 x float>, ptr %m_bvhAabbMin.i, align 8
  %66 = fsub <2 x float> %64, %65
  %67 = load <2 x float>, ptr %m_bvhQuantization.i, align 8
...
cond.false:                                       ; preds = %if.end12.split
  ...
  %74 = load i32, ptr %arrayidx18, align 4
  br label %cond.end
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %75 = load <2 x double>, ptr %add.ptr41, align 8
  ...
  %78 = load double, ptr %arrayidx56, align 8
...
cond.false.1:                                     ; preds = %cond.end
  ...
  %79 = load i32, ptr %arrayidx18.1, align 4
  br label %cond.end.1
...
cond.end.1:                                       ; preds = %cond.true.1, %cond.false.1
  ...
  %81 = load <2 x double>, ptr %add.ptr41.1, align 8
  ...
  %84 = load double, ptr %arrayidx56.1, align 8
...
cond.true.2:                                      ; preds = %cond.end.1
  %86 = load i16, ptr %add.ptr, align 2
...
cond.end.2:                                       ; preds = %cond.true.2, %cond.false.2
  ...
  %87 = load <2 x double>, ptr %add.ptr41.2, align 8
  ...
  %90 = load double, ptr %arrayidx56.2, align 8
...
if.else78:                                        ; preds = %for.body
  ...
  %91 = load i32, ptr %m_escapeIndexOrTriangleIndex.i336, align 4
  ...
  %94 = load i16, ptr %arrayidx124.1, align 2
  %arrayidx127.1 = getelementptr inbounds %struct.btQuantizedBvhNode, ptr %2, i64 %indvars.iv.next, i32 1, i64 1
  store i16 %94, ptr %arrayidx127.1, align 2
  %arrayidx104.2 = getelementptr inbounds [3 x i16], ptr %arrayidx.i, i64 0, i64 2
  %95 = load <4 x i16>, ptr %arrayidx.i335, align 2
  store <4 x i16> %95, ptr %arrayidx.i, align 2
  %96 = load <2 x i16>, ptr %arrayidx134, align 2
  ...
  %100 = load <2 x i16>, ptr %cond93, align 2
  ...
  %103 = load i16, ptr %arrayidx111.2, align 2
...
if.then152:                                       ; preds = %for.end150
  %vtable153 = load ptr, ptr %meshInterface, align 8
...
entry:
  ...
  %1 = load <2 x float>, ptr %arrayidx7.i48, align 4
  ...
  %3 = load <2 x float>, ptr %arrayidx7.i66, align 4
  ...
  %8 = load <2 x float>, ptr %arrayidx7.i102, align 4
  %9 = load <2 x float>, ptr %arrayidx7.i.i, align 4
  %10 = load <2 x float>, ptr %arrayidx7.i44.i, align 4
...
if.then.i:                                        ; preds = %entry
  ...
  %mul.i.i161 = shl nsw i32 %12, 1
  %cond.i.i = select i1 %tobool.not.i.i, i32 1, i32 %mul.i.i161
  %cmp.i.i162 = icmp slt i32 %12, %cond.i.i
  br i1 %cmp.i.i162, label %if.then.i.i163, label %_ZN20btAlignedObjectArrayI18btQuantizedBvhNodeE9push_backERKS0_.exit

if.then.i.i163:                                   ; preds = %if.then.i
  %tobool.not.i.i.i = icmp eq i32 %cond.i.i, 0
  br i1 %tobool.not.i.i.i, label %_ZN20btAlignedObjectArrayI18btQuantizedBvhNodeE8allocateEi.exit.i.i, label %if.then.i.i.i

if.then.i.i.i:                                    ; preds = %if.then.i.i163
...
_ZN20btAlignedObjectArrayI18btQuantizedBvhNodeE8allocateEi.exit.i.i: ; preds = %if.then.i.i.i, %if.then.i.i163
  %14 = phi i32 [ %.pre.i, %if.then.i.i.i ], [ %12, %if.then.i.i163 ]
  %retval.0.i.i.i = phi ptr [ %call.i.i.i.i, %if.then.i.i.i ], [ null, %if.then.i.i163 ]
...
_ZN20btAlignedObjectArrayI18btQuantizedBvhNodeE10deallocateEv.exit.i.i: ; preds = %if.then3.i.i.i, %_ZNK20btAlignedObjectArrayI18btQuantizedBvhNodeE4copyEiiPS0_.exit.i.i
  ...
  %.pre8.i = load i32, ptr %m_size.i.i, align 4
...
_ZN20btAlignedObjectArrayI18btQuantizedBvhNodeE9push_backERKS0_.exit: ; preds = %entry, %if.then.i, %_ZN20btAlignedObjectArrayI18btQuantizedBvhNodeE10deallocateEv.exit.i.i
  ...
  %arrayidx.i160 = getelementptr inbounds %struct.btQuantizedBvhNode, ptr %28, i64 %idxprom.i
  ...
  %node.sroa.7.0.arrayidx.i160.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i160, i64 8
  ...
  store <4 x i16> %66, ptr %arrayidx.i160, align 4
  store <2 x i16> %51, ptr %node.sroa.7.0.arrayidx.i160.sroa_idx, align 4
  %node.sroa.9.0.arrayidx.i160.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i160, i64 12
  store i32 %or, ptr %node.sroa.9.0.arrayidx.i160.sroa_idx, align 4
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i.new
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(64) %arrayidx.i.i.i.1, ptr noundef nonnull align 4 dereferenceable(64) %arrayidx3.i.i.i.1, i64 64, i1 false)
  %indvars.iv.next.i.i.i.1 = add nuw nsw i64 %indvars.iv.i.i.i, 2
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
...
for.body.i.i.i.epil:                              ; preds = %_ZNK20btAlignedObjectArrayI18btOptimizedBvhNodeE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(64) %arrayidx.i.i.i.epil, ptr noundef nonnull align 4 dereferenceable(64) %arrayidx3.i.i.i.epil, i64 64, i1 false)
  br label %_ZNK20btAlignedObjectArrayI18btOptimizedBvhNodeE4copyEiiPS0_.exit.i.i
...
_ZNK20btAlignedObjectArrayI18btOptimizedBvhNodeE4copyEiiPS0_.exit.i.i: ; preds = %for.body.i.i.i.epil, %_ZNK20btAlignedObjectArrayI18btOptimizedBvhNodeE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa, %_ZN20btAlignedObjectArrayI18btOptimizedBvhNodeE8allocateEi.exit.i.i
  ...
  %11 = load ptr, ptr %m_data.i9.i.i, align 8
...
_ZN20btAlignedObjectArrayI18btOptimizedBvhNodeE9push_backERKS0_.exit: ; preds = %entry, %if.then.i, %_ZN20btAlignedObjectArrayI18btOptimizedBvhNodeE10deallocateEv.exit.i.i
  ...
  store i32 -1, ptr %node.sroa.11.0.arrayidx.i.sroa_idx, align 4
  %node.sroa.12.0.arrayidx.i.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i, i64 36
  store i32 %partId, ptr %node.sroa.12.0.arrayidx.i.sroa_idx, align 4
  %node.sroa.13.0.arrayidx.i.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i, i64 40
  store i32 %triangleIndex, ptr %node.sroa.13.0.arrayidx.i.sroa_idx, align 4
