; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btBoxBoxDetector.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btBoxBoxDetector.cpp"
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %8 = load <2 x float>, ptr %arrayidx22, align 4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> <i32 1, i32 1, i32 1, i32 1>, ptr %45, align 16
...
for.body105:                                      ; preds = %for.body105.preheader, %for.body105
  ...
  br i1 %exitcond274.not, label %for.end110, label %for.body105
...
for.body116.preheader:                            ; preds = %for.body116.lr.ph
  ...
  br i1 %min.iters.check299, label %for.body116.preheader311, label %vector.ph300
...
vector.body307:                                   ; preds = %vector.body307, %vector.ph300
  %index308 = phi i64 [ 0, %vector.ph300 ], [ %index.next310, %vector.body307 ]
  ...
  store <4 x i32> %broadcast.splat, ptr %53, align 4
  %index.next310 = add nuw i64 %index308, 8
  %54 = icmp eq i64 %index.next310, %n.vec302
  br i1 %54, label %middle.block297, label %vector.body307

middle.block297:                                  ; preds = %vector.body307
  %cmp.n306 = icmp eq i64 %n.vec302, %50
  br i1 %cmp.n306, label %for.end152, label %for.body116.preheader311

for.body116.preheader311:                         ; preds = %for.body116.preheader, %middle.block297
...
for.body116.us:                                   ; preds = %for.body116.us.preheader, %for.cond126.for.end146_crit_edge.us
  ...
  store i32 %i0, ptr %iret.addr.0255.us, align 4
...
for.body128.us:                                   ; preds = %for.body116.us, %for.inc144.us
  ...
  %57 = load i32, ptr %arrayidx130.us, align 4
...
if.then131.us:                                    ; preds = %for.body128.us
  ...
  %58 = load float, ptr %arrayidx133.us, align 4
...
if.then141.us:                                    ; preds = %if.then131.us
  ...
  store i32 %60, ptr %iret.addr.0255.us, align 4
...
for.body116:                                      ; preds = %for.body116.preheader311, %for.body116
  %iret.addr.0255 = phi ptr [ %iret.addr.0, %for.body116 ], [ %iret.addr.0255.ph, %for.body116.preheader311 ]
  %j.0254 = phi i32 [ %inc151, %for.body116 ], [ %j.0254.ph, %for.body116.preheader311 ]
  store i32 %i0, ptr %iret.addr.0255, align 4
  ...
  br i1 %exitcond275.not, label %for.end152, label %for.body116
...
entry:
  ...
  %arrayidx5.i1886 = getelementptr inbounds [4 x float], ptr %p2, i64 0, i64 1
  %4 = load float, ptr %arrayidx5.i1886, align 4
  %arrayidx7.i1887 = getelementptr inbounds [4 x float], ptr %p1, i64 0, i64 1
  %5 = load float, ptr %arrayidx7.i1887, align 4
  ...
  %arrayidx5.i1889 = getelementptr inbounds float, ptr %R1, i64 8
  %11 = load float, ptr %arrayidx5.i1889, align 4
  ...
  %arrayidx2.i1890 = getelementptr inbounds float, ptr %R1, i64 5
  %14 = load float, ptr %arrayidx2.i1890, align 4
  %mul4.i1892 = fmul float %sub8.i, %14
  %15 = tail call float @llvm.fmuladd.f32(float %13, float %sub.i, float %mul4.i1892)
  %arrayidx5.i1893 = getelementptr inbounds float, ptr %R1, i64 9
  %16 = load float, ptr %arrayidx5.i1893, align 4
  ...
  %arrayidx2.i1895 = getelementptr inbounds float, ptr %R1, i64 6
  %19 = load float, ptr %arrayidx2.i1895, align 4
  %mul4.i1897 = fmul float %sub8.i, %19
  %20 = tail call float @llvm.fmuladd.f32(float %18, float %sub.i, float %mul4.i1897)
  %arrayidx5.i1898 = getelementptr inbounds float, ptr %R1, i64 10
  %21 = load float, ptr %arrayidx5.i1898, align 4
  ...
  %arrayidx3.i1901 = getelementptr inbounds float, ptr %R2, i64 4
  %30 = load float, ptr %arrayidx3.i1901, align 4
  %mul4.i1902 = fmul float %9, %30
  %31 = tail call float @llvm.fmuladd.f32(float %8, float %29, float %mul4.i1902)
  %arrayidx6.i1904 = getelementptr inbounds float, ptr %R2, i64 8
  %32 = load float, ptr %arrayidx6.i1904, align 4
  ...
  %arrayidx3.i1906 = getelementptr inbounds float, ptr %R2, i64 5
  %35 = load float, ptr %arrayidx3.i1906, align 4
  %mul4.i1907 = fmul float %9, %35
  %36 = tail call float @llvm.fmuladd.f32(float %8, float %34, float %mul4.i1907)
  %arrayidx6.i1909 = getelementptr inbounds float, ptr %R2, i64 9
  %37 = load float, ptr %arrayidx6.i1909, align 4
  ...
  %arrayidx3.i1911 = getelementptr inbounds float, ptr %R2, i64 6
  %40 = load float, ptr %arrayidx3.i1911, align 4
  %mul4.i1912 = fmul float %9, %40
  %41 = tail call float @llvm.fmuladd.f32(float %8, float %39, float %mul4.i1912)
  %arrayidx6.i1914 = getelementptr inbounds float, ptr %R2, i64 10
  %42 = load float, ptr %arrayidx6.i1914, align 4
  %43 = tail call float @llvm.fmuladd.f32(float %11, float %42, float %41)
  %mul4.i1917 = fmul float %14, %30
  %44 = tail call float @llvm.fmuladd.f32(float %13, float %29, float %mul4.i1917)
  %45 = tail call float @llvm.fmuladd.f32(float %16, float %32, float %44)
  %mul4.i1922 = fmul float %14, %35
  %46 = tail call float @llvm.fmuladd.f32(float %13, float %34, float %mul4.i1922)
  %47 = tail call float @llvm.fmuladd.f32(float %16, float %37, float %46)
  %mul4.i1927 = fmul float %14, %40
  %48 = tail call float @llvm.fmuladd.f32(float %13, float %39, float %mul4.i1927)
  %49 = tail call float @llvm.fmuladd.f32(float %16, float %42, float %48)
  %mul4.i1932 = fmul float %19, %30
  %50 = tail call float @llvm.fmuladd.f32(float %18, float %29, float %mul4.i1932)
  %51 = tail call float @llvm.fmuladd.f32(float %21, float %32, float %50)
  %mul4.i1937 = fmul float %19, %35
  %52 = tail call float @llvm.fmuladd.f32(float %18, float %34, float %mul4.i1937)
  %53 = tail call float @llvm.fmuladd.f32(float %21, float %37, float %52)
  %mul4.i1942 = fmul float %19, %40
  %54 = tail call float @llvm.fmuladd.f32(float %18, float %39, float %mul4.i1942)
...
if.end136:                                        ; preds = %if.then130, %if.end128
  ...
  %mul4.i1947 = fmul float %sub8.i, %30
  %81 = tail call float @llvm.fmuladd.f32(float %29, float %sub.i, float %mul4.i1947)
...
if.end160:                                        ; preds = %if.then153, %if.end151
  ...
  %mul4.i1957 = fmul float %sub8.i, %35
  %86 = tail call float @llvm.fmuladd.f32(float %34, float %sub.i, float %mul4.i1957)
...
if.end185:                                        ; preds = %if.then178, %if.end176
  ...
  %mul4.i1967 = fmul float %sub8.i, %40
  %91 = tail call float @llvm.fmuladd.f32(float %39, float %sub.i, float %mul4.i1967)
...
if.end279:                                        ; preds = %if.end259
  ...
  %sqrt2240 = tail call float @llvm.sqrt.f32(float %116)
  %cmp285 = fcmp ogt float %sqrt2240, 0.000000e+00
  br i1 %cmp285, label %if.then286, label %if.end311

if.then286:                                       ; preds = %if.end279
  %div287 = fdiv float %sub276, %sqrt2240
...
if.end331:                                        ; preds = %if.end311
  ...
  %sqrt2241 = tail call float @llvm.sqrt.f32(float %129)
  %cmp337 = fcmp ogt float %sqrt2241, 0.000000e+00
  br i1 %cmp337, label %if.then338, label %if.end363

if.then338:                                       ; preds = %if.end331
  %div339 = fdiv float %sub328, %sqrt2241
...
if.end383:                                        ; preds = %if.end363
  ...
  %sqrt2242 = tail call float @llvm.sqrt.f32(float %142)
  %cmp389 = fcmp ogt float %sqrt2242, 0.000000e+00
  br i1 %cmp389, label %if.then390, label %if.end415

if.then390:                                       ; preds = %if.end383
  %div391 = fdiv float %sub380, %sqrt2242
...
if.then394:                                       ; preds = %if.then390
  %div395 = fdiv float %51, %sqrt2242
  %143 = insertelement <2 x float> <float 0.000000e+00, float poison>, float %fneg385, i64 1
  %144 = insertelement <2 x float> poison, float %sqrt2242, i64 0
...
if.end435:                                        ; preds = %if.end415
  ...
  %sqrt2243 = tail call float @llvm.sqrt.f32(float %153)
  %cmp441 = fcmp ogt float %sqrt2243, 0.000000e+00
  br i1 %cmp441, label %if.then442, label %if.end467

if.then442:                                       ; preds = %if.end435
  %div443 = fdiv float %sub432, %sqrt2243
...
if.then446:                                       ; preds = %if.then442
  %div447 = fdiv float %53, %sqrt2243
  %154 = insertelement <2 x float> <float 0.000000e+00, float poison>, float %fneg437, i64 1
  %155 = insertelement <2 x float> poison, float %sqrt2243, i64 0
...
if.end487:                                        ; preds = %if.end467
  ...
  %sqrt2244 = tail call float @llvm.sqrt.f32(float %164)
  %cmp493 = fcmp ogt float %sqrt2244, 0.000000e+00
  br i1 %cmp493, label %if.then494, label %if.end519

if.then494:                                       ; preds = %if.end487
  %div495 = fdiv float %sub484, %sqrt2244
...
if.then498:                                       ; preds = %if.then494
  %div499 = fdiv float %55, %sqrt2244
  %165 = insertelement <2 x float> <float 0.000000e+00, float poison>, float %fneg489, i64 1
  %166 = insertelement <2 x float> poison, float %sqrt2244, i64 0
...
if.end539:                                        ; preds = %if.end519
  ...
  %sqrt2245 = tail call float @llvm.sqrt.f32(float %176)
  %cmp546 = fcmp ogt float %sqrt2245, 0.000000e+00
  br i1 %cmp546, label %if.then547, label %if.end572

if.then547:                                       ; preds = %if.end539
  %div548 = fdiv float %sub536, %sqrt2245
...
if.then551:                                       ; preds = %if.then547
  %div553 = fdiv float %fneg540, %sqrt2245
  %177 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %33, i64 0
  %178 = insertelement <2 x float> poison, float %sqrt2245, i64 0
...
if.end592:                                        ; preds = %if.end572
  ...
  %sqrt2246 = tail call float @llvm.sqrt.f32(float %187)
  %cmp599 = fcmp ogt float %sqrt2246, 0.000000e+00
  br i1 %cmp599, label %if.then600, label %if.end625

if.then600:                                       ; preds = %if.end592
  %div601 = fdiv float %sub589, %sqrt2246
...
if.then604:                                       ; preds = %if.then600
  %div606 = fdiv float %fneg593, %sqrt2246
  %188 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %38, i64 0
  %189 = insertelement <2 x float> poison, float %sqrt2246, i64 0
...
if.end645:                                        ; preds = %if.end625
  ...
  %sqrt2247 = tail call float @llvm.sqrt.f32(float %198)
  %cmp652 = fcmp ogt float %sqrt2247, 0.000000e+00
  br i1 %cmp652, label %if.then653, label %if.end678

if.then653:                                       ; preds = %if.end645
  %div654 = fdiv float %sub642, %sqrt2247
...
if.end680.thread:                                 ; preds = %if.then653
  %div659 = fdiv float %fneg646, %sqrt2247
  %199 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %43, i64 0
  %200 = insertelement <2 x float> poison, float %sqrt2247, i64 0
...
if.then682:                                       ; preds = %if.end680
  ...
  %204 = load float, ptr %arrayidx686, align 4
  %arrayidx688 = getelementptr inbounds float, ptr %normal, i64 1
  store float %204, ptr %arrayidx688, align 4
  %arrayidx689 = getelementptr inbounds float, ptr %normalR.13, i64 8
  %205 = load float, ptr %arrayidx689, align 4
  br label %if.end706

if.else:                                          ; preds = %if.end680.thread, %if.end680
  %normalC.sroa.0.821982221 = phi float [ %div659, %if.end680.thread ], [ %normalC.sroa.0.7, %if.end680 ]
  %code.1422012218 = phi i32 [ 15, %if.end680.thread ], [ %code.13, %if.end680 ]
  %invert_normal.1422022216 = phi i32 [ %conv676, %if.end680.thread ], [ %invert_normal.13, %if.end680 ]
  %s.1422032214 = phi float [ %div654, %if.end680.thread ], [ %s.13, %if.end680 ]
  ...
  %mul4.i1985 = fmul float %209, %208
  %210 = tail call float @llvm.fmuladd.f32(float %207, float %normalC.sroa.0.821982221, float %mul4.i1985)
  ...
  %215 = load float, ptr %arrayidx2.i1890, align 4
  %mul4.i1990 = fmul float %209, %215
  %216 = tail call float @llvm.fmuladd.f32(float %214, float %normalC.sroa.0.821982221, float %mul4.i1990)
  %217 = load float, ptr %arrayidx2.i1895, align 4
  ...
  store float %218, ptr %arrayidx700, align 4
  %219 = load float, ptr %arrayidx5.i1889, align 4
  %220 = load float, ptr %arrayidx5.i1893, align 4
  %mul4.i1995 = fmul float %209, %220
  %221 = tail call float @llvm.fmuladd.f32(float %219, float %normalC.sroa.0.821982221, float %mul4.i1995)
  %222 = load float, ptr %arrayidx5.i1898, align 4
...
if.end706:                                        ; preds = %if.else, %if.then682
  ...
  %code.1422012217 = phi i32 [ %code.1422012218, %if.else ], [ %code.13, %if.then682 ]
  %invert_normal.1422022215 = phi i32 [ %invert_normal.1422022216, %if.else ], [ %invert_normal.13, %if.then682 ]
  %s.1422032213 = phi float [ %s.1422032214, %if.else ], [ %s.13, %if.then682 ]
  %arrayidx705 = getelementptr inbounds float, ptr %normal, i64 2
  store float %.sink, ptr %arrayidx705, align 4
  %tobool707.not = icmp eq i32 %invert_normal.1422022215, 0
  br i1 %tobool707.not, label %if.end724, label %if.then708

if.then708:                                       ; preds = %if.end706
  %fneg711 = fneg float %225
  store float %fneg711, ptr %normal, align 4
  %arrayidx715 = getelementptr inbounds float, ptr %normal, i64 1
  %fneg716 = fneg float %224
  store float %fneg716, ptr %arrayidx715, align 4
  %arrayidx720 = getelementptr inbounds float, ptr %normal, i64 2
  %fneg721 = fneg float %.sink
  store float %fneg721, ptr %arrayidx720, align 4
  br label %if.end724

if.end724:                                        ; preds = %if.then708, %if.end706
  %fneg725 = fneg float %s.1422032213
  store float %fneg725, ptr %depth, align 4
  %cmp726 = icmp ugt i32 %code.1422012217, 6
...
if.then727:                                       ; preds = %if.end724
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(12) %pa, ptr noundef nonnull align 4 dereferenceable(12) %p1, i64 12, i1 false)
  %226 = load float, ptr %normal, align 4
  %arrayidx2.i1998 = getelementptr inbounds float, ptr %normal, i64 1
  %227 = load float, ptr %arrayidx2.i1998, align 4
  %arrayidx5.i2001 = getelementptr inbounds float, ptr %normal, i64 2
  %228 = load float, ptr %arrayidx5.i2001, align 4
  %229 = load float, ptr %R1, align 4
  %230 = load float, ptr %arrayidx2.i, align 4
  %mul4.i2000 = fmul float %227, %230
  %231 = tail call float @llvm.fmuladd.f32(float %226, float %229, float %mul4.i2000)
  %232 = load float, ptr %arrayidx5.i1889, align 4
  %233 = tail call float @llvm.fmuladd.f32(float %228, float %232, float %231)
  %cmp740 = fcmp ogt float %233, 0.000000e+00
  %234 = fneg float %66
  %mul746 = select i1 %cmp740, float %66, float %234
  %arrayidx754.2 = getelementptr inbounds float, ptr %pa, i64 2
  %235 = load float, ptr %arrayidx754.2, align 8
  %236 = tail call float @llvm.fmuladd.f32(float %mul746, float %232, float %235)
  %237 = load float, ptr %add.ptr, align 4
  %arrayidx3.i1999.1 = getelementptr inbounds float, ptr %R1, i64 5
  %238 = load float, ptr %arrayidx3.i1999.1, align 4
  %mul4.i2000.1 = fmul float %227, %238
  %239 = tail call float @llvm.fmuladd.f32(float %226, float %237, float %mul4.i2000.1)
  %arrayidx6.i2002.1 = getelementptr inbounds float, ptr %R1, i64 9
  %240 = load float, ptr %arrayidx6.i2002.1, align 4
  %241 = tail call float @llvm.fmuladd.f32(float %228, float %240, float %239)
  %cmp740.1 = fcmp ogt float %241, 0.000000e+00
  %242 = fneg float %73
  %mul746.1 = select i1 %cmp740.1, float %73, float %242
  %243 = tail call float @llvm.fmuladd.f32(float %mul746.1, float %240, float %236)
  %244 = load float, ptr %add.ptr12, align 4
  %arrayidx3.i1999.2 = getelementptr inbounds float, ptr %R1, i64 6
  %245 = load float, ptr %arrayidx3.i1999.2, align 4
  %arrayidx6.i2002.2 = getelementptr inbounds float, ptr %R1, i64 10
  %246 = load float, ptr %arrayidx6.i2002.2, align 4
  %247 = fneg float %mul26
  %248 = load <2 x float>, ptr %pa, align 8
  %249 = insertelement <2 x float> poison, float %mul746, i64 0
  %250 = shufflevector <2 x float> %249, <2 x float> poison, <2 x i32> zeroinitializer
  %251 = insertelement <2 x float> poison, float %229, i64 0
  %252 = insertelement <2 x float> %251, float %230, i64 1
  %253 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %250, <2 x float> %252, <2 x float> %248)
  %254 = insertelement <2 x float> poison, float %mul746.1, i64 0
  %255 = shufflevector <2 x float> %254, <2 x float> poison, <2 x i32> zeroinitializer
  %256 = insertelement <2 x float> poison, float %237, i64 0
  %257 = insertelement <2 x float> %256, float %238, i64 1
  %258 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %255, <2 x float> %257, <2 x float> %253)
  %259 = insertelement <2 x float> poison, float %244, i64 0
  %260 = insertelement <2 x float> %259, float %245, i64 1
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %pb) #13
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(12) %pb, ptr noundef nonnull align 4 dereferenceable(12) %p2, i64 12, i1 false)
  %261 = load float, ptr %R2, align 4
  %262 = load float, ptr %arrayidx6.i1904, align 4
  %263 = fneg float %67
  %arrayidx795.2 = getelementptr inbounds float, ptr %pb, i64 2
  %264 = load float, ptr %arrayidx795.2, align 8
  %265 = load <2 x float>, ptr %arrayidx3.i1901, align 4
  %arrayidx6.i2007.1 = getelementptr inbounds float, ptr %R2, i64 9
  %266 = fneg float %69
  %267 = load <2 x float>, ptr %add.ptr44, align 4
  %arrayidx3.i2004.2 = getelementptr inbounds float, ptr %R2, i64 6
  %268 = load float, ptr %arrayidx3.i2004.2, align 4
  %269 = load <2 x float>, ptr %arrayidx6.i2007.1, align 4
  ...
  %272 = shufflevector <2 x float> %265, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %273 = insertelement <4 x float> %272, float %268, i64 2
  %274 = insertelement <4 x float> %273, float %245, i64 3
  ...
  %278 = insertelement <4 x float> poison, float %261, i64 0
  %279 = shufflevector <2 x float> %267, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %280 = shufflevector <4 x float> %278, <4 x float> %279, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %281 = insertelement <4 x float> %280, float %244, i64 3
  ...
  %286 = shufflevector <2 x float> %269, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %287 = shufflevector <4 x float> %285, <4 x float> %286, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %288 = insertelement <4 x float> %287, float %246, i64 3
  ...
  %mul746.2 = select i1 %291, float %mul26, float %247
  ...
  %294 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %293, <2 x float> %260, <2 x float> %258)
  store <2 x float> %294, ptr %pa, align 8
  %295 = tail call float @llvm.fmuladd.f32(float %mul746.2, float %246, float %243)
  store float %295, ptr %arrayidx754.2, align 8
  %296 = extractelement <4 x i1> %290, i64 0
  %mul787 = select i1 %296, float %263, float %67
  %297 = tail call float @llvm.fmuladd.f32(float %mul787, float %262, float %264)
  %298 = extractelement <4 x i1> %290, i64 1
  %mul787.1 = select i1 %298, float %266, float %69
  %299 = extractelement <2 x float> %269, i64 0
  %300 = tail call float @llvm.fmuladd.f32(float %mul787.1, float %299, float %297)
  %301 = load float, ptr %arrayidx39, align 8
  %302 = fneg float %301
  %303 = extractelement <4 x i1> %290, i64 2
  %mul787.2 = select i1 %303, float %302, float %301
  %304 = extractelement <2 x float> %269, i64 1
  %305 = tail call float @llvm.fmuladd.f32(float %mul787.2, float %304, float %300)
  store float %305, ptr %arrayidx795.2, align 8
  ...
  %sub805 = add nsw i32 %code.1422012217, -7
  %div806.lhs.trunc = trunc i32 %sub805 to i8
  %div8062367 = udiv i8 %div806.lhs.trunc, 3
  %306 = zext i8 %div8062367 to i64
  %arrayidx810 = getelementptr inbounds float, ptr %R1, i64 %306
  %307 = load float, ptr %arrayidx810, align 4
  store float %307, ptr %ua, align 4
  %308 = add nuw nsw i64 %306, 4
  %arrayidx810.1 = getelementptr inbounds float, ptr %R1, i64 %308
  %309 = load float, ptr %arrayidx810.1, align 4
  %arrayidx813.1 = getelementptr inbounds float, ptr %ua, i64 1
  store float %309, ptr %arrayidx813.1, align 4
  %310 = add nuw nsw i64 %306, 8
  %arrayidx810.2 = getelementptr inbounds float, ptr %R1, i64 %310
  %311 = load float, ptr %arrayidx810.2, align 4
  %arrayidx813.2 = getelementptr inbounds float, ptr %ua, i64 2
  store float %311, ptr %arrayidx813.2, align 4
  %rem.lhs.trunc = trunc i32 %sub805 to i8
  %rem2368 = urem i8 %rem.lhs.trunc, 3
  %rem.zext = zext i8 %rem2368 to i32
  %idxprom823 = zext i8 %rem2368 to i64
  %arrayidx824 = getelementptr inbounds float, ptr %R2, i64 %idxprom823
  %312 = load float, ptr %arrayidx824, align 4
  store float %312, ptr %ub, align 4
  ...
  %313 = load float, ptr %arrayidx824.1, align 4
  %arrayidx827.1 = getelementptr inbounds float, ptr %ub, i64 1
  store float %313, ptr %arrayidx827.1, align 4
  ...
  %314 = load float, ptr %arrayidx824.2, align 4
  %arrayidx827.2 = getelementptr inbounds float, ptr %ub, i64 2
  store float %314, ptr %arrayidx827.2, align 4
  %315 = load <2 x float>, ptr %pb, align 8
  %316 = insertelement <2 x float> poison, float %mul787, i64 0
  %317 = shufflevector <2 x float> %316, <2 x float> poison, <2 x i32> zeroinitializer
  %318 = insertelement <2 x float> poison, float %261, i64 0
  %319 = shufflevector <2 x float> %318, <2 x float> %265, <2 x i32> <i32 0, i32 2>
  %320 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %317, <2 x float> %319, <2 x float> %315)
  %321 = insertelement <2 x float> poison, float %mul787.1, i64 0
  %322 = shufflevector <2 x float> %321, <2 x float> poison, <2 x i32> zeroinitializer
  %323 = shufflevector <2 x float> %267, <2 x float> %265, <2 x i32> <i32 0, i32 3>
  %324 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %322, <2 x float> %323, <2 x float> %320)
  %325 = insertelement <2 x float> poison, float %mul787.2, i64 0
  %326 = shufflevector <2 x float> %325, <2 x float> poison, <2 x i32> zeroinitializer
  %327 = shufflevector <2 x float> %267, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %328 = insertelement <2 x float> %327, float %268, i64 1
  %329 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %326, <2 x float> %328, <2 x float> %324)
  store <2 x float> %329, ptr %pb, align 8
  ...
  %330 = load float, ptr %beta, align 4
  %331 = insertelement <2 x float> poison, float %312, i64 0
  %332 = insertelement <2 x float> %331, float %313, i64 1
  ...
  %335 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %332, <2 x float> %334, <2 x float> %329)
  store <2 x float> %335, ptr %pb, align 8
  %336 = tail call float @llvm.fmuladd.f32(float %314, float %330, float %305)
  store float %336, ptr %arrayidx795.2, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp857) #13
  %337 = load <2 x float>, ptr %normal, align 4
  %338 = fneg <2 x float> %337
  %339 = load float, ptr %arrayidx5.i2001, align 4
  %fneg8.i = fneg float %339
  %retval.sroa.3.12.vec.insert.i2012 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %fneg8.i, i64 0
  store <2 x float> %338, ptr %ref.tmp857, align 8
  %340 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp857, i64 0, i32 1
  store <2 x float> %retval.sroa.3.12.vec.insert.i2012, ptr %340, align 8
  %vtable = load ptr, ptr %output, align 8
  %vfn = getelementptr inbounds ptr, ptr %vtable, i64 4
  %341 = load ptr, ptr %vfn, align 8
  call void %341(ptr noundef nonnull align 8 dereferenceable(8) %output, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp857, ptr noundef nonnull align 4 dereferenceable(16) %pb, float noundef %s.1422032213)
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp857) #13
  store i32 %code.1422012217, ptr %return_code, align 4
...
if.end861:                                        ; preds = %if.end724
  %cmp864 = icmp ult i32 %code.1422012217, 4
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %nr) #13
  %342 = load float, ptr %normal, align 4
  br i1 %cmp864, label %if.then876, label %if.else889

if.then876:                                       ; preds = %if.end861
  %arrayidx882 = getelementptr inbounds float, ptr %normal, i64 1
  %343 = load <2 x float>, ptr %arrayidx882, align 4
  br label %if.end905

if.else889:                                       ; preds = %if.end861
...
if.end905:                                        ; preds = %if.else889, %if.then876
  %Sb.02238 = phi ptr [ %B, %if.then876 ], [ %A, %if.else889 ]
  %Sa.02236 = phi ptr [ %A, %if.then876 ], [ %B, %if.else889 ]
  %pb863.02234 = phi ptr [ %p2, %if.then876 ], [ %p1, %if.else889 ]
  %pa862.02232 = phi ptr [ %p1, %if.then876 ], [ %p2, %if.else889 ]
  %Rb.02230 = phi ptr [ %R2, %if.then876 ], [ %R1, %if.else889 ]
  %Ra.02228 = phi ptr [ %R1, %if.then876 ], [ %R2, %if.else889 ]
  %normal2.sroa.0.0 = phi float [ %342, %if.then876 ], [ %fneg892, %if.else889 ]
  %346 = phi <2 x float> [ %343, %if.then876 ], [ %345, %if.else889 ]
  %arrayidx2.i2015 = getelementptr inbounds float, ptr %Rb.02230, i64 4
  %arrayidx5.i2018 = getelementptr inbounds float, ptr %Rb.02230, i64 8
  %347 = load <2 x float>, ptr %Rb.02230, align 4
  %348 = load <2 x float>, ptr %arrayidx2.i2015, align 4
  ...
  %354 = load <2 x float>, ptr %arrayidx5.i2018, align 4
  ...
  store <2 x float> %356, ptr %nr, align 8
  %add.ptr915 = getelementptr inbounds float, ptr %Rb.02230, i64 2
  %357 = load float, ptr %add.ptr915, align 4
  %arrayidx2.i2025 = getelementptr inbounds float, ptr %Rb.02230, i64 6
  %358 = load float, ptr %arrayidx2.i2025, align 4
  %359 = extractelement <2 x float> %346, i64 0
  %mul4.i2027 = fmul float %359, %358
  %360 = tail call float @llvm.fmuladd.f32(float %357, float %normal2.sroa.0.0, float %mul4.i2027)
  %arrayidx5.i2028 = getelementptr inbounds float, ptr %Rb.02230, i64 10
  %361 = load float, ptr %arrayidx5.i2028, align 4
  ...
  store float %363, ptr %arrayidx919, align 8
...
if.then940:                                       ; preds = %if.end905
  %cmp945 = fcmp ogt float %367, %365
  %. = select i1 %cmp945, i32 1, i32 2
  %.1882 = select i1 %cmp945, i32 2, i32 1
  br label %if.end958

if.else949:                                       ; preds = %if.end905
  %cmp954 = fcmp ogt float %366, %365
  %.1883 = select i1 %cmp954, i32 0, i32 2
  %.1885 = select i1 %cmp954, i32 2, i32 1
  %368 = zext i1 %cmp954 to i64
  br label %if.end958

if.end958:                                        ; preds = %if.else949, %if.then940
  %lanr.0 = phi i32 [ %., %if.then940 ], [ %.1883, %if.else949 ]
  %a1.0 = phi i64 [ 0, %if.then940 ], [ %368, %if.else949 ]
  %a2.0 = phi i32 [ %.1882, %if.then940 ], [ %.1885, %if.else949 ]
  %idxprom960 = zext i32 %lanr.0 to i64
  %arrayidx961 = getelementptr inbounds float, ptr %nr, i64 %idxprom960
  %369 = load float, ptr %arrayidx961, align 4
  %cmp962 = fcmp olt float %369, 0.000000e+00
  %arrayidx973 = getelementptr inbounds float, ptr %Sb.02238, i64 %idxprom960
  %370 = load float, ptr %arrayidx973, align 4
  %neg1001 = fneg float %370
  %neg1001.sink2380 = select i1 %cmp962, float %370, float %neg1001
  %371 = zext i32 %lanr.0 to i64
  %arrayidx999 = getelementptr inbounds float, ptr %Rb.02230, i64 %371
  %372 = load float, ptr %arrayidx999, align 4
  %373 = load <2 x float>, ptr %pb863.02234, align 4
  %374 = load <2 x float>, ptr %pa862.02232, align 4
  %375 = fsub <2 x float> %373, %374
  %376 = or i64 %371, 4
  %arrayidx999.1 = getelementptr inbounds float, ptr %Rb.02230, i64 %376
  %377 = load float, ptr %arrayidx999.1, align 4
  %378 = insertelement <2 x float> poison, float %neg1001.sink2380, i64 0
  ...
  %382 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %379, <2 x float> %381, <2 x float> %375)
  %arrayidx990.2 = getelementptr inbounds float, ptr %pb863.02234, i64 2
  %383 = load float, ptr %arrayidx990.2, align 4
  %arrayidx992.2 = getelementptr inbounds float, ptr %pa862.02232, i64 2
  %384 = load float, ptr %arrayidx992.2, align 4
  %sub993.2 = fsub float %383, %384
  %385 = or i64 %371, 8
  %arrayidx999.2 = getelementptr inbounds float, ptr %Rb.02230, i64 %385
  %386 = load float, ptr %arrayidx999.2, align 4
  %387 = tail call float @llvm.fmuladd.f32(float %neg1001.sink2380, float %386, float %sub993.2)
  %codeN.0.v = select i1 %cmp864, i32 -1, i32 -4
  %codeN.0 = add nsw i32 %codeN.0.v, %code.1422012217
...
if.end1022:                                       ; preds = %if.end958, %if.then1019, %if.else1020
  ...
  %add.ptr1025 = getelementptr inbounds float, ptr %Ra.02228, i64 %code1.0
  %388 = load float, ptr %add.ptr1025, align 4
  %arrayidx3.i2031 = getelementptr inbounds float, ptr %add.ptr1025, i64 4
  %389 = load float, ptr %arrayidx3.i2031, align 4
  %arrayidx6.i2034 = getelementptr inbounds float, ptr %add.ptr1025, i64 8
  %390 = load float, ptr %arrayidx6.i2034, align 4
  %add.ptr1029 = getelementptr inbounds float, ptr %Ra.02228, i64 %code2.0
  %391 = load float, ptr %add.ptr1029, align 4
  %arrayidx3.i2036 = getelementptr inbounds float, ptr %add.ptr1029, i64 4
  %392 = load float, ptr %arrayidx3.i2036, align 4
  %arrayidx6.i2039 = getelementptr inbounds float, ptr %add.ptr1029, i64 8
  %393 = load float, ptr %arrayidx6.i2039, align 4
  %add.ptr1034 = getelementptr inbounds float, ptr %Rb.02230, i64 %a1.0
  %394 = load float, ptr %add.ptr1034, align 4
  %arrayidx3.i2041 = getelementptr inbounds float, ptr %add.ptr1034, i64 4
  %395 = load float, ptr %arrayidx3.i2041, align 4
  %arrayidx6.i2044 = getelementptr inbounds float, ptr %add.ptr1034, i64 8
  %396 = load float, ptr %arrayidx6.i2044, align 4
  %idx.ext1038 = zext i32 %a2.0 to i64
  %add.ptr1039 = getelementptr inbounds float, ptr %Rb.02230, i64 %idx.ext1038
  %397 = load float, ptr %add.ptr1039, align 4
  %arrayidx3.i2046 = getelementptr inbounds float, ptr %add.ptr1039, i64 4
  %398 = load float, ptr %arrayidx3.i2046, align 4
  %arrayidx6.i2049 = getelementptr inbounds float, ptr %add.ptr1039, i64 8
  %399 = load float, ptr %arrayidx6.i2049, align 4
  %arrayidx1052 = getelementptr inbounds float, ptr %Sb.02238, i64 %a1.0
  %400 = load float, ptr %arrayidx1052, align 4
  %arrayidx1058 = getelementptr inbounds float, ptr %Sb.02238, i64 %idx.ext1038
  %401 = load float, ptr %arrayidx1058, align 4
  %402 = shufflevector <2 x float> %382, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %403 = insertelement <2 x float> poison, float %389, i64 0
  %404 = insertelement <2 x float> %403, float %392, i64 1
  %405 = fmul <2 x float> %402, %404
  %406 = shufflevector <2 x float> %382, <2 x float> poison, <2 x i32> zeroinitializer
  %407 = insertelement <2 x float> poison, float %388, i64 0
  %408 = insertelement <2 x float> %407, float %391, i64 1
  ...
  %412 = insertelement <2 x float> poison, float %390, i64 0
  %413 = insertelement <2 x float> %412, float %393, i64 1
  %414 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %411, <2 x float> %413, <2 x float> %409)
  %415 = insertelement <2 x float> poison, float %395, i64 0
  %416 = shufflevector <2 x float> %415, <2 x float> poison, <2 x i32> zeroinitializer
  %417 = fmul <2 x float> %404, %416
  %418 = insertelement <2 x float> poison, float %394, i64 0
  %419 = shufflevector <2 x float> %418, <2 x float> poison, <2 x i32> zeroinitializer
  %420 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %408, <2 x float> %419, <2 x float> %417)
  ...
  %426 = fmul <2 x float> %404, %425
  %427 = insertelement <2 x float> poison, float %397, i64 0
  %428 = shufflevector <2 x float> %427, <2 x float> poison, <2 x i32> zeroinitializer
  %429 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %408, <2 x float> %428, <2 x float> %426)
  %430 = insertelement <2 x float> poison, float %399, i64 0
  ...
  %433 = insertelement <2 x float> poison, float %400, i64 0
  %434 = shufflevector <2 x float> %433, <2 x float> poison, <2 x i32> zeroinitializer
  %435 = fmul <2 x float> %423, %434
  %436 = insertelement <2 x float> poison, float %401, i64 0
  ...
  store <4 x float> %444, ptr %quad, align 16
  ...
  store <4 x float> %449, ptr %arrayidx1077, align 16
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %rect) #13
  %arrayidx1088 = getelementptr inbounds float, ptr %Sa.02236, i64 %code1.0
  %450 = load float, ptr %arrayidx1088, align 4
  store float %450, ptr %rect, align 4
  %arrayidx1091 = getelementptr inbounds float, ptr %Sa.02236, i64 %code2.0
  %451 = load float, ptr %arrayidx1091, align 4
  %arrayidx1092 = getelementptr inbounds [2 x float], ptr %rect, i64 0, i64 1
  store float %451, ptr %arrayidx1092, align 4
  ...
  br i1 %cmp1097, label %cleanup1291, label %if.end1099

if.end1099:                                       ; preds = %if.end1022
  ...
  %arrayidx1161 = getelementptr inbounds float, ptr %Sa.02236, i64 %idxprom1160
  %460 = load float, ptr %arrayidx1161, align 4
  %461 = zext i32 %a2.0 to i64
  %wide.trip.count = zext i32 %call1096 to i64
  %arrayidx1146.phi.trans.insert = getelementptr inbounds float, ptr %Rb.02230, i64 %a1.0
  %.pre = load float, ptr %arrayidx1146.phi.trans.insert, align 4
  %arrayidx1151.phi.trans.insert = getelementptr inbounds float, ptr %Rb.02230, i64 %461
  %.pre2366 = load float, ptr %arrayidx1151.phi.trans.insert, align 4
  %462 = or i64 %a1.0, 4
  %arrayidx1146.1 = getelementptr inbounds float, ptr %Rb.02230, i64 %462
  %463 = load float, ptr %arrayidx1146.1, align 4
  %464 = or i64 %461, 4
  %arrayidx1151.1 = getelementptr inbounds float, ptr %Rb.02230, i64 %464
  %465 = load float, ptr %arrayidx1151.1, align 4
  %466 = or i64 %a1.0, 8
  %arrayidx1146.2 = getelementptr inbounds float, ptr %Rb.02230, i64 %466
  %467 = load float, ptr %arrayidx1146.2, align 4
  %468 = or i64 %461, 8
  %arrayidx1151.2 = getelementptr inbounds float, ptr %Rb.02230, i64 %468
  %469 = load float, ptr %arrayidx1151.2, align 4
  %470 = insertelement <2 x float> poison, float %.pre2366, i64 0
  %471 = insertelement <2 x float> %470, float %465, i64 1
  %472 = insertelement <2 x float> poison, float %.pre, i64 0
  %473 = insertelement <2 x float> %472, float %463, i64 1
  br label %for.body1110

for.body1110:                                     ; preds = %if.end1099, %if.end1190
  %indvars.iv = phi i64 [ 0, %if.end1099 ], [ %indvars.iv.next, %if.end1190 ]
  %cnum.02253 = phi i32 [ 0, %if.end1099 ], [ %cnum.1, %if.end1190 ]
  %474 = shl nuw nsw i64 %indvars.iv, 1
  %arrayidx1114 = getelementptr inbounds [16 x float], ptr %ret, i64 0, i64 %474
  %475 = load <2 x float>, ptr %arrayidx1114, align 8
  ...
  %mul1153 = mul nsw i32 %cnum.02253, 3
  ...
  store <2 x float> %486, ptr %arrayidx1156, align 4
  ...
  store float %488, ptr %arrayidx1156.2, align 4
  %490 = load float, ptr %arrayidx1156, align 4
  %arrayidx3.i2061 = getelementptr inbounds float, ptr %arrayidx1156, i64 1
  %491 = load float, ptr %arrayidx3.i2061, align 4
  %mul4.i2062 = fmul float %359, %491
  %492 = tail call float @llvm.fmuladd.f32(float %normal2.sroa.0.0, float %490, float %mul4.i2062)
  %arrayidx6.i2064 = getelementptr inbounds float, ptr %arrayidx1156, i64 2
  %493 = load float, ptr %arrayidx6.i2064, align 4
  %494 = tail call float @llvm.fmuladd.f32(float %362, float %493, float %492)
  %sub1168 = fsub float %460, %494
  %idxprom1169 = sext i32 %cnum.02253 to i64
  %arrayidx1170 = getelementptr inbounds [8 x float], ptr %dep, i64 0, i64 %idxprom1169
  store float %sub1168, ptr %arrayidx1170, align 4
...
if.then1174:                                      ; preds = %for.body1110
  %mul1178 = shl nsw i32 %cnum.02253, 1
  %idxprom1179 = sext i32 %mul1178 to i64
  %arrayidx1180 = getelementptr inbounds [16 x float], ptr %ret, i64 0, i64 %idxprom1179
  store <2 x float> %475, ptr %arrayidx1180, align 8
  %inc1189 = add nsw i32 %cnum.02253, 1
  br label %if.end1190

if.end1190:                                       ; preds = %if.then1174, %for.body1110
  %cnum.1 = phi i32 [ %inc1189, %if.then1174 ], [ %cnum.02253, %for.body1110 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
...
for.body1207.lr.ph:                               ; preds = %if.end1196
  %arrayidx7.i2068 = getelementptr inbounds [4 x float], ptr %normal, i64 0, i64 2
  %495 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp1225, i64 0, i32 1
  %wide.trip.count2297 = zext i32 %cnum.1 to i64
  %arrayidx1217.2 = getelementptr inbounds float, ptr %pa862.02232, i64 2
...
for.body1207:                                     ; preds = %for.body1207.lr.ph, %for.body1207
  %indvars.iv2293 = phi i64 [ 0, %for.body1207.lr.ph ], [ %indvars.iv.next2294, %for.body1207 ]
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %pointInWorld1208) #13
  %496 = mul nuw nsw i64 %indvars.iv2293, 3
  %arrayidx1215 = getelementptr inbounds [24 x float], ptr %point, i64 0, i64 %496
  %497 = load <2 x float>, ptr %arrayidx1215, align 4
  %498 = load <2 x float>, ptr %pa862.02232, align 4
  %499 = fadd <2 x float> %497, %498
  store <2 x float> %499, ptr %pointInWorld1208, align 8
  %500 = add nuw nsw i64 %496, 2
  %arrayidx1215.2 = getelementptr inbounds [24 x float], ptr %point, i64 0, i64 %500
  %501 = load float, ptr %arrayidx1215.2, align 4
  %502 = load float, ptr %arrayidx1217.2, align 4
  %add1218.2 = fadd float %501, %502
  store float %add1218.2, ptr %arrayidx1221.2, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp1225) #13
  %503 = load <2 x float>, ptr %normal, align 4
  %504 = fneg <2 x float> %503
  %505 = load float, ptr %arrayidx7.i2068, align 4
  %fneg8.i2069 = fneg float %505
  %retval.sroa.3.12.vec.insert.i2072 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %fneg8.i2069, i64 0
  store <2 x float> %504, ptr %ref.tmp1225, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i2072, ptr %495, align 8
  %arrayidx1229 = getelementptr inbounds [8 x float], ptr %dep, i64 0, i64 %indvars.iv2293
  %506 = load float, ptr %arrayidx1229, align 4
  %fneg1230 = fneg float %506
  %vtable1231 = load ptr, ptr %output, align 8
  ...
  %exitcond2298.not = icmp eq i64 %indvars.iv.next2294, %wide.trip.count2297
  br i1 %exitcond2298.not, label %if.end1287, label %for.body1207

if.else1236:                                      ; preds = %if.end1196
  %cmp12392257 = icmp ugt i32 %cnum.1, 1
  br i1 %cmp12392257, label %for.body1240.preheader, label %for.end1250

for.body1240.preheader:                           ; preds = %if.else1236
  %508 = load float, ptr %dep, align 16
  %wide.trip.count2302 = zext i32 %cnum.1 to i64
  %509 = add nsw i64 %wide.trip.count2302, -1
...
for.body1240:                                     ; preds = %for.body1240, %for.body1240.preheader.new
  %indvars.iv2299 = phi i64 [ 1, %for.body1240.preheader.new ], [ %indvars.iv.next2300.1, %for.body1240 ]
  %maxdepth.02260 = phi float [ %508, %for.body1240.preheader.new ], [ %maxdepth.1.1, %for.body1240 ]
  %i1.02259 = phi i32 [ 0, %for.body1240.preheader.new ], [ %i1.1.1, %for.body1240 ]
  %niter = phi i64 [ 0, %for.body1240.preheader.new ], [ %niter.next.1, %for.body1240 ]
  %arrayidx1242 = getelementptr inbounds [8 x float], ptr %dep, i64 0, i64 %indvars.iv2299
  %511 = load float, ptr %arrayidx1242, align 4
  %cmp1243 = fcmp ogt float %511, %maxdepth.02260
  %512 = trunc i64 %indvars.iv2299 to i32
  %i1.1 = select i1 %cmp1243, i32 %512, i32 %i1.02259
  %maxdepth.1 = select i1 %cmp1243, float %511, float %maxdepth.02260
  %indvars.iv.next2300 = add nuw nsw i64 %indvars.iv2299, 1
  %arrayidx1242.1 = getelementptr inbounds [8 x float], ptr %dep, i64 0, i64 %indvars.iv.next2300
  %513 = load float, ptr %arrayidx1242.1, align 4
  %cmp1243.1 = fcmp ogt float %513, %maxdepth.1
  %514 = trunc i64 %indvars.iv.next2300 to i32
  %i1.1.1 = select i1 %cmp1243.1, i32 %514, i32 %i1.1
  %maxdepth.1.1 = select i1 %cmp1243.1, float %513, float %maxdepth.1
  %indvars.iv.next2300.1 = add nuw nsw i64 %indvars.iv2299, 2
...
for.end1250.loopexit.unr-lcssa:                   ; preds = %for.body1240, %for.body1240.preheader
  ...
  %indvars.iv2299.unr = phi i64 [ 1, %for.body1240.preheader ], [ %indvars.iv.next2300.1, %for.body1240 ]
  %maxdepth.02260.unr = phi float [ %508, %for.body1240.preheader ], [ %maxdepth.1.1, %for.body1240 ]
  %i1.02259.unr = phi i32 [ 0, %for.body1240.preheader ], [ %i1.1.1, %for.body1240 ]
...
for.body1240.epil:                                ; preds = %for.end1250.loopexit.unr-lcssa
  %arrayidx1242.epil = getelementptr inbounds [8 x float], ptr %dep, i64 0, i64 %indvars.iv2299.unr
  %515 = load float, ptr %arrayidx1242.epil, align 4
  %cmp1243.epil = fcmp ogt float %515, %maxdepth.02260.unr
  %516 = trunc i64 %indvars.iv2299.unr to i32
  %i1.1.epil = select i1 %cmp1243.epil, i32 %516, i32 %i1.02259.unr
...
for.end1250:                                      ; preds = %for.body1240.epil, %for.end1250.loopexit.unr-lcssa, %if.else1236
  ...
  %arrayidx7.i2078 = getelementptr inbounds [4 x float], ptr %normal, i64 0, i64 2
  %517 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp1274, i64 0, i32 1
  %wide.trip.count2312 = zext i32 %spec.store.select to i64
  %arrayidx1266.2 = getelementptr inbounds float, ptr %pa862.02232, i64 2
...
for.body1255:                                     ; preds = %for.end1250, %for.body1255
  %indvars.iv2309 = phi i64 [ 0, %for.end1250 ], [ %indvars.iv.next2310, %for.body1255 ]
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %posInWorld) #13
  %arrayidx1260 = getelementptr inbounds [8 x i32], ptr %iret, i64 0, i64 %indvars.iv2309
  %518 = load i32, ptr %arrayidx1260, align 4
  ...
  %520 = load <2 x float>, ptr %arrayidx1264, align 4
  %521 = load <2 x float>, ptr %pa862.02232, align 4
  %522 = fadd <2 x float> %520, %521
  store <2 x float> %522, ptr %posInWorld, align 8
  %523 = add nsw i64 %519, 2
  %arrayidx1264.2 = getelementptr inbounds [24 x float], ptr %point, i64 0, i64 %523
  %524 = load float, ptr %arrayidx1264.2, align 4
  %525 = load float, ptr %arrayidx1266.2, align 4
  %add1267.2 = fadd float %524, %525
  store float %add1267.2, ptr %arrayidx1270.2, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp1274) #13
  %526 = load <2 x float>, ptr %normal, align 4
  %527 = fneg <2 x float> %526
  %528 = load float, ptr %arrayidx7.i2078, align 4
  %fneg8.i2079 = fneg float %528
  %retval.sroa.3.12.vec.insert.i2082 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %fneg8.i2079, i64 0
  store <2 x float> %527, ptr %ref.tmp1274, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i2082, ptr %517, align 8
  %idxprom1279 = sext i32 %518 to i64
  %arrayidx1280 = getelementptr inbounds [8 x float], ptr %dep, i64 0, i64 %idxprom1279
  %529 = load float, ptr %arrayidx1280, align 4
  %fneg1281 = fneg float %529
  %vtable1282 = load ptr, ptr %output, align 8
  ...
  br i1 %exitcond2313.not, label %for.end1286, label %for.body1255
...
if.then.if.end17_crit_edge:                       ; preds = %for.body8.lr.ph
  ...
  store float %2, ptr %arrayidx15, align 4
  %add.ptr = getelementptr inbounds float, ptr %ret, i64 2
  %.pre = load float, ptr %p, align 4
  %.pre335 = load float, ptr %h, align 4
...
if.end17:                                         ; preds = %if.then.if.end17_crit_edge, %for.body8.lr.ph
  ...
  %5 = load float, ptr %add.ptr19, align 4
  %mul31 = fneg float %5
...
if.then37.for.inc_crit_edge:                      ; preds = %if.end17
  ...
  store float %9, ptr %arrayidx61, align 4
  %10 = load float, ptr %h, align 4
  %mul65 = fneg float %10
  store float %mul65, ptr %pr.1, align 4
  %inc69 = add nuw nsw i32 %nr.3, 1
  %add.ptr68 = getelementptr inbounds float, ptr %pr.1, i64 2
  %.pre336 = load float, ptr %add.ptr19, align 4
  %.pre337 = load float, ptr %h, align 4
...
for.inc:                                          ; preds = %if.then37.for.inc_crit_edge, %if.end17
  ...
  %nr.5.ph = phi i32 [ %inc69, %if.then37.for.inc_crit_edge ], [ %nr.3, %if.end17 ]
  %pr.3.ph = phi ptr [ %add.ptr68, %if.then37.for.inc_crit_edge ], [ %pr.1, %if.end17 ]
...
if.then.1305.if.end17.1316_crit_edge:             ; preds = %for.inc
  store float %12, ptr %pr.3.ph, align 4
  %arrayidx14.1299 = getelementptr inbounds float, ptr %p, i64 3
  %13 = load float, ptr %arrayidx14.1299, align 4
  %arrayidx15.1300 = getelementptr inbounds float, ptr %pr.3.ph, i64 1
  store float %13, ptr %arrayidx15.1300, align 4
  %inc.1302 = add nuw nsw i32 %nr.5.ph, 1
  %add.ptr.1301 = getelementptr inbounds float, ptr %pr.3.ph, i64 2
  %.pre338 = load float, ptr %add.ptr19, align 4
  %.pre339 = load float, ptr %h, align 4
...
if.end17.1316:                                    ; preds = %if.then.1305.if.end17.1316_crit_edge, %for.inc
  ...
  %nr.3.1306 = phi i32 [ %inc.1302, %if.then.1305.if.end17.1316_crit_edge ], [ %nr.5.ph, %for.inc ]
  %pr.1.1307 = phi ptr [ %add.ptr.1301, %if.then.1305.if.end17.1316_crit_edge ], [ %pr.3.ph, %for.inc ]
  %add.ptr19.1309 = getelementptr inbounds float, ptr %p, i64 4
  %cmp26.1312 = fcmp olt float %mul23.1311.pre-phi, %14
  %16 = load float, ptr %add.ptr19.1309, align 4
...
if.then37.1329:                                   ; preds = %if.end17.1316
  ...
  %17 = load float, ptr %arrayidx39.1317, align 4
  %arrayidx42.1318 = getelementptr inbounds float, ptr %p, i64 5
  %18 = load float, ptr %arrayidx42.1318, align 4
  ...
  store float %20, ptr %arrayidx61.1323, align 4
  %21 = load float, ptr %h, align 4
  %mul65.1324 = fneg float %21
  store float %mul65.1324, ptr %pr.1.1307, align 4
  %inc69.1326 = add nuw nsw i32 %nr.3.1306, 1
  %add.ptr68.1325 = getelementptr inbounds float, ptr %pr.1.1307, i64 2
  %.pre340 = load float, ptr %add.ptr19.1309, align 4
  %.pre341 = load float, ptr %h, align 4
...
for.inc.1334:                                     ; preds = %if.then37.1329, %if.end17.1316
  ...
  %nr.5.ph.1330 = phi i32 [ %inc69.1326, %if.then37.1329 ], [ %nr.3.1306, %if.end17.1316 ]
  %pr.3.ph.1331 = phi ptr [ %add.ptr68.1325, %if.then37.1329 ], [ %pr.1.1307, %if.end17.1316 ]
  %cmp11.2 = fcmp olt float %mul.2.pre-phi, %22
  br i1 %cmp11.2, label %if.then.2, label %if.end17.2

if.then.2:                                        ; preds = %for.inc.1334
  store float %23, ptr %pr.3.ph.1331, align 4
  %arrayidx14.2 = getelementptr inbounds float, ptr %p, i64 5
  %24 = load float, ptr %arrayidx14.2, align 4
  %arrayidx15.2 = getelementptr inbounds float, ptr %pr.3.ph.1331, i64 1
  store float %24, ptr %arrayidx15.2, align 4
  %inc.2 = add nuw nsw i32 %nr.5.ph.1330, 1
  %add.ptr.2 = getelementptr inbounds float, ptr %pr.3.ph.1331, i64 2
  %.pre342 = load float, ptr %add.ptr19.1309, align 4
  %.pre343 = load float, ptr %h, align 4
...
if.end17.2:                                       ; preds = %if.then.2, %for.inc.1334
  ...
  %nr.3.2 = phi i32 [ %inc.2, %if.then.2 ], [ %nr.5.ph.1330, %for.inc.1334 ]
  %pr.1.2 = phi ptr [ %add.ptr.2, %if.then.2 ], [ %pr.3.ph.1331, %for.inc.1334 ]
  %add.ptr19.2 = getelementptr inbounds float, ptr %p, i64 6
  %cmp26.2 = fcmp olt float %mul23.2.pre-phi, %25
  %27 = load float, ptr %add.ptr19.2, align 4
...
if.then37.2:                                      ; preds = %if.end17.2
  ...
  %28 = load float, ptr %arrayidx39.2, align 4
  %arrayidx42.2 = getelementptr inbounds float, ptr %p, i64 7
  %29 = load float, ptr %arrayidx42.2, align 4
  ...
  store float %31, ptr %arrayidx61.2, align 4
  %32 = load float, ptr %h, align 4
  %mul65.2 = fneg float %32
  store float %mul65.2, ptr %pr.1.2, align 4
  %inc69.2 = add nuw nsw i32 %nr.3.2, 1
  %add.ptr68.2 = getelementptr inbounds float, ptr %pr.1.2, i64 2
  %.pre344 = load float, ptr %add.ptr19.2, align 4
  %.pre345 = load float, ptr %h, align 4
...
for.inc.2:                                        ; preds = %if.then37.2, %if.end17.2
  ...
  %nr.5.ph.2 = phi i32 [ %inc69.2, %if.then37.2 ], [ %nr.3.2, %if.end17.2 ]
  %pr.3.ph.2 = phi ptr [ %add.ptr68.2, %if.then37.2 ], [ %pr.1.2, %if.end17.2 ]
  %cmp11.3 = fcmp olt float %mul.3.pre-phi, %33
  br i1 %cmp11.3, label %if.then.3, label %if.end17.3

if.then.3:                                        ; preds = %for.inc.2
  store float %34, ptr %pr.3.ph.2, align 4
  %arrayidx14.3 = getelementptr inbounds float, ptr %p, i64 7
  %35 = load float, ptr %arrayidx14.3, align 4
  %arrayidx15.3 = getelementptr inbounds float, ptr %pr.3.ph.2, i64 1
  store float %35, ptr %arrayidx15.3, align 4
  %inc.3 = add nuw nsw i32 %nr.5.ph.2, 1
  %add.ptr.3 = getelementptr inbounds float, ptr %pr.3.ph.2, i64 2
  %.pre346 = load float, ptr %add.ptr19.2, align 4
  %.pre347 = load float, ptr %h, align 4
...
if.end17.3:                                       ; preds = %if.then.3, %for.inc.2
  ...
  %nr.3.3 = phi i32 [ %inc.3, %if.then.3 ], [ %nr.5.ph.2, %for.inc.2 ]
  %pr.1.3 = phi ptr [ %add.ptr.3, %if.then.3 ], [ %pr.3.ph.2, %for.inc.2 ]
...
if.then37.3:                                      ; preds = %if.end17.3
  ...
  %39 = load float, ptr %arrayidx39.3, align 4
  %arrayidx42.3 = getelementptr inbounds float, ptr %p, i64 1
  %40 = load float, ptr %arrayidx42.3, align 4
  ...
  store float %42, ptr %arrayidx61.3, align 4
  %43 = load float, ptr %h, align 4
  %mul65.3 = fneg float %43
  store float %mul65.3, ptr %pr.1.3, align 4
...
if.end17.1:                                       ; preds = %if.then.1, %for.body8.1
  ...
  %49 = load float, ptr %cond.1, align 4
...
if.then37.1:                                      ; preds = %if.end17.1
  ...
  %50 = load float, ptr %arrayidx39.1, align 4
  %arrayidx42.1 = getelementptr inbounds float, ptr %cond.1, i64 1
  %51 = load float, ptr %arrayidx42.1, align 4
  ...
  store float %53, ptr %arrayidx61.1, align 4
  %54 = load float, ptr %h, align 4
  store float %54, ptr %pr.1.1, align 4
...
for.inc.1:                                        ; preds = %if.then37.1, %if.end17.1
  %nr.5.ph.1 = phi i32 [ %nr.3.1, %if.end17.1 ], [ %inc69.1, %if.then37.1 ]
  %pr.3.ph.1 = phi ptr [ %pr.1.1, %if.end17.1 ], [ %add.ptr68.1, %if.then37.1 ]
  %cmp6.1 = icmp sgt i32 %i.0219.1.ph, 1
  br i1 %cmp6.1, label %for.body8.1.1387, label %for.inc87.1

for.body8.1.1387:                                 ; preds = %for.inc.1
  %55 = load float, ptr %add.ptr19.1, align 4
  %56 = load float, ptr %h, align 4
...
if.then.1.1392:                                   ; preds = %for.body8.1.1387
  store float %55, ptr %pr.3.ph.1, align 4
  %arrayidx14.1.1 = getelementptr inbounds float, ptr %ret, i64 3
  %57 = load float, ptr %arrayidx14.1.1, align 4
  %arrayidx15.1.1388 = getelementptr inbounds float, ptr %pr.3.ph.1, i64 1
  store float %57, ptr %arrayidx15.1.1388, align 4
  %inc.1.1389 = add nsw i32 %nr.5.ph.1, 1
...
if.then.1.if.end17.1_crit_edge.1:                 ; preds = %if.then.1.1392
  %add.ptr.1.1393 = getelementptr inbounds float, ptr %pr.3.ph.1, i64 2
  %.pre348.1 = load float, ptr %add.ptr19.1, align 4
  %.pre349.1 = load float, ptr %h, align 4
...
if.end17.1.1402:                                  ; preds = %if.then.1.if.end17.1_crit_edge.1, %for.body8.1.1387
  ...
  %nr.3.1.1394 = phi i32 [ %inc.1.1389, %if.then.1.if.end17.1_crit_edge.1 ], [ %nr.5.ph.1, %for.body8.1.1387 ]
  %pr.1.1.1395 = phi ptr [ %add.ptr.1.1393, %if.then.1.if.end17.1_crit_edge.1 ], [ %pr.3.ph.1, %for.body8.1.1387 ]
  ...
  %61 = load float, ptr %cond.1.1398, align 4
...
if.then37.1.1410:                                 ; preds = %if.end17.1.1402
  ...
  %62 = load float, ptr %arrayidx39.1.1, align 4
  %arrayidx42.1.1 = getelementptr inbounds float, ptr %cond.1.1398, i64 1
  %63 = load float, ptr %arrayidx42.1.1, align 4
  ...
  store float %65, ptr %arrayidx61.1.1, align 4
  %66 = load float, ptr %h, align 4
  store float %66, ptr %pr.1.1.1395, align 4
...
for.inc.1.1415:                                   ; preds = %if.then37.1.1410, %if.end17.1.1402
  %nr.5.ph.1.1411 = phi i32 [ %nr.3.1.1394, %if.end17.1.1402 ], [ %inc69.1.1407, %if.then37.1.1410 ]
  %pr.3.ph.1.1412 = phi ptr [ %pr.1.1.1395, %if.end17.1.1402 ], [ %add.ptr68.1.1406, %if.then37.1.1410 ]
...
for.body8.1.2:                                    ; preds = %for.inc.1.1415
  %67 = load float, ptr %add.ptr19.1.1397, align 4
  %68 = load float, ptr %h, align 4
  %cmp11.1.2 = fcmp olt float %67, %68
  br i1 %cmp11.1.2, label %if.then.1.2, label %if.end17.1.2

if.then.1.2:                                      ; preds = %for.body8.1.2
  store float %67, ptr %pr.3.ph.1.1412, align 4
  %arrayidx14.1.2 = getelementptr inbounds float, ptr %ret, i64 5
  %69 = load float, ptr %arrayidx14.1.2, align 4
  %arrayidx15.1.2 = getelementptr inbounds float, ptr %pr.3.ph.1.1412, i64 1
  store float %69, ptr %arrayidx15.1.2, align 4
  %inc.1.2 = add nsw i32 %nr.5.ph.1.1411, 1
...
if.then.1.if.end17.1_crit_edge.2:                 ; preds = %if.then.1.2
  %add.ptr.1.2 = getelementptr inbounds float, ptr %pr.3.ph.1.1412, i64 2
  %.pre348.2 = load float, ptr %add.ptr19.1.1397, align 4
  %.pre349.2 = load float, ptr %h, align 4
...
if.end17.1.2:                                     ; preds = %if.then.1.if.end17.1_crit_edge.2, %for.body8.1.2
  ...
  %nr.3.1.2 = phi i32 [ %inc.1.2, %if.then.1.if.end17.1_crit_edge.2 ], [ %nr.5.ph.1.1411, %for.body8.1.2 ]
  %pr.1.1.2 = phi ptr [ %add.ptr.1.2, %if.then.1.if.end17.1_crit_edge.2 ], [ %pr.3.ph.1.1412, %for.body8.1.2 ]
  ...
  %73 = load float, ptr %cond.1.2, align 4
...
if.then37.1.2:                                    ; preds = %if.end17.1.2
  ...
  %74 = load float, ptr %arrayidx39.1.2, align 4
  %arrayidx42.1.2 = getelementptr inbounds float, ptr %cond.1.2, i64 1
  %75 = load float, ptr %arrayidx42.1.2, align 4
  ...
  store float %77, ptr %arrayidx61.1.2, align 4
  %78 = load float, ptr %h, align 4
  store float %78, ptr %pr.1.1.2, align 4
...
for.inc.1.2:                                      ; preds = %if.then37.1.2, %if.end17.1.2
  %nr.5.ph.1.2 = phi i32 [ %nr.3.1.2, %if.end17.1.2 ], [ %inc69.1.2, %if.then37.1.2 ]
  %pr.3.ph.1.2 = phi ptr [ %pr.1.1.2, %if.end17.1.2 ], [ %add.ptr68.1.2, %if.then37.1.2 ]
  %cmp6.1.2 = icmp sgt i32 %i.0219.1.ph, 3
  br i1 %cmp6.1.2, label %for.body8.1.3, label %for.inc87.1

for.body8.1.3:                                    ; preds = %for.inc.1.2
  %79 = load float, ptr %add.ptr19.1.2, align 4
  %80 = load float, ptr %h, align 4
  %cmp11.1.3 = fcmp olt float %79, %80
  br i1 %cmp11.1.3, label %if.then.1.3, label %if.end17.1.3

if.then.1.3:                                      ; preds = %for.body8.1.3
  store float %79, ptr %pr.3.ph.1.2, align 4
  %arrayidx14.1.3 = getelementptr inbounds float, ptr %ret, i64 7
  %81 = load float, ptr %arrayidx14.1.3, align 4
  %arrayidx15.1.3 = getelementptr inbounds float, ptr %pr.3.ph.1.2, i64 1
  store float %81, ptr %arrayidx15.1.3, align 4
  %inc.1.3 = add nsw i32 %nr.5.ph.1.2, 1
...
if.then.1.if.end17.1_crit_edge.3:                 ; preds = %if.then.1.3
  %add.ptr.1.3 = getelementptr inbounds float, ptr %pr.3.ph.1.2, i64 2
  %.pre348.3 = load float, ptr %add.ptr19.1.2, align 4
  %.pre349.3 = load float, ptr %h, align 4
...
if.end17.1.3:                                     ; preds = %if.then.1.if.end17.1_crit_edge.3, %for.body8.1.3
  ...
  %nr.3.1.3 = phi i32 [ %inc.1.3, %if.then.1.if.end17.1_crit_edge.3 ], [ %nr.5.ph.1.2, %for.body8.1.3 ]
  %pr.1.1.3 = phi ptr [ %add.ptr.1.3, %if.then.1.if.end17.1_crit_edge.3 ], [ %pr.3.ph.1.2, %for.body8.1.3 ]
  ...
  %85 = load float, ptr %cond.1.3, align 4
...
if.then37.1.3:                                    ; preds = %if.end17.1.3
  ...
  %86 = load float, ptr %arrayidx39.1.3, align 4
  %arrayidx42.1.3 = getelementptr inbounds float, ptr %cond.1.3, i64 1
  %87 = load float, ptr %arrayidx42.1.3, align 4
  ...
  store float %89, ptr %arrayidx61.1.3, align 4
  %90 = load float, ptr %h, align 4
  store float %90, ptr %pr.1.1.3, align 4
...
for.inc.1.3:                                      ; preds = %if.then37.1.3, %if.end17.1.3
  %nr.5.ph.1.3 = phi i32 [ %nr.3.1.3, %if.end17.1.3 ], [ %inc69.1.3, %if.then37.1.3 ]
  %pr.3.ph.1.3 = phi ptr [ %pr.1.1.3, %if.end17.1.3 ], [ %add.ptr68.1.3, %if.then37.1.3 ]
  %cmp6.1.3 = icmp sgt i32 %i.0219.1.ph, 4
  br i1 %cmp6.1.3, label %for.body8.1.4, label %for.inc87.1

for.body8.1.4:                                    ; preds = %for.inc.1.3
  %91 = load float, ptr %add.ptr19.1.3, align 4
  %92 = load float, ptr %h, align 4
  %cmp11.1.4 = fcmp olt float %91, %92
  br i1 %cmp11.1.4, label %if.then.1.4, label %if.end17.1.4

if.then.1.4:                                      ; preds = %for.body8.1.4
  store float %91, ptr %pr.3.ph.1.3, align 4
  %arrayidx14.1.4 = getelementptr inbounds float, ptr %ret, i64 9
  %93 = load float, ptr %arrayidx14.1.4, align 4
  %arrayidx15.1.4 = getelementptr inbounds float, ptr %pr.3.ph.1.3, i64 1
  store float %93, ptr %arrayidx15.1.4, align 4
  %inc.1.4 = add nsw i32 %nr.5.ph.1.3, 1
...
if.then.1.if.end17.1_crit_edge.4:                 ; preds = %if.then.1.4
  %add.ptr.1.4 = getelementptr inbounds float, ptr %pr.3.ph.1.3, i64 2
  %.pre348.4 = load float, ptr %add.ptr19.1.3, align 4
  %.pre349.4 = load float, ptr %h, align 4
...
if.end17.1.4:                                     ; preds = %if.then.1.if.end17.1_crit_edge.4, %for.body8.1.4
  ...
  %nr.3.1.4 = phi i32 [ %inc.1.4, %if.then.1.if.end17.1_crit_edge.4 ], [ %nr.5.ph.1.3, %for.body8.1.4 ]
  %pr.1.1.4 = phi ptr [ %add.ptr.1.4, %if.then.1.if.end17.1_crit_edge.4 ], [ %pr.3.ph.1.3, %for.body8.1.4 ]
  ...
  %97 = load float, ptr %cond.1.4, align 4
...
if.then37.1.4:                                    ; preds = %if.end17.1.4
  ...
  %98 = load float, ptr %arrayidx39.1.4, align 4
  %arrayidx42.1.4 = getelementptr inbounds float, ptr %cond.1.4, i64 1
  %99 = load float, ptr %arrayidx42.1.4, align 4
  ...
  store float %101, ptr %arrayidx61.1.4, align 4
  %102 = load float, ptr %h, align 4
  store float %102, ptr %pr.1.1.4, align 4
...
for.inc.1.4:                                      ; preds = %if.then37.1.4, %if.end17.1.4
  %nr.5.ph.1.4 = phi i32 [ %nr.3.1.4, %if.end17.1.4 ], [ %inc69.1.4, %if.then37.1.4 ]
  %pr.3.ph.1.4 = phi ptr [ %pr.1.1.4, %if.end17.1.4 ], [ %add.ptr68.1.4, %if.then37.1.4 ]
  %cmp6.1.4 = icmp sgt i32 %i.0219.1.ph, 5
  br i1 %cmp6.1.4, label %for.body8.1.5, label %for.inc87.1

for.body8.1.5:                                    ; preds = %for.inc.1.4
  %103 = load float, ptr %add.ptr19.1.4, align 4
...
if.then.1.5:                                      ; preds = %for.body8.1.5
  store float %103, ptr %pr.3.ph.1.4, align 4
  %arrayidx14.1.5 = getelementptr inbounds float, ptr %ret, i64 11
  %105 = load float, ptr %arrayidx14.1.5, align 4
  %arrayidx15.1.5 = getelementptr inbounds float, ptr %pr.3.ph.1.4, i64 1
  store float %105, ptr %arrayidx15.1.5, align 4
  %inc.1.5 = add nsw i32 %nr.5.ph.1.4, 1
...
if.then.1.if.end17.1_crit_edge.5:                 ; preds = %if.then.1.5
  %add.ptr.1.5 = getelementptr inbounds float, ptr %pr.3.ph.1.4, i64 2
  %.pre348.5 = load float, ptr %add.ptr19.1.4, align 4
  %.pre349.5 = load float, ptr %h, align 4
...
if.end17.1.5:                                     ; preds = %if.then.1.if.end17.1_crit_edge.5, %for.body8.1.5
  ...
  %nr.3.1.5 = phi i32 [ %inc.1.5, %if.then.1.if.end17.1_crit_edge.5 ], [ %nr.5.ph.1.4, %for.body8.1.5 ]
  %pr.1.1.5 = phi ptr [ %add.ptr.1.5, %if.then.1.if.end17.1_crit_edge.5 ], [ %pr.3.ph.1.4, %for.body8.1.5 ]
  ...
  %109 = load float, ptr %cond.1.5, align 4
...
if.then37.1.5:                                    ; preds = %if.end17.1.5
  ...
  %110 = load float, ptr %arrayidx39.1.5, align 4
  %arrayidx42.1.5 = getelementptr inbounds float, ptr %cond.1.5, i64 1
  %111 = load float, ptr %arrayidx42.1.5, align 4
  ...
  store float %113, ptr %arrayidx61.1.5, align 4
  %114 = load float, ptr %h, align 4
  store float %114, ptr %pr.1.1.5, align 4
...
for.inc.1.5:                                      ; preds = %if.then37.1.5, %if.end17.1.5
  %nr.5.ph.1.5 = phi i32 [ %nr.3.1.5, %if.end17.1.5 ], [ %inc69.1.5, %if.then37.1.5 ]
  %pr.3.ph.1.5 = phi ptr [ %pr.1.1.5, %if.end17.1.5 ], [ %add.ptr68.1.5, %if.then37.1.5 ]
  %cmp6.1.5 = icmp sgt i32 %i.0219.1.ph, 6
  br i1 %cmp6.1.5, label %for.body8.1.6, label %for.inc87.1

for.body8.1.6:                                    ; preds = %for.inc.1.5
  %115 = load float, ptr %add.ptr19.1.5, align 4
  %116 = load float, ptr %h, align 4
  %cmp11.1.6 = fcmp olt float %115, %116
  br i1 %cmp11.1.6, label %if.then.1.6, label %if.end17.1.6

if.then.1.6:                                      ; preds = %for.body8.1.6
  store float %115, ptr %pr.3.ph.1.5, align 4
  %arrayidx14.1.6 = getelementptr inbounds float, ptr %ret, i64 13
  %117 = load float, ptr %arrayidx14.1.6, align 4
  %arrayidx15.1.6 = getelementptr inbounds float, ptr %pr.3.ph.1.5, i64 1
  store float %117, ptr %arrayidx15.1.6, align 4
  %inc.1.6 = add nsw i32 %nr.5.ph.1.5, 1
...
if.then.1.if.end17.1_crit_edge.6:                 ; preds = %if.then.1.6
  %add.ptr.1.6 = getelementptr inbounds float, ptr %pr.3.ph.1.5, i64 2
  %.pre348.6 = load float, ptr %add.ptr19.1.5, align 4
  %.pre349.6 = load float, ptr %h, align 4
...
if.end17.1.6:                                     ; preds = %if.then.1.if.end17.1_crit_edge.6, %for.body8.1.6
  ...
  %nr.3.1.6 = phi i32 [ %inc.1.6, %if.then.1.if.end17.1_crit_edge.6 ], [ %nr.5.ph.1.5, %for.body8.1.6 ]
  %pr.1.1.6 = phi ptr [ %add.ptr.1.6, %if.then.1.if.end17.1_crit_edge.6 ], [ %pr.3.ph.1.5, %for.body8.1.6 ]
  ...
  %121 = load float, ptr %cond.1.6, align 4
...
if.then37.1.6:                                    ; preds = %if.end17.1.6
  ...
  %122 = load float, ptr %arrayidx39.1.6, align 4
  %arrayidx42.1.6 = getelementptr inbounds float, ptr %cond.1.6, i64 1
  %123 = load float, ptr %arrayidx42.1.6, align 4
  ...
  store float %125, ptr %arrayidx61.1.6, align 4
  %126 = load float, ptr %h, align 4
  store float %126, ptr %pr.1.1.6, align 4
...
for.inc.1.6:                                      ; preds = %if.then37.1.6, %if.end17.1.6
  %nr.5.ph.1.6 = phi i32 [ %nr.3.1.6, %if.end17.1.6 ], [ %inc69.1.6, %if.then37.1.6 ]
  %pr.3.ph.1.6 = phi ptr [ %pr.1.1.6, %if.end17.1.6 ], [ %add.ptr68.1.6, %if.then37.1.6 ]
  %cmp6.1.6 = icmp sgt i32 %i.0219.1.ph, 7
  br i1 %cmp6.1.6, label %for.body8.1.7, label %for.inc87.1

for.body8.1.7:                                    ; preds = %for.inc.1.6
  %127 = load float, ptr %add.ptr19.1.6, align 4
  %128 = load float, ptr %h, align 4
  %cmp11.1.7 = fcmp olt float %127, %128
  br i1 %cmp11.1.7, label %if.then.1.7, label %if.end17.1.7

if.then.1.7:                                      ; preds = %for.body8.1.7
  store float %127, ptr %pr.3.ph.1.6, align 4
  %arrayidx14.1.7 = getelementptr inbounds float, ptr %ret, i64 15
  %129 = load float, ptr %arrayidx14.1.7, align 4
  %arrayidx15.1.7 = getelementptr inbounds float, ptr %pr.3.ph.1.6, i64 1
  store float %129, ptr %arrayidx15.1.7, align 4
  %inc.1.7 = add nsw i32 %nr.5.ph.1.6, 1
...
if.then.1.if.end17.1_crit_edge.7:                 ; preds = %if.then.1.7
  %add.ptr.1.7 = getelementptr inbounds float, ptr %pr.3.ph.1.6, i64 2
  %.pre348.7 = load float, ptr %add.ptr19.1.6, align 4
  %.pre349.7 = load float, ptr %h, align 4
...
if.end17.1.7:                                     ; preds = %if.then.1.if.end17.1_crit_edge.7, %for.body8.1.7
  ...
  %nr.3.1.7 = phi i32 [ %inc.1.7, %if.then.1.if.end17.1_crit_edge.7 ], [ %nr.5.ph.1.6, %for.body8.1.7 ]
  %pr.1.1.7 = phi ptr [ %add.ptr.1.7, %if.then.1.if.end17.1_crit_edge.7 ], [ %pr.3.ph.1.6, %for.body8.1.7 ]
  %132 = add i32 %i.0219.1.ph, -9
  %cmp18.1.7 = icmp ult i32 %132, -2
  %cond.1.7.idx = select i1 %cmp18.1.7, i64 16, i64 0
  %cond.1.7 = getelementptr inbounds float, ptr %ret, i64 %cond.1.7.idx
  %cmp26.1.7 = fcmp olt float %131, %130
  %133 = load float, ptr %cond.1.7, align 4
...
if.then37.1.7:                                    ; preds = %if.end17.1.7
  ...
  %134 = load float, ptr %arrayidx39.1.7, align 4
  %arrayidx42.1.7 = getelementptr inbounds float, ptr %cond.1.7, i64 1
  %135 = load float, ptr %arrayidx42.1.7, align 4
  ...
  store float %137, ptr %arrayidx61.1.7, align 4
  %138 = load float, ptr %h, align 4
  store float %138, ptr %pr.1.1.7, align 4
...
for.inc87.1:                                      ; preds = %if.end17.1.7, %if.then37.1.7, %for.inc.1.6, %for.inc.1.5, %for.inc.1.4, %for.inc.1.3, %for.inc.1.2, %for.inc.1.1415, %for.inc.1
  %nr.5.ph.1.lcssa = phi i32 [ %nr.5.ph.1, %for.inc.1 ], [ %nr.5.ph.1.1411, %for.inc.1.1415 ], [ %nr.5.ph.1.2, %for.inc.1.2 ], [ %nr.5.ph.1.3, %for.inc.1.3 ], [ %nr.5.ph.1.4, %for.inc.1.4 ], [ %nr.5.ph.1.5, %for.inc.1.5 ], [ %nr.5.ph.1.6, %for.inc.1.6 ], [ %nr.3.1.7, %if.end17.1.7 ], [ %inc69.1.7, %if.then37.1.7 ]
  %arrayidx10.1 = getelementptr inbounds float, ptr %h, i64 1
  %cmp6215.1236 = icmp sgt i32 %nr.5.ph.1.lcssa, 0
...
for.body8.1244:                                   ; preds = %for.inc.1279, %for.body8.lr.ph.1237
  %i.0219.1238 = phi i32 [ %nr.5.ph.1.lcssa, %for.body8.lr.ph.1237 ], [ %dec.1277, %for.inc.1279 ]
  %pr.0218.1239 = phi ptr [ %ret, %for.body8.lr.ph.1237 ], [ %pr.3.ph.1276, %for.inc.1279 ]
  %pq.0217.1240 = phi ptr [ %buffer, %for.body8.lr.ph.1237 ], [ %add.ptr19.1255, %for.inc.1279 ]
  %nr.2216.1241 = phi i32 [ 0, %for.body8.lr.ph.1237 ], [ %nr.5.ph.1275, %for.inc.1279 ]
  %arrayidx.1242 = getelementptr inbounds float, ptr %pq.0217.1240, i64 1
  %139 = load float, ptr %arrayidx.1242, align 4
  %mul.1 = fneg float %139
  %140 = load float, ptr %arrayidx10.1, align 4
...
if.then.1251:                                     ; preds = %for.body8.1244
  %141 = load float, ptr %pq.0217.1240, align 4
  store float %141, ptr %pr.0218.1239, align 4
  %142 = load float, ptr %arrayidx.1242, align 4
  %arrayidx15.1246 = getelementptr inbounds float, ptr %pr.0218.1239, i64 1
  store float %142, ptr %arrayidx15.1246, align 4
...
if.then.1251.if.end17.1261_crit_edge:             ; preds = %if.then.1251
  ...
  %.pre350 = load float, ptr %arrayidx.1242, align 4
  %.pre351 = load float, ptr %arrayidx10.1, align 4
...
if.end17.1261:                                    ; preds = %if.then.1251.if.end17.1261_crit_edge, %for.body8.1244
  ...
  %145 = load float, ptr %cond.1256.sroa.sel, align 4
...
if.then37.1274:                                   ; preds = %if.end17.1261
  ...
  %146 = load float, ptr %pq.0217.1240, align 4
  %147 = load float, ptr %cond.1256, align 4
  ...
  store float %149, ptr %pr.1.1253, align 4
  %150 = load float, ptr %arrayidx10.1, align 4
  %mul65.1 = fneg float %150
  %arrayidx67.1269 = getelementptr inbounds float, ptr %pr.1.1253, i64 1
  store float %mul65.1, ptr %arrayidx67.1269, align 4
...
for.inc.1279:                                     ; preds = %if.then37.1274, %if.end17.1261
  %nr.5.ph.1275 = phi i32 [ %nr.3.1252, %if.end17.1261 ], [ %inc69.1271, %if.then37.1274 ]
  %pr.3.ph.1276 = phi ptr [ %pr.1.1253, %if.end17.1261 ], [ %add.ptr68.1270, %if.then37.1274 ]
...
for.inc87.1285:                                   ; preds = %for.inc.1279
  %cmp6215.1.1 = icmp sgt i32 %nr.5.ph.1275, 0
  br i1 %cmp6215.1.1, label %for.body8.1.1, label %if.then97

for.body8.1.1:                                    ; preds = %for.inc87.1285, %for.inc.1.1
  %i.0219.1.1 = phi i32 [ %dec.1.1, %for.inc.1.1 ], [ %nr.5.ph.1275, %for.inc87.1285 ]
  %pr.0218.1.1 = phi ptr [ %pr.3.ph.1.1, %for.inc.1.1 ], [ %buffer, %for.inc87.1285 ]
  %pq.0217.1.1 = phi ptr [ %add.ptr19.1.1, %for.inc.1.1 ], [ %ret, %for.inc87.1285 ]
  %nr.2216.1.1 = phi i32 [ %nr.5.ph.1.1, %for.inc.1.1 ], [ 0, %for.inc87.1285 ]
  %arrayidx.1.1 = getelementptr inbounds float, ptr %pq.0217.1.1, i64 1
  %151 = load float, ptr %arrayidx.1.1, align 4
  %152 = load float, ptr %arrayidx10.1, align 4
  %cmp11.1.1 = fcmp olt float %151, %152
  br i1 %cmp11.1.1, label %if.then.1.1, label %if.end17.1.1

if.then.1.1:                                      ; preds = %for.body8.1.1
  %153 = load float, ptr %pq.0217.1.1, align 4
  store float %153, ptr %pr.0218.1.1, align 4
  %154 = load float, ptr %arrayidx.1.1, align 4
  %arrayidx15.1.1 = getelementptr inbounds float, ptr %pr.0218.1.1, i64 1
  store float %154, ptr %arrayidx15.1.1, align 4
...
if.then.1.1.if.end17.1.1_crit_edge:               ; preds = %if.then.1.1
  ...
  %.pre352 = load float, ptr %arrayidx.1.1, align 4
  %.pre353 = load float, ptr %arrayidx10.1, align 4
...
if.end17.1.1:                                     ; preds = %if.then.1.1.if.end17.1.1_crit_edge, %for.body8.1.1
  ...
  %157 = load float, ptr %arrayidx30.1.1, align 4
...
if.then37.1.1:                                    ; preds = %if.end17.1.1
  %158 = load float, ptr %pq.0217.1.1, align 4
  %159 = load float, ptr %cond.1.1, align 4
  ...
  store float %161, ptr %pr.1.1.1, align 4
  %162 = load float, ptr %arrayidx10.1, align 4
  %arrayidx67.1.1 = getelementptr inbounds float, ptr %pr.1.1.1, i64 1
  store float %162, ptr %arrayidx67.1.1, align 4
...
for.inc.1.1:                                      ; preds = %if.then37.1.1, %if.end17.1.1
  %nr.5.ph.1.1 = phi i32 [ %nr.3.1.1, %if.end17.1.1 ], [ %inc69.1.1, %if.then37.1.1 ]
  %pr.3.ph.1.1 = phi ptr [ %pr.1.1.1, %if.end17.1.1 ], [ %add.ptr68.1.1, %if.then37.1.1 ]
...
if.then97:                                        ; preds = %if.then.1.1392, %if.then37.1.1410, %if.then.1.2, %if.then37.1.2, %if.then.1.3, %if.then37.1.3, %if.then.1.4, %if.then37.1.4, %if.then.1.5, %if.then37.1.5, %if.then.1.6, %if.then37.1.6, %if.then.1.7, %if.then37.1.7, %for.inc.1.1, %if.then.1.1, %if.then37.1.1, %for.inc87.1285, %for.inc87.1, %for.inc87
  %nr.8 = phi i32 [ 0, %for.inc87.1285 ], [ 0, %for.inc87.1 ], [ 0, %for.inc87 ], [ %inc.1.1, %if.then.1.1 ], [ %inc69.1.1, %if.then37.1.1 ], [ %nr.5.ph.1.1, %for.inc.1.1 ], [ %inc.1.1389, %if.then.1.1392 ], [ %inc69.1.1407, %if.then37.1.1410 ], [ %inc.1.2, %if.then.1.2 ], [ %inc69.1.2, %if.then37.1.2 ], [ %inc.1.3, %if.then.1.3 ], [ %inc69.1.3, %if.then37.1.3 ], [ %inc.1.4, %if.then.1.4 ], [ %inc69.1.4, %if.then37.1.4 ], [ %inc.1.5, %if.then.1.5 ], [ %inc69.1.5, %if.then37.1.5 ], [ %inc.1.6, %if.then.1.6 ], [ %inc69.1.6, %if.then37.1.6 ], [ %inc.1.7, %if.then.1.7 ], [ %inc69.1.7, %if.then37.1.7 ]
...
entry:
  ...
  %2 = load <2 x float>, ptr %input, align 8
  store <2 x float> %2, ptr %R1, align 16
  %3 = load <2 x float>, ptr %m_transformB, align 8
  store <2 x float> %3, ptr %R2, align 16
  %arrayidx.i121 = getelementptr inbounds [4 x float], ptr %input, i64 0, i64 2
  %4 = load float, ptr %arrayidx.i121, align 8
  %arrayidx32 = getelementptr inbounds [12 x float], ptr %R1, i64 0, i64 2
  store float %4, ptr %arrayidx32, align 8
  ...
  %5 = load float, ptr %arrayidx.i124, align 8
  %arrayidx39 = getelementptr inbounds [12 x float], ptr %R2, i64 0, i64 2
  store float %5, ptr %arrayidx39, align 8
  ...
  %6 = load <2 x float>, ptr %arrayidx.i.1, align 8
  store <2 x float> %6, ptr %arrayidx.1, align 16
  %7 = load <2 x float>, ptr %arrayidx.i112.1, align 8
  store <2 x float> %7, ptr %arrayidx11.1, align 16
  %arrayidx.i121.1 = getelementptr inbounds [3 x %class.btVector3], ptr %input, i64 0, i64 1, i32 0, i64 2
  %8 = load float, ptr %arrayidx.i121.1, align 8
  %arrayidx32.1 = getelementptr inbounds [12 x float], ptr %R1, i64 0, i64 6
  store float %8, ptr %arrayidx32.1, align 8
  ...
  %9 = load float, ptr %arrayidx.i124.1, align 8
  %arrayidx39.1 = getelementptr inbounds [12 x float], ptr %R2, i64 0, i64 6
  store float %9, ptr %arrayidx39.1, align 8
  ...
  %10 = load <2 x float>, ptr %arrayidx.i.2, align 8
  store <2 x float> %10, ptr %arrayidx.2, align 16
  %11 = load <2 x float>, ptr %arrayidx.i112.2, align 8
  store <2 x float> %11, ptr %arrayidx11.2, align 16
  %arrayidx.i121.2 = getelementptr inbounds [3 x %class.btVector3], ptr %input, i64 0, i64 2, i32 0, i64 2
  %12 = load float, ptr %arrayidx.i121.2, align 8
  %arrayidx32.2 = getelementptr inbounds [12 x float], ptr %R1, i64 0, i64 10
  store float %12, ptr %arrayidx32.2, align 8
  ...
  %13 = load float, ptr %arrayidx.i124.2, align 8
  %arrayidx39.2 = getelementptr inbounds [12 x float], ptr %R2, i64 0, i64 10
  store float %13, ptr %arrayidx39.2, align 8
  ...
  %m_box1 = getelementptr inbounds %struct.btBoxBoxDetector, ptr %this, i64 0, i32 1
  %14 = load ptr, ptr %m_box1, align 8
  ...
  %vtable8.i = load ptr, ptr %14, align 8
  ...
  %m_box2 = getelementptr inbounds %struct.btBoxBoxDetector, ptr %this, i64 0, i32 2
  %23 = load ptr, ptr %m_box2, align 8
  %m_implicitShapeDimensions.i.i77 = getelementptr inbounds %class.btConvexInternalShape, ptr %23, i64 0, i32 2
  %retval.sroa.0.0.copyload.i78 = load <2 x float>, ptr %m_implicitShapeDimensions.i.i77, align 4
  ...
  %retval.sroa.6.0.copyload.i80 = load <2 x float>, ptr %retval.sroa.6.0.m_implicitShapeDimensions.i.sroa_idx.i79, align 4
  ...
  %vtable4.i84 = load ptr, ptr %23, align 8
  ...
  %vtable8.i87 = load ptr, ptr %23, align 8
...
; Function Attrs: uwtable
define linkonce_odr dso_local void @_ZN16btBoxBoxDetectorD0Ev(ptr noundef nonnull align 8 dereferenceable(24) %this) unnamed_addr #9 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
