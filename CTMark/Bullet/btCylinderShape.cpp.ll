; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btCylinderShape.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btCylinderShape.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [21 x ptr] }, ptr @_ZTV15btCylinderShape, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i42, ptr %ref.tmp16.sroa.5.0.m_implicitShapeDimensions.sroa_idx, align 8
...
entry:
  ...
  %0 = load float, ptr %m_collisionMargin.i.i, align 8
  ...
  %3 = load <2 x float>, ptr %halfExtents, align 4
  %4 = load <2 x float>, ptr %m_localScaling.i, align 8
  %5 = fmul <2 x float> %3, %4
  %6 = insertelement <2 x float> poison, float %0, i64 0
  %7 = shufflevector <2 x float> %6, <2 x float> poison, <2 x i32> zeroinitializer
  %8 = fsub <2 x float> %5, %7
  ...
  store <2 x float> %8, ptr %m_implicitShapeDimensions.i, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i42.i, ptr %ref.tmp16.sroa.5.0.m_implicitShapeDimensions.sroa_idx.i, align 8
  %m_shapeType.i = getelementptr inbounds %class.btCollisionShape, ptr %this, i64 0, i32 1
  store i32 13, ptr %m_shapeType.i, align 8
  store ptr getelementptr inbounds ({ [21 x ptr] }, ptr @_ZTV16btCylinderShapeX, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  store i32 0, ptr %m_upAxis.i, align 8
  ret void
}
...
entry:
  ...
  %m_shapeType.i = getelementptr inbounds %class.btCollisionShape, ptr %this, i64 0, i32 1
  store i32 13, ptr %m_shapeType.i, align 8
  store ptr getelementptr inbounds ({ [22 x ptr] }, ptr @_ZTV16btCylinderShapeZ, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  store i32 2, ptr %m_upAxis.i, align 8
  ret void
}
...
_Z21CylinderLocalSupportYRK9btVector3S1_.exit:    ; preds = %if.then.i, %if.else.i
  ...
  store <2 x float> %retval.sroa.5.0.i, ptr %ref.tmp.sroa.4.0.arrayidx4.sroa_idx, align 4
...
attributes #4 = { mustprogress nofree nosync nounwind willreturn memory(argmem: read) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #5 = { nofree nosync nounwind memory(argmem: readwrite) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
