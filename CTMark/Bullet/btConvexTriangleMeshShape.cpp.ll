; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btConvexTriangleMeshShape.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btConvexTriangleMeshShape.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [27 x ptr] }, ptr @_ZTV25btConvexTriangleMeshShape, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
invoke.cont14:                                    ; preds = %if.else, %entry
  ...
  store float %vec.sroa.13.0, ptr %vec.sroa.13.0.m_supportVecLocal.i.sroa_idx, align 4
  ...
  store float %vec.sroa.17.0, ptr %vec.sroa.17.0.m_supportVecLocal.i.sroa_idx, align 8
...
invoke.cont16:                                    ; preds = %invoke.cont14
  ...
  %.fca.0.insert.i40 = insertvalue { <2 x float>, <2 x float> } poison, <2 x float> %retval.sroa.0.0.copyload.i, 0
  %.fca.1.insert.i41 = insertvalue { <2 x float>, <2 x float> } %.fca.0.insert.i40, <2 x float> %retval.sroa.2.0.copyload.i, 1
  ...
  ret { <2 x float>, <2 x float> } %.fca.1.insert.i41
...
for.body.epil:                                    ; preds = %for.cond3.preheader.unr-lcssa, %for.body.epil
  ...
  store float 0xC3ABC16D60000000, ptr %arrayidx2.epil, align 4
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %for.cond3.preheader, label %for.body.epil

for.cond3.preheader:                              ; preds = %for.body.epil, %for.cond3.preheader.unr-lcssa
  br i1 %cmp44, label %invoke.cont13.lr.ph, label %for.cond.cleanup5

invoke.cont13.lr.ph:                              ; preds = %for.cond3.preheader
  %m_supportVertexLocal.i = getelementptr inbounds %class.LocalSupportVertexCallback, ptr %supportCallback, i64 0, i32 1
  %m_maxDot.i = getelementptr inbounds %class.LocalSupportVertexCallback, ptr %supportCallback, i64 0, i32 2
  %m_supportVecLocal.i = getelementptr inbounds %class.LocalSupportVertexCallback, ptr %supportCallback, i64 0, i32 3
  %m_stridingMesh = getelementptr inbounds %class.btConvexTriangleMeshShape, ptr %this, i64 0, i32 1
...
invoke.cont13:                                    ; preds = %invoke.cont13.lr.ph, %invoke.cont15
  %indvars.iv49 = phi i64 [ 0, %invoke.cont13.lr.ph ], [ %indvars.iv.next50, %invoke.cont15 ]
  %arrayidx8 = getelementptr inbounds %class.btVector3, ptr %vectors, i64 %indvars.iv49
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %supportCallback) #16
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV26LocalSupportVertexCallback, i64 0, inrange i32 0, i64 2), ptr %supportCallback, align 8
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_supportVertexLocal.i, i8 0, i64 16, i1 false)
  store float 0xC3ABC16D60000000, ptr %m_maxDot.i, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %m_supportVecLocal.i, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx8, i64 16, i1 false)
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %aabbMax) #16
  store <4 x float> <float 0x43ABC16D60000000, float 0x43ABC16D60000000, float 0x43ABC16D60000000, float 0.000000e+00>, ptr %aabbMax, align 16
...
invoke.cont15:                                    ; preds = %invoke.cont13
  ...
  store <2 x float> %retval.sroa.0.0.copyload.i, ptr %arrayidx22, align 4
  %ref.tmp16.sroa.4.0.arrayidx22.sroa_idx = getelementptr inbounds i8, ptr %arrayidx22, i64 8
  store <2 x float> %retval.sroa.2.0.copyload.i, ptr %ref.tmp16.sroa.4.0.arrayidx22.sroa_idx, align 4
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %aabbMax) #16
  call void @_ZN31btInternalTriangleIndexCallbackD2Ev(ptr noundef nonnull align 8 dereferenceable(44) %supportCallback)
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %supportCallback) #16
  %indvars.iv.next50 = add nuw nsw i64 %indvars.iv49, 1
  %exitcond53.not = icmp eq i64 %indvars.iv.next50, %wide.trip.count52
  br i1 %exitcond53.not, label %for.cond.cleanup5, label %invoke.cont13
...
if.then:                                          ; preds = %entry
  ...
  %vecnorm.sroa.13.0.copyload = load float, ptr %vecnorm.sroa.13.0.vec.sroa_idx, align 4
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local void @_ZNK25btConvexTriangleMeshShape7getEdgeEiR9btVector3S1_(ptr nocapture nonnull readnone align 8 %this, i32 %0, ptr nocapture nonnull readnone align 4 %1, ptr nocapture nonnull readnone align 4 %2) unnamed_addr #6 align 2 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local void @_ZNK25btConvexTriangleMeshShape9getVertexEiR9btVector3(ptr nocapture nonnull readnone align 8 %this, i32 %0, ptr nocapture nonnull readnone align 4 %1) unnamed_addr #6 align 2 {
entry:
  ret void
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local void @_ZNK25btConvexTriangleMeshShape8getPlaneER9btVector3S1_i(ptr nocapture nonnull readnone align 8 %this, ptr nocapture nonnull readnone align 4 %0, ptr nocapture nonnull readnone align 4 %1, i32 %2) unnamed_addr #6 align 2 {
entry:
  ret void
}
...
invoke.cont20:                                    ; preds = %cond.false.i, %cond.true.i
  ...
  store <2 x float> %retval.sroa.3.0.i, ptr %center.sroa.6.0.m_origin.i.sroa_idx, align 4
  ...
  %sum.i74 = getelementptr inbounds %class.InertiaCallback, ptr %inertiaCallback, i64 0, i32 1
  %center10.i = getelementptr inbounds %class.InertiaCallback, ptr %inertiaCallback, i64 0, i32 2
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %sum.i74, i8 0, i64 48, i1 false)
  ...
  store <2 x float> %retval.sroa.3.0.i, ptr %center.sroa.6.0.center10.i.sroa_idx, align 8
  %9 = load ptr, ptr %m_stridingMesh, align 8
  ...
  %fneg8.i79 = fneg float %12
  %retval.sroa.3.12.vec.insert.i82 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %fneg8.i79, i64 0
  store <2 x float> %11, ptr %ref.tmp18, align 8
  %13 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp18, i64 0, i32 1
  store <2 x float> %retval.sroa.3.12.vec.insert.i82, ptr %13, align 8
...
invoke.cont25:                                    ; preds = %invoke.cont20
  ...
  invoke void @_ZN11btMatrix3x311diagonalizeERS_fi(ptr noundef nonnull align 4 dereferenceable(48) %sum.i74, ptr noundef nonnull align 4 dereferenceable(48) %principal, float noundef 0x3EE4F8B580000000, i32 noundef 20)
...
invoke.cont31:                                    ; preds = %invoke.cont25
  ...
  %15 = load float, ptr %sum.i74, align 8
  store float %15, ptr %inertia, align 4
  %16 = load float, ptr %arrayidx40, align 4
  %arrayidx3.i87 = getelementptr inbounds [4 x float], ptr %inertia, i64 0, i64 1
  store float %16, ptr %arrayidx3.i87, align 4
  %17 = load float, ptr %arrayidx45, align 8
  %arrayidx5.i88 = getelementptr inbounds [4 x float], ptr %inertia, i64 0, i64 2
  store float %17, ptr %arrayidx5.i88, align 4
  %arrayidx7.i89 = getelementptr inbounds [4 x float], ptr %inertia, i64 0, i64 3
  ...
  store float %mul7.i.i, ptr %arrayidx5.i88, align 4
...
ehcleanup51:                                      ; preds = %ehcleanup, %lpad15
  %.pn65 = phi { ptr, i32 } [ %25, %lpad15 ], [ %.pn, %ehcleanup ]
  call void @llvm.lifetime.end.p0(i64 72, ptr nonnull %inertiaCallback) #16
  br label %ehcleanup53

ehcleanup53:                                      ; preds = %ehcleanup51, %lpad5
  %.pn65.pn.pn = phi { ptr, i32 } [ %24, %lpad5 ], [ %.pn65, %ehcleanup51 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %aabbMax) #16
...
if.then:                                          ; preds = %entry
  store float %7, ptr %m_maxDot, align 8
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_supportVertexLocal, ptr noundef nonnull align 4 dereferenceable(16) %triangle, i64 16, i1 false)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %8 = phi float [ %7, %if.then ], [ %m_maxDot.promoted, %entry ]
  %arrayidx.1 = getelementptr inbounds %class.btVector3, ptr %triangle, i64 1
  %9 = load float, ptr %arrayidx.1, align 4
  %arrayidx7.i.1 = getelementptr inbounds %class.btVector3, ptr %triangle, i64 1, i32 0, i64 1
  %10 = load float, ptr %arrayidx7.i.1, align 4
  ...
  %12 = load float, ptr %arrayidx12.i.1, align 4
...
if.then.1:                                        ; preds = %if.end
  store float %13, ptr %m_maxDot, align 8
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_supportVertexLocal, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx.1, i64 16, i1 false)
  br label %if.end.1
...
if.end.1:                                         ; preds = %if.then.1, %if.end
  ...
  %16 = load float, ptr %arrayidx7.i.2, align 4
  ...
  %18 = load float, ptr %arrayidx12.i.2, align 4
...
if.then.2:                                        ; preds = %if.end.1
  store float %19, ptr %m_maxDot, align 8
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_supportVertexLocal, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx.2, i64 16, i1 false)
  br label %if.end.2
...
if.else:                                          ; preds = %entry
  ...
  %3 = load float, ptr %arrayidx11.i46, align 4
  ...
  %4 = load float, ptr %arrayidx11.i58, align 4
  ...
  %6 = load <2 x float>, ptr %triangle, align 4
  %7 = load <2 x float>, ptr %ref4, align 4
  ...
  %13 = load <2 x float>, ptr %arrayidx11, align 4
...
entry:
  ...
  %1 = load float, ptr %center, align 8
  ...
  %17 = load <2 x float>, ptr %arrayidx5.i157, align 4
  %18 = fsub <2 x float> %17, %15
  %19 = load <2 x float>, ptr %arrayidx5.i169, align 4
...
attributes #12 = { mustprogress nofree nosync nounwind willreturn memory(argmem: readwrite) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
