; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btGenericPoolAllocator.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btGenericPoolAllocator.cpp"
...
while.body:                                       ; preds = %while.cond.preheader, %while.body
  %revindex.052 = phi i64 [ %0, %while.cond.preheader ], [ %dec, %while.body ]
  %dec = add i64 %revindex.052, -1
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %3 = load i64, ptr %m_max_element_count, align 8
...
while.body.i:                                     ; preds = %while.body.i, %while.cond.preheader.i
  %revindex.052.i = phi i64 [ %1, %while.cond.preheader.i ], [ %dec.i, %while.body.i ]
  %dec.i = add i64 %revindex.052.i, -1
...
if.then18.i:                                      ; preds = %if.end10.i
  ...
  store i64 %add.i, ptr %arrayidx12.i, align 8
...
if.else.i:                                        ; preds = %if.end10.i
  %9 = load i64, ptr %m_free_nodes_count.i, align 8
  %sub26.i = add i64 %9, -1
  %arrayidx27.i = getelementptr inbounds i64, ptr %3, i64 %sub26.i
  %10 = load i64, ptr %arrayidx27.i, align 8
  store i64 %10, ptr %arrayidx12.i, align 8
  %11 = load i64, ptr %m_free_nodes_count.i, align 8
...
if.then4:                                         ; preds = %_ZN19btGenericMemoryPool24allocate_from_free_nodesEm.exit
  ...
  %13 = load i64, ptr %m_element_size, align 8
  %mul.i = mul i64 %13, %7
...
if.end6:                                          ; preds = %while.end.i, %entry, %_ZN19btGenericMemoryPool24allocate_from_free_nodesEm.exit
  ...
  %14 = load i64, ptr %m_allocated_count.i, align 8
  ...
  %15 = load i64, ptr %m_max_element_count.i, align 8
...
_ZN19btGenericMemoryPool18allocate_from_poolEm.exit: ; preds = %if.end6
  ...
  %16 = load ptr, ptr %m_allocated_sizes.i23, align 8
  %arrayidx.i24 = getelementptr inbounds i64, ptr %16, i64 %14
  store i64 %spec.select, ptr %arrayidx.i24, align 8
  %17 = load i64, ptr %m_allocated_count.i, align 8
...
if.end10:                                         ; preds = %_ZN19btGenericMemoryPool18allocate_from_poolEm.exit
  ...
  %19 = load i64, ptr %m_element_size, align 8
...
if.end:                                           ; preds = %entry
  ...
  %4 = load i64, ptr %m_max_element_count.i, align 8
  %mul5.i = shl i64 %4, 3
  ...
  %5 = load i64, ptr %m_max_element_count.i, align 8
  %mul8.i = shl i64 %5, 3
...
_ZN19btGenericMemoryPool9init_poolEmm.exit:       ; preds = %for.body.i, %if.end
  %8 = load i64, ptr %m_pool_count, align 8
  %inc = add i64 %8, 1
...
if.end6:                                          ; preds = %if.end
  ...
  %2 = load i64, ptr %m_element_size.i, align 8
  ...
  %3 = load i64, ptr %m_free_nodes_count.i.i, align 8
...
while.body.i.i:                                   ; preds = %while.body.i.i, %while.cond.preheader.i.i
  %revindex.052.i.i = phi i64 [ %3, %while.cond.preheader.i.i ], [ %dec.i.i, %while.body.i.i ]
  %dec.i.i = add i64 %revindex.052.i.i, -1
...
if.end10.i.i:                                     ; preds = %while.end.i.i
  ...
  %9 = load i64, ptr %arrayidx12.i.i, align 8
  %arrayidx14.i.i = getelementptr inbounds i64, ptr %4, i64 %9
  %10 = load i64, ptr %arrayidx14.i.i, align 8
  store i64 %spec.select.i, ptr %arrayidx14.i.i, align 8
...
if.then18.i.i:                                    ; preds = %if.end10.i.i
  ...
  store i64 %add.i.i, ptr %arrayidx12.i.i, align 8
  %arrayidx23.i.i = getelementptr inbounds i64, ptr %4, i64 %add.i.i
  store i64 %sub.i.i, ptr %arrayidx23.i.i, align 8
  br label %_ZN19btGenericMemoryPool24allocate_from_free_nodesEm.exit.i

if.else.i.i:                                      ; preds = %if.end10.i.i
  %11 = load i64, ptr %m_free_nodes_count.i.i, align 8
  %sub26.i.i = add i64 %11, -1
  %arrayidx27.i.i = getelementptr inbounds i64, ptr %5, i64 %sub26.i.i
  %12 = load i64, ptr %arrayidx27.i.i, align 8
  store i64 %12, ptr %arrayidx12.i.i, align 8
  %13 = load i64, ptr %m_free_nodes_count.i.i, align 8
  %dec31.i.i = add i64 %13, -1
  store i64 %dec31.i.i, ptr %m_free_nodes_count.i.i, align 8
  br label %_ZN19btGenericMemoryPool24allocate_from_free_nodesEm.exit.i
...
if.then4.i:                                       ; preds = %_ZN19btGenericMemoryPool24allocate_from_free_nodesEm.exit.i
  ...
  %15 = load i64, ptr %m_element_size.i, align 8
...
if.end6.i:                                        ; preds = %_ZN19btGenericMemoryPool24allocate_from_free_nodesEm.exit.i, %while.end.i.i, %if.end6
  ...
  %16 = load i64, ptr %m_allocated_count.i.i, align 8
  ...
  %17 = load i64, ptr %m_max_element_count.i.i, align 8
...
_ZN19btGenericMemoryPool18allocate_from_poolEm.exit.i: ; preds = %if.end6.i
  ...
  %18 = load ptr, ptr %m_allocated_sizes.i23.i, align 8
  %arrayidx.i24.i = getelementptr inbounds i64, ptr %18, i64 %16
  store i64 %spec.select.i, ptr %arrayidx.i24.i, align 8
  %19 = load i64, ptr %m_allocated_count.i.i, align 8
  %add5.i.i = add i64 %19, %spec.select.i
  store i64 %add5.i.i, ptr %m_allocated_count.i.i, align 8
...
if.end10.i:                                       ; preds = %_ZN19btGenericMemoryPool18allocate_from_poolEm.exit.i
  ...
  %21 = load i64, ptr %m_element_size.i, align 8
...
if.end6.i:                                        ; preds = %_ZN19btGenericMemoryPool24allocate_from_free_nodesEm.exit.i, %while.end.i.i, %while.body
  %m_allocated_count.i.i = getelementptr inbounds %class.btGenericMemoryPool, ptr %1, i64 0, i32 3
  %14 = load i64, ptr %m_allocated_count.i.i, align 8
  ...
  %15 = load i64, ptr %m_max_element_count.i.i, align 8
...
_ZN19btGenericMemoryPool18allocate_from_poolEm.exit.i: ; preds = %if.end6.i
  ...
  %16 = load ptr, ptr %m_allocated_sizes.i23.i, align 8
  %arrayidx.i24.i = getelementptr inbounds i64, ptr %16, i64 %14
  store i64 %spec.select.i, ptr %arrayidx.i24.i, align 8
  %17 = load i64, ptr %m_allocated_count.i.i, align 8
...
_ZN19btGenericMemoryPool8allocateEm.exit.sink.split: ; preds = %_ZN19btGenericMemoryPool18allocate_from_poolEm.exit.i, %_ZN19btGenericMemoryPool24allocate_from_free_nodesEm.exit.i
  ...
  %19 = load i64, ptr %m_element_size.i, align 8
...
_ZN19btGenericMemoryPool8allocateEm.exit:         ; preds = %_ZN19btGenericMemoryPool8allocateEm.exit.sink.split, %if.end6.i, %_ZN19btGenericMemoryPool18allocate_from_poolEm.exit.i
  ...
  %20 = load i64, ptr %m_pool_count, align 8
...
if.end.i.i.i:                                     ; preds = %while.body.i.i
  ...
  %3 = load i64, ptr %m_element_size.i.i.i.i, align 8
  %m_max_element_count.i.i.i.i = getelementptr inbounds %class.btGenericMemoryPool, ptr %1, i64 0, i32 6
  %4 = load i64, ptr %m_max_element_count.i.i.i.i, align 8
