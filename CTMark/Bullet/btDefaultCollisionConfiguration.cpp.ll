...
while.body.i158.prol:                             ; preds = %while.body.lr.ph.i156, %while.body.i158.prol
  ...
  store ptr %add.ptr.i161.prol, ptr %p.017.i160.prol, align 8, !tbaa !51
  ...
  br i1 %prol.iter184.cmp.not, label %while.body.i158.prol.loopexit, label %while.body.i158.prol, !llvm.loop !58
...
if.then.i.i:                                      ; preds = %invoke.cont
  ...
  %6 = load i8, ptr %ischild.i.i, align 8, !tbaa !64, !range !60, !noundef !61
  %tobool.not.i.i = icmp eq i8 %6, 0
  br i1 %tobool.not.i.i, label %land.lhs.true.i.i, label %if.end.i.i

land.lhs.true.i.i:                                ; preds = %if.then.i.i
  %7 = load ptr, ptr %.pre, align 8, !tbaa !39
...
if.end:                                           ; preds = %invoke.cont3, %entry
  ...
  %9 = load i8, ptr %m_ownsCollisionAlgorithmPool, align 8, !tbaa !56, !range !60, !noundef !61
...
if.then7:                                         ; preds = %if.end
  ...
  %10 = load ptr, ptr %m_collisionAlgorithmPool, align 8, !tbaa !59
  %m_pool.i = getelementptr inbounds %class.btPoolAllocator, ptr %10, i64 0, i32 4
  %11 = load ptr, ptr %m_pool.i, align 8, !tbaa !48
  tail call void @_Z21btAlignedFreeInternalPv(ptr noundef %11)
  %12 = load ptr, ptr %m_collisionAlgorithmPool, align 8, !tbaa !59
...
if.end11:                                         ; preds = %if.then7, %if.end
  ...
  %13 = load i8, ptr %m_ownsPersistentManifoldPool, align 8, !tbaa !43, !range !60, !noundef !61
...
if.end17:                                         ; preds = %if.then13, %if.end11
  ...
  %54 = load ptr, ptr %m_pdSolver, align 8, !tbaa !17
  %vtable78 = load ptr, ptr %54, align 8, !tbaa !5
  %55 = load ptr, ptr %vtable78, align 8
  tail call void %55(ptr noundef nonnull align 8 dereferenceable(8) %54)
  %56 = load ptr, ptr %m_pdSolver, align 8, !tbaa !17
