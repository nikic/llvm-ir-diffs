...
invoke.cont135:                                   ; preds = %for.body113
  ...
  %131 = load float, ptr %arrayidx.i16.i49.i.i330, align 4, !tbaa !72, !noalias !97
  ...
  store float %132, ptr %ref.tmp.sroa.5.0.agg.result.sroa_idx.i359, align 8, !tbaa.struct !85, !alias.scope !94
  ...
  store float %134, ptr %ref.tmp.sroa.10.16.arrayidx8.i.i.sroa_idx.i363, align 8, !tbaa.struct !85, !alias.scope !94
  ...
  store float %136, ptr %ref.tmp.sroa.15.32.arrayidx12.i.i7.sroa_idx.i367, align 8, !tbaa.struct !85, !alias.scope !94
...
for.body.i.i.i113.prol:                           ; preds = %for.body.i.i.i113.preheader, %for.body.i.i.i113.prol
  ...
  %17 = load ptr, ptr %arrayidx3.i.i.i116.prol, align 8, !tbaa !41
  store ptr %17, ptr %arrayidx.i.i.i115.prol, align 8, !tbaa !41
  %indvars.iv.next.i.i.i117.prol = add nuw nsw i64 %indvars.iv.i.i.i114.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body.i.i.i113.prol.loopexit, label %for.body.i.i.i113.prol, !llvm.loop !106
...
for.body.i.i.i113:                                ; preds = %for.body.i.i.i113.prol.loopexit, %for.body.i.i.i113
  ...
  %19 = load ptr, ptr %arrayidx3.i.i.i116, align 8, !tbaa !41
  store ptr %19, ptr %arrayidx.i.i.i115, align 8, !tbaa !41
  ...
  %20 = load ptr, ptr %arrayidx3.i.i.i116.1, align 8, !tbaa !41
  store ptr %20, ptr %arrayidx.i.i.i115.1, align 8, !tbaa !41
  ...
  %21 = load ptr, ptr %arrayidx3.i.i.i116.2, align 8, !tbaa !41
  store ptr %21, ptr %arrayidx.i.i.i115.2, align 8, !tbaa !41
  ...
  %22 = load ptr, ptr %arrayidx3.i.i.i116.3, align 8, !tbaa !41
  store ptr %22, ptr %arrayidx.i.i.i115.3, align 8, !tbaa !41
  ...
  br i1 %exitcond.not.i.i.i118.3, label %if.then3.i.i.i106, label %for.body.i.i.i113, !llvm.loop !107
...
invoke.cont17:                                    ; preds = %if.then.i86, %if.then16, %if.then3.i.i.i106
  ...
  store ptr %23, ptr %arrayidx.i84, align 8, !tbaa !41
...
for.body.i.i.i158.prol:                           ; preds = %for.body.i.i.i158.preheader, %for.body.i.i.i158.prol
  ...
  %32 = load ptr, ptr %arrayidx3.i.i.i161.prol, align 8, !tbaa !41
  store ptr %32, ptr %arrayidx.i.i.i160.prol, align 8, !tbaa !41
  ...
  br i1 %prol.iter257.cmp.not, label %for.body.i.i.i158.prol.loopexit, label %for.body.i.i.i158.prol, !llvm.loop !109
...
for.body.i.i.i158:                                ; preds = %for.body.i.i.i158.prol.loopexit, %for.body.i.i.i158
  ...
  %34 = load ptr, ptr %arrayidx3.i.i.i161, align 8, !tbaa !41
  store ptr %34, ptr %arrayidx.i.i.i160, align 8, !tbaa !41
  ...
  %35 = load ptr, ptr %arrayidx3.i.i.i161.1, align 8, !tbaa !41
  store ptr %35, ptr %arrayidx.i.i.i160.1, align 8, !tbaa !41
  ...
  %36 = load ptr, ptr %arrayidx3.i.i.i161.2, align 8, !tbaa !41
  store ptr %36, ptr %arrayidx.i.i.i160.2, align 8, !tbaa !41
  ...
  %37 = load ptr, ptr %arrayidx3.i.i.i161.3, align 8, !tbaa !41
  store ptr %37, ptr %arrayidx.i.i.i160.3, align 8, !tbaa !41
  ...
  br i1 %exitcond.not.i.i.i163.3, label %if.then3.i.i.i151, label %for.body.i.i.i158, !llvm.loop !110
...
_ZN20btAlignedObjectArrayIPK10btDbvtNodeE9push_backERKS2_.exit167: ; preds = %invoke.cont17._ZN20btAlignedObjectArrayIPK10btDbvtNodeE9push_backERKS2_.exit167_crit_edge, %if.then3.i.i.i151
  ...
  store ptr %38, ptr %arrayidx.i129, align 8, !tbaa !41
...
entry:
  ...
  store <2 x float> %26, ptr %ref.tmp17.sroa.4.0.pa.sroa_idx, align 4, !tbaa !72
  store <2 x float> %26, ptr %ref.tmp38.sroa.4.0.pb.sroa_idx, align 4, !tbaa !72
  ...
  store float %27, ptr %ref.tmp38.sroa.5.0.pb.sroa_idx, align 8, !tbaa !72
  ...
  store float %27, ptr %ref.tmp17.sroa.5.0.pa.sroa_idx, align 8, !tbaa !72
  store float 0.000000e+00, ptr %ref.tmp38.sroa.6.0.pb.sroa_idx, align 4, !tbaa.struct !87
  store <2 x float> %24, ptr %pb, align 8, !tbaa !72
  ...
  store float %35, ptr %pb, align 8, !tbaa !72
  %36 = fmul <2 x float> %11, <float 1.000000e+00, float -1.000000e+00>
  %37 = fadd <2 x float> %9, %36
  store <2 x float> %37, ptr %ref.tmp17.sroa.4.0.pa.sroa_idx, align 4, !tbaa !72
  store <2 x float> %37, ptr %ref.tmp38.sroa.4.0.pb.sroa_idx, align 4, !tbaa !72
  ...
  store float 0.000000e+00, ptr %ref.tmp17.sroa.6.0.pa.sroa_idx, align 4, !tbaa.struct !87
  store float %35, ptr %pa, align 8, !tbaa !72
  store <2 x float> %37, ptr %ref.tmp17.sroa.4.0.pa.sroa_idx, align 4, !tbaa !72
  store float 0.000000e+00, ptr %ref.tmp38.sroa.6.0.pb.sroa_idx, align 4, !tbaa.struct !87
  store <2 x float> %34, ptr %pb, align 8, !tbaa !72
  %38 = extractelement <2 x float> %37, i64 1
  store float %38, ptr %ref.tmp38.sroa.5.0.pb.sroa_idx, align 8, !tbaa !72
  ...
  store float 0.000000e+00, ptr %ref.tmp17.sroa.6.0.pa.sroa_idx, align 4, !tbaa.struct !87
  store <2 x float> %34, ptr %pa, align 8, !tbaa !72
  store float %38, ptr %ref.tmp17.sroa.5.0.pa.sroa_idx, align 8, !tbaa !72
  store float 0.000000e+00, ptr %ref.tmp38.sroa.6.0.pb.sroa_idx, align 4, !tbaa.struct !87
  store <2 x float> %34, ptr %pb, align 8, !tbaa !72
  ...
  store float %44, ptr %pb, align 8, !tbaa !72
  %45 = fmul <2 x float> %11, <float -1.000000e+00, float 1.000000e+00>
  %46 = fadd <2 x float> %9, %45
  store <2 x float> %46, ptr %ref.tmp17.sroa.4.0.pa.sroa_idx, align 4, !tbaa !72
  store <2 x float> %46, ptr %ref.tmp38.sroa.4.0.pb.sroa_idx, align 4, !tbaa !72
  ...
  store float 0.000000e+00, ptr %ref.tmp17.sroa.6.0.pa.sroa_idx, align 4, !tbaa.struct !87
  store float %44, ptr %pa, align 8, !tbaa !72
  store <2 x float> %46, ptr %ref.tmp17.sroa.4.0.pa.sroa_idx, align 4, !tbaa !72
  store float 0.000000e+00, ptr %ref.tmp38.sroa.6.0.pb.sroa_idx, align 4, !tbaa.struct !87
  store <2 x float> %43, ptr %pb, align 8, !tbaa !72
  %47 = extractelement <2 x float> %46, i64 1
  store float %47, ptr %ref.tmp38.sroa.5.0.pb.sroa_idx, align 8, !tbaa !72
  ...
  store float 0.000000e+00, ptr %ref.tmp17.sroa.6.0.pa.sroa_idx, align 4, !tbaa.struct !87
  store <2 x float> %43, ptr %pa, align 8, !tbaa !72
  store float %47, ptr %ref.tmp17.sroa.5.0.pa.sroa_idx, align 8, !tbaa !72
  store float 0.000000e+00, ptr %ref.tmp38.sroa.6.0.pb.sroa_idx, align 4, !tbaa.struct !87
  store <2 x float> %43, ptr %pb, align 8, !tbaa !72
