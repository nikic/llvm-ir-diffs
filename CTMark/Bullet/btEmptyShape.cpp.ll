; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btEmptyShape.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btEmptyShape.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [15 x ptr] }, ptr @_ZTV12btEmptyShape, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
entry:
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i, ptr %ref.tmp10.sroa.4.0..sroa_idx, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i27, ptr %ref.tmp13.sroa.4.0..sroa_idx, align 4
  ret void
}
...
define dso_local void @_ZNK12btEmptyShape21calculateLocalInertiaEfR9btVector3(ptr nocapture nonnull readnone align 8 %this, float %0, ptr nocapture nonnull readnone align 4 %1) unnamed_addr #5 align 2 {
entry:
  ret void
}
