; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSoftBodyHelpers.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSoftBodyHelpers.cpp"
...
%class.HullResult = type { i8, i32, %class.btAlignedObjectArray.8, i32, i32, %class.btAlignedObjectArray.80 }
...
%class.HullLibrary = type { %class.btAlignedObjectArray.84, %class.btAlignedObjectArray.68 }
...
%class.btSoftBody = type { %class.btCollisionObject, %class.btAlignedObjectArray, %"struct.btSoftBody::Config", %"struct.btSoftBody::SolverState", [4 x i8], %"struct.btSoftBody::Pose", ptr, ptr, %class.btAlignedObjectArray.16, %class.btAlignedObjectArray.20, %class.btAlignedObjectArray.24, %class.btAlignedObjectArray.28, %class.btAlignedObjectArray.32, %class.btAlignedObjectArray.36, %class.btAlignedObjectArray.40, %class.btAlignedObjectArray.44, %class.btAlignedObjectArray.48, %class.btAlignedObjectArray.52, float, [2 x %class.btVector3], i8, %struct.btDbvt, %struct.btDbvt, %struct.btDbvt, %class.btAlignedObjectArray.60, %class.btAlignedObjectArray.64, %class.btTransform, %class.btAlignedObjectArray.68 }
...
%"struct.btSoftBody::Cluster" = type { %class.btAlignedObjectArray.76, %class.btAlignedObjectArray.12, %class.btAlignedObjectArray.8, %class.btTransform, float, float, %class.btMatrix3x3, %class.btMatrix3x3, %class.btVector3, [2 x %class.btVector3], [2 x %class.btVector3], i32, i32, %class.btVector3, %class.btVector3, ptr, float, float, float, float, float, float, i8, i8, i32 }
...
for.cond.preheader:                               ; preds = %entry
  ...
  %cmp93297 = icmp sgt i32 %0, 0
  br i1 %cmp93297, label %for.body.lr.ph, label %if.end71
...
for.body:                                         ; preds = %for.body.lr.ph, %cleanup
  ...
  %9 = load ptr, ptr %m_material, align 8
...
if.end:                                           ; preds = %for.body
  ...
  %12 = load float, ptr %arrayidx5.i1171, align 4
  ...
  %14 = load <2 x float>, ptr %m_x, align 4
  ...
  store <4 x float> <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %ref.tmp27, align 16
  ...
  %19 = load float, ptr %arrayidx5.i1171, align 4
  ...
  %21 = load <2 x float>, ptr %m_x, align 4
  ...
  store <4 x float> <float 0.000000e+00, float 1.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %ref.tmp45, align 16
  %vtable49 = load ptr, ptr %idraw, align 8
  ...
  %25 = load <2 x float>, ptr %m_x, align 4
  ...
  %27 = load <2 x float>, ptr %m_x, align 4
  ...
  store <4 x float> <float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00>, ptr %ref.tmp65, align 16
  %vtable69 = load ptr, ptr %idraw, align 8
...
for.cond75.preheader:                             ; preds = %if.end71
  ...
  %33 = load i32, ptr %m_size.i1254, align 4
  %cmp773299 = icmp sgt i32 %33, 0
  br i1 %cmp773299, label %for.body78.lr.ph, label %if.end99
...
for.body78:                                       ; preds = %for.body78.lr.ph, %cleanup93
  ...
  %indvars.iv3339 = phi i64 [ 0, %for.body78.lr.ph ], [ %indvars.iv.next3340, %cleanup93 ]
  %35 = load ptr, ptr %m_data.i1255, align 8
  %m_material81 = getelementptr inbounds %"struct.btSoftBody::Link", ptr %35, i64 %indvars.iv3339, i32 0, i32 1
  %36 = load ptr, ptr %m_material81, align 8
  %m_flags82 = getelementptr inbounds %"struct.btSoftBody::Material", ptr %36, i64 0, i32 4
  %37 = load i32, ptr %m_flags82, align 4
  %and83 = and i32 %37, 1
  %cmp84 = icmp eq i32 %and83, 0
  br i1 %cmp84, label %cleanup93, label %if.end86

if.end86:                                         ; preds = %for.body78
  %m_n = getelementptr inbounds %"struct.btSoftBody::Link", ptr %35, i64 %indvars.iv3339, i32 1
  %38 = load ptr, ptr %m_n, align 8
  %m_x87 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %38, i64 0, i32 1
  %arrayidx89 = getelementptr inbounds %"struct.btSoftBody::Link", ptr %35, i64 %indvars.iv3339, i32 1, i64 1
  %39 = load ptr, ptr %arrayidx89, align 8
  %m_x90 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %39, i64 0, i32 1
  %vtable91 = load ptr, ptr %idraw, align 8
  ...
  %.pre3383 = load i32, ptr %m_size.i1254, align 4
  br label %cleanup93

cleanup93:                                        ; preds = %for.body78, %if.end86
  %41 = phi i32 [ %34, %for.body78 ], [ %.pre3383, %if.end86 ]
  %indvars.iv.next3340 = add nuw nsw i64 %indvars.iv3339, 1
  %42 = sext i32 %41 to i64
  %cmp77 = icmp slt i64 %indvars.iv.next3340, %42
...
for.cond103.preheader:                            ; preds = %if.end99
  ...
  %43 = load i32, ptr %m_size.i1258, align 4
  %cmp1063301 = icmp sgt i32 %43, 0
  br i1 %cmp1063301, label %for.body107.lr.ph, label %if.end144
...
for.body107:                                      ; preds = %for.body107.lr.ph, %cleanup138
  ...
  %indvars.iv3342 = phi i64 [ 0, %for.body107.lr.ph ], [ %indvars.iv.next3343, %cleanup138 ]
  %48 = load ptr, ptr %m_data.i1259, align 8
  %m_material111 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %48, i64 %indvars.iv3342, i32 0, i32 1
  %49 = load ptr, ptr %m_material111, align 8
  %m_flags112 = getelementptr inbounds %"struct.btSoftBody::Material", ptr %49, i64 0, i32 4
  %50 = load i32, ptr %m_flags112, align 4
  %and113 = and i32 %50, 1
  %cmp114 = icmp eq i32 %and113, 0
  br i1 %cmp114, label %cleanup138, label %if.end116

if.end116:                                        ; preds = %for.body107
  %m_n117 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %48, i64 %indvars.iv3342, i32 5
  %arrayidx7.i1263 = getelementptr inbounds [4 x float], ptr %m_n117, i64 0, i64 2
  %51 = load float, ptr %arrayidx7.i1263, align 4
  %mul8.i = fmul float %51, 5.000000e-01
  %m_x120 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %48, i64 %indvars.iv3342, i32 1
  %52 = load <2 x float>, ptr %m_n117, align 4
  ...
  %vtable125 = load ptr, ptr %idraw, align 8
  ...
  %58 = load <2 x float>, ptr %m_x120, align 4
  %59 = fsub <2 x float> %58, %53
  %60 = load float, ptr %arrayidx11.i1273, align 4
  ...
  %61 = load <2 x float>, ptr %ncolor, align 16
  %62 = fmul <2 x float> %61, <float 5.000000e-01, float 5.000000e-01>
  %63 = load float, ptr %arrayidx5.i1163, align 8
  ...
  %vtable136 = load ptr, ptr %idraw, align 8
  ...
  %.pre3384 = load i32, ptr %m_size.i1258, align 4
  br label %cleanup138

cleanup138:                                       ; preds = %for.body107, %if.end116
  %65 = phi i32 [ %47, %for.body107 ], [ %.pre3384, %if.end116 ]
  %indvars.iv.next3343 = add nuw nsw i64 %indvars.iv3342, 1
  %66 = sext i32 %65 to i64
  %cmp106 = icmp slt i64 %indvars.iv.next3343, %66
...
init.end:                                         ; preds = %init, %init.check, %if.then147
  ...
  %70 = load i32, ptr %m_size.i1303, align 4
  %cmp1693303 = icmp sgt i32 %70, 0
  br i1 %cmp1693303, label %for.body170.lr.ph, label %if.end253
...
for.body170:                                      ; preds = %for.body170.lr.ph, %for.body170
  %indvars.iv3345 = phi i64 [ 0, %for.body170.lr.ph ], [ %indvars.iv.next3346, %for.body170 ]
  %77 = load ptr, ptr %m_data.i1304, align 8
  %arrayidx.i1306 = getelementptr inbounds %"struct.btSoftBody::RContact", ptr %77, i64 %indvars.iv3345
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %o) #18
  %m_node = getelementptr inbounds %"struct.btSoftBody::RContact", ptr %77, i64 %indvars.iv3345, i32 1
  %78 = load ptr, ptr %m_node, align 8
  ...
  %79 = load float, ptr %arrayidx10.i.i, align 4
  %arrayidx12.i.i = getelementptr inbounds %"struct.btSoftBody::sCti", ptr %arrayidx.i1306, i64 0, i32 1, i32 0, i64 2
  %80 = load float, ptr %arrayidx12.i.i, align 4
  %m_offset = getelementptr inbounds %"struct.btSoftBody::sCti", ptr %arrayidx.i1306, i64 0, i32 2
  %81 = load float, ptr %m_offset, align 8
  %82 = load <2 x float>, ptr %m_x173, align 4
  %83 = load <2 x float>, ptr %m_normal, align 4
  ...
  %93 = load float, ptr %m_normal, align 4
  %94 = load <2 x float>, ptr %arrayidx7.i.i, align 4
  ...
  %98 = load <2 x float>, ptr %arrayidx7.i.i1332, align 4
  %99 = load float, ptr %arrayidx192, align 16
  ...
  %vtable216 = load ptr, ptr %idraw, align 8
  ...
  %141 = load <2 x float>, ptr %o, align 8
  %142 = fsub <2 x float> %141, %140
  %143 = load float, ptr %71, align 8
  ...
  %vtable230 = load ptr, ptr %idraw, align 8
  ...
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %ref.tmp244, align 16
  %vtable248 = load ptr, ptr %idraw, align 8
  ...
  %154 = load i32, ptr %m_size.i1303, align 4
  %155 = sext i32 %154 to i64
  %cmp169 = icmp slt i64 %indvars.iv.next3346, %155
...
for.cond257.preheader:                            ; preds = %if.end253
  ...
  %156 = load i32, ptr %m_size.i1481, align 4
  %cmp2593305 = icmp sgt i32 %156, 0
  br i1 %cmp2593305, label %for.body260.lr.ph, label %for.cond287.preheader
...
for.cond287.preheader:                            ; preds = %for.body260, %for.cond257.preheader
  ...
  %170 = load i32, ptr %m_size.i1548, align 4
  %cmp2903307 = icmp sgt i32 %170, 0
  br i1 %cmp2903307, label %for.body291.lr.ph, label %if.end315
...
for.body260:                                      ; preds = %for.body260.lr.ph, %for.body260
  %indvars.iv3348 = phi i64 [ 0, %for.body260.lr.ph ], [ %indvars.iv.next3349, %for.body260 ]
  %177 = load ptr, ptr %m_data.i1482, align 8
  %arrayidx.i1484 = getelementptr inbounds %"struct.btSoftBody::Anchor", ptr %177, i64 %indvars.iv3348
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %q) #18
  %m_body = getelementptr inbounds %"struct.btSoftBody::Anchor", ptr %177, i64 %indvars.iv3348, i32 2
  %178 = load ptr, ptr %m_body, align 8
  %m_worldTransform.i = getelementptr inbounds %class.btCollisionObject, ptr %178, i64 0, i32 1
  %m_local = getelementptr inbounds %"struct.btSoftBody::Anchor", ptr %177, i64 %indvars.iv3348, i32 1
  %179 = load float, ptr %m_worldTransform.i, align 4
  %180 = load float, ptr %m_local, align 4
  %arrayidx5.i.i.i = getelementptr inbounds %class.btCollisionObject, ptr %178, i64 0, i32 1, i32 0, i32 0, i64 0, i32 0, i64 1
  %181 = load float, ptr %arrayidx5.i.i.i, align 4
  %arrayidx7.i.i.i = getelementptr inbounds [4 x float], ptr %m_local, i64 0, i64 1
  %182 = load float, ptr %arrayidx7.i.i.i, align 4
  %arrayidx10.i.i.i = getelementptr inbounds %class.btCollisionObject, ptr %178, i64 0, i32 1, i32 0, i32 0, i64 0, i32 0, i64 2
  %183 = load float, ptr %arrayidx10.i.i.i, align 4
  %arrayidx12.i.i.i = getelementptr inbounds [4 x float], ptr %m_local, i64 0, i64 2
  %184 = load float, ptr %arrayidx12.i.i.i, align 4
  ...
  %191 = insertelement <2 x float> %190, float %186, i64 1
  %192 = fmul <2 x float> %189, %191
  %193 = insertelement <2 x float> poison, float %179, i64 0
  %194 = insertelement <2 x float> %193, float %185, i64 1
  ...
  %199 = insertelement <2 x float> %198, float %187, i64 1
  ...
  %203 = load <2 x float>, ptr %m_origin.i.i, align 4
  ...
  %205 = load float, ptr %arrayidx.i26.i.i, align 4
  %arrayidx5.i27.i.i = getelementptr inbounds %class.btCollisionObject, ptr %178, i64 0, i32 1, i32 0, i32 0, i64 2, i32 0, i64 1
  %206 = load float, ptr %arrayidx5.i27.i.i, align 4
  %mul8.i29.i.i = fmul float %182, %206
  %207 = call float @llvm.fmuladd.f32(float %205, float %180, float %mul8.i29.i.i)
  %arrayidx10.i30.i.i = getelementptr inbounds %class.btCollisionObject, ptr %178, i64 0, i32 1, i32 0, i32 0, i64 2, i32 0, i64 2
  %208 = load float, ptr %arrayidx10.i30.i.i, align 4
  %209 = call float @llvm.fmuladd.f32(float %208, float %184, float %207)
  %arrayidx.i32.i.i = getelementptr inbounds %class.btCollisionObject, ptr %178, i64 0, i32 1, i32 1, i32 0, i64 2
  %210 = load float, ptr %arrayidx.i32.i.i, align 4
  ...
  %211 = load ptr, ptr %arrayidx.i1484, align 8
  ...
  store <4 x float> <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %ref.tmp268, align 16
  ...
  %212 = load float, ptr %arrayidx11.i.i, align 4
  ...
  %213 = load <2 x float>, ptr %m_x267, align 4
  ...
  %218 = load float, ptr %arrayidx11.i.i, align 4
  ...
  %219 = load <2 x float>, ptr %m_x267, align 4
  ...
  %223 = load <2 x float>, ptr %m_x267, align 4
  %224 = load float, ptr %arrayidx11.i.i, align 4
  ...
  store <4 x float> <float 0.000000e+00, float 1.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %ref.tmp272, align 16
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp.i1501) #18
  %227 = load float, ptr %157, align 8
  ...
  %228 = load <2 x float>, ptr %q, align 8
  ...
  %vtable.i1519 = load ptr, ptr %idraw, align 8
  ...
  %233 = load float, ptr %157, align 8
  ...
  %234 = load <2 x float>, ptr %q, align 8
  ...
  %vtable22.i1531 = load ptr, ptr %idraw, align 8
  ...
  %238 = load <2 x float>, ptr %q, align 8
  %239 = load float, ptr %157, align 8
  ...
  %vtable36.i1543 = load ptr, ptr %idraw, align 8
  ...
  %242 = load ptr, ptr %arrayidx.i1484, align 8
  ...
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 0.000000e+00>, ptr %ref.tmp278, align 16
  %vtable282 = load ptr, ptr %idraw, align 8
  ...
  %244 = load i32, ptr %m_size.i1481, align 4
  %245 = sext i32 %244 to i64
  %cmp259 = icmp slt i64 %indvars.iv.next3349, %245
...
for.body291:                                      ; preds = %for.body291.lr.ph, %cleanup309
  ...
  %indvars.iv3351 = phi i64 [ 0, %for.body291.lr.ph ], [ %indvars.iv.next3352, %cleanup309 ]
  %247 = load ptr, ptr %m_data.i1549, align 8
  %m_material295 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %247, i64 %indvars.iv3351, i32 0, i32 1
  %248 = load ptr, ptr %m_material295, align 8
  %m_flags296 = getelementptr inbounds %"struct.btSoftBody::Material", ptr %248, i64 0, i32 4
  %249 = load i32, ptr %m_flags296, align 4
  %and297 = and i32 %249, 1
  %cmp298 = icmp eq i32 %and297, 0
  %m_im = getelementptr inbounds %"struct.btSoftBody::Node", ptr %247, i64 %indvars.iv3351, i32 6
...
if.then302:                                       ; preds = %for.body291
  %m_x303 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %247, i64 %indvars.iv3351, i32 1
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp304) #18
  store <4 x float> <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %ref.tmp304, align 16
  ...
  %vtable.i1573 = load ptr, ptr %idraw, align 8
  ...
  %vtable22.i1585 = load ptr, ptr %idraw, align 8
  ...
  %262 = load <2 x float>, ptr %m_x303, align 4
  %263 = load float, ptr %arrayidx11.i.i1563, align 4
  ...
  %vtable36.i1597 = load ptr, ptr %idraw, align 8
  ...
  %.pre3385 = load i32, ptr %m_size.i1548, align 4
  br label %cleanup309

cleanup309:                                       ; preds = %if.then302, %for.body291
  %266 = phi i32 [ %.pre3385, %if.then302 ], [ %246, %for.body291 ]
  %indvars.iv.next3352 = add nuw nsw i64 %indvars.iv3351, 1
  %267 = sext i32 %266 to i64
  %cmp290 = icmp slt i64 %indvars.iv.next3352, %267
...
if.then318:                                       ; preds = %if.end315
  ...
  %268 = load i32, ptr %m_size.i1602, align 4
  %cmp3253309 = icmp sgt i32 %268, 0
  br i1 %cmp3253309, label %for.body326.lr.ph, label %for.end396
...
for.body326:                                      ; preds = %for.body326.lr.ph, %cleanup391
  ...
  %indvars.iv3354 = phi i64 [ 0, %for.body326.lr.ph ], [ %indvars.iv.next3355, %cleanup391 ]
  %273 = load ptr, ptr %m_data.i1603, align 8
  %m_material329 = getelementptr inbounds %"struct.btSoftBody::Face", ptr %273, i64 %indvars.iv3354, i32 0, i32 1
  %274 = load ptr, ptr %m_material329, align 8
  %m_flags330 = getelementptr inbounds %"struct.btSoftBody::Material", ptr %274, i64 0, i32 4
  %275 = load i32, ptr %m_flags330, align 4
  %and331 = and i32 %275, 1
  %cmp332 = icmp eq i32 %and331, 0
  br i1 %cmp332, label %cleanup391, label %if.end334

if.end334:                                        ; preds = %for.body326
  %m_n336 = getelementptr inbounds %"struct.btSoftBody::Face", ptr %273, i64 %indvars.iv3354, i32 1
  %276 = load ptr, ptr %m_n336, align 8
  %m_x338 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %276, i64 0, i32 1
  %x335.sroa.0.0.copyload = load float, ptr %m_x338, align 8
  %x335.sroa.5.0.m_x338.sroa_idx = getelementptr inbounds %"struct.btSoftBody::Node", ptr %276, i64 0, i32 1, i32 0, i64 1
  %x335.sroa.5.0.copyload = load float, ptr %x335.sroa.5.0.m_x338.sroa_idx, align 4
  %x335.sroa.7.0.m_x338.sroa_idx = getelementptr inbounds %"struct.btSoftBody::Node", ptr %276, i64 0, i32 1, i32 0, i64 2
  %x335.sroa.7.0.copyload = load float, ptr %x335.sroa.7.0.m_x338.sroa_idx, align 8
  %arrayidx340 = getelementptr inbounds %"struct.btSoftBody::Face", ptr %273, i64 %indvars.iv3354, i32 1, i64 1
  %277 = load ptr, ptr %arrayidx340, align 8
  ...
  %x335.sroa.14.16.copyload = load float, ptr %x335.sroa.14.16.m_x341.sroa_idx, align 8
  %arrayidx344 = getelementptr inbounds %"struct.btSoftBody::Face", ptr %273, i64 %indvars.iv3354, i32 1, i64 2
  %278 = load ptr, ptr %arrayidx344, align 8
  ...
  %x335.sroa.21.32.copyload = load float, ptr %x335.sroa.21.32.m_x345.sroa_idx, align 8
  ...
  %vtable389 = load ptr, ptr %idraw, align 8
  ...
  %.pre3386 = load i32, ptr %m_size.i1602, align 4
  br label %cleanup391

cleanup391:                                       ; preds = %for.body326, %if.end334
  %300 = phi i32 [ %272, %for.body326 ], [ %.pre3386, %if.end334 ]
  %indvars.iv.next3355 = add nuw nsw i64 %indvars.iv3354, 1
  %301 = sext i32 %300 to i64
  %cmp325 = icmp slt i64 %indvars.iv.next3355, %301
...
if.then400:                                       ; preds = %if.end397
  ...
  %302 = load i32, ptr %m_size.i1740, align 4
  %cmp4033315 = icmp sgt i32 %302, 0
  br i1 %cmp4033315, label %for.body404.lr.ph, label %if.end594
...
for.body404.lr.ph:                                ; preds = %if.then400
  ...
  %m_ownsMemory.i.i.i1794 = getelementptr inbounds %class.btAlignedObjectArray.84, ptr %hlib, i64 0, i32 6
  %m_data.i.i.i1795 = getelementptr inbounds %class.btAlignedObjectArray.84, ptr %hlib, i64 0, i32 5
  %m_size.i.i.i1796 = getelementptr inbounds %class.btAlignedObjectArray.84, ptr %hlib, i64 0, i32 2
  %m_capacity.i.i.i1797 = getelementptr inbounds %class.btAlignedObjectArray.84, ptr %hlib, i64 0, i32 3
...
for.body404:                                      ; preds = %for.body404.lr.ph, %if.end544
  %indvars.iv3366 = phi i64 [ 0, %for.body404.lr.ph ], [ %indvars.iv.next3367, %if.end544 ]
  %306 = load ptr, ptr %m_data.i1741, align 8
  %arrayidx.i1743 = getelementptr inbounds ptr, ptr %306, i64 %indvars.iv3366
  %307 = load ptr, ptr %arrayidx.i1743, align 8
  %m_collide = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %307, i64 0, i32 23
  %308 = load i8, ptr %m_collide, align 1
...
if.then408:                                       ; preds = %for.body404
  ...
  store <2 x float> %320, ptr %color, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i1767, ptr %arrayidx5.i1745, align 8
  %321 = load ptr, ptr %m_data.i1741, align 8
  %arrayidx.i1772 = getelementptr inbounds ptr, ptr %321, i64 %indvars.iv3366
  %322 = load ptr, ptr %arrayidx.i1772, align 8
  %m_size.i1773 = getelementptr inbounds %class.btAlignedObjectArray.76, ptr %322, i64 0, i32 2
  %323 = load i32, ptr %m_size.i1773, align 4
...
for.body442:                                      ; preds = %for.body442, %for.body442.preheader.new
  %indvars.iv3357 = phi i64 [ 0, %for.body442.preheader.new ], [ %indvars.iv.next3358.1, %for.body442 ]
  %niter = phi i64 [ 0, %for.body442.preheader.new ], [ %niter.next.1, %for.body442 ]
  %325 = load ptr, ptr %m_data.i1741, align 8
  %arrayidx.i1782 = getelementptr inbounds ptr, ptr %325, i64 %indvars.iv3366
  %326 = load ptr, ptr %arrayidx.i1782, align 8
  %m_data.i1783 = getelementptr inbounds %class.btAlignedObjectArray.76, ptr %326, i64 0, i32 5
  %327 = load ptr, ptr %m_data.i1783, align 8
  %arrayidx.i1785 = getelementptr inbounds ptr, ptr %327, i64 %indvars.iv3357
  %328 = load ptr, ptr %arrayidx.i1785, align 8
  %m_x449 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %328, i64 0, i32 1
  %arrayidx.i1788 = getelementptr inbounds %class.btVector3, ptr %call.i.i.i.i1778, i64 %indvars.iv3357
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx.i1788, ptr noundef nonnull align 8 dereferenceable(16) %m_x449, i64 16, i1 false)
  %indvars.iv.next3358 = or i64 %indvars.iv3357, 1
  %329 = load ptr, ptr %m_data.i1741, align 8
  %arrayidx.i1782.1 = getelementptr inbounds ptr, ptr %329, i64 %indvars.iv3366
  %330 = load ptr, ptr %arrayidx.i1782.1, align 8
  %m_data.i1783.1 = getelementptr inbounds %class.btAlignedObjectArray.76, ptr %330, i64 0, i32 5
  %331 = load ptr, ptr %m_data.i1783.1, align 8
  %arrayidx.i1785.1 = getelementptr inbounds ptr, ptr %331, i64 %indvars.iv.next3358
  %332 = load ptr, ptr %arrayidx.i1785.1, align 8
  %m_x449.1 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %332, i64 0, i32 1
  %arrayidx.i1788.1 = getelementptr inbounds %class.btVector3, ptr %call.i.i.i.i1778, i64 %indvars.iv.next3358
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx.i1788.1, ptr noundef nonnull align 8 dereferenceable(16) %m_x449.1, i64 16, i1 false)
  %indvars.iv.next3358.1 = add nuw nsw i64 %indvars.iv3357, 2
...
invoke.cont464.loopexit.unr-lcssa:                ; preds = %for.body442, %for.body442.preheader
  %indvars.iv3357.unr = phi i64 [ 0, %for.body442.preheader ], [ %indvars.iv.next3358.1, %for.body442 ]
...
for.body442.epil:                                 ; preds = %invoke.cont464.loopexit.unr-lcssa
  %334 = load ptr, ptr %m_data.i1741, align 8
  %arrayidx.i1782.epil = getelementptr inbounds ptr, ptr %334, i64 %indvars.iv3366
  %335 = load ptr, ptr %arrayidx.i1782.epil, align 8
  %m_data.i1783.epil = getelementptr inbounds %class.btAlignedObjectArray.76, ptr %335, i64 0, i32 5
  %336 = load ptr, ptr %m_data.i1783.epil, align 8
  %arrayidx.i1785.epil = getelementptr inbounds ptr, ptr %336, i64 %indvars.iv3357.unr
  %337 = load ptr, ptr %arrayidx.i1785.epil, align 8
  %m_x449.epil = getelementptr inbounds %"struct.btSoftBody::Node", ptr %337, i64 0, i32 1
  %arrayidx.i1788.epil = getelementptr inbounds %class.btVector3, ptr %call.i.i.i.i1778, i64 %indvars.iv3357.unr
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx.i1788.epil, ptr noundef nonnull align 8 dereferenceable(16) %m_x449.epil, i64 16, i1 false)
  br label %invoke.cont464

invoke.cont464:                                   ; preds = %for.body442.epil, %invoke.cont464.loopexit.unr-lcssa, %if.then408, %invoke.cont436
  %vertices.sroa.173159.13392 = phi ptr [ %call.i.i.i.i1778, %invoke.cont436 ], [ null, %if.then408 ], [ %call.i.i.i.i1778, %invoke.cont464.loopexit.unr-lcssa ], [ %call.i.i.i.i1778, %for.body442.epil ]
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %hdsc) #18
  store i32 1, ptr %hdsc, align 8
  store i32 %323, ptr %mVcount.i, align 4
  store ptr %vertices.sroa.173159.13392, ptr %mVertices.i, align 8
  ...
  store i8 1, ptr %m_ownsMemory.i.i.i1791, align 8
  store ptr null, ptr %m_data.i.i.i1792, align 8
  store i32 0, ptr %m_size.i.i.i, align 4
  store i32 0, ptr %m_capacity.i.i.i1793, align 8
  ...
  store i8 1, ptr %m_ownsMemory.i.i.i1794, align 8
  store ptr null, ptr %m_data.i.i.i1795, align 8
  store i32 0, ptr %m_size.i.i.i1796, align 4
  store i32 0, ptr %m_capacity.i.i.i1797, align 8
  store i8 1, ptr %m_ownsMemory.i.i4.i1798, align 8
  store ptr null, ptr %m_data.i.i5.i1799, align 8
  store i32 0, ptr %m_size.i.i6.i1800, align 4
  store i32 0, ptr %m_capacity.i.i7.i1801, align 8
  store i32 %323, ptr %mMaxVertices.i, align 8
...
invoke.cont468:                                   ; preds = %invoke.cont464
  %m_OutputVertices.val = load i32, ptr %m_size.i.i.i, align 4
  %m_OutputVertices.val1155 = load ptr, ptr %m_data.i.i.i1792, align 8
  %cmp.i1803 = icmp sgt i32 %m_OutputVertices.val, 0
  br i1 %cmp.i1803, label %if.then.i.i1813, label %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit1862

if.then.i.i1813:                                  ; preds = %invoke.cont468
  %338 = sitofp i32 %m_OutputVertices.val to float
  %retval.sroa.0.0.copyload.i.i = load <2 x float>, ptr %m_OutputVertices.val1155, align 4
  %retval.sroa.6.0.items.16.val.sroa_idx.i.i = getelementptr inbounds i8, ptr %m_OutputVertices.val1155, i64 8
  %retval.sroa.6.0.copyload.i.i = load <2 x float>, ptr %retval.sroa.6.0.items.16.val.sroa_idx.i.i, align 4
  %cmp6.i.not.i = icmp eq i32 %m_OutputVertices.val, 1
  br i1 %cmp6.i.not.i, label %invoke.cont477.thread3405, label %for.body.preheader.i.i

invoke.cont477.thread3405:                        ; preds = %if.then.i.i1813
  %div.i.i18043409 = fdiv float 1.000000e+00, %338
  %339 = insertelement <2 x float> poison, float %div.i.i18043409, i64 0
  ...
  %ref.tmp.sroa.5.8.vec.extract.i3414 = extractelement <2 x float> %retval.sroa.6.0.copyload.i.i, i64 0
  %mul8.i.i.i18073415 = fmul float %div.i.i18043409, %ref.tmp.sroa.5.8.vec.extract.i3414
  br label %for.body.lr.ph.i

for.body.preheader.i.i:                           ; preds = %if.then.i.i1813
  %wide.trip.count.i.i = zext i32 %m_OutputVertices.val to i64
  %342 = add nsw i64 %wide.trip.count.i.i, -1
  %xtraiter3445 = and i64 %342, 1
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.preheader.i.i.new
  ...
  %niter3450 = phi i64 [ 0, %for.body.preheader.i.i.new ], [ %niter3450.next.1, %for.body.i.i ]
  %arrayidx.i.i.i1814 = getelementptr inbounds %class.btVector3, ptr %m_OutputVertices.val1155, i64 %indvars.iv.i.i
  %344 = load <2 x float>, ptr %arrayidx.i.i.i1814, align 4
  %345 = fadd <2 x float> %retval.sroa.0.08.i.i, %344
  %arrayidx10.i.i.i1818 = getelementptr inbounds [4 x float], ptr %arrayidx.i.i.i1814, i64 0, i64 2
  %346 = load float, ptr %arrayidx10.i.i.i1818, align 4
  ...
  %arrayidx.i.i.i1814.1 = getelementptr inbounds %class.btVector3, ptr %m_OutputVertices.val1155, i64 %indvars.iv.next.i.i
  %347 = load <2 x float>, ptr %arrayidx.i.i.i1814.1, align 4
  %348 = fadd <2 x float> %345, %347
  %arrayidx10.i.i.i1818.1 = getelementptr inbounds [4 x float], ptr %arrayidx.i.i.i1814.1, i64 0, i64 2
  %349 = load float, ptr %arrayidx10.i.i.i1818.1, align 4
  ...
  %niter3450.next.1 = add i64 %niter3450, 2
  %niter3450.ncmp.1 = icmp eq i64 %niter3450.next.1, %unroll_iter3449
  br i1 %niter3450.ncmp.1, label %invoke.cont477.unr-lcssa, label %for.body.i.i
...
invoke.cont477.unr-lcssa:                         ; preds = %for.body.i.i, %for.body.preheader.i.i
  ...
  br i1 %lcmp.mod3446.not, label %invoke.cont477, label %for.body.i.i.epil

for.body.i.i.epil:                                ; preds = %invoke.cont477.unr-lcssa
  %arrayidx.i.i.i1814.epil = getelementptr inbounds %class.btVector3, ptr %m_OutputVertices.val1155, i64 %indvars.iv.i.i.unr
  %350 = load <2 x float>, ptr %arrayidx.i.i.i1814.epil, align 4
  %351 = fadd <2 x float> %retval.sroa.0.08.i.i.unr, %350
  %arrayidx10.i.i.i1818.epil = getelementptr inbounds [4 x float], ptr %arrayidx.i.i.i1814.epil, i64 0, i64 2
  %352 = load float, ptr %arrayidx10.i.i.i1818.epil, align 4
...
invoke.cont477:                                   ; preds = %invoke.cont477.unr-lcssa, %for.body.i.i.epil
  ...
  %div.i.i1804 = fdiv float 1.000000e+00, %338
  %353 = insertelement <2 x float> poison, float %div.i.i1804, i64 0
  %354 = shufflevector <2 x float> %353, <2 x float> poison, <2 x i32> zeroinitializer
  %355 = fmul <2 x float> %354, %.lcssa
  %mul8.i.i.i1807 = fmul float %div.i.i1804, %add13.i.i.i.lcssa
  br i1 %cmp.i1803, label %for.body.lr.ph.i, label %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit1862

for.body.lr.ph.i:                                 ; preds = %invoke.cont477.thread3405, %invoke.cont477
  %mul8.i.i.i18073418 = phi float [ %mul8.i.i.i18073415, %invoke.cont477.thread3405 ], [ %mul8.i.i.i1807, %invoke.cont477 ]
  %356 = phi <2 x float> [ %341, %invoke.cont477.thread3405 ], [ %355, %invoke.cont477 ]
  %wide.trip.count.i1828 = zext i32 %m_OutputVertices.val to i64
  %357 = add nsw i64 %wide.trip.count.i1828, -1
  %xtraiter3451 = and i64 %wide.trip.count.i1828, 1
  %358 = icmp eq i64 %357, 0
  br i1 %358, label %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit.unr-lcssa, label %for.body.lr.ph.i.new

for.body.lr.ph.i.new:                             ; preds = %for.body.lr.ph.i
  %unroll_iter3453 = and i64 %wide.trip.count.i1828, 4294967294
  br label %for.body.i

for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i.new
  %indvars.iv.i1829 = phi i64 [ 0, %for.body.lr.ph.i.new ], [ %indvars.iv.next.i1835.1, %for.body.i ]
  %niter3454 = phi i64 [ 0, %for.body.lr.ph.i.new ], [ %niter3454.next.1, %for.body.i ]
  %arrayidx.i.i1830 = getelementptr inbounds %class.btVector3, ptr %m_OutputVertices.val1155, i64 %indvars.iv.i1829
  %359 = load <2 x float>, ptr %arrayidx.i.i1830, align 4
  %360 = fsub <2 x float> %359, %356
  store <2 x float> %360, ptr %arrayidx.i.i1830, align 4
  %arrayidx12.i.i1834 = getelementptr inbounds [4 x float], ptr %arrayidx.i.i1830, i64 0, i64 2
  %361 = load float, ptr %arrayidx12.i.i1834, align 4
  %add13.i.i = fsub float %361, %mul8.i.i.i18073418
  store float %add13.i.i, ptr %arrayidx12.i.i1834, align 4
  ...
  %362 = load <2 x float>, ptr %arrayidx.i.i1830.1, align 4
  %363 = fsub <2 x float> %362, %356
  store <2 x float> %363, ptr %arrayidx.i.i1830.1, align 4
  %arrayidx12.i.i1834.1 = getelementptr inbounds [4 x float], ptr %arrayidx.i.i1830.1, i64 0, i64 2
  %364 = load float, ptr %arrayidx12.i.i1834.1, align 4
  %add13.i.i.1 = fsub float %364, %mul8.i.i.i18073418
  store float %add13.i.i.1, ptr %arrayidx12.i.i1834.1, align 4
  %indvars.iv.next.i1835.1 = add nuw nsw i64 %indvars.iv.i1829, 2
  %niter3454.next.1 = add i64 %niter3454, 2
  %niter3454.ncmp.1 = icmp eq i64 %niter3454.next.1, %unroll_iter3453
  br i1 %niter3454.ncmp.1, label %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit.unr-lcssa, label %for.body.i

_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit.unr-lcssa: ; preds = %for.body.i, %for.body.lr.ph.i
  %indvars.iv.i1829.unr = phi i64 [ 0, %for.body.lr.ph.i ], [ %indvars.iv.next.i1835.1, %for.body.i ]
  %lcmp.mod3452.not = icmp eq i64 %xtraiter3451, 0
  br i1 %lcmp.mod3452.not, label %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit, label %for.body.i.epil

for.body.i.epil:                                  ; preds = %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit.unr-lcssa
  %arrayidx.i.i1830.epil = getelementptr inbounds %class.btVector3, ptr %m_OutputVertices.val1155, i64 %indvars.iv.i1829.unr
  %365 = load <2 x float>, ptr %arrayidx.i.i1830.epil, align 4
  %366 = fsub <2 x float> %365, %356
  store <2 x float> %366, ptr %arrayidx.i.i1830.epil, align 4
  %arrayidx12.i.i1834.epil = getelementptr inbounds [4 x float], ptr %arrayidx.i.i1830.epil, i64 0, i64 2
  %367 = load float, ptr %arrayidx12.i.i1834.epil, align 4
  %add13.i.i.epil = fsub float %367, %mul8.i.i.i18073418
  store float %add13.i.i.epil, ptr %arrayidx12.i.i1834.epil, align 4
  br label %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit

_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit: ; preds = %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit.unr-lcssa, %for.body.i.epil
  %m_OutputVertices.val1161 = load ptr, ptr %m_data.i.i.i1792, align 8
  %xtraiter3455 = and i64 %wide.trip.count.i1828, 1
  %368 = icmp eq i64 %357, 0
  br i1 %368, label %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit1862.loopexit.unr-lcssa, label %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit.new

_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit.new: ; preds = %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit
  %unroll_iter3457 = and i64 %wide.trip.count.i1828, 4294967294
  br label %for.body.i1852

for.body.i1852:                                   ; preds = %for.body.i1852, %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit.new
  %indvars.iv.i1853 = phi i64 [ 0, %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit.new ], [ %indvars.iv.next.i1860.1, %for.body.i1852 ]
  %niter3458 = phi i64 [ 0, %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit.new ], [ %niter3458.next.1, %for.body.i1852 ]
  %arrayidx.i.i1854 = getelementptr inbounds %class.btVector3, ptr %m_OutputVertices.val1161, i64 %indvars.iv.i1853
  %369 = load <2 x float>, ptr %arrayidx.i.i1854, align 4
  %370 = fadd <2 x float> %356, %369
  store <2 x float> %370, ptr %arrayidx.i.i1854, align 4
  %arrayidx12.i.i1858 = getelementptr inbounds [4 x float], ptr %arrayidx.i.i1854, i64 0, i64 2
  %371 = load float, ptr %arrayidx12.i.i1858, align 4
  %add13.i.i1859 = fadd float %mul8.i.i.i18073418, %371
  store float %add13.i.i1859, ptr %arrayidx12.i.i1858, align 4
  %indvars.iv.next.i1860 = or i64 %indvars.iv.i1853, 1
  %arrayidx.i.i1854.1 = getelementptr inbounds %class.btVector3, ptr %m_OutputVertices.val1161, i64 %indvars.iv.next.i1860
  %372 = load <2 x float>, ptr %arrayidx.i.i1854.1, align 4
  %373 = fadd <2 x float> %356, %372
  store <2 x float> %373, ptr %arrayidx.i.i1854.1, align 4
  %arrayidx12.i.i1858.1 = getelementptr inbounds [4 x float], ptr %arrayidx.i.i1854.1, i64 0, i64 2
  %374 = load float, ptr %arrayidx12.i.i1858.1, align 4
  %add13.i.i1859.1 = fadd float %mul8.i.i.i18073418, %374
  store float %add13.i.i1859.1, ptr %arrayidx12.i.i1858.1, align 4
  %indvars.iv.next.i1860.1 = add nuw nsw i64 %indvars.iv.i1853, 2
  %niter3458.next.1 = add i64 %niter3458, 2
  %niter3458.ncmp.1 = icmp eq i64 %niter3458.next.1, %unroll_iter3457
  br i1 %niter3458.ncmp.1, label %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit1862.loopexit.unr-lcssa, label %for.body.i1852

_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit1862.loopexit.unr-lcssa: ; preds = %for.body.i1852, %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit
  %indvars.iv.i1853.unr = phi i64 [ 0, %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit ], [ %indvars.iv.next.i1860.1, %for.body.i1852 ]
  %lcmp.mod3456.not = icmp eq i64 %xtraiter3455, 0
  br i1 %lcmp.mod3456.not, label %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit1862, label %for.body.i1852.epil

for.body.i1852.epil:                              ; preds = %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit1862.loopexit.unr-lcssa
  %arrayidx.i.i1854.epil = getelementptr inbounds %class.btVector3, ptr %m_OutputVertices.val1161, i64 %indvars.iv.i1853.unr
  %375 = load <2 x float>, ptr %arrayidx.i.i1854.epil, align 4
  %376 = fadd <2 x float> %356, %375
  store <2 x float> %376, ptr %arrayidx.i.i1854.epil, align 4
  %arrayidx12.i.i1858.epil = getelementptr inbounds [4 x float], ptr %arrayidx.i.i1854.epil, i64 0, i64 2
  %377 = load float, ptr %arrayidx12.i.i1858.epil, align 4
  %add13.i.i1859.epil = fadd float %mul8.i.i.i18073418, %377
  store float %add13.i.i1859.epil, ptr %arrayidx12.i.i1858.epil, align 4
  br label %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit1862

_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit1862: ; preds = %for.body.i1852.epil, %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit1862.loopexit.unr-lcssa, %invoke.cont468, %invoke.cont477
  %378 = load i32, ptr %mNumFaces.i, align 8
  %cmp4903313 = icmp sgt i32 %378, 0
  br i1 %cmp4903313, label %for.body491, label %for.end527

for.body491:                                      ; preds = %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit1862, %invoke.cont523
  %indvars.iv3360 = phi i64 [ %indvars.iv.next3361, %invoke.cont523 ], [ 0, %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit1862 ]
  %379 = mul nuw nsw i64 %indvars.iv3360, 3
  %380 = load ptr, ptr %m_data.i.i5.i, align 8
  %arrayidx.i1865 = getelementptr inbounds i32, ptr %380, i64 %379
  %381 = load i32, ptr %arrayidx.i1865, align 4
  %382 = add nuw nsw i64 %379, 1
  %arrayidx.i1868 = getelementptr inbounds i32, ptr %380, i64 %382
  %383 = load i32, ptr %arrayidx.i1868, align 4
  %384 = add nuw nsw i64 %379, 2
  %arrayidx.i1871 = getelementptr inbounds i32, ptr %380, i64 %384
  %385 = load i32, ptr %arrayidx.i1871, align 4
  %386 = load ptr, ptr %m_data.i.i.i1792, align 8
  ...
  %vtable521 = load ptr, ptr %idraw, align 8
...
invoke.cont523:                                   ; preds = %for.body491
  ...
  %388 = load i32, ptr %mNumFaces.i, align 8
  %389 = sext i32 %388 to i64
  %cmp490 = icmp slt i64 %indvars.iv.next3361, %389
  br i1 %cmp490, label %for.body491, label %for.end527

lpad461:                                          ; preds = %if.then3.i.i.i10.i1899
...
invoke.cont528:                                   ; preds = %for.end527
  %395 = load ptr, ptr %m_data.i.i5.i1799, align 8
  %tobool.not.i.i.i.i = icmp eq ptr %395, null
  %396 = load i8, ptr %m_ownsMemory.i.i4.i1798, align 8
...
invoke.cont.i:                                    ; preds = %if.then3.i.i.i.i, %invoke.cont528
  ...
  store i32 0, ptr %m_size.i.i6.i1800, align 4
  store i32 0, ptr %m_capacity.i.i7.i1801, align 8
  %397 = load ptr, ptr %m_data.i.i.i1795, align 8
  %tobool.not.i.i.i6.i = icmp eq ptr %397, null
  %398 = load i8, ptr %m_ownsMemory.i.i.i1794, align 8
...
lpad.i:                                           ; preds = %if.then3.i.i.i.i
  %399 = landingpad { ptr, i32 }
          cleanup
  %400 = load ptr, ptr %m_data.i.i.i1795, align 8
  %tobool.not.i.i.i2929 = icmp eq ptr %400, null
  %401 = load i8, ptr %m_ownsMemory.i.i.i1794, align 8
...
invoke.cont531:                                   ; preds = %invoke.cont.i, %if.then3.i.i.i10.i
  ...
  %404 = load ptr, ptr %m_data.i.i5.i, align 8
  %tobool.not.i.i.i.i1883 = icmp eq ptr %404, null
  %405 = load i8, ptr %m_ownsMemory.i.i4.i, align 8
  ...
  br i1 %or.cond.i.i.i1886, label %invoke.cont.i1891, label %if.then3.i.i.i.i1887

if.then3.i.i.i.i1887:                             ; preds = %invoke.cont531
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %404)
          to label %invoke.cont.i1891 unwind label %lpad.i1888

invoke.cont.i1891:                                ; preds = %if.then3.i.i.i.i1887, %invoke.cont531
  store i8 1, ptr %m_ownsMemory.i.i4.i, align 8
  store ptr null, ptr %m_data.i.i5.i, align 8
  store i32 0, ptr %m_size.i.i6.i, align 4
  store i32 0, ptr %m_capacity.i.i7.i, align 8
  %406 = load ptr, ptr %m_data.i.i.i1792, align 8
  %tobool.not.i.i.i6.i1895 = icmp eq ptr %406, null
  %407 = load i8, ptr %m_ownsMemory.i.i.i1791, align 8
  %tobool2.not.i.i.i8.i1897 = icmp eq i8 %407, 0
  %or.cond.i.i9.i1898 = select i1 %tobool.not.i.i.i6.i1895, i1 true, i1 %tobool2.not.i.i.i8.i1897
  br i1 %or.cond.i.i9.i1898, label %invoke.cont535, label %if.then3.i.i.i10.i1899

if.then3.i.i.i10.i1899:                           ; preds = %invoke.cont.i1891
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %406)
          to label %invoke.cont535 unwind label %lpad461

lpad.i1888:                                       ; preds = %if.then3.i.i.i.i1887
  %408 = landingpad { ptr, i32 }
          cleanup
  %409 = load ptr, ptr %m_data.i.i.i1792, align 8
  %tobool.not.i.i.i2938 = icmp eq ptr %409, null
  %410 = load i8, ptr %m_ownsMemory.i.i.i1791, align 8
...
if.then3.i.i.i2942:                               ; preds = %lpad.i1888
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %409)
          to label %ehcleanup540 unwind label %terminate.lpad.i1889

terminate.lpad.i1889:                             ; preds = %if.then3.i.i.i2942
...
invoke.cont535:                                   ; preds = %invoke.cont.i1891, %if.then3.i.i.i10.i1899
  call void @llvm.lifetime.end.p0(i64 80, ptr nonnull %hres) #18
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %hdsc) #18
  %tobool.not.i.i.i1905 = icmp eq ptr %vertices.sroa.173159.13392, null
...
if.then3.i.i.i1909:                               ; preds = %invoke.cont535
  call void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %vertices.sroa.173159.13392)
...
_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit:   ; preds = %invoke.cont535, %if.then3.i.i.i1909
  ...
  %.pre3387 = load ptr, ptr %m_data.i1741, align 8
  %arrayidx.i1924.phi.trans.insert = getelementptr inbounds ptr, ptr %.pre3387, i64 %indvars.iv3366
  %.pre3388 = load ptr, ptr %arrayidx.i1924.phi.trans.insert, align 8
  br label %if.end544
...
ehcleanup540:                                     ; preds = %if.then3.i.i.i2942, %lpad.i1888, %ehcleanup534, %lpad461
  %.pn.pn.pn.pn = phi { ptr, i32 } [ %.pn.pn.pn, %ehcleanup534 ], [ %390, %lpad461 ], [ %408, %lpad.i1888 ], [ %408, %if.then3.i.i.i2942 ]
  call void @llvm.lifetime.end.p0(i64 80, ptr nonnull %hres) #18
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %hdsc) #18
  %tobool.not.i.i.i1913 = icmp eq ptr %vertices.sroa.173159.13392, null
  br i1 %tobool.not.i.i.i1913, label %invoke.cont541, label %if.then3.i.i.i1917

if.then3.i.i.i1917:                               ; preds = %ehcleanup540
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %vertices.sroa.173159.13392)
          to label %invoke.cont541 unwind label %terminate.lpad

common.resume:                                    ; preds = %lpad.i2804, %lpad.i2775, %lpad.i2756, %lpad.i2737, %lpad.i2621, %lpad.i2600, %lpad.i2558, %lpad.i2520, %invoke.cont541
  %common.resume.op = phi { ptr, i32 } [ %.pn.pn.pn.pn.pn3251, %invoke.cont541 ], [ %560, %lpad.i2520 ], [ %598, %lpad.i2558 ], [ %636, %lpad.i2600 ], [ %643, %lpad.i2621 ], [ %680, %lpad.i2737 ], [ %686, %lpad.i2756 ], [ %692, %lpad.i2775 ], [ %727, %lpad.i2804 ]
...
if.end544:                                        ; preds = %_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit, %for.body404
  %413 = phi ptr [ %.pre3388, %_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit ], [ %307, %for.body404 ]
  ...
  %419 = load float, ptr %arrayidx10.i23.i.i1938, align 4
  %420 = insertelement <2 x float> poison, float %415, i64 0
  %421 = insertelement <2 x float> %420, float %418, i64 1
  %422 = fmul <2 x float> %421, zeroinitializer
  %423 = insertelement <2 x float> poison, float %414, i64 0
  %424 = insertelement <2 x float> %423, float %417, i64 1
  %425 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %424, <2 x float> <float 1.000000e+01, float 1.000000e+01>, <2 x float> %422)
  %426 = insertelement <2 x float> poison, float %416, i64 0
  %427 = insertelement <2 x float> %426, float %419, i64 1
  %428 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %427, <2 x float> zeroinitializer, <2 x float> %425)
  %429 = load <2 x float>, ptr %m_origin.i.i1933, align 4
  ...
  %434 = load float, ptr %arrayidx10.i30.i.i1944, align 4
  ...
  %436 = load float, ptr %arrayidx.i32.i.i1945, align 4
  ...
  store <4 x float> <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %ref.tmp555, align 16
  %vtable559 = load ptr, ptr %idraw, align 8
  ...
  %438 = load float, ptr %m_framexform, align 4
  %439 = load float, ptr %arrayidx5.i.i.i1928, align 4
  %440 = load float, ptr %arrayidx10.i.i.i1931, align 4
  %441 = load float, ptr %arrayidx.i.i.i1935, align 4
  %442 = load float, ptr %arrayidx5.i20.i.i1936, align 4
  %443 = load float, ptr %arrayidx10.i23.i.i1938, align 4
  %444 = insertelement <2 x float> poison, float %439, i64 0
  %445 = insertelement <2 x float> %444, float %442, i64 1
  %446 = fmul <2 x float> %445, <float 1.000000e+01, float 1.000000e+01>
  %447 = insertelement <2 x float> poison, float %438, i64 0
  %448 = insertelement <2 x float> %447, float %441, i64 1
  %449 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %448, <2 x float> zeroinitializer, <2 x float> %446)
  %450 = insertelement <2 x float> poison, float %440, i64 0
  %451 = insertelement <2 x float> %450, float %443, i64 1
  %452 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %451, <2 x float> zeroinitializer, <2 x float> %449)
  %453 = load <2 x float>, ptr %m_origin.i.i1933, align 4
  %454 = fadd <2 x float> %453, %452
  %455 = load float, ptr %arrayidx.i26.i.i1941, align 4
  %456 = load float, ptr %arrayidx5.i27.i.i1942, align 4
  ...
  %458 = load float, ptr %arrayidx10.i30.i.i1944, align 4
  %459 = call float @llvm.fmuladd.f32(float %458, float 0.000000e+00, float %457)
  %460 = load float, ptr %arrayidx.i32.i.i1945, align 4
  ...
  store <4 x float> <float 0.000000e+00, float 1.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %ref.tmp570, align 16
  %vtable574 = load ptr, ptr %idraw, align 8
  ...
  %462 = load float, ptr %m_framexform, align 4
  %463 = load float, ptr %arrayidx5.i.i.i1928, align 4
  %464 = load float, ptr %arrayidx10.i.i.i1931, align 4
  %465 = load float, ptr %arrayidx.i.i.i1935, align 4
  %466 = load float, ptr %arrayidx5.i20.i.i1936, align 4
  %467 = load float, ptr %arrayidx10.i23.i.i1938, align 4
  %468 = insertelement <2 x float> poison, float %463, i64 0
  %469 = insertelement <2 x float> %468, float %466, i64 1
  %470 = fmul <2 x float> %469, zeroinitializer
  %471 = insertelement <2 x float> poison, float %462, i64 0
  %472 = insertelement <2 x float> %471, float %465, i64 1
  %473 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %472, <2 x float> zeroinitializer, <2 x float> %470)
  %474 = insertelement <2 x float> poison, float %464, i64 0
  %475 = insertelement <2 x float> %474, float %467, i64 1
  %476 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %475, <2 x float> <float 1.000000e+01, float 1.000000e+01>, <2 x float> %473)
  %477 = load <2 x float>, ptr %m_origin.i.i1933, align 4
  %478 = fadd <2 x float> %477, %476
  %479 = load float, ptr %arrayidx.i26.i.i1941, align 4
  %480 = load float, ptr %arrayidx5.i27.i.i1942, align 4
  ...
  %482 = load float, ptr %arrayidx10.i30.i.i1944, align 4
  %483 = call float @llvm.fmuladd.f32(float %482, float 1.000000e+01, float %481)
  %484 = load float, ptr %arrayidx.i32.i.i1945, align 4
  ...
  store <4 x float> <float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00>, ptr %ref.tmp585, align 16
  %vtable589 = load ptr, ptr %idraw, align 8
  ...
  %486 = load i32, ptr %m_size.i1740, align 4
  %487 = sext i32 %486 to i64
  %cmp403 = icmp slt i64 %indvars.iv.next3367, %487
...
if.then597:                                       ; preds = %if.end594
  ...
  store <4 x float> <float 0x3FE6666660000000, float 0x3FE6666660000000, float 0x3FE6666660000000, float 0.000000e+00>, ptr %col600, align 16
  %m_size.i2018 = getelementptr inbounds %class.btSoftBody, ptr %psb, i64 0, i32 12, i32 2
  %488 = load i32, ptr %m_size.i2018, align 4
  %cmp6073317 = icmp sgt i32 %488, 0
  br i1 %cmp6073317, label %for.body608.lr.ph, label %for.cond.cleanup
...
for.body608:                                      ; preds = %for.body608.lr.ph, %cleanup779
  ...
  %indvars.iv3369 = phi i64 [ 0, %for.body608.lr.ph ], [ %indvars.iv.next3370, %cleanup779 ]
  %502 = load ptr, ptr %m_data.i2019, align 8
  %m_material611 = getelementptr inbounds %"struct.btSoftBody::Tetra", ptr %502, i64 %indvars.iv3369, i32 0, i32 1
  %503 = load ptr, ptr %m_material611, align 8
  %m_flags612 = getelementptr inbounds %"struct.btSoftBody::Material", ptr %503, i64 0, i32 4
  %504 = load i32, ptr %m_flags612, align 4
  %and613 = and i32 %504, 1
  %cmp614 = icmp eq i32 %and613, 0
  br i1 %cmp614, label %cleanup779, label %if.end616

if.end616:                                        ; preds = %for.body608
  %m_n619 = getelementptr inbounds %"struct.btSoftBody::Tetra", ptr %502, i64 %indvars.iv3369, i32 1
  %505 = load ptr, ptr %m_n619, align 8
  %m_x621 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %505, i64 0, i32 1
  %x617.sroa.0.0.copyload = load float, ptr %m_x621, align 8
  %x617.sroa.7.0.m_x621.sroa_idx = getelementptr inbounds %"struct.btSoftBody::Node", ptr %505, i64 0, i32 1, i32 0, i64 1
  %x617.sroa.7.0.copyload = load float, ptr %x617.sroa.7.0.m_x621.sroa_idx, align 4
  %x617.sroa.11.0.m_x621.sroa_idx = getelementptr inbounds %"struct.btSoftBody::Node", ptr %505, i64 0, i32 1, i32 0, i64 2
  %x617.sroa.11.0.copyload = load float, ptr %x617.sroa.11.0.m_x621.sroa_idx, align 8
  %arrayidx624 = getelementptr inbounds %"struct.btSoftBody::Tetra", ptr %502, i64 %indvars.iv3369, i32 1, i64 1
  %506 = load ptr, ptr %arrayidx624, align 8
  %m_x625 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %506, i64 0, i32 1
  %x617.sroa.153106.16.copyload = load float, ptr %m_x625, align 8
  %x617.sroa.20.16.m_x625.sroa_idx = getelementptr inbounds %"struct.btSoftBody::Node", ptr %506, i64 0, i32 1, i32 0, i64 1
  %x617.sroa.20.16.copyload = load float, ptr %x617.sroa.20.16.m_x625.sroa_idx, align 4
  %x617.sroa.24.16.m_x625.sroa_idx = getelementptr inbounds %"struct.btSoftBody::Node", ptr %506, i64 0, i32 1, i32 0, i64 2
  %x617.sroa.24.16.copyload = load float, ptr %x617.sroa.24.16.m_x625.sroa_idx, align 8
  %arrayidx628 = getelementptr inbounds %"struct.btSoftBody::Tetra", ptr %502, i64 %indvars.iv3369, i32 1, i64 2
  %507 = load ptr, ptr %arrayidx628, align 8
  %m_x629 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %507, i64 0, i32 1
  %x617.sroa.283116.32.copyload = load float, ptr %m_x629, align 8
  %x617.sroa.33.32.m_x629.sroa_idx = getelementptr inbounds %"struct.btSoftBody::Node", ptr %507, i64 0, i32 1, i32 0, i64 1
  %x617.sroa.33.32.copyload = load float, ptr %x617.sroa.33.32.m_x629.sroa_idx, align 4
  %x617.sroa.37.32.m_x629.sroa_idx = getelementptr inbounds %"struct.btSoftBody::Node", ptr %507, i64 0, i32 1, i32 0, i64 2
  %x617.sroa.37.32.copyload = load float, ptr %x617.sroa.37.32.m_x629.sroa_idx, align 8
  %arrayidx632 = getelementptr inbounds %"struct.btSoftBody::Tetra", ptr %502, i64 %indvars.iv3369, i32 1, i64 3
  %508 = load ptr, ptr %arrayidx632, align 8
  %m_x633 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %508, i64 0, i32 1
  %x617.sroa.413126.48.copyload = load float, ptr %m_x633, align 8
  %x617.sroa.46.48.m_x633.sroa_idx = getelementptr inbounds %"struct.btSoftBody::Node", ptr %508, i64 0, i32 1, i32 0, i64 1
  %x617.sroa.46.48.copyload = load float, ptr %x617.sroa.46.48.m_x633.sroa_idx, align 4
  %x617.sroa.50.48.m_x633.sroa_idx = getelementptr inbounds %"struct.btSoftBody::Node", ptr %508, i64 0, i32 1, i32 0, i64 2
  %x617.sroa.50.48.copyload = load float, ptr %x617.sroa.50.48.m_x633.sroa_idx, align 8
  ...
  %vtable681 = load ptr, ptr %idraw, align 8
  ...
  %vtable713 = load ptr, ptr %idraw, align 8
  ...
  %vtable745 = load ptr, ptr %idraw, align 8
  ...
  %vtable777 = load ptr, ptr %idraw, align 8
  ...
  %.pre3389 = load i32, ptr %m_size.i2018, align 4
  br label %cleanup779

cleanup779:                                       ; preds = %for.body608, %if.end616
  %513 = phi i32 [ %501, %for.body608 ], [ %.pre3389, %if.end616 ]
  %indvars.iv.next3370 = add nuw nsw i64 %indvars.iv3369, 1
  %514 = sext i32 %513 to i64
  %cmp607 = icmp slt i64 %indvars.iv.next3370, %514
...
for.cond790.preheader:                            ; preds = %if.end786
  ...
  %515 = load i32, ptr %m_size.i2477, align 4
  %cmp7923325 = icmp sgt i32 %515, 0
  br i1 %cmp7923325, label %for.body793.lr.ph, label %if.end822
...
for.body793:                                      ; preds = %for.body793.lr.ph, %for.cond.cleanup801
  %indvars.iv3377 = phi i64 [ 0, %for.body793.lr.ph ], [ %indvars.iv.next3378, %for.cond.cleanup801 ]
  %516 = load ptr, ptr %m_data.i2478, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %p) #18
  %m_offset797 = getelementptr inbounds %"struct.btSoftBody::Note", ptr %516, i64 %indvars.iv3377, i32 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %p, ptr noundef nonnull align 8 dereferenceable(16) %m_offset797, i64 16, i1 false)
  %m_rank = getelementptr inbounds %"struct.btSoftBody::Note", ptr %516, i64 %indvars.iv3377, i32 3
  %517 = load i32, ptr %m_rank, align 8
  %cmp8003320 = icmp sgt i32 %517, 0
  br i1 %cmp8003320, label %for.body802.lr.ph, label %for.cond.cleanup801

for.body802.lr.ph:                                ; preds = %for.body793
  %518 = load <2 x float>, ptr %p, align 8
  %arrayidx12.i.promoted = load float, ptr %arrayidx12.i, align 8
  %wide.trip.count3375 = zext i32 %517 to i64
  br label %for.body802

for.cond.cleanup801:                              ; preds = %for.body802, %for.body793
  %m_text = getelementptr inbounds %"struct.btSoftBody::Note", ptr %516, i64 %indvars.iv3377, i32 1
  %519 = load ptr, ptr %m_text, align 8
  %vtable817 = load ptr, ptr %idraw, align 8
  ...
  %521 = load i32, ptr %m_size.i2477, align 4
  %522 = sext i32 %521 to i64
  %cmp792 = icmp slt i64 %indvars.iv.next3378, %522
  br i1 %cmp792, label %for.body793, label %if.end822

for.body802:                                      ; preds = %for.body802.lr.ph, %for.body802
  %indvars.iv3372 = phi i64 [ 0, %for.body802.lr.ph ], [ %indvars.iv.next3373, %for.body802 ]
  %add13.i3324 = phi float [ %arrayidx12.i.promoted, %for.body802.lr.ph ], [ %add13.i, %for.body802 ]
  %523 = phi <2 x float> [ %518, %for.body802.lr.ph ], [ %531, %for.body802 ]
  %arrayidx806 = getelementptr inbounds %"struct.btSoftBody::Note", ptr %516, i64 %indvars.iv3377, i32 4, i64 %indvars.iv3372
  %524 = load ptr, ptr %arrayidx806, align 8
  %m_x807 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %524, i64 0, i32 1
  %arrayidx809 = getelementptr inbounds %"struct.btSoftBody::Note", ptr %516, i64 %indvars.iv3377, i32 5, i64 %indvars.iv3372
  %525 = load float, ptr %arrayidx809, align 4
  %arrayidx7.i2484 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %524, i64 0, i32 1, i32 0, i64 2
  %526 = load float, ptr %arrayidx7.i2484, align 4
  %mul8.i2485 = fmul float %525, %526
  %527 = load <2 x float>, ptr %m_x807, align 4
  ...
  store <2 x float> %531, ptr %p, align 8
  %add13.i = fadd float %mul8.i2485, %add13.i3324
  ...
  br i1 %exitcond3376.not, label %for.cond.cleanup801, label %for.body802
...
if.then825:                                       ; preds = %if.end822
  ...
  %532 = load ptr, ptr %m_ndbvt.i, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp.i2495) #18
  store <4 x float> <float 1.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00>, ptr %ref.tmp.i2495, align 16
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp4.i2496) #18
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 0.000000e+00>, ptr %ref.tmp4.i2496, align 16
...
if.then829:                                       ; preds = %if.end826
  ...
  %533 = load ptr, ptr %m_fdbvt.i, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp.i2500) #18
  store <4 x float> <float 0.000000e+00, float 1.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %ref.tmp.i2500, align 16
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp4.i2501) #18
  store <4 x float> <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %ref.tmp4.i2501, align 16
...
if.then833:                                       ; preds = %if.end830
  ...
  %534 = load ptr, ptr %m_cdbvt.i, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp.i2508) #18
  store <4 x float> <float 0.000000e+00, float 1.000000e+00, float 1.000000e+00, float 0.000000e+00>, ptr %ref.tmp.i2508, align 16
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp4.i2509) #18
  store <4 x float> <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %ref.tmp4.i2509, align 16
...
for.cond838.preheader:                            ; preds = %if.end834
  ...
  %535 = load i32, ptr %m_size.i2516, align 4
  %cmp8403327 = icmp sgt i32 %535, 0
  br i1 %cmp8403327, label %for.body841.lr.ph, label %if.end969
...
for.body841:                                      ; preds = %for.body841.lr.ph, %sw.epilog
  %indvars.iv3380 = phi i64 [ 0, %for.body841.lr.ph ], [ %indvars.iv.next3381, %sw.epilog ]
  %554 = load ptr, ptr %m_data.i2517, align 8
  %arrayidx.i2519 = getelementptr inbounds ptr, ptr %554, i64 %indvars.iv3380
  %555 = load ptr, ptr %arrayidx.i2519, align 8
  %vtable844 = load ptr, ptr %555, align 8
...
sw.bb:                                            ; preds = %for.body841
  ...
  br i1 %guard.uninitialized.i, label %init.check.i, label %_ZNK10btSoftBody4Body5xformEv.exit
...
init.i:                                           ; preds = %init.check.i
  %call.i = invoke noundef nonnull align 4 dereferenceable(64) ptr @_ZN11btTransform11getIdentityEv()
          to label %invoke.cont2.i unwind label %lpad.i2520
...
invoke.cont2.i:                                   ; preds = %init.i
  ...
  %arrayidx10.i.i.i2521 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i, i64 0, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 2), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx10.i.i.i2521, i64 16, i1 false)
...
_ZNK10btSoftBody4Body5xformEv.exit:               ; preds = %sw.bb, %init.check.i, %invoke.cont2.i
  ...
  %561 = load ptr, ptr %m_collisionObject.i, align 8
  ...
  %575 = insertelement <2 x float> %574, float %570, i64 1
  %576 = fmul <2 x float> %573, %575
  %577 = insertelement <2 x float> poison, float %563, i64 0
  %578 = insertelement <2 x float> %577, float %569, i64 1
  ...
  %581 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %578, <2 x float> %580, <2 x float> %576)
  %582 = insertelement <2 x float> poison, float %567, i64 0
  %583 = insertelement <2 x float> %582, float %571, i64 1
  %584 = insertelement <2 x float> poison, float %568, i64 0
  %585 = shufflevector <2 x float> %584, <2 x float> poison, <2 x i32> zeroinitializer
  %586 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %583, <2 x float> %585, <2 x float> %581)
  %587 = load <2 x float>, ptr %m_origin.i.i2527, align 4
  %588 = fadd <2 x float> %586, %587
  %arrayidx.i26.i.i2535 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i, i64 0, i64 2
  %589 = load float, ptr %arrayidx.i26.i.i2535, align 4
  %arrayidx5.i27.i.i2536 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i, i64 0, i64 2, i32 0, i64 1
  %590 = load float, ptr %arrayidx5.i27.i.i2536, align 4
  %mul8.i29.i.i2537 = fmul float %566, %590
  %591 = call float @llvm.fmuladd.f32(float %589, float %564, float %mul8.i29.i.i2537)
  %arrayidx10.i30.i.i2538 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i, i64 0, i64 2, i32 0, i64 2
  %592 = load float, ptr %arrayidx10.i30.i.i2538, align 4
  %593 = call float @llvm.fmuladd.f32(float %592, float %568, float %591)
  %arrayidx.i32.i.i2539 = getelementptr inbounds %class.btTransform, ptr %retval.0.i, i64 0, i32 1, i32 0, i64 2
  %594 = load float, ptr %arrayidx.i32.i.i2539, align 4
  ...
  br i1 %guard.uninitialized.i2546, label %init.check.i2554, label %_ZNK10btSoftBody4Body5xformEv.exit2563

init.check.i2554:                                 ; preds = %_ZNK10btSoftBody4Body5xformEv.exit
  %596 = call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  %tobool.not.i2555 = icmp eq i32 %596, 0
  br i1 %tobool.not.i2555, label %_ZNK10btSoftBody4Body5xformEv.exit2563, label %init.i2556

init.i2556:                                       ; preds = %init.check.i2554
  %call.i2557 = invoke noundef nonnull align 4 dereferenceable(64) ptr @_ZN11btTransform11getIdentityEv()
          to label %invoke.cont2.i2559 unwind label %lpad.i2558

invoke.cont2.i2559:                               ; preds = %init.i2556
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr noundef nonnull align 4 dereferenceable(16) %call.i2557, i64 16, i1 false)
  %arrayidx6.i.i.i2560 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2557, i64 0, i64 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 1), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx6.i.i.i2560, i64 16, i1 false)
  %arrayidx10.i.i.i2561 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2557, i64 0, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 2), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx10.i.i.i2561, i64 16, i1 false)
  %m_origin3.i.i2562 = getelementptr inbounds %class.btTransform, ptr %call.i2557, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 1), ptr noundef nonnull align 4 dereferenceable(16) %m_origin3.i.i2562, i64 16, i1 false)
...
lpad.i2558:                                       ; preds = %init.i2556
  %598 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_guard_abort(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %common.resume

_ZNK10btSoftBody4Body5xformEv.exit2563:           ; preds = %_ZNK10btSoftBody4Body5xformEv.exit, %init.check.i2554, %invoke.cont2.i2559
  %m_collisionObject.i2547 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %555, i64 0, i32 1, i64 1, i32 2
  %599 = load ptr, ptr %m_collisionObject.i2547, align 8
  %tobool3.not.i2548 = icmp eq ptr %599, null
  %m_interpolationWorldTransform.i.i2549 = getelementptr inbounds %class.btCollisionObject, ptr %599, i64 0, i32 2
  %600 = load ptr, ptr %arrayidx853, align 8
  %tobool6.not.i2550 = icmp eq ptr %600, null
  %m_framexform.i2551 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %600, i64 0, i32 3
  %spec.select.i2552 = select i1 %tobool6.not.i2550, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr %m_framexform.i2551
  %retval.0.i2553 = select i1 %tobool3.not.i2548, ptr %spec.select.i2552, ptr %m_interpolationWorldTransform.i.i2549
  %arrayidx856 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %555, i64 0, i32 2, i64 1
  %601 = load float, ptr %retval.0.i2553, align 4
  %602 = load float, ptr %arrayidx856, align 4
  %arrayidx5.i.i.i2564 = getelementptr inbounds [4 x float], ptr %retval.0.i2553, i64 0, i64 1
  %603 = load float, ptr %arrayidx5.i.i.i2564, align 4
  %arrayidx7.i.i.i2565 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %555, i64 0, i32 2, i64 1, i32 0, i64 1
  %604 = load float, ptr %arrayidx7.i.i.i2565, align 4
  %arrayidx10.i.i.i2567 = getelementptr inbounds [4 x float], ptr %retval.0.i2553, i64 0, i64 2
  %605 = load float, ptr %arrayidx10.i.i.i2567, align 4
  %arrayidx12.i.i.i2568 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %555, i64 0, i32 2, i64 1, i32 0, i64 2
  %606 = load float, ptr %arrayidx12.i.i.i2568, align 4
  %m_origin.i.i2569 = getelementptr inbounds %class.btTransform, ptr %retval.0.i2553, i64 0, i32 1
  %arrayidx.i.i.i2571 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2553, i64 0, i64 1
  %607 = load float, ptr %arrayidx.i.i.i2571, align 4
  %arrayidx5.i20.i.i2572 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2553, i64 0, i64 1, i32 0, i64 1
  %608 = load float, ptr %arrayidx5.i20.i.i2572, align 4
  %arrayidx10.i23.i.i2574 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2553, i64 0, i64 1, i32 0, i64 2
  %609 = load float, ptr %arrayidx10.i23.i.i2574, align 4
  ...
  %612 = insertelement <2 x float> poison, float %603, i64 0
  %613 = insertelement <2 x float> %612, float %608, i64 1
  %614 = fmul <2 x float> %611, %613
  %615 = insertelement <2 x float> poison, float %601, i64 0
  %616 = insertelement <2 x float> %615, float %607, i64 1
  ...
  %619 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %616, <2 x float> %618, <2 x float> %614)
  %620 = insertelement <2 x float> poison, float %605, i64 0
  %621 = insertelement <2 x float> %620, float %609, i64 1
  %622 = insertelement <2 x float> poison, float %606, i64 0
  %623 = shufflevector <2 x float> %622, <2 x float> poison, <2 x i32> zeroinitializer
  %624 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %621, <2 x float> %623, <2 x float> %619)
  %625 = load <2 x float>, ptr %m_origin.i.i2569, align 4
  %626 = fadd <2 x float> %624, %625
  %arrayidx.i26.i.i2577 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2553, i64 0, i64 2
  %627 = load float, ptr %arrayidx.i26.i.i2577, align 4
  %arrayidx5.i27.i.i2578 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2553, i64 0, i64 2, i32 0, i64 1
  %628 = load float, ptr %arrayidx5.i27.i.i2578, align 4
  %mul8.i29.i.i2579 = fmul float %604, %628
  %629 = call float @llvm.fmuladd.f32(float %627, float %602, float %mul8.i29.i.i2579)
  %arrayidx10.i30.i.i2580 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2553, i64 0, i64 2, i32 0, i64 2
  %630 = load float, ptr %arrayidx10.i30.i.i2580, align 4
  %631 = call float @llvm.fmuladd.f32(float %630, float %606, float %629)
  %arrayidx.i32.i.i2581 = getelementptr inbounds %class.btTransform, ptr %retval.0.i2553, i64 0, i32 1, i32 0, i64 2
  %632 = load float, ptr %arrayidx.i32.i.i2581, align 4
  ...
  br i1 %guard.uninitialized.i2588, label %init.check.i2596, label %_ZNK10btSoftBody4Body5xformEv.exit2605

init.check.i2596:                                 ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2563
  %634 = call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  %tobool.not.i2597 = icmp eq i32 %634, 0
  br i1 %tobool.not.i2597, label %_ZNK10btSoftBody4Body5xformEv.exit2605, label %init.i2598

init.i2598:                                       ; preds = %init.check.i2596
  %call.i2599 = invoke noundef nonnull align 4 dereferenceable(64) ptr @_ZN11btTransform11getIdentityEv()
          to label %invoke.cont2.i2601 unwind label %lpad.i2600

invoke.cont2.i2601:                               ; preds = %init.i2598
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr noundef nonnull align 4 dereferenceable(16) %call.i2599, i64 16, i1 false)
  %arrayidx6.i.i.i2602 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2599, i64 0, i64 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 1), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx6.i.i.i2602, i64 16, i1 false)
  %arrayidx10.i.i.i2603 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2599, i64 0, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 2), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx10.i.i.i2603, i64 16, i1 false)
  %m_origin3.i.i2604 = getelementptr inbounds %class.btTransform, ptr %call.i2599, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 1), ptr noundef nonnull align 4 dereferenceable(16) %m_origin3.i.i2604, i64 16, i1 false)
...
lpad.i2600:                                       ; preds = %init.i2598
  %636 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_guard_abort(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %common.resume

_ZNK10btSoftBody4Body5xformEv.exit2605:           ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2563, %init.check.i2596, %invoke.cont2.i2601
  %637 = load ptr, ptr %m_collisionObject.i, align 8
  %tobool3.not.i2590 = icmp eq ptr %637, null
  %m_interpolationWorldTransform.i.i2591 = getelementptr inbounds %class.btCollisionObject, ptr %637, i64 0, i32 2
  %638 = load ptr, ptr %m_bodies, align 8
  %tobool6.not.i2592 = icmp eq ptr %638, null
  %m_framexform.i2593 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %638, i64 0, i32 3
  %spec.select.i2594 = select i1 %tobool6.not.i2592, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr %m_framexform.i2593
  %retval.0.i2595 = select i1 %tobool3.not.i2590, ptr %spec.select.i2594, ptr %m_interpolationWorldTransform.i.i2591
  %m_origin.i = getelementptr inbounds %class.btTransform, ptr %retval.0.i2595, i64 0, i32 1
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp863) #18
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %ref.tmp863, align 16
  %vtable867 = load ptr, ptr %idraw, align 8
  ...
  br i1 %guard.uninitialized.i2609, label %init.check.i2617, label %_ZNK10btSoftBody4Body5xformEv.exit2626

init.check.i2617:                                 ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2605
  %641 = call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  %tobool.not.i2618 = icmp eq i32 %641, 0
  br i1 %tobool.not.i2618, label %_ZNK10btSoftBody4Body5xformEv.exit2626, label %init.i2619

init.i2619:                                       ; preds = %init.check.i2617
  %call.i2620 = invoke noundef nonnull align 4 dereferenceable(64) ptr @_ZN11btTransform11getIdentityEv()
          to label %invoke.cont2.i2622 unwind label %lpad.i2621

invoke.cont2.i2622:                               ; preds = %init.i2619
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr noundef nonnull align 4 dereferenceable(16) %call.i2620, i64 16, i1 false)
  %arrayidx6.i.i.i2623 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2620, i64 0, i64 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 1), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx6.i.i.i2623, i64 16, i1 false)
  %arrayidx10.i.i.i2624 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2620, i64 0, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 2), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx10.i.i.i2624, i64 16, i1 false)
  %m_origin3.i.i2625 = getelementptr inbounds %class.btTransform, ptr %call.i2620, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 1), ptr noundef nonnull align 4 dereferenceable(16) %m_origin3.i.i2625, i64 16, i1 false)
...
lpad.i2621:                                       ; preds = %init.i2619
  %643 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_guard_abort(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %common.resume

_ZNK10btSoftBody4Body5xformEv.exit2626:           ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2605, %init.check.i2617, %invoke.cont2.i2622
  %644 = load ptr, ptr %m_collisionObject.i2547, align 8
  %tobool3.not.i2611 = icmp eq ptr %644, null
  %m_interpolationWorldTransform.i.i2612 = getelementptr inbounds %class.btCollisionObject, ptr %644, i64 0, i32 2
  %645 = load ptr, ptr %arrayidx853, align 8
  %tobool6.not.i2613 = icmp eq ptr %645, null
  %m_framexform.i2614 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %645, i64 0, i32 3
  %spec.select.i2615 = select i1 %tobool6.not.i2613, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr %m_framexform.i2614
  %retval.0.i2616 = select i1 %tobool3.not.i2611, ptr %spec.select.i2615, ptr %m_interpolationWorldTransform.i.i2612
  %m_origin.i2627 = getelementptr inbounds %class.btTransform, ptr %retval.0.i2616, i64 0, i32 1
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp873) #18
  store <4 x float> <float 0.000000e+00, float 1.000000e+00, float 1.000000e+00, float 0.000000e+00>, ptr %ref.tmp873, align 16
  %vtable877 = load ptr, ptr %idraw, align 8
  ...
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %ref.tmp879, align 16
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp.i2634) #18
  %647 = load float, ptr %540, align 8
  ...
  %648 = load <2 x float>, ptr %a0, align 8
  ...
  %vtable.i2652 = load ptr, ptr %idraw, align 8
  ...
  %653 = load float, ptr %540, align 8
  ...
  %654 = load <2 x float>, ptr %a0, align 8
  ...
  %vtable22.i2664 = load ptr, ptr %idraw, align 8
  ...
  %658 = load <2 x float>, ptr %a0, align 8
  %659 = load float, ptr %540, align 8
  ...
  %vtable36.i2676 = load ptr, ptr %idraw, align 8
  ...
  store <4 x float> <float 0.000000e+00, float 1.000000e+00, float 1.000000e+00, float 0.000000e+00>, ptr %ref.tmp883, align 16
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp.i2681) #18
  %662 = load float, ptr %541, align 8
  ...
  %663 = load <2 x float>, ptr %a1, align 8
  ...
  %vtable.i2699 = load ptr, ptr %idraw, align 8
  ...
  %668 = load float, ptr %541, align 8
  ...
  %669 = load <2 x float>, ptr %a1, align 8
  ...
  %vtable22.i2711 = load ptr, ptr %idraw, align 8
  ...
  %673 = load <2 x float>, ptr %a1, align 8
  %674 = load float, ptr %541, align 8
  ...
  %vtable36.i2723 = load ptr, ptr %idraw, align 8
...
sw.bb887:                                         ; preds = %for.body841
  ...
  br i1 %guard.uninitialized.i2725, label %init.check.i2733, label %_ZNK10btSoftBody4Body5xformEv.exit2742

init.check.i2733:                                 ; preds = %sw.bb887
  %678 = call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  %tobool.not.i2734 = icmp eq i32 %678, 0
  br i1 %tobool.not.i2734, label %_ZNK10btSoftBody4Body5xformEv.exit2742, label %init.i2735

init.i2735:                                       ; preds = %init.check.i2733
  %call.i2736 = invoke noundef nonnull align 4 dereferenceable(64) ptr @_ZN11btTransform11getIdentityEv()
          to label %invoke.cont2.i2738 unwind label %lpad.i2737

invoke.cont2.i2738:                               ; preds = %init.i2735
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr noundef nonnull align 4 dereferenceable(16) %call.i2736, i64 16, i1 false)
  %arrayidx6.i.i.i2739 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2736, i64 0, i64 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 1), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx6.i.i.i2739, i64 16, i1 false)
  %arrayidx10.i.i.i2740 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2736, i64 0, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 2), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx10.i.i.i2740, i64 16, i1 false)
  %m_origin3.i.i2741 = getelementptr inbounds %class.btTransform, ptr %call.i2736, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 1), ptr noundef nonnull align 4 dereferenceable(16) %m_origin3.i.i2741, i64 16, i1 false)
...
lpad.i2737:                                       ; preds = %init.i2735
  %680 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_guard_abort(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %common.resume

_ZNK10btSoftBody4Body5xformEv.exit2742:           ; preds = %sw.bb887, %init.check.i2733, %invoke.cont2.i2738
  %m_collisionObject.i2726 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %555, i64 0, i32 1, i64 0, i32 2
  %681 = load ptr, ptr %m_collisionObject.i2726, align 8
  %tobool3.not.i2727 = icmp eq ptr %681, null
  %m_interpolationWorldTransform.i.i2728 = getelementptr inbounds %class.btCollisionObject, ptr %681, i64 0, i32 2
  %682 = load ptr, ptr %m_bodies888, align 8
  %tobool6.not.i2729 = icmp eq ptr %682, null
  %m_framexform.i2730 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %682, i64 0, i32 3
  %spec.select.i2731 = select i1 %tobool6.not.i2729, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr %m_framexform.i2730
  %retval.0.i2732 = select i1 %tobool3.not.i2727, ptr %spec.select.i2731, ptr %m_interpolationWorldTransform.i.i2728
  %m_origin.i2743 = getelementptr inbounds %class.btTransform, ptr %retval.0.i2732, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %o0, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i2743, i64 16, i1 false)
  ...
  br i1 %guard.uninitialized.i2744, label %init.check.i2752, label %_ZNK10btSoftBody4Body5xformEv.exit2761

init.check.i2752:                                 ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2742
  %684 = call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  %tobool.not.i2753 = icmp eq i32 %684, 0
  br i1 %tobool.not.i2753, label %_ZNK10btSoftBody4Body5xformEv.exit2761, label %init.i2754

init.i2754:                                       ; preds = %init.check.i2752
  %call.i2755 = invoke noundef nonnull align 4 dereferenceable(64) ptr @_ZN11btTransform11getIdentityEv()
          to label %invoke.cont2.i2757 unwind label %lpad.i2756

invoke.cont2.i2757:                               ; preds = %init.i2754
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr noundef nonnull align 4 dereferenceable(16) %call.i2755, i64 16, i1 false)
  %arrayidx6.i.i.i2758 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2755, i64 0, i64 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 1), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx6.i.i.i2758, i64 16, i1 false)
  %arrayidx10.i.i.i2759 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2755, i64 0, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 2), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx10.i.i.i2759, i64 16, i1 false)
  %m_origin3.i.i2760 = getelementptr inbounds %class.btTransform, ptr %call.i2755, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 1), ptr noundef nonnull align 4 dereferenceable(16) %m_origin3.i.i2760, i64 16, i1 false)
...
lpad.i2756:                                       ; preds = %init.i2754
  %686 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_guard_abort(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %common.resume

_ZNK10btSoftBody4Body5xformEv.exit2761:           ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2742, %init.check.i2752, %invoke.cont2.i2757
  %m_collisionObject.i2745 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %555, i64 0, i32 1, i64 1, i32 2
  %687 = load ptr, ptr %m_collisionObject.i2745, align 8
  %tobool3.not.i2746 = icmp eq ptr %687, null
  %m_interpolationWorldTransform.i.i2747 = getelementptr inbounds %class.btCollisionObject, ptr %687, i64 0, i32 2
  %688 = load ptr, ptr %arrayidx893, align 8
  %tobool6.not.i2748 = icmp eq ptr %688, null
  %m_framexform.i2749 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %688, i64 0, i32 3
  %spec.select.i2750 = select i1 %tobool6.not.i2748, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr %m_framexform.i2749
  %retval.0.i2751 = select i1 %tobool3.not.i2746, ptr %spec.select.i2750, ptr %m_interpolationWorldTransform.i.i2747
  %m_origin.i2762 = getelementptr inbounds %class.btTransform, ptr %retval.0.i2751, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %o1, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i2762, i64 16, i1 false)
  ...
  br i1 %guard.uninitialized.i2763, label %init.check.i2771, label %_ZNK10btSoftBody4Body5xformEv.exit2780

init.check.i2771:                                 ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2761
  %690 = call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  %tobool.not.i2772 = icmp eq i32 %690, 0
  br i1 %tobool.not.i2772, label %_ZNK10btSoftBody4Body5xformEv.exit2780, label %init.i2773

init.i2773:                                       ; preds = %init.check.i2771
  %call.i2774 = invoke noundef nonnull align 4 dereferenceable(64) ptr @_ZN11btTransform11getIdentityEv()
          to label %invoke.cont2.i2776 unwind label %lpad.i2775

invoke.cont2.i2776:                               ; preds = %init.i2773
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr noundef nonnull align 4 dereferenceable(16) %call.i2774, i64 16, i1 false)
  %arrayidx6.i.i.i2777 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2774, i64 0, i64 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 1), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx6.i.i.i2777, i64 16, i1 false)
  %arrayidx10.i.i.i2778 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2774, i64 0, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 2), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx10.i.i.i2778, i64 16, i1 false)
  %m_origin3.i.i2779 = getelementptr inbounds %class.btTransform, ptr %call.i2774, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 1), ptr noundef nonnull align 4 dereferenceable(16) %m_origin3.i.i2779, i64 16, i1 false)
...
lpad.i2775:                                       ; preds = %init.i2773
  %692 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_guard_abort(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %common.resume

_ZNK10btSoftBody4Body5xformEv.exit2780:           ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2761, %init.check.i2771, %invoke.cont2.i2776
  %693 = load ptr, ptr %m_collisionObject.i2726, align 8
  %tobool3.not.i2765 = icmp eq ptr %693, null
  %m_interpolationWorldTransform.i.i2766 = getelementptr inbounds %class.btCollisionObject, ptr %693, i64 0, i32 2
  %694 = load ptr, ptr %m_bodies888, align 8
  %tobool6.not.i2767 = icmp eq ptr %694, null
  %m_framexform.i2768 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %694, i64 0, i32 3
  %spec.select.i2769 = select i1 %tobool6.not.i2767, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr %m_framexform.i2768
  %retval.0.i2770 = select i1 %tobool3.not.i2765, ptr %spec.select.i2769, ptr %m_interpolationWorldTransform.i.i2766
  %m_refs901 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %555, i64 0, i32 2
  %695 = load float, ptr %retval.0.i2770, align 4
  %696 = load float, ptr %m_refs901, align 4
  %arrayidx5.i.i2781 = getelementptr inbounds [4 x float], ptr %retval.0.i2770, i64 0, i64 1
  %697 = load float, ptr %arrayidx5.i.i2781, align 4
  %arrayidx7.i.i2782 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %555, i64 0, i32 2, i64 0, i32 0, i64 1
  %698 = load float, ptr %arrayidx7.i.i2782, align 4
  %arrayidx10.i.i2784 = getelementptr inbounds [4 x float], ptr %retval.0.i2770, i64 0, i64 2
  %699 = load float, ptr %arrayidx10.i.i2784, align 4
  %arrayidx12.i.i2785 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %555, i64 0, i32 2, i64 0, i32 0, i64 2
  %700 = load float, ptr %arrayidx12.i.i2785, align 4
  %arrayidx.i.i2786 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2770, i64 0, i64 1
  %701 = load float, ptr %arrayidx.i.i2786, align 4
  %arrayidx5.i12.i = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2770, i64 0, i64 1, i32 0, i64 1
  %702 = load float, ptr %arrayidx5.i12.i, align 4
  %703 = insertelement <2 x float> poison, float %698, i64 0
  ...
  %708 = insertelement <2 x float> poison, float %695, i64 0
  %709 = insertelement <2 x float> %708, float %701, i64 1
  %710 = insertelement <2 x float> poison, float %696, i64 0
  ...
  %arrayidx10.i15.i = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2770, i64 0, i64 1, i32 0, i64 2
  %713 = load float, ptr %arrayidx10.i15.i, align 4
  %714 = insertelement <2 x float> poison, float %699, i64 0
  ...
  %arrayidx.i17.i = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2770, i64 0, i64 2
  %719 = load float, ptr %arrayidx.i17.i, align 4
  %arrayidx5.i18.i = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2770, i64 0, i64 2, i32 0, i64 1
  %720 = load float, ptr %arrayidx5.i18.i, align 4
  %mul8.i20.i = fmul float %698, %720
  %721 = call float @llvm.fmuladd.f32(float %719, float %696, float %mul8.i20.i)
  %arrayidx10.i21.i = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2770, i64 0, i64 2, i32 0, i64 2
  %722 = load float, ptr %arrayidx10.i21.i, align 4
  %723 = call float @llvm.fmuladd.f32(float %722, float %700, float %721)
  ...
  br i1 %guard.uninitialized.i2792, label %init.check.i2800, label %_ZNK10btSoftBody4Body5xformEv.exit2809

init.check.i2800:                                 ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2780
  %725 = call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  %tobool.not.i2801 = icmp eq i32 %725, 0
  br i1 %tobool.not.i2801, label %_ZNK10btSoftBody4Body5xformEv.exit2809, label %init.i2802

init.i2802:                                       ; preds = %init.check.i2800
  %call.i2803 = invoke noundef nonnull align 4 dereferenceable(64) ptr @_ZN11btTransform11getIdentityEv()
          to label %invoke.cont2.i2805 unwind label %lpad.i2804

invoke.cont2.i2805:                               ; preds = %init.i2802
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr noundef nonnull align 4 dereferenceable(16) %call.i2803, i64 16, i1 false)
  %arrayidx6.i.i.i2806 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2803, i64 0, i64 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 1), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx6.i.i.i2806, i64 16, i1 false)
  %arrayidx10.i.i.i2807 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2803, i64 0, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 2), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx10.i.i.i2807, i64 16, i1 false)
  %m_origin3.i.i2808 = getelementptr inbounds %class.btTransform, ptr %call.i2803, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 1), ptr noundef nonnull align 4 dereferenceable(16) %m_origin3.i.i2808, i64 16, i1 false)
...
lpad.i2804:                                       ; preds = %init.i2802
  %727 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_guard_abort(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %common.resume

_ZNK10btSoftBody4Body5xformEv.exit2809:           ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2780, %init.check.i2800, %invoke.cont2.i2805
  %728 = load ptr, ptr %m_collisionObject.i2745, align 8
  %tobool3.not.i2794 = icmp eq ptr %728, null
  %m_interpolationWorldTransform.i.i2795 = getelementptr inbounds %class.btCollisionObject, ptr %728, i64 0, i32 2
  %729 = load ptr, ptr %arrayidx893, align 8
  %tobool6.not.i2796 = icmp eq ptr %729, null
  %m_framexform.i2797 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %729, i64 0, i32 3
  %spec.select.i2798 = select i1 %tobool6.not.i2796, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr %m_framexform.i2797
  %retval.0.i2799 = select i1 %tobool3.not.i2794, ptr %spec.select.i2798, ptr %m_interpolationWorldTransform.i.i2795
  %arrayidx911 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %555, i64 0, i32 2, i64 1
  %730 = load float, ptr %retval.0.i2799, align 4
  %731 = load float, ptr %arrayidx911, align 4
  %arrayidx5.i.i2810 = getelementptr inbounds [4 x float], ptr %retval.0.i2799, i64 0, i64 1
  %732 = load float, ptr %arrayidx5.i.i2810, align 4
  %arrayidx7.i.i2811 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %555, i64 0, i32 2, i64 1, i32 0, i64 1
  %733 = load float, ptr %arrayidx7.i.i2811, align 4
  %arrayidx10.i.i2813 = getelementptr inbounds [4 x float], ptr %retval.0.i2799, i64 0, i64 2
  %734 = load float, ptr %arrayidx10.i.i2813, align 4
  %arrayidx12.i.i2814 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %555, i64 0, i32 2, i64 1, i32 0, i64 2
  %735 = load float, ptr %arrayidx12.i.i2814, align 4
  %arrayidx.i.i2815 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2799, i64 0, i64 1
  %736 = load float, ptr %arrayidx.i.i2815, align 4
  %arrayidx5.i12.i2816 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2799, i64 0, i64 1, i32 0, i64 1
  %737 = load float, ptr %arrayidx5.i12.i2816, align 4
  %arrayidx10.i15.i2818 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2799, i64 0, i64 1, i32 0, i64 2
  %738 = load float, ptr %arrayidx10.i15.i2818, align 4
  %arrayidx.i17.i2819 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2799, i64 0, i64 2
  %739 = load float, ptr %arrayidx.i17.i2819, align 4
  %arrayidx5.i18.i2820 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2799, i64 0, i64 2, i32 0, i64 1
  %740 = load float, ptr %arrayidx5.i18.i2820, align 4
  %mul8.i20.i2821 = fmul float %733, %740
  %741 = call float @llvm.fmuladd.f32(float %739, float %731, float %mul8.i20.i2821)
  %arrayidx10.i21.i2822 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2799, i64 0, i64 2, i32 0, i64 2
  %742 = load float, ptr %arrayidx10.i21.i2822, align 4
  %743 = call float @llvm.fmuladd.f32(float %742, float %735, float %741)
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp914) #18
  %744 = fmul <2 x float> %718, <float 1.000000e+01, float 1.000000e+01>
  %mul8.i2832 = fmul float %723, 1.000000e+01
  %745 = load <2 x float>, ptr %o0, align 8
  %746 = fadd <2 x float> %744, %745
  %747 = load float, ptr %arrayidx11.i2842, align 8
  %add14.i2844 = fadd float %mul8.i2832, %747
  %retval.sroa.3.12.vec.insert.i2847 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i2844, i64 0
  store <2 x float> %746, ptr %ref.tmp914, align 8
  ...
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %ref.tmp921, align 16
  %vtable925 = load ptr, ptr %idraw, align 8
  %vfn926 = getelementptr inbounds ptr, ptr %vtable925, i64 5
  %748 = load ptr, ptr %vfn926, align 8
  call void %748(ptr noundef nonnull align 8 dereferenceable(8) %idraw, ptr noundef nonnull align 4 dereferenceable(16) %o0, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp914, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp921)
  ...
  %mul8.i2857 = fmul float %743, 1.000000e+01
  %749 = insertelement <2 x float> poison, float %733, i64 0
  %750 = shufflevector <2 x float> %749, <2 x float> poison, <2 x i32> zeroinitializer
  %751 = insertelement <2 x float> poison, float %732, i64 0
  %752 = insertelement <2 x float> %751, float %737, i64 1
  %753 = fmul <2 x float> %750, %752
  %754 = insertelement <2 x float> poison, float %730, i64 0
  %755 = insertelement <2 x float> %754, float %736, i64 1
  %756 = insertelement <2 x float> poison, float %731, i64 0
  %757 = shufflevector <2 x float> %756, <2 x float> poison, <2 x i32> zeroinitializer
  %758 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %755, <2 x float> %757, <2 x float> %753)
  %759 = insertelement <2 x float> poison, float %734, i64 0
  %760 = insertelement <2 x float> %759, float %738, i64 1
  %761 = insertelement <2 x float> poison, float %735, i64 0
  %762 = shufflevector <2 x float> %761, <2 x float> poison, <2 x i32> zeroinitializer
  %763 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %760, <2 x float> %762, <2 x float> %758)
  %764 = fmul <2 x float> %763, <float 1.000000e+01, float 1.000000e+01>
  %765 = load <2 x float>, ptr %o0, align 8
  %766 = fadd <2 x float> %764, %765
  %767 = load float, ptr %arrayidx11.i2842, align 8
  ...
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %ref.tmp934, align 16
  %vtable938 = load ptr, ptr %idraw, align 8
  ...
  %769 = load <2 x float>, ptr %o1, align 8
  %770 = fadd <2 x float> %744, %769
  %771 = load float, ptr %arrayidx11.i2892, align 8
  ...
  store <4 x float> <float 0.000000e+00, float 1.000000e+00, float 1.000000e+00, float 0.000000e+00>, ptr %ref.tmp947, align 16
  %vtable951 = load ptr, ptr %idraw, align 8
  ...
  %773 = load <2 x float>, ptr %o1, align 8
  %774 = fadd <2 x float> %764, %773
  %775 = load float, ptr %arrayidx11.i2892, align 8
  ...
  store <4 x float> <float 0.000000e+00, float 1.000000e+00, float 1.000000e+00, float 0.000000e+00>, ptr %ref.tmp960, align 16
  %vtable964 = load ptr, ptr %idraw, align 8
...
sw.epilog:                                        ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2809, %for.body841, %_ZNK10btSoftBody4Body5xformEv.exit2626
  ...
  %777 = load i32, ptr %m_size.i2516, align 4
  %778 = sext i32 %777 to i64
  %cmp840 = icmp slt i64 %indvars.iv.next3381, %778
...
invoke.cont:                                      ; preds = %entry, %if.then3.i.i.i
  ...
  %m_data.i.i.i5 = getelementptr inbounds %class.btAlignedObjectArray.84, ptr %this, i64 0, i32 5
  %2 = load ptr, ptr %m_data.i.i.i5, align 8
  %tobool.not.i.i.i6 = icmp eq ptr %2, null
  %m_ownsMemory.i.i.i7 = getelementptr inbounds %class.btAlignedObjectArray.84, ptr %this, i64 0, i32 6
...
_ZN20btAlignedObjectArrayIP14btHullTriangleED2Ev.exit: ; preds = %invoke.cont, %if.then3.i.i.i10
  %m_size.i.i.i11 = getelementptr inbounds %class.btAlignedObjectArray.84, ptr %this, i64 0, i32 2
  store i8 1, ptr %m_ownsMemory.i.i.i7, align 8
  store ptr null, ptr %m_data.i.i.i5, align 8
  store i32 0, ptr %m_size.i.i.i11, align 4
  %m_capacity.i.i.i12 = getelementptr inbounds %class.btAlignedObjectArray.84, ptr %this, i64 0, i32 3
...
for.body.us29:                                    ; preds = %for.body.lr.ph.split, %if.end21.us43
  ...
  %16 = load float, ptr %m_area.us33, align 4
...
if.then19.us39:                                   ; preds = %for.body.us29
  ...
  %vtable.us41 = load ptr, ptr %idraw, align 8
...
if.then6:                                         ; preds = %if.end
  ...
  store float %sub14.i, ptr %arrayidx5.i.i130, align 8
  %arrayidx7.i.i131 = getelementptr inbounds [4 x float], ptr %c.i, i64 0, i64 3
  store float 0.000000e+00, ptr %arrayidx7.i.i131, align 4
  ...
  store float %sub14.i, ptr %arrayidx5.i128.i, align 8
  %arrayidx7.i129.i = getelementptr inbounds %class.btVector3, ptr %c.i, i64 2, i32 0, i64 3
  store float 0.000000e+00, ptr %arrayidx7.i129.i, align 4
  ...
  store float %add14.i, ptr %arrayidx5.i138.i, align 8
  %arrayidx7.i139.i = getelementptr inbounds %class.btVector3, ptr %c.i, i64 4, i32 0, i64 3
  store float 0.000000e+00, ptr %arrayidx7.i139.i, align 4
  ...
  store float %add14.i, ptr %arrayidx5.i148.i, align 8
  %arrayidx7.i149.i = getelementptr inbounds %class.btVector3, ptr %c.i, i64 6, i32 0, i64 3
  store float 0.000000e+00, ptr %arrayidx7.i149.i, align 4
...
if.then:                                          ; preds = %entry
  ...
  %1 = load float, ptr %m_scl, align 4
  %2 = load float, ptr %m_rot, align 4
  ...
  %51 = load float, ptr %arrayidx.i70.i, align 4
  %arrayidx.i.i72.i = getelementptr inbounds %class.btSoftBody, ptr %psb, i64 0, i32 5, i32 6, i32 0, i64 2, i32 0, i64 1
  %52 = load float, ptr %arrayidx.i.i72.i, align 4
  %mul7.i73.i = fmul float %3, %52
  ...
  %54 = load float, ptr %arrayidx.i14.i75.i, align 4
  %55 = tail call float @llvm.fmuladd.f32(float %5, float %54, float %53)
  %mul7.i80.i = fmul float %8, %52
  %56 = tail call float @llvm.fmuladd.f32(float %7, float %51, float %mul7.i80.i)
  %57 = tail call float @llvm.fmuladd.f32(float %9, float %54, float %56)
  %mul7.i87.i = fmul float %11, %52
  %58 = tail call float @llvm.fmuladd.f32(float %10, float %51, float %mul7.i87.i)
  %59 = tail call float @llvm.fmuladd.f32(float %12, float %54, float %58)
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %121 = load float, ptr %arrayidx7.i.i224, align 4
  %arrayidx12.i.i227 = getelementptr inbounds [4 x float], ptr %arrayidx.i, i64 0, i64 2
  %122 = load float, ptr %arrayidx12.i.i227, align 4
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %9 = load float, ptr %arrayidx16.i.i, align 4
  %arrayidx18.i.i = getelementptr inbounds [4 x float], ptr %to, i64 0, i64 2
  %10 = load float, ptr %arrayidx18.i.i, align 4
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  store <2 x float> %14, ptr %arrayidx, align 4
  %ref.tmp.sroa.4.0.arrayidx.sroa_idx = getelementptr inbounds i8, ptr %arrayidx, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i, ptr %ref.tmp.sroa.4.0.arrayidx.sroa_idx, align 4
...
if.end:                                           ; preds = %entry
  ...
  %8 = load <2 x float>, ptr %corner00, align 4
  %9 = load <2 x float>, ptr %corner01, align 4
  %10 = fsub <2 x float> %9, %8
  %11 = load <2 x float>, ptr %corner10, align 4
  %12 = load <2 x float>, ptr %corner11, align 4
  %13 = fsub <2 x float> %12, %11
  %arrayidx16.i.i280 = getelementptr inbounds [4 x float], ptr %corner10, i64 0, i64 2
  %14 = load float, ptr %arrayidx16.i.i280, align 4
  %arrayidx18.i.i281 = getelementptr inbounds [4 x float], ptr %corner11, i64 0, i64 2
  %15 = load float, ptr %arrayidx18.i.i281, align 4
...
for.body10.us:                                    ; preds = %for.body.us, %for.body10.us
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i297.us, ptr %ref.tmp.sroa.4.0.arrayidx.sroa_idx.us, align 4
  %arrayidx21.us = getelementptr inbounds float, ptr %call2, i64 %31
  store float 1.000000e+00, ptr %arrayidx21.us, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
...
if.end:                                           ; preds = %entry
  ...
  %14 = load float, ptr %arrayidx16.i.i385, align 4
  %arrayidx18.i.i386 = getelementptr inbounds [4 x float], ptr %corner11, i64 0, i64 2
  %15 = load float, ptr %arrayidx18.i.i386, align 4
...
for.body10.us:                                    ; preds = %for.body.us, %for.body10.us
  ...
  store <2 x float> %29, ptr %arrayidx.us, align 4
  %ref.tmp.sroa.4.0.arrayidx.sroa_idx.us = getelementptr inbounds i8, ptr %arrayidx.us, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i402.us, ptr %ref.tmp.sroa.4.0.arrayidx.sroa_idx.us, align 4
  %arrayidx21.us = getelementptr inbounds float, ptr %call2, i64 %31
  store float 1.000000e+00, ptr %arrayidx21.us, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
...
if.then57:                                        ; preds = %if.end54
  ...
  %div60375 = lshr i32 %sub59, 1
  tail call void @_ZN10btSoftBody7setMassEif(ptr noundef nonnull align 8 dereferenceable(1496) %call.i, i32 noundef %div60375, float noundef 0.000000e+00)
  br label %if.end62
...
if.then65:                                        ; preds = %if.end62
  ...
  %div67376 = lshr i32 %sub66, 1
  %mul68 = mul nsw i32 %div67376, %resx
...
if.then73:                                        ; preds = %if.end70
  ...
  %div75377 = lshr i32 %sub74, 1
  %mul76 = mul nsw i32 %div75377, %resx
...
if.then82:                                        ; preds = %if.end79
  ...
  %div86378 = lshr i32 %sub85, 1
  %add87 = add nsw i32 %mul84, %div86378
...
if.then91:                                        ; preds = %if.end88
  ...
  %div93379 = lshr i32 %sub92, 1
  %mul94 = mul nsw i32 %div93379, %resx
  %sub95 = add nsw i32 %resx, -1
  %div96380 = lshr i32 %sub95, 1
  %add97 = add nsw i32 %mul94, %div96380
...
for.cond.cleanup2.i:                              ; preds = %for.body3.i, %for.cond1.preheader.i
  ...
  store float %0, ptr %ref.tmp.sroa.5.0.x.addr.0.sroa_idx.i, align 4
  %ref.tmp.sroa.6.0.x.addr.0.sroa_idx.i = getelementptr inbounds i8, ptr %x.addr.038.i, i64 12
  store float 0.000000e+00, ptr %ref.tmp.sroa.6.0.x.addr.0.sroa_idx.i, align 4
...
invoke.cont17:                                    ; preds = %invoke.cont17.lr.ph, %invoke.cont17
  ...
  %9 = load float, ptr %arrayidx13.i43, align 4
  %mul14.i44 = fmul float %8, %9
  %10 = load <2 x float>, ptr %arrayidx.i, align 4
  %11 = load <2 x float>, ptr %radius, align 4
  %12 = fmul <2 x float> %10, %11
  %13 = load <2 x float>, ptr %center, align 4
  %14 = fadd <2 x float> %12, %13
  %15 = load float, ptr %arrayidx13.i49, align 4
  ...
  store <2 x float> %14, ptr %arrayidx.i, align 4
  store <2 x float> %retval.sroa.3.12.vec.insert.i52, ptr %arrayidx11.i, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
...
invoke.cont:
  ...
  store i32 0, ptr %mNumIndices.i, align 4
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %hlib) #18
  %m_ownsMemory.i.i.i91 = getelementptr inbounds %class.btAlignedObjectArray.84, ptr %hlib, i64 0, i32 6
  store i8 1, ptr %m_ownsMemory.i.i.i91, align 8
  %m_data.i.i.i92 = getelementptr inbounds %class.btAlignedObjectArray.84, ptr %hlib, i64 0, i32 5
  store ptr null, ptr %m_data.i.i.i92, align 8
  %m_size.i.i.i93 = getelementptr inbounds %class.btAlignedObjectArray.84, ptr %hlib, i64 0, i32 2
  store i32 0, ptr %m_size.i.i.i93, align 4
  %m_capacity.i.i.i94 = getelementptr inbounds %class.btAlignedObjectArray.84, ptr %hlib, i64 0, i32 3
...
invoke.cont49:                                    ; preds = %if.end45
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %15 = load i32, ptr %mNumFaces.i, align 8
...
invoke.cont52:                                    ; preds = %invoke.cont50
  %17 = load ptr, ptr %m_data.i.i5.i96, align 8
...
invoke.cont.i:                                    ; preds = %if.then3.i.i.i.i, %invoke.cont52
  ...
  store i32 0, ptr %m_size.i.i6.i97, align 4
  store i32 0, ptr %m_capacity.i.i7.i98, align 8
  %19 = load ptr, ptr %m_data.i.i.i92, align 8
...
lpad.i:                                           ; preds = %if.then3.i.i.i.i
  %21 = landingpad { ptr, i32 }
          cleanup
  %22 = load ptr, ptr %m_data.i.i.i92, align 8
...
invoke.cont53:                                    ; preds = %invoke.cont.i, %if.then3.i.i.i10.i
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %hlib) #18
  %26 = load ptr, ptr %m_data.i.i5.i, align 8
  ...
  br i1 %or.cond.i.i.i111, label %invoke.cont.i116, label %if.then3.i.i.i.i112
...
invoke.cont.i116:                                 ; preds = %if.then3.i.i.i.i112, %invoke.cont53
  store i8 1, ptr %m_ownsMemory.i.i4.i, align 8
  store ptr null, ptr %m_data.i.i5.i, align 8
  store i32 0, ptr %m_size.i.i6.i, align 4
  store i32 0, ptr %m_capacity.i.i7.i, align 8
  %28 = load ptr, ptr %m_data.i.i.i, align 8
  %tobool.not.i.i.i6.i120 = icmp eq ptr %28, null
  %29 = load i8, ptr %m_ownsMemory.i.i.i, align 8
  %tobool2.not.i.i.i8.i122 = icmp eq i8 %29, 0
  %or.cond.i.i9.i123 = select i1 %tobool.not.i.i.i6.i120, i1 true, i1 %tobool2.not.i.i.i8.i122
  br i1 %or.cond.i.i9.i123, label %_ZN10HullResultD2Ev.exit, label %if.then3.i.i.i10.i124

if.then3.i.i.i10.i124:                            ; preds = %invoke.cont.i116
  call void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %28)
  br label %_ZN10HullResultD2Ev.exit

lpad.i113:                                        ; preds = %if.then3.i.i.i.i112
...
if.then3.i.i.i137:                                ; preds = %lpad.i113
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %31)
          to label %common.resume unwind label %terminate.lpad.i114

common.resume:                                    ; preds = %if.then3.i.i.i137, %lpad.i113, %invoke.cont58
  %common.resume.op = phi { ptr, i32 } [ %.pn.pn.pn, %invoke.cont58 ], [ %30, %lpad.i113 ], [ %30, %if.then3.i.i.i137 ]
  resume { ptr, i32 } %common.resume.op

terminate.lpad.i114:                              ; preds = %if.then3.i.i.i137
  %33 = landingpad { ptr, i32 }
          catch ptr null
  %34 = extractvalue { ptr, i32 } %33, 0
...
_ZN10HullResultD2Ev.exit:                         ; preds = %invoke.cont.i116, %if.then3.i.i.i10.i124
  call void @llvm.lifetime.end.p0(i64 80, ptr nonnull %hres) #18
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %hdsc) #18
  ret ptr %call.i99
...
entry:
  ...
  br i1 %cmp288, label %for.body.preheader, label %if.then.i.i.i172

for.body.preheader:                               ; preds = %entry
  %smax = tail call i32 @llvm.smax.i32(i32 %mul, i32 1)
  %wide.trip.count = zext i32 %smax to i64
  %min.iters.check = icmp ult i32 %smax, 8
  br i1 %min.iters.check, label %for.body.preheader328, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi326 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %3, %vector.body ]
  ...
  %wide.load327 = load <4 x i32>, ptr %1, align 4
  %2 = tail call <4 x i32> @llvm.smax.v4i32(<4 x i32> %wide.load, <4 x i32> %vec.phi)
  %3 = tail call <4 x i32> @llvm.smax.v4i32(<4 x i32> %wide.load327, <4 x i32> %vec.phi326)
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %if.then.i.i.i172.loopexit, label %for.body.preheader328

for.body.preheader328:                            ; preds = %for.body.preheader, %middle.block
  %indvars.iv.ph = phi i64 [ 0, %for.body.preheader ], [ %n.vec, %middle.block ]
  %maxidx.0289.ph = phi i32 [ 0, %for.body.preheader ], [ %5, %middle.block ]
  br label %for.body

for.body:                                         ; preds = %for.body.preheader328, %for.body
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body ], [ %indvars.iv.ph, %for.body.preheader328 ]
  %maxidx.0289 = phi i32 [ %.sroa.speculated, %for.body ], [ %maxidx.0289.ph, %for.body.preheader328 ]
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %if.then.i.i.i172.loopexit, label %for.body

if.then.i.i.i172.loopexit:                        ; preds = %for.body, %middle.block
  %.sroa.speculated.lcssa = phi i32 [ %5, %middle.block ], [ %.sroa.speculated, %for.body ]
  %7 = add nuw nsw i32 %.sroa.speculated.lcssa, 1
  br label %if.then.i.i.i172

if.then.i.i.i172:                                 ; preds = %if.then.i.i.i172.loopexit, %entry
  %maxidx.0.lcssa = phi i32 [ 1, %entry ], [ %7, %if.then.i.i.i172.loopexit ]
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %call.i.i.i.i154, i8 0, i64 %conv.i.i.i.i, i1 false)
  %conv.i.i.i.i173 = zext i32 %maxidx.0.lcssa to i64
  %mul.i.i.i.i = shl nuw nsw i64 %conv.i.i.i.i173, 4
...
for.body12.preheader:                             ; preds = %if.then.i.i.i172
  %mul9 = mul i32 %maxidx.0.lcssa, 3
  %smax308 = tail call i32 @llvm.smax.i32(i32 %mul9, i32 3)
  %8 = add nsw i32 %smax308, -1
  %9 = udiv i32 %8, 3
  %10 = add nuw nsw i32 %9, 1
  %wide.trip.count309 = zext i32 %10 to i64
  %xtraiter = and i64 %wide.trip.count309, 1
  %11 = icmp ult i32 %smax308, 4
  br i1 %11, label %for.end28.unr-lcssa, label %for.body12.preheader.new
...
for.body12:                                       ; preds = %for.body12, %for.body12.preheader.new
  ...
  %12 = add nuw nsw i64 %indvars.iv299, 2
  %arrayidx20 = getelementptr inbounds float, ptr %vertices, i64 %12
  ...
  store float %13, ptr %ref.tmp13.sroa.5.0.arrayidx.i.sroa_idx, align 4
  %ref.tmp13.sroa.6.0.arrayidx.i.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i, i64 12
  store float 0.000000e+00, ptr %ref.tmp13.sroa.6.0.arrayidx.i.sroa_idx, align 4
  ...
  %15 = add nuw nsw i64 %indvars.iv299, 5
  %arrayidx20.1 = getelementptr inbounds float, ptr %vertices, i64 %15
  %16 = load float, ptr %arrayidx20.1, align 4
  %arrayidx.i.1 = getelementptr inbounds %class.btVector3, ptr %call.i.i.i.i192, i64 %indvars.iv.next304
  %17 = load <2 x float>, ptr %arrayidx15.1, align 4
  store <2 x float> %17, ptr %arrayidx.i.1, align 4
  %ref.tmp13.sroa.5.0.arrayidx.i.sroa_idx.1 = getelementptr inbounds i8, ptr %arrayidx.i.1, i64 8
  store float %16, ptr %ref.tmp13.sroa.5.0.arrayidx.i.sroa_idx.1, align 4
  %ref.tmp13.sroa.6.0.arrayidx.i.sroa_idx.1 = getelementptr inbounds i8, ptr %arrayidx.i.1, i64 12
  store float 0.000000e+00, ptr %ref.tmp13.sroa.6.0.arrayidx.i.sroa_idx.1, align 4
...
for.body12.epil:                                  ; preds = %for.end28.unr-lcssa
  ...
  %20 = add nuw nsw i64 %indvars.iv299.unr, 2
  %arrayidx20.epil = getelementptr inbounds float, ptr %vertices, i64 %20
  %21 = load float, ptr %arrayidx20.epil, align 4
  %arrayidx.i.epil = getelementptr inbounds %class.btVector3, ptr %call.i.i.i.i192, i64 %indvars.iv303.unr
  %22 = load <2 x float>, ptr %arrayidx15.epil, align 4
  store <2 x float> %22, ptr %arrayidx.i.epil, align 4
  %ref.tmp13.sroa.5.0.arrayidx.i.sroa_idx.epil = getelementptr inbounds i8, ptr %arrayidx.i.epil, i64 8
  store float %21, ptr %ref.tmp13.sroa.5.0.arrayidx.i.sroa_idx.epil, align 4
  %ref.tmp13.sroa.6.0.arrayidx.i.sroa_idx.epil = getelementptr inbounds i8, ptr %arrayidx.i.epil, i64 12
  store float 0.000000e+00, ptr %ref.tmp13.sroa.6.0.arrayidx.i.sroa_idx.epil, align 4
  br label %for.end28
...
invoke.cont30:                                    ; preds = %for.end28
  invoke void @_ZN10btSoftBodyC1EP19btSoftBodyWorldInfoiPK9btVector3PKf(ptr noundef nonnull align 8 dereferenceable(1496) %call.i194, ptr noundef nonnull %worldInfo, i32 noundef %maxidx.0.lcssa, ptr noundef nonnull %call.i.i.i.i192, ptr noundef null)
...
for.body42:                                       ; preds = %for.cond40.preheader, %invoke.cont93
  ...
  %24 = add nuw nsw i64 %indvars.iv315, 1
  %arrayidx47 = getelementptr inbounds i32, ptr %triangles, i64 %24
  %25 = load i32, ptr %arrayidx47, align 4
  %26 = add nuw nsw i64 %indvars.iv315, 2
  %arrayidx51 = getelementptr inbounds i32, ptr %triangles, i64 %26
  %27 = load i32, ptr %arrayidx51, align 4
  %mul58 = mul nsw i32 %23, %maxidx.0.lcssa
  %add61 = add nsw i32 %mul58, %27
  %idxprom.i198 = sext i32 %add61 to i64
  %arrayidx.i199 = getelementptr inbounds i8, ptr %call.i.i.i.i154, i64 %idxprom.i198
  %28 = load i8, ptr %arrayidx.i199, align 1
...
if.then:                                          ; preds = %for.body42
  store i8 1, ptr %arrayidx.i199, align 1
  %mul75 = mul nsw i32 %27, %maxidx.0.lcssa
  %add78 = add nsw i32 %mul75, %23
  %idxprom.i204 = sext i32 %add78 to i64
  %arrayidx.i205 = getelementptr inbounds i8, ptr %call.i.i.i.i154, i64 %idxprom.i204
  store i8 1, ptr %arrayidx.i205, align 1
  invoke void @_ZN10btSoftBody10appendLinkEiiPNS_8MaterialEb(ptr noundef nonnull align 8 dereferenceable(1496) %call.i194, i32 noundef %27, i32 noundef %23, ptr noundef null, i1 noundef zeroext false)
...
for.inc86:                                        ; preds = %for.body42, %if.then
  %mul58.1 = mul nsw i32 %25, %maxidx.0.lcssa
  %add61.1 = add nsw i32 %mul58.1, %23
  %idxprom.i198.1 = sext i32 %add61.1 to i64
  %arrayidx.i199.1 = getelementptr inbounds i8, ptr %call.i.i.i.i154, i64 %idxprom.i198.1
  %32 = load i8, ptr %arrayidx.i199.1, align 1
  %tobool.not.1 = icmp eq i8 %32, 0
  br i1 %tobool.not.1, label %if.then.1, label %for.inc86.1

if.then.1:                                        ; preds = %for.inc86
  store i8 1, ptr %arrayidx.i199.1, align 1
  %add78.1 = add nsw i32 %mul58, %25
  %idxprom.i204.1 = sext i32 %add78.1 to i64
  %arrayidx.i205.1 = getelementptr inbounds i8, ptr %call.i.i.i.i154, i64 %idxprom.i204.1
  store i8 1, ptr %arrayidx.i205.1, align 1
  invoke void @_ZN10btSoftBody10appendLinkEiiPNS_8MaterialEb(ptr noundef nonnull align 8 dereferenceable(1496) %call.i194, i32 noundef %23, i32 noundef %25, ptr noundef null, i1 noundef zeroext false)
          to label %for.inc86.1 unwind label %lpad62

for.inc86.1:                                      ; preds = %if.then.1, %for.inc86
  %mul58.2 = mul nsw i32 %27, %maxidx.0.lcssa
  %add61.2 = add nsw i32 %mul58.2, %25
  %idxprom.i198.2 = sext i32 %add61.2 to i64
  %arrayidx.i199.2 = getelementptr inbounds i8, ptr %call.i.i.i.i154, i64 %idxprom.i198.2
  %33 = load i8, ptr %arrayidx.i199.2, align 1
  %tobool.not.2 = icmp eq i8 %33, 0
  br i1 %tobool.not.2, label %if.then.2, label %for.inc86.2

if.then.2:                                        ; preds = %for.inc86.1
  store i8 1, ptr %arrayidx.i199.2, align 1
  %add78.2 = add nsw i32 %mul58.1, %27
  %idxprom.i204.2 = sext i32 %add78.2 to i64
  %arrayidx.i205.2 = getelementptr inbounds i8, ptr %call.i.i.i.i154, i64 %idxprom.i204.2
  store i8 1, ptr %arrayidx.i205.2, align 1
  invoke void @_ZN10btSoftBody10appendLinkEiiPNS_8MaterialEb(ptr noundef nonnull align 8 dereferenceable(1496) %call.i194, i32 noundef %25, i32 noundef %27, ptr noundef null, i1 noundef zeroext false)
          to label %for.inc86.2 unwind label %lpad62

for.inc86.2:                                      ; preds = %if.then.2, %for.inc86.1
  invoke void @_ZN10btSoftBody10appendFaceEiiiPNS_8MaterialE(ptr noundef nonnull align 8 dereferenceable(1496) %call.i194, i32 noundef %23, i32 noundef %25, i32 noundef %27, ptr noundef null)
          to label %invoke.cont93 unwind label %lpad92

invoke.cont93:                                    ; preds = %for.inc86.2
  %indvars.iv.next316 = add nuw i64 %indvars.iv315, 3
  %34 = trunc i64 %indvars.iv.next316 to i32
  %cmp41 = icmp sgt i32 %mul, %34
...
ehcleanup100:                                     ; preds = %lpad62, %lpad92, %lpad29
  %.pn.pn.pn = phi { ptr, i32 } [ %29, %lpad29 ], [ %31, %lpad62 ], [ %35, %lpad92 ]
...
if.then3.i.i.i227:                                ; preds = %lpad32, %ehcleanup100
  %.pn.pn.pn325 = phi { ptr, i32 } [ %.pn.pn.pn, %ehcleanup100 ], [ %30, %lpad32 ]
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %call.i.i.i.i192)
          to label %ehcleanup102 unwind label %terminate.lpad

ehcleanup102:                                     ; preds = %lpad6, %ehcleanup100, %if.then3.i.i.i227, %lpad
  %.pn.pn.pn.pn = phi { ptr, i32 } [ %18, %lpad ], [ %.pn.pn.pn, %ehcleanup100 ], [ %.pn.pn.pn325, %if.then3.i.i.i227 ], [ %19, %lpad6 ]
...
for.body:                                         ; preds = %if.then.i.i.i, %_ZL8nextLinePKc.exit160
  ...
  %5 = load i8, ptr %node.addr.0232, align 1
  %cmp.not10.i150 = icmp eq i8 %5, 10
  br i1 %cmp.not10.i150, label %_ZL8nextLinePKc.exit160, label %while.body.i151

while.body.i151:                                  ; preds = %for.body, %while.body.i151
  %numBytesRead.012.i152 = phi i32 [ %inc.i155, %while.body.i151 ], [ 0, %for.body ]
  %buffer.addr.011.i153 = phi ptr [ %incdec.ptr.i154, %while.body.i151 ], [ %node.addr.0232, %for.body ]
  %incdec.ptr.i154 = getelementptr inbounds i8, ptr %buffer.addr.011.i153, i64 1
  %inc.i155 = add nuw nsw i32 %numBytesRead.012.i152, 1
  %6 = load i8, ptr %incdec.ptr.i154, align 1
  %cmp.not.i156 = icmp eq i8 %6, 10
  br i1 %cmp.not.i156, label %if.end.loopexit.i157, label %while.body.i151

if.end.loopexit.i157:                             ; preds = %while.body.i151
  %7 = add nuw nsw i32 %numBytesRead.012.i152, 2
  br label %_ZL8nextLinePKc.exit160

_ZL8nextLinePKc.exit160:                          ; preds = %for.body, %if.end.loopexit.i157
  %numBytesRead.0.lcssa.i159 = phi i32 [ 1, %for.body ], [ %7, %if.end.loopexit.i157 ]
  %idx.ext15 = sext i32 %numBytesRead.0.lcssa.i159 to i64
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %14 = load i8, ptr %ele, align 1
  %cmp.not10.i170 = icmp eq i8 %14, 10
  br i1 %cmp.not10.i170, label %_ZL8nextLinePKc.exit180, label %while.body.i171

while.body.i171:                                  ; preds = %if.then, %while.body.i171
  %numBytesRead.012.i172 = phi i32 [ %inc.i175, %while.body.i171 ], [ 0, %if.then ]
  %buffer.addr.011.i173 = phi ptr [ %incdec.ptr.i174, %while.body.i171 ], [ %ele, %if.then ]
  %incdec.ptr.i174 = getelementptr inbounds i8, ptr %buffer.addr.011.i173, i64 1
  %inc.i175 = add nuw nsw i32 %numBytesRead.012.i172, 1
  %15 = load i8, ptr %incdec.ptr.i174, align 1
  %cmp.not.i176 = icmp eq i8 %15, 10
  br i1 %cmp.not.i176, label %if.end.loopexit.i177, label %while.body.i171

if.end.loopexit.i177:                             ; preds = %while.body.i171
  %16 = add nuw nsw i32 %numBytesRead.012.i172, 2
  %17 = zext i32 %16 to i64
  br label %_ZL8nextLinePKc.exit180

_ZL8nextLinePKc.exit180:                          ; preds = %if.then, %if.end.loopexit.i177
  %numBytesRead.0.lcssa.i179 = phi i64 [ 1, %if.then ], [ %17, %if.end.loopexit.i177 ]
  %18 = load i32, ptr %ntetra, align 4
...
for.body46.lr.ph:                                 ; preds = %_ZL8nextLinePKc.exit180
  %add.ptr41 = getelementptr inbounds i8, ptr %ele, i64 %numBytesRead.0.lcssa.i179
...
for.body46:                                       ; preds = %for.body46.lr.ph, %if.end
  ...
  store i32 0, ptr %index47, align 4
  ...
  %21 = load i8, ptr %ele.addr.0235, align 1
  %cmp.not10.i182 = icmp eq i8 %21, 10
  br i1 %cmp.not10.i182, label %_ZL8nextLinePKc.exit192, label %while.body.i183

while.body.i183:                                  ; preds = %for.body46, %while.body.i183
  %numBytesRead.012.i184 = phi i32 [ %inc.i187, %while.body.i183 ], [ 0, %for.body46 ]
  %buffer.addr.011.i185 = phi ptr [ %incdec.ptr.i186, %while.body.i183 ], [ %ele.addr.0235, %for.body46 ]
  %incdec.ptr.i186 = getelementptr inbounds i8, ptr %buffer.addr.011.i185, i64 1
  %inc.i187 = add nuw nsw i32 %numBytesRead.012.i184, 1
  %22 = load i8, ptr %incdec.ptr.i186, align 1
  %cmp.not.i188 = icmp eq i8 %22, 10
  br i1 %cmp.not.i188, label %if.end.loopexit.i189, label %while.body.i183

if.end.loopexit.i189:                             ; preds = %while.body.i183
  %23 = add nuw nsw i32 %numBytesRead.012.i184, 2
  br label %_ZL8nextLinePKc.exit192

_ZL8nextLinePKc.exit192:                          ; preds = %for.body46, %if.end.loopexit.i189
  %numBytesRead.0.lcssa.i191 = phi i32 [ 1, %for.body46 ], [ %23, %if.end.loopexit.i189 ]
  %idx.ext56 = sext i32 %numBytesRead.0.lcssa.i191 to i64
  %add.ptr57 = getelementptr inbounds i8, ptr %ele.addr.0235, i64 %idx.ext56
  %24 = load i32, ptr %ni, align 16
  %25 = load i32, ptr %arrayidx49, align 4
  %26 = load i32, ptr %arrayidx50, align 8
  %27 = load i32, ptr %arrayidx51, align 4
...
invoke.cont70:                                    ; preds = %invoke.cont67
  %32 = load i32, ptr %arrayidx50, align 8
  %33 = load i32, ptr %ni, align 16
...
invoke.cont79:                                    ; preds = %invoke.cont76
  %38 = load i32, ptr %arrayidx50, align 8
...
if.end:                                           ; preds = %invoke.cont79, %invoke.cont62
  ...
  %41 = load i32, ptr %ntetra, align 4
...
if.end92:                                         ; preds = %for.cond.cleanup45, %land.lhs.true, %invoke.cont32
  ...
  %42 = load i32, ptr %m_size.i193, align 4
  ...
  %43 = load i32, ptr %m_size.i194, align 4
  ...
  %44 = load i32, ptr %m_size.i195, align 4
  ...
  %45 = load i32, ptr %m_size.i196, align 4
