; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btBox2dBox2dCollisionAlgorithm.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btBox2dBox2dCollisionAlgorithm.cpp"
...
invoke.cont6:                                     ; preds = %if.then
  store ptr %call7, ptr %m_manifoldPtr, align 8
...
if.end:                                           ; preds = %entry
  ...
  %2 = load ptr, ptr %m_collisionShape.i13, align 8
  ...
  %m_ownManifold = getelementptr inbounds %class.btBox2dBox2dCollisionAlgorithm, ptr %this, i64 0, i32 1
  %3 = load i8, ptr %m_ownManifold, align 8
...
if.end4:                                          ; preds = %if.end
  ...
  %10 = tail call float @llvm.fmuladd.f32(float %xf2.sroa.0.0, float %5, float %mul8.i.i48.i)
  %11 = tail call float @llvm.fmuladd.f32(float %xf2.sroa.18457.0, float %9, float %10)
  %mul8.i14.i53.i = fmul float %xf2.sroa.14.0, %7
  %12 = tail call float @llvm.fmuladd.f32(float %xf2.sroa.6.0, float %5, float %mul8.i14.i53.i)
  %13 = tail call float @llvm.fmuladd.f32(float %xf2.sroa.22.0, float %9, float %12)
  %mul8.i20.i57.i = fmul float %xf2.sroa.16.0, %7
  %14 = tail call float @llvm.fmuladd.f32(float %xf2.sroa.8.0, float %5, float %mul8.i20.i57.i)
  %15 = tail call float @llvm.fmuladd.f32(float %xf2.sroa.24.0, float %9, float %14)
  %16 = load float, ptr %m_normals.i44.i, align 4
  %arrayidx7.i.i178 = getelementptr inbounds %class.btBox2dShape, ptr %polyB.polyA, i64 0, i32 3, i64 0, i32 0, i64 1
  %17 = load float, ptr %arrayidx7.i.i178, align 4
  %mul8.i.i = fmul float %17, %13
  ...
  %20 = tail call float @llvm.fmuladd.f32(float %15, float %19, float %18)
  %cmp14.i = fcmp olt float %20, 0x43ABC16D60000000
  %minDot.1.i = select i1 %cmp14.i, float %20, float 0x43ABC16D60000000
  %arrayidx12.1.i = getelementptr inbounds %class.btBox2dShape, ptr %polyB.polyA, i64 0, i32 3, i64 1
  %21 = load float, ptr %arrayidx12.1.i, align 4
  %arrayidx7.i.1.i = getelementptr inbounds %class.btBox2dShape, ptr %polyB.polyA, i64 0, i32 3, i64 1, i32 0, i64 1
  %22 = load float, ptr %arrayidx7.i.1.i, align 4
  %mul8.i.1.i = fmul float %13, %22
  %23 = tail call float @llvm.fmuladd.f32(float %11, float %21, float %mul8.i.1.i)
  %arrayidx12.i.1.i = getelementptr inbounds %class.btBox2dShape, ptr %polyB.polyA, i64 0, i32 3, i64 1, i32 0, i64 2
  %24 = load float, ptr %arrayidx12.i.1.i, align 4
  %25 = tail call float @llvm.fmuladd.f32(float %15, float %24, float %23)
  %cmp14.1.i = fcmp olt float %25, %minDot.1.i
  %minDot.1.1.i = select i1 %cmp14.1.i, float %25, float %minDot.1.i
  ...
  %26 = load float, ptr %arrayidx12.2.i, align 4
  %arrayidx7.i.2.i = getelementptr inbounds %class.btBox2dShape, ptr %polyB.polyA, i64 0, i32 3, i64 2, i32 0, i64 1
  %27 = load float, ptr %arrayidx7.i.2.i, align 4
  %mul8.i.2.i = fmul float %13, %27
  %28 = tail call float @llvm.fmuladd.f32(float %11, float %26, float %mul8.i.2.i)
  %arrayidx12.i.2.i = getelementptr inbounds %class.btBox2dShape, ptr %polyB.polyA, i64 0, i32 3, i64 2, i32 0, i64 2
  %29 = load float, ptr %arrayidx12.i.2.i, align 4
  %30 = tail call float @llvm.fmuladd.f32(float %15, float %29, float %28)
  %cmp14.2.i = fcmp olt float %30, %minDot.1.1.i
  %minDot.1.2.i = select i1 %cmp14.2.i, float %30, float %minDot.1.1.i
  ...
  %31 = load float, ptr %arrayidx12.3.i, align 4
  %arrayidx7.i.3.i = getelementptr inbounds %class.btBox2dShape, ptr %polyB.polyA, i64 0, i32 3, i64 3, i32 0, i64 1
  %32 = load float, ptr %arrayidx7.i.3.i, align 4
  %mul8.i.3.i = fmul float %13, %32
  %33 = tail call float @llvm.fmuladd.f32(float %11, float %31, float %mul8.i.3.i)
  %arrayidx12.i.3.i = getelementptr inbounds %class.btBox2dShape, ptr %polyB.polyA, i64 0, i32 3, i64 3, i32 0, i64 2
  %34 = load float, ptr %arrayidx12.i.3.i, align 4
  %35 = tail call float @llvm.fmuladd.f32(float %15, float %34, float %33)
  %cmp14.3.i = fcmp olt float %35, %minDot.1.2.i
  %36 = zext i32 %index.1.2.i to i64
  ...
  %41 = load <2 x float>, ptr %xf2.sroa.26465.0.in, align 4
  ...
  %57 = fadd <2 x float> %41, %56
  %mul8.i29.i.i.i = fmul float %xf2.sroa.22.0, %39
  %58 = tail call float @llvm.fmuladd.f32(float %xf2.sroa.18457.0, float %38, float %mul8.i29.i.i.i)
  %59 = tail call float @llvm.fmuladd.f32(float %xf2.sroa.24.0, float %40, float %58)
  ...
  store <2 x float> %72, ptr %arrayidx28.i, align 4
  %ref.tmp23.sroa.4.0.v29.sroa_idx.i = getelementptr inbounds %struct.ClipVertex, ptr %incidentEdge, i64 1, i32 0, i32 0, i64 2
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i86.i, ptr %ref.tmp23.sroa.4.0.v29.sroa_idx.i, align 4
  ...
  %v11.sroa.14.0.copyload = load <2 x float>, ptr %v11.sroa.14.0.arrayidx.sroa_idx, align 4
  ...
  %cond-lvalue = getelementptr inbounds %class.btVector3, ptr %m_vertices.i, i64 %cond-lvalue.idx
  ...
  %v12.sroa.12.0.copyload = load <2 x float>, ptr %v12.sroa.12.0.cond-lvalue.sroa_idx, align 4
  ...
  %101 = load float, ptr %ref.tmp17.sroa.4.0.v.sroa_idx.i, align 8
  %102 = load <2 x float>, ptr %incidentEdge, align 16
  ...
  %119 = load <2 x float>, ptr %arrayidx28.i, align 4
  ...
  %123 = load float, ptr %ref.tmp23.sroa.4.0.v29.sroa_idx.i, align 4
...
if.then8.i:                                       ; preds = %if.end.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %arrayidx12.i272, ptr noundef nonnull align 4 dereferenceable(20) %arrayidx28.i, i64 20, i1 false)
  br label %if.end13.i
...
if.then15.i:                                      ; preds = %if.end13.i
  ...
  store <2 x float> %129, ptr %arrayidx31.i, align 4
  %ref.tmp.sroa.4.0.v32.sroa_idx.i = getelementptr inbounds i8, ptr %arrayidx31.i, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i86.i, ptr %ref.tmp.sroa.4.0.v32.sroa_idx.i, align 4
...
if.end82:                                         ; preds = %_ZL17ClipSegmentToLineP10ClipVertexS0_RK9btVector3f.exit
  %131 = load float, ptr %arrayidx5.i248, align 8
  %132 = load <2 x float>, ptr %clipPoints1, align 16
  ...
  %137 = load <2 x float>, ptr %arrayidx52, align 4
  ...
  %141 = load float, ptr %arrayidx5.i251, align 4
  ...
  br i1 %cmp.i289, label %if.end.i291, label %if.then.i290
...
if.end.i291:                                      ; preds = %if.then.i290, %if.end82
  %numOut.0.i292 = phi i32 [ 1, %if.then.i290 ], [ 0, %if.end82 ]
  %cmp7.i293 = fcmp ugt float %sub4.i288, 0.000000e+00
  br i1 %cmp7.i293, label %if.end13.i298, label %if.then8.i294

if.then8.i294:                                    ; preds = %if.end.i291
  %inc10.i295 = add nuw nsw i32 %numOut.0.i292, 1
  %idxprom11.i296 = zext i32 %numOut.0.i292 to i64
  %arrayidx12.i297 = getelementptr inbounds %struct.ClipVertex, ptr %clipPoints2, i64 %idxprom11.i296
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %arrayidx12.i297, ptr noundef nonnull align 4 dereferenceable(20) %arrayidx52, i64 20, i1 false)
  br label %if.end13.i298

if.end13.i298:                                    ; preds = %if.then8.i294, %if.end.i291
  %numOut.1.i299 = phi i32 [ %inc10.i295, %if.then8.i294 ], [ %numOut.0.i292, %if.end.i291 ]
  %mul.i300 = fmul float %sub.i283, %sub4.i288
  %cmp14.i301 = fcmp olt float %mul.i300, 0.000000e+00
  br i1 %cmp14.i301, label %if.then15.i303, label %_ZL17ClipSegmentToLineP10ClipVertexS0_RK9btVector3f.exit326

if.then15.i303:                                   ; preds = %if.end13.i298
  %sub16.i304 = fsub float %sub.i283, %sub4.i288
  %div.i305 = fdiv float %sub.i283, %sub16.i304
  %143 = fsub <2 x float> %137, %132
  %sub14.i.i308 = fsub float %141, %131
  %mul8.i.i.i311 = fmul float %sub14.i.i308, %div.i305
  %144 = insertelement <2 x float> poison, float %div.i305, i64 0
  ...
  %add14.i.i314 = fadd float %131, %mul8.i.i.i311
  %retval.sroa.3.12.vec.insert.i86.i317 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i.i314, i64 0
  %idxprom30.i318 = zext i32 %numOut.1.i299 to i64
  %arrayidx31.i319 = getelementptr inbounds %struct.ClipVertex, ptr %clipPoints2, i64 %idxprom30.i318
  store <2 x float> %147, ptr %arrayidx31.i319, align 4
  %ref.tmp.sroa.4.0.v32.sroa_idx.i320 = getelementptr inbounds i8, ptr %arrayidx31.i319, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i86.i317, ptr %ref.tmp.sroa.4.0.v32.sroa_idx.i320, align 4
  %cmp33.i321 = fcmp ule float %sub.i283, 0.000000e+00
  %..i322 = zext i1 %cmp33.i321 to i64
  %id40.i323 = getelementptr inbounds %struct.ClipVertex, ptr %clipPoints1, i64 %..i322, i32 1
  %.sink.i324 = load i32, ptr %id40.i323, align 4
  %148 = getelementptr inbounds %struct.ClipVertex, ptr %clipPoints2, i64 %idxprom30.i318, i32 1
  store i32 %.sink.i324, ptr %148, align 4
  %inc45.i325 = add nuw nsw i32 %numOut.1.i299, 1
  br label %_ZL17ClipSegmentToLineP10ClipVertexS0_RK9btVector3f.exit326

_ZL17ClipSegmentToLineP10ClipVertexS0_RK9btVector3f.exit326: ; preds = %if.end13.i298, %if.then15.i303
  %numOut.2.i302 = phi i32 [ %inc45.i325, %if.then15.i303 ], [ %numOut.1.i299, %if.end13.i298 ]
  %cmp86 = icmp ult i32 %numOut.2.i302, 2
  br i1 %cmp86, label %cleanup, label %if.end88

if.end88:                                         ; preds = %_ZL17ClipSegmentToLineP10ClipVertexS0_RK9btVector3f.exit326
  %149 = load i32, ptr @b2_maxManifoldPoints, align 4
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end107
  ...
  %153 = load float, ptr %arrayidx96, align 4
  %arrayidx7.i338 = getelementptr inbounds [4 x float], ptr %arrayidx96, i64 0, i64 1
  %154 = load float, ptr %arrayidx7.i338, align 4
  ...
  %156 = load float, ptr %arrayidx12.i341, align 4
...
entry:
  ...
  %0 = load <4 x float>, ptr %xf2, align 4
  %1 = shufflevector <4 x float> %0, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %2 = load float, ptr %m_centroid.i, align 4
  ...
  %6 = load <4 x float>, ptr %arrayidx10.i.i.i, align 4
  ...
  %9 = load <4 x float>, ptr %m_origin.i.i, align 4
  ...
  %11 = load <4 x float>, ptr %arrayidx.i.i.i, align 4
  ...
  %13 = load <4 x float>, ptr %arrayidx5.i20.i.i, align 4
  ...
  %15 = load <4 x float>, ptr %arrayidx10.i23.i.i, align 4
  ...
  %17 = load float, ptr %arrayidx.i25.i.i, align 4
  %arrayidx.i26.i.i = getelementptr inbounds [3 x %class.btVector3], ptr %xf2, i64 0, i64 2
  %18 = load <4 x float>, ptr %arrayidx.i26.i.i, align 4
  ...
  %20 = load <4 x float>, ptr %arrayidx5.i27.i.i, align 4
  ...
  %22 = load <4 x float>, ptr %arrayidx10.i30.i.i, align 4
  ...
  %44 = insertelement <2 x float> %10, float %31, i64 1
  %45 = fadd <2 x float> %43, %44
  %arrayidx.i.i.i153 = getelementptr inbounds [3 x %class.btVector3], ptr %xf1, i64 0, i64 1
  %46 = load float, ptr %arrayidx.i.i.i153, align 4
  %arrayidx5.i20.i.i154 = getelementptr inbounds [3 x %class.btVector3], ptr %xf1, i64 0, i64 1, i32 0, i64 1
  %47 = load float, ptr %arrayidx5.i20.i.i154, align 4
  %arrayidx10.i23.i.i156 = getelementptr inbounds [3 x %class.btVector3], ptr %xf1, i64 0, i64 1, i32 0, i64 2
  %48 = load float, ptr %arrayidx10.i23.i.i156, align 4
  %arrayidx.i25.i.i157 = getelementptr inbounds %class.btTransform, ptr %xf1, i64 0, i32 1, i32 0, i64 1
  %49 = load float, ptr %arrayidx.i25.i.i157, align 4
  %50 = insertelement <2 x float> %14, float %47, i64 1
  %51 = fmul <2 x float> %34, %50
  %52 = insertelement <2 x float> %12, float %46, i64 1
  %53 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %52, <2 x float> %38, <2 x float> %51)
  %54 = insertelement <2 x float> %16, float %48, i64 1
  %55 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %54, <2 x float> %42, <2 x float> %53)
  ...
  %59 = load float, ptr %arrayidx.i26.i.i159, align 4
  %arrayidx5.i27.i.i160 = getelementptr inbounds [3 x %class.btVector3], ptr %xf1, i64 0, i64 2, i32 0, i64 1
  %60 = load float, ptr %arrayidx5.i27.i.i160, align 4
  %arrayidx10.i30.i.i162 = getelementptr inbounds [3 x %class.btVector3], ptr %xf1, i64 0, i64 2, i32 0, i64 2
  %61 = load float, ptr %arrayidx10.i30.i.i162, align 4
  %arrayidx.i32.i.i163 = getelementptr inbounds %class.btTransform, ptr %xf1, i64 0, i32 1, i32 0, i64 2
  %62 = load float, ptr %arrayidx.i32.i.i163, align 4
  %63 = insertelement <2 x float> %21, float %60, i64 1
  %64 = fmul <2 x float> %34, %63
  %65 = insertelement <2 x float> %19, float %59, i64 1
  %66 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %65, <2 x float> %38, <2 x float> %64)
  %67 = insertelement <2 x float> %23, float %61, i64 1
  %68 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %67, <2 x float> %42, <2 x float> %66)
  %69 = insertelement <2 x float> poison, float %24, i64 0
  ...
  %mul8.i.i = fmul float %46, %sub8.i
  %75 = tail call float @llvm.fmuladd.f32(float %25, float %sub.i, float %mul8.i.i)
  %76 = tail call float @llvm.fmuladd.f32(float %59, float %sub14.i, float %75)
  %mul8.i14.i = fmul float %47, %sub8.i
  %77 = tail call float @llvm.fmuladd.f32(float %27, float %sub.i, float %mul8.i14.i)
  %78 = tail call float @llvm.fmuladd.f32(float %60, float %sub14.i, float %77)
  %mul8.i20.i = fmul float %48, %sub8.i
  %79 = tail call float @llvm.fmuladd.f32(float %29, float %sub.i, float %mul8.i20.i)
  %80 = tail call float @llvm.fmuladd.f32(float %61, float %sub14.i, float %79)
  %81 = load float, ptr %m_normals.i, align 4
  %arrayidx5.i177 = getelementptr inbounds %class.btBox2dShape, ptr %poly1, i64 0, i32 3, i64 0, i32 0, i64 1
  %82 = load float, ptr %arrayidx5.i177, align 4
  ...
  %89 = load float, ptr %arrayidx10.i.1, align 4
  ...
  %94 = load float, ptr %arrayidx10.i.2, align 4
  ...
  %99 = load float, ptr %arrayidx10.i.3, align 4
...
cleanup80.sink.split:                             ; preds = %if.end68, %if.end68.us, %if.else
  ...
  store i32 %edge.1.3.sink, ptr %edgeIndex, align 4
  br label %cleanup80
...
entry:
  ...
  %mul8.i14.i = fmul float %3, %9
  %10 = tail call float @llvm.fmuladd.f32(float %8, float %1, float %mul8.i14.i)
  ...
  %mul8.i20.i = fmul float %3, %14
  %15 = tail call float @llvm.fmuladd.f32(float %13, float %1, float %mul8.i20.i)
  ...
  %21 = load float, ptr %arrayidx.i.i38, align 4
  %22 = load float, ptr %arrayidx.i26.i, align 4
  %23 = load float, ptr %arrayidx.i27.i, align 4
  %24 = load float, ptr %arrayidx.i28.i, align 4
  %25 = load float, ptr %arrayidx.i29.i, align 4
  %26 = load float, ptr %arrayidx.i30.i, align 4
  %mul8.i.i41 = fmul float %12, %19
  %27 = tail call float @llvm.fmuladd.f32(float %18, float %7, float %mul8.i.i41)
  %28 = tail call float @llvm.fmuladd.f32(float %20, float %17, float %27)
  %mul8.i14.i46 = fmul float %12, %22
  %29 = tail call float @llvm.fmuladd.f32(float %21, float %7, float %mul8.i14.i46)
  %30 = tail call float @llvm.fmuladd.f32(float %23, float %17, float %29)
  %mul8.i20.i50 = fmul float %12, %25
  %31 = tail call float @llvm.fmuladd.f32(float %24, float %7, float %mul8.i20.i50)
  %32 = tail call float @llvm.fmuladd.f32(float %26, float %17, float %31)
  %33 = load float, ptr %m_vertices.i37, align 4
  %arrayidx5.i89 = getelementptr inbounds %class.btBox2dShape, ptr %poly2, i64 0, i32 2, i64 0, i32 0, i64 1
  %34 = load float, ptr %arrayidx5.i89, align 4
  %mul8.i91 = fmul float %30, %34
  %35 = tail call float @llvm.fmuladd.f32(float %33, float %28, float %mul8.i91)
  %arrayidx10.i92 = getelementptr inbounds %class.btBox2dShape, ptr %poly2, i64 0, i32 2, i64 0, i32 0, i64 2
  %36 = load float, ptr %arrayidx10.i92, align 4
  %37 = tail call float @llvm.fmuladd.f32(float %36, float %32, float %35)
  %cmp13 = fcmp olt float %37, 0x43ABC16D60000000
  %minDot.1 = select i1 %cmp13, float %37, float 0x43ABC16D60000000
  %arrayidx11.1 = getelementptr inbounds %class.btBox2dShape, ptr %poly2, i64 0, i32 2, i64 1
  %38 = load float, ptr %arrayidx11.1, align 4
  %arrayidx5.i89.1 = getelementptr inbounds %class.btBox2dShape, ptr %poly2, i64 0, i32 2, i64 1, i32 0, i64 1
  %39 = load float, ptr %arrayidx5.i89.1, align 4
  %mul8.i91.1 = fmul float %30, %39
  %40 = tail call float @llvm.fmuladd.f32(float %38, float %28, float %mul8.i91.1)
  %arrayidx10.i92.1 = getelementptr inbounds %class.btBox2dShape, ptr %poly2, i64 0, i32 2, i64 1, i32 0, i64 2
  %41 = load float, ptr %arrayidx10.i92.1, align 4
  %42 = tail call float @llvm.fmuladd.f32(float %41, float %32, float %40)
  %cmp13.1 = fcmp olt float %42, %minDot.1
  %minDot.1.1 = select i1 %cmp13.1, float %42, float %minDot.1
  %arrayidx11.2 = getelementptr inbounds %class.btBox2dShape, ptr %poly2, i64 0, i32 2, i64 2
  %43 = load float, ptr %arrayidx11.2, align 4
  %arrayidx5.i89.2 = getelementptr inbounds %class.btBox2dShape, ptr %poly2, i64 0, i32 2, i64 2, i32 0, i64 1
  %44 = load float, ptr %arrayidx5.i89.2, align 4
  %mul8.i91.2 = fmul float %30, %44
  %45 = tail call float @llvm.fmuladd.f32(float %43, float %28, float %mul8.i91.2)
  %arrayidx10.i92.2 = getelementptr inbounds %class.btBox2dShape, ptr %poly2, i64 0, i32 2, i64 2, i32 0, i64 2
  %46 = load float, ptr %arrayidx10.i92.2, align 4
  %47 = tail call float @llvm.fmuladd.f32(float %46, float %32, float %45)
  %cmp13.2 = fcmp olt float %47, %minDot.1.1
  %minDot.1.2 = select i1 %cmp13.2, float %47, float %minDot.1.1
  %48 = zext i1 %cmp13.1 to i64
  %arrayidx11.3 = getelementptr inbounds %class.btBox2dShape, ptr %poly2, i64 0, i32 2, i64 3
  %49 = load float, ptr %arrayidx11.3, align 4
  %arrayidx5.i89.3 = getelementptr inbounds %class.btBox2dShape, ptr %poly2, i64 0, i32 2, i64 3, i32 0, i64 1
  %50 = load float, ptr %arrayidx5.i89.3, align 4
  %mul8.i91.3 = fmul float %30, %50
  %51 = tail call float @llvm.fmuladd.f32(float %49, float %28, float %mul8.i91.3)
  %arrayidx10.i92.3 = getelementptr inbounds %class.btBox2dShape, ptr %poly2, i64 0, i32 2, i64 3, i32 0, i64 2
  %52 = load float, ptr %arrayidx10.i92.3, align 4
  %53 = tail call float @llvm.fmuladd.f32(float %52, float %32, float %51)
  %cmp13.3 = fcmp olt float %53, %minDot.1.2
  %54 = select i1 %cmp13.2, i64 2, i64 %48
  ...
  %55 = load float, ptr %arrayidx15, align 4
  %arrayidx7.i.i.i = getelementptr inbounds [4 x float], ptr %arrayidx15, i64 0, i64 1
  %56 = load float, ptr %arrayidx7.i.i.i, align 4
  ...
  %72 = insertelement <2 x float> %71, float %0, i64 1
  ...
  %76 = insertelement <2 x float> poison, float %24, i64 0
  %77 = insertelement <2 x float> %76, float %5, i64 1
  ...
  %81 = insertelement <2 x float> %65, float %58, i64 1
  %82 = fadd <2 x float> %81, %80
  %arrayidx.i25.i.i69 = getelementptr inbounds %class.btTransform, ptr %xf2, i64 0, i32 1, i32 0, i64 1
  %83 = load float, ptr %arrayidx.i25.i.i69, align 4
  %84 = insertelement <2 x float> poison, float %22, i64 0
  %85 = insertelement <2 x float> %84, float %9, i64 1
  %86 = fmul <2 x float> %85, %69
  %87 = insertelement <2 x float> poison, float %19, i64 0
  %88 = insertelement <2 x float> %87, float %8, i64 1
  %89 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %88, <2 x float> %74, <2 x float> %86)
  %90 = insertelement <2 x float> poison, float %25, i64 0
  %91 = insertelement <2 x float> %90, float %11, i64 1
  %92 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %91, <2 x float> %79, <2 x float> %89)
  ...
  %96 = load float, ptr %arrayidx.i32.i.i75, align 4
  %97 = insertelement <2 x float> poison, float %23, i64 0
  %98 = insertelement <2 x float> %97, float %14, i64 1
  %99 = fmul <2 x float> %98, %69
  %100 = insertelement <2 x float> poison, float %20, i64 0
  %101 = insertelement <2 x float> %100, float %13, i64 1
  %102 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %101, <2 x float> %74, <2 x float> %99)
  %103 = insertelement <2 x float> poison, float %26, i64 0
  %104 = insertelement <2 x float> %103, float %16, i64 1
  %105 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %104, <2 x float> %79, <2 x float> %102)
  %106 = insertelement <2 x float> poison, float %96, i64 0
  %107 = insertelement <2 x float> %106, float %60, i64 1
  %108 = fadd <2 x float> %105, %107
  %shift = shufflevector <2 x float> %82, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %109 = fsub <2 x float> %82, %shift
  ...
  %112 = tail call float @llvm.fmuladd.f32(float %sub.i, float %7, float %mul8.i)
  %113 = tail call float @llvm.fmuladd.f32(float %sub14.i, float %17, float %112)
  ret float %113
}
...
attributes #7 = { nofree nosync nounwind memory(argmem: readwrite) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
