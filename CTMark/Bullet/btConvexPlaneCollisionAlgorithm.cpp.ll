...
if.then:                                          ; preds = %entry
  ...
  %221 = load float, ptr %m_worldTransform.i63, align 4, !tbaa !32
  %222 = load float, ptr %m_planeNormal.i, align 4, !tbaa !32
  %223 = load float, ptr %arrayidx.i.i.i, align 4, !tbaa !32
  %224 = load float, ptr %arrayidx3.i, align 4, !tbaa !32
  %225 = load float, ptr %arrayidx.i28.i.i, align 4, !tbaa !32
  %226 = load float, ptr %arrayidx7.i, align 4, !tbaa !32
  %227 = load float, ptr %arrayidx3.i.i, align 4, !tbaa !32
  %228 = load float, ptr %arrayidx.i26.i.i, align 4, !tbaa !32
  %229 = load float, ptr %arrayidx.i29.i.i, align 4, !tbaa !32
...
_Z13btPlaneSpace1RK9btVector3RS_S2_.exit:         ; preds = %if.then.i, %if.else.i
  ...
  %m_numPerturbationIterations = getelementptr inbounds %class.btConvexPlaneCollisionAlgorithm, ptr %this, i64 0, i32 6
  %30 = load i32, ptr %m_numPerturbationIterations, align 4, !tbaa !17
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %40 = load float, ptr %m_planeNormal.i, align 4, !tbaa !32
  %41 = load float, ptr %arrayidx5.i.i.i.i.i64, align 4, !tbaa !32
  %mul8.i.i.i.i.i65 = fmul float %41, %41
  %42 = tail call float @llvm.fmuladd.f32(float %40, float %40, float %mul8.i.i.i.i.i65)
  %43 = load float, ptr %arrayidx.i.i, align 4, !tbaa !32
  ...
  %45 = load float, ptr %m_planeNormal.i, align 4, !tbaa !32
  %mul4.i.i71 = fmul float %45, %div.i.i70
  %neg37.i = fmul float %37, %mul4.i.i71
  %46 = load <2 x float>, ptr %arrayidx5.i.i.i.i.i64, align 4, !tbaa !32
  ...
  %91 = load i32, ptr %m_numPerturbationIterations, align 4, !tbaa !17
...
if.end.i:                                         ; preds = %if.then43
  ...
  %97 = load ptr, ptr %m_body0.i.i, align 8, !tbaa !39
  %m_body0.i = getelementptr inbounds %class.btManifoldResult, ptr %resultOut, i64 0, i32 4
  %98 = load ptr, ptr %m_body0.i, align 8, !tbaa !40
