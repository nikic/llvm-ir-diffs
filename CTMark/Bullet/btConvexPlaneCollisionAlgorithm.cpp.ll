; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btConvexPlaneCollisionAlgorithm.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btConvexPlaneCollisionAlgorithm.cpp"
...
if.then:                                          ; preds = %land.lhs.true
  ...
  store ptr %call17, ptr %m_manifoldPtr, align 8
...
entry:
  ...
  %2 = load ptr, ptr %m_collisionShape.i62, align 8
  ...
  %convexWorldTransform.sroa.0.0.copyload = load float, ptr %m_worldTransform.i, align 4
  ...
  %convexWorldTransform.sroa.7.0.copyload = load float, ptr %convexWorldTransform.sroa.7.0.m_worldTransform.i.sroa_idx, align 4
  ...
  %convexWorldTransform.sroa.11.0.copyload = load float, ptr %convexWorldTransform.sroa.11.0.m_worldTransform.i.sroa_idx, align 4
  %arrayidx6.i.i = getelementptr inbounds %class.btCollisionObject, ptr %cond, i64 0, i32 1, i32 0, i32 0, i64 1
  %convexWorldTransform.sroa.16.16.copyload = load float, ptr %arrayidx6.i.i, align 4
  ...
  %convexWorldTransform.sroa.21.16.copyload = load float, ptr %convexWorldTransform.sroa.21.16.arrayidx6.i.i.sroa_idx, align 4
  ...
  %convexWorldTransform.sroa.25.16.copyload = load float, ptr %convexWorldTransform.sroa.25.16.arrayidx6.i.i.sroa_idx, align 4
  ...
  %convexWorldTransform.sroa.35.32.copyload = load float, ptr %convexWorldTransform.sroa.35.32.arrayidx10.i.i.sroa_idx, align 4
  ...
  %convexWorldTransform.sroa.39.32.copyload = load float, ptr %convexWorldTransform.sroa.39.32.arrayidx10.i.i.sroa_idx, align 4
  %m_origin3.i = getelementptr inbounds %class.btCollisionObject, ptr %cond, i64 0, i32 1, i32 1
  %convexWorldTransform.sroa.44.48.copyload = load float, ptr %m_origin3.i, align 4
  ...
  %convexWorldTransform.sroa.49.48.copyload = load float, ptr %convexWorldTransform.sroa.49.48.m_origin3.i.sroa_idx, align 4
  ...
  %3 = load float, ptr %m_worldTransform.i63, align 4
  %4 = load float, ptr %arrayidx3.i.i, align 4
  %5 = load float, ptr %arrayidx6.i.i64, align 4
  %6 = load float, ptr %arrayidx.i.i.i, align 4
  %7 = load float, ptr %arrayidx.i26.i.i, align 4
  %8 = load float, ptr %arrayidx.i27.i.i, align 4
  ...
  %12 = load float, ptr %m_origin.i65, align 4
  ...
  %74 = load <2 x float>, ptr %perturbeRot, align 4
  ...
  %190 = load float, ptr %m_worldTransform.i63, align 4
  %191 = load float, ptr %arrayidx.i.i.i, align 4
  %192 = load float, ptr %arrayidx.i28.i.i, align 4
  %193 = load float, ptr %arrayidx3.i.i, align 4
  %194 = load float, ptr %arrayidx.i26.i.i, align 4
  %195 = load float, ptr %arrayidx.i29.i.i, align 4
  %196 = load <2 x float>, ptr %m_origin.i65, align 4
  %197 = load float, ptr %arrayidx6.i.i64, align 4
  %198 = load float, ptr %arrayidx.i27.i.i, align 4
  %199 = load float, ptr %arrayidx.i30.i.i, align 4
  %200 = load float, ptr %arrayidx7.i.i, align 4
  %m_manifoldPtr = getelementptr inbounds %class.btConvexPlaneCollisionAlgorithm, ptr %this, i64 0, i32 3
  ...
  store ptr %202, ptr %m_manifoldPtr.i, align 8
...
if.then:                                          ; preds = %entry
  ...
  %221 = load float, ptr %m_worldTransform.i63, align 4
  %222 = load float, ptr %m_planeNormal.i, align 4
  %223 = load float, ptr %arrayidx.i.i.i, align 4
  %224 = load float, ptr %arrayidx3.i, align 4
  %225 = load float, ptr %arrayidx.i28.i.i, align 4
  %226 = load float, ptr %arrayidx7.i, align 4
  %227 = load float, ptr %arrayidx3.i.i, align 4
  %228 = load float, ptr %arrayidx.i26.i.i, align 4
  %229 = load float, ptr %arrayidx.i29.i.i, align 4
  ...
  %245 = load float, ptr %arrayidx6.i.i64, align 4
  %246 = load float, ptr %arrayidx.i27.i.i, align 4
  %mul8.i20.i242 = fmul float %224, %246
  %247 = call float @llvm.fmuladd.f32(float %245, float %222, float %mul8.i20.i242)
  %248 = load float, ptr %arrayidx.i30.i.i, align 4
  ...
  store <2 x float> %220, ptr %pOnB, align 8
  %vtxInPlaneWorld.sroa.4.0.pOnB.sroa_idx = getelementptr inbounds i8, ptr %pOnB, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i227, ptr %vtxInPlaneWorld.sroa.4.0.pOnB.sroa_idx, align 8
...
if.end:                                           ; preds = %entry
  ...
  %3 = load ptr, ptr %m_collisionShape.i60, align 8
  ...
  store <4 x float> <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00>, ptr %rotq, align 16
  ...
  %m_minimumPointsPerturbationThreshold = getelementptr inbounds %class.btConvexPlaneCollisionAlgorithm, ptr %this, i64 0, i32 7
  %6 = load i32, ptr %m_minimumPointsPerturbationThreshold, align 8
...
_Z13btPlaneSpace1RK9btVector3RS_S2_.exit:         ; preds = %if.then.i, %if.else.i
  ...
  %22 = load float, ptr @gContactBreakingThreshold, align 4
  ...
  %mul8.i.i.i.i.i = extractelement <2 x float> %23, i64 1
  %24 = extractelement <2 x float> %20, i64 0
  %25 = tail call float @llvm.fmuladd.f32(float %24, float %24, float %mul8.i.i.i.i.i)
  %26 = tail call float @llvm.fmuladd.f32(float %v0.sroa.10.0, float %v0.sroa.10.0, float %25)
  ...
  %27 = insertelement <2 x float> poison, float %div.i.i, i64 0
  ...
  %m_numPerturbationIterations = getelementptr inbounds %class.btConvexPlaneCollisionAlgorithm, ptr %this, i64 0, i32 6
  %30 = load i32, ptr %m_numPerturbationIterations, align 4
  %cmp21118 = icmp sgt i32 %30, 0
...
for.body.lr.ph:                                   ; preds = %_Z13btPlaneSpace1RK9btVector3RS_S2_.exit
  ...
  %31 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp26, i64 0, i32 1
  %32 = shufflevector <2 x float> %29, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %33 = insertelement <2 x float> %32, float %mul10.i.i, i64 0
  %34 = insertelement <2 x float> poison, float %call.i21.i.i, i64 0
  %35 = shufflevector <2 x float> %34, <2 x float> poison, <2 x i32> zeroinitializer
  %36 = shufflevector <2 x float> %29, <2 x float> %33, <2 x i32> <i32 1, i32 2>
  %37 = extractelement <2 x float> %29, i64 0
  %38 = extractelement <2 x float> %29, i64 1
  br label %for.body

for.body:                                         ; preds = %for.body.lr.ph, %for.body
  %39 = phi i32 [ %30, %for.body.lr.ph ], [ %91, %for.body ]
  %i.0119 = phi i32 [ 0, %for.body.lr.ph ], [ %inc, %for.body ]
  %conv = sitofp i32 %i.0119 to float
  %conv23 = sitofp i32 %39 to float
  %div24 = fdiv float 0x401921FB60000000, %conv23
  %mul = fmul float %div24, %conv
  %40 = load float, ptr %m_planeNormal.i, align 4
  %41 = load float, ptr %arrayidx5.i.i.i.i.i64, align 4
  %mul8.i.i.i.i.i65 = fmul float %41, %41
  %42 = tail call float @llvm.fmuladd.f32(float %40, float %40, float %mul8.i.i.i.i.i65)
  %43 = load float, ptr %arrayidx.i.i, align 4
  %44 = tail call float @llvm.fmuladd.f32(float %43, float %43, float %42)
  %sqrt.i.i.i67 = tail call float @llvm.sqrt.f32(float %44)
  ...
  %45 = load float, ptr %m_planeNormal.i, align 4
  %mul4.i.i71 = fmul float %45, %div.i.i70
  %neg37.i = fmul float %37, %mul4.i.i71
  %46 = load <2 x float>, ptr %arrayidx5.i.i.i.i.i64, align 4
  %47 = insertelement <2 x float> poison, float %div.i.i70, i64 0
  ...
  %51 = insertelement <2 x float> %50, float %mul4.i.i71, i64 0
  %52 = fneg <2 x float> %51
  %53 = extractelement <2 x float> %49, i64 1
  %fneg9.i = fneg float %53
  %54 = extractelement <2 x float> %52, i64 1
  %mul14.i = fmul float %call.i21.i.i, %54
  %55 = tail call float @llvm.fmuladd.f32(float %call.i21.i.i75, float %38, float %mul14.i)
  %56 = tail call float @llvm.fmuladd.f32(float %fneg9.i, float %37, float %55)
  %57 = tail call float @llvm.fmuladd.f32(float %mul4.i.i71, float %mul10.i.i, float %56)
  %58 = shufflevector <2 x float> %52, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %59 = insertelement <2 x float> %58, float %fneg9.i, i64 0
  %60 = fmul <2 x float> %35, %59
  %61 = insertelement <2 x float> poison, float %call.i21.i.i75, i64 0
  %62 = shufflevector <2 x float> %61, <2 x float> poison, <2 x i32> zeroinitializer
  %63 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %62, <2 x float> %33, <2 x float> %60)
  %64 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %52, <2 x float> %36, <2 x float> %63)
  %65 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %49, <2 x float> %29, <2 x float> %64)
  %66 = tail call float @llvm.fmuladd.f32(float %call.i21.i.i75, float %call.i21.i.i, float %neg37.i)
  %67 = extractelement <2 x float> %49, i64 0
  %68 = tail call float @llvm.fmuladd.f32(float %67, float %38, float %66)
  %69 = tail call float @llvm.fmuladd.f32(float %53, float %mul10.i.i, float %68)
  %70 = shufflevector <2 x float> %65, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %71 = insertelement <2 x float> %70, float %57, i64 1
  %72 = fmul <2 x float> %62, %71
  ...
  %76 = shufflevector <2 x float> %71, <2 x float> %65, <2 x i32> <i32 1, i32 2>
  %77 = shufflevector <2 x float> %49, <2 x float> %51, <2 x i32> <i32 1, i32 2>
  %78 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %76, <2 x float> %77, <2 x float> %75)
  %79 = fneg <2 x float> %65
  %80 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %79, <2 x float> %49, <2 x float> %78)
  %81 = extractelement <2 x float> %65, i64 0
  %mul25.i97 = fmul float %call.i21.i.i75, %81
  %82 = tail call float @llvm.fmuladd.f32(float %69, float %53, float %mul25.i97)
  %83 = extractelement <2 x float> %65, i64 1
  %84 = tail call float @llvm.fmuladd.f32(float %83, float %67, float %82)
  %neg30.i98 = fneg float %57
  %85 = tail call float @llvm.fmuladd.f32(float %neg30.i98, float %mul4.i.i71, float %84)
  %86 = extractelement <2 x float> %79, i64 1
  %neg37.i99 = fmul float %mul4.i.i71, %86
  %87 = tail call float @llvm.fmuladd.f32(float %69, float %call.i21.i.i75, float %neg37.i99)
  %88 = tail call float @llvm.fmuladd.f32(float %neg30.i98, float %67, float %87)
  %89 = extractelement <2 x float> %79, i64 0
  %90 = tail call float @llvm.fmuladd.f32(float %89, float %53, float %88)
  %retval.sroa.3.8.vec.insert.i102 = insertelement <2 x float> undef, float %85, i64 0
  %retval.sroa.3.12.vec.insert.i103 = insertelement <2 x float> %retval.sroa.3.8.vec.insert.i102, float %90, i64 1
  store <2 x float> %80, ptr %ref.tmp26, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i103, ptr %31, align 8
  ...
  %91 = load i32, ptr %m_numPerturbationIterations, align 4
  %cmp21 = icmp slt i32 %inc, %91
  br i1 %cmp21, label %for.body, label %if.end37

if.end37:                                         ; preds = %for.body, %_Z13btPlaneSpace1RK9btVector3RS_S2_.exit, %if.end
  %m_ownManifold = getelementptr inbounds %class.btConvexPlaneCollisionAlgorithm, ptr %this, i64 0, i32 1
  %92 = load i8, ptr %m_ownManifold, align 8
  %tobool38.not = icmp eq i8 %92, 0
  br i1 %tobool38.not, label %return, label %if.then39

if.then39:                                        ; preds = %if.end37
  %93 = load ptr, ptr %m_manifoldPtr, align 8
  %m_cachedPoints.i106 = getelementptr inbounds %class.btPersistentManifold, ptr %93, i64 0, i32 5
  %94 = load i32, ptr %m_cachedPoints.i106, align 8
  %tobool42.not = icmp eq i32 %94, 0
  br i1 %tobool42.not, label %return, label %if.then43

if.then43:                                        ; preds = %if.then39
  %95 = load ptr, ptr %m_manifoldPtr.i, align 8
  %m_cachedPoints.i.i = getelementptr inbounds %class.btPersistentManifold, ptr %95, i64 0, i32 5
  %96 = load i32, ptr %m_cachedPoints.i.i, align 8
  %tobool.not.i = icmp eq i32 %96, 0
  br i1 %tobool.not.i, label %return, label %if.end.i

if.end.i:                                         ; preds = %if.then43
  %m_body0.i.i = getelementptr inbounds %class.btPersistentManifold, ptr %95, i64 0, i32 3
  %97 = load ptr, ptr %m_body0.i.i, align 8
  %m_body0.i = getelementptr inbounds %class.btManifoldResult, ptr %resultOut, i64 0, i32 4
  %98 = load ptr, ptr %m_body0.i, align 8
...
if.then5.i:                                       ; preds = %if.end.i
  ...
  tail call void @_ZN20btPersistentManifold20refreshContactPointsERK11btTransformS2_(ptr noundef nonnull align 8 dereferenceable(744) %95, ptr noundef nonnull align 4 dereferenceable(64) %m_rootTransB.i, ptr noundef nonnull align 4 dereferenceable(64) %m_rootTransA.i)
  br label %return
...
if.else.i108:                                     ; preds = %if.end.i
  ...
  tail call void @_ZN20btPersistentManifold20refreshContactPointsERK11btTransformS2_(ptr noundef nonnull align 8 dereferenceable(744) %95, ptr noundef nonnull align 4 dereferenceable(64) %m_rootTransA8.i, ptr noundef nonnull align 4 dereferenceable(64) %m_rootTransB9.i)
  br label %return
