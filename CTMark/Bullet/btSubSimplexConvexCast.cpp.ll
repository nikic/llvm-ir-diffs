...
entry:
  ...
  %4 = load float, ptr %arrayidx11.i, align 4, !tbaa !15
  ...
  %8 = load float, ptr %m_origin.i162, align 4, !tbaa !15
  ...
  %10 = load float, ptr %arrayidx5.i165, align 4, !tbaa !15
  ...
  %11 = load float, ptr %arrayidx11.i168, align 4, !tbaa !15
  ...
  %45 = load float, ptr %interpolatedTransA.sroa.14.16.arrayidx6.i.i.sroa_idx, align 4, !tbaa !15
  ...
  %94 = load float, ptr %interpolatedTransB.sroa.14.16.arrayidx6.i.i177.sroa_idx, align 4, !tbaa !15
...
if.else:                                          ; preds = %if.then76
  ...
  %210 = load float, ptr %m_origin.i, align 4, !tbaa !15
  %211 = load <2 x float>, ptr %arrayidx7.i, align 4, !tbaa !15
  %212 = load <2 x float>, ptr %arrayidx5.i, align 4, !tbaa !15
  ...
  %221 = load <2 x float>, ptr %arrayidx7.i166, align 4, !tbaa !15
