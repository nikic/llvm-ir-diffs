; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSubSimplexConvexCast.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSubSimplexConvexCast.cpp"
...
entry:
  ...
  %2 = load float, ptr %m_origin.i161, align 4
  ...
  %8 = load float, ptr %m_origin.i162, align 4
  %9 = load float, ptr %m_origin.i163, align 4
  %sub.i164 = fsub float %8, %9
  %arrayidx5.i165 = getelementptr inbounds %class.btTransform, ptr %toB, i64 0, i32 1, i32 0, i64 1
  %10 = load float, ptr %arrayidx5.i165, align 4
  ...
  %11 = load float, ptr %arrayidx11.i168, align 4
  ...
  %sub8.i167 = fsub float %10, %13
  %14 = extractelement <2 x float> %12, i64 1
  %sub14.i170 = fsub float %11, %14
  ...
  %interpolatedTransB.sroa.7.0.copyload = load float, ptr %interpolatedTransB.sroa.7.0.fromB.sroa_idx, align 4
  ...
  %interpolatedTransB.sroa.14.16.copyload = load float, ptr %interpolatedTransB.sroa.14.16.arrayidx6.i.i177.sroa_idx, align 4
  ...
  %interpolatedTransB.sroa.21.32.copyload = load float, ptr %interpolatedTransB.sroa.21.32.arrayidx10.i.i179.sroa_idx, align 4
  ...
  %44 = load float, ptr %interpolatedTransA.sroa.12.16.arrayidx6.i.i.sroa_idx, align 4
  %45 = load float, ptr %interpolatedTransA.sroa.14.16.arrayidx6.i.i.sroa_idx, align 4
  ...
  %49 = insertelement <2 x float> %38, float %43, i64 1
  %50 = shufflevector <2 x float> %35, <2 x float> poison, <2 x i32> zeroinitializer
  %51 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %49, <2 x float> %50, <2 x float> %48)
  %52 = insertelement <2 x float> %42, float %45, i64 1
  ...
  %55 = load <2 x float>, ptr %m_origin.i161, align 4
  %56 = fadd <2 x float> %55, %54
  %57 = load float, ptr %arrayidx10.i.i, align 4
  %58 = load float, ptr %interpolatedTransA.sroa.19.32.arrayidx10.i.i.sroa_idx, align 4
  ...
  %60 = load float, ptr %interpolatedTransA.sroa.21.32.arrayidx10.i.i.sroa_idx, align 4
  ...
  %66 = load <2 x float>, ptr %arrayidx6.i.i177, align 4
  ...
  %73 = load <2 x float>, ptr %arrayidx10.i.i179, align 4
  ...
  %77 = load float, ptr %interpolatedTransB.sroa.7.0.fromB.sroa_idx, align 4
  %78 = load float, ptr %interpolatedTransB.sroa.14.16.arrayidx6.i.i177.sroa_idx, align 4
  %mul7.i15.i225 = fmul float %sub8.i186, %78
  %79 = call float @llvm.fmuladd.f32(float %77, float %sub.i183, float %mul7.i15.i225)
  %80 = load float, ptr %interpolatedTransB.sroa.21.32.arrayidx10.i.i179.sroa_idx, align 4
  ...
  %92 = load float, ptr %arrayidx6.i.i177, align 4
  %93 = load float, ptr %interpolatedTransB.sroa.12.16.arrayidx6.i.i177.sroa_idx, align 4
  %94 = load float, ptr %interpolatedTransB.sroa.14.16.arrayidx6.i.i177.sroa_idx, align 4
  %95 = insertelement <2 x float> %89, float %93, i64 1
  %96 = shufflevector <2 x float> %84, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %97 = fmul <2 x float> %95, %96
  %98 = insertelement <2 x float> %87, float %92, i64 1
  ...
  %101 = insertelement <2 x float> %91, float %94, i64 1
  ...
  %104 = load <2 x float>, ptr %m_origin.i163, align 4
  %105 = fadd <2 x float> %104, %103
  %106 = load float, ptr %arrayidx10.i.i179, align 4
  %107 = load float, ptr %interpolatedTransB.sroa.19.32.arrayidx10.i.i179.sroa_idx, align 4
  ...
  %109 = load float, ptr %interpolatedTransB.sroa.21.32.arrayidx10.i.i179.sroa_idx, align 4
  %110 = call float @llvm.fmuladd.f32(float %109, float %ref.tmp23.sroa.5.8.vec.extract, float %108)
  %111 = load float, ptr %arrayidx13.i169, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i265, ptr %ref.tmp34.sroa.4.0.v.sroa_idx, align 8
...
land.rhs.lr.ph:                                   ; preds = %entry
  ...
  %120 = insertelement <4 x float> poison, float %9, i64 0
  ...
  %123 = insertelement <4 x float> %122, float %2, i64 3
...
land.rhs:                                         ; preds = %land.rhs.lr.ph, %cleanup
  ...
  %135 = phi <2 x float> [ %5, %land.rhs.lr.ph ], [ %236, %cleanup ]
  %dec = add nsw i32 %maxIter.0503, -1
  %tobool.not = icmp eq i32 %maxIter.0503, 0
  br i1 %tobool.not, label %while.end, label %while.body

while.body:                                       ; preds = %land.rhs
  %136 = load ptr, ptr %m_convexA, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp44) #10
  %137 = load float, ptr %v, align 8
  %fneg.i274 = fneg float %137
  %138 = load float, ptr %arrayidx5.i.i271, align 4
  %fneg4.i276 = fneg float %138
  %139 = load float, ptr %ref.tmp34.sroa.4.0.v.sroa_idx, align 8
  ...
  %vtable51 = load ptr, ptr %136, align 8
  ...
  store <2 x float> %162, ptr %supVertexA, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i323, ptr %63, align 8
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp44) #10
  %167 = load ptr, ptr %m_convexB, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp60) #10
  %168 = load float, ptr %v, align 8
  %169 = load float, ptr %arrayidx5.i.i271, align 4
  %170 = load float, ptr %ref.tmp34.sroa.4.0.v.sroa_idx, align 8
  ...
  %vtable64 = load ptr, ptr %167, align 8
  ...
  store <2 x float> %192, ptr %supVertexB, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i365, ptr %112, align 8
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp60) #10
  %197 = load <2 x float>, ptr %supVertexA, align 8
  %198 = fsub <2 x float> %197, %192
  %199 = load float, ptr %63, align 8
  ...
  store <2 x float> %198, ptr %w, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i377, ptr %ref.tmp70.sroa.4.0.w.sroa_idx, align 8
...
if.else:                                          ; preds = %if.then76
  ...
  %209 = load float, ptr %m_origin.i161, align 4
  %210 = load float, ptr %m_origin.i, align 4
  %211 = load <2 x float>, ptr %arrayidx7.i, align 4
  %212 = load <2 x float>, ptr %arrayidx5.i, align 4
  %213 = insertelement <2 x float> poison, float %sub, i64 0
  %214 = shufflevector <2 x float> %213, <2 x float> poison, <2 x i32> zeroinitializer
  %215 = fmul <2 x float> %214, %212
  %216 = insertelement <2 x float> poison, float %sub.i390, i64 0
  %217 = shufflevector <2 x float> %216, <2 x float> poison, <2 x i32> zeroinitializer
  %218 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %217, <2 x float> %211, <2 x float> %215)
  %219 = load <4 x float>, ptr %m_origin.i163, align 4
  %220 = load <4 x float>, ptr %m_origin.i162, align 4
  %221 = load <2 x float>, ptr %arrayidx7.i166, align 4
  %222 = load <2 x float>, ptr %arrayidx5.i165, align 4
  ...
  %226 = shufflevector <4 x float> %220, <4 x float> %225, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %227 = insertelement <4 x float> %226, float %210, i64 3
  ...
  %231 = shufflevector <2 x float> %221, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %232 = shufflevector <4 x float> %219, <4 x float> %231, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
...
if.end90:                                         ; preds = %if.else, %if.end
  ...
  %236 = phi <2 x float> [ %218, %if.else ], [ %135, %if.end ]
  %237 = load ptr, ptr %m_simplexSolver, align 8
  ...
  %238 = load ptr, ptr %m_simplexSolver, align 8
...
cleanup:                                          ; preds = %if.end90
  %239 = load float, ptr %v, align 8
  %240 = load float, ptr %arrayidx5.i.i271, align 4
  %mul8.i.i419 = fmul float %240, %240
  %241 = call float @llvm.fmuladd.f32(float %239, float %239, float %mul8.i.i419)
  %242 = load float, ptr %ref.tmp34.sroa.4.0.v.sroa_idx, align 8
...
if.then100:                                       ; preds = %while.end
  ...
  store <2 x float> %retval.sroa.0.4.vec.insert.i.i.i, ptr %m_normal, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i.i, ptr %ref.tmp101.sroa.4.0.m_normal.sroa_idx, align 8
  br label %if.end110
...
if.end110:                                        ; preds = %if.else104, %if.then100
  ...
  %251 = load float, ptr %m_allowedPenetration, align 8
  %fneg = fneg float %251
...
if.end115:                                        ; preds = %if.end110
  ...
  %252 = load ptr, ptr %m_simplexSolver, align 8
