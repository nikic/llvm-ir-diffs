; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btUniversalConstraint.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btUniversalConstraint.cpp"
...
common.resume:                                    ; preds = %lpad.i108, %lpad.i
  %common.resume.op = phi { ptr, i32 } [ %3, %lpad.i ], [ %7, %lpad.i108 ]
...
_ZN11btTransform11getIdentityEv.exit:             ; preds = %entry, %init.check.i, %invoke.cont6.i
  ...
  br i1 %guard.uninitialized.i103, label %init.check.i104, label %invoke.cont87

init.check.i104:                                  ; preds = %_ZN11btTransform11getIdentityEv.exit
  %5 = tail call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZN11btTransform11getIdentityEvE17identityTransform) #12
  %tobool.not.i105 = icmp eq i32 %5, 0
  br i1 %tobool.not.i105, label %invoke.cont87, label %init.i106

init.i106:                                        ; preds = %init.check.i104
  %call.i107 = invoke noundef nonnull align 4 dereferenceable(48) ptr @_ZN11btMatrix3x311getIdentityEv()
          to label %invoke.cont6.i109 unwind label %lpad.i108

invoke.cont6.i109:                                ; preds = %init.i106
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) @_ZZN11btTransform11getIdentityEvE17identityTransform, ptr noundef nonnull align 4 dereferenceable(16) %call.i107, i64 16, i1 false)
  %arrayidx6.i.i.i110 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i107, i64 0, i64 1
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZN11btTransform11getIdentityEvE17identityTransform, i64 0, i32 0, i32 0, i64 1), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx6.i.i.i110, i64 16, i1 false)
  %arrayidx10.i.i.i111 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i107, i64 0, i64 2
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZN11btTransform11getIdentityEvE17identityTransform, i64 0, i32 0, i32 0, i64 2), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx10.i.i.i111, i64 16, i1 false)
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZN11btTransform11getIdentityEvE17identityTransform, i64 0, i32 1), i8 0, i64 16, i1 false)
  %6 = tail call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull @_ZZN11btTransform11getIdentityEvE17identityTransform)
  tail call void @__cxa_guard_release(ptr nonnull @_ZGVZN11btTransform11getIdentityEvE17identityTransform) #12
  br label %invoke.cont87

lpad.i108:                                        ; preds = %init.i106
  %7 = landingpad { ptr, i32 }
          cleanup
  br label %common.resume

invoke.cont87:                                    ; preds = %invoke.cont6.i109, %init.check.i104, %_ZN11btTransform11getIdentityEv.exit
  ...
  store ptr getelementptr inbounds ({ [10 x ptr] }, ptr @_ZTV21btUniversalConstraint, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  ...
  %9 = load <2 x float>, ptr %axis1, align 4
  ...
  %20 = load float, ptr %arrayidx10.i.i.i.i115, align 4
  ...
  store float %mul.i.i.i118, ptr %axis2, align 4
  %mul4.i.i.i119 = fmul float %18, %div.i.i117
  store float %mul4.i.i.i119, ptr %arrayidx5.i.i.i.i113, align 4
  %mul7.i.i.i120 = fmul float %20, %div.i.i117
  store float %mul7.i.i.i120, ptr %arrayidx10.i.i.i.i115, align 4
  ...
  %34 = load float, ptr %arrayidx.i28.i.i, align 8
  %35 = load float, ptr %arrayidx.i29.i.i, align 8
  %36 = load float, ptr %arrayidx.i30.i.i, align 8
  %m_origin.i124 = getelementptr inbounds %class.btCollisionObject, ptr %rbA, i64 0, i32 1, i32 1
  %37 = load float, ptr %m_origin.i124, align 8
  ...
  %38 = load float, ptr %arrayidx3.i5.i, align 4
  ...
  %39 = load float, ptr %arrayidx7.i.i125, align 8
  ...
  %42 = load <2 x float>, ptr %m_worldTransform.i, align 8
  %43 = load <2 x float>, ptr %arrayidx3.i.i123, align 8
  %44 = load <2 x float>, ptr %arrayidx6.i.i, align 8
  ...
  store float %58, ptr %ref.tmp.sroa.6.0.m_frameInA.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp.sroa.7.0.m_frameInA.sroa_idx, align 4
  ...
  store float %63, ptr %ref.tmp.sroa.11.16.arrayidx7.i.i133.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp.sroa.12.16.arrayidx7.i.i133.sroa_idx, align 4
  ...
  store float %41, ptr %ref.tmp.sroa.16.32.arrayidx11.i.i.sroa_idx, align 8
  ...
  store <2 x float> %70, ptr %m_origin3.i, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i291, ptr %ref.tmp.sroa.20.48.m_origin3.i.sroa_idx, align 8
  ...
  %105 = load float, ptr %arrayidx.i28.i.i141, align 8
  %106 = load float, ptr %arrayidx.i29.i.i142, align 8
  %107 = load float, ptr %arrayidx.i30.i.i143, align 8
  %m_origin.i144 = getelementptr inbounds %class.btCollisionObject, ptr %rbB, i64 0, i32 1, i32 1
  %108 = load float, ptr %m_origin.i144, align 8
  ...
  %109 = load float, ptr %arrayidx3.i5.i146, align 4
  ...
  %110 = load float, ptr %arrayidx7.i.i148, align 8
  ...
  %113 = load <2 x float>, ptr %m_worldTransform.i135, align 8
  %114 = load <2 x float>, ptr %arrayidx3.i.i136, align 8
  %115 = load <2 x float>, ptr %arrayidx6.i.i137, align 8
  ...
  store float %129, ptr %ref.tmp51.sroa.6.0.m_frameInB.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp51.sroa.7.0.m_frameInB.sroa_idx, align 4
  ...
  store float %134, ptr %ref.tmp51.sroa.11.16.arrayidx7.i.i223.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp51.sroa.12.16.arrayidx7.i.i223.sroa_idx, align 4
  ...
  store float %112, ptr %ref.tmp51.sroa.16.32.arrayidx11.i.i225.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp51.sroa.17.32.arrayidx11.i.i225.sroa_idx, align 4
  %m_origin3.i227 = getelementptr inbounds %class.btGeneric6DofConstraint, ptr %this, i64 0, i32 2, i32 1
  store <2 x float> %138, ptr %m_origin3.i227, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i208292, ptr %ref.tmp51.sroa.20.48.m_origin3.i227.sroa_idx, align 8
  ...
  store <2 x float> zeroinitializer, ptr %arrayidx4.i, align 4
  store <2 x float> <float 0xBFF8F905A0000000, float 0x3FF8F905A0000000>, ptr %arrayidx4.1.i, align 4
  store <2 x float> <float 0xC0090D8080000000, float 0x40090D8080000000>, ptr %arrayidx4.2.i, align 4
  ret void
}
