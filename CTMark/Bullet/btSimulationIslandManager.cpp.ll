; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSimulationIslandManager.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSimulationIslandManager.cpp"
...
invoke.cont:                                      ; preds = %entry, %if.then3.i.i.i
  ...
  %2 = load ptr, ptr %m_data.i.i.i10, align 8
...
invoke.cont3:                                     ; preds = %invoke.cont, %if.then3.i.i.i15
  ...
  store i8 1, ptr %m_ownsMemory.i.i.i12, align 8
...
entry:
  ...
  %vtable.i34 = load ptr, ptr %1, align 8
  ...
  %vtable37 = load ptr, ptr %call.i36, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end
  ...
  %4 = load ptr, ptr %m_broadphasePairCache.i, align 8
  ...
  %vtable4 = load ptr, ptr %call.i27, align 8
...
land.lhs.true11:                                  ; preds = %land.lhs.true
  ...
  %12 = load i32, ptr %m_collisionFlags.i28, align 8
...
while.body.i.i:                                   ; preds = %if.then, %while.body.i.i
  ...
  %18 = load i32, ptr %arrayidx.i24.i.i, align 4
  store i32 %18, ptr %arrayidx.i34.i.i, align 4
...
_ZN11btUnionFind4findEi.exit.i:                   ; preds = %while.body.i.i, %if.then
  ...
  %20 = load i32, ptr %arrayidx.i32.i16.i, align 4
...
while.body.i18.i:                                 ; preds = %_ZN11btUnionFind4findEi.exit.i, %while.body.i18.i
  %21 = phi i32 [ %23, %while.body.i18.i ], [ %20, %_ZN11btUnionFind4findEi.exit.i ]
  %arrayidx.i34.i19.i = phi ptr [ %arrayidx.i.i23.i, %while.body.i18.i ], [ %arrayidx.i32.i16.i, %_ZN11btUnionFind4findEi.exit.i ]
  %idxprom.i23.i20.i = sext i32 %21 to i64
  %arrayidx.i24.i21.i = getelementptr inbounds %struct.btElement, ptr %15, i64 %idxprom.i23.i20.i
  %22 = load i32, ptr %arrayidx.i24.i21.i, align 4
  store i32 %22, ptr %arrayidx.i34.i19.i, align 4
  %idxprom.i.i22.i = sext i32 %22 to i64
  %arrayidx.i.i23.i = getelementptr inbounds %struct.btElement, ptr %15, i64 %idxprom.i.i22.i
  %23 = load i32, ptr %arrayidx.i.i23.i, align 4
  %cmp.not.i24.i = icmp eq i32 %22, %23
...
_ZN11btUnionFind4findEi.exit26.i:                 ; preds = %while.body.i18.i, %_ZN11btUnionFind4findEi.exit.i
  %x.addr.0.lcssa.i25.i = phi i32 [ %14, %_ZN11btUnionFind4findEi.exit.i ], [ %22, %while.body.i18.i ]
...
if.end.i:                                         ; preds = %_ZN11btUnionFind4findEi.exit26.i
  ...
  %24 = load i32, ptr %m_sz.i, align 4
  ...
  %25 = load i32, ptr %m_sz8.i, align 4
...
if.end:                                           ; preds = %if.end.i, %_ZN11btUnionFind4findEi.exit26.i, %land.lhs.true11, %land.lhs.true, %for.body
  ...
  %26 = load ptr, ptr %m_broadphasePairCache.i, align 8
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph.new
  ...
  store i32 %indvars22, ptr %m_islandTag1.i, align 4
...
if.then:                                          ; preds = %for.body
  ...
  %5 = load i32, ptr %arrayidx.i32.i, align 4
  %6 = zext i32 %5 to i64
...
while.body.i:                                     ; preds = %if.then, %while.body.i
  ...
  %9 = load i32, ptr %arrayidx.i24.i, align 4
  store i32 %9, ptr %arrayidx.i34.i, align 4
...
if.end:                                           ; preds = %while.body.i, %for.body, %if.then
  ...
  store i32 %.sink25, ptr %m_islandTag1.i17, align 4
  %m_companionId.i18 = getelementptr inbounds %class.btCollisionObject, ptr %3, i64 0, i32 13
  store i32 %.sink, ptr %m_companionId.i18, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i: ; preds = %if.then5.i
  ...
  %2 = load ptr, ptr %m_data.i9.i.i, align 8
...
for.body10.i.prol:                                ; preds = %for.body10.lr.ph.i, %for.body10.i.prol
  ...
  %6 = load ptr, ptr %m_data11.i, align 8
...
for.body10.i:                                     ; preds = %for.body10.i.prol.loopexit, %for.body10.i
  ...
  %11 = load ptr, ptr %m_data11.i, align 8
...
invoke.cont6:                                     ; preds = %invoke.cont3
  ...
  %12 = load i32, ptr %m_size.i.i283, align 4
...
land.rhs:                                         ; preds = %for.cond17
  ...
  %18 = load i32, ptr %arrayidx.i.i288, align 4
...
for.end:                                          ; preds = %for.cond17, %for.end.split.loop.exit384
  ...
  %cmp27.not355 = icmp sgt i32 %startIslandIndex.0363, %endIslandIndex.0.in.lcssa
...
for.body28:                                       ; preds = %for.body28.lr.ph, %if.end57
  %indvars.iv368 = phi i64 [ %idxprom.i.i, %for.body28.lr.ph ], [ %indvars.iv.next369, %if.end57 ]
  %allSleeping.0357 = phi i8 [ 1, %for.body28.lr.ph ], [ %allSleeping.2, %if.end57 ]
  %m_sz = getelementptr inbounds %struct.btElement, ptr %14, i64 %indvars.iv368, i32 1
  %25 = load i32, ptr %m_sz, align 4
  %idxprom.i = sext i32 %25 to i64
  %arrayidx.i = getelementptr inbounds ptr, ptr %23, i64 %idxprom.i
  %26 = load ptr, ptr %arrayidx.i, align 8
  %m_islandTag1.i = getelementptr inbounds %class.btCollisionObject, ptr %26, i64 0, i32 12
  %27 = load i32, ptr %m_islandTag1.i, align 4
  %cmp39.not = icmp eq i32 %27, %15
  br i1 %cmp39.not, label %if.then46, label %if.end57

if.then46:                                        ; preds = %for.body28
  %m_activationState1.i = getelementptr inbounds %class.btCollisionObject, ptr %26, i64 0, i32 14
  %28 = load i32, ptr %m_activationState1.i, align 4
  %cmp49 = icmp eq i32 %28, 1
  %cmp54 = icmp eq i32 %28, 4
  %29 = or i1 %cmp54, %cmp49
  %spec.select281 = select i1 %29, i8 0, i8 %allSleeping.0357
  br label %if.end57
...
if.end57:                                         ; preds = %if.then46, %for.body28
  ...
  br i1 %exitcond.not, label %for.end60, label %for.body28

for.end60:                                        ; preds = %if.end57
  %30 = and i8 %allSleeping.2, 1
...
for.body65.preheader:                             ; preds = %for.cond63.preheader
  %31 = add i32 %endIslandIndex.0.in.lcssa, 1
  br label %for.body65
...
for.body101.preheader:                            ; preds = %for.cond99.preheader
  %32 = add i32 %endIslandIndex.0.in.lcssa, 1
...
for.body65:                                       ; preds = %for.body65.preheader, %if.end91
  ...
  %m_sz72 = getelementptr inbounds %struct.btElement, ptr %33, i64 %indvars.iv370, i32 1
  %34 = load i32, ptr %m_sz72, align 4
  %35 = load ptr, ptr %m_data.i, align 8
  %idxprom.i301 = sext i32 %34 to i64
  %arrayidx.i302 = getelementptr inbounds ptr, ptr %35, i64 %idxprom.i301
  %36 = load ptr, ptr %arrayidx.i302, align 8
  %m_islandTag1.i303 = getelementptr inbounds %class.btCollisionObject, ptr %36, i64 0, i32 12
  %37 = load i32, ptr %m_islandTag1.i303, align 4
  %cmp79.not = icmp eq i32 %37, %15
...
if.then89:                                        ; preds = %for.body65
  invoke void @_ZN17btCollisionObject18setActivationStateEi(ptr noundef nonnull align 8 dereferenceable(280) %36, i32 noundef 2)
...
if.end91:                                         ; preds = %if.then89, %for.body65
  ...
  %exitcond374.not = icmp eq i32 %31, %lftr.wideiv373
...
for.body101:                                      ; preds = %for.body101.preheader, %if.end133
  ...
  %m_sz108 = getelementptr inbounds %struct.btElement, ptr %39, i64 %indvars.iv375, i32 1
  %40 = load i32, ptr %m_sz108, align 4
  %41 = load ptr, ptr %m_data.i, align 8
  %idxprom.i311 = sext i32 %40 to i64
  %arrayidx.i312 = getelementptr inbounds ptr, ptr %41, i64 %idxprom.i311
  %42 = load ptr, ptr %arrayidx.i312, align 8
  %m_islandTag1.i313 = getelementptr inbounds %class.btCollisionObject, ptr %42, i64 0, i32 12
  %43 = load i32, ptr %m_islandTag1.i313, align 4
  %cmp115.not = icmp eq i32 %43, %15
...
if.then125:                                       ; preds = %for.body101
  %m_activationState1.i316 = getelementptr inbounds %class.btCollisionObject, ptr %42, i64 0, i32 14
  %45 = load i32, ptr %m_activationState1.i316, align 4
  %cmp128 = icmp eq i32 %45, 2
  br i1 %cmp128, label %if.then129, label %if.end133

if.then129:                                       ; preds = %if.then125
  invoke void @_ZN17btCollisionObject18setActivationStateEi(ptr noundef nonnull align 8 dereferenceable(280) %42, i32 noundef 3)
          to label %invoke.cont130 unwind label %lpad110

invoke.cont130:                                   ; preds = %if.then129
  %m_deactivationTime.i = getelementptr inbounds %class.btCollisionObject, ptr %42, i64 0, i32 15
  store float 0.000000e+00, ptr %m_deactivationTime.i, align 8
  br label %if.end133
...
if.end133:                                        ; preds = %if.then125, %invoke.cont130, %for.body101
  ...
  %exitcond379.not = icmp eq i32 %32, %lftr.wideiv378
...
for.end145:                                       ; preds = %if.end140, %invoke.cont6
  ...
  %call149 = invoke noundef i32 %46(ptr noundef nonnull align 8 dereferenceable(8) %dispatcher)
...
for.body152.lr.ph:                                ; preds = %for.cond150.preheader
  %m_splitIslands = getelementptr inbounds %class.btSimulationIslandManager, ptr %this, i64 0, i32 4
  %m_capacity.i.i = getelementptr inbounds %class.btSimulationIslandManager, ptr %this, i64 0, i32 2, i32 3
  %m_data.i.i.i342 = getelementptr inbounds %class.btSimulationIslandManager, ptr %this, i64 0, i32 2, i32 5
  %m_ownsMemory.i.i.i337 = getelementptr inbounds %class.btSimulationIslandManager, ptr %this, i64 0, i32 2, i32 6
  br label %for.body152

for.body152:                                      ; preds = %for.body152.lr.ph, %if.end205
  %i146.0365 = phi i32 [ 0, %for.body152.lr.ph ], [ %inc210, %if.end205 ]
  %vtable153 = load ptr, ptr %dispatcher, align 8
  %vfn154 = getelementptr inbounds ptr, ptr %vtable153, i64 10
  %47 = load ptr, ptr %vfn154, align 8
  %call157 = invoke noundef ptr %47(ptr noundef nonnull align 8 dereferenceable(8) %dispatcher, i32 noundef %i146.0365)
...
invoke.cont156:                                   ; preds = %for.body152
  ...
  %48 = load ptr, ptr %m_body0.i, align 8
  %m_body1.i = getelementptr inbounds %class.btPersistentManifold, ptr %call157, i64 0, i32 4
  %49 = load ptr, ptr %m_body1.i, align 8
  %tobool165.not = icmp eq ptr %48, null
  br i1 %tobool165.not, label %lor.lhs.false, label %land.lhs.true166

land.lhs.true166:                                 ; preds = %invoke.cont156
  %m_activationState1.i317 = getelementptr inbounds %class.btCollisionObject, ptr %48, i64 0, i32 14
  %50 = load i32, ptr %m_activationState1.i317, align 4
  %cmp169.not = icmp eq i32 %50, 2
  br i1 %cmp169.not, label %lor.lhs.false, label %if.then175

lor.lhs.false:                                    ; preds = %land.lhs.true166, %invoke.cont156
  %tobool170.not = icmp eq ptr %49, null
  br i1 %tobool170.not, label %if.end205, label %land.lhs.true171

land.lhs.true171:                                 ; preds = %lor.lhs.false
  %m_activationState1.i318 = getelementptr inbounds %class.btCollisionObject, ptr %49, i64 0, i32 14
  %51 = load i32, ptr %m_activationState1.i318, align 4
  %cmp174.not = icmp eq i32 %51, 2
  br i1 %cmp174.not, label %if.end205, label %if.then175

if.then175:                                       ; preds = %land.lhs.true171, %land.lhs.true166
  %m_collisionFlags.i = getelementptr inbounds %class.btCollisionObject, ptr %48, i64 0, i32 11
  %52 = load i32, ptr %m_collisionFlags.i, align 8
  %and.i = and i32 %52, 2
...
land.lhs.true178:                                 ; preds = %if.then175
  %m_activationState1.i320 = getelementptr inbounds %class.btCollisionObject, ptr %48, i64 0, i32 14
  %53 = load i32, ptr %m_activationState1.i320, align 4
  %cmp181.not = icmp eq i32 %53, 2
  br i1 %cmp181.not, label %if.end184, label %if.then182

if.then182:                                       ; preds = %land.lhs.true178
  invoke void @_ZN17btCollisionObject8activateEb(ptr noundef nonnull align 8 dereferenceable(280) %49, i1 noundef zeroext false)
...
lpad162:                                          ; preds = %if.then3.i.i.i340, %if.then.i.i.i, %if.then195, %if.then191, %if.then182
  %56 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup217

if.end184:                                        ; preds = %if.then182, %land.lhs.true178, %if.then175
  %m_collisionFlags.i321 = getelementptr inbounds %class.btCollisionObject, ptr %49, i64 0, i32 11
  %57 = load i32, ptr %m_collisionFlags.i321, align 8
  %and.i322 = and i32 %57, 2
...
land.lhs.true187:                                 ; preds = %if.end184
  %m_activationState1.i324 = getelementptr inbounds %class.btCollisionObject, ptr %49, i64 0, i32 14
  %58 = load i32, ptr %m_activationState1.i324, align 4
  %cmp190.not = icmp eq i32 %58, 2
  br i1 %cmp190.not, label %if.end193, label %if.then191

if.then191:                                       ; preds = %land.lhs.true187
  invoke void @_ZN17btCollisionObject8activateEb(ptr noundef nonnull align 8 dereferenceable(280) %48, i1 noundef zeroext false)
          to label %if.end193 unwind label %lpad162

if.end193:                                        ; preds = %if.then191, %land.lhs.true187, %if.end184
  %59 = load i8, ptr %m_splitIslands, align 8
  %tobool194.not = icmp eq i8 %59, 0
  br i1 %tobool194.not, label %if.end205, label %if.then195

if.then195:                                       ; preds = %if.end193
  %vtable196 = load ptr, ptr %dispatcher, align 8
  %vfn197 = getelementptr inbounds ptr, ptr %vtable196, i64 7
  %60 = load ptr, ptr %vfn197, align 8
  %call199 = invoke noundef zeroext i1 %60(ptr noundef nonnull align 8 dereferenceable(8) %dispatcher, ptr noundef nonnull %48, ptr noundef nonnull %49)
...
if.then.i:                                        ; preds = %if.then200
  ...
  %mul.i.i = shl nsw i32 %61, 1
  %cond.i.i = select i1 %tobool.not.i.i, i32 1, i32 %mul.i.i
  %cmp.i.i331 = icmp slt i32 %61, %cond.i.i
  br i1 %cmp.i.i331, label %if.then.i.i332, label %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE9push_backERKS1_.exit

if.then.i.i332:                                   ; preds = %if.then.i
...
if.then.i.i.i:                                    ; preds = %if.then.i.i332
...
_ZN20btAlignedObjectArrayIP20btPersistentManifoldE8allocateEi.exit.i.i: ; preds = %call.i.i.i.i.noexc, %if.then.i.i332
  %63 = phi i32 [ %.pre.i, %call.i.i.i.i.noexc ], [ %61, %if.then.i.i332 ]
  %retval.0.i.i.i = phi ptr [ %call.i.i.i.i350, %call.i.i.i.i.noexc ], [ null, %if.then.i.i332 ]
  %cmp7.i.i.i333 = icmp sgt i32 %63, 0
  br i1 %cmp7.i.i.i333, label %for.body.lr.ph.i.i.i341, label %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i334

for.body.lr.ph.i.i.i341:                          ; preds = %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE8allocateEi.exit.i.i
  %wide.trip.count.i.i.i343 = zext i32 %63 to i64
  %xtraiter393 = and i64 %wide.trip.count.i.i.i343, 3
  %64 = icmp ult i32 %63, 4
  br i1 %64, label %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i334.loopexit.unr-lcssa, label %for.body.lr.ph.i.i.i341.new

for.body.lr.ph.i.i.i341.new:                      ; preds = %for.body.lr.ph.i.i.i341
  %unroll_iter = and i64 %wide.trip.count.i.i.i343, 4294967292
  br label %for.body.i.i.i344

for.body.i.i.i344:                                ; preds = %for.body.i.i.i344, %for.body.lr.ph.i.i.i341.new
  %indvars.iv.i.i.i345 = phi i64 [ 0, %for.body.lr.ph.i.i.i341.new ], [ %indvars.iv.next.i.i.i348.3, %for.body.i.i.i344 ]
  %niter = phi i64 [ 0, %for.body.lr.ph.i.i.i341.new ], [ %niter.next.3, %for.body.i.i.i344 ]
  %arrayidx.i.i.i346 = getelementptr inbounds ptr, ptr %retval.0.i.i.i, i64 %indvars.iv.i.i.i345
  %65 = load ptr, ptr %m_data.i.i.i342, align 8
  %arrayidx3.i.i.i347 = getelementptr inbounds ptr, ptr %65, i64 %indvars.iv.i.i.i345
  %66 = load ptr, ptr %arrayidx3.i.i.i347, align 8
  store ptr %66, ptr %arrayidx.i.i.i346, align 8
  %indvars.iv.next.i.i.i348 = or i64 %indvars.iv.i.i.i345, 1
  %arrayidx.i.i.i346.1 = getelementptr inbounds ptr, ptr %retval.0.i.i.i, i64 %indvars.iv.next.i.i.i348
  %67 = load ptr, ptr %m_data.i.i.i342, align 8
  %arrayidx3.i.i.i347.1 = getelementptr inbounds ptr, ptr %67, i64 %indvars.iv.next.i.i.i348
  %68 = load ptr, ptr %arrayidx3.i.i.i347.1, align 8
  store ptr %68, ptr %arrayidx.i.i.i346.1, align 8
  %indvars.iv.next.i.i.i348.1 = or i64 %indvars.iv.i.i.i345, 2
  %arrayidx.i.i.i346.2 = getelementptr inbounds ptr, ptr %retval.0.i.i.i, i64 %indvars.iv.next.i.i.i348.1
  %69 = load ptr, ptr %m_data.i.i.i342, align 8
  %arrayidx3.i.i.i347.2 = getelementptr inbounds ptr, ptr %69, i64 %indvars.iv.next.i.i.i348.1
  %70 = load ptr, ptr %arrayidx3.i.i.i347.2, align 8
  store ptr %70, ptr %arrayidx.i.i.i346.2, align 8
  %indvars.iv.next.i.i.i348.2 = or i64 %indvars.iv.i.i.i345, 3
  %arrayidx.i.i.i346.3 = getelementptr inbounds ptr, ptr %retval.0.i.i.i, i64 %indvars.iv.next.i.i.i348.2
  %71 = load ptr, ptr %m_data.i.i.i342, align 8
  %arrayidx3.i.i.i347.3 = getelementptr inbounds ptr, ptr %71, i64 %indvars.iv.next.i.i.i348.2
  %72 = load ptr, ptr %arrayidx3.i.i.i347.3, align 8
  store ptr %72, ptr %arrayidx.i.i.i346.3, align 8
  %indvars.iv.next.i.i.i348.3 = add nuw nsw i64 %indvars.iv.i.i.i345, 4
  %niter.next.3 = add i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i334.loopexit.unr-lcssa, label %for.body.i.i.i344

_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i334.loopexit.unr-lcssa: ; preds = %for.body.i.i.i344, %for.body.lr.ph.i.i.i341
  %indvars.iv.i.i.i345.unr = phi i64 [ 0, %for.body.lr.ph.i.i.i341 ], [ %indvars.iv.next.i.i.i348.3, %for.body.i.i.i344 ]
  %lcmp.mod394.not = icmp eq i64 %xtraiter393, 0
  br i1 %lcmp.mod394.not, label %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i334, label %for.body.i.i.i344.epil

for.body.i.i.i344.epil:                           ; preds = %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i334.loopexit.unr-lcssa, %for.body.i.i.i344.epil
  %indvars.iv.i.i.i345.epil = phi i64 [ %indvars.iv.next.i.i.i348.epil, %for.body.i.i.i344.epil ], [ %indvars.iv.i.i.i345.unr, %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i334.loopexit.unr-lcssa ]
  %epil.iter = phi i64 [ %epil.iter.next, %for.body.i.i.i344.epil ], [ 0, %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i334.loopexit.unr-lcssa ]
  %arrayidx.i.i.i346.epil = getelementptr inbounds ptr, ptr %retval.0.i.i.i, i64 %indvars.iv.i.i.i345.epil
  %73 = load ptr, ptr %m_data.i.i.i342, align 8
  %arrayidx3.i.i.i347.epil = getelementptr inbounds ptr, ptr %73, i64 %indvars.iv.i.i.i345.epil
  %74 = load ptr, ptr %arrayidx3.i.i.i347.epil, align 8
  store ptr %74, ptr %arrayidx.i.i.i346.epil, align 8
  %indvars.iv.next.i.i.i348.epil = add nuw nsw i64 %indvars.iv.i.i.i345.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter393
  br i1 %epil.iter.cmp.not, label %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i334, label %for.body.i.i.i344.epil

_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i334: ; preds = %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i334.loopexit.unr-lcssa, %for.body.i.i.i344.epil, %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE8allocateEi.exit.i.i
  %75 = load ptr, ptr %m_data.i.i.i342, align 8
  %tobool.not.i10.i.i336 = icmp eq ptr %75, null
  %76 = load i8, ptr %m_ownsMemory.i.i.i337, align 8
  %tobool2.not.i.i.i338 = icmp eq i8 %76, 0
  %or.cond.i.i339 = select i1 %tobool.not.i10.i.i336, i1 true, i1 %tobool2.not.i.i.i338
  br i1 %or.cond.i.i339, label %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE10deallocateEv.exit.i.i, label %if.then3.i.i.i340

if.then3.i.i.i340:                                ; preds = %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i334
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %75)
          to label %.noexc351 unwind label %lpad162

.noexc351:                                        ; preds = %if.then3.i.i.i340
  %.pre7.pre.i = load i32, ptr %m_size.i.i, align 4
  br label %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE10deallocateEv.exit.i.i

_ZN20btAlignedObjectArrayIP20btPersistentManifoldE10deallocateEv.exit.i.i: ; preds = %.noexc351, %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i334
  %.pre7.i = phi i32 [ %.pre7.pre.i, %.noexc351 ], [ %63, %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i334 ]
  store i8 1, ptr %m_ownsMemory.i.i.i337, align 8
  store ptr %retval.0.i.i.i, ptr %m_data.i.i.i342, align 8
...
_ZN20btAlignedObjectArrayIP20btPersistentManifoldE9push_backERKS1_.exit: ; preds = %if.then200, %if.then.i, %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE10deallocateEv.exit.i.i
  %77 = phi i32 [ %.pre7.i, %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE10deallocateEv.exit.i.i ], [ %61, %if.then.i ], [ %61, %if.then200 ]
  %78 = load ptr, ptr %m_data.i.i.i342, align 8
  %idxprom.i329 = sext i32 %77 to i64
  %arrayidx.i330 = getelementptr inbounds ptr, ptr %78, i64 %idxprom.i329
  store ptr %call157, ptr %arrayidx.i330, align 8
...
ehcleanup217:                                     ; preds = %lpad155, %lpad162, %lpad147, %lpad74, %lpad110, %lpad2, %lpad
  %.pn276.pn.pn.pn = phi { ptr, i32 } [ %19, %lpad ], [ %20, %lpad2 ], [ %38, %lpad74 ], [ %44, %lpad110 ], [ %54, %lpad147 ], [ %56, %lpad162 ], [ %55, %lpad155 ]
...
invoke.cont8:                                     ; preds = %invoke.cont
  ...
  %vtable14 = load ptr, ptr %callback, align 8
...
if.else:                                          ; preds = %entry
  ...
  %9 = load i32, ptr %m_size.i153, align 4
...
_ZN20btAlignedObjectArrayIP20btPersistentManifoldE9quickSortI33btPersistentManifoldSortPredicateEEvT_.exit: ; preds = %if.then.i, %if.else
  ...
  br i1 %cmp223, label %for.body.lr.ph, label %if.end110
...
for.body:                                         ; preds = %for.body.lr.ph, %invoke.cont99
  %startIslandIndex.0226 = phi i32 [ 0, %for.body.lr.ph ], [ %endIslandIndex.0.lcssa, %invoke.cont99 ]
  %endManifoldIndex.0225 = phi i32 [ 1, %for.body.lr.ph ], [ %endManifoldIndex.3, %invoke.cont99 ]
  %startManifoldIndex.0224 = phi i32 [ 0, %for.body.lr.ph ], [ %spec.select152, %invoke.cont99 ]
  %12 = load ptr, ptr %m_data.i.i, align 8
  %idxprom.i.i = sext i32 %startIslandIndex.0226 to i64
  %arrayidx.i.i = getelementptr inbounds %struct.btElement, ptr %12, i64 %idxprom.i.i
  %13 = load i32, ptr %arrayidx.i.i, align 4
  %14 = add nsw i32 %startIslandIndex.0226, 1
  %smax = tail call i32 @llvm.smax.i32(i32 %0, i32 %14)
  br label %land.rhs

land.rhs:                                         ; preds = %for.body, %invoke.cont45
  %indvars.iv = phi i64 [ %idxprom.i.i, %for.body ], [ %indvars.iv.next, %invoke.cont45 ]
  %islandSleeping.0221 = phi i8 [ 0, %for.body ], [ %spec.select, %invoke.cont45 ]
  %15 = load ptr, ptr %m_data.i.i, align 8
  %arrayidx.i.i159 = getelementptr inbounds %struct.btElement, ptr %15, i64 %indvars.iv
  %16 = load i32, ptr %arrayidx.i.i159, align 4
  %cmp35 = icmp eq i32 %16, %13
  br i1 %cmp35, label %for.body36, label %for.end.split.loop.exit232
...
for.body36:                                       ; preds = %land.rhs
  ...
  %18 = load ptr, ptr %m_data.i164, align 8
  %idxprom.i = sext i32 %17 to i64
  %arrayidx.i = getelementptr inbounds ptr, ptr %18, i64 %idxprom.i
  %19 = load ptr, ptr %arrayidx.i, align 8
  %20 = load i32, ptr %m_size.i.i165, align 4
  %21 = load i32, ptr %m_capacity.i.i, align 8
  %cmp.i166 = icmp eq i32 %20, %21
  br i1 %cmp.i166, label %if.then.i170, label %invoke.cont45

if.then.i170:                                     ; preds = %for.body36
...
if.then.i.i:                                      ; preds = %if.then.i170
  %tobool.not.i.i.i = icmp eq i32 %cond.i.i, 0
...
call.i.i.i.i.noexc:                               ; preds = %if.then.i.i.i
  %.pre.i = load i32, ptr %m_size.i.i165, align 4
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i.new
  ...
  %27 = load ptr, ptr %arrayidx3.i.i.i.1, align 8
  store ptr %27, ptr %arrayidx.i.i.i.1, align 8
  ...
  %29 = load ptr, ptr %arrayidx3.i.i.i.2, align 8
  store ptr %29, ptr %arrayidx.i.i.i.2, align 8
  ...
  %31 = load ptr, ptr %arrayidx3.i.i.i.3, align 8
  store ptr %31, ptr %arrayidx.i.i.i.3, align 8
...
for.body.i.i.i.epil:                              ; preds = %_ZNK20btAlignedObjectArrayIP17btCollisionObjectE4copyEiiPS1_.exit.i.i.loopexit.unr-lcssa, %for.body.i.i.i.epil
  ...
  %33 = load ptr, ptr %arrayidx3.i.i.i.epil, align 8
  store ptr %33, ptr %arrayidx.i.i.i.epil, align 8
...
.noexc172:                                        ; preds = %if.then3.i.i.i
  %.pre7.pre.i = load i32, ptr %m_size.i.i165, align 4
...
_ZN20btAlignedObjectArrayIP17btCollisionObjectE10deallocateEv.exit.i.i: ; preds = %.noexc172, %_ZNK20btAlignedObjectArrayIP17btCollisionObjectE4copyEiiPS1_.exit.i.i
  %.pre7.i = phi i32 [ %.pre7.pre.i, %.noexc172 ], [ %22, %_ZNK20btAlignedObjectArrayIP17btCollisionObjectE4copyEiiPS1_.exit.i.i ]
  store i8 1, ptr %m_ownsMemory.i.i.i, align 8
  store ptr %retval.0.i.i.i, ptr %m_data.i.i.i, align 8
  store i32 %cond.i.i, ptr %m_capacity.i.i, align 8
  br label %invoke.cont45

invoke.cont45:                                    ; preds = %_ZN20btAlignedObjectArrayIP17btCollisionObjectE10deallocateEv.exit.i.i, %if.then.i170, %for.body36
  %36 = phi i32 [ %.pre7.i, %_ZN20btAlignedObjectArrayIP17btCollisionObjectE10deallocateEv.exit.i.i ], [ %20, %if.then.i170 ], [ %20, %for.body36 ]
  %37 = load ptr, ptr %m_data.i.i.i, align 8
  %idxprom.i168 = sext i32 %36 to i64
  %arrayidx.i169 = getelementptr inbounds ptr, ptr %37, i64 %idxprom.i168
  store ptr %19, ptr %arrayidx.i169, align 8
  %inc.i = add nsw i32 %36, 1
  store i32 %inc.i, ptr %m_size.i.i165, align 4
  %m_activationState1.i.i = getelementptr inbounds %class.btCollisionObject, ptr %19, i64 0, i32 14
  %38 = load i32, ptr %m_activationState1.i.i, align 4
  %cmp.not.i = icmp ne i32 %38, 2
  %cmp3.i = icmp ne i32 %38, 5
  %spec.select.i = and i1 %cmp.not.i, %cmp3.i
  %spec.select = select i1 %spec.select.i, i8 %islandSleeping.0221, i8 1
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
...
for.end.split.loop.exit232:                       ; preds = %land.rhs
  %41 = trunc i64 %indvars.iv to i32
  br label %for.end

for.end:                                          ; preds = %invoke.cont45, %for.end.split.loop.exit232
  %islandSleeping.0.lcssa = phi i8 [ %islandSleeping.0221, %for.end.split.loop.exit232 ], [ %spec.select, %invoke.cont45 ]
  %endIslandIndex.0.lcssa = phi i32 [ %41, %for.end.split.loop.exit232 ], [ %smax, %invoke.cont45 ]
  %cmp51 = icmp slt i32 %startManifoldIndex.0224, %9
  br i1 %cmp51, label %if.then52, label %if.end80

if.then52:                                        ; preds = %for.end
  %42 = load ptr, ptr %m_data.i173, align 8
  %idxprom.i174 = sext i32 %startManifoldIndex.0224 to i64
  %arrayidx.i175 = getelementptr inbounds ptr, ptr %42, i64 %idxprom.i174
  %43 = load ptr, ptr %arrayidx.i175, align 8
  %m_body0.i.i = getelementptr inbounds %class.btPersistentManifold, ptr %43, i64 0, i32 3
  %44 = load ptr, ptr %m_body0.i.i, align 8
  %m_islandTag1.i.i = getelementptr inbounds %class.btCollisionObject, ptr %44, i64 0, i32 12
  %45 = load i32, ptr %m_islandTag1.i.i, align 4
  %cmp.i176 = icmp sgt i32 %45, -1
...
for.cond64.preheader:                             ; preds = %invoke.cont57
  %48 = add nsw i32 %startManifoldIndex.0224, 1
  %smax229 = tail call i32 @llvm.smax.i32(i32 %9, i32 %48)
  br label %for.cond64

for.cond64:                                       ; preds = %for.cond64.preheader, %invoke.cont70
  %indvars.iv227 = phi i64 [ %idxprom.i174, %for.cond64.preheader ], [ %indvars.iv.next228, %invoke.cont70 ]
  %indvars.iv.next228 = add nsw i64 %indvars.iv227, 1
  %cmp65 = icmp slt i64 %indvars.iv.next228, %11
  br i1 %cmp65, label %land.rhs66, label %for.end77

land.rhs66:                                       ; preds = %for.cond64
  %arrayidx.i182 = getelementptr inbounds ptr, ptr %42, i64 %indvars.iv.next228
  %49 = load ptr, ptr %arrayidx.i182, align 8
  %m_body0.i.i183 = getelementptr inbounds %class.btPersistentManifold, ptr %49, i64 0, i32 3
  %50 = load ptr, ptr %m_body0.i.i183, align 8
  %m_islandTag1.i.i184 = getelementptr inbounds %class.btCollisionObject, ptr %50, i64 0, i32 12
  %51 = load i32, ptr %m_islandTag1.i.i184, align 4
  %cmp.i185 = icmp sgt i32 %51, -1
  br i1 %cmp.i185, label %invoke.cont70, label %cond.false.i186

cond.false.i186:                                  ; preds = %land.rhs66
  %m_body1.i.i187 = getelementptr inbounds %class.btPersistentManifold, ptr %49, i64 0, i32 4
  %52 = load ptr, ptr %m_body1.i.i187, align 8
  %m_islandTag1.i8.i188 = getelementptr inbounds %class.btCollisionObject, ptr %52, i64 0, i32 12
  %53 = load i32, ptr %m_islandTag1.i8.i188, align 4
  br label %invoke.cont70

invoke.cont70:                                    ; preds = %cond.false.i186, %land.rhs66
  %cond.i189 = phi i32 [ %53, %cond.false.i186 ], [ %51, %land.rhs66 ]
  %cmp72 = icmp eq i32 %13, %cond.i189
  br i1 %cmp72, label %for.cond64, label %for.end77.split.loop.exit235

for.end77.split.loop.exit235:                     ; preds = %invoke.cont70
  %54 = trunc i64 %indvars.iv.next228 to i32
  br label %for.end77

for.end77:                                        ; preds = %for.cond64, %for.end77.split.loop.exit235
  %endManifoldIndex.1.lcssa = phi i32 [ %54, %for.end77.split.loop.exit235 ], [ %smax229, %for.cond64 ]
  %sub = sub nsw i32 %endManifoldIndex.1.lcssa, %startManifoldIndex.0224
  br label %if.end80

if.end80:                                         ; preds = %invoke.cont57, %for.end77, %for.end
  %endManifoldIndex.3 = phi i32 [ %endManifoldIndex.0225, %for.end ], [ %endManifoldIndex.1.lcssa, %for.end77 ], [ %endManifoldIndex.0225, %invoke.cont57 ]
  ...
  %.pre231 = load i32, ptr %m_size.i.i165, align 4
  br i1 %tobool81.not, label %if.then82, label %if.end93

if.then82:                                        ; preds = %if.end80
  %56 = load ptr, ptr %m_data.i.i.i, align 8
  %vtable90 = load ptr, ptr %callback, align 8
  %vfn91 = getelementptr inbounds ptr, ptr %vtable90, i64 2
  %57 = load ptr, ptr %vfn91, align 8
  invoke void %57(ptr noundef nonnull align 8 dereferenceable(8) %callback, ptr noundef nonnull %56, i32 noundef %.pre231, ptr noundef %startManifold.1, i32 noundef %numIslandManifolds.1, i32 noundef %13)
          to label %if.then82.if.end93_crit_edge unwind label %lpad84

if.then82.if.end93_crit_edge:                     ; preds = %if.then82
  %.pre = load i32, ptr %m_size.i.i165, align 4
  br label %if.end93
...
if.end93:                                         ; preds = %if.then82.if.end93_crit_edge, %if.end80
  %59 = phi i32 [ %.pre, %if.then82.if.end93_crit_edge ], [ %.pre231, %if.end80 ]
  %tobool94.not = icmp eq i32 %numIslandManifolds.1, 0
  %spec.select152 = select i1 %tobool94.not, i32 %startManifoldIndex.0224, i32 %endManifoldIndex.3
...
if.then5.i:                                       ; preds = %if.end93
  ...
  br i1 %cmp.i.i195, label %_ZNK20btAlignedObjectArrayIP17btCollisionObjectE4copyEiiPS1_.exit.i.i200, label %for.body10.lr.ph.i

_ZNK20btAlignedObjectArrayIP17btCollisionObjectE4copyEiiPS1_.exit.i.i200: ; preds = %if.then5.i
  %61 = load ptr, ptr %m_data.i.i.i, align 8
  %tobool.not.i10.i.i202 = icmp eq ptr %61, null
  %62 = load i8, ptr %m_ownsMemory.i.i.i, align 8
  %tobool2.not.i.i.i204 = icmp eq i8 %62, 0
  %or.cond.i.i205 = select i1 %tobool.not.i10.i.i202, i1 true, i1 %tobool2.not.i.i.i204
  br i1 %or.cond.i.i205, label %if.end.i, label %if.then3.i.i.i206

if.then3.i.i.i206:                                ; preds = %_ZNK20btAlignedObjectArrayIP17btCollisionObjectE4copyEiiPS1_.exit.i.i200
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %61)
          to label %if.end.i unwind label %lpad98

if.end.i:                                         ; preds = %if.then3.i.i.i206, %_ZNK20btAlignedObjectArrayIP17btCollisionObjectE4copyEiiPS1_.exit.i.i200
  store i8 1, ptr %m_ownsMemory.i.i.i, align 8
  store ptr null, ptr %m_data.i.i.i, align 8
  store i32 0, ptr %m_capacity.i.i, align 8
  br label %for.body10.lr.ph.i
...
for.body10.lr.ph.i:                               ; preds = %if.end.i, %if.then5.i
  ...
  %64 = sub nsw i64 0, %63
  %xtraiter247 = and i64 %64, 3
  %lcmp.mod248.not = icmp eq i64 %xtraiter247, 0
  br i1 %lcmp.mod248.not, label %for.body10.i.prol.loopexit, label %for.body10.i.prol
...
lpad98:                                           ; preds = %if.then3.i.i.i206
...
ehcleanup111:                                     ; preds = %lpad17, %lpad84, %lpad98, %lpad42, %lpad, %lpad7
  %.pn148.pn.pn = phi { ptr, i32 } [ %8, %lpad7 ], [ %7, %lpad ], [ %39, %lpad17 ], [ %40, %lpad42 ], [ %71, %lpad98 ], [ %58, %lpad84 ]
  invoke void @_ZN15CProfileManager12Stop_ProfileEv()
...
tailrecurse:                                      ; preds = %if.end17, %entry
  ...
  %m_body1.i.i7.i = getelementptr inbounds %class.btPersistentManifold, ptr %1, i64 0, i32 4
  br label %do.body
...
cond.false.i.i.us:                                ; preds = %while.cond.us
  ...
  %10 = load i32, ptr %m_islandTag1.i8.i.i.us, align 4
...
do.body.split:                                    ; preds = %do.body
  %11 = load ptr, ptr %m_body1.i.i7.i, align 8
  %m_islandTag1.i8.i8.i = getelementptr inbounds %class.btCollisionObject, ptr %11, i64 0, i32 12
  %12 = load i32, ptr %m_islandTag1.i8.i8.i, align 4
...
cond.false.i.i:                                   ; preds = %while.cond
  ...
  %18 = load i32, ptr %m_islandTag1.i8.i.i, align 4
...
while.cond5.us:                                   ; preds = %while.cond5.us.preheader, %_ZN33btPersistentManifoldSortPredicateclEPK20btPersistentManifoldS2_.exit59.us
  ...
  %m_body0.i.i3.i51.us = getelementptr inbounds %class.btPersistentManifold, ptr %20, i64 0, i32 3
  %21 = load ptr, ptr %m_body0.i.i3.i51.us, align 8
  %m_islandTag1.i.i4.i52.us = getelementptr inbounds %class.btCollisionObject, ptr %21, i64 0, i32 12
  %22 = load i32, ptr %m_islandTag1.i.i4.i52.us, align 4
  %cmp.i5.i53.us = icmp sgt i32 %22, -1
  br i1 %cmp.i5.i53.us, label %_ZN33btPersistentManifoldSortPredicateclEPK20btPersistentManifoldS2_.exit59.us, label %cond.false.i6.i54.us

cond.false.i6.i54.us:                             ; preds = %while.cond5.us
  %m_body1.i.i7.i55.us = getelementptr inbounds %class.btPersistentManifold, ptr %20, i64 0, i32 4
  %23 = load ptr, ptr %m_body1.i.i7.i55.us, align 8
  %m_islandTag1.i8.i8.i56.us = getelementptr inbounds %class.btCollisionObject, ptr %23, i64 0, i32 12
  %24 = load i32, ptr %m_islandTag1.i8.i8.i56.us, align 4
  br label %_ZN33btPersistentManifoldSortPredicateclEPK20btPersistentManifoldS2_.exit59.us

_ZN33btPersistentManifoldSortPredicateclEPK20btPersistentManifoldS2_.exit59.us: ; preds = %cond.false.i6.i54.us, %while.cond5.us
  %cond.i9.i57.us = phi i32 [ %24, %cond.false.i6.i54.us ], [ %22, %while.cond5.us ]
...
while.cond5.preheader.split70:                    ; preds = %while.cond5.preheader
  %25 = load ptr, ptr %m_body1.i.i7.i, align 8
  %m_islandTag1.i8.i.i48 = getelementptr inbounds %class.btCollisionObject, ptr %25, i64 0, i32 12
  %26 = load i32, ptr %m_islandTag1.i8.i.i48, align 4
...
while.cond5:                                      ; preds = %_ZN33btPersistentManifoldSortPredicateclEPK20btPersistentManifoldS2_.exit59, %while.cond5.preheader.split70
  ...
  %m_body0.i.i3.i51 = getelementptr inbounds %class.btPersistentManifold, ptr %28, i64 0, i32 3
  %29 = load ptr, ptr %m_body0.i.i3.i51, align 8
  %m_islandTag1.i.i4.i52 = getelementptr inbounds %class.btCollisionObject, ptr %29, i64 0, i32 12
  %30 = load i32, ptr %m_islandTag1.i.i4.i52, align 4
  %cmp.i5.i53 = icmp sgt i32 %30, -1
  br i1 %cmp.i5.i53, label %_ZN33btPersistentManifoldSortPredicateclEPK20btPersistentManifoldS2_.exit59, label %cond.false.i6.i54

cond.false.i6.i54:                                ; preds = %while.cond5
  %m_body1.i.i7.i55 = getelementptr inbounds %class.btPersistentManifold, ptr %28, i64 0, i32 4
  %31 = load ptr, ptr %m_body1.i.i7.i55, align 8
  %m_islandTag1.i8.i8.i56 = getelementptr inbounds %class.btCollisionObject, ptr %31, i64 0, i32 12
  %32 = load i32, ptr %m_islandTag1.i8.i8.i56, align 4
  br label %_ZN33btPersistentManifoldSortPredicateclEPK20btPersistentManifoldS2_.exit59

_ZN33btPersistentManifoldSortPredicateclEPK20btPersistentManifoldS2_.exit59: ; preds = %while.cond5, %cond.false.i6.i54
  %cond.i9.i57 = phi i32 [ %32, %cond.false.i6.i54 ], [ %30, %while.cond5 ]
...
if.then:                                          ; preds = %while.end11
  ...
  store ptr %.us-phi69, ptr %arrayidx10.i, align 8
