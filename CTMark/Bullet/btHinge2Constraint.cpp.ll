; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btHinge2Constraint.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btHinge2Constraint.cpp"
...
common.resume:                                    ; preds = %lpad.i112, %lpad.i
  %common.resume.op = phi { ptr, i32 } [ %3, %lpad.i ], [ %7, %lpad.i112 ]
...
_ZN11btTransform11getIdentityEv.exit:             ; preds = %entry, %init.check.i, %invoke.cont6.i
  ...
  br i1 %guard.uninitialized.i107, label %init.check.i108, label %invoke.cont87

init.check.i108:                                  ; preds = %_ZN11btTransform11getIdentityEv.exit
  %5 = tail call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZN11btTransform11getIdentityEvE17identityTransform) #12
  %tobool.not.i109 = icmp eq i32 %5, 0
  br i1 %tobool.not.i109, label %invoke.cont87, label %init.i110

init.i110:                                        ; preds = %init.check.i108
  %call.i111 = invoke noundef nonnull align 4 dereferenceable(48) ptr @_ZN11btMatrix3x311getIdentityEv()
          to label %invoke.cont6.i113 unwind label %lpad.i112

invoke.cont6.i113:                                ; preds = %init.i110
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) @_ZZN11btTransform11getIdentityEvE17identityTransform, ptr noundef nonnull align 4 dereferenceable(16) %call.i111, i64 16, i1 false)
  %arrayidx6.i.i.i114 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i111, i64 0, i64 1
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZN11btTransform11getIdentityEvE17identityTransform, i64 0, i32 0, i32 0, i64 1), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx6.i.i.i114, i64 16, i1 false)
  %arrayidx10.i.i.i115 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i111, i64 0, i64 2
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZN11btTransform11getIdentityEvE17identityTransform, i64 0, i32 0, i32 0, i64 2), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx10.i.i.i115, i64 16, i1 false)
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZN11btTransform11getIdentityEvE17identityTransform, i64 0, i32 1), i8 0, i64 16, i1 false)
  %6 = tail call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull @_ZZN11btTransform11getIdentityEvE17identityTransform)
  tail call void @__cxa_guard_release(ptr nonnull @_ZGVZN11btTransform11getIdentityEvE17identityTransform) #12
  br label %invoke.cont87

lpad.i112:                                        ; preds = %init.i110
  %7 = landingpad { ptr, i32 }
          cleanup
  br label %common.resume

invoke.cont87:                                    ; preds = %invoke.cont6.i113, %init.check.i108, %_ZN11btTransform11getIdentityEv.exit
  ...
  store ptr getelementptr inbounds ({ [10 x ptr] }, ptr @_ZTV18btHinge2Constraint, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  ...
  %17 = load float, ptr %arrayidx10.i.i.i.i119, align 4
  %18 = load <2 x float>, ptr %axis2, align 4
  ...
  store <2 x float> %25, ptr %axis2, align 4
  %mul7.i.i.i124 = fmul float %17, %div.i.i121
  store float %mul7.i.i.i124, ptr %arrayidx10.i.i.i.i119, align 4
  ...
  %40 = load float, ptr %arrayidx.i28.i.i, align 8
  %41 = load float, ptr %arrayidx.i29.i.i, align 8
  %42 = load float, ptr %arrayidx.i30.i.i, align 8
  %m_origin.i128 = getelementptr inbounds %class.btCollisionObject, ptr %rbA, i64 0, i32 1, i32 1
  %43 = load float, ptr %m_origin.i128, align 8
  ...
  %44 = load float, ptr %arrayidx3.i5.i, align 4
  ...
  %45 = load float, ptr %arrayidx7.i.i129, align 8
  ...
  %48 = load <2 x float>, ptr %m_worldTransform.i, align 8
  %49 = load <2 x float>, ptr %arrayidx3.i.i127, align 8
  %50 = load <2 x float>, ptr %arrayidx6.i.i, align 8
  ...
  store float %64, ptr %ref.tmp.sroa.6.0.m_frameInA.sroa_idx, align 8
  ...
  store float %69, ptr %ref.tmp.sroa.11.16.arrayidx7.i.i137.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp.sroa.12.16.arrayidx7.i.i137.sroa_idx, align 4
  ...
  store float %47, ptr %ref.tmp.sroa.16.32.arrayidx11.i.i.sroa_idx, align 8
  ...
  store <2 x float> %76, ptr %m_origin3.i, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i295, ptr %ref.tmp.sroa.20.48.m_origin3.i.sroa_idx, align 8
  ...
  %110 = load float, ptr %arrayidx.i28.i.i145, align 8
  %111 = load float, ptr %arrayidx.i29.i.i146, align 8
  %112 = load float, ptr %arrayidx.i30.i.i147, align 8
  %m_origin.i148 = getelementptr inbounds %class.btCollisionObject, ptr %rbB, i64 0, i32 1, i32 1
  %113 = load float, ptr %m_origin.i148, align 8
  ...
  %114 = load float, ptr %arrayidx3.i5.i150, align 4
  ...
  %115 = load float, ptr %arrayidx7.i.i152, align 8
  ...
  %118 = load <2 x float>, ptr %m_worldTransform.i139, align 8
  %119 = load <2 x float>, ptr %arrayidx3.i.i140, align 8
  %120 = load <2 x float>, ptr %arrayidx6.i.i141, align 8
  ...
  store float %134, ptr %ref.tmp51.sroa.6.0.m_frameInB.sroa_idx, align 8
  ...
  store float %139, ptr %ref.tmp51.sroa.11.16.arrayidx7.i.i227.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp51.sroa.12.16.arrayidx7.i.i227.sroa_idx, align 4
  ...
  store float %117, ptr %ref.tmp51.sroa.16.32.arrayidx11.i.i229.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp51.sroa.17.32.arrayidx11.i.i229.sroa_idx, align 4
  %m_origin3.i231 = getelementptr inbounds %class.btGeneric6DofConstraint, ptr %this, i64 0, i32 2, i32 1
  store <2 x float> %143, ptr %m_origin3.i231, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i212296, ptr %ref.tmp51.sroa.20.48.m_origin3.i231.sroa_idx, align 8
  ...
  store <2 x float> <float 1.000000e+00, float -1.000000e+00>, ptr %arrayidx4.i, align 4
  store <2 x float> zeroinitializer, ptr %arrayidx4.1.i, align 4
  store <2 x float> <float 0xBFE921FB60000000, float 0x3FE921FB60000000>, ptr %arrayidx4.2.i, align 4
