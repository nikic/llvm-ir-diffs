; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btConvex2dConvex2dAlgorithm.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btConvex2dConvex2dAlgorithm.cpp"
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %5 = load ptr, ptr %m_collisionShape.i61, align 8
  ...
  %m_simplexSolver = getelementptr inbounds %class.btConvex2dConvex2dAlgorithm, ptr %this, i64 0, i32 1
  %6 = load ptr, ptr %m_simplexSolver, align 8
  %m_pdSolver = getelementptr inbounds %class.btConvex2dConvex2dAlgorithm, ptr %this, i64 0, i32 2
  %7 = load ptr, ptr %m_pdSolver, align 8
  ...
  %11 = load ptr, ptr %m_stackAllocator, align 8
  store ptr %11, ptr %m_stackAlloc.i, align 8
  %m_worldTransform.i = getelementptr inbounds %class.btCollisionObject, ptr %body0, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %input, ptr noundef nonnull align 4 dereferenceable(16) %m_worldTransform.i, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_transformB, ptr noundef nonnull align 4 dereferenceable(16) %m_worldTransform.i62, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx7.i.i64, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx5.i.i63, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx11.i.i66, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx9.i.i65, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_origin3.i68, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i67, i64 16, i1 false)
  %m_debugDraw = getelementptr inbounds %struct.btDispatcherInfo, ptr %dispatchInfo, i64 0, i32 5
  %12 = load ptr, ptr %m_debugDraw, align 8
  ...
  %13 = load i8, ptr %m_ownManifold41, align 8
...
if.end.i:                                         ; preds = %if.then43
  ...
  %17 = load ptr, ptr %m_body0.i, align 8
...
entry:
  ...
  %1 = load float, ptr %m_origin.i172, align 4
...
land.lhs.true:                                    ; preds = %entry
  ...
  %17 = load float, ptr %m_ccdMotionThreshold.i192, align 4
...
if.end42:                                         ; preds = %if.then39, %if.then35
  ...
  %24 = load float, ptr %m_hitFraction.i199, align 4
  %cmp46 = fcmp ogt float %24, %21
  br i1 %cmp46, label %if.then47, label %if.end50

if.then47:                                        ; preds = %if.end42
  store float %21, ptr %m_hitFraction.i199, align 4
  br label %if.end50
...
invoke.cont75:                                    ; preds = %if.end56
  ...
  %25 = load ptr, ptr %m_collisionShape.i201, align 8
  ...
  %26 = load float, ptr %m_ccdSweptSphereRadius.i202, align 8
...
if.then90:                                        ; preds = %invoke.cont88
  ...
  %27 = load float, ptr %m_hitFraction.i216, align 4
  %28 = load float, ptr %m_fraction.i206, align 8
  %cmp94 = fcmp ogt float %27, %28
  br i1 %cmp94, label %if.then95, label %if.end98

if.then95:                                        ; preds = %if.then90
  store float %28, ptr %m_hitFraction.i216, align 4
  br label %if.end98
...
if.end98:                                         ; preds = %if.then95, %if.then90
  ...
  %31 = load float, ptr %m_hitFraction.i218, align 4
  %cmp102 = fcmp ogt float %31, %28
  br i1 %cmp102, label %if.then103, label %if.end106

if.then103:                                       ; preds = %if.end98
  store float %28, ptr %m_hitFraction.i218, align 4
  br label %if.end106
...
entry:
  ...
  %3 = load <2 x i32>, ptr %m_numPerturbationIterations, align 8
  %4 = load <2 x ptr>, ptr %m_pdSolver, align 8
