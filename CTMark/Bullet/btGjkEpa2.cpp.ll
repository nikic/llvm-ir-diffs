; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btGjkEpa2.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btGjkEpa2.cpp"
...
for.cond.preheader:                               ; preds = %entry
  ...
  %1 = load i32, ptr %rank152, align 8
...
for.cond.cleanup:                                 ; preds = %_ZNK12gjkepa2_impl13MinkowskiDiff7SupportERK9btVector3j.exit121, %for.cond.preheader
  ...
  %5 = load <4 x float>, ptr %wtrs0, align 4
  ...
  %7 = load <4 x float>, ptr %arrayidx5.i.i.i, align 4
  ...
  %14 = load float, ptr %arrayidx5.i20.i.i, align 4
  %arrayidx10.i23.i.i = getelementptr inbounds [3 x %class.btVector3], ptr %wtrs0, i64 0, i64 1, i32 0, i64 2
  %15 = load float, ptr %arrayidx10.i23.i.i, align 4
  %16 = shufflevector <2 x float> %3, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %17 = insertelement <2 x float> %8, float %14, i64 1
  %18 = fmul <2 x float> %16, %17
  %19 = insertelement <2 x float> %6, float %13, i64 1
  %20 = shufflevector <2 x float> %3, <2 x float> poison, <2 x i32> zeroinitializer
  %21 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %19, <2 x float> %20, <2 x float> %18)
  %22 = insertelement <2 x float> %12, float %15, i64 1
  ...
  %33 = load float, ptr %arrayidx.i32.i.i, align 4
  ...
  store <2 x float> %27, ptr %witnesses, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i, ptr %ref.tmp33.sroa.4.0.arrayidx36.sroa_idx, align 4
  %34 = load <4 x float>, ptr %wtrs0, align 4
  %35 = shufflevector <4 x float> %34, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %36 = load <4 x float>, ptr %arrayidx5.i.i.i, align 4
  %37 = shufflevector <4 x float> %36, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %38 = extractelement <2 x float> %4, i64 1
  ...
  %42 = load float, ptr %arrayidx.i.i.i, align 4
  %43 = load float, ptr %arrayidx5.i20.i.i, align 4
  %44 = load float, ptr %arrayidx10.i23.i.i, align 4
  %45 = shufflevector <2 x float> %4, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %46 = insertelement <2 x float> %37, float %43, i64 1
  %47 = fmul <2 x float> %45, %46
  %48 = insertelement <2 x float> %35, float %42, i64 1
  %49 = shufflevector <2 x float> %4, <2 x float> poison, <2 x i32> zeroinitializer
  %50 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %48, <2 x float> %49, <2 x float> %47)
  %51 = insertelement <2 x float> %41, float %44, i64 1
  ...
  %55 = load <2 x float>, ptr %m_origin.i.i, align 4
  %56 = fadd <2 x float> %55, %54
  %57 = load float, ptr %arrayidx.i26.i.i, align 4
  %58 = load float, ptr %arrayidx5.i27.i.i, align 4
  %mul8.i29.i.i91 = fmul float %38, %58
  %59 = call float @llvm.fmuladd.f32(float %57, float %39, float %mul8.i29.i.i91)
  %60 = load float, ptr %arrayidx10.i30.i.i, align 4
  %61 = call float @llvm.fmuladd.f32(float %60, float %w1.sroa.12.0.lcssa, float %59)
  %62 = load float, ptr %arrayidx.i32.i.i, align 4
  ...
  store <2 x float> %56, ptr %arrayidx41, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i97, ptr %ref.tmp37.sroa.4.0.arrayidx41.sroa_idx, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i, ptr %ref.tmp42.sroa.4.0.normal.sroa_idx, align 4
  ...
  store <2 x float> %71, ptr %normal, align 4
  %mul7.i.i = fmul float %sub14.i, %div.i
  store float %mul7.i.i, ptr %ref.tmp42.sroa.4.0.normal.sroa_idx, align 4
  br label %cleanup
...
for.body:                                         ; preds = %for.body.lr.ph, %_ZNK12gjkepa2_impl13MinkowskiDiff7SupportERK9btVector3j.exit121
  ...
  %76 = load ptr, ptr %arrayidx13, align 8
  %77 = load ptr, ptr %shape, align 8
  %.unpack.i8.i = load i64, ptr %Ls.i7.i, align 8
  ...
  br i1 %memptr.isvirtual.not.i9.i, label %memptr.nonvirtual.i13.i, label %memptr.virtual.i10.i

memptr.virtual.i10.i:                             ; preds = %for.body
  %vtable.i11.i = load ptr, ptr %78, align 8
  %80 = add i64 %.unpack.i8.i, -1
  %81 = getelementptr i8, ptr %vtable.i11.i, i64 %80
  %memptr.virtualfn.i12.i = load ptr, ptr %81, align 8
  br label %_ZNK12gjkepa2_impl13MinkowskiDiff7SupportERK9btVector3j.exit

memptr.nonvirtual.i13.i:                          ; preds = %for.body
  %memptr.nonvirtualfn.i14.i = inttoptr i64 %.unpack.i8.i to ptr
  br label %_ZNK12gjkepa2_impl13MinkowskiDiff7SupportERK9btVector3j.exit

_ZNK12gjkepa2_impl13MinkowskiDiff7SupportERK9btVector3j.exit: ; preds = %memptr.virtual.i10.i, %memptr.nonvirtual.i13.i
  %82 = phi ptr [ %memptr.virtualfn.i12.i, %memptr.virtual.i10.i ], [ %memptr.nonvirtualfn.i14.i, %memptr.nonvirtual.i13.i ]
...
memptr.virtual.i.i:                               ; preds = %_ZNK12gjkepa2_impl13MinkowskiDiff7SupportERK9btVector3j.exit
  ...
  %98 = getelementptr i8, ptr %vtable.i.i, i64 %97
  %memptr.virtualfn.i.i = load ptr, ptr %98, align 8
...
_ZNK12gjkepa2_impl13MinkowskiDiff7SupportERK9btVector3j.exit121: ; preds = %memptr.virtual.i.i, %memptr.nonvirtual.i.i
  ...
  %106 = load float, ptr %arrayidx.i.i.i.i, align 8
  %107 = load float, ptr %arrayidx5.i12.i.i.i, align 4
  %108 = load float, ptr %arrayidx10.i15.i.i.i, align 8
  %109 = insertelement <2 x float> %103, float %107, i64 1
  %110 = insertelement <2 x float> poison, float %fneg4.i, i64 0
  %111 = shufflevector <2 x float> %110, <2 x float> poison, <2 x i32> zeroinitializer
  %112 = fmul <2 x float> %109, %111
  %113 = insertelement <2 x float> %101, float %106, i64 1
  %114 = insertelement <2 x float> poison, float %fneg.i, i64 0
  %115 = shufflevector <2 x float> %114, <2 x float> poison, <2 x i32> zeroinitializer
  %116 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %113, <2 x float> %115, <2 x float> %112)
  %117 = insertelement <2 x float> %105, float %108, i64 1
  ...
  %121 = load float, ptr %arrayidx.i17.i.i.i, align 8
  %122 = load float, ptr %arrayidx5.i18.i.i.i, align 4
  %mul8.i20.i.i.i = fmul float %122, %fneg4.i
  %123 = call float @llvm.fmuladd.f32(float %121, float %fneg.i, float %mul8.i20.i.i.i)
  %124 = load float, ptr %arrayidx10.i21.i.i.i, align 8
  ...
  %128 = load <4 x float>, ptr %m_toshape0.i.i, align 8
  ...
  %130 = load <4 x float>, ptr %arrayidx5.i.i.i.i.i, align 4
  ...
  %132 = load <4 x float>, ptr %arrayidx10.i.i.i.i.i, align 8
  ...
  %134 = load float, ptr %arrayidx.i.i.i.i.i, align 8
  %135 = load float, ptr %arrayidx5.i20.i.i.i.i, align 4
  %136 = load float, ptr %arrayidx10.i23.i.i.i.i, align 8
  %137 = load float, ptr %arrayidx.i26.i.i.i.i, align 8
  %138 = load float, ptr %arrayidx5.i27.i.i.i.i, align 4
  %mul8.i29.i.i.i.i = fmul float %ref.tmp.sroa.0.4.vec.extract.i.i, %138
  %139 = call float @llvm.fmuladd.f32(float %137, float %ref.tmp.sroa.0.0.vec.extract.i.i, float %mul8.i29.i.i.i.i)
  %140 = load float, ptr %arrayidx10.i30.i.i.i.i, align 8
  %141 = call float @llvm.fmuladd.f32(float %140, float %ref.tmp.sroa.5.8.vec.extract.i.i, float %139)
  %142 = load float, ptr %arrayidx.i32.i.i.i.i, align 8
  %add17.i.i.i.i = fadd float %142, %141
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp2.i.i) #11
  %143 = insertelement <2 x float> %131, float %135, i64 1
  %144 = shufflevector <2 x float> %126, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %145 = fmul <2 x float> %143, %144
  %146 = insertelement <2 x float> %129, float %134, i64 1
  %147 = shufflevector <2 x float> %126, <2 x float> poison, <2 x i32> zeroinitializer
  %148 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %146, <2 x float> %147, <2 x float> %145)
  %149 = insertelement <2 x float> %133, float %136, i64 1
  %150 = shufflevector <2 x float> %127, <2 x float> poison, <2 x i32> zeroinitializer
  %151 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %149, <2 x float> %150, <2 x float> %148)
  %152 = load <2 x float>, ptr %m_origin.i.i.i.i, align 8
...
entry:
  ...
  %6 = load float, ptr %arrayidx.i187.i, align 4
  ...
  %18 = load <2 x float>, ptr %wtrs0, align 4
  %19 = load <2 x float>, ptr %arrayidx.i.i, align 4
  ...
  %26 = load <2 x float>, ptr %arrayidx.i177.i, align 4
  ...
  store float %7, ptr %ref.tmp9.sroa.5.0.m_toshape1.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp9.sroa.6.0.m_toshape1.sroa_idx, align 4
  ...
  store float %12, ptr %ref.tmp9.sroa.10.16.arrayidx7.i24.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp9.sroa.11.16.arrayidx7.i24.sroa_idx, align 4
  ...
  store float %17, ptr %ref.tmp9.sroa.15.32.arrayidx11.i25.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp9.sroa.16.32.arrayidx11.i25.sroa_idx, align 4
  ...
  %48 = load float, ptr %m_origin.i.i, align 4
  %49 = load float, ptr %m_origin.i, align 4
  ...
  %52 = load float, ptr %arrayidx11.i.i, align 4
  %arrayidx13.i.i = getelementptr inbounds %class.btTransform, ptr %wtrs0, i64 0, i32 1, i32 0, i64 2
  %53 = load float, ptr %arrayidx13.i.i, align 4
  %sub14.i.i = fsub float %52, %53
  %54 = load float, ptr %arrayidx.i209.i, align 4
  %55 = load float, ptr %arrayidx.i210.i, align 4
  %56 = load float, ptr %arrayidx.i212.i, align 4
  %57 = load float, ptr %arrayidx.i183.i, align 4
  %58 = load float, ptr %arrayidx.i185.i, align 4
  %59 = load float, ptr %arrayidx.i187.i, align 4
  ...
  %86 = load <2 x float>, ptr %wtrs1, align 4
  %87 = load <2 x float>, ptr %arrayidx5.i22, align 4
  ...
  %92 = load <2 x float>, ptr %arrayidx11.i, align 4
  ...
  store float %69, ptr %ref.tmp12.sroa.5.0.m_toshape0.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp12.sroa.6.0.m_toshape0.sroa_idx, align 4
  ...
  store float %74, ptr %ref.tmp12.sroa.10.16.arrayidx7.i.i27.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp12.sroa.11.16.arrayidx7.i.i27.sroa_idx, align 4
  ...
  store float %61, ptr %ref.tmp12.sroa.15.32.arrayidx11.i.i28.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp12.sroa.16.32.arrayidx11.i.i28.sroa_idx, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i13.i, ptr %ref.tmp12.sroa.19.48.m_origin3.i.sroa_idx, align 8
...
entry:
  ...
  %0 = load <2 x i64>, ptr %Ls.i, align 8
  store <2 x i64> %0, ptr %Ls6.i, align 8
  ...
  %1 = load <2 x float>, ptr %m_ray, align 8
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %.pre = load i32, ptr %m_current, align 4
  %11 = load <2 x float>, ptr %m_ray, align 8
  %.pre387 = load float, ptr %arrayidx10.i.i, align 8
...
do.body:                                          ; preds = %for.cond.cleanup136, %cond.end
  %12 = phi float [ %.pre387, %cond.end ], [ %88, %for.cond.cleanup136 ]
  ...
  %14 = phi <2 x float> [ %11, %cond.end ], [ %89, %for.cond.cleanup136 ]
  %sub = sub i32 1, %13
...
if.end:                                           ; preds = %do.body
  ...
  %20 = load i32, ptr %rank.i279, align 8
  ...
  store float 0.000000e+00, ptr %arrayidx.i281, align 4
  %21 = load i32, ptr %m_nfree, align 8
  %dec.i283 = add i32 %21, -1
  store i32 %dec.i283, ptr %m_nfree, align 8
  ...
  %22 = load ptr, ptr %arrayidx3.i285, align 8
  %arrayidx6.i286 = getelementptr inbounds [4 x ptr], ptr %arrayidx40, i64 0, i64 %idxprom.i280
  store ptr %22, ptr %arrayidx6.i286, align 8
  %inc.i287 = add i32 %20, 1
  store i32 %inc.i287, ptr %rank.i279, align 8
  ...
  %23 = load i32, ptr %rank.i279, align 8
  %sub55 = add i32 %23, -1
  ...
  %28 = load float, ptr %lastw, align 16
  %sub.i = fsub float %25, %28
  %29 = load float, ptr %arrayidx7.i289, align 4
  %sub8.i = fsub float %26, %29
  %30 = load float, ptr %arrayidx13.i, align 8
...
for.cond:                                         ; preds = %if.end
  %33 = load float, ptr %arrayidx35, align 16
  %sub.i.1 = fsub float %25, %33
  %34 = load float, ptr %arrayidx7.i289.1, align 4
  %sub8.i.1 = fsub float %26, %34
  %35 = load float, ptr %arrayidx13.i.1, align 8
...
for.cond.1:                                       ; preds = %for.cond
  %38 = load float, ptr %arrayidx34, align 16
  %sub.i.2 = fsub float %25, %38
  %39 = load float, ptr %arrayidx7.i289.2, align 4
  %sub8.i.2 = fsub float %26, %39
  %40 = load float, ptr %arrayidx13.i.2, align 8
...
for.cond.2:                                       ; preds = %for.cond.1
  %43 = load float, ptr %arrayidx33, align 16
  %sub.i.3 = fsub float %25, %43
  %44 = load float, ptr %arrayidx7.i289.3, align 4
  %sub8.i.3 = fsub float %26, %44
  %45 = load float, ptr %arrayidx13.i.3, align 8
...
for.cond.3:                                       ; preds = %for.cond.2
  ...
  %48 = load float, ptr %m_ray, align 8
  %49 = load float, ptr %arrayidx5.i.i264, align 4
  %mul8.i.i308 = fmul float %49, %26
  %50 = call float @llvm.fmuladd.f32(float %48, float %25, float %mul8.i.i308)
  %51 = load float, ptr %arrayidx10.i.i, align 8
...
if.then69:                                        ; preds = %for.cond.2, %for.cond.1, %for.cond, %if.end
  %54 = load i32, ptr %m_current, align 4
  ...
  %55 = load i32, ptr %rank.i298, align 8
  %dec.i299 = add i32 %55, -1
  store i32 %dec.i299, ptr %rank.i298, align 8
  %idxprom.i300 = zext i32 %dec.i299 to i64
  %arrayidx.i301 = getelementptr inbounds [4 x ptr], ptr %arrayidx73, i64 0, i64 %idxprom.i300
  %56 = load ptr, ptr %arrayidx.i301, align 8
  %57 = load i32, ptr %m_nfree, align 8
  %inc.i303 = add i32 %57, 1
  store i32 %inc.i303, ptr %m_nfree, align 8
  ...
  store ptr %56, ptr %arrayidx3.i305, align 8
  br label %cleanup203.thread

if.then82:                                        ; preds = %for.cond.3
  %58 = load i32, ptr %m_current, align 4
  ...
  %59 = load i32, ptr %rank.i310, align 8
  %dec.i311 = add i32 %59, -1
  store i32 %dec.i311, ptr %rank.i310, align 8
  %idxprom.i312 = zext i32 %dec.i311 to i64
  %arrayidx.i313 = getelementptr inbounds [4 x ptr], ptr %arrayidx86, i64 0, i64 %idxprom.i312
  %60 = load ptr, ptr %arrayidx.i313, align 8
  %61 = load i32, ptr %m_nfree, align 8
  %inc.i315 = add i32 %61, 1
  store i32 %inc.i315, ptr %m_nfree, align 8
  ...
  store ptr %60, ptr %arrayidx3.i317, align 8
  br label %cleanup203.thread
...
sw.bb:                                            ; preds = %if.end87
  ...
  %64 = load float, ptr %w94, align 4
  %65 = load float, ptr %w91, align 4
  ...
  %68 = load float, ptr %arrayidx11.i.i320, align 4
...
if.else13.i:                                      ; preds = %if.else.i
  store float %div.i, ptr %arrayidx6.i324, align 4
  %sub.i326 = fsub float 1.000000e+00, %div.i
  store float %sub.i326, ptr %weights, align 16
...
sw.bb96:                                          ; preds = %if.end87
  %80 = load ptr, ptr %arrayidx40, align 8
  ...
  %81 = load ptr, ptr %arrayidx101, align 8
...
sw.bb108:                                         ; preds = %if.end87
  %83 = load ptr, ptr %arrayidx40, align 8
  ...
  %84 = load ptr, ptr %arrayidx113, align 8
...
if.then124:                                       ; preds = %sw.epilog
  ...
  %87 = load i32, ptr %rank.i279, align 8
  %cmp135378.not = icmp eq i32 %87, 0
  %.pre388 = load i32, ptr %mask, align 4
  br i1 %cmp135378.not, label %for.cond.cleanup136, label %for.body137.lr.ph

for.body137.lr.ph:                                ; preds = %if.then124
  %m_nfree.promoted = load i32, ptr %m_nfree, align 8
  %wide.trip.count = zext i32 %87 to i64
  br label %for.body137

for.cond.cleanup136:                              ; preds = %for.inc176, %if.then124
  %88 = phi float [ 0.000000e+00, %if.then124 ], [ %add13.i376, %for.inc176 ]
  %89 = phi <2 x float> [ zeroinitializer, %if.then124 ], [ %106, %for.inc176 ]
  %cmp181 = icmp eq i32 %.pre388, 15
  %.pre389 = load i32, ptr %m_status, align 8
  %90 = select i1 %cmp181, i32 1, i32 %.pre389
  %inc191 = add i32 %iterations.0, 1
  %cmp192 = icmp ult i32 %inc191, 128
  %spec.select = select i1 %cmp192, i32 %90, i32 2
...
for.body137:                                      ; preds = %for.body137.lr.ph, %for.inc176
  %91 = phi i32 [ 0, %for.body137.lr.ph ], [ %104, %for.inc176 ]
  ...
  %92 = phi i32 [ %m_nfree.promoted, %for.body137.lr.ph ], [ %105, %for.inc176 ]
  %93 = phi <2 x float> [ zeroinitializer, %for.body137.lr.ph ], [ %106, %for.inc176 ]
  %94 = trunc i64 %indvars.iv to i32
  %shl = shl nuw i32 1, %94
  %and138 = and i32 %.pre388, %shl
  %tobool139.not = icmp eq i32 %and138, 0
  %arrayidx169 = getelementptr inbounds [4 x ptr], ptr %arrayidx40, i64 0, i64 %indvars.iv
  %95 = load ptr, ptr %arrayidx169, align 8
...
if.then140:                                       ; preds = %for.body137
  ...
  store ptr %95, ptr %arrayidx147, align 8
  %arrayidx149 = getelementptr inbounds [4 x float], ptr %weights, i64 0, i64 %indvars.iv
  %96 = load float, ptr %arrayidx149, align 4
  %inc152 = add i32 %91, 1
  store i32 %inc152, ptr %rank125, align 8
  %arrayidx154 = getelementptr inbounds %"struct.gjkepa2_impl::GJK", ptr %this, i64 0, i32 4, i64 %idxprom42, i32 1, i64 %idxprom146
  store float %96, ptr %arrayidx154, align 4
  %97 = load ptr, ptr %arrayidx169, align 8
  %w159 = getelementptr inbounds %"struct.gjkepa2_impl::GJK::sSV", ptr %97, i64 0, i32 1
  %arrayidx7.i332 = getelementptr inbounds %"struct.gjkepa2_impl::GJK::sSV", ptr %97, i64 0, i32 1, i32 0, i64 2
  %98 = load float, ptr %arrayidx7.i332, align 4
  %mul8.i = fmul float %96, %98
  %99 = load <2 x float>, ptr %w159, align 4
  %100 = insertelement <2 x float> poison, float %96, i64 0
  %101 = shufflevector <2 x float> %100, <2 x float> poison, <2 x i32> zeroinitializer
  %102 = fmul <2 x float> %101, %99
  %103 = fadd <2 x float> %102, %93
  store <2 x float> %103, ptr %m_ray, align 8
...
if.else166:                                       ; preds = %for.body137
  %inc172 = add i32 %92, 1
  store i32 %inc172, ptr %m_nfree, align 8
  ...
  store ptr %95, ptr %arrayidx174, align 8
  br label %for.inc176

for.inc176:                                       ; preds = %if.then140, %if.else166
  %104 = phi i32 [ %inc152, %if.then140 ], [ %91, %if.else166 ]
  %105 = phi i32 [ %92, %if.then140 ], [ %inc172, %if.else166 ]
  %add13.i376 = phi float [ %add13.i, %if.then140 ], [ %add13.i377379, %if.else166 ]
  %106 = phi <2 x float> [ %103, %if.then140 ], [ %93, %if.else166 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.cond.cleanup136, label %for.body137

cleanup203.thread364:                             ; preds = %sw.epilog, %sw.bb
  %107 = load i32, ptr %m_current, align 4
  %idxprom188 = zext i32 %107 to i64
  ...
  %108 = load i32, ptr %rank.i340, align 8
  %dec.i341 = add i32 %108, -1
  store i32 %dec.i341, ptr %rank.i340, align 8
  %idxprom.i342 = zext i32 %dec.i341 to i64
  %arrayidx.i343 = getelementptr inbounds [4 x ptr], ptr %arrayidx189, i64 0, i64 %idxprom.i342
  %109 = load ptr, ptr %arrayidx.i343, align 8
  %110 = load i32, ptr %m_nfree, align 8
  %inc.i345 = add i32 %110, 1
  store i32 %inc.i345, ptr %m_nfree, align 8
  %idxprom2.i346 = zext i32 %110 to i64
  %arrayidx3.i347 = getelementptr inbounds %"struct.gjkepa2_impl::GJK", ptr %this, i64 0, i32 6, i64 %idxprom2.i346
  store ptr %109, ptr %arrayidx3.i347, align 8
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %mask) #11
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %weights) #11
  %111 = load i32, ptr %m_status, align 8
  br label %do.end
...
cleanup203.thread:                                ; preds = %if.then, %if.then69, %if.then82
  ...
  %112 = load i32, ptr %m_status, align 8
  br label %do.end
...
do.end:                                           ; preds = %for.cond.cleanup136, %cleanup203.thread364, %cleanup203.thread
  ...
  %113 = phi i32 [ %111, %cleanup203.thread364 ], [ %112, %cleanup203.thread ], [ %spec.select, %for.cond.cleanup136 ]
  ...
  store ptr %arrayidx212, ptr %m_simplex, align 8
  switch i32 %113, label %sw.epilog220 [
    i32 0, label %sw.bb214
    i32 1, label %sw.epilog220.sink.split
  ]

sw.bb214:                                         ; preds = %do.end
  %114 = load float, ptr %m_ray, align 8
  %115 = load float, ptr %arrayidx5.i.i264, align 4
  %mul8.i.i.i349 = fmul float %115, %115
  %116 = call float @llvm.fmuladd.f32(float %114, float %114, float %mul8.i.i.i349)
  %117 = load float, ptr %arrayidx10.i.i, align 8
  %118 = call float @llvm.fmuladd.f32(float %117, float %117, float %116)
  %sqrt.i351 = call float @llvm.sqrt.f32(float %118)
...
sw.bb:                                            ; preds = %entry
  ...
  store i32 0, ptr %arrayctor.end3.i, align 8
...
for.body.i.i:                                     ; preds = %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit.i.i, %sw.bb
  ...
  store ptr %4, ptr %arrayidx2.i.i.i, align 8
...
_ZN12gjkepa2_impl3EPAC2Ev.exit:                   ; preds = %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit.i.i
  ...
  store i32 128, ptr %count.i9.i, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp2) #11
  %6 = load <2 x float>, ptr %guess, align 4
  %7 = fneg <2 x float> %6
...
memptr.virtual.i10.i:                             ; preds = %for.body
  %vtable.i11.i = load ptr, ptr %14, align 8
  %16 = add i64 %.unpack.i8.i, -1
  %17 = getelementptr i8, ptr %vtable.i11.i, i64 %16
  %memptr.virtualfn.i12.i = load ptr, ptr %17, align 8
  br label %_ZNK12gjkepa2_impl13MinkowskiDiff7SupportERK9btVector3j.exit
...
_ZNK12gjkepa2_impl13MinkowskiDiff7SupportERK9btVector3j.exit: ; preds = %memptr.virtual.i10.i, %memptr.nonvirtual.i13.i
  %18 = phi ptr [ %memptr.virtualfn.i12.i, %memptr.virtual.i10.i ], [ %memptr.nonvirtualfn.i14.i, %memptr.nonvirtual.i13.i ]
...
cleanup:                                          ; preds = %_ZNK12gjkepa2_impl13MinkowskiDiff7SupportERK9btVector3j.exit, %for.cond.preheader
  ...
  %30 = load <4 x float>, ptr %wtrs0, align 4
  ...
  %arrayidx10.i.i.i = getelementptr inbounds [4 x float], ptr %wtrs0, i64 0, i64 2
  %35 = load <4 x float>, ptr %arrayidx10.i.i.i, align 4
  %36 = shufflevector <4 x float> %35, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %37 = extractelement <2 x float> %29, i64 1
  %m_origin.i.i = getelementptr inbounds %class.btTransform, ptr %wtrs0, i64 0, i32 1
  %arrayidx.i.i.i = getelementptr inbounds [3 x %class.btVector3], ptr %wtrs0, i64 0, i64 1
  %38 = load float, ptr %arrayidx.i.i.i, align 4
  %arrayidx5.i20.i.i = getelementptr inbounds [3 x %class.btVector3], ptr %wtrs0, i64 0, i64 1, i32 0, i64 1
  %39 = load float, ptr %arrayidx5.i20.i.i, align 4
  %arrayidx10.i23.i.i = getelementptr inbounds [3 x %class.btVector3], ptr %wtrs0, i64 0, i64 1, i32 0, i64 2
  %40 = load float, ptr %arrayidx10.i23.i.i, align 4
  %41 = shufflevector <2 x float> %29, <2 x float> poison, <2 x i32> zeroinitializer
  %42 = insertelement <2 x float> %33, float %39, i64 1
  %43 = fmul <2 x float> %41, %42
  %44 = insertelement <2 x float> %31, float %38, i64 1
  %45 = insertelement <2 x float> poison, float %w0.sroa.0.0.lcssa, i64 0
  %46 = shufflevector <2 x float> %45, <2 x float> poison, <2 x i32> zeroinitializer
  %47 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %44, <2 x float> %46, <2 x float> %43)
  %48 = insertelement <2 x float> %36, float %40, i64 1
  %49 = shufflevector <2 x float> %29, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %50 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %48, <2 x float> %49, <2 x float> %47)
  %51 = load <2 x float>, ptr %m_origin.i.i, align 4
  %52 = fadd <2 x float> %51, %50
  %arrayidx.i26.i.i = getelementptr inbounds [3 x %class.btVector3], ptr %wtrs0, i64 0, i64 2
  %53 = load float, ptr %arrayidx.i26.i.i, align 4
  %arrayidx5.i27.i.i = getelementptr inbounds [3 x %class.btVector3], ptr %wtrs0, i64 0, i64 2, i32 0, i64 1
  %54 = load float, ptr %arrayidx5.i27.i.i, align 4
  %mul8.i29.i.i = fmul float %34, %54
  %55 = call float @llvm.fmuladd.f32(float %53, float %w0.sroa.0.0.lcssa, float %mul8.i29.i.i)
  %arrayidx10.i30.i.i = getelementptr inbounds [3 x %class.btVector3], ptr %wtrs0, i64 0, i64 2, i32 0, i64 2
  %56 = load float, ptr %arrayidx10.i30.i.i, align 4
  %57 = call float @llvm.fmuladd.f32(float %56, float %37, float %55)
  %arrayidx.i32.i.i = getelementptr inbounds %class.btTransform, ptr %wtrs0, i64 0, i32 1, i32 0, i64 2
  %58 = load float, ptr %arrayidx.i32.i.i, align 4
  %add17.i.i = fadd float %58, %57
  %retval.sroa.3.12.vec.insert.i.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add17.i.i, i64 0
  %witnesses = getelementptr inbounds %"struct.btGjkEpaSolver2::sResults", ptr %results, i64 0, i32 1
  store <2 x float> %52, ptr %witnesses, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i, ptr %ref.tmp21.sroa.4.0.arrayidx24.sroa_idx, align 4
  %m_depth = getelementptr inbounds %"struct.gjkepa2_impl::EPA", ptr %epa, i64 0, i32 3
  %59 = load float, ptr %m_depth, align 8
  %arrayidx7.i74 = getelementptr inbounds %"struct.gjkepa2_impl::EPA", ptr %epa, i64 0, i32 2, i32 0, i64 2
  %60 = load float, ptr %arrayidx7.i74, align 8
  %mul8.i = fmul float %59, %60
  %sub14.i = fsub float %37, %mul8.i
  ...
  %67 = load float, ptr %arrayidx.i.i.i, align 4
  %68 = load float, ptr %arrayidx5.i20.i.i, align 4
  %69 = load float, ptr %arrayidx10.i23.i.i, align 4
  %70 = insertelement <2 x float> %64, float %68, i64 1
  %71 = insertelement <2 x float> %62, float %67, i64 1
  %72 = insertelement <2 x float> %66, float %69, i64 1
  %73 = insertelement <2 x float> poison, float %sub14.i, i64 0
  %74 = shufflevector <2 x float> %73, <2 x float> poison, <2 x i32> zeroinitializer
  %75 = load <2 x float>, ptr %m_origin.i.i, align 4
  %76 = load float, ptr %arrayidx.i26.i.i, align 4
  %77 = load float, ptr %arrayidx5.i27.i.i, align 4
  %78 = load float, ptr %arrayidx10.i30.i.i, align 4
  %79 = load float, ptr %arrayidx.i32.i.i, align 4
  ...
  %80 = load <2 x float>, ptr %m_normal.i.i, align 8
  ...
  %88 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %71, <2 x float> %87, <2 x float> %85)
  ...
  store <2 x float> %90, ptr %arrayidx35, align 4
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i108, ptr %ref.tmp25.sroa.4.0.arrayidx35.sroa_idx, align 4
  ...
  %normal = getelementptr inbounds %"struct.btGjkEpaSolver2::sResults", ptr %results, i64 0, i32 2
  store <2 x float> %93, ptr %normal, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i118, ptr %ref.tmp36.sroa.4.0.normal.sroa_idx, align 4
  %fneg = fneg float %59
  %distance = getelementptr inbounds %"struct.btGjkEpaSolver2::sResults", ptr %results, i64 0, i32 3
...
while.body.lr.ph:                                 ; preds = %while.cond.preheader
  ...
  %count.i349 = getelementptr inbounds %"struct.gjkepa2_impl::EPA", ptr %this, i64 0, i32 10, i32 1
  %count.i.promoted = load i32, ptr %count.i, align 8
  %count.i349.promoted = load i32, ptr %count.i349, align 8
  br label %while.body

while.body:                                       ; preds = %while.body.lr.ph, %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit
  %3 = phi i32 [ %count.i349.promoted, %while.body.lr.ph ], [ %inc.i, %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit ]
...
if.end17.i:                                       ; preds = %if.then10.i, %if.end.i
  %10 = load ptr, ptr %m_hull, align 8
...
if.then18.i:                                      ; preds = %if.end17.i
  ...
  store ptr %11, ptr %m_hull, align 8
...
_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit: ; preds = %if.end17.i, %if.then18.i
  ...
  %12 = load ptr, ptr %m_stock, align 8
  store ptr %12, ptr %arrayidx.i, align 8
  %13 = load ptr, ptr %m_stock, align 8
  %tobool.not.i345 = icmp eq ptr %13, null
  br i1 %tobool.not.i345, label %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit, label %if.then.i346

if.then.i346:                                     ; preds = %_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit
  %l5.i347 = getelementptr inbounds %"struct.gjkepa2_impl::EPA::sFace", ptr %13, i64 0, i32 5
  store ptr %5, ptr %l5.i347, align 8
  br label %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit

_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit: ; preds = %_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit, %if.then.i346
  store ptr %5, ptr %m_stock, align 8
  %inc.i = add i32 %3, 1
  %14 = load ptr, ptr %m_hull, align 8
...
while.cond.while.end_crit_edge:                   ; preds = %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit
  ...
  store i32 %inc.i, ptr %count.i349, align 8
  br label %while.end
...
while.end:                                        ; preds = %while.cond.while.end_crit_edge, %while.cond.preheader
  ...
  %25 = load float, ptr %arrayidx5.i351, align 4
  ...
  %26 = load float, ptr %arrayidx11.i354, align 4
  ...
  %29 = load float, ptr %arrayidx5.i363, align 4
  ...
  %30 = load float, ptr %arrayidx11.i366, align 4
...
if.end:                                           ; preds = %if.then29, %while.end
  ...
  %46 = load ptr, ptr %arrayidx20, align 8
  %47 = load ptr, ptr %arrayidx11, align 8
  ...
  %50 = load ptr, ptr %arrayidx20, align 8
  %51 = load ptr, ptr %arrayidx6, align 8
...
if.then69:                                        ; preds = %if.end
  ...
  %f.023.i = load ptr, ptr %f.0.in22.i, align 8
...
_ZN12gjkepa2_impl3EPA8findbestEv.exit:            ; preds = %for.body.i, %if.then69
  ...
  %outer.sroa.8629.0.copyload = load float, ptr %outer.sroa.8629.0.minf.0.lcssa.i.sroa_idx, align 8
  %outer.sroa.10.0.minf.0.lcssa.i.sroa_idx = getelementptr inbounds i8, ptr %minf.0.lcssa.i, i64 20
  %outer.sroa.10.0.copyload = load float, ptr %outer.sroa.10.0.minf.0.lcssa.i.sroa_idx, align 4
  ...
  %outer.sroa.17.0.copyload = load ptr, ptr %outer.sroa.17.0.minf.0.lcssa.i.sroa_idx, align 8
  ...
  store ptr %call50, ptr %arrayidx2.i378, align 8
  ...
  %count.i424 = getelementptr inbounds %"struct.gjkepa2_impl::EPA", ptr %this, i64 0, i32 10, i32 1
  br label %for.body

for.body:                                         ; preds = %_ZN12gjkepa2_impl3EPA8findbestEv.exit, %for.inc137
  %best.0702 = phi ptr [ %minf.0.lcssa.i, %_ZN12gjkepa2_impl3EPA8findbestEv.exit ], [ %minf.0.lcssa.i452, %for.inc137 ]
  ...
  %60 = load i32, ptr %m_nextsv, align 8
...
if.then87:                                        ; preds = %for.body
  ...
  %61 = load float, ptr %best.0702, align 4
  %62 = load float, ptr %w94, align 4
  ...
  %64 = load float, ptr %arrayidx7.i.i, align 8
  ...
  %66 = load float, ptr %arrayidx10.i.i, align 4
...
for.body101:                                      ; preds = %if.then87, %for.body101
  ...
  %72 = load i8, ptr %arrayidx106, align 1
...
if.then117:                                       ; preds = %for.cond.cleanup
  ...
  %76 = load ptr, ptr %arrayidx.i404, align 8
  %tobool.not.i405 = icmp eq ptr %76, null
  br i1 %tobool.not.i405, label %if.end.i408, label %if.then.i406

if.then.i406:                                     ; preds = %if.then117
  %77 = load ptr, ptr %l.i403, align 8
  %l5.i407 = getelementptr inbounds %"struct.gjkepa2_impl::EPA::sFace", ptr %76, i64 0, i32 5
  store ptr %77, ptr %l5.i407, align 8
  br label %if.end.i408

if.end.i408:                                      ; preds = %if.then.i406, %if.then117
  %78 = load ptr, ptr %l.i403, align 8
  %tobool9.not.i409 = icmp eq ptr %78, null
  br i1 %tobool9.not.i409, label %if.end17.i412, label %if.then10.i410

if.then10.i410:                                   ; preds = %if.end.i408
  %79 = load ptr, ptr %arrayidx.i404, align 8
  %arrayidx16.i411 = getelementptr inbounds %"struct.gjkepa2_impl::EPA::sFace", ptr %78, i64 0, i32 5, i64 1
  store ptr %79, ptr %arrayidx16.i411, align 8
  br label %if.end17.i412

if.end17.i412:                                    ; preds = %if.then10.i410, %if.end.i408
  %80 = load ptr, ptr %m_hull, align 8
  %cmp.i413 = icmp eq ptr %80, %best.0702
  br i1 %cmp.i413, label %if.then18.i416, label %_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit417

if.then18.i416:                                   ; preds = %if.end17.i412
  %81 = load ptr, ptr %arrayidx.i404, align 8
  store ptr %81, ptr %m_hull, align 8
  br label %_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit417

_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit417: ; preds = %if.end17.i412, %if.then18.i416
  %82 = load i32, ptr %count, align 8
  %dec.i415 = add i32 %82, -1
  store i32 %dec.i415, ptr %count, align 8
  store ptr null, ptr %l.i403, align 8
  %83 = load ptr, ptr %m_stock119, align 8
  store ptr %83, ptr %arrayidx.i404, align 8
  %84 = load ptr, ptr %m_stock119, align 8
  %tobool.not.i420 = icmp eq ptr %84, null
  br i1 %tobool.not.i420, label %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit426, label %if.then.i421

if.then.i421:                                     ; preds = %_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit417
  %l5.i422 = getelementptr inbounds %"struct.gjkepa2_impl::EPA::sFace", ptr %84, i64 0, i32 5
  store ptr %best.0702, ptr %l5.i422, align 8
  br label %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit426

_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit426: ; preds = %_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit417, %if.then.i421
  store ptr %best.0702, ptr %m_stock119, align 8
  %85 = load i32, ptr %count.i424, align 8
  %inc.i425 = add i32 %85, 1
  store i32 %inc.i425, ptr %count.i424, align 8
  %86 = load ptr, ptr %m_hull, align 8
  %f.0.in22.i428 = getelementptr inbounds %"struct.gjkepa2_impl::EPA::sFace", ptr %86, i64 0, i32 5, i64 1
  %f.023.i429 = load ptr, ptr %f.0.in22.i428, align 8
  %tobool.not24.i430 = icmp eq ptr %f.023.i429, null
  br i1 %tobool.not24.i430, label %_ZN12gjkepa2_impl3EPA8findbestEv.exit453, label %for.body.preheader.i431

for.body.preheader.i431:                          ; preds = %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit426
  %p.i432 = getelementptr inbounds %"struct.gjkepa2_impl::EPA::sFace", ptr %86, i64 0, i32 2
  %87 = load float, ptr %p.i432, align 4
  %d.i433 = getelementptr inbounds %"struct.gjkepa2_impl::EPA::sFace", ptr %86, i64 0, i32 1
  %88 = load float, ptr %d.i433, align 8
  %mul.i434 = fmul float %88, %88
  br label %for.body.i435

for.body.i435:                                    ; preds = %for.body.i435, %for.body.preheader.i431
  %f.028.i436 = phi ptr [ %f.0.i450, %for.body.i435 ], [ %f.023.i429, %for.body.preheader.i431 ]
  %minf.027.i437 = phi ptr [ %minf.1.i448, %for.body.i435 ], [ %86, %for.body.preheader.i431 ]
  %maxp.026.i438 = phi float [ %maxp.1.i447, %for.body.i435 ], [ %87, %for.body.preheader.i431 ]
  %mind.025.i439 = phi float [ %mind.1.i446, %for.body.i435 ], [ %mul.i434, %for.body.preheader.i431 ]
  %d3.i440 = getelementptr inbounds %"struct.gjkepa2_impl::EPA::sFace", ptr %f.028.i436, i64 0, i32 1
  %89 = load float, ptr %d3.i440, align 8
  %mul5.i441 = fmul float %89, %89
  %p6.i442 = getelementptr inbounds %"struct.gjkepa2_impl::EPA::sFace", ptr %f.028.i436, i64 0, i32 2
  %90 = load float, ptr %p6.i442, align 4
  ...
  %f.0.i450 = load ptr, ptr %f.0.in.i449, align 8
  %tobool.not.i451 = icmp eq ptr %f.0.i450, null
  br i1 %tobool.not.i451, label %_ZN12gjkepa2_impl3EPA8findbestEv.exit453, label %for.body.i435

_ZN12gjkepa2_impl3EPA8findbestEv.exit453:         ; preds = %for.body.i435, %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit426
  %minf.0.lcssa.i452 = phi ptr [ %86, %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit426 ], [ %minf.1.i448, %for.body.i435 ]
  %p121 = getelementptr inbounds %"struct.gjkepa2_impl::EPA::sFace", ptr %minf.0.lcssa.i452, i64 0, i32 2
...
if.then124:                                       ; preds = %_ZN12gjkepa2_impl3EPA8findbestEv.exit453
  %92 = load <4 x float>, ptr %minf.0.lcssa.i452, align 8
  %outer.sroa.8629.0.minf.0.lcssa.i452.sroa_idx = getelementptr inbounds i8, ptr %minf.0.lcssa.i452, i64 16
  %outer.sroa.8629.0.copyload630 = load float, ptr %outer.sroa.8629.0.minf.0.lcssa.i452.sroa_idx, align 8
  %outer.sroa.11.0.minf.0.lcssa.i452.sroa_idx = getelementptr inbounds i8, ptr %minf.0.lcssa.i452, i64 24
  %outer.sroa.11.0.copyload633 = load ptr, ptr %outer.sroa.11.0.minf.0.lcssa.i452.sroa_idx, align 8
  %outer.sroa.14.0.minf.0.lcssa.i452.sroa_idx = getelementptr inbounds i8, ptr %minf.0.lcssa.i452, i64 32
  %outer.sroa.14.0.copyload636 = load ptr, ptr %outer.sroa.14.0.minf.0.lcssa.i452.sroa_idx, align 8
  %outer.sroa.17.0.minf.0.lcssa.i452.sroa_idx = getelementptr inbounds i8, ptr %minf.0.lcssa.i452, i64 40
  %outer.sroa.17.0.copyload639 = load ptr, ptr %outer.sroa.17.0.minf.0.lcssa.i452.sroa_idx, align 8
  br label %for.inc137
...
cleanup248:                                       ; preds = %for.inc137, %if.else134, %cleanup
  ...
  store float %outer.sroa.8629.0676, ptr %m_depth, align 8
  ...
  %99 = load float, ptr %arrayidx5.i463, align 4
  ...
  %100 = load float, ptr %arrayidx11.i466, align 4
  ...
  %101 = load float, ptr %w172, align 4
  ...
  %102 = load float, ptr %arrayidx5.i475, align 4
  ...
  %103 = load float, ptr %arrayidx11.i478, align 4
  ...
  store float %sqrt.i, ptr %p179, align 8
  %112 = load float, ptr %w172, align 4
  %sub.i489 = fsub float %112, %mul.i454
  %113 = load float, ptr %arrayidx5.i475, align 4
  %sub8.i492 = fsub float %113, %mul4.i
  %114 = load float, ptr %arrayidx11.i478, align 4
  %sub14.i495 = fsub float %114, %mul8.i456
  %115 = load float, ptr %w191, align 4
  %sub.i501 = fsub float %115, %mul.i454
  %116 = load float, ptr %arrayidx5.i502, align 4
  %sub8.i504 = fsub float %116, %mul4.i
  %117 = load float, ptr %arrayidx11.i505, align 4
  ...
  store float %sqrt.i528, ptr %arrayidx199, align 4
  %126 = load float, ptr %w191, align 4
  %sub.i529 = fsub float %126, %mul.i454
  %127 = load float, ptr %arrayidx5.i502, align 4
  %sub8.i532 = fsub float %127, %mul4.i
  %128 = load float, ptr %arrayidx11.i505, align 4
  %sub14.i535 = fsub float %128, %mul8.i456
  %129 = load float, ptr %w166, align 4
  %sub.i541 = fsub float %129, %mul.i454
  %130 = load float, ptr %arrayidx5.i463, align 4
  %sub8.i544 = fsub float %130, %mul4.i
  %131 = load float, ptr %arrayidx11.i466, align 4
  ...
  store <2 x float> %144, ptr %p179, align 8
  %div239 = fdiv float %sqrt.i568, %add228
  store float %div239, ptr %arrayidx218, align 8
  %145 = load i32, ptr %this, align 8
  br label %cleanup286

if.end251:                                        ; preds = %if.end, %land.lhs.true, %entry
  store i32 8, ptr %this, align 8
  %146 = load <2 x float>, ptr %guess, align 4
  %arrayidx7.i570 = getelementptr inbounds [4 x float], ptr %guess, i64 0, i64 2
  %147 = load float, ptr %arrayidx7.i570, align 4
...
if.then260:                                       ; preds = %if.end251
  ...
  store <2 x float> %155, ptr %m_normal256, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i585, ptr %ref.tmp253.sroa.4.0.m_normal256.sroa_idx, align 8
  br label %if.end272
...
if.end272:                                        ; preds = %if.else266, %if.then260
  ...
  store float 0.000000e+00, ptr %m_depth273, align 8
  ...
  store i32 1, ptr %rank275, align 8
  %156 = load ptr, ptr %0, align 8
  store ptr %156, ptr %m_result274, align 8
  %p282 = getelementptr inbounds %"struct.gjkepa2_impl::EPA", ptr %this, i64 0, i32 1, i32 1
  store float 1.000000e+00, ptr %p282, align 8
  br label %cleanup286
...
invoke.cont5:
  ...
  store ptr getelementptr inbounds ({ [20 x ptr] }, ptr @_ZTV13btSphereShape, i64 0, inrange i32 0, i64 2), ptr %shape1, align 8
  ...
  store float 1.000000e+00, ptr %arrayidx3.i6.i.i.i.i, align 4
  ...
  store <2 x float> <float 1.000000e+00, float 0.000000e+00>, ptr %arrayidx5.i10.i.i.i.i, align 4
  ...
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 0.000000e+00>, ptr %ref.tmp10, align 16
...
for.cond.preheader:                               ; preds = %invoke.cont16
  ...
  %1 = load i32, ptr %rank357, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %invoke.cont58
  ...
  %4 = phi ptr [ %0, %for.body.lr.ph ], [ %89, %invoke.cont58 ]
  %w0.sroa.0.0362 = phi float [ 0.000000e+00, %for.body.lr.ph ], [ %add.i, %invoke.cont58 ]
  %w1.sroa.11.0361 = phi float [ 0.000000e+00, %for.body.lr.ph ], [ %add13.i237, %invoke.cont58 ]
  %5 = phi <2 x float> [ zeroinitializer, %for.body.lr.ph ], [ %21, %invoke.cont58 ]
  %6 = phi <2 x float> [ zeroinitializer, %for.body.lr.ph ], [ %88, %invoke.cont58 ]
...
memptr.virtual.i10.i:                             ; preds = %for.body
  %vtable.i11.i = load ptr, ptr %10, align 8
  %12 = add i64 %.unpack.i8.i, -1
  %13 = getelementptr i8, ptr %vtable.i11.i, i64 %12
  %memptr.virtualfn.i12.i = load ptr, ptr %13, align 8
...
_ZNK12gjkepa2_impl13MinkowskiDiff8Support0ERK9btVector3.exit.i: ; preds = %memptr.nonvirtual.i13.i, %memptr.virtual.i10.i
  %14 = phi ptr [ %memptr.virtualfn.i12.i, %memptr.virtual.i10.i ], [ %memptr.nonvirtualfn.i14.i, %memptr.nonvirtual.i13.i ]
...
invoke.cont52:                                    ; preds = %_ZNK12gjkepa2_impl13MinkowskiDiff8Support0ERK9btVector3.exit.i
  ...
  %ref.tmp31.sroa.0.0.vec.extract = extractelement <2 x float> %15, i64 0
  %mul.i = fmul float %7, %ref.tmp31.sroa.0.0.vec.extract
  %17 = insertelement <2 x float> poison, float %7, i64 0
  %18 = shufflevector <2 x float> %17, <2 x float> poison, <2 x i32> zeroinitializer
  %19 = shufflevector <2 x float> %15, <2 x float> %16, <2 x i32> <i32 1, i32 2>
  %20 = fmul <2 x float> %18, %19
  %add.i = fadd float %w0.sroa.0.0362, %mul.i
  %21 = fadd <2 x float> %5, %20
  %22 = load ptr, ptr %m_simplex, align 8
  %arrayidx49 = getelementptr inbounds [4 x ptr], ptr %22, i64 0, i64 %indvars.iv
  %23 = load ptr, ptr %arrayidx49, align 8
  %24 = load float, ptr %23, align 4
  %fneg.i = fneg float %24
  %arrayidx3.i209 = getelementptr inbounds [4 x float], ptr %23, i64 0, i64 1
  %25 = load float, ptr %arrayidx3.i209, align 4
  %fneg4.i = fneg float %25
  %arrayidx7.i210 = getelementptr inbounds [4 x float], ptr %23, i64 0, i64 2
  %26 = load float, ptr %arrayidx7.i210, align 4
  %fneg8.i = fneg float %26
  %27 = load ptr, ptr %arrayidx.i.i, align 8
  %.unpack.i.i = load i64, ptr %Ls.i7.i, align 8
  %.unpack9.i.i = load i64, ptr %.elt3.i.i, align 8
  %28 = getelementptr inbounds i8, ptr %27, i64 %.unpack9.i.i
  %29 = and i64 %.unpack.i.i, 1
  %memptr.isvirtual.not.i.i = icmp eq i64 %29, 0
  br i1 %memptr.isvirtual.not.i.i, label %memptr.nonvirtual.i.i, label %memptr.virtual.i.i

memptr.virtual.i.i:                               ; preds = %invoke.cont52
  %vtable.i.i = load ptr, ptr %28, align 8
  %30 = add i64 %.unpack.i.i, -1
  %31 = getelementptr i8, ptr %vtable.i.i, i64 %30
  %memptr.virtualfn.i.i = load ptr, ptr %31, align 8
...
_ZNK12gjkepa2_impl13MinkowskiDiff8Support1ERK9btVector3.exit.i: ; preds = %memptr.nonvirtual.i.i, %memptr.virtual.i.i
  %32 = phi ptr [ %memptr.virtualfn.i.i, %memptr.virtual.i.i ], [ %memptr.nonvirtualfn.i.i, %memptr.nonvirtual.i.i ]
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp2.i.i) #11
  %33 = load <4 x float>, ptr %m_toshape1.i.i, align 8
  %34 = shufflevector <4 x float> %33, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %35 = load <4 x float>, ptr %arrayidx5.i.i.i.i216, align 4
  %36 = shufflevector <4 x float> %35, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %37 = load <4 x float>, ptr %arrayidx10.i.i.i.i, align 8
  %38 = shufflevector <4 x float> %37, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %39 = load float, ptr %arrayidx.i.i.i.i, align 8
  %40 = load float, ptr %arrayidx5.i12.i.i.i, align 4
  %41 = load float, ptr %arrayidx10.i15.i.i.i, align 8
  %42 = insertelement <2 x float> %36, float %40, i64 1
  %43 = insertelement <2 x float> poison, float %fneg4.i, i64 0
  %44 = shufflevector <2 x float> %43, <2 x float> poison, <2 x i32> zeroinitializer
  %45 = fmul <2 x float> %42, %44
  %46 = insertelement <2 x float> %34, float %39, i64 1
  %47 = insertelement <2 x float> poison, float %fneg.i, i64 0
  %48 = shufflevector <2 x float> %47, <2 x float> poison, <2 x i32> zeroinitializer
  %49 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %46, <2 x float> %48, <2 x float> %45)
  %50 = insertelement <2 x float> %38, float %41, i64 1
  %51 = insertelement <2 x float> poison, float %fneg8.i, i64 0
  %52 = shufflevector <2 x float> %51, <2 x float> poison, <2 x i32> zeroinitializer
  %53 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %50, <2 x float> %52, <2 x float> %49)
  %54 = load float, ptr %arrayidx.i17.i.i.i, align 8
  %55 = load float, ptr %arrayidx5.i18.i.i.i, align 4
  %mul8.i20.i.i.i = fmul float %55, %fneg4.i
  %56 = call float @llvm.fmuladd.f32(float %54, float %fneg.i, float %mul8.i20.i.i.i)
  %57 = load float, ptr %arrayidx10.i21.i.i.i, align 8
  %58 = call float @llvm.fmuladd.f32(float %57, float %fneg8.i, float %56)
  %retval.sroa.3.12.vec.insert.i.i.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %58, i64 0
  store <2 x float> %53, ptr %ref.tmp2.i.i, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i.i, ptr %2, align 8
  %call3.i.i219 = invoke { <2 x float>, <2 x float> } %32(ptr noundef nonnull align 8 dereferenceable(24) %28, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp2.i.i)
...
invoke.cont58:                                    ; preds = %_ZNK12gjkepa2_impl13MinkowskiDiff8Support1ERK9btVector3.exit.i
  %59 = extractvalue { <2 x float>, <2 x float> } %call3.i.i219, 0
  %60 = extractvalue { <2 x float>, <2 x float> } %call3.i.i219, 1
  %61 = load <4 x float>, ptr %m_toshape0.i.i, align 8
  %62 = shufflevector <4 x float> %61, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %ref.tmp.sroa.0.0.vec.extract.i.i = extractelement <2 x float> %59, i64 0
  %63 = load <4 x float>, ptr %arrayidx5.i.i.i.i.i217, align 4
  %64 = shufflevector <4 x float> %63, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %ref.tmp.sroa.0.4.vec.extract.i.i = extractelement <2 x float> %59, i64 1
  %65 = load <4 x float>, ptr %arrayidx10.i.i.i.i.i218, align 8
  %66 = shufflevector <4 x float> %65, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %ref.tmp.sroa.5.8.vec.extract.i.i = extractelement <2 x float> %60, i64 0
  %67 = load float, ptr %arrayidx.i.i.i.i.i, align 8
  %68 = load float, ptr %arrayidx5.i20.i.i.i.i, align 4
  %69 = load float, ptr %arrayidx10.i23.i.i.i.i, align 8
  %70 = load float, ptr %arrayidx.i26.i.i.i.i, align 8
  %71 = load float, ptr %arrayidx5.i27.i.i.i.i, align 4
  %mul8.i29.i.i.i.i = fmul float %ref.tmp.sroa.0.4.vec.extract.i.i, %71
  %72 = call float @llvm.fmuladd.f32(float %70, float %ref.tmp.sroa.0.0.vec.extract.i.i, float %mul8.i29.i.i.i.i)
  %73 = load float, ptr %arrayidx10.i30.i.i.i.i, align 8
  %74 = call float @llvm.fmuladd.f32(float %73, float %ref.tmp.sroa.5.8.vec.extract.i.i, float %72)
  %75 = load float, ptr %arrayidx.i32.i.i.i.i, align 8
  %add17.i.i.i.i = fadd float %75, %74
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp2.i.i) #11
  %76 = shufflevector <2 x float> %59, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %77 = insertelement <2 x float> %64, float %68, i64 1
  %78 = fmul <2 x float> %76, %77
  %79 = insertelement <2 x float> %62, float %67, i64 1
  %80 = shufflevector <2 x float> %59, <2 x float> poison, <2 x i32> zeroinitializer
  %81 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %79, <2 x float> %80, <2 x float> %78)
  %82 = insertelement <2 x float> %66, float %69, i64 1
  ...
  %85 = load <2 x float>, ptr %m_origin.i.i.i.i, align 8
  %86 = fadd <2 x float> %85, %84
  %87 = fmul <2 x float> %18, %86
  %mul8.i225 = fmul float %7, %add17.i.i.i.i
  %88 = fadd <2 x float> %6, %87
  %add13.i237 = fadd float %w1.sroa.11.0361, %mul8.i225
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %89 = load ptr, ptr %m_simplex, align 8
  %rank = getelementptr inbounds %"struct.gjkepa2_impl::GJK::sSimplex", ptr %89, i64 0, i32 2
  %90 = load i32, ptr %rank, align 8
  %91 = zext i32 %90 to i64
  %cmp27 = icmp ult i64 %indvars.iv.next, %91
...
invoke.cont84:                                    ; preds = %invoke.cont84.loopexit, %for.cond.preheader
  %w1.sroa.0.0.lcssa = phi float [ 0.000000e+00, %for.cond.preheader ], [ %95, %invoke.cont84.loopexit ]
  %w1.sroa.7.0.lcssa = phi float [ 0.000000e+00, %for.cond.preheader ], [ %94, %invoke.cont84.loopexit ]
  %w1.sroa.11.0.lcssa = phi float [ 0.000000e+00, %for.cond.preheader ], [ %add13.i237, %invoke.cont84.loopexit ]
  %w0.sroa.0.0.lcssa = phi float [ 0.000000e+00, %for.cond.preheader ], [ %add.i, %invoke.cont84.loopexit ]
  %96 = phi <2 x float> [ zeroinitializer, %for.cond.preheader ], [ %21, %invoke.cont84.loopexit ]
  %97 = load <4 x float>, ptr %wtrs0, align 4
  %98 = shufflevector <4 x float> %97, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %arrayidx5.i.i.i = getelementptr inbounds [4 x float], ptr %wtrs0, i64 0, i64 1
  %99 = load <4 x float>, ptr %arrayidx5.i.i.i, align 4
  %100 = shufflevector <4 x float> %99, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %arrayidx10.i.i.i = getelementptr inbounds [4 x float], ptr %wtrs0, i64 0, i64 2
  %101 = load <4 x float>, ptr %arrayidx10.i.i.i, align 4
  %102 = shufflevector <4 x float> %101, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %m_origin.i.i = getelementptr inbounds %class.btTransform, ptr %wtrs0, i64 0, i32 1
  %arrayidx.i.i.i = getelementptr inbounds [3 x %class.btVector3], ptr %wtrs0, i64 0, i64 1
  %103 = load float, ptr %arrayidx.i.i.i, align 4
  %arrayidx5.i20.i.i = getelementptr inbounds [3 x %class.btVector3], ptr %wtrs0, i64 0, i64 1, i32 0, i64 1
  %104 = load float, ptr %arrayidx5.i20.i.i, align 4
  %arrayidx10.i23.i.i = getelementptr inbounds [3 x %class.btVector3], ptr %wtrs0, i64 0, i64 1, i32 0, i64 2
  %105 = load float, ptr %arrayidx10.i23.i.i, align 4
  %arrayidx.i26.i.i = getelementptr inbounds [3 x %class.btVector3], ptr %wtrs0, i64 0, i64 2
  %106 = load float, ptr %arrayidx.i26.i.i, align 4
  %arrayidx5.i27.i.i = getelementptr inbounds [3 x %class.btVector3], ptr %wtrs0, i64 0, i64 2, i32 0, i64 1
  %107 = load float, ptr %arrayidx5.i27.i.i, align 4
  %108 = extractelement <2 x float> %96, i64 0
  %mul8.i29.i.i = fmul float %108, %107
  %109 = call float @llvm.fmuladd.f32(float %106, float %w0.sroa.0.0.lcssa, float %mul8.i29.i.i)
  %arrayidx10.i30.i.i = getelementptr inbounds [3 x %class.btVector3], ptr %wtrs0, i64 0, i64 2, i32 0, i64 2
  %110 = load float, ptr %arrayidx10.i30.i.i, align 4
  %111 = extractelement <2 x float> %96, i64 1
  %112 = call float @llvm.fmuladd.f32(float %110, float %111, float %109)
  %arrayidx.i32.i.i = getelementptr inbounds %class.btTransform, ptr %wtrs0, i64 0, i32 1, i32 0, i64 2
  %113 = load float, ptr %arrayidx.i32.i.i, align 4
  %add17.i.i = fadd float %113, %112
  %retval.sroa.3.12.vec.insert.i.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add17.i.i, i64 0
  %witnesses = getelementptr inbounds %"struct.btGjkEpaSolver2::sResults", ptr %results, i64 0, i32 1
  ...
  %114 = shufflevector <2 x float> %96, <2 x float> poison, <2 x i32> zeroinitializer
  %115 = insertelement <2 x float> %100, float %104, i64 1
  %116 = fmul <2 x float> %114, %115
  %117 = insertelement <2 x float> %98, float %103, i64 1
  %118 = insertelement <2 x float> poison, float %w0.sroa.0.0.lcssa, i64 0
  %119 = shufflevector <2 x float> %118, <2 x float> poison, <2 x i32> zeroinitializer
  %120 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %117, <2 x float> %119, <2 x float> %116)
  %121 = insertelement <2 x float> %102, float %105, i64 1
  %122 = shufflevector <2 x float> %96, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %123 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %121, <2 x float> %122, <2 x float> %120)
  %124 = load <2 x float>, ptr %m_origin.i.i, align 4
  %125 = fadd <2 x float> %124, %123
  store <2 x float> %125, ptr %witnesses, align 4
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i, ptr %ref.tmp64.sroa.5.0.arrayidx69.sroa_idx, align 4
  %126 = load <4 x float>, ptr %wtrs0, align 4
  %127 = shufflevector <4 x float> %126, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %128 = load <4 x float>, ptr %arrayidx5.i.i.i, align 4
  %129 = shufflevector <4 x float> %128, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %130 = load <4 x float>, ptr %arrayidx10.i.i.i, align 4
  %131 = shufflevector <4 x float> %130, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %132 = load float, ptr %arrayidx.i.i.i, align 4
  %133 = load float, ptr %arrayidx5.i20.i.i, align 4
  %134 = insertelement <2 x float> poison, float %w1.sroa.7.0.lcssa, i64 0
  %135 = shufflevector <2 x float> %134, <2 x float> poison, <2 x i32> zeroinitializer
  %136 = insertelement <2 x float> %129, float %133, i64 1
  %137 = fmul <2 x float> %135, %136
  %138 = insertelement <2 x float> %127, float %132, i64 1
  %139 = insertelement <2 x float> poison, float %w1.sroa.0.0.lcssa, i64 0
  ...
  %142 = load float, ptr %arrayidx10.i23.i.i, align 4
  %143 = insertelement <2 x float> %131, float %142, i64 1
  %144 = insertelement <2 x float> poison, float %w1.sroa.11.0.lcssa, i64 0
  ...
  %149 = load float, ptr %arrayidx.i26.i.i, align 4
  %150 = load float, ptr %arrayidx5.i27.i.i, align 4
  %mul8.i29.i.i253 = fmul float %w1.sroa.7.0.lcssa, %150
  %151 = call float @llvm.fmuladd.f32(float %149, float %w1.sroa.0.0.lcssa, float %mul8.i29.i.i253)
  %152 = load float, ptr %arrayidx10.i30.i.i, align 4
  %153 = call float @llvm.fmuladd.f32(float %152, float %w1.sroa.11.0.lcssa, float %151)
  %154 = load float, ptr %arrayidx.i32.i.i, align 4
  %add17.i.i256 = fadd float %154, %153
  ...
  store <2 x float> %148, ptr %arrayidx77, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i259, ptr %ref.tmp71.sroa.5.0.arrayidx77.sroa_idx, align 4
  %155 = fsub <2 x float> %148, %125
...
invoke.cont105:                                   ; preds = %invoke.cont89
  ...
  %mul8.i.i.i270 = extractelement <2 x float> %156, i64 1
  %157 = extractelement <2 x float> %155, i64 0
  %158 = call float @llvm.fmuladd.f32(float %157, float %157, float %mul8.i.i.i270)
  %159 = call float @llvm.fmuladd.f32(float %sub14.i, float %sub14.i, float %158)
  %sqrt.i = call float @llvm.sqrt.f32(float %159)
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i276, ptr %ref.tmp96.sroa.5.0.normal.sroa_idx, align 4
  %mul8.i283 = fmul float %add, %mul8.i.i
  %160 = insertelement <2 x float> poison, float %div.i, i64 0
  %161 = shufflevector <2 x float> %160, <2 x float> poison, <2 x i32> zeroinitializer
  %162 = fmul <2 x float> %155, %161
  store <2 x float> %162, ptr %normal, align 4
  %163 = insertelement <2 x float> poison, float %add, i64 0
  %164 = shufflevector <2 x float> %163, <2 x float> poison, <2 x i32> zeroinitializer
  %165 = fmul <2 x float> %164, %162
  %166 = load <2 x float>, ptr %witnesses, align 4
  %167 = fadd <2 x float> %165, %166
  store <2 x float> %167, ptr %witnesses, align 4
  %168 = load float, ptr %ref.tmp64.sroa.5.0.arrayidx69.sroa_idx, align 4
  %add13.i295 = fadd float %mul8.i283, %168
  store float %add13.i295, ptr %ref.tmp64.sroa.5.0.arrayidx69.sroa_idx, align 4
...
invoke.cont135:                                   ; preds = %invoke.cont121
  ...
  %170 = load <2 x float>, ptr %witnesses125, align 4
  %171 = load <2 x float>, ptr %arrayidx128, align 4
  ...
  %173 = load float, ptr %arrayidx11.i300, align 4
  %arrayidx13.i301 = getelementptr inbounds %"struct.btGjkEpaSolver2::sResults", ptr %results, i64 0, i32 1, i64 1, i32 0, i64 2
  %174 = load float, ptr %arrayidx13.i301, align 4
  %sub14.i302 = fsub float %173, %174
  %175 = fmul <2 x float> %172, %172
  %mul8.i.i.i309 = extractelement <2 x float> %175, i64 1
  %176 = extractelement <2 x float> %172, i64 0
  %177 = call float @llvm.fmuladd.f32(float %176, float %176, float %mul8.i.i.i309)
  %178 = call float @llvm.fmuladd.f32(float %sub14.i302, float %sub14.i302, float %177)
  %sqrt.i311 = call float @llvm.sqrt.f32(float %178)
...
invoke.cont141:                                   ; preds = %invoke.cont135
  ...
  %179 = insertelement <2 x float> poison, float %div.i312, i64 0
  ...
  store <2 x float> %181, ptr %normal144, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i320, ptr %ref.tmp139.sroa.5.0.normal144.sroa_idx, align 4
  br label %if.end
...
ehcleanup153:                                     ; preds = %lpad51, %lpad35, %lpad88, %lpad14, %lpad120
  %.pn191.pn.pn.pn = phi { ptr, i32 } [ %182, %lpad120 ], [ %3, %lpad14 ], [ %93, %lpad51 ], [ %92, %lpad35 ], [ %169, %lpad88 ]
  call void @llvm.lifetime.end.p0(i64 464, ptr nonnull %gjk) #11
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %wtrs1) #11
...
if.then31:                                        ; preds = %if.else13.i, %if.then9.i, %if.then5.i, %if.then21
  %tobool33.not = phi i32 [ 2, %if.else13.i ], [ 0, %if.then9.i ], [ 2, %if.then5.i ], [ 0, %if.then21 ]
  %subm.1 = phi i32 [ 3, %if.else13.i ], [ 1, %if.then9.i ], [ 2, %if.then5.i ], [ 0, %if.then21 ]
  %subw.sroa.0.1 = phi float [ %sub.i165, %if.else13.i ], [ 1.000000e+00, %if.then9.i ], [ 0.000000e+00, %if.then5.i ], [ 0.000000e+00, %if.then21 ]
  %subw.sroa.7.1 = phi float [ %div.i, %if.else13.i ], [ 0.000000e+00, %if.then9.i ], [ 1.000000e+00, %if.then5.i ], [ 0.000000e+00, %if.then21 ]
  %retval.1.i = phi float [ %31, %if.else13.i ], [ %29, %if.then9.i ], [ %27, %if.then5.i ], [ -1.000000e+00, %if.then21 ]
  %and = and i32 %subm.1, 1
  %add = or i32 %and, %tobool33.not
  store i32 %add, ptr %m, align 4
  store float %subw.sroa.0.1, ptr %w, align 4
  %arrayidx44 = getelementptr inbounds float, ptr %w, i64 1
  store float %subw.sroa.7.1, ptr %arrayidx44, align 4
  %arrayidx48 = getelementptr inbounds float, ptr %w, i64 2
  store float 0.000000e+00, ptr %arrayidx48, align 4
  %.pre = load float, ptr %b, align 4
  %.pre291 = load float, ptr %arrayidx7.i, align 4
  %.pre292 = load float, ptr %arrayidx13.i, align 4
  %.pre294.pre = load float, ptr %c, align 4
  %.pre296.pre = load float, ptr %arrayidx7.i123, align 4
  %.pre298.pre = load float, ptr %arrayidx13.i126, align 4
  br label %for.inc

for.inc:                                          ; preds = %if.then31, %for.body.preheader
  %.pre298 = phi float [ %.pre298.pre, %if.then31 ], [ %8, %for.body.preheader ]
  %.pre296 = phi float [ %.pre296.pre, %if.then31 ], [ %7, %for.body.preheader ]
  %.pre294 = phi float [ %.pre294.pre, %if.then31 ], [ %6, %for.body.preheader ]
...
if.then21.1:                                      ; preds = %for.inc
  %sub.i.i.1 = fsub float %.pre294, %34
  %sub8.i.i.1 = fsub float %.pre296, %33
  %sub14.i.i.1 = fsub float %.pre298, %32
  %mul8.i.i.i.1 = fmul float %sub8.i.i.1, %sub8.i.i.1
  %43 = tail call float @llvm.fmuladd.f32(float %sub.i.i.1, float %sub.i.i.1, float %mul8.i.i.i.1)
  %44 = tail call float @llvm.fmuladd.f32(float %sub14.i.i.1, float %sub14.i.i.1, float %43)
  %cmp.i.1 = fcmp ogt float %44, 0.000000e+00
...
if.then.i.1:                                      ; preds = %if.then21.1
  ...
  %45 = tail call float @llvm.fmuladd.f32(float %34, float %sub.i.i.1, float %mul8.i.i38.i.1)
  %46 = tail call float @llvm.fmuladd.f32(float %32, float %sub14.i.i.1, float %45)
  %fneg.i.1 = fneg float %46
  %div.i.1 = fdiv float %fneg.i.1, %44
...
if.then5.i.1:                                     ; preds = %if.then.i.1
  %mul8.i.i41.i.1 = fmul float %.pre296, %.pre296
  %47 = tail call float @llvm.fmuladd.f32(float %.pre294, float %.pre294, float %mul8.i.i41.i.1)
  %48 = tail call float @llvm.fmuladd.f32(float %.pre298, float %.pre298, float %47)
...
if.then9.i.1:                                     ; preds = %if.else.i.1
  ...
  %49 = tail call float @llvm.fmuladd.f32(float %34, float %34, float %mul8.i.i44.i.1)
  %50 = tail call float @llvm.fmuladd.f32(float %32, float %32, float %49)
  br label %_ZN12gjkepa2_impl3GJK13projectoriginERK9btVector3S3_PfRj.exit.1
...
if.else13.i.1:                                    ; preds = %if.else.i.1
  ...
  %51 = tail call float @llvm.fmuladd.f32(float %add.i.i.1, float %add.i.i.1, float %mul8.i.i62.i.1)
  %52 = tail call float @llvm.fmuladd.f32(float %add14.i.i.1, float %add14.i.i.1, float %51)
  br label %_ZN12gjkepa2_impl3GJK13projectoriginERK9btVector3S3_PfRj.exit.1
...
_ZN12gjkepa2_impl3GJK13projectoriginERK9btVector3S3_PfRj.exit.1: ; preds = %if.else13.i.1, %if.then9.i.1, %if.then5.i.1, %if.then21.1
  ...
  %retval.1.i.1 = phi float [ %52, %if.else13.i.1 ], [ %50, %if.then9.i.1 ], [ %48, %if.then5.i.1 ], [ -1.000000e+00, %if.then21.1 ]
...
if.then31.1:                                      ; preds = %_ZN12gjkepa2_impl3GJK13projectoriginERK9btVector3S3_PfRj.exit.1
  ...
  store i32 %add.1, ptr %m, align 4
  %arrayidx41.1 = getelementptr inbounds float, ptr %w, i64 1
  store float %subw.sroa.0.1.1, ptr %arrayidx41.1, align 4
  %arrayidx44.1 = getelementptr inbounds float, ptr %w, i64 2
  store float %subw.sroa.7.1.1, ptr %arrayidx44.1, align 4
  store float 0.000000e+00, ptr %w, align 4
  %.pre293 = load float, ptr %c, align 4
  %.pre295 = load float, ptr %arrayidx7.i123, align 4
  %.pre297 = load float, ptr %arrayidx13.i126, align 4
  br label %for.inc.1

for.inc.1:                                        ; preds = %if.then31.1, %_ZN12gjkepa2_impl3GJK13projectoriginERK9btVector3S3_PfRj.exit.1, %for.inc
  %53 = phi float [ %.pre297, %if.then31.1 ], [ %.pre298, %_ZN12gjkepa2_impl3GJK13projectoriginERK9btVector3S3_PfRj.exit.1 ], [ %.pre298, %for.inc ]
  %54 = phi float [ %.pre295, %if.then31.1 ], [ %.pre296, %_ZN12gjkepa2_impl3GJK13projectoriginERK9btVector3S3_PfRj.exit.1 ], [ %.pre296, %for.inc ]
  %55 = phi float [ %.pre293, %if.then31.1 ], [ %.pre294, %_ZN12gjkepa2_impl3GJK13projectoriginERK9btVector3S3_PfRj.exit.1 ], [ %.pre294, %for.inc ]
  ...
  %mul8.i.i160.2 = fmul float %54, %59
  %62 = tail call float @llvm.fmuladd.f32(float %55, float %57, float %mul8.i.i160.2)
  %63 = tail call float @llvm.fmuladd.f32(float %53, float %61, float %62)
  %cmp20.2 = fcmp ogt float %63, 0.000000e+00
  br i1 %cmp20.2, label %if.then21.2, label %for.inc.2

if.then21.2:                                      ; preds = %for.inc.1
  %64 = load float, ptr %a, align 4
  %sub.i.i.2 = fsub float %64, %55
  %65 = load float, ptr %arrayidx5.i, align 4
  %sub8.i.i.2 = fsub float %65, %54
  %66 = load float, ptr %arrayidx11.i, align 4
  %sub14.i.i.2 = fsub float %66, %53
  %mul8.i.i.i.2 = fmul float %sub8.i.i.2, %sub8.i.i.2
  %67 = tail call float @llvm.fmuladd.f32(float %sub.i.i.2, float %sub.i.i.2, float %mul8.i.i.i.2)
  %68 = tail call float @llvm.fmuladd.f32(float %sub14.i.i.2, float %sub14.i.i.2, float %67)
  %cmp.i.2 = fcmp ogt float %68, 0.000000e+00
...
if.then.i.2:                                      ; preds = %if.then21.2
  %mul8.i.i38.i.2 = fmul float %54, %sub8.i.i.2
  %69 = tail call float @llvm.fmuladd.f32(float %55, float %sub.i.i.2, float %mul8.i.i38.i.2)
  %70 = tail call float @llvm.fmuladd.f32(float %53, float %sub14.i.i.2, float %69)
  %fneg.i.2 = fneg float %70
  %div.i.2 = fdiv float %fneg.i.2, %68
...
if.then5.i.2:                                     ; preds = %if.then.i.2
  %mul8.i.i41.i.2 = fmul float %65, %65
  %71 = tail call float @llvm.fmuladd.f32(float %64, float %64, float %mul8.i.i41.i.2)
...
if.then9.i.2:                                     ; preds = %if.else.i.2
  %mul8.i.i44.i.2 = fmul float %54, %54
  %73 = tail call float @llvm.fmuladd.f32(float %55, float %55, float %mul8.i.i44.i.2)
  %74 = tail call float @llvm.fmuladd.f32(float %53, float %53, float %73)
  br label %_ZN12gjkepa2_impl3GJK13projectoriginERK9btVector3S3_PfRj.exit.2
...
if.else13.i.2:                                    ; preds = %if.else.i.2
  ...
  %add.i.i.2 = fadd float %55, %mul.i.i.2
  %add8.i.i.2 = fadd float %54, %mul4.i.i.2
  %add14.i.i.2 = fadd float %53, %mul8.i.i166.2
  %mul8.i.i62.i.2 = fmul float %add8.i.i.2, %add8.i.i.2
  %75 = tail call float @llvm.fmuladd.f32(float %add.i.i.2, float %add.i.i.2, float %mul8.i.i62.i.2)
  %76 = tail call float @llvm.fmuladd.f32(float %add14.i.i.2, float %add14.i.i.2, float %75)
  br label %_ZN12gjkepa2_impl3GJK13projectoriginERK9btVector3S3_PfRj.exit.2
...
_ZN12gjkepa2_impl3GJK13projectoriginERK9btVector3S3_PfRj.exit.2: ; preds = %if.else13.i.2, %if.then9.i.2, %if.then5.i.2, %if.then21.2
  ...
  %retval.1.i.2 = phi float [ %76, %if.else13.i.2 ], [ %74, %if.then9.i.2 ], [ %72, %if.then5.i.2 ], [ -1.000000e+00, %if.then21.2 ]
...
if.then31.2:                                      ; preds = %_ZN12gjkepa2_impl3GJK13projectoriginERK9btVector3S3_PfRj.exit.2
  ...
  store i32 %add.2, ptr %m, align 4
  %arrayidx41.2 = getelementptr inbounds float, ptr %w, i64 2
  store float %subw.sroa.0.1.2, ptr %arrayidx41.2, align 4
  store float %subw.sroa.7.1.2, ptr %w, align 4
  %arrayidx48.2 = getelementptr inbounds float, ptr %w, i64 1
  store float 0.000000e+00, ptr %arrayidx48.2, align 4
  br label %for.inc.2
...
if.then51:                                        ; preds = %for.inc.2
  %77 = load float, ptr %a, align 4
  %78 = load float, ptr %arrayidx5.i, align 4
  %mul8.i.i169 = fmul float %12, %78
  %79 = tail call float @llvm.fmuladd.f32(float %77, float %10, float %mul8.i.i169)
  %80 = load float, ptr %arrayidx11.i, align 4
  %81 = tail call float @llvm.fmuladd.f32(float %80, float %14, float %79)
  %sqrt = tail call float @llvm.sqrt.f32(float %16)
  %div = fdiv float %81, %16
  %mul.i = fmul float %10, %div
  %mul4.i = fmul float %12, %div
  %mul8.i = fmul float %14, %div
  %mul8.i.i179 = fmul float %mul4.i, %mul4.i
  %82 = tail call float @llvm.fmuladd.f32(float %mul.i, float %mul.i, float %mul8.i.i179)
  %83 = tail call float @llvm.fmuladd.f32(float %mul8.i, float %mul8.i, float %82)
  store i32 7, ptr %m, align 4
  %84 = load float, ptr %b, align 4
  %sub.i181 = fsub float %84, %mul.i
  %85 = load float, ptr %arrayidx7.i, align 4
  %sub8.i184 = fsub float %85, %mul4.i
  %86 = load float, ptr %arrayidx13.i, align 4
  %sub14.i187 = fsub float %86, %mul8.i
  %neg.i.i197 = fmul float %sub8.i184, %35
  %87 = tail call float @llvm.fmuladd.f32(float %sub8.i124, float %sub14.i187, float %neg.i.i197)
  %neg19.i.i198 = fmul float %sub14.i187, %37
  %88 = tail call float @llvm.fmuladd.f32(float %sub14.i127, float %sub.i181, float %neg19.i.i198)
  %neg30.i.i199 = fmul float %sub.i181, %39
  %89 = tail call float @llvm.fmuladd.f32(float %sub.i121, float %sub8.i184, float %neg30.i.i199)
  %mul8.i.i.i205 = fmul float %88, %88
  %90 = tail call float @llvm.fmuladd.f32(float %87, float %87, float %mul8.i.i.i205)
  %91 = tail call float @llvm.fmuladd.f32(float %89, float %89, float %90)
  %sqrt.i = tail call float @llvm.sqrt.f32(float %91)
  %div66 = fdiv float %sqrt.i, %sqrt
  store float %div66, ptr %w, align 4
  %92 = load float, ptr %c, align 4
  %sub.i206 = fsub float %92, %mul.i
  %93 = load float, ptr %arrayidx7.i123, align 4
  %sub8.i209 = fsub float %93, %mul4.i
  %94 = load float, ptr %arrayidx13.i126, align 4
  %sub14.i212 = fsub float %94, %mul8.i
  %neg.i.i222 = fmul float %sub8.i209, %56
  %95 = tail call float @llvm.fmuladd.f32(float %sub8.i136, float %sub14.i212, float %neg.i.i222)
  %neg19.i.i223 = fmul float %sub14.i212, %58
  %96 = tail call float @llvm.fmuladd.f32(float %sub14.i139, float %sub.i206, float %neg19.i.i223)
  %neg30.i.i224 = fmul float %sub.i206, %60
  %97 = tail call float @llvm.fmuladd.f32(float %sub.i133, float %sub8.i209, float %neg30.i.i224)
  %mul8.i.i.i231 = fmul float %96, %96
  %98 = tail call float @llvm.fmuladd.f32(float %95, float %95, float %mul8.i.i.i231)
  %99 = tail call float @llvm.fmuladd.f32(float %97, float %97, float %98)
  %sqrt.i233 = tail call float @llvm.sqrt.f32(float %99)
...
cleanup:                                          ; preds = %for.inc.2, %if.then51, %entry
  %retval.0 = phi float [ -1.000000e+00, %entry ], [ %83, %if.then51 ], [ %mindist.2.2, %for.inc.2 ]
  ret float %retval.0
}
...
if.then44.1:                                      ; preds = %if.then36.1
  ...
  store i32 %add56.1, ptr %m, align 4
  %arrayidx59.1 = getelementptr inbounds float, ptr %w, i64 1
  %59 = load <2 x float>, ptr %subw, align 8
  store <2 x float> %59, ptr %arrayidx59.1, align 4
  store float 0.000000e+00, ptr %w, align 4
  %60 = load float, ptr %arrayidx67, align 8
  store float %60, ptr %arrayidx68, align 4
  br label %if.end69.1
...
if.then44.2:                                      ; preds = %if.then36.2
  ...
  store i32 %add56.2, ptr %m, align 4
  %73 = load float, ptr %subw, align 8
  %arrayidx59.2 = getelementptr inbounds float, ptr %w, i64 2
  store float %73, ptr %arrayidx59.2, align 4
  %74 = load float, ptr %arrayidx60, align 4
  store float %74, ptr %w, align 4
  %arrayidx66.2 = getelementptr inbounds float, ptr %w, i64 1
  store float 0.000000e+00, ptr %arrayidx66.2, align 4
  %75 = load float, ptr %arrayidx67, align 8
  store float %75, ptr %arrayidx68, align 4
  br label %if.end69.2
...
if.then71:                                        ; preds = %if.end69.2
  ...
  %76 = load float, ptr %arrayidx5.i156, align 4
  %77 = load float, ptr %arrayidx11.i147, align 4
  %mul.i213 = fmul float %76, %77
  %78 = load float, ptr %d, align 4
  %79 = load float, ptr %arrayidx11.i159, align 4
  %80 = load float, ptr %b, align 4
  %mul6.i215 = fmul float %79, %80
  %81 = load float, ptr %arrayidx7.i, align 4
  %mul8.i217 = fmul float %mul6.i215, %81
  %82 = call float @llvm.fmuladd.f32(float %mul.i213, float %78, float %mul8.i217)
  %83 = load float, ptr %c, align 4
  %84 = fneg float %83
  ...
  %89 = load float, ptr %arrayidx5.i144, align 4
  ...
  %106 = load float, ptr %arrayidx5.i156, align 4
...
entry:
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i, ptr %ref.tmp.sroa.4.0.d4.sroa_idx, align 4
...
memptr.virtual.i.i:                               ; preds = %entry
  ...
  %13 = getelementptr i8, ptr %vtable.i.i, i64 %12
  %memptr.virtualfn.i.i = load ptr, ptr %13, align 8
  br label %_ZNK12gjkepa2_impl13MinkowskiDiff8Support0ERK9btVector3.exit.i
...
_ZNK12gjkepa2_impl13MinkowskiDiff8Support0ERK9btVector3.exit.i: ; preds = %memptr.nonvirtual.i.i, %memptr.virtual.i.i
  ...
  %16 = load float, ptr %arrayidx3.i.i12, align 4
  %17 = load float, ptr %ref.tmp.sroa.4.0.d4.sroa_idx, align 4
  %arrayidx.i.i = getelementptr inbounds [2 x ptr], ptr %this, i64 0, i64 1
  %18 = load ptr, ptr %arrayidx.i.i, align 8
  %.unpack.i13.i = load i64, ptr %Ls.i.i, align 8
  %.unpack9.i.i = load i64, ptr %.elt3.i.i, align 8
  %19 = getelementptr inbounds i8, ptr %18, i64 %.unpack9.i.i
  %20 = and i64 %.unpack.i13.i, 1
  %memptr.isvirtual.not.i14.i = icmp eq i64 %20, 0
  br i1 %memptr.isvirtual.not.i14.i, label %memptr.nonvirtual.i18.i, label %memptr.virtual.i15.i

memptr.virtual.i15.i:                             ; preds = %_ZNK12gjkepa2_impl13MinkowskiDiff8Support0ERK9btVector3.exit.i
  %vtable.i16.i = load ptr, ptr %19, align 8
  %21 = add i64 %.unpack.i13.i, -1
  %22 = getelementptr i8, ptr %vtable.i16.i, i64 %21
  %memptr.virtualfn.i17.i = load ptr, ptr %22, align 8
  br label %_ZNK12gjkepa2_impl13MinkowskiDiff7SupportERK9btVector3.exit

memptr.nonvirtual.i18.i:                          ; preds = %_ZNK12gjkepa2_impl13MinkowskiDiff8Support0ERK9btVector3.exit.i
  %memptr.nonvirtualfn.i19.i = inttoptr i64 %.unpack.i13.i to ptr
  br label %_ZNK12gjkepa2_impl13MinkowskiDiff7SupportERK9btVector3.exit

_ZNK12gjkepa2_impl13MinkowskiDiff7SupportERK9btVector3.exit: ; preds = %memptr.virtual.i15.i, %memptr.nonvirtual.i18.i
  %23 = phi ptr [ %memptr.virtualfn.i17.i, %memptr.virtual.i15.i ], [ %memptr.nonvirtualfn.i19.i, %memptr.nonvirtual.i18.i ]
  ...
  %33 = load float, ptr %arrayidx5.i12.i.i.i, align 4
  ...
  %34 = load float, ptr %arrayidx10.i15.i.i.i, align 8
  ...
  %47 = load float, ptr %arrayidx.i17.i.i.i, align 8
  ...
  %48 = load float, ptr %arrayidx5.i18.i.i.i, align 4
  ...
  %50 = load float, ptr %arrayidx10.i21.i.i.i, align 8
  ...
  %57 = load <4 x float>, ptr %arrayidx5.i.i.i.i.i, align 4
  ...
  %59 = load <4 x float>, ptr %arrayidx10.i.i.i.i.i, align 8
  ...
  %62 = load float, ptr %arrayidx5.i20.i.i.i.i, align 4
  ...
  %65 = load float, ptr %arrayidx5.i27.i.i.i.i, align 4
  %mul8.i29.i.i.i.i = fmul float %ref.tmp.sroa.0.4.vec.extract.i.i, %65
  %66 = call float @llvm.fmuladd.f32(float %64, float %ref.tmp.sroa.0.0.vec.extract.i.i, float %mul8.i29.i.i.i.i)
  ...
  %67 = load float, ptr %arrayidx10.i30.i.i.i.i, align 8
  %68 = call float @llvm.fmuladd.f32(float %67, float %ref.tmp.sroa.5.8.vec.extract.i.i, float %66)
  %arrayidx.i32.i.i.i.i = getelementptr inbounds %"struct.gjkepa2_impl::MinkowskiDiff", ptr %this, i64 0, i32 2, i32 1, i32 0, i64 2
  %69 = load float, ptr %arrayidx.i32.i.i.i.i, align 8
  %add17.i.i.i.i = fadd float %69, %68
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp2.i.i) #11
  %70 = insertelement <2 x float> %58, float %62, i64 1
  %71 = shufflevector <2 x float> %53, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %72 = fmul <2 x float> %70, %71
  %73 = insertelement <2 x float> %56, float %61, i64 1
  %74 = shufflevector <2 x float> %53, <2 x float> poison, <2 x i32> zeroinitializer
  %75 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %73, <2 x float> %74, <2 x float> %72)
  %76 = insertelement <2 x float> %60, float %63, i64 1
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i23.i, ptr %ref.tmp5.sroa.4.0.w.sroa_idx, align 4
  ret void
}
...
for.cond.preheader:                               ; preds = %entry
  ...
  store float 1.000000e+00, ptr %axis, align 8
  ...
  %4 = load i32, ptr %m_nfree.i, align 8
  %dec.i = add i32 %4, -1
  ...
  %5 = load ptr, ptr %arrayidx3.i165, align 8
  %arrayidx6.i = getelementptr inbounds [4 x ptr], ptr %0, i64 0, i64 1
  store ptr %5, ptr %arrayidx6.i, align 8
  store i32 2, ptr %rank, align 8
...
if.end:                                           ; preds = %for.cond.preheader
  ...
  %14 = load i32, ptr %rank.i176, align 8
  ...
  store float 0.000000e+00, ptr %arrayidx.i178, align 4
  store i32 %9, ptr %m_nfree.i, align 8
  %arrayidx6.i183 = getelementptr inbounds [4 x ptr], ptr %10, i64 0, i64 %idxprom.i177
  store ptr %8, ptr %arrayidx6.i183, align 8
  %inc.i184 = add i32 %14, 1
  store i32 %inc.i184, ptr %rank.i176, align 8
...
if.end12:                                         ; preds = %if.end
  ...
  store ptr %17, ptr %arrayidx3.i192, align 8
  ...
  store float 0.000000e+00, ptr %arrayidx.i.1, align 4
  store i32 %18, ptr %m_nfree.i, align 8
  %arrayidx6.i.1 = getelementptr inbounds [4 x ptr], ptr %19, i64 0, i64 %idxprom.i.1
  store ptr %17, ptr %arrayidx6.i.1, align 8
  %inc.i.1 = add i32 %20, 1
  store i32 %inc.i.1, ptr %rank.i.1, align 8
...
if.end.1:                                         ; preds = %if.end12
  ...
  %22 = load i32, ptr %rank.i166.1, align 8
  %dec.i167.1 = add i32 %22, -1
  store i32 %dec.i167.1, ptr %rank.i166.1, align 8
  %idxprom.i168.1 = zext i32 %dec.i167.1 to i64
  %arrayidx.i169.1 = getelementptr inbounds [4 x ptr], ptr %21, i64 0, i64 %idxprom.i168.1
  %23 = load ptr, ptr %arrayidx.i169.1, align 8
  %24 = load i32, ptr %m_nfree.i, align 8
  ...
  store ptr %23, ptr %arrayidx3.i173.1, align 8
  %25 = load ptr, ptr %m_simplex, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp8) #11
  %26 = load <2 x float>, ptr %axis, align 8
  ...
  %29 = load i32, ptr %rank.i176.1, align 8
  ...
  store float 0.000000e+00, ptr %arrayidx.i178.1, align 4
  store i32 %24, ptr %m_nfree.i, align 8
  %arrayidx6.i183.1 = getelementptr inbounds [4 x ptr], ptr %25, i64 0, i64 %idxprom.i177.1
  store ptr %23, ptr %arrayidx6.i183.1, align 8
  %inc.i184.1 = add i32 %29, 1
  store i32 %inc.i184.1, ptr %rank.i176.1, align 8
...
if.end12.1:                                       ; preds = %if.end.1
  ...
  store float 0.000000e+00, ptr %arrayidx.i.2, align 4
  store i32 %33, ptr %m_nfree.i, align 8
  %arrayidx6.i.2 = getelementptr inbounds [4 x ptr], ptr %34, i64 0, i64 %idxprom.i.2
  store ptr %32, ptr %arrayidx6.i.2, align 8
  %inc.i.2 = add i32 %35, 1
  store i32 %inc.i.2, ptr %rank.i.2, align 8
...
if.end.2:                                         ; preds = %if.end12.1
  ...
  store ptr %38, ptr %arrayidx3.i173.2, align 8
  %40 = load ptr, ptr %m_simplex, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp8) #11
  %41 = load <2 x float>, ptr %axis, align 8
  %42 = fneg <2 x float> %41
  %43 = load float, ptr %arrayidx5.i, align 8
  ...
  %44 = load i32, ptr %rank.i176.2, align 8
  ...
  store float 0.000000e+00, ptr %arrayidx.i178.2, align 4
  store i32 %39, ptr %m_nfree.i, align 8
  %arrayidx6.i183.2 = getelementptr inbounds [4 x ptr], ptr %40, i64 0, i64 %idxprom.i177.2
  store ptr %38, ptr %arrayidx6.i183.2, align 8
  %inc.i184.2 = add i32 %44, 1
  store i32 %inc.i184.2, ptr %rank.i176.2, align 8
...
if.end12.2:                                       ; preds = %if.end.2
  ...
  store ptr %47, ptr %arrayidx3.i192.2, align 8
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %axis) #11
  br label %sw.epilog
...
sw.bb16:                                          ; preds = %entry
  ...
  %53 = load <2 x float>, ptr %arrayidx5.i193, align 4
  %54 = load <2 x float>, ptr %arrayidx7.i194, align 4
...
if.then41:                                        ; preds = %sw.bb16
  ...
  store float 0.000000e+00, ptr %arrayidx.i206, align 4
  %71 = load i32, ptr %m_nfree.i207, align 8
  %dec.i208 = add i32 %71, -1
  store i32 %dec.i208, ptr %m_nfree.i207, align 8
  ...
  %72 = load ptr, ptr %arrayidx3.i210, align 8
  %arrayidx6.i211 = getelementptr inbounds [4 x ptr], ptr %69, i64 0, i64 %idxprom.i205
  store ptr %72, ptr %arrayidx6.i211, align 8
  %inc.i212 = add i32 %70, 1
  store i32 %inc.i212, ptr %rank.i204, align 8
...
if.end45:                                         ; preds = %if.then41
  ...
  %74 = load i32, ptr %rank.i213, align 8
  %dec.i214 = add i32 %74, -1
  store i32 %dec.i214, ptr %rank.i213, align 8
  %idxprom.i215 = zext i32 %dec.i214 to i64
  %arrayidx.i216 = getelementptr inbounds [4 x ptr], ptr %73, i64 0, i64 %idxprom.i215
  %75 = load ptr, ptr %arrayidx.i216, align 8
  %76 = load i32, ptr %m_nfree.i207, align 8
  ...
  store ptr %75, ptr %arrayidx3.i220, align 8
  %77 = load ptr, ptr %m_simplex, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp48) #11
  %78 = load <2 x float>, ptr %p, align 8
  %79 = fneg <2 x float> %78
  %80 = load float, ptr %59, align 8
  ...
  %81 = load i32, ptr %rank.i231, align 8
  ...
  store float 0.000000e+00, ptr %arrayidx.i233, align 4
  store i32 %76, ptr %m_nfree.i207, align 8
  %arrayidx6.i238 = getelementptr inbounds [4 x ptr], ptr %77, i64 0, i64 %idxprom.i232
  store ptr %75, ptr %arrayidx6.i238, align 8
  %inc.i239 = add i32 %81, 1
  store i32 %inc.i239, ptr %rank.i231, align 8
...
if.end53:                                         ; preds = %if.end45
  ...
  %83 = load i32, ptr %rank.i240, align 8
  %dec.i241 = add i32 %83, -1
  store i32 %dec.i241, ptr %rank.i240, align 8
  %idxprom.i242 = zext i32 %dec.i241 to i64
  %arrayidx.i243 = getelementptr inbounds [4 x ptr], ptr %82, i64 0, i64 %idxprom.i242
  %84 = load ptr, ptr %arrayidx.i243, align 8
  %85 = load i32, ptr %m_nfree.i207, align 8
  %inc.i245 = add i32 %85, 1
  store i32 %inc.i245, ptr %m_nfree.i207, align 8
  ...
  store ptr %84, ptr %arrayidx3.i247, align 8
  br label %cleanup56
...
if.then41.1:                                      ; preds = %cleanup56
  ...
  %94 = load i32, ptr %rank.i204.1, align 8
  ...
  store float 0.000000e+00, ptr %arrayidx.i206.1, align 4
  %95 = load i32, ptr %m_nfree.i207, align 8
  %dec.i208.1 = add i32 %95, -1
  store i32 %dec.i208.1, ptr %m_nfree.i207, align 8
  ...
  %96 = load ptr, ptr %arrayidx3.i210.1, align 8
  %arrayidx6.i211.1 = getelementptr inbounds [4 x ptr], ptr %93, i64 0, i64 %idxprom.i205.1
  store ptr %96, ptr %arrayidx6.i211.1, align 8
  %inc.i212.1 = add i32 %94, 1
  store i32 %inc.i212.1, ptr %rank.i204.1, align 8
...
if.end45.1:                                       ; preds = %if.then41.1
  ...
  %98 = load i32, ptr %rank.i213.1, align 8
  %dec.i214.1 = add i32 %98, -1
  store i32 %dec.i214.1, ptr %rank.i213.1, align 8
  %idxprom.i215.1 = zext i32 %dec.i214.1 to i64
  %arrayidx.i216.1 = getelementptr inbounds [4 x ptr], ptr %97, i64 0, i64 %idxprom.i215.1
  %99 = load ptr, ptr %arrayidx.i216.1, align 8
  %100 = load i32, ptr %m_nfree.i207, align 8
  ...
  store ptr %99, ptr %arrayidx3.i220.1, align 8
  %101 = load ptr, ptr %m_simplex, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp48) #11
  %102 = load <2 x float>, ptr %p, align 8
  %103 = fneg <2 x float> %102
  %104 = load float, ptr %59, align 8
  ...
  %105 = load i32, ptr %rank.i231.1, align 8
  ...
  store float 0.000000e+00, ptr %arrayidx.i233.1, align 4
  store i32 %100, ptr %m_nfree.i207, align 8
  %arrayidx6.i238.1 = getelementptr inbounds [4 x ptr], ptr %101, i64 0, i64 %idxprom.i232.1
  store ptr %99, ptr %arrayidx6.i238.1, align 8
  %inc.i239.1 = add i32 %105, 1
  store i32 %inc.i239.1, ptr %rank.i231.1, align 8
...
if.end53.1:                                       ; preds = %if.end45.1
  ...
  store ptr %108, ptr %arrayidx3.i247.1, align 8
...
if.then41.2:                                      ; preds = %cleanup56.1
  ...
  store float 0.000000e+00, ptr %arrayidx.i206.2, align 4
  %119 = load i32, ptr %m_nfree.i207, align 8
  %dec.i208.2 = add i32 %119, -1
  store i32 %dec.i208.2, ptr %m_nfree.i207, align 8
  ...
  %120 = load ptr, ptr %arrayidx3.i210.2, align 8
  %arrayidx6.i211.2 = getelementptr inbounds [4 x ptr], ptr %117, i64 0, i64 %idxprom.i205.2
  store ptr %120, ptr %arrayidx6.i211.2, align 8
  %inc.i212.2 = add i32 %118, 1
  store i32 %inc.i212.2, ptr %rank.i204.2, align 8
...
if.end45.2:                                       ; preds = %if.then41.2
  ...
  store ptr %123, ptr %arrayidx3.i220.2, align 8
  %125 = load ptr, ptr %m_simplex, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp48) #11
  %126 = load <2 x float>, ptr %p, align 8
  %127 = fneg <2 x float> %126
  %128 = load float, ptr %59, align 8
  ...
  %129 = load i32, ptr %rank.i231.2, align 8
  ...
  store float 0.000000e+00, ptr %arrayidx.i233.2, align 4
  store i32 %124, ptr %m_nfree.i207, align 8
  %arrayidx6.i238.2 = getelementptr inbounds [4 x ptr], ptr %125, i64 0, i64 %idxprom.i232.2
  store ptr %123, ptr %arrayidx6.i238.2, align 8
  %inc.i239.2 = add i32 %129, 1
  store i32 %inc.i239.2, ptr %rank.i231.2, align 8
...
if.end53.2:                                       ; preds = %if.end45.2
  ...
  store ptr %132, ptr %arrayidx3.i247.2, align 8
...
sw.bb68:                                          ; preds = %entry
  ...
  %134 = load ptr, ptr %arrayidx72, align 8
  ...
  %136 = load float, ptr %w73, align 4
  %137 = load float, ptr %w77, align 4
  ...
  %156 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %144, <2 x float> %150, <2 x float> %155)
  %157 = extractelement <2 x float> %144, i64 0
  %158 = fneg float %157
...
if.then95:                                        ; preds = %sw.bb68
  ...
  store float 0.000000e+00, ptr %arrayidx.i289, align 4
  %m_nfree.i290 = getelementptr inbounds %"struct.gjkepa2_impl::GJK", ptr %this, i64 0, i32 7
  %166 = load i32, ptr %m_nfree.i290, align 8
  %dec.i291 = add i32 %166, -1
  store i32 %dec.i291, ptr %m_nfree.i290, align 8
  ...
  %167 = load ptr, ptr %arrayidx3.i293, align 8
  %arrayidx6.i294 = getelementptr inbounds [4 x ptr], ptr %0, i64 0, i64 3
  store ptr %167, ptr %arrayidx6.i294, align 8
  store i32 4, ptr %rank, align 8
...
if.end99:                                         ; preds = %if.then95
  ...
  store ptr %170, ptr %arrayidx3.i303, align 8
  %172 = load ptr, ptr %m_simplex, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp102) #11
  %173 = load <2 x float>, ptr %n, align 8
  %174 = fneg <2 x float> %173
  %175 = load float, ptr %161, align 8
  ...
  %177 = load i32, ptr %rank.i314, align 8
  ...
  store float 0.000000e+00, ptr %arrayidx.i316, align 4
  store i32 %171, ptr %m_nfree.i290, align 8
  %arrayidx6.i321 = getelementptr inbounds [4 x ptr], ptr %172, i64 0, i64 %idxprom.i315
  store ptr %170, ptr %arrayidx6.i321, align 8
  %inc.i322 = add i32 %177, 1
  store i32 %inc.i322, ptr %rank.i314, align 8
...
if.end107:                                        ; preds = %if.end99
  ...
  store ptr %180, ptr %arrayidx3.i330, align 8
...
sw.bb113:                                         ; preds = %entry
  ...
  %183 = load ptr, ptr %arrayidx121, align 8
  %w122 = getelementptr inbounds %"struct.gjkepa2_impl::GJK::sSV", ptr %183, i64 0, i32 1
  %184 = load float, ptr %w118, align 4
  %185 = load float, ptr %w122, align 4
  ...
  %192 = load float, ptr %arrayidx5.i344, align 4
  ...
  %196 = load float, ptr %arrayidx5.i356, align 4
  ...
  %197 = load float, ptr %arrayidx11.i359, align 4
...
if.then10.i:                                      ; preds = %if.end.i
  ...
  store ptr %4, ptr %arrayidx16.i, align 8
  br label %if.end17.i

if.end17.i:                                       ; preds = %if.then10.i, %if.end.i
  %5 = load ptr, ptr %m_stock, align 8
  %cmp.i = icmp eq ptr %5, %0
  br i1 %cmp.i, label %if.then18.i, label %_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit

if.then18.i:                                      ; preds = %if.end17.i
  %6 = load ptr, ptr %arrayidx.i, align 8
  store ptr %6, ptr %m_stock, align 8
  br label %_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit
...
_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit: ; preds = %if.end17.i, %if.then18.i
  ...
  %m_hull = getelementptr inbounds %"struct.gjkepa2_impl::EPA", ptr %this, i64 0, i32 9
  store ptr null, ptr %l.i, align 8
  %8 = load ptr, ptr %m_hull, align 8
  store ptr %8, ptr %arrayidx.i, align 8
  %9 = load ptr, ptr %m_hull, align 8
  %tobool.not.i132 = icmp eq ptr %9, null
  br i1 %tobool.not.i132, label %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit, label %if.then.i133

if.then.i133:                                     ; preds = %_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit
  %l5.i134 = getelementptr inbounds %"struct.gjkepa2_impl::EPA::sFace", ptr %9, i64 0, i32 5
  store ptr %0, ptr %l5.i134, align 8
  br label %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit

_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit: ; preds = %_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit, %if.then.i133
  store ptr %0, ptr %m_hull, align 8
  %count.i136 = getelementptr inbounds %"struct.gjkepa2_impl::EPA", ptr %this, i64 0, i32 9, i32 1
  %10 = load i32, ptr %count.i136, align 8
  %inc.i = add i32 %10, 1
  store i32 %inc.i, ptr %count.i136, align 8
  ...
  %30 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %18, <2 x float> %24, <2 x float> %29)
  ...
  store <2 x float> %30, ptr %0, align 8
  %ref.tmp.sroa.4.0.n.sroa_idx = getelementptr inbounds i8, ptr %0, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i, ptr %ref.tmp.sroa.4.0.n.sroa_idx, align 8
  ...
  %39 = load float, ptr %w11, align 4
  %40 = load float, ptr %w, align 4
  %41 = load float, ptr %arrayidx7.i, align 4
  %42 = load float, ptr %arrayidx5.i, align 4
  %43 = load float, ptr %arrayidx13.i, align 4
  %44 = load float, ptr %arrayidx11.i, align 4
  %45 = fneg float %34
  %46 = fneg float %36
  %47 = fneg float %35
  %48 = load float, ptr %w13, align 4
  %49 = load float, ptr %arrayidx5.i138, align 4
  %50 = load float, ptr %arrayidx11.i141, align 4
  ...
  %61 = insertelement <2 x float> poison, float %43, i64 0
  %62 = insertelement <2 x float> %61, float %44, i64 1
  %63 = insertelement <2 x float> poison, float %44, i64 0
  %64 = insertelement <2 x float> %63, float %50, i64 1
  ...
  %76 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %75, <2 x float> %55, <2 x float> %73)
  %77 = insertelement <2 x float> poison, float %47, i64 0
  %78 = shufflevector <2 x float> %77, <2 x float> poison, <2 x i32> zeroinitializer
  %79 = fmul <2 x float> %55, %78
  %80 = shufflevector <2 x float> %30, <2 x float> poison, <2 x i32> zeroinitializer
  %81 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %80, <2 x float> %60, <2 x float> %79)
  %82 = fmul <2 x float> %57, %76
  %83 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %52, <2 x float> %70, <2 x float> %82)
...
if.then70:                                        ; preds = %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit
  ...
  store float %div74, ptr %d, align 8
  %div.i = fdiv float 1.000000e+00, %sqrt.i
  %97 = insertelement <2 x float> poison, float %div.i, i64 0
  %98 = shufflevector <2 x float> %97, <2 x float> poison, <2 x i32> zeroinitializer
  %99 = fmul <2 x float> %30, %98
  store <2 x float> %99, ptr %0, align 4
  %mul7.i.i = fmul float %34, %div.i
  store float %mul7.i.i, ptr %ref.tmp.sroa.4.0.n.sroa_idx, align 4
...
if.end83:                                         ; preds = %if.then70, %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit
  ...
  br i1 %tobool.not.i244, label %if.end.i247, label %if.then.i245

if.then.i245:                                     ; preds = %if.end83
  %101 = load ptr, ptr %l.i, align 8
  %l5.i246 = getelementptr inbounds %"struct.gjkepa2_impl::EPA::sFace", ptr %100, i64 0, i32 5
  store ptr %101, ptr %l5.i246, align 8
  br label %if.end.i247

if.end.i247:                                      ; preds = %if.then.i245, %if.end83
  %102 = load ptr, ptr %l.i, align 8
  %tobool9.not.i248 = icmp eq ptr %102, null
  br i1 %tobool9.not.i248, label %if.end17.i251, label %if.then10.i249

if.then10.i249:                                   ; preds = %if.end.i247
  %103 = load ptr, ptr %arrayidx.i, align 8
  %arrayidx16.i250 = getelementptr inbounds %"struct.gjkepa2_impl::EPA::sFace", ptr %102, i64 0, i32 5, i64 1
  store ptr %103, ptr %arrayidx16.i250, align 8
  br label %if.end17.i251

if.end17.i251:                                    ; preds = %if.then10.i249, %if.end.i247
  %104 = load ptr, ptr %m_hull, align 8
  %cmp.i252 = icmp eq ptr %104, %0
  br i1 %cmp.i252, label %if.then18.i255, label %_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit256

if.then18.i255:                                   ; preds = %if.end17.i251
  %105 = load ptr, ptr %arrayidx.i, align 8
  store ptr %105, ptr %m_hull, align 8
  br label %_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit256

_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit256: ; preds = %if.end17.i251, %if.then18.i255
  %106 = load i32, ptr %count.i136, align 8
  %dec.i254 = add i32 %106, -1
  store i32 %dec.i254, ptr %count.i136, align 8
  store ptr null, ptr %l.i, align 8
  %107 = load ptr, ptr %m_stock, align 8
  store ptr %107, ptr %arrayidx.i, align 8
  %108 = load ptr, ptr %m_stock, align 8
  %tobool.not.i259 = icmp eq ptr %108, null
  br i1 %tobool.not.i259, label %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit265, label %if.then.i260

if.then.i260:                                     ; preds = %_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit256
  %l5.i261 = getelementptr inbounds %"struct.gjkepa2_impl::EPA::sFace", ptr %108, i64 0, i32 5
  store ptr %0, ptr %l5.i261, align 8
  br label %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit265

_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit265: ; preds = %_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit256, %if.then.i260
  store ptr %0, ptr %m_stock, align 8
  %109 = load i32, ptr %count.i, align 8
  %inc.i264 = add i32 %109, 1
  store i32 %inc.i264, ptr %count.i, align 8
  br label %return
...
_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit: ; preds = %if.end17.i, %if.then18.i
  ...
  %m_stock = getelementptr inbounds %"struct.gjkepa2_impl::EPA", ptr %this, i64 0, i32 10
  store ptr null, ptr %l.i, align 8
  %26 = load ptr, ptr %m_stock, align 8
  store ptr %26, ptr %arrayidx.i91, align 8
  %27 = load ptr, ptr %m_stock, align 8
  %tobool.not.i94 = icmp eq ptr %27, null
  br i1 %tobool.not.i94, label %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit, label %if.then.i95

if.then.i95:                                      ; preds = %_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit
  %l5.i96 = getelementptr inbounds %"struct.gjkepa2_impl::EPA::sFace", ptr %27, i64 0, i32 5
  store ptr %f, ptr %l5.i96, align 8
  br label %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit

_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit: ; preds = %_ZN12gjkepa2_impl3EPA6removeERNS0_5sListEPNS0_5sFaceE.exit, %if.then.i95
  store ptr %f, ptr %m_stock, align 8
  %count.i98 = getelementptr inbounds %"struct.gjkepa2_impl::EPA", ptr %this, i64 0, i32 10, i32 1
  br label %return.sink.split

return.sink.split:                                ; preds = %if.end, %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit
  %count.i98.sink101 = phi ptr [ %count.i98, %_ZN12gjkepa2_impl3EPA6appendERNS0_5sListEPNS0_5sFaceE.exit ], [ %nf17, %if.end ]
  %28 = load i32, ptr %count.i98.sink101, align 8
  %inc.i = add i32 %28, 1
  store i32 %inc.i, ptr %count.i98.sink101, align 8
  br label %return
