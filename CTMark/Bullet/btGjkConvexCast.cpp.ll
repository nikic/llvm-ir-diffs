; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btGjkConvexCast.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btGjkConvexCast.cpp"
...
entry:
  ...
  %2 = load float, ptr %m_origin.i151, align 4
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_origin3.i, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i151, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx7.i.i185, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx5.i.i184, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx11.i.i187, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx9.i.i186, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_origin3.i189, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i153, i64 16, i1 false)
...
if.then:                                          ; preds = %entry
  ...
  %n.sroa.11.0.copyload = load float, ptr %n.sroa.11.0.m_normalOnBInWorld.sroa_idx, align 4
...
if.end39:                                         ; preds = %if.end
  ...
  %23 = load <2 x float>, ptr %m_origin.i151, align 4
  ...
  store <2 x float> %30, ptr %m_origin3.i, align 8
  ...
  store float %33, ptr %arrayidx20.i, align 8
  %34 = load <2 x float>, ptr %m_origin.i153, align 4
  %35 = load <2 x float>, ptr %m_origin.i152, align 4
  %36 = fmul <2 x float> %26, %35
  %37 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %29, <2 x float> %34, <2 x float> %36)
  store <2 x float> %37, ptr %m_origin3.i189, align 8
  %38 = load float, ptr %arrayidx13.i159, align 4
  %39 = load float, ptr %arrayidx11.i158, align 4
  %mul18.i209 = fmul float %sub, %39
  %40 = call float @llvm.fmuladd.f32(float %sub.i195, float %38, float %mul18.i209)
  store float %40, ptr %arrayidx20.i210, align 8
  call void @_ZN17btGjkPairDetector16getClosestPointsERKN36btDiscreteCollisionDetectorInterface17ClosestPointInputERNS0_6ResultEP12btIDebugDrawb(ptr noundef nonnull align 8 dereferenceable(96) %gjk, ptr noundef nonnull align 8 dereferenceable(144) %input, ptr noundef nonnull align 8 dereferenceable(8) %pointCollector, ptr noundef null, i1 noundef zeroext false)
...
cleanup:                                          ; preds = %if.then60
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %c.sroa.0, ptr noundef nonnull align 8 dereferenceable(16) %m_pointInWorld, i64 16, i1 false)
  %n.sroa.0.0.copyload225 = load float, ptr %m_normalOnBInWorld, align 8
  %n.sroa.11.0.copyload231 = load float, ptr %n.sroa.11.0.m_normalOnBInWorld.sroa_idx, align 4
  %n.sroa.14.0.copyload238 = load float, ptr %n.sroa.14.0.m_normalOnBInWorld.sroa_idx, align 8
  %cmp = fcmp ogt float %42, 0x3F50624DE0000000
  br i1 %cmp, label %while.body, label %while.end.loopexit

while.end.loopexit:                               ; preds = %cleanup
  %n.sroa.17.0.copyload245 = load float, ptr %n.sroa.17.0.m_normalOnBInWorld.sroa_idx, align 4
...
if.end77:                                         ; preds = %while.end
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_hitPoint80, ptr noundef nonnull align 4 dereferenceable(16) %c.sroa.0, i64 16, i1 false)
  br label %cleanup83
