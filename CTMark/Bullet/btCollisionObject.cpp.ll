; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btCollisionObject.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btCollisionObject.cpp"
...
entry:
  store ptr getelementptr inbounds ({ [6 x ptr] }, ptr @_ZTV17btCollisionObject, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  ...
  store i8 0, ptr %m_hasAnisotropicFriction, align 8
  ...
  store <2 x float> <float 0.000000e+00, float 5.000000e-01>, ptr %m_deactivationTime, align 8
  %m_restitution = getelementptr inbounds %class.btCollisionObject, ptr %this, i64 0, i32 17
  store float 0.000000e+00, ptr %m_restitution, align 8
...
define dso_local void @_ZN17btCollisionObjectD2Ev(ptr nocapture nonnull readnone align 8 %this) unnamed_addr #1 align 2 {
entry:
  ret void
}
...
entry:
  ...
  %0 = load i32, ptr %m_activationState1, align 4
  %1 = and i32 %0, -2
  %switch = icmp eq i32 %1, 4
  br i1 %switch, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  store i32 %newState, ptr %m_activationState1, align 4
  br label %if.end
...
_ZN17btCollisionObject18setActivationStateEi.exit: ; preds = %if.then, %if.then.i
  %m_deactivationTime = getelementptr inbounds %class.btCollisionObject, ptr %this, i64 0, i32 15
  store float 0.000000e+00, ptr %m_deactivationTime, align 8
  br label %if.end
