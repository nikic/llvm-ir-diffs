; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btMultiSapBroadphase.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btMultiSapBroadphase.cpp"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%class.btMultiSapBroadphase = type { %class.btBroadphaseInterface, %class.btAlignedObjectArray, ptr, ptr, ptr, i8, ptr, i32, [4 x i8], %class.btAlignedObjectArray.0 }
...
%class.btQuantizedBvh = type <{ ptr, %class.btVector3, %class.btVector3, %class.btVector3, i32, i32, i8, [7 x i8], %class.btAlignedObjectArray.8, %class.btAlignedObjectArray.8, %class.btAlignedObjectArray.12, %class.btAlignedObjectArray.12, i32, [4 x i8], %class.btAlignedObjectArray.16, i32, [4 x i8] }>
...
%"struct.btMultiSapBroadphase::btMultiSapProxy" = type { %struct.btBroadphaseProxy.base, [4 x i8], %class.btAlignedObjectArray.20, %class.btVector3, %class.btVector3, i32, [4 x i8] }
...
invoke.cont3:
  store ptr getelementptr inbounds ({ [15 x ptr] }, ptr @_ZTV20btMultiSapBroadphase, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  ...
  store ptr %pairCache, ptr %m_overlappingPairs, align 8
  %m_optimizedAabbTree = getelementptr inbounds %class.btMultiSapBroadphase, ptr %this, i64 0, i32 4
  store ptr null, ptr %m_optimizedAabbTree, align 8
  ...
  store i32 0, ptr %m_invalidPair, align 8
...
invoke.cont8:                                     ; preds = %invoke.cont7
  store ptr %call, ptr %m_overlappingPairs, align 8
  br label %if.end
...
invoke.cont12:                                    ; preds = %if.end
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTVZN20btMultiSapBroadphaseC1EiP22btOverlappingPairCacheE31btMultiSapOverlapFilterCallback, i64 0, inrange i32 0, i64 2), ptr %call13, align 8
  %m_filterCallback = getelementptr inbounds %class.btMultiSapBroadphase, ptr %this, i64 0, i32 6
  store ptr %call13, ptr %m_filterCallback, align 8
  %2 = load ptr, ptr %m_overlappingPairs, align 8
...
entry:
  store ptr getelementptr inbounds ({ [15 x ptr] }, ptr @_ZTV20btMultiSapBroadphase, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %m_ownsPairCache = getelementptr inbounds %class.btMultiSapBroadphase, ptr %this, i64 0, i32 5
  %0 = load i8, ptr %m_ownsPairCache, align 8
  %tobool.not = icmp eq i8 %0, 0
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %m_overlappingPairs = getelementptr inbounds %class.btMultiSapBroadphase, ptr %this, i64 0, i32 3
  %1 = load ptr, ptr %m_overlappingPairs, align 8
...
invoke.cont:                                      ; preds = %if.then
  %3 = load ptr, ptr %m_overlappingPairs, align 8
...
invoke.cont5:                                     ; preds = %if.end, %if.then3.i.i.i
  ...
  %7 = load ptr, ptr %m_data.i.i.i18, align 8
...
invoke.cont:                                      ; preds = %entry
  %m_optimizedAabbTree = getelementptr inbounds %class.btMultiSapBroadphase, ptr %this, i64 0, i32 4
  store ptr %call.i, ptr %m_optimizedAabbTree, align 8
...
for.body.lr.ph:                                   ; preds = %invoke.cont
  %1 = load ptr, ptr %m_optimizedAabbTree, align 8
...
for.cond.cleanup:                                 ; preds = %_ZN20btAlignedObjectArrayI18btQuantizedBvhNodeE9push_backERKS0_.exit, %invoke.cont
  %2 = load ptr, ptr %m_optimizedAabbTree, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %_ZN20btAlignedObjectArrayI18btQuantizedBvhNodeE9push_backERKS0_.exit
  ...
  %17 = insertelement <4 x float> <float poison, float poison, float poison, float 1.000000e+00>, float %11, i64 0
  %18 = load <2 x float>, ptr %arrayidx7.i.i, align 4
  %19 = load <2 x float>, ptr %arrayidx7.i44.i, align 4
  %20 = load <2 x float>, ptr %arrayidx5.i.i19, align 4
  %21 = fsub <2 x float> %20, %18
  %22 = fmul <2 x float> %19, %21
  %23 = shufflevector <2 x float> %18, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %24 = shufflevector <4 x float> %16, <4 x float> %23, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %25 = insertelement <4 x float> %24, float %11, i64 3
  %26 = fsub <4 x float> %15, %25
  %27 = fmul <4 x float> %15, %25
  %28 = shufflevector <4 x float> %26, <4 x float> %27, <4 x i32> <i32 0, i32 1, i32 2, i32 7>
  %29 = shufflevector <2 x float> %19, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %30 = shufflevector <4 x float> %17, <4 x float> %29, <4 x i32> <i32 0, i32 4, i32 5, i32 3>
  %31 = fmul <4 x float> %28, %30
  %32 = fadd <4 x float> %28, %30
  %33 = shufflevector <4 x float> %31, <4 x float> %32, <4 x i32> <i32 0, i32 1, i32 2, i32 7>
  %34 = fptoui <4 x float> %33 to <4 x i16>
  %35 = and <4 x i16> %34, <i16 -2, i16 -2, i16 -2, i16 poison>
  %36 = or <4 x i16> %34, <i16 poison, i16 poison, i16 poison, i16 1>
  %37 = shufflevector <4 x i16> %35, <4 x i16> %36, <4 x i32> <i32 0, i32 1, i32 2, i32 7>
  %38 = fadd <2 x float> %22, <float 1.000000e+00, float 1.000000e+00>
...
if.then.i:                                        ; preds = %for.body
  ...
  %mul.i.i34 = shl nsw i32 %41, 1
  %cond.i.i = select i1 %tobool.not.i.i, i32 1, i32 %mul.i.i34
...
_ZN20btAlignedObjectArrayI18btQuantizedBvhNodeE9push_backERKS0_.exit: ; preds = %for.body, %if.then.i, %_ZN20btAlignedObjectArrayI18btQuantizedBvhNodeE10deallocateEv.exit.i.i
  ...
  %idxprom.i32 = sext i32 %50 to i64
  %arrayidx.i33 = getelementptr inbounds %struct.btQuantizedBvhNode, ptr %51, i64 %idxprom.i32
  store <4 x i16> %37, ptr %arrayidx.i33, align 4
  %node.sroa.7.0.arrayidx.i33.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i33, i64 8
  store <2 x i16> %40, ptr %node.sroa.7.0.arrayidx.i33.sroa_idx, align 4
  %node.sroa.9.0.arrayidx.i33.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i33, i64 12
  %52 = trunc i64 %indvars.iv to i32
  store i32 %52, ptr %node.sroa.9.0.arrayidx.i33.sroa_idx, align 4
...
invoke.cont:
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_aabbMin.i, ptr noundef nonnull align 4 dereferenceable(16) %aabbMin, i64 16, i1 false)
  %m_aabbMax.i = getelementptr inbounds %"struct.btMultiSapBroadphase::btMultiSapProxy", ptr %call, i64 0, i32 4
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_aabbMax.i, ptr noundef nonnull align 4 dereferenceable(16) %aabbMax, i64 16, i1 false)
  %m_shapeType.i = getelementptr inbounds %"struct.btMultiSapBroadphase::btMultiSapProxy", ptr %call, i64 0, i32 5
  store i32 %shapeType, ptr %m_shapeType.i, align 8
  store ptr %call, ptr %m_multiSapParentProxy.i.i, align 8
...
for.body.lr.ph.i.i.i:                             ; preds = %_ZN20btAlignedObjectArrayIPN20btMultiSapBroadphase15btMultiSapProxyEE8allocateEi.exit.i.i
  %m_data.i.i.i8 = getelementptr inbounds %class.btMultiSapBroadphase, ptr %this, i64 0, i32 9, i32 5
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i.new
  ...
  %5 = load ptr, ptr %m_data.i.i.i8, align 8
  ...
  %7 = load ptr, ptr %m_data.i.i.i8, align 8
  ...
  %9 = load ptr, ptr %m_data.i.i.i8, align 8
  ...
  %11 = load ptr, ptr %m_data.i.i.i8, align 8
...
for.body.i.i.i.epil:                              ; preds = %_ZNK20btAlignedObjectArrayIPN20btMultiSapBroadphase15btMultiSapProxyEE4copyEiiPS2_.exit.i.i.loopexit.unr-lcssa, %for.body.i.i.i.epil
  ...
  %13 = load ptr, ptr %m_data.i.i.i8, align 8
  ...
  br i1 %epil.iter.cmp.not, label %_ZNK20btAlignedObjectArrayIPN20btMultiSapBroadphase15btMultiSapProxyEE4copyEiiPS2_.exit.i.i, label %for.body.i.i.i.epil
...
_ZNK20btAlignedObjectArrayIPN20btMultiSapBroadphase15btMultiSapProxyEE4copyEiiPS2_.exit.i.i: ; preds = %_ZNK20btAlignedObjectArrayIPN20btMultiSapBroadphase15btMultiSapProxyEE4copyEiiPS2_.exit.i.i.loopexit.unr-lcssa, %for.body.i.i.i.epil, %_ZN20btAlignedObjectArrayIPN20btMultiSapBroadphase15btMultiSapProxyEE8allocateEi.exit.i.i
  ...
  %m_ownsMemory.i.i.i7 = getelementptr inbounds %class.btMultiSapBroadphase, ptr %this, i64 0, i32 9, i32 6
  %16 = load i8, ptr %m_ownsMemory.i.i.i7, align 8
...
define dso_local void @_ZN20btMultiSapBroadphase12destroyProxyEP17btBroadphaseProxyP12btDispatcher(ptr nocapture nonnull readnone align 8 %this, ptr nocapture readnone %0, ptr nocapture readnone %1) unnamed_addr #7 align 2 {
entry:
  ret void
}
...
for.body.i.i.i.epil:                              ; preds = %_ZNK20btAlignedObjectArrayIPN20btMultiSapBroadphase13btBridgeProxyEE4copyEiiPS2_.exit.i.i.loopexit.unr-lcssa, %for.body.i.i.i.epil
  ...
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %_ZNK20btAlignedObjectArrayIPN20btMultiSapBroadphase13btBridgeProxyEE4copyEiiPS2_.exit.i.i, label %for.body.i.i.i.epil
...
entry:
  %0 = load float, ptr %amin, align 4
  %1 = load float, ptr %bmin, align 4
  %cmp = fcmp ult float %0, %1
  br i1 %cmp, label %land.end, label %land.lhs.true

land.lhs.true:                                    ; preds = %entry
  %2 = load float, ptr %amax, align 4
  %3 = load float, ptr %bmax, align 4
...
land.rhs:                                         ; preds = %land.lhs.true13
  ...
  %11 = load float, ptr %arrayidx.i34, align 4
...
entry:
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %aabbMin, ptr noundef nonnull align 8 dereferenceable(16) %m_aabbMin, i64 16, i1 false)
  %m_aabbMax = getelementptr inbounds %"struct.btMultiSapBroadphase::btMultiSapProxy", ptr %proxy, i64 0, i32 4
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %aabbMax, ptr noundef nonnull align 8 dereferenceable(16) %m_aabbMax, i64 16, i1 false)
  ret void
}
...
entry:
  ...
  %m_aabbMin = getelementptr inbounds %"struct.btMultiSapBroadphase::btMultiSapProxy", ptr %proxy, i64 0, i32 3
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_aabbMin, ptr noundef nonnull align 4 dereferenceable(16) %aabbMin, i64 16, i1 false)
  %m_aabbMax = getelementptr inbounds %"struct.btMultiSapBroadphase::btMultiSapProxy", ptr %proxy, i64 0, i32 4
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_aabbMax, ptr noundef nonnull align 4 dereferenceable(16) %aabbMax, i64 16, i1 false)
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %myNodeCallback) #16
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTVZN20btMultiSapBroadphase7setAabbEP17btBroadphaseProxyRK9btVector3S4_P12btDispatcherE21MyNodeOverlapCallback, i64 0, inrange i32 0, i64 2), ptr %myNodeCallback, align 8
  %m_multiSap.i = getelementptr inbounds %struct.MyNodeOverlapCallback, ptr %myNodeCallback, i64 0, i32 1
  store ptr %this, ptr %m_multiSap.i, align 8
  %m_multiProxy.i = getelementptr inbounds %struct.MyNodeOverlapCallback, ptr %myNodeCallback, i64 0, i32 2
  store ptr %proxy, ptr %m_multiProxy.i, align 8
  ...
  %m_optimizedAabbTree = getelementptr inbounds %class.btMultiSapBroadphase, ptr %this, i64 0, i32 4
  %0 = load ptr, ptr %m_optimizedAabbTree, align 8
...
for.cond40.preheader:                             ; preds = %if.end36
  %2 = icmp sgt i32 %29, 0
  br i1 %2, label %for.body45.lr.ph, label %for.end58
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end36
  ...
  %m_childBroadphase = getelementptr inbounds %"struct.btMultiSapBroadphase::btBridgeProxy", ptr %4, i64 0, i32 1
  %5 = load ptr, ptr %m_childBroadphase, align 8
  %vtable = load ptr, ptr %5, align 8
  %vfn = getelementptr inbounds ptr, ptr %vtable, i64 10
  %6 = load ptr, ptr %vfn, align 8
  call void %6(ptr noundef nonnull align 8 dereferenceable(8) %5, ptr noundef nonnull align 4 dereferenceable(16) %worldAabbMin, ptr noundef nonnull align 4 dereferenceable(16) %worldAabbMax)
  %7 = load float, ptr %worldAabbMin, align 4
  %8 = load float, ptr %m_aabbMax, align 4
  %cmp.i = fcmp ogt float %7, %8
  br i1 %cmp.i, label %cond.end.i, label %lor.lhs.false.i

lor.lhs.false.i:                                  ; preds = %for.body
  %9 = load float, ptr %worldAabbMax, align 4
  %10 = load float, ptr %m_aabbMin, align 4
  %cmp4.i = fcmp olt float %9, %10
...
cond.end.i:                                       ; preds = %cond.false.i, %lor.lhs.false.i, %for.body
  ...
  %12 = load float, ptr %arrayidx.i43.i, align 4
  %cmp7.i = fcmp ogt float %11, %12
  br i1 %cmp7.i, label %cond.end15.i, label %lor.lhs.false8.i

lor.lhs.false8.i:                                 ; preds = %cond.end.i
  %13 = load float, ptr %arrayidx.i44.i, align 4
  %14 = load float, ptr %arrayidx.i45.i, align 4
  %cmp11.i = fcmp olt float %13, %14
...
cond.end15.i:                                     ; preds = %cond.false13.i, %lor.lhs.false8.i, %cond.end.i
  ...
  %15 = load float, ptr %arrayidx.i46.i, align 4
  %16 = load float, ptr %arrayidx.i47.i, align 4
  %cmp20.i = fcmp ogt float %15, %16
  br i1 %cmp20.i, label %if.then19, label %lor.lhs.false21.i

lor.lhs.false21.i:                                ; preds = %cond.end15.i
  %17 = load float, ptr %arrayidx.i48.i, align 4
  %18 = load float, ptr %arrayidx.i49.i, align 4
  %cmp24.i = fcmp uge float %17, %18
...
if.then19:                                        ; preds = %lor.lhs.false21.i, %cond.end15.i
  ...
  %arrayidx.i97 = getelementptr inbounds ptr, ptr %19, i64 %indvars.iv
  %20 = load ptr, ptr %arrayidx.i97, align 8
  %21 = load ptr, ptr %20, align 8
  %m_childBroadphase24 = getelementptr inbounds %"struct.btMultiSapBroadphase::btBridgeProxy", ptr %20, i64 0, i32 1
  %22 = load ptr, ptr %m_childBroadphase24, align 8
  %vtable25 = load ptr, ptr %22, align 8
  %vfn26 = getelementptr inbounds ptr, ptr %vtable25, i64 3
  %23 = load ptr, ptr %vfn26, align 8
  call void %23(ptr noundef nonnull align 8 dereferenceable(8) %22, ptr noundef %21, ptr noundef %dispatcher)
  %24 = load i32, ptr %m_size.i, align 4
  %sub = add nsw i32 %24, -1
  %25 = load ptr, ptr %m_data.i, align 8
  %arrayidx.i101 = getelementptr inbounds ptr, ptr %25, i64 %indvars.iv
  %26 = load ptr, ptr %arrayidx.i101, align 8
  %idxprom3.i = sext i32 %sub to i64
  %arrayidx4.i = getelementptr inbounds ptr, ptr %25, i64 %idxprom3.i
  %27 = load ptr, ptr %arrayidx4.i, align 8
  store ptr %27, ptr %arrayidx.i101, align 8
  %28 = load ptr, ptr %m_data.i, align 8
  %arrayidx10.i = getelementptr inbounds ptr, ptr %28, i64 %idxprom3.i
  store ptr %26, ptr %arrayidx10.i, align 8
...
if.end36:                                         ; preds = %lor.lhs.false21.i.if.end36_crit_edge, %if.then19
  ...
  %29 = phi i32 [ %.pre, %lor.lhs.false21.i.if.end36_crit_edge ], [ %sub, %if.then19 ]
...
for.body45:                                       ; preds = %for.body45.lr.ph, %for.body45
  ...
  %30 = load ptr, ptr %m_data.i104, align 8
  %arrayidx.i106 = getelementptr inbounds ptr, ptr %30, i64 %indvars.iv113
  %31 = load ptr, ptr %arrayidx.i106, align 8
  %m_childBroadphase50 = getelementptr inbounds %"struct.btMultiSapBroadphase::btBridgeProxy", ptr %31, i64 0, i32 1
  %32 = load ptr, ptr %m_childBroadphase50, align 8
  %33 = load ptr, ptr %31, align 8
  %vtable52 = load ptr, ptr %32, align 8
  %vfn53 = getelementptr inbounds ptr, ptr %vtable52, i64 4
  %34 = load ptr, ptr %vfn53, align 8
  call void %34(ptr noundef nonnull align 8 dereferenceable(8) %32, ptr noundef %33, ptr noundef nonnull align 4 dereferenceable(16) %aabbMin, ptr noundef nonnull align 4 dereferenceable(16) %aabbMax, ptr noundef %dispatcher)
  %indvars.iv.next114 = add nuw nsw i64 %indvars.iv113, 1
  %35 = load i32, ptr %m_size.i, align 4
  %36 = sext i32 %35 to i64
  %cmp44 = icmp slt i64 %indvars.iv.next114, %36
...
define linkonce_odr dso_local void @_ZN21btNodeOverlapCallbackD2Ev(ptr noundef nonnull align 8 dereferenceable(8) %this) unnamed_addr #11 comdat align 2 {
entry:
  ret void
}
...
entry:
  ...
  %0 = load i8, ptr @stopUpdating, align 1
  %tobool.not = icmp eq i8 %0, 0
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %m_size.i.i = getelementptr inbounds %class.btAlignedObjectArray.4, ptr %call10, i64 0, i32 2
...
_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI37btMultiSapBroadphasePairSortPredicateEEvT_.exit: ; preds = %if.then, %if.then.i
  ...
  %m_invalidPair = getelementptr inbounds %class.btMultiSapBroadphase, ptr %this, i64 0, i32 7
  %7 = load i32, ptr %m_invalidPair, align 8
  %sub = sub nsw i32 %6, %7
...
for.body.lr.ph:                                   ; preds = %_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI37btMultiSapBroadphasePairSortPredicateEEvT_.exit
  %m_data.i = getelementptr inbounds %class.btAlignedObjectArray.4, ptr %call10, i64 0, i32 5
  br label %for.body
...
cond.true:                                        ; preds = %for.body
  ...
  %13 = load ptr, ptr %m_multiSapParentProxy, align 8
  br label %cond.end
...
cond.true20:                                      ; preds = %cond.end
  ...
  %15 = load ptr, ptr %m_multiSapParentProxy22, align 8
  br label %cond.end24
...
cond.true28:                                      ; preds = %cond.end24
  ...
  %16 = load ptr, ptr %m_multiSapParentProxy30, align 8
  br label %cond.end32
...
cond.true36:                                      ; preds = %cond.end32
  ...
  %17 = load ptr, ptr %m_multiSapParentProxy38, align 8
  br label %cond.end40
...
if.then45:                                        ; preds = %cond.end40
  ...
  %19 = load ptr, ptr %m_multiSapParentProxy.i, align 8
  %m_multiSapParentProxy2.i = getelementptr inbounds %struct.btBroadphaseProxy, ptr %14, i64 0, i32 4
  %20 = load ptr, ptr %m_multiSapParentProxy2.i, align 8
  ...
  %21 = load float, ptr %m_aabbMin.i, align 4
  %22 = load float, ptr %m_aabbMax4.i, align 4
...
lor.lhs.false.i.i:                                ; preds = %if.then45
  ...
  %23 = load float, ptr %m_aabbMax.i, align 4
  %24 = load float, ptr %m_aabbMin3.i, align 4
...
cond.end.i.i:                                     ; preds = %cond.false.i.i, %lor.lhs.false.i.i, %if.then45
  ...
  %26 = load float, ptr %arrayidx.i43.i.i, align 4
...
if.then55:                                        ; preds = %cond.end15.i.i, %lor.lhs.false21.i.i, %cond.end40
  %vtable56 = load ptr, ptr %this, align 8
  ...
  %35 = load i32, ptr %m_invalidPair, align 8
  %inc = add nsw i32 %35, 1
  store i32 %inc, ptr %m_invalidPair, align 8
  %36 = load i32, ptr @gOverlappingPairs, align 4
  %dec = add nsw i32 %36, -1
  store i32 %dec, ptr @gOverlappingPairs, align 4
  %.pre109 = load i32, ptr %m_size.i.i, align 4
  br label %if.end64
...
for.end:                                          ; preds = %if.end64
  ...
  br i1 %cmp.i96, label %if.then.i97, label %_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI37btMultiSapBroadphasePairSortPredicateEEvT_.exit99

if.then.i97:                                      ; preds = %for.end
  %sub.i98 = add nsw i32 %38, -1
  call void @_ZN20btAlignedObjectArrayI16btBroadphasePairE17quickSortInternalI37btMultiSapBroadphasePairSortPredicateEEvT_ii(ptr noundef nonnull align 8 dereferenceable(25) %call10, i32 noundef 0, i32 noundef %sub.i98)
  %.pre110 = load i32, ptr %m_size.i.i, align 4
  %.pre111 = load i32, ptr %m_invalidPair, align 8
  br label %_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI37btMultiSapBroadphasePairSortPredicateEEvT_.exit99

_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI37btMultiSapBroadphasePairSortPredicateEEvT_.exit99: ; preds = %_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI37btMultiSapBroadphasePairSortPredicateEEvT_.exit, %for.end, %if.then.i97
  %40 = phi i32 [ %37, %for.end ], [ %.pre111, %if.then.i97 ], [ 0, %_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI37btMultiSapBroadphasePairSortPredicateEEvT_.exit ]
  %41 = phi i32 [ %38, %for.end ], [ %.pre110, %if.then.i97 ], [ %8, %_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI37btMultiSapBroadphasePairSortPredicateEEvT_.exit ]
...
define linkonce_odr dso_local void @_ZN20btAlignedObjectArrayI16btBroadphasePairE6resizeEiRKS0_(ptr noundef nonnull align 8 dereferenceable(25) %this, i32 noundef %newsize, ptr noundef nonnull align 8 dereferenceable(32) %fillData) local_unnamed_addr #12 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
...
_ZNK20btAlignedObjectArrayI16btBroadphasePairE4copyEiiPS0_.exit.i: ; preds = %for.body.i.i, %_ZN20btAlignedObjectArrayI16btBroadphasePairE8allocateEi.exit.i
  %m_data.i9.i = getelementptr inbounds %class.btAlignedObjectArray.4, ptr %this, i64 0, i32 5
...
for.body10.lr.ph:                                 ; preds = %if.then5, %if.end
  %m_data11 = getelementptr inbounds %class.btAlignedObjectArray.4, ptr %this, i64 0, i32 5
...
define dso_local noundef zeroext i1 @_ZN20btMultiSapBroadphase15testAabbOverlapEP17btBroadphaseProxyS1_(ptr nocapture noundef nonnull readnone align 8 dereferenceable(120) %this, ptr nocapture noundef readonly %childProxy0, ptr nocapture noundef readonly %childProxy1) local_unnamed_addr #13 align 2 {
entry:
  %m_multiSapParentProxy = getelementptr inbounds %struct.btBroadphaseProxy, ptr %childProxy0, i64 0, i32 4
  %0 = load ptr, ptr %m_multiSapParentProxy, align 8
  %m_multiSapParentProxy2 = getelementptr inbounds %struct.btBroadphaseProxy, ptr %childProxy1, i64 0, i32 4
  %1 = load ptr, ptr %m_multiSapParentProxy2, align 8
  ...
  %2 = load float, ptr %m_aabbMin, align 4
  %3 = load float, ptr %m_aabbMax4, align 4
...
lor.lhs.false.i:                                  ; preds = %entry
  ...
  %4 = load float, ptr %m_aabbMax, align 4
  %5 = load float, ptr %m_aabbMin3, align 4
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local void @_ZN20btMultiSapBroadphase10printStatsEv(ptr nocapture nonnull readnone align 8 %this) unnamed_addr #7 align 2 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local void @_ZN20btMultiSapBroadphase9resetPoolEP12btDispatcher(ptr nocapture nonnull readnone align 8 %this, ptr nocapture readnone %dispatcher) unnamed_addr #7 align 2 {
entry:
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr dso_local noundef ptr @_ZN20btMultiSapBroadphase23getOverlappingPairCacheEv(ptr noundef nonnull align 8 dereferenceable(120) %this) unnamed_addr #11 comdat align 2 {
entry:
  %m_overlappingPairs = getelementptr inbounds %class.btMultiSapBroadphase, ptr %this, i64 0, i32 3
  %0 = load ptr, ptr %m_overlappingPairs, align 8
  ret ptr %0
}

; Function Attrs: nounwind uwtable
define linkonce_odr dso_local noundef ptr @_ZNK20btMultiSapBroadphase23getOverlappingPairCacheEv(ptr noundef nonnull align 8 dereferenceable(120) %this) unnamed_addr #11 comdat align 2 {
entry:
  %m_overlappingPairs = getelementptr inbounds %class.btMultiSapBroadphase, ptr %this, i64 0, i32 3
  %0 = load ptr, ptr %m_overlappingPairs, align 8
  ret ptr %0
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN23btOverlapFilterCallbackD2Ev(ptr noundef nonnull align 8 dereferenceable(8) %this) unnamed_addr #11 comdat align 2 {
entry:
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @_ZZN20btMultiSapBroadphaseC1EiP22btOverlappingPairCacheEN31btMultiSapOverlapFilterCallbackD0Ev(ptr noundef nonnull align 8 dereferenceable(8) %this) unnamed_addr #11 align 2 personality ptr @__gxx_personality_v0 {
entry:
  tail call void @_ZdlPv(ptr noundef nonnull %this) #17
  ret void
}
...
entry:
  ...
  %2 = load i16, ptr %m_collisionFilterGroup, align 8
  %m_collisionFilterMask = getelementptr inbounds %struct.btBroadphaseProxy, ptr %1, i64 0, i32 2
  %3 = load i16, ptr %m_collisionFilterMask, align 2
  %and15 = and i16 %3, %2
...
land.rhs:                                         ; preds = %entry
  ...
  %4 = load i16, ptr %m_collisionFilterGroup4, align 8
  %m_collisionFilterMask6 = getelementptr inbounds %struct.btBroadphaseProxy, ptr %0, i64 0, i32 2
  %5 = load i16, ptr %m_collisionFilterMask6, align 2
  %and816 = and i16 %5, %4
...
entry:
  ...
  %1 = load ptr, ptr %m_multiSap, align 8
  ...
  %4 = load ptr, ptr %m_multiProxy, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %for.cond
  ...
  %8 = load ptr, ptr %m_childBroadphase, align 8
...
if.then9:                                         ; preds = %for.cond, %entry
  ...
  %15 = load ptr, ptr %m_multiProxy, align 8
...
cond.true.i:                                      ; preds = %while.cond
  ...
  %7 = load ptr, ptr %m_multiSapParentProxy.i, align 8
  br label %cond.end.i
...
cond.end.i:                                       ; preds = %cond.true.i, %while.cond
  ...
  %8 = load ptr, ptr %m_pProxy1.i42, align 8
...
cond.true4.i:                                     ; preds = %cond.end.i
  ...
  %9 = load ptr, ptr %m_multiSapParentProxy6.i, align 8
...
cond.true12.i:                                    ; preds = %cond.end8.i
  %10 = load ptr, ptr %m_multiSapParentProxy14.i, align 8
...
cond.true20.i:                                    ; preds = %cond.end16.i
  %11 = load ptr, ptr %m_multiSapParentProxy22.i, align 8
...
while.cond5:                                      ; preds = %while.cond5.preheader, %while.body10
  ...
  br i1 %tobool11.not.i, label %cond.end.i47, label %cond.true.i45

cond.true.i45:                                    ; preds = %while.cond5
  %15 = load ptr, ptr %m_multiSapParentProxy14.i, align 8
  br label %cond.end.i47

cond.end.i47:                                     ; preds = %cond.true.i45, %while.cond5
  %cond.i48 = phi ptr [ %15, %cond.true.i45 ], [ null, %while.cond5 ]
  br i1 %tobool19.not.i, label %cond.end8.i53, label %cond.true4.i51

cond.true4.i51:                                   ; preds = %cond.end.i47
  %16 = load ptr, ptr %m_multiSapParentProxy22.i, align 8
  br label %cond.end8.i53

cond.end8.i53:                                    ; preds = %cond.true4.i51, %cond.end.i47
  %cond9.i54 = phi ptr [ %16, %cond.true4.i51 ], [ null, %cond.end.i47 ]
  %17 = load ptr, ptr %arrayidx8, align 8
  %tobool11.not.i55 = icmp eq ptr %17, null
  br i1 %tobool11.not.i55, label %cond.end16.i58, label %cond.true12.i56

cond.true12.i56:                                  ; preds = %cond.end8.i53
  %m_multiSapParentProxy14.i57 = getelementptr inbounds %struct.btBroadphaseProxy, ptr %17, i64 0, i32 4
  %18 = load ptr, ptr %m_multiSapParentProxy14.i57, align 8
  br label %cond.end16.i58

cond.end16.i58:                                   ; preds = %cond.true12.i56, %cond.end8.i53
  %cond17.i59 = phi ptr [ %18, %cond.true12.i56 ], [ null, %cond.end8.i53 ]
...
cond.true20.i62:                                  ; preds = %cond.end16.i58
  %m_multiSapParentProxy22.i63 = getelementptr inbounds %struct.btBroadphaseProxy, ptr %19, i64 0, i32 4
  %20 = load ptr, ptr %m_multiSapParentProxy22.i63, align 8
  br label %cond.end24.i64

cond.end24.i64:                                   ; preds = %cond.true20.i62, %cond.end16.i58
  %cond25.i65 = phi ptr [ %20, %cond.true20.i62 ], [ null, %cond.end16.i58 ]
  %cmp.i66 = icmp ugt ptr %cond.i48, %cond17.i59
  br i1 %cmp.i66, label %while.body10, label %lor.lhs.false.i67

lor.lhs.false.i67:                                ; preds = %cond.end24.i64
  %cmp26.i68 = icmp eq ptr %cond.i48, %cond17.i59
  %cmp27.i69 = icmp ugt ptr %cond9.i54, %cond25.i65
  %or.cond.i70 = select i1 %cmp26.i68, i1 %cmp27.i69, i1 false
  %cmp26.not.i71 = xor i1 %cmp26.i68, true
  %brmerge.i72 = or i1 %or.cond.i70, %cmp26.not.i71
  br i1 %brmerge.i72, label %_ZN37btMultiSapBroadphasePairSortPredicateclERK16btBroadphasePairS2_.exit79, label %land.lhs.true29.i73

land.lhs.true29.i73:                              ; preds = %lor.lhs.false.i67
  %cmp30.i74 = icmp eq ptr %cond9.i54, %cond25.i65
  br i1 %cmp30.i74, label %land.rhs.i75, label %while.end11

land.rhs.i75:                                     ; preds = %land.lhs.true29.i73
  %m_algorithm31.i77 = getelementptr inbounds %struct.btBroadphasePair, ptr %4, i64 %indvars.iv86, i32 2
  %21 = load ptr, ptr %m_algorithm31.i77, align 8
  %cmp32.i78 = icmp ugt ptr %3, %21
  br i1 %cmp32.i78, label %while.body10, label %while.end11

_ZN37btMultiSapBroadphasePairSortPredicateclERK16btBroadphasePairS2_.exit79: ; preds = %lor.lhs.false.i67
  br i1 %or.cond.i70, label %while.body10, label %while.end11

while.body10:                                     ; preds = %cond.end24.i64, %land.rhs.i75, %_ZN37btMultiSapBroadphasePairSortPredicateclERK16btBroadphasePairS2_.exit79
  %indvars.iv.next87 = add i64 %indvars.iv86, -1
  br label %while.cond5

while.end11:                                      ; preds = %land.lhs.true29.i73, %land.rhs.i75, %_ZN37btMultiSapBroadphasePairSortPredicateclERK16btBroadphasePairS2_.exit79
...
if.then:                                          ; preds = %while.end11
  ...
  store ptr %8, ptr %temp.sroa.4.0.arrayidx10.sroa_idx.i, align 8
