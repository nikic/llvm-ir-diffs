...
invoke.cont5:                                     ; preds = %if.end, %if.then3.i.i.i
  ...
  %8 = load i8, ptr %m_ownsMemory.i.i.i20, align 8, !range !31
...
for.body:                                         ; preds = %for.body.lr.ph, %_ZN20btAlignedObjectArrayI18btQuantizedBvhNodeE9push_backERKS0_.exit
  ...
  %18 = load <2 x float>, ptr %arrayidx7.i.i, align 4, !tbaa !34
  %19 = load <2 x float>, ptr %arrayidx7.i44.i, align 4, !tbaa !34
  %20 = load <2 x float>, ptr %arrayidx5.i.i19, align 4, !tbaa !34
...
_ZN20btAlignedObjectArrayI18btQuantizedBvhNodeE9push_backERKS0_.exit: ; preds = %for.body, %if.then.i, %_ZN20btAlignedObjectArrayI18btQuantizedBvhNodeE10deallocateEv.exit.i.i
  ...
  store i32 %52, ptr %node.sroa.9.0.arrayidx.i33.sroa_idx, align 4, !tbaa.struct !45
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i.new
  ...
  %5 = load ptr, ptr %m_data.i.i.i8, align 8, !tbaa !27
  ...
  %7 = load ptr, ptr %m_data.i.i.i8, align 8, !tbaa !27
  ...
  %9 = load ptr, ptr %m_data.i.i.i8, align 8, !tbaa !27
  ...
  %11 = load ptr, ptr %m_data.i.i.i8, align 8, !tbaa !27
...
for.body.i.i.i.epil:                              ; preds = %_ZNK20btAlignedObjectArrayIPN20btMultiSapBroadphase15btMultiSapProxyEE4copyEiiPS2_.exit.i.i.loopexit.unr-lcssa, %for.body.i.i.i.epil
  ...
  %13 = load ptr, ptr %m_data.i.i.i8, align 8, !tbaa !27
...
_ZNK20btAlignedObjectArrayIPN20btMultiSapBroadphase15btMultiSapProxyEE4copyEiiPS2_.exit.i.i: ; preds = %_ZNK20btAlignedObjectArrayIPN20btMultiSapBroadphase15btMultiSapProxyEE4copyEiiPS2_.exit.i.i.loopexit.unr-lcssa, %for.body.i.i.i.epil, %_ZN20btAlignedObjectArrayIPN20btMultiSapBroadphase15btMultiSapProxyEE8allocateEi.exit.i.i
  ...
  %16 = load i8, ptr %m_ownsMemory.i.i.i7, align 8, !range !31
...
_ZN20btAlignedObjectArrayIPN20btMultiSapBroadphase15btMultiSapProxyEE10deallocateEv.exit.i.i: ; preds = %if.then3.i.i.i, %_ZNK20btAlignedObjectArrayIPN20btMultiSapBroadphase15btMultiSapProxyEE4copyEiiPS2_.exit.i.i
  ...
  store i8 1, ptr %m_ownsMemory.i.i.i7, align 8, !tbaa !26
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end36
  ...
  %7 = load float, ptr %worldAabbMin, align 4, !tbaa !34
  %8 = load float, ptr %m_aabbMax, align 4, !tbaa !34
  %cmp.i = fcmp ogt float %7, %8
  br i1 %cmp.i, label %cond.end.i, label %lor.lhs.false.i

lor.lhs.false.i:                                  ; preds = %for.body
  %9 = load float, ptr %worldAabbMax, align 4, !tbaa !34
  %10 = load float, ptr %m_aabbMin, align 4, !tbaa !34
...
cond.end.i:                                       ; preds = %cond.false.i, %lor.lhs.false.i, %for.body
  ...
  %11 = load float, ptr %arrayidx.i.i, align 4, !tbaa !34
  %12 = load float, ptr %arrayidx.i43.i, align 4, !tbaa !34
  %cmp7.i = fcmp ogt float %11, %12
  br i1 %cmp7.i, label %cond.end15.i, label %lor.lhs.false8.i

lor.lhs.false8.i:                                 ; preds = %cond.end.i
  %13 = load float, ptr %arrayidx.i44.i, align 4, !tbaa !34
  %14 = load float, ptr %arrayidx.i45.i, align 4, !tbaa !34
...
cond.end15.i:                                     ; preds = %cond.false13.i, %lor.lhs.false8.i, %cond.end.i
  ...
  %15 = load float, ptr %arrayidx.i46.i, align 4, !tbaa !34
  %16 = load float, ptr %arrayidx.i47.i, align 4, !tbaa !34
  %cmp20.i = fcmp ogt float %15, %16
  br i1 %cmp20.i, label %if.then19, label %lor.lhs.false21.i

lor.lhs.false21.i:                                ; preds = %cond.end15.i
  %17 = load float, ptr %arrayidx.i48.i, align 4, !tbaa !34
  %18 = load float, ptr %arrayidx.i49.i, align 4, !tbaa !34
...
if.then19:                                        ; preds = %lor.lhs.false21.i, %cond.end15.i
  %19 = load ptr, ptr %m_data.i, align 8, !tbaa !57
  %arrayidx.i97 = getelementptr inbounds ptr, ptr %19, i64 %indvars.iv
  %20 = load ptr, ptr %arrayidx.i97, align 8, !tbaa !33
  %21 = load ptr, ptr %20, align 8, !tbaa !64
  %m_childBroadphase24 = getelementptr inbounds %"struct.btMultiSapBroadphase::btBridgeProxy", ptr %20, i64 0, i32 1
  %22 = load ptr, ptr %m_childBroadphase24, align 8, !tbaa !66
  %vtable25 = load ptr, ptr %22, align 8, !tbaa !5
  ...
  %24 = load i32, ptr %m_size.i, align 4, !tbaa !58
  %sub = add nsw i32 %24, -1
  %25 = load ptr, ptr %m_data.i, align 8, !tbaa !57
  %arrayidx.i101 = getelementptr inbounds ptr, ptr %25, i64 %indvars.iv
  %26 = load ptr, ptr %arrayidx.i101, align 8, !tbaa !33
  %idxprom3.i = sext i32 %sub to i64
  %arrayidx4.i = getelementptr inbounds ptr, ptr %25, i64 %idxprom3.i
  %27 = load ptr, ptr %arrayidx4.i, align 8, !tbaa !33
  store ptr %27, ptr %arrayidx.i101, align 8, !tbaa !33
  %28 = load ptr, ptr %m_data.i, align 8, !tbaa !57
  %arrayidx10.i = getelementptr inbounds ptr, ptr %28, i64 %idxprom3.i
  store ptr %26, ptr %arrayidx10.i, align 8, !tbaa !33
...
for.body45:                                       ; preds = %for.body45.lr.ph, %for.body45
  ...
  %35 = load i32, ptr %m_size.i, align 4, !tbaa !58
...
land.rhs.i:                                       ; preds = %land.lhs.true29.i
  ...
  %14 = load ptr, ptr %m_algorithm.i43, align 8, !tbaa !79
...
cond.true12.i56:                                  ; preds = %cond.end8.i53
  ...
  %18 = load ptr, ptr %m_multiSapParentProxy14.i57, align 8, !tbaa !53
...
cond.end16.i58:                                   ; preds = %cond.true12.i56, %cond.end8.i53
  ...
  %19 = load ptr, ptr %m_pProxy118.i60, align 8, !tbaa !83
...
cond.true20.i62:                                  ; preds = %cond.end16.i58
  ...
  %20 = load ptr, ptr %m_multiSapParentProxy22.i63, align 8, !tbaa !53
...
land.rhs.i75:                                     ; preds = %land.lhs.true29.i73
  ...
  %21 = load ptr, ptr %m_algorithm31.i77, align 8, !tbaa !79
