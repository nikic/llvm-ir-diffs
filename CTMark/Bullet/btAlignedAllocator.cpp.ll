; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btAlignedAllocator.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btAlignedAllocator.cpp"
...
entry:
  %0 = load i32, ptr @gNumAlignedAllocs, align 4
  %inc = add nsw i32 %0, 1
  store i32 %inc, ptr @gNumAlignedAllocs, align 4
  %1 = load ptr, ptr @_ZL10sAllocFunc, align 8
  %add = add i64 %size, 8
...
if.then:                                          ; preds = %entry
  ...
  store ptr %call, ptr %add.ptr8, align 8
  br label %if.end
...
if.end:                                           ; preds = %entry
  %0 = load i32, ptr @gNumAlignedFree, align 4
  %inc = add nsw i32 %0, 1
  store i32 %inc, ptr @gNumAlignedFree, align 4
  %add.ptr = getelementptr inbounds ptr, ptr %ptr, i64 -1
  %1 = load ptr, ptr %add.ptr, align 8
  %2 = load ptr, ptr @_ZL9sFreeFunc, align 8
