...
for.body.prol:                                    ; preds = %for.body.lr.ph
  ...
  %3 = load float, ptr %m_max.prol, align 4, !tbaa !13
  %4 = load float, ptr %arrayidx.i.prol, align 4, !tbaa !13
  ...
  %5 = load <2 x float>, ptr %arrayidx5.i69.prol, align 4, !tbaa !13
  %6 = load <2 x float>, ptr %arrayidx7.i70.prol, align 4, !tbaa !13
...
for.body.prol:                                    ; preds = %for.body.lr.ph
  ...
  %4 = load float, ptr %arrayidx11.i.prol, align 4, !tbaa !13
  %arrayidx13.i.prol = getelementptr inbounds [4 x float], ptr %arrayidx.i.prol, i64 0, i64 2
  %5 = load float, ptr %arrayidx13.i.prol, align 4, !tbaa !13
  %add14.i.prol = fadd float %4, %5
  %6 = load <2 x float>, ptr %m_max.prol, align 4, !tbaa !13
  %7 = load <2 x float>, ptr %arrayidx.i.prol, align 4, !tbaa !13
...
_ZN20btAlignedObjectArrayIiE8allocateEi.exit.i.i: ; preds = %if.then.i.i.i, %if.then.i.i
  ...
  %20 = load ptr, ptr %m_data.i.i.i34, align 8, !tbaa !52
...
for.body.i.i.i.prol:                              ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i.prol
  ...
  store i32 %30, ptr %arrayidx.i.i.i35.prol, align 4, !tbaa !22
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  ...
  store i32 %32, ptr %arrayidx.i.i.i35, align 4, !tbaa !22
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1
  ...
  store i32 %33, ptr %arrayidx.i.i.i35.1, align 4, !tbaa !22
  ...
  store i32 %34, ptr %arrayidx.i.i.i35.2, align 4, !tbaa !22
  ...
  store i32 %35, ptr %arrayidx.i.i.i35.3, align 4, !tbaa !22
...
_ZN20btAlignedObjectArrayIiE10deallocateEv.exit.i.i: ; preds = %if.end.i.i.i, %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i
  ...
  store ptr %retval.0.i.i.i, ptr %m_data.i.i.i34, align 8, !tbaa !52
...
_ZN20btAlignedObjectArrayIiE9push_backERKi.exit:  ; preds = %if.then, %if.then.i, %_ZN20btAlignedObjectArrayIiE10deallocateEv.exit.i.i
  ...
  %38 = load ptr, ptr %m_data.i.i.i34, align 8, !tbaa !52
...
while.end:                                        ; preds = %if.end11, %entry
  ...
  %40 = load i32, ptr %m_size.i, align 4, !tbaa !48
...
if.then:                                          ; preds = %_ZNK6btAABB11collide_rayERK9btVector3S2_.exit
  %30 = load i32, ptr %m_size.i.i, align 4, !tbaa !48
  %31 = load i32, ptr %m_capacity.i.i, align 8, !tbaa !51
...
_ZN20btAlignedObjectArrayIiE8allocateEi.exit.i.i: ; preds = %if.then.i.i.i, %if.then.i.i
  ...
  %33 = load ptr, ptr %m_data.i.i.i34, align 8, !tbaa !52
  br i1 %cmp7.i.i.i, label %for.body.lr.ph.i.i.i, label %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i
...
for.body.i.i.i.prol:                              ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i.prol
  ...
  store i32 %43, ptr %arrayidx.i.i.i35.prol, align 4, !tbaa !22
  %indvars.iv.next.i.i.i.prol = add nuw nsw i64 %indvars.iv.i.i.i.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  ...
  store i32 %45, ptr %arrayidx.i.i.i35, align 4, !tbaa !22
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1
  %arrayidx.i.i.i35.1 = getelementptr inbounds i32, ptr %retval.0.i.i.i, i64 %indvars.iv.next.i.i.i
  ...
  store i32 %46, ptr %arrayidx.i.i.i35.1, align 4, !tbaa !22
  %indvars.iv.next.i.i.i.1 = add nuw nsw i64 %indvars.iv.i.i.i, 2
  %arrayidx.i.i.i35.2 = getelementptr inbounds i32, ptr %retval.0.i.i.i, i64 %indvars.iv.next.i.i.i.1
  ...
  store i32 %47, ptr %arrayidx.i.i.i35.2, align 4, !tbaa !22
  %indvars.iv.next.i.i.i.2 = add nuw nsw i64 %indvars.iv.i.i.i, 3
  %arrayidx.i.i.i35.3 = getelementptr inbounds i32, ptr %retval.0.i.i.i, i64 %indvars.iv.next.i.i.i.2
  ...
  store i32 %48, ptr %arrayidx.i.i.i35.3, align 4, !tbaa !22
  %indvars.iv.next.i.i.i.3 = add nuw nsw i64 %indvars.iv.i.i.i, 4
  %exitcond.not.i.i.i.3 = icmp eq i64 %indvars.iv.next.i.i.i.3, %wide.trip.count.i.i.i
...
if.then.i11.i.i:                                  ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i, %middle.block, %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i
  %49 = load i8, ptr %m_ownsMemory.i.i.i, align 8, !tbaa !58, !range !38, !noundef !59
...
if.end.thread:                                    ; preds = %_ZN20btAlignedObjectArrayIiE10deallocateEv.exit.i.i, %if.then.i, %if.then
  ...
  %51 = load ptr, ptr %m_data.i.i.i34, align 8, !tbaa !52
  ...
  %52 = load i32, ptr %m_size.i.i, align 4, !tbaa !48
...
while.end:                                        ; preds = %if.end11, %entry
  %m_size.i = getelementptr inbounds %class.btAlignedObjectArray.4, ptr %collided_results, i64 0, i32 2
  %55 = load i32, ptr %m_size.i, align 4, !tbaa !48
