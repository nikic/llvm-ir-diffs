; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btGImpactBvh.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btGImpactBvh.cpp"
...
if.end:                                           ; preds = %entry
  ...
  %cmp763 = icmp slt i32 %startIndex, %endIndex
  br i1 %cmp763, label %for.body.lr.ph, label %for.cond.cleanup

for.body.lr.ph:                                   ; preds = %if.end
  %m_data.i52 = getelementptr inbounds %class.btAlignedObjectArray, ptr %primitive_boxes, i64 0, i32 5
  %6 = load ptr, ptr %m_data.i52, align 8
...
for.cond.cleanup:                                 ; preds = %for.body, %if.end
  ...
  %10 = load ptr, ptr %m_data.i.i45, align 8
  ...
  store float %node_bound.sroa.10.0.lcssa, ptr %node_bound.sroa.10.0.arrayidx.i.i47.sroa_idx, align 4
  ...
  store float %node_bound.sroa.21.0.lcssa, ptr %node_bound.sroa.21.0.arrayidx.i.i47.sroa_idx, align 4
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %18 = load float, ptr %arrayidx39.i, align 4
  ...
  %22 = load float, ptr %arrayidx98.i, align 4
...
for.body10.i.prol:                                ; preds = %for.body10.lr.ph.i, %for.body10.i.prol
  ...
  store i32 0, ptr %m_escapeIndexOrDataIndex.i.i.prol, align 4
...
for.body10.i:                                     ; preds = %for.body10.i.prol.loopexit, %for.body10.i
  ...
  store i32 0, ptr %m_escapeIndexOrDataIndex.i.i.1, align 4
  ...
  store i32 0, ptr %m_escapeIndexOrDataIndex.i.i.2, align 4
  ...
  store i32 0, ptr %m_escapeIndexOrDataIndex.i.i.3, align 4
...
if.end:                                           ; preds = %while.body
  ...
  %temp_box.sroa.10.0.copyload = load float, ptr %temp_box.sroa.10.0.arrayidx.i.i.i28.sroa_idx, align 4
  ...
  %temp_box.sroa.20.0.copyload = load float, ptr %temp_box.sroa.20.0.arrayidx.i.i.i28.sroa_idx, align 4
  ...
  %13 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i32, align 4
...
if.then9:                                         ; preds = %if.end
  ...
  %temp_box.sroa.10.0.copyload83 = load float, ptr %temp_box.sroa.10.0.arrayidx.i.i.i35.sroa_idx, align 4
  ...
  %temp_box.sroa.20.0.copyload91 = load float, ptr %temp_box.sroa.20.0.arrayidx.i.i.i35.sroa_idx, align 4
...
if.end10:                                         ; preds = %if.then9, %if.end
  ...
  store float %bound.sroa.15.1, ptr %bound.sroa.15.0.arrayidx.i.i.i68.sroa_idx, align 4
  ...
  store float %bound.sroa.34.1, ptr %bound.sroa.34.0.arrayidx.i.i.i68.sroa_idx, align 4
  br label %if.end11
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end11
  ...
  %bound.sroa.639.0.copyload = load float, ptr %bound.sroa.639.0.arrayidx.i.i.i.sroa_idx, align 4
  %bound.sroa.7.0.arrayidx.i.i.i.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i.i.i, i64 20
  %3 = load <2 x float>, ptr %bound.sroa.7.0.arrayidx.i.i.i.sroa_idx, align 4
  %4 = load float, ptr %box, align 4
  %cmp10.i = fcmp olt float %bound.sroa.639.0.copyload, %4
  %5 = load <4 x float>, ptr %m_max.i, align 4
  %6 = load float, ptr %arrayidx33.i, align 4
  %cmp34.i = fcmp ogt float %bound.sroa.5.0.copyload, %6
  ...
  %16 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i41, align 4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %24, align 4
  %25 = getelementptr inbounds i32, ptr %24, i64 4
  %wide.load58 = load <4 x i32>, ptr %25, align 4
  store <4 x i32> %wide.load, ptr %23, align 4
  %26 = getelementptr inbounds i32, ptr %23, i64 4
  store <4 x i32> %wide.load58, ptr %26, align 4
...
for.body.i.i.i.prol:                              ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i.prol
  ...
  %30 = load i32, ptr %arrayidx3.i.i.i.prol, align 4
  store i32 %30, ptr %arrayidx.i.i.i35.prol, align 4
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  ...
  %32 = load i32, ptr %arrayidx3.i.i.i, align 4
  store i32 %32, ptr %arrayidx.i.i.i35, align 4
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1
  ...
  %33 = load i32, ptr %arrayidx3.i.i.i.1, align 4
  store i32 %33, ptr %arrayidx.i.i.i35.1, align 4
  ...
  %34 = load i32, ptr %arrayidx3.i.i.i.2, align 4
  store i32 %34, ptr %arrayidx.i.i.i35.2, align 4
  ...
  %35 = load i32, ptr %arrayidx3.i.i.i.3, align 4
  store i32 %35, ptr %arrayidx.i.i.i35.3, align 4
...
_ZN20btAlignedObjectArrayIiE10deallocateEv.exit.i.i: ; preds = %if.end.i.i.i, %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i
  ...
  store i8 1, ptr %m_ownsMemory.i.i.i, align 8
  store ptr %retval.0.i.i.i, ptr %m_data.i.i.i34, align 8
...
_ZN20btAlignedObjectArrayIiE9push_backERKi.exit:  ; preds = %if.then, %if.then.i, %_ZN20btAlignedObjectArrayIiE10deallocateEv.exit.i.i
  ...
  %38 = load ptr, ptr %m_data.i.i.i34, align 8
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end11
  ...
  %bound.sroa.4.0.copyload = load float, ptr %bound.sroa.4.0.arrayidx.i.i.i.sroa_idx, align 4
  %bound.sroa.5.0.arrayidx.i.i.i.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i.i.i, i64 8
  %bound.sroa.5.0.copyload = load float, ptr %bound.sroa.5.0.arrayidx.i.i.i.sroa_idx, align 4
  %bound.sroa.640.0.arrayidx.i.i.i.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i.i.i, i64 16
  %bound.sroa.640.0.copyload = load float, ptr %bound.sroa.640.0.arrayidx.i.i.i.sroa_idx, align 4
  %bound.sroa.7.0.arrayidx.i.i.i.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i.i.i, i64 20
  %bound.sroa.7.0.copyload = load float, ptr %bound.sroa.7.0.arrayidx.i.i.i.sroa_idx, align 4
  %bound.sroa.8.0.arrayidx.i.i.i.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i.i.i, i64 24
  %bound.sroa.8.0.copyload = load float, ptr %bound.sroa.8.0.arrayidx.i.i.i.sroa_idx, align 4
  ...
  %2 = load float, ptr %ray_origin, align 4
...
land.lhs.true.i:                                  ; preds = %while.body
  %4 = load float, ptr %ray_dir, align 4
...
land.lhs.true19.i:                                ; preds = %if.end.i
  %7 = load float, ptr %arrayidx21.i, align 4
...
if.end41.i:                                       ; preds = %if.end25.i
  %11 = load float, ptr %arrayidx21.i, align 4
  %12 = fneg float %10
...
if.end63.i:                                       ; preds = %if.end41.i
  %18 = load float, ptr %ray_dir, align 4
  %19 = fneg float %18
...
_ZNK6btAABB11collide_rayERK9btVector3S2_.exit.thread: ; preds = %land.lhs.true.i, %land.lhs.true19.i, %if.end41.i, %if.end63.i, %if.end25.i
  ...
  %24 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i42, align 4
...
_ZNK6btAABB11collide_rayERK9btVector3S2_.exit:    ; preds = %if.end63.i
  ...
  %29 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i, align 4
...
_ZN20btAlignedObjectArrayIiE8allocateEi.exit.i.i: ; preds = %if.then.i.i.i, %if.then.i.i
  ...
  %33 = load ptr, ptr %m_data.i.i.i34, align 8
  br i1 %cmp7.i.i.i, label %for.body.lr.ph.i.i.i, label %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i
...
for.body.i.i.i.prol:                              ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i.prol
  ...
  %43 = load i32, ptr %arrayidx3.i.i.i.prol, align 4
  store i32 %43, ptr %arrayidx.i.i.i35.prol, align 4
  %indvars.iv.next.i.i.i.prol = add nuw nsw i64 %indvars.iv.i.i.i.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body.i.i.i.prol.loopexit, label %for.body.i.i.i.prol
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  ...
  %45 = load i32, ptr %arrayidx3.i.i.i, align 4
  store i32 %45, ptr %arrayidx.i.i.i35, align 4
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1
  %arrayidx.i.i.i35.1 = getelementptr inbounds i32, ptr %retval.0.i.i.i, i64 %indvars.iv.next.i.i.i
  %arrayidx3.i.i.i.1 = getelementptr inbounds i32, ptr %33, i64 %indvars.iv.next.i.i.i
  %46 = load i32, ptr %arrayidx3.i.i.i.1, align 4
  store i32 %46, ptr %arrayidx.i.i.i35.1, align 4
  %indvars.iv.next.i.i.i.1 = add nuw nsw i64 %indvars.iv.i.i.i, 2
  %arrayidx.i.i.i35.2 = getelementptr inbounds i32, ptr %retval.0.i.i.i, i64 %indvars.iv.next.i.i.i.1
  %arrayidx3.i.i.i.2 = getelementptr inbounds i32, ptr %33, i64 %indvars.iv.next.i.i.i.1
  %47 = load i32, ptr %arrayidx3.i.i.i.2, align 4
  store i32 %47, ptr %arrayidx.i.i.i35.2, align 4
  %indvars.iv.next.i.i.i.2 = add nuw nsw i64 %indvars.iv.i.i.i, 3
  %arrayidx.i.i.i35.3 = getelementptr inbounds i32, ptr %retval.0.i.i.i, i64 %indvars.iv.next.i.i.i.2
  %arrayidx3.i.i.i.3 = getelementptr inbounds i32, ptr %33, i64 %indvars.iv.next.i.i.i.2
  %48 = load i32, ptr %arrayidx3.i.i.i.3, align 4
  store i32 %48, ptr %arrayidx.i.i.i35.3, align 4
  %indvars.iv.next.i.i.i.3 = add nuw nsw i64 %indvars.iv.i.i.i, 4
  %exitcond.not.i.i.i.3 = icmp eq i64 %indvars.iv.next.i.i.i.3, %wide.trip.count.i.i.i
  br i1 %exitcond.not.i.i.i.3, label %if.then.i11.i.i, label %for.body.i.i.i
...
if.end.thread:                                    ; preds = %_ZN20btAlignedObjectArrayIiE10deallocateEv.exit.i.i, %if.then.i, %if.then
  ...
  %51 = load ptr, ptr %m_data.i.i.i34, align 8
...
if.else:                                          ; preds = %if.end
  ...
  %54 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i38, align 4
...
if.end:                                           ; preds = %entry
  ...
  %5 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i98, align 4
...
_ZN20btAlignedObjectArrayI8GIM_PAIRE8allocateEi.exit.i.i.i: ; preds = %if.then.i.i.i.i, %if.then.i.i.i
  ...
  %9 = load ptr, ptr %m_data.i.i.i.i107, align 8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec170 = load <4 x i32>, ptr %14, align 4
  ...
  store <4 x i32> %wide.vec170, ptr %16, align 4
...
for.body.i.i.i.i.prol:                            ; preds = %for.body.i.i.i.i.preheader, %for.body.i.i.i.i.prol
  ...
  %20 = load <2 x i32>, ptr %arrayidx3.i.i.i.i.prol, align 4
  store <2 x i32> %20, ptr %arrayidx.i.i.i.i108.prol, align 4
...
for.body.i.i.i.i:                                 ; preds = %for.body.i.i.i.i.prol.loopexit, %for.body.i.i.i.i
  ...
  %22 = load <2 x i32>, ptr %arrayidx3.i.i.i.i, align 4
  store <2 x i32> %22, ptr %arrayidx.i.i.i.i108, align 4
  ...
  %23 = load <2 x i32>, ptr %arrayidx3.i.i.i.i.1, align 4
  store <2 x i32> %23, ptr %arrayidx.i.i.i.i108.1, align 4
  ...
  %24 = load <2 x i32>, ptr %arrayidx3.i.i.i.i.2, align 4
  store <2 x i32> %24, ptr %arrayidx.i.i.i.i108.2, align 4
  ...
  %25 = load <2 x i32>, ptr %arrayidx3.i.i.i.i.3, align 4
  store <2 x i32> %25, ptr %arrayidx.i.i.i.i108.3, align 4
...
if.else:                                          ; preds = %if.then2
  ...
  %30 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i112, align 4
...
if.then12:                                        ; preds = %if.else10
  ...
  %32 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i121, align 4
...
if.else15:                                        ; preds = %if.else10
  ...
  %33 = load ptr, ptr %m_data.i.i.i1.i, align 8
  ...
  %34 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i132, align 4
  ...
  %36 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i140, align 4
  ...
  %38 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i149, align 4
  ...
  %40 = load i32, ptr %m_escapeIndexOrDataIndex.i.i.i157, align 4
...
attributes #0 = { nofree norecurse nosync nounwind memory(read, inaccessiblemem: none) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #1 = { mustprogress nocallback nofree nosync nounwind willreturn memory(argmem: readwrite) }
attributes #2 = { mustprogress nocallback nofree nounwind willreturn memory(argmem: readwrite) }
attributes #3 = { nofree nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
