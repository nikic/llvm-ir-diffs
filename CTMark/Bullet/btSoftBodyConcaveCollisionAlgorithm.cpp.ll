; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSoftBodyConcaveCollisionAlgorithm.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSoftBodyConcaveCollisionAlgorithm.cpp"
...
%class.btSoftBody = type { %class.btCollisionObject, %class.btAlignedObjectArray.8, %"struct.btSoftBody::Config", %"struct.btSoftBody::SolverState", [4 x i8], %"struct.btSoftBody::Pose", ptr, ptr, %class.btAlignedObjectArray.28, %class.btAlignedObjectArray.32, %class.btAlignedObjectArray.36, %class.btAlignedObjectArray.40, %class.btAlignedObjectArray.44, %class.btAlignedObjectArray.48, %class.btAlignedObjectArray.52, %class.btAlignedObjectArray.56, %class.btAlignedObjectArray.60, %class.btAlignedObjectArray.64, float, [2 x %class.btVector3], i8, %struct.btDbvt, %struct.btDbvt, %struct.btDbvt, %class.btAlignedObjectArray.72, %class.btAlignedObjectArray.76, %class.btTransform, %class.btAlignedObjectArray }
%class.btCollisionObject = type { ptr, %class.btTransform, %class.btTransform, %class.btVector3, %class.btVector3, %class.btVector3, i8, float, ptr, ptr, ptr, i32, i32, i32, i32, float, float, float, ptr, i32, float, float, float, i8, [7 x i8] }
%class.btAlignedObjectArray.8 = type <{ %class.btAlignedAllocator.9, [3 x i8], i32, i32, [4 x i8], ptr, i8, [7 x i8] }>
%class.btAlignedAllocator.9 = type { i8 }
%"struct.btSoftBody::Config" = type { i32, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, i32, i32, i32, i32, i32, %class.btAlignedObjectArray.12, %class.btAlignedObjectArray.16, %class.btAlignedObjectArray.16 }
...
%struct.btSparseSdf = type { %class.btAlignedObjectArray.80, float, i32, i32, i32, i32, [4 x i8] }
...
entry:
  ...
  store ptr %cond.i, ptr %m_softBody.i, align 8
  ...
  store ptr %cond8.i, ptr %m_triBody.i, align 8
...
for.cond.cleanup.i:
  ...
  store ptr %cond8, ptr %m_triBody, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %delete.end
  ...
  %5 = load i32, ptr %m_size.i.i11, align 4
...
for.body.i:                                       ; preds = %while.end.i, %for.body.lr.ph.i
  ...
  %7 = load ptr, ptr %m_data.i.i12, align 8
...
invoke.cont:                                      ; preds = %entry, %if.then3.i.i.i
  ...
  %2 = load ptr, ptr %m_data.i.i.i17, align 8
...
invoke.cont3:                                     ; preds = %invoke.cont, %if.then3.i.i.i22
  ...
  %4 = load ptr, ptr %m_data.i.i.i26, align 8
...
invoke.cont7:                                     ; preds = %invoke.cont3, %if.then3.i.i.i31
  ...
  store i8 1, ptr %m_ownsMemory.i.i.i28, align 8
  store ptr null, ptr %m_data.i.i.i26, align 8
  ...
  %m_data.i.i.i35 = getelementptr inbounds %class.btAlignedObjectArray, ptr %this, i64 0, i32 5
  %6 = load ptr, ptr %m_data.i.i.i35, align 8
  %tobool.not.i.i.i36 = icmp eq ptr %6, null
  %m_ownsMemory.i.i.i37 = getelementptr inbounds %class.btAlignedObjectArray, ptr %this, i64 0, i32 6
...
_ZN20btAlignedObjectArrayIiED2Ev.exit43:          ; preds = %invoke.cont7, %if.then3.i.i.i40
  %m_size.i.i.i41 = getelementptr inbounds %class.btAlignedObjectArray, ptr %this, i64 0, i32 2
  store i8 1, ptr %m_ownsMemory.i.i.i37, align 8
  store ptr null, ptr %m_data.i.i.i35, align 8
  store i32 0, ptr %m_size.i.i.i41, align 4
  %m_capacity.i.i.i42 = getelementptr inbounds %class.btAlignedObjectArray, ptr %this, i64 0, i32 3
...
for.body.i:                                       ; preds = %delete.end.i, %for.body.lr.ph.i
  ...
  %5 = load i32, ptr %m_size.i.i11.i, align 4
...
for.body.i.i:                                     ; preds = %while.end.i.i, %for.body.lr.ph.i.i
  ...
  %7 = load ptr, ptr %m_data.i.i12.i, align 8
...
while.end.loopexit.i.i:                           ; preds = %if.end8.i.i
  %.pre.i.i = load i32, ptr %m_size.i.i11.i, align 4
...
_ZN20btAlignedObjectArrayIiE5clearEv.exit:        ; preds = %entry, %if.then3.i.i
  ...
  %2 = load ptr, ptr %m_data.i.i2, align 8
...
_ZN20btAlignedObjectArrayIiE5clearEv.exit11:      ; preds = %_ZN20btAlignedObjectArrayIiE5clearEv.exit, %if.then3.i.i7
  ...
  %4 = load ptr, ptr %m_data.i.i12, align 8
...
_ZN20btAlignedObjectArrayI10btTriIndexE5clearEv.exit: ; preds = %_ZN20btAlignedObjectArrayIiE5clearEv.exit11, %if.then3.i.i17
  ...
  %6 = load ptr, ptr %m_data.i.i21, align 8
...
entry:
  ...
  %m_triBody = getelementptr inbounds %class.btSoftBodyTriangleCallback, ptr %this, i64 0, i32 2
  %0 = load ptr, ptr %m_triBody, align 8
  %m_dispatcher = getelementptr inbounds %class.btSoftBodyTriangleCallback, ptr %this, i64 0, i32 6
  %1 = load ptr, ptr %m_dispatcher, align 8
  %m_dispatchInfoPtr = getelementptr inbounds %class.btSoftBodyTriangleCallback, ptr %this, i64 0, i32 7
  %2 = load ptr, ptr %m_dispatchInfoPtr, align 8
...
if.then:                                          ; preds = %land.lhs.true4
  ...
  store <4 x float> <float 2.550000e+02, float 2.550000e+02, float 0.000000e+00, float 0.000000e+00>, ptr %color, align 16
  ...
  %8 = load float, ptr %triangle, align 4
  ...
  %27 = insertelement <2 x float> %26, float %15, i64 1
  ...
  %40 = load float, ptr %m_worldTransform.i, align 4
  %41 = load float, ptr %arrayidx16, align 4
  ...
  %51 = insertelement <2 x float> %50, float %13, i64 1
  ...
  %58 = fadd <2 x float> %31, %57
  %mul8.i29.i192 = fmul float %34, %43
  %59 = tail call float @llvm.fmuladd.f32(float %33, float %41, float %mul8.i29.i192)
  %60 = tail call float @llvm.fmuladd.f32(float %36, float %44, float %59)
  %add17.i195 = fadd float %38, %60
  ...
  %63 = load ptr, ptr %m_dispatchInfoPtr, align 8
  %m_debugDraw22 = getelementptr inbounds %struct.btDispatcherInfo, ptr %63, i64 0, i32 5
  %64 = load ptr, ptr %m_debugDraw22, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp23) #13
  %65 = load float, ptr %m_worldTransform.i, align 4
  %66 = load float, ptr %arrayidx16, align 4
  %67 = load float, ptr %arrayidx5.i.i, align 4
  %68 = load float, ptr %arrayidx7.i.i178, align 4
  %69 = load float, ptr %arrayidx10.i.i, align 4
  %70 = load float, ptr %arrayidx12.i.i181, align 4
  %71 = load float, ptr %arrayidx.i.i, align 4
  %72 = load float, ptr %arrayidx5.i20.i, align 4
  %73 = load float, ptr %arrayidx10.i23.i, align 4
  ...
  %80 = insertelement <2 x float> %79, float %71, i64 1
  ...
  %89 = load <2 x float>, ptr %m_origin.i, align 4
  %90 = fadd <2 x float> %88, %89
  %91 = load float, ptr %arrayidx.i26.i, align 4
  %92 = load float, ptr %arrayidx5.i27.i, align 4
  %mul8.i29.i216 = fmul float %68, %92
  %93 = call float @llvm.fmuladd.f32(float %91, float %66, float %mul8.i29.i216)
  %94 = load float, ptr %arrayidx10.i30.i, align 4
  %95 = call float @llvm.fmuladd.f32(float %94, float %70, float %93)
  %96 = load float, ptr %arrayidx.i32.i, align 4
  %add17.i219 = fadd float %96, %95
  %retval.sroa.3.12.vec.insert.i222 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add17.i219, i64 0
  store <2 x float> %90, ptr %ref.tmp23, align 8
  %97 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp23, i64 0, i32 1
  store <2 x float> %retval.sroa.3.12.vec.insert.i222, ptr %97, align 8
  ...
  %98 = load float, ptr %m_worldTransform.i, align 4
  %99 = load float, ptr %arrayidx28, align 4
  %100 = load float, ptr %arrayidx5.i.i, align 4
  %arrayidx7.i.i226 = getelementptr inbounds %class.btVector3, ptr %triangle, i64 2, i32 0, i64 1
  %101 = load float, ptr %arrayidx7.i.i226, align 4
  %arrayidx12.i.i229 = getelementptr inbounds %class.btVector3, ptr %triangle, i64 2, i32 0, i64 2
  %102 = load float, ptr %arrayidx12.i.i229, align 4
  %103 = insertelement <2 x float> poison, float %100, i64 0
  %104 = insertelement <2 x float> %103, float %72, i64 1
  ...
  %109 = insertelement <2 x float> %108, float %71, i64 1
  %110 = insertelement <2 x float> poison, float %99, i64 0
  %111 = shufflevector <2 x float> %110, <2 x float> poison, <2 x i32> zeroinitializer
  %112 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %109, <2 x float> %111, <2 x float> %107)
  %113 = insertelement <2 x float> poison, float %102, i64 0
  %114 = shufflevector <2 x float> %113, <2 x float> poison, <2 x i32> zeroinitializer
  %115 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %85, <2 x float> %114, <2 x float> %112)
  %116 = fadd <2 x float> %89, %115
  %mul8.i29.i240 = fmul float %92, %101
  %117 = call float @llvm.fmuladd.f32(float %91, float %99, float %mul8.i29.i240)
  %118 = call float @llvm.fmuladd.f32(float %94, float %102, float %117)
  %add17.i243 = fadd float %96, %118
  ...
  %vtable31 = load ptr, ptr %64, align 8
  ...
  %121 = load ptr, ptr %m_dispatchInfoPtr, align 8
  %m_debugDraw34 = getelementptr inbounds %struct.btDispatcherInfo, ptr %121, i64 0, i32 5
  %122 = load ptr, ptr %m_debugDraw34, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp35) #13
  %123 = load float, ptr %m_worldTransform.i, align 4
  %124 = load float, ptr %arrayidx28, align 4
  %125 = load float, ptr %arrayidx5.i.i, align 4
  %126 = load float, ptr %arrayidx7.i.i226, align 4
  %127 = load float, ptr %arrayidx10.i.i, align 4
  %128 = load float, ptr %arrayidx12.i.i229, align 4
  %129 = load float, ptr %arrayidx.i.i, align 4
  %130 = load float, ptr %arrayidx5.i20.i, align 4
  %131 = load float, ptr %arrayidx10.i23.i, align 4
  ...
  %137 = insertelement <2 x float> poison, float %123, i64 0
  %138 = insertelement <2 x float> %137, float %129, i64 1
  ...
  %142 = insertelement <2 x float> poison, float %127, i64 0
  %143 = insertelement <2 x float> %142, float %131, i64 1
  ...
  %147 = load <2 x float>, ptr %m_origin.i, align 4
  %148 = fadd <2 x float> %146, %147
  %149 = load float, ptr %arrayidx.i26.i, align 4
  %150 = load float, ptr %arrayidx5.i27.i, align 4
  %mul8.i29.i264 = fmul float %126, %150
  %151 = call float @llvm.fmuladd.f32(float %149, float %124, float %mul8.i29.i264)
  %152 = load float, ptr %arrayidx10.i30.i, align 4
  %153 = call float @llvm.fmuladd.f32(float %152, float %128, float %151)
  %154 = load float, ptr %arrayidx.i32.i, align 4
  %add17.i267 = fadd float %154, %153
  %retval.sroa.3.12.vec.insert.i270 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add17.i267, i64 0
  store <2 x float> %148, ptr %ref.tmp35, align 8
  %155 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp35, i64 0, i32 1
  store <2 x float> %retval.sroa.3.12.vec.insert.i270, ptr %155, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp39) #13
  %156 = load float, ptr %m_worldTransform.i, align 4
  %157 = load float, ptr %triangle, align 4
  %158 = load float, ptr %arrayidx5.i.i, align 4
  %159 = load float, ptr %arrayidx7.i.i, align 4
  %160 = load float, ptr %arrayidx12.i.i, align 4
  %161 = insertelement <2 x float> poison, float %158, i64 0
  %162 = insertelement <2 x float> %161, float %130, i64 1
  ...
  %166 = insertelement <2 x float> poison, float %156, i64 0
  %167 = insertelement <2 x float> %166, float %129, i64 1
  ...
  %171 = insertelement <2 x float> poison, float %160, i64 0
  %172 = shufflevector <2 x float> %171, <2 x float> poison, <2 x i32> zeroinitializer
  %173 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %143, <2 x float> %172, <2 x float> %170)
  %174 = fadd <2 x float> %147, %173
  %mul8.i29.i288 = fmul float %150, %159
  %175 = call float @llvm.fmuladd.f32(float %149, float %157, float %mul8.i29.i288)
  %176 = call float @llvm.fmuladd.f32(float %152, float %160, float %175)
  %add17.i291 = fadd float %154, %176
  ...
  %vtable43 = load ptr, ptr %122, align 8
...
if.end:                                           ; preds = %if.then, %land.lhs.true4, %land.lhs.true, %entry
  ...
  %179 = load i32, ptr %m_capacity.i.i.i.i, align 8
  ...
  %180 = load i32, ptr %m_size.i.i.i.i, align 4
...
land.rhs.lr.ph.i.i.i:                             ; preds = %if.end.i.i.i
  ...
  %182 = load ptr, ptr %m_data.i16.i.i.i, align 8
...
land.rhs.i.i.i:                                   ; preds = %while.body.i.i.i, %land.rhs.lr.ph.i.i.i
  ...
  %184 = load i32, ptr %arrayidx.i18.i.i.i, align 4
...
while.body.i.i.i:                                 ; preds = %land.rhs.i.i.i
  ...
  %index.0.i.i.i = load i32, ptr %arrayidx.i21.i.i.i, align 4
...
_ZN9btHashMapI9btHashKeyI10btTriIndexES1_EixERKS2_.exit: ; preds = %land.rhs.i.i.i
  %m_data.i.i.i = getelementptr inbounds %class.btSoftBodyTriangleCallback, ptr %this, i64 0, i32 10, i32 2, i32 5
  %185 = load ptr, ptr %m_data.i.i.i, align 8
...
if.then48:                                        ; preds = %_ZN9btHashMapI9btHashKeyI10btTriIndexES1_EixERKS2_.exit
  ...
  %186 = load ptr, ptr %m_childShape, align 8
  %m_rootCollisionShape.i = getelementptr inbounds %class.btCollisionObject, ptr %0, i64 0, i32 10
  %187 = load ptr, ptr %m_rootCollisionShape.i, align 8
  %m_userPointer.i = getelementptr inbounds %class.btCollisionShape, ptr %187, i64 0, i32 2
  %188 = load ptr, ptr %m_userPointer.i, align 8
  %m_userPointer.i297 = getelementptr inbounds %class.btCollisionShape, ptr %186, i64 0, i32 2
  store ptr %188, ptr %m_userPointer.i297, align 8
  %m_collisionShape.i = getelementptr inbounds %class.btCollisionObject, ptr %0, i64 0, i32 9
  %189 = load ptr, ptr %m_collisionShape.i, align 8
  store ptr %186, ptr %m_collisionShape.i, align 8
  %m_softBody = getelementptr inbounds %class.btSoftBodyTriangleCallback, ptr %this, i64 0, i32 1
  %190 = load ptr, ptr %m_softBody, align 8
  %191 = load ptr, ptr %m_triBody, align 8
  %vtable54 = load ptr, ptr %1, align 8
  ...
  %193 = load ptr, ptr %m_softBody, align 8
  %194 = load ptr, ptr %m_triBody, align 8
  %195 = load ptr, ptr %m_dispatchInfoPtr, align 8
  %m_resultOut = getelementptr inbounds %class.btSoftBodyTriangleCallback, ptr %this, i64 0, i32 5
  %196 = load ptr, ptr %m_resultOut, align 8
  %vtable60 = load ptr, ptr %call56, align 8
  ...
  %vtable62 = load ptr, ptr %call56, align 8
  ...
  store ptr %189, ptr %m_collisionShape.i, align 8
  br label %cleanup
...
if.end67:                                         ; preds = %while.body.i.i.i, %if.end.i.i.i, %if.end, %_ZN9btHashMapI9btHashKeyI10btTriIndexES1_EixERKS2_.exit
  ...
  %200 = load float, ptr %arrayidx69, align 4
  ...
  %201 = load float, ptr %arrayidx13.i, align 4
  ...
  %202 = load float, ptr %arrayidx11.i311, align 4
  call void @llvm.lifetime.start.p0(i64 96, ptr nonnull %pts) #13
  %203 = load <2 x float>, ptr %triangle, align 4
  %204 = extractelement <2 x float> %203, i64 0
  %sub.i = fsub float %200, %204
  %205 = load <2 x float>, ptr %arrayidx5.i300, align 4
  %206 = shufflevector <2 x float> %203, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %207 = insertelement <2 x float> %206, float %201, i64 1
  %208 = fsub <2 x float> %205, %207
  %209 = insertelement <2 x float> %203, float %201, i64 1
  %210 = shufflevector <2 x float> %208, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  ...
  %216 = shufflevector <2 x float> %205, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %217 = insertelement <2 x float> %216, float %200, i64 0
  %218 = extractelement <2 x float> %205, i64 1
  ...
  %220 = load <2 x float>, ptr %arrayidx74, align 4
  %221 = fsub <2 x float> %220, %203
  %sub8.i310 = extractelement <2 x float> %221, i64 1
  %222 = insertelement <2 x float> %220, float %202, i64 1
  ...
  %227 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %208, <2 x float> %224, <2 x float> %226)
  ...
  %add14.i356 = fadd float %202, %mul7.i
  ...
  %sub14.i392 = fsub float %202, %mul7.i
...
invoke.cont109:                                   ; preds = %if.end67
  ...
  %254 = load ptr, ptr %m_softBody117, align 8
  %255 = load ptr, ptr %m_triBody, align 8
  %256 = load ptr, ptr %m_dispatchInfoPtr, align 8
  %m_resultOut125 = getelementptr inbounds %class.btSoftBodyTriangleCallback, ptr %this, i64 0, i32 5
  %257 = load ptr, ptr %m_resultOut125, align 8
  %vtable126 = load ptr, ptr %call121, align 8
  ...
  %vtable128 = load ptr, ptr %call121, align 8
  ...
  store ptr %250, ptr %m_collisionShape.i401, align 8
...
if.end.i:                                         ; preds = %entry
  ...
  %index.022.i = load i32, ptr %arrayidx.i.i, align 4
...
land.rhs.i:                                       ; preds = %while.body.i, %land.rhs.lr.ph.i
  ...
  %6 = load i32, ptr %arrayidx.i18.i, align 4
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  %index.0.i = load i32, ptr %arrayidx.i21.i, align 4
...
if.then.i:                                        ; preds = %if.end
  ...
  %cmp.i.i41 = icmp slt i32 %1, %cond.i.i
  br i1 %cmp.i.i41, label %if.then.i.i, label %_ZN20btAlignedObjectArrayI10btTriIndexE9push_backERKS0_.exit
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i.new
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx.i.i.i.1, ptr noundef nonnull align 8 dereferenceable(16) %arrayidx3.i.i.i.1, i64 16, i1 false)
...
for.body.i.i.i.epil:                              ; preds = %_ZNK20btAlignedObjectArrayI10btTriIndexE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx.i.i.i.epil, ptr noundef nonnull align 8 dereferenceable(16) %arrayidx3.i.i.i.epil, i64 16, i1 false)
...
_ZN20btAlignedObjectArrayI10btTriIndexE10deallocateEv.exit.i.i: ; preds = %if.then3.i.i.i, %_ZNK20btAlignedObjectArrayI10btTriIndexE4copyEiiPS0_.exit.i.i
  ...
  %.pre7.i = load i32, ptr %m_size.i, align 4
...
_ZN20btAlignedObjectArrayI10btTriIndexE9push_backERKS0_.exit: ; preds = %if.end, %if.then.i, %_ZN20btAlignedObjectArrayI10btTriIndexE10deallocateEv.exit.i.i
  ...
  %17 = load ptr, ptr %m_data.i38, align 8
  %idxprom.i39 = sext i32 %16 to i64
  %arrayidx.i40 = getelementptr inbounds %struct.btTriIndex, ptr %17, i64 %idxprom.i39
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx.i40, ptr noundef nonnull align 8 dereferenceable(16) %value, i64 16, i1 false)
  ...
  %19 = load i32, ptr %m_size.i.i42, align 4
  %m_capacity.i.i43 = getelementptr inbounds %class.btHashMap, ptr %this, i64 0, i32 3, i32 3
  %20 = load i32, ptr %m_capacity.i.i43, align 8
  %cmp.i44 = icmp eq i32 %19, %20
  br i1 %cmp.i44, label %if.then.i50, label %_ZN20btAlignedObjectArrayI9btHashKeyI10btTriIndexEE9push_backERKS2_.exit

if.then.i50:                                      ; preds = %_ZN20btAlignedObjectArrayI10btTriIndexE9push_backERKS0_.exit
  %tobool.not.i.i51 = icmp eq i32 %19, 0
  %mul.i.i52 = shl nsw i32 %19, 1
  %cond.i.i53 = select i1 %tobool.not.i.i51, i32 1, i32 %mul.i.i52
  %cmp.i.i54 = icmp slt i32 %19, %cond.i.i53
  br i1 %cmp.i.i54, label %if.then.i.i55, label %_ZN20btAlignedObjectArrayI9btHashKeyI10btTriIndexEE9push_backERKS2_.exit

if.then.i.i55:                                    ; preds = %if.then.i50
  %tobool.not.i.i.i56 = icmp eq i32 %cond.i.i53, 0
  br i1 %tobool.not.i.i.i56, label %_ZN20btAlignedObjectArrayI9btHashKeyI10btTriIndexEE8allocateEi.exit.i.i, label %if.then.i.i.i57

if.then.i.i.i57:                                  ; preds = %if.then.i.i55
  %conv.i.i.i.i58 = sext i32 %cond.i.i53 to i64
  %mul.i.i.i.i59 = shl nsw i64 %conv.i.i.i.i58, 2
  %call.i.i.i.i60 = tail call noundef ptr @_Z22btAlignedAllocInternalmi(i64 noundef %mul.i.i.i.i59, i32 noundef 16)
  %.pre.i61 = load i32, ptr %m_size.i.i42, align 4
  br label %_ZN20btAlignedObjectArrayI9btHashKeyI10btTriIndexEE8allocateEi.exit.i.i

_ZN20btAlignedObjectArrayI9btHashKeyI10btTriIndexEE8allocateEi.exit.i.i: ; preds = %if.then.i.i.i57, %if.then.i.i55
  %21 = phi i32 [ %.pre.i61, %if.then.i.i.i57 ], [ %19, %if.then.i.i55 ]
  %retval.0.i.i.i62 = phi ptr [ %call.i.i.i.i60, %if.then.i.i.i57 ], [ null, %if.then.i.i55 ]
  %cmp7.i.i.i63 = icmp sgt i32 %21, 0
  %m_data.i.i.i64 = getelementptr inbounds %class.btHashMap, ptr %this, i64 0, i32 3, i32 5
  %22 = load ptr, ptr %m_data.i.i.i64, align 8
  br i1 %cmp7.i.i.i63, label %for.body.lr.ph.i.i.i70, label %_ZNK20btAlignedObjectArrayI9btHashKeyI10btTriIndexEE4copyEiiPS2_.exit.i.i

for.body.lr.ph.i.i.i70:                           ; preds = %_ZN20btAlignedObjectArrayI9btHashKeyI10btTriIndexEE8allocateEi.exit.i.i
  %23 = ptrtoint ptr %22 to i64
  %retval.0.i.i.i62108 = ptrtoint ptr %retval.0.i.i.i62 to i64
  %wide.trip.count.i.i.i71 = zext i32 %21 to i64
  %min.iters.check = icmp ult i32 %21, 8
  %24 = sub i64 %retval.0.i.i.i62108, %23
  %diff.check = icmp ult i64 %24, 32
  %or.cond = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond, label %for.body.i.i.i72.preheader, label %vector.ph

vector.ph:                                        ; preds = %for.body.lr.ph.i.i.i70
  %n.vec = and i64 %wide.trip.count.i.i.i71, 4294967288
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %25 = getelementptr inbounds %class.btHashKey, ptr %retval.0.i.i.i62, i64 %index
  ...
  %wide.load109 = load <4 x i32>, ptr %27, align 4
  store <4 x i32> %wide.load, ptr %25, align 4
  %28 = getelementptr inbounds i32, ptr %25, i64 4
  store <4 x i32> %wide.load109, ptr %28, align 4
  %index.next = add nuw i64 %index, 8
  %29 = icmp eq i64 %index.next, %n.vec
  br i1 %29, label %middle.block, label %vector.body

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.vec, %wide.trip.count.i.i.i71
  br i1 %cmp.n, label %if.then.i11.i.i, label %for.body.i.i.i72.preheader

for.body.i.i.i72.preheader:                       ; preds = %for.body.lr.ph.i.i.i70, %middle.block
  %indvars.iv.i.i.i73.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i70 ], [ %n.vec, %middle.block ]
  %30 = xor i64 %indvars.iv.i.i.i73.ph, -1
  %31 = add nsw i64 %30, %wide.trip.count.i.i.i71
  %xtraiter111 = and i64 %wide.trip.count.i.i.i71, 3
  %lcmp.mod112.not = icmp eq i64 %xtraiter111, 0
  br i1 %lcmp.mod112.not, label %for.body.i.i.i72.prol.loopexit, label %for.body.i.i.i72.prol

for.body.i.i.i72.prol:                            ; preds = %for.body.i.i.i72.preheader, %for.body.i.i.i72.prol
  %indvars.iv.i.i.i73.prol = phi i64 [ %indvars.iv.next.i.i.i76.prol, %for.body.i.i.i72.prol ], [ %indvars.iv.i.i.i73.ph, %for.body.i.i.i72.preheader ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body.i.i.i72.prol ], [ 0, %for.body.i.i.i72.preheader ]
  %arrayidx.i.i.i74.prol = getelementptr inbounds %class.btHashKey, ptr %retval.0.i.i.i62, i64 %indvars.iv.i.i.i73.prol
  %arrayidx3.i.i.i75.prol = getelementptr inbounds %class.btHashKey, ptr %22, i64 %indvars.iv.i.i.i73.prol
  %32 = load i32, ptr %arrayidx3.i.i.i75.prol, align 4
  store i32 %32, ptr %arrayidx.i.i.i74.prol, align 4
  %indvars.iv.next.i.i.i76.prol = add nuw nsw i64 %indvars.iv.i.i.i73.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter111
  br i1 %prol.iter.cmp.not, label %for.body.i.i.i72.prol.loopexit, label %for.body.i.i.i72.prol

for.body.i.i.i72.prol.loopexit:                   ; preds = %for.body.i.i.i72.prol, %for.body.i.i.i72.preheader
  %indvars.iv.i.i.i73.unr = phi i64 [ %indvars.iv.i.i.i73.ph, %for.body.i.i.i72.preheader ], [ %indvars.iv.next.i.i.i76.prol, %for.body.i.i.i72.prol ]
  %33 = icmp ult i64 %31, 3
  br i1 %33, label %if.then.i11.i.i, label %for.body.i.i.i72

for.body.i.i.i72:                                 ; preds = %for.body.i.i.i72.prol.loopexit, %for.body.i.i.i72
  %indvars.iv.i.i.i73 = phi i64 [ %indvars.iv.next.i.i.i76.3, %for.body.i.i.i72 ], [ %indvars.iv.i.i.i73.unr, %for.body.i.i.i72.prol.loopexit ]
  %arrayidx.i.i.i74 = getelementptr inbounds %class.btHashKey, ptr %retval.0.i.i.i62, i64 %indvars.iv.i.i.i73
  %arrayidx3.i.i.i75 = getelementptr inbounds %class.btHashKey, ptr %22, i64 %indvars.iv.i.i.i73
  %34 = load i32, ptr %arrayidx3.i.i.i75, align 4
  store i32 %34, ptr %arrayidx.i.i.i74, align 4
  %indvars.iv.next.i.i.i76 = add nuw nsw i64 %indvars.iv.i.i.i73, 1
  %arrayidx.i.i.i74.1 = getelementptr inbounds %class.btHashKey, ptr %retval.0.i.i.i62, i64 %indvars.iv.next.i.i.i76
  %arrayidx3.i.i.i75.1 = getelementptr inbounds %class.btHashKey, ptr %22, i64 %indvars.iv.next.i.i.i76
  %35 = load i32, ptr %arrayidx3.i.i.i75.1, align 4
  store i32 %35, ptr %arrayidx.i.i.i74.1, align 4
  %indvars.iv.next.i.i.i76.1 = add nuw nsw i64 %indvars.iv.i.i.i73, 2
  %arrayidx.i.i.i74.2 = getelementptr inbounds %class.btHashKey, ptr %retval.0.i.i.i62, i64 %indvars.iv.next.i.i.i76.1
  %arrayidx3.i.i.i75.2 = getelementptr inbounds %class.btHashKey, ptr %22, i64 %indvars.iv.next.i.i.i76.1
  %36 = load i32, ptr %arrayidx3.i.i.i75.2, align 4
  store i32 %36, ptr %arrayidx.i.i.i74.2, align 4
  %indvars.iv.next.i.i.i76.2 = add nuw nsw i64 %indvars.iv.i.i.i73, 3
  %arrayidx.i.i.i74.3 = getelementptr inbounds %class.btHashKey, ptr %retval.0.i.i.i62, i64 %indvars.iv.next.i.i.i76.2
  %arrayidx3.i.i.i75.3 = getelementptr inbounds %class.btHashKey, ptr %22, i64 %indvars.iv.next.i.i.i76.2
  %37 = load i32, ptr %arrayidx3.i.i.i75.3, align 4
  store i32 %37, ptr %arrayidx.i.i.i74.3, align 4
  %indvars.iv.next.i.i.i76.3 = add nuw nsw i64 %indvars.iv.i.i.i73, 4
  %exitcond.not.i.i.i77.3 = icmp eq i64 %indvars.iv.next.i.i.i76.3, %wide.trip.count.i.i.i71
  br i1 %exitcond.not.i.i.i77.3, label %if.then.i11.i.i, label %for.body.i.i.i72
...
_ZNK20btAlignedObjectArrayI9btHashKeyI10btTriIndexEE4copyEiiPS2_.exit.i.i: ; preds = %_ZN20btAlignedObjectArrayI9btHashKeyI10btTriIndexEE8allocateEi.exit.i.i
  %tobool.not.i10.i.i65 = icmp eq ptr %22, null
  br i1 %tobool.not.i10.i.i65, label %_ZN20btAlignedObjectArrayI9btHashKeyI10btTriIndexEE10deallocateEv.exit.i.i, label %if.then.i11.i.i

if.then.i11.i.i:                                  ; preds = %for.body.i.i.i72.prol.loopexit, %for.body.i.i.i72, %middle.block, %_ZNK20btAlignedObjectArrayI9btHashKeyI10btTriIndexEE4copyEiiPS2_.exit.i.i
  %m_ownsMemory.i.i.i66 = getelementptr inbounds %class.btHashMap, ptr %this, i64 0, i32 3, i32 6
  %38 = load i8, ptr %m_ownsMemory.i.i.i66, align 8
  %tobool2.not.i.i.i67 = icmp eq i8 %38, 0
  br i1 %tobool2.not.i.i.i67, label %if.end.i.i.i, label %if.then3.i.i.i68

if.then3.i.i.i68:                                 ; preds = %if.then.i11.i.i
  tail call void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %22)
  br label %if.end.i.i.i

if.end.i.i.i:                                     ; preds = %if.then3.i.i.i68, %if.then.i11.i.i
  %.pre7.pre.i = load i32, ptr %m_size.i.i42, align 4
...
_ZN20btAlignedObjectArrayI9btHashKeyI10btTriIndexEE10deallocateEv.exit.i.i: ; preds = %if.end.i.i.i, %_ZNK20btAlignedObjectArrayI9btHashKeyI10btTriIndexEE4copyEiiPS2_.exit.i.i
  %.pre7.i69 = phi i32 [ %.pre7.pre.i, %if.end.i.i.i ], [ %21, %_ZNK20btAlignedObjectArrayI9btHashKeyI10btTriIndexEE4copyEiiPS2_.exit.i.i ]
  %m_ownsMemory.i.i = getelementptr inbounds %class.btHashMap, ptr %this, i64 0, i32 3, i32 6
  store i8 1, ptr %m_ownsMemory.i.i, align 8
  store ptr %retval.0.i.i.i62, ptr %m_data.i.i.i64, align 8
  store i32 %cond.i.i53, ptr %m_capacity.i.i43, align 8
  br label %_ZN20btAlignedObjectArrayI9btHashKeyI10btTriIndexEE9push_backERKS2_.exit

_ZN20btAlignedObjectArrayI9btHashKeyI10btTriIndexEE9push_backERKS2_.exit: ; preds = %_ZN20btAlignedObjectArrayI10btTriIndexE9push_backERKS0_.exit, %if.then.i50, %_ZN20btAlignedObjectArrayI9btHashKeyI10btTriIndexEE10deallocateEv.exit.i.i
  %39 = phi i32 [ %.pre7.i69, %_ZN20btAlignedObjectArrayI9btHashKeyI10btTriIndexEE10deallocateEv.exit.i.i ], [ %19, %if.then.i50 ], [ %19, %_ZN20btAlignedObjectArrayI10btTriIndexE9push_backERKS0_.exit ]
  %m_data.i46 = getelementptr inbounds %class.btHashMap, ptr %this, i64 0, i32 3, i32 5
  %40 = load ptr, ptr %m_data.i46, align 8
  %idxprom.i47 = sext i32 %39 to i64
  %arrayidx.i48 = getelementptr inbounds %class.btHashKey, ptr %40, i64 %idxprom.i47
  %41 = load i32, ptr %key, align 4
  store i32 %41, ptr %arrayidx.i48, align 4
  %42 = load i32, ptr %m_size.i.i42, align 4
  %inc.i49 = add nsw i32 %42, 1
  store i32 %inc.i49, ptr %m_size.i.i42, align 4
...
if.end20:                                         ; preds = %if.then14, %_ZN20btAlignedObjectArrayI9btHashKeyI10btTriIndexEE9push_backERKS2_.exit
  ...
  %m_data.i93 = getelementptr inbounds %class.btAlignedObjectArray, ptr %this, i64 0, i32 5
  %46 = load ptr, ptr %m_data.i93, align 8
  ...
  store i32 %47, ptr %arrayidx.i98, align 4
  store i32 %8, ptr %arrayidx.i95, align 4
  br label %cleanup
...
entry:
  ...
  %m_triBody = getelementptr inbounds %class.btSoftBodyTriangleCallback, ptr %this, i64 0, i32 2
  %8 = load ptr, ptr %m_triBody, align 8
  ...
  %10 = load float, ptr %arrayidx.i29.i.i, align 4
  %11 = load float, ptr %arrayidx.i30.i.i, align 4
  ...
  %43 = load <2 x float>, ptr %m_worldTransform.i, align 4
  %44 = load <2 x float>, ptr %arrayidx3.i.i, align 4
  %45 = load <2 x float>, ptr %arrayidx6.i.i, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i43.i, ptr %ref.tmp12.sroa.4.0..sroa_idx.i, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i55.i, ptr %ref.tmp15.sroa.4.0..sroa_idx.i, align 8
...
entry:
  ...
  %2 = load float, ptr %m_origin.i89, align 4
...
if.end:                                           ; preds = %entry
  ...
  %10 = load float, ptr %arrayidx.i28.i.i, align 4
  %11 = load float, ptr %arrayidx.i29.i.i, align 4
  %12 = load float, ptr %arrayidx.i30.i.i, align 4
  %m_origin.i91 = getelementptr inbounds %class.btCollisionObject, ptr %cond7, i64 0, i32 1, i32 1
  %13 = load float, ptr %m_origin.i91, align 4
  ...
  %23 = load float, ptr %arrayidx.i.i45.i.i108, align 4
  ...
  %24 = load float, ptr %arrayidx.i14.i46.i.i109, align 4
  ...
  %25 = load float, ptr %arrayidx.i16.i49.i.i111, align 4
  ...
  %30 = load <2 x float>, ptr %m_worldTransform.i90, align 4
  %31 = load <2 x float>, ptr %arrayidx3.i.i, align 4
  %32 = load <2 x float>, ptr %arrayidx6.i.i, align 4
  %33 = extractelement <2 x float> %31, i64 0
  %34 = extractelement <2 x float> %30, i64 0
  %35 = extractelement <2 x float> %32, i64 0
  %36 = load <2 x float>, ptr %m_worldTransform.i, align 4
  %37 = load <2 x float>, ptr %arrayidx4.i.i.i, align 4
  %38 = load <2 x float>, ptr %arrayidx9.i.i.i, align 4
  ...
  %68 = insertelement <2 x float> %67, float %fneg4.i.i, i64 1
  %69 = fmul <2 x float> %31, %68
  %70 = insertelement <2 x float> poison, float %2, i64 0
  %71 = insertelement <2 x float> %70, float %fneg.i.i, i64 1
  ...
  %74 = insertelement <2 x float> %73, float %fneg8.i.i, i64 1
  %75 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %32, <2 x float> %74, <2 x float> %72)
  %76 = shufflevector <2 x float> %68, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %77 = fmul <2 x float> %31, %76
  %78 = shufflevector <2 x float> %71, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %79 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %30, <2 x float> %78, <2 x float> %77)
  %80 = shufflevector <2 x float> %74, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %81 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %32, <2 x float> %80, <2 x float> %79)
  %82 = fadd <2 x float> %75, %81
  %83 = load <2 x float>, ptr %m_interpolationWorldTransform.i, align 4
  %84 = load <2 x float>, ptr %arrayidx4.i.i.i99, align 4
  %85 = load <2 x float>, ptr %arrayidx9.i.i.i102, align 4
  %86 = fmul <2 x float> %40, %84
  %87 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %83, <2 x float> %43, <2 x float> %86)
  %88 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %85, <2 x float> %46, <2 x float> %87)
  %89 = fmul <2 x float> %48, %84
  %90 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %83, <2 x float> %50, <2 x float> %89)
  %91 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %85, <2 x float> %52, <2 x float> %90)
  %mul7.i48.i.i110 = fmul float %33, %24
  %92 = tail call float @llvm.fmuladd.f32(float %23, float %34, float %mul7.i48.i.i110)
  %93 = tail call float @llvm.fmuladd.f32(float %25, float %35, float %92)
  %94 = fmul <2 x float> %59, %84
  %95 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %83, <2 x float> %61, <2 x float> %94)
  %96 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %85, <2 x float> %63, <2 x float> %95)
  %mul7.i67.i.i117 = fmul float %56, %24
  %97 = tail call float @llvm.fmuladd.f32(float %23, float %57, float %mul7.i67.i.i117)
  %98 = tail call float @llvm.fmuladd.f32(float %25, float %58, float %97)
  %99 = insertelement <2 x float> poison, float %28, i64 0
  %100 = shufflevector <2 x float> %99, <2 x float> poison, <2 x i32> zeroinitializer
  %101 = fmul <2 x float> %31, %100
  %102 = insertelement <2 x float> poison, float %1, i64 0
  %103 = shufflevector <2 x float> %102, <2 x float> poison, <2 x i32> zeroinitializer
  %104 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %30, <2 x float> %103, <2 x float> %101)
  %105 = insertelement <2 x float> poison, float %29, i64 0
  %106 = shufflevector <2 x float> %105, <2 x float> poison, <2 x i32> zeroinitializer
  %107 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %32, <2 x float> %106, <2 x float> %104)
  %108 = shufflevector <2 x float> %81, <2 x float> %75, <2 x i32> <i32 0, i32 3>
  ...
  %retval.sroa.3.12.vec.insert.i.i138231 = insertelement <2 x float> %120, float 0.000000e+00, i64 1
...
if.then19:                                        ; preds = %if.end
  ...
  store <2 x float> %82, ptr %rayAabbMin, align 8
  %convexFromLocal.sroa.22.48.rayAabbMin.sroa_idx = getelementptr inbounds i8, ptr %rayAabbMin, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i, ptr %convexFromLocal.sroa.22.48.rayAabbMin.sroa_idx, align 8
  %125 = extractelement <2 x float> %82, i64 0
...
_Z8btSetMinIfEvRT_RKS0_.exit.i:                   ; preds = %if.then.i.i, %if.then19
  ...
  %128 = extractelement <2 x float> %82, i64 1
  %129 = extractelement <2 x float> %109, i64 1
  %cmp.i17.i = fcmp olt float %129, %128
...
if.then.i18.i:                                    ; preds = %_Z8btSetMinIfEvRT_RKS0_.exit.i
  ...
  store float %129, ptr %arrayidx5.i154, align 4
...
_Z8btSetMinIfEvRT_RKS0_.exit19.i:                 ; preds = %if.then.i18.i, %_Z8btSetMinIfEvRT_RKS0_.exit.i
  %130 = phi float [ %129, %if.then.i18.i ], [ %128, %_Z8btSetMinIfEvRT_RKS0_.exit.i ]
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i, ptr %convexFromLocal.sroa.22.48.rayAabbMax.sroa_idx, align 8
  %132 = fcmp olt <2 x float> %82, %109
  %cmp.i20.i166 = fcmp olt float %add17.i.i, %add17.i.i135
  %133 = select i1 %cmp.i20.i166, float %add17.i.i135, float %add17.i.i
  ...
  store float %sub13.i, ptr %convexFromLocal.sroa.22.48.rayAabbMin.sroa_idx, align 8
  %140 = select <2 x i1> %132, <2 x float> %109, <2 x float> %82
  %141 = fadd <2 x float> %138, %140
  store <2 x float> %141, ptr %rayAabbMax, align 8
  %add13.i = fadd float %134, %133
  store float %add13.i, ptr %convexFromLocal.sroa.22.48.rayAabbMax.sroa_idx, align 8
  ...
  store float %55, ptr %convexFromLocal.sroa.6.0.m_ccdSphereFromTrans.i.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %convexFromLocal.sroa.7.0.m_ccdSphereFromTrans.i.sroa_idx, align 4
  ...
  store float %66, ptr %convexFromLocal.sroa.11.16.arrayidx8.i.i.i188.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %convexFromLocal.sroa.12.16.arrayidx8.i.i.i188.sroa_idx, align 4
  ...
  store float %20, ptr %convexFromLocal.sroa.16.32.arrayidx12.i.i.i189.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %convexFromLocal.sroa.17.32.arrayidx12.i.i.i189.sroa_idx, align 4
  %m_origin.i.i190 = getelementptr inbounds %struct.LocalTriangleSphereCastCallback, ptr %raycastCallback, i64 0, i32 1, i32 1
  store <2 x float> %82, ptr %m_origin.i.i190, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i, ptr %convexFromLocal.sroa.22.48.m_origin.i.i190.sroa_idx, align 8
  %m_ccdSphereToTrans.i = getelementptr inbounds %struct.LocalTriangleSphereCastCallback, ptr %raycastCallback, i64 0, i32 2
  store <2 x float> %91, ptr %m_ccdSphereToTrans.i, align 8
  ...
  store float %93, ptr %convexToLocal.sroa.6.0.m_ccdSphereToTrans.i.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %convexToLocal.sroa.7.0.m_ccdSphereToTrans.i.sroa_idx, align 4
  ...
  store <2 x float> %96, ptr %arrayidx8.i.i7.i, align 8
  ...
  store float %98, ptr %convexToLocal.sroa.11.16.arrayidx8.i.i7.i.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %convexToLocal.sroa.12.16.arrayidx8.i.i7.i.sroa_idx, align 4
  ...
  store <2 x float> %88, ptr %arrayidx12.i.i9.i, align 8
  ...
  store float %27, ptr %convexToLocal.sroa.16.32.arrayidx12.i.i9.i.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %convexToLocal.sroa.17.32.arrayidx12.i.i9.i.sroa_idx, align 4
  %m_origin.i10.i = getelementptr inbounds %struct.LocalTriangleSphereCastCallback, ptr %raycastCallback, i64 0, i32 2, i32 1
  store <2 x float> %109, ptr %m_origin.i10.i, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i138231, ptr %convexToLocal.sroa.24.48.m_origin.i10.i.sroa_idx, align 8
  ...
  %142 = load float, ptr %m_hitFraction.i191, align 4
...
if.end37:                                         ; preds = %_Z8btSetMinIfEvRT_RKS0_.exit19.i
  ...
  %.pre228 = load float, ptr %m_hitFraction.i191, align 4
...
cleanup:                                          ; preds = %if.end37
  store float %.pre, ptr %m_hitFraction.i191, align 4
  call void @_ZN18btTriangleCallbackD2Ev(ptr noundef nonnull align 8 dereferenceable(208) %raycastCallback)
  call void @llvm.lifetime.end.p0(i64 208, ptr nonnull %raycastCallback) #13
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %rayAabbMax) #13
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %rayAabbMin) #13
...
entry:
  ...
  store ptr getelementptr inbounds ({ [6 x ptr] }, ptr @_ZTVN12btConvexCast10CastResultE, i64 0, inrange i32 0, i64 2), ptr %castResult, align 8
  ...
  store ptr getelementptr inbounds ({ [20 x ptr] }, ptr @_ZTV13btSphereShape, i64 0, inrange i32 0, i64 2), ptr %pointShape, align 8
...
invoke.cont7:                                     ; preds = %entry
  ...
  store ptr getelementptr inbounds ({ [28 x ptr] }, ptr @_ZTV15btTriangleShape, i64 0, inrange i32 0, i64 2), ptr %triShape, align 8
  ...
  store i32 1, ptr %m_shapeType.i42, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_vertices1.i, ptr noundef nonnull align 4 dereferenceable(16) %triangle, i64 16, i1 false)
...
if.then5.i.for.body10.lr.ph.i_crit_edge:          ; preds = %if.then5.i
  %m_data11.i.phi.trans.insert = getelementptr inbounds %class.btAlignedObjectArray, ptr %this, i64 0, i32 5
  %.pre = load ptr, ptr %m_data11.i.phi.trans.insert, align 8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load123 = load <4 x i32>, ptr %9, align 4
  store <4 x i32> %wide.load, ptr %7, align 4
  %10 = getelementptr inbounds i32, ptr %7, i64 4
  store <4 x i32> %wide.load123, ptr %10, align 4
  %index.next = add nuw i64 %index, 8
...
for.body.i.i.i.prol:                              ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i.prol
  ...
  %14 = load i32, ptr %arrayidx3.i.i.i.prol, align 4
  store i32 %14, ptr %arrayidx.i.i.i.prol, align 4
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  ...
  %17 = load i32, ptr %arrayidx3.i.i.i.1, align 4
  store i32 %17, ptr %arrayidx.i.i.i.1, align 4
  %indvars.iv.next.i.i.i.1 = add nuw nsw i64 %indvars.iv.i.i.i, 2
  ...
  %18 = load i32, ptr %arrayidx3.i.i.i.2, align 4
  store i32 %18, ptr %arrayidx.i.i.i.2, align 4
  ...
  %19 = load i32, ptr %arrayidx3.i.i.i.3, align 4
  store i32 %19, ptr %arrayidx.i.i.i.3, align 4
...
if.end.thread36.i:                                ; preds = %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i
  %m_ownsMemory.i37.i = getelementptr inbounds %class.btAlignedObjectArray, ptr %this, i64 0, i32 6
...
for.body10.lr.ph.i:                               ; preds = %if.then5.i.for.body10.lr.ph.i_crit_edge, %if.end.i, %if.end.thread36.i
  ...
  tail call void @llvm.memset.p0.i64(ptr align 4 %scevgep, i8 0, i64 %25, i1 false)
  store i32 %0, ptr %m_size.i, align 4
  %m_size.i.i50 = getelementptr inbounds %class.btHashMap, ptr %this, i64 0, i32 1, i32 2
  %26 = load i32, ptr %m_size.i.i50, align 4
  %cmp4.i53 = icmp slt i32 %26, %0
  br i1 %cmp4.i53, label %if.then5.i54, label %_ZN20btAlignedObjectArrayIiE6resizeEiRKi.exit94

if.then5.i54:                                     ; preds = %for.body10.lr.ph.i
  %m_capacity.i.i.i55 = getelementptr inbounds %class.btHashMap, ptr %this, i64 0, i32 1, i32 3
  %27 = load i32, ptr %m_capacity.i.i.i55, align 8
  %cmp.i.i56 = icmp slt i32 %27, %0
  br i1 %cmp.i.i56, label %if.then.i.i65, label %if.then5.i54.for.body10.lr.ph.i57_crit_edge

if.then5.i54.for.body10.lr.ph.i57_crit_edge:      ; preds = %if.then5.i54
  %m_data11.i58.phi.trans.insert = getelementptr inbounds %class.btHashMap, ptr %this, i64 0, i32 1, i32 5
  %.pre121 = load ptr, ptr %m_data11.i58.phi.trans.insert, align 8
  br label %for.body10.lr.ph.i57

if.then.i.i65:                                    ; preds = %if.then5.i54
  %tobool.not.i.i.i66 = icmp eq i32 %0, 0
  br i1 %tobool.not.i.i.i66, label %_ZN20btAlignedObjectArrayIiE8allocateEi.exit.i.i72, label %if.then.i.i.i67

if.then.i.i.i67:                                  ; preds = %if.then.i.i65
  %call.i.i.i.i70 = tail call noundef ptr @_Z22btAlignedAllocInternalmi(i64 noundef %24, i32 noundef 16)
  %.pre.i71 = load i32, ptr %m_size.i.i50, align 4
  br label %_ZN20btAlignedObjectArrayIiE8allocateEi.exit.i.i72

_ZN20btAlignedObjectArrayIiE8allocateEi.exit.i.i72: ; preds = %if.then.i.i.i67, %if.then.i.i65
  %28 = phi i32 [ %.pre.i71, %if.then.i.i.i67 ], [ %26, %if.then.i.i65 ]
  %retval.0.i.i.i73 = phi ptr [ %call.i.i.i.i70, %if.then.i.i.i67 ], [ null, %if.then.i.i65 ]
  %cmp7.i.i.i74 = icmp sgt i32 %28, 0
  %m_data.i.i.i75 = getelementptr inbounds %class.btHashMap, ptr %this, i64 0, i32 1, i32 5
  %29 = load ptr, ptr %m_data.i.i.i75, align 8
  br i1 %cmp7.i.i.i74, label %for.body.lr.ph.i.i.i86, label %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i76

for.body.lr.ph.i.i.i86:                           ; preds = %_ZN20btAlignedObjectArrayIiE8allocateEi.exit.i.i72
  %30 = ptrtoint ptr %29 to i64
  %retval.0.i.i.i73125 = ptrtoint ptr %retval.0.i.i.i73 to i64
  %wide.trip.count.i.i.i87 = zext i32 %28 to i64
  %min.iters.check129 = icmp ult i32 %28, 8
  %31 = sub i64 %retval.0.i.i.i73125, %30
  %diff.check126 = icmp ult i64 %31, 32
  %or.cond140 = select i1 %min.iters.check129, i1 true, i1 %diff.check126
  br i1 %or.cond140, label %for.body.i.i.i88.preheader, label %vector.ph130

vector.ph130:                                     ; preds = %for.body.lr.ph.i.i.i86
  %n.vec132 = and i64 %wide.trip.count.i.i.i87, 4294967288
...
vector.body135:                                   ; preds = %vector.body135, %vector.ph130
  ...
  %32 = getelementptr inbounds i32, ptr %retval.0.i.i.i73, i64 %index136
  %33 = getelementptr inbounds i32, ptr %29, i64 %index136
  %wide.load137 = load <4 x i32>, ptr %33, align 4
  %34 = getelementptr inbounds i32, ptr %33, i64 4
  %wide.load138 = load <4 x i32>, ptr %34, align 4
  store <4 x i32> %wide.load137, ptr %32, align 4
  %35 = getelementptr inbounds i32, ptr %32, i64 4
  store <4 x i32> %wide.load138, ptr %35, align 4
  %index.next139 = add nuw i64 %index136, 8
  %36 = icmp eq i64 %index.next139, %n.vec132
  br i1 %36, label %middle.block127, label %vector.body135

middle.block127:                                  ; preds = %vector.body135
  %cmp.n134 = icmp eq i64 %n.vec132, %wide.trip.count.i.i.i87
  br i1 %cmp.n134, label %if.then.i11.i.i78, label %for.body.i.i.i88.preheader

for.body.i.i.i88.preheader:                       ; preds = %for.body.lr.ph.i.i.i86, %middle.block127
  %indvars.iv.i.i.i89.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i86 ], [ %n.vec132, %middle.block127 ]
  %37 = xor i64 %indvars.iv.i.i.i89.ph, -1
  %38 = add nsw i64 %37, %wide.trip.count.i.i.i87
  %xtraiter141 = and i64 %wide.trip.count.i.i.i87, 3
  %lcmp.mod142.not = icmp eq i64 %xtraiter141, 0
  br i1 %lcmp.mod142.not, label %for.body.i.i.i88.prol.loopexit, label %for.body.i.i.i88.prol

for.body.i.i.i88.prol:                            ; preds = %for.body.i.i.i88.preheader, %for.body.i.i.i88.prol
  %indvars.iv.i.i.i89.prol = phi i64 [ %indvars.iv.next.i.i.i92.prol, %for.body.i.i.i88.prol ], [ %indvars.iv.i.i.i89.ph, %for.body.i.i.i88.preheader ]
  %prol.iter143 = phi i64 [ %prol.iter143.next, %for.body.i.i.i88.prol ], [ 0, %for.body.i.i.i88.preheader ]
  %arrayidx.i.i.i90.prol = getelementptr inbounds i32, ptr %retval.0.i.i.i73, i64 %indvars.iv.i.i.i89.prol
  %arrayidx3.i.i.i91.prol = getelementptr inbounds i32, ptr %29, i64 %indvars.iv.i.i.i89.prol
  %39 = load i32, ptr %arrayidx3.i.i.i91.prol, align 4
  store i32 %39, ptr %arrayidx.i.i.i90.prol, align 4
  %indvars.iv.next.i.i.i92.prol = add nuw nsw i64 %indvars.iv.i.i.i89.prol, 1
  %prol.iter143.next = add i64 %prol.iter143, 1
  %prol.iter143.cmp.not = icmp eq i64 %prol.iter143.next, %xtraiter141
  br i1 %prol.iter143.cmp.not, label %for.body.i.i.i88.prol.loopexit, label %for.body.i.i.i88.prol

for.body.i.i.i88.prol.loopexit:                   ; preds = %for.body.i.i.i88.prol, %for.body.i.i.i88.preheader
  %indvars.iv.i.i.i89.unr = phi i64 [ %indvars.iv.i.i.i89.ph, %for.body.i.i.i88.preheader ], [ %indvars.iv.next.i.i.i92.prol, %for.body.i.i.i88.prol ]
  %40 = icmp ult i64 %38, 3
  br i1 %40, label %if.then.i11.i.i78, label %for.body.i.i.i88

for.body.i.i.i88:                                 ; preds = %for.body.i.i.i88.prol.loopexit, %for.body.i.i.i88
  %indvars.iv.i.i.i89 = phi i64 [ %indvars.iv.next.i.i.i92.3, %for.body.i.i.i88 ], [ %indvars.iv.i.i.i89.unr, %for.body.i.i.i88.prol.loopexit ]
  %arrayidx.i.i.i90 = getelementptr inbounds i32, ptr %retval.0.i.i.i73, i64 %indvars.iv.i.i.i89
  %arrayidx3.i.i.i91 = getelementptr inbounds i32, ptr %29, i64 %indvars.iv.i.i.i89
  %41 = load i32, ptr %arrayidx3.i.i.i91, align 4
  store i32 %41, ptr %arrayidx.i.i.i90, align 4
  %indvars.iv.next.i.i.i92 = add nuw nsw i64 %indvars.iv.i.i.i89, 1
  %arrayidx.i.i.i90.1 = getelementptr inbounds i32, ptr %retval.0.i.i.i73, i64 %indvars.iv.next.i.i.i92
  %arrayidx3.i.i.i91.1 = getelementptr inbounds i32, ptr %29, i64 %indvars.iv.next.i.i.i92
  %42 = load i32, ptr %arrayidx3.i.i.i91.1, align 4
  store i32 %42, ptr %arrayidx.i.i.i90.1, align 4
  %indvars.iv.next.i.i.i92.1 = add nuw nsw i64 %indvars.iv.i.i.i89, 2
  %arrayidx.i.i.i90.2 = getelementptr inbounds i32, ptr %retval.0.i.i.i73, i64 %indvars.iv.next.i.i.i92.1
  %arrayidx3.i.i.i91.2 = getelementptr inbounds i32, ptr %29, i64 %indvars.iv.next.i.i.i92.1
  %43 = load i32, ptr %arrayidx3.i.i.i91.2, align 4
  store i32 %43, ptr %arrayidx.i.i.i90.2, align 4
  %indvars.iv.next.i.i.i92.2 = add nuw nsw i64 %indvars.iv.i.i.i89, 3
  %arrayidx.i.i.i90.3 = getelementptr inbounds i32, ptr %retval.0.i.i.i73, i64 %indvars.iv.next.i.i.i92.2
  %arrayidx3.i.i.i91.3 = getelementptr inbounds i32, ptr %29, i64 %indvars.iv.next.i.i.i92.2
  %44 = load i32, ptr %arrayidx3.i.i.i91.3, align 4
  store i32 %44, ptr %arrayidx.i.i.i90.3, align 4
  %indvars.iv.next.i.i.i92.3 = add nuw nsw i64 %indvars.iv.i.i.i89, 4
  %exitcond.not.i.i.i93.3 = icmp eq i64 %indvars.iv.next.i.i.i92.3, %wide.trip.count.i.i.i87
  br i1 %exitcond.not.i.i.i93.3, label %if.then.i11.i.i78, label %for.body.i.i.i88

_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i76: ; preds = %_ZN20btAlignedObjectArrayIiE8allocateEi.exit.i.i72
  %tobool.not.i10.i.i77 = icmp eq ptr %29, null
  br i1 %tobool.not.i10.i.i77, label %if.end.thread36.i84, label %if.then.i11.i.i78

if.end.thread36.i84:                              ; preds = %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i76
  %m_ownsMemory.i37.i85 = getelementptr inbounds %class.btHashMap, ptr %this, i64 0, i32 1, i32 6
  store i8 1, ptr %m_ownsMemory.i37.i85, align 8
  store ptr %retval.0.i.i.i73, ptr %m_data.i.i.i75, align 8
  store i32 %0, ptr %m_capacity.i.i.i55, align 8
  br label %for.body10.lr.ph.i57

if.then.i11.i.i78:                                ; preds = %for.body.i.i.i88.prol.loopexit, %for.body.i.i.i88, %middle.block127, %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i76
  %m_ownsMemory.i.i.i79 = getelementptr inbounds %class.btHashMap, ptr %this, i64 0, i32 1, i32 6
  %45 = load i8, ptr %m_ownsMemory.i.i.i79, align 8
  %tobool2.not.i.i.i80 = icmp eq i8 %45, 0
  br i1 %tobool2.not.i.i.i80, label %if.end.i82, label %if.then3.i.i.i81

if.then3.i.i.i81:                                 ; preds = %if.then.i11.i.i78
  tail call void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %29)
  br label %if.end.i82

if.end.i82:                                       ; preds = %if.then3.i.i.i81, %if.then.i11.i.i78
  store i8 1, ptr %m_ownsMemory.i.i.i79, align 8
  store ptr %retval.0.i.i.i73, ptr %m_data.i.i.i75, align 8
  store i32 %0, ptr %m_capacity.i.i.i55, align 8
  br label %for.body10.lr.ph.i57

for.body10.lr.ph.i57:                             ; preds = %if.then5.i54.for.body10.lr.ph.i57_crit_edge, %if.end.i82, %if.end.thread36.i84
  %46 = phi ptr [ %.pre121, %if.then5.i54.for.body10.lr.ph.i57_crit_edge ], [ %retval.0.i.i.i73, %if.end.i82 ], [ %retval.0.i.i.i73, %if.end.thread36.i84 ]
  %47 = sext i32 %26 to i64
  %48 = shl nsw i64 %47, 2
  %scevgep117 = getelementptr i8, ptr %46, i64 %48
  %49 = sub nsw i64 %24, %48
  tail call void @llvm.memset.p0.i64(ptr align 4 %scevgep117, i8 0, i64 %49, i1 false)
  br label %_ZN20btAlignedObjectArrayIiE6resizeEiRKi.exit94

_ZN20btAlignedObjectArrayIiE6resizeEiRKi.exit94:  ; preds = %for.body10.lr.ph.i57, %for.body10.lr.ph.i
...
for.body12.lr.ph:                                 ; preds = %_ZN20btAlignedObjectArrayIiE6resizeEiRKi.exit94
  %50 = load ptr, ptr %m_data11.i, align 8
  %51 = zext i32 %0 to i64
  %52 = shl nuw nsw i64 %51, 2
  tail call void @llvm.memset.p0.i64(ptr align 4 %50, i8 -1, i64 %52, i1 false)
  %m_data.i95 = getelementptr inbounds %class.btHashMap, ptr %this, i64 0, i32 1, i32 5
  %53 = load ptr, ptr %m_data.i95, align 8
  %54 = zext i32 %0 to i64
  %55 = shl nuw nsw i64 %54, 2
  tail call void @llvm.memset.p0.i64(ptr align 4 %53, i8 -1, i64 %55, i1 false)
...
for.body20:                                       ; preds = %for.body20.lr.ph, %for.body20
  ...
  %59 = load i32, ptr %arrayidx.i100, align 4
  %shl.i = shl i32 %59, 15
  %not.i = xor i32 %shl.i, -1
  ...
  %61 = load i32, ptr %arrayidx.i104, align 4
  %arrayidx.i107 = getelementptr inbounds i32, ptr %58, i64 %indvars.iv
  store i32 %61, ptr %arrayidx.i107, align 4
  %62 = trunc i64 %indvars.iv to i32
  store i32 %62, ptr %arrayidx.i104, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
