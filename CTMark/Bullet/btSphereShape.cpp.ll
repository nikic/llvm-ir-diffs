; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSphereShape.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSphereShape.cpp"
...
entry:
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i, ptr %ref.tmp11.sroa.4.0..sroa_idx, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i25, ptr %ref.tmp13.sroa.4.0..sroa_idx, align 4
  ret void
}
...
entry:
  ...
  store <4 x float> %3, ptr %inertia, align 4
  ret void
}
