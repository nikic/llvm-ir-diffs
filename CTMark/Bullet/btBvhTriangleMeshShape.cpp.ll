; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btBvhTriangleMeshShape.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btBvhTriangleMeshShape.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [17 x ptr] }, ptr @_ZTV22btBvhTriangleMeshShape, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
if.then:                                          ; preds = %invoke.cont6
  %vtable7 = load ptr, ptr %meshInterface, align 8
...
invoke.cont19:                                    ; preds = %invoke.cont14
  store ptr %call15, ptr %m_bvh, align 8
  %3 = load i8, ptr %m_useQuantizedAabbCompression, align 8
...
_ZN9btVector36setMinERKS_.exit:                   ; preds = %_Z8btSetMinIfEvRT_RKS0_.exit22.i, %if.then.i24.i
  ...
  br i1 %cmp.i.i4, label %if.then.i.i17, label %_Z8btSetMaxIfEvRT_RKS0_.exit.i
...
_Z8btSetMaxIfEvRT_RKS0_.exit.i:                   ; preds = %if.then.i.i17, %_ZN9btVector36setMinERKS_.exit
  %arrayidx5.i5 = getelementptr inbounds %class.btTriangleMeshShape, ptr %this, i64 0, i32 2, i32 0, i64 1
  %arrayidx7.i6 = getelementptr inbounds [4 x float], ptr %aabbMax, i64 0, i64 1
  %12 = load float, ptr %arrayidx5.i5, align 8
  %13 = load float, ptr %arrayidx7.i6, align 4
  %cmp.i17.i7 = fcmp olt float %12, %13
  br i1 %cmp.i17.i7, label %if.then.i18.i16, label %_Z8btSetMaxIfEvRT_RKS0_.exit19.i

if.then.i18.i16:                                  ; preds = %_Z8btSetMaxIfEvRT_RKS0_.exit.i
  store float %13, ptr %arrayidx5.i5, align 8
  br label %_Z8btSetMaxIfEvRT_RKS0_.exit19.i

_Z8btSetMaxIfEvRT_RKS0_.exit19.i:                 ; preds = %if.then.i18.i16, %_Z8btSetMaxIfEvRT_RKS0_.exit.i
  %arrayidx9.i8 = getelementptr inbounds %class.btTriangleMeshShape, ptr %this, i64 0, i32 2, i32 0, i64 2
  %arrayidx11.i9 = getelementptr inbounds [4 x float], ptr %aabbMax, i64 0, i64 2
  %14 = load float, ptr %arrayidx9.i8, align 4
  %15 = load float, ptr %arrayidx11.i9, align 4
  %cmp.i20.i10 = fcmp olt float %14, %15
  br i1 %cmp.i20.i10, label %if.then.i21.i15, label %_Z8btSetMaxIfEvRT_RKS0_.exit22.i

if.then.i21.i15:                                  ; preds = %_Z8btSetMaxIfEvRT_RKS0_.exit19.i
  store float %15, ptr %arrayidx9.i8, align 4
  br label %_Z8btSetMaxIfEvRT_RKS0_.exit22.i

_Z8btSetMaxIfEvRT_RKS0_.exit22.i:                 ; preds = %if.then.i21.i15, %_Z8btSetMaxIfEvRT_RKS0_.exit19.i
  %arrayidx13.i11 = getelementptr inbounds %class.btTriangleMeshShape, ptr %this, i64 0, i32 2, i32 0, i64 3
  %arrayidx.i.i12 = getelementptr inbounds [4 x float], ptr %aabbMax, i64 0, i64 3
  %16 = load float, ptr %arrayidx13.i11, align 8
  %17 = load float, ptr %arrayidx.i.i12, align 4
  %cmp.i23.i13 = fcmp olt float %16, %17
  br i1 %cmp.i23.i13, label %if.then.i24.i14, label %_ZN9btVector36setMaxERKS_.exit

if.then.i24.i14:                                  ; preds = %_Z8btSetMaxIfEvRT_RKS0_.exit22.i
  store float %17, ptr %arrayidx13.i11, align 8
  br label %_ZN9btVector36setMaxERKS_.exit

_ZN9btVector36setMaxERKS_.exit:                   ; preds = %_Z8btSetMaxIfEvRT_RKS0_.exit22.i, %if.then.i24.i14
  ret void
}
...
define linkonce_odr dso_local void @_ZN21btNodeOverlapCallbackD2Ev(ptr noundef nonnull align 8 dereferenceable(8) %this) unnamed_addr #4 comdat align 2 {
entry:
  ret void
}

; Function Attrs: uwtable
define dso_local void @_ZN22btBvhTriangleMeshShape15setLocalScalingERK9btVector3(ptr noundef nonnull align 8 dereferenceable(93) %this, ptr noundef nonnull align 4 dereferenceable(16) %scaling) unnamed_addr #5 align 2 personality ptr @__gxx_personality_v0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %m_ownsBvh = getelementptr inbounds %class.btBvhTriangleMeshShape, ptr %this, i64 0, i32 3
  %9 = load i8, ptr %m_ownsBvh, align 1
  %tobool.not = icmp eq i8 %9, 0
  br i1 %tobool.not, label %if.end, label %if.then4

if.then4:                                         ; preds = %if.then
  %m_bvh = getelementptr inbounds %class.btBvhTriangleMeshShape, ptr %this, i64 0, i32 1
  %10 = load ptr, ptr %m_bvh, align 8
...
if.end:                                           ; preds = %if.then4, %if.then
  ...
  store ptr %call8, ptr %m_bvh11, align 8
  %m_meshInterface = getelementptr inbounds %class.btTriangleMeshShape, ptr %this, i64 0, i32 3
  %13 = load ptr, ptr %m_meshInterface, align 8
  %m_useQuantizedAabbCompression = getelementptr inbounds %class.btBvhTriangleMeshShape, ptr %this, i64 0, i32 2
  %14 = load i8, ptr %m_useQuantizedAabbCompression, align 8
...
; Function Attrs: uwtable
define dso_local void @_ZN22btBvhTriangleMeshShape15setOptimizedBvhEP14btOptimizedBvhRK9btVector3(ptr noundef nonnull align 8 dereferenceable(93) %this, ptr noundef %bvh, ptr noundef nonnull align 4 dereferenceable(16) %scaling) local_unnamed_addr #5 align 2 {
entry:
  %m_bvh = getelementptr inbounds %class.btBvhTriangleMeshShape, ptr %this, i64 0, i32 1
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local noundef ptr @_ZNK22btBvhTriangleMeshShape7getNameEv(ptr noundef nonnull align 8 dereferenceable(93) %this) unnamed_addr #4 comdat align 2 {
entry:
  ret ptr @.str
}

; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN14btConcaveShape9setMarginEf(ptr noundef nonnull align 8 dereferenceable(28) %this, float noundef %collisionMargin) unnamed_addr #4 comdat align 2 {
entry:
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local noundef float @_ZNK14btConcaveShape9getMarginEv(ptr noundef nonnull align 8 dereferenceable(28) %this) unnamed_addr #4 comdat align 2 {
entry:
  %m_collisionMargin = getelementptr inbounds %class.btConcaveShape, ptr %this, i64 0, i32 1
...
; Function Attrs: uwtable
define linkonce_odr dso_local { <2 x float>, <2 x float> } @_ZNK19btTriangleMeshShape37localGetSupportingVertexWithoutMarginERK9btVector3(ptr noundef nonnull align 8 dereferenceable(72) %this, ptr noundef nonnull align 4 dereferenceable(16) %vec) unnamed_addr #5 comdat align 2 {
entry:
  %vtable = load ptr, ptr %this, align 8
...
for.body.us.preheader:                            ; preds = %arrayctor.cont.split.us
  ...
  %9 = load i32, ptr %arrayidx5.us, align 4
  ...
  %10 = load float, ptr %arrayidx19.us, align 4
  %11 = load float, ptr %arrayidx.i72, align 4
  %mul21.us = fmul float %10, %11
  %arrayidx23.us = getelementptr inbounds [3 x %class.btVector3], ptr %m_triangle, i64 0, i64 2
  %12 = load <2 x float>, ptr %add.ptr9.us, align 4
  %13 = load <2 x float>, ptr %m_scaling.i, align 4
  ...
  store float %mul21.us, ptr %ref.tmp.sroa.5.0.arrayidx23.sroa_idx.us, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp.sroa.6.0.arrayidx23.sroa_idx.us, align 4
  %arrayidx5.us.1 = getelementptr inbounds i32, ptr %add.ptr, i64 1
  %15 = load i32, ptr %arrayidx5.us.1, align 4
  ...
  %16 = load float, ptr %arrayidx19.us.1, align 4
  %17 = load float, ptr %arrayidx.i72, align 4
  %mul21.us.1 = fmul float %16, %17
  %arrayidx23.us.1 = getelementptr inbounds [3 x %class.btVector3], ptr %m_triangle, i64 0, i64 1
  %18 = load <2 x float>, ptr %add.ptr9.us.1, align 4
  %19 = load <2 x float>, ptr %m_scaling.i, align 4
  ...
  store float %mul21.us.1, ptr %ref.tmp.sroa.5.0.arrayidx23.sroa_idx.us.1, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp.sroa.6.0.arrayidx23.sroa_idx.us.1, align 4
  ...
  %22 = load float, ptr %add.ptr9.us.2, align 4
  %23 = load float, ptr %m_scaling.i, align 4
  %mul13.us.2 = fmul float %22, %23
  %arrayidx15.us.2 = getelementptr inbounds float, ptr %add.ptr9.us.2, i64 1
  %24 = load <2 x float>, ptr %arrayidx15.us.2, align 4
  %25 = load <2 x float>, ptr %arrayidx.i71, align 4
  %26 = fmul <2 x float> %24, %25
  store float %mul13.us.2, ptr %m_triangle, align 16
  br label %for.cond.cleanup

for.body.us.us.preheader:                         ; preds = %arrayctor.cont.split.us
  %arrayidx.us.us = getelementptr inbounds i16, ptr %add.ptr, i64 2
  %27 = load i16, ptr %arrayidx.us.us, align 2
  ...
  %28 = load float, ptr %arrayidx19.us.us, align 4
  %29 = load float, ptr %arrayidx.i72, align 4
  %mul21.us.us = fmul float %28, %29
  %arrayidx23.us.us = getelementptr inbounds [3 x %class.btVector3], ptr %m_triangle, i64 0, i64 2
  %30 = load <2 x float>, ptr %add.ptr9.us.us, align 4
  %31 = load <2 x float>, ptr %m_scaling.i, align 4
  ...
  store float %mul21.us.us, ptr %ref.tmp.sroa.5.0.arrayidx23.sroa_idx.us.us, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp.sroa.6.0.arrayidx23.sroa_idx.us.us, align 4
  %arrayidx.us.us.1 = getelementptr inbounds i16, ptr %add.ptr, i64 1
  %33 = load i16, ptr %arrayidx.us.us.1, align 2
  ...
  %34 = load float, ptr %arrayidx19.us.us.1, align 4
  %35 = load float, ptr %arrayidx.i72, align 4
  %mul21.us.us.1 = fmul float %34, %35
  %arrayidx23.us.us.1 = getelementptr inbounds [3 x %class.btVector3], ptr %m_triangle, i64 0, i64 1
  %36 = load <2 x float>, ptr %add.ptr9.us.us.1, align 4
  ...
  store float %mul21.us.us.1, ptr %ref.tmp.sroa.5.0.arrayidx23.sroa_idx.us.us.1, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp.sroa.6.0.arrayidx23.sroa_idx.us.us.1, align 4
  ...
  %40 = load float, ptr %add.ptr9.us.us.2, align 4
  %41 = load float, ptr %m_scaling.i, align 4
  %mul13.us.us.2 = fmul float %40, %41
  %arrayidx15.us.us.2 = getelementptr inbounds float, ptr %add.ptr9.us.us.2, i64 1
  %42 = load <2 x float>, ptr %arrayidx15.us.us.2, align 4
  %43 = load <2 x float>, ptr %arrayidx.i71, align 4
  %44 = fmul <2 x float> %42, %43
  store float %mul13.us.us.2, ptr %m_triangle, align 16
  br label %for.cond.cleanup
...
for.body.preheader:                               ; preds = %arrayctor.cont.split
  ...
  %45 = load i32, ptr %arrayidx5, align 4
  ...
  store float %mul43, ptr %ref.tmp28.sroa.5.0.arrayidx45.sroa_idx, align 8
  %ref.tmp28.sroa.6.0.arrayidx45.sroa_idx = getelementptr inbounds [3 x %class.btVector3], ptr %m_triangle, i64 0, i64 2, i32 0, i64 3
  store float 0.000000e+00, ptr %ref.tmp28.sroa.6.0.arrayidx45.sroa_idx, align 4
  %arrayidx5.1 = getelementptr inbounds i32, ptr %add.ptr, i64 1
  %52 = load i32, ptr %arrayidx5.1, align 4
  ...
  store float %mul43.1, ptr %ref.tmp28.sroa.5.0.arrayidx45.sroa_idx.1, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp28.sroa.6.0.arrayidx45.sroa_idx.1, align 4
...
for.body.us77.preheader:                          ; preds = %arrayctor.cont.split
  ...
  store float %mul43.us, ptr %ref.tmp28.sroa.5.0.arrayidx45.sroa_idx.us, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp28.sroa.6.0.arrayidx45.sroa_idx.us, align 4
  %arrayidx.us81.1 = getelementptr inbounds i16, ptr %add.ptr, i64 1
  %73 = load i16, ptr %arrayidx.us81.1, align 2
  ...
  %74 = load double, ptr %arrayidx40.us.1, align 8
  %conv41.us.1 = fptrunc double %74 to float
  %75 = load float, ptr %arrayidx.i72, align 4
  ...
  %76 = load <2 x double>, ptr %add.ptr27.us.1, align 8
  %77 = fptrunc <2 x double> %76 to <2 x float>
  %78 = load <2 x float>, ptr %m_scaling.i, align 4
  ...
  store float %mul43.us.1, ptr %ref.tmp28.sroa.5.0.arrayidx45.sroa_idx.us.1, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp28.sroa.6.0.arrayidx45.sroa_idx.us.1, align 4
  %80 = load i16, ptr %add.ptr, align 2
  ...
  %81 = load double, ptr %add.ptr27.us.2, align 8
  %conv31.us.2 = fptrunc double %81 to float
  %82 = load float, ptr %m_scaling.i, align 4
  %mul33.us.2 = fmul float %82, %conv31.us.2
  %arrayidx35.us.2 = getelementptr inbounds double, ptr %add.ptr27.us.2, i64 1
  %83 = load <2 x double>, ptr %arrayidx35.us.2, align 8
  %84 = fptrunc <2 x double> %83 to <2 x float>
  %85 = load <2 x float>, ptr %arrayidx.i71, align 4
  %86 = fmul <2 x float> %85, %84
  store float %mul33.us.2, ptr %m_triangle, align 16
  br label %for.cond.cleanup
...
for.cond.cleanup:                                 ; preds = %for.body.preheader, %for.body.us77.preheader, %for.body.us.preheader, %for.body.us.us.preheader
  ...
  %88 = load ptr, ptr %m_callback, align 8
  %vtable46 = load ptr, ptr %88, align 8
  ...
  %90 = load ptr, ptr %m_meshInterface, align 8
  %vtable49 = load ptr, ptr %90, align 8
...
for.body.us.preheader:                            ; preds = %entry.split.us
  ...
  %arrayidx19.us = getelementptr inbounds float, ptr %add.ptr9.us, i64 2
  %10 = load float, ptr %arrayidx19.us, align 4
  %11 = load float, ptr %arrayidx.i74, align 4
  %mul21.us = fmul float %10, %11
  ...
  %arrayidx19.us.1 = getelementptr inbounds float, ptr %add.ptr9.us.1, i64 2
  %16 = load float, ptr %arrayidx19.us.1, align 4
  %17 = load float, ptr %arrayidx.i74, align 4
  %mul21.us.1 = fmul float %16, %17
  ...
  %idx.ext8.us.2 = sext i32 %mul7.us.2 to i64
  %add.ptr9.us.2 = getelementptr inbounds i8, ptr %7, i64 %idx.ext8.us.2
  %22 = load <2 x float>, ptr %add.ptr9.us.2, align 4
  ...
  %25 = load float, ptr %arrayidx.i74, align 4
  br label %for.cond.cleanup

for.body.us.us.preheader:                         ; preds = %entry.split.us
  %arrayidx.us.us = getelementptr inbounds i16, ptr %add.ptr, i64 2
  %26 = load i16, ptr %arrayidx.us.us, align 2
  %conv.us.us = zext i16 %26 to i32
  %mul7.us.us = mul nsw i32 %8, %conv.us.us
  %idx.ext8.us.us = sext i32 %mul7.us.us to i64
  %add.ptr9.us.us = getelementptr inbounds i8, ptr %7, i64 %idx.ext8.us.us
  %arrayidx19.us.us = getelementptr inbounds float, ptr %add.ptr9.us.us, i64 2
  %27 = load float, ptr %arrayidx19.us.us, align 4
  ...
  %29 = load <2 x float>, ptr %add.ptr9.us.us, align 4
  ...
  store float 0.000000e+00, ptr %ref.tmp.sroa.6.0.arrayidx23.sroa_idx.us.us, align 4
  %arrayidx.us.us.1 = getelementptr inbounds i16, ptr %add.ptr, i64 1
  %32 = load i16, ptr %arrayidx.us.us.1, align 2
  %conv.us.us.1 = zext i16 %32 to i32
  %mul7.us.us.1 = mul nsw i32 %8, %conv.us.us.1
  %idx.ext8.us.us.1 = sext i32 %mul7.us.us.1 to i64
  %add.ptr9.us.us.1 = getelementptr inbounds i8, ptr %7, i64 %idx.ext8.us.us.1
  %arrayidx19.us.us.1 = getelementptr inbounds float, ptr %add.ptr9.us.us.1, i64 2
  %33 = load float, ptr %arrayidx19.us.us.1, align 4
  %34 = load float, ptr %arrayidx.i74, align 4
  ...
  %35 = load <2 x float>, ptr %add.ptr9.us.us.1, align 4
  %36 = load <2 x float>, ptr %m_scaling.i, align 4
  ...
  %idx.ext8.us.us.2 = sext i32 %mul7.us.us.2 to i64
  %add.ptr9.us.us.2 = getelementptr inbounds i8, ptr %7, i64 %idx.ext8.us.us.2
  %39 = load <2 x float>, ptr %add.ptr9.us.us.2, align 4
  %40 = load <2 x float>, ptr %m_scaling.i, align 4
  %41 = fmul <2 x float> %39, %40
  %arrayidx19.us.us.2 = getelementptr inbounds float, ptr %add.ptr9.us.us.2, i64 2
  %42 = load float, ptr %arrayidx.i74, align 4
  br label %for.cond.cleanup
...
for.body.preheader:                               ; preds = %entry.split
  %arrayidx5 = getelementptr inbounds i32, ptr %add.ptr, i64 2
  %43 = load i32, ptr %arrayidx5, align 4
  ...
  store float %mul43, ptr %ref.tmp28.sroa.5.0.arrayidx46.sroa_idx, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp28.sroa.6.0.arrayidx46.sroa_idx, align 4
  %arrayidx5.1 = getelementptr inbounds i32, ptr %add.ptr, i64 1
  %50 = load i32, ptr %arrayidx5.1, align 4
  %mul25.1 = mul nsw i32 %8, %50
  %idx.ext26.1 = sext i32 %mul25.1 to i64
  %add.ptr27.1 = getelementptr inbounds i8, ptr %7, i64 %idx.ext26.1
  %arrayidx40.1 = getelementptr inbounds double, ptr %add.ptr27.1, i64 2
  %51 = load double, ptr %arrayidx40.1, align 8
  ...
  %53 = load <2 x double>, ptr %add.ptr27.1, align 8
  %54 = fptrunc <2 x double> %53 to <2 x float>
  %55 = load <2 x float>, ptr %m_scaling.i, align 4
  ...
  store float %mul43.1, ptr %ref.tmp28.sroa.5.0.arrayidx46.sroa_idx.1, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp28.sroa.6.0.arrayidx46.sroa_idx.1, align 4
  %57 = load i32, ptr %add.ptr, align 4
  %mul25.2 = mul nsw i32 %8, %57
  %idx.ext26.2 = sext i32 %mul25.2 to i64
  %add.ptr27.2 = getelementptr inbounds i8, ptr %7, i64 %idx.ext26.2
  %58 = load <2 x double>, ptr %add.ptr27.2, align 8
  %59 = fptrunc <2 x double> %58 to <2 x float>
  %60 = load <2 x float>, ptr %m_scaling.i, align 4
  %61 = fmul <2 x float> %60, %59
  %arrayidx40.2 = getelementptr inbounds double, ptr %add.ptr27.2, i64 2
  %62 = load double, ptr %arrayidx40.2, align 8
...
for.body.us79.preheader:                          ; preds = %entry.split
  ...
  %63 = load i16, ptr %arrayidx.us83, align 2
  %conv.us84 = zext i16 %63 to i32
  %mul25.us = mul nsw i32 %8, %conv.us84
  %idx.ext26.us = sext i32 %mul25.us to i64
  %add.ptr27.us = getelementptr inbounds i8, ptr %7, i64 %idx.ext26.us
  %arrayidx40.us = getelementptr inbounds double, ptr %add.ptr27.us, i64 2
  %64 = load double, ptr %arrayidx40.us, align 8
  %conv41.us = fptrunc double %64 to float
  %65 = load float, ptr %arrayidx.i74, align 4
  ...
  %66 = load <2 x double>, ptr %add.ptr27.us, align 8
  %67 = fptrunc <2 x double> %66 to <2 x float>
  %68 = load <2 x float>, ptr %m_scaling.i, align 4
  ...
  store float %mul43.us, ptr %ref.tmp28.sroa.5.0.arrayidx46.sroa_idx.us, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp28.sroa.6.0.arrayidx46.sroa_idx.us, align 4
  %arrayidx.us83.1 = getelementptr inbounds i16, ptr %add.ptr, i64 1
  %70 = load i16, ptr %arrayidx.us83.1, align 2
  %conv.us84.1 = zext i16 %70 to i32
  %mul25.us.1 = mul nsw i32 %8, %conv.us84.1
  %idx.ext26.us.1 = sext i32 %mul25.us.1 to i64
  %add.ptr27.us.1 = getelementptr inbounds i8, ptr %7, i64 %idx.ext26.us.1
  %arrayidx40.us.1 = getelementptr inbounds double, ptr %add.ptr27.us.1, i64 2
  %71 = load double, ptr %arrayidx40.us.1, align 8
  %conv41.us.1 = fptrunc double %71 to float
  %72 = load float, ptr %arrayidx.i74, align 4
  ...
  %73 = load <2 x double>, ptr %add.ptr27.us.1, align 8
  %74 = fptrunc <2 x double> %73 to <2 x float>
  %75 = load <2 x float>, ptr %m_scaling.i, align 4
  ...
  store float %mul43.us.1, ptr %ref.tmp28.sroa.5.0.arrayidx46.sroa_idx.us.1, align 8
  ...
  store float 0.000000e+00, ptr %ref.tmp28.sroa.6.0.arrayidx46.sroa_idx.us.1, align 4
  %77 = load i16, ptr %add.ptr, align 2
  %conv.us84.2 = zext i16 %77 to i32
  %mul25.us.2 = mul nsw i32 %8, %conv.us84.2
  %idx.ext26.us.2 = sext i32 %mul25.us.2 to i64
  %add.ptr27.us.2 = getelementptr inbounds i8, ptr %7, i64 %idx.ext26.us.2
  %78 = load <2 x double>, ptr %add.ptr27.us.2, align 8
  %79 = fptrunc <2 x double> %78 to <2 x float>
  %80 = load <2 x float>, ptr %m_scaling.i, align 4
  %81 = fmul <2 x float> %80, %79
  %arrayidx40.us.2 = getelementptr inbounds double, ptr %add.ptr27.us.2, i64 2
  %82 = load double, ptr %arrayidx40.us.2, align 8
...
for.cond.cleanup:                                 ; preds = %for.body.preheader, %for.body.us79.preheader, %for.body.us.preheader, %for.body.us.us.preheader
  ...
  %86 = load ptr, ptr %m_meshInterface, align 8
  %vtable51 = load ptr, ptr %86, align 8
