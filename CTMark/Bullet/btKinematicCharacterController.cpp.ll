...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit, %entry
  ...
  %9 = load ptr, ptr %m_ghostObject, align 8, !tbaa !27
...
for.body:                                         ; preds = %for.body.lr.ph, %for.cond.cleanup27
  ...
  %10 = load i32, ptr %m_size.i.i, align 4, !tbaa !18
...
if.then5.i:                                       ; preds = %for.body
  %11 = load i32, ptr %m_capacity.i.i.i, align 8, !tbaa !19
...
_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i: ; preds = %if.then5.i
  %12 = load ptr, ptr %m_data.i9.i.i, align 8, !tbaa !17
  %tobool.not.i10.i.i = icmp eq ptr %12, null
  %13 = load i8, ptr %m_ownsMemory.i.i.i, align 8, !range !33
...
for.body10.i.prol:                                ; preds = %for.body10.lr.ph.i, %for.body10.i.prol
  ...
  %16 = load ptr, ptr %m_data.i9.i.i, align 8, !tbaa !17
...
for.body10.i:                                     ; preds = %for.body10.i.prol.loopexit, %for.body10.i
  ...
  %21 = load ptr, ptr %m_data.i9.i.i, align 8, !tbaa !17
...
_ZN20btAlignedObjectArrayIP20btPersistentManifoldE6resizeEiRKS1_.exit: ; preds = %for.body10.i.prol.loopexit, %for.body10.i, %for.body
  store i32 0, ptr %m_size.i.i, align 4, !tbaa !18
  %22 = load ptr, ptr %m_ghostObject, align 8, !tbaa !27
  %m_hashPairCache.i99 = getelementptr inbounds %class.btPairCachingGhostObject, ptr %22, i64 0, i32 1
  %23 = load ptr, ptr %m_hashPairCache.i99, align 8, !tbaa !39
  %vtable15 = load ptr, ptr %23, align 8, !tbaa !9
...
if.then:                                          ; preds = %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE6resizeEiRKS1_.exit
  %vtable21 = load ptr, ptr %26, align 8, !tbaa !9
...
if.end:                                           ; preds = %if.then, %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE6resizeEiRKS1_.exit
  %28 = load i32, ptr %m_size.i.i, align 4, !tbaa !18
...
for.body28.lr.ph:                                 ; preds = %if.end
  %29 = load ptr, ptr %m_data.i9.i.i, align 8, !tbaa !17
...
for.cond.cleanup27:                               ; preds = %for.cond.cleanup37, %if.end
  ...
  %31 = load ptr, ptr %m_hashPairCache.i94, align 8, !tbaa !39
  %vtable10 = load ptr, ptr %31, align 8, !tbaa !9
...
for.body28:                                       ; preds = %for.body28.lr.ph, %for.cond.cleanup37
  ...
  %35 = load ptr, ptr %arrayidx.i102, align 8, !tbaa !47
  %m_body0.i = getelementptr inbounds %class.btPersistentManifold, ptr %35, i64 0, i32 3
  %36 = load ptr, ptr %m_body0.i, align 8, !tbaa !55
  ...
  %37 = load i32, ptr %m_cachedPoints.i, align 8, !tbaa !58
...
for.body38:                                       ; preds = %for.body38.preheader, %if.end65
  ...
  %47 = load float, ptr %m_distance1.i, align 8, !tbaa !59
...
if.then45:                                        ; preds = %if.then42
  ...
  store <2 x float> %49, ptr %m_touchingNormal, align 4, !tbaa.struct !45
...
if.end49:                                         ; preds = %if.then45, %if.then42
  ...
  store <2 x float> %59, ptr %m_currentPosition, align 8, !tbaa !5
...
entry:
  ...
  store float 1.000000e+00, ptr %arrayidx3.i6.i.i.i122, align 4, !tbaa !5
  ...
  store float 1.000000e+00, ptr %arrayidx5.i10.i.i.i124, align 4, !tbaa !5
...
while.body:                                       ; preds = %land.rhs
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i137, ptr noundef nonnull align 4 dereferenceable(16) %m_targetPosition, i64 16, i1 false), !tbaa.struct !45
  call void @llvm.lifetime.start.p0(i64 96, ptr nonnull %callback) #20
...
invoke.cont56:                                    ; preds = %if.end42
  %31 = load float, ptr %m_hitPointWorld, align 8, !tbaa !5
  %32 = load float, ptr %arrayidx5.i142, align 4, !tbaa !5
  %33 = load float, ptr %arrayidx11.i145, align 8, !tbaa !5
  %34 = load float, ptr %arrayidx11.i, align 8, !tbaa !5
  %sub14.i147 = fsub float %33, %34
  %35 = load float, ptr %m_addedMargin, align 4, !tbaa !25
  %36 = load <2 x float>, ptr %m_currentPosition, align 8, !tbaa !5
  ...
  %41 = load <2 x float>, ptr %m_targetPosition, align 4, !tbaa !5
  %.pre206 = load float, ptr %ref.tmp.sroa.4.0.m_targetPosition.sroa_idx, align 4, !tbaa !5
...
if.then63:                                        ; preds = %invoke.cont56
  ...
  store <2 x float> %47, ptr %m_currentPosition, align 8, !tbaa !5
  %mul18.i = fmul float %30, %.pre206
  %48 = call float @llvm.fmuladd.f32(float %sub.i153, float %34, float %mul18.i)
  store float %48, ptr %arrayidx11.i, align 8, !tbaa !5
  br label %if.end70
...
if.then.i:                                        ; preds = %if.end70
  %56 = load float, ptr %arrayidx12.i.i.i, align 8, !tbaa !5
  ...
  %57 = load float, ptr %ref.tmp.sroa.4.0.m_targetPosition.sroa_idx, align 4, !tbaa !5
  %58 = load <2 x float>, ptr %m_hitNormalWorld, align 8, !tbaa !5
  ...
  %89 = load <2 x float>, ptr %m_targetPosition, align 4, !tbaa !5
  %90 = fadd <2 x float> %89, %88
  store <2 x float> %90, ptr %m_targetPosition, align 4, !tbaa !5
...
cleanup:                                          ; preds = %invoke.cont75
  ...
  %97 = load float, ptr %m_normalizedDirection84, align 8, !tbaa !5
  %98 = load float, ptr %arrayidx7.i180, align 4, !tbaa !5
  %mul8.i181 = fmul float %mul4.i.i.i178, %98
  %99 = call float @llvm.fmuladd.f32(float %mul.i.i.i177, float %97, float %mul8.i181)
  %100 = load float, ptr %arrayidx12.i183, align 8, !tbaa !5
...
if.else.i:                                        ; preds = %if.end
  ...
  %3 = load float, ptr %m_worldTransform.i.i, align 4, !tbaa !5
  %4 = load float, ptr %m_hitNormalLocal5.i, align 8, !tbaa !5
  ...
  %6 = load float, ptr %arrayidx7.i.i.i, align 4, !tbaa !5
  ...
  %8 = load float, ptr %arrayidx12.i.i.i, align 8, !tbaa !5
  ...
  %11 = load float, ptr %arrayidx10.i15.i.i, align 4, !tbaa !5
