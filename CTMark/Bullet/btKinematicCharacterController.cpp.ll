; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btKinematicCharacterController.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btKinematicCharacterController.cpp"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%class.btVector3 = type { [4 x float] }
%class.btKinematicCharacterController = type { %class.btCharacterControllerInterface, float, ptr, ptr, float, float, float, float, float, float, %class.btVector3, %class.btVector3, %class.btVector3, float, %class.btVector3, [4 x i8], %class.btAlignedObjectArray, i8, %class.btVector3, i8, i8, float, i32 }
...
%class.btCollisionWorld = type <{ ptr, %class.btAlignedObjectArray.0, ptr, %struct.btDispatcherInfo, ptr, ptr, ptr, i8, [7 x i8] }>
...
invoke.cont5:
  store ptr getelementptr inbounds ({ [15 x ptr] }, ptr @_ZTV30btKinematicCharacterController, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  ...
  store i8 1, ptr %m_useGhostObjectSweepTest, align 4
  ...
  store float %stepHeight, ptr %m_stepHeight, align 8
  %m_turnAngle = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 7
  store float 0.000000e+00, ptr %m_turnAngle, align 4
...
entry:
  ...
  %0 = load ptr, ptr %m_dispatcher1.i, align 8
  %m_ghostObject = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 2
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_currentPosition, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i, i64 16, i1 false)
  %m_hashPairCache.i94170 = getelementptr inbounds %class.btPairCachingGhostObject, ptr %4, i64 0, i32 1
  %5 = load ptr, ptr %m_hashPairCache.i94170, align 8
  %vtable10171 = load ptr, ptr %5, align 8
...
for.cond.cleanup.loopexit:                        ; preds = %for.cond.cleanup27
  %7 = and i8 %penetration.1.lcssa, 1
  %8 = icmp ne i8 %7, 0
  br label %for.cond.cleanup

for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit, %entry
  %penetration.0.lcssa = phi i1 [ false, %entry ], [ %8, %for.cond.cleanup.loopexit ]
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i96, ptr noundef nonnull align 8 dereferenceable(16) %m_currentPosition, i64 16, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_origin3.i, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i96, i64 16, i1 false)
...
for.body10.i.prol:                                ; preds = %for.body10.lr.ph.i, %for.body10.i.prol
  %indvars.iv.i.prol = phi i64 [ %indvars.iv.next.i.prol, %for.body10.i.prol ], [ %14, %for.body10.lr.ph.i ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body10.i.prol ], [ 0, %for.body10.lr.ph.i ]
  %16 = load ptr, ptr %m_data.i9.i.i, align 8
  %arrayidx13.i.prol = getelementptr inbounds ptr, ptr %16, i64 %indvars.iv.i.prol
...
for.body10.i.prol.loopexit:                       ; preds = %for.body10.i.prol, %for.body10.lr.ph.i
  %indvars.iv.i.unr = phi i64 [ %14, %for.body10.lr.ph.i ], [ %indvars.iv.next.i.prol, %for.body10.i.prol ]
  %17 = icmp ugt i32 %10, -4
  br i1 %17, label %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE6resizeEiRKS1_.exit, label %for.body10.i
...
for.body10.i:                                     ; preds = %for.body10.i.prol.loopexit, %for.body10.i
  ...
  %18 = load ptr, ptr %m_data.i9.i.i, align 8
  %arrayidx13.i = getelementptr inbounds ptr, ptr %18, i64 %indvars.iv.i
  store ptr null, ptr %arrayidx13.i, align 8
  %indvars.iv.next.i = add nsw i64 %indvars.iv.i, 1
  %19 = load ptr, ptr %m_data.i9.i.i, align 8
  %arrayidx13.i.1 = getelementptr inbounds ptr, ptr %19, i64 %indvars.iv.next.i
  store ptr null, ptr %arrayidx13.i.1, align 8
  %indvars.iv.next.i.1 = add nsw i64 %indvars.iv.i, 2
  %20 = load ptr, ptr %m_data.i9.i.i, align 8
  %arrayidx13.i.2 = getelementptr inbounds ptr, ptr %20, i64 %indvars.iv.next.i.1
  store ptr null, ptr %arrayidx13.i.2, align 8
  %indvars.iv.next.i.2 = add nsw i64 %indvars.iv.i, 3
  %21 = load ptr, ptr %m_data.i9.i.i, align 8
  %arrayidx13.i.3 = getelementptr inbounds ptr, ptr %21, i64 %indvars.iv.next.i.2
...
_ZN20btAlignedObjectArrayIP20btPersistentManifoldE6resizeEiRKS1_.exit: ; preds = %for.body10.i.prol.loopexit, %for.body10.i, %for.body
  ...
  %m_hashPairCache.i99 = getelementptr inbounds %class.btPairCachingGhostObject, ptr %22, i64 0, i32 1
  %23 = load ptr, ptr %m_hashPairCache.i99, align 8
  %vtable15 = load ptr, ptr %23, align 8
  %vfn16 = getelementptr inbounds ptr, ptr %vtable15, i64 7
  %24 = load ptr, ptr %vfn16, align 8
  %call17 = tail call noundef nonnull align 8 dereferenceable(25) ptr %24(ptr noundef nonnull align 8 dereferenceable(128) %23)
  %m_data.i = getelementptr inbounds %class.btAlignedObjectArray.4, ptr %call17, i64 0, i32 5
  %25 = load ptr, ptr %m_data.i, align 8
  %m_algorithm = getelementptr inbounds %struct.btBroadphasePair, ptr %25, i64 %indvars.iv181, i32 2
  %26 = load ptr, ptr %m_algorithm, align 8
...
if.then:                                          ; preds = %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE6resizeEiRKS1_.exit
  %vtable21 = load ptr, ptr %26, align 8
  %vfn22 = getelementptr inbounds ptr, ptr %vtable21, i64 4
  %27 = load ptr, ptr %vfn22, align 8
  tail call void %27(ptr noundef nonnull align 8 dereferenceable(16) %26, ptr noundef nonnull align 8 dereferenceable(25) %m_manifoldArray)
  br label %if.end
...
if.end:                                           ; preds = %if.then, %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE6resizeEiRKS1_.exit
  ...
  %cmp26153 = icmp sgt i32 %28, 0
  %.pre184 = load ptr, ptr %m_ghostObject, align 8
  br i1 %cmp26153, label %for.body28.lr.ph, label %for.cond.cleanup27

for.body28.lr.ph:                                 ; preds = %if.end
  %29 = load ptr, ptr %m_data.i9.i.i, align 8
  %30 = load <2 x float>, ptr %m_currentPosition, align 8
  %arrayidx12.i.promoted165 = load float, ptr %arrayidx12.i, align 8
  %wide.trip.count = zext i32 %28 to i64
  br label %for.body28

for.cond.cleanup27:                               ; preds = %for.cond.cleanup37, %if.end
  %maxPen.1.lcssa = phi float [ %maxPen.0176, %if.end ], [ %maxPen.2.lcssa, %for.cond.cleanup37 ]
  %penetration.1.lcssa = phi i8 [ %penetration.0177, %if.end ], [ %penetration.2.lcssa, %for.cond.cleanup37 ]
  %indvars.iv.next182 = add nuw nsw i64 %indvars.iv181, 1
  %m_hashPairCache.i94 = getelementptr inbounds %class.btPairCachingGhostObject, ptr %.pre184, i64 0, i32 1
  %31 = load ptr, ptr %m_hashPairCache.i94, align 8
  %vtable10 = load ptr, ptr %31, align 8
  %vfn11 = getelementptr inbounds ptr, ptr %vtable10, i64 9
  %32 = load ptr, ptr %vfn11, align 8
  %call12 = tail call noundef i32 %32(ptr noundef nonnull align 8 dereferenceable(128) %31)
  %33 = sext i32 %call12 to i64
  %cmp = icmp slt i64 %indvars.iv.next182, %33
...
for.body28:                                       ; preds = %for.body28.lr.ph, %for.cond.cleanup37
  ...
  %34 = phi <2 x float> [ %30, %for.body28.lr.ph ], [ %42, %for.cond.cleanup37 ]
  %arrayidx.i102 = getelementptr inbounds ptr, ptr %29, i64 %indvars.iv179
  %35 = load ptr, ptr %arrayidx.i102, align 8
  %m_body0.i = getelementptr inbounds %class.btPersistentManifold, ptr %35, i64 0, i32 3
  %36 = load ptr, ptr %m_body0.i, align 8
  %cmp33 = icmp eq ptr %36, %.pre184
  %cond = select i1 %cmp33, float -1.000000e+00, float 1.000000e+00
  %m_cachedPoints.i = getelementptr inbounds %class.btPersistentManifold, ptr %35, i64 0, i32 5
  %37 = load i32, ptr %m_cachedPoints.i, align 8
  %cmp36142 = icmp sgt i32 %37, 0
  br i1 %cmp36142, label %for.body38.preheader, label %for.cond.cleanup37

for.body38.preheader:                             ; preds = %for.body28
  %38 = insertelement <2 x float> poison, float %cond, i64 0
  %39 = shufflevector <2 x float> %38, <2 x float> poison, <2 x i32> zeroinitializer
  %40 = insertelement <2 x float> poison, float %cond, i64 0
...
for.cond.cleanup37:                               ; preds = %if.end65, %for.body28
  ...
  %42 = phi <2 x float> [ %34, %for.body28 ], [ %62, %if.end65 ]
...
for.body38:                                       ; preds = %for.body38.preheader, %if.end65
  %.pre183185 = phi i32 [ %.pre183186, %if.end65 ], [ %37, %for.body38.preheader ]
  %43 = phi i32 [ %60, %if.end65 ], [ %37, %for.body38.preheader ]
  ...
  %44 = phi float [ %61, %if.end65 ], [ %arrayidx12.i.promoted169, %for.body38.preheader ]
  ...
  %45 = phi <2 x float> [ %63, %if.end65 ], [ %34, %for.body38.preheader ]
  %46 = phi <2 x float> [ %62, %if.end65 ], [ %34, %for.body38.preheader ]
  %m_distance1.i = getelementptr inbounds %class.btPersistentManifold, ptr %35, i64 0, i32 2, i64 %indvars.iv, i32 5
  %47 = load float, ptr %m_distance1.i, align 8
  %cmp41 = fcmp olt float %47, 0.000000e+00
  br i1 %cmp41, label %if.then42, label %if.end65

if.then42:                                        ; preds = %for.body38
  %cmp44 = fcmp olt float %47, %maxPen.2145
  br i1 %cmp44, label %if.then45, label %if.end49

if.then45:                                        ; preds = %if.then42
  %m_normalWorldOnB = getelementptr inbounds %class.btPersistentManifold, ptr %35, i64 0, i32 2, i64 %indvars.iv, i32 4
  %48 = load <2 x float>, ptr %m_normalWorldOnB, align 4
  ...
  store <2 x float> %49, ptr %m_touchingNormal, align 4
  store <2 x float> %retval.sroa.3.12.vec.insert.i, ptr %ref.tmp47.sroa.4.0.m_touchingNormal.sroa_idx, align 4
  %.pre = load float, ptr %m_distance1.i, align 8
  %.pre183.pre = load i32, ptr %m_cachedPoints.i, align 8
  br label %if.end49

if.end49:                                         ; preds = %if.then45, %if.then42
  %.pre183 = phi i32 [ %.pre183.pre, %if.then45 ], [ %.pre183185, %if.then42 ]
  %51 = phi float [ %.pre, %if.then45 ], [ %47, %if.then42 ]
  %maxPen.3 = phi float [ %47, %if.then45 ], [ %maxPen.2145, %if.then42 ]
  %m_normalWorldOnB53 = getelementptr inbounds %class.btPersistentManifold, ptr %35, i64 0, i32 2, i64 %indvars.iv, i32 4
  %arrayidx7.i110 = getelementptr inbounds [4 x float], ptr %m_normalWorldOnB53, i64 0, i64 2
  %52 = load float, ptr %arrayidx7.i110, align 4
  %mul8.i111 = fmul float %cond, %52
  %mul8.i122 = fmul float %51, %mul8.i111
  %mul8.i132 = fmul float %mul8.i122, 0x3FC99999A0000000
  %53 = load <2 x float>, ptr %m_normalWorldOnB53, align 4
  %54 = fmul <2 x float> %41, %53
  %55 = insertelement <2 x float> poison, float %51, i64 0
  %56 = shufflevector <2 x float> %55, <2 x float> poison, <2 x i32> zeroinitializer
  %57 = fmul <2 x float> %54, %56
  %58 = fmul <2 x float> %57, <float 0x3FC99999A0000000, float 0x3FC99999A0000000>
  %59 = fadd <2 x float> %58, %45
  store <2 x float> %59, ptr %m_currentPosition, align 8
  %add13.i = fadd float %mul8.i132, %44
...
entry:
  ...
  %3 = load <2 x float>, ptr %arrayidx, align 16
  %4 = insertelement <2 x float> poison, float %1, i64 0
  %5 = shufflevector <2 x float> %4, <2 x float> poison, <2 x i32> zeroinitializer
  %6 = fmul <2 x float> %5, %3
  %7 = load <2 x float>, ptr %m_currentPosition, align 8
  ...
  %9 = load float, ptr %arrayidx11.i, align 8
  ...
  store <2 x float> %8, ptr %m_targetPosition, align 4
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i51, ptr %ref.tmp.sroa.4.0.m_targetPosition.sroa_idx, align 4
  store float 1.000000e+00, ptr %start, align 4
  ...
  store float 1.000000e+00, ptr %end, align 4
  ...
  store float 1.000000e+00, ptr %arrayidx3.i6.i.i.i55, align 4
  ...
  store float 1.000000e+00, ptr %arrayidx5.i10.i.i.i57, align 4
  ...
  store <2 x float> %11, ptr %m_origin.i, align 4
  %ref.tmp5.sroa.4.0.m_origin.i.sroa_idx = getelementptr inbounds %class.btTransform, ptr %start, i64 0, i32 1, i32 0, i64 2
  store <2 x float> %retval.sroa.3.12.vec.insert.i78, ptr %ref.tmp5.sroa.4.0.m_origin.i.sroa_idx, align 4
  %m_origin.i81 = getelementptr inbounds %class.btTransform, ptr %end, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i81, ptr noundef nonnull align 4 dereferenceable(16) %m_targetPosition, i64 16, i1 false)
  ...
  store ptr %12, ptr %m_me.i, align 8
  ...
  %14 = load <2 x i16>, ptr %m_collisionFilterGroup, align 8
  store <2 x i16> %14, ptr %m_collisionFilterGroup.i.i.i, align 4
  %m_useGhostObjectSweepTest = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 19
  %15 = load i8, ptr %m_useGhostObjectSweepTest, align 4
  %tobool.not = icmp eq i8 %15, 0
  %m_convexShape28 = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 3
  %16 = load ptr, ptr %m_convexShape28, align 8
  br i1 %tobool.not, label %if.else, label %if.then

if.then:                                          ; preds = %entry
  %m_allowedCcdPenetration = getelementptr inbounds %class.btCollisionWorld, ptr %world, i64 0, i32 3, i32 9
  %17 = load float, ptr %m_allowedCcdPenetration, align 4
...
if.end:                                           ; preds = %if.then, %if.else
  %18 = load float, ptr %m_closestHitFraction.i.i.i, align 8
  %cmp.i = fcmp olt float %18, 1.000000e+00
  %19 = load float, ptr %m_stepHeight, align 8
  br i1 %cmp.i, label %if.then32, label %if.else39

if.then32:                                        ; preds = %if.end
  %mul = fmul float %18, %19
  %sub.i = fsub float 1.000000e+00, %18
  %20 = load <2 x float>, ptr %m_currentPosition, align 8
  %21 = load <2 x float>, ptr %m_targetPosition, align 4
  ...
  store <2 x float> %27, ptr %m_currentPosition, align 8
  %28 = load float, ptr %arrayidx11.i, align 8
  %29 = load float, ptr %ref.tmp.sroa.4.0.m_targetPosition.sroa_idx, align 4
  %mul18.i = fmul float %18, %29
  %30 = call float @llvm.fmuladd.f32(float %sub.i, float %28, float %mul18.i)
  store float %30, ptr %arrayidx11.i, align 8
  br label %if.end44

if.else39:                                        ; preds = %if.end
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_currentPosition, ptr noundef nonnull align 4 dereferenceable(16) %m_targetPosition, i64 16, i1 false)
  br label %if.end44
...
entry:
  %m_targetPosition = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 14
  %m_currentPosition = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 12
  %0 = load <2 x float>, ptr %m_targetPosition, align 4
  %1 = load <2 x float>, ptr %m_currentPosition, align 8
...
if.then:                                          ; preds = %entry
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %m_targetPosition, ptr noundef nonnull align 8 dereferenceable(16) %m_currentPosition, i64 16, i1 false)
...
if.then15:                                        ; preds = %if.then
  ...
  %41 = load <2 x float>, ptr %m_targetPosition, align 4
  %42 = fadd <2 x float> %40, %41
  store <2 x float> %42, ptr %m_targetPosition, align 4
  %43 = load float, ptr %arrayidx11.i, align 4
  %add13.i = fadd float %mul8.i, %43
  store float %add13.i, ptr %arrayidx11.i, align 4
  br label %if.end21
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %end) #20
  %m_currentPosition = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 12
  %0 = load <2 x float>, ptr %m_currentPosition, align 8
  ...
  %m_targetPosition = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 14
  store <2 x float> %2, ptr %m_targetPosition, align 4
  %ref.tmp.sroa.4.0.m_targetPosition.sroa_idx = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 14, i32 0, i64 2
  store <2 x float> %retval.sroa.3.12.vec.insert.i, ptr %ref.tmp.sroa.4.0.m_targetPosition.sroa_idx, align 4
  store float 1.000000e+00, ptr %start, align 4
  %arrayidx3.i.i.i.i = getelementptr inbounds [4 x float], ptr %start, i64 0, i64 1
  %arrayidx3.i6.i.i.i = getelementptr inbounds [3 x %class.btVector3], ptr %start, i64 0, i64 1, i32 0, i64 1
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx3.i.i.i.i, i8 0, i64 16, i1 false)
  ...
  store i32 0, ptr %arrayidx7.i11.i.i.i, align 4
  store float 1.000000e+00, ptr %end, align 4
  %arrayidx3.i.i.i.i121 = getelementptr inbounds [4 x float], ptr %end, i64 0, i64 1
  %arrayidx3.i6.i.i.i122 = getelementptr inbounds [3 x %class.btVector3], ptr %end, i64 0, i64 1, i32 0, i64 1
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx3.i.i.i.i121, i8 0, i64 16, i1 false)
  store float 1.000000e+00, ptr %arrayidx3.i6.i.i.i122, align 4
  %arrayidx5.i7.i.i.i123 = getelementptr inbounds [3 x %class.btVector3], ptr %end, i64 0, i64 1, i32 0, i64 2
  %arrayidx5.i10.i.i.i124 = getelementptr inbounds [3 x %class.btVector3], ptr %end, i64 0, i64 2, i32 0, i64 2
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %arrayidx5.i7.i.i.i123, i8 0, i64 16, i1 false)
  store float 1.000000e+00, ptr %arrayidx5.i10.i.i.i124, align 4
  %arrayidx7.i11.i.i.i125 = getelementptr inbounds [3 x %class.btVector3], ptr %end, i64 0, i64 2, i32 0, i64 3
  store i32 0, ptr %arrayidx7.i11.i.i.i125, align 4
  %m_touchingContact = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 17
  %5 = load i8, ptr %m_touchingContact, align 8
...
if.then:                                          ; preds = %entry
  ...
  %m_touchingNormal = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 18
  %6 = load float, ptr %m_normalizedDirection, align 8
  %7 = load float, ptr %m_touchingNormal, align 4
  %arrayidx5.i135 = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 11, i32 0, i64 1
  %8 = load float, ptr %arrayidx5.i135, align 4
  %arrayidx7.i136 = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 18, i32 0, i64 1
  %9 = load float, ptr %arrayidx7.i136, align 8
  ...
  %11 = load float, ptr %arrayidx10.i, align 8
...
if.end11:                                         ; preds = %if.then, %if.then9, %entry
  %m_origin.i = getelementptr inbounds %class.btTransform, ptr %start, i64 0, i32 1
  %m_origin.i137 = getelementptr inbounds %class.btTransform, ptr %end, i64 0, i32 1
  %m_ghostObject = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 2
  %m_closestHitFraction.i.i.i = getelementptr inbounds %"struct.btCollisionWorld::ConvexResultCallback", ptr %callback, i64 0, i32 1
  %m_collisionFilterGroup.i.i.i = getelementptr inbounds %"struct.btCollisionWorld::ConvexResultCallback", ptr %callback, i64 0, i32 2
  %m_convexFromWorld.i.i = getelementptr inbounds %"struct.btCollisionWorld::ClosestConvexResultCallback", ptr %callback, i64 0, i32 1
  ...
  %arrayidx5.i142 = getelementptr inbounds %"struct.btCollisionWorld::ClosestConvexResultCallback", ptr %callback, i64 0, i32 4, i32 0, i64 1
  %arrayidx11.i145 = getelementptr inbounds %"struct.btCollisionWorld::ClosestConvexResultCallback", ptr %callback, i64 0, i32 4, i32 0, i64 2
  ...
  %arrayidx7.i180 = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 11, i32 0, i64 1
  %arrayidx12.i183 = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 11, i32 0, i64 2
  br label %land.rhs

land.rhs:                                         ; preds = %if.end11, %if.end96
  %fraction.0204 = phi float [ 1.000000e+00, %if.end11 ], [ %sub, %if.end96 ]
  %maxIter.0203 = phi i32 [ 10, %if.end11 ], [ %dec, %if.end96 ]
  %dec = add nsw i32 %maxIter.0203, -1
  %cmp13.not = icmp eq i32 %maxIter.0203, 0
  br i1 %cmp13.not, label %while.end, label %while.body

while.body:                                       ; preds = %land.rhs
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i, ptr noundef nonnull align 8 dereferenceable(16) %m_currentPosition, i64 16, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i137, ptr noundef nonnull align 4 dereferenceable(16) %m_targetPosition, i64 16, i1 false)
  call void @llvm.lifetime.start.p0(i64 96, ptr nonnull %callback) #20
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %m_convexFromWorld.i.i, i8 0, i64 32, i1 false)
  store ptr getelementptr inbounds ({ [6 x ptr] }, ptr @_ZTV43btKinematicClosestNotMeConvexResultCallback, i64 0, inrange i32 0, i64 2), ptr %callback, align 8
  store ptr %14, ptr %m_me.i, align 8
  ...
  %16 = load <2 x i16>, ptr %m_collisionFilterGroup, align 8
  store <2 x i16> %16, ptr %m_collisionFilterGroup.i.i.i, align 4
  %17 = load ptr, ptr %m_convexShape, align 8
  ...
  %20 = load float, ptr %m_addedMargin, align 4
  ...
  %22 = load i8, ptr %m_useGhostObjectSweepTest, align 4
  %tobool30.not = icmp eq i8 %22, 0
  br i1 %tobool30.not, label %if.else, label %if.then31

if.then31:                                        ; preds = %while.body
  %23 = load ptr, ptr %m_ghostObject, align 8
  %24 = load ptr, ptr %m_convexShape, align 8
...
if.else:                                          ; preds = %while.body
  %26 = load ptr, ptr %m_convexShape, align 8
  %27 = load float, ptr %m_allowedCcdPenetration, align 4
...
if.end42:                                         ; preds = %if.then31, %if.else
  ...
  %30 = load float, ptr %m_closestHitFraction.i.i.i, align 8
  %sub = fsub float %fraction.0204, %30
  %cmp.i = fcmp olt float %30, 1.000000e+00
  br i1 %cmp.i, label %invoke.cont56, label %if.else93

invoke.cont56:                                    ; preds = %if.end42
  %31 = load float, ptr %m_hitPointWorld, align 8
  %32 = load float, ptr %arrayidx5.i142, align 4
  %33 = load float, ptr %arrayidx11.i145, align 8
  %34 = load float, ptr %arrayidx11.i, align 8
  %sub14.i147 = fsub float %33, %34
  %35 = load float, ptr %m_addedMargin, align 4
  %36 = load <2 x float>, ptr %m_currentPosition, align 8
  %37 = extractelement <2 x float> %36, i64 0
  %sub.i141 = fsub float %31, %37
  %38 = extractelement <2 x float> %36, i64 1
  %sub8.i144 = fsub float %32, %38
  %mul8.i.i.i = fmul float %sub8.i144, %sub8.i144
  %39 = call float @llvm.fmuladd.f32(float %sub.i141, float %sub.i141, float %mul8.i.i.i)
  %40 = call float @llvm.fmuladd.f32(float %sub14.i147, float %sub14.i147, float %39)
  %sqrt.i = call float @llvm.sqrt.f32(float %40)
  %cmp62 = fcmp ogt float %sqrt.i, %35
  %41 = load <2 x float>, ptr %m_targetPosition, align 4
  %.pre206 = load float, ptr %ref.tmp.sroa.4.0.m_targetPosition.sroa_idx, align 4
  br i1 %cmp62, label %if.then63, label %if.end70

if.then63:                                        ; preds = %invoke.cont56
  %sub.i153 = fsub float 1.000000e+00, %30
  %42 = insertelement <2 x float> poison, float %30, i64 0
  %43 = shufflevector <2 x float> %42, <2 x float> poison, <2 x i32> zeroinitializer
  %44 = fmul <2 x float> %43, %41
  %45 = insertelement <2 x float> poison, float %sub.i153, i64 0
  %46 = shufflevector <2 x float> %45, <2 x float> poison, <2 x i32> zeroinitializer
  %47 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %46, <2 x float> %36, <2 x float> %44)
  store <2 x float> %47, ptr %m_currentPosition, align 8
  %mul18.i = fmul float %30, %.pre206
  %48 = call float @llvm.fmuladd.f32(float %sub.i153, float %34, float %mul18.i)
  store float %48, ptr %arrayidx11.i, align 8
  br label %if.end70

if.end70:                                         ; preds = %if.then63, %invoke.cont56
  %49 = phi float [ %48, %if.then63 ], [ %34, %invoke.cont56 ]
  %50 = phi <2 x float> [ %47, %if.then63 ], [ %36, %invoke.cont56 ]
  %51 = fsub <2 x float> %41, %50
  %sub14.i.i = fsub float %.pre206, %49
  %52 = fmul <2 x float> %51, %51
  %mul8.i.i.i.i = extractelement <2 x float> %52, i64 1
  %53 = extractelement <2 x float> %51, i64 0
  %54 = call float @llvm.fmuladd.f32(float %53, float %53, float %mul8.i.i.i.i)
  %55 = call float @llvm.fmuladd.f32(float %sub14.i.i, float %sub14.i.i, float %54)
  %sqrt.i.i = call float @llvm.sqrt.f32(float %55)
  %cmp.i157 = fcmp ogt float %sqrt.i.i, 0x3E80000000000000
  br i1 %cmp.i157, label %if.then.i, label %invoke.cont75

if.then.i:                                        ; preds = %if.end70
  %56 = load float, ptr %arrayidx12.i.i.i, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %m_targetPosition, ptr noundef nonnull align 8 dereferenceable(16) %m_currentPosition, i64 16, i1 false)
  %div.i.i.i = fdiv float 1.000000e+00, %sqrt.i.i
  %mul7.i.i.i.i = fmul float %sub14.i.i, %div.i.i.i
  %57 = load float, ptr %ref.tmp.sroa.4.0.m_targetPosition.sroa_idx, align 4
  %58 = load <2 x float>, ptr %m_hitNormalWorld, align 8
  %59 = insertelement <2 x float> poison, float %div.i.i.i, i64 0
  %60 = shufflevector <2 x float> %59, <2 x float> poison, <2 x i32> zeroinitializer
  %61 = fmul <2 x float> %51, %60
  %62 = fmul <2 x float> %61, %58
  %mul8.i.i.i158 = extractelement <2 x float> %62, i64 1
  %63 = extractelement <2 x float> %61, i64 0
  %64 = extractelement <2 x float> %58, i64 0
  %65 = call float @llvm.fmuladd.f32(float %63, float %64, float %mul8.i.i.i158)
  %66 = call float @llvm.fmuladd.f32(float %mul7.i.i.i.i, float %56, float %65)
  %mul.i.i = fmul float %66, 2.000000e+00
  %mul8.i.i.i28.i = fmul float %56, %mul.i.i
  %sub14.i.i.i = fsub float %mul7.i.i.i.i, %mul8.i.i.i28.i
  %67 = insertelement <2 x float> poison, float %mul.i.i, i64 0
  %68 = shufflevector <2 x float> %67, <2 x float> poison, <2 x i32> zeroinitializer
  %69 = fmul <2 x float> %58, %68
  %70 = fsub <2 x float> %61, %69
  %71 = fmul <2 x float> %70, %70
  %mul8.i.i.i.i30.i = extractelement <2 x float> %71, i64 1
  %72 = extractelement <2 x float> %70, i64 0
  %73 = call float @llvm.fmuladd.f32(float %72, float %72, float %mul8.i.i.i.i30.i)
  %74 = call float @llvm.fmuladd.f32(float %sub14.i.i.i, float %sub14.i.i.i, float %73)
  %sqrt.i.i32.i = call float @llvm.sqrt.f32(float %74)
  %div.i.i33.i = fdiv float 1.000000e+00, %sqrt.i.i32.i
  %mul7.i.i.i36.i = fmul float %sub14.i.i.i, %div.i.i33.i
  %75 = insertelement <2 x float> poison, float %div.i.i33.i, i64 0
  %76 = shufflevector <2 x float> %75, <2 x float> poison, <2 x i32> zeroinitializer
  %77 = fmul <2 x float> %70, %76
  %78 = fmul <2 x float> %58, %77
  %mul8.i.i39.i = extractelement <2 x float> %78, i64 1
  %79 = extractelement <2 x float> %77, i64 0
  %80 = call float @llvm.fmuladd.f32(float %79, float %64, float %mul8.i.i39.i)
  %81 = call float @llvm.fmuladd.f32(float %mul7.i.i.i36.i, float %56, float %80)
  %mul8.i6.i.i = fmul float %56, %81
  %sub14.i.i54.i = fsub float %mul7.i.i.i36.i, %mul8.i6.i.i
  %82 = insertelement <2 x float> poison, float %81, i64 0
  %83 = shufflevector <2 x float> %82, <2 x float> poison, <2 x i32> zeroinitializer
  %84 = fmul <2 x float> %58, %83
  %85 = fsub <2 x float> %77, %84
  %86 = insertelement <2 x float> poison, float %sqrt.i.i, i64 0
  %87 = shufflevector <2 x float> %86, <2 x float> poison, <2 x i32> zeroinitializer
  %88 = fmul <2 x float> %87, %85
  %mul8.i.i159 = fmul float %sqrt.i.i, %sub14.i.i54.i
  %89 = load <2 x float>, ptr %m_targetPosition, align 4
  %90 = fadd <2 x float> %89, %88
  store <2 x float> %90, ptr %m_targetPosition, align 4
  %add13.i.i = fadd float %57, %mul8.i.i159
  store float %add13.i.i, ptr %ref.tmp.sroa.4.0.m_targetPosition.sroa_idx, align 4
  %91 = fsub <2 x float> %90, %50
  %.pre209 = fsub float %add13.i.i, %49
  %92 = fmul <2 x float> %91, %91
  %.pre210 = extractelement <2 x float> %92, i64 1
  %93 = extractelement <2 x float> %91, i64 0
  %.pre211 = call float @llvm.fmuladd.f32(float %93, float %93, float %.pre210)
  %.pre212 = call float @llvm.fmuladd.f32(float %.pre209, float %.pre209, float %.pre211)
  br label %invoke.cont75

invoke.cont75:                                    ; preds = %if.end70, %if.then.i
  %.pre-phi213 = phi float [ %55, %if.end70 ], [ %.pre212, %if.then.i ]
  %sub14.i166.pre-phi = phi float [ %sub14.i.i, %if.end70 ], [ %.pre209, %if.then.i ]
  %94 = phi <2 x float> [ %51, %if.end70 ], [ %91, %if.then.i ]
  %cmp80 = fcmp ogt float %.pre-phi213, 0x3E80000000000000
  br i1 %cmp80, label %cleanup, label %cleanup97.thread

cleanup97.thread:                                 ; preds = %invoke.cont75
  call void @llvm.lifetime.end.p0(i64 96, ptr nonnull %callback) #20
  br label %while.end

cleanup:                                          ; preds = %invoke.cont75
  %sqrt.i.i176 = call float @llvm.sqrt.f32(float %.pre-phi213)
  %div.i.i = fdiv float 1.000000e+00, %sqrt.i.i176
  %95 = extractelement <2 x float> %94, i64 0
  %mul.i.i.i177 = fmul float %95, %div.i.i
  %96 = extractelement <2 x float> %94, i64 1
  %mul4.i.i.i178 = fmul float %96, %div.i.i
  %mul7.i.i.i = fmul float %sub14.i166.pre-phi, %div.i.i
  %97 = load float, ptr %m_normalizedDirection84, align 8
  %98 = load float, ptr %arrayidx7.i180, align 4
  %mul8.i181 = fmul float %mul4.i.i.i178, %98
  %99 = call float @llvm.fmuladd.f32(float %mul.i.i.i177, float %97, float %mul8.i181)
  %100 = load float, ptr %arrayidx12.i183, align 8
  %101 = call float @llvm.fmuladd.f32(float %mul7.i.i.i, float %100, float %99)
  %cmp87 = fcmp ugt float %101, 0.000000e+00
  br i1 %cmp87, label %if.end96, label %cleanup97

if.else93:                                        ; preds = %if.end42
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_currentPosition, ptr noundef nonnull align 4 dereferenceable(16) %m_targetPosition, i64 16, i1 false)
  br label %if.end96

if.end96:                                         ; preds = %cleanup, %if.else93
  call void @llvm.lifetime.end.p0(i64 96, ptr nonnull %callback) #20
  %cmp12 = fcmp ogt float %sub, 0x3F847AE140000000
  br i1 %cmp12, label %land.rhs, label %while.end

cleanup97:                                        ; preds = %cleanup
  call void @llvm.lifetime.end.p0(i64 96, ptr nonnull %callback) #20
  br label %while.end

while.end:                                        ; preds = %if.end96, %land.rhs, %cleanup97, %cleanup97.thread
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %end) #20
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %start) #20
  ret void
}
...
entry:
  ...
  %1 = load float, ptr %m_currentStepOffset, align 8
  %arrayidx7.i = getelementptr inbounds [4 x float], ptr %arrayidx, i64 0, i64 2
  %2 = load float, ptr %arrayidx7.i, align 8
  %mul8.i = fmul float %1, %2
  %m_stepHeight = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 8
  %3 = load float, ptr %m_stepHeight, align 8
  ...
  %12 = load <2 x float>, ptr %m_targetPosition, align 4
  %13 = fsub <2 x float> %12, %11
  store <2 x float> %13, ptr %m_targetPosition, align 4
  ...
  store float 1.000000e+00, ptr %arrayidx3.i6.i.i.i61, align 4
  ...
  store float 1.000000e+00, ptr %arrayidx5.i10.i.i.i63, align 4
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i65, ptr noundef nonnull align 4 dereferenceable(16) %m_targetPosition, i64 16, i1 false)
  call void @llvm.lifetime.start.p0(i64 96, ptr nonnull %callback) #20
  %m_ghostObject = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 2
...
if.end:                                           ; preds = %if.then, %if.else
  %21 = load float, ptr %m_closestHitFraction.i.i.i, align 8
  %cmp.i = fcmp olt float %21, 1.000000e+00
  br i1 %cmp.i, label %if.then29, label %if.else34

if.then29:                                        ; preds = %if.end
  %sub.i69 = fsub float 1.000000e+00, %21
  %22 = load <2 x float>, ptr %m_currentPosition, align 8
  %23 = load <2 x float>, ptr %m_targetPosition, align 4
  ...
  store float %32, ptr %arrayidx15.i, align 8
  br label %if.end37
...
entry:
  ...
  store i8 1, ptr %m_useWalkDirection, align 1
  %m_walkDirection = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 10
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_walkDirection, ptr noundef nonnull align 4 dereferenceable(16) %walkDirection, i64 16, i1 false)
  %arrayidx10.i.i.i.i.i = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 10, i32 0, i64 2
  %0 = load float, ptr %arrayidx10.i.i.i.i.i, align 8
  %1 = load <2 x float>, ptr %m_walkDirection, align 8
  ...
  %m_normalizedDirection = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 11
  store <2 x float> %retval.sroa.0.0.i, ptr %m_normalizedDirection, align 8
  ...
  store <2 x float> %retval.sroa.6.0.i, ptr %ref.tmp.sroa.4.0.m_normalizedDirection.sroa_idx, align 8
  ret void
}
...
entry:
  ...
  %m_walkDirection = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 10
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_walkDirection, ptr noundef nonnull align 4 dereferenceable(16) %velocity, i64 16, i1 false)
  %arrayidx10.i.i.i.i.i = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 10, i32 0, i64 2
  %0 = load float, ptr %arrayidx10.i.i.i.i.i, align 8
  %1 = load <2 x float>, ptr %m_walkDirection, align 8
  %2 = fmul <2 x float> %1, %1
  ...
  store <2 x float> %retval.sroa.6.0.i, ptr %ref.tmp.sroa.4.0.m_normalizedDirection.sroa_idx, align 8
  %m_velocityTimeInterval = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 21
  store float %timeInterval, ptr %m_velocityTimeInterval, align 8
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local void @_ZN30btKinematicCharacterController5resetEv(ptr nocapture nonnull readnone align 8 %this) unnamed_addr #11 align 2 {
entry:
  ret void
}
...
entry:
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %xform.sroa.10.sroa.4, ptr noundef nonnull align 4 dereferenceable(16) %origin, i64 16, i1 false)
  %m_ghostObject = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 2
  %0 = load ptr, ptr %m_ghostObject, align 8
  ...
  store float 1.000000e+00, ptr %xform.sroa.6.16.arrayidx7.i.i.i.sroa_idx, align 4
  ...
  store float 1.000000e+00, ptr %xform.sroa.9.32.arrayidx11.i.i.i.sroa_idx, align 8
  ...
  store i32 0, ptr %xform.sroa.10.32.arrayidx11.i.i.i.sroa_idx, align 4
  %m_origin3.i.i = getelementptr inbounds %class.btCollisionObject, ptr %0, i64 0, i32 1, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_origin3.i.i, ptr noundef nonnull align 4 dereferenceable(16) %xform.sroa.10.sroa.4, i64 16, i1 false)
...
entry:
  ...
  %m_useWalkDirection = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 20
  %0 = load i8, ptr %m_useWalkDirection, align 1
...
if.end:                                           ; preds = %entry
  ...
  %3 = load i8, ptr %m_useWalkDirection, align 1
...
if.else:                                          ; preds = %if.end
  %4 = load float, ptr %m_velocityTimeInterval, align 8
  %cmp7 = fcmp ogt float %4, %dt
  %dt. = select i1 %cmp7, float %dt, float %4
  %sub = fsub float %4, %dt
  store float %sub, ptr %m_velocityTimeInterval, align 8
  ...
  %5 = load <2 x float>, ptr %m_walkDirection10, align 8
...
if.end12:                                         ; preds = %if.else, %if.then5
  ...
  %m_currentPosition = getelementptr inbounds %class.btKinematicCharacterController, ptr %this, i64 0, i32 12
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %m_origin3.i, ptr noundef nonnull align 8 dereferenceable(16) %m_currentPosition, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_worldTransform.i21, ptr noundef nonnull align 4 dereferenceable(16) %xform, i64 16, i1 false)
...
entry:
  ...
  store float %fallSpeed, ptr %m_fallSpeed, align 8
  ret void
}
...
entry:
  ...
  store float %jumpSpeed, ptr %m_jumpSpeed, align 4
  ret void
}
...
land.rhs:                                         ; preds = %entry
  ...
  %2 = load i16, ptr %m_collisionFilterGroup3, align 4
...
if.then.i:                                        ; preds = %if.end
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_hitNormalWorld.i, ptr noundef nonnull align 8 dereferenceable(16) %m_hitNormalLocal.i, i64 16, i1 false)
...
if.else.i:                                        ; preds = %if.end
  ...
  %3 = load float, ptr %m_worldTransform.i.i, align 4
  %4 = load float, ptr %m_hitNormalLocal5.i, align 8
  ...
  %27 = load float, ptr %arrayidx.i17.i.i, align 4
  %arrayidx5.i18.i.i = getelementptr inbounds %class.btCollisionObject, ptr %0, i64 0, i32 1, i32 0, i32 0, i64 2, i32 0, i64 1
  %28 = load float, ptr %arrayidx5.i18.i.i, align 4
  %mul8.i20.i.i = fmul float %6, %28
  %29 = tail call float @llvm.fmuladd.f32(float %27, float %4, float %mul8.i20.i.i)
  %arrayidx10.i21.i.i = getelementptr inbounds %class.btCollisionObject, ptr %0, i64 0, i32 1, i32 0, i32 0, i64 2, i32 0, i64 2
  %30 = load float, ptr %arrayidx10.i21.i.i, align 4
  %31 = tail call float @llvm.fmuladd.f32(float %30, float %8, float %29)
  ...
  store <2 x float> %26, ptr %m_hitNormalWorld7.i, align 8
...
_ZN16btCollisionWorld27ClosestConvexResultCallback15addSingleResultERNS_17LocalConvexResultEb.exit: ; preds = %if.then.i, %if.else.i
  ...
  %32 = load float, ptr %m_hitFraction.i, align 8
  br label %return
...
attributes #1 = { mustprogress nofree nosync nounwind willreturn memory(argmem: read) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #10 = { mustprogress nofree nosync nounwind willreturn memory(argmem: readwrite) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
