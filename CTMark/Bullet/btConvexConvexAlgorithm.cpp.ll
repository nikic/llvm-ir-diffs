; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btConvexConvexAlgorithm.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btConvexConvexAlgorithm.cpp"
...
invoke.cont2:                                     ; preds = %entry
  ...
  %2 = load ptr, ptr %m_collisionShape.i15, align 8
...
if.end:                                           ; preds = %if.then, %entry
  ...
  store ptr %3, ptr %m_manifoldPtr.i, align 8
  %m_collisionShape.i = getelementptr inbounds %class.btCollisionObject, ptr %body0, i64 0, i32 9
  ...
  %5 = load ptr, ptr %m_collisionShape.i324, align 8
  ...
  %6 = load i32, ptr %m_shapeType.i, align 8
...
land.lhs.true:                                    ; preds = %if.end
  ...
  %7 = load i32, ptr %m_shapeType.i325, align 8
...
if.then9:                                         ; preds = %land.lhs.true
  ...
  %11 = load i32, ptr %m_upAxis.i, align 8
  ...
  %13 = load float, ptr %arrayidx.i329, align 4
  ...
  %14 = load i32, ptr %m_upAxis.i331, align 8
  ...
  %15 = load float, ptr %arrayidx.i333, align 4
  ...
  %16 = load float, ptr %arrayidx.i339, align 4
  ...
  %17 = load float, ptr %arrayidx2.i.i, align 4
  ...
  %translationA.sroa.5.0.copyload.i = load float, ptr %translationA.sroa.5.0.m_origin.i.sroa_idx.i, align 4
  ...
  %20 = load float, ptr %arrayidx2.i48.i, align 4
  %21 = load float, ptr %arrayidx7.i50.i, align 4
  %22 = load float, ptr %arrayidx12.i52.i, align 4
  ...
  %mul8.i.i.i.i = fmul float %18, %21
  %26 = tail call float @llvm.fmuladd.f32(float %17, float %20, float %mul8.i.i.i.i)
  %27 = tail call float @llvm.fmuladd.f32(float %19, float %22, float %26)
  %28 = extractelement <2 x float> %25, i64 1
  %mul8.i.i110.i.i = fmul float %18, %28
  %29 = extractelement <2 x float> %25, i64 0
  %30 = tail call float @llvm.fmuladd.f32(float %17, float %29, float %mul8.i.i110.i.i)
  %31 = tail call float @llvm.fmuladd.f32(float %19, float %sub14.i.i, float %30)
  %mul8.i.i115.i.i = fmul float %21, %28
  %32 = tail call float @llvm.fmuladd.f32(float %20, float %29, float %mul8.i.i115.i.i)
  %33 = tail call float @llvm.fmuladd.f32(float %22, float %sub14.i.i, float %32)
...
if.then13.i:                                      ; preds = %if.end.i
  %56 = tail call float @llvm.fabs.f32(float %19)
  %cmp.i69.i = fcmp ogt float %56, 0x3FE6A09E60000000
  %arrayidx5.i.i75.i = getelementptr inbounds [4 x float], ptr %normalOnB, i64 0, i64 2
  br i1 %cmp.i69.i, label %if.then.i71.i, label %if.else.i70.i

if.then.i71.i:                                    ; preds = %if.then13.i
  ...
  %mul9.i.i = fmul float %19, %19
  %57 = tail call float @llvm.fmuladd.f32(float %18, float %18, float %mul9.i.i)
  %sqrt.i72.i = tail call float @llvm.sqrt.f32(float %57)
  %div.i73.i = fdiv float 1.000000e+00, %sqrt.i72.i
  %fneg.i74.i = fneg float %19
  %mul.i.i = fmul float %div.i73.i, %fneg.i74.i
  %mul17.i.i = fmul float %18, %div.i73.i
  store float 0.000000e+00, ptr %normalOnB, align 8
  store float %mul.i.i, ptr %arrayidx3.i.i.i, align 4
  store float %mul17.i.i, ptr %arrayidx5.i.i75.i, align 8
...
if.else.i70.i:                                    ; preds = %if.then13.i
  %mul39.i.i = fmul float %18, %18
  %59 = tail call float @llvm.fmuladd.f32(float %17, float %17, float %mul39.i.i)
  %sqrt106.i.i = tail call float @llvm.sqrt.f32(float %59)
  %div42.i.i = fdiv float 1.000000e+00, %sqrt106.i.i
  %fneg45.i.i = fneg float %18
  ...
  %63 = insertelement <2 x float> %62, float %17, i64 1
  %64 = fmul <2 x float> %61, %63
  store <2 x float> %64, ptr %normalOnB, align 8
  store <2 x float> zeroinitializer, ptr %arrayidx5.i.i75.i, align 8
  br label %if.end18.i
...
if.else.i:                                        ; preds = %if.end.i
  ...
  store <2 x float> %67, ptr %normalOnB, align 8
  %ref.tmp.sroa.4.0..sroa_idx.i = getelementptr inbounds i8, ptr %normalOnB, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i80.i, ptr %ref.tmp.sroa.4.0..sroa_idx.i, align 8
  br label %if.end18.i

if.end18.i:                                       ; preds = %if.else.i, %if.else.i70.i, %if.then.i71.i
  %68 = phi float [ 0.000000e+00, %if.else.i70.i ], [ %mul17.i.i, %if.then.i71.i ], [ %mul8.i.i, %if.else.i ]
  %69 = phi <2 x float> [ %64, %if.else.i70.i ], [ %58, %if.then.i71.i ], [ %67, %if.else.i ]
  ...
  store <2 x float> %74, ptr %pointOnBWorld, align 8
  %ref.tmp19.sroa.4.0..sroa_idx.i = getelementptr inbounds i8, ptr %pointOnBWorld, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i112.i, ptr %ref.tmp19.sroa.4.0..sroa_idx.i, align 8
...
if.then28:                                        ; preds = %_ZL22capsuleCapsuleDistanceR9btVector3S0_ffffiiRK11btTransformS3_f.exit
  %vtable29 = load ptr, ptr %resultOut, align 8
...
if.end32:                                         ; preds = %land.lhs.true, %if.end
  ...
  %80 = load i8, ptr %m_useConvexConservativeDistanceUtil, align 8
...
if.then39:                                        ; preds = %if.end32
  ...
  %m_simplexSolver = getelementptr inbounds %class.btConvexConvexAlgorithm, ptr %this, i64 0, i32 3
  %82 = load ptr, ptr %m_simplexSolver, align 8
  %m_pdSolver = getelementptr inbounds %class.btConvexConvexAlgorithm, ptr %this, i64 0, i32 4
  %83 = load ptr, ptr %m_pdSolver, align 8
...
if.else:                                          ; preds = %if.then39
  ...
  %87 = load ptr, ptr %m_manifoldPtr, align 8
...
invoke.cont66:                                    ; preds = %if.then39, %if.else
  ...
  store float %storemerge673, ptr %m_maximumDistanceSquared.i, align 8
  %m_stackAllocator = getelementptr inbounds %struct.btDispatcherInfo, ptr %dispatchInfo, i64 0, i32 12
  %88 = load ptr, ptr %m_stackAllocator, align 8
  store ptr %88, ptr %m_stackAlloc.i, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %input, ptr noundef nonnull align 4 dereferenceable(16) %m_worldTransform.i346, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx7.i.i349, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx5.i.i, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx11.i.i, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx9.i.i350, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_transformB, ptr noundef nonnull align 4 dereferenceable(16) %m_worldTransform.i347, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx7.i.i353, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx5.i.i352, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx11.i.i355, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx9.i.i354, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_origin3.i357, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i356, i64 16, i1 false)
  %m_debugDraw = getelementptr inbounds %struct.btDispatcherInfo, ptr %dispatchInfo, i64 0, i32 5
  %89 = load ptr, ptr %m_debugDraw, align 8
  ...
  %90 = load i8, ptr %m_useConvexConservativeDistanceUtil, align 8
...
if.then77:                                        ; preds = %invoke.cont66
  ...
  %91 = load float, ptr %m_cachedSeparatingDistance.i, align 4
...
invoke.cont87:                                    ; preds = %if.then77
  ...
  %92 = load float, ptr %m_convexConservativeDistanceThreshold, align 4
  ...
  %93 = load float, ptr %arrayidx10.i.i.i.i, align 8
  %94 = load <2 x float>, ptr %m_cachedSeparatingAxis.i, align 8
  ...
  br i1 %cmp.i364, label %if.then.i, label %if.else.i365
...
if.end91:                                         ; preds = %if.else.i365, %if.then.i, %if.then77, %invoke.cont66
  %sepNormalWorldSpace.sroa.0.0 = phi <2 x float> [ undef, %invoke.cont66 ], [ undef, %if.then77 ], [ %101, %if.then.i ], [ %101, %if.else.i365 ]
  %sepNormalWorldSpace.sroa.12.0 = phi <2 x float> [ undef, %invoke.cont66 ], [ undef, %if.then77 ], [ %retval.sroa.3.12.vec.insert.i.i.i, %if.then.i ], [ %retval.sroa.3.12.vec.insert.i.i.i, %if.else.i365 ]
  %v0.sroa.0.1 = phi float [ undef, %invoke.cont66 ], [ undef, %if.then77 ], [ 0.000000e+00, %if.then.i ], [ %mul46.i, %if.else.i365 ]
  %sepDist.0 = phi float [ 0.000000e+00, %invoke.cont66 ], [ %91, %if.then77 ], [ %add83, %if.then.i ], [ %add83, %if.else.i365 ]
  %114 = phi <2 x float> [ undef, %invoke.cont66 ], [ undef, %if.then77 ], [ %109, %if.then.i ], [ %113, %if.else.i365 ]
  %115 = load ptr, ptr %m_manifoldPtr.i, align 8
  %m_cachedPoints.i = getelementptr inbounds %class.btPersistentManifold, ptr %115, i64 0, i32 5
  %116 = load i32, ptr %m_cachedPoints.i, align 8
  %m_minimumPointsPerturbationThreshold = getelementptr inbounds %class.btConvexConvexAlgorithm, ptr %this, i64 0, i32 11
  %117 = load i32, ptr %m_minimumPointsPerturbationThreshold, align 8
  %cmp96 = icmp slt i32 %116, %117
  br i1 %cmp96, label %if.then97, label %if.end224

if.then97:                                        ; preds = %if.end91
  %vtable98 = load ptr, ptr %4, align 8
  ...
  %vtable103 = load ptr, ptr %5, align 8
  ...
  %m_numPerturbationIterations = getelementptr inbounds %class.btConvexConvexAlgorithm, ptr %this, i64 0, i32 10
  %121 = load i32, ptr %m_numPerturbationIterations, align 4
...
invoke.cont136.lr.ph:                             ; preds = %if.then97
  ...
  %storemerge315 = select i1 %cmp113, float 0x3FD921FB60000000, float %storemerge
  ...
  %mul.i.i384 = fmul float %storemerge315, 5.000000e-01
  %sepNormalWorldSpace.sroa.0.0.vec.extract654 = extractelement <2 x float> %sepNormalWorldSpace.sroa.0.0, i64 0
  %126 = fmul <2 x float> %sepNormalWorldSpace.sroa.0.0, %sepNormalWorldSpace.sroa.0.0
  %mul8.i.i.i.i.i390 = extractelement <2 x float> %126, i64 1
  %127 = call float @llvm.fmuladd.f32(float %sepNormalWorldSpace.sroa.0.0.vec.extract654, float %sepNormalWorldSpace.sroa.0.0.vec.extract654, float %mul8.i.i.i.i.i390)
  %sepNormalWorldSpace.sroa.12.8.vec.extract666 = extractelement <2 x float> %sepNormalWorldSpace.sroa.12.0, i64 0
  %128 = call float @llvm.fmuladd.f32(float %sepNormalWorldSpace.sroa.12.8.vec.extract666, float %sepNormalWorldSpace.sroa.12.8.vec.extract666, float %127)
  %sqrt.i.i.i392 = call float @llvm.sqrt.f32(float %128)
  ...
  %129 = shufflevector <2 x float> %sepNormalWorldSpace.sroa.0.0, <2 x float> %sepNormalWorldSpace.sroa.12.0, <2 x i32> <i32 1, i32 2>
...
invoke.cont136:                                   ; preds = %invoke.cont136.lr.ph, %invoke.cont208
  ...
  %130 = load i32, ptr %m_numPerturbationIterations, align 4
  %conv132 = sitofp i32 %130 to float
  ...
  %131 = insertelement <2 x float> poison, float %div.i.i385, i64 0
  %132 = shufflevector <2 x float> %131, <2 x float> poison, <2 x i32> zeroinitializer
  %133 = fmul <2 x float> %114, %132
  %134 = insertelement <2 x float> poison, float %div.i.i395, i64 0
  %135 = shufflevector <2 x float> %134, <2 x float> poison, <2 x i32> zeroinitializer
  %136 = fmul <2 x float> %129, %135
...
invoke.cont163:                                   ; preds = %invoke.cont136
  ...
  %mul25.i = fmul float %call.i21.i.i, %139
  %140 = extractelement <2 x float> %133, i64 0
  %141 = call float @llvm.fmuladd.f32(float %call.i21.i.i400, float %140, float %mul25.i)
  %142 = extractelement <2 x float> %133, i64 1
  %143 = call float @llvm.fmuladd.f32(float %fneg.i404, float %142, float %141)
  %144 = extractelement <2 x float> %136, i64 0
  %145 = call float @llvm.fmuladd.f32(float %144, float %mul4.i.i386, float %143)
  %neg37.i = fmul float %mul4.i.i386, %mul4.i.i396
  %146 = call float @llvm.fmuladd.f32(float %call.i21.i.i400, float %call.i21.i.i, float %neg37.i)
  %147 = call float @llvm.fmuladd.f32(float %144, float %142, float %146)
  %148 = extractelement <2 x float> %136, i64 1
  %149 = call float @llvm.fmuladd.f32(float %148, float %140, float %147)
  %neg.i419 = fneg float %145
  %150 = insertelement <2 x float> poison, float %call.i21.i.i, i64 0
  %151 = shufflevector <2 x float> %150, <2 x float> poison, <2 x i32> zeroinitializer
  %152 = shufflevector <2 x float> %138, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %153 = insertelement <2 x float> %152, float %fneg.i404, i64 1
  %154 = fmul <2 x float> %151, %153
  %155 = insertelement <2 x float> poison, float %call.i21.i.i400, i64 0
  %156 = shufflevector <2 x float> %155, <2 x float> poison, <2 x i32> zeroinitializer
  %157 = shufflevector <2 x float> %133, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %158 = insertelement <2 x float> %157, float %mul4.i.i386, i64 1
  %159 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %156, <2 x float> %158, <2 x float> %154)
  %160 = shufflevector <2 x float> %158, <2 x float> %133, <2 x i32> <i32 1, i32 2>
  %161 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %138, <2 x float> %160, <2 x float> %159)
  %162 = insertelement <2 x float> %136, float %mul4.i.i396, i64 0
  %163 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %162, <2 x float> %133, <2 x float> %161)
  %164 = shufflevector <2 x float> %163, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %165 = insertelement <2 x float> %164, float %145, i64 0
  ...
  %169 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %168, <2 x float> %137, <2 x float> %166)
  %170 = shufflevector <2 x float> %163, <2 x float> %165, <2 x i32> <i32 1, i32 2>
  %171 = insertelement <2 x float> %136, float %mul4.i.i396, i64 1
  %172 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %170, <2 x float> %171, <2 x float> %169)
  %173 = fneg <2 x float> %163
  %174 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %173, <2 x float> %162, <2 x float> %172)
  %175 = insertelement <2 x float> %156, float %mul4.i.i396, i64 1
  %176 = shufflevector <2 x float> %163, <2 x float> %173, <2 x i32> <i32 1, i32 3>
  %177 = fmul <2 x float> %175, %176
  %178 = shufflevector <2 x float> %175, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %179 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %168, <2 x float> %178, <2 x float> %177)
  %180 = shufflevector <2 x float> %163, <2 x float> %173, <2 x i32> <i32 0, i32 2>
  %181 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %180, <2 x float> %137, <2 x float> %179)
  %182 = insertelement <2 x float> poison, float %neg.i419, i64 0
  %183 = shufflevector <2 x float> %182, <2 x float> poison, <2 x i32> zeroinitializer
  %184 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %183, <2 x float> %136, <2 x float> %181)
  %185 = extractelement <2 x float> %174, i64 1
  %mul5.i.i.i.i = fmul float %185, %185
  %186 = extractelement <2 x float> %184, i64 0
  %187 = call float @llvm.fmuladd.f32(float %186, float %186, float %mul5.i.i.i.i)
  %188 = extractelement <2 x float> %174, i64 0
  ...
  %div.i.i432 = fdiv float 2.000000e+00, %191
  %mul.i.i433 = fmul float %186, %div.i.i432
  %192 = insertelement <2 x float> poison, float %div.i.i432, i64 0
  %193 = shufflevector <2 x float> %192, <2 x float> poison, <2 x i32> zeroinitializer
  %194 = fmul <2 x float> %174, %193
  %mul8.i.i435 = fmul float %190, %mul.i.i433
  %195 = extractelement <2 x float> %194, i64 0
  %mul12.i.i437 = fmul float %190, %195
  %mul14.i.i = fmul float %186, %mul.i.i433
  %shift = shufflevector <2 x float> %194, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %196 = fmul <2 x float> %184, %shift
  %mul16.i.i = extractelement <2 x float> %196, i64 0
  %197 = fmul <2 x float> %184, %194
  %mul22.i.i = fmul float %185, %195
  %198 = fmul <2 x float> %174, %194
  %199 = extractelement <2 x float> %198, i64 0
  %200 = extractelement <2 x float> %198, i64 1
  %add.i.i438 = fadd float %200, %199
  %sub.i.i439 = fsub float 1.000000e+00, %add.i.i438
  %sub26.i.i = fsub float %mul16.i.i, %mul12.i.i437
  %201 = extractelement <2 x float> %197, i64 0
  %202 = extractelement <2 x float> %197, i64 1
  %add28.i.i = fadd float %201, %202
  %add30.i.i = fadd float %mul16.i.i, %mul12.i.i437
  %add32.i.i = fadd float %mul14.i.i, %199
  %sub33.i.i = fsub float 1.000000e+00, %add32.i.i
  %sub35.i.i = fsub float %mul22.i.i, %mul8.i.i435
  %sub37.i.i = fsub float %201, %202
  %add39.i.i = fadd float %mul22.i.i, %mul8.i.i435
  %add41.i.i = fadd float %mul14.i.i, %200
  %sub42.i.i = fsub float 1.000000e+00, %add41.i.i
  %203 = load float, ptr %arrayidx.i.i45.i, align 4
  %204 = load float, ptr %arrayidx.i14.i46.i, align 4
  %mul7.i48.i = fmul float %sub26.i.i, %204
  %205 = call float @llvm.fmuladd.f32(float %203, float %sub.i.i439, float %mul7.i48.i)
  %206 = load float, ptr %arrayidx.i16.i49.i, align 4
  %207 = call float @llvm.fmuladd.f32(float %206, float %add28.i.i, float %205)
  %mul7.i67.i = fmul float %sub33.i.i, %204
  %208 = call float @llvm.fmuladd.f32(float %203, float %add30.i.i, float %mul7.i67.i)
  %209 = call float @llvm.fmuladd.f32(float %206, float %sub35.i.i, float %208)
  %mul7.i87.i = fmul float %add39.i.i, %204
  %210 = call float @llvm.fmuladd.f32(float %203, float %sub37.i.i, float %mul7.i87.i)
  %211 = call float @llvm.fmuladd.f32(float %206, float %sub42.i.i, float %210)
  %212 = load <2 x float>, ptr %m_worldTransform.i346, align 4
  %213 = load <2 x float>, ptr %arrayidx5.i.i, align 4
  %214 = insertelement <2 x float> poison, float %sub26.i.i, i64 0
  %215 = shufflevector <2 x float> %214, <2 x float> poison, <2 x i32> zeroinitializer
  %216 = fmul <2 x float> %215, %213
  %217 = insertelement <2 x float> poison, float %sub.i.i439, i64 0
  %218 = shufflevector <2 x float> %217, <2 x float> poison, <2 x i32> zeroinitializer
  %219 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %212, <2 x float> %218, <2 x float> %216)
  %220 = load <2 x float>, ptr %arrayidx9.i.i350, align 4
  %221 = insertelement <2 x float> poison, float %add28.i.i, i64 0
  %222 = shufflevector <2 x float> %221, <2 x float> poison, <2 x i32> zeroinitializer
  %223 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %220, <2 x float> %222, <2 x float> %219)
  store <2 x float> %223, ptr %input, align 8
  store float %207, ptr %ref.tmp140.sroa.6.0.input.sroa_idx, align 8
  store float 0.000000e+00, ptr %ref.tmp140.sroa.7.0.input.sroa_idx, align 4
  %224 = insertelement <2 x float> poison, float %sub33.i.i, i64 0
  %225 = shufflevector <2 x float> %224, <2 x float> poison, <2 x i32> zeroinitializer
  %226 = fmul <2 x float> %225, %213
  %227 = insertelement <2 x float> poison, float %add30.i.i, i64 0
  %228 = shufflevector <2 x float> %227, <2 x float> poison, <2 x i32> zeroinitializer
  %229 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %212, <2 x float> %228, <2 x float> %226)
  %230 = insertelement <2 x float> poison, float %sub35.i.i, i64 0
  %231 = shufflevector <2 x float> %230, <2 x float> poison, <2 x i32> zeroinitializer
  %232 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %220, <2 x float> %231, <2 x float> %229)
  store <2 x float> %232, ptr %arrayidx7.i.i349, align 8
  store float %209, ptr %ref.tmp140.sroa.11.16.arrayidx7.i.i460.sroa_idx, align 8
  store float 0.000000e+00, ptr %ref.tmp140.sroa.12.16.arrayidx7.i.i460.sroa_idx, align 4
  %233 = insertelement <2 x float> poison, float %add39.i.i, i64 0
  %234 = shufflevector <2 x float> %233, <2 x float> poison, <2 x i32> zeroinitializer
  %235 = fmul <2 x float> %234, %213
  %236 = insertelement <2 x float> poison, float %sub37.i.i, i64 0
  %237 = shufflevector <2 x float> %236, <2 x float> poison, <2 x i32> zeroinitializer
  %238 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %212, <2 x float> %237, <2 x float> %235)
  %239 = insertelement <2 x float> poison, float %sub42.i.i, i64 0
  %240 = shufflevector <2 x float> %239, <2 x float> poison, <2 x i32> zeroinitializer
  %241 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %220, <2 x float> %240, <2 x float> %238)
  store <2 x float> %241, ptr %arrayidx11.i.i, align 8
  store float %211, ptr %ref.tmp140.sroa.16.32.arrayidx11.i.i462.sroa_idx, align 8
  store float 0.000000e+00, ptr %ref.tmp140.sroa.17.32.arrayidx11.i.i462.sroa_idx, align 4
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_transformB, ptr noundef nonnull align 4 dereferenceable(16) %m_worldTransform.i347, i64 16, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx7.i.i353, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx5.i.i352, i64 16, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx11.i.i355, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx9.i.i354, i64 16, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_origin3.i357, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i356, i64 16, i1 false)
...
invoke.cont200:                                   ; preds = %invoke.cont136
  ...
  %242 = call float @llvm.fmuladd.f32(float %call.i21.i.i400, float %call.i21.i.i, float %neg37.i501)
  %243 = extractelement <2 x float> %136, i64 0
  %244 = extractelement <2 x float> %133, i64 1
  %245 = call float @llvm.fmuladd.f32(float %243, float %244, float %242)
  %246 = extractelement <2 x float> %136, i64 1
  %247 = extractelement <2 x float> %133, i64 0
  %248 = call float @llvm.fmuladd.f32(float %246, float %247, float %245)
  %249 = fneg <2 x float> %136
  %250 = insertelement <2 x float> poison, float %call.i21.i.i, i64 0
  %251 = shufflevector <2 x float> %250, <2 x float> poison, <2 x i32> zeroinitializer
  %252 = insertelement <2 x float> %249, float %fneg.i477, i64 1
  %253 = fmul <2 x float> %251, %252
  %254 = insertelement <2 x float> poison, float %call.i21.i.i400, i64 0
  %255 = shufflevector <2 x float> %254, <2 x float> poison, <2 x i32> zeroinitializer
  %256 = shufflevector <2 x float> %133, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %257 = insertelement <2 x float> %256, float %mul4.i.i386, i64 1
  %258 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %255, <2 x float> %257, <2 x float> %253)
  %259 = shufflevector <2 x float> %258, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %260 = insertelement <2 x float> %133, float %mul4.i.i386, i64 1
  %261 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %249, <2 x float> %260, <2 x float> %259)
  %262 = shufflevector <2 x float> %261, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %263 = insertelement <2 x float> %136, float %mul4.i.i396, i64 0
  %264 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %263, <2 x float> %133, <2 x float> %262)
  %265 = extractelement <2 x float> %249, i64 1
  %mul25.i499 = fmul float %call.i21.i.i, %265
  %266 = call float @llvm.fmuladd.f32(float %call.i21.i.i400, float %247, float %mul25.i499)
  %267 = call float @llvm.fmuladd.f32(float %fneg.i477, float %244, float %266)
  %268 = call float @llvm.fmuladd.f32(float %243, float %mul4.i.i386, float %267)
  %neg.i515 = fneg float %268
  %269 = shufflevector <2 x float> %264, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %270 = insertelement <2 x float> %269, float %268, i64 0
  %271 = fmul <2 x float> %255, %270
  %272 = insertelement <2 x float> poison, float %248, i64 0
  %273 = shufflevector <2 x float> %272, <2 x float> poison, <2 x i32> zeroinitializer
  %274 = shufflevector <2 x float> %136, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %275 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %273, <2 x float> %274, <2 x float> %271)
  %276 = shufflevector <2 x float> %264, <2 x float> %270, <2 x i32> <i32 1, i32 2>
  %277 = insertelement <2 x float> %136, float %mul4.i.i396, i64 1
  %278 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %276, <2 x float> %277, <2 x float> %275)
  %279 = fneg <2 x float> %264
  %280 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %279, <2 x float> %263, <2 x float> %278)
  %281 = insertelement <2 x float> %255, float %mul4.i.i396, i64 1
  %282 = shufflevector <2 x float> %264, <2 x float> %279, <2 x i32> <i32 1, i32 3>
  %283 = fmul <2 x float> %281, %282
  %284 = shufflevector <2 x float> %281, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %285 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %273, <2 x float> %284, <2 x float> %283)
  %286 = shufflevector <2 x float> %264, <2 x float> %279, <2 x i32> <i32 0, i32 2>
  %287 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %286, <2 x float> %274, <2 x float> %285)
  %288 = insertelement <2 x float> poison, float %neg.i515, i64 0
  %289 = shufflevector <2 x float> %288, <2 x float> poison, <2 x i32> zeroinitializer
  %290 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %289, <2 x float> %136, <2 x float> %287)
  %291 = extractelement <2 x float> %280, i64 1
  %mul5.i.i.i.i528 = fmul float %291, %291
  %292 = extractelement <2 x float> %290, i64 0
  %293 = call float @llvm.fmuladd.f32(float %292, float %292, float %mul5.i.i.i.i528)
  %294 = extractelement <2 x float> %280, i64 0
  ...
  %div.i.i531 = fdiv float 2.000000e+00, %297
  %mul.i.i532 = fmul float %292, %div.i.i531
  %298 = insertelement <2 x float> poison, float %div.i.i531, i64 0
  %299 = shufflevector <2 x float> %298, <2 x float> poison, <2 x i32> zeroinitializer
  %300 = fmul <2 x float> %280, %299
  %mul8.i.i535 = fmul float %296, %mul.i.i532
  %301 = extractelement <2 x float> %300, i64 0
  %mul12.i.i537 = fmul float %296, %301
  %mul14.i.i538 = fmul float %292, %mul.i.i532
  %shift676 = shufflevector <2 x float> %300, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %302 = fmul <2 x float> %290, %shift676
  %mul16.i.i539 = extractelement <2 x float> %302, i64 0
  %303 = fmul <2 x float> %290, %300
  %mul22.i.i542 = fmul float %291, %301
  %304 = fmul <2 x float> %280, %300
  %305 = extractelement <2 x float> %304, i64 0
  %306 = extractelement <2 x float> %304, i64 1
  %add.i.i544 = fadd float %306, %305
  %sub.i.i545 = fsub float 1.000000e+00, %add.i.i544
  %sub26.i.i546 = fsub float %mul16.i.i539, %mul12.i.i537
  %307 = extractelement <2 x float> %303, i64 0
  %308 = extractelement <2 x float> %303, i64 1
  %add28.i.i547 = fadd float %307, %308
  %add30.i.i548 = fadd float %mul16.i.i539, %mul12.i.i537
  %add32.i.i549 = fadd float %mul14.i.i538, %305
  %sub33.i.i550 = fsub float 1.000000e+00, %add32.i.i549
  %sub35.i.i551 = fsub float %mul22.i.i542, %mul8.i.i535
  %sub37.i.i552 = fsub float %307, %308
  %add39.i.i553 = fadd float %mul22.i.i542, %mul8.i.i535
  %add41.i.i554 = fadd float %mul14.i.i538, %306
  %sub42.i.i555 = fsub float 1.000000e+00, %add41.i.i554
  %309 = load float, ptr %arrayidx.i.i45.i577, align 4
  %310 = load float, ptr %arrayidx.i14.i46.i578, align 4
  %mul7.i48.i579 = fmul float %sub26.i.i546, %310
  %311 = call float @llvm.fmuladd.f32(float %309, float %sub.i.i545, float %mul7.i48.i579)
  %312 = load float, ptr %arrayidx.i16.i49.i580, align 4
  %313 = call float @llvm.fmuladd.f32(float %312, float %add28.i.i547, float %311)
  %mul7.i67.i586 = fmul float %sub33.i.i550, %310
  %314 = call float @llvm.fmuladd.f32(float %309, float %add30.i.i548, float %mul7.i67.i586)
  %315 = call float @llvm.fmuladd.f32(float %312, float %sub35.i.i551, float %314)
  %mul7.i87.i592 = fmul float %add39.i.i553, %310
  %316 = call float @llvm.fmuladd.f32(float %309, float %sub37.i.i552, float %mul7.i87.i592)
  %317 = call float @llvm.fmuladd.f32(float %312, float %sub42.i.i555, float %316)
  %318 = load <2 x float>, ptr %m_worldTransform.i347, align 4
  %319 = load <2 x float>, ptr %arrayidx5.i.i352, align 4
  %320 = insertelement <2 x float> poison, float %sub26.i.i546, i64 0
  %321 = shufflevector <2 x float> %320, <2 x float> poison, <2 x i32> zeroinitializer
  %322 = fmul <2 x float> %321, %319
  %323 = insertelement <2 x float> poison, float %sub.i.i545, i64 0
  %324 = shufflevector <2 x float> %323, <2 x float> poison, <2 x i32> zeroinitializer
  %325 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %318, <2 x float> %324, <2 x float> %322)
  %326 = load <2 x float>, ptr %arrayidx9.i.i354, align 4
  %327 = insertelement <2 x float> poison, float %add28.i.i547, i64 0
  %328 = shufflevector <2 x float> %327, <2 x float> poison, <2 x i32> zeroinitializer
  %329 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %326, <2 x float> %328, <2 x float> %325)
  store <2 x float> %329, ptr %m_transformB, align 8
  store float %313, ptr %ref.tmp177.sroa.6.0.m_transformB.sroa_idx, align 8
  store float 0.000000e+00, ptr %ref.tmp177.sroa.7.0.m_transformB.sroa_idx, align 4
  %330 = insertelement <2 x float> poison, float %sub33.i.i550, i64 0
  %331 = shufflevector <2 x float> %330, <2 x float> poison, <2 x i32> zeroinitializer
  %332 = fmul <2 x float> %331, %319
  %333 = insertelement <2 x float> poison, float %add30.i.i548, i64 0
  %334 = shufflevector <2 x float> %333, <2 x float> poison, <2 x i32> zeroinitializer
  %335 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %318, <2 x float> %334, <2 x float> %332)
  %336 = insertelement <2 x float> poison, float %sub35.i.i551, i64 0
  %337 = shufflevector <2 x float> %336, <2 x float> poison, <2 x i32> zeroinitializer
  %338 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %326, <2 x float> %337, <2 x float> %335)
  store <2 x float> %338, ptr %arrayidx7.i.i353, align 8
  store float %315, ptr %ref.tmp177.sroa.11.16.arrayidx7.i.i605.sroa_idx, align 8
  store float 0.000000e+00, ptr %ref.tmp177.sroa.12.16.arrayidx7.i.i605.sroa_idx, align 4
  %339 = insertelement <2 x float> poison, float %add39.i.i553, i64 0
  %340 = shufflevector <2 x float> %339, <2 x float> poison, <2 x i32> zeroinitializer
  %341 = fmul <2 x float> %340, %319
  %342 = insertelement <2 x float> poison, float %sub37.i.i552, i64 0
  %343 = shufflevector <2 x float> %342, <2 x float> poison, <2 x i32> zeroinitializer
  %344 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %318, <2 x float> %343, <2 x float> %341)
  %345 = insertelement <2 x float> poison, float %sub42.i.i555, i64 0
  %346 = shufflevector <2 x float> %345, <2 x float> poison, <2 x i32> zeroinitializer
  %347 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %326, <2 x float> %346, <2 x float> %344)
  store <2 x float> %347, ptr %arrayidx11.i.i355, align 8
  store float %317, ptr %ref.tmp177.sroa.16.32.arrayidx11.i.i607.sroa_idx, align 8
  store float 0.000000e+00, ptr %ref.tmp177.sroa.17.32.arrayidx11.i.i607.sroa_idx, align 4
  br label %invoke.cont208
...
invoke.cont208:                                   ; preds = %invoke.cont200, %invoke.cont163
  ...
  %348 = load ptr, ptr %m_debugDraw, align 8
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx8.i.i.i, ptr noundef nonnull align 8 dereferenceable(16) %arrayidx7.i.i349, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_origin.i.i608, ptr noundef nonnull align 8 dereferenceable(16) %m_origin3.i, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx8.i.i8.i, ptr noundef nonnull align 8 dereferenceable(16) %arrayidx7.i.i353, i64 16, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx12.i.i10.i, ptr noundef nonnull align 8 dereferenceable(16) %arrayidx11.i.i355, i64 16, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_origin.i11.i, ptr noundef nonnull align 8 dereferenceable(16) %m_origin3.i357, i64 16, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_unPerturbedTransform.i, ptr noundef nonnull align 4 dereferenceable(16) %unPerturbedTransform, i64 16, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx8.i.i14.i, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx6.i.i13.i, i64 16, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx12.i.i16.i, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx10.i.i15.i, i64 16, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_origin.i17.i, ptr noundef nonnull align 4 dereferenceable(16) %m_origin3.i18.i, i64 16, i1 false)
  store i8 %frombool.i, ptr %m_perturbA.i, align 8
  store ptr %348, ptr %m_debugDrawer.i, align 8
  call void @_ZN17btGjkPairDetector16getClosestPointsERKN36btDiscreteCollisionDetectorInterface17ClosestPointInputERNS0_6ResultEP12btIDebugDrawb(ptr noundef nonnull align 8 dereferenceable(96) %gjkPairDetector, ptr noundef nonnull align 8 dereferenceable(144) %input, ptr noundef nonnull align 8 dereferenceable(8) %perturbedResultOut, ptr noundef %348, i1 noundef zeroext false)
  call void @llvm.lifetime.end.p0(i64 392, ptr nonnull %perturbedResultOut) #16
  %inc = add nuw nsw i32 %i.0675, 1
  %349 = load i32, ptr %m_numPerturbationIterations, align 4
  %cmp128 = icmp slt i32 %inc, %349
...
for.end:                                          ; preds = %invoke.cont208, %if.then97
  ...
  %.pre = load i8, ptr %m_useConvexConservativeDistanceUtil, align 8
  br label %if.end224

if.end224:                                        ; preds = %for.end, %if.end91
  %350 = phi i8 [ %.pre, %for.end ], [ %90, %if.end91 ]
  %tobool226 = icmp ne i8 %350, 0
...
if.then229:                                       ; preds = %if.end224
  store float %sepDist.0, ptr %m_separatingDistance.i, align 8
  %cmp.i613 = fcmp ogt float %sepDist.0, 0.000000e+00
  br i1 %cmp.i613, label %if.then.i615, label %if.end238

if.then.i615:                                     ; preds = %if.then229
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_separatingNormal.i, ptr noundef nonnull align 8 dereferenceable(16) %m_cachedSeparatingAxis.i609, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_posA.i, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i, i64 16, i1 false)
  %m_posB.i = getelementptr inbounds %class.btConvexConvexAlgorithm, ptr %this, i64 0, i32 1, i32 3
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %m_posB.i, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i356, i64 16, i1 false)
...
if.end238:                                        ; preds = %if.then.i615, %if.then229, %if.end224
...
if.end247:                                        ; preds = %if.end32, %if.end238
  ...
  %351 = load i8, ptr %m_ownManifold248, align 8
  %tobool249.not = icmp eq i8 %351, 0
  br i1 %tobool249.not, label %cleanup, label %if.then250

if.then250:                                       ; preds = %if.end247
  %352 = load ptr, ptr %m_manifoldPtr.i, align 8
  %m_cachedPoints.i.i620 = getelementptr inbounds %class.btPersistentManifold, ptr %352, i64 0, i32 5
  %353 = load i32, ptr %m_cachedPoints.i.i620, align 8
  %tobool.not.i621 = icmp eq i32 %353, 0
  br i1 %tobool.not.i621, label %cleanup, label %if.end.i622

if.end.i622:                                      ; preds = %if.then250
  %m_body0.i.i623 = getelementptr inbounds %class.btPersistentManifold, ptr %352, i64 0, i32 3
  %354 = load ptr, ptr %m_body0.i.i623, align 8
  %m_body0.i624 = getelementptr inbounds %class.btManifoldResult, ptr %resultOut, i64 0, i32 4
  %355 = load ptr, ptr %m_body0.i624, align 8
  %cmp.not.i625 = icmp eq ptr %354, %355
  br i1 %cmp.not.i625, label %if.else.i629, label %if.then5.i626

if.then5.i626:                                    ; preds = %if.end.i622
  %m_rootTransB.i627 = getelementptr inbounds %class.btManifoldResult, ptr %resultOut, i64 0, i32 3
  %m_rootTransA.i628 = getelementptr inbounds %class.btManifoldResult, ptr %resultOut, i64 0, i32 2
  call void @_ZN20btPersistentManifold20refreshContactPointsERK11btTransformS2_(ptr noundef nonnull align 8 dereferenceable(744) %352, ptr noundef nonnull align 4 dereferenceable(64) %m_rootTransB.i627, ptr noundef nonnull align 4 dereferenceable(64) %m_rootTransA.i628)
  br label %cleanup

if.else.i629:                                     ; preds = %if.end.i622
  %m_rootTransA8.i630 = getelementptr inbounds %class.btManifoldResult, ptr %resultOut, i64 0, i32 2
  %m_rootTransB9.i631 = getelementptr inbounds %class.btManifoldResult, ptr %resultOut, i64 0, i32 3
  call void @_ZN20btPersistentManifold20refreshContactPointsERK11btTransformS2_(ptr noundef nonnull align 8 dereferenceable(744) %352, ptr noundef nonnull align 4 dereferenceable(64) %m_rootTransA8.i630, ptr noundef nonnull align 4 dereferenceable(64) %m_rootTransB9.i631)
  br label %cleanup

cleanup:                                          ; preds = %if.else.i629, %if.then5.i626, %if.then250, %if.else.i345, %if.then5.i, %if.end31, %if.end247
...
entry:
  ...
  %2 = load float, ptr %m_separatingDistance, align 4
...
if.then:                                          ; preds = %entry
  ...
  %3 = load float, ptr %angVelA, align 4
  ...
  %8 = load float, ptr %m_boundingRadiusA, align 4
  %9 = load float, ptr %angVelB, align 4
  %arrayidx5.i.i.i36 = getelementptr inbounds [4 x float], ptr %angVelB, i64 0, i64 1
  %10 = load float, ptr %arrayidx5.i.i.i36, align 4
  ...
  %12 = load float, ptr %arrayidx10.i.i.i38, align 4
  ...
  %14 = load float, ptr %m_boundingRadiusB, align 4
  %mul10 = fmul float %14, %sqrt.i39
  %15 = call float @llvm.fmuladd.f32(float %sqrt.i, float %8, float %mul10)
  %16 = load float, ptr %linVelB, align 4
  %17 = load float, ptr %linVelA, align 4
  ...
  %22 = load float, ptr %m_separatingNormal, align 4
  ...
  %27 = load float, ptr %m_separatingDistance, align 4
  %sub = fsub float %27, %add
  store float %sub, ptr %m_separatingDistance, align 4
...
if.end19:                                         ; preds = %if.then, %entry
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %m_posA20, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i, i64 16, i1 false)
  %m_posB21 = getelementptr inbounds %class.btConvexSeparatingDistanceUtil, ptr %this, i64 0, i32 3
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %m_posB21, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i29, i64 16, i1 false)
...
entry:
  ...
  %1 = load float, ptr %m_origin.i174, align 4
...
land.lhs.true:                                    ; preds = %entry
  ...
  %17 = load float, ptr %m_ccdMotionThreshold.i194, align 4
...
if.end:                                           ; preds = %entry
  %.old = load i8, ptr @disableCcd, align 1
...
invoke.cont23:                                    ; preds = %land.lhs.true, %if.end
  ...
  store ptr getelementptr inbounds ({ [20 x ptr] }, ptr @_ZTV13btSphereShape, i64 0, inrange i32 0, i64 2), ptr %sphere1, align 8
  ...
  store ptr getelementptr inbounds ({ [6 x ptr] }, ptr @_ZTVN12btConvexCast10CastResultE, i64 0, inrange i32 0, i64 2), ptr %result, align 8
...
if.end44:                                         ; preds = %if.then41, %if.then37
  ...
  %25 = load float, ptr %m_hitFraction.i201, align 4
  %cmp48 = fcmp ogt float %25, %22
  br i1 %cmp48, label %if.then49, label %if.end52

if.then49:                                        ; preds = %if.end44
  store float %22, ptr %m_hitFraction.i201, align 4
  br label %if.end52
...
invoke.cont77:                                    ; preds = %if.end58
  ...
  %26 = load ptr, ptr %m_collisionShape.i203, align 8
...
if.then92:                                        ; preds = %invoke.cont90
  ...
  %28 = load float, ptr %m_hitFraction.i218, align 4
  %29 = load float, ptr %m_fraction.i208, align 8
  %cmp96 = fcmp ogt float %28, %29
  br i1 %cmp96, label %if.then97, label %if.end100

if.then97:                                        ; preds = %if.then92
  store float %29, ptr %m_hitFraction.i218, align 4
  br label %if.end100
...
if.end100:                                        ; preds = %if.then97, %if.then92
  ...
  %32 = load float, ptr %m_hitFraction.i220, align 4
  %cmp104 = fcmp ogt float %32, %29
  br i1 %cmp104, label %if.then105, label %if.end108

if.then105:                                       ; preds = %if.end100
  store float %29, ptr %m_hitFraction.i220, align 4
  br label %if.end108
...
entry:
  ...
  %5 = load ptr, ptr %m_collisionShape.i.i, align 8
...
invoke.cont2.i:                                   ; preds = %entry
  ...
  %7 = load ptr, ptr %m_collisionShape.i15.i, align 8
...
_ZN23btConvexConvexAlgorithmC2EP20btPersistentManifoldRK36btCollisionAlgorithmConstructionInfoP17btCollisionObjectS6_P22btVoronoiSimplexSolverP30btConvexPenetrationDepthSolverii.exit: ; preds = %invoke.cont2.i
  ...
  store <2 x ptr> %12, ptr %m_simplexSolver.i, align 8
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i.new
  ...
  %9 = load ptr, ptr %arrayidx3.i.i.i.1, align 8
  store ptr %9, ptr %arrayidx.i.i.i.1, align 8
  ...
  %11 = load ptr, ptr %arrayidx3.i.i.i.2, align 8
  store ptr %11, ptr %arrayidx.i.i.i.2, align 8
  ...
  %13 = load ptr, ptr %arrayidx3.i.i.i.3, align 8
  store ptr %13, ptr %arrayidx.i.i.i.3, align 8
...
for.body.i.i.i.epil:                              ; preds = %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i.loopexit.unr-lcssa, %for.body.i.i.i.epil
  ...
  %15 = load ptr, ptr %arrayidx3.i.i.i.epil, align 8
  store ptr %15, ptr %arrayidx.i.i.i.epil, align 8
...
_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i: ; preds = %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i.loopexit.unr-lcssa, %for.body.i.i.i.epil, %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE8allocateEi.exit.i.i
  ...
  %16 = load ptr, ptr %m_data.i9.i.i, align 8
...
entry:
  ...
  %2 = load <2 x float>, ptr %pos1, align 4
  %3 = load <2 x float>, ptr %pos0, align 4
  ...
  store <2 x float> %7, ptr %linVel, align 4
  %ref.tmp.sroa.4.0..sroa_idx = getelementptr inbounds i8, ptr %linVel, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i, ptr %ref.tmp.sroa.4.0..sroa_idx, align 4
  ...
  %10 = load <2 x float>, ptr %arrayidx7.i.i18, align 4
...
_ZNK10btQuadWordneERKS_.exit:                     ; preds = %land.lhs.true9.i.i
  %15 = load float, ptr %orn0, align 4
  %16 = load float, ptr %orn1, align 4
...
if.then:                                          ; preds = %entry, %land.lhs.true9.i.i, %_ZNK10btQuadWordneERKS_.exit
  %17 = load <2 x float>, ptr %orn0, align 4
  %18 = load <2 x float>, ptr %orn1, align 4
...
_ZN15btTransformUtil32calculateDiffAxisAngleQuaternionERK12btQuaternionS2_R9btVector3Rf.exit: ; preds = %if.then, %if.else.i
  %mul.i.i.sink.i = phi float [ %mul.i.i.i, %if.else.i ], [ 1.000000e+00, %if.then ]
  ...
  %83 = insertelement <2 x float> %79, float %mul.i.i.sink.i, i64 0
  ...
  store <2 x float> %85, ptr %angVel, align 4
  %ref.tmp5.sroa.4.0..sroa_idx = getelementptr inbounds i8, ptr %angVel, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i36, ptr %ref.tmp5.sroa.4.0..sroa_idx, align 4
  br label %if.end
...
entry:
  ...
  %4 = load float, ptr %arrayidx7.i99, align 4
...
if.then:                                          ; preds = %entry
  ...
  %8 = load float, ptr %m_transformA, align 8
  %9 = load float, ptr %arrayidx3.i.i, align 8
  %10 = load float, ptr %arrayidx6.i.i, align 8
  %11 = load float, ptr %arrayidx.i.i.i, align 4
  %12 = load float, ptr %arrayidx.i26.i.i, align 4
  %13 = load float, ptr %arrayidx.i27.i.i, align 4
  %14 = load float, ptr %arrayidx.i28.i.i, align 8
  %15 = load float, ptr %arrayidx.i29.i.i, align 8
  %16 = load float, ptr %arrayidx.i30.i.i, align 8
  %m_origin.i = getelementptr inbounds %struct.btPerturbedContactResult, ptr %this, i64 0, i32 2, i32 1
  %17 = load float, ptr %m_origin.i, align 8
  ...
  %26 = load <4 x float>, ptr %m_unPerturbedTransform27, align 8
  ...
  %30 = load <4 x float>, ptr %arrayidx.i14.i.i.i, align 8
  ...
  %32 = load float, ptr %arrayidx.i.i.i49, align 8
  ...
  %33 = load float, ptr %arrayidx.i.i52.i.i, align 4
  ...
  %36 = load float, ptr %arrayidx.i.i72.i.i, align 4
  %mul7.i73.i.i = fmul float %11, %36
  %37 = tail call float @llvm.fmuladd.f32(float %8, float %35, float %mul7.i73.i.i)
  ...
  %38 = load float, ptr %arrayidx.i14.i75.i.i, align 8
  %39 = tail call float @llvm.fmuladd.f32(float %14, float %38, float %37)
  %mul7.i80.i.i = fmul float %12, %36
  %40 = tail call float @llvm.fmuladd.f32(float %9, float %35, float %mul7.i80.i.i)
  %41 = tail call float @llvm.fmuladd.f32(float %15, float %38, float %40)
  %mul7.i87.i.i = fmul float %13, %36
  %42 = tail call float @llvm.fmuladd.f32(float %10, float %35, float %mul7.i87.i.i)
  %43 = tail call float @llvm.fmuladd.f32(float %16, float %38, float %42)
  %m_origin.i.i52 = getelementptr inbounds %struct.btPerturbedContactResult, ptr %this, i64 0, i32 4, i32 1
  %mul8.i29.i.i = fmul float %23, %36
  %44 = tail call float @llvm.fmuladd.f32(float %35, float %21, float %mul8.i29.i.i)
  %45 = tail call float @llvm.fmuladd.f32(float %38, float %25, float %44)
  %arrayidx.i32.i.i = getelementptr inbounds %struct.btPerturbedContactResult, ptr %this, i64 0, i32 4, i32 1, i32 0, i64 2
  %46 = load float, ptr %arrayidx.i32.i.i, align 8
  %add17.i.i = fadd float %45, %46
  %mul8.i29.i = fmul float %add8.i109, %41
  %47 = tail call float @llvm.fmuladd.f32(float %39, float %add.i106, float %mul8.i29.i)
  %48 = tail call float @llvm.fmuladd.f32(float %43, float %add14.i112, float %47)
  %add17.i = fadd float %add17.i.i, %48
  ...
  %84 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %55, <2 x float> %83, <2 x float> %81)
  ...
  %88 = load <2 x float>, ptr %m_origin.i.i52, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i93, ptr %ref.tmp13.sroa.4.0.startPt.sroa_idx, align 8
  br label %if.end
...
if.else:                                          ; preds = %entry
  ...
  %108 = load float, ptr %m_transformB, align 8
  %109 = load float, ptr %arrayidx3.i.i118, align 8
  %110 = load float, ptr %arrayidx6.i.i119, align 8
  %111 = load float, ptr %arrayidx.i.i.i120, align 4
  %112 = load float, ptr %arrayidx.i26.i.i121, align 4
  %113 = load float, ptr %arrayidx.i27.i.i122, align 4
  %114 = load float, ptr %arrayidx.i28.i.i123, align 8
  %115 = load float, ptr %arrayidx.i29.i.i124, align 8
  %116 = load float, ptr %arrayidx.i30.i.i125, align 8
  %m_origin.i126 = getelementptr inbounds %struct.btPerturbedContactResult, ptr %this, i64 0, i32 3, i32 1
  %117 = load float, ptr %m_origin.i126, align 8
  ...
  %118 = load float, ptr %arrayidx3.i5.i128, align 4
  ...
  %119 = load float, ptr %arrayidx7.i.i130, align 8
  ...
  %126 = load <4 x float>, ptr %m_unPerturbedTransform27, align 8
  ...
  %128 = load <4 x float>, ptr %arrayidx.i.i.i.i152, align 4
  ...
  %130 = load <4 x float>, ptr %arrayidx.i14.i.i.i155, align 8
  ...
  %132 = load float, ptr %arrayidx.i.i.i164, align 8
  ...
  %133 = load float, ptr %arrayidx.i.i52.i.i165, align 4
  ...
  %136 = load float, ptr %arrayidx.i.i72.i.i171, align 4
  %mul7.i73.i.i172 = fmul float %111, %136
  %137 = tail call float @llvm.fmuladd.f32(float %108, float %135, float %mul7.i73.i.i172)
  ...
  %138 = load float, ptr %arrayidx.i14.i75.i.i173, align 8
  %139 = tail call float @llvm.fmuladd.f32(float %114, float %138, float %137)
  %mul7.i80.i.i174 = fmul float %112, %136
  %140 = tail call float @llvm.fmuladd.f32(float %109, float %135, float %mul7.i80.i.i174)
  %141 = tail call float @llvm.fmuladd.f32(float %115, float %138, float %140)
  %mul7.i87.i.i175 = fmul float %113, %136
  %142 = tail call float @llvm.fmuladd.f32(float %110, float %135, float %mul7.i87.i.i175)
  %143 = tail call float @llvm.fmuladd.f32(float %116, float %138, float %142)
  %m_origin.i.i180 = getelementptr inbounds %struct.btPerturbedContactResult, ptr %this, i64 0, i32 4, i32 1
  %mul8.i29.i.i185 = fmul float %123, %136
  %144 = tail call float @llvm.fmuladd.f32(float %135, float %121, float %mul8.i29.i.i185)
  %145 = tail call float @llvm.fmuladd.f32(float %138, float %125, float %144)
  %arrayidx.i32.i.i186 = getelementptr inbounds %struct.btPerturbedContactResult, ptr %this, i64 0, i32 4, i32 1, i32 0, i64 2
  %146 = load float, ptr %arrayidx.i32.i.i186, align 8
  %add17.i.i187 = fadd float %145, %146
  %147 = insertelement <2 x float> poison, float %111, i64 0
  %148 = shufflevector <2 x float> %147, <2 x float> poison, <2 x i32> zeroinitializer
  %149 = insertelement <2 x float> %129, float %133, i64 1
  %150 = fmul <2 x float> %148, %149
  %151 = insertelement <2 x float> poison, float %108, i64 0
  %152 = shufflevector <2 x float> %151, <2 x float> poison, <2 x i32> zeroinitializer
  %153 = insertelement <2 x float> %127, float %132, i64 1
  ...
  %156 = shufflevector <2 x float> %155, <2 x float> poison, <2 x i32> zeroinitializer
  %157 = insertelement <2 x float> %131, float %134, i64 1
  ...
  %164 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %163, <2 x float> %153, <2 x float> %161)
  ...
  %173 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %172, <2 x float> %153, <2 x float> %170)
  ...
  %182 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %153, <2 x float> %181, <2 x float> %179)
  ...
  %186 = load <2 x float>, ptr %m_origin.i.i180, align 8
  ...
  %mul8.i29.i219 = fmul float %6, %141
  %198 = tail call float @llvm.fmuladd.f32(float %139, float %5, float %mul8.i29.i219)
  %199 = tail call float @llvm.fmuladd.f32(float %143, float %7, float %198)
  ...
  store <2 x float> %197, ptr %startPt, align 8
  %ref.tmp25.sroa.4.0.startPt.sroa_idx = getelementptr inbounds i8, ptr %startPt, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i225, ptr %ref.tmp25.sroa.4.0.startPt.sroa_idx, align 8
