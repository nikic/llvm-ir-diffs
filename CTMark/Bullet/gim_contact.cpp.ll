; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/gim_contact.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/gim_contact.cpp"
...
_ZN9gim_arrayI11GIM_CONTACTE5clearEv.exit:        ; preds = %entry, %_ZN9gim_arrayI11GIM_CONTACTE11clear_rangeEj.exit.i
  ...
  %1 = load i32, ptr %m_size.i135, align 8
...
_ZN9gim_arrayI11GIM_CONTACTE9push_backERKS0_.exit: ; preds = %entry._ZN9gim_arrayI11GIM_CONTACTE12growingCheckEv.exit_crit_edge.i, %if.end12.i.i.i
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(48) %arrayidx.i138, ptr noundef nonnull align 4 dereferenceable(48) %2, i64 48, i1 false)
...
_ZN9gim_arrayI15GIM_RSORT_TOKENEC2Ej.exit:        ; preds = %_ZN9gim_arrayI11GIM_CONTACTE5clearEv.exit
  ...
  %.pre300 = load i32, ptr %m_size.i135, align 8
  %cmp.not.i.i147 = icmp ult i32 %1, %.pre300
  br i1 %cmp.not.i.i147, label %if.else.i.i.i158, label %_ZN9gim_arrayI15GIM_RSORT_TOKENE6resizeEjb.exit

if.else.i.i.i158:                                 ; preds = %_ZN9gim_arrayI15GIM_RSORT_TOKENEC2Ej.exit
  %conv8.i.i.i159 = zext i32 %.pre300 to i64
  %mul9.i.i.i160 = shl nuw nsw i64 %conv8.i.i.i159, 3
  %call10.i.i.i161163 = invoke noundef ptr @_Z9gim_allocm(i64 noundef %mul9.i.i.i160)
          to label %if.else.i.i.i158._ZN9gim_arrayI15GIM_RSORT_TOKENE6resizeEjb.exit_crit_edge unwind label %ehcleanup97.thread

if.else.i.i.i158._ZN9gim_arrayI15GIM_RSORT_TOKENE6resizeEjb.exit_crit_edge: ; preds = %if.else.i.i.i158
  %.pre301 = load i32, ptr %m_size.i135, align 8
  br label %_ZN9gim_arrayI15GIM_RSORT_TOKENE6resizeEjb.exit

_ZN9gim_arrayI15GIM_RSORT_TOKENE6resizeEjb.exit:  ; preds = %if.else.i.i.i158._ZN9gim_arrayI15GIM_RSORT_TOKENE6resizeEjb.exit_crit_edge, %_ZN9gim_arrayI15GIM_RSORT_TOKENEC2Ej.exit
  %7 = phi i32 [ %.pre300, %_ZN9gim_arrayI15GIM_RSORT_TOKENEC2Ej.exit ], [ %.pre301, %if.else.i.i.i158._ZN9gim_arrayI15GIM_RSORT_TOKENE6resizeEjb.exit_crit_edge ]
  %keycontacts.sroa.0.3 = phi ptr [ %call10.i.i.i142, %_ZN9gim_arrayI15GIM_RSORT_TOKENEC2Ej.exit ], [ %call10.i.i.i161163, %if.else.i.i.i158._ZN9gim_arrayI15GIM_RSORT_TOKENE6resizeEjb.exit_crit_edge ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> %interleaved.vec, ptr %38, align 4
...
invoke.cont12:                                    ; preds = %invoke.cont12.preheader, %invoke.cont12
  ...
  %40 = load float, ptr %arrayidx.i165, align 4
  ...
  %43 = load float, ptr %arrayidx9.i, align 4
  ...
  store i32 %add15.i, ptr %arrayidx.i166, align 4
  %m_value = getelementptr inbounds %struct.GIM_RSORT_TOKEN, ptr %keycontacts.sroa.0.3, i64 %indvars.iv, i32 1
  %45 = trunc i64 %indvars.iv to i32
  store i32 %45, ptr %m_value, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %invoke.cont12

ehcleanup97.thread:                               ; preds = %if.else.i.i.i158
  %46 = landingpad { ptr, i32 }
          cleanup
  br label %_ZN9gim_arrayI15GIM_RSORT_TOKENE5clearEv.exit.i.i256
...
invoke.cont24:                                    ; preds = %for.end
  ...
  %52 = load i32, ptr %m_allocated_size.i.i170, align 4
  %53 = load i32, ptr %m_size.i, align 8
  %cmp.not.i.i172 = icmp ugt i32 %52, %53
  br i1 %cmp.not.i.i172, label %entry._ZN9gim_arrayI11GIM_CONTACTE12growingCheckEv.exit_crit_edge.i197, label %if.then.i.i173

entry._ZN9gim_arrayI11GIM_CONTACTE12growingCheckEv.exit_crit_edge.i197: ; preds = %invoke.cont24
  %.pre.i198 = load ptr, ptr %this, align 8
  br label %invoke.cont38

if.then.i.i173:                                   ; preds = %invoke.cont24
  store i32 %52, ptr %m_size.i, align 8
  %add.i.i174 = shl i32 %53, 1
  %mul.i.i175 = add i32 %add.i.i174, 4
  %cmp.i.i.i176 = icmp eq i32 %mul.i.i175, 0
  br i1 %cmp.i.i.i176, label %if.then.i.i.i194, label %if.end.i.i.i177

if.then.i.i.i194:                                 ; preds = %if.then.i.i173
  store i32 0, ptr %m_allocated_size.i.i170, align 4
  %54 = load ptr, ptr %this, align 8
  %cmp.i.i.i.i195 = icmp eq ptr %54, null
  br i1 %cmp.i.i.i.i195, label %invoke.cont38, label %if.end.i.i.i.i196

if.end.i.i.i.i196:                                ; preds = %if.then.i.i.i194
  invoke void @_Z8gim_freePv(ptr noundef nonnull %54)
          to label %.noexc unwind label %lpad31

.noexc:                                           ; preds = %if.end.i.i.i.i196
  store ptr null, ptr %this, align 8
  br label %invoke.cont38

if.end.i.i.i177:                                  ; preds = %if.then.i.i173
  %cmp2.not.i.i.i178 = icmp eq i32 %52, 0
  br i1 %cmp2.not.i.i.i178, label %if.else.i.i.i190, label %if.then3.i.i.i179

if.then3.i.i.i179:                                ; preds = %if.end.i.i.i177
  %55 = load ptr, ptr %this, align 8
  %conv.i.i.i180 = zext i32 %52 to i64
  %mul.i.i.i181 = mul nuw nsw i64 %conv.i.i.i180, 48
  %conv5.i.i.i182 = zext i32 %mul.i.i175 to i64
  %mul6.i.i.i183 = mul nuw nsw i64 %conv5.i.i.i182, 48
  %call.i.i.i184199 = invoke noundef ptr @_Z11gim_reallocPvmm(ptr noundef %55, i64 noundef %mul.i.i.i181, i64 noundef %mul6.i.i.i183)
          to label %if.end12.i.i.i185 unwind label %lpad31

if.else.i.i.i190:                                 ; preds = %if.end.i.i.i177
  %conv8.i.i.i191 = zext i32 %mul.i.i175 to i64
  %mul9.i.i.i192 = mul nuw nsw i64 %conv8.i.i.i191, 48
  %call10.i.i.i193200 = invoke noundef ptr @_Z9gim_allocm(i64 noundef %mul9.i.i.i192)
          to label %if.end12.i.i.i185 unwind label %lpad31

if.end12.i.i.i185:                                ; preds = %if.else.i.i.i190, %if.then3.i.i.i179
  %storemerge.i.i.i186 = phi ptr [ %call.i.i.i184199, %if.then3.i.i.i179 ], [ %call10.i.i.i193200, %if.else.i.i.i190 ]
  store ptr %storemerge.i.i.i186, ptr %this, align 8
  store i32 %mul.i.i175, ptr %m_allocated_size.i.i170, align 4
  br label %invoke.cont38

invoke.cont38:                                    ; preds = %if.end12.i.i.i185, %.noexc, %if.then.i.i.i194, %entry._ZN9gim_arrayI11GIM_CONTACTE12growingCheckEv.exit_crit_edge.i197
  %56 = phi ptr [ %.pre.i198, %entry._ZN9gim_arrayI11GIM_CONTACTE12growingCheckEv.exit_crit_edge.i197 ], [ null, %if.then.i.i.i194 ], [ null, %.noexc ], [ %storemerge.i.i.i186, %if.end12.i.i.i185 ]
  %57 = load i32, ptr %m_size.i, align 8
  %idxprom.i187 = zext i32 %57 to i64
  %arrayidx.i188 = getelementptr inbounds %class.GIM_CONTACT, ptr %56, i64 %idxprom.i187
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(48) %arrayidx.i188, ptr noundef nonnull align 4 dereferenceable(48) %arrayidx.i169, i64 48, i1 false)
  %58 = load i32, ptr %m_size.i, align 8
  %inc.i189 = add i32 %58, 1
  store i32 %inc.i189, ptr %m_size.i, align 8
...
if.then60:                                        ; preds = %for.body46
  ...
  %63 = load float, ptr %m_depth, align 4
  %sub = fadd float %63, 0xBEE4F8B580000000
  %m_depth61 = getelementptr inbounds %class.GIM_CONTACT, ptr %62, i64 %conv56, i32 2
  %64 = load float, ptr %m_depth61, align 4
  %cmp62 = fcmp ogt float %sub, %64
  br i1 %cmp62, label %if.then63, label %if.else

if.then63:                                        ; preds = %if.then60
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(48) %pcontact.0293, ptr noundef nonnull align 4 dereferenceable(48) %arrayidx.i209, i64 48, i1 false)
  br label %if.end88

lpad31:                                           ; preds = %if.else.i.i.i190, %if.then3.i.i.i179, %if.end.i.i.i.i196
  %65 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup92

lpad52:                                           ; preds = %if.else.i.i.i234, %if.then3.i.i.i223, %if.end.i.i.i.i240
...
for.body.preheader.i:                             ; preds = %if.else79
  ...
  %vec_sum.sroa.11.0.copyload.i = load float, ptr %vec_sum.sroa.11.0.m_normal.sroa_idx.i, align 4
...
if.else.i:                                        ; preds = %if.end.i
  ...
  %shr.i = lshr i32 %91, 1
  %sub.i213 = sub nsw i32 1597463007, %shr.i
  %92 = bitcast i32 %sub.i213 to float
...
if.end9.i:                                        ; preds = %if.else.i, %if.end.i
  ...
  store <2 x float> %97, ptr %m_normal.i, align 4
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i, ptr %vec_sum.sroa.11.0.m_normal.sroa_idx.i, align 4
  br label %if.end84
...
if.end84:                                         ; preds = %if.end9.i, %for.cond.cleanup.i, %if.else79
  ...
  %98 = load i32, ptr %m_allocated_size.i.i170, align 4
  %99 = load i32, ptr %m_size.i, align 8
  %cmp.not.i.i216 = icmp ugt i32 %98, %99
  br i1 %cmp.not.i.i216, label %entry._ZN9gim_arrayI11GIM_CONTACTE12growingCheckEv.exit_crit_edge.i241, label %if.then.i.i217

entry._ZN9gim_arrayI11GIM_CONTACTE12growingCheckEv.exit_crit_edge.i241: ; preds = %if.end84
  %.pre.i242 = load ptr, ptr %this, align 8
  br label %invoke.cont85

if.then.i.i217:                                   ; preds = %if.end84
  store i32 %98, ptr %m_size.i, align 8
  %add.i.i218 = shl i32 %99, 1
  %mul.i.i219 = add i32 %add.i.i218, 4
  %cmp.i.i.i220 = icmp eq i32 %mul.i.i219, 0
  br i1 %cmp.i.i.i220, label %if.then.i.i.i238, label %if.end.i.i.i221

if.then.i.i.i238:                                 ; preds = %if.then.i.i217
  store i32 0, ptr %m_allocated_size.i.i170, align 4
  %100 = load ptr, ptr %this, align 8
  %cmp.i.i.i.i239 = icmp eq ptr %100, null
  br i1 %cmp.i.i.i.i239, label %invoke.cont85, label %if.end.i.i.i.i240

if.end.i.i.i.i240:                                ; preds = %if.then.i.i.i238
  invoke void @_Z8gim_freePv(ptr noundef nonnull %100)
          to label %.noexc243 unwind label %lpad52

.noexc243:                                        ; preds = %if.end.i.i.i.i240
  store ptr null, ptr %this, align 8
  br label %invoke.cont85

if.end.i.i.i221:                                  ; preds = %if.then.i.i217
  %cmp2.not.i.i.i222 = icmp eq i32 %98, 0
  br i1 %cmp2.not.i.i.i222, label %if.else.i.i.i234, label %if.then3.i.i.i223

if.then3.i.i.i223:                                ; preds = %if.end.i.i.i221
  %101 = load ptr, ptr %this, align 8
  %conv.i.i.i224 = zext i32 %98 to i64
  %mul.i.i.i225 = mul nuw nsw i64 %conv.i.i.i224, 48
  %conv5.i.i.i226 = zext i32 %mul.i.i219 to i64
  %mul6.i.i.i227 = mul nuw nsw i64 %conv5.i.i.i226, 48
  %call.i.i.i228244 = invoke noundef ptr @_Z11gim_reallocPvmm(ptr noundef %101, i64 noundef %mul.i.i.i225, i64 noundef %mul6.i.i.i227)
          to label %if.end12.i.i.i229 unwind label %lpad52

if.else.i.i.i234:                                 ; preds = %if.end.i.i.i221
  %conv8.i.i.i235 = zext i32 %mul.i.i219 to i64
  %mul9.i.i.i236 = mul nuw nsw i64 %conv8.i.i.i235, 48
  %call10.i.i.i237245 = invoke noundef ptr @_Z9gim_allocm(i64 noundef %mul9.i.i.i236)
          to label %if.end12.i.i.i229 unwind label %lpad52

if.end12.i.i.i229:                                ; preds = %if.else.i.i.i234, %if.then3.i.i.i223
  %storemerge.i.i.i230 = phi ptr [ %call.i.i.i228244, %if.then3.i.i.i223 ], [ %call10.i.i.i237245, %if.else.i.i.i234 ]
  store ptr %storemerge.i.i.i230, ptr %this, align 8
  store i32 %mul.i.i219, ptr %m_allocated_size.i.i170, align 4
  br label %invoke.cont85

invoke.cont85:                                    ; preds = %if.end12.i.i.i229, %.noexc243, %if.then.i.i.i238, %entry._ZN9gim_arrayI11GIM_CONTACTE12growingCheckEv.exit_crit_edge.i241
  %102 = phi ptr [ %.pre.i242, %entry._ZN9gim_arrayI11GIM_CONTACTE12growingCheckEv.exit_crit_edge.i241 ], [ null, %if.then.i.i.i238 ], [ null, %.noexc243 ], [ %storemerge.i.i.i230, %if.end12.i.i.i229 ]
  %103 = load i32, ptr %m_size.i, align 8
  %idxprom.i231 = zext i32 %103 to i64
  %arrayidx.i232 = getelementptr inbounds %class.GIM_CONTACT, ptr %102, i64 %idxprom.i231
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(48) %arrayidx.i232, ptr noundef nonnull align 4 dereferenceable(48) %arrayidx.i209, i64 48, i1 false)
  %104 = load i32, ptr %m_size.i, align 8
  %inc.i233 = add i32 %104, 1
  store i32 %inc.i233, ptr %m_size.i, align 8
...
_ZN9gim_arrayI15GIM_RSORT_TOKENE5clearEv.exit.i.i256: ; preds = %ehcleanup92, %lpad6, %ehcleanup97.thread
  %.pn132.pn285 = phi { ptr, i32 } [ %46, %ehcleanup97.thread ], [ %47, %lpad6 ], [ %.pn, %ehcleanup92 ]
  ...
  %cmp.i2.i.i258 = icmp eq ptr %keycontacts.sroa.0.4284, null
  br i1 %cmp.i2.i.i258, label %invoke.cont98, label %if.end.i.i.i259

if.end.i.i.i259:                                  ; preds = %_ZN9gim_arrayI15GIM_RSORT_TOKENE5clearEv.exit.i.i256
  invoke void @_Z8gim_freePv(ptr noundef nonnull %keycontacts.sroa.0.4284)
          to label %invoke.cont98 unwind label %terminate.lpad

invoke.cont98:                                    ; preds = %_ZN9gim_arrayI15GIM_RSORT_TOKENE5clearEv.exit.i.i256, %if.end.i.i.i259
  resume { ptr, i32 } %.pn132.pn285
...
entry:
  ...
  %cmp.not58 = icmp ult i32 %element_count, 2
  br i1 %cmp.not58, label %while.end, label %for.body

while.cond.preheader:                             ; preds = %_Z13gim_down_heapI15GIM_RSORT_TOKEN26GIM_RSORT_TOKEN_COMPARATOREvPT_jjT0_.exit
  %cmp160 = icmp ugt i32 %element_count, 1
...
for.body:                                         ; preds = %entry, %_Z13gim_down_heapI15GIM_RSORT_TOKEN26GIM_RSORT_TOKEN_COMPARATOREvPT_jjT0_.exit
  %k.059 = phi i32 [ %sub.i, %_Z13gim_down_heapI15GIM_RSORT_TOKEN26GIM_RSORT_TOKEN_COMPARATOREvPT_jjT0_.exit ], [ %div13, %entry ]
  %sub.i = add nsw i32 %k.059, -1
  ...
  %cmp.not47.i = icmp ult i32 %div13, %k.059
...
while.body.i:                                     ; preds = %for.body, %cleanup.i
  %k.addr.048.i = phi i32 [ %child.0.i, %cleanup.i ], [ %k.059, %for.body ]
...
land.lhs.true.i:                                  ; preds = %while.body.i
  ...
  %sub.i.i = sub i32 %3, %4
  %5 = lshr i32 %sub.i.i, 31
  %spec.select.i = or i32 %5, %mul.i
  br label %if.end.i
...
cleanup.i:                                        ; preds = %if.end.i
  ...
  %7 = load i64, ptr %arrayidx10.i, align 4
  store i64 %7, ptr %arrayidx19.i, align 4
...
while.body:                                       ; preds = %while.body.preheader, %_Z13gim_down_heapI15GIM_RSORT_TOKEN26GIM_RSORT_TOKEN_COMPARATOREvPT_jjT0_.exit53
  %indvars.iv = phi i64 [ %0, %while.body.preheader ], [ %indvars.iv.next, %_Z13gim_down_heapI15GIM_RSORT_TOKEN26GIM_RSORT_TOKEN_COMPARATOREvPT_jjT0_.exit53 ]
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  %indvars = trunc i64 %indvars.iv.next to i32
  %conv = and i64 %indvars.iv.next, 4294967295
  %8 = load i64, ptr %pArr, align 4
  %arrayidx1.i = getelementptr inbounds %struct.GIM_RSORT_TOKEN, ptr %pArr, i64 %conv
  %9 = load i64, ptr %arrayidx1.i, align 4
  store i64 %9, ptr %pArr, align 4
  store i64 %8, ptr %arrayidx1.i, align 4
  %10 = load i64, ptr %pArr, align 4
  %11 = trunc i64 %10 to i32
  %div41.i16 = lshr i32 %indvars, 1
  %cmp.not47.i17 = icmp eq i64 %indvars.iv, 2
  br i1 %cmp.not47.i17, label %while.end, label %while.body.i18

while.body.i18:                                   ; preds = %while.body, %cleanup.i40
  %k.addr.048.i19 = phi i32 [ %child.0.i23, %cleanup.i40 ], [ 1, %while.body ]
  %mul.i20 = shl nuw i32 %k.addr.048.i19, 1
  %cmp1.i21 = icmp slt i32 %mul.i20, %indvars
  br i1 %cmp1.i21, label %land.lhs.true.i45, label %if.end.i22

land.lhs.true.i45:                                ; preds = %while.body.i18
  %sub2.i46 = add nsw i32 %mul.i20, -1
  %idxprom3.i47 = sext i32 %sub2.i46 to i64
  %arrayidx4.i48 = getelementptr inbounds %struct.GIM_RSORT_TOKEN, ptr %pArr, i64 %idxprom3.i47
  %idxprom5.i49 = sext i32 %mul.i20 to i64
  %arrayidx6.i50 = getelementptr inbounds %struct.GIM_RSORT_TOKEN, ptr %pArr, i64 %idxprom5.i49
  %12 = load i32, ptr %arrayidx4.i48, align 4
  %13 = load i32, ptr %arrayidx6.i50, align 4
  %sub.i.i51 = sub i32 %12, %13
  %14 = lshr i32 %sub.i.i51, 31
  %spec.select.i52 = or i32 %14, %mul.i20
  br label %if.end.i22

if.end.i22:                                       ; preds = %land.lhs.true.i45, %while.body.i18
  %child.0.i23 = phi i32 [ %mul.i20, %while.body.i18 ], [ %spec.select.i52, %land.lhs.true.i45 ]
  %sub8.i24 = add i32 %child.0.i23, -1
  %idxprom9.i25 = sext i32 %sub8.i24 to i64
  %arrayidx10.i26 = getelementptr inbounds %struct.GIM_RSORT_TOKEN, ptr %pArr, i64 %idxprom9.i25
  %15 = load i32, ptr %arrayidx10.i26, align 4
  %sub.i42.i27 = sub i32 %11, %15
  %cmp12.i28 = icmp slt i32 %sub.i42.i27, 0
  %sub17.i41 = add i32 %k.addr.048.i19, -1
  br i1 %cmp12.i28, label %cleanup.i40, label %_Z13gim_down_heapI15GIM_RSORT_TOKEN26GIM_RSORT_TOKEN_COMPARATOREvPT_jjT0_.exit53

cleanup.i40:                                      ; preds = %if.end.i22
  %idxprom18.i42 = zext i32 %sub17.i41 to i64
  %arrayidx19.i43 = getelementptr inbounds %struct.GIM_RSORT_TOKEN, ptr %pArr, i64 %idxprom18.i42
  %16 = load i64, ptr %arrayidx10.i26, align 4
  store i64 %16, ptr %arrayidx19.i43, align 4
  %cmp.not.i44 = icmp ugt i32 %child.0.i23, %div41.i16
  br i1 %cmp.not.i44, label %_Z13gim_down_heapI15GIM_RSORT_TOKEN26GIM_RSORT_TOKEN_COMPARATOREvPT_jjT0_.exit53, label %while.body.i18

_Z13gim_down_heapI15GIM_RSORT_TOKEN26GIM_RSORT_TOKEN_COMPARATOREvPT_jjT0_.exit53: ; preds = %cleanup.i40, %if.end.i22
  %.pre.pre-phi.i32 = phi i32 [ %sub17.i41, %if.end.i22 ], [ %sub8.i24, %cleanup.i40 ]
  %.pre50.i33 = zext i32 %.pre.pre-phi.i32 to i64
  %arrayidx23.i35 = getelementptr inbounds %struct.GIM_RSORT_TOKEN, ptr %pArr, i64 %.pre50.i33
  store i64 %10, ptr %arrayidx23.i35, align 4
  %cmp1 = icmp ugt i32 %indvars, 1
  br i1 %cmp1, label %while.body, label %while.end

while.end:                                        ; preds = %_Z13gim_down_heapI15GIM_RSORT_TOKEN26GIM_RSORT_TOKEN_COMPARATOREvPT_jjT0_.exit53, %while.body, %entry, %while.cond.preheader
  ret void
}
...
_ZN9gim_arrayI11GIM_CONTACTE5clearEv.exit:        ; preds = %entry, %_ZN9gim_arrayI11GIM_CONTACTE11clear_rangeEj.exit.i
  ...
  %1 = load i32, ptr %m_size.i39, align 8
  %cmp = icmp eq i32 %1, 1
...
_ZN9gim_arrayI11GIM_CONTACTE9push_backERKS0_.exit: ; preds = %entry._ZN9gim_arrayI11GIM_CONTACTE12growingCheckEv.exit_crit_edge.i, %if.end12.i.i.i
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(48) %arrayidx.i42, ptr noundef nonnull align 4 dereferenceable(48) %2, i64 48, i1 false)
  %6 = load i32, ptr %m_size.i, align 8
  %inc.i = add i32 %6, 1
  store i32 %inc.i, ptr %m_size.i, align 8
  br label %return
