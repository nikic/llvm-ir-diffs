...
entry._ZN9gim_arrayI11GIM_CONTACTE12growingCheckEv.exit_crit_edge.i197: ; preds = %invoke.cont24
  %.pre.i198 = load ptr, ptr %this, align 8, !tbaa !11
...
if.end12.i.i.i185:                                ; preds = %if.else.i.i.i190, %if.then3.i.i.i179
  ...
  store ptr %storemerge.i.i.i186, ptr %this, align 8, !tbaa !11
  store i32 %mul.i.i175, ptr %m_allocated_size.i.i170, align 4, !tbaa !12
  br label %invoke.cont38
...
invoke.cont38:                                    ; preds = %if.end12.i.i.i185, %.noexc, %if.then.i.i.i194, %entry._ZN9gim_arrayI11GIM_CONTACTE12growingCheckEv.exit_crit_edge.i197
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(48) %arrayidx.i188, ptr noundef nonnull align 4 dereferenceable(48) %arrayidx.i169, i64 48, i1 false), !tbaa.struct !13
  %58 = load i32, ptr %m_size.i, align 8, !tbaa !5
  %inc.i189 = add i32 %58, 1
  store i32 %inc.i189, ptr %m_size.i, align 8, !tbaa !5
...
entry._ZN9gim_arrayI11GIM_CONTACTE12growingCheckEv.exit_crit_edge.i241: ; preds = %if.end84
  %.pre.i242 = load ptr, ptr %this, align 8, !tbaa !11
...
if.end12.i.i.i229:                                ; preds = %if.else.i.i.i234, %if.then3.i.i.i223
  ...
  store ptr %storemerge.i.i.i230, ptr %this, align 8, !tbaa !11
  store i32 %mul.i.i219, ptr %m_allocated_size.i.i170, align 4, !tbaa !12
  br label %invoke.cont85
...
invoke.cont85:                                    ; preds = %if.end12.i.i.i229, %.noexc243, %if.then.i.i.i238, %entry._ZN9gim_arrayI11GIM_CONTACTE12growingCheckEv.exit_crit_edge.i241
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(48) %arrayidx.i232, ptr noundef nonnull align 4 dereferenceable(48) %arrayidx.i209, i64 48, i1 false), !tbaa.struct !13
  %104 = load i32, ptr %m_size.i, align 8, !tbaa !5
  %inc.i233 = add i32 %104, 1
  store i32 %inc.i233, ptr %m_size.i, align 8, !tbaa !5
...
if.end.i:                                         ; preds = %land.lhs.true.i, %while.body.i
  ...
  %6 = load i32, ptr %arrayidx10.i, align 4, !tbaa !21
...
land.lhs.true.i45:                                ; preds = %while.body.i18
  ...
  %12 = load i32, ptr %arrayidx4.i48, align 4, !tbaa !21
  %13 = load i32, ptr %arrayidx6.i50, align 4, !tbaa !21
...
if.end.i22:                                       ; preds = %land.lhs.true.i45, %while.body.i18
  ...
  %15 = load i32, ptr %arrayidx10.i26, align 4, !tbaa !21
