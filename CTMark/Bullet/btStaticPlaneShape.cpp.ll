; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btStaticPlaneShape.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btStaticPlaneShape.cpp"
...
invoke.cont3:
  ...
  store ptr getelementptr inbounds ({ [15 x ptr] }, ptr @_ZTV18btStaticPlaneShape, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  ...
  %1 = load <2 x float>, ptr %planeNormal, align 4
...
_Z13btPlaneSpace1RK9btVector3RS_S2_.exit:         ; preds = %if.then.i, %if.else.i
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i189, ptr %ref.tmp21.sroa.4.0.arrayidx.sroa_idx, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i233, ptr %ref.tmp33.sroa.4.0.arrayidx45.sroa_idx, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i277, ptr %ref.tmp46.sroa.4.0.arrayidx58.sroa_idx, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i277, ptr %ref.tmp21.sroa.4.0.arrayidx.sroa_idx, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i365, ptr %ref.tmp33.sroa.4.0.arrayidx45.sroa_idx, align 8
  store <2 x float> %53, ptr %arrayidx58, align 16
  store <2 x float> %retval.sroa.3.12.vec.insert.i189, ptr %ref.tmp46.sroa.4.0.arrayidx58.sroa_idx, align 8
...
attributes #8 = { mustprogress nofree nosync nounwind willreturn memory(argmem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
