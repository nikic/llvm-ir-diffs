...
if.end:                                           ; preds = %entry
  ...
  %3 = load float, ptr %m_implicitShapeDimensions.i, align 4, !tbaa !29
  %m_localScaling.i = getelementptr inbounds %class.btConvexInternalShape, ptr %2, i64 0, i32 1
  %4 = load float, ptr %m_localScaling.i, align 4, !tbaa !29
...
if.end101:                                        ; preds = %if.then74
  ...
  %117 = load float, ptr %arrayidx.i29.i.i, align 4, !tbaa !29
  ...
  %141 = load float, ptr %m_worldTransform.i, align 4, !tbaa !29
  %142 = load float, ptr %v3PointOnSphere, align 4, !tbaa !29
  %143 = load float, ptr %arrayidx.i.i.i, align 4, !tbaa !29
  %144 = load float, ptr %arrayidx5.i287, align 4, !tbaa !29
  %145 = load float, ptr %arrayidx.i28.i.i, align 4, !tbaa !29
  %146 = load float, ptr %ref.tmp89.sroa.4.0..sroa_idx, align 4, !tbaa !29
  %147 = load float, ptr %arrayidx3.i.i, align 4, !tbaa !29
  %148 = load float, ptr %arrayidx.i26.i.i, align 4, !tbaa !29
  %149 = load float, ptr %arrayidx.i29.i.i, align 4, !tbaa !29
...
entry:
  ...
  %bounds.sroa.9.0.copyload = load float, ptr %bounds.sroa.9.0.aabbMin.sroa_idx, align 4, !tbaa.struct !33
  %bounds.sroa.19.16.aabbMax.sroa_idx = getelementptr inbounds i8, ptr %aabbMax, i64 8
  %bounds.sroa.19.16.copyload = load float, ptr %bounds.sroa.19.16.aabbMax.sroa_idx, align 4, !tbaa.struct !33
  %m_worldTransform.i = getelementptr inbounds %class.btCollisionObject, ptr %boxObj, i64 0, i32 1
  %m_origin.i = getelementptr inbounds %class.btCollisionObject, ptr %boxObj, i64 0, i32 1, i32 1
...
for.inc.5:                                        ; preds = %if.end.5, %if.end.5.for.inc.5_crit_edge
  ...
  %62 = load float, ptr %m_worldTransform.i, align 4, !tbaa !29
  %63 = load float, ptr %pointOnBox, align 4, !tbaa !29
  %64 = load float, ptr %arrayidx.i.i.i, align 4, !tbaa !29
  %65 = load float, ptr %arrayidx5.i185, align 4, !tbaa !29
  %66 = load float, ptr %arrayidx.i28.i.i, align 4, !tbaa !29
  %67 = load float, ptr %ref.tmp59.sroa.4.0..sroa_idx, align 4, !tbaa !29
  %68 = load float, ptr %arrayidx3.i.i, align 4, !tbaa !29
  %69 = load float, ptr %arrayidx.i26.i.i, align 4, !tbaa !29
  %70 = load float, ptr %arrayidx.i29.i.i, align 4, !tbaa !29
  ...
  %94 = load float, ptr %m_worldTransform.i, align 4, !tbaa !29
  %95 = load float, ptr %v3PointOnSphere, align 4, !tbaa !29
  %96 = load float, ptr %arrayidx.i.i.i, align 4, !tbaa !29
  %arrayidx7.i.i204 = getelementptr inbounds [4 x float], ptr %v3PointOnSphere, i64 0, i64 1
  %97 = load float, ptr %arrayidx7.i.i204, align 4, !tbaa !29
  %98 = load float, ptr %arrayidx.i28.i.i, align 4, !tbaa !29
  %99 = load float, ptr %ref.tmp70.sroa.4.0..sroa_idx, align 4, !tbaa !29
  %100 = load float, ptr %arrayidx3.i.i, align 4, !tbaa !29
  %101 = load float, ptr %arrayidx.i26.i.i, align 4, !tbaa !29
  %102 = load float, ptr %arrayidx.i29.i.i, align 4, !tbaa !29
