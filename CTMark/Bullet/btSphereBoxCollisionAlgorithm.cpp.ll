; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSphereBoxCollisionAlgorithm.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSphereBoxCollisionAlgorithm.cpp"
...
if.end:                                           ; preds = %entry
  ...
  %3 = load float, ptr %m_implicitShapeDimensions.i, align 4
  %m_localScaling.i = getelementptr inbounds %class.btConvexInternalShape, ptr %2, i64 0, i32 1
  %4 = load float, ptr %m_localScaling.i, align 4
...
if.then14:                                        ; preds = %if.end
  ...
  %8 = load <2 x float>, ptr %pOnBox, align 8
  %9 = load <2 x float>, ptr %pOnSphere, align 8
  ...
  store <2 x float> %17, ptr %normalOnSurfaceB15, align 8
  %ref.tmp.sroa.8.0.normalOnSurfaceB15.sroa_idx = getelementptr inbounds i8, ptr %normalOnSurfaceB15, i64 8
  store <2 x float> %ref.tmp.sroa.8.8.vec.insert, ptr %ref.tmp.sroa.8.0.normalOnSurfaceB15.sroa_idx, align 8
...
entry:
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i, ptr %ref.tmp.sroa.4.0.arrayidx.sroa_idx, align 8
  %arrayidx5 = getelementptr inbounds [2 x %class.btVector3], ptr %bounds, i64 0, i64 1
  %2 = load <2 x float>, ptr %m_implicitShapeDimensions.i, align 4
  %3 = fneg <2 x float> %2
  store <2 x float> %3, ptr %bounds, align 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %arrayidx5, ptr noundef nonnull align 4 dereferenceable(16) %m_implicitShapeDimensions.i, i64 16, i1 false)
  %vtable = load ptr, ptr %0, align 8
  ...
  store <2 x float> %7, ptr %bounds, align 16
  %add13.i = fsub float %call6, %1
  store float %add13.i, ptr %ref.tmp.sroa.4.0.arrayidx.sroa_idx, align 8
  %8 = load <2 x float>, ptr %arrayidx5, align 16
  %9 = fsub <2 x float> %8, %6
  store <2 x float> %9, ptr %arrayidx5, align 16
  %arrayidx12.i179 = getelementptr inbounds [2 x %class.btVector3], ptr %bounds, i64 0, i64 1, i32 0, i64 2
  %10 = load float, ptr %arrayidx12.i179, align 8
  %sub13.i = fsub float %10, %call6
  store float %sub13.i, ptr %arrayidx12.i179, align 8
  ...
  %11 = load float, ptr %sphereCenter, align 4
  ...
  %15 = load float, ptr %arrayidx11.i.i, align 4
  ...
  %17 = load float, ptr %arrayidx.i28.i.i, align 4
  %18 = load float, ptr %arrayidx.i29.i.i, align 4
  %19 = load float, ptr %arrayidx.i30.i.i, align 4
  %20 = load <2 x float>, ptr %m_worldTransform.i, align 4
  %21 = load <2 x float>, ptr %arrayidx3.i.i, align 4
  %22 = load <2 x float>, ptr %arrayidx6.i.i, align 4
...
if.then74:                                        ; preds = %if.end.5.thread, %if.end.5
  %v3P.sroa.12.1.5460 = phi <2 x float> [ %retval.sroa.3.12.vec.insert.i228.5, %if.end.5.thread ], [ %v3P.sroa.12.1.4, %if.end.5 ]
  %v3P.sroa.0.1.5459 = phi <2 x float> [ %88, %if.end.5.thread ], [ %80, %if.end.5 ]
  %v3P.sroa.12.8.vec.extract386 = extractelement <2 x float> %v3P.sroa.12.1.5460, i64 0
  %sub14.i237 = fsub float %33, %v3P.sroa.12.8.vec.extract386
  %89 = fsub <2 x float> %31, %v3P.sroa.0.1.5459
  ...
  %98 = fadd <2 x float> %v3P.sroa.0.1.5459, %97
  ...
  store <2 x float> %98, ptr %pointOnBox, align 4
  %ref.tmp83.sroa.4.0..sroa_idx = getelementptr inbounds i8, ptr %pointOnBox, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i261, ptr %ref.tmp83.sroa.4.0..sroa_idx, align 4
  ...
  store <2 x float> %102, ptr %v3PointOnSphere, align 4
  %ref.tmp89.sroa.4.0..sroa_idx = getelementptr inbounds i8, ptr %v3PointOnSphere, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i283, ptr %ref.tmp89.sroa.4.0..sroa_idx, align 4
  %103 = load float, ptr %pointOnBox, align 4
  ...
  %105 = load float, ptr %arrayidx7.i288, align 4
  %106 = extractelement <2 x float> %102, i64 1
  %sub8.i289 = fsub float %106, %105
  %107 = load float, ptr %ref.tmp83.sroa.4.0..sroa_idx, align 4
...
if.end101:                                        ; preds = %if.then74
  ...
  %113 = load float, ptr %arrayidx.i.i.i, align 4
  %114 = load float, ptr %arrayidx.i28.i.i, align 4
  %115 = load float, ptr %arrayidx3.i.i, align 4
  %116 = load float, ptr %arrayidx.i26.i.i, align 4
  %117 = load float, ptr %arrayidx.i29.i.i, align 4
  ...
  %124 = insertelement <2 x float> %123, float %115, i64 1
  ...
  store <2 x float> %134, ptr %pointOnBox, align 4
  store <2 x float> %retval.sroa.3.12.vec.insert.i309, ptr %ref.tmp83.sroa.4.0..sroa_idx, align 4
  %141 = load float, ptr %m_worldTransform.i, align 4
  %142 = load float, ptr %v3PointOnSphere, align 4
  %143 = load float, ptr %arrayidx.i.i.i, align 4
  %144 = load float, ptr %arrayidx5.i287, align 4
  %145 = load float, ptr %arrayidx.i28.i.i, align 4
  %146 = load float, ptr %ref.tmp89.sroa.4.0..sroa_idx, align 4
  %147 = load float, ptr %arrayidx3.i.i, align 4
  %148 = load float, ptr %arrayidx.i26.i.i, align 4
  %149 = load float, ptr %arrayidx.i29.i.i, align 4
  ...
  %152 = insertelement <2 x float> poison, float %143, i64 0
  %153 = insertelement <2 x float> %152, float %148, i64 1
  %154 = fmul <2 x float> %151, %153
  %155 = insertelement <2 x float> poison, float %141, i64 0
  %156 = insertelement <2 x float> %155, float %147, i64 1
  ...
  %160 = insertelement <2 x float> poison, float %145, i64 0
  %161 = insertelement <2 x float> %160, float %149, i64 1
  %162 = insertelement <2 x float> poison, float %146, i64 0
  ...
  %165 = load <2 x float>, ptr %m_origin.i, align 4
  %166 = fadd <2 x float> %164, %165
  %167 = load float, ptr %arrayidx6.i.i, align 4
  %168 = load float, ptr %arrayidx.i27.i.i, align 4
  %mul8.i29.i327 = fmul float %144, %168
  %169 = tail call float @llvm.fmuladd.f32(float %167, float %142, float %mul8.i29.i327)
  %170 = load float, ptr %arrayidx.i30.i.i, align 4
  %171 = tail call float @llvm.fmuladd.f32(float %170, float %146, float %169)
  %172 = load float, ptr %arrayidx13.i.i, align 4
  ...
  store <2 x float> %166, ptr %v3PointOnSphere, align 4
  store <2 x float> %retval.sroa.3.12.vec.insert.i333, ptr %ref.tmp89.sroa.4.0..sroa_idx, align 4
  %173 = load float, ptr %pointOnBox, align 4
  %174 = extractelement <2 x float> %166, i64 0
  %sub.i336 = fsub float %173, %174
  %175 = load float, ptr %arrayidx7.i288, align 4
  %176 = extractelement <2 x float> %166, i64 1
  %sub8.i339 = fsub float %175, %176
  %177 = load float, ptr %ref.tmp83.sroa.4.0..sroa_idx, align 4
...
entry:
  %bounds.sroa.9.0.aabbMin.sroa_idx = getelementptr inbounds i8, ptr %aabbMin, i64 8
  %bounds.sroa.9.0.copyload = load float, ptr %bounds.sroa.9.0.aabbMin.sroa_idx, align 4
  %bounds.sroa.19.16.aabbMax.sroa_idx = getelementptr inbounds i8, ptr %aabbMax, i64 8
  %bounds.sroa.19.16.copyload = load float, ptr %bounds.sroa.19.16.aabbMax.sroa_idx, align 4
  %m_worldTransform.i = getelementptr inbounds %class.btCollisionObject, ptr %boxObj, i64 0, i32 1
  %m_origin.i = getelementptr inbounds %class.btCollisionObject, ptr %boxObj, i64 0, i32 1, i32 1
  %0 = load float, ptr %sphereCenter, align 4
  ...
  %arrayidx.i29.i.i = getelementptr inbounds %class.btCollisionObject, ptr %boxObj, i64 0, i32 1, i32 0, i32 0, i64 1, i32 0, i64 2
  %arrayidx.i30.i.i = getelementptr inbounds %class.btCollisionObject, ptr %boxObj, i64 0, i32 1, i32 0, i32 0, i64 2, i32 0, i64 2
  %6 = load float, ptr %arrayidx.i28.i.i, align 4
  %7 = load float, ptr %arrayidx.i29.i.i, align 4
  %8 = load float, ptr %arrayidx.i30.i.i, align 4
  %9 = load <2 x float>, ptr %aabbMin, align 4
  %10 = load <2 x float>, ptr %aabbMax, align 4
  %11 = load <2 x float>, ptr %m_worldTransform.i, align 4
  %12 = load <2 x float>, ptr %arrayidx3.i.i, align 4
  %13 = load <2 x float>, ptr %arrayidx6.i.i, align 4
  ...
  %sub14.i = fsub float %24, %bounds.sroa.9.0.copyload
...
for.inc:                                          ; preds = %if.then51, %if.end
  ...
  %p0.sroa.7.1 = phi float [ %bounds.sroa.9.0.copyload, %if.then51 ], [ 0.000000e+00, %if.end ]
...
for.inc.1:                                        ; preds = %if.then51.1, %if.end.1
  ...
  %p0.sroa.7.1.1 = phi float [ %bounds.sroa.9.0.copyload, %if.then51.1 ], [ %p0.sroa.7.1, %if.end.1 ]
...
for.inc.2:                                        ; preds = %if.then51.2, %if.end.2
  ...
  %p0.sroa.7.1.2 = phi float [ %bounds.sroa.9.0.copyload, %if.then51.2 ], [ %p0.sroa.7.1.1, %if.end.2 ]
  %35 = phi <2 x float> [ %9, %if.then51.2 ], [ %32, %if.end.2 ]
  %36 = fsub <2 x float> %22, %10
  %sub14.i.3 = fsub float %24, %bounds.sroa.19.16.copyload
...
for.inc.3:                                        ; preds = %if.then51.3, %if.end.3
  ...
  %p0.sroa.7.1.3 = phi float [ %bounds.sroa.19.16.copyload, %if.then51.3 ], [ %p0.sroa.7.1.2, %if.end.3 ]
...
for.inc.4:                                        ; preds = %if.then51.4, %if.end.4
  ...
  %p0.sroa.7.1.4 = phi float [ %bounds.sroa.19.16.copyload, %if.then51.4 ], [ %p0.sroa.7.1.3, %if.end.4 ]
...
for.inc.5:                                        ; preds = %if.end.5, %if.end.5.for.inc.5_crit_edge
  ...
  store <2 x float> %57, ptr %pointOnBox, align 4
  %ref.tmp59.sroa.4.0..sroa_idx = getelementptr inbounds i8, ptr %pointOnBox, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i172, ptr %ref.tmp59.sroa.4.0..sroa_idx, align 4
  ...
  store <2 x float> %61, ptr %v3PointOnSphere, align 4
  %ref.tmp70.sroa.4.0..sroa_idx = getelementptr inbounds i8, ptr %v3PointOnSphere, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i191, ptr %ref.tmp70.sroa.4.0..sroa_idx, align 4
  %62 = load float, ptr %m_worldTransform.i, align 4
  %63 = load float, ptr %pointOnBox, align 4
  %64 = load float, ptr %arrayidx.i.i.i, align 4
  %65 = load float, ptr %arrayidx5.i185, align 4
  %66 = load float, ptr %arrayidx.i28.i.i, align 4
  %67 = load float, ptr %ref.tmp59.sroa.4.0..sroa_idx, align 4
  %68 = load float, ptr %arrayidx3.i.i, align 4
  %69 = load float, ptr %arrayidx.i26.i.i, align 4
  %70 = load float, ptr %arrayidx.i29.i.i, align 4
  ...
  %86 = load <2 x float>, ptr %m_origin.i, align 4
  %87 = fadd <2 x float> %85, %86
  %88 = load float, ptr %arrayidx6.i.i, align 4
  %89 = load float, ptr %arrayidx.i27.i.i, align 4
  %mul8.i29.i = fmul float %65, %89
  %90 = tail call float @llvm.fmuladd.f32(float %88, float %63, float %mul8.i29.i)
  %91 = load float, ptr %arrayidx.i30.i.i, align 4
  %92 = tail call float @llvm.fmuladd.f32(float %91, float %67, float %90)
  %93 = load float, ptr %arrayidx13.i.i, align 4
  ...
  store <2 x float> %87, ptr %pointOnBox, align 4
  store <2 x float> %retval.sroa.3.12.vec.insert.i200, ptr %ref.tmp59.sroa.4.0..sroa_idx, align 4
  %94 = load float, ptr %m_worldTransform.i, align 4
  %95 = load float, ptr %v3PointOnSphere, align 4
  ...
  %97 = load float, ptr %arrayidx7.i.i204, align 4
  %98 = load float, ptr %arrayidx.i28.i.i, align 4
  %99 = load float, ptr %ref.tmp70.sroa.4.0..sroa_idx, align 4
  %100 = load float, ptr %arrayidx3.i.i, align 4
  %101 = load float, ptr %arrayidx.i26.i.i, align 4
  %102 = load float, ptr %arrayidx.i29.i.i, align 4
  ...
  %110 = insertelement <2 x float> poison, float %95, i64 0
  %111 = shufflevector <2 x float> %110, <2 x float> poison, <2 x i32> zeroinitializer
  %112 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %109, <2 x float> %111, <2 x float> %107)
  %113 = insertelement <2 x float> poison, float %98, i64 0
  %114 = insertelement <2 x float> %113, float %102, i64 1
  ...
  %118 = load <2 x float>, ptr %m_origin.i, align 4
  %119 = fadd <2 x float> %117, %118
  %120 = load float, ptr %arrayidx6.i.i, align 4
  %121 = load float, ptr %arrayidx.i27.i.i, align 4
  %mul8.i29.i218 = fmul float %97, %121
  %122 = tail call float @llvm.fmuladd.f32(float %120, float %95, float %mul8.i29.i218)
  %123 = load float, ptr %arrayidx.i30.i.i, align 4
  %124 = tail call float @llvm.fmuladd.f32(float %123, float %99, float %122)
  %125 = load float, ptr %arrayidx13.i.i, align 4
  ...
  store <2 x float> %119, ptr %v3PointOnSphere, align 4
  store <2 x float> %retval.sroa.3.12.vec.insert.i224, ptr %ref.tmp70.sroa.4.0..sroa_idx, align 4
  br label %cleanup86
...
attributes #8 = { mustprogress nofree nosync nounwind willreturn memory(argmem: readwrite) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
