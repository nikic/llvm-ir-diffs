; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btCapsuleShape.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btCapsuleShape.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [20 x ptr] }, ptr @_ZTV14btCapsuleShape, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
entry:
  ...
  %vec.sroa.23.0.copyload = load float, ptr %vec.sroa.23.0.vec0.sroa_idx, align 4
...
if.end:                                           ; preds = %entry, %if.else
  ...
  %11 = load float, ptr %arrayidx.i85, align 4
  ...
  %13 = load float, ptr %arrayidx5.i80, align 8
  ...
  %20 = load <2 x float>, ptr %pos, align 8
  ...
  %31 = load i32, ptr %m_upAxis.i, align 8
  ...
  %32 = load float, ptr %arrayidx.i138, align 4
  %fneg = fneg float %32
  %arrayidx44 = getelementptr inbounds float, ptr %pos36, i64 %idxprom.i137
  store float %fneg, ptr %arrayidx44, align 4
  %33 = load float, ptr %arrayidx13.i, align 8
  %mul14.i146 = fmul float %vec.sroa.23.0, %33
  %mul8.i156 = fmul float %10, %mul14.i146
  %34 = load float, ptr %arrayidx5.i133, align 8
  ...
  %36 = load <2 x float>, ptr %m_localScaling, align 8
  %37 = fmul <2 x float> %8, %36
  %38 = fmul <2 x float> %18, %37
  %39 = load <2 x float>, ptr %pos36, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end63
  ...
  %14 = load <2 x float>, ptr %pos, align 8
...
if.then:                                          ; preds = %for.body
  ...
  store <2 x float> %21, ptr %arrayidx28, align 4
  %vtx.sroa.10.0.arrayidx28.sroa_idx = getelementptr inbounds i8, ptr %arrayidx28, i64 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i120, ptr %vtx.sroa.10.0.arrayidx28.sroa_idx, align 4
  %27 = load <2 x float>, ptr %arrayidx, align 4
  %.pre208 = load float, ptr %arrayidx11.i, align 4
  br label %if.end
...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %30 = load i32, ptr %m_upAxis.i, align 8
  ...
  %31 = load float, ptr %arrayidx.i132, align 4
  %fneg = fneg float %31
  %arrayidx37 = getelementptr inbounds float, ptr %pos29, i64 %idxprom.i131
  store float %fneg, ptr %arrayidx37, align 4
  %32 = load float, ptr %arrayidx13.i, align 8
  %mul14.i140 = fmul float %28, %32
  %mul8.i150 = fmul float %1, %mul14.i140
  %33 = load float, ptr %arrayidx5.i127, align 8
...
if.then60:                                        ; preds = %if.end
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i187, ptr %vtx.sroa.10.0.arrayidx62.sroa_idx, align 4
  br label %if.end63
...
entry:
  ...
  %18 = shufflevector <2 x float> %17, <2 x float> poison, <2 x i32> zeroinitializer
  %19 = fmul <2 x float> %18, %16
  store <2 x float> %19, ptr %inertia, align 4
  ...
  store float %mul29, ptr %arrayidx31, align 4
...
entry:
  ...
  store ptr getelementptr inbounds ({ [20 x ptr] }, ptr @_ZTV15btCapsuleShapeX, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %m_upAxis = getelementptr inbounds %class.btCapsuleShape, ptr %this, i64 0, i32 1
...
entry:
  ...
  %m_shapeType.i = getelementptr inbounds %class.btCollisionShape, ptr %this, i64 0, i32 1
  store i32 10, ptr %m_shapeType.i, align 8
  store ptr getelementptr inbounds ({ [20 x ptr] }, ptr @_ZTV15btCapsuleShapeZ, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %m_upAxis = getelementptr inbounds %class.btCapsuleShape, ptr %this, i64 0, i32 1
...
entry:
  ...
  %2 = load float, ptr %arrayidx.i59, align 4
  %add = fadd float %1, %2
  ...
  %6 = load float, ptr %halfExtents, align 4
  ...
  %mul8.i79 = fmul float %add8.i, %21
  %24 = tail call float @llvm.fmuladd.f32(float %19, float %add.i63, float %mul8.i79)
  %25 = tail call float @llvm.fmuladd.f32(float %23, float %add13.i, float %24)
  %26 = insertelement <2 x float> %10, float %15, i64 1
  %27 = tail call <2 x float> @llvm.fabs.v2f32(<2 x float> %26)
  %28 = insertelement <2 x float> %12, float %16, i64 1
  %29 = tail call <2 x float> @llvm.fabs.v2f32(<2 x float> %28)
  %30 = insertelement <2 x float> %14, float %17, i64 1
