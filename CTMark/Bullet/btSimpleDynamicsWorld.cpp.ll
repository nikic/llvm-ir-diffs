; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSimpleDynamicsWorld.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btSimpleDynamicsWorld.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [32 x ptr] }, ptr @_ZTV21btSimpleDynamicsWorld, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
if.then6.i:                                       ; preds = %if.then.i
  ...
  %6 = load i32, ptr %m_activationState1.i.i.i, align 4
...
if.then:                                          ; preds = %_ZN21btSimpleDynamicsWorld25predictUnconstraintMotionEf.exit
  ...
  store <4 x float> <float 2.000000e+01, float 1.000000e+00, float 0x3FC99999A0000000, float 0x3FB99999A0000000>, ptr %m_maxErrorReduction.i, align 8
  ...
  store <2 x float> <float 0xBF947AE140000000, float 0.000000e+00>, ptr %m_splitImpulsePenetrationThreshold.i, align 8
  %m_warmstartingFactor.i = getelementptr inbounds %struct.btContactSolverInfoData, ptr %infoGlobal, i64 0, i32 14
  store float 0x3FEB333340000000, ptr %m_warmstartingFactor.i, align 8
  ...
  store i32 2, ptr %m_restingContactRestitutionThreshold.i, align 8
  %m_timeStep12 = getelementptr inbounds %struct.btContactSolverInfoData, ptr %infoGlobal, i64 0, i32 3
  store float %timeStep, ptr %m_timeStep12, align 4
  %m_constraintSolver = getelementptr inbounds %class.btSimpleDynamicsWorld, ptr %this, i64 0, i32 2
  ...
  %24 = load ptr, ptr %m_stackAlloc, align 8
...
if.end:                                           ; preds = %if.then, %_ZN21btSimpleDynamicsWorld25predictUnconstraintMotionEf.exit
  ...
  br i1 %cmp17.i, label %for.body.lr.ph.i39, label %_ZN21btSimpleDynamicsWorld19integrateTransformsEf.exit

for.body.lr.ph.i39:                               ; preds = %if.end
  %m_data.i.i40 = getelementptr inbounds %class.btCollisionWorld, ptr %this, i64 0, i32 1, i32 5
  br label %for.body.i41

for.body.i41:                                     ; preds = %if.end8.i, %for.body.lr.ph.i39
  %27 = phi i32 [ %26, %for.body.lr.ph.i39 ], [ %33, %if.end8.i ]
  %indvars.iv.i42 = phi i64 [ 0, %for.body.lr.ph.i39 ], [ %indvars.iv.next.i49, %if.end8.i ]
  %28 = load ptr, ptr %m_data.i.i40, align 8
  %arrayidx.i.i43 = getelementptr inbounds ptr, ptr %28, i64 %indvars.iv.i42
  %29 = load ptr, ptr %arrayidx.i.i43, align 8
  %m_internalType.i.i.i44 = getelementptr inbounds %class.btCollisionObject, ptr %29, i64 0, i32 19
  %30 = load i32, ptr %m_internalType.i.i.i44, align 8
  %cmp.i.i45 = icmp ne i32 %30, 2
  %tobool.not16.i = icmp eq ptr %29, null
  %tobool.not.i46 = or i1 %tobool.not16.i, %cmp.i.i45
  br i1 %tobool.not.i46, label %if.end8.i, label %if.then.i47

if.then.i47:                                      ; preds = %for.body.i41
  %m_activationState1.i.i.i48 = getelementptr inbounds %class.btCollisionObject, ptr %29, i64 0, i32 14
  %31 = load i32, ptr %m_activationState1.i.i.i48, align 4
...
land.lhs.true.i:                                  ; preds = %if.then.i47
  %m_collisionFlags.i.i51 = getelementptr inbounds %class.btCollisionObject, ptr %29, i64 0, i32 11
  %32 = load i32, ptr %m_collisionFlags.i.i51, align 8
  %and.i.i52 = and i32 %32, 1
  %cmp.i15.not.i = icmp eq i32 %and.i.i52, 0
...
if.end8.i:                                        ; preds = %if.then7.i, %land.lhs.true.i, %if.then.i47, %if.then.i47, %for.body.i41
  %33 = phi i32 [ %27, %if.then.i47 ], [ %27, %if.then.i47 ], [ %27, %land.lhs.true.i ], [ %.pre.i53, %if.then7.i ], [ %27, %for.body.i41 ]
  %indvars.iv.next.i49 = add nuw nsw i64 %indvars.iv.i42, 1
  %34 = sext i32 %33 to i64
  %cmp.i50 = icmp slt i64 %indvars.iv.next.i49, %34
  br i1 %cmp.i50, label %for.body.i41, label %_ZN21btSimpleDynamicsWorld19integrateTransformsEf.exit
...
if.then6:                                         ; preds = %if.then
  ...
  %6 = load i32, ptr %m_activationState1.i.i, align 4
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %6 = load i32, ptr %m_activationState1.i, align 4
...
attributes #5 = { noreturn nounwind memory(inaccessiblemem: write) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
