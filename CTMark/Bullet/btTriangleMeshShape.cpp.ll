; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btTriangleMeshShape.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/Bullet/btTriangleMeshShape.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [17 x ptr] }, ptr @_ZTV19btTriangleMeshShape, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
if.else:                                          ; preds = %invoke.cont3
  ...
  store float 1.000000e+00, ptr %vec.i, align 4
...
call4.i.noexc:                                    ; preds = %if.else
  ...
  %5 = load float, ptr %m_collisionMargin.i, align 8
  %add.i = fadd float %tmp.sroa.0.0.vec.extract36.i, %5
  store float %add.i, ptr %m_localAabbMax, align 4
  store float -1.000000e+00, ptr %vec.i, align 4
...
call17.i.noexc:                                   ; preds = %call4.i.noexc
  ...
  %8 = load float, ptr %m_collisionMargin.i, align 8
  %sub.i = fsub float %tmp.sroa.0.0.vec.extract.i, %8
  store float %sub.i, ptr %m_localAabbMin, align 4
  ...
  %vtable.1.i = load ptr, ptr %this, align 8
...
call4.1.i.noexc:                                  ; preds = %call17.i.noexc
  ...
  store float %add.1.i, ptr %arrayidx10.1.i, align 8
  store float -1.000000e+00, ptr %arrayidx3.i.i, align 4
  %vtable15.1.i = load ptr, ptr %this, align 8
...
call17.1.i.noexc:                                 ; preds = %call4.1.i.noexc
  ...
  %14 = load float, ptr %m_collisionMargin.i, align 8
  ...
  store float %sub.1.i, ptr %arrayidx25.1.i, align 8
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %vec.i) #14
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %vec.i) #14
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %vec.i, i8 0, i64 16, i1 false)
  store float 1.000000e+00, ptr %arrayidx5.i.i, align 4
  %vtable.2.i = load ptr, ptr %this, align 8
...
call4.2.i.noexc:                                  ; preds = %call17.1.i.noexc
  ...
  %17 = load float, ptr %m_collisionMargin.i, align 8
  ...
  store float %add.2.i, ptr %arrayidx10.2.i, align 4
  store float -1.000000e+00, ptr %arrayidx5.i.i, align 4
  %vtable15.2.i = load ptr, ptr %this, align 8
...
_ZN19btTriangleMeshShape15recalcLocalAabbEv.exit: ; preds = %call4.2.i.noexc
  ...
  %20 = load float, ptr %m_collisionMargin.i, align 8
  ...
  store float %sub.2.i, ptr %arrayidx25.2.i, align 4
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %vec.i) #14
  br label %if.end
...
entry:
  ...
  store float 1.000000e+00, ptr %vec, align 4
  ...
  store float %add, ptr %m_localAabbMax, align 4
  store float -1.000000e+00, ptr %vec, align 4
  ...
  %6 = load float, ptr %m_collisionMargin, align 8
  %sub = fsub float %tmp.sroa.0.0.vec.extract, %6
  store float %sub, ptr %m_localAabbMin, align 4
  ...
  store float %add.1, ptr %arrayidx10.1, align 8
  store float -1.000000e+00, ptr %arrayidx3.i, align 4
  %vtable15.1 = load ptr, ptr %this, align 8
  ...
  store float %sub.1, ptr %arrayidx25.1, align 8
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %vec) #14
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %vec) #14
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %vec, i8 0, i64 16, i1 false)
  ...
  store float %add.2, ptr %arrayidx10.2, align 4
  store float -1.000000e+00, ptr %arrayidx5.i, align 4
  %vtable15.2 = load ptr, ptr %this, align 8
  ...
  %18 = load float, ptr %m_collisionMargin, align 8
  ...
  store float %sub.2, ptr %arrayidx25.2, align 4
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %vec) #14
  ret void
}
...
entry:
  ...
  %19 = load <4 x float>, ptr %arrayidx.i43.i, align 4
  ...
  %26 = load float, ptr %arrayidx.i46.i, align 4
  ...
  %28 = load float, ptr %arrayidx.i47.i, align 4
  %29 = tail call float @llvm.fabs.f32(float %28)
  %m_origin.i = getelementptr inbounds %class.btTransform, ptr %trans, i64 0, i32 1
  %mul8.i29.i = fmul float %mul4.i.i61, %26
  %30 = tail call float @llvm.fmuladd.f32(float %24, float %mul.i.i59, float %mul8.i29.i)
  %31 = tail call float @llvm.fmuladd.f32(float %28, float %mul8.i.i63, float %30)
  ...
  %add17.i = fadd float %31, %32
  %mul8.i90 = fmul float %add8.i, %27
  %33 = tail call float @llvm.fmuladd.f32(float %25, float %add.i, float %mul8.i90)
  %34 = tail call float @llvm.fmuladd.f32(float %29, float %add13.i, float %33)
  ...
  %46 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %35, <2 x float> %45, <2 x float> %43)
  ...
  %57 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %36, <2 x float> %56, <2 x float> %54)
  ...
  %sub14.i102 = fsub float %add17.i, %34
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i105, ptr %ref.tmp37.sroa.4.0..sroa_idx, align 4
  %62 = fadd <2 x float> %60, %51
  %add14.i114 = fadd float %34, %add17.i
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i117, ptr %ref.tmp40.sroa.4.0..sroa_idx, align 4
  ret void
}
...
entry:
  ...
  store float %add.i, ptr %m_localAabbMax.i, align 4
  store float -1.000000e+00, ptr %vec.i, align 4
  %vtable15.i = load ptr, ptr %this, align 8
  %vfn16.i = getelementptr inbounds ptr, ptr %vtable15.i, i64 13
  ...
  store float %sub.i, ptr %m_localAabbMin.i, align 4
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %vec.i) #14
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %vec.i) #14
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %vec.i, i8 0, i64 16, i1 false)
  store float 1.000000e+00, ptr %arrayidx3.i.i, align 4
  ...
  %15 = load float, ptr %m_collisionMargin.i, align 8
  ...
  %18 = load float, ptr %m_collisionMargin.i, align 8
...
invoke.cont6:
  ...
  store float 1.000000e+00, ptr %ident.sroa.7.16.arrayidx8.i.i.i.sroa_idx, align 4
  ...
  store float 1.000000e+00, ptr %ident.sroa.10.32.arrayidx12.i.i.i.sroa_idx, align 8
  ...
  store i32 0, ptr %ident.sroa.11.32.arrayidx12.i.i.i.sroa_idx, align 4
  ...
  %3 = load float, ptr %arrayidx.i14.i.i.i, align 4
  %4 = load float, ptr %ident.sroa.5.0.m_worldTrans.i.sroa_idx, align 4
  ...
  %11 = load float, ptr %arrayidx.i.i12.i.i, align 8
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i, ptr %ref.tmp7.sroa.5.0.m_supportVecLocal13.sroa_idx.i, align 4
...
invoke.cont7:                                     ; preds = %invoke.cont6
  ...
  %.fca.0.insert.i22 = insertvalue { <2 x float>, <2 x float> } poison, <2 x float> %retval.sroa.0.0.copyload.i, 0
  %.fca.1.insert.i23 = insertvalue { <2 x float>, <2 x float> } %.fca.0.insert.i22, <2 x float> %retval.sroa.2.0.copyload.i, 1
...
if.end.i:                                         ; preds = %entry
  ...
  %cond-lvalue.i103.i = select i1 %cmp.i102.i, ptr %triangle, ptr %arrayidx1.i
  %cmp.i104.i = fcmp ogt float %6, %3
  %cond-lvalue.i105.i = select i1 %cmp.i104.i, ptr %cond-lvalue.i103.i, ptr %arrayidx2.i
  %7 = load float, ptr %cond-lvalue.i105.i, align 4
...
if.end37.i:                                       ; preds = %if.end24.i
  ...
  %cond-lvalue.i111.i = select i1 %cmp.i110.i, ptr %arrayidx26.i, ptr %arrayidx28.i
  %cmp.i112.i = fcmp ogt float %15, %12
  %cond-lvalue.i113.i = select i1 %cmp.i112.i, ptr %cond-lvalue.i111.i, ptr %arrayidx31.i
  %16 = load float, ptr %cond-lvalue.i113.i, align 4
...
_Z24TestTriangleAgainstAabb2PK9btVector3RS0_S2_.exit: ; preds = %if.end50.i
  ...
  %cond-lvalue.i121.i = select i1 %cmp.i120.i, ptr %cond-lvalue.i119.i, ptr %arrayidx57.i
  %25 = load float, ptr %cond-lvalue.i121.i, align 4
