...
entry:
  ...
  %sub = sub i64 %0, %1
  %cmp = icmp eq i64 %0, %1
  %.pre23 = load i64, ptr %size, align 8, !tbaa !5
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %4 = load i64, ptr %size2, align 8, !tbaa !5
  store i64 %4, ptr %size1, align 8, !tbaa !25
  %.pre = load i64, ptr %size, align 8, !tbaa !5
  br label %if.end
...
entry:
  ...
  %.pre32 = load i64, ptr %size, align 8, !tbaa !5
