; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/7zStream.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/7zStream.c"
...
while.body:                                       ; preds = %entry, %cleanup5
  ...
  store i64 %size.addr.020, ptr %processed, align 8
...
while.body.i:                                     ; preds = %entry, %cleanup5.i
  ...
  store i64 %size.addr.020.i, ptr %processed.i, align 8
  %0 = load ptr, ptr %stream, align 8
...
cleanup.cont.i:                                   ; preds = %while.body.i
  %1 = load i64, ptr %processed.i, align 8
...
entry:
  ...
  store i64 %offset, ptr %t, align 8
...
cleanup.cont:                                     ; preds = %if.end
  %2 = load ptr, ptr %lookBuf, align 8
...
entry:
  ...
  %sub = sub i64 %0, %1
  %cmp = icmp eq i64 %0, %1
  %.pre23 = load i64, ptr %size, align 8
  br i1 %cmp, label %land.lhs.true, label %if.end

land.lhs.true:                                    ; preds = %entry
  %cmp2.not = icmp eq i64 %.pre23, 0
  br i1 %cmp2.not, label %if.end9, label %if.then

if.then:                                          ; preds = %land.lhs.true
  store i64 0, ptr %pos, align 8
  store i64 16384, ptr %size2, align 8
  %realStream = getelementptr inbounds %struct.CLookToRead, ptr %pp, i64 0, i32 1
  %2 = load ptr, ptr %realStream, align 8
  %3 = load ptr, ptr %2, align 8
  %buf5 = getelementptr inbounds %struct.CLookToRead, ptr %pp, i64 0, i32 4
  %call = call i32 %3(ptr noundef nonnull %2, ptr noundef nonnull %buf5, ptr noundef nonnull %size2) #8
...
if.end:                                           ; preds = %if.then, %entry
  %5 = phi i64 [ %.pre, %if.then ], [ %.pre23, %entry ]
  %6 = phi i64 [ %4, %if.then ], [ %sub, %entry ]
  %res.0 = phi i32 [ %call, %if.then ], [ 0, %entry ]
  %cmp7 = icmp ult i64 %6, %5
...
if.end9:                                          ; preds = %land.lhs.true, %if.then8, %if.end
  %res.026 = phi i32 [ %res.0, %if.then8 ], [ %res.0, %if.end ], [ 0, %land.lhs.true ]
  %buf10 = getelementptr inbounds %struct.CLookToRead, ptr %pp, i64 0, i32 4
  %7 = load i64, ptr %pos, align 8
  %add.ptr = getelementptr inbounds i8, ptr %buf10, i64 %7
...
entry:
  ...
  %.pre32 = load i64, ptr %size, align 8
  br i1 %cmp, label %land.lhs.true, label %if.end9

land.lhs.true:                                    ; preds = %entry
  %cmp2.not = icmp eq i64 %.pre32, 0
  br i1 %cmp2.not, label %if.end12, label %if.then

if.then:                                          ; preds = %land.lhs.true
  store i64 0, ptr %pos, align 8
  %2 = load i64, ptr %size, align 8
  %cmp4 = icmp ugt i64 %2, 16384
  br i1 %cmp4, label %if.then5, label %if.end

if.then5:                                         ; preds = %if.then
  store i64 16384, ptr %size, align 8
  br label %if.end

if.end:                                           ; preds = %if.then5, %if.then
  %realStream = getelementptr inbounds %struct.CLookToRead, ptr %pp, i64 0, i32 1
  %3 = load ptr, ptr %realStream, align 8
  %4 = load ptr, ptr %3, align 8
  %buf7 = getelementptr inbounds %struct.CLookToRead, ptr %pp, i64 0, i32 4
  %call = tail call i32 %4(ptr noundef nonnull %3, ptr noundef nonnull %buf7, ptr noundef nonnull %size) #8
  %5 = load i64, ptr %size, align 8
  store i64 %5, ptr %size1, align 8
  %.pre = load i64, ptr %size, align 8
  br label %if.end9

if.end9:                                          ; preds = %if.end, %entry
  %6 = phi i64 [ %.pre, %if.end ], [ %.pre32, %entry ]
  %res.0 = phi i32 [ %call, %if.end ], [ 0, %entry ]
  %size2.0 = phi i64 [ %5, %if.end ], [ %sub, %entry ]
  %cmp10 = icmp ult i64 %size2.0, %6
  br i1 %cmp10, label %if.then11, label %if.end12

if.then11:                                        ; preds = %if.end9
  store i64 %size2.0, ptr %size, align 8
  br label %if.end12

if.end12:                                         ; preds = %land.lhs.true, %if.then11, %if.end9
  %res.036 = phi i32 [ %res.0, %if.then11 ], [ %res.0, %if.end9 ], [ 0, %land.lhs.true ]
  %buf13 = getelementptr inbounds %struct.CLookToRead, ptr %pp, i64 0, i32 4
  %7 = load i64, ptr %pos, align 8
  %add.ptr = getelementptr inbounds i8, ptr %buf13, i64 %7
  store ptr %add.ptr, ptr %buf, align 8
  ret i32 %res.036
}
...
if.end:                                           ; preds = %entry
  ...
  store i64 %add, ptr %pos, align 8
  store i64 %spec.select, ptr %size, align 8
  br label %cleanup
...
entry:
  store ptr @SecToLook_Read, ptr %p, align 8
  ret void
}
...
cleanup.cont.i:                                   ; preds = %if.end.i
  %3 = load ptr, ptr %lookBuf.i, align 8
  %4 = load i64, ptr %size, align 8
...
entry:
  store ptr @SecToRead_Read, ptr %p, align 8
  ret void
}
