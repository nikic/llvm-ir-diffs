...
for.cond:                                         ; preds = %for.body
  ...
  %0 = load ptr, ptr %arrayidx.1, align 8
...
for.cond.1:                                       ; preds = %for.cond
  ...
  %1 = load ptr, ptr %arrayidx.2, align 16
...
for.cond.2:                                       ; preds = %for.cond.1
  ...
  %2 = load ptr, ptr %arrayidx.3, align 8
...
if.then2:                                         ; preds = %for.cond.2, %for.cond.1, %for.cond, %for.body
  ...
  %4 = load ptr, ptr @g_HugetlbPath, align 8
...
if.end18:                                         ; preds = %if.end
  ...
  store i64 %size, ptr %arrayidx20, align 8
  store ptr %call13, ptr %arrayidx.lcssa, align 8
  br label %cleanup
...
for.cond.i:                                       ; preds = %for.body.i
  ...
  %0 = load ptr, ptr %arrayidx.i.1, align 8
...
for.cond.i.1:                                     ; preds = %for.cond.i
  ...
  %1 = load ptr, ptr %arrayidx.i.2, align 16
...
for.cond.i.2:                                     ; preds = %for.cond.i.1
  ...
  %2 = load ptr, ptr %arrayidx.i.3, align 8
...
for.cond.i.3:                                     ; preds = %for.cond.i.2
  ...
  br i1 %exitcond.not.i.3, label %for.end.i, label %for.body.i
...
if.then.i:                                        ; preds = %for.cond.i.2, %for.cond.i.1, %for.cond.i, %for.body.i
  ...
  store ptr null, ptr %arrayidx.i.lcssa, align 8
  br label %return
...
entry:
  ...
  store ptr %call, ptr @g_HugetlbPath, align 8
  %cmp = icmp eq ptr %call, null
  br i1 %cmp, label %if.then, label %lor.lhs.false

if.then:                                          ; preds = %entry
  store i8 0, ptr @largePageMinimum.dir_hugetlbfs, align 16
...
while.body:                                       ; preds = %if.then2, %if.end
  ...
  %0 = load ptr, ptr %mnt_type, align 8
...
if.then7:                                         ; preds = %while.body
  ...
  %1 = load ptr, ptr %mnt_dir, align 8
...
if.end11:                                         ; preds = %while.end, %if.then
  %2 = load i8, ptr @largePageMinimum.dir_hugetlbfs, align 16
  %tobool12.not = icmp eq i8 %2, 0
  br i1 %tobool12.not, label %if.end15, label %if.then13

if.then13:                                        ; preds = %if.end11
  store ptr @largePageMinimum.dir_hugetlbfs, ptr @g_HugetlbPath, align 8
  br label %lor.lhs.false

if.end15:                                         ; preds = %if.end11
  %.pr = load ptr, ptr @g_HugetlbPath, align 8
...
entry:
  ...
  %0 = tail call i64 @llvm.ctpop.i64(i64 %call)
  %or.cond = icmp eq i64 %0, 1
  br i1 %or.cond, label %if.end, label %cleanup

if.end:                                           ; preds = %entry
  store i64 %call, ptr @g_LargePageSize, align 8
  br label %cleanup
