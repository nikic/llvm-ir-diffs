; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/XzEnc.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/XzEnc.c"
...
entry:
  ...
  %add.ptr8 = getelementptr inbounds [12 x i8], ptr %header, i64 0, i64 8
...
for.body:                                         ; preds = %if.end14, %for.body
  ...
  %8 = load i32, ptr %propsSize, align 8
  ...
  %9 = load i32, ptr %propsSize, align 8
...
while.body:                                       ; preds = %while.cond.preheader
  ...
  br i1 %cmp44.not, label %while.end, label %while.body.1
...
while.body.1:                                     ; preds = %while.body
  ...
  store i8 0, ptr %arrayidx48.1, align 1
  %and43.1 = and i32 %inc46.1, 3
  %cmp44.not.1 = icmp eq i32 %and43.1, 0
  br i1 %cmp44.not.1, label %while.end, label %while.body.2
...
while.body.2:                                     ; preds = %while.body.1
  ...
  store i8 0, ptr %arrayidx48.2, align 1
  %and43.2 = and i32 %inc46.2, 3
  %cmp44.not.2 = icmp eq i32 %and43.2, 0
  br i1 %cmp44.not.2, label %while.end, label %while.body.3
...
while.body.3:                                     ; preds = %while.body.2
  ...
  store i8 0, ptr %arrayidx48.3, align 1
  br label %while.end
...
while.end:                                        ; preds = %while.body, %while.body.1, %while.body.2, %while.body.3, %while.cond.preheader
  ...
  store i8 %conv49, ptr %header, align 16
  ...
  store i32 %call53, ptr %add.ptr56, align 4
...
for.cond.preheader:                               ; preds = %entry
  %2 = load i64, ptr %numBlocks, align 8
...
for.inc:                                          ; preds = %for.body
  ...
  %7 = load i64, ptr %numBlocks, align 8
...
cleanup62:                                        ; preds = %for.end, %cleanup.cont45
  ...
  %xor = xor i32 %crc.1, -1
  store i32 %xor, ptr %buf, align 16
...
cleanup.cont66:                                   ; preds = %cleanup62
  ...
  store i32 %conv68, ptr %add.ptr70, align 4
  %11 = load i16, ptr %p, align 8
  %12 = lshr i16 %11, 8
  %conv73 = trunc i16 %12 to i8
  %arrayidx74 = getelementptr inbounds [32 x i8], ptr %buf, i64 0, i64 8
  store i8 %conv73, ptr %arrayidx74, align 8
  ...
  store i32 %call82, ptr %buf, align 16
...
entry.if.then_crit_edge:                          ; preds = %entry
  ...
  %.pre = load i64, ptr %numBlocks2.phi.trans.insert, align 8
  br label %if.then

lor.lhs.false:                                    ; preds = %entry
  %numBlocksAllocated = getelementptr inbounds %struct.CXzStream, ptr %p, i64 0, i32 2
  %1 = load i64, ptr %numBlocksAllocated, align 8
  %numBlocks = getelementptr inbounds %struct.CXzStream, ptr %p, i64 0, i32 1
  %2 = load i64, ptr %numBlocks, align 8
...
if.end9:                                          ; preds = %if.end
  %5 = load i64, ptr %numBlocks2, align 8
...
if.then12:                                        ; preds = %if.end9
  ...
  %.pre48.pre = load i64, ptr %numBlocks2, align 8
  br label %cleanup
...
cleanup:                                          ; preds = %if.end9, %if.then12
  ...
  store i64 %mul, ptr %numBlocksAllocated18, align 8
  br label %if.end21
...
if.end21:                                         ; preds = %cleanup, %lor.lhs.false
  ...
  %inc = add i64 %7, 1
  store i64 %inc, ptr %numBlocks23, align 8
  ...
  store i64 %totalSize, ptr %totalSize24, align 8
  store i64 %unpackSize, ptr %arrayidx, align 8
  br label %return
...
cleanup.cont.i:                                   ; preds = %if.then
  ...
  %add.ptr8.i.i = getelementptr inbounds [12 x i8], ptr %header.i.i, i64 0, i64 8
  store i32 %call.i.i, ptr %add.ptr8.i.i, align 4
...
cleanup.cont9.i:                                  ; preds = %cleanup.cont.i
  ...
  store i8 %conv12.i, ptr %flags10.i, align 8
...
if.end15.i:                                       ; preds = %if.then14.i, %cleanup.cont9.i
  ...
  store i8 %call24.i, ptr %props.i, align 4
  store ptr @MyWrite, ptr %seqSizeOutStream.i, align 8
  %realStream.i = getelementptr inbounds %struct.CSeqSizeOutStream, ptr %seqSizeOutStream.i, i64 0, i32 1
  store ptr %outStream, ptr %realStream.i, align 8
...
cleanup.cont35.i:                                 ; preds = %if.end15.i
  ...
  %4 = load i64, ptr %processed.i, align 8
...
cleanup.cont52.i:                                 ; preds = %cleanup.cont35.i
  ...
  %6 = load i64, ptr %processed.i, align 8
  %sub55.i = sub i64 %6, %4
...
while.body.preheader.i:                           ; preds = %cleanup.cont52.i
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(1) %buf.i, i8 0, i64 %10, i1 false)
...
if.end.i:                                         ; preds = %if.then.i6
  ...
  %24 = load ptr, ptr @g_Alloc, align 8
...
if.end9.i:                                        ; preds = %if.end.i
  %25 = load i64, ptr %numBlocks2.i, align 8
...
cleanup.cont105.i:                                ; preds = %cleanup.i, %lor.lhs.false.i
  ...
  %inc.i = add i64 %27, 1
  store i64 %inc.i, ptr %numBlocks23.i, align 8
  ...
  store i64 %sub87.i, ptr %totalSize24.i, align 8
...
entry:
  ...
  %add.ptr8.i = getelementptr inbounds [12 x i8], ptr %header.i, i64 0, i64 8
  store i32 %call.i, ptr %add.ptr8.i, align 4
  %1 = load ptr, ptr %outStream, align 8
...
entry:
  ...
  %0 = load ptr, ptr %realStream, align 8
