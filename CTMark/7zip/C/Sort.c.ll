; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/Sort.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/Sort.c"
...
cleanup:                                          ; preds = %if.end11
  ...
  store i32 %3, ptr %arrayidx20, align 4
  %shl = shl i32 %s.0, 1
...
for.end:                                          ; preds = %cleanup, %if.end11, %do.body
  ...
  br i1 %cmp23.not, label %while.cond.preheader, label %do.body
...
cleanup65:                                        ; preds = %if.end55
  ...
  store i32 %12, ptr %arrayidx64, align 4
...
for.end68:                                        ; preds = %cleanup65, %if.end55, %while.body
  ...
  store i32 %5, ptr %arrayidx70, align 4
  %cmp24 = icmp ugt i32 %indvars, 3
  br i1 %cmp24, label %while.body, label %while.end.thread

while.end.thread:                                 ; preds = %for.end68
  %arrayidx73186 = getelementptr inbounds i32, ptr %p, i64 2
  %13 = load i32, ptr %arrayidx73186, align 4
  %14 = load i32, ptr %p, align 4
  store i32 %14, ptr %arrayidx73186, align 4
...
while.end:                                        ; preds = %while.cond.preheader
  ...
  store i32 %16, ptr %arrayidx73, align 4
