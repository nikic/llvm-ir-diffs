; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/Lzma2Dec.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/Lzma2Dec.c"
...
entry:
  ...
  store i32 1, ptr %needInitDic, align 8
  ...
  store i32 1, ptr %needInitProp, align 8
...
entry:
  ...
  %cmp.not276 = icmp eq i32 %1, 8
  br i1 %cmp.not276, label %while.end, label %while.body.lr.ph
...
while.body:                                       ; preds = %while.body.lr.ph, %while.cond.backedge
  ...
  %src.addr.0277 = phi ptr [ %src, %while.body.lr.ph ], [ %src.addr.4286, %while.cond.backedge ]
  %3 = load i64, ptr %dicPos1, align 8
...
if.end16:                                         ; preds = %if.then13
  %inc = add i64 %5, 1
  store i64 %inc, ptr %srcLen, align 8
  %incdec.ptr = getelementptr inbounds i8, ptr %src.addr.0277, i64 1
  %6 = load i8, ptr %src.addr.0277, align 1
...
sw.bb.i:                                          ; preds = %if.end16
  store i8 %6, ptr %control43.i, align 4
...
if.end55.i:                                       ; preds = %sw.bb50.i
  ...
  store i32 %div60.zext.i, ptr %pb.i, align 8
...
if.end66.i:                                       ; preds = %if.end55.i
  ...
  store i32 %rem62.zext.i, ptr %lp72.i, align 4
  store i32 0, ptr %needInitProp73.i, align 8
  br label %cleanup165.thread
...
cleanup165.thread:                                ; preds = %if.end66.i, %if.end55.i, %sw.bb50.i, %cond.false.i, %sw.bb37.i, %sw.bb34.i, %sw.bb24.i, %sw.bb20.i, %if.else.i, %if.end14.i, %if.then7.i, %sw.bb.i, %if.end16
  ...
  store i32 %retval.1.i, ptr %state, align 8
  br label %while.cond.backedge

if.end18:                                         ; preds = %if.end7
  %sub = sub i64 %dicLimit, %3
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %srcSizeCur) #5
  %15 = load i64, ptr %srcLen, align 8
  %sub19 = sub i64 %0, %15
  store i64 %sub19, ptr %srcSizeCur, align 8
  %16 = load i32, ptr %unpackSize26.i, align 4
...
if.then42:                                        ; preds = %if.then37
  store i32 1, ptr %needInitState85, align 4
  store i32 1, ptr %needInitProp73.i, align 8
  br label %cleanup.thread

if.else:                                          ; preds = %if.then37
  %18 = load i32, ptr %needInitDic81, align 8
  %tobool43.not = icmp eq i32 %18, 0
  br i1 %tobool43.not, label %cleanup.thread, label %cleanup165.thread288

cleanup.thread:                                   ; preds = %if.then42, %if.else
  store i32 0, ptr %needInitDic81, align 8
  call void @LzmaDec_InitDicAndState(ptr noundef nonnull %p, i32 noundef %conv41, i32 noundef 0) #5
  %.pre282 = load i64, ptr %srcSizeCur, align 8
  br label %if.end49

if.end49:                                         ; preds = %cleanup.thread, %if.end33
  %19 = phi i64 [ %.pre282, %cleanup.thread ], [ %sub19, %if.end33 ]
  %cmp50 = icmp ugt i64 %19, %spec.select256
  br i1 %cmp50, label %if.then52, label %if.end53

if.then52:                                        ; preds = %if.end49
  store i64 %spec.select256, ptr %srcSizeCur, align 8
  br label %if.end53

if.end53:                                         ; preds = %if.then52, %if.end49
  %20 = phi i64 [ %spec.select256, %if.then52 ], [ %19, %if.end49 ]
  %cmp54 = icmp eq i64 %20, 0
  br i1 %cmp54, label %cleanup165.thread288, label %if.end57

if.end57:                                         ; preds = %if.end53
  %21 = load ptr, ptr %dic.i, align 8
  %22 = load i64, ptr %dicPos1, align 8
  %add.ptr.i = getelementptr inbounds i8, ptr %21, i64 %22
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %add.ptr.i, ptr align 1 %src.addr.0277, i64 %20, i1 false)
  %23 = load i64, ptr %dicPos1, align 8
  %add.i258 = add i64 %23, %20
  store i64 %add.i258, ptr %dicPos1, align 8
  %24 = load i32, ptr %checkDicSize.i, align 4
  %cmp.i259 = icmp eq i32 %24, 0
  br i1 %cmp.i259, label %land.lhs.true.i, label %entry.if.end_crit_edge.i

entry.if.end_crit_edge.i:                         ; preds = %if.end57
  %.pre.i = load i32, ptr %processedPos8.phi.trans.insert.i, align 8
  br label %LzmaDec_UpdateWithUncompressed.exit

land.lhs.true.i:                                  ; preds = %if.end57
  %25 = load i32, ptr %dicSize.i, align 4
  %26 = load i32, ptr %processedPos8.phi.trans.insert.i, align 8
  %sub.i = sub i32 %25, %26
  %conv.i261 = zext i32 %sub.i to i64
  %cmp2.not.i = icmp ult i64 %20, %conv.i261
  br i1 %cmp2.not.i, label %LzmaDec_UpdateWithUncompressed.exit, label %if.then.i

if.then.i:                                        ; preds = %land.lhs.true.i
  store i32 %25, ptr %checkDicSize.i, align 4
  br label %LzmaDec_UpdateWithUncompressed.exit
...
LzmaDec_UpdateWithUncompressed.exit:              ; preds = %entry.if.end_crit_edge.i, %land.lhs.true.i, %if.then.i
  ...
  store i32 %add9.i, ptr %processedPos8.phi.trans.insert.i, align 8
  %28 = load i64, ptr %srcSizeCur, align 8
  %add.ptr = getelementptr inbounds i8, ptr %src.addr.0277, i64 %28
  %29 = load i64, ptr %srcLen, align 8
  %add = add i64 %29, %28
  store i64 %add, ptr %srcLen, align 8
  %conv59 = trunc i64 %28 to i32
  %30 = load i32, ptr %unpackSize26.i, align 4
  %sub61 = sub i32 %30, %conv59
  store i32 %sub61, ptr %unpackSize26.i, align 4
...
land.lhs.true80:                                  ; preds = %if.then70
  %33 = load i32, ptr %needInitDic81, align 8
  %tobool82.not = icmp eq i32 %33, 0
  br i1 %tobool82.not, label %lor.lhs.false, label %cleanup165.thread288

lor.lhs.false:                                    ; preds = %land.lhs.true80
  br i1 %cmp77, label %cleanup93, label %land.lhs.true84

land.lhs.true84:                                  ; preds = %lor.lhs.false
  %34 = load i32, ptr %needInitState85, align 4
  %tobool86.not = icmp eq i32 %34, 0
  br i1 %tobool86.not, label %cleanup93, label %cleanup165.thread288
...
cleanup93:                                        ; preds = %if.then70, %lor.lhs.false, %land.lhs.true84
  ...
  store i32 0, ptr %needInitDic81, align 8
  store i32 0, ptr %needInitState85, align 4
  store i32 7, ptr %state, align 8
  %.pre = load i64, ptr %srcSizeCur, align 8
  br label %if.end98

if.end98:                                         ; preds = %cleanup93, %if.else66
  %35 = phi i64 [ %.pre, %cleanup93 ], [ %sub19, %if.else66 ]
  %36 = load i32, ptr %packSize39.i, align 8
  %conv99 = zext i32 %36 to i64
  %cmp100 = icmp ugt i64 %35, %conv99
  br i1 %cmp100, label %if.then102, label %if.end105

if.then102:                                       ; preds = %if.end98
  store i64 %conv99, ptr %srcSizeCur, align 8
  br label %if.end105

if.end105:                                        ; preds = %if.then102, %if.end98
  %add107 = add i64 %spec.select256, %3
  %call108 = call i32 @LzmaDec_DecodeToDic(ptr noundef nonnull %p, i64 noundef %add107, ptr noundef %src.addr.0277, ptr noundef nonnull %srcSizeCur, i32 noundef %spec.select, ptr noundef nonnull %status) #5
  %37 = load i64, ptr %srcSizeCur, align 8
  %add.ptr109 = getelementptr inbounds i8, ptr %src.addr.0277, i64 %37
  %38 = load i64, ptr %srcLen, align 8
  %add110 = add i64 %38, %37
  store i64 %add110, ptr %srcLen, align 8
  %conv111 = trunc i64 %37 to i32
  %39 = load i32, ptr %packSize39.i, align 8
  %sub113 = sub i32 %39, %conv111
  store i32 %sub113, ptr %packSize39.i, align 8
  %40 = load i64, ptr %dicPos1, align 8
  %sub116.neg = sub i64 %3, %40
  %conv117.neg = trunc i64 %sub116.neg to i32
  %41 = load i32, ptr %unpackSize26.i, align 4
  %sub119 = add i32 %41, %conv117.neg
  store i32 %sub119, ptr %unpackSize26.i, align 4
  %cmp120.not = icmp eq i32 %call108, 0
  br i1 %cmp120.not, label %cleanup.cont126, label %cleanup165.thread288

cleanup.cont126:                                  ; preds = %if.end105
  %42 = load i32, ptr %status, align 4
  %cmp127 = icmp eq i32 %42, 3
  br i1 %cmp127, label %cleanup165.thread288, label %if.end130

if.end130:                                        ; preds = %cleanup.cont126
  %cmp131 = icmp eq i64 %37, 0
  %cmp134 = icmp eq i64 %40, %3
...
if.then136:                                       ; preds = %if.end130
  ...
  %or.cond274 = select i1 %cmp137.not, i1 %cmp141.not, i1 false
  %cmp145.not = icmp eq i32 %39, %conv111
  %or.cond275 = select i1 %or.cond274, i1 %cmp145.not, i1 false
  br i1 %or.cond275, label %if.end148, label %cleanup165.thread288

if.end148:                                        ; preds = %if.then136
  store i32 0, ptr %state, align 8
  %.pre281 = load i32, ptr %status, align 4
  br label %if.end150

if.end150:                                        ; preds = %if.end148, %if.end130
  %43 = phi i32 [ %.pre281, %if.end148 ], [ %42, %if.end130 ]
...
cleanup165.thread288:                             ; preds = %if.end53, %if.else, %if.end105, %cleanup.cont126, %if.then136, %land.lhs.true84, %land.lhs.true80, %if.then32
...
cleanup165:                                       ; preds = %LzmaDec_UpdateWithUncompressed.exit, %if.end150, %if.then153
  %src.addr.3 = phi ptr [ %add.ptr, %LzmaDec_UpdateWithUncompressed.exit ], [ %add.ptr109, %if.then153 ], [ %add.ptr109, %if.end150 ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %srcSizeCur) #5
...
while.cond.backedge:                              ; preds = %cleanup165, %cleanup165.thread
  ...
  %src.addr.4286 = phi ptr [ %src.addr.3, %cleanup165 ], [ %incdec.ptr, %cleanup165.thread ]
...
cleanup168:                                       ; preds = %while.body, %cleanup165.thread288, %if.then15, %if.then6, %while.end
  %retval.10 = phi i32 [ 0, %while.end ], [ 0, %if.then15 ], [ 0, %if.then6 ], [ %retval.8.ph, %cleanup165.thread288 ], [ 1, %while.body ]
  ret i32 %retval.10
}
...
for.cond:                                         ; preds = %cleanup, %entry
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %srcSizeCur) #5
  store i64 %inSize.0, ptr %srcSizeCur, align 8
...
if.end:                                           ; preds = %if.then, %for.cond
  ...
  %5 = load i64, ptr %srcSizeCur, align 8
  %6 = load i64, ptr %srcLen, align 8
  %add15 = add i64 %6, %5
  store i64 %add15, ptr %srcLen, align 8
  ...
  store i64 %add23, ptr %destLen, align 8
...
entry:
  ...
  store i64 %0, ptr %dicBufSize, align 8
  %conv.i = zext i8 %prop to i32
  %cmp.i = icmp ugt i8 %prop, 40
...
cleanup.cont15:                                   ; preds = %cleanup.cont
  store i64 %1, ptr %srcLen, align 8
