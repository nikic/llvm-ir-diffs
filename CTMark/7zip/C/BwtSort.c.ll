; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/BwtSort.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/BwtSort.c"
...
entry:
  %Indices670 = ptrtoint ptr %Indices to i64
  %cmp510 = icmp ult i32 %groupSize, 2
  br i1 %cmp510, label %cleanup215, label %if.end.lr.ph
...
if.end:                                           ; preds = %if.end.lr.ph, %for.end204
  %range.tr515 = phi i32 [ %range, %if.end.lr.ph ], [ %sub209, %for.end204 ]
  %left.tr514 = phi i32 [ %left, %if.end.lr.ph ], [ %add128, %for.end204 ]
  %groupSize.tr513 = phi i32 [ %groupSize, %if.end.lr.ph ], [ %sub207, %for.end204 ]
  %groupOffset.tr512 = phi i32 [ %groupOffset, %if.end.lr.ph ], [ %add197, %for.end204 ]
  %accumulator.tr511 = phi i32 [ 0, %if.end.lr.ph ], [ %or211, %for.end204 ]
  %idx.ext508.pn = zext i32 %groupOffset.tr512 to i64
  %add.ptr516 = getelementptr inbounds i32, ptr %Indices, i64 %idx.ext508.pn
  %cmp4.not = icmp ult i32 %shl, %groupSize.tr513
  %cmp5.not = icmp ugt i32 %groupSize.tr513, %range.tr515
  %or.cond = or i1 %cmp4.not, %cmp5.not
  %0 = load i32, ptr %add.ptr516, align 4
  ...
  %1 = load i32, ptr %arrayidx94, align 4
  br i1 %or.cond, label %for.body97.preheader, label %for.body.preheader

for.body.preheader:                               ; preds = %if.end
  %shl13 = shl i32 %1, %NumRefBits
  store i32 %shl13, ptr %add.ptr2, align 4
  %wide.trip.count572 = zext i32 %groupSize.tr513 to i64
  %2 = add nsw i64 %wide.trip.count572, -1
  %xtraiter729 = and i64 %2, 1
  %3 = icmp eq i32 %groupSize.tr513, 2
...
for.body:                                         ; preds = %for.body, %for.body.preheader.new
  %indvars.iv569 = phi i64 [ 1, %for.body.preheader.new ], [ %indvars.iv.next570.1, %for.body ]
  %gRes.0519 = phi i32 [ 0, %for.body.preheader.new ], [ %or29.1, %for.body ]
  %niter = phi i64 [ 0, %for.body.preheader.new ], [ %niter.next.1, %for.body ]
  %arrayidx18 = getelementptr inbounds i32, ptr %add.ptr516, i64 %indvars.iv569
  ...
  %6 = trunc i64 %indvars.iv569 to i32
  %or = or i32 %shl26, %6
  %arrayidx28 = getelementptr inbounds i32, ptr %add.ptr2, i64 %indvars.iv569
  store i32 %or, ptr %arrayidx28, align 4
  %xor = xor i32 %5, %1
  %or29 = or i32 %xor, %gRes.0519
  %indvars.iv.next570 = add nuw nsw i64 %indvars.iv569, 1
  %arrayidx18.1 = getelementptr inbounds i32, ptr %add.ptr516, i64 %indvars.iv.next570
  ...
  %8 = load i32, ptr %arrayidx25.1, align 4
  %shl26.1 = shl i32 %8, %NumRefBits
  %9 = trunc i64 %indvars.iv.next570 to i32
  %or.1 = or i32 %shl26.1, %9
  %arrayidx28.1 = getelementptr inbounds i32, ptr %add.ptr2, i64 %indvars.iv.next570
  store i32 %or.1, ptr %arrayidx28.1, align 4
  %xor.1 = xor i32 %8, %1
  %or29.1 = or i32 %xor.1, %or29
  %indvars.iv.next570.1 = add nuw nsw i64 %indvars.iv569, 2
...
for.end.unr-lcssa:                                ; preds = %for.body, %for.body.preheader
  ...
  %indvars.iv569.unr = phi i64 [ 1, %for.body.preheader ], [ %indvars.iv.next570.1, %for.body ]
  %gRes.0519.unr = phi i32 [ 0, %for.body.preheader ], [ %or29.1, %for.body ]
  %lcmp.mod730.not = icmp eq i64 %xtraiter729, 0
  br i1 %lcmp.mod730.not, label %for.end, label %for.body.epil

for.body.epil:                                    ; preds = %for.end.unr-lcssa
  %arrayidx18.epil = getelementptr inbounds i32, ptr %add.ptr516, i64 %indvars.iv569.unr
  ...
  %11 = load i32, ptr %arrayidx25.epil, align 4
  %shl26.epil = shl i32 %11, %NumRefBits
  %12 = trunc i64 %indvars.iv569.unr to i32
  %or.epil = or i32 %shl26.epil, %12
  %arrayidx28.epil = getelementptr inbounds i32, ptr %add.ptr2, i64 %indvars.iv569.unr
  store i32 %or.epil, ptr %arrayidx28.epil, align 4
  %xor.epil = xor i32 %11, %1
  %or29.epil = or i32 %xor.epil, %gRes.0519.unr
  br label %for.end
...
if.then31:                                        ; preds = %for.end
  %dec.i = add i32 %groupSize.tr513, -1
  %and.i = shl i32 %dec.i, 20
  %shl.i = and i32 %and.i, 1072693248
  %14 = load i32, ptr %add.ptr516, align 4
  %or.i = or i32 %14, %shl.i
  %or1.i = or i32 %or.i, -2147483648
  store i32 %or1.i, ptr %add.ptr516, align 4
...
for.body43.preheader:                             ; preds = %for.end
  tail call void @HeapSort(ptr noundef nonnull %add.ptr2, i32 noundef %groupSize.tr513) #4
  %sub35 = add nsw i32 %shl, -1
  %15 = load i32, ptr %add.ptr2, align 4
  %and = and i32 %15, %sub35
  %idxprom38 = zext i32 %and to i64
  %arrayidx39 = getelementptr inbounds i32, ptr %add.ptr516, i64 %idxprom38
  %16 = load i32, ptr %arrayidx39, align 4
  store i32 %16, ptr %add.ptr2, align 4
  %shr = lshr i32 %15, %NumRefBits
  %wide.trip.count577 = zext i32 %groupSize.tr513 to i64
  br label %for.body43

for.body43:                                       ; preds = %for.body43.preheader, %if.end53
  %indvars.iv574 = phi i64 [ 1, %for.body43.preheader ], [ %indvars.iv.next575, %if.end53 ]
  %thereAreGroups.0526 = phi i32 [ 0, %for.body43.preheader ], [ %thereAreGroups.1, %if.end53 ]
  %prevGroupStart.0525 = phi i32 [ 0, %for.body43.preheader ], [ %prevGroupStart.1, %if.end53 ]
  %group.0524 = phi i32 [ %groupOffset.tr512, %for.body43.preheader ], [ %group.1, %if.end53 ]
  %cg.0523 = phi i32 [ %shr, %for.body43.preheader ], [ %cg.1, %if.end53 ]
  %arrayidx45 = getelementptr inbounds i32, ptr %add.ptr2, i64 %indvars.iv574
  %17 = load i32, ptr %arrayidx45, align 4
  %shr46 = lshr i32 %17, %NumRefBits
  %cmp47.not = icmp eq i32 %shr46, %cg.0523
  br i1 %cmp47.not, label %if.end53, label %if.then48

if.then48:                                        ; preds = %for.body43
  %18 = trunc i64 %indvars.iv574 to i32
  %add49 = add i32 %groupOffset.tr512, %18
  %idx.ext50 = zext i32 %prevGroupStart.0525 to i64
  %add.ptr51 = getelementptr inbounds i32, ptr %add.ptr2, i64 %idx.ext50
  %19 = xor i32 %prevGroupStart.0525, -1
  %dec.i395 = add i32 %18, %19
  %cmp.i396 = icmp eq i32 %dec.i395, 0
  br i1 %cmp.i396, label %if.end53, label %if.end.i397

if.end.i397:                                      ; preds = %if.then48
  %and.i398 = shl i32 %dec.i395, 20
  %shl.i399 = and i32 %and.i398, 1072693248
  %20 = load i32, ptr %add.ptr51, align 4
  %or.i400 = or i32 %20, %shl.i399
  %or1.i401 = or i32 %or.i400, -2147483648
  store i32 %or1.i401, ptr %add.ptr51, align 4
  %cmp2.i402 = icmp ugt i32 %dec.i395, 1023
  br i1 %cmp2.i402, label %if.then3.i403, label %if.end53

if.then3.i403:                                    ; preds = %if.end.i397
  %or4.i404 = or i32 %or.i400, -1073741824
  store i32 %or4.i404, ptr %add.ptr51, align 4
  %21 = shl i32 %dec.i395, 10
  %shl5.i405 = and i32 %21, -1048576
  %arrayidx.i406 = getelementptr inbounds i32, ptr %add.ptr51, i64 1
  %22 = load i32, ptr %arrayidx.i406, align 4
  %or6.i407 = or i32 %22, %shl5.i405
  store i32 %or6.i407, ptr %arrayidx.i406, align 4
  br label %if.end53

if.end53:                                         ; preds = %if.then3.i403, %if.end.i397, %if.then48, %for.body43
  %cg.1 = phi i32 [ %cg.0523, %for.body43 ], [ %shr46, %if.then48 ], [ %shr46, %if.end.i397 ], [ %shr46, %if.then3.i403 ]
  %group.1 = phi i32 [ %group.0524, %for.body43 ], [ %add49, %if.then48 ], [ %add49, %if.end.i397 ], [ %add49, %if.then3.i403 ]
  %prevGroupStart.1 = phi i32 [ %prevGroupStart.0525, %for.body43 ], [ %18, %if.then48 ], [ %18, %if.end.i397 ], [ %18, %if.then3.i403 ]
  %thereAreGroups.1 = phi i32 [ 1, %for.body43 ], [ %thereAreGroups.0526, %if.then48 ], [ %thereAreGroups.0526, %if.end.i397 ], [ %thereAreGroups.0526, %if.then3.i403 ]
  %and54 = and i32 %17, %sub35
  %idxprom55 = zext i32 %and54 to i64
  %arrayidx56 = getelementptr inbounds i32, ptr %add.ptr516, i64 %idxprom55
  ...
  store i32 %group.1, ptr %arrayidx60, align 4
  %indvars.iv.next575 = add nuw nsw i64 %indvars.iv574, 1
  %exitcond578.not = icmp eq i64 %indvars.iv.next575, %wide.trip.count577
  br i1 %exitcond578.not, label %for.end63, label %for.body43
...
for.end63:                                        ; preds = %if.end53
  ...
  %dec.i409 = add i32 %groupSize.tr513, %24
  %cmp.i410 = icmp eq i32 %dec.i409, 0
  br i1 %cmp.i410, label %SetGroupSize.exit422, label %if.end.i411

if.end.i411:                                      ; preds = %for.end63
  %and.i412 = shl i32 %dec.i409, 20
  %shl.i413 = and i32 %and.i412, 1072693248
  %25 = load i32, ptr %add.ptr65, align 4
  %or.i414 = or i32 %25, %shl.i413
  %or1.i415 = or i32 %or.i414, -2147483648
  store i32 %or1.i415, ptr %add.ptr65, align 4
  %cmp2.i416 = icmp ugt i32 %dec.i409, 1023
  br i1 %cmp2.i416, label %if.then3.i417, label %SetGroupSize.exit422

if.then3.i417:                                    ; preds = %if.end.i411
  %or4.i418 = or i32 %or.i414, -1073741824
  store i32 %or4.i418, ptr %add.ptr65, align 4
  %26 = shl i32 %dec.i409, 10
  %shl5.i419 = and i32 %26, -1048576
  %arrayidx.i420 = getelementptr inbounds i32, ptr %add.ptr65, i64 1
  %27 = load i32, ptr %arrayidx.i420, align 4
  %or6.i421 = or i32 %27, %shl5.i419
  store i32 %or6.i421, ptr %arrayidx.i420, align 4
  br label %SetGroupSize.exit422

SetGroupSize.exit422:                             ; preds = %for.end63, %if.end.i411, %if.then3.i417
  %umax = tail call i32 @llvm.umax.i32(i32 %groupSize.tr513, i32 1)
  %wide.trip.count582 = zext i32 %umax to i64
  %min.iters.check = icmp ult i32 %groupSize.tr513, 16
  br i1 %min.iters.check, label %for.body69.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %SetGroupSize.exit422
  %28 = zext i32 %groupOffset.tr512 to i64
  %29 = shl nuw nsw i64 %28, 2
  %30 = add i64 %29, %Indices670
  %31 = shl nuw nsw i64 %idx.ext1, 2
  %32 = add i64 %31, %Indices670
  %33 = sub i64 %30, %32
  %diff.check = icmp ult i64 %33, 32
  br i1 %diff.check, label %for.body69.preheader, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %wide.trip.count582, 4294967288
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %34 = getelementptr inbounds i32, ptr %add.ptr2, i64 %index
  %wide.load = load <4 x i32>, ptr %34, align 4
  %35 = getelementptr inbounds i32, ptr %34, i64 4
  %wide.load677 = load <4 x i32>, ptr %35, align 4
  %36 = getelementptr inbounds i32, ptr %add.ptr516, i64 %index
  store <4 x i32> %wide.load, ptr %36, align 4
  %37 = getelementptr inbounds i32, ptr %36, i64 4
  store <4 x i32> %wide.load677, ptr %37, align 4
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %cleanup215, label %for.body69.preheader

for.body69.preheader:                             ; preds = %vector.memcheck, %SetGroupSize.exit422, %middle.block
  %indvars.iv579.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %SetGroupSize.exit422 ], [ %n.vec, %middle.block ]
  %39 = xor i64 %indvars.iv579.ph, -1
  %40 = add nsw i64 %39, %wide.trip.count582
  %xtraiter732 = and i64 %wide.trip.count582, 3
  %lcmp.mod733.not = icmp eq i64 %xtraiter732, 0
  br i1 %lcmp.mod733.not, label %for.body69.prol.loopexit, label %for.body69.prol

for.body69.prol:                                  ; preds = %for.body69.preheader, %for.body69.prol
  %indvars.iv579.prol = phi i64 [ %indvars.iv.next580.prol, %for.body69.prol ], [ %indvars.iv579.ph, %for.body69.preheader ]
  %prol.iter734 = phi i64 [ %prol.iter734.next, %for.body69.prol ], [ 0, %for.body69.preheader ]
  %arrayidx71.prol = getelementptr inbounds i32, ptr %add.ptr2, i64 %indvars.iv579.prol
  %41 = load i32, ptr %arrayidx71.prol, align 4
  %arrayidx73.prol = getelementptr inbounds i32, ptr %add.ptr516, i64 %indvars.iv579.prol
  store i32 %41, ptr %arrayidx73.prol, align 4
  %indvars.iv.next580.prol = add nuw nsw i64 %indvars.iv579.prol, 1
  %prol.iter734.next = add i64 %prol.iter734, 1
  %prol.iter734.cmp.not = icmp eq i64 %prol.iter734.next, %xtraiter732
  br i1 %prol.iter734.cmp.not, label %for.body69.prol.loopexit, label %for.body69.prol

for.body69.prol.loopexit:                         ; preds = %for.body69.prol, %for.body69.preheader
  %indvars.iv579.unr = phi i64 [ %indvars.iv579.ph, %for.body69.preheader ], [ %indvars.iv.next580.prol, %for.body69.prol ]
  %42 = icmp ult i64 %40, 3
  br i1 %42, label %cleanup215, label %for.body69

for.body69:                                       ; preds = %for.body69.prol.loopexit, %for.body69
  %indvars.iv579 = phi i64 [ %indvars.iv.next580.3, %for.body69 ], [ %indvars.iv579.unr, %for.body69.prol.loopexit ]
  %arrayidx71 = getelementptr inbounds i32, ptr %add.ptr2, i64 %indvars.iv579
  %43 = load i32, ptr %arrayidx71, align 4
  %arrayidx73 = getelementptr inbounds i32, ptr %add.ptr516, i64 %indvars.iv579
  store i32 %43, ptr %arrayidx73, align 4
  %indvars.iv.next580 = add nuw nsw i64 %indvars.iv579, 1
  %arrayidx71.1 = getelementptr inbounds i32, ptr %add.ptr2, i64 %indvars.iv.next580
  %44 = load i32, ptr %arrayidx71.1, align 4
  %arrayidx73.1 = getelementptr inbounds i32, ptr %add.ptr516, i64 %indvars.iv.next580
  store i32 %44, ptr %arrayidx73.1, align 4
  %indvars.iv.next580.1 = add nuw nsw i64 %indvars.iv579, 2
  %arrayidx71.2 = getelementptr inbounds i32, ptr %add.ptr2, i64 %indvars.iv.next580.1
  %45 = load i32, ptr %arrayidx71.2, align 4
  %arrayidx73.2 = getelementptr inbounds i32, ptr %add.ptr516, i64 %indvars.iv.next580.1
  store i32 %45, ptr %arrayidx73.2, align 4
  %indvars.iv.next580.2 = add nuw nsw i64 %indvars.iv579, 3
  %arrayidx71.3 = getelementptr inbounds i32, ptr %add.ptr2, i64 %indvars.iv.next580.2
  %46 = load i32, ptr %arrayidx71.3, align 4
  %arrayidx73.3 = getelementptr inbounds i32, ptr %add.ptr516, i64 %indvars.iv.next580.2
  store i32 %46, ptr %arrayidx73.3, align 4
  %indvars.iv.next580.3 = add nuw nsw i64 %indvars.iv579, 4
  %exitcond583.not.3 = icmp eq i64 %indvars.iv.next580.3, %wide.trip.count582
  br i1 %exitcond583.not.3, label %cleanup215, label %for.body69

for.body97.preheader:                             ; preds = %if.end
  %wide.trip.count = zext i32 %groupSize.tr513 to i64
  br label %for.body97

for.body97:                                       ; preds = %for.body97.preheader, %for.inc110
  %indvars.iv = phi i64 [ 1, %for.body97.preheader ], [ %indvars.iv.next, %for.inc110 ]
  %arrayidx99 = getelementptr inbounds i32, ptr %add.ptr516, i64 %indvars.iv
  ...
  %48 = load i32, ptr %arrayidx106, align 4
...
for.inc110:                                       ; preds = %for.body97
  ...
  br i1 %exitcond.not, label %if.then114, label %for.body97

for.end112:                                       ; preds = %for.body97
  %49 = trunc i64 %indvars.iv to i32
  %cmp113.not = icmp eq i32 %groupSize.tr513, %49
  br i1 %cmp113.not, label %if.then114, label %for.cond121.preheader

for.cond121.preheader:                            ; preds = %for.end112
  %cmp123662 = icmp ult i32 %range.tr515, 2
  br i1 %cmp123662, label %if.then124, label %if.end125

if.then114:                                       ; preds = %for.end112, %for.inc110
  %dec.i423 = add i32 %groupSize.tr513, -1
  %and.i426 = shl i32 %dec.i423, 20
  %shl.i427 = and i32 %and.i426, 1072693248
  %or.i428 = or i32 %0, %shl.i427
  %or1.i429 = or i32 %or.i428, -2147483648
  store i32 %or1.i429, ptr %add.ptr516, align 4
  %cmp2.i430 = icmp ugt i32 %dec.i423, 1023
  br i1 %cmp2.i430, label %cleanup215.sink.split, label %cleanup215

if.then124:                                       ; preds = %for.cond121.preheader, %cleanup189
  %dec.i437 = add i32 %groupSize.tr513, -1
  %and.i440 = shl i32 %dec.i437, 20
  %shl.i441 = and i32 %and.i440, 1072693248
  %50 = load i32, ptr %add.ptr516, align 4
  %or.i442 = or i32 %50, %shl.i441
  %or1.i443 = or i32 %or.i442, -2147483648
  store i32 %or1.i443, ptr %add.ptr516, align 4
  %cmp2.i444 = icmp ugt i32 %dec.i437, 1023
  br i1 %cmp2.i444, label %cleanup215.sink.split, label %cleanup215

if.end125:                                        ; preds = %for.cond121.preheader, %cleanup189
  %left.addr.0664 = phi i32 [ %left.addr.2, %cleanup189 ], [ %left.tr514, %for.cond121.preheader ]
  %range.addr.0663 = phi i32 [ %range.addr.2, %cleanup189 ], [ %range.tr515, %for.cond121.preheader ]
  %add126 = add i32 %range.addr.0663, 1
  %shr127 = lshr i32 %add126, 1
  %add128 = add i32 %shr127, %left.addr.0664
  br label %do.body

do.body:                                          ; preds = %do.cond, %if.end125
  %indvars.iv561 = phi i64 [ %indvars.iv.next562, %do.cond ], [ 0, %if.end125 ]
  %j122.0 = phi i32 [ %j122.3.ph, %do.cond ], [ %groupSize.tr513, %if.end125 ]
  %arrayidx131 = getelementptr inbounds i32, ptr %add.ptr516, i64 %indvars.iv561
  %51 = load i32, ptr %arrayidx131, align 4
  ...
  %52 = load i32, ptr %arrayidx138, align 4
...
for.cond141:                                      ; preds = %do.body, %for.body143
  ...
  %cmp142 = icmp ult i64 %indvars.iv561, %53
  br i1 %cmp142, label %for.body143, label %do.end

for.body143:                                      ; preds = %for.cond141
  %arrayidx145 = getelementptr inbounds i32, ptr %add.ptr516, i64 %53
  %54 = load i32, ptr %arrayidx145, align 4
  ...
  %55 = load i32, ptr %arrayidx152, align 4
  %cmp153 = icmp ult i32 %55, %add128
  br i1 %cmp153, label %select.unfold, label %for.cond141

select.unfold:                                    ; preds = %for.body143
  %arrayidx145.le = getelementptr inbounds i32, ptr %add.ptr516, i64 %53
  store i32 %54, ptr %arrayidx131, align 4
  store i32 %51, ptr %arrayidx145.le, align 4
  br label %do.cond

do.cond:                                          ; preds = %do.body.do.cond_crit_edge, %select.unfold
  %.pre-phi = phi i64 [ %.pre, %do.body.do.cond_crit_edge ], [ %53, %select.unfold ]
  %j122.3.ph = phi i32 [ %j122.0, %do.body.do.cond_crit_edge ], [ %j122.1, %select.unfold ]
  %indvars.iv.next562 = add nuw nsw i64 %indvars.iv561, 1
  %cmp177 = icmp ult i64 %indvars.iv.next562, %.pre-phi
  br i1 %cmp177, label %do.body, label %if.else182.loopexit

do.end:                                           ; preds = %for.cond141
  %56 = trunc i64 %indvars.iv561 to i32
  %cmp178 = icmp eq i32 %56, 0
  br i1 %cmp178, label %if.then179, label %if.else182

if.then179:                                       ; preds = %do.end
  %sub181 = sub i32 %range.addr.0663, %shr127
  br label %cleanup189

if.else182.loopexit:                              ; preds = %do.cond
  %57 = trunc i64 %indvars.iv.next562 to i32
  br label %if.else182

if.else182:                                       ; preds = %if.else182.loopexit, %do.end
  %i.2457 = phi i32 [ %56, %do.end ], [ %57, %if.else182.loopexit ]
  %cmp183 = icmp eq i32 %i.2457, %groupSize.tr513
  br i1 %cmp183, label %cleanup189, label %for.cond194.preheader

cleanup189:                                       ; preds = %if.else182, %if.then179
  %range.addr.2 = phi i32 [ %sub181, %if.then179 ], [ %shr127, %if.else182 ]
  %left.addr.2 = phi i32 [ %add128, %if.then179 ], [ %left.addr.0664, %if.else182 ]
  %cmp123 = icmp ult i32 %range.addr.2, 2
  br i1 %cmp123, label %if.then124, label %if.end125

for.cond194.preheader:                            ; preds = %if.else182
  %cmp195506 = icmp ult i32 %i.2457, %groupSize.tr513
  %add197 = add i32 %i.2457, %groupOffset.tr512
  br i1 %cmp195506, label %for.body196.lr.ph, label %for.end204

for.body196.lr.ph:                                ; preds = %for.cond194.preheader
  %58 = zext i32 %i.2457 to i64
  %wide.trip.count567 = zext i32 %groupSize.tr513 to i64
  %59 = sub nsw i64 %wide.trip.count, %58
  %60 = xor i64 %58, -1
...
for.body196.prol:                                 ; preds = %for.body196.lr.ph, %for.body196.prol
  %indvars.iv564.prol = phi i64 [ %indvars.iv.next565.prol, %for.body196.prol ], [ %58, %for.body196.lr.ph ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body196.prol ], [ 0, %for.body196.lr.ph ]
  %arrayidx199.prol = getelementptr inbounds i32, ptr %add.ptr516, i64 %indvars.iv564.prol
  %62 = load i32, ptr %arrayidx199.prol, align 4
  %idxprom200.prol = zext i32 %62 to i64
  %arrayidx201.prol = getelementptr inbounds i32, ptr %add.ptr3, i64 %idxprom200.prol
  store i32 %add197, ptr %arrayidx201.prol, align 4
  %indvars.iv.next565.prol = add nuw nsw i64 %indvars.iv564.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body196.prol.loopexit, label %for.body196.prol

for.body196.prol.loopexit:                        ; preds = %for.body196.prol, %for.body196.lr.ph
  %indvars.iv564.unr = phi i64 [ %58, %for.body196.lr.ph ], [ %indvars.iv.next565.prol, %for.body196.prol ]
  %63 = icmp ult i64 %61, 3
  br i1 %63, label %for.end204, label %for.body196

for.body196:                                      ; preds = %for.body196.prol.loopexit, %for.body196
  %indvars.iv564 = phi i64 [ %indvars.iv.next565.3, %for.body196 ], [ %indvars.iv564.unr, %for.body196.prol.loopexit ]
  %arrayidx199 = getelementptr inbounds i32, ptr %add.ptr516, i64 %indvars.iv564
  %64 = load i32, ptr %arrayidx199, align 4
  %idxprom200 = zext i32 %64 to i64
  %arrayidx201 = getelementptr inbounds i32, ptr %add.ptr3, i64 %idxprom200
  store i32 %add197, ptr %arrayidx201, align 4
  %indvars.iv.next565 = add nuw nsw i64 %indvars.iv564, 1
  %arrayidx199.1 = getelementptr inbounds i32, ptr %add.ptr516, i64 %indvars.iv.next565
  %65 = load i32, ptr %arrayidx199.1, align 4
  %idxprom200.1 = zext i32 %65 to i64
  %arrayidx201.1 = getelementptr inbounds i32, ptr %add.ptr3, i64 %idxprom200.1
  store i32 %add197, ptr %arrayidx201.1, align 4
  %indvars.iv.next565.1 = add nuw nsw i64 %indvars.iv564, 2
  %arrayidx199.2 = getelementptr inbounds i32, ptr %add.ptr516, i64 %indvars.iv.next565.1
  %66 = load i32, ptr %arrayidx199.2, align 4
  %idxprom200.2 = zext i32 %66 to i64
  %arrayidx201.2 = getelementptr inbounds i32, ptr %add.ptr3, i64 %idxprom200.2
  store i32 %add197, ptr %arrayidx201.2, align 4
  %indvars.iv.next565.2 = add nuw nsw i64 %indvars.iv564, 3
  %arrayidx199.3 = getelementptr inbounds i32, ptr %add.ptr516, i64 %indvars.iv.next565.2
  %67 = load i32, ptr %arrayidx199.3, align 4
  %idxprom200.3 = zext i32 %67 to i64
  %arrayidx201.3 = getelementptr inbounds i32, ptr %add.ptr3, i64 %idxprom200.3
  store i32 %add197, ptr %arrayidx201.3, align 4
  %indvars.iv.next565.3 = add nuw nsw i64 %indvars.iv564, 4
  %exitcond568.not.3 = icmp eq i64 %indvars.iv.next565.3, %wide.trip.count567
  br i1 %exitcond568.not.3, label %for.end204, label %for.body196

for.end204:                                       ; preds = %for.body196.prol.loopexit, %for.body196, %for.cond194.preheader
  %call = tail call i32 @SortGroup(i32 noundef %BlockSize, i32 noundef %NumSortedBytes, i32 noundef %groupOffset.tr512, i32 noundef %i.2457, i32 noundef %NumRefBits, ptr noundef %Indices, i32 noundef %left.addr.0664, i32 noundef %shr127)
  %sub207 = sub i32 %groupSize.tr513, %i.2457
  %sub209 = sub i32 %range.addr.0663, %shr127
  %or211 = or i32 %call, %accumulator.tr511
...
cleanup215.sink.split:                            ; preds = %if.then124, %if.then114, %if.then31
  %or.i.sink = phi i32 [ %or.i, %if.then31 ], [ %or.i428, %if.then114 ], [ %or.i442, %if.then124 ]
  %dec.i.sink = phi i32 [ %dec.i, %if.then31 ], [ %dec.i423, %if.then114 ], [ %dec.i437, %if.then124 ]
  %or4.i = or i32 %or.i.sink, -1073741824
  store i32 %or4.i, ptr %add.ptr516, align 4
  %68 = shl i32 %dec.i.sink, 10
  %shl5.i = and i32 %68, -1048576
  %arrayidx.i = getelementptr inbounds i32, ptr %add.ptr516, i64 1
  %69 = load i32, ptr %arrayidx.i, align 4
  %or6.i449 = or i32 %69, %shl5.i
  store i32 %or6.i449, ptr %arrayidx.i, align 4
  br label %cleanup215

cleanup215:                                       ; preds = %for.end204, %for.body69.prol.loopexit, %for.body69, %middle.block, %cleanup215.sink.split, %entry, %if.then124, %if.then114, %if.then31
  %accumulator.tr490 = phi i32 [ %accumulator.tr511, %if.then31 ], [ %accumulator.tr511, %if.then114 ], [ %accumulator.tr511, %if.then124 ], [ 0, %entry ], [ %accumulator.tr511, %cleanup215.sink.split ], [ %accumulator.tr511, %middle.block ], [ %accumulator.tr511, %for.body69 ], [ %accumulator.tr511, %for.body69.prol.loopexit ], [ %or211, %for.end204 ]
  %retval.6 = phi i32 [ 1, %if.then31 ], [ 1, %if.then114 ], [ 1, %if.then124 ], [ 0, %entry ], [ 1, %cleanup215.sink.split ], [ %thereAreGroups.1, %middle.block ], [ %thereAreGroups.1, %for.body69 ], [ %thereAreGroups.1, %for.body69.prol.loopexit ], [ 0, %for.end204 ]
  %accumulator.ret.tr = or i32 %retval.6, %accumulator.tr490
...
entry:
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(262144) %add.ptr, i8 0, i64 262144, i1 false)
...
for.body3:                                        ; preds = %for.body3, %for.body3.preheader.new
  ...
  %5 = load i8, ptr %arrayidx7.1, align 1
  %conv8.1 = zext i8 %5 to i64
  %or.1 = or i64 %shl.1, %conv8.1
  %arrayidx10.1 = getelementptr inbounds i32, ptr %add.ptr, i64 %or.1
  %6 = load i32, ptr %arrayidx10.1, align 4
  %inc11.1 = add i32 %6, 1
  store i32 %inc11.1, ptr %arrayidx10.1, align 4
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %for.end14.loopexit.unr-lcssa, label %for.body3
...
for.body3.epil:                                   ; preds = %for.end14.loopexit.unr-lcssa
  ...
  %7 = load i8, ptr %arrayidx5.epil, align 1
  ...
  %8 = load i8, ptr %arrayidx7.epil, align 1
  ...
  %9 = load i32, ptr %arrayidx10.epil, align 4
  %inc11.epil = add i32 %9, 1
  store i32 %inc11.epil, ptr %arrayidx10.epil, align 4
...
for.end61.thread:                                 ; preds = %for.cond41.preheader
  ...
  %15 = load i32, ptr %arrayidx70497, align 4
  store i32 %15, ptr %add.ptr25, align 4
  br label %for.end94
...
for.body45:                                       ; preds = %for.body45, %for.body45.preheader.new
  ...
  %22 = load i8, ptr %arrayidx47, align 1
  ...
  store i32 %24, ptr %arrayidx58, align 4
  %arrayidx47.1 = getelementptr inbounds i8, ptr %data, i64 %indvars.iv.next473
  %25 = load i8, ptr %arrayidx47.1, align 1
...
for.body45.epil:                                  ; preds = %for.end61.unr-lcssa
  ...
  %28 = load i8, ptr %arrayidx47.epil, align 1
  ...
  %29 = load i8, ptr %arrayidx52.epil, align 1
  ...
  %30 = load i32, ptr %arrayidx56.epil, align 4
  %arrayidx58.epil = getelementptr inbounds i32, ptr %add.ptr25, i64 %indvars.iv472.unr
  store i32 %30, ptr %arrayidx58.epil, align 4
  br label %for.end61
...
for.end61:                                        ; preds = %for.end61.unr-lcssa, %for.body45.epil
  ...
  %34 = load i32, ptr %arrayidx70, align 4
  %arrayidx72 = getelementptr inbounds i32, ptr %add.ptr25, i64 %31
  store i32 %34, ptr %arrayidx72, align 4
...
for.body77:                                       ; preds = %for.body77, %for.body77.preheader.new
  ...
  %38 = load i32, ptr %arrayidx88, align 4
  %inc89 = add i32 %38, 1
  store i32 %inc89, ptr %arrayidx88, align 4
  ...
  store i32 %39, ptr %arrayidx91, align 4
  %arrayidx79.1 = getelementptr inbounds i8, ptr %data, i64 %indvars.iv.next478
  %40 = load i8, ptr %arrayidx79.1, align 1
  ...
  store i32 %43, ptr %arrayidx91.1, align 4
  %niter506.next.1 = add i64 %niter506, 2
  %niter506.ncmp.1 = icmp eq i64 %niter506.next.1, %unroll_iter505
  br i1 %niter506.ncmp.1, label %for.end94.loopexit.unr-lcssa, label %for.body77
...
for.body77.epil:                                  ; preds = %for.end94.loopexit.unr-lcssa
  ...
  %44 = load i8, ptr %arrayidx79.epil, align 1
  ...
  %45 = load i8, ptr %arrayidx84.epil, align 1
  ...
  %46 = load i32, ptr %arrayidx88.epil, align 4
  %inc89.epil = add i32 %46, 1
  store i32 %inc89.epil, ptr %arrayidx88.epil, align 4
  ...
  store i32 %47, ptr %arrayidx91.epil, align 4
  br label %for.end94
...
for.end94:                                        ; preds = %for.body77.epil, %for.end94.loopexit.unr-lcssa, %for.end61, %for.end61.thread
  ...
  %50 = load i32, ptr %arrayidx103, align 4
  %inc104 = add i32 %50, 1
  ...
  store i32 %sub, ptr %arrayidx106, align 4
...
for.body110:                                      ; preds = %for.end94, %cleanup
  ...
  %51 = load i32, ptr %arrayidx112, align 4
...
if.end.i:                                         ; preds = %if.end117
  %and.i = shl i32 %dec.i, 20
  %shl.i = and i32 %and.i, 1072693248
  %53 = load i32, ptr %add.ptr119, align 4
  %or.i = or i32 %53, %shl.i
  %or1.i = or i32 %or.i, -2147483648
  store i32 %or1.i, ptr %add.ptr119, align 4
  %cmp2.i = icmp ugt i32 %dec.i, 1023
  br i1 %cmp2.i, label %if.then3.i, label %SetGroupSize.exit

if.then3.i:                                       ; preds = %if.end.i
  %or4.i = or i32 %or.i, -1073741824
  store i32 %or4.i, ptr %add.ptr119, align 4
  %54 = shl i32 %dec.i, 10
...
cleanup:                                          ; preds = %for.body110, %SetGroupSize.exit
  ...
  br i1 %exitcond485.not, label %for.cond125, label %for.body110
...
for.cond125:                                      ; preds = %cleanup, %for.cond125
  ...
  br i1 %cmp127.not, label %for.end132, label %for.cond125
...
for.body142.us:                                   ; preds = %for.cond138.us, %cleanup245.us
  ...
  %57 = load i32, ptr %arrayidx145.us, align 4
...
if.end168.us:                                     ; preds = %if.then157.us, %for.body142.us
  ...
  store i32 %and171.us, ptr %arrayidx145.us, align 4
...
if.then175.us:                                    ; preds = %if.end168.us
  ...
  %60 = load i32, ptr %arrayidx178.us, align 4
  %and179.us = and i32 %60, 1048575
  store i32 %and179.us, ptr %arrayidx178.us, align 4
...
if.then182.us:                                    ; preds = %if.then175.us
  ...
  %61 = load i32, ptr %arrayidx186.us, align 4
  %and187.us = and i32 %61, 1048575
  store i32 %and187.us, ptr %arrayidx186.us, align 4
...
if.end188.us:                                     ; preds = %if.then182.us, %if.then175.us
  ...
  %62 = load i32, ptr %add.ptr196.us, align 4
  %or197.us = or i32 %62, %shl192.us
  store i32 %or197.us, ptr %add.ptr196.us, align 4
...
for.body229.us:                                   ; preds = %for.body229.us, %for.body229.us.preheader.new
  ...
  br i1 %niter510.ncmp.3, label %cleanup245.us.loopexit.unr-lcssa, label %for.body229.us
...
for.body229.us.epil:                              ; preds = %cleanup245.us.loopexit.unr-lcssa, %for.body229.us.epil
  ...
  br i1 %epil.iter.cmp.not, label %cleanup245.us, label %for.body229.us.epil
...
for.body263:                                      ; preds = %for.cond260.preheader, %if.end285
  ...
  %79 = load i32, ptr %arrayidx266, align 4
...
if.end285:                                        ; preds = %for.body263, %if.then274
  ...
  store i32 %and288, ptr %arrayidx266, align 4
...
for.end291:                                       ; preds = %if.end285, %for.end132, %for.cond260.preheader
  %82 = load i32, ptr %add.ptr25, align 4
  ret i32 %82
}
