...
for.body.preheader:                               ; preds = %if.end
  ...
  %wide.trip.count567 = zext i32 %groupSize.tr508 to i64
  %2 = add nsw i64 %wide.trip.count567, -1
...
for.body:                                         ; preds = %for.body, %for.body.preheader.new
  %indvars.iv564 = phi i64 [ 1, %for.body.preheader.new ], [ %indvars.iv.next565.1, %for.body ]
  %gRes.0514 = phi i32 [ 0, %for.body.preheader.new ], [ %or29.1, %for.body ]
  %niter = phi i64 [ 0, %for.body.preheader.new ], [ %niter.next.1, %for.body ]
  %arrayidx18 = getelementptr inbounds i32, ptr %add.ptr511, i64 %indvars.iv564
  ...
  %6 = trunc i64 %indvars.iv564 to i32
  %or = or i32 %shl26, %6
  %arrayidx28 = getelementptr inbounds i32, ptr %add.ptr2, i64 %indvars.iv564
  store i32 %or, ptr %arrayidx28, align 4, !tbaa !5
  %xor = xor i32 %5, %1
  %or29 = or i32 %xor, %gRes.0514
  %indvars.iv.next565 = add nuw nsw i64 %indvars.iv564, 1
  %arrayidx18.1 = getelementptr inbounds i32, ptr %add.ptr511, i64 %indvars.iv.next565
  ...
  %9 = trunc i64 %indvars.iv.next565 to i32
  %or.1 = or i32 %shl26.1, %9
  %arrayidx28.1 = getelementptr inbounds i32, ptr %add.ptr2, i64 %indvars.iv.next565
...
for.end.unr-lcssa:                                ; preds = %for.body, %for.body.preheader
  ...
  %indvars.iv564.unr = phi i64 [ 1, %for.body.preheader ], [ %indvars.iv.next565.1, %for.body ]
...
for.body.epil:                                    ; preds = %for.end.unr-lcssa
  %arrayidx18.epil = getelementptr inbounds i32, ptr %add.ptr511, i64 %indvars.iv564.unr
  ...
  %12 = trunc i64 %indvars.iv564.unr to i32
  %or.epil = or i32 %shl26.epil, %12
  %arrayidx28.epil = getelementptr inbounds i32, ptr %add.ptr2, i64 %indvars.iv564.unr
...
for.body43.preheader:                             ; preds = %for.end
  ...
  %wide.trip.count572 = zext i32 %groupSize.tr508 to i64
  br label %for.body43

for.body43:                                       ; preds = %for.body43.preheader, %if.end53
  %indvars.iv569 = phi i64 [ 1, %for.body43.preheader ], [ %indvars.iv.next570, %if.end53 ]
  ...
  %arrayidx45 = getelementptr inbounds i32, ptr %add.ptr2, i64 %indvars.iv569
...
if.then48:                                        ; preds = %for.body43
  %18 = trunc i64 %indvars.iv569 to i32
  ...
  br i1 %cmp.i393, label %if.end53, label %if.end.i394

if.end.i394:                                      ; preds = %if.then48
  %and.i395 = shl i32 %dec.i392, 20
  %shl.i396 = and i32 %and.i395, 1072693248
  %20 = load i32, ptr %add.ptr51, align 4, !tbaa !5
  %or.i397 = or i32 %20, %shl.i396
  %or1.i398 = or i32 %or.i397, -2147483648
  store i32 %or1.i398, ptr %add.ptr51, align 4, !tbaa !5
  %cmp2.i399 = icmp ugt i32 %dec.i392, 1023
  br i1 %cmp2.i399, label %if.then3.i400, label %if.end53

if.then3.i400:                                    ; preds = %if.end.i394
  %or4.i401 = or i32 %or.i397, -1073741824
  store i32 %or4.i401, ptr %add.ptr51, align 4, !tbaa !5
  %21 = shl i32 %dec.i392, 10
  %shl5.i402 = and i32 %21, -1048576
  %arrayidx.i403 = getelementptr inbounds i32, ptr %add.ptr51, i64 1
  %22 = load i32, ptr %arrayidx.i403, align 4, !tbaa !5
  %or6.i404 = or i32 %22, %shl5.i402
  store i32 %or6.i404, ptr %arrayidx.i403, align 4, !tbaa !5
  br label %if.end53

if.end53:                                         ; preds = %if.then3.i400, %if.end.i394, %if.then48, %for.body43
  %cg.1 = phi i32 [ %cg.0518, %for.body43 ], [ %shr46, %if.then48 ], [ %shr46, %if.end.i394 ], [ %shr46, %if.then3.i400 ]
  %group.1 = phi i32 [ %group.0519, %for.body43 ], [ %add49, %if.then48 ], [ %add49, %if.end.i394 ], [ %add49, %if.then3.i400 ]
  %prevGroupStart.1 = phi i32 [ %prevGroupStart.0520, %for.body43 ], [ %18, %if.then48 ], [ %18, %if.end.i394 ], [ %18, %if.then3.i400 ]
  %thereAreGroups.1 = phi i32 [ 1, %for.body43 ], [ %thereAreGroups.0521, %if.then48 ], [ %thereAreGroups.0521, %if.end.i394 ], [ %thereAreGroups.0521, %if.then3.i400 ]
  ...
  br i1 %exitcond573.not, label %for.end63, label %for.body43, !llvm.loop !11
...
for.end63:                                        ; preds = %if.end53
  ...
  br i1 %cmp.i407, label %SetGroupSize.exit419, label %if.end.i408

if.end.i408:                                      ; preds = %for.end63
  %and.i409 = shl i32 %dec.i406, 20
  %shl.i410 = and i32 %and.i409, 1072693248
  %25 = load i32, ptr %add.ptr65, align 4, !tbaa !5
  %or.i411 = or i32 %25, %shl.i410
  %or1.i412 = or i32 %or.i411, -2147483648
  store i32 %or1.i412, ptr %add.ptr65, align 4, !tbaa !5
  %cmp2.i413 = icmp ugt i32 %dec.i406, 1023
  br i1 %cmp2.i413, label %if.then3.i414, label %SetGroupSize.exit419

if.then3.i414:                                    ; preds = %if.end.i408
  %or4.i415 = or i32 %or.i411, -1073741824
  store i32 %or4.i415, ptr %add.ptr65, align 4, !tbaa !5
  %26 = shl i32 %dec.i406, 10
  %shl5.i416 = and i32 %26, -1048576
  %arrayidx.i417 = getelementptr inbounds i32, ptr %add.ptr65, i64 1
  %27 = load i32, ptr %arrayidx.i417, align 4, !tbaa !5
  %or6.i418 = or i32 %27, %shl5.i416
  store i32 %or6.i418, ptr %arrayidx.i417, align 4, !tbaa !5
  br label %SetGroupSize.exit419

SetGroupSize.exit419:                             ; preds = %for.end63, %if.end.i408, %if.then3.i414
  %umax = tail call i32 @llvm.umax.i32(i32 %groupSize.tr508, i32 1)
  %wide.trip.count577 = zext i32 %umax to i64
  %min.iters.check = icmp ult i32 %groupSize.tr508, 16
  br i1 %min.iters.check, label %for.body69.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %SetGroupSize.exit419
...
vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %wide.trip.count577, 4294967288
...
middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.vec, %wide.trip.count577
  br i1 %cmp.n, label %cleanup215, label %for.body69.preheader

for.body69.preheader:                             ; preds = %vector.memcheck, %SetGroupSize.exit419, %middle.block
  %indvars.iv574.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %SetGroupSize.exit419 ], [ %n.vec, %middle.block ]
  %39 = xor i64 %indvars.iv574.ph, -1
  %40 = add nsw i64 %39, %wide.trip.count577
  %xtraiter727 = and i64 %wide.trip.count577, 3
...
for.body69.prol:                                  ; preds = %for.body69.preheader, %for.body69.prol
  %indvars.iv574.prol = phi i64 [ %indvars.iv.next575.prol, %for.body69.prol ], [ %indvars.iv574.ph, %for.body69.preheader ]
  %prol.iter729 = phi i64 [ %prol.iter729.next, %for.body69.prol ], [ 0, %for.body69.preheader ]
  %arrayidx71.prol = getelementptr inbounds i32, ptr %add.ptr2, i64 %indvars.iv574.prol
  %41 = load i32, ptr %arrayidx71.prol, align 4, !tbaa !5
  %arrayidx73.prol = getelementptr inbounds i32, ptr %add.ptr511, i64 %indvars.iv574.prol
  store i32 %41, ptr %arrayidx73.prol, align 4, !tbaa !5
  %indvars.iv.next575.prol = add nuw nsw i64 %indvars.iv574.prol, 1
...
for.body69.prol.loopexit:                         ; preds = %for.body69.prol, %for.body69.preheader
  %indvars.iv574.unr = phi i64 [ %indvars.iv574.ph, %for.body69.preheader ], [ %indvars.iv.next575.prol, %for.body69.prol ]
  %42 = icmp ult i64 %40, 3
  br i1 %42, label %cleanup215, label %for.body69

for.body69:                                       ; preds = %for.body69.prol.loopexit, %for.body69
  %indvars.iv574 = phi i64 [ %indvars.iv.next575.3, %for.body69 ], [ %indvars.iv574.unr, %for.body69.prol.loopexit ]
  %arrayidx71 = getelementptr inbounds i32, ptr %add.ptr2, i64 %indvars.iv574
  %43 = load i32, ptr %arrayidx71, align 4, !tbaa !5
  %arrayidx73 = getelementptr inbounds i32, ptr %add.ptr511, i64 %indvars.iv574
  store i32 %43, ptr %arrayidx73, align 4, !tbaa !5
  %indvars.iv.next575 = add nuw nsw i64 %indvars.iv574, 1
  %arrayidx71.1 = getelementptr inbounds i32, ptr %add.ptr2, i64 %indvars.iv.next575
  %44 = load i32, ptr %arrayidx71.1, align 4, !tbaa !5
  %arrayidx73.1 = getelementptr inbounds i32, ptr %add.ptr511, i64 %indvars.iv.next575
  store i32 %44, ptr %arrayidx73.1, align 4, !tbaa !5
  %indvars.iv.next575.1 = add nuw nsw i64 %indvars.iv574, 2
  %arrayidx71.2 = getelementptr inbounds i32, ptr %add.ptr2, i64 %indvars.iv.next575.1
  %45 = load i32, ptr %arrayidx71.2, align 4, !tbaa !5
  %arrayidx73.2 = getelementptr inbounds i32, ptr %add.ptr511, i64 %indvars.iv.next575.1
  store i32 %45, ptr %arrayidx73.2, align 4, !tbaa !5
  %indvars.iv.next575.2 = add nuw nsw i64 %indvars.iv574, 3
  %arrayidx71.3 = getelementptr inbounds i32, ptr %add.ptr2, i64 %indvars.iv.next575.2
  %46 = load i32, ptr %arrayidx71.3, align 4, !tbaa !5
  %arrayidx73.3 = getelementptr inbounds i32, ptr %add.ptr511, i64 %indvars.iv.next575.2
  store i32 %46, ptr %arrayidx73.3, align 4, !tbaa !5
  %indvars.iv.next575.3 = add nuw nsw i64 %indvars.iv574, 4
  %exitcond578.not.3 = icmp eq i64 %indvars.iv.next575.3, %wide.trip.count577
  br i1 %exitcond578.not.3, label %cleanup215, label %for.body69, !llvm.loop !17
...
if.then114:                                       ; preds = %for.end112, %for.inc110
  ...
  %and.i423 = shl i32 %dec.i420, 20
  %shl.i424 = and i32 %and.i423, 1072693248
  %or.i425 = or i32 %0, %shl.i424
  %or1.i426 = or i32 %or.i425, -2147483648
  store i32 %or1.i426, ptr %add.ptr511, align 4, !tbaa !5
  %cmp2.i427 = icmp ugt i32 %dec.i420, 1023
  br i1 %cmp2.i427, label %cleanup215.sink.split, label %cleanup215

if.then124:                                       ; preds = %for.cond121.preheader, %cleanup189
  %dec.i434 = add i32 %groupSize.tr508, -1
  %and.i437 = shl i32 %dec.i434, 20
  %shl.i438 = and i32 %and.i437, 1072693248
  %50 = load i32, ptr %add.ptr511, align 4, !tbaa !5
  %or.i439 = or i32 %50, %shl.i438
  %or1.i440 = or i32 %or.i439, -2147483648
  store i32 %or1.i440, ptr %add.ptr511, align 4, !tbaa !5
  %cmp2.i441 = icmp ugt i32 %dec.i434, 1023
  br i1 %cmp2.i441, label %cleanup215.sink.split, label %cleanup215
...
do.body:                                          ; preds = %do.cond, %if.end125
  %indvars.iv556 = phi i64 [ %indvars.iv.next557, %do.cond ], [ 0, %if.end125 ]
  %j122.0 = phi i32 [ %j122.3.ph, %do.cond ], [ %groupSize.tr508, %if.end125 ]
  %arrayidx131 = getelementptr inbounds i32, ptr %add.ptr511, i64 %indvars.iv556
...
for.cond141:                                      ; preds = %do.body, %for.body143
  ...
  %cmp142 = icmp ult i64 %indvars.iv556, %53
...
for.end168.thread:                                ; preds = %for.body143
  %arrayidx145.le = getelementptr inbounds i32, ptr %add.ptr511, i64 %53
...
if.else182.loopexit:                              ; preds = %do.cond
  %57 = trunc i64 %indvars.iv.next557 to i32
  br label %if.else182

if.else182:                                       ; preds = %if.else182.loopexit, %do.end
  %i.2454 = phi i32 [ %56, %do.end ], [ %57, %if.else182.loopexit ]
  %cmp183 = icmp eq i32 %i.2454, %groupSize.tr508
...
for.cond194.preheader:                            ; preds = %if.else182
  %cmp195501 = icmp ult i32 %i.2454, %groupSize.tr508
...
for.body196.lr.ph:                                ; preds = %for.cond194.preheader
  %58 = zext i32 %i.2454 to i64
  %wide.trip.count562 = zext i32 %groupSize.tr508 to i64
...
for.body196.prol:                                 ; preds = %for.body196.lr.ph, %for.body196.prol
  %indvars.iv559.prol = phi i64 [ %indvars.iv.next560.prol, %for.body196.prol ], [ %58, %for.body196.lr.ph ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body196.prol ], [ 0, %for.body196.lr.ph ]
  %arrayidx199.prol = getelementptr inbounds i32, ptr %add.ptr511, i64 %indvars.iv559.prol
  %62 = load i32, ptr %arrayidx199.prol, align 4, !tbaa !5
  ...
  %indvars.iv.next560.prol = add nuw nsw i64 %indvars.iv559.prol, 1
...
for.body196.prol.loopexit:                        ; preds = %for.body196.prol, %for.body196.lr.ph
  %indvars.iv559.unr = phi i64 [ %58, %for.body196.lr.ph ], [ %indvars.iv.next560.prol, %for.body196.prol ]
  %63 = icmp ult i64 %61, 3
  br i1 %63, label %for.end204, label %for.body196

for.body196:                                      ; preds = %for.body196.prol.loopexit, %for.body196
  %indvars.iv559 = phi i64 [ %indvars.iv.next560.3, %for.body196 ], [ %indvars.iv559.unr, %for.body196.prol.loopexit ]
  %arrayidx199 = getelementptr inbounds i32, ptr %add.ptr511, i64 %indvars.iv559
  %64 = load i32, ptr %arrayidx199, align 4, !tbaa !5
  ...
  %arrayidx199.1 = getelementptr inbounds i32, ptr %add.ptr511, i64 %indvars.iv.next560
  %65 = load i32, ptr %arrayidx199.1, align 4, !tbaa !5
  ...
  %indvars.iv.next560.1 = add nuw nsw i64 %indvars.iv559, 2
  %arrayidx199.2 = getelementptr inbounds i32, ptr %add.ptr511, i64 %indvars.iv.next560.1
  %66 = load i32, ptr %arrayidx199.2, align 4, !tbaa !5
  ...
  %indvars.iv.next560.2 = add nuw nsw i64 %indvars.iv559, 3
  %arrayidx199.3 = getelementptr inbounds i32, ptr %add.ptr511, i64 %indvars.iv.next560.2
  %67 = load i32, ptr %arrayidx199.3, align 4, !tbaa !5
  ...
  %indvars.iv.next560.3 = add nuw nsw i64 %indvars.iv559, 4
  %exitcond563.not.3 = icmp eq i64 %indvars.iv.next560.3, %wide.trip.count562
  br i1 %exitcond563.not.3, label %for.end204, label %for.body196, !llvm.loop !22
...
cleanup215.sink.split:                            ; preds = %if.then124, %if.then114, %if.then31
  %or.i.sink = phi i32 [ %or.i, %if.then31 ], [ %or.i425, %if.then114 ], [ %or.i439, %if.then124 ]
  ...
  %or6.i446 = or i32 %69, %shl5.i
  store i32 %or6.i446, ptr %arrayidx.i, align 4, !tbaa !5
  br label %cleanup215
...
cleanup215:                                       ; preds = %for.end204, %for.body69.prol.loopexit, %for.body69, %middle.block, %cleanup215.sink.split, %entry, %if.then124, %if.then114, %if.then31
  %accumulator.tr485 = phi i32 [ %accumulator.tr506, %if.then31 ], [ %accumulator.tr506, %if.then114 ], [ %accumulator.tr506, %if.then124 ], [ 0, %entry ], [ %accumulator.tr506, %cleanup215.sink.split ], [ %accumulator.tr506, %middle.block ], [ %accumulator.tr506, %for.body69 ], [ %accumulator.tr506, %for.body69.prol.loopexit ], [ %or211, %for.end204 ]
