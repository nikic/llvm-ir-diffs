...
while.body.i446:                                  ; preds = %RangeEnc_ShiftLow.exit.i465, %while.body.lr.ph.i442
  ...
  store i32 %shl.i447, ptr %Range.i438, align 8, !tbaa !12
...
entry.if.end_crit_edge.i.i471:                    ; preds = %while.body.i446
  %.pre.i.i472 = load i64, ptr %CacheSize.i.i445, align 8, !tbaa !14
  %32 = add i64 %.pre.i.i472, 1
  br label %RangeEnc_ShiftLow.exit.i465

if.then.i.i449:                                   ; preds = %while.body.i446
  %33 = load i8, ptr %Cache.i.i443, align 4, !tbaa !13
  %34 = load ptr, ptr %Stream.i.i444, align 8, !tbaa !15
  ...
  %36 = load i64, ptr %CacheSize.i.i445, align 8, !tbaa !14
  %dec.peel.i.i453 = add i64 %36, -1
  store i64 %dec.peel.i.i453, ptr %CacheSize.i.i445, align 8, !tbaa !14
...
do.body.i.i455:                                   ; preds = %if.then.i.i449, %do.body.i.i455
  %37 = load ptr, ptr %Stream.i.i444, align 8, !tbaa !15
  ...
  %40 = load i64, ptr %CacheSize.i.i445, align 8, !tbaa !14
  %dec.i.i459 = add i64 %40, -1
  store i64 %dec.i.i459, ptr %CacheSize.i.i445, align 8, !tbaa !14
  %cmp13.not.i.i460 = icmp eq i64 %dec.i.i459, 0
  br i1 %cmp13.not.i.i460, label %do.end.i.i461, label %do.body.i.i455, !llvm.loop !18
...
do.end.i.i461:                                    ; preds = %do.body.i.i455, %if.then.i.i449
  ...
  store i8 %conv18.i.i463, ptr %Cache.i.i443, align 4, !tbaa !13
  %.pr.pre.i464 = load i32, ptr %Range.i438, align 8, !tbaa !12
  br label %RangeEnc_ShiftLow.exit.i465
...
RangeEnc_ShiftLow.exit.i465:                      ; preds = %do.end.i.i461, %entry.if.end_crit_edge.i.i471
  ...
  store i64 %inc.i.i467, ptr %CacheSize.i.i445, align 8, !tbaa !14
  %shl.i.i468 = shl i64 %42, 8
  %conv23.i.i469 = and i64 %shl.i.i468, 4294967040
  store i64 %conv23.i.i469, ptr %rc, align 8, !tbaa !5
  %cmp.i470 = icmp ult i32 %.pr.i466, 16777216
  br i1 %cmp.i470, label %while.body.i446, label %RangeEnc_Encode.exit473, !llvm.loop !33
...
while.body.i485:                                  ; preds = %RangeEnc_ShiftLow.exit.i504, %while.body.lr.ph.i481
  ...
  store i32 %shl.i486, ptr %Range.i474, align 8, !tbaa !12
...
entry.if.end_crit_edge.i.i510:                    ; preds = %while.body.i485
  %.pre.i.i511 = load i64, ptr %CacheSize.i.i484, align 8, !tbaa !14
  %59 = add i64 %.pre.i.i511, 1
  br label %RangeEnc_ShiftLow.exit.i504

if.then.i.i488:                                   ; preds = %while.body.i485
  %60 = load i8, ptr %Cache.i.i482, align 4, !tbaa !13
  %61 = load ptr, ptr %Stream.i.i483, align 8, !tbaa !15
  ...
  %63 = load i64, ptr %CacheSize.i.i484, align 8, !tbaa !14
  %dec.peel.i.i492 = add i64 %63, -1
  store i64 %dec.peel.i.i492, ptr %CacheSize.i.i484, align 8, !tbaa !14
...
do.body.i.i494:                                   ; preds = %if.then.i.i488, %do.body.i.i494
  %64 = load ptr, ptr %Stream.i.i483, align 8, !tbaa !15
  ...
  %67 = load i64, ptr %CacheSize.i.i484, align 8, !tbaa !14
  %dec.i.i498 = add i64 %67, -1
  store i64 %dec.i.i498, ptr %CacheSize.i.i484, align 8, !tbaa !14
  %cmp13.not.i.i499 = icmp eq i64 %dec.i.i498, 0
  br i1 %cmp13.not.i.i499, label %do.end.i.i500, label %do.body.i.i494, !llvm.loop !18
...
do.end.i.i500:                                    ; preds = %do.body.i.i494, %if.then.i.i488
  ...
  store i8 %conv18.i.i502, ptr %Cache.i.i482, align 4, !tbaa !13
  %.pr.pre.i503 = load i32, ptr %Range.i474, align 8, !tbaa !12
  br label %RangeEnc_ShiftLow.exit.i504
...
RangeEnc_ShiftLow.exit.i504:                      ; preds = %do.end.i.i500, %entry.if.end_crit_edge.i.i510
  ...
  store i64 %inc.i.i506, ptr %CacheSize.i.i484, align 8, !tbaa !14
  %shl.i.i507 = shl i64 %69, 8
  %conv23.i.i508 = and i64 %shl.i.i507, 4294967040
  store i64 %conv23.i.i508, ptr %rc, align 8, !tbaa !5
  %cmp.i509 = icmp ult i32 %.pr.i505, 16777216
  br i1 %cmp.i509, label %while.body.i485, label %if.end198, !llvm.loop !33
...
while.body.i519:                                  ; preds = %RangeEnc_ShiftLow.exit.i538, %while.body.lr.ph.i515
  ...
  store i32 %shl.i520, ptr %Range.i513, align 8, !tbaa !12
...
entry.if.end_crit_edge.i.i544:                    ; preds = %while.body.i519
  %.pre.i.i545 = load i64, ptr %CacheSize.i.i518, align 8, !tbaa !14
  %88 = add i64 %.pre.i.i545, 1
  br label %RangeEnc_ShiftLow.exit.i538

if.then.i.i522:                                   ; preds = %while.body.i519
  %89 = load i8, ptr %Cache.i.i516, align 4, !tbaa !13
  %90 = load ptr, ptr %Stream.i.i517, align 8, !tbaa !15
  ...
  %92 = load i64, ptr %CacheSize.i.i518, align 8, !tbaa !14
  %dec.peel.i.i526 = add i64 %92, -1
  store i64 %dec.peel.i.i526, ptr %CacheSize.i.i518, align 8, !tbaa !14
...
do.body.i.i528:                                   ; preds = %if.then.i.i522, %do.body.i.i528
  %93 = load ptr, ptr %Stream.i.i517, align 8, !tbaa !15
  ...
  %96 = load i64, ptr %CacheSize.i.i518, align 8, !tbaa !14
  %dec.i.i532 = add i64 %96, -1
  store i64 %dec.i.i532, ptr %CacheSize.i.i518, align 8, !tbaa !14
  %cmp13.not.i.i533 = icmp eq i64 %dec.i.i532, 0
  br i1 %cmp13.not.i.i533, label %do.end.i.i534, label %do.body.i.i528, !llvm.loop !18
...
do.end.i.i534:                                    ; preds = %do.body.i.i528, %if.then.i.i522
  ...
  store i8 %conv18.i.i536, ptr %Cache.i.i516, align 4, !tbaa !13
  %.pr.pre.i537 = load i32, ptr %Range.i513, align 8, !tbaa !12
  br label %RangeEnc_ShiftLow.exit.i538
...
RangeEnc_ShiftLow.exit.i538:                      ; preds = %do.end.i.i534, %entry.if.end_crit_edge.i.i544
  ...
  store i64 %inc.i.i540, ptr %CacheSize.i.i518, align 8, !tbaa !14
  %shl.i.i541 = shl i64 %98, 8
  %conv23.i.i542 = and i64 %shl.i.i541, 4294967040
  store i64 %conv23.i.i542, ptr %rc, align 8, !tbaa !5
  %cmp.i543 = icmp ult i32 %.pr.i539, 16777216
  br i1 %cmp.i543, label %while.body.i519, label %RangeEnc_EncodeBit_0.exit.loopexit, !llvm.loop !47

RangeEnc_EncodeBit_0.exit.loopexit:               ; preds = %RangeEnc_ShiftLow.exit.i538
  %.pre706 = load i16, ptr %arrayidx124, align 2, !tbaa !46
...
while.body.i556:                                  ; preds = %RangeEnc_ShiftLow.exit.i575, %while.body.lr.ph.i552
  ...
  store i32 %shl.i557, ptr %Range.i513, align 8, !tbaa !12
...
entry.if.end_crit_edge.i.i581:                    ; preds = %while.body.i556
  %.pre.i.i582 = load i64, ptr %CacheSize.i.i555, align 8, !tbaa !14
  %103 = add i64 %.pre.i.i582, 1
  br label %RangeEnc_ShiftLow.exit.i575

if.then.i.i559:                                   ; preds = %while.body.i556
  %104 = load i8, ptr %Cache.i.i553, align 4, !tbaa !13
  %105 = load ptr, ptr %Stream.i.i554, align 8, !tbaa !15
  ...
  %107 = load i64, ptr %CacheSize.i.i555, align 8, !tbaa !14
  %dec.peel.i.i563 = add i64 %107, -1
  store i64 %dec.peel.i.i563, ptr %CacheSize.i.i555, align 8, !tbaa !14
...
do.body.i.i565:                                   ; preds = %if.then.i.i559, %do.body.i.i565
  %108 = load ptr, ptr %Stream.i.i554, align 8, !tbaa !15
  ...
  %111 = load i64, ptr %CacheSize.i.i555, align 8, !tbaa !14
  %dec.i.i569 = add i64 %111, -1
  store i64 %dec.i.i569, ptr %CacheSize.i.i555, align 8, !tbaa !14
  %cmp13.not.i.i570 = icmp eq i64 %dec.i.i569, 0
  br i1 %cmp13.not.i.i570, label %do.end.i.i571, label %do.body.i.i565, !llvm.loop !18
...
do.end.i.i571:                                    ; preds = %do.body.i.i565, %if.then.i.i559
  ...
  store i8 %conv18.i.i573, ptr %Cache.i.i553, align 4, !tbaa !13
  %.pr.pre.i574 = load i32, ptr %Range.i513, align 8, !tbaa !12
  br label %RangeEnc_ShiftLow.exit.i575
...
RangeEnc_ShiftLow.exit.i575:                      ; preds = %do.end.i.i571, %entry.if.end_crit_edge.i.i581
  ...
  store i64 %inc.i.i577, ptr %CacheSize.i.i555, align 8, !tbaa !14
  %shl.i.i578 = shl i64 %113, 8
  %conv23.i.i579 = and i64 %shl.i.i578, 4294967040
  store i64 %conv23.i.i579, ptr %rc, align 8, !tbaa !5
  %cmp.i580 = icmp ult i32 %.pr.i576, 16777216
  br i1 %cmp.i580, label %while.body.i556, label %RangeEnc_EncodeBit_1.exit.loopexit, !llvm.loop !48

RangeEnc_EncodeBit_1.exit.loopexit:               ; preds = %RangeEnc_ShiftLow.exit.i575
  %.pre = load i16, ptr %arrayidx124, align 2, !tbaa !46
  %.pre705 = load i8, ptr %SummFreq116, align 1, !tbaa !29
...
do.body239.prol:                                  ; preds = %do.body239.preheader
  ...
  %129 = load i8, ptr %Freq240.prol, align 1, !tbaa !31
  %130 = load i8, ptr %s200.0, align 1, !tbaa !29
  %idxprom244.prol = zext i8 %130 to i64
  %arrayidx245.prol = getelementptr inbounds i8, ptr %charMask, i64 %idxprom244.prol
  %131 = load i8, ptr %arrayidx245.prol, align 1, !tbaa !37
  %and247680.prol = and i8 %131, %129
...
while.body.i594:                                  ; preds = %do.end253, %RangeEnc_ShiftLow.exit.i613
  ...
  store i32 %shl.i595, ptr %Range.i583, align 8, !tbaa !12
...
entry.if.end_crit_edge.i.i619:                    ; preds = %while.body.i594
  %.pre.i.i620 = load i64, ptr %CacheSize.i.i593, align 8, !tbaa !14
  %148 = add i64 %.pre.i.i620, 1
  br label %RangeEnc_ShiftLow.exit.i613

if.then.i.i597:                                   ; preds = %while.body.i594
  %149 = load i8, ptr %Cache.i.i591, align 4, !tbaa !13
  %150 = load ptr, ptr %Stream.i.i592, align 8, !tbaa !15
  ...
  %152 = load i64, ptr %CacheSize.i.i593, align 8, !tbaa !14
  %dec.peel.i.i601 = add i64 %152, -1
  store i64 %dec.peel.i.i601, ptr %CacheSize.i.i593, align 8, !tbaa !14
...
do.body.i.i603:                                   ; preds = %if.then.i.i597, %do.body.i.i603
  %153 = load ptr, ptr %Stream.i.i592, align 8, !tbaa !15
  ...
  %156 = load i64, ptr %CacheSize.i.i593, align 8, !tbaa !14
  %dec.i.i607 = add i64 %156, -1
  store i64 %dec.i.i607, ptr %CacheSize.i.i593, align 8, !tbaa !14
  %cmp13.not.i.i608 = icmp eq i64 %dec.i.i607, 0
  br i1 %cmp13.not.i.i608, label %do.end.i.i609, label %do.body.i.i603, !llvm.loop !18
...
do.end.i.i609:                                    ; preds = %do.body.i.i603, %if.then.i.i597
  ...
  store i8 %conv18.i.i611, ptr %Cache.i.i591, align 4, !tbaa !13
  %.pr.pre.i612 = load i32, ptr %Range.i583, align 8, !tbaa !12
  br label %RangeEnc_ShiftLow.exit.i613
...
RangeEnc_ShiftLow.exit.i613:                      ; preds = %do.end.i.i609, %entry.if.end_crit_edge.i.i619
  ...
  store i64 %inc.i.i615, ptr %CacheSize.i.i593, align 8, !tbaa !14
  %shl.i.i616 = shl i64 %158, 8
  %conv23.i.i617 = and i64 %shl.i.i616, 4294967040
  store i64 %conv23.i.i617, ptr %rc, align 8, !tbaa !5
  %cmp.i618 = icmp ult i32 %.pr.i614, 16777216
  br i1 %cmp.i618, label %while.body.i594, label %RangeEnc_Encode.exit621, !llvm.loop !33
...
while.body.i633:                                  ; preds = %do.end296, %RangeEnc_ShiftLow.exit.i652
  ...
  store i32 %shl.i634, ptr %Range.i583, align 8, !tbaa !12
...
entry.if.end_crit_edge.i.i658:                    ; preds = %while.body.i633
  %.pre.i.i659 = load i64, ptr %CacheSize.i.i593, align 8, !tbaa !14
  %170 = add i64 %.pre.i.i659, 1
  br label %RangeEnc_ShiftLow.exit.i652

if.then.i.i636:                                   ; preds = %while.body.i633
  %171 = load i8, ptr %Cache.i.i591, align 4, !tbaa !13
  %172 = load ptr, ptr %Stream.i.i592, align 8, !tbaa !15
  ...
  %174 = load i64, ptr %CacheSize.i.i593, align 8, !tbaa !14
  %dec.peel.i.i640 = add i64 %174, -1
  store i64 %dec.peel.i.i640, ptr %CacheSize.i.i593, align 8, !tbaa !14
...
do.body.i.i642:                                   ; preds = %if.then.i.i636, %do.body.i.i642
  %175 = load ptr, ptr %Stream.i.i592, align 8, !tbaa !15
  ...
  %178 = load i64, ptr %CacheSize.i.i593, align 8, !tbaa !14
  %dec.i.i646 = add i64 %178, -1
  store i64 %dec.i.i646, ptr %CacheSize.i.i593, align 8, !tbaa !14
  %cmp13.not.i.i647 = icmp eq i64 %dec.i.i646, 0
  br i1 %cmp13.not.i.i647, label %do.end.i.i648, label %do.body.i.i642, !llvm.loop !18
...
do.end.i.i648:                                    ; preds = %do.body.i.i642, %if.then.i.i636
  ...
  store i8 %conv18.i.i650, ptr %Cache.i.i591, align 4, !tbaa !13
  %.pr.pre.i651 = load i32, ptr %Range.i583, align 8, !tbaa !12
  br label %RangeEnc_ShiftLow.exit.i652
...
RangeEnc_ShiftLow.exit.i652:                      ; preds = %do.end.i.i648, %entry.if.end_crit_edge.i.i658
  ...
  store i64 %inc.i.i654, ptr %CacheSize.i.i593, align 8, !tbaa !14
  %shl.i.i655 = shl i64 %180, 8
  %conv23.i.i656 = and i64 %shl.i.i655, 4294967040
  store i64 %conv23.i.i656, ptr %rc, align 8, !tbaa !5
  %cmp.i657 = icmp ult i32 %.pr.i653, 16777216
  br i1 %cmp.i657, label %while.body.i633, label %RangeEnc_Encode.exit660.loopexit, !llvm.loop !33

RangeEnc_Encode.exit660.loopexit:                 ; preds = %RangeEnc_ShiftLow.exit.i652
  %.pre707 = load i32, ptr %escFreq, align 4, !tbaa !53
