...
if.end12:                                         ; preds = %for.body
  ...
  %6 = load i8, ptr %arrayidx22.1, align 1, !tbaa !5
  ...
  %7 = load i8, ptr %arrayidx22.2, align 1, !tbaa !5
  ...
  %9 = load i8, ptr %arrayidx22.3, align 1, !tbaa !5
  ...
  %10 = load i8, ptr %arrayidx22.4, align 1, !tbaa !5
  ...
  %12 = load i8, ptr %arrayidx22.5, align 1, !tbaa !5
...
if.then35:                                        ; preds = %if.end12
  ...
  store i8 %6, ptr %arrayidx22.1, align 1, !tbaa !5
...
if.end12.1:                                       ; preds = %cleanup
  ...
  %20 = load i8, ptr %arrayidx22.2.1, align 1, !tbaa !5
  ...
  %22 = load i8, ptr %arrayidx22.3.1, align 1, !tbaa !5
  ...
  %23 = load i8, ptr %arrayidx22.4.1, align 1, !tbaa !5
  ...
  %25 = load i8, ptr %arrayidx22.5.1, align 1, !tbaa !5
...
if.then35.1:                                      ; preds = %if.end12.1
  ...
  store i8 %19, ptr %arrayidx22.1.1, align 1, !tbaa !5
...
if.end12.2:                                       ; preds = %cleanup.1
  ...
  %33 = load i8, ptr %arrayidx22.2.2, align 1, !tbaa !5
  ...
  %35 = load i8, ptr %arrayidx22.3.2, align 1, !tbaa !5
  ...
  %36 = load i8, ptr %arrayidx22.4.2, align 1, !tbaa !5
  ...
  %38 = load i8, ptr %arrayidx22.5.2, align 1, !tbaa !5
...
if.then35.2:                                      ; preds = %if.end12.2
  ...
  store i8 %32, ptr %arrayidx22.1.2, align 1, !tbaa !5
