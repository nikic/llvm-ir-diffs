; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/Bra.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/Bra.c"
...
if.then5.us:                                      ; preds = %for.body.us
  ...
  %2 = load i8, ptr %arrayidx10.us, align 1
  ...
  %3 = load i8, ptr %arrayidx14.us, align 1
...
if.then5:                                         ; preds = %for.body
  ...
  store i8 %conv31, ptr %arrayidx10, align 1
  %conv34 = trunc i32 %shr to i8
  store i8 %conv34, ptr %arrayidx14, align 1
  br label %for.inc
...
if.then11.us:                                     ; preds = %land.lhs.true.us
  ...
  %2 = load i8, ptr %arrayidx17.us, align 1
  ...
  %3 = load i8, ptr %arrayidx27.us, align 1
  ...
  store i8 %conv42.us, ptr %arrayidx.us, align 1
  %shr45.us = lshr i32 %dest.0.us, 12
  %conv46.us = trunc i32 %shr45.us to i8
  store i8 %conv46.us, ptr %arrayidx17.us, align 1
  %shr49.us = lshr i32 %dest.0.us, 9
  %6 = trunc i32 %shr49.us to i8
  %conv52.us = or i8 %6, -8
  store i8 %conv52.us, ptr %arrayidx6.us, align 1
  %conv55.us = trunc i32 %shr.us to i8
  store i8 %conv55.us, ptr %arrayidx27.us, align 1
  br label %for.inc.us
...
if.then11:                                        ; preds = %land.lhs.true
  ...
  store i8 %conv46, ptr %arrayidx17, align 1
  %shr49 = lshr i32 %dest.0, 9
  %13 = trunc i32 %shr49 to i8
  %conv52 = or i8 %13, -8
  store i8 %conv52, ptr %arrayidx6, align 1
  %conv55 = trunc i32 %shr to i8
  store i8 %conv55, ptr %arrayidx27, align 1
  br label %for.inc
...
if.then8.us:                                      ; preds = %land.lhs.true.us
  ...
  %3 = load i8, ptr %arrayidx18.us, align 1
  ...
  store i8 %conv38.us, ptr %arrayidx.us, align 1
  %shr41.us = lshr i32 %dest.0.us, 16
  %conv42.us = trunc i32 %shr41.us to i8
  store i8 %conv42.us, ptr %arrayidx14.us, align 1
  %shr45.us = lshr i32 %dest.0.us, 8
  %conv46.us = trunc i32 %shr45.us to i8
  store i8 %conv46.us, ptr %arrayidx18.us, align 1
  %6 = and i8 %1, 3
  %7 = trunc i32 %or.us to i8
  %conv58.us = or i8 %6, %7
  store i8 %conv58.us, ptr %arrayidx4.us, align 1
  br label %for.inc.us
...
if.then8:                                         ; preds = %land.lhs.true
  ...
  store i8 %conv42, ptr %arrayidx14, align 1
  %shr45 = lshr i32 %dest.0, 8
  %conv46 = trunc i32 %shr45 to i8
  store i8 %conv46, ptr %arrayidx18, align 1
  %14 = and i8 %9, 3
  %15 = trunc i32 %or to i8
  %conv58 = or i8 %14, %15
  store i8 %conv58, ptr %arrayidx4, align 1
  br label %for.inc
...
for.body.us:                                      ; preds = %if.end, %for.inc.us
  ...
  %i.0121.us = phi i32 [ %add80.us, %for.inc.us ], [ 0, %if.end ]
...
land.lhs.true16.us:                               ; preds = %for.body.us
  %add17.us = or i32 %i.0121.us, 1
  %idxprom18.us = zext i32 %add17.us to i64
  %arrayidx19.us = getelementptr inbounds i8, ptr %data, i64 %idxprom18.us
  %1 = load i8, ptr %arrayidx19.us, align 1
  %cmp22.us = icmp ugt i8 %1, -65
  br i1 %cmp22.us, label %if.then24.us, label %for.inc.us

land.lhs.true.us:                                 ; preds = %for.body.us
  %add.us = or i32 %i.0121.us, 1
  %idxprom6.us = zext i32 %add.us to i64
  %arrayidx7.us = getelementptr inbounds i8, ptr %data, i64 %idxprom6.us
  %2 = load i8, ptr %arrayidx7.us, align 1
...
if.then24.us:                                     ; preds = %land.lhs.true.us, %land.lhs.true16.us
  ...
  %idxprom30.us.pre-phi = phi i64 [ %idxprom6.us, %land.lhs.true.us ], [ %idxprom18.us, %land.lhs.true16.us ]
  ...
  %add34.us = or i32 %i.0121.us, 2
  %idxprom35.us = zext i32 %add34.us to i64
  %arrayidx36.us = getelementptr inbounds i8, ptr %data, i64 %idxprom35.us
  %4 = load i8, ptr %arrayidx36.us, align 1
  %conv37.us = zext i8 %4 to i32
  %shl38.us = shl nuw nsw i32 %conv37.us, 8
  %or39.us = or i32 %or.us, %shl38.us
  %add40.us = or i32 %i.0121.us, 3
  %idxprom41.us = zext i32 %add40.us to i64
  %arrayidx42.us = getelementptr inbounds i8, ptr %data, i64 %idxprom41.us
  %5 = load i8, ptr %arrayidx42.us, align 1
  %conv43.us = zext i8 %5 to i32
  %or44.us = or i32 %or39.us, %conv43.us
  %shl45.us = shl i32 %or44.us, 2
  %add47.us = add i32 %i.0121.us, %ip
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %arrayidx7 = getelementptr inbounds i8, ptr %data, i64 %idxprom6
...
land.lhs.true16:                                  ; preds = %for.body
  %add17 = or i32 %i.0121, 1
  %idxprom18 = zext i32 %add17 to i64
  %arrayidx19 = getelementptr inbounds i8, ptr %data, i64 %idxprom18
...
if.then24:                                        ; preds = %land.lhs.true16, %land.lhs.true
  ...
  %idxprom30.pre-phi = phi i64 [ %idxprom18, %land.lhs.true16 ], [ %idxprom6, %land.lhs.true ]
