...
do.end55:                                         ; preds = %do.cond54
  ...
  %.pre224 = load ptr, ptr %p, align 8, !tbaa !41
  br i1 %cmp58, label %if.then60, label %if.end127

if.then60:                                        ; preds = %do.end55
  %14 = load i16, ptr %.pre224, align 4, !tbaa !44
  br label %do.body64
...
do.body64:                                        ; preds = %do.body64, %if.then60
  ...
  %15 = load i8, ptr %Freq67, align 1, !tbaa !51
...
do.end71:                                         ; preds = %do.body64
  ...
  store i16 %conv77, ptr %.pre224, align 4, !tbaa !44
...
do.end100:                                        ; preds = %do.body87
  ...
  %18 = load i8, ptr %arrayidx104, align 1, !tbaa !13
  %idxprom.i = zext i8 %18 to i64
  %arrayidx.i = getelementptr inbounds %struct.CPpmd7, ptr %p, i64 0, i32 20, i64 %idxprom.i
  %19 = load i32, ptr %arrayidx.i, align 4, !tbaa !62
  store i32 %19, ptr %add.ptr, align 4, !tbaa !62
  %20 = load ptr, ptr %Base, align 8, !tbaa !5
...
if.then119:                                       ; preds = %if.end109
  ...
  %21 = load i8, ptr %arrayidx.i218, align 1, !tbaa !13
...
do.body.i.prol:                                   ; preds = %if.then11.i
  %27 = load i32, ptr %add.ptr, align 4, !tbaa !62
  store i32 %27, ptr %add.ptr.i.i, align 4, !tbaa !62
  %arrayidx14.i.prol = getelementptr inbounds i32, ptr %add.ptr, i64 1
  %28 = load i32, ptr %arrayidx14.i.prol, align 4, !tbaa !62
  %arrayidx15.i.prol = getelementptr inbounds i32, ptr %add.ptr.i.i, i64 1
  store i32 %28, ptr %arrayidx15.i.prol, align 4, !tbaa !62
  %arrayidx16.i.prol = getelementptr inbounds i32, ptr %add.ptr, i64 2
  %29 = load i32, ptr %arrayidx16.i.prol, align 4, !tbaa !62
  %arrayidx17.i.prol = getelementptr inbounds i32, ptr %add.ptr.i.i, i64 2
  store i32 %29, ptr %arrayidx17.i.prol, align 4, !tbaa !62
...
do.end.i:                                         ; preds = %do.body.i, %do.body.i.prol.loopexit
  ...
  %37 = load i32, ptr %arrayidx.i44.i, align 4, !tbaa !62
  store i32 %37, ptr %add.ptr, align 4, !tbaa !62
...
if.then.i.i:                                      ; preds = %if.end19.i
  ...
  %42 = load i8, ptr %arrayidx20.i.i, align 1, !tbaa !13
  ...
  %44 = load i32, ptr %arrayidx.i.i.i, align 4, !tbaa !62
  store i32 %44, ptr %add.ptr24.i.i, align 4, !tbaa !62
  %45 = load ptr, ptr %Base, align 8, !tbaa !5
...
SplitBlock.exit.i:                                ; preds = %if.then.i.i, %entry.if.end_crit_edge.i.i
  ...
  %47 = load i32, ptr %arrayidx.i42.i.i, align 4, !tbaa !62
  store i32 %47, ptr %add.ptr.i50.i, align 4, !tbaa !62
  br label %cleanup.sink.split.i
...
cleanup.if.end127_crit_edge:                      ; preds = %cleanup
  %.pre223 = load ptr, ptr %p, align 8, !tbaa !41
  br label %if.end127
...
if.end127:                                        ; preds = %cleanup.if.end127_crit_edge, %if.end109, %do.end55
  ...
  %51 = load ptr, ptr %Base, align 8, !tbaa !5
  %Stats136 = getelementptr inbounds %struct.CPpmd7_Context_, ptr %50, i64 0, i32 2
  %52 = load i32, ptr %Stats136, align 4, !tbaa !48
...
if.then112:                                       ; preds = %if.end108
  ...
  %30 = load ptr, ptr %Text, align 8, !tbaa !32
...
if.else121:                                       ; preds = %if.end93
  %31 = load ptr, ptr %FoundState, align 8, !tbaa !46
  ...
  %32 = load ptr, ptr %p, align 8, !tbaa !41
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end303
  ...
  %42 = load i16, ptr %c.0542, align 4, !tbaa !44
...
if.then164:                                       ; preds = %if.then152
  ...
  %arrayidx.i = getelementptr inbounds %struct.CPpmd7, ptr %p, i64 0, i32 20, i64 %idxprom.i
  %45 = load i32, ptr %arrayidx.i, align 4, !tbaa !62
...
AllocUnits.exit.thread:                           ; preds = %if.then164
  ...
  %46 = load i32, ptr %add.ptr.i.i, align 4, !tbaa !62
  store i32 %46, ptr %arrayidx.i, align 4, !tbaa !62
  br label %if.end169

if.end.i:                                         ; preds = %if.then164
  %arrayidx2.i = getelementptr inbounds %struct.CPpmd7, ptr %p, i64 0, i32 18, i64 %idxprom.i
  %47 = load i8, ptr %arrayidx2.i, align 1, !tbaa !13
  %conv.i490 = zext i8 %47 to i32
  %mul.i = mul nuw nsw i32 %conv.i490, 12
  %48 = load ptr, ptr %HiUnit.i, align 8, !tbaa !39
  %49 = load ptr, ptr %LoUnit.i, align 8, !tbaa !47
...
if.end169:                                        ; preds = %AllocUnits.exit.if.end169_crit_edge, %AllocUnits.exit.thread
  ...
  %51 = load i32, ptr %Stats171, align 4, !tbaa !48
...
do.body175.prol:                                  ; preds = %if.end169
  %53 = load i32, ptr %add.ptr173, align 4, !tbaa !62
  store i32 %53, ptr %retval.0.i529, align 4, !tbaa !62
  %arrayidx178.prol = getelementptr inbounds i32, ptr %add.ptr173, i64 1
  %54 = load i32, ptr %arrayidx178.prol, align 4, !tbaa !62
  %arrayidx179.prol = getelementptr inbounds i32, ptr %retval.0.i529, i64 1
  store i32 %54, ptr %arrayidx179.prol, align 4, !tbaa !62
  %arrayidx180.prol = getelementptr inbounds i32, ptr %add.ptr173, i64 2
  %55 = load i32, ptr %arrayidx180.prol, align 4, !tbaa !62
  %arrayidx181.prol = getelementptr inbounds i32, ptr %retval.0.i529, i64 2
  store i32 %55, ptr %arrayidx181.prol, align 4, !tbaa !62
...
cleanup194:                                       ; preds = %do.body175, %do.body175.prol.loopexit
  ...
  %63 = load i32, ptr %arrayidx.i492, align 4, !tbaa !62
  store i32 %63, ptr %add.ptr173, align 4, !tbaa !62
  %sub.ptr.rhs.cast.i494 = ptrtoint ptr %50 to i64
  store i32 %51, ptr %arrayidx.i492, align 4, !tbaa !62
...
if.end203:                                        ; preds = %cleanup194, %if.then152, %if.then149
  ...
  %65 = load i16, ptr %SummFreq204, align 2, !tbaa !45
...
if.else222:                                       ; preds = %for.body
  %66 = load i32, ptr %arrayidx.i497, align 4, !tbaa !62
...
AllocUnits.exit520.thread:                        ; preds = %if.else222
  ...
  %67 = load i32, ptr %add.ptr.i.i502, align 4, !tbaa !62
  store i32 %67, ptr %arrayidx.i497, align 4, !tbaa !62
  br label %cleanup255

if.end.i504:                                      ; preds = %if.else222
  %68 = load i8, ptr %arrayidx2.i505, align 1, !tbaa !13
  %conv.i506 = zext i8 %68 to i32
  %mul.i507 = mul nuw nsw i32 %conv.i506, 12
  %69 = load ptr, ptr %HiUnit.i, align 8, !tbaa !39
  %70 = load ptr, ptr %LoUnit.i, align 8, !tbaa !47
...
if.then6.i515:                                    ; preds = %if.end.i504
  ...
  store ptr %add.ptr.i517, ptr %LoUnit.i, align 8, !tbaa !47
...
cleanup255:                                       ; preds = %AllocUnits.exit520, %AllocUnits.exit520.thread
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(6) %retval.0.i503535, ptr noundef nonnull align 2 dereferenceable(6) %SummFreq228, i64 6, i1 false), !tbaa.struct !63
  %71 = load ptr, ptr %Base84, align 8, !tbaa !5
  ...
  %72 = load i8, ptr %Freq235, align 1, !tbaa !51
  %cmp237 = icmp ult i8 %72, 30
  %shl242 = shl i8 %72, 1
  %storemerge = select i1 %cmp237, i8 %shl242, i8 120
  store i8 %storemerge, ptr %Freq235, align 1, !tbaa !51
  %conv248 = zext i8 %storemerge to i32
  %73 = load i32, ptr %InitEsc, align 4, !tbaa !73
...
if.end258:                                        ; preds = %cleanup255, %if.end203
  ...
  %76 = load ptr, ptr %FoundState, align 8, !tbaa !46
  %Freq260 = getelementptr inbounds %struct.CPpmd_State, ptr %76, i64 0, i32 1
  %77 = load i8, ptr %Freq260, align 1, !tbaa !51
...
if.end303:                                        ; preds = %if.else285, %if.then273
  ...
  store i16 %storemerge484, ptr %SummFreq263, align 2, !tbaa !45
  %Stats306 = getelementptr inbounds %struct.CPpmd7_Context_, ptr %c.0542, i64 0, i32 2
  %79 = load i32, ptr %Stats306, align 4, !tbaa !48
  ...
  %80 = load i8, ptr %76, align 1, !tbaa !49
  store i8 %80, ptr %add.ptr310, align 1, !tbaa !49
...
for.body92.i.prol:                                ; preds = %for.body92.preheader.i, %for.body92.i.prol
  ...
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body92.i.prol.loopexit, label %for.body92.i.prol, !llvm.loop !89
