; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/LzFindMt.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/LzFindMt.c"
...
if.else:                                          ; preds = %entry
  ...
  %1 = load i32, ptr %numProcessedBlocks7, align 8
  %inc = add i32 %1, 1
  store i32 %inc, ptr %numProcessedBlocks7, align 8
  %freeSemaphore = getelementptr inbounds %struct._CMtSync, ptr %p, i64 0, i32 8
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  store i32 1, ptr %csWasEntered13, align 4
  ret void
}
...
entry:
  %numProcessedBlocks = getelementptr inbounds %struct._CMtSync, ptr %p, i64 0, i32 13
  %0 = load i32, ptr %numProcessedBlocks, align 8
  %_created = getelementptr inbounds %struct._CMtSync, ptr %p, i64 0, i32 4, i32 1
  %1 = load i32, ptr %_created, align 8
  %cmp.not = icmp eq i32 %1, 0
  br i1 %cmp.not, label %cleanup, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %entry
  %needStart = getelementptr inbounds %struct._CMtSync, ptr %p, i64 0, i32 1
  %2 = load i32, ptr %needStart, align 4
  %tobool.not = icmp eq i32 %2, 0
  br i1 %tobool.not, label %if.end, label %cleanup

if.end:                                           ; preds = %lor.lhs.false
  %stopWriting = getelementptr inbounds %struct._CMtSync, ptr %p, i64 0, i32 3
  store i32 1, ptr %stopWriting, align 4
  %csWasEntered = getelementptr inbounds %struct._CMtSync, ptr %p, i64 0, i32 11
  %3 = load i32, ptr %csWasEntered, align 4
...
if.end4:                                          ; preds = %if.then2, %if.end
  ...
  %4 = load i32, ptr %numProcessedBlocks, align 8
...
entry:
  ...
  %_created = getelementptr inbounds %struct._CMtSync, ptr %p, i64 0, i32 4, i32 1
  %0 = load i32, ptr %_created, align 8
...
if.then:                                          ; preds = %entry
  ...
  %exit = getelementptr inbounds %struct._CMtSync, ptr %p, i64 0, i32 2
  store i32 1, ptr %exit, align 8
  %needStart = getelementptr inbounds %struct._CMtSync, ptr %p, i64 0, i32 1
  %1 = load i32, ptr %needStart, align 4
...
if.end6:                                          ; preds = %if.end, %entry
  %csWasInitialized = getelementptr inbounds %struct._CMtSync, ptr %p, i64 0, i32 10
  %2 = load i32, ptr %csWasInitialized, align 8
...
if.end:                                           ; preds = %if.end.lr.ph, %cleanup
  %1 = load i32, ptr %stopWriting, align 4
  %tobool3.not = icmp eq i32 %1, 0
  br i1 %tobool3.not, label %if.end7, label %if.then4

if.then4:                                         ; preds = %if.end
  store i32 %numProcessedBlocks.0.ph134, ptr %numProcessedBlocks5, align 8
...
if.then33:                                        ; preds = %if.end31
  ...
  %5 = load i32, ptr %historySize, align 8
  %6 = xor i32 %5, -1
  %sub35 = add i32 %4, %6
  ...
  %8 = load i32, ptr %fixedHashSize, align 4
  ...
  %9 = load i32, ptr %hashMask, align 8
  %add = add i32 %9, 1
...
if.end37:                                         ; preds = %if.then33, %if.end31
  ...
  %11 = load ptr, ptr %hashBuf, align 8
  ...
  %sub41 = sub i32 %12, %10
  store i32 2, ptr %add.ptr39, align 4
  ...
  %13 = load i32, ptr %numHashBytes, align 8
...
if.then44:                                        ; preds = %if.end37
  ...
  %19 = load i32, ptr %hashMask57, align 8
  ...
  %20 = load i32, ptr %add.ptr39, align 4
  %add60 = add i32 %20, %spec.store.select
  store i32 %add60, ptr %add.ptr39, align 4
...
entry:
  ...
  store i32 %mul, ptr %hashBufPosLimit, align 4
  %hashBuf = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 13
  %1 = load ptr, ptr %hashBuf, align 8
  %inc = or i32 %mul, 1
  store i32 %inc, ptr %hashBufPos, align 8
  %idxprom = zext i32 %mul to i64
  %arrayidx = getelementptr inbounds i32, ptr %1, i64 %idxprom
  %2 = load i32, ptr %arrayidx, align 4
  %add = add i32 %2, %mul
  store i32 %add, ptr %hashBufPosLimit, align 4
  %inc6 = or i32 %mul, 2
  store i32 %inc6, ptr %hashBufPos, align 8
  ...
  store i32 %3, ptr %hashNumAvail, align 8
  ret void
}
...
entry:
  ...
  %0 = load i32, ptr %matchMaxLen, align 8
  %mul = shl i32 %0, 1
  %sub = sub i32 16384, %mul
  %hashNumAvail = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 16
  %1 = load i32, ptr %hashNumAvail, align 8
...
if.then:                                          ; preds = %while.cond
  ...
  store i32 %7, ptr %hashNumAvail, align 8
  %add = add i32 %7, %numProcessed.0.ph151
  store i32 %add, ptr %arrayidx, align 4
  %8 = load i32, ptr %hashNumAvail, align 8
  %9 = load i32, ptr %numHashBytes, align 4
  %cmp5.not = icmp ult i32 %8, %9
  br i1 %cmp5.not, label %for.cond.preheader, label %while.cond
...
for.body:                                         ; preds = %for.cond.preheader, %for.body
  ...
  %10 = load i32, ptr %hashNumAvail, align 8
  %dec = add i32 %10, -1
  store i32 %dec, ptr %hashNumAvail, align 8
  %cmp8.not = icmp eq i32 %dec, 0
  br i1 %cmp8.not, label %while.end66, label %for.body

if.end11:                                         ; preds = %while.cond
  %sub14 = sub i32 %3, %2
  %11 = load i32, ptr %matchMaxLen, align 8
  %12 = load i32, ptr %pos16, align 8
  %13 = load i32, ptr %cyclicBufferPos17, align 8
  %14 = load i32, ptr %hashNumAvail, align 8
...
while.body37:                                     ; preds = %while.body37.preheader, %while.body37
  ...
  %17 = load ptr, ptr %hashBuf.i, align 8
  %18 = load i32, ptr %hashBufPos, align 8
  %inc39 = add i32 %18, 1
  store i32 %inc39, ptr %hashBufPos, align 8
  ...
  %22 = load i32, ptr %cutValue, align 8
  %add.ptr44 = getelementptr inbounds i32, ptr %add.ptr, i64 1
  %23 = load i32, ptr %numHashBytes, align 4
  %sub46 = add i32 %23, -1
  ...
  store i32 %sub47, ptr %add.ptr, align 4
  ...
  br i1 %or.cond, label %while.end.loopexit, label %while.body37

while.end.loopexit:                               ; preds = %while.body37
  %.pre162 = load i32, ptr %pos16, align 8
  %.pre163 = load i32, ptr %hashNumAvail, align 8
  %.pre164 = load i32, ptr %cyclicBufferSize, align 4
  br label %while.end
...
while.end:                                        ; preds = %while.end.loopexit, %if.end11
  ...
  store i32 %sub58, ptr %hashNumAvail, align 8
  store i32 %pos.0.lcssa, ptr %pos16, align 8
  %cmp61 = icmp eq i32 %cyclicBufferPos.0.lcssa, %26
  %spec.store.select = select i1 %cmp61, i32 0, i32 %cyclicBufferPos.0.lcssa
  store i32 %spec.store.select, ptr %cyclicBufferPos17, align 8
  %cmp = icmp ult i32 %curPos.2.lcssa, %sub
  br i1 %cmp, label %while.cond.outer.split, label %while.end66
...
while.end66:                                      ; preds = %while.end, %for.body, %entry, %for.cond.preheader
  ...
  store i32 %curPos.3, ptr %distances, align 4
  ret void
}
...
if.then10:                                        ; preds = %if.end7
  ...
  store i32 0, ptr %csWasEntered14, align 4
  br label %if.end15
...
if.then4:                                         ; preds = %if.end
  store i32 %blockIndex.022, ptr %numProcessedBlocks, align 8
...
if.then1.i:                                       ; preds = %if.end.i
  %6 = load i32, ptr %cyclicBufferSize.i, align 4
  %sub.i = sub i32 %5, %6
  %7 = load ptr, ptr %son.i, align 8
  %mul4.i = shl i32 %6, 1
  ...
  store i32 %sub6.i, ptr %pos.i, align 8
  br label %if.end7.i

if.end7.i:                                        ; preds = %if.then1.i, %if.end.i
  %9 = load i32, ptr %needStart.i, align 4
...
if.then10.i:                                      ; preds = %if.end7.i
  ...
  store i32 0, ptr %csWasEntered.i, align 4
...
entry:
  %hashBuf = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 13
  store ptr null, ptr %hashBuf, align 8
  %hashSync = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 25
  store i32 0, ptr %hashSync, align 8
  %csWasInitialized.i = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 25, i32 10
  store i32 0, ptr %csWasInitialized.i, align 8
...
entry:
  ...
  %hashBuf.i = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 13
  %1 = load ptr, ptr %hashBuf.i, align 8
  tail call void %0(ptr noundef %alloc, ptr noundef %1) #10
  store ptr null, ptr %hashBuf.i, align 8
  ret void
}
...
entry:
  ...
  %0 = load ptr, ptr %MatchFinder, align 8
  %historySize1 = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 8
  store i32 %historySize, ptr %historySize1, align 4
...
if.end:                                           ; preds = %entry
  %hashBuf = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 13
  %2 = load ptr, ptr %hashBuf, align 8
...
if.then3:                                         ; preds = %if.end
  ...
  store ptr %call, ptr %hashBuf, align 8
...
if.end8:                                          ; preds = %if.then3
  ...
  %btBuf = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 1
  store ptr %add.ptr, ptr %btBuf, align 8
  br label %if.end10
...
if.end14:                                         ; preds = %if.end10
  %hashSync = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 25
  %call15 = tail call fastcc i32 @MtSync_Create(ptr noundef nonnull %hashSync, ptr noundef nonnull @HashThreadFunc2, ptr noundef nonnull %p, i32 noundef 8)
  %cmp16.not = icmp eq i32 %call15, 0
  br i1 %cmp16.not, label %cleanup.cont, label %cleanup27

cleanup.cont:                                     ; preds = %if.end14
  %btSync = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 11
  %call20 = tail call fastcc i32 @MtSync_Create(ptr noundef nonnull %btSync, ptr noundef nonnull @BtThreadFunc2, ptr noundef nonnull %p, i32 noundef 64)
  br label %cleanup27
...
if.end2.i:                                        ; preds = %if.end.i
  ...
  store i32 1, ptr %csWasInitialized.i, align 8
...
if.end22.i:                                       ; preds = %if.end18.i
  ...
  store i32 1, ptr %needStart.i, align 4
...
entry:
  ...
  store i32 0, ptr %btBufPosLimit, align 4
  %btBufPos = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 2
  store i32 0, ptr %btBufPos, align 8
  %hashBufPosLimit = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 15
  store i32 0, ptr %hashBufPosLimit, align 4
  %hashBufPos = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 14
  store i32 0, ptr %hashBufPos, align 8
  ...
  store ptr %crc, ptr %crc3, align 8
  ...
  %9 = load <2 x i32>, ptr %cyclicBufferPos, align 8
  store <2 x i32> %9, ptr %cyclicBufferPos9, align 8
  %cutValue = getelementptr inbounds %struct._CMatchFinder, ptr %0, i64 0, i32 11
  %10 = load i32, ptr %cutValue, align 4
  %cutValue11 = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 24
  store i32 %10, ptr %cutValue11, align 8
  ret void
}
...
entry:
  ...
  %btBufPos = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 2
  %btBufPosLimit = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 3
  store i32 %mul, ptr %btBufPosLimit, align 4
  %btBuf = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 1
  %1 = load ptr, ptr %btBuf, align 8
  %inc = or i32 %mul, 1
  store i32 %inc, ptr %btBufPos, align 8
  %idxprom = zext i32 %mul to i64
  %arrayidx = getelementptr inbounds i32, ptr %1, i64 %idxprom
  %2 = load i32, ptr %arrayidx, align 4
  %add = add i32 %2, %mul
  store i32 %add, ptr %btBufPosLimit, align 4
  %inc6 = or i32 %mul, 2
  store i32 %inc6, ptr %btBufPos, align 8
  %idxprom7 = zext i32 %inc to i64
  %arrayidx8 = getelementptr inbounds i32, ptr %1, i64 %idxprom7
  %3 = load i32, ptr %arrayidx8, align 4
  %btNumAvailBytes = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 5
  store i32 %3, ptr %btNumAvailBytes, align 4
  %lzPos = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 4
  %4 = load i32, ptr %lzPos, align 8
  %cmp = icmp ugt i32 %4, -16386
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %historySize.i = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 8
  %5 = load i32, ptr %historySize.i, align 4
  %6 = xor i32 %5, -1
  %sub1.i = add i32 %4, %6
  %hash.i = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 6
  %7 = load ptr, ptr %hash.i, align 8
  %fixedHashSize.i = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 7
  %8 = load i32, ptr %fixedHashSize.i, align 8
  tail call void @MatchFinder_Normalize3(i32 noundef %sub1.i, ptr noundef %7, i32 noundef %8) #10
  %9 = load i32, ptr %historySize.i, align 4
  %add.i = add i32 %9, 1
  store i32 %add.i, ptr %lzPos, align 8
  br label %if.end
...
entry:
  %btBufPos = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 2
  %0 = load i32, ptr %btBufPos, align 8
  %btBufPosLimit = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 3
  %1 = load i32, ptr %btBufPosLimit, align 4
  %cmp = icmp eq i32 %0, %1
  br i1 %cmp, label %if.then, label %if.end
...
if.then:                                          ; preds = %entry
  ...
  %2 = load i32, ptr %numProcessedBlocks.i, align 8
  %sub.i = shl i32 %2, 14
  %and.i = add i32 %sub.i, 1032192
  %mul.i = and i32 %and.i, 1032192
  store i32 %mul.i, ptr %btBufPosLimit, align 4
  %btBuf.i = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 1
  %3 = load ptr, ptr %btBuf.i, align 8
  %inc.i = or i32 %mul.i, 1
  store i32 %inc.i, ptr %btBufPos, align 8
  %idxprom.i = zext i32 %mul.i to i64
  %arrayidx.i = getelementptr inbounds i32, ptr %3, i64 %idxprom.i
  %4 = load i32, ptr %arrayidx.i, align 4
  %add.i = add i32 %4, %mul.i
  store i32 %add.i, ptr %btBufPosLimit, align 4
  %inc6.i = or i32 %mul.i, 2
  store i32 %inc6.i, ptr %btBufPos, align 8
  %idxprom7.i = zext i32 %inc.i to i64
...
if.then18:                                        ; preds = %if.then
  ...
  store i32 %sub20, ptr %incdec.ptr, align 4
  br label %if.end22
...
if.then40:                                        ; preds = %if.then
  store i32 3, ptr %distances, align 4
  br label %cleanup
...
if.then57:                                        ; preds = %land.lhs.true47
  ...
  store i32 3, ptr %distances.addr.0, align 4
  %17 = xor i32 %9, -1
  %sub59 = add i32 %2, %17
  %incdec.ptr60 = getelementptr inbounds i32, ptr %distances.addr.0, i64 2
  store i32 %sub59, ptr %incdec.ptr, align 4
  br label %cleanup
...
entry:
  ...
  %0 = load ptr, ptr %btBuf1, align 8
  %btBufPos = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 2
  %1 = load i32, ptr %btBufPos, align 8
  %idx.ext = zext i32 %1 to i64
  %add.ptr = getelementptr inbounds i32, ptr %0, i64 %idx.ext
  %2 = load i32, ptr %add.ptr, align 4
  %add = add i32 %1, 1
  %add3 = add i32 %add, %2
  store i32 %add3, ptr %btBufPos, align 8
  %btNumAvailBytes = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 5
  %3 = load i32, ptr %btNumAvailBytes, align 4
  %dec = add i32 %3, -1
  store i32 %dec, ptr %btNumAvailBytes, align 4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <4 x i32>, ptr %next.gep31, align 4
  %wide.vec33 = load <4 x i32>, ptr %next.gep32, align 4
  store <4 x i32> %wide.vec, ptr %next.gep, align 4
  store <4 x i32> %wide.vec33, ptr %next.gep30, align 4
...
for.end:                                          ; preds = %for.body, %middle.block, %entry
  %lzPos = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 4
  %26 = load i32, ptr %lzPos, align 8
  %inc = add i32 %26, 1
  store i32 %inc, ptr %lzPos, align 8
...
if.then5:                                         ; preds = %if.then
  ...
  %4 = load ptr, ptr %MixMatchesFunc, align 8
  %lzPos = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 4
  %5 = load i32, ptr %lzPos, align 8
  %historySize = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 8
  %6 = load i32, ptr %historySize, align 4
  %sub = sub i32 %5, %6
...
if.else:                                          ; preds = %entry
  ...
  %8 = load i32, ptr %btNumAvailBytes6, align 4
  %dec7 = add i32 %8, -1
  store i32 %dec7, ptr %btNumAvailBytes6, align 4
  %MixMatchesFunc8 = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 10
  %9 = load ptr, ptr %MixMatchesFunc8, align 8
  %lzPos9 = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 4
  %10 = load i32, ptr %lzPos9, align 8
...
if.end24:                                         ; preds = %if.then, %if.then5, %do.end
  ...
  %15 = load i32, ptr %lzPos25, align 8
  %inc = add i32 %15, 1
  store i32 %inc, ptr %lzPos25, align 8
...
entry:
  ...
  %hash.i.i = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 6
  %fixedHashSize.i.i = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 7
  %.pre = load i32, ptr %btBufPos, align 8
  br label %do.body
...
do.body.if.end_crit_edge:                         ; preds = %do.body
  %.pre14 = load i32, ptr %lzPos.i, align 8
  br label %if.end
...
if.then.i:                                        ; preds = %if.then
  ...
  %11 = load i32, ptr %historySize.i.i, align 4
  %add.i.i = add i32 %11, 1
  %.pre15 = load i32, ptr %btBufPos, align 8
  br label %if.end
...
if.end:                                           ; preds = %do.body.if.end_crit_edge, %if.then.i, %if.then
  ...
  %14 = load i32, ptr %btNumAvailBytes.i, align 4
  %dec = add i32 %14, -1
  store i32 %dec, ptr %btNumAvailBytes.i, align 4
  %inc = add i32 %13, 1
  store i32 %inc, ptr %lzPos.i, align 8
  %15 = load ptr, ptr %p, align 8
  %incdec.ptr = getelementptr inbounds i8, ptr %15, i64 1
  store ptr %incdec.ptr, ptr %p, align 8
  %16 = load ptr, ptr %btBuf.i, align 8
  ...
  br i1 %cmp5.not, label %do.end, label %do.body
...
do.body.if.end_crit_edge:                         ; preds = %do.body
  %.pre33.pre = load i32, ptr %lzPos.i, align 8
...
if.endthread-pre-split:                           ; preds = %if.then.i, %do.body.if.end_crit_edge
  %.pre33.ph = phi i32 [ %add.i.i, %if.then.i ], [ %.pre33.pre, %do.body.if.end_crit_edge ]
  %.pr = load i32, ptr %btNumAvailBytes.i, align 4
  br label %if.end

if.end:                                           ; preds = %if.endthread-pre-split, %if.then
  %12 = phi i32 [ %.pr, %if.endthread-pre-split ], [ %5, %if.then ]
  %.pre33 = phi i32 [ %.pre33.ph, %if.endthread-pre-split ], [ %6, %if.then ]
  %dec = add i32 %12, -1
  store i32 %dec, ptr %btNumAvailBytes.i, align 4
  %cmp1 = icmp ugt i32 %12, 1
  %.pre34 = load ptr, ptr %p, align 8
  br i1 %cmp1, label %if.then2, label %if.end8

if.then2:                                         ; preds = %if.end
  %13 = load ptr, ptr %hash.i.i, align 8
  %14 = load ptr, ptr %crc, align 8
  %15 = load i8, ptr %.pre34, align 1
  %idxprom = zext i8 %15 to i64
  %arrayidx4 = getelementptr inbounds i32, ptr %14, i64 %idxprom
  %16 = load i32, ptr %arrayidx4, align 4
  %arrayidx5 = getelementptr inbounds i8, ptr %.pre34, i64 1
  %17 = load i8, ptr %arrayidx5, align 1
  %conv = zext i8 %17 to i32
  %.masked = and i32 %16, 1023
  %and = xor i32 %.masked, %conv
  %idxprom6 = zext i32 %and to i64
  %arrayidx7 = getelementptr inbounds i32, ptr %13, i64 %idxprom6
  store i32 %.pre33, ptr %arrayidx7, align 4
  %.pre32 = load i32, ptr %lzPos.i, align 8
  br label %if.end8

if.end8:                                          ; preds = %if.then2, %if.end
  %18 = phi i32 [ %.pre32, %if.then2 ], [ %.pre33, %if.end ]
  %inc = add i32 %18, 1
  store i32 %inc, ptr %lzPos.i, align 8
  %incdec.ptr = getelementptr inbounds i8, ptr %.pre34, i64 1
  store ptr %incdec.ptr, ptr %p, align 8
  %19 = load ptr, ptr %btBuf.i, align 8
  %20 = load i32, ptr %btBufPos, align 8
  ...
  store i32 %add15, ptr %btBufPos, align 8
...
do.body.if.end_crit_edge:                         ; preds = %do.body
  %.pre43.pre = load i32, ptr %lzPos.i, align 8
  br label %if.endthread-pre-split
...
if.endthread-pre-split:                           ; preds = %if.then.i, %do.body.if.end_crit_edge
  %.pre43.ph = phi i32 [ %add.i.i, %if.then.i ], [ %.pre43.pre, %do.body.if.end_crit_edge ]
  %.pr = load i32, ptr %btNumAvailBytes.i, align 4
  br label %if.end

if.end:                                           ; preds = %if.endthread-pre-split, %if.then
  %12 = phi i32 [ %.pr, %if.endthread-pre-split ], [ %5, %if.then ]
  %.pre43 = phi i32 [ %.pre43.ph, %if.endthread-pre-split ], [ %6, %if.then ]
  %dec = add i32 %12, -1
  store i32 %dec, ptr %btNumAvailBytes.i, align 4
  %cmp1 = icmp ugt i32 %12, 2
  %.pre44 = load ptr, ptr %p, align 8
  br i1 %cmp1, label %if.then2, label %if.end14

if.then2:                                         ; preds = %if.end
  %13 = load ptr, ptr %hash.i.i, align 8
  %14 = load ptr, ptr %crc, align 8
  %15 = load i8, ptr %.pre44, align 1
  %idxprom = zext i8 %15 to i64
  %arrayidx4 = getelementptr inbounds i32, ptr %14, i64 %idxprom
  %16 = load i32, ptr %arrayidx4, align 4
  %arrayidx5 = getelementptr inbounds i8, ptr %.pre44, i64 1
  %17 = load i8, ptr %arrayidx5, align 1
  %conv = zext i8 %17 to i32
  %xor = xor i32 %16, %conv
  %and = and i32 %xor, 1023
  %arrayidx6 = getelementptr inbounds i8, ptr %.pre44, i64 2
  ...
  store i32 %.pre43, ptr %arrayidx11, align 4
  %add = add nuw nsw i32 %and9, 1024
  %idxprom12 = zext i32 %add to i64
  %arrayidx13 = getelementptr inbounds i32, ptr %13, i64 %idxprom12
  store i32 %.pre43, ptr %arrayidx13, align 4
  %.pre42 = load i32, ptr %lzPos.i, align 8
  br label %if.end14

if.end14:                                         ; preds = %if.then2, %if.end
  %19 = phi i32 [ %.pre42, %if.then2 ], [ %.pre43, %if.end ]
  %inc = add i32 %19, 1
  store i32 %inc, ptr %lzPos.i, align 8
  %incdec.ptr = getelementptr inbounds i8, ptr %.pre44, i64 1
  store ptr %incdec.ptr, ptr %p, align 8
  %20 = load ptr, ptr %btBuf.i, align 8
  %21 = load i32, ptr %btBufPos, align 8
  %idxprom18 = zext i32 %21 to i64
  %arrayidx19 = getelementptr inbounds i32, ptr %20, i64 %idxprom18
  %22 = load i32, ptr %arrayidx19, align 4
  %add20 = add i32 %21, 1
  %add22 = add i32 %add20, %22
  store i32 %add22, ptr %btBufPos, align 8
...
sw.default:                                       ; preds = %entry
  ...
  store ptr %cond, ptr %GetHeadsFunc7, align 8
  %MixMatchesFunc8 = getelementptr inbounds %struct._CMatchFinderMt, ptr %p, i64 0, i32 10
  store ptr @MixMatches3, ptr %MixMatchesFunc8, align 8
  %Skip9 = getelementptr inbounds %struct._IMatchFinder, ptr %vTable, i64 0, i32 5
  store ptr @MatchFinderMt3_Skip, ptr %Skip9, align 8
  br label %sw.epilog
...
for.body.prol:                                    ; preds = %for.body.preheader
  ...
  %2 = load i32, ptr %arrayidx3.prol, align 4
  %sub.prol = sub i32 %pos, %2
  %incdec.ptr4.prol = getelementptr inbounds i32, ptr %heads, i64 1
  store i32 %sub.prol, ptr %heads, align 4
  %inc.prol = add i32 %pos, 1
  store i32 %pos, ptr %arrayidx3.prol, align 4
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  ...
  store i32 %sub, ptr %heads.addr.014, align 4
  %inc = add i32 %pos.addr.016, 1
  store i32 %pos.addr.016, ptr %arrayidx3, align 4
  ...
  store i32 %sub.1, ptr %incdec.ptr4, align 4
  %inc.1 = add i32 %pos.addr.016, 2
  store i32 %inc, ptr %arrayidx3.1, align 4
  %dec.1 = add i32 %numHeads.addr.015, -2
  %cmp.not.1 = icmp eq i32 %dec.1, 0
  br i1 %cmp.not.1, label %for.end, label %for.body
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %0 = load i8, ptr %p.addr.022, align 1
  ...
  store i32 %sub, ptr %heads.addr.019, align 4
  %inc = add i32 %pos.addr.021, 1
  store i32 %pos.addr.021, ptr %arrayidx7, align 4
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %0 = load i8, ptr %p.addr.027, align 1
  %idxprom = zext i8 %0 to i64
  %arrayidx1 = getelementptr inbounds i32, ptr %crc, i64 %idxprom
  %1 = load i32, ptr %arrayidx1, align 4
  ...
  store i32 %sub, ptr %heads.addr.024, align 4
  %inc = add i32 %pos.addr.026, 1
  store i32 %pos.addr.026, ptr %arrayidx11, align 4
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %0 = load i8, ptr %p.addr.029, align 1
  %idxprom = zext i8 %0 to i64
  %arrayidx1 = getelementptr inbounds i32, ptr %crc, i64 %idxprom
  %1 = load i32, ptr %arrayidx1, align 4
  ...
  store i32 %sub, ptr %heads.addr.026, align 4
  %inc = add i32 %pos.addr.028, 1
  store i32 %pos.addr.028, ptr %arrayidx12, align 4
