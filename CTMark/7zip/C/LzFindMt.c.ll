...
do.body.if.end_crit_edge:                         ; preds = %do.body
  %.pre33.pre = load i32, ptr %lzPos.i, align 8, !tbaa !69
...
if.end:                                           ; preds = %if.endthread-pre-split, %if.then
  ...
  %.pre34 = load ptr, ptr %p, align 8, !tbaa !44
  br i1 %cmp1, label %if.then2, label %if.end8

if.then2:                                         ; preds = %if.end
  %13 = load ptr, ptr %hash.i.i, align 8, !tbaa !70
  %14 = load ptr, ptr %crc, align 8, !tbaa !72
  %15 = load i8, ptr %.pre34, align 1, !tbaa !77
  %idxprom = zext i8 %15 to i64
  %arrayidx4 = getelementptr inbounds i32, ptr %14, i64 %idxprom
  %16 = load i32, ptr %arrayidx4, align 4, !tbaa !40
  %arrayidx5 = getelementptr inbounds i8, ptr %.pre34, i64 1
  %17 = load i8, ptr %arrayidx5, align 1, !tbaa !77
  %conv = zext i8 %17 to i32
  %.masked = and i32 %16, 1023
  %and = xor i32 %.masked, %conv
  %idxprom6 = zext i32 %and to i64
  %arrayidx7 = getelementptr inbounds i32, ptr %13, i64 %idxprom6
  store i32 %.pre33, ptr %arrayidx7, align 4, !tbaa !40
  %.pre32 = load i32, ptr %lzPos.i, align 8, !tbaa !69
  br label %if.end8
...
if.end8:                                          ; preds = %if.then2, %if.end
  ...
  store ptr %incdec.ptr, ptr %p, align 8, !tbaa !44
  %19 = load ptr, ptr %btBuf.i, align 8, !tbaa !60
  %20 = load i32, ptr %btBufPos, align 8, !tbaa !67
  %idxprom12 = zext i32 %20 to i64
  %arrayidx13 = getelementptr inbounds i32, ptr %19, i64 %idxprom12
  %21 = load i32, ptr %arrayidx13, align 4, !tbaa !40
  %add = add i32 %20, 1
...
do.body.if.end_crit_edge:                         ; preds = %do.body
  %.pre43.pre = load i32, ptr %lzPos.i, align 8, !tbaa !69
  br label %if.endthread-pre-split
...
if.end:                                           ; preds = %if.endthread-pre-split, %if.then
  ...
  %.pre44 = load ptr, ptr %p, align 8, !tbaa !44
  br i1 %cmp1, label %if.then2, label %if.end14

if.then2:                                         ; preds = %if.end
  %13 = load ptr, ptr %hash.i.i, align 8, !tbaa !70
  %14 = load ptr, ptr %crc, align 8, !tbaa !72
  %15 = load i8, ptr %.pre44, align 1, !tbaa !77
  %idxprom = zext i8 %15 to i64
  %arrayidx4 = getelementptr inbounds i32, ptr %14, i64 %idxprom
  %16 = load i32, ptr %arrayidx4, align 4, !tbaa !40
  ...
  %18 = load i8, ptr %arrayidx6, align 1, !tbaa !77
  ...
  store i32 %.pre43, ptr %arrayidx11, align 4, !tbaa !40
  %add = add nuw nsw i32 %and9, 1024
  %idxprom12 = zext i32 %add to i64
  %arrayidx13 = getelementptr inbounds i32, ptr %13, i64 %idxprom12
  store i32 %.pre43, ptr %arrayidx13, align 4, !tbaa !40
  %.pre42 = load i32, ptr %lzPos.i, align 8, !tbaa !69
  br label %if.end14
...
if.end14:                                         ; preds = %if.then2, %if.end
  ...
  store ptr %incdec.ptr, ptr %p, align 8, !tbaa !44
  %20 = load ptr, ptr %btBuf.i, align 8, !tbaa !60
  %21 = load i32, ptr %btBufPos, align 8, !tbaa !67
  %idxprom18 = zext i32 %21 to i64
  %arrayidx19 = getelementptr inbounds i32, ptr %20, i64 %idxprom18
  %22 = load i32, ptr %arrayidx19, align 4, !tbaa !40
  %add20 = add i32 %21, 1
