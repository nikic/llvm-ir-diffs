; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/7zCrcOpt.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/7zCrcOpt.c"
...
for.body:                                         ; preds = %entry
  ...
  br i1 %5, label %for.body.1, label %for.cond6.preheader
...
for.body.1:                                       ; preds = %for.body
  ...
  br i1 %9, label %for.body.2, label %for.cond6.preheader
...
for.body.2:                                       ; preds = %for.body.1
  ...
  br i1 %13, label %for.body.3, label %for.cond6.preheader
...
for.body36.prol:                                  ; preds = %for.body36.preheader
  %16 = load i8, ptr %p.1.lcssa, align 1
  ...
  %17 = load i32, ptr %arrayidx41.prol, align 4
...
for.body9:                                        ; preds = %for.cond6.preheader, %for.body9
  ...
  br i1 %cmp7, label %for.body9, label %for.cond33.preheader
...
for.body36:                                       ; preds = %for.body36.prol.loopexit, %for.body36
  ...
  %26 = load i8, ptr %incdec.ptr46, align 1
  ...
  %27 = load i32, ptr %arrayidx41.1, align 4
  ...
  br i1 %cmp34.not.1, label %for.end47, label %for.body36
...
for.body.i:                                       ; preds = %entry
  ...
  br i1 %5, label %for.body.i.1, label %for.cond6.preheader.i
...
for.body.i.1:                                     ; preds = %for.body.i
  ...
  br i1 %9, label %for.body.i.2, label %for.cond6.preheader.i

for.body.i.2:                                     ; preds = %for.body.i.1
  %10 = load i8, ptr %incdec.ptr.i.1, align 1
  ...
  br i1 %13, label %for.body.i.3, label %for.cond6.preheader.i

for.body.i.3:                                     ; preds = %for.body.i.2
  %14 = load i8, ptr %incdec.ptr.i.2, align 1
...
for.body36.i.prol:                                ; preds = %for.body36.i.preheader
  %16 = load i8, ptr %p.1.lcssa.i, align 1
  ...
  %17 = load i32, ptr %arrayidx41.i.prol, align 4
...
for.body9.i:                                      ; preds = %for.cond6.preheader.i, %for.body9.i
  ...
  %19 = load i32, ptr %p.185.i, align 4
  ...
  %20 = load i32, ptr %arrayidx13.i, align 4
  ...
  br i1 %cmp7.i, label %for.body9.i, label %for.cond33.preheader.i
...
for.body36.i:                                     ; preds = %for.body36.i.prol.loopexit, %for.body36.i
  ...
  %24 = load i8, ptr %p.292.i, align 1
  ...
  %27 = load i32, ptr %arrayidx41.i.1, align 4
  ...
  br i1 %cmp34.not.i.1, label %CrcUpdateT4.exit, label %for.body36.i
