; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/Threads.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/Threads.c"
...
if.end9:                                          ; preds = %if.end4
  store i32 1, ptr %_created, align 8
  br label %cleanup
...
while.end:                                        ; preds = %while.body, %entry
  %_manual_reset = getelementptr inbounds %struct._CEvent, ptr %p, i64 0, i32 1
  %2 = load i32, ptr %_manual_reset, align 4
...
entry:
  ...
  store i32 %initiallyCount, ptr %_count, align 4
  %_maxCount = getelementptr inbounds %struct._CSemaphore, ptr %p, i64 0, i32 2
  store i32 %maxCount, ptr %_maxCount, align 8
  store i32 1, ptr %p, align 8
  ret i32 0
}
...
while.end:                                        ; preds = %while.body, %entry
  ...
  %dec = add i32 %.lcssa, -1
  store i32 %dec, ptr %_count, align 4
...
entry:
  ...
  store i32 1, ptr %_manual_reset.i, align 4
  ...
  store i32 %cond.i, ptr %_state.i, align 8
  store i32 1, ptr %p, align 8
  ret i32 0
}
...
entry:
  ...
  store i32 1, ptr %_manual_reset.i.i, align 4
  %_state.i.i = getelementptr inbounds %struct._CEvent, ptr %p, i64 0, i32 2
  store i32 0, ptr %_state.i.i, align 8
  store i32 1, ptr %p, align 8
  ret i32 0
}
...
entry:
  ...
  %call1.i = tail call i32 @pthread_cond_init(ptr noundef nonnull %_cond.i, ptr noundef null) #4
  %_manual_reset.i = getelementptr inbounds %struct._CEvent, ptr %p, i64 0, i32 1
  store i32 0, ptr %_manual_reset.i, align 4
  %tobool.not.i = icmp ne i32 %initialSignaled, 0
  %cond.i = zext i1 %tobool.not.i to i32
  %_state.i = getelementptr inbounds %struct._CEvent, ptr %p, i64 0, i32 2
  store i32 %cond.i, ptr %_state.i, align 8
...
entry:
  ...
  %call1.i.i = tail call i32 @pthread_cond_init(ptr noundef nonnull %_cond.i.i, ptr noundef null) #4
  %_manual_reset.i.i = getelementptr inbounds %struct._CEvent, ptr %p, i64 0, i32 1
  store i32 0, ptr %_manual_reset.i.i, align 4
  %_state.i.i = getelementptr inbounds %struct._CEvent, ptr %p, i64 0, i32 2
  store i32 0, ptr %_state.i.i, align 8
  store i32 1, ptr %p, align 8
  ret i32 0
