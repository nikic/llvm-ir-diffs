...
land.rhs.i.i425:                                  ; preds = %lor.rhs.i.i423
  ...
  store i32 %and.i.i427, ptr %Range.i414, align 8, !tbaa !25
...
while.body.critedge.i.i428:                       ; preds = %land.rhs.i.i425, %while.cond.i.i419
  ...
  store i32 %shl.i.i431, ptr %Range.i414, align 8, !tbaa !25
  %26 = load i32, ptr %Low.i416, align 8, !tbaa !11
  %shl10.i.i432 = shl i32 %26, 8
  store i32 %shl10.i.i432, ptr %Low.i416, align 8, !tbaa !11
  br label %while.cond.i.i419, !llvm.loop !26
...
land.rhs.i.i447:                                  ; preds = %lor.rhs.i.i445
  ...
  store i32 %and.i.i449, ptr %Range.i434, align 8, !tbaa !25
...
while.body.critedge.i.i450:                       ; preds = %land.rhs.i.i447, %while.cond.i.i441
  ...
  store i32 %shl.i.i453, ptr %Range.i434, align 8, !tbaa !25
  %41 = load i32, ptr %Low.i437, align 8, !tbaa !11
  %shl10.i.i454 = shl i32 %41, 8
  store i32 %shl10.i.i454, ptr %Low.i437, align 8, !tbaa !11
  br label %while.cond.i.i441, !llvm.loop !26
...
land.rhs.i.i465:                                  ; preds = %lor.rhs.i.i463
  ...
  store i32 %and.i.i467, ptr %Range.i456, align 8, !tbaa !25
...
while.body.critedge.i.i468:                       ; preds = %land.rhs.i.i465, %while.cond.i.i459
  ...
  store i32 %shl.i.i471, ptr %Range.i456, align 8, !tbaa !25
  %60 = load i32, ptr %Low.i.i, align 8, !tbaa !11
  %shl10.i.i472 = shl i32 %60, 8
  store i32 %shl10.i.i472, ptr %Low.i.i, align 8, !tbaa !11
  br label %while.cond.i.i459, !llvm.loop !26
...
land.rhs.i.i486:                                  ; preds = %lor.rhs.i.i484
  ...
  store i32 %and.i.i488, ptr %Range.i456, align 8, !tbaa !25
...
while.body.critedge.i.i489:                       ; preds = %land.rhs.i.i486, %while.cond.i.i480
  ...
  store i32 %shl.i.i492, ptr %Range.i456, align 8, !tbaa !25
  %68 = load i32, ptr %Low.i476, align 8, !tbaa !11
  %shl10.i.i493 = shl i32 %68, 8
  store i32 %shl10.i.i493, ptr %Low.i476, align 8, !tbaa !11
  br label %while.cond.i.i480, !llvm.loop !26
...
land.rhs.i.i507:                                  ; preds = %lor.rhs.i.i505
  ...
  store i32 %and.i.i509, ptr %Range.i494, align 8, !tbaa !25
...
while.body.critedge.i.i510:                       ; preds = %land.rhs.i.i507, %while.cond.i.i501
  ...
  store i32 %shl.i.i513, ptr %Range.i494, align 8, !tbaa !25
  %104 = load i32, ptr %Low.i497, align 8, !tbaa !11
  %shl10.i.i514 = shl i32 %104, 8
  store i32 %shl10.i.i514, ptr %Low.i497, align 8, !tbaa !11
  br label %while.cond.i.i501, !llvm.loop !26
...
land.rhs.i.i529:                                  ; preds = %lor.rhs.i.i527
  ...
  store i32 %and.i.i531, ptr %Range.i494, align 8, !tbaa !25
...
while.body.critedge.i.i532:                       ; preds = %land.rhs.i.i529, %while.cond.i.i523
  ...
  store i32 %shl.i.i535, ptr %Range.i494, align 8, !tbaa !25
  %118 = load i32, ptr %Low.i497, align 8, !tbaa !11
  %shl10.i.i536 = shl i32 %118, 8
  store i32 %shl10.i.i536, ptr %Low.i497, align 8, !tbaa !11
  br label %while.cond.i.i523, !llvm.loop !26
