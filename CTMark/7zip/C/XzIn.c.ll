; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/XzIn.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/XzIn.c"
...
entry:
  ...
  store i32 0, ptr %headerSizeRes, align 4
...
if.end5:                                          ; preds = %entry
  %0 = load i8, ptr %header, align 16
  %conv = zext i8 %0 to i32
  %shl = shl nuw nsw i32 %conv, 2
  %add = add nuw nsw i32 %shl, 4
  store i32 0, ptr %isIndex, align 4
  store i32 %add, ptr %headerSizeRes, align 4
...
entry:
  ...
  %0 = load i64, ptr %numBlocks, align 8
...
for.cond:                                         ; preds = %for.body
  ...
  %exitcond.not = icmp eq i64 %inc, %0
  br i1 %exitcond.not, label %cleanup3, label %for.body
...
for.body:                                         ; preds = %for.body.lr.ph, %for.cond
  ...
  %2 = load i64, ptr %totalSize, align 8
  %add = add i64 %2, 3
  %and = and i64 %add, -4
...
for.end:                                          ; preds = %for.body, %entry
  ...
  %4 = load ptr, ptr %streams1, align 8
...
for.body.epil:                                    ; preds = %for.end.loopexit.unr-lcssa, %for.body.epil
  ...
  %7 = load i64, ptr %numBlocks.epil, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %for.cond
  ...
  %2 = load i64, ptr %numBlocks.i, align 8
...
for.cond.i:                                       ; preds = %for.body.i
  ...
  br i1 %exitcond.not.i, label %Xz_GetUnpackSize.exit, label %for.body.i
...
cleanup.cont:                                     ; preds = %entry
  %1 = load i64, ptr %endOffset, align 8
  ...
  %2 = load i64, ptr %startOffset, align 8
  %and.i148 = and i64 %2, 3
  %cmp.not.i149 = icmp ne i64 %and.i148, 0
  %cmp1.i150 = icmp slt i64 %2, 12
  %or.cond279.i151 = or i1 %cmp1.i150, %cmp.not.i149
  br i1 %or.cond279.i151, label %Xz_ReadBackward.exit.thread, label %if.end.i.lr.ph
...
if.end.i:                                         ; preds = %if.end.i.lr.ph, %cleanup47
  store i64 -12, ptr %startOffset, align 8
  ...
  br i1 %cmp2.not.i, label %cleanup.cont.i, label %Xz_ReadBackward.exit.thread
...
cleanup.cont.i:                                   ; preds = %if.end.i
  ...
  br i1 %cmp7.not.i, label %cleanup.cont12.i, label %Xz_ReadBackward.exit.thread
...
if.then16.i:                                      ; preds = %cleanup.cont12.i
  %4 = load i64, ptr %startOffset, align 8
  %add.i = add nsw i64 %4, 12
  store i64 %add.i, ptr %startOffset, align 8
  call void @llvm.lifetime.start.p0(i64 1024, ptr nonnull %tempBuf.i) #9
  %cmp17311.i = icmp slt i64 %4, 0
  br i1 %cmp17311.i, label %cleanup98.i, label %if.end21.i

if.end21.i:                                       ; preds = %if.then16.i, %cleanup92.i
  %5 = phi i64 [ %10, %cleanup92.i ], [ %add.i, %if.then16.i ]
  %i.0312.i = phi i64 [ %add23.i, %cleanup92.i ], [ 0, %if.then16.i ]
  %spec.select.i = call i64 @llvm.umin.i64(i64 %5, i64 1024)
  %add23.i = add nuw nsw i64 %spec.select.i, %i.0312.i
  %sub.i = sub nsw i64 0, %spec.select.i
  store i64 %sub.i, ptr %startOffset, align 8
  %6 = load ptr, ptr %Seek, align 8
  %call.i281.i = call i32 %6(ptr noundef %stream, ptr noundef nonnull %startOffset, i32 noundef 1) #9
  %cmp26.not.i = icmp eq i32 %call.i281.i, 0
...
for.body.i:                                       ; preds = %for.cond41.i
  ...
  br i1 %cmp46.not.i, label %for.cond41.i, label %if.then52.i

if.then52.i:                                      ; preds = %for.body.i
  %and53323.i = and i64 %indvars.iv.i, 3
  %cmp54.not.i = icmp eq i64 %and53323.i, 0
...
if.end57.i:                                       ; preds = %if.then52.i
  ...
  %8 = load i64, ptr %startOffset, align 8
  %add59.i = add nsw i64 %8, %conv58.i
  store i64 %add59.i, ptr %startOffset, align 8
...
if.end63.i:                                       ; preds = %if.end57.i
  ...
  store i64 %sub64.i, ptr %startOffset, align 8
  %9 = load ptr, ptr %Seek, align 8
...
cleanup98.i:                                      ; preds = %cleanup.cont83.i, %cleanup.cont73.i, %if.end63.i, %if.end57.i, %if.then52.i, %if.then16.i, %cleanup92.i, %cleanup.cont31.i, %if.end21.i
  %retval.7.ph.i = phi i32 [ %call34.i, %cleanup.cont31.i ], [ %call.i281.i, %if.end21.i ], [ 17, %cleanup92.i ], [ 17, %if.then16.i ], [ %call76.i, %cleanup.cont73.i ], [ %call66.i, %if.end63.i ], [ 17, %if.then52.i ], [ 17, %if.end57.i ], [ 17, %cleanup.cont83.i ]
  call void @llvm.lifetime.end.p0(i64 1024, ptr nonnull %tempBuf.i) #9
  br label %Xz_ReadBackward.exit.thread

if.end101.i:                                      ; preds = %cleanup98.thread.i, %cleanup.cont12.i
  %11 = load i8, ptr %add.ptr103.i, align 4
  %conv106.i = zext i8 %11 to i16
  %shl.i = shl nuw i16 %conv106.i, 8
  %12 = load i8, ptr %arrayidx109.i, align 1
  %conv110.i = zext i8 %12 to i16
  %or.i = or i16 %shl.i, %conv110.i
  store i16 %or.i, ptr %st, align 8
  %cmp114.i = icmp ult i16 %or.i, 16
  br i1 %cmp114.i, label %if.end117.i, label %Xz_ReadBackward.exit.thread
...
if.end117.i:                                      ; preds = %if.end101.i
  ...
  br i1 %cmp122.not.i, label %if.end125.i, label %Xz_ReadBackward.exit.thread

if.end125.i:                                      ; preds = %if.end117.i
  %14 = load i32, ptr %add.ptr120.i, align 4
  %conv128.i = zext i32 %14 to i64
  %add129.i = shl nuw nsw i64 %conv128.i, 2
  %sub132.i = sub nuw nsw i64 -16, %add129.i
  store i64 %sub132.i, ptr %startOffset, align 8
  %15 = load ptr, ptr %Seek, align 8
  %call.i283.i = call i32 %15(ptr noundef nonnull %stream, ptr noundef nonnull %startOffset, i32 noundef 1) #9
  %cmp135.not.i = icmp eq i32 %call.i283.i, 0
  br i1 %cmp135.not.i, label %cleanup.cont141.i, label %Xz_ReadBackward.exit.thread

cleanup.cont141.i:                                ; preds = %if.end125.i
  %shl130.i = add nuw nsw i64 %add129.i, 4
  %cmp.i = icmp ugt i32 %14, 536870911
  br i1 %cmp.i, label %Xz_ReadBackward.exit.thread, label %if.end3.i
...
if.end3.i:                                        ; preds = %cleanup.cont141.i
  ...
  br i1 %cmp4.i, label %Xz_ReadBackward.exit.thread, label %if.end6.i
...
lor.lhs.false.i.i:                                ; preds = %if.then9.i
  %17 = load i8, ptr %call.i94, align 1
...
cleanup22.i.i:                                    ; preds = %if.end6.i.i
  %19 = load i64, ptr %numBlocks64.i.i, align 8
...
if.then27.i.i:                                    ; preds = %cleanup.cont24.i.i
  store i64 %19, ptr %numBlocks28.i.i, align 8
  store i64 %19, ptr %numBlocksAllocated.i.i, align 8
  ...
  store ptr %call30.i.i, ptr %blocks.i.i98, align 8
  %cmp32.i.i = icmp eq ptr %call30.i.i, null
  br i1 %cmp32.i.i, label %Xz_ReadIndex.exit.thread108, label %for.body.i.i99

for.cond.i.i101:                                  ; preds = %cleanup71.i.i
  %inc.i.i102 = add nuw i64 %i.0154.i.i, 1
  %conv61.i.i = zext i32 %call56.i.i to i64
  %add62.i.i = add i64 %add49.i.i, %conv61.i.i
  %exitcond.not.i.i103 = icmp eq i64 %inc.i.i102, %19
  br i1 %exitcond.not.i.i103, label %while.cond.i.i, label %for.body.i.i99

for.body.i.i99:                                   ; preds = %if.then27.i.i, %for.cond.i.i101
  %i.0154.i.i = phi i64 [ %inc.i.i102, %for.cond.i.i101 ], [ 0, %if.then27.i.i ]
  %pos.1153.i.i = phi i64 [ %add62.i.i, %for.cond.i.i101 ], [ %add.i.i97, %if.then27.i.i ]
  %21 = load ptr, ptr %blocks.i.i98, align 8
  %add.ptr41.i.i = getelementptr inbounds i8, ptr %call.i94, i64 %pos.1153.i.i
  %sub42.i.i = sub i64 %add129.i, %pos.1153.i.i
  %totalSize.i.i100 = getelementptr inbounds %struct.CXzBlockSizes, ptr %21, i64 %i.0154.i.i, i32 1
  %call43.i.i = call i32 @Xz_ReadVarInt(ptr noundef nonnull %add.ptr41.i.i, i64 noundef %sub42.i.i, ptr noundef nonnull %totalSize.i.i100) #9
  %cmp44.not.i.i = icmp eq i32 %call43.i.i, 0
  br i1 %cmp44.not.i.i, label %Xz_ReadIndex.exit.thread108, label %cleanup.cont52.i.i

cleanup.cont52.i.i:                               ; preds = %for.body.i.i99
  %conv48.i.i = zext i32 %call43.i.i to i64
  %add49.i.i = add i64 %pos.1153.i.i, %conv48.i.i
  %arrayidx39.i.i = getelementptr inbounds %struct.CXzBlockSizes, ptr %21, i64 %i.0154.i.i
...
cleanup71.i.i:                                    ; preds = %cleanup.cont52.i.i
  %22 = load i64, ptr %totalSize.i.i100, align 8
...
while.body.i.i:                                   ; preds = %while.cond.i.i
  ...
  %23 = load i8, ptr %arrayidx78.i.i, align 1
  %cmp80.not.i.i = icmp eq i8 %23, 0
  br i1 %cmp80.not.i.i, label %while.cond.i.i.1, label %Xz_ReadIndex.exit.thread108
...
while.body.i.i.1:                                 ; preds = %while.cond.i.i.1
  ...
  %24 = load i8, ptr %arrayidx78.i.i.1, align 1
  %cmp80.not.i.i.1 = icmp eq i8 %24, 0
  br i1 %cmp80.not.i.i.1, label %while.cond.i.i.2, label %Xz_ReadIndex.exit.thread108
...
while.body.i.i.2:                                 ; preds = %while.cond.i.i.2
  ...
  %25 = load i8, ptr %arrayidx78.i.i.2, align 1
  %cmp80.not.i.i.2 = icmp eq i8 %25, 0
  br i1 %cmp80.not.i.i.2, label %while.cond.i.i.3, label %Xz_ReadIndex.exit.thread108
...
Xz_ReadIndex.exit.thread108:                      ; preds = %if.end6.i, %while.end.i.i, %cleanup22.i.i, %lor.lhs.false.i.i, %if.then9.i, %if.end.i.i, %if.then27.i.i, %for.body.i.i99, %cleanup.cont52.i.i, %cleanup71.i.i, %while.cond.i.i.3, %while.body.i.i, %while.body.i.i.1, %while.body.i.i.2, %cleanup22.thread.i.i
  %res.0.i.ph = phi i32 [ 16, %cleanup22.thread.i.i ], [ 16, %while.body.i.i.2 ], [ 16, %while.body.i.i.1 ], [ 16, %while.body.i.i ], [ 16, %while.cond.i.i.3 ], [ 16, %cleanup71.i.i ], [ 16, %cleanup.cont52.i.i ], [ 16, %for.body.i.i99 ], [ %call7.i95, %if.end6.i ], [ 16, %while.end.i.i ], [ 16, %cleanup22.i.i ], [ 16, %lor.lhs.false.i.i ], [ 16, %if.then9.i ], [ 16, %if.end.i.i ], [ 2, %if.then27.i.i ]
  %26 = load ptr, ptr %Free.i, align 8
  call void %26(ptr noundef nonnull %alloc, ptr noundef nonnull %call.i94) #9
  br label %Xz_ReadBackward.exit.thread

cleanup.cont150.i:                                ; preds = %while.end.i.i
  %27 = load ptr, ptr %Free.i, align 8
  call void %27(ptr noundef nonnull %alloc, ptr noundef nonnull %call.i94) #9
  %28 = load i64, ptr %numBlocks28.i.i, align 8
...
for.body.lr.ph.i.i:                               ; preds = %cleanup.cont150.i
  %29 = load ptr, ptr %blocks.i.i98, align 8
  br label %for.body.i.i

for.cond.i.i:                                     ; preds = %for.body.i.i
  %inc.i.i = add nuw i64 %i.013.i.i, 1
  %exitcond.not.i.i = icmp eq i64 %inc.i.i, %28
  br i1 %exitcond.not.i.i, label %Xz_GetPackSize.exit.i, label %for.body.i.i
...
for.body.i.i:                                     ; preds = %for.cond.i.i, %for.body.lr.ph.i.i
  ...
  %30 = load i64, ptr %totalSize.i.i, align 8
  ...
  br i1 %cmp2.not.i.i, label %Xz_ReadBackward.exit.thread, label %for.cond.i.i
...
Xz_GetPackSize.exit.i:                            ; preds = %for.cond.i.i, %cleanup.cont150.i
  ...
  br i1 %or.cond210.i, label %Xz_ReadBackward.exit.thread, label %cleanup174.i

cleanup174.i:                                     ; preds = %Xz_GetPackSize.exit.i
  %sub164.i = sub nsw i64 0, %add153.i
  store i64 %sub164.i, ptr %startOffset, align 8
  %31 = load ptr, ptr %Seek, align 8
  %call.i285.i = call i32 %31(ptr noundef %stream, ptr noundef nonnull %startOffset, i32 noundef 1) #9
  %cmp167.not.i = icmp eq i32 %call.i285.i, 0
  br i1 %cmp167.not.i, label %cleanup.cont177.i, label %Xz_ReadBackward.exit.thread

cleanup.cont177.i:                                ; preds = %cleanup174.i
  ...
  store ptr %stream, ptr %realStream.i, align 8
  ...
  br i1 %cmp.not.i91, label %cleanup.cont.i92, label %Xz_ReadHeader.exit.thread

cleanup.cont.i92:                                 ; preds = %cleanup.cont177.i
  %bcmp.i93 = call i32 @bcmp(ptr noundef nonnull dereferenceable(6) %sig.i, ptr noundef nonnull dereferenceable(6) @XZ_SIG, i64 6)
  %cmp3.not.i = icmp eq i32 %bcmp.i93, 0
  br i1 %cmp3.not.i, label %Xz_ReadHeader.exit, label %Xz_ReadHeader.exit.thread

Xz_ReadHeader.exit.thread:                        ; preds = %cleanup.cont177.i, %cleanup.cont.i92
  %retval.1.i.ph = phi i32 [ 17, %cleanup.cont.i92 ], [ %call.i, %cleanup.cont177.i ]
  call void @llvm.lifetime.end.p0(i64 12, ptr nonnull %sig.i) #9
  br label %Xz_ReadBackward.exit.thread120

Xz_ReadHeader.exit:                               ; preds = %cleanup.cont.i92
  ...
  br i1 %cmp180.not.i, label %cleanup.cont186.i, label %Xz_ReadBackward.exit.thread120

cleanup.cont186.i:                                ; preds = %Xz_ReadHeader.exit
  %32 = load i16, ptr %st, align 8
  %33 = load i16, ptr %headerFlags.i, align 2
  %cmp190.i = icmp eq i16 %32, %33
  br i1 %cmp190.i, label %cleanup.cont9, label %Xz_ReadBackward.exit.thread120

Xz_ReadBackward.exit.thread:                      ; preds = %if.end3.i, %cleanup.cont141.i, %Xz_GetPackSize.exit.i, %if.end117.i, %if.end101.i, %cleanup47, %if.end.i, %cleanup.cont.i, %if.end125.i, %cleanup174.i, %for.body.i.i, %cleanup.cont, %cleanup98.i, %Xz_ReadIndex.exit.thread108
  %retval.15.i.ph = phi i32 [ %res.0.i.ph, %Xz_ReadIndex.exit.thread108 ], [ %retval.7.ph.i, %cleanup98.i ], [ 17, %cleanup.cont ], [ 16, %for.body.i.i ], [ 2, %if.end3.i ], [ 4, %cleanup.cont141.i ], [ 16, %Xz_GetPackSize.exit.i ], [ 16, %if.end117.i ], [ 4, %if.end101.i ], [ 17, %cleanup47 ], [ %call.i.i, %if.end.i ], [ %call6.i, %cleanup.cont.i ], [ %call.i283.i, %if.end125.i ], [ %call.i285.i, %cleanup174.i ]
  call void @llvm.lifetime.end.p0(i64 12, ptr nonnull %buf.i) #9
  br label %cleanup47.thread

Xz_ReadBackward.exit.thread120:                   ; preds = %cleanup.cont186.i, %Xz_ReadHeader.exit, %Xz_ReadHeader.exit.thread
...
cleanup.cont9:                                    ; preds = %cleanup.cont186.i
  ...
  call void @llvm.lifetime.end.p0(i64 2, ptr nonnull %headerFlags.i) #9
  call void @llvm.lifetime.end.p0(i64 12, ptr nonnull %buf.i) #9
  %34 = load i64, ptr %startOffset, align 8
  store i64 %34, ptr %startOffset2, align 8
  %35 = load i64, ptr %p, align 8
  %36 = load i64, ptr %numAllocated, align 8
...
cleanup.cont9.if.end28_crit_edge:                 ; preds = %cleanup.cont9
  %.pre = load ptr, ptr %streams, align 8
  br label %if.end28
...
cleanup24:                                        ; preds = %if.then11
  store i64 %add14, ptr %numAllocated, align 8
  %38 = load ptr, ptr %streams, align 8
  %39 = load i64, ptr %p, align 8
  %mul21 = mul i64 %39, 40
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %call15, ptr align 8 %38, i64 %mul21, i1 false)
  %40 = load ptr, ptr %Free.i, align 8
  %41 = load ptr, ptr %streams, align 8
  call void %40(ptr noundef nonnull %alloc, ptr noundef %41) #9
  store ptr %call15, ptr %streams, align 8
  %.pre178 = load i64, ptr %p, align 8
  br label %if.end28

if.end28:                                         ; preds = %cleanup.cont9.if.end28_crit_edge, %cleanup24
  %42 = phi i64 [ %35, %cleanup.cont9.if.end28_crit_edge ], [ %.pre178, %cleanup24 ]
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %arrayidx, ptr noundef nonnull align 8 dereferenceable(40) %st, i64 40, i1 false)
  %44 = load i64, ptr %startOffset, align 8
  %cmp31 = icmp eq i64 %44, 0
  br i1 %cmp31, label %for.end, label %if.end33

if.end33:                                         ; preds = %if.end28
  %45 = load ptr, ptr %Seek, align 8
...
land.lhs.true:                                    ; preds = %cleanup.cont42
  %46 = load ptr, ptr %progress, align 8
  %47 = load i64, ptr %endOffset, align 8
  %48 = load i64, ptr %startOffset, align 8
...
cleanup47.thread:                                 ; preds = %if.end33, %land.lhs.true, %if.then11, %Xz_ReadBackward.exit.thread, %Xz_ReadBackward.exit.thread120
  %retval.6.ph = phi i32 [ %retval.14.i.ph, %Xz_ReadBackward.exit.thread120 ], [ %retval.15.i.ph, %Xz_ReadBackward.exit.thread ], [ 2, %if.then11 ], [ %call36, %if.end33 ], [ 10, %land.lhs.true ]
...
cleanup47:                                        ; preds = %cleanup.cont42, %land.lhs.true
  ...
  call void @Xz_Construct(ptr noundef nonnull %st) #9
  call void @llvm.lifetime.start.p0(i64 12, ptr nonnull %buf.i) #9
  %49 = load i64, ptr %startOffset, align 8
  %and.i = and i64 %49, 3
  %cmp.not.i = icmp ne i64 %and.i, 0
  %cmp1.i = icmp slt i64 %49, 12
  %or.cond279.i = or i1 %cmp1.i, %cmp.not.i
  br i1 %or.cond279.i, label %Xz_ReadBackward.exit.thread, label %if.end.i
