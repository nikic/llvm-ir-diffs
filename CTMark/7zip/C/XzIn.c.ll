...
for.cond.i.i101:                                  ; preds = %cleanup71.i.i
  ...
  br i1 %exitcond.not.i.i103, label %while.cond.i.i, label %for.body.i.i99, !llvm.loop !40
...
cleanup71.i.i:                                    ; preds = %cleanup.cont52.i.i
  %22 = load i64, ptr %totalSize.i.i100, align 8, !tbaa !22
...
cleanup24:                                        ; preds = %if.then11
  ...
  %.pre178 = load i64, ptr %p, align 8, !tbaa !23
  br label %if.end28
