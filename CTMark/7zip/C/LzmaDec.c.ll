; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/LzmaDec.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/LzmaDec.c"
...
if.then2:                                         ; preds = %if.end
  ...
  store i32 1, ptr %needInitState3, align 4
  br label %if.end4
...
entry:
  %p399 = ptrtoint ptr %p to i64
  %0 = load i64, ptr %srcLen, align 8
  store i64 0, ptr %srcLen, align 8
  %remainLen.i = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 12
  %1 = load i32, ptr %remainLen.i, align 4
  %2 = add i32 %1, -1
...
if.then.i:                                        ; preds = %entry
  ...
  %checkDicSize.i = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 9
  %7 = load i32, ptr %checkDicSize.i, align 4
...
if.then.if.end22_crit_edge.i:                     ; preds = %if.then.i
  ...
  %.pre.i = load i32, ptr %processedPos23.phi.trans.insert.i, align 8
  br label %if.end22.i

land.lhs.true14.i:                                ; preds = %if.then.i
  %dicSize.i = getelementptr inbounds %struct._CLzmaProps, ptr %p, i64 0, i32 3
  %8 = load i32, ptr %dicSize.i, align 4
  %processedPos.i = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 8
  %9 = load i32, ptr %processedPos.i, align 8
  %sub15.i = sub i32 %8, %9
...
if.then18.i:                                      ; preds = %land.lhs.true14.i
  store i32 %8, ptr %checkDicSize.i, align 4
  br label %if.end22.i
...
if.end22.i:                                       ; preds = %if.then18.i, %land.lhs.true14.i, %if.then.if.end22_crit_edge.i
  ...
  store i32 %add.i, ptr %processedPos23.i, align 8
  %sub25.i = sub i32 %1, %spec.select.i
  store i32 %sub25.i, ptr %remainLen.i, align 4
...
while.body.i.prol:                                ; preds = %while.body.lr.ph.i
  ...
  %11 = load i8, ptr %arrayidx34.i.prol, align 1
  %arrayidx35.i.prol = getelementptr inbounds i8, ptr %3, i64 %4
  store i8 %11, ptr %arrayidx35.i.prol, align 1
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  %14 = load i8, ptr %arrayidx34.i.1, align 1
  %arrayidx35.i.1 = getelementptr inbounds i8, ptr %3, i64 %inc.i
  store i8 %14, ptr %arrayidx35.i.1, align 1
  %inc.i.1 = add i64 %dicPos.067.i, 2
  %cmp26.not.i.1 = icmp eq i32 %dec.i.1, 0
  br i1 %cmp26.not.i.1, label %while.end.i, label %while.body.i
...
while.end.i:                                      ; preds = %while.body.i.prol.loopexit, %while.body.i, %if.end22.i
  ...
  store i64 %dicPos.0.lcssa.i, ptr %dicPos4.i, align 8
  br label %LzmaDec_WriteRem.exit

LzmaDec_WriteRem.exit:                            ; preds = %entry, %while.end.i
  store i32 0, ptr %status, align 4
  %15 = load i32, ptr %remainLen.i, align 4
  %cmp.not328 = icmp eq i32 %15, 274
  br i1 %cmp.not328, label %while.end153, label %while.body.lr.ph
...
while.body:                                       ; preds = %while.body.lr.ph, %cleanup150
  ...
  %inSize.0329 = phi i64 [ %0, %while.body.lr.ph ], [ %inSize.6, %cleanup150 ]
  %18 = load i32, ptr %needFlush, align 8
  %cmp1.not = icmp eq i32 %18, 0
  br i1 %cmp1.not, label %if.end17, label %for.cond.preheader

for.cond.preheader:                               ; preds = %while.body
  %cmp2.not312 = icmp eq i64 %inSize.0329, 0
  %.pre = load i32, ptr %tempBufSize, align 4
  br i1 %cmp2.not312, label %for.end, label %land.rhs.lr.ph

land.rhs.lr.ph:                                   ; preds = %for.cond.preheader
  %umax = tail call i32 @llvm.umax.i32(i32 %.pre, i32 5)
  %wide.trip.count = zext i32 %umax to i64
  %exitcond.not390 = icmp ugt i32 %.pre, 4
  br i1 %exitcond.not390, label %for.end, label %for.body.lr.ph

for.body.lr.ph:                                   ; preds = %land.rhs.lr.ph
  %19 = zext i32 %.pre to i64
  %incdec.ptr = getelementptr inbounds i8, ptr %src.addr.0330, i64 1
  %20 = load i8, ptr %src.addr.0330, align 1
  %indvars.iv.next = add nuw nsw i64 %19, 1
  %21 = trunc i64 %indvars.iv.next to i32
  store i32 %21, ptr %tempBufSize, align 4
  %arrayidx = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 17, i64 %19
  store i8 %20, ptr %arrayidx, align 1
  %22 = load i64, ptr %srcLen, align 8
  %inc5 = add i64 %22, 1
  store i64 %inc5, ptr %srcLen, align 8
  %dec = add i64 %inSize.0329, -1
  %cmp2.not = icmp eq i64 %dec, 0
  br i1 %cmp2.not, label %for.end, label %land.rhs
...
for.body.1:                                       ; preds = %land.rhs
  ...
  %indvars.iv.next.1 = add nuw nsw i64 %19, 2
  %24 = trunc i64 %indvars.iv.next.1 to i32
  store i32 %24, ptr %tempBufSize, align 4
  %arrayidx.1 = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 17, i64 %indvars.iv.next
  store i8 %23, ptr %arrayidx.1, align 1
  %25 = load i64, ptr %srcLen, align 8
  %inc5.1 = add i64 %25, 1
  store i64 %inc5.1, ptr %srcLen, align 8
  %dec.1 = add i64 %inSize.0329, -2
  %cmp2.not.1 = icmp eq i64 %dec.1, 0
  br i1 %cmp2.not.1, label %for.end, label %land.rhs.1
...
for.body.2:                                       ; preds = %land.rhs.1
  ...
  %26 = load i8, ptr %incdec.ptr.1, align 1
  %indvars.iv.next.2 = add nuw nsw i64 %19, 3
  %27 = trunc i64 %indvars.iv.next.2 to i32
  store i32 %27, ptr %tempBufSize, align 4
  %arrayidx.2 = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 17, i64 %indvars.iv.next.1
  store i8 %26, ptr %arrayidx.2, align 1
  %28 = load i64, ptr %srcLen, align 8
  %inc5.2 = add i64 %28, 1
  store i64 %inc5.2, ptr %srcLen, align 8
  %dec.2 = add i64 %inSize.0329, -3
  %cmp2.not.2 = icmp eq i64 %dec.2, 0
  br i1 %cmp2.not.2, label %for.end, label %land.rhs.2
...
for.body.3:                                       ; preds = %land.rhs.2
  ...
  %indvars.iv.next.3 = add nuw nsw i64 %19, 4
  %30 = trunc i64 %indvars.iv.next.3 to i32
  store i32 %30, ptr %tempBufSize, align 4
  ...
  %31 = load i64, ptr %srcLen, align 8
  %inc5.3 = add i64 %31, 1
  store i64 %inc5.3, ptr %srcLen, align 8
  %dec.3 = add i64 %inSize.0329, -4
  %cmp2.not.3 = icmp eq i64 %dec.3, 0
  br i1 %cmp2.not.3, label %for.end, label %land.rhs.3

land.rhs.3:                                       ; preds = %for.body.3
  %exitcond.not.3 = icmp eq i64 %indvars.iv.next.3, %wide.trip.count
  br i1 %exitcond.not.3, label %for.end, label %for.body.4

for.body.4:                                       ; preds = %land.rhs.3
  %incdec.ptr.4 = getelementptr inbounds i8, ptr %src.addr.0330, i64 5
  %32 = load i8, ptr %incdec.ptr.3, align 1
  %indvars.iv.next.4 = add i32 %.pre, 5
  store i32 %indvars.iv.next.4, ptr %tempBufSize, align 4
  %arrayidx.4 = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 17, i64 %indvars.iv.next.3
  store i8 %32, ptr %arrayidx.4, align 1
  %33 = load i64, ptr %srcLen, align 8
  %inc5.4 = add i64 %33, 1
  store i64 %inc5.4, ptr %srcLen, align 8
  %dec.4 = add i64 %inSize.0329, -5
  %cmp2.not.4 = icmp eq i64 %dec.4, 0
  %spec.select = select i1 %cmp2.not.4, i64 0, i64 %dec.4
  br label %for.end

for.end:                                          ; preds = %for.body.4, %for.body.lr.ph, %land.rhs, %for.body.1, %land.rhs.1, %for.body.2, %land.rhs.2, %for.body.3, %land.rhs.3, %land.rhs.lr.ph, %for.cond.preheader
  %34 = phi i32 [ %.pre, %for.cond.preheader ], [ %.pre, %land.rhs.lr.ph ], [ %21, %land.rhs ], [ %21, %for.body.lr.ph ], [ %24, %for.body.1 ], [ %24, %land.rhs.1 ], [ %27, %for.body.2 ], [ %27, %land.rhs.2 ], [ %30, %for.body.3 ], [ %30, %land.rhs.3 ], [ %indvars.iv.next.4, %for.body.4 ]
  %inSize.1.lcssa = phi i64 [ 0, %for.cond.preheader ], [ %inSize.0329, %land.rhs.lr.ph ], [ %dec, %land.rhs ], [ 0, %for.body.lr.ph ], [ 0, %for.body.1 ], [ %dec.1, %land.rhs.1 ], [ 0, %for.body.2 ], [ %dec.2, %land.rhs.2 ], [ 0, %for.body.3 ], [ %dec.3, %land.rhs.3 ], [ %spec.select, %for.body.4 ]
  %src.addr.1.lcssa = phi ptr [ %src.addr.0330, %for.cond.preheader ], [ %src.addr.0330, %land.rhs.lr.ph ], [ %incdec.ptr, %land.rhs ], [ %incdec.ptr, %for.body.lr.ph ], [ %incdec.ptr.1, %for.body.1 ], [ %incdec.ptr.1, %land.rhs.1 ], [ %incdec.ptr.2, %for.body.2 ], [ %incdec.ptr.2, %land.rhs.2 ], [ %incdec.ptr.3, %for.body.3 ], [ %incdec.ptr.3, %land.rhs.3 ], [ %incdec.ptr.4, %for.body.4 ]
...
if.end:                                           ; preds = %for.end
  %35 = load i8, ptr %tempBuf9, align 8
...
if.end14:                                         ; preds = %if.end
  ...
  %37 = load i8, ptr %arrayidx1.i, align 1
  ...
  store i32 %or10.i, ptr %code.i, align 4
  store i32 -1, ptr %range.i, align 8
  store i32 0, ptr %needFlush, align 8
  store i32 0, ptr %tempBufSize, align 4
  br label %if.end17

if.end17:                                         ; preds = %if.end14, %while.body
  %inSize.2 = phi i64 [ %inSize.1.lcssa, %if.end14 ], [ %inSize.0329, %while.body ]
  %src.addr.2 = phi ptr [ %src.addr.1.lcssa, %if.end14 ], [ %src.addr.0330, %while.body ]
  %inSize.2.fr = freeze i64 %inSize.2
  %src.addr.2400 = ptrtoint ptr %src.addr.2 to i64
  %40 = load i64, ptr %dicPos, align 8
...
if.end37:                                         ; preds = %if.end27, %if.end17
  %42 = load i32, ptr %needInitState, align 4
...
if.then38:                                        ; preds = %if.end37
  ...
  %44 = load i32, ptr %lp.i, align 4
  %add.i269 = add i32 %44, %43
  %shl.i270 = shl i32 768, %add.i269
  %add2.i = add i32 %shl.i270, 1846
  %45 = load ptr, ptr %probs3.i, align 8
  %umax.i = tail call i32 @llvm.umax.i32(i32 %add2.i, i32 1)
  %wide.trip.count.i = zext i32 %umax.i to i64
  %n.vec407 = add nsw i64 %wide.trip.count.i, -6
  br label %vector.body410

vector.body410:                                   ; preds = %vector.body410, %if.then38
  %index411 = phi i64 [ 0, %if.then38 ], [ %index.next412, %vector.body410 ]
  %46 = getelementptr inbounds i16, ptr %45, i64 %index411
  ...
  %index.next412 = add nuw i64 %index411, 16
  %48 = icmp eq i64 %index.next412, %n.vec407
  br i1 %48, label %for.body.i, label %vector.body410

for.body.i:                                       ; preds = %vector.body410
  %arrayidx.i271 = getelementptr inbounds i16, ptr %45, i64 %n.vec407
  store i16 1024, ptr %arrayidx.i271, align 2
  %indvars.iv.next.i = add nsw i64 %wide.trip.count.i, -5
  %arrayidx.i271.1 = getelementptr inbounds i16, ptr %45, i64 %indvars.iv.next.i
  store i16 1024, ptr %arrayidx.i271.1, align 2
  ...
  store i16 1024, ptr %arrayidx.i271.2, align 2
  ...
  store i16 1024, ptr %arrayidx.i271.3, align 2
  ...
  store i16 1024, ptr %arrayidx.i271.4, align 2
  ...
  store i16 1024, ptr %arrayidx.i271.5, align 2
  store i32 1, ptr %arrayidx4.i273, align 4
  store <4 x i32> <i32 0, i32 1, i32 1, i32 1>, ptr %state.i, align 8
  store i32 0, ptr %needInitState, align 4
  br label %if.end39

if.end39:                                         ; preds = %for.body.i, %if.end37
  %49 = load i32, ptr %tempBufSize, align 4
  %cmp41 = icmp eq i32 %49, 0
  br i1 %cmp41, label %if.then43, label %while.cond78.preheader

while.cond78.preheader:                           ; preds = %if.end39
  %cmp79319 = icmp ult i32 %49, 20
  %cmp83320 = icmp ne i64 %inSize.2.fr, 0
  %50 = and i1 %cmp79319, %cmp83320
...
while.body86.preheader:                           ; preds = %while.cond78.preheader
  ...
  br i1 %min.iters.check, label %while.body86.preheader413, label %vector.memcheck

vector.memcheck:                                  ; preds = %while.body86.preheader
  %55 = add i64 %16, %51
  %56 = sub i64 %55, %src.addr.2400
  %diff.check = icmp ult i64 %56, 16
  br i1 %diff.check, label %while.body86.preheader413, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %59, align 1
  %60 = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 17, i64 %offset.idx
  store <16 x i8> %wide.load, ptr %60, align 1
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %while.end.loopexit, label %while.body86.preheader413

while.body86.preheader413:                        ; preds = %vector.memcheck, %while.body86.preheader, %middle.block
  %indvars.iv352.ph = phi i64 [ %51, %vector.memcheck ], [ %51, %while.body86.preheader ], [ %ind.end, %middle.block ]
  %indvars.iv350.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %while.body86.preheader ], [ %n.vec, %middle.block ]
...
if.then50:                                        ; preds = %if.then47
  ...
  store i32 %conv53, ptr %tempBufSize, align 4
...
if.end63:                                         ; preds = %if.end55, %if.else
  ...
  store ptr %src.addr.2, ptr %buf123, align 8
...
cleanup72:                                        ; preds = %if.end63
  %65 = load ptr, ptr %buf123, align 8
  %sub.ptr.lhs.cast = ptrtoint ptr %65 to i64
  %sub.ptr.rhs.cast = ptrtoint ptr %src.addr.2 to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  %66 = load i64, ptr %srcLen, align 8
  %add70 = add i64 %sub.ptr.sub, %66
  store i64 %add70, ptr %srcLen, align 8
  br label %cleanup150

while.body86:                                     ; preds = %while.body86.preheader413, %while.body86
  %indvars.iv352 = phi i64 [ %indvars.iv.next353, %while.body86 ], [ %indvars.iv352.ph, %while.body86.preheader413 ]
  %indvars.iv350 = phi i64 [ %indvars.iv.next351, %while.body86 ], [ %indvars.iv350.ph, %while.body86.preheader413 ]
  %indvars.iv.next351 = add nuw nsw i64 %indvars.iv350, 1
  %arrayidx89 = getelementptr inbounds i8, ptr %src.addr.2, i64 %indvars.iv350
  %67 = load i8, ptr %arrayidx89, align 1
  %indvars.iv.next353 = add nuw nsw i64 %indvars.iv352, 1
  %arrayidx93 = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 17, i64 %indvars.iv352
  store i8 %67, ptr %arrayidx93, align 1
  %cmp79 = icmp ult i64 %indvars.iv352, 19
  %cmp83 = icmp ugt i64 %inSize.2.fr, %indvars.iv.next351
  %68 = select i1 %cmp79, i1 %cmp83, i1 false
  br i1 %68, label %while.body86, label %while.end.loopexit

while.end.loopexit:                               ; preds = %while.body86, %middle.block
  %indvars.iv.next351.lcssa = phi i64 [ %n.vec, %middle.block ], [ %indvars.iv.next351, %while.body86 ]
  %indvars.iv.next353.lcssa = phi i64 [ %ind.end, %middle.block ], [ %indvars.iv.next353, %while.body86 ]
  %cmp79.lcssa374 = phi i1 [ %63, %middle.block ], [ %cmp79, %while.body86 ]
  %69 = trunc i64 %indvars.iv.next353.lcssa to i32
  %70 = trunc i64 %indvars.iv.next351.lcssa to i32
  br label %while.end
...
while.end:                                        ; preds = %while.end.loopexit, %while.cond78.preheader
  ...
  %cmp79.lcssa = phi i1 [ %cmp79319, %while.cond78.preheader ], [ %cmp79.lcssa374, %while.end.loopexit ]
  %conv82.lcssa = phi i64 [ 0, %while.cond78.preheader ], [ %indvars.iv.next351.lcssa, %while.end.loopexit ]
  store i32 %rem.0.lcssa, ptr %tempBufSize, align 4
...
if.then107:                                       ; preds = %if.then99
  %71 = load i64, ptr %srcLen, align 8
  %add109 = add i64 %71, %conv82.lcssa
  store i64 %add109, ptr %srcLen, align 8
  store i32 3, ptr %status, align 4
  br label %cleanup162
...
if.end120:                                        ; preds = %if.end110, %while.end
  store ptr %tempBuf9, ptr %buf123, align 8
...
cleanup145:                                       ; preds = %if.end120
  %72 = load ptr, ptr %buf123, align 8
  ...
  %73 = load i64, ptr %srcLen, align 8
  %add140 = add i64 %73, %conv139
  store i64 %add140, ptr %srcLen, align 8
  store i32 0, ptr %tempBufSize, align 4
  br label %cleanup150
...
cleanup150:                                       ; preds = %cleanup72, %cleanup145
  ...
  %74 = load i32, ptr %remainLen.i, align 4
  %cmp.not = icmp eq i32 %74, 274
  br i1 %cmp.not, label %while.end153, label %while.body

while.end153:                                     ; preds = %cleanup150, %LzmaDec_WriteRem.exit
  %code154 = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 5
  %75 = load i32, ptr %code154, align 4
  %cmp155 = icmp eq i32 %75, 0
  br i1 %cmp155, label %if.then157, label %cleanup162

if.then157:                                       ; preds = %while.end153
  store i32 1, ptr %status, align 4
  %.pre357 = load i32, ptr %code154, align 4
  %76 = icmp ne i32 %.pre357, 0
  %77 = zext i1 %76 to i32
  br label %cleanup162

cleanup162:                                       ; preds = %if.end120, %if.end63, %if.end, %while.end153, %if.then157, %if.then115, %if.then107, %if.then60, %if.then50, %if.then35, %if.then30, %if.then26, %if.then8
  %retval.9 = phi i32 [ 1, %if.then35 ], [ 0, %if.then30 ], [ 0, %if.then26 ], [ 0, %if.then8 ], [ 1, %if.then60 ], [ 0, %if.then50 ], [ 1, %if.then115 ], [ 0, %if.then107 ], [ %77, %if.then157 ], [ 1, %while.end153 ], [ 1, %if.end ], [ 1, %if.end63 ], [ 1, %if.end120 ]
  ret i32 %retval.9
}
...
entry:
  ...
  %6 = load i16, ptr %add.ptr9, align 2
...
if.then20:                                        ; preds = %if.end17
  ...
  %checkDicSize = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 9
  %8 = load i32, ptr %checkDicSize, align 4
  %9 = or i32 %8, %4
  %or.cond938 = icmp eq i32 %9, 0
  br i1 %or.cond938, label %if.end47, label %if.then27

if.then27:                                        ; preds = %if.then20
  %lp = getelementptr inbounds %struct._CLzmaProps, ptr %p, i64 0, i32 1
  %10 = load i32, ptr %lp, align 4
  ...
  %12 = load ptr, ptr %dic, align 8
  %dicPos = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 6
  %13 = load i64, ptr %dicPos, align 8
...
cond.true:                                        ; preds = %if.then27
  ...
  %14 = load i64, ptr %dicBufSize, align 8
  br label %cond.end
...
do.body:                                          ; preds = %if.end47, %do.cond
  ...
  %16 = load i16, ptr %add.ptr52, align 2
...
if.end60:                                         ; preds = %if.then56
  ...
  %17 = load i8, ptr %buf.addr.1, align 1
...
cond.true92:                                      ; preds = %if.else80
  ...
  %21 = load i64, ptr %dicBufSize93, align 8
  br label %cond.end95
...
cond.end95:                                       ; preds = %if.else80, %cond.true92
  ...
  %22 = load i8, ptr %arrayidx98, align 1
...
do.body101:                                       ; preds = %do.cond142, %cond.end95
  ...
  %23 = load i16, ptr %add.ptr109, align 2
...
if.end117:                                        ; preds = %if.then113
  ...
  %24 = load i8, ptr %buf.addr.4, align 1
...
do.cond142:                                       ; preds = %if.else131, %if.then128
  ...
  br i1 %cmp143, label %do.body101, label %cleanup.thread
...
if.else152:                                       ; preds = %if.end17
  ...
  %25 = load i16, ptr %add.ptr157, align 2
...
if.end165:                                        ; preds = %if.then161
  ...
  %26 = load i8, ptr %buf.addr.0, align 1
...
if.else178:                                       ; preds = %if.end171
  ...
  %27 = load i16, ptr %add.ptr183, align 2
...
if.end191:                                        ; preds = %if.then187
  ...
  %28 = load i8, ptr %buf.addr.8, align 1
...
if.then202:                                       ; preds = %if.end197
  ...
  %29 = load i16, ptr %add.ptr208, align 2
...
if.end216:                                        ; preds = %if.then212
  ...
  %30 = load i8, ptr %buf.addr.9, align 1
...
if.else245:                                       ; preds = %if.end197
  ...
  %31 = load i16, ptr %add.ptr250, align 2
...
if.end258:                                        ; preds = %if.then254
  ...
  %32 = load i8, ptr %buf.addr.9, align 1
...
if.else270:                                       ; preds = %if.end264
  ...
  %33 = load i16, ptr %add.ptr275, align 2
...
if.end283:                                        ; preds = %if.then279
  ...
  %34 = load i8, ptr %buf.addr.12, align 1
...
if.end302:                                        ; preds = %if.else241, %if.else295, %if.end264, %if.end289, %if.end171
  ...
  %35 = load i16, ptr %add.ptr301, align 2
...
if.end311:                                        ; preds = %if.then307
  ...
  %36 = load i8, ptr %buf.addr.15, align 1
...
if.else327:                                       ; preds = %if.end317
  ...
  %37 = load i16, ptr %add.ptr330, align 2
...
if.end338:                                        ; preds = %if.then334
  ...
  %38 = load i8, ptr %buf.addr.16, align 1
...
do.body360:                                       ; preds = %do.cond389, %if.end359
  ...
  %39 = load i16, ptr %add.ptr362, align 2
...
if.end370:                                        ; preds = %if.then366
  ...
  %40 = load i8, ptr %buf.addr.19, align 1
...
do.cond389:                                       ; preds = %if.then381, %if.else383
  ...
  br i1 %cmp390, label %do.body360, label %cleanup.cont399
...
do.body413:                                       ; preds = %do.cond442, %if.then402
  ...
  %41 = load i16, ptr %add.ptr415, align 2
...
if.end423:                                        ; preds = %if.then419
  ...
  %42 = load i8, ptr %buf.addr.22, align 1
...
do.cond442:                                       ; preds = %if.then434, %if.else436
  ...
  br i1 %cmp443, label %do.body413, label %do.end445
...
if.end473:                                        ; preds = %if.then469
  ...
  %43 = load i8, ptr %buf.addr.24, align 1
...
if.end479:                                        ; preds = %if.end473, %do.body466
  ...
  %.inv = icmp slt i32 %sub481, 0
  %and484 = select i1 %.inv, i32 0, i32 %shr480
  %sub485 = sub i32 %code.29, %and484
  %dec = add nsw i32 %numDirectBits.0, -1
  %cmp487.not = icmp eq i32 %dec, 0
  br i1 %cmp487.not, label %do.end489, label %do.body466
...
do.body492:                                       ; preds = %do.cond521, %if.end491
  ...
  %44 = load i16, ptr %add.ptr494, align 2
...
if.end502:                                        ; preds = %if.then498
  ...
  %45 = load i8, ptr %buf.addr.27, align 1
...
do.cond521:                                       ; preds = %if.then513, %if.else515
  ...
  br i1 %cmp523.not, label %cleanup.thread, label %do.body492

cleanup.thread:                                   ; preds = %do.cond521, %do.cond142, %do.cond, %cleanup.cont399, %do.end445
  %res.3.ph = phi i32 [ %res.0, %do.end445 ], [ %res.0, %cleanup.cont399 ], [ 1, %do.cond ], [ 1, %do.cond142 ], [ %res.0, %do.cond521 ]
  %range.41.ph = phi i32 [ %range.27, %do.end445 ], [ %range.23, %cleanup.cont399 ], [ %range.3, %do.cond ], [ %range.8.ph, %do.cond142 ], [ %range.33, %do.cond521 ]
  %buf.addr.36.ph = phi ptr [ %buf.addr.23, %do.end445 ], [ %buf.addr.20, %cleanup.cont399 ], [ %buf.addr.2, %do.cond ], [ %buf.addr.5, %do.cond142 ], [ %buf.addr.28, %do.cond521 ]
  %cmp547933 = icmp ugt i32 %range.41.ph, 16777215
  %cmp550.not934 = icmp ult ptr %buf.addr.36.ph, %add.ptr
  %or.cond935 = select i1 %cmp547933, i1 true, i1 %cmp550.not934
  %spec.select902936 = select i1 %or.cond935, i32 %res.3.ph, i32 0
  br label %cleanup541
...
cleanup541:                                       ; preds = %if.then366, %if.then419, %if.then469, %if.then498, %if.then113, %if.then56, %if.then230, %if.then, %if.then161, %if.then187, %if.then212, %if.then227, %if.then254, %if.then279, %if.then307, %if.then334, %cleanup.thread
  %46 = phi i32 [ %spec.select902936, %cleanup.thread ], [ 0, %if.then ], [ 0, %if.then279 ], [ 0, %if.then254 ], [ 3, %if.then227 ], [ 0, %if.then212 ], [ 0, %if.then187 ], [ 0, %if.then161 ], [ 0, %if.then307 ], [ 0, %if.then334 ], [ %spec.select, %if.then230 ], [ 0, %if.then56 ], [ 0, %if.then113 ], [ 0, %if.then498 ], [ 0, %if.then469 ], [ 0, %if.then419 ], [ 0, %if.then366 ]
  ret i32 %46
}
...
entry:
  ...
  %remainLen.i = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 12
  %.pre.pre = load i64, ptr %dicPos16.i, align 8
  br label %do.body

do.body:                                          ; preds = %land.lhs.true, %entry
  %.pre = phi i64 [ %.pre.pre, %entry ], [ %119, %land.lhs.true ]
  %0 = load i32, ptr %checkDicSize, align 4
  %cmp = icmp eq i32 %0, 0
  %.pre85 = load i32, ptr %processedPos17.i, align 8
  br i1 %cmp, label %if.then, label %if.end7

if.then:                                          ; preds = %do.body
  %1 = load i32, ptr %dicSize, align 4
  %sub = sub i32 %1, %.pre85
  %sub1 = sub i64 %limit, %.pre
  %conv = zext i32 %sub to i64
  %cmp2 = icmp ugt i64 %sub1, %conv
  %add = add i64 %.pre, %conv
  %spec.select = select i1 %cmp2, i64 %add, i64 %limit
  br label %if.end7

if.end7:                                          ; preds = %if.then, %do.body
  %limit2.1 = phi i64 [ %spec.select, %if.then ], [ %limit, %do.body ]
  %2 = load ptr, ptr %probs1.i, align 8
  %3 = load i32, ptr %state2.i, align 8
  %4 = load i32, ptr %reps.i, align 4
  %5 = load i32, ptr %arrayidx4.i, align 4
  %6 = load i32, ptr %arrayidx6.i, align 4
  %7 = load i32, ptr %arrayidx8.i, align 4
  %8 = load i32, ptr %pb.i, align 8
  %notmask.i = shl nsw i32 -1, %8
  %sub.i = xor i32 %notmask.i, -1
  %9 = load i32, ptr %lp.i, align 4
  %notmask1786.i = shl nsw i32 -1, %9
  %sub11.i = xor i32 %notmask1786.i, -1
  %10 = load i32, ptr %p, align 8
  %11 = load ptr, ptr %dic14.i, align 8
  %12 = ptrtoint ptr %11 to i64
  %13 = load i64, ptr %dicBufSize15.i, align 8
  %14 = load ptr, ptr %buf19.i, align 8
  %15 = load i32, ptr %range20.i, align 8
  %16 = load i32, ptr %code21.i, align 4
  %add.ptr175.i = getelementptr inbounds i16, ptr %2, i64 192
  %add.ptr211.i = getelementptr inbounds i16, ptr %2, i64 204
  %add.ptr287.i = getelementptr inbounds i16, ptr %2, i64 216
  %add.ptr315.i = getelementptr inbounds i16, ptr %2, i64 228
  %add.ptr233.i = getelementptr inbounds i16, ptr %2, i64 240
  %add.ptr349.i = getelementptr inbounds i16, ptr %2, i64 1332
  %add.ptr198.i = getelementptr inbounds i16, ptr %2, i64 818
  %add.ptr461.i = getelementptr inbounds i16, ptr %2, i64 432
  %add.ptr767.i = getelementptr inbounds i16, ptr %2, i64 802
  %add.ptr771.i = getelementptr inbounds i16, ptr %2, i64 803
  %add.ptr693.i = getelementptr inbounds i16, ptr %2, i64 688
  %add.ptr36.i = getelementptr inbounds i16, ptr %2, i64 1846
  %sub49.i = sub i32 8, %10
  br label %do.body.i

do.body.i:                                        ; preds = %do.cond1011.i, %if.end7
  %len.0.i = phi i32 [ 0, %if.end7 ], [ %len.7.ph.i, %do.cond1011.i ]
  %buf.0.i = phi ptr [ %14, %if.end7 ], [ %buf.39.ph.i, %do.cond1011.i ]
  %range.0.i = phi i32 [ %15, %if.end7 ], [ %range.54.ph.i, %do.cond1011.i ]
  %code.0.i = phi i32 [ %16, %if.end7 ], [ %code.54.ph.i, %do.cond1011.i ]
  %processedPos.0.i = phi i32 [ %.pre85, %if.end7 ], [ %processedPos.1.ph.i, %do.cond1011.i ]
  %dicPos.0.i = phi i64 [ %.pre, %if.end7 ], [ %dicPos.3.ph.i, %do.cond1011.i ]
  %rep3.0.i = phi i32 [ %7, %if.end7 ], [ %rep3.7.ph.i, %do.cond1011.i ]
  %rep2.0.i = phi i32 [ %6, %if.end7 ], [ %rep2.6.ph.i, %do.cond1011.i ]
  %rep1.0.i = phi i32 [ %5, %if.end7 ], [ %rep1.5.ph.i, %do.cond1011.i ]
  %rep0.0.i = phi i32 [ %4, %if.end7 ], [ %rep0.5.ph.i, %do.cond1011.i ]
  %state.0.i = phi i32 [ %3, %if.end7 ], [ %state.7.ph.i, %do.cond1011.i ]
  %and.i = and i32 %processedPos.0.i, %sub.i
  %shl22.i = shl i32 %state.0.i, 4
  %idx.ext.i = zext i32 %shl22.i to i64
  %add.ptr23.i = getelementptr inbounds i16, ptr %2, i64 %idx.ext.i
  %idx.ext24.i = zext i32 %and.i to i64
  %add.ptr25.i = getelementptr inbounds i16, ptr %add.ptr23.i, i64 %idx.ext24.i
  %17 = load i16, ptr %add.ptr25.i, align 2
...
if.then.i:                                        ; preds = %do.body.i
  ...
  %18 = load i8, ptr %buf.0.i, align 1
...
if.then32.i:                                      ; preds = %if.end.i
  ...
  %19 = trunc i32 %shr34.i to i16
  %conv35.i = add i16 %17, %19
  store i16 %conv35.i, ptr %add.ptr25.i, align 2
  %20 = or i32 %processedPos.0.i, %0
...
if.then41.i:                                      ; preds = %if.then32.i
  ...
  %shl43.i = shl i32 %and42.i, %10
  %cmp44.i = icmp eq i64 %dicPos.0.i, 0
  %cond.i = select i1 %cmp44.i, i64 %13, i64 %dicPos.0.i
  %sub46.i = add i64 %cond.i, -1
  %arrayidx47.i = getelementptr inbounds i8, ptr %11, i64 %sub46.i
  %21 = load i8, ptr %arrayidx47.i, align 1
  %conv48.i = zext i8 %21 to i32
...
do.body66.i:                                      ; preds = %if.end55.i, %do.cond.i
  ...
  %22 = load i16, ptr %add.ptr68.i, align 2
  %conv69.i = zext i16 %22 to i32
...
if.then72.i:                                      ; preds = %do.body66.i
  ...
  %23 = load i8, ptr %buf.2.i, align 1
  %conv76.i = zext i8 %23 to i32
...
if.then83.i:                                      ; preds = %if.end78.i
  ...
  %24 = trunc i32 %shr85.i to i16
  %conv87.i = add i16 %22, %24
  br label %do.cond.i

if.else.i:                                        ; preds = %if.end78.i
  %sub91.i = sub i32 %range.3.i, %mul80.i
  %sub92.i = sub i32 %code.3.i, %mul80.i
  %shr93.i = lshr i16 %22, 5
  %sub94.i = sub i16 %22, %shr93.i
...
do.cond.i:                                        ; preds = %if.else.i, %if.then83.i
  ...
  br i1 %cmp101.i, label %do.body66.i, label %if.end165.loopexit.i

if.else103.i:                                     ; preds = %if.end55.i
  %25 = load ptr, ptr %dic14.i, align 8
  %conv105.i = zext i32 %rep0.0.i to i64
  %sub106.i = sub i64 %dicPos.0.i, %conv105.i
  %cmp108.i = icmp ult i64 %dicPos.0.i, %conv105.i
  %cond113.i = select i1 %cmp108.i, i64 %13, i64 0
  %add114.i = add i64 %sub106.i, %cond113.i
  %arrayidx115.i = getelementptr inbounds i8, ptr %25, i64 %add114.i
  %26 = load i8, ptr %arrayidx115.i, align 1
  %conv116.i = zext i8 %26 to i32
...
do.body121.i:                                     ; preds = %if.end160.i, %if.else103.i
  ...
  %27 = load i16, ptr %add.ptr129.i, align 2
  %conv130.i = zext i16 %27 to i32
...
if.then133.i:                                     ; preds = %do.body121.i
  ...
  %28 = load i8, ptr %buf.4.i, align 1
  %conv137.i = zext i8 %28 to i32
...
if.then144.i:                                     ; preds = %if.end139.i
  ...
  %29 = trunc i32 %shr146.i to i16
  %conv148.i = add i16 %27, %29
...
if.else151.i:                                     ; preds = %if.end139.i
  ...
  %shr154.i = lshr i16 %27, 5
  %sub155.i = sub i16 %27, %shr154.i
...
if.end160.i:                                      ; preds = %if.else151.i, %if.then144.i
  ...
  br i1 %cmp162.i, label %do.body121.i, label %if.end165.loopexit1885.i
...
if.end165.i:                                      ; preds = %if.end165.loopexit1885.i, %if.end165.loopexit.i
  ...
  %arrayidx167.i = getelementptr inbounds i8, ptr %11, i64 %dicPos.0.i
  store i8 %conv166.i, ptr %arrayidx167.i, align 1
  br label %do.cond1011.i

if.else169.i:                                     ; preds = %if.end.i
  %sub170.i = sub i32 %range.1.i, %mul.i
  %sub171.i = sub i32 %code.1.i, %mul.i
  %shr172.i = lshr i16 %17, 5
  %sub173.i = sub i16 %17, %shr172.i
  store i16 %sub173.i, ptr %add.ptr25.i, align 2
  %idx.ext176.i = zext i32 %state.0.i to i64
  %add.ptr177.i = getelementptr inbounds i16, ptr %add.ptr175.i, i64 %idx.ext176.i
  %30 = load i16, ptr %add.ptr177.i, align 2
  %conv178.i = zext i16 %30 to i32
...
if.then181.i:                                     ; preds = %if.else169.i
  ...
  %31 = load i8, ptr %buf.1.i, align 1
  %conv185.i = zext i8 %31 to i32
...
if.then192.i:                                     ; preds = %if.end187.i
  ...
  %32 = trunc i32 %shr194.i to i16
  %conv196.i = add i16 %30, %32
  store i16 %conv196.i, ptr %add.ptr177.i, align 2
...
if.else199.i:                                     ; preds = %if.end187.i
  ...
  %shr202.i = lshr i16 %30, 5
  %sub203.i = sub i16 %30, %shr202.i
  store i16 %sub203.i, ptr %add.ptr177.i, align 2
  %33 = or i32 %processedPos.0.i, %0
  %or.cond1060.i = icmp eq i32 %33, 0
...
if.end210.i:                                      ; preds = %if.else199.i
  ...
  %34 = load i16, ptr %add.ptr213.i, align 2
  %conv214.i = zext i16 %34 to i32
...
if.then217.i:                                     ; preds = %if.end210.i
  ...
  %35 = load i8, ptr %buf.7.i, align 1
  %conv221.i = zext i8 %35 to i32
...
if.then228.i:                                     ; preds = %if.end223.i
  ...
  %36 = trunc i32 %shr230.i to i16
  %conv232.i = add i16 %34, %36
  store i16 %conv232.i, ptr %add.ptr213.i, align 2
  ...
  %37 = load i16, ptr %add.ptr238.i, align 2
  %conv239.i = zext i16 %37 to i32
...
if.then242.i:                                     ; preds = %if.then228.i
  ...
  %38 = load i8, ptr %buf.8.i, align 1
  %conv246.i = zext i8 %38 to i32
...
if.then253.i:                                     ; preds = %if.end248.i
  ...
  %39 = trunc i32 %shr255.i to i16
  %conv257.i = add i16 %37, %39
  store i16 %conv257.i, ptr %add.ptr238.i, align 2
  %conv258.i = zext i32 %rep0.0.i to i64
  %sub259.i = sub i64 %dicPos.0.i, %conv258.i
  %cmp261.i = icmp ult i64 %dicPos.0.i, %conv258.i
  %cond266.i = select i1 %cmp261.i, i64 %13, i64 0
  %add267.i = add i64 %sub259.i, %cond266.i
  %arrayidx268.i = getelementptr inbounds i8, ptr %11, i64 %add267.i
  %40 = load i8, ptr %arrayidx268.i, align 1
  %arrayidx269.i = getelementptr inbounds i8, ptr %11, i64 %dicPos.0.i
  store i8 %40, ptr %arrayidx269.i, align 1
...
if.end275.i:                                      ; preds = %if.end248.i
  ...
  %shr278.i = lshr i16 %37, 5
  %sub279.i = sub i16 %37, %shr278.i
  store i16 %sub279.i, ptr %add.ptr238.i, align 2
...
if.else281.i:                                     ; preds = %if.end223.i
  ...
  %shr284.i = lshr i16 %34, 5
  %sub285.i = sub i16 %34, %shr284.i
  store i16 %sub285.i, ptr %add.ptr213.i, align 2
  %add.ptr289.i = getelementptr inbounds i16, ptr %add.ptr287.i, i64 %idx.ext176.i
  %41 = load i16, ptr %add.ptr289.i, align 2
  %conv290.i = zext i16 %41 to i32
...
if.then293.i:                                     ; preds = %if.else281.i
  ...
  %42 = load i8, ptr %buf.8.i, align 1
  %conv297.i = zext i8 %42 to i32
...
if.then304.i:                                     ; preds = %if.end299.i
  ...
  %43 = trunc i32 %shr306.i to i16
  %conv308.i = add i16 %41, %43
  store i16 %conv308.i, ptr %add.ptr289.i, align 2
  br label %if.end345.i

if.else309.i:                                     ; preds = %if.end299.i
  %sub310.i = sub i32 %range.12.i, %mul301.i
  %sub311.i = sub i32 %code.12.i, %mul301.i
  %shr312.i = lshr i16 %41, 5
  %sub313.i = sub i16 %41, %shr312.i
  store i16 %sub313.i, ptr %add.ptr289.i, align 2
  %add.ptr317.i = getelementptr inbounds i16, ptr %add.ptr315.i, i64 %idx.ext176.i
  %44 = load i16, ptr %add.ptr317.i, align 2
  %conv318.i = zext i16 %44 to i32
...
if.then321.i:                                     ; preds = %if.else309.i
  ...
  %45 = load i8, ptr %buf.10.i, align 1
  %conv325.i = zext i8 %45 to i32
...
if.then332.i:                                     ; preds = %if.end327.i
  ...
  %46 = trunc i32 %shr334.i to i16
  %conv336.i = add i16 %44, %46
...
if.else337.i:                                     ; preds = %if.end327.i
  ...
  %shr340.i = lshr i16 %44, 5
  %sub341.i = sub i16 %44, %shr340.i
  br label %if.end343.i
...
if.end343.i:                                      ; preds = %if.else337.i, %if.then332.i
  ...
  store i16 %storemerge.i, ptr %add.ptr317.i, align 2
  br label %if.end345.i
...
if.end350.i:                                      ; preds = %if.end345.i, %if.then192.i
  ...
  %47 = load i16, ptr %prob.1.i, align 2
  %conv353.i = zext i16 %47 to i32
...
if.then356.i:                                     ; preds = %if.end350.i
  ...
  %48 = load i8, ptr %buf.14.i, align 1
  %conv360.i = zext i8 %48 to i32
...
if.then367.i:                                     ; preds = %if.end362.i
  ...
  %49 = trunc i32 %shr369.i to i16
  %conv371.i = add i16 %47, %49
  store i16 %conv371.i, ptr %prob.1.i, align 2
...
if.else376.i:                                     ; preds = %if.end362.i
  ...
  %shr379.i = lshr i16 %47, 5
  %sub380.i = sub i16 %47, %shr379.i
  store i16 %sub380.i, ptr %prob.1.i, align 2
  %add.ptr382.i = getelementptr inbounds i16, ptr %prob.1.i, i64 1
  %50 = load i16, ptr %add.ptr382.i, align 2
  %conv383.i = zext i16 %50 to i32
...
if.then386.i:                                     ; preds = %if.else376.i
  ...
  %51 = load i8, ptr %buf.15.i, align 1
  %conv390.i = zext i8 %51 to i32
...
if.then397.i:                                     ; preds = %if.end392.i
  ...
  %52 = trunc i32 %shr399.i to i16
  %conv401.i = add i16 %50, %52
  store i16 %conv401.i, ptr %add.ptr382.i, align 2
...
if.else406.i:                                     ; preds = %if.end392.i
  ...
  %shr409.i = lshr i16 %50, 5
  %sub410.i = sub i16 %50, %shr409.i
  store i16 %sub410.i, ptr %add.ptr382.i, align 2
...
do.body415.i:                                     ; preds = %do.cond451.i, %if.end414.i
  ...
  %53 = load i16, ptr %add.ptr417.i, align 2
  %conv418.i = zext i16 %53 to i32
...
if.then421.i:                                     ; preds = %do.body415.i
  ...
  %54 = load i8, ptr %buf.18.i, align 1
  %conv425.i = zext i8 %54 to i32
...
if.then432.i:                                     ; preds = %if.end427.i
  ...
  %55 = trunc i32 %shr434.i to i16
  %conv436.i = add i16 %53, %55
...
if.else440.i:                                     ; preds = %if.end427.i
  ...
  %shr443.i = lshr i16 %53, 5
  %sub444.i = sub i16 %53, %shr443.i
...
do.cond451.i:                                     ; preds = %if.else440.i, %if.then432.i
  ...
  br i1 %cmp452.i, label %do.body415.i, label %do.end454.i
...
if.then459.i:                                     ; preds = %do.end454.i
  ...
  %56 = load i16, ptr %add.ptr472.i, align 2
  %conv473.i = zext i16 %56 to i32
...
if.then476.i:                                     ; preds = %if.then459.i
  ...
  %57 = load i8, ptr %buf.19.i, align 1
  %conv480.i = zext i8 %57 to i32
...
if.then487.i:                                     ; preds = %if.end482.i
  ...
  %58 = trunc i32 %shr489.i to i16
  %conv491.i = add i16 %56, %58
...
if.else495.i:                                     ; preds = %if.end482.i
  ...
  %shr498.i = lshr i16 %56, 5
  %sub499.i = sub i16 %56, %shr498.i
  br label %if.end505.i
...
if.then511.i:                                     ; preds = %if.end505.i
  ...
  %60 = load i8, ptr %buf.20.i, align 1
  %conv515.i = zext i8 %60 to i32
...
if.then522.i:                                     ; preds = %if.end517.i
  ...
  %61 = trunc i32 %shr524.i to i16
  %conv526.i = add i16 %59, %61
...
if.else530.i:                                     ; preds = %if.end517.i
  ...
  %shr533.i = lshr i16 %59, 5
  %sub534.i = sub i16 %59, %shr533.i
...
if.end540.i:                                      ; preds = %if.else530.i, %if.then522.i
  ...
  %62 = load i16, ptr %add.ptr542.i, align 2
  %conv543.i = zext i16 %62 to i32
...
if.then546.i:                                     ; preds = %if.end540.i
  ...
  %63 = load i8, ptr %buf.21.i, align 1
  %conv550.i = zext i8 %63 to i32
...
if.then557.i:                                     ; preds = %if.end552.i
  ...
  %64 = trunc i32 %shr559.i to i16
  %conv561.i = add i16 %62, %64
...
if.else565.i:                                     ; preds = %if.end552.i
  ...
  %shr568.i = lshr i16 %62, 5
  %sub569.i = sub i16 %62, %shr568.i
...
if.end575.i:                                      ; preds = %if.else565.i, %if.then557.i
  ...
  %65 = load i16, ptr %add.ptr577.i, align 2
  %conv578.i = zext i16 %65 to i32
...
if.then581.i:                                     ; preds = %if.end575.i
  ...
  %66 = load i8, ptr %buf.22.i, align 1
  %conv585.i = zext i8 %66 to i32
...
if.then592.i:                                     ; preds = %if.end587.i
  ...
  %67 = trunc i32 %shr594.i to i16
  %conv596.i = add i16 %65, %67
...
if.else600.i:                                     ; preds = %if.end587.i
  ...
  %shr603.i = lshr i16 %65, 5
  %sub604.i = sub i16 %65, %shr603.i
...
if.end610.i:                                      ; preds = %if.else600.i, %if.then592.i
  ...
  %68 = load i16, ptr %add.ptr612.i, align 2
  %conv613.i = zext i16 %68 to i32
...
if.then616.i:                                     ; preds = %if.end610.i
  ...
  %69 = load i8, ptr %buf.23.i, align 1
  %conv620.i = zext i8 %69 to i32
...
if.then627.i:                                     ; preds = %if.end622.i
  ...
  %70 = trunc i32 %shr629.i to i16
  %conv631.i = add i16 %68, %70
...
if.else635.i:                                     ; preds = %if.end622.i
  ...
  %shr638.i = lshr i16 %68, 5
  %sub639.i = sub i16 %68, %shr638.i
...
if.end645.i:                                      ; preds = %if.else635.i, %if.then627.i
  ...
  %71 = load i16, ptr %add.ptr647.i, align 2
  %conv648.i = zext i16 %71 to i32
...
if.then651.i:                                     ; preds = %if.end645.i
  ...
  %72 = load i8, ptr %buf.24.i, align 1
  %conv655.i = zext i8 %72 to i32
...
if.then662.i:                                     ; preds = %if.end657.i
  ...
  %73 = trunc i32 %shr664.i to i16
  %conv666.i = add i16 %71, %73
...
if.else670.i:                                     ; preds = %if.end657.i
  ...
  %shr673.i = lshr i16 %71, 5
  %sub674.i = sub i16 %71, %shr673.i
...
do.body699.i:                                     ; preds = %if.end735.i, %if.then691.i
  ...
  %74 = load i16, ptr %add.ptr701.i, align 2
  %conv702.i = zext i16 %74 to i32
...
if.then705.i:                                     ; preds = %do.body699.i
  ...
  %75 = load i8, ptr %buf.26.i, align 1
  %conv709.i = zext i8 %75 to i32
...
if.then716.i:                                     ; preds = %if.end711.i
  ...
  %76 = trunc i32 %shr718.i to i16
  %conv720.i = add i16 %74, %76
...
if.else724.i:                                     ; preds = %if.end711.i
  ...
  %shr727.i = lshr i16 %74, 5
  %sub728.i = sub i16 %74, %shr727.i
...
if.end735.i:                                      ; preds = %if.else724.i, %if.then716.i
  ...
  br i1 %cmp738.not.i, label %if.end922.i, label %do.body699.i
...
if.then746.i:                                     ; preds = %do.body743.i
  ...
  %77 = load i8, ptr %buf.28.i, align 1
  %conv750.i = zext i8 %77 to i32
...
if.end752.i:                                      ; preds = %if.then746.i, %do.body743.i
  ...
  br i1 %cmp764.not.i, label %do.end766.i, label %do.body743.i

do.end766.i:                                      ; preds = %if.end752.i
  %shl768.i = shl i32 %add759.i, 4
  %78 = load i16, ptr %add.ptr771.i, align 2
  %conv772.i = zext i16 %78 to i32
...
if.then775.i:                                     ; preds = %do.end766.i
  ...
  %79 = load i8, ptr %buf.29.i, align 1
  %conv779.i = zext i8 %79 to i32
...
if.then786.i:                                     ; preds = %if.end781.i
  ...
  %80 = trunc i32 %shr788.i to i16
  %conv790.i = add i16 %78, %80
...
if.else794.i:                                     ; preds = %if.end781.i
  ...
  %shr797.i = lshr i16 %78, 5
  %sub798.i = sub i16 %78, %shr797.i
...
if.end805.i:                                      ; preds = %if.else794.i, %if.then786.i
  ...
  %81 = load i16, ptr %add.ptr807.i, align 2
  %conv808.i = zext i16 %81 to i32
...
if.then811.i:                                     ; preds = %if.end805.i
  ...
  %82 = load i8, ptr %buf.30.i, align 1
  %conv815.i = zext i8 %82 to i32
...
if.then822.i:                                     ; preds = %if.end817.i
  ...
  %83 = trunc i32 %shr824.i to i16
  %conv826.i = add i16 %81, %83
...
if.else830.i:                                     ; preds = %if.end817.i
  ...
  %shr833.i = lshr i16 %81, 5
  %sub834.i = sub i16 %81, %shr833.i
...
if.end841.i:                                      ; preds = %if.else830.i, %if.then822.i
  ...
  %84 = load i16, ptr %add.ptr843.i, align 2
  %conv844.i = zext i16 %84 to i32
...
if.then847.i:                                     ; preds = %if.end841.i
  ...
  %85 = load i8, ptr %buf.31.i, align 1
  %conv851.i = zext i8 %85 to i32
...
if.then858.i:                                     ; preds = %if.end853.i
  ...
  %86 = trunc i32 %shr860.i to i16
  %conv862.i = add i16 %84, %86
...
if.else866.i:                                     ; preds = %if.end853.i
  ...
  %shr869.i = lshr i16 %84, 5
  %sub870.i = sub i16 %84, %shr869.i
...
if.end877.i:                                      ; preds = %if.else866.i, %if.then858.i
  ...
  %87 = load i16, ptr %add.ptr879.i, align 2
  %conv880.i = zext i16 %87 to i32
...
if.then883.i:                                     ; preds = %if.end877.i
  ...
  %88 = load i8, ptr %buf.32.i, align 1
  %conv887.i = zext i8 %88 to i32
...
if.then894.i:                                     ; preds = %if.end889.i
  ...
  %89 = trunc i32 %shr896.i to i16
  %conv898.i = add i16 %87, %89
...
if.else902.i:                                     ; preds = %if.end889.i
  ...
  %shr905.i = lshr i16 %87, 5
  %sub906.i = sub i16 %87, %shr905.i
...
if.end943.i:                                      ; preds = %cleanup940.i, %do.end454.i
  ...
  %cmp945.i = icmp eq i64 %dicPos.0.i, %limit2.1
...
if.end948.i:                                      ; preds = %if.end943.i
  ...
  %cond966.i = select i1 %cmp961.i, i64 %13, i64 0
  ...
  %cmp972.not.i = icmp ugt i64 %add971.i, %13
...
do.body989.i.prol:                                ; preds = %do.body989.i.preheader
  %arrayidx990.i.prol = getelementptr inbounds i8, ptr %11, i64 %add967.i
  %90 = load i8, ptr %arrayidx990.i.prol, align 1
  %inc991.i.prol = add i64 %dicPos.0.i, 1
  %arrayidx992.i.prol = getelementptr inbounds i8, ptr %11, i64 %dicPos.0.i
  store i8 %90, ptr %arrayidx992.i.prol, align 1
  %inc993.i.prol = add i64 %add967.i, 1
  %cmp994.i.prol = icmp eq i64 %inc993.i.prol, %13
...
do.body989.i.prol.loopexit:                       ; preds = %do.body989.i.prol, %do.body989.i.preheader
  ...
  %91 = icmp eq i32 %cond957.i, 1
  br i1 %91, label %do.cond1011.i, label %do.body989.i

iter.check:                                       ; preds = %if.end948.i
  %add.ptr975.i = getelementptr inbounds i8, ptr %11, i64 %dicPos.0.i
...
vector.memcheck:                                  ; preds = %iter.check
  %92 = add i64 %dicPos.0.i, %12
  %93 = add i64 %cond966.i, %12
  %94 = add i64 %93, %dicPos.0.i
  %.neg = sub i64 %conv958.i, %94
  %95 = add i64 %.neg, %92
  %diff.check = icmp ult i64 %95, 32
  br i1 %diff.check, label %do.body981.i.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %vector.memcheck
  %min.iters.check98 = icmp ult i32 %cond957.i, 32
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %96 = getelementptr inbounds i8, ptr %next.gep, i64 %sub976.i
  %wide.load = load <16 x i8>, ptr %96, align 1
  %97 = getelementptr inbounds i8, ptr %96, i64 16
  %wide.load100 = load <16 x i8>, ptr %97, align 1
  store <16 x i8> %wide.load, ptr %next.gep, align 1
  %98 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load100, ptr %98, align 1
...
vec.epilog.iter.check:                            ; preds = %middle.block
  %ind.end104 = getelementptr i8, ptr %add.ptr975.i, i64 %n.vec
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec102 = and i64 %conv970.i, 4294967288
  %ind.end103 = getelementptr i8, ptr %add.ptr975.i, i64 %n.vec102
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index107 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next110, %vec.epilog.vector.body ]
  %next.gep108 = getelementptr i8, ptr %add.ptr975.i, i64 %index107
  %100 = getelementptr inbounds i8, ptr %next.gep108, i64 %sub976.i
  %wide.load109 = load <8 x i8>, ptr %100, align 1
  store <8 x i8> %wide.load109, ptr %next.gep108, align 1
  %index.next110 = add nuw i64 %index107, 8
  %101 = icmp eq i64 %index.next110, %n.vec102
  br i1 %101, label %vec.epilog.middle.block, label %vec.epilog.vector.body

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n106 = icmp eq i64 %n.vec102, %conv970.i
  br i1 %cmp.n106, label %do.cond1011.loopexit1886.i, label %do.body981.i.preheader

do.body981.i.preheader:                           ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %dest.0.i.ph = phi ptr [ %add.ptr975.i, %iter.check ], [ %add.ptr975.i, %vector.memcheck ], [ %ind.end104, %vec.epilog.iter.check ], [ %ind.end103, %vec.epilog.middle.block ]
...
do.body981.i:                                     ; preds = %do.body981.i.preheader, %do.body981.i
  ...
  %102 = load i8, ptr %add.ptr982.i, align 1
  store i8 %102, ptr %dest.0.i, align 1
  %incdec.ptr984.i = getelementptr inbounds i8, ptr %dest.0.i, i64 1
  %cmp985.not.i = icmp eq ptr %incdec.ptr984.i, %add.ptr978.i
  br i1 %cmp985.not.i, label %do.cond1011.loopexit1886.i, label %do.body981.i
...
do.body989.i:                                     ; preds = %do.body989.i.prol.loopexit, %do.body989.i
  ...
  %arrayidx990.i = getelementptr inbounds i8, ptr %11, i64 %pos.0.i
  %103 = load i8, ptr %arrayidx990.i, align 1
  %inc991.i = add i64 %dicPos.1.i, 1
  %arrayidx992.i = getelementptr inbounds i8, ptr %11, i64 %dicPos.1.i
  store i8 %103, ptr %arrayidx992.i, align 1
  %inc993.i = add i64 %pos.0.i, 1
  %cmp994.i = icmp eq i64 %inc993.i, %13
  %spec.store.select.i = select i1 %cmp994.i, i64 0, i64 %inc993.i
  %arrayidx990.i.1 = getelementptr inbounds i8, ptr %11, i64 %spec.store.select.i
  %104 = load i8, ptr %arrayidx990.i.1, align 1
  %inc991.i.1 = add i64 %dicPos.1.i, 2
  %arrayidx992.i.1 = getelementptr inbounds i8, ptr %11, i64 %inc991.i
  store i8 %104, ptr %arrayidx992.i.1, align 1
  %inc993.i.1 = add i64 %spec.store.select.i, 1
  %cmp994.i.1 = icmp eq i64 %inc993.i.1, %13
  ...
  br i1 %cmp1000.not.i.1, label %do.cond1011.i, label %do.body989.i
...
do.cond1011.i:                                    ; preds = %do.body989.i.prol.loopexit, %do.body989.i, %do.cond1011.loopexit1886.i, %if.then253.i, %if.end165.i
  ...
  %105 = select i1 %cmp1012.i, i1 %cmp1014.i, i1 false
  br i1 %105, label %do.body.i, label %do.end1016.i

do.end1016.i:                                     ; preds = %do.cond1011.i, %cleanup1005.i
  %state.71841.i = phi i32 [ %sub918.i, %cleanup1005.i ], [ %state.7.ph.i, %do.cond1011.i ]
  %106 = phi i32 [ %rep0.2.i, %cleanup1005.i ], [ %rep0.5.ph.i, %do.cond1011.i ]
  ...
  %107 = phi i64 [ %dicPos.0.i, %cleanup1005.i ], [ %dicPos.3.ph.i, %do.cond1011.i ]
  ...
  %108 = phi i32 [ %add917.i, %cleanup1005.i ], [ %len.7.ph.i, %do.cond1011.i ]
...
if.then1019.i:                                    ; preds = %do.end1016.i
  ...
  %109 = load i8, ptr %buf.391821.i, align 1
  %conv1023.i = zext i8 %109 to i32
...
cleanup.cont:                                     ; preds = %if.then1019.i, %do.end1016.i
  ...
  store ptr %buf.40.i, ptr %buf19.i, align 8
  store i32 %range.55.i, ptr %range20.i, align 8
  store i32 %code.55.i, ptr %code21.i, align 4
  store i32 %108, ptr %remainLen.i, align 4
  store i64 %107, ptr %dicPos16.i, align 8
  store i32 %processedPos.11828.i, ptr %processedPos17.i, align 8
  store i32 %106, ptr %reps.i, align 4
  store i32 %rep1.51837.i, ptr %arrayidx4.i, align 4
  store i32 %rep2.61835.i, ptr %arrayidx6.i, align 4
  store i32 %rep3.71833.i, ptr %arrayidx8.i, align 4
  store i32 %state.71841.i, ptr %state2.i, align 8
  %110 = load i32, ptr %dicSize, align 4
  %cmp15.not = icmp ult i32 %processedPos.11828.i, %110
  br i1 %cmp15.not, label %if.end21, label %if.then17

if.then17:                                        ; preds = %cleanup.cont
  store i32 %110, ptr %checkDicSize, align 4
  br label %if.end21

if.end21:                                         ; preds = %if.then17, %cleanup.cont
  %111 = add i32 %108, -1
  %or.cond.i = icmp ult i32 %111, 273
  br i1 %or.cond.i, label %if.then.i61, label %do.cond

if.then.i61:                                      ; preds = %if.end21
  %112 = load ptr, ptr %dic14.i, align 8
  %113 = load i64, ptr %dicBufSize15.i, align 8
  %sub.i63 = sub i64 %limit, %107
  %conv.i64 = zext i32 %108 to i64
  %cmp7.i = icmp ult i64 %sub.i63, %conv.i64
  %conv11.i = trunc i64 %sub.i63 to i32
  %spec.select.i = select i1 %cmp7.i, i32 %conv11.i, i32 %108
  %114 = load i32, ptr %checkDicSize, align 4
  %cmp12.i = icmp ne i32 %114, 0
  %sub15.i = sub i32 %110, %processedPos.11828.i
  %cmp16.not.i = icmp ugt i32 %sub15.i, %spec.select.i
  %or.cond = select i1 %cmp12.i, i1 true, i1 %cmp16.not.i
  br i1 %or.cond, label %if.end22.i, label %if.then18.i

if.then18.i:                                      ; preds = %if.then.i61
  store i32 %110, ptr %checkDicSize, align 4
  br label %if.end22.i

if.end22.i:                                       ; preds = %if.then.i61, %if.then18.i
  %add.i = add i32 %spec.select.i, %processedPos.11828.i
  store i32 %add.i, ptr %processedPos17.i, align 8
  %sub25.i = sub i32 %108, %spec.select.i
  store i32 %sub25.i, ptr %remainLen.i, align 4
  %cmp26.not65.i = icmp eq i32 %spec.select.i, 0
  br i1 %cmp26.not65.i, label %while.end.i, label %while.body.lr.ph.i

while.body.lr.ph.i:                               ; preds = %if.end22.i
  %conv28.i = zext i32 %106 to i64
  %xtraiter115 = and i32 %spec.select.i, 1
  %lcmp.mod116.not = icmp eq i32 %xtraiter115, 0
  br i1 %lcmp.mod116.not, label %while.body.i.prol.loopexit, label %while.body.i.prol

while.body.i.prol:                                ; preds = %while.body.lr.ph.i
  %dec.i65.prol = add i32 %spec.select.i, -1
  %sub29.i.prol = sub i64 %107, %conv28.i
  %cmp31.i.prol = icmp ult i64 %107, %conv28.i
  %cond.i66.prol = select i1 %cmp31.i.prol, i64 %113, i64 0
  %add33.i.prol = add i64 %sub29.i.prol, %cond.i66.prol
  %arrayidx34.i.prol = getelementptr inbounds i8, ptr %112, i64 %add33.i.prol
  %115 = load i8, ptr %arrayidx34.i.prol, align 1
  %arrayidx35.i.prol = getelementptr inbounds i8, ptr %112, i64 %107
  store i8 %115, ptr %arrayidx35.i.prol, align 1
  %inc.i67.prol = add i64 %107, 1
  br label %while.body.i.prol.loopexit

while.body.i.prol.loopexit:                       ; preds = %while.body.i.prol, %while.body.lr.ph.i
  %inc.i67.lcssa.unr = phi i64 [ undef, %while.body.lr.ph.i ], [ %inc.i67.prol, %while.body.i.prol ]
  %dicPos.067.i.unr = phi i64 [ %107, %while.body.lr.ph.i ], [ %inc.i67.prol, %while.body.i.prol ]
  %len.166.i.unr = phi i32 [ %spec.select.i, %while.body.lr.ph.i ], [ %dec.i65.prol, %while.body.i.prol ]
  %116 = icmp eq i32 %spec.select.i, 1
  br i1 %116, label %while.end.i, label %while.body.i
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  %sub29.i = sub i64 %dicPos.067.i, %conv28.i
  %cmp31.i = icmp ult i64 %dicPos.067.i, %conv28.i
  %cond.i66 = select i1 %cmp31.i, i64 %113, i64 0
  %add33.i = add i64 %sub29.i, %cond.i66
  %arrayidx34.i = getelementptr inbounds i8, ptr %112, i64 %add33.i
  %117 = load i8, ptr %arrayidx34.i, align 1
  %arrayidx35.i = getelementptr inbounds i8, ptr %112, i64 %dicPos.067.i
  store i8 %117, ptr %arrayidx35.i, align 1
  ...
  %cond.i66.1 = select i1 %cmp31.i.1, i64 %113, i64 0
  %add33.i.1 = add i64 %sub29.i.1, %cond.i66.1
  %arrayidx34.i.1 = getelementptr inbounds i8, ptr %112, i64 %add33.i.1
  %118 = load i8, ptr %arrayidx34.i.1, align 1
  %arrayidx35.i.1 = getelementptr inbounds i8, ptr %112, i64 %inc.i67
  store i8 %118, ptr %arrayidx35.i.1, align 1
  %inc.i67.1 = add i64 %dicPos.067.i, 2
  %cmp26.not.i.1 = icmp eq i32 %dec.i65.1, 0
  br i1 %cmp26.not.i.1, label %while.end.i, label %while.body.i

while.end.i:                                      ; preds = %while.body.i.prol.loopexit, %while.body.i, %if.end22.i
  %dicPos.0.lcssa.i = phi i64 [ %107, %if.end22.i ], [ %inc.i67.lcssa.unr, %while.body.i.prol.loopexit ], [ %inc.i67.1, %while.body.i ]
  store i64 %dicPos.0.lcssa.i, ptr %dicPos16.i, align 8
  br label %do.cond

do.cond:                                          ; preds = %if.end21, %while.end.i
  %119 = phi i64 [ %107, %if.end21 ], [ %dicPos.0.lcssa.i, %while.end.i ]
  %cmp26 = icmp ult i64 %119, %limit
  br i1 %cmp26, label %land.lhs.true, label %do.cond.do.end_crit_edge

do.cond.do.end_crit_edge:                         ; preds = %do.cond
  %.pre86 = load i32, ptr %remainLen.i, align 4
  br label %do.end

land.lhs.true:                                    ; preds = %do.cond
  %120 = load ptr, ptr %buf19.i, align 8
  %cmp28 = icmp ult ptr %120, %bufLimit
  %.pre87 = load i32, ptr %remainLen.i, align 4
  %cmp30 = icmp ult i32 %.pre87, 274
  %or.cond93 = select i1 %cmp28, i1 %cmp30, i1 false
  br i1 %or.cond93, label %do.body, label %do.end

do.end:                                           ; preds = %land.lhs.true, %do.cond.do.end_crit_edge
  %121 = phi i32 [ %.pre86, %do.cond.do.end_crit_edge ], [ %.pre87, %land.lhs.true ]
  %cmp33 = icmp ugt i32 %121, 274
  br i1 %cmp33, label %if.then35, label %return

if.then35:                                        ; preds = %do.end
  store i32 274, ptr %remainLen.i, align 4
  br label %return
...
for.cond:                                         ; preds = %cleanup, %entry
  ...
  store i64 %inSize.0, ptr %inSizeCur, align 8
  %2 = load i64, ptr %dicPos1, align 8
  %3 = load i64, ptr %dicBufSize, align 8
  %cmp = icmp eq i64 %2, %3
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %for.cond
  store i64 0, ptr %dicPos1, align 8
  br label %if.end
...
if.end:                                           ; preds = %if.then, %for.cond
  ...
  %5 = load i64, ptr %inSizeCur, align 8
  %6 = load i64, ptr %srcLen, align 8
  %add10 = add i64 %6, %5
  store i64 %add10, ptr %srcLen, align 8
  %7 = load i64, ptr %dicPos1, align 8
  %sub12 = sub i64 %7, %4
  %8 = load ptr, ptr %dic, align 8
  ...
  store i64 %add16, ptr %destLen, align 8
...
entry:
  ...
  %1 = load ptr, ptr %probs, align 8
  tail call void %0(ptr noundef %alloc, ptr noundef %1) #8
  store ptr null, ptr %probs, align 8
  ret void
}
...
if.else:                                          ; preds = %entry
  ...
  store i32 %spec.store.select, ptr %dicSize15, align 4
...
cleanup.cont:                                     ; preds = %if.else.i
  ...
  %probs.i = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 1
  %3 = load ptr, ptr %probs.i, align 8
...
lor.lhs.false.i:                                  ; preds = %cleanup.cont
  ...
  %4 = load i32, ptr %numProbs2.i, align 8
...
cleanup.cont8:                                    ; preds = %lor.lhs.false.i, %if.then.i
  store i32 %rem.i, ptr %p, align 8
  %propNew.sroa.5.0.p.sroa_idx = getelementptr inbounds i8, ptr %p, i64 4
  store i32 %rem28.zext.i, ptr %propNew.sroa.5.0.p.sroa_idx, align 4
  %propNew.sroa.7.0.p.sroa_idx = getelementptr inbounds i8, ptr %p, i64 8
  store i32 %div26.zext.i, ptr %propNew.sroa.7.0.p.sroa_idx, align 8
  %propNew.sroa.8.0.p.sroa_idx = getelementptr inbounds i8, ptr %p, i64 12
  store i32 %spec.store.select.i, ptr %propNew.sroa.8.0.p.sroa_idx, align 4
  br label %cleanup9
...
if.else.i.i:                                      ; preds = %if.end
  ...
  %3 = load i8, ptr %propData, align 1
...
if.end9:                                          ; preds = %land.lhs.true, %if.end3
  ...
  %9 = load i64, ptr %dicPos.i, align 8
  store i64 %9, ptr %destLen, align 8
  %10 = load ptr, ptr %Free.i.i.i, align 8
  %11 = load ptr, ptr %probs, align 8
  call void %10(ptr noundef nonnull %alloc, ptr noundef %11) #8
  br label %cleanup
