...
for.body.lr.ph:                                   ; preds = %land.rhs.lr.ph
  ...
  %20 = load i8, ptr %src.addr.0330, align 1, !tbaa !24
  %indvars.iv.next = add nuw nsw i64 %19, 1
  %21 = trunc i64 %indvars.iv.next to i32
  store i32 %21, ptr %tempBufSize, align 4, !tbaa !14
  %arrayidx = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 17, i64 %19
  store i8 %20, ptr %arrayidx, align 1, !tbaa !24
  %22 = load i64, ptr %srcLen, align 8, !tbaa !19
  %inc5 = add i64 %22, 1
...
for.body.1:                                       ; preds = %land.rhs
  ...
  store i32 %24, ptr %tempBufSize, align 4, !tbaa !14
  %arrayidx.1 = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 17, i64 %indvars.iv.next
  store i8 %23, ptr %arrayidx.1, align 1, !tbaa !24
  %25 = load i64, ptr %srcLen, align 8, !tbaa !19
  %inc5.1 = add i64 %25, 1
...
for.body.2:                                       ; preds = %land.rhs.1
  ...
  %26 = load i8, ptr %incdec.ptr.1, align 1, !tbaa !24
  %indvars.iv.next.2 = add nuw nsw i64 %19, 3
  %27 = trunc i64 %indvars.iv.next.2 to i32
  store i32 %27, ptr %tempBufSize, align 4, !tbaa !14
  %arrayidx.2 = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 17, i64 %indvars.iv.next.1
  store i8 %26, ptr %arrayidx.2, align 1, !tbaa !24
  %28 = load i64, ptr %srcLen, align 8, !tbaa !19
  %inc5.2 = add i64 %28, 1
...
for.body.3:                                       ; preds = %land.rhs.2
  ...
  %29 = load i8, ptr %incdec.ptr.2, align 1, !tbaa !24
  %indvars.iv.next.3 = add nuw nsw i64 %19, 4
  %30 = trunc i64 %indvars.iv.next.3 to i32
  store i32 %30, ptr %tempBufSize, align 4, !tbaa !14
  %arrayidx.3 = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 17, i64 %indvars.iv.next.2
  store i8 %29, ptr %arrayidx.3, align 1, !tbaa !24
  %31 = load i64, ptr %srcLen, align 8, !tbaa !19
  %inc5.3 = add i64 %31, 1
...
for.body.4:                                       ; preds = %land.rhs.3
  ...
  %32 = load i8, ptr %incdec.ptr.3, align 1, !tbaa !24
  ...
  store i8 %32, ptr %arrayidx.4, align 1, !tbaa !24
...
vector.body410:                                   ; preds = %vector.body410, %if.then38
  ...
  br i1 %48, label %for.body.i, label %vector.body410, !llvm.loop !35
...
if.then157:                                       ; preds = %while.end153
  ...
  %.pre357 = load i32, ptr %code154, align 4, !tbaa !28
...
if.then20:                                        ; preds = %if.end17
  ...
  %9 = or i32 %8, %4
  %or.cond942 = icmp eq i32 %9, 0
  br i1 %or.cond942, label %if.end47, label %if.then27
...
cleanup.thread:                                   ; preds = %do.cond521, %do.cond142, %do.cond, %do.end445, %cleanup.cont399
  ...
  %cmp547937 = icmp ugt i32 %range.41.ph, 16777215
  %cmp550.not938 = icmp ult ptr %buf.addr.36.ph, %add.ptr
  %or.cond939 = select i1 %cmp547937, i1 true, i1 %cmp550.not938
  %spec.select940 = select i1 %or.cond939, i32 %res.3.ph, i32 0
  br label %cleanup541
...
cleanup541:                                       ; preds = %if.then366, %if.then419, %if.then469, %if.then498, %if.then113, %if.then56, %if.then230, %if.then, %if.then161, %if.then187, %if.then212, %if.then227, %if.then254, %if.then279, %if.then307, %if.then334, %cleanup.thread
  %46 = phi i32 [ %spec.select940, %cleanup.thread ], [ 0, %if.then ], [ 0, %if.then279 ], [ 0, %if.then254 ], [ 3, %if.then227 ], [ 0, %if.then212 ], [ 0, %if.then187 ], [ 0, %if.then161 ], [ 0, %if.then307 ], [ 0, %if.then334 ], [ %spec.select, %if.then230 ], [ 0, %if.then56 ], [ 0, %if.then113 ], [ 0, %if.then498 ], [ 0, %if.then469 ], [ 0, %if.then419 ], [ 0, %if.then366 ]
  ret i32 %46
}
...
entry:
  ...
  %remainLen.i = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 12
  %.pre.pre = load i64, ptr %dicPos16.i, align 8, !tbaa !18
  br label %do.body
...
do.body:                                          ; preds = %land.lhs.true, %entry
  ...
  %cmp = icmp eq i32 %0, 0
  %.pre85 = load i32, ptr %processedPos17.i, align 8, !tbaa !15
  br i1 %cmp, label %if.then, label %if.end7

if.then:                                          ; preds = %do.body
  %1 = load i32, ptr %dicSize, align 4, !tbaa !23
  %sub = sub i32 %1, %.pre85
...
if.end7:                                          ; preds = %if.then, %do.body
  ...
  %2 = load ptr, ptr %probs1.i, align 8, !tbaa !32
  %3 = load i32, ptr %state2.i, align 8, !tbaa !42
  %4 = load i32, ptr %reps.i, align 4, !tbaa !22
  %5 = load i32, ptr %arrayidx4.i, align 4, !tbaa !22
  %6 = load i32, ptr %arrayidx6.i, align 4, !tbaa !22
  %7 = load i32, ptr %arrayidx8.i, align 4, !tbaa !22
  %8 = load i32, ptr %pb.i, align 8, !tbaa !43
  %notmask.i = shl nsw i32 -1, %8
  %sub.i = xor i32 %notmask.i, -1
  %9 = load i32, ptr %lp.i, align 4, !tbaa !31
  %notmask1786.i = shl nsw i32 -1, %9
  %sub11.i = xor i32 %notmask1786.i, -1
  %10 = load i32, ptr %p, align 8, !tbaa !30
  %11 = load ptr, ptr %dic14.i, align 8, !tbaa !20
  %12 = ptrtoint ptr %11 to i64
  %13 = load i64, ptr %dicBufSize15.i, align 8, !tbaa !21
  %14 = load ptr, ptr %buf19.i, align 8, !tbaa !39
  %15 = load i32, ptr %range20.i, align 8, !tbaa !29
  %16 = load i32, ptr %code21.i, align 4, !tbaa !28
...
do.body.i:                                        ; preds = %do.cond1011.i, %if.end7
  ...
  %17 = load i16, ptr %add.ptr25.i, align 2, !tbaa !33
...
if.then.i:                                        ; preds = %do.body.i
  ...
  %18 = load i8, ptr %buf.0.i, align 1, !tbaa !24
...
if.then41.i:                                      ; preds = %if.then32.i
  ...
  %21 = load i8, ptr %arrayidx47.i, align 1, !tbaa !24
...
do.body66.i:                                      ; preds = %if.end55.i, %do.cond.i
  ...
  %22 = load i16, ptr %add.ptr68.i, align 2, !tbaa !33
...
if.then72.i:                                      ; preds = %do.body66.i
  ...
  %23 = load i8, ptr %buf.2.i, align 1, !tbaa !24
...
if.else103.i:                                     ; preds = %if.end55.i
  %25 = load ptr, ptr %dic14.i, align 8, !tbaa !20
  ...
  %26 = load i8, ptr %arrayidx115.i, align 1, !tbaa !24
...
do.body121.i:                                     ; preds = %if.end160.i, %if.else103.i
  ...
  %27 = load i16, ptr %add.ptr129.i, align 2, !tbaa !33
...
if.then133.i:                                     ; preds = %do.body121.i
  ...
  %28 = load i8, ptr %buf.4.i, align 1, !tbaa !24
...
if.else169.i:                                     ; preds = %if.end.i
  ...
  %30 = load i16, ptr %add.ptr177.i, align 2, !tbaa !33
...
if.then181.i:                                     ; preds = %if.else169.i
  ...
  %31 = load i8, ptr %buf.1.i, align 1, !tbaa !24
...
if.end210.i:                                      ; preds = %if.else199.i
  ...
  %34 = load i16, ptr %add.ptr213.i, align 2, !tbaa !33
...
if.then217.i:                                     ; preds = %if.end210.i
  ...
  %35 = load i8, ptr %buf.7.i, align 1, !tbaa !24
...
if.then228.i:                                     ; preds = %if.end223.i
  ...
  %37 = load i16, ptr %add.ptr238.i, align 2, !tbaa !33
...
if.then242.i:                                     ; preds = %if.then228.i
  ...
  %38 = load i8, ptr %buf.8.i, align 1, !tbaa !24
...
if.then253.i:                                     ; preds = %if.end248.i
  ...
  %40 = load i8, ptr %arrayidx268.i, align 1, !tbaa !24
  %arrayidx269.i = getelementptr inbounds i8, ptr %11, i64 %dicPos.0.i
  store i8 %40, ptr %arrayidx269.i, align 1, !tbaa !24
...
if.else281.i:                                     ; preds = %if.end223.i
  ...
  %41 = load i16, ptr %add.ptr289.i, align 2, !tbaa !33
...
if.then293.i:                                     ; preds = %if.else281.i
  ...
  %42 = load i8, ptr %buf.8.i, align 1, !tbaa !24
...
if.else309.i:                                     ; preds = %if.end299.i
  ...
  %44 = load i16, ptr %add.ptr317.i, align 2, !tbaa !33
...
if.then321.i:                                     ; preds = %if.else309.i
  ...
  %45 = load i8, ptr %buf.10.i, align 1, !tbaa !24
...
if.end350.i:                                      ; preds = %if.end345.i, %if.then192.i
  ...
  %47 = load i16, ptr %prob.1.i, align 2, !tbaa !33
...
if.then356.i:                                     ; preds = %if.end350.i
  ...
  %48 = load i8, ptr %buf.14.i, align 1, !tbaa !24
...
if.else376.i:                                     ; preds = %if.end362.i
  ...
  %50 = load i16, ptr %add.ptr382.i, align 2, !tbaa !33
...
if.then386.i:                                     ; preds = %if.else376.i
  ...
  %51 = load i8, ptr %buf.15.i, align 1, !tbaa !24
...
do.body415.i:                                     ; preds = %do.cond451.i, %if.end414.i
  ...
  %53 = load i16, ptr %add.ptr417.i, align 2, !tbaa !33
...
if.then421.i:                                     ; preds = %do.body415.i
  ...
  %54 = load i8, ptr %buf.18.i, align 1, !tbaa !24
...
if.then459.i:                                     ; preds = %do.end454.i
  ...
  %56 = load i16, ptr %add.ptr472.i, align 2, !tbaa !33
...
if.then476.i:                                     ; preds = %if.then459.i
  ...
  %57 = load i8, ptr %buf.19.i, align 1, !tbaa !24
...
if.end505.i:                                      ; preds = %if.else495.i, %if.then487.i
  ...
  %59 = load i16, ptr %add.ptr507.i, align 2, !tbaa !33
...
if.then511.i:                                     ; preds = %if.end505.i
  ...
  %60 = load i8, ptr %buf.20.i, align 1, !tbaa !24
...
if.end540.i:                                      ; preds = %if.else530.i, %if.then522.i
  ...
  %62 = load i16, ptr %add.ptr542.i, align 2, !tbaa !33
...
if.then546.i:                                     ; preds = %if.end540.i
  ...
  %63 = load i8, ptr %buf.21.i, align 1, !tbaa !24
...
if.end575.i:                                      ; preds = %if.else565.i, %if.then557.i
  ...
  %65 = load i16, ptr %add.ptr577.i, align 2, !tbaa !33
...
if.then581.i:                                     ; preds = %if.end575.i
  ...
  %66 = load i8, ptr %buf.22.i, align 1, !tbaa !24
...
if.end610.i:                                      ; preds = %if.else600.i, %if.then592.i
  ...
  %68 = load i16, ptr %add.ptr612.i, align 2, !tbaa !33
...
if.then616.i:                                     ; preds = %if.end610.i
  ...
  %69 = load i8, ptr %buf.23.i, align 1, !tbaa !24
...
if.end645.i:                                      ; preds = %if.else635.i, %if.then627.i
  ...
  %71 = load i16, ptr %add.ptr647.i, align 2, !tbaa !33
...
if.then651.i:                                     ; preds = %if.end645.i
  ...
  %72 = load i8, ptr %buf.24.i, align 1, !tbaa !24
...
do.body699.i:                                     ; preds = %if.end735.i, %if.then691.i
  ...
  %74 = load i16, ptr %add.ptr701.i, align 2, !tbaa !33
...
if.then705.i:                                     ; preds = %do.body699.i
  ...
  %75 = load i8, ptr %buf.26.i, align 1, !tbaa !24
...
if.then746.i:                                     ; preds = %do.body743.i
  ...
  %77 = load i8, ptr %buf.28.i, align 1, !tbaa !24
...
do.end766.i:                                      ; preds = %if.end752.i
  ...
  %78 = load i16, ptr %add.ptr771.i, align 2, !tbaa !33
...
if.then775.i:                                     ; preds = %do.end766.i
  ...
  %79 = load i8, ptr %buf.29.i, align 1, !tbaa !24
...
if.end805.i:                                      ; preds = %if.else794.i, %if.then786.i
  ...
  %81 = load i16, ptr %add.ptr807.i, align 2, !tbaa !33
...
if.then811.i:                                     ; preds = %if.end805.i
  ...
  %82 = load i8, ptr %buf.30.i, align 1, !tbaa !24
...
if.end841.i:                                      ; preds = %if.else830.i, %if.then822.i
  ...
  %84 = load i16, ptr %add.ptr843.i, align 2, !tbaa !33
...
if.then847.i:                                     ; preds = %if.end841.i
  ...
  %85 = load i8, ptr %buf.31.i, align 1, !tbaa !24
...
if.end877.i:                                      ; preds = %if.else866.i, %if.then858.i
  ...
  %87 = load i16, ptr %add.ptr879.i, align 2, !tbaa !33
...
if.then883.i:                                     ; preds = %if.end877.i
  ...
  %88 = load i8, ptr %buf.32.i, align 1, !tbaa !24
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %96, align 1, !tbaa !24
  %97 = getelementptr inbounds i8, ptr %96, i64 16
  %wide.load100 = load <16 x i8>, ptr %97, align 1, !tbaa !24
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !24
  %98 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load100, ptr %98, align 1, !tbaa !24
  %index.next = add nuw i64 %index, 32
  %99 = icmp eq i64 %index.next, %n.vec
  br i1 %99, label %middle.block, label %vector.body, !llvm.loop !55
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load109 = load <8 x i8>, ptr %100, align 1, !tbaa !24
  store <8 x i8> %wide.load109, ptr %next.gep108, align 1, !tbaa !24
  %index.next110 = add nuw i64 %index107, 8
  %101 = icmp eq i64 %index.next110, %n.vec102
  br i1 %101, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !56
...
do.body981.i:                                     ; preds = %do.body981.i.preheader, %do.body981.i
  ...
  %102 = load i8, ptr %add.ptr982.i, align 1, !tbaa !24
  store i8 %102, ptr %dest.0.i, align 1, !tbaa !24
...
do.body989.i:                                     ; preds = %do.body989.i.prol.loopexit, %do.body989.i
  ...
  %103 = load i8, ptr %arrayidx990.i, align 1, !tbaa !24
  %inc991.i = add i64 %dicPos.1.i, 1
  %arrayidx992.i = getelementptr inbounds i8, ptr %11, i64 %dicPos.1.i
  store i8 %103, ptr %arrayidx992.i, align 1, !tbaa !24
  ...
  %104 = load i8, ptr %arrayidx990.i.1, align 1, !tbaa !24
  %inc991.i.1 = add i64 %dicPos.1.i, 2
  %arrayidx992.i.1 = getelementptr inbounds i8, ptr %11, i64 %inc991.i
  store i8 %104, ptr %arrayidx992.i.1, align 1, !tbaa !24
...
do.cond1011.i:                                    ; preds = %do.body989.i.prol.loopexit, %do.body989.i, %do.cond1011.loopexit1886.i, %if.then253.i, %if.end165.i
  ...
  br i1 %105, label %do.body.i, label %do.end1016.i, !llvm.loop !59
...
if.then1019.i:                                    ; preds = %do.end1016.i
  ...
  %109 = load i8, ptr %buf.391821.i, align 1, !tbaa !24
...
cleanup.cont:                                     ; preds = %if.then1019.i, %do.end1016.i
  ...
  store i32 %108, ptr %remainLen.i, align 4, !tbaa !13
  store i64 %107, ptr %dicPos16.i, align 8, !tbaa !18
  store i32 %processedPos.11828.i, ptr %processedPos17.i, align 8, !tbaa !15
  store i32 %106, ptr %reps.i, align 4, !tbaa !22
  ...
  %110 = load i32, ptr %dicSize, align 4, !tbaa !23
...
if.then17:                                        ; preds = %cleanup.cont
  store i32 %110, ptr %checkDicSize, align 4, !tbaa !16
  br label %if.end21
...
if.then.i61:                                      ; preds = %if.end21
  %112 = load ptr, ptr %dic14.i, align 8, !tbaa !20
  %113 = load i64, ptr %dicBufSize15.i, align 8, !tbaa !21
  ...
  %114 = load i32, ptr %checkDicSize, align 4, !tbaa !16
...
while.body.i.prol:                                ; preds = %while.body.lr.ph.i
  ...
  %115 = load i8, ptr %arrayidx34.i.prol, align 1, !tbaa !24
  %arrayidx35.i.prol = getelementptr inbounds i8, ptr %112, i64 %107
  store i8 %115, ptr %arrayidx35.i.prol, align 1, !tbaa !24
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  %117 = load i8, ptr %arrayidx34.i, align 1, !tbaa !24
  %arrayidx35.i = getelementptr inbounds i8, ptr %112, i64 %dicPos.067.i
  store i8 %117, ptr %arrayidx35.i, align 1, !tbaa !24
  ...
  %118 = load i8, ptr %arrayidx34.i.1, align 1, !tbaa !24
  %arrayidx35.i.1 = getelementptr inbounds i8, ptr %112, i64 %inc.i67
  store i8 %118, ptr %arrayidx35.i.1, align 1, !tbaa !24
...
do.cond.do.end_crit_edge:                         ; preds = %do.cond
  %.pre86 = load i32, ptr %remainLen.i, align 4, !tbaa !13
  br label %do.end

land.lhs.true:                                    ; preds = %do.cond
  %120 = load ptr, ptr %buf19.i, align 8, !tbaa !39
  %cmp28 = icmp ult ptr %120, %bufLimit
  %.pre87 = load i32, ptr %remainLen.i, align 4, !tbaa !13
  %cmp30 = icmp ult i32 %.pre87, 274
  %or.cond93 = select i1 %cmp28, i1 %cmp30, i1 false
  br i1 %or.cond93, label %do.body, label %do.end, !llvm.loop !60
...
if.then20:                                        ; preds = %if.then14
  %12 = load ptr, ptr %Free.i, align 8, !tbaa !61
  %13 = load ptr, ptr %probs.i, align 8, !tbaa !32
...
land.lhs.true:                                    ; preds = %if.end3
  %8 = load i32, ptr %status, align 4, !tbaa !24
...
if.end9:                                          ; preds = %land.lhs.true, %if.end3
  ...
  %9 = load i64, ptr %dicPos.i, align 8, !tbaa !18
  store i64 %9, ptr %destLen, align 8, !tbaa !19
  %10 = load ptr, ptr %Free.i.i.i, align 8, !tbaa !61
  %11 = load ptr, ptr %probs, align 8, !tbaa !32
