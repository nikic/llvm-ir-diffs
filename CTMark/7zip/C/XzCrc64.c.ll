; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/XzCrc64.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/XzCrc64.c"
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  br i1 %40, label %for.end8, label %vector.body
...
for.body.prol:                                    ; preds = %for.body.preheader
  ...
  %1 = load i64, ptr %arrayidx.prol, align 8
...
for.body.i:                                       ; preds = %for.body.i, %for.body.i.preheader.new
  ...
  %4 = load i64, ptr %arrayidx.i.1, align 8
  ...
  br i1 %niter.ncmp.1, label %Crc64Update.exit.loopexit.unr-lcssa, label %for.body.i
...
for.body.i.epil:                                  ; preds = %Crc64Update.exit.loopexit.unr-lcssa
  %5 = load i8, ptr %p.09.i.unr, align 1
  ...
  %6 = load i64, ptr %arrayidx.i.epil, align 8
