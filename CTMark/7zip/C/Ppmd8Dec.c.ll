...
land.rhs.i465:                                    ; preds = %lor.rhs.i463
  ...
  store i32 %and.i467, ptr %Range.i, align 8, !tbaa !13
...
while.body.critedge.i468:                         ; preds = %land.rhs.i465, %while.cond.i459
  ...
  store i32 %or.i472, ptr %Code.i, align 4, !tbaa !14
  %24 = load i32, ptr %Range.i, align 8, !tbaa !13
  %shl16.i473 = shl i32 %24, 8
  store i32 %shl16.i473, ptr %Range.i, align 8, !tbaa !13
  %25 = load i32, ptr %Low.i455, align 8, !tbaa !5
  %shl18.i474 = shl i32 %25, 8
  store i32 %shl18.i474, ptr %Low.i455, align 8, !tbaa !5
  br label %while.cond.i459, !llvm.loop !26
...
land.rhs.i490:                                    ; preds = %lor.rhs.i488
  ...
  store i32 %and.i492, ptr %Range.i, align 8, !tbaa !13
...
while.body.critedge.i493:                         ; preds = %land.rhs.i490, %while.cond.i484
  ...
  store i32 %or.i497, ptr %Code.i, align 4, !tbaa !14
  %39 = load i32, ptr %Range.i, align 8, !tbaa !13
  %shl16.i498 = shl i32 %39, 8
  store i32 %shl16.i498, ptr %Range.i, align 8, !tbaa !13
  %40 = load i32, ptr %Low.i478, align 8, !tbaa !5
  %shl18.i499 = shl i32 %40, 8
  store i32 %shl18.i499, ptr %Low.i478, align 8, !tbaa !5
  br label %while.cond.i484, !llvm.loop !26
...
land.rhs.i512:                                    ; preds = %lor.rhs.i510
  ...
  store i32 %and.i514, ptr %Range, align 8, !tbaa !13
...
while.body.critedge.i515:                         ; preds = %land.rhs.i512, %while.cond.i506
  ...
  store i32 %or.i519, ptr %Code, align 4, !tbaa !14
  %64 = load i32, ptr %Range, align 8, !tbaa !13
  %shl16.i520 = shl i32 %64, 8
  store i32 %shl16.i520, ptr %Range, align 8, !tbaa !13
  %65 = load i32, ptr %Low.i502, align 8, !tbaa !5
  %shl18.i521 = shl i32 %65, 8
  store i32 %shl18.i521, ptr %Low.i502, align 8, !tbaa !5
  br label %while.cond.i506, !llvm.loop !26
...
land.rhs.i537:                                    ; preds = %lor.rhs.i535
  ...
  store i32 %and.i539, ptr %Range, align 8, !tbaa !13
...
while.body.critedge.i540:                         ; preds = %land.rhs.i537, %while.cond.i531
  ...
  store i32 %or.i544, ptr %Code, align 4, !tbaa !14
  %75 = load i32, ptr %Range, align 8, !tbaa !13
  %shl16.i545 = shl i32 %75, 8
  store i32 %shl16.i545, ptr %Range, align 8, !tbaa !13
  %76 = load i32, ptr %Low.i525, align 8, !tbaa !5
  %shl18.i546 = shl i32 %76, 8
  store i32 %shl18.i546, ptr %Low.i525, align 8, !tbaa !5
  br label %while.cond.i531, !llvm.loop !26
...
land.rhs.i566:                                    ; preds = %lor.rhs.i564
  ...
  store i32 %and.i568, ptr %Range.i549, align 8, !tbaa !13
...
while.body.critedge.i569:                         ; preds = %land.rhs.i566, %while.cond.i560
  ...
  store i32 %or.i573, ptr %Code.i548, align 4, !tbaa !14
  %103 = load i32, ptr %Range.i549, align 8, !tbaa !13
  %shl16.i574 = shl i32 %103, 8
  store i32 %shl16.i574, ptr %Range.i549, align 8, !tbaa !13
  %104 = load i32, ptr %Low.i579, align 8, !tbaa !5
  %shl18.i575 = shl i32 %104, 8
  store i32 %shl18.i575, ptr %Low.i579, align 8, !tbaa !5
  br label %while.cond.i560, !llvm.loop !26
...
land.rhs.i591:                                    ; preds = %lor.rhs.i589
  ...
  store i32 %and.i593, ptr %Range.i549, align 8, !tbaa !13
...
while.body.critedge.i594:                         ; preds = %land.rhs.i591, %while.cond.i585
  ...
  store i32 %or.i598, ptr %Code.i548, align 4, !tbaa !14
  %115 = load i32, ptr %Range.i549, align 8, !tbaa !13
  %shl16.i599 = shl i32 %115, 8
  store i32 %shl16.i599, ptr %Range.i549, align 8, !tbaa !13
  %116 = load i32, ptr %Low.i579, align 8, !tbaa !5
  %shl18.i600 = shl i32 %116, 8
  store i32 %shl18.i600, ptr %Low.i579, align 8, !tbaa !5
  br label %while.cond.i585, !llvm.loop !26
