; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/Lzma2Enc.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/Lzma2Enc.c"
...
entry:
  ...
  store i32 -1, ptr %numTotalThreads, align 4
  %numBlockThreads = getelementptr inbounds %struct.CLzma2EncProps, ptr %p, i64 0, i32 2
  store i32 -1, ptr %numBlockThreads, align 8
...
entry:
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(48) %lzmaProps, ptr noundef nonnull align 8 dereferenceable(48) %p, i64 48, i1 false)
  ...
  %0 = load i32, ptr %numThreads, align 4
  ...
  %1 = load i32, ptr %numThreads3, align 4
  %numBlockThreads = getelementptr inbounds %struct.CLzma2EncProps, ptr %p, i64 0, i32 2
  %2 = load i32, ptr %numBlockThreads, align 8
  %numTotalThreads = getelementptr inbounds %struct.CLzma2EncProps, ptr %p, i64 0, i32 3
  %3 = load i32, ptr %numTotalThreads, align 4
...
if.end28:                                         ; preds = %if.then10, %if.else24, %if.then19, %if.then5
  ...
  store i32 %t1.1, ptr %numThreads3, align 4
  store i32 %t2.1, ptr %numBlockThreads, align 8
  store i32 %t3.0, ptr %numTotalThreads, align 4
  call void @LzmaEncProps_Normalize(ptr noundef nonnull %p) #5
  %blockSize = getelementptr inbounds %struct.CLzma2EncProps, ptr %p, i64 0, i32 1
  %4 = load i64, ptr %blockSize, align 8
...
if.then35:                                        ; preds = %if.end28
  ...
  %5 = load i32, ptr %dictSize37, align 4
  ...
  store i64 %spec.select93, ptr %blockSize, align 8
  br label %if.end54
...
if.end:                                           ; preds = %entry
  ...
  %1 = load i32, ptr %numThreads.i, align 4
  ...
  %2 = load i32, ptr %numThreads3.i, align 4
  %3 = load i32, ptr %numBlockThreads.i, align 8
  %4 = load i32, ptr %numTotalThreads.i, align 4
...
if.end28.i:                                       ; preds = %if.else24.i, %if.then19.i, %if.then10.i, %if.then5.i
  ...
  store i32 %t1.1.i, ptr %numThreads3.i, align 4
  store i32 %t2.1.i, ptr %numBlockThreads.i, align 8
  store i32 %t3.0.i, ptr %numTotalThreads.i, align 4
  call void @LzmaEncProps_Normalize(ptr noundef nonnull %props) #5
  %5 = load i64, ptr %blockSize.i, align 8
...
if.then35.i:                                      ; preds = %if.end28.i
  ...
  %6 = load i32, ptr %dictSize37.i, align 4
  ...
  store i64 %spec.select93.i, ptr %blockSize.i, align 8
...
Lzma2EncProps_Normalize.exit:                     ; preds = %if.end28.i, %if.then35.i
  ...
  store ptr %alloc, ptr %alloc2, align 8
  %allocBig3 = getelementptr inbounds %struct.CLzma2Enc, ptr %call, i64 0, i32 4
  store ptr %allocBig, ptr %allocBig3, align 8
...
if.then:                                          ; preds = %for.body
  ...
  %2 = load ptr, ptr %allocBig, align 8
...
entry:
  ...
  %lzmaProps = alloca %struct._CLzmaEncProps, align 4
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %lzmaProps) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(48) %lzmaProps, ptr noundef nonnull align 8 dereferenceable(48) %props, i64 48, i1 false)
  call void @LzmaEncProps_Normalize(ptr noundef nonnull %lzmaProps) #5
...
if.end:                                           ; preds = %entry
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(64) %props2, ptr noundef nonnull align 8 dereferenceable(64) %props, i64 64, i1 false)
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %lzmaProps.i) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(48) %lzmaProps.i, ptr noundef nonnull align 8 dereferenceable(48) %props, i64 48, i1 false)
  call void @LzmaEncProps_Normalize(ptr noundef nonnull %lzmaProps.i) #5
  %numThreads.i = getelementptr inbounds %struct._CLzmaEncProps, ptr %lzmaProps.i, i64 0, i32 11
  %2 = load i32, ptr %numThreads.i, align 4
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %lzmaProps.i) #5
  %numThreads3.i = getelementptr inbounds %struct.CLzma2Enc, ptr %pp, i64 0, i32 1, i32 0, i32 11
  %3 = load i32, ptr %numThreads3.i, align 4
  %numBlockThreads.i = getelementptr inbounds %struct.CLzma2Enc, ptr %pp, i64 0, i32 1, i32 2
  %4 = load i32, ptr %numBlockThreads.i, align 8
  %numTotalThreads.i = getelementptr inbounds %struct.CLzma2Enc, ptr %pp, i64 0, i32 1, i32 3
  %5 = load i32, ptr %numTotalThreads.i, align 4
...
if.end28.i:                                       ; preds = %if.else24.i, %if.then19.i, %if.then10.i, %if.then5.i
  ...
  %6 = load i64, ptr %blockSize.i, align 8
...
if.then35.i:                                      ; preds = %if.end28.i
  ...
  %7 = load i32, ptr %dictSize37.i, align 4
...
entry:
  ...
  %0 = load i32, ptr %numBlockThreads, align 8
...
if.then.if.end6_crit_edge:                        ; preds = %if.then
  %.pre = load i32, ptr %numBlockThreads, align 8
  br label %if.end6
...
if.end6.i:                                        ; preds = %if.then.i, %if.then10
  ...
  store i64 5, ptr %propsSize.i.i, align 8
  %9 = load ptr, ptr %coders11, align 8
...
cleanup.cont.i.i:                                 ; preds = %if.end6.i
  %10 = load ptr, ptr %coders11, align 8
...
cleanup.cont.i:                                   ; preds = %cleanup.cont.i.i
  ...
  store i64 0, ptr %srcPos.i.i, align 8
  %11 = load i8, ptr %propsEncoded.i.i, align 1
  %props10.i.i = getelementptr inbounds %struct.CLzma2Enc, ptr %pp, i64 0, i32 5, i64 0, i32 2
  store i8 %11, ptr %props10.i.i, align 8
  ...
  store i32 1, ptr %needInitProp.i.i, align 8
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %propsSize.i.i) #5
  call void @llvm.lifetime.end.p0(i64 5, ptr nonnull %propsEncoded.i.i) #5
  %12 = load ptr, ptr %coders11, align 8
  %alloc12.i = getelementptr inbounds %struct.CLzma2Enc, ptr %pp, i64 0, i32 3
  %13 = load ptr, ptr %alloc12.i, align 8
  %allocBig.i = getelementptr inbounds %struct.CLzma2Enc, ptr %pp, i64 0, i32 4
  %14 = load ptr, ptr %allocBig.i, align 8
...
for.cond.preheader.i:                             ; preds = %cleanup.cont.i
  ...
  store i64 65552, ptr %packSize.i, align 8
  %15 = load ptr, ptr %outBuf.i, align 8
...
if.end24.us.i:                                    ; preds = %if.end24.lr.ph.i, %cleanup32.us.i
  %16 = load i64, ptr %packSize.i, align 8
...
cleanup32.us.i:                                   ; preds = %if.end24.us.i
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %packSize.i) #5
  store i64 65552, ptr %packSize.i, align 8
  %17 = load ptr, ptr %outBuf.i, align 8
...
if.end24.i:                                       ; preds = %if.end24.lr.ph.i, %cleanup32.i
  ...
  %18 = load i64, ptr %packSize.i, align 8
  %add.i = add i64 %18, %packTotal.090.i
  %19 = load i64, ptr %srcPos.i.i, align 8
...
cleanup32.i:                                      ; preds = %if.end28.i
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %packSize.i) #5
  store i64 65552, ptr %packSize.i, align 8
  %21 = load ptr, ptr %outBuf.i, align 8
...
if.then37.i:                                      ; preds = %if.end28.i, %if.end24.us.i
  ...
  %24 = load ptr, ptr %outStream, align 8
...
entry:
  ...
  %0 = load ptr, ptr %lzma2Enc, align 8
  %idxprom = zext i32 %index to i64
  %arrayidx = getelementptr inbounds %struct.CLzma2Enc, ptr %0, i64 0, i32 5, i64 %idxprom
  %1 = load i64, ptr %destSize, align 8
  store i64 0, ptr %destSize, align 8
...
if.then:                                          ; preds = %entry
  ...
  store i64 5, ptr %propsSize.i, align 8
  %2 = load ptr, ptr %arrayidx, align 8
...
cleanup.cont:                                     ; preds = %cleanup.cont.i
  ...
  store i64 0, ptr %srcPos.i, align 8
  %4 = load i8, ptr %propsEncoded.i, align 1
  %props10.i = getelementptr inbounds %struct.CLzma2Enc, ptr %0, i64 0, i32 5, i64 %idxprom, i32 2
  store i8 %4, ptr %props10.i, align 8
  ...
  store i32 1, ptr %needInitProp.i, align 8
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %propsSize.i) #5
  call void @llvm.lifetime.end.p0(i64 5, ptr nonnull %propsEncoded.i) #5
  ...
  %7 = load ptr, ptr %allocBig, align 8
...
while.cond.preheader:                             ; preds = %cleanup.cont
  %8 = load i64, ptr %srcPos.i, align 8
...
while.body:                                       ; preds = %while.body.lr.ph, %cleanup24
  ...
  %9 = load i64, ptr %destSize, align 8
  %sub = sub i64 %1, %9
  store i64 %sub, ptr %packSize, align 8
...
if.end15:                                         ; preds = %while.body
  %10 = load i64, ptr %packSize, align 8
  %11 = load i64, ptr %destSize, align 8
  %add = add i64 %11, %10
  store i64 %add, ptr %destSize, align 8
  %cmp16 = icmp eq i64 %10, 0
  br i1 %cmp16, label %while.end, label %if.end18

if.end18:                                         ; preds = %if.end15
  %12 = load i64, ptr %srcPos.i, align 8
...
cleanup24:                                        ; preds = %if.end18
  ...
  %13 = load i64, ptr %srcPos.i, align 8
...
if.end:                                           ; preds = %entry
  ...
  %4 = load i32, ptr %needInitState, align 4
...
if.end35.us:                                      ; preds = %while.body.us
  ...
  store i8 %conv39.us, ptr %arrayidx.us, align 1
  ...
  store i8 %conv41.us, ptr %arrayidx43.us, align 1
  ...
  store i32 %sub54.us, ptr %unpackSize, align 4
  %add56.us = add i64 %inc46.us, %conv53.us
  %11 = load i64, ptr %srcPos, align 8
  %add59.us = add i64 %11, %conv53.us
  store i64 %add59.us, ptr %srcPos, align 8
  store i64 %add56.us, ptr %packSizeRes, align 8
  %cmp24.not.us = icmp eq i32 %sub54.us, 0
  br i1 %cmp24.not.us, label %while.end, label %while.body.us
...
if.end35:                                         ; preds = %while.body
  %13 = load i64, ptr %srcPos, align 8
  %cmp36 = icmp eq i64 %13, 0
  %conv39 = select i1 %cmp36, i8 1, i8 2
  store i8 %conv39, ptr %outBuf, align 1
  ...
  %15 = load i32, ptr %unpackSize, align 4
  ...
  store i32 %sub54, ptr %unpackSize, align 4
  %add56 = add nuw nsw i64 %conv53, 3
  %16 = load i64, ptr %srcPos, align 8
  %add59 = add i64 %16, %conv53
  store i64 %add59, ptr %srcPos, align 8
  %17 = load i64, ptr %packSizeRes, align 8
  %add62 = add i64 %17, %add56
  store i64 %add62, ptr %packSizeRes, align 8
...
cond.end92:                                       ; preds = %cond.true85, %cond.false82, %if.end72
  ...
  store i8 %conv96, ptr %outBuf, align 1
  ...
  %26 = load i32, ptr %needInitProp, align 8
...
if.end133:                                        ; preds = %if.then126, %if.end118
  store i64 %add121, ptr %packSizeRes, align 8
  br label %cleanup138
