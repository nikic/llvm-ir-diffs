; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/XzDec.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/XzDec.c"
...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %cmp7, label %for.cond, label %cleanup18.split.loop.exit30
...
cleanup18.split.loop.exit30:                      ; preds = %for.body
  ...
  %or.cond.le = and i1 %cmp12.le, %cmp10.le
...
entry:
  ...
  store i32 0, ptr %encodeMode, align 4
  ...
  %0 = load i32, ptr %methodId, align 8
  %cmp = icmp eq i32 %0, 3
...
if.end:                                           ; preds = %if.then
  ...
  store i32 %add, ptr %delta, align 8
  br label %if.end30
...
entry:
  ...
  store i32 0, ptr %x86State, align 8
  %methodId = getelementptr inbounds %struct.CBraState, ptr %pp, i64 0, i32 3
...
entry:
  ...
  %1 = load i64, ptr %srcLen, align 8
  store i64 0, ptr %destLen, align 8
  store i64 0, ptr %srcLen, align 8
  store i32 0, ptr %wasFinished, align 4
...
while.body:                                       ; preds = %while.body.lr.ph, %if.then
  ...
  %3 = load i64, ptr %bufConv, align 8
...
if.then:                                          ; preds = %while.body
  ...
  store i64 %add, ptr %pp, align 8
  %5 = load i64, ptr %destLen, align 8
  %add8 = add i64 %5, %spec.select
  store i64 %add8, ptr %destLen, align 8
...
if.end11:                                         ; preds = %while.body
  %6 = load i64, ptr %bufTotal, align 8
  %sub13 = sub i64 %6, %2
  store i64 %sub13, ptr %bufTotal, align 8
  ...
  store i64 %add33, ptr %srcLen, align 8
...
sw.bb:                                            ; preds = %if.end41
  %10 = load i32, ptr %encodeMode99, align 4
  %tobool.not = icmp eq i32 %10, 0
  %11 = load i32, ptr %delta, align 8
...
if.end53:                                         ; preds = %if.else, %if.then42
  %12 = load i64, ptr %bufTotal, align 8
  br label %sw.epilog

sw.bb56:                                          ; preds = %if.end41
  %13 = load i32, ptr %ip98, align 4
  %14 = load i32, ptr %encodeMode99, align 4
...
sw.bb62:                                          ; preds = %if.end41
  %15 = load i32, ptr %ip98, align 4
  %16 = load i32, ptr %encodeMode99, align 4
...
sw.bb70:                                          ; preds = %if.end41
  %17 = load i32, ptr %ip98, align 4
  %18 = load i32, ptr %encodeMode99, align 4
...
sw.bb78:                                          ; preds = %if.end41
  %19 = load i32, ptr %ip98, align 4
  %20 = load i32, ptr %encodeMode99, align 4
...
sw.bb86:                                          ; preds = %if.end41
  %21 = load i32, ptr %ip98, align 4
  %22 = load i32, ptr %encodeMode99, align 4
...
sw.bb94:                                          ; preds = %if.end41
  %23 = load i32, ptr %ip98, align 4
  %24 = load i32, ptr %encodeMode99, align 4
...
sw.epilog:                                        ; preds = %sw.bb94, %sw.bb86, %sw.bb78, %sw.bb70, %sw.bb62, %sw.bb56, %if.end53
  ...
  store i64 %call100.sink, ptr %bufConv, align 8
  %conv = trunc i64 %call100.sink to i32
  %25 = load i32, ptr %ip98, align 4
  %add104 = add i32 %25, %conv
  store i32 %add104, ptr %ip98, align 4
...
if.end111:                                        ; preds = %if.then108
  %26 = load i64, ptr %bufTotal, align 8
  store i64 %26, ptr %bufConv, align 8
...
while.end:                                        ; preds = %if.then108, %if.end11, %if.then, %entry
  ...
  %27 = load i64, ptr %bufTotal115, align 8
  %28 = load i64, ptr %pp, align 8
...
if.then123:                                       ; preds = %while.end
  store i32 1, ptr %wasFinished, align 4
  br label %cleanup
...
entry:
  ...
  store i32 0, ptr %numCoders, align 8
...
entry:
  %numCoders = getelementptr inbounds %struct.CMixCoder, ptr %p, i64 0, i32 2
  %0 = load i32, ptr %numCoders, align 8
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %.pre = load i32, ptr %numCoders, align 8
  br label %if.end
...
if.end:                                           ; preds = %if.then, %land.lhs.true, %for.body
  ...
  br i1 %cmp, label %for.bodythread-pre-split, label %for.end
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <2 x i64> zeroinitializer, ptr %1, align 8
  %2 = getelementptr inbounds i64, ptr %1, i64 2
  store <2 x i64> zeroinitializer, ptr %2, align 8
  %3 = getelementptr inbounds %struct.CMixCoder, ptr %p, i64 0, i32 4, i64 %index
  store <2 x i64> zeroinitializer, ptr %3, align 8
  %4 = getelementptr inbounds i64, ptr %3, i64 2
  store <2 x i64> zeroinitializer, ptr %4, align 8
  %5 = getelementptr inbounds %struct.CMixCoder, ptr %p, i64 0, i32 3, i64 %index
  store <2 x i32> zeroinitializer, ptr %5, align 4
  %6 = getelementptr inbounds i32, ptr %5, i64 2
  store <2 x i32> zeroinitializer, ptr %6, align 4
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %10 = load i32, ptr %numCoders, align 8
...
entry:
  ...
  store i64 %methodId, ptr %arrayidx2, align 8
...
sw.epilog:                                        ; preds = %entry
  ...
  br i1 %or.cond, label %cleanup, label %if.end.i13

if.end.i13:                                       ; preds = %sw.epilog
  %3 = load ptr, ptr %p, align 8
  store ptr null, ptr %arrayidx, align 8
  %4 = load ptr, ptr %3, align 8
  %call.i14 = tail call ptr %4(ptr noundef nonnull %3, i64 noundef 16688) #11
  %cmp13.i = icmp eq ptr %call.i14, null
  br i1 %cmp13.i, label %cleanup, label %if.end15.i

if.end15.i:                                       ; preds = %if.end.i13
  %conv.i = trunc i64 %methodId to i32
  %methodId.i = getelementptr inbounds %struct.CBraState, ptr %call.i14, i64 0, i32 3
  store i32 %conv.i, ptr %methodId.i, align 8
  store ptr %call.i14, ptr %arrayidx, align 8
  %Free.i15 = getelementptr inbounds %struct.CMixCoder, ptr %p, i64 0, i32 7, i64 %idxprom, i32 1
  store ptr @BraState_Free, ptr %Free.i15, align 8
  %SetProps.i16 = getelementptr inbounds %struct.CMixCoder, ptr %p, i64 0, i32 7, i64 %idxprom, i32 2
  store ptr @BraState_SetProps, ptr %SetProps.i16, align 8
  %Init.i17 = getelementptr inbounds %struct.CMixCoder, ptr %p, i64 0, i32 7, i64 %idxprom, i32 3
  store ptr @BraState_Init, ptr %Init.i17, align 8
  %Code.i18 = getelementptr inbounds %struct.CMixCoder, ptr %p, i64 0, i32 7, i64 %idxprom, i32 4
  store ptr @BraState_Code, ptr %Code.i18, align 8
  br label %cleanup

cleanup:                                          ; preds = %if.end15.i, %if.end.i13, %if.end.i, %sw.bb, %sw.epilog
  %retval.0 = phi i32 [ 4, %sw.epilog ], [ 0, %if.end.i ], [ 2, %sw.bb ], [ 0, %if.end15.i ], [ 2, %if.end.i13 ]
  ret i32 %retval.0
}
...
if.end6:                                          ; preds = %if.then, %entry
  %numCoders = getelementptr inbounds %struct.CMixCoder, ptr %p, i64 0, i32 2
  %5 = load i32, ptr %numCoders, align 8
...
if.else38.peel:                                   ; preds = %if.end32.peel
  %10 = load i64, ptr %arrayidx41.peel, align 8
  %11 = load i64, ptr %arrayidx44.peel, align 8
...
if.end66.peel:                                    ; preds = %if.then36.peel, %if.end47.peel
  ...
  store i64 %storemerge.peel, ptr %destLenCur, align 8
  %14 = load ptr, ptr %Code.peel, align 8
  %15 = load ptr, ptr %arrayidx.peel, align 8
...
if.then36:                                        ; preds = %if.end32
  %33 = load i64, ptr %destLen, align 8
  %sub37 = sub i64 %0, %33
  br label %if.end66
...
if.end66:                                         ; preds = %if.end47, %if.then36
  ...
  store i64 %storemerge, ptr %destLenCur, align 8
...
if.else73:                                        ; preds = %if.end66
  ...
  store i64 %45, ptr %arrayidx76, align 8
  ...
  store i32 %39, ptr %arrayidx82, align 4
  br label %if.end83
...
for.inc:                                          ; preds = %if.end86, %if.else38
  ...
  br i1 %cmp12, label %if.end32, label %for.end
...
for.end:                                          ; preds = %for.inc, %for.inc.peel
  ...
  br i1 %tobool98.not, label %for.end105, label %for.cond

for.end105:                                       ; preds = %for.cond, %for.end
  %allFinished.1.lcssa212 = phi i32 [ %allFinished.1.lcssa, %for.end ], [ %allFinished.0, %for.cond ]
  %51 = icmp eq i32 %allFinished.1.lcssa212, 0
  br i1 %51, label %cleanup109, label %if.then107
...
entry:
  ...
  %2 = load i32, ptr %add.ptr8, align 4
...
for.body.i:                                       ; preds = %for.cond.i
  ...
  %or.i = or i64 %shl.i, %5
  store i64 %or.i, ptr %p, align 8
  %cmp7.i = icmp slt i8 %6, 0
  br i1 %cmp7.i, label %for.cond.i, label %cleanup18.split.loop.exit30.i
...
cleanup18.split.loop.exit30.i:                    ; preds = %for.body.i
  ...
  %or.cond.le.i = and i1 %cmp12.le.i, %cmp10.le.i
...
for.cond.i186:                                    ; preds = %for.body.i189, %if.then37
  %12 = phi i64 [ %or.i194, %for.body.i189 ], [ 0, %if.then37 ]
  %indvars.iv.i187 = phi i64 [ %indvars.iv.next.i192, %for.body.i189 ], [ 0, %if.then37 ]
  %exitcond.not.i188 = icmp eq i64 %indvars.iv.i187, %cond29.i185
  br i1 %exitcond.not.i188, label %cleanup119, label %for.body.i189

for.body.i189:                                    ; preds = %for.cond.i186
  %arrayidx.i190 = getelementptr inbounds i8, ptr %add.ptr40, i64 %indvars.iv.i187
  %13 = load i8, ptr %arrayidx.i190, align 1
  %14 = and i8 %13, 127
  %conv4.i191 = zext i8 %14 to i64
  %indvars.iv.next.i192 = add nuw nsw i64 %indvars.iv.i187, 1
  %15 = mul nuw nsw i64 %indvars.iv.i187, 7
  %shl.i193 = shl i64 %conv4.i191, %15
  %or.i194 = or i64 %shl.i193, %12
  store i64 %or.i194, ptr %unpackSize, align 8
  %cmp7.i195 = icmp slt i8 %13, 0
  br i1 %cmp7.i195, label %for.cond.i186, label %cleanup18.split.loop.exit30.i196

cleanup18.split.loop.exit30.i196:                 ; preds = %for.body.i189
  %16 = trunc i64 %indvars.iv.next.i192 to i32
  %cmp10.le.i197 = icmp eq i8 %13, 0
  %17 = and i64 %indvars.iv.i187, 4294967295
  %cmp12.le.i198 = icmp ne i64 %17, 0
  %or.cond.le.i199 = and i1 %cmp12.le.i198, %cmp10.le.i197
  %cmp44.not = icmp eq i32 %16, 0
  %add48 = add i32 %pos.1, %16
  %or.cond258 = select i1 %or.cond.le.i199, i1 true, i1 %cmp44.not
  br i1 %or.cond258, label %cleanup119, label %if.end52

if.end52:                                         ; preds = %cleanup18.split.loop.exit30.i196, %if.end31
  %pos.3 = phi i32 [ %pos.1, %if.end31 ], [ %add48, %cleanup18.split.loop.exit30.i196 ]
  %18 = and i8 %2, 3
  ...
  store i64 0, ptr %filters, align 8
  %19 = tail call i32 @llvm.umin.i32(i32 %sub64, i32 9)
  %cond29.i203 = zext i32 %19 to i64
  %20 = add i32 %pos.3, 2
  br label %for.cond.i204

for.cond.i204:                                    ; preds = %for.body.i207, %if.end52
  %indvars.iv289 = phi i32 [ %indvars.iv.next290, %for.body.i207 ], [ %20, %if.end52 ]
  %21 = phi i64 [ %or.i212, %for.body.i207 ], [ 0, %if.end52 ]
  %indvars.iv.i205 = phi i64 [ %indvars.iv.next.i210, %for.body.i207 ], [ 0, %if.end52 ]
  %exitcond.not.i206 = icmp eq i64 %indvars.iv.i205, %cond29.i203
  br i1 %exitcond.not.i206, label %cleanup119, label %for.body.i207

for.body.i207:                                    ; preds = %for.cond.i204
  %arrayidx.i208 = getelementptr inbounds i8, ptr %add.ptr63, i64 %indvars.iv.i205
  %22 = load i8, ptr %arrayidx.i208, align 1
  %23 = and i8 %22, 127
  %conv4.i209 = zext i8 %23 to i64
  %indvars.iv.next.i210 = add nuw nsw i64 %indvars.iv.i205, 1
  %24 = mul nuw nsw i64 %indvars.iv.i205, 7
  %shl.i211 = shl i64 %conv4.i209, %24
  %or.i212 = or i64 %shl.i211, %21
  store i64 %or.i212, ptr %filters, align 8
  %cmp7.i213 = icmp slt i8 %22, 0
  %indvars.iv.next290 = add i32 %indvars.iv289, 1
  br i1 %cmp7.i213, label %for.cond.i204, label %cleanup18.split.loop.exit30.i214

cleanup18.split.loop.exit30.i214:                 ; preds = %for.body.i207
  %cmp10.le.i215 = icmp eq i8 %22, 0
  %25 = and i64 %indvars.iv.i205, 4294967295
  %cmp12.le.i216 = icmp ne i64 %25, 0
  %or.cond.le.i217 = and i1 %cmp12.le.i216, %cmp10.le.i215
  br i1 %or.cond.le.i217, label %cleanup119, label %cleanup.cont74

cleanup.cont74:                                   ; preds = %cleanup18.split.loop.exit30.i214
  %26 = trunc i64 %indvars.iv.next.i210 to i32
...
for.cond.i222:                                    ; preds = %for.body.i225, %cleanup.cont74
  %indvars.iv292 = phi i32 [ %indvars.iv.next293, %for.body.i225 ], [ %indvars.iv289, %cleanup.cont74 ]
  %28 = phi i64 [ %or.i230, %for.body.i225 ], [ 0, %cleanup.cont74 ]
  %indvars.iv.i223 = phi i64 [ %indvars.iv.next.i228, %for.body.i225 ], [ 0, %cleanup.cont74 ]
  %exitcond.not.i224 = icmp eq i64 %indvars.iv.i223, %cond29.i221
  br i1 %exitcond.not.i224, label %cleanup119, label %for.body.i225

for.body.i225:                                    ; preds = %for.cond.i222
  %arrayidx.i226 = getelementptr inbounds i8, ptr %add.ptr77, i64 %indvars.iv.i223
  %29 = load i8, ptr %arrayidx.i226, align 1
  %30 = and i8 %29, 127
  %conv4.i227 = zext i8 %30 to i64
  %indvars.iv.next.i228 = add nuw nsw i64 %indvars.iv.i223, 1
  %31 = mul nuw nsw i64 %indvars.iv.i223, 7
  %shl.i229 = shl i64 %conv4.i227, %31
  %or.i230 = or i64 %shl.i229, %28
  %cmp7.i231 = icmp slt i8 %29, 0
  %indvars.iv.next293 = add i32 %indvars.iv292, 1
  br i1 %cmp7.i231, label %for.cond.i222, label %cleanup18.split.loop.exit30.i232

cleanup18.split.loop.exit30.i232:                 ; preds = %for.body.i225
  %cmp10.le.i233 = icmp eq i8 %29, 0
  %32 = and i64 %indvars.iv.i223, 4294967295
  %cmp12.le.i234 = icmp ne i64 %32, 0
  %or.cond.le.i235 = and i1 %cmp12.le.i234, %cmp10.le.i233
  br i1 %or.cond.le.i235, label %cleanup119, label %cleanup.cont88

cleanup.cont88:                                   ; preds = %cleanup18.split.loop.exit30.i232
  %33 = trunc i64 %indvars.iv.next.i228 to i32
  %add85 = add i32 %add71, %33
  %sub89 = sub i32 %shl, %add85
  %conv90 = zext i32 %sub89 to i64
  %cmp91 = icmp ugt i64 %or.i230, %conv90
  %cmp94 = icmp ugt i64 %or.i230, 20
  %or.cond = or i1 %cmp91, %cmp94
  br i1 %or.cond, label %cleanup119, label %for.inc

for.inc:                                          ; preds = %cleanup.cont88
  %conv98 = trunc i64 %or.i230 to i32
  %propsSize = getelementptr inbounds %struct.CXzBlock, ptr %p, i64 0, i32 3, i64 0, i32 1
  store i32 %conv98, ptr %propsSize, align 8
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %props, ptr nonnull align 1 %add.ptr101, i64 %or.i230, i1 false)
  %add103 = add i32 %add85, %conv98
  %exitcond.not = icmp eq i8 %18, 0
  br i1 %exitcond.not, label %while.cond.preheader, label %for.body.1
...
for.body.1:                                       ; preds = %for.inc
  ...
  store i64 0, ptr %add.ptr60.1, align 8
  %34 = tail call i32 @llvm.umin.i32(i32 %sub64.1, i32 9)
  %cond29.i203.1 = zext i32 %34 to i64
  %35 = add i32 %add103, 2
  br label %for.cond.i204.1

for.cond.i204.1:                                  ; preds = %for.body.i207.1, %for.body.1
  %indvars.iv289.1 = phi i32 [ %indvars.iv.next290.1, %for.body.i207.1 ], [ %35, %for.body.1 ]
  %36 = phi i64 [ %or.i212.1, %for.body.i207.1 ], [ 0, %for.body.1 ]
  %indvars.iv.i205.1 = phi i64 [ %indvars.iv.next.i210.1, %for.body.i207.1 ], [ 0, %for.body.1 ]
  %exitcond.not.i206.1 = icmp eq i64 %indvars.iv.i205.1, %cond29.i203.1
  br i1 %exitcond.not.i206.1, label %cleanup119, label %for.body.i207.1

for.body.i207.1:                                  ; preds = %for.cond.i204.1
  %arrayidx.i208.1 = getelementptr inbounds i8, ptr %add.ptr63.1, i64 %indvars.iv.i205.1
  %37 = load i8, ptr %arrayidx.i208.1, align 1
  %38 = and i8 %37, 127
  %conv4.i209.1 = zext i8 %38 to i64
  %indvars.iv.next.i210.1 = add nuw nsw i64 %indvars.iv.i205.1, 1
  %39 = mul nuw nsw i64 %indvars.iv.i205.1, 7
  %shl.i211.1 = shl i64 %conv4.i209.1, %39
  %or.i212.1 = or i64 %shl.i211.1, %36
  store i64 %or.i212.1, ptr %add.ptr60.1, align 8
  %cmp7.i213.1 = icmp slt i8 %37, 0
  %indvars.iv.next290.1 = add i32 %indvars.iv289.1, 1
  br i1 %cmp7.i213.1, label %for.cond.i204.1, label %cleanup18.split.loop.exit30.i214.1

cleanup18.split.loop.exit30.i214.1:               ; preds = %for.body.i207.1
  %cmp10.le.i215.1 = icmp eq i8 %37, 0
  %40 = and i64 %indvars.iv.i205.1, 4294967295
  %cmp12.le.i216.1 = icmp ne i64 %40, 0
  %or.cond.le.i217.1 = and i1 %cmp12.le.i216.1, %cmp10.le.i215.1
  br i1 %or.cond.le.i217.1, label %cleanup119, label %cleanup.cont74.1

cleanup.cont74.1:                                 ; preds = %cleanup18.split.loop.exit30.i214.1
  %41 = trunc i64 %indvars.iv.next.i210.1 to i32
  ...
  br label %for.cond.i222.1

for.cond.i222.1:                                  ; preds = %for.body.i225.1, %cleanup.cont74.1
  %indvars.iv292.1 = phi i32 [ %indvars.iv.next293.1, %for.body.i225.1 ], [ %indvars.iv289.1, %cleanup.cont74.1 ]
  %43 = phi i64 [ %or.i230.1, %for.body.i225.1 ], [ 0, %cleanup.cont74.1 ]
  %indvars.iv.i223.1 = phi i64 [ %indvars.iv.next.i228.1, %for.body.i225.1 ], [ 0, %cleanup.cont74.1 ]
  %exitcond.not.i224.1 = icmp eq i64 %indvars.iv.i223.1, %cond29.i221.1
  br i1 %exitcond.not.i224.1, label %cleanup119, label %for.body.i225.1

for.body.i225.1:                                  ; preds = %for.cond.i222.1
  %arrayidx.i226.1 = getelementptr inbounds i8, ptr %add.ptr77.1, i64 %indvars.iv.i223.1
  %44 = load i8, ptr %arrayidx.i226.1, align 1
  %45 = and i8 %44, 127
  %conv4.i227.1 = zext i8 %45 to i64
  %indvars.iv.next.i228.1 = add nuw nsw i64 %indvars.iv.i223.1, 1
  %46 = mul nuw nsw i64 %indvars.iv.i223.1, 7
  %shl.i229.1 = shl i64 %conv4.i227.1, %46
  %or.i230.1 = or i64 %shl.i229.1, %43
  %cmp7.i231.1 = icmp slt i8 %44, 0
  %indvars.iv.next293.1 = add i32 %indvars.iv292.1, 1
  br i1 %cmp7.i231.1, label %for.cond.i222.1, label %cleanup18.split.loop.exit30.i232.1

cleanup18.split.loop.exit30.i232.1:               ; preds = %for.body.i225.1
  %cmp10.le.i233.1 = icmp eq i8 %44, 0
  %47 = and i64 %indvars.iv.i223.1, 4294967295
  %cmp12.le.i234.1 = icmp ne i64 %47, 0
  %or.cond.le.i235.1 = and i1 %cmp12.le.i234.1, %cmp10.le.i233.1
  br i1 %or.cond.le.i235.1, label %cleanup119, label %cleanup.cont88.1

cleanup.cont88.1:                                 ; preds = %cleanup18.split.loop.exit30.i232.1
  %48 = trunc i64 %indvars.iv.next.i228.1 to i32
  %add85.1 = add i32 %add71.1, %48
  %sub89.1 = sub i32 %shl, %add85.1
  %conv90.1 = zext i32 %sub89.1 to i64
  %cmp91.1 = icmp ugt i64 %or.i230.1, %conv90.1
  %cmp94.1 = icmp ugt i64 %or.i230.1, 20
  %or.cond.1 = or i1 %cmp91.1, %cmp94.1
  br i1 %or.cond.1, label %cleanup119, label %for.inc.1

for.inc.1:                                        ; preds = %cleanup.cont88.1
  %conv98.1 = trunc i64 %or.i230.1 to i32
  %propsSize.1 = getelementptr inbounds %struct.CXzBlock, ptr %p, i64 0, i32 3, i64 1, i32 1
  store i32 %conv98.1, ptr %propsSize.1, align 8
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %props.1, ptr nonnull align 1 %add.ptr101.1, i64 %or.i230.1, i1 false)
  %add103.1 = add i32 %add85.1, %conv98.1
  %exitcond.not.1 = icmp eq i8 %narrow, 2
  br i1 %exitcond.not.1, label %while.cond.preheader, label %for.body.2
...
for.body.2:                                       ; preds = %for.inc.1
  ...
  store i64 0, ptr %add.ptr60.2, align 8
  %49 = tail call i32 @llvm.umin.i32(i32 %sub64.2, i32 9)
  %cond29.i203.2 = zext i32 %49 to i64
  %50 = add i32 %add103.1, 2
  br label %for.cond.i204.2

for.cond.i204.2:                                  ; preds = %for.body.i207.2, %for.body.2
  %indvars.iv289.2 = phi i32 [ %indvars.iv.next290.2, %for.body.i207.2 ], [ %50, %for.body.2 ]
  %51 = phi i64 [ %or.i212.2, %for.body.i207.2 ], [ 0, %for.body.2 ]
  %indvars.iv.i205.2 = phi i64 [ %indvars.iv.next.i210.2, %for.body.i207.2 ], [ 0, %for.body.2 ]
  %exitcond.not.i206.2 = icmp eq i64 %indvars.iv.i205.2, %cond29.i203.2
  br i1 %exitcond.not.i206.2, label %cleanup119, label %for.body.i207.2

for.body.i207.2:                                  ; preds = %for.cond.i204.2
  %arrayidx.i208.2 = getelementptr inbounds i8, ptr %add.ptr63.2, i64 %indvars.iv.i205.2
  %52 = load i8, ptr %arrayidx.i208.2, align 1
  %53 = and i8 %52, 127
  %conv4.i209.2 = zext i8 %53 to i64
  %indvars.iv.next.i210.2 = add nuw nsw i64 %indvars.iv.i205.2, 1
  %54 = mul nuw nsw i64 %indvars.iv.i205.2, 7
  %shl.i211.2 = shl i64 %conv4.i209.2, %54
  %or.i212.2 = or i64 %shl.i211.2, %51
  store i64 %or.i212.2, ptr %add.ptr60.2, align 8
  %cmp7.i213.2 = icmp slt i8 %52, 0
  %indvars.iv.next290.2 = add i32 %indvars.iv289.2, 1
  br i1 %cmp7.i213.2, label %for.cond.i204.2, label %cleanup18.split.loop.exit30.i214.2

cleanup18.split.loop.exit30.i214.2:               ; preds = %for.body.i207.2
  %cmp10.le.i215.2 = icmp eq i8 %52, 0
  %55 = and i64 %indvars.iv.i205.2, 4294967295
  %cmp12.le.i216.2 = icmp ne i64 %55, 0
  %or.cond.le.i217.2 = and i1 %cmp12.le.i216.2, %cmp10.le.i215.2
  br i1 %or.cond.le.i217.2, label %cleanup119, label %cleanup.cont74.2

cleanup.cont74.2:                                 ; preds = %cleanup18.split.loop.exit30.i214.2
  %56 = trunc i64 %indvars.iv.next.i210.2 to i32
  ...
  br label %for.cond.i222.2

for.cond.i222.2:                                  ; preds = %for.body.i225.2, %cleanup.cont74.2
  %indvars.iv292.2 = phi i32 [ %indvars.iv.next293.2, %for.body.i225.2 ], [ %indvars.iv289.2, %cleanup.cont74.2 ]
  %58 = phi i64 [ %or.i230.2, %for.body.i225.2 ], [ 0, %cleanup.cont74.2 ]
  %indvars.iv.i223.2 = phi i64 [ %indvars.iv.next.i228.2, %for.body.i225.2 ], [ 0, %cleanup.cont74.2 ]
  %exitcond.not.i224.2 = icmp eq i64 %indvars.iv.i223.2, %cond29.i221.2
  br i1 %exitcond.not.i224.2, label %cleanup119, label %for.body.i225.2

for.body.i225.2:                                  ; preds = %for.cond.i222.2
  %arrayidx.i226.2 = getelementptr inbounds i8, ptr %add.ptr77.2, i64 %indvars.iv.i223.2
  %59 = load i8, ptr %arrayidx.i226.2, align 1
  %60 = and i8 %59, 127
  %conv4.i227.2 = zext i8 %60 to i64
  %indvars.iv.next.i228.2 = add nuw nsw i64 %indvars.iv.i223.2, 1
  %61 = mul nuw nsw i64 %indvars.iv.i223.2, 7
  %shl.i229.2 = shl i64 %conv4.i227.2, %61
  %or.i230.2 = or i64 %shl.i229.2, %58
  %cmp7.i231.2 = icmp slt i8 %59, 0
  %indvars.iv.next293.2 = add i32 %indvars.iv292.2, 1
  br i1 %cmp7.i231.2, label %for.cond.i222.2, label %cleanup18.split.loop.exit30.i232.2

cleanup18.split.loop.exit30.i232.2:               ; preds = %for.body.i225.2
  %cmp10.le.i233.2 = icmp eq i8 %59, 0
  %62 = and i64 %indvars.iv.i223.2, 4294967295
  %cmp12.le.i234.2 = icmp ne i64 %62, 0
  %or.cond.le.i235.2 = and i1 %cmp12.le.i234.2, %cmp10.le.i233.2
  br i1 %or.cond.le.i235.2, label %cleanup119, label %cleanup.cont88.2

cleanup.cont88.2:                                 ; preds = %cleanup18.split.loop.exit30.i232.2
  %63 = trunc i64 %indvars.iv.next.i228.2 to i32
  %add85.2 = add i32 %add71.2, %63
  %sub89.2 = sub i32 %shl, %add85.2
  %conv90.2 = zext i32 %sub89.2 to i64
  %cmp91.2 = icmp ugt i64 %or.i230.2, %conv90.2
  %cmp94.2 = icmp ugt i64 %or.i230.2, 20
  %or.cond.2 = or i1 %cmp91.2, %cmp94.2
  br i1 %or.cond.2, label %cleanup119, label %for.inc.2

for.inc.2:                                        ; preds = %cleanup.cont88.2
  %conv98.2 = trunc i64 %or.i230.2 to i32
  %propsSize.2 = getelementptr inbounds %struct.CXzBlock, ptr %p, i64 0, i32 3, i64 2, i32 1
  store i32 %conv98.2, ptr %propsSize.2, align 8
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %props.2, ptr nonnull align 1 %add.ptr101.2, i64 %or.i230.2, i1 false)
  %add103.2 = add i32 %add85.2, %conv98.2
  %exitcond.not.2 = icmp eq i8 %narrow, 3
  br i1 %exitcond.not.2, label %while.cond.preheader, label %for.body.3
...
for.body.3:                                       ; preds = %for.inc.2
  ...
  store i64 0, ptr %add.ptr60.3, align 8
  %64 = tail call i32 @llvm.umin.i32(i32 %sub64.3, i32 9)
  %cond29.i203.3 = zext i32 %64 to i64
  %65 = add i32 %add103.2, 2
  br label %for.cond.i204.3

for.cond.i204.3:                                  ; preds = %for.body.i207.3, %for.body.3
  %indvars.iv289.3 = phi i32 [ %indvars.iv.next290.3, %for.body.i207.3 ], [ %65, %for.body.3 ]
  %66 = phi i64 [ %or.i212.3, %for.body.i207.3 ], [ 0, %for.body.3 ]
  %indvars.iv.i205.3 = phi i64 [ %indvars.iv.next.i210.3, %for.body.i207.3 ], [ 0, %for.body.3 ]
  %exitcond.not.i206.3 = icmp eq i64 %indvars.iv.i205.3, %cond29.i203.3
  br i1 %exitcond.not.i206.3, label %cleanup119, label %for.body.i207.3

for.body.i207.3:                                  ; preds = %for.cond.i204.3
  %arrayidx.i208.3 = getelementptr inbounds i8, ptr %add.ptr63.3, i64 %indvars.iv.i205.3
  %67 = load i8, ptr %arrayidx.i208.3, align 1
  %68 = and i8 %67, 127
  %conv4.i209.3 = zext i8 %68 to i64
  %indvars.iv.next.i210.3 = add nuw nsw i64 %indvars.iv.i205.3, 1
  %69 = mul nuw nsw i64 %indvars.iv.i205.3, 7
  %shl.i211.3 = shl i64 %conv4.i209.3, %69
  %or.i212.3 = or i64 %shl.i211.3, %66
  store i64 %or.i212.3, ptr %add.ptr60.3, align 8
  %cmp7.i213.3 = icmp slt i8 %67, 0
  %indvars.iv.next290.3 = add i32 %indvars.iv289.3, 1
  br i1 %cmp7.i213.3, label %for.cond.i204.3, label %cleanup18.split.loop.exit30.i214.3

cleanup18.split.loop.exit30.i214.3:               ; preds = %for.body.i207.3
  %cmp10.le.i215.3 = icmp eq i8 %67, 0
  %70 = and i64 %indvars.iv.i205.3, 4294967295
  %cmp12.le.i216.3 = icmp ne i64 %70, 0
  %or.cond.le.i217.3 = and i1 %cmp12.le.i216.3, %cmp10.le.i215.3
  br i1 %or.cond.le.i217.3, label %cleanup119, label %cleanup.cont74.3

cleanup.cont74.3:                                 ; preds = %cleanup18.split.loop.exit30.i214.3
  %71 = trunc i64 %indvars.iv.next.i210.3 to i32
  ...
  br label %for.cond.i222.3

for.cond.i222.3:                                  ; preds = %for.body.i225.3, %cleanup.cont74.3
  %indvars.iv292.3 = phi i32 [ %indvars.iv.next293.3, %for.body.i225.3 ], [ %indvars.iv289.3, %cleanup.cont74.3 ]
  %73 = phi i64 [ %or.i230.3, %for.body.i225.3 ], [ 0, %cleanup.cont74.3 ]
  %indvars.iv.i223.3 = phi i64 [ %indvars.iv.next.i228.3, %for.body.i225.3 ], [ 0, %cleanup.cont74.3 ]
  %exitcond.not.i224.3 = icmp eq i64 %indvars.iv.i223.3, %cond29.i221.3
  br i1 %exitcond.not.i224.3, label %cleanup119, label %for.body.i225.3

for.body.i225.3:                                  ; preds = %for.cond.i222.3
  %arrayidx.i226.3 = getelementptr inbounds i8, ptr %add.ptr77.3, i64 %indvars.iv.i223.3
  %74 = load i8, ptr %arrayidx.i226.3, align 1
  %75 = and i8 %74, 127
  %conv4.i227.3 = zext i8 %75 to i64
  %indvars.iv.next.i228.3 = add nuw nsw i64 %indvars.iv.i223.3, 1
  %76 = mul nuw nsw i64 %indvars.iv.i223.3, 7
  %shl.i229.3 = shl i64 %conv4.i227.3, %76
  %or.i230.3 = or i64 %shl.i229.3, %73
  %cmp7.i231.3 = icmp slt i8 %74, 0
  %indvars.iv.next293.3 = add i32 %indvars.iv292.3, 1
  br i1 %cmp7.i231.3, label %for.cond.i222.3, label %cleanup18.split.loop.exit30.i232.3

cleanup18.split.loop.exit30.i232.3:               ; preds = %for.body.i225.3
  %cmp10.le.i233.3 = icmp eq i8 %74, 0
  %77 = and i64 %indvars.iv.i223.3, 4294967295
  %cmp12.le.i234.3 = icmp ne i64 %77, 0
  %or.cond.le.i235.3 = and i1 %cmp12.le.i234.3, %cmp10.le.i233.3
  br i1 %or.cond.le.i235.3, label %cleanup119, label %cleanup.cont88.3

cleanup.cont88.3:                                 ; preds = %cleanup18.split.loop.exit30.i232.3
  %78 = trunc i64 %indvars.iv.next.i228.3 to i32
  %add85.3 = add i32 %add71.3, %78
  %sub89.3 = sub i32 %shl, %add85.3
  %conv90.3 = zext i32 %sub89.3 to i64
  %cmp91.3 = icmp ugt i64 %or.i230.3, %conv90.3
  %cmp94.3 = icmp ugt i64 %or.i230.3, 20
  %or.cond.3 = or i1 %cmp91.3, %cmp94.3
  br i1 %or.cond.3, label %cleanup119, label %for.inc.3

for.inc.3:                                        ; preds = %cleanup.cont88.3
  %conv98.3 = trunc i64 %or.i230.3 to i32
  %propsSize.3 = getelementptr inbounds %struct.CXzBlock, ptr %p, i64 0, i32 3, i64 3, i32 1
  store i32 %conv98.3, ptr %propsSize.3, align 8
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %props.3, ptr nonnull align 1 %add.ptr101.3, i64 %or.i230.3, i1 false)
  br label %while.cond.preheader

while.cond.preheader:                             ; preds = %for.inc.3, %for.inc.2, %for.inc.1, %for.inc
  %conv98.lcssa = phi i32 [ %conv98, %for.inc ], [ %conv98.1, %for.inc.1 ], [ %conv98.2, %for.inc.2 ], [ %conv98.3, %for.inc.3 ]
  ...
  %79 = add i32 %indvars.iv292.lcssa333.lcssa, %conv98.lcssa
...
while.body:                                       ; preds = %while.cond
  ...
  %81 = load i8, ptr %arrayidx113, align 1
  %cmp115.not = icmp eq i8 %81, 0
  br i1 %cmp115.not, label %while.cond, label %cleanup119

cleanup119:                                       ; preds = %for.cond.i, %for.cond.i186, %cleanup18.split.loop.exit30.i232, %cleanup18.split.loop.exit30.i214, %cleanup.cont88, %cleanup18.split.loop.exit30.i214.1, %cleanup18.split.loop.exit30.i232.1, %cleanup.cont88.1, %cleanup18.split.loop.exit30.i214.2, %cleanup18.split.loop.exit30.i232.2, %cleanup.cont88.2, %cleanup18.split.loop.exit30.i214.3, %cleanup18.split.loop.exit30.i232.3, %cleanup.cont88.3, %for.cond.i204, %for.cond.i204.1, %for.cond.i204.2, %for.cond.i204.3, %for.cond.i222, %for.cond.i222.1, %for.cond.i222.2, %for.cond.i222.3, %while.cond, %while.body, %cleanup18.split.loop.exit30.i196, %cleanup18.split.loop.exit30.i, %cleanup.cont, %entry, %Xz_ReadVarInt.exit
  %retval.8 = phi i32 [ 16, %Xz_ReadVarInt.exit ], [ 16, %entry ], [ 16, %cleanup.cont ], [ 16, %cleanup18.split.loop.exit30.i ], [ 16, %cleanup18.split.loop.exit30.i196 ], [ 0, %while.cond ], [ 16, %while.body ], [ 16, %for.cond.i222.3 ], [ 16, %for.cond.i222.2 ], [ 16, %for.cond.i222.1 ], [ 16, %for.cond.i222 ], [ 16, %for.cond.i204.3 ], [ 16, %for.cond.i204.2 ], [ 16, %for.cond.i204.1 ], [ 16, %for.cond.i204 ], [ 16, %cleanup.cont88.3 ], [ 16, %cleanup18.split.loop.exit30.i232.3 ], [ 16, %cleanup18.split.loop.exit30.i214.3 ], [ 16, %cleanup.cont88.2 ], [ 16, %cleanup18.split.loop.exit30.i232.2 ], [ 16, %cleanup18.split.loop.exit30.i214.2 ], [ 16, %cleanup.cont88.1 ], [ 16, %cleanup18.split.loop.exit30.i232.1 ], [ 16, %cleanup18.split.loop.exit30.i214.1 ], [ 16, %cleanup.cont88 ], [ 16, %cleanup18.split.loop.exit30.i214 ], [ 16, %cleanup18.split.loop.exit30.i232 ], [ 16, %for.cond.i186 ], [ 16, %for.cond.i ]
  ret i32 %retval.8
}
...
entry:
  ...
  %numCoders = getelementptr inbounds %struct.CMixCoder, ptr %p, i64 0, i32 2
  %2 = load i32, ptr %numCoders, align 8
...
for.inc:                                          ; preds = %for.body.preheader
  ...
  br i1 %exitcond.not, label %if.end35, label %for.body.1
...
for.body.3:                                       ; preds = %for.inc.2
  ...
  %14 = load i64, ptr %arrayidx6.3, align 8
...
if.then.i:                                        ; preds = %land.lhs.true.i
  ...
  %20 = load ptr, ptr %Free.i, align 8
  tail call void %20(ptr noundef nonnull %19, ptr noundef nonnull %17) #11
  %.pre.i = load i32, ptr %numCoders, align 8
  br label %if.end.i
...
if.end.i:                                         ; preds = %if.then.i, %land.lhs.true.i, %for.body.i
  ...
  br i1 %cmp.i, label %for.bodythread-pre-split.i, label %for.end.i
...
if.then7.i:                                       ; preds = %for.end.i
  ...
  %25 = load ptr, ptr %Free9.i, align 8
...
MixCoder_Free.exit:                               ; preds = %for.end.i, %if.then7.i
  store i32 %add, ptr %numCoders, align 8
  %26 = zext i8 %1 to i64
...
for.body18:                                       ; preds = %MixCoder_Free.exit, %for.inc32
  ...
  store i64 %28, ptr %arrayidx2.i, align 8
...
sw.bb.i:                                          ; preds = %for.body18
  ...
  store ptr %call.i.i, ptr %arrayidx.i110, align 8
...
sw.epilog.i:                                      ; preds = %for.body18
  ...
  br i1 %or.cond.i, label %cleanup66, label %if.end.i13.i

if.end.i13.i:                                     ; preds = %sw.epilog.i
  %32 = load ptr, ptr %p, align 8
  store ptr null, ptr %arrayidx.i110, align 8
  %33 = load ptr, ptr %32, align 8
  %call.i14.i = tail call ptr %33(ptr noundef nonnull %32, i64 noundef 16688) #11
  %cmp13.i.i = icmp eq ptr %call.i14.i, null
  br i1 %cmp13.i.i, label %cleanup66, label %if.end15.i.i

if.end15.i.i:                                     ; preds = %if.end.i13.i
  %conv.i.i = trunc i64 %28 to i32
  %methodId.i.i = getelementptr inbounds %struct.CBraState, ptr %call.i14.i, i64 0, i32 3
  store i32 %conv.i.i, ptr %methodId.i.i, align 8
  store ptr %call.i14.i, ptr %arrayidx.i110, align 8
  %Free.i15.i = getelementptr inbounds %struct.CMixCoder, ptr %p, i64 0, i32 7, i64 %indvars.iv131, i32 1
  store ptr @BraState_Free, ptr %Free.i15.i, align 8
  %SetProps.i16.i = getelementptr inbounds %struct.CMixCoder, ptr %p, i64 0, i32 7, i64 %indvars.iv131, i32 2
  store ptr @BraState_SetProps, ptr %SetProps.i16.i, align 8
  %Init.i17.i = getelementptr inbounds %struct.CMixCoder, ptr %p, i64 0, i32 7, i64 %indvars.iv131, i32 3
  store ptr @BraState_Init, ptr %Init.i17.i, align 8
  %Code.i18.i = getelementptr inbounds %struct.CMixCoder, ptr %p, i64 0, i32 7, i64 %indvars.iv131, i32 4
  store ptr @BraState_Code, ptr %Code.i18.i, align 8
  br label %for.inc32

for.inc32:                                        ; preds = %if.end15.i.i, %if.end.i.i
  %indvars.iv.next132 = add nuw nsw i64 %indvars.iv131, 1
  %exitcond136.not = icmp eq i64 %indvars.iv.next132, %wide.trip.count135
  br i1 %exitcond136.not, label %if.end35, label %for.body18
...
for.cond36:                                       ; preds = %for.body39
  ...
  br i1 %exitcond142.not, label %for.end65, label %for.body39
...
for.body39:                                       ; preds = %if.end35, %for.cond36
  ...
  %35 = load ptr, ptr %SetProps, align 8
  ...
  %37 = load i32, ptr %propsSize, align 8
...
for.end65:                                        ; preds = %for.cond36
  %39 = load i32, ptr %numCoders, align 8
...
for.body.preheader.i:                             ; preds = %for.end65
  ...
  br i1 %min.iters.check, label %for.body.i113.preheader, label %vector.ph
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.cond5.preheader.i, label %for.body.i113.preheader

for.body.i113.preheader:                          ; preds = %for.body.preheader.i, %middle.block
  %indvars.iv.i114.ph = phi i64 [ 0, %for.body.preheader.i ], [ %n.vec, %middle.block ]
  br label %for.body.i113

for.cond5.preheader.i:                            ; preds = %for.body.i113, %middle.block, %for.end65
  %cmp730.i = icmp sgt i32 %39, 0
  br i1 %cmp730.i, label %for.body8.i, label %cleanup66

for.body.i113:                                    ; preds = %for.body.i113.preheader, %for.body.i113
  %indvars.iv.i114 = phi i64 [ %indvars.iv.next.i117, %for.body.i113 ], [ %indvars.iv.i114.ph, %for.body.i113.preheader ]
  %arrayidx.i115 = getelementptr inbounds %struct.CMixCoder, ptr %p, i64 0, i32 5, i64 %indvars.iv.i114
  store i64 0, ptr %arrayidx.i115, align 8
  %arrayidx2.i116 = getelementptr inbounds %struct.CMixCoder, ptr %p, i64 0, i32 4, i64 %indvars.iv.i114
  store i64 0, ptr %arrayidx2.i116, align 8
  %arrayidx4.i = getelementptr inbounds %struct.CMixCoder, ptr %p, i64 0, i32 3, i64 %indvars.iv.i114
  ...
  br i1 %exitcond.not.i, label %for.cond5.preheader.i, label %for.body.i113
...
for.body8.i:                                      ; preds = %for.cond5.preheader.i, %for.body8.i
  ...
  %47 = load ptr, ptr %Init.i, align 8
  %48 = load ptr, ptr %arrayidx10.i, align 8
  tail call void %47(ptr noundef %48) #11
  %indvars.iv.next34.i = add nuw nsw i64 %indvars.iv33.i, 1
  %49 = load i32, ptr %numCoders, align 8
  %50 = sext i32 %49 to i64
  %cmp7.i = icmp slt i64 %indvars.iv.next34.i, %50
  br i1 %cmp7.i, label %for.body8.i, label %cleanup66

cleanup66:                                        ; preds = %if.end.i13.i, %sw.bb.i, %sw.epilog.i, %for.body39, %for.body8.i, %for.cond5.preheader.i
  %retval.5 = phi i32 [ 0, %for.cond5.preheader.i ], [ 0, %for.body8.i ], [ %call51, %for.body39 ], [ 4, %sw.epilog.i ], [ 2, %sw.bb.i ], [ 2, %if.end.i13.i ]
  ret i32 %retval.5
}
...
entry:
  ...
  store ptr %alloc, ptr %decoder, align 8
  ...
  store i32 0, ptr %numCoders.i, align 8
  ...
  store i64 0, ptr %numStreams, align 8
  ret i32 0
}
...
entry:
  %decoder = getelementptr inbounds %struct.CXzUnpacker, ptr %p, i64 0, i32 14
  %numCoders.i = getelementptr inbounds %struct.CXzUnpacker, ptr %p, i64 0, i32 14, i32 2
  %0 = load i32, ptr %numCoders.i, align 8
...
for.bodythread-pre-split.i:                       ; preds = %if.end.i
  %.pr.i = load ptr, ptr %decoder, align 8
  br label %for.body.i
...
if.then.i:                                        ; preds = %land.lhs.true.i
  ...
  tail call void %6(ptr noundef nonnull %5, ptr noundef nonnull %3) #11
  %.pre.i = load i32, ptr %numCoders.i, align 8
  br label %if.end.i
...
if.then7.i:                                       ; preds = %for.end.i
  ...
  %11 = load ptr, ptr %Free9.i, align 8
  tail call void %11(ptr noundef %10, ptr noundef nonnull %9) #11
  br label %MixCoder_Free.exit
...
entry:
  ...
  %add.ptr.i669 = getelementptr inbounds %struct.CXzUnpacker, ptr %p, i64 0, i32 19, i64 4
...
if.then:                                          ; preds = %for.cond
  ...
  %sub1 = sub i64 %0, %4
  store i64 %sub1, ptr %destLen2, align 8
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %srcLen2) #11
  store i64 %sub, ptr %srcLen2, align 8
...
if.end:                                           ; preds = %if.then
  ...
  %6 = load i64, ptr %srcLen2, align 8
  %7 = load i64, ptr %srcLen, align 8
  %add = add i64 %7, %6
  store i64 %add, ptr %srcLen, align 8
  %add.ptr = getelementptr inbounds i8, ptr %src.addr.0, i64 %6
  %8 = load i64, ptr %packSize191, align 8
  %add6 = add i64 %8, %6
  store i64 %add6, ptr %packSize191, align 8
  %9 = load i64, ptr %destLen, align 8
  %add7 = add i64 %9, %5
  store i64 %add7, ptr %destLen, align 8
  %add.ptr8 = getelementptr inbounds i8, ptr %dest.addr.0, i64 %5
  %10 = load i64, ptr %unpackSize173, align 8
  %add9 = add i64 %10, %5
  store i64 %add9, ptr %unpackSize173, align 8
  %cmp10.not = icmp eq i32 %call, 0
  br i1 %cmp10.not, label %cleanup.cont, label %cleanup434.thread702
...
if.then14:                                        ; preds = %cleanup.cont
  ...
  %12 = load i32, ptr %blockHeaderSize134, align 4
  %conv = zext i32 %12 to i64
  %add16 = add i64 %add6, %conv
  %13 = load i16, ptr %streamFlags403, align 8
  ...
  %14 = load i64, ptr %unpackSize173, align 8
  ...
  %15 = load <2 x i64>, ptr %numBlocks108, align 8
  %16 = insertelement <2 x i64> <i64 1, i64 poison>, i64 %conv27, i64 1
  %17 = add <2 x i64> %15, %16
  store <2 x i64> %17, ptr %numBlocks108, align 8
  store i32 7, ptr %p, align 8
  store i32 0, ptr %pos426, align 4
  store i32 0, ptr %alignPos192, align 8
...
if.else:                                          ; preds = %cleanup.cont
  ...
  br i1 %or.cond447, label %cleanup434.thread702, label %cleanup434
...
for.cond.backedge:                                ; preds = %if.end46, %cleanup.cont80, %if.end62, %if.then137, %cleanup.cont170, %if.end126, %if.then198, %if.then284, %if.else329, %if.then306, %if.then265, %if.else363, %if.then355, %if.else428, %if.end425, %cleanup255.thread, %cleanup255.thread679, %sw.bb375, %Xz_CheckFooter.exit, %cleanup434
  %src.addr.0.be = phi ptr [ %add.ptr, %cleanup434 ], [ %add.ptr396, %Xz_CheckFooter.exit ], [ %add.ptr396, %sw.bb375 ], [ %src.addr.0, %cleanup255.thread679 ], [ %add.ptr234, %cleanup255.thread ], [ %src.addr.0, %if.end425 ], [ %incdec.ptr430, %if.else428 ], [ %incdec.ptr357, %if.then355 ], [ %src.addr.0, %if.else363 ], [ %incdec.ptr267, %if.then265 ], [ %incdec.ptr307, %if.then306 ], [ %src.addr.0, %if.else329 ], [ %add.ptr298, %if.then284 ], [ %incdec.ptr202, %if.then198 ], [ %incdec.ptr92, %if.end126 ], [ %src.addr.0, %cleanup.cont170 ], [ %add.ptr158, %if.then137 ], [ %incdec.ptr, %if.end62 ], [ %src.addr.0, %cleanup.cont80 ], [ %src.addr.0, %if.end46 ]
  %dest.addr.0.be = phi ptr [ %add.ptr8, %cleanup434 ], [ %dest.addr.0, %Xz_CheckFooter.exit ], [ %dest.addr.0, %sw.bb375 ], [ %dest.addr.0, %cleanup255.thread679 ], [ %dest.addr.0, %cleanup255.thread ], [ %dest.addr.0, %if.end425 ], [ %dest.addr.0, %if.else428 ], [ %dest.addr.0, %if.then355 ], [ %dest.addr.0, %if.else363 ], [ %dest.addr.0, %if.then265 ], [ %dest.addr.0, %if.then306 ], [ %dest.addr.0, %if.else329 ], [ %dest.addr.0, %if.then284 ], [ %dest.addr.0, %if.then198 ], [ %dest.addr.0, %if.end126 ], [ %dest.addr.0, %cleanup.cont170 ], [ %dest.addr.0, %if.then137 ], [ %dest.addr.0, %if.end62 ], [ %dest.addr.0, %cleanup.cont80 ], [ %dest.addr.0, %if.end46 ]
  br label %for.cond

sw.bb:                                            ; preds = %if.end46
  %19 = load i32, ptr %pos426, align 4
  %cmp49 = icmp ult i32 %19, 12
  br i1 %cmp49, label %if.then51, label %if.else68

if.then51:                                        ; preds = %sw.bb
  %cmp53 = icmp ult i32 %19, 6
  %.pre692 = load i8, ptr %src.addr.0, align 1
...
land.lhs.true55:                                  ; preds = %if.then51
  ...
  %cmp59.not = icmp eq i8 %.pre692, %20
...
if.end62:                                         ; preds = %if.then51, %land.lhs.true55
  ...
  store i32 %inc64, ptr %pos426, align 4
  %arrayidx66 = getelementptr inbounds %struct.CXzUnpacker, ptr %p, i64 0, i32 19, i64 %idxprom
  store i8 %.pre692, ptr %arrayidx66, align 1
  %21 = load i64, ptr %srcLen, align 8
  %inc67 = add i64 %21, 1
  store i64 %inc67, ptr %srcLen, align 8
...
if.else68:                                        ; preds = %sw.bb
  ...
  %conv4.i = zext i8 %23 to i16
  %or.i = or i16 %shl.i, %conv4.i
  store i16 %or.i, ptr %streamFlags403, align 2
  %call.i = call i32 @CrcCalc(ptr noundef nonnull %add.ptr.i, i64 noundef 2) #11
  %24 = load i32, ptr %add.ptr6.i, align 4
  %cmp.not.i = icmp eq i32 %call.i, %24
  br i1 %cmp.not.i, label %if.end.i, label %cleanup437

if.end.i:                                         ; preds = %if.else68
  %25 = load i16, ptr %streamFlags403, align 2
  %cmp11.i = icmp ult i16 %25, 16
...
sw.bb87:                                          ; preds = %if.end46
  %26 = load i32, ptr %pos426, align 4
...
if.then91:                                        ; preds = %sw.bb87
  ...
  %27 = load i8, ptr %src.addr.0, align 1
  store i32 1, ptr %pos426, align 4
  store i8 %27, ptr %buf385, align 1
  %28 = load i64, ptr %srcLen, align 8
  %inc98 = add i64 %28, 1
  store i64 %inc98, ptr %srcLen, align 8
  %29 = load i8, ptr %buf385, align 8
  %cmp102 = icmp eq i8 %29, 0
  br i1 %cmp102, label %if.then104, label %if.end126

if.then104:                                       ; preds = %if.then91
  %30 = load i64, ptr %numBlocks108, align 8
  %call109 = call i32 @Xz_WriteVarInt(ptr noundef nonnull %add.ptr107, i64 noundef %30) #11
  %add110 = add i32 %call109, 1
  store i32 %add110, ptr %indexPreSize262, align 4
  %conv112 = zext i32 %add110 to i64
  store i64 %conv112, ptr %indexPos280, align 8
  %31 = load i64, ptr %indexSize404, align 8
  %add116 = add i64 %31, %conv112
  store i64 %add116, ptr %indexSize404, align 8
  call void @Sha256_Final(ptr noundef nonnull %sha335, ptr noundef nonnull %shaDigest338) #11
  call void @Sha256_Init(ptr noundef nonnull %sha335) #11
  %32 = load i32, ptr %indexPreSize262, align 4
  %conv123 = zext i32 %32 to i64
  %call124 = call i32 @CrcUpdate(i32 noundef -1, ptr noundef nonnull %buf385, i64 noundef %conv123) #11
  store i32 %call124, ptr %crc366, align 8
  store i32 1, ptr %p, align 8
  %.pre = load i8, ptr %buf385, align 8
  br label %if.end126

if.end126:                                        ; preds = %if.then104, %if.then91
  %33 = phi i8 [ %.pre, %if.then104 ], [ %29, %if.then91 ]
  %conv129 = zext i8 %33 to i32
  %shl = shl nuw nsw i32 %conv129, 2
  %add130 = add nuw nsw i32 %shl, 4
  store i32 %add130, ptr %blockHeaderSize134, align 4
  br label %for.cond.backedge

if.else132:                                       ; preds = %sw.bb87
  %34 = load i32, ptr %blockHeaderSize134, align 4
  %cmp135.not = icmp eq i32 %26, %34
  br i1 %cmp135.not, label %if.else159, label %if.then137

if.then137:                                       ; preds = %if.else132
  %sub140 = sub i32 %34, %26
  ...
  %35 = load i32, ptr %pos426, align 4
  %add154 = add i32 %35, %spec.select
  store i32 %add154, ptr %pos426, align 4
  %36 = load i64, ptr %srcLen, align 8
  %add156 = add i64 %36, %conv152
  store i64 %add156, ptr %srcLen, align 8
  %add.ptr158 = getelementptr inbounds i8, ptr %src.addr.0, i64 %conv152
  br label %for.cond.backedge

if.else159:                                       ; preds = %if.else132
  %call163 = call i32 @XzBlock_Parse(ptr noundef nonnull %block, ptr noundef nonnull %buf385)
  %cmp164.not = icmp eq i32 %call163, 0
  br i1 %cmp164.not, label %cleanup.cont170, label %cleanup437

cleanup.cont170:                                  ; preds = %if.else159
  store i32 6, ptr %p, align 8
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %packSize191, i8 0, i64 16, i1 false)
  %37 = load i16, ptr %streamFlags403, align 8
  %38 = and i16 %37, 15
...
sw.bb190:                                         ; preds = %if.end46
  %39 = load i64, ptr %packSize191, align 8
  %40 = load i32, ptr %alignPos192, align 8
  %conv193 = zext i32 %40 to i64
  %add194 = add i64 %39, %conv193
...
if.then198:                                       ; preds = %sw.bb190
  %inc199 = add i64 %2, 1
  store i64 %inc199, ptr %srcLen, align 8
  %inc201 = add i32 %40, 1
  store i32 %inc201, ptr %alignPos192, align 8
  %incdec.ptr202 = getelementptr inbounds i8, ptr %src.addr.0, i64 1
  %41 = load i8, ptr %src.addr.0, align 1
  %cmp204.not = icmp eq i8 %41, 0
  br i1 %cmp204.not, label %for.cond.backedge, label %cleanup437

if.else208:                                       ; preds = %sw.bb190
  %42 = load i16, ptr %streamFlags403, align 8
  %call210 = call i32 @XzFlags_GetCheckSize(i16 noundef zeroext %42) #11
  %43 = load i32, ptr %pos426, align 4
  %cmp214.not = icmp eq i32 %call210, %43
  br i1 %cmp214.not, label %if.else235, label %cleanup255.thread

cleanup255.thread:                                ; preds = %if.else208
  %sub213 = sub i32 %call210, %43
  ...
  %44 = load i32, ptr %pos426, align 4
  %add230 = add i32 %44, %spec.select664
  store i32 %add230, ptr %pos426, align 4
  %45 = load i64, ptr %srcLen, align 8
  %add232 = add i64 %45, %conv228
  store i64 %add232, ptr %srcLen, align 8
...
if.else235:                                       ; preds = %if.else208
  ...
  br i1 %tobool.not, label %cleanup255.thread679, label %land.lhs.true241
...
land.lhs.true241:                                 ; preds = %if.else235
  ...
  br i1 %cmp247.not, label %cleanup255.thread679, label %cleanup255

cleanup255.thread679:                             ; preds = %if.else235, %land.lhs.true241
...
sw.bb260:                                         ; preds = %if.end46
  %46 = load i32, ptr %pos426, align 4
  %47 = load i32, ptr %indexPreSize262, align 4
  %cmp263 = icmp ult i32 %46, %47
  br i1 %cmp263, label %if.then265, label %if.else279

if.then265:                                       ; preds = %sw.bb260
  %inc266 = add i64 %2, 1
  store i64 %inc266, ptr %srcLen, align 8
  %incdec.ptr267 = getelementptr inbounds i8, ptr %src.addr.0, i64 1
  %48 = load i8, ptr %src.addr.0, align 1
  %inc271 = add nuw i32 %46, 1
  store i32 %inc271, ptr %pos426, align 4
  %idxprom272 = zext i32 %46 to i64
  %arrayidx273 = getelementptr inbounds %struct.CXzUnpacker, ptr %p, i64 0, i32 19, i64 %idxprom272
  %49 = load i8, ptr %arrayidx273, align 1
  %cmp275.not = icmp eq i8 %48, %49
  br i1 %cmp275.not, label %for.cond.backedge, label %cleanup437

if.else279:                                       ; preds = %sw.bb260
  %50 = load i64, ptr %indexPos280, align 8
  %51 = load i64, ptr %indexSize404, align 8
  %cmp282 = icmp ult i64 %50, %51
  br i1 %cmp282, label %if.then284, label %if.else301

if.then284:                                       ; preds = %if.else279
  %sub288 = sub i64 %51, %50
  %spec.select665 = call i64 @llvm.umin.i64(i64 %sub, i64 %sub288)
  %52 = load i32, ptr %crc366, align 8
  %call294 = call i32 @CrcUpdate(i32 noundef %52, ptr noundef %src.addr.0, i64 noundef %spec.select665) #11
  store i32 %call294, ptr %crc366, align 8
  call void @Sha256_Update(ptr noundef nonnull %sha335, ptr noundef %src.addr.0, i64 noundef %spec.select665) #11
  %53 = load i64, ptr %srcLen, align 8
  %add297 = add i64 %53, %spec.select665
  store i64 %add297, ptr %srcLen, align 8
  %add.ptr298 = getelementptr inbounds i8, ptr %src.addr.0, i64 %spec.select665
  %54 = load i64, ptr %indexPos280, align 8
  %add300 = add i64 %54, %spec.select665
  store i64 %add300, ptr %indexPos280, align 8
  br label %for.cond.backedge
...
if.then306:                                       ; preds = %if.else301
  ...
  %55 = load i8, ptr %src.addr.0, align 1
  %56 = load i32, ptr %crc366, align 8
  %conv309 = zext i8 %55 to i32
  %.masked = and i32 %56, 255
  ...
  %57 = load i32, ptr %arrayidx312, align 4
  %shr = lshr i32 %56, 8
  %xor314 = xor i32 %57, %shr
  store i32 %xor314, ptr %crc366, align 8
  %inc316 = add i64 %2, 1
  store i64 %inc316, ptr %srcLen, align 8
  %inc318 = add i64 %50, 1
  store i64 %inc318, ptr %indexPos280, align 8
  %inc320 = add i64 %51, 1
  store i64 %inc320, ptr %indexSize404, align 8
  %cmp322.not = icmp eq i8 %55, 0
...
if.else329:                                       ; preds = %if.else301
  ...
  %add333 = add i64 %51, 4
  store i64 %add333, ptr %indexSize404, align 8
  store i32 0, ptr %pos426, align 4
...
sw.bb351:                                         ; preds = %if.end46
  %58 = load i32, ptr %pos426, align 4
  %cmp353 = icmp ult i32 %58, 4
  br i1 %cmp353, label %if.then355, label %if.else363

if.then355:                                       ; preds = %sw.bb351
  %inc356 = add i64 %2, 1
  store i64 %inc356, ptr %srcLen, align 8
  %incdec.ptr357 = getelementptr inbounds i8, ptr %src.addr.0, i64 1
  %59 = load i8, ptr %src.addr.0, align 1
  %inc360 = add nuw nsw i32 %58, 1
  store i32 %inc360, ptr %pos426, align 4
  %idxprom361 = zext i32 %58 to i64
  %arrayidx362 = getelementptr inbounds %struct.CXzUnpacker, ptr %p, i64 0, i32 19, i64 %idxprom361
  store i8 %59, ptr %arrayidx362, align 1
  br label %for.cond.backedge

if.else363:                                       ; preds = %sw.bb351
  store i32 3, ptr %p, align 8
  store i32 0, ptr %pos426, align 4
  %60 = load i32, ptr %crc366, align 8
  %xor367 = xor i32 %60, -1
  %61 = load i32, ptr %buf385, align 8
  %cmp370.not = icmp eq i32 %61, %xor367
  br i1 %cmp370.not, label %for.cond.backedge, label %cleanup437

sw.bb375:                                         ; preds = %if.end46
  %62 = load i32, ptr %pos426, align 4
  %sub378 = sub i32 12, %62
  ...
  %63 = load i32, ptr %pos426, align 4
  %add392 = add i32 %spec.select667, %63
  store i32 %add392, ptr %pos426, align 4
  %64 = load i64, ptr %srcLen, align 8
  %add394 = add i64 %64, %conv390
  store i64 %add394, ptr %srcLen, align 8
...
if.then400:                                       ; preds = %sw.bb375
  ...
  %inc402 = add i64 %65, 1
  store i64 %inc402, ptr %numStreams, align 8
  store i64 0, ptr %padSize419, align 8
  %66 = load i16, ptr %streamFlags403, align 8
  %67 = load i64, ptr %indexSize404, align 8
  %68 = load i32, ptr %add.ptr.i669, align 4
  %conv.i = zext i32 %68 to i64
  %add.i = shl nuw nsw i64 %conv.i, 2
  %shl.i670 = add nuw nsw i64 %add.i, 4
  %cmp.i = icmp eq i64 %shl.i670, %67
  br i1 %cmp.i, label %land.rhs.i, label %cleanup437

land.rhs.i:                                       ; preds = %if.then400
  %69 = load i32, ptr %buf385, align 4
  %call.i671 = call i32 @CrcCalc(ptr noundef nonnull %add.ptr.i669, i64 noundef 6) #11
  %cmp3.i = icmp eq i32 %69, %call.i671
  br i1 %cmp3.i, label %land.lhs.true.i, label %cleanup437

land.lhs.true.i:                                  ; preds = %land.rhs.i
  %conv5.i = zext i16 %66 to i32
  %70 = load i8, ptr %add.ptr6.i, align 1
  %conv8.i = zext i8 %70 to i32
  %shl9.i = shl nuw nsw i32 %conv8.i, 8
  %71 = load i8, ptr %arrayidx11.i, align 1
  %conv12.i = zext i8 %71 to i32
  %or.i672 = or i32 %shl9.i, %conv12.i
  %cmp13.i = icmp eq i32 %or.i672, %conv5.i
...
sw.bb414:                                         ; preds = %if.end46
  %72 = load i8, ptr %src.addr.0, align 1
  %cmp416.not = icmp eq i8 %72, 0
  br i1 %cmp416.not, label %if.else428, label %if.then418

if.then418:                                       ; preds = %sw.bb414
  %73 = load i64, ptr %padSize419, align 8
  %and421662 = and i64 %73, 3
...
if.else428:                                       ; preds = %sw.bb414
  %inc429 = add i64 %2, 1
  store i64 %inc429, ptr %srcLen, align 8
  %incdec.ptr430 = getelementptr inbounds i8, ptr %src.addr.0, i64 1
  %74 = load i64, ptr %padSize419, align 8
  %inc432 = add i64 %74, 1
  store i64 %inc432, ptr %padSize419, align 8
  br label %for.cond.backedge

cleanup434.thread702:                             ; preds = %if.end, %if.else, %if.then5
...
cleanup437:                                       ; preds = %land.rhs.i, %land.lhs.true.i, %if.then400, %Xz_CheckFooter.exit, %if.else68, %if.end.i, %if.then418, %if.else363, %if.then265, %if.then198, %land.lhs.true55, %if.else159, %cleanup.cont170, %if.else329, %if.then306, %cleanup434.thread702, %cleanup255, %if.then45
  %retval.13691 = phi i32 [ 3, %cleanup255 ], [ 0, %if.then45 ], [ %retval.2.ph, %cleanup434.thread702 ], [ 3, %land.rhs.i ], [ 3, %land.lhs.true.i ], [ 3, %if.then400 ], [ 3, %Xz_CheckFooter.exit ], [ 4, %if.end.i ], [ 17, %if.else68 ], [ 3, %if.then306 ], [ 3, %if.else329 ], [ %call180, %cleanup.cont170 ], [ %call163, %if.else159 ], [ 17, %land.lhs.true55 ], [ 3, %if.then198 ], [ 3, %if.then265 ], [ 3, %if.else363 ], [ 17, %if.then418 ]
  ret i32 %retval.13691
}
...
land.rhs:                                         ; preds = %entry
  ...
  %1 = load i64, ptr %padSize, align 8
  %and4 = and i64 %1, 3
...
entry:
  ...
  store i32 %conv, ptr %wasFinished, align 4
