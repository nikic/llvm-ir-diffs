...
if.end15.i:                                       ; preds = %if.end.i13
  ...
  store ptr %call.i14, ptr %arrayidx, align 8, !tbaa !24
...
for.body.i189:                                    ; preds = %for.cond.i186
  ...
  %13 = load i8, ptr %arrayidx.i190, align 1, !tbaa !9
  %14 = and i8 %13, 127
  ...
  store i64 %or.i194, ptr %unpackSize, align 8, !tbaa !5
  %cmp7.i195 = icmp slt i8 %13, 0
  br i1 %cmp7.i195, label %for.cond.i186, label %cleanup18.split.loop.exit30.i196, !llvm.loop !10
...
for.body.i207:                                    ; preds = %for.cond.i204
  ...
  %22 = load i8, ptr %arrayidx.i208, align 1, !tbaa !9
  %23 = and i8 %22, 127
  ...
  store i64 %or.i212, ptr %filters, align 8, !tbaa !5
  %cmp7.i213 = icmp slt i8 %22, 0
  %indvars.iv.next290 = add i32 %indvars.iv289, 1
  br i1 %cmp7.i213, label %for.cond.i204, label %cleanup18.split.loop.exit30.i214, !llvm.loop !10
...
for.body.i225:                                    ; preds = %for.cond.i222
  ...
  %29 = load i8, ptr %arrayidx.i226, align 1, !tbaa !9
  %30 = and i8 %29, 127
  ...
  br i1 %cmp7.i231, label %for.cond.i222, label %cleanup18.split.loop.exit30.i232, !llvm.loop !10
...
for.body.i207.1:                                  ; preds = %for.cond.i204.1
  ...
  %37 = load i8, ptr %arrayidx.i208.1, align 1, !tbaa !9
  %38 = and i8 %37, 127
  ...
  store i64 %or.i212.1, ptr %add.ptr60.1, align 8, !tbaa !5
  %cmp7.i213.1 = icmp slt i8 %37, 0
  %indvars.iv.next290.1 = add i32 %indvars.iv289.1, 1
  br i1 %cmp7.i213.1, label %for.cond.i204.1, label %cleanup18.split.loop.exit30.i214.1, !llvm.loop !10
...
for.body.i225.1:                                  ; preds = %for.cond.i222.1
  ...
  %44 = load i8, ptr %arrayidx.i226.1, align 1, !tbaa !9
  %45 = and i8 %44, 127
  ...
  br i1 %cmp7.i231.1, label %for.cond.i222.1, label %cleanup18.split.loop.exit30.i232.1, !llvm.loop !10
...
for.body.i207.2:                                  ; preds = %for.cond.i204.2
  ...
  %52 = load i8, ptr %arrayidx.i208.2, align 1, !tbaa !9
  %53 = and i8 %52, 127
  ...
  store i64 %or.i212.2, ptr %add.ptr60.2, align 8, !tbaa !5
  %cmp7.i213.2 = icmp slt i8 %52, 0
  %indvars.iv.next290.2 = add i32 %indvars.iv289.2, 1
  br i1 %cmp7.i213.2, label %for.cond.i204.2, label %cleanup18.split.loop.exit30.i214.2, !llvm.loop !10
...
for.body.i225.2:                                  ; preds = %for.cond.i222.2
  ...
  %59 = load i8, ptr %arrayidx.i226.2, align 1, !tbaa !9
  %60 = and i8 %59, 127
  ...
  br i1 %cmp7.i231.2, label %for.cond.i222.2, label %cleanup18.split.loop.exit30.i232.2, !llvm.loop !10
...
for.body.i207.3:                                  ; preds = %for.cond.i204.3
  ...
  %67 = load i8, ptr %arrayidx.i208.3, align 1, !tbaa !9
  %68 = and i8 %67, 127
  ...
  store i64 %or.i212.3, ptr %add.ptr60.3, align 8, !tbaa !5
  %cmp7.i213.3 = icmp slt i8 %67, 0
  %indvars.iv.next290.3 = add i32 %indvars.iv289.3, 1
  br i1 %cmp7.i213.3, label %for.cond.i204.3, label %cleanup18.split.loop.exit30.i214.3, !llvm.loop !10
...
for.body.i225.3:                                  ; preds = %for.cond.i222.3
  ...
  %74 = load i8, ptr %arrayidx.i226.3, align 1, !tbaa !9
  %75 = and i8 %74, 127
  ...
  br i1 %cmp7.i231.3, label %for.cond.i222.3, label %cleanup18.split.loop.exit30.i232.3, !llvm.loop !10
...
if.end15.i.i:                                     ; preds = %if.end.i13.i
  ...
  store ptr %call.i14.i, ptr %arrayidx.i110, align 8, !tbaa !24
...
for.body.i113:                                    ; preds = %for.body.i113.preheader, %for.body.i113
  ...
  br i1 %exitcond.not.i, label %for.cond5.preheader.i, label %for.body.i113, !llvm.loop !63
...
if.then51:                                        ; preds = %sw.bb
  ...
  %.pre690 = load i8, ptr %src.addr.0, align 1, !tbaa !9
...
land.lhs.true55:                                  ; preds = %if.then51
  ...
  %20 = load i8, ptr %arrayidx, align 1, !tbaa !9
  %cmp59.not = icmp eq i8 %.pre690, %20
...
if.end62:                                         ; preds = %if.then51, %land.lhs.true55
  ...
  store i8 %.pre690, ptr %arrayidx66, align 1, !tbaa !9
  %21 = load i64, ptr %srcLen, align 8, !tbaa !31
  %inc67 = add i64 %21, 1
  store i64 %inc67, ptr %srcLen, align 8, !tbaa !31
  br label %for.cond.backedge

if.else68:                                        ; preds = %sw.bb
  %22 = load i8, ptr %add.ptr.i, align 1, !tbaa !9
  %conv1.i = zext i8 %22 to i16
  %shl.i = shl nuw i16 %conv1.i, 8
  %23 = load i8, ptr %arrayidx3.i, align 1, !tbaa !9
...
sw.bb87:                                          ; preds = %if.end46
  %26 = load i32, ptr %pos426, align 4, !tbaa !68
...
if.then91:                                        ; preds = %sw.bb87
  ...
  %27 = load i8, ptr %src.addr.0, align 1, !tbaa !9
  store i32 1, ptr %pos426, align 4, !tbaa !68
  store i8 %27, ptr %buf385, align 1, !tbaa !9
  %28 = load i64, ptr %srcLen, align 8, !tbaa !31
  %inc98 = add i64 %28, 1
  store i64 %inc98, ptr %srcLen, align 8, !tbaa !31
  %29 = load i8, ptr %buf385, align 8, !tbaa !9
  %cmp102 = icmp eq i8 %29, 0
  br i1 %cmp102, label %if.then104, label %if.end126

if.then104:                                       ; preds = %if.then91
  %30 = load i64, ptr %numBlocks108, align 8, !tbaa !75
  ...
  %31 = load i64, ptr %indexSize404, align 8, !tbaa !78
  ...
  call void @Sha256_Init(ptr noundef nonnull %sha335) #11
  %32 = load i32, ptr %indexPreSize262, align 4, !tbaa !76
...
if.else132:                                       ; preds = %sw.bb87
  %34 = load i32, ptr %blockHeaderSize134, align 4, !tbaa !72
...
if.then137:                                       ; preds = %if.else132
  ...
  %35 = load i32, ptr %pos426, align 4, !tbaa !68
  %add154 = add i32 %35, %spec.select
  store i32 %add154, ptr %pos426, align 4, !tbaa !68
  %36 = load i64, ptr %srcLen, align 8, !tbaa !31
...
cleanup.cont170:                                  ; preds = %if.else159
  ...
  %37 = load i16, ptr %streamFlags403, align 8, !tbaa !73
  %38 = and i16 %37, 15
...
sw.bb190:                                         ; preds = %if.end46
  %39 = load i64, ptr %packSize191, align 8, !tbaa !70
  %40 = load i32, ptr %alignPos192, align 8, !tbaa !74
...
if.then216:                                       ; preds = %if.else208
  ...
  %45 = load i64, ptr %srcLen, align 8, !tbaa !31
...
sw.bb260:                                         ; preds = %if.end46
  %46 = load i32, ptr %pos426, align 4, !tbaa !68
  %47 = load i32, ptr %indexPreSize262, align 4, !tbaa !76
...
if.then265:                                       ; preds = %sw.bb260
  ...
  %48 = load i8, ptr %src.addr.0, align 1, !tbaa !9
  ...
  %49 = load i8, ptr %arrayidx273, align 1, !tbaa !9
  %cmp275.not = icmp eq i8 %48, %49
  br i1 %cmp275.not, label %for.cond.backedge, label %cleanup437

if.else279:                                       ; preds = %sw.bb260
  %50 = load i64, ptr %indexPos280, align 8, !tbaa !77
  %51 = load i64, ptr %indexSize404, align 8, !tbaa !78
...
if.then284:                                       ; preds = %if.else279
  ...
  %52 = load i32, ptr %crc366, align 8, !tbaa !79
  ...
  %53 = load i64, ptr %srcLen, align 8, !tbaa !31
  ...
  %54 = load i64, ptr %indexPos280, align 8, !tbaa !77
...
if.then306:                                       ; preds = %if.else301
  ...
  %55 = load i8, ptr %src.addr.0, align 1, !tbaa !9
  %56 = load i32, ptr %crc366, align 8, !tbaa !79
  ...
  %57 = load i32, ptr %arrayidx312, align 4, !tbaa !22
  %shr = lshr i32 %56, 8
...
sw.bb351:                                         ; preds = %if.end46
  %58 = load i32, ptr %pos426, align 4, !tbaa !68
...
if.then355:                                       ; preds = %sw.bb351
  ...
  %59 = load i8, ptr %src.addr.0, align 1, !tbaa !9
  ...
  store i8 %59, ptr %arrayidx362, align 1, !tbaa !9
  br label %for.cond.backedge

if.else363:                                       ; preds = %sw.bb351
  store i32 3, ptr %p, align 8, !tbaa !64
  store i32 0, ptr %pos426, align 4, !tbaa !68
  %60 = load i32, ptr %crc366, align 8, !tbaa !79
  %61 = load i32, ptr %buf385, align 8, !tbaa !22
  %62 = xor i32 %61, %60
  %cmp370.not = icmp eq i32 %62, -1
