...
entry:
  %call = tail call i32 @CrcUpdateT4(i32 noundef %v, ptr noundef %data, i64 noundef %size, ptr noundef nonnull @g_CrcTable) #3
  ret i32 %call
}
...
entry:
  %call = tail call i32 @CrcUpdateT4(i32 noundef -1, ptr noundef %data, i64 noundef %size, ptr noundef nonnull @g_CrcTable) #3
  %xor = xor i32 %call, -1
  ret i32 %xor
}
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  store <4 x i32> %34, ptr %35, align 16
  %index.next = add nuw i64 %index, 4
  %vec.ind.next = add <4 x i32> %vec.ind, <i32 4, i32 4, i32 4, i32 4>
  %36 = icmp eq i64 %index.next, 256
  br i1 %36, label %for.body10, label %vector.body
...
for.body10:                                       ; preds = %vector.body, %for.body10
  ...
  %38 = load i32, ptr %arrayidx14, align 8
  ...
  store i32 %xor19, ptr %arrayidx21, align 8
  ...
  %41 = load i32, ptr %arrayidx14.1, align 4
  ...
  %42 = load i32, ptr %arrayidx17.1, align 4
