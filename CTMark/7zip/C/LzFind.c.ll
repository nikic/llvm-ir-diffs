...
entry:
  ...
  %0 = load i32, ptr %streamPos, align 8
...
entry:
  ...
  %0 = load ptr, ptr %bufferBase, align 8
  %1 = load ptr, ptr %p, align 8
  %keepSizeBefore = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 16
  %2 = load i32, ptr %keepSizeBefore, align 8
  %idx.ext = zext i32 %2 to i64
  %idx.neg = sub nsw i64 0, %idx.ext
  %add.ptr = getelementptr inbounds i8, ptr %1, i64 %idx.neg
  %streamPos = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 3
  %3 = load i32, ptr %streamPos, align 8
  %pos = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 1
  ...
  %5 = load ptr, ptr %bufferBase, align 8
  %6 = load i32, ptr %keepSizeBefore, align 8
...
entry:
  ...
  %0 = load i32, ptr %directInput, align 4
  %tobool.not = icmp eq i32 %0, 0
  br i1 %tobool.not, label %if.end, label %return

if.end:                                           ; preds = %entry
  %bufferBase = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 12
  %1 = load ptr, ptr %bufferBase, align 8
  ...
  %4 = load i32, ptr %keepSizeAfter, align 4
...
entry:
  ...
  %0 = load i32, ptr %streamEndWasReached, align 8
  %tobool.not = icmp eq i32 %0, 0
  br i1 %tobool.not, label %if.end, label %if.end2

if.end:                                           ; preds = %entry
  %keepSizeAfter = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 17
  %1 = load i32, ptr %keepSizeAfter, align 4
  %streamPos = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 3
  %2 = load i32, ptr %streamPos, align 8
  %pos = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 1
...
if.end.i:                                         ; preds = %lor.lhs.false.i
  ...
  %5 = load i32, ptr %directInput.i, align 4
...
if.then2.i:                                       ; preds = %if.end.i
  ...
  %6 = load i64, ptr %directInputRem.i, align 8
...
for.cond.i:                                       ; preds = %cleanup.i, %for.cond.preheader.i
  ...
  %10 = load ptr, ptr %bufferBase.i, align 8
  %11 = load i32, ptr %blockSize.i, align 4
  ...
  store i64 %sub.ptr.sub.i, ptr %size.i, align 8
...
cleanup.i:                                        ; preds = %if.end34.i
  ...
  %15 = load i32, ptr %streamPos, align 8
  %add42.i = add i32 %15, %conv40.i
  store i32 %add42.i, ptr %streamPos, align 8
  %16 = load i32, ptr %pos, align 8
  %sub45.i = sub i32 %add42.i, %16
  %17 = load i32, ptr %keepSizeAfter, align 4
...
entry:
  %bufferBase = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 12
  store ptr null, ptr %bufferBase, align 8
  %directInput = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 19
  store i32 0, ptr %directInput, align 4
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  store <4 x i32> %34, ptr %35, align 4
  %index.next = add nuw i64 %index, 4
  %vec.ind.next = add <4 x i32> %vec.ind, <i32 4, i32 4, i32 4, i32 4>
  %36 = icmp eq i64 %index.next, 256
  br i1 %36, label %for.end7, label %vector.body
...
if.then.i:                                        ; preds = %entry
  ...
  %bufferBase.i = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 12
  %4 = load ptr, ptr %bufferBase.i, align 8
  tail call void %3(ptr noundef nonnull %alloc, ptr noundef %4) #11
  store ptr null, ptr %bufferBase.i, align 8
...
if.then:                                          ; preds = %entry
  ...
  %1 = load ptr, ptr %hash.i.i, align 8
  tail call void %0(ptr noundef %alloc, ptr noundef %1) #11
  store ptr null, ptr %hash.i.i, align 8
  %directInput.i.i = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 19
  %2 = load i32, ptr %directInput.i.i, align 4
...
if.then.i.i:                                      ; preds = %if.then
  ...
  %4 = load ptr, ptr %bufferBase.i.i, align 8
  tail call void %3(ptr noundef nonnull %alloc, ptr noundef %4) #11
  store ptr null, ptr %bufferBase.i.i, align 8
  br label %cleanup81
...
if.end:                                           ; preds = %entry
  ...
  %keepSizeBefore = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 16
  store i32 %add9, ptr %keepSizeBefore, align 8
  %keepSizeAfter = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 17
  store i32 %add, ptr %keepSizeAfter, align 4
...
if.then.i:                                        ; preds = %if.end
  ...
  store i32 %add1.i, ptr %blockSize2.i, align 4
  br label %if.then11

if.end.i:                                         ; preds = %if.end
  %bufferBase.i = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 12
  %6 = load ptr, ptr %bufferBase.i, align 8
...
lor.lhs.false.i:                                  ; preds = %if.end.i
  ...
  %7 = load i32, ptr %blockSize3.i, align 4
...
LzInWindow_Create.exit:                           ; preds = %if.end.i, %lor.lhs.false.i
  ...
  %8 = load ptr, ptr %Free.i.i153, align 8
  ...
  store i32 %add1.i, ptr %blockSize6.i, align 4
  ...
  store ptr %call.i, ptr %bufferBase.i, align 8
...
LzInWindow_Create.exit.if.end80_crit_edge:        ; preds = %LzInWindow_Create.exit
  ...
  %.pre = load ptr, ptr %hash.i.i157.phi.trans.insert, align 8
  br label %if.end80
...
if.end34.thread:                                  ; preds = %if.then11
  ...
  store i32 65535, ptr %hashMask167, align 8
  br label %if.end52
...
if.then71:                                        ; preds = %if.end66
  ...
  store ptr %add.ptr, ptr %son, align 8
  br label %cleanup81
...
if.end80:                                         ; preds = %LzInWindow_Create.exit.if.end80_crit_edge, %if.end66
  ...
  %22 = load ptr, ptr %Free.i.i156, align 8
  ...
  store ptr null, ptr %hash.i.i157, align 8
  %23 = load i32, ptr %directInput.i, align 4
...
entry:
  %size.i = alloca i64, align 8
  %hashSizeSum = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 25
  %0 = load i32, ptr %hashSizeSum, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %2 = load i32, ptr %hashSizeSum, align 8
  %3 = zext i32 %2 to i64
  %cmp = icmp ult i64 %indvars.iv.next, %3
  br i1 %cmp, label %for.body, label %if.end.i

if.end.i:                                         ; preds = %for.body, %entry
  %cyclicBufferPos = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 5
  store i32 0, ptr %cyclicBufferPos, align 8
  %bufferBase = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 12
  %4 = load ptr, ptr %bufferBase, align 8
  store ptr %4, ptr %p, align 8
  %cyclicBufferSize = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 6
  %5 = load i32, ptr %cyclicBufferSize, align 4
  %streamPos = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 3
  store i32 %5, ptr %streamPos, align 8
  %pos = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 1
  store i32 %5, ptr %pos, align 8
  %result = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 27
  store i32 0, ptr %result, align 8
  %streamEndWasReached = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 14
  store i32 0, ptr %streamEndWasReached, align 8
  %directInput.i = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 19
  %6 = load i32, ptr %directInput.i, align 4
...
if.then2.i:                                       ; preds = %if.end.i
  ...
  %conv.i = zext i32 %sub.i to i64
  %directInputRem.i = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 20
  %7 = load i64, ptr %directInputRem.i, align 8
...
for.cond.i:                                       ; preds = %cleanup.i, %for.cond.preheader.i
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %size.i) #11
  %11 = load ptr, ptr %bufferBase, align 8
  %12 = load i32, ptr %blockSize.i, align 4
...
if.end27.i:                                       ; preds = %for.cond.i
  ...
  store i32 %call.i, ptr %result, align 8
  %cmp31.not.i = icmp eq i32 %call.i, 0
  br i1 %cmp31.not.i, label %if.end34.i, label %cleanup.thread.i
...
cleanup.thread.i:                                 ; preds = %if.end27.i, %for.cond.i, %if.then37.i
  ...
  %.pre22 = load i32, ptr %streamPos, align 8
  br label %MatchFinder_ReadBlock.exit
...
cleanup.i:                                        ; preds = %if.end34.i
  ...
  %18 = load i32, ptr %keepSizeAfter.i, align 4
...
MatchFinder_ReadBlock.exit:                       ; preds = %cleanup.i, %if.then2.i, %if.then16.i, %cleanup.thread.i
  ...
  %21 = load i32, ptr %cyclicBufferSize, align 4
  %22 = load i32, ptr %cyclicBufferPos, align 8
  ...
  %23 = load i32, ptr %keepSizeAfter.i17, align 4
  ...
  %24 = load i32, ptr %matchMaxLen.i, align 8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load14 = load <4 x i32>, ptr %1, align 4
...
if.then:                                          ; preds = %cleanup75, %entry
  ...
  store i32 0, ptr %ptr1.0.lcssa, align 4
  br label %cleanup78
...
while.body:                                       ; preds = %while.cond
  ...
  br i1 %cmp44.not, label %while.cond, label %if.end48
...
if.then70:                                        ; preds = %if.end61
  store i32 %curMatch.addr.0160, ptr %ptr1.0157, align 4
  %add.ptr71 = getelementptr inbounds i32, ptr %add.ptr10, i64 1
  br label %cleanup75

if.else:                                          ; preds = %if.end61
  store i32 %curMatch.addr.0160, ptr %ptr0.0156, align 4
  br label %cleanup75
...
cleanup75:                                        ; preds = %if.then70, %if.else
  ...
  %curMatch.addr.1 = load i32, ptr %curMatch.addr.1.in, align 4
...
cleanup78:                                        ; preds = %if.then, %if.then56
  ...
  store i32 %storemerge, ptr %ptr0.0147, align 4
  ret ptr %retval.2.ph
}
...
entry:
  ...
  %0 = load i32, ptr %lenLimit1, align 4
  %cmp = icmp ult i32 %0, 3
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %cyclicBufferPos.i = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 5
  %1 = load i32, ptr %cyclicBufferPos.i, align 8
  %inc.i = add i32 %1, 1
  store i32 %inc.i, ptr %cyclicBufferPos.i, align 8
  ...
  %inc1.i = add i32 %3, 1
  store i32 %inc1.i, ptr %pos.i, align 8
  %posLimit.i = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 2
  %4 = load i32, ptr %posLimit.i, align 4
...
if.end:                                           ; preds = %entry
  ...
  %son = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 9
  %14 = load ptr, ptr %son, align 8
  %cyclicBufferPos = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 5
  %15 = load i32, ptr %cyclicBufferPos, align 8
  %cyclicBufferSize = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 6
  %16 = load i32, ptr %cyclicBufferSize, align 4
  %cutValue = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 11
  %17 = load i32, ptr %cutValue, align 4
  %shl.i = shl i32 %15, 1
...
while.body.i:                                     ; preds = %while.cond.i
  ...
  %23 = load i8, ptr %arrayidx42.i, align 1
  %cmp44.not.i = icmp eq i8 %22, %23
  br i1 %cmp44.not.i, label %while.cond.i, label %if.end48.i
...
if.then70.i:                                      ; preds = %if.end61.i
  store i32 %curMatch.addr.0160.i, ptr %ptr1.0157.i, align 4
  %add.ptr71.i = getelementptr inbounds i32, ptr %add.ptr10.i, i64 1
  br label %cleanup75.i

if.else.i:                                        ; preds = %if.end61.i
  store i32 %curMatch.addr.0160.i, ptr %ptr0.0156.i, align 4
  br label %cleanup75.i
...
cleanup75.i:                                      ; preds = %if.else.i, %if.then70.i
  ...
  %curMatch.addr.1.i = load i32, ptr %curMatch.addr.1.in.i, align 4
...
GetMatchesSpec1.exit:                             ; preds = %if.then.i49, %if.then56.i
  ...
  store i32 %storemerge.i, ptr %ptr0.0147.i, align 4
  ...
  %29 = load i32, ptr %cyclicBufferPos, align 8
  %inc = add i32 %29, 1
  store i32 %inc, ptr %cyclicBufferPos, align 8
  store ptr %arrayidx4, ptr %p, align 8
  %30 = load i32, ptr %pos, align 8
  %inc17 = add i32 %30, 1
  store i32 %inc17, ptr %pos, align 8
  %posLimit = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 2
  %31 = load i32, ptr %posLimit, align 4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load23 = load <4 x i32>, ptr %6, align 4
...
for.body.i.i:                                     ; preds = %for.body.i.i.preheader, %for.body.i.i
  ...
  store i32 %value.0.i.i, ptr %arrayidx.i.i, align 4
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1
  %exitcond.not.i.i = icmp eq i64 %indvars.iv.next.i.i, %wide.trip.count.i.i
  br i1 %exitcond.not.i.i, label %MatchFinder_Normalize3.exit.loopexit.i, label %for.body.i.i

MatchFinder_Normalize3.exit.loopexit.i:           ; preds = %for.body.i.i, %middle.block
  %.pre.i = load i32, ptr %pos, align 8
...
MatchFinder_Normalize.exit:                       ; preds = %if.then, %MatchFinder_Normalize3.exit.loopexit.i
  ...
  store i32 %sub1.i7.i, ptr %pos, align 8
  %12 = load <2 x i32>, ptr %posLimit.i.i, align 4
...
if.then3:                                         ; preds = %land.lhs.true
  %directInput.i.i = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 19
  %20 = load i32, ptr %directInput.i.i, align 4
...
if.end.i:                                         ; preds = %MatchFinder_NeedMove.exit.i
  ...
  %24 = load i32, ptr %keepSizeBefore.i.i, align 8
  ...
  %25 = load ptr, ptr %bufferBase.i.i, align 8
  %26 = load i32, ptr %keepSizeBefore.i.i, align 8
  %idx.ext4.i.i = zext i32 %26 to i64
  %add.ptr5.i.i = getelementptr inbounds i8, ptr %25, i64 %idx.ext4.i.i
  store ptr %add.ptr5.i.i, ptr %p, align 8
  %.pre = load i32, ptr %streamEndWasReached, align 8
...
for.cond.preheader.i.i:                           ; preds = %if.end.i8.i
  ...
  %.pre.i.i = load i32, ptr %streamPos, align 8
  %.pre80.i.i = load i32, ptr %pos, align 8
  br label %for.cond.i.i

if.then2.i.i:                                     ; preds = %if.end.i8.i
  %30 = load i32, ptr %streamPos, align 8
  ...
  %31 = load i64, ptr %directInputRem.i.i, align 8
  ...
  store i64 %sub11.i.i, ptr %directInputRem.i.i, align 8
  %add.i12.i = add i32 %spec.select.i.i, %30
  store i32 %add.i12.i, ptr %streamPos, align 8
...
for.cond.i.i:                                     ; preds = %cleanup.i.i, %for.cond.preheader.i.i
  ...
  %35 = load ptr, ptr %bufferBase.i14.i, align 8
  %36 = load i32, ptr %blockSize.i15.i, align 4
  ...
  store i64 %sub.ptr.sub.i21.i, ptr %size.i.i, align 8
...
cleanup.i.i:                                      ; preds = %if.end34.i.i
  ...
  %40 = load i32, ptr %streamPos, align 8
  %add42.i.i = add i32 %40, %conv40.i.i
  store i32 %add42.i.i, ptr %streamPos, align 8
  %41 = load i32, ptr %pos, align 8
  %sub45.i.i = sub i32 %add42.i.i, %41
  %42 = load i32, ptr %keepSizeAfter, align 4
...
if.end4:                                          ; preds = %cleanup.i.i, %cleanup.thread.i.i, %if.then16.i.i, %if.then2.i.i, %lor.lhs.false.i.i, %if.end.i, %land.lhs.true, %if.end
  %cyclicBufferPos = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 5
  %43 = load i32, ptr %cyclicBufferPos, align 8
  %cyclicBufferSize = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 6
  %44 = load i32, ptr %cyclicBufferSize, align 4
...
if.end8:                                          ; preds = %if.then6, %if.end4
  ...
  %47 = load i32, ptr %streamPos.i, align 8
  %sub3.i = sub i32 %47, %46
  %keepSizeAfter.i = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 17
  %48 = load i32, ptr %keepSizeAfter.i, align 4
...
if.end:                                           ; preds = %entry
  ...
  %sub95.i = sub i32 %13, %11
  %cmp97.i = icmp ne i32 %17, 0
  %cmp1.not98.i = icmp ult i32 %sub95.i, %16
  %or.cond99.i = and i1 %cmp1.not98.i, %cmp97.i
  br i1 %or.cond99.i, label %if.end.preheader.i, label %Hc_GetMatchesSpec.exit
...
if.end.i:                                         ; preds = %cleanup44.i, %if.end.preheader.i
  %dec104.in.i = phi i32 [ %dec104.i, %cleanup44.i ], [ %17, %if.end.preheader.i ]
  %sub103.i = phi i32 [ %sub.i, %cleanup44.i ], [ %sub95.i, %if.end.preheader.i ]
  %maxLen.addr.0101.i = phi i32 [ %maxLen.addr.5.i, %cleanup44.i ], [ 2, %if.end.preheader.i ]
  %distances.addr.0100.i = phi ptr [ %distances.addr.5.i, %cleanup44.i ], [ %distances, %if.end.preheader.i ]
  %dec104.i = add i32 %dec104.in.i, -1
  %idx.ext.i = zext i32 %sub103.i to i64
  %idx.neg.i = sub nsw i64 0, %idx.ext.i
  %add.ptr.i = getelementptr inbounds i8, ptr %5, i64 %idx.neg.i
  %sub2.i = sub i32 %15, %sub103.i
  %cmp3.i = icmp ugt i32 %sub103.i, %15
  ...
  %idxprom6.i = zext i32 %maxLen.addr.0101.i to i64
...
while.body.i:                                     ; preds = %while.cond.i
  ...
  %24 = load i8, ptr %arrayidx21.i, align 1
  ...
  br i1 %cmp26.not.i, label %while.cond.i, label %while.end.split.loop.exit.i

while.end.split.loop.exit.i:                      ; preds = %while.body.i
  %indvars.le110.i = trunc i64 %indvars.iv.next.i to i32
  br label %while.end.i

while.end.i:                                      ; preds = %while.cond.i, %while.end.split.loop.exit.i
  %inc.lcssa.i = phi i32 [ %indvars.le110.i, %while.end.split.loop.exit.i ], [ %0, %while.cond.i ]
  %cmp30.i = icmp ult i32 %maxLen.addr.0101.i, %inc.lcssa.i
  br i1 %cmp30.i, label %cleanup.i, label %cleanup44.i

cleanup.i:                                        ; preds = %while.end.i
  %cmp18.not.not.le.i = icmp eq i32 %inc.lcssa.i, %0
  %incdec.ptr.i49 = getelementptr inbounds i32, ptr %distances.addr.0100.i, i64 1
  store i32 %inc.lcssa.i, ptr %distances.addr.0100.i, align 4
  %sub33.i = add i32 %sub103.i, -1
  %incdec.ptr34.i = getelementptr inbounds i32, ptr %distances.addr.0100.i, i64 2
  store i32 %sub33.i, ptr %incdec.ptr.i49, align 4
  br i1 %cmp18.not.not.le.i, label %Hc_GetMatchesSpec.exit, label %cleanup44.i

cleanup44.i:                                      ; preds = %cleanup.i, %while.end.i, %land.lhs.true.i, %if.end.i
  %distances.addr.5.i = phi ptr [ %distances.addr.0100.i, %land.lhs.true.i ], [ %distances.addr.0100.i, %if.end.i ], [ %distances.addr.0100.i, %while.end.i ], [ %incdec.ptr34.i, %cleanup.i ]
  %maxLen.addr.5.i = phi i32 [ %maxLen.addr.0101.i, %land.lhs.true.i ], [ %maxLen.addr.0101.i, %if.end.i ], [ %maxLen.addr.0101.i, %while.end.i ], [ %inc.lcssa.i, %cleanup.i ]
  %sub.i = sub i32 %13, %19
  %cmp.i48 = icmp ne i32 %dec104.i, 0
...
Hc_GetMatchesSpec.exit:                           ; preds = %cleanup.i, %cleanup44.i, %if.end
  %retval.4.ph.i = phi ptr [ %distances, %if.end ], [ %incdec.ptr34.i, %cleanup.i ], [ %distances.addr.5.i, %cleanup44.i ]
  %sub.ptr.lhs.cast = ptrtoint ptr %retval.4.ph.i to i64
  %sub.ptr.rhs.cast = ptrtoint ptr %distances to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  %26 = lshr exact i64 %sub.ptr.sub, 2
  %conv13 = trunc i64 %26 to i32
  %27 = load i32, ptr %cyclicBufferPos, align 8
  %inc = add i32 %27, 1
  store i32 %inc, ptr %cyclicBufferPos, align 8
  store ptr %arrayidx4, ptr %p, align 8
  ...
  store i32 %inc17, ptr %pos, align 8
  %posLimit = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 2
  %29 = load i32, ptr %posLimit, align 4
...
if.then:                                          ; preds = %do.body
  %1 = load i32, ptr %cyclicBufferPos, align 8
  %inc.i = add i32 %1, 1
  store i32 %inc.i, ptr %cyclicBufferPos, align 8
  %2 = load ptr, ptr %p, align 8
  %incdec.ptr.i = getelementptr inbounds i8, ptr %2, i64 1
  store ptr %incdec.ptr.i, ptr %p, align 8
  %3 = load i32, ptr %pos, align 8
  %inc1.i = add i32 %3, 1
  store i32 %inc1.i, ptr %pos, align 8
  %4 = load i32, ptr %posLimit, align 4
  %cmp.i = icmp eq i32 %inc1.i, %4
  br i1 %cmp.i, label %cleanup.sink.split, label %cleanup
...
if.then51.i:                                      ; preds = %if.end42.i
  store i32 %curMatch.addr.0123.i, ptr %ptr1.0119.i, align 4
  %add.ptr52.i = getelementptr inbounds i32, ptr %add.ptr10.i, i64 1
  br label %cleanup56.i

if.else.i:                                        ; preds = %if.end42.i
  store i32 %curMatch.addr.0123.i, ptr %ptr0.0122.i, align 4
  br label %cleanup56.i
...
SkipMatchesSpec.exit:                             ; preds = %if.then.i47, %if.then38.i
  ...
  store i32 %storemerge.i, ptr %ptr0.0112.i, align 4
  %26 = load i32, ptr %cyclicBufferPos, align 8
  %inc = add i32 %26, 1
  store i32 %inc, ptr %cyclicBufferPos, align 8
  store ptr %arrayidx4, ptr %p, align 8
  %27 = load i32, ptr %pos, align 8
  %inc16 = add i32 %27, 1
  store i32 %inc16, ptr %pos, align 8
  %28 = load i32, ptr %posLimit, align 4
...
if.end:                                           ; preds = %do.body
  ...
  %12 = load i32, ptr %pos, align 8
  store i32 %12, ptr %arrayidx7, align 4
  %13 = load ptr, ptr %son, align 8
  %14 = load i32, ptr %cyclicBufferPos, align 8
  ...
  %inc16 = add i32 %16, 1
  store i32 %inc16, ptr %pos, align 8
  %17 = load i32, ptr %posLimit, align 4
...
entry:
  store ptr @MatchFinder_Init, ptr %vTable, align 8
  %GetIndexByte = getelementptr inbounds %struct._IMatchFinder, ptr %vTable, i64 0, i32 1
  store ptr @MatchFinder_GetIndexByte, ptr %GetIndexByte, align 8
  %GetNumAvailableBytes = getelementptr inbounds %struct._IMatchFinder, ptr %vTable, i64 0, i32 2
  store ptr @MatchFinder_GetNumAvailableBytes, ptr %GetNumAvailableBytes, align 8
  %GetPointerToCurrentPos = getelementptr inbounds %struct._IMatchFinder, ptr %vTable, i64 0, i32 3
  store ptr @MatchFinder_GetPointerToCurrentPos, ptr %GetPointerToCurrentPos, align 8
  %btMode = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 21
  %0 = load i32, ptr %btMode, align 8
  %tobool.not = icmp eq i32 %0, 0
  br i1 %tobool.not, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  %GetMatches = getelementptr inbounds %struct._IMatchFinder, ptr %vTable, i64 0, i32 4
  store ptr @Hc4_MatchFinder_GetMatches, ptr %GetMatches, align 8
  %Skip = getelementptr inbounds %struct._IMatchFinder, ptr %vTable, i64 0, i32 5
  store ptr @Hc4_MatchFinder_Skip, ptr %Skip, align 8
  br label %if.end14

if.else:                                          ; preds = %entry
  %numHashBytes = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 18
  %1 = load i32, ptr %numHashBytes, align 8
...
if.then1:                                         ; preds = %if.else
  store ptr @Bt2_MatchFinder_GetMatches, ptr %GetMatches11, align 8
  store ptr @Bt2_MatchFinder_Skip, ptr %Skip12, align 8
  br label %if.end14

if.then7:                                         ; preds = %if.else
  store ptr @Bt3_MatchFinder_GetMatches, ptr %GetMatches11, align 8
  store ptr @Bt3_MatchFinder_Skip, ptr %Skip12, align 8
  br label %if.end14

if.else10:                                        ; preds = %if.else
  store ptr @Bt4_MatchFinder_GetMatches, ptr %GetMatches11, align 8
  store ptr @Bt4_MatchFinder_Skip, ptr %Skip12, align 8
  br label %if.end14
...
if.end:                                           ; preds = %entry
  ...
  %hashMask = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 10
  %12 = load i32, ptr %hashMask, align 8
  ...
  store i32 %13, ptr %arrayidx29, align 4
  store i32 %13, ptr %arrayidx24, align 4
  store i32 %13, ptr %arrayidx20, align 4
  %cyclicBufferSize = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 6
  %18 = load i32, ptr %cyclicBufferSize, align 4
...
if.then48:                                        ; preds = %land.lhs.true
  store i32 2, ptr %distances, align 4
  %sub50 = add i32 %sub, -1
  %arrayidx51 = getelementptr inbounds i32, ptr %distances, i64 1
  store i32 %sub50, ptr %arrayidx51, align 4
  br label %if.end52
...
land.lhs.true59:                                  ; preds = %land.lhs.true55
  ...
  %22 = load i8, ptr %add.ptr62, align 1
  %23 = load i8, ptr %5, align 1
...
for.body.lr.ph:                                   ; preds = %if.end73, %if.end73.thread
  %delta2.0239 = phi i32 [ %sub25, %if.end73.thread ], [ %sub, %if.end73 ]
  %maxLen.1238 = phi i32 [ 3, %if.end73.thread ], [ %maxLen.0, %if.end73 ]
  %offset.1236 = phi i32 [ %add72, %if.end73.thread ], [ %offset.0, %if.end73 ]
  %conv80 = zext i32 %delta2.0239 to i64
  br label %for.body

for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %maxLen.2229 = phi i32 [ %maxLen.1238, %for.body.lr.ph ], [ %inc, %for.inc ]
  %conv79 = zext i32 %maxLen.2229 to i64
...
if.end109:                                        ; preds = %for.end, %if.end73
  %offset.1237 = phi i64 [ %26, %for.end ], [ 0, %if.end73 ]
  %maxLen.3 = phi i32 [ %maxLen.2229, %for.end ], [ %maxLen.0, %if.end73 ]
  %32 = load i32, ptr %pos, align 8
  %son116 = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 9
  %33 = load ptr, ptr %son116, align 8
  %cyclicBufferPos117 = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 5
  %34 = load i32, ptr %cyclicBufferPos117, align 8
  %35 = load i32, ptr %cyclicBufferSize, align 4
  %cutValue = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 11
  %36 = load i32, ptr %cutValue, align 4
  %add.ptr120 = getelementptr inbounds i32, ptr %distances, i64 %offset.1237
  ...
  %sub95.i = sub i32 %32, %17
  %cmp97.i = icmp ne i32 %36, 0
  %cmp1.not98.i = icmp ult i32 %sub95.i, %35
  %or.cond99.i = and i1 %cmp1.not98.i, %cmp97.i
  br i1 %or.cond99.i, label %if.end.preheader.i, label %Hc_GetMatchesSpec.exit
...
if.end.i:                                         ; preds = %cleanup44.i, %if.end.preheader.i
  %dec104.in.i = phi i32 [ %dec104.i, %cleanup44.i ], [ %36, %if.end.preheader.i ]
  %sub103.i = phi i32 [ %sub.i, %cleanup44.i ], [ %sub95.i, %if.end.preheader.i ]
  %maxLen.addr.0101.i = phi i32 [ %maxLen.addr.5.i, %cleanup44.i ], [ %spec.store.select, %if.end.preheader.i ]
  %distances.addr.0100.i = phi ptr [ %distances.addr.5.i, %cleanup44.i ], [ %add.ptr120, %if.end.preheader.i ]
  %dec104.i = add i32 %dec104.in.i, -1
  %idx.ext.i = zext i32 %sub103.i to i64
  %idx.neg.i = sub nsw i64 0, %idx.ext.i
  %add.ptr.i = getelementptr inbounds i8, ptr %5, i64 %idx.neg.i
  %sub2.i = sub i32 %34, %sub103.i
  %cmp3.i = icmp ugt i32 %sub103.i, %34
...
land.lhs.true.i:                                  ; preds = %if.end.i
  %41 = load i8, ptr %add.ptr.i, align 1
...
while.body.i:                                     ; preds = %while.cond.i
  ...
  %idxprom20.i = and i64 %indvars.iv.next.i, 4294967295
  %arrayidx21.i = getelementptr inbounds i8, ptr %add.ptr.i, i64 %idxprom20.i
  %43 = load i8, ptr %arrayidx21.i, align 1
  %arrayidx24.i = getelementptr inbounds i8, ptr %5, i64 %idxprom20.i
...
cleanup.i:                                        ; preds = %while.end.i
  %cmp18.not.not.le.i = icmp eq i32 %inc.lcssa.i, %0
  %incdec.ptr.i222 = getelementptr inbounds i32, ptr %distances.addr.0100.i, i64 1
  store i32 %inc.lcssa.i, ptr %distances.addr.0100.i, align 4
  %sub33.i = add i32 %sub103.i, -1
  %incdec.ptr34.i = getelementptr inbounds i32, ptr %distances.addr.0100.i, i64 2
  store i32 %sub33.i, ptr %incdec.ptr.i222, align 4
  br i1 %cmp18.not.not.le.i, label %Hc_GetMatchesSpec.exit, label %cleanup44.i
...
cleanup44.i:                                      ; preds = %cleanup.i, %while.end.i, %land.lhs.true.i, %if.end.i
  ...
  %maxLen.addr.5.i = phi i32 [ %maxLen.addr.0101.i, %land.lhs.true.i ], [ %maxLen.addr.0101.i, %if.end.i ], [ %maxLen.addr.0101.i, %while.end.i ], [ %inc.lcssa.i, %cleanup.i ]
  %sub.i = sub i32 %32, %38
  %cmp.i221 = icmp ne i32 %dec104.i, 0
  %cmp1.not.i = icmp ult i32 %sub.i, %35
  %or.cond.i = select i1 %cmp.i221, i1 %cmp1.not.i, i1 false
  br i1 %or.cond.i, label %if.end.i, label %Hc_GetMatchesSpec.exit

Hc_GetMatchesSpec.exit:                           ; preds = %cleanup.i, %cleanup44.i, %if.end109
  %retval.4.ph.i = phi ptr [ %add.ptr120, %if.end109 ], [ %incdec.ptr34.i, %cleanup.i ], [ %distances.addr.5.i, %cleanup44.i ]
  %sub.ptr.lhs.cast = ptrtoint ptr %retval.4.ph.i to i64
  %sub.ptr.rhs.cast = ptrtoint ptr %distances to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  %45 = lshr exact i64 %sub.ptr.sub, 2
  %conv121 = trunc i64 %45 to i32
  %46 = load i32, ptr %cyclicBufferPos117, align 8
  %inc123 = add i32 %46, 1
  store i32 %inc123, ptr %cyclicBufferPos117, align 8
  store ptr %arrayidx3, ptr %p, align 8
  %47 = load i32, ptr %pos, align 8
  %inc127 = add i32 %47, 1
  store i32 %inc127, ptr %pos, align 8
  %posLimit128 = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 2
  %48 = load i32, ptr %posLimit128, align 4
...
cleanup.sink.split:                               ; preds = %Hc_GetMatchesSpec.exit, %if.then96, %if.then
  %retval.0.ph = phi i32 [ 0, %if.then ], [ %offset.1236, %if.then96 ], [ %conv121, %Hc_GetMatchesSpec.exit ]
  tail call fastcc void @MatchFinder_CheckLimits(ptr noundef nonnull %p)
  br label %cleanup

cleanup:                                          ; preds = %cleanup.sink.split, %if.then, %Hc_GetMatchesSpec.exit, %if.then96
  %retval.0 = phi i32 [ %offset.1236, %if.then96 ], [ %conv121, %Hc_GetMatchesSpec.exit ], [ 0, %if.then ], [ %retval.0.ph, %cleanup.sink.split ]
  ret i32 %retval.0
}
...
if.end:                                           ; preds = %do.body
  ...
  %16 = load ptr, ptr %son, align 8
  %17 = load i32, ptr %cyclicBufferPos, align 8
  ...
  %18 = load i32, ptr %cyclicBufferPos, align 8
  %inc = add i32 %18, 1
  store i32 %inc, ptr %cyclicBufferPos, align 8
  store ptr %arrayidx3, ptr %p, align 8
  %19 = load i32, ptr %pos, align 8
  %inc37 = add i32 %19, 1
  store i32 %inc37, ptr %pos, align 8
  %20 = load i32, ptr %posLimit, align 4
...
cleanup:                                          ; preds = %cleanup.sink.split, %if.then, %if.end
  ...
  br i1 %cmp47.not, label %do.end, label %do.body
...
if.end:                                           ; preds = %entry
  ...
  %cyclicBufferPos = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 5
  %13 = load i32, ptr %cyclicBufferPos, align 8
  %cyclicBufferSize = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 6
  %14 = load i32, ptr %cyclicBufferSize, align 4
  %cutValue = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 11
  %15 = load i32, ptr %cutValue, align 4
  %shl.i = shl i32 %13, 1
  %idx.ext.i = zext i32 %shl.i to i64
...
if.then51.i:                                      ; preds = %if.end48.i
  ...
  %sub52.i = add i32 %sub161.i, -1
  %incdec.ptr53.i = getelementptr inbounds i32, ptr %distances.addr.0154.i, i64 2
  store i32 %sub52.i, ptr %incdec.ptr.i47, align 4
  %cmp54.i = icmp eq i32 %len.1.i, %0
  br i1 %cmp54.i, label %if.then56.i, label %if.end61.i

if.then56.i:                                      ; preds = %if.then51.i
  %22 = load i32, ptr %add.ptr10.i, align 4
  store i32 %22, ptr %ptr1.0157.i, align 4
  %arrayidx58.i = getelementptr inbounds i32, ptr %add.ptr10.i, i64 1
  %23 = load i32, ptr %arrayidx58.i, align 4
  br label %GetMatchesSpec1.exit
...
GetMatchesSpec1.exit:                             ; preds = %if.then.i44, %if.then56.i
  ...
  %28 = load i32, ptr %pos, align 8
  %inc14 = add i32 %28, 1
  store i32 %inc14, ptr %pos, align 8
  %posLimit = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 2
  %29 = load i32, ptr %posLimit, align 4
...
if.then38.i:                                      ; preds = %while.cond.i
  %20 = load i32, ptr %add.ptr10.i, align 4
  store i32 %20, ptr %ptr1.0119.i, align 4
  %arrayidx40.i = getelementptr inbounds i32, ptr %add.ptr10.i, i64 1
...
SkipMatchesSpec.exit:                             ; preds = %if.then.i42, %if.then38.i
  ...
  store i32 %storemerge.i, ptr %ptr0.0112.i, align 4
  %24 = load i32, ptr %cyclicBufferPos, align 8
  %inc = add i32 %24, 1
  store i32 %inc, ptr %cyclicBufferPos, align 8
  store ptr %arrayidx2, ptr %p, align 8
  %25 = load i32, ptr %pos, align 8
  %inc13 = add i32 %25, 1
  store i32 %inc13, ptr %pos, align 8
  %26 = load i32, ptr %posLimit, align 4
...
if.end:                                           ; preds = %entry
  ...
  %xor6 = xor i32 %shl, %xor
  %hashMask = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 10
  %10 = load i32, ptr %hashMask, align 8
  ...
  %cyclicBufferSize = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 6
  %15 = load i32, ptr %cyclicBufferSize, align 4
...
for.inc:                                          ; preds = %for.body
  ...
  br i1 %cmp28.not, label %if.then47, label %for.body

for.end:                                          ; preds = %for.body
  store i32 %maxLen.0212, ptr %distances, align 4
  %sub43 = add i32 %sub, -1
  %arrayidx44 = getelementptr inbounds i32, ptr %distances, i64 1
  store i32 %sub43, ptr %arrayidx44, align 4
  %.pre = load i32, ptr %cyclicBufferSize, align 4
  br label %if.end61

if.then47:                                        ; preds = %for.inc
  store i32 %0, ptr %distances, align 4
  %sub43200 = add i32 %sub, -1
  %arrayidx44201 = getelementptr inbounds i32, ptr %distances, i64 1
  store i32 %sub43200, ptr %arrayidx44201, align 4
  %20 = load i32, ptr %pos, align 8
  %son = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 9
  %21 = load ptr, ptr %son, align 8
  %cyclicBufferPos = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 5
  %22 = load i32, ptr %cyclicBufferPos, align 8
  %23 = load i32, ptr %cyclicBufferSize, align 4
  %cutValue = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 11
  %24 = load i32, ptr %cutValue, align 4
  %shl.i = shl i32 %22, 1
  %idx.ext.i = zext i32 %shl.i to i64
...
while.body.i:                                     ; preds = %while.cond.i
  ...
  %arrayidx30.i = getelementptr inbounds i8, ptr %5, i64 %idxprom26.i
  %28 = load i8, ptr %arrayidx30.i, align 1
  %cmp32.not.i = icmp eq i8 %27, %28
  br i1 %cmp32.not.i, label %while.cond.i, label %if.end42.i

if.then38.i:                                      ; preds = %while.cond.i
  %29 = load i32, ptr %add.ptr10.i, align 4
  store i32 %29, ptr %ptr1.0119.i, align 4
  %arrayidx40.i = getelementptr inbounds i32, ptr %add.ptr10.i, i64 1
  %30 = load i32, ptr %arrayidx40.i, align 4
  br label %SkipMatchesSpec.exit
...
SkipMatchesSpec.exit:                             ; preds = %if.then.i150, %if.then38.i
  ...
  store i32 %storemerge.i, ptr %ptr0.0112.i, align 4
  %33 = load i32, ptr %cyclicBufferPos, align 8
  %inc52 = add i32 %33, 1
  store i32 %inc52, ptr %cyclicBufferPos, align 8
  store ptr %arrayidx3, ptr %p, align 8
  %34 = load i32, ptr %pos, align 8
  %inc55 = add i32 %34, 1
  store i32 %inc55, ptr %pos, align 8
  %posLimit = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 2
  %35 = load i32, ptr %posLimit, align 4
...
if.then.i157:                                     ; preds = %cleanup75.i, %if.end61
  ...
  store i32 0, ptr %ptr1.0.lcssa.i159, align 4
  br label %GetMatchesSpec1.exit
...
if.end.i161:                                      ; preds = %if.end61, %cleanup75.i
  ...
  %41 = load i8, ptr %arrayidx.i174, align 1
  %arrayidx19.i175 = getelementptr inbounds i8, ptr %5, i64 %idxprom.i173
  %42 = load i8, ptr %arrayidx19.i175, align 1
...
land.lhs.true.i:                                  ; preds = %if.then23.i
  ...
  %43 = load i8, ptr %arrayidx27.i191, align 1
  %arrayidx30.i192 = getelementptr inbounds i8, ptr %5, i64 %idxprom26.i190
  %44 = load i8, ptr %arrayidx30.i192, align 1
...
while.body.i199:                                  ; preds = %while.cond.i197
  ...
  %arrayidx42.i = getelementptr inbounds i8, ptr %5, i64 %idxprom38.i
  %46 = load i8, ptr %arrayidx42.i, align 1
  %cmp44.not.i = icmp eq i8 %45, %46
  br i1 %cmp44.not.i, label %while.cond.i197, label %if.end48.i
...
if.then51.i195:                                   ; preds = %if.end48.i
  ...
  store i32 %len.1.i193, ptr %distances.addr.0154.i, align 4
  %sub52.i = add i32 %sub161.i, -1
  %incdec.ptr53.i = getelementptr inbounds i32, ptr %distances.addr.0154.i, i64 2
  store i32 %sub52.i, ptr %incdec.ptr.i196, align 4
  %cmp54.i = icmp eq i32 %len.1.i193, %0
  br i1 %cmp54.i, label %if.then56.i, label %if.end61.i

if.then56.i:                                      ; preds = %if.then51.i195
  %47 = load i32, ptr %add.ptr10.i168, align 4
  store i32 %47, ptr %ptr1.0157.i, align 4
  %arrayidx58.i = getelementptr inbounds i32, ptr %add.ptr10.i168, i64 1
  %48 = load i32, ptr %arrayidx58.i, align 4
  br label %GetMatchesSpec1.exit
...
if.end61.i:                                       ; preds = %if.then51.i195, %if.end48.i, %if.end.i161
  ...
  %49 = load i8, ptr %arrayidx63.i, align 1
  %arrayidx66.i = getelementptr inbounds i8, ptr %5, i64 %idxprom62.i
...
cleanup75.i:                                      ; preds = %if.else.i177, %if.then70.i
  ...
  %curMatch.addr.1.i183 = load i32, ptr %curMatch.addr.1.in.i182, align 4
...
GetMatchesSpec1.exit:                             ; preds = %if.then.i157, %if.then56.i
  ...
  store i32 %storemerge.i160, ptr %ptr0.0147.i, align 4
  %sub.ptr.lhs.cast = ptrtoint ptr %retval.2.ph.i to i64
  %sub.ptr.rhs.cast = ptrtoint ptr %distances to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  %51 = lshr exact i64 %sub.ptr.sub, 2
  %conv70 = trunc i64 %51 to i32
  %52 = load i32, ptr %cyclicBufferPos65, align 8
  %inc72 = add i32 %52, 1
  store i32 %inc72, ptr %cyclicBufferPos65, align 8
  store ptr %arrayidx3, ptr %p, align 8
  %53 = load i32, ptr %pos, align 8
  %inc76 = add i32 %53, 1
  store i32 %inc76, ptr %pos, align 8
  %posLimit77 = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 2
  %54 = load i32, ptr %posLimit77, align 4
...
if.end:                                           ; preds = %do.body
  ...
  %16 = load i32, ptr %cyclicBufferPos, align 8
  %17 = load i32, ptr %cyclicBufferSize, align 4
  %18 = load i32, ptr %cutValue, align 4
  %shl.i = shl i32 %16, 1
  %idx.ext.i = zext i32 %shl.i to i64
...
while.body.i:                                     ; preds = %while.cond.i
  ...
  %arrayidx27.i = getelementptr inbounds i8, ptr %add.ptr12.i, i64 %idxprom26.i
  %21 = load i8, ptr %arrayidx27.i, align 1
  %arrayidx30.i = getelementptr inbounds i8, ptr %5, i64 %idxprom26.i
...
if.then38.i:                                      ; preds = %while.cond.i
  %23 = load i32, ptr %add.ptr10.i, align 4
  store i32 %23, ptr %ptr1.0119.i, align 4
  %arrayidx40.i = getelementptr inbounds i32, ptr %add.ptr10.i, i64 1
  %24 = load i32, ptr %arrayidx40.i, align 4
  br label %SkipMatchesSpec.exit
...
SkipMatchesSpec.exit:                             ; preds = %if.then.i57, %if.then38.i
  ...
  %28 = load i32, ptr %pos, align 8
  %inc22 = add i32 %28, 1
  store i32 %inc22, ptr %pos, align 8
  %29 = load i32, ptr %posLimit, align 4
...
cleanup:                                          ; preds = %cleanup.sink.split, %if.then, %SkipMatchesSpec.exit
  ...
  br i1 %cmp31.not, label %do.end, label %do.body
...
for.end:                                          ; preds = %for.body
  ...
  %idxprom92 = zext i32 %sub91 to i64
  %arrayidx93 = getelementptr inbounds i32, ptr %distances, i64 %idxprom92
  store i32 %maxLen.2291, ptr %arrayidx93, align 4
...
if.then96:                                        ; preds = %for.inc
  ...
  store i32 %0, ptr %arrayidx93280, align 4
  %27 = load i32, ptr %pos, align 8
  %son = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 9
  %28 = load ptr, ptr %son, align 8
  %cyclicBufferPos = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 5
  %29 = load i32, ptr %cyclicBufferPos, align 8
  %30 = load i32, ptr %cyclicBufferSize, align 4
  %cutValue = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 11
  %31 = load i32, ptr %cutValue, align 4
  %shl.i = shl i32 %29, 1
  %idx.ext.i = zext i32 %shl.i to i64
...
while.body.i:                                     ; preds = %while.cond.i
  ...
  %arrayidx27.i = getelementptr inbounds i8, ptr %add.ptr12.i, i64 %idxprom26.i
  %34 = load i8, ptr %arrayidx27.i, align 1
  %arrayidx30.i = getelementptr inbounds i8, ptr %5, i64 %idxprom26.i
...
if.then38.i:                                      ; preds = %while.cond.i
  ...
  store i32 %36, ptr %ptr1.0119.i, align 4
  %arrayidx40.i = getelementptr inbounds i32, ptr %add.ptr10.i, i64 1
...
SkipMatchesSpec.exit:                             ; preds = %if.then.i228, %if.then38.i
  ...
  store i32 %storemerge.i, ptr %ptr0.0112.i, align 4
  %40 = load i32, ptr %cyclicBufferPos, align 8
  %inc101 = add i32 %40, 1
  store i32 %inc101, ptr %cyclicBufferPos, align 8
  store ptr %arrayidx3, ptr %p, align 8
  %41 = load i32, ptr %pos, align 8
  %inc104 = add i32 %41, 1
  store i32 %inc104, ptr %pos, align 8
  %posLimit = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 2
  %42 = load i32, ptr %posLimit, align 4
...
if.then.i235:                                     ; preds = %cleanup75.i, %if.end110
  ...
  store i32 0, ptr %ptr1.0.lcssa.i237, align 4
  br label %GetMatchesSpec1.exit
...
if.end.i239:                                      ; preds = %if.end.i239.preheader, %cleanup75.i
  ...
  %48 = load i8, ptr %arrayidx.i252, align 1
  %arrayidx19.i253 = getelementptr inbounds i8, ptr %5, i64 %idxprom.i251
  %49 = load i8, ptr %arrayidx19.i253, align 1
...
land.lhs.true.i:                                  ; preds = %if.then23.i
  ...
  %50 = load i8, ptr %arrayidx27.i269, align 1
  %arrayidx30.i270 = getelementptr inbounds i8, ptr %5, i64 %idxprom26.i268
  %51 = load i8, ptr %arrayidx30.i270, align 1
...
while.body.i277:                                  ; preds = %while.cond.i275
  ...
  %52 = load i8, ptr %arrayidx39.i, align 1
  %arrayidx42.i = getelementptr inbounds i8, ptr %5, i64 %idxprom38.i
  %53 = load i8, ptr %arrayidx42.i, align 1
  %cmp44.not.i = icmp eq i8 %52, %53
  br i1 %cmp44.not.i, label %while.cond.i275, label %if.end48.i
...
if.then51.i273:                                   ; preds = %if.end48.i
  ...
  store i32 %len.1.i271, ptr %distances.addr.0154.i, align 4
  %sub52.i = add i32 %sub161.i, -1
  %incdec.ptr53.i = getelementptr inbounds i32, ptr %distances.addr.0154.i, i64 2
  store i32 %sub52.i, ptr %incdec.ptr.i274, align 4
  %cmp54.i = icmp eq i32 %len.1.i271, %0
  br i1 %cmp54.i, label %if.then56.i, label %if.end61.i

if.then56.i:                                      ; preds = %if.then51.i273
  %54 = load i32, ptr %add.ptr10.i246, align 4
  store i32 %54, ptr %ptr1.0157.i, align 4
...
if.end61.i:                                       ; preds = %if.then51.i273, %if.end48.i, %if.end.i239
  ...
  %56 = load i8, ptr %arrayidx63.i, align 1
  %arrayidx66.i = getelementptr inbounds i8, ptr %5, i64 %idxprom62.i
  %57 = load i8, ptr %arrayidx66.i, align 1
...
cleanup75.i:                                      ; preds = %if.else.i255, %if.then70.i
  ...
  %curMatch.addr.1.i261 = load i32, ptr %curMatch.addr.1.in.i260, align 4
...
GetMatchesSpec1.exit:                             ; preds = %if.then.i235, %if.then56.i
  ...
  store i32 %storemerge.i238, ptr %ptr0.0147.i, align 4
  %sub.ptr.lhs.cast = ptrtoint ptr %retval.2.ph.i to i64
  %sub.ptr.rhs.cast = ptrtoint ptr %distances to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  %58 = lshr exact i64 %sub.ptr.sub, 2
  %conv123 = trunc i64 %58 to i32
  %59 = load i32, ptr %cyclicBufferPos118, align 8
  %inc125 = add i32 %59, 1
  store i32 %inc125, ptr %cyclicBufferPos118, align 8
  store ptr %arrayidx3, ptr %p, align 8
  %60 = load i32, ptr %pos, align 8
  %inc129 = add i32 %60, 1
  store i32 %inc129, ptr %pos, align 8
  %posLimit130 = getelementptr inbounds %struct._CMatchFinder, ptr %p, i64 0, i32 2
  %61 = load i32, ptr %posLimit130, align 4
...
if.end:                                           ; preds = %do.body
  ...
  %17 = load i32, ptr %pos, align 8
  %18 = load ptr, ptr %son, align 8
  %19 = load i32, ptr %cyclicBufferPos, align 8
  %20 = load i32, ptr %cyclicBufferSize, align 4
  %21 = load i32, ptr %cutValue, align 4
  %shl.i = shl i32 %19, 1
  %idx.ext.i = zext i32 %shl.i to i64
...
while.body.i:                                     ; preds = %while.cond.i
  ...
  %arrayidx27.i = getelementptr inbounds i8, ptr %add.ptr12.i, i64 %idxprom26.i
  %24 = load i8, ptr %arrayidx27.i, align 1
  %arrayidx30.i = getelementptr inbounds i8, ptr %5, i64 %idxprom26.i
...
if.then38.i:                                      ; preds = %while.cond.i
  %26 = load i32, ptr %add.ptr10.i, align 4
  store i32 %26, ptr %ptr1.0119.i, align 4
  %arrayidx40.i = getelementptr inbounds i32, ptr %add.ptr10.i, i64 1
  %27 = load i32, ptr %arrayidx40.i, align 4
  br label %SkipMatchesSpec.exit
...
SkipMatchesSpec.exit:                             ; preds = %if.then.i80, %if.then38.i
  ...
  store i32 %storemerge.i, ptr %ptr0.0112.i, align 4
  %30 = load i32, ptr %cyclicBufferPos, align 8
  %inc = add i32 %30, 1
  store i32 %inc, ptr %cyclicBufferPos, align 8
  store ptr %arrayidx3, ptr %p, align 8
  %31 = load i32, ptr %pos, align 8
  %inc38 = add i32 %31, 1
  store i32 %inc38, ptr %pos, align 8
  %32 = load i32, ptr %posLimit, align 4
...
cleanup:                                          ; preds = %cleanup.sink.split, %if.then, %SkipMatchesSpec.exit
  ...
  br i1 %cmp48.not, label %do.end, label %do.body
