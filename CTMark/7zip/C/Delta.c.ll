; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/Delta.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/Delta.c"
...
entry:
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(256) %state, i8 0, i64 256, i1 false)
  ret void
}
...
MyMemCpy.exit:                                    ; preds = %entry
  %cmp67.not = icmp eq i64 %size, 0
  br i1 %cmp67.not, label %for.end12, label %for.cond1.preheader

MyMemCpy.exit.thread:                             ; preds = %entry
  %wide.trip.count.i = zext i32 %delta to i64
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 %buf, ptr align 1 %state, i64 %wide.trip.count.i, i1 false)
  %cmp67.not71 = icmp eq i64 %size, 0
  br i1 %cmp67.not71, label %for.end12, label %for.cond1.preheader.us.preheader
...
for.cond1.preheader.us:                           ; preds = %for.cond1.preheader.us.preheader, %for.cond1.for.cond.loopexit_crit_edge.us
  %i.068.us = phi i64 [ %inc.us.lcssa, %for.cond1.for.cond.loopexit_crit_edge.us ], [ 0, %for.cond1.preheader.us.preheader ]
  %2 = add i64 %i.068.us, 1
  %umax = tail call i64 @llvm.umax.i64(i64 %size, i64 %2)
  %3 = xor i64 %i.068.us, -1
  %4 = add i64 %umax, %3
  %5 = freeze i64 %4
...
vector.ph:                                        ; preds = %for.cond1.preheader.us
  %n.vec = and i64 %6, -16
  %ind.end = add i64 %i.068.us, %n.vec
  %7 = add i64 %i.068.us, 15
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %8 = phi i64 [ %7, %vector.ph ], [ %12, %vector.body ]
  %offset.idx = add i64 %i.068.us, %index
  %9 = getelementptr inbounds i8, ptr %data, i64 %offset.idx
  %wide.load = load <16 x i8>, ptr %9, align 1
  %10 = getelementptr inbounds [256 x i8], ptr %buf, i64 0, i64 %index
  %wide.load73 = load <16 x i8>, ptr %10, align 16
  %11 = sub <16 x i8> %wide.load, %wide.load73
  store <16 x i8> %11, ptr %9, align 1
  store <16 x i8> %wide.load, ptr %10, align 16
...
for.body4.us.preheader:                           ; preds = %for.cond1.preheader.us, %middle.block
  ...
  %i.164.us.ph = phi i64 [ %i.068.us, %for.cond1.preheader.us ], [ %ind.end, %middle.block ]
...
for.body4.us:                                     ; preds = %for.body4.us.preheader, %for.body4.us
  ...
  %arrayidx.us = getelementptr inbounds i8, ptr %data, i64 %i.164.us
  %16 = load i8, ptr %arrayidx.us, align 1
  %arrayidx5.us = getelementptr inbounds [256 x i8], ptr %buf, i64 0, i64 %indvars.iv
  %17 = load i8, ptr %arrayidx5.us, align 1
  %sub.us = sub i8 %16, %17
  store i8 %sub.us, ptr %arrayidx.us, align 1
  store i8 %16, ptr %arrayidx5.us, align 1
  ...
  br i1 %18, label %for.body4.us, label %for.cond1.for.cond.loopexit_crit_edge.us
...
for.cond1.for.cond.loopexit_crit_edge.us:         ; preds = %for.body4.us, %middle.block
  ...
  br i1 %cmp3.us.lcssa, label %for.cond1.preheader.us, label %for.end12.loopexit
...
for.end12:                                        ; preds = %MyMemCpy.exit.thread, %for.end12.loopexit, %MyMemCpy.exit
  ...
  br i1 %cmp6.not.i43, label %MyMemCpy.exit52, label %for.body.preheader.i44

for.body.preheader.i44:                           ; preds = %for.end12
  %add.ptr = getelementptr i8, ptr %buf, i64 %idx.ext
  %sub16 = sub i32 %delta, %spec.store.select
  %wide.trip.count.i45 = zext i32 %sub16 to i64
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %state, ptr align 1 %add.ptr, i64 %wide.trip.count.i45, i1 false)
  br label %MyMemCpy.exit52

MyMemCpy.exit52:                                  ; preds = %for.body.preheader.i44, %for.end12
  %cmp6.not.i53 = icmp eq i32 %spec.store.select, 0
  br i1 %cmp6.not.i53, label %MyMemCpy.exit62, label %for.body.i56.preheader

for.body.i56.preheader:                           ; preds = %MyMemCpy.exit52
  %idx.ext17 = zext i32 %delta to i64
  %add.ptr18 = getelementptr i8, ptr %state, i64 %idx.ext17
  %idx.neg = sub nsw i64 0, %idx.ext
  %add.ptr20 = getelementptr i8, ptr %add.ptr18, i64 %idx.neg
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %add.ptr20, ptr nonnull align 16 %buf, i64 %idx.ext, i1 false)
  br label %MyMemCpy.exit62

MyMemCpy.exit62:                                  ; preds = %for.body.i56.preheader, %MyMemCpy.exit52
...
MyMemCpy.exit:                                    ; preds = %entry
  %cmp65.not = icmp eq i64 %size, 0
  br i1 %cmp65.not, label %for.end12, label %for.cond1.preheader

MyMemCpy.exit.thread:                             ; preds = %entry
  %wide.trip.count.i = zext i32 %delta to i64
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 %buf, ptr align 1 %state, i64 %wide.trip.count.i, i1 false)
  %cmp65.not69 = icmp eq i64 %size, 0
  br i1 %cmp65.not69, label %for.end12, label %for.cond1.preheader.us.preheader
...
for.cond1.preheader.us:                           ; preds = %for.cond1.preheader.us.preheader, %for.cond1.for.cond.loopexit_crit_edge.us
  %i.066.us = phi i64 [ %inc.us.lcssa, %for.cond1.for.cond.loopexit_crit_edge.us ], [ 0, %for.cond1.preheader.us.preheader ]
  %2 = add i64 %i.066.us, 1
  %umax = tail call i64 @llvm.umax.i64(i64 %size, i64 %2)
  %3 = xor i64 %i.066.us, -1
  %4 = add i64 %umax, %3
  %5 = freeze i64 %4
  %umin = tail call i64 @llvm.umin.i64(i64 %5, i64 %1)
  %6 = add i64 %umin, 1
...
vector.ph:                                        ; preds = %for.cond1.preheader.us
  %n.vec = and i64 %6, -16
  %ind.end = add i64 %i.066.us, %n.vec
  %7 = add i64 %i.066.us, 15
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %8 = phi i64 [ %7, %vector.ph ], [ %12, %vector.body ]
  %offset.idx = add i64 %i.066.us, %index
  %9 = getelementptr inbounds [256 x i8], ptr %buf, i64 0, i64 %index
  %wide.load = load <16 x i8>, ptr %9, align 16
  %10 = getelementptr inbounds i8, ptr %data, i64 %offset.idx
  %wide.load71 = load <16 x i8>, ptr %10, align 1
  %11 = add <16 x i8> %wide.load71, %wide.load
  store <16 x i8> %11, ptr %10, align 1
  store <16 x i8> %11, ptr %9, align 16
  %index.next = add nuw i64 %index, 16
  %12 = add i64 %8, 16
  %13 = icmp eq i64 %index.next, %n.vec
  br i1 %13, label %middle.block, label %vector.body
...
for.body4.us.preheader:                           ; preds = %for.cond1.preheader.us, %middle.block
  %indvars.iv.ph = phi i64 [ 0, %for.cond1.preheader.us ], [ %n.vec, %middle.block ]
  %i.163.us.ph = phi i64 [ %i.066.us, %for.cond1.preheader.us ], [ %ind.end, %middle.block ]
  br label %for.body4.us

for.body4.us:                                     ; preds = %for.body4.us.preheader, %for.body4.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body4.us ], [ %indvars.iv.ph, %for.body4.us.preheader ]
  %i.163.us = phi i64 [ %inc.us, %for.body4.us ], [ %i.163.us.ph, %for.body4.us.preheader ]
  %arrayidx.us = getelementptr inbounds [256 x i8], ptr %buf, i64 0, i64 %indvars.iv
  %16 = load i8, ptr %arrayidx.us, align 1
  %arrayidx5.us = getelementptr inbounds i8, ptr %data, i64 %i.163.us
  %17 = load i8, ptr %arrayidx5.us, align 1
  %add.us = add i8 %17, %16
  store i8 %add.us, ptr %arrayidx5.us, align 1
  store i8 %add.us, ptr %arrayidx.us, align 1
  %inc.us = add nuw i64 %i.163.us, 1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %cmp2.us = icmp ult i64 %indvars.iv.next, %0
  %cmp3.us = icmp ult i64 %inc.us, %size
  %18 = select i1 %cmp2.us, i1 %cmp3.us, i1 false
...
for.end12:                                        ; preds = %MyMemCpy.exit.thread, %for.end12.loopexit, %MyMemCpy.exit
  ...
  br i1 %cmp6.not.i41, label %MyMemCpy.exit50, label %for.body.preheader.i42

for.body.preheader.i42:                           ; preds = %for.end12
  %add.ptr = getelementptr i8, ptr %buf, i64 %idx.ext
  %sub = sub i32 %delta, %spec.store.select
  %wide.trip.count.i43 = zext i32 %sub to i64
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %state, ptr align 1 %add.ptr, i64 %wide.trip.count.i43, i1 false)
  br label %MyMemCpy.exit50

MyMemCpy.exit50:                                  ; preds = %for.body.preheader.i42, %for.end12
  %cmp6.not.i51 = icmp eq i32 %spec.store.select, 0
  br i1 %cmp6.not.i51, label %MyMemCpy.exit60, label %for.body.i54.preheader

for.body.i54.preheader:                           ; preds = %MyMemCpy.exit50
  %idx.ext16 = zext i32 %delta to i64
  %add.ptr17 = getelementptr i8, ptr %state, i64 %idx.ext16
  %idx.neg = sub nsw i64 0, %idx.ext
  %add.ptr19 = getelementptr i8, ptr %add.ptr17, i64 %idx.neg
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %add.ptr19, ptr nonnull align 16 %buf, i64 %idx.ext, i1 false)
  br label %MyMemCpy.exit60

MyMemCpy.exit60:                                  ; preds = %for.body.i54.preheader, %MyMemCpy.exit50
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %buf) #6
  ret void
}
