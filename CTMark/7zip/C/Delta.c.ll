...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load73 = load <16 x i8>, ptr %10, align 16, !tbaa !5
...
for.body.preheader.i44:                           ; preds = %for.end12
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %state, ptr align 1 %add.ptr, i64 %wide.trip.count.i45, i1 false), !tbaa !5
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load71 = load <16 x i8>, ptr %10, align 1, !tbaa !5
...
for.body.preheader.i42:                           ; preds = %for.end12
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %state, ptr align 1 %add.ptr, i64 %wide.trip.count.i43, i1 false), !tbaa !5
