; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/Ppmd7Dec.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/Ppmd7Dec.c"
...
if.then.i:                                        ; preds = %entry
  ...
  %4 = load i32, ptr %Range, align 8
  %shl4.i = shl i32 %4, 8
  store i32 %shl4.i, ptr %Range, align 8
...
if.then8.i:                                       ; preds = %if.then.i
  ...
  store i32 %or16.i, ptr %Code, align 4
  %7 = load i32, ptr %Range, align 8
  %shl19.i = shl i32 %7, 8
  store i32 %shl19.i, ptr %Range, align 8
...
if.end:                                           ; preds = %entry, %if.else
  ...
  store i32 %storemerge, ptr %Range, align 8
...
if.then.i:                                        ; preds = %if.end
  %shl.i = shl i32 %2, 8
  %Stream.i = getelementptr inbounds %struct.CPpmd7z_RangeDec, ptr %pp, i64 0, i32 3
  %3 = load ptr, ptr %Stream.i, align 8
  %4 = load ptr, ptr %3, align 8
  %call.i = tail call zeroext i8 %4(ptr noundef nonnull %3) #6
  %conv.i = zext i8 %call.i to i32
  %or.i = or i32 %shl.i, %conv.i
  store i32 %or.i, ptr %Code, align 4
  %5 = load i32, ptr %Range, align 8
  %shl4.i = shl i32 %5, 8
  store i32 %shl4.i, ptr %Range, align 8
  %cmp6.i = icmp ult i32 %shl4.i, 16777216
  br i1 %cmp6.i, label %if.then8.i, label %Range_Normalize.exit
...
if.then19:                                        ; preds = %do.body
  ...
  %12 = load ptr, ptr %Decode21, align 8
  ...
  store ptr %incdec.ptr, ptr %FoundState27, align 8
...
do.end:                                           ; preds = %do.cond
  ...
  %14 = load i16, ptr %SummFreq32, align 2
...
if.end37:                                         ; preds = %do.end
  ...
  %15 = load ptr, ptr %FoundState38, align 8
...
do.body82.prol:                                   ; preds = %if.end37, %do.body82.prol
  ...
  %23 = load i8, ptr %incdec.ptr84.prol, align 1
  %idxprom86.prol = zext i8 %23 to i64
  %arrayidx87.prol = getelementptr inbounds i8, ptr %charMask, i64 %idxprom86.prol
  store i8 0, ptr %arrayidx87.prol, align 1
  %dec89.prol = add i32 %i.1.prol, -1
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %do.body82.prol.loopexit, label %do.body82.prol
...
do.body82:                                        ; preds = %do.body82.prol.loopexit, %do.body82
  ...
  %25 = load i8, ptr %incdec.ptr84, align 1
...
if.else:                                          ; preds = %entry
  ...
  %33 = load i16, ptr %add.ptr106, align 4
  ...
  %35 = load ptr, ptr %FoundState115, align 8
  ...
  %40 = load i32, ptr %RunLength, align 4
  %41 = lshr i32 %40, 26
  %and = and i32 %41, 32
...
cleanup204.thread:                                ; preds = %if.else
  ...
  store i16 %conv145, ptr %arrayidx132, align 2
  %45 = load ptr, ptr %p, align 8
  %SummFreq147 = getelementptr inbounds %struct.CPpmd7_Context_, ptr %45, i64 0, i32 1
  store ptr %SummFreq147, ptr %FoundState115, align 8
  %46 = load i8, ptr %SummFreq147, align 1
...
if.end152:                                        ; preds = %if.else
  ...
  store i16 %conv158, ptr %arrayidx132, align 2
  ...
  store i32 0, ptr %PrevSuccess102, align 8
  br label %if.end207
...
do.body216:                                       ; preds = %if.end221, %for.cond208
  ...
  %55 = load i32, ptr %Suffix218, align 4
...
if.end221:                                        ; preds = %do.body216
  %56 = load ptr, ptr %Base222, align 8
  ...
  %57 = load i16, ptr %add.ptr226, align 4
  %cmp232 = icmp eq i16 %57, %54
  br i1 %cmp232, label %do.body216, label %do.end234
...
do.end234:                                        ; preds = %if.end221
  ...
  %58 = load i32, ptr %Stats237, align 4
...
do.body244:                                       ; preds = %do.body244, %do.end234
  ...
  store ptr %s209.0, ptr %arrayidx256, align 8
  %sub257 = sub i32 %i212.0, %conv249
  %cmp259.not = icmp eq i32 %sub257, %sub243
  br i1 %cmp259.not, label %do.end261, label %do.body244
...
do.end261:                                        ; preds = %do.body244
  ...
  %62 = load i32, ptr %freqSum, align 4
  %add263 = add i32 %62, %add253
  store i32 %add263, ptr %freqSum, align 4
  %63 = load ptr, ptr %rc, align 8
...
for.cond271:                                      ; preds = %do.end261, %for.cond271
  ...
  br i1 %cmp275.not, label %for.end280, label %for.cond271

for.end280:                                       ; preds = %for.cond271
  %66 = load ptr, ptr %Decode314, align 8
...
cleanup344:                                       ; preds = %do.end, %if.then19, %if.then8, %cleanup333.thread, %cleanup204.thread
  %retval.5 = phi i32 [ %conv150, %cleanup204.thread ], [ %retval.4.ph, %cleanup333.thread ], [ -2, %do.end ], [ %conv29, %if.then19 ], [ %conv11, %if.then8 ]
