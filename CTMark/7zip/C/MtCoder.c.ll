; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/MtCoder.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/MtCoder.c"
...
if.end2:                                          ; preds = %if.end
  ...
  store i32 %call3, ptr %res, align 8
...
if.then:                                          ; preds = %entry
  ...
  store i64 %inSize, ptr %arrayidx, align 8
  br label %if.end
...
if.then5:                                         ; preds = %if.end
  ...
  %3 = load i64, ptr %totalOutSize, align 8
  %add9 = add i64 %sub8, %3
  store i64 %add9, ptr %totalOutSize, align 8
  store i64 %outSize, ptr %arrayidx7, align 8
  br label %if.end13

if.end13:                                         ; preds = %if.then5, %if.end
  %res14 = getelementptr inbounds %struct.CMtProgress, ptr %p, i64 0, i32 3
  %4 = load i32, ptr %res14, align 8
...
land.rhs.i:                                       ; preds = %if.then16
  ...
  %6 = load i64, ptr %totalOutSize18, align 8
...
Progress.exit:                                    ; preds = %if.then16, %land.rhs.i
  ...
  store i32 %cond.i, ptr %res14, align 8
  br label %if.end21
...
entry:
  store ptr %mtCoder, ptr %p, align 8
...
for.body:                                         ; preds = %entry, %for.body
  ...
  store ptr null, ptr %outBuf.i, align 8
...
for.body:                                         ; preds = %entry, %CMtThread_Destruct.exit
  ...
  %0 = load i32, ptr %_created.i, align 8
...
if.then.i:                                        ; preds = %for.body
  ...
  store i32 1, ptr %stop.i.i, align 8
  %startEvent.i.i = getelementptr inbounds %struct._CMtCoder, ptr %p, i64 0, i32 11, i64 %indvars.iv, i32 6, i32 1
...
if.end9.thread.i:                                 ; preds = %if.end.i
  ...
  store ptr null, ptr %outBuf1042.i, align 8
...
if.end9.i:                                        ; preds = %if.end.i
  ...
  %outBuf.i = getelementptr inbounds %struct._CMtCoder, ptr %p, i64 0, i32 11, i64 %indvars.iv, i32 1
  %4 = load ptr, ptr %outBuf.i, align 8
  ...
  %.pre41.i = load ptr, ptr %alloc12.phi.trans.insert.i, align 8
  store ptr null, ptr %outBuf.i, align 8
...
if.then14.i:                                      ; preds = %if.end9.i
  ...
  %5 = load ptr, ptr %Free17.i, align 8
  %inBuf.i = getelementptr inbounds %struct._CMtCoder, ptr %p, i64 0, i32 11, i64 %indvars.iv, i32 3
  %6 = load ptr, ptr %inBuf.i, align 8
...
CMtThread_Destruct.exit:                          ; preds = %if.end9.thread.i, %if.end9.i, %if.then14.i
  ...
  store ptr null, ptr %inBuf21.i, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32
  br i1 %exitcond.not, label %for.end, label %for.body
...
entry:
  ...
  %0 = load i32, ptr %numThreads1, align 8
  %res2 = getelementptr inbounds %struct._CMtCoder, ptr %p, i64 0, i32 9
  store i32 0, ptr %res2, align 8
  ...
  store ptr %1, ptr %progress3.i, align 8
...
for.body:                                         ; preds = %for.body.preheader, %for.cond
  ...
  %arrayidx = getelementptr inbounds %struct._CMtCoder, ptr %p, i64 0, i32 11, i64 %indvars.iv
  %inBuf.i = getelementptr inbounds %struct._CMtCoder, ptr %p, i64 0, i32 11, i64 %indvars.iv, i32 3
  %2 = load ptr, ptr %inBuf.i, align 8
...
lor.lhs.false.i:                                  ; preds = %for.body
  ...
  %3 = load i64, ptr %inBufSize.i, align 8
  %4 = load i64, ptr %.pre.i, align 8
  %cmp1.not.i = icmp eq i64 %3, %4
  br i1 %cmp1.not.i, label %if.end18.i, label %if.then.i

if.then.i:                                        ; preds = %lor.lhs.false.i, %for.body
  %alloc.i = getelementptr inbounds %struct._CMtCoder, ptr %.pre.i, i64 0, i32 6
  %5 = load ptr, ptr %alloc.i, align 8
  %Free.i = getelementptr inbounds %struct.ISzAlloc, ptr %5, i64 0, i32 1
  %6 = load ptr, ptr %Free.i, align 8
  tail call void %6(ptr noundef %5, ptr noundef %2) #6
  %7 = load ptr, ptr %arrayidx, align 8
  %8 = load i64, ptr %7, align 8
  %inBufSize8.i = getelementptr inbounds %struct._CMtCoder, ptr %p, i64 0, i32 11, i64 %indvars.iv, i32 4
  store i64 %8, ptr %inBufSize8.i, align 8
  %alloc10.i = getelementptr inbounds %struct._CMtCoder, ptr %7, i64 0, i32 6
  %9 = load ptr, ptr %alloc10.i, align 8
  %10 = load ptr, ptr %9, align 8
  %call.i = tail call ptr %10(ptr noundef nonnull %9, i64 noundef %8) #6
  store ptr %call.i, ptr %inBuf.i, align 8
  %cmp16.i = icmp eq ptr %call.i, null
  br i1 %cmp16.i, label %cleanup76, label %if.then.if.end18_crit_edge.i

if.then.if.end18_crit_edge.i:                     ; preds = %if.then.i
  %.pre83.pre.i = load ptr, ptr %arrayidx, align 8
  br label %if.end18.i

if.end18.i:                                       ; preds = %if.then.if.end18_crit_edge.i, %lor.lhs.false.i
  %.pre83.i = phi ptr [ %.pre83.pre.i, %if.then.if.end18_crit_edge.i ], [ %.pre.i, %lor.lhs.false.i ]
  %outBuf.i = getelementptr inbounds %struct._CMtCoder, ptr %p, i64 0, i32 11, i64 %indvars.iv, i32 1
  %11 = load ptr, ptr %outBuf.i, align 8
  %cmp19.i = icmp eq ptr %11, null
  br i1 %cmp19.i, label %if.then23.i, label %lor.lhs.false20.i
...
lor.lhs.false20.i:                                ; preds = %if.end18.i
  ...
  %12 = load i64, ptr %outBufSize.i, align 8
  %destBlockSize.i = getelementptr inbounds %struct._CMtCoder, ptr %.pre83.i, i64 0, i32 1
  %13 = load i64, ptr %destBlockSize.i, align 8
  %cmp22.not.i = icmp eq i64 %12, %13
  br i1 %cmp22.not.i, label %if.end45.i, label %if.then23.i

if.then23.i:                                      ; preds = %lor.lhs.false20.i, %if.end18.i
  %alloc25.i = getelementptr inbounds %struct._CMtCoder, ptr %.pre83.i, i64 0, i32 6
  %14 = load ptr, ptr %alloc25.i, align 8
  %Free26.i = getelementptr inbounds %struct.ISzAlloc, ptr %14, i64 0, i32 1
  %15 = load ptr, ptr %Free26.i, align 8
  tail call void %15(ptr noundef %14, ptr noundef %11) #6
  %16 = load ptr, ptr %arrayidx, align 8
  %destBlockSize31.i = getelementptr inbounds %struct._CMtCoder, ptr %16, i64 0, i32 1
  %17 = load i64, ptr %destBlockSize31.i, align 8
  %outBufSize32.i = getelementptr inbounds %struct._CMtCoder, ptr %p, i64 0, i32 11, i64 %indvars.iv, i32 2
  store i64 %17, ptr %outBufSize32.i, align 8
  %alloc34.i = getelementptr inbounds %struct._CMtCoder, ptr %16, i64 0, i32 6
  %18 = load ptr, ptr %alloc34.i, align 8
  %19 = load ptr, ptr %18, align 8
  %call39.i = tail call ptr %19(ptr noundef nonnull %18, i64 noundef %17) #6
  store ptr %call39.i, ptr %outBuf.i, align 8
...
for.body6:                                        ; preds = %for.body6.preheader, %for.inc22
  ...
  %20 = load i32, ptr %_created, align 8
...
for.inc22:                                        ; preds = %LoopThread_Create.exit, %for.body6
  ...
  br i1 %exitcond161.not, label %for.cond27.preheader, label %for.body6
...
cleanup41:                                        ; preds = %for.body29
  %21 = trunc i64 %indvars.iv162 to i32
  %stopReading = getelementptr inbounds %struct._CMtCoder, ptr %p, i64 0, i32 11, i64 0, i32 7
  store i32 1, ptr %stopReading, align 8
  br label %for.end46

for.inc44:                                        ; preds = %for.body29
  %indvars.iv.next163 = add nuw nsw i64 %indvars.iv162, 1
  %exitcond166.not = icmp eq i64 %indvars.iv.next163, %wide.trip.count165
  br i1 %exitcond166.not, label %for.end46, label %for.body29

for.end46:                                        ; preds = %for.inc44, %entry, %for.cond4.preheader, %for.cond27.preheader, %cleanup41
  %i.2143 = phi i32 [ %21, %cleanup41 ], [ 0, %for.cond27.preheader ], [ 0, %for.cond4.preheader ], [ 0, %entry ], [ %0, %for.inc44 ]
...
for.body55:                                       ; preds = %for.body55.preheader, %for.body55
  ...
  br i1 %exitcond171.not, label %if.end64, label %for.body55
...
for.body67:                                       ; preds = %for.body67.preheader, %for.body67
  ...
  br i1 %exitcond176.not, label %for.end73, label %for.body67
...
cond.true:                                        ; preds = %for.end73
  %22 = load i32, ptr %res2, align 8
  br label %cleanup76

cleanup76:                                        ; preds = %if.end49.i, %if.end45.i, %if.then23.i, %if.then.i, %cond.true, %for.end73
  %retval.2 = phi i32 [ %22, %cond.true ], [ %res.6, %for.end73 ], [ 2, %if.then.i ], [ 2, %if.then23.i ], [ 12, %if.end45.i ], [ 12, %if.end49.i ]
  ret i32 %retval.2
}
...
if.end.i:                                         ; preds = %for.cond
  ...
  %6 = load i32, ptr %stopReading.i, align 8
...
if.then4.i:                                       ; preds = %if.end.i
  ...
  store i32 1, ptr %stopReading5.i, align 8
...
if.end10.i:                                       ; preds = %if.end.i
  ...
  %8 = load i64, ptr %outBufSize.i, align 8
  store i64 %8, ptr %destSize.i, align 8
  %inStream.i = getelementptr inbounds %struct._CMtCoder, ptr %3, i64 0, i32 3
  %9 = load ptr, ptr %inStream.i, align 8
...
while.body.i.i:                                   ; preds = %while.cond.i.i
  ...
  store i64 %size.0.i.i, ptr %curSize.i.i, align 8
  ...
  %13 = and i1 %cmp1.not.i.i, %cmp2.i.i
  ...
  br i1 %cond10.i.i, label %while.cond.i.i, label %FullRead.exit.i
...
cleanup.cont.i:                                   ; preds = %while.cond.i.i, %FullRead.exit.i
  ...
  store i32 %conv.i, ptr %stopReading20.i, align 8
...
if.end26.i:                                       ; preds = %cleanup.cont.i
  ...
  %17 = load ptr, ptr %mtCallback.i, align 8
...
if.end47.i:                                       ; preds = %cleanup.cont40.i
  %24 = load i32, ptr %stopWriting.i, align 4
...
if.end50.i:                                       ; preds = %if.end47.i
  ...
  %26 = load ptr, ptr %outStream.i, align 8
  %27 = load ptr, ptr %26, align 8
  %28 = load ptr, ptr %outBuf.i, align 8
  %29 = load i64, ptr %destSize.i, align 8
  %call55.i = call i64 %27(ptr noundef nonnull %26, ptr noundef %28, i64 noundef %29) #6
  %30 = load i64, ptr %destSize.i, align 8
...
MtCoder_SetError.exit:                            ; preds = %if.then, %if.then.i
  ...
  %34 = load i32, ptr %res1.i30, align 8
  %cmp.i31 = icmp eq i32 %34, 0
  br i1 %cmp.i31, label %if.then.i34, label %cleanup.thread

if.then.i34:                                      ; preds = %MtCoder_SetError.exit
  store i32 %retval.3.i39, ptr %res1.i30, align 8
  br label %cleanup.thread

cleanup.thread:                                   ; preds = %if.then.i34, %MtCoder_SetError.exit
