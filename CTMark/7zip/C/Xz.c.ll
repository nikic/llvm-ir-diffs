; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/Xz.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/C/Xz.c"
...
do.end:                                           ; preds = %do.body
  ...
  %and5 = and i8 %0, 127
  store i8 %and5, ptr %arrayidx.le, align 1
  ret i32 %1
}
...
sw.bb:                                            ; preds = %entry
  ...
  %1 = load i32, ptr %crc, align 4
  %xor = xor i32 %1, -1
  store i32 %xor, ptr %digest, align 4
  br label %return
...
sw.bb1:                                           ; preds = %entry
  ...
  store i8 %conv, ptr %digest, align 1
  %shr = lshr i64 %xor2, 8
