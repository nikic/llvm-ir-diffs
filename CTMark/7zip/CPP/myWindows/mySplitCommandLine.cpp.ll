...
for.cond.i.i127:                                  ; preds = %for.cond.i.i127, %if.else51
  ...
  %18 = load i8, ptr %arrayidx.i.i129, align 1, !tbaa !11
  %cmp.not.i.i130 = icmp eq i8 %18, 0
  %indvars.iv.next.i.i131 = add nuw i64 %indvars.iv.i.i128, 1
  br i1 %cmp.not.i.i130, label %_Z11MyStringLenIcEiPKT_.exit.i132, label %for.cond.i.i127, !llvm.loop !14
...
_Z11MyStringLenIcEiPKT_.exit.i132:                ; preds = %for.cond.i.i127
  ...
  store ptr %call.i.i137, ptr %ref.tmp52, align 8, !tbaa !5
  store i8 0, ptr %call.i.i137, align 1, !tbaa !11
  store i32 %add.i.i133, ptr %_capacity.i126, align 4, !tbaa !12
...
while.cond.i.i139:                                ; preds = %_Z11MyStringLenIcEiPKT_.exit.i132, %while.cond.i.i139
  ...
  %20 = load i8, ptr %src.addr.0.i.i140, align 1, !tbaa !11
  %incdec.ptr1.i.i143 = getelementptr inbounds i8, ptr %dest.addr.0.i.i141, i64 1
  store i8 %20, ptr %dest.addr.0.i.i141, align 1, !tbaa !11
  %cmp.not.i10.i144 = icmp eq i8 %20, 0
  br i1 %cmp.not.i10.i144, label %_ZN11CStringBaseIcEC2EPKc.exit146, label %while.cond.i.i139, !llvm.loop !16
