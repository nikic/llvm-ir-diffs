; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/myWindows/mySplitCommandLine.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/myWindows/mySplitCommandLine.cpp"
...
invoke.cont:                                      ; preds = %entry
  ...
  store ptr %call.i.i106107, ptr %name, align 8
  store i8 0, ptr %call.i.i106107, align 1
  store i32 4, ptr %_capacity.i105, align 4
...
call.i.i109.noexc:                                ; preds = %_Z11MyStringLenIcEiPKT_.exit.i
  ...
  store ptr %call.i.i109110, ptr %ref.tmp, align 8
  store i8 0, ptr %call.i.i109110, align 1
  store i32 %add.i.i, ptr %_capacity.i108, align 4
...
_ZN11CStringBaseIcED2Ev.exit:                     ; preds = %invoke.cont4, %delete.notnull.i
  ...
  store i8 0, ptr getelementptr inbounds ([4096 x i8], ptr @_ZZ18mySplitCommandLineiPPKcR13CObjectVectorI11CStringBaseIwEEE14p7zip_home_dir, i64 0, i64 4095), align 1
...
if.then31:                                        ; preds = %land.lhs.true28
  store i32 1, ptr @global_use_utf16_conversion, align 4
  br label %if.end
...
if.then43:                                        ; preds = %land.lhs.true39
  store i32 0, ptr @global_use_utf16_conversion, align 4
  br label %for.inc70
...
for.cond.i.i127:                                  ; preds = %for.cond.i.i127, %if.else51
  %indvars.iv.i.i128 = phi i64 [ %indvars.iv.next.i.i131, %for.cond.i.i127 ], [ 0, %if.else51 ]
  %arrayidx.i.i129 = getelementptr inbounds i8, ptr %17, i64 %indvars.iv.i.i128
  %18 = load i8, ptr %arrayidx.i.i129, align 1
  %cmp.not.i.i130 = icmp eq i8 %18, 0
  %indvars.iv.next.i.i131 = add nuw i64 %indvars.iv.i.i128, 1
  br i1 %cmp.not.i.i130, label %_Z11MyStringLenIcEiPKT_.exit.i132, label %for.cond.i.i127

_Z11MyStringLenIcEiPKT_.exit.i132:                ; preds = %for.cond.i.i127
  %19 = trunc i64 %indvars.iv.i.i128 to i32
  %add.i.i133 = add nsw i32 %19, 1
  %cmp.i.i134 = icmp ne i32 %add.i.i133, 0
  call void @llvm.assume(i1 %cmp.i.i134)
  %conv.i.i136 = sext i32 %add.i.i133 to i64
  %call.i.i137 = call noalias noundef nonnull ptr @_Znam(i64 noundef %conv.i.i136) #16
  store ptr %call.i.i137, ptr %ref.tmp52, align 8
  store i8 0, ptr %call.i.i137, align 1
  store i32 %add.i.i133, ptr %_capacity.i126, align 4
  br label %while.cond.i.i139

while.cond.i.i139:                                ; preds = %_Z11MyStringLenIcEiPKT_.exit.i132, %while.cond.i.i139
  %src.addr.0.i.i140 = phi ptr [ %incdec.ptr.i.i142, %while.cond.i.i139 ], [ %17, %_Z11MyStringLenIcEiPKT_.exit.i132 ]
  %dest.addr.0.i.i141 = phi ptr [ %incdec.ptr1.i.i143, %while.cond.i.i139 ], [ %call.i.i137, %_Z11MyStringLenIcEiPKT_.exit.i132 ]
  %incdec.ptr.i.i142 = getelementptr inbounds i8, ptr %src.addr.0.i.i140, i64 1
  %20 = load i8, ptr %src.addr.0.i.i140, align 1
  %incdec.ptr1.i.i143 = getelementptr inbounds i8, ptr %dest.addr.0.i.i141, i64 1
  store i8 %20, ptr %dest.addr.0.i.i141, align 1
  %cmp.not.i10.i144 = icmp eq i8 %20, 0
  br i1 %cmp.not.i10.i144, label %_ZN11CStringBaseIcEC2EPKc.exit146, label %while.cond.i.i139

_ZN11CStringBaseIcEC2EPKc.exit146:                ; preds = %while.cond.i.i139
  store i32 %19, ptr %_length.i145, align 8
...
_ZN11CStringBaseIcED2Ev.exit149:                  ; preds = %invoke.cont56, %delete.notnull.i148
  ...
  %22 = load i32, ptr %_length.i150, align 8
...
call.i.i.noexc.i:                                 ; preds = %if.end9.i.i.i
  ...
  store ptr %call.i.i4.i, ptr %call.i152, align 8
...
_ZN13CObjectVectorI11CStringBaseIwEE3AddERKS1_.exit: ; preds = %invoke.cont.i
  ...
  store ptr %call.i152, ptr %arrayidx.i.i151, align 8
...
for.inc70:                                        ; preds = %if.then43, %_ZN11CStringBaseIwED2Ev.exit160, %if.then50
  ...
  br i1 %exitcond166.not, label %for.cond.cleanup36, label %for.body37
...
define dso_local noundef nonnull ptr @_Z12my_getlocalev() local_unnamed_addr #10 {
entry:
