; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/myWindows/wine_date_and_time.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/myWindows/wine_date_and_time.cpp"
...
entry:
  ...
  store i32 %conv1.i, ptr %ft, align 4
  ...
  store i32 %conv2.i, ptr %dwHighDateTime.i, align 4
...
if.end:                                           ; preds = %entry
  ...
  store i32 %conv, ptr %Seconds, align 4
  br label %cleanup
...
entry:
  ...
  store i64 %conv4, ptr %unixtime, align 8
...
if.then:                                          ; preds = %entry
  ...
  %7 = load i32, ptr %call5, align 8
  %div = sdiv i32 %7, 2
  %add8 = add nsw i32 %add, %div
  %conv9 = trunc i32 %add8 to i16
  store i16 %conv9, ptr %fattime, align 2
  br label %if.end
...
if.then17:                                        ; preds = %if.end
  store i16 %conv15, ptr %fatdate, align 2
  br label %if.end18
...
entry:
  ...
  store i64 %call.i.i, ptr %utc.i.i, align 8
  ...
  %1 = load i32, ptr %tm_isdst.i.i, align 8
  ...
  store i32 %1, ptr %tm_isdst3.i.i, align 8
  %call4.i.i = call i64 @mktime(ptr noundef %call2.i.i) #8
  %2 = load i64, ptr %utc.i.i, align 8
...
entry:
  ...
  store i32 %conv5, ptr %utcft, align 4
  %3 = lshr i64 %add.i, 32
  %conv8 = trunc i64 %3 to i32
...
entry:
  %0 = load i16, ptr %syst, align 2
  %wMonth = getelementptr inbounds %struct._SYSTEMTIME, ptr %syst, i64 0, i32 1
  %1 = load i16, ptr %wMonth, align 2
  %wHour = getelementptr inbounds %struct._SYSTEMTIME, ptr %syst, i64 0, i32 4
  %2 = load <4 x i16>, ptr %wHour, align 2
  %.fr = freeze <4 x i16> %2
...
lor.end.i:                                        ; preds = %lor.rhs.i.i, %land.rhs.i.i, %lor.rhs.i, %lor.lhs.false35.i
  ...
  %10 = load i32, ptr %arrayidx45.i, align 4
