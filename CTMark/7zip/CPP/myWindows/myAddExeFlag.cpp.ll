; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/myWindows/myAddExeFlag.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/myWindows/myAddExeFlag.cpp"
...
entry:
  ...
  call void @_Z24UnicodeStringToMultiByteRK11CStringBaseIwEj(ptr nonnull sret(%class.CStringBase) align 8 %filename, ptr noundef nonnull align 8 dereferenceable(16) %u_name, i32 noundef 0)
...
_ZL16nameWindowToUnixPKc.exit:                    ; preds = %entry, %land.lhs.true.i
  ...
  %call3 = call i32 @chmod(ptr noundef nonnull %retval.0.i, i32 noundef 448) #5
