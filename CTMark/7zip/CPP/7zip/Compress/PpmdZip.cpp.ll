; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Compress/PpmdZip.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Compress/PpmdZip.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTVN9NCompress8NPpmdZip8CDecoderE, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  ...
  store i8 %frombool, ptr %_fullFileMode, align 8
  ...
  store ptr %_inStream, ptr %Stream, align 8
...
_ZN9NCompress8NPpmdZip4CBuf5AllocEv.exit:         ; preds = %entry
  ...
  store ptr %call.i, ptr %_outStream, align 8
...
_ZN14CByteInBufWrap8ReadByteEv.exit:              ; preds = %if.end
  ...
  %call.i199 = tail call noundef zeroext i8 @_ZN14CByteInBufWrap20ReadByteFromNewBlockEv(ptr noundef nonnull align 8 dereferenceable(64) %_inStream)
  %.pre = load ptr, ptr %Cur.i, align 8
  %.pre263 = load ptr, ptr %Lim.i, align 8
  %cmp.not.i.1 = icmp eq ptr %.pre, %.pre263
  br i1 %cmp.not.i.1, label %if.end.i.1, label %if.then.i198.1

if.then.i198.1:                                   ; preds = %_ZN14CByteInBufWrap8ReadByteEv.exit
  %incdec.ptr.i.1 = getelementptr inbounds i8, ptr %.pre, i64 1
  store ptr %incdec.ptr.i.1, ptr %Cur.i, align 8
...
if.end.i.1:                                       ; preds = %_ZN14CByteInBufWrap8ReadByteEv.exit
  %call.i199.1 = tail call noundef zeroext i8 @_ZN14CByteInBufWrap20ReadByteFromNewBlockEv(ptr noundef nonnull align 8 dereferenceable(64) %_inStream)
  br label %_ZN14CByteInBufWrap8ReadByteEv.exit.1

_ZN14CByteInBufWrap8ReadByteEv.exit.1:            ; preds = %if.end.i.1, %if.then.i198.1
  %retval.0.i.1 = phi i8 [ %3, %if.then.i198.1 ], [ %call.i199.1, %if.end.i.1 ]
  %4 = load i8, ptr %Extra.i, align 8
...
if.end11:                                         ; preds = %_ZN14CByteInBufWrap8ReadByteEv.exit.1
  ...
  %buf.sroa.0.0.insert.ext = zext i8 %call.i199 to i16
...
cleanup.cont:                                     ; preds = %if.end25
  ...
  store i64 0, ptr %processedSize, align 8
...
if.end43.us:                                      ; preds = %if.then39.us, %while.cond.us
  ...
  %8 = load ptr, ptr %_outStream, align 8
  br label %do.body.us
...
if.end54.us:                                      ; preds = %do.body.us
  ...
  br i1 %cmp58.not.us, label %do.end.us, label %do.body.us
...
do.end.us:                                        ; preds = %if.end54.us, %do.body.us
  ...
  %10 = load i64, ptr %processedSize, align 8
  %add59.us = add i64 %10, %i45.1.us
  store i64 %add59.us, ptr %processedSize, align 8
  %11 = load ptr, ptr %_outStream, align 8
...
cleanup.cont76.us:                                ; preds = %cleanup.cont68.us
  %13 = load i8, ptr %Extra.i, align 8
...
cleanup.cont.split:                               ; preds = %cleanup.cont
  br i1 %tobool36.not, label %while.cond.us221, label %while.cond

while.cond.us221:                                 ; preds = %cleanup.cont.split, %if.end87.us247
  %14 = load ptr, ptr %_outStream, align 8
  br label %do.body.us224

do.body.us224:                                    ; preds = %if.end54.us230, %while.cond.us221
  %i45.0.us225 = phi i64 [ 0, %while.cond.us221 ], [ %inc57.us233, %if.end54.us230 ]
  %call47.us226 = call i32 @Ppmd8_DecodeSymbol(ptr noundef nonnull %_ppmd)
  %15 = load i8, ptr %Extra.i, align 8
  %tobool50.us227 = icmp ne i8 %15, 0
  %cmp52.us228 = icmp slt i32 %call47.us226, 0
  %or.cond158.us229 = select i1 %tobool50.us227, i1 true, i1 %cmp52.us228
  br i1 %or.cond158.us229, label %do.end.us235, label %if.end54.us230

if.end54.us230:                                   ; preds = %do.body.us224
  %conv55.us231 = trunc i32 %call47.us226 to i8
  %arrayidx56.us232 = getelementptr inbounds i8, ptr %14, i64 %i45.0.us225
  store i8 %conv55.us231, ptr %arrayidx56.us232, align 1
  %inc57.us233 = add nuw nsw i64 %i45.0.us225, 1
  %cmp58.not.us234 = icmp eq i64 %inc57.us233, 1048576
  br i1 %cmp58.not.us234, label %do.end.us235, label %do.body.us224

do.end.us235:                                     ; preds = %if.end54.us230, %do.body.us224
  %cmp52.us228.lcssa = phi i1 [ false, %if.end54.us230 ], [ %cmp52.us228, %do.body.us224 ]
  %i45.1.us238 = phi i64 [ 1048576, %if.end54.us230 ], [ %i45.0.us225, %do.body.us224 ]
  %16 = load i64, ptr %processedSize, align 8
  %add59.us239 = add i64 %16, %i45.1.us238
  store i64 %add59.us239, ptr %processedSize, align 8
  %17 = load ptr, ptr %_outStream, align 8
  %call62.us240 = call noundef i32 @_Z11WriteStreamP20ISequentialOutStreamPKvm(ptr noundef %outStream, ptr noundef %17, i64 noundef %i45.1.us238)
  %cmp63.not.us241 = icmp eq i32 %call62.us240, 0
  br i1 %cmp63.not.us241, label %cleanup.cont68.us242, label %cleanup150

cleanup.cont68.us242:                             ; preds = %do.end.us235
  %18 = load i32, ptr %Res.i, align 4
  %cmp71.not.us243 = icmp eq i32 %18, 0
  br i1 %cmp71.not.us243, label %cleanup.cont76.us244, label %cleanup150

cleanup.cont76.us244:                             ; preds = %cleanup.cont68.us242
  %19 = load i8, ptr %Extra.i, align 8
  %tobool79.not.us245 = icmp eq i8 %19, 0
  br i1 %tobool79.not.us245, label %if.end81.us246, label %cleanup150

if.end81.us246:                                   ; preds = %cleanup.cont76.us244
  br i1 %cmp52.us228.lcssa, label %if.then83, label %if.end87.us247

if.end87.us247:                                   ; preds = %if.end81.us246
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %inSize) #10
  %20 = load i64, ptr %Processed.i, align 8
  ...
  store i64 %add.i.us, ptr %inSize, align 8
  ...
  br i1 %cmp94.not.us, label %while.cond.us221, label %cleanup150

while.cond:                                       ; preds = %cleanup.cont.split, %if.end87
  %24 = load i64, ptr %processedSize, align 8
  %25 = load i64, ptr %outSize, align 8
  %cmp37 = icmp ult i64 %24, %25
...
if.then39:                                        ; preds = %while.cond
  ...
  %26 = load ptr, ptr %_outStream, align 8
  br label %do.body
...
do.body:                                          ; preds = %if.end54, %if.then39
  ...
  %27 = load i8, ptr %Extra.i, align 8
...
if.end54:                                         ; preds = %do.body
  ...
  br i1 %cmp58.not, label %do.end, label %do.body
...
do.end:                                           ; preds = %do.body, %if.end54
  ...
  %28 = load i64, ptr %processedSize, align 8
  %add59 = add i64 %28, %i45.1
  store i64 %add59, ptr %processedSize, align 8
  %29 = load ptr, ptr %_outStream, align 8
...
cleanup.cont76:                                   ; preds = %cleanup.cont68
  %31 = load i8, ptr %Extra.i, align 8
...
if.then83:                                        ; preds = %if.end81, %if.end81.us246, %if.end81.us
  %.us-phi220 = phi i32 [ %call47.us, %if.end81.us ], [ %call47.us226, %if.end81.us246 ], [ %call47, %if.end81 ]
  %cmp84.not = icmp eq i32 %.us-phi220, -1
  br i1 %cmp84.not, label %while.end, label %cleanup150

if.end87:                                         ; preds = %if.end81
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %inSize) #10
  %32 = load i64, ptr %Processed.i, align 8
  %33 = load ptr, ptr %Cur.i, align 8
...
cleanup141:                                       ; preds = %if.then122
  ...
  %or.cond217 = select i1 %or.cond159.not, i1 %cmp146, i1 false
  br i1 %or.cond217, label %if.end149, label %cleanup150

if.end144:                                        ; preds = %if.then120
  %Code.old = getelementptr inbounds %"class.NCompress::NPpmdZip::CDecoder", ptr %this, i64 0, i32 5, i32 19
  %.old = load i32, ptr %Code.old, align 4
...
cleanup150:                                       ; preds = %if.end87, %cleanup.cont76, %do.end, %cleanup.cont68, %do.end.us235, %cleanup.cont68.us242, %cleanup.cont76.us244, %if.end87.us247, %cleanup.cont76.us, %cleanup.cont68.us, %do.end.us, %if.then122, %if.then83, %if.end144, %cleanup141, %while.end, %if.end149
  %retval.12 = phi i32 [ 0, %if.end149 ], [ 1, %cleanup141 ], [ %36, %while.end ], [ 1, %if.end144 ], [ 1, %if.then83 ], [ %38, %if.then122 ], [ %12, %cleanup.cont68.us ], [ %call62.us, %do.end.us ], [ 1, %cleanup.cont76.us ], [ %18, %cleanup.cont68.us242 ], [ %call62.us240, %do.end.us235 ], [ 1, %cleanup.cont76.us244 ], [ %call93.us, %if.end87.us247 ], [ %30, %cleanup.cont68 ], [ %call62, %do.end ], [ 1, %cleanup.cont76 ], [ %call93, %if.end87 ]
...
entry:
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTVN9NCompress8NPpmdZip8CEncoderE, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
if.end7:                                          ; preds = %sw.bb
  store i32 %2, ptr %_restor, align 8
  br label %for.inc
...
if.end12:                                         ; preds = %sw.bb8
  %shr = lshr i32 %2, 20
  store i32 %shr, ptr %_usedMemInMB, align 8
  br label %for.inc
...
if.end18:                                         ; preds = %sw.bb13
  store i32 %2, ptr %_order, align 4
  br label %for.inc
...
entry:
  ...
  %_usedMemInMB = getelementptr inbounds %"class.NCompress::NPpmdZip::CEncoder", ptr %this, i64 0, i32 6
  store i32 16, ptr %_usedMemInMB, align 8
  %_order = getelementptr inbounds %"class.NCompress::NPpmdZip::CEncoder", ptr %this, i64 0, i32 7
  store i32 6, ptr %_order, align 4
  %_restor = getelementptr inbounds %"class.NCompress::NPpmdZip::CEncoder", ptr %this, i64 0, i32 8
  store i32 0, ptr %_restor, align 8
...
_ZN9NCompress8NPpmdZip4CBuf5AllocEv.exit:         ; preds = %entry
  %call.i = tail call ptr @MidAlloc(i64 noundef 1048576)
  store ptr %call.i, ptr %_inStream, align 8
  %.not = icmp eq ptr %call.i, null
  br i1 %.not, label %return, label %if.end
...
if.end5:                                          ; preds = %if.end
  %_ppmd = getelementptr inbounds %"class.NCompress::NPpmdZip::CEncoder", ptr %this, i64 0, i32 5
  %_usedMemInMB = getelementptr inbounds %"class.NCompress::NPpmdZip::CEncoder", ptr %this, i64 0, i32 6
  %3 = load i32, ptr %_usedMemInMB, align 8
  %shl = shl i32 %3, 20
...
if.end8:                                          ; preds = %if.end5
  ...
  %_order = getelementptr inbounds %"class.NCompress::NPpmdZip::CEncoder", ptr %this, i64 0, i32 7
  %6 = load i32, ptr %_order, align 4
  %_restor = getelementptr inbounds %"class.NCompress::NPpmdZip::CEncoder", ptr %this, i64 0, i32 8
  %7 = load i32, ptr %_restor, align 8
  tail call void @Ppmd8_Init(ptr noundef nonnull %_ppmd, i32 noundef %6, i32 noundef %7)
  %8 = load i32, ptr %_order, align 4
  %9 = load i32, ptr %_usedMemInMB, align 8
  %sub16 = shl i32 %9, 4
  %shl17 = add i32 %8, -17
  %add = add i32 %shl17, %sub16
  %10 = load i32, ptr %_restor, align 8
  %shl19 = shl i32 %10, 12
  %add20 = add i32 %add, %shl19
  %conv = trunc i32 %add to i8
  %11 = load ptr, ptr %Cur.i, align 8
  %incdec.ptr.i = getelementptr inbounds i8, ptr %11, i64 1
  store ptr %incdec.ptr.i, ptr %Cur.i, align 8
  store i8 %conv, ptr %11, align 1
  %12 = load ptr, ptr %Cur.i, align 8
  %13 = load ptr, ptr %Lim.i, align 8
  %cmp.i107 = icmp eq ptr %12, %13
  br i1 %cmp.i107, label %if.then.i108, label %_ZN15CByteOutBufWrap9WriteByteEh.exit

if.then.i108:                                     ; preds = %if.end8
  %call.i109 = tail call noundef i32 @_ZN15CByteOutBufWrap5FlushEv(ptr noundef nonnull align 8 dereferenceable(60) %_outStream)
  %.pre = load ptr, ptr %Cur.i, align 8
  br label %_ZN15CByteOutBufWrap9WriteByteEh.exit

_ZN15CByteOutBufWrap9WriteByteEh.exit:            ; preds = %if.end8, %if.then.i108
  %14 = phi ptr [ %12, %if.end8 ], [ %.pre, %if.then.i108 ]
  %shr = lshr i32 %add20, 8
  %conv23 = trunc i32 %shr to i8
  %incdec.ptr.i111 = getelementptr inbounds i8, ptr %14, i64 1
  store ptr %incdec.ptr.i111, ptr %Cur.i, align 8
  store i8 %conv23, ptr %14, align 1
  %15 = load ptr, ptr %Cur.i, align 8
  %16 = load ptr, ptr %Lim.i, align 8
  %cmp.i113 = icmp eq ptr %15, %16
  br i1 %cmp.i113, label %if.then.i114, label %_ZN15CByteOutBufWrap9WriteByteEh.exit116

if.then.i114:                                     ; preds = %_ZN15CByteOutBufWrap9WriteByteEh.exit
  %call.i115 = tail call noundef i32 @_ZN15CByteOutBufWrap5FlushEv(ptr noundef nonnull align 8 dereferenceable(60) %_outStream)
  br label %_ZN15CByteOutBufWrap9WriteByteEh.exit116

_ZN15CByteOutBufWrap9WriteByteEh.exit116:         ; preds = %_ZN15CByteOutBufWrap9WriteByteEh.exit, %if.then.i114
...
cleanup.cont:                                     ; preds = %_ZN15CByteOutBufWrap9WriteByteEh.exit116
  ...
  %18 = load ptr, ptr %_inStream, align 8
  %vtable131 = load ptr, ptr %inStream, align 8
  %vfn132 = getelementptr inbounds ptr, ptr %vtable131, i64 5
  %19 = load ptr, ptr %vfn132, align 8
  %call29133 = call noundef i32 %19(ptr noundef nonnull align 8 dereferenceable(8) %inStream, ptr noundef %18, i32 noundef 1048576, ptr noundef nonnull %size)
  %cmp30.not134 = icmp eq i32 %call29133, 0
  br i1 %cmp30.not134, label %cleanup.cont35.lr.ph, label %cleanup80.thread
...
for.cond43.us:                                    ; preds = %for.body.us
  ...
  %cmp44.not.us = icmp ult i64 %indvars.iv.next146, %23
  br i1 %cmp44.not.us, label %for.body.us, label %for.end.us

for.end.us:                                       ; preds = %for.cond43.us
  %add61.us = add i64 %20, %23
  store i64 %add61.us, ptr %processed, align 8
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %size) #10
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %size) #10
  %24 = load ptr, ptr %_inStream, align 8
  ...
  br i1 %cmp30.not.us, label %cleanup.cont35.us, label %cleanup80.thread

for.body.us:                                      ; preds = %cleanup.cont35.us, %for.cond43.us
  %indvars.iv145 = phi i64 [ %indvars.iv.next146, %for.cond43.us ], [ 0, %cleanup.cont35.us ]
  %26 = load ptr, ptr %_inStream, align 8
  %arrayidx.us = getelementptr inbounds i8, ptr %26, i64 %indvars.iv145
  ...
  %28 = load i32, ptr %Res.i, align 8
  %cmp52.not.us = icmp eq i32 %28, 0
  br i1 %cmp52.not.us, label %for.cond43.us, label %cleanup80.thread

cleanup.cont35:                                   ; preds = %cleanup.cont35.lr.ph, %for.cond.backedge
...
for.body:                                         ; preds = %cleanup.cont35, %for.cond43
  ...
  %34 = load i32, ptr %Res.i, align 8
  %cmp52.not = icmp eq i32 %34, 0
  br i1 %cmp52.not, label %for.cond43, label %cleanup80.thread

for.end:                                          ; preds = %for.cond43
  %35 = load i64, ptr %processed, align 8
  %add61 = add i64 %35, %31
  store i64 %add61, ptr %processed, align 8
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %outSize) #10
  %36 = load i64, ptr %Processed.i, align 8
  %37 = load ptr, ptr %Cur.i, align 8
  ...
  %vtable67 = load ptr, ptr %progress, align 8
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %size) #10
  br i1 %cmp70.not, label %for.cond.backedge, label %cleanup83
...
for.cond.backedge:                                ; preds = %for.end
  ...
  br i1 %cmp30.not, label %cleanup.cont35, label %cleanup80.thread

cleanup80.thread:                                 ; preds = %for.cond.backedge, %for.body, %for.end.us, %for.body.us, %cleanup.cont, %if.then37
  %retval.8.ph = phi i32 [ %call41, %if.then37 ], [ %call29133, %cleanup.cont ], [ %28, %for.body.us ], [ %call29.us, %for.end.us ], [ %34, %for.body ], [ %call29, %for.cond.backedge ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %size) #10
  br label %cleanup83

cleanup83:                                        ; preds = %for.end, %cleanup80.thread
  %retval.8124 = phi i32 [ %retval.8.ph, %cleanup80.thread ], [ %call69, %for.end ]
...
return:                                           ; preds = %cleanup83, %_ZN15CByteOutBufWrap9WriteByteEh.exit116, %if.end5, %if.end, %_ZN9NCompress8NPpmdZip4CBuf5AllocEv.exit
  %retval.10 = phi i32 [ -2147024882, %_ZN9NCompress8NPpmdZip4CBuf5AllocEv.exit ], [ -2147024882, %if.end ], [ -2147024882, %if.end5 ], [ %retval.8124, %cleanup83 ], [ %17, %_ZN15CByteOutBufWrap9WriteByteEh.exit116 ]
  ret i32 %retval.10
}
