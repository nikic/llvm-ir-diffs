...
_ZN14CByteInBufWrap8ReadByteEv.exit:              ; preds = %if.end
  ...
  %.pre261 = load ptr, ptr %Lim.i, align 8, !tbaa !30
  %cmp.not.i.1 = icmp eq ptr %.pre, %.pre261
...
cleanup.cont.split:                               ; preds = %cleanup.cont
  br i1 %tobool36.not, label %while.cond.us219, label %while.cond

while.cond.us219:                                 ; preds = %cleanup.cont.split, %if.end87.us245
  %14 = load ptr, ptr %_outStream, align 8, !tbaa !38
  br label %do.body.us222

do.body.us222:                                    ; preds = %if.end54.us228, %while.cond.us219
  %i45.0.us223 = phi i64 [ 0, %while.cond.us219 ], [ %inc57.us231, %if.end54.us228 ]
  %call47.us224 = call i32 @Ppmd8_DecodeSymbol(ptr noundef nonnull %_ppmd)
  %15 = load i8, ptr %Extra.i, align 8, !tbaa !34, !range !35, !noundef !36
  %tobool50.us225 = icmp ne i8 %15, 0
  %cmp52.us226 = icmp slt i32 %call47.us224, 0
  %or.cond158.us227 = select i1 %tobool50.us225, i1 true, i1 %cmp52.us226
  br i1 %or.cond158.us227, label %do.end.us233, label %if.end54.us228

if.end54.us228:                                   ; preds = %do.body.us222
  %conv55.us229 = trunc i32 %call47.us224 to i8
  %arrayidx56.us230 = getelementptr inbounds i8, ptr %14, i64 %i45.0.us223
  store i8 %conv55.us229, ptr %arrayidx56.us230, align 1, !tbaa !26
  %inc57.us231 = add nuw nsw i64 %i45.0.us223, 1
  %cmp58.not.us232 = icmp eq i64 %inc57.us231, 1048576
  br i1 %cmp58.not.us232, label %do.end.us233, label %do.body.us222, !llvm.loop !39

do.end.us233:                                     ; preds = %if.end54.us228, %do.body.us222
  %cmp52.us226.lcssa = phi i1 [ false, %if.end54.us228 ], [ %cmp52.us226, %do.body.us222 ]
  %i45.1.us236 = phi i64 [ 1048576, %if.end54.us228 ], [ %i45.0.us223, %do.body.us222 ]
  %16 = load i64, ptr %processedSize, align 8, !tbaa !37
  %add59.us237 = add i64 %16, %i45.1.us236
  store i64 %add59.us237, ptr %processedSize, align 8, !tbaa !37
  %17 = load ptr, ptr %_outStream, align 8, !tbaa !38
  %call62.us238 = call noundef i32 @_Z11WriteStreamP20ISequentialOutStreamPKvm(ptr noundef %outStream, ptr noundef %17, i64 noundef %i45.1.us236)
  %cmp63.not.us239 = icmp eq i32 %call62.us238, 0
  br i1 %cmp63.not.us239, label %cleanup.cont68.us240, label %cleanup150

cleanup.cont68.us240:                             ; preds = %do.end.us233
  %18 = load i32, ptr %Res.i, align 4, !tbaa !41
  %cmp71.not.us241 = icmp eq i32 %18, 0
  br i1 %cmp71.not.us241, label %cleanup.cont76.us242, label %cleanup150

cleanup.cont76.us242:                             ; preds = %cleanup.cont68.us240
  %19 = load i8, ptr %Extra.i, align 8, !tbaa !34, !range !35, !noundef !36
  %tobool79.not.us243 = icmp eq i8 %19, 0
  br i1 %tobool79.not.us243, label %if.end81.us244, label %cleanup150

if.end81.us244:                                   ; preds = %cleanup.cont76.us242
  br i1 %cmp52.us226.lcssa, label %if.then83, label %if.end87.us245

if.end87.us245:                                   ; preds = %if.end81.us244
  ...
  br i1 %cmp94.not.us, label %while.cond.us219, label %cleanup150
...
if.then83:                                        ; preds = %if.end81, %if.end81.us244, %if.end81.us
  %.us-phi218 = phi i32 [ %call47.us, %if.end81.us ], [ %call47.us224, %if.end81.us244 ], [ %call47, %if.end81 ]
  %cmp84.not = icmp eq i32 %.us-phi218, -1
...
cleanup141:                                       ; preds = %if.then122
  ...
  %or.cond215 = select i1 %or.cond159.not, i1 %cmp146, i1 false
  br i1 %or.cond215, label %if.end149, label %cleanup150
...
cleanup150:                                       ; preds = %cleanup.cont76, %do.end, %cleanup.cont68, %if.end87, %do.end.us233, %cleanup.cont68.us240, %cleanup.cont76.us242, %if.end87.us245, %cleanup.cont76.us, %cleanup.cont68.us, %do.end.us, %if.then122, %if.then83, %if.end144, %cleanup141, %while.end, %if.end149
  %retval.12 = phi i32 [ 0, %if.end149 ], [ 1, %cleanup141 ], [ %36, %while.end ], [ 1, %if.end144 ], [ 1, %if.then83 ], [ %38, %if.then122 ], [ %12, %cleanup.cont68.us ], [ %call62.us, %do.end.us ], [ 1, %cleanup.cont76.us ], [ %call93.us, %if.end87.us245 ], [ %18, %cleanup.cont68.us240 ], [ %call62.us238, %do.end.us233 ], [ 1, %cleanup.cont76.us242 ], [ %call93, %if.end87 ], [ %30, %cleanup.cont68 ], [ %call62, %do.end ], [ 1, %cleanup.cont76 ]
