...
invoke.cont.i4:                                   ; preds = %_ZN10COutBufferD2Ev.exit
  ...
  %13 = load ptr, ptr %_stream.i5, align 8, !tbaa !21
...
if.then.i.i7:                                     ; preds = %invoke.cont.i4
  %vtable.i.i8 = load ptr, ptr %13, align 8, !tbaa !19
...
invoke.cont.i14:                                  ; preds = %_ZN10COutBufferD2Ev.exit12
  ...
  %19 = load ptr, ptr %_stream.i15, align 8, !tbaa !21
...
if.then.i.i17:                                    ; preds = %invoke.cont.i14
  %vtable.i.i18 = load ptr, ptr %19, align 8, !tbaa !19
...
cleanup98:                                        ; preds = %if.end92, %if.then15.i, %if.else84
  ...
  br i1 %exitcond670.not, label %for.end104, label %for.body71, !llvm.loop !43
...
if.then15.i486:                                   ; preds = %if.then237
  ...
  store i32 %shl.i487, ptr %Range.i, align 8, !tbaa !27
  invoke void @_ZN9NCompress11NRangeCoder8CEncoder8ShiftLowEv(ptr noundef nonnull align 8 dereferenceable(80) %_rangeEncoder)
...
if.then.i497.for.inc256_crit_edge:                ; preds = %if.then.i497
  %.pre671 = load i32, ptr %_pos.i490, align 8, !tbaa !41
  br label %for.inc256
...
if.else262:                                       ; preds = %if.else207, %if.then192, %if.else195, %if.else226, %if.then222, %if.end231
  ...
  store i32 %add.i506, ptr %arrayidx265, align 4, !tbaa !30
...
if.then15.i509:                                   ; preds = %if.else262
  ...
  store i32 %shl.i510, ptr %Range.i, align 8, !tbaa !27
  invoke void @_ZN9NCompress11NRangeCoder8CEncoder8ShiftLowEv(ptr noundef nonnull align 8 dereferenceable(80) %_rangeEncoder)
...
if.then.i514:                                     ; preds = %cleanup324
  %vtable.i515 = load ptr, ptr %164, align 8, !tbaa !19
...
if.then.i.i4.i.i:                                 ; preds = %_ZN10COutBuffer13ReleaseStreamEv.exit.i.i
  %vtable.i.i5.i.i = load ptr, ptr %171, align 8, !tbaa !19
...
if.then.i.i11.i.i:                                ; preds = %_ZN10COutBuffer13ReleaseStreamEv.exit8.i.i
  %vtable.i.i12.i.i = load ptr, ptr %173, align 8, !tbaa !19
...
if.then.i521:                                     ; preds = %ehcleanup339
  %vtable.i522 = load ptr, ptr %179, align 8, !tbaa !19
...
if.then.i.i4.i:                                   ; preds = %_ZN10COutBuffer13ReleaseStreamEv.exit.i
  %vtable.i.i5.i = load ptr, ptr %3, align 8, !tbaa !19
...
if.then.i.i11.i:                                  ; preds = %_ZN10COutBuffer13ReleaseStreamEv.exit8.i
  %vtable.i.i12.i = load ptr, ptr %5, align 8, !tbaa !19
...
if.end.i56.i:                                     ; preds = %if.then23.i
  ...
  store ptr %incdec.ptr.i57.i, ptr %_rangeDecoder, align 8, !tbaa !60
...
invoke.cont101.thread:                            ; preds = %call.i.i.noexc, %if.end.i.i
  ...
  %conv28.i375 = zext i8 %retval.0.i55.sink.i.ph to i32
...
for.cond52.backedge:                              ; preds = %invoke.cont101.thread, %for.end90, %if.then.i226, %cleanup153.thread
  %processedBytes.0.be = phi i32 [ %add, %for.end90 ], [ %add151, %cleanup153.thread ], [ %add285, %if.then.i226 ], [ %add285, %invoke.cont101.thread ]
  %prevByte.0.be = phi i8 [ %83, %for.end90 ], [ %conv147, %cleanup153.thread ], [ %83, %if.then.i226 ], [ %83, %invoke.cont101.thread ]
  br label %for.cond52
...
if.then.if.end3_crit_edge.i234:                   ; preds = %call.i232.noexc
  %.pre.i235 = load ptr, ptr %cond-lvalue, align 8, !tbaa !60
...
for.inc123:                                       ; preds = %if.then104, %if.then.if.end3_crit_edge.i234
  ...
  store ptr %incdec.ptr.i237, ptr %cond-lvalue, align 8, !tbaa !60
...
if.then.if.end3_crit_edge.i234.1:                 ; preds = %call.i232.noexc.1
  %.pre.i235.1 = load ptr, ptr %cond-lvalue, align 8, !tbaa !60
...
for.inc123.1:                                     ; preds = %if.then.if.end3_crit_edge.i234.1, %for.inc123
  ...
  store ptr %incdec.ptr.i237.1, ptr %cond-lvalue, align 8, !tbaa !60
...
if.then.if.end3_crit_edge.i234.2:                 ; preds = %call.i232.noexc.2
  %.pre.i235.2 = load ptr, ptr %cond-lvalue, align 8, !tbaa !60
...
for.inc123.2:                                     ; preds = %if.then.if.end3_crit_edge.i234.2, %for.inc123.1
  ...
  store ptr %incdec.ptr.i237.2, ptr %cond-lvalue, align 8, !tbaa !60
...
if.then.if.end3_crit_edge.i234.3:                 ; preds = %call.i232.noexc.3
  %.pre.i235.3 = load ptr, ptr %cond-lvalue, align 8, !tbaa !60
...
for.inc123.3:                                     ; preds = %if.then.if.end3_crit_edge.i234.3, %for.inc123.2
  ...
  store ptr %incdec.ptr.i237.3, ptr %cond-lvalue, align 8, !tbaa !60
...
cleanup170:                                       ; preds = %invoke.cont61, %call.i232.noexc, %call.i232.noexc.1, %call.i232.noexc.2, %call.i232.noexc.3, %if.then78
  %retval.9 = phi i32 [ %call.i218219, %if.then78 ], [ %call62, %invoke.cont61 ], [ 1, %call.i232.noexc ], [ 1, %call.i232.noexc.1 ], [ 1, %call.i232.noexc.2 ], [ 1, %call.i232.noexc.3 ]
...
if.then.i.i18.i:                                  ; preds = %_ZN9NCompress11NRangeCoder8CDecoder13ReleaseStreamEv.exit.i
  %vtable.i.i19.i = load ptr, ptr %9, align 8, !tbaa !19
...
for.cond.i15:                                     ; preds = %if.end
  ...
  %33 = load i8, ptr %arrayidx.1.i16, align 1, !tbaa !34
...
for.cond.1.i18:                                   ; preds = %for.cond.i15
  ...
  %35 = load i8, ptr %arrayidx.2.i19, align 2, !tbaa !34
...
for.cond.2.i21:                                   ; preds = %for.cond.1.i18
  ...
  %37 = load i8, ptr %arrayidx.3.i22, align 1, !tbaa !34
...
for.cond.3.i24:                                   ; preds = %for.cond.2.i21
  ...
  %39 = load i8, ptr %arrayidx.4.i25, align 4, !tbaa !34
...
for.cond.4.i27:                                   ; preds = %for.cond.3.i24
  ...
  %41 = load i8, ptr %arrayidx.5.i28, align 1, !tbaa !34
...
for.cond.5.i30:                                   ; preds = %for.cond.4.i27
  ...
  %43 = load i8, ptr %arrayidx.6.i31, align 2, !tbaa !34
...
for.cond.6.i33:                                   ; preds = %for.cond.5.i30
  ...
  %45 = load i8, ptr %arrayidx.7.i34, align 1, !tbaa !34
...
for.cond.7.i36:                                   ; preds = %for.cond.6.i33
  ...
  %47 = load i8, ptr %arrayidx.8.i37, align 4, !tbaa !34
...
for.cond.8.i39:                                   ; preds = %for.cond.7.i36
  ...
  %49 = load i8, ptr %arrayidx.9.i40, align 1, !tbaa !34
...
for.cond.9.i42:                                   ; preds = %for.cond.8.i39
  ...
  %51 = load i8, ptr %arrayidx.10.i43, align 2, !tbaa !34
...
for.cond.10.i45:                                  ; preds = %for.cond.9.i42
  ...
  %53 = load i8, ptr %arrayidx.11.i46, align 1, !tbaa !34
...
for.cond.11.i48:                                  ; preds = %for.cond.10.i45
  ...
  %55 = load i8, ptr %arrayidx.12.i49, align 4, !tbaa !34
...
for.cond.12.i51:                                  ; preds = %for.cond.11.i48
  ...
  %57 = load i8, ptr %arrayidx.13.i52, align 1, !tbaa !34
...
for.cond.13.i54:                                  ; preds = %for.cond.12.i51
  ...
  %59 = load i8, ptr %arrayidx.14.i55, align 2, !tbaa !34
...
_ZeqRK4GUIDS1_.exit61:                            ; preds = %for.cond.13.i54
  ...
  %61 = load i8, ptr %arrayidx.15.i58, align 1, !tbaa !34
...
invoke.cont.i13:                                  ; preds = %_ZN9CInBufferD2Ev.exit
  ...
  %18 = load ptr, ptr %_stream.i14, align 8, !tbaa !57
...
if.then.i.i16:                                    ; preds = %invoke.cont.i13
  %vtable.i.i17 = load ptr, ptr %18, align 8, !tbaa !19
...
invoke.cont.i23:                                  ; preds = %_ZN9CInBufferD2Ev.exit21
  ...
  %24 = load ptr, ptr %_stream.i24, align 8, !tbaa !57
...
if.then.i.i26:                                    ; preds = %invoke.cont.i23
  %vtable.i.i27 = load ptr, ptr %24, align 8, !tbaa !19
