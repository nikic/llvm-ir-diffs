...
entry:
  ...
  %cmp = icmp eq ptr %0, null
  %_propsWereSet = getelementptr inbounds %"class.NCompress::NLzma::CDecoder", ptr %this, i64 0, i32 13
  %1 = load i8, ptr %_propsWereSet, align 8, !range !42
...
if.end19:                                         ; preds = %if.then11, %for.cond
  %11 = load i64, ptr %dicPos, align 8, !tbaa !44
  %sub23 = sub i64 %next.0, %11
  %12 = load i8, ptr %_outSizeDefined, align 1, !tbaa !28, !range !42, !noundef !45
...
if.then28:                                        ; preds = %if.then25
  %15 = load i8, ptr %FinishStream, align 8, !tbaa !31, !range !42, !noundef !45
...
if.end33:                                         ; preds = %if.then28, %if.then25, %if.end19
  ...
  %25 = load i8, ptr %_outSizeDefined, align 1, !tbaa !28, !range !42, !noundef !45
...
cleanup153.thread:                                ; preds = %if.then135, %cleanup130, %if.end92, %if.then126
  %retval.8.ph = phi i32 [ %cond128, %if.then126 ], [ 1, %if.end92 ], [ %call142, %if.then135 ], [ %call79, %cleanup130 ]
...
if.then2.if.end10_crit_edge:                      ; preds = %if.then2
  ...
  %.pre79 = load i32, ptr %_inPos, align 8, !tbaa !34
  br label %if.end10
...
if.end10:                                         ; preds = %if.then2.if.end10_crit_edge, %do.body
  ...
  %8 = load i8, ptr %_outSizeDefined, align 1, !tbaa !28, !range !42, !noundef !45
...
cleanup51:                                        ; preds = %if.end38
  ...
  br i1 %or.cond77, label %return, label %do.body, !llvm.loop !53
...
while.body.us.preheader:                          ; preds = %if.end3
  ...
  %_inBufSizeAllocated = getelementptr inbounds %"class.NCompress::NLzma::CDecoder", ptr %this, i64 0, i32 19
  %_inSizeProcessed = getelementptr inbounds %"class.NCompress::NLzma::CDecoder", ptr %this, i64 0, i32 17
  %.pre73 = load i32, ptr %_inPos, align 8, !tbaa !34
...
while.body.us:                                    ; preds = %while.body.us.preheader, %if.end23.us
  ...
  %.pre76 = load ptr, ptr %_inBuf.i, align 8, !tbaa !35
...
if.then6.us:                                      ; preds = %while.body.us
  ...
  %8 = load i32, ptr %_inBufSizeAllocated, align 8, !tbaa !37
...
cleanup.cont18.us:                                ; preds = %if.then6.us
  %10 = load i32, ptr %_inSize, align 4, !tbaa !33
...
cleanup.cont18.us.if.end23.us_crit_edge:          ; preds = %cleanup.cont18.us
  %.pre74 = load i32, ptr %_inPos, align 8, !tbaa !34
  %.pre75 = load ptr, ptr %_inBuf.i, align 8, !tbaa !35
...
if.end23.us:                                      ; preds = %cleanup.cont18.us.if.end23.us_crit_edge, %while.body.us
  ...
  %14 = load i32, ptr %_inPos, align 8, !tbaa !34
  %add.us = add i32 %14, %spec.select.us
  store i32 %add.us, ptr %_inPos, align 8, !tbaa !34
  %15 = load i64, ptr %_inSizeProcessed, align 8, !tbaa !32
...
while.body:                                       ; preds = %while.body.preheader, %if.end23
  ...
  %16 = load i32, ptr %_inPos78, align 8, !tbaa !34
  %17 = load i32, ptr %_inSize79, align 4, !tbaa !33
  %cmp5 = icmp eq i32 %16, %17
  %.pre72 = load ptr, ptr %_inBuf.i, align 8, !tbaa !35
  br i1 %cmp5, label %if.then6, label %if.end23

if.then6:                                         ; preds = %while.body
  store i32 0, ptr %_inSize79, align 4, !tbaa !33
  store i32 0, ptr %_inPos78, align 8, !tbaa !34
  %18 = load ptr, ptr %_inStream80, align 8, !tbaa !36
  %19 = load i32, ptr %_inBufSizeAllocated81, align 8, !tbaa !37
  %vtable = load ptr, ptr %18, align 8, !tbaa !10
  %vfn = getelementptr inbounds ptr, ptr %vtable, i64 5
...
cleanup.cont18:                                   ; preds = %if.then6
  %21 = load i32, ptr %_inSize79, align 4, !tbaa !33
...
cleanup.cont18.if.end23_crit_edge:                ; preds = %cleanup.cont18
  %.pre = load i32, ptr %_inPos78, align 8, !tbaa !34
  %.pre71 = load ptr, ptr %_inBuf.i, align 8, !tbaa !35
  br label %if.end23
...
if.end23:                                         ; preds = %cleanup.cont18.if.end23_crit_edge, %while.body
  ...
  %25 = load i32, ptr %_inPos78, align 8, !tbaa !34
  %add = add i32 %25, %spec.select
  store i32 %add, ptr %_inPos78, align 8, !tbaa !34
  %26 = load i64, ptr %_inSizeProcessed82, align 8, !tbaa !32
  %add33 = add i64 %26, %conv
  store i64 %add33, ptr %_inSizeProcessed82, align 8, !tbaa !32
  %sub34 = sub i32 %size.addr.063, %spec.select
  %add.ptr36 = getelementptr inbounds i8, ptr %data.addr.064, i64 %conv
  %27 = load i32, ptr %processedSize, align 4, !tbaa !52
...
for.cond.i63:                                     ; preds = %if.end
  ...
  %33 = load i8, ptr %arrayidx.1.i64, align 1, !tbaa !55
...
for.cond.1.i66:                                   ; preds = %for.cond.i63
  ...
  %35 = load i8, ptr %arrayidx.2.i67, align 2, !tbaa !55
...
for.cond.2.i69:                                   ; preds = %for.cond.1.i66
  ...
  %37 = load i8, ptr %arrayidx.3.i70, align 1, !tbaa !55
...
for.cond.3.i72:                                   ; preds = %for.cond.2.i69
  ...
  %39 = load i8, ptr %arrayidx.4.i73, align 4, !tbaa !55
...
for.cond.4.i75:                                   ; preds = %for.cond.3.i72
  ...
  %41 = load i8, ptr %arrayidx.5.i76, align 1, !tbaa !55
...
for.cond.5.i78:                                   ; preds = %for.cond.4.i75
  ...
  %43 = load i8, ptr %arrayidx.6.i79, align 2, !tbaa !55
...
for.cond.6.i81:                                   ; preds = %for.cond.5.i78
  ...
  %45 = load i8, ptr %arrayidx.7.i82, align 1, !tbaa !55
...
for.cond.7.i84:                                   ; preds = %for.cond.6.i81
  ...
  %47 = load i8, ptr %arrayidx.8.i85, align 4, !tbaa !55
...
for.cond.8.i87:                                   ; preds = %for.cond.7.i84
  ...
  %49 = load i8, ptr %arrayidx.9.i88, align 1, !tbaa !55
...
for.cond.9.i90:                                   ; preds = %for.cond.8.i87
  ...
  %51 = load i8, ptr %arrayidx.10.i91, align 2, !tbaa !55
...
for.cond.10.i93:                                  ; preds = %for.cond.9.i90
  ...
  %53 = load i8, ptr %arrayidx.11.i94, align 1, !tbaa !55
...
for.cond.11.i96:                                  ; preds = %for.cond.10.i93
  ...
  %55 = load i8, ptr %arrayidx.12.i97, align 4, !tbaa !55
...
for.cond.12.i99:                                  ; preds = %for.cond.11.i96
  ...
  %57 = load i8, ptr %arrayidx.13.i100, align 1, !tbaa !55
...
for.cond.13.i102:                                 ; preds = %for.cond.12.i99
  ...
  %59 = load i8, ptr %arrayidx.14.i103, align 2, !tbaa !55
...
_ZeqRK4GUIDS1_.exit109:                           ; preds = %for.cond.13.i102
  ...
  %61 = load i8, ptr %arrayidx.15.i106, align 1, !tbaa !55
...
for.cond.i112:                                    ; preds = %if.end9
  ...
  %64 = load i8, ptr %arrayidx.1.i113, align 1, !tbaa !55
...
for.cond.1.i115:                                  ; preds = %for.cond.i112
  ...
  %66 = load i8, ptr %arrayidx.2.i116, align 2, !tbaa !55
...
for.cond.2.i118:                                  ; preds = %for.cond.1.i115
  ...
  %68 = load i8, ptr %arrayidx.3.i119, align 1, !tbaa !55
...
for.cond.3.i121:                                  ; preds = %for.cond.2.i118
  ...
  %70 = load i8, ptr %arrayidx.4.i122, align 4, !tbaa !55
...
for.cond.4.i124:                                  ; preds = %for.cond.3.i121
  ...
  %72 = load i8, ptr %arrayidx.5.i125, align 1, !tbaa !55
...
for.cond.5.i127:                                  ; preds = %for.cond.4.i124
  ...
  %74 = load i8, ptr %arrayidx.6.i128, align 2, !tbaa !55
...
for.cond.6.i130:                                  ; preds = %for.cond.5.i127
  ...
  %76 = load i8, ptr %arrayidx.7.i131, align 1, !tbaa !55
...
for.cond.7.i133:                                  ; preds = %for.cond.6.i130
  ...
  %78 = load i8, ptr %arrayidx.8.i134, align 4, !tbaa !55
...
for.cond.8.i136:                                  ; preds = %for.cond.7.i133
  ...
  %80 = load i8, ptr %arrayidx.9.i137, align 1, !tbaa !55
...
for.cond.9.i139:                                  ; preds = %for.cond.8.i136
  ...
  %82 = load i8, ptr %arrayidx.10.i140, align 2, !tbaa !55
...
for.cond.10.i142:                                 ; preds = %for.cond.9.i139
  ...
  %84 = load i8, ptr %arrayidx.11.i143, align 1, !tbaa !55
...
for.cond.11.i145:                                 ; preds = %for.cond.10.i142
  ...
  %86 = load i8, ptr %arrayidx.12.i146, align 4, !tbaa !55
...
for.cond.12.i148:                                 ; preds = %for.cond.11.i145
  ...
  %88 = load i8, ptr %arrayidx.13.i149, align 1, !tbaa !55
...
for.cond.13.i151:                                 ; preds = %for.cond.12.i148
  ...
  %90 = load i8, ptr %arrayidx.14.i152, align 2, !tbaa !55
...
_ZeqRK4GUIDS1_.exit158:                           ; preds = %for.cond.13.i151
  ...
  %92 = load i8, ptr %arrayidx.15.i155, align 1, !tbaa !55
...
for.cond.i161:                                    ; preds = %if.end16
  ...
  %95 = load i8, ptr %arrayidx.1.i162, align 1, !tbaa !55
...
for.cond.1.i164:                                  ; preds = %for.cond.i161
  ...
  %97 = load i8, ptr %arrayidx.2.i165, align 2, !tbaa !55
...
for.cond.2.i167:                                  ; preds = %for.cond.1.i164
  ...
  %99 = load i8, ptr %arrayidx.3.i168, align 1, !tbaa !55
...
for.cond.3.i170:                                  ; preds = %for.cond.2.i167
  ...
  %101 = load i8, ptr %arrayidx.4.i171, align 4, !tbaa !55
...
for.cond.4.i173:                                  ; preds = %for.cond.3.i170
  ...
  %103 = load i8, ptr %arrayidx.5.i174, align 1, !tbaa !55
...
for.cond.5.i176:                                  ; preds = %for.cond.4.i173
  ...
  %105 = load i8, ptr %arrayidx.6.i177, align 2, !tbaa !55
...
for.cond.6.i179:                                  ; preds = %for.cond.5.i176
  ...
  %107 = load i8, ptr %arrayidx.7.i180, align 1, !tbaa !55
...
for.cond.7.i182:                                  ; preds = %for.cond.6.i179
  ...
  %109 = load i8, ptr %arrayidx.8.i183, align 4, !tbaa !55
...
for.cond.8.i185:                                  ; preds = %for.cond.7.i182
  ...
  %111 = load i8, ptr %arrayidx.9.i186, align 1, !tbaa !55
...
for.cond.9.i188:                                  ; preds = %for.cond.8.i185
  ...
  %113 = load i8, ptr %arrayidx.10.i189, align 2, !tbaa !55
...
for.cond.10.i191:                                 ; preds = %for.cond.9.i188
  ...
  %115 = load i8, ptr %arrayidx.11.i192, align 1, !tbaa !55
...
for.cond.11.i194:                                 ; preds = %for.cond.10.i191
  ...
  %117 = load i8, ptr %arrayidx.12.i195, align 4, !tbaa !55
...
for.cond.12.i197:                                 ; preds = %for.cond.11.i194
  ...
  %119 = load i8, ptr %arrayidx.13.i198, align 1, !tbaa !55
...
for.cond.13.i200:                                 ; preds = %for.cond.12.i197
  ...
  %121 = load i8, ptr %arrayidx.14.i201, align 2, !tbaa !55
...
_ZeqRK4GUIDS1_.exit207:                           ; preds = %for.cond.13.i200
  ...
  %123 = load i8, ptr %arrayidx.15.i204, align 1, !tbaa !55
