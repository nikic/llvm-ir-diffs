...
invoke.cont:                                      ; preds = %entry
  store ptr getelementptr inbounds ({ [14 x ptr], [8 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress8NDeflate8NDecoder11CCOMCoder64E, i64 0, inrange i32 0, i64 2), ptr %call, align 8, !tbaa !5
  %add.ptr.i = getelementptr inbounds i8, ptr %call, i64 8
  store ptr getelementptr inbounds ({ [14 x ptr], [8 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress8NDeflate8NDecoder11CCOMCoder64E, i64 0, inrange i32 1, i64 2), ptr %add.ptr.i, align 8, !tbaa !5
  %add.ptr2.i = getelementptr inbounds i8, ptr %call, i64 16
  store ptr getelementptr inbounds ({ [14 x ptr], [8 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress8NDeflate8NDecoder11CCOMCoder64E, i64 0, inrange i32 2, i64 2), ptr %add.ptr2.i, align 8, !tbaa !5
  %add.ptr3.i = getelementptr inbounds i8, ptr %call, i64 24
  store ptr getelementptr inbounds ({ [14 x ptr], [8 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress8NDeflate8NDecoder11CCOMCoder64E, i64 0, inrange i32 3, i64 2), ptr %add.ptr3.i, align 8, !tbaa !5
  %add.ptr4.i = getelementptr inbounds i8, ptr %call, i64 32
  store ptr getelementptr inbounds ({ [14 x ptr], [8 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress8NDeflate8NDecoder11CCOMCoder64E, i64 0, inrange i32 4, i64 2), ptr %add.ptr4.i, align 8, !tbaa !5
  ret ptr %call
...
invoke.cont:                                      ; preds = %entry
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress8NDeflate8NEncoder11CCOMCoder64E, i64 0, inrange i32 0, i64 2), ptr %call, align 8, !tbaa !5
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress8NDeflate8NEncoder11CCOMCoder64E, i64 0, inrange i32 1, i64 2), ptr %0, align 8, !tbaa !5
  ret ptr %call
