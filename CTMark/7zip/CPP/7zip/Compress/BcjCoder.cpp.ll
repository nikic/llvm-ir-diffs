; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Compress/BcjCoder.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Compress/BcjCoder.cpp"
...
define dso_local noundef i32 @_ZN16CBCJ_x86_Encoder9SubFilterEPhj(ptr noundef nonnull align 8 dereferenceable(20) %this, ptr noundef %data, i32 noundef %size) unnamed_addr #0 align 2 {
entry:
  ...
  %call = tail call i64 @x86_Convert(ptr noundef %data, i64 noundef %conv, i32 noundef %0, ptr noundef nonnull %add.ptr, i32 noundef 1)
...
; Function Attrs: mustprogress uwtable
define dso_local noundef i32 @_ZN16CBCJ_x86_Decoder9SubFilterEPhj(ptr noundef nonnull align 8 dereferenceable(20) %this, ptr noundef %data, i32 noundef %size) unnamed_addr #0 align 2 {
entry:
  %conv = zext i32 %size to i64
  %_bufferPos = getelementptr inbounds %class.CBranchConverter, ptr %this, i64 0, i32 2
  %0 = load i32, ptr %_bufferPos, align 4, !tbaa !5
  %add.ptr = getelementptr inbounds i8, ptr %this, i64 16
  %call = tail call i64 @x86_Convert(ptr noundef %data, i64 noundef %conv, i32 noundef %0, ptr noundef nonnull %add.ptr, i32 noundef 0)
  %conv2 = trunc i64 %call to i32
  ret i32 %conv2
}
...
define linkonce_odr dso_local void @_ZN16CBCJ_x86_EncoderD0Ev(ptr noundef nonnull align 8 dereferenceable(20) %this) unnamed_addr #3 comdat align 2 {
entry:
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZN16CBCJ_x86_Encoder7SubInitEv(ptr noundef nonnull align 8 dereferenceable(20) %this) unnamed_addr #0 comdat align 2 {
entry:
  %add.ptr = getelementptr inbounds i8, ptr %this, i64 16
  store i32 0, ptr %add.ptr, align 8, !tbaa !19
  ret void
}
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr dso_local void @_ZN16CBCJ_x86_DecoderD0Ev(ptr noundef nonnull align 8 dereferenceable(20) %this) unnamed_addr #3 comdat align 2 {
entry:
  tail call void @_ZdlPv(ptr noundef nonnull %this) #7
  ret void
}
...
; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local void @_ZN16CBCJ_x86_Decoder7SubInitEv(ptr noundef nonnull align 8 dereferenceable(20) %this) unnamed_addr #2 comdat align 2 {
entry:
  %add.ptr = getelementptr inbounds i8, ptr %this, i64 16
  store i32 0, ptr %add.ptr, align 8, !tbaa !19
  ret void
