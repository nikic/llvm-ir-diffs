...
entry._ZN5NBitl8CDecoderI9CInBufferE9NormalizeEv.exit_crit_edge.i33: ; preds = %for.body
  %.pre.i35 = load i32, ptr %m_NormalValue.i, align 4, !tbaa !26
  br label %_ZN5NBitl8CDecoderI9CInBufferE8ReadBitsEj.exit69

for.body.i.i46:                                   ; preds = %for.body, %if.end.i.i52
  %11 = load ptr, ptr %m_Stream.i.i41, align 8, !tbaa !28
  %12 = load ptr, ptr %_bufferLimit.i.i.i42, align 8, !tbaa !29
...
if.then.if.end3_crit_edge.i.i.i65:                ; preds = %if.then.i.i.i48
  %.pre.i.i.i66 = load ptr, ptr %m_Stream.i.i41, align 8, !tbaa !28
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i.i67:      ; preds = %if.then.if.end3_crit_edge.i.i.i65, %for.body.i.i46
  ...
  store ptr %incdec.ptr.i.i.i68, ptr %m_Stream.i.i41, align 8, !tbaa !28
  %14 = load i8, ptr %13, align 1, !tbaa !30
  br label %if.end.i.i52

if.then.i.i50:                                    ; preds = %if.then.i.i.i48
  %15 = load i32, ptr %NumExtraBytes.i.i43, align 8, !tbaa !31
  %inc.i.i51 = add i32 %15, 1
  store i32 %inc.i.i51, ptr %NumExtraBytes.i.i43, align 8, !tbaa !31
  br label %if.end.i.i52
...
if.end.i.i52:                                     ; preds = %if.then.i.i50, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i67
  ...
  store i32 %or.i.i57, ptr %m_NormalValue.i, align 4, !tbaa !26
  %18 = load i32, ptr %m_Value.i.i45, align 4, !tbaa !32
  ...
  %19 = load i8, ptr %arrayidx.i.i60, align 1, !tbaa !30
  %conv5.i.i61 = zext i8 %19 to i32
  %or6.i.i62 = or i32 %shl4.i.i58, %conv5.i.i61
  store i32 %or6.i.i62, ptr %m_Value.i.i45, align 4, !tbaa !32
  %sub9.i.i63 = add i32 %16, -8
  store i32 %sub9.i.i63, ptr %m_InBitStream, align 8, !tbaa !23
  %cmp.i.i64 = icmp ugt i32 %sub9.i.i63, 7
  br i1 %cmp.i.i64, label %for.body.i.i46, label %_ZN5NBitl8CDecoderI9CInBufferE8ReadBitsEj.exit69, !llvm.loop !33
...
_ZN5NBitl8CDecoderI9CInBufferE8ReadBitsEj.exit69: ; preds = %if.end.i.i52, %entry._ZN5NBitl8CDecoderI9CInBufferE9NormalizeEv.exit_crit_edge.i33
  ...
  store i32 %add.i.i38, ptr %m_InBitStream, align 8, !tbaa !23
  %shr.i.i39 = lshr i32 %21, 4
  store i32 %shr.i.i39, ptr %m_NormalValue.i, align 4, !tbaa !26
...
for.body.i.i85:                                   ; preds = %_ZN5NBitl8CDecoderI9CInBufferE8ReadBitsEj.exit69, %if.end.i.i91
  %22 = load ptr, ptr %m_Stream.i.i41, align 8, !tbaa !28
  %23 = load ptr, ptr %_bufferLimit.i.i.i42, align 8, !tbaa !29
...
if.then.if.end3_crit_edge.i.i.i104:               ; preds = %if.then.i.i.i87
  %.pre.i.i.i105 = load ptr, ptr %m_Stream.i.i41, align 8, !tbaa !28
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i.i106:     ; preds = %if.then.if.end3_crit_edge.i.i.i104, %for.body.i.i85
  ...
  store ptr %incdec.ptr.i.i.i107, ptr %m_Stream.i.i41, align 8, !tbaa !28
  %25 = load i8, ptr %24, align 1, !tbaa !30
  br label %if.end.i.i91

if.then.i.i89:                                    ; preds = %if.then.i.i.i87
  %26 = load i32, ptr %NumExtraBytes.i.i43, align 8, !tbaa !31
  %inc.i.i90 = add i32 %26, 1
  store i32 %inc.i.i90, ptr %NumExtraBytes.i.i43, align 8, !tbaa !31
  br label %if.end.i.i91
...
if.end.i.i91:                                     ; preds = %if.then.i.i89, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i106
  ...
  store i32 %or.i.i96, ptr %m_NormalValue.i, align 4, !tbaa !26
  %29 = load i32, ptr %m_Value.i.i45, align 4, !tbaa !32
  ...
  %30 = load i8, ptr %arrayidx.i.i99, align 1, !tbaa !30
  %conv5.i.i100 = zext i8 %30 to i32
  %or6.i.i101 = or i32 %shl4.i.i97, %conv5.i.i100
  store i32 %or6.i.i101, ptr %m_Value.i.i45, align 4, !tbaa !32
  %sub9.i.i102 = add i32 %27, -8
  store i32 %sub9.i.i102, ptr %m_InBitStream, align 8, !tbaa !23
  %cmp.i.i103 = icmp ugt i32 %sub9.i.i102, 7
  br i1 %cmp.i.i103, label %for.body.i.i85, label %_ZN5NBitl8CDecoderI9CInBufferE8ReadBitsEj.exit108, !llvm.loop !33
...
_ZN5NBitl8CDecoderI9CInBufferE8ReadBitsEj.exit108: ; preds = %if.end.i.i91, %_ZN5NBitl8CDecoderI9CInBufferE8ReadBitsEj.exit69
  ...
  store i32 %add.i.i77, ptr %m_InBitStream, align 8, !tbaa !23
  %shr.i.i78 = lshr i32 %32, 4
  store i32 %shr.i.i78, ptr %m_NormalValue.i, align 4, !tbaa !26
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end115
  ...
  %.pr.i.i.pre358 = load i32, ptr %m_InBitStream, align 8, !tbaa !23
...
invoke.cont23.if.end31_crit_edge:                 ; preds = %invoke.cont23
  %.pr.i.i.pre = load i32, ptr %m_InBitStream, align 8, !tbaa !23
  br label %if.end31
...
if.then.if.end3_crit_edge.i.i.i209:               ; preds = %call.i.i.i.noexc213
  %.pre.i.i.i210 = load ptr, ptr %m_Stream.i, align 8, !tbaa !28
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i.i211:     ; preds = %if.then.if.end3_crit_edge.i.i.i209, %for.body.i.i191
  ...
  store ptr %incdec.ptr.i.i.i212, ptr %m_Stream.i, align 8, !tbaa !28
...
if.then.i.i194:                                   ; preds = %call.i.i.i.noexc213
  ...
  store i32 %inc.i.i195, ptr %NumExtraBytes.i.i, align 8, !tbaa !31
  br label %if.end.i.i196
...
if.end.i.i196:                                    ; preds = %if.then.i.i194, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i211
  ...
  store i32 %or.i.i201, ptr %m_NormalValue.i, align 4, !tbaa !26
  ...
  %33 = load i8, ptr %arrayidx.i.i204, align 1, !tbaa !30
  %conv5.i.i205 = zext i8 %33 to i32
  %or6.i.i206 = or i32 %shl4.i.i202, %conv5.i.i205
  store i32 %or6.i.i206, ptr %m_Value.i.i, align 4, !tbaa !32
  %sub9.i.i207 = add i32 %30, -8
  store i32 %sub9.i.i207, ptr %m_InBitStream, align 8, !tbaa !23
  %cmp.i.i208 = icmp ugt i32 %sub9.i.i207, 7
  br i1 %cmp.i.i208, label %for.body.i.i191, label %invoke.cont39, !llvm.loop !33
...
invoke.cont39:                                    ; preds = %if.end.i.i196, %if.then36
  ...
  store i32 %add.i.i183, ptr %m_InBitStream, align 8, !tbaa !23
  %shr.i.i184 = lshr i32 %35, %24
  store i32 %shr.i.i184, ptr %m_NormalValue.i, align 4, !tbaa !26
...
entry._ZN5NBitl8CDecoderI9CInBufferE9NormalizeEv.exit_crit_edge.i218: ; preds = %if.then58
  %.pre.i220 = load i32, ptr %m_NormalValue.i, align 4, !tbaa !26
...
if.then.if.end3_crit_edge.i.i.i249:               ; preds = %call.i.i.i.noexc253
  %.pre.i.i.i250 = load ptr, ptr %m_Stream.i, align 8, !tbaa !28
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i.i251:     ; preds = %if.then.if.end3_crit_edge.i.i.i249, %for.body.i.i231
  ...
  store ptr %incdec.ptr.i.i.i252, ptr %m_Stream.i, align 8, !tbaa !28
...
if.then.i.i234:                                   ; preds = %call.i.i.i.noexc253
  ...
  store i32 %inc.i.i235, ptr %NumExtraBytes.i.i, align 8, !tbaa !31
  br label %if.end.i.i236
...
if.end.i.i236:                                    ; preds = %if.then.i.i234, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i251
  ...
  store i32 %or.i.i241, ptr %m_NormalValue.i, align 4, !tbaa !26
  ...
  %49 = load i8, ptr %arrayidx.i.i244, align 1, !tbaa !30
  %conv5.i.i245 = zext i8 %49 to i32
  %or6.i.i246 = or i32 %shl4.i.i242, %conv5.i.i245
  store i32 %or6.i.i246, ptr %m_Value.i.i, align 4, !tbaa !32
  %sub9.i.i247 = add i32 %46, -8
  store i32 %sub9.i.i247, ptr %m_InBitStream, align 8, !tbaa !23
  %cmp.i.i248 = icmp ugt i32 %sub9.i.i247, 7
  br i1 %cmp.i.i248, label %for.body.i.i231, label %invoke.cont61, !llvm.loop !33
...
invoke.cont61:                                    ; preds = %if.end.i.i236, %entry._ZN5NBitl8CDecoderI9CInBufferE9NormalizeEv.exit_crit_edge.i218
  ...
  store i32 %add.i.i223, ptr %m_InBitStream, align 8, !tbaa !23
  %shr.i.i224 = lshr i32 %51, 8
  store i32 %shr.i.i224, ptr %m_NormalValue.i, align 4, !tbaa !26
...
while.body68:                                     ; preds = %if.end64, %invoke.cont70
  ...
  %55 = load i32, ptr %_pos.i306, align 8, !tbaa !18
  %inc.i = add i32 %55, 1
  ...
  %57 = load i32, ptr %_limitPos.i310, align 4, !tbaa !55
...
if.then72:                                        ; preds = %while.end
  %60 = load i32, ptr %_pos.i306, align 8, !tbaa !18
  %61 = xor i32 %add, -1
...
if.end7.i260:                                     ; preds = %if.end.i, %if.then72
  ...
  %64 = load i32, ptr %_limitPos.i310, align 4, !tbaa !55
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load368 = load <16 x i8>, ptr %74, align 1, !tbaa !30
  store <16 x i8> %wide.load, ptr %next.gep366, align 1, !tbaa !30
  %75 = getelementptr i8, ptr %next.gep366, i64 16
  store <16 x i8> %wide.load368, ptr %75, align 1, !tbaa !30
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load387 = load <8 x i8>, ptr %next.gep385, align 1, !tbaa !30
  store <8 x i8> %wide.load387, ptr %next.gep386, align 1, !tbaa !30
...
do.body23.i:                                      ; preds = %do.body23.i.preheader, %do.cond39.i
  ...
  %91 = load i8, ptr %arrayidx.i264, align 1, !tbaa !30
  %92 = load i32, ptr %_pos.i306, align 8, !tbaa !18
  ...
  %94 = load i32, ptr %_limitPos.i310, align 4, !tbaa !55
...
if.then.if.end3_crit_edge.i.i.i299:               ; preds = %call.i.i.i.noexc303
  %.pre.i.i.i300 = load ptr, ptr %m_Stream.i, align 8, !tbaa !28
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i.i301:     ; preds = %if.then.if.end3_crit_edge.i.i.i299, %for.body.i.i281
  ...
  store ptr %incdec.ptr.i.i.i302, ptr %m_Stream.i, align 8, !tbaa !28
...
if.then.i.i284:                                   ; preds = %call.i.i.i.noexc303
  ...
  store i32 %inc.i.i285, ptr %NumExtraBytes.i.i, align 8, !tbaa !31
  br label %if.end.i.i286
...
if.end.i.i286:                                    ; preds = %if.then.i.i284, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i301
  ...
  store i32 %or.i.i291, ptr %m_NormalValue.i, align 4, !tbaa !26
  ...
  %106 = load i8, ptr %arrayidx.i.i294, align 1, !tbaa !30
  %conv5.i.i295 = zext i8 %106 to i32
  %or6.i.i296 = or i32 %shl4.i.i292, %conv5.i.i295
  store i32 %or6.i.i296, ptr %m_Value.i.i, align 4, !tbaa !32
  %sub9.i.i297 = add i32 %103, -8
  store i32 %sub9.i.i297, ptr %m_InBitStream, align 8, !tbaa !23
  %cmp.i.i298 = icmp ugt i32 %sub9.i.i297, 7
  br i1 %cmp.i.i298, label %for.body.i.i281, label %invoke.cont104, !llvm.loop !33
...
invoke.cont104:                                   ; preds = %if.end.i.i286, %if.else101
  ...
  store i32 %add.i.i273, ptr %m_InBitStream, align 8, !tbaa !23
  %shr.i.i274 = lshr i32 %108, 8
  store i32 %shr.i.i274, ptr %m_NormalValue.i, align 4, !tbaa !26
  br label %if.end107
...
if.end107:                                        ; preds = %invoke.cont91, %invoke.cont104
  ...
  %110 = load i32, ptr %_pos.i306, align 8, !tbaa !18
  ...
  %112 = load i32, ptr %_limitPos.i310, align 4, !tbaa !55
...
for.cond.i15:                                     ; preds = %if.end
  ...
  %33 = load i8, ptr %arrayidx.1.i16, align 1, !tbaa !30
...
for.cond.1.i18:                                   ; preds = %for.cond.i15
  ...
  %35 = load i8, ptr %arrayidx.2.i19, align 2, !tbaa !30
...
for.cond.2.i21:                                   ; preds = %for.cond.1.i18
  ...
  %37 = load i8, ptr %arrayidx.3.i22, align 1, !tbaa !30
...
for.cond.3.i24:                                   ; preds = %for.cond.2.i21
  ...
  %39 = load i8, ptr %arrayidx.4.i25, align 4, !tbaa !30
...
for.cond.4.i27:                                   ; preds = %for.cond.3.i24
  ...
  %41 = load i8, ptr %arrayidx.5.i28, align 1, !tbaa !30
...
for.cond.5.i30:                                   ; preds = %for.cond.4.i27
  ...
  %43 = load i8, ptr %arrayidx.6.i31, align 2, !tbaa !30
...
for.cond.6.i33:                                   ; preds = %for.cond.5.i30
  ...
  %45 = load i8, ptr %arrayidx.7.i34, align 1, !tbaa !30
...
for.cond.7.i36:                                   ; preds = %for.cond.6.i33
  ...
  %47 = load i8, ptr %arrayidx.8.i37, align 4, !tbaa !30
...
for.cond.8.i39:                                   ; preds = %for.cond.7.i36
  ...
  %49 = load i8, ptr %arrayidx.9.i40, align 1, !tbaa !30
...
for.cond.9.i42:                                   ; preds = %for.cond.8.i39
  ...
  %51 = load i8, ptr %arrayidx.10.i43, align 2, !tbaa !30
...
for.cond.10.i45:                                  ; preds = %for.cond.9.i42
  ...
  %53 = load i8, ptr %arrayidx.11.i46, align 1, !tbaa !30
...
for.cond.11.i48:                                  ; preds = %for.cond.10.i45
  ...
  %55 = load i8, ptr %arrayidx.12.i49, align 4, !tbaa !30
...
for.cond.12.i51:                                  ; preds = %for.cond.11.i48
  ...
  %57 = load i8, ptr %arrayidx.13.i52, align 1, !tbaa !30
...
for.cond.13.i54:                                  ; preds = %for.cond.12.i51
  ...
  %59 = load i8, ptr %arrayidx.14.i55, align 2, !tbaa !30
...
_ZeqRK4GUIDS1_.exit61:                            ; preds = %for.cond.13.i54
  ...
  %61 = load i8, ptr %arrayidx.15.i58, align 1, !tbaa !30
