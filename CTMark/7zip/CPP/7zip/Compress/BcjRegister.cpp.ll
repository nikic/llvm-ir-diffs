; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Compress/BcjRegister.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Compress/BcjRegister.cpp"
...
invoke.cont:
  ...
  store ptr getelementptr inbounds ({ [11 x ptr] }, ptr @_ZTV16CBCJ_x86_Decoder, i64 0, inrange i32 0, i64 2), ptr %call, align 8
  ret ptr %call
}
...
invoke.cont:
  %call = tail call noalias noundef nonnull dereferenceable(24) ptr @_Znwm(i64 noundef 24) #4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(24) %call, i8 0, i64 24, i1 false)
  store ptr getelementptr inbounds ({ [11 x ptr] }, ptr @_ZTV16CBCJ_x86_Encoder, i64 0, inrange i32 0, i64 2), ptr %call, align 8
  ret ptr %call
}
