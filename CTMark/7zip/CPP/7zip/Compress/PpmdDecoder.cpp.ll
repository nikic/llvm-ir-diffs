; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Compress/PpmdDecoder.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Compress/PpmdDecoder.cpp"
...
entry:
  store ptr getelementptr inbounds ({ [13 x ptr], [8 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress5NPpmd8CDecoderE, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %add.ptr = getelementptr inbounds i8, ptr %this, i64 8
  store ptr getelementptr inbounds ({ [13 x ptr], [8 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress5NPpmd8CDecoderE, i64 0, inrange i32 1, i64 2), ptr %add.ptr, align 8
  %add.ptr2 = getelementptr inbounds i8, ptr %this, i64 16
  store ptr getelementptr inbounds ({ [13 x ptr], [8 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress5NPpmd8CDecoderE, i64 0, inrange i32 2, i64 2), ptr %add.ptr2, align 8
  %add.ptr3 = getelementptr inbounds i8, ptr %this, i64 24
  store ptr getelementptr inbounds ({ [13 x ptr], [8 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress5NPpmd8CDecoderE, i64 0, inrange i32 3, i64 2), ptr %add.ptr3, align 8
  %add.ptr4 = getelementptr inbounds i8, ptr %this, i64 32
  store ptr getelementptr inbounds ({ [13 x ptr], [8 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress5NPpmd8CDecoderE, i64 0, inrange i32 4, i64 2), ptr %add.ptr4, align 8
  %_outBuf = getelementptr inbounds %"class.NCompress::NPpmd::CDecoder", ptr %this, i64 0, i32 6
  %0 = load ptr, ptr %_outBuf, align 8
...
invoke.cont5:                                     ; preds = %invoke.cont
  ...
  %1 = load ptr, ptr %InSeqStream, align 8
...
if.end.i:                                         ; preds = %entry
  ...
  store i8 %0, ptr %_order.i, align 8
...
if.then:                                          ; preds = %sw.bb3
  store i32 3, ptr %_status, align 4
  br label %return

if.end:                                           ; preds = %sw.bb3
  store i32 1, ptr %_status, align 4
  %_ppmd = getelementptr inbounds %"class.NCompress::NPpmd::CDecoder", ptr %this, i64 0, i32 9
  %_order = getelementptr inbounds %"class.NCompress::NPpmd::CDecoder", ptr %this, i64 0, i32 10
  %2 = load i8, ptr %_order, align 8
...
sw.epilog:                                        ; preds = %entry, %if.end
  ...
  %3 = load i8, ptr %_outSizeDefined, align 1
...
if.then7:                                         ; preds = %sw.epilog
  ...
  %5 = load i64, ptr %_processedSize, align 8
  %sub = sub i64 %4, %5
...
for.end.split.loop.exit61:                        ; preds = %for.body
  %8 = trunc i64 %indvars.iv to i32
  br label %for.end

for.end:                                          ; preds = %if.end21, %for.end.split.loop.exit61
  %i.0.lcssa.ph = phi i32 [ %8, %for.end.split.loop.exit61 ], [ %size.addr.1, %if.end21 ]
  ...
  %10 = load i64, ptr %_processedSize24, align 8
  %add = add i64 %10, %9
  store i64 %add, ptr %_processedSize24, align 8
  %Extra26 = getelementptr inbounds %"class.NCompress::NPpmd::CDecoder", ptr %this, i64 0, i32 8, i32 7
  %11 = load i8, ptr %Extra26, align 8
  %tobool27.not = icmp eq i8 %11, 0
  br i1 %tobool27.not, label %if.end31, label %if.then28

for.end.thread:                                   ; preds = %if.end12
  %Extra2656 = getelementptr inbounds %"class.NCompress::NPpmd::CDecoder", ptr %this, i64 0, i32 8, i32 7
  %12 = load i8, ptr %Extra2656, align 8
  %tobool27.not57 = icmp eq i8 %12, 0
  br i1 %tobool27.not57, label %return, label %if.then28
...
if.then33:                                        ; preds = %if.end31
  ...
  store i32 %cond, ptr %_status, align 4
  br label %return

return:                                           ; preds = %for.end.thread, %if.then28, %if.then33, %if.end31, %entry, %if.then, %sw.bb2
  %retval.1 = phi i32 [ 1, %if.then ], [ 1, %sw.bb2 ], [ 0, %entry ], [ %13, %if.then28 ], [ 0, %if.then33 ], [ 0, %if.end31 ], [ 0, %for.end.thread ]
  ret i32 %retval.1
}
...
if.end6:                                          ; preds = %if.then, %entry
  ...
  %_status = getelementptr inbounds %"class.NCompress::NPpmd::CDecoder", ptr %this, i64 0, i32 12
  %_processedSize = getelementptr inbounds %"class.NCompress::NPpmd::CDecoder", ptr %this, i64 0, i32 14
  %3 = load i64, ptr %_processedSize, align 8
  %4 = load ptr, ptr %_outBuf, align 8
  %call971 = tail call noundef i32 @_ZN9NCompress5NPpmd8CDecoder8CodeSpecEPhj(ptr noundef nonnull align 8 dereferenceable(19376) %this, ptr noundef %4, i32 noundef 1048576)
  %5 = load i64, ptr %_processedSize, align 8
  %sub72 = sub i64 %5, %3
  %6 = load ptr, ptr %_outBuf, align 8
  %call1273 = tail call noundef i32 @_Z11WriteStreamP20ISequentialOutStreamPKvm(ptr noundef %outStream, ptr noundef %6, i64 noundef %sub72)
  %cmp.not74 = icmp eq i32 %call1273, 0
  br i1 %cmp.not74, label %cleanup.cont.lr.ph, label %return
...
cleanup.cont.us:                                  ; preds = %cleanup.cont.lr.ph, %do.body.backedge.us
  %call975.us = phi i32 [ %call9.us, %do.body.backedge.us ], [ %call971, %cleanup.cont.lr.ph ]
  %cmp16.not.us = icmp eq i32 %call975.us, 0
  br i1 %cmp16.not.us, label %cleanup.cont21.us, label %return

cleanup.cont21.us:                                ; preds = %cleanup.cont.us
  %7 = load i32, ptr %_status, align 4
...
if.end24.us:                                      ; preds = %cleanup.cont21.us
  ...
  %.pre85 = load i64, ptr %_processedSize, align 8
  %9 = load i64, ptr %_outSize, align 8
  %cmp51.us = icmp ult i64 %.pre85, %9
...
do.body.backedge.us:                              ; preds = %if.end24.us
  %10 = load ptr, ptr %_outBuf, align 8
  ...
  %11 = load i64, ptr %_processedSize, align 8
  %sub.us = sub i64 %11, %.pre85
  %12 = load ptr, ptr %_outBuf, align 8
  ...
  br i1 %cmp.not.us, label %cleanup.cont.us, label %return

cleanup.cont:                                     ; preds = %cleanup.cont.lr.ph, %do.body.backedge
  %call975 = phi i32 [ %call9, %do.body.backedge ], [ %call971, %cleanup.cont.lr.ph ]
  %cmp16.not = icmp eq i32 %call975, 0
  br i1 %cmp16.not, label %cleanup.cont21, label %return

cleanup.cont21:                                   ; preds = %cleanup.cont
  %13 = load i32, ptr %_status, align 4
...
if.end24:                                         ; preds = %cleanup.cont21
  ...
  %14 = load i64, ptr %Processed.i, align 8
  ...
  %vtable31 = load ptr, ptr %progress, align 8
...
do.cond:                                          ; preds = %if.end24
  %18 = load i8, ptr %_outSizeDefined, align 1
  %tobool49.not = icmp eq i8 %18, 0
  %.pre = load i64, ptr %_processedSize, align 8
  %19 = load i64, ptr %_outSize, align 8
  %cmp51 = icmp ult i64 %.pre, %19
  %or.cond88 = select i1 %tobool49.not, i1 true, i1 %cmp51
  br i1 %or.cond88, label %do.body.backedge, label %return

do.body.backedge:                                 ; preds = %do.cond
  %20 = load ptr, ptr %_outBuf, align 8
  ...
  %21 = load i64, ptr %_processedSize, align 8
  %sub = sub i64 %21, %.pre
  %22 = load ptr, ptr %_outBuf, align 8
...
return:                                           ; preds = %cleanup.cont21, %cleanup.cont, %do.body.backedge, %if.end24, %do.cond, %cleanup.cont21.us, %cleanup.cont.us, %do.body.backedge.us, %if.end24.us, %if.end6, %if.then
  %retval.6 = phi i32 [ -2147024882, %if.then ], [ %call1273, %if.end6 ], [ 0, %cleanup.cont21.us ], [ %call975.us, %cleanup.cont.us ], [ %call12.us, %do.body.backedge.us ], [ 0, %if.end24.us ], [ 0, %cleanup.cont21 ], [ %call975, %cleanup.cont ], [ %call12, %do.body.backedge ], [ %call33, %if.end24 ], [ 0, %do.cond ]
  ret i32 %retval.6
}
...
if.end:                                           ; preds = %if.then, %entry
  %_processedSize = getelementptr inbounds %"class.NCompress::NPpmd::CDecoder", ptr %this, i64 0, i32 14
  store i64 0, ptr %_processedSize, align 8
  %_status = getelementptr inbounds %"class.NCompress::NPpmd::CDecoder", ptr %this, i64 0, i32 12
  store i32 0, ptr %_status, align 4
  ret i32 0
}
...
_ZN9NCompress5NPpmd8CDecoder16SetOutStreamSizeEPKy.exit: ; preds = %entry, %if.then.i
  ...
  store i64 0, ptr %_processedSize.i, align 8
  %_status.i = getelementptr inbounds i8, ptr %this, i64 19324
  store i32 0, ptr %_status.i, align 4
  ret i32 0
}
...
_ZN9CMyComPtrI19ISequentialInStreamEaSEPS0_.exit: ; preds = %if.end.i, %if.then2.i
  store ptr %inStream, ptr %InSeqStream, align 8
  %Stream = getelementptr inbounds %"class.NCompress::NPpmd::CDecoder", ptr %this, i64 0, i32 8, i32 5
  store ptr %inStream, ptr %Stream, align 8
  ret i32 0
}
...
if.end.i.i:                                       ; preds = %if.then.i.i, %entry
  %1 = load ptr, ptr %InSeqStream.i, align 8
...
_ZN9NCompress5NPpmd8CDecoder11SetInStreamEP19ISequentialInStream.exit: ; preds = %if.end.i.i, %if.then2.i.i
  store ptr %inStream, ptr %InSeqStream.i, align 8
...
entry:
  %InSeqStream = getelementptr inbounds %"class.NCompress::NPpmd::CDecoder", ptr %this, i64 0, i32 15
  %0 = load ptr, ptr %InSeqStream, align 8
...
if.then.i:                                        ; preds = %entry
  ...
  store ptr null, ptr %InSeqStream, align 8
...
entry:
  %InSeqStream.i = getelementptr inbounds i8, ptr %this, i64 19352
  %0 = load ptr, ptr %InSeqStream.i, align 8
...
if.then.i.i:                                      ; preds = %entry
  ...
  store ptr null, ptr %InSeqStream.i, align 8
...
entry:
  %_processedSize = getelementptr inbounds %"class.NCompress::NPpmd::CDecoder", ptr %this, i64 0, i32 14
  %0 = load i64, ptr %_processedSize, align 8
...
if.then:                                          ; preds = %entry
  %1 = load i64, ptr %_processedSize, align 8
  %sub = sub i64 %1, %0
...
entry:
  ...
  %1 = load i64, ptr %_processedSize.i, align 8
...
if.then.i:                                        ; preds = %entry
  %2 = load i64, ptr %_processedSize.i, align 8
  %sub.i = sub i64 %2, %1
  %conv.i = trunc i64 %sub.i to i32
  store i32 %conv.i, ptr %processedSize, align 4
