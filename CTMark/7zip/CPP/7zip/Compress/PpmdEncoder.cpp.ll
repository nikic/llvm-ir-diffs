...
for.end.us:                                       ; preds = %for.cond28.us
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %size) #11
  %13 = load ptr, ptr %_inBuf, align 8, !tbaa !12
...
for.body.us:                                      ; preds = %cleanup.cont.us, %for.cond28.us
  ...
  %15 = load ptr, ptr %_inBuf, align 8, !tbaa !12
  %arrayidx.us = getelementptr inbounds i8, ptr %15, i64 %indvars.iv107
  %16 = load i8, ptr %arrayidx.us, align 1, !tbaa !32
  ...
  %17 = load i32, ptr %Res.i, align 8, !tbaa !46
...
cleanup.cont:                                     ; preds = %cleanup.cont.lr.ph, %cleanup63
  %18 = load i32, ptr %size, align 4, !tbaa !33
...
for.body:                                         ; preds = %cleanup.cont, %for.cond28
  ...
  %21 = load ptr, ptr %_inBuf, align 8, !tbaa !12
  %arrayidx = getelementptr inbounds i8, ptr %21, i64 %indvars.iv
  %22 = load i8, ptr %arrayidx, align 1, !tbaa !32
  ...
  %23 = load i32, ptr %Res.i, align 8, !tbaa !46
  %cmp36.not = icmp eq i32 %23, 0
  br i1 %cmp36.not, label %for.cond28, label %cleanup66

for.end:                                          ; preds = %for.cond28
  %24 = load i64, ptr %processed, align 8, !tbaa !43
  %add = add i64 %24, %20
  store i64 %add, ptr %processed, align 8, !tbaa !43
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %outSize) #11
  %25 = load i64, ptr %Processed.i, align 8, !tbaa !41
  %26 = load ptr, ptr %Cur.i, align 8, !tbaa !38
  %27 = load ptr, ptr %Buf.i, align 8, !tbaa !37
...
cleanup63:                                        ; preds = %for.end
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %size) #11
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %size) #11
  %29 = load ptr, ptr %_inBuf, align 8, !tbaa !12
...
cleanup66:                                        ; preds = %cleanup63, %for.end, %for.body, %for.end.us, %for.body.us, %if.end14, %if.then23
  %retval.7.ph = phi i32 [ %call26, %if.then23 ], [ %call1995, %if.end14 ], [ %17, %for.body.us ], [ %call19.us, %for.end.us ], [ %23, %for.body ], [ %call19, %cleanup63 ], [ %call52, %for.end ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %size) #11
...
for.cond.i25:                                     ; preds = %if.end
  ...
  %33 = load i8, ptr %arrayidx.1.i26, align 1, !tbaa !32
...
for.cond.1.i28:                                   ; preds = %for.cond.i25
  ...
  %35 = load i8, ptr %arrayidx.2.i29, align 2, !tbaa !32
...
for.cond.2.i31:                                   ; preds = %for.cond.1.i28
  ...
  %37 = load i8, ptr %arrayidx.3.i32, align 1, !tbaa !32
...
for.cond.3.i34:                                   ; preds = %for.cond.2.i31
  ...
  %39 = load i8, ptr %arrayidx.4.i35, align 4, !tbaa !32
...
for.cond.4.i37:                                   ; preds = %for.cond.3.i34
  ...
  %41 = load i8, ptr %arrayidx.5.i38, align 1, !tbaa !32
...
for.cond.5.i40:                                   ; preds = %for.cond.4.i37
  ...
  %43 = load i8, ptr %arrayidx.6.i41, align 2, !tbaa !32
...
for.cond.6.i43:                                   ; preds = %for.cond.5.i40
  ...
  %45 = load i8, ptr %arrayidx.7.i44, align 1, !tbaa !32
...
for.cond.7.i46:                                   ; preds = %for.cond.6.i43
  ...
  %47 = load i8, ptr %arrayidx.8.i47, align 4, !tbaa !32
...
for.cond.8.i49:                                   ; preds = %for.cond.7.i46
  ...
  %49 = load i8, ptr %arrayidx.9.i50, align 1, !tbaa !32
...
for.cond.9.i52:                                   ; preds = %for.cond.8.i49
  ...
  %51 = load i8, ptr %arrayidx.10.i53, align 2, !tbaa !32
...
for.cond.10.i55:                                  ; preds = %for.cond.9.i52
  ...
  %53 = load i8, ptr %arrayidx.11.i56, align 1, !tbaa !32
...
for.cond.11.i58:                                  ; preds = %for.cond.10.i55
  ...
  %55 = load i8, ptr %arrayidx.12.i59, align 4, !tbaa !32
...
for.cond.12.i61:                                  ; preds = %for.cond.11.i58
  ...
  %57 = load i8, ptr %arrayidx.13.i62, align 1, !tbaa !32
...
for.cond.13.i64:                                  ; preds = %for.cond.12.i61
  ...
  %59 = load i8, ptr %arrayidx.14.i65, align 2, !tbaa !32
...
_ZeqRK4GUIDS1_.exit71:                            ; preds = %for.cond.13.i64
  ...
  %61 = load i8, ptr %arrayidx.15.i68, align 1, !tbaa !32
...
for.cond.i74:                                     ; preds = %if.end10
  ...
  %64 = load i8, ptr %arrayidx.1.i75, align 1, !tbaa !32
...
for.cond.1.i77:                                   ; preds = %for.cond.i74
  ...
  %66 = load i8, ptr %arrayidx.2.i78, align 2, !tbaa !32
...
for.cond.2.i80:                                   ; preds = %for.cond.1.i77
  ...
  %68 = load i8, ptr %arrayidx.3.i81, align 1, !tbaa !32
...
for.cond.3.i83:                                   ; preds = %for.cond.2.i80
  ...
  %70 = load i8, ptr %arrayidx.4.i84, align 4, !tbaa !32
...
for.cond.4.i86:                                   ; preds = %for.cond.3.i83
  ...
  %72 = load i8, ptr %arrayidx.5.i87, align 1, !tbaa !32
...
for.cond.5.i89:                                   ; preds = %for.cond.4.i86
  ...
  %74 = load i8, ptr %arrayidx.6.i90, align 2, !tbaa !32
...
for.cond.6.i92:                                   ; preds = %for.cond.5.i89
  ...
  %76 = load i8, ptr %arrayidx.7.i93, align 1, !tbaa !32
...
for.cond.7.i95:                                   ; preds = %for.cond.6.i92
  ...
  %78 = load i8, ptr %arrayidx.8.i96, align 4, !tbaa !32
...
for.cond.8.i98:                                   ; preds = %for.cond.7.i95
  ...
  %80 = load i8, ptr %arrayidx.9.i99, align 1, !tbaa !32
...
for.cond.9.i101:                                  ; preds = %for.cond.8.i98
  ...
  %82 = load i8, ptr %arrayidx.10.i102, align 2, !tbaa !32
...
for.cond.10.i104:                                 ; preds = %for.cond.9.i101
  ...
  %84 = load i8, ptr %arrayidx.11.i105, align 1, !tbaa !32
...
for.cond.11.i107:                                 ; preds = %for.cond.10.i104
  ...
  %86 = load i8, ptr %arrayidx.12.i108, align 4, !tbaa !32
...
for.cond.12.i110:                                 ; preds = %for.cond.11.i107
  ...
  %88 = load i8, ptr %arrayidx.13.i111, align 1, !tbaa !32
...
for.cond.13.i113:                                 ; preds = %for.cond.12.i110
  ...
  %90 = load i8, ptr %arrayidx.14.i114, align 2, !tbaa !32
...
_ZeqRK4GUIDS1_.exit120:                           ; preds = %for.cond.13.i113
  ...
  %92 = load i8, ptr %arrayidx.15.i117, align 1, !tbaa !32
