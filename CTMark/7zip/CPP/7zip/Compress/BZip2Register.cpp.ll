; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Compress/BZip2Register.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Compress/BZip2Register.cpp"
...
entry:
  %call = tail call noalias noundef nonnull dereferenceable(28992) ptr @_Znwm(i64 noundef 28992) #5
  invoke void @_ZN9NCompress6NBZip28CDecoderC1Ev(ptr noundef nonnull align 8 dereferenceable(28988) %call)
...
entry:
  %call = tail call noalias noundef nonnull dereferenceable(712) ptr @_Znwm(i64 noundef 712) #5
  invoke void @_ZN9NCompress6NBZip28CEncoderC1Ev(ptr noundef nonnull align 8 dereferenceable(712) %call)
          to label %invoke.cont unwind label %lpad
