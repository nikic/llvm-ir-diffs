; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Compress/ImplodeHuffmanDecoder.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Compress/ImplodeHuffmanDecoder.cpp"
...
entry:
  ...
  store i32 %numSymbols, ptr %m_NumSymbols, align 8
  ...
  store ptr %call, ptr %m_Symbols, align 8
  ret void
}
...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(68) %lenCounts, i8 0, i64 68, i1 false)
  %m_NumSymbols = getelementptr inbounds %"class.NCompress::NImplode::NHuffman::CDecoder", ptr %this, i64 0, i32 2
  %0 = load i32, ptr %m_NumSymbols, align 8
...
for.body4.epil:                                   ; preds = %for.end12.unr-lcssa, %for.body4.epil
  ...
  %10 = load i8, ptr %arrayidx6.epil, align 1
  %idxprom7.epil = zext i8 %10 to i64
  %arrayidx8.epil = getelementptr inbounds [18 x i32], ptr %lenCounts, i64 0, i64 %idxprom7.epil
  %11 = load i32, ptr %arrayidx8.epil, align 4
  %inc9.epil = add nsw i32 %11, 1
  store i32 %inc9.epil, ptr %arrayidx8.epil, align 4
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %for.end12, label %for.body4.epil
...
for.end12:                                        ; preds = %for.body4.epil, %for.end12.unr-lcssa
  ...
  %.pre = load i32, ptr %arrayidx20.phi.trans.insert, align 16
...
if.end.1:                                         ; preds = %if.end
  ...
  store i32 %12, ptr %arrayidx35.1, align 4
  ...
  %14 = load i32, ptr %arrayidx20.2, align 8
  %shl.2 = shl i32 %14, 2
...
if.end.3:                                         ; preds = %if.end.2
  ...
  store i32 %add41.2, ptr %arrayidx35.3, align 4
  ...
  %16 = load i32, ptr %arrayidx20.4, align 16
  %shl.4 = shl i32 %16, 4
...
if.then56:                                        ; preds = %for.body52
  ...
  store i32 %dec61, ptr %arrayidx60, align 4
  ...
  store i32 %32, ptr %arrayidx63, align 4
  %.pre113 = load i32, ptr %m_NumSymbols, align 8
  br label %for.inc65
...
for.inc65:                                        ; preds = %for.body52, %if.then56
  ...
  br i1 %cmp51, label %for.body52, label %cleanup
...
entry:
  %.pr.i.i = load i32, ptr %inStream, align 8
...
if.end.i.i:                                       ; preds = %if.then.i.i, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i
  ...
  %5 = load i32, ptr %inStream, align 8
  ...
  store i32 %sub9.i.i, ptr %inStream, align 8
...
for.inc.3:                                        ; preds = %for.inc.2
  ...
  %15 = load i32, ptr %arrayidx.4, align 8
...
for.inc.5:                                        ; preds = %for.inc.4
  ...
  %17 = load i32, ptr %arrayidx.6, align 8
...
for.inc.7:                                        ; preds = %for.inc.6
  ...
  %19 = load i32, ptr %arrayidx.8, align 8
...
for.inc.8:                                        ; preds = %for.inc.7
  ...
  %20 = load i32, ptr %arrayidx.9, align 4
...
for.inc.9:                                        ; preds = %for.inc.8
  ...
  %21 = load i32, ptr %arrayidx.10, align 8
...
for.inc.10:                                       ; preds = %for.inc.9
  ...
  %22 = load i32, ptr %arrayidx.11, align 4
...
for.inc.11:                                       ; preds = %for.inc.10
  ...
  %23 = load i32, ptr %arrayidx.12, align 8
...
for.inc.12:                                       ; preds = %for.inc.11
  ...
  %24 = load i32, ptr %arrayidx.13, align 4
...
for.inc.13:                                       ; preds = %for.inc.12
  ...
  %25 = load i32, ptr %arrayidx.14, align 8
...
for.inc.14:                                       ; preds = %for.inc.13
  ...
  %26 = load i32, ptr %arrayidx.15, align 4
...
if.end5:                                          ; preds = %_ZN5NBitl8CDecoderI9CInBufferE8GetValueEj.exit, %for.inc, %for.inc.1, %for.inc.2, %for.inc.3, %for.inc.4, %for.inc.5, %for.inc.6, %for.inc.7, %for.inc.8, %for.inc.9, %for.inc.10, %for.inc.11, %for.inc.12, %for.inc.13, %for.inc.14
  ...
  store i32 %add.i, ptr %inStream, align 8
  %m_NormalValue.i = getelementptr inbounds %"class.NBitl::CDecoder", ptr %inStream, i64 0, i32 1
  %27 = load i32, ptr %m_NormalValue.i, align 4
  %shr.i31 = lshr i32 %27, %i.036.lcssa
  store i32 %shr.i31, ptr %m_NormalValue.i, align 4
...
attributes #4 = { mustprogress nofree nosync nounwind memory(write, argmem: readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
