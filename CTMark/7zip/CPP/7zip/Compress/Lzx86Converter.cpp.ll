; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Compress/Lzx86Converter.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Compress/Lzx86Converter.cpp"
...
for.body8.preheader:                              ; preds = %for.body
  ...
  %5 = load i8, ptr %arrayidx10.1, align 1
  ...
  %6 = load i8, ptr %arrayidx10.2, align 1
  ...
  %7 = load i8, ptr %arrayidx10.3, align 1
...
if.then19:                                        ; preds = %for.body8.preheader
  ...
  store i8 %conv27, ptr %arrayidx10, align 1
  %shr = lshr i32 %cond, 8
  %conv27.1 = trunc i32 %shr to i8
  store i8 %conv27.1, ptr %arrayidx10.1, align 1
  %shr.1 = lshr i32 %cond, 16
  %conv27.2 = trunc i32 %shr.1 to i8
  store i8 %conv27.2, ptr %arrayidx10.2, align 1
  %shr.2 = lshr i32 %cond, 24
  %conv27.3 = trunc i32 %shr.2 to i8
  store i8 %conv27.3, ptr %arrayidx10.3, align 1
  br label %if.end34
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %0 = load i8, ptr %m_TranslationMode, align 4
  %tobool.not = icmp eq i8 %0, 0
  br i1 %tobool.not, label %if.then2, label %while.cond.preheader

while.cond.preheader:                             ; preds = %if.end
  %cmp545.not = icmp eq i32 %size, 0
  br i1 %cmp545.not, label %while.end, label %while.body.lr.ph
...
while.body:                                       ; preds = %while.body.lr.ph, %while.cond.backedge
  %realProcessedSize.046 = phi i32 [ 0, %while.body.lr.ph ], [ %add12, %while.cond.backedge ]
  %sub = sub i32 %size, %realProcessedSize.046
  ...
  %idx.ext9 = zext i32 %realProcessedSize.046 to i64
  ...
  store i32 %add, ptr %m_Pos, align 4
  %add12 = add i32 %cond.i, %realProcessedSize.046
...
if.then15:                                        ; preds = %while.body
  ...
  br i1 %cmp17.not, label %while.cond.backedge, label %return
...
while.end:                                        ; preds = %while.cond.backedge, %while.cond.preheader
  %realProcessedSize.0.lcssa = phi i32 [ 0, %while.cond.preheader ], [ %add12, %while.cond.backedge ]
  br i1 %cmp.not, label %return, label %if.then25

if.then25:                                        ; preds = %while.end
  store i32 %realProcessedSize.0.lcssa, ptr %processedSize, align 4
  br label %return
...
if.end:                                           ; preds = %entry
  %m_TranslationMode = getelementptr inbounds %"class.NCompress::NLzx::Cx86ConvertOutStream", ptr %this, i64 0, i32 7
  %1 = load i8, ptr %m_TranslationMode, align 4
...
for.body8.preheader.i:                            ; preds = %for.body.i
  ...
  %6 = load i8, ptr %arrayidx10.1.i, align 1
  ...
  %7 = load i8, ptr %arrayidx10.2.i, align 1
  ...
  %8 = load i8, ptr %arrayidx10.3.i, align 1
...
if.then19.i:                                      ; preds = %for.body8.preheader.i
  ...
  store i8 %conv27.i, ptr %arrayidx10.i, align 1
  %shr.i = lshr i32 %cond.i, 8
  %conv27.1.i = trunc i32 %shr.i to i8
  store i8 %conv27.1.i, ptr %arrayidx10.1.i, align 1
  %shr.1.i = lshr i32 %cond.i, 16
  %conv27.2.i = trunc i32 %shr.1.i to i8
  store i8 %conv27.2.i, ptr %arrayidx10.2.i, align 1
  %shr.2.i = lshr i32 %cond.i, 24
  %conv27.3.i = trunc i32 %shr.2.i to i8
  store i8 %conv27.3.i, ptr %arrayidx10.3.i, align 1
  br label %if.end34.i
...
if.end36.i:                                       ; preds = %if.end34.i, %for.body.i
  ...
  br i1 %cmp3.i, label %for.body.i, label %if.end3
...
do.body:                                          ; preds = %do.cond, %if.end3
  ...
  %10 = load ptr, ptr %m_Stream, align 8
...
do.cond:                                          ; preds = %cleanup.cont
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %processed) #9
  %13 = load i32, ptr %m_Pos, align 4
  %cmp16 = icmp ult i32 %add, %13
  br i1 %cmp16, label %do.body, label %do.end

do.end:                                           ; preds = %do.cond
  %m_ProcessedSize = getelementptr inbounds %"class.NCompress::NLzx::Cx86ConvertOutStream", ptr %this, i64 0, i32 4
  %14 = load i32, ptr %m_ProcessedSize, align 8
  %add18 = add i32 %14, %13
  store i32 %add18, ptr %m_ProcessedSize, align 8
  store i32 0, ptr %m_Pos, align 4
  %15 = load i8, ptr %m_TranslationMode, align 4
  ...
  store i8 %frombool, ptr %m_TranslationMode, align 4
  br label %return
...
entry:
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTVN9NCompress4NLzx20Cx86ConvertOutStreamE, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %m_Stream = getelementptr inbounds %"class.NCompress::NLzx::Cx86ConvertOutStream", ptr %this, i64 0, i32 3
...
entry:
  ...
  %0 = load ptr, ptr %m_Stream.i, align 8
