...
entry:
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress10CCopyCoderE, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %add.ptr = getelementptr inbounds i8, ptr %this, i64 8
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress10CCopyCoderE, i64 0, inrange i32 1, i64 2), ptr %add.ptr, align 8
...
entry:
  ...
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress10CCopyCoderE, i64 0, inrange i32 0, i64 2), ptr %0, align 8
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress10CCopyCoderE, i64 0, inrange i32 1, i64 2), ptr %this, align 8
...
entry:
  ...
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress10CCopyCoderE, i64 0, inrange i32 1, i64 2), ptr %add.ptr.i, align 8
...
entry:
  ...
  %1 = load ptr, ptr %_buffer.i.i, align 8
  invoke void @MidFree(ptr noundef %1)
...
for.cond.us:                                      ; preds = %if.end6, %if.end36.us
  ...
  store i32 131072, ptr %size, align 4
...
if.then11.us:                                     ; preds = %if.then8.us
  ...
  store i32 %conv14.us, ptr %size, align 4
...
if.then25.us.if.end36.us_crit_edge:               ; preds = %if.then25.us
  %.pre133 = load i32, ptr %size, align 4
...
if.end36.us:                                      ; preds = %if.then25.us.if.end36.us_crit_edge, %if.end24.us
  ...
  store i64 %add.us, ptr %TotalSize, align 8
...
if.end6.split.split.us:                           ; preds = %if.end6.split
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %size) #12
  store i32 131072, ptr %size, align 4
  %vtable.us76116 = load ptr, ptr %inStream, align 8
...
if.then25.us83:                                   ; preds = %if.end24.us82
  %14 = load ptr, ptr %_buffer, align 8
...
if.then25.us83.if.end36.us87_crit_edge:           ; preds = %if.then25.us83
  %.pre132 = load i32, ptr %size, align 4
...
if.end36.us87:                                    ; preds = %if.then25.us83.if.end36.us87_crit_edge, %if.end24.us82
  ...
  %16 = load i64, ptr %TotalSize, align 8
  %add.us89 = add i64 %16, %conv37.us88
  store i64 %add.us89, ptr %TotalSize, align 8
  %vtable44.us = load ptr, ptr %progress, align 8
...
cleanup54.us90:                                   ; preds = %if.end36.us87
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %size) #12
  store i32 131072, ptr %size, align 4
  %18 = load ptr, ptr %_buffer, align 8
  %vtable.us76 = load ptr, ptr %inStream, align 8
...
for.cond.us93:                                    ; preds = %if.end6.split.split, %cleanup54.us113
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %size) #12
  store i32 131072, ptr %size, align 4
  %21 = load i64, ptr %outSize, align 8
...
if.then11.us96:                                   ; preds = %for.cond.us93
  ...
  store i32 %conv14.us97, ptr %size, align 4
...
if.end16.us98:                                    ; preds = %if.then11.us96, %for.cond.us93
  ...
  %23 = load ptr, ptr %_buffer, align 8
  %vtable.us99 = load ptr, ptr %inStream, align 8
...
if.end24.us105:                                   ; preds = %cleanup.cont.us103
  ...
  %26 = load i64, ptr %TotalSize, align 8
  %add.us108 = add i64 %26, %conv37.us107
  store i64 %add.us108, ptr %TotalSize, align 8
  %vtable44.us109 = load ptr, ptr %progress, align 8
...
cleanup54.us113:                                  ; preds = %if.end24.us105
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %size) #12
  %.pre131 = load i64, ptr %TotalSize, align 8
...
if.end16:                                         ; preds = %for.cond, %if.then11
  ...
  %31 = load ptr, ptr %_buffer, align 8
...
if.end24:                                         ; preds = %cleanup.cont
  %34 = load ptr, ptr %_buffer, align 8
...
if.end36:                                         ; preds = %if.end24
  ...
  %vtable44 = load ptr, ptr %progress, align 8
...
cleanup54.thread:                                 ; preds = %if.end36, %if.end16, %if.end24, %if.end16.us98, %if.end24.us105, %cleanup54.us90, %if.then25.us83, %if.end36.us87, %if.end16.us, %if.then25.us, %if.end6.split.split.us
  %.us-phi = phi i32 [ %call18.us78118, %if.end6.split.split.us ], [ %call18.us, %if.end16.us ], [ %call29.us, %if.then25.us ], [ %call46.us, %if.end36.us87 ], [ %call29.us85, %if.then25.us83 ], [ %call18.us78, %cleanup54.us90 ], [ %call46.us111, %if.end24.us105 ], [ %call18.us101, %if.end16.us98 ], [ %call46, %if.end36 ], [ %call18, %if.end16 ], [ %call29, %if.end24 ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %size) #12
  br label %return

cleanup54:                                        ; preds = %if.end36
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %size) #12
  %.pre = load i64, ptr %TotalSize, align 8
  br label %for.cond
...
entry:
  ...
  %0 = load i64, ptr %TotalSize.i, align 8
  store i64 %0, ptr %value, align 8
  ret i32 0
}
...
invoke.cont:
  ...
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress10CCopyCoderE, i64 0, inrange i32 1, i64 2), ptr %0, align 8
...
if.then.i12:                                      ; preds = %invoke.cont
  %5 = landingpad { ptr, i32 }
          cleanup
  %vtable.i13 = load ptr, ptr %call, align 8
