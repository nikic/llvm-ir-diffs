; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Compress/ZDecoder.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Compress/ZDecoder.cpp"
...
entry:
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress2NZ8CDecoderE, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %add.ptr = getelementptr inbounds i8, ptr %this, i64 8
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress2NZ8CDecoderE, i64 0, inrange i32 1, i64 2), ptr %add.ptr, align 8
  %_parents.i = getelementptr inbounds %"class.NCompress::NZ::CDecoder", ptr %this, i64 0, i32 3
  %0 = load ptr, ptr %_parents.i, align 8
  invoke void @MyFree(ptr noundef %0)
          to label %.noexc unwind label %terminate.lpad

.noexc:                                           ; preds = %entry
  store ptr null, ptr %_parents.i, align 8
  %_suffixes.i = getelementptr inbounds %"class.NCompress::NZ::CDecoder", ptr %this, i64 0, i32 4
  %1 = load ptr, ptr %_suffixes.i, align 8
  invoke void @MyFree(ptr noundef %1)
          to label %.noexc2 unwind label %terminate.lpad

.noexc2:                                          ; preds = %.noexc
  store ptr null, ptr %_suffixes.i, align 8
  %_stack.i = getelementptr inbounds %"class.NCompress::NZ::CDecoder", ptr %this, i64 0, i32 5
  %2 = load ptr, ptr %_stack.i, align 8
  invoke void @MyFree(ptr noundef %2)
          to label %invoke.cont unwind label %terminate.lpad

invoke.cont:                                      ; preds = %.noexc2
  store ptr null, ptr %_stack.i, align 8
  ret void
...
entry:
  ...
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress2NZ8CDecoderE, i64 0, inrange i32 0, i64 2), ptr %0, align 8
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress2NZ8CDecoderE, i64 0, inrange i32 1, i64 2), ptr %this, align 8
  %_parents.i.i = getelementptr inbounds i8, ptr %this, i64 16
  %1 = load ptr, ptr %_parents.i.i, align 8
  invoke void @MyFree(ptr noundef %1)
          to label %.noexc.i unwind label %terminate.lpad.i

.noexc.i:                                         ; preds = %entry
  store ptr null, ptr %_parents.i.i, align 8
  %_suffixes.i.i = getelementptr inbounds i8, ptr %this, i64 24
  %2 = load ptr, ptr %_suffixes.i.i, align 8
  invoke void @MyFree(ptr noundef %2)
          to label %.noexc2.i unwind label %terminate.lpad.i

.noexc2.i:                                        ; preds = %.noexc.i
  store ptr null, ptr %_suffixes.i.i, align 8
  %_stack.i.i = getelementptr inbounds i8, ptr %this, i64 32
  %3 = load ptr, ptr %_stack.i.i, align 8
...
_ZN9NCompress2NZ8CDecoderD2Ev.exit:               ; preds = %.noexc2.i
  store ptr null, ptr %_stack.i.i, align 8
  ret void
}
...
entry:
  ...
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress2NZ8CDecoderE, i64 0, inrange i32 1, i64 2), ptr %add.ptr.i, align 8
  %_parents.i.i = getelementptr inbounds %"class.NCompress::NZ::CDecoder", ptr %this, i64 0, i32 3
  %0 = load ptr, ptr %_parents.i.i, align 8
  invoke void @MyFree(ptr noundef %0)
          to label %.noexc.i unwind label %terminate.lpad.i
...
.noexc.i:                                         ; preds = %entry
  ...
  %1 = load ptr, ptr %_suffixes.i.i, align 8
  invoke void @MyFree(ptr noundef %1)
          to label %.noexc2.i unwind label %terminate.lpad.i
...
.noexc2.i:                                        ; preds = %.noexc.i
  ...
  %2 = load ptr, ptr %_stack.i.i, align 8
  invoke void @MyFree(ptr noundef %2)
          to label %_ZN9NCompress2NZ8CDecoderD2Ev.exit unwind label %terminate.lpad.i
...
invoke.cont12:                                    ; preds = %invoke.cont11
  ...
  %3 = load i8, ptr %_properties, align 8
  %4 = and i8 %3, 31
...
if.end15:                                         ; preds = %invoke.cont12
  ...
  %6 = load i32, ptr %_numMaxBits, align 4
...
.noexc:                                           ; preds = %if.then27
  store ptr null, ptr %_parents, align 8
  %10 = load ptr, ptr %_suffixes, align 8
...
invoke.cont31:                                    ; preds = %invoke.cont29
  store ptr %call32, ptr %_parents, align 8
...
invoke.cont40:                                    ; preds = %if.end37
  store ptr %call41, ptr %_suffixes, align 8
...
invoke.cont49:                                    ; preds = %if.end46
  store ptr %call50, ptr %_stack, align 8
  %cmp53 = icmp eq ptr %call50, null
  br i1 %cmp53, label %cleanup203, label %if.end55

if.end55:                                         ; preds = %invoke.cont49
  store i32 %and, ptr %_numMaxBits, align 4
  %.pre = load ptr, ptr %_parents, align 8
  %.pre321 = load ptr, ptr %_suffixes, align 8
  br label %if.end57
...
for.cond.outer:                                   ; preds = %for.cond.outer.backedge, %if.end57
  ...
  %wide.trip.count44.i = zext i32 %numBits.0.ph to i64
...
if.then62:                                        ; preds = %for.cond
  %15 = load ptr, ptr %_bufferLimit.i, align 8
  %16 = load ptr, ptr %inBuffer, align 8
...
for.body.preheader.i:                             ; preds = %for.cond.preheader.i
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 %buf, ptr align 1 %16, i64 %wide.trip.count.i, i1 false)
...
for.cond.cleanup.i:                               ; preds = %for.body.preheader.i, %for.cond.preheader.i
  ...
  store ptr %add.ptr.i, ptr %inBuffer, align 8
  br label %invoke.cont64

for.body11.i:                                     ; preds = %if.then62, %if.end18.i
  %17 = phi ptr [ %incdec.ptr.i, %if.end18.i ], [ %16, %if.then62 ]
  %indvars.iv41.i = phi i64 [ %indvars.iv.next42.i, %if.end18.i ], [ 0, %if.then62 ]
  %18 = load ptr, ptr %_bufferLimit.i, align 8
...
call.i.noexc:                                     ; preds = %if.then15.i
  br i1 %call.i274, label %if.then15.if.end18_crit_edge.i, label %cleanup.split.loop.exit.i

if.then15.if.end18_crit_edge.i:                   ; preds = %call.i.noexc
  %.pre46.i = load ptr, ptr %inBuffer, align 8
  br label %if.end18.i

if.end18.i:                                       ; preds = %if.then15.if.end18_crit_edge.i, %for.body11.i
  %19 = phi ptr [ %.pre46.i, %if.then15.if.end18_crit_edge.i ], [ %17, %for.body11.i ]
  %incdec.ptr.i = getelementptr inbounds i8, ptr %19, i64 1
  store ptr %incdec.ptr.i, ptr %inBuffer, align 8
  %20 = load i8, ptr %19, align 1
  %arrayidx21.i = getelementptr inbounds i8, ptr %buf, i64 %indvars.iv41.i
  store i8 %20, ptr %arrayidx21.i, align 1
...
cleanup.i:                                        ; preds = %if.end18.i, %cleanup.split.loop.exit.i
  %i7.0.lcssa.i = phi i32 [ %21, %cleanup.split.loop.exit.i ], [ %numBits.0.ph, %if.end18.i ]
  %spec.select.i = call i32 @llvm.umin.i32(i32 %i7.0.lcssa.i, i32 %numBits.0.ph)
  br label %invoke.cont64
...
invoke.cont68:                                    ; preds = %invoke.cont64
  store i64 %call69, ptr %nowPos, align 8
...
cleanup86.thread:                                 ; preds = %invoke.cont68
...
if.then72:                                        ; preds = %invoke.cont68
  ...
  %22 = load i64, ptr %_processedSize.i, align 8
  %23 = load ptr, ptr %inBuffer, align 8
  %24 = load ptr, ptr %_bufferBase.i, align 8
  ...
  %call78 = invoke noundef i32 %25(ptr noundef nonnull align 8 dereferenceable(8) %progress, ptr noundef nonnull %packSize, ptr noundef nonnull %nowPos)
          to label %cleanup86 unwind label %lpad76
...
cleanup86:                                        ; preds = %if.then72
  %cmp79.not = icmp eq i32 %call78, 0
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %packSize) #13
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %nowPos) #13
  br i1 %cmp79.not, label %if.end90, label %cleanup183
...
if.end90:                                         ; preds = %cleanup86.thread, %cleanup86, %for.cond
  %prevPos.3 = phi i64 [ %call69, %cleanup86 ], [ %prevPos.0, %for.cond ], [ %prevPos.0, %cleanup86.thread ]
  %bitPos.1 = phi i32 [ 0, %cleanup86 ], [ %bitPos.0, %for.cond ], [ 0, %cleanup86.thread ]
  %numBufBits.1 = phi i32 [ %mul66, %cleanup86 ], [ %numBufBits.0, %for.cond ], [ %mul66, %cleanup86.thread ]
  %shr = lshr i32 %bitPos.1, 3
  %idxprom = zext i32 %shr to i64
  %arrayidx91 = getelementptr inbounds [20 x i8], ptr %buf, i64 0, i64 %idxprom
  %28 = load i8, ptr %arrayidx91, align 1
  ...
  %29 = load i8, ptr %arrayidx94, align 1
  ...
  %30 = load i8, ptr %arrayidx99, align 1
...
if.end114:                                        ; preds = %if.end111
  ...
  br i1 %or.cond215, label %for.cond.outer.backedge, label %while.cond.preheader
...
while.end:                                        ; preds = %while.end.loopexit, %while.cond.preheader
  ...
  %37 = load ptr, ptr %_stack, align 8
...
do.body:                                          ; preds = %do.cond, %if.end150
  ...
  %41 = load ptr, ptr %_stack, align 8
  %indvars.iv.next319 = add nsw i64 %indvars.iv318, -1
  %arrayidx153 = getelementptr inbounds i8, ptr %41, i64 %indvars.iv.next319
  %42 = load i8, ptr %arrayidx153, align 1
  %43 = load ptr, ptr %outBuffer, align 8
  %44 = load i32, ptr %_pos.i, align 8
  %inc.i = add i32 %44, 1
  ...
  store i8 %42, ptr %arrayidx.i279, align 1
  %45 = load i32, ptr %_pos.i, align 8
  %46 = load i32, ptr %_limitPos.i, align 4
...
if.then158:                                       ; preds = %do.end
  ...
  %47 = load ptr, ptr %_parents, align 8
  ...
  store i16 %conv159, ptr %arrayidx163, align 2
...
cleanup183:                                       ; preds = %if.end111, %cleanup86, %for.end
  %retval.6 = phi i32 [ %call182, %for.end ], [ 1, %if.end111 ], [ %call78, %cleanup86 ]
...
ehcleanup184:                                     ; preds = %lpad63.loopexit, %lpad63.loopexit.split-lp, %lpad154, %ehcleanup89
  %.pn262 = phi { ptr, i32 } [ %48, %lpad154 ], [ %.pn, %ehcleanup89 ], [ %lpad.loopexit, %lpad63.loopexit ], [ %lpad.loopexit.split-lp, %lpad63.loopexit.split-lp ]
  call void @llvm.lifetime.end.p0(i64 20, ptr nonnull %buf) #13
  br label %ehcleanup204
...
invoke.cont.i:                                    ; preds = %cleanup203
  %49 = load ptr, ptr %_stream.i, align 8
...
_ZN10COutBufferD2Ev.exit:                         ; preds = %invoke.cont.i, %if.then.i.i
  ...
  invoke void @_ZN9CInBuffer4FreeEv(ptr noundef nonnull align 8 dereferenceable(45) %inBuffer)
          to label %invoke.cont.i283 unwind label %terminate.lpad.i282

invoke.cont.i283:                                 ; preds = %_ZN10COutBufferD2Ev.exit
  %_stream.i284 = getelementptr inbounds %class.CInBuffer, ptr %inBuffer, i64 0, i32 3
  %55 = load ptr, ptr %_stream.i284, align 8
  %tobool.not.i.i285 = icmp eq ptr %55, null
  br i1 %tobool.not.i.i285, label %_ZN9CInBufferD2Ev.exit, label %if.then.i.i286

if.then.i.i286:                                   ; preds = %invoke.cont.i283
  %vtable.i.i287 = load ptr, ptr %55, align 8
  %vfn.i.i288 = getelementptr inbounds ptr, ptr %vtable.i.i287, i64 2
  %56 = load ptr, ptr %vfn.i.i288, align 8
  %call.i.i289 = invoke noundef i32 %56(ptr noundef nonnull align 8 dereferenceable(8) %55)
          to label %_ZN9CInBufferD2Ev.exit unwind label %terminate.lpad.i.i290

terminate.lpad.i.i290:                            ; preds = %if.then.i.i286
...
terminate.lpad.i282:                              ; preds = %_ZN10COutBufferD2Ev.exit
...
_ZN9CInBufferD2Ev.exit:                           ; preds = %invoke.cont.i283, %if.then.i.i286
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %inBuffer) #13
  ret i32 %retval.9

ehcleanup204:                                     ; preds = %lpad28, %ehcleanup184, %lpad3
  %.pn262.pn.pn = phi { ptr, i32 } [ %2, %lpad3 ], [ %.pn262, %ehcleanup184 ], [ %12, %lpad28 ]
...
if.end:                                           ; preds = %entry
  ...
  %_properties = getelementptr inbounds %"class.NCompress::NZ::CDecoder", ptr %this, i64 0, i32 6
  store i8 %0, ptr %_properties, align 8
  br label %return
...
if.end.i:                                         ; preds = %entry
  ...
  store i8 %0, ptr %_properties.i, align 8
