...
for.cond38.preheader:                             ; preds = %invoke.cont11
  ...
  %scevgep446 = getelementptr inbounds i8, ptr %this, i64 41229
...
if.then52:                                        ; preds = %if.end50
  ...
  br i1 %cmp8.i.i343, label %for.body.i.i358, label %invoke.cont55

for.body.i.i358:                                  ; preds = %if.then52, %if.end.i.i363
  %42 = load ptr, ptr %m_Stream.i, align 8, !tbaa !24
  %43 = load ptr, ptr %_bufferLimit.i.i.i, align 8, !tbaa !25
  %cmp.not.i.i.i359 = icmp ult ptr %42, %43
  br i1 %cmp.not.i.i.i359, label %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i373, label %if.then.i.i.i360

if.then.i.i.i360:                                 ; preds = %for.body.i.i358
...
call.i.i.i.noexc375:                              ; preds = %if.then.i.i.i360
  br i1 %call.i.i.i376, label %if.then.if.end3_crit_edge.i.i.i371, label %if.then.i.i361

if.then.if.end3_crit_edge.i.i.i371:               ; preds = %call.i.i.i.noexc375
  %.pre.i.i.i372 = load ptr, ptr %m_Stream.i, align 8, !tbaa !24
  br label %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i373

_ZN9CInBuffer8ReadByteERh.exit.thread.i.i373:     ; preds = %if.then.if.end3_crit_edge.i.i.i371, %for.body.i.i358
  %44 = phi ptr [ %.pre.i.i.i372, %if.then.if.end3_crit_edge.i.i.i371 ], [ %42, %for.body.i.i358 ]
  %incdec.ptr.i.i.i374 = getelementptr inbounds i8, ptr %44, i64 1
  store ptr %incdec.ptr.i.i.i374, ptr %m_Stream.i, align 8, !tbaa !24
  %45 = load i8, ptr %44, align 1, !tbaa !26
  br label %if.end.i.i363

if.then.i.i361:                                   ; preds = %call.i.i.i.noexc375
  %46 = load i32, ptr %NumExtraBytes.i, align 8, !tbaa !22
  %inc.i.i362 = add i32 %46, 1
  store i32 %inc.i.i362, ptr %NumExtraBytes.i, align 8, !tbaa !22
  br label %if.end.i.i363

if.end.i.i363:                                    ; preds = %if.then.i.i361, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i373
  %b.1.i.i364 = phi i8 [ -1, %if.then.i.i361 ], [ %45, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i373 ]
  %conv.i.i365 = zext i8 %b.1.i.i364 to i32
  %47 = load i32, ptr %inBuffer, align 8, !tbaa !17
  %sub.i.i366 = sub i32 32, %47
  %shl.i.i367 = shl i32 %conv.i.i365, %sub.i.i366
  %48 = load i32, ptr %m_Value.i, align 4, !tbaa !21
  %or.i.i368 = or i32 %shl.i.i367, %48
  store i32 %or.i.i368, ptr %m_Value.i, align 4, !tbaa !21
  %sub5.i.i369 = add i32 %47, -8
  store i32 %sub5.i.i369, ptr %inBuffer, align 8, !tbaa !17
  %cmp.i.i370 = icmp ugt i32 %sub5.i.i369, 7
  br i1 %cmp.i.i370, label %for.body.i.i358, label %invoke.cont55, !llvm.loop !27

invoke.cont55:                                    ; preds = %if.end.i.i363, %if.then52
  %49 = phi i32 [ %add.i, %if.then52 ], [ %sub5.i.i369, %if.end.i.i363 ]
  %50 = phi i32 [ %shr.i, %if.then52 ], [ %or.i.i368, %if.end.i.i363 ]
  %and.i350 = and i32 %50, %sub.i
  %add.i351 = add i32 %49, %numBits.0
  store i32 %add.i351, ptr %inBuffer, align 8, !tbaa !17
  %shr.i352 = lshr i32 %50, %numBits.0
  store i32 %shr.i352, ptr %m_Value.i, align 4, !tbaa !21
  switch i32 %and.i350, label %cleanup250 [
...
vector.body:                                      ; preds = %for.inc94.2, %pred.store.continue553
  %index = phi i64 [ %index.next, %pred.store.continue553 ], [ 0, %for.inc94.2 ]
  ...
  %wide.load491 = load <16 x i8>, ptr %61, align 1, !tbaa !23
  %62 = icmp eq <16 x i8> %wide.load, zeroinitializer
  %63 = icmp eq <16 x i8> %wide.load491, zeroinitializer
...
pred.store.continue:                              ; preds = %pred.store.if, %vector.body
  ...
  br i1 %66, label %pred.store.if492, label %pred.store.continue493

pred.store.if492:                                 ; preds = %pred.store.continue
...
pred.store.continue493:                           ; preds = %pred.store.if492, %pred.store.continue
  %69 = extractelement <16 x i1> %62, i64 2
  br i1 %69, label %pred.store.if494, label %pred.store.continue495
...
pred.store.continue495:                           ; preds = %pred.store.if494, %pred.store.continue493
  ...
  br i1 %72, label %pred.store.if496, label %pred.store.continue497
...
pred.store.continue497:                           ; preds = %pred.store.if496, %pred.store.continue495
  ...
  br i1 %75, label %pred.store.if498, label %pred.store.continue499
...
pred.store.continue499:                           ; preds = %pred.store.if498, %pred.store.continue497
  ...
  br i1 %78, label %pred.store.if500, label %pred.store.continue501
...
pred.store.continue501:                           ; preds = %pred.store.if500, %pred.store.continue499
  ...
  br i1 %81, label %pred.store.if502, label %pred.store.continue503
...
pred.store.continue503:                           ; preds = %pred.store.if502, %pred.store.continue501
  ...
  br i1 %84, label %pred.store.if504, label %pred.store.continue505
...
pred.store.continue505:                           ; preds = %pred.store.if504, %pred.store.continue503
  ...
  br i1 %87, label %pred.store.if506, label %pred.store.continue507
...
pred.store.continue507:                           ; preds = %pred.store.if506, %pred.store.continue505
  ...
  br i1 %90, label %pred.store.if508, label %pred.store.continue509
...
pred.store.continue509:                           ; preds = %pred.store.if508, %pred.store.continue507
  ...
  br i1 %93, label %pred.store.if510, label %pred.store.continue511
...
pred.store.continue511:                           ; preds = %pred.store.if510, %pred.store.continue509
  ...
  br i1 %96, label %pred.store.if512, label %pred.store.continue513
...
pred.store.continue513:                           ; preds = %pred.store.if512, %pred.store.continue511
  ...
  br i1 %99, label %pred.store.if514, label %pred.store.continue515
...
pred.store.continue515:                           ; preds = %pred.store.if514, %pred.store.continue513
  ...
  br i1 %102, label %pred.store.if516, label %pred.store.continue517
...
pred.store.continue517:                           ; preds = %pred.store.if516, %pred.store.continue515
  ...
  br i1 %105, label %pred.store.if518, label %pred.store.continue519
...
pred.store.continue519:                           ; preds = %pred.store.if518, %pred.store.continue517
  ...
  br i1 %108, label %pred.store.if520, label %pred.store.continue521
...
pred.store.continue521:                           ; preds = %pred.store.if520, %pred.store.continue519
  ...
  br i1 %111, label %pred.store.if522, label %pred.store.continue523
...
pred.store.continue523:                           ; preds = %pred.store.if522, %pred.store.continue521
  ...
  br i1 %113, label %pred.store.if524, label %pred.store.continue525
...
pred.store.continue525:                           ; preds = %pred.store.if524, %pred.store.continue523
  ...
  br i1 %116, label %pred.store.if526, label %pred.store.continue527
...
pred.store.continue527:                           ; preds = %pred.store.if526, %pred.store.continue525
  ...
  br i1 %119, label %pred.store.if528, label %pred.store.continue529
...
pred.store.continue529:                           ; preds = %pred.store.if528, %pred.store.continue527
  ...
  br i1 %122, label %pred.store.if530, label %pred.store.continue531
...
pred.store.continue531:                           ; preds = %pred.store.if530, %pred.store.continue529
  ...
  br i1 %125, label %pred.store.if532, label %pred.store.continue533
...
pred.store.continue533:                           ; preds = %pred.store.if532, %pred.store.continue531
  ...
  br i1 %128, label %pred.store.if534, label %pred.store.continue535
...
pred.store.continue535:                           ; preds = %pred.store.if534, %pred.store.continue533
  ...
  br i1 %131, label %pred.store.if536, label %pred.store.continue537
...
pred.store.continue537:                           ; preds = %pred.store.if536, %pred.store.continue535
  ...
  br i1 %134, label %pred.store.if538, label %pred.store.continue539
...
pred.store.continue539:                           ; preds = %pred.store.if538, %pred.store.continue537
  ...
  br i1 %137, label %pred.store.if540, label %pred.store.continue541
...
pred.store.continue541:                           ; preds = %pred.store.if540, %pred.store.continue539
  ...
  br i1 %140, label %pred.store.if542, label %pred.store.continue543
...
pred.store.continue543:                           ; preds = %pred.store.if542, %pred.store.continue541
  ...
  br i1 %143, label %pred.store.if544, label %pred.store.continue545
...
pred.store.continue545:                           ; preds = %pred.store.if544, %pred.store.continue543
  ...
  br i1 %146, label %pred.store.if546, label %pred.store.continue547
...
pred.store.continue547:                           ; preds = %pred.store.if546, %pred.store.continue545
  ...
  br i1 %149, label %pred.store.if548, label %pred.store.continue549
...
pred.store.continue549:                           ; preds = %pred.store.if548, %pred.store.continue547
  ...
  br i1 %152, label %pred.store.if550, label %pred.store.continue551
...
pred.store.continue551:                           ; preds = %pred.store.if550, %pred.store.continue549
  ...
  br i1 %155, label %pred.store.if552, label %pred.store.continue553
...
vec.epilog.vector.body:                           ; preds = %pred.store.continue553
  %wide.load556 = load <8 x i8>, ptr %3, align 1, !tbaa !23
  %159 = icmp eq <8 x i8> %wide.load556, zeroinitializer
  %160 = extractelement <8 x i1> %159, i64 0
  br i1 %160, label %pred.store.if557, label %pred.store.continue558

pred.store.if557:                                 ; preds = %vec.epilog.vector.body
  store i8 1, ptr %4, align 1, !tbaa !23
  br label %pred.store.continue558

pred.store.continue558:                           ; preds = %pred.store.if557, %vec.epilog.vector.body
  %161 = extractelement <8 x i1> %159, i64 1
  br i1 %161, label %pred.store.if559, label %pred.store.continue560
...
pred.store.continue560:                           ; preds = %pred.store.if559, %pred.store.continue558
  ...
  br i1 %162, label %pred.store.if561, label %pred.store.continue562
...
pred.store.continue562:                           ; preds = %pred.store.if561, %pred.store.continue560
  ...
  br i1 %163, label %pred.store.if563, label %pred.store.continue564
...
pred.store.continue564:                           ; preds = %pred.store.if563, %pred.store.continue562
  ...
  br i1 %164, label %pred.store.if565, label %pred.store.continue566
...
pred.store.continue566:                           ; preds = %pred.store.if565, %pred.store.continue564
  ...
  br i1 %165, label %pred.store.if567, label %pred.store.continue568
...
pred.store.continue568:                           ; preds = %pred.store.if567, %pred.store.continue566
  ...
  br i1 %166, label %pred.store.if569, label %pred.store.continue570
...
pred.store.continue570:                           ; preds = %pred.store.if569, %pred.store.continue568
  ...
  br i1 %167, label %pred.store.if571, label %pred.store.continue572
...
pred.store.continue572:                           ; preds = %pred.store.if571, %pred.store.continue570
  %wide.load556.1 = load <8 x i8>, ptr %12, align 1, !tbaa !23
  %168 = icmp eq <8 x i8> %wide.load556.1, zeroinitializer
  %169 = extractelement <8 x i1> %168, i64 0
  br i1 %169, label %pred.store.if557.1, label %pred.store.continue558.1

pred.store.if557.1:                               ; preds = %pred.store.continue572
  store i8 1, ptr %13, align 1, !tbaa !23
  br label %pred.store.continue558.1

pred.store.continue558.1:                         ; preds = %pred.store.if557.1, %pred.store.continue572
  %170 = extractelement <8 x i1> %168, i64 1
  br i1 %170, label %pred.store.if559.1, label %pred.store.continue560.1

pred.store.if559.1:                               ; preds = %pred.store.continue558.1
  store i8 1, ptr %14, align 2, !tbaa !23
  br label %pred.store.continue560.1

pred.store.continue560.1:                         ; preds = %pred.store.if559.1, %pred.store.continue558.1
  %171 = extractelement <8 x i1> %168, i64 2
  br i1 %171, label %pred.store.if561.1, label %pred.store.continue562.1

pred.store.if561.1:                               ; preds = %pred.store.continue560.1
  store i8 1, ptr %15, align 1, !tbaa !23
  br label %pred.store.continue562.1

pred.store.continue562.1:                         ; preds = %pred.store.if561.1, %pred.store.continue560.1
  %172 = extractelement <8 x i1> %168, i64 3
  br i1 %172, label %pred.store.if563.1, label %pred.store.continue564.1

pred.store.if563.1:                               ; preds = %pred.store.continue562.1
  store i8 1, ptr %16, align 8, !tbaa !23
  br label %pred.store.continue564.1

pred.store.continue564.1:                         ; preds = %pred.store.if563.1, %pred.store.continue562.1
  %173 = extractelement <8 x i1> %168, i64 4
  br i1 %173, label %pred.store.if565.1, label %pred.store.continue566.1

pred.store.if565.1:                               ; preds = %pred.store.continue564.1
  store i8 1, ptr %17, align 1, !tbaa !23
  br label %pred.store.continue566.1

pred.store.continue566.1:                         ; preds = %pred.store.if565.1, %pred.store.continue564.1
  %174 = extractelement <8 x i1> %168, i64 5
  br i1 %174, label %pred.store.if567.1, label %pred.store.continue568.1

pred.store.if567.1:                               ; preds = %pred.store.continue566.1
  store i8 1, ptr %18, align 2, !tbaa !23
  br label %pred.store.continue568.1

pred.store.continue568.1:                         ; preds = %pred.store.if567.1, %pred.store.continue566.1
  %175 = extractelement <8 x i1> %168, i64 6
  br i1 %175, label %pred.store.if569.1, label %pred.store.continue570.1

pred.store.if569.1:                               ; preds = %pred.store.continue568.1
  store i8 1, ptr %19, align 1, !tbaa !23
  br label %pred.store.continue570.1

pred.store.continue570.1:                         ; preds = %pred.store.if569.1, %pred.store.continue568.1
  %176 = extractelement <8 x i1> %168, i64 7
  br i1 %176, label %pred.store.if571.1, label %pred.store.continue572.1

pred.store.if571.1:                               ; preds = %pred.store.continue570.1
  store i8 1, ptr %20, align 4, !tbaa !23
  br label %pred.store.continue572.1

pred.store.continue572.1:                         ; preds = %pred.store.if571.1, %pred.store.continue570.1
  %wide.load556.2 = load <8 x i8>, ptr %21, align 1, !tbaa !23
  %177 = icmp eq <8 x i8> %wide.load556.2, zeroinitializer
  %178 = extractelement <8 x i1> %177, i64 0
  br i1 %178, label %pred.store.if557.2, label %pred.store.continue558.2

pred.store.if557.2:                               ; preds = %pred.store.continue572.1
  store i8 1, ptr %22, align 1, !tbaa !23
  br label %pred.store.continue558.2

pred.store.continue558.2:                         ; preds = %pred.store.if557.2, %pred.store.continue572.1
  %179 = extractelement <8 x i1> %177, i64 1
  br i1 %179, label %pred.store.if559.2, label %pred.store.continue560.2

pred.store.if559.2:                               ; preds = %pred.store.continue558.2
  store i8 1, ptr %23, align 2, !tbaa !23
  br label %pred.store.continue560.2

pred.store.continue560.2:                         ; preds = %pred.store.if559.2, %pred.store.continue558.2
  %180 = extractelement <8 x i1> %177, i64 2
  br i1 %180, label %pred.store.if561.2, label %pred.store.continue562.2

pred.store.if561.2:                               ; preds = %pred.store.continue560.2
  store i8 1, ptr %24, align 1, !tbaa !23
  br label %pred.store.continue562.2

pred.store.continue562.2:                         ; preds = %pred.store.if561.2, %pred.store.continue560.2
  %181 = extractelement <8 x i1> %177, i64 3
  br i1 %181, label %pred.store.if563.2, label %pred.store.continue564.2

pred.store.if563.2:                               ; preds = %pred.store.continue562.2
  store i8 1, ptr %25, align 8, !tbaa !23
  br label %pred.store.continue564.2

pred.store.continue564.2:                         ; preds = %pred.store.if563.2, %pred.store.continue562.2
  %182 = extractelement <8 x i1> %177, i64 4
  br i1 %182, label %pred.store.if565.2, label %pred.store.continue566.2

pred.store.if565.2:                               ; preds = %pred.store.continue564.2
  store i8 1, ptr %26, align 1, !tbaa !23
  br label %pred.store.continue566.2

pred.store.continue566.2:                         ; preds = %pred.store.if565.2, %pred.store.continue564.2
  %183 = extractelement <8 x i1> %177, i64 5
  br i1 %183, label %pred.store.if567.2, label %pred.store.continue568.2

pred.store.if567.2:                               ; preds = %pred.store.continue566.2
  store i8 1, ptr %27, align 2, !tbaa !23
  br label %pred.store.continue568.2

pred.store.continue568.2:                         ; preds = %pred.store.if567.2, %pred.store.continue566.2
  %184 = extractelement <8 x i1> %177, i64 6
  br i1 %184, label %pred.store.if569.2, label %pred.store.continue570.2

pred.store.if569.2:                               ; preds = %pred.store.continue568.2
  store i8 1, ptr %28, align 1, !tbaa !23
  br label %pred.store.continue570.2

pred.store.continue570.2:                         ; preds = %pred.store.if569.2, %pred.store.continue568.2
  %185 = extractelement <8 x i1> %177, i64 7
  br i1 %185, label %pred.store.if571.2, label %for.body99

pred.store.if571.2:                               ; preds = %pred.store.continue570.2
  store i8 1, ptr %29, align 4, !tbaa !23
  br label %for.body99

for.body99:                                       ; preds = %pred.store.continue570.2, %pred.store.if571.2
...
if.then119:                                       ; preds = %while.body.3, %while.body.2, %while.body.1, %while.body, %land.rhs
  ...
  %arrayidx115.le = getelementptr inbounds %"class.NCompress::NShrink::CDecoder", ptr %this, i64 0, i32 5, i64 %indvars.iv461.lcssa
  %198 = trunc i64 %indvars.iv461.lcssa to i32
  store i8 0, ptr %arrayidx115.le, align 1, !tbaa !23
  %conv = trunc i32 %lastSymbol.0 to i16
  %arrayidx125 = getelementptr inbounds %"class.NCompress::NShrink::CDecoder", ptr %this, i64 0, i32 2, i64 %indvars.iv461.lcssa
...
while.cond179.preheader:                          ; preds = %_ZN10COutBuffer9WriteByteEh.exit
  %cmp180419 = icmp ult i32 %head.0, 8192
  br i1 %cmp180419, label %land.rhs181.preheader, label %if.end202
...
if.then192:                                       ; preds = %land.rhs181
  %arrayidx184.le = getelementptr inbounds %"class.NCompress::NShrink::CDecoder", ptr %this, i64 0, i32 5, i64 %indvars.iv442
  %214 = trunc i64 %indvars.iv442 to i32
  store i8 0, ptr %arrayidx184.le, align 1, !tbaa !23
  %conv196 = trunc i32 %and.i to i16
  %arrayidx199 = getelementptr inbounds %"class.NCompress::NShrink::CDecoder", ptr %this, i64 0, i32 2, i64 %indvars.iv442
...
_ZN10COutBufferD2Ev.exit:                         ; preds = %invoke.cont.i, %if.then.i.i384
  ...
  invoke void @_ZN9CInBuffer4FreeEv(ptr noundef nonnull align 8 dereferenceable(45) %m_Stream.i)
          to label %invoke.cont.i.i unwind label %terminate.lpad.i.i386
...
invoke.cont.i.i:                                  ; preds = %_ZN10COutBufferD2Ev.exit
  ...
  br i1 %tobool.not.i.i.i, label %_ZN5NBitl12CBaseDecoderI9CInBufferED2Ev.exit, label %if.then.i.i.i387

if.then.i.i.i387:                                 ; preds = %invoke.cont.i.i
...
terminate.lpad.i.i.i:                             ; preds = %if.then.i.i.i387
...
terminate.lpad.i.i386:                            ; preds = %_ZN10COutBufferD2Ev.exit
...
_ZN5NBitl12CBaseDecoderI9CInBufferED2Ev.exit:     ; preds = %invoke.cont.i.i, %if.then.i.i.i387
...
ehcleanup251:                                     ; preds = %lpad235, %lpad176, %ehcleanup225, %lpad54, %lpad39, %lpad3
  %.pn329.pn = phi { ptr, i32 } [ %2, %lpad3 ], [ %225, %lpad235 ], [ %51, %lpad54 ], [ %40, %lpad39 ], [ %212, %lpad176 ], [ %.pn.pn, %ehcleanup225 ]
