; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Compress/ByteSwap.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Compress/ByteSwap.cpp"
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <16 x i8> %interleaved.vec, ptr %69, align 1
...
for.body:                                         ; preds = %for.body.preheader32, %for.body
  ...
  %73 = load i8, ptr %arrayidx4, align 1
  store i8 %73, ptr %arrayidx, align 1
  store i8 %71, ptr %arrayidx4, align 1
...
define linkonce_odr dso_local void @_ZN8IUnknownD2Ev(ptr noundef nonnull align 8 dereferenceable(8) %this) unnamed_addr #5 comdat align 2 {
entry:
  ret void
}
...
declare void @_Z13RegisterCodecPK10CCodecInfo(ptr noundef) local_unnamed_addr #6

; Function Attrs: uwtable
define internal noalias noundef nonnull ptr @_ZL12CreateCodec2v() #7 personality ptr @__gxx_personality_v0 {
invoke.cont:
  %call = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znwm(i64 noundef 16) #13
  %0 = getelementptr inbounds i8, ptr %call, i64 8
  store i32 0, ptr %0, align 4
  store ptr getelementptr inbounds ({ [9 x ptr] }, ptr @_ZTV10CByteSwap2, i64 0, inrange i32 0, i64 2), ptr %call, align 8
  ret ptr %call
}

; Function Attrs: uwtable
define internal noalias noundef nonnull ptr @_ZL12CreateCodec4v() #7 personality ptr @__gxx_personality_v0 {
entry:
  %call = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znwm(i64 noundef 16) #13
  %0 = getelementptr inbounds i8, ptr %call, i64 8
  store i32 0, ptr %0, align 4
  store ptr getelementptr inbounds ({ [9 x ptr] }, ptr @_ZTV10CByteSwap4, i64 0, inrange i32 0, i64 2), ptr %call, align 8
  ret ptr %call
}
...
; Function Attrs: uwtable
define internal void @_GLOBAL__sub_I_ByteSwap.cpp() #7 section ".text.startup" {
entry:
