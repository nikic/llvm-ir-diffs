...
for.cond.i15:                                     ; preds = %if.end
  ...
  %33 = load i8, ptr %arrayidx.1.i16, align 1, !tbaa !16
...
for.cond.1.i18:                                   ; preds = %for.cond.i15
  ...
  %35 = load i8, ptr %arrayidx.2.i19, align 2, !tbaa !16
...
for.cond.2.i21:                                   ; preds = %for.cond.1.i18
  ...
  %37 = load i8, ptr %arrayidx.3.i22, align 1, !tbaa !16
...
for.cond.3.i24:                                   ; preds = %for.cond.2.i21
  ...
  %39 = load i8, ptr %arrayidx.4.i25, align 4, !tbaa !16
...
for.cond.4.i27:                                   ; preds = %for.cond.3.i24
  ...
  %41 = load i8, ptr %arrayidx.5.i28, align 1, !tbaa !16
...
for.cond.5.i30:                                   ; preds = %for.cond.4.i27
  ...
  %43 = load i8, ptr %arrayidx.6.i31, align 2, !tbaa !16
...
for.cond.6.i33:                                   ; preds = %for.cond.5.i30
  ...
  %45 = load i8, ptr %arrayidx.7.i34, align 1, !tbaa !16
...
for.cond.7.i36:                                   ; preds = %for.cond.6.i33
  ...
  %47 = load i8, ptr %arrayidx.8.i37, align 4, !tbaa !16
...
for.cond.8.i39:                                   ; preds = %for.cond.7.i36
  ...
  %49 = load i8, ptr %arrayidx.9.i40, align 1, !tbaa !16
...
for.cond.9.i42:                                   ; preds = %for.cond.8.i39
  ...
  %51 = load i8, ptr %arrayidx.10.i43, align 2, !tbaa !16
...
for.cond.10.i45:                                  ; preds = %for.cond.9.i42
  ...
  %53 = load i8, ptr %arrayidx.11.i46, align 1, !tbaa !16
...
for.cond.11.i48:                                  ; preds = %for.cond.10.i45
  ...
  %55 = load i8, ptr %arrayidx.12.i49, align 4, !tbaa !16
...
for.cond.12.i51:                                  ; preds = %for.cond.11.i48
  ...
  %57 = load i8, ptr %arrayidx.13.i52, align 1, !tbaa !16
...
for.cond.13.i54:                                  ; preds = %for.cond.12.i51
  ...
  %59 = load i8, ptr %arrayidx.14.i55, align 2, !tbaa !16
...
_ZeqRK4GUIDS1_.exit61:                            ; preds = %for.cond.13.i54
  ...
  %61 = load i8, ptr %arrayidx.15.i58, align 1, !tbaa !16
