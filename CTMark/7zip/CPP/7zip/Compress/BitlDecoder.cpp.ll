...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %vec.ind = phi <16 x i8> [ <i8 0, i8 1, i8 2, i8 3, i8 4, i8 5, i8 6, i8 7, i8 8, i8 9, i8 10, i8 11, i8 12, i8 13, i8 14, i8 15>, %entry ], [ %vec.ind.next, %vector.body ]
  %0 = tail call <16 x i8> @llvm.bitreverse.v16i8(<16 x i8> %vec.ind)
  %1 = getelementptr inbounds [256 x i8], ptr @_ZN5NBitl12kInvertTableE, i64 0, i64 %index
  store <16 x i8> %0, ptr %1, align 16, !tbaa !5
  ...
  br i1 %2, label %__cxx_global_var_init.exit, label %vector.body, !llvm.loop !8
