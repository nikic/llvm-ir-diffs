...
invoke.cont6:
  ...
  store ptr getelementptr inbounds ({ [14 x ptr], [8 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress8NDeflate8NDecoder6CCoderE, i64 0, inrange i32 1, i64 2), ptr %0, align 8
  store ptr getelementptr inbounds ({ [14 x ptr], [8 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress8NDeflate8NDecoder6CCoderE, i64 0, inrange i32 2, i64 2), ptr %1, align 8
  store ptr getelementptr inbounds ({ [14 x ptr], [8 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress8NDeflate8NDecoder6CCoderE, i64 0, inrange i32 3, i64 2), ptr %2, align 8
  store ptr getelementptr inbounds ({ [14 x ptr], [8 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress8NDeflate8NDecoder6CCoderE, i64 0, inrange i32 4, i64 2), ptr %3, align 8
...
for.body.i.i:                                     ; preds = %if.end.i.i, %for.body.lr.ph.i.i
  %0 = load ptr, ptr %m_Stream.i.i, align 8
  %1 = load ptr, ptr %_bufferLimit.i.i.i, align 8
...
if.then.i.i:                                      ; preds = %if.then.i.i.i
  %4 = load i32, ptr %NumExtraBytes.i.i, align 8
  %inc.i.i = add i32 %4, 1
...
if.end.i.i:                                       ; preds = %if.then.i.i, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i
  ...
  %5 = load i32, ptr %m_InBitStream, align 8
  %sub.i.i = sub i32 32, %5
  %shl.i.i = shl i32 %conv.i.i, %sub.i.i
  %6 = load i32, ptr %m_NormalValue.i.i, align 4
...
if.end:                                           ; preds = %if.then5
  %.pr.i.i.i = load i32, ptr %m_InBitStream, align 8
...
entry._ZN5NBitl8CDecoderI9CInBufferE9NormalizeEv.exit_crit_edge.i.i: ; preds = %if.end
  %.pre.i.i = load i32, ptr %m_NormalValue.phi.trans.insert.i.i67, align 4
  br label %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit

for.body.i.i.i:                                   ; preds = %if.end, %if.end.i.i.i
  %1 = load ptr, ptr %m_Stream.i.i.i74, align 8
  %2 = load ptr, ptr %_bufferLimit.i.i.i.i75, align 8
...
if.then.if.end3_crit_edge.i.i.i.i:                ; preds = %if.then.i.i.i.i
  %.pre.i.i.i.i = load ptr, ptr %m_Stream.i.i.i74, align 8
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i:      ; preds = %if.then.if.end3_crit_edge.i.i.i.i, %for.body.i.i.i
  ...
  store ptr %incdec.ptr.i.i.i.i, ptr %m_Stream.i.i.i74, align 8
  %4 = load i8, ptr %3, align 1
  br label %if.end.i.i.i

if.then.i.i.i:                                    ; preds = %if.then.i.i.i.i
  %5 = load i32, ptr %NumExtraBytes.i.i.i76, align 8
  %inc.i.i.i = add i32 %5, 1
  store i32 %inc.i.i.i, ptr %NumExtraBytes.i.i.i76, align 8
  br label %if.end.i.i.i
...
if.end.i.i.i:                                     ; preds = %if.then.i.i.i, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i
  ...
  %7 = load i32, ptr %m_NormalValue.phi.trans.insert.i.i67, align 4
  %or.i.i.i = or i32 %shl.i.i.i, %7
  store i32 %or.i.i.i, ptr %m_NormalValue.phi.trans.insert.i.i67, align 4
  %8 = load i32, ptr %m_Value.i.i.i78, align 4
  ...
  store i32 %or6.i.i.i, ptr %m_Value.i.i.i78, align 4
  %sub9.i.i.i = add i32 %6, -8
  store i32 %sub9.i.i.i, ptr %m_InBitStream, align 8
  %cmp.i.i.i = icmp ugt i32 %sub9.i.i.i, 7
  br i1 %cmp.i.i.i, label %for.body.i.i.i, label %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit
...
_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit: ; preds = %if.end.i.i.i, %entry._ZN5NBitl8CDecoderI9CInBufferE9NormalizeEv.exit_crit_edge.i.i
  ...
  store i32 %add.i.i.i, ptr %m_InBitStream, align 8
  %shr.i.i.i = lshr i32 %11, 2
  store i32 %shr.i.i.i, ptr %m_NormalValue.phi.trans.insert.i.i67, align 4
...
for.body.2:                                       ; preds = %for.body.1
  ...
  br i1 %13, label %for.body.3, label %cleanup.loopexit156

for.body.3:                                       ; preds = %for.body.2
  %arrayidx14.3 = getelementptr inbounds i8, ptr %values, i64 %indvars.iv.next.2
  store i8 %load_initial, ptr %arrayidx14.3, align 1
  ...
  br i1 %14, label %for.body.4, label %cleanup.loopexit156

for.body.4:                                       ; preds = %for.body.3
  %arrayidx14.4 = getelementptr inbounds i8, ptr %values, i64 %indvars.iv.next.3
  store i8 %load_initial, ptr %arrayidx14.4, align 1
...
entry._ZN5NBitl8CDecoderI9CInBufferE9NormalizeEv.exit_crit_edge.i.i66: ; preds = %if.then19
  %.pre.i.i68 = load i32, ptr %m_NormalValue.phi.trans.insert.i.i67, align 4
  br label %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit102

for.body.i.i.i79:                                 ; preds = %if.then19, %if.end.i.i.i85
  %17 = load ptr, ptr %m_Stream.i.i.i74, align 8
  %18 = load ptr, ptr %_bufferLimit.i.i.i.i75, align 8
...
if.then.if.end3_crit_edge.i.i.i.i98:              ; preds = %if.then.i.i.i.i81
  %.pre.i.i.i.i99 = load ptr, ptr %m_Stream.i.i.i74, align 8
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i100:   ; preds = %if.then.if.end3_crit_edge.i.i.i.i98, %for.body.i.i.i79
  ...
  store ptr %incdec.ptr.i.i.i.i101, ptr %m_Stream.i.i.i74, align 8
  %20 = load i8, ptr %19, align 1
  br label %if.end.i.i.i85

if.then.i.i.i83:                                  ; preds = %if.then.i.i.i.i81
  %21 = load i32, ptr %NumExtraBytes.i.i.i76, align 8
  %inc.i.i.i84 = add i32 %21, 1
  store i32 %inc.i.i.i84, ptr %NumExtraBytes.i.i.i76, align 8
  br label %if.end.i.i.i85
...
if.end.i.i.i85:                                   ; preds = %if.then.i.i.i83, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i100
  ...
  %22 = load i32, ptr %m_InBitStream, align 8
  %sub.i.i.i88 = sub i32 32, %22
  %shl.i.i.i89 = shl i32 %conv.i.i.i87, %sub.i.i.i88
  %23 = load i32, ptr %m_NormalValue.phi.trans.insert.i.i67, align 4
  %or.i.i.i90 = or i32 %shl.i.i.i89, %23
  store i32 %or.i.i.i90, ptr %m_NormalValue.phi.trans.insert.i.i67, align 4
  %24 = load i32, ptr %m_Value.i.i.i78, align 4
  ...
  %25 = load i8, ptr %arrayidx.i.i.i93, align 1
  %conv5.i.i.i94 = zext i8 %25 to i32
  %or6.i.i.i95 = or i32 %shl4.i.i.i91, %conv5.i.i.i94
  store i32 %or6.i.i.i95, ptr %m_Value.i.i.i78, align 4
  %sub9.i.i.i96 = add i32 %22, -8
  store i32 %sub9.i.i.i96, ptr %m_InBitStream, align 8
  %cmp.i.i.i97 = icmp ugt i32 %sub9.i.i.i96, 7
  br i1 %cmp.i.i.i97, label %for.body.i.i.i79, label %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit102
...
_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit102: ; preds = %if.end.i.i.i85, %entry._ZN5NBitl8CDecoderI9CInBufferE9NormalizeEv.exit_crit_edge.i.i66
  ...
  store i32 %add.i.i.i71, ptr %m_InBitStream, align 8
  %shr.i.i.i72 = lshr i32 %27, 3
  store i32 %shr.i.i.i72, ptr %m_NormalValue.phi.trans.insert.i.i67, align 4
  %add21 = add nuw nsw i32 %and.i.i70, 3
  br label %if.end25

if.else22:                                        ; preds = %if.then3
  %.pr.i.i.i104 = load i32, ptr %m_InBitStream, align 8
...
entry._ZN5NBitl8CDecoderI9CInBufferE9NormalizeEv.exit_crit_edge.i.i106: ; preds = %if.else22
  %.pre.i.i108 = load i32, ptr %m_NormalValue.phi.trans.insert.i.i67, align 4
  br label %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit142

for.body.i.i.i119:                                ; preds = %if.else22, %if.end.i.i.i125
  %28 = load ptr, ptr %m_Stream.i.i.i74, align 8
  %29 = load ptr, ptr %_bufferLimit.i.i.i.i75, align 8
...
if.then.if.end3_crit_edge.i.i.i.i138:             ; preds = %if.then.i.i.i.i121
  %.pre.i.i.i.i139 = load ptr, ptr %m_Stream.i.i.i74, align 8
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i140:   ; preds = %if.then.if.end3_crit_edge.i.i.i.i138, %for.body.i.i.i119
  ...
  store ptr %incdec.ptr.i.i.i.i141, ptr %m_Stream.i.i.i74, align 8
  %31 = load i8, ptr %30, align 1
  br label %if.end.i.i.i125

if.then.i.i.i123:                                 ; preds = %if.then.i.i.i.i121
  %32 = load i32, ptr %NumExtraBytes.i.i.i76, align 8
  %inc.i.i.i124 = add i32 %32, 1
  store i32 %inc.i.i.i124, ptr %NumExtraBytes.i.i.i76, align 8
  br label %if.end.i.i.i125
...
if.end.i.i.i125:                                  ; preds = %if.then.i.i.i123, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i140
  ...
  %33 = load i32, ptr %m_InBitStream, align 8
  %sub.i.i.i128 = sub i32 32, %33
  %shl.i.i.i129 = shl i32 %conv.i.i.i127, %sub.i.i.i128
  %34 = load i32, ptr %m_NormalValue.phi.trans.insert.i.i67, align 4
  %or.i.i.i130 = or i32 %shl.i.i.i129, %34
  store i32 %or.i.i.i130, ptr %m_NormalValue.phi.trans.insert.i.i67, align 4
  %35 = load i32, ptr %m_Value.i.i.i78, align 4
  ...
  %36 = load i8, ptr %arrayidx.i.i.i133, align 1
  %conv5.i.i.i134 = zext i8 %36 to i32
  %or6.i.i.i135 = or i32 %shl4.i.i.i131, %conv5.i.i.i134
  store i32 %or6.i.i.i135, ptr %m_Value.i.i.i78, align 4
  %sub9.i.i.i136 = add i32 %33, -8
  store i32 %sub9.i.i.i136, ptr %m_InBitStream, align 8
  %cmp.i.i.i137 = icmp ugt i32 %sub9.i.i.i136, 7
  br i1 %cmp.i.i.i137, label %for.body.i.i.i119, label %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit142
...
_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit142: ; preds = %if.end.i.i.i125, %entry._ZN5NBitl8CDecoderI9CInBufferE9NormalizeEv.exit_crit_edge.i.i106
  ...
  store i32 %add.i.i.i111, ptr %m_InBitStream, align 8
  %shr.i.i.i112 = lshr i32 %38, 7
  store i32 %shr.i.i.i112, ptr %m_NormalValue.phi.trans.insert.i.i67, align 4
...
for.body31.preheader:                             ; preds = %if.end25
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %scevgep, i8 0, i64 %44, i1 false)
  br label %for.body31
...
for.body31:                                       ; preds = %for.body31.preheader, %for.body31
  ...
  br i1 %45, label %for.body31, label %cleanup.loopexit
...
cleanup:                                          ; preds = %cleanup.loopexit156, %cleanup.loopexit, %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit, %if.end25, %if.then
  ...
  br i1 %cmp42, label %do.body, label %cleanup43
...
if.end.i.i:                                       ; preds = %if.then.i.i, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i
  %b.1.i.i = phi i8 [ -1, %if.then.i.i ], [ %3, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i ]
  %conv.i.i = zext i8 %b.1.i.i to i32
  %5 = load i32, ptr %bitStream, align 8
  %sub.i.i = sub i32 32, %5
  %shl.i.i = shl i32 %conv.i.i, %sub.i.i
  %6 = load i32, ptr %m_NormalValue.i.i, align 4
  %or.i.i = or i32 %shl.i.i, %6
  ...
  store i32 %or6.i.i, ptr %m_Value.i.i, align 4
  %sub9.i.i = add i32 %5, -8
  store i32 %sub9.i.i, ptr %bitStream, align 8
  %cmp.i.i = icmp ugt i32 %sub9.i.i, 7
  br i1 %cmp.i.i, label %for.body.i.i, label %_ZN5NBitl8CDecoderI9CInBufferE8GetValueEj.exit
...
if.end:                                           ; preds = %if.end.loopexit, %if.then
  ...
  %15 = load i32, ptr %m_NormalValue.i, align 4
  %shr.i32 = lshr i32 %15, %numBits.1
  store i32 %shr.i32, ptr %m_NormalValue.i, align 4
...
entry:
  %lenCounts.i368 = alloca [16 x i32], align 16
  %tmpPositions.i369 = alloca [16 x i32], align 16
  ...
  %.pr.i.i.i = load i32, ptr %m_InBitStream.i, align 8
  %cmp13.i.i.i = icmp ugt i32 %.pr.i.i.i, 7
...
entry._ZN5NBitl8CDecoderI9CInBufferE9NormalizeEv.exit_crit_edge.i.i: ; preds = %entry
  ...
  %.pre.i.i = load i32, ptr %m_NormalValue.phi.trans.insert.i.i, align 4
  br label %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit
...
for.body.i.i.i:                                   ; preds = %if.end.i.i.i, %for.body.lr.ph.i.i.i
  %0 = load ptr, ptr %m_Stream.i.i.i, align 8
  %1 = load ptr, ptr %_bufferLimit.i.i.i.i, align 8
...
if.then.if.end3_crit_edge.i.i.i.i:                ; preds = %if.then.i.i.i.i
  %.pre.i.i.i.i = load ptr, ptr %m_Stream.i.i.i, align 8
  br label %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i
...
if.then.i.i.i:                                    ; preds = %if.then.i.i.i.i
  %4 = load i32, ptr %NumExtraBytes.i.i.i, align 8
  %inc.i.i.i = add i32 %4, 1
  store i32 %inc.i.i.i, ptr %NumExtraBytes.i.i.i, align 8
  br label %if.end.i.i.i

if.end.i.i.i:                                     ; preds = %if.then.i.i.i, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i
  %b.1.i.i.i = phi i8 [ -1, %if.then.i.i.i ], [ %3, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i ]
  %conv.i.i.i = zext i8 %b.1.i.i.i to i32
  %5 = load i32, ptr %m_InBitStream.i, align 8
  %sub.i.i.i = sub i32 32, %5
  %shl.i.i.i = shl i32 %conv.i.i.i, %sub.i.i.i
  %6 = load i32, ptr %m_NormalValue.i.i.i, align 4
  %or.i.i.i = or i32 %shl.i.i.i, %6
  store i32 %or.i.i.i, ptr %m_NormalValue.i.i.i, align 4
  ...
  %or6.i.i.i = or i32 %shl4.i.i.i, %conv5.i.i.i
  store i32 %or6.i.i.i, ptr %m_Value.i.i.i, align 4
  %sub9.i.i.i = add i32 %5, -8
  store i32 %sub9.i.i.i, ptr %m_InBitStream.i, align 8
  %cmp.i.i.i = icmp ugt i32 %sub9.i.i.i, 7
  br i1 %cmp.i.i.i, label %for.body.i.i.i, label %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit
...
_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit: ; preds = %if.end.i.i.i, %entry._ZN5NBitl8CDecoderI9CInBufferE9NormalizeEv.exit_crit_edge.i.i
  ...
  store i32 %add.i.i.i, ptr %m_InBitStream.i, align 8
  %shr.i.i.i = lshr i32 %10, 1
  store i32 %shr.i.i.i, ptr %m_NormalValue.i.i, align 4
  ...
  store i8 %frombool, ptr %m_FinalBlock, align 8
...
for.body.i.i.i100:                                ; preds = %if.end.i.i.i106, %for.body.lr.ph.i.i.i94
  %12 = load ptr, ptr %m_Stream.i.i.i95, align 8
  %13 = load ptr, ptr %_bufferLimit.i.i.i.i96, align 8
...
if.then.if.end3_crit_edge.i.i.i.i119:             ; preds = %if.then.i.i.i.i102
  %.pre.i.i.i.i120 = load ptr, ptr %m_Stream.i.i.i95, align 8
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i121:   ; preds = %if.then.if.end3_crit_edge.i.i.i.i119, %for.body.i.i.i100
  ...
  store ptr %incdec.ptr.i.i.i.i122, ptr %m_Stream.i.i.i95, align 8
  %15 = load i8, ptr %14, align 1
  br label %if.end.i.i.i106

if.then.i.i.i104:                                 ; preds = %if.then.i.i.i.i102
  %16 = load i32, ptr %NumExtraBytes.i.i.i97, align 8
  %inc.i.i.i105 = add i32 %16, 1
  store i32 %inc.i.i.i105, ptr %NumExtraBytes.i.i.i97, align 8
  br label %if.end.i.i.i106
...
if.end.i.i.i106:                                  ; preds = %if.then.i.i.i104, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i121
  ...
  %17 = load i32, ptr %m_InBitStream.i, align 8
  %sub.i.i.i109 = sub i32 32, %17
  %shl.i.i.i110 = shl i32 %conv.i.i.i108, %sub.i.i.i109
  %18 = load i32, ptr %m_NormalValue.i.i, align 4
  %or.i.i.i111 = or i32 %shl.i.i.i110, %18
  store i32 %or.i.i.i111, ptr %m_NormalValue.i.i, align 4
  %19 = load i32, ptr %m_Value.i.i.i99, align 4
  ...
  %20 = load i8, ptr %arrayidx.i.i.i114, align 1
  %conv5.i.i.i115 = zext i8 %20 to i32
  %or6.i.i.i116 = or i32 %shl4.i.i.i112, %conv5.i.i.i115
  store i32 %or6.i.i.i116, ptr %m_Value.i.i.i99, align 4
  %sub9.i.i.i117 = add i32 %17, -8
  store i32 %sub9.i.i.i117, ptr %m_InBitStream.i, align 8
  %cmp.i.i.i118 = icmp ugt i32 %sub9.i.i.i117, 7
  br i1 %cmp.i.i.i118, label %for.body.i.i.i100, label %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit123
...
_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit123: ; preds = %if.end.i.i.i106, %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit
  ...
  store i32 %add.i.i.i92, ptr %m_InBitStream.i, align 8
  %shr.i.i.i93 = lshr i32 %22, 2
  store i32 %shr.i.i.i93, ptr %m_NormalValue.i.i, align 4
...
if.then5:                                         ; preds = %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit123
  ...
  store i8 1, ptr %m_StoredMode, align 1
  %sub.i = sub nsw i32 6, %21
  %and.i = and i32 %sub.i, 7
  %add.i.i = add nuw nsw i32 %and.i, %add.i.i.i92
  store i32 %add.i.i, ptr %m_InBitStream.i, align 8
  %shr.i.i = lshr i32 %shr.i.i.i93, %and.i
  store i32 %shr.i.i, ptr %m_NormalValue.i.i, align 4
...
for.body.i.i.i141:                                ; preds = %if.end.i.i.i147, %for.body.lr.ph.i.i.i135
  %23 = load ptr, ptr %m_Stream.i.i.i136, align 8
  %24 = load ptr, ptr %_bufferLimit.i.i.i.i137, align 8
...
if.then.if.end3_crit_edge.i.i.i.i160:             ; preds = %if.then.i.i.i.i143
  %.pre.i.i.i.i161 = load ptr, ptr %m_Stream.i.i.i136, align 8
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i162:   ; preds = %if.then.if.end3_crit_edge.i.i.i.i160, %for.body.i.i.i141
  ...
  store ptr %incdec.ptr.i.i.i.i163, ptr %m_Stream.i.i.i136, align 8
  %26 = load i8, ptr %25, align 1
  br label %if.end.i.i.i147

if.then.i.i.i145:                                 ; preds = %if.then.i.i.i.i143
  %27 = load i32, ptr %NumExtraBytes.i.i.i138, align 8
  %inc.i.i.i146 = add i32 %27, 1
  store i32 %inc.i.i.i146, ptr %NumExtraBytes.i.i.i138, align 8
  br label %if.end.i.i.i147
...
if.end.i.i.i147:                                  ; preds = %if.then.i.i.i145, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i162
  ...
  %28 = load i32, ptr %m_InBitStream.i, align 8
  %sub.i.i.i150 = sub i32 32, %28
  %shl.i.i.i151 = shl i32 %conv.i.i.i149, %sub.i.i.i150
  %29 = load i32, ptr %m_NormalValue.i.i, align 4
  %or.i.i.i152 = or i32 %shl.i.i.i151, %29
  store i32 %or.i.i.i152, ptr %m_NormalValue.i.i, align 4
  %30 = load i32, ptr %m_Value.i.i.i140, align 4
  ...
  %31 = load i8, ptr %arrayidx.i.i.i155, align 1
  %conv5.i.i.i156 = zext i8 %31 to i32
  %or6.i.i.i157 = or i32 %shl4.i.i.i153, %conv5.i.i.i156
  store i32 %or6.i.i.i157, ptr %m_Value.i.i.i140, align 4
  %sub9.i.i.i158 = add i32 %28, -8
  store i32 %sub9.i.i.i158, ptr %m_InBitStream.i, align 8
  %cmp.i.i.i159 = icmp ugt i32 %sub9.i.i.i158, 7
  br i1 %cmp.i.i.i159, label %for.body.i.i.i141, label %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit164
...
_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit164: ; preds = %if.end.i.i.i147, %if.then5
  ...
  store i32 %add.i.i.i133, ptr %m_InBitStream.i, align 8
  %shr.i.i.i134 = lshr i32 %33, 16
  store i32 %shr.i.i.i134, ptr %m_NormalValue.i.i, align 4
  %m_StoredBlockSize = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 12
  store i32 %and.i.i132, ptr %m_StoredBlockSize, align 4
  %_deflateNSIS = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 17
  %34 = load i8, ptr %_deflateNSIS, align 8
...
for.body.i.i.i181:                                ; preds = %if.end.i.i.i187, %for.body.lr.ph.i.i.i175
  %35 = load ptr, ptr %m_Stream.i.i.i176, align 8
  %36 = load ptr, ptr %_bufferLimit.i.i.i.i177, align 8
...
if.then.if.end3_crit_edge.i.i.i.i200:             ; preds = %if.then.i.i.i.i183
  %.pre.i.i.i.i201 = load ptr, ptr %m_Stream.i.i.i176, align 8
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i202:   ; preds = %if.then.if.end3_crit_edge.i.i.i.i200, %for.body.i.i.i181
  ...
  store ptr %incdec.ptr.i.i.i.i203, ptr %m_Stream.i.i.i176, align 8
  %38 = load i8, ptr %37, align 1
  br label %if.end.i.i.i187

if.then.i.i.i185:                                 ; preds = %if.then.i.i.i.i183
  %39 = load i32, ptr %NumExtraBytes.i.i.i178, align 8
  %inc.i.i.i186 = add i32 %39, 1
  store i32 %inc.i.i.i186, ptr %NumExtraBytes.i.i.i178, align 8
  br label %if.end.i.i.i187
...
if.end.i.i.i187:                                  ; preds = %if.then.i.i.i185, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i202
  ...
  %40 = load i32, ptr %m_InBitStream.i, align 8
  %sub.i.i.i190 = sub i32 32, %40
  %shl.i.i.i191 = shl i32 %conv.i.i.i189, %sub.i.i.i190
  %41 = load i32, ptr %m_NormalValue.i.i, align 4
  %or.i.i.i192 = or i32 %shl.i.i.i191, %41
  store i32 %or.i.i.i192, ptr %m_NormalValue.i.i, align 4
  %42 = load i32, ptr %m_Value.i.i.i180, align 4
  ...
  %43 = load i8, ptr %arrayidx.i.i.i195, align 1
  %conv5.i.i.i196 = zext i8 %43 to i32
  %or6.i.i.i197 = or i32 %shl4.i.i.i193, %conv5.i.i.i196
  store i32 %or6.i.i.i197, ptr %m_Value.i.i.i180, align 4
  %sub9.i.i.i198 = add i32 %40, -8
  store i32 %sub9.i.i.i198, ptr %m_InBitStream.i, align 8
  %cmp.i.i.i199 = icmp ugt i32 %sub9.i.i.i198, 7
  br i1 %cmp.i.i.i199, label %for.body.i.i.i181, label %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit204

_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit204: ; preds = %if.end.i.i.i187
  %and.i.i172 = and i32 %or.i.i.i192, 65535
  %add.i.i.i173 = add nuw nsw i32 %40, 8
  store i32 %add.i.i.i173, ptr %m_InBitStream.i, align 8
  %shr.i.i.i174 = lshr i32 %or.i.i.i192, 16
  store i32 %shr.i.i.i174, ptr %m_NormalValue.i.i, align 4
  %conv11 = xor i32 %and.i.i172, 65535
  %cmp12 = icmp eq i32 %and.i.i132, %conv11
  br label %cleanup73
...
if.end13:                                         ; preds = %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit123
  ...
  store i8 0, ptr %m_StoredMode14, align 1
  call void @llvm.lifetime.start.p0(i64 320, ptr nonnull %levels) #13
  %cmp15 = icmp eq i32 %and.i.i91, 1
  br i1 %cmp15, label %if.then16, label %if.else

if.then16:                                        ; preds = %if.end13
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(144) %levels, i8 8, i64 144, i1 false)
  %scevgep.i = getelementptr inbounds i8, ptr %levels, i64 144
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(112) %scevgep.i, i8 9, i64 112, i1 false)
  %scevgep62.i = getelementptr inbounds i8, ptr %levels, i64 256
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(24) %scevgep62.i, i8 7, i64 24, i1 false)
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(32) %scevgep66.i, i8 5, i64 32, i1 false)
  %_deflate64Mode = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 18
  %44 = load i8, ptr %_deflate64Mode, align 1
  ...
  store i32 %cond, ptr %_numDistLevels, align 4
  br label %if.end63
...
for.body.i.i.i221:                                ; preds = %if.end.i.i.i227, %for.body.lr.ph.i.i.i215
  %45 = load ptr, ptr %m_Stream.i.i.i216, align 8
  %46 = load ptr, ptr %_bufferLimit.i.i.i.i217, align 8
  %cmp.not.i.i.i.i222 = icmp ult ptr %45, %46
...
if.then.if.end3_crit_edge.i.i.i.i240:             ; preds = %if.then.i.i.i.i223
  %.pre.i.i.i.i241 = load ptr, ptr %m_Stream.i.i.i216, align 8
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i242:   ; preds = %if.then.if.end3_crit_edge.i.i.i.i240, %for.body.i.i.i221
  %47 = phi ptr [ %.pre.i.i.i.i241, %if.then.if.end3_crit_edge.i.i.i.i240 ], [ %45, %for.body.i.i.i221 ]
  %incdec.ptr.i.i.i.i243 = getelementptr inbounds i8, ptr %47, i64 1
  store ptr %incdec.ptr.i.i.i.i243, ptr %m_Stream.i.i.i216, align 8
  %48 = load i8, ptr %47, align 1
  br label %if.end.i.i.i227

if.then.i.i.i225:                                 ; preds = %if.then.i.i.i.i223
  %49 = load i32, ptr %NumExtraBytes.i.i.i218, align 8
  %inc.i.i.i226 = add i32 %49, 1
  store i32 %inc.i.i.i226, ptr %NumExtraBytes.i.i.i218, align 8
  br label %if.end.i.i.i227

if.end.i.i.i227:                                  ; preds = %if.then.i.i.i225, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i242
  %b.1.i.i.i228 = phi i8 [ -1, %if.then.i.i.i225 ], [ %48, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i242 ]
  %conv.i.i.i229 = zext i8 %b.1.i.i.i228 to i32
  %50 = load i32, ptr %m_InBitStream.i, align 8
  %sub.i.i.i230 = sub i32 32, %50
  %shl.i.i.i231 = shl i32 %conv.i.i.i229, %sub.i.i.i230
  %51 = load i32, ptr %m_NormalValue.i.i, align 4
  %or.i.i.i232 = or i32 %shl.i.i.i231, %51
  store i32 %or.i.i.i232, ptr %m_NormalValue.i.i, align 4
  %52 = load i32, ptr %m_Value.i.i.i220, align 4
  %shl4.i.i.i233 = shl i32 %52, 8
  ...
  %53 = load i8, ptr %arrayidx.i.i.i235, align 1
  %conv5.i.i.i236 = zext i8 %53 to i32
  %or6.i.i.i237 = or i32 %shl4.i.i.i233, %conv5.i.i.i236
  store i32 %or6.i.i.i237, ptr %m_Value.i.i.i220, align 4
  %sub9.i.i.i238 = add i32 %50, -8
  store i32 %sub9.i.i.i238, ptr %m_InBitStream.i, align 8
  %cmp.i.i.i239 = icmp ugt i32 %sub9.i.i.i238, 7
  br i1 %cmp.i.i.i239, label %for.body.i.i.i221, label %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit244

_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit244: ; preds = %if.end.i.i.i227, %if.else
  %54 = phi i32 [ %add.i.i.i92, %if.else ], [ %sub9.i.i.i238, %if.end.i.i.i227 ]
  %55 = phi i32 [ %shr.i.i.i93, %if.else ], [ %or.i.i.i232, %if.end.i.i.i227 ]
  %and.i.i212 = and i32 %55, 31
  %add.i.i.i213 = add nuw nsw i32 %54, 5
  store i32 %add.i.i.i213, ptr %m_InBitStream.i, align 8
  %shr.i.i.i214 = lshr i32 %55, 5
  store i32 %shr.i.i.i214, ptr %m_NormalValue.i.i, align 4
  %add = add nuw nsw i32 %and.i.i212, 257
  %cmp13.i.i.i247 = icmp ugt i32 %54, 2
...
for.body.i.i.i261:                                ; preds = %if.end.i.i.i267, %for.body.lr.ph.i.i.i255
  %56 = load ptr, ptr %m_Stream.i.i.i256, align 8
  %57 = load ptr, ptr %_bufferLimit.i.i.i.i257, align 8
  %cmp.not.i.i.i.i262 = icmp ult ptr %56, %57
...
if.then.if.end3_crit_edge.i.i.i.i280:             ; preds = %if.then.i.i.i.i263
  %.pre.i.i.i.i281 = load ptr, ptr %m_Stream.i.i.i256, align 8
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i282:   ; preds = %if.then.if.end3_crit_edge.i.i.i.i280, %for.body.i.i.i261
  %58 = phi ptr [ %.pre.i.i.i.i281, %if.then.if.end3_crit_edge.i.i.i.i280 ], [ %56, %for.body.i.i.i261 ]
  %incdec.ptr.i.i.i.i283 = getelementptr inbounds i8, ptr %58, i64 1
  store ptr %incdec.ptr.i.i.i.i283, ptr %m_Stream.i.i.i256, align 8
  %59 = load i8, ptr %58, align 1
  br label %if.end.i.i.i267

if.then.i.i.i265:                                 ; preds = %if.then.i.i.i.i263
  %60 = load i32, ptr %NumExtraBytes.i.i.i258, align 8
  %inc.i.i.i266 = add i32 %60, 1
  store i32 %inc.i.i.i266, ptr %NumExtraBytes.i.i.i258, align 8
  br label %if.end.i.i.i267

if.end.i.i.i267:                                  ; preds = %if.then.i.i.i265, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i282
  %b.1.i.i.i268 = phi i8 [ -1, %if.then.i.i.i265 ], [ %59, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i282 ]
  %conv.i.i.i269 = zext i8 %b.1.i.i.i268 to i32
  %61 = load i32, ptr %m_InBitStream.i, align 8
  %sub.i.i.i270 = sub i32 32, %61
  %shl.i.i.i271 = shl i32 %conv.i.i.i269, %sub.i.i.i270
  %62 = load i32, ptr %m_NormalValue.i.i, align 4
  %or.i.i.i272 = or i32 %shl.i.i.i271, %62
  store i32 %or.i.i.i272, ptr %m_NormalValue.i.i, align 4
  %63 = load i32, ptr %m_Value.i.i.i260, align 4
  %shl4.i.i.i273 = shl i32 %63, 8
  ...
  %64 = load i8, ptr %arrayidx.i.i.i275, align 1
  %conv5.i.i.i276 = zext i8 %64 to i32
  %or6.i.i.i277 = or i32 %shl4.i.i.i273, %conv5.i.i.i276
  store i32 %or6.i.i.i277, ptr %m_Value.i.i.i260, align 4
  %sub9.i.i.i278 = add i32 %61, -8
  store i32 %sub9.i.i.i278, ptr %m_InBitStream.i, align 8
  %cmp.i.i.i279 = icmp ugt i32 %sub9.i.i.i278, 7
  br i1 %cmp.i.i.i279, label %for.body.i.i.i261, label %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit284
...
_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit284: ; preds = %if.end.i.i.i267, %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit244
  %65 = phi i32 [ %add.i.i.i213, %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit244 ], [ %sub9.i.i.i278, %if.end.i.i.i267 ]
  %66 = phi i32 [ %shr.i.i.i214, %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit244 ], [ %or.i.i.i272, %if.end.i.i.i267 ]
  %and.i.i252 = and i32 %66, 31
  %add.i.i.i253 = add nuw nsw i32 %65, 5
  store i32 %add.i.i.i253, ptr %m_InBitStream.i, align 8
  %shr.i.i.i254 = lshr i32 %66, 5
  store i32 %shr.i.i.i254, ptr %m_NormalValue.i.i, align 4
  ...
  store i32 %add20, ptr %_numDistLevels21, align 4
  %cmp13.i.i.i287 = icmp ugt i32 %65, 2
...
for.body.i.i.i301:                                ; preds = %if.end.i.i.i307, %for.body.lr.ph.i.i.i295
  %67 = load ptr, ptr %m_Stream.i.i.i296, align 8
  %68 = load ptr, ptr %_bufferLimit.i.i.i.i297, align 8
  %cmp.not.i.i.i.i302 = icmp ult ptr %67, %68
...
if.then.if.end3_crit_edge.i.i.i.i320:             ; preds = %if.then.i.i.i.i303
  %.pre.i.i.i.i321 = load ptr, ptr %m_Stream.i.i.i296, align 8
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i322:   ; preds = %if.then.if.end3_crit_edge.i.i.i.i320, %for.body.i.i.i301
  %69 = phi ptr [ %.pre.i.i.i.i321, %if.then.if.end3_crit_edge.i.i.i.i320 ], [ %67, %for.body.i.i.i301 ]
  %incdec.ptr.i.i.i.i323 = getelementptr inbounds i8, ptr %69, i64 1
  store ptr %incdec.ptr.i.i.i.i323, ptr %m_Stream.i.i.i296, align 8
  %70 = load i8, ptr %69, align 1
  br label %if.end.i.i.i307

if.then.i.i.i305:                                 ; preds = %if.then.i.i.i.i303
  %71 = load i32, ptr %NumExtraBytes.i.i.i298, align 8
  %inc.i.i.i306 = add i32 %71, 1
  store i32 %inc.i.i.i306, ptr %NumExtraBytes.i.i.i298, align 8
  br label %if.end.i.i.i307

if.end.i.i.i307:                                  ; preds = %if.then.i.i.i305, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i322
  %b.1.i.i.i308 = phi i8 [ -1, %if.then.i.i.i305 ], [ %70, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i322 ]
  %conv.i.i.i309 = zext i8 %b.1.i.i.i308 to i32
  %72 = load i32, ptr %m_InBitStream.i, align 8
  %sub.i.i.i310 = sub i32 32, %72
  %shl.i.i.i311 = shl i32 %conv.i.i.i309, %sub.i.i.i310
  %73 = load i32, ptr %m_NormalValue.i.i, align 4
  %or.i.i.i312 = or i32 %shl.i.i.i311, %73
  store i32 %or.i.i.i312, ptr %m_NormalValue.i.i, align 4
  %74 = load i32, ptr %m_Value.i.i.i300, align 4
  %shl4.i.i.i313 = shl i32 %74, 8
  ...
  %75 = load i8, ptr %arrayidx.i.i.i315, align 1
  %conv5.i.i.i316 = zext i8 %75 to i32
  %or6.i.i.i317 = or i32 %shl4.i.i.i313, %conv5.i.i.i316
  store i32 %or6.i.i.i317, ptr %m_Value.i.i.i300, align 4
  %sub9.i.i.i318 = add i32 %72, -8
  store i32 %sub9.i.i.i318, ptr %m_InBitStream.i, align 8
  %cmp.i.i.i319 = icmp ugt i32 %sub9.i.i.i318, 7
  br i1 %cmp.i.i.i319, label %for.body.i.i.i301, label %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit324.loopexit
...
_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit324: ; preds = %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit324.loopexit, %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit284
  %76 = phi i32 [ %add20, %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit284 ], [ %.pre, %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit324.loopexit ]
  %77 = phi i32 [ %add.i.i.i253, %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit284 ], [ %sub9.i.i.i318, %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit324.loopexit ]
  %78 = phi i32 [ %shr.i.i.i254, %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit284 ], [ %or.i.i.i312, %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit324.loopexit ]
  %add.i.i.i293 = add nuw nsw i32 %77, 4
  store i32 %add.i.i.i293, ptr %m_InBitStream.i, align 8
  %shr.i.i.i294 = lshr i32 %78, 4
  store i32 %shr.i.i.i294, ptr %m_NormalValue.i.i, align 4
  %_deflate64Mode24 = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 18
  %79 = load i8, ptr %_deflate64Mode24, align 1
...
for.body:                                         ; preds = %if.end31, %if.end43
  %.pre.i.i330 = phi i32 [ %shr.i.i.i294, %if.end31 ], [ %.pre.i.i330446, %if.end43 ]
  %.pr.i.i.i326 = phi i32 [ %add.i.i.i293, %if.end31 ], [ %.pr.i.i.i326444, %if.end43 ]
...
for.body.i.i.i341:                                ; preds = %if.then35, %if.end.i.i.i347
  %82 = load ptr, ptr %m_Stream.i.i.i336, align 8
  %83 = load ptr, ptr %_bufferLimit.i.i.i.i337, align 8
  %cmp.not.i.i.i.i342 = icmp ult ptr %82, %83
...
if.then.if.end3_crit_edge.i.i.i.i360:             ; preds = %if.then.i.i.i.i343
  %.pre.i.i.i.i361 = load ptr, ptr %m_Stream.i.i.i336, align 8
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i362:   ; preds = %if.then.if.end3_crit_edge.i.i.i.i360, %for.body.i.i.i341
  %84 = phi ptr [ %.pre.i.i.i.i361, %if.then.if.end3_crit_edge.i.i.i.i360 ], [ %82, %for.body.i.i.i341 ]
  %incdec.ptr.i.i.i.i363 = getelementptr inbounds i8, ptr %84, i64 1
  store ptr %incdec.ptr.i.i.i.i363, ptr %m_Stream.i.i.i336, align 8
  %85 = load i8, ptr %84, align 1
  br label %if.end.i.i.i347

if.then.i.i.i345:                                 ; preds = %if.then.i.i.i.i343
  %86 = load i32, ptr %NumExtraBytes.i.i.i338, align 8
  %inc.i.i.i346 = add i32 %86, 1
  store i32 %inc.i.i.i346, ptr %NumExtraBytes.i.i.i338, align 8
  br label %if.end.i.i.i347

if.end.i.i.i347:                                  ; preds = %if.then.i.i.i345, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i362
  %b.1.i.i.i348 = phi i8 [ -1, %if.then.i.i.i345 ], [ %85, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i.i362 ]
  %conv.i.i.i349 = zext i8 %b.1.i.i.i348 to i32
  %87 = load i32, ptr %m_InBitStream.i, align 8
  %sub.i.i.i350 = sub i32 32, %87
  %shl.i.i.i351 = shl i32 %conv.i.i.i349, %sub.i.i.i350
  %88 = load i32, ptr %m_NormalValue.i.i, align 4
  %or.i.i.i352 = or i32 %shl.i.i.i351, %88
  store i32 %or.i.i.i352, ptr %m_NormalValue.i.i, align 4
  %89 = load i32, ptr %m_Value.i.i.i340, align 4
  %shl4.i.i.i353 = shl i32 %89, 8
  ...
  %90 = load i8, ptr %arrayidx.i.i.i355, align 1
  %conv5.i.i.i356 = zext i8 %90 to i32
  %or6.i.i.i357 = or i32 %shl4.i.i.i353, %conv5.i.i.i356
  store i32 %or6.i.i.i357, ptr %m_Value.i.i.i340, align 4
  %sub9.i.i.i358 = add i32 %87, -8
  store i32 %sub9.i.i.i358, ptr %m_InBitStream.i, align 8
  %cmp.i.i.i359 = icmp ugt i32 %sub9.i.i.i358, 7
  br i1 %cmp.i.i.i359, label %for.body.i.i.i341, label %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit364

_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit364: ; preds = %if.end.i.i.i347, %if.then35
  %91 = phi i32 [ %.pr.i.i.i326, %if.then35 ], [ %sub9.i.i.i358, %if.end.i.i.i347 ]
  %92 = phi i32 [ %.pre.i.i330, %if.then35 ], [ %or.i.i.i352, %if.end.i.i.i347 ]
  %add.i.i.i333 = add nuw nsw i32 %91, 3
  store i32 %add.i.i.i333, ptr %m_InBitStream.i, align 8
  %shr.i.i.i334 = lshr i32 %92, 3
  store i32 %shr.i.i.i334, ptr %m_NormalValue.i.i, align 4
...
if.end43:                                         ; preds = %for.body, %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit364
  ...
  %.pre.i.i330446 = phi i32 [ %shr.i.i.i334, %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit364 ], [ %.pre.i.i330, %for.body ]
  %.pr.i.i.i326444 = phi i32 [ %add.i.i.i333, %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit364 ], [ %.pr.i.i.i326, %for.body ]
...
if.end46:                                         ; preds = %for.cond.cleanup
  ...
  %94 = load i32, ptr %_numDistLevels21, align 4
...
if.end52:                                         ; preds = %if.end46
  ...
  %95 = load i32, ptr %_numDistLevels21, align 4
...
if.end63:                                         ; preds = %if.end52, %if.then16
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(60) %scevgep.i366, i8 0, i64 60, i1 false)
...
if.end.i:                                         ; preds = %for.body4.i
  ...
  %97 = load i32, ptr %arrayidx9.i, align 4
...
if.end.i.1:                                       ; preds = %if.end.i
  ...
  %99 = load i32, ptr %arrayidx9.i.1, align 4
  ...
  store i32 -1, ptr %arrayidx12.i.1, align 4
...
for.end15.i:                                      ; preds = %if.end.i.1
  ...
  store i32 0, ptr %m_MainDecoder, align 8
...
for.body21.i:                                     ; preds = %for.inc62.i, %for.end15.i
  ...
  %100 = load i32, ptr %arrayidx23.i, align 4
  %sub.i367 = xor i32 %indvars146.i, 15
  %shl.i = shl i32 %100, %sub.i367
...
for.body54.lr.ph.i:                               ; preds = %if.then48.i
  ...
  %104 = zext i32 %index.0129.i to i64
  %scevgep138.i = getelementptr i8, ptr %scevgep137.i, i64 %104
  %105 = xor i32 %index.0129.i, -1
  %106 = add i32 %shr.i, %105
  %107 = zext i32 %106 to i64
  %108 = add nuw nsw i64 %107, 1
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %scevgep138.i, i8 %conv55.i, i64 %108, i1 false)
...
for.inc62.i:                                      ; preds = %for.body54.lr.ph.i, %if.then48.i, %if.end26.i
  ...
  br i1 %exitcond147.i, label %for.body67.i, label %for.body21.i
...
for.body67.i:                                     ; preds = %for.inc62.i, %if.end80.i.1
  ...
  %109 = load i8, ptr %arrayidx70.i, align 1
...
if.then73.i:                                      ; preds = %for.body67.i
  ...
  %110 = load i32, ptr %arrayidx76.i, align 4
  ...
  %111 = trunc i64 %indvars.iv148.i to i32
  store i32 %111, ptr %arrayidx79.i, align 4
  br label %if.end80.i
...
if.end80.i:                                       ; preds = %if.then73.i, %for.body67.i
  ...
  %112 = load i8, ptr %arrayidx70.i.1, align 1
...
if.then73.i.1:                                    ; preds = %if.end80.i
  ...
  %113 = load i32, ptr %arrayidx76.i.1, align 4
  ...
  %114 = trunc i64 %indvars.iv.next149.i to i32
  store i32 %114, ptr %arrayidx79.i.1, align 4
...
if.end80.i.1:                                     ; preds = %if.then73.i.1, %if.end80.i
  ...
  br i1 %exitcond151.not.i.1, label %if.end68, label %for.body67.i
...
if.end68:                                         ; preds = %if.end80.i.1
  ...
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %lenCounts.i368) #13
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %tmpPositions.i369) #13
  %scevgep.i370 = getelementptr inbounds i8, ptr %lenCounts.i368, i64 4
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(60) %scevgep.i370, i8 0, i64 60, i1 false)
  br label %for.body4.i371

for.body4.i371:                                   ; preds = %if.end.i376.1, %if.end68
  %indvars.iv.i372 = phi i64 [ 0, %if.end68 ], [ %indvars.iv.next.i381.1, %if.end.i376.1 ]
  %arrayidx6.i373 = getelementptr inbounds i8, ptr %distLevels69, i64 %indvars.iv.i372
  %115 = load i8, ptr %arrayidx6.i373, align 1
  %cmp7.i374 = icmp ult i8 %115, 16
  br i1 %cmp7.i374, label %if.end.i376, label %_ZN9NCompress8NHuffman8CDecoderILi15ELj32EE14SetCodeLengthsEPKh.exit

if.end.i376:                                      ; preds = %for.body4.i371
  %idxprom8.i377 = zext i8 %115 to i64
  %arrayidx9.i378 = getelementptr inbounds [16 x i32], ptr %lenCounts.i368, i64 0, i64 %idxprom8.i377
  %116 = load i32, ptr %arrayidx9.i378, align 4
  %inc10.i379 = add nsw i32 %116, 1
  store i32 %inc10.i379, ptr %arrayidx9.i378, align 4
  %arrayidx12.i380 = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 10, i32 2, i64 %indvars.iv.i372
  store i32 -1, ptr %arrayidx12.i380, align 8
  %indvars.iv.next.i381 = or i64 %indvars.iv.i372, 1
  %arrayidx6.i373.1 = getelementptr inbounds i8, ptr %distLevels69, i64 %indvars.iv.next.i381
  %117 = load i8, ptr %arrayidx6.i373.1, align 1
  %cmp7.i374.1 = icmp ult i8 %117, 16
  br i1 %cmp7.i374.1, label %if.end.i376.1, label %_ZN9NCompress8NHuffman8CDecoderILi15ELj32EE14SetCodeLengthsEPKh.exit

if.end.i376.1:                                    ; preds = %if.end.i376
  %idxprom8.i377.1 = zext i8 %117 to i64
  %arrayidx9.i378.1 = getelementptr inbounds [16 x i32], ptr %lenCounts.i368, i64 0, i64 %idxprom8.i377.1
  %118 = load i32, ptr %arrayidx9.i378.1, align 4
  %inc10.i379.1 = add nsw i32 %118, 1
  store i32 %inc10.i379.1, ptr %arrayidx9.i378.1, align 4
  %arrayidx12.i380.1 = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 10, i32 2, i64 %indvars.iv.next.i381
  store i32 -1, ptr %arrayidx12.i380.1, align 4
  %indvars.iv.next.i381.1 = add nuw nsw i64 %indvars.iv.i372, 2
  %exitcond.not.i382.1 = icmp eq i64 %indvars.iv.next.i381.1, 32
  br i1 %exitcond.not.i382.1, label %for.end15.i383, label %for.body4.i371

for.end15.i383:                                   ; preds = %if.end.i376.1
  store i32 0, ptr %lenCounts.i368, align 16
  store i32 0, ptr %m_DistDecoder, align 8
  %m_Positions.i384 = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 10, i32 1
  store i32 0, ptr %m_Positions.i384, align 8
  %scevgep137.i385 = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 10, i32 3
  br label %for.body21.i386

for.body21.i386:                                  ; preds = %for.inc62.i406, %for.end15.i383
  %indvars.iv143.i387 = phi i64 [ 1, %for.end15.i383 ], [ %indvars.iv.next144.i408, %for.inc62.i406 ]
  %index.0129.i388 = phi i32 [ 0, %for.end15.i383 ], [ %index.2.i407, %for.inc62.i406 ]
  %startPos.0128.i389 = phi i32 [ 0, %for.end15.i383 ], [ %add.i394, %for.inc62.i406 ]
  %indvars146.i390 = trunc i64 %indvars.iv143.i387 to i32
  %arrayidx23.i391 = getelementptr inbounds [16 x i32], ptr %lenCounts.i368, i64 0, i64 %indvars.iv143.i387
  %119 = load i32, ptr %arrayidx23.i391, align 4
  %sub.i392 = xor i32 %indvars146.i390, 15
  %shl.i393 = shl i32 %119, %sub.i392
  %add.i394 = add i32 %shl.i393, %startPos.0128.i389
  %cmp24.i395 = icmp ugt i32 %add.i394, 32768
  br i1 %cmp24.i395, label %_ZN9NCompress8NHuffman8CDecoderILi15ELj32EE14SetCodeLengthsEPKh.exit, label %if.end26.i396

if.end26.i396:                                    ; preds = %for.body21.i386
  %cmp27.i397 = icmp eq i64 %indvars.iv143.i387, 15
  %cond.i398 = select i1 %cmp27.i397, i32 32768, i32 %add.i394
  %arrayidx30.i399 = getelementptr inbounds [16 x i32], ptr %m_DistDecoder, i64 0, i64 %indvars.iv143.i387
  store i32 %cond.i398, ptr %arrayidx30.i399, align 4
  %120 = add nsw i64 %indvars.iv143.i387, -1
  %arrayidx34.i400 = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 10, i32 1, i64 %120
  %121 = load i32, ptr %arrayidx34.i400, align 4
  %arrayidx37.i401 = getelementptr inbounds [16 x i32], ptr %lenCounts.i368, i64 0, i64 %120
  %122 = load i32, ptr %arrayidx37.i401, align 4
  %add38.i402 = add i32 %122, %121
  %arrayidx41.i403 = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 10, i32 1, i64 %indvars.iv143.i387
  store i32 %add38.i402, ptr %arrayidx41.i403, align 4
  %arrayidx46.i404 = getelementptr inbounds [16 x i32], ptr %tmpPositions.i369, i64 0, i64 %indvars.iv143.i387
  store i32 %add38.i402, ptr %arrayidx46.i404, align 4
  %cmp47.i405 = icmp ult i64 %indvars.iv143.i387, 10
  br i1 %cmp47.i405, label %if.then48.i423, label %for.inc62.i406

if.then48.i423:                                   ; preds = %if.end26.i396
  %shr.i424 = lshr i32 %cond.i398, 6
  %cmp53126.i425 = icmp ult i32 %index.0129.i388, %shr.i424
  br i1 %cmp53126.i425, label %for.body54.lr.ph.i426, label %for.inc62.i406

for.body54.lr.ph.i426:                            ; preds = %if.then48.i423
  %conv55.i427 = trunc i64 %indvars.iv143.i387 to i8
  %123 = zext i32 %index.0129.i388 to i64
  %scevgep138.i428 = getelementptr i8, ptr %scevgep137.i385, i64 %123
  %124 = xor i32 %index.0129.i388, -1
  %125 = add i32 %shr.i424, %124
  %126 = zext i32 %125 to i64
  %127 = add nuw nsw i64 %126, 1
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %scevgep138.i428, i8 %conv55.i427, i64 %127, i1 false)
  br label %for.inc62.i406

for.inc62.i406:                                   ; preds = %for.body54.lr.ph.i426, %if.then48.i423, %if.end26.i396
  %index.2.i407 = phi i32 [ %index.0129.i388, %if.end26.i396 ], [ %index.0129.i388, %if.then48.i423 ], [ %shr.i424, %for.body54.lr.ph.i426 ]
  %indvars.iv.next144.i408 = add nuw nsw i64 %indvars.iv143.i387, 1
  %exitcond147.i409 = icmp eq i64 %indvars.iv.next144.i408, 16
  br i1 %exitcond147.i409, label %for.body67.i410, label %for.body21.i386

for.body67.i410:                                  ; preds = %for.inc62.i406, %if.end80.i420.1
  %indvars.iv148.i411 = phi i64 [ %indvars.iv.next149.i421.1, %if.end80.i420.1 ], [ 0, %for.inc62.i406 ]
  %arrayidx70.i412 = getelementptr inbounds i8, ptr %distLevels69, i64 %indvars.iv148.i411
  %128 = load i8, ptr %arrayidx70.i412, align 1
  %cmp72.not.i413 = icmp eq i8 %128, 0
  br i1 %cmp72.not.i413, label %if.end80.i420, label %if.then73.i414

if.then73.i414:                                   ; preds = %for.body67.i410
  %idxprom75.i415 = zext i8 %128 to i64
  %arrayidx76.i416 = getelementptr inbounds [16 x i32], ptr %tmpPositions.i369, i64 0, i64 %idxprom75.i415
  %129 = load i32, ptr %arrayidx76.i416, align 4
  %inc77.i417 = add i32 %129, 1
  store i32 %inc77.i417, ptr %arrayidx76.i416, align 4
  %idxprom78.i418 = zext i32 %129 to i64
  %arrayidx79.i419 = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 10, i32 2, i64 %idxprom78.i418
  %130 = trunc i64 %indvars.iv148.i411 to i32
  store i32 %130, ptr %arrayidx79.i419, align 4
  br label %if.end80.i420

if.end80.i420:                                    ; preds = %if.then73.i414, %for.body67.i410
  %indvars.iv.next149.i421 = or i64 %indvars.iv148.i411, 1
  %arrayidx70.i412.1 = getelementptr inbounds i8, ptr %distLevels69, i64 %indvars.iv.next149.i421
  %131 = load i8, ptr %arrayidx70.i412.1, align 1
  %cmp72.not.i413.1 = icmp eq i8 %131, 0
  br i1 %cmp72.not.i413.1, label %if.end80.i420.1, label %if.then73.i414.1

if.then73.i414.1:                                 ; preds = %if.end80.i420
  %idxprom75.i415.1 = zext i8 %131 to i64
  %arrayidx76.i416.1 = getelementptr inbounds [16 x i32], ptr %tmpPositions.i369, i64 0, i64 %idxprom75.i415.1
  %132 = load i32, ptr %arrayidx76.i416.1, align 4
  %inc77.i417.1 = add i32 %132, 1
  store i32 %inc77.i417.1, ptr %arrayidx76.i416.1, align 4
  %idxprom78.i418.1 = zext i32 %132 to i64
  %arrayidx79.i419.1 = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 10, i32 2, i64 %idxprom78.i418.1
  %133 = trunc i64 %indvars.iv.next149.i421 to i32
  store i32 %133, ptr %arrayidx79.i419.1, align 4
  br label %if.end80.i420.1

if.end80.i420.1:                                  ; preds = %if.then73.i414.1, %if.end80.i420
  %indvars.iv.next149.i421.1 = add nuw nsw i64 %indvars.iv148.i411, 2
  %exitcond151.not.i422.1 = icmp eq i64 %indvars.iv.next149.i421.1, 32
  br i1 %exitcond151.not.i422.1, label %_ZN9NCompress8NHuffman8CDecoderILi15ELj32EE14SetCodeLengthsEPKh.exit, label %for.body67.i410

_ZN9NCompress8NHuffman8CDecoderILi15ELj32EE14SetCodeLengthsEPKh.exit: ; preds = %for.body4.i371, %if.end.i376, %for.body21.i386, %if.end80.i420.1
  %retval.3.i375 = phi i1 [ true, %if.end80.i420.1 ], [ false, %for.body21.i386 ], [ false, %if.end.i376 ], [ false, %for.body4.i371 ]
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %tmpPositions.i369) #13
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %lenCounts.i368) #13
  br label %cleanup72
...
cleanup72:                                        ; preds = %_ZN9NCompress8NHuffman8CDecoderILi15ELj288EE14SetCodeLengthsEPKh.exit.thread, %cleanup72.critedge83, %cleanup72.critedge, %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit324, %_ZN9NCompress8NHuffman8CDecoderILi15ELj32EE14SetCodeLengthsEPKh.exit
  %retval.3 = phi i1 [ %retval.3.i375, %_ZN9NCompress8NHuffman8CDecoderILi15ELj32EE14SetCodeLengthsEPKh.exit ], [ false, %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit324 ], [ false, %cleanup72.critedge ], [ false, %cleanup72.critedge83 ], [ false, %_ZN9NCompress8NHuffman8CDecoderILi15ELj288EE14SetCodeLengthsEPKh.exit.thread ]
...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(60) %scevgep, i8 0, i64 60, i1 false)
...
for.body54.lr.ph:                                 ; preds = %if.then48
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %scevgep138, i8 %conv55, i64 %46, i1 false)
  br label %for.inc62
...
for.inc62:                                        ; preds = %for.body54.lr.ph, %if.then48, %if.end26
  ...
  br i1 %exitcond144, label %for.body67.preheader, label %for.body21

for.body67.preheader:                             ; preds = %for.inc62
  %47 = load i8, ptr %codeLengths, align 1
...
if.end80:                                         ; preds = %if.then73, %for.body67.preheader
  %49 = load i8, ptr %arrayidx6.1, align 1
...
if.then73.1:                                      ; preds = %if.end80
  ...
  %50 = load i32, ptr %arrayidx76.1, align 4
...
if.end80.1:                                       ; preds = %if.then73.1, %if.end80
  %51 = load i8, ptr %arrayidx6.2, align 1
...
if.then73.2:                                      ; preds = %if.end80.1
  ...
  %52 = load i32, ptr %arrayidx76.2, align 4
...
if.end80.2:                                       ; preds = %if.then73.2, %if.end80.1
  %53 = load i8, ptr %arrayidx6.3, align 1
...
if.then73.3:                                      ; preds = %if.end80.2
  ...
  %54 = load i32, ptr %arrayidx76.3, align 4
...
if.end80.3:                                       ; preds = %if.then73.3, %if.end80.2
  %55 = load i8, ptr %arrayidx6.4, align 1
...
if.then73.4:                                      ; preds = %if.end80.3
  ...
  %56 = load i32, ptr %arrayidx76.4, align 4
...
if.end80.4:                                       ; preds = %if.then73.4, %if.end80.3
  %57 = load i8, ptr %arrayidx6.5, align 1
...
if.then73.5:                                      ; preds = %if.end80.4
  ...
  %58 = load i32, ptr %arrayidx76.5, align 4
...
if.end80.5:                                       ; preds = %if.then73.5, %if.end80.4
  %59 = load i8, ptr %arrayidx6.6, align 1
...
if.then73.6:                                      ; preds = %if.end80.5
  ...
  %60 = load i32, ptr %arrayidx76.6, align 4
...
if.end80.6:                                       ; preds = %if.then73.6, %if.end80.5
  %61 = load i8, ptr %arrayidx6.7, align 1
...
if.then73.7:                                      ; preds = %if.end80.6
  ...
  %62 = load i32, ptr %arrayidx76.7, align 4
...
if.end80.7:                                       ; preds = %if.then73.7, %if.end80.6
  %63 = load i8, ptr %arrayidx6.8, align 1
...
if.then73.8:                                      ; preds = %if.end80.7
  ...
  %64 = load i32, ptr %arrayidx76.8, align 4
...
if.end80.8:                                       ; preds = %if.then73.8, %if.end80.7
  %65 = load i8, ptr %arrayidx6.9, align 1
...
if.then73.9:                                      ; preds = %if.end80.8
  ...
  %66 = load i32, ptr %arrayidx76.9, align 4
...
if.end80.9:                                       ; preds = %if.then73.9, %if.end80.8
  %67 = load i8, ptr %arrayidx6.10, align 1
...
if.then73.10:                                     ; preds = %if.end80.9
  ...
  %68 = load i32, ptr %arrayidx76.10, align 4
...
if.end80.10:                                      ; preds = %if.then73.10, %if.end80.9
  %69 = load i8, ptr %arrayidx6.11, align 1
...
if.then73.11:                                     ; preds = %if.end80.10
  ...
  %70 = load i32, ptr %arrayidx76.11, align 4
...
if.end80.11:                                      ; preds = %if.then73.11, %if.end80.10
  %71 = load i8, ptr %arrayidx6.12, align 1
...
if.then73.12:                                     ; preds = %if.end80.11
  ...
  %72 = load i32, ptr %arrayidx76.12, align 4
...
if.end80.12:                                      ; preds = %if.then73.12, %if.end80.11
  %73 = load i8, ptr %arrayidx6.13, align 1
...
if.then73.13:                                     ; preds = %if.end80.12
  ...
  %74 = load i32, ptr %arrayidx76.13, align 4
...
if.end80.13:                                      ; preds = %if.then73.13, %if.end80.12
  %75 = load i8, ptr %arrayidx6.14, align 1
...
if.then73.14:                                     ; preds = %if.end80.13
  ...
  %76 = load i32, ptr %arrayidx76.14, align 4
...
if.end80.14:                                      ; preds = %if.then73.14, %if.end80.13
  %77 = load i8, ptr %arrayidx6.15, align 1
...
if.then73.15:                                     ; preds = %if.end80.14
  ...
  %78 = load i32, ptr %arrayidx76.15, align 4
...
if.end80.15:                                      ; preds = %if.then73.15, %if.end80.14
  %79 = load i8, ptr %arrayidx6.16, align 1
...
if.then73.16:                                     ; preds = %if.end80.15
  ...
  %80 = load i32, ptr %arrayidx76.16, align 4
...
if.end80.16:                                      ; preds = %if.then73.16, %if.end80.15
  %81 = load i8, ptr %arrayidx6.17, align 1
...
if.then73.17:                                     ; preds = %if.end80.16
  ...
  %82 = load i32, ptr %arrayidx76.17, align 4
...
if.end80.17:                                      ; preds = %if.then73.17, %if.end80.16
  %83 = load i8, ptr %arrayidx6.18, align 1
...
if.then73.18:                                     ; preds = %if.end80.17
  ...
  %84 = load i32, ptr %arrayidx76.18, align 4
...
entry:
  ...
  %0 = load i32, ptr %_remainLen, align 4
...
if.then4:                                         ; preds = %entry
  %_keepHistory = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 19
  %1 = load i8, ptr %_keepHistory, align 2
...
if.then5:                                         ; preds = %if.then4
  %m_OutWindowStream = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 7
  %_deflate64Mode = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 18
  %2 = load i8, ptr %_deflate64Mode, align 1
...
if.end9:                                          ; preds = %if.then5, %if.then4
  %_needInitInStream = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 20
  %3 = load i8, ptr %_needInitInStream, align 1
...
_ZN9NCompress8NDeflate8NDecoder6CCoder12InitInStreamEb.exit.thread: ; preds = %if.end9
  ...
  store i32 32, ptr %m_InBitStream.i, align 8
  %m_Value.i.i.i = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 8, i32 0, i32 1
  store i32 0, ptr %m_Value.i.i.i, align 4
  %NumExtraBytes.i.i.i = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 8, i32 0, i32 3
  store i32 0, ptr %NumExtraBytes.i.i.i, align 8
  %m_NormalValue.i.i = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 8, i32 1
  store i32 0, ptr %m_NormalValue.i.i, align 4
  store i8 0, ptr %_needInitInStream, align 1
...
if.end19.thread:                                  ; preds = %_ZN9NCompress8NDeflate8NDecoder6CCoder12InitInStreamEb.exit, %_ZN9NCompress8NDeflate8NDecoder6CCoder12InitInStreamEb.exit.thread
  ...
  %4 = load i8, ptr %_keepHistory, align 2
  ...
  %m_FinalBlock = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 13
  store i8 0, ptr %m_FinalBlock, align 8
  store i32 0, ptr %_remainLen, align 4
  %_needReadTable = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 23
  store i8 1, ptr %_needReadTable, align 4
...
while.body:                                       ; preds = %while.body.lr.ph, %_ZN12CLzOutWindow7PutByteEh.exit
  ...
  %dec = add nsw i32 %5, -1
  store i32 %dec, ptr %_remainLen, align 4
  %6 = load i32, ptr %_rep0, align 8
  %7 = load i32, ptr %_pos.i, align 8
  %8 = xor i32 %6, -1
  %sub2.i = add i32 %7, %8
  %9 = load i32, ptr %_bufferSize.i, align 4
  %cmp.not.i = icmp ult i32 %sub2.i, %9
  %add.i = select i1 %cmp.not.i, i32 0, i32 %9
  %spec.select.i = add i32 %add.i, %sub2.i
  %10 = load ptr, ptr %m_OutWindowStream27, align 8
  ...
  store i8 %11, ptr %arrayidx.i176, align 1
  %12 = load i32, ptr %_pos.i, align 8
  %13 = load i32, ptr %_limitPos.i, align 4
...
_ZN12CLzOutWindow7PutByteEh.exit:                 ; preds = %while.body, %if.then.i
  ...
  %14 = load i32, ptr %_remainLen, align 4
  %cmp24 = icmp sgt i32 %14, 0
  %cmp25 = icmp ne i32 %dec30, 0
  %15 = select i1 %cmp24, i1 %cmp25, i1 false
  br i1 %15, label %while.body, label %while.cond31.preheader
...
if.end44:                                         ; preds = %if.end41
  store i8 0, ptr %_needReadTable34, align 4
  br label %if.end46

if.end46:                                         ; preds = %if.end44, %while.body33
  %18 = load i8, ptr %m_StoredMode, align 1
...
for.cond.preheader:                               ; preds = %if.end46
  %19 = load i32, ptr %m_StoredBlockSize, align 4
...
for.body:                                         ; preds = %for.cond.preheader, %_ZN12CLzOutWindow7PutByteEh.exit190
  ...
  %20 = load i32, ptr %m_InBitStream, align 8
  %cmp.i177 = icmp eq i32 %20, 32
  br i1 %cmp.i177, label %if.then.i179, label %if.end3.i

if.then.i179:                                     ; preds = %for.body
  %21 = load ptr, ptr %m_Stream.i, align 8
  %22 = load ptr, ptr %_bufferLimit.i.i, align 8
...
if.then.if.end3_crit_edge.i.i:                    ; preds = %if.then.i.i
  %.pre.i.i = load ptr, ptr %m_Stream.i, align 8
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i:          ; preds = %if.then.if.end3_crit_edge.i.i, %if.then.i179
  ...
  store ptr %incdec.ptr.i.i, ptr %m_Stream.i, align 8
  %24 = load i8, ptr %23, align 1
  br label %_ZN5NBitl8CDecoderI9CInBufferE8ReadByteEv.exit

if.then2.i181:                                    ; preds = %if.then.i.i
  %25 = load i32, ptr %NumExtraBytes.i, align 8
  %inc.i182 = add i32 %25, 1
  store i32 %inc.i182, ptr %NumExtraBytes.i, align 8
  br label %_ZN5NBitl8CDecoderI9CInBufferE8ReadByteEv.exit

if.end3.i:                                        ; preds = %for.body
  %26 = load i32, ptr %m_NormalValue.i, align 4
...
_ZN5NBitl8CDecoderI9CInBufferE8ReadByteEv.exit:   ; preds = %_ZN9CInBuffer8ReadByteERh.exit.thread.i, %if.then2.i181, %if.end3.i
  ...
  %27 = load ptr, ptr %m_OutWindowStream53, align 8
  %28 = load i32, ptr %_pos.i183, align 8
  %inc.i184 = add i32 %28, 1
  store i32 %inc.i184, ptr %_pos.i183, align 8
  %idxprom.i185 = zext i32 %28 to i64
  %arrayidx.i186 = getelementptr inbounds i8, ptr %27, i64 %idxprom.i185
  store i8 %retval.0.i178, ptr %arrayidx.i186, align 1
  %29 = load i32, ptr %_pos.i183, align 8
  %30 = load i32, ptr %_limitPos.i187, align 4
...
_ZN12CLzOutWindow7PutByteEh.exit190:              ; preds = %_ZN5NBitl8CDecoderI9CInBufferE8ReadByteEv.exit, %if.then.i189
  %31 = load i32, ptr %m_StoredBlockSize, align 4
  %dec56 = add i32 %31, -1
  store i32 %dec56, ptr %m_StoredBlockSize, align 4
...
for.end:                                          ; preds = %_ZN12CLzOutWindow7PutByteEh.exit190, %for.cond.preheader
  ...
  store i8 %frombool, ptr %_needReadTable34, align 4
...
while.body64:                                     ; preds = %if.end46, %cleanup135
  ...
  %33 = load i32, ptr %NumExtraBytes.i, align 8
...
if.then72:                                        ; preds = %if.end68
  ...
  %34 = load ptr, ptr %m_OutWindowStream53, align 8
  %35 = load i32, ptr %_pos.i183, align 8
  %inc.i192 = add i32 %35, 1
  store i32 %inc.i192, ptr %_pos.i183, align 8
  %idxprom.i193 = zext i32 %35 to i64
  %arrayidx.i194 = getelementptr inbounds i8, ptr %34, i64 %idxprom.i193
  store i8 %conv, ptr %arrayidx.i194, align 1
  %36 = load i32, ptr %_pos.i183, align 8
  %37 = load i32, ptr %_limitPos.i187, align 4
...
if.then76:                                        ; preds = %if.else
  store i8 1, ptr %_needReadTable34, align 4
  br label %while.cond31.backedge
...
if.then80:                                        ; preds = %if.else78
  ...
  %38 = load i8, ptr %_deflate64Mode81, align 1
  ...
  %numBits.0.in = load i8, ptr %numBits.0.in.in, align 1
  %numBits.0 = zext i8 %numBits.0.in to i32
  %len.0.in = load i8, ptr %len.0.in.in, align 1
...
for.body.i.i:                                     ; preds = %if.then80, %if.end.i.i
  %39 = load ptr, ptr %m_Stream.i, align 8
  %40 = load ptr, ptr %_bufferLimit.i.i, align 8
...
if.then.i.i204:                                   ; preds = %if.then.i.i.i
  %43 = load i32, ptr %NumExtraBytes.i, align 8
...
if.end.i.i:                                       ; preds = %if.then.i.i204, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i
  ...
  %conv.i.i = zext i8 %b.1.i.i to i32
  %44 = load i32, ptr %m_InBitStream, align 8
  %sub.i.i = sub i32 32, %44
  %shl.i.i = shl i32 %conv.i.i, %sub.i.i
  %45 = load i32, ptr %m_NormalValue.i, align 4
  %or.i.i = or i32 %shl.i.i, %45
  store i32 %or.i.i, ptr %m_NormalValue.i, align 4
  %46 = load i32, ptr %m_Value.i.i, align 4
...
_ZN5NBitl8CDecoderI9CInBufferE8ReadBitsEj.exit:   ; preds = %if.end.i.i, %entry._ZN5NBitl8CDecoderI9CInBufferE9NormalizeEv.exit_crit_edge.i
  ...
  store i32 %add.i.i200, ptr %m_InBitStream, align 8
  %shr.i.i201 = lshr i32 %49, %numBits.0
  store i32 %shr.i.i201, ptr %m_NormalValue.i, align 4
  ...
  %50 = load i32, ptr %_numDistLevels, align 4
...
if.end106:                                        ; preds = %_ZN5NBitl8CDecoderI9CInBufferE8ReadBitsEj.exit
  ...
  %.pr.i.i205 = load i32, ptr %m_InBitStream, align 8
...
entry._ZN5NBitl8CDecoderI9CInBufferE9NormalizeEv.exit_crit_edge.i207: ; preds = %if.end106
  %.pre.i209 = load i32, ptr %m_NormalValue.i, align 4
  br label %_ZN5NBitl8CDecoderI9CInBufferE8ReadBitsEj.exit245

for.body.i.i222:                                  ; preds = %if.end106, %if.end.i.i228
  %53 = load ptr, ptr %m_Stream.i, align 8
  %54 = load ptr, ptr %_bufferLimit.i.i, align 8
...
if.then.if.end3_crit_edge.i.i.i241:               ; preds = %if.then.i.i.i224
  %.pre.i.i.i242 = load ptr, ptr %m_Stream.i, align 8
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i.i243:     ; preds = %if.then.if.end3_crit_edge.i.i.i241, %for.body.i.i222
  ...
  store ptr %incdec.ptr.i.i.i244, ptr %m_Stream.i, align 8
  %56 = load i8, ptr %55, align 1
  br label %if.end.i.i228

if.then.i.i226:                                   ; preds = %if.then.i.i.i224
  %57 = load i32, ptr %NumExtraBytes.i, align 8
  %inc.i.i227 = add i32 %57, 1
  store i32 %inc.i.i227, ptr %NumExtraBytes.i, align 8
  br label %if.end.i.i228
...
if.end.i.i228:                                    ; preds = %if.then.i.i226, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i243
  ...
  %58 = load i32, ptr %m_InBitStream, align 8
  %sub.i.i231 = sub i32 32, %58
  %shl.i.i232 = shl i32 %conv.i.i230, %sub.i.i231
  %59 = load i32, ptr %m_NormalValue.i, align 4
  %or.i.i233 = or i32 %shl.i.i232, %59
  store i32 %or.i.i233, ptr %m_NormalValue.i, align 4
  %60 = load i32, ptr %m_Value.i.i, align 4
  ...
  %61 = load i8, ptr %arrayidx.i.i236, align 1
  %conv5.i.i237 = zext i8 %61 to i32
  %or6.i.i238 = or i32 %shl4.i.i234, %conv5.i.i237
  store i32 %or6.i.i238, ptr %m_Value.i.i, align 4
  %sub9.i.i239 = add i32 %58, -8
  store i32 %sub9.i.i239, ptr %m_InBitStream, align 8
  %cmp.i.i240 = icmp ugt i32 %sub9.i.i239, 7
  br i1 %cmp.i.i240, label %for.body.i.i222, label %_ZN5NBitl8CDecoderI9CInBufferE8ReadBitsEj.exit245
...
_ZN5NBitl8CDecoderI9CInBufferE8ReadBitsEj.exit245: ; preds = %if.end.i.i228, %entry._ZN5NBitl8CDecoderI9CInBufferE9NormalizeEv.exit_crit_edge.i207
  ...
  store i32 %add.i.i214, ptr %m_InBitStream, align 8
  %shr.i.i215 = lshr i32 %63, %conv112
  store i32 %shr.i.i215, ptr %m_NormalValue.i, align 4
  %add114 = add i32 %and.i213, %51
  %64 = load i32, ptr %_pos.i183, align 8
  %65 = xor i32 %add114, -1
...
land.lhs.true.i:                                  ; preds = %if.end7.i
  %69 = load i32, ptr %_bufferSize.i250, align 4
...
iter.check:                                       ; preds = %land.lhs.true.i
  %70 = load ptr, ptr %m_OutWindowStream53, align 8
  ...
  store i32 %add20.i, ptr %_pos.i183, align 8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load312 = load <16 x i8>, ptr %78, align 1
  store <16 x i8> %wide.load, ptr %next.gep310, align 1
  %79 = getelementptr i8, ptr %next.gep310, i64 16
  store <16 x i8> %wide.load312, ptr %79, align 1
  %index.next = add nuw i64 %index, 32
  %80 = icmp eq i64 %index.next, %n.vec
  br i1 %80, label %middle.block, label %vector.body
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load331 = load <8 x i8>, ptr %next.gep329, align 1
  store <8 x i8> %wide.load331, ptr %next.gep330, align 1
  %index.next332 = add nuw i64 %index328, 8
  %81 = icmp eq i64 %index.next332, %n.vec316
  br i1 %81, label %vec.epilog.middle.block, label %vec.epilog.vector.body
...
do.body.i.prol:                                   ; preds = %do.body.i.preheader, %do.body.i.prol
  ...
  %83 = load i8, ptr %src.0.i.prol, align 1
  %incdec.ptr21.i.prol = getelementptr inbounds i8, ptr %dest.0.i.prol, i64 1
  store i8 %83, ptr %dest.0.i.prol, align 1
...
do.body23.i:                                      ; preds = %do.body23.i.preheader, %do.cond39.i
  ...
  %95 = load i8, ptr %arrayidx.i256, align 1
  %96 = load i32, ptr %_pos.i183, align 8
  %inc31.i = add i32 %96, 1
  store i32 %inc31.i, ptr %_pos.i183, align 8
  %idxprom32.i = zext i32 %96 to i64
  %arrayidx33.i = getelementptr inbounds i8, ptr %94, i64 %idxprom32.i
  store i8 %95, ptr %arrayidx33.i, align 1
  %97 = load i32, ptr %_pos.i183, align 8
  %98 = load i32, ptr %_limitPos.i187, align 4
...
do.cond39.i:                                      ; preds = %if.then37.i, %do.body23.i
  ...
  br i1 %cmp41.not.i, label %if.end118, label %do.body23.i
...
if.then122:                                       ; preds = %if.end118
  ...
  store i32 %sub120, ptr %_remainLen, align 4
  store i32 %add114, ptr %_rep0124, align 8
  br label %while.cond31.backedge
...
invoke.cont:                                      ; preds = %entry
  ...
  %_needInitInStream = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 20
  %0 = load i8, ptr %_needInitInStream, align 1
...
cond.false:                                       ; preds = %invoke.cont
  ...
  %1 = load i64, ptr %_processedSize.i.i, align 8
  %2 = load ptr, ptr %m_Stream.i, align 8
  %_bufferBase.i.i = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 8, i32 0, i32 2, i32 2
  %3 = load ptr, ptr %_bufferBase.i.i, align 8
  %sub.ptr.lhs.cast.i.i = ptrtoint ptr %2 to i64
  %sub.ptr.rhs.cast.i.i = ptrtoint ptr %3 to i64
  %NumExtraBytes.i = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 8, i32 0, i32 3
  %4 = load i32, ptr %NumExtraBytes.i, align 8
...
for.cond.preheader:                               ; preds = %cond.end
  ...
  %m_Stream.i135 = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 8, i32 0, i32 2
  %_processedSize.i.i136 = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 8, i32 0, i32 2, i32 4
  %_bufferBase.i.i137 = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 8, i32 0, i32 2, i32 2
  %NumExtraBytes.i140 = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 8, i32 0, i32 3
...
invoke.cont23.us.us:                              ; preds = %for.cond.us.us
  ...
  br i1 %cmp25.not.us.us, label %cleanup.cont.us.us, label %if.then.i156

cleanup.cont.us.us:                               ; preds = %invoke.cont23.us.us
  %9 = load i32, ptr %_remainLen, align 4
...
if.end21.us:                                      ; preds = %if.end18.us, %invoke.cont12.us
  %curSize.1159.us = phi i32 [ %conv17.us, %if.end18.us ], [ 262144, %invoke.cont12.us ]
  %call24.us = invoke noundef i32 @_ZN9NCompress8NDeflate8NDecoder6CCoder8CodeSpecEj(ptr noundef nonnull align 8 dereferenceable(3474) %this, i32 noundef %curSize.1159.us)
...
invoke.cont23.us:                                 ; preds = %if.end21.us
  ...
  br i1 %cmp25.not.us, label %cleanup.cont.us, label %if.then.i156

cleanup.cont.us:                                  ; preds = %invoke.cont23.us
  %12 = load i32, ptr %_remainLen, align 4
...
for.cond.preheader.split:                         ; preds = %for.cond.preheader
  br i1 %cmp.not, label %for.cond.us172, label %for.cond

for.cond.us172:                                   ; preds = %for.cond.preheader.split, %invoke.cont45.us
  %call24.us175 = invoke noundef i32 @_ZN9NCompress8NDeflate8NDecoder6CCoder8CodeSpecEj(ptr noundef nonnull align 8 dereferenceable(3474) %this, i32 noundef 262144)
          to label %invoke.cont23.us176 unwind label %lpad22.split.split.us

invoke.cont23.us176:                              ; preds = %for.cond.us172
  %cmp25.not.us177 = icmp eq i32 %call24.us175, 0
  br i1 %cmp25.not.us177, label %cleanup.cont.us178, label %if.then.i156

cleanup.cont.us178:                               ; preds = %invoke.cont23.us176
  %15 = load i32, ptr %_remainLen, align 4
...
if.end30.us180:                                   ; preds = %cleanup.cont.us178
  ...
  %16 = load i64, ptr %_processedSize.i.i136, align 8
  %17 = load ptr, ptr %m_Stream.i135, align 8
  %18 = load ptr, ptr %_bufferBase.i.i137, align 8
  %sub.ptr.lhs.cast.i.i138.us = ptrtoint ptr %17 to i64
  %sub.ptr.rhs.cast.i.i139.us = ptrtoint ptr %18 to i64
  %19 = load i32, ptr %NumExtraBytes.i140, align 8
  %conv.i141.us = zext i32 %19 to i64
  %20 = load i32, ptr %m_InBitStream33, align 8
  %sub.i142.us = sub i32 32, %20
  %div4.i143.us = lshr i32 %sub.i142.us, 3
  %conv2.i144.us = zext i32 %div4.i143.us to i64
  %.neg169.us = add i64 %16, %cond.neg
  %.neg.i145.us = add i64 %.neg169.us, %sub.ptr.lhs.cast.i.i138.us
  %21 = add i64 %.neg.i145.us, %conv.i141.us
  %22 = add i64 %sub.ptr.rhs.cast.i.i139.us, %conv2.i144.us
  %sub37.us = sub i64 %21, %22
  store i64 %sub37.us, ptr %inSize, align 8
...
invoke.cont40.us:                                 ; preds = %if.end30.us180
  ...
  store i64 %sub42.us, ptr %nowPos64, align 8
  %vtable.us = load ptr, ptr %progress, align 8
...
invoke.cont45.us:                                 ; preds = %invoke.cont40.us
  ...
  br i1 %cmp47.not.us, label %for.cond.us172, label %if.then.i156

lpad22.split.split.us:                            ; preds = %for.cond.us172
...
for.cond:                                         ; preds = %for.cond.preheader.split, %invoke.cont45
  %27 = load i64, ptr %outSize, align 8
...
if.end21:                                         ; preds = %invoke.cont12, %if.end18
  %curSize.1159 = phi i32 [ %conv17, %if.end18 ], [ 262144, %invoke.cont12 ]
  %call24 = invoke noundef i32 @_ZN9NCompress8NDeflate8NDecoder6CCoder8CodeSpecEj(ptr noundef nonnull align 8 dereferenceable(3474) %this, i32 noundef %curSize.1159)
          to label %invoke.cont23 unwind label %lpad22.split.split

invoke.cont23:                                    ; preds = %if.end21
  %cmp25.not = icmp eq i32 %call24, 0
  br i1 %cmp25.not, label %cleanup.cont, label %if.then.i156
...
cleanup.cont:                                     ; preds = %invoke.cont23
  %32 = load i32, ptr %_remainLen, align 4
  %cmp28 = icmp eq i32 %32, -1
  br i1 %cmp28, label %for.end, label %if.end30

if.end30:                                         ; preds = %cleanup.cont
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %inSize) #13
  %33 = load i64, ptr %_processedSize.i.i136, align 8
  %34 = load ptr, ptr %m_Stream.i135, align 8
  %35 = load ptr, ptr %_bufferBase.i.i137, align 8
  %sub.ptr.lhs.cast.i.i138 = ptrtoint ptr %34 to i64
  %sub.ptr.rhs.cast.i.i139 = ptrtoint ptr %35 to i64
  %36 = load i32, ptr %NumExtraBytes.i140, align 8
  %conv.i141 = zext i32 %36 to i64
  %37 = load i32, ptr %m_InBitStream33, align 8
  %sub.i142 = sub i32 32, %37
  %div4.i143 = lshr i32 %sub.i142, 3
  %conv2.i144 = zext i32 %div4.i143 to i64
  %.neg169 = add i64 %33, %cond.neg
  %.neg.i145 = add i64 %.neg169, %sub.ptr.lhs.cast.i.i138
  %38 = add i64 %.neg.i145, %conv.i141
  %39 = add i64 %sub.ptr.rhs.cast.i.i139, %conv2.i144
  %sub37 = sub i64 %38, %39
  store i64 %sub37, ptr %inSize, align 8
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %nowPos64) #13
...
invoke.cont40:                                    ; preds = %if.end30
  ...
  store i64 %sub42, ptr %nowPos64, align 8
...
invoke.cont45:                                    ; preds = %invoke.cont40
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %nowPos64) #13
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %inSize) #13
  br i1 %cmp47.not, label %for.cond, label %if.then.i156
...
for.end:                                          ; preds = %if.end18, %cleanup.cont, %cleanup.cont.us178, %cleanup.cont.us, %if.end18.us, %cleanup.cont.us.us
  %43 = load i32, ptr %_remainLen, align 4
...
if.then66:                                        ; preds = %for.end
  %45 = load i32, ptr %m_InBitStream33, align 8
  %sub.i147 = sub i32 0, %45
  %and.i = and i32 %sub.i147, 7
  %add.i.i = add i32 %and.i, %45
  store i32 %add.i.i, ptr %m_InBitStream33, align 8
  %m_NormalValue.i.i = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 8, i32 1
  %46 = load i32, ptr %m_NormalValue.i.i, align 4
...
if.then.i:                                        ; preds = %if.then66
  %47 = load ptr, ptr %m_Stream.i135, align 8
  %48 = load ptr, ptr %_bufferLimit.i.i, align 8
  %cmp.not.i.i = icmp ult ptr %47, %48
  br i1 %cmp.not.i.i, label %_ZN9CInBuffer8ReadByteERh.exit.thread.i, label %if.then.i.i

if.then.i.i:                                      ; preds = %if.then.i
  %call.i.i153 = invoke noundef zeroext i1 @_ZN9CInBuffer9ReadBlockEv(ptr noundef nonnull align 8 dereferenceable(45) %m_Stream.i135)
          to label %call.i.i.noexc unwind label %lpad72

call.i.i.noexc:                                   ; preds = %if.then.i.i
  br i1 %call.i.i153, label %if.then.if.end3_crit_edge.i.i, label %if.then2.i

if.then.if.end3_crit_edge.i.i:                    ; preds = %call.i.i.noexc
  %.pre.i.i = load ptr, ptr %m_Stream.i135, align 8
  br label %_ZN9CInBuffer8ReadByteERh.exit.thread.i
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i:          ; preds = %if.then.if.end3_crit_edge.i.i, %if.then.i
  ...
  store ptr %incdec.ptr.i.i, ptr %m_Stream.i135, align 8
  %50 = load i8, ptr %49, align 1
  br label %invoke.cont73thread-pre-split

if.then2.i:                                       ; preds = %call.i.i.noexc
  %51 = load i32, ptr %NumExtraBytes.i140, align 8
  %inc.i = add i32 %51, 1
  store i32 %inc.i, ptr %NumExtraBytes.i140, align 8
  br label %invoke.cont73thread-pre-split

if.end3.i:                                        ; preds = %if.then66
  %conv.i148 = trunc i32 %shr.i.i to i8
  %add.i.i149 = add i32 %add.i.i, 8
  store i32 %add.i.i149, ptr %m_InBitStream33, align 8
  %shr.i.i150 = lshr i32 %shr.i.i, 8
  store i32 %shr.i.i150, ptr %m_NormalValue.i.i, align 4
...
invoke.cont73thread-pre-split:                    ; preds = %_ZN9CInBuffer8ReadByteERh.exit.thread.i, %if.then2.i
  ...
  %.pr = load i32, ptr %m_InBitStream33, align 8
  br label %invoke.cont73

invoke.cont73:                                    ; preds = %invoke.cont73thread-pre-split, %if.end3.i
  %52 = phi i32 [ %.pr, %invoke.cont73thread-pre-split ], [ %add.i.i149, %if.end3.i ]
  %retval.0.i = phi i8 [ %retval.0.i.ph, %invoke.cont73thread-pre-split ], [ %conv.i148, %if.end3.i ]
  %arrayidx = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 25, i64 0
  store i8 %retval.0.i, ptr %arrayidx, align 2
  %cmp.i.1 = icmp eq i32 %52, 32
  br i1 %cmp.i.1, label %if.then.i.1, label %if.end3.i.1

if.end3.i.1:                                      ; preds = %invoke.cont73
  %53 = load i32, ptr %m_NormalValue.i.i, align 4
  %conv.i148.1 = trunc i32 %53 to i8
  %add.i.i149.1 = add i32 %52, 8
  store i32 %add.i.i149.1, ptr %m_InBitStream33, align 8
  %shr.i.i150.1 = lshr i32 %53, 8
  store i32 %shr.i.i150.1, ptr %m_NormalValue.i.i, align 4
  br label %invoke.cont73.1

if.then.i.1:                                      ; preds = %invoke.cont73
  %54 = load ptr, ptr %m_Stream.i135, align 8
  %55 = load ptr, ptr %_bufferLimit.i.i, align 8
...
if.then.i.i.1:                                    ; preds = %if.then.i.1
  %call.i.i153.1 = invoke noundef zeroext i1 @_ZN9CInBuffer9ReadBlockEv(ptr noundef nonnull align 8 dereferenceable(45) %m_Stream.i135)
          to label %call.i.i.noexc.1 unwind label %lpad72

call.i.i.noexc.1:                                 ; preds = %if.then.i.i.1
  br i1 %call.i.i153.1, label %if.then.if.end3_crit_edge.i.i.1, label %if.then2.i.1

if.then2.i.1:                                     ; preds = %call.i.i.noexc.1
  %56 = load i32, ptr %NumExtraBytes.i140, align 8
  %inc.i.1 = add i32 %56, 1
  store i32 %inc.i.1, ptr %NumExtraBytes.i140, align 8
  br label %invoke.cont73.1thread-pre-split

if.then.if.end3_crit_edge.i.i.1:                  ; preds = %call.i.i.noexc.1
  %.pre.i.i.1 = load ptr, ptr %m_Stream.i135, align 8
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i.1:        ; preds = %if.then.if.end3_crit_edge.i.i.1, %if.then.i.1
  ...
  store ptr %incdec.ptr.i.i.1, ptr %m_Stream.i135, align 8
...
invoke.cont73.1thread-pre-split:                  ; preds = %if.then2.i.1, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.1
  ...
  %.pr199 = load i32, ptr %m_InBitStream33, align 8
  br label %invoke.cont73.1

invoke.cont73.1:                                  ; preds = %invoke.cont73.1thread-pre-split, %if.end3.i.1
  %59 = phi i32 [ %.pr199, %invoke.cont73.1thread-pre-split ], [ %add.i.i149.1, %if.end3.i.1 ]
  %retval.0.i.1 = phi i8 [ %retval.0.i.1.ph, %invoke.cont73.1thread-pre-split ], [ %conv.i148.1, %if.end3.i.1 ]
  %arrayidx.1 = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 25, i64 1
  store i8 %retval.0.i.1, ptr %arrayidx.1, align 1
  %cmp.i.2 = icmp eq i32 %59, 32
  br i1 %cmp.i.2, label %if.then.i.2, label %if.end3.i.2

if.end3.i.2:                                      ; preds = %invoke.cont73.1
  %60 = load i32, ptr %m_NormalValue.i.i, align 4
  %conv.i148.2 = trunc i32 %60 to i8
  %add.i.i149.2 = add i32 %59, 8
  store i32 %add.i.i149.2, ptr %m_InBitStream33, align 8
  %shr.i.i150.2 = lshr i32 %60, 8
  store i32 %shr.i.i150.2, ptr %m_NormalValue.i.i, align 4
  br label %invoke.cont73.2

if.then.i.2:                                      ; preds = %invoke.cont73.1
  %61 = load ptr, ptr %m_Stream.i135, align 8
  %62 = load ptr, ptr %_bufferLimit.i.i, align 8
...
if.then.i.i.2:                                    ; preds = %if.then.i.2
  %call.i.i153.2 = invoke noundef zeroext i1 @_ZN9CInBuffer9ReadBlockEv(ptr noundef nonnull align 8 dereferenceable(45) %m_Stream.i135)
          to label %call.i.i.noexc.2 unwind label %lpad72

call.i.i.noexc.2:                                 ; preds = %if.then.i.i.2
  br i1 %call.i.i153.2, label %if.then.if.end3_crit_edge.i.i.2, label %if.then2.i.2

if.then2.i.2:                                     ; preds = %call.i.i.noexc.2
  %63 = load i32, ptr %NumExtraBytes.i140, align 8
  %inc.i.2 = add i32 %63, 1
  store i32 %inc.i.2, ptr %NumExtraBytes.i140, align 8
  br label %invoke.cont73.2thread-pre-split

if.then.if.end3_crit_edge.i.i.2:                  ; preds = %call.i.i.noexc.2
  %.pre.i.i.2 = load ptr, ptr %m_Stream.i135, align 8
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i.2:        ; preds = %if.then.if.end3_crit_edge.i.i.2, %if.then.i.2
  ...
  store ptr %incdec.ptr.i.i.2, ptr %m_Stream.i135, align 8
...
invoke.cont73.2thread-pre-split:                  ; preds = %if.then2.i.2, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.2
  ...
  %.pr200 = load i32, ptr %m_InBitStream33, align 8
  br label %invoke.cont73.2

invoke.cont73.2:                                  ; preds = %invoke.cont73.2thread-pre-split, %if.end3.i.2
  %66 = phi i32 [ %.pr200, %invoke.cont73.2thread-pre-split ], [ %add.i.i149.2, %if.end3.i.2 ]
  %retval.0.i.2 = phi i8 [ %retval.0.i.2.ph, %invoke.cont73.2thread-pre-split ], [ %conv.i148.2, %if.end3.i.2 ]
  %arrayidx.2 = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 25, i64 2
  store i8 %retval.0.i.2, ptr %arrayidx.2, align 8
  %cmp.i.3 = icmp eq i32 %66, 32
  br i1 %cmp.i.3, label %if.then.i.3, label %if.end3.i.3

if.end3.i.3:                                      ; preds = %invoke.cont73.2
  %67 = load i32, ptr %m_NormalValue.i.i, align 4
  %conv.i148.3 = trunc i32 %67 to i8
  %add.i.i149.3 = add i32 %66, 8
  store i32 %add.i.i149.3, ptr %m_InBitStream33, align 8
  %shr.i.i150.3 = lshr i32 %67, 8
  store i32 %shr.i.i150.3, ptr %m_NormalValue.i.i, align 4
  br label %invoke.cont73.3

if.then.i.3:                                      ; preds = %invoke.cont73.2
  %68 = load ptr, ptr %m_Stream.i135, align 8
  %69 = load ptr, ptr %_bufferLimit.i.i, align 8
...
if.then.i.i.3:                                    ; preds = %if.then.i.3
  %call.i.i153.3 = invoke noundef zeroext i1 @_ZN9CInBuffer9ReadBlockEv(ptr noundef nonnull align 8 dereferenceable(45) %m_Stream.i135)
          to label %call.i.i.noexc.3 unwind label %lpad72

call.i.i.noexc.3:                                 ; preds = %if.then.i.i.3
  br i1 %call.i.i153.3, label %if.then.if.end3_crit_edge.i.i.3, label %if.then2.i.3

if.then2.i.3:                                     ; preds = %call.i.i.noexc.3
  %70 = load i32, ptr %NumExtraBytes.i140, align 8
  %inc.i.3 = add i32 %70, 1
  store i32 %inc.i.3, ptr %NumExtraBytes.i140, align 8
  br label %invoke.cont73.3

if.then.if.end3_crit_edge.i.i.3:                  ; preds = %call.i.i.noexc.3
  %.pre.i.i.3 = load ptr, ptr %m_Stream.i135, align 8
...
_ZN9CInBuffer8ReadByteERh.exit.thread.i.3:        ; preds = %if.then.if.end3_crit_edge.i.i.3, %if.then.i.3
  ...
  store ptr %incdec.ptr.i.i.3, ptr %m_Stream.i135, align 8
  %72 = load i8, ptr %71, align 1
  br label %invoke.cont73.3

invoke.cont73.3:                                  ; preds = %_ZN9CInBuffer8ReadByteERh.exit.thread.i.3, %if.then2.i.3, %if.end3.i.3
  %retval.0.i.3 = phi i8 [ %conv.i148.3, %if.end3.i.3 ], [ -1, %if.then2.i.3 ], [ %72, %_ZN9CInBuffer8ReadByteERh.exit.thread.i.3 ]
  %arrayidx.3 = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 25, i64 3
  store i8 %retval.0.i.3, ptr %arrayidx.3, align 1
  br label %if.end78
...
if.end78:                                         ; preds = %invoke.cont73.3, %for.end
  ...
  %call.i154 = invoke noundef i32 @_ZN10COutBuffer5FlushEv(ptr noundef nonnull align 8 dereferenceable(49) %m_OutWindowStream)
          to label %invoke.cont80 unwind label %lpad79

invoke.cont80:                                    ; preds = %if.end78
  %cmp82 = icmp eq i32 %call.i154, 0
  br i1 %cmp82, label %invoke.cont84, label %if.end87

invoke.cont84:                                    ; preds = %invoke.cont80
  %74 = load i32, ptr %NumExtraBytes.i140, align 8
...
if.then.i156:                                     ; preds = %invoke.cont23, %invoke.cont45, %invoke.cont45.us, %invoke.cont23.us176, %invoke.cont23.us, %invoke.cont23.us.us
  %retval.6.ph = phi i32 [ %call24.us.us, %invoke.cont23.us.us ], [ %call24.us, %invoke.cont23.us ], [ %call46.us, %invoke.cont45.us ], [ %call24.us175, %invoke.cont23.us176 ], [ %call46, %invoke.cont45 ], [ %call24, %invoke.cont23 ]
...
if.end.i:                                         ; preds = %invoke.cont84, %if.end87, %if.then.i156
  %retval.6204 = phi i32 [ %retval.6.ph, %if.then.i156 ], [ %call.i154, %if.end87 ], [ 1, %invoke.cont84 ]
  %_stream.i.i.i = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 7, i32 0, i32 5
  %77 = load ptr, ptr %_stream.i.i.i, align 8
...
terminate.lpad.i:                                 ; preds = %if.then.i.i.i.i, %if.then.i156
...
if.end:                                           ; preds = %entry
  ...
  %m_Stream.i = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 8, i32 0, i32 2
  %_processedSize.i.i = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 8, i32 0, i32 2, i32 4
  %0 = load i64, ptr %_processedSize.i.i, align 8
  %1 = load ptr, ptr %m_Stream.i, align 8
  %_bufferBase.i.i = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 8, i32 0, i32 2, i32 2
  %2 = load ptr, ptr %_bufferBase.i.i, align 8
  %sub.ptr.lhs.cast.i.i = ptrtoint ptr %1 to i64
  %sub.ptr.rhs.cast.i.i = ptrtoint ptr %2 to i64
  %NumExtraBytes.i = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 8, i32 0, i32 3
  %3 = load i32, ptr %NumExtraBytes.i, align 8
  %conv.i = zext i32 %3 to i64
  %4 = load i32, ptr %m_InBitStream, align 8
  %sub.i = sub i32 32, %4
  %div4.i = lshr i32 %sub.i, 3
  %conv2.i = zext i32 %div4.i to i64
  ...
  %sub3.i = sub i64 %5, %6
  store i64 %sub3.i, ptr %value, align 8
  br label %return
...
if.end.i:                                         ; preds = %entry
  ...
  store i64 %sub3.i.i, ptr %value, align 8
...
entry:
  %_remainLen = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 21
  store i32 -2, ptr %_remainLen, align 4
  %_needInitInStream = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 20
  store i8 1, ptr %_needInitInStream, align 1
  %m_OutWindowStream = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 7
  %_keepHistory = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 19
...
invoke.cont:                                      ; preds = %if.end
  ...
  store ptr %data, ptr %_buffer2.i, align 8
...
invoke.cont12:                                    ; preds = %if.then10
  ...
  store i32 %conv, ptr %processedSize, align 4
  br label %if.end14
...
entry:
  ...
  %m_OutWindowStream = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 7
  %_keepHistory = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 19
  %0 = load i8, ptr %_keepHistory, align 2
