; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Compress/BranchCoder.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Compress/BranchCoder.cpp"
...
entry:
  ...
  store i32 0, ptr %_bufferPos, align 4
...
entry:
  ...
  %_bufferPos = getelementptr inbounds %class.CBranchConverter, ptr %this, i64 0, i32 2
  %1 = load i32, ptr %_bufferPos, align 4
  %add = add i32 %1, %call
  store i32 %add, ptr %_bufferPos, align 4
  ret i32 %call
}
