; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Crypto/HmacSha1.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Crypto/HmacSha1.cpp"
...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %keyTemp, i8 0, i64 64, i1 false)
...
for.body7.preheader:                              ; preds = %for.cond5.preheader
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 %keyTemp, ptr align 1 %key, i64 %keySize, i1 false)
...
if.then:                                          ; preds = %entry
  ...
  store i32 0, ptr %_count2.i, align 8
...
vector.body:                                      ; preds = %for.body7.preheader, %for.cond5.preheader, %if.then
  ...
  store <16 x i8> %2, ptr %1, align 16
  %3 = getelementptr inbounds [64 x i8], ptr %keyTemp, i64 0, i64 32
  %wide.load.2 = load <16 x i8>, ptr %3, align 16
  ...
  store <16 x i8> %4, ptr %3, align 16
  %5 = getelementptr inbounds [64 x i8], ptr %keyTemp, i64 0, i64 48
  %wide.load.3 = load <16 x i8>, ptr %5, align 16
  ...
  store <16 x i8> %6, ptr %5, align 16
  ...
  store i32 0, ptr %_count2.i51, align 8
  ...
  %wide.load65 = load <16 x i8>, ptr %keyTemp, align 16
  ...
  store <16 x i8> %7, ptr %keyTemp, align 16
  %8 = getelementptr inbounds [64 x i8], ptr %keyTemp, i64 0, i64 16
  %wide.load65.1 = load <16 x i8>, ptr %8, align 16
  ...
  %wide.load65.2 = load <16 x i8>, ptr %10, align 16
  ...
  store <16 x i8> %11, ptr %10, align 16
  %12 = getelementptr inbounds [64 x i8], ptr %keyTemp, i64 0, i64 48
  %wide.load65.3 = load <16 x i8>, ptr %12, align 16
  ...
  store <16 x i8> %13, ptr %12, align 16
  ...
  store i32 0, ptr %_count2.i52, align 8
...
for.body.preheader:                               ; preds = %entry
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %mac, ptr nonnull align 16 %digest, i64 %macSize, i1 false)
...
if.then:                                          ; preds = %entry
  ...
  %3 = load i8, ptr %arrayidx17, align 2
  ...
  %7 = load i8, ptr %arrayidx17.1, align 2
  ...
  %11 = load i8, ptr %arrayidx17.2, align 2
  ...
  %12 = load i8, ptr %arrayidx24.2, align 1
  ...
  %15 = load i8, ptr %arrayidx17.3, align 2
  ...
  %16 = load i8, ptr %arrayidx24.3, align 1
  ...
  %19 = load i8, ptr %arrayidx17.4, align 2
  ...
  %20 = load i8, ptr %arrayidx24.4, align 1
...
for.body36:                                       ; preds = %for.body36, %for.body36.preheader.new
  ...
  %25 = load i8, ptr %arrayidx37.1, align 1
  ...
  %28 = load i32, ptr %arrayidx41.1, align 4
  %or42.1 = or i32 %shl40.1, %28
  store i32 %or42.1, ptr %arrayidx41.1, align 4
  %inc44.1 = add nuw nsw i64 %i32.091, 2
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %if.end.loopexit.unr-lcssa, label %for.body36
...
for.body36.epil:                                  ; preds = %if.end.loopexit.unr-lcssa
  ...
  %29 = load i8, ptr %arrayidx37.epil, align 1
...
if.end:                                           ; preds = %if.end.loopexit, %for.cond33.preheader, %if.then
  ...
  %38 = load <4 x i32>, ptr %arrayidx49.5, align 4
  %39 = xor <4 x i32> %38, <i32 909522486, i32 909522486, i32 909522486, i32 909522486>
  store <4 x i32> %39, ptr %arrayidx49.5, align 4
  ...
  %45 = load <4 x i32>, ptr %keyTemp, align 16
  %46 = xor <4 x i32> %45, <i32 1785358954, i32 1785358954, i32 1785358954, i32 1785358954>
  store <4 x i32> %46, ptr %keyTemp, align 16
  %47 = load <4 x i32>, ptr %arrayidx49.4, align 16
  %48 = xor <4 x i32> %47, <i32 1785358954, i32 1785358954, i32 1785358954, i32 1785358954>
  store <4 x i32> %48, ptr %arrayidx49.4, align 16
  %49 = load <4 x i32>, ptr %arrayidx49.8, align 16
  %50 = xor <4 x i32> %49, <i32 1785358954, i32 1785358954, i32 1785358954, i32 1785358954>
  store <4 x i32> %50, ptr %arrayidx49.8, align 16
  %51 = load <4 x i32>, ptr %arrayidx49.12, align 16
  %52 = xor <4 x i32> %51, <i32 1785358954, i32 1785358954, i32 1785358954, i32 1785358954>
  store <4 x i32> %52, ptr %arrayidx49.12, align 16
  ...
  store i32 0, ptr %_count2.i88, align 8
...
for.body.preheader:                               ; preds = %entry
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %mac, ptr nonnull align 16 %digest, i64 %0, i1 false)
  br label %for.cond.cleanup
...
entry:
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(20) %block, ptr noundef nonnull align 4 dereferenceable(20) %mac, i64 20, i1 false)
...
for.body8:                                        ; preds = %for.body8.preheader, %for.body8
  ...
  %0 = load <4 x i32>, ptr %block, align 16
  %1 = load <4 x i32>, ptr %mac, align 4
  %2 = xor <4 x i32> %1, %0
  store <4 x i32> %2, ptr %mac, align 4
  %3 = load i32, ptr %arrayidx21.4, align 16
  %4 = load i32, ptr %arrayidx23.4, align 4
  %xor.4 = xor i32 %4, %3
  store i32 %xor.4, ptr %arrayidx23.4, align 4
