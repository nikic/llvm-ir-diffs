...
vector.ph:                                        ; preds = %while.body
  ...
  %wide.load = load <4 x i8>, ptr %buff, align 16, !tbaa !23
  store <4 x i8> %wide.load, ptr %data.addr.019, align 1, !tbaa !23
  %9 = add <4 x i32> %8, <i32 -1, i32 -1, i32 -1, i32 -1>
  %10 = icmp eq i64 %n.vec, 4
  br i1 %10, label %middle.block, label %vector.body.1, !llvm.loop !24

vector.body.1:                                    ; preds = %vector.ph
  %next.gep.1 = getelementptr i8, ptr %data.addr.019, i64 4
  %wide.load.1 = load <4 x i8>, ptr %1, align 4, !tbaa !23
  store <4 x i8> %wide.load.1, ptr %next.gep.1, align 1, !tbaa !23
  %11 = add <4 x i32> %8, <i32 -2, i32 -2, i32 -2, i32 -2>
  %12 = icmp eq i64 %n.vec, 8
  br i1 %12, label %middle.block, label %vector.body.2, !llvm.loop !24

vector.body.2:                                    ; preds = %vector.body.1
  %next.gep.2 = getelementptr i8, ptr %data.addr.019, i64 8
  %wide.load.2 = load <4 x i8>, ptr %2, align 8, !tbaa !23
  store <4 x i8> %wide.load.2, ptr %next.gep.2, align 1, !tbaa !23
  %13 = add <4 x i32> %8, <i32 -3, i32 -3, i32 -3, i32 -3>
  %14 = icmp eq i64 %n.vec, 12
  br i1 %14, label %middle.block, label %vector.body.3, !llvm.loop !24

vector.body.3:                                    ; preds = %vector.body.2
  %next.gep.3 = getelementptr i8, ptr %data.addr.019, i64 12
  %wide.load.3 = load <4 x i8>, ptr %3, align 4, !tbaa !23
  store <4 x i8> %wide.load.3, ptr %next.gep.3, align 1, !tbaa !23
  %15 = add <4 x i32> %8, <i32 -4, i32 -4, i32 -4, i32 -4>
  %16 = icmp eq i64 %n.vec, 16
  br i1 %16, label %middle.block, label %vector.body.4, !llvm.loop !24

vector.body.4:                                    ; preds = %vector.body.3
  %next.gep.4 = getelementptr i8, ptr %data.addr.019, i64 16
  %wide.load.4 = load <4 x i8>, ptr %4, align 16, !tbaa !23
  store <4 x i8> %wide.load.4, ptr %next.gep.4, align 1, !tbaa !23
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %19 = load i8, ptr %arrayidx, align 1, !tbaa !23
  %incdec.ptr = getelementptr inbounds i8, ptr %data.addr.115, i64 1
  store i8 %19, ptr %data.addr.115, align 1, !tbaa !23
