; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Crypto/ZipCrypto.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Crypto/ZipCrypto.cpp"
...
entry:
  ...
  %shr = lshr i32 %0, 8
  %xor5 = xor i32 %1, %shr
  store i32 %xor5, ptr %Keys, align 4
  ...
  %add13 = add i32 %mul, 1
  store i32 %add13, ptr %arrayidx9, align 8
  ...
  store i32 %xor30, ptr %arrayidx17, align 4
  ret void
}
...
for.cond7.preheader:                              ; preds = %for.body, %entry
  ...
  store i32 %2, ptr %arrayidx15, align 8
  ...
  store i32 %0, ptr %arrayidx15.2, align 8
  ret i32 0
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %8 = load i32, ptr %arrayidx26.i, align 4
  %shr29.i = lshr i32 %5, 8
  %xor30.i = xor i32 %8, %shr29.i
  store i32 %xor30.i, ptr %arrayidx5, align 4
...
entry:
  ...
  store i32 305419896, ptr %Keys.i, align 4
  %arrayidx3.i = getelementptr inbounds i8, ptr %this, i64 16
  store i32 591751049, ptr %arrayidx3.i, align 4
  %arrayidx5.i = getelementptr inbounds i8, ptr %this, i64 20
  store i32 878082192, ptr %arrayidx5.i, align 4
...
for.body.i:                                       ; preds = %for.body.i, %for.body.preheader.i
  ...
  %5 = load i32, ptr %arrayidx26.i.i, align 4
  %shr29.i.i = lshr i32 %2, 8
  %xor30.i.i = xor i32 %5, %shr29.i.i
  store i32 %xor30.i.i, ptr %arrayidx5.i, align 4
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %_ZN7NCrypto4NZip7CCipher17CryptoSetPasswordEPKhj.exit, label %for.body.i
...
_ZN7NCrypto4NZip7CCipher17CryptoSetPasswordEPKhj.exit: ; preds = %for.body.i, %entry
  ...
  store i32 %8, ptr %arrayidx15.i, align 4
  %arrayidx15.1.i = getelementptr inbounds i8, ptr %this, i64 28
  store i32 %7, ptr %arrayidx15.1.i, align 4
  %arrayidx15.2.i = getelementptr inbounds i8, ptr %this, i64 32
  store i32 %6, ptr %arrayidx15.2.i, align 4
  ret i32 0
}
...
entry:
  ...
  %scevgep.i = getelementptr inbounds i8, ptr %this, i64 20
  %scevgep8.i = getelementptr inbounds i8, ptr %this, i64 32
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %scevgep.i, ptr noundef nonnull align 8 dereferenceable(12) %scevgep8.i, i64 12, i1 false)
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %xor12 = xor i8 %1, %conv.i
  store i8 %xor12, ptr %arrayidx, align 1
  %2 = load i32, ptr %Keys.i, align 4
  %.tr.i = trunc i32 %2 to i8
  %xor.narrow.i = xor i8 %1, %.tr.i
  %idxprom.i = zext i8 %xor.narrow.i to i64
  %arrayidx2.i = getelementptr inbounds [0 x i32], ptr @g_CrcTable, i64 0, i64 %idxprom.i
  %3 = load i32, ptr %arrayidx2.i, align 4
  %shr.i13 = lshr i32 %2, 8
  %xor5.i = xor i32 %3, %shr.i13
  store i32 %xor5.i, ptr %Keys.i, align 4
  %4 = load i32, ptr %arrayidx9.i, align 8
  %and12.i = and i32 %xor5.i, 255
  %add.i = add i32 %4, %and12.i
  %mul.i14 = mul i32 %add.i, 134775813
  %add13.i = add i32 %mul.i14, 1
  store i32 %add13.i, ptr %arrayidx9.i, align 8
  ...
  store i32 %xor30.i, ptr %arrayidx.i, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %shr.i = lshr i32 %mul.i, 8
  %conv.i = trunc i32 %shr.i to i8
  %xor12 = xor i8 %0, %conv.i
  %2 = load i32, ptr %Keys.i, align 4
  %.tr.i = trunc i32 %2 to i8
  %xor.narrow.i = xor i8 %xor12, %.tr.i
  %idxprom.i = zext i8 %xor.narrow.i to i64
  %arrayidx2.i = getelementptr inbounds [0 x i32], ptr @g_CrcTable, i64 0, i64 %idxprom.i
  %3 = load i32, ptr %arrayidx2.i, align 4
  %shr.i13 = lshr i32 %2, 8
