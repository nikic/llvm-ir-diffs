...
entry:
  ...
  store i32 591751049, ptr %arrayidx3.i, align 4, !tbaa !5
...
for.body.i:                                       ; preds = %for.body.i, %for.body.preheader.i
  ...
  store i32 %add13.i.i, ptr %arrayidx3.i, align 4, !tbaa !5
...
_ZN7NCrypto4NZip7CCipher17CryptoSetPasswordEPKhj.exit: ; preds = %for.body.i, %entry
  ...
  store i32 %8, ptr %arrayidx15.i, align 4, !tbaa !5
  ...
  store i32 %6, ptr %arrayidx15.2.i, align 4, !tbaa !5
  ret i32 0
}
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  store i8 %xor12, ptr %arrayidx, align 1, !tbaa !9
  %2 = load i32, ptr %Keys.i, align 4, !tbaa !5
  ...
  %4 = load i32, ptr %arrayidx9.i, align 8, !tbaa !5
  %and12.i = and i32 %xor5.i, 255
  %add.i = add i32 %4, %and12.i
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %idxprom25.i = zext i32 %and24.i to i64
  %arrayidx26.i = getelementptr inbounds [0 x i32], ptr @g_CrcTable, i64 0, i64 %idxprom25.i
  %5 = load i32, ptr %arrayidx26.i, align 4, !tbaa !5
...
for.cond.i15:                                     ; preds = %if.end
  ...
  %33 = load i8, ptr %arrayidx.1.i16, align 1, !tbaa !9
...
for.cond.1.i18:                                   ; preds = %for.cond.i15
  ...
  %35 = load i8, ptr %arrayidx.2.i19, align 2, !tbaa !9
...
for.cond.2.i21:                                   ; preds = %for.cond.1.i18
  ...
  %37 = load i8, ptr %arrayidx.3.i22, align 1, !tbaa !9
...
for.cond.3.i24:                                   ; preds = %for.cond.2.i21
  ...
  %39 = load i8, ptr %arrayidx.4.i25, align 4, !tbaa !9
...
for.cond.4.i27:                                   ; preds = %for.cond.3.i24
  ...
  %41 = load i8, ptr %arrayidx.5.i28, align 1, !tbaa !9
...
for.cond.5.i30:                                   ; preds = %for.cond.4.i27
  ...
  %43 = load i8, ptr %arrayidx.6.i31, align 2, !tbaa !9
...
for.cond.6.i33:                                   ; preds = %for.cond.5.i30
  ...
  %45 = load i8, ptr %arrayidx.7.i34, align 1, !tbaa !9
...
for.cond.7.i36:                                   ; preds = %for.cond.6.i33
  ...
  %47 = load i8, ptr %arrayidx.8.i37, align 4, !tbaa !9
...
for.cond.8.i39:                                   ; preds = %for.cond.7.i36
  ...
  %49 = load i8, ptr %arrayidx.9.i40, align 1, !tbaa !9
...
for.cond.9.i42:                                   ; preds = %for.cond.8.i39
  ...
  %51 = load i8, ptr %arrayidx.10.i43, align 2, !tbaa !9
...
for.cond.10.i45:                                  ; preds = %for.cond.9.i42
  ...
  %53 = load i8, ptr %arrayidx.11.i46, align 1, !tbaa !9
...
for.cond.11.i48:                                  ; preds = %for.cond.10.i45
  ...
  %55 = load i8, ptr %arrayidx.12.i49, align 4, !tbaa !9
...
for.cond.12.i51:                                  ; preds = %for.cond.11.i48
  ...
  %57 = load i8, ptr %arrayidx.13.i52, align 1, !tbaa !9
...
for.cond.13.i54:                                  ; preds = %for.cond.12.i51
  ...
  %59 = load i8, ptr %arrayidx.14.i55, align 2, !tbaa !9
...
_ZeqRK4GUIDS1_.exit61:                            ; preds = %for.cond.13.i54
  ...
  %61 = load i8, ptr %arrayidx.15.i58, align 1, !tbaa !9
