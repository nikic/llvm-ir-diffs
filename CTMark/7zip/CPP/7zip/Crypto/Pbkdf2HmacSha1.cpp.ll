; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Crypto/Pbkdf2HmacSha1.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Crypto/Pbkdf2HmacSha1.cpp"
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  br i1 %cmp1767, label %for.body19.us.us.preheader.preheader, label %for.cond16.preheader

for.body19.us.us.preheader.preheader:             ; preds = %for.body.lr.ph
  %0 = getelementptr inbounds [20 x i8], ptr %u, i64 0, i64 8
  br label %for.body19.us.us.preheader

for.body19.us.us.preheader:                       ; preds = %for.body19.us.us.preheader.preheader, %for.cond16.for.cond.cleanup18_crit_edge.us
  %key.addr.072.us = phi ptr [ %add.ptr.us, %for.cond16.for.cond.cleanup18_crit_edge.us ], [ %key, %for.body19.us.us.preheader.preheader ]
  %i.071.us = phi i32 [ %inc39.us, %for.cond16.for.cond.cleanup18_crit_edge.us ], [ 1, %for.body19.us.us.preheader.preheader ]
  %keySize.addr.070.us = phi i64 [ %sub.us, %for.cond16.for.cond.cleanup18_crit_edge.us ], [ %keySize, %for.body19.us.us.preheader.preheader ]
  ...
  store i8 %conv.us, ptr %u, align 16
  %shr1.us = lshr i32 %i.071.us, 16
  %conv2.us = trunc i32 %shr1.us to i8
  store i8 %conv2.us, ptr %arrayinit.element, align 1
  %shr4.us = lshr i32 %i.071.us, 8
  %conv5.us = trunc i32 %shr4.us to i8
  store i8 %conv5.us, ptr %arrayinit.element3, align 2
  %conv7.us = trunc i32 %i.071.us to i8
  store i8 %conv7.us, ptr %arrayinit.element6, align 1
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %key.addr.072.us, ptr nonnull align 16 %u, i64 %cond61.us, i1 false)
  %min.iters.check = icmp ult i64 %keySize.addr.070.us, 8
  %n.vec92 = and i64 %cond61.us, 24
  %1 = icmp eq i64 %n.vec92, 8
  %2 = getelementptr inbounds i8, ptr %key.addr.072.us, i64 8
  %cmp.n93 = icmp eq i64 %cond61.us, %n.vec92
  br label %iter.check
...
for.cond16.for.cond.cleanup18_crit_edge.us:       ; preds = %for.cond22.for.inc35_crit_edge.us.us
  ...
  br i1 %cmp.not.us, label %for.cond.cleanup, label %for.body19.us.us.preheader

iter.check:                                       ; preds = %for.body19.us.us.preheader, %for.cond22.for.inc35_crit_edge.us.us
  %j.068.us.us = phi i32 [ %dec.us.us, %for.cond22.for.inc35_crit_edge.us.us ], [ %numIterations, %for.body19.us.us.preheader ]
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(208) %ctx, ptr noundef nonnull align 8 dereferenceable(208) %baseCtx, i64 208, i1 false)
...
vec.epilog.vector.body:                           ; preds = %iter.check
  %wide.load95 = load <8 x i8>, ptr %u, align 16
  %wide.load96 = load <8 x i8>, ptr %key.addr.072.us, align 1
  %3 = xor <8 x i8> %wide.load96, %wide.load95
  store <8 x i8> %3, ptr %key.addr.072.us, align 1
  br i1 %1, label %vec.epilog.middle.block, label %vec.epilog.vector.body.1

vec.epilog.vector.body.1:                         ; preds = %vec.epilog.vector.body
  %wide.load95.1 = load <8 x i8>, ptr %0, align 8
  %wide.load96.1 = load <8 x i8>, ptr %2, align 1
  %4 = xor <8 x i8> %wide.load96.1, %wide.load95.1
  store <8 x i8> %4, ptr %2, align 1
  br label %vec.epilog.middle.block

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body.1, %vec.epilog.vector.body
  br i1 %cmp.n93, label %for.cond22.for.inc35_crit_edge.us.us, label %for.body24.us.us.preheader

for.body24.us.us.preheader:                       ; preds = %iter.check, %vec.epilog.middle.block
  %indvars.iv.ph = phi i64 [ 0, %iter.check ], [ %n.vec92, %vec.epilog.middle.block ]
...
for.body24.us.us:                                 ; preds = %for.body24.us.us.preheader, %for.body24.us.us
  ...
  %5 = load i8, ptr %arrayidx26.us.us, align 1
  %arrayidx29.us.us = getelementptr inbounds i8, ptr %key.addr.072.us, i64 %indvars.iv
  %6 = load i8, ptr %arrayidx29.us.us, align 1
  %xor62.us.us = xor i8 %6, %5
  store i8 %xor62.us.us, ptr %arrayidx29.us.us, align 1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %cond61.us
  br i1 %exitcond.not, label %for.cond22.for.inc35_crit_edge.us.us, label %for.body24.us.us
...
for.cond22.for.inc35_crit_edge.us.us:             ; preds = %for.body24.us.us, %vec.epilog.middle.block
  ...
  br i1 %cmp17.us.us, label %iter.check, label %for.cond16.for.cond.cleanup18_crit_edge.us

for.cond.cleanup:                                 ; preds = %for.cond16.preheader, %for.cond16.for.cond.cleanup18_crit_edge.us, %entry
  call void @llvm.lifetime.end.p0(i64 208, ptr nonnull %baseCtx) #6
  ret void

for.cond16.preheader:                             ; preds = %for.body.lr.ph, %for.cond16.preheader
  %key.addr.072 = phi ptr [ %add.ptr, %for.cond16.preheader ], [ %key, %for.body.lr.ph ]
  %i.071 = phi i32 [ %inc39, %for.cond16.preheader ], [ 1, %for.body.lr.ph ]
  %keySize.addr.070 = phi i64 [ %sub, %for.cond16.preheader ], [ %keySize, %for.body.lr.ph ]
  call void @llvm.lifetime.start.p0(i64 208, ptr nonnull %ctx) #6
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(208) %ctx, ptr noundef nonnull align 8 dereferenceable(208) %baseCtx, i64 208, i1 false)
  call void @_ZN7NCrypto5NSha18CContext6UpdateEPKhm(ptr noundef nonnull align 8 dereferenceable(100) %ctx, ptr noundef %salt, i64 noundef %saltSize)
  call void @llvm.lifetime.start.p0(i64 20, ptr nonnull %u) #6
  ...
  store i8 %conv5, ptr %arrayinit.element3, align 2
  %conv7 = trunc i32 %i.071 to i8
  store i8 %conv7, ptr %arrayinit.element6, align 1
  %cond61 = call i64 @llvm.umin.i64(i64 %keySize.addr.070, i64 20)
  call void @_ZN7NCrypto5NSha18CContext6UpdateEPKhm(ptr noundef nonnull align 8 dereferenceable(100) %ctx, ptr noundef nonnull %u, i64 noundef 4)
  call void @_ZN7NCrypto5NSha15CHmac5FinalEPhm(ptr noundef nonnull align 8 dereferenceable(208) %ctx, ptr noundef nonnull %u, i64 noundef 20)
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %key.addr.072, ptr nonnull align 16 %u, i64 %cond61, i1 false)
  ...
  br i1 %cmp.not, label %for.cond.cleanup, label %for.cond16.preheader
}
...
for.end:                                          ; preds = %for.body.lr.ph, %for.end
  %key.addr.030 = phi ptr [ %key, %for.body.lr.ph ], [ %add.ptr, %for.end ]
  %i.029 = phi i32 [ 1, %for.body.lr.ph ], [ %inc12, %for.end ]
  %keySize.addr.028 = phi i64 [ %keySize, %for.body.lr.ph ], [ %sub10, %for.end ]
  call void @llvm.lifetime.start.p0(i64 208, ptr nonnull %ctx) #6
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(208) %ctx, ptr noundef nonnull align 8 dereferenceable(208) %baseCtx, i64 208, i1 false)
  ...
  call void @llvm.lifetime.start.p0(i64 20, ptr nonnull %u) #6
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(20) %u, i8 0, i64 20, i1 false)
  store i32 %i.029, ptr %u, align 16
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %key.addr.030, ptr nonnull align 16 %u, i64 %0, i1 false)
  ...
  br i1 %cmp.not, label %for.cond.cleanup, label %for.end
}
