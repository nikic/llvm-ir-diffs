...
for.cond16.for.cond.cleanup18_crit_edge.us:       ; preds = %for.cond22.for.inc35_crit_edge.us.us
  ...
  br i1 %cmp.not.us, label %for.cond.cleanup, label %for.body19.us.us.preheader, !llvm.loop !8
...
vec.epilog.vector.body:                           ; preds = %iter.check
  %wide.load95 = load <8 x i8>, ptr %u, align 16, !tbaa !5
  %wide.load96 = load <8 x i8>, ptr %key.addr.072.us, align 1, !tbaa !5
...
vec.epilog.vector.body.1:                         ; preds = %vec.epilog.vector.body
  %wide.load95.1 = load <8 x i8>, ptr %0, align 8, !tbaa !5
  %wide.load96.1 = load <8 x i8>, ptr %2, align 1, !tbaa !5
...
for.cond16.preheader:                             ; preds = %for.body.lr.ph, %for.cond16.preheader
  ...
  br i1 %cmp.not, label %for.cond.cleanup, label %for.cond16.preheader, !llvm.loop !8
}
...
for.end:                                          ; preds = %for.body.lr.ph, %for.end
  ...
  br i1 %cmp.not, label %for.cond.cleanup, label %for.end, !llvm.loop !17
}
