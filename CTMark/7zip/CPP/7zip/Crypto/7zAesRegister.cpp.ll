; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Crypto/7zAesRegister.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Crypto/7zAesRegister.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [9 x ptr] }, ptr @_ZTV15ICompressFilter, i64 0, inrange i32 0, i64 2), ptr %call, align 8
  %1 = getelementptr inbounds i8, ptr %call, i64 8
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV18ICryptoSetPassword, i64 0, inrange i32 0, i64 2), ptr %1, align 8
...
invoke.cont:                                      ; preds = %entry
  ...
  store ptr null, ptr %_aesFilter.i.i, align 8
  %3 = getelementptr inbounds i8, ptr %call, i64 176
  store ptr getelementptr inbounds ({ [12 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN7NCrypto7NSevenZ8CDecoderE, i64 0, inrange i32 0, i64 2), ptr %call, align 8
  store ptr getelementptr inbounds ({ [12 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN7NCrypto7NSevenZ8CDecoderE, i64 0, inrange i32 1, i64 2), ptr %1, align 8
  store ptr getelementptr inbounds ({ [12 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN7NCrypto7NSevenZ8CDecoderE, i64 0, inrange i32 2, i64 2), ptr %3, align 8
  ret ptr %call
...
invoke.cont:                                      ; preds = %entry
  ...
  store ptr getelementptr inbounds ({ [13 x ptr], [8 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN7NCrypto7NSevenZ8CEncoderE, i64 0, inrange i32 0, i64 2), ptr %call, align 8
  store ptr getelementptr inbounds ({ [13 x ptr], [8 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN7NCrypto7NSevenZ8CEncoderE, i64 0, inrange i32 1, i64 2), ptr %1, align 8
  store ptr getelementptr inbounds ({ [13 x ptr], [8 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN7NCrypto7NSevenZ8CEncoderE, i64 0, inrange i32 2, i64 2), ptr %3, align 8
  store ptr getelementptr inbounds ({ [13 x ptr], [8 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN7NCrypto7NSevenZ8CEncoderE, i64 0, inrange i32 3, i64 2), ptr %4, align 8
  ret ptr %call
