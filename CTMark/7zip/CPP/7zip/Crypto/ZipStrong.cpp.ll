; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Crypto/ZipStrong.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Crypto/ZipStrong.cpp"
...
entry:
  ...
  store i32 0, ptr %_count2.i.i, align 8
  ...
  store i32 0, ptr %_count2.i.i66, align 8
...
entry:
  ...
  store i32 0, ptr %_count2.i.i.i, align 8
...
cleanup.cont32:                                   ; preds = %if.end23
  ...
  store i32 %3, ptr %_remSize, align 4
  %4 = add i32 %3, -262145
...
if.end39.if.end53_crit_edge:                      ; preds = %if.end39
  ...
  %.pre72 = load ptr, ptr %_bufAligned54.phi.trans.insert, align 8
  br label %if.end53
...
delete.notnull.i:                                 ; preds = %if.then44
  ...
  %.pre = load i32, ptr %_remSize, align 4
...
_ZN7CBufferIhE4FreeEv.exit:                       ; preds = %if.then44, %delete.notnull.i
  ...
  store ptr %9, ptr %_bufAligned, align 8
  %.pre73 = load i32, ptr %_remSize, align 4
  br label %if.end53
...
entry:
  ...
  %sha = alloca %"class.NCrypto::NSha1::CContext", align 8
  store i8 0, ptr %passwOK, align 1
  %_remSize = getelementptr inbounds %"class.NCrypto::NZipStrong::CDecoder", ptr %this, i64 0, i32 3
  %0 = load i32, ptr %_remSize, align 4
  %cmp = icmp ult i32 %0, 16
  br i1 %cmp, label %return, label %if.end

if.end:                                           ; preds = %entry
  %_bufAligned = getelementptr inbounds %"class.NCrypto::NZipStrong::CBaseCoder", ptr %this, i64 0, i32 4
  %1 = load ptr, ptr %_bufAligned, align 8
...
if.end21:                                         ; preds = %if.end14
  ...
  store i32 %add24, ptr %KeySize, align 8
  %6 = and i16 %5, 16385
...
if.end33:                                         ; preds = %if.end21
  ...
  %7 = load i16, ptr %add.ptr34, align 2
...
if.end42:                                         ; preds = %lor.lhs.false
  ...
  %8 = load i32, ptr %add.ptr47, align 4
...
if.end50:                                         ; preds = %if.end42
  ...
  %9 = load i16, ptr %add.ptr51, align 2
...
cleanup.cont78:                                   ; preds = %cleanup.cont
  ...
  %16 = load i32, ptr %KeySize, align 8
...
cleanup.cont114:                                  ; preds = %cleanup.cont102
  ...
  %vtable118 = load ptr, ptr %this, align 8
...
if.end123:                                        ; preds = %cleanup.cont114
  ...
  %21 = load i32, ptr %add.ptr126, align 4
...
if.end131:                                        ; preds = %if.end123
  store i8 1, ptr %passwOK, align 1
  %vtable132 = load ptr, ptr %this, align 8
