...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i8> %27, ptr %28, align 4, !tbaa !15
  %index.next = add nuw i64 %index, 4
  %vec.ind.next = add <4 x i32> %vec.ind, <i32 4, i32 4, i32 4, i32 4>
  %29 = icmp eq i64 %index.next, %n.vec
  br i1 %29, label %for.body.preheader, label %vector.body, !llvm.loop !20
...
for.cond.cleanup:                                 ; preds = %for.body
  ...
  %31 = load i32, ptr %offset.i, align 8, !tbaa !23
  ...
  store i32 16, ptr %_aes, align 4, !tbaa !25
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %32 = load i32, ptr %arrayidx, align 4, !tbaa !16
  ...
  store i8 %conv18, ptr %arrayidx20, align 1, !tbaa !15
...
entry:
  ...
  %0 = load i32, ptr %offset, align 4, !tbaa !23
  ...
  store i32 16, ptr %p, align 4, !tbaa !25
  ret void
}
...
entry:
  ...
  store i8 0, ptr %isOK, align 1, !tbaa !29
...
for.cond.i.preheader:                             ; preds = %cleanup.cont
  ...
  br i1 %cmp4.not.i, label %for.cond.i.1, label %_ZN7NCrypto6NWzAesL13CompareArraysEPKhS2_j.exit, !llvm.loop !31
...
for.cond.i.1:                                     ; preds = %for.cond.i.preheader
  ...
  br i1 %cmp4.not.i.1, label %for.cond.i.2, label %_ZN7NCrypto6NWzAesL13CompareArraysEPKhS2_j.exit, !llvm.loop !31
...
for.cond.i.2:                                     ; preds = %for.cond.i.1
  ...
  br i1 %cmp4.not.i.2, label %for.cond.i.3, label %_ZN7NCrypto6NWzAesL13CompareArraysEPKhS2_j.exit, !llvm.loop !31
...
for.cond.i.3:                                     ; preds = %for.cond.i.2
  ...
  br i1 %cmp4.not.i.3, label %for.cond.i.4, label %_ZN7NCrypto6NWzAesL13CompareArraysEPKhS2_j.exit, !llvm.loop !31
...
for.cond.i.4:                                     ; preds = %for.cond.i.3
  ...
  br i1 %cmp4.not.i.4, label %for.cond.i.5, label %_ZN7NCrypto6NWzAesL13CompareArraysEPKhS2_j.exit, !llvm.loop !31
...
for.cond.i.5:                                     ; preds = %for.cond.i.4
  ...
  br i1 %cmp4.not.i.5, label %for.cond.i.6, label %_ZN7NCrypto6NWzAesL13CompareArraysEPKhS2_j.exit, !llvm.loop !31
...
for.cond.i.6:                                     ; preds = %for.cond.i.5
  ...
  br i1 %cmp4.not.i.6, label %for.cond.i.7, label %_ZN7NCrypto6NWzAesL13CompareArraysEPKhS2_j.exit, !llvm.loop !31
...
for.cond.i.7:                                     ; preds = %for.cond.i.6
  ...
  br i1 %cmp4.not.i.7, label %for.cond.i.8, label %_ZN7NCrypto6NWzAesL13CompareArraysEPKhS2_j.exit, !llvm.loop !31
...
for.cond.i.8:                                     ; preds = %for.cond.i.7
  ...
  br label %_ZN7NCrypto6NWzAesL13CompareArraysEPKhS2_j.exit, !llvm.loop !31
...
_ZN7NCrypto6NWzAesL13CompareArraysEPKhS2_j.exit:  ; preds = %for.cond.i.8, %for.cond.i.preheader, %for.cond.i.1, %for.cond.i.2, %for.cond.i.3, %for.cond.i.4, %for.cond.i.5, %for.cond.i.6, %for.cond.i.7, %cleanup.cont
  ...
  store i8 %cmp.lcssa.i, ptr %isOK, align 1, !tbaa !29
...
entry:
  ...
  store i32 %conv3, ptr %offset, align 4, !tbaa !23
  ret void
}
...
if.end:                                           ; preds = %entry
  %1 = load i32, ptr %p, align 4, !tbaa !25
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %24, align 1, !tbaa !15, !alias.scope !32
  %25 = getelementptr inbounds i8, ptr %24, i64 16
  %wide.load84 = load <16 x i8>, ptr %25, align 1, !tbaa !15, !alias.scope !32
  %wide.load85 = load <16 x i8>, ptr %next.gep, align 1, !tbaa !15, !alias.scope !35, !noalias !32
  %26 = getelementptr i8, ptr %next.gep, i64 16
  %wide.load86 = load <16 x i8>, ptr %26, align 1, !tbaa !15, !alias.scope !35, !noalias !32
  %27 = xor <16 x i8> %wide.load85, %wide.load
  %28 = xor <16 x i8> %wide.load86, %wide.load84
  store <16 x i8> %27, ptr %next.gep, align 1, !tbaa !15, !alias.scope !35, !noalias !32
  store <16 x i8> %28, ptr %26, align 1, !tbaa !15, !alias.scope !35, !noalias !32
  %index.next = add nuw i64 %index, 32
  %29 = icmp eq i64 %index.next, %n.vec
  br i1 %29, label %middle.block, label %vector.body, !llvm.loop !37
...
do.body:                                          ; preds = %do.body.preheader87, %do.body
  ...
  %xor68 = xor i8 %31, %30
  store i8 %xor68, ptr %data.addr.0, align 1, !tbaa !15
  %dec = add i64 %size.addr.0, -1
  %cmp6 = icmp ne i64 %dec, 0
  %cmp7 = icmp ne i32 %inc, 16
  %32 = and i1 %cmp7, %cmp6
  br i1 %32, label %do.body, label %if.end8, !llvm.loop !38
...
if.then10:                                        ; preds = %if.end8
  ...
  %33 = load ptr, ptr @g_AesCtr_Code, align 8, !tbaa !39
...
for.body.preheader:                               ; preds = %if.end13
  ...
  %34 = load ptr, ptr @g_AesCtr_Code, align 8, !tbaa !39
...
do.body22:                                        ; preds = %do.body22, %for.body.preheader.new
  ...
  store i8 %xor2969, ptr %data.addr.3, align 1, !tbaa !15
  ...
  store i8 %xor2969.1, ptr %incdec.ptr27, align 1, !tbaa !15
  ...
  store i8 %xor2969.2, ptr %incdec.ptr27.1, align 1, !tbaa !15
  ...
  store i8 %xor2969.3, ptr %incdec.ptr27.2, align 1, !tbaa !15
  %niter.next.3 = add i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %if.end38.loopexit.unr-lcssa, label %do.body22, !llvm.loop !40
...
do.body22.epil:                                   ; preds = %if.end38.loopexit.unr-lcssa, %do.body22.epil
  ...
  store i8 %xor2969.epil, ptr %data.addr.3.epil, align 1, !tbaa !15
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %if.end38.loopexit, label %do.body22.epil, !llvm.loop !41
...
if.end38:                                         ; preds = %if.end38.loopexit, %if.end13
  ...
  store i32 %pos.4, ptr %p, align 4, !tbaa !25
  br label %cleanup
...
entry:
  ...
  %aes.i = getelementptr inbounds %"class.NCrypto::NWzAes::CBaseCoder", ptr %this, i64 0, i32 6, i32 2
  %offset.i = getelementptr inbounds %"class.NCrypto::NWzAes::CBaseCoder", ptr %this, i64 0, i32 6, i32 1
  %0 = load i32, ptr %offset.i, align 8, !tbaa !23
...
if.end.i:                                         ; preds = %entry
  %1 = load i32, ptr %_aes, align 4, !tbaa !25
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %24, align 1, !tbaa !15, !alias.scope !43
  %25 = getelementptr inbounds i8, ptr %24, i64 16
  %wide.load17 = load <16 x i8>, ptr %25, align 1, !tbaa !15, !alias.scope !43
  %wide.load18 = load <16 x i8>, ptr %next.gep, align 1, !tbaa !15, !alias.scope !46, !noalias !43
  %26 = getelementptr i8, ptr %next.gep, i64 16
  %wide.load19 = load <16 x i8>, ptr %26, align 1, !tbaa !15, !alias.scope !46, !noalias !43
  %27 = xor <16 x i8> %wide.load18, %wide.load
  %28 = xor <16 x i8> %wide.load19, %wide.load17
  store <16 x i8> %27, ptr %next.gep, align 1, !tbaa !15, !alias.scope !46, !noalias !43
  store <16 x i8> %28, ptr %26, align 1, !tbaa !15, !alias.scope !46, !noalias !43
  %index.next = add nuw i64 %index, 32
  %29 = icmp eq i64 %index.next, %n.vec
...
do.body22.i:                                      ; preds = %do.body22.i, %for.body.preheader.i.new
  ...
  store i8 %xor2969.i, ptr %data.addr.3.i, align 1, !tbaa !15
  ...
  store i8 %xor2969.i.1, ptr %incdec.ptr27.i, align 1, !tbaa !15
  ...
  store i8 %xor2969.i.2, ptr %incdec.ptr27.i.1, align 1, !tbaa !15
  ...
  store i8 %xor2969.i.3, ptr %incdec.ptr27.i.2, align 1, !tbaa !15
  %niter.next.3 = add i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %if.end38.loopexit.i.unr-lcssa, label %do.body22.i, !llvm.loop !40
...
do.body22.i.epil:                                 ; preds = %if.end38.loopexit.i.unr-lcssa, %do.body22.i.epil
  ...
  store i8 %xor2969.i.epil, ptr %data.addr.3.i.epil, align 1, !tbaa !15
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %if.end38.loopexit.i, label %do.body22.i.epil, !llvm.loop !50
...
if.end38.i:                                       ; preds = %if.end38.loopexit.i, %if.end13.i
  ...
  store i32 %pos.4.i, ptr %_aes, align 4, !tbaa !25
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %23 = zext i32 %offset.idx16 to i64
  %24 = getelementptr inbounds i8, ptr %add.ptr.i, i64 %23
  %wide.load = load <16 x i8>, ptr %24, align 1, !tbaa !15, !alias.scope !51
  %25 = getelementptr inbounds i8, ptr %24, i64 16
  %wide.load17 = load <16 x i8>, ptr %25, align 1, !tbaa !15, !alias.scope !51
  %wide.load18 = load <16 x i8>, ptr %next.gep, align 1, !tbaa !15, !alias.scope !54, !noalias !51
  %26 = getelementptr i8, ptr %next.gep, i64 16
  %wide.load19 = load <16 x i8>, ptr %26, align 1, !tbaa !15, !alias.scope !54, !noalias !51
  %27 = xor <16 x i8> %wide.load18, %wide.load
  %28 = xor <16 x i8> %wide.load19, %wide.load17
  store <16 x i8> %27, ptr %next.gep, align 1, !tbaa !15, !alias.scope !54, !noalias !51
  store <16 x i8> %28, ptr %26, align 1, !tbaa !15, !alias.scope !54, !noalias !51
  %index.next = add nuw i64 %index, 32
  %29 = icmp eq i64 %index.next, %n.vec
  br i1 %29, label %middle.block, label %vector.body, !llvm.loop !56
...
do.body.i:                                        ; preds = %do.body.i.preheader20, %do.body.i
  ...
  %cmp7.i = icmp ne i32 %inc.i, 16
  %32 = and i1 %cmp7.i, %cmp6.i
  br i1 %32, label %do.body.i, label %if.end8.i, !llvm.loop !57
...
do.body22.i.epil:                                 ; preds = %if.end38.loopexit.i.unr-lcssa, %do.body22.i.epil
  ...
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %if.end38.loopexit.i, label %do.body22.i.epil, !llvm.loop !58
...
for.cond.i15:                                     ; preds = %if.end
  ...
  %33 = load i8, ptr %arrayidx.1.i16, align 1, !tbaa !15
...
for.cond.1.i18:                                   ; preds = %for.cond.i15
  ...
  %35 = load i8, ptr %arrayidx.2.i19, align 2, !tbaa !15
...
for.cond.2.i21:                                   ; preds = %for.cond.1.i18
  ...
  %37 = load i8, ptr %arrayidx.3.i22, align 1, !tbaa !15
...
for.cond.3.i24:                                   ; preds = %for.cond.2.i21
  ...
  %39 = load i8, ptr %arrayidx.4.i25, align 4, !tbaa !15
...
for.cond.4.i27:                                   ; preds = %for.cond.3.i24
  ...
  %41 = load i8, ptr %arrayidx.5.i28, align 1, !tbaa !15
...
for.cond.5.i30:                                   ; preds = %for.cond.4.i27
  ...
  %43 = load i8, ptr %arrayidx.6.i31, align 2, !tbaa !15
...
for.cond.6.i33:                                   ; preds = %for.cond.5.i30
  ...
  %45 = load i8, ptr %arrayidx.7.i34, align 1, !tbaa !15
...
for.cond.7.i36:                                   ; preds = %for.cond.6.i33
  ...
  %47 = load i8, ptr %arrayidx.8.i37, align 4, !tbaa !15
...
for.cond.8.i39:                                   ; preds = %for.cond.7.i36
  ...
  %49 = load i8, ptr %arrayidx.9.i40, align 1, !tbaa !15
...
for.cond.9.i42:                                   ; preds = %for.cond.8.i39
  ...
  %51 = load i8, ptr %arrayidx.10.i43, align 2, !tbaa !15
...
for.cond.10.i45:                                  ; preds = %for.cond.9.i42
  ...
  %53 = load i8, ptr %arrayidx.11.i46, align 1, !tbaa !15
...
for.cond.11.i48:                                  ; preds = %for.cond.10.i45
  ...
  %55 = load i8, ptr %arrayidx.12.i49, align 4, !tbaa !15
...
for.cond.12.i51:                                  ; preds = %for.cond.11.i48
  ...
  %57 = load i8, ptr %arrayidx.13.i52, align 1, !tbaa !15
...
for.cond.13.i54:                                  ; preds = %for.cond.12.i51
  ...
  %59 = load i8, ptr %arrayidx.14.i55, align 2, !tbaa !15
...
_ZeqRK4GUIDS1_.exit61:                            ; preds = %for.cond.13.i54
  ...
  %61 = load i8, ptr %arrayidx.15.i58, align 1, !tbaa !15
...
return.sink.split:                                ; preds = %_ZeqRK4GUIDS1_.exit61, %_ZeqRK4GUIDS1_.exit
  ...
  %vtable7 = load ptr, ptr %this, align 8, !tbaa !27
...
entry:
  ...
  %0 = load i32, ptr %add.ptr, align 8, !tbaa !59
  %inc = add i32 %0, 1
  store i32 %inc, ptr %add.ptr, align 8, !tbaa !59
  ret i32 %inc
}
...
entry:
  ...
  %0 = load i32, ptr %add.ptr, align 8, !tbaa !59
  %dec = add i32 %0, -1
  store i32 %dec, ptr %add.ptr, align 8, !tbaa !59
...
entry:
  store ptr getelementptr inbounds ({ [10 x ptr], [8 x ptr] }, ptr @_ZTVN7NCrypto6NWzAes10CBaseCoderE, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !27
  %add.ptr.i = getelementptr inbounds i8, ptr %this, i64 8
  store ptr getelementptr inbounds ({ [10 x ptr], [8 x ptr] }, ptr @_ZTVN7NCrypto6NWzAes10CBaseCoderE, i64 0, inrange i32 1, i64 2), ptr %add.ptr.i, align 8, !tbaa !27
  %Password.i.i = getelementptr inbounds %"class.NCrypto::NWzAes::CBaseCoder", ptr %this, i64 0, i32 3, i32 3
  store ptr getelementptr inbounds ({ [4 x ptr] }, ptr @_ZTV7CBufferIhE, i64 0, inrange i32 0, i64 2), ptr %Password.i.i, align 8, !tbaa !27
...
entry:
  %add.ptr.i = getelementptr inbounds i8, ptr %this, i64 8
  %0 = load i32, ptr %add.ptr.i, align 8, !tbaa !59
  %inc.i = add i32 %0, 1
  store i32 %inc.i, ptr %add.ptr.i, align 8, !tbaa !59
  ret i32 %inc.i
}
...
entry:
  %0 = getelementptr inbounds i8, ptr %this, i64 -8
  store ptr getelementptr inbounds ({ [10 x ptr], [8 x ptr] }, ptr @_ZTVN7NCrypto6NWzAes10CBaseCoderE, i64 0, inrange i32 0, i64 2), ptr %0, align 8, !tbaa !27
  store ptr getelementptr inbounds ({ [10 x ptr], [8 x ptr] }, ptr @_ZTVN7NCrypto6NWzAes10CBaseCoderE, i64 0, inrange i32 1, i64 2), ptr %this, align 8, !tbaa !27
...
entry:
  ...
  store ptr getelementptr inbounds ({ [4 x ptr] }, ptr @_ZTV7CBufferIhE, i64 0, inrange i32 0, i64 2), ptr %Password.i.i.i, align 8, !tbaa !27
...
entry:
  ...
  store ptr getelementptr inbounds ({ [10 x ptr], [8 x ptr] }, ptr @_ZTVN7NCrypto6NWzAes10CBaseCoderE, i64 0, inrange i32 1, i64 2), ptr %add.ptr, align 8, !tbaa !27
  %Password.i = getelementptr inbounds %"class.NCrypto::NWzAes::CBaseCoder", ptr %this, i64 0, i32 3, i32 3
  store ptr getelementptr inbounds ({ [4 x ptr] }, ptr @_ZTV7CBufferIhE, i64 0, inrange i32 0, i64 2), ptr %Password.i, align 8, !tbaa !27
...
for.cond.i25:                                     ; preds = %if.end
  ...
  %33 = load i8, ptr %arrayidx.1.i26, align 1, !tbaa !15
  %34 = load i8, ptr getelementptr inbounds (i8, ptr @IID_ICryptoSetPassword, i64 1), align 1, !tbaa !15
...
for.cond.1.i28:                                   ; preds = %for.cond.i25
  ...
  %35 = load i8, ptr %arrayidx.2.i29, align 2, !tbaa !15
  %36 = load i8, ptr getelementptr inbounds (i8, ptr @IID_ICryptoSetPassword, i64 2), align 2, !tbaa !15
...
for.cond.2.i31:                                   ; preds = %for.cond.1.i28
  ...
  %37 = load i8, ptr %arrayidx.3.i32, align 1, !tbaa !15
  %38 = load i8, ptr getelementptr inbounds (i8, ptr @IID_ICryptoSetPassword, i64 3), align 1, !tbaa !15
...
for.cond.3.i34:                                   ; preds = %for.cond.2.i31
  ...
  %39 = load i8, ptr %arrayidx.4.i35, align 4, !tbaa !15
  %40 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_ICryptoSetPassword, i64 0, i32 1), align 4, !tbaa !15
...
for.cond.4.i37:                                   ; preds = %for.cond.3.i34
  ...
  %41 = load i8, ptr %arrayidx.5.i38, align 1, !tbaa !15
  %42 = load i8, ptr getelementptr inbounds (i8, ptr @IID_ICryptoSetPassword, i64 5), align 1, !tbaa !15
...
for.cond.5.i40:                                   ; preds = %for.cond.4.i37
  ...
  %43 = load i8, ptr %arrayidx.6.i41, align 2, !tbaa !15
  %44 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_ICryptoSetPassword, i64 0, i32 2), align 2, !tbaa !15
...
for.cond.6.i43:                                   ; preds = %for.cond.5.i40
  ...
  %45 = load i8, ptr %arrayidx.7.i44, align 1, !tbaa !15
  %46 = load i8, ptr getelementptr inbounds (i8, ptr @IID_ICryptoSetPassword, i64 7), align 1, !tbaa !15
...
for.cond.7.i46:                                   ; preds = %for.cond.6.i43
  ...
  %47 = load i8, ptr %arrayidx.8.i47, align 4, !tbaa !15
  %48 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_ICryptoSetPassword, i64 0, i32 3, i64 0), align 4, !tbaa !15
...
for.cond.8.i49:                                   ; preds = %for.cond.7.i46
  ...
  %49 = load i8, ptr %arrayidx.9.i50, align 1, !tbaa !15
  %50 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_ICryptoSetPassword, i64 0, i32 3, i64 1), align 1, !tbaa !15
...
for.cond.9.i52:                                   ; preds = %for.cond.8.i49
  ...
  %51 = load i8, ptr %arrayidx.10.i53, align 2, !tbaa !15
  %52 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_ICryptoSetPassword, i64 0, i32 3, i64 2), align 2, !tbaa !15
...
for.cond.10.i55:                                  ; preds = %for.cond.9.i52
  ...
  %53 = load i8, ptr %arrayidx.11.i56, align 1, !tbaa !15
  %54 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_ICryptoSetPassword, i64 0, i32 3, i64 3), align 1, !tbaa !15
...
for.cond.11.i58:                                  ; preds = %for.cond.10.i55
  ...
  %55 = load i8, ptr %arrayidx.12.i59, align 4, !tbaa !15
  %56 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_ICryptoSetPassword, i64 0, i32 3, i64 4), align 4, !tbaa !15
...
for.cond.12.i61:                                  ; preds = %for.cond.11.i58
  ...
  %57 = load i8, ptr %arrayidx.13.i62, align 1, !tbaa !15
  %58 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_ICryptoSetPassword, i64 0, i32 3, i64 5), align 1, !tbaa !15
...
for.cond.13.i64:                                  ; preds = %for.cond.12.i61
  ...
  %59 = load i8, ptr %arrayidx.14.i65, align 2, !tbaa !15
  %60 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_ICryptoSetPassword, i64 0, i32 3, i64 6), align 2, !tbaa !15
...
_ZeqRK4GUIDS1_.exit71:                            ; preds = %for.cond.13.i64
  ...
  %61 = load i8, ptr %arrayidx.15.i68, align 1, !tbaa !15
  %62 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_ICryptoSetPassword, i64 0, i32 3, i64 7), align 1, !tbaa !15
...
for.cond.i74:                                     ; preds = %if.end10
  ...
  %64 = load i8, ptr %arrayidx.1.i75, align 1, !tbaa !15
...
for.cond.1.i77:                                   ; preds = %for.cond.i74
  ...
  %66 = load i8, ptr %arrayidx.2.i78, align 2, !tbaa !15
...
for.cond.2.i80:                                   ; preds = %for.cond.1.i77
  ...
  %68 = load i8, ptr %arrayidx.3.i81, align 1, !tbaa !15
...
for.cond.3.i83:                                   ; preds = %for.cond.2.i80
  ...
  %70 = load i8, ptr %arrayidx.4.i84, align 4, !tbaa !15
...
for.cond.4.i86:                                   ; preds = %for.cond.3.i83
  ...
  %72 = load i8, ptr %arrayidx.5.i87, align 1, !tbaa !15
...
for.cond.5.i89:                                   ; preds = %for.cond.4.i86
  ...
  %74 = load i8, ptr %arrayidx.6.i90, align 2, !tbaa !15
...
for.cond.6.i92:                                   ; preds = %for.cond.5.i89
  ...
  %76 = load i8, ptr %arrayidx.7.i93, align 1, !tbaa !15
...
for.cond.7.i95:                                   ; preds = %for.cond.6.i92
  ...
  %78 = load i8, ptr %arrayidx.8.i96, align 4, !tbaa !15
...
for.cond.8.i98:                                   ; preds = %for.cond.7.i95
  ...
  %80 = load i8, ptr %arrayidx.9.i99, align 1, !tbaa !15
...
for.cond.9.i101:                                  ; preds = %for.cond.8.i98
  ...
  %82 = load i8, ptr %arrayidx.10.i102, align 2, !tbaa !15
...
for.cond.10.i104:                                 ; preds = %for.cond.9.i101
  ...
  %84 = load i8, ptr %arrayidx.11.i105, align 1, !tbaa !15
...
for.cond.11.i107:                                 ; preds = %for.cond.10.i104
  ...
  %86 = load i8, ptr %arrayidx.12.i108, align 4, !tbaa !15
...
for.cond.12.i110:                                 ; preds = %for.cond.11.i107
  ...
  %88 = load i8, ptr %arrayidx.13.i111, align 1, !tbaa !15
...
for.cond.13.i113:                                 ; preds = %for.cond.12.i110
  ...
  %90 = load i8, ptr %arrayidx.14.i114, align 2, !tbaa !15
...
_ZeqRK4GUIDS1_.exit120:                           ; preds = %for.cond.13.i113
  ...
  %92 = load i8, ptr %arrayidx.15.i117, align 1, !tbaa !15
...
return.sink.split:                                ; preds = %_ZeqRK4GUIDS1_.exit120, %_ZeqRK4GUIDS1_.exit71, %_ZeqRK4GUIDS1_.exit
  ...
  store ptr %add.ptr14, ptr %outObject, align 8, !tbaa !39
  %vtable15 = load ptr, ptr %this, align 8, !tbaa !27
...
entry:
  ...
  store ptr getelementptr inbounds ({ [10 x ptr], [8 x ptr] }, ptr @_ZTVN7NCrypto6NWzAes10CBaseCoderE, i64 0, inrange i32 1, i64 2), ptr %add.ptr.i.i, align 8, !tbaa !27
...
entry:
  ...
  store ptr getelementptr inbounds ({ [4 x ptr] }, ptr @_ZTV7CBufferIhE, i64 0, inrange i32 0, i64 2), ptr %Password.i.i.i.i, align 8, !tbaa !27
...
entry:
  ...
  store ptr getelementptr inbounds ({ [10 x ptr], [8 x ptr] }, ptr @_ZTVN7NCrypto6NWzAes10CBaseCoderE, i64 0, inrange i32 1, i64 2), ptr %add.ptr.i.i.i, align 8, !tbaa !27
...
entry:
  store ptr getelementptr inbounds ({ [4 x ptr] }, ptr @_ZTV7CBufferIhE, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !27
