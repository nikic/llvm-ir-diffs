...
if.end5:                                          ; preds = %cleanup.cont
  ...
  store i32 %shr17, ptr %Restor, align 4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %8, align 1
  %9 = getelementptr inbounds i8, ptr %8, i64 16
  %wide.load59 = load <16 x i8>, ptr %9, align 1
  %10 = getelementptr inbounds i8, ptr %call.i.i, i64 %index
  store <16 x i8> %wide.load, ptr %10, align 1
  %11 = getelementptr inbounds i8, ptr %10, i64 16
  store <16 x i8> %wide.load59, ptr %11, align 1
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load64 = load <8 x i8>, ptr %13, align 1
  %14 = getelementptr inbounds i8, ptr %call.i.i, i64 %index63
  store <8 x i8> %wide.load64, ptr %14, align 1
...
for.body.i.i.prol:                                ; preds = %for.body.i.i.preheader, %for.body.i.i.prol
  ...
  %18 = load i8, ptr %arrayidx.i.i.prol, align 1
  %arrayidx7.i.i.prol = getelementptr inbounds i8, ptr %call.i.i, i64 %indvars.iv.i.i.prol
  store i8 %18, ptr %arrayidx7.i.i.prol, align 1
...
if.end9.i.i:                                      ; preds = %delete.notnull.i.i, %for.cond.cleanup.i.i, %if.end.i.i
  ...
  %24 = load i32, ptr %_length12.i.i, align 8
...
_ZN11CStringBaseIcE9GetBufferEi.exit:             ; preds = %if.end29, %if.then.i, %if.end9.i.i
  ...
  store i32 %add34, ptr %headerSize, align 4
...
for.cond.i.i:                                     ; preds = %for.cond.i.i, %_ZN11CStringBaseIcE9GetBufferEi.exit
  ...
  %27 = load i8, ptr %arrayidx.i.i53, align 1
...
_ZN11CStringBaseIcE13ReleaseBufferEv.exit:        ; preds = %for.cond.i.i
  ...
  store i32 %28, ptr %_length.i.i55, align 8
  br label %cleanup40
...
sw.bb16:                                          ; preds = %entry
  ...
  %8 = load i32, ptr %_item17, align 8
...
if.end.i.i.i:                                     ; preds = %if.end9.i.i
  ...
  store i32 5, ptr %_capacity.i, align 4
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(5) %call.i.i76, ptr noundef nonnull align 1 dereferenceable(5) @.str, i64 5, i1 false)
...
invoke.cont31:                                    ; preds = %if.end.i.i.i
  ...
  %conv = add i8 %13, 65
  %14 = load <4 x i8>, ptr %call.i.i76, align 1
  store <4 x i8> %14, ptr %call.i.i.i79, align 1
  tail call void @_ZdaPv(ptr noundef nonnull %call.i.i76) #19
  store ptr %call.i.i.i79, ptr %s, align 8
  store i32 10, ptr %_capacity.i, align 4
  ...
  store i32 %inc.i, ptr %_length.i, align 8
  ...
  %16 = load i32, ptr %Order, align 8
  %17 = load i32, ptr %_capacity.i, align 4
...
for.cond.preheader.i.i.i181:                      ; preds = %call.i.i.i.noexc196
  ...
  %.pre.i.i.i183 = load ptr, ptr %s, align 8
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load321 = load <8 x i8>, ptr %26, align 1
  %27 = getelementptr inbounds i8, ptr %call.i.i.i197, i64 %index320
  store <8 x i8> %wide.load321, ptr %27, align 1
...
for.body.i.i.i190.prol:                           ; preds = %for.body.i.i.i190.preheader, %for.body.i.i.i190.prol
  ...
  %31 = load i8, ptr %arrayidx.i.i.i192.prol, align 1
  %arrayidx7.i.i.i193.prol = getelementptr inbounds i8, ptr %call.i.i.i197, i64 %indvars.iv.i.i.i191.prol
  store i8 %31, ptr %arrayidx7.i.i.i193.prol, align 1
  %indvars.iv.next.i.i.i194.prol = add nuw nsw i64 %indvars.iv.i.i.i191.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body.i.i.i190.prol.loopexit, label %for.body.i.i.i190.prol
...
if.end9.i.i.i178:                                 ; preds = %delete.notnull.i.i.i186, %for.cond.cleanup.i.i.i184, %call.i.i.i.noexc196
  store ptr %call.i.i.i197, ptr %s, align 8
  ...
  store i32 %add.i.i.i173, ptr %_capacity.i, align 4
...
_ZN11CStringBaseIcE10GrowLengthEi.exit.i:         ; preds = %if.end9.i.i.i178, %if.end.i.i162, %invoke.cont31
  ...
  store i8 111, ptr %incdec.ptr1.i.i161, align 1
  store i8 0, ptr %incdec.ptr1.i.i161.1, align 1
...
invoke.cont34:                                    ; preds = %.noexc
  ...
  %39 = load i32, ptr %MemInMB, align 4
  %40 = load i32, ptr %_capacity.i, align 4
...
for.cond.preheader.i.i.i237:                      ; preds = %call.i.i.i.noexc252
  ...
  %.pre.i.i.i239 = load ptr, ptr %s, align 8
...
vector.body337:                                   ; preds = %vector.body337, %vector.ph333
  ...
  %wide.load339 = load <16 x i8>, ptr %44, align 1
  %45 = getelementptr inbounds i8, ptr %44, i64 16
  %wide.load340 = load <16 x i8>, ptr %45, align 1
  %46 = getelementptr inbounds i8, ptr %call.i.i.i253, i64 %index338
  store <16 x i8> %wide.load339, ptr %46, align 1
  %47 = getelementptr inbounds i8, ptr %46, i64 16
  store <16 x i8> %wide.load340, ptr %47, align 1
  %index.next341 = add nuw i64 %index338, 32
  %48 = icmp eq i64 %index.next341, %n.vec335
  br i1 %48, label %middle.block327, label %vector.body337
...
vec.epilog.vector.body353:                        ; preds = %vec.epilog.vector.body353, %vec.epilog.ph345
  ...
  %wide.load355 = load <8 x i8>, ptr %49, align 1
  %50 = getelementptr inbounds i8, ptr %call.i.i.i253, i64 %index354
  store <8 x i8> %wide.load355, ptr %50, align 1
  %index.next356 = add nuw i64 %index354, 8
  %51 = icmp eq i64 %index.next356, %n.vec350
  br i1 %51, label %vec.epilog.middle.block342, label %vec.epilog.vector.body353
...
for.body.i.i.i246.prol:                           ; preds = %for.body.i.i.i246.preheader, %for.body.i.i.i246.prol
  ...
  br i1 %prol.iter430.cmp.not, label %for.body.i.i.i246.prol.loopexit, label %for.body.i.i.i246.prol
...
delete.notnull.i.i.i242:                          ; preds = %for.body.i.i.i246.prol.loopexit, %for.body.i.i.i246, %middle.block327, %vec.epilog.middle.block342, %for.cond.cleanup.i.i.i240
  ...
  %.pre.i.i243 = load i32, ptr %_length.i, align 8
...
if.end9.i.i.i234:                                 ; preds = %delete.notnull.i.i.i242, %for.cond.cleanup.i.i.i240, %call.i.i.i.noexc252
  ...
  store ptr %call.i.i.i253, ptr %s, align 8
  ...
  store i32 %add.i.i.i229, ptr %_capacity.i, align 4
...
_ZN11CStringBaseIcE10GrowLengthEi.exit.i208:      ; preds = %if.end9.i.i.i234, %if.end.i.i218, %invoke.cont34
  ...
  store <4 x i8> <i8 58, i8 109, i8 101, i8 109>, ptr %add.ptr.i210, align 1
  store i8 0, ptr %incdec.ptr1.i.i215.3, align 1
  %63 = load i32, ptr %_length.i, align 8
  %add.i217 = add nsw i32 %63, 4
  store i32 %add.i217, ptr %_length.i, align 8
...
invoke.cont36:                                    ; preds = %.noexc85
  ...
  %64 = load i32, ptr %_capacity.i, align 4
...
for.cond.preheader.i.i.i116:                      ; preds = %call.i.i.i.noexc131
  ...
  %.pre.i.i.i118 = load ptr, ptr %s, align 8
...
vector.body371:                                   ; preds = %vector.body371, %vector.ph367
  ...
  %wide.load373 = load <16 x i8>, ptr %68, align 1
  %69 = getelementptr inbounds i8, ptr %68, i64 16
  %wide.load374 = load <16 x i8>, ptr %69, align 1
  %70 = getelementptr inbounds i8, ptr %call.i.i.i132, i64 %index372
  store <16 x i8> %wide.load373, ptr %70, align 1
  %71 = getelementptr inbounds i8, ptr %70, i64 16
  store <16 x i8> %wide.load374, ptr %71, align 1
  %index.next375 = add nuw i64 %index372, 32
  %72 = icmp eq i64 %index.next375, %n.vec369
  br i1 %72, label %middle.block361, label %vector.body371
...
vec.epilog.vector.body387:                        ; preds = %vec.epilog.vector.body387, %vec.epilog.ph379
  ...
  %wide.load389 = load <8 x i8>, ptr %73, align 1
  %74 = getelementptr inbounds i8, ptr %call.i.i.i132, i64 %index388
  store <8 x i8> %wide.load389, ptr %74, align 1
  %index.next390 = add nuw i64 %index388, 8
  %75 = icmp eq i64 %index.next390, %n.vec384
  br i1 %75, label %vec.epilog.middle.block376, label %vec.epilog.vector.body387
...
for.body.i.i.i125.prol:                           ; preds = %for.body.i.i.i125.preheader, %for.body.i.i.i125.prol
  ...
  br i1 %prol.iter433.cmp.not, label %for.body.i.i.i125.prol.loopexit, label %for.body.i.i.i125.prol
...
for.body.i.i.i125:                                ; preds = %for.body.i.i.i125.prol.loopexit, %for.body.i.i.i125
  ...
  br i1 %exitcond.not.i.i.i130.3, label %delete.notnull.i.i.i121, label %for.body.i.i.i125
...
delete.notnull.i.i.i121:                          ; preds = %for.body.i.i.i125.prol.loopexit, %for.body.i.i.i125, %middle.block361, %vec.epilog.middle.block376, %for.cond.cleanup.i.i.i119
  ...
  %.pre.i.i122 = load i32, ptr %_length.i, align 8
...
if.end9.i.i.i113:                                 ; preds = %delete.notnull.i.i.i121, %for.cond.cleanup.i.i.i119, %call.i.i.i.noexc131
  ...
  store ptr %call.i.i.i132, ptr %s, align 8
  ...
  store i8 0, ptr %arrayidx14.i.i.i115, align 1
  store i32 %add.i.i.i108, ptr %_capacity.i, align 4
...
invoke.cont37:                                    ; preds = %if.end9.i.i.i113, %if.end.i.i97, %invoke.cont36
  ...
  store i8 109, ptr %arrayidx.i93, align 1
  %87 = load ptr, ptr %s, align 8
  %88 = load i32, ptr %_length.i, align 8
  %inc.i94 = add nsw i32 %88, 1
  store i32 %inc.i94, ptr %_length.i, align 8
  %idxprom4.i95 = sext i32 %inc.i94 to i64
  %arrayidx5.i96 = getelementptr inbounds i8, ptr %87, i64 %idxprom4.i95
  store i8 0, ptr %arrayidx5.i96, align 1
  %89 = load i32, ptr %Ver, align 8
...
land.lhs.true:                                    ; preds = %invoke.cont37
  ...
  %90 = load i32, ptr %Restor, align 4
...
for.cond.i.i255.preheader:                        ; preds = %land.lhs.true
  %91 = load i32, ptr %_capacity.i, align 4
...
for.cond.preheader.i.i.i294:                      ; preds = %call.i.i.i.noexc309
  ...
  %.pre.i.i.i296 = load ptr, ptr %s, align 8
...
vector.body405:                                   ; preds = %vector.body405, %vector.ph401
  ...
  %wide.load407 = load <16 x i8>, ptr %95, align 1
  %96 = getelementptr inbounds i8, ptr %95, i64 16
  %wide.load408 = load <16 x i8>, ptr %96, align 1
  %97 = getelementptr inbounds i8, ptr %call.i.i.i310, i64 %index406
  store <16 x i8> %wide.load407, ptr %97, align 1
  %98 = getelementptr inbounds i8, ptr %97, i64 16
  store <16 x i8> %wide.load408, ptr %98, align 1
  %index.next409 = add nuw i64 %index406, 32
  %99 = icmp eq i64 %index.next409, %n.vec403
  br i1 %99, label %middle.block395, label %vector.body405
...
vec.epilog.vector.body421:                        ; preds = %vec.epilog.vector.body421, %vec.epilog.ph413
  ...
  %wide.load423 = load <8 x i8>, ptr %100, align 1
  %101 = getelementptr inbounds i8, ptr %call.i.i.i310, i64 %index422
  store <8 x i8> %wide.load423, ptr %101, align 1
  %index.next424 = add nuw i64 %index422, 8
  %102 = icmp eq i64 %index.next424, %n.vec418
  br i1 %102, label %vec.epilog.middle.block410, label %vec.epilog.vector.body421
...
for.body.i.i.i303.prol:                           ; preds = %for.body.i.i.i303.preheader, %for.body.i.i.i303.prol
  ...
  br i1 %prol.iter436.cmp.not, label %for.body.i.i.i303.prol.loopexit, label %for.body.i.i.i303.prol
...
for.body.i.i.i303:                                ; preds = %for.body.i.i.i303.prol.loopexit, %for.body.i.i.i303
  ...
  br i1 %exitcond.not.i.i.i308.3, label %delete.notnull.i.i.i299, label %for.body.i.i.i303
...
delete.notnull.i.i.i299:                          ; preds = %for.body.i.i.i303.prol.loopexit, %for.body.i.i.i303, %middle.block395, %vec.epilog.middle.block410, %for.cond.cleanup.i.i.i297
  ...
  %.pre.i.i300 = load i32, ptr %_length.i, align 8
...
if.end9.i.i.i291:                                 ; preds = %delete.notnull.i.i.i299, %for.cond.cleanup.i.i.i297, %call.i.i.i.noexc309
  ...
  store ptr %call.i.i.i310, ptr %s, align 8
  ...
  store i8 0, ptr %arrayidx14.i.i.i293, align 1
  store i32 %add.i.i.i286, ptr %_capacity.i, align 4
...
_ZN11CStringBaseIcE10GrowLengthEi.exit.i265:      ; preds = %if.end9.i.i.i291, %if.end.i.i275, %for.cond.i.i255.preheader
  ...
  store i8 58, ptr %add.ptr.i267, align 1
  %incdec.ptr1.i.i272.1 = getelementptr inbounds i8, ptr %add.ptr.i267, i64 2
  store i8 114, ptr %incdec.ptr1.i.i272, align 1
  store i8 0, ptr %incdec.ptr1.i.i272.1, align 1
  %114 = load i32, ptr %_length.i, align 8
  %add.i274 = add nsw i32 %114, 2
  store i32 %add.i274, ptr %_length.i, align 8
...
catch58:                                          ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit147
  ...
  store ptr %125, ptr %exception, align 16
...
if.end.i:                                         ; preds = %if.then.i, %if.then
  %5 = load ptr, ptr %_stream, align 8
...
catch14:                                          ; preds = %lpad4
  ...
  store ptr %11, ptr %exception, align 16
  invoke void @__cxa_throw(ptr nonnull %exception, ptr nonnull @_ZTIPKc, ptr null) #21
...
entry:
  store ptr @_ZN8NArchive5NPpmdL18Range_GetThresholdEPvj, ptr %this, align 8
  %Decode = getelementptr inbounds %struct.IPpmd7_RangeDec, ptr %this, i64 0, i32 1
  store ptr @_ZN8NArchive5NPpmdL12Range_DecodeEPvjj, ptr %Decode, align 8
  %DecodeBit = getelementptr inbounds %struct.IPpmd7_RangeDec, ptr %this, i64 0, i32 2
  store ptr @_ZN8NArchive5NPpmdL15Range_DecodeBitEPvj, ptr %DecodeBit, align 8
  ret void
}
...
entry:
  ...
  store i32 %div, ptr %Range, align 8
  %div1 = udiv i32 %0, %div
  ret i32 %div1
}
...
entry:
  ...
  %1 = load i32, ptr %Low, align 8
  %add = add i32 %1, %mul
  store i32 %add, ptr %Low, align 8
  %Code = getelementptr inbounds %"struct.NArchive::NPpmd::CRangeDecoder", ptr %pp, i64 0, i32 2
  %2 = load i32, ptr %Code, align 4
  %sub = sub i32 %2, %mul
  store i32 %sub, ptr %Code, align 4
  %mul2 = mul i32 %0, %size
  store i32 %mul2, ptr %Range, align 8
...
land.rhs.i:                                       ; preds = %lor.rhs.i
  ...
  store i32 %and.i, ptr %Range, align 8
...
while.body.critedge.i:                            ; preds = %land.rhs.i, %while.cond.i
  ...
  %9 = load ptr, ptr %Lim.i.i, align 8
...
if.end.i.i:                                       ; preds = %while.body.critedge.i
  ...
  %.pre13.i = load i32, ptr %Range, align 8
  %.pre14.i = load i32, ptr %Low, align 8
  br label %_ZN14CByteInBufWrap8ReadByteEv.exit.i
...
_ZN14CByteInBufWrap8ReadByteEv.exit.i:            ; preds = %if.end.i.i, %if.then.i.i
  ...
  store i32 %or.i, ptr %Code, align 4
  %shl9.i = shl i32 %12, 8
  store i32 %shl9.i, ptr %Range, align 8
  %shl11.i = shl i32 %11, 8
  store i32 %shl11.i, ptr %Low, align 8
  br label %while.cond.i
...
if.then:                                          ; preds = %entry
  ...
  %2 = load i32, ptr %Low.i, align 8
  %mul2.i = mul i32 %shr, %size0
  store i32 %mul2.i, ptr %Range, align 8
...
land.rhs.i.i:                                     ; preds = %lor.rhs.i.i
  ...
  store i32 %and.i.i, ptr %Range, align 8
...
if.end.i.i.i:                                     ; preds = %while.body.critedge.i.i
  ...
  %.pre13.i.i = load i32, ptr %Range, align 8
  %.pre14.i.i = load i32, ptr %Low.i, align 8
  br label %_ZN14CByteInBufWrap8ReadByteEv.exit.i.i
...
_ZN14CByteInBufWrap8ReadByteEv.exit.i.i:          ; preds = %if.end.i.i.i, %if.then.i.i.i
  ...
  store i32 %or.i.i, ptr %Code, align 4
  %shl9.i.i = shl i32 %12, 8
  store i32 %shl9.i.i, ptr %Range, align 8
  %shl11.i.i = shl i32 %11, 8
  store i32 %shl11.i.i, ptr %Low.i, align 8
  br label %while.cond.i.i
...
if.else:                                          ; preds = %entry
  ...
  %13 = load i32, ptr %Low.i8, align 8
  %add.i = add i32 %13, %mul.i
  store i32 %add.i, ptr %Low.i8, align 8
  %sub.i = sub i32 %0, %mul.i
  store i32 %sub.i, ptr %Code, align 4
  %mul2.i10 = mul i32 %shr, %sub
  store i32 %mul2.i10, ptr %Range, align 8
...
land.rhs.i.i18:                                   ; preds = %lor.rhs.i.i16
  ...
  store i32 %and.i.i20, ptr %Range, align 8
...
if.then.i.i.i26:                                  ; preds = %while.body.critedge.i.i21
  ...
  store ptr %incdec.ptr.i.i.i27, ptr %Cur.i.i.i23, align 8
...
if.end.i.i.i34:                                   ; preds = %while.body.critedge.i.i21
  ...
  %.pre13.i.i36 = load i32, ptr %Range, align 8
  %.pre14.i.i37 = load i32, ptr %Low.i8, align 8
  br label %_ZN14CByteInBufWrap8ReadByteEv.exit.i.i28
...
_ZN14CByteInBufWrap8ReadByteEv.exit.i.i28:        ; preds = %if.end.i.i.i34, %if.then.i.i.i26
  ...
  store i32 %or.i.i31, ptr %Code, align 4
  %shl9.i.i32 = shl i32 %23, 8
  store i32 %shl9.i.i32, ptr %Range, align 8
  %shl11.i.i33 = shl i32 %22, 8
  store i32 %shl11.i.i33, ptr %Low.i8, align 8
  br label %while.cond.i.i12
...
cleanup.cont:                                     ; preds = %if.end6
  ...
  %vtable12 = load ptr, ptr %extractCallback, align 8
...
if.end28:                                         ; preds = %cleanup.cont21
  %vtable29 = load ptr, ptr %extractCallback, align 8
...
if.then.i:                                        ; preds = %invoke.cont36
  %_stream = getelementptr inbounds %"class.NArchive::NPpmd::CHandler", ptr %this, i64 0, i32 7
  %9 = load ptr, ptr %_stream, align 8
...
invoke.cont53:                                    ; preds = %invoke.cont50
  %vtable.i = load ptr, ptr %call51, align 8
  %vfn.i = getelementptr inbounds ptr, ptr %vtable.i, i64 1
...
invoke.cont59:                                    ; preds = %invoke.cont57
  %MemInMB = getelementptr inbounds %"class.NArchive::NPpmd::CHandler", ptr %this, i64 0, i32 3, i32 4
  %13 = load i32, ptr %MemInMB, align 4
...
if.end65.if.then70_crit_edge:                     ; preds = %if.end65
  ...
  %.pre = load i32, ptr %Restor.phi.trans.insert, align 4
  br label %if.then70
...
_ZNK8NArchive5NPpmd5CItem11IsSupportedEv.exit:    ; preds = %if.end65
  ...
  %21 = load i32, ptr %Restor.i, align 4
...
invoke.cont73:                                    ; preds = %if.then70
  ...
  store i8 0, ptr %Extra.i, align 8
...
land.lhs.true78:                                  ; preds = %invoke.cont76
  %25 = load i8, ptr %Extra.i, align 8
...
for.cond:                                         ; preds = %for.cond.preheader, %if.end150
  ...
  %27 = load i64, ptr %Processed.i, align 8
  %28 = load ptr, ptr %Cur.i, align 8
  ...
  store i64 %add.i, ptr %_packSize, align 8
  store i64 %add.i, ptr %InSize, align 8
  store i64 %outSize.0, ptr %OutSize, align 8
...
invoke.cont101:                                   ; preds = %for.body
  %34 = load i8, ptr %Extra.i, align 8
...
if.end108:                                        ; preds = %invoke.cont101
  ...
  store i8 %conv, ptr %arrayidx109, align 1
  %inc = add nuw nsw i64 %i.0353, 1
  %exitcond357.not = icmp eq i64 %inc, 1048576
  br i1 %exitcond357.not, label %if.end127, label %for.body
...
invoke.cont113:                                   ; preds = %for.body112
  %35 = load i8, ptr %Extra.i, align 8
...
if.end120:                                        ; preds = %invoke.cont113
  ...
  br i1 %exitcond.not, label %if.end127, label %for.body112
...
if.end127:                                        ; preds = %if.end120, %invoke.cont113, %if.end108, %invoke.cont101
  ...
  %36 = load i32, ptr %_headerSize, align 8
  %conv128 = zext i32 %36 to i64
  %37 = load i64, ptr %Processed.i, align 8
  ...
  store i64 %add131, ptr %_packSize, align 8
  store i8 1, ptr %_packSizeDefined, align 8
  %40 = load ptr, ptr %realOutStream, align 8
...
if.end166thread-pre-split:                        ; preds = %invoke.cont76, %land.lhs.true154, %if.then152
  ...
  %.pr345 = load i32, ptr %Res.i, align 4
  br label %if.end166
...
if.end179:                                        ; preds = %if.end65, %if.end166, %_ZNK8NArchive5NPpmd5CItem11IsSupportedEv.exit
  ...
  %44 = load ptr, ptr %realOutStream, align 8
...
if.then.i289:                                     ; preds = %if.end179
  %vtable.i290 = load ptr, ptr %44, align 8
...
invoke.cont180:                                   ; preds = %call.i.noexc292, %if.end179
  %vtable181 = load ptr, ptr %extractCallback, align 8
...
if.then.i295:                                     ; preds = %invoke.cont142, %invoke.cont87, %if.end166, %invoke.cont62, %invoke.cont180
  ...
  %vtable.i296 = load ptr, ptr %call51, align 8
...
if.then.i299:                                     ; preds = %lpad56, %ehcleanup190
  ...
  %vtable.i300 = load ptr, ptr %call51, align 8
...
if.then.i312:                                     ; preds = %cleanup205
  %vtable.i313 = load ptr, ptr %.pr, align 8
...
ehcleanup206:                                     ; preds = %ehcleanup204, %lpad24, %lpad
  ...
  %64 = load ptr, ptr %realOutStream, align 8
...
if.then.i318:                                     ; preds = %ehcleanup206
  %vtable.i319 = load ptr, ptr %64, align 8
...
entry:
  ...
  store ptr @_ZN8NArchive5NPpmdL18Range_GetThresholdEPvj, ptr %_rc, align 8
  %Decode.i = getelementptr inbounds %"struct.NArchive::NPpmd::CPpmdCpp", ptr %this, i64 0, i32 1, i32 0, i32 1
  store ptr @_ZN8NArchive5NPpmdL12Range_DecodeEPvjj, ptr %Decode.i, align 8
  %DecodeBit.i = getelementptr inbounds %"struct.NArchive::NPpmd::CPpmdCpp", ptr %this, i64 0, i32 1, i32 0, i32 2
  store ptr @_ZN8NArchive5NPpmdL15Range_DecodeBitEPvj, ptr %DecodeBit.i, align 8
  store i32 %version, ptr %this, align 8
...
if.else:                                          ; preds = %entry
  ...
  store ptr %inStream, ptr %Stream3, align 8
...
entry:
  store ptr getelementptr inbounds ({ [18 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive5NPpmd8CHandlerE, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %add.ptr = getelementptr inbounds i8, ptr %this, i64 8
  store ptr getelementptr inbounds ({ [18 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive5NPpmd8CHandlerE, i64 0, inrange i32 1, i64 2), ptr %add.ptr, align 8
  %_stream = getelementptr inbounds %"class.NArchive::NPpmd::CHandler", ptr %this, i64 0, i32 7
  %0 = load ptr, ptr %_stream, align 8
  %tobool.not.i = icmp eq ptr %0, null
...
entry:
  ...
  store ptr getelementptr inbounds ({ [18 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive5NPpmd8CHandlerE, i64 0, inrange i32 1, i64 2), ptr %add.ptr.i, align 8
...
entry:
  %0 = getelementptr inbounds i8, ptr %this, i64 -8
  store ptr getelementptr inbounds ({ [18 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive5NPpmd8CHandlerE, i64 0, inrange i32 0, i64 2), ptr %0, align 8
  store ptr getelementptr inbounds ({ [18 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive5NPpmd8CHandlerE, i64 0, inrange i32 1, i64 2), ptr %this, align 8
...
_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.i.i: ; preds = %if.then.i.i.i, %entry
  ...
  %5 = load ptr, ptr %Name.i.i.i, align 8
...
if.end.i:                                         ; preds = %entry
  ...
  %.pre8 = load ptr, ptr %Cur.i.1.phi.trans.insert, align 8
  %Lim.i.1.phi.trans.insert = getelementptr inbounds %struct.CByteInBufWrap, ptr %.pre, i64 0, i32 2
  %.pre9 = load ptr, ptr %Lim.i.1.phi.trans.insert, align 8
  br label %_ZN14CByteInBufWrap8ReadByteEv.exit
...
if.then.i.1:                                      ; preds = %_ZN14CByteInBufWrap8ReadByteEv.exit
  ...
  store ptr %incdec.ptr.i.1, ptr %Cur.i.1, align 8
...
if.then.i.2:                                      ; preds = %_ZN14CByteInBufWrap8ReadByteEv.exit.1
  ...
  store ptr %incdec.ptr.i.2, ptr %Cur.i.2, align 8
...
if.then.i.3:                                      ; preds = %_ZN14CByteInBufWrap8ReadByteEv.exit.2
  ...
  store ptr %incdec.ptr.i.3, ptr %Cur.i.3, align 8
...
entry:
  ...
  store ptr getelementptr inbounds ({ [18 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive5NPpmd8CHandlerE, i64 0, inrange i32 0, i64 2), ptr %call, align 8
  store ptr getelementptr inbounds ({ [18 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive5NPpmd8CHandlerE, i64 0, inrange i32 1, i64 2), ptr %0, align 8
...
invoke.cont:                                      ; preds = %entry
  ...
  store ptr %call.i.i.i7.i2, ptr %Name.i.i, align 8
  store i8 0, ptr %call.i.i.i7.i2, align 1
