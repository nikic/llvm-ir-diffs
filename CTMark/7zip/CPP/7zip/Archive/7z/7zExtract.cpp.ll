...
invoke.cont103:                                   ; preds = %invoke.cont100
  %vtable.i523 = load ptr, ptr %call101, align 8, !tbaa !5
...
for.cond111:                                      ; preds = %for.cond111.preheader, %for.inc312
  %indvars.iv673 = phi i64 [ 0, %for.cond111.preheader ], [ %indvars.iv.next674, %for.inc312 ]
...
invoke.cont114:                                   ; preds = %for.cond111
  ...
  br i1 %cmp116.not, label %cleanup.cont121, label %if.then.i586.loopexit
...
cleanup.cont121:                                  ; preds = %invoke.cont114
  %45 = load i32, ptr %_size.i485, align 4, !tbaa !22
  %46 = sext i32 %45 to i64
  %cmp126.not = icmp slt i64 %indvars.iv673, %46
  br i1 %cmp126.not, label %invoke.cont131, label %if.then.i586

invoke.cont131:                                   ; preds = %cleanup.cont121
  %47 = load ptr, ptr %_items.i.i.i, align 8, !tbaa !15
  %arrayidx.i.i530 = getelementptr inbounds ptr, ptr %47, i64 %indvars.iv673
...
invoke.cont138:                                   ; preds = %invoke.cont135
  %vtable.i532 = load ptr, ptr %call136, align 8, !tbaa !5
...
if.else:                                          ; preds = %invoke.cont141
  ...
  %56 = load ptr, ptr %_items.i513, align 8, !tbaa !15
...
invoke.cont178:                                   ; preds = %cleanup.cont168
  ...
  %62 = load ptr, ptr %_items.i.i493, align 8, !tbaa !15
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi705 = phi <2 x i64> [ zeroinitializer, %vector.ph ], [ %80, %vector.body ]
  ...
  %wide.load706 = load <2 x i64>, ptr %78, align 8, !tbaa !31
  %79 = add <2 x i64> %wide.load, %vec.phi
  %80 = add <2 x i64> %wide.load706, %vec.phi705
...
if.then.i562:                                     ; preds = %cleanup284
  %vtable.i563 = load ptr, ptr %117, align 8, !tbaa !5
...
if.then.i566:                                     ; preds = %_ZN9CMyComPtrI22ICryptoGetTextPasswordED2Ev.exit, %invoke.cont160, %cleanup.cont168
  ...
  %vtable.i567 = load ptr, ptr %call136, align 8, !tbaa !5
...
if.then.i572:                                     ; preds = %ehcleanup285
  %vtable.i573 = load ptr, ptr %124, align 8, !tbaa !5
...
if.then.i579:                                     ; preds = %lpad155, %_ZN9CMyComPtrI22ICryptoGetTextPasswordED2Ev.exit577
  ...
  %vtable.i580 = load ptr, ptr %call136, align 8, !tbaa !5
...
if.then.i586.loopexit:                            ; preds = %invoke.cont114, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit
  %.ph = phi i32 [ %retval.10, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit ], [ %call115, %invoke.cont114 ]
  br label %if.then.i586

if.then.i586:                                     ; preds = %cleanup.cont121, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit, %if.then.i586.loopexit
  %131 = phi i32 [ %.ph, %if.then.i586.loopexit ], [ 0, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit ], [ 0, %cleanup.cont121 ]
  %vtable.i587 = load ptr, ptr %call101, align 8, !tbaa !5
...
if.then.i592:                                     ; preds = %lpad107, %lpad137, %lpad134, %lpad113, %if.then.i579, %lpad140
  ...
  %vtable.i593 = load ptr, ptr %call101, align 8, !tbaa !5
...
if.then.i601:                                     ; preds = %ehcleanup339.thread, %ehcleanup339
  %.pn469.pn.pn677 = phi { ptr, i32 } [ %37, %ehcleanup339.thread ], [ %.pn469.pn.pn, %ehcleanup339 ]
  %vtable.i602 = load ptr, ptr %extractCallbackSpec, align 8, !tbaa !5
...
if.then.i607:                                     ; preds = %cleanup342
  %vtable.i608 = load ptr, ptr %extractCallbackSpec, align 8, !tbaa !5
...
ehcleanup349:                                     ; preds = %if.then.i601, %ehcleanup339, %lpad
  %.pn469.pn.pn.pn.pn = phi { ptr, i32 } [ %2, %lpad ], [ %.pn469.pn.pn, %ehcleanup339 ], [ %.pn469.pn.pn677, %if.then.i601 ]
