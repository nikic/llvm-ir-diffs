; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Archive/7z/7zExtract.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Archive/7z/7zExtract.cpp"
...
%"struct.NArchive::N7z::CExtractFolderInfo" = type { i32, i32, %class.CRecordVector.2, i64 }
...
%"struct.NArchive::N7z::CBindInfoEx" = type { %"struct.NCoderMixer::CBindInfo", %class.CRecordVector.1 }
%"struct.NCoderMixer::CBindInfo" = type { %class.CRecordVector.10, %class.CRecordVector.11, %class.CRecordVector.3, %class.CRecordVector.3 }
...
%"class.NArchive::N7z::CHandler" = type { %struct.IInArchive, %"class.NArchive::COutHandler.base", %struct.ISetProperties, %struct.IOutArchive, %class.CMyUnknownImp, %class.CMyComPtr.0, %"struct.NArchive::N7z::CArchiveDatabaseEx", i8, %class.CRecordVector.6, %class.CRecordVector.1 }
...
%"struct.NArchive::N7z::CArchiveDatabaseEx" = type { %"struct.NArchive::N7z::CArchiveDatabase", %"struct.NArchive::N7z::CInArchiveInfo", %class.CRecordVector.1, %class.CRecordVector.3, %class.CRecordVector.3, %class.CRecordVector.3, i64, i64 }
%"struct.NArchive::N7z::CArchiveDatabase" = type { %class.CRecordVector.1, %class.CRecordVector.2, %class.CRecordVector.3, %class.CObjectVector.4, %class.CRecordVector.3, %class.CObjectVector.5, %"struct.NArchive::N7z::CUInt64DefVector", %"struct.NArchive::N7z::CUInt64DefVector", %"struct.NArchive::N7z::CUInt64DefVector", %"struct.NArchive::N7z::CUInt64DefVector", %class.CRecordVector.2 }
%class.CObjectVector.4 = type { %class.CRecordVector }
%class.CObjectVector.5 = type { %class.CRecordVector }
%"struct.NArchive::N7z::CUInt64DefVector" = type { %class.CRecordVector.1, %class.CRecordVector.2 }
%"struct.NArchive::N7z::CInArchiveInfo" = type { %"struct.NArchive::N7z::CArchiveVersion", i64, i64, i64, i64, %class.CRecordVector.1 }
%"struct.NArchive::N7z::CArchiveVersion" = type { i8, i8 }
%class.CRecordVector.6 = type { %class.CBaseRecordVector }
%"struct.NArchive::N7z::CFolder" = type <{ %class.CObjectVector.8, %class.CRecordVector.9, %class.CRecordVector.3, %class.CRecordVector.1, i32, i8, [3 x i8] }>
...
%class.CLocalProgress = type <{ %struct.ICompressProgressInfo, %class.CMyUnknownImp, [4 x i8], %class.CMyComPtr.14, %class.CMyComPtr.15, i8, [7 x i8], i64, i64, i64, i8, i8, [6 x i8] }>
%struct.ICompressProgressInfo = type { %struct.IUnknown }
%class.CMyComPtr.14 = type { ptr }
%class.CMyComPtr.15 = type { ptr }
%"class.NArchive::N7z::CFolderOutStream" = type { %struct.ISequentialOutStream, %struct.ICompressGetSubStreamSize, %class.CMyUnknownImp, ptr, %class.CMyComPtr.16, ptr, ptr, %class.CMyComPtr, i32, i32, i32, i8, i8, i8, i64 }
...
entry:
  ...
  %getTextPassword = alloca %class.CMyComPtr.17, align 8
...
if.then.i:                                        ; preds = %entry
  %vtable.i = load ptr, ptr %extractCallbackSpec, align 8
...
invoke.cont:                                      ; preds = %entry, %if.then.i
  ...
  br i1 %cmp6, label %cleanup342, label %if.end8
...
if.end8:                                          ; preds = %invoke.cont
  ...
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN8NArchive3N7z18CExtractFolderInfoEE, i64 0, inrange i32 0, i64 2), ptr %extractFolderInfoVector, align 8
...
for.cond.cleanup:                                 ; preds = %cleanup
  %vtable = load ptr, ptr %extractCallbackSpec, align 8
...
for.body:                                         ; preds = %if.end8, %cleanup
  %indvars.iv = phi i64 [ 0, %if.end8 ], [ %indvars.iv.next, %cleanup ]
  %importantTotalUnpacked.0657 = phi i64 [ 0, %if.end8 ], [ %importantTotalUnpacked.2, %cleanup ]
...
if.then18:                                        ; preds = %cond.end
  ...
  store i32 -1, ptr %FolderIndex.i, align 4
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %_capacity.i.i.i479, i8 0, i64 16, i1 false)
  store i64 1, ptr %_itemSize.i.i.i480, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CRecordVectorIbE, i64 0, inrange i32 0, i64 2), ptr %ExtractStatuses.i, align 8
  store i64 0, ptr %UnpackSize.i, align 8
...
if.end24:                                         ; preds = %cond.end
  %12 = load i32, ptr %_size.i485, align 4
...
invoke.cont27:                                    ; preds = %if.end24
  ...
  %15 = load i32, ptr %FolderIndex, align 4
...
invoke.cont33:                                    ; preds = %if.end24, %invoke.cont27
  ...
  store i32 %7, ptr %FolderIndex.i487, align 4
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %_capacity.i.i.i489, i8 0, i64 16, i1 false)
  store i64 1, ptr %_itemSize.i.i.i490, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CRecordVectorIbE, i64 0, inrange i32 0, i64 2), ptr %ExtractStatuses.i488, align 8
  store i64 0, ptr %UnpackSize.i491, align 8
...
for.body.i.us.i:                                  ; preds = %for.cond.us.i, %for.inc.i.us.i
  ...
  %21 = load i32, ptr %OutIndex.i.us.i, align 4
...
invoke.cont51:                                    ; preds = %invoke.cont27.invoke.cont51_crit_edge, %invoke.cont45
  ...
  %importantTotalUnpacked.1 = phi i64 [ %importantTotalUnpacked.0657, %invoke.cont27.invoke.cont51_crit_edge ], [ %add, %invoke.cont45 ]
  %31 = load ptr, ptr %_items.i513, align 8
  %arrayidx.i515 = getelementptr inbounds i32, ptr %31, i64 %idxprom.i514.pre-phi
  %32 = load i32, ptr %arrayidx.i515, align 4
  ...
  %33 = load i32, ptr %_size.i516, align 4
  %sub = sub i32 %cond, %32
...
for.inc:                                          ; preds = %for.body62
  ...
  %35 = load ptr, ptr %_items.i517, align 8
  %36 = load i32, ptr %_size.i516, align 4
  %idxprom.i519 = sext i32 %36 to i64
  %arrayidx.i520 = getelementptr inbounds i8, ptr %35, i64 %idxprom.i519
  store i8 %frombool.i, ptr %arrayidx.i520, align 1
  %inc.i = add nsw i32 %36, 1
  store i32 %inc.i, ptr %_size.i516, align 4
  %inc = add i32 %index.0655, 1
  %cmp60.not = icmp ugt i32 %inc, %sub
  br i1 %cmp60.not, label %cleanup, label %for.body62

cleanup:                                          ; preds = %for.inc, %invoke.cont51, %invoke.cont22
  %importantTotalUnpacked.2 = phi i64 [ %importantTotalUnpacked.0657, %invoke.cont22 ], [ %importantTotalUnpacked.1, %invoke.cont51 ], [ %importantTotalUnpacked.1, %for.inc ]
...
invoke.cont103:                                   ; preds = %invoke.cont100
  %vtable.i523 = load ptr, ptr %call101, align 8
  %vfn.i524 = getelementptr inbounds ptr, ptr %vtable.i523, i64 1
  %38 = load ptr, ptr %vfn.i524, align 8
...
for.cond111:                                      ; preds = %for.cond111.preheader, %for.inc312
  %indvars.iv675 = phi i64 [ 0, %for.cond111.preheader ], [ %indvars.iv.next676, %for.inc312 ]
  ...
  store i64 %totalUnpacked.0, ptr %OutSize, align 8
  store i64 %totalPacked.0, ptr %InSize, align 8
...
invoke.cont114:                                   ; preds = %for.cond111
  ...
  br i1 %cmp116.not, label %cleanup.cont121, label %if.then.i586
...
cleanup.cont121:                                  ; preds = %invoke.cont114
  %45 = load i32, ptr %_size.i485, align 4
  %46 = sext i32 %45 to i64
  %cmp126.not = icmp slt i64 %indvars.iv675, %46
  br i1 %cmp126.not, label %invoke.cont131, label %if.then.i586

invoke.cont131:                                   ; preds = %cleanup.cont121
  %47 = load ptr, ptr %_items.i.i.i, align 8
  %arrayidx.i.i530 = getelementptr inbounds ptr, ptr %47, i64 %indvars.iv675
  %48 = load ptr, ptr %arrayidx.i.i530, align 8
  %UnpackSize133 = getelementptr inbounds %"struct.NArchive::N7z::CExtractFolderInfo", ptr %48, i64 0, i32 3
  %49 = load i64, ptr %UnpackSize133, align 8
...
invoke.cont138:                                   ; preds = %invoke.cont135
  %vtable.i532 = load ptr, ptr %call136, align 8
  %vfn.i533 = getelementptr inbounds ptr, ptr %vtable.i532, i64 1
  %50 = load ptr, ptr %vfn.i533, align 8
...
if.else:                                          ; preds = %invoke.cont141
  ...
  %55 = load i32, ptr %FolderIndex149, align 4
  %56 = load ptr, ptr %_items.i513, align 8
  %idxprom.i537 = sext i32 %55 to i64
  %arrayidx.i538 = getelementptr inbounds i32, ptr %56, i64 %idxprom.i537
  %57 = load i32, ptr %arrayidx.i538, align 4
  br label %if.end153
...
if.end153:                                        ; preds = %invoke.cont141, %if.else
  ...
  %58 = load i32, ptr %_crcSize, align 4
...
invoke.cont160:                                   ; preds = %if.end153
  ...
  %retval.1.call115.call161 = select i1 %cmp163.not, i32 %retval.1, i32 %call161
  br i1 %cmp163.not, label %cleanup.cont168, label %if.then.i566
...
cleanup.cont168:                                  ; preds = %invoke.cont160
  ...
  br i1 %cmp170.not, label %invoke.cont178, label %if.then.i566
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi710 = phi <2 x i64> [ zeroinitializer, %vector.ph ], [ %80, %vector.body ]
  %74 = trunc i64 %offset.idx to i32
  %75 = add i32 %65, %74
  %76 = sext i32 %75 to i64
  %77 = getelementptr inbounds i64, ptr %67, i64 %76
  %wide.load = load <2 x i64>, ptr %77, align 8
  %78 = getelementptr inbounds i64, ptr %77, i64 2
  %wide.load711 = load <2 x i64>, ptr %78, align 8
  %79 = add <2 x i64> %wide.load, %vec.phi
  %80 = add <2 x i64> %wide.load711, %vec.phi710
  %index.next = add nuw i64 %offset.idx, 4
  %81 = icmp eq i64 %index.next, %n.vec
  br i1 %81, label %middle.block, label %vector.body
...
for.body.i.prol:                                  ; preds = %for.body.i.preheader, %for.body.i.prol
  ...
  %86 = load i64, ptr %arrayidx.i12.i.prol, align 8
...
for.body.i:                                       ; preds = %for.body.i.prol.loopexit, %for.body.i
  ...
  %89 = load i64, ptr %arrayidx.i12.i, align 8
  ...
  %92 = load i64, ptr %arrayidx.i12.i.1, align 8
  ...
  %95 = load i64, ptr %arrayidx.i12.i.2, align 8
  ...
  %98 = load i64, ptr %arrayidx.i12.i.3, align 8
  %add5.i.3 = add i64 %98, %add5.i.2
  %indvars.iv.next.i.3 = add nuw nsw i64 %indvars.iv.i, 4
  %exitcond.not.i.3 = icmp eq i64 %indvars.iv.next.i.3, %wide.trip.count.i
  br i1 %exitcond.not.i.3, label %if.then195, label %for.body.i
...
if.end200:                                        ; preds = %if.then195
  ...
  %104 = load ptr, ptr %_inStream, align 8
  %105 = load ptr, ptr %_items.i10.i, align 8
  %arrayidx.i559 = getelementptr inbounds i64, ptr %105, i64 %idxprom.i5.i
  %106 = load ptr, ptr %getTextPassword, align 8
  %107 = load i32, ptr %add.ptr, align 8
...
cleanup284:                                       ; preds = %cleanup263, %invoke.cont271
  ...
  %117 = load ptr, ptr %getTextPassword, align 8
  %tobool.not.i = icmp eq ptr %117, null
  br i1 %tobool.not.i, label %_ZN9CMyComPtrI22ICryptoGetTextPasswordED2Ev.exit, label %if.then.i562

if.then.i562:                                     ; preds = %cleanup284
  %vtable.i563 = load ptr, ptr %117, align 8
  %vfn.i564 = getelementptr inbounds ptr, ptr %vtable.i563, i64 2
  %118 = load ptr, ptr %vfn.i564, align 8
...
terminate.lpad.i:                                 ; preds = %if.then.i562
...
_ZN9CMyComPtrI22ICryptoGetTextPasswordED2Ev.exit: ; preds = %cleanup284, %if.then.i562
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %getTextPassword) #12
  br label %if.then.i566

if.then.i566:                                     ; preds = %_ZN9CMyComPtrI22ICryptoGetTextPasswordED2Ev.exit, %invoke.cont160, %cleanup.cont168
  ...
  %vtable.i567 = load ptr, ptr %call136, align 8
  %vfn.i568 = getelementptr inbounds ptr, ptr %vtable.i567, i64 2
  %121 = load ptr, ptr %vfn.i568, align 8
  %call.i569 = invoke noundef i32 %121(ptr noundef nonnull align 8 dereferenceable(8) %call136)
          to label %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit unwind label %terminate.lpad.i570

terminate.lpad.i570:                              ; preds = %if.then.i566
...
_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit:   ; preds = %if.then.i566
  switch i32 %cleanup.dest.slot.10, label %if.then.i586.loopexit [
    i32 0, label %for.inc312
    i32 10, label %for.inc312
    i32 8, label %if.then.i586
  ]
...
ehcleanup285:                                     ; preds = %lpad270, %lpad191
  ...
  %124 = load ptr, ptr %getTextPassword, align 8
  %tobool.not.i571 = icmp eq ptr %124, null
  br i1 %tobool.not.i571, label %_ZN9CMyComPtrI22ICryptoGetTextPasswordED2Ev.exit577, label %if.then.i572

if.then.i572:                                     ; preds = %ehcleanup285
  %vtable.i573 = load ptr, ptr %124, align 8
  %vfn.i574 = getelementptr inbounds ptr, ptr %vtable.i573, i64 2
  %125 = load ptr, ptr %vfn.i574, align 8
  %call.i575 = invoke noundef i32 %125(ptr noundef nonnull align 8 dereferenceable(8) %124)
          to label %_ZN9CMyComPtrI22ICryptoGetTextPasswordED2Ev.exit577 unwind label %terminate.lpad.i576

terminate.lpad.i576:                              ; preds = %if.then.i572
...
_ZN9CMyComPtrI22ICryptoGetTextPasswordED2Ev.exit577: ; preds = %ehcleanup285, %if.then.i572
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %getTextPassword) #12
  br label %if.then.i579

if.then.i579:                                     ; preds = %lpad155, %_ZN9CMyComPtrI22ICryptoGetTextPasswordED2Ev.exit577
  %.pn450.pn.pn.pn = phi { ptr, i32 } [ %59, %lpad155 ], [ %.pn450, %_ZN9CMyComPtrI22ICryptoGetTextPasswordED2Ev.exit577 ]
  %vtable.i580 = load ptr, ptr %call136, align 8
  %vfn.i581 = getelementptr inbounds ptr, ptr %vtable.i580, i64 2
  %128 = load ptr, ptr %vfn.i581, align 8
  %call.i582 = invoke noundef i32 %128(ptr noundef nonnull align 8 dereferenceable(8) %call136)
          to label %if.then.i592 unwind label %terminate.lpad.i583

terminate.lpad.i583:                              ; preds = %if.then.i579
...
if.then.i586.loopexit:                            ; preds = %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit
  br label %if.then.i586

if.then.i586:                                     ; preds = %invoke.cont114, %cleanup.cont121, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit, %if.then.i586.loopexit
  %131 = phi i32 [ 0, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit ], [ 0, %cleanup.cont121 ], [ %call115, %invoke.cont114 ], [ %retval.10, %if.then.i586.loopexit ]
  %vtable.i587 = load ptr, ptr %call101, align 8
  %vfn.i588 = getelementptr inbounds ptr, ptr %vtable.i587, i64 2
  %132 = load ptr, ptr %vfn.i588, align 8
  %call.i589 = invoke noundef i32 %132(ptr noundef nonnull align 8 dereferenceable(8) %call101)
          to label %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit unwind label %terminate.lpad.i590

terminate.lpad.i590:                              ; preds = %if.then.i586
...
_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit:  ; preds = %if.then.i586
...
if.then.i592:                                     ; preds = %lpad107, %lpad137, %lpad134, %lpad113, %if.then.i579, %lpad140
  %.pn450.pn.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %43, %lpad107 ], [ %44, %lpad113 ], [ %53, %lpad137 ], [ %52, %lpad134 ], [ %54, %lpad140 ], [ %.pn450.pn.pn.pn, %if.then.i579 ]
  %vtable.i593 = load ptr, ptr %call101, align 8
  %vfn.i594 = getelementptr inbounds ptr, ptr %vtable.i593, i64 2
  %135 = load ptr, ptr %vfn.i594, align 8
  %call.i595 = invoke noundef i32 %135(ptr noundef nonnull align 8 dereferenceable(8) %call101)
          to label %ehcleanup325 unwind label %terminate.lpad.i596

terminate.lpad.i596:                              ; preds = %if.then.i592
...
ehcleanup325:                                     ; preds = %lpad105, %if.then.i592, %lpad102, %lpad99
  %.pn450.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %41, %lpad102 ], [ %40, %lpad99 ], [ %42, %lpad105 ], [ %.pn450.pn.pn.pn.pn.pn.pn.pn.pn, %if.then.i592 ]
  call void @_ZN8NArchive3N7z8CDecoderD2Ev(ptr noundef nonnull align 8 dereferenceable(232) %decoder) #12
  br label %ehcleanup337
...
cleanup338:                                       ; preds = %invoke.cont88, %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit
  ...
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %extractFolderInfoVector)
          to label %_ZN13CObjectVectorIN8NArchive3N7z18CExtractFolderInfoEED2Ev.exit unwind label %terminate.lpad.i598

terminate.lpad.i598:                              ; preds = %cleanup338
...
ehcleanup339:                                     ; preds = %ehcleanup, %lpad34, %lpad42, %lpad56, %ehcleanup337
  ...
  call void @_ZN13CObjectVectorIN8NArchive3N7z18CExtractFolderInfoEED2Ev(ptr noundef nonnull align 8 dereferenceable(32) %extractFolderInfoVector) #12
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %extractFolderInfoVector) #12
  br i1 %cmp.not.i, label %ehcleanup349, label %if.then.i601

if.then.i601:                                     ; preds = %ehcleanup339.thread, %ehcleanup339
  %.pn469.pn.pn679 = phi { ptr, i32 } [ %37, %ehcleanup339.thread ], [ %.pn469.pn.pn, %ehcleanup339 ]
  %vtable.i602 = load ptr, ptr %extractCallbackSpec, align 8
  %vfn.i603 = getelementptr inbounds ptr, ptr %vtable.i602, i64 2
  %140 = load ptr, ptr %vfn.i603, align 8
  %call.i604 = invoke noundef i32 %140(ptr noundef nonnull align 8 dereferenceable(8) %extractCallbackSpec)
          to label %ehcleanup349 unwind label %terminate.lpad.i605

terminate.lpad.i605:                              ; preds = %if.then.i601
...
cleanup342:                                       ; preds = %invoke.cont, %_ZN13CObjectVectorIN8NArchive3N7z18CExtractFolderInfoEED2Ev.exit
  ...
  br i1 %cmp.not.i, label %return, label %if.then.i607

if.then.i607:                                     ; preds = %cleanup342
  %vtable.i608 = load ptr, ptr %extractCallbackSpec, align 8
  %vfn.i609 = getelementptr inbounds ptr, ptr %vtable.i608, i64 2
  %143 = load ptr, ptr %vfn.i609, align 8
  %call.i610 = invoke noundef i32 %143(ptr noundef nonnull align 8 dereferenceable(8) %extractCallbackSpec)
...
ehcleanup349:                                     ; preds = %if.then.i601, %ehcleanup339, %lpad
  %.pn469.pn.pn.pn.pn = phi { ptr, i32 } [ %2, %lpad ], [ %.pn469.pn.pn, %ehcleanup339 ], [ %.pn469.pn.pn679, %if.then.i601 ]
...
catch355:                                         ; preds = %ehcleanup349
  ...
  store ptr %147, ptr %exception, align 16
...
return:                                           ; preds = %if.then.i607, %cleanup342, %catch352
  %retval.15 = phi i32 [ -2147024882, %catch352 ], [ %retval.14, %cleanup342 ], [ %retval.14, %if.then.i607 ]
  ret i32 %retval.15
...
entry:
  ...
  store i64 1, ptr %_itemSize.i.i.i, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CRecordVectorIbE, i64 0, inrange i32 0, i64 2), ptr %ExtractStatuses.i, align 8
...
.noexc4.i.i:                                      ; preds = %for.body.i.i.i.i
  %5 = load ptr, ptr %_items.i10.i.i.i.i, align 8
  ...
  store i8 %4, ptr %arrayidx.i13.i.i.i.i, align 1
...
invoke.cont:                                      ; preds = %.noexc4.i.i, %.noexc3.i.i
  ...
  %7 = load i64, ptr %UnpackSize4.i, align 8
  store i64 %7, ptr %UnpackSize.i, align 8
...
entry:
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN8NArchive3N7z18CExtractFolderInfoEE, i64 0, inrange i32 0, i64 2), ptr %this, align 8
