...
invoke.cont8:
  ...
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive3N7z15CFolderInStreamE, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive3N7z15CFolderInStreamE, i64 0, inrange i32 1, i64 2), ptr %0, align 8
  ...
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CRecordVectorIbE, i64 0, inrange i32 0, i64 2), ptr %Processed, align 8
  ...
  store i64 4, ptr %_itemSize.i.i29, align 8
  ...
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CRecordVectorIyE, i64 0, inrange i32 0, i64 2), ptr %Sizes, align 8
...
invoke.cont14:                                    ; preds = %invoke.cont8
  ...
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV26CSequentialInStreamWithCRC, i64 0, inrange i32 0, i64 2), ptr %call, align 8
  ...
  store ptr %call, ptr %_inStreamWithHashSpec, align 8
...
call.i.noexc:                                     ; preds = %invoke.cont14
  %4 = load ptr, ptr %_inStreamWithHash, align 8
...
invoke.cont17:                                    ; preds = %call.i.noexc, %if.then2.i
  store ptr %call, ptr %_inStreamWithHash, align 8
  ret void
...
lpad11:                                           ; preds = %if.then2.i, %invoke.cont14, %invoke.cont8
  ...
  %7 = load ptr, ptr %_updateCallback, align 8
...
if.then.i:                                        ; preds = %lpad11
  %vtable.i35 = load ptr, ptr %7, align 8
...
_ZN9CMyComPtrI22IArchiveUpdateCallbackED2Ev.exit: ; preds = %lpad11, %if.then.i
  %11 = load ptr, ptr %_inStreamWithHash, align 8
...
if.then.i38:                                      ; preds = %_ZN9CMyComPtrI22IArchiveUpdateCallbackED2Ev.exit
  %vtable.i39 = load ptr, ptr %11, align 8
...
if.end.i:                                         ; preds = %if.then.i, %entry
  %1 = load ptr, ptr %_updateCallback, align 8
...
entry:
  ...
  store i64 0, ptr %_filePos, align 8
  %_fileIndex = getelementptr inbounds %"class.NArchive::N7z::CFolderInStream", ptr %this, i64 0, i32 12
  %_numFiles = getelementptr inbounds %"class.NArchive::N7z::CFolderInStream", ptr %this, i64 0, i32 11
  %_updateCallback = getelementptr inbounds %"class.NArchive::N7z::CFolderInStream", ptr %this, i64 0, i32 5
  %_fileIndices = getelementptr inbounds %"class.NArchive::N7z::CFolderInStream", ptr %this, i64 0, i32 10
...
while.cond:                                       ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit, %entry
  ...
  %0 = load i32, ptr %_fileIndex, align 4
  %1 = load i32, ptr %_numFiles, align 8
...
while.body:                                       ; preds = %while.cond
  ...
  %2 = load ptr, ptr %_updateCallback, align 8
  %3 = load ptr, ptr %_fileIndices, align 8
...
if.end:                                           ; preds = %invoke.cont5
  %7 = load i32, ptr %_fileIndex, align 4
  %inc = add i32 %7, 1
  store i32 %inc, ptr %_fileIndex, align 4
  %8 = load ptr, ptr %_inStreamWithHashSpec, align 8
...
invoke.cont12:                                    ; preds = %if.end.i.i, %if.then2.i.i
  store ptr %9, ptr %_stream.i, align 8
  %13 = load ptr, ptr %_inStreamWithHashSpec, align 8
...
if.then17:                                        ; preds = %invoke.cont12
  store i8 1, ptr %_fileIsOpen, align 1
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %streamGetSize) #13
  store ptr null, ptr %streamGetSize, align 8
...
invoke.cont23:                                    ; preds = %if.then17
  %16 = load ptr, ptr %streamGetSize, align 8
...
ehcleanup:                                        ; preds = %lpad29, %lpad20
  ...
  %23 = load ptr, ptr %streamGetSize, align 8
...
if.then.i90:                                      ; preds = %ehcleanup
  %vtable.i91 = load ptr, ptr %23, align 8
...
if.end43:                                         ; preds = %invoke.cont12
  %27 = load ptr, ptr %_updateCallback, align 8
  %vtable49 = load ptr, ptr %27, align 8
...
invoke.cont60:                                    ; preds = %cleanup.cont58
  %30 = load ptr, ptr %_items.i, align 8
  %31 = load i32, ptr %_size.i96, align 4
  ...
  store i32 %inc.i, ptr %_size.i96, align 4
...
invoke.cont63:                                    ; preds = %invoke.cont60
  ...
  %32 = load ptr, ptr %_items.i97, align 8
  %33 = load i32, ptr %_size.i98, align 4
  %idxprom.i99 = sext i32 %33 to i64
  %arrayidx.i100 = getelementptr inbounds i8, ptr %32, i64 %idxprom.i99
  store i8 %frombool.i, ptr %arrayidx.i100, align 1
  %inc.i101 = add nsw i32 %33, 1
  store i32 %inc.i101, ptr %_size.i98, align 4
  %34 = load ptr, ptr %_inStreamWithHashSpec, align 8
  %_crc.i.i = getelementptr inbounds %class.CSequentialInStreamWithCRC, ptr %34, i64 0, i32 5
  %35 = load i32, ptr %_crc.i.i, align 8
...
if.then.i103:                                     ; preds = %cleanup66
  %vtable.i104 = load ptr, ptr %39, align 8
...
if.then.i109:                                     ; preds = %ehcleanup67
  %vtable.i110 = load ptr, ptr %43, align 8
...
entry:
  %_updateCallback = getelementptr inbounds %"class.NArchive::N7z::CFolderInStream", ptr %this, i64 0, i32 5
  %0 = load ptr, ptr %_updateCallback, align 8
...
cleanup.cont:                                     ; preds = %entry
  %_inStreamWithHashSpec = getelementptr inbounds %"class.NArchive::N7z::CFolderInStream", ptr %this, i64 0, i32 3
  %2 = load ptr, ptr %_inStreamWithHashSpec, align 8
...
_ZN26CSequentialInStreamWithCRC13ReleaseStreamEv.exit: ; preds = %cleanup.cont, %if.then.i.i
  ...
  %Sizes = getelementptr inbounds %"class.NArchive::N7z::CFolderInStream", ptr %this, i64 0, i32 15
  %_filePos = getelementptr inbounds %"class.NArchive::N7z::CFolderInStream", ptr %this, i64 0, i32 9
  %7 = load i64, ptr %_filePos, align 8
...
cleanup.cont:                                     ; preds = %if.then3
  %3 = load i32, ptr %processed2, align 4
...
if.then20:                                        ; preds = %if.end18
  store i32 %3, ptr %processedSize, align 4
  br label %cleanup22.thread49

cleanup22.thread49:                               ; preds = %if.end18, %if.then20
  %conv = zext i32 %3 to i64
  %_filePos = getelementptr inbounds %"class.NArchive::N7z::CFolderInStream", ptr %this, i64 0, i32 9
  %4 = load i64, ptr %_filePos, align 8
  %add = add i64 %4, %conv
  store i64 %add, ptr %_filePos, align 8
...
if.end24:                                         ; preds = %while.body
  %5 = load i32, ptr %_fileIndex, align 4
  %6 = load i32, ptr %_numFiles, align 8
...
if.end10:                                         ; preds = %if.end
  %_currentSizeIsDefined = getelementptr inbounds %"class.NArchive::N7z::CFolderInStream", ptr %this, i64 0, i32 6
  %2 = load i8, ptr %_currentSizeIsDefined, align 8
...
cleanup.sink.split:                               ; preds = %if.then7, %if.end12
  ...
  %3 = load i64, ptr %_currentSize.sink, align 8
...
if.end10.i:                                       ; preds = %if.end.i
  ...
  %2 = load i8, ptr %_currentSizeIsDefined.i, align 8
...
cleanup.sink.split.i:                             ; preds = %if.end12.i, %if.then7.i
  ...
  %3 = load i64, ptr %_currentSize.sink.i, align 8
  store i64 %3, ptr %value, align 8
...
entry:
  ...
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive3N7z15CFolderInStreamE, i64 0, inrange i32 1, i64 2), ptr %add.ptr, align 8
  %Sizes = getelementptr inbounds %"class.NArchive::N7z::CFolderInStream", ptr %this, i64 0, i32 15
  tail call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %Sizes) #13
  %CRCs = getelementptr inbounds %"class.NArchive::N7z::CFolderInStream", ptr %this, i64 0, i32 14
  tail call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %CRCs) #13
...
entry:
  ...
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive3N7z15CFolderInStreamE, i64 0, inrange i32 1, i64 2), ptr %add.ptr.i, align 8
  ...
  %0 = load ptr, ptr %_updateCallback.i, align 8
...
_ZN9CMyComPtrI22IArchiveUpdateCallbackED2Ev.exit.i: ; preds = %if.then.i.i, %entry
  ...
  %4 = load ptr, ptr %_inStreamWithHash.i, align 8
...
entry:
  %0 = getelementptr inbounds i8, ptr %this, i64 -8
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive3N7z15CFolderInStreamE, i64 0, inrange i32 0, i64 2), ptr %0, align 8
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive3N7z15CFolderInStreamE, i64 0, inrange i32 1, i64 2), ptr %this, align 8
  ...
  %1 = load ptr, ptr %_updateCallback.i, align 8
...
_ZN9CMyComPtrI22IArchiveUpdateCallbackED2Ev.exit.i: ; preds = %if.then.i.i, %entry
  ...
  %5 = load ptr, ptr %_inStreamWithHash.i, align 8
...
entry:
  ...
  %1 = load ptr, ptr %_updateCallback.i.i, align 8
...
_ZN9CMyComPtrI22IArchiveUpdateCallbackED2Ev.exit.i.i: ; preds = %if.then.i.i.i, %entry
  ...
  %5 = load ptr, ptr %_inStreamWithHash.i.i, align 8
