...
if.then.i24:                                      ; preds = %_ZN9CMyComPtrI23IArchiveExtractCallbackED2Ev.exit
  %vtable.i25 = load ptr, ptr %11, align 8, !tbaa !10
...
lor.rhs.i:                                        ; preds = %cleanup.cont
  ...
  %20 = select i1 %cmp.i, i32 0, i32 3
  br label %lor.end.i

lor.end.i:                                        ; preds = %lor.rhs.i, %entry.lor.end_crit_edge.i
  %21 = phi ptr [ %.pre.i, %entry.lor.end_crit_edge.i ], [ %17, %lor.rhs.i ]
  %cond.i = phi i32 [ 0, %entry.lor.end_crit_edge.i ], [ %20, %lor.rhs.i ]
  %_stream.i.i.i = getelementptr inbounds %class.COutStreamWithCRC, ptr %21, i64 0, i32 3
  %22 = load ptr, ptr %_stream.i.i.i, align 8, !tbaa !12
...
if.then.i.i.i.i:                                  ; preds = %lor.end.i
  %vtable.i.i.i.i = load ptr, ptr %22, align 8, !tbaa !10
  %vfn.i.i.i.i = getelementptr inbounds ptr, ptr %vtable.i.i.i.i, i64 2
  %23 = load ptr, ptr %vfn.i.i.i.i, align 8
  %call.i.i.i.i = tail call noundef i32 %23(ptr noundef nonnull align 8 dereferenceable(8) %22)
...
_ZN8NArchive3N7z16CFolderOutStream21CloseFileAndSetResultEv.exit: ; preds = %lor.end.i, %if.then.i.i.i.i
  %24 = phi i32 [ %10, %lor.end.i ], [ %.pre10.i, %if.then.i.i.i.i ]
  ...
  %25 = load ptr, ptr %_extractCallback.i.i, align 8, !tbaa !15
  %vtable.i.i = load ptr, ptr %25, align 8, !tbaa !10
  %vfn.i.i = getelementptr inbounds ptr, ptr %vtable.i.i, i64 9
  %26 = load ptr, ptr %vfn.i.i, align 8
  %call2.i.i = tail call noundef i32 %26(ptr noundef nonnull align 8 dereferenceable(8) %25, i32 noundef %cond.i)
...
if.then.i63:                                      ; preds = %ehcleanup
  %vtable.i64 = load ptr, ptr %34, align 8, !tbaa !10
...
lor.rhs:                                          ; preds = %entry
  ...
  %12 = select i1 %cmp, i32 0, i32 3
  br label %lor.end

lor.end:                                          ; preds = %entry.lor.end_crit_edge, %lor.rhs
  %13 = phi ptr [ %.pre, %entry.lor.end_crit_edge ], [ %9, %lor.rhs ]
  %cond = phi i32 [ 0, %entry.lor.end_crit_edge ], [ %12, %lor.rhs ]
  %_stream.i.i = getelementptr inbounds %class.COutStreamWithCRC, ptr %13, i64 0, i32 3
  %14 = load ptr, ptr %_stream.i.i, align 8, !tbaa !12
...
if.then.i.i.i:                                    ; preds = %lor.end
  %vtable.i.i.i = load ptr, ptr %14, align 8, !tbaa !10
  %vfn.i.i.i = getelementptr inbounds ptr, ptr %vtable.i.i.i, i64 2
  %15 = load ptr, ptr %vfn.i.i.i, align 8
  %call.i.i.i = tail call noundef i32 %15(ptr noundef nonnull align 8 dereferenceable(8) %14)
...
_ZN8NArchive3N7z16CFolderOutStream21CloseFileAndSetResultEi.exit: ; preds = %lor.end, %if.then.i.i.i
  %16 = phi i32 [ %2, %lor.end ], [ %.pre10, %if.then.i.i.i ]
  ...
  %17 = load ptr, ptr %_extractCallback.i, align 8, !tbaa !15
  %vtable.i = load ptr, ptr %17, align 8, !tbaa !10
  %vfn.i = getelementptr inbounds ptr, ptr %vtable.i, i64 9
  %18 = load ptr, ptr %vfn.i, align 8
  %call2.i = tail call noundef i32 %18(ptr noundef nonnull align 8 dereferenceable(8) %17, i32 noundef %cond)
  ret i32 %call2.i
}
...
lor.end.i:                                        ; preds = %lor.rhs.i, %entry.lor.end_crit_edge.i
  %20 = phi ptr [ %.pre.i, %entry.lor.end_crit_edge.i ], [ %16, %lor.rhs.i ]
...
if.then.i.i.i.i:                                  ; preds = %lor.end.i
  ...
  %call.i.i.i.i = call noundef i32 %22(ptr noundef nonnull align 8 dereferenceable(8) %21)
  store ptr null, ptr %_stream.i.i.i, align 8, !tbaa !12
  %.pre10.i = load i32, ptr %_currentIndex.i, align 8, !tbaa !30
  br label %_ZN8NArchive3N7z16CFolderOutStream21CloseFileAndSetResultEv.exit

_ZN8NArchive3N7z16CFolderOutStream21CloseFileAndSetResultEv.exit: ; preds = %lor.end.i, %if.then.i.i.i.i
  %23 = phi i32 [ %9, %lor.end.i ], [ %.pre10.i, %if.then.i.i.i.i ]
  store i8 0, ptr %_fileIsOpen, align 2, !tbaa !31
  ...
  %call2.i.i = call noundef i32 %25(ptr noundef nonnull align 8 dereferenceable(8) %24, i32 noundef %cond.i)
...
cleanup.cont50:                                   ; preds = %if.else
  %26 = load i32, ptr %_currentIndex.i, align 8, !tbaa !30
  %27 = load ptr, ptr %_extractStatuses, align 8, !tbaa !27
  %_size.i = getelementptr inbounds %class.CBaseRecordVector, ptr %27, i64 0, i32 2
  %28 = load i32, ptr %_size.i, align 4, !tbaa !32
  %cmp52 = icmp eq i32 %26, %28
...
if.then55:                                        ; preds = %if.then53
  %29 = load i32, ptr %processedSize, align 4, !tbaa !50
  %add56 = add i32 %29, %size.addr.0111
...
for.cond.i15:                                     ; preds = %if.end
  ...
  %33 = load i8, ptr %arrayidx.1.i16, align 1, !tbaa !55
...
for.cond.1.i18:                                   ; preds = %for.cond.i15
  ...
  %35 = load i8, ptr %arrayidx.2.i19, align 2, !tbaa !55
...
for.cond.2.i21:                                   ; preds = %for.cond.1.i18
  ...
  %37 = load i8, ptr %arrayidx.3.i22, align 1, !tbaa !55
...
for.cond.3.i24:                                   ; preds = %for.cond.2.i21
  ...
  %39 = load i8, ptr %arrayidx.4.i25, align 4, !tbaa !55
...
for.cond.4.i27:                                   ; preds = %for.cond.3.i24
  ...
  %41 = load i8, ptr %arrayidx.5.i28, align 1, !tbaa !55
...
for.cond.5.i30:                                   ; preds = %for.cond.4.i27
  ...
  %43 = load i8, ptr %arrayidx.6.i31, align 2, !tbaa !55
...
for.cond.6.i33:                                   ; preds = %for.cond.5.i30
  ...
  %45 = load i8, ptr %arrayidx.7.i34, align 1, !tbaa !55
...
for.cond.7.i36:                                   ; preds = %for.cond.6.i33
  ...
  %47 = load i8, ptr %arrayidx.8.i37, align 4, !tbaa !55
...
for.cond.8.i39:                                   ; preds = %for.cond.7.i36
  ...
  %49 = load i8, ptr %arrayidx.9.i40, align 1, !tbaa !55
...
for.cond.9.i42:                                   ; preds = %for.cond.8.i39
  ...
  %51 = load i8, ptr %arrayidx.10.i43, align 2, !tbaa !55
...
for.cond.10.i45:                                  ; preds = %for.cond.9.i42
  ...
  %53 = load i8, ptr %arrayidx.11.i46, align 1, !tbaa !55
...
for.cond.11.i48:                                  ; preds = %for.cond.10.i45
  ...
  %55 = load i8, ptr %arrayidx.12.i49, align 4, !tbaa !55
...
for.cond.12.i51:                                  ; preds = %for.cond.11.i48
  ...
  %57 = load i8, ptr %arrayidx.13.i52, align 1, !tbaa !55
...
for.cond.13.i54:                                  ; preds = %for.cond.12.i51
  ...
  %59 = load i8, ptr %arrayidx.14.i55, align 2, !tbaa !55
...
_ZeqRK4GUIDS1_.exit61:                            ; preds = %for.cond.13.i54
  ...
  %61 = load i8, ptr %arrayidx.15.i58, align 1, !tbaa !55
