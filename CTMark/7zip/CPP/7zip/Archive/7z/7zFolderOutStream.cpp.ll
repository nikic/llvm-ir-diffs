; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Archive/7z/7zFolderOutStream.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Archive/7z/7zFolderOutStream.cpp"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.GUID = type { i32, i16, i16, [8 x i8] }
%"class.NArchive::N7z::CFolderOutStream" = type { %struct.ISequentialOutStream, %struct.ICompressGetSubStreamSize, %class.CMyUnknownImp, ptr, %class.CMyComPtr, ptr, ptr, %class.CMyComPtr.0, i32, i32, i32, i8, i8, i8, i64 }
...
%"struct.NArchive::N7z::CArchiveDatabase" = type { %class.CRecordVector.1, %class.CRecordVector, %class.CRecordVector.2, %class.CObjectVector, %class.CRecordVector.2, %class.CObjectVector.4, %"struct.NArchive::N7z::CUInt64DefVector", %"struct.NArchive::N7z::CUInt64DefVector", %"struct.NArchive::N7z::CUInt64DefVector", %"struct.NArchive::N7z::CUInt64DefVector", %class.CRecordVector }
...
%"struct.NArchive::N7z::CUInt64DefVector" = type { %class.CRecordVector.1, %class.CRecordVector }
...
entry:
  ...
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive3N7z16CFolderOutStreamE, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive3N7z16CFolderOutStreamE, i64 0, inrange i32 1, i64 2), ptr %0, align 8
  ...
  store ptr null, ptr %_extractCallback, align 8
...
lpad5:                                            ; preds = %if.then2.i, %invoke.cont8, %entry
  %6 = landingpad { ptr, i32 }
          cleanup
  %7 = load ptr, ptr %_extractCallback, align 8
...
if.then.i:                                        ; preds = %lpad5
  %vtable.i21 = load ptr, ptr %7, align 8
...
_ZN9CMyComPtrI23IArchiveExtractCallbackED2Ev.exit: ; preds = %lpad5, %if.then.i
  %11 = load ptr, ptr %_crcStream, align 8
  %tobool.not.i23 = icmp eq ptr %11, null
  br i1 %tobool.not.i23, label %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit, label %if.then.i24

if.then.i24:                                      ; preds = %_ZN9CMyComPtrI23IArchiveExtractCallbackED2Ev.exit
...
_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit:   ; preds = %_ZN9CMyComPtrI23IArchiveExtractCallbackED2Ev.exit, %if.then.i24
  resume { ptr, i32 } %6
}
...
if.end.i:                                         ; preds = %if.then.i, %entry
  %1 = load ptr, ptr %_extractCallback, align 8
...
while.cond:                                       ; preds = %_ZN8NArchive3N7z16CFolderOutStream21CloseFileAndSetResultEv.exit, %entry
  %0 = load i32, ptr %_currentIndex, align 8
...
land.rhs:                                         ; preds = %while.cond
  %3 = load ptr, ptr %_db, align 8
  %4 = load i32, ptr %_startIndex, align 4
  %add = add i32 %4, %0
...
cleanup.cont:                                     ; preds = %while.body
  %8 = load ptr, ptr %_db, align 8
  %9 = load i32, ptr %_startIndex, align 4
  %10 = load i32, ptr %_currentIndex, align 8
  %add.i = add i32 %10, %9
...
entry.lor.end_crit_edge.i:                        ; preds = %cleanup.cont
  %.pre.i = load ptr, ptr %_crcStreamSpec.i, align 8
  br label %lor.end.i
...
lor.rhs.i:                                        ; preds = %cleanup.cont
  ...
  %18 = load i32, ptr %_crc.i.i, align 8
...
lor.end.i:                                        ; preds = %lor.rhs.i, %entry.lor.end_crit_edge.i
  ...
  %21 = load ptr, ptr %_stream.i.i.i, align 8
...
if.then.i.i.i.i:                                  ; preds = %lor.end.i
  ...
  %.pre10.i = load i32, ptr %_currentIndex, align 8
...
_ZN8NArchive3N7z16CFolderOutStream21CloseFileAndSetResultEv.exit: ; preds = %lor.end.i, %if.then.i.i.i.i
  ...
  store i8 0, ptr %_fileIsOpen.i.i, align 2
  %inc.i.i = add nsw i32 %23, 1
  store i32 %inc.i.i, ptr %_currentIndex, align 8
  %24 = load ptr, ptr %_extractCallback.i.i, align 8
...
entry:
  ...
  %_extractStatuses = getelementptr inbounds %"class.NArchive::N7z::CFolderOutStream", ptr %this, i64 0, i32 6
  %0 = load ptr, ptr %_extractStatuses, align 8
  %_currentIndex = getelementptr inbounds %"class.NArchive::N7z::CFolderOutStream", ptr %this, i64 0, i32 10
  %1 = load i32, ptr %_currentIndex, align 8
  ...
  %_testMode = getelementptr inbounds %"class.NArchive::N7z::CFolderOutStream", ptr %this, i64 0, i32 11
  %4 = load i8, ptr %_testMode, align 4
  ...
  %_startIndex = getelementptr inbounds %"class.NArchive::N7z::CFolderOutStream", ptr %this, i64 0, i32 9
  %5 = load i32, ptr %_startIndex, align 4
  %add = add i32 %5, %1
  %_extractCallback = getelementptr inbounds %"class.NArchive::N7z::CFolderOutStream", ptr %this, i64 0, i32 7
  %6 = load ptr, ptr %_extractCallback, align 8
  %_ref2Offset = getelementptr inbounds %"class.NArchive::N7z::CFolderOutStream", ptr %this, i64 0, i32 8
  %7 = load i32, ptr %_ref2Offset, align 8
  %add6 = add i32 %7, %add
...
cleanup.cont:                                     ; preds = %invoke.cont9
  %_crcStreamSpec = getelementptr inbounds %"class.NArchive::N7z::CFolderOutStream", ptr %this, i64 0, i32 3
  %10 = load ptr, ptr %_crcStreamSpec, align 8
  %11 = load ptr, ptr %realOutStream, align 8
...
if.end.i.i:                                       ; preds = %if.then.i.i, %cleanup.cont
  %13 = load ptr, ptr %_stream.i, align 8
...
invoke.cont19:                                    ; preds = %if.then2.i.i, %if.end.i.i
  store ptr %11, ptr %_stream.i, align 8
  %15 = load ptr, ptr %_crcStreamSpec, align 8
  %_checkCrc = getelementptr inbounds %"class.NArchive::N7z::CFolderOutStream", ptr %this, i64 0, i32 12
  %16 = load i8, ptr %_checkCrc, align 1
...
land.rhs.i:                                       ; preds = %land.lhs.true24
  ...
  %23 = load ptr, ptr %_items.i.i59, align 8
  %arrayidx.i.i61 = getelementptr inbounds i8, ptr %23, i64 %idxprom.i.i
  %24 = load i8, ptr %arrayidx.i.i61, align 1
...
if.end31:                                         ; preds = %invoke.cont26, %land.lhs.true, %invoke.cont19
  ...
  %28 = load ptr, ptr %_extractCallback, align 8
...
cleanup40:                                        ; preds = %if.end31, %invoke.cont9
  ...
  %30 = load ptr, ptr %realOutStream, align 8
...
ehcleanup:                                        ; preds = %lpad18, %lpad11, %lpad
  ...
  %34 = load ptr, ptr %realOutStream, align 8
  %tobool.not.i62 = icmp eq ptr %34, null
  br i1 %tobool.not.i62, label %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit68, label %if.then.i63

if.then.i63:                                      ; preds = %ehcleanup
  %vtable.i64 = load ptr, ptr %34, align 8
  %vfn.i65 = getelementptr inbounds ptr, ptr %vtable.i64, i64 2
  %35 = load ptr, ptr %vfn.i65, align 8
  %call.i66 = invoke noundef i32 %35(ptr noundef nonnull align 8 dereferenceable(8) %34)
          to label %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit68 unwind label %terminate.lpad.i67

terminate.lpad.i67:                               ; preds = %if.then.i63
...
_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit68: ; preds = %ehcleanup, %if.then.i63
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %realOutStream) #11
  resume { ptr, i32 } %.pn
}
...
_ZN17COutStreamWithCRC13ReleaseStreamEv.exit:     ; preds = %entry, %if.then.i.i
  ...
  store i8 0, ptr %_fileIsOpen, align 2
  %_currentIndex = getelementptr inbounds %"class.NArchive::N7z::CFolderOutStream", ptr %this, i64 0, i32 10
  %3 = load i32, ptr %_currentIndex, align 8
  %inc = add nsw i32 %3, 1
  store i32 %inc, ptr %_currentIndex, align 8
  %_extractCallback = getelementptr inbounds %"class.NArchive::N7z::CFolderOutStream", ptr %this, i64 0, i32 7
  %4 = load ptr, ptr %_extractCallback, align 8
...
entry:
  ...
  %_startIndex = getelementptr inbounds %"class.NArchive::N7z::CFolderOutStream", ptr %this, i64 0, i32 9
  %1 = load i32, ptr %_startIndex, align 4
  %_currentIndex = getelementptr inbounds %"class.NArchive::N7z::CFolderOutStream", ptr %this, i64 0, i32 10
  %2 = load i32, ptr %_currentIndex, align 8
  %add = add i32 %2, %1
  ...
  %6 = load i8, ptr %CrcDefined, align 2
  %tobool2.not = icmp eq i8 %6, 0
  %or.cond = select i1 %tobool.not, i1 true, i1 %tobool2.not
  %_checkCrc = getelementptr inbounds %"class.NArchive::N7z::CFolderOutStream", ptr %this, i64 0, i32 12
  %7 = load i8, ptr %_checkCrc, align 1
...
entry.lor.end_crit_edge:                          ; preds = %entry
  ...
  %.pre = load ptr, ptr %_crcStreamSpec.i.phi.trans.insert, align 8
  br label %lor.end
...
lor.end:                                          ; preds = %entry.lor.end_crit_edge, %lor.rhs
  ...
  %13 = load ptr, ptr %_stream.i.i, align 8
...
if.then.i.i.i:                                    ; preds = %lor.end
  ...
  %.pre10 = load i32, ptr %_currentIndex, align 8
...
while.body:                                       ; preds = %while.body.lr.ph, %while.cond.backedge
  ...
  %0 = load i8, ptr %_fileIsOpen, align 2
...
if.then22:                                        ; preds = %if.end19
  ...
  %8 = load i32, ptr %_startIndex.i, align 4
  %9 = load i32, ptr %_currentIndex.i, align 8
  %add.i = add i32 %9, %8
...
lor.rhs.i:                                        ; preds = %if.then22
  ...
  %15 = load i32, ptr %Crc.i, align 4
  %16 = load ptr, ptr %_crcStreamSpec.i, align 8
  %_crc.i.i = getelementptr inbounds %class.COutStreamWithCRC, ptr %16, i64 0, i32 5
  %17 = load i32, ptr %_crc.i.i, align 8
...
lor.end.i:                                        ; preds = %lor.rhs.i, %entry.lor.end_crit_edge.i
  ...
  %20 = load ptr, ptr %_stream.i.i.i, align 8
...
if.then.i.i.i.i:                                  ; preds = %lor.end.i
  ...
  store ptr null, ptr %_stream.i.i.i, align 8
  %.pre10.i = load i32, ptr %_currentIndex.i, align 8
  br label %_ZN8NArchive3N7z16CFolderOutStream21CloseFileAndSetResultEv.exit
...
_ZN8NArchive3N7z16CFolderOutStream21CloseFileAndSetResultEv.exit: ; preds = %lor.end.i, %if.then.i.i.i.i
  ...
  store i32 %inc.i.i, ptr %_currentIndex.i, align 8
  %23 = load ptr, ptr %_extractCallback.i.i, align 8
...
cleanup.cont50:                                   ; preds = %if.else
  %25 = load i32, ptr %_currentIndex.i, align 8
  %26 = load ptr, ptr %_extractStatuses, align 8
...
if.then55:                                        ; preds = %if.then53
  ...
  store i32 %add56, ptr %processedSize, align 4
  br label %return
...
if.end:                                           ; preds = %entry
  %_db = getelementptr inbounds %"class.NArchive::N7z::CFolderOutStream", ptr %this, i64 0, i32 5
  %2 = load ptr, ptr %_db, align 8
  %_startIndex = getelementptr inbounds %"class.NArchive::N7z::CFolderOutStream", ptr %this, i64 0, i32 9
  %3 = load i32, ptr %_startIndex, align 4
  %add = add i32 %3, %conv
...
entry:
  ...
  %0 = load ptr, ptr %_extractStatuses.i, align 8
...
if.end.i:                                         ; preds = %entry
  ...
  %2 = load ptr, ptr %_db.i, align 8
  %_startIndex.i = getelementptr inbounds i8, ptr %this, i64 60
  %3 = load i32, ptr %_startIndex.i, align 4
...
entry:
  ...
  %2 = load i32, ptr %_size.i18, align 4
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end13
  ...
  %4 = load i8, ptr %_fileIsOpen, align 2
...
if.then.i.i.i:                                    ; preds = %if.then
  ...
  store ptr null, ptr %_stream.i.i, align 8
  %.pre = load i32, ptr %_currentIndex, align 8
  br label %_ZN8NArchive3N7z16CFolderOutStream21CloseFileAndSetResultEi.exit
...
_ZN8NArchive3N7z16CFolderOutStream21CloseFileAndSetResultEi.exit: ; preds = %if.then, %if.then.i.i.i
  ...
  store i32 %inc.i, ptr %_currentIndex, align 8
  %9 = load ptr, ptr %_extractCallback.i, align 8
...
if.end13:                                         ; preds = %if.else, %_ZN8NArchive3N7z16CFolderOutStream21CloseFileAndSetResultEi.exit
  %11 = load i32, ptr %_currentIndex, align 8
  %12 = load ptr, ptr %_extractStatuses, align 8
...
entry:
  ...
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive3N7z16CFolderOutStreamE, i64 0, inrange i32 1, i64 2), ptr %add.ptr, align 8
  %_extractCallback = getelementptr inbounds %"class.NArchive::N7z::CFolderOutStream", ptr %this, i64 0, i32 7
  %0 = load ptr, ptr %_extractCallback, align 8
...
if.then.i3:                                       ; preds = %_ZN9CMyComPtrI23IArchiveExtractCallbackED2Ev.exit
...
_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit:   ; preds = %_ZN9CMyComPtrI23IArchiveExtractCallbackED2Ev.exit, %if.then.i3
  ret void
}
...
entry:
  ...
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive3N7z16CFolderOutStreamE, i64 0, inrange i32 1, i64 2), ptr %add.ptr.i, align 8
  %_extractCallback.i = getelementptr inbounds %"class.NArchive::N7z::CFolderOutStream", ptr %this, i64 0, i32 7
  %0 = load ptr, ptr %_extractCallback.i, align 8
...
_ZN9CMyComPtrI23IArchiveExtractCallbackED2Ev.exit.i: ; preds = %if.then.i.i, %entry
  ...
  br i1 %tobool.not.i2.i, label %_ZN8NArchive3N7z16CFolderOutStreamD2Ev.exit, label %if.then.i3.i

if.then.i3.i:                                     ; preds = %_ZN9CMyComPtrI23IArchiveExtractCallbackED2Ev.exit.i
...
_ZN8NArchive3N7z16CFolderOutStreamD2Ev.exit:      ; preds = %_ZN9CMyComPtrI23IArchiveExtractCallbackED2Ev.exit.i, %if.then.i3.i
...
entry:
  %0 = getelementptr inbounds i8, ptr %this, i64 -8
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive3N7z16CFolderOutStreamE, i64 0, inrange i32 0, i64 2), ptr %0, align 8
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive3N7z16CFolderOutStreamE, i64 0, inrange i32 1, i64 2), ptr %this, align 8
  %_extractCallback.i = getelementptr inbounds i8, ptr %this, i64 48
  %1 = load ptr, ptr %_extractCallback.i, align 8
  %tobool.not.i.i = icmp eq ptr %1, null
  br i1 %tobool.not.i.i, label %_ZN9CMyComPtrI23IArchiveExtractCallbackED2Ev.exit.i, label %if.then.i.i
...
_ZN9CMyComPtrI23IArchiveExtractCallbackED2Ev.exit.i: ; preds = %if.then.i.i, %entry
  ...
  %5 = load ptr, ptr %_crcStream.i, align 8
...
entry:
  ...
  %1 = load ptr, ptr %_extractCallback.i.i, align 8
...
_ZN9CMyComPtrI23IArchiveExtractCallbackED2Ev.exit.i.i: ; preds = %if.then.i.i.i, %entry
  ...
  %5 = load ptr, ptr %_crcStream.i.i, align 8
  %tobool.not.i2.i.i = icmp eq ptr %5, null
  br i1 %tobool.not.i2.i.i, label %_ZN8NArchive3N7z16CFolderOutStreamD0Ev.exit, label %if.then.i3.i.i

if.then.i3.i.i:                                   ; preds = %_ZN9CMyComPtrI23IArchiveExtractCallbackED2Ev.exit.i.i
...
_ZN8NArchive3N7z16CFolderOutStreamD0Ev.exit:      ; preds = %_ZN9CMyComPtrI23IArchiveExtractCallbackED2Ev.exit.i.i, %if.then.i3.i.i
