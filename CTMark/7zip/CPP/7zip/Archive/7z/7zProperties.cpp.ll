...
entry:
  ...
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CRecordVectorIyE, i64 0, inrange i32 0, i64 2), ptr %fileInfoPopIDs, align 8
...
_ZN13CRecordVectorIyEC2ERKS0_.exitthread-pre-split: ; preds = %.noexc3.i
  %.pr = load i32, ptr %_size.i9.i.i.i, align 4
...
if.then.i:                                        ; preds = %for.body.i
  ...
  %vtable.i = load ptr, ptr %fileInfoPopIDs, align 8
...
if.then.i.invoke.cont_crit_edge:                  ; preds = %if.then.i
  %.pre = load i32, ptr %_size.i9.i.i.i, align 4
...
for.body.lr.ph.i45:                               ; preds = %invoke.cont
  ...
  %12 = load ptr, ptr %_items.i.i46, align 8
...
for.body.i48:                                     ; preds = %for.inc.i52, %for.body.lr.ph.i45
  ...
  %13 = load i64, ptr %arrayidx.i.i50, align 8
...
if.then.i55:                                      ; preds = %for.body.i48
  ...
  %vtable.i56 = load ptr, ptr %fileInfoPopIDs, align 8
...
if.then.i55.invoke.cont2_crit_edge:               ; preds = %if.then.i55
  %.pr390.pre = load i32, ptr %_size.i9.i.i.i, align 4
...
for.inc.i52:                                      ; preds = %for.body.i48
  ...
  br i1 %exitcond.not.i54, label %invoke.cont2, label %for.body.i48
...
for.body.lr.ph.i61:                               ; preds = %invoke.cont2
  %16 = load ptr, ptr %_items.i.i46, align 8
...
for.body.i64:                                     ; preds = %for.inc.i68, %for.body.lr.ph.i61
  ...
  %17 = load i64, ptr %arrayidx.i.i66, align 8
...
.noexc74.invoke.cont4_crit_edge:                  ; preds = %.noexc74
  %.pr392.pre = load i32, ptr %_size.i9.i.i.i, align 4
...
for.inc.i68:                                      ; preds = %for.body.i64
  ...
  br i1 %exitcond.not.i70, label %invoke.cont4, label %for.body.i64
...
for.body.lr.ph.i78:                               ; preds = %invoke.cont4
  %22 = load ptr, ptr %_items.i.i46, align 8
...
for.body.i81:                                     ; preds = %for.inc.i85, %for.body.lr.ph.i78
  ...
  %23 = load i64, ptr %arrayidx.i.i83, align 8
...
.noexc96.invoke.cont6_crit_edge:                  ; preds = %.noexc96
  %.pr394.pr.pre = load i32, ptr %_size.i9.i.i.i, align 4
...
for.inc.i85:                                      ; preds = %for.body.i81
  ...
  br i1 %exitcond.not.i87, label %invoke.cont6, label %for.body.i81
...
for.body.lr.ph.i101:                              ; preds = %invoke.cont6
  %28 = load ptr, ptr %_items.i.i46, align 8
...
for.body.i104:                                    ; preds = %for.inc.i108, %for.body.lr.ph.i101
  ...
  %29 = load i64, ptr %arrayidx.i.i106, align 8
...
.noexc119.invoke.cont8_crit_edge:                 ; preds = %.noexc119
  %.pr396.pre = load i32, ptr %_size.i9.i.i.i, align 4
...
for.inc.i108:                                     ; preds = %for.body.i104
  ...
  br i1 %exitcond.not.i110, label %invoke.cont8, label %for.body.i104
...
for.body.lr.ph.i124:                              ; preds = %invoke.cont8
  %34 = load ptr, ptr %_items.i.i46, align 8
...
for.body.i127:                                    ; preds = %for.inc.i131, %for.body.lr.ph.i124
  ...
  %35 = load i64, ptr %arrayidx.i.i129, align 8
...
.noexc142.invoke.cont10_crit_edge:                ; preds = %.noexc142
  %.pr398.pr.pr.pre = load i32, ptr %_size.i9.i.i.i, align 4
...
for.inc.i131:                                     ; preds = %for.body.i127
  ...
  br i1 %exitcond.not.i133, label %invoke.cont10, label %for.body.i127
...
for.body.lr.ph.i147:                              ; preds = %invoke.cont10
  %40 = load ptr, ptr %_items.i.i46, align 8
...
for.body.i150:                                    ; preds = %for.inc.i154, %for.body.lr.ph.i147
  ...
  %41 = load i64, ptr %arrayidx.i.i152, align 8
...
.noexc165.invoke.cont12_crit_edge:                ; preds = %.noexc165
  %.pr400.pre = load i32, ptr %_size.i9.i.i.i, align 4
...
for.inc.i154:                                     ; preds = %for.body.i150
  ...
  br i1 %exitcond.not.i156, label %invoke.cont12, label %for.body.i150
...
for.body.lr.ph.i170:                              ; preds = %invoke.cont12
  %46 = load ptr, ptr %_items.i.i46, align 8
...
for.body.i173:                                    ; preds = %for.inc.i177, %for.body.lr.ph.i170
  ...
  %47 = load i64, ptr %arrayidx.i.i175, align 8
...
.noexc188.invoke.cont14_crit_edge:                ; preds = %.noexc188
  %.pr402.pr.pr.pre = load i32, ptr %_size.i9.i.i.i, align 4
...
for.inc.i177:                                     ; preds = %for.body.i173
  ...
  br i1 %exitcond.not.i179, label %invoke.cont14, label %for.body.i173
...
for.body.lr.ph.i193:                              ; preds = %invoke.cont14
  %52 = load ptr, ptr %_items.i.i46, align 8
...
for.body.i196:                                    ; preds = %for.inc.i200, %for.body.lr.ph.i193
  ...
  %53 = load i64, ptr %arrayidx.i.i198, align 8
...
.noexc211.invoke.cont16_crit_edge:                ; preds = %.noexc211
  %.pr404.pre = load i32, ptr %_size.i9.i.i.i, align 4
...
for.inc.i200:                                     ; preds = %for.body.i196
  ...
  br i1 %exitcond.not.i202, label %invoke.cont16, label %for.body.i196
...
for.body.lr.ph.i216:                              ; preds = %invoke.cont16
  %58 = load ptr, ptr %_items.i.i46, align 8
...
for.body.i219:                                    ; preds = %for.inc.i223, %for.body.lr.ph.i216
  ...
  %59 = load i64, ptr %arrayidx.i.i221, align 8
...
.noexc234.invoke.cont18_crit_edge:                ; preds = %.noexc234
  %.pr406.pr.pr.pr.pre = load i32, ptr %_size.i9.i.i.i, align 4
...
for.inc.i223:                                     ; preds = %for.body.i219
  ...
  br i1 %exitcond.not.i225, label %invoke.cont18, label %for.body.i219
...
for.body.lr.ph.i239:                              ; preds = %invoke.cont18
  %64 = load ptr, ptr %_items.i.i46, align 8
...
for.body.i242:                                    ; preds = %for.inc.i246, %for.body.lr.ph.i239
  ...
  %65 = load i64, ptr %arrayidx.i.i244, align 8
...
.noexc257.invoke.cont20_crit_edge:                ; preds = %.noexc257
  %.pr408.pre = load i32, ptr %_size.i9.i.i.i, align 4
...
for.inc.i246:                                     ; preds = %for.body.i242
  ...
  br i1 %exitcond.not.i248, label %invoke.cont20, label %for.body.i242
...
for.body.lr.ph.i262:                              ; preds = %invoke.cont20
  %70 = load ptr, ptr %_items.i.i46, align 8
...
for.body.i265:                                    ; preds = %for.inc.i269, %for.body.lr.ph.i262
  ...
  %71 = load i64, ptr %arrayidx.i.i267, align 8
...
.noexc280.invoke.cont22thread-pre-split_crit_edge: ; preds = %.noexc280
  %.pr410.pre = load i32, ptr %_size.i9.i.i.i, align 4
...
for.inc.i269:                                     ; preds = %for.body.i265
  ...
  br i1 %exitcond.not.i271, label %invoke.cont22, label %for.body.i265
...
invoke.cont22:                                    ; preds = %for.inc.i269, %_ZN13CRecordVectorIyEC2ERKS0_.exit, %invoke.cont18, %invoke.cont16, %invoke.cont12, %invoke.cont14, %invoke.cont6, %invoke.cont4, %invoke.cont10, %invoke.cont8, %invoke.cont, %invoke.cont2, %.noexc280.invoke.cont22thread-pre-split_crit_edge, %invoke.cont20
  ...
  %77 = load i32, ptr %_size.i9.i, align 4
...
.noexc294:                                        ; preds = %for.body.i287
  ...
  br i1 %exitcond.not.i292, label %invoke.cont24, label %for.body.i287
...
for.body.i315:                                    ; preds = %for.inc.i319, %for.body.lr.ph.i312
  ...
  %88 = load i64, ptr %arrayidx.i.i317, align 8
...
if.then.i322:                                     ; preds = %for.body.i315
  ...
  %vtable.i323 = load ptr, ptr %_fileInfoPopIDs, align 8
...
for.inc.i319:                                     ; preds = %for.body.i315
  ...
  br i1 %exitcond.not.i321, label %cleanup.i, label %for.body.i315
...
invoke.cont35:                                    ; preds = %cleanup.i
  %91 = load ptr, ptr %_items.i, align 8
  store i64 20, ptr %91, align 8
  %92 = load i32, ptr %_size.i9.i, align 4
...
for.body.i335:                                    ; preds = %for.inc.i339, %for.body.lr.ph.i332
  ...
  %93 = load i64, ptr %arrayidx.i.i337, align 8
...
if.then.i342:                                     ; preds = %for.body.i335
  ...
  %vtable.i343 = load ptr, ptr %_fileInfoPopIDs, align 8
...
for.inc.i339:                                     ; preds = %for.body.i335
  ...
  br i1 %exitcond.not.i341, label %cleanup.i330, label %for.body.i335
...
invoke.cont37:                                    ; preds = %cleanup.i330
  %96 = load ptr, ptr %_items.i, align 8
  store i64 6, ptr %96, align 8
  %97 = load i32, ptr %_size.i9.i, align 4
...
for.body.i356:                                    ; preds = %for.inc.i360, %for.body.lr.ph.i353
  ...
  %98 = load i64, ptr %arrayidx.i.i358, align 8
...
if.then.i363:                                     ; preds = %for.body.i356
  ...
  %vtable.i364 = load ptr, ptr %_fileInfoPopIDs, align 8
...
for.inc.i360:                                     ; preds = %for.body.i356
  ...
  br i1 %exitcond.not.i362, label %cleanup.i351, label %for.body.i356
...
invoke.cont39:                                    ; preds = %cleanup.i351
  %101 = load ptr, ptr %_items.i, align 8
  store i64 9, ptr %101, align 8
  %102 = load i32, ptr %_size.i9.i, align 4
...
for.body.i377:                                    ; preds = %for.inc.i381, %for.body.lr.ph.i374
  ...
  %103 = load i64, ptr %arrayidx.i.i379, align 8
...
if.then.i384:                                     ; preds = %for.body.i377
  ...
  %vtable.i385 = load ptr, ptr %_fileInfoPopIDs, align 8
...
for.inc.i381:                                     ; preds = %for.body.i377
  ...
  br i1 %exitcond.not.i383, label %cleanup.i372, label %for.body.i377
...
invoke.cont41:                                    ; preds = %cleanup.i372
  %106 = load ptr, ptr %_items.i, align 8
...
if.end:                                           ; preds = %entry
  ...
  %3 = load i64, ptr @_ZN8NArchive3N7z8kPropMapE, align 16
  %cmp1.i = icmp eq i64 %3, %2
  br i1 %cmp1.i, label %if.end7, label %for.inc.i

for.inc.i:                                        ; preds = %if.end
  %4 = load i64, ptr getelementptr inbounds ([13 x %"struct.NArchive::N7z::CPropMap"], ptr @_ZN8NArchive3N7z8kPropMapE, i64 0, i64 1), align 8
  %cmp1.1.i = icmp eq i64 %4, %2
  br i1 %cmp1.1.i, label %if.end7, label %for.inc.1.i

for.inc.1.i:                                      ; preds = %for.inc.i
  %5 = load i64, ptr getelementptr inbounds ([13 x %"struct.NArchive::N7z::CPropMap"], ptr @_ZN8NArchive3N7z8kPropMapE, i64 0, i64 2), align 16
  %cmp1.2.i = icmp eq i64 %5, %2
  br i1 %cmp1.2.i, label %if.end7, label %for.inc.2.i

for.inc.2.i:                                      ; preds = %for.inc.1.i
  %6 = load i64, ptr getelementptr inbounds ([13 x %"struct.NArchive::N7z::CPropMap"], ptr @_ZN8NArchive3N7z8kPropMapE, i64 0, i64 3), align 8
  %cmp1.3.i = icmp eq i64 %6, %2
  br i1 %cmp1.3.i, label %if.end7, label %for.inc.3.i

for.inc.3.i:                                      ; preds = %for.inc.2.i
  %7 = load i64, ptr getelementptr inbounds ([13 x %"struct.NArchive::N7z::CPropMap"], ptr @_ZN8NArchive3N7z8kPropMapE, i64 0, i64 4), align 16
  %cmp1.4.i = icmp eq i64 %7, %2
  br i1 %cmp1.4.i, label %if.end7, label %for.inc.4.i

for.inc.4.i:                                      ; preds = %for.inc.3.i
  %8 = load i64, ptr getelementptr inbounds ([13 x %"struct.NArchive::N7z::CPropMap"], ptr @_ZN8NArchive3N7z8kPropMapE, i64 0, i64 5), align 8
  %cmp1.5.i = icmp eq i64 %8, %2
  br i1 %cmp1.5.i, label %if.end7, label %for.inc.5.i

for.inc.5.i:                                      ; preds = %for.inc.4.i
  %9 = load i64, ptr getelementptr inbounds ([13 x %"struct.NArchive::N7z::CPropMap"], ptr @_ZN8NArchive3N7z8kPropMapE, i64 0, i64 6), align 16
  %cmp1.6.i = icmp eq i64 %9, %2
  br i1 %cmp1.6.i, label %if.end7, label %for.inc.6.i

for.inc.6.i:                                      ; preds = %for.inc.5.i
  %10 = load i64, ptr getelementptr inbounds ([13 x %"struct.NArchive::N7z::CPropMap"], ptr @_ZN8NArchive3N7z8kPropMapE, i64 0, i64 7), align 8
  %cmp1.7.i = icmp eq i64 %10, %2
  br i1 %cmp1.7.i, label %if.end7, label %for.inc.7.i

for.inc.7.i:                                      ; preds = %for.inc.6.i
  %11 = load i64, ptr getelementptr inbounds ([13 x %"struct.NArchive::N7z::CPropMap"], ptr @_ZN8NArchive3N7z8kPropMapE, i64 0, i64 8), align 16
  %cmp1.8.i = icmp eq i64 %11, %2
  br i1 %cmp1.8.i, label %if.end7, label %for.inc.8.i

for.inc.8.i:                                      ; preds = %for.inc.7.i
  %12 = load i64, ptr getelementptr inbounds ([13 x %"struct.NArchive::N7z::CPropMap"], ptr @_ZN8NArchive3N7z8kPropMapE, i64 0, i64 9), align 8
  %cmp1.9.i = icmp eq i64 %12, %2
  br i1 %cmp1.9.i, label %if.end7, label %for.inc.9.i

for.inc.9.i:                                      ; preds = %for.inc.8.i
  %13 = load i64, ptr getelementptr inbounds ([13 x %"struct.NArchive::N7z::CPropMap"], ptr @_ZN8NArchive3N7z8kPropMapE, i64 0, i64 10), align 16
  %cmp1.10.i = icmp eq i64 %13, %2
  br i1 %cmp1.10.i, label %if.end7, label %for.inc.10.i

for.inc.10.i:                                     ; preds = %for.inc.9.i
  %14 = load i64, ptr getelementptr inbounds ([13 x %"struct.NArchive::N7z::CPropMap"], ptr @_ZN8NArchive3N7z8kPropMapE, i64 0, i64 11), align 8
  %cmp1.11.i = icmp eq i64 %14, %2
  br i1 %cmp1.11.i, label %if.end7, label %for.inc.11.i

for.inc.11.i:                                     ; preds = %for.inc.10.i
  %15 = load i64, ptr getelementptr inbounds ([13 x %"struct.NArchive::N7z::CPropMap"], ptr @_ZN8NArchive3N7z8kPropMapE, i64 0, i64 12), align 16
...
if.end7:                                          ; preds = %for.inc.11.i, %if.end, %for.inc.i, %for.inc.1.i, %for.inc.2.i, %for.inc.3.i, %for.inc.4.i, %for.inc.5.i, %for.inc.6.i, %for.inc.7.i, %for.inc.8.i, %for.inc.9.i, %for.inc.10.i
  ...
  %16 = load i32, ptr %propid, align 8
  store i32 %16, ptr %propID, align 4
  ...
  %17 = load i16, ptr %vt, align 4
  store i16 %17, ptr %varType, align 2
