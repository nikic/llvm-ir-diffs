...
if.end:                                           ; preds = %entry
  %0 = load i32, ptr getelementptr inbounds ([1 x %struct.tagSTATPROPSTG], ptr @_ZN8NArchive2NZ6kPropsE, i64 0, i64 0, i32 1), align 8
  store i32 %0, ptr %propID, align 4
  %1 = load i16, ptr getelementptr inbounds ([1 x %struct.tagSTATPROPSTG], ptr @_ZN8NArchive2NZ6kPropsE, i64 0, i64 0, i32 2), align 4
...
if.end18:                                         ; preds = %cleanup.cont12
  ...
  store i8 %7, ptr %_properties, align 8
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %endPosition) #14
  %vtable21 = load ptr, ptr %stream, align 8
...
if.then.i:                                        ; preds = %invoke.cont24
  %10 = load i64, ptr %endPosition, align 8
  %11 = load i64, ptr %_streamStartPosition, align 8
  %sub = add i64 %10, -3
  %sub33 = sub i64 %sub, %11
  %_packSize = getelementptr inbounds %"class.NArchive::NZ::CHandler", ptr %this, i64 0, i32 5
  store i64 %sub33, ptr %_packSize, align 8
...
catch43:                                          ; preds = %catch.dispatch
  ...
  store ptr %18, ptr %exception, align 16
...
invoke.cont46:                                    ; preds = %invoke.cont40
  ...
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV15CDummyOutStream, i64 0, inrange i32 0, i64 2), ptr %call44, align 8
...
invoke.cont48:                                    ; preds = %invoke.cont46
  %13 = load ptr, ptr %realOutStream, align 8
...
if.end.i.i:                                       ; preds = %if.then.i.i, %invoke.cont48
  %15 = load ptr, ptr %_stream.i, align 8
...
invoke.cont59:                                    ; preds = %invoke.cont56
  %vtable.i208 = load ptr, ptr %call57, align 8
...
invoke.cont63:                                    ; preds = %invoke.cont61
  %_stream = getelementptr inbounds %"class.NArchive::NZ::CHandler", ptr %this, i64 0, i32 3
  %20 = load ptr, ptr %_stream, align 8
  %_streamStartPosition = getelementptr inbounds %"class.NArchive::NZ::CHandler", ptr %this, i64 0, i32 4
  %21 = load i64, ptr %_streamStartPosition, align 8
  %add = add i64 %21, 3
...
invoke.cont81:                                    ; preds = %cleanup.cont77
  ...
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress2NZ8CDecoderE, i64 0, inrange i32 0, i64 2), ptr %call82, align 8
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress2NZ8CDecoderE, i64 0, inrange i32 1, i64 2), ptr %31, align 8
  ...
  store i32 0, ptr %_numMaxBits.i, align 4
...
invoke.cont85:                                    ; preds = %invoke.cont81
  %_properties = getelementptr inbounds %"class.NArchive::NZ::CHandler", ptr %this, i64 0, i32 6
  %vtable87 = load ptr, ptr %call82, align 8
...
if.else:                                          ; preds = %invoke.cont90
  %36 = load ptr, ptr %_stream, align 8
  %vtable104 = load ptr, ptr %call82, align 8
...
if.then.i220:                                     ; preds = %invoke.cont106, %if.then.i220.fold.split, %invoke.cont90
  ...
  %vtable.i221 = load ptr, ptr %call44, align 8
...
if.then.i227:                                     ; preds = %invoke.cont106, %invoke.cont120
  ...
  %vtable.i228 = load ptr, ptr %call82, align 8
...
if.then.i231:                                     ; preds = %lpad94, %lpad89
  ...
  %vtable.i232 = load ptr, ptr %call82, align 8
...
if.then.i238:                                     ; preds = %invoke.cont70, %if.then.i227
  ...
  %vtable.i239 = load ptr, ptr %call57, align 8
...
if.then.i244:                                     ; preds = %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit
  %vtable.i245 = load ptr, ptr %outStream.sroa.0.4, align 8
...
if.then.i250:                                     ; preds = %lpad62, %lpad65, %ehcleanup128, %if.then.i231
  ...
  %vtable.i251 = load ptr, ptr %call57, align 8
...
if.then.i257:                                     ; preds = %lpad60, %lpad49, %lpad55, %lpad58, %ehcleanup140
  ...
  %vtable.i258 = load ptr, ptr %outStream.sroa.0.7297, align 8
...
if.then.i264:                                     ; preds = %cleanup145
  %vtable.i265 = load ptr, ptr %.pr, align 8
...
if.then.i271:                                     ; preds = %ehcleanup146
  %vtable.i272 = load ptr, ptr %63, align 8
...
entry:
  store ptr getelementptr inbounds ({ [17 x ptr] }, ptr @_ZTVN8NArchive2NZ8CHandlerE, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %_stream = getelementptr inbounds %"class.NArchive::NZ::CHandler", ptr %this, i64 0, i32 3
  %0 = load ptr, ptr %_stream, align 8
  %tobool.not.i = icmp eq ptr %0, null
...
invoke.cont:
  ...
  store ptr getelementptr inbounds ({ [17 x ptr] }, ptr @_ZTVN8NArchive2NZ8CHandlerE, i64 0, inrange i32 0, i64 2), ptr %call, align 8
