; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Archive/Zip/ZipItem.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Archive/Zip/ZipItem.cpp"
...
while.body:                                       ; preds = %while.body.preheader, %cleanup
  ...
  %3 = load i16, ptr %p.053, align 2
  %add.ptr7 = getelementptr inbounds i8, ptr %p.053, i64 2
  %4 = load i16, ptr %add.ptr7, align 2
...
cleanup.thread:                                   ; preds = %while.body
  ...
  store i32 %5, ptr %ft, align 4
  %add.ptr20 = getelementptr inbounds i8, ptr %add.ptr18, i64 4
  %6 = load i32, ptr %add.ptr20, align 4
  store i32 %6, ptr %dwHighDateTime, align 4
  br label %cleanup28
...
if.then14:                                        ; preds = %for.inc.1, %if.end12.1, %if.end12
  ...
  %4 = load i32, ptr %p.033.lcssa36, align 4
...
entry:
  ...
  %0 = load i8, ptr %HostOS.i, align 1
...
if.end:                                           ; preds = %entry
  ...
  %1 = load i8, ptr %FromCentral, align 1
...
if.end.i:                                         ; preds = %sw.epilog
  ...
  %4 = load i8, ptr %FromCentral.i, align 1
...
sw.bb11.i:                                        ; preds = %if.end4.i, %if.end4.i, %if.end4.i, %if.end4.i
  %6 = load i32, ptr %ExternalAttributes.i, align 4
  %.fr = freeze i32 %6
...
_ZNK8NArchive4NZip5CItem5IsDirEv.exit:            ; preds = %if.end4.i
  %7 = load i32, ptr %ExternalAttributes.i, align 4
  %.fr28 = freeze i32 %7
...
entry:
  ...
  store i16 %conv5.sink, ptr %Flags, align 2
  ret void
}
...
entry:
  ...
  store i16 %conv5.sink.i, ptr %Flags.i, align 2
  ret void
}
...
attributes #1 = { mustprogress nofree nosync nounwind memory(read, argmem: readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
