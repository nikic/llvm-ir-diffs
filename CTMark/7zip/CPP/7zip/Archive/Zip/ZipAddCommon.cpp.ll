...
if.then.i:                                        ; preds = %if.end36, %invoke.cont13, %invoke.cont24, %cleanup.cont31
  ...
  %vtable.i64 = load ptr, ptr %call6, align 8, !tbaa !16
...
if.then.i68:                                      ; preds = %lpad12, %lpad19
  ...
  %vtable.i69 = load ptr, ptr %call6, align 8, !tbaa !16
...
call.i.i.noexc:                                   ; preds = %if.end9.i.i
  ...
  store ptr %call.i.i15, ptr %MatchFinder, align 8, !tbaa !34
  store i32 0, ptr %call.i.i15, align 4, !tbaa !35
...
while.cond.i.i:                                   ; preds = %while.cond.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i
  ...
  br i1 %cmp.not.i.i, label %invoke.cont, label %while.cond.i.i, !llvm.loop !38
...
invoke.cont:                                      ; preds = %while.cond.i.i
  ...
  %15 = load i32, ptr %_length2.i16, align 8, !tbaa !39
...
call.i.i.noexc29:                                 ; preds = %if.end9.i.i19
  ...
  store ptr %call.i.i30, ptr %Password, align 8, !tbaa !41
  store i8 0, ptr %call.i.i30, align 1, !tbaa !25
  store i32 %add.i.i17, ptr %_capacity.i20, align 4, !tbaa !42
...
while.cond.i.i22:                                 ; preds = %while.cond.i.i22, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i
  ...
  %18 = load i8, ptr %src.addr.0.i.i23, align 1, !tbaa !25
  %incdec.ptr1.i.i26 = getelementptr inbounds i8, ptr %dest.addr.0.i.i24, i64 1
  store i8 %18, ptr %dest.addr.0.i.i24, align 1, !tbaa !25
  %cmp.not.i.i27 = icmp eq i8 %18, 0
  br i1 %cmp.not.i.i27, label %invoke.cont7, label %while.cond.i.i22, !llvm.loop !43
...
invoke.cont7:                                     ; preds = %while.cond.i.i22
  ...
  store i32 %15, ptr %_length.i28, align 8, !tbaa !39
...
invoke.cont4:                                     ; preds = %entry
  ...
  %.pre1888 = load ptr, ptr %inStream2, align 8, !tbaa !44
...
cleanup.cont:                                     ; preds = %invoke.cont4
  %tobool.not = icmp eq ptr %.pre1888, null
...
invoke.cont13:                                    ; preds = %if.then9
  ...
  %call.i990 = invoke noundef i32 %3(ptr noundef nonnull align 8 dereferenceable(8) %call11)
          to label %invoke.cont14 unwind label %lpad6

invoke.cont14:                                    ; preds = %invoke.cont13
  %4 = load ptr, ptr %inStream2, align 8, !tbaa !44
  %cmp.not.i.i = icmp eq ptr %4, null
  br i1 %cmp.not.i.i, label %if.end.i.i, label %if.then.i.i

if.then.i.i:                                      ; preds = %invoke.cont14
  %vtable.i.i = load ptr, ptr %4, align 8, !tbaa !16
  %vfn.i.i = getelementptr inbounds ptr, ptr %vtable.i.i, i64 1
  %5 = load ptr, ptr %vfn.i.i, align 8
  %call.i.i993 = invoke noundef i32 %5(ptr noundef nonnull align 8 dereferenceable(8) %4)
          to label %if.end.i.i unwind label %lpad6

if.end.i.i:                                       ; preds = %if.then.i.i, %invoke.cont14
  %6 = load ptr, ptr %_stream.i, align 8, !tbaa !44
  %tobool.not.i.i = icmp eq ptr %6, null
  br i1 %tobool.not.i.i, label %invoke.cont18, label %if.then2.i.i

if.then2.i.i:                                     ; preds = %if.end.i.i
  %vtable4.i.i = load ptr, ptr %6, align 8, !tbaa !16
  %vfn5.i.i = getelementptr inbounds ptr, ptr %vtable4.i.i, i64 2
  %7 = load ptr, ptr %vfn5.i.i, align 8
  %call6.i.i994 = invoke noundef i32 %7(ptr noundef nonnull align 8 dereferenceable(8) %6)
          to label %invoke.cont18 unwind label %lpad6

invoke.cont18:                                    ; preds = %if.end.i.i, %if.then2.i.i
  store ptr %4, ptr %_stream.i, align 8, !tbaa !44
...
lpad6:                                            ; preds = %if.then2.i.i1014, %if.then.i.i1009, %invoke.cont23, %if.then2.i.i, %if.then.i.i, %invoke.cont13, %if.else, %if.then9
  %inCrcStream.sroa.0.0 = phi ptr [ %call21, %if.then2.i.i1014 ], [ %call21, %if.then.i.i1009 ], [ null, %invoke.cont23 ], [ null, %if.else ], [ %call11, %if.then2.i.i ], [ %call11, %if.then.i.i ], [ null, %invoke.cont13 ], [ null, %if.then9 ]
...
invoke.cont23:                                    ; preds = %if.else
  ...
  %_stream.i995 = getelementptr inbounds %class.CSequentialInStreamWithCRC, ptr %call21, i64 0, i32 3
  store ptr null, ptr %_stream.i995, align 8, !tbaa !51
  %10 = load ptr, ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV26CSequentialInStreamWithCRC, i64 0, inrange i32 0, i64 3), align 8
  %call.i1003 = invoke noundef i32 %10(ptr noundef nonnull align 8 dereferenceable(8) %call21)
          to label %if.then.i.i1009 unwind label %lpad6

if.then.i.i1009:                                  ; preds = %invoke.cont23
  %vtable.i.i1010 = load ptr, ptr %inStream, align 8, !tbaa !16
  %vfn.i.i1011 = getelementptr inbounds ptr, ptr %vtable.i.i1010, i64 1
  %11 = load ptr, ptr %vfn.i.i1011, align 8
  %call.i.i1018 = invoke noundef i32 %11(ptr noundef nonnull align 8 dereferenceable(8) %inStream)
          to label %if.end.i.i1012 unwind label %lpad6

if.end.i.i1012:                                   ; preds = %if.then.i.i1009
  %12 = load ptr, ptr %_stream.i995, align 8, !tbaa !51
  %tobool.not.i.i1013 = icmp eq ptr %12, null
  br i1 %tobool.not.i.i1013, label %invoke.cont26, label %if.then2.i.i1014

if.then2.i.i1014:                                 ; preds = %if.end.i.i1012
  %vtable4.i.i1015 = load ptr, ptr %12, align 8, !tbaa !16
  %vfn5.i.i1016 = getelementptr inbounds ptr, ptr %vtable4.i.i1015, i64 2
  %13 = load ptr, ptr %vfn5.i.i1016, align 8
  %call6.i.i1020 = invoke noundef i32 %13(ptr noundef nonnull align 8 dereferenceable(8) %12)
          to label %invoke.cont26 unwind label %lpad6

invoke.cont26:                                    ; preds = %if.end.i.i1012, %if.then2.i.i1014
  store ptr %inStream, ptr %_stream.i995, align 8, !tbaa !51
  %_size.i1021 = getelementptr inbounds %class.CSequentialInStreamWithCRC, ptr %call21, i64 0, i32 4
  store i64 0, ptr %_size.i1021, align 8, !tbaa !53
  ...
  %_crc.i1022 = getelementptr inbounds %class.CSequentialInStreamWithCRC, ptr %call21, i64 0, i32 5
  br label %cleanup29.sink.split

cleanup29.sink.split:                             ; preds = %invoke.cont26, %invoke.cont18
  %_crc.i.sink = phi ptr [ %_crc.i, %invoke.cont18 ], [ %_crc.i1022, %invoke.cont26 ]
  ...
  %.pre1887 = load ptr, ptr %inStream2, align 8, !tbaa !44
  br label %cleanup29

cleanup29:                                        ; preds = %cleanup29.sink.split, %invoke.cont4
  %14 = phi ptr [ %.pre1888, %invoke.cont4 ], [ %.pre1887, %cleanup29.sink.split ]
  ...
  %tobool.not.i1023 = icmp eq ptr %14, null
  br i1 %tobool.not.i1023, label %_ZN9CMyComPtrI9IInStreamED2Ev.exit, label %if.then.i

if.then.i:                                        ; preds = %cleanup29
  %vtable.i1024 = load ptr, ptr %14, align 8, !tbaa !16
  %vfn.i1025 = getelementptr inbounds ptr, ptr %vtable.i1024, i64 2
  %15 = load ptr, ptr %vfn.i1025, align 8
...
cleanup.cont32:                                   ; preds = %_ZN9CMyComPtrI9IInStreamED2Ev.exit
  %_size.i1026 = getelementptr inbounds %class.CBaseRecordVector, ptr %this, i64 0, i32 2
  %18 = load i32, ptr %_size.i1026, align 4, !tbaa !28
...
lor.lhs.false:                                    ; preds = %cleanup.cont32
  ...
  %19 = load i8, ptr %PasswordIsDefined, align 4, !tbaa !58, !range !63, !noundef !64
...
ehcleanup:                                        ; preds = %lpad6, %lpad2
  ...
  %20 = load ptr, ptr %inStream2, align 8, !tbaa !44
  %tobool.not.i1027 = icmp eq ptr %20, null
  br i1 %tobool.not.i1027, label %_ZN9CMyComPtrI9IInStreamED2Ev.exit1033, label %if.then.i1028

if.then.i1028:                                    ; preds = %ehcleanup
  %vtable.i1029 = load ptr, ptr %20, align 8, !tbaa !16
  %vfn.i1030 = getelementptr inbounds ptr, ptr %vtable.i1029, i64 2
  %21 = load ptr, ptr %vfn.i1030, align 8
  %call.i1031 = invoke noundef i32 %21(ptr noundef nonnull align 8 dereferenceable(8) %20)
          to label %_ZN9CMyComPtrI9IInStreamED2Ev.exit1033 unwind label %terminate.lpad.i1032

terminate.lpad.i1032:                             ; preds = %if.then.i1028
...
_ZN9CMyComPtrI9IInStreamED2Ev.exit1033:           ; preds = %ehcleanup, %if.then.i1028
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %inStream2) #17
  br label %ehcleanup816

if.end49.thread:                                  ; preds = %if.then40, %if.then42
  %numTestMethods.0.ph = phi i32 [ 1, %if.then42 ], [ %18, %if.then40 ]
  %ExtractVersion1565 = getelementptr inbounds %"struct.NArchive::NZip::CCompressingResult", ptr %opRes, i64 0, i32 4
  store i8 10, ptr %ExtractVersion1565, align 2, !tbaa !65
...
if.end49:                                         ; preds = %lor.lhs.false
  ...
  %cmp521447 = icmp sgt i32 %18, 0
  br i1 %cmp521447, label %for.body.lr.ph, label %for.end

for.body.lr.ph:                                   ; preds = %if.end49.thread, %if.end49
  %ExtractVersion1568 = phi ptr [ %ExtractVersion1565, %if.end49.thread ], [ %ExtractVersion, %if.end49 ]
  %numTestMethods.01567 = phi i32 [ %numTestMethods.0.ph, %if.end49.thread ], [ 1, %if.end49 ]
  ...
  %wReserved1.i1172 = getelementptr inbounds %struct.tagPROPVARIANT, ptr %props401, i64 0, i32 1
  ...
  %wReserved1.i1173 = getelementptr inbounds %"class.NWindows::NCOM::CPropVariant", ptr %props401, i64 1, i32 0, i32 1
  ...
  %wReserved1.i1174 = getelementptr inbounds %"class.NWindows::NCOM::CPropVariant", ptr %props401, i64 2, i32 0, i32 1
  ...
  %wReserved1.i1147 = getelementptr inbounds %"class.NWindows::NCOM::CPropVariant", ptr %props, i64 1, i32 0, i32 1
  ...
  %wReserved1.i1148 = getelementptr inbounds %"class.NWindows::NCOM::CPropVariant", ptr %props, i64 2, i32 0, i32 1
  ...
  %wReserved1.i1149 = getelementptr inbounds %"class.NWindows::NCOM::CPropVariant", ptr %props, i64 3, i32 0, i32 1
  ...
  %wReserved1.i1150 = getelementptr inbounds %"class.NWindows::NCOM::CPropVariant", ptr %props, i64 5, i32 0, i32 1
  ...
  %wReserved1.i1210 = getelementptr inbounds %struct.tagPROPVARIANT, ptr %props583, i64 0, i32 1
  ...
  %wReserved1.i1211 = getelementptr inbounds %"class.NWindows::NCOM::CPropVariant", ptr %props583, i64 1, i32 0, i32 1
  ...
  %wReserved1.i1212 = getelementptr inbounds %"class.NWindows::NCOM::CPropVariant", ptr %props583, i64 2, i32 0, i32 1
  %36 = getelementptr inbounds %"class.NWindows::NCOM::CPropVariant", ptr %props583, i64 2, i32 0, i32 4
  %wReserved1.i1182 = getelementptr inbounds %struct.tagPROPVARIANT, ptr %props490, i64 0, i32 1
  ...
  %wReserved1.i1183 = getelementptr inbounds %"class.NWindows::NCOM::CPropVariant", ptr %props490, i64 1, i32 0, i32 1
  ...
  %wReserved1.i1184 = getelementptr inbounds %"class.NWindows::NCOM::CPropVariant", ptr %props490, i64 2, i32 0, i32 1
  ...
  %wReserved1.i1185 = getelementptr inbounds %"class.NWindows::NCOM::CPropVariant", ptr %props490, i64 3, i32 0, i32 1
  ...
  %_crc.i1283 = getelementptr inbounds %class.CInStreamWithCRC, ptr %inCrcStreamSpec.1, i64 0, i32 5
  %CRC = getelementptr inbounds %"struct.NArchive::NZip::CCompressingResult", ptr %opRes, i64 0, i32 2
  %_size.i1285 = getelementptr inbounds %class.CInStreamWithCRC, ptr %inCrcStreamSpec.1, i64 0, i32 4
  %_crc.i1286 = getelementptr inbounds %class.CSequentialInStreamWithCRC, ptr %inSecCrcStreamSpec.1, i64 0, i32 5
  %_size.i1288 = getelementptr inbounds %class.CSequentialInStreamWithCRC, ptr %inSecCrcStreamSpec.1, i64 0, i32 4
  %wide.trip.count = zext i32 %numTestMethods.01567 to i64
  %spec.select1675 = select i1 %cmp54.not, ptr %_crc.i1286, ptr %_crc.i1283
  %spec.select1676 = select i1 %cmp54.not, ptr %_size.i1288, ptr %_size.i1285
  br label %for.body

for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %indvars.iv = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next, %for.inc ]
  %retval.11450 = phi i32 [ 0, %for.body.lr.ph ], [ %retval.30, %for.inc ]
  %outStreamReleaser.sroa.0.01448 = phi ptr [ null, %for.body.lr.ph ], [ %outStreamReleaser.sroa.0.2, %for.inc ]
  store i8 10, ptr %ExtractVersion1568, align 2, !tbaa !65
...
invoke.cont87:                                    ; preds = %cleanup.cont81
  ...
  %retval.3.call75.call88 = select i1 %cmp89.not, i32 %retval.11450, i32 %call88
...
cleanup.cont94:                                   ; preds = %invoke.cont87
  %48 = load i8, ptr %PasswordIsDefined97, align 4, !tbaa !58, !range !63, !noundef !64
  %tobool98.not = icmp eq i8 %48, 0
  br i1 %tobool98.not, label %if.end255, label %if.then99

if.then99:                                        ; preds = %cleanup.cont94
  store i8 20, ptr %ExtractVersion1568, align 2, !tbaa !65
  %49 = load ptr, ptr %_cryptoStream, align 8, !tbaa !68
...
invoke.cont108:                                   ; preds = %invoke.cont105
  ...
  %vtable.i1035 = load ptr, ptr %add.ptr, align 8, !tbaa !16
  %vfn.i1036 = getelementptr inbounds ptr, ptr %vtable.i1035, i64 1
  %50 = load ptr, ptr %vfn.i1036, align 8
  %call.i10371042 = invoke noundef i32 %50(ptr noundef nonnull align 8 dereferenceable(8) %add.ptr)
          to label %call.i1037.noexc unwind label %lpad101

call.i1037.noexc:                                 ; preds = %invoke.cont108
  %51 = load ptr, ptr %_cryptoStream, align 8, !tbaa !68
  %tobool.not.i1038 = icmp eq ptr %51, null
  br i1 %tobool.not.i1038, label %_ZN9CMyComPtrI20ISequentialOutStreamEaSEPS0_.exit, label %if.then2.i1039

if.then2.i1039:                                   ; preds = %call.i1037.noexc
  %vtable4.i1040 = load ptr, ptr %51, align 8, !tbaa !16
  %vfn5.i1041 = getelementptr inbounds ptr, ptr %vtable4.i1040, i64 2
  %52 = load ptr, ptr %vfn5.i1041, align 8
  %call6.i1044 = invoke noundef i32 %52(ptr noundef nonnull align 8 dereferenceable(8) %51)
          to label %_ZN9CMyComPtrI20ISequentialOutStreamEaSEPS0_.exit unwind label %lpad101

_ZN9CMyComPtrI20ISequentialOutStreamEaSEPS0_.exit: ; preds = %if.then2.i1039, %call.i1037.noexc
  store ptr %add.ptr, ptr %_cryptoStream, align 8, !tbaa !68
  br label %if.end114

lpad101:                                          ; preds = %if.then2.i1085, %invoke.cont263, %if.then2.i1064, %invoke.cont179, %if.then2.i1051, %invoke.cont126, %if.then2.i1039, %invoke.cont108, %if.then262, %invoke.cont183, %if.then175, %if.then122, %if.then104
  %outStreamReleaser.sroa.0.1 = phi ptr [ %outStreamReleaser.sroa.0.2, %if.then2.i1085 ], [ %outStreamReleaser.sroa.0.2, %invoke.cont263 ], [ %outStreamReleaser.sroa.0.2, %if.then262 ], [ %outStreamReleaser.sroa.0.01448, %invoke.cont183 ], [ %outStreamReleaser.sroa.0.01448, %if.then2.i1064 ], [ %outStreamReleaser.sroa.0.01448, %invoke.cont179 ], [ %outStreamReleaser.sroa.0.01448, %if.then175 ], [ %outStreamReleaser.sroa.0.01448, %if.then2.i1051 ], [ %outStreamReleaser.sroa.0.01448, %invoke.cont126 ], [ %outStreamReleaser.sroa.0.01448, %if.then122 ], [ %outStreamReleaser.sroa.0.01448, %if.then2.i1039 ], [ %outStreamReleaser.sroa.0.01448, %invoke.cont108 ], [ %outStreamReleaser.sroa.0.01448, %if.then104 ]
...
if.end114:                                        ; preds = %_ZN9CMyComPtrI20ISequentialOutStreamEaSEPS0_.exit, %if.then99
  %55 = load i8, ptr %IsAesMode, align 8, !tbaa !70, !range !63, !noundef !64
  %tobool116.not = icmp eq i8 %55, 0
  br i1 %tobool116.not, label %if.else170, label %if.then117

if.then117:                                       ; preds = %if.end114
  store i8 51, ptr %ExtractVersion1568, align 2, !tbaa !65
  %56 = load ptr, ptr %_cryptoStreamSpec, align 8, !tbaa !69
  %Filter = getelementptr inbounds %class.CFilterCoder, ptr %56, i64 0, i32 26
  %57 = load ptr, ptr %Filter, align 8, !tbaa !71
  %cmp.i1045 = icmp eq ptr %57, null
  br i1 %cmp.i1045, label %if.then122, label %if.end157
...
invoke.cont123:                                   ; preds = %if.then122
  ...
  store ptr getelementptr inbounds ({ [10 x ptr], [8 x ptr] }, ptr @_ZTVN7NCrypto6NWzAes10CBaseCoderE, i64 0, inrange i32 1, i64 2), ptr %58, align 8, !tbaa !16
...
lpad2.i.i:                                        ; preds = %invoke.cont123
  ...
  %61 = load ptr, ptr %_items.i.i.i.i, align 8, !tbaa !77
...
invoke.cont126:                                   ; preds = %invoke.cont123
  ...
  store ptr getelementptr inbounds ({ [10 x ptr], [8 x ptr] }, ptr @_ZTVN7NCrypto6NWzAes8CEncoderE, i64 0, inrange i32 1, i64 2), ptr %58, align 8, !tbaa !16
  store ptr %call124, ptr %_filterAesSpec, align 8, !tbaa !78
  %62 = load ptr, ptr %_cryptoStreamSpec, align 8, !tbaa !69
  %Filter129 = getelementptr inbounds %class.CFilterCoder, ptr %62, i64 0, i32 26
  %call.i10491054 = invoke noundef i32 %24(ptr noundef nonnull align 8 dereferenceable(8) %call124)
          to label %call.i1049.noexc unwind label %lpad101

call.i1049.noexc:                                 ; preds = %invoke.cont126
  %63 = load ptr, ptr %Filter129, align 8, !tbaa !71
  %tobool.not.i1050 = icmp eq ptr %63, null
  br i1 %tobool.not.i1050, label %invoke.cont130, label %if.then2.i1051

if.then2.i1051:                                   ; preds = %call.i1049.noexc
  %vtable4.i1052 = load ptr, ptr %63, align 8, !tbaa !16
  %vfn5.i1053 = getelementptr inbounds ptr, ptr %vtable4.i1052, i64 2
  %64 = load ptr, ptr %vfn5.i1053, align 8
  %call6.i1056 = invoke noundef i32 %64(ptr noundef nonnull align 8 dereferenceable(8) %63)
          to label %invoke.cont130 unwind label %lpad101

invoke.cont130:                                   ; preds = %call.i1049.noexc, %if.then2.i1051
  store ptr %call124, ptr %Filter129, align 8, !tbaa !71
  %65 = load ptr, ptr %_filterAesSpec, align 8, !tbaa !78
...
_ZN7NCrypto6NWzAes10CBaseCoder10SetKeyModeEj.exit: ; preds = %invoke.cont130, %if.end.i
  %68 = load ptr, ptr %Password, align 8, !tbaa !41
  %69 = load i32, ptr %_length.i, align 8, !tbaa !39
  %vtable146 = load ptr, ptr %65, align 8, !tbaa !16
...
if.end157:                                        ; preds = %invoke.cont148, %if.then117
  %72 = load ptr, ptr %_filterAesSpec, align 8, !tbaa !78
...
if.else170:                                       ; preds = %if.end114
  %74 = load ptr, ptr %_cryptoStreamSpec, align 8, !tbaa !69
  %Filter172 = getelementptr inbounds %class.CFilterCoder, ptr %74, i64 0, i32 26
  %75 = load ptr, ptr %Filter172, align 8, !tbaa !71
  %cmp.i1057 = icmp eq ptr %75, null
  br i1 %cmp.i1057, label %if.then175, label %if.end198
...
invoke.cont179:                                   ; preds = %if.then175
  ...
  store ptr getelementptr inbounds ({ [10 x ptr], [8 x ptr] }, ptr @_ZTVN7NCrypto4NZip8CEncoderE, i64 0, inrange i32 1, i64 2), ptr %76, align 8, !tbaa !16
  store ptr %call177, ptr %_filterSpec, align 8, !tbaa !89
  %call.i10611067 = invoke noundef i32 %25(ptr noundef nonnull align 8 dereferenceable(8) %call177)
          to label %call.i1061.noexc unwind label %lpad101

call.i1061.noexc:                                 ; preds = %invoke.cont179
  %78 = load ptr, ptr %Filter172, align 8, !tbaa !71
  %tobool.not.i1063 = icmp eq ptr %78, null
  br i1 %tobool.not.i1063, label %invoke.cont183, label %if.then2.i1064

if.then2.i1064:                                   ; preds = %call.i1061.noexc
  %vtable4.i1065 = load ptr, ptr %78, align 8, !tbaa !16
  %vfn5.i1066 = getelementptr inbounds ptr, ptr %vtable4.i1065, i64 2
  %79 = load ptr, ptr %vfn5.i1066, align 8
  %call6.i1069 = invoke noundef i32 %79(ptr noundef nonnull align 8 dereferenceable(8) %78)
          to label %invoke.cont183 unwind label %lpad101

invoke.cont183:                                   ; preds = %call.i1061.noexc, %if.then2.i1064
  store ptr %call177, ptr %Filter172, align 8, !tbaa !71
  %80 = load ptr, ptr %_filterSpec, align 8, !tbaa !89
  %81 = load ptr, ptr %Password, align 8, !tbaa !41
  %82 = load i32, ptr %_length.i, align 8, !tbaa !39
  %vtable194 = load ptr, ptr %80, align 8, !tbaa !16
...
if.end198:                                        ; preds = %invoke.cont183, %if.else170
  ...
  %vtable23.i = load ptr, ptr %inStream, align 8, !tbaa !16
  %vfn24.i = getelementptr inbounds ptr, ptr %vtable23.i, i64 5
  %84 = load ptr, ptr %vfn24.i, align 8
  %call25.i1076 = invoke noundef i32 %84(ptr noundef nonnull align 8 dereferenceable(8) %inStream, ptr noundef nonnull %buffer.i, i32 noundef 16384, ptr noundef nonnull %realProcessedSize.i)
          to label %call25.i.noexc unwind label %lpad200.loopexit.split-lp

call25.i.noexc:                                   ; preds = %if.end198
  %cmp.not26.i = icmp eq i32 %call25.i1076, 0
  br i1 %cmp.not26.i, label %cleanup.cont.i, label %invoke.cont201.thread

cleanup.cont.i:                                   ; preds = %call25.i.noexc, %call.i1074.noexc
  %crc.027.i = phi i32 [ %call5.i1077, %call.i1074.noexc ], [ -1, %call25.i.noexc ]
  %85 = load i32, ptr %realProcessedSize.i, align 4, !tbaa !57
...
cleanup6.i:                                       ; preds = %cleanup.cont.i
  ...
  %call5.i1077 = invoke i32 @CrcUpdate(i32 noundef %crc.027.i, ptr noundef nonnull %buffer.i, i64 noundef %conv.i)
...
call5.i.noexc:                                    ; preds = %cleanup6.i
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %realProcessedSize.i) #17
  %vtable.i1072 = load ptr, ptr %inStream, align 8, !tbaa !16
  %vfn.i1073 = getelementptr inbounds ptr, ptr %vtable.i1072, i64 5
  %86 = load ptr, ptr %vfn.i1073, align 8
  %call.i10741078 = invoke noundef i32 %86(ptr noundef nonnull align 8 dereferenceable(8) %inStream, ptr noundef nonnull %buffer.i, i32 noundef 16384, ptr noundef nonnull %realProcessedSize.i)
          to label %call.i1074.noexc unwind label %lpad200.loopexit

call.i1074.noexc:                                 ; preds = %call5.i.noexc
  %cmp.not.i = icmp eq i32 %call.i10741078, 0
  br i1 %cmp.not.i, label %cleanup.cont.i, label %invoke.cont201.thread, !llvm.loop !90

invoke.cont201.thread:                            ; preds = %call25.i.noexc, %call.i1074.noexc
  %call21.i.ph = phi i32 [ %call.i10741078, %call.i1074.noexc ], [ %call25.i1076, %call25.i.noexc ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %realProcessedSize.i) #17
...
cleanup.cont221:                                  ; preds = %invoke.cont214
  %89 = load ptr, ptr %_filterSpec, align 8, !tbaa !89
...
if.end239:                                        ; preds = %invoke.cont226, %invoke.cont161
  %retval.13 = phi i32 [ %retval.11450, %invoke.cont161 ], [ %retval.3.call75.call88, %invoke.cont226 ]
  %91 = load ptr, ptr %_cryptoStreamSpec, align 8, !tbaa !69
  %vtable242 = load ptr, ptr %91, align 8, !tbaa !16
...
cleanup.cont252:                                  ; preds = %invoke.cont245
  %94 = load ptr, ptr %_cryptoStreamSpec, align 8, !tbaa !69
  br label %if.end255

if.end255:                                        ; preds = %cleanup.cont252, %cleanup.cont94
  %outStreamReleaser.sroa.0.2 = phi ptr [ %outStreamReleaser.sroa.0.01448, %cleanup.cont94 ], [ %94, %cleanup.cont252 ]
  %retval.15 = phi i32 [ %retval.11450, %cleanup.cont94 ], [ %retval.13, %cleanup.cont252 ]
  %95 = load ptr, ptr %_items.i, align 8, !tbaa !29
  %arrayidx.i = getelementptr inbounds i8, ptr %95, i64 %indvars.iv
  %96 = load i8, ptr %arrayidx.i, align 1, !tbaa !25
  %cond831 = icmp eq i8 %96, 0
  br i1 %cond831, label %sw.bb, label %sw.default

sw.bb:                                            ; preds = %if.end255
  %97 = load ptr, ptr %_copyCoderSpec, align 8, !tbaa !91
...
invoke.cont263:                                   ; preds = %if.then262
  ...
  store ptr getelementptr inbounds ({ [9 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress10CCopyCoderE, i64 0, inrange i32 1, i64 2), ptr %98, align 8, !tbaa !16
  ...
  %call.i10821088 = invoke noundef i32 %41(ptr noundef nonnull align 8 dereferenceable(8) %call264)
          to label %call.i1082.noexc unwind label %lpad101

call.i1082.noexc:                                 ; preds = %invoke.cont263
  %100 = load ptr, ptr %_copyCoder, align 8, !tbaa !5
  %tobool.not.i1084 = icmp eq ptr %100, null
  br i1 %tobool.not.i1084, label %_ZN9CMyComPtrI14ICompressCoderEaSEPS0_.exit, label %if.then2.i1085

if.then2.i1085:                                   ; preds = %call.i1082.noexc
  %vtable4.i1086 = load ptr, ptr %100, align 8, !tbaa !16
  %vfn5.i1087 = getelementptr inbounds ptr, ptr %vtable4.i1086, i64 2
  %101 = load ptr, ptr %vfn5.i1087, align 8
  %call6.i1090 = invoke noundef i32 %101(ptr noundef nonnull align 8 dereferenceable(8) %100)
          to label %_ZN9CMyComPtrI14ICompressCoderEaSEPS0_.exit unwind label %lpad101

_ZN9CMyComPtrI14ICompressCoderEaSEPS0_.exit:      ; preds = %if.then2.i1085, %call.i1082.noexc
  store ptr %call264, ptr %_copyCoder, align 8, !tbaa !5
  br label %if.end272

if.end272:                                        ; preds = %_ZN9CMyComPtrI14ICompressCoderEaSEPS0_.exit, %sw.bb
  %102 = load i8, ptr %PasswordIsDefined97, align 4, !tbaa !58, !range !63, !noundef !64
  %tobool277.not = icmp eq i8 %102, 0
  br i1 %tobool277.not, label %if.then.i1105, label %if.then278

if.then278:                                       ; preds = %if.end272
  %103 = load ptr, ptr %_cryptoStream, align 8, !tbaa !68
  %cmp.not.i.i1091 = icmp eq ptr %103, null
  br i1 %cmp.not.i.i1091, label %if.end286, label %if.then.i.i1092

if.then.i.i1092:                                  ; preds = %if.then278
  %vtable.i.i1093 = load ptr, ptr %103, align 8, !tbaa !16
  %vfn.i.i1094 = getelementptr inbounds ptr, ptr %vtable.i.i1093, i64 1
  %104 = load ptr, ptr %vfn.i.i1094, align 8
  %call.i.i1101 = invoke noundef i32 %104(ptr noundef nonnull align 8 dereferenceable(8) %103)
          to label %if.end286 unwind label %ehcleanup308.thread

ehcleanup308.thread:                              ; preds = %if.then.i.i1092, %if.then.i1105
  %105 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup808

if.then.i1105:                                    ; preds = %if.end272
  %vtable.i1106 = load ptr, ptr %outStream, align 8, !tbaa !16
  %vfn.i1107 = getelementptr inbounds ptr, ptr %vtable.i1106, i64 1
  %106 = load ptr, ptr %vfn.i1107, align 8
  %call.i11081114 = invoke noundef i32 %106(ptr noundef nonnull align 8 dereferenceable(8) %outStream)
          to label %if.end286 unwind label %ehcleanup308.thread

if.end286:                                        ; preds = %if.then.i1105, %if.then.i.i1092, %if.then278
  %outStreamNew.sroa.0.0 = phi ptr [ null, %if.then278 ], [ %103, %if.then.i.i1092 ], [ %outStream, %if.then.i1105 ]
  %107 = load ptr, ptr %_copyCoder, align 8, !tbaa !5
  %vtable296 = load ptr, ptr %107, align 8, !tbaa !16
...
invoke.cont298:                                   ; preds = %if.end286
  ...
  %tobool.not.i1118 = icmp eq ptr %outStreamNew.sroa.0.0, null
  br i1 %tobool.not.i1118, label %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit, label %if.then.i1119

if.then.i1119:                                    ; preds = %invoke.cont298
  %vtable.i1120 = load ptr, ptr %outStreamNew.sroa.0.0, align 8, !tbaa !16
  %vfn.i1121 = getelementptr inbounds ptr, ptr %vtable.i1120, i64 2
  %109 = load ptr, ptr %vfn.i1121, align 8
  %call.i1122 = invoke noundef i32 %109(ptr noundef nonnull align 8 dereferenceable(8) %outStreamNew.sroa.0.0)
          to label %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit unwind label %terminate.lpad.i1123

terminate.lpad.i1123:                             ; preds = %if.then.i1119
...
_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit:   ; preds = %invoke.cont298, %if.then.i1119
  br i1 %cmp300.not, label %sw.epilog719, label %cleanup807

ehcleanup308:                                     ; preds = %if.end286
  %112 = landingpad { ptr, i32 }
          cleanup
  %tobool.not.i1125 = icmp eq ptr %outStreamNew.sroa.0.0, null
  br i1 %tobool.not.i1125, label %ehcleanup808, label %if.then.i1126

if.then.i1126:                                    ; preds = %ehcleanup308
  %vtable.i1127 = load ptr, ptr %outStreamNew.sroa.0.0, align 8, !tbaa !16
  %vfn.i1128 = getelementptr inbounds ptr, ptr %vtable.i1127, i64 2
  %113 = load ptr, ptr %vfn.i1128, align 8
  %call.i1129 = invoke noundef i32 %113(ptr noundef nonnull align 8 dereferenceable(8) %outStreamNew.sroa.0.0)
          to label %ehcleanup808 unwind label %terminate.lpad.i1130

terminate.lpad.i1130:                             ; preds = %if.then.i1126
...
sw.default:                                       ; preds = %if.end255
  %116 = load ptr, ptr %_compressEncoder, align 8, !tbaa !5
  %cmp.i1133 = icmp eq ptr %116, null
  br i1 %cmp.i1133, label %if.then314, label %if.end669
...
invoke.cont325:                                   ; preds = %if.then317
  ...
  %117 = load i32, ptr %NumThreads, align 8, !tbaa !93
  store i16 19, ptr %props, align 16, !tbaa !94
  store i16 0, ptr %wReserved1.i, align 2, !tbaa !96
  store i32 %117, ptr %29, align 8, !tbaa !25
  %118 = load i32, ptr %Algo405, align 8, !tbaa !97
  store i16 19, ptr %arrayinit.element, align 16, !tbaa !94
  store i16 0, ptr %wReserved1.i1147, align 2, !tbaa !96
  store i32 %118, ptr %30, align 8, !tbaa !25
  %119 = load i32, ptr %DicSize, align 4, !tbaa !98
  store i16 19, ptr %arrayinit.element332, align 16, !tbaa !94
  store i16 0, ptr %wReserved1.i1148, align 2, !tbaa !96
  store i32 %119, ptr %31, align 8, !tbaa !25
  %120 = load i32, ptr %NumFastBytes, align 8, !tbaa !99
  ...
  %121 = load ptr, ptr %MatchFinder, align 8, !tbaa !34
...
invoke.cont342:                                   ; preds = %invoke.cont325
  ...
  %123 = load i8, ptr %NumMatchFinderCyclesDefined, align 4, !tbaa !101, !range !63, !noundef !64
...
lpad328:                                          ; preds = %invoke.cont325
  %125 = landingpad { ptr, i32 }
          cleanup
  %call.i1151 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element335)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit unwind label %terminate.lpad.i1152

terminate.lpad.i1152:                             ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit.2, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit.1, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit, %lpad328
...
_ZN8NWindows4NCOM12CPropVariantD2Ev.exit:         ; preds = %lpad328
  %call.i1151.1 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element332)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit.1 unwind label %terminate.lpad.i1152

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit.1:       ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit
  %call.i1151.2 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit.2 unwind label %terminate.lpad.i1152

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit.2:       ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit.1
  %call.i1151.3 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %props)
          to label %ehcleanup382 unwind label %terminate.lpad.i1152
...
invoke.cont355:                                   ; preds = %invoke.cont342
  ...
  %call.i1153 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element343)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155 unwind label %terminate.lpad.i1154

lpad354:                                          ; preds = %invoke.cont342
  %128 = landingpad { ptr, i32 }
          cleanup
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %propIDs) #17
  %call.i1156 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element343)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158 unwind label %terminate.lpad.i1157

terminate.lpad.i1154:                             ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.4, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.3, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.2, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.1, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155, %invoke.cont355
...
_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155:     ; preds = %invoke.cont355
  %call.i1153.1 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element338)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.1 unwind label %terminate.lpad.i1154

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.1:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155
  %call.i1153.2 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element335)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.2 unwind label %terminate.lpad.i1154

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.2:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.1
  %call.i1153.3 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element332)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.3 unwind label %terminate.lpad.i1154

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.3:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.2
  %call.i1153.4 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.4 unwind label %terminate.lpad.i1154

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.4:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.3
  %call.i1153.5 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %props)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.5 unwind label %terminate.lpad.i1154

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.5:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.4
  call void @llvm.lifetime.end.p0(i64 96, ptr nonnull %props) #17
  br i1 %cmp357.not, label %if.end669, label %cleanup807

terminate.lpad.i1157:                             ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158.4, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158.3, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158.2, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158.1, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158, %lpad354
...
_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158:     ; preds = %lpad354
  %call.i1156.1 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element338)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158.1 unwind label %terminate.lpad.i1157

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158.1:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158
  %call.i1156.2 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element335)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158.2 unwind label %terminate.lpad.i1157

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158.2:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158.1
  %call.i1156.3 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element332)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158.3 unwind label %terminate.lpad.i1157

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158.3:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158.2
  %call.i1156.4 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158.4 unwind label %terminate.lpad.i1157

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158.4:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158.3
  %call.i1156.5 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %props)
          to label %ehcleanup382 unwind label %terminate.lpad.i1157

ehcleanup382:                                     ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158.4, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit.2
  %.pn977 = phi { ptr, i32 } [ %125, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit.2 ], [ %128, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1158.4 ]
  call void @llvm.lifetime.end.p0(i64 96, ptr nonnull %props) #17
  br label %ehcleanup808
...
invoke.cont396:                                   ; preds = %invoke.cont393
  %vtable.i1160 = load ptr, ptr %call394, align 8, !tbaa !16
  %vfn.i1161 = getelementptr inbounds ptr, ptr %vtable.i1160, i64 1
  %133 = load ptr, ptr %vfn.i1161, align 8
  %call.i11621168 = invoke noundef i32 %133(ptr noundef nonnull align 8 dereferenceable(8) %call394)
          to label %call.i1162.noexc unwind label %lpad392

call.i1162.noexc:                                 ; preds = %invoke.cont396
  %134 = load ptr, ptr %_compressEncoder, align 8, !tbaa !5
  %tobool.not.i1164 = icmp eq ptr %134, null
  br i1 %tobool.not.i1164, label %invoke.cont399, label %if.then2.i1165

if.then2.i1165:                                   ; preds = %call.i1162.noexc
  %vtable4.i1166 = load ptr, ptr %134, align 8, !tbaa !16
  %vfn5.i1167 = getelementptr inbounds ptr, ptr %vtable4.i1166, i64 2
  %135 = load ptr, ptr %vfn5.i1167, align 8
  %call6.i1170 = invoke noundef i32 %135(ptr noundef nonnull align 8 dereferenceable(8) %134)
          to label %invoke.cont399 unwind label %lpad392

invoke.cont399:                                   ; preds = %call.i1162.noexc, %if.then2.i1165
  store ptr %call394, ptr %_compressEncoder, align 8, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %props401) #17
  %136 = load i32, ptr %Algo405, align 8, !tbaa !97
  store i16 19, ptr %props401, align 16, !tbaa !94
  store i16 0, ptr %wReserved1.i1172, align 2, !tbaa !96
  store i32 %136, ptr %26, align 8, !tbaa !25
  %137 = load i32, ptr %MemSize, align 8, !tbaa !102
  store i16 19, ptr %arrayinit.element408, align 16, !tbaa !94
  store i16 0, ptr %wReserved1.i1173, align 2, !tbaa !96
  store i32 %137, ptr %27, align 8, !tbaa !25
  %138 = load i32, ptr %Order, align 4, !tbaa !103
  store i16 19, ptr %arrayinit.element411, align 16, !tbaa !94
  store i16 0, ptr %wReserved1.i1174, align 2, !tbaa !96
...
invoke.cont426:                                   ; preds = %invoke.cont399
  ...
  %call.i1175 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element411)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1177 unwind label %terminate.lpad.i1176

lpad392:                                          ; preds = %if.then2.i1165, %invoke.cont396, %if.then390
...
lpad425:                                          ; preds = %invoke.cont399
  %141 = landingpad { ptr, i32 }
          cleanup
  call void @llvm.lifetime.end.p0(i64 12, ptr nonnull %propIDs421) #17
  %call.i1178 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element411)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1180 unwind label %terminate.lpad.i1179

terminate.lpad.i1176:                             ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1177.1, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1177, %invoke.cont426
...
_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1177:     ; preds = %invoke.cont426
  %call.i1175.1 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element408)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1177.1 unwind label %terminate.lpad.i1176

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1177.1:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1177
  %call.i1175.2 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %props401)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1177.2 unwind label %terminate.lpad.i1176

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1177.2:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1177.1
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %props401) #17
  br i1 %cmp428.not, label %if.end669, label %cleanup807

terminate.lpad.i1179:                             ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1180.1, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1180, %lpad425
...
_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1180:     ; preds = %lpad425
  %call.i1178.1 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element408)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1180.1 unwind label %terminate.lpad.i1179

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1180.1:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1180
  %call.i1178.2 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %props401)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1180.2 unwind label %terminate.lpad.i1179

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1180.2:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1180.1
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %props401) #17
  br label %ehcleanup808
...
cleanup.cont476:                                  ; preds = %invoke.cont469
  %147 = load ptr, ptr %_compressEncoder, align 8, !tbaa !5
  %cmp.i1181 = icmp eq ptr %147, null
  br i1 %cmp.i1181, label %cleanup807, label %if.end483
...
if.then489:                                       ; preds = %if.end483
  ...
  %149 = load i32, ptr %Algo405, align 8, !tbaa !97
  store i16 19, ptr %props490, align 16, !tbaa !94
  store i16 0, ptr %wReserved1.i1182, align 2, !tbaa !96
  store i32 %149, ptr %37, align 8, !tbaa !25
  %150 = load i32, ptr %NumPasses592, align 4, !tbaa !104
  store i16 19, ptr %arrayinit.element497, align 16, !tbaa !94
  store i16 0, ptr %wReserved1.i1183, align 2, !tbaa !96
  store i32 %150, ptr %38, align 8, !tbaa !25
  %151 = load i32, ptr %NumFastBytes, align 8, !tbaa !99
  store i16 19, ptr %arrayinit.element500, align 16, !tbaa !94
  store i16 0, ptr %wReserved1.i1184, align 2, !tbaa !96
  store i32 %151, ptr %39, align 8, !tbaa !25
  %152 = load i32, ptr %NumMatchFinderCycles, align 8, !tbaa !100
  store i16 19, ptr %arrayinit.element504, align 16, !tbaa !94
  store i16 0, ptr %wReserved1.i1185, align 2, !tbaa !96
  ...
  %153 = load i8, ptr %NumMatchFinderCyclesDefined, align 4, !tbaa !101, !range !63, !noundef !64
  ...
  %vtable.i1186 = load ptr, ptr %147, align 8, !tbaa !16
  %154 = load ptr, ptr %vtable.i1186, align 8
  %call.i11871188 = invoke noundef i32 %154(ptr noundef nonnull align 8 dereferenceable(8) %147, ptr noundef nonnull align 4 dereferenceable(16) @IID_ICompressSetCoderProperties, ptr noundef nonnull %setCoderProperties)
          to label %invoke.cont529 unwind label %lpad526

invoke.cont529:                                   ; preds = %if.then489
  %155 = load ptr, ptr %setCoderProperties, align 8, !tbaa !105
  %tobool533.not = icmp eq ptr %155, null
  br i1 %tobool533.not, label %if.end552, label %if.then534

if.then534:                                       ; preds = %invoke.cont529
  %vtable541 = load ptr, ptr %155, align 8, !tbaa !16
...
cleanup553:                                       ; preds = %invoke.cont543, %if.end552
  %cond840 = phi i1 [ true, %if.end552 ], [ false, %invoke.cont543 ]
  %retval.22 = phi i32 [ %retval.15, %if.end552 ], [ %call544, %invoke.cont543 ]
  %159 = load ptr, ptr %setCoderProperties, align 8, !tbaa !105
  %tobool.not.i1189 = icmp eq ptr %159, null
  br i1 %tobool.not.i1189, label %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit, label %if.then.i1190

if.then.i1190:                                    ; preds = %cleanup553
  %vtable.i1191 = load ptr, ptr %159, align 8, !tbaa !16
  %vfn.i1192 = getelementptr inbounds ptr, ptr %vtable.i1191, i64 2
  %160 = load ptr, ptr %vfn.i1192, align 8
  %call.i1193 = invoke noundef i32 %160(ptr noundef nonnull align 8 dereferenceable(8) %159)
          to label %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit unwind label %terminate.lpad.i1194

terminate.lpad.i1194:                             ; preds = %if.then.i1190
...
_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit: ; preds = %cleanup553, %if.then.i1190
  ...
  %call.i1196 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element504)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1198 unwind label %terminate.lpad.i1197

terminate.lpad.i1197:                             ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1198.2, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1198.1, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1198, %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit
...
_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1198:     ; preds = %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit
  %call.i1196.1 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element500)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1198.1 unwind label %terminate.lpad.i1197

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1198.1:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1198
  %call.i1196.2 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element497)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1198.2 unwind label %terminate.lpad.i1197

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1198.2:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1198.1
  %call.i1196.3 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %props490)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1198.3 unwind label %terminate.lpad.i1197

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1198.3:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1198.2
...
ehcleanup554:                                     ; preds = %lpad536, %lpad526
  ...
  %165 = load ptr, ptr %setCoderProperties, align 8, !tbaa !105
  %tobool.not.i1199 = icmp eq ptr %165, null
  br i1 %tobool.not.i1199, label %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit1206, label %if.then.i1200

if.then.i1200:                                    ; preds = %ehcleanup554
  %vtable.i1201 = load ptr, ptr %165, align 8, !tbaa !16
  %vfn.i1202 = getelementptr inbounds ptr, ptr %vtable.i1201, i64 2
  %166 = load ptr, ptr %vfn.i1202, align 8
  %call.i1203 = invoke noundef i32 %166(ptr noundef nonnull align 8 dereferenceable(8) %165)
          to label %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit1206 unwind label %terminate.lpad.i1204

terminate.lpad.i1204:                             ; preds = %if.then.i1200
...
_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit1206: ; preds = %ehcleanup554, %if.then.i1200
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %setCoderProperties) #17
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %propIDs515) #17
  %call.i1207 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element504)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1209 unwind label %terminate.lpad.i1208

terminate.lpad.i1208:                             ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1209.2, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1209.1, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1209, %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit1206
...
_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1209:     ; preds = %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit1206
  %call.i1207.1 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element500)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1209.1 unwind label %terminate.lpad.i1208

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1209.1:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1209
  %call.i1207.2 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element497)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1209.2 unwind label %terminate.lpad.i1208

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1209.2:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1209.1
  %call.i1207.3 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %props490)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1209.3 unwind label %terminate.lpad.i1208

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1209.3:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1209.2
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %props490) #17
  br label %ehcleanup808
...
if.then582:                                       ; preds = %if.else579
  ...
  %171 = load i32, ptr %DicSize, align 4, !tbaa !98
  store i16 19, ptr %props583, align 16, !tbaa !94
  store i16 0, ptr %wReserved1.i1210, align 2, !tbaa !96
  store i32 %171, ptr %34, align 8, !tbaa !25
  %172 = load i32, ptr %NumPasses592, align 4, !tbaa !104
  store i16 19, ptr %arrayinit.element590, align 16, !tbaa !94
  store i16 0, ptr %wReserved1.i1211, align 2, !tbaa !96
  store i32 %172, ptr %35, align 8, !tbaa !25
  %173 = load i32, ptr %NumThreads, align 8, !tbaa !93
  store i16 19, ptr %arrayinit.element594, align 16, !tbaa !94
  store i16 0, ptr %wReserved1.i1212, align 2, !tbaa !96
  ...
  %vtable.i1213 = load ptr, ptr %147, align 8, !tbaa !16
  %174 = load ptr, ptr %vtable.i1213, align 8
  %call.i12141215 = invoke noundef i32 %174(ptr noundef nonnull align 8 dereferenceable(8) %147, ptr noundef nonnull align 4 dereferenceable(16) @IID_ICompressSetCoderProperties, ptr noundef nonnull %setCoderProperties606)
          to label %invoke.cont613 unwind label %lpad610

invoke.cont613:                                   ; preds = %if.then582
  %175 = load ptr, ptr %setCoderProperties606, align 8, !tbaa !105
  %tobool617.not = icmp eq ptr %175, null
  br i1 %tobool617.not, label %if.end636, label %if.then618

if.then618:                                       ; preds = %invoke.cont613
  %vtable625 = load ptr, ptr %175, align 8, !tbaa !16
  %vfn626 = getelementptr inbounds ptr, ptr %vtable625, i64 5
  %176 = load ptr, ptr %vfn626, align 8
  %call628 = invoke noundef i32 %176(ptr noundef nonnull align 8 dereferenceable(8) %175, ptr noundef nonnull %propIDs605, ptr noundef nonnull %props583, i32 noundef 3)
...
cleanup637:                                       ; preds = %invoke.cont627, %if.end636
  %cond838 = phi i1 [ true, %if.end636 ], [ false, %invoke.cont627 ]
  %retval.25 = phi i32 [ %retval.15, %if.end636 ], [ %call628, %invoke.cont627 ]
  %179 = load ptr, ptr %setCoderProperties606, align 8, !tbaa !105
  %tobool.not.i1217 = icmp eq ptr %179, null
  br i1 %tobool.not.i1217, label %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit1224, label %if.then.i1218

if.then.i1218:                                    ; preds = %cleanup637
  %vtable.i1219 = load ptr, ptr %179, align 8, !tbaa !16
  %vfn.i1220 = getelementptr inbounds ptr, ptr %vtable.i1219, i64 2
  %180 = load ptr, ptr %vfn.i1220, align 8
  %call.i1221 = invoke noundef i32 %180(ptr noundef nonnull align 8 dereferenceable(8) %179)
          to label %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit1224 unwind label %terminate.lpad.i1222
...
_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit1224: ; preds = %cleanup637, %if.then.i1218
  ...
  %call.i1225 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element594)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1227 unwind label %terminate.lpad.i1226

terminate.lpad.i1226:                             ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1227.1, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1227, %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit1224
...
_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1227:     ; preds = %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit1224
  %call.i1225.1 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element590)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1227.1 unwind label %terminate.lpad.i1226

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1227.1:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1227
  %call.i1225.2 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %props583)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1227.2 unwind label %terminate.lpad.i1226

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1227.2:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1227.1
...
ehcleanup638:                                     ; preds = %lpad620, %lpad610
  %.pn970 = phi { ptr, i32 } [ %178, %lpad620 ], [ %177, %lpad610 ]
  %185 = load ptr, ptr %setCoderProperties606, align 8, !tbaa !105
  %tobool.not.i1228 = icmp eq ptr %185, null
  br i1 %tobool.not.i1228, label %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit1235, label %if.then.i1229

if.then.i1229:                                    ; preds = %ehcleanup638
  %vtable.i1230 = load ptr, ptr %185, align 8, !tbaa !16
  %vfn.i1231 = getelementptr inbounds ptr, ptr %vtable.i1230, i64 2
  %186 = load ptr, ptr %vfn.i1231, align 8
  %call.i1232 = invoke noundef i32 %186(ptr noundef nonnull align 8 dereferenceable(8) %185)
          to label %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit1235 unwind label %terminate.lpad.i1233
...
_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit1235: ; preds = %ehcleanup638, %if.then.i1229
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %setCoderProperties606) #17
  call void @llvm.lifetime.end.p0(i64 12, ptr nonnull %propIDs605) #17
  %call.i1236 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element594)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1238 unwind label %terminate.lpad.i1237

terminate.lpad.i1237:                             ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1238.1, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1238, %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit1235
...
_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1238:     ; preds = %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit1235
  %call.i1236.1 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %arrayinit.element590)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1238.1 unwind label %terminate.lpad.i1237

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1238.1:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1238
  %call.i1236.2 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %props583)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1238.2 unwind label %terminate.lpad.i1237

_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1238.2:   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1238.1
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %props583) #17
  br label %ehcleanup808

if.end669:                                        ; preds = %if.else579, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1227.2, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1198.3, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.5, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1177.2, %sw.default
  %retval.28 = phi i32 [ %retval.15, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.5 ], [ %retval.15, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1177.2 ], [ %retval.15, %sw.default ], [ %retval.22, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1198.3 ], [ %retval.25, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1227.2 ], [ %retval.15, %if.else579 ]
  %191 = load i8, ptr %PasswordIsDefined97, align 4, !tbaa !58, !range !63, !noundef !64
  %tobool675.not = icmp eq i8 %191, 0
  br i1 %tobool675.not, label %if.then.i1254, label %if.then676

if.then676:                                       ; preds = %if.end669
  %192 = load ptr, ptr %_cryptoStream, align 8, !tbaa !68
  %cmp.not.i.i1239 = icmp eq ptr %192, null
  br i1 %cmp.not.i.i1239, label %if.end684, label %if.then.i.i1240

if.then.i.i1240:                                  ; preds = %if.then676
  %vtable.i.i1241 = load ptr, ptr %192, align 8, !tbaa !16
  %vfn.i.i1242 = getelementptr inbounds ptr, ptr %vtable.i.i1241, i64 1
  %193 = load ptr, ptr %vfn.i.i1242, align 8
  %call.i.i1249 = invoke noundef i32 %193(ptr noundef nonnull align 8 dereferenceable(8) %192)
          to label %if.end684 unwind label %ehcleanup715.thread

ehcleanup715.thread:                              ; preds = %if.then.i.i1240, %if.then.i1254
  %194 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup808

if.then.i1254:                                    ; preds = %if.end669
  %vtable.i1255 = load ptr, ptr %outStream, align 8, !tbaa !16
  %vfn.i1256 = getelementptr inbounds ptr, ptr %vtable.i1255, i64 1
  %195 = load ptr, ptr %vfn.i1256, align 8
  %call.i12571263 = invoke noundef i32 %195(ptr noundef nonnull align 8 dereferenceable(8) %outStream)
          to label %if.end684 unwind label %ehcleanup715.thread

if.end684:                                        ; preds = %if.then.i1254, %if.then.i.i1240, %if.then676
  %outStreamNew670.sroa.0.0 = phi ptr [ null, %if.then676 ], [ %192, %if.then.i.i1240 ], [ %outStream, %if.then.i1254 ]
  %196 = load i8, ptr %_compressExtractVersion391, align 8, !tbaa !92
  %197 = load i8, ptr %ExtractVersion1568, align 2, !tbaa !65
  %cmp689 = icmp ugt i8 %196, %197
  br i1 %cmp689, label %if.then690, label %if.end693

if.then690:                                       ; preds = %if.end684
  store i8 %196, ptr %ExtractVersion1568, align 2, !tbaa !65
  br label %if.end693

if.end693:                                        ; preds = %if.then690, %if.end684
  %198 = load ptr, ptr %_compressEncoder, align 8, !tbaa !5
  %vtable703 = load ptr, ptr %198, align 8, !tbaa !16
  %vfn704 = getelementptr inbounds ptr, ptr %vtable703, i64 5
  %199 = load ptr, ptr %vfn704, align 8
  %call706 = invoke noundef i32 %199(ptr noundef nonnull align 8 dereferenceable(8) %198, ptr noundef %inCrcStream.sroa.0.1, ptr noundef %outStreamNew670.sroa.0.0, ptr noundef null, ptr noundef null, ptr noundef %progress)
          to label %invoke.cont705 unwind label %ehcleanup715

invoke.cont705:                                   ; preds = %if.end693
  %cmp707.not = icmp eq i32 %call706, 0
  %tobool.not.i1267 = icmp eq ptr %outStreamNew670.sroa.0.0, null
  br i1 %tobool.not.i1267, label %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit1274, label %if.then.i1268

if.then.i1268:                                    ; preds = %invoke.cont705
  %vtable.i1269 = load ptr, ptr %outStreamNew670.sroa.0.0, align 8, !tbaa !16
  %vfn.i1270 = getelementptr inbounds ptr, ptr %vtable.i1269, i64 2
  %200 = load ptr, ptr %vfn.i1270, align 8
  %call.i1271 = invoke noundef i32 %200(ptr noundef nonnull align 8 dereferenceable(8) %outStreamNew670.sroa.0.0)
          to label %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit1274 unwind label %terminate.lpad.i1272

terminate.lpad.i1272:                             ; preds = %if.then.i1268
...
_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit1274: ; preds = %invoke.cont705, %if.then.i1268
  br i1 %cmp707.not, label %sw.epilog719, label %cleanup807

ehcleanup715:                                     ; preds = %if.end693
  %203 = landingpad { ptr, i32 }
          cleanup
  %tobool.not.i1275 = icmp eq ptr %outStreamNew670.sroa.0.0, null
  br i1 %tobool.not.i1275, label %ehcleanup808, label %if.then.i1276

if.then.i1276:                                    ; preds = %ehcleanup715
  %vtable.i1277 = load ptr, ptr %outStreamNew670.sroa.0.0, align 8, !tbaa !16
  %vfn.i1278 = getelementptr inbounds ptr, ptr %vtable.i1277, i64 2
  %204 = load ptr, ptr %vfn.i1278, align 8
  %call.i1279 = invoke noundef i32 %204(ptr noundef nonnull align 8 dereferenceable(8) %outStreamNew670.sroa.0.0)
          to label %ehcleanup808 unwind label %terminate.lpad.i1280

terminate.lpad.i1280:                             ; preds = %if.then.i1276
...
sw.epilog719:                                     ; preds = %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit1274
  %retval.30 = phi i32 [ %retval.15, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit ], [ %retval.28, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit1274 ]
  %vtable721 = load ptr, ptr %outStream, align 8, !tbaa !16
  %vfn722 = getelementptr inbounds ptr, ptr %vtable721, i64 6
  %207 = load ptr, ptr %vfn722, align 8
  %call725 = invoke noundef i32 %207(ptr noundef nonnull align 8 dereferenceable(8) %outStream, i64 noundef 0, i32 noundef 1, ptr noundef nonnull %PackSize)
...
cleanup.cont731:                                  ; preds = %invoke.cont724
  %storemerge1562.in = load i32, ptr %spec.select1675, align 8, !tbaa !57
  %storemerge1562 = xor i32 %storemerge1562.in, -1
  store i32 %storemerge1562, ptr %CRC, align 8, !tbaa !107
  %storemerge = load i64, ptr %spec.select1676, align 8, !tbaa !108
  store i64 %storemerge, ptr %opRes, align 8, !tbaa !109
  %209 = load i8, ptr %PasswordIsDefined97, align 4, !tbaa !58, !range !63, !noundef !64
  %tobool749.not = icmp eq i8 %209, 0
  %210 = load i64, ptr %PackSize, align 8, !tbaa !110
  br i1 %tobool749.not, label %if.else765, label %if.then750

if.then750:                                       ; preds = %cleanup.cont731
  %211 = load i8, ptr %IsAesMode, align 8, !tbaa !70, !range !63, !noundef !64
  %tobool755.not = icmp eq i8 %211, 0
  br i1 %tobool755.not, label %cond.end, label %cond.true

cond.true:                                        ; preds = %if.then750
  %212 = load ptr, ptr %_filterAesSpec, align 8, !tbaa !78
  %_key.i1289 = getelementptr inbounds %"class.NCrypto::NWzAes::CBaseCoder", ptr %212, i64 0, i32 3
  %213 = load i32, ptr %_key.i1289, align 8, !tbaa !73
  %and.i.i = shl i32 %213, 2
...
for.end:                                          ; preds = %for.end.loopexit, %if.end49
  ...
  %method.1 = phi i16 [ 0, %if.end49 ], [ %214, %for.end.loopexit ]
  %IsAesMode776 = getelementptr inbounds %"struct.NArchive::NZip::CCompressionMethodMode", ptr %this, i64 0, i32 15
  %215 = load i8, ptr %IsAesMode776, align 8, !tbaa !70, !range !63, !noundef !64
  %tobool777.not = icmp eq i8 %215, 0
...
if.then778:                                       ; preds = %for.end
  ...
  %216 = load ptr, ptr %_filterAesSpec780, align 8, !tbaa !78
  %call783 = invoke noundef i32 @_ZN7NCrypto6NWzAes8CEncoder11WriteFooterEP20ISequentialOutStream(ptr noundef nonnull align 8 dereferenceable(592) %216, ptr noundef %outStream)
...
cleanup.cont789:                                  ; preds = %invoke.cont782
  ...
  %218 = load ptr, ptr %vfn794, align 8
  %call797 = invoke noundef i32 %218(ptr noundef nonnull align 8 dereferenceable(8) %outStream, i64 noundef 0, i32 noundef 1, ptr noundef nonnull %PackSize792)
...
cleanup807:                                       ; preds = %cleanup.cont476, %invoke.cont469, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1227.2, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1198.3, %invoke.cont214, %invoke.cont226, %invoke.cont60, %invoke.cont74, %invoke.cont87, %invoke.cont148, %invoke.cont161, %invoke.cont245, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1177.2, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.5, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit1274, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit, %invoke.cont724, %invoke.cont201.thread, %invoke.cont796, %invoke.cont782, %if.end805
  %outStreamReleaser.sroa.0.31355 = phi ptr [ %outStreamReleaser.sroa.0.3, %if.end805 ], [ %outStreamReleaser.sroa.0.3, %invoke.cont796 ], [ %outStreamReleaser.sroa.0.3, %invoke.cont782 ], [ %outStreamReleaser.sroa.0.01448, %invoke.cont201.thread ], [ %outStreamReleaser.sroa.0.01448, %invoke.cont60 ], [ %outStreamReleaser.sroa.0.01448, %invoke.cont74 ], [ %outStreamReleaser.sroa.0.01448, %invoke.cont87 ], [ %outStreamReleaser.sroa.0.01448, %invoke.cont148 ], [ %outStreamReleaser.sroa.0.01448, %invoke.cont161 ], [ %outStreamReleaser.sroa.0.01448, %invoke.cont245 ], [ %outStreamReleaser.sroa.0.2, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.5 ], [ %outStreamReleaser.sroa.0.2, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1177.2 ], [ %outStreamReleaser.sroa.0.2, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit1274 ], [ %outStreamReleaser.sroa.0.2, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit ], [ %outStreamReleaser.sroa.0.2, %invoke.cont724 ], [ %outStreamReleaser.sroa.0.01448, %invoke.cont226 ], [ %outStreamReleaser.sroa.0.01448, %invoke.cont214 ], [ %outStreamReleaser.sroa.0.2, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1198.3 ], [ %outStreamReleaser.sroa.0.2, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1227.2 ], [ %outStreamReleaser.sroa.0.2, %invoke.cont469 ], [ %outStreamReleaser.sroa.0.2, %cleanup.cont476 ]
  %retval.35 = phi i32 [ 0, %if.end805 ], [ %call797, %invoke.cont796 ], [ %call783, %invoke.cont782 ], [ %call21.i.ph, %invoke.cont201.thread ], [ %call61, %invoke.cont60 ], [ %call75, %invoke.cont74 ], [ %call88, %invoke.cont87 ], [ %call149, %invoke.cont148 ], [ %call162, %invoke.cont161 ], [ %call246, %invoke.cont245 ], [ %call356, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1155.5 ], [ %call427, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1177.2 ], [ %call706, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit1274 ], [ %call299, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit ], [ %call725, %invoke.cont724 ], [ %call227, %invoke.cont226 ], [ %call215, %invoke.cont214 ], [ %retval.22, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1198.3 ], [ %retval.25, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1227.2 ], [ %call470, %invoke.cont469 ], [ -2147467263, %cleanup.cont476 ]
  %tobool.not.i1290 = icmp eq ptr %outStreamReleaser.sroa.0.31355, null
  br i1 %tobool.not.i1290, label %cleanup815, label %if.then.i1291

if.then.i1291:                                    ; preds = %cleanup807
  %vtable.i1292 = load ptr, ptr %outStreamReleaser.sroa.0.31355, align 8, !tbaa !16
  %vfn.i1293 = getelementptr inbounds ptr, ptr %vtable.i1292, i64 10
  %220 = load ptr, ptr %vfn.i1293, align 8
  %call.i1294 = invoke noundef i32 %220(ptr noundef nonnull align 8 dereferenceable(200) %outStreamReleaser.sroa.0.31355)
          to label %cleanup815 unwind label %terminate.lpad.i1295

terminate.lpad.i1295:                             ; preds = %if.then.i1291
...
ehcleanup808:                                     ; preds = %lpad200.loopexit, %lpad200.loopexit.split-lp, %if.then.i1276, %ehcleanup715, %ehcleanup715.thread, %if.then.i1126, %ehcleanup308, %ehcleanup308.thread, %lpad213, %lpad225, %lpad59, %lpad73, %lpad86, %lpad101, %lpad107, %lpad125.body, %lpad139, %lpad160, %lpad244, %lpad723, %ehcleanup382, %lpad318, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1180.2, %lpad395, %lpad392, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1238.2, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1209.3, %lpad468, %lpad795, %lpad781
  %outStreamReleaser.sroa.0.4 = phi ptr [ %outStreamReleaser.sroa.0.3, %lpad795 ], [ %outStreamReleaser.sroa.0.3, %lpad781 ], [ %outStreamReleaser.sroa.0.2, %lpad723 ], [ %outStreamReleaser.sroa.0.1, %lpad101 ], [ %outStreamReleaser.sroa.0.2, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1209.3 ], [ %outStreamReleaser.sroa.0.2, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1238.2 ], [ %outStreamReleaser.sroa.0.2, %lpad468 ], [ %outStreamReleaser.sroa.0.2, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1180.2 ], [ %outStreamReleaser.sroa.0.2, %lpad392 ], [ %outStreamReleaser.sroa.0.2, %lpad395 ], [ %outStreamReleaser.sroa.0.2, %ehcleanup382 ], [ %outStreamReleaser.sroa.0.2, %lpad318 ], [ %outStreamReleaser.sroa.0.01448, %lpad244 ], [ %outStreamReleaser.sroa.0.01448, %lpad160 ], [ %outStreamReleaser.sroa.0.01448, %lpad139 ], [ %outStreamReleaser.sroa.0.01448, %lpad125.body ], [ %outStreamReleaser.sroa.0.01448, %lpad107 ], [ %outStreamReleaser.sroa.0.01448, %lpad86 ], [ %outStreamReleaser.sroa.0.01448, %lpad73 ], [ %outStreamReleaser.sroa.0.01448, %lpad59 ], [ %outStreamReleaser.sroa.0.01448, %lpad225 ], [ %outStreamReleaser.sroa.0.01448, %lpad213 ], [ %outStreamReleaser.sroa.0.2, %ehcleanup308.thread ], [ %outStreamReleaser.sroa.0.2, %ehcleanup308 ], [ %outStreamReleaser.sroa.0.2, %if.then.i1126 ], [ %outStreamReleaser.sroa.0.2, %ehcleanup715.thread ], [ %outStreamReleaser.sroa.0.2, %ehcleanup715 ], [ %outStreamReleaser.sroa.0.2, %if.then.i1276 ], [ %outStreamReleaser.sroa.0.01448, %lpad200.loopexit ], [ %outStreamReleaser.sroa.0.01448, %lpad200.loopexit.split-lp ]
  %.pn986 = phi { ptr, i32 } [ %219, %lpad795 ], [ %217, %lpad781 ], [ %208, %lpad723 ], [ %53, %lpad101 ], [ %.pn972, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1209.3 ], [ %.pn970, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1238.2 ], [ %146, %lpad468 ], [ %141, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1180.2 ], [ %139, %lpad392 ], [ %140, %lpad395 ], [ %.pn977, %ehcleanup382 ], [ %124, %lpad318 ], [ %93, %lpad244 ], [ %73, %lpad160 ], [ %71, %lpad139 ], [ %60, %lpad125.body ], [ %54, %lpad107 ], [ %47, %lpad86 ], [ %45, %lpad73 ], [ %43, %lpad59 ], [ %90, %lpad225 ], [ %88, %lpad213 ], [ %105, %ehcleanup308.thread ], [ %112, %ehcleanup308 ], [ %112, %if.then.i1126 ], [ %194, %ehcleanup715.thread ], [ %203, %ehcleanup715 ], [ %203, %if.then.i1276 ], [ %lpad.loopexit, %lpad200.loopexit ], [ %lpad.loopexit.split-lp, %lpad200.loopexit.split-lp ]
  %tobool.not.i1297 = icmp eq ptr %outStreamReleaser.sroa.0.4, null
  br i1 %tobool.not.i1297, label %ehcleanup816, label %if.then.i1298

if.then.i1298:                                    ; preds = %ehcleanup808
  %vtable.i1299 = load ptr, ptr %outStreamReleaser.sroa.0.4, align 8, !tbaa !16
  %vfn.i1300 = getelementptr inbounds ptr, ptr %vtable.i1299, i64 10
  %223 = load ptr, ptr %vfn.i1300, align 8
  %call.i1301 = invoke noundef i32 %223(ptr noundef nonnull align 8 dereferenceable(200) %outStreamReleaser.sroa.0.4)
          to label %ehcleanup816 unwind label %terminate.lpad.i1302

terminate.lpad.i1302:                             ; preds = %if.then.i1298
...
cleanup815:                                       ; preds = %lor.lhs.false, %if.then.i1291, %cleanup807, %if.then42, %_ZN9CMyComPtrI9IInStreamED2Ev.exit
  %retval.37 = phi i32 [ %call5, %_ZN9CMyComPtrI9IInStreamED2Ev.exit ], [ -2147467263, %if.then42 ], [ %retval.35, %cleanup807 ], [ %retval.35, %if.then.i1291 ], [ -2147467263, %lor.lhs.false ]
  %tobool.not.i1305 = icmp eq ptr %inCrcStream.sroa.0.1, null
  br i1 %tobool.not.i1305, label %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit, label %if.then.i1306

if.then.i1306:                                    ; preds = %cleanup815
  %vtable.i1307 = load ptr, ptr %inCrcStream.sroa.0.1, align 8, !tbaa !16
  %vfn.i1308 = getelementptr inbounds ptr, ptr %vtable.i1307, i64 2
  %226 = load ptr, ptr %vfn.i1308, align 8
  %call.i1309 = invoke noundef i32 %226(ptr noundef nonnull align 8 dereferenceable(8) %inCrcStream.sroa.0.1)
          to label %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit unwind label %terminate.lpad.i1310

terminate.lpad.i1310:                             ; preds = %if.then.i1306
...
_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit:    ; preds = %cleanup815, %if.then.i1306
  ret i32 %retval.37

ehcleanup816:                                     ; preds = %if.then.i1298, %ehcleanup808, %_ZN9CMyComPtrI9IInStreamED2Ev.exit1033
  %inCrcStream.sroa.0.3 = phi ptr [ %inCrcStream.sroa.0.2, %_ZN9CMyComPtrI9IInStreamED2Ev.exit1033 ], [ %inCrcStream.sroa.0.1, %ehcleanup808 ], [ %inCrcStream.sroa.0.1, %if.then.i1298 ]
  %.pn986.pn = phi { ptr, i32 } [ %.pn, %_ZN9CMyComPtrI9IInStreamED2Ev.exit1033 ], [ %.pn986, %ehcleanup808 ], [ %.pn986, %if.then.i1298 ]
  %tobool.not.i1312 = icmp eq ptr %inCrcStream.sroa.0.3, null
  br i1 %tobool.not.i1312, label %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit1319, label %if.then.i1313

if.then.i1313:                                    ; preds = %ehcleanup816
  %vtable.i1314 = load ptr, ptr %inCrcStream.sroa.0.3, align 8, !tbaa !16
  %vfn.i1315 = getelementptr inbounds ptr, ptr %vtable.i1314, i64 2
  %229 = load ptr, ptr %vfn.i1315, align 8
  %call.i1316 = invoke noundef i32 %229(ptr noundef nonnull align 8 dereferenceable(8) %inCrcStream.sroa.0.3)
          to label %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit1319 unwind label %terminate.lpad.i1317
...
_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit1319: ; preds = %ehcleanup816, %if.then.i1313
