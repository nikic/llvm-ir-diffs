; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Archive/DeflateProps.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Archive/DeflateProps.cpp"
...
if.then16:                                        ; preds = %if.end14
  ...
  store i32 %cond23, ptr %Fb, align 4
  br label %if.end25
...
if.then3.i:                                       ; preds = %entry
  ...
  store i32 %cond.i, ptr %Algo.i, align 4
  br label %if.end6.i
...
if.end6.i:                                        ; preds = %if.then3.i, %entry
  ...
  %3 = load i32, ptr %NumPasses.i, align 4
...
if.then8.i:                                       ; preds = %if.end6.i
  ...
  store i32 %cond12.i, ptr %NumPasses.i, align 4
  br label %if.end14.i
...
if.then16.i:                                      ; preds = %if.end14.i
  ...
  store i32 %cond23.i, ptr %Fb.i, align 4
...
_ZN8NArchive13CDeflateProps9NormalizeEv.exit:     ; preds = %if.end14.i, %if.then16.i
  ...
  store i16 0, ptr %wReserved1.i24, align 2
  ...
  %10 = load i32, ptr %Mc, align 4
  store i16 19, ptr %arrayinit.element5, align 16
  %wReserved1.i26 = getelementptr inbounds %"class.NWindows::NCOM::CPropVariant", ptr %props, i64 3, i32 0, i32 1
  store i16 0, ptr %wReserved1.i26, align 2
  ...
  %12 = load i8, ptr %McDefined, align 4
  %tobool.not = icmp eq i8 %12, 0
  %spec.select = select i1 %tobool.not, i32 3, i32 4
  %vtable = load ptr, ptr %setCoderProperties, align 8
...
entry:
  ...
  store i8 0, ptr %McDefined.i, align 4
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %_capacity.i32.i414 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp128, i64 0, i32 2
  %_length17.i427 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp128, i64 0, i32 1
  %Mc = getelementptr inbounds %"class.NArchive::CDeflateProps", ptr %this, i64 0, i32 4
  %_capacity.i32.i384 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp97, i64 0, i32 2
  %_length17.i397 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp97, i64 0, i32 1
  %Fb = getelementptr inbounds %"class.NArchive::CDeflateProps", ptr %this, i64 0, i32 2
  %_capacity.i32.i354 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp66, i64 0, i32 2
  %_length17.i367 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp66, i64 0, i32 1
  %NumPasses = getelementptr inbounds %"class.NArchive::CDeflateProps", ptr %this, i64 0, i32 1
  %_capacity.i32.i324 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp35, i64 0, i32 2
  %_length17.i337 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp35, i64 0, i32 1
  %Algo = getelementptr inbounds %"class.NArchive::CDeflateProps", ptr %this, i64 0, i32 3
...
for.cond:                                         ; preds = %_ZN11CStringBaseIwED2Ev.exit307
  ...
  br i1 %exitcond462.not, label %cleanup161, label %for.body
...
if.then10:                                        ; preds = %if.end
  ...
  %call.i.i33.i318 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #13
          to label %call.i.i33.i.noexc unwind label %lpad11

call.i.i33.i.noexc:                               ; preds = %if.then10
  store ptr %call.i.i33.i318, ptr %ref.tmp, align 8
  store i32 0, ptr %call.i.i33.i318, align 4
...
if.end.i.i:                                       ; preds = %call.i.i33.i.noexc
  ...
  %call.i36.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %14) #13
          to label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i317 unwind label %_ZN11CStringBaseIwED2Ev.exit.i

_ZN11CStringBaseIwE11SetCapacityEi.exit.i317:     ; preds = %if.end.i.i
  call void @_ZdaPv(ptr noundef nonnull %call.i.i33.i318) #14
...
for.body.lr.ph.i:                                 ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i317.for.body.lr.ph.i_crit_edge, %call.i.i33.i.noexc
  %15 = phi ptr [ %.pre, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i317.for.body.lr.ph.i_crit_edge ], [ %10, %call.i.i33.i.noexc ]
  %16 = phi ptr [ %call.i36.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i317.for.body.lr.ph.i_crit_edge ], [ %call.i.i33.i318, %call.i.i33.i.noexc ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load473 = load <4 x i32>, ptr %24, align 4
  ...
  store <4 x i32> %wide.load473, ptr %26, align 4
...
for.body.i.prol:                                  ; preds = %for.body.i.preheader, %for.body.i.prol
  ...
  br i1 %prol.iter550.cmp.not, label %for.body.i.prol.loopexit, label %for.body.i.prol
...
for.body.i:                                       ; preds = %for.body.i.prol.loopexit, %for.body.i
  ...
  br i1 %exitcond460.not.3, label %invoke.cont12, label %for.body.i
...
invoke.cont28:                                    ; preds = %invoke.cont26
  ...
  %49 = load ptr, ptr %ref.tmp24, align 8
...
if.then32:                                        ; preds = %_ZN11CStringBaseIwED2Ev.exit232
  ...
  store i32 1, ptr %a33, align 4
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp35) #11
  %50 = load i32, ptr %_length.i, align 8
  %sub.i234 = add i32 %50, -1
  call void @llvm.experimental.noalias.scope.decl(metadata !47)
  %call.i.i33.i346 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #13
          to label %call.i.i33.i.noexc345 unwind label %lpad36

call.i.i33.i.noexc345:                            ; preds = %if.then32
  store ptr %call.i.i33.i346, ptr %ref.tmp35, align 8
  store i32 0, ptr %call.i.i33.i346, align 4
  store i32 4, ptr %_capacity.i32.i324, align 4
  %cmp.i.i326 = icmp eq i32 %50, 4
  br i1 %cmp.i.i326, label %for.body.lr.ph.i338, label %if.end.i.i327

if.end.i.i327:                                    ; preds = %call.i.i33.i.noexc345
  %conv.i.i328 = zext i32 %50 to i64
  %51 = icmp slt i32 %50, 0
  %52 = shl nuw nsw i64 %conv.i.i328, 2
  %53 = select i1 %51, i64 -1, i64 %52
  %call.i36.i329 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %53) #13
          to label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i331 unwind label %_ZN11CStringBaseIwED2Ev.exit.i330

_ZN11CStringBaseIwE11SetCapacityEi.exit.i331:     ; preds = %if.end.i.i327
  call void @_ZdaPv(ptr noundef nonnull %call.i.i33.i346) #14
  store ptr %call.i36.i329, ptr %ref.tmp35, align 8
  store i32 0, ptr %call.i36.i329, align 4
  store i32 %50, ptr %_capacity.i32.i324, align 4
  %cmp939.i332 = icmp sgt i32 %50, 1
  br i1 %cmp939.i332, label %for.body.lr.ph.i338, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i333
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i333: ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i331
  %.pre.i334 = sext i32 %sub.i234 to i64
  br label %invoke.cont37

for.body.lr.ph.i338:                              ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i331, %call.i.i33.i.noexc345
  %54 = phi ptr [ %call.i36.i329, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i331 ], [ %call.i.i33.i346, %call.i.i33.i.noexc345 ]
  %55 = load ptr, ptr %name, align 8
  %56 = zext i32 %sub.i234 to i64
  %min.iters.check478 = icmp ult i32 %sub.i234, 8
  br i1 %min.iters.check478, label %for.body.i339.preheader, label %vector.memcheck474

vector.memcheck474:                               ; preds = %for.body.lr.ph.i338
  %57 = ptrtoint ptr %55 to i64
  %58 = ptrtoint ptr %54 to i64
  %59 = add nuw i64 %57, 4
  %60 = sub i64 %58, %59
  %diff.check475 = icmp ult i64 %60, 32
  br i1 %diff.check475, label %for.body.i339.preheader, label %vector.ph479
...
vector.body484:                                   ; preds = %vector.body484, %vector.ph479
  ...
  %wide.load486 = load <4 x i32>, ptr %62, align 4
  %63 = getelementptr inbounds i32, ptr %62, i64 4
  %wide.load487 = load <4 x i32>, ptr %63, align 4
  %64 = getelementptr inbounds i32, ptr %54, i64 %index485
  store <4 x i32> %wide.load486, ptr %64, align 4
  %65 = getelementptr inbounds i32, ptr %64, i64 4
  store <4 x i32> %wide.load487, ptr %65, align 4
  %index.next488 = add nuw i64 %index485, 8
  %66 = icmp eq i64 %index.next488, %n.vec481
  br i1 %66, label %middle.block476, label %vector.body484

middle.block476:                                  ; preds = %vector.body484
  %cmp.n483 = icmp eq i64 %n.vec481, %56
  br i1 %cmp.n483, label %invoke.cont37, label %for.body.i339.preheader

for.body.i339.preheader:                          ; preds = %vector.memcheck474, %for.body.lr.ph.i338, %middle.block476
  %indvars.iv.i340.ph = phi i64 [ 0, %vector.memcheck474 ], [ 0, %for.body.lr.ph.i338 ], [ %n.vec481, %middle.block476 ]
  %67 = xor i64 %indvars.iv.i340.ph, -1
  %68 = add nsw i64 %67, %56
  %xtraiter545 = and i64 %56, 3
  %lcmp.mod546.not = icmp eq i64 %xtraiter545, 0
  br i1 %lcmp.mod546.not, label %for.body.i339.prol.loopexit, label %for.body.i339.prol

for.body.i339.prol:                               ; preds = %for.body.i339.preheader, %for.body.i339.prol
  %indvars.iv.i340.prol = phi i64 [ %69, %for.body.i339.prol ], [ %indvars.iv.i340.ph, %for.body.i339.preheader ]
  %prol.iter547 = phi i64 [ %prol.iter547.next, %for.body.i339.prol ], [ 0, %for.body.i339.preheader ]
  %69 = add nuw nsw i64 %indvars.iv.i340.prol, 1
  %arrayidx.i341.prol = getelementptr inbounds i32, ptr %55, i64 %69
  %70 = load i32, ptr %arrayidx.i341.prol, align 4
  %arrayidx13.i342.prol = getelementptr inbounds i32, ptr %54, i64 %indvars.iv.i340.prol
  store i32 %70, ptr %arrayidx13.i342.prol, align 4
  %prol.iter547.next = add i64 %prol.iter547, 1
  %prol.iter547.cmp.not = icmp eq i64 %prol.iter547.next, %xtraiter545
  br i1 %prol.iter547.cmp.not, label %for.body.i339.prol.loopexit, label %for.body.i339.prol

for.body.i339.prol.loopexit:                      ; preds = %for.body.i339.prol, %for.body.i339.preheader
  %indvars.iv.i340.unr = phi i64 [ %indvars.iv.i340.ph, %for.body.i339.preheader ], [ %69, %for.body.i339.prol ]
  %71 = icmp ult i64 %68, 3
  br i1 %71, label %invoke.cont37, label %for.body.i339

_ZN11CStringBaseIwED2Ev.exit.i330:                ; preds = %if.end.i.i327
  %72 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdaPv(ptr noundef nonnull %call.i.i33.i346) #14
  br label %ehcleanup42

for.body.i339:                                    ; preds = %for.body.i339.prol.loopexit, %for.body.i339
  %indvars.iv.i340 = phi i64 [ %79, %for.body.i339 ], [ %indvars.iv.i340.unr, %for.body.i339.prol.loopexit ]
  %73 = add nuw nsw i64 %indvars.iv.i340, 1
  %arrayidx.i341 = getelementptr inbounds i32, ptr %55, i64 %73
  %74 = load i32, ptr %arrayidx.i341, align 4
  %arrayidx13.i342 = getelementptr inbounds i32, ptr %54, i64 %indvars.iv.i340
  store i32 %74, ptr %arrayidx13.i342, align 4
  %75 = add nuw nsw i64 %indvars.iv.i340, 2
  %arrayidx.i341.1 = getelementptr inbounds i32, ptr %55, i64 %75
  %76 = load i32, ptr %arrayidx.i341.1, align 4
  %arrayidx13.i342.1 = getelementptr inbounds i32, ptr %54, i64 %73
  store i32 %76, ptr %arrayidx13.i342.1, align 4
  %77 = add nuw nsw i64 %indvars.iv.i340, 3
  %arrayidx.i341.2 = getelementptr inbounds i32, ptr %55, i64 %77
  %78 = load i32, ptr %arrayidx.i341.2, align 4
  %arrayidx13.i342.2 = getelementptr inbounds i32, ptr %54, i64 %75
  store i32 %78, ptr %arrayidx13.i342.2, align 4
  %79 = add nuw nsw i64 %indvars.iv.i340, 4
  %arrayidx.i341.3 = getelementptr inbounds i32, ptr %55, i64 %79
  %80 = load i32, ptr %arrayidx.i341.3, align 4
  %arrayidx13.i342.3 = getelementptr inbounds i32, ptr %54, i64 %77
  store i32 %80, ptr %arrayidx13.i342.3, align 4
  %exitcond458.not.3 = icmp eq i64 %79, %56
  br i1 %exitcond458.not.3, label %invoke.cont37, label %for.body.i339

invoke.cont37:                                    ; preds = %for.body.i339.prol.loopexit, %for.body.i339, %middle.block476, %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i333
  %81 = phi ptr [ %call.i36.i329, %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i333 ], [ %54, %middle.block476 ], [ %54, %for.body.i339 ], [ %54, %for.body.i339.prol.loopexit ]
  %idxprom15.pre-phi.i335 = phi i64 [ %.pre.i334, %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i333 ], [ %56, %middle.block476 ], [ %56, %for.body.i339 ], [ %56, %for.body.i339.prol.loopexit ]
  %arrayidx16.i336 = getelementptr inbounds i32, ptr %81, i64 %idxprom15.pre-phi.i335
  store i32 0, ptr %arrayidx16.i336, align 4
  store i32 %sub.i234, ptr %_length17.i337, align 8
...
invoke.cont39:                                    ; preds = %invoke.cont37
  %82 = load ptr, ptr %ref.tmp35, align 8
...
lpad27:                                           ; preds = %invoke.cont26
  %84 = landingpad { ptr, i32 }
          cleanup
  %85 = load ptr, ptr %ref.tmp24, align 8
...
lpad38:                                           ; preds = %invoke.cont37
  %87 = landingpad { ptr, i32 }
          cleanup
  %88 = load ptr, ptr %ref.tmp35, align 8
...
ehcleanup42:                                      ; preds = %delete.notnull.i243, %lpad38, %lpad36, %_ZN11CStringBaseIwED2Ev.exit.i330
  %.pn211 = phi { ptr, i32 } [ %86, %lpad36 ], [ %72, %_ZN11CStringBaseIwED2Ev.exit.i330 ], [ %87, %lpad38 ], [ %87, %delete.notnull.i243 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp35) #11
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %a33) #11
  br label %ehcleanup156

cleanup.cont48:                                   ; preds = %_ZN11CStringBaseIwED2Ev.exit238
  %89 = load i32, ptr %a33, align 4
  store i32 %89, ptr %Algo, align 4
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %a33) #11
  br label %cleanup155
...
invoke.cont57:                                    ; preds = %if.else54
  %90 = load ptr, ptr %ref.tmp55, align 8
...
invoke.cont59:                                    ; preds = %invoke.cont57
  ...
  %91 = load ptr, ptr %ref.tmp55, align 8
...
if.then63:                                        ; preds = %_ZN11CStringBaseIwED2Ev.exit252
  ...
  store i32 10, ptr %a64, align 4
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp66) #11
  %92 = load i32, ptr %_length.i, align 8
  %sub.i254 = add i32 %92, -4
  call void @llvm.experimental.noalias.scope.decl(metadata !53)
  %call.i.i33.i376 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #13
          to label %call.i.i33.i.noexc375 unwind label %lpad67

call.i.i33.i.noexc375:                            ; preds = %if.then63
  store ptr %call.i.i33.i376, ptr %ref.tmp66, align 8
  store i32 0, ptr %call.i.i33.i376, align 4
  store i32 4, ptr %_capacity.i32.i354, align 4
  %add.i.i355 = add nsw i32 %92, -3
  %cmp.i.i356 = icmp eq i32 %add.i.i355, 4
  br i1 %cmp.i.i356, label %for.body.lr.ph.i368, label %if.end.i.i357

if.end.i.i357:                                    ; preds = %call.i.i33.i.noexc375
  %conv.i.i358 = zext i32 %add.i.i355 to i64
  %93 = icmp slt i32 %92, 3
  %94 = shl nuw nsw i64 %conv.i.i358, 2
  %95 = select i1 %93, i64 -1, i64 %94
  %call.i36.i359 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %95) #13
          to label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i361 unwind label %_ZN11CStringBaseIwED2Ev.exit.i360

_ZN11CStringBaseIwE11SetCapacityEi.exit.i361:     ; preds = %if.end.i.i357
  call void @_ZdaPv(ptr noundef nonnull %call.i.i33.i376) #14
  store ptr %call.i36.i359, ptr %ref.tmp66, align 8
  store i32 0, ptr %call.i36.i359, align 4
  store i32 %add.i.i355, ptr %_capacity.i32.i354, align 4
  %cmp939.i362 = icmp sgt i32 %92, 4
  br i1 %cmp939.i362, label %for.body.lr.ph.i368, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i363
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i363: ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i361
  %.pre.i364 = sext i32 %sub.i254 to i64
  br label %invoke.cont68

for.body.lr.ph.i368:                              ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i361, %call.i.i33.i.noexc375
  %96 = phi ptr [ %call.i36.i359, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i361 ], [ %call.i.i33.i376, %call.i.i33.i.noexc375 ]
  %97 = load ptr, ptr %name, align 8
  %98 = zext i32 %sub.i254 to i64
  %min.iters.check493 = icmp ult i32 %sub.i254, 8
  br i1 %min.iters.check493, label %for.body.i369.preheader, label %vector.memcheck489

vector.memcheck489:                               ; preds = %for.body.lr.ph.i368
  %99 = ptrtoint ptr %97 to i64
  %100 = ptrtoint ptr %96 to i64
  %101 = add nuw i64 %99, 16
  %102 = sub i64 %100, %101
  %diff.check490 = icmp ult i64 %102, 32
  br i1 %diff.check490, label %for.body.i369.preheader, label %vector.ph494
...
vector.body499:                                   ; preds = %vector.body499, %vector.ph494
  ...
  %wide.load501 = load <4 x i32>, ptr %104, align 4
  %105 = getelementptr inbounds i32, ptr %104, i64 4
  %wide.load502 = load <4 x i32>, ptr %105, align 4
  %106 = getelementptr inbounds i32, ptr %96, i64 %index500
  store <4 x i32> %wide.load501, ptr %106, align 4
  %107 = getelementptr inbounds i32, ptr %106, i64 4
  store <4 x i32> %wide.load502, ptr %107, align 4
  %index.next503 = add nuw i64 %index500, 8
  %108 = icmp eq i64 %index.next503, %n.vec496
  br i1 %108, label %middle.block491, label %vector.body499

middle.block491:                                  ; preds = %vector.body499
  %cmp.n498 = icmp eq i64 %n.vec496, %98
  br i1 %cmp.n498, label %invoke.cont68, label %for.body.i369.preheader

for.body.i369.preheader:                          ; preds = %vector.memcheck489, %for.body.lr.ph.i368, %middle.block491
  %indvars.iv.i370.ph = phi i64 [ 0, %vector.memcheck489 ], [ 0, %for.body.lr.ph.i368 ], [ %n.vec496, %middle.block491 ]
  %109 = xor i64 %indvars.iv.i370.ph, -1
  %110 = add nsw i64 %109, %98
  %xtraiter542 = and i64 %98, 3
  %lcmp.mod543.not = icmp eq i64 %xtraiter542, 0
  br i1 %lcmp.mod543.not, label %for.body.i369.prol.loopexit, label %for.body.i369.prol

for.body.i369.prol:                               ; preds = %for.body.i369.preheader, %for.body.i369.prol
  %indvars.iv.i370.prol = phi i64 [ %indvars.iv.next.i373.prol, %for.body.i369.prol ], [ %indvars.iv.i370.ph, %for.body.i369.preheader ]
  %prol.iter544 = phi i64 [ %prol.iter544.next, %for.body.i369.prol ], [ 0, %for.body.i369.preheader ]
  %111 = add nuw nsw i64 %indvars.iv.i370.prol, 4
  %arrayidx.i371.prol = getelementptr inbounds i32, ptr %97, i64 %111
  %112 = load i32, ptr %arrayidx.i371.prol, align 4
  %arrayidx13.i372.prol = getelementptr inbounds i32, ptr %96, i64 %indvars.iv.i370.prol
  store i32 %112, ptr %arrayidx13.i372.prol, align 4
  %indvars.iv.next.i373.prol = add nuw nsw i64 %indvars.iv.i370.prol, 1
  %prol.iter544.next = add i64 %prol.iter544, 1
  %prol.iter544.cmp.not = icmp eq i64 %prol.iter544.next, %xtraiter542
  br i1 %prol.iter544.cmp.not, label %for.body.i369.prol.loopexit, label %for.body.i369.prol

for.body.i369.prol.loopexit:                      ; preds = %for.body.i369.prol, %for.body.i369.preheader
  %indvars.iv.i370.unr = phi i64 [ %indvars.iv.i370.ph, %for.body.i369.preheader ], [ %indvars.iv.next.i373.prol, %for.body.i369.prol ]
  %113 = icmp ult i64 %110, 3
  br i1 %113, label %invoke.cont68, label %for.body.i369

_ZN11CStringBaseIwED2Ev.exit.i360:                ; preds = %if.end.i.i357
  %114 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdaPv(ptr noundef nonnull %call.i.i33.i376) #14
  br label %ehcleanup73

for.body.i369:                                    ; preds = %for.body.i369.prol.loopexit, %for.body.i369
  %indvars.iv.i370 = phi i64 [ %indvars.iv.next.i373.3, %for.body.i369 ], [ %indvars.iv.i370.unr, %for.body.i369.prol.loopexit ]
  %115 = add nuw nsw i64 %indvars.iv.i370, 4
  %arrayidx.i371 = getelementptr inbounds i32, ptr %97, i64 %115
  %116 = load i32, ptr %arrayidx.i371, align 4
  %arrayidx13.i372 = getelementptr inbounds i32, ptr %96, i64 %indvars.iv.i370
  store i32 %116, ptr %arrayidx13.i372, align 4
  %indvars.iv.next.i373 = add nuw nsw i64 %indvars.iv.i370, 1
  %117 = add nuw nsw i64 %indvars.iv.i370, 5
  %arrayidx.i371.1 = getelementptr inbounds i32, ptr %97, i64 %117
  %118 = load i32, ptr %arrayidx.i371.1, align 4
  %arrayidx13.i372.1 = getelementptr inbounds i32, ptr %96, i64 %indvars.iv.next.i373
  store i32 %118, ptr %arrayidx13.i372.1, align 4
  %indvars.iv.next.i373.1 = add nuw nsw i64 %indvars.iv.i370, 2
  %119 = add nuw nsw i64 %indvars.iv.i370, 6
  %arrayidx.i371.2 = getelementptr inbounds i32, ptr %97, i64 %119
  %120 = load i32, ptr %arrayidx.i371.2, align 4
  %arrayidx13.i372.2 = getelementptr inbounds i32, ptr %96, i64 %indvars.iv.next.i373.1
  store i32 %120, ptr %arrayidx13.i372.2, align 4
  %indvars.iv.next.i373.2 = add nuw nsw i64 %indvars.iv.i370, 3
  %121 = add nuw nsw i64 %indvars.iv.i370, 7
  %arrayidx.i371.3 = getelementptr inbounds i32, ptr %97, i64 %121
  %122 = load i32, ptr %arrayidx.i371.3, align 4
  %arrayidx13.i372.3 = getelementptr inbounds i32, ptr %96, i64 %indvars.iv.next.i373.2
  store i32 %122, ptr %arrayidx13.i372.3, align 4
  %indvars.iv.next.i373.3 = add nuw nsw i64 %indvars.iv.i370, 4
  %exitcond456.not.3 = icmp eq i64 %indvars.iv.next.i373.3, %98
  br i1 %exitcond456.not.3, label %invoke.cont68, label %for.body.i369

invoke.cont68:                                    ; preds = %for.body.i369.prol.loopexit, %for.body.i369, %middle.block491, %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i363
  %123 = phi ptr [ %call.i36.i359, %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i363 ], [ %96, %middle.block491 ], [ %96, %for.body.i369 ], [ %96, %for.body.i369.prol.loopexit ]
  %idxprom15.pre-phi.i365 = phi i64 [ %.pre.i364, %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i363 ], [ %98, %middle.block491 ], [ %98, %for.body.i369 ], [ %98, %for.body.i369.prol.loopexit ]
  %arrayidx16.i366 = getelementptr inbounds i32, ptr %123, i64 %idxprom15.pre-phi.i365
  store i32 0, ptr %arrayidx16.i366, align 4
  store i32 %sub.i254, ptr %_length17.i367, align 8
...
invoke.cont70:                                    ; preds = %invoke.cont68
  %124 = load ptr, ptr %ref.tmp66, align 8
...
lpad58:                                           ; preds = %invoke.cont57
  %126 = landingpad { ptr, i32 }
          cleanup
  %127 = load ptr, ptr %ref.tmp55, align 8
...
lpad69:                                           ; preds = %invoke.cont68
  %129 = landingpad { ptr, i32 }
          cleanup
  %130 = load ptr, ptr %ref.tmp66, align 8
...
ehcleanup73:                                      ; preds = %delete.notnull.i263, %lpad69, %lpad67, %_ZN11CStringBaseIwED2Ev.exit.i360
  %.pn209 = phi { ptr, i32 } [ %128, %lpad67 ], [ %114, %_ZN11CStringBaseIwED2Ev.exit.i360 ], [ %129, %lpad69 ], [ %129, %delete.notnull.i263 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp66) #11
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %a64) #11
  br label %ehcleanup156

cleanup.cont79:                                   ; preds = %_ZN11CStringBaseIwED2Ev.exit258
  %131 = load i32, ptr %a64, align 4
  store i32 %131, ptr %NumPasses, align 4
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %a64) #11
  br label %cleanup155
...
invoke.cont88:                                    ; preds = %if.else85
  %132 = load ptr, ptr %ref.tmp86, align 8
...
invoke.cont90:                                    ; preds = %invoke.cont88
  ...
  %133 = load ptr, ptr %ref.tmp86, align 8
...
if.then94:                                        ; preds = %_ZN11CStringBaseIwED2Ev.exit272
  ...
  store i32 128, ptr %a95, align 4
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp97) #11
  %134 = load i32, ptr %_length.i, align 8
  %sub.i274 = add i32 %134, -2
  call void @llvm.experimental.noalias.scope.decl(metadata !59)
  %call.i.i33.i406 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #13
          to label %call.i.i33.i.noexc405 unwind label %lpad98

call.i.i33.i.noexc405:                            ; preds = %if.then94
  store ptr %call.i.i33.i406, ptr %ref.tmp97, align 8
  store i32 0, ptr %call.i.i33.i406, align 4
  store i32 4, ptr %_capacity.i32.i384, align 4
  %add.i.i385 = add nsw i32 %134, -1
  %cmp.i.i386 = icmp eq i32 %add.i.i385, 4
  br i1 %cmp.i.i386, label %for.body.lr.ph.i398, label %if.end.i.i387

if.end.i.i387:                                    ; preds = %call.i.i33.i.noexc405
  %conv.i.i388 = zext i32 %add.i.i385 to i64
  %135 = icmp slt i32 %134, 1
  %136 = shl nuw nsw i64 %conv.i.i388, 2
  %137 = select i1 %135, i64 -1, i64 %136
  %call.i36.i389 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %137) #13
          to label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i391 unwind label %_ZN11CStringBaseIwED2Ev.exit.i390

_ZN11CStringBaseIwE11SetCapacityEi.exit.i391:     ; preds = %if.end.i.i387
  call void @_ZdaPv(ptr noundef nonnull %call.i.i33.i406) #14
  store ptr %call.i36.i389, ptr %ref.tmp97, align 8
  store i32 0, ptr %call.i36.i389, align 4
  store i32 %add.i.i385, ptr %_capacity.i32.i384, align 4
  %cmp939.i392 = icmp sgt i32 %134, 2
  br i1 %cmp939.i392, label %for.body.lr.ph.i398, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i393
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i393: ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i391
  %.pre.i394 = sext i32 %sub.i274 to i64
  br label %invoke.cont99

for.body.lr.ph.i398:                              ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i391, %call.i.i33.i.noexc405
  %138 = phi ptr [ %call.i36.i389, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i391 ], [ %call.i.i33.i406, %call.i.i33.i.noexc405 ]
  %139 = load ptr, ptr %name, align 8
  %140 = zext i32 %sub.i274 to i64
  %min.iters.check508 = icmp ult i32 %sub.i274, 8
  br i1 %min.iters.check508, label %for.body.i399.preheader, label %vector.memcheck504

vector.memcheck504:                               ; preds = %for.body.lr.ph.i398
  %141 = ptrtoint ptr %139 to i64
  %142 = ptrtoint ptr %138 to i64
  %143 = add nuw i64 %141, 8
  %144 = sub i64 %142, %143
  %diff.check505 = icmp ult i64 %144, 32
  br i1 %diff.check505, label %for.body.i399.preheader, label %vector.ph509
...
vector.body514:                                   ; preds = %vector.body514, %vector.ph509
  ...
  %wide.load516 = load <4 x i32>, ptr %146, align 4
  %147 = getelementptr inbounds i32, ptr %146, i64 4
  %wide.load517 = load <4 x i32>, ptr %147, align 4
  %148 = getelementptr inbounds i32, ptr %138, i64 %index515
  store <4 x i32> %wide.load516, ptr %148, align 4
  %149 = getelementptr inbounds i32, ptr %148, i64 4
  store <4 x i32> %wide.load517, ptr %149, align 4
  %index.next518 = add nuw i64 %index515, 8
  %150 = icmp eq i64 %index.next518, %n.vec511
  br i1 %150, label %middle.block506, label %vector.body514

middle.block506:                                  ; preds = %vector.body514
  %cmp.n513 = icmp eq i64 %n.vec511, %140
  br i1 %cmp.n513, label %invoke.cont99, label %for.body.i399.preheader

for.body.i399.preheader:                          ; preds = %vector.memcheck504, %for.body.lr.ph.i398, %middle.block506
  %indvars.iv.i400.ph = phi i64 [ 0, %vector.memcheck504 ], [ 0, %for.body.lr.ph.i398 ], [ %n.vec511, %middle.block506 ]
  %151 = xor i64 %indvars.iv.i400.ph, -1
  %152 = add nsw i64 %151, %140
  %xtraiter539 = and i64 %140, 3
  %lcmp.mod540.not = icmp eq i64 %xtraiter539, 0
  br i1 %lcmp.mod540.not, label %for.body.i399.prol.loopexit, label %for.body.i399.prol

for.body.i399.prol:                               ; preds = %for.body.i399.preheader, %for.body.i399.prol
  %indvars.iv.i400.prol = phi i64 [ %indvars.iv.next.i403.prol, %for.body.i399.prol ], [ %indvars.iv.i400.ph, %for.body.i399.preheader ]
  %prol.iter541 = phi i64 [ %prol.iter541.next, %for.body.i399.prol ], [ 0, %for.body.i399.preheader ]
  %153 = add nuw nsw i64 %indvars.iv.i400.prol, 2
  %arrayidx.i401.prol = getelementptr inbounds i32, ptr %139, i64 %153
  %154 = load i32, ptr %arrayidx.i401.prol, align 4
  %arrayidx13.i402.prol = getelementptr inbounds i32, ptr %138, i64 %indvars.iv.i400.prol
  store i32 %154, ptr %arrayidx13.i402.prol, align 4
  %indvars.iv.next.i403.prol = add nuw nsw i64 %indvars.iv.i400.prol, 1
  %prol.iter541.next = add i64 %prol.iter541, 1
  %prol.iter541.cmp.not = icmp eq i64 %prol.iter541.next, %xtraiter539
  br i1 %prol.iter541.cmp.not, label %for.body.i399.prol.loopexit, label %for.body.i399.prol

for.body.i399.prol.loopexit:                      ; preds = %for.body.i399.prol, %for.body.i399.preheader
  %indvars.iv.i400.unr = phi i64 [ %indvars.iv.i400.ph, %for.body.i399.preheader ], [ %indvars.iv.next.i403.prol, %for.body.i399.prol ]
  %155 = icmp ult i64 %152, 3
  br i1 %155, label %invoke.cont99, label %for.body.i399

_ZN11CStringBaseIwED2Ev.exit.i390:                ; preds = %if.end.i.i387
  %156 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdaPv(ptr noundef nonnull %call.i.i33.i406) #14
  br label %ehcleanup104

for.body.i399:                                    ; preds = %for.body.i399.prol.loopexit, %for.body.i399
  %indvars.iv.i400 = phi i64 [ %indvars.iv.next.i403.3, %for.body.i399 ], [ %indvars.iv.i400.unr, %for.body.i399.prol.loopexit ]
  %157 = add nuw nsw i64 %indvars.iv.i400, 2
  %arrayidx.i401 = getelementptr inbounds i32, ptr %139, i64 %157
  %158 = load i32, ptr %arrayidx.i401, align 4
  %arrayidx13.i402 = getelementptr inbounds i32, ptr %138, i64 %indvars.iv.i400
  store i32 %158, ptr %arrayidx13.i402, align 4
  %indvars.iv.next.i403 = add nuw nsw i64 %indvars.iv.i400, 1
  %159 = add nuw nsw i64 %indvars.iv.i400, 3
  %arrayidx.i401.1 = getelementptr inbounds i32, ptr %139, i64 %159
  %160 = load i32, ptr %arrayidx.i401.1, align 4
  %arrayidx13.i402.1 = getelementptr inbounds i32, ptr %138, i64 %indvars.iv.next.i403
  store i32 %160, ptr %arrayidx13.i402.1, align 4
  %indvars.iv.next.i403.1 = add nuw nsw i64 %indvars.iv.i400, 2
  %161 = add nuw nsw i64 %indvars.iv.i400, 4
  %arrayidx.i401.2 = getelementptr inbounds i32, ptr %139, i64 %161
  %162 = load i32, ptr %arrayidx.i401.2, align 4
  %arrayidx13.i402.2 = getelementptr inbounds i32, ptr %138, i64 %indvars.iv.next.i403.1
  store i32 %162, ptr %arrayidx13.i402.2, align 4
  %indvars.iv.next.i403.2 = add nuw nsw i64 %indvars.iv.i400, 3
  %163 = add nuw nsw i64 %indvars.iv.i400, 5
  %arrayidx.i401.3 = getelementptr inbounds i32, ptr %139, i64 %163
  %164 = load i32, ptr %arrayidx.i401.3, align 4
  %arrayidx13.i402.3 = getelementptr inbounds i32, ptr %138, i64 %indvars.iv.next.i403.2
  store i32 %164, ptr %arrayidx13.i402.3, align 4
  %indvars.iv.next.i403.3 = add nuw nsw i64 %indvars.iv.i400, 4
  %exitcond454.not.3 = icmp eq i64 %indvars.iv.next.i403.3, %140
  br i1 %exitcond454.not.3, label %invoke.cont99, label %for.body.i399

invoke.cont99:                                    ; preds = %for.body.i399.prol.loopexit, %for.body.i399, %middle.block506, %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i393
  %165 = phi ptr [ %call.i36.i389, %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i393 ], [ %138, %middle.block506 ], [ %138, %for.body.i399 ], [ %138, %for.body.i399.prol.loopexit ]
  %idxprom15.pre-phi.i395 = phi i64 [ %.pre.i394, %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i393 ], [ %140, %middle.block506 ], [ %140, %for.body.i399 ], [ %140, %for.body.i399.prol.loopexit ]
  %arrayidx16.i396 = getelementptr inbounds i32, ptr %165, i64 %idxprom15.pre-phi.i395
  store i32 0, ptr %arrayidx16.i396, align 4
  store i32 %sub.i274, ptr %_length17.i397, align 8
...
invoke.cont101:                                   ; preds = %invoke.cont99
  %166 = load ptr, ptr %ref.tmp97, align 8
...
lpad89:                                           ; preds = %invoke.cont88
  %168 = landingpad { ptr, i32 }
          cleanup
  %169 = load ptr, ptr %ref.tmp86, align 8
...
lpad100:                                          ; preds = %invoke.cont99
  %171 = landingpad { ptr, i32 }
          cleanup
  %172 = load ptr, ptr %ref.tmp97, align 8
...
ehcleanup104:                                     ; preds = %delete.notnull.i283, %lpad100, %lpad98, %_ZN11CStringBaseIwED2Ev.exit.i390
  %.pn207 = phi { ptr, i32 } [ %170, %lpad98 ], [ %156, %_ZN11CStringBaseIwED2Ev.exit.i390 ], [ %171, %lpad100 ], [ %171, %delete.notnull.i283 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp97) #11
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %a95) #11
  br label %ehcleanup156

cleanup.cont110:                                  ; preds = %_ZN11CStringBaseIwED2Ev.exit278
  %173 = load i32, ptr %a95, align 4
  store i32 %173, ptr %Fb, align 4
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %a95) #11
  br label %cleanup155
...
invoke.cont119:                                   ; preds = %if.else116
  %174 = load ptr, ptr %ref.tmp117, align 8
...
invoke.cont121:                                   ; preds = %invoke.cont119
  ...
  %175 = load ptr, ptr %ref.tmp117, align 8
...
if.then125:                                       ; preds = %_ZN11CStringBaseIwED2Ev.exit292
  ...
  store i32 -1, ptr %a126, align 4
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp128) #11
  %176 = load i32, ptr %_length.i, align 8
  %sub.i294 = add i32 %176, -2
  call void @llvm.experimental.noalias.scope.decl(metadata !65)
  %call.i.i33.i436 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #13
          to label %call.i.i33.i.noexc435 unwind label %lpad129

call.i.i33.i.noexc435:                            ; preds = %if.then125
  store ptr %call.i.i33.i436, ptr %ref.tmp128, align 8
  store i32 0, ptr %call.i.i33.i436, align 4
  store i32 4, ptr %_capacity.i32.i414, align 4
  %add.i.i415 = add nsw i32 %176, -1
  %cmp.i.i416 = icmp eq i32 %add.i.i415, 4
  br i1 %cmp.i.i416, label %for.body.lr.ph.i428, label %if.end.i.i417

if.end.i.i417:                                    ; preds = %call.i.i33.i.noexc435
  %conv.i.i418 = zext i32 %add.i.i415 to i64
  %177 = icmp slt i32 %176, 1
  %178 = shl nuw nsw i64 %conv.i.i418, 2
  %179 = select i1 %177, i64 -1, i64 %178
  %call.i36.i419 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %179) #13
          to label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i421 unwind label %_ZN11CStringBaseIwED2Ev.exit.i420

_ZN11CStringBaseIwE11SetCapacityEi.exit.i421:     ; preds = %if.end.i.i417
  call void @_ZdaPv(ptr noundef nonnull %call.i.i33.i436) #14
  store ptr %call.i36.i419, ptr %ref.tmp128, align 8
  store i32 0, ptr %call.i36.i419, align 4
  store i32 %add.i.i415, ptr %_capacity.i32.i414, align 4
  %cmp939.i422 = icmp sgt i32 %176, 2
  br i1 %cmp939.i422, label %for.body.lr.ph.i428, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i423
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i423: ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i421
  %.pre.i424 = sext i32 %sub.i294 to i64
  br label %invoke.cont130

for.body.lr.ph.i428:                              ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i421, %call.i.i33.i.noexc435
  %180 = phi ptr [ %call.i36.i419, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i421 ], [ %call.i.i33.i436, %call.i.i33.i.noexc435 ]
  %181 = load ptr, ptr %name, align 8
  %182 = zext i32 %sub.i294 to i64
  %min.iters.check523 = icmp ult i32 %sub.i294, 8
  br i1 %min.iters.check523, label %for.body.i429.preheader, label %vector.memcheck519

vector.memcheck519:                               ; preds = %for.body.lr.ph.i428
  %183 = ptrtoint ptr %181 to i64
  %184 = ptrtoint ptr %180 to i64
  %185 = add nuw i64 %183, 8
  %186 = sub i64 %184, %185
  %diff.check520 = icmp ult i64 %186, 32
  br i1 %diff.check520, label %for.body.i429.preheader, label %vector.ph524
...
vector.body529:                                   ; preds = %vector.body529, %vector.ph524
  ...
  %wide.load531 = load <4 x i32>, ptr %188, align 4
  %189 = getelementptr inbounds i32, ptr %188, i64 4
  %wide.load532 = load <4 x i32>, ptr %189, align 4
  %190 = getelementptr inbounds i32, ptr %180, i64 %index530
  store <4 x i32> %wide.load531, ptr %190, align 4
  %191 = getelementptr inbounds i32, ptr %190, i64 4
  store <4 x i32> %wide.load532, ptr %191, align 4
  %index.next533 = add nuw i64 %index530, 8
  %192 = icmp eq i64 %index.next533, %n.vec526
  br i1 %192, label %middle.block521, label %vector.body529

middle.block521:                                  ; preds = %vector.body529
  %cmp.n528 = icmp eq i64 %n.vec526, %182
  br i1 %cmp.n528, label %invoke.cont130, label %for.body.i429.preheader

for.body.i429.preheader:                          ; preds = %vector.memcheck519, %for.body.lr.ph.i428, %middle.block521
  %indvars.iv.i430.ph = phi i64 [ 0, %vector.memcheck519 ], [ 0, %for.body.lr.ph.i428 ], [ %n.vec526, %middle.block521 ]
  %193 = xor i64 %indvars.iv.i430.ph, -1
  %194 = add nsw i64 %193, %182
  %xtraiter = and i64 %182, 3
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %for.body.i429.prol.loopexit, label %for.body.i429.prol

for.body.i429.prol:                               ; preds = %for.body.i429.preheader, %for.body.i429.prol
  %indvars.iv.i430.prol = phi i64 [ %indvars.iv.next.i433.prol, %for.body.i429.prol ], [ %indvars.iv.i430.ph, %for.body.i429.preheader ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body.i429.prol ], [ 0, %for.body.i429.preheader ]
  %195 = add nuw nsw i64 %indvars.iv.i430.prol, 2
  %arrayidx.i431.prol = getelementptr inbounds i32, ptr %181, i64 %195
  %196 = load i32, ptr %arrayidx.i431.prol, align 4
  %arrayidx13.i432.prol = getelementptr inbounds i32, ptr %180, i64 %indvars.iv.i430.prol
  store i32 %196, ptr %arrayidx13.i432.prol, align 4
  %indvars.iv.next.i433.prol = add nuw nsw i64 %indvars.iv.i430.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body.i429.prol.loopexit, label %for.body.i429.prol

for.body.i429.prol.loopexit:                      ; preds = %for.body.i429.prol, %for.body.i429.preheader
  %indvars.iv.i430.unr = phi i64 [ %indvars.iv.i430.ph, %for.body.i429.preheader ], [ %indvars.iv.next.i433.prol, %for.body.i429.prol ]
  %197 = icmp ult i64 %194, 3
  br i1 %197, label %invoke.cont130, label %for.body.i429

_ZN11CStringBaseIwED2Ev.exit.i420:                ; preds = %if.end.i.i417
  %198 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdaPv(ptr noundef nonnull %call.i.i33.i436) #14
  br label %ehcleanup135

for.body.i429:                                    ; preds = %for.body.i429.prol.loopexit, %for.body.i429
  %indvars.iv.i430 = phi i64 [ %indvars.iv.next.i433.3, %for.body.i429 ], [ %indvars.iv.i430.unr, %for.body.i429.prol.loopexit ]
  %199 = add nuw nsw i64 %indvars.iv.i430, 2
  %arrayidx.i431 = getelementptr inbounds i32, ptr %181, i64 %199
  %200 = load i32, ptr %arrayidx.i431, align 4
  %arrayidx13.i432 = getelementptr inbounds i32, ptr %180, i64 %indvars.iv.i430
  store i32 %200, ptr %arrayidx13.i432, align 4
  %indvars.iv.next.i433 = add nuw nsw i64 %indvars.iv.i430, 1
  %201 = add nuw nsw i64 %indvars.iv.i430, 3
  %arrayidx.i431.1 = getelementptr inbounds i32, ptr %181, i64 %201
  %202 = load i32, ptr %arrayidx.i431.1, align 4
  %arrayidx13.i432.1 = getelementptr inbounds i32, ptr %180, i64 %indvars.iv.next.i433
  store i32 %202, ptr %arrayidx13.i432.1, align 4
  %indvars.iv.next.i433.1 = add nuw nsw i64 %indvars.iv.i430, 2
  %203 = add nuw nsw i64 %indvars.iv.i430, 4
  %arrayidx.i431.2 = getelementptr inbounds i32, ptr %181, i64 %203
  %204 = load i32, ptr %arrayidx.i431.2, align 4
  %arrayidx13.i432.2 = getelementptr inbounds i32, ptr %180, i64 %indvars.iv.next.i433.1
  store i32 %204, ptr %arrayidx13.i432.2, align 4
  %indvars.iv.next.i433.2 = add nuw nsw i64 %indvars.iv.i430, 3
  %205 = add nuw nsw i64 %indvars.iv.i430, 5
  %arrayidx.i431.3 = getelementptr inbounds i32, ptr %181, i64 %205
  %206 = load i32, ptr %arrayidx.i431.3, align 4
  %arrayidx13.i432.3 = getelementptr inbounds i32, ptr %180, i64 %indvars.iv.next.i433.2
  store i32 %206, ptr %arrayidx13.i432.3, align 4
  %indvars.iv.next.i433.3 = add nuw nsw i64 %indvars.iv.i430, 4
  %exitcond.not.3 = icmp eq i64 %indvars.iv.next.i433.3, %182
  br i1 %exitcond.not.3, label %invoke.cont130, label %for.body.i429

invoke.cont130:                                   ; preds = %for.body.i429.prol.loopexit, %for.body.i429, %middle.block521, %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i423
  %207 = phi ptr [ %call.i36.i419, %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i423 ], [ %180, %middle.block521 ], [ %180, %for.body.i429 ], [ %180, %for.body.i429.prol.loopexit ]
  %idxprom15.pre-phi.i425 = phi i64 [ %.pre.i424, %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i423 ], [ %182, %middle.block521 ], [ %182, %for.body.i429 ], [ %182, %for.body.i429.prol.loopexit ]
  %arrayidx16.i426 = getelementptr inbounds i32, ptr %207, i64 %idxprom15.pre-phi.i425
  store i32 0, ptr %arrayidx16.i426, align 4
  store i32 %sub.i294, ptr %_length17.i427, align 8
...
invoke.cont132:                                   ; preds = %invoke.cont130
  %208 = load ptr, ptr %ref.tmp128, align 8
...
lpad120:                                          ; preds = %invoke.cont119
  %210 = landingpad { ptr, i32 }
          cleanup
  %211 = load ptr, ptr %ref.tmp117, align 8
...
lpad131:                                          ; preds = %invoke.cont130
  %213 = landingpad { ptr, i32 }
          cleanup
  %214 = load ptr, ptr %ref.tmp128, align 8
...
ehcleanup135:                                     ; preds = %delete.notnull.i303, %lpad131, %lpad129, %_ZN11CStringBaseIwED2Ev.exit.i420
  %.pn205 = phi { ptr, i32 } [ %212, %lpad129 ], [ %198, %_ZN11CStringBaseIwED2Ev.exit.i420 ], [ %213, %lpad131 ], [ %213, %delete.notnull.i303 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp128) #11
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %a126) #11
  br label %ehcleanup156

cleanup.cont141:                                  ; preds = %_ZN11CStringBaseIwED2Ev.exit298
  %215 = load i32, ptr %a126, align 4
  store i32 %215, ptr %Mc, align 4
  store i8 1, ptr %McDefined.i, align 4
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %a126) #11
  br label %cleanup155
...
cleanup155:                                       ; preds = %cleanup.cont, %cleanup.cont48, %cleanup.cont79, %cleanup.cont110, %cleanup.cont141, %cleanup153.critedge, %cleanup153.critedge217, %cleanup153.critedge218, %cleanup153.critedge219, %cleanup153.critedge220, %_ZN11CStringBaseIwED2Ev.exit292, %invoke.cont
  %cond = phi i1 [ false, %invoke.cont ], [ false, %cleanup153.critedge ], [ false, %cleanup153.critedge217 ], [ false, %cleanup153.critedge218 ], [ false, %cleanup153.critedge219 ], [ false, %cleanup153.critedge220 ], [ false, %_ZN11CStringBaseIwED2Ev.exit292 ], [ true, %cleanup.cont141 ], [ true, %cleanup.cont110 ], [ true, %cleanup.cont79 ], [ true, %cleanup.cont48 ], [ true, %cleanup.cont ]
  %retval.8 = phi i32 [ -2147024809, %invoke.cont ], [ %call15, %cleanup153.critedge ], [ %call40, %cleanup153.critedge217 ], [ %call71, %cleanup153.critedge218 ], [ %call102, %cleanup153.critedge219 ], [ %call133, %cleanup153.critedge220 ], [ -2147024809, %_ZN11CStringBaseIwED2Ev.exit292 ], [ %retval.0446, %cleanup.cont141 ], [ %retval.0446, %cleanup.cont110 ], [ %retval.0446, %cleanup.cont79 ], [ %retval.0446, %cleanup.cont48 ], [ %retval.0446, %cleanup.cont ]
  %216 = load ptr, ptr %name, align 8
