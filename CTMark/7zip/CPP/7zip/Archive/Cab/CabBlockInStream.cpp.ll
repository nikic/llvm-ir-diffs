; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Archive/Cab/CabBlockInStream.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Archive/Cab/CabBlockInStream.cpp"
...
entry:
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTVN8NArchive4NCab17CCabBlockInStreamE, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %_buffer = getelementptr inbounds %"class.NArchive::NCab::CCabBlockInStream", ptr %this, i64 0, i32 4
  %0 = load ptr, ptr %_buffer, align 8
...
entry:
  ...
  %0 = load ptr, ptr %_buffer.i, align 8
  invoke void @MyFree(ptr noundef %0)
...
land.rhs.preheader:                               ; preds = %entry
  %.pre = load i32, ptr %m_Pos, align 4
...
while.body:                                       ; preds = %land.rhs
  ...
  %3 = load i8, ptr %dataPointer.070, align 1
...
if.end:                                           ; preds = %for.body.preheader, %while.body
  ...
  br i1 %cmp.not, label %while.end30.thread, label %land.rhs

while.end30.thread:                               ; preds = %if.end, %entry
  %checkSum.0.lcssa.ph = phi i32 [ %0, %entry ], [ %checkSum.2, %if.end ]
  store i32 %checkSum.0.lcssa.ph, ptr %this, align 4
...
while.body15:                                     ; preds = %while.body15.preheader110, %while.body15
  ...
  br i1 %cmp14.not, label %while.end30, label %while.body15
...
while.end30:                                      ; preds = %while.body15, %middle.block, %while.end
  ...
  store i32 %checkSum.3.lcssa, ptr %this, align 4
...
while.body35:                                     ; preds = %while.end30
  %.pre88 = load i32, ptr %m_Pos, align 4
  %23 = load i8, ptr %dataPointer.1.lcssa, align 1
  ...
  store i8 %23, ptr %arrayidx40, align 1
  %24 = load i32, ptr %m_Pos, align 4
  %add42 = add nsw i32 %24, 1
  %and43 = and i32 %add42, 3
  store i32 %and43, ptr %m_Pos, align 4
  %cmp34.not = icmp eq i32 %and32, 1
  br i1 %cmp34.not, label %while.end46, label %while.body35.1

while.body35.1:                                   ; preds = %while.body35
  %incdec.ptr36 = getelementptr inbounds i8, ptr %dataPointer.1.lcssa, i64 1
  %25 = load i8, ptr %incdec.ptr36, align 1
...
while.body35.2:                                   ; preds = %while.body35.1
  ...
  store i8 %27, ptr %arrayidx40.2, align 1
  %28 = load i32, ptr %m_Pos, align 4
  %add42.2 = add nsw i32 %28, 1
  %and43.2 = and i32 %add42.2, 3
  store i32 %and43.2, ptr %m_Pos, align 4
  br label %while.end46
...
cleanup.cont:                                     ; preds = %entry
  %Pos.i.promoted.i = load i32, ptr %Pos, align 4
  %inc.i.i = add i32 %Pos.i.promoted.i, 1
  store i32 %inc.i.i, ptr %Pos, align 4
  ...
  store i32 %inc.i.i133, ptr %Pos, align 4
  ...
  %5 = load i8, ptr %arrayidx.i.i135, align 1
  %6 = zext i8 %5 to i32
  %inc.i.1.i136 = add i32 %Pos.i.promoted.i, 6
  store i32 %inc.i.1.i136, ptr %Pos, align 4
  ...
  %8 = load i8, ptr %arrayidx.i.i144, align 1
  %9 = zext i8 %8 to i32
  %inc.i.1.i145 = add i32 %Pos.i.promoted.i, 8
  store i32 %inc.i.1.i145, ptr %Pos, align 4
...
if.then8:                                         ; preds = %cleanup.cont
  ...
  %_buffer = getelementptr inbounds %"class.NArchive::NCab::CCabBlockInStream", ptr %this, i64 0, i32 4
  %13 = load ptr, ptr %_buffer, align 8
...
if.end21:                                         ; preds = %if.then8, %cleanup.cont
  ...
  store i32 0, ptr %checkSumCalc, align 4
...
if.end26:                                         ; preds = %if.then23
  ...
  %17 = load ptr, ptr %_stream, align 8
...
cleanup46:                                        ; preds = %cleanup.cont37
  ...
  call void @llvm.lifetime.end.p0(i64 2, ptr nonnull %sig) #13
  %.pre = load i32, ptr %_size, align 4
  br label %if.end49
...
if.then56:                                        ; preds = %if.end54
  ...
  store i64 %conv57, ptr %processedSizeLoc, align 8
  ...
  %22 = load ptr, ptr %_buffer61, align 8
...
cleanup81:                                        ; preds = %if.then56
  %23 = load ptr, ptr %_buffer61, align 8
  %24 = load i32, ptr %_size, align 4
  %idx.ext72 = zext i32 %24 to i64
  %add.ptr73 = getelementptr inbounds i8, ptr %23, i64 %idx.ext72
  %25 = load i64, ptr %processedSizeLoc, align 8
  ...
  store i32 %add, ptr %_size, align 4
...
if.end84:                                         ; preds = %cleanup81, %if.end54
  ...
  store i32 %26, ptr %TotalPackSize, align 8
  %27 = load i32, ptr %m_Pos.i, align 4
...
for.body.preheader.i:                             ; preds = %if.end84
  %this.promoted.i = load i32, ptr %checkSumCalc, align 4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i8>, ptr %29, align 4
  %30 = getelementptr inbounds i8, ptr %29, i64 4
  %wide.load161 = load <4 x i8>, ptr %30, align 4
...
for.cond.for.cond.cleanup_crit_edge.i:            ; preds = %for.body.i, %middle.block
  ...
  store i32 %xor.i.lcssa, ptr %checkSumCalc, align 4
...
for.body.i:                                       ; preds = %for.body.i.preheader, %for.body.i
  ...
  br i1 %exitcond.not.i, label %for.cond.for.cond.cleanup_crit_edge.i, label %for.body.i
...
if.else:                                          ; preds = %_ZN8NArchive4NCab10CCheckSum216FinishDataUpdateEv.exit
  %47 = load i32, ptr %packSize, align 4
  %48 = load i32, ptr %unpackSize, align 4
  %shl = shl i32 %48, 16
  %or = or i32 %shl, %47
  %49 = load i32, ptr %checkSumCalc, align 4
...
if.end90:                                         ; preds = %_ZN8NArchive4NCab10CCheckSum216FinishDataUpdateEv.exit, %if.else
  ...
  %50 = load i8, ptr %DataError, align 8
  %51 = zext i1 %dataError.0 to i8
  %52 = or i8 %50, %51
  store i8 %52, ptr %DataError, align 8
...
if.then6:                                         ; preds = %if.end4
  ...
  store i32 %add, ptr %_pos, align 8
  %4 = load i32, ptr %_size, align 4
  %sub = sub i32 %4, %cond.i
  store i32 %sub, ptr %_size, align 4
  br i1 %cmp.not, label %return, label %if.then11

if.then11:                                        ; preds = %if.then6
  store i32 %cond.i, ptr %processedSize, align 4
  br label %return
