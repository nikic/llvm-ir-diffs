...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(512) %record, i8 0, i64 512, i1 false)
...
_ZN8NArchive4NTarL9MyStrNCpyEPcPKci.exit:         ; preds = %for.body.i
  ...
  %4 = load i32, ptr %_length.i.i, align 8
...
entry.cleanup_crit_edge.i:                        ; preds = %_ZN8NArchive4NTarL9MyStrNCpyEPcPKci.exit
  %.pre.i = load ptr, ptr %tempString.i, align 8
  br label %cleanup.i
...
for.body.preheader.i:                             ; preds = %if.end.i
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %add.ptr, i8 32, i64 %5, i1 false)
...
for.cond.cleanup.i:                               ; preds = %for.body.preheader.i, %if.end.i
  ...
  %6 = load ptr, ptr %tempString.i, align 8
...
while.cond.i.i:                                   ; preds = %while.cond.i.i, %for.cond.cleanup.i
  ...
  store i8 %7, ptr %dest.addr.0.i.i, align 1
  %cmp.not.i.i = icmp eq i8 %7, 0
  br i1 %cmp.not.i.i, label %cleanup.i, label %while.cond.i.i
...
if.end7:                                          ; preds = %_ZN8NArchive4NTarL16MakeOctalString8EPcj.exit
  ...
  %10 = load i32, ptr %_length.i.i118, align 8
...
entry.cleanup_crit_edge.i120:                     ; preds = %if.end7
  %.pre.i121 = load ptr, ptr %tempString.i116, align 8
...
for.body.preheader.i128:                          ; preds = %if.end.i125
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %add.ptr8, i8 32, i64 %11, i1 false)
...
for.cond.cleanup.i130:                            ; preds = %for.body.preheader.i128, %if.end.i125
  ...
  %12 = load ptr, ptr %tempString.i116, align 8
...
while.cond.i.i133:                                ; preds = %while.cond.i.i133, %for.cond.cleanup.i130
  ...
  %13 = load i8, ptr %src.addr.0.i.i134, align 1
  %incdec.ptr1.i.i137 = getelementptr inbounds i8, ptr %dest.addr.0.i.i135, i64 1
  store i8 %13, ptr %dest.addr.0.i.i135, align 1
  %cmp.not.i.i138 = icmp eq i8 %13, 0
  br i1 %cmp.not.i.i138, label %cleanup.i122, label %while.cond.i.i133
...
if.end11:                                         ; preds = %_ZN8NArchive4NTarL16MakeOctalString8EPcj.exit139
  ...
  %16 = load i32, ptr %_length.i.i142, align 8
...
entry.cleanup_crit_edge.i144:                     ; preds = %if.end11
  %.pre.i145 = load ptr, ptr %tempString.i140, align 8
...
for.body.preheader.i152:                          ; preds = %if.end.i149
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %add.ptr12, i8 32, i64 %17, i1 false)
...
for.cond.cleanup.i154:                            ; preds = %for.body.preheader.i152, %if.end.i149
  ...
  %18 = load ptr, ptr %tempString.i140, align 8
...
while.cond.i.i157:                                ; preds = %while.cond.i.i157, %for.cond.cleanup.i154
  ...
  %19 = load i8, ptr %src.addr.0.i.i158, align 1
  %incdec.ptr1.i.i161 = getelementptr inbounds i8, ptr %dest.addr.0.i.i159, i64 1
  store i8 %19, ptr %dest.addr.0.i.i159, align 1
  %cmp.not.i.i162 = icmp eq i8 %19, 0
  br i1 %cmp.not.i.i162, label %cleanup.i146, label %while.cond.i.i157
...
for.body13.preheader.i:                           ; preds = %if.end.i167
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %add.ptr16, i8 32, i64 %29, i1 false)
...
for.cond.cleanup12.i:                             ; preds = %for.body13.preheader.i, %if.end.i167
  ...
  %30 = load ptr, ptr %tempString.i164, align 8
...
_ZN8NArchive4NTarL17MakeOctalString12EPcy.exit:   ; preds = %cleanup.i172, %delete.notnull.i.i174
  ...
  %33 = load i32, ptr %_length.i.i178, align 8
...
if.then.i192:                                     ; preds = %_ZN8NArchive4NTarL17MakeOctalString12EPcy.exit
  store i8 -128, ptr %add.ptr17, align 8
...
for.body13.preheader.i183:                        ; preds = %if.end.i180
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %add.ptr17, i8 32, i64 %37, i1 false)
...
for.cond.cleanup12.i185:                          ; preds = %for.body13.preheader.i183, %if.end.i180
  ...
  %38 = load ptr, ptr %tempString.i177, align 8
...
_ZN8NArchive4NTarL17MakeOctalString12EPcy.exit214: ; preds = %cleanup.i189, %delete.notnull.i.i191
  ...
  %40 = load ptr, ptr @_ZN8NArchive4NTar11NFileHeader15kCheckSumBlanksE, align 8
  ...
  %42 = load i8, ptr %LinkFlag, align 8
  store i8 %42, ptr %add.ptr19, align 4
  %43 = getelementptr inbounds %"struct.NArchive::NTar::CItem", ptr %item, i64 0, i32 8, i32 1
  %LinkName.val115 = load i32, ptr %43, align 8
...
while.cond.i.i215:                                ; preds = %while.cond.i.i215.preheader, %while.cond.i.i215
  ...
  %44 = load i8, ptr %src.addr.0.i.i216, align 1
  %incdec.ptr1.i.i219 = getelementptr inbounds i8, ptr %dest.addr.0.i.i217, i64 1
  store i8 %44, ptr %dest.addr.0.i.i217, align 1
  %cmp.not.i.i220 = icmp eq i8 %44, 0
  br i1 %cmp.not.i.i220, label %if.end22, label %while.cond.i.i215
...
if.end22:                                         ; preds = %while.cond.i.i215
  ...
  %User.val114 = load i32, ptr %46, align 8
...
while.cond.i.i230:                                ; preds = %while.cond.i.i230.preheader, %while.cond.i.i230
  ...
  %49 = load i8, ptr %src.addr.0.i.i231, align 1
  %incdec.ptr1.i.i234 = getelementptr inbounds i8, ptr %dest.addr.0.i.i232, i64 1
  store i8 %49, ptr %dest.addr.0.i.i232, align 1
  %cmp.not.i.i235 = icmp eq i8 %49, 0
  br i1 %cmp.not.i.i235, label %if.end32, label %while.cond.i.i230
...
if.end32:                                         ; preds = %while.cond.i.i230
  ...
  %50 = load i8, ptr %DeviceMajorDefined, align 1
...
if.then34:                                        ; preds = %if.end32
  ...
  %51 = load i32, ptr %DeviceMajor, align 8
...
if.end38:                                         ; preds = %if.then34, %if.end32
  ...
  %52 = load i8, ptr %DeviceMinorDefined, align 2
...
if.then41:                                        ; preds = %if.end38
  ...
  %53 = load i32, ptr %DeviceMinor, align 4
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %wide.load = load <4 x i8>, ptr %54, align 16
  %55 = getelementptr inbounds i8, ptr %54, i64 4
  %wide.load243 = load <4 x i8>, ptr %55, align 4
  ...
  %wide.load.1 = load <4 x i8>, ptr %60, align 8
  %61 = getelementptr inbounds i8, ptr %60, i64 4
  %wide.load243.1 = load <4 x i8>, ptr %61, align 4
...
entry.cleanup_crit_edge:                          ; preds = %entry
  %.pre = load ptr, ptr %tempString, align 8
  br label %cleanup
...
for.body.preheader:                               ; preds = %if.end
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %s, i8 32, i64 %1, i1 false)
  br label %for.cond.cleanup

for.cond.cleanup:                                 ; preds = %for.body.preheader, %if.end
  %idx.ext = sext i32 %sub to i64
  %add.ptr = getelementptr inbounds i8, ptr %s, i64 %idx.ext
  %2 = load ptr, ptr %tempString, align 8
...
while.cond.i:                                     ; preds = %while.cond.i, %for.cond.cleanup
  ...
  br i1 %cmp.not.i, label %cleanup, label %while.cond.i
...
if.end:                                           ; preds = %entry
  ...
  store i8 76, ptr %LinkFlag, align 8
  %1 = load ptr, ptr @_ZN8NArchive4NTar11NFileHeader9kLongLinkE, align 8
  %_length.i.i = getelementptr inbounds %class.CStringBase, ptr %modifiedItem, i64 0, i32 1
  store i32 0, ptr %_length.i.i, align 8
  %2 = load ptr, ptr %modifiedItem, align 8
...
_Z11MyStringLenIcEiPKT_.exit._ZN11CStringBaseIcE11SetCapacityEi.exit_crit_edge.i: ; preds = %_Z11MyStringLenIcEiPKT_.exit.i
  %.pre11.i = load ptr, ptr %modifiedItem, align 8
...
for.cond.preheader.i.i:                           ; preds = %call.i.i.noexc
  ...
  %.pre.i.i = load ptr, ptr %modifiedItem, align 8
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load132 = load <8 x i8>, ptr %12, align 1
  %13 = getelementptr inbounds i8, ptr %call.i.i74, i64 %index131
  store <8 x i8> %wide.load132, ptr %13, align 1
...
if.end9.i.i:                                      ; preds = %delete.notnull.i.i, %for.cond.cleanup.i.i, %call.i.i.noexc
  ...
  store ptr %call.i.i74, ptr %modifiedItem, align 8
...
invoke.cont:                                      ; preds = %while.cond.i.i
  ...
  store i32 0, ptr %_length.i75, align 8
  %25 = load ptr, ptr %LinkName, align 8
...
if.end.i:                                         ; preds = %cleanup.cont24
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(1) %residualBytes.i, i8 0, i64 %31, i1 false)
...
invoke.cont40:                                    ; preds = %invoke.cont36
  store i32 0, ptr %_length.i.i, align 8
  %34 = load ptr, ptr %modifiedItem, align 8
  store i8 0, ptr %34, align 1
  %_length.i81 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp, i64 0, i32 1
  %35 = load i32, ptr %_length.i81, align 8
  %add.i.i82 = add nsw i32 %35, 1
  %36 = load i32, ptr %_capacity.i.i, align 4
...
if.end._ZN11CStringBaseIcE11SetCapacityEi.exit_crit_edge.i: ; preds = %invoke.cont40
  %.pre10.i113 = load ptr, ptr %modifiedItem, align 8
...
for.cond.preheader.i.i98:                         ; preds = %call.i.i.noexc114
  ...
  %.pre.i.i100 = load ptr, ptr %modifiedItem, align 8
...
vector.body148:                                   ; preds = %vector.body148, %vector.ph144
  ...
  %wide.load150 = load <16 x i8>, ptr %38, align 1
  %39 = getelementptr inbounds i8, ptr %38, i64 16
  %wide.load151 = load <16 x i8>, ptr %39, align 1
  %40 = getelementptr inbounds i8, ptr %call.i.i115, i64 %index149
  store <16 x i8> %wide.load150, ptr %40, align 1
  %41 = getelementptr inbounds i8, ptr %40, i64 16
  store <16 x i8> %wide.load151, ptr %41, align 1
  %index.next152 = add nuw i64 %index149, 32
  %42 = icmp eq i64 %index.next152, %n.vec146
  br i1 %42, label %middle.block138, label %vector.body148
...
vec.epilog.vector.body164:                        ; preds = %vec.epilog.vector.body164, %vec.epilog.ph156
  ...
  %wide.load166 = load <8 x i8>, ptr %43, align 1
  %44 = getelementptr inbounds i8, ptr %call.i.i115, i64 %index165
  store <8 x i8> %wide.load166, ptr %44, align 1
  %index.next167 = add nuw i64 %index165, 8
  %45 = icmp eq i64 %index.next167, %n.vec161
  br i1 %45, label %vec.epilog.middle.block153, label %vec.epilog.vector.body164
...
for.body.i.i107.prol:                             ; preds = %for.body.i.i107.preheader, %for.body.i.i107.prol
  ...
  br i1 %prol.iter171.cmp.not, label %for.body.i.i107.prol.loopexit, label %for.body.i.i107.prol
...
for.body.i.i107:                                  ; preds = %for.body.i.i107.prol.loopexit, %for.body.i.i107
  ...
  br i1 %exitcond.not.i.i112.3, label %delete.notnull.i.i103, label %for.body.i.i107
...
delete.notnull.i.i103:                            ; preds = %for.body.i.i107.prol.loopexit, %for.body.i.i107, %middle.block138, %vec.epilog.middle.block153, %for.cond.cleanup.i.i101
  ...
  %.pre.i104 = load i32, ptr %_length.i.i, align 8
...
if.end9.i.i88:                                    ; preds = %delete.notnull.i.i103, %for.cond.cleanup.i.i101, %call.i.i.noexc114
  ...
  store ptr %call.i.i115, ptr %modifiedItem, align 8
  %idxprom13.i.i89 = sext i32 %54 to i64
  %arrayidx14.i.i90 = getelementptr inbounds i8, ptr %call.i.i115, i64 %idxprom13.i.i89
  store i8 0, ptr %arrayidx14.i.i90, align 1
  store i32 %add.i.i82, ptr %_capacity.i.i, align 4
  br label %_ZN11CStringBaseIcE11SetCapacityEi.exit.i91
...
while.cond.i.i92:                                 ; preds = %while.cond.i.i92, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i91
  ...
  %57 = load i8, ptr %src.addr.0.i.i93, align 1
  %incdec.ptr1.i.i96 = getelementptr inbounds i8, ptr %dest.addr.0.i.i94, i64 1
  store i8 %57, ptr %dest.addr.0.i.i94, align 1
  %cmp.not.i.i97 = icmp eq i8 %57, 0
  br i1 %cmp.not.i.i97, label %invoke.cont43, label %while.cond.i.i92

invoke.cont43:                                    ; preds = %while.cond.i.i92
  %58 = load i32, ptr %_length.i81, align 8
  store i32 %58, ptr %_length.i.i, align 8
  %59 = load ptr, ptr %ref.tmp, align 8
...
cleanup47:                                        ; preds = %_ZN11CStringBaseIcED2Ev.exit, %invoke.cont28, %invoke.cont17, %invoke.cont7
  ...
  %63 = load ptr, ptr %Group.i, align 8
...
_ZN11CStringBaseIcED2Ev.exit.i:                   ; preds = %delete.notnull.i.i120, %cleanup47
  ...
  %64 = load ptr, ptr %User.i, align 8
...
_ZN11CStringBaseIcED2Ev.exit4.i:                  ; preds = %delete.notnull.i3.i, %_ZN11CStringBaseIcED2Ev.exit.i
  %65 = load ptr, ptr %LinkName, align 8
...
_ZN11CStringBaseIcED2Ev.exit7.i:                  ; preds = %delete.notnull.i6.i, %_ZN11CStringBaseIcED2Ev.exit4.i
  %66 = load ptr, ptr %modifiedItem, align 8
...
if.end:                                           ; preds = %entry
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(1) %residualBytes, i8 0, i64 %1, i1 false)
...
call.i.i.i.noexc:                                 ; preds = %_ZN11CStringBaseIcEC2EPKc.exit
  ...
  store ptr %call.i.i.i3, ptr %agg.result, align 8
  store i8 0, ptr %call.i.i.i3, align 1
  store i32 %add.i.i, ptr %_capacity.i.i, align 4
