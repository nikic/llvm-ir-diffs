...
if.end3:                                          ; preds = %if.end
  ...
  %1 = load i64, ptr %_totalLength, align 8
...
if.end9:                                          ; preds = %if.end3
  ...
  %2 = load i32, ptr %_streamIndex, align 8
...
for.cond:                                         ; preds = %cleanup, %if.end9
  ...
  %6 = load i64, ptr %GlobalOffset, align 8
...
if.then32.if.end42_crit_edge:                     ; preds = %if.then32
  %.pre = load i64, ptr %Size.le, align 8
  br label %if.end42
...
if.then46:                                        ; preds = %if.end42
  ...
  store i32 %conv47, ptr %size.addr, align 4
  br label %if.end48
...
if.end48:                                         ; preds = %if.then46, %if.end42
  ...
  %16 = load i64, ptr %_pos, align 8
  %add56 = add i64 %16, %conv54
  store i64 %add56, ptr %_pos, align 8
  %17 = load i64, ptr %LocalPos, align 8
  %add59 = add i64 %17, %conv54
  store i64 %add59, ptr %LocalPos, align 8
  br i1 %tobool.not, label %return, label %if.then61

if.then61:                                        ; preds = %if.end48
  store i32 %15, ptr %processedSize, align 4
  br label %return
...
entry:
  store ptr getelementptr inbounds ({ [9 x ptr] }, ptr @_ZTV12CMultiStream, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %Streams = getelementptr inbounds %class.CMultiStream, ptr %this, i64 0, i32 5
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN12CMultiStream14CSubStreamInfoEE, i64 0, inrange i32 0, i64 2), ptr %Streams, align 8
