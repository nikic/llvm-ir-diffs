; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Archive/Common/InStreamWithCRC.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Archive/Common/InStreamWithCRC.cpp"
...
for.cond.i14:                                     ; preds = %if.end
  ...
  %33 = load i8, ptr %arrayidx.1.i15, align 1, !tbaa !29
...
for.cond.1.i17:                                   ; preds = %for.cond.i14
  ...
  %35 = load i8, ptr %arrayidx.2.i18, align 2, !tbaa !29
...
for.cond.2.i20:                                   ; preds = %for.cond.1.i17
  ...
  %37 = load i8, ptr %arrayidx.3.i21, align 1, !tbaa !29
...
for.cond.3.i23:                                   ; preds = %for.cond.2.i20
  ...
  %39 = load i8, ptr %arrayidx.4.i24, align 4, !tbaa !29
...
for.cond.4.i26:                                   ; preds = %for.cond.3.i23
  ...
  %41 = load i8, ptr %arrayidx.5.i27, align 1, !tbaa !29
...
for.cond.5.i29:                                   ; preds = %for.cond.4.i26
  ...
  %43 = load i8, ptr %arrayidx.6.i30, align 2, !tbaa !29
...
for.cond.6.i32:                                   ; preds = %for.cond.5.i29
  ...
  %45 = load i8, ptr %arrayidx.7.i33, align 1, !tbaa !29
...
for.cond.7.i35:                                   ; preds = %for.cond.6.i32
  ...
  %47 = load i8, ptr %arrayidx.8.i36, align 4, !tbaa !29
...
for.cond.8.i38:                                   ; preds = %for.cond.7.i35
  ...
  %49 = load i8, ptr %arrayidx.9.i39, align 1, !tbaa !29
...
for.cond.9.i41:                                   ; preds = %for.cond.8.i38
  ...
  %51 = load i8, ptr %arrayidx.10.i42, align 2, !tbaa !29
...
for.cond.10.i44:                                  ; preds = %for.cond.9.i41
  ...
  %53 = load i8, ptr %arrayidx.11.i45, align 1, !tbaa !29
...
for.cond.11.i47:                                  ; preds = %for.cond.10.i44
  ...
  %55 = load i8, ptr %arrayidx.12.i48, align 4, !tbaa !29
...
for.cond.12.i50:                                  ; preds = %for.cond.11.i47
  ...
  %57 = load i8, ptr %arrayidx.13.i51, align 1, !tbaa !29
...
for.cond.13.i53:                                  ; preds = %for.cond.12.i50
  ...
  %59 = load i8, ptr %arrayidx.14.i54, align 2, !tbaa !29
...
_ZeqRK4GUIDS1_.exit60:                            ; preds = %for.cond.13.i53
  ...
  %61 = load i8, ptr %arrayidx.15.i57, align 1, !tbaa !29
