...
if.then8:                                         ; preds = %if.end
  %5 = load i32, ptr %realProcessedSize, align 4
  store i32 %5, ptr %processedSize, align 4
  br label %if.end9
...
entry:
  ...
  store i32 %call4, ptr %_crc, align 8
...
entry:
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV26CSequentialInStreamWithCRC, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %_stream = getelementptr inbounds %class.CSequentialInStreamWithCRC, ptr %this, i64 0, i32 3
  %0 = load ptr, ptr %_stream, align 8
...
entry:
  store ptr getelementptr inbounds ({ [9 x ptr] }, ptr @_ZTV16CInStreamWithCRC, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %_stream = getelementptr inbounds %class.CInStreamWithCRC, ptr %this, i64 0, i32 3
  %0 = load ptr, ptr %_stream, align 8
  %tobool.not.i = icmp eq ptr %0, null
