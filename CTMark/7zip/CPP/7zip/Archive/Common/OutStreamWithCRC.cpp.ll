...
if.then:                                          ; preds = %entry
  ...
  %.pre15.pre = load i32, ptr %size.addr, align 4
  br label %if.end
...
if.then11:                                        ; preds = %if.end9
  store i32 %4, ptr %processedSize, align 4
  br label %if.end12
...
entry:
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV17COutStreamWithCRC, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %_stream = getelementptr inbounds %class.COutStreamWithCRC, ptr %this, i64 0, i32 3
  %0 = load ptr, ptr %_stream, align 8
