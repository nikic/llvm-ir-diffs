; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Archive/Common/DummyOutStream.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Archive/Common/DummyOutStream.cpp"
...
if.else:                                          ; preds = %entry
  ...
  %.pre = load i32, ptr %realProcessedSize, align 4
  br label %if.end
...
entry:
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV15CDummyOutStream, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %_stream = getelementptr inbounds %class.CDummyOutStream, ptr %this, i64 0, i32 2
  %0 = load ptr, ptr %_stream, align 8
