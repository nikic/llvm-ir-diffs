...
if.then.i3:                                       ; preds = %_ZN9CMyComPtrI15ICompressCoder2ED2Ev.exit
  %vtable.i4 = load ptr, ptr %4, align 8, !tbaa !15
...
if.then.i153:                                     ; preds = %for.body87
  %vtable.i154 = load ptr, ptr %49, align 8, !tbaa !15
...
for.body.i.i20:                                   ; preds = %for.body.i.i20, %for.body.lr.ph.i.i16
  ...
  store i64 %agg.tmp.sroa.0.0.copyload.i.i23, ptr %arrayidx.i13.i.i25, align 4, !tbaa.struct !57
  %12 = load i32, ptr %_size.i9.i.i13, align 4, !tbaa !33
  %inc.i.i.i26 = add nsw i32 %12, 1
  store i32 %inc.i.i.i26, ptr %_size.i9.i.i13, align 4, !tbaa !33
  ...
  br i1 %exitcond.not.i.i28, label %_ZN13CRecordVectorIN11NCoderMixer9CBindPairEEaSERKS2_.exit, label %for.body.i.i20, !llvm.loop !60
...
for.body.i.i37:                                   ; preds = %for.body.i.i37, %for.body.lr.ph.i.i33
  ...
  store i32 %16, ptr %arrayidx.i13.i.i41, align 4, !tbaa !58
  %19 = load i32, ptr %_size.i9.i.i30, align 4, !tbaa !33
  %inc.i.i.i42 = add nsw i32 %19, 1
  store i32 %inc.i.i.i42, ptr %_size.i9.i.i30, align 4, !tbaa !33
  ...
  br i1 %exitcond.not.i.i44, label %_ZN13CRecordVectorIjEaSERKS0_.exit, label %for.body.i.i37, !llvm.loop !61
...
for.body.i.i53:                                   ; preds = %for.body.i.i53, %for.body.lr.ph.i.i49
  ...
  store i32 %23, ptr %arrayidx.i13.i.i57, align 4, !tbaa !58
  %26 = load i32, ptr %_size.i9.i.i46, align 4, !tbaa !33
  %inc.i.i.i58 = add nsw i32 %26, 1
  store i32 %inc.i.i.i58, ptr %_size.i9.i.i46, align 4, !tbaa !33
  ...
  br i1 %exitcond.not.i.i60, label %_ZN13CRecordVectorIjEaSERKS0_.exit61, label %for.body.i.i53, !llvm.loop !61
...
if.then.i3.i:                                     ; preds = %_ZN9CMyComPtrI15ICompressCoder2ED2Ev.exit.i
  %vtable.i4.i = load ptr, ptr %9, align 8, !tbaa !15
...
for.body12:                                       ; preds = %for.body12.lr.ph, %for.body12
  ...
  tail call void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %OutStreams)
  %10 = load ptr, ptr %_items.i.i184, align 8, !tbaa !29
  %11 = load i32, ptr %_size.i.i185, align 4, !tbaa !33
  %idxprom.i.i186 = sext i32 %11 to i64
  %arrayidx.i.i187 = getelementptr inbounds ptr, ptr %10, i64 %idxprom.i.i186
  store ptr %call.i176189, ptr %arrayidx.i.i187, align 8, !tbaa !30
  %inc.i.i188 = add nsw i32 %11, 1
  store i32 %inc.i.i188, ptr %_size.i.i185, align 4, !tbaa !33
...
for.inc.i220:                                     ; preds = %for.body.i216
  ...
  br i1 %exitcond397.not, label %for.end.i224, label %for.body.i216, !llvm.loop !73

for.end.i224:                                     ; preds = %for.inc.i220
  %exception.i225 = call ptr @__cxa_allocate_exception(i64 4) #15
  store i32 1, ptr %exception.i225, align 16, !tbaa !58
...
if.then.i257:                                     ; preds = %if.end
  %vtable.i258 = load ptr, ptr %.pr, align 8, !tbaa !15
...
if.then.i263:                                     ; preds = %_ZN9CMyComPtrI19ICompressSetBufSizeED2Ev.exit.thread, %_ZN9CMyComPtrI19ICompressSetBufSizeED2Ev.exit
  ...
  %vtable.i264 = load ptr, ptr %52, align 8, !tbaa !15
...
if.then.i270:                                     ; preds = %ehcleanup82
  %vtable.i271 = load ptr, ptr %58, align 8, !tbaa !15
...
if.then.i277:                                     ; preds = %_ZN9CMyComPtrI19ICompressSetBufSizeED2Ev.exit275
  %vtable.i278 = load ptr, ptr %62, align 8, !tbaa !15
...
for.body.lr.ph.i289:                              ; preds = %for.body99
  ...
  %70 = load ptr, ptr %_items.i.i290, align 8, !tbaa !29
...
for.body.i291:                                    ; preds = %for.inc.i296, %for.body.lr.ph.i289
  ...
  %71 = load i32, ptr %arrayidx.i.i294, align 4, !tbaa !62
...
for.inc.i296:                                     ; preds = %for.body.i291
  ...
  br i1 %exitcond401.not, label %for.end.i300, label %for.body.i291, !llvm.loop !71

for.end.i300:                                     ; preds = %for.body99, %for.inc.i296
  %exception.i301 = call ptr @__cxa_allocate_exception(i64 4) #15
  store i32 1, ptr %exception.i301, align 16, !tbaa !58
...
if.then.i309:                                     ; preds = %_ZNK11NCoderMixer9CBindInfo12FindInStreamEjRjS1_.exit302
  %vtable.i310 = load ptr, ptr %72, align 8, !tbaa !15
...
for.body.lr.ph.i320:                              ; preds = %for.body119
  ...
  %85 = load ptr, ptr %_items.i.i321, align 8, !tbaa !29
...
for.body.i322:                                    ; preds = %for.inc.i327, %for.body.lr.ph.i320
  ...
  %86 = load i32, ptr %NumOutStreams.i325, align 4, !tbaa !64
...
for.inc.i327:                                     ; preds = %for.body.i322
  ...
  br i1 %exitcond405.not, label %for.end.i331, label %for.body.i322, !llvm.loop !73

for.end.i331:                                     ; preds = %for.body119, %for.inc.i327
  %exception.i332 = call ptr @__cxa_allocate_exception(i64 4) #15
  store i32 1, ptr %exception.i332, align 16, !tbaa !58
...
if.then.i341:                                     ; preds = %_ZNK11NCoderMixer9CBindInfo13FindOutStreamEjRjS1_.exit333
  %vtable.i342 = load ptr, ptr %87, align 8, !tbaa !15
...
if.then2.i347:                                    ; preds = %if.end.i345
  %vtable4.i348 = load ptr, ptr %93, align 8, !tbaa !15
...
for.cond.i:                                       ; preds = %for.body.i
  ...
  br i1 %exitcond.not.i, label %for.body.i167, label %for.body.i, !llvm.loop !79
...
for.cond.i172:                                    ; preds = %for.body.i167
  ...
  br i1 %exitcond.not.i174, label %_ZN11NCoderMixer14CCoderMixer2MT13ReturnIfErrorEi.exit175, label %for.body.i167, !llvm.loop !79
...
for.body.i167:                                    ; preds = %for.cond.i, %for.cond.i172
  ...
  %33 = load ptr, ptr %arrayidx.i.i.i169, align 8, !tbaa !30
  %Result.i170 = getelementptr inbounds %"struct.NCoderMixer::CCoder2", ptr %33, i64 0, i32 2
  %34 = load i32, ptr %Result.i170, align 8, !tbaa !80
...
for.cond.i191:                                    ; preds = %for.body.i186
  ...
  br i1 %exitcond.not.i193, label %_ZN11NCoderMixer14CCoderMixer2MT13ReturnIfErrorEi.exit194, label %for.body.i186, !llvm.loop !79
...
for.body.i186:                                    ; preds = %for.cond.i191, %for.body.lr.ph.i183
  ...
  %39 = load ptr, ptr %arrayidx.i.i.i188, align 8, !tbaa !30
  %Result.i189 = getelementptr inbounds %"struct.NCoderMixer::CCoder2", ptr %39, i64 0, i32 2
  %40 = load i32, ptr %Result.i189, align 8, !tbaa !80
...
for.body.i.i.i49:                                 ; preds = %.noexc4.i54, %for.body.lr.ph.i.i.i45
  ...
  %13 = load ptr, ptr %_items.i.i.i.i46, align 8, !tbaa !29
  %arrayidx.i.i.i.i51 = getelementptr inbounds ptr, ptr %13, i64 %indvars.iv.i.i.i50
  %14 = load ptr, ptr %arrayidx.i.i.i.i51, align 8, !tbaa !30
...
.noexc4.i54:                                      ; preds = %for.body.i.i.i49
  %15 = load ptr, ptr %_items.i10.i.i.i47, align 8, !tbaa !29
  %16 = load i32, ptr %_size.i9.i.i.i41, align 4, !tbaa !33
  %idxprom.i12.i.i.i55 = sext i32 %16 to i64
  %arrayidx.i13.i.i.i56 = getelementptr inbounds ptr, ptr %15, i64 %idxprom.i12.i.i.i55
  store ptr %14, ptr %arrayidx.i13.i.i.i56, align 8, !tbaa !30
  %inc.i.i.i.i57 = add nsw i32 %16, 1
  store i32 %inc.i.i.i.i57, ptr %_size.i9.i.i.i41, align 4, !tbaa !33
  ...
  br i1 %exitcond.not.i.i.i59, label %invoke.cont12, label %for.body.i.i.i49, !llvm.loop !114
...
if.then.i33:                                      ; preds = %_ZN9CMyComPtrI14ICompressCoderEC2ERKS1_.exit
  %vtable.i34 = load ptr, ptr %3, align 8, !tbaa !15
...
for.body.i.i.i54:                                 ; preds = %.noexc4.i59, %for.body.lr.ph.i.i.i50
  ...
  %14 = load ptr, ptr %_items.i.i.i.i51, align 8, !tbaa !29
  %arrayidx.i.i.i.i56 = getelementptr inbounds i64, ptr %14, i64 %indvars.iv.i.i.i55
  %15 = load i64, ptr %arrayidx.i.i.i.i56, align 8, !tbaa !41
...
.noexc4.i59:                                      ; preds = %for.body.i.i.i54
  %16 = load ptr, ptr %_items.i10.i.i.i52, align 8, !tbaa !29
  %17 = load i32, ptr %_size.i9.i.i.i46, align 4, !tbaa !33
  %idxprom.i12.i.i.i60 = sext i32 %17 to i64
  %arrayidx.i13.i.i.i61 = getelementptr inbounds i64, ptr %16, i64 %idxprom.i12.i.i.i60
  store i64 %15, ptr %arrayidx.i13.i.i.i61, align 8, !tbaa !41
  %inc.i.i.i.i62 = add nsw i32 %17, 1
  store i32 %inc.i.i.i.i62, ptr %_size.i9.i.i.i46, align 4, !tbaa !33
  ...
  br i1 %exitcond.not.i.i.i64, label %invoke.cont11, label %for.body.i.i.i54, !llvm.loop !115
...
for.body.i.i.i83:                                 ; preds = %.noexc4.i88, %for.body.lr.ph.i.i.i79
  ...
  %20 = load ptr, ptr %_items.i.i.i.i80, align 8, !tbaa !29
  %arrayidx.i.i.i.i85 = getelementptr inbounds ptr, ptr %20, i64 %indvars.iv.i.i.i84
  %21 = load ptr, ptr %arrayidx.i.i.i.i85, align 8, !tbaa !30
...
.noexc4.i88:                                      ; preds = %for.body.i.i.i83
  %22 = load ptr, ptr %_items.i10.i.i.i81, align 8, !tbaa !29
  %23 = load i32, ptr %_size.i9.i.i.i75, align 4, !tbaa !33
  %idxprom.i12.i.i.i89 = sext i32 %23 to i64
  %arrayidx.i13.i.i.i90 = getelementptr inbounds ptr, ptr %22, i64 %idxprom.i12.i.i.i89
  store ptr %21, ptr %arrayidx.i13.i.i.i90, align 8, !tbaa !30
  %inc.i.i.i.i91 = add nsw i32 %23, 1
  store i32 %inc.i.i.i.i91, ptr %_size.i9.i.i.i75, align 4, !tbaa !33
  ...
  br i1 %exitcond.not.i.i.i93, label %invoke.cont14, label %for.body.i.i.i83, !llvm.loop !116
...
for.body.i.i.i111:                                ; preds = %.noexc4.i116, %for.body.lr.ph.i.i.i107
  ...
  %26 = load ptr, ptr %_items.i.i.i.i108, align 8, !tbaa !29
  %arrayidx.i.i.i.i113 = getelementptr inbounds ptr, ptr %26, i64 %indvars.iv.i.i.i112
  %27 = load ptr, ptr %arrayidx.i.i.i.i113, align 8, !tbaa !30
...
.noexc4.i116:                                     ; preds = %for.body.i.i.i111
  %28 = load ptr, ptr %_items.i10.i.i.i109, align 8, !tbaa !29
  %29 = load i32, ptr %_size.i9.i.i.i103, align 4, !tbaa !33
  %idxprom.i12.i.i.i117 = sext i32 %29 to i64
  %arrayidx.i13.i.i.i118 = getelementptr inbounds ptr, ptr %28, i64 %idxprom.i12.i.i.i117
  store ptr %27, ptr %arrayidx.i13.i.i.i118, align 8, !tbaa !30
  %inc.i.i.i.i119 = add nsw i32 %29, 1
  store i32 %inc.i.i.i.i119, ptr %_size.i9.i.i.i103, align 4, !tbaa !33
  ...
  br i1 %exitcond.not.i.i.i121, label %invoke.cont17, label %for.body.i.i.i111, !llvm.loop !116
...
if.then.i124:                                     ; preds = %ehcleanup19
  %vtable.i125 = load ptr, ptr %31, align 8, !tbaa !15
...
if.then.i129:                                     ; preds = %ehcleanup20
  %vtable.i130 = load ptr, ptr %35, align 8, !tbaa !15
