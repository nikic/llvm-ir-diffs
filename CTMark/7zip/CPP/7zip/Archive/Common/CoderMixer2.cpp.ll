...
entry:
  ...
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CRecordVectorIjE, i64 0, inrange i32 0, i64 2), ptr %_srcInToDestOutMap, align 8
  ...
  store i64 4, ptr %_itemSize.i.i118, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CRecordVectorIjE, i64 0, inrange i32 0, i64 2), ptr %_srcOutToDestInMap, align 8
  ...
  store i64 4, ptr %_itemSize.i.i120, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CRecordVectorIjE, i64 0, inrange i32 0, i64 2), ptr %_destInToSrcOutMap, align 8
  ...
  store i64 4, ptr %_itemSize.i.i122, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CRecordVectorIjE, i64 0, inrange i32 0, i64 2), ptr %DestOutToSrcInMap, align 8
  %NumSrcInStreams = getelementptr inbounds %"class.NCoderMixer::CBindReverseConverter", ptr %this, i64 0, i32 5
  store i32 0, ptr %NumSrcInStreams, align 8
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  %add.i = add i32 %3, %4
  store i32 %add.i, ptr %NumSrcInStreams, align 8
  %NumOutStreams.i = getelementptr inbounds %"struct.NCoderMixer::CCoderStreamsInfo", ptr %1, i64 %indvars.iv.i, i32 1
  %5 = load i32, ptr %NumOutStreams.i, align 4
  %add4.i = add i32 %2, %5
  store i32 %add4.i, ptr %this, align 8
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %6 = load i32, ptr %_size.i.i, align 4
  %7 = sext i32 %6 to i64
  %cmp.i = icmp slt i64 %indvars.iv.next.i, %7
  br i1 %cmp.i, label %for.body.i, label %_ZNK11NCoderMixer9CBindInfo13GetNumStreamsERjS1_.exit
...
for.inc:                                          ; preds = %invoke.cont13
  %13 = load ptr, ptr %_items.i123, align 8
  %14 = load i32, ptr %_size.i124, align 4
  ...
  %15 = load i32, ptr %_size.i124, align 4
  %inc.i127 = add nsw i32 %15, 1
  store i32 %inc.i127, ptr %_size.i124, align 4
  %inc = add nuw i32 %j.0159, 1
  %16 = load i32, ptr %NumSrcInStreams, align 8
  %cmp = icmp ult i32 %inc, %16
  br i1 %cmp, label %for.body, label %for.cond17.preheader.loopexit
...
invoke.cont22:                                    ; preds = %for.body20
  %17 = load ptr, ptr %_items.i129, align 8
  %18 = load i32, ptr %_size.i130, align 4
  %idxprom.i131 = sext i32 %18 to i64
  %arrayidx.i132 = getelementptr inbounds i32, ptr %17, i64 %idxprom.i131
  store i32 0, ptr %arrayidx.i132, align 4
  %19 = load i32, ptr %_size.i130, align 4
  %inc.i133 = add nsw i32 %19, 1
  store i32 %inc.i133, ptr %_size.i130, align 4
...
for.inc27:                                        ; preds = %invoke.cont22
  %20 = load ptr, ptr %_items.i135, align 8
  %21 = load i32, ptr %_size.i136, align 4
  %idxprom.i137 = sext i32 %21 to i64
  %arrayidx.i138 = getelementptr inbounds i32, ptr %20, i64 %idxprom.i137
  store i32 0, ptr %arrayidx.i138, align 4
  %22 = load i32, ptr %_size.i136, align 4
  %inc.i139 = add nsw i32 %22, 1
  store i32 %inc.i139, ptr %_size.i136, align 4
...
for.cond35.loopexit:                              ; preds = %for.body63, %for.cond60.preheader
  ...
  br i1 %cmp36, label %for.body37, label %for.cond.cleanup
...
for.body37:                                       ; preds = %for.body37.lr.ph, %for.cond35.loopexit
  ...
  %31 = load i32, ptr %arrayidx.i144, align 4
  ...
  %32 = load i32, ptr %NumOutStreams, align 4
...
for.cond60.preheader.loopexit:                    ; preds = %for.body48
  %.pre179 = load i32, ptr %NumOutStreams, align 4
...
entry:
  ...
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CRecordVectorIN11NCoderMixer17CCoderStreamsInfoEE, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
.noexc4.i:                                        ; preds = %for.body.i.i.i
  ...
  br i1 %exitcond.not.i.i.i, label %_ZN13CRecordVectorIN11NCoderMixer17CCoderStreamsInfoEEC2ERKS2_.exit, label %for.body.i.i.i
...
_ZN13CRecordVectorIN11NCoderMixer17CCoderStreamsInfoEEC2ERKS2_.exit: ; preds = %.noexc4.i, %.noexc3.i
  ...
  store i64 8, ptr %_itemSize.i.i18, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CRecordVectorIN11NCoderMixer9CBindPairEE, i64 0, inrange i32 0, i64 2), ptr %BindPairs, align 8
...
for.body.i.i.i33:                                 ; preds = %.noexc4.i39, %for.body.lr.ph.i.i.i29
  ...
  %9 = load ptr, ptr %_items.i.i.i.i30, align 8
  %arrayidx.i.i.i.i35 = getelementptr inbounds %"struct.NCoderMixer::CBindPair", ptr %9, i64 %indvars.iv.i.i.i34
  %agg.tmp.sroa.0.0.copyload.i.i.i36 = load i64, ptr %arrayidx.i.i.i.i35, align 4
...
.noexc4.i39:                                      ; preds = %for.body.i.i.i33
  %10 = load ptr, ptr %_items.i10.i.i.i31, align 8
  %11 = load i32, ptr %_size.i9.i.i.i25, align 4
  ...
  store i64 %agg.tmp.sroa.0.0.copyload.i.i.i36, ptr %arrayidx.i13.i.i.i41, align 4
  %12 = load i32, ptr %_size.i9.i.i.i25, align 4
  %inc.i.i.i.i42 = add nsw i32 %12, 1
  store i32 %inc.i.i.i.i42, ptr %_size.i9.i.i.i25, align 4
  ...
  br i1 %exitcond.not.i.i.i44, label %invoke.cont, label %for.body.i.i.i33
...
invoke.cont:                                      ; preds = %.noexc4.i39, %.noexc3.i27
  ...
  store i64 4, ptr %_itemSize.i.i46, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CRecordVectorIjE, i64 0, inrange i32 0, i64 2), ptr %InStreams, align 8
...
for.body.i.i.i61:                                 ; preds = %.noexc4.i66, %for.body.lr.ph.i.i.i57
  ...
  %15 = load ptr, ptr %_items.i.i.i.i58, align 8
  %arrayidx.i.i.i.i63 = getelementptr inbounds i32, ptr %15, i64 %indvars.iv.i.i.i62
  %16 = load i32, ptr %arrayidx.i.i.i.i63, align 4
...
.noexc4.i66:                                      ; preds = %for.body.i.i.i61
  %17 = load ptr, ptr %_items.i10.i.i.i59, align 8
  %18 = load i32, ptr %_size.i9.i.i.i53, align 4
  %idxprom.i12.i.i.i67 = sext i32 %18 to i64
  %arrayidx.i13.i.i.i68 = getelementptr inbounds i32, ptr %17, i64 %idxprom.i12.i.i.i67
  store i32 %16, ptr %arrayidx.i13.i.i.i68, align 4
  %19 = load i32, ptr %_size.i9.i.i.i53, align 4
  %inc.i.i.i.i69 = add nsw i32 %19, 1
  store i32 %inc.i.i.i.i69, ptr %_size.i9.i.i.i53, align 4
  ...
  br i1 %exitcond.not.i.i.i71, label %invoke.cont6, label %for.body.i.i.i61
...
invoke.cont6:                                     ; preds = %.noexc4.i66, %.noexc3.i55
  ...
  store i64 4, ptr %_itemSize.i.i74, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CRecordVectorIjE, i64 0, inrange i32 0, i64 2), ptr %OutStreams, align 8
...
for.body.i.i.i89:                                 ; preds = %.noexc4.i94, %for.body.lr.ph.i.i.i85
  ...
  %22 = load ptr, ptr %_items.i.i.i.i86, align 8
  %arrayidx.i.i.i.i91 = getelementptr inbounds i32, ptr %22, i64 %indvars.iv.i.i.i90
  %23 = load i32, ptr %arrayidx.i.i.i.i91, align 4
...
.noexc4.i94:                                      ; preds = %for.body.i.i.i89
  %24 = load ptr, ptr %_items.i10.i.i.i87, align 8
  %25 = load i32, ptr %_size.i9.i.i.i81, align 4
  %idxprom.i12.i.i.i95 = sext i32 %25 to i64
  %arrayidx.i13.i.i.i96 = getelementptr inbounds i32, ptr %24, i64 %idxprom.i12.i.i.i95
  store i32 %23, ptr %arrayidx.i13.i.i.i96, align 4
  %26 = load i32, ptr %_size.i9.i.i.i81, align 4
  %inc.i.i.i.i97 = add nsw i32 %26, 1
  store i32 %inc.i.i.i.i97, ptr %_size.i9.i.i.i81, align 4
  ...
  br i1 %exitcond.not.i.i.i99, label %invoke.cont9, label %for.body.i.i.i89
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %5 = load ptr, ptr %_items.i81, align 8
  %6 = load i32, ptr %_size.i82, align 4
  ...
  store i64 %destCoderInfo.sroa.0.0.insert.insert, ptr %arrayidx.i84, align 4
  %7 = load i32, ptr %_size.i82, align 4
  %inc.i = add nsw i32 %7, 1
  store i32 %inc.i, ptr %_size.i82, align 4
...
for.end:                                          ; preds = %for.body, %entry
  ...
  %8 = load i32, ptr %_size.i85, align 4
...
for.cond30.preheader:                             ; preds = %for.body16, %for.end
  ...
  %10 = load i32, ptr %_size.i100, align 4
...
for.body16:                                       ; preds = %for.body16.lr.ph, %for.body16
  ...
  %11 = load ptr, ptr %_items.i86, align 8
  ...
  %18 = load ptr, ptr %_items.i95, align 8
  %19 = load i32, ptr %_size.i96, align 4
  %idxprom.i97 = sext i32 %19 to i64
  %arrayidx.i98 = getelementptr inbounds %"struct.NCoderMixer::CBindPair", ptr %18, i64 %idxprom.i97
  store i64 %destBindPair.sroa.0.0.insert.insert, ptr %arrayidx.i98, align 4
  %20 = load i32, ptr %_size.i96, align 4
  %inc.i99 = add nsw i32 %20, 1
  store i32 %inc.i99, ptr %_size.i96, align 4
  %cmp15 = icmp ugt i64 %indvars.iv133, 1
  br i1 %cmp15, label %for.body16, label %for.cond30.preheader
...
for.cond45.preheader:                             ; preds = %for.body35, %for.cond30.preheader
  ...
  %21 = load i32, ptr %_size.i112, align 4
...
for.body50:                                       ; preds = %for.body50.lr.ph, %for.body50
  ...
  %35 = load ptr, ptr %_items.i119, align 8
  %36 = load i32, ptr %_size.i120, align 4
  %idxprom.i121 = sext i32 %36 to i64
  %arrayidx.i122 = getelementptr inbounds i32, ptr %35, i64 %idxprom.i121
  store i32 %34, ptr %arrayidx.i122, align 4
  %37 = load i32, ptr %_size.i120, align 4
  %inc.i123 = add nsw i32 %37, 1
  store i32 %inc.i123, ptr %_size.i120, align 4
  %indvars.iv.next142 = add nuw nsw i64 %indvars.iv141, 1
  %38 = load i32, ptr %_size.i112, align 4
...
entry:
  ...
  store i32 %numInStreams, ptr %NumInStreams, align 8
  %NumOutStreams = getelementptr inbounds %"struct.NCoderMixer::CCoderInfo2", ptr %this, i64 0, i32 3
  store i32 %numOutStreams, ptr %NumOutStreams, align 4
  ...
  store i64 8, ptr %_itemSize.i.i29, align 8
  ...
  store i64 8, ptr %_itemSize.i.i31, align 8
  ...
  store i64 8, ptr %_itemSize.i.i33, align 8
...
invoke.cont19:                                    ; preds = %invoke.cont16
  %2 = load i32, ptr %NumOutStreams, align 4
...
if.then.i35:                                      ; preds = %_ZN9CMyComPtrI15ICompressCoder2ED2Ev.exit
  %vtable.i36 = load ptr, ptr %8, align 8
