; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Archive/Common/FindSignature.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Archive/Common/FindSignature.cpp"
...
entry:
  ...
  store i64 0, ptr %resPos, align 8
...
invoke.cont16:                                    ; preds = %if.end.i164
  ...
  store i64 1, ptr %resPos, align 8
...
for.body.lr.ph:                                   ; preds = %do.end
  %6 = load i8, ptr %signature, align 1
...
for.cond52:                                       ; preds = %if.end63
  ...
  br i1 %cmp53, label %for.body, label %cleanup87
...
for.cond54:                                       ; preds = %for.cond54, %for.body
  ...
  br i1 %10, label %for.cond54, label %for.end
