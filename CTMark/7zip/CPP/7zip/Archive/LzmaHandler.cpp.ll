...
if.then.i54:                                      ; preds = %ehcleanup
  %vtable.i55 = load ptr, ptr %14, align 8, !tbaa !21
...
if.then.i4:                                       ; preds = %invoke.cont
  %vtable.i5 = load ptr, ptr %3, align 8, !tbaa !21
...
if.then.i8:                                       ; preds = %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit
  %vtable.i9 = load ptr, ptr %7, align 8, !tbaa !21
...
if.then.i150:                                     ; preds = %ehcleanup
  %vtable.i151 = load ptr, ptr %14, align 8, !tbaa !21
...
if.then.i161:                                     ; preds = %invoke.cont92
  %vtable.i162 = load ptr, ptr %33, align 8, !tbaa !21
...
if.then.i167:                                     ; preds = %ehcleanup98
  %vtable.i168 = load ptr, ptr %38, align 8, !tbaa !21
...
if.then.i174:                                     ; preds = %cleanup112
  %vtable.i175 = load ptr, ptr %.pr194, align 8, !tbaa !21
...
if.then.i180:                                     ; preds = %ehcleanup113
  %vtable.i181 = load ptr, ptr %45, align 8, !tbaa !21
...
for.cond.i.i43:                                   ; preds = %for.cond.i.i43.preheader, %for.cond.i.i43
  ...
  %12 = load i8, ptr %arrayidx.i.i45, align 1, !tbaa !10
  %cmp.not.i.i46 = icmp eq i8 %12, 0
  %indvars.iv.next.i.i47 = add nuw i64 %indvars.iv.i.i44, 1
  br i1 %cmp.not.i.i46, label %_Z11MyStringLenIcEiPKT_.exit.i48, label %for.cond.i.i43, !llvm.loop !53
...
_Z11MyStringLenIcEiPKT_.exit.i48:                 ; preds = %for.cond.i.i43
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(6) %add.ptr.i51, ptr noundef nonnull align 1 dereferenceable(6) @.str.1, i64 6, i1 false), !tbaa !10
...
for.cond.i.i60:                                   ; preds = %if.end9.i, %for.cond.i.i60
  ...
  %15 = load i8, ptr %arrayidx.i.i62, align 1, !tbaa !10
  %cmp.not.i.i63 = icmp eq i8 %15, 0
  %indvars.iv.next.i.i64 = add nuw i64 %indvars.iv.i.i61, 1
  br i1 %cmp.not.i.i63, label %_Z11MyStringLenIcEiPKT_.exit.i65, label %for.cond.i.i60, !llvm.loop !53
...
_Z11MyStringLenIcEiPKT_.exit.i65:                 ; preds = %for.cond.i.i60
  ...
  store i8 %c.0.i, ptr %arrayidx.i67, align 1, !tbaa !10
...
if.end.i52:                                       ; preds = %if.end.i, %if.then2.i
  ...
  %vtable.i49 = load ptr, ptr %inStream, align 8, !tbaa !21
...
if.then2.i54:                                     ; preds = %if.end.i52
  %vtable4.i55 = load ptr, ptr %13, align 8, !tbaa !21
...
if.then.i3:                                       ; preds = %_ZN9CMyComPtrI9IInStreamE7ReleaseEv.exit
  %vtable.i4 = load ptr, ptr %2, align 8, !tbaa !21
...
invoke.cont52:                                    ; preds = %invoke.cont49
  %vtable.i267 = load ptr, ptr %call50, align 8, !tbaa !21
...
if.then.i275:                                     ; preds = %for.end.thread408, %for.end.thread
  %opRes.1.ph346 = phi i32 [ %opRes.1.ph.ph, %for.end.thread ], [ 0, %for.end.thread408 ]
  %vtable.i276 = load ptr, ptr %call37, align 8, !tbaa !21
...
if.then.i.i282:                                   ; preds = %cleanup175
  ...
  %vtable.i.i283 = load ptr, ptr %51, align 8, !tbaa !21
...
if.then.i4.i:                                     ; preds = %invoke.cont.i
  %vtable.i5.i = load ptr, ptr %53, align 8, !tbaa !21
...
if.then.i8.i:                                     ; preds = %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit.i
  %vtable.i9.i = load ptr, ptr %57, align 8, !tbaa !21
...
if.then.i286:                                     ; preds = %_ZN8NArchive5NLzma8CDecoderD2Ev.exit, %invoke.cont69
  ...
  %vtable.i287 = load ptr, ptr %call50, align 8, !tbaa !21
...
if.then.i291:                                     ; preds = %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit
  %vtable.i292 = load ptr, ptr %outStream.sroa.0.4, align 8, !tbaa !21
...
if.then.i297:                                     ; preds = %lpad55, %lpad64, %ehcleanup176
  ...
  %vtable.i298 = load ptr, ptr %call50, align 8, !tbaa !21
...
if.then.i304:                                     ; preds = %lpad53, %lpad42, %lpad48, %lpad51, %ehcleanup188
  %.pn247.pn.pn.pn.pn.pn.pn351 = phi { ptr, i32 } [ %.pn247.pn.pn.pn, %ehcleanup188 ], [ %27, %lpad53 ], [ %25, %lpad48 ], [ %26, %lpad51 ], [ %24, %lpad42 ]
  %outStream.sroa.0.7350 = phi ptr [ %outStream.sroa.0.5, %ehcleanup188 ], [ %call37, %lpad53 ], [ %call37, %lpad48 ], [ %call37, %lpad51 ], [ %call37, %lpad42 ]
  %vtable.i305 = load ptr, ptr %outStream.sroa.0.7350, align 8, !tbaa !21
  %vfn.i306 = getelementptr inbounds ptr, ptr %vtable.i305, i64 2
  %72 = load ptr, ptr %vfn.i306, align 8
  %call.i307 = invoke noundef i32 %72(ptr noundef nonnull align 8 dereferenceable(8) %outStream.sroa.0.7350)
...
if.then.i311:                                     ; preds = %cleanup193
  %vtable.i312 = load ptr, ptr %.pr, align 8, !tbaa !21
...
_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit316: ; preds = %cleanup.cont, %cleanup193, %if.then.i311
  %retval.12355 = phi i32 [ %retval.12.ph, %cleanup193 ], [ %retval.12.ph, %if.then.i311 ], [ 0, %cleanup.cont ]
...
ehcleanup194:                                     ; preds = %lpad40, %ehcleanup188, %if.then.i304, %lpad35, %lpad26, %lpad14
  %.pn247.pn.pn.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %8, %lpad26 ], [ %6, %lpad14 ], [ %22, %lpad35 ], [ %23, %lpad40 ], [ %.pn247.pn.pn.pn, %ehcleanup188 ], [ %.pn247.pn.pn.pn.pn.pn.pn351, %if.then.i304 ]
...
if.then.i318:                                     ; preds = %ehcleanup194
  %vtable.i319 = load ptr, ptr %78, align 8, !tbaa !21
...
for.cond.i23:                                     ; preds = %if.end
  ...
  %33 = load i8, ptr %arrayidx.1.i24, align 1, !tbaa !10
...
for.cond.1.i26:                                   ; preds = %for.cond.i23
  ...
  %35 = load i8, ptr %arrayidx.2.i27, align 2, !tbaa !10
...
for.cond.2.i29:                                   ; preds = %for.cond.1.i26
  ...
  %37 = load i8, ptr %arrayidx.3.i30, align 1, !tbaa !10
...
for.cond.3.i32:                                   ; preds = %for.cond.2.i29
  ...
  %39 = load i8, ptr %arrayidx.4.i33, align 4, !tbaa !10
...
for.cond.4.i35:                                   ; preds = %for.cond.3.i32
  ...
  %41 = load i8, ptr %arrayidx.5.i36, align 1, !tbaa !10
...
for.cond.5.i38:                                   ; preds = %for.cond.4.i35
  ...
  %43 = load i8, ptr %arrayidx.6.i39, align 2, !tbaa !10
...
for.cond.6.i41:                                   ; preds = %for.cond.5.i38
  ...
  %45 = load i8, ptr %arrayidx.7.i42, align 1, !tbaa !10
...
for.cond.7.i44:                                   ; preds = %for.cond.6.i41
  ...
  %47 = load i8, ptr %arrayidx.8.i45, align 4, !tbaa !10
...
for.cond.8.i47:                                   ; preds = %for.cond.7.i44
  ...
  %49 = load i8, ptr %arrayidx.9.i48, align 1, !tbaa !10
...
for.cond.9.i50:                                   ; preds = %for.cond.8.i47
  ...
  %51 = load i8, ptr %arrayidx.10.i51, align 2, !tbaa !10
...
for.cond.10.i53:                                  ; preds = %for.cond.9.i50
  ...
  %53 = load i8, ptr %arrayidx.11.i54, align 1, !tbaa !10
...
for.cond.11.i56:                                  ; preds = %for.cond.10.i53
  ...
  %55 = load i8, ptr %arrayidx.12.i57, align 4, !tbaa !10
...
for.cond.12.i59:                                  ; preds = %for.cond.11.i56
  ...
  %57 = load i8, ptr %arrayidx.13.i60, align 1, !tbaa !10
...
for.cond.13.i62:                                  ; preds = %for.cond.12.i59
  ...
  %59 = load i8, ptr %arrayidx.14.i63, align 2, !tbaa !10
...
_ZeqRK4GUIDS1_.exit69:                            ; preds = %for.cond.13.i62
  ...
  %61 = load i8, ptr %arrayidx.15.i66, align 1, !tbaa !10
...
for.cond.i72:                                     ; preds = %if.end9
  ...
  %64 = load i8, ptr %arrayidx.1.i73, align 1, !tbaa !10
...
for.cond.1.i75:                                   ; preds = %for.cond.i72
  ...
  %66 = load i8, ptr %arrayidx.2.i76, align 2, !tbaa !10
...
for.cond.2.i78:                                   ; preds = %for.cond.1.i75
  ...
  %68 = load i8, ptr %arrayidx.3.i79, align 1, !tbaa !10
...
for.cond.3.i81:                                   ; preds = %for.cond.2.i78
  ...
  %70 = load i8, ptr %arrayidx.4.i82, align 4, !tbaa !10
...
for.cond.4.i84:                                   ; preds = %for.cond.3.i81
  ...
  %72 = load i8, ptr %arrayidx.5.i85, align 1, !tbaa !10
...
for.cond.5.i87:                                   ; preds = %for.cond.4.i84
  ...
  %74 = load i8, ptr %arrayidx.6.i88, align 2, !tbaa !10
...
for.cond.6.i90:                                   ; preds = %for.cond.5.i87
  ...
  %76 = load i8, ptr %arrayidx.7.i91, align 1, !tbaa !10
...
for.cond.7.i93:                                   ; preds = %for.cond.6.i90
  ...
  %78 = load i8, ptr %arrayidx.8.i94, align 4, !tbaa !10
...
for.cond.8.i96:                                   ; preds = %for.cond.7.i93
  ...
  %80 = load i8, ptr %arrayidx.9.i97, align 1, !tbaa !10
...
for.cond.9.i99:                                   ; preds = %for.cond.8.i96
  ...
  %82 = load i8, ptr %arrayidx.10.i100, align 2, !tbaa !10
...
for.cond.10.i102:                                 ; preds = %for.cond.9.i99
  ...
  %84 = load i8, ptr %arrayidx.11.i103, align 1, !tbaa !10
...
for.cond.11.i105:                                 ; preds = %for.cond.10.i102
  ...
  %86 = load i8, ptr %arrayidx.12.i106, align 4, !tbaa !10
...
for.cond.12.i108:                                 ; preds = %for.cond.11.i105
  ...
  %88 = load i8, ptr %arrayidx.13.i109, align 1, !tbaa !10
...
for.cond.13.i111:                                 ; preds = %for.cond.12.i108
  ...
  %90 = load i8, ptr %arrayidx.14.i112, align 2, !tbaa !10
...
_ZeqRK4GUIDS1_.exit118:                           ; preds = %for.cond.13.i111
  ...
  %92 = load i8, ptr %arrayidx.15.i115, align 1, !tbaa !10
...
if.then.i3:                                       ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit
  %vtable.i4 = load ptr, ptr %4, align 8, !tbaa !21
  %vfn.i5 = getelementptr inbounds ptr, ptr %vtable.i4, i64 2
...
if.then.i3.i:                                     ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.i
  %vtable.i4.i = load ptr, ptr %4, align 8, !tbaa !21
...
if.then.i3.i:                                     ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.i
  %vtable.i4.i = load ptr, ptr %5, align 8, !tbaa !21
  %vfn.i5.i = getelementptr inbounds ptr, ptr %vtable.i4.i, i64 2
...
if.then.i3.i.i:                                   ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.i.i
  %vtable.i4.i.i = load ptr, ptr %5, align 8, !tbaa !21
