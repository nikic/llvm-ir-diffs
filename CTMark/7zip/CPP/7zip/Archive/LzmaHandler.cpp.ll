; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Archive/LzmaHandler.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Archive/LzmaHandler.cpp"
...
%"class.NArchive::NLzma::CHandler" = type { %struct.IInArchive, %struct.IArchiveOpenSeq, %class.CMyUnknownImp, %"struct.NArchive::NLzma::CHeader", i8, i64, i64, i8, %class.CMyComPtr.5, %class.CMyComPtr.1 }
...
%"class.NCompress::NLzma::CDecoder" = type <{ %struct.ICompressCoder, %struct.ICompressSetDecoderProperties2, %struct.ICompressSetBufSize, %struct.ICompressSetInStream, %struct.ICompressSetOutStreamSize, %struct.ISequentialInStream, %class.CMyUnknownImp, [4 x i8], %class.CMyComPtr.1, ptr, i32, i32, %struct.CLzmaDec, i8, i8, [6 x i8], i64, i64, i64, i32, i32, i32, [4 x i8], i64, i8, [7 x i8] }>
...
entry:
  ...
  store i8 0, ptr %FilterID, align 8
...
land.rhs:                                         ; preds = %if.end
  %add.ptr18.val = load i32, ptr %arrayidx6.1, align 4
...
invoke.cont:                                      ; preds = %if.then
  ...
  %2 = load ptr, ptr %_lzmaDecoder, align 8
...
_ZN9CMyComPtrI14ICompressCoderEaSEPS0_.exit:      ; preds = %invoke.cont, %if.then2.i
  store ptr %call2, ptr %_lzmaDecoder, align 8
  br label %if.end
...
if.then6:                                         ; preds = %if.end
  ...
  %5 = load ptr, ptr %_bcjStream, align 8
...
invoke.cont22:                                    ; preds = %if.end18
  %10 = load ptr, ptr %_bcjStream, align 8
...
if.then.i:                                        ; preds = %cleanup29
  %vtable.i50 = load ptr, ptr %.pr, align 8
...
ehcleanup:                                        ; preds = %lpad14, %lpad9
  ...
  br i1 %tobool.not.i53, label %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit59, label %if.then.i54

if.then.i54:                                      ; preds = %ehcleanup
  %vtable.i55 = load ptr, ptr %14, align 8
  %vfn.i56 = getelementptr inbounds ptr, ptr %vtable.i55, i64 2
  %15 = load ptr, ptr %vfn.i56, align 8
  %call.i57 = invoke noundef i32 %15(ptr noundef nonnull align 8 dereferenceable(8) %14)
...
_ZN9CMyComPtrI14ICompressCoderED2Ev.exit59:       ; preds = %ehcleanup, %if.then.i54
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %coder) #19
  br label %eh.resume
...
entry:
  ...
  %0 = load ptr, ptr %_lzmaDecoder.i, align 8
...
invoke.cont:                                      ; preds = %entry, %if.then.i
  %_bcjStream = getelementptr inbounds %"class.NArchive::NLzma::CDecoder", ptr %this, i64 0, i32 2
  %3 = load ptr, ptr %_bcjStream, align 8
  %tobool.not.i3 = icmp eq ptr %3, null
  br i1 %tobool.not.i3, label %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit, label %if.then.i4

if.then.i4:                                       ; preds = %invoke.cont
  %vtable.i5 = load ptr, ptr %3, align 8
  %vfn.i6 = getelementptr inbounds ptr, ptr %vtable.i5, i64 2
  %4 = load ptr, ptr %vfn.i6, align 8
...
_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit:   ; preds = %invoke.cont, %if.then.i4
  %7 = load ptr, ptr %_lzmaDecoder.i, align 8
  %tobool.not.i7 = icmp eq ptr %7, null
  br i1 %tobool.not.i7, label %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit, label %if.then.i8

if.then.i8:                                       ; preds = %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit
  %vtable.i9 = load ptr, ptr %7, align 8
  %vfn.i10 = getelementptr inbounds ptr, ptr %vtable.i9, i64 2
  %8 = load ptr, ptr %vfn.i10, align 8
  %call.i11 = invoke noundef i32 %8(ptr noundef nonnull align 8 dereferenceable(8) %7)
          to label %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit unwind label %terminate.lpad.i12

terminate.lpad.i12:                               ; preds = %if.then.i8
...
_ZN9CMyComPtrI14ICompressCoderED2Ev.exit:         ; preds = %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit, %if.then.i8
  ret void
...
entry:
  ...
  %0 = load i8, ptr %FilterID, align 8
  %cmp = icmp ugt i8 %0, 1
...
if.end:                                           ; preds = %entry
  ...
  %_lzmaDecoder = getelementptr inbounds %"class.NArchive::NLzma::CDecoder", ptr %this, i64 0, i32 1
  %1 = load ptr, ptr %_lzmaDecoder, align 8
  %vtable.i = load ptr, ptr %1, align 8
...
invoke.cont2:                                     ; preds = %if.end
  %3 = load ptr, ptr %setDecoderProperties, align 8
...
cleanup16:                                        ; preds = %if.end7
  ...
  %.pr = load ptr, ptr %setDecoderProperties, align 8
...
if.then.i:                                        ; preds = %cleanup16
  %vtable.i144 = load ptr, ptr %.pr, align 8
...
cleanup.cont19:                                   ; preds = %_ZN9CMyComPtrI30ICompressSetDecoderProperties2ED2Ev.exit
  ...
  store ptr null, ptr %setOutStream, align 8
  %10 = load i8, ptr %FilterID, align 8
  %cmp23 = icmp eq i8 %10, 1
  br i1 %cmp23, label %if.then24, label %if.end52

if.then24:                                        ; preds = %cleanup.cont19
  %_bcjStream = getelementptr inbounds %"class.NArchive::NLzma::CDecoder", ptr %this, i64 0, i32 2
  %11 = load ptr, ptr %_bcjStream, align 8
  %vtable.i145 = load ptr, ptr %11, align 8
...
invoke.cont28:                                    ; preds = %if.then24
  %13 = load ptr, ptr %setOutStream, align 8
...
ehcleanup:                                        ; preds = %lpad8, %lpad
  ...
  %14 = load ptr, ptr %setDecoderProperties, align 8
  %tobool.not.i149 = icmp eq ptr %14, null
  br i1 %tobool.not.i149, label %_ZN9CMyComPtrI30ICompressSetDecoderProperties2ED2Ev.exit155, label %if.then.i150

if.then.i150:                                     ; preds = %ehcleanup
  %vtable.i151 = load ptr, ptr %14, align 8
  %vfn.i152 = getelementptr inbounds ptr, ptr %vtable.i151, i64 2
  %15 = load ptr, ptr %vfn.i152, align 8
  %call.i153 = invoke noundef i32 %15(ptr noundef nonnull align 8 dereferenceable(8) %14)
...
_ZN9CMyComPtrI30ICompressSetDecoderProperties2ED2Ev.exit155: ; preds = %ehcleanup, %if.then.i150
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %setDecoderProperties) #19
  br label %eh.resume
...
if.end33:                                         ; preds = %invoke.cont28
  %vtable38 = load ptr, ptr %13, align 8
...
if.then61:                                        ; preds = %invoke.cont58
  ...
  %24 = load ptr, ptr %_bcjStream64, align 8
  %vtable.i157 = load ptr, ptr %24, align 8
...
if.end85:                                         ; preds = %invoke.cont79, %invoke.cont68
  ...
  %31 = load ptr, ptr %setOutStream, align 8
  %vtable90 = load ptr, ptr %31, align 8
...
invoke.cont92:                                    ; preds = %if.end85
  ...
  %33 = load ptr, ptr %flush, align 8
  %tobool.not.i160 = icmp eq ptr %33, null
  br i1 %tobool.not.i160, label %_ZN9CMyComPtrI15IOutStreamFlushED2Ev.exit, label %if.then.i161

if.then.i161:                                     ; preds = %invoke.cont92
  %vtable.i162 = load ptr, ptr %33, align 8
  %vfn.i163 = getelementptr inbounds ptr, ptr %vtable.i162, i64 2
  %34 = load ptr, ptr %vfn.i163, align 8
  %call.i164 = invoke noundef i32 %34(ptr noundef nonnull align 8 dereferenceable(8) %33)
          to label %_ZN9CMyComPtrI15IOutStreamFlushED2Ev.exit unwind label %terminate.lpad.i165

terminate.lpad.i165:                              ; preds = %if.then.i161
...
_ZN9CMyComPtrI15IOutStreamFlushED2Ev.exit:        ; preds = %invoke.cont92, %if.then.i161
...
ehcleanup98:                                      ; preds = %lpad87, %lpad74, %lpad65
  ...
  %38 = load ptr, ptr %flush, align 8
  %tobool.not.i166 = icmp eq ptr %38, null
  br i1 %tobool.not.i166, label %_ZN9CMyComPtrI15IOutStreamFlushED2Ev.exit172, label %if.then.i167

if.then.i167:                                     ; preds = %ehcleanup98
  %vtable.i168 = load ptr, ptr %38, align 8
  %vfn.i169 = getelementptr inbounds ptr, ptr %vtable.i168, i64 2
  %39 = load ptr, ptr %vfn.i169, align 8
  %call.i170 = invoke noundef i32 %39(ptr noundef nonnull align 8 dereferenceable(8) %38)
          to label %_ZN9CMyComPtrI15IOutStreamFlushED2Ev.exit172 unwind label %terminate.lpad.i171

terminate.lpad.i171:                              ; preds = %if.then.i167
...
_ZN9CMyComPtrI15IOutStreamFlushED2Ev.exit172:     ; preds = %ehcleanup98, %if.then.i167
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %flush) #19
  br label %ehcleanup113
...
cleanup112:                                       ; preds = %invoke.cont58, %_ZN9CMyComPtrI15IOutStreamFlushED2Ev.exit, %invoke.cont40
  ...
  %.pr194 = load ptr, ptr %setOutStream, align 8
  %tobool.not.i173 = icmp eq ptr %.pr194, null
  br i1 %tobool.not.i173, label %_ZN9CMyComPtrI21ICompressSetOutStreamED2Ev.exit, label %if.then.i174

if.then.i174:                                     ; preds = %cleanup112
  %vtable.i175 = load ptr, ptr %.pr194, align 8
  %vfn.i176 = getelementptr inbounds ptr, ptr %vtable.i175, i64 2
  %42 = load ptr, ptr %vfn.i176, align 8
  %call.i177 = invoke noundef i32 %42(ptr noundef nonnull align 8 dereferenceable(8) %.pr194)
...
_ZN9CMyComPtrI21ICompressSetOutStreamED2Ev.exit:  ; preds = %invoke.cont28, %cleanup112, %if.then.i174
  %retval.6197 = phi i32 [ %retval.6.ph, %cleanup112 ], [ %retval.6.ph, %if.then.i174 ], [ -2147467263, %invoke.cont28 ]
...
ehcleanup113:                                     ; preds = %lpad57, %_ZN9CMyComPtrI15IOutStreamFlushED2Ev.exit172, %lpad35, %lpad25
  ...
  %45 = load ptr, ptr %setOutStream, align 8
  %tobool.not.i179 = icmp eq ptr %45, null
  br i1 %tobool.not.i179, label %_ZN9CMyComPtrI21ICompressSetOutStreamED2Ev.exit185, label %if.then.i180

if.then.i180:                                     ; preds = %ehcleanup113
  %vtable.i181 = load ptr, ptr %45, align 8
  %vfn.i182 = getelementptr inbounds ptr, ptr %vtable.i181, i64 2
  %46 = load ptr, ptr %vfn.i182, align 8
  %call.i183 = invoke noundef i32 %46(ptr noundef nonnull align 8 dereferenceable(8) %45)
          to label %_ZN9CMyComPtrI21ICompressSetOutStreamED2Ev.exit185 unwind label %terminate.lpad.i184

terminate.lpad.i184:                              ; preds = %if.then.i180
...
_ZN9CMyComPtrI21ICompressSetOutStreamED2Ev.exit185: ; preds = %ehcleanup113, %if.then.i180
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %setOutStream) #19
  br label %eh.resume
...
sw.bb7:                                           ; preds = %entry
  %_packSizeDefined = getelementptr inbounds %"class.NArchive::NLzma::CHandler", ptr %this, i64 0, i32 7
  %4 = load i8, ptr %_packSizeDefined, align 8
...
sw.bb13:                                          ; preds = %entry
  ...
  %8 = load ptr, ptr %_stream14, align 8
...
if.then18:                                        ; preds = %sw.bb13
  ...
  %9 = load i8, ptr %FilterID, align 8
  %cmp.not = icmp eq i8 %9, 0
  br i1 %cmp.not, label %for.cond.i.i43.preheader, label %for.cond.i.i

for.cond.i.i43.preheader:                         ; preds = %_Z11MyStringLenIcEiPKT_.exit.i, %if.then18
...
_Z11MyStringLenIcEiPKT_.exit.i:                   ; preds = %for.cond.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(5) %add.ptr.i, ptr noundef nonnull align 1 dereferenceable(5) @.str, i64 5, i1 false)
  br label %for.cond.i.i43.preheader
...
for.cond.i.i43:                                   ; preds = %for.cond.i.i43.preheader, %for.cond.i.i43
  %indvars.iv.i.i44 = phi i64 [ %indvars.iv.next.i.i47, %for.cond.i.i43 ], [ 0, %for.cond.i.i43.preheader ]
  %arrayidx.i.i45 = getelementptr inbounds i8, ptr %s, i64 %indvars.iv.i.i44
  %12 = load i8, ptr %arrayidx.i.i45, align 1
  %cmp.not.i.i46 = icmp eq i8 %12, 0
  %indvars.iv.next.i.i47 = add nuw i64 %indvars.iv.i.i44, 1
  br i1 %cmp.not.i.i46, label %_Z11MyStringLenIcEiPKT_.exit.i48, label %for.cond.i.i43

_Z11MyStringLenIcEiPKT_.exit.i48:                 ; preds = %for.cond.i.i43
  %sext.i49 = shl i64 %indvars.iv.i.i44, 32
  %idx.ext.i50 = ashr exact i64 %sext.i49, 32
  %add.ptr.i51 = getelementptr i8, ptr %s, i64 %idx.ext.i50
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(6) %add.ptr.i51, ptr noundef nonnull align 1 dereferenceable(6) @.str.1, i64 6, i1 false)
  %add.ptr.i59 = getelementptr inbounds %"class.NArchive::NLzma::CHandler", ptr %this, i64 0, i32 3, i32 2, i64 1
  %13 = load i32, ptr %add.ptr.i59, align 4
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.cond.i, %_Z11MyStringLenIcEiPKT_.exit.i48
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %for.cond.i ], [ 0, %_Z11MyStringLenIcEiPKT_.exit.i48 ]
...
if.end9.i:                                        ; preds = %if.else.i, %if.then3.i
  ...
  invoke void @_Z21ConvertUInt32ToStringjPc(i32 noundef %value.addr.0.i, ptr noundef nonnull %add.ptr)
          to label %for.cond.i.i60 unwind label %lpad21

for.cond.i.i60:                                   ; preds = %if.end9.i, %for.cond.i.i60
  %indvars.iv.i.i61 = phi i64 [ %indvars.iv.next.i.i64, %for.cond.i.i60 ], [ 0, %if.end9.i ]
  %arrayidx.i.i62 = getelementptr inbounds i8, ptr %add.ptr, i64 %indvars.iv.i.i61
  %15 = load i8, ptr %arrayidx.i.i62, align 1
  %cmp.not.i.i63 = icmp eq i8 %15, 0
  %indvars.iv.next.i.i64 = add nuw i64 %indvars.iv.i.i61, 1
  br i1 %cmp.not.i.i63, label %_Z11MyStringLenIcEiPKT_.exit.i65, label %for.cond.i.i60

_Z11MyStringLenIcEiPKT_.exit.i65:                 ; preds = %for.cond.i.i60
  %sext.i66 = shl i64 %indvars.iv.i.i61, 32
  %idxprom.i = ashr exact i64 %sext.i66, 32
  %arrayidx.i67 = getelementptr inbounds i8, ptr %add.ptr, i64 %idxprom.i
  store i8 %c.0.i, ptr %arrayidx.i67, align 1
  %sext31.i = add i64 %sext.i66, 4294967296
...
invoke.cont33:                                    ; preds = %_Z11MyStringLenIcEiPKT_.exit.i65, %cleanup.i
...
if.end19:                                         ; preds = %if.end14
  ...
  %vtable21 = load ptr, ptr %inStream, align 8
...
if.end.i:                                         ; preds = %if.end19
  ...
  %8 = load i64, ptr %_startPosition, align 8
  %sub = sub i64 %7, %8
  %_packSize = getelementptr inbounds %"class.NArchive::NLzma::CHandler", ptr %this, i64 0, i32 6
  ...
  %10 = load ptr, ptr %_stream, align 8
  %tobool.not.i = icmp eq ptr %10, null
  br i1 %tobool.not.i, label %if.end.i52, label %if.then2.i
...
if.end.i52:                                       ; preds = %if.end.i, %if.then2.i
  ...
  %vtable.i49 = load ptr, ptr %inStream, align 8
  %vfn.i50 = getelementptr inbounds ptr, ptr %vtable.i49, i64 1
  %12 = load ptr, ptr %vfn.i50, align 8
  %call.i51 = call noundef i32 %12(ptr noundef nonnull align 8 dereferenceable(8) %inStream)
  %13 = load ptr, ptr %_seqStream, align 8
  %tobool.not.i53 = icmp eq ptr %13, null
  br i1 %tobool.not.i53, label %_ZN9CMyComPtrI19ISequentialInStreamEaSEPS0_.exit, label %if.then2.i54

if.then2.i54:                                     ; preds = %if.end.i52
  %vtable4.i55 = load ptr, ptr %13, align 8
  %vfn5.i56 = getelementptr inbounds ptr, ptr %vtable4.i55, i64 2
  %14 = load ptr, ptr %vfn5.i56, align 8
  %call6.i57 = call noundef i32 %14(ptr noundef nonnull align 8 dereferenceable(8) %13)
  br label %_ZN9CMyComPtrI19ISequentialInStreamEaSEPS0_.exit

_ZN9CMyComPtrI19ISequentialInStreamEaSEPS0_.exit: ; preds = %if.end.i52, %if.then2.i54
...
if.end10:                                         ; preds = %if.then7, %if.end6
  ...
  %vtable17 = load ptr, ptr %extractCallback, align 8
...
if.end30:                                         ; preds = %cleanup.cont
  %vtable31 = load ptr, ptr %extractCallback, align 8
...
invoke.cont39:                                    ; preds = %invoke.cont33
  ...
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV15CDummyOutStream, i64 0, inrange i32 0, i64 2), ptr %call37, align 8
...
invoke.cont41:                                    ; preds = %invoke.cont39
  %12 = load ptr, ptr %realOutStream, align 8
...
if.end.i.i:                                       ; preds = %if.then.i.i, %invoke.cont41
  %14 = load ptr, ptr %_stream.i, align 8
...
invoke.cont52:                                    ; preds = %invoke.cont49
  %vtable.i267 = load ptr, ptr %call50, align 8
  %vfn.i268 = getelementptr inbounds ptr, ptr %vtable.i267, i64 1
  %18 = load ptr, ptr %vfn.i268, align 8
...
if.then61:                                        ; preds = %invoke.cont56
  %_startPosition = getelementptr inbounds %"class.NArchive::NLzma::CHandler", ptr %this, i64 0, i32 5
  %20 = load i64, ptr %_startPosition, align 8
  %vtable67 = load ptr, ptr %19, align 8
...
invoke.cont69:                                    ; preds = %if.then61
  ...
  br i1 %cmp71.not, label %invoke.cont79, label %if.then.i286
...
invoke.cont79:                                    ; preds = %invoke.cont56, %invoke.cont69
  ...
  %_lzma86 = getelementptr inbounds %"class.NArchive::NLzma::CHandler", ptr %this, i64 0, i32 4
  %30 = load i8, ptr %_lzma86, align 8
  %tobool80 = icmp ne i8 %30, 0
  %_seqStream = getelementptr inbounds %"class.NArchive::NLzma::CHandler", ptr %this, i64 0, i32 9
  %31 = load ptr, ptr %_seqStream, align 8
...
invoke.cont96.preheader:                          ; preds = %invoke.cont84
  ...
  store i64 %32, ptr %OutSize, align 8
  ...
  %34 = load i64, ptr %_inSizeProcessed.i.i.peel, align 8
  store i64 %34, ptr %_packSize98, align 8
  store i64 %34, ptr %InSize, align 8
  store i8 1, ptr %_packSizeDefined, align 8
...
cleanup.cont108.peel:                             ; preds = %invoke.cont101.peel
  ...
  %35 = load i8, ptr %_lzma86, align 8
...
invoke.cont114.peel:                              ; preds = %cleanup.cont108.peel
  ...
  br i1 %cmp116.not.peel, label %cleanup.cont121.peel, label %cleanup152.thread337

cleanup.cont121.peel:                             ; preds = %invoke.cont114.peel
  %37 = load i32, ptr %processed, align 4
...
if.end124.peel:                                   ; preds = %cleanup.cont121.peel
  %38 = load i8, ptr %_lzma86, align 8
...
invoke.cont137.peel:                              ; preds = %if.end132.peel
  switch i32 %call138.peel, label %cleanup152.thread337 [
    i32 -2147467263, label %for.end.thread
    i32 1, label %for.end.thread.loopexit368
...
invoke.cont96:                                    ; preds = %cleanup152.peel, %cleanup152
  ...
  store i64 %40, ptr %OutSize, align 8
  ...
  %42 = load i64, ptr %_inSizeProcessed.i.i, align 8
  store i64 %42, ptr %_packSize98, align 8
  store i64 %42, ptr %InSize, align 8
  store i8 1, ptr %_packSizeDefined, align 8
...
lpad93:                                           ; preds = %if.then.i275, %invoke.cont166
  %outStream.sroa.0.0 = phi ptr [ null, %invoke.cont166 ], [ %call37, %if.then.i275 ]
  %43 = landingpad { ptr, i32 }
          catch ptr @_ZTIPKc
          catch ptr null
  br label %ehcleanup176
...
cleanup.cont108:                                  ; preds = %invoke.cont101
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %st) #19
  call void @llvm.lifetime.start.p0(i64 14, ptr nonnull %buf) #19
  %44 = load i8, ptr %_lzma86, align 8
...
invoke.cont114:                                   ; preds = %cleanup.cont108
  ...
  br i1 %cmp116.not, label %cleanup.cont121, label %cleanup152.thread337
...
cleanup.cont121:                                  ; preds = %invoke.cont114
  %46 = load i32, ptr %processed, align 4
  %cmp122.not = icmp eq i32 %46, %add.i
  br i1 %cmp122.not, label %if.end124, label %for.end.thread389

if.end124:                                        ; preds = %cleanup.cont121
  %47 = load i8, ptr %_lzma86, align 8
  ...
  br i1 %call130, label %if.end132, label %for.end.thread389
...
invoke.cont137:                                   ; preds = %if.end132
  switch i32 %call138, label %cleanup152.thread337 [
    i32 -2147467263, label %for.end.thread
    i32 1, label %for.end.thread.loopexit368
    i32 0, label %cleanup152
  ]

cleanup152.thread337:                             ; preds = %invoke.cont114, %invoke.cont137, %invoke.cont137.peel, %invoke.cont114.peel
  %retval.8.ph = phi i32 [ %call.i273.peel, %invoke.cont114.peel ], [ %call138.peel, %invoke.cont137.peel ], [ %call.i273, %invoke.cont114 ], [ %call138, %invoke.cont137 ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %processed) #19
  call void @llvm.lifetime.end.p0(i64 14, ptr nonnull %buf) #19
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %st) #19
  br label %cleanup175
...
ehcleanup:                                        ; preds = %lpad128.loopexit, %lpad128.loopexit.split-lp, %lpad113.loopexit, %lpad113.loopexit.split-lp
  %.pn = phi { ptr, i32 } [ %lpad.loopexit383, %lpad113.loopexit ], [ %lpad.loopexit.split-lp384, %lpad113.loopexit.split-lp ], [ %lpad.loopexit386, %lpad128.loopexit ], [ %lpad.loopexit.split-lp387, %lpad128.loopexit.split-lp ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %processed) #19
  call void @llvm.lifetime.end.p0(i64 14, ptr nonnull %buf) #19
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %st) #19
  br label %ehcleanup176

for.end.thread.loopexit368:                       ; preds = %invoke.cont137, %invoke.cont137.peel
  br label %for.end.thread

for.end.thread:                                   ; preds = %invoke.cont137, %invoke.cont137.peel, %for.end.thread.loopexit368
  %opRes.1.ph.ph = phi i32 [ 2, %for.end.thread.loopexit368 ], [ 1, %invoke.cont137.peel ], [ 1, %invoke.cont137 ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %processed) #19
  call void @llvm.lifetime.end.p0(i64 14, ptr nonnull %buf) #19
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %st) #19
  br label %if.then.i275

for.end.thread389:                                ; preds = %if.end124, %cleanup.cont121
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %processed) #19
  call void @llvm.lifetime.end.p0(i64 14, ptr nonnull %buf) #19
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %st) #19
  br label %if.then.i275
...
if.then.i275:                                     ; preds = %for.end.thread389, %for.end.thread
  %opRes.1.ph345 = phi i32 [ %opRes.1.ph.ph, %for.end.thread ], [ 0, %for.end.thread389 ]
  %vtable.i276 = load ptr, ptr %call37, align 8
...
invoke.cont166:                                   ; preds = %if.then.i275
  %vtable167 = load ptr, ptr %extractCallback, align 8
  %vfn168 = getelementptr inbounds ptr, ptr %vtable167, i64 9
  %49 = load ptr, ptr %vfn168, align 8
  %call170 = invoke noundef i32 %49(ptr noundef nonnull align 8 dereferenceable(8) %extractCallback, i32 noundef %opRes.1.ph345)
          to label %cleanup175 unwind label %lpad93

cleanup175:                                       ; preds = %invoke.cont101, %invoke.cont101.peel, %for.end, %cleanup152.thread337, %invoke.cont166, %invoke.cont84
  %outStream.sroa.0.2 = phi ptr [ null, %invoke.cont166 ], [ %call37, %for.end ], [ %call37, %invoke.cont84 ], [ %call37, %cleanup152.thread337 ], [ %call37, %invoke.cont101.peel ], [ %call37, %invoke.cont101 ]
  %retval.10 = phi i32 [ %call170, %invoke.cont166 ], [ -2147467259, %for.end ], [ %call85, %invoke.cont84 ], [ %retval.8.ph, %cleanup152.thread337 ], [ %call102.peel, %invoke.cont101.peel ], [ %call102, %invoke.cont101 ]
  %50 = load ptr, ptr %_lzmaDecoder.i, align 8
  %tobool.not.i.i281 = icmp eq ptr %50, null
  br i1 %tobool.not.i.i281, label %invoke.cont.i, label %if.then.i.i282

if.then.i.i282:                                   ; preds = %cleanup175
  %51 = load ptr, ptr %decoder, align 8
  %vtable.i.i283 = load ptr, ptr %51, align 8
  %vfn.i.i284 = getelementptr inbounds ptr, ptr %vtable.i.i283, i64 11
  %52 = load ptr, ptr %vfn.i.i284, align 8
  %call2.i2.i = invoke noundef i32 %52(ptr noundef nonnull align 8 dereferenceable(273) %51)
          to label %invoke.cont.i unwind label %terminate.lpad.i

invoke.cont.i:                                    ; preds = %if.then.i.i282, %cleanup175
  %_bcjStream.i = getelementptr inbounds %"class.NArchive::NLzma::CDecoder", ptr %decoder, i64 0, i32 2
  %53 = load ptr, ptr %_bcjStream.i, align 8
  %tobool.not.i3.i = icmp eq ptr %53, null
  br i1 %tobool.not.i3.i, label %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit.i, label %if.then.i4.i

if.then.i4.i:                                     ; preds = %invoke.cont.i
  %vtable.i5.i = load ptr, ptr %53, align 8
  %vfn.i6.i = getelementptr inbounds ptr, ptr %vtable.i5.i, i64 2
  %54 = load ptr, ptr %vfn.i6.i, align 8
...
_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit.i: ; preds = %if.then.i4.i, %invoke.cont.i
  %57 = load ptr, ptr %_lzmaDecoder.i, align 8
  %tobool.not.i7.i = icmp eq ptr %57, null
  br i1 %tobool.not.i7.i, label %_ZN8NArchive5NLzma8CDecoderD2Ev.exit, label %if.then.i8.i

if.then.i8.i:                                     ; preds = %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit.i
  %vtable.i9.i = load ptr, ptr %57, align 8
  %vfn.i10.i = getelementptr inbounds ptr, ptr %vtable.i9.i, i64 2
  %58 = load ptr, ptr %vfn.i10.i, align 8
  %call.i11.i = invoke noundef i32 %58(ptr noundef nonnull align 8 dereferenceable(8) %57)
...
terminate.lpad.i:                                 ; preds = %if.then.i.i282
...
_ZN8NArchive5NLzma8CDecoderD2Ev.exit:             ; preds = %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit.i, %if.then.i8.i
...
ehcleanup176:                                     ; preds = %lpad100.loopexit, %lpad100.loopexit.split-lp, %lpad93, %ehcleanup, %lpad81
  ...
  %.pn247.pn = phi { ptr, i32 } [ %43, %lpad93 ], [ %.pn, %ehcleanup ], [ %39, %lpad81 ], [ %lpad.loopexit.split-lp, %lpad100.loopexit.split-lp ], [ %lpad.loopexit, %lpad100.loopexit ]
  call void @_ZN8NArchive5NLzma8CDecoderD2Ev(ptr noundef nonnull align 8 dereferenceable(24) %decoder) #19
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %decoder) #19
  br label %if.then.i297

if.then.i286:                                     ; preds = %_ZN8NArchive5NLzma8CDecoderD2Ev.exit, %invoke.cont69
  ...
  %vtable.i287 = load ptr, ptr %call50, align 8
  %vfn.i288 = getelementptr inbounds ptr, ptr %vtable.i287, i64 2
  %63 = load ptr, ptr %vfn.i288, align 8
...
terminate.lpad.i289:                              ; preds = %if.then.i286
...
_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit:  ; preds = %if.then.i286
  ...
  br i1 %tobool.not.i290, label %cleanup193, label %if.then.i291

if.then.i291:                                     ; preds = %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit
  %vtable.i292 = load ptr, ptr %outStream.sroa.0.4, align 8
  %vfn.i293 = getelementptr inbounds ptr, ptr %vtable.i292, i64 2
  %66 = load ptr, ptr %vfn.i293, align 8
  %call.i294 = invoke noundef i32 %66(ptr noundef nonnull align 8 dereferenceable(8) %outStream.sroa.0.4)
...
if.then.i297:                                     ; preds = %lpad55, %lpad64, %ehcleanup176
  %outStream.sroa.0.5 = phi ptr [ %outStream.sroa.0.3, %ehcleanup176 ], [ %call37, %lpad64 ], [ %call37, %lpad55 ]
  %.pn247.pn.pn.pn = phi { ptr, i32 } [ %.pn247.pn, %ehcleanup176 ], [ %29, %lpad64 ], [ %28, %lpad55 ]
  %vtable.i298 = load ptr, ptr %call50, align 8
  %vfn.i299 = getelementptr inbounds ptr, ptr %vtable.i298, i64 2
  %69 = load ptr, ptr %vfn.i299, align 8
  %call.i300 = invoke noundef i32 %69(ptr noundef nonnull align 8 dereferenceable(8) %call50)
          to label %ehcleanup188 unwind label %terminate.lpad.i301

terminate.lpad.i301:                              ; preds = %if.then.i297
...
ehcleanup188:                                     ; preds = %if.then.i297
  %tobool.not.i303 = icmp eq ptr %outStream.sroa.0.5, null
  br i1 %tobool.not.i303, label %ehcleanup194, label %if.then.i304

if.then.i304:                                     ; preds = %lpad53, %lpad42, %lpad48, %lpad51, %ehcleanup188
  %.pn247.pn.pn.pn.pn.pn.pn350 = phi { ptr, i32 } [ %.pn247.pn.pn.pn, %ehcleanup188 ], [ %27, %lpad53 ], [ %25, %lpad48 ], [ %26, %lpad51 ], [ %24, %lpad42 ]
  %outStream.sroa.0.7349 = phi ptr [ %outStream.sroa.0.5, %ehcleanup188 ], [ %call37, %lpad53 ], [ %call37, %lpad48 ], [ %call37, %lpad51 ], [ %call37, %lpad42 ]
  %vtable.i305 = load ptr, ptr %outStream.sroa.0.7349, align 8
  %vfn.i306 = getelementptr inbounds ptr, ptr %vtable.i305, i64 2
  %72 = load ptr, ptr %vfn.i306, align 8
  %call.i307 = invoke noundef i32 %72(ptr noundef nonnull align 8 dereferenceable(8) %outStream.sroa.0.7349)
          to label %ehcleanup194 unwind label %terminate.lpad.i308

terminate.lpad.i308:                              ; preds = %if.then.i304
...
cleanup193:                                       ; preds = %if.then.i291, %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit, %invoke.cont19
  %retval.12.ph = phi i32 [ %retval.11, %if.then.i291 ], [ %retval.11, %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit ], [ %call20, %invoke.cont19 ]
  %.pr = load ptr, ptr %realOutStream, align 8
  %tobool.not.i310 = icmp eq ptr %.pr, null
  br i1 %tobool.not.i310, label %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit316, label %if.then.i311

if.then.i311:                                     ; preds = %cleanup193
  %vtable.i312 = load ptr, ptr %.pr, align 8
  %vfn.i313 = getelementptr inbounds ptr, ptr %vtable.i312, i64 2
  %75 = load ptr, ptr %vfn.i313, align 8
  %call.i314 = invoke noundef i32 %75(ptr noundef nonnull align 8 dereferenceable(8) %.pr)
          to label %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit316 unwind label %terminate.lpad.i315

terminate.lpad.i315:                              ; preds = %if.then.i311
...
_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit316: ; preds = %cleanup.cont, %cleanup193, %if.then.i311
  %retval.12354 = phi i32 [ %retval.12.ph, %cleanup193 ], [ %retval.12.ph, %if.then.i311 ], [ 0, %cleanup.cont ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %realOutStream) #19
  br label %return

ehcleanup194:                                     ; preds = %lpad40, %ehcleanup188, %if.then.i304, %lpad35, %lpad26, %lpad14
  %.pn247.pn.pn.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %8, %lpad26 ], [ %6, %lpad14 ], [ %22, %lpad35 ], [ %23, %lpad40 ], [ %.pn247.pn.pn.pn, %ehcleanup188 ], [ %.pn247.pn.pn.pn.pn.pn.pn350, %if.then.i304 ]
  %78 = load ptr, ptr %realOutStream, align 8
...
if.then.i318:                                     ; preds = %ehcleanup194
  %vtable.i319 = load ptr, ptr %78, align 8
  %vfn.i320 = getelementptr inbounds ptr, ptr %vtable.i319, i64 2
  %79 = load ptr, ptr %vfn.i320, align 8
  %call.i321 = invoke noundef i32 %79(ptr noundef nonnull align 8 dereferenceable(8) %78)
...
_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit323: ; preds = %ehcleanup194, %if.then.i318
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %realOutStream) #19
  br label %catch.dispatch

catch.dispatch:                                   ; preds = %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit323, %lpad
  %.pn247.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %.pn247.pn.pn.pn.pn.pn.pn.pn.pn.pn, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit323 ], [ %4, %lpad ]
  %exn.slot.11 = extractvalue { ptr, i32 } %.pn247.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn, 0
  %ehselector.slot.11 = extractvalue { ptr, i32 } %.pn247.pn.pn.pn.pn.pn.pn.pn.pn.pn.pn, 1
...
return:                                           ; preds = %entry, %catch, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit316, %if.then5
  %retval.13 = phi i32 [ -2147024809, %if.then5 ], [ %retval.12354, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit316 ], [ -2147024882, %catch ], [ %numItems, %entry ]
  ret i32 %retval.13
...
entry:
  store ptr getelementptr inbounds ({ [18 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive5NLzma8CHandlerE, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %add.ptr = getelementptr inbounds i8, ptr %this, i64 8
  store ptr getelementptr inbounds ({ [18 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive5NLzma8CHandlerE, i64 0, inrange i32 1, i64 2), ptr %add.ptr, align 8
  %_seqStream = getelementptr inbounds %"class.NArchive::NLzma::CHandler", ptr %this, i64 0, i32 9
...
_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit:    ; preds = %entry, %if.then.i
  ...
  br i1 %tobool.not.i2, label %_ZN9CMyComPtrI9IInStreamED2Ev.exit, label %if.then.i3
...
_ZN9CMyComPtrI9IInStreamED2Ev.exit:               ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit, %if.then.i3
  ret void
}
...
entry:
  ...
  store ptr getelementptr inbounds ({ [18 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive5NLzma8CHandlerE, i64 0, inrange i32 1, i64 2), ptr %add.ptr.i, align 8
...
_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.i:  ; preds = %if.then.i.i, %entry
  ...
  br i1 %tobool.not.i2.i, label %_ZN8NArchive5NLzma8CHandlerD2Ev.exit, label %if.then.i3.i

if.then.i3.i:                                     ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.i
...
_ZN8NArchive5NLzma8CHandlerD2Ev.exit:             ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.i, %if.then.i3.i
...
entry:
  %0 = getelementptr inbounds i8, ptr %this, i64 -8
  store ptr getelementptr inbounds ({ [18 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive5NLzma8CHandlerE, i64 0, inrange i32 0, i64 2), ptr %0, align 8
  store ptr getelementptr inbounds ({ [18 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive5NLzma8CHandlerE, i64 0, inrange i32 1, i64 2), ptr %this, align 8
  %_seqStream.i = getelementptr inbounds i8, ptr %this, i64 72
...
_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.i.i: ; preds = %if.then.i.i.i, %entry
  ...
  br i1 %tobool.not.i2.i.i, label %_ZN8NArchive5NLzma8CHandlerD0Ev.exit, label %if.then.i3.i.i

if.then.i3.i.i:                                   ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.i.i
...
_ZN8NArchive5NLzma8CHandlerD0Ev.exit:             ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.i.i, %if.then.i3.i.i
...
invoke.cont:
  ...
  store ptr getelementptr inbounds ({ [18 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive5NLzma8CHandlerE, i64 0, inrange i32 0, i64 2), ptr %call, align 8
  store ptr getelementptr inbounds ({ [18 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive5NLzma8CHandlerE, i64 0, inrange i32 1, i64 2), ptr %0, align 8
  ...
  store i8 0, ptr %_lzma86.i, align 8
  ret ptr %call
}
...
invoke.cont:
  ...
  %_lzma86.i = getelementptr inbounds %"class.NArchive::NLzma::CHandler", ptr %call, i64 0, i32 4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %_stream.i, i8 0, i64 16, i1 false)
  store i8 1, ptr %_lzma86.i, align 8
  ret ptr %call
}
