; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Console/OpenCallbackConsole.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Console/OpenCallbackConsole.cpp"
...
entry:
  ...
  store i8 1, ptr %PasswordWasAsked, align 1
  %vtable = load ptr, ptr %this, align 8
...
cleanup.cont:                                     ; preds = %entry
  ...
  %1 = load i8, ptr %PasswordIsDefined, align 8
...
if.end9.i.i:                                      ; preds = %delete.notnull.i.i, %call.i.i.noexc
  ...
  store ptr %call.i.i11, ptr %Password, align 8
...
_ZN11CStringBaseIwED2Ev.exit:                     ; preds = %invoke.cont, %delete.notnull.i
  ...
  store i8 1, ptr %PasswordIsDefined, align 8
  br label %if.end5
...
if.end5:                                          ; preds = %_ZN11CStringBaseIwED2Ev.exit, %cleanup.cont
  ...
  %17 = load ptr, ptr %Password6, align 8
...
entry:
  %PasswordIsDefined = getelementptr inbounds %class.COpenCallbackConsole, ptr %this, i64 0, i32 2
  %0 = load i8, ptr %PasswordIsDefined, align 8
...
entry:
  %PasswordWasAsked = getelementptr inbounds %class.COpenCallbackConsole, ptr %this, i64 0, i32 3
  %0 = load i8, ptr %PasswordWasAsked, align 1
...
entry:
  %PasswordWasAsked = getelementptr inbounds %class.COpenCallbackConsole, ptr %this, i64 0, i32 3
  store i8 0, ptr %PasswordWasAsked, align 1
  ret void
}
