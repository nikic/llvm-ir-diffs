; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Console/BenchCon.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Console/BenchCon.cpp"
...
for.body.i:                                       ; preds = %_ZL11MyMultDiv64yyy.exit, %for.body.i
  ...
  br i1 %exitcond.not.i, label %_ZL11PrintNumberP8_IO_FILEyi.exit, label %for.body.i
...
_ZL11PrintNumberP8_IO_FILEyi.exit:                ; preds = %for.body.i, %_ZL11MyMultDiv64yyy.exit
  ...
  %4 = load i64, ptr %RPU, align 8
  %add = add i64 %4, %call2
  store i64 %add, ptr %RPU, align 8
  %5 = load <2 x i64>, ptr %res, align 8
  %6 = insertelement <2 x i64> <i64 1, i64 poison>, i64 %rating, i64 1
  %7 = add <2 x i64> %5, %6
  store <2 x i64> %7, ptr %res, align 8
  %Usage = getelementptr inbounds %struct.CTotalBenchRes, ptr %res, i64 0, i32 2
  %8 = load i64, ptr %Usage, align 8
  %add4 = add i64 %8, %call1
  store i64 %add4, ptr %Usage, align 8
  ret void
}
...
if.then2:                                         ; preds = %entry
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %info2, ptr noundef nonnull align 8 dereferenceable(56) %info, i64 56, i1 false)
  %NumIterations5 = getelementptr inbounds %struct.CBenchInfo, ptr %info2, i64 0, i32 6
  %7 = load i32, ptr %NumIterations5, align 8
  %conv = zext i32 %7 to i64
  %UnpackSize6 = getelementptr inbounds %struct.CBenchInfo, ptr %info2, i64 0, i32 4
  %8 = load i64, ptr %UnpackSize6, align 8
  %mul = mul i64 %8, %conv
  store i64 %mul, ptr %UnpackSize6, align 8
  %PackSize9 = getelementptr inbounds %struct.CBenchInfo, ptr %info2, i64 0, i32 5
  %9 = load i64, ptr %PackSize9, align 8
  %mul10 = mul i64 %9, %conv
  store i64 %mul10, ptr %PackSize9, align 8
  store i32 1, ptr %NumIterations5, align 8
...
for.inc.5:                                        ; preds = %for.inc.4
  ...
  %spec.select166 = select i1 %cmp12.not.6, i32 18, i32 19
  br label %for.end

for.end:                                          ; preds = %for.inc.5, %for.inc.4, %for.inc.3, %for.inc.2, %for.inc.1, %for.inc, %for.body.preheader
  %dicSizeLog.0.lcssa = phi i32 [ 25, %for.body.preheader ], [ 24, %for.inc ], [ 23, %for.inc.1 ], [ 22, %for.inc.2 ], [ 21, %for.inc.3 ], [ 20, %for.inc.4 ], [ %spec.select166, %for.inc.5 ]
...
for.inc39.1:                                      ; preds = %for.end, %if.end
  ...
  store ptr getelementptr inbounds ({ [4 x ptr] }, ptr @_ZTV14CBenchCallback, i64 0, inrange i32 0, i64 2), ptr %callback, align 8
  ...
  %cmp44.not161.not = icmp eq i32 %numIterations, 0
  br i1 %cmp44.not161.not, label %_ZN14CTotalBenchRes9NormalizeEv.exit.i, label %for.body45.lr.ph
...
for.body45:                                       ; preds = %for.body45.lr.ph, %for.inc72
  %i.0162 = phi i32 [ 0, %for.body45.lr.ph ], [ %inc73, %for.inc72 ]
  br label %while.cond
...
while.cond:                                       ; preds = %while.cond, %for.body45
  ...
  br i1 %cmp48, label %while.cond, label %for.cond50.preheader

for.cond50.preheader:                             ; preds = %while.cond
  %shl51157 = shl nuw i32 1, %pow.0
  %cmp52.not158 = icmp ugt i32 %shl51157, %dictionary.addr.0
  br i1 %cmp52.not158, label %for.inc72, label %for.body53

for.cond50:                                       ; preds = %for.body53
  %inc66 = add nsw i32 %pow.1159, 1
  %shl51 = shl nuw i32 1, %inc66
  %cmp52.not = icmp ugt i32 %shl51, %dictionary.addr.0
  br i1 %cmp52.not, label %for.inc72, label %for.body53

for.body53:                                       ; preds = %for.cond50.preheader, %for.cond50
  %shl51160 = phi i32 [ %shl51, %for.cond50 ], [ %shl51157, %for.cond50.preheader ]
  %pow.1159 = phi i32 [ %inc66, %for.cond50 ], [ %pow.0, %for.cond50.preheader ]
  %call54 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %f, ptr noundef nonnull @.str.9, i32 noundef %pow.1159)
  store i32 %shl51160, ptr %dictionarySize, align 8
  %call57 = call noundef i32 @_Z9LzmaBenchjjP14IBenchCallback(i32 noundef %numThreads.addr.1, i32 noundef %shl51160, ptr noundef nonnull %callback)
  %fputc = call i32 @fputc(i32 10, ptr %f)
  %cmp59.not = icmp eq i32 %call57, 0
  br i1 %cmp59.not, label %for.cond50, label %cleanup84

for.inc72:                                        ; preds = %for.cond50, %for.cond50.preheader
  %inc73 = add nuw i32 %i.0162, 1
  %exitcond.not = icmp eq i32 %inc73, %numIterations
  br i1 %exitcond.not, label %for.end76, label %for.body45

for.end76:                                        ; preds = %for.inc72
  %.pre = load i64, ptr %EncodeRes.i, align 8
...
if.end.i.i:                                       ; preds = %for.end76
  ...
  %7 = load i64, ptr %Rating.i.i, align 8
  %div.i.i = udiv i64 %7, %.pre
  store i64 %div.i.i, ptr %Rating.i.i, align 8
  %Usage.i.i = getelementptr inbounds %struct.CBenchCallback, ptr %callback, i64 0, i32 1, i32 2
  %8 = load i64, ptr %Usage.i.i, align 8
  %div4.i.i = udiv i64 %8, %.pre
  store i64 %div4.i.i, ptr %Usage.i.i, align 8
  %RPU.i.i = getelementptr inbounds %struct.CBenchCallback, ptr %callback, i64 0, i32 1, i32 3
  %9 = load i64, ptr %RPU.i.i, align 8
  %div6.i.i = udiv i64 %9, %.pre
  store i64 %div6.i.i, ptr %RPU.i.i, align 8
  store i64 1, ptr %EncodeRes.i, align 8
  br label %_ZN14CTotalBenchRes9NormalizeEv.exit.i

_ZN14CTotalBenchRes9NormalizeEv.exit.i:           ; preds = %for.inc39.1, %if.end.i.i, %for.end76
  %DecodeRes.i = getelementptr inbounds %struct.CBenchCallback, ptr %callback, i64 0, i32 2
  %10 = load i64, ptr %DecodeRes.i, align 8
  %cmp.i2.i = icmp eq i64 %10, 0
  br i1 %cmp.i2.i, label %_ZN14CBenchCallback9NormalizeEv.exit, label %if.end.i3.i

if.end.i3.i:                                      ; preds = %_ZN14CTotalBenchRes9NormalizeEv.exit.i
  %Rating.i4.i = getelementptr inbounds %struct.CBenchCallback, ptr %callback, i64 0, i32 2, i32 1
  %11 = load i64, ptr %Rating.i4.i, align 8
  %div.i5.i = udiv i64 %11, %10
  store i64 %div.i5.i, ptr %Rating.i4.i, align 8
  %Usage.i6.i = getelementptr inbounds %struct.CBenchCallback, ptr %callback, i64 0, i32 2, i32 2
  %12 = load i64, ptr %Usage.i6.i, align 8
  %div4.i7.i = udiv i64 %12, %10
  store i64 %div4.i7.i, ptr %Usage.i6.i, align 8
  %RPU.i8.i = getelementptr inbounds %struct.CBenchCallback, ptr %callback, i64 0, i32 2, i32 3
  %13 = load i64, ptr %RPU.i8.i, align 8
  %div6.i9.i = udiv i64 %13, %10
  store i64 %div6.i9.i, ptr %RPU.i8.i, align 8
  store i64 1, ptr %DecodeRes.i, align 8
  br label %_ZN14CBenchCallback9NormalizeEv.exit

_ZN14CBenchCallback9NormalizeEv.exit:             ; preds = %_ZN14CTotalBenchRes9NormalizeEv.exit.i, %if.end.i3.i
  %14 = call i64 @fwrite(ptr nonnull @.str.11, i64 69, i64 1, ptr %f)
  %15 = call i64 @fwrite(ptr nonnull @.str.21, i64 7, i64 1, ptr %f)
  %Usage.i = getelementptr inbounds %struct.CBenchCallback, ptr %callback, i64 0, i32 1, i32 2
  %16 = load i64, ptr %Usage.i, align 8
  %RPU.i = getelementptr inbounds %struct.CBenchCallback, ptr %callback, i64 0, i32 1, i32 3
  %17 = load i64, ptr %RPU.i, align 8
  %Rating.i = getelementptr inbounds %struct.CBenchCallback, ptr %callback, i64 0, i32 1, i32 1
  %18 = load i64, ptr %Rating.i, align 8
  call fastcc void @_ZL12PrintResultsP8_IO_FILEyyy(ptr noundef %f, i64 noundef %16, i64 noundef %17, i64 noundef %18)
  %19 = call i64 @fwrite(ptr nonnull @.str.12, i64 5, i64 1, ptr %f)
  %20 = call i64 @fwrite(ptr nonnull @.str.21, i64 7, i64 1, ptr %f)
  %Usage.i142 = getelementptr inbounds %struct.CBenchCallback, ptr %callback, i64 0, i32 2, i32 2
  %21 = load i64, ptr %Usage.i142, align 8
  %RPU.i143 = getelementptr inbounds %struct.CBenchCallback, ptr %callback, i64 0, i32 2, i32 3
  %22 = load i64, ptr %RPU.i143, align 8
  %Rating.i144 = getelementptr inbounds %struct.CBenchCallback, ptr %callback, i64 0, i32 2, i32 1
  %23 = load i64, ptr %Rating.i144, align 8
  call fastcc void @_ZL12PrintResultsP8_IO_FILEyyy(ptr noundef %f, i64 noundef %21, i64 noundef %22, i64 noundef %23)
  %24 = call i64 @fwrite(ptr nonnull @.str.13, i64 5, i64 1, ptr %f)
  %25 = load i64, ptr %Rating.i, align 8
  %26 = load i64, ptr %Rating.i144, align 8
  %add.i = add i64 %26, %25
  %div22.i = lshr i64 %add.i, 1
  %27 = load i64, ptr %Usage.i, align 8
  %28 = load i64, ptr %Usage.i142, align 8
  %add5.i = add i64 %28, %27
  %div623.i = lshr i64 %add5.i, 1
  %29 = load i64, ptr %RPU.i, align 8
  %30 = load i64, ptr %RPU.i143, align 8
  %add9.i = add i64 %30, %29
  %div1024.i = lshr i64 %add9.i, 1
  %31 = call i64 @fwrite(ptr nonnull @.str.21, i64 7, i64 1, ptr %f)
...
cleanup84:                                        ; preds = %for.body53, %_ZN14CBenchCallback9NormalizeEv.exit
  %retval.5 = phi i32 [ 0, %_ZN14CBenchCallback9NormalizeEv.exit ], [ %call57, %for.body53 ]
...
if.end:                                           ; preds = %entry
  ...
  %cmp9212.not = icmp eq i32 %spec.select, 0
  br i1 %cmp9212.not, label %for.cond.cleanup.thread, label %for.body

for.cond.cleanup:                                 ; preds = %for.body
  %2 = tail call i64 @fwrite(ptr nonnull @.str.8, i64 2, i64 1, ptr %f)
  %cmp16.not225.not = icmp eq i32 %numIterations, 0
  br i1 %cmp16.not225.not, label %_ZN11CTempValuesD2Ev.exit, label %for.cond19.preheader.lr.ph

for.cond.cleanup.thread:                          ; preds = %if.end
  %3 = tail call i64 @fwrite(ptr nonnull @.str.8, i64 2, i64 1, ptr %f)
  %cmp16.not225.not254 = icmp eq i32 %numIterations, 0
  br i1 %cmp16.not225.not254, label %_ZN11CTempValuesD2Ev.exit, label %for.cond19.preheader.preheader

for.cond19.preheader.lr.ph:                       ; preds = %for.cond.cleanup
  br i1 %cmp9212.not, label %for.cond19.preheader.preheader, label %for.cond19.preheader.us
...
for.cond19.preheader.us:                          ; preds = %for.cond19.preheader.lr.ph, %for.inc72.split.us.us
  %i.0227.us = phi i32 [ %inc73.us, %for.inc72.split.us.us ], [ 0, %for.cond19.preheader.lr.ph ]
  %numSteps.0226.us = phi i64 [ %numSteps.1.lcssa.us.us, %for.inc72.split.us.us ], [ 0, %for.cond19.preheader.lr.ph ]
  %4 = add i64 %numSteps.0226.us, 22
  %5 = trunc i64 %numSteps.0226.us to i32
  %6 = add i32 %5, 22
  br label %for.body22.us.us

for.body22.us.us:                                 ; preds = %for.cond30.for.inc66_crit_edge.us.us, %for.cond19.preheader.us
  %pow.0218.us.us = phi i32 [ 10, %for.cond19.preheader.us ], [ %inc67.us.us, %for.cond30.for.inc66_crit_edge.us.us ]
  %numSteps.1217.us.us = phi i64 [ %numSteps.0226.us, %for.cond19.preheader.us ], [ %inc59.us.us, %for.cond30.for.inc66_crit_edge.us.us ]
  %shl.us.us = shl nuw i32 1, %pow.0218.us.us
...
if.end25.us.us:                                   ; preds = %for.body22.us.us
  %call28.us.us = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %f, ptr noundef nonnull @.str.16, i32 noundef %pow.0218.us.us)
...
for.body33.us.us:                                 ; preds = %invoke.cont46.us.us, %if.end25.us.us
  %indvars.iv239 = phi i64 [ %indvars.iv.next240, %invoke.cont46.us.us ], [ 0, %if.end25.us.us ]
...
if.end38.us.us:                                   ; preds = %invoke.cont35.us.us
  ...
  %7 = trunc i64 %indvars.iv.next240 to i32
...
for.body.i.us.us:                                 ; preds = %.noexc.us.us, %for.body.i.us.us
  ...
  br i1 %exitcond.not.i.us.us, label %invoke.cont46.us.us, label %for.body.i.us.us
...
invoke.cont46.us.us:                              ; preds = %for.body.i.us.us, %.noexc.us.us
  ...
  %arrayidx49.us.us = getelementptr inbounds i64, ptr %call.i, i64 %indvars.iv239
  %10 = load i64, ptr %arrayidx49.us.us, align 8
  %add50.us.us = add i64 %10, %9
  store i64 %add50.us.us, ptr %arrayidx49.us.us, align 8
  %exitcond243.not = icmp eq i64 %indvars.iv.next240, %conv.i
  br i1 %exitcond243.not, label %for.cond30.for.inc66_crit_edge.us.us, label %for.body33.us.us

for.cond30.for.inc66_crit_edge.us.us:             ; preds = %invoke.cont46.us.us
  %fputc.us.us = call i32 @fputc(i32 10, ptr %f)
  %inc59.us.us = add i64 %numSteps.1217.us.us, 1
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
  %inc67.us.us = add nuw nsw i32 %pow.0218.us.us, 1
  %lftr.wideiv = trunc i64 %inc59.us.us to i32
  %exitcond244.not = icmp eq i32 %6, %lftr.wideiv
  br i1 %exitcond244.not, label %for.inc72.split.us.us, label %for.body22.us.us

for.inc72.split.us.us:                            ; preds = %for.cond30.for.inc66_crit_edge.us.us, %for.body22.us.us
  %numSteps.1.lcssa.us.us = phi i64 [ %numSteps.1217.us.us, %for.body22.us.us ], [ %4, %for.cond30.for.inc66_crit_edge.us.us ]
  %inc73.us = add nuw i32 %i.0227.us, 1
  %exitcond245.not = icmp eq i32 %inc73.us, %numIterations
  br i1 %exitcond245.not, label %for.end77, label %for.cond19.preheader.us
...
for.cond19.preheader:                             ; preds = %for.cond19.preheader.preheader, %for.inc72.split
  %i.0227 = phi i32 [ %inc73, %for.inc72.split ], [ 0, %for.cond19.preheader.preheader ]
  %numSteps.0226 = phi i64 [ %numSteps.1.lcssa, %for.inc72.split ], [ 0, %for.cond19.preheader.preheader ]
  %14 = add i64 %numSteps.0226, 22
...
if.end25.1:                                       ; preds = %if.end25
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.1 = tail call i32 @fputc(i32 10, ptr %f)
  %inc59.1 = add i64 %numSteps.0226, 2
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
if.end25.2:                                       ; preds = %if.end25.1
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.2 = tail call i32 @fputc(i32 10, ptr %f)
  %inc59.2 = add i64 %numSteps.0226, 3
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
if.end25.3:                                       ; preds = %if.end25.2
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.3 = tail call i32 @fputc(i32 10, ptr %f)
  %inc59.3 = add i64 %numSteps.0226, 4
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
if.end25.4:                                       ; preds = %if.end25.3
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.4 = tail call i32 @fputc(i32 10, ptr %f)
  %inc59.4 = add i64 %numSteps.0226, 5
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
if.end25.5:                                       ; preds = %if.end25.4
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.5 = tail call i32 @fputc(i32 10, ptr %f)
  %inc59.5 = add i64 %numSteps.0226, 6
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
if.end25.6:                                       ; preds = %if.end25.5
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.6 = tail call i32 @fputc(i32 10, ptr %f)
  %inc59.6 = add i64 %numSteps.0226, 7
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
if.end25.7:                                       ; preds = %if.end25.6
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.7 = tail call i32 @fputc(i32 10, ptr %f)
  %inc59.7 = add i64 %numSteps.0226, 8
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
if.end25.8:                                       ; preds = %if.end25.7
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.8 = tail call i32 @fputc(i32 10, ptr %f)
  %inc59.8 = add i64 %numSteps.0226, 9
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
if.end25.9:                                       ; preds = %if.end25.8
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.9 = tail call i32 @fputc(i32 10, ptr %f)
  %inc59.9 = add i64 %numSteps.0226, 10
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
if.end25.10:                                      ; preds = %if.end25.9
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.10 = tail call i32 @fputc(i32 10, ptr %f)
  %inc59.10 = add i64 %numSteps.0226, 11
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
if.end25.11:                                      ; preds = %if.end25.10
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.11 = tail call i32 @fputc(i32 10, ptr %f)
  %inc59.11 = add i64 %numSteps.0226, 12
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
if.end25.12:                                      ; preds = %if.end25.11
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.12 = tail call i32 @fputc(i32 10, ptr %f)
  %inc59.12 = add i64 %numSteps.0226, 13
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
if.end25.13:                                      ; preds = %if.end25.12
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.13 = tail call i32 @fputc(i32 10, ptr %f)
  %inc59.13 = add i64 %numSteps.0226, 14
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
if.end25.14:                                      ; preds = %if.end25.13
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.14 = tail call i32 @fputc(i32 10, ptr %f)
  %inc59.14 = add i64 %numSteps.0226, 15
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
if.end25.15:                                      ; preds = %if.end25.14
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.15 = tail call i32 @fputc(i32 10, ptr %f)
  %inc59.15 = add i64 %numSteps.0226, 16
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
if.end25.16:                                      ; preds = %if.end25.15
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.16 = tail call i32 @fputc(i32 10, ptr %f)
  %inc59.16 = add i64 %numSteps.0226, 17
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
if.end25.17:                                      ; preds = %if.end25.16
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.17 = tail call i32 @fputc(i32 10, ptr %f)
  %inc59.17 = add i64 %numSteps.0226, 18
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
if.end25.18:                                      ; preds = %if.end25.17
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.18 = tail call i32 @fputc(i32 10, ptr %f)
  %inc59.18 = add i64 %numSteps.0226, 19
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
if.end25.19:                                      ; preds = %if.end25.18
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.19 = tail call i32 @fputc(i32 10, ptr %f)
  %inc59.19 = add i64 %numSteps.0226, 20
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
if.end25.20:                                      ; preds = %if.end25.19
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.20 = tail call i32 @fputc(i32 10, ptr %f)
  %inc59.20 = add i64 %numSteps.0226, 21
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
if.end25.21:                                      ; preds = %if.end25.20
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #12
  %fputc.21 = tail call i32 @fputc(i32 10, ptr %f)
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #12
...
for.inc72.split:                                  ; preds = %if.end25.21, %if.end25.20, %if.end25.19, %if.end25.18, %if.end25.17, %if.end25.16, %if.end25.15, %if.end25.14, %if.end25.13, %if.end25.12, %if.end25.11, %if.end25.10, %if.end25.9, %if.end25.8, %if.end25.7, %if.end25.6, %if.end25.5, %if.end25.4, %if.end25.3, %if.end25.2, %if.end25.1, %if.end25, %for.cond19.preheader
  %numSteps.1.lcssa = phi i64 [ %numSteps.0226, %for.cond19.preheader ], [ %inc59, %if.end25 ], [ %inc59.1, %if.end25.1 ], [ %inc59.2, %if.end25.2 ], [ %inc59.3, %if.end25.3 ], [ %inc59.4, %if.end25.4 ], [ %inc59.5, %if.end25.5 ], [ %inc59.6, %if.end25.6 ], [ %inc59.7, %if.end25.7 ], [ %inc59.8, %if.end25.8 ], [ %inc59.9, %if.end25.9 ], [ %inc59.10, %if.end25.10 ], [ %inc59.11, %if.end25.11 ], [ %inc59.12, %if.end25.12 ], [ %inc59.13, %if.end25.13 ], [ %inc59.14, %if.end25.14 ], [ %inc59.15, %if.end25.15 ], [ %inc59.16, %if.end25.16 ], [ %inc59.17, %if.end25.17 ], [ %inc59.18, %if.end25.18 ], [ %inc59.19, %if.end25.19 ], [ %inc59.20, %if.end25.20 ], [ %14, %if.end25.21 ]
  %inc73 = add nuw i32 %i.0227, 1
  %exitcond248.not = icmp eq i32 %inc73, %numIterations
  br i1 %exitcond248.not, label %for.end77, label %for.cond19.preheader
...
for.end77:                                        ; preds = %for.inc72.split.us.us, %for.inc72.split
  %numSteps.0.lcssa = phi i64 [ %numSteps.1.lcssa, %for.inc72.split ], [ %numSteps.1.lcssa.us.us, %for.inc72.split.us.us ]
  %cmp78.not = icmp eq i64 %numSteps.0.lcssa, 0
...
if.then79:                                        ; preds = %for.end77
  ...
  br i1 %cmp9212.not, label %for.cond.cleanup86, label %for.body87

for.cond.cleanup86:                               ; preds = %for.inc94, %if.then79
  %fputc153 = call i32 @fputc(i32 10, ptr %f)
  br label %_ZN11CTempValuesD2Ev.exit

for.body87:                                       ; preds = %if.then79, %for.inc94
  %indvars.iv249 = phi i64 [ %indvars.iv.next250, %for.inc94 ], [ 0, %if.then79 ]
  %arrayidx90 = getelementptr inbounds i64, ptr %call.i, i64 %indvars.iv249
  %16 = load i64, ptr %arrayidx90, align 8
  %div = udiv i64 %16, %numSteps.0.lcssa
...
.noexc168:                                        ; preds = %for.body87
  ...
  br i1 %cmp10.i161, label %for.body.i163, label %for.inc94

for.body.i163:                                    ; preds = %.noexc168, %for.body.i163
  %len.011.i164 = phi i32 [ %inc.i166, %for.body.i163 ], [ %conv.i160, %.noexc168 ]
  %fputc9.i165 = call i32 @fputc(i32 32, ptr %f)
  %inc.i166 = add i32 %len.011.i164, 1
  %exitcond.not.i167 = icmp eq i32 %inc.i166, 5
  br i1 %exitcond.not.i167, label %for.inc94, label %for.body.i163

for.inc94:                                        ; preds = %for.body.i163, %.noexc168
  ...
  %exitcond253.not = icmp eq i64 %indvars.iv.next250, %conv.i
  br i1 %exitcond253.not, label %for.cond.cleanup86, label %for.body87
...
_ZN11CTempValuesD2Ev.exit:                        ; preds = %for.cond.cleanup.thread, %for.cond.cleanup, %cleanup74, %for.end77, %for.cond.cleanup86
...
_ZN11CTempValuesD2Ev.exit172:                     ; preds = %lpad92, %ehcleanup
  %.pn154 = phi { ptr, i32 } [ %17, %lpad92 ], [ %.pn, %ehcleanup ]
  call void @_ZdaPv(ptr noundef nonnull %call.i) #15
...
for.body.i.i:                                     ; preds = %_ZL11PrintNumberP8_IO_FILEyi.exit, %for.body.i.i
  ...
  br i1 %exitcond.not.i.i, label %_ZL11PrintRatingP8_IO_FILEy.exit, label %for.body.i.i
...
_ZL11PrintRatingP8_IO_FILEy.exit:                 ; preds = %for.body.i.i, %_ZL11PrintNumberP8_IO_FILEyi.exit
  ...
  br i1 %cmp10.i.i8, label %for.body.i.i10, label %_ZL11PrintRatingP8_IO_FILEy.exit15

for.body.i.i10:                                   ; preds = %_ZL11PrintRatingP8_IO_FILEy.exit, %for.body.i.i10
  %len.011.i.i11 = phi i32 [ %inc.i.i13, %for.body.i.i10 ], [ %conv.i.i7, %_ZL11PrintRatingP8_IO_FILEy.exit ]
  %fputc9.i.i12 = call i32 @fputc(i32 32, ptr %f)
  %inc.i.i13 = add i32 %len.011.i.i11, 1
  %exitcond.not.i.i14 = icmp eq i32 %inc.i.i13, 6
  br i1 %exitcond.not.i.i14, label %_ZL11PrintRatingP8_IO_FILEy.exit15, label %for.body.i.i10

_ZL11PrintRatingP8_IO_FILEy.exit15:               ; preds = %for.body.i.i10, %_ZL11PrintRatingP8_IO_FILEy.exit
  %call5.i.i9 = call i32 @fputs(ptr noundef nonnull %s.i.i3, ptr noundef %f)
