...
for.body53:                                       ; preds = %for.cond50.preheader, %for.cond50
  ...
  store i32 %shl51160, ptr %dictionarySize, align 8, !tbaa !5
...
for.end76:                                        ; preds = %for.inc72
  %.pre = load i64, ptr %EncodeRes.i, align 8, !tbaa !34
...
if.end.i.i:                                       ; preds = %for.end76
  ...
  %7 = load i64, ptr %Rating.i.i, align 8, !tbaa !35
  ...
  %8 = load i64, ptr %Usage.i.i, align 8, !tbaa !24
  ...
  %9 = load i64, ptr %RPU.i.i, align 8, !tbaa !22
...
_ZN14CTotalBenchRes9NormalizeEv.exit.i:           ; preds = %for.inc39.1, %if.end.i.i, %for.end76
  ...
  %10 = load i64, ptr %DecodeRes.i, align 8, !tbaa !34
...
if.end.i3.i:                                      ; preds = %_ZN14CTotalBenchRes9NormalizeEv.exit.i
  ...
  %11 = load i64, ptr %Rating.i4.i, align 8, !tbaa !35
  %div.i5.i = udiv i64 %11, %10
  store i64 %div.i5.i, ptr %Rating.i4.i, align 8, !tbaa !35
  %Usage.i6.i = getelementptr inbounds %struct.CBenchCallback, ptr %callback, i64 0, i32 2, i32 2
  %12 = load i64, ptr %Usage.i6.i, align 8, !tbaa !24
  %div4.i7.i = udiv i64 %12, %10
  store i64 %div4.i7.i, ptr %Usage.i6.i, align 8, !tbaa !24
  %RPU.i8.i = getelementptr inbounds %struct.CBenchCallback, ptr %callback, i64 0, i32 2, i32 3
  %13 = load i64, ptr %RPU.i8.i, align 8, !tbaa !22
  %div6.i9.i = udiv i64 %13, %10
  store i64 %div6.i9.i, ptr %RPU.i8.i, align 8, !tbaa !22
...
_ZN14CBenchCallback9NormalizeEv.exit:             ; preds = %_ZN14CTotalBenchRes9NormalizeEv.exit.i, %if.end.i3.i
  ...
  %25 = load i64, ptr %Rating.i, align 8, !tbaa !35
  %26 = load i64, ptr %Rating.i144, align 8, !tbaa !35
  %add.i = add i64 %26, %25
  %div22.i = lshr i64 %add.i, 1
  %27 = load i64, ptr %Usage.i, align 8, !tbaa !24
  %28 = load i64, ptr %Usage.i142, align 8, !tbaa !24
  %add5.i = add i64 %28, %27
  %div623.i = lshr i64 %add5.i, 1
  %29 = load i64, ptr %RPU.i, align 8, !tbaa !22
  %30 = load i64, ptr %RPU.i143, align 8, !tbaa !22
...
invoke.cont46.us.us:                              ; preds = %for.body.i.us.us, %.noexc.us.us
  ...
  br i1 %exitcond243.not, label %for.cond30.for.inc66_crit_edge.us.us, label %for.body33.us.us, !llvm.loop !36
...
for.cond30.for.inc66_crit_edge.us.us:             ; preds = %invoke.cont46.us.us
  ...
  br i1 %exitcond244.not, label %for.inc72.split.us.us, label %for.body22.us.us, !llvm.loop !37
...
for.inc72.split.us.us:                            ; preds = %for.cond30.for.inc66_crit_edge.us.us, %for.body22.us.us
  ...
  br i1 %exitcond245.not, label %for.end77, label %for.cond19.preheader.us, !llvm.loop !38
...
for.inc72.split:                                  ; preds = %if.end25.21, %if.end25.20, %if.end25.19, %if.end25.18, %if.end25.17, %if.end25.16, %if.end25.15, %if.end25.14, %if.end25.13, %if.end25.12, %if.end25.11, %if.end25.10, %if.end25.9, %if.end25.8, %if.end25.7, %if.end25.6, %if.end25.5, %if.end25.4, %if.end25.3, %if.end25.2, %if.end25.1, %if.end25, %for.cond19.preheader
  ...
  br i1 %exitcond248.not, label %for.end77, label %for.cond19.preheader, !llvm.loop !38
...
for.body.i163:                                    ; preds = %.noexc168, %for.body.i163
  ...
  br i1 %exitcond.not.i167, label %for.inc94, label %for.body.i163, !llvm.loop !21
...
for.inc94:                                        ; preds = %for.body.i163, %.noexc168
  ...
  br i1 %exitcond253.not, label %for.cond.cleanup86, label %for.body87, !llvm.loop !40
...
for.body.i.i10:                                   ; preds = %_ZL11PrintRatingP8_IO_FILEy.exit, %for.body.i.i10
  ...
  br i1 %exitcond.not.i.i14, label %_ZL11PrintRatingP8_IO_FILEy.exit15, label %for.body.i.i10, !llvm.loop !21
