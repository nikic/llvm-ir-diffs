; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Console/ConsoleClose.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Console/ConsoleClose.cpp"
...
entry:
  %0 = load i32, ptr @_ZL14g_BreakCounter, align 4
...
entry:
  store ptr getelementptr inbounds ({ [4 x ptr] }, ptr @_ZTVN13NConsoleClose18CCtrlHandlerSetterE, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  ...
  store ptr %call, ptr %memo_sig_int, align 8
...
entry:
  %1 = load i32, ptr @_ZL14g_BreakCounter, align 4
  %inc = add nsw i32 %1, 1
  store i32 %inc, ptr @_ZL14g_BreakCounter, align 4
...
entry:
  store ptr getelementptr inbounds ({ [4 x ptr] }, ptr @_ZTVN13NConsoleClose18CCtrlHandlerSetterE, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %memo_sig_int = getelementptr inbounds %"class.NConsoleClose::CCtrlHandlerSetter", ptr %this, i64 0, i32 1
  %0 = load ptr, ptr %memo_sig_int, align 8
  %call = tail call ptr @signal(i32 noundef 2, ptr noundef %0) #8
  %memo_sig_term = getelementptr inbounds %"class.NConsoleClose::CCtrlHandlerSetter", ptr %this, i64 0, i32 2
  %1 = load ptr, ptr %memo_sig_term, align 8
...
entry:
  ...
  %0 = load ptr, ptr %memo_sig_int.i, align 8
  ...
  %1 = load ptr, ptr %memo_sig_term.i, align 8
