; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Console/UserInputUtils.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Console/UserInputUtils.cpp"
...
if.then:                                          ; preds = %invoke.cont
  %1 = load ptr, ptr %scannedString, align 8
...
lpad:                                             ; preds = %.noexc, %for.cond, %if.then
  %3 = landingpad { ptr, i32 }
          cleanup
  %4 = load ptr, ptr %scannedString, align 8
...
cleanup:                                          ; preds = %invoke.cont7, %if.end, %sw.bb13, %sw.bb12, %sw.bb11, %sw.bb10, %sw.bb9
  ...
  %5 = load ptr, ptr %scannedString, align 8
...
if.end9.i.i:                                      ; preds = %_Z11MyStringLenIcEiPKT_.exit.i
  ...
  store ptr %call.i.i, ptr %oemPassword, align 8
...
invoke.cont4:                                     ; preds = %invoke.cont
  %call8 = invoke ptr @getpass(ptr noundef nonnull @.str.1)
          to label %for.cond.i.i25 unwind label %lpad6

for.cond.i.i25:                                   ; preds = %invoke.cont4, %for.cond.i.i25
  %indvars.iv.i.i26 = phi i64 [ %indvars.iv.next.i.i29, %for.cond.i.i25 ], [ 0, %invoke.cont4 ]
  %arrayidx.i.i27 = getelementptr inbounds i8, ptr %call8, i64 %indvars.iv.i.i26
  %4 = load i8, ptr %arrayidx.i.i27, align 1
  %cmp.not.i.i28 = icmp eq i8 %4, 0
  %indvars.iv.next.i.i29 = add nuw i64 %indvars.iv.i.i26, 1
  br i1 %cmp.not.i.i28, label %_Z11MyStringLenIcEiPKT_.exit.i30, label %for.cond.i.i25

_Z11MyStringLenIcEiPKT_.exit.i30:                 ; preds = %for.cond.i.i25
  %5 = trunc i64 %indvars.iv.i.i26 to i32
  %add.i.i31 = add nsw i32 %5, 1
  %cmp.i.i32 = icmp eq i32 %add.i.i31, 0
  br i1 %cmp.i.i32, label %_ZN11CStringBaseIcE11SetCapacityEi.exit.i36, label %if.end9.i.i33

if.end9.i.i33:                                    ; preds = %_Z11MyStringLenIcEiPKT_.exit.i30
  %conv.i.i34 = sext i32 %add.i.i31 to i64
  %call.i.i3544 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %conv.i.i34) #10
          to label %call.i.i35.noexc unwind label %lpad6

call.i.i35.noexc:                                 ; preds = %if.end9.i.i33
  store i8 0, ptr %call.i.i3544, align 1
  br label %_ZN11CStringBaseIcE11SetCapacityEi.exit.i36

_ZN11CStringBaseIcE11SetCapacityEi.exit.i36:      ; preds = %call.i.i35.noexc, %_Z11MyStringLenIcEiPKT_.exit.i30
  %oemPassword2.sroa.0.0 = phi ptr [ null, %_Z11MyStringLenIcEiPKT_.exit.i30 ], [ %call.i.i3544, %call.i.i35.noexc ]
  br label %while.cond.i.i37

while.cond.i.i37:                                 ; preds = %while.cond.i.i37, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i36
  %src.addr.0.i.i38 = phi ptr [ %call8, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i36 ], [ %incdec.ptr.i.i40, %while.cond.i.i37 ]
  %dest.addr.0.i.i39 = phi ptr [ %oemPassword2.sroa.0.0, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i36 ], [ %incdec.ptr1.i.i41, %while.cond.i.i37 ]
  %incdec.ptr.i.i40 = getelementptr inbounds i8, ptr %src.addr.0.i.i38, i64 1
  %6 = load i8, ptr %src.addr.0.i.i38, align 1
  %incdec.ptr1.i.i41 = getelementptr inbounds i8, ptr %dest.addr.0.i.i39, i64 1
  store i8 %6, ptr %dest.addr.0.i.i39, align 1
  %cmp.not.i10.i42 = icmp eq i8 %6, 0
  br i1 %cmp.not.i10.i42, label %invoke.cont9, label %while.cond.i.i37

invoke.cont9:                                     ; preds = %while.cond.i.i37
...
lpad6:                                            ; preds = %if.end9.i.i33, %invoke.cont4
...
invoke.cont15:                                    ; preds = %if.end14
  %10 = load ptr, ptr %oemPassword, align 8
...
ehcleanup16:                                      ; preds = %lpad6, %lpad10, %delete.notnull.i, %lpad
  ...
  %11 = load ptr, ptr %oemPassword, align 8
...
invoke.cont.i:
  %call.i.i.i = tail call noalias noundef nonnull dereferenceable(4) ptr @_Znam(i64 noundef 4) #10
  store <4 x i8> <i8 32, i8 10, i8 9, i8 0>, ptr %call.i.i.i, align 1
...
while.body.i:                                     ; preds = %while.body.i.preheader, %call.i.i.i3.noexc
  ...
  %3 = load i8, ptr %call.i.i.i, align 1
...
call.i.i.i.i.i.noexc:                             ; preds = %if.end8.i.i.i
  %5 = load i8, ptr %call.i.i.i.i.i4, align 1
  %cmp.i.i.i = icmp eq i8 %5, %2
  br i1 %cmp.i.i.i, label %_ZNK11CStringBaseIcE4FindEc.exit.i.loopexit, label %if.end.i.i.i
...
call.i.i.i3.noexc:                                ; preds = %_ZNK11CStringBaseIcE4FindEc.exit.thread.i
  %8 = load i8, ptr %call.i.i.i35, align 1
...
call.i.i.i.i.i.noexc:                             ; preds = %if.end8.i.i.i
  %4 = load i8, ptr %call.i.i.i.i.i4, align 1
...
while.body.i:                                     ; preds = %land.rhs.i
  %call.i.i.i35 = invoke noundef ptr @_Z9CharNextAPKc(ptr noundef nonnull %p.0.i)
          to label %while.cond.i unwind label %_ZN11CStringBaseIcED2Ev.exit8.loopexit.split-lp
...
while.end.i:                                      ; preds = %land.rhs.i, %_ZNK11CStringBaseIcE4FindEc.exit.i, %if.end.i.i.i
  ...
  %8 = load i32, ptr %_length.i.i, align 8
...
if.then4.i.i:                                     ; preds = %while.end.i
  ...
  store i32 %sub7.i.i, ptr %_length.i.i, align 8
  br label %_ZN11CStringBaseIcED2Ev.exit
