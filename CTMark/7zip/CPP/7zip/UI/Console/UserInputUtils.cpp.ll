...
for.cond.i.i25:                                   ; preds = %invoke.cont4, %for.cond.i.i25
  ...
  %4 = load i8, ptr %arrayidx.i.i27, align 1, !tbaa !12
  %cmp.not.i.i28 = icmp eq i8 %4, 0
  %indvars.iv.next.i.i29 = add nuw i64 %indvars.iv.i.i26, 1
  br i1 %cmp.not.i.i28, label %_Z11MyStringLenIcEiPKT_.exit.i30, label %for.cond.i.i25, !llvm.loop !13
...
call.i.i35.noexc:                                 ; preds = %if.end9.i.i33
  store i8 0, ptr %call.i.i3544, align 1, !tbaa !12
...
while.cond.i.i37:                                 ; preds = %while.cond.i.i37, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i36
  ...
  %6 = load i8, ptr %src.addr.0.i.i38, align 1, !tbaa !12
  %incdec.ptr1.i.i41 = getelementptr inbounds i8, ptr %dest.addr.0.i.i39, i64 1
  store i8 %6, ptr %dest.addr.0.i.i39, align 1, !tbaa !12
  %cmp.not.i10.i42 = icmp eq i8 %6, 0
  br i1 %cmp.not.i10.i42, label %invoke.cont9, label %while.cond.i.i37, !llvm.loop !16
