...
sw.bb12:                                          ; preds = %entry
  store i32 2, ptr %answer, align 4
  br label %cleanup

sw.bb13:                                          ; preds = %entry
  store i32 3, ptr %answer, align 4
  br label %cleanup
...
sw.bb16:                                          ; preds = %entry
  store i32 4, ptr %answer, align 4
  br label %cleanup
...
switch.lookup:                                    ; preds = %entry
  ...
  %3 = load ptr, ptr %OutStream6, align 8
...
sw.epilog:                                        ; preds = %entry, %switch.lookup
  ...
  %4 = load ptr, ptr %OutStream8, align 8
...
if.then:                                          ; preds = %sw.epilog
  %5 = load ptr, ptr %OutStream8, align 8
  ...
  %6 = load i64, ptr %position, align 8
...
entry:
  ...
  %1 = load <2 x i64>, ptr %NumFileErrors, align 8
  %2 = add <2 x i64> %1, <i64 1, i64 1>
  store <2 x i64> %2, ptr %NumFileErrors, align 8
  ret i32 0
}
...
sw.default:                                       ; preds = %entry
  %NumFileErrors = getelementptr inbounds %class.CExtractCallbackConsole, ptr %this, i64 0, i32 7
  %0 = load <2 x i64>, ptr %NumFileErrors, align 8
  %1 = add <2 x i64> %0, <i64 1, i64 1>
  store <2 x i64> %1, ptr %NumFileErrors, align 8
  %OutStream = getelementptr inbounds %class.CExtractCallbackConsole, ptr %this, i64 0, i32 9
  ...
  %3 = load ptr, ptr %OutStream, align 8
...
sw.epilog19:                                      ; preds = %sw.epilog19.sink.split, %entry
  ...
  %4 = load ptr, ptr %OutStream20, align 8
...
entry:
  ...
  store i8 1, ptr %PasswordIsDefined, align 4
...
entry:
  ...
  %PasswordIsDefined = getelementptr inbounds %class.CExtractCallbackConsole, ptr %this, i64 0, i32 3
  %0 = load i8, ptr %PasswordIsDefined, align 4
...
if.end9.i.i:                                      ; preds = %delete.notnull.i.i, %call.i.i.noexc
  ...
  store ptr %call.i.i7, ptr %Password, align 8
...
entry:
  ...
  %0 = load i64, ptr %NumArchives, align 8
  %inc = add i64 %0, 1
  store i64 %inc, ptr %NumArchives, align 8
  %NumFileErrorsInCurrentArchive = getelementptr inbounds %class.CExtractCallbackConsole, ptr %this, i64 0, i32 8
  store i64 0, ptr %NumFileErrorsInCurrentArchive, align 8
  %OutStream = getelementptr inbounds %class.CExtractCallbackConsole, ptr %this, i64 0, i32 9
  %1 = load ptr, ptr %OutStream, align 8
...
if.else12:                                        ; preds = %if.then
  ...
  %call.i.i.i = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #10
...
if.end17:                                         ; preds = %if.then9, %_ZN11CStringBaseIwED2Ev.exit, %if.then5
  %11 = load ptr, ptr %OutStream, align 8
  ...
  %12 = load i64, ptr %NumArchiveErrors, align 8
  %inc = add i64 %12, 1
  store i64 %inc, ptr %NumArchiveErrors, align 8
  br label %if.end20
...
if.then:                                          ; preds = %entry
  ...
  %call = tail call noundef nonnull align 8 dereferenceable(16) ptr @_ZN13CStdOutStreamlsEPFRS_S0_E(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef nonnull @_Z4endlR13CStdOutStream)
  %NumFileErrorsInCurrentArchive = getelementptr inbounds %class.CExtractCallbackConsole, ptr %this, i64 0, i32 8
  %1 = load i64, ptr %NumFileErrorsInCurrentArchive, align 8
...
if.else:                                          ; preds = %if.then
  %NumArchiveErrors = getelementptr inbounds %class.CExtractCallbackConsole, ptr %this, i64 0, i32 6
  %3 = load i64, ptr %NumArchiveErrors, align 8
  %inc = add i64 %3, 1
  store i64 %inc, ptr %NumArchiveErrors, align 8
  %4 = load ptr, ptr %OutStream, align 8
  ...
  %5 = load i64, ptr %NumFileErrorsInCurrentArchive, align 8
...
if.end15:                                         ; preds = %entry
  ...
  %6 = load i64, ptr %NumArchiveErrors16, align 8
  %inc17 = add i64 %6, 1
  store i64 %inc17, ptr %NumArchiveErrors16, align 8
...
if.end21:                                         ; preds = %if.end15
  ...
  %7 = load ptr, ptr %OutStream22, align 8
...
if.then26:                                        ; preds = %if.end21
  %8 = load ptr, ptr %OutStream22, align 8
...
if.else29:                                        ; preds = %if.end21
  ...
  store ptr %call.i.i, ptr %message, align 8
...
invoke.cont:                                      ; preds = %if.else29
  %10 = load ptr, ptr %OutStream22, align 8
...
if.end36:                                         ; preds = %_ZN11CStringBaseIwED2Ev.exit, %if.then26
  %15 = load ptr, ptr %OutStream22, align 8
...
if.end:                                           ; preds = %for.cond.13.i, %for.cond.12.i, %for.cond.11.i, %for.cond.10.i, %for.cond.9.i, %for.cond.8.i, %for.cond.7.i, %for.cond.6.i, %for.cond.5.i, %for.cond.4.i, %for.cond.3.i, %for.cond.2.i, %for.cond.1.i, %for.cond.i, %entry, %_ZeqRK4GUIDS1_.exit
  %32 = load i8, ptr @IID_IFolderArchiveExtractCallback, align 4
...
for.cond.i23:                                     ; preds = %if.end
  ...
  %34 = load i8, ptr getelementptr inbounds (i8, ptr @IID_IFolderArchiveExtractCallback, i64 1), align 1
...
for.cond.1.i26:                                   ; preds = %for.cond.i23
  ...
  %36 = load i8, ptr getelementptr inbounds (i8, ptr @IID_IFolderArchiveExtractCallback, i64 2), align 2
...
for.cond.2.i29:                                   ; preds = %for.cond.1.i26
  ...
  %38 = load i8, ptr getelementptr inbounds (i8, ptr @IID_IFolderArchiveExtractCallback, i64 3), align 1
...
for.cond.3.i32:                                   ; preds = %for.cond.2.i29
  ...
  %40 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IFolderArchiveExtractCallback, i64 0, i32 1), align 4
...
for.cond.4.i35:                                   ; preds = %for.cond.3.i32
  ...
  %42 = load i8, ptr getelementptr inbounds (i8, ptr @IID_IFolderArchiveExtractCallback, i64 5), align 1
...
for.cond.5.i38:                                   ; preds = %for.cond.4.i35
  ...
  %44 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IFolderArchiveExtractCallback, i64 0, i32 2), align 2
...
for.cond.6.i41:                                   ; preds = %for.cond.5.i38
  ...
  %46 = load i8, ptr getelementptr inbounds (i8, ptr @IID_IFolderArchiveExtractCallback, i64 7), align 1
...
for.cond.7.i44:                                   ; preds = %for.cond.6.i41
  ...
  %48 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IFolderArchiveExtractCallback, i64 0, i32 3, i64 0), align 4
...
for.cond.8.i47:                                   ; preds = %for.cond.7.i44
  ...
  %50 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IFolderArchiveExtractCallback, i64 0, i32 3, i64 1), align 1
...
for.cond.9.i50:                                   ; preds = %for.cond.8.i47
  ...
  %52 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IFolderArchiveExtractCallback, i64 0, i32 3, i64 2), align 2
...
for.cond.10.i53:                                  ; preds = %for.cond.9.i50
  ...
  %54 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IFolderArchiveExtractCallback, i64 0, i32 3, i64 3), align 1
...
for.cond.11.i56:                                  ; preds = %for.cond.10.i53
  ...
  %56 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IFolderArchiveExtractCallback, i64 0, i32 3, i64 4), align 4
...
for.cond.12.i59:                                  ; preds = %for.cond.11.i56
  ...
  %58 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IFolderArchiveExtractCallback, i64 0, i32 3, i64 5), align 1
...
for.cond.13.i62:                                  ; preds = %for.cond.12.i59
  ...
  %60 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IFolderArchiveExtractCallback, i64 0, i32 3, i64 6), align 2
...
_ZeqRK4GUIDS1_.exit69:                            ; preds = %for.cond.13.i62
  ...
  %62 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IFolderArchiveExtractCallback, i64 0, i32 3, i64 7), align 1
...
entry:
  store ptr getelementptr inbounds ({ [19 x ptr], [8 x ptr] }, ptr @_ZTV23CExtractCallbackConsole, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %add.ptr = getelementptr inbounds i8, ptr %this, i64 8
  store ptr getelementptr inbounds ({ [19 x ptr], [8 x ptr] }, ptr @_ZTV23CExtractCallbackConsole, i64 0, inrange i32 1, i64 2), ptr %add.ptr, align 8
  %Password = getelementptr inbounds %class.CExtractCallbackConsole, ptr %this, i64 0, i32 4
  %0 = load ptr, ptr %Password, align 8
...
entry:
  ...
  store ptr getelementptr inbounds ({ [19 x ptr], [8 x ptr] }, ptr @_ZTV23CExtractCallbackConsole, i64 0, inrange i32 1, i64 2), ptr %add.ptr.i, align 8
...
entry:
  %0 = getelementptr inbounds i8, ptr %this, i64 -8
  store ptr getelementptr inbounds ({ [19 x ptr], [8 x ptr] }, ptr @_ZTV23CExtractCallbackConsole, i64 0, inrange i32 0, i64 2), ptr %0, align 8
  store ptr getelementptr inbounds ({ [19 x ptr], [8 x ptr] }, ptr @_ZTV23CExtractCallbackConsole, i64 0, inrange i32 1, i64 2), ptr %this, align 8
...
entry:
  ...
  %1 = load ptr, ptr %Password.i.i, align 8
