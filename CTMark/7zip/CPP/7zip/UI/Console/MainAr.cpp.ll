; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Console/MainAr.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Console/MainAr.cpp"
...
entry:
  ...
  store ptr @g_StdOut, ptr @g_StdStream, align 8
...
catch156:                                         ; preds = %lpad
  ...
  %5 = load ptr, ptr @g_StdStream, align 8
...
catch142:                                         ; preds = %catch.fallthrough
  ...
  %8 = load ptr, ptr @g_StdStream, align 8
...
catch124:                                         ; preds = %catch.fallthrough2
  ...
  %11 = load ptr, ptr @g_StdStream, align 8
...
if.then:                                          ; preds = %catch83
  %16 = load ptr, ptr @g_StdStream, align 8
...
catch72:                                          ; preds = %catch.fallthrough6
  ...
  %19 = load ptr, ptr @g_StdStream, align 8
...
catch55:                                          ; preds = %catch.fallthrough8
  ...
  %24 = load ptr, ptr @g_StdStream, align 8
...
catch40:                                          ; preds = %catch.fallthrough10
  ...
  %28 = load ptr, ptr @g_StdStream, align 8
...
catch31:                                          ; preds = %catch.fallthrough12
  ...
  %32 = load ptr, ptr @g_StdStream, align 8
...
catch22:                                          ; preds = %catch.fallthrough14
  ...
  %36 = load ptr, ptr @g_StdStream, align 8
...
invoke.cont27:                                    ; preds = %invoke.cont25
  ...
  %37 = load ptr, ptr @g_StdStream, align 8
...
if.then90:                                        ; preds = %catch83
  %48 = load ptr, ptr @g_StdStream, align 8
...
invoke.cont97:                                    ; preds = %if.end95
  ...
  store ptr %call.i.i198, ptr %message, align 8
  store i32 0, ptr %call.i.i198, align 4
...
invoke.cont100:                                   ; preds = %invoke.cont97
  %51 = load ptr, ptr @g_StdStream, align 8
...
invoke.cont114:                                   ; preds = %invoke.cont112
  %53 = load ptr, ptr %message, align 8
