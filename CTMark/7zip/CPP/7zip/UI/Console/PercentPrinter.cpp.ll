...
entry:
  ...
  %0 = load i32, ptr %m_NumExtraChars, align 8
  %cmp = icmp eq i32 %0, 0
...
for.body10.preheader.i:                           ; preds = %if.end
  %1 = zext i32 %0 to i64
  call void @llvm.memset.p0.i64(ptr nonnull align 16 %s, i8 8, i64 %1, i1 false)
  %scevgep.i = getelementptr i8, ptr %s, i64 %1
  call void @llvm.memset.p0.i64(ptr align 1 %scevgep.i, i8 32, i64 %1, i1 false)
  %scevgep36.i = getelementptr i8, ptr %scevgep.i, i64 %1
  call void @llvm.memset.p0.i64(ptr align 1 %scevgep36.i, i8 8, i64 %1, i1 false)
...
_ZL9ClearPrevPci.exit:                            ; preds = %if.end, %for.body10.preheader.i
  ...
  store i8 0, ptr %p.addr.2.lcssa.i, align 1
  ...
  store i32 0, ptr %m_NumExtraChars, align 8
...
entry:
  ...
  %0 = load i32, ptr %m_NumExtraChars.i, align 8
...
for.body10.preheader.i.i:                         ; preds = %if.end.i
  %1 = zext i32 %0 to i64
  call void @llvm.memset.p0.i64(ptr nonnull align 16 %s.i, i8 8, i64 %1, i1 false)
  %scevgep.i.i = getelementptr i8, ptr %s.i, i64 %1
  call void @llvm.memset.p0.i64(ptr align 1 %scevgep.i.i, i8 32, i64 %1, i1 false)
  %scevgep36.i.i = getelementptr i8, ptr %scevgep.i.i, i64 %1
  call void @llvm.memset.p0.i64(ptr align 1 %scevgep36.i.i, i8 8, i64 %1, i1 false)
...
_ZL9ClearPrevPci.exit.i:                          ; preds = %for.body10.preheader.i.i, %if.end.i
  ...
  store i32 0, ptr %m_NumExtraChars.i, align 8
...
cond.end:                                         ; preds = %entry, %cond.false
  ...
  %m_NumExtraChars = getelementptr inbounds %class.CPercentPrinter, ptr %this, i64 0, i32 4
  %2 = load i32, ptr %m_NumExtraChars, align 8
...
for.end:                                          ; preds = %cond.end
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(1) %fullString, i8 32, i64 %umax, i1 false)
  %umax66 = call i32 @llvm.umax.i32(i32 %spec.select, i32 1)
  %4 = zext i32 %umax66 to i64
  %scevgep = getelementptr i8, ptr %fullString, i64 %4
  store i32 %spec.select, ptr %m_NumExtraChars, align 8
  br label %if.end16
...
for.body20.preheader:                             ; preds = %if.end16
  %6 = load i32, ptr %m_NumExtraChars, align 8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <16 x i8> <i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8>, ptr %next.gep, align 1
  %8 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> <i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8>, ptr %8, align 1
...
for.body29:                                       ; preds = %for.end24, %for.body29
  ...
  store i8 32, ptr %p.364, align 1
  %inc32 = add nsw i32 %size.063, 1
  %10 = load i32, ptr %m_NumExtraChars, align 8
  %cmp28 = icmp slt i32 %inc32, %10
  br i1 %cmp28, label %for.body29, label %while.cond.i.preheader
...
while.cond.i:                                     ; preds = %while.cond.i.preheader, %while.cond.i
  ...
  %11 = load i8, ptr %src.addr.0.i, align 1
  %incdec.ptr1.i = getelementptr inbounds i8, ptr %dest.addr.0.i, i64 1
  store i8 %11, ptr %dest.addr.0.i, align 1
...
_Z12MyStringCopyIcEPT_S1_PKS0_.exit:              ; preds = %while.cond.i
  %OutStream = getelementptr inbounds %class.CPercentPrinter, ptr %this, i64 0, i32 5
  %12 = load ptr, ptr %OutStream, align 8
  ...
  %13 = load ptr, ptr %OutStream, align 8
...
entry:
  %m_CurValue = getelementptr inbounds %class.CPercentPrinter, ptr %this, i64 0, i32 2
  %0 = load i64, ptr %m_CurValue, align 8
  %m_PrevValue = getelementptr inbounds %class.CPercentPrinter, ptr %this, i64 0, i32 1
  %1 = load i64, ptr %m_PrevValue, align 8
