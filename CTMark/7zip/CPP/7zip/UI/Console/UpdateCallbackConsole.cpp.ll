; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Console/UpdateCallbackConsole.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Console/UpdateCallbackConsole.cpp"
...
entry:
  %call = tail call i32 @pthread_mutex_destroy(ptr noundef nonnull %this) #14
  ret void
}
...
_ZN11CStringBaseIwEC2EPKw.exit:                   ; preds = %while.cond.i.i
  %call.i20 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znwm(i64 noundef 16) #15
          to label %call.i.noexc unwind label %lpad

call.i.noexc:                                     ; preds = %_ZN11CStringBaseIwEC2EPKw.exit
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %call.i20, i8 0, i64 16, i1 false)
  tail call void @llvm.assume(i1 %cmp.i.i)
  %conv.i.i.i = zext i32 %add.i.i to i64
  %6 = icmp slt i32 %1, -1
  %7 = shl nuw nsw i64 %conv.i.i.i, 2
  %8 = select i1 %6, i64 -1, i64 %7
  %call.i.i4.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %8) #15
          to label %call.i.i.noexc.i unwind label %lpad.i

call.i.i.noexc.i:                                 ; preds = %call.i.noexc
  %_capacity.i.i = getelementptr inbounds %class.CStringBase, ptr %call.i20, i64 0, i32 2
  store ptr %call.i.i4.i, ptr %call.i20, align 8
...
while.cond.i.i.i:                                 ; preds = %call.i.i.noexc.i, %while.cond.i.i.i
  %src.addr.0.i.i.i = phi ptr [ %incdec.ptr.i.i.i, %while.cond.i.i.i ], [ %ref.tmp.sroa.0.0, %call.i.i.noexc.i ]
...
invoke.cont.i:                                    ; preds = %while.cond.i.i.i
  %_length.i.i = getelementptr inbounds %class.CStringBase, ptr %call.i20, i64 0, i32 1
...
lpad.i:                                           ; preds = %call.i.noexc
  %10 = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZdlPv(ptr noundef nonnull %call.i20) #16
  br label %lpad.body
...
invoke.cont:                                      ; preds = %invoke.cont.i
  ...
  %arrayidx.i.i19 = getelementptr inbounds ptr, ptr %11, i64 %idxprom.i.i
  store ptr %call.i20, ptr %arrayidx.i.i19, align 8
...
delete.notnull.i:                                 ; preds = %invoke.cont
  tail call void @_ZdaPv(ptr noundef nonnull %ref.tmp.sroa.0.0) #16
...
_ZN11CStringBaseIwED2Ev.exit:                     ; preds = %invoke.cont, %delete.notnull.i
  ...
  store i32 %systemError, ptr %arrayidx.i, align 4
  ...
  %16 = load i8, ptr %m_WarningsMode, align 2
  %tobool.not = icmp eq i8 %16, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %_ZN11CStringBaseIwED2Ev.exit
  %OutStream = getelementptr inbounds %class.CUpdateCallbackConsole, ptr %this, i64 0, i32 5
  %17 = load ptr, ptr %OutStream, align 8
  %call3 = tail call noundef nonnull align 8 dereferenceable(16) ptr @_ZN13CStdOutStreamlsEPFRS_S0_E(ptr noundef nonnull align 8 dereferenceable(16) %17, ptr noundef nonnull @_Z4endlR13CStdOutStream)
  ...
  store i8 1, ptr %m_WarningsMode, align 2
  br label %if.end

lpad:                                             ; preds = %invoke.cont.i, %_ZN11CStringBaseIwEC2EPKw.exit
  %18 = landingpad { ptr, i32 }
          cleanup
  br label %lpad.body

lpad.body:                                        ; preds = %lpad.i, %lpad
  %eh.lpad-body = phi { ptr, i32 } [ %18, %lpad ], [ %10, %lpad.i ]
  %isnull.i21 = icmp eq ptr %ref.tmp.sroa.0.0, null
  br i1 %isnull.i21, label %common.resume, label %delete.notnull.i22

delete.notnull.i22:                               ; preds = %lpad.body
  tail call void @_ZdaPv(ptr noundef nonnull %ref.tmp.sroa.0.0) #16
...
if.end:                                           ; preds = %if.then, %_ZN11CStringBaseIwED2Ev.exit
  ...
  %19 = getelementptr inbounds i8, ptr %ref.tmp9, i64 8
  store i64 0, ptr %19, align 8
  %call.i.i.i.i = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #15
  store ptr %call.i.i.i.i, ptr %ref.tmp9, align 8
  store i32 0, ptr %call.i.i.i.i, align 4
  store i32 4, ptr %_capacity.i.i.i, align 4
  %call.i.i24 = invoke noundef zeroext i1 @_ZN8NWindows6NError15MyFormatMessageEjR11CStringBaseIwE(i32 noundef %systemError, ptr noundef nonnull align 8 dereferenceable(16) %ref.tmp9)
...
common.resume:                                    ; preds = %_ZN11CStringBaseIwED2Ev.exit30, %lpad.body, %delete.notnull.i22, %lpad.i.i, %delete.notnull.i.i.i
  %common.resume.op = phi { ptr, i32 } [ %20, %delete.notnull.i.i.i ], [ %20, %lpad.i.i ], [ %24, %_ZN11CStringBaseIwED2Ev.exit30 ], [ %eh.lpad-body, %lpad.body ], [ %eh.lpad-body, %delete.notnull.i22 ]
  resume { ptr, i32 } %common.resume.op

_ZN8NWindows6NError16MyFormatMessageWEj.exit:     ; preds = %if.end
  %22 = load ptr, ptr %ref.tmp9, align 8
  invoke void @_ZN15CPercentPrinter11PrintStringEPKw(ptr noundef nonnull align 8 dereferenceable(48) %m_PercentPrinter6, ptr noundef %22)
          to label %invoke.cont13 unwind label %lpad10

invoke.cont13:                                    ; preds = %_ZN8NWindows6NError16MyFormatMessageWEj.exit
  %23 = load ptr, ptr %ref.tmp9, align 8
  %isnull.i25 = icmp eq ptr %23, null
  br i1 %isnull.i25, label %_ZN11CStringBaseIwED2Ev.exit27, label %delete.notnull.i26

delete.notnull.i26:                               ; preds = %invoke.cont13
  call void @_ZdaPv(ptr noundef nonnull %23) #16
  br label %_ZN11CStringBaseIwED2Ev.exit27

_ZN11CStringBaseIwED2Ev.exit27:                   ; preds = %invoke.cont13, %delete.notnull.i26
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp9) #14
...
entry:
  ...
  %1 = load ptr, ptr %OutStream8, align 8
...
if.end10:                                         ; preds = %if.else7, %if.then4
  ...
  %2 = load ptr, ptr %OutStream11, align 8
...
lpad:                                             ; preds = %if.then6, %if.then3
  %2 = landingpad { ptr, i32 }
          cleanup
  %call.i.i.i = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull @_ZL17g_CriticalSection) #14
  resume { ptr, i32 } %2

if.end:                                           ; preds = %if.then3, %if.then
  %StdOutMode = getelementptr inbounds %class.CUpdateCallbackConsole, ptr %this, i64 0, i32 7
  %3 = load i8, ptr %StdOutMode, align 1
...
land.lhs.true:                                    ; preds = %if.end
  ...
  %4 = load i8, ptr %m_NeedNewLine, align 1
...
invoke.cont8:                                     ; preds = %if.then6
  store i8 0, ptr %m_NeedNewLine, align 1
  br label %if.end10

if.end10:                                         ; preds = %invoke.cont8, %land.lhs.true, %if.end
  store i8 0, ptr %m_NeedBeClosed, align 8
  br label %if.end12

if.end12:                                         ; preds = %if.end10, %entry
  %call.i.i.i14 = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull @_ZL17g_CriticalSection) #14
  ret i32 0
}
...
invoke.cont4:                                     ; preds = %if.then2
  %m_NeedBeClosed = getelementptr inbounds %class.CUpdateCallbackConsole, ptr %this, i64 0, i32 2
  store i8 1, ptr %m_NeedBeClosed, align 8
  br label %if.end5
...
invoke.cont6:                                     ; preds = %if.end5
  %. = select i1 %call, i32 -2147467260, i32 0
  %call.i.i.i12 = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull @_ZL17g_CriticalSection) #14
  ret i32 %.
}
...
entry:
  %call.i.i = tail call i32 @pthread_mutex_lock(ptr noundef nonnull @_ZL17g_CriticalSection) #14
  %StdOutMode = getelementptr inbounds %class.CUpdateCallbackConsole, ptr %this, i64 0, i32 7
  %0 = load i8, ptr %StdOutMode, align 1
  %tobool.not = icmp eq i8 %0, 0
...
invoke.cont10:                                    ; preds = %if.end6
  %EnablePercents = getelementptr inbounds %class.CUpdateCallbackConsole, ptr %this, i64 0, i32 6
  %4 = load i8, ptr %EnablePercents, align 8
...
cleanup:                                          ; preds = %invoke.cont10, %if.then12, %entry
  %call.i.i.i19 = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull @_ZL17g_CriticalSection) #14
  ret i32 0
}
...
if.end9.i.i:                                      ; preds = %_Z11MyStringLenIwEiPKT_.exit.i
  ...
  %call.i.i3031 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %7) #15
          to label %call.i.i30.noexc unwind label %lpad2

call.i.i30.noexc:                                 ; preds = %if.end9.i.i
  store i32 0, ptr %call.i.i3031, align 4
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i

_ZN11CStringBaseIwE11SetCapacityEi.exit.i:        ; preds = %call.i.i30.noexc, %_Z11MyStringLenIwEiPKT_.exit.i
  %ref.tmp.sroa.0.0 = phi ptr [ null, %_Z11MyStringLenIwEiPKT_.exit.i ], [ %call.i.i3031, %call.i.i30.noexc ]
  br label %while.cond.i.i
...
invoke.cont3:                                     ; preds = %while.cond.i.i
  ...
  %call.i33 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znwm(i64 noundef 16) #15
          to label %call.i.noexc unwind label %lpad4

call.i.noexc:                                     ; preds = %invoke.cont3
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %call.i33, i8 0, i64 16, i1 false)
  tail call void @llvm.assume(i1 %cmp.i.i)
  %conv.i.i.i = zext i32 %add.i.i to i64
  %9 = icmp slt i32 %4, -1
  %10 = shl nuw nsw i64 %conv.i.i.i, 2
  %11 = select i1 %9, i64 -1, i64 %10
  %call.i.i4.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %11) #15
          to label %call.i.i.noexc.i unwind label %lpad.i

call.i.i.noexc.i:                                 ; preds = %call.i.noexc
  %_capacity.i.i = getelementptr inbounds %class.CStringBase, ptr %call.i33, i64 0, i32 2
  store ptr %call.i.i4.i, ptr %call.i33, align 8
  store i32 0, ptr %call.i.i4.i, align 4
  store i32 %add.i.i, ptr %_capacity.i.i, align 4
  br label %while.cond.i.i.i
...
invoke.cont.i:                                    ; preds = %while.cond.i.i.i
  %_length.i.i = getelementptr inbounds %class.CStringBase, ptr %call.i33, i64 0, i32 1
...
lpad.i:                                           ; preds = %call.i.noexc
  %13 = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZdlPv(ptr noundef nonnull %call.i33) #16
  br label %lpad4.body
...
invoke.cont5:                                     ; preds = %invoke.cont.i
  ...
  %arrayidx.i.i32 = getelementptr inbounds ptr, ptr %14, i64 %idxprom.i.i
  store ptr %call.i33, ptr %arrayidx.i.i32, align 8
...
invoke.cont11:                                    ; preds = %invoke.cont9
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp13) #14
  tail call void @llvm.experimental.noalias.scope.decl(metadata !54)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !57)
  %16 = getelementptr inbounds i8, ptr %ref.tmp13, i64 8
  store i64 0, ptr %16, align 8
  %call.i.i.i.i35 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #15
...
call.i.i.i.i.noexc:                               ; preds = %invoke.cont11
  ...
  store ptr %call.i.i.i.i35, ptr %ref.tmp13, align 8
  store i32 0, ptr %call.i.i.i.i35, align 4
  store i32 4, ptr %_capacity.i.i.i, align 4
  %call.i.i34 = invoke noundef zeroext i1 @_ZN8NWindows6NError15MyFormatMessageEjR11CStringBaseIwE(i32 noundef %systemError, ptr noundef nonnull align 8 dereferenceable(16) %ref.tmp13)
...
invoke.cont15:                                    ; preds = %call.i.i.i.i.noexc
  ...
  invoke void @_ZN15CPercentPrinter11PrintStringEPKw(ptr noundef nonnull align 8 dereferenceable(48) %m_PercentPrinter, ptr noundef %19)
...
delete.notnull.i38:                               ; preds = %invoke.cont19
  call void @_ZdaPv(ptr noundef nonnull %20) #16
  br label %_ZN11CStringBaseIwED2Ev.exit39

_ZN11CStringBaseIwED2Ev.exit39:                   ; preds = %invoke.cont19, %delete.notnull.i38
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp13) #14
  %call.i.i.i = call i32 @pthread_mutex_unlock(ptr noundef nonnull @_ZL17g_CriticalSection) #14
  ret i32 1
...
lpad4:                                            ; preds = %invoke.cont.i, %invoke.cont3
  %23 = landingpad { ptr, i32 }
          cleanup
  br label %lpad4.body

lpad4.body:                                       ; preds = %lpad.i, %lpad4
  %eh.lpad-body = phi { ptr, i32 } [ %23, %lpad4 ], [ %13, %lpad.i ]
  %isnull.i41 = icmp eq ptr %ref.tmp.sroa.0.0, null
  br i1 %isnull.i41, label %ehcleanup22, label %delete.notnull.i42

delete.notnull.i42:                               ; preds = %lpad4.body
  tail call void @_ZdaPv(ptr noundef nonnull %ref.tmp.sroa.0.0) #16
  br label %ehcleanup22
...
lpad16:                                           ; preds = %invoke.cont15
  ...
  %isnull.i44 = icmp eq ptr %26, null
  br i1 %isnull.i44, label %ehcleanup21, label %delete.notnull.i45

delete.notnull.i45:                               ; preds = %lpad16
  call void @_ZdaPv(ptr noundef nonnull %26) #16
  br label %ehcleanup21

ehcleanup21:                                      ; preds = %delete.notnull.i45, %lpad16, %lpad14, %delete.notnull.i.i.i, %lpad.i.i
  %.pn27 = phi { ptr, i32 } [ %24, %lpad14 ], [ %17, %delete.notnull.i.i.i ], [ %17, %lpad.i.i ], [ %25, %lpad16 ], [ %25, %delete.notnull.i45 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp13) #14
  br label %ehcleanup22

ehcleanup22:                                      ; preds = %lpad2, %lpad4.body, %delete.notnull.i42, %ehcleanup21, %lpad
  %.pn27.pn = phi { ptr, i32 } [ %.pn27, %ehcleanup21 ], [ %21, %lpad ], [ %22, %lpad2 ], [ %eh.lpad-body, %lpad4.body ], [ %eh.lpad-body, %delete.notnull.i42 ]
  %call.i.i.i48 = call i32 @pthread_mutex_unlock(ptr noundef nonnull @_ZL17g_CriticalSection) #14
...
entry:
  ...
  store i8 1, ptr %m_NeedBeClosed, align 8
  %m_NeedNewLine = getelementptr inbounds %class.CUpdateCallbackConsole, ptr %this, i64 0, i32 3
  store i8 1, ptr %m_NeedNewLine, align 1
  ret i32 0
}
...
if.end.i.i:                                       ; preds = %if.end.i
  ...
  %8 = select i1 %6, i64 -1, i64 %7
  %call.i.i14 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %8) #15
...
if.end9.i.i:                                      ; preds = %delete.notnull.i.i, %call.i.i.noexc
  ...
  store ptr %call.i.i14, ptr %Password, align 8
...
_ZN11CStringBaseIwED2Ev.exit:                     ; preds = %invoke.cont, %delete.notnull.i
  ...
  store i8 1, ptr %PasswordIsDefined, align 2
  br label %if.end5
...
if.end.i.i:                                       ; preds = %if.end.i
  ...
  %6 = shl nuw nsw i64 %conv.i.i, 2
  %7 = select i1 %5, i64 -1, i64 %6
  %call.i.i8 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %7) #15
          to label %call.i.i.noexc unwind label %lpad
...
if.end9.i.i:                                      ; preds = %delete.notnull.i.i, %call.i.i.noexc
  ...
  store ptr %call.i.i8, ptr %Password, align 8
...
if.end:                                           ; preds = %_ZN11CStringBaseIwED2Ev.exit, %entry
  ...
  %16 = load ptr, ptr %Password3, align 8
...
entry:
  ...
  %0 = tail call i32 @__cxa_atexit(ptr nonnull @_ZN8NWindows16NSynchronization16CCriticalSectionD2Ev, ptr nonnull @_ZL17g_CriticalSection, ptr nonnull @__dso_handle) #14
  ret void
}
