...
for.cond.i.i180:                                  ; preds = %for.cond.i.i180, %for.inc.15
  ...
  %24 = load i32, ptr %arrayidx.i.i182, align 4, !tbaa !5
  %cmp.not.i.i183 = icmp eq i32 %24, 0
  %indvars.iv.next.i.i184 = add nuw i64 %indvars.iv.i.i181, 1
  br i1 %cmp.not.i.i183, label %_Z11MyStringLenIwEiPKT_.exit.i185, label %for.cond.i.i180, !llvm.loop !18
...
_Z11MyStringLenIwEiPKT_.exit.i185:                ; preds = %for.cond.i.i180
  ...
  store ptr %call.i.i190, ptr %agg.result, align 8, !tbaa !13
  store i32 0, ptr %call.i.i190, align 4, !tbaa !5
  store i32 %add.i.i186, ptr %_capacity.i179, align 4, !tbaa !17
...
while.cond.i.i192:                                ; preds = %_Z11MyStringLenIwEiPKT_.exit.i185, %while.cond.i.i192
  ...
  %29 = load i32, ptr %src.addr.0.i.i193, align 4, !tbaa !5
  %incdec.ptr1.i.i196 = getelementptr inbounds i32, ptr %dest.addr.0.i.i194, i64 1
  store i32 %29, ptr %dest.addr.0.i.i194, align 4, !tbaa !5
  %cmp.not.i10.i197 = icmp eq i32 %29, 0
  br i1 %cmp.not.i10.i197, label %_ZN11CStringBaseIwEC2EPKw.exit199, label %while.cond.i.i192, !llvm.loop !20
...
if.end42:                                         ; preds = %sw.bb37
  ...
  store ptr %call.i.i202, ptr %agg.result, align 8, !tbaa !13
  store i32 0, ptr %call.i.i202, align 4, !tbaa !5
  store i32 4, ptr %_capacity.i201, align 4, !tbaa !17
...
for.cond.i.i203:                                  ; preds = %for.cond.i.i203, %if.end106
  ...
  %44 = load i32, ptr %arrayidx.i.i205, align 4, !tbaa !5
  %cmp.not.i.i206 = icmp eq i32 %44, 0
  %indvars.iv.next.i.i207 = add nuw i64 %indvars.iv.i.i204, 1
  br i1 %cmp.not.i.i206, label %_Z11MyStringLenIwEiPKT_.exit.i208, label %for.cond.i.i203, !llvm.loop !18
...
if.end9.i.i213:                                   ; preds = %if.end.i.i
  ...
  store i32 %add.i.i209, ptr %_capacity.i201, align 4, !tbaa !17
...
while.cond.i.i215:                                ; preds = %while.cond.i.i215, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i214
  ...
  %50 = load i32, ptr %src.addr.0.i.i216, align 4, !tbaa !5
  %incdec.ptr1.i.i219 = getelementptr inbounds i32, ptr %dest.addr.0.i.i217, i64 1
  store i32 %50, ptr %dest.addr.0.i.i217, align 4, !tbaa !5
  %cmp.not.i9.i = icmp eq i32 %50, 0
  br i1 %cmp.not.i9.i, label %invoke.cont, label %while.cond.i.i215, !llvm.loop !20
...
for.cond.i.i271:                                  ; preds = %for.cond.i.i271, %if.then112
  ...
  %51 = load i32, ptr %arrayidx.i.i273, align 4, !tbaa !5
  %cmp.not.i.i274 = icmp eq i32 %51, 0
  %indvars.iv.next.i.i275 = add nuw i64 %indvars.iv.i.i272, 1
  br i1 %cmp.not.i.i274, label %_Z11MyStringLenIwEiPKT_.exit.i276, label %for.cond.i.i271, !llvm.loop !18
...
call.i.i281.noexc:                                ; preds = %if.end9.i.i279
  store i32 0, ptr %call.i.i281290, align 4, !tbaa !5
...
while.cond.i.i283:                                ; preds = %while.cond.i.i283, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i282
  ...
  %56 = load i32, ptr %src.addr.0.i.i284, align 4, !tbaa !5
  %incdec.ptr1.i.i287 = getelementptr inbounds i32, ptr %dest.addr.0.i.i285, i64 1
  store i32 %56, ptr %dest.addr.0.i.i285, align 4, !tbaa !5
  %cmp.not.i10.i288 = icmp eq i32 %56, 0
  br i1 %cmp.not.i10.i288, label %invoke.cont118, label %while.cond.i.i283, !llvm.loop !20
...
while.cond.i.i.i:                                 ; preds = %while.cond.i.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i
  ...
  br i1 %cmp.not.i.i.i, label %if.end.i.i363, label %while.cond.i.i.i, !llvm.loop !20
...
while.cond.i.i.i303:                              ; preds = %while.cond.i.i.i303, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i302
  ...
  %69 = load i32, ptr %src.addr.0.i.i.i304, align 4, !tbaa !5, !noalias !25
  %incdec.ptr1.i.i.i307 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i305, i64 1
  store i32 %69, ptr %dest.addr.0.i.i.i305, align 4, !tbaa !5, !noalias !25
  %cmp.not.i.i.i308 = icmp eq i32 %69, 0
  br i1 %cmp.not.i.i.i308, label %_ZN11CStringBaseIwEC2ERKS0_.exit.i309, label %while.cond.i.i.i303, !llvm.loop !20
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load445 = load <4 x i32>, ptr %74, align 4, !tbaa !5
  ...
  store <4 x i32> %wide.load445, ptr %76, align 4, !tbaa !5
...
for.body.i.i.i411:                                ; preds = %for.body.i.i.i411.preheader, %for.body.i.i.i411
  ...
  %78 = load i32, ptr %arrayidx.i.i.i413, align 4, !tbaa !5
  %arrayidx7.i.i.i414 = getelementptr inbounds i32, ptr %call.i.i.i418, i64 %indvars.iv.i.i.i412
  store i32 %78, ptr %arrayidx7.i.i.i414, align 4, !tbaa !5
  ...
  br i1 %exitcond.not.i.i.i416, label %delete.notnull.i.i.i407, label %for.body.i.i.i411, !llvm.loop !31
...
while.cond.i.i376:                                ; preds = %while.cond.i.i376, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i
  ...
  %79 = load i32, ptr %src.addr.0.i.i377, align 4, !tbaa !5
  %incdec.ptr1.i.i380 = getelementptr inbounds i32, ptr %dest.addr.0.i.i378, i64 1
  store i32 %79, ptr %dest.addr.0.i.i378, align 4, !tbaa !5
  %cmp.not.i8.i = icmp eq i32 %79, 0
  br i1 %cmp.not.i8.i, label %invoke.cont122, label %while.cond.i.i376, !llvm.loop !20
...
if.end9.i.i328:                                   ; preds = %delete.notnull.i.i338, %call.i.i326.noexc
  store ptr %call.i.i326340, ptr %agg.result, align 8, !tbaa !13
  store i32 0, ptr %call.i.i326340, align 4, !tbaa !5
  store i32 %add.i.i321, ptr %_capacity.i201, align 4, !tbaa !17
...
while.cond.i.i332:                                ; preds = %while.cond.i.i332.preheader, %while.cond.i.i332
  ...
  %84 = load i32, ptr %src.addr.0.i.i333, align 4, !tbaa !5
  %incdec.ptr1.i.i336 = getelementptr inbounds i32, ptr %dest.addr.0.i.i334, i64 1
  store i32 %84, ptr %dest.addr.0.i.i334, align 4, !tbaa !5
  %cmp.not.i.i337 = icmp eq i32 %84, 0
  br i1 %cmp.not.i.i337, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i, label %while.cond.i.i332, !llvm.loop !20

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i:            ; preds = %while.cond.i.i332
  store i32 %add.i382, ptr %_length.i.i, align 8, !tbaa !21
