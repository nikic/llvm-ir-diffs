; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Common/ExtractingFilePath.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Common/ExtractingFilePath.cpp"
...
if.then.i:                                        ; preds = %lor.lhs.false.i, %for.body
  %call.i.i7.i = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #12, !noalias !16
...
if.end9.i.i.i.i:                                  ; preds = %if.end.i
  ...
  %call.i.i.i.i = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %8) #12, !noalias !22
...
while.cond.i.i.i.i:                               ; preds = %while.cond.i.i.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i.i
  ...
  br i1 %cmp.not.i.i.i.i, label %if.end.i12, label %while.cond.i.i.i.i, !llvm.loop !25

if.end.i12:                                       ; preds = %while.cond.i.i.i.i, %if.then.i
  ...
  %_capacity.i.i13 = getelementptr inbounds %class.CStringBase, ptr %2, i64 0, i32 2
  %11 = load i32, ptr %_capacity.i.i13, align 4, !tbaa !27
  %cmp.i.i14 = icmp eq i32 %add.i.i, %11
  br i1 %cmp.i.i14, label %while.cond.i.i.preheader, label %if.end.i.i
...
if.end.i.i:                                       ; preds = %if.end.i12
  ...
  %call.i.i15 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %14) #12
...
if.end9.i.i:                                      ; preds = %delete.notnull.i.i, %call.i.i.noexc
  ...
  store i32 %add.i.i, ptr %_capacity.i.i13, align 4, !tbaa !27
  br label %while.cond.i.i.preheader

while.cond.i.i.preheader:                         ; preds = %if.end9.i.i, %if.end.i12
  %dest.addr.0.i.i.ph = phi ptr [ %10, %if.end.i12 ], [ %call.i.i15, %if.end9.i.i ]
...
delete.notnull.i:                                 ; preds = %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i
  tail call void @_ZdaPv(ptr noundef nonnull %ref.tmp.sroa.0.2) #13
...
entry:
  ...
  %call.i.i = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #12
...
if.end.i.i:                                       ; preds = %if.end.i
  ...
  %call.i.i = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %5) #12
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %7, align 4, !tbaa !19
  %8 = getelementptr inbounds i32, ptr %7, i64 4
  %wide.load8 = load <4 x i32>, ptr %8, align 4, !tbaa !19
  %9 = getelementptr inbounds i32, ptr %call.i.i, i64 %index
  store <4 x i32> %wide.load, ptr %9, align 4, !tbaa !19
  %10 = getelementptr inbounds i32, ptr %9, i64 4
  store <4 x i32> %wide.load8, ptr %10, align 4, !tbaa !19
  %index.next = add nuw i64 %index, 8
  %11 = icmp eq i64 %index.next, %n.vec
  br i1 %11, label %middle.block, label %vector.body, !llvm.loop !33
...
for.body.i.i.prol:                                ; preds = %for.body.i.i.preheader, %for.body.i.i.prol
  ...
  %14 = load i32, ptr %arrayidx.i.i.prol, align 4, !tbaa !19
  %arrayidx7.i.i.prol = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.i.i.prol
  store i32 %14, ptr %arrayidx7.i.i.prol, align 4, !tbaa !19
...
if.end.i.i:                                       ; preds = %if.end.i
  ...
  %call.i.i = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %6) #12
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %8, align 4, !tbaa !19
  %9 = getelementptr inbounds i32, ptr %8, i64 4
  %wide.load11 = load <4 x i32>, ptr %9, align 4, !tbaa !19
  %10 = getelementptr inbounds i32, ptr %call.i.i, i64 %index
  store <4 x i32> %wide.load, ptr %10, align 4, !tbaa !19
  %11 = getelementptr inbounds i32, ptr %10, i64 4
  store <4 x i32> %wide.load11, ptr %11, align 4, !tbaa !19
  %index.next = add nuw i64 %index, 8
  %12 = icmp eq i64 %index.next, %n.vec
  br i1 %12, label %middle.block, label %vector.body, !llvm.loop !39
...
for.body.i.i.prol:                                ; preds = %for.body.i.i.preheader, %for.body.i.i.prol
  ...
  %prol.iter = phi i64 [ %prol.iter.next, %for.body.i.i.prol ], [ 0, %for.body.i.i.preheader ]
  %arrayidx.i.i.prol = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.i.i.prol
  %15 = load i32, ptr %arrayidx.i.i.prol, align 4, !tbaa !19
  %arrayidx7.i.i.prol = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.i.i.prol
  store i32 %15, ptr %arrayidx7.i.i.prol, align 4, !tbaa !19
  %indvars.iv.next.i.i.prol = add nuw nsw i64 %indvars.iv.i.i.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
...
for.body.i.i:                                     ; preds = %for.body.i.i.prol.loopexit, %for.body.i.i
  %indvars.iv.i.i = phi i64 [ %indvars.iv.next.i.i.3, %for.body.i.i ], [ %indvars.iv.i.i.unr, %for.body.i.i.prol.loopexit ]
  %arrayidx.i.i = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.i.i
  %17 = load i32, ptr %arrayidx.i.i, align 4, !tbaa !19
  %arrayidx7.i.i = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.i.i
  store i32 %17, ptr %arrayidx7.i.i, align 4, !tbaa !19
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1
  %arrayidx.i.i.1 = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.next.i.i
  %18 = load i32, ptr %arrayidx.i.i.1, align 4, !tbaa !19
  %arrayidx7.i.i.1 = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.next.i.i
  store i32 %18, ptr %arrayidx7.i.i.1, align 4, !tbaa !19
  %indvars.iv.next.i.i.1 = add nuw nsw i64 %indvars.iv.i.i, 2
  %arrayidx.i.i.2 = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.next.i.i.1
  %19 = load i32, ptr %arrayidx.i.i.2, align 4, !tbaa !19
  %arrayidx7.i.i.2 = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.next.i.i.1
  store i32 %19, ptr %arrayidx7.i.i.2, align 4, !tbaa !19
  %indvars.iv.next.i.i.2 = add nuw nsw i64 %indvars.iv.i.i, 3
  %arrayidx.i.i.3 = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.next.i.i.2
  %20 = load i32, ptr %arrayidx.i.i.3, align 4, !tbaa !19
  %arrayidx7.i.i.3 = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.next.i.i.2
  store i32 %20, ptr %arrayidx7.i.i.3, align 4, !tbaa !19
  %indvars.iv.next.i.i.3 = add nuw nsw i64 %indvars.iv.i.i, 4
  %exitcond.not.i.i.3 = icmp eq i64 %indvars.iv.next.i.i.3, %wide.trip.count.i.i
...
while.cond.i:                                     ; preds = %while.cond.i, %_ZN11CStringBaseIwE10GrowLengthEi.exit
  ...
  %25 = load i32, ptr %src.addr.0.i, align 4, !tbaa !19
  %incdec.ptr1.i = getelementptr inbounds i32, ptr %dest.addr.0.i, i64 1
  store i32 %25, ptr %dest.addr.0.i, align 4, !tbaa !19
...
_Z12MyStringCopyIwEPT_S1_PKS0_.exit:              ; preds = %while.cond.i
  %26 = load i32, ptr %_length, align 8, !tbaa !21
...
if.then.i:                                        ; preds = %lor.lhs.false.i, %entry
  ...
  %call.i.i7.i = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #12, !noalias !42
...
if.end.i:                                         ; preds = %lor.lhs.false.i
  ...
  %5 = select i1 %3, i64 -1, i64 %4
  %call.i.i.i.i = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %5) #12, !noalias !48
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %parts) #14
...
for.cond.preheader:                               ; preds = %entry
  ...
  %call.i.i.i13 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #12
...
_ZN13CObjectVectorI11CStringBaseIwEED2Ev.exit:    ; preds = %invoke.cont6
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %parts) #14
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %parts) #14
  ret void

ehcleanup7:                                       ; preds = %lpad, %delete.notnull.i.i, %lpad.i
  %.pn = phi { ptr, i32 } [ %7, %lpad ], [ %lpad.phi.i, %delete.notnull.i.i ], [ %lpad.phi.i, %lpad.i ]
  call void @_ZN13CObjectVectorI11CStringBaseIwEED2Ev(ptr noundef nonnull align 8 dereferenceable(32) %parts) #14
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %parts) #14
  resume { ptr, i32 } %.pn
}
