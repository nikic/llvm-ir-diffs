...
for.body:                                         ; preds = %for.body.lr.ph, %if.end
  ...
  %call.i.i.i = tail call noundef i32 @_Z15MyStringComparePKwS0_(ptr noundef %3, ptr noundef nonnull @.str)
  %cmp.i.i = icmp eq i32 %call.i.i.i, 0
  br i1 %cmp.i.i, label %if.then.i, label %lor.lhs.false.i

lor.lhs.false.i:                                  ; preds = %for.body
  %4 = load ptr, ptr %2, align 8
  %call.i.i5.i = tail call noundef i32 @_Z15MyStringComparePKwS0_(ptr noundef %4, ptr noundef nonnull @.str.1)
  %cmp.i6.i = icmp eq i32 %call.i.i5.i, 0
  br i1 %cmp.i6.i, label %if.then.i, label %if.end.i

if.then.i:                                        ; preds = %lor.lhs.false.i, %for.body
  %call.i.i7.i = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #12
  store i32 0, ptr %call.i.i7.i, align 4
  br label %if.end.i12

if.end.i:                                         ; preds = %lor.lhs.false.i
  %path.val.i = load ptr, ptr %2, align 8
  %5 = getelementptr inbounds i8, ptr %2, i64 8
  %path.val4.i = load i32, ptr %5, align 8
...
if.end9.i.i.i.i:                                  ; preds = %if.end.i
  ...
  %call.i.i.i.i = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %8) #12
...
while.cond.i.i.i.i:                               ; preds = %while.cond.i.i.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i.i
  ...
  %9 = load i32, ptr %src.addr.0.i.i.i.i, align 4
  %incdec.ptr1.i.i.i.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i.i, i64 1
  store i32 %9, ptr %dest.addr.0.i.i.i.i, align 4
  %cmp.not.i.i.i.i = icmp eq i32 %9, 0
  br i1 %cmp.not.i.i.i.i, label %if.end.i12, label %while.cond.i.i.i.i
...
if.end.i12:                                       ; preds = %while.cond.i.i.i.i, %if.then.i
  ...
  %11 = load i32, ptr %_capacity.i.i13, align 4
...
while.cond.i.i:                                   ; preds = %while.cond.i.i.preheader, %while.cond.i.i
  ...
  %16 = load i32, ptr %src.addr.0.i.i, align 4
  %incdec.ptr1.i.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i, i64 1
  store i32 %16, ptr %dest.addr.0.i.i, align 4
...
_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i:            ; preds = %while.cond.i.i
  store i32 %ref.tmp.sroa.10.1, ptr %_length.i.i, align 8
...
if.then:                                          ; preds = %_ZN11CStringBaseIwED2Ev.exit
  %vtable = load ptr, ptr %pathParts, align 8
...
entry:
  ...
  %call.i.i.i = tail call noundef i32 @_Z15MyStringComparePKwS0_(ptr noundef %0, ptr noundef nonnull @.str)
  %cmp.i.i = icmp eq i32 %call.i.i.i, 0
  br i1 %cmp.i.i, label %if.then.i, label %lor.lhs.false.i

lor.lhs.false.i:                                  ; preds = %entry
  %1 = load ptr, ptr %path, align 8
  %call.i.i5.i = tail call noundef i32 @_Z15MyStringComparePKwS0_(ptr noundef %1, ptr noundef nonnull @.str.1)
  %cmp.i6.i = icmp eq i32 %call.i.i5.i, 0
  br i1 %cmp.i6.i, label %if.then.i, label %if.end.i
...
if.end.i:                                         ; preds = %lor.lhs.false.i
  ...
  %5 = select i1 %3, i64 -1, i64 %4
  %call.i.i.i.i = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %5) #12
...
while.cond.i.i.i.i:                               ; preds = %if.end.i, %while.cond.i.i.i.i
  ...
  br i1 %cmp.not.i.i.i.i, label %_ZL21ReplaceIncorrectCharsRK11CStringBaseIwE.exit.i, label %while.cond.i.i.i.i
...
_ZL21ReplaceIncorrectCharsRK11CStringBaseIwE.exit.i: ; preds = %while.cond.i.i.i.i
  ...
  store i32 %path.val4.i, ptr %_length.i.i.i, align 8
  br label %_ZL18GetCorrectFileNameRK11CStringBaseIwE.exit
...
entry:
  ...
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorI11CStringBaseIwEE, i64 0, inrange i32 0, i64 2), ptr %parts, align 8
...
call.i.i.i.noexc:                                 ; preds = %for.cond.preheader
  %_capacity.i.i = getelementptr inbounds %class.CStringBase, ptr %agg.result, i64 0, i32 2
  store ptr %call.i.i.i13, ptr %agg.result, align 8
...
invoke.cont4.peel.i:                              ; preds = %call.i.i.i.noexc
  ...
  %.pre.i = load ptr, ptr %_items.i.i.i, align 8
