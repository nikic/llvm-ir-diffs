...
_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit.i: ; preds = %cleanup.i.i, %if.end7.for.end.loopexit_crit_edge.i.i, %do.body.i
  ...
  br i1 %17, label %do.body3.preheader.split.i, label %do.body.i, !llvm.loop !15
...
do.body3.preheader.split.i:                       ; preds = %_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit.i
  ...
  store i32 %19, ptr %arrayidx70.i, align 4, !tbaa !13
...
land.lhs.true.i52.i:                              ; preds = %if.end.i30.i
  ...
  %21 = load i32, ptr %add.ptr2.i55.i, align 4, !tbaa !13
  ...
  %24 = load i32, ptr %add.ptr.i54.i, align 4, !tbaa !13
...
if.end7.i34.i:                                    ; preds = %land.lhs.true.i52.i, %if.end.i30.i
  ...
  %28 = load i32, ptr %add.ptr9.i37.i, align 4, !tbaa !13
...
cleanup.i40.i:                                    ; preds = %if.end7.i34.i
  %30 = load i32, ptr %add.ptr9.i37.i, align 4, !tbaa !13
  ...
  store i32 %30, ptr %arrayidx17.i42.i, align 4, !tbaa !13
...
_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit60.i: ; preds = %cleanup.i40.i, %if.end7.for.end.loopexit_crit_edge.i50.i
  ...
  store i32 %temp.i27.i.0, ptr %arrayidx19.i49.i, align 4, !tbaa !13
