; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Common/SortUtils.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Common/SortUtils.cpp"
...
entry.for.cond.cleanup_crit_edge:                 ; preds = %entry
  ...
  %.pre = load i32, ptr %_size.i9.phi.trans.insert, align 4
...
land.lhs.true.i.i:                                ; preds = %if.end.i.i
  ...
  %11 = load ptr, ptr %arrayidx.i.i6.i29, align 8
...
_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit.i: ; preds = %cleanup.i.i, %if.end7.for.end.loopexit_crit_edge.i.i, %do.body.i
  ...
  store i32 %5, ptr %arrayidx19.i.i, align 4
  %indvars.iv.next.i = add nsw i64 %indvars.iv.i, -1
  %17 = icmp eq i64 %indvars.iv.next.i, 0
  br i1 %17, label %do.body3.preheader.split.i, label %do.body.i

do.body3.preheader.split.i:                       ; preds = %_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit.i
  %idxprom69.i = sext i32 %1 to i64
  %arrayidx70.i = getelementptr inbounds i32, ptr %add.ptr.i, i64 %idxprom69.i
  %18 = load i32, ptr %arrayidx70.i, align 4
  %19 = load i32, ptr %2, align 4
  store i32 %19, ptr %arrayidx70.i, align 4
  store i32 %18, ptr %2, align 4
  %cmp44.i2972.i = icmp slt i32 %1, 3
  br i1 %cmp44.i2972.i, label %_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit60.thread.i, label %if.end.i30.preheader.i

if.end.i30.preheader.i:                           ; preds = %do.body3.preheader.split.i, %_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit60.i
  %temp.i27.i.0 = phi i32 [ %32, %_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit60.i ], [ %18, %do.body3.preheader.split.i ]
  %indvars.iv80.i = phi i64 [ %indvars.iv.next81.i, %_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit60.i ], [ %idxprom69.i, %do.body3.preheader.split.i ]
  %indvars.iv.next81.i = add nsw i64 %indvars.iv80.i, -1
  %idxprom.i.i.i = sext i32 %temp.i27.i.0 to i64
  br label %if.end.i30.i

_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit60.thread.i: ; preds = %_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit60.i, %do.body3.preheader.split.i
  %.lcssa.i = phi i32 [ %18, %do.body3.preheader.split.i ], [ %32, %_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit60.i ]
  store i32 %.lcssa.i, ptr %2, align 4
...
if.end.i30.i:                                     ; preds = %cleanup.i40.i, %if.end.i30.preheader.i
  ...
  %20 = sext i32 %shl46.i31.i to i64
  %cmp1.i33.i = icmp sgt i64 %indvars.iv.next81.i, %20
  br i1 %cmp1.i33.i, label %land.lhs.true.i52.i, label %if.end7.i34.i

land.lhs.true.i52.i:                              ; preds = %if.end.i30.i
  %add.ptr.i54.i = getelementptr inbounds i32, ptr %add.ptr.i, i64 %20
  %add.ptr2.i55.i = getelementptr inbounds i32, ptr %add.ptr.i54.i, i64 1
  %21 = load i32, ptr %add.ptr2.i55.i, align 4
  %22 = load ptr, ptr %_items.i.i.i25, align 8
  %idxprom.i.i.i14 = sext i32 %21 to i64
  %arrayidx.i.i.i15 = getelementptr inbounds ptr, ptr %22, i64 %idxprom.i.i.i14
  %23 = load ptr, ptr %arrayidx.i.i.i15, align 8
  %24 = load i32, ptr %add.ptr.i54.i, align 4
  %idxprom.i.i5.i16 = sext i32 %24 to i64
  %arrayidx.i.i6.i17 = getelementptr inbounds ptr, ptr %22, i64 %idxprom.i.i5.i16
  %25 = load ptr, ptr %arrayidx.i.i6.i17, align 8
  ...
  %cmp5.i57.i = icmp sgt i32 %call2.i18, 0
...
if.end7.i34.i:                                    ; preds = %land.lhs.true.i52.i, %if.end.i30.i
  %idx.ext8.i36.pre-phi.i = phi i64 [ %.pre.i, %land.lhs.true.i52.i ], [ %20, %if.end.i30.i ]
  %s.0.i35.i = phi i32 [ %spec.select.i59.i, %land.lhs.true.i52.i ], [ %shl46.i31.i, %if.end.i30.i ]
  %add.ptr9.i37.i = getelementptr inbounds i32, ptr %add.ptr.i, i64 %idx.ext8.i36.pre-phi.i
  %26 = load ptr, ptr %_items.i.i.i25, align 8
  %arrayidx.i.i.i = getelementptr inbounds ptr, ptr %26, i64 %idxprom.i.i.i
  %27 = load ptr, ptr %arrayidx.i.i.i, align 8
  %28 = load i32, ptr %add.ptr9.i37.i, align 4
  %idxprom.i.i5.i = sext i32 %28 to i64
  %arrayidx.i.i6.i = getelementptr inbounds ptr, ptr %26, i64 %idxprom.i.i5.i
  %29 = load ptr, ptr %arrayidx.i.i6.i, align 8
  ...
  %cmp11.i39.i = icmp sgt i32 %call2.i, -1
  br i1 %cmp11.i39.i, label %if.end7.for.end.loopexit_crit_edge.i50.i, label %cleanup.i40.i

if.end7.for.end.loopexit_crit_edge.i50.i:         ; preds = %if.end7.i34.i
  %.pre49.i51.i = sext i32 %k.addr.045.i32.i to i64
  br label %_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit60.i

cleanup.i40.i:                                    ; preds = %if.end7.i34.i
  %30 = load i32, ptr %add.ptr9.i37.i, align 4
  %idxprom16.i41.i = sext i32 %k.addr.045.i32.i to i64
  %arrayidx17.i42.i = getelementptr inbounds i32, ptr %add.ptr.i, i64 %idxprom16.i41.i
  store i32 %30, ptr %arrayidx17.i42.i, align 4
  %shl.i43.i = shl i32 %s.0.i35.i, 1
  %31 = sext i32 %shl.i43.i to i64
  %cmp.i44.not.i = icmp sgt i64 %indvars.iv80.i, %31
  br i1 %cmp.i44.not.i, label %if.end.i30.i, label %_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit60.i

_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit60.i: ; preds = %cleanup.i40.i, %if.end7.for.end.loopexit_crit_edge.i50.i
  %.pre48.pre-phi.i46.i = phi i64 [ %.pre49.i51.i, %if.end7.for.end.loopexit_crit_edge.i50.i ], [ %idx.ext8.i36.pre-phi.i, %cleanup.i40.i ]
  %arrayidx19.i49.i = getelementptr inbounds i32, ptr %add.ptr.i, i64 %.pre48.pre-phi.i46.i
  store i32 %temp.i27.i.0, ptr %arrayidx19.i49.i, align 4
  %arrayidx.i = getelementptr inbounds i32, ptr %add.ptr.i, i64 %indvars.iv.next81.i
  %32 = load i32, ptr %arrayidx.i, align 4
  %33 = load i32, ptr %2, align 4
  store i32 %33, ptr %arrayidx.i, align 4
  store i32 %32, ptr %2, align 4
  %cmp44.i29.i = icmp slt i64 %indvars.iv80.i, 4
  br i1 %cmp44.i29.i, label %_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit60.thread.i, label %if.end.i30.preheader.i
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %34 = load ptr, ptr %_items.i, align 8
  %35 = load i32, ptr %_size.i10, align 4
  %idxprom.i = sext i32 %35 to i64
  %arrayidx.i11 = getelementptr inbounds i32, ptr %34, i64 %idxprom.i
  store i32 %i.038, ptr %arrayidx.i11, align 4
  %36 = load i32, ptr %_size.i10, align 4
  %inc.i = add nsw i32 %36, 1
  store i32 %inc.i, ptr %_size.i10, align 4
