; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Common/OpenArchive.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Common/OpenArchive.cpp"
...
%class.CObjectVector.7 = type { %class.CRecordVector.0 }
...
if.end9.i.i:                                      ; preds = %delete.notnull.i.i, %call.i.i.noexc
  ...
  store ptr %call.i.i83, ptr %result, align 8
...
_ZN11CStringBaseIwEaSEPKw.exit:                   ; preds = %while.cond.i.i
  store i32 %8, ptr %_length.i.i, align 8
  br label %cleanup17
...
cleanup.cont20:                                   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit
  ...
  %19 = load i32, ptr %_length.i84, align 8
...
if.end.i:                                         ; preds = %if.then23
  store i32 0, ptr %_length.i84, align 8
  %20 = load ptr, ptr %result, align 8
  store i32 0, ptr %20, align 4
  %_length.i87 = getelementptr inbounds %struct.CArc, ptr %this, i64 0, i32 2, i32 1
  %21 = load i32, ptr %_length.i87, align 8
  %add.i.i88 = add nsw i32 %21, 1
  %_capacity.i.i89 = getelementptr inbounds %class.CStringBase, ptr %result, i64 0, i32 2
  %22 = load i32, ptr %_capacity.i.i89, align 4
  %cmp.i.i90 = icmp eq i32 %add.i.i88, %22
  br i1 %cmp.i.i90, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i97, label %if.end.i.i91

if.end.i.i91:                                     ; preds = %if.end.i
  %conv.i.i92 = zext i32 %add.i.i88 to i64
  %23 = icmp slt i32 %21, -1
  %24 = shl nuw nsw i64 %conv.i.i92, 2
  %25 = select i1 %23, i64 -1, i64 %24
  %call.i.i = call noalias noundef nonnull ptr @_Znam(i64 noundef %25) #18
  %cmp3.i.i93 = icmp sgt i32 %22, 0
  br i1 %cmp3.i.i93, label %delete.notnull.i.i104, label %if.end9.i.i94

delete.notnull.i.i104:                            ; preds = %if.end.i.i91
  call void @_ZdaPv(ptr noundef nonnull %20) #19
  %.pre.i105 = load i32, ptr %_length.i84, align 8
  %26 = sext i32 %.pre.i105 to i64
  br label %if.end9.i.i94

if.end9.i.i94:                                    ; preds = %delete.notnull.i.i104, %if.end.i.i91
  %idxprom13.i.i95 = phi i64 [ %26, %delete.notnull.i.i104 ], [ 0, %if.end.i.i91 ]
  store ptr %call.i.i, ptr %result, align 8
  %arrayidx14.i.i96 = getelementptr inbounds i32, ptr %call.i.i, i64 %idxprom13.i.i95
  store i32 0, ptr %arrayidx14.i.i96, align 4
  store i32 %add.i.i88, ptr %_capacity.i.i89, align 4
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i97

_ZN11CStringBaseIwE11SetCapacityEi.exit.i97:      ; preds = %if.end9.i.i94, %if.end.i
  %27 = phi ptr [ %20, %if.end.i ], [ %call.i.i, %if.end9.i.i94 ]
  %28 = load ptr, ptr %DefaultName, align 8
  br label %while.cond.i.i98

while.cond.i.i98:                                 ; preds = %while.cond.i.i98, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i97
  %src.addr.0.i.i99 = phi ptr [ %28, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i97 ], [ %incdec.ptr.i.i101, %while.cond.i.i98 ]
  %dest.addr.0.i.i100 = phi ptr [ %27, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i97 ], [ %incdec.ptr1.i.i102, %while.cond.i.i98 ]
  %incdec.ptr.i.i101 = getelementptr inbounds i32, ptr %src.addr.0.i.i99, i64 1
  %29 = load i32, ptr %src.addr.0.i.i99, align 4
  %incdec.ptr1.i.i102 = getelementptr inbounds i32, ptr %dest.addr.0.i.i100, i64 1
  store i32 %29, ptr %dest.addr.0.i.i100, align 4
  %cmp.not.i.i103 = icmp eq i32 %29, 0
  br i1 %cmp.not.i.i103, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i, label %while.cond.i.i98

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i:            ; preds = %while.cond.i.i98
  %30 = load i32, ptr %_length.i87, align 8
  store i32 %30, ptr %_length.i84, align 8
...
cleanup.cont40:                                   ; preds = %invoke.cont33
  %36 = load i16, ptr %prop25, align 8
...
entry:
  ...
  %wReserved1.i = getelementptr inbounds %struct.tagPROPVARIANT, ptr %prop, i64 0, i32 1
  store i16 0, ptr %wReserved1.i, align 2
  store i8 0, ptr %defined, align 1
...
if.else10:                                        ; preds = %cleanup.cont
  ...
  %7 = load i8, ptr %MTimeDefined, align 8
...
cleanup15.sink.split:                             ; preds = %if.then11, %if.then5
  ...
  store i8 1, ptr %defined, align 1
  br label %cleanup15
...
entry:
  ...
  %orderIndices = alloca %class.CRecordVector, align 8
  %orderIndices2 = alloca %class.CRecordVector, align 8
...
_ZN9CMyComPtrI10IInArchiveE7ReleaseEv.exit:       ; preds = %entry, %if.then.i
  ...
  store i32 0, ptr %_length.i, align 8
  %2 = load ptr, ptr %ErrorMessage, align 8
...
if.end7.i:                                        ; preds = %for.cond.i
  ...
  br i1 %cmp9.i, label %if.end, label %for.cond.i
...
invoke.cont5:                                     ; preds = %if.then
  store i32 0, ptr %call.i.i793, align 4
  %_length.i797 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp, i64 0, i32 1
  %7 = load i32, ptr %_length.i797, align 8
...
if.end9.i.i:                                      ; preds = %if.end.i.i
  ...
  store i32 0, ptr %call.i.i798, align 4
...
while.cond.i.i:                                   ; preds = %while.cond.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i
  ...
  %incdec.ptr.i.i = getelementptr inbounds i32, ptr %src.addr.0.i.i, i64 1
  %12 = load i32, ptr %src.addr.0.i.i, align 4
  %incdec.ptr1.i.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i, i64 1
  store i32 %12, ptr %dest.addr.0.i.i, align 4
...
ehcleanup:                                        ; preds = %delete.notnull.i800, %lpad6, %lpad4
  %.pn = phi { ptr, i32 } [ %14, %lpad4 ], [ %15, %lpad6 ], [ %15, %delete.notnull.i800 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp) #16
...
if.end:                                           ; preds = %if.end7.i, %invoke.cont, %_ZN11CStringBaseIwED2Ev.exit, %invoke.cont3
  ...
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CRecordVectorIiE, i64 0, inrange i32 0, i64 2), ptr %orderIndices, align 8
...
for.cond.preheader:                               ; preds = %if.end
  ...
  %17 = load i32, ptr %_size.i803, align 4
...
invoke.cont22:                                    ; preds = %invoke.cont22.lr.ph, %for.inc
  ...
  %24 = load i32, ptr %_size.i.i, align 4
...
for.inc.i:                                        ; preds = %call.i.i.noexc804
  ...
  %28 = load i32, ptr %_size.i.i, align 4
  %29 = sext i32 %28 to i64
  %cmp.not.i = icmp slt i64 %indvars.iv.next.i, %29
  br i1 %cmp.not.i, label %for.body.i, label %if.else29
...
_ZN13CRecordVectorIiE3AddEi.exit814:              ; preds = %if.else29
  %33 = load ptr, ptr %_items.i809, align 8
  %34 = load i32, ptr %_size.i810, align 4
  %idxprom.i811 = sext i32 %34 to i64
  %arrayidx.i812 = getelementptr inbounds i32, ptr %33, i64 %idxprom.i811
  %35 = trunc i64 %indvars.iv to i32
  store i32 %35, ptr %arrayidx.i812, align 4
  %36 = load i32, ptr %_size.i810, align 4
  %inc.i813 = add nsw i32 %36, 1
  store i32 %inc.i813, ptr %_size.i810, align 4
  br label %for.inc
...
for.inc:                                          ; preds = %_ZN13CRecordVectorIiE3AddEi.exit814, %_ZN13CRecordVectorIiE6InsertEii.exit
  ...
  %37 = load i32, ptr %_size.i803, align 4
  %38 = sext i32 %37 to i64
  %cmp20 = icmp slt i64 %indvars.iv.next, %38
  br i1 %cmp20, label %invoke.cont22, label %for.end
...
for.end.thread:                                   ; preds = %for.cond.preheader
  %tobool.not1510 = icmp eq ptr %stream, null
  br i1 %tobool.not1510, label %_ZN11CStringBaseIwED2Ev.exit1264, label %if.end39.thread1515
...
if.end39:                                         ; preds = %for.end
  ...
  %39 = load i32, ptr %_size.i815, align 4
  %cmp42 = icmp sgt i32 %39, 1
  br i1 %cmp42, label %land.lhs.true, label %if.else275

if.end39.thread1515:                              ; preds = %for.end.thread
  %_size.i8151517 = getelementptr inbounds %class.CBaseRecordVector, ptr %orderIndices, i64 0, i32 2
  %40 = load i32, ptr %_size.i8151517, align 4
  %cmp421518 = icmp sgt i32 %40, 1
  br i1 %cmp421518, label %if.end.i823, label %if.else275

if.end39.thread:                                  ; preds = %if.end37
  %_size.i8151304 = getelementptr inbounds %class.CBaseRecordVector, ptr %orderIndices, i64 0, i32 2
  %41 = load i32, ptr %_size.i8151304, align 4
...
if.end.i823:                                      ; preds = %if.end39.thread1515, %land.lhs.true, %invoke.cont44
  %_size.i81513061314 = phi ptr [ %_size.i81513061313, %invoke.cont44 ], [ %_size.i815, %land.lhs.true ], [ %_size.i8151517, %if.end39.thread1515 ]
  ...
  store i64 4, ptr %_itemSize.i.i819, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CRecordVectorIiE, i64 0, inrange i32 0, i64 2), ptr %orderIndices2, align 8
...
cleanup.cont:                                     ; preds = %invoke.cont55
  ...
  store i64 2097152, ptr %processedSize, align 8
...
cleanup.cont72:                                   ; preds = %invoke.cont65
  %45 = load i64, ptr %processedSize, align 8
...
if.end76:                                         ; preds = %cleanup.cont72
  ...
  store ptr getelementptr inbounds ({ [4 x ptr] }, ptr @_ZTV7CBufferIhE, i64 0, inrange i32 0, i64 2), ptr %hashBuffer, align 8
...
invoke.cont83:                                    ; preds = %if.end76
  ...
  %46 = load ptr, ptr %_items.i832, align 8
  ...
  %47 = load i32, ptr %_size.i81513061314, align 4
...
invoke.cont104:                                   ; preds = %invoke.cont104.lr.ph, %cleanup126
  ...
  %indvars.iv1493 = phi i64 [ 0, %invoke.cont104.lr.ph ], [ %indvars.iv.next1494, %cleanup126 ]
  %50 = load ptr, ptr %_items.i835, align 8
  %arrayidx.i837 = getelementptr inbounds i32, ptr %50, i64 %indvars.iv1493
  %51 = load i32, ptr %arrayidx.i837, align 4
  %52 = load ptr, ptr %_items.i.i838, align 8
  %idxprom.i.i839 = sext i32 %51 to i64
  %arrayidx.i.i840 = getelementptr inbounds ptr, ptr %52, i64 %idxprom.i.i839
  %53 = load ptr, ptr %arrayidx.i.i840, align 8
  %_capacity.i841 = getelementptr inbounds %struct.CArcInfoEx, ptr %53, i64 0, i32 6, i32 1
  %54 = load i64, ptr %_capacity.i841, align 8
...
if.end111:                                        ; preds = %invoke.cont104
  ...
  %56 = load ptr, ptr %_items.i842, align 8
  %57 = load i16, ptr %56, align 1
  %58 = zext i16 %57 to i64
  %arrayidx119 = getelementptr inbounds i8, ptr %46, i64 %58
  %59 = load i8, ptr %arrayidx119, align 1
  %arrayidx121 = getelementptr inbounds [256 x i8], ptr %prevs, i64 0, i64 %indvars.iv1493
  store i8 %59, ptr %arrayidx121, align 1
  %conv122 = trunc i64 %indvars.iv1493 to i8
  store i8 %conv122, ptr %arrayidx119, align 1
  %.pre = load i32, ptr %_size.i81513061314, align 4
  br label %cleanup126
...
cleanup126:                                       ; preds = %invoke.cont104, %if.end111
  ...
  %cmp98 = icmp slt i64 %indvars.iv.next1494, %61
  br i1 %cmp98, label %invoke.cont104, label %for.end134

for.end134:                                       ; preds = %cleanup126, %for.cond94.preheader
  %62 = phi i32 [ %47, %for.cond94.preheader ], [ %60, %cleanup126 ]
  %63 = load i64, ptr %processedSize, align 8
  %sub = add i64 %63, -1
  store i64 %sub, ptr %processedSize, align 8
  %cmp1371446.not = icmp eq i64 %sub, 0
  br i1 %cmp1371446.not, label %cleanup226, label %for.cond139.preheader.lr.ph
...
for.cond139.preheader:                            ; preds = %for.cond139.preheader.lr.ph, %do.end
  ...
  %pos.01447 = phi i32 [ 0, %for.cond139.preheader.lr.ph ], [ %add167, %do.end ]
  br label %for.cond139

for.cond139:                                      ; preds = %for.cond139.preheader, %land.rhs
  %pos.1 = phi i32 [ %add145, %land.rhs ], [ %pos.01447, %for.cond139.preheader ]
...
land.rhs:                                         ; preds = %for.cond139
  ...
  %66 = load i8, ptr %arrayidx147, align 1
  ...
  %67 = load i8, ptr %arrayidx152, align 1
  %cmp154 = icmp eq i8 %67, -1
  br i1 %cmp154, label %for.cond139, label %for.end158
...
if.end162:                                        ; preds = %for.end158
  ...
  %68 = load i8, ptr %arrayidx165, align 1
  ...
  %69 = load i8, ptr %arrayidx169, align 1
  ...
  %70 = load i8, ptr %arrayidx174, align 1
...
land.lhs.true191:                                 ; preds = %invoke.cont183
  ...
  %76 = load i64, ptr %processedSize, align 8
  %add196 = add i64 %76, 1
...
land.lhs.true198:                                 ; preds = %land.lhs.true191
  ...
  %77 = load ptr, ptr %_items.i852, align 8
  %78 = load i8, ptr %arrayidx165, align 1
  %79 = load i8, ptr %77, align 1
  %cmp3.not.i1442 = icmp eq i8 %78, %79
  br i1 %cmp3.not.i1442, label %for.cond.i857, label %if.else212

for.cond.i857:                                    ; preds = %land.lhs.true198, %for.body.i854
  %i.08.i1443 = phi i64 [ %inc.i858, %for.body.i854 ], [ 0, %land.lhs.true198 ]
  %inc.i858 = add nuw i64 %i.08.i1443, 1
  %exitcond.i = icmp eq i64 %inc.i858, %75
  br i1 %exitcond.i, label %_ZL13TestSignaturePKhS0_m.exit, label %for.body.i854

for.body.i854:                                    ; preds = %for.cond.i857
  %arrayidx.i856 = getelementptr inbounds i8, ptr %arrayidx165, i64 %inc.i858
  %80 = load i8, ptr %arrayidx.i856, align 1
  %arrayidx1.i = getelementptr inbounds i8, ptr %77, i64 %inc.i858
  %81 = load i8, ptr %arrayidx1.i, align 1
  %cmp3.not.i = icmp eq i8 %80, %81
  br i1 %cmp3.not.i, label %for.cond.i857, label %_ZL13TestSignaturePKhS0_m.exit

_ZL13TestSignaturePKhS0_m.exit:                   ; preds = %for.body.i854, %for.cond.i857
  %cmp.i859.not.le = icmp ult i64 %inc.i858, %75
  br i1 %cmp.i859.not.le, label %if.else212, label %if.then205
...
if.else212:                                       ; preds = %land.lhs.true198, %_ZL13TestSignaturePKhS0_m.exit, %land.lhs.true191, %invoke.cont183
  ...
  %.pr = load i8, ptr %arrayidx214, align 1
  br label %if.end215
...
if.end215:                                        ; preds = %if.else212, %invoke.cont206
  ...
  br i1 %cmp220.not, label %do.end, label %invoke.cont183

do.end:                                           ; preds = %if.end215
  %89 = load i64, ptr %processedSize, align 8
  %cmp137 = icmp ugt i64 %89, %idxprom168
  br i1 %cmp137, label %for.cond139.preheader, label %cleanup226.loopexit

cleanup226.loopexit:                              ; preds = %for.end158, %do.end
  %.pre1505 = load i32, ptr %_size.i81513061314, align 4
  br label %cleanup226

cleanup226:                                       ; preds = %cleanup226.loopexit, %for.end134
  %90 = phi i32 [ %.pre1505, %cleanup226.loopexit ], [ %62, %for.end134 ]
  %cmp2321448 = icmp sgt i32 %90, 0
  br i1 %cmp2321448, label %for.body233.lr.ph, label %for.end245
...
for.body233:                                      ; preds = %for.body233.lr.ph, %if.end241
  ...
  %indvars.iv1496 = phi i64 [ 0, %for.body233.lr.ph ], [ %indvars.iv.next1497, %if.end241 ]
  %92 = load ptr, ptr %_items.i870, align 8
  %arrayidx.i872 = getelementptr inbounds i32, ptr %92, i64 %indvars.iv1496
  %93 = load i32, ptr %arrayidx.i872, align 4
...
_ZN13CRecordVectorIiE3AddEi.exit878:              ; preds = %if.then238
  %94 = load ptr, ptr %_items.i873, align 8
  %95 = load i32, ptr %_size.i874, align 4
  %idxprom.i875 = sext i32 %95 to i64
  %arrayidx.i876 = getelementptr inbounds i32, ptr %94, i64 %idxprom.i875
  store i32 %93, ptr %arrayidx.i876, align 4
  %96 = load i32, ptr %_size.i874, align 4
  %inc.i877 = add nsw i32 %96, 1
  store i32 %inc.i877, ptr %_size.i874, align 4
  %.pre1506 = load i32, ptr %_size.i81513061314, align 4
  br label %if.end241
...
if.end241:                                        ; preds = %_ZN13CRecordVectorIiE3AddEi.exit878, %for.body233
  %98 = phi i32 [ %.pre1506, %_ZN13CRecordVectorIiE3AddEi.exit878 ], [ %91, %for.body233 ]
  %indvars.iv.next1497 = add nuw nsw i64 %indvars.iv1496, 1
  %99 = sext i32 %98 to i64
  %cmp232 = icmp slt i64 %indvars.iv.next1497, %99
  br i1 %cmp232, label %for.body233, label %for.end245
...
cleanup249:                                       ; preds = %for.end245
  %.pr1315 = load ptr, ptr %_items.i832, align 8
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %prevs) #16
  store ptr getelementptr inbounds ({ [4 x ptr] }, ptr @_ZTV7CBufferIhE, i64 0, inrange i32 0, i64 2), ptr %hashBuffer, align 8
...
ehcleanup248:                                     ; preds = %lpad187, %lpad234, %lpad95
  %.pn766 = phi { ptr, i32 } [ %97, %lpad234 ], [ %55, %lpad95 ], [ %87, %lpad187 ]
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %prevs) #16
  br label %ehcleanup254

ehcleanup254:                                     ; preds = %ehcleanup248, %lpad82
  %.pn766.pn = phi { ptr, i32 } [ %.pn766, %ehcleanup248 ], [ %48, %lpad82 ]
  store ptr getelementptr inbounds ({ [4 x ptr] }, ptr @_ZTV7CBufferIhE, i64 0, inrange i32 0, i64 2), ptr %hashBuffer, align 8
  %_items.i888 = getelementptr inbounds %class.CBuffer, ptr %hashBuffer, i64 0, i32 2
  %101 = load ptr, ptr %_items.i888, align 8
...
ehcleanup262:                                     ; preds = %_ZN7CBufferIhED2Ev.exit892, %lpad62
  %.pn766.pn.pn = phi { ptr, i32 } [ %.pn766.pn, %_ZN7CBufferIhED2Ev.exit892 ], [ %44, %lpad62 ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %processedSize) #16
  br label %delete.notnull.i895
...
delete.notnull.i895:                              ; preds = %ehcleanup262, %lpad54
  %.pn766.pn.pn.pn.ph = phi { ptr, i32 } [ %43, %lpad54 ], [ %.pn766.pn.pn, %ehcleanup262 ]
  call void @_ZdaPv(ptr noundef nonnull %call.i824828) #19
  br label %_ZN7CBufferIhED2Ev.exit897

_ZN7CBufferIhED2Ev.exit897:                       ; preds = %ehcleanup264, %delete.notnull.i895
  %.pn766.pn.pn.pn1328 = phi { ptr, i32 } [ %102, %ehcleanup264 ], [ %.pn766.pn.pn.pn.ph, %delete.notnull.i895 ]
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %orderIndices2) #16
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %orderIndices2) #16
  br label %ehcleanup625

if.else275:                                       ; preds = %if.end39.thread1515, %if.end39.thread, %invoke.cont44, %if.end39
  %_size.i8151308 = phi ptr [ %_size.i8151304, %if.end39.thread ], [ %_size.i81513061313, %invoke.cont44 ], [ %_size.i815, %if.end39 ], [ %_size.i8151517, %if.end39.thread1515 ]
...
invoke.cont287:                                   ; preds = %if.end.i908
  %vtable292 = load ptr, ptr %stream, align 8
...
cleanup.cont302:                                  ; preds = %invoke.cont295
  ...
  store i64 1024, ptr %processedSize304, align 8
...
cleanup.cont314:                                  ; preds = %invoke.cont307
  %106 = load i64, ptr %processedSize304, align 8
  %cmp316 = icmp ugt i64 %106, 15
  %107 = load <4 x i8>, ptr %call.i909919, align 1
  %.fr = freeze <4 x i8> %107
  %arrayidx.i925.3 = getelementptr inbounds i8, ptr %call.i909919, i64 4
  %108 = load i8, ptr %arrayidx.i925.3, align 1
  %.fr1601 = freeze i8 %108
  %cmp3.not.i927.3 = icmp eq i8 %.fr1601, 26
  %arrayidx.i925.4 = getelementptr inbounds i8, ptr %call.i909919, i64 5
  %109 = load i8, ptr %arrayidx.i925.4, align 1
  %.fr1600 = freeze i8 %109
  %cmp3.not.i927.4 = icmp eq i8 %.fr1600, 7
  %arrayidx.i925.5 = getelementptr inbounds i8, ptr %call.i909919, i64 6
  %110 = load i8, ptr %arrayidx.i925.5, align 1
  %.fr1602 = freeze i8 %110
  %cmp3.not.i927.5 = icmp eq i8 %.fr1602, 0
  ...
  %op.rdx = and i1 %112, %cmp3.not.i927.3
  %113 = and i1 %op.rdx, %cmp3.not.i927.4
  %op.rdx1598 = and i1 %113, %cmp3.not.i927.5
  %114 = select i1 %op.rdx1598, i1 %cmp316, i1 false
  %op.rdx1599 = select i1 %114, i1 %cmp324, i1 false
  br i1 %op.rdx1599, label %land.lhs.true325, label %_ZN7CBufferIhED2Ev.exit950.thread1333

land.lhs.true325:                                 ; preds = %cleanup.cont314
  %arrayidx326 = getelementptr inbounds i8, ptr %call.i909919, i64 10
  %115 = load i8, ptr %arrayidx326, align 1
  %116 = and i8 %115, 1
...
for.cond331.preheader:                            ; preds = %land.lhs.true325
  %117 = load i32, ptr %_size.i8151308, align 4
...
invoke.cont345:                                   ; preds = %invoke.cont345.lr.ph, %for.inc359
  %indvars.iv1490 = phi i64 [ 0, %invoke.cont345.lr.ph ], [ %indvars.iv.next1491, %for.inc359 ]
  %118 = load ptr, ptr %_items.i935, align 8
  %arrayidx.i937 = getelementptr inbounds i32, ptr %118, i64 %indvars.iv1490
  %119 = load i32, ptr %arrayidx.i937, align 4
  %120 = load ptr, ptr %_items.i.i938, align 8
  %idxprom.i.i939 = sext i32 %119 to i64
  %arrayidx.i.i940 = getelementptr inbounds ptr, ptr %120, i64 %idxprom.i.i939
  %121 = load ptr, ptr %arrayidx.i.i940, align 8
...
if.end351:                                        ; preds = %invoke.cont347
  %123 = trunc i64 %indvars.iv1490 to i32
...
cleanup354.thread:                                ; preds = %invoke.cont352
  %124 = load ptr, ptr %_items.i935, align 8
...
for.inc359:                                       ; preds = %invoke.cont347
  ...
  %125 = load i32, ptr %_size.i8151308, align 4
  %126 = sext i32 %125 to i64
  %cmp335 = icmp slt i64 %indvars.iv.next1491, %126
  br i1 %cmp335, label %invoke.cont345, label %_ZN7CBufferIhED2Ev.exit950.thread1333
...
ehcleanup368:                                     ; preds = %lpad344.loopexit, %lpad344.loopexit.split-lp, %lpad306
  %.pn760 = phi { ptr, i32 } [ %105, %lpad306 ], [ %lpad.loopexit, %lpad344.loopexit ], [ %lpad.loopexit.split-lp, %lpad344.loopexit.split-lp ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %processedSize304) #16
  br label %delete.notnull.i953
...
delete.notnull.i953:                              ; preds = %ehcleanup368, %lpad294
  %.pn760.pn.pn.ph = phi { ptr, i32 } [ %104, %lpad294 ], [ %.pn760, %ehcleanup368 ]
  call void @_ZdaPv(ptr noundef nonnull %call.i909919) #19
  br label %ehcleanup625
...
if.end380:                                        ; preds = %_ZN7CBufferIhED2Ev.exit950.thread1333, %invoke.cont279, %_ZN7CBufferIhED2Ev.exit887
  ...
  %128 = load i32, ptr %_size.i8151307, align 4
  %cmp383 = icmp sgt i32 %128, 1
  br i1 %cmp383, label %if.end9.i.i962, label %if.end445

if.end9.i.i962:                                   ; preds = %if.end380
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i964:     ; preds = %if.end9.i.i962
  %_capacity.i957 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp385, i64 0, i32 2
  store ptr %call.i.i972, ptr %ref.tmp385, align 8
  store i32 4, ptr %_capacity.i957, align 4
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %call.i.i972, ptr noundef nonnull align 4 dereferenceable(16) @.str.4, i64 16, i1 false)
  %_length.i970 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp385, i64 0, i32 1
  store i32 3, ptr %_length.i970, align 8
...
invoke.cont389:                                   ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i964
  %129 = load ptr, ptr %ref.tmp385, align 8
  %isnull.i973 = icmp eq ptr %129, null
  br i1 %isnull.i973, label %if.end9.i.i986, label %delete.notnull.i974

delete.notnull.i974:                              ; preds = %invoke.cont389
  call void @_ZdaPv(ptr noundef nonnull %129) #19
  br label %if.end9.i.i986

if.end9.i.i986:                                   ; preds = %delete.notnull.i974, %invoke.cont389
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i988:     ; preds = %if.end9.i.i986
  %_capacity.i977 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp393, i64 0, i32 2
  store ptr %call.i.i997, ptr %ref.tmp393, align 8
  store i32 4, ptr %_capacity.i977, align 4
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %call.i.i997, ptr noundef nonnull align 4 dereferenceable(16) @.str.5, i64 16, i1 false)
  %_length.i995 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp393, i64 0, i32 1
  store i32 3, ptr %_length.i995, align 8
...
invoke.cont397:                                   ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i988
  %130 = load ptr, ptr %ref.tmp393, align 8
...
_ZN11CStringBaseIwED2Ev.exit1002:                 ; preds = %invoke.cont397, %delete.notnull.i1000
  ...
  %131 = load i32, ptr %_size.i8151307, align 4
  %cmp4061450 = icmp sgt i32 %131, 0
  br i1 %cmp4061450, label %for.body408.lr.ph, label %if.end445
...
for.body408.lr.ph:                                ; preds = %_ZN11CStringBaseIwED2Ev.exit1002
  ...
  %132 = load ptr, ptr %_items.i1012, align 8
...
for.cond.cleanup407.unr-lcssa:                    ; preds = %for.body408, %for.body408.lr.ph
  ...
  %indvars.iv1499.unr = phi i64 [ 0, %for.body408.lr.ph ], [ %indvars.iv.next1500.3, %for.body408 ]
  %iUdf.01452.unr = phi i32 [ -1, %for.body408.lr.ph ], [ %iUdf.1.3, %for.body408 ]
  %iIso.01451.unr = phi i32 [ -1, %for.body408.lr.ph ], [ %spec.select.3, %for.body408 ]
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
...
for.body408.epil:                                 ; preds = %for.cond.cleanup407.unr-lcssa, %for.body408.epil
  %indvars.iv1499.epil = phi i64 [ %indvars.iv.next1500.epil, %for.body408.epil ], [ %indvars.iv1499.unr, %for.cond.cleanup407.unr-lcssa ]
  %iUdf.01452.epil = phi i32 [ %iUdf.1.epil, %for.body408.epil ], [ %iUdf.01452.unr, %for.cond.cleanup407.unr-lcssa ]
  %iIso.01451.epil = phi i32 [ %spec.select.epil, %for.body408.epil ], [ %iIso.01451.unr, %for.cond.cleanup407.unr-lcssa ]
  %epil.iter = phi i64 [ %epil.iter.next, %for.body408.epil ], [ 0, %for.cond.cleanup407.unr-lcssa ]
  %arrayidx.i1014.epil = getelementptr inbounds i32, ptr %132, i64 %indvars.iv1499.epil
  %134 = load i32, ptr %arrayidx.i1014.epil, align 4
  %cmp411.epil = icmp eq i32 %134, %call390
  %135 = trunc i64 %indvars.iv1499.epil to i32
  %spec.select.epil = select i1 %cmp411.epil, i32 %135, i32 %iIso.01451.epil
  %cmp416.epil = icmp eq i32 %134, %call398
  %iUdf.1.epil = select i1 %cmp416.epil, i32 %135, i32 %iUdf.01452.epil
  %indvars.iv.next1500.epil = add nuw nsw i64 %indvars.iv1499.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %for.cond.cleanup407, label %for.body408.epil
...
lpad388:                                          ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i964
  %137 = landingpad { ptr, i32 }
          cleanup
  %138 = load ptr, ptr %ref.tmp385, align 8
...
ehcleanup392:                                     ; preds = %delete.notnull.i1005, %lpad388, %lpad386
  %.pn771 = phi { ptr, i32 } [ %136, %lpad386 ], [ %137, %lpad388 ], [ %137, %delete.notnull.i1005 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp385) #16
  br label %ehcleanup625

lpad394:                                          ; preds = %if.end9.i.i986
...
lpad396:                                          ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i988
  %140 = landingpad { ptr, i32 }
          cleanup
  %141 = load ptr, ptr %ref.tmp393, align 8
...
ehcleanup400:                                     ; preds = %delete.notnull.i1009, %lpad396, %lpad394
  %.pn773 = phi { ptr, i32 } [ %139, %lpad394 ], [ %140, %lpad396 ], [ %140, %delete.notnull.i1009 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp393) #16
  br label %ehcleanup625

for.body408:                                      ; preds = %for.body408, %for.body408.lr.ph.new
  %indvars.iv1499 = phi i64 [ 0, %for.body408.lr.ph.new ], [ %indvars.iv.next1500.3, %for.body408 ]
  %iUdf.01452 = phi i32 [ -1, %for.body408.lr.ph.new ], [ %iUdf.1.3, %for.body408 ]
  %iIso.01451 = phi i32 [ -1, %for.body408.lr.ph.new ], [ %spec.select.3, %for.body408 ]
  %niter = phi i64 [ 0, %for.body408.lr.ph.new ], [ %niter.next.3, %for.body408 ]
  %arrayidx.i1014 = getelementptr inbounds i32, ptr %132, i64 %indvars.iv1499
  %142 = load i32, ptr %arrayidx.i1014, align 4
  %cmp411 = icmp eq i32 %142, %call390
  %143 = trunc i64 %indvars.iv1499 to i32
  %spec.select = select i1 %cmp411, i32 %143, i32 %iIso.01451
  %cmp416 = icmp eq i32 %142, %call398
  %iUdf.1 = select i1 %cmp416, i32 %143, i32 %iUdf.01452
  %indvars.iv.next1500 = or i64 %indvars.iv1499, 1
  %arrayidx.i1014.1 = getelementptr inbounds i32, ptr %132, i64 %indvars.iv.next1500
  %144 = load i32, ptr %arrayidx.i1014.1, align 4
  %cmp411.1 = icmp eq i32 %144, %call390
  %145 = trunc i64 %indvars.iv.next1500 to i32
  ...
  %indvars.iv.next1500.1 = or i64 %indvars.iv1499, 2
  %arrayidx.i1014.2 = getelementptr inbounds i32, ptr %132, i64 %indvars.iv.next1500.1
  %146 = load i32, ptr %arrayidx.i1014.2, align 4
  %cmp411.2 = icmp eq i32 %146, %call390
  %147 = trunc i64 %indvars.iv.next1500.1 to i32
  ...
  %indvars.iv.next1500.2 = or i64 %indvars.iv1499, 3
  %arrayidx.i1014.3 = getelementptr inbounds i32, ptr %132, i64 %indvars.iv.next1500.2
  %148 = load i32, ptr %arrayidx.i1014.3, align 4
  %cmp411.3 = icmp eq i32 %148, %call390
  %149 = trunc i64 %indvars.iv.next1500.2 to i32
  ...
  %indvars.iv.next1500.3 = add nuw nsw i64 %indvars.iv1499, 4
  %niter.next.3 = add i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %for.cond.cleanup407.unr-lcssa, label %for.body408
...
if.end445:                                        ; preds = %_ZN11CStringBaseIwED2Ev.exit1002, %for.cond.cleanup407, %if.then427, %if.end380, %_ZN13CRecordVectorIiE3AddEi.exit
  ...
  %151 = load i32, ptr %_size.i1024, align 4
  %cmp451.not1456 = icmp sgt i32 %151, 0
  br i1 %cmp451.not1456, label %for.body453.lr.ph, label %_ZN11CStringBaseIwED2Ev.exit1264
...
for.body453.lr.ph:                                ; preds = %if.end445
  ...
  %_capacity.i.i1063 = getelementptr inbounds %struct.CArc, ptr %this, i64 0, i32 7, i32 2
  %DefaultName600 = getelementptr inbounds %struct.CArc, ptr %this, i64 0, i32 2
  %cmp.i1212 = icmp eq ptr %ref.tmp597, %DefaultName600
  %_length.i.i1214 = getelementptr inbounds %struct.CArc, ptr %this, i64 0, i32 2, i32 1
  %_length.i1215 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp597, i64 0, i32 1
  %_capacity.i.i1217 = getelementptr inbounds %struct.CArc, ptr %this, i64 0, i32 2, i32 2
  ...
  %_length.i1148 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp568, i64 0, i32 1
  br label %for.body453

for.body453:                                      ; preds = %for.body453.lr.ph, %for.inc618
  %indvars.iv1502 = phi i64 [ 0, %for.body453.lr.ph ], [ %indvars.iv.next1503, %for.inc618 ]
  %retval.111459 = phi i32 [ %retval.10, %for.body453.lr.ph ], [ %retval.1913601369, %for.inc618 ]
  br i1 %tobool454.not, label %if.end469, label %if.then455

if.then455:                                       ; preds = %for.body453
  %vtable457 = load ptr, ptr %stream, align 8
...
if.end469:                                        ; preds = %invoke.cont460, %for.body453
  %155 = load ptr, ptr %_items.i1025, align 8
  %arrayidx.i1027 = getelementptr inbounds i32, ptr %155, i64 %indvars.iv1502
  %156 = load i32, ptr %arrayidx.i1027, align 4
  store i32 %156, ptr %FormatIndex, align 8
  %157 = load ptr, ptr %_items.i.i.i1028, align 8
  %idxprom.i.i.i = sext i32 %156 to i64
  %arrayidx.i.i.i1029 = getelementptr inbounds ptr, ptr %157, i64 %idxprom.i.i.i
  %158 = load ptr, ptr %arrayidx.i.i.i1029, align 8
  %CreateInArchive.i = getelementptr inbounds %struct.CArcInfoEx, ptr %158, i64 0, i32 2
  %159 = load ptr, ptr %CreateInArchive.i, align 8
...
if.then.i.i:                                      ; preds = %call2.i.noexc
  %vtable.i.i = load ptr, ptr %call2.i1032, align 8
...
if.then492:                                       ; preds = %if.end490
  %vtable496 = load ptr, ptr %call2.i1032, align 8
...
lpad493:                                          ; preds = %if.then2.i.i1092, %if.then.i.i1087, %if.then492
...
if.else500:                                       ; preds = %if.end490
  ...
  store ptr null, ptr %openSeq, align 8
  %vtable.i1037 = load ptr, ptr %call2.i1032, align 8
...
invoke.cont506:                                   ; preds = %if.else500
  %165 = load ptr, ptr %openSeq, align 8
...
lpad503:                                          ; preds = %if.else500, %if.end511
  %166 = landingpad { ptr, i32 }
          cleanup
  %167 = load ptr, ptr %openSeq, align 8
  %tobool.not.i1041 = icmp eq ptr %167, null
  br i1 %tobool.not.i1041, label %_ZN9CMyComPtrI15IArchiveOpenSeqED2Ev.exit, label %if.then.i1042

if.then.i1042:                                    ; preds = %lpad503
  %vtable.i1043 = load ptr, ptr %167, align 8
  %vfn.i1044 = getelementptr inbounds ptr, ptr %vtable.i1043, i64 2
  %168 = load ptr, ptr %vfn.i1044, align 8
  %call.i1045 = invoke noundef i32 %168(ptr noundef nonnull align 8 dereferenceable(8) %167)
          to label %_ZN9CMyComPtrI15IArchiveOpenSeqED2Ev.exit unwind label %terminate.lpad.i

terminate.lpad.i:                                 ; preds = %if.then.i1042
...
_ZN9CMyComPtrI15IArchiveOpenSeqED2Ev.exit:        ; preds = %lpad503, %if.then.i1042
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %openSeq) #16
  br label %if.then.i1254

if.end511:                                        ; preds = %invoke.cont506
  %vtable514 = load ptr, ptr %165, align 8
...
cleanup518:                                       ; preds = %if.end511
  %.pr1344 = load ptr, ptr %openSeq, align 8
  %tobool.not.i1047 = icmp eq ptr %.pr1344, null
  br i1 %tobool.not.i1047, label %_ZN9CMyComPtrI15IArchiveOpenSeqED2Ev.exit1054.thread, label %if.then.i1048

if.then.i1048:                                    ; preds = %cleanup518
  %vtable.i1049 = load ptr, ptr %.pr1344, align 8
  %vfn.i1050 = getelementptr inbounds ptr, ptr %vtable.i1049, i64 2
  %172 = load ptr, ptr %vfn.i1050, align 8
  %call.i1051 = invoke noundef i32 %172(ptr noundef nonnull align 8 dereferenceable(8) %.pr1344)
          to label %_ZN9CMyComPtrI15IArchiveOpenSeqED2Ev.exit1054.thread unwind label %terminate.lpad.i1052

terminate.lpad.i1052:                             ; preds = %if.then.i1048
...
_ZN9CMyComPtrI15IArchiveOpenSeqED2Ev.exit1054.thread: ; preds = %cleanup518, %if.then.i1048
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %openSeq) #16
  br label %if.end524

_ZN9CMyComPtrI15IArchiveOpenSeqED2Ev.exit1054:    ; preds = %invoke.cont506
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %openSeq) #16
  br label %if.then.i1247
...
if.end524:                                        ; preds = %_ZN9CMyComPtrI15IArchiveOpenSeqED2Ev.exit1054.thread, %if.then492
  ...
  switch i32 %result.2, label %if.then.i1247.fold.split [
    i32 1, label %if.then.i1247
...
cleanup.cont534:                                  ; preds = %if.end524
  ...
  store i16 0, ptr %prop, align 8
  store i16 0, ptr %wReserved1.i, align 2
  %vtable540 = load ptr, ptr %call2.i1032, align 8
...
if.then546:                                       ; preds = %invoke.cont542
  ...
  store i32 0, ptr %_length.i, align 8
  %178 = load ptr, ptr %ErrorMessage, align 8
  store i32 0, ptr %178, align 4
  br label %for.cond.i.i1056

for.cond.i.i1056:                                 ; preds = %for.cond.i.i1056, %if.then546
  %indvars.iv.i.i1057 = phi i64 [ %indvars.iv.next.i.i1060, %for.cond.i.i1056 ], [ 0, %if.then546 ]
  %arrayidx.i.i1058 = getelementptr inbounds i32, ptr %cond, i64 %indvars.iv.i.i1057
  %179 = load i32, ptr %arrayidx.i.i1058, align 4
  %cmp.not.i.i1059 = icmp eq i32 %179, 0
  %indvars.iv.next.i.i1060 = add nuw i64 %indvars.iv.i.i1057, 1
  br i1 %cmp.not.i.i1059, label %_Z11MyStringLenIwEiPKT_.exit.i1061, label %for.cond.i.i1056

_Z11MyStringLenIwEiPKT_.exit.i1061:               ; preds = %for.cond.i.i1056
  %180 = trunc i64 %indvars.iv.i.i1057 to i32
  %add.i.i1062 = add nsw i32 %180, 1
  %181 = load i32, ptr %_capacity.i.i1063, align 4
  %cmp.i.i1064 = icmp eq i32 %add.i.i1062, %181
  br i1 %cmp.i.i1064, label %while.cond.i.i1072.preheader, label %if.end.i.i1065

if.end.i.i1065:                                   ; preds = %_Z11MyStringLenIwEiPKT_.exit.i1061
  %conv.i.i1066 = zext i32 %add.i.i1062 to i64
  %182 = icmp slt i32 %180, -1
  %183 = shl nuw nsw i64 %conv.i.i1066, 2
...
call.i.i.noexc1079:                               ; preds = %if.end.i.i1065
  %cmp3.i.i1067 = icmp sgt i32 %181, 0
  br i1 %cmp3.i.i1067, label %delete.notnull.i.i1077, label %if.end9.i.i1068

delete.notnull.i.i1077:                           ; preds = %call.i.i.noexc1079
  call void @_ZdaPv(ptr noundef nonnull %178) #19
  %.pre.i1078 = load i32, ptr %_length.i, align 8
  %185 = sext i32 %.pre.i1078 to i64
  br label %if.end9.i.i1068

if.end9.i.i1068:                                  ; preds = %delete.notnull.i.i1077, %call.i.i.noexc1079
  %idxprom13.i.i1069 = phi i64 [ %185, %delete.notnull.i.i1077 ], [ 0, %call.i.i.noexc1079 ]
  store ptr %call.i.i1080, ptr %ErrorMessage, align 8
  %arrayidx14.i.i1070 = getelementptr inbounds i32, ptr %call.i.i1080, i64 %idxprom13.i.i1069
  store i32 0, ptr %arrayidx14.i.i1070, align 4
  store i32 %add.i.i1062, ptr %_capacity.i.i1063, align 4
  br label %while.cond.i.i1072.preheader

while.cond.i.i1072.preheader:                     ; preds = %if.end9.i.i1068, %_Z11MyStringLenIwEiPKT_.exit.i1061
  %dest.addr.0.i.i1074.ph = phi ptr [ %178, %_Z11MyStringLenIwEiPKT_.exit.i1061 ], [ %call.i.i1080, %if.end9.i.i1068 ]
  br label %while.cond.i.i1072

while.cond.i.i1072:                               ; preds = %while.cond.i.i1072.preheader, %while.cond.i.i1072
  %src.addr.0.i.i1073 = phi ptr [ %incdec.ptr.i.i1075, %while.cond.i.i1072 ], [ %cond, %while.cond.i.i1072.preheader ]
  %dest.addr.0.i.i1074 = phi ptr [ %incdec.ptr1.i.i1076, %while.cond.i.i1072 ], [ %dest.addr.0.i.i1074.ph, %while.cond.i.i1072.preheader ]
  %incdec.ptr.i.i1075 = getelementptr inbounds i32, ptr %src.addr.0.i.i1073, i64 1
  %186 = load i32, ptr %src.addr.0.i.i1073, align 4
  %incdec.ptr1.i.i1076 = getelementptr inbounds i32, ptr %dest.addr.0.i.i1074, i64 1
  store i32 %186, ptr %dest.addr.0.i.i1074, align 4
  %cmp.not.i9.i = icmp eq i32 %186, 0
  br i1 %cmp.not.i9.i, label %_ZN11CStringBaseIwEaSEPKw.exit, label %while.cond.i.i1072

_ZN11CStringBaseIwEaSEPKw.exit:                   ; preds = %while.cond.i.i1072
  store i32 %180, ptr %_length.i, align 8
  br label %if.end553

lpad537:                                          ; preds = %if.end.i.i1065, %cleanup.cont534
...
if.end553:                                        ; preds = %_ZN11CStringBaseIwEaSEPKw.exit, %invoke.cont542
  %call.i1083 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %prop)
          to label %if.then.i.i1087 unwind label %terminate.lpad.i1084
...
if.then.i.i1087:                                  ; preds = %if.end553
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %prop) #16
  %vtable.i.i1088 = load ptr, ptr %call2.i1032, align 8
  %vfn.i.i1089 = getelementptr inbounds ptr, ptr %vtable.i.i1088, i64 1
  %192 = load ptr, ptr %vfn.i.i1089, align 8
  %call.i.i1096 = invoke noundef i32 %192(ptr noundef nonnull align 8 dereferenceable(8) %call2.i1032)
          to label %if.end.i.i1090 unwind label %lpad493

if.end.i.i1090:                                   ; preds = %if.then.i.i1087
  %193 = load ptr, ptr %this, align 8
  %tobool.not.i.i1091 = icmp eq ptr %193, null
  br i1 %tobool.not.i.i1091, label %invoke.cont562, label %if.then2.i.i1092

if.then2.i.i1092:                                 ; preds = %if.end.i.i1090
  %vtable4.i.i1093 = load ptr, ptr %193, align 8
  %vfn5.i.i1094 = getelementptr inbounds ptr, ptr %vtable4.i.i1093, i64 2
  %194 = load ptr, ptr %vfn5.i.i1094, align 8
...
invoke.cont562:                                   ; preds = %if.then2.i.i1092, %if.end.i.i1090
  store ptr %call2.i1032, ptr %this, align 8
  %195 = load i32, ptr %FormatIndex, align 8
  %196 = load ptr, ptr %_items.i.i.i1028, align 8
  %idxprom.i.i1100 = sext i32 %195 to i64
  %arrayidx.i.i1101 = getelementptr inbounds ptr, ptr %196, i64 %idxprom.i.i1100
  %197 = load ptr, ptr %arrayidx.i.i1101, align 8
  %_size.i1102 = getelementptr inbounds %struct.CArcInfoEx, ptr %197, i64 0, i32 5, i32 0, i32 0, i32 2
  %198 = load i32, ptr %_size.i1102, align 4
...
call.i.i.noexc1121:                               ; preds = %if.then567
  store ptr %call.i.i1122, ptr %ref.tmp569, align 8
  store i32 1, ptr %_capacity.i1103, align 4
  store i32 0, ptr %call.i.i1122, align 4
  store i32 0, ptr %_length.i1120, align 8
...
call.i.i.noexc1142:                               ; preds = %call.i.i.noexc1121
  store ptr %call.i.i1143, ptr %ref.tmp572, align 8
  store i32 1, ptr %_capacity.i1124, align 4
  store i32 0, ptr %call.i.i1143, align 4
  store i32 0, ptr %_length.i1141, align 8
...
invoke.cont576:                                   ; preds = %call.i.i.noexc1142
  br i1 %cmp.i1145, label %invoke.cont576.invoke.cont578_crit_edge, label %if.end.i1146

invoke.cont576.invoke.cont578_crit_edge:          ; preds = %invoke.cont576
  %.pre1508 = load ptr, ptr %ref.tmp568, align 8
  br label %invoke.cont578

if.end.i1146:                                     ; preds = %invoke.cont576
  store i32 0, ptr %_length.i.i1214, align 8
  %199 = load ptr, ptr %DefaultName600, align 8
  store i32 0, ptr %199, align 4
  %200 = load i32, ptr %_length.i1148, align 8
  %add.i.i1149 = add nsw i32 %200, 1
  %201 = load i32, ptr %_capacity.i.i1217, align 4
  %cmp.i.i1151 = icmp eq i32 %add.i.i1149, %201
  br i1 %cmp.i.i1151, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1158, label %if.end.i.i1152

if.end.i.i1152:                                   ; preds = %if.end.i1146
  %conv.i.i1153 = zext i32 %add.i.i1149 to i64
  %202 = icmp slt i32 %200, -1
  %203 = shl nuw nsw i64 %conv.i.i1153, 2
...
call.i.i.noexc1167:                               ; preds = %if.end.i.i1152
  %cmp3.i.i1154 = icmp sgt i32 %201, 0
  br i1 %cmp3.i.i1154, label %delete.notnull.i.i1165, label %if.end9.i.i1155

delete.notnull.i.i1165:                           ; preds = %call.i.i.noexc1167
  call void @_ZdaPv(ptr noundef nonnull %199) #19
  %.pre.i1166 = load i32, ptr %_length.i.i1214, align 8
  %205 = sext i32 %.pre.i1166 to i64
  br label %if.end9.i.i1155

if.end9.i.i1155:                                  ; preds = %delete.notnull.i.i1165, %call.i.i.noexc1167
  %idxprom13.i.i1156 = phi i64 [ %205, %delete.notnull.i.i1165 ], [ 0, %call.i.i.noexc1167 ]
  store ptr %call.i.i1168, ptr %DefaultName600, align 8
  %arrayidx14.i.i1157 = getelementptr inbounds i32, ptr %call.i.i1168, i64 %idxprom13.i.i1156
  store i32 0, ptr %arrayidx14.i.i1157, align 4
  store i32 %add.i.i1149, ptr %_capacity.i.i1217, align 4
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1158

_ZN11CStringBaseIwE11SetCapacityEi.exit.i1158:    ; preds = %if.end9.i.i1155, %if.end.i1146
  %206 = phi ptr [ %199, %if.end.i1146 ], [ %call.i.i1168, %if.end9.i.i1155 ]
  %207 = load ptr, ptr %ref.tmp568, align 8
  br label %while.cond.i.i1159

while.cond.i.i1159:                               ; preds = %while.cond.i.i1159, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1158
  %src.addr.0.i.i1160 = phi ptr [ %207, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1158 ], [ %incdec.ptr.i.i1162, %while.cond.i.i1159 ]
  %dest.addr.0.i.i1161 = phi ptr [ %206, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1158 ], [ %incdec.ptr1.i.i1163, %while.cond.i.i1159 ]
  %incdec.ptr.i.i1162 = getelementptr inbounds i32, ptr %src.addr.0.i.i1160, i64 1
  %208 = load i32, ptr %src.addr.0.i.i1160, align 4
  %incdec.ptr1.i.i1163 = getelementptr inbounds i32, ptr %dest.addr.0.i.i1161, i64 1
  store i32 %208, ptr %dest.addr.0.i.i1161, align 4
  %cmp.not.i.i1164 = icmp eq i32 %208, 0
  br i1 %cmp.not.i.i1164, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i, label %while.cond.i.i1159

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i:            ; preds = %while.cond.i.i1159
  %209 = load i32, ptr %_length.i1148, align 8
  store i32 %209, ptr %_length.i.i1214, align 8
  br label %invoke.cont578

invoke.cont578:                                   ; preds = %invoke.cont576.invoke.cont578_crit_edge, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i
  %210 = phi ptr [ %.pre1508, %invoke.cont576.invoke.cont578_crit_edge ], [ %207, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i ]
...
_ZN11CStringBaseIwED2Ev.exit1173:                 ; preds = %invoke.cont578, %delete.notnull.i1171
  %211 = load ptr, ptr %ref.tmp572, align 8
...
_ZN11CStringBaseIwED2Ev.exit1177:                 ; preds = %_ZN11CStringBaseIwED2Ev.exit1173, %delete.notnull.i1175
  ...
  %212 = load ptr, ptr %ref.tmp569, align 8
...
lpad577:                                          ; preds = %if.end.i.i1152
  %216 = landingpad { ptr, i32 }
          cleanup
  %217 = load ptr, ptr %ref.tmp568, align 8
...
ehcleanup581:                                     ; preds = %delete.notnull.i1183, %lpad577, %lpad575
  %.pn781 = phi { ptr, i32 } [ %215, %lpad575 ], [ %216, %lpad577 ], [ %216, %delete.notnull.i1183 ]
  %218 = load ptr, ptr %ref.tmp572, align 8
...
ehcleanup582:                                     ; preds = %delete.notnull.i1187, %ehcleanup581, %lpad573
  %.pn781.pn = phi { ptr, i32 } [ %214, %lpad573 ], [ %.pn781, %ehcleanup581 ], [ %.pn781, %delete.notnull.i1187 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp572) #16
  %219 = load ptr, ptr %ref.tmp569, align 8
...
ehcleanup584:                                     ; preds = %delete.notnull.i1191, %ehcleanup582, %lpad570
  %.pn781.pn.pn = phi { ptr, i32 } [ %213, %lpad570 ], [ %.pn781.pn, %ehcleanup582 ], [ %.pn781.pn, %delete.notnull.i1191 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp569) #16
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp568) #16
  br label %if.then.i1254
...
if.else586:                                       ; preds = %invoke.cont562
  ...
  br i1 %cmp.not9.i1196, label %for.body.i1198, label %invoke.cont588

for.body.i1198:                                   ; preds = %if.else586, %for.inc.i1202
  %indvars.iv.i1199 = phi i64 [ %indvars.iv.next.i1203, %for.inc.i1202 ], [ 0, %if.else586 ]
  %220 = load ptr, ptr %_items.i.i.i1194, align 8
  %arrayidx.i.i.i1200 = getelementptr inbounds ptr, ptr %220, i64 %indvars.iv.i1199
  %221 = load ptr, ptr %arrayidx.i.i.i1200, align 8
...
call.i.i.noexc1206:                               ; preds = %for.body.i1198
  %cmp5.i1201 = icmp eq i32 %call.i.i1207, 0
  br i1 %cmp5.i1201, label %cleanup.loopexit.split.loop.exit.i1205, label %for.inc.i1202

for.inc.i1202:                                    ; preds = %call.i.i.noexc1206
  %indvars.iv.next.i1203 = add nuw nsw i64 %indvars.iv.i1199, 1
  %223 = load i32, ptr %_size.i1102, align 4
  %224 = sext i32 %223 to i64
  %cmp.not.i1204 = icmp slt i64 %indvars.iv.next.i1203, %224
  br i1 %cmp.not.i1204, label %for.body.i1198, label %invoke.cont588

cleanup.loopexit.split.loop.exit.i1205:           ; preds = %call.i.i.noexc1206
  %225 = trunc i64 %indvars.iv.i1199 to i32
  br label %invoke.cont588

invoke.cont588:                                   ; preds = %for.inc.i1202, %cleanup.loopexit.split.loop.exit.i1205, %if.else586
  %spec.select.i1197 = phi i32 [ -1, %if.else586 ], [ %225, %cleanup.loopexit.split.loop.exit.i1205 ], [ -1, %for.inc.i1202 ]
  %spec.store.select = call i32 @llvm.smax.i32(i32 %spec.select.i1197, i32 0)
  %226 = load ptr, ptr %_items.i.i.i1194, align 8
  %idxprom.i.i1210 = zext i32 %spec.store.select to i64
  %arrayidx.i.i1211 = getelementptr inbounds ptr, ptr %226, i64 %idxprom.i.i1210
  %227 = load ptr, ptr %arrayidx.i.i1211, align 8
...
lpad587:                                          ; preds = %for.body.i1198
  %228 = landingpad { ptr, i32 }
          cleanup
  br label %if.then.i1254

invoke.cont599:                                   ; preds = %invoke.cont588
  br i1 %cmp.i1212, label %invoke.cont599.invoke.cont602_crit_edge, label %if.end.i1213

invoke.cont599.invoke.cont602_crit_edge:          ; preds = %invoke.cont599
  %.pre1507 = load ptr, ptr %ref.tmp597, align 8
  br label %invoke.cont602

if.end.i1213:                                     ; preds = %invoke.cont599
  store i32 0, ptr %_length.i.i1214, align 8
  %229 = load ptr, ptr %DefaultName600, align 8
  store i32 0, ptr %229, align 4
  %230 = load i32, ptr %_length.i1215, align 8
  %add.i.i1216 = add nsw i32 %230, 1
  %231 = load i32, ptr %_capacity.i.i1217, align 4
  %cmp.i.i1218 = icmp eq i32 %add.i.i1216, %231
  br i1 %cmp.i.i1218, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1225, label %if.end.i.i1219

if.end.i.i1219:                                   ; preds = %if.end.i1213
  %conv.i.i1220 = zext i32 %add.i.i1216 to i64
  %232 = icmp slt i32 %230, -1
  %233 = shl nuw nsw i64 %conv.i.i1220, 2
...
call.i.i.noexc1235:                               ; preds = %if.end.i.i1219
  %cmp3.i.i1221 = icmp sgt i32 %231, 0
  br i1 %cmp3.i.i1221, label %delete.notnull.i.i1233, label %if.end9.i.i1222

delete.notnull.i.i1233:                           ; preds = %call.i.i.noexc1235
  call void @_ZdaPv(ptr noundef nonnull %229) #19
  %.pre.i1234 = load i32, ptr %_length.i.i1214, align 8
  %235 = sext i32 %.pre.i1234 to i64
  br label %if.end9.i.i1222

if.end9.i.i1222:                                  ; preds = %delete.notnull.i.i1233, %call.i.i.noexc1235
  %idxprom13.i.i1223 = phi i64 [ %235, %delete.notnull.i.i1233 ], [ 0, %call.i.i.noexc1235 ]
  store ptr %call.i.i1236, ptr %DefaultName600, align 8
  %arrayidx14.i.i1224 = getelementptr inbounds i32, ptr %call.i.i1236, i64 %idxprom13.i.i1223
  store i32 0, ptr %arrayidx14.i.i1224, align 4
  store i32 %add.i.i1216, ptr %_capacity.i.i1217, align 4
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1225

_ZN11CStringBaseIwE11SetCapacityEi.exit.i1225:    ; preds = %if.end9.i.i1222, %if.end.i1213
  %236 = phi ptr [ %229, %if.end.i1213 ], [ %call.i.i1236, %if.end9.i.i1222 ]
  %237 = load ptr, ptr %ref.tmp597, align 8
  br label %while.cond.i.i1226

while.cond.i.i1226:                               ; preds = %while.cond.i.i1226, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1225
  %src.addr.0.i.i1227 = phi ptr [ %237, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1225 ], [ %incdec.ptr.i.i1229, %while.cond.i.i1226 ]
  %dest.addr.0.i.i1228 = phi ptr [ %236, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1225 ], [ %incdec.ptr1.i.i1230, %while.cond.i.i1226 ]
  %incdec.ptr.i.i1229 = getelementptr inbounds i32, ptr %src.addr.0.i.i1227, i64 1
  %238 = load i32, ptr %src.addr.0.i.i1227, align 4
  %incdec.ptr1.i.i1230 = getelementptr inbounds i32, ptr %dest.addr.0.i.i1228, i64 1
  store i32 %238, ptr %dest.addr.0.i.i1228, align 4
  %cmp.not.i.i1231 = icmp eq i32 %238, 0
  br i1 %cmp.not.i.i1231, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i1232, label %while.cond.i.i1226

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i1232:        ; preds = %while.cond.i.i1226
  %239 = load i32, ptr %_length.i1215, align 8
  store i32 %239, ptr %_length.i.i1214, align 8
  br label %invoke.cont602

invoke.cont602:                                   ; preds = %invoke.cont599.invoke.cont602_crit_edge, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i1232
  %240 = phi ptr [ %.pre1507, %invoke.cont599.invoke.cont602_crit_edge ], [ %237, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i1232 ]
...
lpad601:                                          ; preds = %if.end.i.i1219
  %242 = landingpad { ptr, i32 }
          cleanup
  %243 = load ptr, ptr %ref.tmp597, align 8
...
ehcleanup605:                                     ; preds = %delete.notnull.i1243, %lpad601, %lpad598
  %.pn778 = phi { ptr, i32 } [ %241, %lpad598 ], [ %242, %lpad601 ], [ %242, %delete.notnull.i1243 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp597) #16
  br label %if.then.i1254

if.then.i1247.fold.split:                         ; preds = %if.end524
  br label %if.then.i1247

if.then.i1247:                                    ; preds = %_ZN11CStringBaseIwED2Ev.exit1181, %_ZN11CStringBaseIwED2Ev.exit1241, %if.end524, %if.then.i1247.fold.split, %_ZN9CMyComPtrI15IArchiveOpenSeqED2Ev.exit1054
  %retval.191359 = phi i32 [ %retval.111459, %if.end524 ], [ -2147467263, %_ZN9CMyComPtrI15IArchiveOpenSeqED2Ev.exit1054 ], [ %result.2, %if.then.i1247.fold.split ], [ 0, %_ZN11CStringBaseIwED2Ev.exit1241 ], [ 0, %_ZN11CStringBaseIwED2Ev.exit1181 ]
  %cond640 = phi i1 [ true, %if.end524 ], [ false, %_ZN9CMyComPtrI15IArchiveOpenSeqED2Ev.exit1054 ], [ false, %if.then.i1247.fold.split ], [ false, %_ZN11CStringBaseIwED2Ev.exit1241 ], [ false, %_ZN11CStringBaseIwED2Ev.exit1181 ]
  %vtable.i1248 = load ptr, ptr %call2.i1032, align 8
  %vfn.i1249 = getelementptr inbounds ptr, ptr %vtable.i1248, i64 2
  %244 = load ptr, ptr %vfn.i1249, align 8
  %call.i1250 = invoke noundef i32 %244(ptr noundef nonnull align 8 dereferenceable(8) %call2.i1032)
          to label %_ZN9CMyComPtrI10IInArchiveED2Ev.exit unwind label %terminate.lpad.i1251

terminate.lpad.i1251:                             ; preds = %if.then.i1247
...
_ZN9CMyComPtrI10IInArchiveED2Ev.exit:             ; preds = %if.then.i1247
  br i1 %cond640, label %for.inc618, label %_ZN11CStringBaseIwED2Ev.exit1264

if.then.i1254:                                    ; preds = %ehcleanup584, %ehcleanup605, %lpad587, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit, %_ZN9CMyComPtrI15IArchiveOpenSeqED2Ev.exit, %lpad493
  %.pn781.pn.pn.pn.pn.pn1380 = phi { ptr, i32 } [ %166, %_ZN9CMyComPtrI15IArchiveOpenSeqED2Ev.exit ], [ %163, %lpad493 ], [ %187, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit ], [ %.pn781.pn.pn, %ehcleanup584 ], [ %.pn778, %ehcleanup605 ], [ %228, %lpad587 ]
  %vtable.i1255 = load ptr, ptr %call2.i1032, align 8
  %vfn.i1256 = getelementptr inbounds ptr, ptr %vtable.i1255, i64 2
  %247 = load ptr, ptr %vfn.i1256, align 8
  %call.i1257 = invoke noundef i32 %247(ptr noundef nonnull align 8 dereferenceable(8) %call2.i1032)
          to label %ehcleanup625 unwind label %terminate.lpad.i1258

terminate.lpad.i1258:                             ; preds = %if.then.i1254
...
for.inc618:                                       ; preds = %call2.i.noexc, %_ZN9CMyComPtrI10IInArchiveED2Ev.exit
  %retval.1913601369 = phi i32 [ %retval.191359, %_ZN9CMyComPtrI10IInArchiveED2Ev.exit ], [ %retval.111459, %call2.i.noexc ]
  %indvars.iv.next1503 = add nuw nsw i64 %indvars.iv1502, 1
  %250 = load i32, ptr %_size.i1024, align 4
  %251 = sext i32 %250 to i64
  %cmp451.not = icmp slt i64 %indvars.iv.next1503, %251
  br i1 %cmp451.not, label %for.body453, label %_ZN11CStringBaseIwED2Ev.exit1264
...
_ZN11CStringBaseIwED2Ev.exit1264:                 ; preds = %for.inc618, %invoke.cont460, %_ZN9CMyComPtrI10IInArchiveED2Ev.exit, %_ZN11CStringBaseIwED2Ev.exit1264.sink.split, %for.end.thread, %if.end445, %if.then34, %_ZN7CBufferIhED2Ev.exit887
  %retval.21 = phi i32 [ -2147467263, %if.then34 ], [ %retval.4, %_ZN7CBufferIhED2Ev.exit887 ], [ 1, %if.end445 ], [ -2147467263, %for.end.thread ], [ %retval.21.ph, %_ZN11CStringBaseIwED2Ev.exit1264.sink.split ], [ 1, %for.inc618 ], [ %call461, %invoke.cont460 ], [ %retval.191359, %_ZN9CMyComPtrI10IInArchiveED2Ev.exit ]
...
ehcleanup625:                                     ; preds = %lpad17.loopexit, %lpad17.loopexit.split-lp.loopexit.split-lp, %lpad17.loopexit.split-lp.loopexit, %if.then.i1254, %ehcleanup614.thread1382, %delete.notnull.i953, %ehcleanup372, %lpad459, %_ZN7CBufferIhED2Ev.exit897, %ehcleanup400, %ehcleanup392, %lpad14
  %.pn781.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %21, %lpad14 ], [ %.pn766.pn.pn.pn1328, %_ZN7CBufferIhED2Ev.exit897 ], [ %.pn773, %ehcleanup400 ], [ %.pn771, %ehcleanup392 ], [ %154, %lpad459 ], [ %127, %ehcleanup372 ], [ %.pn760.pn.pn.ph, %delete.notnull.i953 ], [ %.pn781.pn.pn.pn.pn.pn1380, %if.then.i1254 ], [ %161, %ehcleanup614.thread1382 ], [ %lpad.loopexit1397, %lpad17.loopexit ], [ %lpad.loopexit1400, %lpad17.loopexit.split-lp.loopexit ], [ %lpad.loopexit.split-lp1401, %lpad17.loopexit.split-lp.loopexit.split-lp ]
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %orderIndices) #16
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %orderIndices) #16
  br label %_ZN11CStringBaseIwED2Ev.exit1272
...
_ZN11CStringBaseIwED2Ev.exit1272:                 ; preds = %ehcleanup, %ehcleanup625
  ...
  %.pn781.pn.pn.pn.pn.pn.pn.pn.pn.ph = phi { ptr, i32 } [ %.pn, %ehcleanup ], [ %.pn781.pn.pn.pn.pn.pn.pn.pn, %ehcleanup625 ]
  call void @_ZdaPv(ptr noundef nonnull %extension.sroa.0.2.ph) #19
  br label %ehcleanup631

ehcleanup631:                                     ; preds = %_ZN11CStringBaseIwED2Ev.exit1272, %lpad
  %.pn781.pn.pn.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %.pn781.pn.pn.pn.pn.pn.pn.pn.pn.ph, %_ZN11CStringBaseIwED2Ev.exit1272 ], [ %13, %lpad ]
  %253 = load ptr, ptr %fileName, align 8
...
_ZN11CStringBaseIwED2Ev.exit1276:                 ; preds = %ehcleanup631, %delete.notnull.i1274
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %fileName) #16
  resume { ptr, i32 } %.pn781.pn.pn.pn.pn.pn.pn.pn.pn.pn
}
...
entry:
  ...
  %0 = load i64, ptr %_capacity, align 8
...
if.end10:                                         ; preds = %if.end, %if.then3, %if.then6
  ...
  %2 = load ptr, ptr %_items11, align 8
...
delete.end:                                       ; preds = %delete.notnull, %if.end10
  store ptr %newBuffer.0, ptr %_items11, align 8
  store i64 %newCapacity, ptr %_capacity, align 8
  br label %return
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  %4 = load ptr, ptr %_items.i10.i, align 8
  %5 = load i32, ptr %_size.i9.i, align 4
  %idxprom.i12.i = sext i32 %5 to i64
  %arrayidx.i13.i = getelementptr inbounds i32, ptr %4, i64 %idxprom.i12.i
  store i32 %3, ptr %arrayidx.i13.i, align 4
  %6 = load i32, ptr %_size.i9.i, align 4
  %inc.i.i = add nsw i32 %6, 1
  store i32 %inc.i.i, ptr %_size.i9.i, align 4
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %_ZN13CRecordVectorIiEpLERKS0_.exit, label %for.body.i
...
if.then:                                          ; preds = %entry
  ...
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV16CStdInFileStream, i64 0, inrange i32 0, i64 2), ptr %call, align 8
...
invoke.cont11:                                    ; preds = %if.then9
  ...
  store ptr getelementptr inbounds ({ [10 x ptr], [8 x ptr] }, ptr @_ZTV13CInFileStream, i64 0, inrange i32 0, i64 2), ptr %call12, align 8
  store ptr getelementptr inbounds ({ [10 x ptr], [8 x ptr] }, ptr @_ZTV13CInFileStream, i64 0, inrange i32 1, i64 2), ptr %2, align 8
...
invoke.cont14:                                    ; preds = %invoke.cont11
  ...
  store ptr %call.i.i.i.i4.i48, ptr %_unix_filename.i.i.i, align 8
  store i8 0, ptr %call.i.i.i.i4.i48, align 1
  ...
  store i8 1, ptr %_ignoreSymbolicLink.i, align 4
...
if.then.i:                                        ; preds = %cleanup32
  %vtable.i60 = load ptr, ptr %seqStream.sroa.0.1, align 8
...
_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit:    ; preds = %cleanup32, %if.then.i
  ...
  br i1 %tobool.not.i63, label %_ZN9CMyComPtrI9IInStreamED2Ev.exit, label %if.then.i64
...
if.then.i64:                                      ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.thread, %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit
  ...
  %vtable.i65 = load ptr, ptr %fileStream.sroa.0.395102, align 8
  %vfn.i66 = getelementptr inbounds ptr, ptr %vtable.i65, i64 2
  %12 = load ptr, ptr %vfn.i66, align 8
  %call.i67 = invoke noundef i32 %12(ptr noundef nonnull align 8 dereferenceable(8) %fileStream.sroa.0.395102)
...
_ZN9CMyComPtrI9IInStreamED2Ev.exit:               ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit, %if.then.i64
  %retval.196101 = phi i32 [ %call31, %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit ], [ %retval.196100, %if.then.i64 ]
...
ehcleanup33:                                      ; preds = %if.end27
  ...
  br i1 %tobool.not.i69, label %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit75, label %if.then.i70

if.then.i70:                                      ; preds = %ehcleanup33
  %vtable.i71 = load ptr, ptr %seqStream.sroa.0.1, align 8
  %vfn.i72 = getelementptr inbounds ptr, ptr %vtable.i71, i64 2
  %15 = load ptr, ptr %vfn.i72, align 8
  %call.i73 = invoke noundef i32 %15(ptr noundef nonnull align 8 dereferenceable(8) %seqStream.sroa.0.1)
          to label %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit75 unwind label %terminate.lpad.i74

terminate.lpad.i74:                               ; preds = %if.then.i70
...
_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit75:  ; preds = %lpad10, %ehcleanup33, %if.then.i70
  %.pn44108 = phi { ptr, i32 } [ %lpad.thr_comm.split-lp, %ehcleanup33 ], [ %lpad.thr_comm.split-lp, %if.then.i70 ], [ %6, %lpad10 ]
  %fileStream.sroa.0.4107 = phi ptr [ %fileStream.sroa.0.2, %ehcleanup33 ], [ %fileStream.sroa.0.2, %if.then.i70 ], [ %fileStream.sroa.0.1, %lpad10 ]
  %tobool.not.i76 = icmp eq ptr %fileStream.sroa.0.4107, null
  br i1 %tobool.not.i76, label %_ZN9CMyComPtrI9IInStreamED2Ev.exit82, label %if.then.i77

if.then.i77:                                      ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit75
  %vtable.i78 = load ptr, ptr %fileStream.sroa.0.4107, align 8
  %vfn.i79 = getelementptr inbounds ptr, ptr %vtable.i78, i64 2
  %18 = load ptr, ptr %vfn.i79, align 8
  %call.i80 = invoke noundef i32 %18(ptr noundef nonnull align 8 dereferenceable(8) %fileStream.sroa.0.4107)
...
_ZN9CMyComPtrI9IInStreamED2Ev.exit82:             ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit75.thread127, %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit75, %if.then.i77
  %.pn44108126 = phi { ptr, i32 } [ %.pn44108, %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit75 ], [ %.pn44108, %if.then.i77 ], [ %7, %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit75.thread127 ]
...
while.body.i:                                     ; preds = %entry, %while.body.i
  ...
  br i1 %cmp.i.i, label %_ZN12CArchiveLink7ReleaseEv.exit, label %while.body.i
...
if.end9.i.i:                                      ; preds = %delete.notnull.i.i, %call.i.i.noexc
  ...
  store ptr %call.i.i300, ptr %Path, align 8
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i:        ; preds = %if.end9.i.i, %if.end.i
  ...
  %17 = load ptr, ptr %filePath, align 8
  br label %while.cond.i.i
...
invoke.cont:                                      ; preds = %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i, %if.then23
  store i32 -1, ptr %SubfileIndex, align 4
...
cleanup34:                                        ; preds = %_ZN13CObjectVectorI4CArcE3AddERKS0_.exit, %invoke.cont26
  ...
  %25 = load ptr, ptr %ErrorMessage.i, align 8
...
_ZN11CStringBaseIwED2Ev.exit.i:                   ; preds = %delete.notnull.i.i303, %cleanup34
  %26 = load ptr, ptr %DefaultName.i, align 8
...
if.then57:                                        ; preds = %cleanup.cont54
  ...
  %vtable65 = load ptr, ptr %39, align 8
...
invoke.cont67:                                    ; preds = %if.then57
  ...
  %retval.0.call48.call68 = select i1 %cmp69.not, i32 %retval.0, i32 %call68
...
cleanup.cont85:                                   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit
  ...
  store ptr null, ptr %getStream, align 8
  %45 = load ptr, ptr %33, align 8
  %vtable93 = load ptr, ptr %45, align 8
...
lor.lhs.false:                                    ; preds = %invoke.cont95
  %47 = load ptr, ptr %getStream, align 8
...
ehcleanup82:                                      ; preds = %lpad62, %lpad44
  ...
  %call.i308 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %prop)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit311 unwind label %terminate.lpad.i309

terminate.lpad.i309:                              ; preds = %ehcleanup82
  %48 = landingpad { ptr, i32 }
          catch ptr null
...
if.end101:                                        ; preds = %lor.lhs.false
  ...
  store ptr null, ptr %subSeqStream, align 8
  %vtable109 = load ptr, ptr %47, align 8
...
lor.lhs.false114:                                 ; preds = %invoke.cont111
  %52 = load ptr, ptr %subSeqStream, align 8
...
cleanup.cont144:                                  ; preds = %invoke.cont137
  ...
  store ptr null, ptr %setSubArchiveName, align 8
  %vtable151 = load ptr, ptr %callback, align 8
...
if.end168:                                        ; preds = %if.then158, %invoke.cont153
  store i32 %mainSubfile.1, ptr %SubfileIndex169, align 4
  %64 = load ptr, ptr %subStream, align 8
...
cleanup203:                                       ; preds = %invoke.cont173, %cleanup203.fold.split, %cleanup.cont198, %invoke.cont191
  ...
  %retval.8 = phi i32 [ %call192, %invoke.cont191 ], [ %retval.4, %invoke.cont173 ], [ %retval.4, %cleanup.cont198 ], [ %call174, %cleanup203.fold.split ]
  %67 = load ptr, ptr %setSubArchiveName, align 8
...
if.then.i:                                        ; preds = %cleanup203
  %vtable.i317 = load ptr, ptr %67, align 8
  ...
  %call.i318 = invoke noundef i32 %68(ptr noundef nonnull align 8 dereferenceable(8) %67)
          to label %_ZN9CMyComPtrI29IArchiveOpenSetSubArchiveNameED2Ev.exit unwind label %terminate.lpad.i319
...
cleanup213:                                       ; preds = %invoke.cont124, %cleanup209
  ...
  %.pr377 = load ptr, ptr %subStream, align 8
  %tobool.not.i321 = icmp eq ptr %.pr377, null
  br i1 %tobool.not.i321, label %_ZN9CMyComPtrI9IInStreamED2Ev.exit, label %if.then.i322

if.then.i322:                                     ; preds = %cleanup213
  %vtable.i323 = load ptr, ptr %.pr377, align 8
  %vfn.i324 = getelementptr inbounds ptr, ptr %vtable.i323, i64 2
  %71 = load ptr, ptr %vfn.i324, align 8
  %call.i325 = invoke noundef i32 %71(ptr noundef nonnull align 8 dereferenceable(8) %.pr377)
          to label %_ZN9CMyComPtrI9IInStreamED2Ev.exit unwind label %terminate.lpad.i326

terminate.lpad.i326:                              ; preds = %if.then.i322
...
_ZN9CMyComPtrI9IInStreamED2Ev.exit:               ; preds = %lor.lhs.false127, %cleanup213, %if.then.i322
  %retval.10382 = phi i32 [ %retval.10.ph, %cleanup213 ], [ %retval.10.ph, %if.then.i322 ], [ %retval.4, %lor.lhs.false127 ]
  %cleanup.dest.slot.11381 = phi i32 [ %cleanup.dest.slot.11.ph, %cleanup213 ], [ %cleanup.dest.slot.11.ph, %if.then.i322 ], [ 2, %lor.lhs.false127 ]
...
cleanup217:                                       ; preds = %invoke.cont111, %_ZN9CMyComPtrI9IInStreamED2Ev.exit
  ...
  %.pr383 = load ptr, ptr %subSeqStream, align 8
  %tobool.not.i328 = icmp eq ptr %.pr383, null
  br i1 %tobool.not.i328, label %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit, label %if.then.i329

if.then.i329:                                     ; preds = %cleanup217
  %vtable.i330 = load ptr, ptr %.pr383, align 8
  %vfn.i331 = getelementptr inbounds ptr, ptr %vtable.i330, i64 2
  %74 = load ptr, ptr %vfn.i331, align 8
  %call.i332 = invoke noundef i32 %74(ptr noundef nonnull align 8 dereferenceable(8) %.pr383)
          to label %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit unwind label %terminate.lpad.i333

terminate.lpad.i333:                              ; preds = %if.then.i329
...
_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit:    ; preds = %lor.lhs.false114, %cleanup217, %if.then.i329
  %retval.11388 = phi i32 [ %retval.11.ph, %cleanup217 ], [ %retval.11.ph, %if.then.i329 ], [ %retval.4, %lor.lhs.false114 ]
  %cleanup.dest.slot.12387 = phi i32 [ %cleanup.dest.slot.12.ph, %cleanup217 ], [ %cleanup.dest.slot.12.ph, %if.then.i329 ], [ 2, %lor.lhs.false114 ]
...
cleanup221:                                       ; preds = %invoke.cont95, %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit
  ...
  %.pr389 = load ptr, ptr %getStream, align 8
  %tobool.not.i335 = icmp eq ptr %.pr389, null
  br i1 %tobool.not.i335, label %_ZN9CMyComPtrI19IInArchiveGetStreamED2Ev.exit, label %if.then.i336

if.then.i336:                                     ; preds = %cleanup221
  %vtable.i337 = load ptr, ptr %.pr389, align 8
  %vfn.i338 = getelementptr inbounds ptr, ptr %vtable.i337, i64 2
  %77 = load ptr, ptr %vfn.i338, align 8
  %call.i339 = invoke noundef i32 %77(ptr noundef nonnull align 8 dereferenceable(8) %.pr389)
          to label %_ZN9CMyComPtrI19IInArchiveGetStreamED2Ev.exit unwind label %terminate.lpad.i340

terminate.lpad.i340:                              ; preds = %if.then.i336
...
_ZN9CMyComPtrI19IInArchiveGetStreamED2Ev.exit:    ; preds = %lor.lhs.false, %cleanup221, %if.then.i336
  %retval.12394 = phi i32 [ %retval.12.ph, %cleanup221 ], [ %retval.12.ph, %if.then.i336 ], [ %retval.4, %lor.lhs.false ]
  %cleanup.dest.slot.13393 = phi i32 [ %cleanup.dest.slot.13.ph, %cleanup221 ], [ %cleanup.dest.slot.13.ph, %if.then.i336 ], [ 2, %lor.lhs.false ]
...
ehcleanup206:                                     ; preds = %lpad170, %lpad190, %lpad148
  ...
  %80 = load ptr, ptr %setSubArchiveName, align 8
  %tobool.not.i342 = icmp eq ptr %80, null
  br i1 %tobool.not.i342, label %_ZN9CMyComPtrI29IArchiveOpenSetSubArchiveNameED2Ev.exit349, label %if.then.i343

if.then.i343:                                     ; preds = %ehcleanup206
  %vtable.i344 = load ptr, ptr %80, align 8
  %vfn.i345 = getelementptr inbounds ptr, ptr %vtable.i344, i64 2
  %81 = load ptr, ptr %vfn.i345, align 8
  %call.i346 = invoke noundef i32 %81(ptr noundef nonnull align 8 dereferenceable(8) %80)
          to label %_ZN9CMyComPtrI29IArchiveOpenSetSubArchiveNameED2Ev.exit349 unwind label %terminate.lpad.i347

terminate.lpad.i347:                              ; preds = %if.then.i343
...
_ZN9CMyComPtrI29IArchiveOpenSetSubArchiveNameED2Ev.exit349: ; preds = %ehcleanup206, %if.then.i343
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %setSubArchiveName) #16
  br label %ehcleanup210
...
ehcleanup214:                                     ; preds = %ehcleanup212, %lpad121
  ...
  %84 = load ptr, ptr %subStream, align 8
  %tobool.not.i350 = icmp eq ptr %84, null
  br i1 %tobool.not.i350, label %_ZN9CMyComPtrI9IInStreamED2Ev.exit357, label %if.then.i351

if.then.i351:                                     ; preds = %ehcleanup214
  %vtable.i352 = load ptr, ptr %84, align 8
  %vfn.i353 = getelementptr inbounds ptr, ptr %vtable.i352, i64 2
  %85 = load ptr, ptr %vfn.i353, align 8
  %call.i354 = invoke noundef i32 %85(ptr noundef nonnull align 8 dereferenceable(8) %84)
          to label %_ZN9CMyComPtrI9IInStreamED2Ev.exit357 unwind label %terminate.lpad.i355
...
_ZN9CMyComPtrI9IInStreamED2Ev.exit357:            ; preds = %ehcleanup214, %if.then.i351
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %subStream) #16
  br label %ehcleanup218
...
ehcleanup218:                                     ; preds = %_ZN9CMyComPtrI9IInStreamED2Ev.exit357, %lpad104
  ...
  %88 = load ptr, ptr %subSeqStream, align 8
  %tobool.not.i358 = icmp eq ptr %88, null
  br i1 %tobool.not.i358, label %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit365, label %if.then.i359

if.then.i359:                                     ; preds = %ehcleanup218
  %vtable.i360 = load ptr, ptr %88, align 8
  %vfn.i361 = getelementptr inbounds ptr, ptr %vtable.i360, i64 2
  %89 = load ptr, ptr %vfn.i361, align 8
  %call.i362 = invoke noundef i32 %89(ptr noundef nonnull align 8 dereferenceable(8) %88)
          to label %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit365 unwind label %terminate.lpad.i363

terminate.lpad.i363:                              ; preds = %if.then.i359
...
_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit365: ; preds = %ehcleanup218, %if.then.i359
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %subSeqStream) #16
  br label %ehcleanup222
...
ehcleanup222:                                     ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit365, %lpad88
  ...
  %92 = load ptr, ptr %getStream, align 8
  %tobool.not.i366 = icmp eq ptr %92, null
  br i1 %tobool.not.i366, label %_ZN9CMyComPtrI19IInArchiveGetStreamED2Ev.exit373, label %if.then.i367

if.then.i367:                                     ; preds = %ehcleanup222
  %vtable.i368 = load ptr, ptr %92, align 8
  %vfn.i369 = getelementptr inbounds ptr, ptr %vtable.i368, i64 2
  %93 = load ptr, ptr %vfn.i369, align 8
  %call.i370 = invoke noundef i32 %93(ptr noundef nonnull align 8 dereferenceable(8) %92)
          to label %_ZN9CMyComPtrI19IInArchiveGetStreamED2Ev.exit373 unwind label %terminate.lpad.i371

terminate.lpad.i371:                              ; preds = %if.then.i367
...
_ZN9CMyComPtrI19IInArchiveGetStreamED2Ev.exit373: ; preds = %ehcleanup222, %if.then.i367
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %getStream) #16
  br label %ehcleanup232
...
for.end:                                          ; preds = %if.else, %if.then4, %cleanup229.for.end_crit_edge
  ...
  store i8 %frombool235, ptr %IsOpen, align 8
  br label %return
...
entry:
  ...
  store ptr %call.i.i10, ptr %Path, align 8
  store i32 0, ptr %call.i.i10, align 4
...
invoke.cont3:                                     ; preds = %entry
  ...
  store ptr %call.i.i12, ptr %DefaultName, align 8
  store i32 0, ptr %call.i.i12, align 4
  store i32 4, ptr %_capacity.i11, align 4
  %MTimeDefined = getelementptr inbounds %struct.CArc, ptr %this, i64 0, i32 6
  store i8 0, ptr %MTimeDefined, align 8
  %ErrorMessage = getelementptr inbounds %struct.CArc, ptr %this, i64 0, i32 7
...
invoke.cont5:                                     ; preds = %invoke.cont3
  ...
  store ptr %call.i.i15, ptr %ErrorMessage, align 8
  store i32 0, ptr %call.i.i15, align 4
  store i32 4, ptr %_capacity.i14, align 4
  ret void
...
entry:
  %ErrorMessage = getelementptr inbounds %struct.CArc, ptr %this, i64 0, i32 7
  %0 = load ptr, ptr %ErrorMessage, align 8
...
_ZN11CStringBaseIwED2Ev.exit:                     ; preds = %entry, %delete.notnull.i
  %DefaultName = getelementptr inbounds %struct.CArc, ptr %this, i64 0, i32 2
  %1 = load ptr, ptr %DefaultName, align 8
...
entry:
  ...
  store i64 0, ptr %VolumesSize, align 8
...
invoke.cont:                                      ; preds = %entry
  ...
  store ptr %callbackUI, ptr %Callback, align 8
...
invoke.cont3:                                     ; preds = %invoke.cont
  ...
  store ptr %call.i.i125, ptr %fullName, align 8
  store i32 0, ptr %call.i.i125, align 4
  store i32 4, ptr %_capacity.i, align 4
...
invoke.cont5:                                     ; preds = %invoke.cont3
  store ptr %call.i.i127, ptr %prefix, align 8
  store i32 0, ptr %call.i.i127, align 4
  store i32 4, ptr %_capacity.i126, align 4
...
invoke.cont7:                                     ; preds = %invoke.cont5
  store ptr %call.i.i130, ptr %name, align 8
  store i32 0, ptr %call.i.i130, align 4
  store i32 4, ptr %_capacity.i129, align 4
...
if.then:                                          ; preds = %invoke.cont7
  ...
  %4 = load ptr, ptr %filePath, align 8
...
cleanup.thread:                                   ; preds = %invoke.cont12
  ...
  %5 = load i32, ptr %call.i132, align 4
...
if.end:                                           ; preds = %invoke.cont12
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp) #16
  %11 = load i32, ptr %fileNamePartStartIndex, align 4
...
invoke.cont18:                                    ; preds = %if.end
  ...
  %14 = load i32, ptr %_capacity.i126, align 4
...
if.end9.i.i:                                      ; preds = %delete.notnull.i.i, %call.i.i.noexc
  ...
  store ptr %call.i.i133, ptr %prefix, align 8
  %arrayidx14.i.i = getelementptr inbounds i32, ptr %call.i.i133, i64 %idxprom13.i.i
  store i32 0, ptr %arrayidx14.i.i, align 4
  store i32 %add.i.i, ptr %_capacity.i126, align 4
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i
...
while.cond.i.i:                                   ; preds = %while.cond.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i
  ...
  br i1 %cmp.not.i.i, label %invoke.cont20, label %while.cond.i.i
...
_ZN11CStringBaseIwED2Ev.exit:                     ; preds = %invoke.cont20, %delete.notnull.i
  ...
  %23 = load i32, ptr %fileNamePartStartIndex, align 4
  %_length.i134 = getelementptr inbounds %class.CStringBase, ptr %fullName, i64 0, i32 1
  %24 = load i32, ptr %_length.i134, align 8
...
invoke.cont24:                                    ; preds = %_ZN11CStringBaseIwED2Ev.exit
  ...
  store i32 0, ptr %_length.i.i135, align 8
  %25 = load ptr, ptr %name, align 8
  store i32 0, ptr %25, align 4
  %_length.i136 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp22, i64 0, i32 1
  %26 = load i32, ptr %_length.i136, align 8
  %add.i.i137 = add nsw i32 %26, 1
  %27 = load i32, ptr %_capacity.i129, align 4
  %cmp.i.i139 = icmp eq i32 %add.i.i137, %27
  br i1 %cmp.i.i139, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i146, label %if.end.i.i140

if.end.i.i140:                                    ; preds = %invoke.cont24
  %conv.i.i141 = zext i32 %add.i.i137 to i64
  %28 = icmp slt i32 %26, -1
  %29 = shl nuw nsw i64 %conv.i.i141, 2
...
call.i.i.noexc155:                                ; preds = %if.end.i.i140
  %cmp3.i.i142 = icmp sgt i32 %27, 0
  br i1 %cmp3.i.i142, label %delete.notnull.i.i153, label %if.end9.i.i143

delete.notnull.i.i153:                            ; preds = %call.i.i.noexc155
  call void @_ZdaPv(ptr noundef nonnull %25) #19
  %.pre.i154 = load i32, ptr %_length.i.i135, align 8
  %31 = sext i32 %.pre.i154 to i64
  br label %if.end9.i.i143

if.end9.i.i143:                                   ; preds = %delete.notnull.i.i153, %call.i.i.noexc155
  %idxprom13.i.i144 = phi i64 [ %31, %delete.notnull.i.i153 ], [ 0, %call.i.i.noexc155 ]
  store ptr %call.i.i156, ptr %name, align 8
  %arrayidx14.i.i145 = getelementptr inbounds i32, ptr %call.i.i156, i64 %idxprom13.i.i144
  store i32 0, ptr %arrayidx14.i.i145, align 4
  store i32 %add.i.i137, ptr %_capacity.i129, align 4
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i146

_ZN11CStringBaseIwE11SetCapacityEi.exit.i146:     ; preds = %if.end9.i.i143, %invoke.cont24
  %32 = phi ptr [ %25, %invoke.cont24 ], [ %call.i.i156, %if.end9.i.i143 ]
  %33 = load ptr, ptr %ref.tmp22, align 8
  br label %while.cond.i.i147

while.cond.i.i147:                                ; preds = %while.cond.i.i147, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i146
  %src.addr.0.i.i148 = phi ptr [ %33, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i146 ], [ %incdec.ptr.i.i150, %while.cond.i.i147 ]
  %dest.addr.0.i.i149 = phi ptr [ %32, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i146 ], [ %incdec.ptr1.i.i151, %while.cond.i.i147 ]
  %incdec.ptr.i.i150 = getelementptr inbounds i32, ptr %src.addr.0.i.i148, i64 1
  %34 = load i32, ptr %src.addr.0.i.i148, align 4
  %incdec.ptr1.i.i151 = getelementptr inbounds i32, ptr %dest.addr.0.i.i149, i64 1
  store i32 %34, ptr %dest.addr.0.i.i149, align 4
  %cmp.not.i.i152 = icmp eq i32 %34, 0
  br i1 %cmp.not.i.i152, label %invoke.cont26, label %while.cond.i.i147

invoke.cont26:                                    ; preds = %while.cond.i.i147
  %35 = load i32, ptr %_length.i136, align 8
  store i32 %35, ptr %_length.i.i135, align 8
...
ehcleanup:                                        ; preds = %delete.notnull.i162, %lpad19, %lpad17
  %.pn = phi { ptr, i32 } [ %36, %lpad17 ], [ %37, %lpad19 ], [ %37, %delete.notnull.i162 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp) #16
  br label %ehcleanup31
...
ehcleanup29:                                      ; preds = %delete.notnull.i165, %lpad25, %lpad23
  %.pn112 = phi { ptr, i32 } [ %39, %lpad23 ], [ %40, %lpad25 ], [ %40, %delete.notnull.i165 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp22) #16
  br label %ehcleanup31

ehcleanup31:                                      ; preds = %ehcleanup29, %ehcleanup, %lpad9
  %.pn114 = phi { ptr, i32 } [ %10, %lpad9 ], [ %.pn112, %ehcleanup29 ], [ %.pn, %ehcleanup ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %fileNamePartStartIndex) #16
  br label %ehcleanup78

if.else:                                          ; preds = %invoke.cont7
  %42 = load ptr, ptr %filePath, align 8
...
cleanup.cont48:                                   ; preds = %invoke.cont42
  ...
  %46 = load i32, ptr %_length2.i.i, align 8
...
call.i.i.i.noexc:                                 ; preds = %if.end9.i.i.i
  store i32 0, ptr %call.i.i.i171, align 4
...
while.cond.i.i.i:                                 ; preds = %while.cond.i.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i
  ...
  %51 = load i32, ptr %src.addr.0.i.i.i, align 4
  %incdec.ptr1.i.i.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i, i64 1
  store i32 %51, ptr %dest.addr.0.i.i.i, align 4
...
_ZN11CStringBaseIwEC2ERKS0_.exit.i:               ; preds = %while.cond.i.i.i
  ...
  %52 = load i32, ptr %_length.i284, align 8
  %cmp.not.i.i287 = icmp sgt i32 %52, 0
  br i1 %cmp.not.i.i287, label %if.end.i.i293, label %_ZN11CStringBaseIwE10GrowLengthEi.exit.i

if.end.i.i293:                                    ; preds = %_ZN11CStringBaseIwEC2ERKS0_.exit.i
  ...
  %cmp.i.i.i296 = icmp eq i32 %add18.i.i, %46
  br i1 %cmp.i.i.i296, label %_ZN11CStringBaseIwE10GrowLengthEi.exit.i, label %if.end.i.i.i

if.end.i.i.i:                                     ; preds = %if.end.i.i293
  %add.i.i.i295 = add nsw i32 %add18.i.i, 1
  %conv.i.i.i297 = zext i32 %add.i.i.i295 to i64
  %53 = icmp slt i32 %add18.i.i, -1
  %54 = shl nuw nsw i64 %conv.i.i.i297, 2
...
call.i.i.i.noexc299:                              ; preds = %if.end.i.i.i
  ...
  br i1 %cmp3.i.i.i, label %for.cond.preheader.i.i.i, label %if.end9.i.i.i298
...
for.body.lr.ph.i.i.i:                             ; preds = %for.cond.preheader.i.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %call.i.i.i300, ptr align 4 %ref.tmp50.sroa.0.0, i64 %56, i1 false)
...
for.cond.cleanup.i.i.i:                           ; preds = %for.cond.preheader.i.i.i
  ...
  br i1 %isnull.i.i.i, label %if.end9.i.i.i298, label %delete.notnull.i.i.i
...
if.end9.i.i.i298:                                 ; preds = %delete.notnull.i.i.i, %for.cond.cleanup.i.i.i, %call.i.i.i.noexc299
...
_ZN11CStringBaseIwE10GrowLengthEi.exit.i:         ; preds = %if.end9.i.i.i298, %if.end.i.i293, %_ZN11CStringBaseIwEC2ERKS0_.exit.i
  %ref.tmp50.sroa.0.1 = phi ptr [ %ref.tmp50.sroa.0.0, %if.end.i.i293 ], [ %call.i.i.i300, %if.end9.i.i.i298 ], [ %ref.tmp50.sroa.0.0, %_ZN11CStringBaseIwEC2ERKS0_.exit.i ]
...
while.cond.i.i288:                                ; preds = %while.cond.i.i288, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i
  %src.addr.0.i.i289 = phi ptr [ %57, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i ], [ %incdec.ptr.i.i291, %while.cond.i.i288 ]
  %dest.addr.0.i.i290 = phi ptr [ %add.ptr.i, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i ], [ %incdec.ptr1.i.i292, %while.cond.i.i288 ]
  %incdec.ptr.i.i291 = getelementptr inbounds i32, ptr %src.addr.0.i.i289, i64 1
  %58 = load i32, ptr %src.addr.0.i.i289, align 4
  %incdec.ptr1.i.i292 = getelementptr inbounds i32, ptr %dest.addr.0.i.i290, i64 1
  store i32 %58, ptr %dest.addr.0.i.i290, align 4
  %cmp.not.i8.i = icmp eq i32 %58, 0
  br i1 %cmp.not.i8.i, label %invoke.cont52, label %while.cond.i.i288
...
invoke.cont52:                                    ; preds = %while.cond.i.i288
  %60 = load i32, ptr %_length.i284, align 8
...
call.i172.noexc:                                  ; preds = %invoke.cont52
  ...
  %62 = shl nuw nsw i64 %conv.i.i.i177, 2
  %63 = select i1 %61, i64 -1, i64 %62
  %call.i.i4.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %63) #18
          to label %call.i.i.noexc.i unwind label %lpad.i178

call.i.i.noexc.i:                                 ; preds = %call.i172.noexc
  %_capacity.i.i179 = getelementptr inbounds %class.CStringBase, ptr %call.i172188, i64 0, i32 2
  store ptr %call.i.i4.i, ptr %call.i172188, align 8
  store i32 0, ptr %call.i.i4.i, align 4
  store i32 %add.i.i.i174, ptr %_capacity.i.i179, align 4
  br label %while.cond.i.i.i181

while.cond.i.i.i181:                              ; preds = %call.i.i.noexc.i, %while.cond.i.i.i181
  %src.addr.0.i.i.i182 = phi ptr [ %incdec.ptr.i.i.i184, %while.cond.i.i.i181 ], [ %ref.tmp50.sroa.0.1, %call.i.i.noexc.i ]
  %dest.addr.0.i.i.i183 = phi ptr [ %incdec.ptr1.i.i.i185, %while.cond.i.i.i181 ], [ %call.i.i4.i, %call.i.i.noexc.i ]
  %incdec.ptr.i.i.i184 = getelementptr inbounds i32, ptr %src.addr.0.i.i.i182, i64 1
  %64 = load i32, ptr %src.addr.0.i.i.i182, align 4
  %incdec.ptr1.i.i.i185 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i183, i64 1
  store i32 %64, ptr %dest.addr.0.i.i.i183, align 4
  %cmp.not.i.i.i186 = icmp eq i32 %64, 0
  br i1 %cmp.not.i.i.i186, label %invoke.cont.i, label %while.cond.i.i.i181

invoke.cont.i:                                    ; preds = %while.cond.i.i.i181
  %_length.i.i187 = getelementptr inbounds %class.CStringBase, ptr %call.i172188, i64 0, i32 1
  store i32 %add.i, ptr %_length.i.i187, align 8
...
lpad.i178:                                        ; preds = %call.i172.noexc
  %65 = landingpad { ptr, i32 }
          cleanup
...
_ZN11CStringBaseIwED2Ev.exit192:                  ; preds = %invoke.cont54, %delete.notnull.i191
  ...
  %68 = load i32, ptr %_size.i, align 4
  %cmp61374 = icmp sgt i32 %68, 0
...
for.cond.cleanup:                                 ; preds = %_ZN11CStringBaseIwED2Ev.exit252, %_ZN11CStringBaseIwED2Ev.exit192
  ...
  %69 = load i64, ptr %TotalSize, align 8
  store i64 %69, ptr %VolumesSize, align 8
  br label %cleanup77
...
lpad53.body:                                      ; preds = %lpad.i178, %lpad53
  %eh.lpad-body189 = phi { ptr, i32 } [ %71, %lpad53 ], [ %65, %lpad.i178 ]
...
for.body:                                         ; preds = %for.body.lr.ph, %_ZN11CStringBaseIwED2Ev.exit252
  ...
  %72 = load ptr, ptr %_items.i.i196, align 8
  %arrayidx.i.i198 = getelementptr inbounds ptr, ptr %72, i64 %indvars.iv
  %73 = load ptr, ptr %arrayidx.i.i198, align 8
  %74 = load i32, ptr %_length2.i.i, align 8
  %add.i.i.i200 = add nsw i32 %74, 1
  %cmp.i.i.i201 = icmp eq i32 %add.i.i.i200, 0
  br i1 %cmp.i.i.i201, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i205, label %if.end9.i.i.i202

if.end9.i.i.i202:                                 ; preds = %for.body
  %conv.i.i.i204 = zext i32 %add.i.i.i200 to i64
  %75 = icmp slt i32 %74, -1
  %76 = shl nuw nsw i64 %conv.i.i.i204, 2
...
call.i.i.i.noexc219:                              ; preds = %if.end9.i.i.i202
  store i32 0, ptr %call.i.i.i220, align 4
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i205:   ; preds = %call.i.i.i.noexc219, %for.body
  ...
  br label %while.cond.i.i.i206

while.cond.i.i.i206:                              ; preds = %while.cond.i.i.i206, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i205
  %src.addr.0.i.i.i207 = phi ptr [ %78, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i205 ], [ %incdec.ptr.i.i.i209, %while.cond.i.i.i206 ]
  %dest.addr.0.i.i.i208 = phi ptr [ %ref.tmp63.sroa.0.1, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i205 ], [ %incdec.ptr1.i.i.i210, %while.cond.i.i.i206 ]
  %incdec.ptr.i.i.i209 = getelementptr inbounds i32, ptr %src.addr.0.i.i.i207, i64 1
  %79 = load i32, ptr %src.addr.0.i.i.i207, align 4
  %incdec.ptr1.i.i.i210 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i208, i64 1
  store i32 %79, ptr %dest.addr.0.i.i.i208, align 4
  %cmp.not.i.i.i211 = icmp eq i32 %79, 0
  br i1 %cmp.not.i.i.i211, label %_ZN11CStringBaseIwEC2ERKS0_.exit.i212, label %while.cond.i.i.i206

_ZN11CStringBaseIwEC2ERKS0_.exit.i212:            ; preds = %while.cond.i.i.i206
  %_length.i301 = getelementptr inbounds %class.CStringBase, ptr %73, i64 0, i32 1
  %80 = load i32, ptr %_length.i301, align 8
  %cmp.not.i.i305 = icmp sgt i32 %80, 0
  br i1 %cmp.not.i.i305, label %if.end.i.i316, label %_ZN11CStringBaseIwE10GrowLengthEi.exit.i306

if.end.i.i316:                                    ; preds = %_ZN11CStringBaseIwEC2ERKS0_.exit.i212
  %cmp4.i.i317 = icmp sgt i32 %74, 63
  %div24.i.i318 = lshr i32 %add.i.i.i200, 1
  ...
  %delta.1.i.i325 = call i32 @llvm.smax.i32(i32 %delta.0.i.i321, i32 %80)
  %add18.i.i326 = add nsw i32 %delta.1.i.i325, %add.i.i.i200
  %cmp.i.i.i328 = icmp eq i32 %add18.i.i326, %74
  br i1 %cmp.i.i.i328, label %_ZN11CStringBaseIwE10GrowLengthEi.exit.i306, label %if.end.i.i.i329

if.end.i.i.i329:                                  ; preds = %if.end.i.i316
  ...
  %call.i.i.i351 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %83) #18
          to label %call.i.i.i.noexc350 unwind label %lpad.i215

call.i.i.i.noexc350:                              ; preds = %if.end.i.i.i329
  %cmp3.i.i.i331 = icmp sgt i32 %74, -1
  br i1 %cmp3.i.i.i331, label %for.cond.preheader.i.i.i335, label %if.end9.i.i.i332

for.cond.preheader.i.i.i335:                      ; preds = %call.i.i.i.noexc350
  %cmp522.i.i.i336.not = icmp eq i32 %74, 0
  br i1 %cmp522.i.i.i336.not, label %for.cond.cleanup.i.i.i338, label %for.body.lr.ph.i.i.i342

for.body.lr.ph.i.i.i342:                          ; preds = %for.cond.preheader.i.i.i335
  %wide.trip.count.i.i.i343 = zext i32 %74 to i64
  %84 = shl nuw nsw i64 %wide.trip.count.i.i.i343, 2
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %call.i.i.i351, ptr align 4 %ref.tmp63.sroa.0.1, i64 %84, i1 false)
  br label %delete.notnull.i.i.i340

for.cond.cleanup.i.i.i338:                        ; preds = %for.cond.preheader.i.i.i335
  %isnull.i.i.i339 = icmp eq ptr %ref.tmp63.sroa.0.1, null
  br i1 %isnull.i.i.i339, label %if.end9.i.i.i332, label %delete.notnull.i.i.i340

delete.notnull.i.i.i340:                          ; preds = %for.body.lr.ph.i.i.i342, %for.cond.cleanup.i.i.i338
  call void @_ZdaPv(ptr noundef nonnull %ref.tmp63.sroa.0.1) #19
  br label %if.end9.i.i.i332

if.end9.i.i.i332:                                 ; preds = %delete.notnull.i.i.i340, %for.cond.cleanup.i.i.i338, %call.i.i.i.noexc350
  %idxprom13.i.i.i333 = sext i32 %74 to i64
  %arrayidx14.i.i.i334 = getelementptr inbounds i32, ptr %call.i.i.i351, i64 %idxprom13.i.i.i333
  store i32 0, ptr %arrayidx14.i.i.i334, align 4
  br label %_ZN11CStringBaseIwE10GrowLengthEi.exit.i306

_ZN11CStringBaseIwE10GrowLengthEi.exit.i306:      ; preds = %if.end9.i.i.i332, %if.end.i.i316, %_ZN11CStringBaseIwEC2ERKS0_.exit.i212
  %ref.tmp63.sroa.0.2 = phi ptr [ %ref.tmp63.sroa.0.1, %if.end.i.i316 ], [ %call.i.i.i351, %if.end9.i.i.i332 ], [ %ref.tmp63.sroa.0.1, %_ZN11CStringBaseIwEC2ERKS0_.exit.i212 ]
  %idx.ext.i307 = sext i32 %74 to i64
  %add.ptr.i308 = getelementptr inbounds i32, ptr %ref.tmp63.sroa.0.2, i64 %idx.ext.i307
  %85 = load ptr, ptr %73, align 8
  br label %while.cond.i.i309

while.cond.i.i309:                                ; preds = %while.cond.i.i309, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i306
  %src.addr.0.i.i310 = phi ptr [ %85, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i306 ], [ %incdec.ptr.i.i312, %while.cond.i.i309 ]
  %dest.addr.0.i.i311 = phi ptr [ %add.ptr.i308, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i306 ], [ %incdec.ptr1.i.i313, %while.cond.i.i309 ]
  %incdec.ptr.i.i312 = getelementptr inbounds i32, ptr %src.addr.0.i.i310, i64 1
  %86 = load i32, ptr %src.addr.0.i.i310, align 4
  %incdec.ptr1.i.i313 = getelementptr inbounds i32, ptr %dest.addr.0.i.i311, i64 1
  store i32 %86, ptr %dest.addr.0.i.i311, align 4
  %cmp.not.i8.i314 = icmp eq i32 %86, 0
  br i1 %cmp.not.i8.i314, label %invoke.cont68, label %while.cond.i.i309

lpad.i215:                                        ; preds = %if.end.i.i.i329
  %87 = landingpad { ptr, i32 }
          cleanup
  %isnull.i.i216 = icmp eq ptr %ref.tmp63.sroa.0.1, null
  br i1 %isnull.i.i216, label %ehcleanup78, label %delete.notnull.i.i217

delete.notnull.i.i217:                            ; preds = %lpad.i215
  call void @_ZdaPv(ptr noundef nonnull %ref.tmp63.sroa.0.1) #19
  br label %ehcleanup78

invoke.cont68:                                    ; preds = %while.cond.i.i309
  %88 = load i32, ptr %_length.i301, align 8
  %add.i315 = add nsw i32 %88, %74
...
call.i223.noexc:                                  ; preds = %invoke.cont68
  ...
  %add.i.i.i225 = add nsw i32 %add.i315, 1
  %cmp.i.i.i226 = icmp ne i32 %add.i.i.i225, 0
  call void @llvm.assume(i1 %cmp.i.i.i226)
  %conv.i.i.i228 = zext i32 %add.i.i.i225 to i64
  %89 = icmp slt i32 %add.i315, -1
  %90 = shl nuw nsw i64 %conv.i.i.i228, 2
  %91 = select i1 %89, i64 -1, i64 %90
  %call.i.i4.i229 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %91) #18
          to label %call.i.i.noexc.i231 unwind label %lpad.i230

call.i.i.noexc.i231:                              ; preds = %call.i223.noexc
  %_capacity.i.i232 = getelementptr inbounds %class.CStringBase, ptr %call.i223247, i64 0, i32 2
  store ptr %call.i.i4.i229, ptr %call.i223247, align 8
  store i32 0, ptr %call.i.i4.i229, align 4
  store i32 %add.i.i.i225, ptr %_capacity.i.i232, align 4
  br label %while.cond.i.i.i234

while.cond.i.i.i234:                              ; preds = %call.i.i.noexc.i231, %while.cond.i.i.i234
  %src.addr.0.i.i.i235 = phi ptr [ %incdec.ptr.i.i.i237, %while.cond.i.i.i234 ], [ %ref.tmp63.sroa.0.2, %call.i.i.noexc.i231 ]
  %dest.addr.0.i.i.i236 = phi ptr [ %incdec.ptr1.i.i.i238, %while.cond.i.i.i234 ], [ %call.i.i4.i229, %call.i.i.noexc.i231 ]
  %incdec.ptr.i.i.i237 = getelementptr inbounds i32, ptr %src.addr.0.i.i.i235, i64 1
  %92 = load i32, ptr %src.addr.0.i.i.i235, align 4
  %incdec.ptr1.i.i.i238 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i236, i64 1
  store i32 %92, ptr %dest.addr.0.i.i.i236, align 4
  %cmp.not.i.i.i239 = icmp eq i32 %92, 0
  br i1 %cmp.not.i.i.i239, label %invoke.cont.i240, label %while.cond.i.i.i234

invoke.cont.i240:                                 ; preds = %while.cond.i.i.i234
  %_length.i.i241 = getelementptr inbounds %class.CStringBase, ptr %call.i223247, i64 0, i32 1
  store i32 %add.i315, ptr %_length.i.i241, align 8
  invoke void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %VolumePaths)
          to label %invoke.cont70 unwind label %lpad69

lpad.i230:                                        ; preds = %call.i223.noexc
  %93 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPv(ptr noundef nonnull %call.i223247) #19
  br label %lpad69.body

invoke.cont70:                                    ; preds = %invoke.cont.i240
  %94 = load ptr, ptr %_items.i.i, align 8
  %95 = load i32, ptr %_size.i.i, align 4
  %idxprom.i.i244 = sext i32 %95 to i64
  %arrayidx.i.i245 = getelementptr inbounds ptr, ptr %94, i64 %idxprom.i.i244
  store ptr %call.i223247, ptr %arrayidx.i.i245, align 8
  %inc.i.i246 = add nsw i32 %95, 1
  store i32 %inc.i.i246, ptr %_size.i.i, align 4
...
_ZN11CStringBaseIwED2Ev.exit252:                  ; preds = %invoke.cont70, %delete.notnull.i251
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %96 = load i32, ptr %_size.i, align 4
  %97 = sext i32 %96 to i64
  %cmp61 = icmp slt i64 %indvars.iv.next, %97
  br i1 %cmp61, label %for.body, label %for.cond.cleanup

lpad65:                                           ; preds = %if.end9.i.i.i202
  %98 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup78

lpad69:                                           ; preds = %invoke.cont.i240, %invoke.cont68
  %99 = landingpad { ptr, i32 }
          cleanup
  br label %lpad69.body

lpad69.body:                                      ; preds = %lpad.i230, %lpad69
  %eh.lpad-body248 = phi { ptr, i32 } [ %99, %lpad69 ], [ %93, %lpad.i230 ]
...
_ZN11CStringBaseIwED2Ev.exit261:                  ; preds = %_ZN11CStringBaseIwED2Ev.exit258, %delete.notnull.i260
  ...
  %102 = load ptr, ptr %fullName, align 8
...
if.then.i:                                        ; preds = %delete.notnull.i263, %_ZN11CStringBaseIwED2Ev.exit261
  ...
  %vtable.i265 = load ptr, ptr %call, align 8
...
ehcleanup78:                                      ; preds = %lpad.i215, %delete.notnull.i.i217, %lpad65, %lpad69.body, %delete.notnull.i254, %lpad.i, %delete.notnull.i.i170, %lpad51, %lpad53.body, %delete.notnull.i194, %lpad39, %lpad32, %ehcleanup31
  %.pn118.pn = phi { ptr, i32 } [ %45, %lpad39 ], [ %44, %lpad32 ], [ %.pn114, %ehcleanup31 ], [ %70, %lpad51 ], [ %59, %delete.notnull.i.i170 ], [ %59, %lpad.i ], [ %eh.lpad-body189, %lpad53.body ], [ %eh.lpad-body189, %delete.notnull.i194 ], [ %98, %lpad65 ], [ %87, %delete.notnull.i.i217 ], [ %87, %lpad.i215 ], [ %eh.lpad-body248, %lpad69.body ], [ %eh.lpad-body248, %delete.notnull.i254 ]
...
ehcleanup80:                                      ; preds = %delete.notnull.i269, %ehcleanup78, %lpad6
  %.pn118.pn.pn = phi { ptr, i32 } [ %9, %lpad6 ], [ %.pn118.pn, %ehcleanup78 ], [ %.pn118.pn, %delete.notnull.i269 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %name) #16
  %107 = load ptr, ptr %prefix, align 8
...
ehcleanup84:                                      ; preds = %delete.notnull.i272, %ehcleanup80, %lpad4
  %.pn118.pn.pn.pn = phi { ptr, i32 } [ %8, %lpad4 ], [ %.pn118.pn.pn, %ehcleanup80 ], [ %.pn118.pn.pn, %delete.notnull.i272 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %prefix) #16
  %108 = load ptr, ptr %fullName, align 8
  %isnull.i274 = icmp eq ptr %108, null
  br i1 %isnull.i274, label %if.then.i278, label %delete.notnull.i275

delete.notnull.i275:                              ; preds = %ehcleanup84
  call void @_ZdaPv(ptr noundef nonnull %108) #19
  br label %if.then.i278

if.then.i278:                                     ; preds = %lpad2, %ehcleanup84, %delete.notnull.i275
  %.pn118.pn.pn.pn.pn = phi { ptr, i32 } [ %7, %lpad2 ], [ %.pn118.pn.pn.pn, %ehcleanup84 ], [ %.pn118.pn.pn.pn, %delete.notnull.i275 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %fullName) #16
  %vtable.i279 = load ptr, ptr %call, align 8
  %vfn.i280 = getelementptr inbounds ptr, ptr %vtable.i279, i64 2
  %109 = load ptr, ptr %vfn.i280, align 8
  %call.i281 = invoke noundef i32 %109(ptr noundef nonnull align 8 dereferenceable(8) %call)
          to label %ehcleanup94 unwind label %terminate.lpad.i282

terminate.lpad.i282:                              ; preds = %if.then.i278
...
ehcleanup94:                                      ; preds = %if.then.i278, %lpad
  %.pn118.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %6, %lpad ], [ %.pn118.pn.pn.pn.pn, %if.then.i278 ]
...
entry:
  ...
  store ptr getelementptr inbounds ({ [13 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTV16COpenCallbackImp, i64 0, inrange i32 1, i64 2), ptr %0, align 8
  store ptr getelementptr inbounds ({ [13 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTV16COpenCallbackImp, i64 0, inrange i32 2, i64 2), ptr %1, align 8
  store ptr getelementptr inbounds ({ [13 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTV16COpenCallbackImp, i64 0, inrange i32 3, i64 2), ptr %2, align 8
  ...
  store ptr %call.i.i22, ptr %_folderPrefix, align 8
  store i32 0, ptr %call.i.i22, align 4
  store i32 4, ptr %_capacity.i, align 4
...
invoke.cont5:                                     ; preds = %entry
  ...
  store ptr %call.i.i.i23, ptr %Name.i, align 8
  store i32 0, ptr %call.i.i.i23, align 4
...
invoke.cont9:                                     ; preds = %invoke.cont5
  ...
  store ptr %call.i.i25, ptr %_subArchiveName, align 8
  store i32 0, ptr %call.i.i25, align 4
  store i32 4, ptr %_capacity.i24, align 4
...
ehcleanup13:                                      ; preds = %invoke.cont5
  ...
  %.pre = load ptr, ptr %_folderPrefix, align 8
...
entry._ZN11CStringBaseIwEaSERKS0_.exit_crit_edge: ; preds = %entry
  %.pre = load i32, ptr %_length2.i.i.phi.trans.insert, align 8
  br label %_ZN11CStringBaseIwEaSERKS0_.exit

if.end.i:                                         ; preds = %entry
  store i32 0, ptr %_length2.i.i.phi.trans.insert, align 8
  %0 = load ptr, ptr %_folderPrefix, align 8
  store i32 0, ptr %0, align 4
...
delete.notnull.i.i:                               ; preds = %if.end.i.i
  tail call void @_ZdaPv(ptr noundef nonnull %0) #19
  %.pre.i = load i32, ptr %_length2.i.i.phi.trans.insert, align 8
...
if.end9.i.i:                                      ; preds = %delete.notnull.i.i, %if.end.i.i
  ...
  store ptr %call.i.i, ptr %_folderPrefix, align 8
  %arrayidx14.i.i = getelementptr inbounds i32, ptr %call.i.i, i64 %idxprom13.i.i
  store i32 0, ptr %arrayidx14.i.i, align 4
  store i32 %add.i.i, ptr %_capacity.i.i, align 4
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i:        ; preds = %if.end9.i.i, %if.end.i
  ...
  %8 = load ptr, ptr %folderPrefix, align 8
  br label %while.cond.i.i
...
_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i:            ; preds = %while.cond.i.i
  %10 = load i32, ptr %_length.i, align 8
  store i32 %10, ptr %_length2.i.i.phi.trans.insert, align 8
  br label %_ZN11CStringBaseIwEaSERKS0_.exit
...
if.end9.i.i.i:                                    ; preds = %_ZN11CStringBaseIwEaSERKS0_.exit
  ...
  %14 = select i1 %12, i64 -1, i64 %13
  %call.i.i.i = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %14) #18
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i:      ; preds = %if.end9.i.i.i, %_ZN11CStringBaseIwEaSERKS0_.exit
  ...
  %15 = load ptr, ptr %_folderPrefix, align 8
  br label %while.cond.i.i.i
...
_ZN11CStringBaseIwEC2ERKS0_.exit.i:               ; preds = %while.cond.i.i.i
  ...
  %17 = load i32, ptr %_length.i13, align 8
  %cmp.not.i.i16 = icmp sgt i32 %17, 0
  br i1 %cmp.not.i.i16, label %if.end.i.i23, label %_ZN11CStringBaseIwE10GrowLengthEi.exit.i

if.end.i.i23:                                     ; preds = %_ZN11CStringBaseIwEC2ERKS0_.exit.i
  ...
  %add18.i.i = add nsw i32 %delta.1.i.i, %add.i.i.i
  %cmp.i.i.i26 = icmp eq i32 %add18.i.i, %11
  br i1 %cmp.i.i.i26, label %_ZN11CStringBaseIwE10GrowLengthEi.exit.i, label %if.end.i.i.i

if.end.i.i.i:                                     ; preds = %if.end.i.i23
  %add.i.i.i25 = add nsw i32 %add18.i.i, 1
  %conv.i.i.i27 = zext i32 %add.i.i.i25 to i64
  %18 = icmp slt i32 %add18.i.i, -1
  %19 = shl nuw nsw i64 %conv.i.i.i27, 2
  %20 = select i1 %18, i64 -1, i64 %19
  %call.i.i.i2830 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %20) #18
          to label %call.i.i.i28.noexc unwind label %lpad.i

call.i.i.i28.noexc:                               ; preds = %if.end.i.i.i
  %cmp3.i.i.i = icmp sgt i32 %11, -1
  br i1 %cmp3.i.i.i, label %for.cond.preheader.i.i.i, label %if.end9.i.i.i29

for.cond.preheader.i.i.i:                         ; preds = %call.i.i.i28.noexc
...
for.body.lr.ph.i.i.i:                             ; preds = %for.cond.preheader.i.i.i
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %call.i.i.i2830, ptr align 4 %ref.tmp.sroa.0.0, i64 %21, i1 false)
  br label %delete.notnull.i.i.i

for.cond.cleanup.i.i.i:                           ; preds = %for.cond.preheader.i.i.i
  %isnull.i.i.i = icmp eq ptr %ref.tmp.sroa.0.0, null
  br i1 %isnull.i.i.i, label %if.end9.i.i.i29, label %delete.notnull.i.i.i

delete.notnull.i.i.i:                             ; preds = %for.body.lr.ph.i.i.i, %for.cond.cleanup.i.i.i
  tail call void @_ZdaPv(ptr noundef nonnull %ref.tmp.sroa.0.0) #19
  br label %if.end9.i.i.i29

if.end9.i.i.i29:                                  ; preds = %delete.notnull.i.i.i, %for.cond.cleanup.i.i.i, %call.i.i.i28.noexc
  %idxprom13.i.i.i = sext i32 %11 to i64
  %arrayidx14.i.i.i = getelementptr inbounds i32, ptr %call.i.i.i2830, i64 %idxprom13.i.i.i
  store i32 0, ptr %arrayidx14.i.i.i, align 4
  br label %_ZN11CStringBaseIwE10GrowLengthEi.exit.i

_ZN11CStringBaseIwE10GrowLengthEi.exit.i:         ; preds = %if.end9.i.i.i29, %if.end.i.i23, %_ZN11CStringBaseIwEC2ERKS0_.exit.i
  %ref.tmp.sroa.0.1 = phi ptr [ %ref.tmp.sroa.0.0, %if.end.i.i23 ], [ %call.i.i.i2830, %if.end9.i.i.i29 ], [ %ref.tmp.sroa.0.0, %_ZN11CStringBaseIwEC2ERKS0_.exit.i ]
...
while.cond.i.i17:                                 ; preds = %while.cond.i.i17, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i
  %src.addr.0.i.i18 = phi ptr [ %22, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i ], [ %incdec.ptr.i.i20, %while.cond.i.i17 ]
  %dest.addr.0.i.i19 = phi ptr [ %add.ptr.i, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i ], [ %incdec.ptr1.i.i21, %while.cond.i.i17 ]
  %incdec.ptr.i.i20 = getelementptr inbounds i32, ptr %src.addr.0.i.i18, i64 1
  %23 = load i32, ptr %src.addr.0.i.i18, align 4
  %incdec.ptr1.i.i21 = getelementptr inbounds i32, ptr %dest.addr.0.i.i19, i64 1
  store i32 %23, ptr %dest.addr.0.i.i19, align 4
  %cmp.not.i8.i = icmp eq i32 %23, 0
  br i1 %cmp.not.i8.i, label %_ZplIwE11CStringBaseIT_ERKS2_S4_.exit, label %while.cond.i.i17
...
_ZplIwE11CStringBaseIT_ERKS2_S4_.exit:            ; preds = %while.cond.i.i17
...
if.end:                                           ; preds = %_ZN11CStringBaseIwED2Ev.exit
  ...
  store i8 0, ptr %_subArchiveMode, align 8
...
entry:
  ...
  %ref.tmp = alloca %class.CRecordVector, align 8
  %_size.i = getelementptr inbounds %class.CBaseRecordVector, ptr %this, i64 0, i32 2
  %0 = load i32, ptr %_size.i, align 4
...
if.then5:                                         ; preds = %if.end
  ...
  store i64 4, ptr %_itemSize.i.i, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CRecordVectorIiE, i64 0, inrange i32 0, i64 2), ptr %ref.tmp, align 8
...
invoke.cont.i:                                    ; preds = %if.end7
  %vtable.i.i = load ptr, ptr %call.i56, align 8
  %vfn.i.i = getelementptr inbounds ptr, ptr %vtable.i.i, i64 1
...
if.then.i.i:                                      ; preds = %invoke.cont.i
  %vtable.i29.i = load ptr, ptr %callback, align 8
...
if.end.i.i:                                       ; preds = %if.then.i.i, %invoke.cont.i
  %4 = load ptr, ptr %ReOpenCallback.i, align 8
  %tobool.not.i32.i = icmp eq ptr %4, null
  br i1 %tobool.not.i32.i, label %_ZN9CMyComPtrI20IArchiveOpenCallbackEaSEPS0_.exit37.i, label %if.then2.i33.i

if.then2.i33.i:                                   ; preds = %if.end.i.i
  %vtable4.i34.i = load ptr, ptr %4, align 8
  %vfn5.i35.i = getelementptr inbounds ptr, ptr %vtable4.i34.i, i64 2
  %5 = load ptr, ptr %vfn5.i35.i, align 8
  %call6.i36.i60 = invoke noundef i32 %5(ptr noundef nonnull align 8 dereferenceable(8) %4)
          to label %_ZN9CMyComPtrI20IArchiveOpenCallbackEaSEPS0_.exit37.i unwind label %ehcleanup39.thread104

_ZN9CMyComPtrI20IArchiveOpenCallbackEaSEPS0_.exit37.i: ; preds = %if.then2.i33.i, %if.end.i.i
  store ptr %callback, ptr %ReOpenCallback.i, align 8
...
call.i.i.i.noexc:                                 ; preds = %_ZN9CMyComPtrI20IArchiveOpenCallbackEaSEPS0_.exit37.i
  ...
  store ptr %call.i.i.i61, ptr %fullName.i, align 8
  store i32 0, ptr %call.i.i.i61, align 4
  store i32 4, ptr %_capacity.i.i55, align 4
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %fileNamePartStartIndex.i) #16
  %7 = load ptr, ptr %filePath, align 8
...
invoke.cont6.i:                                   ; preds = %call.i.i.i.noexc
  ...
  %8 = load i32, ptr %fileNamePartStartIndex.i, align 4
...
invoke.cont9.i:                                   ; preds = %invoke.cont6.i
  ...
  %9 = load i32, ptr %fileNamePartStartIndex.i, align 4
...
invoke.cont14.i:                                  ; preds = %invoke.cont12.i
  %11 = load ptr, ptr %ref.tmp10.i, align 8
...
_ZN11CStringBaseIwED2Ev.exit40.i:                 ; preds = %delete.notnull.i39.i, %_ZN11CStringBaseIwED2Ev.exit.i
  ...
  %13 = load ptr, ptr %fullName.i, align 8
...
lpad13.i:                                         ; preds = %invoke.cont12.i
  %18 = landingpad { ptr, i32 }
          cleanup
  %19 = load ptr, ptr %ref.tmp10.i, align 8
...
ehcleanup17.i:                                    ; preds = %ehcleanup16.i, %lpad3.i
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %fileNamePartStartIndex.i) #16
  %21 = load ptr, ptr %fullName.i, align 8
...
invoke.cont11:                                    ; preds = %invoke.cont9
  ...
  store ptr getelementptr inbounds ({ [10 x ptr], [8 x ptr] }, ptr @_ZTV13CInFileStream, i64 0, inrange i32 0, i64 2), ptr %call12, align 8
  store ptr getelementptr inbounds ({ [10 x ptr], [8 x ptr] }, ptr @_ZTV13CInFileStream, i64 0, inrange i32 1, i64 2), ptr %22, align 8
  %File.i = getelementptr inbounds %class.CInFileStream, ptr %call12, i64 0, i32 5
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTVN8NWindows5NFile3NIO9CFileBaseE, i64 0, inrange i32 0, i64 2), ptr %File.i, align 8
  %_fd.i.i.i = getelementptr inbounds %class.CInFileStream, ptr %call12, i64 0, i32 5, i32 0, i32 1
  store i32 -1, ptr %_fd.i.i.i, align 8
...
invoke.cont14:                                    ; preds = %invoke.cont11
  %_capacity.i.i.i.i = getelementptr inbounds %class.CInFileStream, ptr %call12, i64 0, i32 5, i32 0, i32 3, i32 2
  store ptr %call.i.i.i.i4.i62, ptr %_unix_filename.i.i.i, align 8
  store i8 0, ptr %call.i.i.i.i4.i62, align 1
  store i32 4, ptr %_capacity.i.i.i.i, align 4
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTVN8NWindows5NFile3NIO7CInFileE, i64 0, inrange i32 0, i64 2), ptr %File.i, align 8
  %_ignoreSymbolicLink.i = getelementptr inbounds %class.CInFileStream, ptr %call12, i64 0, i32 3
  store i8 1, ptr %_ignoreSymbolicLink.i, align 4
...
invoke.cont16:                                    ; preds = %invoke.cont14
  %25 = load ptr, ptr %filePath, align 8
...
invoke.cont27:                                    ; preds = %invoke.cont20
  ...
  %32 = load ptr, ptr %_items.i.i.i.i, align 8
...
invoke.cont31:                                    ; preds = %invoke.cont27
  ...
  store i8 %frombool, ptr %IsOpen, align 8
  br label %if.then.i
...
if.then.i:                                        ; preds = %if.then22, %invoke.cont31
  ...
  %vtable.i66 = load ptr, ptr %call12, align 8
  ...
  %call.i68 = invoke noundef i32 %37(ptr noundef nonnull align 8 dereferenceable(8) %call12)
          to label %if.then.i70 unwind label %terminate.lpad.i
...
if.then.i70:                                      ; preds = %if.then.i
  %vtable.i71 = load ptr, ptr %call.i56, align 8
  %vfn.i72 = getelementptr inbounds ptr, ptr %vtable.i71, i64 2
  %40 = load ptr, ptr %vfn.i72, align 8
  %call.i73 = invoke noundef i32 %40(ptr noundef nonnull align 8 dereferenceable(8) %call.i56)
...
if.then.i76:                                      ; preds = %lpad17, %lpad26
  %.pn = phi { ptr, i32 } [ %36, %lpad26 ], [ %30, %lpad17 ]
  %vtable.i77 = load ptr, ptr %call12, align 8
  %vfn.i78 = getelementptr inbounds ptr, ptr %vtable.i77, i64 2
  %43 = load ptr, ptr %vfn.i78, align 8
  %call.i79 = invoke noundef i32 %43(ptr noundef nonnull align 8 dereferenceable(8) %call12)
          to label %if.then.i83 unwind label %terminate.lpad.i80

terminate.lpad.i80:                               ; preds = %if.then.i76
  %44 = landingpad { ptr, i32 }
          catch ptr null
...
ehcleanup39.thread104:                            ; preds = %_ZN9CMyComPtrI20IArchiveOpenCallbackEaSEPS0_.exit37.i, %if.then2.i33.i, %if.then.i.i
  %lpad.thr_comm = landingpad { ptr, i32 }
          cleanup
  br label %if.then.i83

if.then.i83:                                      ; preds = %lpad15, %if.then.i76, %_ZN11CStringBaseIwED2Ev.exit52.i, %lpad10, %lpad13, %ehcleanup39.thread104
  %.pn.pn.pn.pn97 = phi { ptr, i32 } [ %lpad.thr_comm, %ehcleanup39.thread104 ], [ %.pn, %if.then.i76 ], [ %29, %lpad15 ], [ %.pn.pn.pn.i, %_ZN11CStringBaseIwED2Ev.exit52.i ], [ %27, %lpad10 ], [ %28, %lpad13 ]
  %vtable.i84 = load ptr, ptr %call.i56, align 8
  %vfn.i85 = getelementptr inbounds ptr, ptr %vtable.i84, i64 2
  %46 = load ptr, ptr %vfn.i85, align 8
  %call.i86 = invoke noundef i32 %46(ptr noundef nonnull align 8 dereferenceable(8) %call.i56)
          to label %eh.resume unwind label %terminate.lpad.i87

terminate.lpad.i87:                               ; preds = %if.then.i83
...
return:                                           ; preds = %if.then.i70, %entry, %invoke.cont
  %retval.1 = phi i32 [ %call6, %invoke.cont ], [ -2147467263, %entry ], [ %retval.0, %if.then.i70 ]
  ret i32 %retval.1

eh.resume:                                        ; preds = %if.then.i83, %ehcleanup39.thread99, %lpad
  %.pn52 = phi { ptr, i32 } [ %1, %lpad ], [ %.pn.pn.pn.pn97, %if.then.i83 ], [ %14, %ehcleanup39.thread99 ]
  resume { ptr, i32 } %.pn52
}
...
_ZN9CMyComPtrI10IInArchiveEC2ERKS1_.exit:         ; preds = %entry, %if.then.i
  ...
  %3 = load i32, ptr %_length2.i, align 8
...
call.i.i.noexc:                                   ; preds = %if.end9.i.i
  %_capacity.i = getelementptr inbounds %struct.CArc, ptr %this, i64 0, i32 1, i32 2
  store ptr %call.i.i19, ptr %Path, align 8
...
invoke.cont:                                      ; preds = %while.cond.i.i
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %DefaultName, i8 0, i64 16, i1 false)
  %10 = load i32, ptr %_length2.i20, align 8
  %add.i.i21 = add nsw i32 %10, 1
  %cmp.i.i22 = icmp eq i32 %add.i.i21, 0
  br i1 %cmp.i.i22, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i26, label %if.end9.i.i23

if.end9.i.i23:                                    ; preds = %invoke.cont
  %conv.i.i25 = zext i32 %add.i.i21 to i64
  %11 = icmp slt i32 %10, -1
  %12 = shl nuw nsw i64 %conv.i.i25, 2
  %13 = select i1 %11, i64 -1, i64 %12
  %call.i.i35 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %13) #18
          to label %call.i.i.noexc34 unwind label %lpad5

call.i.i.noexc34:                                 ; preds = %if.end9.i.i23
  %_capacity.i24 = getelementptr inbounds %struct.CArc, ptr %this, i64 0, i32 2, i32 2
  store ptr %call.i.i35, ptr %DefaultName, align 8
  store i32 0, ptr %call.i.i35, align 4
  store i32 %add.i.i21, ptr %_capacity.i24, align 4
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i26:      ; preds = %call.i.i.noexc34, %invoke.cont
  ...
  %15 = load ptr, ptr %DefaultName4, align 8
  br label %while.cond.i.i27

while.cond.i.i27:                                 ; preds = %while.cond.i.i27, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i26
  %src.addr.0.i.i28 = phi ptr [ %15, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i26 ], [ %incdec.ptr.i.i30, %while.cond.i.i27 ]
  %dest.addr.0.i.i29 = phi ptr [ %14, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i26 ], [ %incdec.ptr1.i.i31, %while.cond.i.i27 ]
  %incdec.ptr.i.i30 = getelementptr inbounds i32, ptr %src.addr.0.i.i28, i64 1
  %16 = load i32, ptr %src.addr.0.i.i28, align 4
  %incdec.ptr1.i.i31 = getelementptr inbounds i32, ptr %dest.addr.0.i.i29, i64 1
  store i32 %16, ptr %dest.addr.0.i.i29, align 4
  %cmp.not.i.i32 = icmp eq i32 %16, 0
  br i1 %cmp.not.i.i32, label %invoke.cont6, label %while.cond.i.i27

invoke.cont6:                                     ; preds = %while.cond.i.i27
  %_length.i33 = getelementptr inbounds %struct.CArc, ptr %this, i64 0, i32 2, i32 1
  store i32 %10, ptr %_length.i33, align 8
  %FormatIndex = getelementptr inbounds %struct.CArc, ptr %this, i64 0, i32 3
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %ErrorMessage, i8 0, i64 16, i1 false)
  %17 = load i32, ptr %_length2.i37, align 8
  %add.i.i38 = add nsw i32 %17, 1
  %cmp.i.i39 = icmp eq i32 %add.i.i38, 0
  br i1 %cmp.i.i39, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i43, label %if.end9.i.i40

if.end9.i.i40:                                    ; preds = %invoke.cont6
  %conv.i.i42 = zext i32 %add.i.i38 to i64
  %18 = icmp slt i32 %17, -1
  %19 = shl nuw nsw i64 %conv.i.i42, 2
  %20 = select i1 %18, i64 -1, i64 %19
  %call.i.i52 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %20) #18
          to label %call.i.i.noexc51 unwind label %lpad9

call.i.i.noexc51:                                 ; preds = %if.end9.i.i40
  %_capacity.i41 = getelementptr inbounds %struct.CArc, ptr %this, i64 0, i32 7, i32 2
  store ptr %call.i.i52, ptr %ErrorMessage, align 8
  store i32 0, ptr %call.i.i52, align 4
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i43:      ; preds = %call.i.i.noexc51, %invoke.cont6
  ...
  %22 = load ptr, ptr %ErrorMessage8, align 8
  br label %while.cond.i.i44

while.cond.i.i44:                                 ; preds = %while.cond.i.i44, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i43
  %src.addr.0.i.i45 = phi ptr [ %22, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i43 ], [ %incdec.ptr.i.i47, %while.cond.i.i44 ]
  %dest.addr.0.i.i46 = phi ptr [ %21, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i43 ], [ %incdec.ptr1.i.i48, %while.cond.i.i44 ]
  %incdec.ptr.i.i47 = getelementptr inbounds i32, ptr %src.addr.0.i.i45, i64 1
  %23 = load i32, ptr %src.addr.0.i.i45, align 4
  %incdec.ptr1.i.i48 = getelementptr inbounds i32, ptr %dest.addr.0.i.i46, i64 1
  store i32 %23, ptr %dest.addr.0.i.i46, align 4
  %cmp.not.i.i49 = icmp eq i32 %23, 0
  br i1 %cmp.not.i.i49, label %invoke.cont10, label %while.cond.i.i44

invoke.cont10:                                    ; preds = %while.cond.i.i44
  %_length.i50 = getelementptr inbounds %struct.CArc, ptr %this, i64 0, i32 7, i32 1
  store i32 %17, ptr %_length.i50, align 8
  ret void
...
lpad5:                                            ; preds = %if.end9.i.i23
  %25 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup

lpad9:                                            ; preds = %if.end9.i.i40
  %26 = landingpad { ptr, i32 }
          cleanup
...
ehcleanup11:                                      ; preds = %delete.notnull.i55, %ehcleanup, %lpad
  ...
  br i1 %tobool.not.i, label %_ZN9CMyComPtrI10IInArchiveED2Ev.exit, label %if.then.i57

if.then.i57:                                      ; preds = %ehcleanup11
  %vtable.i58 = load ptr, ptr %28, align 8
  %vfn.i59 = getelementptr inbounds ptr, ptr %vtable.i58, i64 2
  %29 = load ptr, ptr %vfn.i59, align 8
  %call.i60 = invoke noundef i32 %29(ptr noundef nonnull align 8 dereferenceable(8) %28)
          to label %_ZN9CMyComPtrI10IInArchiveED2Ev.exit unwind label %terminate.lpad.i
...
_ZN9CMyComPtrI10IInArchiveED2Ev.exit:             ; preds = %ehcleanup11, %if.then.i57
