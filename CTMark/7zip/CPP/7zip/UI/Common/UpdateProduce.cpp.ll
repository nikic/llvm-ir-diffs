; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Common/UpdateProduce.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Common/UpdateProduce.cpp"
...
for.body.us:                                      ; preds = %for.body.lr.ph, %cleanup.us
  ...
  %3 = load i32, ptr %DirIndex.us, align 4
  ...
  %4 = load i32, ptr %ArcIndex.us, align 4
...
sw.epilog.us:                                     ; preds = %sw.bb6.us, %sw.bb13.us, %sw.bb21.us, %for.body.us
  ...
  %7 = load ptr, ptr %_items.i37, align 8
  %8 = load i32, ptr %_size.i38, align 4
  %idxprom.i39.us = sext i32 %8 to i64
  %arrayidx.i40.us = getelementptr inbounds %struct.CUpdatePair2, ptr %7, i64 %idxprom.i39.us
  store i64 %up2.sroa.0.1.us, ptr %arrayidx.i40.us, align 4
  %item.sroa.2.0.arrayidx.sroa_idx.i.us = getelementptr inbounds i8, ptr %arrayidx.i40.us, i64 8
  store i64 %up2.sroa.12.8.insert.insert.us, ptr %item.sroa.2.0.arrayidx.sroa_idx.i.us, align 4
  %9 = load i32, ptr %_size.i38, align 4
  %inc.i.us = add nsw i32 %9, 1
  store i32 %inc.i.us, ptr %_size.i38, align 4
...
for.body:                                         ; preds = %for.body.lr.ph, %cleanup
  ...
  %12 = load ptr, ptr %_items.i, align 8
  ...
  %13 = load i32, ptr %DirIndex, align 4
  ...
  %14 = load i32, ptr %ArcIndex, align 4
...
if.then18:                                        ; preds = %sw.bb13, %sw.bb13.us
  ...
  store ptr @.str, ptr %exception19, align 16
...
sw.epilog:                                        ; preds = %sw.bb6, %sw.bb13, %for.body, %sw.bb21
  ...
  tail call void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %operationChain)
  %18 = load ptr, ptr %_items.i37, align 8
  %19 = load i32, ptr %_size.i38, align 4
  %idxprom.i39 = sext i32 %19 to i64
  %arrayidx.i40 = getelementptr inbounds %struct.CUpdatePair2, ptr %18, i64 %idxprom.i39
  store i64 %up2.sroa.0.1, ptr %arrayidx.i40, align 4
  %item.sroa.2.0.arrayidx.sroa_idx.i = getelementptr inbounds i8, ptr %arrayidx.i40, i64 8
  store i64 %up2.sroa.12.8.insert.insert, ptr %item.sroa.2.0.arrayidx.sroa_idx.i, align 4
  %20 = load i32, ptr %_size.i38, align 4
  %inc.i = add nsw i32 %20, 1
  store i32 %inc.i, ptr %_size.i38, align 4
  br label %cleanup
