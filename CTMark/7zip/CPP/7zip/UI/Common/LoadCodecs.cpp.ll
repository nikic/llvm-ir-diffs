...
for.cond.i.i72:                                   ; preds = %for.cond.i.i72, %if.then7
  ...
  %9 = load i32, ptr %arrayidx.i.i74, align 4, !tbaa !16
  %cmp.not.i.i75 = icmp eq i32 %9, 0
  %indvars.iv.next.i.i76 = add nuw i64 %indvars.iv.i.i73, 1
  br i1 %cmp.not.i.i75, label %_Z11MyStringLenIwEiPKT_.exit.i77, label %for.cond.i.i72, !llvm.loop !18
...
call.i.i.noexc90:                                 ; preds = %if.end9.i.i80
  ...
  store i32 %add.i.i78, ptr %_capacity.i71, align 4, !tbaa !22
...
while.cond.i.i83:                                 ; preds = %while.cond.i.i83, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i82
  ...
  %15 = load i32, ptr %src.addr.0.i.i84, align 4, !tbaa !16
  %incdec.ptr1.i.i87 = getelementptr inbounds i32, ptr %dest.addr.0.i.i85, i64 1
  store i32 %15, ptr %dest.addr.0.i.i85, align 4, !tbaa !16
  %cmp.not.i10.i88 = icmp eq i32 %15, 0
  br i1 %cmp.not.i10.i88, label %invoke.cont10, label %while.cond.i.i83, !llvm.loop !23
...
while.cond.i.i110:                                ; preds = %while.cond.i.i110, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i109
  ...
  %34 = load i32, ptr %src.addr.0.i.i111, align 4, !tbaa !16
  %incdec.ptr1.i.i114 = getelementptr inbounds i32, ptr %dest.addr.0.i.i112, i64 1
  store i32 %34, ptr %dest.addr.0.i.i112, align 4, !tbaa !16
  %cmp.not.i.i115 = icmp eq i32 %34, 0
  br i1 %cmp.not.i.i115, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i, label %while.cond.i.i110, !llvm.loop !23
...
if.end.i123:                                      ; preds = %invoke.cont30
  store i32 0, ptr %_length.i.i124, align 8, !tbaa !24
  store i32 0, ptr %.pre, align 4, !tbaa !16
  %_length.i125 = getelementptr inbounds %class.CStringBase, ptr %39, i64 0, i32 1
  %40 = load i32, ptr %_length.i125, align 8, !tbaa !24
  %add.i.i126 = add nsw i32 %40, 1
  %41 = load i32, ptr %_capacity.i3.i, align 4, !tbaa !22
...
delete.notnull.i.i143:                            ; preds = %call.i.i.noexc145
  ...
  %.pre.i144 = load i32, ptr %_length.i.i124, align 8, !tbaa !24
...
if.end9.i.i132:                                   ; preds = %delete.notnull.i.i143, %call.i.i.noexc145
  ...
  store i32 0, ptr %arrayidx14.i.i134, align 4, !tbaa !16
  store i32 %add.i.i126, ptr %_capacity.i3.i, align 4, !tbaa !22
...
while.cond.i.i136:                                ; preds = %while.cond.i.i136, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i135
  ...
  %48 = load i32, ptr %src.addr.0.i.i137, align 4, !tbaa !16
  %incdec.ptr1.i.i140 = getelementptr inbounds i32, ptr %dest.addr.0.i.i138, i64 1
  store i32 %48, ptr %dest.addr.0.i.i138, align 4, !tbaa !16
  %cmp.not.i.i141 = icmp eq i32 %48, 0
  br i1 %cmp.not.i.i141, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i142, label %while.cond.i.i136, !llvm.loop !23

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i142:         ; preds = %while.cond.i.i136
  %49 = load i32, ptr %_length.i125, align 8, !tbaa !24
  store i32 %49, ptr %_length.i.i124, align 8, !tbaa !24
...
if.then37:                                        ; preds = %invoke.cont35
  store i32 0, ptr %_length.i.i124, align 8, !tbaa !24
  %51 = load ptr, ptr %AddExt.i, align 8, !tbaa !20
...
invoke.cont42:                                    ; preds = %if.end41
  %54 = load ptr, ptr %AddExt.i, align 8, !tbaa !20
...
_ZN11CStringBaseIwED2Ev.exit.i154:                ; preds = %delete.notnull.i.i153, %invoke.cont42
  %55 = load ptr, ptr %extInfo, align 8, !tbaa !20
...
_ZN11CArcExtInfoD2Ev.exit:                        ; preds = %_ZN11CStringBaseIwED2Ev.exit.i154, %delete.notnull.i3.i
  ...
  %56 = load i32, ptr %_size.i, align 4, !tbaa !25
...
invoke.cont.i:                                    ; preds = %while.cond.i.i.i
  ...
  store i32 %s.sroa.13.0102, ptr %_length.i.i, align 8, !tbaa !24
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load121 = load <4 x i32>, ptr %18, align 4, !tbaa !16
  ...
  store <4 x i32> %wide.load121, ptr %20, align 4, !tbaa !16
...
call.i.i.noexc.i55:                               ; preds = %call.i.noexc71
  ...
  store ptr %call.i.i4.i53, ptr %call.i72, align 8, !tbaa !20
  store i32 0, ptr %call.i.i4.i53, align 4, !tbaa !16
  store i32 %add.i.i.i49, ptr %_capacity.i.i56, align 4, !tbaa !22
...
while.cond.i.i.i58:                               ; preds = %call.i.i.noexc.i55, %while.cond.i.i.i58
  ...
  %33 = load i32, ptr %src.addr.0.i.i.i59, align 4, !tbaa !16
  %incdec.ptr1.i.i.i62 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i60, i64 1
  store i32 %33, ptr %dest.addr.0.i.i.i60, align 4, !tbaa !16
  %cmp.not.i.i.i63 = icmp eq i32 %33, 0
  br i1 %cmp.not.i.i.i63, label %invoke.cont.i64, label %while.cond.i.i.i58, !llvm.loop !23

invoke.cont.i64:                                  ; preds = %while.cond.i.i.i58
  %_length.i.i65 = getelementptr inbounds %class.CStringBase, ptr %call.i72, i64 0, i32 1
  store i32 %s.sroa.13.1, ptr %_length.i.i65, align 8, !tbaa !24
  invoke void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %destStrings)
...
call.i.i12.noexc.i:                               ; preds = %if.end9.i.i9.i
  ...
  store ptr %call.i.i1221.i, ptr %AddExt.i, align 8, !tbaa !20
  store i32 0, ptr %call.i.i1221.i, align 4, !tbaa !16
  store i32 %add.i.i7.i, ptr %_capacity.i10.i, align 4, !tbaa !22
...
while.cond.i.i14.i:                               ; preds = %while.cond.i.i14.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i13.i
  ...
  %13 = load i32, ptr %src.addr.0.i.i15.i, align 4, !tbaa !16
  %incdec.ptr1.i.i18.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i16.i, i64 1
  store i32 %13, ptr %dest.addr.0.i.i16.i, align 4, !tbaa !16
  %cmp.not.i.i19.i = icmp eq i32 %13, 0
  br i1 %cmp.not.i.i19.i, label %invoke.cont, label %while.cond.i.i14.i, !llvm.loop !23
...
entry._ZN7CBufferIhE11SetCapacityEm.exit_crit_edge.i: ; preds = %invoke.cont5
  %.pre.i31 = load ptr, ptr %_items.i.i, align 8, !tbaa !52
...
if.end.i.i29.if.end10.i.i_crit_edge:              ; preds = %if.end.i.i29
  %.pre = load ptr, ptr %_items.i.i, align 8, !tbaa !52
...
call.i.i.noexc32:                                 ; preds = %if.then3.i.i
  ...
  %.pre49 = load ptr, ptr %_items.i.i, align 8, !tbaa !52
...
invoke.cont12:                                    ; preds = %invoke.cont.i
  %20 = load ptr, ptr %_items.i.i34, align 8, !tbaa !26
  %21 = load i32, ptr %_size.i.i, align 4, !tbaa !25
  ...
  store i32 %inc.i.i, ptr %_size.i.i, align 4, !tbaa !25
  store ptr getelementptr inbounds ({ [4 x ptr] }, ptr @_ZTV7CBufferIhE, i64 0, inrange i32 0, i64 2), ptr %StartSignature.i, align 8, !tbaa !14
  %22 = load ptr, ptr %_items.i.i, align 8, !tbaa !52
...
_ZN13CObjectVectorI11CArcExtInfoED2Ev.exit.i:     ; preds = %_ZN7CBufferIhED2Ev.exit.i
  ...
  %25 = load ptr, ptr %Name.i, align 8, !tbaa !20
...
_ZN10CArcInfoExD2Ev.exit:                         ; preds = %_ZN13CObjectVectorI11CArcExtInfoED2Ev.exit.i, %delete.notnull.i3.i
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %26 = load i32, ptr @_ZL9g_NumArcs, align 4, !tbaa !5
...
if.end7.i:                                        ; preds = %for.cond.i
  ...
  br i1 %cmp9.i, label %if.end.i47, label %for.cond.i, !llvm.loop !54
...
for.cond.i50:                                     ; preds = %if.end7.i54, %if.end.i47
  ...
  %4 = load i32, ptr %p.0.i52, align 4, !tbaa !16
...
if.end7.i54:                                      ; preds = %for.cond.i50
  ...
  br i1 %cmp9.i55, label %if.end.i65, label %for.cond.i50, !llvm.loop !54
...
for.cond.i68:                                     ; preds = %if.end7.i72, %if.end.i65
  ...
  %6 = load i32, ptr %p.0.i70, align 4, !tbaa !16
...
if.end7.i72:                                      ; preds = %for.cond.i68
  ...
  br i1 %cmp9.i73, label %cleanup26, label %for.cond.i68, !llvm.loop !54
...
if.end8:                                          ; preds = %entry
  ...
  store ptr %call.i.i33, ptr %agg.result, align 8, !tbaa !20
  store i32 0, ptr %call.i.i33, align 4, !tbaa !16
