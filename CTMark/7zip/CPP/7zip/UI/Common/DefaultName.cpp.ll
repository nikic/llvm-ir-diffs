; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Common/DefaultName.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/UI/Common/DefaultName.cpp"
...
entry:
  ...
  %_length.i53.i = getelementptr inbounds %class.CStringBase, ptr %fileName, i64 0, i32 1
  %1 = load i32, ptr %_length.i53.i, align 8, !tbaa !8, !noalias !5
...
if.then5.i:                                       ; preds = %if.then.i
  ...
  %call.i55.i = invoke noundef i32 @_Z21MyStringCompareNoCasePKwS0_(ptr noundef %4, ptr noundef %5)
          to label %invoke.cont.i unwind label %lpad.i, !noalias !5

invoke.cont.i:                                    ; preds = %if.then5.i
  %cmp8.i = icmp eq i32 %call.i55.i, 0
...
_ZN11CStringBaseIwED2Ev.exit.if.end14thread-pre-split_crit_edge.i: ; preds = %_ZN11CStringBaseIwED2Ev.exit.i
  %.pr.pre.i = load i32, ptr %_length.i53.i, align 8, !tbaa !8, !noalias !5
  br label %if.end14.i
...
if.end9.i.i.i.i:                                  ; preds = %if.then9.i
  %conv.i.i.i.i = zext i32 %add.i.i.i.i to i64
  %8 = icmp slt i32 %7, -1
  %9 = shl nuw nsw i64 %conv.i.i.i.i, 2
  %10 = select i1 %8, i64 -1, i64 %9
  %call.i.i.i56.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %10) #11
...
call.i.i.i.noexc.i:                               ; preds = %if.end9.i.i.i.i
  ...
  store ptr %call.i.i.i56.i, ptr %agg.result, align 8, !tbaa !14, !alias.scope !20
  store i32 0, ptr %call.i.i.i56.i, align 4, !tbaa !15, !noalias !20
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i.i:    ; preds = %call.i.i.i.noexc.i, %if.then9.i
  %11 = phi ptr [ null, %if.then9.i ], [ %call.i.i.i56.i, %call.i.i.i.noexc.i ]
...
lpad11.body.i:                                    ; preds = %lpad11.i, %delete.notnull.i.i.i, %lpad.i.i
  ...
  %isnull.i63.i = icmp eq ptr %20, null
  br i1 %isnull.i63.i, label %_ZN11CStringBaseIwED2Ev.exit65.i, label %delete.notnull.i64.i

delete.notnull.i64.i:                             ; preds = %lpad11.body.i
  call void @_ZdaPv(ptr noundef nonnull %20) #10
  br label %_ZN11CStringBaseIwED2Ev.exit65.i

_ZN11CStringBaseIwED2Ev.exit65.i:                 ; preds = %delete.notnull.i64.i, %lpad11.body.i
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp10.i) #9, !noalias !5
  br label %common.resume
...
if.then18.i:                                      ; preds = %_ZNK11CStringBaseIwE11ReverseFindEw.exit.i
  ...
  %_length2.i.i67.i = getelementptr inbounds %class.CStringBase, ptr %ref.tmp19.i, i64 0, i32 1
  ...
  %25 = load i32, ptr %_length2.i.i67.i, align 8, !tbaa !8, !noalias !28
  %add.i.i.i68.i = add nsw i32 %25, 1
  %cmp.i.i.i69.i = icmp eq i32 %add.i.i.i68.i, 0
  br i1 %cmp.i.i.i69.i, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i73.i, label %if.end9.i.i.i70.i

if.end9.i.i.i70.i:                                ; preds = %if.then18.i
  %conv.i.i.i72.i = zext i32 %add.i.i.i68.i to i64
  %26 = icmp slt i32 %25, -1
  %27 = shl nuw nsw i64 %conv.i.i.i72.i, 2
  %28 = select i1 %26, i64 -1, i64 %27
  %call.i.i.i88.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %28) #11
          to label %call.i.i.i.noexc87.i unwind label %lpad20.i, !noalias !5

call.i.i.i.noexc87.i:                             ; preds = %if.end9.i.i.i70.i
  %_capacity.i.i71.i = getelementptr inbounds %class.CStringBase, ptr %agg.result, i64 0, i32 2
  store ptr %call.i.i.i88.i, ptr %agg.result, align 8, !tbaa !14, !alias.scope !28
  store i32 0, ptr %call.i.i.i88.i, align 4, !tbaa !15, !noalias !28
  store i32 %add.i.i.i68.i, ptr %_capacity.i.i71.i, align 4, !tbaa !21, !alias.scope !28
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i73.i

_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i73.i:  ; preds = %call.i.i.i.noexc87.i, %if.then18.i
  %29 = phi ptr [ null, %if.then18.i ], [ %call.i.i.i88.i, %call.i.i.i.noexc87.i ]
  %30 = load ptr, ptr %ref.tmp19.i, align 8, !tbaa !14, !noalias !28
  br label %while.cond.i.i.i74.i

while.cond.i.i.i74.i:                             ; preds = %while.cond.i.i.i74.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i73.i
  %src.addr.0.i.i.i75.i = phi ptr [ %30, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i73.i ], [ %incdec.ptr.i.i.i77.i, %while.cond.i.i.i74.i ]
  %dest.addr.0.i.i.i76.i = phi ptr [ %29, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i73.i ], [ %incdec.ptr1.i.i.i78.i, %while.cond.i.i.i74.i ]
  %incdec.ptr.i.i.i77.i = getelementptr inbounds i32, ptr %src.addr.0.i.i.i75.i, i64 1
  %31 = load i32, ptr %src.addr.0.i.i.i75.i, align 4, !tbaa !15, !noalias !28
  %incdec.ptr1.i.i.i78.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i76.i, i64 1
  store i32 %31, ptr %dest.addr.0.i.i.i76.i, align 4, !tbaa !15, !noalias !28
  %cmp.not.i.i.i79.i = icmp eq i32 %31, 0
  br i1 %cmp.not.i.i.i79.i, label %_ZN11CStringBaseIwEC2ERKS0_.exit.i80.i, label %while.cond.i.i.i74.i, !llvm.loop !22

_ZN11CStringBaseIwEC2ERKS0_.exit.i80.i:           ; preds = %while.cond.i.i.i74.i
  %_length.i.i81.i = getelementptr inbounds %class.CStringBase, ptr %agg.result, i64 0, i32 1
  store i32 %25, ptr %_length.i.i81.i, align 8, !tbaa !8, !alias.scope !28
  %call.i82.i = invoke noundef nonnull align 8 dereferenceable(16) ptr @_ZN11CStringBaseIwEpLERKS0_(ptr noundef nonnull align 8 dereferenceable(16) %agg.result, ptr noundef nonnull align 8 dereferenceable(16) %addSubExtension)
          to label %invoke.cont21.i unwind label %lpad.i83.i

lpad.i83.i:                                       ; preds = %_ZN11CStringBaseIwEC2ERKS0_.exit.i80.i
  %32 = landingpad { ptr, i32 }
          cleanup
  %33 = load ptr, ptr %agg.result, align 8, !tbaa !14, !alias.scope !28
  %isnull.i.i84.i = icmp eq ptr %33, null
  br i1 %isnull.i.i84.i, label %lpad20.body.i, label %delete.notnull.i.i85.i

delete.notnull.i.i85.i:                           ; preds = %lpad.i83.i
  call void @_ZdaPv(ptr noundef nonnull %33) #10
  br label %lpad20.body.i

invoke.cont21.i:                                  ; preds = %_ZN11CStringBaseIwEC2ERKS0_.exit.i80.i
  %34 = load ptr, ptr %ref.tmp19.i, align 8, !tbaa !14, !noalias !5
  %isnull.i91.i = icmp eq ptr %34, null
  br i1 %isnull.i91.i, label %_ZN11CStringBaseIwED2Ev.exit93.i, label %delete.notnull.i92.i

delete.notnull.i92.i:                             ; preds = %invoke.cont21.i
  call void @_ZdaPv(ptr noundef nonnull %34) #10
  br label %_ZN11CStringBaseIwED2Ev.exit93.i

_ZN11CStringBaseIwED2Ev.exit93.i:                 ; preds = %delete.notnull.i92.i, %invoke.cont21.i
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp19.i) #9, !noalias !5
  br label %_ZL15GetDefaultName3RK11CStringBaseIwES2_S2_.exit

lpad20.i:                                         ; preds = %if.end9.i.i.i70.i
  %35 = landingpad { ptr, i32 }
          cleanup
  br label %lpad20.body.i

lpad20.body.i:                                    ; preds = %lpad20.i, %delete.notnull.i.i85.i, %lpad.i83.i
  %eh.lpad-body89.i = phi { ptr, i32 } [ %35, %lpad20.i ], [ %32, %delete.notnull.i.i85.i ], [ %32, %lpad.i83.i ]
  %36 = load ptr, ptr %ref.tmp19.i, align 8, !tbaa !14, !noalias !5
  %isnull.i94.i = icmp eq ptr %36, null
  br i1 %isnull.i94.i, label %_ZN11CStringBaseIwED2Ev.exit96.i, label %delete.notnull.i95.i

delete.notnull.i95.i:                             ; preds = %lpad20.body.i
  call void @_ZdaPv(ptr noundef nonnull %36) #10
  br label %_ZN11CStringBaseIwED2Ev.exit96.i

_ZN11CStringBaseIwED2Ev.exit96.i:                 ; preds = %delete.notnull.i95.i, %lpad20.body.i
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp19.i) #9, !noalias !5
  br label %common.resume

if.end24.i:                                       ; preds = %if.end7.i.i, %_ZNK11CStringBaseIwE11ReverseFindEw.exit.i, %if.end14.i
  %_length.i97.i = getelementptr inbounds %class.CStringBase, ptr %addSubExtension, i64 0, i32 1
  %37 = load i32, ptr %_length.i97.i, align 8, !tbaa !8, !noalias !5
  %cmp.i98.i = icmp eq i32 %37, 0
  %add.i.i.i100.i = add nsw i32 %21, 1
  %cmp.i.i.i101.i = icmp eq i32 %add.i.i.i100.i, 0
  br i1 %cmp.i98.i, label %if.then26.i, label %if.else.i
...
if.then26.i:                                      ; preds = %if.end24.i
  ...
  br i1 %cmp.i.i.i101.i, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i105.i, label %if.end9.i.i.i102.i

if.end9.i.i.i102.i:                               ; preds = %if.then26.i
  %_capacity.i.i103.i = getelementptr inbounds %class.CStringBase, ptr %agg.result, i64 0, i32 2
  %conv.i.i.i104.i = zext i32 %add.i.i.i100.i to i64
  %38 = icmp slt i32 %21, -1
  %39 = shl nuw nsw i64 %conv.i.i.i104.i, 2
  ...
  store i32 %add.i.i.i100.i, ptr %_capacity.i.i103.i, align 4, !tbaa !21, !alias.scope !32
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i105.i

_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i105.i: ; preds = %if.end9.i.i.i102.i, %if.then26.i
  %41 = phi ptr [ null, %if.then26.i ], [ %call.i.i.i.i, %if.end9.i.i.i102.i ]
  %42 = load ptr, ptr %fileName, align 8, !tbaa !14, !noalias !32
  br label %while.cond.i.i.i106.i

while.cond.i.i.i106.i:                            ; preds = %while.cond.i.i.i106.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i105.i
  %src.addr.0.i.i.i107.i = phi ptr [ %42, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i105.i ], [ %incdec.ptr.i.i.i109.i, %while.cond.i.i.i106.i ]
  %dest.addr.0.i.i.i108.i = phi ptr [ %41, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i105.i ], [ %incdec.ptr1.i.i.i110.i, %while.cond.i.i.i106.i ]
  %incdec.ptr.i.i.i109.i = getelementptr inbounds i32, ptr %src.addr.0.i.i.i107.i, i64 1
  %43 = load i32, ptr %src.addr.0.i.i.i107.i, align 4, !tbaa !15, !noalias !32
  %incdec.ptr1.i.i.i110.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i108.i, i64 1
  store i32 %43, ptr %dest.addr.0.i.i.i108.i, align 4, !tbaa !15, !noalias !32
  %cmp.not.i.i.i111.i = icmp eq i32 %43, 0
  br i1 %cmp.not.i.i.i111.i, label %_ZN11CStringBaseIwEC2ERKS0_.exit.i112.i, label %while.cond.i.i.i106.i, !llvm.loop !22

_ZN11CStringBaseIwEC2ERKS0_.exit.i112.i:          ; preds = %while.cond.i.i.i106.i
  %_length.i.i113.i = getelementptr inbounds %class.CStringBase, ptr %agg.result, i64 0, i32 1
  store i32 %21, ptr %_length.i.i113.i, align 8, !tbaa !8, !alias.scope !32
  %call.i114.i = invoke noundef nonnull align 8 dereferenceable(16) ptr @_ZN11CStringBaseIwEpLEPKw(ptr noundef nonnull align 8 dereferenceable(16) %agg.result, ptr noundef nonnull @.str)
          to label %_ZL15GetDefaultName3RK11CStringBaseIwES2_S2_.exit unwind label %lpad.i115.i

lpad.i115.i:                                      ; preds = %_ZN11CStringBaseIwEC2ERKS0_.exit.i112.i
  %44 = landingpad { ptr, i32 }
          cleanup
  %45 = load ptr, ptr %agg.result, align 8, !tbaa !14, !alias.scope !32
  %isnull.i.i116.i = icmp eq ptr %45, null
  br i1 %isnull.i.i116.i, label %common.resume, label %delete.notnull.i.i117.i

delete.notnull.i.i117.i:                          ; preds = %lpad.i115.i
  call void @_ZdaPv(ptr noundef nonnull %45) #10
  br label %common.resume

common.resume:                                    ; preds = %delete.notnull.i, %lpad, %_ZN11CStringBaseIwED2Ev.exit62.i, %_ZN11CStringBaseIwED2Ev.exit65.i, %_ZN11CStringBaseIwED2Ev.exit96.i, %lpad.i115.i, %delete.notnull.i.i117.i, %lpad.i136.i, %delete.notnull.i.i138.i
  %common.resume.op = phi { ptr, i32 } [ %44, %delete.notnull.i.i117.i ], [ %44, %lpad.i115.i ], [ %52, %delete.notnull.i.i138.i ], [ %52, %lpad.i136.i ], [ %eh.lpad-body89.i, %_ZN11CStringBaseIwED2Ev.exit96.i ], [ %eh.lpad-body.i, %_ZN11CStringBaseIwED2Ev.exit65.i ], [ %17, %_ZN11CStringBaseIwED2Ev.exit62.i ], [ %66, %lpad ], [ %66, %delete.notnull.i ]
...
if.else.i:                                        ; preds = %if.end24.i
  ...
  br i1 %cmp.i.i.i101.i, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i126.i, label %if.end9.i.i.i122.i

if.end9.i.i.i122.i:                               ; preds = %if.else.i
  %_capacity.i.i123.i = getelementptr inbounds %class.CStringBase, ptr %agg.result, i64 0, i32 2
  %conv.i.i.i124.i = zext i32 %add.i.i.i100.i to i64
  %46 = icmp slt i32 %21, -1
  %47 = shl nuw nsw i64 %conv.i.i.i124.i, 2
  %48 = select i1 %46, i64 -1, i64 %47
  %call.i.i.i125.i = call noalias noundef nonnull ptr @_Znam(i64 noundef %48) #11, !noalias !36
  store ptr %call.i.i.i125.i, ptr %agg.result, align 8, !tbaa !14, !alias.scope !36
  store i32 0, ptr %call.i.i.i125.i, align 4, !tbaa !15, !noalias !36
  store i32 %add.i.i.i100.i, ptr %_capacity.i.i123.i, align 4, !tbaa !21, !alias.scope !36
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i126.i

_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i126.i: ; preds = %if.end9.i.i.i122.i, %if.else.i
  %49 = phi ptr [ null, %if.else.i ], [ %call.i.i.i125.i, %if.end9.i.i.i122.i ]
  %50 = load ptr, ptr %fileName, align 8, !tbaa !14, !noalias !36
  br label %while.cond.i.i.i127.i

while.cond.i.i.i127.i:                            ; preds = %while.cond.i.i.i127.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i126.i
  %src.addr.0.i.i.i128.i = phi ptr [ %50, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i126.i ], [ %incdec.ptr.i.i.i130.i, %while.cond.i.i.i127.i ]
  %dest.addr.0.i.i.i129.i = phi ptr [ %49, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i126.i ], [ %incdec.ptr1.i.i.i131.i, %while.cond.i.i.i127.i ]
  %incdec.ptr.i.i.i130.i = getelementptr inbounds i32, ptr %src.addr.0.i.i.i128.i, i64 1
  %51 = load i32, ptr %src.addr.0.i.i.i128.i, align 4, !tbaa !15, !noalias !36
  %incdec.ptr1.i.i.i131.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i129.i, i64 1
  store i32 %51, ptr %dest.addr.0.i.i.i129.i, align 4, !tbaa !15, !noalias !36
  %cmp.not.i.i.i132.i = icmp eq i32 %51, 0
  br i1 %cmp.not.i.i.i132.i, label %_ZN11CStringBaseIwEC2ERKS0_.exit.i133.i, label %while.cond.i.i.i127.i, !llvm.loop !22

_ZN11CStringBaseIwEC2ERKS0_.exit.i133.i:          ; preds = %while.cond.i.i.i127.i
  %_length.i.i134.i = getelementptr inbounds %class.CStringBase, ptr %agg.result, i64 0, i32 1
  store i32 %21, ptr %_length.i.i134.i, align 8, !tbaa !8, !alias.scope !36
  %call.i135.i = invoke noundef nonnull align 8 dereferenceable(16) ptr @_ZN11CStringBaseIwEpLERKS0_(ptr noundef nonnull align 8 dereferenceable(16) %agg.result, ptr noundef nonnull align 8 dereferenceable(16) %addSubExtension)
          to label %_ZL15GetDefaultName3RK11CStringBaseIwES2_S2_.exit unwind label %lpad.i136.i

lpad.i136.i:                                      ; preds = %_ZN11CStringBaseIwEC2ERKS0_.exit.i133.i
  %52 = landingpad { ptr, i32 }
          cleanup
  %53 = load ptr, ptr %agg.result, align 8, !tbaa !14, !alias.scope !36
  %isnull.i.i137.i = icmp eq ptr %53, null
  br i1 %isnull.i.i137.i, label %common.resume, label %delete.notnull.i.i138.i

delete.notnull.i.i138.i:                          ; preds = %lpad.i136.i
  call void @_ZdaPv(ptr noundef nonnull %53) #10
  br label %common.resume

_ZL15GetDefaultName3RK11CStringBaseIwES2_S2_.exit: ; preds = %_ZN11CStringBaseIwED2Ev.exit59.i, %_ZN11CStringBaseIwED2Ev.exit93.i, %_ZN11CStringBaseIwEC2ERKS0_.exit.i112.i, %_ZN11CStringBaseIwEC2ERKS0_.exit.i133.i
  %call.i.i.i.i210 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #11
...
call.i.i.i.i2.noexc:                              ; preds = %_ZL15GetDefaultName3RK11CStringBaseIwES2_S2_.exit
  store <4 x i32> <i32 32, i32 10, i32 9, i32 0>, ptr %call.i.i.i.i210, align 4, !tbaa !15
  %54 = load ptr, ptr %agg.result, align 8, !tbaa !14
  %55 = load i32, ptr %54, align 4, !tbaa !15
  %cmp.not26.i.i = icmp eq i32 %55, 0
  br i1 %cmp.not26.i.i, label %nrvo.skipdtor, label %while.body.lr.ph.i.i

while.body.lr.ph.i.i:                             ; preds = %call.i.i.i.i2.noexc
  %sub.ptr.rhs.cast.i.i.i.i = ptrtoint ptr %call.i.i.i.i210 to i64
...
if.end.i.i.i.i:                                   ; preds = %while.body.i.i, %if.end5.i.i.i.i
  ...
  %p.011.i.i.i.i = phi ptr [ %add.ptr.i.i.i.i.i.i, %if.end5.i.i.i.i ], [ %call.i.i.i.i210, %while.body.i.i ]
...
if.end5.i.i.i.i:                                  ; preds = %if.end.i.i.i.i
  ...
  %cmp.i.i.i.i3 = icmp eq i32 %58, %56
  br i1 %cmp.i.i.i.i3, label %_ZNK11CStringBaseIwE4FindEw.exit.loopexit.i.i, label %if.end.i.i.i.i, !llvm.loop !37
...
_ZNK11CStringBaseIwE4FindEw.exit.thread.i.thread.i: ; preds = %if.end.i.i.i.i
  ...
  %61 = load i32, ptr %add.ptr.i.i.i125.i, align 4, !tbaa !15
  %cmp.not.i126.i = icmp eq i32 %61, 0
  br i1 %cmp.not.i126.i, label %nrvo.skipdtor, label %while.body.i.i.backedge
...
while.end.i.i:                                    ; preds = %_ZNK11CStringBaseIwE4FindEw.exit.thread.i.i
  br i1 %cmp2.i.not.i, label %if.then8.i.i, label %nrvo.skipdtor

if.then8.i.i:                                     ; preds = %while.end.i.i
  %sub.ptr.lhs.cast.i.i5 = ptrtoint ptr %spec.select.i.i to i64
  ...
  br i1 %cmp3.i.i.i, label %if.then4.i.i.i, label %nrvo.skipdtor
...
nrvo.skipdtor:                                    ; preds = %_ZNK11CStringBaseIwE4FindEw.exit.thread.i.thread.i, %if.then4.i.i.i, %if.then8.i.i, %while.end.i.i, %call.i.i.i.i2.noexc
  call void @_ZdaPv(ptr noundef nonnull %call.i.i.i.i210) #10
  ret void
}
...
if.end8:                                          ; preds = %entry
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %agg.result, i8 0, i64 16, i1 false)
  %call.i.i33 = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #11
  store ptr %call.i.i33, ptr %agg.result, align 8, !tbaa !14
...
if.end.i:                                         ; preds = %if.end8
  ...
  %call.i36 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %9) #11
...
_ZN11CStringBaseIwE11SetCapacityEi.exit:          ; preds = %if.end.i
  ...
  store ptr %call.i36, ptr %agg.result, align 8, !tbaa !14
...
for.cond.preheader.i.i:                           ; preds = %if.end.i.i
  ...
  %.pre.i.i = load ptr, ptr %this, align 8, !tbaa !14
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load11 = load <4 x i32>, ptr %9, align 4, !tbaa !15
  %10 = getelementptr inbounds i32, ptr %call.i.i, i64 %index
  store <4 x i32> %wide.load, ptr %10, align 4, !tbaa !15
  %11 = getelementptr inbounds i32, ptr %10, i64 4
  store <4 x i32> %wide.load11, ptr %11, align 4, !tbaa !15
  %index.next = add nuw i64 %index, 8
  %12 = icmp eq i64 %index.next, %n.vec
  br i1 %12, label %middle.block, label %vector.body, !llvm.loop !43
...
for.body.i.i.prol:                                ; preds = %for.body.i.i.preheader, %for.body.i.i.prol
  ...
  %15 = load i32, ptr %arrayidx.i.i.prol, align 4, !tbaa !15
  %arrayidx7.i.i.prol = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.i.i.prol
  store i32 %15, ptr %arrayidx7.i.i.prol, align 4, !tbaa !15
...
_ZN11CStringBaseIwE10GrowLengthEi.exit:           ; preds = %entry, %if.end.i, %if.end9.i.i
  ...
  %24 = load ptr, ptr %s, align 8, !tbaa !14
...
while.cond.i:                                     ; preds = %while.cond.i, %_ZN11CStringBaseIwE10GrowLengthEi.exit
  ...
  %25 = load i32, ptr %src.addr.0.i, align 4, !tbaa !15
  %incdec.ptr1.i = getelementptr inbounds i32, ptr %dest.addr.0.i, i64 1
  store i32 %25, ptr %dest.addr.0.i, align 4, !tbaa !15
...
_Z12MyStringCopyIwEPT_S1_PKS0_.exit:              ; preds = %while.cond.i
  %26 = load i32, ptr %_length, align 8, !tbaa !8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %9, align 4, !tbaa !15
  %10 = getelementptr inbounds i32, ptr %9, i64 4
  %wide.load10 = load <4 x i32>, ptr %10, align 4, !tbaa !15
  %11 = getelementptr inbounds i32, ptr %call.i.i, i64 %index
  store <4 x i32> %wide.load, ptr %11, align 4, !tbaa !15
  %12 = getelementptr inbounds i32, ptr %11, i64 4
  store <4 x i32> %wide.load10, ptr %12, align 4, !tbaa !15
  %index.next = add nuw i64 %index, 8
  %13 = icmp eq i64 %index.next, %n.vec
  br i1 %13, label %middle.block, label %vector.body, !llvm.loop !48
...
for.body.i.i.prol:                                ; preds = %for.body.i.i.preheader, %for.body.i.i.prol
  ...
  %prol.iter = phi i64 [ %prol.iter.next, %for.body.i.i.prol ], [ 0, %for.body.i.i.preheader ]
  %arrayidx.i.i.prol = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.i.i.prol
  %16 = load i32, ptr %arrayidx.i.i.prol, align 4, !tbaa !15
  %arrayidx7.i.i.prol = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.i.i.prol
  store i32 %16, ptr %arrayidx7.i.i.prol, align 4, !tbaa !15
  %indvars.iv.next.i.i.prol = add nuw nsw i64 %indvars.iv.i.i.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
...
for.body.i.i:                                     ; preds = %for.body.i.i.prol.loopexit, %for.body.i.i
  %indvars.iv.i.i = phi i64 [ %indvars.iv.next.i.i.3, %for.body.i.i ], [ %indvars.iv.i.i.unr, %for.body.i.i.prol.loopexit ]
  %arrayidx.i.i = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.i.i
  %18 = load i32, ptr %arrayidx.i.i, align 4, !tbaa !15
  %arrayidx7.i.i = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.i.i
  store i32 %18, ptr %arrayidx7.i.i, align 4, !tbaa !15
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1
  %arrayidx.i.i.1 = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.next.i.i
  %19 = load i32, ptr %arrayidx.i.i.1, align 4, !tbaa !15
  %arrayidx7.i.i.1 = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.next.i.i
  store i32 %19, ptr %arrayidx7.i.i.1, align 4, !tbaa !15
  %indvars.iv.next.i.i.1 = add nuw nsw i64 %indvars.iv.i.i, 2
  %arrayidx.i.i.2 = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.next.i.i.1
  %20 = load i32, ptr %arrayidx.i.i.2, align 4, !tbaa !15
  %arrayidx7.i.i.2 = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.next.i.i.1
  store i32 %20, ptr %arrayidx7.i.i.2, align 4, !tbaa !15
  %indvars.iv.next.i.i.2 = add nuw nsw i64 %indvars.iv.i.i, 3
  %arrayidx.i.i.3 = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.next.i.i.2
  %21 = load i32, ptr %arrayidx.i.i.3, align 4, !tbaa !15
  %arrayidx7.i.i.3 = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.next.i.i.2
  store i32 %21, ptr %arrayidx7.i.i.3, align 4, !tbaa !15
  %indvars.iv.next.i.i.3 = add nuw nsw i64 %indvars.iv.i.i, 4
  %exitcond.not.i.i.3 = icmp eq i64 %indvars.iv.next.i.i.3, %wide.trip.count.i.i
