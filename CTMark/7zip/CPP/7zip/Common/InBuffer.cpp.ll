; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/InBuffer.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/InBuffer.cpp"
...
entry:
  ...
  %0 = load ptr, ptr %_bufferBase, align 8
...
if.end5:                                          ; preds = %entry
  ...
  store ptr null, ptr %_bufferBase, align 8
  store i32 %spec.store.select, ptr %_bufferSize, align 8
  %conv = zext i32 %spec.store.select to i64
  %call = tail call ptr @MidAlloc(i64 noundef %conv)
  store ptr %call, ptr %_bufferBase, align 8
...
entry:
  ...
  %_wasFinished = getelementptr inbounds %class.CInBuffer, ptr %this, i64 0, i32 6
  %0 = load i8, ptr %_wasFinished, align 4
...
if.end:                                           ; preds = %entry
  ...
  %_bufferBase = getelementptr inbounds %class.CInBuffer, ptr %this, i64 0, i32 2
  %2 = load ptr, ptr %_bufferBase, align 8
...
invoke.cont:                                      ; preds = %if.end
  ...
  store i32 %call3, ptr %exception, align 4
  call void @__cxa_throw(ptr nonnull %exception, ptr nonnull @_ZTI18CInBufferException, ptr null) #9
  unreachable

if.end5:                                          ; preds = %if.end
  %7 = load ptr, ptr %_bufferBase, align 8
  store ptr %7, ptr %this, align 8
  %8 = load i32, ptr %numProcessedBytes, align 4
  %idx.ext = zext i32 %8 to i64
  %add.ptr = getelementptr inbounds i8, ptr %7, i64 %idx.ext
  %_bufferLimit = getelementptr inbounds %class.CInBuffer, ptr %this, i64 0, i32 1
  store ptr %add.ptr, ptr %_bufferLimit, align 8
  %cmp9 = icmp eq i32 %8, 0
  %frombool = zext i1 %cmp9 to i8
  store i8 %frombool, ptr %_wasFinished, align 4
...
entry:
  ...
  %0 = load i8, ptr %_wasFinished.i, align 4
...
if.end.i:                                         ; preds = %entry
  ...
  %5 = load i32, ptr %_bufferSize.i, align 8
...
invoke.cont.i:                                    ; preds = %if.end.i
  ...
  store i32 %call3.i, ptr %exception.i, align 4
...
_ZN9CInBuffer9ReadBlockEv.exit:                   ; preds = %if.end.i
  %7 = load ptr, ptr %_bufferBase.i, align 8
  store ptr %7, ptr %this, align 8
  %8 = load i32, ptr %numProcessedBytes.i, align 4
  ...
  store ptr %add.ptr.i, ptr %_bufferLimit.i, align 8
  %cmp9.i = icmp eq i32 %8, 0
  %frombool.i = zext i1 %cmp9.i to i8
  store i8 %frombool.i, ptr %_wasFinished.i, align 4
...
if.then:                                          ; preds = %entry, %_ZN9CInBuffer9ReadBlockEv.exit
  %_processedSize = getelementptr inbounds %class.CInBuffer, ptr %this, i64 0, i32 4
  %9 = load i64, ptr %_processedSize, align 8
  %inc = add i64 %9, 1
  store i64 %inc, ptr %_processedSize, align 8
  br label %return
