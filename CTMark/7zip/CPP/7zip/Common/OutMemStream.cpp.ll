; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/OutMemStream.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/OutMemStream.cpp"
...
entry:
  ...
  %0 = load ptr, ptr %_memManager, align 8
  ...
  store i8 1, ptr %LockMode, align 8
  ret void
}
...
entry:
  ...
  store i8 0, ptr %_state.i, align 1
  ...
  store i8 0, ptr %_unlockEventWasSent, align 1
  %_realStreamMode = getelementptr inbounds %class.COutMemStream, ptr %this, i64 0, i32 5
  store i8 0, ptr %_realStreamMode, align 8
  ...
  %2 = load ptr, ptr %_memManager.i, align 8
  ...
  store i8 1, ptr %LockMode.i, align 8
...
entry:
  ...
  %1 = load ptr, ptr %_memManager, align 8
...
cleanup.cont:                                     ; preds = %entry
  %3 = load ptr, ptr %_memManager, align 8
...
entry:
  ...
  %_realStreamMode = getelementptr inbounds %class.COutMemStream, ptr %this, i64 0, i32 5
  %0 = load i8, ptr %_realStreamMode, align 8
  %tobool.not = icmp eq i8 %0, 0
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %OutSeqStream = getelementptr inbounds %class.COutMemStream, ptr %this, i64 0, i32 13
  %1 = load ptr, ptr %OutSeqStream, align 8
...
if.end4:                                          ; preds = %if.then3, %if.end
  ...
  %cmp5.not179 = icmp eq i32 %size, 0
  br i1 %cmp5.not179, label %return, label %while.cond.preheader

while.cond.preheader:                             ; preds = %if.end4, %if.end45
  %data.addr.0.ph181 = phi ptr [ %add.ptr26, %if.end45 ], [ %data, %if.end4 ]
  %size.addr.0.ph180 = phi i32 [ %sub28, %if.end45 ], [ %size, %if.end4 ]
  %.pre = load i32, ptr %_size.i, align 4
  br label %while.cond

while.cond:                                       ; preds = %while.cond.preheader, %cleanup83
  %3 = phi i32 [ %.pre, %while.cond.preheader ], [ %inc.i, %cleanup83 ]
  %4 = load i64, ptr %_curBlockIndex, align 8
  %conv = trunc i64 %4 to i32
  %cmp8 = icmp sgt i32 %3, %conv
  br i1 %cmp8, label %if.then9, label %if.end46

if.then9:                                         ; preds = %while.cond
  %5 = load ptr, ptr %_items.i113, align 8
  %sext = shl i64 %4, 32
  %idxprom.i = ashr exact i64 %sext, 32
  %arrayidx.i = getelementptr inbounds ptr, ptr %5, i64 %idxprom.i
  %6 = load ptr, ptr %arrayidx.i, align 8
  %7 = load i64, ptr %_curBlockPos, align 8
  %add.ptr = getelementptr inbounds i8, ptr %6, i64 %7
  %8 = load ptr, ptr %_memManager50, align 8
  %_blockSize.i = getelementptr inbounds %class.CMemBlockManager, ptr %8, i64 0, i32 1
  %9 = load i64, ptr %_blockSize.i, align 8
  %sub = sub i64 %9, %7
  %conv17 = zext i32 %size.addr.0.ph180 to i64
  %spec.select = call i64 @llvm.umin.i64(i64 %sub, i64 %conv17)
  call void @llvm.memmove.p0.p0.i64(ptr align 1 %add.ptr, ptr align 1 %data.addr.0.ph181, i64 %spec.select, i1 false)
  %.pre152 = trunc i64 %spec.select to i32
  br i1 %cmp.not, label %if.end25, label %if.then23

if.then23:                                        ; preds = %if.then9
  %10 = load i32, ptr %processedSize, align 4
  %add = add i32 %10, %.pre152
  store i32 %add, ptr %processedSize, align 4
  br label %if.end25

if.end25:                                         ; preds = %if.then9, %if.then23
  %add.ptr26 = getelementptr inbounds i8, ptr %data.addr.0.ph181, i64 %spec.select
  %sub28 = sub i32 %size.addr.0.ph180, %.pre152
  %11 = load i64, ptr %_curBlockPos, align 8
  %add30 = add i64 %11, %spec.select
  store i64 %add30, ptr %_curBlockPos, align 8
  %12 = load i64, ptr %_curBlockIndex, align 8
  %13 = load ptr, ptr %_memManager50, align 8
  %_blockSize.i.i = getelementptr inbounds %class.CMemBlockManager, ptr %13, i64 0, i32 1
  %14 = load i64, ptr %_blockSize.i.i, align 8
  %mul.i = mul i64 %14, %12
...
if.then34:                                        ; preds = %if.end25
  store i64 %add.i, ptr %TotalSize, align 8
  br label %if.end37
...
if.then42:                                        ; preds = %if.end37
  %inc = add i64 %12, 1
  store i64 %inc, ptr %_curBlockIndex, align 8
  store i64 0, ptr %_curBlockPos, align 8
  br label %if.end45

if.end45:                                         ; preds = %if.then42, %if.end37
  %cmp5.not = icmp eq i32 %sub28, 0
  br i1 %cmp5.not, label %return, label %while.cond.preheader

if.end46:                                         ; preds = %while.cond
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %events) #11
  store ptr %StopWritingEvent, ptr %events, align 16
  store ptr %WriteToRealStreamEvent, ptr %arrayinit.element, align 8
  %16 = load ptr, ptr %_memManager50, align 8
  %Semaphore = getelementptr inbounds %class.CMemBlockManagerMt, ptr %16, i64 0, i32 2
  store ptr %Semaphore, ptr %arrayinit.element49, align 16
  %17 = load i8, ptr %LockMode, align 8
  ...
  switch i32 %call54, label %cleanup83.thread [
    i32 0, label %sw.bb
    i32 1, label %sw.bb55
    i32 2, label %cleanup83
  ]

sw.bb:                                            ; preds = %if.end46
  %StopWriteResult = getelementptr inbounds %class.COutMemStream, ptr %this, i64 0, i32 10
  %18 = load i32, ptr %StopWriteResult, align 8
  br label %cleanup83.thread

sw.bb55:                                          ; preds = %if.end46
  store i8 1, ptr %_realStreamMode, align 8
  %19 = load ptr, ptr %_memManager50, align 8
  %_blockSize.i.i112 = getelementptr inbounds %class.CMemBlockManager, ptr %19, i64 0, i32 1
  %20 = load i64, ptr %_blockSize.i.i112, align 8
  %OutSeqStream.i = getelementptr inbounds %class.COutMemStream, ptr %this, i64 0, i32 13
  %21 = load ptr, ptr %OutSeqStream.i, align 8
  %call3.i = call noundef i32 @_ZNK10CMemBlocks13WriteToStreamEmP20ISequentialOutStream(ptr noundef nonnull align 8 dereferenceable(40) %Blocks, i64 noundef %20, ptr noundef %21)
...
cleanup.cont:                                     ; preds = %sw.bb55
  %22 = load ptr, ptr %_memManager50, align 8
  call void @_ZN14CMemLockBlocks4FreeEP18CMemBlockManagerMt(ptr noundef nonnull align 8 dereferenceable(41) %Blocks, ptr noundef %22)
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %processedSize2) #11
  %23 = load ptr, ptr %OutSeqStream.i, align 8
  %vtable63 = load ptr, ptr %23, align 8
  %vfn64 = getelementptr inbounds ptr, ptr %vtable63, i64 5
  %24 = load ptr, ptr %vfn64, align 8
  %call65 = call noundef i32 %24(ptr noundef nonnull align 8 dereferenceable(8) %23, ptr noundef %data.addr.0.ph181, i32 noundef %size.addr.0.ph180, ptr noundef nonnull %processedSize2)
  br i1 %cmp.not, label %if.end69, label %if.then67

if.then67:                                        ; preds = %cleanup.cont
  %25 = load i32, ptr %processedSize2, align 4
  %26 = load i32, ptr %processedSize, align 4
  %add68 = add i32 %26, %25
  store i32 %add68, ptr %processedSize, align 4
  br label %if.end69
...
cleanup83.thread:                                 ; preds = %if.end46, %sw.bb55, %if.end69, %sw.bb
  %retval.2.ph = phi i32 [ %18, %sw.bb ], [ %call65, %if.end69 ], [ %call3.i, %sw.bb55 ], [ -2147467259, %if.end46 ]
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %events) #11
  br label %return

cleanup83:                                        ; preds = %if.end46
  %27 = load ptr, ptr %_memManager50, align 8
  %call75 = call noundef ptr @_ZN18CMemBlockManagerMt13AllocateBlockEv(ptr noundef nonnull align 8 dereferenceable(88) %27)
  call void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %Blocks)
  %28 = load ptr, ptr %_items.i113, align 8
  %29 = load i32, ptr %_size.i, align 4
  %idxprom.i115 = sext i32 %29 to i64
  %arrayidx.i116 = getelementptr inbounds ptr, ptr %28, i64 %idxprom.i115
  store ptr %call75, ptr %arrayidx.i116, align 8
  %inc.i = add nsw i32 %29, 1
  store i32 %inc.i, ptr %_size.i, align 4
  %30 = load ptr, ptr %_items.i113, align 8
  %arrayidx.i.i = getelementptr inbounds ptr, ptr %30, i64 %idxprom.i115
  %31 = load ptr, ptr %arrayidx.i.i, align 8
  %cmp80.not = icmp eq ptr %31, null
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %events) #11
  br i1 %cmp80.not, label %return, label %while.cond

return:                                           ; preds = %if.end45, %cleanup83, %if.end4, %cleanup83.thread, %if.then
  %retval.3 = phi i32 [ %call2, %if.then ], [ %retval.2.ph, %cleanup83.thread ], [ 0, %if.end4 ], [ -2147467259, %cleanup83 ], [ 0, %if.end45 ]
  ret i32 %retval.3
}
...
if.then20:                                        ; preds = %if.end18
  ...
  %3 = load i64, ptr %_curBlockIndex.i, align 8
  %_memManager.i = getelementptr inbounds %class.COutMemStream, ptr %this, i64 0, i32 2
  %4 = load ptr, ptr %_memManager.i, align 8
  %_blockSize.i.i = getelementptr inbounds %class.CMemBlockManager, ptr %4, i64 0, i32 1
  %5 = load i64, ptr %_blockSize.i.i, align 8
  %mul.i = mul i64 %5, %3
  %_curBlockPos.i = getelementptr inbounds %class.COutMemStream, ptr %this, i64 0, i32 4
  %6 = load i64, ptr %_curBlockPos.i, align 8
  %add.i = add i64 %mul.i, %6
  store i64 %add.i, ptr %newPosition, align 8
  br label %return
...
if.end6:                                          ; preds = %entry
  %TotalSize = getelementptr inbounds %class.COutMemStream, ptr %this, i64 0, i32 12, i32 0, i32 1
  store i64 %newSize, ptr %TotalSize, align 8
  br label %return
...
entry:
  store ptr getelementptr inbounds ({ [10 x ptr] }, ptr @_ZTV13COutMemStream, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %Blocks.i = getelementptr inbounds %class.COutMemStream, ptr %this, i64 0, i32 12
  %_memManager.i = getelementptr inbounds %class.COutMemStream, ptr %this, i64 0, i32 2
  %0 = load ptr, ptr %_memManager.i, align 8
...
_ZN9CMyComPtrI10IOutStreamED2Ev.exit:             ; preds = %invoke.cont, %if.then.i
  %OutSeqStream = getelementptr inbounds %class.COutMemStream, ptr %this, i64 0, i32 13
  %5 = load ptr, ptr %OutSeqStream, align 8
...
if.then.i3:                                       ; preds = %_ZN9CMyComPtrI10IOutStreamED2Ev.exit
...
_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit:   ; preds = %_ZN9CMyComPtrI10IOutStreamED2Ev.exit, %if.then.i3
  tail call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %Blocks.i) #11
  %WriteToRealStreamEvent = getelementptr inbounds %class.COutMemStream, ptr %this, i64 0, i32 9
  store ptr getelementptr inbounds ({ [3 x ptr] }, ptr @_ZTVN8NWindows16NSynchronization14CBaseEventWFMOE, i64 0, inrange i32 0, i64 2), ptr %WriteToRealStreamEvent, align 8
  ...
  %StopWritingEvent = getelementptr inbounds %class.COutMemStream, ptr %this, i64 0, i32 8
  store ptr getelementptr inbounds ({ [3 x ptr] }, ptr @_ZTVN8NWindows16NSynchronization14CBaseEventWFMOE, i64 0, inrange i32 0, i64 2), ptr %StopWritingEvent, align 8
  %_sync.i.i8 = getelementptr inbounds %class.COutMemStream, ptr %this, i64 0, i32 8, i32 0, i32 0, i32 1
  store ptr null, ptr %_sync.i.i8, align 8
  ret void
