...
if.end7.i:                                        ; preds = %for.cond.i
  ...
  br i1 %cmp9.i, label %if.end.i76, label %for.cond.i, !llvm.loop !15
...
for.cond.i79:                                     ; preds = %if.end7.i83, %if.end.i76
  ...
  %5 = load i32, ptr %p.0.i81, align 4, !tbaa !11
...
if.end7.i83:                                      ; preds = %for.cond.i79
  ...
  br i1 %cmp9.i84, label %invoke.cont2, label %for.cond.i79, !llvm.loop !15
...
invoke.cont10:                                    ; preds = %if.then
  ...
  %10 = load i32, ptr %_length.i100, align 8, !tbaa !14
...
invoke.cont12:                                    ; preds = %while.cond.i.i
  %19 = load i32, ptr %_length.i100, align 8, !tbaa !14
...
invoke.cont16:                                    ; preds = %_ZN11CStringBaseIwED2Ev.exit
  ...
  store i32 0, ptr %_length.i.i105, align 8, !tbaa !14
  store i32 0, ptr %call.i.i9697, align 4, !tbaa !11
  %_length.i106 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp14, i64 0, i32 1
  %21 = load i32, ptr %_length.i106, align 8, !tbaa !14
...
if.end9.i.i114:                                   ; preds = %if.end.i.i110
  ...
  store ptr %call.i.i112126, ptr %extension, align 8, !tbaa !5
  store i32 0, ptr %call.i.i112126, align 4, !tbaa !11
  store i32 %add.i.i107, ptr %_capacity.i95, align 4, !tbaa !13
...
while.cond.i.i118:                                ; preds = %while.cond.i.i118, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i117
  ...
  %27 = load i32, ptr %src.addr.0.i.i119, align 4, !tbaa !11
  %incdec.ptr1.i.i122 = getelementptr inbounds i32, ptr %dest.addr.0.i.i120, i64 1
  store i32 %27, ptr %dest.addr.0.i.i120, align 4, !tbaa !11
  %cmp.not.i.i123 = icmp eq i32 %27, 0
  br i1 %cmp.not.i.i123, label %invoke.cont18, label %while.cond.i.i118, !llvm.loop !17

invoke.cont18:                                    ; preds = %while.cond.i.i118
  %28 = load i32, ptr %_length.i106, align 8, !tbaa !14
  store i32 %28, ptr %_length.i.i105, align 8, !tbaa !14
...
if.end.i138:                                      ; preds = %if.else
  ...
  store i32 0, ptr %_length.i.i139, align 8, !tbaa !14
  store i32 0, ptr %call.i.i9394, align 4, !tbaa !11
...
if.end9.i.i148:                                   ; preds = %if.end.i.i144
  ...
  %.pre.i159 = load i32, ptr %_length.i.i139, align 8, !tbaa !14
  %40 = sext i32 %.pre.i159 to i64
  store ptr %call.i.i146160, ptr %name, align 8, !tbaa !5
  %arrayidx14.i.i150 = getelementptr inbounds i32, ptr %call.i.i146160, i64 %40
  store i32 0, ptr %arrayidx14.i.i150, align 4, !tbaa !11
  store i32 %add.i.i141, ptr %_capacity.i92, align 4, !tbaa !13
...
while.cond.i.i152:                                ; preds = %while.cond.i.i152, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i151
  ...
  %43 = load i32, ptr %src.addr.0.i.i153, align 4, !tbaa !11
  %incdec.ptr1.i.i156 = getelementptr inbounds i32, ptr %dest.addr.0.i.i154, i64 1
  store i32 %43, ptr %dest.addr.0.i.i154, align 4, !tbaa !11
  %cmp.not.i.i157 = icmp eq i32 %43, 0
  br i1 %cmp.not.i.i157, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i, label %while.cond.i.i152, !llvm.loop !17

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i:            ; preds = %while.cond.i.i152
  %44 = load i32, ptr %_length.i, align 8, !tbaa !14
  store i32 %44, ptr %_length.i.i139, align 8, !tbaa !14
  br label %if.end
...
for.cond.preheader.i.i.i:                         ; preds = %call.i.i.i.noexc
  ...
  %.pre.i.i.i = load ptr, ptr %name, align 8, !tbaa !5
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %53, align 4, !tbaa !11
  %54 = getelementptr inbounds i32, ptr %53, i64 4
  %wide.load202 = load <4 x i32>, ptr %54, align 4, !tbaa !11
  %55 = getelementptr inbounds i32, ptr %call.i.i.i167, i64 %index
  store <4 x i32> %wide.load, ptr %55, align 4, !tbaa !11
  %56 = getelementptr inbounds i32, ptr %55, i64 4
  store <4 x i32> %wide.load202, ptr %56, align 4, !tbaa !11
  %index.next = add nuw i64 %index, 8
  %57 = icmp eq i64 %index.next, %n.vec
  br i1 %57, label %middle.block, label %vector.body, !llvm.loop !21
...
for.body.i.i.i.prol:                              ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i.prol
  ...
  %60 = load i32, ptr %arrayidx.i.i.i.prol, align 4, !tbaa !11
  %arrayidx7.i.i.i.prol = getelementptr inbounds i32, ptr %call.i.i.i167, i64 %indvars.iv.i.i.i.prol
  store i32 %60, ptr %arrayidx7.i.i.i.prol, align 4, !tbaa !11
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  ...
  %65 = load i32, ptr %arrayidx.i.i.i.3, align 4, !tbaa !11
  %arrayidx7.i.i.i.3 = getelementptr inbounds i32, ptr %call.i.i.i167, i64 %indvars.iv.next.i.i.i.2
  store i32 %65, ptr %arrayidx7.i.i.i.3, align 4, !tbaa !11
...
_ZN11CStringBaseIwEpLEw.exit:                     ; preds = %if.end, %if.end.i.i165, %if.end9.i.i.i
  ...
  %68 = load ptr, ptr %name, align 8, !tbaa !5
...
invoke.cont37:                                    ; preds = %while.end
  %70 = load ptr, ptr %extension, align 8, !tbaa !5
...
_ZN11CStringBaseIwED2Ev.exit170:                  ; preds = %invoke.cont37, %delete.notnull.i169
  ...
  %71 = load ptr, ptr %name, align 8, !tbaa !5
...
ehcleanup41:                                      ; preds = %lpad28, %lpad36, %lpad22, %ehcleanup21, %ehcleanup
  ...
  %74 = load ptr, ptr %extension, align 8, !tbaa !5
...
ehcleanup42:                                      ; preds = %delete.notnull.i178, %ehcleanup41, %lpad6
  ...
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %extension) #8
  %75 = load ptr, ptr %name, align 8, !tbaa !5
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %9, align 4, !tbaa !11
  %10 = getelementptr inbounds i32, ptr %9, i64 4
  %wide.load10 = load <4 x i32>, ptr %10, align 4, !tbaa !11
  %11 = getelementptr inbounds i32, ptr %call.i.i, i64 %index
  store <4 x i32> %wide.load, ptr %11, align 4, !tbaa !11
  %12 = getelementptr inbounds i32, ptr %11, i64 4
  store <4 x i32> %wide.load10, ptr %12, align 4, !tbaa !11
  %index.next = add nuw i64 %index, 8
...
for.body.i.i.prol:                                ; preds = %for.body.i.i.preheader, %for.body.i.i.prol
  ...
  %16 = load i32, ptr %arrayidx.i.i.prol, align 4, !tbaa !11
  %arrayidx7.i.i.prol = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.i.i.prol
  store i32 %16, ptr %arrayidx7.i.i.prol, align 4, !tbaa !11
...
_ZN11CStringBaseIwE10GrowLengthEi.exit:           ; preds = %_Z11MyStringLenIwEiPKT_.exit, %if.end.i, %if.end9.i.i
  ...
  %24 = load ptr, ptr %this, align 8, !tbaa !5
...
while.cond.i:                                     ; preds = %while.cond.i, %_ZN11CStringBaseIwE10GrowLengthEi.exit
  ...
  %25 = load i32, ptr %src.addr.0.i, align 4, !tbaa !11
  %incdec.ptr1.i = getelementptr inbounds i32, ptr %dest.addr.0.i, i64 1
  store i32 %25, ptr %dest.addr.0.i, align 4, !tbaa !11
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %8, align 4, !tbaa !11
  %9 = getelementptr inbounds i32, ptr %8, i64 4
  %wide.load11 = load <4 x i32>, ptr %9, align 4, !tbaa !11
  %10 = getelementptr inbounds i32, ptr %call.i.i, i64 %index
  store <4 x i32> %wide.load, ptr %10, align 4, !tbaa !11
  %11 = getelementptr inbounds i32, ptr %10, i64 4
  store <4 x i32> %wide.load11, ptr %11, align 4, !tbaa !11
  %index.next = add nuw i64 %index, 8
...
for.body.i.i.prol:                                ; preds = %for.body.i.i.preheader, %for.body.i.i.prol
  ...
  %prol.iter = phi i64 [ %prol.iter.next, %for.body.i.i.prol ], [ 0, %for.body.i.i.preheader ]
  %arrayidx.i.i.prol = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.i.i.prol
  %15 = load i32, ptr %arrayidx.i.i.prol, align 4, !tbaa !11
  %arrayidx7.i.i.prol = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.i.i.prol
  store i32 %15, ptr %arrayidx7.i.i.prol, align 4, !tbaa !11
  %indvars.iv.next.i.i.prol = add nuw nsw i64 %indvars.iv.i.i.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
...
for.body.i.i:                                     ; preds = %for.body.i.i.prol.loopexit, %for.body.i.i
  %indvars.iv.i.i = phi i64 [ %indvars.iv.next.i.i.3, %for.body.i.i ], [ %indvars.iv.i.i.unr, %for.body.i.i.prol.loopexit ]
  %arrayidx.i.i = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.i.i
  %17 = load i32, ptr %arrayidx.i.i, align 4, !tbaa !11
  %arrayidx7.i.i = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.i.i
  store i32 %17, ptr %arrayidx7.i.i, align 4, !tbaa !11
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1
  %arrayidx.i.i.1 = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.next.i.i
  %18 = load i32, ptr %arrayidx.i.i.1, align 4, !tbaa !11
  %arrayidx7.i.i.1 = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.next.i.i
  store i32 %18, ptr %arrayidx7.i.i.1, align 4, !tbaa !11
  %indvars.iv.next.i.i.1 = add nuw nsw i64 %indvars.iv.i.i, 2
  %arrayidx.i.i.2 = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.next.i.i.1
  %19 = load i32, ptr %arrayidx.i.i.2, align 4, !tbaa !11
  %arrayidx7.i.i.2 = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.next.i.i.1
  store i32 %19, ptr %arrayidx7.i.i.2, align 4, !tbaa !11
  %indvars.iv.next.i.i.2 = add nuw nsw i64 %indvars.iv.i.i, 3
  %arrayidx.i.i.3 = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.next.i.i.2
  %20 = load i32, ptr %arrayidx.i.i.3, align 4, !tbaa !11
  %arrayidx7.i.i.3 = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.next.i.i.2
  store i32 %20, ptr %arrayidx7.i.i.3, align 4, !tbaa !11
  %indvars.iv.next.i.i.3 = add nuw nsw i64 %indvars.iv.i.i, 4
  %exitcond.not.i.i.3 = icmp eq i64 %indvars.iv.next.i.i.3, %wide.trip.count.i.i
...
_Z12MyStringCopyIwEPT_S1_PKS0_.exit:              ; preds = %while.cond.i
  %26 = load i32, ptr %_length, align 8, !tbaa !14
...
if.end8:                                          ; preds = %entry
  ...
  store i32 4, ptr %_capacity.i32, align 4, !tbaa !13
...
_ZN11CStringBaseIwE11SetCapacityEi.exit:          ; preds = %if.end.i
  ...
  store i32 %add.i, ptr %_capacity.i32, align 4, !tbaa !13
