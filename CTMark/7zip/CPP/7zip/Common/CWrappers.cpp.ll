; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/CWrappers.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/CWrappers.cpp"
...
entry:
  store ptr @_ZL16CompressProgressPvyy, ptr %this, align 8
  %Progress3 = getelementptr inbounds %struct.CCompressProgressWrap, ptr %this, i64 0, i32 1
  store ptr %progress, ptr %Progress3, align 8
...
entry:
  store ptr @_ZL6MyReadPvS_Pm, ptr %this, align 8
  %Stream = getelementptr inbounds %struct.CSeqInStreamWrap, ptr %this, i64 0, i32 1
  store ptr %stream, ptr %Stream, align 8
  ret void
}
...
entry:
  store ptr @_ZL7MyWritePvPKvm, ptr %this, align 8
...
entry:
  ...
  store ptr %stream, ptr %Stream, align 8
  store ptr @_ZL17InStreamWrap_ReadPvS_Pm, ptr %this, align 8
  %Seek = getelementptr inbounds %struct.ISeekInStream, ptr %this, i64 0, i32 1
  store ptr @_ZL17InStreamWrap_SeekPvPx7ESzSeek, ptr %Seek, align 8
...
sw.epilog:                                        ; preds = %entry
  ...
  %Res = getelementptr inbounds %struct.CSeekInStreamWrap, ptr %pp, i64 0, i32 2
  store i32 %call, ptr %Res, align 8
  %3 = load i64, ptr %newPosition, align 8
...
if.then:                                          ; preds = %entry
  ...
  store ptr %call, ptr %Lim, align 8
  store i32 %size, ptr %Size, align 8
  %2 = icmp ne ptr %call, null
  br label %if.end

if.end:                                           ; preds = %entry, %if.then
  %cmp6 = phi i1 [ true, %entry ], [ %2, %if.then ]
  ret i1 %cmp6
}
...
entry:
  %Buf = getelementptr inbounds %struct.CByteInBufWrap, ptr %this, i64 0, i32 3
  store ptr null, ptr %Buf, align 8
  store ptr @_ZL13Wrap_ReadBytePv, ptr %this, align 8
  ret void
}
...
if.then.i:                                        ; preds = %if.end
  ...
  %5 = load i64, ptr %Processed.i, align 8
...
cleanup.i:                                        ; preds = %if.then.i
  ...
  store ptr %incdec.ptr.i, ptr %Cur, align 8
...
if.end10.i:                                       ; preds = %cleanup.thread.i, %if.end
  ...
  store i8 1, ptr %Extra.i, align 8
  br label %cleanup
...
if.then:                                          ; preds = %entry
  ...
  store ptr %call, ptr %Buf, align 8
  store i64 %size, ptr %Size, align 8
  %2 = icmp ne ptr %call, null
  br label %if.end
...
entry:
  %Buf = getelementptr inbounds %struct.CByteOutBufWrap, ptr %this, i64 0, i32 3
  store ptr null, ptr %Buf, align 8
  store ptr @_ZL14Wrap_WriteBytePvh, ptr %this, align 8
  ret void
}
...
if.then.i:                                        ; preds = %if.then
  ...
  store i32 %call.i, ptr %Res.i, align 8
