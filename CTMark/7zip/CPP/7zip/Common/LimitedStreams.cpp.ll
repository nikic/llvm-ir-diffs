...
entry:
  ...
  store i32 0, ptr %realProcessedSize, align 4
...
if.then:                                          ; preds = %entry
  ...
  %4 = load i32, ptr %realProcessedSize, align 4
...
if.then8:                                         ; preds = %if.then
  ...
  store i8 1, ptr %_wasFinished, align 8
  br label %if.end9
...
if.then11:                                        ; preds = %if.end9
  store i32 %6, ptr %processedSize, align 4
  br label %if.end12
...
if.then11:                                        ; preds = %if.end7
  ...
  store i32 %conv12, ptr %size.addr, align 4
  br label %if.end13
...
if.end21:                                         ; preds = %if.then16, %if.end13
  ...
  %.pre = load i32, ptr %size.addr, align 4
  br i1 %cmp.not, label %if.end26, label %if.then25

if.then25:                                        ; preds = %if.end21
  store i32 %.pre, ptr %processedSize, align 4
  br label %if.end26
...
if.end26:                                         ; preds = %if.then25, %if.end21
  ...
  %12 = add <2 x i64> %9, %11
  store <2 x i64> %12, ptr %_virtPos, align 8
  br label %return
...
if.end7:                                          ; preds = %if.end
  ...
  %2 = load i32, ptr %_curRem, align 8
...
if.end27:                                         ; preds = %if.then21.if.end27_crit_edge, %if.then9
  ...
  store i32 %sub28, ptr %_curRem, align 8
...
land.rhs:                                         ; preds = %land.lhs.true
  ...
  %13 = load i32, ptr %arrayidx.i103, align 4
...
for.cond.cleanup:                                 ; preds = %land.rhs.1, %land.lhs.true.1, %land.lhs.true, %for.body, %land.rhs
  ...
  %16 = load i64, ptr %_virtPos, align 8
  %sub47 = sub i64 %15, %16
...
for.body:                                         ; preds = %land.rhs
  ...
  store i32 %add43, ptr %_curRem, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 64
  br i1 %exitcond.not, label %for.cond.cleanup, label %land.lhs.true.1
...
land.rhs.1:                                       ; preds = %land.lhs.true.1
  ...
  %17 = load i32, ptr %arrayidx.i103.1, align 4
...
for.body.1:                                       ; preds = %land.rhs.1
  ...
  store i32 %add43.1, ptr %_curRem, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  br label %land.lhs.true

if.then51:                                        ; preds = %for.cond.cleanup
  %conv52 = trunc i64 %sub47 to i32
  store i32 %conv52, ptr %_curRem, align 8
  br label %if.end62
...
if.then65:                                        ; preds = %if.end62
  store i32 %18, ptr %size.addr, align 4
  br label %if.end67
...
if.end67:                                         ; preds = %if.then65, %if.end62
  ...
  %.pre110 = load i32, ptr %size.addr, align 4
  br i1 %cmp.not, label %if.end72, label %if.then71

if.then71:                                        ; preds = %if.end67
  store i32 %.pre110, ptr %processedSize, align 4
  br label %if.end72

if.end72:                                         ; preds = %if.then71, %if.end67
  %conv73 = zext i32 %.pre110 to i64
  %22 = load <2 x i64>, ptr %_virtPos, align 8
  ...
  store <2 x i64> %25, ptr %_virtPos, align 8
  %26 = load i32, ptr %_curRem, align 8
  %sub80 = sub i32 %26, %.pre110
  store i32 %sub80, ptr %_curRem, align 8
  br label %return
...
sw.epilog:                                        ; preds = %sw.bb2, %sw.bb, %entry
  ...
  %2 = load i64, ptr %_virtPos4, align 8
  %cmp.not = icmp eq i64 %2, %newVirtPos.0
  br i1 %cmp.not, label %if.end, label %if.then

if.then:                                          ; preds = %sw.epilog
  %_curRem = getelementptr inbounds %class.CClusterInStream, ptr %this, i64 0, i32 4
  store i32 0, ptr %_curRem, align 8
  br label %if.end

if.end:                                           ; preds = %if.then, %sw.epilog
  store i64 %newVirtPos.0, ptr %_virtPos4, align 8
  %tobool.not = icmp eq ptr %newPosition, null
  br i1 %tobool.not, label %cleanup, label %if.then6

if.then6:                                         ; preds = %if.end
  store i64 %newVirtPos.0, ptr %newPosition, align 8
  br label %cleanup
...
invoke.cont2:                                     ; preds = %if.then.i.i
  %vtable.i.i26.pre = load ptr, ptr %inStream, align 8
...
cleanup.cont:                                     ; preds = %invoke.cont4
  store i64 0, ptr %_virtPos.i, align 8
  store ptr %call, ptr %resStream, align 8
  br label %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit

if.then.i.i.i:                                    ; preds = %invoke.cont4
  store i32 0, ptr %0, align 8
  store ptr getelementptr inbounds ({ [9 x ptr] }, ptr @_ZTV16CLimitedInStream, i64 0, inrange i32 0, i64 2), ptr %call, align 8
  %vtable.i.i.i = load ptr, ptr %inStream, align 8
...
if.end12:                                         ; preds = %if.then3
  ...
  store i32 %conv14, ptr %size.addr, align 4
  br label %if.end15
...
if.then17:                                        ; preds = %if.end15
  ...
  %.pre = load i32, ptr %size.addr, align 4
  %.pre32 = load i64, ptr %_size, align 8
  br label %if.end21
...
if.end21:                                         ; preds = %if.then17, %if.end15
  ...
  store i64 %sub, ptr %_size, align 8
...
cleanup.sink.split:                               ; preds = %if.end21, %if.then6
  ...
  store i32 %.sink, ptr %processedSize, align 4
  br label %cleanup
...
entry:
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV26CLimitedSequentialInStream, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %_stream = getelementptr inbounds %class.CLimitedSequentialInStream, ptr %this, i64 0, i32 3
...
entry:
  store ptr getelementptr inbounds ({ [9 x ptr] }, ptr @_ZTV16CLimitedInStream, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %_stream = getelementptr inbounds %class.CLimitedInStream, ptr %this, i64 0, i32 2
  %0 = load ptr, ptr %_stream, align 8
  %tobool.not.i = icmp eq ptr %0, null
...
entry:
  store ptr getelementptr inbounds ({ [9 x ptr] }, ptr @_ZTV16CClusterInStream, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
entry:
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV27CLimitedSequentialOutStream, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %_stream = getelementptr inbounds %class.CLimitedSequentialOutStream, ptr %this, i64 0, i32 3
  %0 = load ptr, ptr %_stream, align 8
  %tobool.not.i = icmp eq ptr %0, null
