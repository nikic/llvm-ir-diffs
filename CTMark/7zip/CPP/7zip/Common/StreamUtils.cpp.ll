; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/StreamUtils.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/StreamUtils.cpp"
...
entry:
  ...
  %0 = load i64, ptr %processedSize, align 8
...
while.body:                                       ; preds = %while.cond
  ...
  %3 = load i64, ptr %processedSize, align 8
  %add = add i64 %3, %conv2
  ...
  br i1 %cond15, label %while.cond, label %cleanup13
...
_Z10ReadStreamP19ISequentialInStreamPvPm.exit.thread: ; preds = %while.cond.i
  %cmp111 = icmp ne i64 %processedSize.0, %size
  %cond12 = zext i1 %cmp111 to i32
  br label %3
...
while.body.i:                                     ; preds = %while.cond.i
  ...
  br i1 %cond15.i, label %while.cond.i, label %_Z10ReadStreamP19ISequentialInStreamPvPm.exit

_Z10ReadStreamP19ISequentialInStreamPvPm.exit:    ; preds = %while.body.i
  %cmp.not = icmp eq i32 %retval.2.i, 0
  %cmp1 = icmp ne i64 %add.i, %size
  %cond = zext i1 %cmp1 to i32
  %spec.select = select i1 %cmp.not, i32 %cond, i32 %retval.2.i
  br label %3

3:                                                ; preds = %_Z10ReadStreamP19ISequentialInStreamPvPm.exit, %_Z10ReadStreamP19ISequentialInStreamPvPm.exit.thread
  %4 = phi i32 [ %cond12, %_Z10ReadStreamP19ISequentialInStreamPvPm.exit.thread ], [ %spec.select, %_Z10ReadStreamP19ISequentialInStreamPvPm.exit ]
  ret i32 %4
}
