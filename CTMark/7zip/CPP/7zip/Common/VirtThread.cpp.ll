; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/VirtThread.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/VirtThread.cpp"
...
entry:
  ...
  %0 = load i32, ptr %StartEvent, align 8
...
cleanup.cont:                                     ; preds = %entry, %_ZN8NWindows16NSynchronization15CAutoResetEvent18CreateIfNotCreatedEv.exit
  ...
  %1 = load i32, ptr %FinishedEvent, align 8
...
_ZN8NWindows16NSynchronization15CAutoResetEvent18CreateIfNotCreatedEv.exit27: ; preds = %cleanup.cont
  %call2.i26 = tail call i32 @AutoResetEvent_CreateNotSignaled(ptr noundef nonnull %FinishedEvent)
  %cmp4.not.not = icmp eq i32 %call2.i26, 0
...
return:                                           ; preds = %_ZN8NWindows16NSynchronization15CAutoResetEvent18CreateIfNotCreatedEv.exit27, %_ZN8NWindows16NSynchronization15CAutoResetEvent18CreateIfNotCreatedEv.exit, %cleanup.cont9, %if.end16
  %retval.2 = phi i32 [ %call2.i, %_ZN8NWindows16NSynchronization15CAutoResetEvent18CreateIfNotCreatedEv.exit ], [ %call2.i26, %_ZN8NWindows16NSynchronization15CAutoResetEvent18CreateIfNotCreatedEv.exit27 ], [ %call.i29, %if.end16 ], [ 0, %cleanup.cont9 ]
  ret i32 %retval.2
}
...
entry:
  ...
  %0 = load i8, ptr %ExitEvent, align 8
...
cleanup:                                          ; preds = %cleanup.lr.ph, %cleanup
  ...
  %2 = load i8, ptr %ExitEvent, align 8
...
entry:
  ...
  %ExitEvent = getelementptr inbounds %struct.CVirtThread, ptr %this, i64 0, i32 4
  store i8 1, ptr %ExitEvent, align 8
  %StartEvent = getelementptr inbounds %struct.CVirtThread, ptr %this, i64 0, i32 1
  %0 = load i32, ptr %StartEvent, align 8
...
if.end:                                           ; preds = %if.then, %entry
  %Thread = getelementptr inbounds %struct.CVirtThread, ptr %this, i64 0, i32 3
  %_created.i = getelementptr inbounds %struct.CVirtThread, ptr %this, i64 0, i32 3, i32 0, i32 1
  %1 = load i32, ptr %_created.i, align 8
