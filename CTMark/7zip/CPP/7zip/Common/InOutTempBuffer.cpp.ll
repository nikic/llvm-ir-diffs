; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/InOutTempBuffer.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/InOutTempBuffer.cpp"
...
entry:
  ...
  %call.i.i.i.i6 = invoke noalias noundef nonnull dereferenceable(4) ptr @_Znam(i64 noundef 4) #15
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %_capacity.i.i.i = getelementptr inbounds %class.CInOutTempBuffer, ptr %this, i64 0, i32 1, i32 0, i32 3, i32 2
  store ptr %call.i.i.i.i6, ptr %_unix_filename.i.i, align 8
  store i8 0, ptr %call.i.i.i.i6, align 1
  ...
  %call.i.i7 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #15
          to label %invoke.cont3 unwind label %lpad2

invoke.cont3:                                     ; preds = %invoke.cont
  %_capacity.i = getelementptr inbounds %class.CInOutTempBuffer, ptr %this, i64 0, i32 5, i32 2
  store ptr %call.i.i7, ptr %_tempFileName, align 8
...
delete.end:                                       ; preds = %delete.notnull, %entry
  %_tempFileName = getelementptr inbounds %class.CInOutTempBuffer, ptr %this, i64 0, i32 5
  %1 = load ptr, ptr %_tempFileName, align 8
...
if.end:                                           ; preds = %entry
  %_tempFileCreated = getelementptr inbounds %class.CInOutTempBuffer, ptr %this, i64 0, i32 6
  %0 = load i8, ptr %_tempFileCreated, align 8
...
if.then2:                                         ; preds = %if.end
  ...
  store ptr %call.i.i, ptr %tempDirPath, align 8
...
lpad:                                             ; preds = %if.end11, %if.end4, %if.then2
  %2 = landingpad { ptr, i32 }
          cleanup
  %3 = load ptr, ptr %tempDirPath, align 8
...
if.end4:                                          ; preds = %invoke.cont
  %4 = load ptr, ptr %tempDirPath, align 8
  %_tempFileName = getelementptr inbounds %class.CInOutTempBuffer, ptr %this, i64 0, i32 5
...
if.end11:                                         ; preds = %invoke.cont7
  %_outFile = getelementptr inbounds %class.CInOutTempBuffer, ptr %this, i64 0, i32 1
  %5 = load ptr, ptr %_tempFileName, align 8
...
if.end18:                                         ; preds = %invoke.cont15
  store i8 1, ptr %_tempFileCreated, align 8
  br label %cleanup
...
cleanup:                                          ; preds = %invoke.cont15, %invoke.cont7, %invoke.cont, %if.end18
  ...
  %6 = load ptr, ptr %tempDirPath, align 8
...
entry:
  %_bufPos = getelementptr inbounds %class.CInOutTempBuffer, ptr %this, i64 0, i32 3
  %0 = load i32, ptr %_bufPos, align 8
...
if.then:                                          ; preds = %entry
  ...
  %_crc = getelementptr inbounds %class.CInOutTempBuffer, ptr %this, i64 0, i32 9
  %2 = load i32, ptr %_crc, align 8
  %call5 = tail call i32 @CrcUpdate(i32 noundef %2, ptr noundef %data, i64 noundef %conv)
  store i32 %call5, ptr %_crc, align 8
  %3 = load i32, ptr %_bufPos, align 8
  %add = add i32 %3, %cond.i
  store i32 %add, ptr %_bufPos, align 8
  ...
  store i64 %add12, ptr %_size, align 8
  br label %if.end
...
cleanup.cont:                                     ; preds = %if.then2
  ...
  %4 = load i32, ptr %_bufPos, align 8
...
if.end14:                                         ; preds = %cleanup.cont, %if.end
  ...
  %_tempFileCreated = getelementptr inbounds %class.CInOutTempBuffer, ptr %this, i64 0, i32 6
  %5 = load i8, ptr %_tempFileCreated, align 8
...
if.then15:                                        ; preds = %if.end14
  ...
  store i32 4, ptr %_capacity.i.i.i, align 4
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTVN8NWindows5NFile3NIO7CInFileE, i64 0, inrange i32 0, i64 2), ptr %inFile, align 8
  %_tempFileName = getelementptr inbounds %class.CInOutTempBuffer, ptr %this, i64 0, i32 5
  %7 = load ptr, ptr %_tempFileName, align 8
...
while.cond.preheader:                             ; preds = %invoke.cont17
  ...
  %cmp21111 = icmp ult i64 %size.0, %8
  br i1 %cmp21111, label %while.body.lr.ph, label %cleanup52.thread
...
while.body:                                       ; preds = %while.body.lr.ph, %cleanup49
  %size.1113 = phi i64 [ %size.0, %while.body.lr.ph ], [ %add48, %cleanup49 ]
  %crc.1112 = phi i32 [ %crc.0, %while.body.lr.ph ], [ %call46, %cleanup49 ]
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %processed) #16
  %10 = load ptr, ptr %_buf22, align 8
...
if.end30:                                         ; preds = %if.end27
  %13 = load ptr, ptr %_buf22, align 8
...
cleanup.cont42:                                   ; preds = %invoke.cont35
  %15 = load ptr, ptr %_buf22, align 8
  %16 = load i32, ptr %processed, align 4
  %conv44 = zext i32 %16 to i64
  %call46 = invoke i32 @CrcUpdate(i32 noundef %crc.1112, ptr noundef %15, i64 noundef %conv44)
...
cleanup49:                                        ; preds = %cleanup.cont42
  %17 = load i32, ptr %processed, align 4
  %conv47 = zext i32 %17 to i64
  %add48 = add i64 %size.1113, %conv47
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %processed) #16
  %18 = load i64, ptr %_size, align 8
...
cleanup52.thread:                                 ; preds = %cleanup49, %while.cond.preheader, %while.end
  %crc.1110 = phi i32 [ %crc.1112, %while.end ], [ %crc.0, %while.cond.preheader ], [ %call46, %cleanup49 ]
  %size.1105 = phi i64 [ %size.1113, %while.end ], [ %size.0, %while.cond.preheader ], [ %add48, %cleanup49 ]
...
if.end58:                                         ; preds = %cleanup52.thread, %if.end14
  %crc.5 = phi i32 [ %crc.0, %if.end14 ], [ %crc.1110, %cleanup52.thread ]
  %size.5 = phi i64 [ %size.0, %if.end14 ], [ %size.1105, %cleanup52.thread ]
  %_crc = getelementptr inbounds %class.CInOutTempBuffer, ptr %this, i64 0, i32 9
  %19 = load i32, ptr %_crc, align 8
...
entry:
  ...
  %1 = load i32, ptr %_bufPos.i, align 8
...
if.then.i:                                        ; preds = %entry
  ...
  %3 = load i32, ptr %_crc.i, align 8
  %call5.i = tail call i32 @CrcUpdate(i32 noundef %3, ptr noundef %data, i64 noundef %conv.i)
  store i32 %call5.i, ptr %_crc.i, align 8
  %4 = load i32, ptr %_bufPos.i, align 8
  %add.i = add i32 %4, %cond.i.i
  store i32 %add.i, ptr %_bufPos.i, align 8
  ...
  store i64 %add12.i, ptr %_size.i, align 8
...
return.sink.split:                                ; preds = %_ZN16CInOutTempBuffer5WriteEPKvj.exit
  ...
  store i32 %size., ptr %processed, align 4
  br label %return
