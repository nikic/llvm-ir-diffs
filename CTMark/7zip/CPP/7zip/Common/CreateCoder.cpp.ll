...
if.then.i79:                                      ; preds = %if.then11
  %vtable.i80 = load ptr, ptr %call, align 8, !tbaa !35
...
if.then2.i85:                                     ; preds = %if.end.i83
  %vtable4.i86 = load ptr, ptr %13, align 8, !tbaa !35
...
if.then.i90:                                      ; preds = %if.else13
  %vtable.i91 = load ptr, ptr %call, align 8, !tbaa !35
...
if.then2.i96:                                     ; preds = %if.end.i94
  %vtable4.i97 = load ptr, ptr %16, align 8, !tbaa !35
...
if.then.i101:                                     ; preds = %if.then27
  %vtable.i102 = load ptr, ptr %call24, align 8, !tbaa !35
...
if.then2.i107:                                    ; preds = %if.end.i105
  %vtable4.i108 = load ptr, ptr %20, align 8, !tbaa !35
...
if.then.i113:                                     ; preds = %if.then32
  %vtable.i114 = load ptr, ptr %call24, align 8, !tbaa !35
...
if.then2.i119:                                    ; preds = %if.end.i117
  %vtable4.i120 = load ptr, ptr %24, align 8, !tbaa !35
...
if.then.i125:                                     ; preds = %if.else34
  %vtable.i126 = load ptr, ptr %call24, align 8, !tbaa !35
...
if.then2.i131:                                    ; preds = %if.end.i129
  %vtable4.i132 = load ptr, ptr %27, align 8, !tbaa !35
...
invoke.cont:                                      ; preds = %if.then46
  %vtable.i137 = load ptr, ptr %call47, align 8, !tbaa !35
...
if.then2.i142:                                    ; preds = %invoke.cont
  %vtable4.i143 = load ptr, ptr %31, align 8, !tbaa !35
...
if.then.i3:                                       ; preds = %lpad
  %vtable.i4 = load ptr, ptr %5, align 8, !tbaa !35
...
if.then.i3.i:                                     ; preds = %lpad.i
  %vtable.i4.i = load ptr, ptr %5, align 8, !tbaa !35
...
if.then.i14:                                      ; preds = %_ZN9CMyComPtrI15ICompressFilterED2Ev.exit8.i
  %vtable.i15 = load ptr, ptr %9, align 8, !tbaa !35
...
if.then.i7:                                       ; preds = %_ZN9CMyComPtrI15ICompressCoder2ED2Ev.exit
  %vtable.i8 = load ptr, ptr %4, align 8, !tbaa !35
...
if.then.i20:                                      ; preds = %_ZN9CMyComPtrI15ICompressCoder2ED2Ev.exit18
  %vtable.i21 = load ptr, ptr %13, align 8, !tbaa !35
