; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/ProgressMt.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/ProgressMt.cpp"
...
for.inc:                                          ; preds = %invoke.cont5
  %6 = load ptr, ptr %_items.i17, align 8
  %7 = load i32, ptr %_size.i18, align 4
  ...
  store i32 %inc.i21, ptr %_size.i18, align 4
...
invoke.cont9:                                     ; preds = %if.end.i, %if.then2.i
  store ptr %progress, ptr %this, align 8
...
entry:
  ...
  %1 = load ptr, ptr %_items.i6, align 8
  %arrayidx.i8 = getelementptr inbounds i64, ptr %1, i64 %idxprom.i
  store i64 0, ptr %arrayidx.i8, align 8
  %call.i.i.i = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull %CriticalSection) #9
  ret void
}
...
if.then:                                          ; preds = %entry
  ...
  store i64 %0, ptr %arrayidx.i, align 8
  %TotalInSize = getelementptr inbounds %class.CMtCompressProgressMixer, ptr %this, i64 0, i32 3
  %3 = load i64, ptr %TotalInSize, align 8
  %add = add i64 %sub, %3
  store i64 %add, ptr %TotalInSize, align 8
  br label %if.end
...
entry:
  ...
  %0 = load ptr, ptr %_progress, align 8
...
if.then.i:                                        ; preds = %entry
  ...
  %5 = load i64, ptr %TotalInSize.i, align 8
  %add.i = add i64 %sub.i, %5
  store i64 %add.i, ptr %TotalInSize.i, align 8
  br label %if.end.i
