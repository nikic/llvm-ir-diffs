; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/OutBuffer.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/OutBuffer.cpp"
...
if.end5:                                          ; preds = %entry
  ...
  store i32 %spec.store.select, ptr %_bufferSize, align 4
...
entry:
  ...
  store i32 0, ptr %_streamPos, align 8
  %_bufferSize = getelementptr inbounds %class.COutBuffer, ptr %this, i64 0, i32 4
  %0 = load i32, ptr %_bufferSize, align 4
  %_limitPos = getelementptr inbounds %class.COutBuffer, ptr %this, i64 0, i32 2
  store i32 %0, ptr %_limitPos, align 4
  ...
  store i8 0, ptr %_overDict, align 8
  ret void
}
...
entry:
  ...
  %add = add i64 %0, %conv
  %_streamPos = getelementptr inbounds %class.COutBuffer, ptr %this, i64 0, i32 3
  %2 = load i32, ptr %_streamPos, align 8
...
entry:
  ...
  %_streamPos = getelementptr inbounds %class.COutBuffer, ptr %this, i64 0, i32 3
  %0 = load i32, ptr %_streamPos, align 8
  %_pos = getelementptr inbounds %class.COutBuffer, ptr %this, i64 0, i32 1
  %1 = load i32, ptr %_pos, align 8
  ...
  %3 = load ptr, ptr %_buffer2, align 8
...
if.then:                                          ; preds = %entry
  ...
  %5 = load ptr, ptr %_buffer2, align 8
  %add.ptr11 = getelementptr inbounds i8, ptr %5, i64 %conv
  store ptr %add.ptr11, ptr %_buffer2, align 8
  %.pre53.pre = load i32, ptr %_streamPos, align 8
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %.pre53 = phi i32 [ %.pre53.pre, %if.then ], [ %0, %entry ]
  %_stream = getelementptr inbounds %class.COutBuffer, ptr %this, i64 0, i32 5
...
if.then13:                                        ; preds = %if.end
  ...
  %idx.ext18 = zext i32 %.pre53 to i64
  %add.ptr19 = getelementptr inbounds i8, ptr %7, i64 %idx.ext18
  %vtable = load ptr, ptr %6, align 8
  %vfn = getelementptr inbounds ptr, ptr %vtable, i64 5
  %8 = load ptr, ptr %vfn, align 8
  %call20 = call noundef i32 %8(ptr noundef nonnull align 8 dereferenceable(8) %6, ptr noundef %add.ptr19, i32 noundef %cond, ptr noundef nonnull %processedSize)
  %9 = load i32, ptr %processedSize, align 4
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %processedSize) #8
  %.pre = load i32, ptr %_streamPos, align 8
  br label %if.end21

if.end21:                                         ; preds = %if.then13, %if.end
  %10 = phi i32 [ %.pre, %if.then13 ], [ %.pre53, %if.end ]
  %size.0 = phi i32 [ %9, %if.then13 ], [ %cond, %if.end ]
  %result.0 = phi i32 [ %call20, %if.then13 ], [ 0, %if.end ]
  %add = add i32 %10, %size.0
  %11 = load i32, ptr %_bufferSize, align 4
  %cmp25 = icmp eq i32 %add, %11
  %spec.store.select = select i1 %cmp25, i32 0, i32 %add
  store i32 %spec.store.select, ptr %_streamPos, align 8
  %12 = load i32, ptr %_pos, align 8
  %cmp31 = icmp eq i32 %12, %11
  br i1 %cmp31, label %if.then32, label %if.end34

if.then32:                                        ; preds = %if.end21
  %_overDict = getelementptr inbounds %class.COutBuffer, ptr %this, i64 0, i32 8
  store i8 1, ptr %_overDict, align 8
  store i32 0, ptr %_pos, align 8
  br label %if.end34

if.end34:                                         ; preds = %if.then32, %if.end21
  %13 = phi i32 [ 0, %if.then32 ], [ %12, %if.end21 ]
  %cmp37 = icmp ugt i32 %spec.store.select, %13
  %cond43 = select i1 %cmp37, i32 %spec.store.select, i32 %11
  %_limitPos = getelementptr inbounds %class.COutBuffer, ptr %this, i64 0, i32 2
  store i32 %cond43, ptr %_limitPos, align 4
  %conv44 = zext i32 %size.0 to i64
  %_processedSize = getelementptr inbounds %class.COutBuffer, ptr %this, i64 0, i32 6
  %14 = load i64, ptr %_processedSize, align 8
  %add45 = add i64 %14, %conv44
  store i64 %add45, ptr %_processedSize, align 8
  ret i32 %result.0
}
...
entry:
  ...
  %.pre = load i32, ptr %_streamPos, align 8
  %.pre4 = load i32, ptr %_pos, align 8
  br label %while.cond

while.cond:                                       ; preds = %_ZN10COutBuffer9FlushPartEv.exit, %entry
  %0 = phi i32 [ %13, %_ZN10COutBuffer9FlushPartEv.exit ], [ %.pre4, %entry ]
...
if.then.i:                                        ; preds = %while.body
  ...
  %5 = load ptr, ptr %_buffer2.i, align 8
  %add.ptr11.i = getelementptr inbounds i8, ptr %5, i64 %conv.i
  store ptr %add.ptr11.i, ptr %_buffer2.i, align 8
  %.pre53.pre.i = load i32, ptr %_streamPos, align 8
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i, %while.body
  %.pre53.i = phi i32 [ %.pre53.pre.i, %if.then.i ], [ %1, %while.body ]
...
if.then13.i:                                      ; preds = %if.end.i
  ...
  store i32 0, ptr %processedSize.i, align 4
  %7 = load ptr, ptr %this, align 8
  %idx.ext18.i = zext i32 %.pre53.i to i64
  %add.ptr19.i = getelementptr inbounds i8, ptr %7, i64 %idx.ext18.i
  %vtable.i = load ptr, ptr %6, align 8
  %vfn.i = getelementptr inbounds ptr, ptr %vtable.i, i64 5
  %8 = load ptr, ptr %vfn.i, align 8
  %call20.i = call noundef i32 %8(ptr noundef nonnull align 8 dereferenceable(8) %6, ptr noundef %add.ptr19.i, i32 noundef %cond.i, ptr noundef nonnull %processedSize.i)
  %9 = load i32, ptr %processedSize.i, align 4
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %processedSize.i) #8
  %.pre.i = load i32, ptr %_streamPos, align 8
  br label %if.end21.i

if.end21.i:                                       ; preds = %if.then13.i, %if.end.i
  %10 = phi i32 [ %.pre.i, %if.then13.i ], [ %.pre53.i, %if.end.i ]
  %size.0.i = phi i32 [ %9, %if.then13.i ], [ %cond.i, %if.end.i ]
  %result.0.i = phi i32 [ %call20.i, %if.then13.i ], [ 0, %if.end.i ]
  %add.i = add i32 %size.0.i, %10
  %11 = load i32, ptr %_bufferSize.i, align 4
  %cmp25.i = icmp eq i32 %add.i, %11
  %spec.store.select.i = select i1 %cmp25.i, i32 0, i32 %add.i
  store i32 %spec.store.select.i, ptr %_streamPos, align 8
  %12 = load i32, ptr %_pos, align 8
  %cmp31.i = icmp eq i32 %12, %11
  br i1 %cmp31.i, label %if.then32.i, label %_ZN10COutBuffer9FlushPartEv.exit

if.then32.i:                                      ; preds = %if.end21.i
  store i8 1, ptr %_overDict.i, align 8
  store i32 0, ptr %_pos, align 8
  br label %_ZN10COutBuffer9FlushPartEv.exit

_ZN10COutBuffer9FlushPartEv.exit:                 ; preds = %if.end21.i, %if.then32.i
  %13 = phi i32 [ 0, %if.then32.i ], [ %12, %if.end21.i ]
  %cmp37.i = icmp ugt i32 %spec.store.select.i, %13
  %cond43.i = select i1 %cmp37.i, i32 %spec.store.select.i, i32 %11
  store i32 %cond43.i, ptr %_limitPos.i, align 4
  %conv44.i = zext i32 %size.0.i to i64
  %14 = load i64, ptr %_processedSize.i, align 8
  %add45.i = add i64 %14, %conv44.i
  store i64 %add45.i, ptr %_processedSize.i, align 8
...
entry:
  ...
  %.pre.i = load i32, ptr %_streamPos.i, align 8
  %.pre4.i = load i32, ptr %_pos.i, align 8
  br label %while.cond.i

while.cond.i:                                     ; preds = %_ZN10COutBuffer9FlushPartEv.exit.i, %entry
  %0 = phi i32 [ %13, %_ZN10COutBuffer9FlushPartEv.exit.i ], [ %.pre4.i, %entry ]
...
if.then.i.i:                                      ; preds = %while.body.i
  ...
  %5 = load ptr, ptr %_buffer2.i.i, align 8
  %add.ptr11.i.i = getelementptr inbounds i8, ptr %5, i64 %conv.i.i
  store ptr %add.ptr11.i.i, ptr %_buffer2.i.i, align 8
  %.pre53.pre.i.i = load i32, ptr %_streamPos.i, align 8
  br label %if.end.i.i

if.end.i.i:                                       ; preds = %if.then.i.i, %while.body.i
  %.pre53.i.i = phi i32 [ %.pre53.pre.i.i, %if.then.i.i ], [ %1, %while.body.i ]
...
if.then13.i.i:                                    ; preds = %if.end.i.i
  ...
  store i32 0, ptr %processedSize.i.i, align 4
  %7 = load ptr, ptr %this, align 8
  %idx.ext18.i.i = zext i32 %.pre53.i.i to i64
  ...
  %call20.i.i = call noundef i32 %8(ptr noundef nonnull align 8 dereferenceable(8) %6, ptr noundef %add.ptr19.i.i, i32 noundef %cond.i.i, ptr noundef nonnull %processedSize.i.i)
  %9 = load i32, ptr %processedSize.i.i, align 4
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %processedSize.i.i) #8
  %.pre.i.i = load i32, ptr %_streamPos.i, align 8
  br label %if.end21.i.i

if.end21.i.i:                                     ; preds = %if.then13.i.i, %if.end.i.i
  %10 = phi i32 [ %.pre.i.i, %if.then13.i.i ], [ %.pre53.i.i, %if.end.i.i ]
  %size.0.i.i = phi i32 [ %9, %if.then13.i.i ], [ %cond.i.i, %if.end.i.i ]
  %result.0.i.i = phi i32 [ %call20.i.i, %if.then13.i.i ], [ 0, %if.end.i.i ]
  %add.i.i = add i32 %size.0.i.i, %10
  %11 = load i32, ptr %_bufferSize.i.i, align 4
  %cmp25.i.i = icmp eq i32 %add.i.i, %11
...
_ZN10COutBuffer9FlushPartEv.exit.i:               ; preds = %if.then32.i.i, %if.end21.i.i
  %13 = phi i32 [ 0, %if.then32.i.i ], [ %12, %if.end21.i.i ]
  %cmp37.i.i = icmp ugt i32 %spec.store.select.i.i, %13
  %cond43.i.i = select i1 %cmp37.i.i, i32 %spec.store.select.i.i, i32 %11
  store i32 %cond43.i.i, ptr %_limitPos.i.i, align 4
  %conv44.i.i = zext i32 %size.0.i.i to i64
  %14 = load i64, ptr %_processedSize.i.i, align 8
  %add45.i.i = add i64 %14, %conv44.i.i
  store i64 %add45.i.i, ptr %_processedSize.i.i, align 8
...
invoke.cont:                                      ; preds = %_ZN10COutBuffer9FlushPartEv.exit.i
  ...
  store i32 %result.0.i.i, ptr %exception, align 4
