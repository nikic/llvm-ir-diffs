...
if.then:                                          ; preds = %entry
  ...
  %.pre53.pre = load i32, ptr %_streamPos, align 8, !tbaa !18
  br label %if.end
...
if.then13:                                        ; preds = %if.end
  ...
  %9 = load i32, ptr %processedSize, align 4, !tbaa !24
...
if.end21:                                         ; preds = %if.then13, %if.end
  ...
  %12 = load i32, ptr %_pos, align 8, !tbaa !20
...
if.end34:                                         ; preds = %if.then32, %if.end21
  ...
  %_processedSize = getelementptr inbounds %class.COutBuffer, ptr %this, i64 0, i32 6
  %14 = load i64, ptr %_processedSize, align 8, !tbaa !21
...
if.then.i:                                        ; preds = %while.body
  ...
  %.pre53.pre.i = load i32, ptr %_streamPos, align 8, !tbaa !18
  br label %if.end.i
...
if.then13.i:                                      ; preds = %if.end.i
  ...
  %9 = load i32, ptr %processedSize.i, align 4, !tbaa !24
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %processedSize.i) #8
  %.pre.i = load i32, ptr %_streamPos, align 8, !tbaa !18
  br label %if.end21.i
...
_ZN10COutBuffer9FlushPartEv.exit:                 ; preds = %if.end21.i, %if.then32.i
  ...
  %14 = load i64, ptr %_processedSize.i, align 8, !tbaa !21
...
if.then.i.i:                                      ; preds = %while.body.i
  ...
  %.pre53.pre.i.i = load i32, ptr %_streamPos.i, align 8, !tbaa !18
  br label %if.end.i.i
...
if.then13.i.i:                                    ; preds = %if.end.i.i
  ...
  %9 = load i32, ptr %processedSize.i.i, align 4, !tbaa !24
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %processedSize.i.i) #8
  %.pre.i.i = load i32, ptr %_streamPos.i, align 8, !tbaa !18
...
if.end21.i.i:                                     ; preds = %if.then13.i.i, %if.end.i.i
  ...
  %12 = load i32, ptr %_pos.i, align 8, !tbaa !20
...
_ZN10COutBuffer9FlushPartEv.exit.i:               ; preds = %if.then32.i.i, %if.end21.i.i
  ...
  %14 = load i64, ptr %_processedSize.i.i, align 8, !tbaa !21
