; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/MemBlocks.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/MemBlocks.cpp"
...
for.body.lr.ph:                                   ; preds = %for.cond.preheader
  %2 = load i64, ptr %_blockSize, align 8
...
for.body.epil:                                    ; preds = %for.cond.cleanup.loopexit.unr-lcssa, %for.body.epil
  ...
  store ptr %add.ptr.epil, ptr %p.028.epil, align 8
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit.unr-lcssa, %for.body.epil, %for.cond.preheader
  ...
  store ptr null, ptr %p.0.lcssa, align 8
  %6 = load ptr, ptr %this, align 8
  store ptr %6, ptr %_headFree.i, align 8
  br label %return
...
entry:
  ...
  store ptr null, ptr %_headFree, align 8
  ret void
}
...
entry:
  %_headFree = getelementptr inbounds %class.CMemBlockManager, ptr %this, i64 0, i32 2
  %0 = load ptr, ptr %_headFree, align 8
  %cmp = icmp eq ptr %0, null
  br i1 %cmp, label %return, label %if.end

if.end:                                           ; preds = %entry
  %1 = load ptr, ptr %0, align 8
  store ptr %1, ptr %_headFree, align 8
  br label %return
...
if.end:                                           ; preds = %entry
  ...
  store ptr %p, ptr %_headFree, align 8
  br label %return
...
entry:
  %cmp = icmp ugt i64 %numNoLockBlocks, %numBlocks
  br i1 %cmp, label %return, label %if.end
...
for.body.lr.ph.i:                                 ; preds = %for.cond.preheader.i
  %2 = load i64, ptr %_blockSize.i, align 8
  %3 = add i64 %numBlocks, -1
  %4 = add i64 %numBlocks, -2
  %xtraiter = and i64 %3, 7
  %5 = icmp ult i64 %4, 7
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i.new
  ...
  store ptr %add.ptr.i, ptr %p.028.i, align 8
  ...
  %niter.next.7 = add i64 %niter, 8
  %niter.ncmp.7 = icmp eq i64 %niter.next.7, %unroll_iter
  br i1 %niter.ncmp.7, label %if.end3.loopexit.unr-lcssa, label %for.body.i
...
for.body.i.epil:                                  ; preds = %if.end3.loopexit.unr-lcssa, %for.body.i.epil
  ...
  store ptr %add.ptr.i.epil, ptr %p.028.i.epil, align 8
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %if.end3, label %for.body.i.epil
...
if.end3:                                          ; preds = %if.end3.loopexit.unr-lcssa, %for.body.i.epil, %for.cond.preheader.i
  ...
  %6 = load ptr, ptr %this, align 8
  store ptr %6, ptr %_headFree.i.i, align 8
  ...
  store ptr null, ptr %_sync.i, align 8
  %conv = trunc i64 %sub to i32
  %or.cond = icmp slt i32 %conv, 1
  br i1 %or.cond, label %return, label %if.end.i13

if.end.i13:                                       ; preds = %if.end3
  store ptr %sync, ptr %_sync.i, align 8
  %_count.i = getelementptr inbounds %class.CMemBlockManagerMt, ptr %this, i64 0, i32 2, i32 1
  store i32 %conv, ptr %_count.i, align 8
  %_maxCount.i = getelementptr inbounds %class.CMemBlockManagerMt, ptr %this, i64 0, i32 2, i32 2
  store i32 %conv, ptr %_maxCount.i, align 4
  br label %return

return:                                           ; preds = %if.end7.i, %if.end.i, %if.end, %if.end.i13, %if.end3, %entry
  %retval.0 = phi i32 [ -2147024809, %entry ], [ 0, %if.end.i13 ], [ 1, %if.end3 ], [ -2147024882, %if.end ], [ -2147024882, %if.end.i ], [ -2147024882, %if.end7.i ]
  ret i32 %retval.0
}
...
if.end.i:                                         ; preds = %for.cond
  ...
  %1 = load i64, ptr %_blockSize.i.i, align 8
...
for.body.lr.ph.i.i:                               ; preds = %for.cond.preheader.i.i
  %2 = load i64, ptr %_blockSize.i.i, align 8
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i.new
  ...
  store ptr %add.ptr.i.i, ptr %p.028.i.i, align 8
  %add.ptr.i.i.1 = getelementptr inbounds i8, ptr %add.ptr.i.i, i64 %2
  store ptr %add.ptr.i.i.1, ptr %add.ptr.i.i, align 8
  %add.ptr.i.i.2 = getelementptr inbounds i8, ptr %add.ptr.i.i.1, i64 %2
  store ptr %add.ptr.i.i.2, ptr %add.ptr.i.i.1, align 8
  %add.ptr.i.i.3 = getelementptr inbounds i8, ptr %add.ptr.i.i.2, i64 %2
  store ptr %add.ptr.i.i.3, ptr %add.ptr.i.i.2, align 8
  %add.ptr.i.i.4 = getelementptr inbounds i8, ptr %add.ptr.i.i.3, i64 %2
  store ptr %add.ptr.i.i.4, ptr %add.ptr.i.i.3, align 8
  %add.ptr.i.i.5 = getelementptr inbounds i8, ptr %add.ptr.i.i.4, i64 %2
  store ptr %add.ptr.i.i.5, ptr %add.ptr.i.i.4, align 8
  %add.ptr.i.i.6 = getelementptr inbounds i8, ptr %add.ptr.i.i.5, i64 %2
  store ptr %add.ptr.i.i.6, ptr %add.ptr.i.i.5, align 8
  %add.ptr.i.i.7 = getelementptr inbounds i8, ptr %add.ptr.i.i.6, i64 %2
  store ptr %add.ptr.i.i.7, ptr %add.ptr.i.i.6, align 8
  %niter.next.7 = add i64 %niter, 8
  %niter.ncmp.7 = icmp eq i64 %niter.next.7, %unroll_iter
  br i1 %niter.ncmp.7, label %if.end3.i.loopexit.unr-lcssa, label %for.body.i.i
...
for.body.i.i.epil:                                ; preds = %if.end3.i.loopexit.unr-lcssa, %for.body.i.i.epil
  ...
  store ptr %add.ptr.i.i.epil, ptr %p.028.i.i.epil, align 8
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %if.end3.i, label %for.body.i.i.epil
...
if.end3.i:                                        ; preds = %if.end3.i.loopexit.unr-lcssa, %for.body.i.i.epil, %for.cond.preheader.i.i
  ...
  store ptr null, ptr %p.0.lcssa.i.i, align 8
  %6 = load ptr, ptr %this, align 8
  store ptr %6, ptr %_headFree.i.i.i, align 8
...
_ZN16CMemBlockManager9FreeBlockEPv.exit:          ; preds = %entry
  ...
  %0 = load ptr, ptr %_headFree.i, align 8
  store ptr %0, ptr %p, align 8
  store ptr %p, ptr %_headFree.i, align 8
  %call.i.i.i = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull %_criticalSection) #9
...
_ZN16CMemBlockManager9FreeBlockEPv.exit.i:        ; preds = %while.body
  ...
  %4 = load ptr, ptr %_headFree.i.i, align 8
  store ptr %4, ptr %3, align 8
  store ptr %3, ptr %_headFree.i.i, align 8
  %call.i.i.i.i = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull %_criticalSection.i) #9
  %5 = load ptr, ptr %_sync.i.i, align 8
  %call.i.i6.i = tail call i32 @pthread_mutex_lock(ptr noundef nonnull %5) #9
  %6 = load i32, ptr %_count.i.i, align 8
  %7 = load i32, ptr %_maxCount.i.i, align 4
...
if.then3.i.i:                                     ; preds = %_ZN16CMemBlockManager9FreeBlockEPv.exit.i
  %8 = load ptr, ptr %_sync.i.i, align 8
...
if.end5.i.i:                                      ; preds = %_ZN16CMemBlockManager9FreeBlockEPv.exit.i
  ...
  store i32 %add.i.i, ptr %_count.i.i, align 8
  %9 = load ptr, ptr %_sync.i.i, align 8
...
entry:
  %TotalSize = getelementptr inbounds %class.CMemBlocks, ptr %this, i64 0, i32 1
  %0 = load i64, ptr %TotalSize, align 8
  %_size.i = getelementptr inbounds %class.CBaseRecordVector, ptr %this, i64 0, i32 2
...
for.inc:                                          ; preds = %cleanup16
  ...
  br i1 %cmp.not, label %cleanup19, label %for.body
...
_ZN16CMemBlockManager9FreeBlockEPv.exit.i:        ; preds = %entry
  ...
  %2 = load i8, ptr %LockMode, align 8
  ...
  %3 = load ptr, ptr %_headFree.i.i, align 8
  store ptr %3, ptr %1, align 8
  store ptr %1, ptr %_headFree.i.i, align 8
  %call.i.i.i.i = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull %_criticalSection.i) #9
...
_ZN16CMemBlockManager9FreeBlockEPv.exit.i.i:      ; preds = %while.body
  %4 = load i8, ptr %LockMode.i, align 8
  %tobool.not.i = icmp eq i8 %4, 0
  %call.i.i.i.i = tail call i32 @pthread_mutex_lock(ptr noundef nonnull %_criticalSection.i.i) #9
  %5 = load ptr, ptr %_headFree.i.i.i, align 8
  store ptr %5, ptr %3, align 8
  store ptr %3, ptr %_headFree.i.i.i, align 8
...
if.then2.i.i:                                     ; preds = %_ZN16CMemBlockManager9FreeBlockEPv.exit.i.i
  ...
  %call.i.i6.i.i = tail call i32 @pthread_mutex_lock(ptr noundef nonnull %6) #9
  %7 = load i32, ptr %_count.i.i.i, align 8
  %8 = load i32, ptr %_maxCount.i.i.i, align 4
...
if.then3.i.i.i:                                   ; preds = %if.then2.i.i
  %9 = load ptr, ptr %_sync.i.i.i, align 8
...
if.end5.i.i.i:                                    ; preds = %if.then2.i.i
  ...
  store i32 %add.i.i.i, ptr %_count.i.i.i, align 8
  %10 = load ptr, ptr %_sync.i.i.i, align 8
...
_ZN14CMemLockBlocks9FreeBlockEiP18CMemBlockManagerMt.exit: ; preds = %while.body, %_ZN16CMemBlockManager9FreeBlockEPv.exit.i.i, %_ZN8NWindows16NSynchronization14CSemaphoreWFMO7ReleaseEi.exit.i.i
  ...
  store ptr null, ptr %arrayidx.i7.i, align 8
  tail call void @_ZN17CBaseRecordVector10DeleteBackEv(ptr noundef nonnull align 8 dereferenceable(32) %this)
...
entry:
  %LockMode = getelementptr inbounds %struct.CMemLockBlocks, ptr %this, i64 0, i32 1
  %0 = load i8, ptr %LockMode, align 8
...
if.end.i.i:                                       ; preds = %if.then
  %_sync.i.i = getelementptr inbounds %class.CMemBlockManagerMt, ptr %memManager, i64 0, i32 2, i32 0, i32 1
  %2 = load ptr, ptr %_sync.i.i, align 8
  %call.i.i.i = tail call i32 @pthread_mutex_lock(ptr noundef nonnull %2) #9
  %_count.i.i = getelementptr inbounds %class.CMemBlockManagerMt, ptr %memManager, i64 0, i32 2, i32 1
  %3 = load i32, ptr %_count.i.i, align 8
  %add.i.i = add nsw i32 %3, %1
  %_maxCount.i.i = getelementptr inbounds %class.CMemBlockManagerMt, ptr %memManager, i64 0, i32 2, i32 2
  %4 = load i32, ptr %_maxCount.i.i, align 4
...
_ZN18CMemBlockManagerMt19ReleaseLockedBlocksEi.exit: ; preds = %if.end.i.i
  %6 = load ptr, ptr %_sync.i.i, align 8
...
if.end8:                                          ; preds = %_ZN18CMemBlockManagerMt19ReleaseLockedBlocksEi.exit.thread, %if.then
  store i8 0, ptr %LockMode, align 8
  br label %return
...
entry:
  ...
  store i8 %0, ptr %LockMode2, align 8
...
if.then:                                          ; preds = %for.body
  ...
  %7 = load ptr, ptr %_items.i24, align 8
  %8 = load i32, ptr %_size.i25, align 4
  %idxprom.i26 = sext i32 %8 to i64
  %arrayidx.i27 = getelementptr inbounds ptr, ptr %7, i64 %idxprom.i26
  store ptr %6, ptr %arrayidx.i27, align 8
...
_ZN16CMemBlockManager9FreeBlockEPv.exit.i.i:      ; preds = %if.else
  %9 = load i8, ptr %LockMode, align 8
  %tobool.not.i = icmp eq i8 %9, 0
  %call.i.i.i.i = tail call i32 @pthread_mutex_lock(ptr noundef nonnull %_criticalSection.i.i) #9
  %10 = load ptr, ptr %_headFree.i.i.i, align 8
...
if.then2.i.i:                                     ; preds = %_ZN16CMemBlockManager9FreeBlockEPv.exit.i.i
  %11 = load ptr, ptr %_sync.i.i.i, align 8
  %call.i.i6.i.i = tail call i32 @pthread_mutex_lock(ptr noundef nonnull %11) #9
  %12 = load i32, ptr %_count.i.i.i, align 8
  %13 = load i32, ptr %_maxCount.i.i.i, align 4
  %cmp2.i.not.i.i = icmp slt i32 %12, %13
  br i1 %cmp2.i.not.i.i, label %if.end5.i.i.i, label %if.then3.i.i.i

if.then3.i.i.i:                                   ; preds = %if.then2.i.i
  %14 = load ptr, ptr %_sync.i.i.i, align 8
  br label %_ZN8NWindows16NSynchronization14CSemaphoreWFMO7ReleaseEi.exit.i.i

if.end5.i.i.i:                                    ; preds = %if.then2.i.i
  %add.i.i.i = add nsw i32 %12, 1
  store i32 %add.i.i.i, ptr %_count.i.i.i, align 8
  %15 = load ptr, ptr %_sync.i.i.i, align 8
