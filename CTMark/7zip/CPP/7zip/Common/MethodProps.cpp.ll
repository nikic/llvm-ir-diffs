; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/MethodProps.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/MethodProps.cpp"
...
if.then:                                          ; preds = %land.lhs.true, %land.lhs.true
  %1 = load i64, ptr %inSizeForReduce, align 8
...
if.end14:                                         ; preds = %if.end9.20, %if.end, %if.then, %if.end9, %if.end.1, %if.end9.1, %if.end.2, %if.end9.2, %if.end.3, %if.end9.3, %if.end.4, %if.end9.4, %if.end.5, %if.end9.5, %if.end.6, %if.end9.6, %if.end.7, %if.end9.7, %if.end.8, %if.end9.8, %if.end.9, %if.end9.9, %if.end.10, %if.end9.10, %if.end.11, %if.end9.11, %if.end.12, %if.end9.12, %if.end.13, %if.end9.13, %if.end.14, %if.end9.14, %if.end.15, %if.end9.15, %if.end.16, %if.end9.16, %if.end.17, %if.end9.17, %if.end.18, %if.end9.18, %if.end.19, %if.end9.19, %if.end.20, %land.lhs.true, %entry
  ...
  %vtable = load ptr, ptr %coder, align 8
...
invoke.cont16:                                    ; preds = %if.end14
  %4 = load ptr, ptr %setCoderProperties, align 8
...
if.then21:                                        ; preds = %invoke.cont16
  ...
  br i1 %cmp22.not, label %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit194.thread219, label %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit194.thread
...
invoke.cont26:                                    ; preds = %invoke.cont16
  ...
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CRecordVectorIjE, i64 0, inrange i32 0, i64 2), ptr %propIDs, align 8
...
arrayctor.cont:                                   ; preds = %arrayctor.loop
  %cmp35222 = icmp sgt i32 %2, 0
  br i1 %cmp35222, label %invoke.cont38.lr.ph, label %for.cond.cleanup
...
invoke.cont38.lr.ph:                              ; preds = %arrayctor.cont
  ...
  %wide.trip.count230 = zext i32 %2 to i64
...
invoke.cont38.us:                                 ; preds = %invoke.cont38.lr.ph, %invoke.cont44.us
  ...
  %12 = load ptr, ptr %arrayidx.i.i.us, align 8
...
invoke.cont41.us:                                 ; preds = %invoke.cont38.us
  ...
  %15 = load i32, ptr %_size.i174, align 4
  %idxprom.i.us = sext i32 %15 to i64
  %arrayidx.i.us = getelementptr inbounds i32, ptr %14, i64 %idxprom.i.us
  store i32 %13, ptr %arrayidx.i.us, align 4
  %16 = load i32, ptr %_size.i174, align 4
  %inc.i.us = add nsw i32 %16, 1
  store i32 %inc.i.us, ptr %_size.i174, align 4
...
invoke.cont44.us:                                 ; preds = %invoke.cont41.us
  ...
  br i1 %exitcond.not, label %for.cond.cleanup, label %invoke.cont38.us
...
for.cond.cleanup:                                 ; preds = %invoke.cont44.us, %if.end58, %invoke.cont29, %arrayctor.cont
  ...
  store ptr null, ptr %setCoderProperties62, align 8
  %vtable68 = load ptr, ptr %coder, align 8
...
invoke.cont38:                                    ; preds = %invoke.cont38.lr.ph, %if.end58
  %indvars.iv227 = phi i64 [ %indvars.iv.next228, %if.end58 ], [ 0, %invoke.cont38.lr.ph ]
  %21 = load ptr, ptr %_items.i.i, align 8
  %arrayidx.i.i = getelementptr inbounds ptr, ptr %21, i64 %indvars.iv227
...
invoke.cont41:                                    ; preds = %invoke.cont38
  ...
  %25 = load i32, ptr %_size.i174, align 4
  ...
  %26 = load i32, ptr %_size.i174, align 4
  %inc.i = add nsw i32 %26, 1
  store i32 %inc.i, ptr %_size.i174, align 4
  %arrayidx = getelementptr inbounds %"class.NWindows::NCOM::CPropVariant", ptr %10, i64 %indvars.iv227
...
if.then54:                                        ; preds = %if.then52
  store i32 %reducedDictionarySize.2, ptr %29, align 8
  br label %if.end58
...
if.end58:                                         ; preds = %if.then52, %if.then54, %if.then49, %invoke.cont44
  ...
  br i1 %exitcond231.not, label %for.cond.cleanup, label %invoke.cont38

invoke.cont74:                                    ; preds = %for.cond.cleanup
  %33 = load ptr, ptr %setCoderProperties62, align 8
  %_items.i.i175 = getelementptr inbounds %class.CBaseRecordVector, ptr %propIDs, i64 0, i32 3
  %34 = load ptr, ptr %_items.i.i175, align 8
  %vtable76 = load ptr, ptr %33, align 8
...
invoke.cont78:                                    ; preds = %invoke.cont74
  %36 = load ptr, ptr %setCoderProperties62, align 8
...
lpad65:                                           ; preds = %invoke.cont74, %for.cond.cleanup
  ...
  %42 = load ptr, ptr %setCoderProperties62, align 8
  %tobool.not.i176 = icmp eq ptr %42, null
  br i1 %tobool.not.i176, label %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit182, label %if.then.i177

if.then.i177:                                     ; preds = %lpad65
  %vtable.i178 = load ptr, ptr %42, align 8
  %vfn.i179 = getelementptr inbounds ptr, ptr %vtable.i178, i64 2
  %43 = load ptr, ptr %vfn.i179, align 8
  %call.i180 = invoke noundef i32 %43(ptr noundef nonnull align 8 dereferenceable(8) %42)
          to label %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit182 unwind label %terminate.lpad.i181

terminate.lpad.i181:                              ; preds = %if.then.i177
...
_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit182: ; preds = %lpad65, %if.then.i177
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %setCoderProperties62) #9
  br label %catch
  ...
  %.pn.pn = phi { ptr, i32 } [ %41, %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit182 ], [ %31, %lpad37.split ], [ %17, %lpad37.split.us ], [ %32, %lpad43.split ], [ %18, %lpad43.split.us ]
...
arraydestroy.done100:                             ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit187, %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit
  ...
  %.pr.pr = load ptr, ptr %setCoderProperties, align 8
  %tobool.not.i188 = icmp eq ptr %.pr.pr, null
  br i1 %tobool.not.i188, label %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit194, label %if.then.i189

ehcleanup111:                                     ; preds = %lpad89, %lpad28
  %.pn168 = phi { ptr, i32 } [ %20, %lpad28 ], [ %50, %lpad89 ]
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %propIDs) #9
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %propIDs) #9
  br label %ehcleanup120

if.then.i189:                                     ; preds = %arraydestroy.done100
  %vtable.i190 = load ptr, ptr %.pr.pr, align 8
  %vfn.i191 = getelementptr inbounds ptr, ptr %vtable.i190, i64 2
  %53 = load ptr, ptr %vfn.i191, align 8
  %call.i192 = invoke noundef i32 %53(ptr noundef nonnull align 8 dereferenceable(8) %.pr.pr)
...
_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit194: ; preds = %arraydestroy.done100, %if.then.i189
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %setCoderProperties) #9
  br i1 %cmp102.not, label %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit194.thread219, label %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit194.thread

_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit194.thread219: ; preds = %if.then21, %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit194
  br label %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit194.thread

_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit194.thread: ; preds = %if.then21, %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit194, %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit194.thread219
  %56 = phi i32 [ 0, %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit194.thread219 ], [ %call79, %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit194 ], [ -2147024809, %if.then21 ]
  ret i32 %56

ehcleanup120:                                     ; preds = %ehcleanup111, %lpad
  %.pn168.pn.pn = phi { ptr, i32 } [ %.pn168, %ehcleanup111 ], [ %5, %lpad ]
  %57 = load ptr, ptr %setCoderProperties, align 8
  %tobool.not.i195 = icmp eq ptr %57, null
  br i1 %tobool.not.i195, label %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit201, label %if.then.i196

if.then.i196:                                     ; preds = %ehcleanup120
  %vtable.i197 = load ptr, ptr %57, align 8
  %vfn.i198 = getelementptr inbounds ptr, ptr %vtable.i197, i64 2
  %58 = load ptr, ptr %vfn.i198, align 8
  %call.i199 = invoke noundef i32 %58(ptr noundef nonnull align 8 dereferenceable(8) %57)
          to label %_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit201 unwind label %terminate.lpad.i200

terminate.lpad.i200:                              ; preds = %if.then.i196
...
_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit201: ; preds = %ehcleanup120, %if.then.i196
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %setCoderProperties) #9
