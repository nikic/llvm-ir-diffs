...
if.then.i177:                                     ; preds = %lpad65
  %vtable.i178 = load ptr, ptr %42, align 8, !tbaa !20
...
cleanup119:                                       ; preds = %arraydestroy.done100, %if.end118
  %cond134.ph = phi i32 [ %call79, %arraydestroy.done100 ], [ 0, %if.end118 ]
...
if.then.i189:                                     ; preds = %cleanup119
  %vtable.i190 = load ptr, ptr %.pr, align 8, !tbaa !20
  %vfn.i191 = getelementptr inbounds ptr, ptr %vtable.i190, i64 2
  %53 = load ptr, ptr %vfn.i191, align 8
  %call.i192 = invoke noundef i32 %53(ptr noundef nonnull align 8 dereferenceable(8) %.pr)
...
_ZN9CMyComPtrI27ICompressSetCoderPropertiesED2Ev.exit194: ; preds = %cleanup119, %if.then.i189
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %setCoderProperties) #9
  br label %56
...
if.then.i196:                                     ; preds = %ehcleanup120
  %vtable.i197 = load ptr, ptr %58, align 8, !tbaa !20
  %vfn.i198 = getelementptr inbounds ptr, ptr %vtable.i197, i64 2
  %59 = load ptr, ptr %vfn.i198, align 8
  %call.i199 = invoke noundef i32 %59(ptr noundef nonnull align 8 dereferenceable(8) %58)
