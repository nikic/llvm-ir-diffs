; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/StreamBinder.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/StreamBinder.cpp"
...
entry:
  ...
  %0 = load ptr, ptr %m_StreamBinder, align 8
...
cleanup.cont:                                     ; preds = %if.then
  ...
  %0 = load i32, ptr %_bufferSize, align 8
...
if.then7:                                         ; preds = %cleanup.cont
  ...
  store ptr %add.ptr, ptr %_buffer, align 8
  %3 = load i32, ptr %_bufferSize, align 8
  %sub = sub i32 %3, %cond.i
  store i32 %sub, ptr %_bufferSize, align 8
...
if.then.i:                                        ; preds = %entry
  ...
  store i8 0, ptr %_state.i.i, align 1
  ...
  store ptr %0, ptr %events.i, align 16
  ...
  store ptr %_readStreamIsClosedEvent.i, ptr %arrayidx6.i, align 8
...
if.then:                                          ; preds = %entry
  %_buffer = getelementptr inbounds %class.CStreamBinder, ptr %this, i64 0, i32 5
  store ptr %data, ptr %_buffer, align 8
  %_bufferSize = getelementptr inbounds %class.CStreamBinder, ptr %this, i64 0, i32 4
  store i32 %size, ptr %_bufferSize, align 8
  %_sync.i = getelementptr inbounds %"struct.NWindows::NSynchronization::CBaseHandleWFMO", ptr %this, i64 0, i32 1
  ...
  store ptr %this, ptr %events, align 16
  ...
  store ptr %_readStreamIsClosedEvent, ptr %arrayidx6, align 8
...
cleanup.cont:
  ...
  store i8 0, ptr %_isValid.i, align 8
  ...
  store ptr %call, ptr %_synchroFor_allBytesAreWritenEvent_and_readStreamIsClosedEvent, align 8
...
invoke.cont:
  ...
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV28CSequentialInStreamForBinder, i64 0, inrange i32 0, i64 2), ptr %call, align 8
  store i32 1, ptr %0, align 8
  %m_StreamBinder.i = getelementptr inbounds %class.CSequentialInStreamForBinder, ptr %call, i64 0, i32 2
  store ptr %this, ptr %m_StreamBinder.i, align 8
  store ptr %call, ptr %inStream, align 8
  ...
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV29CSequentialOutStreamForBinder, i64 0, inrange i32 0, i64 2), ptr %call8, align 8
  store i32 1, ptr %1, align 8
  %m_StreamBinder.i30 = getelementptr inbounds %class.CSequentialOutStreamForBinder, ptr %call8, i64 0, i32 2
  store ptr %this, ptr %m_StreamBinder.i30, align 8
  store ptr %call8, ptr %outStream, align 8
  %_buffer = getelementptr inbounds %class.CStreamBinder, ptr %this, i64 0, i32 5
  %_bufferSize = getelementptr inbounds %class.CStreamBinder, ptr %this, i64 0, i32 4
  store i32 0, ptr %_bufferSize, align 8
...
invoke.cont:
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV28CSequentialInStreamForBinder, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %m_StreamBinder = getelementptr inbounds %class.CSequentialInStreamForBinder, ptr %this, i64 0, i32 2
  %0 = load ptr, ptr %m_StreamBinder, align 8
...
entry:
  ...
  %2 = load ptr, ptr %_sync.i.i.i, align 8
...
entry:
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV29CSequentialOutStreamForBinder, i64 0, inrange i32 0, i64 2), ptr %this, align 8
  %m_StreamBinder = getelementptr inbounds %class.CSequentialOutStreamForBinder, ptr %this, i64 0, i32 2
  %0 = load ptr, ptr %m_StreamBinder, align 8
  %_thereAreBytesToReadEvent.i = getelementptr inbounds %class.CStreamBinder, ptr %0, i64 0, i32 1
