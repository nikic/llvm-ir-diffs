; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/LockedStream.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/LockedStream.cpp"
...
ehcleanup:                                        ; preds = %lpad5, %lpad
  ...
  %call.i.i.i18 = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull %_criticalSection) #8
  resume { ptr, i32 } %.pn
}
...
entry:
  ...
  %0 = load ptr, ptr %_lockedInStream, align 8
...
ehcleanup.i:                                      ; preds = %lpad5.i, %lpad.i
  ...
  %call.i.i.i18.i = call i32 @pthread_mutex_unlock(ptr noundef nonnull %_criticalSection.i) #8
  resume { ptr, i32 } %.pn.i
...
_ZN15CLockedInStream4ReadEyPvjPj.exit:            ; preds = %invoke.cont2.i, %cleanup.cont.i
  ...
  %8 = load i32, ptr %realProcessedSize, align 4
...
if.then:                                          ; preds = %_ZN15CLockedInStream4ReadEyPvjPj.exit
  store i32 %8, ptr %processedSize, align 4
  br label %if.end
