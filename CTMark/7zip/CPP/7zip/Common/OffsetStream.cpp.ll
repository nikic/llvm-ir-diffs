...
_ZN9CMyComPtrI10IOutStreamEaSEPS0_.exit:          ; preds = %if.end.i, %if.then2.i
  store ptr %stream, ptr %_stream, align 8, !tbaa !19
  %vtable = load ptr, ptr %stream, align 8, !tbaa !17
...
if.then4:                                         ; preds = %entry
  %3 = load i64, ptr %absoluteNewPosition, align 8, !tbaa !20
  %4 = load i64, ptr %_offset, align 8, !tbaa !5
  %sub = sub i64 %3, %4
  store i64 %sub, ptr %newPosition, align 8, !tbaa !20
  br label %if.end6
...
entry:
  ...
  %0 = load ptr, ptr %_stream, align 8, !tbaa !19
  %_offset = getelementptr inbounds %class.COffsetOutStream, ptr %this, i64 0, i32 2
  %1 = load i64, ptr %_offset, align 8, !tbaa !5
...
entry:
  store ptr getelementptr inbounds ({ [10 x ptr] }, ptr @_ZTV16COffsetOutStream, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !17
  %_stream = getelementptr inbounds %class.COffsetOutStream, ptr %this, i64 0, i32 3
  %0 = load ptr, ptr %_stream, align 8, !tbaa !19
