; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/ProgressUtils.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/7zip/Common/ProgressUtils.cpp"
...
entry:
  ...
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV14CLocalProgress, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
entry:
  ...
  %0 = load ptr, ptr %_ratioProgress, align 8
...
if.then.i:                                        ; preds = %entry
  ...
  store ptr null, ptr %_ratioProgress, align 8
...
if.then.i7:                                       ; preds = %_ZN9CMyComPtrI21ICompressProgressInfoE7ReleaseEv.exit
  %vtable.i8 = load ptr, ptr %progress, align 8
  %vfn.i9 = getelementptr inbounds ptr, ptr %vtable.i8, i64 1
  %2 = load ptr, ptr %vfn.i9, align 8
  %call.i10 = tail call noundef i32 %2(ptr noundef nonnull align 8 dereferenceable(8) %progress)
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i7, %_ZN9CMyComPtrI21ICompressProgressInfoE7ReleaseEv.exit
  %3 = load ptr, ptr %_progress, align 8
...
_ZN9CMyComPtrI9IProgressEaSEPS0_.exit:            ; preds = %if.end.i, %if.then2.i
  ...
  store ptr %progress, ptr %_progress, align 8
  %vtable.i12 = load ptr, ptr %progress, align 8
...
entry:
  ...
  %0 = load i64, ptr %InSize, align 8
  store i64 %0, ptr %inSizeNew, align 8
  ...
  store i64 %1, ptr %outSizeNew, align 8
  %tobool.not = icmp eq ptr %inSize, null
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %2 = load i64, ptr %inSize, align 8
  %add = add i64 %2, %0
  store i64 %add, ptr %inSizeNew, align 8
  br label %if.end
...
if.then3:                                         ; preds = %if.end
  ...
  %add4 = add i64 %4, %1
  store i64 %add4, ptr %outSizeNew, align 8
  br label %if.end5

if.end5:                                          ; preds = %if.then3, %if.end
  %5 = phi i64 [ %add4, %if.then3 ], [ %1, %if.end ]
  %SendRatio = getelementptr inbounds %class.CLocalProgress, ptr %this, i64 0, i32 10
  %6 = load i8, ptr %SendRatio, align 8
  %tobool6.not = icmp eq i8 %6, 0
  br i1 %tobool6.not, label %if.end14, label %land.lhs.true

land.lhs.true:                                    ; preds = %if.end5
  %_ratioProgress = getelementptr inbounds %class.CLocalProgress, ptr %this, i64 0, i32 4
  %7 = load ptr, ptr %_ratioProgress, align 8
...
if.then8.if.end14_crit_edge:                      ; preds = %if.then8
  %.pre = load i64, ptr %inSizeNew, align 8
  %.pre32 = load i64, ptr %outSizeNew, align 8
  br label %if.end14
...
if.end14:                                         ; preds = %if.then8.if.end14_crit_edge, %land.lhs.true, %if.end5
  ...
  %ProgressOffset = getelementptr inbounds %class.CLocalProgress, ptr %this, i64 0, i32 7
  %11 = load i64, ptr %ProgressOffset, align 8
  %add15 = add i64 %10, %11
  store i64 %add15, ptr %inSizeNew, align 8
  %add17 = add i64 %9, %11
  store i64 %add17, ptr %outSizeNew, align 8
  %SendProgress = getelementptr inbounds %class.CLocalProgress, ptr %this, i64 0, i32 11
  %12 = load i8, ptr %SendProgress, align 1
  %tobool18.not = icmp eq i8 %12, 0
  br i1 %tobool18.not, label %cleanup26, label %if.then19

if.then19:                                        ; preds = %if.end14
  %_progress = getelementptr inbounds %class.CLocalProgress, ptr %this, i64 0, i32 3
  %13 = load ptr, ptr %_progress, align 8
  %_inSizeIsMain = getelementptr inbounds %class.CLocalProgress, ptr %this, i64 0, i32 5
  %14 = load i8, ptr %_inSizeIsMain, align 8
...
_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit:  ; preds = %entry, %if.then.i
  %_progress = getelementptr inbounds %class.CLocalProgress, ptr %this, i64 0, i32 3
  %4 = load ptr, ptr %_progress, align 8
  %tobool.not.i2 = icmp eq ptr %4, null
  br i1 %tobool.not.i2, label %_ZN9CMyComPtrI9IProgressED2Ev.exit, label %if.then.i3

if.then.i3:                                       ; preds = %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit
...
_ZN9CMyComPtrI9IProgressED2Ev.exit:               ; preds = %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit, %if.then.i3
  ret void
}
...
entry:
  ...
  %0 = load ptr, ptr %_ratioProgress.i, align 8
...
_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit.i: ; preds = %if.then.i.i, %entry
  ...
  %4 = load ptr, ptr %_progress.i, align 8
  %tobool.not.i2.i = icmp eq ptr %4, null
  br i1 %tobool.not.i2.i, label %_ZN14CLocalProgressD2Ev.exit, label %if.then.i3.i

if.then.i3.i:                                     ; preds = %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit.i
...
_ZN14CLocalProgressD2Ev.exit:                     ; preds = %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit.i, %if.then.i3.i
