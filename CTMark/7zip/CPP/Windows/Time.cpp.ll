; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Windows/Time.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Windows/Time.cpp"
...
if.end:                                           ; preds = %entry
  %1 = load i16, ptr %datePart, align 2
  %conv = zext i16 %1 to i32
  %shl = shl nuw i32 %conv, 16
  %2 = load i16, ptr %timePart, align 2
...
cleanup:                                          ; preds = %if.end, %if.then
  ...
  store i32 %storemerge, ptr %dosTime, align 4
...
entry:
  ...
  store i32 %conv1, ptr %fileTime, align 4
  %shr = lshr i64 %add, 32
...
cleanup:                                          ; preds = %if.end, %entry, %if.end4
  ...
  store i32 %conv5.sink, ptr %unixTime, align 4
  ret i1 %retval.0
}
...
entry:
  ...
  store i64 0, ptr %resSeconds, align 8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load81 = load <4 x i8>, ptr %7, align 1
...
for.cond.cleanup:                                 ; preds = %for.body, %middle.block, %if.end27
  ...
  store i64 %add41, ptr %resSeconds, align 8
...
attributes #5 = { mustprogress nofree nosync nounwind memory(argmem: write) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
