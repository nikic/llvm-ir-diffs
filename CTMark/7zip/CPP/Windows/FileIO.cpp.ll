; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Windows/FileIO.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Windows/FileIO.cpp"
...
entry:
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTVN8NWindows5NFile3NIO9CFileBaseE, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
invoke.cont:                                      ; preds = %entry
  ...
  %0 = load ptr, ptr %_unix_filename, align 8
...
invoke.cont.i:                                    ; preds = %entry
  ...
  %0 = load ptr, ptr %_unix_filename.i, align 8
...
land.lhs.true.i:                                  ; preds = %entry
  ...
  %spec.select.i = getelementptr inbounds i8, ptr %filename, i64 %spec.select.idx.i
...
sw.epilog:                                        ; preds = %_ZL16nameWindowToUnixPKc.exit, %sw.bb16, %sw.bb14, %sw.bb
  ...
  store i32 -1, ptr %_fd, align 8
  %3 = load i32, ptr @global_use_lstat, align 4
...
if.then20:                                        ; preds = %sw.epilog
  ...
  %call21 = tail call i64 @readlink(ptr noundef nonnull %retval.0.i, ptr noundef nonnull %_buffer, i64 noundef 1024) #20
  %conv22 = trunc i64 %call21 to i32
  %_size = getelementptr inbounds %"class.NWindows::NFile::NIO::CFileBase", ptr %this, i64 0, i32 6
  store i32 %conv22, ptr %_size, align 8
...
if.then34:                                        ; preds = %if.else
  %call35 = tail call i32 @unlink(ptr noundef nonnull %retval.0.i) #20
  %tobool36.not = icmp eq i32 %call35, 0
  br i1 %tobool36.not, label %cleanup95, label %if.end42

if.end42:                                         ; preds = %if.then20, %if.else, %if.then34, %if.then28
  %.pr = load i32, ptr %_fd, align 8
  %cmp44 = icmp eq i32 %.pr, -1
  br i1 %cmp44, label %if.end48, label %if.else92

if.end48:                                         ; preds = %if.end42, %sw.epilog
  %call46 = tail call i32 (ptr, i32, ...) @open64(ptr noundef nonnull %retval.0.i, i32 noundef %flags.2, i32 noundef %and5)
  store i32 %call46, ptr %_fd, align 8
...
for.body:                                         ; preds = %_ZN11CStringBaseIcEC2Ev.exit, %for.inc
  ...
  %resultString.sroa.0.0183 = phi ptr [ %resultString.sroa.0.1, %for.inc ], [ %call.i.i128129, %_ZN11CStringBaseIcEC2Ev.exit ]
  %resultString.sroa.0.0183201 = ptrtoint ptr %resultString.sroa.0.0183 to i64
  %14 = load ptr, ptr %ustr, align 8
...
iter.check:                                       ; preds = %for.cond.preheader.i.i.i
  ...
  %or.cond244 = or i1 %min.iters.check, %diff.check
  br i1 %or.cond244, label %for.body.i.i.i.preheader, label %vector.main.loop.iter.check
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load208 = load <8 x i8>, ptr %23, align 1
  %24 = getelementptr inbounds i8, ptr %call.i.i.i136, i64 %index207
  store <8 x i8> %wide.load208, ptr %24, align 1
...
for.inc:                                          ; preds = %if.end9.i.i.i, %if.end.i.i, %if.else66
  ...
  store i8 %conv71, ptr %arrayidx.i, align 1
  ...
  %34 = load i32, ptr %_length.i130, align 8
  %35 = sext i32 %34 to i64
  %cmp59 = icmp slt i64 %indvars.iv.next, %35
  br i1 %cmp59, label %for.body, label %if.then76

if.then76:                                        ; preds = %for.inc, %_ZN11CStringBaseIcEC2Ev.exit
  %resultString.sroa.0.0.lcssa = phi ptr [ %call.i.i128129, %_ZN11CStringBaseIcEC2Ev.exit ], [ %resultString.sroa.0.1, %for.inc ]
...
invoke.cont80:                                    ; preds = %if.then76
  store i32 %call81, ptr %_fd, align 8
...
_ZN11CStringBaseIwED2Ev.exit:                     ; preds = %_ZN11CStringBaseIcED2Ev.exit139, %delete.notnull.i141
  ...
  %.pr177 = load i32, ptr %_fd, align 8
  br label %if.end88
...
if.else92:                                        ; preds = %if.end42, %if.end88
  ...
  store i32 0, ptr %_length.i.i148, align 8
  %40 = load ptr, ptr %_unix_filename, align 8
  store i8 0, ptr %40, align 1
  br label %for.cond.i.i149

for.cond.i.i149:                                  ; preds = %for.cond.i.i149, %if.else92
  %indvars.iv.i.i150 = phi i64 [ %indvars.iv.next.i.i153, %for.cond.i.i149 ], [ 0, %if.else92 ]
  %arrayidx.i.i151 = getelementptr inbounds i8, ptr %retval.0.i, i64 %indvars.iv.i.i150
  %41 = load i8, ptr %arrayidx.i.i151, align 1
  %cmp.not.i.i152 = icmp eq i8 %41, 0
  %indvars.iv.next.i.i153 = add nuw i64 %indvars.iv.i.i150, 1
  br i1 %cmp.not.i.i152, label %_Z11MyStringLenIcEiPKT_.exit.i154, label %for.cond.i.i149

_Z11MyStringLenIcEiPKT_.exit.i154:                ; preds = %for.cond.i.i149
  %42 = trunc i64 %indvars.iv.i.i150 to i32
  %add.i.i155 = add nsw i32 %42, 1
  %_capacity.i.i156 = getelementptr inbounds %"class.NWindows::NFile::NIO::CFileBase", ptr %this, i64 0, i32 3, i32 2
  %43 = load i32, ptr %_capacity.i.i156, align 4
  %cmp.i.i157 = icmp eq i32 %add.i.i155, %43
  br i1 %cmp.i.i157, label %_Z11MyStringLenIcEiPKT_.exit._ZN11CStringBaseIcE11SetCapacityEi.exit_crit_edge.i, label %if.end.i.i158

_Z11MyStringLenIcEiPKT_.exit._ZN11CStringBaseIcE11SetCapacityEi.exit_crit_edge.i: ; preds = %_Z11MyStringLenIcEiPKT_.exit.i154
  %.pre11.i = load ptr, ptr %_unix_filename, align 8
  br label %while.cond.i.i163.preheader

if.end.i.i158:                                    ; preds = %_Z11MyStringLenIcEiPKT_.exit.i154
  %conv.i.i159 = sext i32 %add.i.i155 to i64
  %call.i.i160 = call noalias noundef nonnull ptr @_Znam(i64 noundef %conv.i.i159) #21
  %call.i.i160211 = ptrtoint ptr %call.i.i160 to i64
  %cmp3.i.i = icmp sgt i32 %43, 0
  %.pre10.i = load i32, ptr %_length.i.i148, align 8
  br i1 %cmp3.i.i, label %for.cond.preheader.i.i, label %if.end9.i.i161

for.cond.preheader.i.i:                           ; preds = %if.end.i.i158
  %cmp522.i.i = icmp sgt i32 %.pre10.i, 0
  %.pre.i.i168 = load ptr, ptr %_unix_filename, align 8
  br i1 %cmp522.i.i, label %iter.check217, label %for.cond.cleanup.i.i

iter.check217:                                    ; preds = %for.cond.preheader.i.i
  %.pre.i.i168212 = ptrtoint ptr %.pre.i.i168 to i64
  %wide.trip.count.i.i = zext i32 %.pre10.i to i64
  %min.iters.check215 = icmp ult i32 %.pre10.i, 8
  %44 = sub i64 %call.i.i160211, %.pre.i.i168212
  %diff.check213 = icmp ult i64 %44, 32
  %or.cond245 = select i1 %min.iters.check215, i1 true, i1 %diff.check213
  br i1 %or.cond245, label %for.body.i.i.preheader, label %vector.main.loop.iter.check219

vector.main.loop.iter.check219:                   ; preds = %iter.check217
  %min.iters.check218 = icmp ult i32 %.pre10.i, 32
  br i1 %min.iters.check218, label %vec.epilog.ph232, label %vector.ph220

vector.ph220:                                     ; preds = %vector.main.loop.iter.check219
  %n.vec222 = and i64 %wide.trip.count.i.i, 4294967264
  br label %vector.body224

vector.body224:                                   ; preds = %vector.body224, %vector.ph220
  %index225 = phi i64 [ 0, %vector.ph220 ], [ %index.next228, %vector.body224 ]
  %45 = getelementptr inbounds i8, ptr %.pre.i.i168, i64 %index225
  %wide.load226 = load <16 x i8>, ptr %45, align 1
  %46 = getelementptr inbounds i8, ptr %45, i64 16
  %wide.load227 = load <16 x i8>, ptr %46, align 1
  %47 = getelementptr inbounds i8, ptr %call.i.i160, i64 %index225
  store <16 x i8> %wide.load226, ptr %47, align 1
  %48 = getelementptr inbounds i8, ptr %47, i64 16
  store <16 x i8> %wide.load227, ptr %48, align 1
  %index.next228 = add nuw i64 %index225, 32
  %49 = icmp eq i64 %index.next228, %n.vec222
  br i1 %49, label %middle.block214, label %vector.body224

middle.block214:                                  ; preds = %vector.body224
  %cmp.n223 = icmp eq i64 %n.vec222, %wide.trip.count.i.i
  br i1 %cmp.n223, label %delete.notnull.i.i, label %vec.epilog.iter.check231

vec.epilog.iter.check231:                         ; preds = %middle.block214
  %n.vec.remaining233 = and i64 %wide.trip.count.i.i, 24
  %min.epilog.iters.check234 = icmp eq i64 %n.vec.remaining233, 0
  br i1 %min.epilog.iters.check234, label %for.body.i.i.preheader, label %vec.epilog.ph232

vec.epilog.ph232:                                 ; preds = %vector.main.loop.iter.check219, %vec.epilog.iter.check231
  %vec.epilog.resume.val235 = phi i64 [ %n.vec222, %vec.epilog.iter.check231 ], [ 0, %vector.main.loop.iter.check219 ]
  %n.vec237 = and i64 %wide.trip.count.i.i, 4294967288
  br label %vec.epilog.vector.body240

vec.epilog.vector.body240:                        ; preds = %vec.epilog.vector.body240, %vec.epilog.ph232
  %index241 = phi i64 [ %vec.epilog.resume.val235, %vec.epilog.ph232 ], [ %index.next243, %vec.epilog.vector.body240 ]
  %50 = getelementptr inbounds i8, ptr %.pre.i.i168, i64 %index241
  %wide.load242 = load <8 x i8>, ptr %50, align 1
  %51 = getelementptr inbounds i8, ptr %call.i.i160, i64 %index241
  store <8 x i8> %wide.load242, ptr %51, align 1
  %index.next243 = add nuw i64 %index241, 8
  %52 = icmp eq i64 %index.next243, %n.vec237
  br i1 %52, label %vec.epilog.middle.block229, label %vec.epilog.vector.body240

vec.epilog.middle.block229:                       ; preds = %vec.epilog.vector.body240
  %cmp.n239 = icmp eq i64 %n.vec237, %wide.trip.count.i.i
  br i1 %cmp.n239, label %delete.notnull.i.i, label %for.body.i.i.preheader

for.body.i.i.preheader:                           ; preds = %iter.check217, %vec.epilog.iter.check231, %vec.epilog.middle.block229
  %indvars.iv.i6.i.ph = phi i64 [ 0, %iter.check217 ], [ %n.vec222, %vec.epilog.iter.check231 ], [ %n.vec237, %vec.epilog.middle.block229 ]
  %53 = xor i64 %indvars.iv.i6.i.ph, -1
  %54 = add nsw i64 %53, %wide.trip.count.i.i
  %xtraiter248 = and i64 %wide.trip.count.i.i, 3
  %lcmp.mod249.not = icmp eq i64 %xtraiter248, 0
  br i1 %lcmp.mod249.not, label %for.body.i.i.prol.loopexit, label %for.body.i.i.prol
...
for.body.i.i.prol:                                ; preds = %for.body.i.i.preheader, %for.body.i.i.prol
  ...
  %prol.iter250 = phi i64 [ %prol.iter250.next, %for.body.i.i.prol ], [ 0, %for.body.i.i.preheader ]
  %arrayidx.i7.i.prol = getelementptr inbounds i8, ptr %.pre.i.i168, i64 %indvars.iv.i6.i.prol
  %55 = load i8, ptr %arrayidx.i7.i.prol, align 1
  %arrayidx7.i.i.prol = getelementptr inbounds i8, ptr %call.i.i160, i64 %indvars.iv.i6.i.prol
  store i8 %55, ptr %arrayidx7.i.i.prol, align 1
  ...
  br i1 %prol.iter250.cmp.not, label %for.body.i.i.prol.loopexit, label %for.body.i.i.prol
...
for.body.i.i.prol.loopexit:                       ; preds = %for.body.i.i.prol, %for.body.i.i.preheader
  ...
  br i1 %56, label %delete.notnull.i.i, label %for.body.i.i

for.cond.cleanup.i.i:                             ; preds = %for.cond.preheader.i.i
  %isnull.i.i = icmp eq ptr %.pre.i.i168, null
...
for.body.i.i:                                     ; preds = %for.body.i.i.prol.loopexit, %for.body.i.i
  ...
  %arrayidx.i7.i = getelementptr inbounds i8, ptr %.pre.i.i168, i64 %indvars.iv.i6.i
  %57 = load i8, ptr %arrayidx.i7.i, align 1
  %arrayidx7.i.i = getelementptr inbounds i8, ptr %call.i.i160, i64 %indvars.iv.i6.i
  store i8 %57, ptr %arrayidx7.i.i, align 1
  %indvars.iv.next.i8.i = add nuw nsw i64 %indvars.iv.i6.i, 1
  %arrayidx.i7.i.1 = getelementptr inbounds i8, ptr %.pre.i.i168, i64 %indvars.iv.next.i8.i
  %58 = load i8, ptr %arrayidx.i7.i.1, align 1
  %arrayidx7.i.i.1 = getelementptr inbounds i8, ptr %call.i.i160, i64 %indvars.iv.next.i8.i
  store i8 %58, ptr %arrayidx7.i.i.1, align 1
  %indvars.iv.next.i8.i.1 = add nuw nsw i64 %indvars.iv.i6.i, 2
  %arrayidx.i7.i.2 = getelementptr inbounds i8, ptr %.pre.i.i168, i64 %indvars.iv.next.i8.i.1
  %59 = load i8, ptr %arrayidx.i7.i.2, align 1
  %arrayidx7.i.i.2 = getelementptr inbounds i8, ptr %call.i.i160, i64 %indvars.iv.next.i8.i.1
  store i8 %59, ptr %arrayidx7.i.i.2, align 1
  %indvars.iv.next.i8.i.2 = add nuw nsw i64 %indvars.iv.i6.i, 3
  %arrayidx.i7.i.3 = getelementptr inbounds i8, ptr %.pre.i.i168, i64 %indvars.iv.next.i8.i.2
  %60 = load i8, ptr %arrayidx.i7.i.3, align 1
  %arrayidx7.i.i.3 = getelementptr inbounds i8, ptr %call.i.i160, i64 %indvars.iv.next.i8.i.2
  store i8 %60, ptr %arrayidx7.i.i.3, align 1
...
delete.notnull.i.i:                               ; preds = %for.body.i.i.prol.loopexit, %for.body.i.i, %middle.block214, %vec.epilog.middle.block229, %for.cond.cleanup.i.i
  call void @_ZdaPv(ptr noundef nonnull %.pre.i.i168) #18
  %.pre.i = load i32, ptr %_length.i.i148, align 8
  br label %if.end9.i.i161

if.end9.i.i161:                                   ; preds = %delete.notnull.i.i, %for.cond.cleanup.i.i, %if.end.i.i158
  %61 = phi i32 [ %.pre.i, %delete.notnull.i.i ], [ %.pre10.i, %for.cond.cleanup.i.i ], [ %.pre10.i, %if.end.i.i158 ]
  store ptr %call.i.i160, ptr %_unix_filename, align 8
  %idxprom13.i.i = sext i32 %61 to i64
  %arrayidx14.i.i = getelementptr inbounds i8, ptr %call.i.i160, i64 %idxprom13.i.i
  store i8 0, ptr %arrayidx14.i.i, align 1
  store i32 %add.i.i155, ptr %_capacity.i.i156, align 4
  br label %while.cond.i.i163.preheader

while.cond.i.i163.preheader:                      ; preds = %if.end9.i.i161, %_Z11MyStringLenIcEiPKT_.exit._ZN11CStringBaseIcE11SetCapacityEi.exit_crit_edge.i
  %dest.addr.0.i.i165.ph = phi ptr [ %.pre11.i, %_Z11MyStringLenIcEiPKT_.exit._ZN11CStringBaseIcE11SetCapacityEi.exit_crit_edge.i ], [ %call.i.i160, %if.end9.i.i161 ]
  br label %while.cond.i.i163

while.cond.i.i163:                                ; preds = %while.cond.i.i163.preheader, %while.cond.i.i163
  %src.addr.0.i.i164 = phi ptr [ %incdec.ptr.i.i166, %while.cond.i.i163 ], [ %retval.0.i, %while.cond.i.i163.preheader ]
  %dest.addr.0.i.i165 = phi ptr [ %incdec.ptr1.i.i167, %while.cond.i.i163 ], [ %dest.addr.0.i.i165.ph, %while.cond.i.i163.preheader ]
  %incdec.ptr.i.i166 = getelementptr inbounds i8, ptr %src.addr.0.i.i164, i64 1
  %62 = load i8, ptr %src.addr.0.i.i164, align 1
  %incdec.ptr1.i.i167 = getelementptr inbounds i8, ptr %dest.addr.0.i.i165, i64 1
  store i8 %62, ptr %dest.addr.0.i.i165, align 1
  %cmp.not.i9.i = icmp eq i8 %62, 0
  br i1 %cmp.not.i9.i, label %_ZN11CStringBaseIcEaSEPKc.exit, label %while.cond.i.i163

_ZN11CStringBaseIcEaSEPKc.exit:                   ; preds = %while.cond.i.i163
  store i32 %42, ptr %_length.i.i148, align 8
  br label %cleanup95
...
if.then17:                                        ; preds = %if.then11
  ...
  %_unix_filename = getelementptr inbounds %"class.NWindows::NFile::NIO::CFileBase", ptr %this, i64 0, i32 3
  %3 = load ptr, ptr %_unix_filename, align 8
...
if.then25:                                        ; preds = %if.then22
  ...
  %4 = load i64, ptr %st_atim, align 8
...
if.end45:                                         ; preds = %if.end45.sink.split, %if.end27
  %6 = load ptr, ptr %_unix_filename, align 8
...
if.end19:                                         ; preds = %if.end14
  store i64 %call11, ptr %length, align 8
  br label %return
...
if.end11:                                         ; preds = %sw.epilog
  ...
  store i32 %conv19, ptr %_offset20, align 8
  store i64 %spec.select, ptr %newPosition, align 8
  br label %return
...
if.else:                                          ; preds = %if.end22
  store i64 %call, ptr %newPosition, align 8
  br label %return
...
if.end11.i:                                       ; preds = %if.then4.i
  ...
  store i32 %conv19.i, ptr %_offset20.i, align 8
  store i64 %spec.select.i, ptr %newPosition, align 8
  br label %_ZN8NWindows5NFile3NIO9CFileBase4SeekExjRy.exit
...
if.else.i:                                        ; preds = %if.end22.i
  store i64 %call.i, ptr %newPosition, align 8
  br label %_ZN8NWindows5NFile3NIO9CFileBase4SeekExjRy.exit
...
if.then7.i:                                       ; preds = %if.end4.i
  ...
  %1 = load i32, ptr %_offset.i, align 8
  %_size.i = getelementptr inbounds %"class.NWindows::NFile::NIO::CFileBase", ptr %this, i64 0, i32 6
  %2 = load i32, ptr %_size.i, align 8
  %cmp8.not.i = icmp slt i32 %1, %2
...
if.end10.i:                                       ; preds = %if.then7.i
  ...
  store i32 %spec.select.i, ptr %processedSize, align 4
  %3 = load i32, ptr %_offset.i, align 8
  %add.i = add nsw i32 %3, %spec.select.i
  store i32 %add.i, ptr %_offset.i, align 8
  br label %_ZN8NWindows5NFile3NIO7CInFile4ReadEPvjRj.exit

do.body.i:                                        ; preds = %land.rhs.i, %do.body.preheader.i
  %4 = load i32, ptr %_fd.i, align 8
...
land.rhs.i:                                       ; preds = %do.body.i
  ...
  %5 = load i32, ptr %call22.i, align 4
  %cmp23.i = icmp eq i32 %5, 4
  br i1 %cmp23.i, label %do.body.i, label %do.end.i
...
do.end.i:                                         ; preds = %land.rhs.i, %do.body.i
  ...
  store i32 %storemerge.i, ptr %processedSize, align 4
  br label %_ZN8NWindows5NFile3NIO7CInFile4ReadEPvjRj.exit
...
if.end10:                                         ; preds = %if.then7
  ...
  store i32 %spec.select, ptr %bytesRead, align 4
  %3 = load i32, ptr %_offset, align 8
  %add = add nsw i32 %3, %spec.select
  store i32 %add, ptr %_offset, align 8
  br label %return

do.body:                                          ; preds = %do.body.preheader, %land.rhs
  %4 = load i32, ptr %_fd, align 8
...
do.end:                                           ; preds = %do.body, %land.rhs
  ...
  store i32 %storemerge, ptr %bytesRead, align 4
  br label %return
...
if.then2:                                         ; preds = %if.end
  ...
  %1 = load i32, ptr %dwHighDateTime, align 4
  %conv = zext i32 %1 to i64
  %shl = shl nuw i64 %conv, 32
  %2 = load i32, ptr %aTime, align 4
  ...
  %_lastAccessTime = getelementptr inbounds %"class.NWindows::NFile::NIO::CFileBase", ptr %this, i64 0, i32 4
  store i64 %conv6, ptr %_lastAccessTime, align 8
  br label %if.end7
...
if.then9:                                         ; preds = %if.end7
  ...
  %4 = load i32, ptr %dwHighDateTime10, align 4
  %conv11 = zext i32 %4 to i64
  %shl14 = shl nuw i64 %conv11, 32
  %5 = load i32, ptr %mTime, align 4
  %conv16 = zext i32 %5 to i64
  %or17 = or i64 %shl14, %conv16
  store i64 %or17, ptr %ltime, align 8
  ...
  %_lastWriteTime = getelementptr inbounds %"class.NWindows::NFile::NIO::CFileBase", ptr %this, i64 0, i32 5
  store i64 %conv20, ptr %_lastWriteTime, align 8
  br label %cleanup
...
if.then9.i:                                       ; preds = %if.end.i
  ...
  store i64 %1, ptr %ltime.i, align 8
  ...
  store i64 %conv20.i, ptr %_lastWriteTime.i, align 8
  br label %_ZN8NWindows5NFile3NIO8COutFile7SetTimeEPK9_FILETIMES5_S5_.exit
...
land.rhs.i:                                       ; preds = %do.body.i
  ...
  br i1 %cmp5.i, label %do.body.i, label %do.end.i
...
do.end:                                           ; preds = %do.body, %land.rhs
  ...
  store i32 %storemerge, ptr %bytesWritten, align 4
  br label %return
...
entry:
  ...
  %0 = load i32, ptr %_fd.i.i, align 8
...
if.then.i.i:                                      ; preds = %entry
  ...
  store i32 9, ptr %call.i.i.i, align 4
  br label %cleanup
...
if.then10.i.i:                                    ; preds = %if.then4.i.i
  ...
  store i32 22, ptr %call.i38.i.i, align 4
  br label %cleanup
...
if.end11.i.i:                                     ; preds = %if.then4.i.i
  ...
  %1 = load i32, ptr %_size12.i.i, align 8
  ...
  store i32 %conv19.i.i, ptr %_offset20.i.i, align 8
...
if.end3:                                          ; preds = %_ZN8NWindows5NFile3NIO9CFileBase4SeekEyRy.exit
  %2 = load i32, ptr %_fd.i.i, align 8
  %cmp.i = icmp eq i32 %2, -1
  br i1 %cmp.i, label %if.then.i, label %if.end.i

if.then.i:                                        ; preds = %if.end3
  %call.i.i6 = tail call ptr @__errno_location() #22
  store i32 9, ptr %call.i.i6, align 4
  br label %cleanup
...
if.then4.i:                                       ; preds = %if.end.i
  %3 = load i32, ptr %_fd.i.i, align 8
