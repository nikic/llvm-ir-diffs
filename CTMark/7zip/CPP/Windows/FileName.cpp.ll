...
if.end.i:                                         ; preds = %entry
  %1 = load ptr, ptr %dirPath, align 8
...
if.end7.i:                                        ; preds = %for.cond.i
  ...
  br i1 %cmp9.i, label %_ZNK11CStringBaseIwE11ReverseFindEw.exit, label %for.cond.i
...
if.end.i19:                                       ; preds = %if.then
  ...
  %4 = load ptr, ptr %pureName, align 8
...
if.end9.i.i:                                      ; preds = %delete.notnull.i.i, %if.end.i.i
  ...
  store ptr %call.i.i, ptr %pureName, align 8
  %arrayidx14.i.i = getelementptr inbounds i32, ptr %call.i.i, i64 %idxprom13.i.i
  store i32 0, ptr %arrayidx14.i.i, align 4
...
_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i:            ; preds = %while.cond.i.i
  ...
  store i32 %14, ptr %_length.i.i, align 8
...
_ZN11CStringBaseIwEaSERKS0_.exit:                 ; preds = %if.then, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i
  ...
  store i32 0, ptr %_length.i21, align 8
  %15 = load ptr, ptr %extensionDelimiter, align 8
  store i32 0, ptr %15, align 4
  %_length.i22 = getelementptr inbounds %class.CStringBase, ptr %extension, i64 0, i32 1
  store i32 0, ptr %_length.i22, align 8
...
if.else.invoke.cont_crit_edge:                    ; preds = %if.else
  %.pre = load ptr, ptr %pureName, align 8
...
if.end9.i.i34:                                    ; preds = %delete.notnull.i.i45, %call.i.i32.noexc
  ...
  store ptr %call.i.i3247, ptr %pureName, align 8
...
while.cond.i.i38:                                 ; preds = %while.cond.i.i38, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i37
  ...
  %26 = load i32, ptr %src.addr.0.i.i39, align 4
  %incdec.ptr1.i.i42 = getelementptr inbounds i32, ptr %dest.addr.0.i.i40, i64 1
  store i32 %26, ptr %dest.addr.0.i.i40, align 4
  %cmp.not.i.i43 = icmp eq i32 %26, 0
  br i1 %cmp.not.i.i43, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i44, label %while.cond.i.i38

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i44:          ; preds = %while.cond.i.i38
  %27 = load i32, ptr %_length.i26, align 8
  store i32 %27, ptr %_length.i.i25, align 8
  br label %invoke.cont
...
_ZN11CStringBaseIwED2Ev.exit:                     ; preds = %invoke.cont, %delete.notnull.i
  ...
  store i32 0, ptr %_length.i.i49, align 8
  %29 = load ptr, ptr %extensionDelimiter, align 8
  store i32 0, ptr %29, align 4
  %_capacity.i.i50 = getelementptr inbounds %class.CStringBase, ptr %extensionDelimiter, i64 0, i32 2
  %30 = load i32, ptr %_capacity.i.i50, align 4
...
delete.notnull.i.i59:                             ; preds = %if.end.i.i52
  ...
  %.pre.i60 = load i32, ptr %_length.i.i49, align 8
...
if.end9.i.i55:                                    ; preds = %delete.notnull.i.i59, %if.end.i.i52
  ...
  store ptr %call.i.i53, ptr %extensionDelimiter, align 8
  %arrayidx14.i.i57 = getelementptr inbounds i32, ptr %call.i.i53, i64 %idxprom13.i.i56
  store i32 0, ptr %arrayidx14.i.i57, align 4
  store i32 2, ptr %_capacity.i.i50, align 4
...
_ZN11CStringBaseIwEaSEw.exit.invoke.cont6_crit_edge: ; preds = %_ZN11CStringBaseIwEaSEw.exit
  %.pre101 = load ptr, ptr %extension, align 8
...
delete.notnull.i.i84:                             ; preds = %call.i.i71.noexc
  ...
  %.pre.i85 = load i32, ptr %_length.i.i64, align 8
...
if.end9.i.i73:                                    ; preds = %delete.notnull.i.i84, %call.i.i71.noexc
  ...
  store ptr %call.i.i7186, ptr %extension, align 8
  %arrayidx14.i.i75 = getelementptr inbounds i32, ptr %call.i.i7186, i64 %idxprom13.i.i74
  store i32 0, ptr %arrayidx14.i.i75, align 4
  store i32 %add.i.i66, ptr %_capacity.i.i67, align 4
...
while.cond.i.i77:                                 ; preds = %while.cond.i.i77, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i76
  ...
  %43 = load i32, ptr %src.addr.0.i.i78, align 4
  %incdec.ptr1.i.i81 = getelementptr inbounds i32, ptr %dest.addr.0.i.i79, i64 1
  store i32 %43, ptr %dest.addr.0.i.i79, align 4
  %cmp.not.i.i82 = icmp eq i32 %43, 0
  br i1 %cmp.not.i.i82, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i83, label %while.cond.i.i77

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i83:          ; preds = %while.cond.i.i77
  %44 = load i32, ptr %_length.i65, align 8
  store i32 %44, ptr %_length.i.i64, align 8
  br label %invoke.cont6
...
lpad5:                                            ; preds = %if.end.i.i69
  %48 = landingpad { ptr, i32 }
          cleanup
  %49 = load ptr, ptr %ref.tmp4, align 8
