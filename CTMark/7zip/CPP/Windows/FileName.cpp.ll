; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Windows/FileName.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Windows/FileName.cpp"
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %7, align 4, !tbaa !12
  %8 = getelementptr inbounds i32, ptr %7, i64 4
  %wide.load8 = load <4 x i32>, ptr %8, align 4, !tbaa !12
  %9 = getelementptr inbounds i32, ptr %call.i.i, i64 %index
  store <4 x i32> %wide.load, ptr %9, align 4, !tbaa !12
  %10 = getelementptr inbounds i32, ptr %9, i64 4
  store <4 x i32> %wide.load8, ptr %10, align 4, !tbaa !12
...
for.body.i.i.prol:                                ; preds = %for.body.i.i.preheader, %for.body.i.i.prol
  ...
  %14 = load i32, ptr %arrayidx.i.i.prol, align 4, !tbaa !12
  %arrayidx7.i.i.prol = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.i.i.prol
  store i32 %14, ptr %arrayidx7.i.i.prol, align 4, !tbaa !12
...
delete.notnull.i.i:                               ; preds = %for.body.i.i.prol.loopexit, %for.body.i.i, %middle.block, %for.cond.cleanup.i.i
  tail call void @_ZdaPv(ptr noundef nonnull %.pre.i.i) #8
...
if.then:                                          ; preds = %if.end7.i, %entry, %_ZNK11CStringBaseIwE11ReverseFindEw.exit
  ...
  br i1 %cmp.i18, label %_ZN11CStringBaseIwEaSERKS0_.exit, label %if.end.i19
...
if.else:                                          ; preds = %_ZNK11CStringBaseIwE11ReverseFindEw.exit
  ...
  br i1 %cmp.i23, label %if.else.invoke.cont_crit_edge, label %if.end.i24
...
if.end.i24:                                       ; preds = %if.else
  %_length.i.i25 = getelementptr inbounds %class.CStringBase, ptr %pureName, i64 0, i32 1
  store i32 0, ptr %_length.i.i25, align 8, !tbaa !5
  ...
  %18 = load i32, ptr %_length.i26, align 8, !tbaa !5
  %add.i.i27 = add nsw i32 %18, 1
  %_capacity.i.i28 = getelementptr inbounds %class.CStringBase, ptr %pureName, i64 0, i32 2
  %19 = load i32, ptr %_capacity.i.i28, align 4, !tbaa !16
  %cmp.i.i29 = icmp eq i32 %add.i.i27, %19
...
if.end.i.i30:                                     ; preds = %if.end.i24
  ...
  %21 = shl nuw nsw i64 %conv.i.i31, 2
  %22 = select i1 %20, i64 -1, i64 %21
  %call.i.i3247 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %22) #7
          to label %call.i.i32.noexc unwind label %lpad

call.i.i32.noexc:                                 ; preds = %if.end.i.i30
  %cmp3.i.i33 = icmp sgt i32 %19, 0
  br i1 %cmp3.i.i33, label %delete.notnull.i.i45, label %if.end9.i.i34

delete.notnull.i.i45:                             ; preds = %call.i.i32.noexc
  call void @_ZdaPv(ptr noundef nonnull %17) #8
  %.pre.i46 = load i32, ptr %_length.i.i25, align 8, !tbaa !5
  %23 = sext i32 %.pre.i46 to i64
  br label %if.end9.i.i34

if.end9.i.i34:                                    ; preds = %delete.notnull.i.i45, %call.i.i32.noexc
  %idxprom13.i.i35 = phi i64 [ %23, %delete.notnull.i.i45 ], [ 0, %call.i.i32.noexc ]
  store ptr %call.i.i3247, ptr %pureName, align 8, !tbaa !11
  %arrayidx14.i.i36 = getelementptr inbounds i32, ptr %call.i.i3247, i64 %idxprom13.i.i35
  store i32 0, ptr %arrayidx14.i.i36, align 4, !tbaa !12
  store i32 %add.i.i27, ptr %_capacity.i.i28, align 4, !tbaa !16
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i37:      ; preds = %if.end9.i.i34, %if.end.i24
  %24 = phi ptr [ %17, %if.end.i24 ], [ %call.i.i3247, %if.end9.i.i34 ]
...
while.cond.i.i38:                                 ; preds = %while.cond.i.i38, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i37
  %src.addr.0.i.i39 = phi ptr [ %25, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i37 ], [ %incdec.ptr.i.i41, %while.cond.i.i38 ]
  %dest.addr.0.i.i40 = phi ptr [ %24, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i37 ], [ %incdec.ptr1.i.i42, %while.cond.i.i38 ]
  ...
  br i1 %cmp.not.i.i43, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i44, label %while.cond.i.i38, !llvm.loop !23

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i44:          ; preds = %while.cond.i.i38
  %27 = load i32, ptr %_length.i26, align 8, !tbaa !5
  store i32 %27, ptr %_length.i.i25, align 8, !tbaa !5
  br label %invoke.cont

invoke.cont:                                      ; preds = %if.else.invoke.cont_crit_edge, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i44
  %28 = phi ptr [ %.pre, %if.else.invoke.cont_crit_edge ], [ %25, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i44 ]
...
_ZN11CStringBaseIwED2Ev.exit:                     ; preds = %invoke.cont, %delete.notnull.i
  ...
  br i1 %cmp.i.i51, label %_ZN11CStringBaseIwEaSEw.exit, label %if.end.i.i52

if.end.i.i52:                                     ; preds = %_ZN11CStringBaseIwED2Ev.exit
  %call.i.i53 = call noalias noundef nonnull dereferenceable(8) ptr @_Znam(i64 noundef 8) #7
  %cmp3.i.i54 = icmp sgt i32 %30, 0
  br i1 %cmp3.i.i54, label %delete.notnull.i.i59, label %if.end9.i.i55

delete.notnull.i.i59:                             ; preds = %if.end.i.i52
  call void @_ZdaPv(ptr noundef nonnull %29) #8
  %.pre.i60 = load i32, ptr %_length.i.i49, align 8, !tbaa !5
  %31 = sext i32 %.pre.i60 to i64
  br label %if.end9.i.i55

if.end9.i.i55:                                    ; preds = %delete.notnull.i.i59, %if.end.i.i52
  %idxprom13.i.i56 = phi i64 [ %31, %delete.notnull.i.i59 ], [ 0, %if.end.i.i52 ]
  store ptr %call.i.i53, ptr %extensionDelimiter, align 8, !tbaa !11
  %arrayidx14.i.i57 = getelementptr inbounds i32, ptr %call.i.i53, i64 %idxprom13.i.i56
...
_ZN11CStringBaseIwEaSEw.exit:                     ; preds = %_ZN11CStringBaseIwED2Ev.exit, %if.end9.i.i55
  %32 = phi ptr [ %29, %_ZN11CStringBaseIwED2Ev.exit ], [ %call.i.i53, %if.end9.i.i55 ]
  ...
  br i1 %cmp.i62, label %_ZN11CStringBaseIwEaSEw.exit.invoke.cont6_crit_edge, label %if.end.i63
...
if.end.i63:                                       ; preds = %_ZN11CStringBaseIwEaSEw.exit
  %_length.i.i64 = getelementptr inbounds %class.CStringBase, ptr %extension, i64 0, i32 1
  store i32 0, ptr %_length.i.i64, align 8, !tbaa !5
  %34 = load ptr, ptr %extension, align 8, !tbaa !11
  store i32 0, ptr %34, align 4, !tbaa !12
  %_length.i65 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp4, i64 0, i32 1
  %35 = load i32, ptr %_length.i65, align 8, !tbaa !5
  %add.i.i66 = add nsw i32 %35, 1
  %_capacity.i.i67 = getelementptr inbounds %class.CStringBase, ptr %extension, i64 0, i32 2
  %36 = load i32, ptr %_capacity.i.i67, align 4, !tbaa !16
  %cmp.i.i68 = icmp eq i32 %add.i.i66, %36
  br i1 %cmp.i.i68, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i76, label %if.end.i.i69

if.end.i.i69:                                     ; preds = %if.end.i63
  %conv.i.i70 = zext i32 %add.i.i66 to i64
  %37 = icmp slt i32 %35, -1
  %38 = shl nuw nsw i64 %conv.i.i70, 2
  %39 = select i1 %37, i64 -1, i64 %38
  %call.i.i7186 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %39) #7
          to label %call.i.i71.noexc unwind label %lpad5

call.i.i71.noexc:                                 ; preds = %if.end.i.i69
  %cmp3.i.i72 = icmp sgt i32 %36, 0
  br i1 %cmp3.i.i72, label %delete.notnull.i.i84, label %if.end9.i.i73

delete.notnull.i.i84:                             ; preds = %call.i.i71.noexc
  call void @_ZdaPv(ptr noundef nonnull %34) #8
  %.pre.i85 = load i32, ptr %_length.i.i64, align 8, !tbaa !5
  %40 = sext i32 %.pre.i85 to i64
  br label %if.end9.i.i73

if.end9.i.i73:                                    ; preds = %delete.notnull.i.i84, %call.i.i71.noexc
  %idxprom13.i.i74 = phi i64 [ %40, %delete.notnull.i.i84 ], [ 0, %call.i.i71.noexc ]
  store ptr %call.i.i7186, ptr %extension, align 8, !tbaa !11
  %arrayidx14.i.i75 = getelementptr inbounds i32, ptr %call.i.i7186, i64 %idxprom13.i.i74
  store i32 0, ptr %arrayidx14.i.i75, align 4, !tbaa !12
  store i32 %add.i.i66, ptr %_capacity.i.i67, align 4, !tbaa !16
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i76

_ZN11CStringBaseIwE11SetCapacityEi.exit.i76:      ; preds = %if.end9.i.i73, %if.end.i63
  %41 = phi ptr [ %34, %if.end.i63 ], [ %call.i.i7186, %if.end9.i.i73 ]
  %42 = load ptr, ptr %ref.tmp4, align 8, !tbaa !11
  br label %while.cond.i.i77

while.cond.i.i77:                                 ; preds = %while.cond.i.i77, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i76
  %src.addr.0.i.i78 = phi ptr [ %42, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i76 ], [ %incdec.ptr.i.i80, %while.cond.i.i77 ]
  %dest.addr.0.i.i79 = phi ptr [ %41, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i76 ], [ %incdec.ptr1.i.i81, %while.cond.i.i77 ]
  ...
  br i1 %cmp.not.i.i82, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i83, label %while.cond.i.i77, !llvm.loop !23

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i83:          ; preds = %while.cond.i.i77
  %44 = load i32, ptr %_length.i65, align 8, !tbaa !5
  store i32 %44, ptr %_length.i.i64, align 8, !tbaa !5
  br label %invoke.cont6

invoke.cont6:                                     ; preds = %_ZN11CStringBaseIwEaSEw.exit.invoke.cont6_crit_edge, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i83
  %45 = phi ptr [ %.pre101, %_ZN11CStringBaseIwEaSEw.exit.invoke.cont6_crit_edge ], [ %42, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i83 ]
...
if.end8:                                          ; preds = %entry
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %agg.result, i8 0, i64 16, i1 false)
  %call.i.i33 = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #7
  store ptr %call.i.i33, ptr %agg.result, align 8, !tbaa !11
  store i32 0, ptr %call.i.i33, align 4, !tbaa !12
  store i32 4, ptr %_capacity.i32, align 4, !tbaa !16
...
_ZN11CStringBaseIwE11SetCapacityEi.exit:          ; preds = %if.end.i
  tail call void @_ZdaPv(ptr noundef nonnull %call.i.i33) #8
  store ptr %call.i36, ptr %agg.result, align 8, !tbaa !11
  store i32 0, ptr %call.i36, align 4, !tbaa !12
  store i32 %add.i, ptr %_capacity.i32, align 4, !tbaa !16
