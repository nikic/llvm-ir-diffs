...
sw.bb2:                                           ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0(i64 128, ptr nonnull %buffer.i) #12, !noalias !44
...
_Z11MyStringLenIwEiPKT_.exit.i.i:                 ; preds = %for.cond.i.i.i
  ...
  %call.i.i.i = call noalias noundef nonnull ptr @_Znam(i64 noundef %15) #14, !noalias !44
...
_ZL21ConvertUInt64ToStringy.exit:                 ; preds = %while.cond.i.i.i
  ...
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %buffer.i) #12, !noalias !44
  br label %return
...
sw.bb4:                                           ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0(i64 128, ptr nonnull %buffer.i29) #12, !noalias !47
...
for.cond.i.i.i30:                                 ; preds = %for.cond.i.i.i30, %sw.bb4
  ...
  %19 = load i32, ptr %arrayidx.i.i.i32, align 4, !tbaa !38, !noalias !47
  %cmp.not.i.i.i33 = icmp eq i32 %19, 0
  %indvars.iv.next.i.i.i34 = add nuw i64 %indvars.iv.i.i.i31, 1
  br i1 %cmp.not.i.i.i33, label %_Z11MyStringLenIwEiPKT_.exit.i.i35, label %for.cond.i.i.i30, !llvm.loop !41
...
_Z11MyStringLenIwEiPKT_.exit.i.i35:               ; preds = %for.cond.i.i.i30
  ...
  %call.i.i.i41 = call noalias noundef nonnull ptr @_Znam(i64 noundef %23) #14, !noalias !47
  store ptr %call.i.i.i41, ptr %agg.result, align 8, !tbaa !36, !alias.scope !47
  store i32 0, ptr %call.i.i.i41, align 4, !tbaa !38, !noalias !47
  store i32 %add.i.i.i36, ptr %_capacity.i.i39, align 4, !tbaa !40, !alias.scope !47
...
while.cond.i.i.i43:                               ; preds = %_Z11MyStringLenIwEiPKT_.exit.i.i35, %while.cond.i.i.i43
  ...
  %24 = load i32, ptr %src.addr.0.i.i.i44, align 4, !tbaa !38, !noalias !47
  %incdec.ptr1.i.i.i47 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i45, i64 1
  store i32 %24, ptr %dest.addr.0.i.i.i45, align 4, !tbaa !38, !noalias !47
  %cmp.not.i10.i.i48 = icmp eq i32 %24, 0
  br i1 %cmp.not.i10.i.i48, label %_ZL21ConvertUInt64ToStringy.exit50, label %while.cond.i.i.i43, !llvm.loop !42
...
_ZL21ConvertUInt64ToStringy.exit50:               ; preds = %while.cond.i.i.i43
  ...
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %buffer.i29) #12, !noalias !47
  br label %return
...
sw.bb6:                                           ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0(i64 128, ptr nonnull %buffer.i51) #12, !noalias !50
...
for.cond.i.i.i52:                                 ; preds = %for.cond.i.i.i52, %sw.bb6
  ...
  %27 = load i32, ptr %arrayidx.i.i.i54, align 4, !tbaa !38, !noalias !50
  %cmp.not.i.i.i55 = icmp eq i32 %27, 0
  %indvars.iv.next.i.i.i56 = add nuw i64 %indvars.iv.i.i.i53, 1
  br i1 %cmp.not.i.i.i55, label %_Z11MyStringLenIwEiPKT_.exit.i.i57, label %for.cond.i.i.i52, !llvm.loop !41
...
_Z11MyStringLenIwEiPKT_.exit.i.i57:               ; preds = %for.cond.i.i.i52
  ...
  %call.i.i.i63 = call noalias noundef nonnull ptr @_Znam(i64 noundef %31) #14, !noalias !50
  store ptr %call.i.i.i63, ptr %agg.result, align 8, !tbaa !36, !alias.scope !50
  store i32 0, ptr %call.i.i.i63, align 4, !tbaa !38, !noalias !50
  store i32 %add.i.i.i58, ptr %_capacity.i.i61, align 4, !tbaa !40, !alias.scope !50
...
while.cond.i.i.i65:                               ; preds = %_Z11MyStringLenIwEiPKT_.exit.i.i57, %while.cond.i.i.i65
  ...
  %32 = load i32, ptr %src.addr.0.i.i.i66, align 4, !tbaa !38, !noalias !50
  %incdec.ptr1.i.i.i69 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i67, i64 1
  store i32 %32, ptr %dest.addr.0.i.i.i67, align 4, !tbaa !38, !noalias !50
  %cmp.not.i10.i.i70 = icmp eq i32 %32, 0
  br i1 %cmp.not.i10.i.i70, label %_ZL21ConvertUInt64ToStringy.exit72, label %while.cond.i.i.i65, !llvm.loop !42
...
_ZL21ConvertUInt64ToStringy.exit72:               ; preds = %while.cond.i.i.i65
  ...
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %buffer.i51) #12, !noalias !50
  br label %return
...
sw.bb8:                                           ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0(i64 128, ptr nonnull %buffer.i73) #12, !noalias !53
...
for.cond.i.i.i74:                                 ; preds = %for.cond.i.i.i74, %sw.bb8
  ...
  %35 = load i32, ptr %arrayidx.i.i.i76, align 4, !tbaa !38, !noalias !53
  %cmp.not.i.i.i77 = icmp eq i32 %35, 0
  %indvars.iv.next.i.i.i78 = add nuw i64 %indvars.iv.i.i.i75, 1
  br i1 %cmp.not.i.i.i77, label %_Z11MyStringLenIwEiPKT_.exit.i.i79, label %for.cond.i.i.i74, !llvm.loop !41
...
_Z11MyStringLenIwEiPKT_.exit.i.i79:               ; preds = %for.cond.i.i.i74
  ...
  %call.i.i.i85 = call noalias noundef nonnull ptr @_Znam(i64 noundef %39) #14, !noalias !53
  store ptr %call.i.i.i85, ptr %agg.result, align 8, !tbaa !36, !alias.scope !53
  store i32 0, ptr %call.i.i.i85, align 4, !tbaa !38, !noalias !53
  store i32 %add.i.i.i80, ptr %_capacity.i.i83, align 4, !tbaa !40, !alias.scope !53
...
while.cond.i.i.i87:                               ; preds = %_Z11MyStringLenIwEiPKT_.exit.i.i79, %while.cond.i.i.i87
  ...
  %40 = load i32, ptr %src.addr.0.i.i.i88, align 4, !tbaa !38, !noalias !53
  %incdec.ptr1.i.i.i91 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i89, i64 1
  store i32 %40, ptr %dest.addr.0.i.i.i89, align 4, !tbaa !38, !noalias !53
  %cmp.not.i10.i.i92 = icmp eq i32 %40, 0
  br i1 %cmp.not.i10.i.i92, label %_ZL21ConvertUInt64ToStringy.exit94, label %while.cond.i.i.i87, !llvm.loop !42
...
_ZL21ConvertUInt64ToStringy.exit94:               ; preds = %while.cond.i.i.i87
  ...
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %buffer.i73) #12, !noalias !53
  br label %return
...
sw.bb10:                                          ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0(i64 128, ptr nonnull %buffer.i95) #12, !noalias !56
...
for.cond.i.i.i96:                                 ; preds = %for.cond.i.i.i96, %sw.bb10
  ...
  %44 = load i32, ptr %arrayidx.i.i.i98, align 4, !tbaa !38, !noalias !56
  %cmp.not.i.i.i99 = icmp eq i32 %44, 0
  %indvars.iv.next.i.i.i100 = add nuw i64 %indvars.iv.i.i.i97, 1
  br i1 %cmp.not.i.i.i99, label %_Z11MyStringLenIwEiPKT_.exit.i.i101, label %for.cond.i.i.i96, !llvm.loop !41
...
_Z11MyStringLenIwEiPKT_.exit.i.i101:              ; preds = %for.cond.i.i.i96
  ...
  %call.i.i.i107 = call noalias noundef nonnull ptr @_Znam(i64 noundef %48) #14, !noalias !56
  store ptr %call.i.i.i107, ptr %agg.result, align 8, !tbaa !36, !alias.scope !56
  store i32 0, ptr %call.i.i.i107, align 4, !tbaa !38, !noalias !56
  store i32 %add.i.i.i102, ptr %_capacity.i.i105, align 4, !tbaa !40, !alias.scope !56
...
while.cond.i.i.i109:                              ; preds = %_Z11MyStringLenIwEiPKT_.exit.i.i101, %while.cond.i.i.i109
  ...
  %49 = load i32, ptr %src.addr.0.i.i.i110, align 4, !tbaa !38, !noalias !56
  %incdec.ptr1.i.i.i113 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i111, i64 1
  store i32 %49, ptr %dest.addr.0.i.i.i111, align 4, !tbaa !38, !noalias !56
  %cmp.not.i10.i.i114 = icmp eq i32 %49, 0
  br i1 %cmp.not.i10.i.i114, label %_ZL20ConvertInt64ToStringx.exit, label %while.cond.i.i.i109, !llvm.loop !42
...
_ZL20ConvertInt64ToStringx.exit:                  ; preds = %while.cond.i.i.i109
  ...
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %buffer.i95) #12, !noalias !56
  br label %return
...
sw.bb12:                                          ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0(i64 128, ptr nonnull %buffer.i116) #12, !noalias !59
...
for.cond.i.i.i117:                                ; preds = %for.cond.i.i.i117, %sw.bb12
  ...
  %52 = load i32, ptr %arrayidx.i.i.i119, align 4, !tbaa !38, !noalias !59
  %cmp.not.i.i.i120 = icmp eq i32 %52, 0
  %indvars.iv.next.i.i.i121 = add nuw i64 %indvars.iv.i.i.i118, 1
  br i1 %cmp.not.i.i.i120, label %_Z11MyStringLenIwEiPKT_.exit.i.i122, label %for.cond.i.i.i117, !llvm.loop !41
...
_Z11MyStringLenIwEiPKT_.exit.i.i122:              ; preds = %for.cond.i.i.i117
  ...
  %call.i.i.i128 = call noalias noundef nonnull ptr @_Znam(i64 noundef %56) #14, !noalias !59
  store ptr %call.i.i.i128, ptr %agg.result, align 8, !tbaa !36, !alias.scope !59
  store i32 0, ptr %call.i.i.i128, align 4, !tbaa !38, !noalias !59
  store i32 %add.i.i.i123, ptr %_capacity.i.i126, align 4, !tbaa !40, !alias.scope !59
...
while.cond.i.i.i130:                              ; preds = %_Z11MyStringLenIwEiPKT_.exit.i.i122, %while.cond.i.i.i130
  ...
  %57 = load i32, ptr %src.addr.0.i.i.i131, align 4, !tbaa !38, !noalias !59
  %incdec.ptr1.i.i.i134 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i132, i64 1
  store i32 %57, ptr %dest.addr.0.i.i.i132, align 4, !tbaa !38, !noalias !59
  %cmp.not.i10.i.i135 = icmp eq i32 %57, 0
  br i1 %cmp.not.i10.i.i135, label %_ZL20ConvertInt64ToStringx.exit137, label %while.cond.i.i.i130, !llvm.loop !42
...
_ZL20ConvertInt64ToStringx.exit137:               ; preds = %while.cond.i.i.i130
  ...
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %buffer.i116) #12, !noalias !59
  br label %return
...
sw.bb14:                                          ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0(i64 128, ptr nonnull %buffer.i138) #12, !noalias !62
...
for.cond.i.i.i139:                                ; preds = %for.cond.i.i.i139, %sw.bb14
  ...
  %60 = load i32, ptr %arrayidx.i.i.i141, align 4, !tbaa !38, !noalias !62
  %cmp.not.i.i.i142 = icmp eq i32 %60, 0
  %indvars.iv.next.i.i.i143 = add nuw i64 %indvars.iv.i.i.i140, 1
  br i1 %cmp.not.i.i.i142, label %_Z11MyStringLenIwEiPKT_.exit.i.i144, label %for.cond.i.i.i139, !llvm.loop !41
...
_Z11MyStringLenIwEiPKT_.exit.i.i144:              ; preds = %for.cond.i.i.i139
  ...
  %call.i.i.i150 = call noalias noundef nonnull ptr @_Znam(i64 noundef %64) #14, !noalias !62
  store ptr %call.i.i.i150, ptr %agg.result, align 8, !tbaa !36, !alias.scope !62
  store i32 0, ptr %call.i.i.i150, align 4, !tbaa !38, !noalias !62
  store i32 %add.i.i.i145, ptr %_capacity.i.i148, align 4, !tbaa !40, !alias.scope !62
...
while.cond.i.i.i152:                              ; preds = %_Z11MyStringLenIwEiPKT_.exit.i.i144, %while.cond.i.i.i152
  ...
  %65 = load i32, ptr %src.addr.0.i.i.i153, align 4, !tbaa !38, !noalias !62
  %incdec.ptr1.i.i.i156 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i154, i64 1
  store i32 %65, ptr %dest.addr.0.i.i.i154, align 4, !tbaa !38, !noalias !62
  %cmp.not.i10.i.i157 = icmp eq i32 %65, 0
  br i1 %cmp.not.i10.i.i157, label %_ZL20ConvertInt64ToStringx.exit159, label %while.cond.i.i.i152, !llvm.loop !42
...
_ZL20ConvertInt64ToStringx.exit159:               ; preds = %while.cond.i.i.i152
  ...
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %buffer.i138) #12, !noalias !62
  br label %return
...
for.cond.i.i161:                                  ; preds = %for.cond.i.i161, %sw.bb16
  ...
  %68 = load i32, ptr %arrayidx.i.i163, align 4, !tbaa !38
  %cmp.not.i.i164 = icmp eq i32 %68, 0
  %indvars.iv.next.i.i165 = add nuw i64 %indvars.iv.i.i162, 1
  br i1 %cmp.not.i.i164, label %_Z11MyStringLenIwEiPKT_.exit.i166, label %for.cond.i.i161, !llvm.loop !41
...
_Z11MyStringLenIwEiPKT_.exit.i166:                ; preds = %for.cond.i.i161
  ...
  store ptr %call.i.i171, ptr %agg.result, align 8, !tbaa !36
  store i32 0, ptr %call.i.i171, align 4, !tbaa !38
  store i32 %add.i.i167, ptr %_capacity.i160, align 4, !tbaa !40
...
while.cond.i.i173:                                ; preds = %_Z11MyStringLenIwEiPKT_.exit.i166, %while.cond.i.i173
  ...
  %73 = load i32, ptr %src.addr.0.i.i174, align 4, !tbaa !38
  %incdec.ptr1.i.i177 = getelementptr inbounds i32, ptr %dest.addr.0.i.i175, i64 1
  store i32 %73, ptr %dest.addr.0.i.i175, align 4, !tbaa !38
  %cmp.not.i10.i178 = icmp eq i32 %73, 0
  br i1 %cmp.not.i10.i178, label %_ZN11CStringBaseIwEC2EPKw.exit180, label %while.cond.i.i173, !llvm.loop !42
