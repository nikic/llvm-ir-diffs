...
for.cond.i.i33:                                   ; preds = %for.cond.i.i33, %if.else
  ...
  %7 = load i8, ptr %arrayidx.i.i35, align 1, !tbaa !11
  %cmp.not.i.i36 = icmp eq i8 %7, 0
  %indvars.iv.next.i.i37 = add nuw i64 %indvars.iv.i.i34, 1
  br i1 %cmp.not.i.i36, label %_Z11MyStringLenIcEiPKT_.exit.i38, label %for.cond.i.i33, !llvm.loop !14
...
if.end9.i.i47:                                    ; preds = %if.end.i.i42
  tail call void @_ZdaPv(ptr noundef nonnull %call.i.i) #10
  store ptr %call.i.i4474, ptr %msg, align 8, !tbaa !5
  store i8 0, ptr %call.i.i4474, align 1, !tbaa !11
  store i32 %add.i.i39, ptr %_capacity.i, align 4, !tbaa !12
...
while.cond.i.i51:                                 ; preds = %while.cond.i.i51, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i50
  ...
  %10 = load i8, ptr %src.addr.0.i.i52, align 1, !tbaa !11
  %incdec.ptr1.i.i55 = getelementptr inbounds i8, ptr %dest.addr.0.i.i53, i64 1
  store i8 %10, ptr %dest.addr.0.i.i53, align 1, !tbaa !11
  %cmp.not.i9.i56 = icmp eq i8 %10, 0
  br i1 %cmp.not.i9.i56, label %invoke.cont12, label %while.cond.i.i51, !llvm.loop !16
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %15, align 1, !tbaa !11
  %16 = getelementptr inbounds i8, ptr %15, i64 16
  %wide.load133 = load <16 x i8>, ptr %16, align 1, !tbaa !11
  %17 = getelementptr inbounds i8, ptr %call.i.i.i92, i64 %index
  store <16 x i8> %wide.load, ptr %17, align 1, !tbaa !11
  %18 = getelementptr inbounds i8, ptr %17, i64 16
  store <16 x i8> %wide.load133, ptr %18, align 1, !tbaa !11
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load138 = load <8 x i8>, ptr %20, align 1, !tbaa !11
  %21 = getelementptr inbounds i8, ptr %call.i.i.i92, i64 %index137
  store <8 x i8> %wide.load138, ptr %21, align 1, !tbaa !11
  %index.next139 = add nuw i64 %index137, 8
  %22 = icmp eq i64 %index.next139, %n.vec135
  br i1 %22, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !20
...
for.body.i.i.i.prol:                              ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i.prol
  ...
  %25 = load i8, ptr %arrayidx.i.i.i.prol, align 1, !tbaa !11
  %arrayidx7.i.i.i.prol = getelementptr inbounds i8, ptr %call.i.i.i92, i64 %indvars.iv.i.i.i.prol
  store i8 %25, ptr %arrayidx7.i.i.i.prol, align 1, !tbaa !11
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  ...
  %30 = load i8, ptr %arrayidx.i.i.i.3, align 1, !tbaa !11
  %arrayidx7.i.i.i.3 = getelementptr inbounds i8, ptr %call.i.i.i92, i64 %indvars.iv.next.i.i.i.2
  store i8 %30, ptr %arrayidx7.i.i.i.3, align 1, !tbaa !11
...
if.end9.i.i.i:                                    ; preds = %delete.notnull.i.i.i, %call.i.i.i.noexc
  store ptr %call.i.i.i92, ptr %msg, align 8, !tbaa !5
...
_ZN11CStringBaseIcE10GrowLengthEi.exit.i:         ; preds = %if.end9.i.i.i, %if.end.i.i89, %if.end
  ...
  store i8 0, ptr %incdec.ptr1.i.i88.15, align 1, !tbaa !11
  %32 = load i32, ptr %_length.i.i83, align 8, !tbaa !13
  %add.i = add nsw i32 %32, 16
  store i32 %add.i, ptr %_length.i.i83, align 8, !tbaa !13
...
delete.notnull.i.i110:                            ; preds = %call.i.i99.noexc
  ...
  %.pre.i111 = load i32, ptr %_length.i.i93, align 8, !tbaa !26
...
if.end9.i.i101:                                   ; preds = %delete.notnull.i.i110, %call.i.i99.noexc
  ...
  store ptr %call.i.i99112, ptr %message, align 8, !tbaa !24
  %arrayidx14.i.i103 = getelementptr inbounds i32, ptr %call.i.i99112, i64 %idxprom13.i.i102
  store i32 0, ptr %arrayidx14.i.i103, align 4, !tbaa !27
  store i32 %add.i.i94, ptr %_capacity.i.i95, align 4, !tbaa !29
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i:        ; preds = %if.end9.i.i101, %if.end.i
  ...
  %41 = load ptr, ptr %ref.tmp, align 8, !tbaa !24
...
while.cond.i.i104:                                ; preds = %while.cond.i.i104, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i
  ...
  %42 = load i32, ptr %src.addr.0.i.i105, align 4, !tbaa !27
  %incdec.ptr1.i.i108 = getelementptr inbounds i32, ptr %dest.addr.0.i.i106, i64 1
  store i32 %42, ptr %dest.addr.0.i.i106, align 4, !tbaa !27
  %cmp.not.i.i109 = icmp eq i32 %42, 0
  br i1 %cmp.not.i.i109, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i, label %while.cond.i.i104, !llvm.loop !30

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i:            ; preds = %while.cond.i.i104
  %43 = load i32, ptr %_length.i, align 8, !tbaa !26
  store i32 %43, ptr %_length.i.i93, align 8, !tbaa !26
  br label %invoke.cont19
...
_ZN11CStringBaseIwED2Ev.exit:                     ; preds = %invoke.cont19, %delete.notnull.i
  ...
  %45 = load ptr, ptr %msg, align 8, !tbaa !5
...
lpad18:                                           ; preds = %if.end.i.i97
  %47 = landingpad { ptr, i32 }
          cleanup
  %48 = load ptr, ptr %ref.tmp, align 8, !tbaa !24
