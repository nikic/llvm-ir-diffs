...
for.cond.i.i9:                                    ; preds = %for.cond.i.i9, %_ZL16nameWindowToUnixPKc.exit
  ...
  %10 = load i8, ptr %arrayidx.i.i11, align 1, !tbaa !20
  %cmp.not.i.i12 = icmp eq i8 %10, 0
  %indvars.iv.next.i.i13 = add nuw i64 %indvars.iv.i.i10, 1
  br i1 %cmp.not.i.i12, label %_Z11MyStringLenIcEiPKT_.exit.i, label %for.cond.i.i9, !llvm.loop !21
...
call.i.i18.noexc:                                 ; preds = %_Z11MyStringLenIcEiPKT_.exit.i
  ...
  store ptr %call.i.i1826, ptr %agg.result, align 8, !tbaa !18
  store i8 0, ptr %call.i.i1826, align 1, !tbaa !20
...
while.cond.i.i19:                                 ; preds = %call.i.i18.noexc, %while.cond.i.i19
  ...
  %12 = load i8, ptr %src.addr.0.i.i20, align 1, !tbaa !20
  %incdec.ptr1.i.i23 = getelementptr inbounds i8, ptr %dest.addr.0.i.i21, i64 1
  store i8 %12, ptr %dest.addr.0.i.i21, align 1, !tbaa !20
  %cmp.not.i10.i24 = icmp eq i8 %12, 0
  br i1 %cmp.not.i10.i24, label %_ZN11CStringBaseIcED2Ev.exit, label %while.cond.i.i19, !llvm.loop !23
...
for.cond.preheader.i.i:                           ; preds = %if.end.i.i
  ...
  %.pre.i.i = load ptr, ptr %resultPath, align 8, !tbaa !11
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load21 = load <4 x i32>, ptr %4, align 4, !tbaa !5
  %5 = getelementptr inbounds i32, ptr %call.i.i, i64 %index
  store <4 x i32> %wide.load, ptr %5, align 4, !tbaa !5
  %6 = getelementptr inbounds i32, ptr %5, i64 4
  store <4 x i32> %wide.load21, ptr %6, align 4, !tbaa !5
  %index.next = add nuw i64 %index, 8
  %7 = icmp eq i64 %index.next, %n.vec
  br i1 %7, label %middle.block, label %vector.body, !llvm.loop !33
...
for.body.i.i.prol:                                ; preds = %for.body.i.i.preheader, %for.body.i.i.prol
  ...
  %10 = load i32, ptr %arrayidx.i.i.prol, align 4, !tbaa !5
  %arrayidx7.i.i.prol = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.i.i.prol
  store i32 %10, ptr %arrayidx7.i.i.prol, align 4, !tbaa !5
...
if.end9.i.i:                                      ; preds = %delete.notnull.i.i, %for.cond.cleanup.i.i, %if.end.i.i
  ...
  %16 = load i32, ptr %_length12.i.i, align 8, !tbaa !17
...
_ZN11CStringBaseIwE9GetBufferEi.exit:             ; preds = %entry._ZN11CStringBaseIwE9GetBufferEi.exit_crit_edge, %if.end9.i.i
  ...
  %18 = load ptr, ptr %resultPath, align 8, !tbaa !11
  br label %for.cond.i.i
...
for.cond.i.i:                                     ; preds = %for.cond.i.i, %_ZN11CStringBaseIwE9GetBufferEi.exit
  ...
  %19 = load i32, ptr %arrayidx.i.i16, align 4, !tbaa !5
...
_ZN11CStringBaseIwE13ReleaseBufferEv.exit:        ; preds = %for.cond.i.i
  ...
  store i32 %20, ptr %_length.i.i18, align 8, !tbaa !17
  %21 = add i32 %call1, -1
  %or.cond = icmp ult i32 %21, 4095
  br i1 %or.cond, label %if.end, label %cleanup

if.end:                                           ; preds = %_ZN11CStringBaseIwE13ReleaseBufferEv.exit
  %22 = load ptr, ptr %fileNamePointer, align 8, !tbaa !25
...
while.cond.i.i20:                                 ; preds = %while.cond.i.i20, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i
  ...
  %12 = load i32, ptr %src.addr.0.i.i21, align 4, !tbaa !5
  %incdec.ptr1.i.i24 = getelementptr inbounds i32, ptr %dest.addr.0.i.i22, i64 1
  store i32 %12, ptr %dest.addr.0.i.i22, align 4, !tbaa !5
  %cmp.not.i.i25 = icmp eq i32 %12, 0
  br i1 %cmp.not.i.i25, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i, label %while.cond.i.i20, !llvm.loop !16
...
if.then23:                                        ; preds = %if.end
  ...
  %9 = load i32, ptr %st_mode, align 8, !tbaa !41
  %10 = load i32, ptr @_ZL9gbl_umask.1, align 4, !tbaa !45
  %and = and i32 %10, %9
...
call.i.i114.noexc:                                ; preds = %if.end9.i.i111.thread
  store i32 0, ptr %call.i.i114123, align 4, !tbaa !5
...
while.cond.i.i116:                                ; preds = %while.cond.i.i116, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i115
  ...
  %16 = load i32, ptr %src.addr.0.i.i117, align 4, !tbaa !5
  %incdec.ptr1.i.i120 = getelementptr inbounds i32, ptr %dest.addr.0.i.i118, i64 1
  store i32 %16, ptr %dest.addr.0.i.i118, align 4, !tbaa !5
  %cmp.not.i.i121 = icmp eq i32 %16, 0
  br i1 %cmp.not.i.i121, label %while.cond.preheader, label %while.cond.i.i116, !llvm.loop !16
...
if.end25.thread:                                  ; preds = %lor.lhs.false.i, %while.cond
  ...
  store i32 2, ptr %call.i.i127, align 4, !tbaa !29
  br label %if.end30
...
for.cond.i133:                                    ; preds = %if.end7.i137, %if.end.i130
  ...
  %23 = load i32, ptr %p.0.i135, align 4, !tbaa !5
...
if.end7.i137:                                     ; preds = %for.cond.i133
  ...
  br i1 %cmp9.i138, label %cleanup, label %for.cond.i133, !llvm.loop !58
...
invoke.cont45:                                    ; preds = %if.end43
  ...
  %27 = load i32, ptr %_length.i148, align 8, !tbaa !17
...
if.end9.i.i153:                                   ; preds = %delete.notnull.i.i161, %call.i.i152.noexc
  ...
  store i32 0, ptr %arrayidx14.i.i, align 4, !tbaa !5
  store i32 %add.i.i149, ptr %_capacity.i, align 4, !tbaa !15
...
while.cond.i.i155:                                ; preds = %while.cond.i.i155, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i154
  ...
  br i1 %cmp.not.i.i160, label %invoke.cont47, label %while.cond.i.i155, !llvm.loop !16

invoke.cont47:                                    ; preds = %while.cond.i.i155
  %36 = load i32, ptr %_length.i148, align 8, !tbaa !17
...
delete.notnull.i.i186:                            ; preds = %call.i.i174.noexc
  ...
  %.pre.i187 = load i32, ptr %_length.i, align 8, !tbaa !17
...
if.end9.i.i176:                                   ; preds = %delete.notnull.i.i186, %call.i.i174.noexc
  ...
  store ptr %call.i.i174188, ptr %pathName, align 8, !tbaa !11
  %arrayidx14.i.i178 = getelementptr inbounds i32, ptr %call.i.i174188, i64 %idxprom13.i.i177
  store i32 0, ptr %arrayidx14.i.i178, align 4, !tbaa !5
...
while.cond.i.i180:                                ; preds = %while.cond.i.i180.preheader, %while.cond.i.i180
  ...
  %46 = load i32, ptr %src.addr.0.i.i181, align 4, !tbaa !5
  %incdec.ptr1.i.i184 = getelementptr inbounds i32, ptr %dest.addr.0.i.i182, i64 1
  store i32 %46, ptr %dest.addr.0.i.i182, align 4, !tbaa !5
  %cmp.not.i.i185 = icmp eq i32 %46, 0
  br i1 %cmp.not.i.i185, label %_ZN11CStringBaseIwEaSERKS0_.exit189, label %while.cond.i.i180, !llvm.loop !16
...
if.end5.i:                                        ; preds = %if.end.i193
  ...
  br i1 %cmp.i195, label %invoke.cont56, label %if.end.i193, !llvm.loop !60
...
if.then.i216:                                     ; preds = %lor.lhs.false.i207, %invoke.cont65
  ...
  store i32 2, ptr %call.i.i217, align 4, !tbaa !29
...
_ZN11CStringBaseIwED2Ev.exit222:                  ; preds = %invoke.cont69, %delete.notnull.i221
  ...
  br i1 %retval.0.i215, label %while.cond51, label %cleanup, !llvm.loop !61
...
while.cond.i.i.i:                                 ; preds = %while.cond.i.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i
  ...
  br i1 %cmp.not.i.i.i, label %if.end.i.i117, label %while.cond.i.i.i, !llvm.loop !16
...
call.i.i.i49.noexc:                               ; preds = %if.end9.i.i.i46
  ...
  store ptr %call.i.i.i4964, ptr %ref.tmp, align 8, !tbaa !11, !alias.scope !65
  store i32 0, ptr %call.i.i.i4964, align 4, !tbaa !5, !noalias !65
  store i32 %add.i.i.i44, ptr %_capacity.i.i47, align 4, !tbaa !15, !alias.scope !65
...
while.cond.i.i.i51:                               ; preds = %while.cond.i.i.i51, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i50
  ...
  %15 = load i32, ptr %src.addr.0.i.i.i52, align 4, !tbaa !5, !noalias !65
  %incdec.ptr1.i.i.i55 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i53, i64 1
  store i32 %15, ptr %dest.addr.0.i.i.i53, align 4, !tbaa !5, !noalias !65
  %cmp.not.i.i.i56 = icmp eq i32 %15, 0
  br i1 %cmp.not.i.i.i56, label %if.end.i.i135, label %while.cond.i.i.i51, !llvm.loop !16
...
for.body.lr.ph.i.i.i162:                          ; preds = %for.cond.preheader.i.i.i155
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %call.i.i.i150170, ptr align 4 %.pre.i.i.i157, i64 %19, i1 false), !tbaa !5
...
if.end9.i.i.i152:                                 ; preds = %delete.notnull.i.i.i160, %for.cond.cleanup.i.i.i158, %call.i.i.i150.noexc
  store ptr %call.i.i.i150170, ptr %ref.tmp, align 8, !tbaa !11
  %arrayidx14.i.i.i154 = getelementptr inbounds i32, ptr %call.i.i.i150170, i64 %idxprom4.i
  store i32 0, ptr %arrayidx14.i.i.i154, align 4, !tbaa !5
  store i32 %add.i.i.i146, ptr %_capacity.i.i126, align 4, !tbaa !15
...
invoke.cont2:                                     ; preds = %if.end.i.i135, %if.end9.i.i.i152
  ...
  store i32 42, ptr %arrayidx.i131, align 4, !tbaa !5
  store i32 %add.i.i.i44, ptr %_length.i.i58, align 8, !tbaa !17
  %idxprom4.i133 = sext i32 %add.i.i.i44 to i64
  %arrayidx5.i134 = getelementptr inbounds i32, ptr %21, i64 %idxprom4.i133
  store i32 0, ptr %arrayidx5.i134, align 4, !tbaa !5
...
call.i67.noexc:                                   ; preds = %invoke.cont6
  %27 = load i32, ptr %Attrib.i.i, align 8, !tbaa !68
...
call.i.i.i213.noexc:                              ; preds = %if.end9.i.i.i210
  store ptr %call.i.i.i213228, ptr %ref.tmp.i, align 8, !tbaa !11, !alias.scope !71
  store i32 0, ptr %call.i.i.i213228, align 4, !tbaa !5, !noalias !71
  store i32 %add.i.i.i44, ptr %_capacity.i.i211, align 4, !tbaa !15, !alias.scope !71
...
while.cond.i.i.i215:                              ; preds = %while.cond.i.i.i215, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i214
  ...
  %28 = load i32, ptr %src.addr.0.i.i.i216, align 4, !tbaa !5, !noalias !71
  %incdec.ptr1.i.i.i219 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i217, i64 1
  store i32 %28, ptr %dest.addr.0.i.i.i217, align 4, !tbaa !5, !noalias !71
  %cmp.not.i.i.i220 = icmp eq i32 %28, 0
  br i1 %cmp.not.i.i.i220, label %_ZN11CStringBaseIwEC2ERKS0_.exit.i221, label %while.cond.i.i.i215, !llvm.loop !16

_ZN11CStringBaseIwEC2ERKS0_.exit.i221:            ; preds = %while.cond.i.i.i215
  store i32 %add.i.i.i, ptr %_length.i.i222, align 8, !tbaa !17, !alias.scope !71
...
for.body.i.i.i316.preheader:                      ; preds = %for.cond.preheader.i.i.i307
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %call.i.i.i302322, ptr align 4 %.pr, i64 %26, i1 false), !tbaa !5
...
if.end9.i.i.i304:                                 ; preds = %delete.notnull.i.i.i312, %for.cond.cleanup.i.i.i310, %call.i.i.i302.noexc
  store ptr %call.i.i.i302322, ptr %ref.tmp.i, align 8, !tbaa !11
  %arrayidx14.i.i.i306 = getelementptr inbounds i32, ptr %call.i.i.i302322, i64 %idxprom4.i
  store i32 0, ptr %arrayidx14.i.i.i306, align 4, !tbaa !5
  store i32 %add.i.i.i298, ptr %_capacity.i.i211, align 4, !tbaa !15
...
while.cond.i.i280:                                ; preds = %while.cond.i.i280, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i277
  ...
  %35 = load i32, ptr %src.addr.0.i.i281, align 4, !tbaa !5
  %incdec.ptr1.i.i284 = getelementptr inbounds i32, ptr %dest.addr.0.i.i282, i64 1
  store i32 %35, ptr %dest.addr.0.i.i282, align 4, !tbaa !5
  %cmp.not.i8.i285 = icmp eq i32 %35, 0
  br i1 %cmp.not.i8.i285, label %.noexc, label %while.cond.i.i280, !llvm.loop !16
...
.noexc:                                           ; preds = %while.cond.i.i280
  ...
  store i32 %add.i286, ptr %_length.i.i222, align 8, !tbaa !17
...
call.i.i.i184.noexc:                              ; preds = %if.end9.i.i.i181
  store i32 0, ptr %call.i.i.i184198, align 4, !tbaa !5, !noalias !75
...
while.cond.i.i.i186:                              ; preds = %while.cond.i.i.i186, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i185
  ...
  %39 = load i32, ptr %src.addr.0.i.i.i187, align 4, !tbaa !5, !noalias !75
  %incdec.ptr1.i.i.i190 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i188, i64 1
  store i32 %39, ptr %dest.addr.0.i.i.i188, align 4, !tbaa !5, !noalias !75
  %cmp.not.i.i.i191 = icmp eq i32 %39, 0
  br i1 %cmp.not.i.i.i191, label %_ZN11CStringBaseIwEC2ERKS0_.exit.i192, label %while.cond.i.i.i186, !llvm.loop !16
...
for.body.i.i.i265.preheader:                      ; preds = %for.cond.preheader.i.i.i256
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %call.i.i.i251271, ptr align 4 %ref.tmp2.i.sroa.0.1, i64 %26, i1 false), !tbaa !5
...
if.end9.i.i.i253:                                 ; preds = %delete.notnull.i.i.i261, %for.cond.cleanup.i.i.i259, %call.i.i.i251.noexc
  ...
  store i32 0, ptr %arrayidx14.i.i.i255, align 4, !tbaa !5
...
lor.lhs.false.i:                                  ; preds = %.noexc71
  %47 = load i32, ptr %ref.tmp2.i.sroa.0.2, align 4, !tbaa !5
...
.noexc361:                                        ; preds = %if.end.i356
  %48 = load ptr, ptr %unixname.i, align 8, !tbaa !18
...
delete.notnull.i176.thread:                       ; preds = %lor.lhs.false.i
  ...
  store i32 2, ptr %call.i.i360, align 4, !tbaa !29
...
invoke.cont7:                                     ; preds = %.noexc71
  ...
  store i32 2, ptr %call.i.i360365, align 4, !tbaa !29
  br label %cleanup
...
cleanup:                                          ; preds = %delete.notnull.i176, %_ZN11CStringBaseIwED2Ev.exit206, %invoke.cont7, %delete.notnull.i176.thread
  ...
  %55 = load ptr, ptr %_wildcard.i, align 8, !tbaa !11
...
invoke.cont.i.i:                                  ; preds = %_ZN11CStringBaseIwED2Ev.exit.i78
  ...
  %56 = load ptr, ptr %_directory.i.i, align 8, !tbaa !18
...
_ZN11CStringBaseIcED2Ev.exit.i.i:                 ; preds = %delete.notnull.i.i.i, %invoke.cont.i.i
  ...
  %57 = load ptr, ptr %_pattern.i.i, align 8, !tbaa !18
...
cleanup.cont.critedge:                            ; preds = %invoke.cont6
  ...
  %60 = load ptr, ptr %_wildcard.i79, align 8, !tbaa !11
...
invoke.cont.i.i85:                                ; preds = %_ZN11CStringBaseIwED2Ev.exit.i82
  ...
  %61 = load ptr, ptr %_directory.i.i86, align 8, !tbaa !18
...
_ZN11CStringBaseIcED2Ev.exit.i.i89:               ; preds = %delete.notnull.i.i.i88, %invoke.cont.i.i85
  ...
  %62 = load ptr, ptr %_pattern.i.i90, align 8, !tbaa !18
...
if.end18:                                         ; preds = %invoke.cont15
  %67 = load ptr, ptr %path, align 8, !tbaa !11
...
if.then.i.i:                                      ; preds = %lor.lhs.false.i.i, %if.end18
  ...
  store i32 2, ptr %call.i.i.i97, align 4, !tbaa !29
  br label %cleanup23
...
.noexc98:                                         ; preds = %if.end.i.i
  %69 = load ptr, ptr %name.i.i, align 8, !tbaa !18
...
_ZN11CStringBaseIwED2Ev.exit101:                  ; preds = %cleanup23, %delete.notnull.i100
  %70 = load ptr, ptr %Name.i, align 8, !tbaa !11
...
for.cond.i.i57:                                   ; preds = %for.cond.i.i57, %_ZN11CStringBaseIcEC2EPKc.exit
  ...
  %3 = load i32, ptr %arrayidx.i.i59, align 4, !tbaa !5
  %cmp.not.i.i60 = icmp eq i32 %3, 0
  %indvars.iv.next.i.i61 = add nuw i64 %indvars.iv.i.i58, 1
  br i1 %cmp.not.i.i60, label %_Z11MyStringLenIwEiPKT_.exit.i, label %for.cond.i.i57, !llvm.loop !9
...
call.i.i66.noexc:                                 ; preds = %_Z11MyStringLenIwEiPKT_.exit.i
  ...
  store ptr %call.i.i6674, ptr %ref.tmp11, align 8, !tbaa !11
  store i32 0, ptr %call.i.i6674, align 4, !tbaa !5
...
invoke.cont13:                                    ; preds = %invoke.cont
  ...
  %9 = load i32, ptr %_length.i75, align 8, !tbaa !24
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %10, align 1, !tbaa !20
  %11 = getelementptr inbounds i8, ptr %10, i64 16
  %wide.load127 = load <16 x i8>, ptr %11, align 1, !tbaa !20
  %12 = getelementptr inbounds i8, ptr %call.i.i.i83, i64 %index
  store <16 x i8> %wide.load, ptr %12, align 1, !tbaa !20
  %13 = getelementptr inbounds i8, ptr %12, i64 16
  store <16 x i8> %wide.load127, ptr %13, align 1, !tbaa !20
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load132 = load <8 x i8>, ptr %15, align 1, !tbaa !20
  %16 = getelementptr inbounds i8, ptr %call.i.i.i83, i64 %index131
  store <8 x i8> %wide.load132, ptr %16, align 1, !tbaa !20
  %index.next133 = add nuw i64 %index131, 8
  %17 = icmp eq i64 %index.next133, %n.vec129
  br i1 %17, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !79
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i
  ...
  store i8 %18, ptr %arrayidx7.i.i.i, align 1, !tbaa !20
...
while.cond.i.i77:                                 ; preds = %while.cond.i.i77, %_ZN11CStringBaseIcE10GrowLengthEi.exit.i
  ...
  %21 = load i8, ptr %src.addr.0.i.i78, align 1, !tbaa !20
  %incdec.ptr1.i.i81 = getelementptr inbounds i8, ptr %dest.addr.0.i.i79, i64 1
  store i8 %21, ptr %dest.addr.0.i.i79, align 1, !tbaa !20
  %cmp.not.i8.i = icmp eq i8 %21, 0
  br i1 %cmp.not.i8.i, label %invoke.cont15, label %while.cond.i.i77, !llvm.loop !23

invoke.cont15:                                    ; preds = %while.cond.i.i77
  %22 = load i32, ptr %_length.i75, align 8, !tbaa !24
...
_ZN11CStringBaseIwED2Ev.exit:                     ; preds = %_ZN11CStringBaseIcED2Ev.exit, %delete.notnull.i85
  ...
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp) #23
  %26 = load ptr, ptr %file_path, align 8, !tbaa !18
...
if.end9.i.i94:                                    ; preds = %delete.notnull.i.i, %call.i.i93.noexc
  ...
  store ptr %call.i.i93102, ptr %resultPath, align 8, !tbaa !11
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i95:      ; preds = %if.end9.i.i94, %if.end.i
  ...
  %35 = load ptr, ptr %ref.tmp28, align 8, !tbaa !11
...
while.cond.i.i96:                                 ; preds = %while.cond.i.i96, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i95
  ...
  %36 = load i32, ptr %src.addr.0.i.i97, align 4, !tbaa !5
  %incdec.ptr1.i.i100 = getelementptr inbounds i32, ptr %dest.addr.0.i.i98, i64 1
  store i32 %36, ptr %dest.addr.0.i.i98, align 4, !tbaa !5
  %cmp.not.i.i101 = icmp eq i32 %36, 0
  br i1 %cmp.not.i.i101, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i, label %while.cond.i.i96, !llvm.loop !16

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i:            ; preds = %while.cond.i.i96
  %37 = load i32, ptr %_length.i87, align 8, !tbaa !17
  store i32 %37, ptr %_length.i.i86, align 8, !tbaa !17
  br label %invoke.cont32
...
_ZN11CStringBaseIwED2Ev.exit105:                  ; preds = %invoke.cont32, %delete.notnull.i104
  ...
  %39 = load ptr, ptr %file_path, align 8, !tbaa !18
...
_ZN11CStringBaseIwEaSEPKw.exit:                   ; preds = %while.cond.i.i
  ...
  call void @llvm.lifetime.start.p0(i64 128, ptr nonnull %buffer.i) #23, !noalias !85
...
_Z11MyStringLenIwEiPKT_.exit.i.i:                 ; preds = %for.cond.i.i.i
  ...
  %18 = select i1 %16, i64 -1, i64 %17
  %call.i.i.i29 = call noalias noundef nonnull ptr @_Znam(i64 noundef %18) #24, !noalias !85
...
_ZN8NWindows5NFile10NDirectoryL25CSysConvertUInt32ToStringEj.exit: ; preds = %while.cond.i.i.i
  ...
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %buffer.i) #23, !noalias !85
...
_ZN11CStringBaseIwED2Ev.exit:                     ; preds = %invoke.cont, %delete.notnull.i
  ...
  call void @llvm.lifetime.start.p0(i64 128, ptr nonnull %buffer.i31) #23, !noalias !88
...
for.cond.i.i.i32:                                 ; preds = %for.cond.i.i.i32, %_ZN11CStringBaseIwED2Ev.exit
  ...
  %21 = load i32, ptr %arrayidx.i.i.i34, align 4, !tbaa !5, !noalias !88
  %cmp.not.i.i.i35 = icmp eq i32 %21, 0
  %indvars.iv.next.i.i.i36 = add nuw i64 %indvars.iv.i.i.i33, 1
  br i1 %cmp.not.i.i.i35, label %_Z11MyStringLenIwEiPKT_.exit.i.i37, label %for.cond.i.i.i32, !llvm.loop !9
...
_Z11MyStringLenIwEiPKT_.exit.i.i37:               ; preds = %for.cond.i.i.i32
  ...
  %25 = select i1 %23, i64 -1, i64 %24
  %call.i.i.i43 = call noalias noundef nonnull ptr @_Znam(i64 noundef %25) #24, !noalias !88
  store ptr %call.i.i.i43, ptr %ref.tmp8, align 8, !tbaa !11, !alias.scope !88
  store i32 0, ptr %call.i.i.i43, align 4, !tbaa !5, !noalias !88
  store i32 %add.i.i.i38, ptr %_capacity.i.i41, align 4, !tbaa !15, !alias.scope !88
...
while.cond.i.i.i45:                               ; preds = %_Z11MyStringLenIwEiPKT_.exit.i.i37, %while.cond.i.i.i45
  ...
  %26 = load i32, ptr %src.addr.0.i.i.i46, align 4, !tbaa !5, !noalias !88
  %incdec.ptr1.i.i.i49 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i47, i64 1
  store i32 %26, ptr %dest.addr.0.i.i.i47, align 4, !tbaa !5, !noalias !88
  %cmp.not.i10.i.i50 = icmp eq i32 %26, 0
  br i1 %cmp.not.i10.i.i50, label %_ZN8NWindows5NFile10NDirectoryL25CSysConvertUInt32ToStringEj.exit52, label %while.cond.i.i.i45, !llvm.loop !16
...
_ZN8NWindows5NFile10NDirectoryL25CSysConvertUInt32ToStringEj.exit52: ; preds = %while.cond.i.i.i45
  ...
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %buffer.i31) #23, !noalias !88
...
if.end.i56:                                       ; preds = %_ZN11CStringBaseIwED2Ev.exit55
  ...
  store i32 0, ptr %_length.i.i57, align 8, !tbaa !17
  ...
  %30 = load i32, ptr %_capacity.i.i59, align 4, !tbaa !15
...
delete.notnull.i.i75:                             ; preds = %if.end.i.i61
  ...
  %.pre.i76 = load i32, ptr %_length.i.i57, align 8, !tbaa !17
...
if.end9.i.i65:                                    ; preds = %delete.notnull.i.i75, %if.end.i.i61
  ...
  store ptr %call.i.i63, ptr %_fileName, align 8, !tbaa !11
  ...
  store i32 %add.i.i58, ptr %_capacity.i.i59, align 4, !tbaa !15
...
while.cond.i.i69:                                 ; preds = %while.cond.i.i69, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i68
  ...
  br i1 %cmp.not.i.i74, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i, label %while.cond.i.i69, !llvm.loop !16

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i:            ; preds = %while.cond.i.i69
  %38 = load i32, ptr %_length.i.i, align 8, !tbaa !17
  store i32 %38, ptr %_length.i.i57, align 8, !tbaa !17
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load10 = load <4 x i32>, ptr %10, align 4, !tbaa !5
  %11 = getelementptr inbounds i32, ptr %call.i.i, i64 %index
  store <4 x i32> %wide.load, ptr %11, align 4, !tbaa !5
  %12 = getelementptr inbounds i32, ptr %11, i64 4
  store <4 x i32> %wide.load10, ptr %12, align 4, !tbaa !5
  %index.next = add nuw i64 %index, 8
  %13 = icmp eq i64 %index.next, %n.vec
  br i1 %13, label %middle.block, label %vector.body, !llvm.loop !91
...
while.cond.i:                                     ; preds = %while.cond.i, %_ZN11CStringBaseIwE10GrowLengthEi.exit
  ...
  %25 = load i32, ptr %src.addr.0.i, align 4, !tbaa !5
  %incdec.ptr1.i = getelementptr inbounds i32, ptr %dest.addr.0.i, i64 1
  store i32 %25, ptr %dest.addr.0.i, align 4, !tbaa !5
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load8 = load <4 x i32>, ptr %8, align 4, !tbaa !5
  %9 = getelementptr inbounds i32, ptr %call.i.i, i64 %index
  store <4 x i32> %wide.load, ptr %9, align 4, !tbaa !5
  %10 = getelementptr inbounds i32, ptr %9, i64 4
  store <4 x i32> %wide.load8, ptr %10, align 4, !tbaa !5
  %index.next = add nuw i64 %index, 8
...
for.body.i.i.prol:                                ; preds = %for.body.i.i.preheader, %for.body.i.i.prol
  ...
  %prol.iter = phi i64 [ %prol.iter.next, %for.body.i.i.prol ], [ 0, %for.body.i.i.preheader ]
  %arrayidx.i.i.prol = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.i.i.prol
  %14 = load i32, ptr %arrayidx.i.i.prol, align 4, !tbaa !5
  %arrayidx7.i.i.prol = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.i.i.prol
  store i32 %14, ptr %arrayidx7.i.i.prol, align 4, !tbaa !5
  %indvars.iv.next.i.i.prol = add nuw nsw i64 %indvars.iv.i.i.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
...
for.body.i.i:                                     ; preds = %for.body.i.i.prol.loopexit, %for.body.i.i
  ...
  %arrayidx7.i.i = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.i.i
  store i32 %16, ptr %arrayidx7.i.i, align 4, !tbaa !5
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1
  %arrayidx.i.i.1 = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.next.i.i
  %17 = load i32, ptr %arrayidx.i.i.1, align 4, !tbaa !5
  %arrayidx7.i.i.1 = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.next.i.i
  store i32 %17, ptr %arrayidx7.i.i.1, align 4, !tbaa !5
  %indvars.iv.next.i.i.1 = add nuw nsw i64 %indvars.iv.i.i, 2
  %arrayidx.i.i.2 = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.next.i.i.1
  %18 = load i32, ptr %arrayidx.i.i.2, align 4, !tbaa !5
  %arrayidx7.i.i.2 = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.next.i.i.1
  store i32 %18, ptr %arrayidx7.i.i.2, align 4, !tbaa !5
  %indvars.iv.next.i.i.2 = add nuw nsw i64 %indvars.iv.i.i, 3
  %arrayidx.i.i.3 = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.next.i.i.2
  %19 = load i32, ptr %arrayidx.i.i.3, align 4, !tbaa !5
  %arrayidx7.i.i.3 = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.next.i.i.2
  store i32 %19, ptr %arrayidx7.i.i.3, align 4, !tbaa !5
  %indvars.iv.next.i.i.3 = add nuw nsw i64 %indvars.iv.i.i, 4
  %exitcond.not.i.i.3 = icmp eq i64 %indvars.iv.next.i.i.3, %wide.trip.count.i.i
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load11 = load <4 x i32>, ptr %9, align 4, !tbaa !5
  %10 = getelementptr inbounds i32, ptr %call.i.i, i64 %index
  store <4 x i32> %wide.load, ptr %10, align 4, !tbaa !5
  %11 = getelementptr inbounds i32, ptr %10, i64 4
  store <4 x i32> %wide.load11, ptr %11, align 4, !tbaa !5
  %index.next = add nuw i64 %index, 8
  %12 = icmp eq i64 %index.next, %n.vec
  br i1 %12, label %middle.block, label %vector.body, !llvm.loop !97
...
for.body.i.i.prol:                                ; preds = %for.body.i.i.preheader, %for.body.i.i.prol
  ...
  %prol.iter = phi i64 [ %prol.iter.next, %for.body.i.i.prol ], [ 0, %for.body.i.i.preheader ]
  %arrayidx.i.i.prol = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.i.i.prol
  %15 = load i32, ptr %arrayidx.i.i.prol, align 4, !tbaa !5
  %arrayidx7.i.i.prol = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.i.i.prol
  store i32 %15, ptr %arrayidx7.i.i.prol, align 4, !tbaa !5
  %indvars.iv.next.i.i.prol = add nuw nsw i64 %indvars.iv.i.i.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
...
for.body.i.i:                                     ; preds = %for.body.i.i.prol.loopexit, %for.body.i.i
  ...
  %arrayidx7.i.i = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.i.i
  store i32 %17, ptr %arrayidx7.i.i, align 4, !tbaa !5
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1
  %arrayidx.i.i.1 = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.next.i.i
  %18 = load i32, ptr %arrayidx.i.i.1, align 4, !tbaa !5
  %arrayidx7.i.i.1 = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.next.i.i
  store i32 %18, ptr %arrayidx7.i.i.1, align 4, !tbaa !5
  %indvars.iv.next.i.i.1 = add nuw nsw i64 %indvars.iv.i.i, 2
  %arrayidx.i.i.2 = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.next.i.i.1
  %19 = load i32, ptr %arrayidx.i.i.2, align 4, !tbaa !5
  %arrayidx7.i.i.2 = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.next.i.i.1
  store i32 %19, ptr %arrayidx7.i.i.2, align 4, !tbaa !5
  %indvars.iv.next.i.i.2 = add nuw nsw i64 %indvars.iv.i.i, 3
  %arrayidx.i.i.3 = getelementptr inbounds i32, ptr %.pre.i.i, i64 %indvars.iv.next.i.i.2
  %20 = load i32, ptr %arrayidx.i.i.3, align 4, !tbaa !5
  %arrayidx7.i.i.3 = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.next.i.i.2
  store i32 %20, ptr %arrayidx7.i.i.3, align 4, !tbaa !5
  %indvars.iv.next.i.i.3 = add nuw nsw i64 %indvars.iv.i.i, 4
  %exitcond.not.i.i.3 = icmp eq i64 %indvars.iv.next.i.i.3, %wide.trip.count.i.i
...
_ZN11CStringBaseIwE10GrowLengthEi.exit:           ; preds = %entry, %if.end.i, %if.end9.i.i
  ...
  %24 = load ptr, ptr %s, align 8, !tbaa !11
  br label %while.cond.i
...
_Z12MyStringCopyIwEPT_S1_PKS0_.exit:              ; preds = %while.cond.i
  %26 = load i32, ptr %_length, align 8, !tbaa !17
...
if.end8:                                          ; preds = %entry
  ...
  store i32 0, ptr %call.i.i33, align 4, !tbaa !5
