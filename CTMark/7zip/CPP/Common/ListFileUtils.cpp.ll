...
while.cond.i.i:                                   ; preds = %while.cond.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i
  ...
  br i1 %cmp.not.i.i145, label %invoke.cont35, label %while.cond.i.i, !llvm.loop !29
...
_ZN11CStringBaseIwEC2Ev.exit161:                  ; preds = %if.end49
  ...
  store i32 4, ptr %_capacity.i158, align 4, !tbaa !27
...
if.else73:                                        ; preds = %for.body
  %55 = load i32, ptr %_capacity.i158, align 4, !tbaa !27
  %56 = xor i32 %39, -1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load239 = load <4 x i32>, ptr %62, align 4, !tbaa !25
  ...
  store <4 x i32> %wide.load239, ptr %64, align 4, !tbaa !25
...
delete.notnull.i.i.i:                             ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i, %middle.block, %for.cond.preheader.i.i.i
  ...
  %.pre.i.i180 = load i32, ptr %_length.i163, align 8, !tbaa !28
...
if.end9.i.i.i179:                                 ; preds = %delete.notnull.i.i.i, %call.i.i.i.noexc
  ...
  store ptr %call.i.i.i181, ptr %t, align 8, !tbaa !23
  ...
  store i32 %add.i.i.i176, ptr %_capacity.i158, align 4, !tbaa !27
...
invoke.cont81:                                    ; preds = %invoke.cont80
  ...
  %81 = load i32, ptr %_length.i182, align 8, !tbaa !28
...
call.i.i.noexc.i191:                              ; preds = %if.end9.i.i.i187
  ...
  store ptr %call.i.i4.i189, ptr %call.i208, align 8, !tbaa !23
  store i32 0, ptr %call.i.i4.i189, align 4, !tbaa !25
  store i32 %add.i.i.i185, ptr %_capacity.i.i192, align 4, !tbaa !27
...
while.cond.i.i.i194:                              ; preds = %while.cond.i.i.i194, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i193
  ...
  %87 = load i32, ptr %src.addr.0.i.i.i195, align 4, !tbaa !25
  %incdec.ptr1.i.i.i198 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i196, i64 1
  store i32 %87, ptr %dest.addr.0.i.i.i196, align 4, !tbaa !25
  %cmp.not.i.i.i199 = icmp eq i32 %87, 0
  br i1 %cmp.not.i.i.i199, label %invoke.cont.i200, label %while.cond.i.i.i194, !llvm.loop !29
...
invoke.cont.i200:                                 ; preds = %while.cond.i.i.i194
  ...
  store i32 %81, ptr %_length.i.i201, align 8, !tbaa !28
  invoke void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %resultStrings)
...
ehcleanup96:                                      ; preds = %lpad14, %ehcleanup92
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %processed) #10
  %.pre233 = load ptr, ptr %s, align 8, !tbaa !13
...
_ZNK11CStringBaseIwE4FindEw.exit.thread.i.thread.i: ; preds = %if.end.i.i.i.i
  ...
  %7 = load i32, ptr %add.ptr.i.i.i125.i, align 4, !tbaa !25
...
if.end5.i.i.i.i10:                                ; preds = %if.end.i.i.i.i7
  ...
  %15 = load i32, ptr %add.ptr.i.i.i.i.i.i11, align 4, !tbaa !25
  %cmp.i.i.i.i12 = icmp eq i32 %15, %13
  br i1 %cmp.i.i.i.i12, label %_ZNK11CStringBaseIwE4FindEw.exit.loopexit.i.i13, label %if.end.i.i.i.i7, !llvm.loop !44
...
if.then4.i.i.i25:                                 ; preds = %while.end.i.i19
  ...
  store i32 %sub7.i.i.i28, ptr %_length.i.i.i, align 8, !tbaa !28
...
if.then7:                                         ; preds = %land.lhs.true
  %sub9 = add i32 %0, -2
  %call.i.i33.i = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #11, !noalias !50
  store i32 0, ptr %call.i.i33.i, align 4, !tbaa !25, !noalias !50
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i:        ; preds = %if.end.i.i
  tail call void @_ZdaPv(ptr noundef nonnull %call.i.i33.i) #12, !noalias !50
...
delete.notnull.i.i:                               ; preds = %call.i.i.noexc
  ...
  %.pre.i29 = load i32, ptr %_length.i, align 8, !tbaa !28
