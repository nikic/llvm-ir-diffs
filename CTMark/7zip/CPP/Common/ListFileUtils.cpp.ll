; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Common/ListFileUtils.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Common/ListFileUtils.cpp"
...
entry:
  ...
  store ptr %call.i.i.i.i, ptr %_unix_filename.i.i, align 8
...
invoke.cont9:                                     ; preds = %if.end7
  store ptr %call.i.i126, ptr %s, align 8
  store i8 0, ptr %call.i.i126, align 1
...
if.end9.i.i:                                      ; preds = %if.end.i.i
  ...
  %5 = load i32, ptr %_length.i.i, align 8
...
invoke.cont11:                                    ; preds = %if.end9.i.i, %invoke.cont9
  %conv13.pre-phi = phi i32 [ %.pre234, %if.end9.i.i ], [ %conv, %invoke.cont9 ]
...
for.cond.i.i:                                     ; preds = %for.cond.i.i, %if.end18
  ...
  %12 = load i8, ptr %arrayidx.i.i130, align 1
  %cmp.not.i.i = icmp eq i8 %12, 0
  %indvars.iv.next.i.i131 = add nuw i64 %indvars.iv.i.i129, 1
  br i1 %cmp.not.i.i, label %invoke.cont20, label %for.cond.i.i
...
invoke.cont20:                                    ; preds = %for.cond.i.i
  ...
  store i32 %13, ptr %_length.i.i132, align 8
...
invoke.cont24:                                    ; preds = %invoke.cont21
  store ptr %call.i.i135, ptr %u, align 8
...
invoke.cont33:                                    ; preds = %if.else
  ...
  %19 = load i32, ptr %_capacity.i133, align 4
  %cmp.i.i138 = icmp eq i32 %add.i.i137, %19
  br i1 %cmp.i.i138, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i, label %if.end.i.i139

if.end.i.i139:                                    ; preds = %invoke.cont33
  %conv.i.i140 = zext i32 %add.i.i137 to i64
  %20 = icmp slt i32 %18, -1
  %21 = shl nuw nsw i64 %conv.i.i140, 2
...
call.i.i.noexc147:                                ; preds = %if.end.i.i139
  %cmp3.i.i141 = icmp sgt i32 %19, 0
  br i1 %cmp3.i.i141, label %delete.notnull.i.i146, label %if.end9.i.i142

delete.notnull.i.i146:                            ; preds = %call.i.i.noexc147
  call void @_ZdaPv(ptr noundef nonnull %17) #12
  %.pre.i = load i32, ptr %_length.i.i136, align 8
  %23 = sext i32 %.pre.i to i64
  br label %if.end9.i.i142

if.end9.i.i142:                                   ; preds = %delete.notnull.i.i146, %call.i.i.noexc147
  %idxprom13.i.i143 = phi i64 [ %23, %delete.notnull.i.i146 ], [ 0, %call.i.i.noexc147 ]
  store ptr %call.i.i148, ptr %u, align 8
  %arrayidx14.i.i144 = getelementptr inbounds i32, ptr %call.i.i148, i64 %idxprom13.i.i143
  store i32 0, ptr %arrayidx14.i.i144, align 4
  store i32 %add.i.i137, ptr %_capacity.i133, align 4
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i

_ZN11CStringBaseIwE11SetCapacityEi.exit.i:        ; preds = %if.end9.i.i142, %invoke.cont33
  %24 = phi ptr [ %17, %invoke.cont33 ], [ %call.i.i148, %if.end9.i.i142 ]
...
while.cond.i.i:                                   ; preds = %while.cond.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i
  ...
  %26 = load i32, ptr %src.addr.0.i.i, align 4
  %incdec.ptr1.i.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i, i64 1
  store i32 %26, ptr %dest.addr.0.i.i, align 4
  %cmp.not.i.i145 = icmp eq i32 %26, 0
  br i1 %cmp.not.i.i145, label %invoke.cont35, label %while.cond.i.i

invoke.cont35:                                    ; preds = %while.cond.i.i
  %27 = load i32, ptr %_length.i, align 8
  store i32 %27, ptr %_length.i.i136, align 8
...
if.end37:                                         ; preds = %invoke.cont28, %_ZN11CStringBaseIwED2Ev.exit
  ...
  %31 = load i32, ptr %_length.i152, align 8
...
if.then4.i:                                       ; preds = %if.then40
  ...
  %34 = load i32, ptr %_length.i152, align 8
  %sub7.i = add nsw i32 %34, -1
  store i32 %sub7.i, ptr %_length.i152, align 8
  br label %if.end49
...
if.end49:                                         ; preds = %if.then4.i, %if.then40, %if.end37
  ...
  %_capacity.i158 = getelementptr inbounds %class.CStringBase.0, ptr %t, i64 0, i32 2
...
_ZN11CStringBaseIwEC2Ev.exit161:                  ; preds = %if.end49
  store ptr %call.i.i160, ptr %t, align 8
  store i32 0, ptr %call.i.i160, align 4
  store i32 4, ptr %_capacity.i158, align 4
  %cmp55228 = icmp sgt i32 %35, 0
  br i1 %cmp55228, label %for.body.lr.ph, label %for.cond.cleanup
...
invoke.cont65:                                    ; preds = %invoke.cont64
  %43 = load i32, ptr %_length.i163, align 8
...
call.i.i.noexc.i:                                 ; preds = %if.end9.i.i.i
  ...
  store ptr %call.i.i4.i, ptr %call.i169, align 8
  store i32 0, ptr %call.i.i4.i, align 4
  store i32 %add.i.i.i, ptr %_capacity.i.i165, align 4
...
while.cond.i.i.i:                                 ; preds = %while.cond.i.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i
  ...
  %49 = load i32, ptr %src.addr.0.i.i.i, align 4
  %incdec.ptr1.i.i.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i, i64 1
  store i32 %49, ptr %dest.addr.0.i.i.i, align 4
...
invoke.cont.i:                                    ; preds = %while.cond.i.i.i
  ...
  store i32 %43, ptr %_length.i.i166, align 8
...
_ZN13CObjectVectorI11CStringBaseIwEE3AddERKS1_.exit: ; preds = %invoke.cont.i
  %51 = load ptr, ptr %_items.i.i, align 8
  %52 = load i32, ptr %_size.i.i, align 4
  %idxprom.i.i167 = sext i32 %52 to i64
  %arrayidx.i.i168 = getelementptr inbounds ptr, ptr %51, i64 %idxprom.i.i167
  store ptr %call.i169, ptr %arrayidx.i.i168, align 8
...
if.end71:                                         ; preds = %_ZN13CObjectVectorI11CStringBaseIwEE3AddERKS1_.exit, %invoke.cont65
  store i32 0, ptr %_length.i163, align 8
  %54 = load ptr, ptr %t, align 8
  br label %if.end76

if.else73:                                        ; preds = %for.body
  %55 = load i32, ptr %_capacity.i158, align 4
  %56 = xor i32 %39, -1
  %sub2.i.i = add i32 %55, %56
  %cmp.not.i.i173 = icmp slt i32 %sub2.i.i, 1
  br i1 %cmp.not.i.i173, label %if.end.i.i174, label %_ZN11CStringBaseIwEpLEw.exit

if.end.i.i174:                                    ; preds = %if.else73
  ...
  %add.i.i175 = add nsw i32 %delta.0.i.i, %sub2.i.i
  %cmp13.i.i = icmp slt i32 %add.i.i175, 1
  ...
  %add.i.i.i176 = add nsw i32 %add18.i.i, 1
  %cmp.i.i.i177 = icmp eq i32 %add.i.i.i176, %55
  br i1 %cmp.i.i.i177, label %_ZN11CStringBaseIwEpLEw.exit, label %if.end.i.i.i

if.end.i.i.i:                                     ; preds = %if.end.i.i174
  %conv.i.i.i178 = zext i32 %add.i.i.i176 to i64
  %57 = icmp slt i32 %add18.i.i, -1
  %58 = shl nuw nsw i64 %conv.i.i.i178, 2
  %59 = select i1 %57, i64 -1, i64 %58
  %call.i.i.i181 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %59) #11
          to label %call.i.i.i.noexc unwind label %lpad56

call.i.i.i.noexc:                                 ; preds = %if.end.i.i.i
  %call.i.i.i181238 = ptrtoint ptr %call.i.i.i181 to i64
...
for.body.lr.ph.i.i.i:                             ; preds = %for.cond.preheader.i.i.i
  ...
  %60 = sub i64 %call.i.i.i181238, %40
  %diff.check = icmp ult i64 %60, 32
  %or.cond240 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond240, label %for.body.i.i.i.preheader, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load239 = load <4 x i32>, ptr %62, align 4
  %63 = getelementptr inbounds i32, ptr %call.i.i.i181, i64 %index
  store <4 x i32> %wide.load, ptr %63, align 4
  %64 = getelementptr inbounds i32, ptr %63, i64 4
  store <4 x i32> %wide.load239, ptr %64, align 4
...
for.body.i.i.i.prol:                              ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i.prol
  ...
  %68 = load i32, ptr %arrayidx.i.i.i.prol, align 4
  %arrayidx7.i.i.i.prol = getelementptr inbounds i32, ptr %call.i.i.i181, i64 %indvars.iv.i.i.i.prol
  store i32 %68, ptr %arrayidx7.i.i.i.prol, align 4
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  ...
  %arrayidx7.i.i.i = getelementptr inbounds i32, ptr %call.i.i.i181, i64 %indvars.iv.i.i.i
  store i32 %70, ptr %arrayidx7.i.i.i, align 4
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1
  %arrayidx.i.i.i.1 = getelementptr inbounds i32, ptr %38, i64 %indvars.iv.next.i.i.i
  %71 = load i32, ptr %arrayidx.i.i.i.1, align 4
  %arrayidx7.i.i.i.1 = getelementptr inbounds i32, ptr %call.i.i.i181, i64 %indvars.iv.next.i.i.i
  store i32 %71, ptr %arrayidx7.i.i.i.1, align 4
  %indvars.iv.next.i.i.i.1 = add nuw nsw i64 %indvars.iv.i.i.i, 2
  %arrayidx.i.i.i.2 = getelementptr inbounds i32, ptr %38, i64 %indvars.iv.next.i.i.i.1
  %72 = load i32, ptr %arrayidx.i.i.i.2, align 4
  %arrayidx7.i.i.i.2 = getelementptr inbounds i32, ptr %call.i.i.i181, i64 %indvars.iv.next.i.i.i.1
  store i32 %72, ptr %arrayidx7.i.i.i.2, align 4
  ...
  %73 = load i32, ptr %arrayidx.i.i.i.3, align 4
  %arrayidx7.i.i.i.3 = getelementptr inbounds i32, ptr %call.i.i.i181, i64 %indvars.iv.next.i.i.i.2
  store i32 %73, ptr %arrayidx7.i.i.i.3, align 4
...
delete.notnull.i.i.i:                             ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i, %middle.block, %for.cond.preheader.i.i.i
  ...
  %.pre.i.i180 = load i32, ptr %_length.i163, align 8
  br label %if.end9.i.i.i179

if.end9.i.i.i179:                                 ; preds = %delete.notnull.i.i.i, %call.i.i.i.noexc
  %74 = phi i32 [ %.pre.i.i180, %delete.notnull.i.i.i ], [ %39, %call.i.i.i.noexc ]
  store ptr %call.i.i.i181, ptr %t, align 8
  %idxprom13.i.i.i = sext i32 %74 to i64
  %arrayidx14.i.i.i = getelementptr inbounds i32, ptr %call.i.i.i181, i64 %idxprom13.i.i.i
  store i32 0, ptr %arrayidx14.i.i.i, align 4
  store i32 %add.i.i.i176, ptr %_capacity.i158, align 4
  br label %_ZN11CStringBaseIwEpLEw.exit

_ZN11CStringBaseIwEpLEw.exit:                     ; preds = %if.else73, %if.end.i.i174, %if.end9.i.i.i179
  %75 = phi ptr [ %38, %if.else73 ], [ %38, %if.end.i.i174 ], [ %call.i.i.i181, %if.end9.i.i.i179 ]
  %76 = phi i32 [ %39, %if.else73 ], [ %39, %if.end.i.i174 ], [ %74, %if.end9.i.i.i179 ]
  ...
  store i32 %inc.i, ptr %_length.i163, align 8
...
if.end76:                                         ; preds = %_ZN11CStringBaseIwEpLEw.exit, %if.end71
  ...
  %79 = load i32, ptr %_length.i152, align 8
...
invoke.cont81:                                    ; preds = %invoke.cont80
  %_length.i182 = getelementptr inbounds %class.CStringBase.0, ptr %t, i64 0, i32 1
  %81 = load i32, ptr %_length.i182, align 8
  %cmp.i183 = icmp eq i32 %81, 0
  br i1 %cmp.i183, label %if.end87, label %if.then84

if.then84:                                        ; preds = %invoke.cont81
  %call.i208 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znwm(i64 noundef 16) #11
          to label %call.i.noexc207 unwind label %lpad79

call.i.noexc207:                                  ; preds = %if.then84
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %call.i208, i8 0, i64 16, i1 false)
  %add.i.i.i185 = add nsw i32 %81, 1
  %cmp.i.i.i186 = icmp eq i32 %add.i.i.i185, 0
  br i1 %cmp.i.i.i186, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i193, label %if.end9.i.i.i187

if.end9.i.i.i187:                                 ; preds = %call.i.noexc207
  %conv.i.i.i188 = zext i32 %add.i.i.i185 to i64
  %82 = icmp slt i32 %81, -1
  %83 = shl nuw nsw i64 %conv.i.i.i188, 2
  %84 = select i1 %82, i64 -1, i64 %83
  %call.i.i4.i189 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %84) #11
          to label %call.i.i.noexc.i191 unwind label %lpad.i190

call.i.i.noexc.i191:                              ; preds = %if.end9.i.i.i187
  %_capacity.i.i192 = getelementptr inbounds %class.CStringBase.0, ptr %call.i208, i64 0, i32 2
  store ptr %call.i.i4.i189, ptr %call.i208, align 8
  store i32 0, ptr %call.i.i4.i189, align 4
  store i32 %add.i.i.i185, ptr %_capacity.i.i192, align 4
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i193

_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i193:   ; preds = %call.i.i.noexc.i191, %call.i.noexc207
  %85 = phi ptr [ null, %call.i.noexc207 ], [ %call.i.i4.i189, %call.i.i.noexc.i191 ]
  %86 = load ptr, ptr %t, align 8
  br label %while.cond.i.i.i194

while.cond.i.i.i194:                              ; preds = %while.cond.i.i.i194, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i193
  %src.addr.0.i.i.i195 = phi ptr [ %86, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i193 ], [ %incdec.ptr.i.i.i197, %while.cond.i.i.i194 ]
  %dest.addr.0.i.i.i196 = phi ptr [ %85, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i193 ], [ %incdec.ptr1.i.i.i198, %while.cond.i.i.i194 ]
  %incdec.ptr.i.i.i197 = getelementptr inbounds i32, ptr %src.addr.0.i.i.i195, i64 1
  %87 = load i32, ptr %src.addr.0.i.i.i195, align 4
  %incdec.ptr1.i.i.i198 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i196, i64 1
  store i32 %87, ptr %dest.addr.0.i.i.i196, align 4
  %cmp.not.i.i.i199 = icmp eq i32 %87, 0
  br i1 %cmp.not.i.i.i199, label %invoke.cont.i200, label %while.cond.i.i.i194

invoke.cont.i200:                                 ; preds = %while.cond.i.i.i194
  %_length.i.i201 = getelementptr inbounds %class.CStringBase.0, ptr %call.i208, i64 0, i32 1
  store i32 %81, ptr %_length.i.i201, align 8
  invoke void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %resultStrings)
          to label %_ZN13CObjectVectorI11CStringBaseIwEE3AddERKS1_.exit210 unwind label %lpad79

lpad.i190:                                        ; preds = %if.end9.i.i.i187
  %88 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPv(ptr noundef nonnull %call.i208) #12
  br label %ehcleanup88

_ZN13CObjectVectorI11CStringBaseIwEE3AddERKS1_.exit210: ; preds = %invoke.cont.i200
  %_items.i.i202 = getelementptr inbounds %class.CBaseRecordVector, ptr %resultStrings, i64 0, i32 3
  %89 = load ptr, ptr %_items.i.i202, align 8
  %_size.i.i203 = getelementptr inbounds %class.CBaseRecordVector, ptr %resultStrings, i64 0, i32 2
  %90 = load i32, ptr %_size.i.i203, align 4
  %idxprom.i.i204 = sext i32 %90 to i64
  %arrayidx.i.i205 = getelementptr inbounds ptr, ptr %89, i64 %idxprom.i.i204
  store ptr %call.i208, ptr %arrayidx.i.i205, align 8
  %inc.i.i206 = add nsw i32 %90, 1
  store i32 %inc.i.i206, ptr %_size.i.i203, align 4
  br label %if.end87

lpad79:                                           ; preds = %invoke.cont.i200, %if.then84, %invoke.cont80, %for.cond.cleanup
  %91 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup88

if.end87:                                         ; preds = %_ZN13CObjectVectorI11CStringBaseIwEE3AddERKS1_.exit210, %invoke.cont81
  %92 = load ptr, ptr %t, align 8
  %isnull.i211 = icmp eq ptr %92, null
  br i1 %isnull.i211, label %_ZN11CStringBaseIwED2Ev.exit213, label %delete.notnull.i212

delete.notnull.i212:                              ; preds = %if.end87
  call void @_ZdaPv(ptr noundef nonnull %92) #12
  br label %_ZN11CStringBaseIwED2Ev.exit213

_ZN11CStringBaseIwED2Ev.exit213:                  ; preds = %if.end87, %delete.notnull.i212
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %t) #10
  br label %cleanup

ehcleanup88:                                      ; preds = %lpad79, %lpad.i190, %lpad56, %lpad.i
  %.pn116 = phi { ptr, i32 } [ %53, %lpad56 ], [ %50, %lpad.i ], [ %91, %lpad79 ], [ %88, %lpad.i190 ]
  %93 = load ptr, ptr %t, align 8
  %isnull.i214 = icmp eq ptr %93, null
  br i1 %isnull.i214, label %ehcleanup89, label %delete.notnull.i215

delete.notnull.i215:                              ; preds = %ehcleanup88
  call void @_ZdaPv(ptr noundef nonnull %93) #12
  br label %ehcleanup89

ehcleanup89:                                      ; preds = %delete.notnull.i215, %ehcleanup88, %lpad50
  %.pn116.pn = phi { ptr, i32 } [ %37, %lpad50 ], [ %.pn116, %ehcleanup88 ], [ %.pn116, %delete.notnull.i215 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %t) #10
  br label %ehcleanup90

cleanup:                                          ; preds = %invoke.cont28, %_ZN11CStringBaseIwED2Ev.exit213
  %retval.0 = phi i1 [ true, %_ZN11CStringBaseIwED2Ev.exit213 ], [ false, %invoke.cont28 ]
  %94 = load ptr, ptr %u, align 8
  %isnull.i217 = icmp eq ptr %94, null
  br i1 %isnull.i217, label %_ZN11CStringBaseIwED2Ev.exit219, label %delete.notnull.i218

delete.notnull.i218:                              ; preds = %cleanup
  call void @_ZdaPv(ptr noundef nonnull %94) #12
  br label %_ZN11CStringBaseIwED2Ev.exit219

_ZN11CStringBaseIwED2Ev.exit219:                  ; preds = %cleanup, %delete.notnull.i218
...
ehcleanup90:                                      ; preds = %ehcleanup89, %ehcleanup, %lpad27
  ...
  %isnull.i220 = icmp eq ptr %95, null
  br i1 %isnull.i220, label %ehcleanup92, label %delete.notnull.i221

delete.notnull.i221:                              ; preds = %ehcleanup90
  call void @_ZdaPv(ptr noundef nonnull %95) #12
  br label %ehcleanup92

ehcleanup92:                                      ; preds = %delete.notnull.i221, %ehcleanup90, %lpad23
  %.pn116.pn.pn.pn = phi { ptr, i32 } [ %15, %lpad23 ], [ %.pn116.pn.pn, %ehcleanup90 ], [ %.pn116.pn.pn, %delete.notnull.i221 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %u) #10
  br label %ehcleanup96

cleanup93:                                        ; preds = %invoke.cont15, %_ZN11CStringBaseIwED2Ev.exit219
  %retval.1 = phi i1 [ %retval.0, %_ZN11CStringBaseIwED2Ev.exit219 ], [ false, %invoke.cont15 ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %processed) #10
  %96 = load ptr, ptr %s, align 8
  %isnull.i223 = icmp eq ptr %96, null
  br i1 %isnull.i223, label %_ZN11CStringBaseIcED2Ev.exit, label %delete.notnull.i224

delete.notnull.i224:                              ; preds = %cleanup93
  call void @_ZdaPv(ptr noundef nonnull %96) #12
  br label %_ZN11CStringBaseIcED2Ev.exit

_ZN11CStringBaseIcED2Ev.exit:                     ; preds = %cleanup93, %delete.notnull.i224
...
ehcleanup96:                                      ; preds = %lpad14, %ehcleanup92
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %processed) #10
  %.pre233 = load ptr, ptr %s, align 8
  %isnull.i225 = icmp eq ptr %.pre233, null
  br i1 %isnull.i225, label %ehcleanup100, label %delete.notnull.i226

delete.notnull.i226:                              ; preds = %ehcleanup96.thread, %ehcleanup96
  %.pn116.pn.pn.pn.pn.pn237 = phi { ptr, i32 } [ %8, %ehcleanup96.thread ], [ %.pn116.pn.pn.pn.pn, %ehcleanup96 ]
  %97 = phi ptr [ %call.i.i126, %ehcleanup96.thread ], [ %.pre233, %ehcleanup96 ]
  call void @_ZdaPv(ptr noundef nonnull %97) #12
  br label %ehcleanup100

ehcleanup100:                                     ; preds = %delete.notnull.i226, %ehcleanup96, %lpad8
  %.pn116.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %7, %lpad8 ], [ %.pn116.pn.pn.pn.pn, %ehcleanup96 ], [ %.pn116.pn.pn.pn.pn.pn237, %delete.notnull.i226 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %s) #10
  br label %ehcleanup102
...
entry:
  %call.i.i.i.i = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #11
  store <4 x i32> <i32 32, i32 10, i32 9, i32 0>, ptr %call.i.i.i.i, align 4
...
if.end5.i.i.i.i:                                  ; preds = %if.end.i.i.i.i
  ...
  %4 = load i32, ptr %add.ptr.i.i.i.i.i.i, align 4
...
_ZNK11CStringBaseIwE4FindEw.exit.thread.i.thread.i: ; preds = %if.end.i.i.i.i
  %add.ptr.i.i.i125.i = getelementptr inbounds i32, ptr %p.028.i.i, i64 1
  %7 = load i32, ptr %add.ptr.i.i.i125.i, align 4
  %cmp.not.i126.i = icmp eq i32 %7, 0
  br i1 %cmp.not.i126.i, label %_ZN11CStringBaseIwE9TrimRightEv.exit, label %while.body.i.i.backedge
...
while.body.i.i.backedge:                          ; preds = %_ZNK11CStringBaseIwE4FindEw.exit.thread.i.thread.i, %_ZNK11CStringBaseIwE4FindEw.exit.thread.i.i
  ...
  %p.028.i.i.be = phi ptr [ %add.ptr.i.i.i.i, %_ZNK11CStringBaseIwE4FindEw.exit.thread.i.i ], [ %add.ptr.i.i.i125.i, %_ZNK11CStringBaseIwE4FindEw.exit.thread.i.thread.i ]
...
if.then8.i.i:                                     ; preds = %while.end.i.i
  ...
  %9 = load i32, ptr %_length.i.i, align 8
...
if.then4.i.i.i:                                   ; preds = %if.then8.i.i
  ...
  %11 = load i32, ptr %_length.i.i, align 8
  %sub7.i.i.i = sub nsw i32 %11, %sub.i.i
  store i32 %sub7.i.i.i, ptr %_length.i.i, align 8
...
_ZN11CStringBaseIwE9TrimRightEv.exit:             ; preds = %_ZNK11CStringBaseIwE4FindEw.exit.thread.i.thread.i, %entry, %while.end.i.i, %if.then8.i.i, %if.then4.i.i.i
  ...
  %call.i.i.i.i2 = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #11
  store <4 x i32> <i32 32, i32 10, i32 9, i32 0>, ptr %call.i.i.i.i2, align 4
  %12 = load ptr, ptr %this, align 8
  %sub.ptr.rhs.cast.i.i.i.i5 = ptrtoint ptr %call.i.i.i.i2 to i64
  br label %while.cond.i.i

while.cond.i.i:                                   ; preds = %while.body.i.i17, %_ZN11CStringBaseIwE9TrimRightEv.exit
  %p.0.i.i = phi ptr [ %12, %_ZN11CStringBaseIwE9TrimRightEv.exit ], [ %add.ptr.i.i.i.i18, %while.body.i.i17 ]
  %13 = load i32, ptr %p.0.i.i, align 4
  %cmp10.i.i.i.i6 = icmp eq i32 %13, 32
  br i1 %cmp10.i.i.i.i6, label %_ZNK11CStringBaseIwE4FindEw.exit.i.i, label %if.end.i.i.i.i7

if.end.i.i.i.i7:                                  ; preds = %while.cond.i.i, %if.end5.i.i.i.i10
  %14 = phi i32 [ %15, %if.end5.i.i.i.i10 ], [ 32, %while.cond.i.i ]
  %p.011.i.i.i.i8 = phi ptr [ %add.ptr.i.i.i.i.i.i11, %if.end5.i.i.i.i10 ], [ %call.i.i.i.i2, %while.cond.i.i ]
  %cmp3.i.i.i.i9 = icmp eq i32 %14, 0
  br i1 %cmp3.i.i.i.i9, label %while.end.i.i19, label %if.end5.i.i.i.i10

if.end5.i.i.i.i10:                                ; preds = %if.end.i.i.i.i7
  %add.ptr.i.i.i.i.i.i11 = getelementptr inbounds i32, ptr %p.011.i.i.i.i8, i64 1
  %15 = load i32, ptr %add.ptr.i.i.i.i.i.i11, align 4
  %cmp.i.i.i.i12 = icmp eq i32 %15, %13
  br i1 %cmp.i.i.i.i12, label %_ZNK11CStringBaseIwE4FindEw.exit.loopexit.i.i13, label %if.end.i.i.i.i7

_ZNK11CStringBaseIwE4FindEw.exit.loopexit.i.i13:  ; preds = %if.end5.i.i.i.i10
  %.pre.i.i14 = ptrtoint ptr %add.ptr.i.i.i.i.i.i11 to i64
  br label %_ZNK11CStringBaseIwE4FindEw.exit.i.i

_ZNK11CStringBaseIwE4FindEw.exit.i.i:             ; preds = %_ZNK11CStringBaseIwE4FindEw.exit.loopexit.i.i13, %while.cond.i.i
  %sub.ptr.lhs.cast.i.i.pre-phi.i.i15 = phi i64 [ %.pre.i.i14, %_ZNK11CStringBaseIwE4FindEw.exit.loopexit.i.i13 ], [ %sub.ptr.rhs.cast.i.i.i.i5, %while.cond.i.i ]
  ...
  br i1 %or.cond.i.i, label %while.end.i.i19, label %while.body.i.i17

while.body.i.i17:                                 ; preds = %_ZNK11CStringBaseIwE4FindEw.exit.i.i
  %add.ptr.i.i.i.i18 = getelementptr inbounds i32, ptr %p.0.i.i, i64 1
  br label %while.cond.i.i

while.end.i.i19:                                  ; preds = %_ZNK11CStringBaseIwE4FindEw.exit.i.i, %if.end.i.i.i.i7
  %sub.ptr.lhs.cast.i.i20 = ptrtoint ptr %p.0.i.i to i64
  %sub.ptr.rhs.cast.i.i21 = ptrtoint ptr %12 to i64
  %sub.ptr.sub.i.i22 = sub i64 %sub.ptr.lhs.cast.i.i20, %sub.ptr.rhs.cast.i.i21
  %17 = lshr exact i64 %sub.ptr.sub.i.i22, 2
  %conv.i.i23 = trunc i64 %17 to i32
  %_length.i.i.i = getelementptr inbounds %class.CStringBase.0, ptr %this, i64 0, i32 1
  %18 = load i32, ptr %_length.i.i.i, align 8
  %spec.select.i.i.i = tail call i32 @llvm.smin.i32(i32 %18, i32 %conv.i.i23)
  %cmp3.i.i.i24 = icmp sgt i32 %spec.select.i.i.i, 0
  br i1 %cmp3.i.i.i24, label %if.then4.i.i.i25, label %_ZN11CStringBaseIwE8TrimLeftEv.exit

if.then4.i.i.i25:                                 ; preds = %while.end.i.i19
  %idx.ext3.i.i.i.i26 = zext i32 %spec.select.i.i.i to i64
  %add.ptr4.i.i.i.i27 = getelementptr inbounds i32, ptr %12, i64 %idx.ext3.i.i.i.i26
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr align 4 %12, ptr nonnull align 4 %add.ptr4.i.i.i.i27, i64 %mul.i.i.i.i, i1 false)
  %19 = load i32, ptr %_length.i.i.i, align 8
  %sub7.i.i.i28 = sub nsw i32 %19, %spec.select.i.i.i
  store i32 %sub7.i.i.i28, ptr %_length.i.i.i, align 8
  br label %_ZN11CStringBaseIwE8TrimLeftEv.exit

_ZN11CStringBaseIwE8TrimLeftEv.exit:              ; preds = %while.end.i.i19, %if.then4.i.i.i25
...
if.then7:                                         ; preds = %land.lhs.true
  %sub9 = add i32 %0, -2
  %call.i.i33.i = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #11
  store i32 0, ptr %call.i.i33.i, align 4
...
if.end.i.i:                                       ; preds = %if.then7
  ...
  %call.i36.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %4) #11
          to label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i unwind label %_ZN11CStringBaseIwED2Ev.exit.i

_ZN11CStringBaseIwE11SetCapacityEi.exit.i:        ; preds = %if.end.i.i
  tail call void @_ZdaPv(ptr noundef nonnull %call.i.i33.i) #12
  store i32 0, ptr %call.i36.i, align 4
  %cmp939.i.not = icmp eq i32 %sub9, 0
  %.pre36 = load ptr, ptr %s, align 8
...
for.body.lr.ph.i:                                 ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i, %if.then7
  ...
  %ref.tmp.sroa.0.0 = phi ptr [ %call.i.i33.i, %if.then7 ], [ %call.i36.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load38 = load <4 x i32>, ptr %12, align 4
  %13 = getelementptr inbounds i32, ptr %ref.tmp.sroa.0.0, i64 %index
  store <4 x i32> %wide.load, ptr %13, align 4
  %14 = getelementptr inbounds i32, ptr %13, i64 4
  store <4 x i32> %wide.load38, ptr %14, align 4
  %index.next = add nuw i64 %index, 8
...
common.resume:                                    ; preds = %_ZN11CStringBaseIwED2Ev.exit33, %_ZN11CStringBaseIwED2Ev.exit.i
  %ref.tmp.sroa.0.1.sink = phi ptr [ %ref.tmp.sroa.0.1, %_ZN11CStringBaseIwED2Ev.exit33 ], [ %call.i.i33.i, %_ZN11CStringBaseIwED2Ev.exit.i ]
...
for.body.i:                                       ; preds = %for.body.i.prol.loopexit, %for.body.i
  ...
  store i32 %25, ptr %arrayidx13.i.1, align 4
  ...
  store i32 %27, ptr %arrayidx13.i.2, align 4
  ...
  store i32 %29, ptr %arrayidx13.i.3, align 4
  %exitcond.not.3 = icmp eq i64 %28, %6
  br i1 %exitcond.not.3, label %_ZNK11CStringBaseIwE3MidEii.exit, label %for.body.i
...
call.i.i.noexc:                                   ; preds = %if.end.i.i26
...
while.cond.i.i:                                   ; preds = %while.cond.i.i.preheader, %while.cond.i.i
  ...
  br i1 %cmp.not.i.i, label %_ZN11CStringBaseIwED2Ev.exit, label %while.cond.i.i

_ZN11CStringBaseIwED2Ev.exit:                     ; preds = %while.cond.i.i
  store i32 %sub9, ptr %_length.i, align 8
  tail call void @_ZdaPv(ptr noundef nonnull %ref.tmp.sroa.0.1) #12
  br label %if.end11

_ZN11CStringBaseIwED2Ev.exit33:                   ; preds = %if.end.i.i26
