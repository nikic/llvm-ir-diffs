...
entry:
  %1 = load i32, ptr @global_use_utf16_conversion, align 4
...
if.end9.i.i:                                      ; preds = %if.end.i.i
  ...
  store ptr %call.i.i4243, ptr %agg.result, align 8
...
invoke.cont2:                                     ; preds = %if.end9.i.i, %if.then
  ...
  %6 = load ptr, ptr %srcString, align 8
  %add = add nsw i32 %4, 1
...
nrvo.skipdtor:                                    ; preds = %invoke.cont2
  ...
  store i32 %conv9, ptr %_length.i45, align 8
  br label %return
...
if.end13:                                         ; preds = %delete.notnull.i47, %land.lhs.true, %entry
  ...
  store ptr %call.i.i50, ptr %agg.result, align 8
  ...
  %8 = load i32, ptr %_length.i51, align 8
...
for.body:                                         ; preds = %if.end13, %for.inc
  ...
  %11 = load ptr, ptr %srcString, align 8
...
for.inc:                                          ; preds = %for.body
  ...
  %13 = load i32, ptr %_length.i51, align 8
...
if.end9.i.i:                                      ; preds = %if.end.i.i
  tail call void @_ZdaPv(ptr noundef nonnull %call.i.i) #7
  store ptr %call.i.i5556, ptr %agg.result, align 8
  store i8 0, ptr %call.i.i5556, align 1
  store i32 %add.i.i, ptr %_capacity.i, align 4
  br label %invoke.cont3

invoke.cont3:                                     ; preds = %if.end9.i.i, %if.then
  %3 = phi ptr [ %call.i.i5556, %if.end9.i.i ], [ %call.i.i, %if.then ]
  %4 = load ptr, ptr %srcString, align 8
  %conv = sext i32 %add to i64
...
nrvo.skipdtor:                                    ; preds = %invoke.cont3
  ...
  store i32 %conv8, ptr %_length.i57, align 8
  br label %return
...
if.end14:                                         ; preds = %delete.notnull.i59, %land.lhs.true, %entry
  ...
  store ptr %call.i.i62, ptr %agg.result, align 8
  store i8 0, ptr %call.i.i62, align 1
  store i32 4, ptr %_capacity.i61, align 4
  %_length.i63 = getelementptr inbounds %class.CStringBase, ptr %srcString, i64 0, i32 1
  %6 = load i32, ptr %_length.i63, align 8
...
for.body:                                         ; preds = %if.end14, %for.inc
  ...
  %9 = load ptr, ptr %srcString, align 8
...
for.inc:                                          ; preds = %for.body
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %13 = load i32, ptr %_length.i63, align 8
  %14 = sext i32 %13 to i64
