; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Common/StringConvert.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Common/StringConvert.cpp"
...
define dso_local void @_Z24MultiByteToUnicodeStringRK11CStringBaseIcEj(ptr noalias sret(%class.CStringBase) align 8 %agg.result, ptr nocapture noundef nonnull readonly align 8 dereferenceable(16) %srcString, i32 noundef %0) local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
entry:
...
nrvo.skipdtor:                                    ; preds = %invoke.cont2
  ...
  %_length.i45 = getelementptr inbounds %class.CStringBase, ptr %agg.result, i64 0, i32 1
  store i32 %conv9, ptr %_length.i45, align 8, !tbaa !18
  br label %return

if.end13:                                         ; preds = %delete.notnull.i47, %land.lhs.true, %entry
  %_capacity.i49 = getelementptr inbounds %class.CStringBase, ptr %agg.result, i64 0, i32 2
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %agg.result, i8 0, i64 16, i1 false)
  ...
  %_length.i51 = getelementptr inbounds %class.CStringBase.0, ptr %srcString, i64 0, i32 1
...
for.cond.preheader.i.i:                           ; preds = %if.end.i.i
  ...
  %.pre.i.i = load ptr, ptr %this, align 8, !tbaa !12
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load8 = load <4 x i32>, ptr %8, align 4, !tbaa !14
  %9 = getelementptr inbounds i32, ptr %call.i.i, i64 %index
  store <4 x i32> %wide.load, ptr %9, align 4, !tbaa !14
  %10 = getelementptr inbounds i32, ptr %9, i64 4
  store <4 x i32> %wide.load8, ptr %10, align 4, !tbaa !14
...
for.body.i.i.prol:                                ; preds = %for.body.i.i.preheader, %for.body.i.i.prol
  ...
  %14 = load i32, ptr %arrayidx.i.i.prol, align 4, !tbaa !14
  %arrayidx7.i.i.prol = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.i.i.prol
  store i32 %14, ptr %arrayidx7.i.i.prol, align 4, !tbaa !14
...
delete.notnull.i.i:                               ; preds = %for.body.i.i.prol.loopexit, %for.body.i.i, %middle.block, %for.cond.cleanup.i.i
  tail call void @_ZdaPv(ptr noundef nonnull %.pre.i.i) #7
...
_ZN11CStringBaseIwE10GrowLengthEi.exit:           ; preds = %entry, %if.end.i, %if.end9.i.i
  ...
  %22 = load ptr, ptr %this, align 8, !tbaa !12
...
; Function Attrs: uwtable
define dso_local void @_Z24UnicodeStringToMultiByteRK11CStringBaseIwEj(ptr noalias sret(%class.CStringBase.0) align 8 %agg.result, ptr nocapture noundef nonnull readonly align 8 dereferenceable(16) %srcString, i32 noundef %0) local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
entry:
  %1 = load i32, ptr @global_use_utf16_conversion, align 4, !tbaa !5
  %tobool.not = icmp eq i32 %1, 0
...
nrvo.skipdtor:                                    ; preds = %invoke.cont3
  ...
  %_length.i57 = getelementptr inbounds %class.CStringBase.0, ptr %agg.result, i64 0, i32 1
  store i32 %conv8, ptr %_length.i57, align 8, !tbaa !9
  br label %return

if.end14:                                         ; preds = %delete.notnull.i59, %land.lhs.true, %entry
  %_capacity.i61 = getelementptr inbounds %class.CStringBase.0, ptr %agg.result, i64 0, i32 2
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %agg.result, i8 0, i64 16, i1 false)
  ...
  %_length.i63 = getelementptr inbounds %class.CStringBase, ptr %srcString, i64 0, i32 1
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %11, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !31
...
_ZN11CStringBaseIcE10GrowLengthEi.exit:           ; preds = %entry, %if.end.i, %if.end9.i.i
  ...
  %24 = load i32, ptr %_length.i, align 8, !tbaa !9
