; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Common/MyWindows.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Common/MyWindows.cpp"
...
if.end:                                           ; preds = %entry
  store i32 %len, ptr %call.i, align 4
...
for.cond.i:                                       ; preds = %entry, %for.cond.i
  ...
  br i1 %cmp.not.i, label %_ZL11MyStringLenPKw.exit, label %for.cond.i
...
VariantClear.exit:                                ; preds = %entry, %if.then.i, %if.then.i.i
  store i16 0, ptr %dest, align 8
  %3 = load i16, ptr %src, align 8
...
SysStringByteLen.exit:                            ; preds = %if.then2, %if.end.i
  ...
  br i1 %cmp.i19, label %SysAllocStringByteLen.exit.thread, label %if.end.i20
...
if.end.i20:                                       ; preds = %SysStringByteLen.exit
  store i32 %retval.0.i, ptr %call.i.i, align 4
  %add.ptr.i21 = getelementptr inbounds i32, ptr %call.i.i, i64 1
  br i1 %cmp.i18, label %if.end7, label %if.then5.i

if.then5.i:                                       ; preds = %if.end.i20
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %add.ptr.i21, ptr nonnull align 1 %5, i64 %conv.i, i1 false)
  br label %if.end7

if.end7:                                          ; preds = %if.then5.i, %if.end.i20
  %add.ptr8.i = getelementptr inbounds i8, ptr %add.ptr.i21, i64 %conv.i
  ...
  store ptr %add.ptr.i21, ptr %8, align 8
  store i16 8, ptr %dest, align 8
  br label %cleanup
...
entry:
  ...
  %1 = load i32, ptr %dwHighDateTime1, align 4
...
if.end6:                                          ; preds = %if.end
  %2 = load i32, ptr %ft1, align 4
  %3 = load i32, ptr %ft2, align 4
