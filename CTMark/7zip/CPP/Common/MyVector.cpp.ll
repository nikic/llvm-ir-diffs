; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Common/MyVector.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Common/MyVector.cpp"
...
entry:
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV17CBaseRecordVector, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
if.then.i:                                        ; preds = %entry
  store i32 0, ptr %_size.i.i.i, align 4
...
if.then.i.i:                                      ; preds = %entry
  store i32 0, ptr %_size.i.i.i.i, align 4
...
entry:
  ...
  %0 = load i32, ptr %_size, align 4
  %_capacity = getelementptr inbounds %class.CBaseRecordVector, ptr %this, i64 0, i32 1
  %1 = load i32, ptr %_capacity, align 8
...
entry:
  %_capacity = getelementptr inbounds %class.CBaseRecordVector, ptr %this, i64 0, i32 1
  %0 = load i32, ptr %_capacity, align 8
...
if.then3:                                         ; preds = %if.end
  ...
  store i32 1052353, ptr %exception, align 16
...
if.end4:                                          ; preds = %if.end
  ...
  %1 = load i64, ptr %_itemSize, align 8
...
if.then8:                                         ; preds = %if.end4
  ...
  store i32 1052354, ptr %exception9, align 16
...
if.end10.if.end22_crit_edge:                      ; preds = %if.end10
  ...
  %.pre = load ptr, ptr %_items23.phi.trans.insert, align 8
  br label %if.end22

if.then12:                                        ; preds = %if.end10
  %call = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %mul.val) #11
  %_size = getelementptr inbounds %class.CBaseRecordVector, ptr %this, i64 0, i32 2
  %2 = load i32, ptr %_size, align 4
...
delete.end:                                       ; preds = %delete.notnull, %if.end22
  store ptr %p.0, ptr %_items23, align 8
  store i32 %newCapacity, ptr %_capacity, align 8
  br label %return
...
entry:
  ...
  %0 = load i32, ptr %_size.i, align 4
  %_capacity.i = getelementptr inbounds %class.CBaseRecordVector, ptr %this, i64 0, i32 1
  %1 = load i32, ptr %_capacity.i, align 8
...
_ZN17CBaseRecordVector18ReserveOnePositionEv.exit: ; preds = %entry, %if.end.i
  ...
  %4 = load i64, ptr %_itemSize.i, align 8
  ...
  %inc = add nsw i32 %5, 1
  store i32 %inc, ptr %_size.i, align 4
  ret void
}
...
if.then:                                          ; preds = %entry
  ...
  %_itemSize.i = getelementptr inbounds %class.CBaseRecordVector, ptr %this, i64 0, i32 4
  %2 = load i64, ptr %_itemSize.i, align 8
  ...
  store i32 %sub, ptr %_size.i, align 4
  br label %if.end
