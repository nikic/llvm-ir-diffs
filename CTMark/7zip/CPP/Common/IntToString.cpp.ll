; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Common/IntToString.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Common/IntToString.cpp"
...
do.body:                                          ; preds = %do.body, %if.end
  ...
  br i1 %cmp7.not, label %do.body8.preheader, label %do.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load34 = load <16 x i8>, ptr %7, align 1
  ...
  store <16 x i8> %reverse, ptr %next.gep, align 1
  %8 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %reverse35, ptr %8, align 1
...
do.body8:                                         ; preds = %do.body8.preheader36, %do.body8
  ...
  store i8 %10, ptr %s.addr.0, align 1
...
do.end13:                                         ; preds = %do.body8, %middle.block
  ...
  store i8 0, ptr %incdec.ptr.lcssa, align 1
...
do.body:                                          ; preds = %do.body, %entry
  ...
  br i1 %cmp.not, label %do.body1.preheader, label %do.body
...
do.body1:                                         ; preds = %do.body1.preheader23, %do.body1
  ...
  store i32 %11, ptr %s.addr.0, align 4
...
do.end6:                                          ; preds = %do.body1, %middle.block
  ...
  store i32 0, ptr %incdec.ptr.lcssa, align 4
...
do.body.i:                                        ; preds = %do.body.i, %entry
  ...
  store i8 %cond.i, ptr %arrayidx.i, align 1
  %div.i = udiv i64 %value.addr.0.i, 10
  %cmp7.not.i = icmp ult i64 %value.addr.0.i, 10
  %indvars.iv.next27.i = add i32 %indvars.iv26.i, 1
  br i1 %cmp7.not.i, label %do.body8.preheader.i, label %do.body.i
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load4 = load <16 x i8>, ptr %6, align 1
  ...
  store <16 x i8> %reverse5, ptr %7, align 1
  %index.next = add nuw i64 %index, 32
...
do.body8.i:                                       ; preds = %do.body8.i.preheader, %do.body8.i
  ...
  store i8 %9, ptr %s.addr.0.i, align 1
  %cmp12.i = icmp sgt i64 %indvars.iv28.i, 1
  br i1 %cmp12.i, label %do.body8.i, label %_Z21ConvertUInt64ToStringyPcj.exit
...
_Z21ConvertUInt64ToStringyPcj.exit:               ; preds = %do.body8.i, %middle.block
  ...
  store i8 0, ptr %incdec.ptr.i.lcssa, align 1
...
do.body.i:                                        ; preds = %do.body.i, %entry
  ...
  %indvars.iv.next14.i = add i32 %indvars.iv13.i, 1
  br i1 %cmp.not.i, label %do.body1.preheader.i, label %do.body.i
...
do.body1.i:                                       ; preds = %do.body1.i.preheader, %do.body1.i
  ...
  store i32 %11, ptr %s.addr.0.i, align 4
  %cmp5.i = icmp sgt i64 %indvars.iv15.i, 1
  br i1 %cmp5.i, label %do.body1.i, label %_Z21ConvertUInt64ToStringyPw.exit
...
_Z21ConvertUInt64ToStringyPw.exit:                ; preds = %do.body1.i, %middle.block
  ...
  store i32 0, ptr %incdec.ptr.i.lcssa, align 4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %reverse = shufflevector <16 x i8> %wide.load, <16 x i8> poison, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  %6 = getelementptr inbounds i8, ptr %4, i64 -31
  %wide.load7 = load <16 x i8>, ptr %6, align 1
  ...
  store <16 x i8> %reverse, ptr %next.gep, align 1
  %7 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %reverse8, ptr %7, align 1
  %index.next = add nuw i64 %index, 32
  %8 = icmp eq i64 %index.next, %n.vec
  br i1 %8, label %middle.block, label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> %reverse, ptr %next.gep, align 4
  %9 = getelementptr i32, ptr %next.gep, i64 4
  store <4 x i32> %reverse8, ptr %9, align 4
  %index.next = add nuw i64 %index, 8
  %10 = icmp eq i64 %index.next, %n.vec
  br i1 %10, label %middle.block, label %vector.body
...
entry:
  ...
  store <4 x i8> %8, ptr %arrayidx.6, align 1
...
attributes #0 = { mustprogress nofree nosync nounwind memory(write, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
