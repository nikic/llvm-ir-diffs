...
while.cond:                                       ; preds = %while.cond, %entry
  ...
  %0 = load i8, ptr %start.addr.0, align 1
...
while.body:                                       ; preds = %while.cond.preheader, %while.body
  ...
  store i8 %conv1.i, ptr %s.addr.07, align 1
...
while.body:                                       ; preds = %while.cond.preheader, %while.body
  ...
  store i32 %call.i, ptr %s.addr.07, align 4
...
while.body:                                       ; preds = %cleanup, %entry
  ...
  %0 = load i32, ptr %s1.addr.0, align 4
  %incdec.ptr1 = getelementptr inbounds i32, ptr %s2.addr.0, i64 1
  %1 = load i32, ptr %s2.addr.0, align 4
...
_Z11MyStringLenIcEiPKT_.exit.i:                   ; preds = %for.cond.i.i
  ...
  store ptr %call.i.i, ptr %ref.tmp1, align 8
...
for.cond.i.i24:                                   ; preds = %for.cond.i.i24, %invoke.cont
  ...
  %4 = load i8, ptr %arrayidx.i.i26, align 1
  %cmp.not.i.i27 = icmp eq i8 %4, 0
  %indvars.iv.next.i.i28 = add nuw i64 %indvars.iv.i.i25, 1
  br i1 %cmp.not.i.i27, label %_Z11MyStringLenIcEiPKT_.exit.i29, label %for.cond.i.i24
...
call.i.i34.noexc:                                 ; preds = %_Z11MyStringLenIcEiPKT_.exit.i29
  ...
  store ptr %call.i.i3443, ptr %ref.tmp5, align 8
  store i8 0, ptr %call.i.i3443, align 1
  store i32 %add.i.i30, ptr %_capacity.i23, align 4
...
while.body.i:                                     ; preds = %cleanup13.i, %invoke.cont9
  ...
  %8 = load i32, ptr %s1.addr.0.i, align 4
  %incdec.ptr1.i = getelementptr inbounds i32, ptr %s2.addr.0.i, i64 1
  %9 = load i32, ptr %s2.addr.0.i, align 4
