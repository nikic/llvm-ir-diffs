...
if.then.i:                                        ; preds = %land.lhs.true.i
  ...
  store ptr @.str.3, ptr %exception.i, align 16
...
if.then6:                                         ; preds = %if.end3
  ...
  store ptr @.str.2, ptr %exception7, align 16
...
entry:
  ...
  %0 = load ptr, ptr %resultString, align 8
...
land.lhs.true.i:                                  ; preds = %while.body, %entry
  %2 = load ptr, ptr %_stream.i, align 8
...
while.body:                                       ; preds = %entry, %while.body
  ...
  %cmp.i = icmp eq i32 %call.i, -1
  br i1 %cmp.i, label %land.lhs.true.i, label %while.body
...
entry:
  ...
  store i8 0, ptr @g_StdIn, align 8
  store ptr %0, ptr getelementptr inbounds (%class.CStdInStream, ptr @g_StdIn, i64 0, i32 1), align 8
