; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Common/StdInStream.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Common/StdInStream.cpp"
...
_ZL16nameWindowToUnixPKc.exit:                    ; preds = %_ZN11CStringBaseIwED2Ev.exit, %land.lhs.true.i
  ...
  %call8 = call noalias ptr @fopen64(ptr noundef nonnull %retval.0.i13, ptr noundef nonnull @.str)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %4, align 1, !tbaa !26
  %5 = getelementptr inbounds i8, ptr %4, i64 16
  %wide.load9 = load <16 x i8>, ptr %5, align 1, !tbaa !26
  %6 = getelementptr inbounds i8, ptr %call.i.i, i64 %index
  store <16 x i8> %wide.load, ptr %6, align 1, !tbaa !26
  %7 = getelementptr inbounds i8, ptr %6, i64 16
  store <16 x i8> %wide.load9, ptr %7, align 1, !tbaa !26
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load14 = load <8 x i8>, ptr %9, align 1, !tbaa !26
  %10 = getelementptr inbounds i8, ptr %call.i.i, i64 %index13
  store <8 x i8> %wide.load14, ptr %10, align 1, !tbaa !26
...
for.body.i.i.prol:                                ; preds = %for.body.i.i.preheader, %for.body.i.i.prol
  ...
  %14 = load i8, ptr %arrayidx.i.i.prol, align 1, !tbaa !26
  %arrayidx7.i.i.prol = getelementptr inbounds i8, ptr %call.i.i, i64 %indvars.iv.i.i.prol
  store i8 %14, ptr %arrayidx7.i.i.prol, align 1, !tbaa !26
...
_ZN11CStringBaseIcE10GrowLengthEi.exit:           ; preds = %entry, %if.end.i, %if.end9.i.i
  ...
  %22 = load ptr, ptr %this, align 8, !tbaa !24
  ...
  %24 = load i32, ptr %_length.i, align 8, !tbaa !29
