...
call.i.i.noexc.i37:                               ; preds = %call.i.noexc53
  ...
  store ptr %call.i.i4.i35, ptr %call.i54, align 8, !tbaa !5
  store i32 0, ptr %call.i.i4.i35, align 4, !tbaa !15
  store i32 %add.i.i.i31, ptr %_capacity.i.i38, align 4, !tbaa !18
...
while.cond.i.i.i40:                               ; preds = %call.i.i.noexc.i37, %while.cond.i.i.i40
  ...
  %12 = load i32, ptr %src.addr.0.i.i.i41, align 4, !tbaa !15
  %incdec.ptr1.i.i.i44 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i42, i64 1
  store i32 %12, ptr %dest.addr.0.i.i.i42, align 4, !tbaa !15
  %cmp.not.i.i.i45 = icmp eq i32 %12, 0
  br i1 %cmp.not.i.i.i45, label %invoke.cont.i46, label %while.cond.i.i.i40, !llvm.loop !19

invoke.cont.i46:                                  ; preds = %while.cond.i.i.i40
  %_length.i.i47 = getelementptr inbounds %class.CStringBase, ptr %call.i54, i64 0, i32 1
  store i32 %name.sroa.13.093, ptr %_length.i.i47, align 8, !tbaa !17
  invoke void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %pathParts)
...
invoke.cont8:                                     ; preds = %invoke.cont.i46
  %14 = load ptr, ptr %_items.i.i48, align 8, !tbaa !21
  %15 = load i32, ptr %_size.i.i49, align 4, !tbaa !24
  %idxprom.i.i50 = sext i32 %15 to i64
  %arrayidx.i.i51 = getelementptr inbounds ptr, ptr %14, i64 %idxprom.i.i50
  store ptr %call.i54, ptr %arrayidx.i.i51, align 8, !tbaa !25
  %inc.i.i52 = add nsw i32 %15, 1
  store i32 %inc.i.i52, ptr %_size.i.i49, align 4, !tbaa !24
  br label %if.end13
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load106 = load <4 x i32>, ptr %23, align 4, !tbaa !15
  ...
  store <4 x i32> %wide.load106, ptr %25, align 4, !tbaa !15
...
delete.notnull.i.i43:                             ; preds = %call.i.i.noexc45
  ...
  %.pre.i44 = load i32, ptr %_length.i.i24, align 8, !tbaa !17
...
if.end9.i.i32:                                    ; preds = %delete.notnull.i.i43, %call.i.i.noexc45
  ...
  store i32 %add.i.i26, ptr %_capacity.i.i27, align 4, !tbaa !18
...
while.cond.i.i36:                                 ; preds = %while.cond.i.i36, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i35
  ...
  br i1 %cmp.not.i.i41, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i42, label %while.cond.i.i36, !llvm.loop !19

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i42:          ; preds = %while.cond.i.i36
  %29 = load i32, ptr %_length.i25, align 8, !tbaa !17
  store i32 %29, ptr %_length.i.i24, align 8, !tbaa !17
  br label %invoke.cont7
...
if.end5.if.end28_crit_edge:                       ; preds = %if.end5
  ...
  %.pre111 = load i8, ptr %ForFile34.phi.trans.insert, align 1, !range !13
  br label %if.end28
...
for.cond:                                         ; preds = %for.end
  ...
  br i1 %exitcond110.not, label %return.loopexit.split.loop.exit113, label %for.cond41.preheader, !llvm.loop !45
...
for.body45:                                       ; preds = %for.cond41.preheader, %for.inc
  ...
  %.pre112.pre = load i32, ptr %_size.i89, align 4, !tbaa !24
...
for.cond:                                         ; preds = %for.body
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %return.loopexit.split.loop.exit, label %for.body, !llvm.loop !61
...
for.cond.i47:                                     ; preds = %for.body.i43
  ...
  br i1 %cmp.not.i49, label %for.body.i43, label %_ZNK9NWildcard11CCensorNode16CheckPathCurrentEbRK13CObjectVectorI11CStringBaseIwEEb.exit50, !llvm.loop !62
...
for.body.i43:                                     ; preds = %for.cond.i47, %for.body.lr.ph.i41
  ...
  %8 = load ptr, ptr %_items.i.i.i42, align 8, !tbaa !21
  %arrayidx.i.i.i45 = getelementptr inbounds ptr, ptr %8, i64 %indvars.iv.i44
  %9 = load ptr, ptr %arrayidx.i.i.i45, align 8, !tbaa !25
...
for.body.i55:                                     ; preds = %for.inc.i, %for.body.lr.ph.i53
  ...
  %14 = load ptr, ptr %_items.i.i.i54, align 8, !tbaa !21
  %arrayidx.i.i.i57 = getelementptr inbounds ptr, ptr %14, i64 %indvars.iv.i56
  %15 = load ptr, ptr %arrayidx.i.i.i57, align 8, !tbaa !25
  %Name.i = getelementptr inbounds %"class.NWildcard::CCensorNode", ptr %15, i64 0, i32 1
  %16 = load i8, ptr @g_CaseSensitive, align 1, !tbaa !11, !range !13, !noundef !14
  %tobool.not.i.i = icmp eq i8 %16, 0
  %17 = load ptr, ptr %Name.i, align 8, !tbaa !5
...
for.inc.i:                                        ; preds = %_Z16CompareFileNamesRK11CStringBaseIwES2_.exit.i
  ...
  br i1 %cmp.not.i59, label %for.body.i55, label %if.end21, !llvm.loop !48
...
invoke.cont:                                      ; preds = %for.cond.cleanup.i
  %27 = load ptr, ptr %_items.i.i.i54, align 8, !tbaa !21
...
vector.body313:                                   ; preds = %vector.body313, %vector.ph308
  ...
  %wide.load315 = load <4 x i32>, ptr %40, align 4, !tbaa !15
  %41 = getelementptr inbounds i32, ptr %40, i64 4
  %wide.load316 = load <4 x i32>, ptr %41, align 4, !tbaa !15
  %42 = getelementptr inbounds i32, ptr %call.i.i.i165, i64 %index314
  store <4 x i32> %wide.load315, ptr %42, align 4, !tbaa !15
  %43 = getelementptr inbounds i32, ptr %42, i64 4
  store <4 x i32> %wide.load316, ptr %43, align 4, !tbaa !15
  %index.next317 = add nuw i64 %index314, 8
  %44 = icmp eq i64 %index.next317, %n.vec310
  br i1 %44, label %middle.block305, label %vector.body313, !llvm.loop !67
...
for.body.i.i.i.prol:                              ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i.prol
  ...
  %47 = load i32, ptr %arrayidx.i.i.i164.prol, align 4, !tbaa !15
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  ...
  %49 = load i32, ptr %arrayidx.i.i.i164, align 4, !tbaa !15
  ...
  %50 = load i32, ptr %arrayidx.i.i.i164.1, align 4, !tbaa !15
  ...
  %51 = load i32, ptr %arrayidx.i.i.i164.2, align 4, !tbaa !15
  ...
  %52 = load i32, ptr %arrayidx.i.i.i164.3, align 4, !tbaa !15
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load300 = load <4 x i32>, ptr %62, align 4, !tbaa !15
  ...
  store <4 x i32> %wide.load300, ptr %64, align 4, !tbaa !15
  %index.next = add nuw i64 %index, 8
...
for.body.i.i.i199.prol:                           ; preds = %for.body.i.i.i199.preheader, %for.body.i.i.i199.prol
  ...
  %68 = load i32, ptr %arrayidx.i.i.i201.prol, align 4, !tbaa !15
  %arrayidx7.i.i.i202.prol = getelementptr inbounds i32, ptr %call.i.i.i206, i64 %indvars.iv.i.i.i200.prol
  store i32 %68, ptr %arrayidx7.i.i.i202.prol, align 4, !tbaa !15
  ...
  br i1 %prol.iter324.cmp.not, label %for.body.i.i.i199.prol.loopexit, label %for.body.i.i.i199.prol, !llvm.loop !71
...
for.body.i.i.i199:                                ; preds = %for.body.i.i.i199.prol.loopexit, %for.body.i.i.i199
  ...
  %70 = load i32, ptr %arrayidx.i.i.i201, align 4, !tbaa !15
  %arrayidx7.i.i.i202 = getelementptr inbounds i32, ptr %call.i.i.i206, i64 %indvars.iv.i.i.i200
  store i32 %70, ptr %arrayidx7.i.i.i202, align 4, !tbaa !15
  ...
  %71 = load i32, ptr %arrayidx.i.i.i201.1, align 4, !tbaa !15
  %arrayidx7.i.i.i202.1 = getelementptr inbounds i32, ptr %call.i.i.i206, i64 %indvars.iv.next.i.i.i203
  store i32 %71, ptr %arrayidx7.i.i.i202.1, align 4, !tbaa !15
  ...
  %72 = load i32, ptr %arrayidx.i.i.i201.2, align 4, !tbaa !15
  %arrayidx7.i.i.i202.2 = getelementptr inbounds i32, ptr %call.i.i.i206, i64 %indvars.iv.next.i.i.i203.1
  store i32 %72, ptr %arrayidx7.i.i.i202.2, align 4, !tbaa !15
  ...
  %73 = load i32, ptr %arrayidx.i.i.i201.3, align 4, !tbaa !15
  %arrayidx7.i.i.i202.3 = getelementptr inbounds i32, ptr %call.i.i.i206, i64 %indvars.iv.next.i.i.i203.2
  store i32 %73, ptr %arrayidx7.i.i.i202.3, align 4, !tbaa !15
  ...
  br i1 %exitcond.not.i.i.i204.3, label %delete.notnull.i.i.i195, label %for.body.i.i.i199, !llvm.loop !72
...
if.end9.i.i.i187:                                 ; preds = %delete.notnull.i.i.i195, %for.cond.cleanup.i.i.i193, %call.i.i.i.noexc205
  ...
  store i32 0, ptr %arrayidx14.i.i.i189, align 4, !tbaa !15
...
for.inc77:                                        ; preds = %for.cond.cleanup.i
  ...
  br i1 %exitcond289.not, label %cleanup79, label %invoke.cont62, !llvm.loop !73
...
cleanup79:                                        ; preds = %for.inc77, %invoke.cont64, %_ZN11CStringBaseIwEC2Ev.exit
  ...
  %78 = load i32, ptr %_size.i.i209, align 4, !tbaa !24
...
for.body.i213:                                    ; preds = %for.inc.i216, %for.body.lr.ph.i211
  ...
  %79 = load ptr, ptr %_items.i.i.i212, align 8, !tbaa !21
  %arrayidx.i.i.i215 = getelementptr inbounds ptr, ptr %79, i64 %indvars.iv.i214
  %80 = load ptr, ptr %arrayidx.i.i.i215, align 8, !tbaa !25
...
for.inc.i216:                                     ; preds = %_Z16CompareFileNamesRK11CStringBaseIwES2_.exit.i
  ...
  %83 = load i32, ptr %_size.i.i209, align 4, !tbaa !24
...
call.i.i.i.noexc232:                              ; preds = %if.end9.i.i.i224
  ...
  store ptr %call.i.i.i233, ptr %ref.tmp, align 8, !tbaa !5
  store i32 0, ptr %call.i.i.i233, align 4, !tbaa !15
  store i32 %add.i.i.i222, ptr %_capacity.i.i225, align 4, !tbaa !18
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i
...
_ZN11CStringBaseIwEC2ERKS0_.exit.i:               ; preds = %while.cond.i.i.i
  ...
  store i32 %prefix.sroa.15.0.lcssa, ptr %_length.i.i227, align 8, !tbaa !17
...
invoke.cont88:                                    ; preds = %_ZN11CStringBaseIwEC2ERKS0_.exit.i
  ...
  store i32 4, ptr %_capacity.i.i.i231, align 4, !tbaa !18
...
if.end8:                                          ; preds = %entry
  ...
  store ptr %call.i.i33, ptr %agg.result, align 8, !tbaa !5
  store i32 0, ptr %call.i.i33, align 4, !tbaa !15
  store i32 4, ptr %_capacity.i32, align 4, !tbaa !18
...
_ZN11CStringBaseIwE11SetCapacityEi.exit:          ; preds = %if.end.i
  ...
  store i32 %add.i, ptr %_capacity.i32, align 4, !tbaa !18
