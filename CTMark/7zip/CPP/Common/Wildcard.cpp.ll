; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Common/Wildcard.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Common/Wildcard.cpp"
...
entry:
  %0 = load i8, ptr @g_CaseSensitive, align 1
...
for.cond.preheader:                               ; preds = %entry
  ...
  br i1 %cmp191, label %for.body.lr.ph, label %for.cond.cleanup

for.body.lr.ph:                                   ; preds = %for.cond.preheader
  %_items.i.i48 = getelementptr inbounds %class.CBaseRecordVector, ptr %pathParts, i64 0, i32 3
  %_size.i.i49 = getelementptr inbounds %class.CBaseRecordVector, ptr %pathParts, i64 0, i32 2
...
call.i.i.noexc.i:                                 ; preds = %call.i.noexc
  ...
  store ptr %call.i.i4.i, ptr %call.i29, align 8
...
invoke.cont.i:                                    ; preds = %while.cond.i.i.i
  ...
  store i32 %name.sroa.13.0.lcssa, ptr %_length.i.i, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end13
  ...
  %name.sroa.19.094 = phi i32 [ 4, %for.body.lr.ph ], [ %name.sroa.19.2, %if.end13 ]
  %name.sroa.13.093 = phi i32 [ 0, %for.body.lr.ph ], [ %name.sroa.13.1, %if.end13 ]
  %name.sroa.0.092 = phi ptr [ %call.i.i, %for.body.lr.ph ], [ %name.sroa.0.2, %if.end13 ]
  %name.sroa.0.092105 = ptrtoint ptr %name.sroa.0.092 to i64
...
call.i.noexc53:                                   ; preds = %if.then7
  ...
  %add.i.i.i31 = add nsw i32 %name.sroa.13.093, 1
  %cmp.i.i.i32 = icmp ne i32 %add.i.i.i31, 0
  tail call void @llvm.assume(i1 %cmp.i.i.i32)
  %conv.i.i.i34 = zext i32 %add.i.i.i31 to i64
  %9 = icmp slt i32 %name.sroa.13.093, -1
  %10 = shl nuw nsw i64 %conv.i.i.i34, 2
  %11 = select i1 %9, i64 -1, i64 %10
  %call.i.i4.i35 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %11) #19
          to label %call.i.i.noexc.i37 unwind label %lpad.i36

call.i.i.noexc.i37:                               ; preds = %call.i.noexc53
  %_capacity.i.i38 = getelementptr inbounds %class.CStringBase, ptr %call.i54, i64 0, i32 2
  store ptr %call.i.i4.i35, ptr %call.i54, align 8
  store i32 0, ptr %call.i.i4.i35, align 4
  store i32 %add.i.i.i31, ptr %_capacity.i.i38, align 4
  br label %while.cond.i.i.i40

while.cond.i.i.i40:                               ; preds = %call.i.i.noexc.i37, %while.cond.i.i.i40
  %src.addr.0.i.i.i41 = phi ptr [ %incdec.ptr.i.i.i43, %while.cond.i.i.i40 ], [ %name.sroa.0.092, %call.i.i.noexc.i37 ]
  %dest.addr.0.i.i.i42 = phi ptr [ %incdec.ptr1.i.i.i44, %while.cond.i.i.i40 ], [ %call.i.i4.i35, %call.i.i.noexc.i37 ]
  %incdec.ptr.i.i.i43 = getelementptr inbounds i32, ptr %src.addr.0.i.i.i41, i64 1
  %12 = load i32, ptr %src.addr.0.i.i.i41, align 4
  %incdec.ptr1.i.i.i44 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i42, i64 1
  store i32 %12, ptr %dest.addr.0.i.i.i42, align 4
  %cmp.not.i.i.i45 = icmp eq i32 %12, 0
  br i1 %cmp.not.i.i.i45, label %invoke.cont.i46, label %while.cond.i.i.i40

invoke.cont.i46:                                  ; preds = %while.cond.i.i.i40
  %_length.i.i47 = getelementptr inbounds %class.CStringBase, ptr %call.i54, i64 0, i32 1
  store i32 %name.sroa.13.093, ptr %_length.i.i47, align 8
  invoke void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %pathParts)
          to label %invoke.cont8 unwind label %lpad2

lpad.i36:                                         ; preds = %call.i.noexc53
  %13 = landingpad { ptr, i32 }
          cleanup
  br label %delete.notnull.i66.sink.split

invoke.cont8:                                     ; preds = %invoke.cont.i46
  %14 = load ptr, ptr %_items.i.i48, align 8
  %15 = load i32, ptr %_size.i.i49, align 4
  %idxprom.i.i50 = sext i32 %15 to i64
  %arrayidx.i.i51 = getelementptr inbounds ptr, ptr %14, i64 %idxprom.i.i50
  store ptr %call.i54, ptr %arrayidx.i.i51, align 8
  %inc.i.i52 = add nsw i32 %15, 1
  store i32 %inc.i.i52, ptr %_size.i.i49, align 4
  br label %if.end13

lpad2:                                            ; preds = %if.end.i.i.i, %invoke.cont.i46, %if.then7
  %16 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup

if.else:                                          ; preds = %for.body
  %17 = xor i32 %name.sroa.13.093, -1
  %sub2.i.i = add i32 %name.sroa.19.094, %17
  %cmp.not.i.i = icmp slt i32 %sub2.i.i, 1
  br i1 %cmp.not.i.i, label %if.end.i.i, label %_ZN11CStringBaseIwEpLEw.exit

if.end.i.i:                                       ; preds = %if.else
  %cmp4.i.i = icmp sgt i32 %name.sroa.19.094, 64
  %div24.i.i = lshr i32 %name.sroa.19.094, 1
  %cmp8.i.i = icmp sgt i32 %name.sroa.19.094, 8
  ...
  %add18.i.i = add nsw i32 %delta.1.i.i, %name.sroa.19.094
  %add.i.i.i60 = add nsw i32 %add18.i.i, 1
  %cmp.i.i.i61 = icmp eq i32 %add.i.i.i60, %name.sroa.19.094
...
call.i.i.i.noexc:                                 ; preds = %if.end.i.i.i
  %call.i.i.i64104 = ptrtoint ptr %call.i.i.i64 to i64
  %cmp3.i.i.i = icmp sgt i32 %name.sroa.19.094, 0
  br i1 %cmp3.i.i.i, label %for.cond.preheader.i.i.i, label %if.end9.i.i.i63

for.cond.preheader.i.i.i:                         ; preds = %call.i.i.i.noexc
  %cmp522.i.i.i = icmp sgt i32 %name.sroa.13.093, 0
  br i1 %cmp522.i.i.i, label %for.body.lr.ph.i.i.i, label %delete.notnull.i.i.i

for.body.lr.ph.i.i.i:                             ; preds = %for.cond.preheader.i.i.i
  %wide.trip.count.i.i.i = zext i32 %name.sroa.13.093 to i64
  %min.iters.check = icmp ult i32 %name.sroa.13.093, 8
  %21 = sub i64 %call.i.i.i64104, %name.sroa.0.092105
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %22 = getelementptr inbounds i32, ptr %name.sroa.0.092, i64 %index
  %wide.load = load <4 x i32>, ptr %22, align 4
  %23 = getelementptr inbounds i32, ptr %22, i64 4
  %wide.load106 = load <4 x i32>, ptr %23, align 4
  %24 = getelementptr inbounds i32, ptr %call.i.i.i64, i64 %index
  store <4 x i32> %wide.load, ptr %24, align 4
  %25 = getelementptr inbounds i32, ptr %24, i64 4
  store <4 x i32> %wide.load106, ptr %25, align 4
...
for.body.i.i.i.prol:                              ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i.prol
  ...
  %arrayidx.i.i.i.prol = getelementptr inbounds i32, ptr %name.sroa.0.092, i64 %indvars.iv.i.i.i.prol
  %29 = load i32, ptr %arrayidx.i.i.i.prol, align 4
  %arrayidx7.i.i.i.prol = getelementptr inbounds i32, ptr %call.i.i.i64, i64 %indvars.iv.i.i.i.prol
  store i32 %29, ptr %arrayidx7.i.i.i.prol, align 4
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  ...
  %arrayidx.i.i.i = getelementptr inbounds i32, ptr %name.sroa.0.092, i64 %indvars.iv.i.i.i
  %31 = load i32, ptr %arrayidx.i.i.i, align 4
  %arrayidx7.i.i.i = getelementptr inbounds i32, ptr %call.i.i.i64, i64 %indvars.iv.i.i.i
  store i32 %31, ptr %arrayidx7.i.i.i, align 4
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1
  %arrayidx.i.i.i.1 = getelementptr inbounds i32, ptr %name.sroa.0.092, i64 %indvars.iv.next.i.i.i
  %32 = load i32, ptr %arrayidx.i.i.i.1, align 4
  %arrayidx7.i.i.i.1 = getelementptr inbounds i32, ptr %call.i.i.i64, i64 %indvars.iv.next.i.i.i
  store i32 %32, ptr %arrayidx7.i.i.i.1, align 4
  %indvars.iv.next.i.i.i.1 = add nuw nsw i64 %indvars.iv.i.i.i, 2
  %arrayidx.i.i.i.2 = getelementptr inbounds i32, ptr %name.sroa.0.092, i64 %indvars.iv.next.i.i.i.1
  %33 = load i32, ptr %arrayidx.i.i.i.2, align 4
  %arrayidx7.i.i.i.2 = getelementptr inbounds i32, ptr %call.i.i.i64, i64 %indvars.iv.next.i.i.i.1
  store i32 %33, ptr %arrayidx7.i.i.i.2, align 4
  %indvars.iv.next.i.i.i.2 = add nuw nsw i64 %indvars.iv.i.i.i, 3
  %arrayidx.i.i.i.3 = getelementptr inbounds i32, ptr %name.sroa.0.092, i64 %indvars.iv.next.i.i.i.2
  %34 = load i32, ptr %arrayidx.i.i.i.3, align 4
  %arrayidx7.i.i.i.3 = getelementptr inbounds i32, ptr %call.i.i.i64, i64 %indvars.iv.next.i.i.i.2
  store i32 %34, ptr %arrayidx7.i.i.i.3, align 4
...
delete.notnull.i.i.i:                             ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i, %middle.block, %for.cond.preheader.i.i.i
  tail call void @_ZdaPv(ptr noundef nonnull %name.sroa.0.092) #18
  br label %if.end9.i.i.i63

if.end9.i.i.i63:                                  ; preds = %delete.notnull.i.i.i, %call.i.i.i.noexc
  %idxprom13.i.i.i = sext i32 %name.sroa.13.093 to i64
...
_ZN11CStringBaseIwEpLEw.exit:                     ; preds = %if.else, %if.end.i.i, %if.end9.i.i.i63
  %name.sroa.0.1 = phi ptr [ %name.sroa.0.092, %if.end.i.i ], [ %call.i.i.i64, %if.end9.i.i.i63 ], [ %name.sroa.0.092, %if.else ]
  %name.sroa.19.1 = phi i32 [ %name.sroa.19.094, %if.end.i.i ], [ %add.i.i.i60, %if.end9.i.i.i63 ], [ %name.sroa.19.094, %if.else ]
  %idxprom.i = sext i32 %name.sroa.13.093 to i64
  %arrayidx.i = getelementptr inbounds i32, ptr %name.sroa.0.1, i64 %idxprom.i
  store i32 %8, ptr %arrayidx.i, align 4
  %inc.i = add nsw i32 %name.sroa.13.093, 1
...
if.end13:                                         ; preds = %_ZN11CStringBaseIwEpLEw.exit, %invoke.cont8
  %arrayidx5.i.sink = phi ptr [ %arrayidx5.i, %_ZN11CStringBaseIwEpLEw.exit ], [ %name.sroa.0.092, %invoke.cont8 ]
  %name.sroa.0.2 = phi ptr [ %name.sroa.0.1, %_ZN11CStringBaseIwEpLEw.exit ], [ %name.sroa.0.092, %invoke.cont8 ]
  %name.sroa.13.1 = phi i32 [ %inc.i, %_ZN11CStringBaseIwEpLEw.exit ], [ 0, %invoke.cont8 ]
  %name.sroa.19.2 = phi i32 [ %name.sroa.19.1, %_ZN11CStringBaseIwEpLEw.exit ], [ %name.sroa.19.094, %invoke.cont8 ]
...
cleanup:                                          ; preds = %invoke.cont.i
  ...
  store ptr %call.i29, ptr %arrayidx.i.i, align 8
...
delete.notnull.i:                                 ; preds = %entry, %cleanup
  %name.sroa.0.380 = phi ptr [ %name.sroa.0.0.lcssa, %cleanup ], [ %call.i.i, %entry ]
  tail call void @_ZdaPv(ptr noundef nonnull %name.sroa.0.380) #18
...
ehcleanup:                                        ; preds = %lpad2, %lpad
  %name.sroa.0.089 = phi ptr [ %name.sroa.0.0.lcssa, %lpad ], [ %name.sroa.0.092, %lpad2 ]
  %.pn = phi { ptr, i32 } [ %1, %lpad ], [ %16, %lpad2 ]
  %isnull.i65 = icmp eq ptr %name.sroa.0.089, null
  br i1 %isnull.i65, label %_ZN11CStringBaseIwED2Ev.exit67, label %delete.notnull.i66

delete.notnull.i66.sink.split:                    ; preds = %lpad.i36, %lpad.i
  %call.i29.sink = phi ptr [ %call.i29, %lpad.i ], [ %call.i54, %lpad.i36 ]
  %name.sroa.0.090.ph = phi ptr [ %name.sroa.0.0.lcssa, %lpad.i ], [ %name.sroa.0.092, %lpad.i36 ]
  %.pn83.ph = phi { ptr, i32 } [ %6, %lpad.i ], [ %13, %lpad.i36 ]
...
delete.notnull.i66:                               ; preds = %delete.notnull.i66.sink.split, %ehcleanup
  %name.sroa.0.090 = phi ptr [ %name.sroa.0.089, %ehcleanup ], [ %name.sroa.0.090.ph, %delete.notnull.i66.sink.split ]
  %.pn83 = phi { ptr, i32 } [ %.pn, %ehcleanup ], [ %.pn83.ph, %delete.notnull.i66.sink.split ]
  tail call void @_ZdaPv(ptr noundef nonnull %name.sroa.0.090) #18
  br label %_ZN11CStringBaseIwED2Ev.exit67

_ZN11CStringBaseIwED2Ev.exit67:                   ; preds = %ehcleanup, %delete.notnull.i66
  %.pn84 = phi { ptr, i32 } [ %.pn, %ehcleanup ], [ %.pn83, %delete.notnull.i66 ]
  resume { ptr, i32 } %.pn84
}
...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %cmp.i, label %for.end, label %for.cond
...
for.end.invoke.cont_crit_edge:                    ; preds = %for.end
  %.pre = load ptr, ptr %dirPrefix, align 8
...
if.end9.i.i:                                      ; preds = %delete.notnull.i.i, %call.i.i.noexc
  ...
  store ptr %call.i.i20, ptr %dirPrefix, align 8
...
_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i:            ; preds = %while.cond.i.i
  %16 = load i32, ptr %_length.i19, align 8
  store i32 %16, ptr %_length.i.i, align 8
  br label %invoke.cont
...
_ZN11CStringBaseIwED2Ev.exit:                     ; preds = %invoke.cont, %delete.notnull.i
  ...
  br i1 %cmp.i22, label %_ZN11CStringBaseIwED2Ev.exit.invoke.cont7_crit_edge, label %if.end.i23

_ZN11CStringBaseIwED2Ev.exit.invoke.cont7_crit_edge: ; preds = %_ZN11CStringBaseIwED2Ev.exit
  %.pre59 = load ptr, ptr %name, align 8
  br label %invoke.cont7

if.end.i23:                                       ; preds = %_ZN11CStringBaseIwED2Ev.exit
  %_length.i.i24 = getelementptr inbounds %class.CStringBase, ptr %name, i64 0, i32 1
  store i32 0, ptr %_length.i.i24, align 8
  %19 = load ptr, ptr %name, align 8
  store i32 0, ptr %19, align 4
  %_length.i25 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp4, i64 0, i32 1
  %20 = load i32, ptr %_length.i25, align 8
  %add.i.i26 = add nsw i32 %20, 1
  %_capacity.i.i27 = getelementptr inbounds %class.CStringBase, ptr %name, i64 0, i32 2
  %21 = load i32, ptr %_capacity.i.i27, align 4
  %cmp.i.i28 = icmp eq i32 %add.i.i26, %21
  br i1 %cmp.i.i28, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i35, label %if.end.i.i29

if.end.i.i29:                                     ; preds = %if.end.i23
  %conv.i.i30 = zext i32 %add.i.i26 to i64
  %22 = icmp slt i32 %20, -1
  %23 = shl nuw nsw i64 %conv.i.i30, 2
  %24 = select i1 %22, i64 -1, i64 %23
  %call.i.i46 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %24) #19
          to label %call.i.i.noexc45 unwind label %lpad6

call.i.i.noexc45:                                 ; preds = %if.end.i.i29
  %cmp3.i.i31 = icmp sgt i32 %21, 0
  br i1 %cmp3.i.i31, label %delete.notnull.i.i43, label %if.end9.i.i32

delete.notnull.i.i43:                             ; preds = %call.i.i.noexc45
  call void @_ZdaPv(ptr noundef nonnull %19) #18
  %.pre.i44 = load i32, ptr %_length.i.i24, align 8
  %25 = sext i32 %.pre.i44 to i64
  br label %if.end9.i.i32

if.end9.i.i32:                                    ; preds = %delete.notnull.i.i43, %call.i.i.noexc45
  %idxprom13.i.i33 = phi i64 [ %25, %delete.notnull.i.i43 ], [ 0, %call.i.i.noexc45 ]
  store ptr %call.i.i46, ptr %name, align 8
  %arrayidx14.i.i34 = getelementptr inbounds i32, ptr %call.i.i46, i64 %idxprom13.i.i33
  store i32 0, ptr %arrayidx14.i.i34, align 4
  store i32 %add.i.i26, ptr %_capacity.i.i27, align 4
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i35

_ZN11CStringBaseIwE11SetCapacityEi.exit.i35:      ; preds = %if.end9.i.i32, %if.end.i23
  %26 = phi ptr [ %19, %if.end.i23 ], [ %call.i.i46, %if.end9.i.i32 ]
  %27 = load ptr, ptr %ref.tmp4, align 8
  br label %while.cond.i.i36

while.cond.i.i36:                                 ; preds = %while.cond.i.i36, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i35
  %src.addr.0.i.i37 = phi ptr [ %27, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i35 ], [ %incdec.ptr.i.i39, %while.cond.i.i36 ]
  %dest.addr.0.i.i38 = phi ptr [ %26, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i35 ], [ %incdec.ptr1.i.i40, %while.cond.i.i36 ]
  %incdec.ptr.i.i39 = getelementptr inbounds i32, ptr %src.addr.0.i.i37, i64 1
  %28 = load i32, ptr %src.addr.0.i.i37, align 4
  %incdec.ptr1.i.i40 = getelementptr inbounds i32, ptr %dest.addr.0.i.i38, i64 1
  store i32 %28, ptr %dest.addr.0.i.i38, align 4
  %cmp.not.i.i41 = icmp eq i32 %28, 0
  br i1 %cmp.not.i.i41, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i42, label %while.cond.i.i36

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i42:          ; preds = %while.cond.i.i36
  %29 = load i32, ptr %_length.i25, align 8
  store i32 %29, ptr %_length.i.i24, align 8
  br label %invoke.cont7

invoke.cont7:                                     ; preds = %_ZN11CStringBaseIwED2Ev.exit.invoke.cont7_crit_edge, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i42
  %30 = phi ptr [ %.pre59, %_ZN11CStringBaseIwED2Ev.exit.invoke.cont7_crit_edge ], [ %27, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i42 ]
...
for.cond:                                         ; preds = %cleanup, %entry
  ...
  %0 = load i32, ptr %mask.addr.0, align 4
  %1 = load i32, ptr %name.addr.0, align 4
...
if.then16:                                        ; preds = %if.else14
  %2 = load i8, ptr @g_CaseSensitive, align 1
...
for.body.lr.ph.i:                                 ; preds = %entry
  %1 = load ptr, ptr %path, align 8
  %2 = load ptr, ptr @_ZL16kWildCardCharSet, align 8
...
if.end5.i.i.i:                                    ; preds = %if.end.i.i.i
  ...
  br i1 %cmp.i.i.i, label %_ZNK11CStringBaseIwE4FindEw.exit.loopexit.i, label %if.end.i.i.i
...
for.inc.i:                                        ; preds = %if.end.i.i.i, %_ZNK11CStringBaseIwE4FindEw.exit.i
  ...
  br i1 %exitcond.not.i, label %_ZNK11CStringBaseIwE9FindOneOfERKS0_.exit, label %for.body.i
...
if.end:                                           ; preds = %entry
  ...
  %2 = load i32, ptr %_size.i89, align 4
  %sub = sub nsw i32 %1, %2
...
if.end5.if.end28_crit_edge:                       ; preds = %if.end5
  ...
  %.pre = load i8, ptr %Recursive29.phi.trans.insert, align 8
  %ForFile34.phi.trans.insert = getelementptr inbounds %"struct.NWildcard::CItem", ptr %this, i64 0, i32 2
  %.pre111 = load i8, ptr %ForFile34.phi.trans.insert, align 1
  br label %if.end28
...
land.lhs.true10:                                  ; preds = %if.then7
  ...
  %3 = load i8, ptr %Recursive, align 8
...
if.end28:                                         ; preds = %if.end5.if.end28_crit_edge, %if.end20
  %6 = phi i8 [ %.pre111, %if.end5.if.end28_crit_edge ], [ %4, %if.end20 ]
...
for.cond:                                         ; preds = %for.end
  ...
  %exitcond110.not = icmp eq i32 %11, %lftr.wideiv
  br i1 %exitcond110.not, label %return.loopexit.split.loop.exit113, label %for.cond41.preheader

for.cond41.preheader:                             ; preds = %for.cond41.preheader.preheader, %for.cond
  %12 = phi i32 [ %2, %for.cond41.preheader.preheader ], [ %21, %for.cond ]
  %indvars.iv106 = phi i64 [ %9, %for.cond41.preheader.preheader ], [ %indvars.iv.next107, %for.cond ]
...
for.body45:                                       ; preds = %for.cond41.preheader, %for.inc
  ...
  %15 = add nuw nsw i64 %indvars.iv, %indvars.iv106
  %16 = load ptr, ptr %_items.i.i91, align 8
  %arrayidx.i.i93 = getelementptr inbounds ptr, ptr %16, i64 %15
  %17 = load ptr, ptr %arrayidx.i.i93, align 8
  %18 = load ptr, ptr %14, align 8
  %19 = load ptr, ptr %17, align 8
  %call2.i = tail call fastcc noundef zeroext i1 @_ZL16EnhancedMaskTestPKwS0_(ptr noundef %18, ptr noundef %19)
  %.pre112.pre = load i32, ptr %_size.i89, align 4
  br i1 %call2.i, label %for.inc, label %for.end.loopexit

for.inc:                                          ; preds = %for.body45
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %20 = sext i32 %.pre112.pre to i64
  %cmp44 = icmp slt i64 %indvars.iv.next, %20
  br i1 %cmp44, label %for.body45, label %for.end.loopexit

for.end.loopexit:                                 ; preds = %for.body45, %for.inc
  %i.0.lcssa.ph.in = phi i64 [ %indvars.iv.next, %for.inc ], [ %indvars.iv, %for.body45 ]
  %i.0.lcssa.ph = trunc i64 %i.0.lcssa.ph.in to i32
  br label %for.end

for.end:                                          ; preds = %for.end.loopexit, %for.cond41.preheader
  %21 = phi i32 [ %12, %for.cond41.preheader ], [ %.pre112.pre, %for.end.loopexit ]
  %i.0.lcssa = phi i32 [ 0, %for.cond41.preheader ], [ %i.0.lcssa.ph, %for.end.loopexit ]
  %cmp54.not = icmp eq i32 %i.0.lcssa, %21
  br i1 %cmp54.not, label %return, label %for.cond

return.loopexit.split.loop.exit113:               ; preds = %for.cond
  %cmp40.not.le = icmp slt i64 %indvars.iv106, %10
  br label %return

return:                                           ; preds = %for.end, %for.cond41.preheader.lr.ph.split.us, %return.loopexit.split.loop.exit113, %if.end28, %if.end, %if.end15, %land.lhs.true10, %entry
  %retval.5 = phi i1 [ false, %entry ], [ false, %if.end ], [ false, %land.lhs.true10 ], [ false, %if.end15 ], [ false, %if.end28 ], [ %cmp40.not.le, %return.loopexit.split.loop.exit113 ], [ %cmp54.not.us, %for.cond41.preheader.lr.ph.split.us ], [ true, %for.end ]
  ret i1 %retval.5
}
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %3 = load i8, ptr @g_CaseSensitive, align 1
...
entry:
  ...
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorI11CStringBaseIwEE, i64 0, inrange i32 0, i64 2), ptr %call.i, align 8
...
common.resume:                                    ; preds = %lpad.i.i.i7, %lpad.i.i.i
  %common.resume.op = phi { ptr, i32 } [ %0, %lpad.i.i.i ], [ %1, %lpad.i.i.i7 ]
...
if.else:                                          ; preds = %entry
  ...
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %call.i)
          to label %.noexc.i.i.i8 unwind label %lpad.i.i.i7

.noexc.i.i.i8:                                    ; preds = %if.else
  %call.i3.i.i.i9 = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZN13CObjectVectorI11CStringBaseIwEEpLERKS2_(ptr noundef nonnull align 8 dereferenceable(32) %call.i, ptr noundef nonnull align 8 dereferenceable(32) %item)
          to label %_ZN13CObjectVectorIN9NWildcard5CItemEE3AddERKS1_.exit17 unwind label %lpad.i.i.i7

lpad.i.i.i7:                                      ; preds = %.noexc.i.i.i8, %if.else
  %1 = landingpad { ptr, i32 }
          cleanup
  br label %common.resume
...
if.end:                                           ; preds = %_ZN13CObjectVectorIN9NWildcard5CItemEE3AddERKS1_.exit17, %_ZN13CObjectVectorIN9NWildcard5CItemEE3AddERKS1_.exit
  ...
  %2 = load i32, ptr %_size.i.i13.sink20, align 4
  %idxprom.i.i14 = sext i32 %2 to i64
  %arrayidx.i.i15 = getelementptr inbounds ptr, ptr %.sink18, i64 %idxprom.i.i14
  store ptr %call.i, ptr %arrayidx.i.i15, align 8
  %inc.i.i16 = add nsw i32 %2, 1
  store i32 %inc.i.i16, ptr %_size.i.i13.sink20, align 4
  ret void
}
...
for.body.lr.ph.i.i:                               ; preds = %if.end
  ...
  %5 = load ptr, ptr @_ZL16kWildCardCharSet, align 8
...
if.end5.i.i.i.i:                                  ; preds = %if.end.i.i.i.i
  ...
  br i1 %cmp.i.i.i.i, label %_ZNK11CStringBaseIwE4FindEw.exit.loopexit.i.i, label %if.end.i.i.i.i
...
for.inc.i.i:                                      ; preds = %if.end.i.i.i.i, %_ZNK11CStringBaseIwE4FindEw.exit.i.i
  ...
  br i1 %exitcond.not.i.i, label %if.end7, label %for.body.i.i
...
for.body.i:                                       ; preds = %for.inc.i, %for.body.lr.ph.i
  %indvars.iv.i = phi i64 [ 0, %for.body.lr.ph.i ], [ %indvars.iv.next.i, %for.inc.i ]
  %14 = load ptr, ptr %_items.i.i.i28, align 8
  ...
  %16 = load i8, ptr @g_CaseSensitive, align 1
...
for.inc.i:                                        ; preds = %_Z16CompareFileNamesRK11CStringBaseIwES2_.exit.i
  ...
  br i1 %cmp.not.i, label %for.body.i, label %if.then10
...
if.then10:                                        ; preds = %for.inc.i, %if.end7, %_ZNK9NWildcard11CCensorNode11FindSubNodeERK11CStringBaseIwE.exit
  ...
  %22 = load i32, ptr %_length.i.i, align 8
...
if.end9.i.i.i:                                    ; preds = %if.then10
  ...
  store ptr %call.i.i.i30, ptr %Name.i29, align 8
...
while.cond.i.i.i:                                 ; preds = %while.cond.i.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i
  ...
  %incdec.ptr.i.i.i = getelementptr inbounds i32, ptr %src.addr.0.i.i.i, i64 1
  %28 = load i32, ptr %src.addr.0.i.i.i, align 4
  %incdec.ptr1.i.i.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i, i64 1
  store i32 %28, ptr %dest.addr.0.i.i.i, align 4
  %cmp.not.i.i.i = icmp eq i32 %28, 0
  br i1 %cmp.not.i.i.i, label %_ZN9NWildcard11CCensorNodeC2ERK11CStringBaseIwEPS0_.exit, label %while.cond.i.i.i
...
_ZN9NWildcard11CCensorNodeC2ERK11CStringBaseIwEPS0_.exit: ; preds = %while.cond.i.i.i
  ...
  store i32 %22, ptr %_length.i.i31, align 8
  ...
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard11CCensorNodeEE, i64 0, inrange i32 0, i64 2), ptr %SubNodes.i, align 8
  ...
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard5CItemEE, i64 0, inrange i32 0, i64 2), ptr %IncludeItems.i, align 8
  ...
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard5CItemEE, i64 0, inrange i32 0, i64 2), ptr %ExcludeItems.i, align 8
...
for.body.i35:                                     ; preds = %if.end12
  %31 = load ptr, ptr %_items.i.i.i, align 8
...
_ZN13CObjectVectorI11CStringBaseIwEE6DeleteEii.exit: ; preds = %_ZN11CStringBaseIwED2Ev.exit.i, %for.body.i35, %if.end12
  ...
  %_items.i.i = getelementptr inbounds %"class.NWildcard::CCensorNode", ptr %this, i64 0, i32 2, i32 0, i32 0, i32 3
  %34 = load ptr, ptr %_items.i.i, align 8
...
call.i.i.noexc:                                   ; preds = %if.end9.i.i
  ...
  store ptr %call.i.i22, ptr %Name.i, align 8
...
while.cond.i.i:                                   ; preds = %while.cond.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i
  ...
  br i1 %cmp.not.i.i, label %.noexc, label %while.cond.i.i
...
.noexc.i18:                                       ; preds = %.noexc
  ...
  %9 = load i32, ptr %_size.i9.i, align 4
  ...
  invoke void @_ZN17CBaseRecordVector7ReserveEi(ptr noundef nonnull align 8 dereferenceable(32) %SubNodes.i, i32 noundef %add.i)
          to label %for.cond.i.preheader unwind label %lpad.i17.loopexit.split-lp
...
for.body.i:                                       ; preds = %for.body.i.lr.ph, %call4.i.noexc
  ...
  %call4.i25 = invoke noundef i32 @_ZN13CObjectVectorIN9NWildcard11CCensorNodeEE3AddERKS1_(ptr noundef nonnull align 8 dereferenceable(32) %SubNodes.i, ptr noundef nonnull align 8 dereferenceable(120) %11)
          to label %call4.i.noexc unwind label %lpad.i17.loopexit

call4.i.noexc:                                    ; preds = %for.body.i
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %invoke.cont.i, label %for.body.i

lpad.i17.loopexit:                                ; preds = %for.body.i
  %lpad.loopexit = landingpad { ptr, i32 }
          cleanup
  br label %lpad.i17

lpad.i17.loopexit.split-lp:                       ; preds = %.noexc, %.noexc.i18
  %lpad.loopexit.split-lp = landingpad { ptr, i32 }
          cleanup
  br label %lpad.i17

lpad.i17:                                         ; preds = %lpad.i17.loopexit.split-lp, %lpad.i17.loopexit
  %lpad.phi = phi { ptr, i32 } [ %lpad.loopexit, %lpad.i17.loopexit ], [ %lpad.loopexit.split-lp, %lpad.i17.loopexit.split-lp ]
...
invoke.cont.i:                                    ; preds = %call4.i.noexc, %for.cond.i.preheader
  ...
  store i64 8, ptr %_itemSize.i.i.i8, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard5CItemEE, i64 0, inrange i32 0, i64 2), ptr %IncludeItems.i, align 8
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %IncludeItems.i)
          to label %.noexc.i10 unwind label %lpad.i9

.noexc.i10:                                       ; preds = %invoke.cont.i
  %IncludeItems5.i = getelementptr inbounds %"class.NWildcard::CCensorNode", ptr %item, i64 0, i32 3
  %call.i3.i11 = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZN13CObjectVectorIN9NWildcard5CItemEEpLERKS2_(ptr noundef nonnull align 8 dereferenceable(32) %IncludeItems.i, ptr noundef nonnull align 8 dereferenceable(32) %IncludeItems5.i)
          to label %invoke.cont7.i unwind label %lpad.i9

lpad.i9:                                          ; preds = %.noexc.i10, %invoke.cont.i
...
invoke.cont7.i:                                   ; preds = %.noexc.i10
  ...
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %ExcludeItems.i)
          to label %.noexc.i unwind label %lpad.i4
...
lpad.i4:                                          ; preds = %.noexc.i, %invoke.cont7.i
  %13 = landingpad { ptr, i32 }
          cleanup
...
ehcleanup.i:                                      ; preds = %lpad.i9, %lpad.i4
  %.pn.i = phi { ptr, i32 } [ %13, %lpad.i4 ], [ %12, %lpad.i9 ]
...
ehcleanup11.i:                                    ; preds = %lpad.i17, %ehcleanup.i
  %.pn.pn.i = phi { ptr, i32 } [ %.pn.i, %ehcleanup.i ], [ %lpad.phi, %lpad.i17 ]
...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %_capacity.i.i.i.i, i8 0, i64 16, i1 false)
  store i64 8, ptr %_itemSize.i.i.i.i, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorI11CStringBaseIwEE, i64 0, inrange i32 0, i64 2), ptr %item, align 8
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %4 = load i8, ptr %Recursive18, align 8
...
for.cond:                                         ; preds = %lor.lhs.false
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %cleanup6, label %for.body
...
for.body:                                         ; preds = %for.cond
  ...
  %6 = load i8, ptr %Recursive, align 8
...
lor.lhs.false:                                    ; preds = %for.body.lr.ph, %for.body
  ...
  %8 = load i32, ptr %_size.i12, align 4
...
for.cond.preheader:                               ; preds = %entry
  ...
  %1 = load i32, ptr %_size.i11, align 4
...
for.cond:                                         ; preds = %for.body
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %return.loopexit.split.loop.exit, label %for.body

for.body:                                         ; preds = %for.body.lr.ph, %for.cond
  %indvars.iv = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next, %for.cond ]
  %arrayidx.i.i = getelementptr inbounds ptr, ptr %2, i64 %indvars.iv
  %4 = load ptr, ptr %arrayidx.i.i, align 8
  %call6 = tail call noundef zeroext i1 @_ZNK9NWildcard11CCensorNode20AreThereIncludeItemsEv(ptr noundef nonnull align 8 dereferenceable(120) %4)
...
return:                                           ; preds = %for.body, %return.loopexit.split.loop.exit, %for.cond.preheader, %entry
  %retval.1 = phi i1 [ true, %entry ], [ false, %for.cond.preheader ], [ %cmp3.not.le, %return.loopexit.split.loop.exit ], [ true, %for.body ]
  ret i1 %retval.1
}
...
for.cond:                                         ; preds = %for.body
  ...
  br i1 %cmp.not, label %for.body, label %cleanup6
...
for.body.lr.ph.i41:                               ; preds = %if.end
  %_items.i.i.i42 = getelementptr inbounds %"class.NWildcard::CCensorNode", ptr %this, i64 0, i32 3, i32 0, i32 0, i32 3
  br label %for.body.i43

for.cond.i47:                                     ; preds = %for.body.i43
  %indvars.iv.next.i48 = add nuw nsw i64 %indvars.iv.i44, 1
  %6 = load i32, ptr %_size.i.i38, align 4
  %7 = sext i32 %6 to i64
  %cmp.not.i49 = icmp slt i64 %indvars.iv.next.i48, %7
  br i1 %cmp.not.i49, label %for.body.i43, label %_ZNK9NWildcard11CCensorNode16CheckPathCurrentEbRK13CObjectVectorI11CStringBaseIwEEb.exit50

for.body.i43:                                     ; preds = %for.cond.i47, %for.body.lr.ph.i41
  %indvars.iv.i44 = phi i64 [ 0, %for.body.lr.ph.i41 ], [ %indvars.iv.next.i48, %for.cond.i47 ]
  %8 = load ptr, ptr %_items.i.i.i42, align 8
  %arrayidx.i.i.i45 = getelementptr inbounds ptr, ptr %8, i64 %indvars.iv.i44
  %9 = load ptr, ptr %arrayidx.i.i.i45, align 8
  %call5.i46 = tail call noundef zeroext i1 @_ZNK9NWildcard5CItem9CheckPathERK13CObjectVectorI11CStringBaseIwEEb(ptr noundef nonnull align 8 dereferenceable(35) %9, ptr noundef nonnull align 8 dereferenceable(32) %pathParts, i1 noundef zeroext %isFile)
  br i1 %call5.i46, label %_ZNK9NWildcard11CCensorNode16CheckPathCurrentEbRK13CObjectVectorI11CStringBaseIwEEb.exit50, label %for.cond.i47

_ZNK9NWildcard11CCensorNode16CheckPathCurrentEbRK13CObjectVectorI11CStringBaseIwEEb.exit50: ; preds = %for.cond.i47, %for.body.i43, %if.end
  %cmp.not.lcssa.i40 = phi i1 [ false, %if.end ], [ %call5.i46, %for.body.i43 ], [ %call5.i46, %for.cond.i47 ]
  %_size.i = getelementptr inbounds %class.CBaseRecordVector, ptr %pathParts, i64 0, i32 2
...
if.end8:                                          ; preds = %_ZNK9NWildcard11CCensorNode16CheckPathCurrentEbRK13CObjectVectorI11CStringBaseIwEEb.exit50
  ...
  %11 = load ptr, ptr %_items.i.i.i51, align 8
  %12 = load ptr, ptr %11, align 8
  %_size.i.i52 = getelementptr inbounds %"class.NWildcard::CCensorNode", ptr %this, i64 0, i32 2, i32 0, i32 0, i32 2
  %13 = load i32, ptr %_size.i.i52, align 4
  %cmp.not9.i = icmp sgt i32 %13, 0
  br i1 %cmp.not9.i, label %for.body.lr.ph.i53, label %if.end21

for.body.lr.ph.i53:                               ; preds = %if.end8
  %_items.i.i.i54 = getelementptr inbounds %"class.NWildcard::CCensorNode", ptr %this, i64 0, i32 2, i32 0, i32 0, i32 3
  br label %for.body.i55

for.body.i55:                                     ; preds = %for.inc.i, %for.body.lr.ph.i53
  %indvars.iv.i56 = phi i64 [ 0, %for.body.lr.ph.i53 ], [ %indvars.iv.next.i58, %for.inc.i ]
  %14 = load ptr, ptr %_items.i.i.i54, align 8
  %arrayidx.i.i.i57 = getelementptr inbounds ptr, ptr %14, i64 %indvars.iv.i56
  %15 = load ptr, ptr %arrayidx.i.i.i57, align 8
  %Name.i = getelementptr inbounds %"class.NWildcard::CCensorNode", ptr %15, i64 0, i32 1
  %16 = load i8, ptr @g_CaseSensitive, align 1
  %tobool.not.i.i = icmp eq i8 %16, 0
  %17 = load ptr, ptr %Name.i, align 8
...
if.then.i.i:                                      ; preds = %for.body.i55
  %call.i.i.i = tail call noundef i32 @_Z15MyStringComparePKwS0_(ptr noundef %17, ptr noundef %18)
  br label %_Z16CompareFileNamesRK11CStringBaseIwES2_.exit.i

if.end.i.i:                                       ; preds = %for.body.i55
  %call.i4.i.i = tail call noundef i32 @_Z21MyStringCompareNoCasePKwS0_(ptr noundef %17, ptr noundef %18)
  br label %_Z16CompareFileNamesRK11CStringBaseIwES2_.exit.i
...
for.inc.i:                                        ; preds = %_Z16CompareFileNamesRK11CStringBaseIwES2_.exit.i
  ...
  %19 = load i32, ptr %_size.i.i52, align 4
  %20 = sext i32 %19 to i64
  %cmp.not.i59 = icmp slt i64 %indvars.iv.next.i58, %20
  br i1 %cmp.not.i59, label %for.body.i55, label %if.end21

_ZNK9NWildcard11CCensorNode11FindSubNodeERK11CStringBaseIwE.exit: ; preds = %_Z16CompareFileNamesRK11CStringBaseIwES2_.exit.i
  %21 = and i64 %indvars.iv.i56, 2147483648
...
if.then12:                                        ; preds = %_ZNK9NWildcard11CCensorNode11FindSubNodeERK11CStringBaseIwE.exit
  ...
  store i64 8, ptr %_itemSize.i.i.i, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorI11CStringBaseIwEE, i64 0, inrange i32 0, i64 2), ptr %pathParts2, align 8
...
_ZN13CObjectVectorI11CStringBaseIwEEC2ERKS2_.exit: ; preds = %.noexc.i
  ...
  %23 = load i32, ptr %_size.i.i60, align 4
  %spec.select.i61 = call i32 @llvm.smin.i32(i32 %23, i32 1)
  %cmp8.i = icmp sgt i32 %23, 0
  br i1 %cmp8.i, label %for.body.i63, label %for.cond.cleanup.i

for.cond.cleanup.i:                               ; preds = %for.body.i63, %_ZN11CStringBaseIwED2Ev.exit.i, %_ZN13CObjectVectorI11CStringBaseIwEEC2ERKS2_.exit
...
for.body.i63:                                     ; preds = %_ZN13CObjectVectorI11CStringBaseIwEEC2ERKS2_.exit
...
delete.notnull.i:                                 ; preds = %for.body.i63
...
invoke.cont:                                      ; preds = %for.cond.cleanup.i
  %27 = load ptr, ptr %_items.i.i.i54, align 8
  %sext = shl i64 %indvars.iv.i56, 32
...
return:                                           ; preds = %_ZNK9NWildcard11CCensorNode16CheckPathCurrentEbRK13CObjectVectorI11CStringBaseIwEEb.exit50, %_ZN13CObjectVectorI11CStringBaseIwEED2Ev.exit, %if.end21, %if.then
  %retval.3 = phi i1 [ true, %if.then ], [ %cmp.not.lcssa.i40, %_ZNK9NWildcard11CCensorNode16CheckPathCurrentEbRK13CObjectVectorI11CStringBaseIwEEb.exit50 ], [ %cmp.not.lcssa.i40, %if.end21 ], [ true, %_ZN13CObjectVectorI11CStringBaseIwEED2Ev.exit ]
  ret i1 %retval.3
}
...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %_capacity.i.i.i.i, i8 0, i64 16, i1 false)
  store i64 8, ptr %_itemSize.i.i.i.i, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorI11CStringBaseIwEE, i64 0, inrange i32 0, i64 2), ptr %pathParts.i, align 8
...
if.end:                                           ; preds = %for.cond.i, %tailrecurse
  %5 = load ptr, ptr %this.tr, align 8
...
call.i.i.noexc.i:                                 ; preds = %if.end9.i.i.i
  ...
  store ptr %call.i.i3.i, ptr %call.i, align 8
...
while.cond.i.i.i:                                 ; preds = %while.cond.i.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i
  ...
  br i1 %cmp.not.i.i.i, label %_ZN13CObjectVectorI11CStringBaseIwEE6InsertEiRKS1_.exit, label %while.cond.i.i.i
...
_ZN13CObjectVectorI11CStringBaseIwEE6InsertEiRKS1_.exit: ; preds = %while.cond.i.i.i
  ...
  %15 = load ptr, ptr %this.tr, align 8
  br label %tailrecurse
...
if.end9.i.i:                                      ; preds = %if.end
  ...
  store ptr %call.i.i, ptr %path2, align 8
  store i32 0, ptr %call.i.i, align 4
  store i32 %add.i.i, ptr %_capacity.i, align 4
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i
...
_ZN11CStringBaseIwEC2ERKS0_.exit:                 ; preds = %while.cond.i.i
  ...
  store i32 %0, ptr %_length.i24, align 8
  %sub = add nsw i32 %0, -1
...
_ZN11CStringBaseIwE6DeleteEii.exit:               ; preds = %_ZN11CStringBaseIwEC2ERKS0_.exit
  ...
  store i32 %sub, ptr %_length.i24, align 8
  br label %if.end14
...
if.end14:                                         ; preds = %_ZN11CStringBaseIwE6DeleteEii.exit, %_ZN11CStringBaseIwEC2ERKS0_.exit
  ...
  store i64 8, ptr %_itemSize.i.i.i.i.i, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorI11CStringBaseIwEE, i64 0, inrange i32 0, i64 2), ptr %item.i, align 8
...
for.body.i:                                       ; preds = %for.body, %for.inc.i
  ...
  %6 = load i8, ptr @g_CaseSensitive, align 1
...
if.then:                                          ; preds = %for.inc.i, %for.body, %_ZNK9NWildcard11CCensorNode11FindSubNodeERK11CStringBaseIwE.exit
  ...
  %12 = load i32, ptr %_length2.i.i, align 8
...
if.end9.i.i.i:                                    ; preds = %if.then
  ...
  store ptr %call.i.i.i22, ptr %Name.i21, align 8
  store i32 0, ptr %call.i.i.i22, align 4
  store i32 %add.i.i.i, ptr %_capacity.i.i, align 4
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i
...
if.end:                                           ; preds = %invoke.cont, %_ZNK9NWildcard11CCensorNode11FindSubNodeERK11CStringBaseIwE.exit
  ...
  %20 = load ptr, ptr %_items.i.i.i, align 8
...
_ZN13CObjectVectorIN9NWildcard5CItemEE3AddERKS1_.exit: ; preds = %.noexc.i.i.i
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(3) %Recursive.i.i, ptr noundef nonnull align 8 dereferenceable(3) %Recursive3.i.i, i64 3, i1 false)
  tail call void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %this)
  %5 = load ptr, ptr %_items.i.i10, align 8
  %6 = load i32, ptr %_size.i9, align 4
...
invoke.cont5:                                     ; preds = %if.end
  ...
  %5 = load i32, ptr %_length.i144, align 8
...
if.then9.invoke.cont13_crit_edge:                 ; preds = %if.then9
  %.pre = load ptr, ptr %_items.i.i.i, align 8
...
invoke.cont13:                                    ; preds = %if.then9.invoke.cont13_crit_edge, %invoke.cont5
  ...
  %9 = load i32, ptr %_length.i147, align 8
...
if.else25:                                        ; preds = %invoke.cont13, %land.lhs.true
  ...
  %cmp29273 = icmp sgt i32 %12, 0
  br i1 %cmp29273, label %for.body, label %if.end52
...
for.cond:                                         ; preds = %cleanup
  ...
  br i1 %cmp29, label %for.body, label %if.end41
...
if.then42:                                        ; preds = %cleanup, %invoke.cont33, %invoke.cont13, %land.lhs.true, %if.end41
  ...
  %spec.select267 = select i1 %cmp46, i32 %sub, i32 1
  br label %if.end52

if.end52:                                         ; preds = %if.else25, %if.then42, %if.end41
  %numAbsParts.0 = phi i32 [ 0, %if.end41 ], [ %spec.select267, %if.then42 ], [ 0, %if.else25 ]
...
_ZN11CStringBaseIwEC2Ev.exit:                     ; preds = %if.end52
  ...
  %cmp57277 = icmp sgt i32 %numAbsParts.0, 0
  br i1 %cmp57277, label %invoke.cont62, label %cleanup79
...
invoke.cont62:                                    ; preds = %_ZN11CStringBaseIwEC2Ev.exit, %for.inc77
  %i55.0281 = phi i32 [ %inc78, %for.inc77 ], [ 0, %_ZN11CStringBaseIwEC2Ev.exit ]
  %prefix.sroa.22.0280 = phi i32 [ %prefix.sroa.22.2, %for.inc77 ], [ 4, %_ZN11CStringBaseIwEC2Ev.exit ]
  %prefix.sroa.15.0279 = phi i32 [ %inc.i, %for.inc77 ], [ 0, %_ZN11CStringBaseIwEC2Ev.exit ]
  %prefix.sroa.0.0278 = phi ptr [ %prefix.sroa.0.3, %for.inc77 ], [ %call.i.i158, %_ZN11CStringBaseIwEC2Ev.exit ]
  %prefix.sroa.0.0278303 = ptrtoint ptr %prefix.sroa.0.0278 to i64
  %22 = load ptr, ptr %_items.i.i.i, align 8
  %23 = load ptr, ptr %22, align 8
  %_length.i.i = getelementptr inbounds %class.CStringBase, ptr %23, i64 0, i32 1
  %24 = load i32, ptr %_length.i.i, align 8
...
for.body.lr.ph.i.i:                               ; preds = %invoke.cont62
  ...
  %26 = load ptr, ptr @_ZL16kWildCardCharSet, align 8
...
for.body.i.i:                                     ; preds = %for.inc.i.i, %for.body.lr.ph.i.i
  ...
  %28 = load i32, ptr %arrayidx.i.i160, align 4
...
if.end5.i.i.i.i:                                  ; preds = %if.end.i.i.i.i
  %add.ptr.i.i.i.i.i.i = getelementptr inbounds i32, ptr %p.011.i.i.i.i, i64 1
  %30 = load i32, ptr %add.ptr.i.i.i.i.i.i, align 4
...
for.inc.i.i:                                      ; preds = %if.end.i.i.i.i, %_ZNK11CStringBaseIwE4FindEw.exit.i.i
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1
  %exitcond.not.i.i = icmp eq i64 %indvars.iv.next.i.i, %wide.trip.count.i.i
  br i1 %exitcond.not.i.i, label %if.end67, label %for.body.i.i
...
lpad61:                                           ; preds = %for.cond.cleanup.i, %if.end.i.i.i184, %if.end.i.i.i
  %prefix.sroa.0.1 = phi ptr [ %prefix.sroa.0.3, %for.cond.cleanup.i ], [ %prefix.sroa.0.2, %if.end.i.i.i184 ], [ %prefix.sroa.0.0278, %if.end.i.i.i ]
  %34 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup112

if.end67:                                         ; preds = %for.inc.i.i, %invoke.cont62, %invoke.cont64
  %35 = xor i32 %prefix.sroa.15.0279, -1
  %sub2.i.i = add i32 %prefix.sroa.22.0280, %35
  %cmp.not.i.i = icmp slt i32 %sub2.i.i, %24
  br i1 %cmp.not.i.i, label %if.end.i.i, label %_ZN11CStringBaseIwE10GrowLengthEi.exit.i

if.end.i.i:                                       ; preds = %if.end67
  %cmp4.i.i = icmp sgt i32 %prefix.sroa.22.0280, 64
  %div24.i.i = lshr i32 %prefix.sroa.22.0280, 1
  %cmp8.i.i = icmp sgt i32 %prefix.sroa.22.0280, 8
  %..i.i = select i1 %cmp8.i.i, i32 16, i32 4
  %delta.0.i.i = select i1 %cmp4.i.i, i32 %div24.i.i, i32 %..i.i
  %add.i.i = add nsw i32 %delta.0.i.i, %sub2.i.i
  ...
  %delta.1.i.i = select i1 %cmp13.i.i, i32 %sub15.i.i, i32 %delta.0.i.i
  %add18.i.i = add nsw i32 %delta.1.i.i, %prefix.sroa.22.0280
  %add.i.i.i = add nsw i32 %add18.i.i, 1
  %cmp.i.i.i = icmp eq i32 %add.i.i.i, %prefix.sroa.22.0280
...
call.i.i.i.noexc:                                 ; preds = %if.end.i.i.i
  %call.i.i.i165302 = ptrtoint ptr %call.i.i.i165 to i64
  %cmp3.i.i.i = icmp sgt i32 %prefix.sroa.22.0280, 0
  br i1 %cmp3.i.i.i, label %for.cond.preheader.i.i.i, label %if.end9.i.i.i

for.cond.preheader.i.i.i:                         ; preds = %call.i.i.i.noexc
  %cmp522.i.i.i = icmp sgt i32 %prefix.sroa.15.0279, 0
  br i1 %cmp522.i.i.i, label %for.body.lr.ph.i.i.i, label %for.cond.cleanup.i.i.i

for.body.lr.ph.i.i.i:                             ; preds = %for.cond.preheader.i.i.i
  %wide.trip.count.i.i.i = zext i32 %prefix.sroa.15.0279 to i64
  %min.iters.check307 = icmp ult i32 %prefix.sroa.15.0279, 8
  %39 = sub i64 %call.i.i.i165302, %prefix.sroa.0.0278303
  %diff.check304 = icmp ult i64 %39, 32
  %or.cond = or i1 %min.iters.check307, %diff.check304
  br i1 %or.cond, label %for.body.i.i.i.preheader, label %vector.ph308

vector.ph308:                                     ; preds = %for.body.lr.ph.i.i.i
  %n.vec310 = and i64 %wide.trip.count.i.i.i, 4294967288
  br label %vector.body313

vector.body313:                                   ; preds = %vector.body313, %vector.ph308
  %index314 = phi i64 [ 0, %vector.ph308 ], [ %index.next317, %vector.body313 ]
  %40 = getelementptr inbounds i32, ptr %prefix.sroa.0.0278, i64 %index314
  %wide.load315 = load <4 x i32>, ptr %40, align 4
  %41 = getelementptr inbounds i32, ptr %40, i64 4
  %wide.load316 = load <4 x i32>, ptr %41, align 4
  %42 = getelementptr inbounds i32, ptr %call.i.i.i165, i64 %index314
  store <4 x i32> %wide.load315, ptr %42, align 4
  %43 = getelementptr inbounds i32, ptr %42, i64 4
  store <4 x i32> %wide.load316, ptr %43, align 4
  %index.next317 = add nuw i64 %index314, 8
  %44 = icmp eq i64 %index.next317, %n.vec310
  br i1 %44, label %middle.block305, label %vector.body313

middle.block305:                                  ; preds = %vector.body313
  %cmp.n312 = icmp eq i64 %n.vec310, %wide.trip.count.i.i.i
  br i1 %cmp.n312, label %delete.notnull.i.i.i, label %for.body.i.i.i.preheader

for.body.i.i.i.preheader:                         ; preds = %for.body.lr.ph.i.i.i, %middle.block305
  %indvars.iv.i.i.i.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i ], [ %n.vec310, %middle.block305 ]
...
for.body.i.i.i.prol:                              ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i.prol
  %indvars.iv.i.i.i.prol = phi i64 [ %indvars.iv.next.i.i.i.prol, %for.body.i.i.i.prol ], [ %indvars.iv.i.i.i.ph, %for.body.i.i.i.preheader ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body.i.i.i.prol ], [ 0, %for.body.i.i.i.preheader ]
  %arrayidx.i.i.i164.prol = getelementptr inbounds i32, ptr %prefix.sroa.0.0278, i64 %indvars.iv.i.i.i.prol
  %47 = load i32, ptr %arrayidx.i.i.i164.prol, align 4
  %arrayidx7.i.i.i.prol = getelementptr inbounds i32, ptr %call.i.i.i165, i64 %indvars.iv.i.i.i.prol
  store i32 %47, ptr %arrayidx7.i.i.i.prol, align 4
  %indvars.iv.next.i.i.i.prol = add nuw nsw i64 %indvars.iv.i.i.i.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body.i.i.i.prol.loopexit, label %for.body.i.i.i.prol
...
for.cond.cleanup.i.i.i:                           ; preds = %for.cond.preheader.i.i.i
  %isnull.i.i.i = icmp eq ptr %prefix.sroa.0.0278, null
  br i1 %isnull.i.i.i, label %if.end9.i.i.i, label %delete.notnull.i.i.i

for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  %indvars.iv.i.i.i = phi i64 [ %indvars.iv.next.i.i.i.3, %for.body.i.i.i ], [ %indvars.iv.i.i.i.unr, %for.body.i.i.i.prol.loopexit ]
  %arrayidx.i.i.i164 = getelementptr inbounds i32, ptr %prefix.sroa.0.0278, i64 %indvars.iv.i.i.i
  %49 = load i32, ptr %arrayidx.i.i.i164, align 4
  %arrayidx7.i.i.i = getelementptr inbounds i32, ptr %call.i.i.i165, i64 %indvars.iv.i.i.i
  store i32 %49, ptr %arrayidx7.i.i.i, align 4
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1
  %arrayidx.i.i.i164.1 = getelementptr inbounds i32, ptr %prefix.sroa.0.0278, i64 %indvars.iv.next.i.i.i
  %50 = load i32, ptr %arrayidx.i.i.i164.1, align 4
  %arrayidx7.i.i.i.1 = getelementptr inbounds i32, ptr %call.i.i.i165, i64 %indvars.iv.next.i.i.i
  store i32 %50, ptr %arrayidx7.i.i.i.1, align 4
  %indvars.iv.next.i.i.i.1 = add nuw nsw i64 %indvars.iv.i.i.i, 2
  %arrayidx.i.i.i164.2 = getelementptr inbounds i32, ptr %prefix.sroa.0.0278, i64 %indvars.iv.next.i.i.i.1
  %51 = load i32, ptr %arrayidx.i.i.i164.2, align 4
  %arrayidx7.i.i.i.2 = getelementptr inbounds i32, ptr %call.i.i.i165, i64 %indvars.iv.next.i.i.i.1
  store i32 %51, ptr %arrayidx7.i.i.i.2, align 4
  %indvars.iv.next.i.i.i.2 = add nuw nsw i64 %indvars.iv.i.i.i, 3
  %arrayidx.i.i.i164.3 = getelementptr inbounds i32, ptr %prefix.sroa.0.0278, i64 %indvars.iv.next.i.i.i.2
  %52 = load i32, ptr %arrayidx.i.i.i164.3, align 4
  %arrayidx7.i.i.i.3 = getelementptr inbounds i32, ptr %call.i.i.i165, i64 %indvars.iv.next.i.i.i.2
  store i32 %52, ptr %arrayidx7.i.i.i.3, align 4
  %indvars.iv.next.i.i.i.3 = add nuw nsw i64 %indvars.iv.i.i.i, 4
  %exitcond.not.i.i.i.3 = icmp eq i64 %indvars.iv.next.i.i.i.3, %wide.trip.count.i.i.i
  br i1 %exitcond.not.i.i.i.3, label %delete.notnull.i.i.i, label %for.body.i.i.i

delete.notnull.i.i.i:                             ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i, %middle.block305, %for.cond.cleanup.i.i.i
  call void @_ZdaPv(ptr noundef nonnull %prefix.sroa.0.0278) #18
  br label %if.end9.i.i.i

if.end9.i.i.i:                                    ; preds = %delete.notnull.i.i.i, %for.cond.cleanup.i.i.i, %call.i.i.i.noexc
  %idxprom13.i.i.i = sext i32 %prefix.sroa.15.0279 to i64
...
_ZN11CStringBaseIwE10GrowLengthEi.exit.i:         ; preds = %if.end9.i.i.i, %if.end.i.i, %if.end67
  %prefix.sroa.0.2 = phi ptr [ %prefix.sroa.0.0278, %if.end.i.i ], [ %call.i.i.i165, %if.end9.i.i.i ], [ %prefix.sroa.0.0278, %if.end67 ]
  %prefix.sroa.22.1 = phi i32 [ %prefix.sroa.22.0280, %if.end.i.i ], [ %add.i.i.i, %if.end9.i.i.i ], [ %prefix.sroa.22.0280, %if.end67 ]
  %prefix.sroa.0.2299 = ptrtoint ptr %prefix.sroa.0.2 to i64
  %idx.ext.i = sext i32 %prefix.sroa.15.0279 to i64
...
while.cond.i.i:                                   ; preds = %while.cond.i.i, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i
  ...
  %incdec.ptr.i.i = getelementptr inbounds i32, ptr %src.addr.0.i.i, i64 1
  %54 = load i32, ptr %src.addr.0.i.i, align 4
  %incdec.ptr1.i.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i, i64 1
  store i32 %54, ptr %dest.addr.0.i.i, align 4
  %cmp.not.i8.i = icmp eq i32 %54, 0
  br i1 %cmp.not.i8.i, label %invoke.cont68, label %while.cond.i.i

invoke.cont68:                                    ; preds = %while.cond.i.i
  %55 = load i32, ptr %_length.i.i, align 8
  %add.i = add nsw i32 %55, %prefix.sroa.15.0279
  %56 = xor i32 %add.i, -1
  %sub2.i.i168 = add i32 %prefix.sroa.22.1, %56
  %cmp.not.i.i169 = icmp slt i32 %sub2.i.i168, 1
  br i1 %cmp.not.i.i169, label %if.end.i.i171, label %invoke.cont70

if.end.i.i171:                                    ; preds = %invoke.cont68
  %cmp4.i.i172 = icmp sgt i32 %prefix.sroa.22.1, 64
  %div24.i.i173 = lshr i32 %prefix.sroa.22.1, 1
  %cmp8.i.i174 = icmp sgt i32 %prefix.sroa.22.1, 8
  %..i.i175 = select i1 %cmp8.i.i174, i32 16, i32 4
  %delta.0.i.i176 = select i1 %cmp4.i.i172, i32 %div24.i.i173, i32 %..i.i175
  %add.i.i177 = add nsw i32 %sub2.i.i168, %delta.0.i.i176
  %cmp13.i.i178 = icmp slt i32 %add.i.i177, 1
  %sub15.i.i179 = sub nsw i32 1, %sub2.i.i168
  %delta.1.i.i180 = select i1 %cmp13.i.i178, i32 %sub15.i.i179, i32 %delta.0.i.i176
  %add18.i.i181 = add nsw i32 %delta.1.i.i180, %prefix.sroa.22.1
  %add.i.i.i182 = add nsw i32 %add18.i.i181, 1
  %cmp.i.i.i183 = icmp eq i32 %add.i.i.i182, %prefix.sroa.22.1
  br i1 %cmp.i.i.i183, label %invoke.cont70, label %if.end.i.i.i184

if.end.i.i.i184:                                  ; preds = %if.end.i.i171
  %conv.i.i.i185 = zext i32 %add.i.i.i182 to i64
  %57 = icmp slt i32 %add18.i.i181, -1
  %58 = shl nuw nsw i64 %conv.i.i.i185, 2
  %59 = select i1 %57, i64 -1, i64 %58
  %call.i.i.i206 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %59) #19
          to label %call.i.i.i.noexc205 unwind label %lpad61

call.i.i.i.noexc205:                              ; preds = %if.end.i.i.i184
  %call.i.i.i206298 = ptrtoint ptr %call.i.i.i206 to i64
  %cmp3.i.i.i186 = icmp sgt i32 %prefix.sroa.22.1, 0
  br i1 %cmp3.i.i.i186, label %for.cond.preheader.i.i.i190, label %if.end9.i.i.i187

for.cond.preheader.i.i.i190:                      ; preds = %call.i.i.i.noexc205
  %cmp522.i.i.i191 = icmp sgt i32 %add.i, 0
  br i1 %cmp522.i.i.i191, label %for.body.lr.ph.i.i.i197, label %for.cond.cleanup.i.i.i193

for.body.lr.ph.i.i.i197:                          ; preds = %for.cond.preheader.i.i.i190
  %wide.trip.count.i.i.i198 = zext i32 %add.i to i64
  %min.iters.check = icmp ult i32 %add.i, 8
  %60 = sub i64 %call.i.i.i206298, %prefix.sroa.0.2299
  %diff.check = icmp ult i64 %60, 32
  %or.cond318 = or i1 %min.iters.check, %diff.check
  br i1 %or.cond318, label %for.body.i.i.i199.preheader, label %vector.ph

vector.ph:                                        ; preds = %for.body.lr.ph.i.i.i197
  %n.vec = and i64 %wide.trip.count.i.i.i198, 4294967288
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %61 = getelementptr inbounds i32, ptr %prefix.sroa.0.2, i64 %index
  %wide.load = load <4 x i32>, ptr %61, align 4
  %62 = getelementptr inbounds i32, ptr %61, i64 4
  %wide.load300 = load <4 x i32>, ptr %62, align 4
  %63 = getelementptr inbounds i32, ptr %call.i.i.i206, i64 %index
  store <4 x i32> %wide.load, ptr %63, align 4
  %64 = getelementptr inbounds i32, ptr %63, i64 4
  store <4 x i32> %wide.load300, ptr %64, align 4
  %index.next = add nuw i64 %index, 8
  %65 = icmp eq i64 %index.next, %n.vec
  br i1 %65, label %middle.block, label %vector.body

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.vec, %wide.trip.count.i.i.i198
  br i1 %cmp.n, label %delete.notnull.i.i.i195, label %for.body.i.i.i199.preheader

for.body.i.i.i199.preheader:                      ; preds = %for.body.lr.ph.i.i.i197, %middle.block
  %indvars.iv.i.i.i200.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i197 ], [ %n.vec, %middle.block ]
  %66 = xor i64 %indvars.iv.i.i.i200.ph, -1
  %67 = add nsw i64 %66, %wide.trip.count.i.i.i198
  %xtraiter322 = and i64 %wide.trip.count.i.i.i198, 3
  %lcmp.mod323.not = icmp eq i64 %xtraiter322, 0
  br i1 %lcmp.mod323.not, label %for.body.i.i.i199.prol.loopexit, label %for.body.i.i.i199.prol

for.body.i.i.i199.prol:                           ; preds = %for.body.i.i.i199.preheader, %for.body.i.i.i199.prol
  %indvars.iv.i.i.i200.prol = phi i64 [ %indvars.iv.next.i.i.i203.prol, %for.body.i.i.i199.prol ], [ %indvars.iv.i.i.i200.ph, %for.body.i.i.i199.preheader ]
  %prol.iter324 = phi i64 [ %prol.iter324.next, %for.body.i.i.i199.prol ], [ 0, %for.body.i.i.i199.preheader ]
  %arrayidx.i.i.i201.prol = getelementptr inbounds i32, ptr %prefix.sroa.0.2, i64 %indvars.iv.i.i.i200.prol
  %68 = load i32, ptr %arrayidx.i.i.i201.prol, align 4
  %arrayidx7.i.i.i202.prol = getelementptr inbounds i32, ptr %call.i.i.i206, i64 %indvars.iv.i.i.i200.prol
  store i32 %68, ptr %arrayidx7.i.i.i202.prol, align 4
  ...
  br i1 %prol.iter324.cmp.not, label %for.body.i.i.i199.prol.loopexit, label %for.body.i.i.i199.prol

for.body.i.i.i199.prol.loopexit:                  ; preds = %for.body.i.i.i199.prol, %for.body.i.i.i199.preheader
  %indvars.iv.i.i.i200.unr = phi i64 [ %indvars.iv.i.i.i200.ph, %for.body.i.i.i199.preheader ], [ %indvars.iv.next.i.i.i203.prol, %for.body.i.i.i199.prol ]
  %69 = icmp ult i64 %67, 3
  br i1 %69, label %delete.notnull.i.i.i195, label %for.body.i.i.i199

for.cond.cleanup.i.i.i193:                        ; preds = %for.cond.preheader.i.i.i190
  %isnull.i.i.i194 = icmp eq ptr %prefix.sroa.0.2, null
  br i1 %isnull.i.i.i194, label %if.end9.i.i.i187, label %delete.notnull.i.i.i195

for.body.i.i.i199:                                ; preds = %for.body.i.i.i199.prol.loopexit, %for.body.i.i.i199
  %indvars.iv.i.i.i200 = phi i64 [ %indvars.iv.next.i.i.i203.3, %for.body.i.i.i199 ], [ %indvars.iv.i.i.i200.unr, %for.body.i.i.i199.prol.loopexit ]
  %arrayidx.i.i.i201 = getelementptr inbounds i32, ptr %prefix.sroa.0.2, i64 %indvars.iv.i.i.i200
  %70 = load i32, ptr %arrayidx.i.i.i201, align 4
  %arrayidx7.i.i.i202 = getelementptr inbounds i32, ptr %call.i.i.i206, i64 %indvars.iv.i.i.i200
  store i32 %70, ptr %arrayidx7.i.i.i202, align 4
  %indvars.iv.next.i.i.i203 = add nuw nsw i64 %indvars.iv.i.i.i200, 1
  %arrayidx.i.i.i201.1 = getelementptr inbounds i32, ptr %prefix.sroa.0.2, i64 %indvars.iv.next.i.i.i203
  %71 = load i32, ptr %arrayidx.i.i.i201.1, align 4
  %arrayidx7.i.i.i202.1 = getelementptr inbounds i32, ptr %call.i.i.i206, i64 %indvars.iv.next.i.i.i203
  store i32 %71, ptr %arrayidx7.i.i.i202.1, align 4
  %indvars.iv.next.i.i.i203.1 = add nuw nsw i64 %indvars.iv.i.i.i200, 2
  %arrayidx.i.i.i201.2 = getelementptr inbounds i32, ptr %prefix.sroa.0.2, i64 %indvars.iv.next.i.i.i203.1
  %72 = load i32, ptr %arrayidx.i.i.i201.2, align 4
  %arrayidx7.i.i.i202.2 = getelementptr inbounds i32, ptr %call.i.i.i206, i64 %indvars.iv.next.i.i.i203.1
  store i32 %72, ptr %arrayidx7.i.i.i202.2, align 4
  %indvars.iv.next.i.i.i203.2 = add nuw nsw i64 %indvars.iv.i.i.i200, 3
  %arrayidx.i.i.i201.3 = getelementptr inbounds i32, ptr %prefix.sroa.0.2, i64 %indvars.iv.next.i.i.i203.2
  %73 = load i32, ptr %arrayidx.i.i.i201.3, align 4
  %arrayidx7.i.i.i202.3 = getelementptr inbounds i32, ptr %call.i.i.i206, i64 %indvars.iv.next.i.i.i203.2
  store i32 %73, ptr %arrayidx7.i.i.i202.3, align 4
  %indvars.iv.next.i.i.i203.3 = add nuw nsw i64 %indvars.iv.i.i.i200, 4
  %exitcond.not.i.i.i204.3 = icmp eq i64 %indvars.iv.next.i.i.i203.3, %wide.trip.count.i.i.i198
  br i1 %exitcond.not.i.i.i204.3, label %delete.notnull.i.i.i195, label %for.body.i.i.i199

delete.notnull.i.i.i195:                          ; preds = %for.body.i.i.i199.prol.loopexit, %for.body.i.i.i199, %middle.block, %for.cond.cleanup.i.i.i193
  call void @_ZdaPv(ptr noundef nonnull %prefix.sroa.0.2) #18
  br label %if.end9.i.i.i187

if.end9.i.i.i187:                                 ; preds = %delete.notnull.i.i.i195, %for.cond.cleanup.i.i.i193, %call.i.i.i.noexc205
  %idxprom13.i.i.i188 = sext i32 %add.i to i64
  %arrayidx14.i.i.i189 = getelementptr inbounds i32, ptr %call.i.i.i206, i64 %idxprom13.i.i.i188
  store i32 0, ptr %arrayidx14.i.i.i189, align 4
  br label %invoke.cont70

invoke.cont70:                                    ; preds = %if.end9.i.i.i187, %if.end.i.i171, %invoke.cont68
  %prefix.sroa.0.3 = phi ptr [ %prefix.sroa.0.2, %if.end.i.i171 ], [ %call.i.i.i206, %if.end9.i.i.i187 ], [ %prefix.sroa.0.2, %invoke.cont68 ]
  %prefix.sroa.22.2 = phi i32 [ %prefix.sroa.22.1, %if.end.i.i171 ], [ %add.i.i.i182, %if.end9.i.i.i187 ], [ %prefix.sroa.22.1, %invoke.cont68 ]
  ...
  %74 = load i32, ptr %_size.i, align 4
...
for.body.i:                                       ; preds = %invoke.cont70
  %75 = load ptr, ptr %_items.i.i.i, align 8
...
for.inc77:                                        ; preds = %for.cond.cleanup.i
  %inc78 = add nuw nsw i32 %i55.0281, 1
  %exitcond289.not = icmp eq i32 %inc78, %numAbsParts.0
  br i1 %exitcond289.not, label %cleanup79, label %invoke.cont62

cleanup79:                                        ; preds = %for.inc77, %invoke.cont64, %_ZN11CStringBaseIwEC2Ev.exit
  %prefix.sroa.0.0.lcssa = phi ptr [ %call.i.i158, %_ZN11CStringBaseIwEC2Ev.exit ], [ %prefix.sroa.0.0278, %invoke.cont64 ], [ %prefix.sroa.0.3, %for.inc77 ]
  %prefix.sroa.15.0.lcssa = phi i32 [ 0, %_ZN11CStringBaseIwEC2Ev.exit ], [ %prefix.sroa.15.0279, %invoke.cont64 ], [ %inc.i, %for.inc77 ]
  %_size.i.i209 = getelementptr inbounds %class.CBaseRecordVector, ptr %this, i64 0, i32 2
  %78 = load i32, ptr %_size.i.i209, align 4
  %cmp.not9.i = icmp sgt i32 %78, 0
  br i1 %cmp.not9.i, label %for.body.lr.ph.i211, label %if.then86

for.body.lr.ph.i211:                              ; preds = %cleanup79
  %_items.i.i.i212 = getelementptr inbounds %class.CBaseRecordVector, ptr %this, i64 0, i32 3
  br label %for.body.i213

for.body.i213:                                    ; preds = %for.inc.i216, %for.body.lr.ph.i211
  %indvars.iv.i214 = phi i64 [ 0, %for.body.lr.ph.i211 ], [ %indvars.iv.next.i217, %for.inc.i216 ]
  %79 = load ptr, ptr %_items.i.i.i212, align 8
  %arrayidx.i.i.i215 = getelementptr inbounds ptr, ptr %79, i64 %indvars.iv.i214
  %80 = load ptr, ptr %arrayidx.i.i.i215, align 8
  %81 = load i8, ptr @g_CaseSensitive, align 1
  %tobool.not.i.i = icmp eq i8 %81, 0
  %82 = load ptr, ptr %80, align 8
  br i1 %tobool.not.i.i, label %if.end.i.i218, label %if.then.i.i

if.then.i.i:                                      ; preds = %for.body.i213
  %call.i.i.i220 = invoke noundef i32 @_Z15MyStringComparePKwS0_(ptr noundef %82, ptr noundef %prefix.sroa.0.0.lcssa)
          to label %_Z16CompareFileNamesRK11CStringBaseIwES2_.exit.i unwind label %lpad82

if.end.i.i218:                                    ; preds = %for.body.i213
  %call.i4.i.i221 = invoke noundef i32 @_Z21MyStringCompareNoCasePKwS0_(ptr noundef %82, ptr noundef %prefix.sroa.0.0.lcssa)
          to label %_Z16CompareFileNamesRK11CStringBaseIwES2_.exit.i unwind label %lpad82

_Z16CompareFileNamesRK11CStringBaseIwES2_.exit.i: ; preds = %if.end.i.i218, %if.then.i.i
  %retval.0.i.i = phi i32 [ %call.i.i.i220, %if.then.i.i ], [ %call.i4.i.i221, %if.end.i.i218 ]
  %cmp5.i = icmp eq i32 %retval.0.i.i, 0
...
for.inc.i216:                                     ; preds = %_Z16CompareFileNamesRK11CStringBaseIwES2_.exit.i
  ...
  %83 = load i32, ptr %_size.i.i209, align 4
  %84 = sext i32 %83 to i64
  %cmp.not.i = icmp slt i64 %indvars.iv.next.i217, %84
  br i1 %cmp.not.i, label %for.body.i213, label %if.then86

invoke.cont83:                                    ; preds = %_Z16CompareFileNamesRK11CStringBaseIwES2_.exit.i
  %85 = trunc i64 %indvars.iv.i214 to i32
...
if.then86:                                        ; preds = %for.inc.i216, %cleanup79, %invoke.cont83
  ...
  %add.i.i.i222 = add nsw i32 %prefix.sroa.15.0.lcssa, 1
  %cmp.i.i.i223 = icmp eq i32 %add.i.i.i222, 0
  br i1 %cmp.i.i.i223, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i, label %if.end9.i.i.i224

if.end9.i.i.i224:                                 ; preds = %if.then86
  %conv.i.i.i226 = zext i32 %add.i.i.i222 to i64
  %86 = icmp slt i32 %prefix.sroa.15.0.lcssa, -1
  %87 = shl nuw nsw i64 %conv.i.i.i226, 2
  %88 = select i1 %86, i64 -1, i64 %87
  %call.i.i.i233 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %88) #19
          to label %call.i.i.i.noexc232 unwind label %lpad87

call.i.i.i.noexc232:                              ; preds = %if.end9.i.i.i224
  %_capacity.i.i225 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp, i64 0, i32 2
  store ptr %call.i.i.i233, ptr %ref.tmp, align 8
  store i32 0, ptr %call.i.i.i233, align 4
  store i32 %add.i.i.i222, ptr %_capacity.i.i225, align 4
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i

_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i:      ; preds = %call.i.i.i.noexc232, %if.then86
  %89 = phi ptr [ null, %if.then86 ], [ %call.i.i.i233, %call.i.i.i.noexc232 ]
  br label %while.cond.i.i.i
...
while.cond.i.i.i:                                 ; preds = %while.cond.i.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i
  ...
  %incdec.ptr.i.i.i = getelementptr inbounds i32, ptr %src.addr.0.i.i.i, i64 1
  %90 = load i32, ptr %src.addr.0.i.i.i, align 4
  %incdec.ptr1.i.i.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i, i64 1
  store i32 %90, ptr %dest.addr.0.i.i.i, align 4
...
_ZN11CStringBaseIwEC2ERKS0_.exit.i:               ; preds = %while.cond.i.i.i
  %_length.i.i227 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp, i64 0, i32 1
  store i32 %prefix.sroa.15.0.lcssa, ptr %_length.i.i227, align 8
...
invoke.cont88:                                    ; preds = %_ZN11CStringBaseIwEC2ERKS0_.exit.i
  %_capacity.i.i.i231 = getelementptr inbounds %"struct.NWildcard::CPair", ptr %ref.tmp, i64 0, i32 1, i32 1, i32 2
  %Name.i.i = getelementptr inbounds %"struct.NWildcard::CPair", ptr %ref.tmp, i64 0, i32 1, i32 1
  store ptr %call.i.i.i3.i, ptr %Name.i.i, align 8
  store i32 0, ptr %call.i.i.i3.i, align 4
  store i32 4, ptr %_capacity.i.i.i231, align 4
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %_capacity.i.i.i.i.i, i8 0, i64 16, i1 false)
  store i64 8, ptr %_itemSize.i.i.i.i.i, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard11CCensorNodeEE, i64 0, inrange i32 0, i64 2), ptr %SubNodes.i.i, align 8
  ...
  store i64 8, ptr %_itemSize.i.i.i11.i.i, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard5CItemEE, i64 0, inrange i32 0, i64 2), ptr %IncludeItems.i.i, align 8
  ...
  store i64 8, ptr %_itemSize.i.i.i13.i.i, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard5CItemEE, i64 0, inrange i32 0, i64 2), ptr %ExcludeItems.i.i, align 8
...
invoke.cont90:                                    ; preds = %invoke.cont88
  ...
  %92 = load ptr, ptr %ref.tmp, align 8
  %isnull.i.i235 = icmp eq ptr %92, null
  br i1 %isnull.i.i235, label %_ZN9NWildcard5CPairD2Ev.exit, label %delete.notnull.i.i236

delete.notnull.i.i236:                            ; preds = %invoke.cont90
  call void @_ZdaPv(ptr noundef nonnull %92) #18
  br label %_ZN9NWildcard5CPairD2Ev.exit

_ZN9NWildcard5CPairD2Ev.exit:                     ; preds = %invoke.cont90, %delete.notnull.i.i236
  call void @llvm.lifetime.end.p0(i64 136, ptr nonnull %ref.tmp) #20
  br label %invoke.cont96

lpad82:                                           ; preds = %if.end.i.i218, %if.then.i.i
  %93 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup112

lpad87:                                           ; preds = %if.end9.i.i.i224
...
ehcleanup93:                                      ; preds = %lpad87, %delete.notnull.i.i229, %lpad.i, %lpad89
  %.pn = phi { ptr, i32 } [ %95, %lpad89 ], [ %94, %lpad87 ], [ %91, %delete.notnull.i.i229 ], [ %91, %lpad.i ]
  call void @llvm.lifetime.end.p0(i64 136, ptr nonnull %ref.tmp) #20
  br label %ehcleanup112
...
.noexc:                                           ; preds = %invoke.cont96
  %call.i238 = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZN13CObjectVectorI11CStringBaseIwEEpLERKS2_(ptr noundef nonnull align 8 dereferenceable(32) %item, ptr noundef nonnull align 8 dereferenceable(32) %pathParts)
          to label %invoke.cont98 unwind label %lpad97

invoke.cont98:                                    ; preds = %.noexc
  %ForDir = getelementptr inbounds %"struct.NWildcard::CItem", ptr %item, i64 0, i32 3
  store i8 1, ptr %ForDir, align 2
  %ForFile = getelementptr inbounds %"struct.NWildcard::CItem", ptr %item, i64 0, i32 2
  %frombool101 = zext i1 %cmp.i145 to i8
  store i8 %frombool101, ptr %ForFile, align 1
  %Recursive = getelementptr inbounds %"struct.NWildcard::CItem", ptr %item, i64 0, i32 1
  store i8 %frombool1, ptr %Recursive, align 8
  %_items.i.i239 = getelementptr inbounds %class.CBaseRecordVector, ptr %this, i64 0, i32 3
  %96 = load ptr, ptr %_items.i.i239, align 8
  %idxprom.i.i240 = sext i32 %index.0 to i64
  %arrayidx.i.i241 = getelementptr inbounds ptr, ptr %96, i64 %idxprom.i.i240
  %97 = load ptr, ptr %arrayidx.i.i241, align 8
...
_ZN9NWildcard5CItemD2Ev.exit:                     ; preds = %invoke.cont108
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %item) #20
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %item) #20
  %isnull.i242 = icmp eq ptr %prefix.sroa.0.0.lcssa, null
  br i1 %isnull.i242, label %_ZN11CStringBaseIwED2Ev.exit, label %delete.notnull.i243

delete.notnull.i243:                              ; preds = %_ZN9NWildcard5CItemD2Ev.exit
  call void @_ZdaPv(ptr noundef nonnull %prefix.sroa.0.0.lcssa) #18
  br label %_ZN11CStringBaseIwED2Ev.exit

_ZN11CStringBaseIwED2Ev.exit:                     ; preds = %_ZN9NWildcard5CItemD2Ev.exit, %delete.notnull.i243
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorI11CStringBaseIwEE, i64 0, inrange i32 0, i64 2), ptr %pathParts, align 8
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %pathParts)
          to label %_ZN13CObjectVectorI11CStringBaseIwEED2Ev.exit unwind label %terminate.lpad.i
...
ehcleanup112:                                     ; preds = %lpad82, %ehcleanup93, %lpad97, %lpad61
  ...
  %.pn133.pn.pn = phi { ptr, i32 } [ %102, %lpad97 ], [ %.pn, %ehcleanup93 ], [ %93, %lpad82 ], [ %34, %lpad61 ]
  %isnull.i244 = icmp eq ptr %prefix.sroa.0.5, null
  br i1 %isnull.i244, label %ehcleanup118, label %delete.notnull.i245

delete.notnull.i245:                              ; preds = %ehcleanup112
  call void @_ZdaPv(ptr noundef nonnull %prefix.sroa.0.5) #18
  br label %ehcleanup118

ehcleanup118:                                     ; preds = %lpad53, %ehcleanup112, %delete.notnull.i245, %lpad4, %lpad30, %lpad
  %.pn141 = phi { ptr, i32 } [ %1, %lpad ], [ %6, %lpad4 ], [ %19, %lpad30 ], [ %21, %lpad53 ], [ %.pn133.pn.pn, %ehcleanup112 ], [ %.pn133.pn.pn, %delete.notnull.i245 ]
  call void @_ZN13CObjectVectorI11CStringBaseIwEED2Ev(ptr noundef nonnull align 8 dereferenceable(32) %pathParts) #20
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %pathParts) #20
...
entry:
  ...
  br i1 %cmp.not20, label %cleanup8, label %for.body.lr.ph
...
for.cond:                                         ; preds = %_ZNK9NWildcard11CCensorNode9CheckPathERK11CStringBaseIwEbRb.exit
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %1 = load i32, ptr %_size.i, align 4
  %2 = sext i32 %1 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv.next, %2
  br i1 %cmp.not.not, label %for.body, label %cleanup8.loopexit

for.body:                                         ; preds = %for.body.lr.ph, %for.cond
  %indvars.iv = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next, %for.cond ]
  %finded.021 = phi i8 [ 0, %for.body.lr.ph ], [ %finded.2, %for.cond ]
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %include) #20
  %3 = load ptr, ptr %_items.i.i, align 8
  %arrayidx.i.i = getelementptr inbounds ptr, ptr %3, i64 %indvars.iv
  %4 = load ptr, ptr %arrayidx.i.i, align 8
...
_ZNK9NWildcard11CCensorNode9CheckPathERK11CStringBaseIwEbRb.exit: ; preds = %invoke.cont2.i
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %pathParts.i) #20
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %pathParts.i) #20
  %10 = load i8, ptr %include, align 1
  %tobool5.not = icmp ne i8 %10, 0
  %11 = select i1 %call.i, i1 %tobool5.not, i1 false
  %finded.2 = select i1 %11, i8 1, i8 %finded.021
  %not.call.i = xor i1 %call.i, true
  %cond12 = select i1 %not.call.i, i1 true, i1 %tobool5.not
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %include) #20
  br i1 %cond12, label %for.cond, label %cleanup8.loopexit

cleanup8.loopexit:                                ; preds = %for.cond, %_ZNK9NWildcard11CCensorNode9CheckPathERK11CStringBaseIwEbRb.exit
  %12 = and i8 %finded.2, 1
  %13 = icmp ne i8 %12, 0
  %14 = select i1 %cond12, i1 %13, i1 false
  br label %cleanup8

cleanup8:                                         ; preds = %cleanup8.loopexit, %entry
  %cmp.not.lcssa = phi i1 [ false, %entry ], [ %14, %cleanup8.loopexit ]
  ret i1 %cmp.not.lcssa
}
...
if.then16:                                        ; preds = %for.body14
  %6 = load ptr, ptr %_items.i.i37, align 8
  %arrayidx.i.i39 = getelementptr inbounds ptr, ptr %6, i64 %indvars.iv51
  %7 = load ptr, ptr %arrayidx.i.i39, align 8
  ...
  %8 = load ptr, ptr %arrayidx.i.i42, align 8
...
if.end8:                                          ; preds = %entry
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %agg.result, i8 0, i64 16, i1 false)
  %call.i.i33 = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #19
...
entry:
  ...
  %2 = load i32, ptr %_length2.i, align 8
...
for.body.i.i:                                     ; preds = %call4.i.noexc.i, %for.body.lr.ph.i.i
  ...
  %11 = load ptr, ptr %_items.i.i.i.i, align 8
...
invoke.cont:                                      ; preds = %call4.i.noexc.i, %.noexc4.i
  ...
  store i64 8, ptr %_itemSize.i.i.i21, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard5CItemEE, i64 0, inrange i32 0, i64 2), ptr %IncludeItems, align 8
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %IncludeItems)
          to label %.noexc.i23 unwind label %lpad.i22

.noexc.i23:                                       ; preds = %invoke.cont
...
lpad.i22:                                         ; preds = %.noexc.i23, %invoke.cont
  %13 = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %IncludeItems) #20
  br label %ehcleanup

invoke.cont7:                                     ; preds = %.noexc.i23
  %ExcludeItems = getelementptr inbounds %"class.NWildcard::CCensorNode", ptr %this, i64 0, i32 4
  ...
  store i64 8, ptr %_itemSize.i.i.i26, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard5CItemEE, i64 0, inrange i32 0, i64 2), ptr %ExcludeItems, align 8
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %ExcludeItems)
          to label %.noexc.i28 unwind label %lpad.i27

.noexc.i28:                                       ; preds = %invoke.cont7
  %ExcludeItems8 = getelementptr inbounds %"class.NWildcard::CCensorNode", ptr %0, i64 0, i32 4
  %call.i3.i29 = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZN13CObjectVectorIN9NWildcard5CItemEEpLERKS2_(ptr noundef nonnull align 8 dereferenceable(32) %ExcludeItems, ptr noundef nonnull align 8 dereferenceable(32) %ExcludeItems8)
          to label %invoke.cont10 unwind label %lpad.i27

lpad.i27:                                         ; preds = %.noexc.i28, %invoke.cont7
...
ehcleanup:                                        ; preds = %lpad.i22, %lpad.i27
  %.pn = phi { ptr, i32 } [ %14, %lpad.i27 ], [ %13, %lpad.i22 ]
...
entry:
  ...
  store ptr %call.i.i.i, ptr @_ZL16kWildCardCharSet, align 8
  store i32 3, ptr getelementptr inbounds (%class.CStringBase, ptr @_ZL16kWildCardCharSet, i64 0, i32 2), align 4
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %call.i.i.i, ptr noundef nonnull align 4 dereferenceable(12) @.str, i64 12, i1 false)
  store i32 2, ptr getelementptr inbounds (%class.CStringBase, ptr @_ZL16kWildCardCharSet, i64 0, i32 1), align 8
  ...
  store ptr %call.i.i.i1, ptr @_ZL29kIllegalWildCardFileNameChars, align 8
  store i32 39, ptr getelementptr inbounds (%class.CStringBase, ptr @_ZL29kIllegalWildCardFileNameChars, i64 0, i32 2), align 4
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(156) %call.i.i.i1, ptr noundef nonnull align 4 dereferenceable(156) @.str.2, i64 156, i1 false)
  store i32 38, ptr getelementptr inbounds (%class.CStringBase, ptr @_ZL29kIllegalWildCardFileNameChars, i64 0, i32 1), align 8
