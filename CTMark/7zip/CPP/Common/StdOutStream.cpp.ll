; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Common/StdOutStream.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Common/StdOutStream.cpp"
...
_ZN13CStdOutStream5CloseEv.exit:                  ; preds = %entry, %if.end.i, %if.end3.i
  ...
  store ptr %call2, ptr %_stream, align 8
...
entry:
  ...
  store i8 0, ptr @g_StdOut, align 8
  store ptr %0, ptr getelementptr inbounds (%class.CStdOutStream, ptr @g_StdOut, i64 0, i32 1), align 8
  %1 = tail call i32 @__cxa_atexit(ptr nonnull @_ZN13CStdOutStreamD2Ev, ptr nonnull @g_StdOut, ptr nonnull @__dso_handle) #12
  %2 = load ptr, ptr @stderr, align 8
  store i8 0, ptr @g_StdErr, align 8
  store ptr %2, ptr getelementptr inbounds (%class.CStdOutStream, ptr @g_StdErr, i64 0, i32 1), align 8
