...
call.i.i.noexc.i30:                               ; preds = %if.end9.i.i.i26
  ...
  store ptr %call.i.i4.i28, ptr %call.i22, align 8, !tbaa !27
  store i32 0, ptr %call.i.i4.i28, align 4, !tbaa !28
  store i32 %add.i.i.i24, ptr %_capacity.i.i31, align 4, !tbaa !30
...
while.cond.i.i.i33:                               ; preds = %while.cond.i.i.i33, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i32
  ...
  %19 = load i32, ptr %src.addr.0.i.i.i34, align 4, !tbaa !28
  %incdec.ptr1.i.i.i37 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i35, i64 1
  store i32 %19, ptr %dest.addr.0.i.i.i35, align 4, !tbaa !28
  %cmp.not.i.i.i38 = icmp eq i32 %19, 0
  br i1 %cmp.not.i.i.i38, label %if.end12.sink.split, label %while.cond.i.i.i33, !llvm.loop !31
...
if.end12.sink.split:                              ; preds = %while.cond.i.i.i, %while.cond.i.i.i33
  ...
  store ptr %call.i.sink, ptr %arrayidx.i.i43, align 8, !tbaa !24
  %inc.i.i44 = add nsw i32 %22, 1
  store i32 %inc.i.i44, ptr %_size.i.i, align 4, !tbaa !22
  br label %if.end12
...
if.then7.i:                                       ; preds = %_ZN11CStringBaseIwEC2EPKw.exit
  br i1 %cmp.i.i, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i383, label %if.end9.i.i.i380

if.end9.i.i.i380:                                 ; preds = %if.then7.i
  %conv.i.i.i382 = zext i32 %add.i.i to i64
  %18 = icmp slt i32 %13, -1
  %19 = shl nuw nsw i64 %conv.i.i.i382, 2
...
call.i.i.i.noexc390:                              ; preds = %if.end9.i.i.i380
  store i32 0, ptr %call.i.i.i391, align 4, !tbaa !28, !noalias !38
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i383

_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i383:   ; preds = %call.i.i.i.noexc390, %if.then7.i
  %ref.tmp.sroa.0.2 = phi ptr [ null, %if.then7.i ], [ %call.i.i.i391, %call.i.i.i.noexc390 ]
  br label %while.cond.i.i.i384

while.cond.i.i.i384:                              ; preds = %while.cond.i.i.i384, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i383
  %src.addr.0.i.i.i385 = phi ptr [ %temp.sroa.0.2, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i383 ], [ %incdec.ptr.i.i.i387, %while.cond.i.i.i384 ]
  %dest.addr.0.i.i.i386 = phi ptr [ %ref.tmp.sroa.0.2, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i383 ], [ %incdec.ptr1.i.i.i388, %while.cond.i.i.i384 ]
  %incdec.ptr.i.i.i387 = getelementptr inbounds i32, ptr %src.addr.0.i.i.i385, i64 1
  %21 = load i32, ptr %src.addr.0.i.i.i385, align 4, !tbaa !28, !noalias !38
  %incdec.ptr1.i.i.i388 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i386, i64 1
  store i32 %21, ptr %dest.addr.0.i.i.i386, align 4, !tbaa !28, !noalias !38
  %cmp.not.i.i.i389 = icmp eq i32 %21, 0
  br i1 %cmp.not.i.i.i389, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i262.sink.split, label %while.cond.i.i.i384, !llvm.loop !31

if.end8.i:                                        ; preds = %_ZN11CStringBaseIwEC2EPKw.exit
  %call.i.i33.i392 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #13
          to label %call.i.i33.i.noexc unwind label %lpad

call.i.i33.i.noexc:                               ; preds = %if.end8.i
  store i32 0, ptr %call.i.i33.i392, align 4, !tbaa !28, !noalias !38
  %add.i.i369 = add nsw i32 %spec.select.i, 1
  %cmp.i.i370 = icmp eq i32 %add.i.i369, 4
  br i1 %cmp.i.i370, label %for.body.lr.ph.i, label %if.end.i.i371

if.end.i.i371:                                    ; preds = %call.i.i33.i.noexc
  %conv.i.i372 = zext i32 %add.i.i369 to i64
  %22 = icmp slt i32 %spec.select.i, -1
  %23 = shl nuw nsw i64 %conv.i.i372, 2
  %24 = select i1 %22, i64 -1, i64 %23
  %call.i36.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %24) #13
          to label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i373 unwind label %_ZN11CStringBaseIwED2Ev.exit.i, !noalias !38

_ZN11CStringBaseIwE11SetCapacityEi.exit.i373:     ; preds = %if.end.i.i371
  call void @_ZdaPv(ptr noundef nonnull %call.i.i33.i392) #16, !noalias !38
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i: ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i373
  %.pre.i374 = sext i32 %spec.select.i to i64
  br label %invoke.cont

for.body.lr.ph.i:                                 ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i373, %call.i.i33.i.noexc
  %ref.tmp.sroa.0.3 = phi ptr [ %call.i.i33.i392, %call.i.i33.i.noexc ], [ %call.i36.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i373 ]
...
_ZN11CStringBaseIwED2Ev.exit.i:                   ; preds = %if.end.i.i371
...
invoke.cont:                                      ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i, %for.body.lr.ph.i
  ...
  %idxprom15.pre-phi.i = phi i64 [ %.pre.i374, %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i ], [ %25, %for.body.lr.ph.i ]
...
if.end.i.i:                                       ; preds = %invoke.cont
  %conv.i.i259 = zext i32 %add.i.i369 to i64
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i262.sink.split: ; preds = %while.cond.i.i.i384, %call.i.i260.noexc, %delete.notnull.i.i
  %temp.sroa.0.2.sink = phi ptr [ %call.i.i260269, %delete.notnull.i.i ], [ %call.i.i260269, %call.i.i260.noexc ], [ %temp.sroa.0.2, %while.cond.i.i.i384 ]
  %ref.tmp.sroa.0.5508.ph = phi ptr [ %ref.tmp.sroa.0.4, %delete.notnull.i.i ], [ %ref.tmp.sroa.0.4, %call.i.i260.noexc ], [ %ref.tmp.sroa.0.2, %while.cond.i.i.i384 ]
...
while.cond.i.i263:                                ; preds = %while.cond.i.i263, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i262
  %src.addr.0.i.i264 = phi ptr [ %ref.tmp.sroa.0.5508, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i262 ], [ %incdec.ptr.i.i266, %while.cond.i.i263 ]
  %dest.addr.0.i.i265 = phi ptr [ %temp.sroa.0.3, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i262 ], [ %incdec.ptr1.i.i267, %while.cond.i.i263 ]
  %incdec.ptr.i.i266 = getelementptr inbounds i32, ptr %src.addr.0.i.i264, i64 1
  %31 = load i32, ptr %src.addr.0.i.i264, align 4, !tbaa !28
  %incdec.ptr1.i.i267 = getelementptr inbounds i32, ptr %dest.addr.0.i.i265, i64 1
  store i32 %31, ptr %dest.addr.0.i.i265, align 4, !tbaa !28
  %cmp.not.i.i268 = icmp eq i32 %31, 0
  br i1 %cmp.not.i.i268, label %invoke.cont23, label %while.cond.i.i263, !llvm.loop !31

invoke.cont23:                                    ; preds = %while.cond.i.i263
...
lpad:                                             ; preds = %if.end8.i, %if.end9.i.i.i380
...
if.end70:                                         ; preds = %sw.bb66
  ...
  br label %for.cond.i.i281

for.cond.i.i281:                                  ; preds = %for.cond.i.i281, %if.end70
  %indvars.iv.i.i282 = phi i64 [ %indvars.iv.next.i.i285, %for.cond.i.i281 ], [ 0, %if.end70 ]
  %arrayidx.i.i283 = getelementptr inbounds i32, ptr %46, i64 %indvars.iv.i.i282
  %47 = load i32, ptr %arrayidx.i.i283, align 4, !tbaa !28
  %cmp.not.i.i284 = icmp eq i32 %47, 0
  %indvars.iv.next.i.i285 = add nuw i64 %indvars.iv.i.i282, 1
  br i1 %cmp.not.i.i284, label %_Z11MyStringLenIwEiPKT_.exit.i286, label %for.cond.i.i281, !llvm.loop !37

_Z11MyStringLenIwEiPKT_.exit.i286:                ; preds = %for.cond.i.i281
  %48 = trunc i64 %indvars.iv.i.i282 to i32
  %add.i.i287 = add nsw i32 %48, 1
  %cmp.i.i288 = icmp eq i32 %add.i.i287, 0
  br i1 %cmp.i.i288, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i292, label %if.end9.i.i289

if.end9.i.i289:                                   ; preds = %_Z11MyStringLenIwEiPKT_.exit.i286
  %conv.i.i290 = zext i32 %add.i.i287 to i64
  %49 = icmp slt i32 %48, -1
  %50 = shl nuw nsw i64 %conv.i.i290, 2
  %51 = select i1 %49, i64 -1, i64 %50
  %call.i.i291 = call noalias noundef nonnull ptr @_Znam(i64 noundef %51) #13
  store i32 0, ptr %call.i.i291, align 4, !tbaa !28
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i292

_ZN11CStringBaseIwE11SetCapacityEi.exit.i292:     ; preds = %if.end9.i.i289, %_Z11MyStringLenIwEiPKT_.exit.i286
  %set.sroa.0.1 = phi ptr [ null, %_Z11MyStringLenIwEiPKT_.exit.i286 ], [ %call.i.i291, %if.end9.i.i289 ]
  br label %while.cond.i.i293

while.cond.i.i293:                                ; preds = %while.cond.i.i293, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i292
  %src.addr.0.i.i294 = phi ptr [ %46, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i292 ], [ %incdec.ptr.i.i296, %while.cond.i.i293 ]
  %dest.addr.0.i.i295 = phi ptr [ %set.sroa.0.1, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i292 ], [ %incdec.ptr1.i.i297, %while.cond.i.i293 ]
  %incdec.ptr.i.i296 = getelementptr inbounds i32, ptr %src.addr.0.i.i294, i64 1
  %52 = load i32, ptr %src.addr.0.i.i294, align 4, !tbaa !28
  %incdec.ptr1.i.i297 = getelementptr inbounds i32, ptr %dest.addr.0.i.i295, i64 1
  store i32 %52, ptr %dest.addr.0.i.i295, align 4, !tbaa !28
  %cmp.not.i10.i298 = icmp eq i32 %52, 0
  br i1 %cmp.not.i10.i298, label %_ZN11CStringBaseIwEC2EPKw.exit300, label %while.cond.i.i293, !llvm.loop !31

_ZN11CStringBaseIwEC2EPKw.exit300:                ; preds = %while.cond.i.i293
...
if.else73:                                        ; preds = %_ZN11CStringBaseIwEC2EPKw.exit300
  ...
  br i1 %cmp10.i.i, label %invoke.cont79, label %if.end.i.i301

if.end.i.i301:                                    ; preds = %if.else73, %if.end5.i.i
...
if.end5.i.i:                                      ; preds = %if.end.i.i301
  %add.ptr.i.i.i.i = getelementptr inbounds i32, ptr %p.011.i.i, i64 1
  %57 = load i32, ptr %add.ptr.i.i.i.i, align 4, !tbaa !28
  %cmp.i.i303 = icmp eq i32 %57, %54
  br i1 %cmp.i.i303, label %invoke.cont79, label %if.end.i.i301, !llvm.loop !50
...
invoke.cont79:                                    ; preds = %if.end5.i.i, %if.else73
  ...
  %conv.i.i304 = trunc i64 %58 to i32
  %cmp81 = icmp slt i32 %conv.i.i304, 0
  br i1 %cmp81, label %if.then82, label %if.else84

if.then82:                                        ; preds = %if.end.i.i301, %invoke.cont79
...
if.else84:                                        ; preds = %invoke.cont79
  ...
  store i32 %conv.i.i304, ptr %PostCharIndex85, align 8, !tbaa !49
...
if.end126:                                        ; preds = %for.body117
  ...
  br i1 %cmp.not.i.i325, label %if.end.i.i327, label %for.inc133

if.end.i.i327:                                    ; preds = %if.end126
  ...
  %add.i.i328 = add nsw i32 %delta.0.i.i, %sub2.i.i
  %cmp13.i.i = icmp slt i32 %add.i.i328, 1
  ...
  %add.i.i.i329 = add nsw i32 %add18.i.i, 1
  %cmp.i.i.i330 = icmp eq i32 %add.i.i.i329, %80
  br i1 %cmp.i.i.i330, label %for.inc133, label %if.end.i.i.i

if.end.i.i.i:                                     ; preds = %if.end.i.i327
  %conv.i.i.i331 = zext i32 %add.i.i.i329 to i64
  %83 = icmp slt i32 %add18.i.i, -1
  %84 = shl nuw nsw i64 %conv.i.i.i331, 2
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %87, align 4, !tbaa !28
  %88 = getelementptr inbounds i32, ptr %87, i64 4
  %wide.load557 = load <4 x i32>, ptr %88, align 4, !tbaa !28
  %89 = getelementptr inbounds i32, ptr %call.i.i.i333, i64 %index
  store <4 x i32> %wide.load, ptr %89, align 4, !tbaa !28
  %90 = getelementptr inbounds i32, ptr %89, i64 4
  store <4 x i32> %wide.load557, ptr %90, align 4, !tbaa !28
  %index.next = add nuw i64 %index, 8
  %91 = icmp eq i64 %index.next, %n.vec
  br i1 %91, label %middle.block, label %vector.body, !llvm.loop !55
...
for.body.i.i.i.prol:                              ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i.prol
  ...
  %94 = load i32, ptr %arrayidx.i.i.i.prol, align 4, !tbaa !28
  %arrayidx7.i.i.i.prol = getelementptr inbounds i32, ptr %call.i.i.i333, i64 %indvars.iv.i.i.i.prol
  store i32 %94, ptr %arrayidx7.i.i.i.prol, align 4, !tbaa !28
...
for.cond.cleanup.i.i.i:                           ; preds = %for.cond.preheader.i.i.i
  ...
  br i1 %isnull.i.i.i, label %if.end9.i.i.i332, label %delete.notnull.i.i.i
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  ...
  %99 = load i32, ptr %arrayidx.i.i.i.3, align 4, !tbaa !28
  %arrayidx7.i.i.i.3 = getelementptr inbounds i32, ptr %call.i.i.i333, i64 %indvars.iv.next.i.i.i.2
  store i32 %99, ptr %arrayidx7.i.i.i.3, align 4, !tbaa !28
...
if.end9.i.i.i332:                                 ; preds = %delete.notnull.i.i.i, %for.cond.cleanup.i.i.i, %call.i.i.i.noexc
  ...
  store i32 %add.i.i.i329, ptr %_capacity.i.i323, align 4, !tbaa !30
  br label %for.inc133

for.inc133:                                       ; preds = %if.end126, %if.end.i.i327, %if.end9.i.i.i332
  %101 = phi i32 [ %81, %if.end126 ], [ %81, %if.end.i.i327 ], [ %100, %if.end9.i.i.i332 ]
  %102 = load ptr, ptr %stringSwitch, align 8, !tbaa !27
  %idxprom.i = sext i32 %101 to i64
  %arrayidx.i326 = getelementptr inbounds i32, ptr %102, i64 %idxprom.i
  store i32 %78, ptr %arrayidx.i326, align 4, !tbaa !28
  ...
  br i1 %103, label %for.body117, label %cleanup136.loopexit, !llvm.loop !61
...
call.i.noexc357:                                  ; preds = %cleanup136
  ...
  %104 = load i32, ptr %_length.i.i324, align 8, !tbaa !25
  %add.i.i.i335 = add nsw i32 %104, 1
  %cmp.i.i.i336 = icmp eq i32 %add.i.i.i335, 0
  br i1 %cmp.i.i.i336, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i343, label %if.end9.i.i.i337

if.end9.i.i.i337:                                 ; preds = %call.i.noexc357
  %conv.i.i.i338 = zext i32 %add.i.i.i335 to i64
  %105 = icmp slt i32 %104, -1
  %106 = shl nuw nsw i64 %conv.i.i.i338, 2
  %107 = select i1 %105, i64 -1, i64 %106
  %call.i.i4.i339 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %107) #13
          to label %call.i.i.noexc.i341 unwind label %lpad.i340

call.i.i.noexc.i341:                              ; preds = %if.end9.i.i.i337
  %_capacity.i.i342 = getelementptr inbounds %class.CStringBase, ptr %call.i358, i64 0, i32 2
  store ptr %call.i.i4.i339, ptr %call.i358, align 8, !tbaa !27
  store i32 0, ptr %call.i.i4.i339, align 4, !tbaa !28
  store i32 %add.i.i.i335, ptr %_capacity.i.i342, align 4, !tbaa !30
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i343

_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i343:   ; preds = %call.i.i.noexc.i341, %call.i.noexc357
  %108 = phi ptr [ null, %call.i.noexc357 ], [ %call.i.i4.i339, %call.i.i.noexc.i341 ]
  %109 = load ptr, ptr %stringSwitch, align 8, !tbaa !27
  br label %while.cond.i.i.i344

while.cond.i.i.i344:                              ; preds = %while.cond.i.i.i344, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i343
  %src.addr.0.i.i.i345 = phi ptr [ %109, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i343 ], [ %incdec.ptr.i.i.i347, %while.cond.i.i.i344 ]
  %dest.addr.0.i.i.i346 = phi ptr [ %108, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i343 ], [ %incdec.ptr1.i.i.i348, %while.cond.i.i.i344 ]
  %incdec.ptr.i.i.i347 = getelementptr inbounds i32, ptr %src.addr.0.i.i.i345, i64 1
  %110 = load i32, ptr %src.addr.0.i.i.i345, align 4, !tbaa !28
  %incdec.ptr1.i.i.i348 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i346, i64 1
  store i32 %110, ptr %dest.addr.0.i.i.i346, align 4, !tbaa !28
  %cmp.not.i.i.i349 = icmp eq i32 %110, 0
  br i1 %cmp.not.i.i.i349, label %invoke.cont.i350, label %while.cond.i.i.i344, !llvm.loop !31

invoke.cont.i350:                                 ; preds = %while.cond.i.i.i344
  %_length.i.i351 = getelementptr inbounds %class.CStringBase, ptr %call.i358, i64 0, i32 1
  store i32 %104, ptr %_length.i.i351, align 8, !tbaa !25
...
lpad.i340:                                        ; preds = %if.end9.i.i.i337
  %111 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPv(ptr noundef nonnull %call.i358) #16
  br label %ehcleanup144

invoke.cont141:                                   ; preds = %invoke.cont.i350
  %_items.i.i352 = getelementptr inbounds %class.CBaseRecordVector, ptr %PostStrings139, i64 0, i32 3
  %112 = load ptr, ptr %_items.i.i352, align 8, !tbaa !23
  %_size.i.i353 = getelementptr inbounds %class.CBaseRecordVector, ptr %PostStrings139, i64 0, i32 2
  %113 = load i32, ptr %_size.i.i353, align 4, !tbaa !22
  %idxprom.i.i354 = sext i32 %113 to i64
  %arrayidx.i.i355 = getelementptr inbounds ptr, ptr %112, i64 %idxprom.i.i354
  store ptr %call.i358, ptr %arrayidx.i.i355, align 8, !tbaa !24
  %inc.i.i356 = add nsw i32 %113, 1
  store i32 %inc.i.i356, ptr %_size.i.i353, align 4, !tbaa !22
  %114 = load ptr, ptr %stringSwitch, align 8, !tbaa !27
  %isnull.i361 = icmp eq ptr %114, null
...
lpad140:                                          ; preds = %invoke.cont.i350, %cleanup136
  %115 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup144

ehcleanup144:                                     ; preds = %lpad140, %lpad.i340, %lpad118
  %.pn = phi { ptr, i32 } [ %79, %lpad118 ], [ %115, %lpad140 ], [ %111, %lpad.i340 ]
  %116 = load ptr, ptr %stringSwitch, align 8, !tbaa !27
  %isnull.i364 = icmp eq ptr %116, null
...
if.end8:                                          ; preds = %entry
  ...
  store ptr %call.i.i33, ptr %agg.result, align 8, !tbaa !27
...
while.cond.i.i49:                                 ; preds = %while.cond.i.i49, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i48
  ...
  %25 = load i32, ptr %src.addr.0.i.i50, align 4, !tbaa !28
  %incdec.ptr1.i.i53 = getelementptr inbounds i32, ptr %dest.addr.0.i.i51, i64 1
  store i32 %25, ptr %dest.addr.0.i.i51, align 4, !tbaa !28
  %cmp.not.i.i54 = icmp eq i32 %25, 0
  br i1 %cmp.not.i.i54, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i, label %while.cond.i.i49, !llvm.loop !31
