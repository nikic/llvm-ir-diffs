; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Common/StringToInt.cpp'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/7zip/CPP/Common/StringToInt.cpp"
...
if.then4:                                         ; preds = %if.then
  store ptr %s.addr.0.lcssa, ptr %end, align 8
  br label %cleanup8
...
if.then24:                                        ; preds = %if.else22
  store ptr %s.addr.0, ptr %end, align 8
  br label %cleanup30
...
if.then4.i:                                       ; preds = %if.then.i
  store ptr %s.addr.0.lcssa.i, ptr %end, align 8
...
cleanup.i:                                        ; preds = %if.then, %cleanup.i
  ...
  br i1 %or.cond.i, label %cleanup.i, label %if.then.i
...
if.end:                                           ; preds = %entry
  ...
  br i1 %or.cond20.i5, label %cleanup.i11, label %if.then.i6

if.then.i6:                                       ; preds = %cleanup.i11, %if.end
  %s.addr.0.lcssa.i7 = phi ptr [ %s, %if.end ], [ %incdec.ptr.i19, %cleanup.i11 ]
  %result.0.lcssa.i8 = phi i64 [ 0, %if.end ], [ %add.i18, %cleanup.i11 ]
  %cmp3.not.i9 = icmp eq ptr %end, null
  br i1 %cmp3.not.i9, label %return, label %if.then4.i10

if.then4.i10:                                     ; preds = %if.then.i6
  store ptr %s.addr.0.lcssa.i7, ptr %end, align 8
  br label %return

cleanup.i11:                                      ; preds = %if.end, %cleanup.i11
  %7 = phi i8 [ %8, %cleanup.i11 ], [ %0, %if.end ]
  %result.022.i12 = phi i64 [ %add.i18, %cleanup.i11 ], [ 0, %if.end ]
  %s.addr.021.i13 = phi ptr [ %incdec.ptr.i19, %cleanup.i11 ], [ %s, %if.end ]
  %conv.i14 = zext i8 %7 to i64
  %mul.i15 = mul i64 %result.022.i12, 10
  %sub.i16 = add nuw nsw i64 %conv.i14, 4294967248
  %conv7.i17 = and i64 %sub.i16, 4294967295
  %add.i18 = add i64 %conv7.i17, %mul.i15
  %incdec.ptr.i19 = getelementptr inbounds i8, ptr %s.addr.021.i13, i64 1
  %8 = load i8, ptr %incdec.ptr.i19, align 1
  %9 = add i8 %8, -48
  %or.cond.i20 = icmp ult i8 %9, 10
  br i1 %or.cond.i20, label %cleanup.i11, label %if.then.i6

return:                                           ; preds = %if.then4.i10, %if.then.i6, %_Z21ConvertStringToUInt64PKcPS0_.exit
  %retval.0 = phi i64 [ %sub, %_Z21ConvertStringToUInt64PKcPS0_.exit ], [ %result.0.lcssa.i8, %if.then.i6 ], [ %result.0.lcssa.i8, %if.then4.i10 ]
  ret i64 %retval.0
}
