...
if.then4.i10:                                     ; preds = %if.then.i6
  store ptr %s.addr.0.lcssa.i7, ptr %end, align 8, !tbaa !8
  br label %return
...
cleanup.i11:                                      ; preds = %if.end, %cleanup.i11
  ...
  %8 = load i8, ptr %incdec.ptr.i19, align 1, !tbaa !5
  %9 = add i8 %8, -48
  %or.cond.i20 = icmp ult i8 %9, 10
  br i1 %or.cond.i20, label %cleanup.i11, label %if.then.i6, !llvm.loop !10
