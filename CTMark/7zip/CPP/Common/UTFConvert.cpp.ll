...
if.end.i20:                                       ; preds = %_ZN11CStringBaseIwE9GetBufferEi.exit, %cleanup63.sink.split.i
  ...
  %21 = load i8, ptr %arrayidx.i24, align 1, !tbaa !17
  %conv.i25 = zext i8 %21 to i32
  %cmp1.i26 = icmp sgt i8 %21, -1
  br i1 %cmp1.i26, label %cleanup63.sink.split.i, label %if.end8.i27, !llvm.loop !21
...
cleanup.i54:                                      ; preds = %if.end29.i50
  ...
  br i1 %cmp40.not.i60, label %do.end.i61, label %do.body.i45.1, !llvm.loop !18
...
cleanup.i54.1:                                    ; preds = %if.end29.i50.1
  ...
  br i1 %cmp40.not.i60.1, label %do.end.i61, label %do.body.i45.2, !llvm.loop !18
...
cleanup.i54.2:                                    ; preds = %if.end29.i50.2
  ...
  br i1 %cmp40.not.i60.2, label %do.end.i61, label %do.body.i45.3, !llvm.loop !18
...
cleanup.i54.3:                                    ; preds = %if.end29.i50.3
  ...
  br i1 %cmp40.not.i60.3, label %do.end.i61, label %do.body.i45.4, !llvm.loop !18
...
if.end.i.i:                                       ; preds = %if.then.i
  ...
  %.pre69 = load i32, ptr %_length.i, align 8, !tbaa !16
  br i1 %cmp3.i.i, label %for.cond.preheader.i.i, label %if.end9.i.i

for.cond.preheader.i.i:                           ; preds = %if.end.i.i
  %cmp522.i.i = icmp sgt i32 %.pre69, 0
  %.pre.i.i = load ptr, ptr %dest, align 8, !tbaa !14
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %11, align 1, !tbaa !17
  %12 = getelementptr inbounds i8, ptr %11, i64 16
  %wide.load79 = load <16 x i8>, ptr %12, align 1, !tbaa !17
  %13 = getelementptr inbounds i8, ptr %call.i.i, i64 %index
  store <16 x i8> %wide.load, ptr %13, align 1, !tbaa !17
  %14 = getelementptr inbounds i8, ptr %13, i64 16
  store <16 x i8> %wide.load79, ptr %14, align 1, !tbaa !17
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load84 = load <8 x i8>, ptr %16, align 1, !tbaa !17
  %17 = getelementptr inbounds i8, ptr %call.i.i, i64 %index83
  store <8 x i8> %wide.load84, ptr %17, align 1, !tbaa !17
  %index.next85 = add nuw i64 %index83, 8
  %18 = icmp eq i64 %index.next85, %n.vec81
  br i1 %18, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !28
...
for.body.i.i.prol:                                ; preds = %for.body.i.i.preheader, %for.body.i.i.prol
  ...
  %21 = load i8, ptr %arrayidx.i.i.prol, align 1, !tbaa !17
  %arrayidx7.i.i.prol = getelementptr inbounds i8, ptr %call.i.i, i64 %indvars.iv.i.i.prol
  store i8 %21, ptr %arrayidx7.i.i.prol, align 1, !tbaa !17
...
delete.notnull.i.i:                               ; preds = %for.body.i.i.prol.loopexit, %for.body.i.i, %middle.block, %vec.epilog.middle.block, %for.cond.cleanup.i.i
  ...
  %.pre = load i32, ptr %_length.i, align 8, !tbaa !16
  %.pre70.pre = load ptr, ptr %src, align 8, !tbaa !11
  %.pre71.pre = load i32, ptr %_length.i15, align 8, !tbaa !5
...
_ZN11CStringBaseIcE9GetBufferEi.exitthread-pre-split: ; preds = %if.then.i, %_ZL13Utf16_To_Utf8PcPmPKwm.exit
  %.pr = load ptr, ptr %dest, align 8, !tbaa !14
  br label %_ZN11CStringBaseIcE9GetBufferEi.exit
...
if.end.i20:                                       ; preds = %cleanup53.i41, %if.end.lr.ph.i19
  ...
  %31 = load i32, ptr %arrayidx.i24, align 4, !tbaa !12
...
if.end5.i:                                        ; preds = %if.then3.i, %if.then2.i61
  ...
  br label %cleanup53.i41, !llvm.loop !23
...
if.end14.i51:                                     ; preds = %if.then10.i47
  ...
  %33 = load i32, ptr %arrayidx16.i52, align 4, !tbaa !12
  %34 = add i32 %33, -57344
...
do.body.preheader.i:                              ; preds = %for.end.i37
  ...
  %37 = load i8, ptr %arrayidx35.i, align 1, !tbaa !17
  ...
  br i1 %cmp52.not.i, label %cleanup53.i41, label %do.body.i.1, !llvm.loop !32
...
do.body.i.1:                                      ; preds = %do.body.preheader.i
  ...
  br i1 %cmp52.not.i.1, label %cleanup53.i41, label %do.body.i.2, !llvm.loop !32
...
do.body.i.2:                                      ; preds = %do.body.i.1
  ...
  br i1 %cmp52.not.i.2, label %cleanup53.i41, label %do.body.i.3, !llvm.loop !32
...
do.body.i.3:                                      ; preds = %do.body.i.2
  ...
  br i1 %cmp52.not.i.3, label %cleanup53.i41, label %do.body.i.4, !llvm.loop !32
...
_ZL13Utf16_To_Utf8PcPmPKwm.exit63:                ; preds = %if.then10.i47, %if.end14.i51, %cleanup53.i41, %_ZN11CStringBaseIcE9GetBufferEi.exit
  ...
  %52 = load ptr, ptr %dest, align 8, !tbaa !14
  br label %for.cond.i.i
...
for.cond.i.i:                                     ; preds = %for.cond.i.i, %_ZL13Utf16_To_Utf8PcPmPKwm.exit63
  ...
  %53 = load i8, ptr %arrayidx.i.i65, align 1, !tbaa !17
...
_ZN11CStringBaseIcE13ReleaseBufferEv.exit:        ; preds = %for.cond.i.i
  ...
  store i32 %54, ptr %_length.i, align 8, !tbaa !16
  ret i1 %tobool
}
