; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/mafft/rna.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/mafft/rna.c"
...
entry:
  ...
  %1 = load ptr, ptr @rnaalifoldcall.order, align 8
...
if.then:                                          ; preds = %entry
  ...
  store ptr %call4, ptr @rnaalifoldcall.order, align 8
  %3 = load i32, ptr @njob, align 4
  %call5 = tail call ptr @AllocateCharMtx(i32 noundef %3, i32 noundef 10) #16
  store ptr %call5, ptr @rnaalifoldcall.name, align 8
...
if.end26:                                         ; preds = %if.end
  ...
  %13 = load ptr, ptr @rnaalifoldcall.name, align 8
  %14 = load ptr, ptr @rnaalifoldcall.order, align 8
...
entry:
  ...
  store ptr %call26, ptr @foldrna.pairprob1, align 8
...
for.body.lr.ph:                                   ; preds = %entry
  %2 = load ptr, ptr @foldrna.useq1, align 8
...
for.body41.lr.ph:                                 ; preds = %for.cond38.preheader
  %3 = load ptr, ptr @foldrna.useq2, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %4 = load ptr, ptr %arrayidx34, align 8
  ...
  br i1 %exitcond.not, label %for.cond38.preheader, label %for.body
...
for.body53.lr.ph:                                 ; preds = %for.cond50.preheader
  %6 = load ptr, ptr @foldrna.oseq1, align 8
...
for.body41:                                       ; preds = %for.body41.lr.ph, %for.body41
  ...
  br i1 %exitcond992.not, label %for.cond50.preheader, label %for.body41
...
for.body65.lr.ph:                                 ; preds = %for.cond62.preheader
  %9 = load ptr, ptr @foldrna.oseq2, align 8
...
for.body53:                                       ; preds = %for.body53.lr.ph, %for.body53
  ...
  br i1 %exitcond997.not, label %for.cond62.preheader, label %for.body53
...
for.body65:                                       ; preds = %for.body65.lr.ph, %for.body65
  ...
  %12 = load ptr, ptr %arrayidx67, align 8
  %arrayidx69 = getelementptr inbounds ptr, ptr %seq2, i64 %indvars.iv998
  %13 = load ptr, ptr %arrayidx69, align 8
  ...
  br i1 %exitcond1002.not, label %for.cond74.preheader, label %for.body65
...
for.body77:                                       ; preds = %for.body77.preheader, %for.body77
  ...
  %14 = load ptr, ptr @foldrna.useq1, align 8
  ...
  br i1 %exitcond1007.not, label %for.cond83.preheader, label %for.body77
...
for.body97.lr.ph:                                 ; preds = %for.cond94.preheader
  %16 = load ptr, ptr @foldrna.pairprob1, align 8
...
for.body86:                                       ; preds = %for.body86.preheader, %for.body86
  ...
  %17 = load ptr, ptr @foldrna.useq2, align 8
  ...
  %18 = load ptr, ptr %arrayidx90, align 8
  ...
  br i1 %exitcond1012.not, label %for.cond94.preheader, label %for.body86
...
for.body113.lr.ph:                                ; preds = %for.cond110.preheader
  %19 = load ptr, ptr @foldrna.pairprob2, align 8
...
for.body3.us.i:                                   ; preds = %for.cond1.preheader.us.i, %for.inc.us.i.1
  ...
  %22 = load ptr, ptr %arrayidx.us.i, align 8
  %arrayidx5.us.i = getelementptr inbounds i8, ptr %22, i64 %indvars.iv135.i
  %23 = load i8, ptr %arrayidx5.us.i, align 1
...
for.inc.us.i.1:                                   ; preds = %if.else76.us.i.1, %if.then32.us.i.1, %for.inc.us.i, %for.inc.us.i, %for.inc.us.i, %for.inc.us.i, %for.inc.us.i
  ...
  store i8 %.sink.i.1, ptr %arrayidx5.us.i.1, align 1
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %for.cond1.for.inc86_crit_edge.us.i.unr-lcssa, label %for.body3.us.i
...
for.body3.us.i.epil:                              ; preds = %for.cond1.for.inc86_crit_edge.us.i.unr-lcssa
  ...
  %26 = load ptr, ptr %arrayidx.us.i.epil, align 8
  %arrayidx5.us.i.epil = getelementptr inbounds i8, ptr %26, i64 %indvars.iv135.i
  %27 = load i8, ptr %arrayidx5.us.i.epil, align 1
...
for.inc.us.i.epil:                                ; preds = %if.else76.us.i.epil, %if.then32.us.i.epil, %for.body3.us.i.epil, %for.body3.us.i.epil, %for.body3.us.i.epil, %for.body3.us.i.epil, %for.body3.us.i.epil
  ...
  store i8 %.sink.i.epil, ptr %arrayidx5.us.i.epil, align 1
...
for.cond1.for.inc86_crit_edge.us.i:               ; preds = %for.cond1.for.inc86_crit_edge.us.i.unr-lcssa, %for.inc.us.i.epil
  ...
  br i1 %exitcond139.not.i, label %utot.exit, label %for.cond1.preheader.us.i

utot.exit:                                        ; preds = %for.cond1.for.inc86_crit_edge.us.i, %for.end127
  %28 = load ptr, ptr @foldrna.oseq2, align 8
  %or.cond.i640 = and i1 %cmp39786, %cmp111798
  br i1 %or.cond.i640, label %for.cond1.preheader.us.preheader.i641, label %utot.exit663

for.cond1.preheader.us.preheader.i641:            ; preds = %utot.exit
  %wide.trip.count138.i642 = and i64 %call2, 4294967295
  %wide.trip.count.i643 = zext i32 %nseq2 to i64
  %xtraiter1218 = and i64 %wide.trip.count.i643, 1
  %29 = icmp eq i32 %nseq2, 1
  %unroll_iter1220 = and i64 %wide.trip.count.i643, 4294967294
  %lcmp.mod1219.not = icmp eq i64 %xtraiter1218, 0
  br label %for.cond1.preheader.us.i644

for.cond1.preheader.us.i644:                      ; preds = %for.cond1.for.inc86_crit_edge.us.i654, %for.cond1.preheader.us.preheader.i641
  %indvars.iv135.i645 = phi i64 [ 0, %for.cond1.preheader.us.preheader.i641 ], [ %indvars.iv.next136.i655, %for.cond1.for.inc86_crit_edge.us.i654 ]
  br i1 %29, label %for.cond1.for.inc86_crit_edge.us.i654.unr-lcssa, label %for.body3.us.i646

for.body3.us.i646:                                ; preds = %for.cond1.preheader.us.i644, %for.inc.us.i650.1
  %indvars.iv.i647 = phi i64 [ %indvars.iv.next.i652.1, %for.inc.us.i650.1 ], [ 0, %for.cond1.preheader.us.i644 ]
  %niter1221 = phi i64 [ %niter1221.next.1, %for.inc.us.i650.1 ], [ 0, %for.cond1.preheader.us.i644 ]
  %arrayidx.us.i648 = getelementptr inbounds ptr, ptr %28, i64 %indvars.iv.i647
  %30 = load ptr, ptr %arrayidx.us.i648, align 8
  %arrayidx5.us.i649 = getelementptr inbounds i8, ptr %30, i64 %indvars.iv135.i645
  %31 = load i8, ptr %arrayidx5.us.i649, align 1
  switch i8 %31, label %if.else76.us.i662 [
    i8 97, label %for.inc.us.i650
    i8 116, label %for.inc.us.i650
    i8 117, label %if.then32.us.i659
    i8 103, label %for.inc.us.i650
    i8 99, label %for.inc.us.i650
    i8 45, label %for.inc.us.i650
  ]

if.then32.us.i659:                                ; preds = %for.body3.us.i646
  br label %for.inc.us.i650

if.else76.us.i662:                                ; preds = %for.body3.us.i646
  br label %for.inc.us.i650

for.inc.us.i650:                                  ; preds = %for.body3.us.i646, %for.body3.us.i646, %for.body3.us.i646, %for.body3.us.i646, %if.else76.us.i662, %if.then32.us.i659, %for.body3.us.i646
  %.sink.i651 = phi i8 [ 110, %if.else76.us.i662 ], [ 116, %if.then32.us.i659 ], [ %31, %for.body3.us.i646 ], [ %31, %for.body3.us.i646 ], [ %31, %for.body3.us.i646 ], [ %31, %for.body3.us.i646 ], [ %31, %for.body3.us.i646 ]
  store i8 %.sink.i651, ptr %arrayidx5.us.i649, align 1
  %indvars.iv.next.i652 = or i64 %indvars.iv.i647, 1
  %arrayidx.us.i648.1 = getelementptr inbounds ptr, ptr %28, i64 %indvars.iv.next.i652
  %32 = load ptr, ptr %arrayidx.us.i648.1, align 8
  %arrayidx5.us.i649.1 = getelementptr inbounds i8, ptr %32, i64 %indvars.iv135.i645
  %33 = load i8, ptr %arrayidx5.us.i649.1, align 1
  switch i8 %33, label %if.else76.us.i662.1 [
    i8 97, label %for.inc.us.i650.1
    i8 116, label %for.inc.us.i650.1
    i8 117, label %if.then32.us.i659.1
    i8 103, label %for.inc.us.i650.1
    i8 99, label %for.inc.us.i650.1
    i8 45, label %for.inc.us.i650.1
  ]

if.then32.us.i659.1:                              ; preds = %for.inc.us.i650
  br label %for.inc.us.i650.1

if.else76.us.i662.1:                              ; preds = %for.inc.us.i650
  br label %for.inc.us.i650.1

for.inc.us.i650.1:                                ; preds = %if.else76.us.i662.1, %if.then32.us.i659.1, %for.inc.us.i650, %for.inc.us.i650, %for.inc.us.i650, %for.inc.us.i650, %for.inc.us.i650
  %.sink.i651.1 = phi i8 [ 110, %if.else76.us.i662.1 ], [ 116, %if.then32.us.i659.1 ], [ %33, %for.inc.us.i650 ], [ %33, %for.inc.us.i650 ], [ %33, %for.inc.us.i650 ], [ %33, %for.inc.us.i650 ], [ %33, %for.inc.us.i650 ]
  store i8 %.sink.i651.1, ptr %arrayidx5.us.i649.1, align 1
  %indvars.iv.next.i652.1 = add nuw nsw i64 %indvars.iv.i647, 2
  %niter1221.next.1 = add i64 %niter1221, 2
  %niter1221.ncmp.1 = icmp eq i64 %niter1221.next.1, %unroll_iter1220
  br i1 %niter1221.ncmp.1, label %for.cond1.for.inc86_crit_edge.us.i654.unr-lcssa, label %for.body3.us.i646

for.cond1.for.inc86_crit_edge.us.i654.unr-lcssa:  ; preds = %for.inc.us.i650.1, %for.cond1.preheader.us.i644
  %indvars.iv.i647.unr = phi i64 [ 0, %for.cond1.preheader.us.i644 ], [ %indvars.iv.next.i652.1, %for.inc.us.i650.1 ]
  br i1 %lcmp.mod1219.not, label %for.cond1.for.inc86_crit_edge.us.i654, label %for.body3.us.i646.epil

for.body3.us.i646.epil:                           ; preds = %for.cond1.for.inc86_crit_edge.us.i654.unr-lcssa
  %arrayidx.us.i648.epil = getelementptr inbounds ptr, ptr %28, i64 %indvars.iv.i647.unr
  %34 = load ptr, ptr %arrayidx.us.i648.epil, align 8
  %arrayidx5.us.i649.epil = getelementptr inbounds i8, ptr %34, i64 %indvars.iv135.i645
  %35 = load i8, ptr %arrayidx5.us.i649.epil, align 1
  switch i8 %35, label %if.else76.us.i662.epil [
    i8 97, label %for.inc.us.i650.epil
    i8 116, label %for.inc.us.i650.epil
    i8 117, label %if.then32.us.i659.epil
    i8 103, label %for.inc.us.i650.epil
    i8 99, label %for.inc.us.i650.epil
    i8 45, label %for.inc.us.i650.epil
  ]

if.then32.us.i659.epil:                           ; preds = %for.body3.us.i646.epil
  br label %for.inc.us.i650.epil

if.else76.us.i662.epil:                           ; preds = %for.body3.us.i646.epil
  br label %for.inc.us.i650.epil

for.inc.us.i650.epil:                             ; preds = %if.else76.us.i662.epil, %if.then32.us.i659.epil, %for.body3.us.i646.epil, %for.body3.us.i646.epil, %for.body3.us.i646.epil, %for.body3.us.i646.epil, %for.body3.us.i646.epil
  %.sink.i651.epil = phi i8 [ 110, %if.else76.us.i662.epil ], [ 116, %if.then32.us.i659.epil ], [ %35, %for.body3.us.i646.epil ], [ %35, %for.body3.us.i646.epil ], [ %35, %for.body3.us.i646.epil ], [ %35, %for.body3.us.i646.epil ], [ %35, %for.body3.us.i646.epil ]
  store i8 %.sink.i651.epil, ptr %arrayidx5.us.i649.epil, align 1
  br label %for.cond1.for.inc86_crit_edge.us.i654

for.cond1.for.inc86_crit_edge.us.i654:            ; preds = %for.cond1.for.inc86_crit_edge.us.i654.unr-lcssa, %for.inc.us.i650.epil
  %indvars.iv.next136.i655 = add nuw nsw i64 %indvars.iv135.i645, 1
  %exitcond139.not.i656 = icmp eq i64 %indvars.iv.next136.i655, %wide.trip.count138.i642
  br i1 %exitcond139.not.i656, label %utot.exit663, label %for.cond1.preheader.us.i644

utot.exit663:                                     ; preds = %for.cond1.for.inc86_crit_edge.us.i654, %utot.exit
  %36 = load i8, ptr @rnaprediction, align 1
...
if.else:                                          ; preds = %utot.exit663
  %37 = load ptr, ptr @foldrna.useq1, align 8
  %38 = load ptr, ptr @foldrna.pairprob1, align 8
  %.val637 = load ptr, ptr %20, align 8
  ...
  %39 = load i8, ptr @rnaprediction, align 1
  %cmp132 = icmp eq i8 %39, 114
  %40 = load ptr, ptr @foldrna.oseq2, align 8
...
if.else135:                                       ; preds = %if.else
  %41 = load ptr, ptr @foldrna.useq2, align 8
  %42 = load ptr, ptr @foldrna.pairprob2, align 8
  ...
  %43 = load ptr, ptr @foldrna.oseq1, align 8
  %44 = load ptr, ptr @foldrna.oseq2, align 8
  %45 = load ptr, ptr @foldrna.map, align 8
  ...
  %46 = load i8, ptr @RNAscoremtx, align 1
...
for.cond169.preheader.us:                         ; preds = %for.cond169.preheader.us.preheader, %for.cond169.for.inc184_crit_edge.us
  ...
  %48 = load ptr, ptr %arrayidx174.us, align 8
  %arrayidx178.us = getelementptr inbounds ptr, ptr %47, i64 %indvars.iv1028
  %49 = load ptr, ptr %arrayidx178.us, align 8
...
vector.body:                                      ; preds = %for.cond169.preheader.us, %vector.body
  ...
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00>, ptr %53, align 4
  %54 = getelementptr inbounds float, ptr %53, i64 4
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00>, ptr %54, align 4
  %55 = getelementptr inbounds float, ptr %49, i64 %index
  store <4 x float> zeroinitializer, ptr %55, align 4
  %56 = getelementptr inbounds float, ptr %55, i64 4
  store <4 x float> zeroinitializer, ptr %56, align 4
...
for.body172.us.prol:                              ; preds = %for.body172.us.preheader, %for.body172.us.prol
  ...
  store float 1.000000e+00, ptr %arrayidx176.us.prol, align 4
  %arrayidx180.us.prol = getelementptr inbounds float, ptr %49, i64 %indvars.iv1023.prol
  store float 0.000000e+00, ptr %arrayidx180.us.prol, align 4
  ...
  br i1 %prol.iter.cmp.not, label %for.body172.us.prol.loopexit, label %for.body172.us.prol
...
for.body172.us:                                   ; preds = %for.body172.us.prol.loopexit, %for.body172.us
  ...
  store float 1.000000e+00, ptr %arrayidx176.us, align 4
  %arrayidx180.us = getelementptr inbounds float, ptr %49, i64 %indvars.iv1023
  store float 0.000000e+00, ptr %arrayidx180.us, align 4
  ...
  store float 1.000000e+00, ptr %arrayidx176.us.1, align 4
  %arrayidx180.us.1 = getelementptr inbounds float, ptr %49, i64 %indvars.iv.next1024
  store float 0.000000e+00, ptr %arrayidx180.us.1, align 4
  ...
  store float 1.000000e+00, ptr %arrayidx176.us.2, align 4
  %arrayidx180.us.2 = getelementptr inbounds float, ptr %49, i64 %indvars.iv.next1024.1
  store float 0.000000e+00, ptr %arrayidx180.us.2, align 4
  ...
  store float 1.000000e+00, ptr %arrayidx176.us.3, align 4
  %arrayidx180.us.3 = getelementptr inbounds float, ptr %49, i64 %indvars.iv.next1024.2
  store float 0.000000e+00, ptr %arrayidx180.us.3, align 4
  ...
  br i1 %exitcond1027.not.3, label %for.cond169.for.inc184_crit_edge.us, label %for.body172.us
...
for.cond169.for.inc184_crit_edge.us:              ; preds = %for.body172.us.prol.loopexit, %for.body172.us, %middle.block
  ...
  br i1 %exitcond1032.not, label %for.cond187.preheader, label %for.cond169.preheader.us
...
for.cond146.preheader.us:                         ; preds = %for.cond146.preheader.us, %for.cond146.preheader.us.preheader.new
  ...
  %67 = load ptr, ptr %arrayidx151.us, align 8
  tail call void @llvm.memset.p0.i64(ptr align 4 %67, i8 0, i64 %64, i1 false)
  %indvars.iv.next1067 = or i64 %indvars.iv1066, 1
  %arrayidx151.us.1 = getelementptr inbounds ptr, ptr %62, i64 %indvars.iv.next1067
  %68 = load ptr, ptr %arrayidx151.us.1, align 8
  tail call void @llvm.memset.p0.i64(ptr align 4 %68, i8 0, i64 %64, i1 false)
  ...
  %69 = load ptr, ptr %arrayidx151.us.2, align 8
  tail call void @llvm.memset.p0.i64(ptr align 4 %69, i8 0, i64 %64, i1 false)
  ...
  %70 = load ptr, ptr %arrayidx151.us.3, align 8
  tail call void @llvm.memset.p0.i64(ptr align 4 %70, i8 0, i64 %64, i1 false)
  ...
  %71 = load ptr, ptr %arrayidx151.us.4, align 8
  tail call void @llvm.memset.p0.i64(ptr align 4 %71, i8 0, i64 %64, i1 false)
  ...
  %72 = load ptr, ptr %arrayidx151.us.5, align 8
  tail call void @llvm.memset.p0.i64(ptr align 4 %72, i8 0, i64 %64, i1 false)
  ...
  %73 = load ptr, ptr %arrayidx151.us.6, align 8
  tail call void @llvm.memset.p0.i64(ptr align 4 %73, i8 0, i64 %64, i1 false)
  ...
  %74 = load ptr, ptr %arrayidx151.us.7, align 8
  tail call void @llvm.memset.p0.i64(ptr align 4 %74, i8 0, i64 %64, i1 false)
  ...
  br i1 %niter1233.ncmp.7, label %if.end294.loopexit.unr-lcssa, label %for.cond146.preheader.us
...
for.body190.lr.ph:                                ; preds = %for.cond169.preheader.lr.ph, %for.cond187.preheader
  %75 = load ptr, ptr @foldrna.pairprob1, align 8
  %76 = load ptr, ptr @foldrna.pairprob2, align 8
  %77 = load ptr, ptr @foldrna.oseq1, align 8
  %78 = load ptr, ptr @foldrna.oseq2, align 8
  %wide.trip.count169.i682 = zext i32 %nseq1 to i64
  %wide.trip.count.i683 = zext i32 %nseq2 to i64
...
for.cond268.preheader:                            ; preds = %for.inc265
  store ptr %storemerge.lcssa, ptr @foldrna.pairpt1, align 8
...
for.cond272.preheader.lr.ph:                      ; preds = %for.cond268.preheader
  ...
  %wide.trip.count.i768 = zext i32 %nseq2 to i64
...
for.cond272.preheader.us:                         ; preds = %for.cond272.preheader.us.preheader, %for.cond272.for.inc290_crit_edge.us
  ...
  %85 = load ptr, ptr %arrayidx277.us, align 8
  %arrayidx284.us = getelementptr inbounds ptr, ptr %82, i64 %indvars.iv1058
  %86 = load ptr, ptr %arrayidx284.us, align 8
...
vector.ph1170:                                    ; preds = %vector.memcheck1157
  %87 = load float, ptr @consweight_multi, align 4
...
vector.body1175:                                  ; preds = %vector.body1175, %vector.ph1170
  ...
  %wide.load1177 = load <4 x float>, ptr %88, align 4
  %89 = getelementptr inbounds float, ptr %88, i64 4
  %wide.load1178 = load <4 x float>, ptr %89, align 4
  ...
  %wide.load1179 = load <4 x float>, ptr %92, align 4
  %93 = getelementptr inbounds float, ptr %92, i64 4
  %wide.load1180 = load <4 x float>, ptr %93, align 4
...
for.body275.us820:                                ; preds = %for.body275.us820.prol.loopexit, %for.body275.us820
  ...
  br i1 %exitcond1047.not.1, label %for.cond272.for.inc290_crit_edge.us, label %for.body275.us820
...
for.cond272.for.inc290_crit_edge.us:              ; preds = %for.body275.us820.prol.loopexit, %for.body275.us820, %for.body275.us.us830.prol.loopexit, %for.body275.us.us830, %singleribosumscore.exit.loopexit.us.us.us, %middle.block1167, %middle.block1141
  ...
  br i1 %exitcond1062.not, label %if.end294, label %for.cond272.preheader.us
...
vector.ph1144:                                    ; preds = %vector.memcheck1136
  %111 = load float, ptr @consweight_multi, align 4
...
vector.body1149:                                  ; preds = %vector.body1149, %vector.ph1144
  ...
  %wide.load = load <4 x float>, ptr %112, align 4
  %113 = getelementptr inbounds float, ptr %112, i64 4
  %wide.load1151 = load <4 x float>, ptr %113, align 4
  ...
  %wide.load1152 = load <4 x float>, ptr %116, align 4
  %117 = getelementptr inbounds float, ptr %116, i64 4
  %wide.load1153 = load <4 x float>, ptr %117, align 4
  ...
  store <4 x float> %118, ptr %116, align 4
  store <4 x float> %119, ptr %117, align 4
  %index.next1156 = add nuw i64 %index1150, 8
  %120 = icmp eq i64 %index.next1156, %n.vec1146
  br i1 %120, label %middle.block1141, label %vector.body1149
...
for.body275.us.us830:                             ; preds = %for.body275.us.us830.prol.loopexit, %for.body275.us.us830
  ...
  br i1 %exitcond1052.not.1, label %for.cond272.for.inc290_crit_edge.us, label %for.body275.us.us830
...
for.body275.us.us.us:                             ; preds = %for.body275.lr.ph.split.us.us, %singleribosumscore.exit.loopexit.us.us.us
  ...
  %135 = load float, ptr %arrayidx279.us.us.us, align 4
  br label %for.cond1.preheader.us.i769.us.us.us

for.cond1.preheader.us.i769.us.us.us:             ; preds = %for.cond1.for.inc34_crit_edge.us.i.us.us.us, %for.body275.us.us.us
  ...
  %arrayidx.us.i770.us.us.us = getelementptr inbounds ptr, ptr %80, i64 %indvars.iv56.i.us.us.us
  %136 = load ptr, ptr %arrayidx.us.i770.us.us.us, align 8
  %arrayidx5.us.i771.us.us.us = getelementptr inbounds i8, ptr %136, i64 %indvars.iv1058
  %137 = load i8, ptr %arrayidx5.us.i771.us.us.us, align 1
  %idxprom6.us.i772.us.us.us = sext i8 %137 to i64
  %arrayidx7.us.i773.us.us.us = getelementptr inbounds [128 x i32], ptr @amino_n, i64 0, i64 %idxprom6.us.i772.us.us.us
  %138 = load i32, ptr %arrayidx7.us.i773.us.us.us, align 4
  ...
  %139 = load double, ptr %arrayidx28.us.i.us.us.us, align 8
  br label %for.body3.us.i774.us.us.us

for.body3.us.i774.us.us.us:                       ; preds = %for.body3.us.i774.us.us.us, %for.cond1.preheader.us.i769.us.us.us
  %indvars.iv.i775.us.us.us = phi i64 [ 0, %for.cond1.preheader.us.i769.us.us.us ], [ %indvars.iv.next.i779.us.us.us, %for.body3.us.i774.us.us.us ]
  %val.149.us.i.us.us.us = phi float [ %val.052.us.i.us.us.us, %for.cond1.preheader.us.i769.us.us.us ], [ %conv33.us.i.us.us.us, %for.body3.us.i774.us.us.us ]
  %arrayidx11.us.i776.us.us.us = getelementptr inbounds ptr, ptr %81, i64 %indvars.iv.i775.us.us.us
  %140 = load ptr, ptr %arrayidx11.us.i776.us.us.us, align 8
  %arrayidx13.us.i.us.us.us = getelementptr inbounds i8, ptr %140, i64 %indvars.iv1053
  %141 = load i8, ptr %arrayidx13.us.i.us.us.us, align 1
  ...
  %142 = load i32, ptr %arrayidx16.us.i.us.us.us, align 4
  %cmp17.us.i777.us.us.us = icmp sgt i32 %142, 3
  %spec.store.select37.us.i.us.us.us = select i1 %cmp17.us.i777.us.us.us, i32 36, i32 %142
  ...
  %143 = load i32, ptr %arrayidx24.us.i.us.us.us, align 4
  %conv25.us.i.us.us.us = sitofp i32 %143 to float
  %conv26.us.i.us.us.us = fpext float %conv25.us.i.us.us.us to double
  %mul.us.i778.us.us.us = fmul double %139, %conv26.us.i.us.us.us
  %arrayidx30.us.i.us.us.us = getelementptr inbounds double, ptr %eff2, i64 %indvars.iv.i775.us.us.us
  %144 = load double, ptr %arrayidx30.us.i.us.us.us, align 8
  %conv32.us.i.us.us.us = fpext float %val.149.us.i.us.us.us to double
  %145 = tail call double @llvm.fmuladd.f64(double %mul.us.i778.us.us.us, double %144, double %conv32.us.i.us.us.us)
  %conv33.us.i.us.us.us = fptrunc double %145 to float
  %indvars.iv.next.i779.us.us.us = add nuw nsw i64 %indvars.iv.i775.us.us.us, 1
  %exitcond.not.i780.us.us.us = icmp eq i64 %indvars.iv.next.i779.us.us.us, %wide.trip.count.i768
  br i1 %exitcond.not.i780.us.us.us, label %for.cond1.for.inc34_crit_edge.us.i.us.us.us, label %for.body3.us.i774.us.us.us

for.cond1.for.inc34_crit_edge.us.i.us.us.us:      ; preds = %for.body3.us.i774.us.us.us
  ...
  br i1 %exitcond60.not.i.us.us.us, label %singleribosumscore.exit.loopexit.us.us.us, label %for.cond1.preheader.us.i769.us.us.us
...
for.body190:                                      ; preds = %for.body190.lr.ph, %for.inc265
  ...
  %150 = load i32, ptr %bestpos194809, align 4
...
for.cond198.preheader.us:                         ; preds = %for.cond198.preheader.lr.ph, %for.cond198.for.inc262_crit_edge.us
  ...
  %storemerge811.us = phi ptr [ %incdec.ptr263.us, %for.cond198.for.inc262_crit_edge.us ], [ %149, %for.cond198.preheader.lr.ph ]
  %bestscore211.us = getelementptr inbounds %struct._RNApair, ptr %storemerge811.us, i64 0, i32 5
  %152 = sext i32 %151 to i64
  %cmp218.us = icmp slt i64 %indvars.iv1038, %152
  %idxprom10.i678.us = zext i32 %151 to i64
...
for.body201.us:                                   ; preds = %for.cond198.preheader.us, %for.inc259.us
  ...
  %153 = load ptr, ptr %arrayidx203.us, align 8
  %bestpos205804.us = getelementptr inbounds %struct._RNApair, ptr %153, i64 0, i32 4
  %154 = load i32, ptr %bestpos205804.us, align 4
...
for.body208.us:                                   ; preds = %for.body201.us, %for.inc257.us
  ...
  %storemerge630806.us = phi ptr [ %incdec.ptr.us, %for.inc257.us ], [ %153, %for.body201.us ]
  %156 = load float, ptr %bestscore211.us, align 4
  %bestscore212.us = getelementptr inbounds %struct._RNApair, ptr %storemerge630806.us, i64 0, i32 5
  %157 = load float, ptr %bestscore212.us, align 4
...
if.then241.us:                                    ; preds = %if.else235.us
  br i1 %cmp32784, label %for.cond1.preheader.lr.ph.i675.us, label %pairedribosumscore35.exit.us

for.cond1.preheader.lr.ph.i675.us:                ; preds = %if.then241.us
  %idxprom32.i680.us = zext i32 %155 to i64
  br i1 %cmp39786, label %for.cond1.preheader.us.i685.us, label %pairedribosumscore35.exit.us

for.cond1.preheader.us.i685.us:                   ; preds = %for.cond1.preheader.lr.ph.i675.us, %for.cond1.for.inc85_crit_edge.us.i737.us
  %indvars.iv166.i686.us = phi i64 [ %indvars.iv.next167.i739.us, %for.cond1.for.inc85_crit_edge.us.i737.us ], [ 0, %for.cond1.preheader.lr.ph.i675.us ]
  %val.0126.us.i687.us = phi float [ %.us-phi.us.i738.us, %for.cond1.for.inc85_crit_edge.us.i737.us ], [ 0.000000e+00, %for.cond1.preheader.lr.ph.i675.us ]
  %arrayidx.us.i688.us = getelementptr inbounds ptr, ptr %77, i64 %indvars.iv166.i686.us
  %160 = load ptr, ptr %arrayidx.us.i688.us, align 8
  %arrayidx5.us.i689.us = getelementptr inbounds i8, ptr %160, i64 %indvars.iv1038
  %161 = load i8, ptr %arrayidx5.us.i689.us, align 1
  %idxprom6.us.i690.us = sext i8 %161 to i64
  %arrayidx7.us.i691.us = getelementptr inbounds [128 x i32], ptr @amino_n, i64 0, i64 %idxprom6.us.i690.us
  %162 = load i32, ptr %arrayidx7.us.i691.us, align 4
  %cmp15.us.i692.us = icmp sgt i32 %162, 3
  %arrayidx77.us.i693.us = getelementptr inbounds double, ptr %eff1, i64 %indvars.iv166.i686.us
  br i1 %cmp15.us.i692.us, label %for.body3.lr.ph.split.us.us.i746.us, label %for.body3.us128.preheader.i694.us

for.body3.us128.preheader.i694.us:                ; preds = %for.cond1.preheader.us.i685.us
  %add.us.i695.us = add nsw i32 %162, 4
  %arrayidx11.us.i696.us = getelementptr inbounds i8, ptr %160, i64 %idxprom10.i678.us
  %163 = load i8, ptr %arrayidx11.us.i696.us, align 1
  %idxprom13.us.i697.us = sext i8 %163 to i64
  %arrayidx14.us.i698.us = getelementptr inbounds [128 x i32], ptr @amino_n, i64 0, i64 %idxprom13.us.i697.us
  %164 = load i32, ptr %arrayidx14.us.i698.us, align 4
  %mul.us.i699.us = shl nsw i32 %164, 2
  %add21.us.i700.us = add i32 %add.us.i695.us, %mul.us.i699.us
  %cmp17.us.i701.us = icmp sgt i32 %164, 3
  %spec.select.i702.us = select i1 %cmp17.us.i701.us, i32 36, i32 %add21.us.i700.us
  %cmp50.us.i703.us = icmp eq i32 %spec.select.i702.us, 36
  %idxprom70.us.i704.us = sext i32 %spec.select.i702.us to i64
  %165 = load double, ptr %arrayidx77.us.i693.us, align 8
  br label %for.body3.us128.i705.us

for.body3.us128.i705.us:                          ; preds = %for.inc.us.i727.us, %for.body3.us128.preheader.i694.us
  %indvars.iv.i706.us = phi i64 [ 0, %for.body3.us128.preheader.i694.us ], [ %indvars.iv.next.i735.us, %for.inc.us.i727.us ]
  %val.1123.us129.i707.us = phi float [ %val.0126.us.i687.us, %for.body3.us128.preheader.i694.us ], [ %val.2.us151.i734.us, %for.inc.us.i727.us ]
  %arrayidx24.us132.i708.us = getelementptr inbounds ptr, ptr %78, i64 %indvars.iv.i706.us
  %166 = load ptr, ptr %arrayidx24.us132.i708.us, align 8
  %arrayidx26.us133.i709.us = getelementptr inbounds i8, ptr %166, i64 %indvars.iv1033
  %167 = load i8, ptr %arrayidx26.us133.i709.us, align 1
  %idxprom28.us134.i710.us = sext i8 %167 to i64
  %arrayidx29.us135.i711.us = getelementptr inbounds [128 x i32], ptr @amino_n, i64 0, i64 %idxprom28.us134.i710.us
  %168 = load i32, ptr %arrayidx29.us135.i711.us, align 4
  %arrayidx33.us136.i712.us = getelementptr inbounds i8, ptr %166, i64 %idxprom32.i680.us
  %169 = load i8, ptr %arrayidx33.us136.i712.us, align 1
  %idxprom35.us137.i713.us = sext i8 %169 to i64
  %arrayidx36.us138.i714.us = getelementptr inbounds [128 x i32], ptr @amino_n, i64 0, i64 %idxprom35.us137.i713.us
  %170 = load i32, ptr %arrayidx36.us138.i714.us, align 4
  %cmp37.us139.i715.us = icmp sgt i32 %168, 3
  br i1 %cmp37.us139.i715.us, label %if.then54.us143.i741.us, label %if.else40.us140.i716.us

if.else40.us140.i716.us:                          ; preds = %for.body3.us128.i705.us
  %cmp41.us141.i717.us = icmp sgt i32 %170, 3
  br i1 %cmp41.us141.i717.us, label %if.then54.us143.i741.us, label %if.end49.us142.i718.us

if.end49.us142.i718.us:                           ; preds = %if.else40.us140.i716.us
  %mul45.us.i719.us = shl nsw i32 %170, 2
  %add46.us.i720.us = add nsw i32 %168, 4
  %add47.us.i721.us = add i32 %add46.us.i720.us, %mul45.us.i719.us
  %cmp52.us.i722.us = icmp eq i32 %add47.us.i721.us, 36
  %or.cond.us.i723.us = select i1 %cmp50.us.i703.us, i1 true, i1 %cmp52.us.i722.us
  br i1 %or.cond.us.i723.us, label %if.then54.us143.i741.us, label %if.else69.us.i724.us

if.else69.us.i724.us:                             ; preds = %if.end49.us142.i718.us
  %idxprom72.us.i725.us = sext i32 %add47.us.i721.us to i64
  %arrayidx73.us.i726.us = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 %idxprom70.us.i704.us, i64 %idxprom72.us.i725.us
  br label %for.inc.us.i727.us

if.then54.us143.i741.us:                          ; preds = %if.end49.us142.i718.us, %if.else40.us140.i716.us, %for.body3.us128.i705.us
  %code1o.1120.us.i742.us = phi i32 [ %162, %if.end49.us142.i718.us ], [ %162, %if.else40.us140.i716.us ], [ 36, %for.body3.us128.i705.us ]
  %idxprom55.us.i743.us = sext i32 %code1o.1120.us.i742.us to i64
  %idxprom57.us144.i744.us = sext i32 %168 to i64
  %arrayidx58.us145.i745.us = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 %idxprom55.us.i743.us, i64 %idxprom57.us144.i744.us
  br label %for.inc.us.i727.us

for.inc.us.i727.us:                               ; preds = %if.then54.us143.i741.us, %if.else69.us.i724.us
  %arrayidx58.us145.sink.i728.us = phi ptr [ %arrayidx58.us145.i745.us, %if.then54.us143.i741.us ], [ %arrayidx73.us.i726.us, %if.else69.us.i724.us ]
  %171 = load i32, ptr %arrayidx58.us145.sink.i728.us, align 4
  %conv59.us146.i729.us = sitofp i32 %171 to float
  %conv60.us147.i730.us = fpext float %conv59.us146.i729.us to double
  %mul63.us148.i731.us = fmul double %165, %conv60.us147.i730.us
  %arrayidx65.us149.i732.us = getelementptr inbounds double, ptr %eff2, i64 %indvars.iv.i706.us
  %172 = load double, ptr %arrayidx65.us149.i732.us, align 8
  %conv67.us150.i733.us = fpext float %val.1123.us129.i707.us to double
  %173 = tail call double @llvm.fmuladd.f64(double %mul63.us148.i731.us, double %172, double %conv67.us150.i733.us)
  %val.2.us151.i734.us = fptrunc double %173 to float
  %indvars.iv.next.i735.us = add nuw nsw i64 %indvars.iv.i706.us, 1
  %exitcond.not.i736.us = icmp eq i64 %indvars.iv.next.i735.us, %wide.trip.count.i683
  br i1 %exitcond.not.i736.us, label %for.cond1.for.inc85_crit_edge.us.i737.us, label %for.body3.us128.i705.us

for.body3.lr.ph.split.us.us.i746.us:              ; preds = %for.cond1.preheader.us.i685.us
  %174 = load double, ptr %arrayidx77.us.i693.us, align 8
  br label %for.body3.us.us.i747.us

for.body3.us.us.i747.us:                          ; preds = %for.body3.us.us.i747.us, %for.body3.lr.ph.split.us.us.i746.us
  %indvars.iv161.i748.us = phi i64 [ %indvars.iv.next162.i762.us, %for.body3.us.us.i747.us ], [ 0, %for.body3.lr.ph.split.us.us.i746.us ]
  %val.1123.us.us.i749.us = phi float [ %val.2.us.us.i761.us, %for.body3.us.us.i747.us ], [ %val.0126.us.i687.us, %for.body3.lr.ph.split.us.us.i746.us ]
  %arrayidx24.us.us.i750.us = getelementptr inbounds ptr, ptr %78, i64 %indvars.iv161.i748.us
  %175 = load ptr, ptr %arrayidx24.us.us.i750.us, align 8
  %arrayidx26.us.us.i751.us = getelementptr inbounds i8, ptr %175, i64 %indvars.iv1033
  %176 = load i8, ptr %arrayidx26.us.us.i751.us, align 1
  %idxprom28.us.us.i752.us = sext i8 %176 to i64
  %arrayidx29.us.us.i753.us = getelementptr inbounds [128 x i32], ptr @amino_n, i64 0, i64 %idxprom28.us.us.i752.us
  %177 = load i32, ptr %arrayidx29.us.us.i753.us, align 4
  %idxprom57.us.us.i754.us = sext i32 %177 to i64
  %arrayidx58.us.us.i755.us = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 36, i64 %idxprom57.us.us.i754.us
  %178 = load i32, ptr %arrayidx58.us.us.i755.us, align 4
  %conv59.us.us.i756.us = sitofp i32 %178 to float
  %conv60.us.us.i757.us = fpext float %conv59.us.us.i756.us to double
  %mul63.us.us.i758.us = fmul double %174, %conv60.us.us.i757.us
  %arrayidx65.us.us.i759.us = getelementptr inbounds double, ptr %eff2, i64 %indvars.iv161.i748.us
  %179 = load double, ptr %arrayidx65.us.us.i759.us, align 8
  %conv67.us.us.i760.us = fpext float %val.1123.us.us.i749.us to double
  %180 = tail call double @llvm.fmuladd.f64(double %mul63.us.us.i758.us, double %179, double %conv67.us.us.i760.us)
  %val.2.us.us.i761.us = fptrunc double %180 to float
  %indvars.iv.next162.i762.us = add nuw nsw i64 %indvars.iv161.i748.us, 1
  %exitcond165.not.i763.us = icmp eq i64 %indvars.iv.next162.i762.us, %wide.trip.count.i683
  br i1 %exitcond165.not.i763.us, label %for.cond1.for.inc85_crit_edge.us.i737.us, label %for.body3.us.us.i747.us

for.cond1.for.inc85_crit_edge.us.i737.us:         ; preds = %for.inc.us.i727.us, %for.body3.us.us.i747.us
  %.us-phi.us.i738.us = phi float [ %val.2.us.us.i761.us, %for.body3.us.us.i747.us ], [ %val.2.us151.i734.us, %for.inc.us.i727.us ]
  %indvars.iv.next167.i739.us = add nuw nsw i64 %indvars.iv166.i686.us, 1
  %exitcond170.not.i740.us = icmp eq i64 %indvars.iv.next167.i739.us, %wide.trip.count169.i682
  br i1 %exitcond170.not.i740.us, label %pairedribosumscore35.exit.us, label %for.cond1.preheader.us.i685.us

pairedribosumscore35.exit.us:                     ; preds = %for.cond1.for.inc85_crit_edge.us.i737.us, %for.cond1.preheader.lr.ph.i675.us, %if.then241.us
  %val.0.lcssa.i674.us = phi float [ 0.000000e+00, %if.then241.us ], [ 0.000000e+00, %for.cond1.preheader.lr.ph.i675.us ], [ %.us-phi.us.i738.us, %for.cond1.for.inc85_crit_edge.us.i737.us ]
  %mul243.us = fmul float %mul.us, %val.0.lcssa.i674.us
  %181 = load float, ptr @consweight_multi, align 4
  %182 = load ptr, ptr %arrayidx246, align 8
  %arrayidx248.us = getelementptr inbounds float, ptr %182, i64 %indvars.iv1033
  %183 = load float, ptr %arrayidx248.us, align 4
  %184 = tail call float @llvm.fmuladd.f32(float %mul243.us, float %181, float %183)
  store float %184, ptr %arrayidx248.us, align 4
...
for.cond1.preheader.lr.ph.i.us:                   ; preds = %if.then223.us
  ...
  br i1 %cmp39786, label %for.cond1.preheader.us.i666.us, label %pairedribosumscore53.exit.us

for.cond1.preheader.us.i666.us:                   ; preds = %for.cond1.preheader.lr.ph.i.us, %for.cond1.for.inc85_crit_edge.us.i.us
  ...
  %arrayidx.us.i667.us = getelementptr inbounds ptr, ptr %77, i64 %indvars.iv166.i.us
  %185 = load ptr, ptr %arrayidx.us.i667.us, align 8
  %arrayidx5.us.i668.us = getelementptr inbounds i8, ptr %185, i64 %indvars.iv1038
  %186 = load i8, ptr %arrayidx5.us.i668.us, align 1
  ...
  %187 = load i32, ptr %arrayidx7.us.i.us, align 4
...
for.body3.us128.preheader.i.us:                   ; preds = %for.cond1.preheader.us.i666.us
  %mul.us.i.us = shl nsw i32 %187, 2
  %add.us.i.us = add nsw i32 %mul.us.i.us, 4
  %arrayidx11.us.i.us = getelementptr inbounds i8, ptr %185, i64 %idxprom10.i678.us
  %188 = load i8, ptr %arrayidx11.us.i.us, align 1
  ...
  %189 = load i32, ptr %arrayidx14.us.i.us, align 4
  ...
  %190 = load double, ptr %arrayidx77.us.i.us, align 8
  br label %for.body3.us128.i.us

for.body3.us128.i.us:                             ; preds = %for.inc.us.i670.us, %for.body3.us128.preheader.i.us
  %indvars.iv.i669.us = phi i64 [ 0, %for.body3.us128.preheader.i.us ], [ %indvars.iv.next.i671.us, %for.inc.us.i670.us ]
  %val.1123.us129.i.us = phi float [ %val.0126.us.i.us, %for.body3.us128.preheader.i.us ], [ %val.2.us151.i.us, %for.inc.us.i670.us ]
  %arrayidx24.us132.i.us = getelementptr inbounds ptr, ptr %78, i64 %indvars.iv.i669.us
  %191 = load ptr, ptr %arrayidx24.us132.i.us, align 8
  %arrayidx26.us133.i.us = getelementptr inbounds i8, ptr %191, i64 %indvars.iv1033
  %192 = load i8, ptr %arrayidx26.us133.i.us, align 1
  ...
  %193 = load i32, ptr %arrayidx29.us135.i.us, align 4
  %arrayidx33.us136.i.us = getelementptr inbounds i8, ptr %191, i64 %idxprom32.i.us
  %194 = load i8, ptr %arrayidx33.us136.i.us, align 1
  ...
  %195 = load i32, ptr %arrayidx36.us138.i.us, align 4
...
for.inc.us.i670.us:                               ; preds = %if.then54.us143.i.us, %if.else69.us.i.us
  %arrayidx58.us145.sink.i.us = phi ptr [ %arrayidx58.us145.i.us, %if.then54.us143.i.us ], [ %arrayidx73.us.i.us, %if.else69.us.i.us ]
  %196 = load i32, ptr %arrayidx58.us145.sink.i.us, align 4
  ...
  %197 = load double, ptr %arrayidx65.us149.i.us, align 8
  ...
  %indvars.iv.next.i671.us = add nuw nsw i64 %indvars.iv.i669.us, 1
  %exitcond.not.i672.us = icmp eq i64 %indvars.iv.next.i671.us, %wide.trip.count.i683
  br i1 %exitcond.not.i672.us, label %for.cond1.for.inc85_crit_edge.us.i.us, label %for.body3.us128.i.us

for.body3.lr.ph.split.us.us.i.us:                 ; preds = %for.cond1.preheader.us.i666.us
  %199 = load double, ptr %arrayidx77.us.i.us, align 8
...
for.body3.us.us.i.us:                             ; preds = %for.body3.us.us.i.us, %for.body3.lr.ph.split.us.us.i.us
  ...
  %200 = load ptr, ptr %arrayidx24.us.us.i.us, align 8
  %arrayidx26.us.us.i.us = getelementptr inbounds i8, ptr %200, i64 %indvars.iv1033
  %201 = load i8, ptr %arrayidx26.us.us.i.us, align 1
  ...
  %202 = load i32, ptr %arrayidx29.us.us.i.us, align 4
  ...
  %203 = load i32, ptr %arrayidx58.us.us.i.us, align 4
  ...
  %204 = load double, ptr %arrayidx65.us.us.i.us, align 8
  ...
  %exitcond165.not.i.us = icmp eq i64 %indvars.iv.next162.i.us, %wide.trip.count.i683
  br i1 %exitcond165.not.i.us, label %for.cond1.for.inc85_crit_edge.us.i.us, label %for.body3.us.us.i.us

for.cond1.for.inc85_crit_edge.us.i.us:            ; preds = %for.inc.us.i670.us, %for.body3.us.us.i.us
  %.us-phi.us.i.us = phi float [ %val.2.us.us.i.us, %for.body3.us.us.i.us ], [ %val.2.us151.i.us, %for.inc.us.i670.us ]
  %indvars.iv.next167.i.us = add nuw nsw i64 %indvars.iv166.i.us, 1
  %exitcond170.not.i.us = icmp eq i64 %indvars.iv.next167.i.us, %wide.trip.count169.i682
  br i1 %exitcond170.not.i.us, label %pairedribosumscore53.exit.us, label %for.cond1.preheader.us.i666.us
...
pairedribosumscore53.exit.us:                     ; preds = %for.cond1.for.inc85_crit_edge.us.i.us, %for.cond1.preheader.lr.ph.i.us, %if.then223.us
  ...
  %206 = load float, ptr @consweight_multi, align 4
  %207 = load ptr, ptr %arrayidx246, align 8
  %arrayidx230.us = getelementptr inbounds float, ptr %207, i64 %indvars.iv1033
  %208 = load float, ptr %arrayidx230.us, align 4
  %209 = tail call float @llvm.fmuladd.f32(float %mul225.us, float %206, float %208)
  store float %209, ptr %arrayidx230.us, align 4
  br label %for.inc257.us.sink.split

for.inc257.us.sink.split:                         ; preds = %pairedribosumscore35.exit.us, %pairedribosumscore53.exit.us
  %210 = load ptr, ptr %arrayidx250, align 8
  %arrayidx252.us = getelementptr inbounds float, ptr %210, i64 %indvars.iv1033
  %211 = load float, ptr %arrayidx252.us, align 4
  %sub.us = fsub float %211, %mul.us
  store float %sub.us, ptr %arrayidx252.us, align 4
  br label %for.inc257.us

for.inc257.us:                                    ; preds = %for.inc257.us.sink.split, %if.else235.us, %for.body208.us
  %incdec.ptr.us = getelementptr inbounds %struct._RNApair, ptr %storemerge630806.us, i64 1
  %bestpos205.us = getelementptr inbounds %struct._RNApair, ptr %storemerge630806.us, i64 1, i32 4
  %212 = load i32, ptr %bestpos205.us, align 4
  %cmp206.not.us = icmp eq i32 %212, -1
  br i1 %cmp206.not.us, label %for.inc259.us, label %for.body208.us

for.inc259.us:                                    ; preds = %for.inc257.us, %for.body201.us
  %storemerge630.lcssa.us = phi ptr [ %153, %for.body201.us ], [ %incdec.ptr.us, %for.inc257.us ]
  %indvars.iv.next1034 = add nuw nsw i64 %indvars.iv1033, 1
  %exitcond1037.not = icmp eq i64 %indvars.iv.next1034, %wide.trip.count1036
  br i1 %exitcond1037.not, label %for.cond198.for.inc262_crit_edge.us, label %for.body201.us

for.cond198.for.inc262_crit_edge.us:              ; preds = %for.inc259.us
  %incdec.ptr263.us = getelementptr inbounds %struct._RNApair, ptr %storemerge811.us, i64 1
  %bestpos194.us = getelementptr inbounds %struct._RNApair, ptr %storemerge811.us, i64 1, i32 4
  %213 = load i32, ptr %bestpos194.us, align 4
  %cmp195.not.us = icmp eq i32 %213, -1
  br i1 %cmp195.not.us, label %for.cond193.for.inc265_crit_edge.split.us, label %for.cond198.preheader.us

for.cond193.for.inc265_crit_edge.split.us:        ; preds = %for.cond198.for.inc262_crit_edge.us
  store ptr %storemerge630.lcssa.us, ptr @foldrna.pairpt2, align 8
  br label %for.inc265

for.cond198.preheader:                            ; preds = %for.cond198.preheader.lr.ph, %for.cond198.preheader
  %storemerge811 = phi ptr [ %incdec.ptr263, %for.cond198.preheader ], [ %149, %for.cond198.preheader.lr.ph ]
  %incdec.ptr263 = getelementptr inbounds %struct._RNApair, ptr %storemerge811, i64 1
  %bestpos194 = getelementptr inbounds %struct._RNApair, ptr %storemerge811, i64 1, i32 4
  %214 = load i32, ptr %bestpos194, align 4
  %cmp195.not = icmp eq i32 %214, -1
  br i1 %cmp195.not, label %for.inc265, label %for.cond198.preheader

for.inc265:                                       ; preds = %for.cond198.preheader, %for.cond193.for.inc265_crit_edge.split.us, %for.body190
  %storemerge.lcssa = phi ptr [ %149, %for.body190 ], [ %incdec.ptr263.us, %for.cond193.for.inc265_crit_edge.split.us ], [ %incdec.ptr263, %for.cond198.preheader ]
  %indvars.iv.next1039 = add nuw nsw i64 %indvars.iv1038, 1
  %exitcond1042.not = icmp eq i64 %indvars.iv.next1039, %wide.trip.count1041
  br i1 %exitcond1042.not, label %for.cond268.preheader, label %for.body190
...
for.cond146.preheader.us.epil:                    ; preds = %if.end294.loopexit.unr-lcssa, %for.cond146.preheader.us.epil
  ...
  %215 = load ptr, ptr %arrayidx151.us.epil, align 8
  tail call void @llvm.memset.p0.i64(ptr align 4 %215, i8 0, i64 %64, i1 false)
  ...
  br i1 %epil.iter.cmp.not, label %if.end294, label %for.cond146.preheader.us.epil
...
for.body298.lr.ph:                                ; preds = %for.cond146.preheader.lr.ph, %for.cond272.preheader.lr.ph, %if.end294
  %216 = load ptr, ptr @foldrna.pairprob1, align 8
...
for.cond373.preheader:                            ; preds = %for.inc370
  store ptr %storemerge631.lcssa, ptr @foldrna.pairpt1, align 8
...
for.body380.us:                                   ; preds = %for.body380.us.prol.loopexit, %for.body380.us
  ...
  br i1 %exitcond1100.not.3, label %for.cond377.for.inc393_crit_edge.us, label %for.body380.us
...
for.cond377.for.inc393_crit_edge.us:              ; preds = %for.body380.us.prol.loopexit, %for.body380.us, %middle.block1190
  ...
  br i1 %exitcond1105.not, label %for.end395, label %for.cond377.preheader.us
...
for.cond301.for.inc370_crit_edge.split.us:        ; preds = %for.cond306.for.inc367_crit_edge.us
  store ptr %.us-phi876.us, ptr @foldrna.pairpt2, align 8
  br label %for.inc370
...
for.cond405.preheader:                            ; preds = %for.body399, %for.end395
  %.pre = load ptr, ptr @foldrna.pairprob2, align 8
...
entry:
  ...
  store ptr %call2, ptr @mccaskillextract.pairnum, align 8
...
for.body16:                                       ; preds = %for.body16.lr.ph, %for.inc107
  ...
  %3 = load i32, ptr %bestpos3, align 4
...
for.cond21:                                       ; preds = %if.end90
  ...
  %4 = load i32, ptr %bestpos, align 4
  %cmp22.not = icmp eq i32 %4, -1
  br i1 %cmp22.not, label %for.inc107, label %for.body24
...
for.body24:                                       ; preds = %for.body16, %for.cond21
  ...
  %9 = load float, ptr %bestscore, align 4
...
for.cond36:                                       ; preds = %for.cond36, %for.body24
  ...
  %11 = load i32, ptr %bestpos37, align 4
  ...
  br i1 %or.cond, label %for.end45, label %for.cond36
...
if.end90:                                         ; preds = %for.end45, %if.then49
  ...
  %15 = load double, ptr %arrayidx93, align 8
  %bestscore95 = getelementptr inbounds %struct._RNApair, ptr %pt2.1, i64 0, i32 5
  %16 = load float, ptr %bestscore95, align 4
  ...
  store float %conv97, ptr %bestscore95, align 4
