...
vector.body566:                                   ; preds = %vector.body566, %vector.ph561
  ...
  %wide.load568 = load <2 x ptr>, ptr %50, align 8, !tbaa !9
  %51 = getelementptr inbounds ptr, ptr %50, i64 2
  %wide.load569 = load <2 x ptr>, ptr %51, align 8, !tbaa !9
  %52 = getelementptr inbounds ptr, ptr %42, i64 %index567
  store <2 x ptr> %wide.load568, ptr %52, align 8, !tbaa !9
  %53 = getelementptr inbounds ptr, ptr %52, i64 2
  store <2 x ptr> %wide.load569, ptr %53, align 8, !tbaa !9
  %index.next570 = add nuw i64 %index567, 4
  %54 = icmp eq i64 %index.next570, %n.vec563
  br i1 %54, label %middle.block558, label %vector.body566, !llvm.loop !17
...
for.body84.prol:                                  ; preds = %for.body84.preheader, %for.body84.prol
  ...
  br i1 %prol.iter640.cmp.not, label %for.body84.prol.loopexit, label %for.body84.prol, !llvm.loop !18
...
if.end124.if.end162_crit_edge:                    ; preds = %if.end124
  %.pre536.pre = load ptr, ptr @Aalign.currentw, align 8, !tbaa !9
  br label %if.end162
...
vector.body579:                                   ; preds = %vector.body579, %vector.ph574
  ...
  %wide.load581 = load <4 x float>, ptr %101, align 4, !tbaa !21
  %102 = getelementptr inbounds float, ptr %101, i64 4
  %wide.load582 = load <4 x float>, ptr %102, align 4, !tbaa !21
  ...
  br i1 %109, label %middle.block571, label %vector.body579, !llvm.loop !23
...
for.cond148.preheader:                            ; preds = %for.body138, %middle.block571, %for.cond134.preheader
  ...
  %.pre536.pre542 = load ptr, ptr @Aalign.currentw, align 8, !tbaa !9
...
vector.body593:                                   ; preds = %vector.body593, %vector.ph587
  ...
  %wide.load596 = load <4 x float>, ptr %113, align 4, !tbaa !21
  %114 = getelementptr inbounds float, ptr %113, i64 4
  %wide.load597 = load <4 x float>, ptr %114, align 4, !tbaa !21
...
for.body138:                                      ; preds = %for.body138.preheader, %for.body138
  ...
  %122 = load float, ptr %arrayidx142, align 4, !tbaa !21
...
for.body152:                                      ; preds = %for.body152.preheader, %for.body152
  ...
  %124 = load float, ptr %arrayidx156, align 4, !tbaa !21
...
for.body167.lr.ph:                                ; preds = %if.end162
  %126 = load ptr, ptr @Aalign.m, align 8, !tbaa !9
  %127 = load ptr, ptr @Aalign.mp, align 8, !tbaa !9
  %128 = add i32 %conv5, 1
...
vector.ph611:                                     ; preds = %vector.memcheck601
  ...
  %131 = load i32, ptr @penalty, align 4, !tbaa !5, !alias.scope !27
...
vector.body616:                                   ; preds = %vector.body616, %vector.ph611
  ...
  %wide.load618 = load <4 x float>, ptr %134, align 4, !tbaa !21, !alias.scope !30
  ...
  store <4 x float> %137, ptr %138, align 4, !tbaa !21, !alias.scope !32, !noalias !30
  %139 = getelementptr inbounds i32, ptr %127, i64 %index617
  store <4 x i32> zeroinitializer, ptr %139, align 4, !tbaa !5, !alias.scope !34, !noalias !27
  %index.next621 = add nuw i64 %index617, 4
  %140 = icmp eq i64 %index.next621, %n.vec613
  br i1 %140, label %middle.block608, label %vector.body616, !llvm.loop !36
...
for.body167.prol:                                 ; preds = %for.body167.preheader
  %141 = add nsw i64 %indvars.iv501.ph, -1
  %arrayidx169.prol = getelementptr inbounds float, ptr %.pre536, i64 %141
  %142 = load float, ptr %arrayidx169.prol, align 4, !tbaa !21
  %conv170.prol = fpext float %142 to double
  %143 = load i32, ptr @penalty, align 4, !tbaa !5
  %conv171.prol = sitofp i32 %143 to double
  %144 = tail call double @llvm.fmuladd.f64(double %conv171.prol, double 5.000000e-01, double %conv170.prol)
  %conv173.prol = fptrunc double %144 to float
...
for.body167.prol.loopexit:                        ; preds = %for.body167.prol, %for.body167.preheader
  ...
  %145 = sub nsw i64 0, %wide.trip.count505
  %146 = xor i64 %indvars.iv501.ph, %145
...
for.body167:                                      ; preds = %for.body167.prol.loopexit, %for.body167
  ...
  %149 = load float, ptr %arrayidx169, align 4, !tbaa !21
  %conv170 = fpext float %149 to double
  %150 = load i32, ptr @penalty, align 4, !tbaa !5
  ...
  %152 = load float, ptr %arrayidx169.1, align 4, !tbaa !21
  %conv170.1 = fpext float %152 to double
  %153 = load i32, ptr @penalty, align 4, !tbaa !5
...
for.end180:                                       ; preds = %if.end162.for.end180_crit_edge, %for.end180.loopexit
  ...
  %156 = load float, ptr %arrayidx183, align 4, !tbaa !21
  %157 = load ptr, ptr @Aalign.lastverticalw, align 8, !tbaa !9
  store float %156, ptr %157, align 4, !tbaa !21
...
for.body192:                                      ; preds = %for.body192.lr.ph, %for.end284
  ...
  %160 = load ptr, ptr @Aalign.initverticalw, align 8, !tbaa !9
  %161 = add nsw i64 %indvars.iv513, -1
  %arrayidx196 = getelementptr inbounds float, ptr %160, i64 %161
  %162 = load float, ptr %arrayidx196, align 4, !tbaa !21
  %163 = load ptr, ptr @Aalign.previousw, align 8, !tbaa !9
  store float %162, ptr %163, align 4, !tbaa !21
  %164 = load ptr, ptr @Aalign.currentw, align 8, !tbaa !9
  %165 = load ptr, ptr @Aalign.cpmx1, align 8, !tbaa !9
  %166 = load ptr, ptr @Aalign.cpmx2, align 8, !tbaa !9
  %167 = load ptr, ptr @Aalign.floatwork, align 8, !tbaa !9
  %168 = load ptr, ptr @Aalign.intwork, align 8, !tbaa !9
  ...
  %170 = load ptr, ptr @Aalign.initverticalw, align 8, !tbaa !9
  %arrayidx199 = getelementptr inbounds float, ptr %170, i64 %indvars.iv513
  %171 = load float, ptr %arrayidx199, align 4, !tbaa !21
  %172 = load ptr, ptr @Aalign.currentw, align 8, !tbaa !9
  store float %171, ptr %172, align 4, !tbaa !21
  %173 = load ptr, ptr @Aalign.previousw, align 8, !tbaa !9
  br i1 %cmp208.not472, label %for.end284, label %for.body210.lr.ph

for.body210.lr.ph:                                ; preds = %for.body192
  %174 = load i32, ptr @penalty, align 4, !tbaa !5
  %conv203 = sitofp i32 %174 to double
  %175 = load float, ptr %173, align 4, !tbaa !21
  ...
  %177 = load ptr, ptr @Aalign.ijp, align 8, !tbaa !9
  %arrayidx215 = getelementptr inbounds ptr, ptr %177, i64 %indvars.iv513
  %178 = load ptr, ptr %arrayidx215, align 8, !tbaa !9
  %179 = load ptr, ptr @Aalign.m, align 8, !tbaa !9
...
if.end231:                                        ; preds = %if.then224, %for.body210
  ...
  %187 = load float, ptr %arrayidx248, align 4, !tbaa !21
...
if.then252:                                       ; preds = %if.end231
  ...
  %188 = load i32, ptr %arrayidx254, align 4, !tbaa !5
...
for.end284:                                       ; preds = %if.end278, %for.body192
  ...
  %190 = load float, ptr %arrayidx287, align 4, !tbaa !21
  %191 = load ptr, ptr @Aalign.lastverticalw, align 8, !tbaa !9
  %arrayidx289 = getelementptr inbounds float, ptr %191, i64 %indvars.iv513
  store float %190, ptr %arrayidx289, align 4, !tbaa !21
...
for.end292:                                       ; preds = %for.end292.loopexit, %for.end180
  ...
  %195 = load ptr, ptr @Aalign.mseq1, align 8, !tbaa !9
  %196 = load ptr, ptr @Aalign.mseq2, align 8, !tbaa !9
  %197 = load ptr, ptr @Aalign.ijp, align 8, !tbaa !9
  %198 = load ptr, ptr %seq1, align 8, !tbaa !9
  %call.i = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %198) #11
  %conv.i = trunc i64 %call.i to i32
  %199 = load ptr, ptr %seq2, align 8, !tbaa !9
...
if.else.i:                                        ; preds = %for.end292
  %200 = load float, ptr %193, align 4, !tbaa !21
...
for.body.i.epil:                                  ; preds = %for.cond19.preheader.i.loopexit.unr-lcssa
  ...
  %202 = load float, ptr %arrayidx8.i.epil, align 4, !tbaa !21
...
if.then11.i.epil:                                 ; preds = %for.body.i.epil
  ...
  %204 = load ptr, ptr %arrayidx16.i, align 8, !tbaa !9
...
for.body.i:                                       ; preds = %for.inc.i.1, %for.body.lr.ph.i.new
  ...
  %206 = load float, ptr %arrayidx8.i, align 4, !tbaa !21
...
if.then11.i:                                      ; preds = %for.body.i
  ...
  %208 = load ptr, ptr %arrayidx16.i, align 8, !tbaa !9
...
for.inc.i:                                        ; preds = %if.then11.i, %for.body.i
  ...
  %209 = load float, ptr %arrayidx8.i.1, align 4, !tbaa !21
...
if.then11.i.1:                                    ; preds = %for.inc.i
  ...
  %211 = load ptr, ptr %arrayidx16.i, align 8, !tbaa !9
...
for.body22.i:                                     ; preds = %for.inc38.i.1, %for.body22.lr.ph.i.new
  ...
  %212 = load float, ptr %arrayidx24.i, align 4, !tbaa !21
...
if.then27.i:                                      ; preds = %for.body22.i
  ...
  %214 = load ptr, ptr %arrayidx34.i, align 8, !tbaa !9
...
for.inc38.i:                                      ; preds = %if.then27.i, %for.body22.i
  ...
  %215 = load float, ptr %arrayidx24.i.1, align 4, !tbaa !21
...
if.then27.i.1:                                    ; preds = %for.inc38.i
  ...
  %217 = load ptr, ptr %arrayidx34.i, align 8, !tbaa !9
...
for.inc38.i.1:                                    ; preds = %if.then27.i.1, %for.inc38.i
  ...
  br i1 %niter650.ncmp.1, label %if.end41.i.loopexit.unr-lcssa, label %for.body22.i, !llvm.loop !41
...
for.body22.i.epil:                                ; preds = %if.end41.i.loopexit.unr-lcssa
  ...
  %218 = load float, ptr %arrayidx24.i.epil, align 4, !tbaa !21
...
if.then27.i.epil:                                 ; preds = %for.body22.i.epil
  ...
  %220 = load ptr, ptr %arrayidx34.i, align 8, !tbaa !9
...
for.body45.i.epil:                                ; preds = %for.cond53.preheader.i.loopexit.unr-lcssa, %for.body45.i.epil
  ...
  %224 = load ptr, ptr %arrayidx48.i.epil, align 8, !tbaa !9
...
for.body57.lr.ph.i:                               ; preds = %for.cond53.preheader.i
  %226 = load ptr, ptr %197, align 8, !tbaa !9
...
vector.body630:                                   ; preds = %vector.body630, %vector.ph625
  ...
  store <4 x i32> %228, ptr %230, align 4, !tbaa !5
  ...
  br i1 %232, label %middle.block622, label %vector.body630, !llvm.loop !43
...
for.body45.i:                                     ; preds = %for.body45.i, %for.body45.preheader.i.new
  ...
  %233 = load ptr, ptr %arrayidx48.i, align 8, !tbaa !9
  ...
  %235 = load ptr, ptr %arrayidx48.i.1, align 8, !tbaa !9
  ...
  %237 = load ptr, ptr %arrayidx48.i.2, align 8, !tbaa !9
  ...
  %239 = load ptr, ptr %arrayidx48.i.3, align 8, !tbaa !9
  ...
  %241 = load ptr, ptr %arrayidx48.i.4, align 8, !tbaa !9
  ...
  %243 = load ptr, ptr %arrayidx48.i.5, align 8, !tbaa !9
  ...
  %245 = load ptr, ptr %arrayidx48.i.6, align 8, !tbaa !9
  %246 = trunc i64 %indvars.iv.next48.i.6 to i32
  store i32 %246, ptr %245, align 4, !tbaa !5
  ...
  %247 = load ptr, ptr %arrayidx48.i.7, align 8, !tbaa !9
  %248 = trunc i64 %indvars.iv.next48.i.7 to i32
  store i32 %248, ptr %247, align 4, !tbaa !5
  %niter654.next.7 = add i64 %niter654, 8
  %niter654.ncmp.7 = icmp eq i64 %niter654.next.7, %unroll_iter653
  br i1 %niter654.ncmp.7, label %for.cond53.preheader.i.loopexit.unr-lcssa, label %for.body45.i, !llvm.loop !44
...
for.body69.i.epil:                                ; preds = %for.cond78.preheader.i.loopexit.unr-lcssa, %for.body69.i.epil
  ...
  %250 = load ptr, ptr %arrayidx72.i.epil, align 8, !tbaa !9
  ...
  br i1 %epil.iter656.cmp.not, label %for.cond78.preheader.i, label %for.body69.i.epil, !llvm.loop !47
...
for.body69.i:                                     ; preds = %for.body69.i, %for.body69.lr.ph.i.new
  ...
  %252 = load ptr, ptr %arrayidx72.i, align 8, !tbaa !9
  ...
  %253 = load ptr, ptr %arrayidx72.i.1, align 8, !tbaa !9
  ...
  %254 = load ptr, ptr %arrayidx72.i.2, align 8, !tbaa !9
  ...
  %255 = load ptr, ptr %arrayidx72.i.3, align 8, !tbaa !9
  ...
  br i1 %niter659.ncmp.3, label %for.cond78.preheader.i.loopexit.unr-lcssa, label %for.body69.i, !llvm.loop !48
...
for.body81.i.epil:                                ; preds = %for.cond92.preheader.i.loopexit.unr-lcssa, %for.body81.i.epil
  ...
  %256 = load ptr, ptr %arrayidx84.i.epil, align 8, !tbaa !9
  ...
  br i1 %epil.iter661.cmp.not, label %for.cond92.preheader.i, label %for.body81.i.epil, !llvm.loop !49
...
for.body81.i:                                     ; preds = %for.body81.i, %for.body81.lr.ph.i.new
  ...
  %265 = load ptr, ptr %arrayidx84.i, align 8, !tbaa !9
  ...
  %266 = load ptr, ptr %arrayidx84.i.1, align 8, !tbaa !9
  ...
  %267 = load ptr, ptr %arrayidx84.i.2, align 8, !tbaa !9
  ...
  %268 = load ptr, ptr %arrayidx84.i.3, align 8, !tbaa !9
  ...
  br i1 %niter664.ncmp.3, label %for.cond92.preheader.i.loopexit.unr-lcssa, label %for.body81.i, !llvm.loop !50
...
for.body133.i.epil:                               ; preds = %for.cond144.preheader.i.loopexit.unr-lcssa
  ...
  %276 = load ptr, ptr %arrayidx135.i.epil, align 8, !tbaa !9
  %arrayidx138.i.epil = getelementptr inbounds i8, ptr %276, i64 %275
  %277 = load i8, ptr %arrayidx138.i.epil, align 1, !tbaa !46
  %arrayidx140.i.epil = getelementptr inbounds ptr, ptr %195, i64 %indvars.iv68.i.unr
  %278 = load ptr, ptr %arrayidx140.i.epil, align 8, !tbaa !9
  ...
  store i8 %277, ptr %incdec.ptr.i.epil, align 1, !tbaa !46
...
for.body133.i:                                    ; preds = %for.body133.lr.ph.i, %for.body133.i
  ...
  br i1 %niter669.ncmp.1, label %for.cond144.preheader.i.loopexit.unr-lcssa, label %for.body133.i, !llvm.loop !51
...
for.body147.i:                                    ; preds = %for.body147.i.preheader, %for.body147.i
  ...
  %285 = load ptr, ptr %arrayidx149.i, align 8, !tbaa !9
  ...
  %286 = load ptr, ptr %arrayidx149.i.1, align 8, !tbaa !9
  ...
  %287 = load ptr, ptr %arrayidx149.i.2, align 8, !tbaa !9
  ...
  %288 = load ptr, ptr %arrayidx149.i.3, align 8, !tbaa !9
  ...
  br i1 %niter674.ncmp.3, label %for.end153.i.loopexit.unr-lcssa, label %for.body147.i, !llvm.loop !52
...
for.body147.i.epil:                               ; preds = %for.end153.i.loopexit.unr-lcssa, %for.body147.i.epil
  ...
  %289 = load ptr, ptr %arrayidx149.i.epil, align 8, !tbaa !9
  ...
  br i1 %epil.iter671.cmp.not, label %for.end153.i, label %for.body147.i.epil, !llvm.loop !53
...
for.body163.i.epil:                               ; preds = %for.cond171.preheader.i.loopexit.unr-lcssa, %for.body163.i.epil
  ...
  %295 = load ptr, ptr %arrayidx166.i.epil, align 8, !tbaa !9
  ...
  br i1 %epil.iter676.cmp.not, label %for.cond171.preheader.i, label %for.body163.i.epil, !llvm.loop !55
...
for.body163.i:                                    ; preds = %for.body163.i.preheader, %for.body163.i
  ...
  %297 = load ptr, ptr %arrayidx166.i, align 8, !tbaa !9
  ...
  %298 = load ptr, ptr %arrayidx166.i.1, align 8, !tbaa !9
  ...
  %299 = load ptr, ptr %arrayidx166.i.2, align 8, !tbaa !9
  ...
  %300 = load ptr, ptr %arrayidx166.i.3, align 8, !tbaa !9
  ...
  br i1 %niter679.ncmp.3, label %for.cond171.preheader.i.loopexit.unr-lcssa, label %for.body163.i, !llvm.loop !56
...
for.body174.i:                                    ; preds = %for.body174.lr.ph.i, %for.body174.i
  ...
  br i1 %niter684.ncmp.1, label %for.end185.i.loopexit.unr-lcssa, label %for.body174.i, !llvm.loop !57
...
for.body174.i.epil:                               ; preds = %for.end185.i.loopexit.unr-lcssa
  ...
  %307 = load ptr, ptr %arrayidx176.i.epil, align 8, !tbaa !9
  %arrayidx179.i.epil = getelementptr inbounds i8, ptr %307, i64 %296
  %308 = load i8, ptr %arrayidx179.i.epil, align 1, !tbaa !46
  %arrayidx181.i.epil = getelementptr inbounds ptr, ptr %196, i64 %indvars.iv87.i.unr
  %309 = load ptr, ptr %arrayidx181.i.epil, align 8, !tbaa !9
  ...
  store i8 %308, ptr %incdec.ptr182.i.epil, align 1, !tbaa !46
...
for.body197.i.epil:                               ; preds = %for.cond208.preheader.i.loopexit.unr-lcssa
  ...
  %311 = load ptr, ptr %arrayidx199.i.epil, align 8, !tbaa !9
  %arrayidx201.i.epil = getelementptr inbounds i8, ptr %311, i64 %idxprom200.i
  %312 = load i8, ptr %arrayidx201.i.epil, align 1, !tbaa !46
  %arrayidx203.i.epil = getelementptr inbounds ptr, ptr %195, i64 %indvars.iv96.i.unr
  %313 = load ptr, ptr %arrayidx203.i.epil, align 8, !tbaa !9
  ...
  store i8 %312, ptr %incdec.ptr204.i.epil, align 1, !tbaa !46
...
for.body197.i:                                    ; preds = %for.body197.lr.ph.i, %for.body197.i
  ...
  br i1 %niter689.ncmp.1, label %for.cond208.preheader.i.loopexit.unr-lcssa, label %for.body197.i, !llvm.loop !59
...
for.body211.i:                                    ; preds = %for.body211.lr.ph.i, %for.body211.i
  ...
  br i1 %niter694.ncmp.1, label %for.end221.i.loopexit.unr-lcssa, label %for.body211.i, !llvm.loop !60
...
for.body211.i.epil:                               ; preds = %for.end221.i.loopexit.unr-lcssa
  ...
  %326 = load ptr, ptr %arrayidx213.i.epil, align 8, !tbaa !9
  %arrayidx215.i.epil = getelementptr inbounds i8, ptr %326, i64 %idxprom214.i
  %327 = load i8, ptr %arrayidx215.i.epil, align 1, !tbaa !46
  %arrayidx217.i.epil = getelementptr inbounds ptr, ptr %196, i64 %indvars.iv101.i.unr
  %328 = load ptr, ptr %arrayidx217.i.epil, align 8, !tbaa !9
  ...
  store i8 %327, ptr %incdec.ptr218.i.epil, align 1, !tbaa !46
...
Atracking.exit:                                   ; preds = %while.end187.i, %for.end221.i, %for.cond92.preheader.i
  %329 = load ptr, ptr %195, align 8, !tbaa !9
...
for.body308.lr.ph:                                ; preds = %if.end304
  %331 = load ptr, ptr @Aalign.mseq1, align 8, !tbaa !9
...
for.body320.lr.ph:                                ; preds = %for.cond317.preheader
  %332 = load ptr, ptr @Aalign.mseq2, align 8, !tbaa !9
...
for.body308:                                      ; preds = %for.body308.lr.ph, %for.body308
  ...
  %333 = load ptr, ptr %arrayidx310, align 8, !tbaa !9
  %arrayidx312 = getelementptr inbounds ptr, ptr %331, i64 %indvars.iv519
  %334 = load ptr, ptr %arrayidx312, align 8, !tbaa !9
...
for.body320:                                      ; preds = %for.body320.lr.ph, %for.body320
  ...
  %335 = load ptr, ptr %arrayidx322, align 8, !tbaa !9
  %arrayidx324 = getelementptr inbounds ptr, ptr %332, i64 %indvars.iv524
  %336 = load ptr, ptr %arrayidx324, align 8, !tbaa !9
