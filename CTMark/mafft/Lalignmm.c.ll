; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/mafft/Lalignmm.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/mafft/Lalignmm.c"
...
entry:
  %0 = load i32, ptr @RNApenalty, align 4
  %conv = sitofp i32 %0 to float
  %1 = load ptr, ptr %seq1, align 8
  %call = tail call i32 @seqlen(ptr noundef %1) #12
  %2 = load ptr, ptr %seq2, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %5 = load ptr, ptr %arrayidx28, align 8
...
for.inc49:                                        ; preds = %for.body38
  ...
  br i1 %exitcond322.not, label %for.end51, label %for.body38
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %16, align 4
  ...
  store <4 x float> %21, ptr %16, align 4
  %22 = getelementptr inbounds float, ptr %call20, i64 %index
  %wide.load355 = load <4 x float>, ptr %22, align 4
  ...
  store <4 x float> %27, ptr %22, align 4
...
vector.body370:                                   ; preds = %vector.body370, %vector.ph365
  ...
  %wide.load372 = load <4 x float>, ptr %30, align 4
  ...
  store <4 x float> %35, ptr %30, align 4
  %36 = getelementptr inbounds float, ptr %call22, i64 %index371
  %wide.load375 = load <4 x float>, ptr %36, align 4
  ...
  store <4 x float> %41, ptr %36, align 4
  %index.next376 = add nuw i64 %index371, 4
  %42 = icmp eq i64 %index.next376, %n.vec367
  br i1 %42, label %middle.block362, label %vector.body370
...
for.body57:                                       ; preds = %for.body57.preheader, %for.body57
  ...
  store float %conv63, ptr %arrayidx59, align 4
  %arrayidx67 = getelementptr inbounds float, ptr %call20, i64 %indvars.iv323
  %44 = load float, ptr %arrayidx67, align 4
  ...
  store float %conv73, ptr %arrayidx67, align 4
  %indvars.iv.next324 = add nuw nsw i64 %indvars.iv323, 1
  %exitcond327.not = icmp eq i64 %indvars.iv.next324, %wide.trip.count326
  br i1 %exitcond327.not, label %for.cond79.preheader, label %for.body57
...
for.body82:                                       ; preds = %for.body82.preheader, %for.body82
  ...
  %45 = load float, ptr %arrayidx84, align 4
  ...
  store float %conv90, ptr %arrayidx84, align 4
  ...
  store float %conv100, ptr %arrayidx94, align 4
  %indvars.iv.next329 = add nuw nsw i64 %indvars.iv328, 1
  %exitcond332.not = icmp eq i64 %indvars.iv.next329, %wide.trip.count331
  br i1 %exitcond332.not, label %for.end105, label %for.body82

for.end105:                                       ; preds = %for.body82, %middle.block362, %for.cond79.preheader
  store ptr %call16, ptr %call14, align 8
  %arrayidx107 = getelementptr inbounds ptr, ptr %call14, i64 1
  store ptr %call20, ptr %arrayidx107, align 8
  %arrayidx108 = getelementptr inbounds ptr, ptr %call14, i64 2
  store ptr %call18, ptr %arrayidx108, align 8
  %arrayidx109 = getelementptr inbounds ptr, ptr %call14, i64 3
  store ptr %call22, ptr %arrayidx109, align 8
  %sub110 = add i32 %conv5, -1
  %sub111 = add i32 %conv8, -1
  %47 = load i32, ptr @reccycle, align 4
  %inc10.i = add nsw i32 %47, 1
  store i32 %inc10.i, ptr @reccycle, align 4
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  br i1 %exitcond218.not.i, label %for.cond29.preheader.i, label %for.body.i
...
for.body32.i:                                     ; preds = %for.inc46.i, %for.body32.lr.ph.i
  ...
  %51 = load ptr, ptr %arrayidx34.i, align 8
...
for.body39.i:                                     ; preds = %for.body32.i, %for.body39.i
  ...
  %52 = load ptr, ptr %arrayidx34.i, align 8
  ...
  br i1 %exitcond219.not.i, label %for.inc46.i, label %for.body39.i
...
for.inc46.i:                                      ; preds = %for.body39.i, %for.body32.i
  ...
  br i1 %exitcond225.not.i, label %MSalignmm_rec.exit, label %for.body32.i
...
vector.body388:                                   ; preds = %vector.body388, %vector.ph383
  ...
  %wide.load390 = load <2 x ptr>, ptr %54, align 8
  %55 = getelementptr inbounds ptr, ptr %54, i64 2
  %wide.load391 = load <2 x ptr>, ptr %55, align 8
  %56 = getelementptr inbounds ptr, ptr %call49.i, i64 %index389
  store <2 x ptr> %wide.load390, ptr %56, align 8
  %57 = getelementptr inbounds ptr, ptr %56, i64 2
  store <2 x ptr> %wide.load391, ptr %57, align 8
  %index.next392 = add nuw i64 %index389, 4
  %58 = icmp eq i64 %index.next392, %n.vec385
  br i1 %58, label %middle.block380, label %vector.body388
...
for.body54.i.prol:                                ; preds = %for.body54.i.preheader, %for.body54.i.prol
  ...
  %61 = load ptr, ptr %arrayidx56.i.prol, align 8
  %arrayidx58.i.prol = getelementptr inbounds ptr, ptr %call49.i, i64 %indvars.iv.i.prol
  store ptr %61, ptr %arrayidx58.i.prol, align 8
  %indvars.iv.next.i.prol = add nuw nsw i64 %indvars.iv.i.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body54.i.prol.loopexit, label %for.body54.i.prol
...
vector.body405:                                   ; preds = %vector.body405, %vector.ph400
  ...
  %wide.load407 = load <2 x ptr>, ptr %64, align 8
  %65 = getelementptr inbounds ptr, ptr %64, i64 2
  %wide.load408 = load <2 x ptr>, ptr %65, align 8
  %66 = getelementptr inbounds ptr, ptr %call50.i, i64 %index406
  store <2 x ptr> %wide.load407, ptr %66, align 8
  %67 = getelementptr inbounds ptr, ptr %66, i64 2
  store <2 x ptr> %wide.load408, ptr %67, align 8
  %index.next409 = add nuw i64 %index406, 4
  %68 = icmp eq i64 %index.next409, %n.vec402
  br i1 %68, label %middle.block397, label %vector.body405
...
for.body65.i.prol:                                ; preds = %for.body65.i.preheader, %for.body65.i.prol
  ...
  %71 = load ptr, ptr %arrayidx67.i.prol, align 8
  %arrayidx69.i.prol = getelementptr inbounds ptr, ptr %call50.i, i64 %indvars.iv97.i.prol
  store ptr %71, ptr %arrayidx69.i.prol, align 8
  ...
  br i1 %prol.iter679.cmp.not, label %for.body65.i.prol.loopexit, label %for.body65.i.prol
...
for.body65.i:                                     ; preds = %for.body65.i.prol.loopexit, %for.body65.i
  ...
  br i1 %exitcond101.not.i.3, label %for.end72.i, label %for.body65.i
...
vector.ph424:                                     ; preds = %vector.memcheck410
  ...
  %84 = load float, ptr %call16, align 4
...
vector.body429:                                   ; preds = %vector.body429, %vector.ph424
  ...
  %wide.load431 = load <4 x float>, ptr %85, align 4
  %86 = getelementptr inbounds float, ptr %85, i64 4
  %wide.load432 = load <4 x float>, ptr %86, align 4
  ...
  %wide.load437 = load <4 x float>, ptr %89, align 4
  %90 = getelementptr inbounds float, ptr %89, i64 4
  %wide.load438 = load <4 x float>, ptr %90, align 4
  %91 = fadd <4 x float> %wide.load437, %87
  %92 = fadd <4 x float> %wide.load438, %88
  store <4 x float> %91, ptr %89, align 4
  store <4 x float> %92, ptr %90, align 4
  %index.next439 = add nuw i64 %index430, 8
  %93 = icmp eq i64 %index.next439, %n.vec426
  br i1 %93, label %middle.block421, label %vector.body429
...
vector.ph455:                                     ; preds = %vector.memcheck440
  ...
  %105 = load float, ptr %call18, align 4
...
vector.body461:                                   ; preds = %vector.body461, %vector.ph455
  ...
  %wide.load464 = load <4 x float>, ptr %106, align 4
  %107 = getelementptr inbounds float, ptr %106, i64 4
  %wide.load465 = load <4 x float>, ptr %107, align 4
  ...
  %wide.load470 = load <4 x float>, ptr %110, align 4
  %111 = getelementptr inbounds float, ptr %110, i64 4
  %wide.load471 = load <4 x float>, ptr %111, align 4
  %112 = fadd <4 x float> %wide.load470, %108
  %113 = fadd <4 x float> %wide.load471, %109
  store <4 x float> %112, ptr %110, align 4
  store <4 x float> %113, ptr %111, align 4
  %index.next472 = add nuw i64 %index462, 8
  %114 = icmp eq i64 %index.next472, %n.vec457
  br i1 %114, label %middle.block452, label %vector.body461
...
for.body145.i:                                    ; preds = %for.body145.i.prol.loopexit, %for.body145.i
  ...
  br i1 %exitcond107.not.i.1, label %for.cond157.preheader.i, label %for.body145.i
...
for.body161.i:                                    ; preds = %for.body161.i.prol.loopexit, %for.body161.i
  ...
  br i1 %exitcond114.not.i.1, label %for.end172.i, label %for.body161.i

for.end172.i:                                     ; preds = %for.body161.i.prol.loopexit, %for.body161.i, %middle.block452
  %137 = load float, ptr %call104.i, align 4
  %138 = load ptr, ptr %call131.i, align 8
...
for.body180.i:                                    ; preds = %for.body180.i, %for.end172.i.new
  ...
  %142 = load float, ptr %arrayidx182.i, align 4
  %arrayidx184.i = getelementptr inbounds ptr, ptr %call131.i, i64 %indvars.iv115.i
  %143 = load ptr, ptr %arrayidx184.i, align 8
  ...
  %144 = load float, ptr %arrayidx182.i.1, align 4
  %arrayidx184.i.1 = getelementptr inbounds ptr, ptr %call131.i, i64 %indvars.iv.next116.i
  %145 = load ptr, ptr %arrayidx184.i.1, align 8
  ...
  %148 = load float, ptr %arrayidx182.i.3, align 4
  %arrayidx184.i.3 = getelementptr inbounds ptr, ptr %call131.i, i64 %indvars.iv.next116.i.2
  %149 = load ptr, ptr %arrayidx184.i.3, align 8
  store float %148, ptr %149, align 4
  %indvars.iv.next116.i.3 = add nuw nsw i64 %indvars.iv115.i, 4
  %niter.next.3 = add i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %for.body193.i.preheader.unr-lcssa, label %for.body180.i
...
for.body180.i.epil:                               ; preds = %for.body193.i.preheader.unr-lcssa, %for.body180.i.epil
  ...
  %150 = load float, ptr %arrayidx182.i.epil, align 4
  %arrayidx184.i.epil = getelementptr inbounds ptr, ptr %call131.i, i64 %indvars.iv115.i.epil
  %151 = load ptr, ptr %arrayidx184.i.epil, align 8
  ...
  br i1 %epil.iter.cmp.not, label %for.body193.i.preheader, label %for.body180.i.epil
...
vector.body485:                                   ; preds = %vector.body485, %vector.ph479
  ...
  %wide.load488 = load <4 x float>, ptr %154, align 4
  %155 = getelementptr inbounds float, ptr %154, i64 4
  %wide.load489 = load <4 x float>, ptr %155, align 4
  %156 = getelementptr inbounds float, ptr %138, i64 %offset.idx487
  store <4 x float> %wide.load488, ptr %156, align 4
  %157 = getelementptr inbounds float, ptr %156, i64 4
  store <4 x float> %wide.load489, ptr %157, align 4
  %index.next490 = add nuw i64 %index486, 8
  %158 = icmp eq i64 %index.next490, %n.vec481
  br i1 %158, label %middle.block476, label %vector.body485
...
for.body193.i.prol:                               ; preds = %for.body193.i.preheader674, %for.body193.i.prol
  ...
  %162 = load float, ptr %arrayidx195.i.prol, align 4
  %arrayidx198.i.prol = getelementptr inbounds float, ptr %138, i64 %indvars.iv122.i.prol
  store float %162, ptr %arrayidx198.i.prol, align 4
  ...
  br i1 %prol.iter690.cmp.not, label %for.body193.i.prol.loopexit, label %for.body193.i.prol
...
vector.ph506:                                     ; preds = %vector.memcheck491
  ...
  %167 = load float, ptr %arrayidx210.i, align 4
...
vector.body512:                                   ; preds = %vector.body512, %vector.ph506
  ...
  %wide.load515 = load <4 x float>, ptr %168, align 4
  %169 = getelementptr inbounds float, ptr %168, i64 4
  %wide.load516 = load <4 x float>, ptr %169, align 4
  ...
  store <4 x float> %170, ptr %172, align 4
  ...
  store <4 x i32> zeroinitializer, ptr %174, align 4
  %175 = getelementptr inbounds i32, ptr %174, i64 4
  store <4 x i32> zeroinitializer, ptr %175, align 4
  %index.next521 = add nuw i64 %index513, 8
  %176 = icmp eq i64 %index.next521, %n.vec508
  br i1 %176, label %middle.block503, label %vector.body512
...
for.body193.i:                                    ; preds = %for.body193.i.prol.loopexit, %for.body193.i
  ...
  %186 = load float, ptr %arrayidx195.i.2, align 4
  %arrayidx198.i.2 = getelementptr inbounds float, ptr %138, i64 %indvars.iv.next123.i.1
  store float %186, ptr %arrayidx198.i.2, align 4
  ...
  %187 = load float, ptr %arrayidx195.i.3, align 4
  %arrayidx198.i.3 = getelementptr inbounds float, ptr %138, i64 %indvars.iv.next123.i.2
  store float %187, ptr %arrayidx198.i.3, align 4
  ...
  br i1 %exitcond127.not.i.3, label %for.body206.lr.ph.i, label %for.body193.i
...
for.body206.i:                                    ; preds = %for.body206.i.prol.loopexit, %for.body206.i
  ...
  br i1 %exitcond134.not.i.1, label %for.end218.i, label %for.body206.i
...
for.end218.i:                                     ; preds = %for.body206.i.prol.loopexit, %for.body206.i, %middle.block503
  ...
  %193 = load float, ptr %arrayidx221.i, align 4
  store float %193, ptr %call106.i, align 4
...
for.body229.i:                                    ; preds = %for.end321.i, %for.end218.i
  ...
  %196 = load float, ptr %arrayidx232.i, align 4
  store float %196, ptr %currentw.030.i, align 4
  ...
  %198 = load float, ptr %arrayidx239.i, align 4
  store float %198, ptr %previousw.029.i, align 4
  %arrayidx242.i = getelementptr inbounds float, ptr %call16, i64 %indvars.iv149.i
  %199 = load float, ptr %arrayidx242.i, align 4
  store float %199, ptr %call108.i, align 4
  %cmp244.i = icmp eq i64 %indvars.iv149.i, %194
  br i1 %cmp244.i, label %if.end249.i, label %if.end249.thread.i

if.end249.i:                                      ; preds = %for.body229.i
  store float %199, ptr %call90.i, align 4
  %200 = load float, ptr %currentw.030.i, align 4
  %201 = load float, ptr %arrayidx251.i, align 4
  %add252.i = fadd float %200, %201
  %arrayidx279.i = getelementptr inbounds float, ptr %call20, i64 %195
  %202 = load ptr, ptr %arrayidx295.i, align 8
  %203 = load ptr, ptr %arrayidx299.i, align 8
  %204 = trunc i64 %195 to i32
  br label %for.body260.us.i

if.end249.thread.i:                               ; preds = %for.body229.i
  %205 = load float, ptr %currentw.030.i, align 4
  %206 = load float, ptr %arrayidx251.i, align 4
  ...
  %207 = load ptr, ptr %arrayidx295231.i, align 8
  %arrayidx299232.i = getelementptr inbounds ptr, ptr %call132.i, i64 %indvars.iv149.i
  %208 = load ptr, ptr %arrayidx299232.i, align 8
...
for.body260.us.i:                                 ; preds = %if.end292.us.i, %if.end249.i
  ...
  %213 = load float, ptr %arrayidx270.us.i, align 4
  ...
  %215 = load float, ptr %mjpt.027.us.i, align 4
  %216 = load float, ptr %arrayidx279.i, align 4
  ...
  %217 = load float, ptr %arrayidx242.i, align 4
...
for.body260.us.if.end292.us_crit_edge.i:          ; preds = %for.body260.us.i
  %.pre.i = load i32, ptr %mpjpt.026.us.i, align 4
  br label %if.end292.us.i

if.then290.us.i:                                  ; preds = %for.body260.us.i
  store float %add287.us.i, ptr %mjpt.027.us.i, align 4
  store i32 %204, ptr %mpjpt.026.us.i, align 4
  br label %if.end292.us.i
...
if.end292.us.i:                                   ; preds = %if.then290.us.i, %for.body260.us.if.end292.us_crit_edge.i
  ...
  %219 = load float, ptr %curpt.025.us.i, align 4
  %add293.us.i = fadd float %wm.1.us.i, %219
  store float %add293.us.i, ptr %curpt.025.us.i, align 4
  ...
  %221 = load float, ptr %curpt.025.us.i, align 4
  %arrayidx310.us.i = getelementptr inbounds float, ptr %call86.i, i64 %indvars.iv142.i
  store float %221, ptr %arrayidx310.us.i, align 4
  %222 = load float, ptr %mjpt.027.us.i, align 4
  %arrayidx312.us.i = getelementptr inbounds float, ptr %call90.i, i64 %indvars.iv142.i
  store float %222, ptr %arrayidx312.us.i, align 4
  ...
  br i1 %exitcond148.not.i, label %for.end321.i, label %for.body260.us.i

for.body260.i:                                    ; preds = %if.end292.i, %if.end249.thread.i
  %indvars.iv135.i = phi i64 [ 1, %if.end249.thread.i ], [ %indvars.iv.next136.i, %if.end292.i ]
  %mjpt.027.i = phi ptr [ %mjpt.019.i, %if.end249.thread.i ], [ %mjpt.0.i, %if.end292.i ]
  %mpjpt.026.i = phi ptr [ %mpjpt.018.i, %if.end249.thread.i ], [ %mpjpt.0.i, %if.end292.i ]
  %previousw.029.pn.i = phi ptr [ %previousw.029.i, %if.end249.thread.i ], [ %curpt.025.i, %if.end292.i ]
  %prept.022.i = phi ptr [ %currentw.030.i, %if.end249.thread.i ], [ %incdec.ptr316.i, %if.end292.i ]
  %mi.021.i = phi float [ %add252229.i, %if.end249.thread.i ], [ %mi.1.i, %if.end292.i ]
  %curpt.025.i = getelementptr inbounds float, ptr %previousw.029.pn.i, i64 1
  %223 = load float, ptr %prept.022.i, align 4
  %224 = add nsw i64 %indvars.iv135.i, -1
  %arrayidx263.i = getelementptr inbounds float, ptr %call22, i64 %224
  %225 = load float, ptr %arrayidx263.i, align 4
  ...
  %226 = load float, ptr %arrayidx270.i, align 4
  ...
  %227 = load float, ptr %mjpt.027.i, align 4
  %228 = load float, ptr %arrayidx279230.i, align 4
  %add280.i = fadd float %227, %228
  %cmp281.i = fcmp ogt float %add280.i, %wm.0.i
  %wm.1.i = select i1 %cmp281.i, float %add280.i, float %wm.0.i
  %229 = load float, ptr %arrayidx242.i, align 4
...
if.then290.i:                                     ; preds = %for.body260.i
  store float %add287.i, ptr %mjpt.027.i, align 4
  store i32 %209, ptr %mpjpt.026.i, align 4
  br label %if.end292.i

if.end292.i:                                      ; preds = %if.then290.i, %for.body260.i
  %230 = load float, ptr %curpt.025.i, align 4
  %add293.i = fadd float %wm.1.i, %230
  store float %add293.i, ptr %curpt.025.i, align 4
  %arrayidx297.i = getelementptr inbounds float, ptr %207, i64 %indvars.iv135.i
  store float %add293.i, ptr %arrayidx297.i, align 4
  %231 = load float, ptr %mjpt.027.i, align 4
  %arrayidx301.i = getelementptr inbounds float, ptr %208, i64 %indvars.iv135.i
  store float %231, ptr %arrayidx301.i, align 4
  ...
  br i1 %exitcond141.not.i, label %for.end321.i, label %for.body260.i
...
for.end321.i:                                     ; preds = %if.end292.i, %if.end292.us.i
  ...
  %233 = load float, ptr %arrayidx324.i, align 4
  %arrayidx326.i = getelementptr inbounds float, ptr %call106.i, i64 %indvars.iv149.i
  store float %233, ptr %arrayidx326.i, align 4
  %234 = load float, ptr %arrayidx329.i, align 4
  %arrayidx333.i = getelementptr inbounds float, ptr %232, i64 %idxprom332.i
  store float %234, ptr %arrayidx333.i, align 4
  %indvars.iv.next150.i = add nuw nsw i64 %indvars.iv149.i, 1
  %exitcond155.not.i = icmp eq i64 %indvars.iv.next150.i, %wide.trip.count106.i
  br i1 %exitcond155.not.i, label %for.end336.i, label %for.body229.i
...
vector.ph536:                                     ; preds = %vector.memcheck522
  ...
  %237 = load float, ptr %arrayidx354.i, align 4
...
vector.body541:                                   ; preds = %vector.body541, %vector.ph536
  ...
  %wide.load543 = load <4 x float>, ptr %239, align 4
  %240 = getelementptr inbounds float, ptr %239, i64 4
  %wide.load544 = load <4 x float>, ptr %240, align 4
  ...
  %wide.load549 = load <4 x float>, ptr %243, align 4
  %244 = getelementptr inbounds float, ptr %243, i64 4
  %wide.load550 = load <4 x float>, ptr %244, align 4
  %245 = fadd <4 x float> %wide.load549, %241
  %246 = fadd <4 x float> %wide.load550, %242
  store <4 x float> %245, ptr %243, align 4
  store <4 x float> %246, ptr %244, align 4
  %index.next551 = add nuw i64 %index542, 8
  %247 = icmp eq i64 %index.next551, %n.vec538
  br i1 %247, label %middle.block533, label %vector.body541

middle.block533:                                  ; preds = %vector.body541
  %cmp.n540 = icmp eq i64 %n.vec538, %idxprom353.i
  br i1 %cmp.n540, label %for.body369.lr.ph.i, label %for.body351.i.preheader
...
for.body351.i.prol:                               ; preds = %for.body351.i.preheader
  %249 = load float, ptr %arrayidx354.i, align 4
...
for.body351.i.prol.loopexit:                      ; preds = %for.body351.i.prol, %for.body351.i.preheader
  ...
  br i1 %253, label %for.body369.lr.ph.i, label %for.body351.i

for.body369.lr.ph.i:                              ; preds = %for.body351.i.prol.loopexit, %for.body351.i, %middle.block533
...
vector.memcheck552:                               ; preds = %for.body369.lr.ph.i
...
vector.ph567:                                     ; preds = %vector.memcheck552
  ...
  %258 = load float, ptr %arrayidx372.i, align 4
...
vector.body572:                                   ; preds = %vector.body572, %vector.ph567
  ...
  %wide.load574 = load <4 x float>, ptr %260, align 4
  %261 = getelementptr inbounds float, ptr %260, i64 4
  %wide.load575 = load <4 x float>, ptr %261, align 4
  ...
  %wide.load580 = load <4 x float>, ptr %264, align 4
  %265 = getelementptr inbounds float, ptr %264, i64 4
  %wide.load581 = load <4 x float>, ptr %265, align 4
  %266 = fadd <4 x float> %wide.load580, %262
  %267 = fadd <4 x float> %wide.load581, %263
  store <4 x float> %266, ptr %264, align 4
  store <4 x float> %267, ptr %265, align 4
  %index.next582 = add nuw i64 %index573, 8
  %268 = icmp eq i64 %index.next582, %n.vec569
  br i1 %268, label %middle.block564, label %vector.body572
...
for.body369.i.preheader:                          ; preds = %vector.memcheck552, %for.body369.lr.ph.i, %middle.block564
  %indvars.iv161.i.ph = phi i64 [ 0, %vector.memcheck552 ], [ 0, %for.body369.lr.ph.i ], [ %n.vec569, %middle.block564 ]
...
for.body369.i.prol:                               ; preds = %for.body369.i.preheader
  %270 = load float, ptr %arrayidx372.i, align 4
  ...
  %271 = load float, ptr %arrayidx375.i.prol, align 4
  ...
  %272 = load float, ptr %arrayidx378.i.prol, align 4
  %add379.i.prol = fadd float %272, %add376.i.prol
  store float %add379.i.prol, ptr %arrayidx378.i.prol, align 4
...
for.body387.i.epil:                               ; preds = %for.body408.lr.ph.i.unr-lcssa
  %288 = load float, ptr %arrayidx354.i, align 4
...
for.body408.lr.ph.i:                              ; preds = %for.body408.lr.ph.i.unr-lcssa, %for.body387.i.epil
  ...
  %292 = load ptr, ptr %arrayidx418.i, align 8
...
vector.ph598:                                     ; preds = %vector.memcheck583
  ...
  %297 = load float, ptr %arrayidx372.i, align 4
...
vector.body603:                                   ; preds = %vector.body603, %vector.ph598
  ...
  %wide.load605 = load <4 x float>, ptr %299, align 4
  %300 = getelementptr inbounds float, ptr %299, i64 4
  %wide.load606 = load <4 x float>, ptr %300, align 4
  ...
  %wide.load611 = load <4 x float>, ptr %303, align 4
  %304 = getelementptr inbounds float, ptr %303, i64 4
  %wide.load612 = load <4 x float>, ptr %304, align 4
  %305 = fadd <4 x float> %301, %wide.load611
  %306 = fadd <4 x float> %302, %wide.load612
  store <4 x float> %305, ptr %303, align 4
  store <4 x float> %306, ptr %304, align 4
  %index.next613 = add nuw i64 %index604, 8
  %307 = icmp eq i64 %index.next613, %n.vec600
  br i1 %307, label %middle.block595, label %vector.body603
...
for.body408.i.prol:                               ; preds = %for.body408.i.preheader
  %309 = load float, ptr %arrayidx372.i, align 4
...
for.body387.i:                                    ; preds = %for.body387.i, %for.body387.i.preheader.new
  ...
  %314 = load float, ptr %arrayidx354.i, align 4
  ...
  %315 = load float, ptr %arrayidx393.i, align 4
  %add394.i = fadd float %314, %315
  %arrayidx396.i = getelementptr inbounds ptr, ptr %call131.i, i64 %indvars.iv166.i
  %316 = load ptr, ptr %arrayidx396.i, align 8
  %arrayidx399.i = getelementptr inbounds float, ptr %316, i64 %idxprom220.i
  %317 = load float, ptr %arrayidx399.i, align 4
  %add400.i = fadd float %add394.i, %317
  store float %add400.i, ptr %arrayidx399.i, align 4
  %318 = load float, ptr %arrayidx354.i, align 4
...
vector.ph633:                                     ; preds = %vector.memcheck615
  ...
  %339 = load float, ptr %arrayidx434.i, align 4
...
vector.body639:                                   ; preds = %vector.body639, %vector.ph633
  ...
  %wide.load642 = load <4 x float>, ptr %gep, align 4
  ...
  store <4 x float> %reverse645, ptr %gep730, align 4
  %gep732 = getelementptr i32, ptr %invariant.gep731, i64 %offset.idx641
  store <4 x i32> %broadcast.splat647, ptr %gep732, align 4
  %index.next649 = add nuw i64 %index640, 4
  %343 = icmp eq i64 %index.next649, %n.vec635
  br i1 %343, label %middle.block630, label %vector.body639
...
for.body429.i:                                    ; preds = %for.body429.i.preheader, %for.body429.i
  ...
  %354 = load float, ptr %arrayidx431.i, align 4
  %355 = load float, ptr %arrayidx434.i, align 4
  ...
  store float %add435.i, ptr %arrayidx438.i, align 4
  %arrayidx441.i = getelementptr inbounds i32, ptr %call110.i, i64 %indvars.iv176.i
  store i32 %sub110, ptr %arrayidx441.i, align 4
  %cmp427.i = icmp ugt i64 %indvars.iv176.i, 1
  br i1 %cmp427.i, label %for.body429.i, label %for.body449.lr.ph.i

for.cond682.preheader.preheader.i:                ; preds = %for.inc675.i
...
for.body449.i:                                    ; preds = %for.inc675.i, %for.body449.lr.ph.i
  ...
  %356 = load float, ptr %arrayidx452.i, align 4
  %arrayidx455.i = getelementptr inbounds float, ptr %currentw.173.i, i64 %idxprom220.i
  store float %356, ptr %arrayidx455.i, align 4
  ...
  %357 = load float, ptr %arrayidx461.i, align 4
  %arrayidx464.i = getelementptr inbounds float, ptr %previousw.172.i, i64 %idxprom220.i
  store float %357, ptr %arrayidx464.i, align 4
  ...
  %358 = load float, ptr %arrayidx455.i, align 4
  %359 = load float, ptr %arrayidx434.i, align 4
  ...
  %361 = load ptr, ptr %arrayidx558.i, align 8
  %arrayidx563.i = getelementptr inbounds ptr, ptr %call132.i, i64 %idxprom460.i
  %362 = load ptr, ptr %arrayidx563.i, align 8
...
for.body489.i:                                    ; preds = %if.end556.i, %for.body449.i
  ...
  %368 = load float, ptr %arrayidx502.i, align 4
  ...
  %369 = load float, ptr %mjpt.148.i, align 4
  %370 = load float, ptr %arrayidx511.i, align 4
...
if.then515.i:                                     ; preds = %for.body489.i
  %371 = load i32, ptr %mpjpt.150.i, align 4
...
if.end517.i:                                      ; preds = %if.then515.i, %for.body489.i
  ...
  %372 = load float, ptr %arrayidx519.i, align 4
...
if.then523.i:                                     ; preds = %if.end517.i
  store float %add520.i, ptr %mjpt.148.i, align 4
  store i32 %363, ptr %mpjpt.150.i, align 4
...
if.then532.i:                                     ; preds = %if.end525.i
  ...
  store i32 %ijpi.1.i, ptr %arrayidx534.i, align 4
  %arrayidx536.i = getelementptr inbounds i32, ptr %call98.i, i64 %indvars.iv179.i
  store i32 %ijpj.1.i, ptr %arrayidx536.i, align 4
...
if.then540.i:                                     ; preds = %if.end537.i
  ...
  %373 = load float, ptr %arrayidx542.i, align 4
  %add543.i = fadd float %wm.3.i, %373
  store float %add543.i, ptr %arrayidx542.i, align 4
  %374 = load float, ptr %mjpt.148.i, align 4
  %arrayidx546.i = getelementptr inbounds float, ptr %call90.i, i64 %365
  %375 = load float, ptr %arrayidx546.i, align 4
  %add547.i = fadd float %374, %375
  store float %add547.i, ptr %arrayidx546.i, align 4
...
if.then552.i:                                     ; preds = %if.end548.i
  ...
  %376 = load float, ptr %arrayidx554.i, align 4
  %add555.i = fadd float %mi.3.i, %376
  store float %add555.i, ptr %arrayidx554.i, align 4
...
if.end556.i:                                      ; preds = %if.then552.i, %if.end548.i
  ...
  %377 = load float, ptr %arrayidx560.i, align 4
  %add561.i = fadd float %wm.3.i, %377
  store float %add561.i, ptr %arrayidx560.i, align 4
  %378 = load float, ptr %curpt.147.i, align 4
  %arrayidx565.i = getelementptr inbounds float, ptr %362, i64 %indvars.iv179.i
  %379 = load float, ptr %arrayidx565.i, align 4
  %add566.i = fadd float %378, %379
  store float %add566.i, ptr %arrayidx565.i, align 4
  %380 = load float, ptr %curpt.147.i, align 4
  %add567.i = fadd float %wm.3.i, %380
  store float %add567.i, ptr %curpt.147.i, align 4
  ...
  br i1 %cmp487.i, label %for.body489.i, label %for.end574.i.loopexit

for.end574.i.loopexit:                            ; preds = %if.end556.i
  %381 = load float, ptr %prept.1.i, align 4
  %382 = load float, ptr %arrayidx519.i, align 4
...
if.then585.i:                                     ; preds = %for.end574.i.loopexit
  %383 = load float, ptr %call90.i, align 4
  %add589.i = fadd float %firstm.1.i, %383
  store float %add589.i, ptr %call90.i, align 4
  br label %if.end590.i

if.end590.i:                                      ; preds = %if.then585.i, %for.end574.i.loopexit
  %sub591.i = add nsw i32 %imid.077.i, -1
  br i1 %cmp530.i, label %if.then594.i, label %if.end654.i

if.then594.i:                                     ; preds = %if.end590.i
  %384 = load float, ptr %arrayidx595.i, align 4
...
for.body600.i:                                    ; preds = %if.then594.i, %for.body600.i
  ...
  %385 = load float, ptr %arrayidx602.i, align 4
  ...
  %387 = load float, ptr %arrayidx602.i.1, align 4
  ...
  br i1 %niter714.ncmp.1, label %for.body614.i.preheader.unr-lcssa, label %for.body600.i
...
for.body600.i.epil:                               ; preds = %for.body614.i.preheader.unr-lcssa
  ...
  %389 = load float, ptr %arrayidx602.i.epil, align 4
...
for.body614.i.preheader:                          ; preds = %for.body614.i.preheader.unr-lcssa, %for.body600.i.epil
  ...
  br i1 %353, label %for.end623.i.loopexit.unr-lcssa, label %for.body614.i
...
for.body614.i:                                    ; preds = %for.body614.i.preheader, %for.body614.i
  ...
  %391 = load float, ptr %arrayidx616.i, align 4
  ...
  %393 = load float, ptr %arrayidx616.i.1, align 4
  ...
  br i1 %niter721.ncmp.1, label %for.end623.i.loopexit.unr-lcssa, label %for.body614.i

for.end623.i.loopexit.unr-lcssa:                  ; preds = %for.body614.i, %for.body614.i.preheader
  ...
  br i1 %lcmp.mod717.not, label %for.end623.i.loopexit, label %for.body614.i.epil

for.body614.i.epil:                               ; preds = %for.end623.i.loopexit.unr-lcssa
  %arrayidx616.i.epil = getelementptr inbounds float, ptr %call90.i, i64 %indvars.iv190.i.unr
  %395 = load float, ptr %arrayidx616.i.epil, align 4
  ...
  br label %for.end623.i.loopexit

for.end623.i.loopexit:                            ; preds = %for.end623.i.loopexit.unr-lcssa, %for.body614.i.epil
  %maxwm.4.i.lcssa = phi float [ %maxwm.4.i.lcssa.ph, %for.end623.i.loopexit.unr-lcssa ], [ %maxwm.4.i.epil, %for.body614.i.epil ]
  %jmid.4.i.lcssa = phi i32 [ %jmid.4.i.lcssa.ph, %for.end623.i.loopexit.unr-lcssa ], [ %jmid.4.i.epil, %for.body614.i.epil ]
  %idxprom624.i = sext i32 %jmid.4.i.lcssa to i64
  %arrayidx625.i = getelementptr inbounds float, ptr %call86.i, i64 %idxprom624.i
  %397 = load float, ptr %arrayidx625.i, align 4
...
if.then635.i:                                     ; preds = %land.lhs.true.i
  ...
  %399 = load i32, ptr %arrayidx638.i, align 4
  br label %if.end642.i

if.end642.i:                                      ; preds = %if.then635.i, %land.lhs.true.i, %for.end623.i.loopexit
  %wm.4.i = phi float [ %398, %if.then635.i ], [ %397, %land.lhs.true.i ], [ %397, %for.end623.i.loopexit ]
  %jumpj.1.i = phi i32 [ %399, %if.then635.i ], [ %sub627.i, %land.lhs.true.i ], [ %sub627.i, %for.end623.i.loopexit ]
  %arrayidx644.i = getelementptr inbounds float, ptr %call90.i, i64 %idxprom624.i
  %400 = load float, ptr %arrayidx644.i, align 4
...
if.then647.i:                                     ; preds = %if.end642.i
  ...
  %401 = load i32, ptr %arrayidx649.i, align 4
...
if.else667.i:                                     ; preds = %if.else.i
  ...
  %402 = load i32, ptr %arrayidx669.i, align 4
  %arrayidx671.i = getelementptr inbounds i32, ptr %call98.i, i64 %idxprom668.i
  %403 = load i32, ptr %arrayidx671.i, align 4
  br label %for.inc675.i
...
for.inc675.i:                                     ; preds = %if.else667.i, %if.else.i, %if.then660.i, %if.end654.i
  ...
  br i1 %cmp447.i, label %for.body449.i, label %for.cond682.preheader.preheader.i

for.cond682.preheader.i:                          ; preds = %for.cond682.for.inc697_crit_edge.i, %for.cond682.preheader.preheader.i
  %indvars.iv207.i = phi i64 [ 0, %for.cond682.preheader.preheader.i ], [ %indvars.iv.next208.i, %for.cond682.for.inc697_crit_edge.i ]
  %arrayidx687.i = getelementptr inbounds ptr, ptr %call131.i, i64 %indvars.iv207.i
  %404 = load ptr, ptr %arrayidx687.i, align 8
  %arrayidx691.i = getelementptr inbounds ptr, ptr %map, i64 %indvars.iv207.i
  %405 = load ptr, ptr %arrayidx691.i, align 8
...
for.body685.i.prol:                               ; preds = %for.body685.i.preheader, %for.body685.i.prol
  ...
  br i1 %prol.iter724.cmp.not, label %for.body685.i.prol.loopexit, label %for.body685.i.prol
...
for.body685.i:                                    ; preds = %for.body685.i.prol.loopexit, %for.body685.i
  ...
  br i1 %exitcond206.not.i.3, label %for.cond682.for.inc697_crit_edge.i, label %for.body685.i
...
for.cond682.for.inc697_crit_edge.i:               ; preds = %for.body685.i.prol.loopexit, %for.body685.i, %middle.block652
  ...
  br i1 %exitcond212.not.i, label %for.end699.i, label %for.cond682.preheader.i
...
for.body122:                                      ; preds = %for.body122.lr.ph, %for.inc133
  ...
  %424 = load ptr, ptr %arrayidx124, align 8
...
for.inc133:                                       ; preds = %for.body122
  ...
  br i1 %exitcond338.not, label %for.cond136.preheader, label %for.body122
...
for.body139:                                      ; preds = %for.body139.lr.ph, %for.inc150
  ...
  %429 = load ptr, ptr %arrayidx141, align 8
...
for.inc150:                                       ; preds = %for.body139
  ...
  br i1 %exitcond343.not, label %for.end152, label %for.body139
...
for.inc46.i:                                      ; preds = %for.body39.i, %for.body32.i
  %indvars.iv.next221.i = add nuw nsw i64 %indvars.iv220.i, 1
  %exitcond225.not.i = icmp eq i64 %indvars.iv.next221.i, %wide.trip.count224.i
  br i1 %exitcond225.not.i, label %MSalign2m2m_rec.exit, label %for.body32.i
...
for.cond1.preheader:                              ; preds = %for.cond1.preheader.preheader, %for.end
  %indvars.iv119 = phi i64 [ 0, %for.cond1.preheader.preheader ], [ %indvars.iv.next120, %for.end ]
  %arrayidx = getelementptr inbounds ptr, ptr %cpmx2, i64 %indvars.iv119
  %0 = load ptr, ptr %arrayidx, align 8
  %arrayidx13 = getelementptr inbounds ptr, ptr %floatwork, i64 %indvars.iv119
  %arrayidx17 = getelementptr inbounds ptr, ptr %intwork, i64 %indvars.iv119
  br label %for.body3

for.body3:                                        ; preds = %for.cond1.preheader, %for.inc
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next, %for.inc ]
  %count.0104 = phi i32 [ 0, %for.cond1.preheader ], [ %count.1, %for.inc ]
...
for.end:                                          ; preds = %for.inc
  ...
  br i1 %exitcond122.not, label %if.end28, label %for.cond1.preheader

if.end28:                                         ; preds = %for.end, %entry
  %6 = load i32, ptr @RNAthr, align 4
  ...
  %arrayidx44.12.phi.trans.insert = getelementptr inbounds float, ptr %7, i64 12
  %.pre = load float, ptr %arrayidx44.12.phi.trans.insert, align 4
  %arrayidx44.13.phi.trans.insert = getelementptr inbounds float, ptr %7, i64 13
  %.pre134 = load float, ptr %arrayidx44.13.phi.trans.insert, align 4
  %8 = load float, ptr %7, align 4
  %arrayidx44.1 = getelementptr inbounds float, ptr %7, i64 1
  %9 = load float, ptr %arrayidx44.1, align 4
  %arrayidx44.2 = getelementptr inbounds float, ptr %7, i64 2
  %10 = load float, ptr %arrayidx44.2, align 4
  %arrayidx44.3 = getelementptr inbounds float, ptr %7, i64 3
  %11 = load float, ptr %arrayidx44.3, align 4
  %arrayidx44.4 = getelementptr inbounds float, ptr %7, i64 4
  %12 = load float, ptr %arrayidx44.4, align 4
  %arrayidx44.5 = getelementptr inbounds float, ptr %7, i64 5
  %13 = load float, ptr %arrayidx44.5, align 4
  %arrayidx44.6 = getelementptr inbounds float, ptr %7, i64 6
  %14 = load float, ptr %arrayidx44.6, align 4
  %arrayidx44.7 = getelementptr inbounds float, ptr %7, i64 7
  %15 = load float, ptr %arrayidx44.7, align 4
  %arrayidx44.8 = getelementptr inbounds float, ptr %7, i64 8
  %16 = load float, ptr %arrayidx44.8, align 4
  %arrayidx44.9 = getelementptr inbounds float, ptr %7, i64 9
  %17 = load float, ptr %arrayidx44.9, align 4
  %arrayidx44.10 = getelementptr inbounds float, ptr %7, i64 10
  %18 = load float, ptr %arrayidx44.10, align 4
  %arrayidx44.11 = getelementptr inbounds float, ptr %7, i64 11
  %19 = load float, ptr %arrayidx44.11, align 4
  %arrayidx44.14 = getelementptr inbounds float, ptr %7, i64 14
  %20 = load float, ptr %arrayidx44.14, align 4
  %arrayidx44.15 = getelementptr inbounds float, ptr %7, i64 15
  %21 = load float, ptr %arrayidx44.15, align 4
  %arrayidx44.16 = getelementptr inbounds float, ptr %7, i64 16
  %22 = load float, ptr %arrayidx44.16, align 4
  %arrayidx44.17 = getelementptr inbounds float, ptr %7, i64 17
  %23 = load float, ptr %arrayidx44.17, align 4
  %arrayidx44.18 = getelementptr inbounds float, ptr %7, i64 18
  %24 = load float, ptr %arrayidx44.18, align 4
  %arrayidx44.19 = getelementptr inbounds float, ptr %7, i64 19
  %25 = load float, ptr %arrayidx44.19, align 4
  %arrayidx44.20 = getelementptr inbounds float, ptr %7, i64 20
  %26 = load float, ptr %arrayidx44.20, align 4
  %arrayidx44.21 = getelementptr inbounds float, ptr %7, i64 21
  %27 = load float, ptr %arrayidx44.21, align 4
  %arrayidx44.22 = getelementptr inbounds float, ptr %7, i64 22
  %28 = load float, ptr %arrayidx44.22, align 4
  %arrayidx44.23 = getelementptr inbounds float, ptr %7, i64 23
  %29 = load float, ptr %arrayidx44.23, align 4
  %arrayidx44.24 = getelementptr inbounds float, ptr %7, i64 24
  %30 = load float, ptr %arrayidx44.24, align 4
  %arrayidx44.25 = getelementptr inbounds float, ptr %7, i64 25
  %31 = load float, ptr %arrayidx44.25, align 4
  %broadcast.splatinsert = insertelement <4 x i32> poison, i32 %6, i64 0
  %broadcast.splat = shufflevector <4 x i32> %broadcast.splatinsert, <4 x i32> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert135 = insertelement <4 x float> poison, float %8, i64 0
  %broadcast.splat136 = shufflevector <4 x float> %broadcast.splatinsert135, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert138 = insertelement <4 x float> poison, float %9, i64 0
  %broadcast.splat139 = shufflevector <4 x float> %broadcast.splatinsert138, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert141 = insertelement <4 x float> poison, float %10, i64 0
...
vector.body:                                      ; preds = %vector.body, %if.end28
  ...
  %32 = getelementptr inbounds [26 x float], ptr %scarr, i64 0, i64 %index
  %33 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 0, i64 %index
  %wide.load = load <4 x i32>, ptr %33, align 16
  %34 = sub nsw <4 x i32> %wide.load, %broadcast.splat
  %35 = sitofp <4 x i32> %34 to <4 x float>
  %36 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %35, <4 x float> %broadcast.splat136, <4 x float> zeroinitializer)
  %37 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 1, i64 %index
  %wide.load137 = load <4 x i32>, ptr %37, align 8
  %38 = sub nsw <4 x i32> %wide.load137, %broadcast.splat
  %39 = sitofp <4 x i32> %38 to <4 x float>
  %40 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %39, <4 x float> %broadcast.splat139, <4 x float> %36)
  %41 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 2, i64 %index
  %wide.load140 = load <4 x i32>, ptr %41, align 16
  %42 = sub nsw <4 x i32> %wide.load140, %broadcast.splat
  %43 = sitofp <4 x i32> %42 to <4 x float>
  %44 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %43, <4 x float> %broadcast.splat142, <4 x float> %40)
  %45 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 3, i64 %index
  %wide.load143 = load <4 x i32>, ptr %45, align 8
  %46 = sub nsw <4 x i32> %wide.load143, %broadcast.splat
  %47 = sitofp <4 x i32> %46 to <4 x float>
  %48 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %47, <4 x float> %broadcast.splat145, <4 x float> %44)
  %49 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 4, i64 %index
  %wide.load146 = load <4 x i32>, ptr %49, align 16
  %50 = sub nsw <4 x i32> %wide.load146, %broadcast.splat
  %51 = sitofp <4 x i32> %50 to <4 x float>
  %52 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %51, <4 x float> %broadcast.splat148, <4 x float> %48)
  %53 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 5, i64 %index
  %wide.load149 = load <4 x i32>, ptr %53, align 8
  %54 = sub nsw <4 x i32> %wide.load149, %broadcast.splat
  %55 = sitofp <4 x i32> %54 to <4 x float>
  %56 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %55, <4 x float> %broadcast.splat151, <4 x float> %52)
  %57 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 6, i64 %index
  %wide.load152 = load <4 x i32>, ptr %57, align 16
  %58 = sub nsw <4 x i32> %wide.load152, %broadcast.splat
  %59 = sitofp <4 x i32> %58 to <4 x float>
  %60 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %59, <4 x float> %broadcast.splat154, <4 x float> %56)
  %61 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 7, i64 %index
  %wide.load155 = load <4 x i32>, ptr %61, align 8
  %62 = sub nsw <4 x i32> %wide.load155, %broadcast.splat
  %63 = sitofp <4 x i32> %62 to <4 x float>
  %64 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %63, <4 x float> %broadcast.splat157, <4 x float> %60)
  %65 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 8, i64 %index
  %wide.load158 = load <4 x i32>, ptr %65, align 16
  %66 = sub nsw <4 x i32> %wide.load158, %broadcast.splat
  %67 = sitofp <4 x i32> %66 to <4 x float>
  %68 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %67, <4 x float> %broadcast.splat160, <4 x float> %64)
  %69 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 9, i64 %index
  %wide.load161 = load <4 x i32>, ptr %69, align 8
  %70 = sub nsw <4 x i32> %wide.load161, %broadcast.splat
  %71 = sitofp <4 x i32> %70 to <4 x float>
  %72 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %71, <4 x float> %broadcast.splat163, <4 x float> %68)
  %73 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 10, i64 %index
  %wide.load164 = load <4 x i32>, ptr %73, align 16
  %74 = sub nsw <4 x i32> %wide.load164, %broadcast.splat
  %75 = sitofp <4 x i32> %74 to <4 x float>
  %76 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %75, <4 x float> %broadcast.splat166, <4 x float> %72)
  %77 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 11, i64 %index
  %wide.load167 = load <4 x i32>, ptr %77, align 8
  %78 = sub nsw <4 x i32> %wide.load167, %broadcast.splat
  %79 = sitofp <4 x i32> %78 to <4 x float>
  %80 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %79, <4 x float> %broadcast.splat169, <4 x float> %76)
  %81 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 12, i64 %index
  %wide.load170 = load <4 x i32>, ptr %81, align 16
  %82 = sub nsw <4 x i32> %wide.load170, %broadcast.splat
  %83 = sitofp <4 x i32> %82 to <4 x float>
  %84 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %83, <4 x float> %broadcast.splat172, <4 x float> %80)
  %85 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 13, i64 %index
  %wide.load173 = load <4 x i32>, ptr %85, align 8
  %86 = sub nsw <4 x i32> %wide.load173, %broadcast.splat
  %87 = sitofp <4 x i32> %86 to <4 x float>
  %88 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %87, <4 x float> %broadcast.splat175, <4 x float> %84)
  %89 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 14, i64 %index
  %wide.load176 = load <4 x i32>, ptr %89, align 16
  %90 = sub nsw <4 x i32> %wide.load176, %broadcast.splat
  %91 = sitofp <4 x i32> %90 to <4 x float>
  %92 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %91, <4 x float> %broadcast.splat178, <4 x float> %88)
  %93 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 15, i64 %index
  %wide.load179 = load <4 x i32>, ptr %93, align 8
  %94 = sub nsw <4 x i32> %wide.load179, %broadcast.splat
  %95 = sitofp <4 x i32> %94 to <4 x float>
  %96 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %95, <4 x float> %broadcast.splat181, <4 x float> %92)
  %97 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 16, i64 %index
  %wide.load182 = load <4 x i32>, ptr %97, align 16
  %98 = sub nsw <4 x i32> %wide.load182, %broadcast.splat
  %99 = sitofp <4 x i32> %98 to <4 x float>
  %100 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %99, <4 x float> %broadcast.splat184, <4 x float> %96)
  %101 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 17, i64 %index
  %wide.load185 = load <4 x i32>, ptr %101, align 8
  %102 = sub nsw <4 x i32> %wide.load185, %broadcast.splat
  %103 = sitofp <4 x i32> %102 to <4 x float>
  %104 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %103, <4 x float> %broadcast.splat187, <4 x float> %100)
  %105 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 18, i64 %index
  %wide.load188 = load <4 x i32>, ptr %105, align 16
  %106 = sub nsw <4 x i32> %wide.load188, %broadcast.splat
  %107 = sitofp <4 x i32> %106 to <4 x float>
  %108 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %107, <4 x float> %broadcast.splat190, <4 x float> %104)
  %109 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 19, i64 %index
  %wide.load191 = load <4 x i32>, ptr %109, align 8
  %110 = sub nsw <4 x i32> %wide.load191, %broadcast.splat
  %111 = sitofp <4 x i32> %110 to <4 x float>
  %112 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %111, <4 x float> %broadcast.splat193, <4 x float> %108)
  %113 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 20, i64 %index
  %wide.load194 = load <4 x i32>, ptr %113, align 16
  %114 = sub nsw <4 x i32> %wide.load194, %broadcast.splat
  %115 = sitofp <4 x i32> %114 to <4 x float>
  %116 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %115, <4 x float> %broadcast.splat196, <4 x float> %112)
  %117 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 21, i64 %index
  %wide.load197 = load <4 x i32>, ptr %117, align 8
  %118 = sub nsw <4 x i32> %wide.load197, %broadcast.splat
  %119 = sitofp <4 x i32> %118 to <4 x float>
  %120 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %119, <4 x float> %broadcast.splat199, <4 x float> %116)
  %121 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 22, i64 %index
  %wide.load200 = load <4 x i32>, ptr %121, align 16
  %122 = sub nsw <4 x i32> %wide.load200, %broadcast.splat
  %123 = sitofp <4 x i32> %122 to <4 x float>
  %124 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %123, <4 x float> %broadcast.splat202, <4 x float> %120)
  %125 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 23, i64 %index
  %wide.load203 = load <4 x i32>, ptr %125, align 8
  %126 = sub nsw <4 x i32> %wide.load203, %broadcast.splat
  %127 = sitofp <4 x i32> %126 to <4 x float>
  %128 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %127, <4 x float> %broadcast.splat205, <4 x float> %124)
  %129 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 24, i64 %index
  %wide.load206 = load <4 x i32>, ptr %129, align 16
  %130 = sub nsw <4 x i32> %wide.load206, %broadcast.splat
  %131 = sitofp <4 x i32> %130 to <4 x float>
  %132 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %131, <4 x float> %broadcast.splat208, <4 x float> %128)
  %133 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 25, i64 %index
  %wide.load209 = load <4 x i32>, ptr %133, align 8
  %134 = sub nsw <4 x i32> %wide.load209, %broadcast.splat
  %135 = sitofp <4 x i32> %134 to <4 x float>
  %136 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %135, <4 x float> %broadcast.splat211, <4 x float> %132)
  store <4 x float> %136, ptr %32, align 16
  %index.next = add nuw i64 %index, 4
  %137 = icmp eq i64 %index.next, 24
  br i1 %137, label %for.body31, label %vector.body

while.cond.preheader:                             ; preds = %for.body31
  %tobool53.not113 = icmp eq i32 %lgth2, 0
  br i1 %tobool53.not113, label %while.end, label %while.body

for.body31:                                       ; preds = %vector.body, %for.body31
  %indvars.iv127 = phi i64 [ %indvars.iv.next128, %for.body31 ], [ 24, %vector.body ]
  %arrayidx33 = getelementptr inbounds [26 x float], ptr %scarr, i64 0, i64 %indvars.iv127
  %arrayidx40 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 0, i64 %indvars.iv127
  %138 = load i32, ptr %arrayidx40, align 4
  %sub = sub nsw i32 %138, %6
  %conv = sitofp i32 %sub to float
  %139 = tail call float @llvm.fmuladd.f32(float %conv, float %8, float 0.000000e+00)
  %arrayidx40.1 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 1, i64 %indvars.iv127
  %140 = load i32, ptr %arrayidx40.1, align 4
  %sub.1 = sub nsw i32 %140, %6
  %conv.1 = sitofp i32 %sub.1 to float
  %141 = tail call float @llvm.fmuladd.f32(float %conv.1, float %9, float %139)
  %arrayidx40.2 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 2, i64 %indvars.iv127
  %142 = load i32, ptr %arrayidx40.2, align 4
  %sub.2 = sub nsw i32 %142, %6
  %conv.2 = sitofp i32 %sub.2 to float
  %143 = tail call float @llvm.fmuladd.f32(float %conv.2, float %10, float %141)
  %arrayidx40.3 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 3, i64 %indvars.iv127
  %144 = load i32, ptr %arrayidx40.3, align 4
  %sub.3 = sub nsw i32 %144, %6
  %conv.3 = sitofp i32 %sub.3 to float
  %145 = tail call float @llvm.fmuladd.f32(float %conv.3, float %11, float %143)
  %arrayidx40.4 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 4, i64 %indvars.iv127
  %146 = load i32, ptr %arrayidx40.4, align 4
  %sub.4 = sub nsw i32 %146, %6
  %conv.4 = sitofp i32 %sub.4 to float
  %147 = tail call float @llvm.fmuladd.f32(float %conv.4, float %12, float %145)
  %arrayidx40.5 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 5, i64 %indvars.iv127
  %148 = load i32, ptr %arrayidx40.5, align 4
  %sub.5 = sub nsw i32 %148, %6
  %conv.5 = sitofp i32 %sub.5 to float
  %149 = tail call float @llvm.fmuladd.f32(float %conv.5, float %13, float %147)
  %arrayidx40.6 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 6, i64 %indvars.iv127
  %150 = load i32, ptr %arrayidx40.6, align 4
  %sub.6 = sub nsw i32 %150, %6
  %conv.6 = sitofp i32 %sub.6 to float
  %151 = tail call float @llvm.fmuladd.f32(float %conv.6, float %14, float %149)
  %arrayidx40.7 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 7, i64 %indvars.iv127
  %152 = load i32, ptr %arrayidx40.7, align 4
  %sub.7 = sub nsw i32 %152, %6
  %conv.7 = sitofp i32 %sub.7 to float
  %153 = tail call float @llvm.fmuladd.f32(float %conv.7, float %15, float %151)
  %arrayidx40.8 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 8, i64 %indvars.iv127
  %154 = load i32, ptr %arrayidx40.8, align 4
  %sub.8 = sub nsw i32 %154, %6
  %conv.8 = sitofp i32 %sub.8 to float
  %155 = tail call float @llvm.fmuladd.f32(float %conv.8, float %16, float %153)
  %arrayidx40.9 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 9, i64 %indvars.iv127
  %156 = load i32, ptr %arrayidx40.9, align 4
  %sub.9 = sub nsw i32 %156, %6
  %conv.9 = sitofp i32 %sub.9 to float
  %157 = tail call float @llvm.fmuladd.f32(float %conv.9, float %17, float %155)
  %arrayidx40.10 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 10, i64 %indvars.iv127
  %158 = load i32, ptr %arrayidx40.10, align 4
  %sub.10 = sub nsw i32 %158, %6
  %conv.10 = sitofp i32 %sub.10 to float
  %159 = tail call float @llvm.fmuladd.f32(float %conv.10, float %18, float %157)
  %arrayidx40.11 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 11, i64 %indvars.iv127
  %160 = load i32, ptr %arrayidx40.11, align 4
  %sub.11 = sub nsw i32 %160, %6
  %conv.11 = sitofp i32 %sub.11 to float
  %161 = tail call float @llvm.fmuladd.f32(float %conv.11, float %19, float %159)
  %arrayidx40.12 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 12, i64 %indvars.iv127
  %162 = load i32, ptr %arrayidx40.12, align 4
  %sub.12 = sub nsw i32 %162, %6
  %conv.12 = sitofp i32 %sub.12 to float
  %163 = tail call float @llvm.fmuladd.f32(float %conv.12, float %.pre, float %161)
  %arrayidx40.13 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 13, i64 %indvars.iv127
  %164 = load i32, ptr %arrayidx40.13, align 4
  %sub.13 = sub nsw i32 %164, %6
  %conv.13 = sitofp i32 %sub.13 to float
  %165 = tail call float @llvm.fmuladd.f32(float %conv.13, float %.pre134, float %163)
  %arrayidx40.14 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 14, i64 %indvars.iv127
  %166 = load i32, ptr %arrayidx40.14, align 4
  %sub.14 = sub nsw i32 %166, %6
  %conv.14 = sitofp i32 %sub.14 to float
  %167 = tail call float @llvm.fmuladd.f32(float %conv.14, float %20, float %165)
  %arrayidx40.15 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 15, i64 %indvars.iv127
  %168 = load i32, ptr %arrayidx40.15, align 4
  %sub.15 = sub nsw i32 %168, %6
  %conv.15 = sitofp i32 %sub.15 to float
  %169 = tail call float @llvm.fmuladd.f32(float %conv.15, float %21, float %167)
  %arrayidx40.16 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 16, i64 %indvars.iv127
  %170 = load i32, ptr %arrayidx40.16, align 4
  %sub.16 = sub nsw i32 %170, %6
  %conv.16 = sitofp i32 %sub.16 to float
  %171 = tail call float @llvm.fmuladd.f32(float %conv.16, float %22, float %169)
  %arrayidx40.17 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 17, i64 %indvars.iv127
  %172 = load i32, ptr %arrayidx40.17, align 4
  %sub.17 = sub nsw i32 %172, %6
  %conv.17 = sitofp i32 %sub.17 to float
  %173 = tail call float @llvm.fmuladd.f32(float %conv.17, float %23, float %171)
  %arrayidx40.18 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 18, i64 %indvars.iv127
  %174 = load i32, ptr %arrayidx40.18, align 4
  %sub.18 = sub nsw i32 %174, %6
  %conv.18 = sitofp i32 %sub.18 to float
  %175 = tail call float @llvm.fmuladd.f32(float %conv.18, float %24, float %173)
  %arrayidx40.19 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 19, i64 %indvars.iv127
  %176 = load i32, ptr %arrayidx40.19, align 4
  %sub.19 = sub nsw i32 %176, %6
  %conv.19 = sitofp i32 %sub.19 to float
  %177 = tail call float @llvm.fmuladd.f32(float %conv.19, float %25, float %175)
  %arrayidx40.20 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 20, i64 %indvars.iv127
  %178 = load i32, ptr %arrayidx40.20, align 4
  %sub.20 = sub nsw i32 %178, %6
  %conv.20 = sitofp i32 %sub.20 to float
  %179 = tail call float @llvm.fmuladd.f32(float %conv.20, float %26, float %177)
  %arrayidx40.21 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 21, i64 %indvars.iv127
  %180 = load i32, ptr %arrayidx40.21, align 4
  %sub.21 = sub nsw i32 %180, %6
  %conv.21 = sitofp i32 %sub.21 to float
  %181 = tail call float @llvm.fmuladd.f32(float %conv.21, float %27, float %179)
  %arrayidx40.22 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 22, i64 %indvars.iv127
  %182 = load i32, ptr %arrayidx40.22, align 4
  %sub.22 = sub nsw i32 %182, %6
  %conv.22 = sitofp i32 %sub.22 to float
  %183 = tail call float @llvm.fmuladd.f32(float %conv.22, float %28, float %181)
  %arrayidx40.23 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 23, i64 %indvars.iv127
  %184 = load i32, ptr %arrayidx40.23, align 4
  %sub.23 = sub nsw i32 %184, %6
  %conv.23 = sitofp i32 %sub.23 to float
  %185 = tail call float @llvm.fmuladd.f32(float %conv.23, float %29, float %183)
  %arrayidx40.24 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 24, i64 %indvars.iv127
  %186 = load i32, ptr %arrayidx40.24, align 4
  %sub.24 = sub nsw i32 %186, %6
  %conv.24 = sitofp i32 %sub.24 to float
  %187 = tail call float @llvm.fmuladd.f32(float %conv.24, float %30, float %185)
  %arrayidx40.25 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 25, i64 %indvars.iv127
  %188 = load i32, ptr %arrayidx40.25, align 4
  %sub.25 = sub nsw i32 %188, %6
  %conv.25 = sitofp i32 %sub.25 to float
  %189 = tail call float @llvm.fmuladd.f32(float %conv.25, float %31, float %187)
  store float %189, ptr %arrayidx33, align 4
  %indvars.iv.next128 = add nuw nsw i64 %indvars.iv127, 1
  %exitcond130.not = icmp eq i64 %indvars.iv.next128, 26
  br i1 %exitcond130.not, label %while.cond.preheader, label %for.body31

while.body:                                       ; preds = %while.cond.preheader, %for.end66
  %dec117.in = phi i32 [ %dec117, %for.end66 ], [ %lgth2, %while.cond.preheader ]
  %cpmxpdnpt.0116 = phi ptr [ %incdec.ptr67, %for.end66 ], [ %intwork, %while.cond.preheader ]
  %cpmxpdpt.0115 = phi ptr [ %incdec.ptr68, %for.end66 ], [ %floatwork, %while.cond.preheader ]
  %matchpt.0114 = phi ptr [ %incdec.ptr, %for.end66 ], [ %match, %while.cond.preheader ]
  %dec117 = add nsw i32 %dec117.in, -1
  store float 0.000000e+00, ptr %matchpt.0114, align 4
  %190 = load ptr, ptr %cpmxpdnpt.0116, align 8
  %191 = load i32, ptr %190, align 4
  %cmp57109 = icmp sgt i32 %191, -1
  br i1 %cmp57109, label %for.body59.lr.ph, label %for.end66

for.body59.lr.ph:                                 ; preds = %while.body
  %192 = load ptr, ptr %cpmxpdpt.0115, align 8
  br label %for.body59

for.body59:                                       ; preds = %for.body59.lr.ph, %for.body59
  %indvars.iv131 = phi i64 [ 0, %for.body59.lr.ph ], [ %indvars.iv.next132, %for.body59 ]
  %193 = phi float [ 0.000000e+00, %for.body59.lr.ph ], [ %197, %for.body59 ]
  %194 = phi i32 [ %191, %for.body59.lr.ph ], [ %198, %for.body59 ]
  %idxprom60 = zext i32 %194 to i64
  %arrayidx61 = getelementptr inbounds [26 x float], ptr %scarr, i64 0, i64 %idxprom60
  %195 = load float, ptr %arrayidx61, align 4
  %arrayidx63 = getelementptr inbounds float, ptr %192, i64 %indvars.iv131
  %196 = load float, ptr %arrayidx63, align 4
  %197 = tail call float @llvm.fmuladd.f32(float %195, float %196, float %193)
  store float %197, ptr %matchpt.0114, align 4
  %indvars.iv.next132 = add nuw nsw i64 %indvars.iv131, 1
  %arrayidx56 = getelementptr inbounds i32, ptr %190, i64 %indvars.iv.next132
  %198 = load i32, ptr %arrayidx56, align 4
  %cmp57 = icmp sgt i32 %198, -1
  br i1 %cmp57, label %for.body59, label %for.end66

for.end66:                                        ; preds = %for.body59, %while.body
  %incdec.ptr = getelementptr inbounds float, ptr %matchpt.0114, i64 1
  %incdec.ptr67 = getelementptr inbounds ptr, ptr %cpmxpdnpt.0116, i64 1
  %incdec.ptr68 = getelementptr inbounds ptr, ptr %cpmxpdpt.0115, i64 1
  %tobool53.not = icmp eq i32 %dec117, 0
  br i1 %tobool53.not, label %while.end, label %while.body
...
if.end28:                                         ; preds = %for.end, %entry
  ...
  %arrayidx44.1 = getelementptr inbounds float, ptr %6, i64 1
  %8 = load float, ptr %arrayidx44.1, align 4
  %arrayidx44.2 = getelementptr inbounds float, ptr %6, i64 2
  %9 = load float, ptr %arrayidx44.2, align 4
  %arrayidx44.3 = getelementptr inbounds float, ptr %6, i64 3
  %10 = load float, ptr %arrayidx44.3, align 4
  %arrayidx44.4 = getelementptr inbounds float, ptr %6, i64 4
  %11 = load float, ptr %arrayidx44.4, align 4
  %arrayidx44.5 = getelementptr inbounds float, ptr %6, i64 5
  %12 = load float, ptr %arrayidx44.5, align 4
  %arrayidx44.6 = getelementptr inbounds float, ptr %6, i64 6
  %13 = load float, ptr %arrayidx44.6, align 4
  %arrayidx44.7 = getelementptr inbounds float, ptr %6, i64 7
  %14 = load float, ptr %arrayidx44.7, align 4
  %arrayidx44.8 = getelementptr inbounds float, ptr %6, i64 8
  %15 = load float, ptr %arrayidx44.8, align 4
  %arrayidx44.9 = getelementptr inbounds float, ptr %6, i64 9
  %16 = load float, ptr %arrayidx44.9, align 4
  %arrayidx44.10 = getelementptr inbounds float, ptr %6, i64 10
  %17 = load float, ptr %arrayidx44.10, align 4
  %arrayidx44.11 = getelementptr inbounds float, ptr %6, i64 11
  %18 = load float, ptr %arrayidx44.11, align 4
  %arrayidx44.12 = getelementptr inbounds float, ptr %6, i64 12
  %19 = load float, ptr %arrayidx44.12, align 4
  %arrayidx44.13 = getelementptr inbounds float, ptr %6, i64 13
  %20 = load float, ptr %arrayidx44.13, align 4
  %arrayidx44.14 = getelementptr inbounds float, ptr %6, i64 14
  %21 = load float, ptr %arrayidx44.14, align 4
  %arrayidx44.15 = getelementptr inbounds float, ptr %6, i64 15
  %22 = load float, ptr %arrayidx44.15, align 4
  %arrayidx44.16 = getelementptr inbounds float, ptr %6, i64 16
  %23 = load float, ptr %arrayidx44.16, align 4
  %arrayidx44.17 = getelementptr inbounds float, ptr %6, i64 17
  %24 = load float, ptr %arrayidx44.17, align 4
  %arrayidx44.18 = getelementptr inbounds float, ptr %6, i64 18
  %25 = load float, ptr %arrayidx44.18, align 4
  %arrayidx44.19 = getelementptr inbounds float, ptr %6, i64 19
  %26 = load float, ptr %arrayidx44.19, align 4
  %arrayidx44.20 = getelementptr inbounds float, ptr %6, i64 20
  %27 = load float, ptr %arrayidx44.20, align 4
  %arrayidx44.21 = getelementptr inbounds float, ptr %6, i64 21
  %28 = load float, ptr %arrayidx44.21, align 4
  %arrayidx44.22 = getelementptr inbounds float, ptr %6, i64 22
  %29 = load float, ptr %arrayidx44.22, align 4
  %arrayidx44.23 = getelementptr inbounds float, ptr %6, i64 23
  %30 = load float, ptr %arrayidx44.23, align 4
  %arrayidx44.24 = getelementptr inbounds float, ptr %6, i64 24
  %31 = load float, ptr %arrayidx44.24, align 4
  %arrayidx44.25 = getelementptr inbounds float, ptr %6, i64 25
  %32 = load float, ptr %arrayidx44.25, align 4
  %arrayidx44.26 = getelementptr inbounds float, ptr %6, i64 26
  %33 = load float, ptr %arrayidx44.26, align 4
  %arrayidx44.27 = getelementptr inbounds float, ptr %6, i64 27
  %34 = load float, ptr %arrayidx44.27, align 4
  %arrayidx44.28 = getelementptr inbounds float, ptr %6, i64 28
  %35 = load float, ptr %arrayidx44.28, align 4
  %arrayidx44.29 = getelementptr inbounds float, ptr %6, i64 29
  %36 = load float, ptr %arrayidx44.29, align 4
  %arrayidx44.30 = getelementptr inbounds float, ptr %6, i64 30
  %37 = load float, ptr %arrayidx44.30, align 4
  %arrayidx44.31 = getelementptr inbounds float, ptr %6, i64 31
  %38 = load float, ptr %arrayidx44.31, align 4
  %arrayidx44.32 = getelementptr inbounds float, ptr %6, i64 32
  %39 = load float, ptr %arrayidx44.32, align 4
  %arrayidx44.33 = getelementptr inbounds float, ptr %6, i64 33
  %40 = load float, ptr %arrayidx44.33, align 4
  %arrayidx44.34 = getelementptr inbounds float, ptr %6, i64 34
  %41 = load float, ptr %arrayidx44.34, align 4
  %arrayidx44.35 = getelementptr inbounds float, ptr %6, i64 35
  %42 = load float, ptr %arrayidx44.35, align 4
  %arrayidx44.36 = getelementptr inbounds float, ptr %6, i64 36
  %43 = load float, ptr %arrayidx44.36, align 4
  ...
  %broadcast.splatinsert168 = insertelement <4 x float> poison, float %19, i64 0
  %broadcast.splat169 = shufflevector <4 x float> %broadcast.splatinsert168, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert171 = insertelement <4 x float> poison, float %20, i64 0
  %broadcast.splat172 = shufflevector <4 x float> %broadcast.splatinsert171, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert174 = insertelement <4 x float> poison, float %21, i64 0
  %broadcast.splat175 = shufflevector <4 x float> %broadcast.splatinsert174, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert177 = insertelement <4 x float> poison, float %22, i64 0
  %broadcast.splat178 = shufflevector <4 x float> %broadcast.splatinsert177, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert180 = insertelement <4 x float> poison, float %23, i64 0
  %broadcast.splat181 = shufflevector <4 x float> %broadcast.splatinsert180, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert183 = insertelement <4 x float> poison, float %24, i64 0
  %broadcast.splat184 = shufflevector <4 x float> %broadcast.splatinsert183, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert186 = insertelement <4 x float> poison, float %25, i64 0
  %broadcast.splat187 = shufflevector <4 x float> %broadcast.splatinsert186, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert189 = insertelement <4 x float> poison, float %26, i64 0
  %broadcast.splat190 = shufflevector <4 x float> %broadcast.splatinsert189, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert192 = insertelement <4 x float> poison, float %27, i64 0
  %broadcast.splat193 = shufflevector <4 x float> %broadcast.splatinsert192, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert195 = insertelement <4 x float> poison, float %28, i64 0
  %broadcast.splat196 = shufflevector <4 x float> %broadcast.splatinsert195, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert198 = insertelement <4 x float> poison, float %29, i64 0
  %broadcast.splat199 = shufflevector <4 x float> %broadcast.splatinsert198, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert201 = insertelement <4 x float> poison, float %30, i64 0
  %broadcast.splat202 = shufflevector <4 x float> %broadcast.splatinsert201, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert204 = insertelement <4 x float> poison, float %31, i64 0
  %broadcast.splat205 = shufflevector <4 x float> %broadcast.splatinsert204, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert207 = insertelement <4 x float> poison, float %32, i64 0
  %broadcast.splat208 = shufflevector <4 x float> %broadcast.splatinsert207, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert210 = insertelement <4 x float> poison, float %33, i64 0
  %broadcast.splat211 = shufflevector <4 x float> %broadcast.splatinsert210, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert213 = insertelement <4 x float> poison, float %34, i64 0
  %broadcast.splat214 = shufflevector <4 x float> %broadcast.splatinsert213, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert216 = insertelement <4 x float> poison, float %35, i64 0
  %broadcast.splat217 = shufflevector <4 x float> %broadcast.splatinsert216, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert219 = insertelement <4 x float> poison, float %36, i64 0
  %broadcast.splat220 = shufflevector <4 x float> %broadcast.splatinsert219, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert222 = insertelement <4 x float> poison, float %37, i64 0
  %broadcast.splat223 = shufflevector <4 x float> %broadcast.splatinsert222, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert225 = insertelement <4 x float> poison, float %38, i64 0
  %broadcast.splat226 = shufflevector <4 x float> %broadcast.splatinsert225, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert228 = insertelement <4 x float> poison, float %39, i64 0
  %broadcast.splat229 = shufflevector <4 x float> %broadcast.splatinsert228, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert231 = insertelement <4 x float> poison, float %40, i64 0
  %broadcast.splat232 = shufflevector <4 x float> %broadcast.splatinsert231, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert234 = insertelement <4 x float> poison, float %41, i64 0
  %broadcast.splat235 = shufflevector <4 x float> %broadcast.splatinsert234, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert237 = insertelement <4 x float> poison, float %42, i64 0
  %broadcast.splat238 = shufflevector <4 x float> %broadcast.splatinsert237, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert240 = insertelement <4 x float> poison, float %43, i64 0
  %broadcast.splat241 = shufflevector <4 x float> %broadcast.splatinsert240, <4 x float> poison, <4 x i32> zeroinitializer
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %if.end28
  %index = phi i64 [ 0, %if.end28 ], [ %index.next, %vector.body ]
  %44 = getelementptr inbounds [38 x float], ptr %scarr, i64 0, i64 %index
  %45 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 0, i64 %index
  %wide.load = load <4 x i32>, ptr %45, align 16
  %46 = sitofp <4 x i32> %wide.load to <4 x float>
  %47 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %46, <4 x float> %broadcast.splat, <4 x float> zeroinitializer)
  %48 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 1, i64 %index
  %wide.load134 = load <4 x i32>, ptr %48, align 4
  %49 = sitofp <4 x i32> %wide.load134 to <4 x float>
  %50 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %49, <4 x float> %broadcast.splat136, <4 x float> %47)
  %51 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 2, i64 %index
  %wide.load137 = load <4 x i32>, ptr %51, align 8
  %52 = sitofp <4 x i32> %wide.load137 to <4 x float>
  %53 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %52, <4 x float> %broadcast.splat139, <4 x float> %50)
  %54 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 3, i64 %index
  %wide.load140 = load <4 x i32>, ptr %54, align 4
  %55 = sitofp <4 x i32> %wide.load140 to <4 x float>
  %56 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %55, <4 x float> %broadcast.splat142, <4 x float> %53)
  %57 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 4, i64 %index
  %wide.load143 = load <4 x i32>, ptr %57, align 16
  %58 = sitofp <4 x i32> %wide.load143 to <4 x float>
  %59 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %58, <4 x float> %broadcast.splat145, <4 x float> %56)
  %60 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 5, i64 %index
  %wide.load146 = load <4 x i32>, ptr %60, align 4
  %61 = sitofp <4 x i32> %wide.load146 to <4 x float>
  %62 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %61, <4 x float> %broadcast.splat148, <4 x float> %59)
  %63 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 6, i64 %index
  %wide.load149 = load <4 x i32>, ptr %63, align 8
  %64 = sitofp <4 x i32> %wide.load149 to <4 x float>
  %65 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %64, <4 x float> %broadcast.splat151, <4 x float> %62)
  %66 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 7, i64 %index
  %wide.load152 = load <4 x i32>, ptr %66, align 4
  %67 = sitofp <4 x i32> %wide.load152 to <4 x float>
  %68 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %67, <4 x float> %broadcast.splat154, <4 x float> %65)
  %69 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 8, i64 %index
  %wide.load155 = load <4 x i32>, ptr %69, align 16
  %70 = sitofp <4 x i32> %wide.load155 to <4 x float>
  %71 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %70, <4 x float> %broadcast.splat157, <4 x float> %68)
  %72 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 9, i64 %index
  %wide.load158 = load <4 x i32>, ptr %72, align 4
  %73 = sitofp <4 x i32> %wide.load158 to <4 x float>
  %74 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %73, <4 x float> %broadcast.splat160, <4 x float> %71)
  %75 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 10, i64 %index
  %wide.load161 = load <4 x i32>, ptr %75, align 8
  %76 = sitofp <4 x i32> %wide.load161 to <4 x float>
  %77 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %76, <4 x float> %broadcast.splat163, <4 x float> %74)
  %78 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 11, i64 %index
  %wide.load164 = load <4 x i32>, ptr %78, align 4
  %79 = sitofp <4 x i32> %wide.load164 to <4 x float>
  %80 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %79, <4 x float> %broadcast.splat166, <4 x float> %77)
  %81 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 12, i64 %index
  %wide.load167 = load <4 x i32>, ptr %81, align 16
  %82 = sitofp <4 x i32> %wide.load167 to <4 x float>
  %83 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %82, <4 x float> %broadcast.splat169, <4 x float> %80)
  %84 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 13, i64 %index
  %wide.load170 = load <4 x i32>, ptr %84, align 4
  %85 = sitofp <4 x i32> %wide.load170 to <4 x float>
  %86 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %85, <4 x float> %broadcast.splat172, <4 x float> %83)
  %87 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 14, i64 %index
  %wide.load173 = load <4 x i32>, ptr %87, align 8
  %88 = sitofp <4 x i32> %wide.load173 to <4 x float>
  %89 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %88, <4 x float> %broadcast.splat175, <4 x float> %86)
  %90 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 15, i64 %index
  %wide.load176 = load <4 x i32>, ptr %90, align 4
  %91 = sitofp <4 x i32> %wide.load176 to <4 x float>
  %92 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %91, <4 x float> %broadcast.splat178, <4 x float> %89)
  %93 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 16, i64 %index
  %wide.load179 = load <4 x i32>, ptr %93, align 16
  %94 = sitofp <4 x i32> %wide.load179 to <4 x float>
  %95 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %94, <4 x float> %broadcast.splat181, <4 x float> %92)
  %96 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 17, i64 %index
  %wide.load182 = load <4 x i32>, ptr %96, align 4
  %97 = sitofp <4 x i32> %wide.load182 to <4 x float>
  %98 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %97, <4 x float> %broadcast.splat184, <4 x float> %95)
  %99 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 18, i64 %index
  %wide.load185 = load <4 x i32>, ptr %99, align 8
  %100 = sitofp <4 x i32> %wide.load185 to <4 x float>
  %101 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %100, <4 x float> %broadcast.splat187, <4 x float> %98)
  %102 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 19, i64 %index
  %wide.load188 = load <4 x i32>, ptr %102, align 4
  %103 = sitofp <4 x i32> %wide.load188 to <4 x float>
  %104 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %103, <4 x float> %broadcast.splat190, <4 x float> %101)
  %105 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 20, i64 %index
  %wide.load191 = load <4 x i32>, ptr %105, align 16
  %106 = sitofp <4 x i32> %wide.load191 to <4 x float>
  %107 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %106, <4 x float> %broadcast.splat193, <4 x float> %104)
  %108 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 21, i64 %index
  %wide.load194 = load <4 x i32>, ptr %108, align 4
  %109 = sitofp <4 x i32> %wide.load194 to <4 x float>
  %110 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %109, <4 x float> %broadcast.splat196, <4 x float> %107)
  %111 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 22, i64 %index
  %wide.load197 = load <4 x i32>, ptr %111, align 8
  %112 = sitofp <4 x i32> %wide.load197 to <4 x float>
  %113 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %112, <4 x float> %broadcast.splat199, <4 x float> %110)
  %114 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 23, i64 %index
  %wide.load200 = load <4 x i32>, ptr %114, align 4
  %115 = sitofp <4 x i32> %wide.load200 to <4 x float>
  %116 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %115, <4 x float> %broadcast.splat202, <4 x float> %113)
  %117 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 24, i64 %index
  %wide.load203 = load <4 x i32>, ptr %117, align 16
  %118 = sitofp <4 x i32> %wide.load203 to <4 x float>
  %119 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %118, <4 x float> %broadcast.splat205, <4 x float> %116)
  %120 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 25, i64 %index
  %wide.load206 = load <4 x i32>, ptr %120, align 4
  %121 = sitofp <4 x i32> %wide.load206 to <4 x float>
  %122 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %121, <4 x float> %broadcast.splat208, <4 x float> %119)
  %123 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 26, i64 %index
  %wide.load209 = load <4 x i32>, ptr %123, align 8
  %124 = sitofp <4 x i32> %wide.load209 to <4 x float>
  %125 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %124, <4 x float> %broadcast.splat211, <4 x float> %122)
  %126 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 27, i64 %index
  %wide.load212 = load <4 x i32>, ptr %126, align 4
  %127 = sitofp <4 x i32> %wide.load212 to <4 x float>
  %128 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %127, <4 x float> %broadcast.splat214, <4 x float> %125)
  %129 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 28, i64 %index
  %wide.load215 = load <4 x i32>, ptr %129, align 16
  %130 = sitofp <4 x i32> %wide.load215 to <4 x float>
  %131 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %130, <4 x float> %broadcast.splat217, <4 x float> %128)
  %132 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 29, i64 %index
  %wide.load218 = load <4 x i32>, ptr %132, align 4
  %133 = sitofp <4 x i32> %wide.load218 to <4 x float>
  %134 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %133, <4 x float> %broadcast.splat220, <4 x float> %131)
  %135 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 30, i64 %index
  %wide.load221 = load <4 x i32>, ptr %135, align 8
  %136 = sitofp <4 x i32> %wide.load221 to <4 x float>
  %137 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %136, <4 x float> %broadcast.splat223, <4 x float> %134)
  %138 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 31, i64 %index
  %wide.load224 = load <4 x i32>, ptr %138, align 4
  %139 = sitofp <4 x i32> %wide.load224 to <4 x float>
  %140 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %139, <4 x float> %broadcast.splat226, <4 x float> %137)
  %141 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 32, i64 %index
  %wide.load227 = load <4 x i32>, ptr %141, align 16
  %142 = sitofp <4 x i32> %wide.load227 to <4 x float>
  %143 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %142, <4 x float> %broadcast.splat229, <4 x float> %140)
  %144 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 33, i64 %index
  %wide.load230 = load <4 x i32>, ptr %144, align 4
  %145 = sitofp <4 x i32> %wide.load230 to <4 x float>
  %146 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %145, <4 x float> %broadcast.splat232, <4 x float> %143)
  %147 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 34, i64 %index
  %wide.load233 = load <4 x i32>, ptr %147, align 8
  %148 = sitofp <4 x i32> %wide.load233 to <4 x float>
  %149 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %148, <4 x float> %broadcast.splat235, <4 x float> %146)
  %150 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 35, i64 %index
  %wide.load236 = load <4 x i32>, ptr %150, align 4
  %151 = sitofp <4 x i32> %wide.load236 to <4 x float>
  %152 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %151, <4 x float> %broadcast.splat238, <4 x float> %149)
  %153 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 36, i64 %index
  %wide.load239 = load <4 x i32>, ptr %153, align 16
  %154 = sitofp <4 x i32> %wide.load239 to <4 x float>
  %155 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %154, <4 x float> %broadcast.splat241, <4 x float> %152)
  store <4 x float> %155, ptr %44, align 16
  %index.next = add nuw i64 %index, 4
  %156 = icmp eq i64 %index.next, 36
  br i1 %156, label %for.body31, label %vector.body

for.body31:                                       ; preds = %vector.body
  %arrayidx33 = getelementptr inbounds [38 x float], ptr %scarr, i64 0, i64 36
  %157 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 0, i64 36), align 16
  %conv = sitofp i32 %157 to float
  %158 = tail call float @llvm.fmuladd.f32(float %conv, float %7, float 0.000000e+00)
  %159 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 1, i64 36), align 4
  %conv.1 = sitofp i32 %159 to float
  %160 = tail call float @llvm.fmuladd.f32(float %conv.1, float %8, float %158)
  %161 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 2, i64 36), align 8
  %conv.2 = sitofp i32 %161 to float
  %162 = tail call float @llvm.fmuladd.f32(float %conv.2, float %9, float %160)
  %163 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 3, i64 36), align 4
  %conv.3 = sitofp i32 %163 to float
  %164 = tail call float @llvm.fmuladd.f32(float %conv.3, float %10, float %162)
  %165 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 4, i64 36), align 16
  %conv.4 = sitofp i32 %165 to float
  %166 = tail call float @llvm.fmuladd.f32(float %conv.4, float %11, float %164)
  %167 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 5, i64 36), align 4
  %conv.5 = sitofp i32 %167 to float
  %168 = tail call float @llvm.fmuladd.f32(float %conv.5, float %12, float %166)
  %169 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 6, i64 36), align 8
  %conv.6 = sitofp i32 %169 to float
  %170 = tail call float @llvm.fmuladd.f32(float %conv.6, float %13, float %168)
  %171 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 7, i64 36), align 4
  %conv.7 = sitofp i32 %171 to float
  %172 = tail call float @llvm.fmuladd.f32(float %conv.7, float %14, float %170)
  %173 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 8, i64 36), align 16
  %conv.8 = sitofp i32 %173 to float
  %174 = tail call float @llvm.fmuladd.f32(float %conv.8, float %15, float %172)
  %175 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 9, i64 36), align 4
  %conv.9 = sitofp i32 %175 to float
  %176 = tail call float @llvm.fmuladd.f32(float %conv.9, float %16, float %174)
  %177 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 10, i64 36), align 8
  %conv.10 = sitofp i32 %177 to float
  %178 = tail call float @llvm.fmuladd.f32(float %conv.10, float %17, float %176)
  %179 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 11, i64 36), align 4
  %conv.11 = sitofp i32 %179 to float
  %180 = tail call float @llvm.fmuladd.f32(float %conv.11, float %18, float %178)
  %181 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 12, i64 36), align 16
  %conv.12 = sitofp i32 %181 to float
  %182 = tail call float @llvm.fmuladd.f32(float %conv.12, float %19, float %180)
  %183 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 13, i64 36), align 4
  %conv.13 = sitofp i32 %183 to float
  %184 = tail call float @llvm.fmuladd.f32(float %conv.13, float %20, float %182)
  %185 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 14, i64 36), align 8
  %conv.14 = sitofp i32 %185 to float
  %186 = tail call float @llvm.fmuladd.f32(float %conv.14, float %21, float %184)
  %187 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 15, i64 36), align 4
  %conv.15 = sitofp i32 %187 to float
  %188 = tail call float @llvm.fmuladd.f32(float %conv.15, float %22, float %186)
  %189 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 16, i64 36), align 16
  %conv.16 = sitofp i32 %189 to float
  %190 = tail call float @llvm.fmuladd.f32(float %conv.16, float %23, float %188)
  %191 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 17, i64 36), align 4
  %conv.17 = sitofp i32 %191 to float
  %192 = tail call float @llvm.fmuladd.f32(float %conv.17, float %24, float %190)
  %193 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 18, i64 36), align 8
  %conv.18 = sitofp i32 %193 to float
  %194 = tail call float @llvm.fmuladd.f32(float %conv.18, float %25, float %192)
  %195 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 19, i64 36), align 4
  %conv.19 = sitofp i32 %195 to float
  %196 = tail call float @llvm.fmuladd.f32(float %conv.19, float %26, float %194)
  %197 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 20, i64 36), align 16
  %conv.20 = sitofp i32 %197 to float
  %198 = tail call float @llvm.fmuladd.f32(float %conv.20, float %27, float %196)
  %199 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 21, i64 36), align 4
  %conv.21 = sitofp i32 %199 to float
  %200 = tail call float @llvm.fmuladd.f32(float %conv.21, float %28, float %198)
  %201 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 22, i64 36), align 8
  %conv.22 = sitofp i32 %201 to float
  %202 = tail call float @llvm.fmuladd.f32(float %conv.22, float %29, float %200)
  %203 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 23, i64 36), align 4
  %conv.23 = sitofp i32 %203 to float
  %204 = tail call float @llvm.fmuladd.f32(float %conv.23, float %30, float %202)
  %205 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 24, i64 36), align 16
  %conv.24 = sitofp i32 %205 to float
  %206 = tail call float @llvm.fmuladd.f32(float %conv.24, float %31, float %204)
  %207 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 25, i64 36), align 4
  %conv.25 = sitofp i32 %207 to float
  %208 = tail call float @llvm.fmuladd.f32(float %conv.25, float %32, float %206)
  %209 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 26, i64 36), align 8
  %conv.26 = sitofp i32 %209 to float
  %210 = tail call float @llvm.fmuladd.f32(float %conv.26, float %33, float %208)
  %211 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 27, i64 36), align 4
  %conv.27 = sitofp i32 %211 to float
  %212 = tail call float @llvm.fmuladd.f32(float %conv.27, float %34, float %210)
  %213 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 28, i64 36), align 16
  %conv.28 = sitofp i32 %213 to float
  %214 = tail call float @llvm.fmuladd.f32(float %conv.28, float %35, float %212)
  %215 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 29, i64 36), align 4
  %conv.29 = sitofp i32 %215 to float
  %216 = tail call float @llvm.fmuladd.f32(float %conv.29, float %36, float %214)
  %217 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 30, i64 36), align 8
  %conv.30 = sitofp i32 %217 to float
  %218 = tail call float @llvm.fmuladd.f32(float %conv.30, float %37, float %216)
  %219 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 31, i64 36), align 4
  %conv.31 = sitofp i32 %219 to float
  %220 = tail call float @llvm.fmuladd.f32(float %conv.31, float %38, float %218)
  %221 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 32, i64 36), align 16
  %conv.32 = sitofp i32 %221 to float
  %222 = tail call float @llvm.fmuladd.f32(float %conv.32, float %39, float %220)
  %223 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 33, i64 36), align 4
  %conv.33 = sitofp i32 %223 to float
  %224 = tail call float @llvm.fmuladd.f32(float %conv.33, float %40, float %222)
  %225 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 34, i64 36), align 8
  %conv.34 = sitofp i32 %225 to float
  %226 = tail call float @llvm.fmuladd.f32(float %conv.34, float %41, float %224)
  %227 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 35, i64 36), align 4
  %conv.35 = sitofp i32 %227 to float
  %228 = tail call float @llvm.fmuladd.f32(float %conv.35, float %42, float %226)
  %229 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 36, i64 36), align 16
  %conv.36 = sitofp i32 %229 to float
  %230 = tail call float @llvm.fmuladd.f32(float %conv.36, float %43, float %228)
  store float %230, ptr %arrayidx33, align 16
  %tobool53.not113 = icmp eq i32 %lgth2, 0
  br i1 %tobool53.not113, label %while.end, label %while.body

while.body:                                       ; preds = %for.body31, %for.end66
  %dec117.in = phi i32 [ %dec117, %for.end66 ], [ %lgth2, %for.body31 ]
  %cpmxpdnpt.0116 = phi ptr [ %incdec.ptr67, %for.end66 ], [ %intwork, %for.body31 ]
  %cpmxpdpt.0115 = phi ptr [ %incdec.ptr68, %for.end66 ], [ %floatwork, %for.body31 ]
  %matchpt.0114 = phi ptr [ %incdec.ptr, %for.end66 ], [ %match, %for.body31 ]
  %dec117 = add nsw i32 %dec117.in, -1
  store float 0.000000e+00, ptr %matchpt.0114, align 4
  %231 = load ptr, ptr %cpmxpdnpt.0116, align 8
  %232 = load i32, ptr %231, align 4
  %cmp57109 = icmp sgt i32 %232, -1
  br i1 %cmp57109, label %for.body59.lr.ph, label %for.end66

for.body59.lr.ph:                                 ; preds = %while.body
  %233 = load ptr, ptr %cpmxpdpt.0115, align 8
  br label %for.body59

for.body59:                                       ; preds = %for.body59.lr.ph, %for.body59
  %indvars.iv131 = phi i64 [ 0, %for.body59.lr.ph ], [ %indvars.iv.next132, %for.body59 ]
  %234 = phi float [ 0.000000e+00, %for.body59.lr.ph ], [ %238, %for.body59 ]
  %235 = phi i32 [ %232, %for.body59.lr.ph ], [ %239, %for.body59 ]
  %idxprom60 = zext i32 %235 to i64
  %arrayidx61 = getelementptr inbounds [38 x float], ptr %scarr, i64 0, i64 %idxprom60
  %236 = load float, ptr %arrayidx61, align 4
  %arrayidx63 = getelementptr inbounds float, ptr %233, i64 %indvars.iv131
  %237 = load float, ptr %arrayidx63, align 4
  %238 = tail call float @llvm.fmuladd.f32(float %236, float %237, float %234)
  store float %238, ptr %matchpt.0114, align 4
  %indvars.iv.next132 = add nuw nsw i64 %indvars.iv131, 1
  %arrayidx56 = getelementptr inbounds i32, ptr %231, i64 %indvars.iv.next132
  %239 = load i32, ptr %arrayidx56, align 4
  %cmp57 = icmp sgt i32 %239, -1
  br i1 %cmp57, label %for.body59, label %for.end66
