...
for.inc:                                          ; preds = %for.body3, %if.then7
  ...
  %5 = load float, ptr %arrayidx5.1, align 4
...
for.inc.1:                                        ; preds = %if.then7.1, %for.inc
  ...
  br i1 %exitcond.not.1, label %for.end, label %for.body3
...
if.end28:                                         ; preds = %for.end, %entry
  %10 = load i32, ptr @RNAthr, align 4
...
vector.body:                                      ; preds = %vector.body, %if.end28
  ...
  %wide.load = load <4 x i32>, ptr %37, align 16
  %38 = sub nsw <4 x i32> %wide.load, %broadcast.splat
  %39 = sitofp <4 x i32> %38 to <4 x float>
  %40 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %39, <4 x float> %broadcast.splat136, <4 x float> zeroinitializer)
  %41 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 1, i64 %index
  %wide.load137 = load <4 x i32>, ptr %41, align 8
  %42 = sub nsw <4 x i32> %wide.load137, %broadcast.splat
  %43 = sitofp <4 x i32> %42 to <4 x float>
  %44 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %43, <4 x float> %broadcast.splat139, <4 x float> %40)
  %45 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 2, i64 %index
  %wide.load140 = load <4 x i32>, ptr %45, align 16
  %46 = sub nsw <4 x i32> %wide.load140, %broadcast.splat
  %47 = sitofp <4 x i32> %46 to <4 x float>
  %48 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %47, <4 x float> %broadcast.splat142, <4 x float> %44)
  %49 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 3, i64 %index
  %wide.load143 = load <4 x i32>, ptr %49, align 8
  %50 = sub nsw <4 x i32> %wide.load143, %broadcast.splat
  %51 = sitofp <4 x i32> %50 to <4 x float>
  %52 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %51, <4 x float> %broadcast.splat145, <4 x float> %48)
  %53 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 4, i64 %index
  %wide.load146 = load <4 x i32>, ptr %53, align 16
  %54 = sub nsw <4 x i32> %wide.load146, %broadcast.splat
  %55 = sitofp <4 x i32> %54 to <4 x float>
  %56 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %55, <4 x float> %broadcast.splat148, <4 x float> %52)
  %57 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 5, i64 %index
  %wide.load149 = load <4 x i32>, ptr %57, align 8
  %58 = sub nsw <4 x i32> %wide.load149, %broadcast.splat
  %59 = sitofp <4 x i32> %58 to <4 x float>
  %60 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %59, <4 x float> %broadcast.splat151, <4 x float> %56)
  %61 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 6, i64 %index
  %wide.load152 = load <4 x i32>, ptr %61, align 16
  %62 = sub nsw <4 x i32> %wide.load152, %broadcast.splat
  %63 = sitofp <4 x i32> %62 to <4 x float>
  %64 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %63, <4 x float> %broadcast.splat154, <4 x float> %60)
  %65 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 7, i64 %index
  %wide.load155 = load <4 x i32>, ptr %65, align 8
  %66 = sub nsw <4 x i32> %wide.load155, %broadcast.splat
  %67 = sitofp <4 x i32> %66 to <4 x float>
  %68 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %67, <4 x float> %broadcast.splat157, <4 x float> %64)
  %69 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 8, i64 %index
  %wide.load158 = load <4 x i32>, ptr %69, align 16
  %70 = sub nsw <4 x i32> %wide.load158, %broadcast.splat
  %71 = sitofp <4 x i32> %70 to <4 x float>
  %72 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %71, <4 x float> %broadcast.splat160, <4 x float> %68)
  %73 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 9, i64 %index
  %wide.load161 = load <4 x i32>, ptr %73, align 8
  %74 = sub nsw <4 x i32> %wide.load161, %broadcast.splat
  %75 = sitofp <4 x i32> %74 to <4 x float>
  %76 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %75, <4 x float> %broadcast.splat163, <4 x float> %72)
  %77 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 10, i64 %index
  %wide.load164 = load <4 x i32>, ptr %77, align 16
  %78 = sub nsw <4 x i32> %wide.load164, %broadcast.splat
  %79 = sitofp <4 x i32> %78 to <4 x float>
  %80 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %79, <4 x float> %broadcast.splat166, <4 x float> %76)
  %81 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 11, i64 %index
  %wide.load167 = load <4 x i32>, ptr %81, align 8
  %82 = sub nsw <4 x i32> %wide.load167, %broadcast.splat
  %83 = sitofp <4 x i32> %82 to <4 x float>
  %84 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %83, <4 x float> %broadcast.splat169, <4 x float> %80)
  %85 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 12, i64 %index
  %wide.load170 = load <4 x i32>, ptr %85, align 16
  %86 = sub nsw <4 x i32> %wide.load170, %broadcast.splat
  %87 = sitofp <4 x i32> %86 to <4 x float>
  %88 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %87, <4 x float> %broadcast.splat172, <4 x float> %84)
  %89 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 13, i64 %index
  %wide.load173 = load <4 x i32>, ptr %89, align 8
  %90 = sub nsw <4 x i32> %wide.load173, %broadcast.splat
  %91 = sitofp <4 x i32> %90 to <4 x float>
  %92 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %91, <4 x float> %broadcast.splat175, <4 x float> %88)
  %93 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 14, i64 %index
  %wide.load176 = load <4 x i32>, ptr %93, align 16
  %94 = sub nsw <4 x i32> %wide.load176, %broadcast.splat
  %95 = sitofp <4 x i32> %94 to <4 x float>
  %96 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %95, <4 x float> %broadcast.splat178, <4 x float> %92)
  %97 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 15, i64 %index
  %wide.load179 = load <4 x i32>, ptr %97, align 8
  %98 = sub nsw <4 x i32> %wide.load179, %broadcast.splat
  %99 = sitofp <4 x i32> %98 to <4 x float>
  %100 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %99, <4 x float> %broadcast.splat181, <4 x float> %96)
  %101 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 16, i64 %index
  %wide.load182 = load <4 x i32>, ptr %101, align 16
  %102 = sub nsw <4 x i32> %wide.load182, %broadcast.splat
  %103 = sitofp <4 x i32> %102 to <4 x float>
  %104 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %103, <4 x float> %broadcast.splat184, <4 x float> %100)
  %105 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 17, i64 %index
  %wide.load185 = load <4 x i32>, ptr %105, align 8
  %106 = sub nsw <4 x i32> %wide.load185, %broadcast.splat
  %107 = sitofp <4 x i32> %106 to <4 x float>
  %108 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %107, <4 x float> %broadcast.splat187, <4 x float> %104)
  %109 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 18, i64 %index
  %wide.load188 = load <4 x i32>, ptr %109, align 16
  %110 = sub nsw <4 x i32> %wide.load188, %broadcast.splat
  %111 = sitofp <4 x i32> %110 to <4 x float>
  %112 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %111, <4 x float> %broadcast.splat190, <4 x float> %108)
  %113 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 19, i64 %index
  %wide.load191 = load <4 x i32>, ptr %113, align 8
  %114 = sub nsw <4 x i32> %wide.load191, %broadcast.splat
  %115 = sitofp <4 x i32> %114 to <4 x float>
  %116 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %115, <4 x float> %broadcast.splat193, <4 x float> %112)
  %117 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 20, i64 %index
  %wide.load194 = load <4 x i32>, ptr %117, align 16
  %118 = sub nsw <4 x i32> %wide.load194, %broadcast.splat
  %119 = sitofp <4 x i32> %118 to <4 x float>
  %120 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %119, <4 x float> %broadcast.splat196, <4 x float> %116)
  %121 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 21, i64 %index
  %wide.load197 = load <4 x i32>, ptr %121, align 8
  %122 = sub nsw <4 x i32> %wide.load197, %broadcast.splat
  %123 = sitofp <4 x i32> %122 to <4 x float>
  %124 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %123, <4 x float> %broadcast.splat199, <4 x float> %120)
  %125 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 22, i64 %index
  %wide.load200 = load <4 x i32>, ptr %125, align 16
  %126 = sub nsw <4 x i32> %wide.load200, %broadcast.splat
  %127 = sitofp <4 x i32> %126 to <4 x float>
  %128 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %127, <4 x float> %broadcast.splat202, <4 x float> %124)
  %129 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 23, i64 %index
  %wide.load203 = load <4 x i32>, ptr %129, align 8
  %130 = sub nsw <4 x i32> %wide.load203, %broadcast.splat
  %131 = sitofp <4 x i32> %130 to <4 x float>
  %132 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %131, <4 x float> %broadcast.splat205, <4 x float> %128)
  %133 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 24, i64 %index
  %wide.load206 = load <4 x i32>, ptr %133, align 16
  %134 = sub nsw <4 x i32> %wide.load206, %broadcast.splat
  %135 = sitofp <4 x i32> %134 to <4 x float>
  %136 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %135, <4 x float> %broadcast.splat208, <4 x float> %132)
  %137 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 25, i64 %index
  %wide.load209 = load <4 x i32>, ptr %137, align 8
  %138 = sub nsw <4 x i32> %wide.load209, %broadcast.splat
  %139 = sitofp <4 x i32> %138 to <4 x float>
  %140 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %139, <4 x float> %broadcast.splat211, <4 x float> %136)
  store <4 x float> %140, ptr %36, align 16
  %index.next = add nuw i64 %index, 4
  %141 = icmp eq i64 %index.next, 24
  br i1 %141, label %for.body31, label %vector.body
...
for.body31:                                       ; preds = %vector.body, %for.body31
  ...
  %142 = load i32, ptr %arrayidx40, align 4
  ...
  %144 = load i32, ptr %arrayidx40.1, align 4
  ...
  %146 = load i32, ptr %arrayidx40.2, align 4
  ...
  %148 = load i32, ptr %arrayidx40.3, align 4
  ...
  %150 = load i32, ptr %arrayidx40.4, align 4
  ...
  %152 = load i32, ptr %arrayidx40.5, align 4
  ...
  %154 = load i32, ptr %arrayidx40.6, align 4
  ...
  %156 = load i32, ptr %arrayidx40.7, align 4
  ...
  %158 = load i32, ptr %arrayidx40.8, align 4
  ...
  %160 = load i32, ptr %arrayidx40.9, align 4
  ...
  %162 = load i32, ptr %arrayidx40.10, align 4
  ...
  %164 = load i32, ptr %arrayidx40.11, align 4
  ...
  %166 = load i32, ptr %arrayidx40.12, align 4
  ...
  %172 = load i32, ptr %arrayidx40.15, align 4
  ...
  %174 = load i32, ptr %arrayidx40.16, align 4
  ...
  %176 = load i32, ptr %arrayidx40.17, align 4
  ...
  %178 = load i32, ptr %arrayidx40.18, align 4
  ...
  %180 = load i32, ptr %arrayidx40.19, align 4
  ...
  %182 = load i32, ptr %arrayidx40.20, align 4
  ...
  %184 = load i32, ptr %arrayidx40.21, align 4
  ...
  %186 = load i32, ptr %arrayidx40.22, align 4
  ...
  %188 = load i32, ptr %arrayidx40.23, align 4
  ...
  %190 = load i32, ptr %arrayidx40.24, align 4
  ...
  %192 = load i32, ptr %arrayidx40.25, align 4
  ...
  store float %193, ptr %arrayidx33, align 4
...
while.body:                                       ; preds = %while.cond.preheader, %for.end66
  ...
  %194 = load ptr, ptr %cpmxpdnpt.0116, align 8
  %195 = load i32, ptr %194, align 4
  %cmp57109 = icmp sgt i32 %195, -1
  br i1 %cmp57109, label %for.body59.lr.ph, label %for.end66

for.body59.lr.ph:                                 ; preds = %while.body
  %196 = load ptr, ptr %cpmxpdpt.0115, align 8
  br label %for.body59
...
for.body59:                                       ; preds = %for.body59.lr.ph, %for.body59
  ...
  %199 = load float, ptr %arrayidx61, align 4
  %arrayidx63 = getelementptr inbounds float, ptr %196, i64 %indvars.iv131
  %200 = load float, ptr %arrayidx63, align 4
  %201 = tail call float @llvm.fmuladd.f32(float %199, float %200, float %197)
  store float %201, ptr %matchpt.0114, align 4
  %indvars.iv.next132 = add nuw nsw i64 %indvars.iv131, 1
  %arrayidx56 = getelementptr inbounds i32, ptr %194, i64 %indvars.iv.next132
  %202 = load i32, ptr %arrayidx56, align 4
...
for.inc:                                          ; preds = %for.body3, %if.then7
  ...
  br i1 %exitcond.not, label %for.end, label %for.body3.1
...
if.end28:                                         ; preds = %for.end, %entry
  ...
  %12 = load float, ptr %arrayidx44.1, align 4
  %arrayidx44.2 = getelementptr inbounds float, ptr %10, i64 2
  %13 = load float, ptr %arrayidx44.2, align 4
  %arrayidx44.3 = getelementptr inbounds float, ptr %10, i64 3
  %14 = load float, ptr %arrayidx44.3, align 4
  ...
  %broadcast.splatinsert168 = insertelement <4 x float> poison, float %23, i64 0
  %broadcast.splat169 = shufflevector <4 x float> %broadcast.splatinsert168, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert171 = insertelement <4 x float> poison, float %24, i64 0
  %broadcast.splat172 = shufflevector <4 x float> %broadcast.splatinsert171, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert174 = insertelement <4 x float> poison, float %25, i64 0
  %broadcast.splat175 = shufflevector <4 x float> %broadcast.splatinsert174, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert177 = insertelement <4 x float> poison, float %26, i64 0
  %broadcast.splat178 = shufflevector <4 x float> %broadcast.splatinsert177, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert180 = insertelement <4 x float> poison, float %27, i64 0
  %broadcast.splat181 = shufflevector <4 x float> %broadcast.splatinsert180, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert183 = insertelement <4 x float> poison, float %28, i64 0
  %broadcast.splat184 = shufflevector <4 x float> %broadcast.splatinsert183, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert186 = insertelement <4 x float> poison, float %29, i64 0
  %broadcast.splat187 = shufflevector <4 x float> %broadcast.splatinsert186, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert189 = insertelement <4 x float> poison, float %30, i64 0
  %broadcast.splat190 = shufflevector <4 x float> %broadcast.splatinsert189, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert192 = insertelement <4 x float> poison, float %31, i64 0
  %broadcast.splat193 = shufflevector <4 x float> %broadcast.splatinsert192, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert195 = insertelement <4 x float> poison, float %32, i64 0
  %broadcast.splat196 = shufflevector <4 x float> %broadcast.splatinsert195, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert198 = insertelement <4 x float> poison, float %33, i64 0
  %broadcast.splat199 = shufflevector <4 x float> %broadcast.splatinsert198, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert201 = insertelement <4 x float> poison, float %34, i64 0
  %broadcast.splat202 = shufflevector <4 x float> %broadcast.splatinsert201, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert204 = insertelement <4 x float> poison, float %35, i64 0
  %broadcast.splat205 = shufflevector <4 x float> %broadcast.splatinsert204, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert207 = insertelement <4 x float> poison, float %36, i64 0
  %broadcast.splat208 = shufflevector <4 x float> %broadcast.splatinsert207, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert210 = insertelement <4 x float> poison, float %37, i64 0
  %broadcast.splat211 = shufflevector <4 x float> %broadcast.splatinsert210, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert213 = insertelement <4 x float> poison, float %38, i64 0
  %broadcast.splat214 = shufflevector <4 x float> %broadcast.splatinsert213, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert216 = insertelement <4 x float> poison, float %39, i64 0
  %broadcast.splat217 = shufflevector <4 x float> %broadcast.splatinsert216, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert219 = insertelement <4 x float> poison, float %40, i64 0
  %broadcast.splat220 = shufflevector <4 x float> %broadcast.splatinsert219, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert222 = insertelement <4 x float> poison, float %41, i64 0
  %broadcast.splat223 = shufflevector <4 x float> %broadcast.splatinsert222, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert225 = insertelement <4 x float> poison, float %42, i64 0
  %broadcast.splat226 = shufflevector <4 x float> %broadcast.splatinsert225, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert228 = insertelement <4 x float> poison, float %43, i64 0
  %broadcast.splat229 = shufflevector <4 x float> %broadcast.splatinsert228, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert231 = insertelement <4 x float> poison, float %44, i64 0
  %broadcast.splat232 = shufflevector <4 x float> %broadcast.splatinsert231, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert234 = insertelement <4 x float> poison, float %45, i64 0
  %broadcast.splat235 = shufflevector <4 x float> %broadcast.splatinsert234, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert237 = insertelement <4 x float> poison, float %46, i64 0
  %broadcast.splat238 = shufflevector <4 x float> %broadcast.splatinsert237, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert240 = insertelement <4 x float> poison, float %47, i64 0
...
vector.body:                                      ; preds = %vector.body, %if.end28
  ...
  %wide.load = load <4 x i32>, ptr %49, align 16
  ...
  %wide.load134 = load <4 x i32>, ptr %52, align 4
  %53 = sitofp <4 x i32> %wide.load134 to <4 x float>
  %54 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %53, <4 x float> %broadcast.splat136, <4 x float> %51)
  %55 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 2, i64 %index
  %wide.load137 = load <4 x i32>, ptr %55, align 8
  %56 = sitofp <4 x i32> %wide.load137 to <4 x float>
  %57 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %56, <4 x float> %broadcast.splat139, <4 x float> %54)
  %58 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 3, i64 %index
  %wide.load140 = load <4 x i32>, ptr %58, align 4
  %59 = sitofp <4 x i32> %wide.load140 to <4 x float>
  %60 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %59, <4 x float> %broadcast.splat142, <4 x float> %57)
  %61 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 4, i64 %index
  %wide.load143 = load <4 x i32>, ptr %61, align 16
  %62 = sitofp <4 x i32> %wide.load143 to <4 x float>
  %63 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %62, <4 x float> %broadcast.splat145, <4 x float> %60)
  %64 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 5, i64 %index
  %wide.load146 = load <4 x i32>, ptr %64, align 4
  %65 = sitofp <4 x i32> %wide.load146 to <4 x float>
  %66 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %65, <4 x float> %broadcast.splat148, <4 x float> %63)
  %67 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 6, i64 %index
  %wide.load149 = load <4 x i32>, ptr %67, align 8
  %68 = sitofp <4 x i32> %wide.load149 to <4 x float>
  %69 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %68, <4 x float> %broadcast.splat151, <4 x float> %66)
  %70 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 7, i64 %index
  %wide.load152 = load <4 x i32>, ptr %70, align 4
  %71 = sitofp <4 x i32> %wide.load152 to <4 x float>
  %72 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %71, <4 x float> %broadcast.splat154, <4 x float> %69)
  %73 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 8, i64 %index
  %wide.load155 = load <4 x i32>, ptr %73, align 16
  %74 = sitofp <4 x i32> %wide.load155 to <4 x float>
  %75 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %74, <4 x float> %broadcast.splat157, <4 x float> %72)
  %76 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 9, i64 %index
  %wide.load158 = load <4 x i32>, ptr %76, align 4
  %77 = sitofp <4 x i32> %wide.load158 to <4 x float>
  %78 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %77, <4 x float> %broadcast.splat160, <4 x float> %75)
  %79 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 10, i64 %index
  %wide.load161 = load <4 x i32>, ptr %79, align 8
  %80 = sitofp <4 x i32> %wide.load161 to <4 x float>
  %81 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %80, <4 x float> %broadcast.splat163, <4 x float> %78)
  %82 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 11, i64 %index
  %wide.load164 = load <4 x i32>, ptr %82, align 4
  %83 = sitofp <4 x i32> %wide.load164 to <4 x float>
  %84 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %83, <4 x float> %broadcast.splat166, <4 x float> %81)
  %85 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 12, i64 %index
  %wide.load167 = load <4 x i32>, ptr %85, align 16
  %86 = sitofp <4 x i32> %wide.load167 to <4 x float>
  %87 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %86, <4 x float> %broadcast.splat169, <4 x float> %84)
  %88 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 13, i64 %index
  %wide.load170 = load <4 x i32>, ptr %88, align 4
  %89 = sitofp <4 x i32> %wide.load170 to <4 x float>
  %90 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %89, <4 x float> %broadcast.splat172, <4 x float> %87)
  %91 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 14, i64 %index
  %wide.load173 = load <4 x i32>, ptr %91, align 8
  %92 = sitofp <4 x i32> %wide.load173 to <4 x float>
  %93 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %92, <4 x float> %broadcast.splat175, <4 x float> %90)
  %94 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 15, i64 %index
  %wide.load176 = load <4 x i32>, ptr %94, align 4
  %95 = sitofp <4 x i32> %wide.load176 to <4 x float>
  %96 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %95, <4 x float> %broadcast.splat178, <4 x float> %93)
  %97 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 16, i64 %index
  %wide.load179 = load <4 x i32>, ptr %97, align 16
  %98 = sitofp <4 x i32> %wide.load179 to <4 x float>
  %99 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %98, <4 x float> %broadcast.splat181, <4 x float> %96)
  %100 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 17, i64 %index
  %wide.load182 = load <4 x i32>, ptr %100, align 4
  %101 = sitofp <4 x i32> %wide.load182 to <4 x float>
  %102 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %101, <4 x float> %broadcast.splat184, <4 x float> %99)
  %103 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 18, i64 %index
  %wide.load185 = load <4 x i32>, ptr %103, align 8
  %104 = sitofp <4 x i32> %wide.load185 to <4 x float>
  %105 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %104, <4 x float> %broadcast.splat187, <4 x float> %102)
  %106 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 19, i64 %index
  %wide.load188 = load <4 x i32>, ptr %106, align 4
  %107 = sitofp <4 x i32> %wide.load188 to <4 x float>
  %108 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %107, <4 x float> %broadcast.splat190, <4 x float> %105)
  %109 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 20, i64 %index
  %wide.load191 = load <4 x i32>, ptr %109, align 16
  %110 = sitofp <4 x i32> %wide.load191 to <4 x float>
  %111 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %110, <4 x float> %broadcast.splat193, <4 x float> %108)
  %112 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 21, i64 %index
  %wide.load194 = load <4 x i32>, ptr %112, align 4
  %113 = sitofp <4 x i32> %wide.load194 to <4 x float>
  %114 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %113, <4 x float> %broadcast.splat196, <4 x float> %111)
  %115 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 22, i64 %index
  %wide.load197 = load <4 x i32>, ptr %115, align 8
  %116 = sitofp <4 x i32> %wide.load197 to <4 x float>
  %117 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %116, <4 x float> %broadcast.splat199, <4 x float> %114)
  %118 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 23, i64 %index
  %wide.load200 = load <4 x i32>, ptr %118, align 4
  %119 = sitofp <4 x i32> %wide.load200 to <4 x float>
  %120 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %119, <4 x float> %broadcast.splat202, <4 x float> %117)
  %121 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 24, i64 %index
  %wide.load203 = load <4 x i32>, ptr %121, align 16
  %122 = sitofp <4 x i32> %wide.load203 to <4 x float>
  %123 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %122, <4 x float> %broadcast.splat205, <4 x float> %120)
  %124 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 25, i64 %index
  %wide.load206 = load <4 x i32>, ptr %124, align 4
  %125 = sitofp <4 x i32> %wide.load206 to <4 x float>
  %126 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %125, <4 x float> %broadcast.splat208, <4 x float> %123)
  %127 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 26, i64 %index
  %wide.load209 = load <4 x i32>, ptr %127, align 8
  %128 = sitofp <4 x i32> %wide.load209 to <4 x float>
  %129 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %128, <4 x float> %broadcast.splat211, <4 x float> %126)
  %130 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 27, i64 %index
  %wide.load212 = load <4 x i32>, ptr %130, align 4
  %131 = sitofp <4 x i32> %wide.load212 to <4 x float>
  %132 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %131, <4 x float> %broadcast.splat214, <4 x float> %129)
  %133 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 28, i64 %index
  %wide.load215 = load <4 x i32>, ptr %133, align 16
  %134 = sitofp <4 x i32> %wide.load215 to <4 x float>
  %135 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %134, <4 x float> %broadcast.splat217, <4 x float> %132)
  %136 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 29, i64 %index
  %wide.load218 = load <4 x i32>, ptr %136, align 4
  %137 = sitofp <4 x i32> %wide.load218 to <4 x float>
  %138 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %137, <4 x float> %broadcast.splat220, <4 x float> %135)
  %139 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 30, i64 %index
  %wide.load221 = load <4 x i32>, ptr %139, align 8
  %140 = sitofp <4 x i32> %wide.load221 to <4 x float>
  %141 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %140, <4 x float> %broadcast.splat223, <4 x float> %138)
  %142 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 31, i64 %index
  %wide.load224 = load <4 x i32>, ptr %142, align 4
  %143 = sitofp <4 x i32> %wide.load224 to <4 x float>
  %144 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %143, <4 x float> %broadcast.splat226, <4 x float> %141)
  %145 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 32, i64 %index
  %wide.load227 = load <4 x i32>, ptr %145, align 16
  %146 = sitofp <4 x i32> %wide.load227 to <4 x float>
  %147 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %146, <4 x float> %broadcast.splat229, <4 x float> %144)
  %148 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 33, i64 %index
  %wide.load230 = load <4 x i32>, ptr %148, align 4
  %149 = sitofp <4 x i32> %wide.load230 to <4 x float>
  %150 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %149, <4 x float> %broadcast.splat232, <4 x float> %147)
  %151 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 34, i64 %index
  %wide.load233 = load <4 x i32>, ptr %151, align 8
  %152 = sitofp <4 x i32> %wide.load233 to <4 x float>
  %153 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %152, <4 x float> %broadcast.splat235, <4 x float> %150)
  %154 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 35, i64 %index
  %wide.load236 = load <4 x i32>, ptr %154, align 4
  %155 = sitofp <4 x i32> %wide.load236 to <4 x float>
  %156 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %155, <4 x float> %broadcast.splat238, <4 x float> %153)
  %157 = getelementptr inbounds [37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 36, i64 %index
  %wide.load239 = load <4 x i32>, ptr %157, align 16
  %158 = sitofp <4 x i32> %wide.load239 to <4 x float>
  %159 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %158, <4 x float> %broadcast.splat241, <4 x float> %156)
  store <4 x float> %159, ptr %48, align 16
  %index.next = add nuw i64 %index, 4
  %160 = icmp eq i64 %index.next, 36
  br i1 %160, label %for.body31, label %vector.body

for.body31:                                       ; preds = %vector.body
  %arrayidx33 = getelementptr inbounds [38 x float], ptr %scarr, i64 0, i64 36
  %161 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 0, i64 36), align 16
  %conv = sitofp i32 %161 to float
  %162 = tail call float @llvm.fmuladd.f32(float %conv, float %11, float 0.000000e+00)
  %163 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 1, i64 36), align 4
  %conv.1 = sitofp i32 %163 to float
  %164 = tail call float @llvm.fmuladd.f32(float %conv.1, float %12, float %162)
  %165 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 2, i64 36), align 8
  %conv.2 = sitofp i32 %165 to float
  %166 = tail call float @llvm.fmuladd.f32(float %conv.2, float %13, float %164)
  %167 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 3, i64 36), align 4
  %conv.3 = sitofp i32 %167 to float
  %168 = tail call float @llvm.fmuladd.f32(float %conv.3, float %14, float %166)
  %169 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 4, i64 36), align 16
  %conv.4 = sitofp i32 %169 to float
  %170 = tail call float @llvm.fmuladd.f32(float %conv.4, float %15, float %168)
  %171 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 5, i64 36), align 4
  %conv.5 = sitofp i32 %171 to float
  %172 = tail call float @llvm.fmuladd.f32(float %conv.5, float %16, float %170)
  %173 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 6, i64 36), align 8
  %conv.6 = sitofp i32 %173 to float
  %174 = tail call float @llvm.fmuladd.f32(float %conv.6, float %17, float %172)
  %175 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 7, i64 36), align 4
  %conv.7 = sitofp i32 %175 to float
  %176 = tail call float @llvm.fmuladd.f32(float %conv.7, float %18, float %174)
  %177 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 8, i64 36), align 16
  %conv.8 = sitofp i32 %177 to float
  %178 = tail call float @llvm.fmuladd.f32(float %conv.8, float %19, float %176)
  %179 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 9, i64 36), align 4
  %conv.9 = sitofp i32 %179 to float
  %180 = tail call float @llvm.fmuladd.f32(float %conv.9, float %20, float %178)
  %181 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 10, i64 36), align 8
  %conv.10 = sitofp i32 %181 to float
  %182 = tail call float @llvm.fmuladd.f32(float %conv.10, float %21, float %180)
  %183 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 11, i64 36), align 4
  %conv.11 = sitofp i32 %183 to float
  %184 = tail call float @llvm.fmuladd.f32(float %conv.11, float %22, float %182)
  %185 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 12, i64 36), align 16
  %conv.12 = sitofp i32 %185 to float
  %186 = tail call float @llvm.fmuladd.f32(float %conv.12, float %23, float %184)
  %187 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 13, i64 36), align 4
  %conv.13 = sitofp i32 %187 to float
  %188 = tail call float @llvm.fmuladd.f32(float %conv.13, float %24, float %186)
  %189 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 14, i64 36), align 8
  %conv.14 = sitofp i32 %189 to float
  %190 = tail call float @llvm.fmuladd.f32(float %conv.14, float %25, float %188)
  %191 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 15, i64 36), align 4
  %conv.15 = sitofp i32 %191 to float
  %192 = tail call float @llvm.fmuladd.f32(float %conv.15, float %26, float %190)
  %193 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 16, i64 36), align 16
  %conv.16 = sitofp i32 %193 to float
  %194 = tail call float @llvm.fmuladd.f32(float %conv.16, float %27, float %192)
  %195 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 17, i64 36), align 4
  %conv.17 = sitofp i32 %195 to float
  %196 = tail call float @llvm.fmuladd.f32(float %conv.17, float %28, float %194)
  %197 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 18, i64 36), align 8
  %conv.18 = sitofp i32 %197 to float
  %198 = tail call float @llvm.fmuladd.f32(float %conv.18, float %29, float %196)
  %199 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 19, i64 36), align 4
  %conv.19 = sitofp i32 %199 to float
  %200 = tail call float @llvm.fmuladd.f32(float %conv.19, float %30, float %198)
  %201 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 20, i64 36), align 16
  %conv.20 = sitofp i32 %201 to float
  %202 = tail call float @llvm.fmuladd.f32(float %conv.20, float %31, float %200)
  %203 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 21, i64 36), align 4
  %conv.21 = sitofp i32 %203 to float
  %204 = tail call float @llvm.fmuladd.f32(float %conv.21, float %32, float %202)
  %205 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 22, i64 36), align 8
  %conv.22 = sitofp i32 %205 to float
  %206 = tail call float @llvm.fmuladd.f32(float %conv.22, float %33, float %204)
  %207 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 23, i64 36), align 4
  %conv.23 = sitofp i32 %207 to float
  %208 = tail call float @llvm.fmuladd.f32(float %conv.23, float %34, float %206)
  %209 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 24, i64 36), align 16
  %conv.24 = sitofp i32 %209 to float
  %210 = tail call float @llvm.fmuladd.f32(float %conv.24, float %35, float %208)
  %211 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 25, i64 36), align 4
  %conv.25 = sitofp i32 %211 to float
  %212 = tail call float @llvm.fmuladd.f32(float %conv.25, float %36, float %210)
  %213 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 26, i64 36), align 8
  %conv.26 = sitofp i32 %213 to float
  %214 = tail call float @llvm.fmuladd.f32(float %conv.26, float %37, float %212)
  %215 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 27, i64 36), align 4
  %conv.27 = sitofp i32 %215 to float
  %216 = tail call float @llvm.fmuladd.f32(float %conv.27, float %38, float %214)
  %217 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 28, i64 36), align 16
  %conv.28 = sitofp i32 %217 to float
  %218 = tail call float @llvm.fmuladd.f32(float %conv.28, float %39, float %216)
  %219 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 29, i64 36), align 4
  %conv.29 = sitofp i32 %219 to float
  %220 = tail call float @llvm.fmuladd.f32(float %conv.29, float %40, float %218)
  %221 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 30, i64 36), align 8
  %conv.30 = sitofp i32 %221 to float
  %222 = tail call float @llvm.fmuladd.f32(float %conv.30, float %41, float %220)
  %223 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 31, i64 36), align 4
  %conv.31 = sitofp i32 %223 to float
  %224 = tail call float @llvm.fmuladd.f32(float %conv.31, float %42, float %222)
  %225 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 32, i64 36), align 16
  %conv.32 = sitofp i32 %225 to float
  %226 = tail call float @llvm.fmuladd.f32(float %conv.32, float %43, float %224)
  %227 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 33, i64 36), align 4
  %conv.33 = sitofp i32 %227 to float
  %228 = tail call float @llvm.fmuladd.f32(float %conv.33, float %44, float %226)
  %229 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 34, i64 36), align 8
  %conv.34 = sitofp i32 %229 to float
  %230 = tail call float @llvm.fmuladd.f32(float %conv.34, float %45, float %228)
  %231 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 35, i64 36), align 4
  %conv.35 = sitofp i32 %231 to float
  %232 = tail call float @llvm.fmuladd.f32(float %conv.35, float %46, float %230)
  %233 = load i32, ptr getelementptr inbounds ([37 x [37 x i32]], ptr @ribosumdis, i64 0, i64 36, i64 36), align 16
  %conv.36 = sitofp i32 %233 to float
  %234 = tail call float @llvm.fmuladd.f32(float %conv.36, float %47, float %232)
  store float %234, ptr %arrayidx33, align 16
  %tobool53.not113 = icmp eq i32 %lgth2, 0
  br i1 %tobool53.not113, label %while.end, label %while.body
...
while.body:                                       ; preds = %for.body31, %for.end66
  ...
  %dec117 = add nsw i32 %dec117.in, -1
  store float 0.000000e+00, ptr %matchpt.0114, align 4
  %235 = load ptr, ptr %cpmxpdnpt.0116, align 8
  %236 = load i32, ptr %235, align 4
  %cmp57109 = icmp sgt i32 %236, -1
  br i1 %cmp57109, label %for.body59.lr.ph, label %for.end66

for.body59.lr.ph:                                 ; preds = %while.body
  %237 = load ptr, ptr %cpmxpdpt.0115, align 8
  br label %for.body59
...
for.body59:                                       ; preds = %for.body59.lr.ph, %for.body59
  ...
  %240 = load float, ptr %arrayidx61, align 4
  %arrayidx63 = getelementptr inbounds float, ptr %237, i64 %indvars.iv131
  %241 = load float, ptr %arrayidx63, align 4
  %242 = tail call float @llvm.fmuladd.f32(float %240, float %241, float %238)
  store float %242, ptr %matchpt.0114, align 4
  %indvars.iv.next132 = add nuw nsw i64 %indvars.iv131, 1
  %arrayidx56 = getelementptr inbounds i32, ptr %235, i64 %indvars.iv.next132
  %243 = load i32, ptr %arrayidx56, align 4
