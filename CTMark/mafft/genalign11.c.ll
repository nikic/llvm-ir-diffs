; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/mafft/genalign11.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/mafft/genalign11.c"
...
if.then21:                                        ; preds = %if.then16
  %11 = load ptr, ptr @genL__align11.w1, align 8
  tail call void @FreeFloatVec(ptr noundef %11) #6
  %12 = load ptr, ptr @genL__align11.w2, align 8
  tail call void @FreeFloatVec(ptr noundef %12) #6
  %13 = load ptr, ptr @genL__align11.match, align 8
  tail call void @FreeFloatVec(ptr noundef %13) #6
  %14 = load ptr, ptr @genL__align11.initverticalw, align 8
  tail call void @FreeFloatVec(ptr noundef %14) #6
  %15 = load ptr, ptr @genL__align11.lastverticalw, align 8
  tail call void @FreeFloatVec(ptr noundef %15) #6
  %16 = load ptr, ptr @genL__align11.m, align 8
  tail call void @FreeFloatVec(ptr noundef %16) #6
  %17 = load ptr, ptr @genL__align11.mp, align 8
  tail call void @FreeIntVec(ptr noundef %17) #6
  %18 = load ptr, ptr @genL__align11.largeM, align 8
  tail call void @FreeFloatVec(ptr noundef %18) #6
  %19 = load ptr, ptr @genL__align11.Mp, align 8
  tail call void @FreeIntVec(ptr noundef %19) #6
  %20 = load ptr, ptr @genL__align11.mseq, align 8
  tail call void @FreeCharMtx(ptr noundef %20) #6
  %21 = load ptr, ptr @genL__align11.cpmx1, align 8
  tail call void @FreeFloatMtx(ptr noundef %21) #6
  %22 = load ptr, ptr @genL__align11.cpmx2, align 8
  tail call void @FreeFloatMtx(ptr noundef %22) #6
  %23 = load ptr, ptr @genL__align11.floatwork, align 8
  tail call void @FreeFloatMtx(ptr noundef %23) #6
  %24 = load ptr, ptr @genL__align11.intwork, align 8
  tail call void @FreeIntMtx(ptr noundef %24) #6
  %.pre574 = load i32, ptr @genL__align11.orlgth1, align 4
  %.pre575 = load i32, ptr @genL__align11.orlgth2, align 4
  br label %if.end22
...
if.end22:                                         ; preds = %if.then21, %if.then16
  ...
  store ptr %call74, ptr @genL__align11.floatwork, align 8
  %call82 = tail call ptr @AllocateIntMtx(i32 noundef 26, i32 noundef %add73) #6
  store ptr %call82, ptr @genL__align11.intwork, align 8
  store i32 %conv24., ptr @genL__align11.orlgth1, align 4
  store i32 %cond41, ptr @genL__align11.orlgth2, align 4
  br label %if.end84

if.end84:                                         ; preds = %if.end, %if.end22
  %28 = phi i32 [ %10, %if.end ], [ %cond41, %if.end22 ]
  %29 = phi i32 [ %7, %if.end ], [ %conv24., %if.end22 ]
  %30 = load ptr, ptr @genL__align11.mseq, align 8
  %31 = load ptr, ptr %30, align 8
  %32 = load ptr, ptr @genL__align11.mseq1, align 8
  store ptr %31, ptr %32, align 8
  %arrayidx87 = getelementptr inbounds ptr, ptr %30, i64 1
  %33 = load ptr, ptr %arrayidx87, align 8
  %34 = load ptr, ptr @genL__align11.mseq2, align 8
...
lor.lhs.false91.if.end119_crit_edge:              ; preds = %if.end84
  %.pre581 = load ptr, ptr @commonJP, align 8
  br label %if.end119
...
if.end100:                                        ; preds = %if.then99, %if.then94
  ...
  store ptr %call115, ptr @commonIP, align 8
  %call118 = tail call ptr @AllocateIntMtx(i32 noundef %add113, i32 noundef %add114) #6
  store ptr %call118, ptr @commonJP, align 8
  store i32 %cond106, ptr @commonAlloc1, align 4
  store i32 %cond112, ptr @commonAlloc2, align 4
  br label %if.end119
...
if.end119:                                        ; preds = %lor.lhs.false91.if.end119_crit_edge, %if.end100
  ...
  store ptr %43, ptr @genL__align11.ijpi, align 8
  store ptr %42, ptr @genL__align11.ijpj, align 8
  %44 = load ptr, ptr @genL__align11.w1, align 8
  %45 = load ptr, ptr @genL__align11.w2, align 8
  %46 = load ptr, ptr @genL__align11.initverticalw, align 8
  %seq2.val475 = load ptr, ptr %seq2, align 8
  %seq1.val476 = load ptr, ptr %seq1, align 8
...
while.body.lr.ph.i:                               ; preds = %if.end119
  %47 = load i8, ptr %seq2.val475, align 1
...
while.body.i.prol:                                ; preds = %while.body.lr.ph.i, %while.body.i.prol
  ...
  %48 = load i8, ptr %seq2.04.i.prol, align 1
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  %51 = load i8, ptr %seq2.04.i, align 1
...
match_calc.exit:                                  ; preds = %while.body.i.prol.loopexit, %while.body.i, %if.end119
  ...
  br i1 %tobool.not1.i477, label %for.end, label %while.body.lr.ph.i478

while.body.lr.ph.i478:                            ; preds = %match_calc.exit
  %59 = load i8, ptr %seq1.val476, align 1
  %idxprom3.i479 = sext i8 %59 to i64
  %xtraiter625 = and i32 %conv11, 3
  %lcmp.mod626.not = icmp eq i32 %xtraiter625, 0
  br i1 %lcmp.mod626.not, label %while.body.i480.prol.loopexit, label %while.body.i480.prol

while.body.i480.prol:                             ; preds = %while.body.lr.ph.i478, %while.body.i480.prol
  %seq2.04.i481.prol = phi ptr [ %incdec.ptr.i485.prol, %while.body.i480.prol ], [ %seq2.val475, %while.body.lr.ph.i478 ]
  %match.addr.03.i482.prol = phi ptr [ %incdec.ptr9.i489.prol, %while.body.i480.prol ], [ %44, %while.body.lr.ph.i478 ]
  %lgth2.addr.02.i483.prol = phi i32 [ %dec.i484.prol, %while.body.i480.prol ], [ %conv11, %while.body.lr.ph.i478 ]
  %prol.iter627 = phi i32 [ %prol.iter627.next, %while.body.i480.prol ], [ 0, %while.body.lr.ph.i478 ]
  %dec.i484.prol = add nsw i32 %lgth2.addr.02.i483.prol, -1
  %incdec.ptr.i485.prol = getelementptr inbounds i8, ptr %seq2.04.i481.prol, i64 1
  %60 = load i8, ptr %seq2.04.i481.prol, align 1
  %idxprom6.i486.prol = sext i8 %60 to i64
  %arrayidx7.i487.prol = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom3.i479, i64 %idxprom6.i486.prol
  %61 = load i32, ptr %arrayidx7.i487.prol, align 4
  %conv8.i488.prol = sitofp i32 %61 to float
  %incdec.ptr9.i489.prol = getelementptr inbounds float, ptr %match.addr.03.i482.prol, i64 1
  store float %conv8.i488.prol, ptr %match.addr.03.i482.prol, align 4
  %prol.iter627.next = add i32 %prol.iter627, 1
  %prol.iter627.cmp.not = icmp eq i32 %prol.iter627.next, %xtraiter625
  br i1 %prol.iter627.cmp.not, label %while.body.i480.prol.loopexit, label %while.body.i480.prol

while.body.i480.prol.loopexit:                    ; preds = %while.body.i480.prol, %while.body.lr.ph.i478
  %seq2.04.i481.unr = phi ptr [ %seq2.val475, %while.body.lr.ph.i478 ], [ %incdec.ptr.i485.prol, %while.body.i480.prol ]
  %match.addr.03.i482.unr = phi ptr [ %44, %while.body.lr.ph.i478 ], [ %incdec.ptr9.i489.prol, %while.body.i480.prol ]
  %lgth2.addr.02.i483.unr = phi i32 [ %conv11, %while.body.lr.ph.i478 ], [ %dec.i484.prol, %while.body.i480.prol ]
  %62 = icmp ult i32 %conv11, 4
  br i1 %62, label %match_calc.exit491, label %while.body.i480

while.body.i480:                                  ; preds = %while.body.i480.prol.loopexit, %while.body.i480
  %seq2.04.i481 = phi ptr [ %incdec.ptr.i485.3, %while.body.i480 ], [ %seq2.04.i481.unr, %while.body.i480.prol.loopexit ]
  %match.addr.03.i482 = phi ptr [ %incdec.ptr9.i489.3, %while.body.i480 ], [ %match.addr.03.i482.unr, %while.body.i480.prol.loopexit ]
  %lgth2.addr.02.i483 = phi i32 [ %dec.i484.3, %while.body.i480 ], [ %lgth2.addr.02.i483.unr, %while.body.i480.prol.loopexit ]
  %incdec.ptr.i485 = getelementptr inbounds i8, ptr %seq2.04.i481, i64 1
  %63 = load i8, ptr %seq2.04.i481, align 1
  %idxprom6.i486 = sext i8 %63 to i64
  %arrayidx7.i487 = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom3.i479, i64 %idxprom6.i486
  %64 = load i32, ptr %arrayidx7.i487, align 4
  %conv8.i488 = sitofp i32 %64 to float
  %incdec.ptr9.i489 = getelementptr inbounds float, ptr %match.addr.03.i482, i64 1
  store float %conv8.i488, ptr %match.addr.03.i482, align 4
  %incdec.ptr.i485.1 = getelementptr inbounds i8, ptr %seq2.04.i481, i64 2
  %65 = load i8, ptr %incdec.ptr.i485, align 1
  %idxprom6.i486.1 = sext i8 %65 to i64
  %arrayidx7.i487.1 = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom3.i479, i64 %idxprom6.i486.1
  %66 = load i32, ptr %arrayidx7.i487.1, align 4
  %conv8.i488.1 = sitofp i32 %66 to float
  %incdec.ptr9.i489.1 = getelementptr inbounds float, ptr %match.addr.03.i482, i64 2
  store float %conv8.i488.1, ptr %incdec.ptr9.i489, align 4
  %incdec.ptr.i485.2 = getelementptr inbounds i8, ptr %seq2.04.i481, i64 3
  %67 = load i8, ptr %incdec.ptr.i485.1, align 1
  %idxprom6.i486.2 = sext i8 %67 to i64
  %arrayidx7.i487.2 = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom3.i479, i64 %idxprom6.i486.2
  %68 = load i32, ptr %arrayidx7.i487.2, align 4
  %conv8.i488.2 = sitofp i32 %68 to float
  %incdec.ptr9.i489.2 = getelementptr inbounds float, ptr %match.addr.03.i482, i64 3
  store float %conv8.i488.2, ptr %incdec.ptr9.i489.1, align 4
  %dec.i484.3 = add nsw i32 %lgth2.addr.02.i483, -4
  %incdec.ptr.i485.3 = getelementptr inbounds i8, ptr %seq2.04.i481, i64 4
  %69 = load i8, ptr %incdec.ptr.i485.2, align 1
  %idxprom6.i486.3 = sext i8 %69 to i64
  %arrayidx7.i487.3 = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom3.i479, i64 %idxprom6.i486.3
  %70 = load i32, ptr %arrayidx7.i487.3, align 4
  %conv8.i488.3 = sitofp i32 %70 to float
  %incdec.ptr9.i489.3 = getelementptr inbounds float, ptr %match.addr.03.i482, i64 4
  store float %conv8.i488.3, ptr %incdec.ptr9.i489.2, align 4
  %tobool.not.i490.3 = icmp eq i32 %dec.i484.3, 0
  br i1 %tobool.not.i490.3, label %match_calc.exit491, label %while.body.i480

match_calc.exit491:                               ; preds = %while.body.i480, %while.body.i480.prol.loopexit
...
for.body.lr.ph:                                   ; preds = %match_calc.exit491
  %71 = load ptr, ptr @genL__align11.m, align 8
  %72 = load ptr, ptr @genL__align11.mp, align 8
  %73 = load ptr, ptr @genL__align11.largeM, align 8
  %74 = load ptr, ptr @genL__align11.Mp, align 8
  %75 = add i64 %call10, 1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %79, align 4
  %80 = getelementptr inbounds float, ptr %71, i64 %offset.idx
  store <4 x float> %wide.load, ptr %80, align 4
  ...
  store <4 x float> %wide.load, ptr %82, align 4
  %83 = getelementptr inbounds i32, ptr %74, i64 %offset.idx
  store <4 x i32> zeroinitializer, ptr %83, align 4
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  ...
  %90 = load float, ptr %arrayidx124, align 4
...
for.end:                                          ; preds = %for.body.prol.loopexit, %for.body, %middle.block, %match_calc.exit, %match_calc.exit491
  ...
  %94 = load float, ptr %arrayidx138, align 4
  %95 = load ptr, ptr @genL__align11.lastverticalw, align 8
...
for.body146.lr.ph:                                ; preds = %for.end
  %96 = load ptr, ptr @genL__align11.m, align 8
  %97 = load ptr, ptr @genL__align11.largeM, align 8
  %98 = load ptr, ptr @genL__align11.mp, align 8
  %99 = load ptr, ptr @genL__align11.Mp, align 8
  %wide.trip.count572 = zext i32 %add140 to i64
  %xtraiter631 = and i32 %conv11, 3
...
for.body146:                                      ; preds = %for.body146.lr.ph, %for.end239
  ...
  %102 = load float, ptr %arrayidx149, align 4
  store float %102, ptr %currentw.0555, align 4
  br i1 %tobool.not1.i477, label %match_calc.exit506, label %while.body.lr.ph.i493

while.body.lr.ph.i493:                            ; preds = %for.body146
  %arrayidx1.i = getelementptr inbounds i8, ptr %seq1.val476, i64 %indvars.iv568
  %103 = load i8, ptr %arrayidx1.i, align 1
  %idxprom3.i494 = sext i8 %103 to i64
  br i1 %lcmp.mod632.not, label %while.body.i495.prol.loopexit, label %while.body.i495.prol

while.body.i495.prol:                             ; preds = %while.body.lr.ph.i493, %while.body.i495.prol
  %seq2.04.i496.prol = phi ptr [ %incdec.ptr.i500.prol, %while.body.i495.prol ], [ %seq2.val475, %while.body.lr.ph.i493 ]
  %match.addr.03.i497.prol = phi ptr [ %incdec.ptr9.i504.prol, %while.body.i495.prol ], [ %previousw.0554, %while.body.lr.ph.i493 ]
  %lgth2.addr.02.i498.prol = phi i32 [ %dec.i499.prol, %while.body.i495.prol ], [ %conv11, %while.body.lr.ph.i493 ]
  %prol.iter633 = phi i32 [ %prol.iter633.next, %while.body.i495.prol ], [ 0, %while.body.lr.ph.i493 ]
  %dec.i499.prol = add nsw i32 %lgth2.addr.02.i498.prol, -1
  %incdec.ptr.i500.prol = getelementptr inbounds i8, ptr %seq2.04.i496.prol, i64 1
  %104 = load i8, ptr %seq2.04.i496.prol, align 1
  %idxprom6.i501.prol = sext i8 %104 to i64
  %arrayidx7.i502.prol = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom3.i494, i64 %idxprom6.i501.prol
  %105 = load i32, ptr %arrayidx7.i502.prol, align 4
  %conv8.i503.prol = sitofp i32 %105 to float
  %incdec.ptr9.i504.prol = getelementptr inbounds float, ptr %match.addr.03.i497.prol, i64 1
  store float %conv8.i503.prol, ptr %match.addr.03.i497.prol, align 4
  %prol.iter633.next = add i32 %prol.iter633, 1
  %prol.iter633.cmp.not = icmp eq i32 %prol.iter633.next, %xtraiter631
  br i1 %prol.iter633.cmp.not, label %while.body.i495.prol.loopexit, label %while.body.i495.prol

while.body.i495.prol.loopexit:                    ; preds = %while.body.i495.prol, %while.body.lr.ph.i493
  %seq2.04.i496.unr = phi ptr [ %seq2.val475, %while.body.lr.ph.i493 ], [ %incdec.ptr.i500.prol, %while.body.i495.prol ]
  %match.addr.03.i497.unr = phi ptr [ %previousw.0554, %while.body.lr.ph.i493 ], [ %incdec.ptr9.i504.prol, %while.body.i495.prol ]
  %lgth2.addr.02.i498.unr = phi i32 [ %conv11, %while.body.lr.ph.i493 ], [ %dec.i499.prol, %while.body.i495.prol ]
  br i1 %100, label %match_calc.exit506, label %while.body.i495

while.body.i495:                                  ; preds = %while.body.i495.prol.loopexit, %while.body.i495
  %seq2.04.i496 = phi ptr [ %incdec.ptr.i500.3, %while.body.i495 ], [ %seq2.04.i496.unr, %while.body.i495.prol.loopexit ]
  %match.addr.03.i497 = phi ptr [ %incdec.ptr9.i504.3, %while.body.i495 ], [ %match.addr.03.i497.unr, %while.body.i495.prol.loopexit ]
  %lgth2.addr.02.i498 = phi i32 [ %dec.i499.3, %while.body.i495 ], [ %lgth2.addr.02.i498.unr, %while.body.i495.prol.loopexit ]
  %incdec.ptr.i500 = getelementptr inbounds i8, ptr %seq2.04.i496, i64 1
  %106 = load i8, ptr %seq2.04.i496, align 1
  %idxprom6.i501 = sext i8 %106 to i64
  %arrayidx7.i502 = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom3.i494, i64 %idxprom6.i501
  %107 = load i32, ptr %arrayidx7.i502, align 4
  %conv8.i503 = sitofp i32 %107 to float
  %incdec.ptr9.i504 = getelementptr inbounds float, ptr %match.addr.03.i497, i64 1
  store float %conv8.i503, ptr %match.addr.03.i497, align 4
  %incdec.ptr.i500.1 = getelementptr inbounds i8, ptr %seq2.04.i496, i64 2
  %108 = load i8, ptr %incdec.ptr.i500, align 1
  %idxprom6.i501.1 = sext i8 %108 to i64
  %arrayidx7.i502.1 = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom3.i494, i64 %idxprom6.i501.1
  %109 = load i32, ptr %arrayidx7.i502.1, align 4
  %conv8.i503.1 = sitofp i32 %109 to float
  %incdec.ptr9.i504.1 = getelementptr inbounds float, ptr %match.addr.03.i497, i64 2
  store float %conv8.i503.1, ptr %incdec.ptr9.i504, align 4
  %incdec.ptr.i500.2 = getelementptr inbounds i8, ptr %seq2.04.i496, i64 3
  %110 = load i8, ptr %incdec.ptr.i500.1, align 1
  %idxprom6.i501.2 = sext i8 %110 to i64
  %arrayidx7.i502.2 = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom3.i494, i64 %idxprom6.i501.2
  %111 = load i32, ptr %arrayidx7.i502.2, align 4
  %conv8.i503.2 = sitofp i32 %111 to float
  %incdec.ptr9.i504.2 = getelementptr inbounds float, ptr %match.addr.03.i497, i64 3
  store float %conv8.i503.2, ptr %incdec.ptr9.i504.1, align 4
  %dec.i499.3 = add nsw i32 %lgth2.addr.02.i498, -4
  %incdec.ptr.i500.3 = getelementptr inbounds i8, ptr %seq2.04.i496, i64 4
  %112 = load i8, ptr %incdec.ptr.i500.2, align 1
  %idxprom6.i501.3 = sext i8 %112 to i64
  %arrayidx7.i502.3 = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom3.i494, i64 %idxprom6.i501.3
  %113 = load i32, ptr %arrayidx7.i502.3, align 4
  %conv8.i503.3 = sitofp i32 %113 to float
  %incdec.ptr9.i504.3 = getelementptr inbounds float, ptr %match.addr.03.i497, i64 4
  store float %conv8.i503.3, ptr %incdec.ptr9.i504.2, align 4
  %tobool.not.i505.3 = icmp eq i32 %dec.i499.3, 0
  br i1 %tobool.not.i505.3, label %match_calc.exit506, label %while.body.i495

match_calc.exit506:                               ; preds = %while.body.i495.prol.loopexit, %while.body.i495, %for.body146
  %arrayidx152 = getelementptr inbounds float, ptr %46, i64 %indvars.iv568
  %114 = load float, ptr %arrayidx152, align 4
  store float %114, ptr %previousw.0554, align 4
  br i1 %cmp121.not510587, label %for.end239, label %for.body170.preheader

for.body170.preheader:                            ; preds = %match_calc.exit506
  %115 = load float, ptr %currentw.0555, align 4
...
for.body170:                                      ; preds = %for.body170.preheader, %if.end228
  ...
  %121 = load float, ptr %prept.0529, align 4
  store i32 %118, ptr %ijpipt.0543, align 4
  ...
  store i32 %storemerge, ptr %ijpjpt.0542, align 4
  ...
  %122 = load float, ptr %mjpt.0541, align 4
...
if.then187:                                       ; preds = %for.body170
  %123 = load i32, ptr %mpjpt.0539, align 4
  store i32 %123, ptr %ijpipt.0543, align 4
  store i32 %sub172, ptr %ijpjpt.0542, align 4
  br label %if.end189
...
if.then199:                                       ; preds = %if.end194
  store i32 %tbki.0532, ptr %ijpipt.0543, align 4
  store i32 %tbkj.0533, ptr %ijpjpt.0542, align 4
  br label %if.end200
...
if.end210:                                        ; preds = %if.then208, %if.end200
  ...
  %127 = load float, ptr %prept.0529, align 4
  %cmp211 = fcmp ogt float %127, %125
  br i1 %cmp211, label %if.then213, label %if.end215

if.then213:                                       ; preds = %if.end210
  store float %127, ptr %Mjpt.0540, align 4
  store i32 %118, ptr %Mpjpt.0538, align 4
  %.pre582 = load float, ptr %prept.0529, align 4
  br label %if.end215
...
if.then227:                                       ; preds = %if.end215
  store i32 %add141, ptr %ijpipt.0543, align 4
  br label %if.end228

if.end228:                                        ; preds = %if.then227, %if.end215
  %wm.3 = phi float [ %fneg, %if.then227 ], [ %wm.2, %if.end215 ]
  %130 = load float, ptr %curpt.0537, align 4
  %add229 = fadd float %wm.3, %130
  store float %add229, ptr %curpt.0537, align 4
  ...
  br i1 %exitcond567.not, label %for.end239, label %for.body170
...
for.end247:                                       ; preds = %for.end239, %for.end
  ...
  %132 = load ptr, ptr %arrayidx249, align 8
...
if.then254:                                       ; preds = %for.end247
  ...
  %134 = load ptr, ptr %seq2, align 8
  store i8 0, ptr %134, align 1
  store i32 0, ptr %off2pt, align 4
  store i32 0, ptr %off1pt, align 4
  br label %cleanup

if.end259:                                        ; preds = %for.end247
  %135 = load ptr, ptr @genL__align11.mseq1, align 8
  %136 = load ptr, ptr @genL__align11.mseq2, align 8
...
for.cond10.preheader.i.loopexit.unr-lcssa:        ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  br i1 %lcmp.mod635.not, label %for.cond10.preheader.i, label %for.body.i.epil
...
for.body.i.epil:                                  ; preds = %for.cond10.preheader.i.loopexit.unr-lcssa, %for.body.i.epil
  ...
  %140 = load ptr, ptr %arrayidx5.i.epil, align 8
  store i32 %add141, ptr %140, align 4
  %arrayidx8.i.epil = getelementptr inbounds ptr, ptr %42, i64 %indvars.iv.i.epil
  %141 = load ptr, ptr %arrayidx8.i.epil, align 8
  store i32 %add141, ptr %141, align 4
...
for.body14.lr.ph.i:                               ; preds = %for.cond10.preheader.i
  ...
  %or.cond624 = select i1 %min.iters.check613, i1 true, i1 %diff.check
  br i1 %or.cond624, label %for.body14.i.preheader, label %vector.ph614
...
vector.body619:                                   ; preds = %vector.body619, %vector.ph614
  %index620 = phi i64 [ 0, %vector.ph614 ], [ %index.next621, %vector.body619 ]
  %148 = getelementptr inbounds i32, ptr %142, i64 %index620
  store <4 x i32> %broadcast.splat, ptr %148, align 4
  %149 = getelementptr inbounds i32, ptr %148, i64 4
  store <4 x i32> %broadcast.splat, ptr %149, align 4
  %150 = getelementptr inbounds i32, ptr %143, i64 %index620
  store <4 x i32> %broadcast.splat, ptr %150, align 4
  %151 = getelementptr inbounds i32, ptr %150, i64 4
  store <4 x i32> %broadcast.splat, ptr %151, align 4
  %index.next621 = add nuw i64 %index620, 8
  %152 = icmp eq i64 %index.next621, %n.vec616
  br i1 %152, label %middle.block611, label %vector.body619
...
for.body14.i.preheader:                           ; preds = %for.body14.lr.ph.i, %middle.block611
  ...
  %xtraiter636 = and i64 %153, 3
  %lcmp.mod637.not = icmp eq i64 %xtraiter636, 0
  br i1 %lcmp.mod637.not, label %for.body14.i.prol.loopexit, label %for.body14.i.prol
...
for.body14.i.prol:                                ; preds = %for.body14.i.preheader, %for.body14.i.prol
  ...
  %prol.iter638 = phi i64 [ %prol.iter638.next, %for.body14.i.prol ], [ 0, %for.body14.i.preheader ]
  %arrayidx17.i.prol = getelementptr inbounds i32, ptr %142, i64 %indvars.iv28.i.prol
  store i32 %add141, ptr %arrayidx17.i.prol, align 4
  %arrayidx20.i.prol = getelementptr inbounds i32, ptr %143, i64 %indvars.iv28.i.prol
  store i32 %add141, ptr %arrayidx20.i.prol, align 4
  ...
  br i1 %prol.iter638.cmp.not, label %for.body14.i.prol.loopexit, label %for.body14.i.prol
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i.new
  ...
  %157 = load ptr, ptr %arrayidx5.i, align 8
  store i32 %add141, ptr %157, align 4
  %arrayidx8.i = getelementptr inbounds ptr, ptr %42, i64 %indvars.iv.i
  %158 = load ptr, ptr %arrayidx8.i, align 8
  store i32 %add141, ptr %158, align 4
  %indvars.iv.next.i = or i64 %indvars.iv.i, 1
  %arrayidx5.i.1 = getelementptr inbounds ptr, ptr %43, i64 %indvars.iv.next.i
  %159 = load ptr, ptr %arrayidx5.i.1, align 8
  store i32 %add141, ptr %159, align 4
  %arrayidx8.i.1 = getelementptr inbounds ptr, ptr %42, i64 %indvars.iv.next.i
  %160 = load ptr, ptr %arrayidx8.i.1, align 8
  store i32 %add141, ptr %160, align 4
  %indvars.iv.next.i.1 = or i64 %indvars.iv.i, 2
  %arrayidx5.i.2 = getelementptr inbounds ptr, ptr %43, i64 %indvars.iv.next.i.1
  %161 = load ptr, ptr %arrayidx5.i.2, align 8
  store i32 %add141, ptr %161, align 4
  %arrayidx8.i.2 = getelementptr inbounds ptr, ptr %42, i64 %indvars.iv.next.i.1
  %162 = load ptr, ptr %arrayidx8.i.2, align 8
  store i32 %add141, ptr %162, align 4
  %indvars.iv.next.i.2 = or i64 %indvars.iv.i, 3
  %arrayidx5.i.3 = getelementptr inbounds ptr, ptr %43, i64 %indvars.iv.next.i.2
  %163 = load ptr, ptr %arrayidx5.i.3, align 8
  store i32 %add141, ptr %163, align 4
  %arrayidx8.i.3 = getelementptr inbounds ptr, ptr %42, i64 %indvars.iv.next.i.2
  %164 = load ptr, ptr %arrayidx8.i.3, align 8
  store i32 %add141, ptr %164, align 4
...
for.body14.i:                                     ; preds = %for.body14.i.prol.loopexit, %for.body14.i
  ...
  store i32 %add141, ptr %arrayidx17.i.2, align 4
  %arrayidx20.i.2 = getelementptr inbounds i32, ptr %143, i64 %indvars.iv.next29.i.1
  store i32 %add141, ptr %arrayidx20.i.2, align 4
  ...
  store i32 %add141, ptr %arrayidx17.i.3, align 4
  %arrayidx20.i.3 = getelementptr inbounds i32, ptr %143, i64 %indvars.iv.next29.i.2
  store i32 %add141, ptr %arrayidx20.i.3, align 4
  ...
  br i1 %exitcond32.not.i.3, label %for.end23.i, label %for.body14.i
...
while.body.preheader.i:                           ; preds = %for.body36.i
  ...
  %xtraiter639 = and i32 %dec5.i, 1
  %lcmp.mod640.not = icmp eq i32 %xtraiter639, 0
  br i1 %lcmp.mod640.not, label %while.body.i507.prol.loopexit, label %while.body.i507.prol

while.body.i507.prol:                             ; preds = %while.body.preheader.i
  %173 = load ptr, ptr %seq1, align 8
  %174 = add nsw i64 %170, %171
  %arrayidx48.i.prol = getelementptr inbounds i8, ptr %173, i64 %174
  %175 = load i8, ptr %arrayidx48.i.prol, align 1
  %176 = load ptr, ptr %135, align 8
  %incdec.ptr.i508.prol = getelementptr inbounds i8, ptr %176, i64 -1
  store ptr %incdec.ptr.i508.prol, ptr %135, align 8
  store i8 %175, ptr %incdec.ptr.i508.prol, align 1
  %177 = load ptr, ptr %136, align 8
  %incdec.ptr51.i.prol = getelementptr inbounds i8, ptr %177, i64 -1
  store ptr %incdec.ptr51.i.prol, ptr %136, align 8
  store i8 45, ptr %incdec.ptr51.i.prol, align 1
  %indvars.iv.next34.i.prol = add nsw i64 %170, -1
  br label %while.body.i507.prol.loopexit

while.body.i507.prol.loopexit:                    ; preds = %while.body.i507.prol, %while.body.preheader.i
  %indvars.iv33.i.unr = phi i64 [ %170, %while.body.preheader.i ], [ %indvars.iv.next34.i.prol, %while.body.i507.prol ]
  %178 = icmp eq i32 %172, %.fr.i
  br i1 %178, label %while.end.loopexit.i, label %while.body.i507

while.body.i507:                                  ; preds = %while.body.i507.prol.loopexit, %while.body.i507
  %indvars.iv33.i = phi i64 [ %indvars.iv.next34.i.1, %while.body.i507 ], [ %indvars.iv33.i.unr, %while.body.i507.prol.loopexit ]
  %179 = load ptr, ptr %seq1, align 8
  %180 = add nsw i64 %indvars.iv33.i, %171
  %arrayidx48.i = getelementptr inbounds i8, ptr %179, i64 %180
  %181 = load i8, ptr %arrayidx48.i, align 1
  %182 = load ptr, ptr %135, align 8
  %incdec.ptr.i508 = getelementptr inbounds i8, ptr %182, i64 -1
  store ptr %incdec.ptr.i508, ptr %135, align 8
  store i8 %181, ptr %incdec.ptr.i508, align 1
  %183 = load ptr, ptr %136, align 8
  %incdec.ptr51.i = getelementptr inbounds i8, ptr %183, i64 -1
  store ptr %incdec.ptr51.i, ptr %136, align 8
  store i8 45, ptr %incdec.ptr51.i, align 1
  ...
  %186 = load i8, ptr %arrayidx48.i.1, align 1
  %187 = load ptr, ptr %135, align 8
  %incdec.ptr.i508.1 = getelementptr inbounds i8, ptr %187, i64 -1
  store ptr %incdec.ptr.i508.1, ptr %135, align 8
  store i8 %186, ptr %incdec.ptr.i508.1, align 1
  %188 = load ptr, ptr %136, align 8
  %incdec.ptr51.i.1 = getelementptr inbounds i8, ptr %188, i64 -1
  store ptr %incdec.ptr51.i.1, ptr %136, align 8
  store i8 45, ptr %incdec.ptr51.i.1, align 1
  %indvars.iv.next34.i.1 = add nsw i64 %indvars.iv33.i, -2
  %189 = and i64 %indvars.iv.next34.i.1, 4294967295
  %tobool.not.i509.1 = icmp eq i64 %189, 0
  br i1 %tobool.not.i509.1, label %while.end.loopexit.i, label %while.body.i507

while.end.loopexit.i:                             ; preds = %while.body.i507, %while.body.i507.prol.loopexit
...
while.body57.preheader.i:                         ; preds = %while.end.i
  ...
  %xtraiter642 = and i32 %dec559.i, 1
  %lcmp.mod643.not = icmp eq i32 %xtraiter642, 0
  br i1 %lcmp.mod643.not, label %while.body57.i.prol.loopexit, label %while.body57.i.prol
...
while.body57.i.prol:                              ; preds = %while.body57.preheader.i
  ...
  store ptr %incdec.ptr60.i.prol, ptr %135, align 8
  store i8 45, ptr %incdec.ptr60.i.prol, align 1
  %197 = load ptr, ptr %seq2, align 8
  %198 = add nsw i64 %193, %194
  %arrayidx64.i.prol = getelementptr inbounds i8, ptr %197, i64 %198
  %199 = load i8, ptr %arrayidx64.i.prol, align 1
  %200 = load ptr, ptr %136, align 8
  %incdec.ptr66.i.prol = getelementptr inbounds i8, ptr %200, i64 -1
  store ptr %incdec.ptr66.i.prol, ptr %136, align 8
  store i8 %199, ptr %incdec.ptr66.i.prol, align 1
...
while.body57.i:                                   ; preds = %while.body57.i.prol.loopexit, %while.body57.i
  ...
  store ptr %incdec.ptr60.i, ptr %135, align 8
  store i8 45, ptr %incdec.ptr60.i, align 1
  %203 = load ptr, ptr %seq2, align 8
  %204 = add nsw i64 %indvars.iv37.i, %194
  %arrayidx64.i = getelementptr inbounds i8, ptr %203, i64 %204
  %205 = load i8, ptr %arrayidx64.i, align 1
  %206 = load ptr, ptr %136, align 8
  %incdec.ptr66.i = getelementptr inbounds i8, ptr %206, i64 -1
  store ptr %incdec.ptr66.i, ptr %136, align 8
  store i8 %205, ptr %incdec.ptr66.i, align 1
  ...
  store ptr %incdec.ptr60.i.1, ptr %135, align 8
  store i8 45, ptr %incdec.ptr60.i.1, align 1
  %208 = load ptr, ptr %seq2, align 8
  %209 = add nsw i64 %indvars.iv.next38.i, %194
  %arrayidx64.i.1 = getelementptr inbounds i8, ptr %208, i64 %209
  %210 = load i8, ptr %arrayidx64.i.1, align 1
  %211 = load ptr, ptr %136, align 8
  %incdec.ptr66.i.1 = getelementptr inbounds i8, ptr %211, i64 -1
  store ptr %incdec.ptr66.i.1, ptr %136, align 8
  store i8 %210, ptr %incdec.ptr66.i.1, align 1
  ...
  br i1 %tobool56.not.i.1, label %while.end68.i, label %while.body57.i
...
if.end90.i:                                       ; preds = %if.end.i
  ...
  %221 = load ptr, ptr %arrayidx92.i, align 8
  %arrayidx94.i = getelementptr inbounds i32, ptr %221, i64 %idxprom79.i
  %222 = load i32, ptr %arrayidx94.i, align 4
  ...
  br i1 %or.cond54.i, label %for.end102.i, label %for.body36.i
...
for.end102.i:                                     ; preds = %if.end90.i, %if.end.i, %while.end68.i
  ...
  store i32 %spec.select.i, ptr %off1pt, align 4
...
gentracking.exit:                                 ; preds = %.thread.i, %for.end102.i
  ...
  store i32 %223, ptr %off2pt, align 4
...
if.then269:                                       ; preds = %gentracking.exit
  ...
  %.pre583 = load ptr, ptr @genL__align11.mseq1, align 8
  %.pre584 = load ptr, ptr %.pre583, align 8
  %.pre585 = load ptr, ptr @genL__align11.mseq2, align 8
  br label %if.end271
