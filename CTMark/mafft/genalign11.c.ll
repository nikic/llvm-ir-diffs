...
while.body.i480.prol:                             ; preds = %while.body.lr.ph.i478, %while.body.i480.prol
  ...
  %60 = load i8, ptr %seq2.04.i481.prol, align 1, !tbaa !11
  ...
  %61 = load i32, ptr %arrayidx7.i487.prol, align 4, !tbaa !5
  ...
  store float %conv8.i488.prol, ptr %match.addr.03.i482.prol, align 4, !tbaa !12
  %prol.iter627.next = add i32 %prol.iter627, 1
  %prol.iter627.cmp.not = icmp eq i32 %prol.iter627.next, %xtraiter625
  br i1 %prol.iter627.cmp.not, label %while.body.i480.prol.loopexit, label %while.body.i480.prol, !llvm.loop !18
...
while.body.i480:                                  ; preds = %while.body.i480.prol.loopexit, %while.body.i480
  ...
  %63 = load i8, ptr %seq2.04.i481, align 1, !tbaa !11
  ...
  %70 = load i32, ptr %arrayidx7.i487.3, align 4, !tbaa !5
  %conv8.i488.3 = sitofp i32 %70 to float
  %incdec.ptr9.i489.3 = getelementptr inbounds float, ptr %match.addr.03.i482, i64 4
  store float %conv8.i488.3, ptr %incdec.ptr9.i489.2, align 4, !tbaa !12
  %tobool.not.i490.3 = icmp eq i32 %dec.i484.3, 0
  br i1 %tobool.not.i490.3, label %match_calc.exit491, label %while.body.i480, !llvm.loop !16
...
while.body.i495.prol:                             ; preds = %while.body.lr.ph.i493, %while.body.i495.prol
  ...
  %104 = load i8, ptr %seq2.04.i496.prol, align 1, !tbaa !11
  ...
  %105 = load i32, ptr %arrayidx7.i502.prol, align 4, !tbaa !5
  ...
  store float %conv8.i503.prol, ptr %match.addr.03.i497.prol, align 4, !tbaa !12
  %prol.iter633.next = add i32 %prol.iter633, 1
  %prol.iter633.cmp.not = icmp eq i32 %prol.iter633.next, %xtraiter631
  br i1 %prol.iter633.cmp.not, label %while.body.i495.prol.loopexit, label %while.body.i495.prol, !llvm.loop !35
...
while.body.i495:                                  ; preds = %while.body.i495.prol.loopexit, %while.body.i495
  ...
  %106 = load i8, ptr %seq2.04.i496, align 1, !tbaa !11
  ...
  %113 = load i32, ptr %arrayidx7.i502.3, align 4, !tbaa !5
  %conv8.i503.3 = sitofp i32 %113 to float
  %incdec.ptr9.i504.3 = getelementptr inbounds float, ptr %match.addr.03.i497, i64 4
  store float %conv8.i503.3, ptr %incdec.ptr9.i504.2, align 4, !tbaa !12
  %tobool.not.i505.3 = icmp eq i32 %dec.i499.3, 0
  br i1 %tobool.not.i505.3, label %match_calc.exit506, label %while.body.i495, !llvm.loop !16
...
vector.body619:                                   ; preds = %vector.body619, %vector.ph614
  ...
  store <4 x i32> %broadcast.splat, ptr %149, align 4, !tbaa !5
  ...
  store <4 x i32> %broadcast.splat, ptr %151, align 4, !tbaa !5
...
for.body14.i.prol:                                ; preds = %for.body14.i.preheader, %for.body14.i.prol
  ...
  br i1 %prol.iter638.cmp.not, label %for.body14.i.prol.loopexit, label %for.body14.i.prol, !llvm.loop !40
...
while.body.i507.prol:                             ; preds = %while.body.preheader.i
  ...
  store ptr %incdec.ptr.i508.prol, ptr %135, align 8, !tbaa !9
  store i8 %175, ptr %incdec.ptr.i508.prol, align 1, !tbaa !11
...
while.body.i507:                                  ; preds = %while.body.i507.prol.loopexit, %while.body.i507
  ...
  store ptr %incdec.ptr.i508, ptr %135, align 8, !tbaa !9
  store i8 %181, ptr %incdec.ptr.i508, align 1, !tbaa !11
  ...
  store ptr %incdec.ptr.i508.1, ptr %135, align 8, !tbaa !9
  store i8 %186, ptr %incdec.ptr.i508.1, align 1, !tbaa !11
  ...
  br i1 %tobool.not.i509.1, label %while.end.loopexit.i, label %while.body.i507, !llvm.loop !43
