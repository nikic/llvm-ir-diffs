; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/mafft/MSalignmm.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/mafft/MSalignmm.c"
...
for.inc49:                                        ; preds = %for.body38
  ...
  br i1 %exitcond388.not, label %for.end51, label %for.body38
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load428 = load <4 x float>, ptr %22, align 4
...
vector.body443:                                   ; preds = %vector.body443, %vector.ph438
  ...
  %wide.load445 = load <4 x float>, ptr %30, align 4
  ...
  %wide.load448 = load <4 x float>, ptr %36, align 4
  ...
  br i1 %42, label %middle.block435, label %vector.body443
...
for.body57:                                       ; preds = %for.body57.preheader, %for.body57
  ...
  br i1 %exitcond393.not, label %for.cond79.preheader, label %for.body57
...
for.body82:                                       ; preds = %for.body82.preheader, %for.body82
  ...
  br i1 %exitcond398.not, label %for.end105, label %for.body82
...
for.body116:                                      ; preds = %for.body116.preheader, %for.body116
  ...
  %47 = load ptr, ptr %arrayidx118, align 8
  %arrayidx120 = getelementptr inbounds ptr, ptr %call11, i64 %indvars.iv399
  %48 = load ptr, ptr %arrayidx120, align 8
  ...
  br i1 %exitcond403.not, label %for.cond125.preheader, label %for.body116
...
for.body128:                                      ; preds = %for.body128.preheader, %for.body128
  ...
  %49 = load ptr, ptr %arrayidx130, align 8
  ...
  br i1 %exitcond408.not, label %for.end136, label %for.body128

for.end136:                                       ; preds = %for.body128, %for.cond125.preheader
  %51 = load ptr, ptr %seq1, align 8
...
for.body166:                                      ; preds = %for.body166.lr.ph, %for.inc177
  ...
  %61 = load ptr, ptr %arrayidx168, align 8
...
for.inc177:                                       ; preds = %for.body166
  ...
  br i1 %exitcond413.not, label %for.cond180.preheader, label %for.body166
...
for.body183:                                      ; preds = %for.body183.lr.ph, %for.inc194
  ...
  %66 = load ptr, ptr %arrayidx185, align 8
...
for.inc194:                                       ; preds = %for.body183
  ...
  br i1 %exitcond418.not, label %for.end196, label %for.body183
...
entry:
  ...
  %0 = load ptr, ptr %gapinfo, align 8
  ...
  %4 = load i32, ptr @reccycle, align 4
  %inc10 = add nsw i32 %4, 1
  store i32 %inc10, ptr @reccycle, align 4
  %sub = sub i32 %ien, %ist
  %add = add i32 %sub, 1
...
for.cond.preheader:                               ; preds = %entry
  %cmp131422 = icmp sgt i32 %icyc, 0
  br i1 %cmp131422, label %for.body.lr.ph, label %for.cond24.preheader

for.body.lr.ph:                                   ; preds = %for.cond.preheader
  %conv = sext i32 %add to i64
  %wide.trip.count1569 = zext i32 %icyc to i64
  br label %for.body

for.cond24.preheader:                             ; preds = %for.body, %for.cond.preheader
  %cmp251426 = icmp sgt i32 %jcyc, 0
  br i1 %cmp251426, label %for.body27.lr.ph, label %common.ret

for.body27.lr.ph:                                 ; preds = %for.cond24.preheader
  %cmp32.not1424 = icmp slt i32 %sub, 0
  %wide.trip.count1576 = zext i32 %jcyc to i64
  br label %for.body27

for.body:                                         ; preds = %for.body.lr.ph, %for.body
  %indvars.iv1565 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next1566, %for.body ]
  %arrayidx14 = getelementptr inbounds ptr, ptr %mseq1, i64 %indvars.iv1565
  %5 = load ptr, ptr %arrayidx14, align 8
  %arrayidx16 = getelementptr inbounds ptr, ptr %seq1, i64 %indvars.iv1565
  ...
  %exitcond1570.not = icmp eq i64 %indvars.iv.next1566, %wide.trip.count1569
  br i1 %exitcond1570.not, label %for.cond24.preheader, label %for.body

for.body27:                                       ; preds = %for.body27.lr.ph, %for.inc41
  %indvars.iv1572 = phi i64 [ 0, %for.body27.lr.ph ], [ %indvars.iv.next1573, %for.inc41 ]
  %arrayidx29 = getelementptr inbounds ptr, ptr %mseq2, i64 %indvars.iv1572
  %8 = load ptr, ptr %arrayidx29, align 8
  store i8 0, ptr %8, align 1
  br i1 %cmp32.not1424, label %for.inc41, label %for.body34

for.body34:                                       ; preds = %for.body27, %for.body34
  %j.01425 = phi i32 [ %inc39, %for.body34 ], [ 0, %for.body27 ]
  ...
  %inc39 = add nuw i32 %j.01425, 1
  %exitcond1571.not = icmp eq i32 %j.01425, %sub
  br i1 %exitcond1571.not, label %for.inc41, label %for.body34
...
for.inc41:                                        ; preds = %for.body34, %for.body27
  ...
  br i1 %exitcond1577.not, label %common.ret, label %for.body27
...
for.body49.prol:                                  ; preds = %for.body49.preheader399, %for.body49.prol
  ...
  %18 = load ptr, ptr %arrayidx51.prol, align 8
  %arrayidx53.prol = getelementptr inbounds ptr, ptr %call44, i64 %indvars.iv.prol
  store ptr %18, ptr %arrayidx53.prol, align 8
  %indvars.iv.next.prol = add nuw nsw i64 %indvars.iv.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body49.prol.loopexit, label %for.body49.prol
...
for.body60.preheader:                             ; preds = %for.cond57.preheader
  %wide.trip.count1437 = zext i32 %jcyc to i64
...
vector.ph17:                                      ; preds = %for.body60.preheader
  %n.vec19 = and i64 %wide.trip.count1437, 4294967292
...
vector.body22:                                    ; preds = %vector.body22, %vector.ph17
  ...
  %wide.load24 = load <2 x ptr>, ptr %21, align 8
  %22 = getelementptr inbounds ptr, ptr %21, i64 2
  %wide.load25 = load <2 x ptr>, ptr %22, align 8
  %23 = getelementptr inbounds ptr, ptr %call45, i64 %index23
  store <2 x ptr> %wide.load24, ptr %23, align 8
  %24 = getelementptr inbounds ptr, ptr %23, i64 2
  store <2 x ptr> %wide.load25, ptr %24, align 8
  %index.next26 = add nuw i64 %index23, 4
  %25 = icmp eq i64 %index.next26, %n.vec19
  br i1 %25, label %middle.block14, label %vector.body22

middle.block14:                                   ; preds = %vector.body22
  %cmp.n21 = icmp eq i64 %n.vec19, %wide.trip.count1437
...
for.body60.preheader398:                          ; preds = %for.body60.preheader, %middle.block14
  %indvars.iv1434.ph = phi i64 [ 0, %for.body60.preheader ], [ %n.vec19, %middle.block14 ]
  %26 = xor i64 %indvars.iv1434.ph, -1
  %27 = add nsw i64 %26, %wide.trip.count1437
  %xtraiter400 = and i64 %wide.trip.count1437, 3
...
for.body60.prol:                                  ; preds = %for.body60.preheader398, %for.body60.prol
  %indvars.iv1434.prol = phi i64 [ %indvars.iv.next1435.prol, %for.body60.prol ], [ %indvars.iv1434.ph, %for.body60.preheader398 ]
  %prol.iter402 = phi i64 [ %prol.iter402.next, %for.body60.prol ], [ 0, %for.body60.preheader398 ]
  %arrayidx62.prol = getelementptr inbounds ptr, ptr %mseq2, i64 %indvars.iv1434.prol
  %28 = load ptr, ptr %arrayidx62.prol, align 8
  %arrayidx64.prol = getelementptr inbounds ptr, ptr %call45, i64 %indvars.iv1434.prol
  store ptr %28, ptr %arrayidx64.prol, align 8
  %indvars.iv.next1435.prol = add nuw nsw i64 %indvars.iv1434.prol, 1
  %prol.iter402.next = add i64 %prol.iter402, 1
  %prol.iter402.cmp.not = icmp eq i64 %prol.iter402.next, %xtraiter400
  br i1 %prol.iter402.cmp.not, label %for.body60.prol.loopexit, label %for.body60.prol

for.body60.prol.loopexit:                         ; preds = %for.body60.prol, %for.body60.preheader398
  %indvars.iv1434.unr = phi i64 [ %indvars.iv1434.ph, %for.body60.preheader398 ], [ %indvars.iv.next1435.prol, %for.body60.prol ]
...
for.body49:                                       ; preds = %for.body49.prol.loopexit, %for.body49
  ...
  store ptr %30, ptr %arrayidx53, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx51.1 = getelementptr inbounds ptr, ptr %mseq1, i64 %indvars.iv.next
  %31 = load ptr, ptr %arrayidx51.1, align 8
  %arrayidx53.1 = getelementptr inbounds ptr, ptr %call44, i64 %indvars.iv.next
  store ptr %31, ptr %arrayidx53.1, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx51.2 = getelementptr inbounds ptr, ptr %mseq1, i64 %indvars.iv.next.1
  %32 = load ptr, ptr %arrayidx51.2, align 8
  %arrayidx53.2 = getelementptr inbounds ptr, ptr %call44, i64 %indvars.iv.next.1
  store ptr %32, ptr %arrayidx53.2, align 8
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %arrayidx51.3 = getelementptr inbounds ptr, ptr %mseq1, i64 %indvars.iv.next.2
  %33 = load ptr, ptr %arrayidx51.3, align 8
  %arrayidx53.3 = getelementptr inbounds ptr, ptr %call44, i64 %indvars.iv.next.2
  store ptr %33, ptr %arrayidx53.3, align 8
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %exitcond.not.3 = icmp eq i64 %indvars.iv.next.3, %wide.trip.count
  br i1 %exitcond.not.3, label %for.cond57.preheader, label %for.body49

for.body60:                                       ; preds = %for.body60.prol.loopexit, %for.body60
  %indvars.iv1434 = phi i64 [ %indvars.iv.next1435.3, %for.body60 ], [ %indvars.iv1434.unr, %for.body60.prol.loopexit ]
  %arrayidx62 = getelementptr inbounds ptr, ptr %mseq2, i64 %indvars.iv1434
  %34 = load ptr, ptr %arrayidx62, align 8
  %arrayidx64 = getelementptr inbounds ptr, ptr %call45, i64 %indvars.iv1434
  store ptr %34, ptr %arrayidx64, align 8
  %indvars.iv.next1435 = add nuw nsw i64 %indvars.iv1434, 1
  %arrayidx62.1 = getelementptr inbounds ptr, ptr %mseq2, i64 %indvars.iv.next1435
  %35 = load ptr, ptr %arrayidx62.1, align 8
  %arrayidx64.1 = getelementptr inbounds ptr, ptr %call45, i64 %indvars.iv.next1435
  store ptr %35, ptr %arrayidx64.1, align 8
  %indvars.iv.next1435.1 = add nuw nsw i64 %indvars.iv1434, 2
  %arrayidx62.2 = getelementptr inbounds ptr, ptr %mseq2, i64 %indvars.iv.next1435.1
  %36 = load ptr, ptr %arrayidx62.2, align 8
  %arrayidx64.2 = getelementptr inbounds ptr, ptr %call45, i64 %indvars.iv.next1435.1
  store ptr %36, ptr %arrayidx64.2, align 8
  %indvars.iv.next1435.2 = add nuw nsw i64 %indvars.iv1434, 3
  %arrayidx62.3 = getelementptr inbounds ptr, ptr %mseq2, i64 %indvars.iv.next1435.2
  %37 = load ptr, ptr %arrayidx62.3, align 8
  %arrayidx64.3 = getelementptr inbounds ptr, ptr %call45, i64 %indvars.iv.next1435.2
  store ptr %37, ptr %arrayidx64.3, align 8
  %indvars.iv.next1435.3 = add nuw nsw i64 %indvars.iv1434, 4
  %exitcond1438.not.3 = icmp eq i64 %indvars.iv.next1435.3, %wide.trip.count1437
  br i1 %exitcond1438.not.3, label %for.end67, label %for.body60
...
vector.ph241:                                     ; preds = %vector.memcheck226
  ...
  %48 = load float, ptr %add.ptr.i, align 4
...
vector.body247:                                   ; preds = %vector.body247, %vector.ph241
  ...
  %wide.load250 = load <4 x float>, ptr %49, align 4
  %50 = getelementptr inbounds float, ptr %49, i64 4
  %wide.load251 = load <4 x float>, ptr %50, align 4
  ...
  %wide.load256 = load <4 x float>, ptr %53, align 4
  %54 = getelementptr inbounds float, ptr %53, i64 4
  %wide.load257 = load <4 x float>, ptr %54, align 4
  ...
  br i1 %57, label %middle.block238, label %vector.body247
...
vector.ph274:                                     ; preds = %vector.memcheck259
  ...
  %72 = load float, ptr %add.ptr6.i, align 4
...
vector.body280:                                   ; preds = %vector.body280, %vector.ph274
  ...
  %wide.load283 = load <4 x float>, ptr %73, align 4
  %74 = getelementptr inbounds float, ptr %73, i64 4
  %wide.load284 = load <4 x float>, ptr %74, align 4
...
vector.ph307:                                     ; preds = %vector.memcheck292
  ...
  %102 = load float, ptr %arrayidx76.i, align 4
...
vector.body313:                                   ; preds = %vector.body313, %vector.ph307
  ...
  %wide.load316 = load <4 x float>, ptr %103, align 4
  %104 = getelementptr inbounds float, ptr %103, i64 4
  %wide.load317 = load <4 x float>, ptr %104, align 4
...
for.body57.i:                                     ; preds = %for.body57.i.prol.loopexit, %for.body57.i
  ...
  br i1 %exitcond37.not.i.1, label %for.body72.lr.ph.i, label %for.body57.i
...
for.body72.i:                                     ; preds = %for.body72.i.prol.loopexit, %for.body72.i
  ...
  br i1 %exitcond44.not.i.1, label %for.end84.i, label %for.body72.i
...
for.end84.i:                                      ; preds = %for.body72.i.prol.loopexit, %for.body72.i, %middle.block304
  ...
  %131 = load float, ptr %arrayidx87.i, align 4
  store float %131, ptr %call20.i, align 4
...
for.body92.i:                                     ; preds = %for.end153.i.loopexit, %for.body92.lr.ph.i
  %indvars.iv52.i = phi i64 [ 1, %for.body92.lr.ph.i ], [ %indvars.iv.next53.i, %for.end153.i.loopexit ]
  %currentw.024.i = phi ptr [ %call.i, %for.body92.lr.ph.i ], [ %previousw.023.i, %for.end153.i.loopexit ]
  %previousw.023.i = phi ptr [ %call16.i, %for.body92.lr.ph.i ], [ %currentw.024.i, %for.end153.i.loopexit ]
  %132 = add nsw i64 %indvars.iv52.i, -1
  %arrayidx95.i = getelementptr inbounds float, ptr %call18.i, i64 %132
  %133 = load float, ptr %arrayidx95.i, align 4
  store float %133, ptr %currentw.024.i, align 4
  ...
  %135 = load float, ptr %arrayidx102.i, align 4
  store float %135, ptr %previousw.023.i, align 4
  %arrayidx108.i = getelementptr inbounds ptr, ptr %call36.i, i64 %indvars.iv52.i
  %136 = load ptr, ptr %arrayidx108.i, align 8
  %137 = load float, ptr %currentw.024.i, align 4
  %138 = load float, ptr %arrayidx105.i, align 4
...
for.body116.i:                                    ; preds = %if.end145.i, %for.body92.i
  ...
  %140 = load float, ptr %prept.015.i, align 4
  store i32 0, ptr %ijppt.020.i, align 4
  %141 = add nsw i64 %indvars.iv45.i, -1
  %arrayidx119.i = getelementptr inbounds float, ptr %add.ptr9.i, i64 %141
  %142 = load float, ptr %arrayidx119.i, align 4
...
if.then.i:                                        ; preds = %for.body116.i
  ...
  %sub122.neg.i = sub nsw i32 %mpi.013.i, %143
  store i32 %sub122.neg.i, ptr %ijppt.020.i, align 4
  br label %if.end.i
...
if.end.i:                                         ; preds = %if.then.i, %for.body116.i
  ...
  %144 = load float, ptr %arrayidx125.i, align 4
  ...
  %146 = load float, ptr %mjpt.019.i, align 4
  %147 = load float, ptr %arrayidx133.i, align 4
...
if.then143.i:                                     ; preds = %if.end138.i
  store float %add141.i, ptr %mjpt.019.i, align 4
  store i32 %139, ptr %mpjpt.018.i, align 4
  br label %if.end145.i

if.end145.i:                                      ; preds = %if.then143.i, %if.end138.i
  %150 = load float, ptr %curpt.017.i, align 4
  %add146.i = fadd float %wm.3.i, %150
  store float %add146.i, ptr %curpt.017.i, align 4
  ...
  br i1 %exitcond51.not.i, label %for.end153.i.loopexit, label %for.body116.i

for.end153.i.loopexit:                            ; preds = %if.end145.i
  %arrayidx156.i = getelementptr inbounds float, ptr %previousw.023.i, i64 %idxprom86.i
  %151 = load float, ptr %arrayidx156.i, align 4
  %arrayidx158.i = getelementptr inbounds float, ptr %call20.i, i64 %indvars.iv52.i
  store float %151, ptr %arrayidx158.i, align 4
  %indvars.iv.next53.i = add nuw nsw i64 %indvars.iv52.i, 1
  %exitcond58.not.i = icmp eq i64 %indvars.iv.next53.i, %wide.trip.count57.i
  br i1 %exitcond58.not.i, label %for.end161.i, label %for.body92.i

for.end161.i:                                     ; preds = %for.end153.i.loopexit, %for.end84.i
  %wm.0.lcssa.i = phi float [ 0.000000e+00, %for.end84.i ], [ %wm.3.i, %for.end153.i.loopexit ]
  ...
  br i1 %cmp172.i.i, label %for.body.preheader.i.i, label %for.body14.lr.ph.i.i
...
for.body.preheader.i.i:                           ; preds = %for.end161.i
  ...
  br i1 %153, label %for.body14.lr.ph.i.i.loopexit.unr-lcssa, label %for.body.preheader.i.i.new

for.body.preheader.i.i.new:                       ; preds = %for.body.preheader.i.i
  %unroll_iter438 = and i64 %wide.trip.count.i.i, 4294967288
  br label %for.body.i.i

for.body14.lr.ph.i.i.loopexit.unr-lcssa:          ; preds = %for.body.i.i, %for.body.preheader.i.i
  ...
  br i1 %lcmp.mod437.not, label %for.body14.lr.ph.i.i, label %for.body.i.i.epil

for.body.i.i.epil:                                ; preds = %for.body14.lr.ph.i.i.loopexit.unr-lcssa, %for.body.i.i.epil
  %indvars.iv.i.i.epil = phi i64 [ %indvars.iv.next.i.i.epil, %for.body.i.i.epil ], [ %indvars.iv.i.i.unr, %for.body14.lr.ph.i.i.loopexit.unr-lcssa ]
  %epil.iter = phi i64 [ %epil.iter.next, %for.body.i.i.epil ], [ 0, %for.body14.lr.ph.i.i.loopexit.unr-lcssa ]
  %indvars.iv.next.i.i.epil = add nuw nsw i64 %indvars.iv.i.i.epil, 1
  %arrayidx.i.i.epil = getelementptr inbounds ptr, ptr %call36.i, i64 %indvars.iv.i.i.epil
  %154 = load ptr, ptr %arrayidx.i.i.epil, align 8
  ...
  br i1 %epil.iter.cmp.not, label %for.body14.lr.ph.i.i, label %for.body.i.i.epil

for.body14.lr.ph.i.i:                             ; preds = %for.body14.lr.ph.i.i.loopexit.unr-lcssa, %for.body.i.i.epil, %for.end161.i
  %156 = load ptr, ptr %call36.i, align 8
...
vector.ph326:                                     ; preds = %for.body14.lr.ph.i.i
...
for.body14.i.i.preheader:                         ; preds = %for.body14.lr.ph.i.i, %middle.block323
  %indvars.iv208.i.i.ph = phi i64 [ 0, %for.body14.lr.ph.i.i ], [ %n.vec328, %middle.block323 ]
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.preheader.i.i.new
  ...
  %164 = load ptr, ptr %arrayidx.i.i.1, align 8
  ...
  %166 = load ptr, ptr %arrayidx.i.i.2, align 8
  ...
  %168 = load ptr, ptr %arrayidx.i.i.3, align 8
  ...
  %170 = load ptr, ptr %arrayidx.i.i.4, align 8
  ...
  %172 = load ptr, ptr %arrayidx.i.i.5, align 8
  ...
  %174 = load ptr, ptr %arrayidx.i.i.6, align 8
  ...
  %176 = load ptr, ptr %arrayidx.i.i.7, align 8
  ...
  br i1 %niter439.ncmp.7, label %for.body14.lr.ph.i.i.loopexit.unr-lcssa, label %for.body.i.i
...
for.body14.i.i:                                   ; preds = %for.body14.i.i.preheader, %for.body14.i.i
  ...
  store i32 %sub16.i.i, ptr %arrayidx19.i.i, align 4
  %exitcond213.i.i = icmp eq i64 %indvars.iv.next209.i.i, %wide.trip.count212.i.i
  br i1 %exitcond213.i.i, label %for.end22.i.i, label %for.body14.i.i
...
for.end22.i.i:                                    ; preds = %for.body14.i.i, %middle.block323
  ...
  store i8 0, ptr %add.ptr24.i.i, align 1
  ...
  store i8 0, ptr %add.ptr28.i.i, align 1
...
vector.ph366:                                     ; preds = %while.body.i.i.preheader
  %n.vec368 = and i64 %184, 8589934576
...
vector.body377:                                   ; preds = %vector.body377, %vector.ph366
  ...
  store <16 x i8> <i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111>, ptr %gep459, align 1
  %gep461 = getelementptr i8, ptr %invariant.gep460, i64 %188
  store <16 x i8> <i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45>, ptr %gep461, align 1
  %index.next381 = add nuw i64 %index378, 16
  %190 = icmp eq i64 %index.next381, %n.vec368
  br i1 %190, label %middle.block363, label %vector.body377
...
while.body.i.i.prol:                              ; preds = %while.body.i.i.preheader386, %while.body.i.i.prol
  ...
  store i8 111, ptr %incdec.ptr.i.i.prol, align 1
  %incdec.ptr61.i.i.prol = getelementptr inbounds i8, ptr %gaptable2.1180.i.i.prol, i64 -1
  store i8 45, ptr %incdec.ptr61.i.i.prol, align 1
  ...
  br i1 %prol.iter442.cmp.not, label %while.body.i.i.prol.loopexit, label %while.body.i.i.prol
...
vector.ph342:                                     ; preds = %while.body67.preheader.i.i
  %n.vec344 = and i64 %198, 8589934584
...
vector.body352:                                   ; preds = %vector.body352, %vector.ph342
  ...
  store <4 x i8> <i8 45, i8 45, i8 45, i8 45>, ptr %205, align 1
  %206 = getelementptr inbounds i8, ptr %next.gep355, i64 -8
  store <4 x i8> <i8 45, i8 45, i8 45, i8 45>, ptr %206, align 1
  %207 = getelementptr inbounds i8, ptr %next.gep, i64 -4
  store <4 x i8> <i8 111, i8 111, i8 111, i8 111>, ptr %207, align 1
  %208 = getelementptr inbounds i8, ptr %next.gep, i64 -8
  store <4 x i8> <i8 111, i8 111, i8 111, i8 111>, ptr %208, align 1
  ...
  br i1 %211, label %middle.block339, label %vector.body352
...
while.body67.i.i.prol:                            ; preds = %while.body67.i.i.preheader, %while.body67.i.i.prol
  ...
  store i8 45, ptr %incdec.ptr68.i.i.prol, align 1
  %incdec.ptr69.i.i.prol = getelementptr inbounds i8, ptr %gaptable2.2188.i.i.prol, i64 -1
  store i8 111, ptr %incdec.ptr69.i.i.prol, align 1
  ...
  br i1 %prol.iter445.cmp.not, label %while.body67.i.i.prol.loopexit, label %while.body67.i.i.prol
...
for.body84.i.i:                                   ; preds = %for.body84.i.i, %for.body84.lr.ph.i.i
  ...
  %215 = load ptr, ptr %arrayidx86.i.i, align 8
  %arrayidx88.i.i = getelementptr inbounds ptr, ptr %seq1, i64 %indvars.iv218.i.i
  %216 = load ptr, ptr %arrayidx88.i.i, align 8
  ...
  br i1 %exitcond222.not.i.i, label %for.cond94.preheader.i.i, label %for.body84.i.i
...
for.body96.i.i:                                   ; preds = %for.body96.i.i, %for.body96.lr.ph.i.i
  ...
  %217 = load ptr, ptr %arrayidx98.i.i, align 8
  %arrayidx100.i.i = getelementptr inbounds ptr, ptr %seq2, i64 %indvars.iv223.i.i
  %218 = load ptr, ptr %arrayidx100.i.i, align 8
  ...
  br i1 %exitcond227.not.i.i, label %MSalignmm_tanni.exit, label %for.body96.i.i
...
for.body139.preheader:                            ; preds = %for.end67
  ...
  %219 = add i32 %ien, 2
  %220 = sub i32 %219, %ist
  %wide.trip.count1443 = zext i32 %220 to i64
  %221 = add nsw i64 %wide.trip.count1443, -1
...
vector.memcheck27:                                ; preds = %for.body139.preheader
  ...
  %222 = shl nuw nsw i64 %wide.trip.count1443, 2
...
vector.ph37:                                      ; preds = %vector.memcheck27
  ...
  %227 = load float, ptr %add.ptr, align 4
...
vector.body42:                                    ; preds = %vector.body42, %vector.ph37
  ...
  %wide.load44 = load <4 x float>, ptr %228, align 4
  %229 = getelementptr inbounds float, ptr %228, i64 4
  %wide.load45 = load <4 x float>, ptr %229, align 4
  ...
  %wide.load48 = load <4 x float>, ptr %232, align 4
  %233 = getelementptr inbounds float, ptr %232, i64 4
  %wide.load49 = load <4 x float>, ptr %233, align 4
  %234 = fadd <4 x float> %wide.load48, %230
  %235 = fadd <4 x float> %wide.load49, %231
  store <4 x float> %234, ptr %232, align 4
  store <4 x float> %235, ptr %233, align 4
  %index.next50 = add nuw i64 %index43, 8
  %236 = icmp eq i64 %index.next50, %n.vec39
  br i1 %236, label %middle.block34, label %vector.body42
...
for.body139.preheader397:                         ; preds = %vector.memcheck27, %for.body139.preheader, %middle.block34
  %indvars.iv1439.ph = phi i64 [ 1, %vector.memcheck27 ], [ 1, %for.body139.preheader ], [ %ind.end, %middle.block34 ]
  %237 = xor i64 %indvars.iv1439.ph, -1
  %238 = and i64 %wide.trip.count1443, 1
...
for.body139.prol:                                 ; preds = %for.body139.preheader397
  %239 = load float, ptr %add.ptr, align 4
  %240 = add nsw i64 %indvars.iv1439.ph, -1
  %arrayidx143.prol = getelementptr inbounds float, ptr %add.ptr3, i64 %240
  %241 = load float, ptr %arrayidx143.prol, align 4
  %add144.prol = fadd float %239, %241
  %arrayidx146.prol = getelementptr inbounds float, ptr %call100, i64 %indvars.iv1439.ph
  %242 = load float, ptr %arrayidx146.prol, align 4
  %add147.prol = fadd float %242, %add144.prol
  store float %add147.prol, ptr %arrayidx146.prol, align 4
  %indvars.iv.next1440.prol = add nuw nsw i64 %indvars.iv1439.ph, 1
  br label %for.body139.prol.loopexit

for.body139.prol.loopexit:                        ; preds = %for.body139.prol, %for.body139.preheader397
  %indvars.iv1439.unr = phi i64 [ %indvars.iv1439.ph, %for.body139.preheader397 ], [ %indvars.iv.next1440.prol, %for.body139.prol ]
  %243 = sub nsw i64 0, %wide.trip.count1443
...
for.body155.preheader:                            ; preds = %for.cond151.preheader
  ...
  %245 = add nsw i64 %wide.trip.count1449, -1
...
vector.memcheck51:                                ; preds = %for.body155.preheader
  ...
  %246 = shl nuw nsw i64 %wide.trip.count1449, 2
...
vector.ph66:                                      ; preds = %vector.memcheck51
  ...
  %251 = load float, ptr %add.ptr6, align 4
...
vector.body72:                                    ; preds = %vector.body72, %vector.ph66
  ...
  %wide.load75 = load <4 x float>, ptr %252, align 4
  %253 = getelementptr inbounds float, ptr %252, i64 4
  %wide.load76 = load <4 x float>, ptr %253, align 4
  ...
  %wide.load79 = load <4 x float>, ptr %256, align 4
  %257 = getelementptr inbounds float, ptr %256, i64 4
  %wide.load80 = load <4 x float>, ptr %257, align 4
  %258 = fadd <4 x float> %wide.load79, %254
  %259 = fadd <4 x float> %wide.load80, %255
  store <4 x float> %258, ptr %256, align 4
  store <4 x float> %259, ptr %257, align 4
  %index.next81 = add nuw i64 %index73, 8
  %260 = icmp eq i64 %index.next81, %n.vec68
  br i1 %260, label %middle.block63, label %vector.body72
...
for.body155.preheader396:                         ; preds = %vector.memcheck51, %for.body155.preheader, %middle.block63
  ...
  %262 = and i64 %wide.trip.count1449, 1
...
for.body155.prol.loopexit:                        ; preds = %for.body155.prol, %for.body155.preheader396
  %indvars.iv1445.unr = phi i64 [ %indvars.iv1445.ph, %for.body155.preheader396 ], [ %indvars.iv.next1446.prol, %for.body155.prol ]
  %267 = sub nsw i64 0, %wide.trip.count1449
...
for.body139:                                      ; preds = %for.body139.prol.loopexit, %for.body139
  %indvars.iv1439 = phi i64 [ %indvars.iv.next1440.1, %for.body139 ], [ %indvars.iv1439.unr, %for.body139.prol.loopexit ]
  %269 = load float, ptr %add.ptr, align 4
  %270 = add nsw i64 %indvars.iv1439, -1
  %arrayidx143 = getelementptr inbounds float, ptr %add.ptr3, i64 %270
  %271 = load float, ptr %arrayidx143, align 4
  %add144 = fadd float %269, %271
  %arrayidx146 = getelementptr inbounds float, ptr %call100, i64 %indvars.iv1439
  %272 = load float, ptr %arrayidx146, align 4
  %add147 = fadd float %272, %add144
  store float %add147, ptr %arrayidx146, align 4
  %indvars.iv.next1440 = add nuw nsw i64 %indvars.iv1439, 1
  %273 = load float, ptr %add.ptr, align 4
  %arrayidx143.1 = getelementptr inbounds float, ptr %add.ptr3, i64 %indvars.iv1439
  %274 = load float, ptr %arrayidx143.1, align 4
  %add144.1 = fadd float %273, %274
  %arrayidx146.1 = getelementptr inbounds float, ptr %call100, i64 %indvars.iv.next1440
  %275 = load float, ptr %arrayidx146.1, align 4
  %add147.1 = fadd float %275, %add144.1
  store float %add147.1, ptr %arrayidx146.1, align 4
  %indvars.iv.next1440.1 = add nuw nsw i64 %indvars.iv1439, 2
  %exitcond1444.1 = icmp eq i64 %indvars.iv.next1440.1, %wide.trip.count1443
  br i1 %exitcond1444.1, label %for.cond151.preheader, label %for.body139
...
for.body171.lr.ph:                                ; preds = %for.cond167.preheader
  ...
  %276 = add nsw i64 %wide.trip.count1449, -1
...
vector.memcheck82:                                ; preds = %for.body171.lr.ph
  ...
  %277 = shl nuw nsw i64 %wide.trip.count1449, 2
...
vector.ph97:                                      ; preds = %vector.memcheck82
  ...
  %281 = load float, ptr %arrayidx175, align 4
...
vector.body103:                                   ; preds = %vector.body103, %vector.ph97
  ...
  %wide.load106 = load <4 x float>, ptr %282, align 4
  %283 = getelementptr inbounds float, ptr %282, i64 4
  %wide.load107 = load <4 x float>, ptr %283, align 4
...
for.body171.preheader:                            ; preds = %vector.memcheck82, %for.body171.lr.ph, %middle.block94
  ...
  %291 = xor i64 %indvars.iv1451.ph, -1
  %292 = and i64 %wide.trip.count1449, 1
...
for.body171.prol.loopexit:                        ; preds = %for.body171.prol, %for.body171.preheader
  ...
  %296 = sub nsw i64 0, %wide.trip.count1449
...
for.body155:                                      ; preds = %for.body155.prol.loopexit, %for.body155
  ...
  br i1 %exitcond1450.not.1, label %for.cond167.preheader, label %for.body155
...
for.body171:                                      ; preds = %for.body171.prol.loopexit, %for.body171
  ...
  %308 = load float, ptr %arrayidx174.1, align 4
  %309 = load float, ptr %arrayidx175, align 4
  %add176.1 = fadd float %308, %309
  %arrayidx178.1 = getelementptr inbounds float, ptr %call104, i64 %indvars.iv.next1452
  store float %add176.1, ptr %arrayidx178.1, align 4
  ...
  br i1 %exitcond1457.not.1, label %for.end183, label %for.body171
...
for.end183:                                       ; preds = %for.body171.prol.loopexit, %for.body171, %middle.block94, %for.cond151.preheader, %for.cond167.preheader
  ...
  %310 = load float, ptr %arrayidx186, align 4
  store float %310, ptr %call102, align 4
...
for.body194.lr.ph:                                ; preds = %for.end183
  ...
  %wide.trip.count1476 = zext i32 %312 to i64
...
for.body194:                                      ; preds = %for.body194.lr.ph, %for.end278
  ...
  %313 = add nsw i64 %indvars.iv1472, -1
  %arrayidx197 = getelementptr inbounds float, ptr %call100, i64 %313
  %314 = load float, ptr %arrayidx197, align 4
  store float %314, ptr %currentw.01374, align 4
  %315 = trunc i64 %indvars.iv1472 to i32
  ...
  %316 = load float, ptr %arrayidx204, align 4
  store float %316, ptr %previousw.01373, align 4
  %arrayidx207 = getelementptr inbounds float, ptr %add.ptr, i64 %indvars.iv1472
  %317 = load float, ptr %arrayidx207, align 4
  store float %317, ptr %call104, align 4
  %cmp209 = icmp eq i64 %indvars.iv1472, %311
  br i1 %cmp209, label %if.end214, label %if.end214.thread

if.end214:                                        ; preds = %for.body194
  store float %317, ptr %call86, align 4
...
for.body225.preheader:                            ; preds = %if.end214.thread
  %318 = load float, ptr %currentw.01374, align 4
  %319 = load float, ptr %arrayidx216, align 4
  %add2171582 = fadd float %318, %319
  %arrayidx2441583 = getelementptr inbounds float, ptr %add.ptr3, i64 %313
  %320 = trunc i64 %313 to i32
  br label %for.body225

for.body225.us.preheader:                         ; preds = %if.end214
  %321 = load float, ptr %currentw.01374, align 4
  %322 = load float, ptr %arrayidx216, align 4
...
for.body225.us:                                   ; preds = %for.body225.us.preheader, %if.end257.us
  ...
  %previousw.01373.pn1593 = phi ptr [ %previousw.01373, %for.body225.us.preheader ], [ %curpt.01369.us, %if.end257.us ]
  ...
  %curpt.01369.us = getelementptr inbounds float, ptr %previousw.01373.pn1593, i64 1
  %324 = load float, ptr %prept.01366.us, align 4
  %325 = add nsw i64 %indvars.iv1465, -1
  %arrayidx228.us = getelementptr inbounds float, ptr %add.ptr9, i64 %325
  %326 = load float, ptr %arrayidx228.us, align 4
  ...
  %327 = load float, ptr %arrayidx235.us, align 4
  ...
  %329 = load float, ptr %mjpt.01371.us, align 4
  %330 = load float, ptr %arrayidx244, align 4
  ...
  %331 = load float, ptr %arrayidx207, align 4
...
for.body225.us.if.end257.us_crit_edge:            ; preds = %for.body225.us
  %.pre = load i32, ptr %mpjpt.01370.us, align 4
  br label %if.end257.us

if.then255.us:                                    ; preds = %for.body225.us
  store float %add252.us, ptr %mjpt.01371.us, align 4
  store i32 %323, ptr %mpjpt.01370.us, align 4
  br label %if.end257.us
...
if.end257.us:                                     ; preds = %for.body225.us.if.end257.us_crit_edge, %if.then255.us
  ...
  br i1 %exitcond1471.not, label %for.end278, label %for.body225.us
...
for.body225:                                      ; preds = %for.body225.preheader, %if.end257
  ...
  %mi.01365 = phi float [ %add2171582, %for.body225.preheader ], [ %mi.1, %if.end257 ]
  %curpt.01369 = getelementptr inbounds float, ptr %previousw.01373.pn, i64 1
  %335 = load float, ptr %prept.01366, align 4
  %336 = add nsw i64 %indvars.iv1458, -1
  %arrayidx228 = getelementptr inbounds float, ptr %add.ptr9, i64 %336
  %337 = load float, ptr %arrayidx228, align 4
...
if.then255:                                       ; preds = %for.body225
  store float %add252, ptr %mjpt.01371, align 4
  store i32 %320, ptr %mpjpt.01370, align 4
  br label %if.end257

if.end257:                                        ; preds = %if.then255, %for.body225
  %342 = load float, ptr %curpt.01369, align 4
  %add258 = fadd float %wm.1, %342
  store float %add258, ptr %curpt.01369, align 4
  ...
  br i1 %exitcond1464.not, label %for.end278, label %for.body225
...
vector.memcheck111:                               ; preds = %for.body301.lr.ph
  %344 = shl nuw nsw i64 %wide.trip.count1481, 2
...
vector.ph126:                                     ; preds = %vector.memcheck111
  %n.vec128 = and i64 %wide.trip.count1481, 4294967288
  %349 = load float, ptr %arrayidx304, align 4
...
vector.body131:                                   ; preds = %vector.body131, %vector.ph126
  ...
  %wide.load133 = load <4 x float>, ptr %351, align 4
  %352 = getelementptr inbounds float, ptr %351, i64 4
  %wide.load134 = load <4 x float>, ptr %352, align 4
  ...
  %wide.load137 = load <4 x float>, ptr %355, align 4
  %356 = getelementptr inbounds float, ptr %355, i64 4
  %wide.load138 = load <4 x float>, ptr %356, align 4
  %357 = fadd <4 x float> %wide.load137, %353
  %358 = fadd <4 x float> %wide.load138, %354
  store <4 x float> %357, ptr %355, align 4
  store <4 x float> %358, ptr %356, align 4
  %index.next139 = add nuw i64 %index132, 8
  %359 = icmp eq i64 %index.next139, %n.vec128
  br i1 %359, label %middle.block123, label %vector.body131

middle.block123:                                  ; preds = %vector.body131
  %cmp.n130 = icmp eq i64 %n.vec128, %wide.trip.count1481
...
for.body301.preheader:                            ; preds = %vector.memcheck111, %for.body301.lr.ph, %middle.block123
  ...
  %360 = xor i64 %indvars.iv1478.ph, -1
  %xtraiter412 = and i64 %wide.trip.count1481, 1
...
for.body301.prol:                                 ; preds = %for.body301.preheader
  %361 = load float, ptr %arrayidx304, align 4
...
for.body301.prol.loopexit:                        ; preds = %for.body301.prol, %for.body301.preheader
  ...
  %364 = sub nsw i64 0, %wide.trip.count1481
...
vector.memcheck140:                               ; preds = %for.body319.lr.ph
  %366 = shl nuw nsw i64 %wide.trip.count1486, 2
...
vector.ph155:                                     ; preds = %vector.memcheck140
  ...
  %374 = load float, ptr %arrayidx322, align 4
...
vector.body160:                                   ; preds = %vector.body160, %vector.ph155
  ...
  %wide.load162 = load <4 x float>, ptr %376, align 4
  %377 = getelementptr inbounds float, ptr %376, i64 4
  %wide.load163 = load <4 x float>, ptr %377, align 4
  ...
  %wide.load166 = load <4 x float>, ptr %380, align 4
  %381 = getelementptr inbounds float, ptr %380, i64 4
  %wide.load167 = load <4 x float>, ptr %381, align 4
  %382 = fadd <4 x float> %wide.load166, %378
  %383 = fadd <4 x float> %wide.load167, %379
  store <4 x float> %382, ptr %380, align 4
  store <4 x float> %383, ptr %381, align 4
  %index.next168 = add nuw i64 %index161, 8
  %384 = icmp eq i64 %index.next168, %n.vec157
  br i1 %384, label %middle.block152, label %vector.body160
...
for.body319.preheader:                            ; preds = %vector.memcheck140, %for.body319.lr.ph, %middle.block152
  ...
  %385 = xor i64 %indvars.iv1483.ph, -1
  %xtraiter415 = and i64 %wide.trip.count1486, 1
...
for.body319.prol:                                 ; preds = %for.body319.preheader
  %386 = load float, ptr %arrayidx322, align 4
...
for.body319.prol.loopexit:                        ; preds = %for.body319.prol, %for.body319.preheader
  ...
  %389 = sub nsw i64 0, %wide.trip.count1486
...
for.body301:                                      ; preds = %for.body301.prol.loopexit, %for.body301
  ...
  %391 = load float, ptr %arrayidx304, align 4
  ...
  %392 = load float, ptr %arrayidx307, align 4
  %add308 = fadd float %391, %392
  %arrayidx310 = getelementptr inbounds float, ptr %call100, i64 %indvars.iv1478
  %393 = load float, ptr %arrayidx310, align 4
  %add311 = fadd float %393, %add308
  store float %add311, ptr %arrayidx310, align 4
  %394 = load float, ptr %arrayidx304, align 4
...
for.cond334.preheader.for.cond354.preheader_crit_edge: ; preds = %for.cond315.preheader, %for.cond334.preheader
  %.pre1579 = add i32 %sub11, -1
  %.pre1580 = zext i32 %.pre1579 to i64
...
vector.memcheck170:                               ; preds = %for.body337.lr.ph
  %399 = shl nuw nsw i64 %wide.trip.count1486, 2
...
vector.ph185:                                     ; preds = %vector.memcheck170
  ...
  %407 = load float, ptr %arrayidx342, align 4
...
vector.body191:                                   ; preds = %vector.body191, %vector.ph185
  ...
  %wide.load194 = load <4 x float>, ptr %gep453, align 4
  ...
  store <4 x float> %reverse195, ptr %gep455, align 4
  %gep457 = getelementptr i32, ptr %invariant.gep456, i64 %offset.idx193
  store <4 x i32> %broadcast.splat197, ptr %gep457, align 4
  %index.next199 = add nuw i64 %index192, 4
  %411 = icmp eq i64 %index.next199, %n.vec187
  br i1 %411, label %middle.block182, label %vector.body191
...
for.body337.preheader:                            ; preds = %vector.memcheck170, %for.body337.lr.ph, %middle.block182
  %indvars.iv1488.ph = phi i64 [ %397, %vector.memcheck170 ], [ %397, %for.body337.lr.ph ], [ %ind.end188, %middle.block182 ]
...
for.body319:                                      ; preds = %for.body319.prol.loopexit, %for.body319
  ...
  %412 = load float, ptr %arrayidx322, align 4
  ...
  %413 = load float, ptr %arrayidx325, align 4
  %add326 = fadd float %412, %413
  %arrayidx328 = getelementptr inbounds float, ptr %currentw.0.lcssa, i64 %indvars.iv1483
  %414 = load float, ptr %arrayidx328, align 4
  %add329 = fadd float %414, %add326
  store float %add329, ptr %arrayidx328, align 4
  %415 = load float, ptr %arrayidx322, align 4
  ...
  %416 = load float, ptr %arrayidx325.1, align 4
  %add326.1 = fadd float %415, %416
  %arrayidx328.1 = getelementptr inbounds float, ptr %currentw.0.lcssa, i64 %indvars.iv.next1484
  %417 = load float, ptr %arrayidx328.1, align 4
  %add329.1 = fadd float %417, %add326.1
  store float %add329.1, ptr %arrayidx328.1, align 4
  %exitcond1487.not.1 = icmp eq i64 %indvars.iv.next1484.1, %wide.trip.count1486
  br i1 %exitcond1487.not.1, label %for.cond334.preheader, label %for.body319

for.cond354.preheader:                            ; preds = %for.body337, %middle.block182, %for.cond334.preheader.for.cond354.preheader_crit_edge
  %idxprom377.pre-phi = phi i64 [ %.pre1580, %for.cond334.preheader.for.cond354.preheader_crit_edge ], [ %idxprom341, %middle.block182 ], [ %idxprom341, %for.body337 ]
  ...
  %xtraiter418 = and i64 %wide.trip.count1500, 1
  %420 = icmp eq i32 %sub11, 3
  %421 = and i64 %wide.trip.count1500, 4294967294
  %422 = add nsw i64 %421, -4
  %lcmp.mod419.not = icmp eq i64 %xtraiter418, 0
  %xtraiter422 = and i64 %wide.trip.count1507, 1
  %423 = icmp ugt i32 %sub11, 2147483645
  %unroll_iter425 = and i64 %wide.trip.count1507, 2147483646
...
for.body337:                                      ; preds = %for.body337.preheader, %for.body337
  ...
  %424 = load float, ptr %arrayidx339, align 4
  %425 = load float, ptr %arrayidx342, align 4
  ...
  store float %add343, ptr %arrayidx346, align 4
  %arrayidx349 = getelementptr inbounds i32, ptr %call106, i64 %indvars.iv1488
  store i32 %sub, ptr %arrayidx349, align 4
  %426 = trunc i64 %indvars.iv1488 to i32
  %cmp335 = icmp sgt i32 %426, 1
  br i1 %cmp335, label %for.body337, label %for.cond354.preheader

for.cond354:                                      ; preds = %for.cond354.preheader, %if.end552
  %indvars.iv1509 = phi i64 [ %418, %for.cond354.preheader ], [ %indvars.iv.next1510, %if.end552 ]
  ...
  %427 = trunc i64 %indvars.iv1509 to i32
...
for.body357:                                      ; preds = %for.cond354
  ...
  %428 = load float, ptr %arrayidx360, align 4
  %arrayidx363 = getelementptr inbounds float, ptr %currentw.1, i64 %idxprom185
  store float %428, ptr %arrayidx363, align 4
  ...
  %429 = load float, ptr %arrayidx369, align 4
  %arrayidx372 = getelementptr inbounds float, ptr %previousw.1, i64 %idxprom185
  store float %429, ptr %arrayidx372, align 4
...
for.body397.lr.ph:                                ; preds = %for.body357
  ...
  %430 = load float, ptr %arrayidx363, align 4
  %431 = load float, ptr %arrayidx378, align 4
  ...
  %cmp438 = icmp eq i64 %indvars.iv1509, %419
...
for.body397:                                      ; preds = %for.body397.lr.ph, %if.end464
  ...
  %432 = load float, ptr %prept.11392, align 4
  %433 = add nuw nsw i64 %indvars.iv1491, 1
  %arrayidx402 = getelementptr inbounds float, ptr %add.ptr6, i64 %433
  %434 = load float, ptr %arrayidx402, align 4
  ...
  %436 = load float, ptr %arrayidx410, align 4
  ...
  %437 = load float, ptr %mjpt.11388, align 4
  %438 = load float, ptr %arrayidx419, align 4
...
if.then423:                                       ; preds = %for.body397
  %439 = load i32, ptr %mpjpt.11390, align 4
  br label %if.end425
...
if.end425:                                        ; preds = %if.then423, %for.body397
  ...
  %440 = load float, ptr %arrayidx427, align 4
...
if.then431:                                       ; preds = %if.end425
  store float %add428, ptr %mjpt.11388, align 4
  store i32 %427, ptr %mpjpt.11390, align 4
  br label %if.end433
...
if.then440:                                       ; preds = %if.end433
  ...
  store i32 %ijpi.1, ptr %arrayidx442, align 4
  %arrayidx444 = getelementptr inbounds i32, ptr %call94, i64 %indvars.iv1491
  store i32 %ijpj.1, ptr %arrayidx444, align 4
  br label %if.end445
...
if.then448:                                       ; preds = %if.end445
  ...
  %441 = load float, ptr %arrayidx450, align 4
  %add451 = fadd float %wm.3, %441
  store float %add451, ptr %arrayidx450, align 4
  %442 = load float, ptr %mjpt.11388, align 4
  %arrayidx454 = getelementptr inbounds float, ptr %call86, i64 %433
  %443 = load float, ptr %arrayidx454, align 4
  %add455 = fadd float %442, %443
  store float %add455, ptr %arrayidx454, align 4
  br label %if.end456
...
if.then460:                                       ; preds = %if.end456
  ...
  %444 = load float, ptr %arrayidx462, align 4
  %add463 = fadd float %mi.3, %444
  store float %add463, ptr %arrayidx462, align 4
  br label %if.end464

if.end464:                                        ; preds = %if.then460, %if.end456
  %445 = load float, ptr %curpt.11387, align 4
  %add465 = fadd float %wm.3, %445
  store float %add465, ptr %curpt.11387, align 4
  ...
  %446 = trunc i64 %indvars.iv1491 to i32
  %cmp395 = icmp sgt i32 %446, 0
  br i1 %cmp395, label %for.body397, label %for.end472
...
for.end472:                                       ; preds = %if.end464, %for.body357
  ...
  %447 = load float, ptr %prept.1.lcssa, align 4
  %arrayidx474 = getelementptr inbounds float, ptr %add.ptr3, i64 %idxprom368
  %448 = load float, ptr %arrayidx474, align 4
...
if.then483:                                       ; preds = %for.end472
  ...
  %449 = load float, ptr %arrayidx486, align 4
  %add487 = fadd float %firstm.1, %449
  store float %add487, ptr %arrayidx486, align 4
  br label %if.end488

if.end488:                                        ; preds = %if.then483, %for.end472
  %cmp490 = icmp eq i64 %indvars.iv1509, %419
  br i1 %cmp490, label %if.then492, label %if.end552

if.then492:                                       ; preds = %if.end488
  %450 = load float, ptr %arrayidx493, align 4
...
for.body498:                                      ; preds = %for.body498.preheader, %for.body498
  ...
  br i1 %niter.ncmp.1, label %for.cond508.preheader.loopexit.unr-lcssa, label %for.body498
...
for.body512:                                      ; preds = %for.body512.preheader, %for.body512
  ...
  br i1 %niter426.ncmp.1, label %for.end521.loopexit.unr-lcssa, label %for.body512
...
for.body512.epil:                                 ; preds = %for.end521.loopexit.unr-lcssa
  ...
  %461 = load float, ptr %arrayidx514.epil, align 4
  %cmp515.epil = fcmp ogt float %461, %maxwm.21402.unr
  %462 = trunc i64 %indvars.iv1502.unr to i32
...
for.end521:                                       ; preds = %for.body512.epil, %for.end521.loopexit.unr-lcssa, %for.cond508.preheader
  ...
  %463 = load float, ptr %arrayidx523, align 4
...
land.lhs.true:                                    ; preds = %for.end521
  ...
  %464 = load float, ptr %arrayidx530, align 4
...
if.then533:                                       ; preds = %land.lhs.true
  ...
  %465 = load i32, ptr %arrayidx536, align 4
  br label %if.end540
...
if.end540:                                        ; preds = %if.then533, %land.lhs.true, %for.end521
  ...
  %466 = load float, ptr %arrayidx542, align 4
...
if.then545:                                       ; preds = %if.end540
  ...
  %467 = load i32, ptr %arrayidx547, align 4
  br label %if.end552
...
if.end552:                                        ; preds = %if.end540, %if.then545, %if.end488
  ...
  br i1 %cmp553, label %if.then555, label %for.cond354
...
if.else565:                                       ; preds = %if.else
  ...
  %468 = load i32, ptr %arrayidx567, align 4
  %arrayidx569 = getelementptr inbounds i32, ptr %call94, i64 %idxprom566
  %469 = load i32, ptr %arrayidx569, align 4
  br label %for.end575
...
for.end575:                                       ; preds = %for.cond354, %if.else, %if.then558, %if.else565
  ...
  %jumpi.3 = phi i32 [ %sub559, %if.then558 ], [ %indvars1511, %if.else565 ], [ %sub489, %if.else ], [ %jumpi.0, %for.cond354 ]
  ...
  %470 = load ptr, ptr %mseq1, align 8
...
for.body590.preheader:                            ; preds = %for.end575
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %call110, i8 45, i64 %475, i1 false)
...
for.body616:                                      ; preds = %for.body616.lr.ph, %for.body616
  ...
  %478 = load ptr, ptr %arrayidx618, align 8
  %arrayidx620 = getelementptr inbounds ptr, ptr %seq2, i64 %indvars.iv1525
  %479 = load ptr, ptr %arrayidx620, align 8
  ...
  %call627 = tail call ptr @strncat(ptr noundef nonnull dereferenceable(1) %478, ptr noundef nonnull %add.ptr625, i64 noundef %wide.trip.count1517) #13
  %480 = load ptr, ptr %arrayidx618, align 8
  ...
  br i1 %exitcond1530.not, label %for.end635, label %for.body616
...
for.end635:                                       ; preds = %for.body616, %for.cond613.preheader
  ...
  %481 = load float, ptr %arrayidx638, align 4
  ...
  %482 = load float, ptr %arrayidx641, align 4
  %add642 = fadd float %481, %482
  %add643 = fadd float %call578, %add642
  %.pre1578 = load ptr, ptr %mseq1, align 8
  br label %if.end644

if.end644:                                        ; preds = %for.end635, %for.end575
  %483 = phi ptr [ %.pre1578, %for.end635 ], [ %470, %for.end575 ]
...
for.body656.preheader:                            ; preds = %if.end644
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %call110, i8 45, i64 %488, i1 false)
  ...
  store i8 0, ptr %arrayidx663, align 1
...
for.body667:                                      ; preds = %for.body667.lr.ph, %for.body667
  ...
  %489 = load ptr, ptr %arrayidx669, align 8
  %arrayidx671 = getelementptr inbounds ptr, ptr %seq1, i64 %indvars.iv1537
  %490 = load ptr, ptr %arrayidx671, align 8
  ...
  %call678 = tail call ptr @strncat(ptr noundef nonnull dereferenceable(1) %489, ptr noundef nonnull %add.ptr676, i64 noundef %wide.trip.count1535) #13
  %491 = load ptr, ptr %arrayidx669, align 8
  %arrayidx683 = getelementptr inbounds i8, ptr %491, i64 %idxprom682
  store i8 0, ptr %arrayidx683, align 1
  %indvars.iv.next1538 = add nuw nsw i64 %indvars.iv1537, 1
  %exitcond1542.not = icmp eq i64 %indvars.iv.next1538, %wide.trip.count1541
  br i1 %exitcond1542.not, label %for.cond687.preheader, label %for.body667
...
for.end701:                                       ; preds = %for.body690, %for.cond687.preheader
  ...
  %494 = load float, ptr %arrayidx704, align 4
  ...
  %495 = load float, ptr %arrayidx707, align 4
...
if.end710:                                        ; preds = %for.end701, %if.end644
  ...
  %496 = load ptr, ptr %call44, align 8
...
vector.body208:                                   ; preds = %vector.body208, %vector.ph203
  ...
  %wide.load210 = load <2 x ptr>, ptr %497, align 8
  %498 = getelementptr inbounds ptr, ptr %497, i64 2
  %wide.load211 = load <2 x ptr>, ptr %498, align 8
  ...
  store <2 x ptr> %499, ptr %497, align 8
  store <2 x ptr> %500, ptr %498, align 8
  %index.next212 = add nuw i64 %index209, 4
  %501 = icmp eq i64 %index.next212, %n.vec205
  br i1 %501, label %middle.block200, label %vector.body208
...
vector.body221:                                   ; preds = %vector.body221, %vector.ph216
  ...
  %wide.load223 = load <2 x ptr>, ptr %502, align 8
  %503 = getelementptr inbounds ptr, ptr %502, i64 2
  %wide.load224 = load <2 x ptr>, ptr %503, align 8
  ...
  store <2 x ptr> %504, ptr %502, align 8
  store <2 x ptr> %505, ptr %503, align 8
  %index.next225 = add nuw i64 %index222, 4
  %506 = icmp eq i64 %index.next225, %n.vec218
  br i1 %506, label %middle.block213, label %vector.body221
...
if.end28:                                         ; preds = %for.end, %entry
  ...
  %arrayidx44.10.phi.trans.insert = getelementptr inbounds float, ptr %6, i64 10
  %.pre = load float, ptr %arrayidx44.10.phi.trans.insert, align 4
  %arrayidx44.11.phi.trans.insert = getelementptr inbounds float, ptr %6, i64 11
  %.pre134 = load float, ptr %arrayidx44.11.phi.trans.insert, align 4
  %arrayidx44.12.phi.trans.insert = getelementptr inbounds float, ptr %6, i64 12
  %.pre135 = load float, ptr %arrayidx44.12.phi.trans.insert, align 4
  %arrayidx44.13.phi.trans.insert = getelementptr inbounds float, ptr %6, i64 13
  %.pre136 = load float, ptr %arrayidx44.13.phi.trans.insert, align 4
  %arrayidx44.14.phi.trans.insert = getelementptr inbounds float, ptr %6, i64 14
  %.pre137 = load float, ptr %arrayidx44.14.phi.trans.insert, align 4
  %arrayidx44.15.phi.trans.insert = getelementptr inbounds float, ptr %6, i64 15
  %.pre138 = load float, ptr %arrayidx44.15.phi.trans.insert, align 4
  %arrayidx44.16.phi.trans.insert = getelementptr inbounds float, ptr %6, i64 16
  %.pre139 = load float, ptr %arrayidx44.16.phi.trans.insert, align 4
...
vector.body:                                      ; preds = %vector.body, %if.end28
  ...
  %26 = getelementptr inbounds [26 x float], ptr %scarr, i64 0, i64 %index
  %27 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 0, i64 %index
  %wide.load = load <4 x i32>, ptr %27, align 16
  %28 = sitofp <4 x i32> %wide.load to <4 x float>
  %29 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %28, <4 x float> %broadcast.splat, <4 x float> zeroinitializer)
  %30 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 1, i64 %index
  %wide.load140 = load <4 x i32>, ptr %30, align 8
  %31 = sitofp <4 x i32> %wide.load140 to <4 x float>
  %32 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %31, <4 x float> %broadcast.splat142, <4 x float> %29)
  %33 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 2, i64 %index
  %wide.load143 = load <4 x i32>, ptr %33, align 16
  %34 = sitofp <4 x i32> %wide.load143 to <4 x float>
  %35 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %34, <4 x float> %broadcast.splat145, <4 x float> %32)
  %36 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 3, i64 %index
  %wide.load146 = load <4 x i32>, ptr %36, align 8
  %37 = sitofp <4 x i32> %wide.load146 to <4 x float>
  %38 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %37, <4 x float> %broadcast.splat148, <4 x float> %35)
  %39 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 4, i64 %index
  %wide.load149 = load <4 x i32>, ptr %39, align 16
  %40 = sitofp <4 x i32> %wide.load149 to <4 x float>
  %41 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %40, <4 x float> %broadcast.splat151, <4 x float> %38)
  %42 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 5, i64 %index
  %wide.load152 = load <4 x i32>, ptr %42, align 8
  %43 = sitofp <4 x i32> %wide.load152 to <4 x float>
  %44 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %43, <4 x float> %broadcast.splat154, <4 x float> %41)
  %45 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 6, i64 %index
  %wide.load155 = load <4 x i32>, ptr %45, align 16
  %46 = sitofp <4 x i32> %wide.load155 to <4 x float>
  %47 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %46, <4 x float> %broadcast.splat157, <4 x float> %44)
  %48 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 7, i64 %index
  %wide.load158 = load <4 x i32>, ptr %48, align 8
  %49 = sitofp <4 x i32> %wide.load158 to <4 x float>
  %50 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %49, <4 x float> %broadcast.splat160, <4 x float> %47)
  %51 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 8, i64 %index
  %wide.load161 = load <4 x i32>, ptr %51, align 16
  %52 = sitofp <4 x i32> %wide.load161 to <4 x float>
  %53 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %52, <4 x float> %broadcast.splat163, <4 x float> %50)
  %54 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 9, i64 %index
  %wide.load164 = load <4 x i32>, ptr %54, align 8
  %55 = sitofp <4 x i32> %wide.load164 to <4 x float>
  %56 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %55, <4 x float> %broadcast.splat166, <4 x float> %53)
  %57 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 10, i64 %index
  %wide.load167 = load <4 x i32>, ptr %57, align 16
  %58 = sitofp <4 x i32> %wide.load167 to <4 x float>
  %59 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %58, <4 x float> %broadcast.splat169, <4 x float> %56)
  %60 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 11, i64 %index
  %wide.load170 = load <4 x i32>, ptr %60, align 8
  %61 = sitofp <4 x i32> %wide.load170 to <4 x float>
  %62 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %61, <4 x float> %broadcast.splat172, <4 x float> %59)
  %63 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 12, i64 %index
  %wide.load173 = load <4 x i32>, ptr %63, align 16
  %64 = sitofp <4 x i32> %wide.load173 to <4 x float>
  %65 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %64, <4 x float> %broadcast.splat175, <4 x float> %62)
  %66 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 13, i64 %index
  %wide.load176 = load <4 x i32>, ptr %66, align 8
  %67 = sitofp <4 x i32> %wide.load176 to <4 x float>
  %68 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %67, <4 x float> %broadcast.splat178, <4 x float> %65)
  %69 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 14, i64 %index
  %wide.load179 = load <4 x i32>, ptr %69, align 16
  %70 = sitofp <4 x i32> %wide.load179 to <4 x float>
  %71 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %70, <4 x float> %broadcast.splat181, <4 x float> %68)
  %72 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 15, i64 %index
  %wide.load182 = load <4 x i32>, ptr %72, align 8
  %73 = sitofp <4 x i32> %wide.load182 to <4 x float>
  %74 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %73, <4 x float> %broadcast.splat184, <4 x float> %71)
  %75 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 16, i64 %index
  %wide.load185 = load <4 x i32>, ptr %75, align 16
  %76 = sitofp <4 x i32> %wide.load185 to <4 x float>
  %77 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %76, <4 x float> %broadcast.splat187, <4 x float> %74)
  %78 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 17, i64 %index
  %wide.load188 = load <4 x i32>, ptr %78, align 8
  %79 = sitofp <4 x i32> %wide.load188 to <4 x float>
  %80 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %79, <4 x float> %broadcast.splat190, <4 x float> %77)
  %81 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 18, i64 %index
  %wide.load191 = load <4 x i32>, ptr %81, align 16
  %82 = sitofp <4 x i32> %wide.load191 to <4 x float>
  %83 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %82, <4 x float> %broadcast.splat193, <4 x float> %80)
  %84 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 19, i64 %index
  %wide.load194 = load <4 x i32>, ptr %84, align 8
  %85 = sitofp <4 x i32> %wide.load194 to <4 x float>
  %86 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %85, <4 x float> %broadcast.splat196, <4 x float> %83)
  %87 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 20, i64 %index
  %wide.load197 = load <4 x i32>, ptr %87, align 16
  %88 = sitofp <4 x i32> %wide.load197 to <4 x float>
  %89 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %88, <4 x float> %broadcast.splat199, <4 x float> %86)
  %90 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 21, i64 %index
  %wide.load200 = load <4 x i32>, ptr %90, align 8
  %91 = sitofp <4 x i32> %wide.load200 to <4 x float>
  %92 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %91, <4 x float> %broadcast.splat202, <4 x float> %89)
  %93 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 22, i64 %index
  %wide.load203 = load <4 x i32>, ptr %93, align 16
  %94 = sitofp <4 x i32> %wide.load203 to <4 x float>
  %95 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %94, <4 x float> %broadcast.splat205, <4 x float> %92)
  %96 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 23, i64 %index
  %wide.load206 = load <4 x i32>, ptr %96, align 8
  %97 = sitofp <4 x i32> %wide.load206 to <4 x float>
  %98 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %97, <4 x float> %broadcast.splat208, <4 x float> %95)
  %99 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 24, i64 %index
  %wide.load209 = load <4 x i32>, ptr %99, align 16
  %100 = sitofp <4 x i32> %wide.load209 to <4 x float>
  %101 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %100, <4 x float> %broadcast.splat211, <4 x float> %98)
  %102 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 25, i64 %index
  %wide.load212 = load <4 x i32>, ptr %102, align 8
  %103 = sitofp <4 x i32> %wide.load212 to <4 x float>
  %104 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %103, <4 x float> %broadcast.splat214, <4 x float> %101)
  store <4 x float> %104, ptr %26, align 16
  %index.next = add nuw i64 %index, 4
  %105 = icmp eq i64 %index.next, 24
  br i1 %105, label %for.body31, label %vector.body

for.body31:                                       ; preds = %vector.body
  %arrayidx33 = getelementptr inbounds [26 x float], ptr %scarr, i64 0, i64 24
  %106 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 0, i64 24), align 16
  %conv = sitofp i32 %106 to float
  %107 = tail call float @llvm.fmuladd.f32(float %conv, float %7, float 0.000000e+00)
  %108 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 1, i64 24), align 8
  %conv.1 = sitofp i32 %108 to float
  %109 = tail call float @llvm.fmuladd.f32(float %conv.1, float %8, float %107)
  %110 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 2, i64 24), align 16
  %conv.2 = sitofp i32 %110 to float
  %111 = tail call float @llvm.fmuladd.f32(float %conv.2, float %9, float %109)
  %112 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 3, i64 24), align 8
  %conv.3 = sitofp i32 %112 to float
  %113 = tail call float @llvm.fmuladd.f32(float %conv.3, float %10, float %111)
  %114 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 4, i64 24), align 16
  %conv.4 = sitofp i32 %114 to float
  %115 = tail call float @llvm.fmuladd.f32(float %conv.4, float %11, float %113)
  %116 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 5, i64 24), align 8
  %conv.5 = sitofp i32 %116 to float
  %117 = tail call float @llvm.fmuladd.f32(float %conv.5, float %12, float %115)
  %118 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 6, i64 24), align 16
  %conv.6 = sitofp i32 %118 to float
  %119 = tail call float @llvm.fmuladd.f32(float %conv.6, float %13, float %117)
  %120 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 7, i64 24), align 8
  %conv.7 = sitofp i32 %120 to float
  %121 = tail call float @llvm.fmuladd.f32(float %conv.7, float %14, float %119)
  %122 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 8, i64 24), align 16
  %conv.8 = sitofp i32 %122 to float
  %123 = tail call float @llvm.fmuladd.f32(float %conv.8, float %15, float %121)
  %124 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 9, i64 24), align 8
  %conv.9 = sitofp i32 %124 to float
  %125 = tail call float @llvm.fmuladd.f32(float %conv.9, float %16, float %123)
  %126 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 10, i64 24), align 16
  %conv.10 = sitofp i32 %126 to float
  %127 = tail call float @llvm.fmuladd.f32(float %conv.10, float %.pre, float %125)
  %128 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 11, i64 24), align 8
  %conv.11 = sitofp i32 %128 to float
  %129 = tail call float @llvm.fmuladd.f32(float %conv.11, float %.pre134, float %127)
  %130 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 12, i64 24), align 16
  %conv.12 = sitofp i32 %130 to float
  %131 = tail call float @llvm.fmuladd.f32(float %conv.12, float %.pre135, float %129)
  %132 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 13, i64 24), align 8
  %conv.13 = sitofp i32 %132 to float
  %133 = tail call float @llvm.fmuladd.f32(float %conv.13, float %.pre136, float %131)
  %134 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 14, i64 24), align 16
  %conv.14 = sitofp i32 %134 to float
  %135 = tail call float @llvm.fmuladd.f32(float %conv.14, float %.pre137, float %133)
  %136 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 15, i64 24), align 8
  %conv.15 = sitofp i32 %136 to float
  %137 = tail call float @llvm.fmuladd.f32(float %conv.15, float %.pre138, float %135)
  %138 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 16, i64 24), align 16
  %conv.16 = sitofp i32 %138 to float
  %139 = tail call float @llvm.fmuladd.f32(float %conv.16, float %.pre139, float %137)
  %140 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 17, i64 24), align 8
  %conv.17 = sitofp i32 %140 to float
  %141 = tail call float @llvm.fmuladd.f32(float %conv.17, float %17, float %139)
  %142 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 18, i64 24), align 16
  %conv.18 = sitofp i32 %142 to float
  %143 = tail call float @llvm.fmuladd.f32(float %conv.18, float %18, float %141)
  %144 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 19, i64 24), align 8
  %conv.19 = sitofp i32 %144 to float
  %145 = tail call float @llvm.fmuladd.f32(float %conv.19, float %19, float %143)
  %146 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 20, i64 24), align 16
  %conv.20 = sitofp i32 %146 to float
  %147 = tail call float @llvm.fmuladd.f32(float %conv.20, float %20, float %145)
  %148 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 21, i64 24), align 8
  %conv.21 = sitofp i32 %148 to float
  %149 = tail call float @llvm.fmuladd.f32(float %conv.21, float %21, float %147)
  %150 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 22, i64 24), align 16
  %conv.22 = sitofp i32 %150 to float
  %151 = tail call float @llvm.fmuladd.f32(float %conv.22, float %22, float %149)
  %152 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 23, i64 24), align 8
  %conv.23 = sitofp i32 %152 to float
  %153 = tail call float @llvm.fmuladd.f32(float %conv.23, float %23, float %151)
  %154 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 24, i64 24), align 16
  %conv.24 = sitofp i32 %154 to float
  %155 = tail call float @llvm.fmuladd.f32(float %conv.24, float %24, float %153)
  %156 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 25, i64 24), align 8
  %conv.25 = sitofp i32 %156 to float
  %157 = tail call float @llvm.fmuladd.f32(float %conv.25, float %25, float %155)
  store float %157, ptr %arrayidx33, align 16
  %arrayidx33.1 = getelementptr inbounds [26 x float], ptr %scarr, i64 0, i64 25
  %158 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 0, i64 25), align 4
  %conv.1216 = sitofp i32 %158 to float
  %159 = tail call float @llvm.fmuladd.f32(float %conv.1216, float %7, float 0.000000e+00)
  %160 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 1, i64 25), align 4
  %conv.1.1 = sitofp i32 %160 to float
  %161 = tail call float @llvm.fmuladd.f32(float %conv.1.1, float %8, float %159)
  %162 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 2, i64 25), align 4
  %conv.2.1 = sitofp i32 %162 to float
  %163 = tail call float @llvm.fmuladd.f32(float %conv.2.1, float %9, float %161)
  %164 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 3, i64 25), align 4
  %conv.3.1 = sitofp i32 %164 to float
  %165 = tail call float @llvm.fmuladd.f32(float %conv.3.1, float %10, float %163)
  %166 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 4, i64 25), align 4
  %conv.4.1 = sitofp i32 %166 to float
  %167 = tail call float @llvm.fmuladd.f32(float %conv.4.1, float %11, float %165)
  %168 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 5, i64 25), align 4
  %conv.5.1 = sitofp i32 %168 to float
  %169 = tail call float @llvm.fmuladd.f32(float %conv.5.1, float %12, float %167)
  %170 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 6, i64 25), align 4
  %conv.6.1 = sitofp i32 %170 to float
  %171 = tail call float @llvm.fmuladd.f32(float %conv.6.1, float %13, float %169)
  %172 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 7, i64 25), align 4
  %conv.7.1 = sitofp i32 %172 to float
  %173 = tail call float @llvm.fmuladd.f32(float %conv.7.1, float %14, float %171)
  %174 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 8, i64 25), align 4
  %conv.8.1 = sitofp i32 %174 to float
  %175 = tail call float @llvm.fmuladd.f32(float %conv.8.1, float %15, float %173)
  %176 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 9, i64 25), align 4
  %conv.9.1 = sitofp i32 %176 to float
  %177 = tail call float @llvm.fmuladd.f32(float %conv.9.1, float %16, float %175)
  %178 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 10, i64 25), align 4
  %conv.10.1 = sitofp i32 %178 to float
  %179 = tail call float @llvm.fmuladd.f32(float %conv.10.1, float %.pre, float %177)
  %180 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 11, i64 25), align 4
  %conv.11.1 = sitofp i32 %180 to float
  %181 = tail call float @llvm.fmuladd.f32(float %conv.11.1, float %.pre134, float %179)
  %182 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 12, i64 25), align 4
  %conv.12.1 = sitofp i32 %182 to float
  %183 = tail call float @llvm.fmuladd.f32(float %conv.12.1, float %.pre135, float %181)
  %184 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 13, i64 25), align 4
  %conv.13.1 = sitofp i32 %184 to float
  %185 = tail call float @llvm.fmuladd.f32(float %conv.13.1, float %.pre136, float %183)
  %186 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 14, i64 25), align 4
  %conv.14.1 = sitofp i32 %186 to float
  %187 = tail call float @llvm.fmuladd.f32(float %conv.14.1, float %.pre137, float %185)
  %188 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 15, i64 25), align 4
  %conv.15.1 = sitofp i32 %188 to float
  %189 = tail call float @llvm.fmuladd.f32(float %conv.15.1, float %.pre138, float %187)
  %190 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 16, i64 25), align 4
  %conv.16.1 = sitofp i32 %190 to float
  %191 = tail call float @llvm.fmuladd.f32(float %conv.16.1, float %.pre139, float %189)
  %192 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 17, i64 25), align 4
  %conv.17.1 = sitofp i32 %192 to float
  %193 = tail call float @llvm.fmuladd.f32(float %conv.17.1, float %17, float %191)
  %194 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 18, i64 25), align 4
  %conv.18.1 = sitofp i32 %194 to float
  %195 = tail call float @llvm.fmuladd.f32(float %conv.18.1, float %18, float %193)
  %196 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 19, i64 25), align 4
  %conv.19.1 = sitofp i32 %196 to float
  %197 = tail call float @llvm.fmuladd.f32(float %conv.19.1, float %19, float %195)
  %198 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 20, i64 25), align 4
  %conv.20.1 = sitofp i32 %198 to float
  %199 = tail call float @llvm.fmuladd.f32(float %conv.20.1, float %20, float %197)
  %200 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 21, i64 25), align 4
  %conv.21.1 = sitofp i32 %200 to float
  %201 = tail call float @llvm.fmuladd.f32(float %conv.21.1, float %21, float %199)
  %202 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 22, i64 25), align 4
  %conv.22.1 = sitofp i32 %202 to float
  %203 = tail call float @llvm.fmuladd.f32(float %conv.22.1, float %22, float %201)
  %204 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 23, i64 25), align 4
  %conv.23.1 = sitofp i32 %204 to float
  %205 = tail call float @llvm.fmuladd.f32(float %conv.23.1, float %23, float %203)
  %206 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 24, i64 25), align 4
  %conv.24.1 = sitofp i32 %206 to float
  %207 = tail call float @llvm.fmuladd.f32(float %conv.24.1, float %24, float %205)
  %208 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 25, i64 25), align 4
  %conv.25.1 = sitofp i32 %208 to float
  %209 = tail call float @llvm.fmuladd.f32(float %conv.25.1, float %25, float %207)
  store float %209, ptr %arrayidx33.1, align 4
...
while.body:                                       ; preds = %for.body31, %for.end66
  ...
  %210 = load ptr, ptr %cpmxpdnpt.0116, align 8
  %211 = load i32, ptr %210, align 4
  %cmp57109 = icmp sgt i32 %211, -1
  br i1 %cmp57109, label %for.body59.lr.ph, label %for.end66

for.body59.lr.ph:                                 ; preds = %while.body
  %212 = load ptr, ptr %cpmxpdpt.0115, align 8
  br label %for.body59

for.body59:                                       ; preds = %for.body59.lr.ph, %for.body59
  %indvars.iv131 = phi i64 [ 0, %for.body59.lr.ph ], [ %indvars.iv.next132, %for.body59 ]
  %213 = phi float [ 0.000000e+00, %for.body59.lr.ph ], [ %217, %for.body59 ]
  %214 = phi i32 [ %211, %for.body59.lr.ph ], [ %218, %for.body59 ]
  %idxprom60 = zext i32 %214 to i64
  %arrayidx61 = getelementptr inbounds [26 x float], ptr %scarr, i64 0, i64 %idxprom60
  %215 = load float, ptr %arrayidx61, align 4
  %arrayidx63 = getelementptr inbounds float, ptr %212, i64 %indvars.iv131
  %216 = load float, ptr %arrayidx63, align 4
  %217 = tail call float @llvm.fmuladd.f32(float %215, float %216, float %213)
  store float %217, ptr %matchpt.0114, align 4
  %indvars.iv.next132 = add nuw nsw i64 %indvars.iv131, 1
  %arrayidx56 = getelementptr inbounds i32, ptr %210, i64 %indvars.iv.next132
  %218 = load i32, ptr %arrayidx56, align 4
  %cmp57 = icmp sgt i32 %218, -1
