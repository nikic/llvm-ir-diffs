...
vector.body:                                      ; preds = %vector.body, %if.end28
  ...
  %wide.load = load <4 x i32>, ptr %31, align 16
  ...
  %wide.load140 = load <4 x i32>, ptr %34, align 8
  %35 = sitofp <4 x i32> %wide.load140 to <4 x float>
  %36 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %35, <4 x float> %broadcast.splat142, <4 x float> %33)
  %37 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 2, i64 %index
  %wide.load143 = load <4 x i32>, ptr %37, align 16
  %38 = sitofp <4 x i32> %wide.load143 to <4 x float>
  %39 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %38, <4 x float> %broadcast.splat145, <4 x float> %36)
  %40 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 3, i64 %index
  %wide.load146 = load <4 x i32>, ptr %40, align 8
  %41 = sitofp <4 x i32> %wide.load146 to <4 x float>
  %42 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %41, <4 x float> %broadcast.splat148, <4 x float> %39)
  %43 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 4, i64 %index
  %wide.load149 = load <4 x i32>, ptr %43, align 16
  %44 = sitofp <4 x i32> %wide.load149 to <4 x float>
  %45 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %44, <4 x float> %broadcast.splat151, <4 x float> %42)
  %46 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 5, i64 %index
  %wide.load152 = load <4 x i32>, ptr %46, align 8
  %47 = sitofp <4 x i32> %wide.load152 to <4 x float>
  %48 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %47, <4 x float> %broadcast.splat154, <4 x float> %45)
  %49 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 6, i64 %index
  %wide.load155 = load <4 x i32>, ptr %49, align 16
  %50 = sitofp <4 x i32> %wide.load155 to <4 x float>
  %51 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %50, <4 x float> %broadcast.splat157, <4 x float> %48)
  %52 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 7, i64 %index
  %wide.load158 = load <4 x i32>, ptr %52, align 8
  %53 = sitofp <4 x i32> %wide.load158 to <4 x float>
  %54 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %53, <4 x float> %broadcast.splat160, <4 x float> %51)
  %55 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 8, i64 %index
  %wide.load161 = load <4 x i32>, ptr %55, align 16
  %56 = sitofp <4 x i32> %wide.load161 to <4 x float>
  %57 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %56, <4 x float> %broadcast.splat163, <4 x float> %54)
  %58 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 9, i64 %index
  %wide.load164 = load <4 x i32>, ptr %58, align 8
  %59 = sitofp <4 x i32> %wide.load164 to <4 x float>
  %60 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %59, <4 x float> %broadcast.splat166, <4 x float> %57)
  %61 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 10, i64 %index
  %wide.load167 = load <4 x i32>, ptr %61, align 16
  %62 = sitofp <4 x i32> %wide.load167 to <4 x float>
  %63 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %62, <4 x float> %broadcast.splat169, <4 x float> %60)
  %64 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 11, i64 %index
  %wide.load170 = load <4 x i32>, ptr %64, align 8
  %65 = sitofp <4 x i32> %wide.load170 to <4 x float>
  %66 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %65, <4 x float> %broadcast.splat172, <4 x float> %63)
  %67 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 12, i64 %index
  %wide.load173 = load <4 x i32>, ptr %67, align 16
  %68 = sitofp <4 x i32> %wide.load173 to <4 x float>
  %69 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %68, <4 x float> %broadcast.splat175, <4 x float> %66)
  %70 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 13, i64 %index
  %wide.load176 = load <4 x i32>, ptr %70, align 8
  %71 = sitofp <4 x i32> %wide.load176 to <4 x float>
  %72 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %71, <4 x float> %broadcast.splat178, <4 x float> %69)
  %73 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 14, i64 %index
  %wide.load179 = load <4 x i32>, ptr %73, align 16
  %74 = sitofp <4 x i32> %wide.load179 to <4 x float>
  %75 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %74, <4 x float> %broadcast.splat181, <4 x float> %72)
  %76 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 15, i64 %index
  %wide.load182 = load <4 x i32>, ptr %76, align 8
  %77 = sitofp <4 x i32> %wide.load182 to <4 x float>
  %78 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %77, <4 x float> %broadcast.splat184, <4 x float> %75)
  %79 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 16, i64 %index
  %wide.load185 = load <4 x i32>, ptr %79, align 16
  %80 = sitofp <4 x i32> %wide.load185 to <4 x float>
  %81 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %80, <4 x float> %broadcast.splat187, <4 x float> %78)
  %82 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 17, i64 %index
  %wide.load188 = load <4 x i32>, ptr %82, align 8
  %83 = sitofp <4 x i32> %wide.load188 to <4 x float>
  %84 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %83, <4 x float> %broadcast.splat190, <4 x float> %81)
  %85 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 18, i64 %index
  %wide.load191 = load <4 x i32>, ptr %85, align 16
  %86 = sitofp <4 x i32> %wide.load191 to <4 x float>
  %87 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %86, <4 x float> %broadcast.splat193, <4 x float> %84)
  %88 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 19, i64 %index
  %wide.load194 = load <4 x i32>, ptr %88, align 8
  %89 = sitofp <4 x i32> %wide.load194 to <4 x float>
  %90 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %89, <4 x float> %broadcast.splat196, <4 x float> %87)
  %91 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 20, i64 %index
  %wide.load197 = load <4 x i32>, ptr %91, align 16
  %92 = sitofp <4 x i32> %wide.load197 to <4 x float>
  %93 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %92, <4 x float> %broadcast.splat199, <4 x float> %90)
  %94 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 21, i64 %index
  %wide.load200 = load <4 x i32>, ptr %94, align 8
  %95 = sitofp <4 x i32> %wide.load200 to <4 x float>
  %96 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %95, <4 x float> %broadcast.splat202, <4 x float> %93)
  %97 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 22, i64 %index
  %wide.load203 = load <4 x i32>, ptr %97, align 16
  %98 = sitofp <4 x i32> %wide.load203 to <4 x float>
  %99 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %98, <4 x float> %broadcast.splat205, <4 x float> %96)
  %100 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 23, i64 %index
  %wide.load206 = load <4 x i32>, ptr %100, align 8
  %101 = sitofp <4 x i32> %wide.load206 to <4 x float>
  %102 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %101, <4 x float> %broadcast.splat208, <4 x float> %99)
  %103 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 24, i64 %index
  %wide.load209 = load <4 x i32>, ptr %103, align 16
  %104 = sitofp <4 x i32> %wide.load209 to <4 x float>
  %105 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %104, <4 x float> %broadcast.splat211, <4 x float> %102)
  %106 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 25, i64 %index
  %wide.load212 = load <4 x i32>, ptr %106, align 8
  %107 = sitofp <4 x i32> %wide.load212 to <4 x float>
  %108 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %107, <4 x float> %broadcast.splat214, <4 x float> %105)
  store <4 x float> %108, ptr %30, align 16
  %index.next = add nuw i64 %index, 4
  %109 = icmp eq i64 %index.next, 24
  br i1 %109, label %for.body31, label %vector.body

for.body31:                                       ; preds = %vector.body
  %arrayidx33 = getelementptr inbounds [26 x float], ptr %scarr, i64 0, i64 24
  %110 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 0, i64 24), align 16
  %conv = sitofp i32 %110 to float
  %111 = tail call float @llvm.fmuladd.f32(float %conv, float %11, float 0.000000e+00)
  %112 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 1, i64 24), align 8
  %conv.1 = sitofp i32 %112 to float
  %113 = tail call float @llvm.fmuladd.f32(float %conv.1, float %12, float %111)
  %114 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 2, i64 24), align 16
  %conv.2 = sitofp i32 %114 to float
  %115 = tail call float @llvm.fmuladd.f32(float %conv.2, float %13, float %113)
  %116 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 3, i64 24), align 8
  %conv.3 = sitofp i32 %116 to float
  %117 = tail call float @llvm.fmuladd.f32(float %conv.3, float %14, float %115)
  %118 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 4, i64 24), align 16
  %conv.4 = sitofp i32 %118 to float
  %119 = tail call float @llvm.fmuladd.f32(float %conv.4, float %15, float %117)
  %120 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 5, i64 24), align 8
  %conv.5 = sitofp i32 %120 to float
  %121 = tail call float @llvm.fmuladd.f32(float %conv.5, float %16, float %119)
  %122 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 6, i64 24), align 16
  %conv.6 = sitofp i32 %122 to float
  %123 = tail call float @llvm.fmuladd.f32(float %conv.6, float %17, float %121)
  %124 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 7, i64 24), align 8
  %conv.7 = sitofp i32 %124 to float
  %125 = tail call float @llvm.fmuladd.f32(float %conv.7, float %18, float %123)
  %126 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 8, i64 24), align 16
  %conv.8 = sitofp i32 %126 to float
  %127 = tail call float @llvm.fmuladd.f32(float %conv.8, float %19, float %125)
  %128 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 9, i64 24), align 8
  %conv.9 = sitofp i32 %128 to float
  %129 = tail call float @llvm.fmuladd.f32(float %conv.9, float %20, float %127)
  %130 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 10, i64 24), align 16
  %conv.10 = sitofp i32 %130 to float
  %131 = tail call float @llvm.fmuladd.f32(float %conv.10, float %.pre, float %129)
  %132 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 11, i64 24), align 8
  %conv.11 = sitofp i32 %132 to float
  %133 = tail call float @llvm.fmuladd.f32(float %conv.11, float %.pre134, float %131)
  %134 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 12, i64 24), align 16
  %conv.12 = sitofp i32 %134 to float
  %135 = tail call float @llvm.fmuladd.f32(float %conv.12, float %.pre135, float %133)
  %136 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 13, i64 24), align 8
  %conv.13 = sitofp i32 %136 to float
  %137 = tail call float @llvm.fmuladd.f32(float %conv.13, float %.pre136, float %135)
  %138 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 14, i64 24), align 16
  %conv.14 = sitofp i32 %138 to float
  %139 = tail call float @llvm.fmuladd.f32(float %conv.14, float %.pre137, float %137)
  %140 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 15, i64 24), align 8
  %conv.15 = sitofp i32 %140 to float
  %141 = tail call float @llvm.fmuladd.f32(float %conv.15, float %.pre138, float %139)
  %142 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 16, i64 24), align 16
  %conv.16 = sitofp i32 %142 to float
  %143 = tail call float @llvm.fmuladd.f32(float %conv.16, float %.pre139, float %141)
  %144 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 17, i64 24), align 8
  %conv.17 = sitofp i32 %144 to float
  %145 = tail call float @llvm.fmuladd.f32(float %conv.17, float %21, float %143)
  %146 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 18, i64 24), align 16
  %conv.18 = sitofp i32 %146 to float
  %147 = tail call float @llvm.fmuladd.f32(float %conv.18, float %22, float %145)
  %148 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 19, i64 24), align 8
  %conv.19 = sitofp i32 %148 to float
  %149 = tail call float @llvm.fmuladd.f32(float %conv.19, float %23, float %147)
  %150 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 20, i64 24), align 16
  %conv.20 = sitofp i32 %150 to float
  %151 = tail call float @llvm.fmuladd.f32(float %conv.20, float %24, float %149)
  %152 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 21, i64 24), align 8
  %conv.21 = sitofp i32 %152 to float
  %153 = tail call float @llvm.fmuladd.f32(float %conv.21, float %25, float %151)
  %154 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 22, i64 24), align 16
  %conv.22 = sitofp i32 %154 to float
  %155 = tail call float @llvm.fmuladd.f32(float %conv.22, float %26, float %153)
  %156 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 23, i64 24), align 8
  %conv.23 = sitofp i32 %156 to float
  %157 = tail call float @llvm.fmuladd.f32(float %conv.23, float %27, float %155)
  %158 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 24, i64 24), align 16
  %conv.24 = sitofp i32 %158 to float
  %159 = tail call float @llvm.fmuladd.f32(float %conv.24, float %28, float %157)
  %160 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 25, i64 24), align 8
  %conv.25 = sitofp i32 %160 to float
  %161 = tail call float @llvm.fmuladd.f32(float %conv.25, float %29, float %159)
  store float %161, ptr %arrayidx33, align 16
  %arrayidx33.1 = getelementptr inbounds [26 x float], ptr %scarr, i64 0, i64 25
  %162 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 0, i64 25), align 4
  %conv.1216 = sitofp i32 %162 to float
  %163 = tail call float @llvm.fmuladd.f32(float %conv.1216, float %11, float 0.000000e+00)
  %164 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 1, i64 25), align 4
  %conv.1.1 = sitofp i32 %164 to float
  %165 = tail call float @llvm.fmuladd.f32(float %conv.1.1, float %12, float %163)
  %166 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 2, i64 25), align 4
  %conv.2.1 = sitofp i32 %166 to float
  %167 = tail call float @llvm.fmuladd.f32(float %conv.2.1, float %13, float %165)
  %168 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 3, i64 25), align 4
  %conv.3.1 = sitofp i32 %168 to float
  %169 = tail call float @llvm.fmuladd.f32(float %conv.3.1, float %14, float %167)
  %170 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 4, i64 25), align 4
  %conv.4.1 = sitofp i32 %170 to float
  %171 = tail call float @llvm.fmuladd.f32(float %conv.4.1, float %15, float %169)
  %172 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 5, i64 25), align 4
  %conv.5.1 = sitofp i32 %172 to float
  %173 = tail call float @llvm.fmuladd.f32(float %conv.5.1, float %16, float %171)
  %174 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 6, i64 25), align 4
  %conv.6.1 = sitofp i32 %174 to float
  %175 = tail call float @llvm.fmuladd.f32(float %conv.6.1, float %17, float %173)
  %176 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 7, i64 25), align 4
  %conv.7.1 = sitofp i32 %176 to float
  %177 = tail call float @llvm.fmuladd.f32(float %conv.7.1, float %18, float %175)
  %178 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 8, i64 25), align 4
  %conv.8.1 = sitofp i32 %178 to float
  %179 = tail call float @llvm.fmuladd.f32(float %conv.8.1, float %19, float %177)
  %180 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 9, i64 25), align 4
  %conv.9.1 = sitofp i32 %180 to float
  %181 = tail call float @llvm.fmuladd.f32(float %conv.9.1, float %20, float %179)
  %182 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 10, i64 25), align 4
  %conv.10.1 = sitofp i32 %182 to float
  %183 = tail call float @llvm.fmuladd.f32(float %conv.10.1, float %.pre, float %181)
  %184 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 11, i64 25), align 4
  %conv.11.1 = sitofp i32 %184 to float
  %185 = tail call float @llvm.fmuladd.f32(float %conv.11.1, float %.pre134, float %183)
  %186 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 12, i64 25), align 4
  %conv.12.1 = sitofp i32 %186 to float
  %187 = tail call float @llvm.fmuladd.f32(float %conv.12.1, float %.pre135, float %185)
  %188 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 13, i64 25), align 4
  %conv.13.1 = sitofp i32 %188 to float
  %189 = tail call float @llvm.fmuladd.f32(float %conv.13.1, float %.pre136, float %187)
  %190 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 14, i64 25), align 4
  %conv.14.1 = sitofp i32 %190 to float
  %191 = tail call float @llvm.fmuladd.f32(float %conv.14.1, float %.pre137, float %189)
  %192 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 15, i64 25), align 4
  %conv.15.1 = sitofp i32 %192 to float
  %193 = tail call float @llvm.fmuladd.f32(float %conv.15.1, float %.pre138, float %191)
  %194 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 16, i64 25), align 4
  %conv.16.1 = sitofp i32 %194 to float
  %195 = tail call float @llvm.fmuladd.f32(float %conv.16.1, float %.pre139, float %193)
  %196 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 17, i64 25), align 4
  %conv.17.1 = sitofp i32 %196 to float
  %197 = tail call float @llvm.fmuladd.f32(float %conv.17.1, float %21, float %195)
  %198 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 18, i64 25), align 4
  %conv.18.1 = sitofp i32 %198 to float
  %199 = tail call float @llvm.fmuladd.f32(float %conv.18.1, float %22, float %197)
  %200 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 19, i64 25), align 4
  %conv.19.1 = sitofp i32 %200 to float
  %201 = tail call float @llvm.fmuladd.f32(float %conv.19.1, float %23, float %199)
  %202 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 20, i64 25), align 4
  %conv.20.1 = sitofp i32 %202 to float
  %203 = tail call float @llvm.fmuladd.f32(float %conv.20.1, float %24, float %201)
  %204 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 21, i64 25), align 4
  %conv.21.1 = sitofp i32 %204 to float
  %205 = tail call float @llvm.fmuladd.f32(float %conv.21.1, float %25, float %203)
  %206 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 22, i64 25), align 4
  %conv.22.1 = sitofp i32 %206 to float
  %207 = tail call float @llvm.fmuladd.f32(float %conv.22.1, float %26, float %205)
  %208 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 23, i64 25), align 4
  %conv.23.1 = sitofp i32 %208 to float
  %209 = tail call float @llvm.fmuladd.f32(float %conv.23.1, float %27, float %207)
  %210 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 24, i64 25), align 4
  %conv.24.1 = sitofp i32 %210 to float
  %211 = tail call float @llvm.fmuladd.f32(float %conv.24.1, float %28, float %209)
  %212 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 25, i64 25), align 4
  %conv.25.1 = sitofp i32 %212 to float
  %213 = tail call float @llvm.fmuladd.f32(float %conv.25.1, float %29, float %211)
  store float %213, ptr %arrayidx33.1, align 4
...
while.body:                                       ; preds = %for.body31, %for.end66
  ...
  %214 = load ptr, ptr %cpmxpdnpt.0116, align 8
  %215 = load i32, ptr %214, align 4
  %cmp57109 = icmp sgt i32 %215, -1
  br i1 %cmp57109, label %for.body59.lr.ph, label %for.end66

for.body59.lr.ph:                                 ; preds = %while.body
  %216 = load ptr, ptr %cpmxpdpt.0115, align 8
  br label %for.body59
...
for.body59:                                       ; preds = %for.body59.lr.ph, %for.body59
  ...
  %219 = load float, ptr %arrayidx61, align 4
  %arrayidx63 = getelementptr inbounds float, ptr %216, i64 %indvars.iv131
  %220 = load float, ptr %arrayidx63, align 4
  %221 = tail call float @llvm.fmuladd.f32(float %219, float %220, float %217)
  store float %221, ptr %matchpt.0114, align 4
  %indvars.iv.next132 = add nuw nsw i64 %indvars.iv131, 1
  %arrayidx56 = getelementptr inbounds i32, ptr %214, i64 %indvars.iv.next132
  %222 = load i32, ptr %arrayidx56, align 4
