...
vector.body1349:                                  ; preds = %vector.body1349, %vector.ph1344
  ...
  %wide.load1351 = load <2 x ptr>, ptr %48, align 8, !tbaa !5
  %49 = getelementptr inbounds ptr, ptr %48, i64 2
  %wide.load1352 = load <2 x ptr>, ptr %49, align 8, !tbaa !5
  %50 = getelementptr inbounds ptr, ptr %44, i64 %index1350
  store <2 x ptr> %wide.load1351, ptr %50, align 8, !tbaa !5
  %51 = getelementptr inbounds ptr, ptr %50, i64 2
  store <2 x ptr> %wide.load1352, ptr %51, align 8, !tbaa !5
  %index.next1353 = add nuw i64 %index1350, 4
  %52 = icmp eq i64 %index.next1353, %n.vec1346
  br i1 %52, label %middle.block1341, label %vector.body1349, !llvm.loop !33
...
for.body257:                                      ; preds = %for.body249, %for.body257
  ...
  %360 = load i8, ptr %arrayidx261, align 1, !tbaa !9
  ...
  %362 = load ptr, ptr %arrayidx276, align 8, !tbaa !5
...
for.cond349.preheader:                            ; preds = %for.cond349.preheader.lr.ph, %for.cond344.loopexit
  ...
  %383 = load ptr, ptr %arrayidx355, align 8, !tbaa !5
  %arrayidx359 = getelementptr inbounds ptr, ptr %.pre1323.pre.pre, i64 %indvars.iv1226
  %384 = load ptr, ptr %arrayidx359, align 8, !tbaa !5
...
vector.body1447:                                  ; preds = %vector.body1447, %vector.ph1442
  ...
  store <4 x float> zeroinitializer, ptr %388, align 4, !tbaa !36
  ...
  br i1 %392, label %middle.block1439, label %vector.body1447, !llvm.loop !47
...
for.body372:                                      ; preds = %for.body372.lr.ph, %for.inc416
  ...
  %400 = load double, ptr %arrayidx374, align 8, !tbaa !24
...
for.body380.lr.ph:                                ; preds = %for.body372
  ...
  %401 = load ptr, ptr %arrayidx382, align 8, !tbaa !5
...
for.body380:                                      ; preds = %for.body380.lr.ph, %for.inc413
  ...
  %403 = load i8, ptr %arrayidx384, align 1, !tbaa !9
...
for.body444.prol:                                 ; preds = %for.body444.lr.ph, %for.body444.prol
  ...
  %419 = load float, ptr %arrayidx453.prol, align 4, !tbaa !36
...
for.body427:                                      ; preds = %for.body427, %for.body427.lr.ph.new
  ...
  %422 = load float, ptr %arrayidx436, align 4, !tbaa !36
  ...
  %423 = load float, ptr %arrayidx436.1, align 4, !tbaa !36
  ...
  %424 = load float, ptr %arrayidx436.2, align 4, !tbaa !36
  ...
  %425 = load float, ptr %arrayidx436.3, align 4, !tbaa !36
...
for.body444:                                      ; preds = %for.body444.prol.loopexit, %for.body444
  ...
  %426 = load float, ptr %arrayidx453, align 4, !tbaa !36
  ...
  %427 = load float, ptr %arrayidx453.1, align 4, !tbaa !36
  ...
  %428 = load float, ptr %arrayidx453.2, align 4, !tbaa !36
  ...
  %429 = load float, ptr %arrayidx453.3, align 4, !tbaa !36
  ...
  br i1 %430, label %for.body444, label %for.inc457, !llvm.loop !55
...
for.end459:                                       ; preds = %for.inc457, %for.cond419.preheader
  %431 = load ptr, ptr @Calignm1.v, align 8, !tbaa !5
  store ptr %431, ptr @Calignm1.w, align 8, !tbaa !5
  %432 = load ptr, ptr @Calignm1.g, align 8, !tbaa !5
  %433 = load ptr, ptr %432, align 8, !tbaa !5
  %434 = load ptr, ptr %433, align 8, !tbaa !5
  %435 = load float, ptr %434, align 4, !tbaa !36
  %436 = load ptr, ptr %431, align 8, !tbaa !5
  %437 = load float, ptr %436, align 4, !tbaa !36
  %add465 = fadd float %435, %437
  store float %add465, ptr %436, align 4, !tbaa !36
  %arrayidx468 = getelementptr inbounds float, ptr %434, i64 1
  %438 = load float, ptr %arrayidx468, align 4, !tbaa !36
  %arrayidx469 = getelementptr inbounds ptr, ptr %432, i64 1
  %439 = load ptr, ptr %arrayidx469, align 8, !tbaa !5
  %arrayidx470 = getelementptr inbounds ptr, ptr %439, i64 1
  %440 = load ptr, ptr %arrayidx470, align 8, !tbaa !5
...
for.body485:                                      ; preds = %for.body485.lr.ph, %for.body485
  ...
  %457 = load ptr, ptr %arrayidx509, align 8, !tbaa !5
  %arrayidx510 = getelementptr inbounds ptr, ptr %457, i64 1
  %458 = load ptr, ptr %arrayidx510, align 8, !tbaa !5
  ...
  %460 = load ptr, ptr %arrayidx514, align 8, !tbaa !5
...
for.end525:                                       ; preds = %for.body485, %for.end459
  %464 = load i32, ptr @penalty, align 4, !tbaa !14
  %conv526 = sitofp i32 %464 to float
  %465 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 24), align 16, !tbaa !14
  ...
  %467 = load float, ptr %arrayidx531, align 4, !tbaa !36
...
for.body537.epil:                                 ; preds = %for.cond549.preheader.loopexit.unr-lcssa
  ...
  %473 = load float, ptr %arrayidx544.epil, align 4, !tbaa !36
...
for.body553.lr.ph:                                ; preds = %for.cond549.preheader
  %474 = load ptr, ptr @Calignm1.m, align 8, !tbaa !5
  %475 = load ptr, ptr @Calignm1.mp, align 8, !tbaa !5
  %476 = add i64 %call5, 1
...
vector.body1458:                                  ; preds = %vector.body1458, %vector.ph1453
  ...
  store <4 x float> zeroinitializer, ptr %477, align 4, !tbaa !36
  %478 = getelementptr inbounds float, ptr %477, i64 4
  store <4 x float> zeroinitializer, ptr %478, align 4, !tbaa !36
  %479 = getelementptr inbounds i32, ptr %475, i64 %index1459
  store <4 x i32> zeroinitializer, ptr %479, align 4, !tbaa !14
  %480 = getelementptr inbounds i32, ptr %479, i64 4
  store <4 x i32> zeroinitializer, ptr %480, align 4, !tbaa !14
  %index.next1460 = add nuw i64 %index1459, 8
  %481 = icmp eq i64 %index.next1460, %n.vec1455
  br i1 %481, label %middle.block1450, label %vector.body1458, !llvm.loop !58
...
for.body537:                                      ; preds = %for.body537, %for.body537.preheader.new
  ...
  %484 = load float, ptr %arrayidx544, align 4, !tbaa !36
  ...
  %487 = load float, ptr %arrayidx544.1, align 4, !tbaa !36
...
if.else665.peel:                                  ; preds = %if.end612.peel
  %508 = load float, ptr %436, align 4, !tbaa !36
  %arrayidx673.peel = getelementptr inbounds float, ptr %499, i64 1
  %509 = load float, ptr %arrayidx673.peel, align 4, !tbaa !36
...
if.then615.peel:                                  ; preds = %if.end612.peel
  %510 = load ptr, ptr %arrayidx618, align 8, !tbaa !5
  %511 = load float, ptr %510, align 4, !tbaa !36
  %512 = load ptr, ptr %arrayidx590, align 8, !tbaa !5
  %513 = load ptr, ptr %512, align 8, !tbaa !5
  %arrayidx626.peel = getelementptr inbounds float, ptr %513, i64 1
  %514 = load float, ptr %arrayidx626.peel, align 4, !tbaa !36
  %add627.peel = fadd float %511, %514
  %515 = load float, ptr %arrayidx630, align 4, !tbaa !36
  %add631.peel = fadd float %add627.peel, %515
  %arrayidx635.peel = getelementptr inbounds ptr, ptr %512, i64 1
  %516 = load ptr, ptr %arrayidx635.peel, align 8, !tbaa !5
  %arrayidx636.peel = getelementptr inbounds float, ptr %516, i64 1
  %517 = load float, ptr %arrayidx636.peel, align 4, !tbaa !36
  %518 = load ptr, ptr %arrayidx639, align 8, !tbaa !5
  %519 = load i32, ptr %arrayidx641.peel, align 4, !tbaa !14
  ...
  %520 = load float, ptr %arrayidx645.peel, align 4, !tbaa !36
  %add646.peel = fadd float %517, %520
  %add650.peel = fadd float %515, %add646.peel
  %521 = load float, ptr %arrayidx652.peel, align 4, !tbaa !36
...
if.then658.peel:                                  ; preds = %if.then615.peel
  ...
  store i32 %497, ptr %arrayidx641.peel, align 4, !tbaa !14
  br label %if.end679.peel
...
if.end679.peel:                                   ; preds = %if.then658.peel, %if.then615.peel, %if.else665.peel
  ...
  %523 = load float, ptr %494, align 4, !tbaa !36
  %524 = load float, ptr %499, align 4, !tbaa !36
  ...
  %525 = load float, ptr %501, align 4, !tbaa !36
...
if.end709.peel:                                   ; preds = %if.then702.peel, %if.end679.peel
  ...
  %526 = load float, ptr %502, align 4, !tbaa !36
  %add716.peel = fadd float %522, %526
  %527 = load i32, ptr %arrayidx720.peel, align 4, !tbaa !14
  ...
  %529 = load float, ptr %arrayidx723.peel, align 4, !tbaa !36
...
if.end735.peel:                                   ; preds = %if.then727.peel, %if.end709.peel
  ...
  %530 = load float, ptr %arrayidx739.peel, align 4, !tbaa !36
...
if.then573:                                       ; preds = %if.end735, %for.body570.peel.next
  ...
  %539 = load float, ptr %arrayidx579, align 4, !tbaa !36
  %540 = load float, ptr %arrayidx584, align 4, !tbaa !36
  %add585 = fadd float %539, %540
  %541 = load i32, ptr getelementptr inbounds ([26 x [26 x i32]], ptr @n_dis, i64 0, i64 24), align 16, !tbaa !14
  %conv586 = sitofp i32 %541 to float
  %542 = tail call float @llvm.fmuladd.f32(float %conv586, float %totaleff.0.lcssa, float %add585)
  %543 = load float, ptr %arrayidx592, align 4, !tbaa !36
...
if.then658:                                       ; preds = %if.then615
  ...
  store i32 %497, ptr %arrayidx641, align 4, !tbaa !14
  br label %if.end679

if.else665:                                       ; preds = %if.then573
  %560 = add nsw i64 %indvars.iv1283, -1
  %arrayidx669 = getelementptr inbounds float, ptr %436, i64 %560
  %561 = load float, ptr %arrayidx669, align 4, !tbaa !36
  %562 = load ptr, ptr %531, align 8, !tbaa !5
  %arrayidx673 = getelementptr inbounds float, ptr %562, i64 1
  %563 = load float, ptr %arrayidx673, align 4, !tbaa !36
...
if.end679:                                        ; preds = %if.then615, %if.then658, %if.else665
  ...
  %565 = load float, ptr %arrayidx685, align 4, !tbaa !36
  %566 = load float, ptr %499, align 4, !tbaa !36
  ...
  %567 = load float, ptr %501, align 4, !tbaa !36
...
if.end709:                                        ; preds = %if.then702, %if.end679
  ...
  %571 = load float, ptr %arrayidx723, align 4, !tbaa !36
...
if.end735:                                        ; preds = %if.then727, %if.end709
  ...
  %572 = load float, ptr %arrayidx739, align 4, !tbaa !36
...
for.end746:                                       ; preds = %for.cond566.for.inc744_crit_edge, %for.body565.lr.ph, %for.cond561.preheader
  %573 = load i32, ptr @cnst, align 4, !tbaa !14
...
for.end746.if.end768_crit_edge:                   ; preds = %for.end746
  ...
  %.pre1325.pre.pre = load ptr, ptr @Calignm1.ijp, align 8, !tbaa !5
...
if.then748:                                       ; preds = %for.end746
  ...
  %574 = load ptr, ptr %arrayidx751, align 8, !tbaa !5
  ...
  %575 = load float, ptr %arrayidx754, align 4, !tbaa !36
  %arrayidx756 = getelementptr inbounds ptr, ptr %432, i64 %idxprom215.pre-phi
  %576 = load ptr, ptr %arrayidx756, align 8, !tbaa !5
  ...
  %579 = load ptr, ptr %arrayidx761, align 8, !tbaa !5
  ...
  %580 = load ptr, ptr @Calignm1.ijp, align 8, !tbaa !5
  %arrayidx765 = getelementptr inbounds ptr, ptr %580, i64 %idxprom215.pre-phi
  %581 = load ptr, ptr %arrayidx765, align 8, !tbaa !5
...
if.end768:                                        ; preds = %for.end746.if.end768_crit_edge, %if.then748
  ...
  %583 = load float, ptr %arrayidx772, align 4, !tbaa !36
  store float %583, ptr %wm, align 4, !tbaa !36
...
for.body777.epil:                                 ; preds = %for.cond785.preheader.loopexit.unr-lcssa, %for.body777.epil
  ...
  %587 = load ptr, ptr %arrayidx780.epil, align 8, !tbaa !5
  %588 = trunc i64 %indvars.iv.next1305.epil to i32
  store i32 %588, ptr %587, align 4, !tbaa !14
...
for.body789.lr.ph:                                ; preds = %for.cond785.preheader
  %589 = load ptr, ptr %.pre1325.pre, align 8, !tbaa !5
  %590 = add i64 %call5, 1
...
vector.body1469:                                  ; preds = %vector.body1469, %vector.ph1464
  ...
  store <4 x i32> %591, ptr %593, align 4, !tbaa !14
  %594 = getelementptr inbounds i32, ptr %593, i64 4
  store <4 x i32> %592, ptr %594, align 4, !tbaa !14
  %index.next1472 = add nuw i64 %index1470, 8
  %vec.ind.next = add <4 x i32> %vec.ind, <i32 8, i32 8, i32 8, i32 8>
  %595 = icmp eq i64 %index.next1472, %n.vec1466
  br i1 %595, label %middle.block1461, label %vector.body1469, !llvm.loop !65
...
for.body777:                                      ; preds = %for.body777, %for.body777.lr.ph.new
  ...
  %596 = load ptr, ptr %arrayidx780, align 8, !tbaa !5
  %597 = trunc i64 %indvars.iv.next1305 to i32
  store i32 %597, ptr %596, align 4, !tbaa !14
  ...
  %598 = load ptr, ptr %arrayidx780.1, align 8, !tbaa !5
  %599 = trunc i64 %indvars.iv.next1305.1 to i32
  store i32 %599, ptr %598, align 4, !tbaa !14
  ...
  %600 = load ptr, ptr %arrayidx780.2, align 8, !tbaa !5
  %601 = trunc i64 %indvars.iv.next1305.2 to i32
  store i32 %601, ptr %600, align 4, !tbaa !14
  ...
  %602 = load ptr, ptr %arrayidx780.3, align 8, !tbaa !5
  %603 = trunc i64 %indvars.iv.next1305.3 to i32
  store i32 %603, ptr %602, align 4, !tbaa !14
  ...
  %604 = load ptr, ptr %arrayidx780.4, align 8, !tbaa !5
  ...
  %606 = load ptr, ptr %arrayidx780.5, align 8, !tbaa !5
  ...
  %608 = load ptr, ptr %arrayidx780.6, align 8, !tbaa !5
  ...
  %610 = load ptr, ptr %arrayidx780.7, align 8, !tbaa !5
...
for.end797:                                       ; preds = %for.body789, %middle.block1461, %for.cond785.preheader
  ...
  %612 = load ptr, ptr @Calignm1.nseq, align 8, !tbaa !5
  ...
  %613 = load ptr, ptr %arrayidx770, align 8, !tbaa !5
  %arrayidx801 = getelementptr inbounds float, ptr %613, i64 %idxprom771.pre-phi
  %614 = load float, ptr %arrayidx801, align 4, !tbaa !36
  store float %614, ptr %wm, align 4, !tbaa !36
  ret ptr %612
}
