...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %2 = sub nsw i64 0, %wide.trip.count
  %3 = xor i64 %idxprom, %2
  %4 = icmp eq i64 %3, -1
...
for.inc.1:                                        ; preds = %if.then.1, %for.inc
  ...
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %for.end.loopexit.unr-lcssa.loopexit, label %for.body, !llvm.loop !98
...
for.body.epil:                                    ; preds = %for.end.loopexit.unr-lcssa
  ...
  %13 = load i8, ptr %arrayidx2.epil, align 1, !tbaa !11
...
if.then.epil:                                     ; preds = %for.body.epil
  ...
  %14 = load ptr, ptr %arrayidx6.epil, align 8, !tbaa !9
  %arrayidx8.epil = getelementptr inbounds ptr, ptr %group, i64 %k.015.unr
  store ptr %14, ptr %arrayidx8.epil, align 8, !tbaa !9
  br label %for.end
...
for.inc46:                                        ; preds = %for.body39, %for.cond31.preheader
  %indvars.iv.next91 = add nuw nsw i64 %indvars.iv90, 1
  %exitcond94.not = icmp eq i64 %indvars.iv.next91, %wide.trip.count93
  br i1 %exitcond94.not, label %for.end48, label %for.cond31.preheader, !llvm.loop !119
...
if.then37:                                        ; preds = %for.body33
  ...
  store i32 %19, ptr %arrayidx39, align 4, !tbaa !5
...
if.then37.1:                                      ; preds = %for.inc42
  ...
  store i32 %21, ptr %arrayidx39.1, align 4, !tbaa !5
...
if.then37.epil:                                   ; preds = %for.body33.epil
  ...
  store i32 %23, ptr %arrayidx39.epil, align 4, !tbaa !5
...
for.cond108.preheader:                            ; preds = %for.body80, %for.cond76.preheader
  %37 = load i32, ptr %.pre, align 4, !tbaa !5
...
for.body112:                                      ; preds = %for.cond108.preheader, %for.body112
  ...
  %48 = load ptr, ptr %arrayidx114, align 8, !tbaa !9
  ...
  %50 = load i32, ptr %arrayidx117, align 4, !tbaa !5
  ...
  %52 = load i32, ptr %arrayidx122, align 4, !tbaa !5
  %arrayidx126 = getelementptr inbounds ptr, ptr %pairwisenode, i64 %idxprom121
  %53 = load ptr, ptr %arrayidx126, align 8, !tbaa !9
  ...
  %55 = load i32, ptr %arrayidx110, align 4, !tbaa !5
...
for.body26.prol:                                  ; preds = %for.body26.preheader
  %17 = load i32, ptr %s1, align 4, !tbaa !5
  %idxprom27.prol = sext i32 %17 to i64
...
for.body26.prol.loopexit:                         ; preds = %for.inc38.prol, %for.body26.preheader
  ...
  %22 = sub nsw i64 0, %wide.trip.count78
  %23 = xor i64 %15, %22
  %24 = icmp eq i64 %23, -1
