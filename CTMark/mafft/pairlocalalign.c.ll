...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load11 = load <4 x i8>, ptr %1, align 1, !tbaa !5
...
while.body:                                       ; preds = %while.body.preheader12, %while.body
  ...
  %10 = load i8, ptr %s.addr.04, align 1, !tbaa !5
...
for.body.i:                                       ; preds = %for.end42, %for.inc36.i
  ...
  store ptr %call3.i70, ptr %arrayidx.i, align 8, !tbaa !8
...
for.inc36.i:                                      ; preds = %for.body7.i, %for.body.i
  ...
  br i1 %cmp.i71, label %for.body.i, label %for.end38.i, !llvm.loop !31
...
if.then.i68:                                      ; preds = %for.end38.i
  ...
  %.pre.i69 = load i32, ptr @njob, align 4, !tbaa !10
  br label %if.end.i
...
readhat4.exit.i.i:                                ; preds = %while.cond.i.i657.i, %while.cond.i.i657.i
  ...
  br i1 %exitcond.not.i659.i, label %preparebpp.exit.i, label %for.body.i655.i, !llvm.loop !39
...
if.then.i665.i:                                   ; preds = %sw.bb160.i
  ...
  store ptr %call.i666.i, ptr @recallpairfoldalign.fp, align 8, !tbaa !8
...
if.end14.i.i:                                     ; preds = %if.else.i.i, %if.then9.i.i
  ...
  %183 = load i8, ptr %call5.i661.i, align 1, !tbaa !5
...
if.then.i690.i:                                   ; preds = %sw.bb162.i
  ...
  store ptr %call.i691.i, ptr @recalllara.fp, align 8, !tbaa !8
...
if.end.i.i:                                       ; preds = %if.then.i690.i
  ...
  store ptr %call5.i693.i, ptr @recalllara.ungap2, align 8, !tbaa !8
  ...
  store ptr %call7.i694.i, ptr @recalllara.ori2, align 8, !tbaa !8
...
while.cond.i.i671.i:                              ; preds = %if.end55.i.i674.i, %if.end8.i.i
  ...
  %207 = load i8, ptr %seq.addr.0.i.i672.i, align 1, !tbaa !5
...
if.end55.i.i674.i:                                ; preds = %if.else46.i.i689.i, %if.then45.i.i673.i, %if.then40.i.i677.i, %if.then35.i.i678.i, %if.then30.i.i679.i, %if.then25.i.i680.i, %if.then20.i.i681.i, %if.then15.i.i682.i, %if.then10.i.i683.i, %while.cond.i.i671.i, %while.cond.i.i671.i
  ...
  store i8 %.sink.i.i675.i, ptr %seq.addr.0.i.i672.i, align 1, !tbaa !5
  %incdec.ptr.i.i676.i = getelementptr inbounds i8, ptr %seq.addr.0.i.i672.i, i64 1
  br label %while.cond.i.i671.i, !llvm.loop !36
...
while.cond.i40.i.i:                               ; preds = %if.end55.i43.i.i, %t2u.exit.i684.i
  ...
  %209 = load i8, ptr %seq.addr.0.i41.i.i, align 1, !tbaa !5
...
if.end55.i43.i.i:                                 ; preds = %if.else46.i53.i.i, %if.then45.i42.i.i, %if.then40.i46.i.i, %if.then35.i47.i.i, %if.then30.i48.i.i, %if.then25.i49.i.i, %if.then20.i50.i.i, %if.then15.i51.i.i, %if.then10.i52.i.i, %while.cond.i40.i.i, %while.cond.i40.i.i
  ...
  store i8 %.sink.i44.i.i, ptr %seq.addr.0.i41.i.i, align 1, !tbaa !5
  %incdec.ptr.i45.i.i = getelementptr inbounds i8, ptr %seq.addr.0.i41.i.i, i64 1
  br label %while.cond.i40.i.i, !llvm.loop !36
...
while.cond.i55.i.i:                               ; preds = %if.end55.i58.i.i, %t2u.exit54.i.i
  ...
  %211 = load i8, ptr %seq.addr.0.i56.i.i, align 1, !tbaa !5
...
if.end55.i58.i.i:                                 ; preds = %if.else46.i68.i.i, %if.then45.i57.i.i, %if.then40.i61.i.i, %if.then35.i62.i.i, %if.then30.i63.i.i, %if.then25.i64.i.i, %if.then20.i65.i.i, %if.then15.i66.i.i, %if.then10.i67.i.i, %while.cond.i55.i.i, %while.cond.i55.i.i
  ...
  store i8 %.sink.i59.i.i, ptr %seq.addr.0.i56.i.i, align 1, !tbaa !5
  %incdec.ptr.i60.i.i = getelementptr inbounds i8, ptr %seq.addr.0.i56.i.i, i64 1
  br label %while.cond.i55.i.i, !llvm.loop !36
...
while.cond.i70.i.i:                               ; preds = %if.end55.i73.i.i, %t2u.exit69.i.i
  ...
  %213 = load i8, ptr %seq.addr.0.i71.i.i, align 1, !tbaa !5
...
if.end55.i73.i.i:                                 ; preds = %if.else46.i83.i.i, %if.then45.i72.i.i, %if.then40.i76.i.i, %if.then35.i77.i.i, %if.then30.i78.i.i, %if.then25.i79.i.i, %if.then20.i80.i.i, %if.then15.i81.i.i, %if.then10.i82.i.i, %while.cond.i70.i.i, %while.cond.i70.i.i
  ...
  store i8 %.sink.i74.i.i, ptr %seq.addr.0.i71.i.i, align 1, !tbaa !5
  %incdec.ptr.i75.i.i = getelementptr inbounds i8, ptr %seq.addr.0.i71.i.i, i64 1
  br label %while.cond.i70.i.i, !llvm.loop !36
...
if.end172thread-pre-split.i:                      ; preds = %sw.bb170.i, %recalllara.exit.i, %recallpairfoldalign.exit.i, %sw.bb157.i, %sw.bb155.i, %sw.bb152.i, %sw.bb150.i, %sw.bb148.i, %sw.bb.i, %if.then144.i
  ...
  %.pr1.i = load i8, ptr @alg, align 1, !tbaa !5
