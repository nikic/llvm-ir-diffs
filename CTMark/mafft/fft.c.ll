; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/mafft/fft.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/mafft/fft.c"
...
entry:
  ...
  %0 = load i32, ptr @fft.last_n, align 4
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  store float %conv16.i, ptr %arrayidx19.i, align 4
...
if.end.i.thread:                                  ; preds = %for.end.i
  ...
  store float 0x3FE6A09E60000000, ptr %arrayidx25.i, align 4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load291 = load <4 x float>, ptr %14, align 4
  ...
  store <4 x float> %15, ptr %18, align 4
  %19 = getelementptr inbounds float, ptr %18, i64 4
  store <4 x float> %16, ptr %19, align 4
...
for.body42.i.prol:                                ; preds = %for.body42.i.preheader, %for.body42.i.prol
  ...
  %23 = load float, ptr %arrayidx44.i.prol, align 4
  ...
  store float %fneg.i.prol, ptr %arrayidx47.i.prol, align 4
  ...
  br i1 %prol.iter.cmp.not, label %for.body42.i.prol.loopexit, label %for.body42.i.prol
...
for.body42.i:                                     ; preds = %for.body42.i.prol.loopexit, %for.body42.i
  ...
  store float %fneg.i.1, ptr %arrayidx47.i.1, align 4
  ...
  %38 = load float, ptr %arrayidx44.i.2, align 4
  ...
  store float %fneg.i.2, ptr %arrayidx47.i.2, align 4
  ...
  %40 = load float, ptr %arrayidx44.i.3, align 4
  ...
  store float %fneg.i.3, ptr %arrayidx47.i.3, align 4
  ...
  br i1 %exitcond115.not.i.3, label %make_sintbl.exit, label %for.body42.i

make_sintbl.exit:                                 ; preds = %for.body42.i.prol.loopexit, %for.body42.i, %middle.block, %for.cond38.preheader.i
  %42 = load ptr, ptr @fft.bitrev, align 8
...
while.cond.preheader.i:                           ; preds = %while.end.i.1, %while.cond.preheader.i.preheader.new
  %indvars.iv.i248 = phi i64 [ 1, %while.cond.preheader.i.preheader.new ], [ %indvars.iv.next.i252.1, %while.end.i.1 ]
  %j.012.i = phi i32 [ 0, %while.cond.preheader.i.preheader.new ], [ %add.i250.1, %while.end.i.1 ]
...
while.cond.i:                                     ; preds = %while.cond.i, %while.cond.preheader.i
  %j.1.i = phi i32 [ %sub.i249, %while.cond.i ], [ %j.012.i, %while.cond.preheader.i ]
  %k.0.in.i = phi i32 [ %k.0.i287, %while.cond.i ], [ %n.addr.0, %while.cond.preheader.i ]
  %k.0.i287 = lshr i32 %k.0.in.i, 1
  %cmp1.not.i = icmp sgt i32 %k.0.i287, %j.1.i
  %sub.i249 = sub nsw i32 %j.1.i, %k.0.i287
  br i1 %cmp1.not.i, label %while.end.i, label %while.cond.i

while.end.i:                                      ; preds = %while.cond.i
  %add.i250 = add nsw i32 %k.0.i287, %j.1.i
  %arrayidx.i251 = getelementptr inbounds i32, ptr %42, i64 %indvars.iv.i248
  store i32 %add.i250, ptr %arrayidx.i251, align 4
...
while.cond.i.1:                                   ; preds = %while.cond.i.1, %while.end.i
  %j.1.i.1 = phi i32 [ %sub.i249.1, %while.cond.i.1 ], [ %add.i250, %while.end.i ]
  %k.0.in.i.1 = phi i32 [ %k.0.i287.1, %while.cond.i.1 ], [ %n.addr.0, %while.end.i ]
  %k.0.i287.1 = lshr i32 %k.0.in.i.1, 1
  %cmp1.not.i.1 = icmp sgt i32 %k.0.i287.1, %j.1.i.1
  %sub.i249.1 = sub nsw i32 %j.1.i.1, %k.0.i287.1
  br i1 %cmp1.not.i.1, label %while.end.i.1, label %while.cond.i.1

while.end.i.1:                                    ; preds = %while.cond.i.1
  %add.i250.1 = add nsw i32 %k.0.i287.1, %j.1.i.1
  %arrayidx.i251.1 = getelementptr inbounds i32, ptr %42, i64 %indvars.iv.next.i252
  store i32 %add.i250.1, ptr %arrayidx.i251.1, align 4
  %indvars.iv.next.i252.1 = add nuw nsw i64 %indvars.iv.i248, 2
...
if.end15.loopexit.unr-lcssa:                      ; preds = %while.end.i.1, %while.cond.preheader.i.preheader
  %indvars.iv.i248.unr = phi i64 [ 1, %while.cond.preheader.i.preheader ], [ %indvars.iv.next.i252.1, %while.end.i.1 ]
  %j.012.i.unr = phi i32 [ 0, %while.cond.preheader.i.preheader ], [ %add.i250.1, %while.end.i.1 ]
...
while.cond.i.epil:                                ; preds = %if.end15.loopexit.unr-lcssa, %while.cond.i.epil
  %j.1.i.epil = phi i32 [ %sub.i249.epil, %while.cond.i.epil ], [ %j.012.i.unr, %if.end15.loopexit.unr-lcssa ]
  ...
  %cmp1.not.i.epil = icmp sgt i32 %k.0.i287.epil, %j.1.i.epil
  %sub.i249.epil = sub nsw i32 %j.1.i.epil, %k.0.i287.epil
  br i1 %cmp1.not.i.epil, label %while.end.i.epil, label %while.cond.i.epil

while.end.i.epil:                                 ; preds = %while.cond.i.epil
  %add.i250.epil = add nsw i32 %k.0.i287.epil, %j.1.i.epil
  %arrayidx.i251.epil = getelementptr inbounds i32, ptr %42, i64 %indvars.iv.i248.unr
  store i32 %add.i250.epil, ptr %arrayidx.i251.epil, align 4
  br label %if.end15
...
for.body.lr.ph:                                   ; preds = %entry, %if.end15
  %45 = load ptr, ptr @fft.bitrev, align 8
...
if.then20:                                        ; preds = %for.body
  ...
  %51 = load <2 x double>, ptr %arrayidx25, align 8
  %52 = load <2 x double>, ptr %arrayidx22, align 8
  %53 = fptrunc <2 x double> %52 to <2 x float>
  store <2 x double> %51, ptr %arrayidx22, align 8
  %54 = fpext <2 x float> %53 to <2 x double>
  store <2 x double> %54, ptr %arrayidx25, align 8
  br label %for.inc

for.inc:                                          ; preds = %for.body, %if.then20
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.cond48.preheader, label %for.body

for.cond48.loopexit:                              ; preds = %for.end123, %for.body51
  %cmp49 = icmp slt i32 %add52, %n.addr.0
  br i1 %cmp49, label %for.body51, label %for.end129
...
for.body71.lr.ph:                                 ; preds = %for.body57
  ...
  %59 = load float, ptr %arrayidx66, align 4
  %fneg = fneg float %59
  ...
  %61 = load float, ptr %arrayidx60, align 4
...
for.body71:                                       ; preds = %for.body71.lr.ph, %for.body71
  ...
  %67 = load double, ptr %I76, align 8
  ...
  %77 = load <2 x double>, ptr %arrayidx96, align 8
  %78 = fpext <2 x float> %76 to <2 x double>
  %79 = fsub <2 x double> %77, %78
  store <2 x double> %79, ptr %arrayidx75, align 8
  %80 = fadd <2 x double> %77, %78
  store <2 x double> %80, ptr %arrayidx96, align 8
  %indvars.iv.next273 = add i64 %indvars.iv272, %55
  %cmp69 = icmp slt i64 %indvars.iv.next273, %47
  br i1 %cmp69, label %for.body71, label %for.end123
...
for.end123:                                       ; preds = %for.body71, %for.body57
  ...
  br i1 %exitcond281.not, label %for.cond48.loopexit, label %for.body57
...
vector.body300:                                   ; preds = %vector.body300, %vector.ph295
  ...
  %wide.vec = load <4 x double>, ptr %81, align 8
  ...
  store <4 x double> %interleaved.vec, ptr %84, align 8
  %index.next303 = add nuw i64 %index301, 2
  %85 = icmp eq i64 %index.next303, %n.vec297
  br i1 %85, label %middle.block292, label %vector.body300
...
for.body135:                                      ; preds = %for.body135.preheader, %for.body135
  ...
  %88 = load <2 x double>, ptr %arrayidx138, align 8
  %89 = fdiv <2 x double> %88, %87
  store <2 x double> %89, ptr %arrayidx138, align 8
  %indvars.iv.next283 = add nuw nsw i64 %indvars.iv282, 1
  %exitcond286.not = icmp eq i64 %indvars.iv.next283, %wide.trip.count285
  br i1 %exitcond286.not, label %cleanup, label %for.body135
