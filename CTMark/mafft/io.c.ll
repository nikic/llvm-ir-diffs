; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/mafft/io.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/mafft/io.c"
...
while.end:                                        ; preds = %while.cond
  ...
  %1 = load i32, ptr %localhompt, align 8
  %cmp = icmp eq i32 %1, 0
...
while.body8:                                      ; preds = %while.end, %if.end67
  ...
  %start2.0.neg232 = phi i32 [ %start2.0.neg, %if.end67 ], [ 0, %while.end ]
  %pos1.0231 = phi i32 [ %spec.select216, %if.end67 ], [ %off1, %while.end ]
  %st.0230 = phi i32 [ %st.2, %if.end67 ], [ 0, %while.end ]
  %tmppt.0229 = phi ptr [ %tmppt.2, %if.end67 ], [ %subnosento.0, %while.end ]
  %sumoverlap.0228 = phi i32 [ %sumoverlap.2, %if.end67 ], [ 0, %while.end ]
  %sumscore.0227 = phi double [ %sumscore.2, %if.end67 ], [ 0.000000e+00, %while.end ]
  %score.0226 = phi double [ %score.1, %if.end67 ], [ 0.000000e+00, %while.end ]
  %pt2.0224 = phi ptr [ %incdec.ptr74, %if.end67 ], [ %al2, %while.end ]
  %pt1.0223 = phi ptr [ %incdec.ptr, %if.end67 ], [ %al1, %while.end ]
  %start2.0222 = phi i32 [ %start2.2, %if.end67 ], [ 0, %while.end ]
  %start1.0221 = phi i32 [ %start1.2, %if.end67 ], [ 0, %while.end ]
  %pos2.0219 = phi i32 [ %pos2.1, %if.end67 ], [ %off2, %while.end ]
  %cmp9 = icmp eq i32 %st.0230, 1
...
lor.lhs.false:                                    ; preds = %land.lhs.true
  %7 = load i8, ptr %pt2.0224, align 1
  %cmp15 = icmp eq i8 %7, 45
  br i1 %cmp15, label %if.then, label %if.else43

if.then:                                          ; preds = %lor.lhs.false, %land.lhs.true
  %sub = add nsw i32 %pos1.0231, -1
  %sub17 = add nsw i32 %pos2.0219, -1
  %8 = load i32, ptr %localhompt, align 8
  %inc = add nsw i32 %8, 1
  store i32 %inc, ptr %localhompt, align 8
...
if.then21:                                        ; preds = %if.then
  ...
  %next23 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.0229, i64 0, i32 1
  store ptr %call22, ptr %next23, align 8
...
if.then31:                                        ; preds = %if.end
  ...
  store double %div36, ptr %opt37, align 8
  br label %if.end67

if.else:                                          ; preds = %if.end
  %add38 = fadd double %score.0226, %sumscore.0227
  %add40 = add i32 %pos2.0219, %start2.0.neg232
  %add41 = add nsw i32 %add40, %sumoverlap.0228
  br label %if.end67
...
land.lhs.true47:                                  ; preds = %if.else43
  %10 = load i8, ptr %pt2.0224, align 1
  %cmp49.not = icmp eq i8 %10, 45
  br i1 %cmp49.not, label %if.end67, label %if.then51

if.then51:                                        ; preds = %land.lhs.true47
  %cmp52 = icmp eq i32 %st.0230, 0
  %spec.select = select i1 %cmp52, i32 %pos1.0231, i32 %start1.0221
  %spec.select215 = select i1 %cmp52, i32 %pos2.0219, i32 %start2.0222
  ...
  %add65 = fadd double %score.0226, %conv64
  br label %if.end67

if.end67:                                         ; preds = %if.then31, %if.else, %if.else43, %land.lhs.true47, %if.then51
  %start1.2 = phi i32 [ %spec.select, %if.then51 ], [ %start1.0221, %land.lhs.true47 ], [ %start1.0221, %if.else43 ], [ %start1.0221, %if.else ], [ %start1.0221, %if.then31 ]
  %start2.2 = phi i32 [ %spec.select215, %if.then51 ], [ %start2.0222, %land.lhs.true47 ], [ %start2.0222, %if.else43 ], [ %start2.0222, %if.else ], [ %start2.0222, %if.then31 ]
  %score.1 = phi double [ %add65, %if.then51 ], [ %score.0226, %land.lhs.true47 ], [ %score.0226, %if.else43 ], [ 0.000000e+00, %if.else ], [ 0.000000e+00, %if.then31 ]
  %sumscore.2 = phi double [ %sumscore.0227, %if.then51 ], [ %sumscore.0227, %land.lhs.true47 ], [ %sumscore.0227, %if.else43 ], [ %add38, %if.else ], [ %sumscore.0227, %if.then31 ]
  %sumoverlap.2 = phi i32 [ %sumoverlap.0228, %if.then51 ], [ %sumoverlap.0228, %land.lhs.true47 ], [ %sumoverlap.0228, %if.else43 ], [ %add41, %if.else ], [ %sumoverlap.0228, %if.then31 ]
  %tmppt.2 = phi ptr [ %tmppt.0229, %if.then51 ], [ %tmppt.0229, %land.lhs.true47 ], [ %tmppt.0229, %if.else43 ], [ %tmppt.1, %if.else ], [ %tmppt.1, %if.then31 ]
  %st.2 = phi i32 [ 1, %if.then51 ], [ %st.0230, %land.lhs.true47 ], [ %st.0230, %if.else43 ], [ 0, %if.else ], [ 0, %if.then31 ]
  %incdec.ptr = getelementptr inbounds i8, ptr %pt1.0223, i64 1
  %14 = load i8, ptr %pt1.0223, align 1
  %cmp69.not = icmp ne i8 %14, 45
  %inc72 = zext i1 %cmp69.not to i32
  %spec.select216 = add nsw i32 %pos1.0231, %inc72
  %incdec.ptr74 = getelementptr inbounds i8, ptr %pt2.0224, i64 1
  %15 = load i8, ptr %pt2.0224, align 1
  ...
  br i1 %cmp6.not, label %while.end81, label %while.body8
...
if.then108:                                       ; preds = %if.end100
  ...
  store i32 %add110, ptr %overlapaa111, align 8
  ...
  store double %div116, ptr %opt117, align 8
  br label %if.end124

if.else118:                                       ; preds = %if.end100
  %add119 = fadd double %score.0.lcssa, %sumscore.0.lcssa
  %add121 = add i32 %pos2.0.lcssa, %start2.0.neg.lcssa
  %add122 = add nsw i32 %add121, %sumoverlap.0.lcssa
  br label %if.end124
...
if.end124:                                        ; preds = %if.then108, %if.else118, %land.lhs.true85, %while.end81
  ...
  %22 = load i32, ptr @divpairscore, align 4
...
if.then129:                                       ; preds = %if.then127
  %23 = load ptr, ptr %next.le, align 8
  br label %if.end131

if.end131:                                        ; preds = %if.then129, %if.then127
  %subnosento.1 = phi ptr [ %subnosento.0, %if.then127 ], [ %23, %if.then129 ]
  %tobool132.not243 = icmp eq ptr %subnosento.1, null
  br i1 %tobool132.not243, label %if.end142, label %for.body.lr.ph
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  %tmppt.4244 = phi ptr [ %subnosento.1, %for.body.lr.ph ], [ %25, %for.body ]
  %overlapaa133 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.4244, i64 0, i32 8
  store i32 %sumoverlap.3, ptr %overlapaa133, align 8
  %opt138 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.4244, i64 0, i32 7
  store double %div137, ptr %opt138, align 8
  %24 = load ptr, ptr @stderr, align 8
  %call140 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %24, ptr noundef nonnull @.str.4, double noundef %div137) #27
  %next141 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.4244, i64 0, i32 1
  %25 = load ptr, ptr %next141, align 8
  %tobool132.not = icmp eq ptr %25, null
  br i1 %tobool132.not, label %if.end142, label %for.body
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end56
  ...
  %start2.0.neg197 = phi i32 [ 0, %while.body.lr.ph ], [ %start2.0.neg, %if.end56 ]
  %st.0196 = phi i32 [ 0, %while.body.lr.ph ], [ %st.2, %if.end56 ]
  %nlocalhom.0195 = phi i32 [ 0, %while.body.lr.ph ], [ %nlocalhom.1, %if.end56 ]
  %tmppt.0194 = phi ptr [ %localhompt, %while.body.lr.ph ], [ %tmppt.2, %if.end56 ]
  %sumoverlap.0193 = phi i32 [ 0, %while.body.lr.ph ], [ %sumoverlap.2, %if.end56 ]
  %iscore.0191 = phi i32 [ 0, %while.body.lr.ph ], [ %iscore.1, %if.end56 ]
  %pt2.0189 = phi ptr [ %al2, %while.body.lr.ph ], [ %incdec.ptr63, %if.end56 ]
  %pt1.0188 = phi ptr [ %al1, %while.body.lr.ph ], [ %incdec.ptr, %if.end56 ]
  %start2.0187 = phi i32 [ 0, %while.body.lr.ph ], [ %start2.2, %if.end56 ]
  %start1.0186 = phi i32 [ 0, %while.body.lr.ph ], [ %start1.2, %if.end56 ]
  %pos2.0184 = phi i32 [ %off2, %while.body.lr.ph ], [ %pos2.1, %if.end56 ]
  %pos1.0183 = phi i32 [ %off1, %while.body.lr.ph ], [ %spec.select181, %if.end56 ]
  %cmp2 = icmp eq i32 %st.0196, 1
...
lor.lhs.false:                                    ; preds = %land.lhs.true
  %3 = load i8, ptr %pt2.0189, align 1
...
if.then:                                          ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %inc = add nsw i32 %nlocalhom.0195, 1
  %cmp11 = icmp sgt i32 %nlocalhom.0195, 0
  br i1 %cmp11, label %if.then13, label %if.end

if.then13:                                        ; preds = %if.then
  %call = tail call noalias dereferenceable_or_null(80) ptr @calloc(i64 noundef 1, i64 noundef 80) #28
  %next = getelementptr inbounds %struct._LocalHom, ptr %tmppt.0194, i64 0, i32 1
...
if.then20:                                        ; preds = %if.end
  ...
  store double %div26, ptr %opt27, align 8
  br label %if.end56

if.else:                                          ; preds = %if.end
  %add30 = add i32 %pos2.0184, %start2.0.neg197
  %add31 = add nsw i32 %add30, %sumoverlap.0193
  br label %if.end56
...
land.lhs.true37:                                  ; preds = %if.else33
  %4 = load i8, ptr %pt2.0189, align 1
  %cmp39.not = icmp eq i8 %4, 45
  br i1 %cmp39.not, label %if.end56, label %if.then41

if.then41:                                        ; preds = %land.lhs.true37
  %cmp42 = icmp eq i32 %st.0196, 0
  %spec.select = select i1 %cmp42, i32 %pos1.0183, i32 %start1.0186
  %spec.select180 = select i1 %cmp42, i32 %pos2.0184, i32 %start2.0187
  ...
  %add54 = add nsw i32 %7, %iscore.0191
  br label %if.end56

if.end56:                                         ; preds = %if.then20, %if.else, %if.else33, %land.lhs.true37, %if.then41
  %start1.2 = phi i32 [ %spec.select, %if.then41 ], [ %start1.0186, %land.lhs.true37 ], [ %start1.0186, %if.else33 ], [ %start1.0186, %if.else ], [ %start1.0186, %if.then20 ]
  %start2.2 = phi i32 [ %spec.select180, %if.then41 ], [ %start2.0187, %land.lhs.true37 ], [ %start2.0187, %if.else33 ], [ %start2.0187, %if.else ], [ %start2.0187, %if.then20 ]
  %iscore.1 = phi i32 [ %add54, %if.then41 ], [ %iscore.0191, %land.lhs.true37 ], [ %iscore.0191, %if.else33 ], [ 0, %if.else ], [ 0, %if.then20 ]
  %sumoverlap.2 = phi i32 [ %sumoverlap.0193, %if.then41 ], [ %sumoverlap.0193, %land.lhs.true37 ], [ %sumoverlap.0193, %if.else33 ], [ %add31, %if.else ], [ %sumoverlap.0193, %if.then20 ]
  %tmppt.2 = phi ptr [ %tmppt.0194, %if.then41 ], [ %tmppt.0194, %land.lhs.true37 ], [ %tmppt.0194, %if.else33 ], [ %tmppt.1, %if.else ], [ %tmppt.1, %if.then20 ]
  %nlocalhom.1 = phi i32 [ %nlocalhom.0195, %if.then41 ], [ %nlocalhom.0195, %land.lhs.true37 ], [ %nlocalhom.0195, %if.else33 ], [ %inc, %if.else ], [ %inc, %if.then20 ]
  %st.2 = phi i32 [ 1, %if.then41 ], [ %st.0196, %land.lhs.true37 ], [ %st.0196, %if.else33 ], [ 0, %if.else ], [ 0, %if.then20 ]
  %incdec.ptr = getelementptr inbounds i8, ptr %pt1.0188, i64 1
  %8 = load i8, ptr %pt1.0188, align 1
  %cmp58.not = icmp ne i8 %8, 45
  %inc61 = zext i1 %cmp58.not to i32
  %spec.select181 = add nsw i32 %pos1.0183, %inc61
  %incdec.ptr63 = getelementptr inbounds i8, ptr %pt2.0189, i64 1
  %9 = load i8, ptr %pt2.0189, align 1
...
while.end.loopexit:                               ; preds = %if.end56
  %11 = icmp sgt i32 %nlocalhom.1, 0
  %12 = sitofp i32 %iscore.1 to double
  br label %while.end

while.end:                                        ; preds = %while.end.loopexit, %entry
  %pos1.0.lcssa = phi i32 [ %off1, %entry ], [ %spec.select181, %while.end.loopexit ]
  %pos2.0.lcssa = phi i32 [ %off2, %entry ], [ %pos2.1, %while.end.loopexit ]
  %start1.0.lcssa = phi i32 [ 0, %entry ], [ %start1.2, %while.end.loopexit ]
  %start2.0.lcssa = phi i32 [ 0, %entry ], [ %start2.2, %while.end.loopexit ]
  %pt1.0.lcssa = phi ptr [ %al1, %entry ], [ %incdec.ptr, %while.end.loopexit ]
  %pt2.0.lcssa = phi ptr [ %al2, %entry ], [ %incdec.ptr63, %while.end.loopexit ]
  %iscore.0.lcssa = phi double [ 0.000000e+00, %entry ], [ %12, %while.end.loopexit ]
  %sumoverlap.0.lcssa = phi i32 [ 0, %entry ], [ %sumoverlap.2, %while.end.loopexit ]
  %tmppt.0.lcssa = phi ptr [ %localhompt, %entry ], [ %tmppt.2, %while.end.loopexit ]
  %nlocalhom.0.lcssa = phi i1 [ false, %entry ], [ %11, %while.end.loopexit ]
  %start2.0.neg.lcssa = phi i32 [ 0, %entry ], [ %start2.0.neg, %while.end.loopexit ]
  %add.ptr = getelementptr inbounds i8, ptr %pt1.0.lcssa, i64 -1
  %13 = load i8, ptr %add.ptr, align 1
  %cmp71.not = icmp eq i8 %13, 45
...
land.lhs.true73:                                  ; preds = %while.end
  ...
  %cmp76.not = icmp eq i8 %14, 45
  br i1 %cmp76.not, label %if.end112, label %if.then78

if.then78:                                        ; preds = %land.lhs.true73
  br i1 %nlocalhom.0.lcssa, label %if.then82, label %if.end87
...
if.then95:                                        ; preds = %if.end87
  ...
  store i32 %add97, ptr %overlapaa98, align 8
  %conv101 = sitofp i32 %add97 to double
  %div102 = fdiv double %iscore.0.lcssa, %conv101
  ...
  store double %div104, ptr %opt105, align 8
  br label %if.end112

if.else106:                                       ; preds = %if.end87
  %add109 = add i32 %pos2.0.lcssa, %start2.0.neg.lcssa
  %add110 = add nsw i32 %add109, %sumoverlap.0.lcssa
  br label %if.end112
...
if.end112:                                        ; preds = %if.then95, %if.else106, %land.lhs.true73, %while.end
  ...
  %16 = load i32, ptr @divpairscore, align 4
  %tobool113.not = icmp ne i32 %16, 0
  %tobool115.not208 = icmp eq ptr %localhompt, null
  %or.cond = or i1 %tobool113.not, %tobool115.not208
  br i1 %or.cond, label %if.end119, label %for.body

for.body:                                         ; preds = %if.end112, %for.body
  %tmppt.4209 = phi ptr [ %17, %for.body ], [ %localhompt, %if.end112 ]
  %overlapaa116 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.4209, i64 0, i32 8
  store i32 %sumoverlap.3, ptr %overlapaa116, align 8
  %opt117 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.4209, i64 0, i32 7
  store double 5.800000e+00, ptr %opt117, align 8
  %next118 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.4209, i64 0, i32 1
  %17 = load ptr, ptr %next118, align 8
  %tobool115.not = icmp eq ptr %17, null
  br i1 %tobool115.not, label %if.end119, label %for.body
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end56
  %2 = phi i8 [ %0, %while.body.lr.ph ], [ %10, %if.end56 ]
  %start2.0.neg204 = phi i32 [ 0, %while.body.lr.ph ], [ %start2.0.neg, %if.end56 ]
  %st.0203 = phi i32 [ 0, %while.body.lr.ph ], [ %st.2, %if.end56 ]
  %nlocalhom.0202 = phi i32 [ 0, %while.body.lr.ph ], [ %nlocalhom.1, %if.end56 ]
  %tmppt.0201 = phi ptr [ %localhompt, %while.body.lr.ph ], [ %tmppt.2, %if.end56 ]
  %sumoverlap.0200 = phi i32 [ 0, %while.body.lr.ph ], [ %sumoverlap.2, %if.end56 ]
  %isumscore.0199 = phi i32 [ 0, %while.body.lr.ph ], [ %isumscore.2, %if.end56 ]
  %iscore.0198 = phi i32 [ 0, %while.body.lr.ph ], [ %iscore.1, %if.end56 ]
  %pt2.0196 = phi ptr [ %al2, %while.body.lr.ph ], [ %incdec.ptr63, %if.end56 ]
  %pt1.0195 = phi ptr [ %al1, %while.body.lr.ph ], [ %incdec.ptr, %if.end56 ]
  %start2.0194 = phi i32 [ 0, %while.body.lr.ph ], [ %start2.2, %if.end56 ]
  %start1.0193 = phi i32 [ 0, %while.body.lr.ph ], [ %start1.2, %if.end56 ]
  %pos2.0191 = phi i32 [ %off2, %while.body.lr.ph ], [ %pos2.1, %if.end56 ]
  %pos1.0190 = phi i32 [ %off1, %while.body.lr.ph ], [ %spec.select188, %if.end56 ]
  %cmp2 = icmp eq i32 %st.0203, 1
  br i1 %cmp2, label %land.lhs.true, label %if.else33
...
lor.lhs.false:                                    ; preds = %land.lhs.true
  %3 = load i8, ptr %pt2.0196, align 1
  %cmp8 = icmp eq i8 %3, 45
  br i1 %cmp8, label %if.then, label %if.else33
...
if.then:                                          ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %inc = add nsw i32 %nlocalhom.0202, 1
  %cmp11 = icmp sgt i32 %nlocalhom.0202, 0
  br i1 %cmp11, label %if.then13, label %if.end

if.then13:                                        ; preds = %if.then
  %call = tail call noalias dereferenceable_or_null(80) ptr @calloc(i64 noundef 1, i64 noundef 80) #28
  %next = getelementptr inbounds %struct._LocalHom, ptr %tmppt.0201, i64 0, i32 1
  store ptr %call, ptr %next, align 8
  %next15 = getelementptr inbounds %struct._LocalHom, ptr %call, i64 0, i32 1
  store ptr null, ptr %next15, align 8
  br label %if.end
...
if.end:                                           ; preds = %if.then13, %if.then
  %tmppt.1 = phi ptr [ %call, %if.then13 ], [ %tmppt.0201, %if.then ]
  %start116 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.1, i64 0, i32 3
  store i32 %start1.0193, ptr %start116, align 8
  %start217 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.1, i64 0, i32 5
  store i32 %start2.0194, ptr %start217, align 8
  %end118 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.1, i64 0, i32 4
  store i32 %sub, ptr %end118, align 4
  %end219 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.1, i64 0, i32 6
  store i32 %sub10, ptr %end219, align 4
...
if.then20:                                        ; preds = %if.end
  %sub21 = sub nsw i32 %sub10, %start2.0194
  %add = add nsw i32 %sub21, 1
  %overlapaa22 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.1, i64 0, i32 8
  store i32 %add, ptr %overlapaa22, align 8
  %conv23 = sitofp i32 %iscore.0198 to double
  %conv25 = sitofp i32 %add to double
  %div = fdiv double %conv23, %conv25
  %mul = fmul double %div, 5.800000e+00
  %div26 = fdiv double %mul, 6.000000e+02
...
if.else:                                          ; preds = %if.end
  %add28 = add nsw i32 %isumscore.0199, %iscore.0198
  %add30 = add i32 %pos2.0191, %start2.0.neg204
  %add31 = add nsw i32 %add30, %sumoverlap.0200
  br label %if.end56
...
land.lhs.true37:                                  ; preds = %if.else33
  %4 = load i8, ptr %pt2.0196, align 1
  %cmp39.not = icmp eq i8 %4, 45
  br i1 %cmp39.not, label %if.end56, label %if.then41

if.then41:                                        ; preds = %land.lhs.true37
  %cmp42 = icmp eq i32 %st.0203, 0
  %spec.select = select i1 %cmp42, i32 %pos1.0190, i32 %start1.0193
  %spec.select187 = select i1 %cmp42, i32 %pos2.0191, i32 %start2.0194
  %idxprom = sext i8 %2 to i64
  %arrayidx = getelementptr inbounds [128 x i32], ptr @amino_n, i64 0, i64 %idxprom
  %5 = load i32, ptr %arrayidx, align 4
  %idxprom47 = sext i32 %5 to i64
  ...
  %arrayidx53 = getelementptr inbounds [26 x [26 x i32]], ptr @n_dis, i64 0, i64 %idxprom47, i64 %idxprom52
  %7 = load i32, ptr %arrayidx53, align 4
  %add54 = add nsw i32 %7, %iscore.0198
  br label %if.end56

if.end56:                                         ; preds = %if.then20, %if.else, %if.else33, %land.lhs.true37, %if.then41
  %start1.2 = phi i32 [ %spec.select, %if.then41 ], [ %start1.0193, %land.lhs.true37 ], [ %start1.0193, %if.else33 ], [ %start1.0193, %if.else ], [ %start1.0193, %if.then20 ]
  %start2.2 = phi i32 [ %spec.select187, %if.then41 ], [ %start2.0194, %land.lhs.true37 ], [ %start2.0194, %if.else33 ], [ %start2.0194, %if.else ], [ %start2.0194, %if.then20 ]
  %iscore.1 = phi i32 [ %add54, %if.then41 ], [ %iscore.0198, %land.lhs.true37 ], [ %iscore.0198, %if.else33 ], [ 0, %if.else ], [ 0, %if.then20 ]
  %isumscore.2 = phi i32 [ %isumscore.0199, %if.then41 ], [ %isumscore.0199, %land.lhs.true37 ], [ %isumscore.0199, %if.else33 ], [ %add28, %if.else ], [ %isumscore.0199, %if.then20 ]
  %sumoverlap.2 = phi i32 [ %sumoverlap.0200, %if.then41 ], [ %sumoverlap.0200, %land.lhs.true37 ], [ %sumoverlap.0200, %if.else33 ], [ %add31, %if.else ], [ %sumoverlap.0200, %if.then20 ]
  %tmppt.2 = phi ptr [ %tmppt.0201, %if.then41 ], [ %tmppt.0201, %land.lhs.true37 ], [ %tmppt.0201, %if.else33 ], [ %tmppt.1, %if.else ], [ %tmppt.1, %if.then20 ]
  %nlocalhom.1 = phi i32 [ %nlocalhom.0202, %if.then41 ], [ %nlocalhom.0202, %land.lhs.true37 ], [ %nlocalhom.0202, %if.else33 ], [ %inc, %if.else ], [ %inc, %if.then20 ]
  %st.2 = phi i32 [ 1, %if.then41 ], [ %st.0203, %land.lhs.true37 ], [ %st.0203, %if.else33 ], [ 0, %if.else ], [ 0, %if.then20 ]
  %incdec.ptr = getelementptr inbounds i8, ptr %pt1.0195, i64 1
  %8 = load i8, ptr %pt1.0195, align 1
  %cmp58.not = icmp ne i8 %8, 45
  %inc61 = zext i1 %cmp58.not to i32
  %spec.select188 = add nsw i32 %pos1.0190, %inc61
  %incdec.ptr63 = getelementptr inbounds i8, ptr %pt2.0196, i64 1
  %9 = load i8, ptr %pt2.0196, align 1
  %cmp65.not = icmp ne i8 %9, 45
  %inc68 = zext i1 %cmp65.not to i32
...
while.end:                                        ; preds = %while.end.loopexit, %entry
  %pos1.0.lcssa = phi i32 [ %off1, %entry ], [ %spec.select188, %while.end.loopexit ]
  %pos2.0.lcssa = phi i32 [ %off2, %entry ], [ %pos2.1, %while.end.loopexit ]
  %start1.0.lcssa = phi i32 [ 0, %entry ], [ %start1.2, %while.end.loopexit ]
  %start2.0.lcssa = phi i32 [ 0, %entry ], [ %start2.2, %while.end.loopexit ]
  %pt1.0.lcssa = phi ptr [ %al1, %entry ], [ %incdec.ptr, %while.end.loopexit ]
  %pt2.0.lcssa = phi ptr [ %al2, %entry ], [ %incdec.ptr63, %while.end.loopexit ]
  %iscore.0.lcssa = phi i32 [ 0, %entry ], [ %iscore.1, %while.end.loopexit ]
  %isumscore.0.lcssa = phi i32 [ 0, %entry ], [ %isumscore.2, %while.end.loopexit ]
  %sumoverlap.0.lcssa = phi i32 [ 0, %entry ], [ %sumoverlap.2, %while.end.loopexit ]
  %tmppt.0.lcssa = phi ptr [ %localhompt, %entry ], [ %tmppt.2, %while.end.loopexit ]
  %nlocalhom.0.lcssa = phi i1 [ false, %entry ], [ %11, %while.end.loopexit ]
  %start2.0.neg.lcssa = phi i32 [ 0, %entry ], [ %start2.0.neg, %while.end.loopexit ]
  ...
  %cmp71.not = icmp eq i8 %12, 45
  br i1 %cmp71.not, label %if.end112, label %land.lhs.true73

land.lhs.true73:                                  ; preds = %while.end
  %add.ptr74 = getelementptr inbounds i8, ptr %pt2.0.lcssa, i64 -1
  %13 = load i8, ptr %add.ptr74, align 1
  %cmp76.not = icmp eq i8 %13, 45
  br i1 %cmp76.not, label %if.end112, label %if.then78
...
if.end87:                                         ; preds = %if.then82, %if.then78
  ...
  %end293 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.3, i64 0, i32 6
  store i32 %sub89, ptr %end293, align 4
  %14 = load i32, ptr @divpairscore, align 4
...
if.end112:                                        ; preds = %if.then95, %if.else106, %land.lhs.true73, %while.end
  ...
  %sumoverlap.3 = phi i32 [ %sumoverlap.0.lcssa, %if.then95 ], [ %add110, %if.else106 ], [ %sumoverlap.0.lcssa, %land.lhs.true73 ], [ %sumoverlap.0.lcssa, %while.end ]
  %15 = load i32, ptr @divpairscore, align 4
  %tobool113.not = icmp ne i32 %15, 0
  %tobool115.not216 = icmp eq ptr %localhompt, null
  %or.cond = or i1 %tobool113.not, %tobool115.not216
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  %tmppt.4217 = phi ptr [ %localhompt, %for.body.lr.ph ], [ %16, %for.body ]
  %overlapaa116 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.4217, i64 0, i32 8
  store i32 %sumoverlap.3, ptr %overlapaa116, align 8
  %opt122 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.4217, i64 0, i32 7
  store double %div121, ptr %opt122, align 8
  %next123 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.4217, i64 0, i32 1
  %16 = load ptr, ptr %next123, align 8
  %tobool115.not = icmp eq ptr %16, null
  br i1 %tobool115.not, label %if.end124, label %for.body
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end56
  %2 = phi i8 [ %0, %while.body.lr.ph ], [ %10, %if.end56 ]
  %start2.0.neg192 = phi i32 [ 0, %while.body.lr.ph ], [ %start2.0.neg, %if.end56 ]
  %st.0191 = phi i32 [ 0, %while.body.lr.ph ], [ %st.2, %if.end56 ]
  %nlocalhom.0190 = phi i32 [ 0, %while.body.lr.ph ], [ %nlocalhom.1, %if.end56 ]
  %tmppt.0189 = phi ptr [ %localhompt, %while.body.lr.ph ], [ %tmppt.2, %if.end56 ]
  %sumoverlap.0188 = phi i32 [ 0, %while.body.lr.ph ], [ %sumoverlap.2, %if.end56 ]
  %sumscore.0187 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %sumscore.2, %if.end56 ]
  %score.0186 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %score.1, %if.end56 ]
  %pt2.0184 = phi ptr [ %al2, %while.body.lr.ph ], [ %incdec.ptr63, %if.end56 ]
  %pt1.0183 = phi ptr [ %al1, %while.body.lr.ph ], [ %incdec.ptr, %if.end56 ]
  %start2.0182 = phi i32 [ 0, %while.body.lr.ph ], [ %start2.2, %if.end56 ]
  %start1.0181 = phi i32 [ 0, %while.body.lr.ph ], [ %start1.2, %if.end56 ]
  %pos2.0179 = phi i32 [ %off2, %while.body.lr.ph ], [ %pos2.1, %if.end56 ]
  %pos1.0178 = phi i32 [ %off1, %while.body.lr.ph ], [ %spec.select174, %if.end56 ]
  %cmp2 = icmp eq i32 %st.0191, 1
...
lor.lhs.false:                                    ; preds = %land.lhs.true
  %3 = load i8, ptr %pt2.0184, align 1
  %cmp8 = icmp eq i8 %3, 45
...
if.then:                                          ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %inc = add nsw i32 %nlocalhom.0190, 1
  %cmp11 = icmp sgt i32 %nlocalhom.0190, 0
  br i1 %cmp11, label %if.then13, label %if.end

if.then13:                                        ; preds = %if.then
  %call = tail call noalias dereferenceable_or_null(80) ptr @calloc(i64 noundef 1, i64 noundef 80) #28
  %next = getelementptr inbounds %struct._LocalHom, ptr %tmppt.0189, i64 0, i32 1
  store ptr %call, ptr %next, align 8
  %next15 = getelementptr inbounds %struct._LocalHom, ptr %call, i64 0, i32 1
  store ptr null, ptr %next15, align 8
  br label %if.end
...
if.end:                                           ; preds = %if.then13, %if.then
  %tmppt.1 = phi ptr [ %call, %if.then13 ], [ %tmppt.0189, %if.then ]
  %start116 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.1, i64 0, i32 3
  store i32 %start1.0181, ptr %start116, align 8
  %start217 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.1, i64 0, i32 5
  store i32 %start2.0182, ptr %start217, align 8
  %end118 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.1, i64 0, i32 4
  store i32 %sub, ptr %end118, align 4
  %end219 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.1, i64 0, i32 6
  store i32 %sub10, ptr %end219, align 4
...
if.then20:                                        ; preds = %if.end
  %sub21 = sub nsw i32 %sub10, %start2.0182
  %add = add nsw i32 %sub21, 1
  %overlapaa22 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.1, i64 0, i32 8
  store i32 %add, ptr %overlapaa22, align 8
  %conv24 = sitofp i32 %add to double
  %div = fdiv double %score.0186, %conv24
  %mul = fmul double %div, 5.800000e+00
  %div25 = fdiv double %mul, 6.000000e+02
  %opt26 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.1, i64 0, i32 7
  store double %div25, ptr %opt26, align 8
  br label %if.end56

if.else:                                          ; preds = %if.end
  %add27 = fadd double %score.0186, %sumscore.0187
  %add29 = add i32 %pos2.0179, %start2.0.neg192
  %add30 = add nsw i32 %add29, %sumoverlap.0188
  br label %if.end56
...
land.lhs.true36:                                  ; preds = %if.else32
  %4 = load i8, ptr %pt2.0184, align 1
  %cmp38.not = icmp eq i8 %4, 45
  br i1 %cmp38.not, label %if.end56, label %if.then40

if.then40:                                        ; preds = %land.lhs.true36
  %cmp41 = icmp eq i32 %st.0191, 0
  %spec.select = select i1 %cmp41, i32 %pos1.0178, i32 %start1.0181
  %spec.select173 = select i1 %cmp41, i32 %pos2.0179, i32 %start2.0182
  %idxprom = sext i8 %2 to i64
  %arrayidx = getelementptr inbounds [128 x i32], ptr @amino_n, i64 0, i64 %idxprom
  %5 = load i32, ptr %arrayidx, align 4
  ...
  %6 = load i32, ptr %arrayidx50, align 4
  ...
  %add54 = fadd double %score.0186, %conv53
  br label %if.end56

if.end56:                                         ; preds = %if.then20, %if.else, %if.else32, %land.lhs.true36, %if.then40
  %start1.2 = phi i32 [ %spec.select, %if.then40 ], [ %start1.0181, %land.lhs.true36 ], [ %start1.0181, %if.else32 ], [ %start1.0181, %if.else ], [ %start1.0181, %if.then20 ]
  %start2.2 = phi i32 [ %spec.select173, %if.then40 ], [ %start2.0182, %land.lhs.true36 ], [ %start2.0182, %if.else32 ], [ %start2.0182, %if.else ], [ %start2.0182, %if.then20 ]
  %score.1 = phi double [ %add54, %if.then40 ], [ %score.0186, %land.lhs.true36 ], [ %score.0186, %if.else32 ], [ 0.000000e+00, %if.else ], [ 0.000000e+00, %if.then20 ]
  %sumscore.2 = phi double [ %sumscore.0187, %if.then40 ], [ %sumscore.0187, %land.lhs.true36 ], [ %sumscore.0187, %if.else32 ], [ %add27, %if.else ], [ %sumscore.0187, %if.then20 ]
  %sumoverlap.2 = phi i32 [ %sumoverlap.0188, %if.then40 ], [ %sumoverlap.0188, %land.lhs.true36 ], [ %sumoverlap.0188, %if.else32 ], [ %add30, %if.else ], [ %sumoverlap.0188, %if.then20 ]
  %tmppt.2 = phi ptr [ %tmppt.0189, %if.then40 ], [ %tmppt.0189, %land.lhs.true36 ], [ %tmppt.0189, %if.else32 ], [ %tmppt.1, %if.else ], [ %tmppt.1, %if.then20 ]
  %nlocalhom.1 = phi i32 [ %nlocalhom.0190, %if.then40 ], [ %nlocalhom.0190, %land.lhs.true36 ], [ %nlocalhom.0190, %if.else32 ], [ %inc, %if.else ], [ %inc, %if.then20 ]
  %st.2 = phi i32 [ 1, %if.then40 ], [ %st.0191, %land.lhs.true36 ], [ %st.0191, %if.else32 ], [ 0, %if.else ], [ 0, %if.then20 ]
  %incdec.ptr = getelementptr inbounds i8, ptr %pt1.0183, i64 1
  %8 = load i8, ptr %pt1.0183, align 1
  %cmp58.not = icmp ne i8 %8, 45
  %inc61 = zext i1 %cmp58.not to i32
  %spec.select174 = add nsw i32 %pos1.0178, %inc61
  %incdec.ptr63 = getelementptr inbounds i8, ptr %pt2.0184, i64 1
  %9 = load i8, ptr %pt2.0184, align 1
  %cmp65.not = icmp ne i8 %9, 45
  %inc68 = zext i1 %cmp65.not to i32
...
while.end:                                        ; preds = %if.end56
  %11 = icmp sgt i32 %nlocalhom.1, 0
  br i1 %11, label %if.then73, label %if.end78
...
if.then73:                                        ; preds = %while.end
  ...
  store ptr %call74, ptr %next75, align 8
...
if.end78:                                         ; preds = %entry, %if.then73, %while.end
  ...
  store i32 %start1.0.lcssa217, ptr %start181, align 8
  %start282 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.3, i64 0, i32 5
  store i32 %start2.0.lcssa218, ptr %start282, align 8
  %end183 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.3, i64 0, i32 4
  store i32 %sub79, ptr %end183, align 4
  %end284 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.3, i64 0, i32 6
  store i32 %sub80, ptr %end284, align 4
  %12 = load i32, ptr @divpairscore, align 4
  %tobool85.not = icmp eq i32 %12, 0
...
if.end101.thread:                                 ; preds = %if.end78
  ...
  store i32 %add88, ptr %overlapaa89, align 8
  ...
  store double %div94, ptr %opt95, align 8
  br label %if.end112

if.end101:                                        ; preds = %if.end78
  %add99 = add i32 %pos2.0.lcssa216, %start2.0.neg.lcssa222
  %add100 = add nsw i32 %add99, %sumoverlap.0.lcssa221
  %tobool104.not202 = icmp eq ptr %localhompt, null
  br i1 %tobool104.not202, label %if.end112, label %for.body.lr.ph
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  %tmppt.4203 = phi ptr [ %localhompt, %for.body.lr.ph ], [ %13, %for.body ]
  %overlapaa105 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.4203, i64 0, i32 8
  store i32 %add100, ptr %overlapaa105, align 8
  %opt110 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.4203, i64 0, i32 7
  store double %div109, ptr %opt110, align 8
  %next111 = getelementptr inbounds %struct._LocalHom, ptr %tmppt.4203, i64 0, i32 1
  %13 = load ptr, ptr %next111, align 8
  %tobool104.not = icmp eq ptr %13, null
  br i1 %tobool104.not, label %if.end112, label %for.body
...
if.end3:                                          ; preds = %do.body
  ...
  br i1 %cmp9.not, label %do.end, label %do.body
...
while.body:                                       ; preds = %while.body.prol.loopexit, %while.body
  ...
  %7 = load i8, ptr %str2.addr.011, align 1
  ...
  store i8 %conv2, ptr %str1.addr.012, align 1
  ...
  store i8 %conv2.1, ptr %incdec.ptr3, align 1
  ...
  store i8 %conv2.2, ptr %incdec.ptr3.1, align 1
  ...
  %16 = load i8, ptr %incdec.ptr.2, align 1
  ...
  store i8 %conv2.3, ptr %incdec.ptr3.2, align 1
  %tobool.not.3 = icmp eq i32 %dec.3, 0
  br i1 %tobool.not.3, label %if.end, label %while.body
...
for.body:                                         ; preds = %land.lhs.true
  ...
  store i8 %conv4, ptr %s.addr.09, align 1
  %inc = add nuw nsw i32 %i.010, 1
  %exitcond.not = icmp eq i32 %inc, %l
  br i1 %exitcond.not, label %for.end, label %land.lhs.true

for.end.loopexit:                                 ; preds = %land.lhs.true
  br label %for.end

for.end:                                          ; preds = %for.body, %land.lhs.true, %for.end.loopexit, %entry
  %s.addr.0.lcssa = phi ptr [ %s, %entry ], [ %s.addr.09, %land.lhs.true ], [ %incdec.ptr, %for.body ], [ %s.addr.09, %for.end.loopexit ]
  %noteofflag.1.shrunk = phi i32 [ 1, %entry ], [ 0, %land.lhs.true ], [ 0, %for.body ], [ 1, %for.end.loopexit ]
...
for.body:                                         ; preds = %land.lhs.true
  ...
  store i8 %conv5, ptr %s.addr.028, align 1
...
for.end.thread:                                   ; preds = %land.lhs.true, %for.end.thread.loopexit
  ...
  store i8 0, ptr %s.addr.028, align 1
  br label %cleanup
...
while.cond:                                       ; preds = %while.cond.preheader, %while.cond
  ...
  br i1 %cmp13.not, label %cleanup, label %while.cond
...
for.body:                                         ; preds = %land.rhs
  ...
  store i8 %conv, ptr %s.addr.018, align 1
  %inc = add nuw nsw i32 %i.019, 1
  %exitcond.not = icmp eq i32 %inc, %l
  br i1 %exitcond.not, label %while.cond.critedge, label %land.rhs

for.end:                                          ; preds = %land.rhs
  store i8 0, ptr %s.addr.018, align 1
  br label %cleanup
...
while.cond:                                       ; preds = %while.cond.critedge, %while.cond
  ...
  br i1 %cmp7.not, label %cleanup, label %while.cond
...
entry:
  ...
  store i32 %conv.i, ptr %locnjob, align 4
  store i32 0, ptr %locnlenmax, align 4
  %0 = load i32, ptr %locnjob, align 4
...
if.then6:                                         ; preds = %if.else
  store i32 -1, ptr @scoremtx, align 4
  store i32 -1, ptr @upperCase, align 4
  br label %if.end29
...
if.then11:                                        ; preds = %if.else7
  store i32 -1, ptr @scoremtx, align 4
  store i32 0, ptr @upperCase, align 4
  br label %if.end29
...
if.then24:                                        ; preds = %lor.lhs.false, %if.else17
  store i32 2, ptr @scoremtx, align 4
  br label %if.end29

if.else25:                                        ; preds = %lor.lhs.false
  store i32 0, ptr @scoremtx, align 4
  br label %if.end29

if.end29:                                         ; preds = %if.then6, %if.then16, %if.else25, %if.then24, %if.then11, %if.then
  store float 0x3F50624DE0000000, ptr @geta2, align 4
  %0 = load i32, ptr @njob, align 4
...
for.body.i:                                       ; preds = %land.lhs.true.i
  ...
  store i8 %conv5.i, ptr %s.addr.028.i, align 1
  %inc.i = add nuw nsw i32 %i.029.i, 1
  %exitcond.not.i = icmp eq i32 %inc.i, 255
  br i1 %exitcond.not.i, label %for.end.i, label %land.lhs.true.i

for.end.thread.i:                                 ; preds = %land.lhs.true.i, %land.lhs.true.i
  store i8 0, ptr %s.addr.028.i, align 1
...
while.cond.i:                                     ; preds = %for.end.i, %while.cond.i
  ...
  br i1 %cmp13.not.i, label %getaline_fp_eof_new.exit, label %while.cond.i
...
getaline_fp_eof_new.exit:                         ; preds = %while.cond.i, %for.body, %for.end.thread.i, %for.end.i
  ...
  store i32 %conv.i, ptr %arrayidx40, align 4
  %arrayidx42 = getelementptr inbounds ptr, ptr %seq, i64 %indvars.iv
  %1 = load ptr, ptr %arrayidx42, align 8
...
for.body52:                                       ; preds = %for.cond48.preheader, %getaline_fp_eof_new.exit115
  ...
  br i1 %tobool.not.i94, label %land.lhs.true.i97, label %getaline_fp_eof_new.exit115

land.lhs.true.i97:                                ; preds = %for.body52, %for.body.i104
  %i.029.i98 = phi i32 [ %inc.i107, %for.body.i104 ], [ 0, %for.body52 ]
  %s.addr.028.i99 = phi ptr [ %incdec.ptr.i106, %for.body.i104 ], [ %b, %for.body52 ]
  %call1.i100 = call i32 @getc(ptr noundef %fp)
  switch i32 %call1.i100, label %for.body.i104 [
    i32 -1, label %for.end.thread.i101
    i32 10, label %for.end.thread.i101
  ]

for.body.i104:                                    ; preds = %land.lhs.true.i97
  %conv5.i105 = trunc i32 %call1.i100 to i8
  %incdec.ptr.i106 = getelementptr inbounds i8, ptr %s.addr.028.i99, i64 1
  store i8 %conv5.i105, ptr %s.addr.028.i99, align 1
  %inc.i107 = add nuw nsw i32 %i.029.i98, 1
  %exitcond.not.i108 = icmp eq i32 %inc.i107, 255
  br i1 %exitcond.not.i108, label %for.end.i109, label %land.lhs.true.i97

for.end.thread.i101:                              ; preds = %land.lhs.true.i97, %land.lhs.true.i97
  store i8 0, ptr %s.addr.028.i99, align 1
  br label %getaline_fp_eof_new.exit115

for.end.i109:                                     ; preds = %for.body.i104
  store i8 0, ptr %incdec.ptr.i106, align 1
  %cond.i110 = icmp eq i32 %call1.i100, 10
  br i1 %cond.i110, label %getaline_fp_eof_new.exit115, label %while.cond.i112

while.cond.i112:                                  ; preds = %for.end.i109, %while.cond.i112
  %call12.i113 = call i32 @getc(ptr noundef %fp)
  %cmp13.not.i114 = icmp eq i32 %call12.i113, 10
  br i1 %cmp13.not.i114, label %getaline_fp_eof_new.exit115, label %while.cond.i112

getaline_fp_eof_new.exit115:                      ; preds = %while.cond.i112, %for.body52, %for.end.thread.i101, %for.end.i109
  ...
  br i1 %cmp51.not.not, label %for.body52, label %if.end59
...
for.end68:                                        ; preds = %if.end59
  %.pre = load i32, ptr @scoremtx, align 4
...
for.body.i116:                                    ; preds = %for.inc18.i, %for.body.preheader.i
  ...
  %call.i117 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %10) #32
  %conv.i118 = trunc i64 %call.i117 to i32
  %cmp230.i = icmp sgt i32 %conv.i118, 0
  br i1 %cmp230.i, label %for.body4.lr.ph.i, label %for.inc18.i

for.body4.lr.ph.i:                                ; preds = %for.body.i116
  %call5.i = tail call ptr @__ctype_tolower_loc() #30
  %wide.trip.count.i = and i64 %call.i117, 4294967295
  %xtraiter = and i64 %call.i117, 1
...
for.body4.i:                                      ; preds = %for.body4.i, %for.body4.lr.ph.i.new
  ...
  %12 = load ptr, ptr %call5.i, align 8
  ...
  store i8 %conv13.i, ptr %arrayidx9.i, align 1
  %indvars.iv.next.i = or i64 %indvars.iv.i, 1
  %16 = load ptr, ptr %call5.i, align 8
  %17 = load ptr, ptr %arrayidx.i, align 8
  %arrayidx9.i.1 = getelementptr inbounds i8, ptr %17, i64 %indvars.iv.next.i
  %18 = load i8, ptr %arrayidx9.i.1, align 1
  %idxprom11.i.1 = sext i8 %18 to i64
  %arrayidx12.i.1 = getelementptr inbounds i32, ptr %16, i64 %idxprom11.i.1
  %19 = load i32, ptr %arrayidx12.i.1, align 4
  %conv13.i.1 = trunc i32 %19 to i8
  store i8 %conv13.i.1, ptr %arrayidx9.i.1, align 1
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %for.inc18.i.loopexit.unr-lcssa, label %for.body4.i
...
for.body4.i.epil:                                 ; preds = %for.inc18.i.loopexit.unr-lcssa
  ...
  %22 = load i8, ptr %arrayidx9.i.epil, align 1
  %idxprom11.i.epil = sext i8 %22 to i64
  %arrayidx12.i.epil = getelementptr inbounds i32, ptr %20, i64 %idxprom11.i.epil
  %23 = load i32, ptr %arrayidx12.i.epil, align 4
  %conv13.i.epil = trunc i32 %23 to i8
  store i8 %conv13.i.epil, ptr %arrayidx9.i.epil, align 1
  br label %for.inc18.i

for.inc18.i:                                      ; preds = %for.body4.i.epil, %for.inc18.i.loopexit.unr-lcssa, %for.body.i116
  %indvars.iv.next36.i = add nuw nsw i64 %indvars.iv35.i, 1
  %exitcond39.not.i = icmp eq i64 %indvars.iv.next36.i, %wide.trip.count38.i
  br i1 %exitcond39.not.i, label %if.end72, label %for.body.i116
...
if.then:                                          ; preds = %do.body
  store i8 45, ptr %str.addr.0, align 1
  br label %do.cond
...
while.body:                                       ; preds = %while.cond, %land.rhs13
  ...
  store i8 %conv17, ptr %cbuf.0, align 1
  %sub.ptr.lhs.cast = ptrtoint ptr %incdec.ptr to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  %cmp19 = icmp eq i64 %sub.ptr.sub, %conv18
  br i1 %cmp19, label %if.then, label %while.cond
...
while.end:                                        ; preds = %while.cond, %land.rhs13
  ...
  store i8 0, ptr %cbuf.0, align 1
  %6 = load i32, ptr @dorp, align 4
  %cmp33 = icmp eq i32 %6, 100
  %7 = load i8, ptr %val.0.ph, align 1
...
if.then.i:                                        ; preds = %switch.early.test.i, %switch.early.test.i, %switch.early.test.i, %while.body.i
  ...
  %12 = load ptr, ptr %call13.i, align 8
  ...
  store i8 %conv18.i, ptr %res.034.i, align 1
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i, %switch.early.test.i
  %res.1.i = phi ptr [ %incdec.ptr19.i, %if.then.i ], [ %res.034.i, %switch.early.test.i ]
  %14 = load i8, ptr %incdec.ptr35.i, align 1
  %tobool.not.i = icmp eq i8 %14, 0
  br i1 %tobool.not.i, label %if.end38, label %while.body.i

if.else:                                          ; preds = %while.end
  br i1 %tobool.not33.i, label %if.end38, label %while.body.lr.ph.i63

while.body.lr.ph.i63:                             ; preds = %if.else
  %call.i64 = tail call ptr @__ctype_b_loc() #30
  br label %while.body.i65

while.body.i65:                                   ; preds = %if.end.i78, %while.body.lr.ph.i63
  %15 = phi i8 [ %7, %while.body.lr.ph.i63 ], [ %21, %if.end.i78 ]
  %str.pn.i66 = phi ptr [ %val.0.ph, %while.body.lr.ph.i63 ], [ %incdec.ptr35.i68, %if.end.i78 ]
  %res.034.i67 = phi ptr [ %val.0.ph, %while.body.lr.ph.i63 ], [ %res.1.i79, %if.end.i78 ]
  %incdec.ptr35.i68 = getelementptr inbounds i8, ptr %str.pn.i66, i64 1
  %16 = load ptr, ptr %call.i64, align 8
  %idxprom.i69 = sext i8 %15 to i64
  %arrayidx.i70 = getelementptr inbounds i16, ptr %16, i64 %idxprom.i69
  %17 = load i16, ptr %arrayidx.i70, align 2
  %.fr31.i71 = freeze i16 %17
  %18 = and i16 %.fr31.i71, 1024
  %tobool2.not.i72 = icmp eq i16 %18, 0
  br i1 %tobool2.not.i72, label %switch.early.test.i86, label %if.then.i73

switch.early.test.i86:                            ; preds = %while.body.i65
  switch i8 %15, label %if.end.i78 [
    i8 46, label %if.then.i73
    i8 45, label %if.then.i73
    i8 42, label %if.then.i73
  ]

if.then.i73:                                      ; preds = %switch.early.test.i86, %switch.early.test.i86, %switch.early.test.i86, %while.body.i65
  %call13.i74 = tail call ptr @__ctype_toupper_loc() #30
  %19 = load ptr, ptr %call13.i74, align 8
  %arrayidx16.i75 = getelementptr inbounds i32, ptr %19, i64 %idxprom.i69
  %20 = load i32, ptr %arrayidx16.i75, align 4
  %conv18.i76 = trunc i32 %20 to i8
  %incdec.ptr19.i77 = getelementptr inbounds i8, ptr %res.034.i67, i64 1
  store i8 %conv18.i76, ptr %res.034.i67, align 1
  br label %if.end.i78

if.end.i78:                                       ; preds = %if.then.i73, %switch.early.test.i86
  %res.1.i79 = phi ptr [ %incdec.ptr19.i77, %if.then.i73 ], [ %res.034.i67, %switch.early.test.i86 ]
  %21 = load i8, ptr %incdec.ptr35.i68, align 1
  %tobool.not.i80 = icmp eq i8 %21, 0
  br i1 %tobool.not.i80, label %if.end38, label %while.body.i65

if.end38:                                         ; preds = %if.end.i78, %if.end.i, %if.else, %if.then35
  %res.0.lcssa.i81.sink = phi ptr [ %val.0.ph, %if.then35 ], [ %val.0.ph, %if.else ], [ %res.1.i, %if.end.i ], [ %res.1.i79, %if.end.i78 ]
  store i8 0, ptr %res.0.lcssa.i81.sink, align 1
  br label %do.body.i

do.body.i:                                        ; preds = %do.cond.i, %if.end38
  %str.addr.0.i = phi ptr [ %val.0.ph, %if.end38 ], [ %incdec.ptr.i, %do.cond.i ]
  %22 = load i8, ptr %str.addr.0.i, align 1
  %cmp.i = icmp eq i8 %22, 42
  br i1 %cmp.i, label %if.then.i88, label %do.cond.i

if.then.i88:                                      ; preds = %do.body.i
  store i8 45, ptr %str.addr.0.i, align 1
  br label %do.cond.i

do.cond.i:                                        ; preds = %if.then.i88, %do.body.i
  %23 = phi i8 [ %22, %do.body.i ], [ 45, %if.then.i88 ]
  %incdec.ptr.i = getelementptr inbounds i8, ptr %str.addr.0.i, i64 1
  %tobool.not.i87 = icmp eq i8 %23, 0
  br i1 %tobool.not.i87, label %kake2hiku.exit, label %do.body.i
...
if.then.i:                                        ; preds = %switch.early.test.i, %switch.early.test.i, %switch.early.test.i, %while.body.i
  %call13.i = tail call ptr @__ctype_tolower_loc() #30
  %6 = load ptr, ptr %call13.i, align 8
...
if.end.i:                                         ; preds = %if.then.i, %switch.early.test.i
  %res.1.i = phi ptr [ %incdec.ptr19.i, %if.then.i ], [ %res.034.i, %switch.early.test.i ]
  %8 = load i8, ptr %incdec.ptr35.i, align 1
  %tobool.not.i = icmp eq i8 %8, 0
  br i1 %tobool.not.i, label %if.end, label %while.body.i

if.else:                                          ; preds = %while.end
  br i1 %tobool.not33.i, label %if.end, label %while.body.lr.ph.i29

while.body.lr.ph.i29:                             ; preds = %if.else
  %call.i30 = tail call ptr @__ctype_b_loc() #30
  br label %while.body.i31

while.body.i31:                                   ; preds = %if.end.i44, %while.body.lr.ph.i29
  %9 = phi i8 [ %1, %while.body.lr.ph.i29 ], [ %15, %if.end.i44 ]
  %str.pn.i32 = phi ptr [ %cbuf, %while.body.lr.ph.i29 ], [ %incdec.ptr35.i34, %if.end.i44 ]
  %res.034.i33 = phi ptr [ %cbuf, %while.body.lr.ph.i29 ], [ %res.1.i45, %if.end.i44 ]
  %incdec.ptr35.i34 = getelementptr inbounds i8, ptr %str.pn.i32, i64 1
  %10 = load ptr, ptr %call.i30, align 8
  %idxprom.i35 = sext i8 %9 to i64
  %arrayidx.i36 = getelementptr inbounds i16, ptr %10, i64 %idxprom.i35
  %11 = load i16, ptr %arrayidx.i36, align 2
  %.fr31.i37 = freeze i16 %11
  %12 = and i16 %.fr31.i37, 1024
  %tobool2.not.i38 = icmp eq i16 %12, 0
  br i1 %tobool2.not.i38, label %switch.early.test.i52, label %if.then.i39

switch.early.test.i52:                            ; preds = %while.body.i31
  switch i8 %9, label %if.end.i44 [
    i8 46, label %if.then.i39
    i8 45, label %if.then.i39
    i8 42, label %if.then.i39
  ]

if.then.i39:                                      ; preds = %switch.early.test.i52, %switch.early.test.i52, %switch.early.test.i52, %while.body.i31
  %call13.i40 = tail call ptr @__ctype_toupper_loc() #30
  %13 = load ptr, ptr %call13.i40, align 8
  %arrayidx16.i41 = getelementptr inbounds i32, ptr %13, i64 %idxprom.i35
  %14 = load i32, ptr %arrayidx16.i41, align 4
  %conv18.i42 = trunc i32 %14 to i8
  %incdec.ptr19.i43 = getelementptr inbounds i8, ptr %res.034.i33, i64 1
  store i8 %conv18.i42, ptr %res.034.i33, align 1
  br label %if.end.i44

if.end.i44:                                       ; preds = %if.then.i39, %switch.early.test.i52
  %res.1.i45 = phi ptr [ %incdec.ptr19.i43, %if.then.i39 ], [ %res.034.i33, %switch.early.test.i52 ]
  %15 = load i8, ptr %incdec.ptr35.i34, align 1
  %tobool.not.i46 = icmp eq i8 %15, 0
  br i1 %tobool.not.i46, label %if.end, label %while.body.i31

if.end:                                           ; preds = %if.end.i44, %if.end.i, %if.else, %if.then
  %res.0.lcssa.i47.sink = phi ptr [ %cbuf, %if.then ], [ %cbuf, %if.else ], [ %res.1.i, %if.end.i ], [ %res.1.i45, %if.end.i44 ]
  store i8 0, ptr %res.0.lcssa.i47.sink, align 1
  br label %do.body.i
...
do.body.i:                                        ; preds = %do.cond.i, %if.end
  ...
  br i1 %cmp.i, label %if.then.i54, label %do.cond.i

if.then.i54:                                      ; preds = %do.body.i
  store i8 45, ptr %str.addr.0.i, align 1
  br label %do.cond.i

do.cond.i:                                        ; preds = %if.then.i54, %do.body.i
  %17 = phi i8 [ %16, %do.body.i ], [ 45, %if.then.i54 ]
  %incdec.ptr.i = getelementptr inbounds i8, ptr %str.addr.0.i, i64 1
  %tobool.not.i53 = icmp eq i8 %17, 0
  br i1 %tobool.not.i53, label %kake2hiku.exit, label %do.body.i
...
land.rhs.i32:                                     ; preds = %land.rhs.i32.preheader, %for.body.i
  %i.019.i = phi i32 [ %inc.i, %for.body.i ], [ 0, %land.rhs.i32.preheader ]
  %s.addr.018.i = phi ptr [ %incdec.ptr.i, %for.body.i ], [ %add.ptr, %land.rhs.i32.preheader ]
...
for.body.i:                                       ; preds = %land.rhs.i32
  ...
  store i8 %conv.i, ptr %s.addr.018.i, align 1
  %inc.i = add nuw nsw i32 %i.019.i, 1
  %exitcond.not.i = icmp eq i32 %inc.i, 254
  br i1 %exitcond.not.i, label %while.cond.critedge.i, label %land.rhs.i32

for.end.i:                                        ; preds = %land.rhs.i32
  store i8 0, ptr %s.addr.018.i, align 1
...
for.body.i34:                                     ; preds = %for.inc18.i, %for.body.preheader.i
  %indvars.iv35.i = phi i64 [ 0, %for.body.preheader.i ], [ %indvars.iv.next36.i, %for.inc18.i ]
  %arrayidx.i = getelementptr inbounds ptr, ptr %seq, i64 %indvars.iv35.i
  %9 = load ptr, ptr %arrayidx.i, align 8
  %call.i35 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %9) #32
  %conv.i36 = trunc i64 %call.i35 to i32
  %cmp230.i = icmp sgt i32 %conv.i36, 0
  br i1 %cmp230.i, label %for.body4.lr.ph.i, label %for.inc18.i

for.body4.lr.ph.i:                                ; preds = %for.body.i34
  %call5.i37 = tail call ptr @__ctype_tolower_loc() #30
  %wide.trip.count.i = and i64 %call.i35, 4294967295
  %xtraiter = and i64 %call.i35, 1
...
for.body4.i:                                      ; preds = %for.body4.i, %for.body4.lr.ph.i.new
  %indvars.iv.i = phi i64 [ 0, %for.body4.lr.ph.i.new ], [ %indvars.iv.next.i.1, %for.body4.i ]
  %niter = phi i64 [ 0, %for.body4.lr.ph.i.new ], [ %niter.next.1, %for.body4.i ]
  %11 = load ptr, ptr %call5.i37, align 8
...
for.body4.i.epil:                                 ; preds = %for.inc18.i.loopexit.unr-lcssa
  %19 = load ptr, ptr %call5.i37, align 8
  %20 = load ptr, ptr %arrayidx.i, align 8
  %arrayidx9.i.epil = getelementptr inbounds i8, ptr %20, i64 %indvars.iv.i.unr
  %21 = load i8, ptr %arrayidx9.i.epil, align 1
  %idxprom11.i.epil = sext i8 %21 to i64
  %arrayidx12.i.epil = getelementptr inbounds i32, ptr %19, i64 %idxprom11.i.epil
  %22 = load i32, ptr %arrayidx12.i.epil, align 4
  %conv13.i.epil = trunc i32 %22 to i8
  store i8 %conv13.i.epil, ptr %arrayidx9.i.epil, align 1
  br label %for.inc18.i

for.inc18.i:                                      ; preds = %for.body4.i.epil, %for.inc18.i.loopexit.unr-lcssa, %for.body.i34
  %indvars.iv.next36.i = add nuw nsw i64 %indvars.iv35.i, 1
  %exitcond39.not.i = icmp eq i64 %indvars.iv.next36.i, %wide.trip.count38.i
  br i1 %exitcond39.not.i, label %if.end, label %for.body.i34
...
land.rhs.i38:                                     ; preds = %land.rhs.i38.preheader, %for.body.i
  %i.019.i = phi i32 [ %inc.i, %for.body.i ], [ 0, %land.rhs.i38.preheader ]
  %s.addr.018.i = phi ptr [ %incdec.ptr.i, %for.body.i ], [ %add.ptr, %land.rhs.i38.preheader ]
  %call1.i = tail call i32 @getc(ptr noundef %fp)
  %cmp2.not.i = icmp eq i32 %call1.i, 10
  br i1 %cmp2.not.i, label %for.end.i, label %for.body.i
...
for.body.i:                                       ; preds = %land.rhs.i38
  ...
  %inc.i = add nuw nsw i32 %i.019.i, 1
  %exitcond.not.i = icmp eq i32 %inc.i, 254
  br i1 %exitcond.not.i, label %while.cond.critedge.i, label %land.rhs.i38
...
while.cond.i39:                                   ; preds = %while.cond.i39, %while.cond.critedge.i
  %call6.i = tail call i32 @getc(ptr noundef %fp)
  %cmp7.not.i = icmp eq i32 %call6.i, 10
  br i1 %cmp7.not.i, label %myfgets.exit, label %while.cond.i39

myfgets.exit:                                     ; preds = %while.cond.i39, %for.body, %for.end.i
  %call5 = tail call ptr @load1SeqWithoutName_realloc(ptr noundef %fp)
  store ptr %call5, ptr @readData_varlen.tmpseq, align 8
...
for.body.i40:                                     ; preds = %for.inc18.i, %for.body.preheader.i
  %indvars.iv35.i = phi i64 [ 0, %for.body.preheader.i ], [ %indvars.iv.next36.i, %for.inc18.i ]
  %arrayidx.i = getelementptr inbounds ptr, ptr %seq, i64 %indvars.iv35.i
  %7 = load ptr, ptr %arrayidx.i, align 8
  %call.i41 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %7) #32
  %conv.i42 = trunc i64 %call.i41 to i32
  %cmp230.i = icmp sgt i32 %conv.i42, 0
  br i1 %cmp230.i, label %for.body4.lr.ph.i, label %for.inc18.i

for.body4.lr.ph.i:                                ; preds = %for.body.i40
  %call5.i43 = tail call ptr @__ctype_tolower_loc() #30
  %wide.trip.count.i = and i64 %call.i41, 4294967295
  %xtraiter = and i64 %call.i41, 1
...
for.body4.i:                                      ; preds = %for.body4.i, %for.body4.lr.ph.i.new
  %indvars.iv.i = phi i64 [ 0, %for.body4.lr.ph.i.new ], [ %indvars.iv.next.i.1, %for.body4.i ]
  %niter = phi i64 [ 0, %for.body4.lr.ph.i.new ], [ %niter.next.1, %for.body4.i ]
  %9 = load ptr, ptr %call5.i43, align 8
  %10 = load ptr, ptr %arrayidx.i, align 8
...
for.body4.i.epil:                                 ; preds = %for.inc18.i.loopexit.unr-lcssa
  %17 = load ptr, ptr %call5.i43, align 8
  %18 = load ptr, ptr %arrayidx.i, align 8
  %arrayidx9.i.epil = getelementptr inbounds i8, ptr %18, i64 %indvars.iv.i.unr
  %19 = load i8, ptr %arrayidx9.i.epil, align 1
  %idxprom11.i.epil = sext i8 %19 to i64
  %arrayidx12.i.epil = getelementptr inbounds i32, ptr %17, i64 %idxprom11.i.epil
  %20 = load i32, ptr %arrayidx12.i.epil, align 4
  %conv13.i.epil = trunc i32 %20 to i8
  store i8 %conv13.i.epil, ptr %arrayidx9.i.epil, align 1
  br label %for.inc18.i

for.inc18.i:                                      ; preds = %for.body4.i.epil, %for.inc18.i.loopexit.unr-lcssa, %for.body.i40
  %indvars.iv.next36.i = add nuw nsw i64 %indvars.iv35.i, 1
  %exitcond39.not.i = icmp eq i64 %indvars.iv.next36.i, %wide.trip.count38.i
  br i1 %exitcond39.not.i, label %if.end, label %for.body.i40
...
myfgets.exit:                                     ; preds = %while.cond.i33, %for.body, %for.end.i
  %call5 = tail call ptr @load1SeqWithoutName_realloc(ptr noundef %fp)
  store ptr %call5, ptr @readData_pointer.tmpseq, align 8
  %arrayidx7 = getelementptr inbounds ptr, ptr %seq, i64 %indvars.iv
  %3 = load ptr, ptr %arrayidx7, align 8
  %call8 = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %3, ptr noundef nonnull dereferenceable(1) %call5) #31
  tail call void @free(ptr noundef %call5) #31
...
myfgets.exit:                                     ; preds = %while.cond.i33, %for.body, %for.end.i
  %call5 = tail call ptr @load1SeqWithoutName_realloc(ptr noundef %fp)
  store ptr %call5, ptr @readData.tmpseq, align 8
  %arrayidx7 = getelementptr inbounds ptr, ptr %seq, i64 %indvars.iv
...
for.body.i34:                                     ; preds = %for.inc18.i, %for.body.preheader.i
  ...
  %arrayidx.i = getelementptr inbounds ptr, ptr %seq, i64 %indvars.iv35.i
  %7 = load ptr, ptr %arrayidx.i, align 8
  %call.i35 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %7) #32
  %conv.i36 = trunc i64 %call.i35 to i32
  %cmp230.i = icmp sgt i32 %conv.i36, 0
  br i1 %cmp230.i, label %for.body4.lr.ph.i, label %for.inc18.i
...
for.body4.i:                                      ; preds = %for.body4.i, %for.body4.lr.ph.i.new
  %indvars.iv.i = phi i64 [ 0, %for.body4.lr.ph.i.new ], [ %indvars.iv.next.i.1, %for.body4.i ]
  %niter = phi i64 [ 0, %for.body4.lr.ph.i.new ], [ %niter.next.1, %for.body4.i ]
  %9 = load ptr, ptr %call5.i37, align 8
  %10 = load ptr, ptr %arrayidx.i, align 8
  %arrayidx9.i = getelementptr inbounds i8, ptr %10, i64 %indvars.iv.i
  %11 = load i8, ptr %arrayidx9.i, align 1
  %idxprom11.i = sext i8 %11 to i64
  ...
  store i8 %conv13.i, ptr %arrayidx9.i, align 1
  %indvars.iv.next.i = or i64 %indvars.iv.i, 1
  %13 = load ptr, ptr %call5.i37, align 8
  %14 = load ptr, ptr %arrayidx.i, align 8
  %arrayidx9.i.1 = getelementptr inbounds i8, ptr %14, i64 %indvars.iv.next.i
  %15 = load i8, ptr %arrayidx9.i.1, align 1
  %idxprom11.i.1 = sext i8 %15 to i64
...
for.body4.i.epil:                                 ; preds = %for.inc18.i.loopexit.unr-lcssa
  %17 = load ptr, ptr %call5.i37, align 8
  %18 = load ptr, ptr %arrayidx.i, align 8
  %arrayidx9.i.epil = getelementptr inbounds i8, ptr %18, i64 %indvars.iv.i.unr
  %19 = load i8, ptr %arrayidx9.i.epil, align 1
  %idxprom11.i.epil = sext i8 %19 to i64
...
do.end:                                           ; preds = %do.cond
  store i32 %nChar.1, ptr %total, align 4
  br label %cleanup
...
while.body:                                       ; preds = %while.body.lr.ph, %while.body
  %2 = phi i8 [ %0, %while.body.lr.ph ], [ %7, %while.body ]
...
while.body.i:                                     ; preds = %entry, %while.body.i
  ...
  br i1 %cmp.not.i, label %countKUorWA.exit, label %while.body.i

countKUorWA.exit:                                 ; preds = %while.body.i, %entry
  %value.0.lcssa.i = phi i32 [ 0, %entry ], [ %value.1.i, %while.body.i ]
  tail call void @rewind(ptr noundef %fp)
  store i32 %value.0.lcssa.i, ptr @njob, align 4
  br label %while.cond.i
...
searchKUorWA.exit:                                ; preds = %land.rhs.i
  ...
  store i32 0, ptr @nlenmax, align 4
  store i32 99999999, ptr %nlenminpt, align 4
...
for.body:                                         ; preds = %searchKUorWA.exit, %countATGC.exit
  %total.058 = phi i32 [ %add10, %countATGC.exit ], [ 0, %searchKUorWA.exit ]
  %atgcnum.057 = phi i32 [ %add, %countATGC.exit ], [ 0, %searchKUorWA.exit ]
  %i.056 = phi i32 [ %inc, %countATGC.exit ], [ 0, %searchKUorWA.exit ]
  %nsite.055 = phi i32 [ %nsite.1, %countATGC.exit ], [ undef, %searchKUorWA.exit ]
...
for.body.i:                                       ; preds = %land.rhs.i39
  ...
  br i1 %exitcond.not.i, label %while.cond.critedge.i, label %land.rhs.i39
...
while.cond.i41:                                   ; preds = %while.cond.i41, %while.cond.critedge.i
  %call6.i = tail call i32 @getc(ptr noundef %fp)
  %cmp7.not.i = icmp eq i32 %call6.i, 10
  br i1 %cmp7.not.i, label %myfgets.exit, label %while.cond.i41
...
while.body.lr.ph.i:                               ; preds = %myfgets.exit
  ...
  %3 = load ptr, ptr %call.i42, align 8
  br label %while.body.i43

while.body.i43:                                   ; preds = %while.body.i43, %while.body.lr.ph.i
  %4 = phi i8 [ %2, %while.body.lr.ph.i ], [ %9, %while.body.i43 ]
  %val.07.i = phi i32 [ 0, %while.body.lr.ph.i ], [ %spec.select.i, %while.body.i43 ]
  %seq.addr.06.i = phi ptr [ %call3, %while.body.lr.ph.i ], [ %incdec.ptr.i44, %while.body.i43 ]
  %incdec.ptr.i44 = getelementptr inbounds i8, ptr %seq.addr.06.i, i64 1
  ...
  %7 = and i16 %6, 1
  %8 = zext i16 %7 to i32
  %spec.select.i = add i32 %val.07.i, %8
  %9 = load i8, ptr %incdec.ptr.i44, align 1
  %tobool.not.i45 = icmp eq i8 %9, 0
  br i1 %tobool.not.i45, label %countalpha.exit, label %while.body.i43

countalpha.exit:                                  ; preds = %while.body.i43, %myfgets.exit
  %val.0.lcssa.i = phi i32 [ 0, %myfgets.exit ], [ %spec.select.i, %while.body.i43 ]
  %10 = load i32, ptr @nlenmax, align 4
  %cmp5 = icmp sgt i32 %val.0.lcssa.i, %10
  br i1 %cmp5, label %if.then, label %if.end

if.then:                                          ; preds = %countalpha.exit
  store i32 %val.0.lcssa.i, ptr @nlenmax, align 4
  br label %if.end

if.end:                                           ; preds = %if.then, %countalpha.exit
  %11 = load i32, ptr %nlenminpt, align 4
  %cmp6 = icmp slt i32 %val.0.lcssa.i, %11
  br i1 %cmp6, label %if.then7, label %if.end8

if.then7:                                         ; preds = %if.end
  store i32 %val.0.lcssa.i, ptr %nlenminpt, align 4
  br label %if.end8
...
do.body.preheader.i:                              ; preds = %if.end8
  %call.i46 = tail call ptr @__ctype_tolower_loc() #30
  %13 = load ptr, ptr %call.i46, align 8
  %call4.i = tail call ptr @__ctype_b_loc() #30
  %14 = load ptr, ptr %call4.i, align 8
  br label %do.body.i

do.body.i:                                        ; preds = %do.cond.i, %do.body.preheader.i
  %15 = phi i8 [ %21, %do.cond.i ], [ %12, %do.body.preheader.i ]
  %nATGC.0.i = phi i32 [ %nATGC.1.i, %do.cond.i ], [ 0, %do.body.preheader.i ]
  %nChar.0.i = phi i32 [ %nChar.1.i, %do.cond.i ], [ 0, %do.body.preheader.i ]
  %s.addr.0.i = phi ptr [ %incdec.ptr.i51, %do.cond.i ], [ %call3, %do.body.preheader.i ]
  %idxprom.i47 = sext i8 %15 to i64
  %arrayidx.i48 = getelementptr inbounds i32, ptr %13, i64 %idxprom.i47
  %16 = load i32, ptr %arrayidx.i48, align 4
  %.fr53.i = freeze i32 %16
  %sext.i = shl i32 %.fr53.i, 24
  %conv5.i = ashr exact i32 %sext.i, 24
  %idxprom6.i = sext i32 %conv5.i to i64
  %arrayidx7.i = getelementptr inbounds i16, ptr %14, i64 %idxprom6.i
  %17 = load i16, ptr %arrayidx7.i, align 2
  %18 = and i16 %17, 1024
  %tobool.not.i49 = icmp eq i16 %18, 0
  br i1 %tobool.not.i49, label %do.cond.i, label %if.then9.i

if.then9.i:                                       ; preds = %do.body.i
  %inc.i50 = add nsw i32 %nChar.0.i, 1
  %19 = and i32 %.fr53.i, 251
  %20 = icmp eq i32 %19, 99
  br i1 %20, label %if.then32.i, label %switch.early.test.i
...
do.cond.i:                                        ; preds = %if.then32.i, %switch.early.test.i, %do.body.i
  ...
  %nChar.1.i = phi i32 [ %inc.i50, %if.then32.i ], [ %inc.i50, %switch.early.test.i ], [ %nChar.0.i, %do.body.i ]
  %incdec.ptr.i51 = getelementptr inbounds i8, ptr %s.addr.0.i, i64 1
  %21 = load i8, ptr %incdec.ptr.i51, align 1
  %tobool36.not.i = icmp eq i8 %21, 0
  br i1 %tobool36.not.i, label %countATGC.exit, label %do.body.i

countATGC.exit:                                   ; preds = %do.cond.i, %if.end8
  %nsite.1 = phi i32 [ %nsite.055, %if.end8 ], [ %nChar.1.i, %do.cond.i ]
  %retval.0.i52 = phi i32 [ 0, %if.end8 ], [ %nATGC.1.i, %do.cond.i ]
  %add = add nsw i32 %retval.0.i52, %atgcnum.057
  %add10 = add nsw i32 %nsite.1, %total.058
...
for.end.loopexit:                                 ; preds = %countATGC.exit
  %23 = sitofp i32 %add to double
  %24 = sitofp i32 %add10 to double
  %25 = fdiv double %23, %24
  br label %for.end

for.end:                                          ; preds = %for.end.loopexit, %searchKUorWA.exit
  %div = phi double [ %25, %for.end.loopexit ], [ 0x7FF8000000000000, %searchKUorWA.exit ]
  tail call void @free(ptr noundef %call) #31
  %26 = load ptr, ptr @stderr, align 8
  %call12 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %26, ptr noundef nonnull @.str.19, double noundef %div) #27
  %27 = load i32, ptr @dorp, align 4
  %cmp13 = icmp eq i32 %27, 100009
  br i1 %cmp13, label %if.then15, label %if.end20

if.then15:                                        ; preds = %for.end
  %cmp16 = fcmp ogt double %div, 7.500000e-01
  %. = select i1 %cmp16, i32 100, i32 112
  %.63 = sext i1 %cmp16 to i32
  store i32 %., ptr @dorp, align 4
  store i32 %.63, ptr @upperCase, align 4
  br label %if.end20
...
while.cond.i34:                                   ; preds = %while.cond.i34, %while.cond.critedge.i
  %call6.i = tail call i32 @getc(ptr noundef %fp)
  %cmp7.not.i = icmp eq i32 %call6.i, 10
  br i1 %cmp7.not.i, label %myfgets.exit, label %while.cond.i34
...
myfgets.exit:                                     ; preds = %while.cond.i34, %for.body, %for.end.i
  ...
  %2 = load i32, ptr @nlenmax, align 4
  %cmp5 = icmp slt i32 %2, %conv
  br i1 %cmp5, label %if.then, label %if.end

if.then:                                          ; preds = %myfgets.exit
  store i32 %conv, ptr @nlenmax, align 4
  br label %if.end
...
do.body.preheader.i:                              ; preds = %if.end
  ...
  %4 = load ptr, ptr %call.i35, align 8
  %call4.i = tail call ptr @__ctype_b_loc() #30
...
do.cond.i:                                        ; preds = %if.then32.i, %switch.early.test.i, %do.body.i
  ...
  %12 = load i8, ptr %incdec.ptr.i38, align 1
...
if.then13:                                        ; preds = %for.end
  ...
  store i32 %., ptr @dorp, align 4
  store i32 %.50, ptr @upperCase, align 4
  br label %if.end18
...
for.body6.preheader:                              ; preds = %for.cond3.preheader
  ...
  tail call void @llvm.memset.p0.i64(ptr nonnull align 16 @WriteGapFill.gap, i8 45, i64 %0, i1 false)
  br label %for.end11
...
for.body19:                                       ; preds = %for.body19.preheader, %for.inc49
  ...
  %3 = load i32, ptr @nlenmax, align 4
...
while.body.i:                                     ; preds = %while.body.i, %while.cond.preheader.i
  ...
  %8 = load i8, ptr %str2.addr.011.i, align 1
  %idxprom.i = sext i8 %8 to i64
  ...
  store i8 %conv2.i, ptr %str1.addr.012.i, align 1
  ...
  store i8 %conv2.i.3, ptr %incdec.ptr3.i.2, align 1
  ...
  %21 = load i32, ptr %arrayidx.i.4, align 4
  %conv2.i.4 = trunc i32 %21 to i8
  %incdec.ptr3.i.4 = getelementptr inbounds i8, ptr %str1.addr.012.i, i64 5
  store i8 %conv2.i.4, ptr %incdec.ptr3.i.3, align 1
  %tobool.not.i.4 = icmp eq i32 %dec.i.4, 0
  br i1 %tobool.not.i.4, label %strncpy_caseC.exit, label %while.body.i
...
strncpy_caseC.exit:                               ; preds = %while.body.i, %if.else.i
  store i8 0, ptr getelementptr inbounds ([5000000 x i8], ptr @WriteGapFill.b, i64 0, i64 60), align 4
  ...
  br i1 %cmp43, label %for.body45, label %for.inc49

for.inc49:                                        ; preds = %strncpy_caseC.exit, %for.body19
  %indvars.iv.next95 = add nuw nsw i64 %indvars.iv94, 1
  %exitcond98.not = icmp eq i64 %indvars.iv.next95, %wide.trip.count97
  br i1 %exitcond98.not, label %for.end51, label %for.body19

for.end51.critedge:                               ; preds = %entry
  store i8 0, ptr @WriteGapFill.gap, align 16
...
for.body.i:                                       ; preds = %land.rhs.i
  ...
  %incdec.ptr.i = getelementptr inbounds i8, ptr %s.addr.018.i, i64 1
  store i8 %conv.i44, ptr %s.addr.018.i, align 1
  %inc.i = add nuw nsw i32 %i.019.i, 1
  %exitcond.not.i = icmp eq i32 %inc.i, 254
  br i1 %exitcond.not.i, label %while.cond.critedge.i, label %land.rhs.i
...
while.cond.i:                                     ; preds = %while.cond.i, %while.cond.critedge.i
  ...
  %cmp7.not.i = icmp eq i32 %call6.i, 10
  br i1 %cmp7.not.i, label %myfgets.exit, label %while.cond.i
...
for.cond10.loopexit:                              ; preds = %if.end.i, %for.body12
  ...
  br i1 %exitcond68.not, label %for.end26, label %for.body12
...
if.end.i:                                         ; preds = %if.then.i, %for.body15
  ...
  %conv.i48 = trunc i32 %call3.i to i8
  store i8 %conv.i48, ptr %mojiretsu.i, align 1
  %call3.i.1 = call i32 @getc(ptr noundef %fp)
  %conv.i48.1 = trunc i32 %call3.i.1 to i8
  store i8 %conv.i48.1, ptr %arrayidx.i.1, align 1
  %call3.i.2 = call i32 @getc(ptr noundef %fp)
  %conv.i48.2 = trunc i32 %call3.i.2 to i8
  store i8 %conv.i48.2, ptr %arrayidx.i.2, align 1
  %call3.i.3 = call i32 @getc(ptr noundef %fp)
  %conv.i48.3 = trunc i32 %call3.i.3 to i8
  store i8 %conv.i48.3, ptr %arrayidx.i.3, align 1
  %call3.i.4 = call i32 @getc(ptr noundef %fp)
  %conv.i48.4 = trunc i32 %call3.i.4 to i8
  store i8 %conv.i48.4, ptr %arrayidx.i.4, align 1
  %call3.i.5 = call i32 @getc(ptr noundef %fp)
  %conv.i48.5 = trunc i32 %call3.i.5 to i8
  store i8 %conv.i48.5, ptr %arrayidx.i.5, align 1
  ...
  store float %conv7.i, ptr %arrayidx20, align 4
  %indvars.iv.next60 = add nuw nsw i64 %indvars.iv59, 1
  %exitcond63.not = icmp eq i64 %indvars.iv.next60, %wide.trip.count
  br i1 %exitcond63.not, label %for.cond10.loopexit, label %for.body15
...
for.body.i:                                       ; preds = %land.rhs.i
  ...
  %incdec.ptr.i = getelementptr inbounds i8, ptr %s.addr.018.i, i64 1
  store i8 %conv.i42, ptr %s.addr.018.i, align 1
  %inc.i = add nuw nsw i32 %i.019.i, 1
  %exitcond.not.i = icmp eq i32 %inc.i, 254
  br i1 %exitcond.not.i, label %while.cond.critedge.i, label %land.rhs.i
...
for.cond10.loopexit:                              ; preds = %if.end.i, %for.body12
  ...
  br i1 %exitcond65.not, label %for.end25, label %for.body12
...
if.end.i:                                         ; preds = %if.then.i, %for.body15
  ...
  store i8 %conv.i46, ptr %mojiretsu.i, align 1
  %call3.i.1 = call i32 @getc(ptr noundef %fp)
  %conv.i46.1 = trunc i32 %call3.i.1 to i8
  store i8 %conv.i46.1, ptr %arrayidx.i.1, align 1
  %call3.i.2 = call i32 @getc(ptr noundef %fp)
  %conv.i46.2 = trunc i32 %call3.i.2 to i8
  store i8 %conv.i46.2, ptr %arrayidx.i.2, align 1
  %call3.i.3 = call i32 @getc(ptr noundef %fp)
  %conv.i46.3 = trunc i32 %call3.i.3 to i8
  store i8 %conv.i46.3, ptr %arrayidx.i.3, align 1
  %call3.i.4 = call i32 @getc(ptr noundef %fp)
  %conv.i46.4 = trunc i32 %call3.i.4 to i8
  store i8 %conv.i46.4, ptr %arrayidx.i.4, align 1
  %call3.i.5 = call i32 @getc(ptr noundef %fp)
  %conv.i46.5 = trunc i32 %call3.i.5 to i8
  store i8 %conv.i46.5, ptr %arrayidx.i.5, align 1
  store i8 0, ptr %arrayidx5.i, align 1
  %call.i.i = call double @strtod(ptr nocapture noundef nonnull %mojiretsu.i, ptr noundef null) #31
  %conv7.i = fptrunc double %call.i.i to float
  call void @llvm.lifetime.end.p0(i64 10, ptr nonnull %mojiretsu.i) #31
  ...
  store float %conv7.i, ptr %arrayidx19, align 4
  %indvars.iv.next58 = add nuw nsw i64 %indvars.iv57, 1
  %exitcond60.not = icmp eq i64 %indvars.iv.next58, %wide.trip.count
  br i1 %exitcond60.not, label %for.cond10.loopexit, label %for.body15
...
for.body.i:                                       ; preds = %land.rhs.i
  ...
  %incdec.ptr.i = getelementptr inbounds i8, ptr %s.addr.018.i, i64 1
  store i8 %conv.i43, ptr %s.addr.018.i, align 1
  %inc.i = add nuw nsw i32 %i.019.i, 1
  %exitcond.not.i = icmp eq i32 %inc.i, 254
  br i1 %exitcond.not.i, label %while.cond.critedge.i, label %land.rhs.i
...
for.cond10.loopexit:                              ; preds = %if.end.i, %for.body12
  ...
  br i1 %exitcond66.not, label %for.end26, label %for.body12
...
if.end.i:                                         ; preds = %if.then.i, %for.body15
  ...
  store i8 %conv.i47, ptr %mojiretsu.i, align 1
  %call3.i.1 = call i32 @getc(ptr noundef %fp)
  %conv.i47.1 = trunc i32 %call3.i.1 to i8
  store i8 %conv.i47.1, ptr %arrayidx.i.1, align 1
  %call3.i.2 = call i32 @getc(ptr noundef %fp)
  %conv.i47.2 = trunc i32 %call3.i.2 to i8
  store i8 %conv.i47.2, ptr %arrayidx.i.2, align 1
  %call3.i.3 = call i32 @getc(ptr noundef %fp)
  %conv.i47.3 = trunc i32 %call3.i.3 to i8
  store i8 %conv.i47.3, ptr %arrayidx.i.3, align 1
  %call3.i.4 = call i32 @getc(ptr noundef %fp)
  %conv.i47.4 = trunc i32 %call3.i.4 to i8
  store i8 %conv.i47.4, ptr %arrayidx.i.4, align 1
  %call3.i.5 = call i32 @getc(ptr noundef %fp)
  %conv.i47.5 = trunc i32 %call3.i.5 to i8
  store i8 %conv.i47.5, ptr %arrayidx.i.5, align 1
  store i8 0, ptr %arrayidx5.i, align 1
  %call.i.i = call double @strtod(ptr nocapture noundef nonnull %mojiretsu.i, ptr noundef null) #31
  %conv7.i = fptrunc double %call.i.i to float
  call void @llvm.lifetime.end.p0(i64 10, ptr nonnull %mojiretsu.i) #31
  ...
  br i1 %exitcond61.not, label %for.cond10.loopexit, label %for.body15
...
if.end.i:                                         ; preds = %if.then.i, %for.body15
  ...
  store double %conv, ptr %arrayidx19, align 8
  %indvars.iv.next58 = add nuw nsw i64 %indvars.iv57, 1
  %exitcond60.not = icmp eq i64 %indvars.iv.next58, %wide.trip.count
  br i1 %exitcond60.not, label %for.cond10.loopexit, label %for.body15
...
for.cond1.preheader:                              ; preds = %for.cond1.preheader.preheader, %for.inc14
  ...
  %2 = add nsw i64 %1, -1
  %cmp394 = icmp slt i64 %indvars.iv110, %invariant.op
...
for.body4.lr.ph:                                  ; preds = %for.cond1.preheader
  ...
  %4 = icmp eq i32 %indvars.iv108, 2
  br i1 %4, label %for.inc14.loopexit.unr-lcssa, label %for.body4.lr.ph.new
...
for.body4:                                        ; preds = %for.body4, %for.body4.lr.ph.new
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx6.1 = getelementptr inbounds float, ptr %3, i64 %indvars.iv.next
  %6 = load float, ptr %arrayidx6.1, align 4
  %conv.1 = fpext float %6 to double
  %cmp7.1 = fcmp olt double %max.2, %conv.1
  %max.2.1 = select i1 %cmp7.1, double %conv.1, double %max.2
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %for.inc14.loopexit.unr-lcssa, label %for.body4
...
for.body4.epil:                                   ; preds = %for.inc14.loopexit.unr-lcssa
  %arrayidx6.epil = getelementptr inbounds float, ptr %3, i64 %indvars.iv.unr
  %7 = load float, ptr %arrayidx6.epil, align 4
...
for.inc14:                                        ; preds = %for.body4.epil, %for.inc14.loopexit.unr-lcssa, %for.cond1.preheader
  ...
  br i1 %exitcond115.not, label %for.end16.loopexit, label %for.cond1.preheader

for.end16.loopexit:                               ; preds = %for.inc14
  %8 = fmul double %max.1.lcssa, 2.500000e+00
  br label %for.end16

for.end16:                                        ; preds = %for.end16.loopexit, %entry
  %max.0.lcssa = phi double [ 0.000000e+00, %entry ], [ %8, %for.end16.loopexit ]
  ...
  %call18 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %hat2p, ptr noundef nonnull @.str.26, double noundef %max.0.lcssa)
...
for.body22:                                       ; preds = %for.body22.preheader, %for.body22
  ...
  br i1 %exitcond120.not, label %for.cond29.preheader, label %for.body22
...
for.inc53:                                        ; preds = %for.body37, %if.then50
  ...
  br i1 %exitcond127.not, label %for.inc56, label %for.body37
...
for.inc56:                                        ; preds = %for.inc53, %for.cond33.preheader
  ...
  br i1 %exitcond134.not, label %for.end58, label %for.cond33.preheader
...
for.cond.loopexit:                                ; preds = %for.body3, %for.body
  ...
  br i1 %exitcond119.not, label %for.end15, label %for.body
...
for.body21:                                       ; preds = %for.body21.preheader, %for.body21
  ...
  br i1 %exitcond124.not, label %for.cond29.preheader, label %for.body21

for.cond29.loopexit:                              ; preds = %for.inc56, %for.body33
  %indvars.iv.next126 = add nuw nsw i64 %indvars.iv125, 1
  %exitcond136.not = icmp eq i64 %indvars.iv.next133, %3
  br i1 %exitcond136.not, label %for.end61, label %for.body33
...
for.inc56:                                        ; preds = %for.body38, %if.then53
  ...
  br i1 %exitcond131.not, label %for.cond29.loopexit, label %for.body38
...
for.cond.loopexit:                                ; preds = %for.body3, %for.body
  ...
  br i1 %exitcond108.not, label %for.end13.loopexit, label %for.body
...
for.end13.loopexit:                               ; preds = %for.cond.loopexit
  %3 = fmul double %max.1.lcssa, 2.500000e+00
  br label %for.end13

for.end13:                                        ; preds = %for.end13.loopexit, %entry
  %max.0.lcssa = phi double [ 0.000000e+00, %entry ], [ %3, %for.end13.loopexit ]
  %call = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %hat2p, ptr noundef nonnull @.str.22, i32 noundef 1)
  %call14 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %hat2p, ptr noundef nonnull @.str.22, i32 noundef %locnjob)
  %call15 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %hat2p, ptr noundef nonnull @.str.26, double noundef %max.0.lcssa)
...
for.body18:                                       ; preds = %for.body18.preheader, %for.body18
  ...
  %6 = trunc i64 %indvars.iv.next110 to i32
  %call22 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %hat2p, ptr noundef nonnull @.str.27, i32 noundef %6, ptr noundef %arrayidx21)
  %exitcond113.not = icmp eq i64 %indvars.iv.next110, %wide.trip.count112
  br i1 %exitcond113.not, label %for.cond26.preheader, label %for.body18

for.cond26.loopexit:                              ; preds = %for.inc46, %for.body29
  %indvars.iv.next115 = add nuw nsw i64 %indvars.iv114, 1
  %exitcond125.not = icmp eq i64 %indvars.iv.next122, %4
  br i1 %exitcond125.not, label %for.end51, label %for.body29
...
for.body29:                                       ; preds = %for.body29.preheader, %for.cond26.loopexit
  ...
  %indvars.iv.next122 = add nuw nsw i64 %indvars.iv121, 1
  %cmp3297 = icmp ult i64 %indvars.iv.next122, %5
...
for.body33.lr.ph:                                 ; preds = %for.body29
  ...
  %7 = trunc i64 %indvars.iv121 to i32
  br label %for.body33
...
for.body33:                                       ; preds = %for.body33.lr.ph, %for.inc46
  ...
  %arrayidx37 = getelementptr inbounds double, ptr %8, i64 %indvars.iv116
  %9 = load double, ptr %arrayidx37, align 8
  %call38 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %hat2p, ptr noundef nonnull @.str.28, double noundef %9)
  %10 = trunc i64 %indvars.iv116 to i32
  %sub39 = sub nsw i32 %10, %7
  %rem = srem i32 %sub39, 12
  %cmp40 = icmp eq i32 %rem, 0
  %cmp42 = icmp eq i64 %indvars.iv116, %4
...
for.inc46:                                        ; preds = %for.body33, %if.then43
  %indvars.iv.next117 = add nuw nsw i64 %indvars.iv116, 1
  %exitcond120.not = icmp eq i64 %indvars.iv.next117, %wide.trip.count119
  br i1 %exitcond120.not, label %for.cond26.loopexit, label %for.body33
...
for.cond.loopexit:                                ; preds = %for.body3, %for.body
  ...
  br i1 %exitcond30.not, label %for.end10, label %for.body
...
for.inc:                                          ; preds = %for.body, %if.then
  ...
  br i1 %0, label %for.body, label %for.cond7.preheader

for.body20.preheader:                             ; preds = %for.cond7.preheader
  %1 = zext i32 %nseq to i64
  %2 = shl nuw nsw i64 %1, 3
  call void @llvm.memset.p0.i64(ptr align 8 %dis, i8 0, i64 %2, i1 false)
  br label %for.body20
...
if.then34:                                        ; preds = %if.end25
  ...
  store double %call.i65, ptr %arrayidx42, align 8
...
for.inc45:                                        ; preds = %if.end25, %if.then34
  ...
  br i1 %4, label %for.body20, label %for.end47
...
if.then:                                          ; preds = %for.body
  ...
  store double %conv, ptr %arrayidx12, align 8
...
entry:
  ...
  %call1231 = tail call i32 @feof(ptr noundef %fp) #31
  %tobool.not232 = icmp eq i32 %call1231, 0
  br i1 %tobool.not232, label %while.cond2.preheader.lr.ph, label %while.end180
...
while.cond2.preheader:                            ; preds = %while.cond2.preheader.lr.ph, %if.end179
  %count.0236 = phi i32 [ 0, %while.cond2.preheader.lr.ph ], [ %count.1, %if.end179 ]
  %scorepersite.0235 = phi double [ 0.000000e+00, %while.cond2.preheader.lr.ph ], [ %scorepersite.1, %if.end179 ]
  %sumscore.0234 = phi double [ 0.000000e+00, %while.cond2.preheader.lr.ph ], [ %sumscore.1, %if.end179 ]
  %sumlen.0233 = phi double [ 0.000000e+00, %while.cond2.preheader.lr.ph ], [ %add109, %if.end179 ]
...
lor.lhs.false:                                    ; preds = %while.body5
  %bcmp215 = call i32 @bcmp(ptr noundef nonnull dereferenceable(23) @.str.33, ptr noundef nonnull dereferenceable(23) %b, i64 23)
  %tobool11.not = icmp eq i32 %bcmp215, 0
  br i1 %tobool11.not, label %while.end, label %while.cond2

while.end:                                        ; preds = %while.body5, %lor.lhs.false, %while.cond2
  %bcmp216 = call i32 @bcmp(ptr noundef nonnull dereferenceable(19) @.str.32, ptr noundef nonnull dereferenceable(19) %b, i64 19)
  %tobool16.not = icmp eq i32 %bcmp216, 0
  br i1 %tobool16.not, label %if.then17, label %while.cond21.preheader

if.then17:                                        ; preds = %while.end
  %call.i = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr, ptr noundef null, i32 noundef 10) #31
  %conv.i = trunc i64 %call.i to i32
  %idxprom = sext i32 %count.0236 to i64
...
while.body25:                                     ; preds = %while.cond21
  %bcmp217 = call i32 @bcmp(ptr noundef nonnull dereferenceable(25) @.str.34, ptr noundef nonnull dereferenceable(25) %b, i64 25)
  %tobool28.not = icmp eq i32 %bcmp217, 0
  br i1 %tobool28.not, label %while.end31, label %while.cond21

while.end31:                                      ; preds = %while.body25, %while.cond21
  %call.i228 = call double @strtod(ptr nocapture noundef nonnull %add.ptr33, ptr noundef null) #31
  %add = fadd double %sumscore.0234, %call.i228
...
while.cond35:                                     ; preds = %while.body39, %while.end31
  ...
  br i1 %tobool38.not, label %while.cond49.preheader, label %while.body39

while.body39:                                     ; preds = %while.cond35
  %bcmp218 = call i32 @bcmp(ptr noundef nonnull dereferenceable(30) @.str.35, ptr noundef nonnull dereferenceable(30) %b, i64 30)
  %tobool42.not = icmp eq i32 %bcmp218, 0
  br i1 %tobool42.not, label %while.cond49.preheader, label %while.cond35

while.cond49.preheader:                           ; preds = %while.body39, %while.cond35
  br label %while.cond49

while.cond49:                                     ; preds = %while.cond49.preheader, %while.body53
  %call51 = call ptr @fgets(ptr noundef nonnull %b, i32 noundef 255, ptr noundef %fp)
  %tobool52.not = icmp eq ptr %call51, null
  br i1 %tobool52.not, label %while.cond64.preheader, label %while.body53

while.body53:                                     ; preds = %while.cond49
  %bcmp219 = call i32 @bcmp(ptr noundef nonnull dereferenceable(28) @.str.36, ptr noundef nonnull dereferenceable(28) %b, i64 28)
  %tobool56.not = icmp eq i32 %bcmp219, 0
  br i1 %tobool56.not, label %while.cond64.preheader, label %while.cond49

while.cond64.preheader:                           ; preds = %while.body53, %while.cond49
  br label %while.cond64

while.cond64:                                     ; preds = %while.cond64.preheader, %while.body68
  %call66 = call ptr @fgets(ptr noundef nonnull %b, i32 noundef 255, ptr noundef %fp)
  %tobool67.not = icmp eq ptr %call66, null
  br i1 %tobool67.not, label %while.cond79.preheader, label %while.body68

while.body68:                                     ; preds = %while.cond64
  %bcmp220 = call i32 @bcmp(ptr noundef nonnull dereferenceable(28) @.str.37, ptr noundef nonnull dereferenceable(28) %b, i64 28)
  %tobool71.not = icmp eq i32 %bcmp220, 0
  br i1 %tobool71.not, label %while.cond79.preheader, label %while.cond64

while.cond79.preheader:                           ; preds = %while.body68, %while.cond64
  br label %while.cond79

while.cond79:                                     ; preds = %while.cond79.preheader, %while.body83
  %call81 = call ptr @fgets(ptr noundef nonnull %b, i32 noundef 255, ptr noundef %fp)
  %tobool82.not = icmp eq ptr %call81, null
  br i1 %tobool82.not, label %while.cond94.preheader, label %while.body83

while.body83:                                     ; preds = %while.cond79
  %bcmp221 = call i32 @bcmp(ptr noundef nonnull dereferenceable(26) @.str.38, ptr noundef nonnull dereferenceable(26) %b, i64 26)
  %tobool86.not = icmp eq i32 %bcmp221, 0
  br i1 %tobool86.not, label %while.cond94.preheader, label %while.cond79

while.cond94.preheader:                           ; preds = %while.body83, %while.cond79
  br label %while.cond94

while.cond94:                                     ; preds = %while.cond94.preheader, %while.body98
...
while.body98:                                     ; preds = %while.cond94
  %bcmp222 = call i32 @bcmp(ptr noundef nonnull dereferenceable(29) @.str.39, ptr noundef nonnull dereferenceable(29) %b, i64 29)
  %tobool101.not = icmp eq i32 %bcmp222, 0
  br i1 %tobool101.not, label %while.end104, label %while.cond94

while.end104:                                     ; preds = %while.body98, %while.cond94
  %call.i229 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr106, ptr noundef null, i32 noundef 10) #31
  %conv.i230 = trunc i64 %call.i229 to i32
  %conv108 = sitofp i32 %conv.i230 to double
  %add109 = fadd double %sumlen.0233, %conv108
...
while.body113:                                    ; preds = %while.cond110
  %bcmp223 = call i32 @bcmp(ptr noundef nonnull dereferenceable(24) @.str.40, ptr noundef nonnull dereferenceable(24) @ReadBlastm7_avscore.al, i64 24)
  %tobool115.not = icmp eq i32 %bcmp223, 0
  br i1 %tobool115.not, label %while.end118, label %while.cond110
...
while.cond120:                                    ; preds = %while.cond120, %while.end118
  ...
  br i1 %cmp.not, label %while.end124, label %while.cond120
...
while.body128:                                    ; preds = %while.cond125
  %bcmp224 = call i32 @bcmp(ptr noundef nonnull dereferenceable(24) @.str.41, ptr noundef nonnull dereferenceable(24) @ReadBlastm7_avscore.al, i64 24)
  %tobool130.not = icmp eq i32 %bcmp224, 0
  br i1 %tobool130.not, label %while.end133, label %while.cond125
...
while.cond135:                                    ; preds = %while.cond135, %while.end133
  ...
  %1 = load i8, ptr %incdec.ptr136, align 1
  %cmp138.not = icmp eq i8 %1, 60
  br i1 %cmp138.not, label %while.end141, label %while.cond135

while.end141:                                     ; preds = %while.cond135
  store i8 0, ptr %incdec.ptr136, align 1
...
while.body146:                                    ; preds = %while.cond142
  %bcmp225 = call i32 @bcmp(ptr noundef nonnull dereferenceable(18) @.str.42, ptr noundef nonnull dereferenceable(18) %b, i64 18)
  %tobool149.not = icmp eq i32 %bcmp225, 0
  br i1 %tobool149.not, label %while.end152, label %while.cond142
...
if.end173:                                        ; preds = %if.then158
  ...
  br i1 %tobool176.not, label %while.end180.loopexit, label %if.end179

if.end179:                                        ; preds = %if.end173, %while.end152
  %sumscore.1 = phi double [ %add, %while.end152 ], [ 0.000000e+00, %if.end173 ]
  %scorepersite.1 = phi double [ %scorepersite.0235, %while.end152 ], [ %div, %if.end173 ]
  %count.1 = phi i32 [ %count.0236, %while.end152 ], [ %inc, %if.end173 ]
  %call1 = call i32 @feof(ptr noundef %fp) #31
  %tobool.not = icmp eq i32 %call1, 0
  br i1 %tobool.not, label %while.cond2.preheader, label %while.end180.loopexit

while.end180.loopexit:                            ; preds = %if.end173, %if.end179
  %scorepersite.2.ph = phi double [ %scorepersite.1, %if.end179 ], [ %div, %if.end173 ]
  %4 = fptosi double %scorepersite.2.ph to i32
  br label %while.end180

while.end180:                                     ; preds = %while.end180.loopexit, %entry
  %scorepersite.2 = phi i32 [ 0, %entry ], [ %4, %while.end180.loopexit ]
  call void @free(ptr noundef %call) #31
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %b) #31
  ret i32 %scorepersite.2
}
...
entry:
  ...
  %conv = sext i32 %nin to i64
  %call = tail call noalias ptr @calloc(i64 noundef %conv, i64 noundef 4) #28
  %call1213 = tail call i32 @feof(ptr noundef %fp) #31
  %tobool.not214 = icmp eq i32 %call1213, 0
  br i1 %tobool.not214, label %while.cond2.preheader.lr.ph, label %while.end171
...
while.cond2.preheader:                            ; preds = %while.cond2.preheader.lr.ph, %if.end170
  %count.0216 = phi i32 [ 0, %while.cond2.preheader.lr.ph ], [ %count.1, %if.end170 ]
  %sumscore.0215 = phi double [ 0.000000e+00, %while.cond2.preheader.lr.ph ], [ %sumscore.1, %if.end170 ]
  br label %while.cond2
...
lor.lhs.false:                                    ; preds = %while.body5
  %bcmp199 = call i32 @bcmp(ptr noundef nonnull dereferenceable(23) @.str.33, ptr noundef nonnull dereferenceable(23) %b, i64 23)
  %tobool11.not = icmp eq i32 %bcmp199, 0
  br i1 %tobool11.not, label %while.end, label %while.cond2

while.end:                                        ; preds = %while.body5, %lor.lhs.false, %while.cond2
  %bcmp200 = call i32 @bcmp(ptr noundef nonnull dereferenceable(19) @.str.32, ptr noundef nonnull dereferenceable(19) %b, i64 19)
  %tobool16.not = icmp eq i32 %bcmp200, 0
  br i1 %tobool16.not, label %if.then17, label %while.cond21.preheader

if.then17:                                        ; preds = %while.end
  %call.i = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr, ptr noundef null, i32 noundef 10) #31
  %conv.i = trunc i64 %call.i to i32
  %idxprom = sext i32 %count.0216 to i64
  %arrayidx = getelementptr inbounds i32, ptr %call, i64 %idxprom
  store i32 %conv.i, ptr %arrayidx, align 4
  br label %while.cond21.preheader
...
while.body25:                                     ; preds = %while.cond21
  %bcmp201 = call i32 @bcmp(ptr noundef nonnull dereferenceable(25) @.str.34, ptr noundef nonnull dereferenceable(25) %b, i64 25)
  %tobool28.not = icmp eq i32 %bcmp201, 0
  br i1 %tobool28.not, label %while.end31, label %while.cond21

while.end31:                                      ; preds = %while.body25, %while.cond21
  %call.i212 = call double @strtod(ptr nocapture noundef nonnull %add.ptr33, ptr noundef null) #31
  %add = fadd double %sumscore.0215, %call.i212
  br label %while.cond35
...
while.body39:                                     ; preds = %while.cond35
  %bcmp202 = call i32 @bcmp(ptr noundef nonnull dereferenceable(30) @.str.35, ptr noundef nonnull dereferenceable(30) %b, i64 30)
  %tobool42.not = icmp eq i32 %bcmp202, 0
  br i1 %tobool42.not, label %while.cond49.preheader, label %while.cond35
...
while.body53:                                     ; preds = %while.cond49
  %bcmp203 = call i32 @bcmp(ptr noundef nonnull dereferenceable(28) @.str.36, ptr noundef nonnull dereferenceable(28) %b, i64 28)
  %tobool56.not = icmp eq i32 %bcmp203, 0
  br i1 %tobool56.not, label %while.cond64.preheader, label %while.cond49
...
while.body68:                                     ; preds = %while.cond64
  %bcmp204 = call i32 @bcmp(ptr noundef nonnull dereferenceable(28) @.str.37, ptr noundef nonnull dereferenceable(28) %b, i64 28)
  %tobool71.not = icmp eq i32 %bcmp204, 0
  br i1 %tobool71.not, label %while.cond79.preheader, label %while.cond64
...
while.body83:                                     ; preds = %while.cond79
  %bcmp205 = call i32 @bcmp(ptr noundef nonnull dereferenceable(26) @.str.38, ptr noundef nonnull dereferenceable(26) %b, i64 26)
  %tobool86.not = icmp eq i32 %bcmp205, 0
  br i1 %tobool86.not, label %while.cond94.preheader, label %while.cond79
...
while.body98:                                     ; preds = %while.cond94
  %bcmp206 = call i32 @bcmp(ptr noundef nonnull dereferenceable(29) @.str.39, ptr noundef nonnull dereferenceable(29) %b, i64 29)
  %tobool101.not = icmp eq i32 %bcmp206, 0
  br i1 %tobool101.not, label %while.cond108.preheader, label %while.cond94
...
while.body111:                                    ; preds = %while.cond108
  %bcmp207 = call i32 @bcmp(ptr noundef nonnull dereferenceable(24) @.str.40, ptr noundef nonnull dereferenceable(24) @ReadBlastm7_scoreonly.al, i64 24)
  %tobool113.not = icmp eq i32 %bcmp207, 0
  br i1 %tobool113.not, label %while.end116, label %while.cond108
...
while.cond118:                                    ; preds = %while.cond118, %while.end116
  ...
  %0 = load i8, ptr %incdec.ptr, align 1
  %cmp.not = icmp eq i8 %0, 60
  br i1 %cmp.not, label %while.end122, label %while.cond118
...
while.body126:                                    ; preds = %while.cond123
  %bcmp208 = call i32 @bcmp(ptr noundef nonnull dereferenceable(24) @.str.41, ptr noundef nonnull dereferenceable(24) @ReadBlastm7_scoreonly.al, i64 24)
  %tobool128.not = icmp eq i32 %bcmp208, 0
  br i1 %tobool128.not, label %while.end131, label %while.cond123
...
while.cond133:                                    ; preds = %while.cond133, %while.end131
  ...
  %1 = load i8, ptr %incdec.ptr134, align 1
  %cmp136.not = icmp eq i8 %1, 60
  br i1 %cmp136.not, label %while.end139, label %while.cond133

while.end139:                                     ; preds = %while.cond133
  store i8 0, ptr %incdec.ptr134, align 1
...
while.body144:                                    ; preds = %while.cond140
  %bcmp209 = call i32 @bcmp(ptr noundef nonnull dereferenceable(18) @.str.42, ptr noundef nonnull dereferenceable(18) %b, i64 18)
  %tobool147.not = icmp eq i32 %bcmp209, 0
  br i1 %tobool147.not, label %while.end150, label %while.cond140
...
while.end150:                                     ; preds = %while.body144, %while.cond140
  ...
  %bcmp210 = call i32 @bcmp(ptr noundef nonnull dereferenceable(21) @.str.43, ptr noundef nonnull dereferenceable(21) %b, i64 21)
  %tobool155.not = icmp eq i32 %bcmp210, 0
  br i1 %tobool155.not, label %if.then156, label %if.end170

if.then156:                                       ; preds = %while.end150
  %inc = add nsw i32 %count.0216, 1
  %idxprom157 = sext i32 %count.0216 to i64
  %arrayidx158 = getelementptr inbounds i32, ptr %call, i64 %idxprom157
  %2 = load i32, ptr %arrayidx158, align 4
  %idxprom159 = sext i32 %2 to i64
  %arrayidx160 = getelementptr inbounds double, ptr %dis, i64 %idxprom159
  store double %add, ptr %arrayidx160, align 8
  %call162 = call ptr @fgets(ptr noundef nonnull %b, i32 noundef 255, ptr noundef %fp)
  %call164 = call ptr @fgets(ptr noundef nonnull %b, i32 noundef 255, ptr noundef %fp)
  %bcmp211 = call i32 @bcmp(ptr noundef nonnull dereferenceable(23) @.str.45, ptr noundef nonnull dereferenceable(23) %b, i64 23)
  %tobool167.not = icmp eq i32 %bcmp211, 0
...
if.end170:                                        ; preds = %if.then156, %while.end150
  ...
  %count.1 = phi i32 [ %count.0216, %while.end150 ], [ %inc, %if.then156 ]
  %call1 = call i32 @feof(ptr noundef %fp) #31
  %tobool.not = icmp eq i32 %call1, 0
...
entry:
  %b = alloca [256 x i8], align 16
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %b) #31
  %call225 = tail call i32 @feof(ptr noundef %fp) #31
  %tobool.not226 = icmp eq i32 %call225, 0
  br i1 %tobool.not226, label %while.cond1.preheader.lr.ph, label %while.end175
...
while.cond1.preheader:                            ; preds = %while.cond1.preheader.lr.ph, %if.end174
  %nlocalhom.0229 = phi i32 [ 0, %while.cond1.preheader.lr.ph ], [ %add143, %if.end174 ]
  %count.0228 = phi i32 [ 0, %while.cond1.preheader.lr.ph ], [ %count.1, %if.end174 ]
  %sumscore.0227 = phi double [ 0.000000e+00, %while.cond1.preheader.lr.ph ], [ %sumscore.1, %if.end174 ]
...
lor.lhs.false:                                    ; preds = %while.body4
  %bcmp204 = call i32 @bcmp(ptr noundef nonnull dereferenceable(23) @.str.33, ptr noundef nonnull dereferenceable(23) %b, i64 23)
  %tobool10.not = icmp eq i32 %bcmp204, 0
  br i1 %tobool10.not, label %while.end, label %while.cond1

while.end:                                        ; preds = %while.body4, %lor.lhs.false, %while.cond1
  %bcmp205 = call i32 @bcmp(ptr noundef nonnull dereferenceable(19) @.str.32, ptr noundef nonnull dereferenceable(19) %b, i64 19)
  %tobool15.not = icmp eq i32 %bcmp205, 0
  br i1 %tobool15.not, label %if.then16, label %if.end19

if.then16:                                        ; preds = %while.end
  %call.i = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr, ptr noundef null, i32 noundef 10) #31
  %conv.i = trunc i64 %call.i to i32
  %idxprom = sext i32 %count.0228 to i64
  %arrayidx = getelementptr inbounds [50000 x i32], ptr @ReadBlastm7.junban, i64 0, i64 %idxprom
  store i32 %conv.i, ptr %arrayidx, align 4
  br label %if.end19

if.end19:                                         ; preds = %if.then16, %while.end
  %nlocalhom.1 = phi i32 [ %nlocalhom.0229, %while.end ], [ 0, %if.then16 ]
...
while.body24:                                     ; preds = %while.cond20
  %bcmp206 = call i32 @bcmp(ptr noundef nonnull dereferenceable(25) @.str.34, ptr noundef nonnull dereferenceable(25) %b, i64 25)
  %tobool27.not = icmp eq i32 %bcmp206, 0
  br i1 %tobool27.not, label %while.end30, label %while.cond20

while.end30:                                      ; preds = %while.body24, %while.cond20
  %call.i217 = call double @strtod(ptr nocapture noundef nonnull %add.ptr32, ptr noundef null) #31
  %add = fadd double %sumscore.0227, %call.i217
...
while.body38:                                     ; preds = %while.cond34
  %bcmp207 = call i32 @bcmp(ptr noundef nonnull dereferenceable(30) @.str.35, ptr noundef nonnull dereferenceable(30) %b, i64 30)
  %tobool41.not = icmp eq i32 %bcmp207, 0
  br i1 %tobool41.not, label %while.end44, label %while.cond34

while.end44:                                      ; preds = %while.body38, %while.cond34
  %call.i218 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr46, ptr noundef null, i32 noundef 10) #31
  %conv.i219 = trunc i64 %call.i218 to i32
  %sub = add nsw i32 %conv.i219, -1
...
while.cond48:                                     ; preds = %while.body52, %while.end44
  ...
  br i1 %tobool51.not, label %while.cond63.preheader, label %while.body52

while.body52:                                     ; preds = %while.cond48
  %bcmp208 = call i32 @bcmp(ptr noundef nonnull dereferenceable(28) @.str.36, ptr noundef nonnull dereferenceable(28) %b, i64 28)
  %tobool55.not = icmp eq i32 %bcmp208, 0
  br i1 %tobool55.not, label %while.cond63.preheader, label %while.cond48

while.cond63.preheader:                           ; preds = %while.body52, %while.cond48
  br label %while.cond63

while.cond63:                                     ; preds = %while.cond63.preheader, %while.body67
...
while.body67:                                     ; preds = %while.cond63
  %bcmp209 = call i32 @bcmp(ptr noundef nonnull dereferenceable(28) @.str.37, ptr noundef nonnull dereferenceable(28) %b, i64 28)
  %tobool70.not = icmp eq i32 %bcmp209, 0
  br i1 %tobool70.not, label %while.end73, label %while.cond63

while.end73:                                      ; preds = %while.body67, %while.cond63
  %call.i220 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr60, ptr noundef null, i32 noundef 10) #31
  %conv.i221 = trunc i64 %call.i220 to i32
  %sub77 = add nsw i32 %conv.i221, -1
...
while.cond78:                                     ; preds = %while.body82, %while.end73
  ...
  br i1 %tobool81.not, label %while.cond93.preheader, label %while.body82

while.body82:                                     ; preds = %while.cond78
  %bcmp210 = call i32 @bcmp(ptr noundef nonnull dereferenceable(26) @.str.38, ptr noundef nonnull dereferenceable(26) %b, i64 26)
  %tobool85.not = icmp eq i32 %bcmp210, 0
  br i1 %tobool85.not, label %while.cond93.preheader, label %while.cond78

while.cond93.preheader:                           ; preds = %while.body82, %while.cond78
  br label %while.cond93

while.cond93:                                     ; preds = %while.cond93.preheader, %while.body97
...
while.body97:                                     ; preds = %while.cond93
  %bcmp211 = call i32 @bcmp(ptr noundef nonnull dereferenceable(29) @.str.39, ptr noundef nonnull dereferenceable(29) %b, i64 29)
  %tobool100.not = icmp eq i32 %bcmp211, 0
  br i1 %tobool100.not, label %while.end103, label %while.cond93

while.end103:                                     ; preds = %while.body97, %while.cond93
  %call.i222 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr105, ptr noundef null, i32 noundef 10) #31
...
while.body110:                                    ; preds = %while.cond107
  %bcmp212 = call i32 @bcmp(ptr noundef nonnull dereferenceable(24) @.str.40, ptr noundef nonnull dereferenceable(24) @ReadBlastm7.al, i64 24)
  %tobool112.not = icmp eq i32 %bcmp212, 0
  br i1 %tobool112.not, label %while.end115, label %while.cond107
...
while.cond117:                                    ; preds = %while.cond117, %while.end115
  ...
  %0 = load i8, ptr %incdec.ptr, align 1
  %cmp.not = icmp eq i8 %0, 60
  br i1 %cmp.not, label %while.end120, label %while.cond117
...
while.body124:                                    ; preds = %while.cond121
  %bcmp213 = call i32 @bcmp(ptr noundef nonnull dereferenceable(24) @.str.41, ptr noundef nonnull dereferenceable(24) @ReadBlastm7.al, i64 24)
  %tobool126.not = icmp eq i32 %bcmp213, 0
  br i1 %tobool126.not, label %while.end129, label %while.cond121
...
while.cond131:                                    ; preds = %while.cond131, %while.end129
  ...
  %1 = load i8, ptr %incdec.ptr132, align 1
  %cmp134.not = icmp eq i8 %1, 60
  br i1 %cmp134.not, label %while.end137, label %while.cond131

while.end137:                                     ; preds = %while.cond131
  store i8 0, ptr %incdec.ptr132, align 1
  %idxprom138 = sext i32 %count.0228 to i64
  %arrayidx139 = getelementptr inbounds [50000 x i32], ptr @ReadBlastm7.junban, i64 0, i64 %idxprom138
  %2 = load i32, ptr %arrayidx139, align 4
  %idx.ext = sext i32 %2 to i64
  %add.ptr140 = getelementptr inbounds %struct._LocalHom, ptr %localhomlist, i64 %idx.ext
  %3 = load ptr, ptr @stderr, align 8
  %call.i224 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %3, ptr noundef nonnull @.str.104, ptr noundef nonnull @ReadBlastm7.qal, ptr noundef nonnull @ReadBlastm7.tal) #27
...
while.body.i:                                     ; preds = %while.cond.preheader.i, %while.body.i
  ...
  %localhompt.addr.05.i = phi ptr [ %4, %while.body.i ], [ %add.ptr140, %while.cond.preheader.i ]
...
while.end.i:                                      ; preds = %while.body.i, %while.cond.preheader.i
  ...
  store ptr %call1.i, ptr %next2.i, align 8
...
if.end.i:                                         ; preds = %while.end.i, %while.end137
  ...
  %6 = load i8, ptr @ReadBlastm7.qal, align 16
  %cmp6.not7.i = icmp eq i8 %6, 0
  br i1 %cmp6.not7.i, label %if.end87.i, label %while.body8.i

while.body8.i:                                    ; preds = %if.end.i, %if.end64.i
  %start2.0.neg22.i = phi i32 [ %start2.0.neg.i, %if.end64.i ], [ 0, %if.end.i ]
  %nlocalhom.021.i = phi i32 [ %nlocalhom.1.i, %if.end64.i ], [ 0, %if.end.i ]
  %st.020.i = phi i32 [ %st.2.i, %if.end64.i ], [ 0, %if.end.i ]
  %tmppt.019.i = phi ptr [ %tmppt.2.i, %if.end64.i ], [ %localhompt.addr.1.i, %if.end.i ]
  %sumoverlap.018.i = phi i32 [ %sumoverlap.1.i, %if.end64.i ], [ 0, %if.end.i ]
  %sumscore.017.i = phi double [ %sumscore.1.i, %if.end64.i ], [ 0.000000e+00, %if.end.i ]
  %score.016.i = phi double [ %score.1.i, %if.end64.i ], [ 0.000000e+00, %if.end.i ]
  %pt2.014.i = phi ptr [ %incdec.ptr71.i, %if.end64.i ], [ @ReadBlastm7.tal, %if.end.i ]
  %pt1.013.i = phi ptr [ %incdec.ptr.i, %if.end64.i ], [ @ReadBlastm7.qal, %if.end.i ]
  %start2.012.i = phi i32 [ %start2.2.i, %if.end64.i ], [ 0, %if.end.i ]
  %start1.011.i = phi i32 [ %start1.2.i, %if.end64.i ], [ 0, %if.end.i ]
  %pos2.09.i = phi i32 [ %pos2.1.i, %if.end64.i ], [ %sub77, %if.end.i ]
  %pos1.08.i = phi i32 [ %spec.select178.i, %if.end64.i ], [ %sub, %if.end.i ]
  %7 = load ptr, ptr @stderr, align 8
  %8 = call i64 @fwrite(ptr nonnull @.str.106, i64 17, i64 1, ptr %7) #27
  %9 = load ptr, ptr @stderr, align 8
  %10 = load i8, ptr %pt1.013.i, align 1
  %conv10.i = sext i8 %10 to i32
  %11 = load i8, ptr %pt2.014.i, align 1
  %conv11.i = sext i8 %11 to i32
  %call12.i = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %9, ptr noundef nonnull @.str.107, i32 noundef %conv10.i, i32 noundef %conv11.i, i32 noundef %st.020.i) #27
  %cmp13.i = icmp eq i32 %st.020.i, 1
  %12 = load i8, ptr %pt1.013.i, align 1
...
lor.lhs.false.i:                                  ; preds = %land.lhs.true.i
  %13 = load i8, ptr %pt2.014.i, align 1
...
if.then21.i:                                      ; preds = %lor.lhs.false.i, %land.lhs.true.i
  ...
  %inc.i = add nsw i32 %nlocalhom.021.i, 1
  %cmp23.i = icmp sgt i32 %nlocalhom.021.i, 0
...
if.then25.i:                                      ; preds = %if.then21.i
  ...
  %next27.i = getelementptr inbounds %struct._LocalHom, ptr %tmppt.019.i, i64 0, i32 1
  store ptr %call26.i, ptr %next27.i, align 8
  %next29.i = getelementptr inbounds %struct._LocalHom, ptr %call26.i, i64 0, i32 1
  store ptr null, ptr %next29.i, align 8
  br label %if.end30.i

if.end30.i:                                       ; preds = %if.then25.i, %if.then21.i
  %tmppt.1.i = phi ptr [ %call26.i, %if.then25.i ], [ %tmppt.019.i, %if.then21.i ]
  %start131.i = getelementptr inbounds %struct._LocalHom, ptr %tmppt.1.i, i64 0, i32 3
  store i32 %start1.011.i, ptr %start131.i, align 8
  %start232.i = getelementptr inbounds %struct._LocalHom, ptr %tmppt.1.i, i64 0, i32 5
  store i32 %start2.012.i, ptr %start232.i, align 8
  %end133.i = getelementptr inbounds %struct._LocalHom, ptr %tmppt.1.i, i64 0, i32 4
  store i32 %sub.i, ptr %end133.i, align 4
  %end234.i = getelementptr inbounds %struct._LocalHom, ptr %tmppt.1.i, i64 0, i32 6
  store i32 %sub22.i, ptr %end234.i, align 4
  %add.i = fadd double %sumscore.017.i, %score.016.i
  %add36.i = add i32 %sumoverlap.018.i, %start2.0.neg22.i
  %add37.i = add i32 %add36.i, %pos2.09.i
  %14 = load ptr, ptr @stderr, align 8
  %call38.i = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %14, ptr noundef nonnull @.str.108, double noundef %score.016.i) #27
  %15 = load ptr, ptr @stderr, align 8
  %call39.i = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %15, ptr noundef nonnull @.str.109, i32 noundef %start1.011.i, i32 noundef %sub.i) #27
  %16 = load ptr, ptr @stderr, align 8
  %call40.i = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %16, ptr noundef nonnull @.str.110, i32 noundef %start2.012.i, i32 noundef %sub22.i) #27
  %.pre.i = load i8, ptr %pt1.013.i, align 1
  %.pre36.i = load i8, ptr %pt2.014.i, align 1
  br label %if.end64.i

if.else.i:                                        ; preds = %while.body8.i
  %.pre37.i = load i8, ptr %pt2.014.i, align 1
  br i1 %cmp16.i, label %if.end64.i, label %land.lhs.true44.i

land.lhs.true44.i:                                ; preds = %if.else.i
  %cmp46.not.i = icmp eq i8 %.pre37.i, 45
  br i1 %cmp46.not.i, label %if.end64.i, label %if.then48.i

if.then48.i:                                      ; preds = %land.lhs.true44.i, %lor.lhs.false.i
  %17 = phi i8 [ %.pre37.i, %land.lhs.true44.i ], [ %13, %lor.lhs.false.i ]
  %cmp49.i = icmp eq i32 %st.020.i, 0
  %spec.select.i = select i1 %cmp49.i, i32 %pos1.08.i, i32 %start1.011.i
  %spec.select177.i = select i1 %cmp49.i, i32 %pos2.09.i, i32 %start2.012.i
  ...
  %20 = load i32, ptr %arrayidx60.i, align 4
  %conv61.i = sitofp i32 %20 to double
  %add62.i = fadd double %score.016.i, %conv61.i
  br label %if.end64.i

if.end64.i:                                       ; preds = %if.then48.i, %land.lhs.true44.i, %if.else.i, %if.end30.i
  %21 = phi i8 [ %.pre36.i, %if.end30.i ], [ %17, %if.then48.i ], [ 45, %land.lhs.true44.i ], [ %.pre37.i, %if.else.i ]
  %22 = phi i8 [ %.pre.i, %if.end30.i ], [ %12, %if.then48.i ], [ %12, %land.lhs.true44.i ], [ 45, %if.else.i ]
  %start1.2.i = phi i32 [ %start1.011.i, %if.end30.i ], [ %spec.select.i, %if.then48.i ], [ %start1.011.i, %land.lhs.true44.i ], [ %start1.011.i, %if.else.i ]
  %start2.2.i = phi i32 [ %start2.012.i, %if.end30.i ], [ %spec.select177.i, %if.then48.i ], [ %start2.012.i, %land.lhs.true44.i ], [ %start2.012.i, %if.else.i ]
  %score.1.i = phi double [ 0.000000e+00, %if.end30.i ], [ %add62.i, %if.then48.i ], [ %score.016.i, %land.lhs.true44.i ], [ %score.016.i, %if.else.i ]
  %sumscore.1.i = phi double [ %add.i, %if.end30.i ], [ %sumscore.017.i, %if.then48.i ], [ %sumscore.017.i, %land.lhs.true44.i ], [ %sumscore.017.i, %if.else.i ]
  %sumoverlap.1.i = phi i32 [ %add37.i, %if.end30.i ], [ %sumoverlap.018.i, %if.then48.i ], [ %sumoverlap.018.i, %land.lhs.true44.i ], [ %sumoverlap.018.i, %if.else.i ]
  %tmppt.2.i = phi ptr [ %tmppt.1.i, %if.end30.i ], [ %tmppt.019.i, %if.then48.i ], [ %tmppt.019.i, %land.lhs.true44.i ], [ %tmppt.019.i, %if.else.i ]
  %st.2.i = phi i32 [ 0, %if.end30.i ], [ 1, %if.then48.i ], [ %st.020.i, %land.lhs.true44.i ], [ %st.020.i, %if.else.i ]
  %nlocalhom.1.i = phi i32 [ %inc.i, %if.end30.i ], [ %nlocalhom.021.i, %if.then48.i ], [ %nlocalhom.021.i, %land.lhs.true44.i ], [ %nlocalhom.021.i, %if.else.i ]
  %incdec.ptr.i = getelementptr inbounds i8, ptr %pt1.013.i, i64 1
  %cmp66.not.i = icmp ne i8 %22, 45
  %inc69.i = zext i1 %cmp66.not.i to i32
  %spec.select178.i = add nsw i32 %pos1.08.i, %inc69.i
  %incdec.ptr71.i = getelementptr inbounds i8, ptr %pt2.014.i, i64 1
  %cmp73.not.i = icmp ne i8 %21, 45
  ...
  br i1 %cmp6.not.i, label %while.end78.i, label %while.body8.i
...
if.then82.i:                                      ; preds = %while.end78.i
  ...
  store ptr %call83.i, ptr %next84.i, align 8
  %next86.i = getelementptr inbounds %struct._LocalHom, ptr %call83.i, i64 0, i32 1
  store ptr null, ptr %next86.i, align 8
  br label %if.end87.i

if.end87.i:                                       ; preds = %if.then82.i, %while.end78.i, %if.end.i
  %start2.0.neg.lcssa57.i = phi i32 [ %start2.0.neg.i, %if.then82.i ], [ %start2.0.neg.i, %while.end78.i ], [ 0, %if.end.i ]
  %nlocalhom.0.lcssa56.i = phi i32 [ %nlocalhom.1.i, %if.then82.i ], [ %nlocalhom.1.i, %while.end78.i ], [ 0, %if.end.i ]
  %sumoverlap.0.lcssa55.i = phi i32 [ %sumoverlap.1.i, %if.then82.i ], [ %sumoverlap.1.i, %while.end78.i ], [ 0, %if.end.i ]
  %sumscore.0.lcssa54.i = phi double [ %sumscore.1.i, %if.then82.i ], [ %sumscore.1.i, %while.end78.i ], [ 0.000000e+00, %if.end.i ]
  %score.0.lcssa53.i = phi double [ %score.1.i, %if.then82.i ], [ %score.1.i, %while.end78.i ], [ 0.000000e+00, %if.end.i ]
  %start2.0.lcssa52.i = phi i32 [ %start2.2.i, %if.then82.i ], [ %start2.2.i, %while.end78.i ], [ 0, %if.end.i ]
  %start1.0.lcssa51.i = phi i32 [ %start1.2.i, %if.then82.i ], [ %start1.2.i, %while.end78.i ], [ 0, %if.end.i ]
  %pos2.0.lcssa50.i = phi i32 [ %pos2.1.i, %if.then82.i ], [ %pos2.1.i, %while.end78.i ], [ %sub77, %if.end.i ]
  %pos1.0.lcssa49.i = phi i32 [ %spec.select178.i, %if.then82.i ], [ %spec.select178.i, %while.end78.i ], [ %sub, %if.end.i ]
  %tmppt.3.i = phi ptr [ %call83.i, %if.then82.i ], [ %tmppt.2.i, %while.end78.i ], [ %localhompt.addr.1.i, %if.end.i ]
  %sub88.i = add nsw i32 %pos1.0.lcssa49.i, -1
  %sub89.i = add nsw i32 %pos2.0.lcssa50.i, -1
  %start190.i = getelementptr inbounds %struct._LocalHom, ptr %tmppt.3.i, i64 0, i32 3
  store i32 %start1.0.lcssa51.i, ptr %start190.i, align 8
  %start291.i = getelementptr inbounds %struct._LocalHom, ptr %tmppt.3.i, i64 0, i32 5
  store i32 %start2.0.lcssa52.i, ptr %start291.i, align 8
  %end192.i = getelementptr inbounds %struct._LocalHom, ptr %tmppt.3.i, i64 0, i32 4
  store i32 %sub88.i, ptr %end192.i, align 4
  %end293.i = getelementptr inbounds %struct._LocalHom, ptr %tmppt.3.i, i64 0, i32 6
  store i32 %sub89.i, ptr %end293.i, align 4
  %add96.i = add i32 %sumoverlap.0.lcssa55.i, %start2.0.neg.lcssa57.i
  %add97.i = add i32 %add96.i, %pos2.0.lcssa50.i
  %24 = load ptr, ptr @stderr, align 8
  %call98.i = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %24, ptr noundef nonnull @.str.111, double noundef %score.0.lcssa53.i) #27
  %25 = load ptr, ptr @stderr, align 8
  %call99.i = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %25, ptr noundef nonnull @.str.109, i32 noundef %start1.0.lcssa51.i, i32 noundef %sub88.i) #27
  %26 = load ptr, ptr @stderr, align 8
  %call100.i = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %26, ptr noundef nonnull @.str.110, i32 noundef %start2.0.lcssa52.i, i32 noundef %sub89.i) #27
  %tobool101.not33.i = icmp eq ptr %localhompt.addr.1.i, null
  br i1 %tobool101.not33.i, label %addlocalhom_r.exit, label %for.body.lr.ph.i

for.body.lr.ph.i:                                 ; preds = %if.end87.i
  %add94.i = fadd double %sumscore.0.lcssa54.i, %score.0.lcssa53.i
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  %tmppt.434.i = phi ptr [ %localhompt.addr.1.i, %for.body.lr.ph.i ], [ %27, %for.body.i ]
  %overlapaa102.i = getelementptr inbounds %struct._LocalHom, ptr %tmppt.434.i, i64 0, i32 8
  store i32 %add97.i, ptr %overlapaa102.i, align 8
  %opt105.i = getelementptr inbounds %struct._LocalHom, ptr %tmppt.434.i, i64 0, i32 7
  store double %div104.i, ptr %opt105.i, align 8
  %next106.i = getelementptr inbounds %struct._LocalHom, ptr %tmppt.434.i, i64 0, i32 1
  %27 = load ptr, ptr %next106.i, align 8
  %tobool101.not.i = icmp eq ptr %27, null
  br i1 %tobool101.not.i, label %addlocalhom_r.exit, label %for.body.i

addlocalhom_r.exit:                               ; preds = %for.body.i, %if.end87.i
  %inc79.i = add i32 %nlocalhom.1, 1
  %add143 = add i32 %inc79.i, %nlocalhom.0.lcssa56.i
...
while.body148:                                    ; preds = %while.cond144
  %bcmp214 = call i32 @bcmp(ptr noundef nonnull dereferenceable(18) @.str.42, ptr noundef nonnull dereferenceable(18) %b, i64 18)
  %tobool151.not = icmp eq i32 %bcmp214, 0
  br i1 %tobool151.not, label %while.end154, label %while.cond144
...
while.end154:                                     ; preds = %while.body148, %while.cond144
  ...
  %bcmp215 = call i32 @bcmp(ptr noundef nonnull dereferenceable(21) @.str.43, ptr noundef nonnull dereferenceable(21) %b, i64 21)
  %tobool159.not = icmp eq i32 %bcmp215, 0
  br i1 %tobool159.not, label %if.then160, label %if.end174

if.then160:                                       ; preds = %while.end154
  %inc = add nsw i32 %count.0228, 1
  %28 = load i32, ptr %arrayidx139, align 4
  %idxprom163 = sext i32 %28 to i64
  %arrayidx164 = getelementptr inbounds double, ptr %dis, i64 %idxprom163
  store double %add, ptr %arrayidx164, align 8
  %call166 = call ptr @fgets(ptr noundef nonnull %b, i32 noundef 255, ptr noundef %fp)
  %call168 = call ptr @fgets(ptr noundef nonnull %b, i32 noundef 255, ptr noundef %fp)
  %bcmp216 = call i32 @bcmp(ptr noundef nonnull dereferenceable(23) @.str.45, ptr noundef nonnull dereferenceable(23) %b, i64 23)
  %tobool171.not = icmp eq i32 %bcmp216, 0
...
if.end174:                                        ; preds = %if.then160, %while.end154
  ...
  %count.1 = phi i32 [ %count.0228, %while.end154 ], [ %inc, %if.then160 ]
...
if.then:                                          ; preds = %while.body
  ...
  store double %conv, ptr %arrayidx14, align 8
...
if.end:                                           ; preds = %if.then
  ...
  store double %conv, ptr %arrayidx18, align 8
...
if.else:                                          ; preds = %while.body
  ...
  br i1 %cmp, label %while.end, label %while.cond.outer
...
while.cond28.outer:                               ; preds = %while.cond28.preheader, %cutal.exit343
  %indvars.iv = phi i64 [ 0, %while.cond28.preheader ], [ %indvars.iv.next, %cutal.exit343 ]
  br label %while.cond28

while.cond28:                                     ; preds = %while.cond28.outer, %if.then33
  %bcmp293 = call i32 @bcmp(ptr noundef nonnull dereferenceable(14) @.str.47, ptr noundef nonnull dereferenceable(14) %b, i64 14)
  %tobool32.not = icmp eq i32 %bcmp293, 0
...
if.end40:                                         ; preds = %while.cond28
  %call.i310 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr42, ptr noundef null, i32 noundef 10) #31
  %conv.i311 = trunc i64 %call.i310 to i32
  %indvars.iv.next = add nuw i64 %indvars.iv, 1
  %arrayidx46 = getelementptr inbounds [50000 x i32], ptr @ReadFasta34m10_nuc.junban, i64 0, i64 %indvars.iv
  store i32 %conv.i311, ptr %arrayidx46, align 4
...
while.body51:                                     ; preds = %while.cond47
  %bcmp294 = call i32 @bcmp(ptr noundef nonnull dereferenceable(9) @.str.48, ptr noundef nonnull dereferenceable(9) %b, i64 9)
  %tobool54.not = icmp eq i32 %bcmp294, 0
  br i1 %tobool54.not, label %while.end60, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %while.body51
  %bcmp295 = call i32 @bcmp(ptr noundef nonnull dereferenceable(13) @.str.49, ptr noundef nonnull dereferenceable(13) %b, i64 13)
  %tobool57.not = icmp eq i32 %bcmp295, 0
  br i1 %tobool57.not, label %while.end60, label %while.cond47
...
while.end60:                                      ; preds = %while.body51, %lor.lhs.false, %while.cond47
  ...
  %call.i312 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr63, ptr noundef null, i32 noundef 10) #31
  %conv.i313 = trunc i64 %call.i312 to i32
  store i32 %conv.i313, ptr %opt, align 4
...
while.body69:                                     ; preds = %while.cond65
  %bcmp296 = call i32 @bcmp(ptr noundef nonnull dereferenceable(9) @.str.51, ptr noundef nonnull dereferenceable(9) %add.ptr71, i64 9)
  %tobool73.not = icmp eq i32 %bcmp296, 0
  br i1 %tobool73.not, label %while.end76, label %while.cond65

while.end76:                                      ; preds = %while.body69, %while.cond65
  %strchr297 = call ptr @strchr(ptr nonnull dereferenceable(1) %b, i32 58)
  %add.ptr79 = getelementptr inbounds i8, ptr %strchr297, i64 1
  %call.i314 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr79, ptr noundef null, i32 noundef 10) #31
...
while.body85:                                     ; preds = %while.cond81
  %bcmp298 = call i32 @bcmp(ptr noundef nonnull dereferenceable(7) @.str.52, ptr noundef nonnull dereferenceable(7) %add.ptr71, i64 7)
  %tobool89.not = icmp eq i32 %bcmp298, 0
  br i1 %tobool89.not, label %while.end92, label %while.cond81

while.end92:                                      ; preds = %while.body85, %while.cond81
  %strchr299 = call ptr @strchr(ptr nonnull dereferenceable(1) %b, i32 58)
  %add.ptr95 = getelementptr inbounds i8, ptr %strchr299, i64 1
  %call.i316 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr95, ptr noundef null, i32 noundef 10) #31
  %conv.i317 = trunc i64 %call.i316 to i32
  %sub = add nsw i32 %conv.i317, -1
...
while.body101:                                    ; preds = %while.cond97
  %bcmp300 = call i32 @bcmp(ptr noundef nonnull dereferenceable(6) @.str.53, ptr noundef nonnull dereferenceable(6) %add.ptr71, i64 6)
  %tobool105.not = icmp eq i32 %bcmp300, 0
  br i1 %tobool105.not, label %while.end108, label %while.cond97

while.end108:                                     ; preds = %while.body101, %while.cond97
  %strchr301 = call ptr @strchr(ptr nonnull dereferenceable(1) %b, i32 58)
  %add.ptr111 = getelementptr inbounds i8, ptr %strchr301, i64 1
  %call.i318 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr111, ptr noundef null, i32 noundef 10) #31
  %conv.i319 = trunc i64 %call.i318 to i32
  %sub113 = add nsw i32 %conv.i319, -1
...
while.body118:                                    ; preds = %while.cond114
  %bcmp302 = call i32 @bcmp(ptr noundef nonnull dereferenceable(15) @.str.54, ptr noundef nonnull dereferenceable(15) %add.ptr71, i64 15)
  %tobool122.not = icmp eq i32 %bcmp302, 0
  br i1 %tobool122.not, label %while.end125, label %while.cond114

while.end125:                                     ; preds = %while.body118, %while.cond114
  %strchr303 = call ptr @strchr(ptr nonnull dereferenceable(1) %b, i32 58)
  %add.ptr128 = getelementptr inbounds i8, ptr %strchr303, i64 1
  %call.i320 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr128, ptr noundef null, i32 noundef 10) #31
  %conv.i321 = trunc i64 %call.i320 to i32
  %sub130 = add nsw i32 %conv.i321, -1
...
while.body156:                                    ; preds = %while.cond152
  %bcmp304 = call i32 @bcmp(ptr noundef nonnull dereferenceable(7) @.str.52, ptr noundef nonnull dereferenceable(7) %add.ptr71, i64 7)
  %tobool160.not = icmp eq i32 %bcmp304, 0
  br i1 %tobool160.not, label %while.end163, label %while.cond152

while.end163:                                     ; preds = %while.body156, %while.cond152
  %strchr305 = call ptr @strchr(ptr nonnull dereferenceable(1) %b, i32 58)
  %add.ptr166 = getelementptr inbounds i8, ptr %strchr305, i64 1
  %call.i322 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr166, ptr noundef null, i32 noundef 10) #31
  %conv.i323 = trunc i64 %call.i322 to i32
  %sub168 = add nsw i32 %conv.i323, -1
...
while.body173:                                    ; preds = %while.cond169
  %bcmp306 = call i32 @bcmp(ptr noundef nonnull dereferenceable(6) @.str.53, ptr noundef nonnull dereferenceable(6) %add.ptr71, i64 6)
  %tobool177.not = icmp eq i32 %bcmp306, 0
  br i1 %tobool177.not, label %while.end180, label %while.cond169

while.end180:                                     ; preds = %while.body173, %while.cond169
  %strchr307 = call ptr @strchr(ptr nonnull dereferenceable(1) %b, i32 58)
  %add.ptr183 = getelementptr inbounds i8, ptr %strchr307, i64 1
  %call.i324 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr183, ptr noundef null, i32 noundef 10) #31
  %conv.i325 = trunc i64 %call.i324 to i32
  %sub185 = add nsw i32 %conv.i325, -1
...
while.body190:                                    ; preds = %while.cond186
  %bcmp308 = call i32 @bcmp(ptr noundef nonnull dereferenceable(15) @.str.54, ptr noundef nonnull dereferenceable(15) %add.ptr71, i64 15)
  %tobool194.not = icmp eq i32 %bcmp308, 0
  br i1 %tobool194.not, label %while.end197, label %while.cond186

while.end197:                                     ; preds = %while.body190, %while.cond186
  %strchr309 = call ptr @strchr(ptr nonnull dereferenceable(1) %b, i32 58)
  %add.ptr200 = getelementptr inbounds i8, ptr %strchr309, i64 1
  %call.i326 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr200, ptr noundef null, i32 noundef 10) #31
  %conv.i327 = trunc i64 %call.i326 to i32
  %sub202 = add nsw i32 %conv.i327, -1
...
if.end3.i:                                        ; preds = %do.body.i
  ...
  br i1 %cmp9.not.i, label %cutal.exit, label %do.body.i
...
do.body.i328:                                     ; preds = %if.end3.i335, %cutal.exit
  %pos.0.i329 = phi i32 [ %sub202, %cutal.exit ], [ %spec.select16.i338, %if.end3.i335 ]
  %pt.0.i330 = phi ptr [ @ReadFasta34m10_nuc.tal, %cutal.exit ], [ %incdec.ptr.i339, %if.end3.i335 ]
  %val.0.i331 = phi ptr [ null, %cutal.exit ], [ %spec.select.i333, %if.end3.i335 ]
  %cmp.i332 = icmp eq i32 %pos.0.i329, %sub168
  %spec.select.i333 = select i1 %cmp.i332, ptr %pt.0.i330, ptr %val.0.i331
  %cmp1.i334 = icmp eq i32 %pos.0.i329, %sub185
  br i1 %cmp1.i334, label %cutal.exit343, label %if.end3.i335

if.end3.i335:                                     ; preds = %do.body.i328
  %9 = load i8, ptr %pt.0.i330, align 1
  %cmp4.not.i336 = icmp ne i8 %9, 45
  %inc.i337 = zext i1 %cmp4.not.i336 to i32
  %spec.select16.i338 = add nsw i32 %pos.0.i329, %inc.i337
  %incdec.ptr.i339 = getelementptr inbounds i8, ptr %pt.0.i330, i64 1
  %cmp9.not.i340 = icmp eq i8 %9, 0
  br i1 %cmp9.not.i340, label %cutal.exit343, label %do.body.i328

cutal.exit343:                                    ; preds = %do.body.i328, %if.end3.i335
  %pt.1.i341 = phi ptr [ %pt.0.i330, %do.body.i328 ], [ %incdec.ptr.i339, %if.end3.i335 ]
  %add.ptr.i342 = getelementptr inbounds i8, ptr %pt.1.i341, i64 1
  store i8 0, ptr %add.ptr.i342, align 1
  %10 = load i32, ptr %arrayidx46, align 4
  %idx.ext = sext i32 %10 to i64
  %add.ptr231 = getelementptr inbounds %struct._LocalHom, ptr %localhomlist, i64 %idx.ext
  call void @putlocalhom(ptr noundef %spec.select.i, ptr noundef %spec.select.i333, ptr noundef %add.ptr231, i32 noundef %sub, i32 noundef %sub168, i32 poison, i32 poison)
  br label %while.cond28.outer
...
while.end:                                        ; preds = %if.end19, %if.else
  %count.0.lcssa.ph = phi i32 [ %count.1, %if.end19 ], [ %count.0346, %if.else ]
  %2 = icmp eq i32 %count.0.lcssa.ph, 0
  br i1 %2, label %cleanup, label %while.cond23.preheader
...
while.cond23.outer:                               ; preds = %while.cond23.preheader, %cutal.exit338
  %indvars.iv = phi i64 [ 0, %while.cond23.preheader ], [ %indvars.iv.next, %cutal.exit338 ]
  br label %while.cond23

while.cond23:                                     ; preds = %while.cond23.outer, %if.then28
  %bcmp288 = call i32 @bcmp(ptr noundef nonnull dereferenceable(14) @.str.47, ptr noundef nonnull dereferenceable(14) %b, i64 14)
  %tobool27.not = icmp eq i32 %bcmp288, 0
...
if.end35:                                         ; preds = %while.cond23
  %call.i305 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr37, ptr noundef null, i32 noundef 10) #31
  ...
  store i32 %conv.i306, ptr %arrayidx41, align 4
...
while.body46:                                     ; preds = %while.cond42
  %bcmp289 = call i32 @bcmp(ptr noundef nonnull dereferenceable(9) @.str.48, ptr noundef nonnull dereferenceable(9) %b, i64 9)
  %tobool49.not = icmp eq i32 %bcmp289, 0
  br i1 %tobool49.not, label %while.end55, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %while.body46
  %bcmp290 = call i32 @bcmp(ptr noundef nonnull dereferenceable(13) @.str.49, ptr noundef nonnull dereferenceable(13) %b, i64 13)
  %tobool52.not = icmp eq i32 %bcmp290, 0
  br i1 %tobool52.not, label %while.end55, label %while.cond42

while.end55:                                      ; preds = %while.body46, %lor.lhs.false, %while.cond42
  %strchr = call ptr @strchr(ptr nonnull dereferenceable(1) %b, i32 58)
  %add.ptr58 = getelementptr inbounds i8, ptr %strchr, i64 1
  %call.i307 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr58, ptr noundef null, i32 noundef 10) #31
  %conv.i308 = trunc i64 %call.i307 to i32
  store i32 %conv.i308, ptr %opt, align 4
...
while.body64:                                     ; preds = %while.cond60
  %bcmp291 = call i32 @bcmp(ptr noundef nonnull dereferenceable(9) @.str.51, ptr noundef nonnull dereferenceable(9) %add.ptr66, i64 9)
  %tobool68.not = icmp eq i32 %bcmp291, 0
  br i1 %tobool68.not, label %while.end71, label %while.cond60

while.end71:                                      ; preds = %while.body64, %while.cond60
  %strchr292 = call ptr @strchr(ptr nonnull dereferenceable(1) %b, i32 58)
  %add.ptr74 = getelementptr inbounds i8, ptr %strchr292, i64 1
  %call.i309 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr74, ptr noundef null, i32 noundef 10) #31
...
while.body80:                                     ; preds = %while.cond76
  %bcmp293 = call i32 @bcmp(ptr noundef nonnull dereferenceable(7) @.str.52, ptr noundef nonnull dereferenceable(7) %add.ptr66, i64 7)
  %tobool84.not = icmp eq i32 %bcmp293, 0
  br i1 %tobool84.not, label %while.end87, label %while.cond76

while.end87:                                      ; preds = %while.body80, %while.cond76
  %strchr294 = call ptr @strchr(ptr nonnull dereferenceable(1) %b, i32 58)
  %add.ptr90 = getelementptr inbounds i8, ptr %strchr294, i64 1
  %call.i311 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr90, ptr noundef null, i32 noundef 10) #31
  %conv.i312 = trunc i64 %call.i311 to i32
  %sub = add nsw i32 %conv.i312, -1
...
while.body96:                                     ; preds = %while.cond92
  %bcmp295 = call i32 @bcmp(ptr noundef nonnull dereferenceable(6) @.str.53, ptr noundef nonnull dereferenceable(6) %add.ptr66, i64 6)
  %tobool100.not = icmp eq i32 %bcmp295, 0
  br i1 %tobool100.not, label %while.end103, label %while.cond92

while.end103:                                     ; preds = %while.body96, %while.cond92
  %strchr296 = call ptr @strchr(ptr nonnull dereferenceable(1) %b, i32 58)
  %add.ptr106 = getelementptr inbounds i8, ptr %strchr296, i64 1
  %call.i313 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr106, ptr noundef null, i32 noundef 10) #31
  %conv.i314 = trunc i64 %call.i313 to i32
  %sub108 = add nsw i32 %conv.i314, -1
...
while.body113:                                    ; preds = %while.cond109
  %bcmp297 = call i32 @bcmp(ptr noundef nonnull dereferenceable(15) @.str.54, ptr noundef nonnull dereferenceable(15) %add.ptr66, i64 15)
  %tobool117.not = icmp eq i32 %bcmp297, 0
  br i1 %tobool117.not, label %while.end120, label %while.cond109

while.end120:                                     ; preds = %while.body113, %while.cond109
  %strchr298 = call ptr @strchr(ptr nonnull dereferenceable(1) %b, i32 58)
  %add.ptr123 = getelementptr inbounds i8, ptr %strchr298, i64 1
  %call.i315 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr123, ptr noundef null, i32 noundef 10) #31
  %conv.i316 = trunc i64 %call.i315 to i32
  %sub125 = add nsw i32 %conv.i316, -1
...
if.end134:                                        ; preds = %while.cond126
  ...
  %3 = load ptr, ptr %call135, align 8
  %idxprom136 = sext i32 %call127 to i64
  %arrayidx137 = getelementptr inbounds i16, ptr %3, i64 %idxprom136
  %4 = load i16, ptr %arrayidx137, align 2
  %5 = and i16 %4, 1024
  %tobool139 = icmp ne i16 %5, 0
  %cmp141 = icmp eq i32 %call127, 45
  %or.cond = or i1 %cmp141, %tobool139
  br i1 %or.cond, label %if.then143, label %while.cond126

if.then143:                                       ; preds = %if.end134
  %conv144 = trunc i32 %call127 to i8
  %incdec.ptr = getelementptr inbounds i8, ptr %pt.0.ph, i64 1
  store i8 %conv144, ptr %pt.0.ph, align 1
  br label %while.cond126.outer
...
while.body151:                                    ; preds = %while.cond147
  %bcmp299 = call i32 @bcmp(ptr noundef nonnull dereferenceable(7) @.str.52, ptr noundef nonnull dereferenceable(7) %add.ptr66, i64 7)
  %tobool155.not = icmp eq i32 %bcmp299, 0
  br i1 %tobool155.not, label %while.end158, label %while.cond147

while.end158:                                     ; preds = %while.body151, %while.cond147
  %strchr300 = call ptr @strchr(ptr nonnull dereferenceable(1) %b, i32 58)
  %add.ptr161 = getelementptr inbounds i8, ptr %strchr300, i64 1
  %call.i317 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr161, ptr noundef null, i32 noundef 10) #31
  %conv.i318 = trunc i64 %call.i317 to i32
  %sub163 = add nsw i32 %conv.i318, -1
...
while.body168:                                    ; preds = %while.cond164
  %bcmp301 = call i32 @bcmp(ptr noundef nonnull dereferenceable(6) @.str.53, ptr noundef nonnull dereferenceable(6) %add.ptr66, i64 6)
  %tobool172.not = icmp eq i32 %bcmp301, 0
  br i1 %tobool172.not, label %while.end175, label %while.cond164

while.end175:                                     ; preds = %while.body168, %while.cond164
  %strchr302 = call ptr @strchr(ptr nonnull dereferenceable(1) %b, i32 58)
  %add.ptr178 = getelementptr inbounds i8, ptr %strchr302, i64 1
  %call.i319 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr178, ptr noundef null, i32 noundef 10) #31
  %conv.i320 = trunc i64 %call.i319 to i32
  %sub180 = add nsw i32 %conv.i320, -1
...
while.body185:                                    ; preds = %while.cond181
  %bcmp303 = call i32 @bcmp(ptr noundef nonnull dereferenceable(15) @.str.54, ptr noundef nonnull dereferenceable(15) %add.ptr66, i64 15)
  %tobool189.not = icmp eq i32 %bcmp303, 0
  br i1 %tobool189.not, label %while.end192, label %while.cond181

while.end192:                                     ; preds = %while.body185, %while.cond181
  %strchr304 = call ptr @strchr(ptr nonnull dereferenceable(1) %b, i32 58)
  %add.ptr195 = getelementptr inbounds i8, ptr %strchr304, i64 1
  %call.i321 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr195, ptr noundef null, i32 noundef 10) #31
  %conv.i322 = trunc i64 %call.i321 to i32
  %sub197 = add nsw i32 %conv.i322, -1
...
if.end206:                                        ; preds = %while.cond198
  ...
  %6 = load ptr, ptr %call207, align 8
  %idxprom208 = sext i32 %call199 to i64
  %arrayidx209 = getelementptr inbounds i16, ptr %6, i64 %idxprom208
  %7 = load i16, ptr %arrayidx209, align 2
  %8 = and i16 %7, 1024
  %tobool212 = icmp ne i16 %8, 0
  %cmp214 = icmp eq i32 %call199, 45
  %or.cond243 = or i1 %cmp214, %tobool212
  br i1 %or.cond243, label %if.then216, label %while.cond198

if.then216:                                       ; preds = %if.end206
  %conv217 = trunc i32 %call199 to i8
  %incdec.ptr218 = getelementptr inbounds i8, ptr %pt.2.ph, i64 1
  store i8 %conv217, ptr %pt.2.ph, align 1
  br label %while.cond198.outer
...
if.end3.i:                                        ; preds = %do.body.i
  %9 = load i8, ptr %pt.0.i, align 1
  %cmp4.not.i = icmp ne i8 %9, 45
  %inc.i = zext i1 %cmp4.not.i to i32
  %spec.select16.i = add nsw i32 %pos.0.i, %inc.i
  %incdec.ptr.i = getelementptr inbounds i8, ptr %pt.0.i, i64 1
...
do.body.i323:                                     ; preds = %if.end3.i330, %cutal.exit
  %pos.0.i324 = phi i32 [ %sub197, %cutal.exit ], [ %spec.select16.i333, %if.end3.i330 ]
  %pt.0.i325 = phi ptr [ @ReadFasta34m10.tal, %cutal.exit ], [ %incdec.ptr.i334, %if.end3.i330 ]
  %val.0.i326 = phi ptr [ null, %cutal.exit ], [ %spec.select.i328, %if.end3.i330 ]
  %cmp.i327 = icmp eq i32 %pos.0.i324, %sub163
  %spec.select.i328 = select i1 %cmp.i327, ptr %pt.0.i325, ptr %val.0.i326
  %cmp1.i329 = icmp eq i32 %pos.0.i324, %sub180
  br i1 %cmp1.i329, label %cutal.exit338, label %if.end3.i330

if.end3.i330:                                     ; preds = %do.body.i323
  %10 = load i8, ptr %pt.0.i325, align 1
  %cmp4.not.i331 = icmp ne i8 %10, 45
  %inc.i332 = zext i1 %cmp4.not.i331 to i32
  %spec.select16.i333 = add nsw i32 %pos.0.i324, %inc.i332
  %incdec.ptr.i334 = getelementptr inbounds i8, ptr %pt.0.i325, i64 1
  %cmp9.not.i335 = icmp eq i8 %10, 0
  br i1 %cmp9.not.i335, label %cutal.exit338, label %do.body.i323

cutal.exit338:                                    ; preds = %do.body.i323, %if.end3.i330
  %pt.1.i336 = phi ptr [ %pt.0.i325, %do.body.i323 ], [ %incdec.ptr.i334, %if.end3.i330 ]
  %add.ptr.i337 = getelementptr inbounds i8, ptr %pt.1.i336, i64 1
  store i8 0, ptr %add.ptr.i337, align 1
  %11 = load i32, ptr %arrayidx41, align 4
  %idx.ext = sext i32 %11 to i64
  %add.ptr226 = getelementptr inbounds %struct._LocalHom, ptr %localhomlist, i64 %idx.ext
  call void @putlocalhom(ptr noundef %spec.select.i, ptr noundef %spec.select.i328, ptr noundef %add.ptr226, i32 noundef %sub, i32 noundef %sub163, i32 poison, i32 poison)
  br label %while.cond23.outer
...
cleanup:                                          ; preds = %entry, %cleanup.loopexit, %while.end
  %retval.0 = phi i32 [ -1, %while.end ], [ %12, %cleanup.loopexit ], [ -1, %entry ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %bits) #31
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %z) #31
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %opt) #31
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %b) #31
...
for.body3.preheader:                              ; preds = %entry
  ...
  tail call void @llvm.memset.p0.i64(ptr align 4 %call, i8 0, i64 %1, i1 false)
  %2 = zext i32 %nin to i64
  %3 = shl nuw nsw i64 %2, 3
  tail call void @llvm.memset.p0.i64(ptr align 8 %dis, i8 0, i64 %3, i1 false)
  br label %while.cond.preheader
...
if.then:                                          ; preds = %while.body
  ...
  br i1 %tobool18.not, label %if.end, label %while.cond
...
if.then27:                                        ; preds = %if.end
  ...
  store double %add, ptr %arrayidx29, align 8
...
for.body41.preheader:                             ; preds = %for.cond38.preheader
  call void @llvm.memset.p0.i64(ptr align 4 %call, i8 0, i64 %4, i1 false)
...
if.then23:                                        ; preds = %if.then
  ...
  %8 = load double, ptr %arrayidx25, align 8
...
for.body36.preheader:                             ; preds = %for.cond33.preheader
  call void @llvm.memset.p0.i64(ptr align 4 %call, i8 0, i64 %5, i1 false)
  br label %if.end50
...
while.end:                                        ; preds = %if.end19, %if.else
  %count.0.lcssa.ph = phi i32 [ %count.1, %if.end19 ], [ %count.0139, %if.else ]
  %2 = icmp eq i32 %count.0.lcssa.ph, 0
  br i1 %2, label %cleanup, label %while.cond23.preheader
...
while.body27:                                     ; preds = %while.body27.lr.ph, %if.end90
  ...
  %bcmp132 = call i32 @bcmp(ptr noundef nonnull dereferenceable(14) @.str.47, ptr noundef nonnull dereferenceable(14) %b, i64 14)
  %tobool30.not = icmp eq i32 %bcmp132, 0
  br i1 %tobool30.not, label %if.then31, label %if.end90

if.then31:                                        ; preds = %while.body27
  %call.i133 = call i64 @strtol(ptr nocapture noundef nonnull %add.ptr33, ptr noundef null, i32 noundef 10) #31
  ...
  store i32 %conv.i134, ptr %arrayidx36, align 4
  ...
  %call.i135 = call double @strtod(ptr nocapture noundef nonnull %add.ptr42, ptr noundef null) #31
  ...
  store double %call.i135, ptr %opt48, align 8
  %call50 = call ptr @fgets(ptr noundef nonnull %b, i32 noundef 255, ptr noundef %fp)
  ...
  %4 = load ptr, ptr @stderr, align 8
  %5 = load i32, ptr %overlapaa, align 4
  %call55 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %4, ptr noundef nonnull @.str.60, ptr noundef nonnull %add.ptr53, i32 noundef %5) #27
  ...
  %6 = load i32, ptr %overlapaa, align 4
  ...
  store i32 %6, ptr %overlapaa65, align 8
  %8 = load i32, ptr %qstart, align 4
  %sub66 = add nsw i32 %8, -1
  %start1 = getelementptr inbounds %struct._LocalHom, ptr %localhomlist, i64 %idxprom63, i32 3
  store i32 %sub66, ptr %start1, align 8
  %9 = load i32, ptr %qend, align 4
  %sub72 = add nsw i32 %9, -1
  %end1 = getelementptr inbounds %struct._LocalHom, ptr %localhomlist, i64 %idxprom63, i32 4
  store i32 %sub72, ptr %end1, align 4
  %10 = load i32, ptr %tstart, align 4
  %sub78 = add nsw i32 %10, -1
  %start2 = getelementptr inbounds %struct._LocalHom, ptr %localhomlist, i64 %idxprom63, i32 5
  store i32 %sub78, ptr %start2, align 8
  %11 = load i32, ptr %tend, align 4
  %sub84 = add nsw i32 %11, -1
  %end2 = getelementptr inbounds %struct._LocalHom, ptr %localhomlist, i64 %idxprom63, i32 6
  store i32 %sub84, ptr %end2, align 4
  br label %if.end90
...
if.end90:                                         ; preds = %if.then31, %while.body27
  ...
  br i1 %tobool25.not, label %while.body27, label %while.end93

while.end93:                                      ; preds = %if.end90, %while.cond23.preheader
  %count.2.lcssa = phi i32 [ 0, %while.cond23.preheader ], [ %count.3, %if.end90 ]
  %12 = load ptr, ptr @stderr, align 8
  %call94 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %12, ptr noundef nonnull @.str.63, i32 noundef %count.2.lcssa) #27
  br label %cleanup
...
for.cond1.preheader:                              ; preds = %entry
  ...
  tail call void @llvm.memset.p0.i64(ptr align 8 %dis, i8 0, i64 %1, i1 false)
...
for.inc20:                                        ; preds = %for.body3, %if.then
  ...
  br i1 %4, label %for.body3, label %for.end22
...
if.then:                                          ; preds = %for.body
  ...
  store i32 %conv.i19, ptr %arrayidx12, align 4
...
if.then:                                          ; preds = %entry
  %0 = load ptr, ptr @prep_g, align 8
  tail call void @rewind(ptr noundef %0)
  %1 = load ptr, ptr @prep_g, align 8
...
for.body7.i:                                      ; preds = %for.body.i, %for.body7.i
  ...
  br i1 %cmp5.i, label %for.body7.i, label %for.inc12.i
...
entry:
  %b = alloca [256 x i8], align 16
  %0 = load i32, ptr @calledByXced, align 4
...
if.else:                                          ; preds = %entry
  store i32 0, ptr %ppidptr, align 4
  store i32 80, ptr %fftThresholdptr, align 4
  %2 = load i32, ptr @dorp, align 4
  %cmp = icmp eq i32 %2, 100
  br i1 %cmp, label %if.then7, label %if.else8

if.then7:                                         ; preds = %if.else
  store i32 100, ptr %fftWinSizeptr, align 4
  br label %if.end10

if.else8:                                         ; preds = %if.else
  store i32 20, ptr %fftWinSizeptr, align 4
  br label %if.end10
...
entry:
  %0 = load i32, ptr @ppid, align 4
  %tobool.not = icmp eq i32 %0, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  store ptr null, ptr @signalSM, align 8
  br label %if.end
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  store ptr %call4, ptr @prep_g, align 8
  %tobool5.not = icmp eq ptr %call4, null
...
if.end7:                                          ; preds = %if.end
  ...
  store ptr %call8, ptr @trap_g, align 8
  %tobool9.not = icmp eq ptr %call8, null
...
for.body11:                                       ; preds = %for.body, %for.body11
  ...
  store i8 0, ptr getelementptr inbounds ([5000000 x i8], ptr @WriteForFasta.b, i64 0, i64 60), align 4
  ...
  br i1 %cmp9, label %for.body11, label %for.inc16
...
while.body:                                       ; preds = %entry, %if.end53
  ...
  %inc = add nsw i32 %3, 1
  store i32 %inc, ptr %arrayidx3, align 8
...
if.then:                                          ; preds = %while.body
  ...
  store ptr %call9, ptr %last16, align 8
  br label %if.end
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  store double %mul, ptr %opt23, align 8
  %14 = load i32, ptr %overlapaa, align 4
  %overlapaa24 = getelementptr inbounds %struct._LocalHom, ptr %tmpptr1.0, i64 0, i32 8
  store i32 %14, ptr %overlapaa24, align 8
  ...
  %16 = load i32, ptr %arrayidx28, align 8
  %inc30 = add nsw i32 %16, 1
  store i32 %inc30, ptr %arrayidx28, align 8
...
if.then32:                                        ; preds = %if.end
  ...
  %20 = load ptr, ptr %last37, align 8
...
for.body3.us:                                     ; preds = %for.cond1.preheader.us, %for.body3.us
  ...
  store i32 %inc.us, ptr %j, align 4
  %cmp2.us = icmp slt i32 %inc.us, %njob
  br i1 %cmp2.us, label %for.body3.us, label %for.cond1.for.inc6_crit_edge.us

for.cond1.for.inc6_crit_edge.us:                  ; preds = %for.body3.us
  %3 = load i32, ptr %i, align 4
  %inc7.us = add nsw i32 %3, 1
  store i32 %inc7.us, ptr %i, align 4
  %cmp.us = icmp slt i32 %inc7.us, %njob
  br i1 %cmp.us, label %for.cond1.preheader.us, label %while.cond.preheader
...
if.then35:                                        ; preds = %if.end
  ...
  store ptr %call36, ptr %next37, align 8
...
do.body.us:                                       ; preds = %do.body.us, %for.body3.us
  ...
  br i1 %tobool.not.us, label %for.inc.us, label %do.body.us

for.inc.us:                                       ; preds = %do.body.us
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count29
  br i1 %exitcond.not, label %for.cond1.for.inc5_crit_edge.us, label %for.body3.us

for.cond1.for.inc5_crit_edge.us:                  ; preds = %for.inc.us
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv26, 1
  %exitcond30.not = icmp eq i64 %indvars.iv.next27, %wide.trip.count29
  br i1 %exitcond30.not, label %for.end7, label %for.cond1.preheader.us
...
for.body3.us:                                     ; preds = %for.cond1.preheader.us, %for.inc.us
  ...
  %2 = load ptr, ptr %arrayidx5.us, align 8
  %3 = load ptr, ptr @stderr, align 8
...
do.body.us:                                       ; preds = %do.body.us, %for.body3.us
  ...
  %5 = load ptr, ptr @stderr, align 8
  %start1.us = getelementptr inbounds %struct._LocalHom, ptr %tmpptr.0.us, i64 0, i32 3
  %6 = load i32, ptr %start1.us, align 8
  %end1.us = getelementptr inbounds %struct._LocalHom, ptr %tmpptr.0.us, i64 0, i32 4
  %7 = load i32, ptr %end1.us, align 4
  %start2.us = getelementptr inbounds %struct._LocalHom, ptr %tmpptr.0.us, i64 0, i32 5
  %8 = load i32, ptr %start2.us, align 8
  %end2.us = getelementptr inbounds %struct._LocalHom, ptr %tmpptr.0.us, i64 0, i32 6
  %9 = load i32, ptr %end2.us, align 4
  %importance.us = getelementptr inbounds %struct._LocalHom, ptr %tmpptr.0.us, i64 0, i32 10
  %10 = load double, ptr %importance.us, align 8
  %opt.us = getelementptr inbounds %struct._LocalHom, ptr %tmpptr.0.us, i64 0, i32 7
  %11 = load double, ptr %opt.us, align 8
  %wimportance.us = getelementptr inbounds %struct._LocalHom, ptr %tmpptr.0.us, i64 0, i32 12
  %12 = load double, ptr %wimportance.us, align 8
  ...
  %next.us = getelementptr inbounds %struct._LocalHom, ptr %tmpptr.0.us, i64 0, i32 1
  %13 = load ptr, ptr %next.us, align 8
...
for.inc.us:                                       ; preds = %do.body.us
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.cond1.for.inc7_crit_edge.us, label %for.body3.us

for.cond1.for.inc7_crit_edge.us:                  ; preds = %for.inc.us
  %indvars.iv.next30 = add nuw nsw i64 %indvars.iv29, 1
  %exitcond33.not = icmp eq i64 %indvars.iv.next30, %wide.trip.count32
  br i1 %exitcond33.not, label %for.end9, label %for.cond1.preheader.us
...
for.body5.us:                                     ; preds = %for.body5.us.preheader, %for.inc.us
  ...
  %3 = load ptr, ptr %next6.us, align 8
...
for.inc.us:                                       ; preds = %if.then.us, %for.body5.us
  ...
  br i1 %tobool.not.us, label %for.inc12.us, label %for.body5.us

for.inc12.us:                                     ; preds = %for.inc.us, %for.body3.us
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count44
  br i1 %exitcond.not, label %for.cond1.for.end13_crit_edge.us, label %for.body3.us
...
for.cond1.for.end13_crit_edge.us:                 ; preds = %for.inc12.us
  ...
  br i1 %exitcond45.not, label %for.end18, label %for.cond1.preheader.us
...
for.body.us:                                      ; preds = %while.body.us, %extractfirstword.exit.us
  ...
  %2 = load ptr, ptr %arrayidx6.us, align 8
...
while.body.i.i.us:                                ; preds = %for.body.us, %while.body.i.i.us
  ...
  store i8 32, ptr %call3.i.i.us, align 1
  ...
  br i1 %cmp.not.i.i.us, label %tabtospace.exit.i.us, label %while.body.i.i.us

tabtospace.exit.i.us:                             ; preds = %while.body.i.i.us, %for.body.us
  %3 = load i8, ptr %add.ptr.us, align 1
...
if.end15.thread.i.us:                             ; preds = %if.else.i.us
  store i8 0, ptr %str.addr.028.i.us, align 1
...
if.end15.i.us:                                    ; preds = %if.then.i.us, %if.then7.i.us
  ...
  %.pr.i.us = load i8, ptr %str.addr.1.ph.i.us, align 1
  %tobool.not.i.us = icmp eq i8 %.pr.i.us, 0
  br i1 %tobool.not.i.us, label %extractfirstword.exit.us, label %while.body.i.us
...
extractfirstword.exit.us:                         ; preds = %if.end15.i.us, %if.end15.thread.i.us, %tabtospace.exit.i.us
  ...
  %6 = load ptr, ptr %arrayidx12.us, align 8
  ...
  br i1 %exitcond.not, label %for.cond.for.end_crit_edge.us, label %for.body.us
...
while.body.us42:                                  ; preds = %while.body.lr.ph.split, %while.body.us42
  ...
  br i1 %cmp2.us47, label %while.body.us42, label %while.end
...
for.inc14:                                        ; preds = %for.body9, %for.body
  ...
  br i1 %exitcond.not, label %for.end15, label %for.body
...
while.body:                                       ; preds = %while.cond
  ...
  br i1 %cmp13.not, label %while.cond, label %while.end

while.end:                                        ; preds = %while.body, %while.cond.while.end_crit_edge
  %6 = phi i8 [ %.pre, %while.cond.while.end_crit_edge ], [ %5, %while.body ]
  %tobool18.not355 = icmp eq i8 %6, 0
  br i1 %tobool18.not355, label %while.end33, label %while.body19.lr.ph
...
while.body19:                                     ; preds = %while.body19.lr.ph, %if.end31
  ...
  %ptr2.0357 = phi ptr [ %call9, %while.body19.lr.ph ], [ %incdec.ptr32, %if.end31 ]
  %ptr1.0356 = phi ptr [ %call9, %while.body19.lr.ph ], [ %ptr1.1, %if.end31 ]
...
if.then25:                                        ; preds = %while.body19
  ...
  store i8 %conv30, ptr %ptr1.0356, align 1
  %incdec.ptr = getelementptr inbounds i8, ptr %ptr1.0356, i64 1
  br label %if.end31

if.end31:                                         ; preds = %if.then25, %while.body19
  %ptr1.1 = phi ptr [ %incdec.ptr, %if.then25 ], [ %ptr1.0356, %while.body19 ]
  %incdec.ptr32 = getelementptr inbounds i8, ptr %ptr2.0357, i64 1
  %13 = load i8, ptr %incdec.ptr32, align 1
  %tobool18.not = icmp eq i8 %13, 0
  br i1 %tobool18.not, label %while.end33, label %while.body19
...
if.else:                                          ; preds = %while.end33
  ...
  store i32 %conv48, ptr %call2, align 4
...
if.else.1:                                        ; preds = %if.else
  ...
  store i32 %conv48.1, ptr %arrayidx50.1, align 4
...
if.else.2:                                        ; preds = %if.else.1
  ...
  store i32 %conv48.2, ptr %arrayidx50.2, align 4
...
if.else.3:                                        ; preds = %if.else.2
  ...
  store i32 %conv48.3, ptr %arrayidx50.3, align 4
...
if.else.4:                                        ; preds = %if.else.3
  ...
  store i32 %conv48.4, ptr %arrayidx50.4, align 4
...
if.else.5:                                        ; preds = %if.else.4
  ...
  store i32 %conv48.5, ptr %arrayidx50.5, align 4
...
if.else.6:                                        ; preds = %if.else.5
  ...
  store i32 %conv48.6, ptr %arrayidx50.6, align 4
...
if.else.7:                                        ; preds = %if.else.6
  ...
  store i32 %conv48.7, ptr %arrayidx50.7, align 4
...
if.else.8:                                        ; preds = %if.else.7
  ...
  store i32 %conv48.8, ptr %arrayidx50.8, align 4
...
if.else.9:                                        ; preds = %if.else.8
  ...
  store i32 %conv48.9, ptr %arrayidx50.9, align 4
...
if.else.10:                                       ; preds = %if.else.9
  ...
  store i32 %conv48.10, ptr %arrayidx50.10, align 4
...
if.else.11:                                       ; preds = %if.else.10
  ...
  store i32 %conv48.11, ptr %arrayidx50.11, align 4
...
if.else.12:                                       ; preds = %if.else.11
  ...
  store i32 %conv48.12, ptr %arrayidx50.12, align 4
...
if.else.13:                                       ; preds = %if.else.12
  ...
  store i32 %conv48.13, ptr %arrayidx50.13, align 4
...
if.else.14:                                       ; preds = %if.else.13
  ...
  store i32 %conv48.14, ptr %arrayidx50.14, align 4
...
if.else.15:                                       ; preds = %if.else.14
  ...
  store i32 %conv48.15, ptr %arrayidx50.15, align 4
...
if.else.16:                                       ; preds = %if.else.15
  ...
  store i32 %conv48.16, ptr %arrayidx50.16, align 4
...
if.else.17:                                       ; preds = %if.else.16
  ...
  store i32 %conv48.17, ptr %arrayidx50.17, align 4
...
if.else.18:                                       ; preds = %if.else.17
  ...
  store i32 %conv48.18, ptr %arrayidx50.18, align 4
...
if.else.19:                                       ; preds = %if.else.18
  ...
  store i32 %conv48.19, ptr %arrayidx50.19, align 4
...
while.body56:                                     ; preds = %while.cond52
  ...
  br i1 %cmp60, label %while.cond52, label %for.cond64.preheader

for.cond64.preheader:                             ; preds = %while.body56
  %call69 = tail call ptr @__ctype_b_loc() #30
  %arrayidx87 = getelementptr inbounds ptr, ptr %call, i64 %indvars.iv378
  br label %while.cond68.preheader

for.cond64:                                       ; preds = %while.end84
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %indvars.iv376
  br i1 %exitcond.not, label %for.end100, label %while.cond68.preheader
...
while.cond68.preheader:                           ; preds = %for.cond64.preheader, %for.cond64
  ...
  %ptr1.2359 = phi ptr [ %call10, %for.cond64.preheader ], [ %call90, %for.cond64 ]
  %16 = load ptr, ptr %call69, align 8
  br label %while.cond68

while.cond68:                                     ; preds = %while.cond68, %while.cond68.preheader
  %ptr1.3 = phi ptr [ %incdec.ptr83, %while.cond68 ], [ %ptr1.2359, %while.cond68.preheader ]
  %17 = load i8, ptr %ptr1.3, align 1
  %idxprom71 = sext i8 %17 to i64
  %arrayidx72 = getelementptr inbounds i16, ptr %16, i64 %idxprom71
  %18 = load i16, ptr %arrayidx72, align 2
  %.fr351 = freeze i16 %18
  %19 = and i16 %.fr351, 2048
  %tobool75.not = icmp ne i16 %19, 0
  %.off = add i8 %17, -45
  %switch = icmp ult i8 %.off, 2
  %or.cond345 = or i1 %switch, %tobool75.not
  %incdec.ptr83 = getelementptr inbounds i8, ptr %ptr1.3, i64 1
  br i1 %or.cond345, label %while.end84, label %while.cond68
...
while.end84:                                      ; preds = %while.cond68
  ...
  store double %call.i, ptr %arrayidx89, align 8
  %call90 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %ptr1.3, i32 noundef 32) #32
  %cmp91 = icmp eq ptr %call90, null
  %cmp94 = icmp ult i64 %indvars.iv, %indvars.iv378
  %or.cond341 = and i1 %cmp91, %cmp94
  br i1 %or.cond341, label %if.then96, label %for.cond64
...
for.end100:                                       ; preds = %for.cond64
  ...
  %exitcond383 = icmp eq i64 %indvars.iv.next379, 20
  br i1 %exitcond383, label %while.end106, label %while.cond52.outer

while.cond52.outer:                               ; preds = %if.else.19, %for.end100
  %indvars.iv378 = phi i64 [ 0, %if.else.19 ], [ %indvars.iv.next379, %for.end100 ]
  %indvars.iv376 = phi i64 [ 1, %if.else.19 ], [ %indvars.iv.next377, %for.end100 ]
...
while.end106:                                     ; preds = %for.end100, %while.cond52
  ...
  store <2 x double> <double -1.000000e+00, double -1.000000e+00>, ptr %45, align 8
  %arrayidx113.2 = getelementptr inbounds double, ptr %45, i64 2
  store <2 x double> <double -1.000000e+00, double -1.000000e+00>, ptr %arrayidx113.2, align 8
  %arrayidx113.4 = getelementptr inbounds double, ptr %45, i64 4
  store <2 x double> <double -1.000000e+00, double -1.000000e+00>, ptr %arrayidx113.4, align 8
  %arrayidx113.6 = getelementptr inbounds double, ptr %45, i64 6
  store <2 x double> <double -1.000000e+00, double -1.000000e+00>, ptr %arrayidx113.6, align 8
  %arrayidx113.8 = getelementptr inbounds double, ptr %45, i64 8
  store <2 x double> <double -1.000000e+00, double -1.000000e+00>, ptr %arrayidx113.8, align 8
  %arrayidx113.10 = getelementptr inbounds double, ptr %45, i64 10
  store <2 x double> <double -1.000000e+00, double -1.000000e+00>, ptr %arrayidx113.10, align 8
  %arrayidx113.12 = getelementptr inbounds double, ptr %45, i64 12
  store <2 x double> <double -1.000000e+00, double -1.000000e+00>, ptr %arrayidx113.12, align 8
  %arrayidx113.14 = getelementptr inbounds double, ptr %45, i64 14
  store <2 x double> <double -1.000000e+00, double -1.000000e+00>, ptr %arrayidx113.14, align 8
  %arrayidx113.16 = getelementptr inbounds double, ptr %45, i64 16
  store <2 x double> <double -1.000000e+00, double -1.000000e+00>, ptr %arrayidx113.16, align 8
  %arrayidx113.18 = getelementptr inbounds double, ptr %45, i64 18
  store <2 x double> <double -1.000000e+00, double -1.000000e+00>, ptr %arrayidx113.18, align 8
  br label %while.cond117
...
while.body121:                                    ; preds = %while.cond117
  ...
  %46 = load i8, ptr %call10, align 1
  %cmp125 = icmp eq i8 %46, 102
  br i1 %cmp125, label %for.cond128.preheader, label %while.cond117
...
for.cond128:                                      ; preds = %while.end151
  ...
  %exitcond391.not = icmp eq i64 %indvars.iv.next389, 20
  br i1 %exitcond391.not, label %for.cond173.preheader.preheader, label %while.cond132.preheader
...
while.cond132.preheader:                          ; preds = %for.cond128.preheader, %for.cond128
  %indvars.iv388 = phi i64 [ 0, %for.cond128.preheader ], [ %indvars.iv.next389, %for.cond128 ]
  %ptr1.4362 = phi ptr [ %call10, %for.cond128.preheader ], [ %call156, %for.cond128 ]
  %47 = load ptr, ptr %call133, align 8
  br label %while.cond132

while.cond132:                                    ; preds = %while.cond132, %while.cond132.preheader
  %ptr1.5 = phi ptr [ %incdec.ptr150, %while.cond132 ], [ %ptr1.4362, %while.cond132.preheader ]
  %48 = load i8, ptr %ptr1.5, align 1
  %idxprom135 = sext i8 %48 to i64
  %arrayidx136 = getelementptr inbounds i16, ptr %47, i64 %idxprom135
  %49 = load i16, ptr %arrayidx136, align 2
  %.fr352 = freeze i16 %49
  %50 = and i16 %.fr352, 2048
  %tobool139.not = icmp ne i16 %50, 0
  %.off346 = add i8 %48, -45
  %switch347 = icmp ult i8 %.off346, 2
  %or.cond348 = or i1 %switch347, %tobool139.not
  %incdec.ptr150 = getelementptr inbounds i8, ptr %ptr1.5, i64 1
  br i1 %or.cond348, label %while.end151, label %while.cond132

while.end151:                                     ; preds = %while.cond132
  %call.i349 = tail call double @strtod(ptr nocapture noundef nonnull %ptr1.5, ptr noundef null) #31
  %51 = load ptr, ptr %arrayidx111, align 8
  %arrayidx155 = getelementptr inbounds double, ptr %51, i64 %indvars.iv388
  store double %call.i349, ptr %arrayidx155, align 8
  ...
  %cmp160 = icmp ult i64 %indvars.iv388, 19
...
for.cond173.preheader:                            ; preds = %for.cond173.preheader.preheader, %for.inc218
  %indvars.iv404 = phi i64 [ %indvars.iv.next405, %for.inc218 ], [ 0, %for.cond173.preheader.preheader ]
  %indvars.iv402 = phi i64 [ %indvars.iv.next403, %for.inc218 ], [ 1, %for.cond173.preheader.preheader ]
  %k.0366 = phi i64 [ %indvars.iv.next395, %for.inc218 ], [ 0, %for.cond173.preheader.preheader ]
  %arrayidx181 = getelementptr inbounds i32, ptr %call2, i64 %indvars.iv404
  %sext = shl i64 %k.0366, 32
  %76 = ashr exact i64 %sext, 32
  %77 = load i32, ptr %arrayidx181, align 4
  br label %for.body176

for.cond221.preheader:                            ; preds = %for.inc218
  %78 = load ptr, ptr %arrayidx111, align 8
  %79 = load i32, ptr %call2, align 4
  %idxprom228 = sext i32 %79 to i64
  %arrayidx229 = getelementptr inbounds double, ptr %78, i64 %idxprom228
  %80 = load double, ptr %arrayidx229, align 8
  %arrayidx231 = getelementptr inbounds double, ptr %call1, i64 400
  store double %80, ptr %arrayidx231, align 8
  %81 = load i32, ptr %arrayidx50.1, align 4
  %idxprom228.1 = sext i32 %81 to i64
  %arrayidx229.1 = getelementptr inbounds double, ptr %78, i64 %idxprom228.1
  %82 = load double, ptr %arrayidx229.1, align 8
  %arrayidx231.1 = getelementptr inbounds double, ptr %call1, i64 401
  store double %82, ptr %arrayidx231.1, align 8
  %83 = load i32, ptr %arrayidx50.2, align 4
  %idxprom228.2 = sext i32 %83 to i64
  %arrayidx229.2 = getelementptr inbounds double, ptr %78, i64 %idxprom228.2
  %84 = load double, ptr %arrayidx229.2, align 8
  %arrayidx231.2 = getelementptr inbounds double, ptr %call1, i64 402
  store double %84, ptr %arrayidx231.2, align 8
  %85 = load i32, ptr %arrayidx50.3, align 4
  %idxprom228.3 = sext i32 %85 to i64
  %arrayidx229.3 = getelementptr inbounds double, ptr %78, i64 %idxprom228.3
  %86 = load double, ptr %arrayidx229.3, align 8
  %arrayidx231.3 = getelementptr inbounds double, ptr %call1, i64 403
  store double %86, ptr %arrayidx231.3, align 8
  %87 = load i32, ptr %arrayidx50.4, align 4
  %idxprom228.4 = sext i32 %87 to i64
  %arrayidx229.4 = getelementptr inbounds double, ptr %78, i64 %idxprom228.4
  %88 = load double, ptr %arrayidx229.4, align 8
  %arrayidx231.4 = getelementptr inbounds double, ptr %call1, i64 404
  store double %88, ptr %arrayidx231.4, align 8
  %89 = load i32, ptr %arrayidx50.5, align 4
  %idxprom228.5 = sext i32 %89 to i64
  %arrayidx229.5 = getelementptr inbounds double, ptr %78, i64 %idxprom228.5
  %90 = load double, ptr %arrayidx229.5, align 8
  %arrayidx231.5 = getelementptr inbounds double, ptr %call1, i64 405
  store double %90, ptr %arrayidx231.5, align 8
  %91 = load i32, ptr %arrayidx50.6, align 4
  %idxprom228.6 = sext i32 %91 to i64
  %arrayidx229.6 = getelementptr inbounds double, ptr %78, i64 %idxprom228.6
  %92 = load double, ptr %arrayidx229.6, align 8
  %arrayidx231.6 = getelementptr inbounds double, ptr %call1, i64 406
  store double %92, ptr %arrayidx231.6, align 8
  %93 = load i32, ptr %arrayidx50.7, align 4
  %idxprom228.7 = sext i32 %93 to i64
  %arrayidx229.7 = getelementptr inbounds double, ptr %78, i64 %idxprom228.7
  %94 = load double, ptr %arrayidx229.7, align 8
  %arrayidx231.7 = getelementptr inbounds double, ptr %call1, i64 407
  store double %94, ptr %arrayidx231.7, align 8
  %95 = load i32, ptr %arrayidx50.8, align 4
  %idxprom228.8 = sext i32 %95 to i64
  %arrayidx229.8 = getelementptr inbounds double, ptr %78, i64 %idxprom228.8
  %96 = load double, ptr %arrayidx229.8, align 8
  %arrayidx231.8 = getelementptr inbounds double, ptr %call1, i64 408
  store double %96, ptr %arrayidx231.8, align 8
  %97 = load i32, ptr %arrayidx50.9, align 4
  %idxprom228.9 = sext i32 %97 to i64
  %arrayidx229.9 = getelementptr inbounds double, ptr %78, i64 %idxprom228.9
  %98 = load double, ptr %arrayidx229.9, align 8
  %arrayidx231.9 = getelementptr inbounds double, ptr %call1, i64 409
  store double %98, ptr %arrayidx231.9, align 8
  %99 = load i32, ptr %arrayidx50.10, align 4
  %idxprom228.10 = sext i32 %99 to i64
  %arrayidx229.10 = getelementptr inbounds double, ptr %78, i64 %idxprom228.10
  %100 = load double, ptr %arrayidx229.10, align 8
  %arrayidx231.10 = getelementptr inbounds double, ptr %call1, i64 410
  store double %100, ptr %arrayidx231.10, align 8
  %101 = load i32, ptr %arrayidx50.11, align 4
  %idxprom228.11 = sext i32 %101 to i64
  %arrayidx229.11 = getelementptr inbounds double, ptr %78, i64 %idxprom228.11
  %102 = load double, ptr %arrayidx229.11, align 8
  %arrayidx231.11 = getelementptr inbounds double, ptr %call1, i64 411
  store double %102, ptr %arrayidx231.11, align 8
  %103 = load i32, ptr %arrayidx50.12, align 4
  %idxprom228.12 = sext i32 %103 to i64
  %arrayidx229.12 = getelementptr inbounds double, ptr %78, i64 %idxprom228.12
  %104 = load double, ptr %arrayidx229.12, align 8
  %arrayidx231.12 = getelementptr inbounds double, ptr %call1, i64 412
  store double %104, ptr %arrayidx231.12, align 8
  %105 = load i32, ptr %arrayidx50.13, align 4
  %idxprom228.13 = sext i32 %105 to i64
  %arrayidx229.13 = getelementptr inbounds double, ptr %78, i64 %idxprom228.13
  %106 = load double, ptr %arrayidx229.13, align 8
  %arrayidx231.13 = getelementptr inbounds double, ptr %call1, i64 413
  store double %106, ptr %arrayidx231.13, align 8
  %107 = load i32, ptr %arrayidx50.14, align 4
  %idxprom228.14 = sext i32 %107 to i64
  %arrayidx229.14 = getelementptr inbounds double, ptr %78, i64 %idxprom228.14
  %108 = load double, ptr %arrayidx229.14, align 8
  %arrayidx231.14 = getelementptr inbounds double, ptr %call1, i64 414
  store double %108, ptr %arrayidx231.14, align 8
  %109 = load i32, ptr %arrayidx50.15, align 4
  %idxprom228.15 = sext i32 %109 to i64
  %arrayidx229.15 = getelementptr inbounds double, ptr %78, i64 %idxprom228.15
  %110 = load double, ptr %arrayidx229.15, align 8
  %arrayidx231.15 = getelementptr inbounds double, ptr %call1, i64 415
  store double %110, ptr %arrayidx231.15, align 8
  %111 = load i32, ptr %arrayidx50.16, align 4
  %idxprom228.16 = sext i32 %111 to i64
  %arrayidx229.16 = getelementptr inbounds double, ptr %78, i64 %idxprom228.16
  %112 = load double, ptr %arrayidx229.16, align 8
  %arrayidx231.16 = getelementptr inbounds double, ptr %call1, i64 416
  store double %112, ptr %arrayidx231.16, align 8
  %113 = load i32, ptr %arrayidx50.17, align 4
  %idxprom228.17 = sext i32 %113 to i64
  %arrayidx229.17 = getelementptr inbounds double, ptr %78, i64 %idxprom228.17
  %114 = load double, ptr %arrayidx229.17, align 8
  %arrayidx231.17 = getelementptr inbounds double, ptr %call1, i64 417
  store double %114, ptr %arrayidx231.17, align 8
  %115 = load i32, ptr %arrayidx50.18, align 4
  %idxprom228.18 = sext i32 %115 to i64
  %arrayidx229.18 = getelementptr inbounds double, ptr %78, i64 %idxprom228.18
  %116 = load double, ptr %arrayidx229.18, align 8
  %arrayidx231.18 = getelementptr inbounds double, ptr %call1, i64 418
  store double %116, ptr %arrayidx231.18, align 8
  %117 = load i32, ptr %arrayidx50.19, align 4
  %idxprom228.19 = sext i32 %117 to i64
  %arrayidx229.19 = getelementptr inbounds double, ptr %78, i64 %idxprom228.19
  %118 = load double, ptr %arrayidx229.19, align 8
  %arrayidx231.19 = getelementptr inbounds double, ptr %call1, i64 419
  store double %118, ptr %arrayidx231.19, align 8
  %119 = load ptr, ptr @stderr, align 8
  %call235 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %119, ptr noundef nonnull @.str.91, ptr noundef nonnull %call9) #27
...
for.body176:                                      ; preds = %for.cond173.preheader, %if.end207
  %indvars.iv394 = phi i64 [ %76, %for.cond173.preheader ], [ %indvars.iv.next395, %if.end207 ]
  %indvars.iv392 = phi i64 [ 0, %for.cond173.preheader ], [ %indvars.iv.next393, %if.end207 ]
  %cmp177.not = icmp eq i64 %indvars.iv404, %indvars.iv392
  br i1 %cmp177.not, label %if.end207, label %if.then179

if.then179:                                       ; preds = %for.body176
  %arrayidx183 = getelementptr inbounds i32, ptr %call2, i64 %indvars.iv392
  %120 = load i32, ptr %arrayidx183, align 4
  %. = tail call i32 @llvm.smax.i32(i32 %77, i32 %120)
  %cond203 = tail call i32 @llvm.smin.i32(i32 %77, i32 %120)
  br label %if.end207

if.end207:                                        ; preds = %for.body176, %if.then179
  %jj.0 = phi i32 [ %cond203, %if.then179 ], [ %77, %for.body176 ]
  %ii.0 = phi i32 [ %., %if.then179 ], [ %77, %for.body176 ]
  ...
  %arrayidx211 = getelementptr inbounds double, ptr %121, i64 %idxprom210
  %122 = load double, ptr %arrayidx211, align 8
  %indvars.iv.next395 = add nsw i64 %indvars.iv394, 1
  %arrayidx214 = getelementptr inbounds double, ptr %call1, i64 %indvars.iv394
  store double %122, ptr %arrayidx214, align 8
  %indvars.iv.next393 = add nuw nsw i64 %indvars.iv392, 1
  %exitcond401.not = icmp eq i64 %indvars.iv.next393, %indvars.iv402
  br i1 %exitcond401.not, label %for.inc218, label %for.body176

for.inc218:                                       ; preds = %if.end207
  %indvars.iv.next405 = add nuw nsw i64 %indvars.iv404, 1
  %indvars.iv.next403 = add nuw nsw i64 %indvars.iv402, 1
  %exitcond409.not = icmp eq i64 %indvars.iv.next405, 20
  br i1 %exitcond409.not, label %for.cond221.preheader, label %for.cond173.preheader
}
...
for.body14:                                       ; preds = %for.body, %for.body14
  ...
  br i1 %cmp12, label %for.body14, label %for.inc19
...
if.then37:                                        ; preds = %if.end31
  ...
  %10 = load float, ptr %prob, align 4
  ...
  store ptr %call82, ptr %arrayidx84, align 8
  %16 = load float, ptr %prob, align 4
...
entry:
  ...
  store i32 -1, ptr %of1, align 4
  store i32 -1, ptr %of2, align 4
...
while.body:                                       ; preds = %while.cond
  ...
  %bcmp = call i32 @bcmp(ptr noundef nonnull dereferenceable(10) %gett, ptr noundef nonnull dereferenceable(10) @.str.96, i64 10)
  %tobool7.not = icmp eq i32 %bcmp, 0
...
while.body26:                                     ; preds = %while.cond22
  ...
  %bcmp193 = call i32 @bcmp(ptr noundef nonnull dereferenceable(10) %gett, ptr noundef nonnull dereferenceable(10) @.str.100, i64 10)
  %tobool31.not = icmp eq i32 %bcmp193, 0
  br i1 %tobool31.not, label %while.end34, label %while.cond22
...
while.body39.preheader:                           ; preds = %while.end34
  ...
  %bcmp194236 = call i32 @bcmp(ptr noundef nonnull dereferenceable(10) %gett, ptr noundef nonnull dereferenceable(10) @.str.101, i64 10)
  %tobool44.not237 = icmp eq i32 %bcmp194236, 0
...
while.body39:                                     ; preds = %if.end46
  ...
  %bcmp194 = call i32 @bcmp(ptr noundef nonnull dereferenceable(10) %gett, ptr noundef nonnull dereferenceable(10) @.str.101, i64 10)
  %tobool44.not = icmp eq i32 %bcmp194, 0
  br i1 %tobool44.not, label %while.end56.loopexit, label %if.end46
...
if.end46:                                         ; preds = %while.body39.preheader, %while.body39
  ...
  %call.i198 = call i64 @strtol(ptr nocapture noundef nonnull %sinseq, ptr noundef null, i32 noundef 10) #31
  %conv.i199 = trunc i64 %call.i198 to i32
  %sub = add nsw i32 %conv.i199, -1
  ...
  %call36 = call i32 @feof(ptr noundef %fp) #31
  %tobool37.not = icmp eq i32 %call36, 0
  br i1 %tobool37.not, label %while.body39, label %while.end56.loopexit
...
while.body61:                                     ; preds = %while.cond57
  ...
  %bcmp195 = call i32 @bcmp(ptr noundef nonnull dereferenceable(10) %gett, ptr noundef nonnull dereferenceable(10) @.str.100, i64 10)
  %tobool66.not = icmp eq i32 %bcmp195, 0
  br i1 %tobool66.not, label %while.end69, label %while.cond57
...
while.body74.preheader:                           ; preds = %while.end69
  ...
  %bcmp196240 = call i32 @bcmp(ptr noundef nonnull dereferenceable(10) %gett, ptr noundef nonnull dereferenceable(10) @.str.101, i64 10)
  %tobool79.not241 = icmp eq i32 %bcmp196240, 0
...
while.body74:                                     ; preds = %if.end81
  ...
  %bcmp196 = call i32 @bcmp(ptr noundef nonnull dereferenceable(10) %gett, ptr noundef nonnull dereferenceable(10) @.str.101, i64 10)
  %tobool79.not = icmp eq i32 %bcmp196, 0
  br i1 %tobool79.not, label %while.end95, label %if.end81
...
if.end81:                                         ; preds = %while.body74.preheader, %while.body74
  ...
  %call.i200 = call double @strtod(ptr nocapture noundef nonnull %sinaln, ptr noundef null) #31
  %conv = fptosi double %call.i200 to i32
  %call.i201 = call double @strtod(ptr nocapture noundef nonnull %sinseq, ptr noundef null) #31
  %conv90 = fptosi double %call.i201 to i32
  ...
  store i32 %sub91, ptr %arrayidx94, align 4
  %call71 = call i32 @feof(ptr noundef %fp) #31
  %tobool72.not = icmp eq i32 %call71, 0
  br i1 %tobool72.not, label %while.body74, label %while.end95
...
for.end.thread:                                   ; preds = %for.cond.preheader
  store i8 0, ptr %aln1, align 1
  store i8 0, ptr %aln2, align 1
...
for.body125:                                      ; preds = %for.body125, %for.body125.preheader
  ...
  br i1 %or.cond, label %for.end134, label %for.body125

for.end134.thread:                                ; preds = %for.end.thread, %for.end
  store i32 0, ptr %of2, align 4
  br label %for.end147
...
for.body138:                                      ; preds = %for.body138, %for.body138.preheader
  ...
  br i1 %or.cond234, label %for.end147, label %for.body138
...
attributes #21 = { mustprogress nofree nounwind willreturn memory(argmem: read) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
