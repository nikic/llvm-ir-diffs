...
if.end113:                                        ; preds = %lor.lhs.false88.if.end113_crit_edge, %if.end97
  ...
  %seq2.val367 = load ptr, ptr %seq2, align 8, !tbaa !9
  %seq1.val368 = load ptr, ptr %seq1, align 8, !tbaa !9
  %41 = load i8, ptr %seq2.val367, align 1, !tbaa !11
...
match_calc.exit:                                  ; preds = %while.body.i.prol.loopexit, %while.body.i, %if.end113
  %53 = load i8, ptr %seq1.val368, align 1, !tbaa !11
...
while.body.i372.prol:                             ; preds = %while.body.i372.preheader, %while.body.i372.prol
  ...
  %54 = load i8, ptr %seq2.03.i374.prol, align 1, !tbaa !11
  ...
  %55 = load i32, ptr %arrayidx7.i379.prol, align 4, !tbaa !5
  ...
  store float %conv8.i380.prol, ptr %match.addr.04.i373.prol, align 4, !tbaa !12
  %prol.iter520.next = add i32 %prol.iter520, 1
  %prol.iter520.cmp.not = icmp eq i32 %prol.iter520.next, %xtraiter518
  br i1 %prol.iter520.cmp.not, label %while.body.i372.prol.loopexit, label %while.body.i372.prol, !llvm.loop !18
...
vector.body481:                                   ; preds = %vector.body481, %vector.ph475
  ...
  %wide.load484 = load <4 x float>, ptr %75, align 4, !tbaa !12
  %76 = getelementptr inbounds float, ptr %75, i64 4
  %wide.load485 = load <4 x float>, ptr %76, align 4, !tbaa !12
  ...
  br i1 %79, label %middle.block472, label %vector.body481, !llvm.loop !22
...
vector.body498:                                   ; preds = %vector.body498, %vector.ph492
  ...
  %wide.load501 = load <4 x float>, ptr %89, align 4, !tbaa !12
  %90 = getelementptr inbounds float, ptr %89, i64 4
  %wide.load502 = load <4 x float>, ptr %90, align 4, !tbaa !12
  %91 = getelementptr inbounds float, ptr %82, i64 %offset.idx500
  store <4 x float> %wide.load501, ptr %91, align 4, !tbaa !12
  %92 = getelementptr inbounds float, ptr %91, i64 4
  store <4 x float> %wide.load502, ptr %92, align 4, !tbaa !12
  ...
  br i1 %95, label %middle.block489, label %vector.body498, !llvm.loop !25
...
while.body.i387.prol:                             ; preds = %while.body.i387.preheader, %while.body.i387.prol
  ...
  %114 = load i8, ptr %seq2.03.i389.prol, align 1, !tbaa !11
  ...
  %115 = load i32, ptr %arrayidx7.i394.prol, align 4, !tbaa !5
  ...
  store float %conv8.i395.prol, ptr %match.addr.04.i388.prol, align 4, !tbaa !12
  %prol.iter526.next = add i32 %prol.iter526, 1
  %prol.iter526.cmp.not = icmp eq i32 %prol.iter526.next, %xtraiter524
  br i1 %prol.iter526.cmp.not, label %while.body.i387.prol.loopexit, label %while.body.i387.prol, !llvm.loop !27
...
vector.body512:                                   ; preds = %vector.body512, %vector.ph507
  ...
  br i1 %152, label %middle.block504, label %vector.body512, !llvm.loop !31
...
while.body.i399.prol:                             ; preds = %while.body.preheader.i
  ...
  store ptr %incdec.ptr.i400.prol, ptr %139, align 8, !tbaa !9
  store i8 %180, ptr %incdec.ptr.i400.prol, align 1, !tbaa !11
...
while.body.i399:                                  ; preds = %while.body.i399.prol.loopexit, %while.body.i399
  ...
  store ptr %incdec.ptr.i400, ptr %139, align 8, !tbaa !9
  store i8 %186, ptr %incdec.ptr.i400, align 1, !tbaa !11
  ...
  store ptr %incdec.ptr.i400.1, ptr %139, align 8, !tbaa !9
  store i8 %191, ptr %incdec.ptr.i400.1, align 1, !tbaa !11
  ...
  br i1 %tobool.not.i401.1, label %while.end.loopexit.i, label %while.body.i399, !llvm.loop !34
...
if.end71:                                         ; preds = %if.end, %if.end21
  ...
  %seq2.val267 = load ptr, ptr %seq2, align 8, !tbaa !9
  %seq1.val268 = load ptr, ptr %seq1, align 8, !tbaa !9
  %19 = load i8, ptr %seq2.val267, align 1, !tbaa !11
...
match_calc_mtx.exit:                              ; preds = %while.body.i.prol.loopexit, %while.body.i, %if.end71
  %31 = load i8, ptr %seq1.val268, align 1, !tbaa !11
...
while.body.i272.prol:                             ; preds = %while.body.i272.preheader, %while.body.i272.prol
  ...
  %32 = load i8, ptr %seq2.03.i274.prol, align 1, !tbaa !11
  ...
  %33 = load i32, ptr %arrayidx7.i279.prol, align 4, !tbaa !5
  ...
  store float %conv8.i280.prol, ptr %match.addr.04.i273.prol, align 4, !tbaa !12
  %prol.iter385.next = add i32 %prol.iter385, 1
  %prol.iter385.cmp.not = icmp eq i32 %prol.iter385.next, %xtraiter383
  br i1 %prol.iter385.cmp.not, label %while.body.i272.prol.loopexit, label %while.body.i272.prol, !llvm.loop !39
...
vector.body358:                                   ; preds = %vector.body358, %vector.ph352
  ...
  %wide.load361 = load <4 x float>, ptr %53, align 4, !tbaa !12
  %54 = getelementptr inbounds float, ptr %53, i64 4
  %wide.load362 = load <4 x float>, ptr %54, align 4, !tbaa !12
  ...
  br i1 %57, label %middle.block349, label %vector.body358, !llvm.loop !41
...
vector.body375:                                   ; preds = %vector.body375, %vector.ph369
  ...
  %wide.load378 = load <4 x float>, ptr %66, align 4, !tbaa !12
  %67 = getelementptr inbounds float, ptr %66, i64 4
  %wide.load379 = load <4 x float>, ptr %67, align 4, !tbaa !12
  %68 = getelementptr inbounds float, ptr %60, i64 %offset.idx377
  store <4 x float> %wide.load378, ptr %68, align 4, !tbaa !12
  %69 = getelementptr inbounds float, ptr %68, i64 4
  store <4 x float> %wide.load379, ptr %69, align 4, !tbaa !12
  %index.next380 = add nuw i64 %index376, 8
  %70 = icmp eq i64 %index.next380, %n.vec371
  br i1 %70, label %middle.block366, label %vector.body375, !llvm.loop !44
...
for.body96.prol:                                  ; preds = %for.body96.preheader, %for.body96.prol
  ...
  br i1 %prol.iter388.cmp.not, label %for.body96.prol.loopexit, label %for.body96.prol, !llvm.loop !45
...
for.body96:                                       ; preds = %for.body96.prol.loopexit, %for.body96
  ...
  %81 = load float, ptr %arrayidx99.2, align 4, !tbaa !12
  %arrayidx101.2 = getelementptr inbounds float, ptr %60, i64 %indvars.iv.next330.1
  store float %81, ptr %arrayidx101.2, align 4, !tbaa !12
  ...
  %83 = load float, ptr %arrayidx99.3, align 4, !tbaa !12
  %arrayidx101.3 = getelementptr inbounds float, ptr %60, i64 %indvars.iv.next330.2
  store float %83, ptr %arrayidx101.3, align 4, !tbaa !12
...
if.else:                                          ; preds = %for.end104
  ...
  %85 = load float, ptr %arrayidx111, align 4, !tbaa !12
  %86 = load ptr, ptr @G__align11_noalign.lastverticalw, align 8, !tbaa !9
  store float %85, ptr %86, align 4, !tbaa !12
  br label %if.end113
...
for.body121.lr.ph:                                ; preds = %if.end113
  %88 = load ptr, ptr @G__align11_noalign.m, align 8, !tbaa !9
...
for.body121:                                      ; preds = %for.body121.lr.ph, %for.end163
  ...
  %92 = load float, ptr %arrayidx124, align 4, !tbaa !12
  store float %92, ptr %currentw.0317, align 4, !tbaa !12
  %arrayidx2.i = getelementptr inbounds i8, ptr %seq1.val268, i64 %indvars.iv340
  %93 = load i8, ptr %arrayidx2.i, align 1, !tbaa !11
...
while.body.i287.prol:                             ; preds = %while.body.i287.preheader, %while.body.i287.prol
  ...
  %94 = load i8, ptr %seq2.03.i289.prol, align 1, !tbaa !11
  ...
  %95 = load i32, ptr %arrayidx7.i294.prol, align 4, !tbaa !5
  ...
  store float %conv8.i295.prol, ptr %match.addr.04.i288.prol, align 4, !tbaa !12
  %prol.iter391.next = add i32 %prol.iter391, 1
  %prol.iter391.cmp.not = icmp eq i32 %prol.iter391.next, %xtraiter389
  br i1 %prol.iter391.cmp.not, label %while.body.i287.prol.loopexit, label %while.body.i287.prol, !llvm.loop !47
...
match_calc_mtx.exit298.thread:                    ; preds = %for.body121
  ...
  %96 = load float, ptr %arrayidx127347, align 4, !tbaa !12
  store float %96, ptr %previousw.0318, align 4, !tbaa !12
  br label %for.end163
...
while.body.i287:                                  ; preds = %while.body.i287.prol.loopexit, %while.body.i287
  ...
  br i1 %tobool.not.i297.3, label %match_calc_mtx.exit298, label %while.body.i287, !llvm.loop !38
...
match_calc_mtx.exit298:                           ; preds = %while.body.i287, %while.body.i287.prol.loopexit
  ...
  %105 = load float, ptr %arrayidx127, align 4, !tbaa !12
  store float %105, ptr %previousw.0318, align 4, !tbaa !12
  br i1 %cmp7, label %for.end163, label %for.body135.preheader

for.body135.preheader:                            ; preds = %match_calc_mtx.exit298
  %106 = load float, ptr %currentw.0317, align 4, !tbaa !12
...
for.body135:                                      ; preds = %for.body135.preheader, %if.end154
  ...
  %107 = load float, ptr %prept.0311, align 4, !tbaa !12
  ...
  %108 = load float, ptr %mjpt.0313, align 4, !tbaa !12
...
for.end163:                                       ; preds = %if.end154, %match_calc_mtx.exit298.thread, %match_calc_mtx.exit298
  ...
  %111 = load float, ptr %arrayidx166, align 4, !tbaa !12
  %arrayidx168 = getelementptr inbounds float, ptr %87, i64 %indvars.iv340
  store float %111, ptr %arrayidx168, align 4, !tbaa !12
