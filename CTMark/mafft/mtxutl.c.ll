; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/mafft/mtxutl.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/mafft/mtxutl.c"
...
for.cond1.preheader.us:                           ; preds = %for.cond1.preheader.us, %for.cond1.preheader.us.preheader.new
  ...
  tail call void @llvm.memset.p0.i64(ptr align 8 %3, i8 0, i64 %1, i1 false)
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx.us.1 = getelementptr inbounds ptr, ptr %mtx, i64 %indvars.iv.next
  %4 = load ptr, ptr %arrayidx.us.1, align 8
  tail call void @llvm.memset.p0.i64(ptr align 8 %4, i8 0, i64 %1, i1 false)
  %indvars.iv.next.1 = or i64 %indvars.iv, 2
  %arrayidx.us.2 = getelementptr inbounds ptr, ptr %mtx, i64 %indvars.iv.next.1
  %5 = load ptr, ptr %arrayidx.us.2, align 8
  tail call void @llvm.memset.p0.i64(ptr align 8 %5, i8 0, i64 %1, i1 false)
  %indvars.iv.next.2 = or i64 %indvars.iv, 3
  %arrayidx.us.3 = getelementptr inbounds ptr, ptr %mtx, i64 %indvars.iv.next.2
  %6 = load ptr, ptr %arrayidx.us.3, align 8
  tail call void @llvm.memset.p0.i64(ptr align 8 %6, i8 0, i64 %1, i1 false)
  %indvars.iv.next.3 = or i64 %indvars.iv, 4
  %arrayidx.us.4 = getelementptr inbounds ptr, ptr %mtx, i64 %indvars.iv.next.3
  %7 = load ptr, ptr %arrayidx.us.4, align 8
  ...
  %8 = load ptr, ptr %arrayidx.us.5, align 8
  tail call void @llvm.memset.p0.i64(ptr align 8 %8, i8 0, i64 %1, i1 false)
  %indvars.iv.next.5 = or i64 %indvars.iv, 6
  %arrayidx.us.6 = getelementptr inbounds ptr, ptr %mtx, i64 %indvars.iv.next.5
  %9 = load ptr, ptr %arrayidx.us.6, align 8
  ...
  %10 = load ptr, ptr %arrayidx.us.7, align 8
  tail call void @llvm.memset.p0.i64(ptr align 8 %10, i8 0, i64 %1, i1 false)
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %niter.next.7 = add i64 %niter, 8
  %niter.ncmp.7 = icmp eq i64 %niter.next.7, %unroll_iter
  br i1 %niter.ncmp.7, label %for.cond9.preheader.unr-lcssa, label %for.cond1.preheader.us
...
for.cond1.preheader.us.epil:                      ; preds = %for.cond9.preheader.unr-lcssa, %for.cond1.preheader.us.epil
  ...
  %11 = load ptr, ptr %arrayidx.us.epil, align 8
  tail call void @llvm.memset.p0.i64(ptr align 8 %11, i8 0, i64 %1, i1 false)
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %for.cond9.preheader, label %for.cond1.preheader.us.epil
...
for.body11:                                       ; preds = %for.body11, %for.body11.preheader.new
  ...
  %14 = load ptr, ptr %arrayidx13.1, align 8
  %arrayidx15.1 = getelementptr inbounds double, ptr %14, i64 %indvars.iv.next39
  store double 1.000000e+00, ptr %arrayidx15.1, align 8
  ...
  br i1 %niter47.ncmp.3, label %for.end18.loopexit.unr-lcssa, label %for.body11
...
for.body11.epil:                                  ; preds = %for.end18.loopexit.unr-lcssa, %for.body11.epil
  ...
  %17 = load ptr, ptr %arrayidx13.epil, align 8
  %arrayidx15.epil = getelementptr inbounds double, ptr %17, i64 %indvars.iv38.epil
  store double 1.000000e+00, ptr %arrayidx15.epil, align 8
  ...
  br i1 %epil.iter44.cmp.not, label %for.end18, label %for.body11.epil
...
for.cond2.preheader.us.us:                        ; preds = %for.cond2.preheader.us.us.preheader, %for.cond10.for.inc34_crit_edge.split.us.us.us
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 8 %call, ptr align 8 %3, i64 %1, i1 false)
...
for.body17.us.us.us.epil:                         ; preds = %for.cond14.for.end26_crit_edge.us.us.us.unr-lcssa, %for.body17.us.us.us.epil
  ...
  %20 = load double, ptr %arrayidx19.us.us.us.epil, align 8
  %arrayidx21.us.us.us.epil = getelementptr inbounds ptr, ptr %mtx2, i64 %indvars.iv.epil
  %21 = load ptr, ptr %arrayidx21.us.us.us.epil, align 8
  %arrayidx23.us.us.us.epil = getelementptr inbounds double, ptr %21, i64 %indvars.iv85
  %22 = load double, ptr %arrayidx23.us.us.us.epil, align 8
  %23 = tail call double @llvm.fmuladd.f64(double %20, double %22, double %s.062.us.us.us.epil)
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %for.cond14.for.end26_crit_edge.us.us.us, label %for.body17.us.us.us.epil
...
for.cond14.for.end26_crit_edge.us.us.us:          ; preds = %for.body17.us.us.us.epil, %for.cond14.for.end26_crit_edge.us.us.us.unr-lcssa
  ...
  store double %.lcssa, ptr %arrayidx30.us.us.us, align 8
  %indvars.iv.next86 = add nuw nsw i64 %indvars.iv85, 1
  %exitcond89.not = icmp eq i64 %indvars.iv.next86, %0
  br i1 %exitcond89.not, label %for.cond10.for.inc34_crit_edge.split.us.us.us, label %for.cond14.preheader.us.us.us
...
for.cond10.for.inc34_crit_edge.split.us.us.us:    ; preds = %for.cond14.for.end26_crit_edge.us.us.us
  ...
  br i1 %exitcond94.not, label %for.end36, label %for.cond2.preheader.us.us
...
for.cond:                                         ; preds = %for.body
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %if.end14, label %for.body
...
AllocateIntVec.exit:                              ; preds = %for.body
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %if.end6, label %for.body
...
for.body.i:                                       ; preds = %for.body, %for.body.i
  ...
  br i1 %tobool.not.i, label %FreeCharMtx.exit, label %for.body.i
...
for.body.lr.ph:                                   ; preds = %for.cond.preheader
  ...
  %wide.trip.count.i20 = zext i32 %ll3 to i64
...
for.body.i.us.us.us:                              ; preds = %for.body.us.us, %AllocateCharMtx.exit.loopexit.us.us.us
  ...
  br i1 %cmp.i.us.us.us, label %if.then.i26, label %for.body.i21.us.us.us

for.body.i21.us.us.us:                            ; preds = %for.body.i.us.us.us, %AllocateCharVec.exit.i.us.us.us
  %indvars.iv.i22.us.us.us = phi i64 [ %indvars.iv.next.i24.us.us.us, %AllocateCharVec.exit.i.us.us.us ], [ 0, %for.body.i.us.us.us ]
...
AllocateCharVec.exit.i.us.us.us:                  ; preds = %for.body.i21.us.us.us
  %arrayidx.i23.us.us.us = getelementptr inbounds ptr, ptr %call.i16.us.us.us, i64 %indvars.iv.i22.us.us.us
  store ptr %call.i.i.us.us.us, ptr %arrayidx.i23.us.us.us, align 8
  %indvars.iv.next.i24.us.us.us = add nuw nsw i64 %indvars.iv.i22.us.us.us, 1
  %exitcond.not.i25.us.us.us = icmp eq i64 %indvars.iv.next.i24.us.us.us, %wide.trip.count.i20
  br i1 %exitcond.not.i25.us.us.us, label %AllocateCharMtx.exit.loopexit.us.us.us, label %for.body.i21.us.us.us
...
AllocateCharMtx.exit.loopexit.us.us.us:           ; preds = %AllocateCharVec.exit.i.us.us.us
  ...
  store ptr null, ptr %arrayidx9.i.us.us.us, align 8
  %arrayidx.i.us.us.us = getelementptr inbounds ptr, ptr %call.i.us.us, i64 %indvars.iv.i.us.us.us
  store ptr %call.i16.us.us.us, ptr %arrayidx.i.us.us.us, align 8
  ...
  br i1 %exitcond.not.i.us.us.us, label %AllocateCharCub.exit.loopexit.split.us.us.us, label %for.body.i.us.us.us
...
AllocateCharCub.exit.loopexit.split.us.us.us:     ; preds = %AllocateCharMtx.exit.loopexit.us.us.us
  ...
  store ptr null, ptr %arrayidx8.i.us.us, align 8
  %arrayidx.us.us = getelementptr inbounds ptr, ptr %call, i64 %indvars.iv51
  store ptr %call.i.us.us, ptr %arrayidx.us.us, align 8
  %indvars.iv.next52 = add nuw nsw i64 %indvars.iv51, 1
  %exitcond55.not = icmp eq i64 %indvars.iv.next52, %wide.trip.count54
  br i1 %exitcond55.not, label %for.end, label %for.body.us.us
...
for.body.i.us29:                                  ; preds = %for.body.us, %if.end.i17.us33
  %indvars.iv.i.us30 = phi i64 [ %indvars.iv.next.i.us36, %if.end.i17.us33 ], [ 0, %for.body.us ]
  ...
  br i1 %cmp.i.us32, label %if.then.i26, label %if.end.i17.us33

if.end.i17.us33:                                  ; preds = %for.body.i.us29
  %arrayidx9.i.us34 = getelementptr inbounds ptr, ptr %call.i16.us31, i64 %idxprom8.i
  store ptr null, ptr %arrayidx9.i.us34, align 8
  %arrayidx.i.us35 = getelementptr inbounds ptr, ptr %call.i.us, i64 %indvars.iv.i.us30
  store ptr %call.i16.us31, ptr %arrayidx.i.us35, align 8
  ...
  br i1 %exitcond.not.i.us37, label %AllocateCharCub.exit.loopexit.split.us38, label %for.body.i.us29

AllocateCharCub.exit.loopexit.split.us38:         ; preds = %if.end.i17.us33
  %arrayidx8.i.us = getelementptr inbounds ptr, ptr %call.i.us, i64 %idxprom7.i
  store ptr null, ptr %arrayidx8.i.us, align 8
  ...
  br i1 %exitcond50.not, label %for.end, label %for.body.us
...
for.body.i.i:                                     ; preds = %for.body.i, %for.body.i.i
  ...
  br i1 %tobool.not.i.i, label %FreeCharMtx.exit.i, label %for.body.i.i
...
FreeCharMtx.exit.i:                               ; preds = %for.body.i.i, %for.body.i
  ...
  br i1 %tobool.not.i, label %FreeCharCub.exit, label %for.body.i
...
for.body.i:                                       ; preds = %for.body, %for.body.i
  ...
  %4 = load ptr, ptr %arrayidx.i, align 8
  %tobool.not.i = icmp eq ptr %4, null
  br i1 %tobool.not.i, label %FreeIntMtx.exit, label %for.body.i
...
for.body.i:                                       ; preds = %for.body, %for.body.i
  ...
  %4 = load ptr, ptr %arrayidx.i, align 8
  %tobool.not.i = icmp eq ptr %4, null
  br i1 %tobool.not.i, label %FreeFloatMtx.exit, label %for.body.i
...
for.body.i.us:                                    ; preds = %for.body.us, %for.body.i.us
  ...
  store ptr %call.i.i.us, ptr %arrayidx.i.us, align 8
  %indvars.iv.next.i.us = add nuw nsw i64 %indvars.iv.i.us, 1
  %exitcond.not.i.us = icmp eq i64 %indvars.iv.next.i.us, %wide.trip.count.i
  br i1 %exitcond.not.i.us, label %AllocateDoubleMtx.exit.loopexit.us, label %for.body.i.us
...
AllocateDoubleMtx.exit.loopexit.us:               ; preds = %for.body.i.us
  ...
  br i1 %exitcond22.not, label %for.end, label %for.body.us
...
for.body.i:                                       ; preds = %for.body, %for.body.i
  ...
  %4 = load ptr, ptr %arrayidx.i, align 8
  %tobool.not.i = icmp eq ptr %4, null
  br i1 %tobool.not.i, label %FreeDoubleMtx.exit, label %for.body.i
