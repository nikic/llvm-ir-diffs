; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/mafft/genGalign11.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/mafft/genGalign11.c"
...
entry:
  ...
  %1 = load i32, ptr @penalty_OP, align 4
  %conv1 = sitofp i32 %1 to float
  %2 = load i32, ptr @penalty_ex, align 4
  %conv2 = sitofp i32 %2 to float
  %3 = load i32, ptr @genG__align11.orlgth1, align 4
  %cmp = icmp eq i32 %3, 0
...
if.then:                                          ; preds = %entry
  ...
  store ptr %call, ptr @genG__align11.mseq1, align 8
  %5 = load i32, ptr @njob, align 4
  %call4 = tail call ptr @AllocateCharMtx(i32 noundef %5, i32 noundef 0) #6
  store ptr %call4, ptr @genG__align11.mseq2, align 8
  br label %if.end
...
if.then27:                                        ; preds = %if.then22
  %11 = load ptr, ptr @genG__align11.w1, align 8
  tail call void @FreeFloatVec(ptr noundef %11) #6
  %12 = load ptr, ptr @genG__align11.w2, align 8
  tail call void @FreeFloatVec(ptr noundef %12) #6
  %13 = load ptr, ptr @genG__align11.match, align 8
  tail call void @FreeFloatVec(ptr noundef %13) #6
  %14 = load ptr, ptr @genG__align11.initverticalw, align 8
  tail call void @FreeFloatVec(ptr noundef %14) #6
  %15 = load ptr, ptr @genG__align11.lastverticalw, align 8
  tail call void @FreeFloatVec(ptr noundef %15) #6
  %16 = load ptr, ptr @genG__align11.m, align 8
  tail call void @FreeFloatVec(ptr noundef %16) #6
  %17 = load ptr, ptr @genG__align11.mp, align 8
  tail call void @FreeIntVec(ptr noundef %17) #6
  %18 = load ptr, ptr @genG__align11.largeM, align 8
  tail call void @FreeFloatVec(ptr noundef %18) #6
  %19 = load ptr, ptr @genG__align11.Mp, align 8
  tail call void @FreeIntVec(ptr noundef %19) #6
  %20 = load ptr, ptr @genG__align11.mseq, align 8
  tail call void @FreeCharMtx(ptr noundef %20) #6
  %21 = load ptr, ptr @genG__align11.cpmx1, align 8
  tail call void @FreeFloatMtx(ptr noundef %21) #6
  %22 = load ptr, ptr @genG__align11.cpmx2, align 8
  tail call void @FreeFloatMtx(ptr noundef %22) #6
  %23 = load ptr, ptr @genG__align11.floatwork, align 8
  tail call void @FreeFloatMtx(ptr noundef %23) #6
  %24 = load ptr, ptr @genG__align11.intwork, align 8
  tail call void @FreeIntMtx(ptr noundef %24) #6
  %.pre = load i32, ptr @genG__align11.orlgth1, align 4
  %.pre572 = load i32, ptr @genG__align11.orlgth2, align 4
  br label %if.end28
...
if.end28:                                         ; preds = %if.then27, %if.then22
  ...
  store ptr %call80, ptr @genG__align11.floatwork, align 8
  %call88 = tail call ptr @AllocateIntMtx(i32 noundef 26, i32 noundef %add79) #6
  store ptr %call88, ptr @genG__align11.intwork, align 8
  store i32 %conv30., ptr @genG__align11.orlgth1, align 4
  store i32 %cond47, ptr @genG__align11.orlgth2, align 4
  br label %if.end90

if.end90:                                         ; preds = %if.end16, %if.end28
  %28 = phi i32 [ %10, %if.end16 ], [ %cond47, %if.end28 ]
  %29 = phi i32 [ %9, %if.end16 ], [ %conv30., %if.end28 ]
  %30 = load ptr, ptr @genG__align11.mseq, align 8
  %31 = load ptr, ptr %30, align 8
  %32 = load ptr, ptr @genG__align11.mseq1, align 8
  store ptr %31, ptr %32, align 8
  %arrayidx93 = getelementptr inbounds ptr, ptr %30, i64 1
  %33 = load ptr, ptr %arrayidx93, align 8
  %34 = load ptr, ptr @genG__align11.mseq2, align 8
...
lor.lhs.false97.if.end125_crit_edge:              ; preds = %if.end90
  %.pre578 = load ptr, ptr @commonJP, align 8
  br label %if.end125
...
if.then105:                                       ; preds = %if.then100
  %36 = load ptr, ptr @commonIP, align 8
  tail call void @FreeIntMtx(ptr noundef %36) #6
  %37 = load ptr, ptr @commonJP, align 8
...
if.end106:                                        ; preds = %if.then105, %if.then100
  ...
  store ptr %call121, ptr @commonIP, align 8
  %call124 = tail call ptr @AllocateIntMtx(i32 noundef %add119, i32 noundef %add120) #6
  store ptr %call124, ptr @commonJP, align 8
  store i32 %cond112, ptr @commonAlloc1, align 4
  store i32 %cond118, ptr @commonAlloc2, align 4
  br label %if.end125
...
if.end125:                                        ; preds = %lor.lhs.false97.if.end125_crit_edge, %if.end106
  ...
  %43 = load ptr, ptr @commonIP, align 8
  store ptr %43, ptr @genG__align11.ijpi, align 8
  store ptr %42, ptr @genG__align11.ijpj, align 8
  %44 = load ptr, ptr @genG__align11.w1, align 8
  %45 = load ptr, ptr @genG__align11.w2, align 8
  %46 = load ptr, ptr @genG__align11.initverticalw, align 8
  %seq2.val463 = load ptr, ptr %seq2, align 8
  %seq1.val464 = load ptr, ptr %seq1, align 8
  %47 = load i8, ptr %seq2.val463, align 1
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  %51 = load i8, ptr %seq2.03.i, align 1
  ...
  %54 = load i32, ptr %arrayidx7.i.1, align 4
...
match_calc.exit:                                  ; preds = %while.body.i.prol.loopexit, %while.body.i, %if.end125
  %59 = load i8, ptr %seq1.val464, align 1
  ...
  br i1 %tobool.not1.i467, label %match_calc.exit479, label %while.body.i468.preheader

while.body.i468.preheader:                        ; preds = %match_calc.exit
  %xtraiter655 = and i32 %conv9, 3
  %lcmp.mod656.not = icmp eq i32 %xtraiter655, 0
  br i1 %lcmp.mod656.not, label %while.body.i468.prol.loopexit, label %while.body.i468.prol

while.body.i468.prol:                             ; preds = %while.body.i468.preheader, %while.body.i468.prol
  %match.addr.04.i469.prol = phi ptr [ %incdec.ptr9.i477.prol, %while.body.i468.prol ], [ %44, %while.body.i468.preheader ]
  %seq2.03.i470.prol = phi ptr [ %incdec.ptr.i473.prol, %while.body.i468.prol ], [ %seq2.val463, %while.body.i468.preheader ]
  %lgth2.addr.02.i471.prol = phi i32 [ %dec.i472.prol, %while.body.i468.prol ], [ %conv9, %while.body.i468.preheader ]
  %prol.iter657 = phi i32 [ %prol.iter657.next, %while.body.i468.prol ], [ 0, %while.body.i468.preheader ]
  %dec.i472.prol = add nsw i32 %lgth2.addr.02.i471.prol, -1
  %incdec.ptr.i473.prol = getelementptr inbounds i8, ptr %seq2.03.i470.prol, i64 1
  %60 = load i8, ptr %seq2.03.i470.prol, align 1
  %idxprom6.i474.prol = sext i8 %60 to i64
  %arrayidx7.i475.prol = getelementptr inbounds i32, ptr %arrayidx4.i466, i64 %idxprom6.i474.prol
  %61 = load i32, ptr %arrayidx7.i475.prol, align 4
  %conv8.i476.prol = sitofp i32 %61 to float
  %incdec.ptr9.i477.prol = getelementptr inbounds float, ptr %match.addr.04.i469.prol, i64 1
  store float %conv8.i476.prol, ptr %match.addr.04.i469.prol, align 4
  %prol.iter657.next = add i32 %prol.iter657, 1
  %prol.iter657.cmp.not = icmp eq i32 %prol.iter657.next, %xtraiter655
  br i1 %prol.iter657.cmp.not, label %while.body.i468.prol.loopexit, label %while.body.i468.prol

while.body.i468.prol.loopexit:                    ; preds = %while.body.i468.prol, %while.body.i468.preheader
  %match.addr.04.i469.unr = phi ptr [ %44, %while.body.i468.preheader ], [ %incdec.ptr9.i477.prol, %while.body.i468.prol ]
  %seq2.03.i470.unr = phi ptr [ %seq2.val463, %while.body.i468.preheader ], [ %incdec.ptr.i473.prol, %while.body.i468.prol ]
  %lgth2.addr.02.i471.unr = phi i32 [ %conv9, %while.body.i468.preheader ], [ %dec.i472.prol, %while.body.i468.prol ]
  %62 = icmp ult i32 %conv9, 4
  br i1 %62, label %match_calc.exit479, label %while.body.i468

while.body.i468:                                  ; preds = %while.body.i468.prol.loopexit, %while.body.i468
  %match.addr.04.i469 = phi ptr [ %incdec.ptr9.i477.3, %while.body.i468 ], [ %match.addr.04.i469.unr, %while.body.i468.prol.loopexit ]
  %seq2.03.i470 = phi ptr [ %incdec.ptr.i473.3, %while.body.i468 ], [ %seq2.03.i470.unr, %while.body.i468.prol.loopexit ]
  %lgth2.addr.02.i471 = phi i32 [ %dec.i472.3, %while.body.i468 ], [ %lgth2.addr.02.i471.unr, %while.body.i468.prol.loopexit ]
  %incdec.ptr.i473 = getelementptr inbounds i8, ptr %seq2.03.i470, i64 1
  %63 = load i8, ptr %seq2.03.i470, align 1
  %idxprom6.i474 = sext i8 %63 to i64
  %arrayidx7.i475 = getelementptr inbounds i32, ptr %arrayidx4.i466, i64 %idxprom6.i474
  %64 = load i32, ptr %arrayidx7.i475, align 4
  %conv8.i476 = sitofp i32 %64 to float
  %incdec.ptr9.i477 = getelementptr inbounds float, ptr %match.addr.04.i469, i64 1
  store float %conv8.i476, ptr %match.addr.04.i469, align 4
  %incdec.ptr.i473.1 = getelementptr inbounds i8, ptr %seq2.03.i470, i64 2
  %65 = load i8, ptr %incdec.ptr.i473, align 1
  %idxprom6.i474.1 = sext i8 %65 to i64
  %arrayidx7.i475.1 = getelementptr inbounds i32, ptr %arrayidx4.i466, i64 %idxprom6.i474.1
  %66 = load i32, ptr %arrayidx7.i475.1, align 4
  %conv8.i476.1 = sitofp i32 %66 to float
  %incdec.ptr9.i477.1 = getelementptr inbounds float, ptr %match.addr.04.i469, i64 2
  store float %conv8.i476.1, ptr %incdec.ptr9.i477, align 4
  %incdec.ptr.i473.2 = getelementptr inbounds i8, ptr %seq2.03.i470, i64 3
  %67 = load i8, ptr %incdec.ptr.i473.1, align 1
  %idxprom6.i474.2 = sext i8 %67 to i64
  %arrayidx7.i475.2 = getelementptr inbounds i32, ptr %arrayidx4.i466, i64 %idxprom6.i474.2
  %68 = load i32, ptr %arrayidx7.i475.2, align 4
  %conv8.i476.2 = sitofp i32 %68 to float
  %incdec.ptr9.i477.2 = getelementptr inbounds float, ptr %match.addr.04.i469, i64 3
  store float %conv8.i476.2, ptr %incdec.ptr9.i477.1, align 4
  %dec.i472.3 = add nsw i32 %lgth2.addr.02.i471, -4
  %incdec.ptr.i473.3 = getelementptr inbounds i8, ptr %seq2.03.i470, i64 4
  %69 = load i8, ptr %incdec.ptr.i473.2, align 1
  %idxprom6.i474.3 = sext i8 %69 to i64
  %arrayidx7.i475.3 = getelementptr inbounds i32, ptr %arrayidx4.i466, i64 %idxprom6.i474.3
  %70 = load i32, ptr %arrayidx7.i475.3, align 4
  %conv8.i476.3 = sitofp i32 %70 to float
  %incdec.ptr9.i477.3 = getelementptr inbounds float, ptr %match.addr.04.i469, i64 4
  store float %conv8.i476.3, ptr %incdec.ptr9.i477.2, align 4
  %tobool.not.i478.3 = icmp eq i32 %dec.i472.3, 0
  br i1 %tobool.not.i478.3, label %match_calc.exit479, label %while.body.i468

match_calc.exit479:                               ; preds = %while.body.i468.prol.loopexit, %while.body.i468, %match_calc.exit
  %71 = load i32, ptr @outgap, align 4
...
for.body.preheader:                               ; preds = %for.cond.preheader
  ...
  br i1 %min.iters.check, label %for.body.preheader654, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %74, align 4
  %75 = getelementptr inbounds float, ptr %74, i64 4
  %wide.load586 = load <4 x float>, ptr %75, align 4
  %76 = fadd <4 x float> %wide.load, %broadcast.splat
  %77 = fadd <4 x float> %wide.load586, %broadcast.splat
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.cond134.preheader, label %for.body.preheader654

for.body.preheader654:                            ; preds = %for.body.preheader, %middle.block
...
for.body138.preheader:                            ; preds = %for.cond134.preheader
  ...
  %min.iters.check589 = icmp ult i64 %80, 8
  br i1 %min.iters.check589, label %for.body138.preheader653, label %vector.ph590

vector.ph590:                                     ; preds = %for.body138.preheader
  %n.vec592 = and i64 %80, -8
  %ind.end593 = or i64 %n.vec592, 1
  %broadcast.splatinsert601 = insertelement <4 x float> poison, float %conv, i64 0
  %broadcast.splat602 = shufflevector <4 x float> %broadcast.splatinsert601, <4 x float> poison, <4 x i32> zeroinitializer
  br label %vector.body596

vector.body596:                                   ; preds = %vector.body596, %vector.ph590
  %index597 = phi i64 [ 0, %vector.ph590 ], [ %index.next603, %vector.body596 ]
  %offset.idx598 = or i64 %index597, 1
  %81 = getelementptr inbounds float, ptr %44, i64 %offset.idx598
  %wide.load599 = load <4 x float>, ptr %81, align 4
  %82 = getelementptr inbounds float, ptr %81, i64 4
  %wide.load600 = load <4 x float>, ptr %82, align 4
  %83 = fadd <4 x float> %wide.load599, %broadcast.splat602
  %84 = fadd <4 x float> %wide.load600, %broadcast.splat602
  store <4 x float> %83, ptr %81, align 4
  store <4 x float> %84, ptr %82, align 4
  %index.next603 = add nuw i64 %index597, 8
  %85 = icmp eq i64 %index.next603, %n.vec592
  br i1 %85, label %middle.block587, label %vector.body596

middle.block587:                                  ; preds = %vector.body596
  %cmp.n595 = icmp eq i64 %80, %n.vec592
  br i1 %cmp.n595, label %if.end145, label %for.body138.preheader653

for.body138.preheader653:                         ; preds = %for.body138.preheader, %middle.block587
  %indvars.iv549.ph = phi i64 [ 1, %for.body138.preheader ], [ %ind.end593, %middle.block587 ]
  br label %for.body138

for.body:                                         ; preds = %for.body.preheader654, %for.body
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body ], [ %indvars.iv.ph, %for.body.preheader654 ]
  %arrayidx132 = getelementptr inbounds float, ptr %46, i64 %indvars.iv
  %86 = load float, ptr %arrayidx132, align 4
  %add133 = fadd float %86, %conv
  store float %add133, ptr %arrayidx132, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.cond134.preheader, label %for.body

for.body138:                                      ; preds = %for.body138.preheader653, %for.body138
  %indvars.iv549 = phi i64 [ %indvars.iv.next550, %for.body138 ], [ %indvars.iv549.ph, %for.body138.preheader653 ]
  %arrayidx140 = getelementptr inbounds float, ptr %44, i64 %indvars.iv549
  %87 = load float, ptr %arrayidx140, align 4
  %add141 = fadd float %87, %conv
  store float %add141, ptr %arrayidx140, align 4
  %indvars.iv.next550 = add nuw nsw i64 %indvars.iv549, 1
  %exitcond553.not = icmp eq i64 %indvars.iv.next550, %wide.trip.count552
  br i1 %exitcond553.not, label %if.end145, label %for.body138

if.end145:                                        ; preds = %for.body138, %middle.block587, %match_calc.exit479
  br i1 %cmp12, label %for.end167, label %for.body150.lr.ph

for.body150.lr.ph:                                ; preds = %if.end145
  %88 = load ptr, ptr @genG__align11.m, align 8
  %89 = load ptr, ptr @genG__align11.mp, align 8
  %90 = load ptr, ptr @genG__align11.largeM, align 8
  %91 = load ptr, ptr @genG__align11.Mp, align 8
  %92 = add i64 %call8, 1
  %wide.trip.count558 = and i64 %92, 4294967295
  %93 = add nsw i64 %wide.trip.count558, -1
  %min.iters.check625 = icmp ult i64 %93, 20
  br i1 %min.iters.check625, label %for.body150.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %for.body150.lr.ph
  %scevgep = getelementptr i8, ptr %88, i64 4
  %94 = shl nuw nsw i64 %wide.trip.count558, 2
  %scevgep604 = getelementptr i8, ptr %88, i64 %94
  %scevgep605 = getelementptr i8, ptr %90, i64 4
  %scevgep606 = getelementptr i8, ptr %90, i64 %94
  %95 = add nsw i64 %94, -4
  %scevgep607 = getelementptr i8, ptr %44, i64 %95
  %scevgep608 = getelementptr i8, ptr %89, i64 4
  %scevgep609 = getelementptr i8, ptr %89, i64 %94
  %scevgep610 = getelementptr i8, ptr %91, i64 4
  %scevgep611 = getelementptr i8, ptr %91, i64 %94
  %bound0 = icmp ult ptr %scevgep, %scevgep606
  %bound1 = icmp ult ptr %scevgep605, %scevgep604
  %found.conflict = and i1 %bound0, %bound1
  %bound0612 = icmp ult ptr %scevgep, %scevgep607
  %bound1613 = icmp ult ptr %44, %scevgep604
  %found.conflict614 = and i1 %bound0612, %bound1613
  %conflict.rdx = or i1 %found.conflict, %found.conflict614
  %bound0615 = icmp ult ptr %scevgep605, %scevgep607
  %bound1616 = icmp ult ptr %44, %scevgep606
  %found.conflict617 = and i1 %bound0615, %bound1616
  %conflict.rdx618 = or i1 %conflict.rdx, %found.conflict617
  %bound0619 = icmp ult ptr %scevgep608, %scevgep611
  %bound1620 = icmp ult ptr %scevgep610, %scevgep609
  %found.conflict621 = and i1 %bound0619, %bound1620
  %conflict.rdx622 = or i1 %conflict.rdx618, %found.conflict621
  br i1 %conflict.rdx622, label %for.body150.preheader, label %vector.ph626

vector.ph626:                                     ; preds = %vector.memcheck
  %n.vec628 = and i64 %93, -4
  %ind.end629 = or i64 %n.vec628, 1
  br label %vector.body632

vector.body632:                                   ; preds = %vector.body632, %vector.ph626
  %index633 = phi i64 [ 0, %vector.ph626 ], [ %index.next637, %vector.body632 ]
  %offset.idx634 = or i64 %index633, 1
  %96 = getelementptr inbounds float, ptr %44, i64 %index633
  %wide.load635 = load <4 x float>, ptr %96, align 4
  %97 = getelementptr inbounds float, ptr %88, i64 %offset.idx634
  store <4 x float> %wide.load635, ptr %97, align 4
  %98 = getelementptr inbounds i32, ptr %89, i64 %offset.idx634
  store <4 x i32> zeroinitializer, ptr %98, align 4
  %99 = getelementptr inbounds float, ptr %90, i64 %offset.idx634
  store <4 x float> %wide.load635, ptr %99, align 4
  %100 = getelementptr inbounds i32, ptr %91, i64 %offset.idx634
  store <4 x i32> zeroinitializer, ptr %100, align 4
  %index.next637 = add nuw i64 %index633, 4
  %101 = icmp eq i64 %index.next637, %n.vec628
  br i1 %101, label %middle.block623, label %vector.body632

middle.block623:                                  ; preds = %vector.body632
  %cmp.n631 = icmp eq i64 %93, %n.vec628
  br i1 %cmp.n631, label %for.end167, label %for.body150.preheader

for.body150.preheader:                            ; preds = %vector.memcheck, %for.body150.lr.ph, %middle.block623
  %indvars.iv554.ph = phi i64 [ 1, %vector.memcheck ], [ 1, %for.body150.lr.ph ], [ %ind.end629, %middle.block623 ]
  %.neg = add nsw i64 %indvars.iv554.ph, 1
  %xtraiter658 = and i64 %call8, 1
  %lcmp.mod659.not = icmp eq i64 %xtraiter658, 0
  br i1 %lcmp.mod659.not, label %for.body150.prol.loopexit, label %for.body150.prol
...
for.body150:                                      ; preds = %for.body150.prol.loopexit, %for.body150
  ...
  %107 = load float, ptr %arrayidx153, align 4
  %arrayidx155 = getelementptr inbounds float, ptr %88, i64 %indvars.iv554
  store float %107, ptr %arrayidx155, align 4
  ...
  store float %108, ptr %arrayidx162, align 4
  ...
  br i1 %exitcond559.not.1, label %for.end167, label %for.body150

for.end167:                                       ; preds = %for.body150.prol.loopexit, %for.body150, %middle.block623, %for.cond134.preheader, %if.end145
  br i1 %tobool.not1.i467, label %if.then170, label %if.else

if.then170:                                       ; preds = %for.end167
  %111 = load ptr, ptr @genG__align11.lastverticalw, align 8
...
if.else:                                          ; preds = %for.end167
  ...
  %112 = load float, ptr %arrayidx174, align 4
  %113 = load ptr, ptr @genG__align11.lastverticalw, align 8
  store float %112, ptr %113, align 4
  br label %if.end176

if.end176:                                        ; preds = %if.else, %if.then170
  %114 = phi ptr [ %113, %if.else ], [ %111, %if.then170 ]
  %115 = load i32, ptr @outgap, align 4
...
for.body185.lr.ph:                                ; preds = %if.end176
  %116 = load ptr, ptr @genG__align11.m, align 8
  %117 = load ptr, ptr @genG__align11.largeM, align 8
  %118 = load ptr, ptr @genG__align11.mp, align 8
  %119 = load ptr, ptr @genG__align11.Mp, align 8
...
for.body185:                                      ; preds = %for.body185.lr.ph, %for.end272
  ...
  %123 = load float, ptr %arrayidx188, align 4
  store float %123, ptr %currentw.0539, align 4
  %arrayidx2.i = getelementptr inbounds i8, ptr %seq1.val464, i64 %indvars.iv566
  %124 = load i8, ptr %arrayidx2.i, align 1
  ...
  br i1 %tobool.not1.i467, label %match_calc.exit494.thread, label %while.body.i483.preheader

while.body.i483.preheader:                        ; preds = %for.body185
  br i1 %lcmp.mod662.not, label %while.body.i483.prol.loopexit, label %while.body.i483.prol

while.body.i483.prol:                             ; preds = %while.body.i483.preheader, %while.body.i483.prol
  %match.addr.04.i484.prol = phi ptr [ %incdec.ptr9.i492.prol, %while.body.i483.prol ], [ %previousw.0538, %while.body.i483.preheader ]
  %seq2.03.i485.prol = phi ptr [ %incdec.ptr.i488.prol, %while.body.i483.prol ], [ %seq2.val463, %while.body.i483.preheader ]
  %lgth2.addr.02.i486.prol = phi i32 [ %dec.i487.prol, %while.body.i483.prol ], [ %conv9, %while.body.i483.preheader ]
  %prol.iter663 = phi i32 [ %prol.iter663.next, %while.body.i483.prol ], [ 0, %while.body.i483.preheader ]
  %dec.i487.prol = add nsw i32 %lgth2.addr.02.i486.prol, -1
  %incdec.ptr.i488.prol = getelementptr inbounds i8, ptr %seq2.03.i485.prol, i64 1
  %125 = load i8, ptr %seq2.03.i485.prol, align 1
  %idxprom6.i489.prol = sext i8 %125 to i64
  %arrayidx7.i490.prol = getelementptr inbounds i32, ptr %arrayidx4.i481, i64 %idxprom6.i489.prol
  %126 = load i32, ptr %arrayidx7.i490.prol, align 4
  %conv8.i491.prol = sitofp i32 %126 to float
  %incdec.ptr9.i492.prol = getelementptr inbounds float, ptr %match.addr.04.i484.prol, i64 1
  store float %conv8.i491.prol, ptr %match.addr.04.i484.prol, align 4
  %prol.iter663.next = add i32 %prol.iter663, 1
  %prol.iter663.cmp.not = icmp eq i32 %prol.iter663.next, %xtraiter661
  br i1 %prol.iter663.cmp.not, label %while.body.i483.prol.loopexit, label %while.body.i483.prol

while.body.i483.prol.loopexit:                    ; preds = %while.body.i483.prol, %while.body.i483.preheader
  %match.addr.04.i484.unr = phi ptr [ %previousw.0538, %while.body.i483.preheader ], [ %incdec.ptr9.i492.prol, %while.body.i483.prol ]
  %seq2.03.i485.unr = phi ptr [ %seq2.val463, %while.body.i483.preheader ], [ %incdec.ptr.i488.prol, %while.body.i483.prol ]
  %lgth2.addr.02.i486.unr = phi i32 [ %conv9, %while.body.i483.preheader ], [ %dec.i487.prol, %while.body.i483.prol ]
  br i1 %121, label %match_calc.exit494, label %while.body.i483

match_calc.exit494.thread:                        ; preds = %for.body185
  %arrayidx191583 = getelementptr inbounds float, ptr %46, i64 %indvars.iv566
  %127 = load float, ptr %arrayidx191583, align 4
  store float %127, ptr %previousw.0538, align 4
  br label %for.end272

while.body.i483:                                  ; preds = %while.body.i483.prol.loopexit, %while.body.i483
  %match.addr.04.i484 = phi ptr [ %incdec.ptr9.i492.3, %while.body.i483 ], [ %match.addr.04.i484.unr, %while.body.i483.prol.loopexit ]
  %seq2.03.i485 = phi ptr [ %incdec.ptr.i488.3, %while.body.i483 ], [ %seq2.03.i485.unr, %while.body.i483.prol.loopexit ]
  %lgth2.addr.02.i486 = phi i32 [ %dec.i487.3, %while.body.i483 ], [ %lgth2.addr.02.i486.unr, %while.body.i483.prol.loopexit ]
  %incdec.ptr.i488 = getelementptr inbounds i8, ptr %seq2.03.i485, i64 1
  %128 = load i8, ptr %seq2.03.i485, align 1
  %idxprom6.i489 = sext i8 %128 to i64
  %arrayidx7.i490 = getelementptr inbounds i32, ptr %arrayidx4.i481, i64 %idxprom6.i489
  %129 = load i32, ptr %arrayidx7.i490, align 4
  %conv8.i491 = sitofp i32 %129 to float
  %incdec.ptr9.i492 = getelementptr inbounds float, ptr %match.addr.04.i484, i64 1
  store float %conv8.i491, ptr %match.addr.04.i484, align 4
  %incdec.ptr.i488.1 = getelementptr inbounds i8, ptr %seq2.03.i485, i64 2
  %130 = load i8, ptr %incdec.ptr.i488, align 1
  %idxprom6.i489.1 = sext i8 %130 to i64
  %arrayidx7.i490.1 = getelementptr inbounds i32, ptr %arrayidx4.i481, i64 %idxprom6.i489.1
  %131 = load i32, ptr %arrayidx7.i490.1, align 4
  %conv8.i491.1 = sitofp i32 %131 to float
  %incdec.ptr9.i492.1 = getelementptr inbounds float, ptr %match.addr.04.i484, i64 2
  store float %conv8.i491.1, ptr %incdec.ptr9.i492, align 4
  %incdec.ptr.i488.2 = getelementptr inbounds i8, ptr %seq2.03.i485, i64 3
  %132 = load i8, ptr %incdec.ptr.i488.1, align 1
  %idxprom6.i489.2 = sext i8 %132 to i64
  %arrayidx7.i490.2 = getelementptr inbounds i32, ptr %arrayidx4.i481, i64 %idxprom6.i489.2
  %133 = load i32, ptr %arrayidx7.i490.2, align 4
  %conv8.i491.2 = sitofp i32 %133 to float
  %incdec.ptr9.i492.2 = getelementptr inbounds float, ptr %match.addr.04.i484, i64 3
  store float %conv8.i491.2, ptr %incdec.ptr9.i492.1, align 4
  %dec.i487.3 = add nsw i32 %lgth2.addr.02.i486, -4
  %incdec.ptr.i488.3 = getelementptr inbounds i8, ptr %seq2.03.i485, i64 4
  %134 = load i8, ptr %incdec.ptr.i488.2, align 1
  %idxprom6.i489.3 = sext i8 %134 to i64
  %arrayidx7.i490.3 = getelementptr inbounds i32, ptr %arrayidx4.i481, i64 %idxprom6.i489.3
  %135 = load i32, ptr %arrayidx7.i490.3, align 4
  %conv8.i491.3 = sitofp i32 %135 to float
  %incdec.ptr9.i492.3 = getelementptr inbounds float, ptr %match.addr.04.i484, i64 4
  store float %conv8.i491.3, ptr %incdec.ptr9.i492.2, align 4
  %tobool.not.i493.3 = icmp eq i32 %dec.i487.3, 0
  br i1 %tobool.not.i493.3, label %match_calc.exit494, label %while.body.i483

match_calc.exit494:                               ; preds = %while.body.i483, %while.body.i483.prol.loopexit
  %arrayidx191 = getelementptr inbounds float, ptr %46, i64 %indvars.iv566
  %136 = load float, ptr %arrayidx191, align 4
  store float %136, ptr %previousw.0538, align 4
  br i1 %cmp12, label %for.end272, label %for.body209.preheader

for.body209.preheader:                            ; preds = %match_calc.exit494
  %137 = load float, ptr %currentw.0539, align 4
  %arrayidx198 = getelementptr inbounds ptr, ptr %42, i64 %indvars.iv566
  %138 = load ptr, ptr %arrayidx198, align 8
  %arrayidx196 = getelementptr inbounds ptr, ptr %43, i64 %indvars.iv566
  %139 = load ptr, ptr %arrayidx196, align 8
...
for.body209:                                      ; preds = %for.body209.preheader, %if.end256
  ...
  %142 = load float, ptr %prept.0521, align 4
  store i32 %140, ptr %ijpipt.0531, align 4
  ...
  store i32 %storemerge, ptr %ijpjpt.0530, align 4
  ...
  %145 = load float, ptr %mjpt.0529, align 4
...
if.then226:                                       ; preds = %for.body209
  %146 = load i32, ptr %mpjpt.0527, align 4
  store i32 %146, ptr %ijpipt.0531, align 4
  store i32 %144, ptr %ijpjpt.0530, align 4
  br label %if.end228
...
if.then231:                                       ; preds = %if.end228
  store float %142, ptr %mjpt.0529, align 4
  store i32 %140, ptr %mpjpt.0527, align 4
  br label %if.end233

if.end233:                                        ; preds = %if.then231, %if.end228
  %arrayidx235 = getelementptr inbounds float, ptr %116, i64 %indvars.iv560
  %147 = load float, ptr %arrayidx235, align 4
...
if.then240:                                       ; preds = %if.end233
  store i32 %tbki.0523, ptr %ijpipt.0531, align 4
  store i32 %tbkj.0524, ptr %ijpjpt.0530, align 4
  br label %if.end241
...
if.end251:                                        ; preds = %if.then249, %if.end241
  ...
  %150 = load float, ptr %prept.0521, align 4
  %cmp252 = fcmp ogt float %150, %148
  br i1 %cmp252, label %if.then254, label %if.end256

if.then254:                                       ; preds = %if.end251
  store float %150, ptr %Mjpt.0528, align 4
  store i32 %140, ptr %Mpjpt.0526, align 4
  %.pre579 = load float, ptr %prept.0521, align 4
  br label %if.end256
...
if.end256:                                        ; preds = %if.then254, %if.end251
  ...
  %153 = load float, ptr %curpt.0532, align 4
  %add262 = fadd float %wm.4, %153
  store float %add262, ptr %curpt.0532, align 4
  ...
  br i1 %exitcond565.not, label %for.end272, label %for.body209
...
for.cond10.preheader.i.loopexit.unr-lcssa:        ; preds = %for.body.i, %for.body.preheader.i
  ...
  br i1 %lcmp.mod665.not, label %for.cond10.preheader.i, label %for.body.i.epil
...
for.body.i.epil:                                  ; preds = %for.cond10.preheader.i.loopexit.unr-lcssa, %for.body.i.epil
  ...
  %160 = load ptr, ptr %arrayidx5.i.epil, align 8
  store i32 -1, ptr %160, align 4
  %arrayidx8.i.epil = getelementptr inbounds ptr, ptr %42, i64 %indvars.iv.i.epil
  %161 = load ptr, ptr %arrayidx8.i.epil, align 8
  store i32 -1, ptr %161, align 4
  %indvars.iv.next.i.epil = add nuw nsw i64 %indvars.iv.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter664
  br i1 %epil.iter.cmp.not, label %for.cond10.preheader.i, label %for.body.i.epil
...
for.body14.lr.ph.i:                               ; preds = %for.cond10.preheader.i
  ...
  %min.iters.check641 = icmp ult i64 %wide.trip.count22.i, 8
  %165 = ptrtoint ptr %163 to i64
  %166 = ptrtoint ptr %162 to i64
  %167 = sub i64 %165, %166
  %diff.check = icmp ult i64 %167, 32
  %or.cond652 = select i1 %min.iters.check641, i1 true, i1 %diff.check
  br i1 %or.cond652, label %for.body14.i.preheader, label %vector.ph642

vector.ph642:                                     ; preds = %for.body14.lr.ph.i
  %n.mod.vf643 = and i64 %164, 7
  %n.vec644 = sub nsw i64 %wide.trip.count22.i, %n.mod.vf643
  br label %vector.body647

vector.body647:                                   ; preds = %vector.body647, %vector.ph642
  %index648 = phi i64 [ 0, %vector.ph642 ], [ %index.next649, %vector.body647 ]
  %168 = getelementptr inbounds i32, ptr %162, i64 %index648
  store <4 x i32> <i32 -1, i32 -1, i32 -1, i32 -1>, ptr %168, align 4
  %169 = getelementptr inbounds i32, ptr %168, i64 4
  store <4 x i32> <i32 -1, i32 -1, i32 -1, i32 -1>, ptr %169, align 4
  %170 = getelementptr inbounds i32, ptr %163, i64 %index648
  store <4 x i32> <i32 -1, i32 -1, i32 -1, i32 -1>, ptr %170, align 4
  %171 = getelementptr inbounds i32, ptr %170, i64 4
  store <4 x i32> <i32 -1, i32 -1, i32 -1, i32 -1>, ptr %171, align 4
  %index.next649 = add nuw i64 %index648, 8
  %172 = icmp eq i64 %index.next649, %n.vec644
  br i1 %172, label %middle.block639, label %vector.body647

middle.block639:                                  ; preds = %vector.body647
  %cmp.n646 = icmp eq i64 %n.mod.vf643, 0
  br i1 %cmp.n646, label %for.end23.i, label %for.body14.i.preheader

for.body14.i.preheader:                           ; preds = %for.body14.lr.ph.i, %middle.block639
  %indvars.iv19.i.ph = phi i64 [ 0, %for.body14.lr.ph.i ], [ %n.vec644, %middle.block639 ]
  %173 = sub i64 %164, %indvars.iv19.i.ph
  %174 = xor i64 %indvars.iv19.i.ph, -1
  %175 = add nsw i64 %wide.trip.count22.i, %174
  %xtraiter666 = and i64 %173, 3
  %lcmp.mod667.not = icmp eq i64 %xtraiter666, 0
  br i1 %lcmp.mod667.not, label %for.body14.i.prol.loopexit, label %for.body14.i.prol
...
for.body14.i.prol:                                ; preds = %for.body14.i.preheader, %for.body14.i.prol
  ...
  %prol.iter668 = phi i64 [ %prol.iter668.next, %for.body14.i.prol ], [ 0, %for.body14.i.preheader ]
  %arrayidx17.i.prol = getelementptr inbounds i32, ptr %162, i64 %indvars.iv19.i.prol
  store i32 -1, ptr %arrayidx17.i.prol, align 4
  %arrayidx20.i.prol = getelementptr inbounds i32, ptr %163, i64 %indvars.iv19.i.prol
  store i32 -1, ptr %arrayidx20.i.prol, align 4
  ...
  br i1 %prol.iter668.cmp.not, label %for.body14.i.prol.loopexit, label %for.body14.i.prol
...
for.body14.i:                                     ; preds = %for.body14.i.prol.loopexit, %for.body14.i
  ...
  store i32 -1, ptr %arrayidx17.i.1, align 4
  %arrayidx20.i.1 = getelementptr inbounds i32, ptr %163, i64 %indvars.iv.next20.i
  store i32 -1, ptr %arrayidx20.i.1, align 4
  ...
  store i32 -1, ptr %arrayidx17.i.2, align 4
  %arrayidx20.i.2 = getelementptr inbounds i32, ptr %163, i64 %indvars.iv.next20.i.1
  store i32 -1, ptr %arrayidx20.i.2, align 4
  ...
  store i32 -1, ptr %arrayidx17.i.3, align 4
  %arrayidx20.i.3 = getelementptr inbounds i32, ptr %163, i64 %indvars.iv.next20.i.2
  store i32 -1, ptr %arrayidx20.i.3, align 4
  ...
  br i1 %exitcond23.not.i.3, label %for.end23.i, label %for.body14.i

for.end23.i:                                      ; preds = %for.body14.i.prol.loopexit, %for.body14.i, %middle.block639, %for.cond10.preheader.i
...
for.body37.i:                                     ; preds = %for.end23.i, %if.end.i
  ...
  %190 = load i32, ptr %arrayidx45.i, align 4
  %191 = xor i32 %188, -1
...
while.body.preheader.i:                           ; preds = %for.body37.i
  ...
  %xtraiter669 = and i32 %dec5.i, 1
  %lcmp.mod670.not = icmp eq i32 %xtraiter669, 0
  br i1 %lcmp.mod670.not, label %while.body.i495.prol.loopexit, label %while.body.i495.prol

while.body.i495.prol:                             ; preds = %while.body.preheader.i
  %195 = load ptr, ptr %seq1, align 8
  %196 = add nsw i64 %192, %193
  %arrayidx49.i.prol = getelementptr inbounds i8, ptr %195, i64 %196
  %197 = load i8, ptr %arrayidx49.i.prol, align 1
  %198 = load ptr, ptr %155, align 8
  %incdec.ptr.i496.prol = getelementptr inbounds i8, ptr %198, i64 -1
  store ptr %incdec.ptr.i496.prol, ptr %155, align 8
  store i8 %197, ptr %incdec.ptr.i496.prol, align 1
  %199 = load ptr, ptr %156, align 8
  %incdec.ptr52.i.prol = getelementptr inbounds i8, ptr %199, i64 -1
  store ptr %incdec.ptr52.i.prol, ptr %156, align 8
  store i8 45, ptr %incdec.ptr52.i.prol, align 1
  %indvars.iv.next25.i.prol = add nsw i64 %192, -1
  br label %while.body.i495.prol.loopexit

while.body.i495.prol.loopexit:                    ; preds = %while.body.i495.prol, %while.body.preheader.i
  %indvars.iv24.i.unr = phi i64 [ %192, %while.body.preheader.i ], [ %indvars.iv.next25.i.prol, %while.body.i495.prol ]
  %200 = icmp eq i32 %194, %188
  br i1 %200, label %while.end.loopexit.i, label %while.body.i495

while.body.i495:                                  ; preds = %while.body.i495.prol.loopexit, %while.body.i495
  %indvars.iv24.i = phi i64 [ %indvars.iv.next25.i.1, %while.body.i495 ], [ %indvars.iv24.i.unr, %while.body.i495.prol.loopexit ]
  %201 = load ptr, ptr %seq1, align 8
  ...
  %incdec.ptr.i496 = getelementptr inbounds i8, ptr %204, i64 -1
  store ptr %incdec.ptr.i496, ptr %155, align 8
  store i8 %203, ptr %incdec.ptr.i496, align 1
  %205 = load ptr, ptr %156, align 8
  %incdec.ptr52.i = getelementptr inbounds i8, ptr %205, i64 -1
  store ptr %incdec.ptr52.i, ptr %156, align 8
  store i8 45, ptr %incdec.ptr52.i, align 1
  %indvars.iv.next25.i = add nsw i64 %indvars.iv24.i, -1
  %206 = load ptr, ptr %seq1, align 8
  %207 = add nsw i64 %indvars.iv.next25.i, %193
  %arrayidx49.i.1 = getelementptr inbounds i8, ptr %206, i64 %207
  %208 = load i8, ptr %arrayidx49.i.1, align 1
  %209 = load ptr, ptr %155, align 8
  %incdec.ptr.i496.1 = getelementptr inbounds i8, ptr %209, i64 -1
  store ptr %incdec.ptr.i496.1, ptr %155, align 8
  store i8 %208, ptr %incdec.ptr.i496.1, align 1
  %210 = load ptr, ptr %156, align 8
  %incdec.ptr52.i.1 = getelementptr inbounds i8, ptr %210, i64 -1
  store ptr %incdec.ptr52.i.1, ptr %156, align 8
  store i8 45, ptr %incdec.ptr52.i.1, align 1
  %indvars.iv.next25.i.1 = add nsw i64 %indvars.iv24.i, -2
  %211 = and i64 %indvars.iv.next25.i.1, 4294967295
  %tobool.not.i497.1 = icmp eq i64 %211, 0
  br i1 %tobool.not.i497.1, label %while.end.loopexit.i, label %while.body.i495

while.end.loopexit.i:                             ; preds = %while.body.i495, %while.body.i495.prol.loopexit
...
while.body58.preheader.i:                         ; preds = %while.end.i
  ...
  %xtraiter672 = and i32 %dec569.i, 1
  %lcmp.mod673.not = icmp eq i32 %xtraiter672, 0
  br i1 %lcmp.mod673.not, label %while.body58.i.prol.loopexit, label %while.body58.i.prol
...
while.body58.i.prol:                              ; preds = %while.body58.preheader.i
  ...
  store ptr %incdec.ptr61.i.prol, ptr %155, align 8
  store i8 45, ptr %incdec.ptr61.i.prol, align 1
  %220 = load ptr, ptr %seq2, align 8
  %221 = add nsw i64 %216, %217
  %arrayidx65.i.prol = getelementptr inbounds i8, ptr %220, i64 %221
  %222 = load i8, ptr %arrayidx65.i.prol, align 1
  %223 = load ptr, ptr %156, align 8
  %incdec.ptr67.i.prol = getelementptr inbounds i8, ptr %223, i64 -1
  store ptr %incdec.ptr67.i.prol, ptr %156, align 8
  store i8 %222, ptr %incdec.ptr67.i.prol, align 1
...
while.body58.i:                                   ; preds = %while.body58.i.prol.loopexit, %while.body58.i
  ...
  store ptr %incdec.ptr61.i, ptr %155, align 8
  store i8 45, ptr %incdec.ptr61.i, align 1
  %226 = load ptr, ptr %seq2, align 8
  %227 = add nsw i64 %indvars.iv28.i, %217
  %arrayidx65.i = getelementptr inbounds i8, ptr %226, i64 %227
  %228 = load i8, ptr %arrayidx65.i, align 1
  %229 = load ptr, ptr %156, align 8
  %incdec.ptr67.i = getelementptr inbounds i8, ptr %229, i64 -1
  store ptr %incdec.ptr67.i, ptr %156, align 8
  store i8 %228, ptr %incdec.ptr67.i, align 1
  ...
  store ptr %incdec.ptr61.i.1, ptr %155, align 8
  store i8 45, ptr %incdec.ptr61.i.1, align 1
  %231 = load ptr, ptr %seq2, align 8
  %232 = add nsw i64 %indvars.iv.next29.i, %217
  %arrayidx65.i.1 = getelementptr inbounds i8, ptr %231, i64 %232
  %233 = load i8, ptr %arrayidx65.i.1, align 1
  %234 = load ptr, ptr %156, align 8
  %incdec.ptr67.i.1 = getelementptr inbounds i8, ptr %234, i64 -1
  store ptr %incdec.ptr67.i.1, ptr %156, align 8
  store i8 %233, ptr %incdec.ptr67.i.1, align 1
  ...
  br i1 %tobool57.not.i.1, label %while.end69.i, label %while.body58.i
...
if.then290:                                       ; preds = %genGtracking.exit
  ...
  %.pre580 = load ptr, ptr @genG__align11.mseq1, align 8
  %.pre581 = load ptr, ptr %.pre580, align 8
  %.pre582 = load ptr, ptr @genG__align11.mseq2, align 8
  br label %if.end292
