...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> %broadcast.splat, ptr %8, align 4, !tbaa !22
...
for.body62:                                       ; preds = %for.body62.preheader, %for.body62
  ...
  br i1 %niter464.ncmp.1, label %for.cond78.preheader.loopexit.unr-lcssa, label %for.body62, !llvm.loop !49
...
for.body81:                                       ; preds = %for.body81.preheader, %for.body81
  ...
  br i1 %niter469.ncmp.1, label %for.body100.preheader.loopexit.unr-lcssa, label %for.body81, !llvm.loop !50
...
for.body162.epil:                                 ; preds = %for.cond169.preheader.loopexit.unr-lcssa, %for.body162.epil
  ...
  br i1 %epil.iter471.cmp.not, label %for.cond169.preheader, label %for.body162.epil, !llvm.loop !58
...
for.body162:                                      ; preds = %for.body162, %for.body162.lr.ph.new
  ...
  br i1 %niter475.ncmp.7, label %for.cond169.preheader.loopexit.unr-lcssa, label %for.body162, !llvm.loop !59
...
vector.body:                                      ; preds = %for.cond3.preheader.us, %vector.body
  ...
  %wide.load501 = load <2 x double>, ptr %9, align 8, !tbaa !9
  ...
  store <2 x double> %wide.load501, ptr %11, align 8, !tbaa !9
  %index.next = add nuw i64 %index, 4
...
for.cond13.for.inc22_crit_edge.us:                ; preds = %for.body15.us.prol.loopexit, %for.body15.us, %middle.block
  ...
  br i1 %exitcond483.not, label %for.cond25.preheader, label %for.cond13.preheader.us, !llvm.loop !79
...
if.end64.us.peel:                                 ; preds = %for.body47.lr.ph
  %44 = load double, ptr %34, align 8, !tbaa !9
...
for.body47:                                       ; preds = %for.body47, %for.body47.preheader.new
  ...
  %47 = load double, ptr %arrayidx69, align 8, !tbaa !9
  ...
  %50 = load double, ptr %arrayidx69.1, align 8, !tbaa !9
...
for.body47.epil:                                  ; preds = %for.end80.loopexit.unr-lcssa
  ...
  %53 = load double, ptr %arrayidx69.epil, align 8, !tbaa !9
...
if.end102.us.peel:                                ; preds = %for.body84.lr.ph
  ...
  %60 = load double, ptr %arrayidx107.us.peel, align 8, !tbaa !9
...
for.body84:                                       ; preds = %for.body84.preheader, %for.body84
  ...
  %63 = load ptr, ptr %arrayidx104, align 8, !tbaa !5
  %arrayidx107 = getelementptr inbounds double, ptr %63, i64 %58
  %64 = load double, ptr %arrayidx107, align 8, !tbaa !9
  ...
  %67 = load ptr, ptr %arrayidx104.1, align 8, !tbaa !5
  %arrayidx107.1 = getelementptr inbounds double, ptr %67, i64 %58
  %68 = load double, ptr %arrayidx107.1, align 8, !tbaa !9
  ...
  br i1 %niter576.ncmp.1, label %for.end118.loopexit.unr-lcssa, label %for.body84, !llvm.loop !81
...
for.body84.epil:                                  ; preds = %for.end118.loopexit.unr-lcssa
  ...
  %71 = load ptr, ptr %arrayidx104.epil, align 8, !tbaa !5
  %arrayidx107.epil = getelementptr inbounds double, ptr %71, i64 %58
  %72 = load double, ptr %arrayidx107.epil, align 8, !tbaa !9
...
for.end118:                                       ; preds = %for.body84.epil, %for.end118.loopexit.unr-lcssa, %if.end102.us.peel, %for.end80.for.end118_crit_edge
  ...
  %76 = load i32, ptr @penalty, align 4, !tbaa !22
  ...
  %77 = load double, ptr %arrayidx127, align 8, !tbaa !9
...
if.end235:                                        ; preds = %for.body223
  ...
  %93 = load i32, ptr %arrayidx240, align 4, !tbaa !22
...
if.then251:                                       ; preds = %if.end235.if.then251_crit_edge, %lor.lhs.false243
  ...
  %arrayidx264 = getelementptr inbounds ptr, ptr %ocrossscore, i64 %idxprom263
  %94 = load ptr, ptr %arrayidx264, align 8, !tbaa !5
  %arrayidx269 = getelementptr inbounds double, ptr %94, i64 %idxprom268.pre-phi
  %95 = load double, ptr %arrayidx269, align 8, !tbaa !9
...
if.end275:                                        ; preds = %if.then251, %if.then272, %lor.lhs.false243
  ...
  %96 = load i32, ptr %arrayidx279, align 4, !tbaa !22
  %idxprom280 = sext i32 %count.1 to i64
  %arrayidx281 = getelementptr inbounds i32, ptr %cut1, i64 %idxprom280
  store i32 %96, ptr %arrayidx281, align 4, !tbaa !22
  %arrayidx285 = getelementptr inbounds [100000 x i32], ptr @blockAlign2.ocut2, i64 0, i64 %idxprom230
  %97 = load i32, ptr %arrayidx285, align 4, !tbaa !22
  %arrayidx287 = getelementptr inbounds i32, ptr %cut2, i64 %idxprom280
  store i32 %97, ptr %arrayidx287, align 4, !tbaa !22
  %inc288 = add nsw i32 %count.1, 1
  br label %for.inc289
...
vector.body:                                      ; preds = %for.cond21.preheader.us, %vector.body
  ...
  %wide.load474 = load <2 x double>, ptr %20, align 8, !tbaa !9
  ...
  store <2 x double> %wide.load474, ptr %22, align 8, !tbaa !9
  %index.next = add nuw i64 %index, 4
