; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/mafft/fftFunctions.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/mafft/fftFunctions.c"
...
for.body:                                         ; preds = %for.body, %for.body.preheader.new
  ...
  %3 = load double, ptr %arrayidx.2, align 8
  ...
  %4 = load double, ptr %arrayidx.3, align 8
...
for.body.epil:                                    ; preds = %for.end.loopexit.unr-lcssa, %for.body.epil
  ...
  %5 = load double, ptr %arrayidx.epil, align 8
...
entry:
  ...
  store double %7, ptr %I10, align 8
  ret void
}
...
for.body3.us:                                     ; preds = %for.cond1.preheader.us, %for.body3.us
  ...
  %1 = load double, ptr %arrayidx.us, align 8
  ...
  %3 = load double, ptr %arrayidx.us.1, align 8
...
for.body3.us.epil:                                ; preds = %for.cond1.for.end_crit_edge.us.unr-lcssa
  ...
  %5 = load double, ptr %arrayidx.us.epil, align 8
...
for.cond1.for.end_crit_edge.us:                   ; preds = %for.cond1.for.end_crit_edge.us.unr-lcssa, %for.body3.us.epil
  ...
  store double 0xC0C387F333333333, ptr %arrayidx6.us, align 8
  %sub.us = add i32 %ikouho.2.us.lcssa, %div.neg
  %arrayidx8.us = getelementptr inbounds i32, ptr %kouho, i64 %indvars.iv36
  store i32 %sub.us, ptr %arrayidx8.us, align 4
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  %exitcond40.not = icmp eq i64 %indvars.iv.next37, %wide.trip.count39
  br i1 %exitcond40.not, label %for.end11, label %for.cond1.preheader.us

for.cond1.preheader.lr.ph.split:                  ; preds = %for.cond1.preheader.lr.ph
  store double 0xC0C387F333333333, ptr %soukan, align 8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> %broadcast.splat, ptr %7, align 4
...
for.cond1.preheader:                              ; preds = %for.cond1.preheader.preheader, %for.cond1.preheader
  ...
  store i32 %div.neg, ptr %arrayidx8, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x ptr>, ptr %1, align 8
  %2 = getelementptr inbounds ptr, ptr %1, i64 2
  %wide.load89 = load <2 x ptr>, ptr %2, align 8
...
for.body16.prol:                                  ; preds = %for.body16.preheader, %for.body16.prol
  ...
  %10 = load ptr, ptr %arrayidx18.prol, align 8
  ...
  store ptr %add.ptr20.prol, ptr %arrayidx22.prol, align 8
  %indvars.iv.next.prol = add nuw nsw i64 %indvars.iv.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body16.prol.loopexit, label %for.body16.prol
...
vector.body119:                                   ; preds = %vector.body119, %vector.ph114
  ...
  %wide.load121 = load <2 x ptr>, ptr %13, align 8
  %14 = getelementptr inbounds ptr, ptr %13, i64 2
  %wide.load122 = load <2 x ptr>, ptr %14, align 8
  %15 = getelementptr inbounds ptr, ptr %aseq1, i64 %index120
  store <2 x ptr> %wide.load121, ptr %15, align 8
  %16 = getelementptr inbounds ptr, ptr %15, i64 2
  store <2 x ptr> %wide.load122, ptr %16, align 8
  %index.next123 = add nuw i64 %index120, 4
  %17 = icmp eq i64 %index.next123, %n.vec116
  br i1 %17, label %middle.block111, label %vector.body119
...
for.body.prol:                                    ; preds = %for.body.preheader144, %for.body.prol
  ...
  store ptr %20, ptr %arrayidx3.prol, align 8
  ...
  br i1 %prol.iter152.cmp.not, label %for.body.prol.loopexit, label %for.body.prol
...
vector.body136:                                   ; preds = %vector.body136, %vector.ph131
  ...
  %wide.load138 = load <2 x ptr>, ptr %23, align 8
  %24 = getelementptr inbounds ptr, ptr %23, i64 2
  %wide.load139 = load <2 x ptr>, ptr %24, align 8
  ...
  store <2 x ptr> %25, ptr %27, align 8
  %28 = getelementptr inbounds ptr, ptr %27, i64 2
  store <2 x ptr> %26, ptr %28, align 8
  %index.next140 = add nuw i64 %index137, 4
  %29 = icmp eq i64 %index.next140, %n.vec133
  br i1 %29, label %middle.block128, label %vector.body136
...
for.body6.prol:                                   ; preds = %for.body6.preheader, %for.body6.prol
  ...
  %32 = load ptr, ptr %arrayidx8.prol, align 8
  ...
  store ptr %add.ptr.prol, ptr %arrayidx10.prol, align 8
  ...
  br i1 %prol.iter155.cmp.not, label %for.body6.prol.loopexit, label %for.body6.prol
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  ...
  store ptr %36, ptr %arrayidx3.2, align 8
...
for.body6:                                        ; preds = %for.body6.prol.loopexit, %for.body6
  ...
  store ptr %add.ptr.1, ptr %arrayidx10.1, align 8
  ...
  %40 = load ptr, ptr %arrayidx8.2, align 8
  ...
  store ptr %add.ptr.2, ptr %arrayidx10.2, align 8
  ...
  %41 = load ptr, ptr %arrayidx8.3, align 8
...
vector.body102:                                   ; preds = %vector.body102, %vector.ph97
  ...
  %wide.load104 = load <2 x ptr>, ptr %43, align 8
  %44 = getelementptr inbounds ptr, ptr %43, i64 2
  %wide.load105 = load <2 x ptr>, ptr %44, align 8
  %45 = getelementptr inbounds ptr, ptr %aseq2, i64 %index103
  store <2 x ptr> %wide.load104, ptr %45, align 8
  %46 = getelementptr inbounds ptr, ptr %45, i64 2
  store <2 x ptr> %wide.load105, ptr %46, align 8
  %index.next106 = add nuw i64 %index103, 4
  %47 = icmp eq i64 %index.next106, %n.vec99
  br i1 %47, label %middle.block94, label %vector.body102
...
for.body28.prol:                                  ; preds = %for.body28.preheader145, %for.body28.prol
  ...
  %50 = load ptr, ptr %arrayidx30.prol, align 8
  %arrayidx32.prol = getelementptr inbounds ptr, ptr %aseq2, i64 %indvars.iv70.prol
  store ptr %50, ptr %arrayidx32.prol, align 8
  ...
  br i1 %prol.iter149.cmp.not, label %for.body28.prol.loopexit, label %for.body28.prol
...
for.body16:                                       ; preds = %for.body16.prol.loopexit, %for.body16
  ...
  store ptr %add.ptr20.1, ptr %arrayidx22.1, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx18.2 = getelementptr inbounds ptr, ptr %seq1, i64 %indvars.iv.next.1
  %54 = load ptr, ptr %arrayidx18.2, align 8
  ...
  store ptr %add.ptr20.2, ptr %arrayidx22.2, align 8
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %arrayidx18.3 = getelementptr inbounds ptr, ptr %seq1, i64 %indvars.iv.next.2
  %55 = load ptr, ptr %arrayidx18.3, align 8
  ...
  store ptr %add.ptr20.3, ptr %arrayidx22.3, align 8
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %exitcond.not.3 = icmp eq i64 %indvars.iv.next.3, %wide.trip.count
  br i1 %exitcond.not.3, label %for.cond26.preheader, label %for.body16
...
for.body28:                                       ; preds = %for.body28.prol.loopexit, %for.body28
  ...
  %58 = load ptr, ptr %arrayidx30.2, align 8
  %arrayidx32.2 = getelementptr inbounds ptr, ptr %aseq2, i64 %indvars.iv.next71.1
  store ptr %58, ptr %arrayidx32.2, align 8
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  br i1 %exitcond82.not, label %for.cond4.preheader, label %for.body
...
for.body6:                                        ; preds = %for.body6.lr.ph, %for.body6
  ...
  br i1 %exitcond87.not, label %if.end, label %for.body6
...
for.body17:                                       ; preds = %for.body17.lr.ph, %for.body17
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.cond28.preheader, label %for.body17
...
for.body30:                                       ; preds = %for.body30.preheader, %for.body30
  ...
  br i1 %exitcond77.not, label %if.end, label %for.body30
...
entry:
  ...
  %2 = load i32, ptr @fftWinSize, align 4
  %3 = trunc i64 %cond20 to i32
  %conv22 = add i32 %2, %3
  %4 = load i32, ptr @alignableReagion.alloclen, align 4
...
if.then25:                                        ; preds = %if.then
  %5 = load ptr, ptr @alignableReagion.stra, align 8
  tail call void @FreeDoubleVec(ptr noundef %5) #22
  br label %if.end

if.else:                                          ; preds = %if.then
  %6 = load i32, ptr @fftThreshold, align 4
  ...
  store double %mul28, ptr @alignableReagion.threshold, align 8
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then25
  %call29 = tail call ptr @AllocateDoubleVec(i32 noundef %conv22) #22
  store ptr %call29, ptr @alignableReagion.stra, align 8
  store i32 %conv22, ptr @alignableReagion.alloclen, align 4
  br label %if.end30

if.end30:                                         ; preds = %if.end, %entry
  %cmp31351 = icmp sgt i32 %clus1, 0
  %cmp34348 = icmp sgt i32 %clus2, 0
  %or.cond454 = and i1 %cmp31351, %cmp34348
  br i1 %or.cond454, label %for.cond33.preheader.us.preheader, label %for.cond44.preheader
...
for.cond33.preheader.us:                          ; preds = %for.cond33.preheader.us.preheader, %for.cond33.for.inc41_crit_edge.us
  ...
  %totaleff.0353.us = phi double [ 0.000000e+00, %for.cond33.preheader.us.preheader ], [ %.lcssa458, %for.cond33.for.inc41_crit_edge.us ]
  %arrayidx37.us = getelementptr inbounds double, ptr %eff1, i64 %indvars.iv400
  %8 = load double, ptr %arrayidx37.us, align 8
...
for.body36.us:                                    ; preds = %for.cond33.preheader.us, %for.body36.us
  ...
  %9 = load double, ptr %arrayidx39.us, align 8
  ...
  %11 = load double, ptr %arrayidx39.us.1, align 8
  ...
  %13 = load double, ptr %arrayidx39.us.2, align 8
  ...
  %15 = load double, ptr %arrayidx39.us.3, align 8
  %16 = tail call double @llvm.fmuladd.f64(double %8, double %15, double %14)
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %niter.next.3 = add i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %for.cond33.for.inc41_crit_edge.us.unr-lcssa, label %for.body36.us

for.cond33.for.inc41_crit_edge.us.unr-lcssa:      ; preds = %for.body36.us, %for.cond33.preheader.us
  %.lcssa458.ph = phi double [ undef, %for.cond33.preheader.us ], [ %16, %for.body36.us ]
...
for.body36.us.epil:                               ; preds = %for.cond33.for.inc41_crit_edge.us.unr-lcssa, %for.body36.us.epil
  ...
  %17 = load double, ptr %arrayidx39.us.epil, align 8
  %18 = tail call double @llvm.fmuladd.f64(double %8, double %17, double %totaleff.1350.us.epil)
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %for.cond33.for.inc41_crit_edge.us, label %for.body36.us.epil

for.cond33.for.inc41_crit_edge.us:                ; preds = %for.body36.us.epil, %for.cond33.for.inc41_crit_edge.us.unr-lcssa
  %.lcssa458 = phi double [ %.lcssa458.ph, %for.cond33.for.inc41_crit_edge.us.unr-lcssa ], [ %18, %for.body36.us.epil ]
  %indvars.iv.next401 = add nuw nsw i64 %indvars.iv400, 1
  %exitcond404.not = icmp eq i64 %indvars.iv.next401, %wide.trip.count403
  br i1 %exitcond404.not, label %for.cond44.preheader, label %for.cond33.preheader.us

for.cond44.preheader:                             ; preds = %for.cond33.for.inc41_crit_edge.us, %if.end30
  %totaleff.0.lcssa = phi double [ 0.000000e+00, %if.end30 ], [ %.lcssa458, %for.cond33.for.inc41_crit_edge.us ]
...
for.cond48.preheader.lr.ph:                       ; preds = %for.cond44.preheader
  ...
  %19 = load ptr, ptr @alignableReagion.stra, align 8
  ...
  %xtraiter460 = and i64 %wide.trip.count411, 1
  %20 = icmp eq i32 %clus1, 1
  %unroll_iter463 = and i64 %wide.trip.count411, 4294967294
  %lcmp.mod462.not = icmp eq i64 %xtraiter460, 0
  %xtraiter465 = and i64 %wide.trip.count416, 1
  %21 = icmp eq i32 %clus2, 1
  %unroll_iter468 = and i64 %wide.trip.count416, 4294967294
...
for.cond48.preheader:                             ; preds = %for.cond48.preheader.lr.ph, %for.end151
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(208) @alignableReagion.prf1, i8 0, i64 208, i1 false)
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(208) @alignableReagion.prf2, i8 0, i64 208, i1 false)
...
for.cond78.preheader.loopexit.unr-lcssa:          ; preds = %for.body62, %for.body62.preheader
  ...
  br i1 %lcmp.mod462.not, label %for.cond78.preheader, label %for.body62.epil
...
for.body62.epil:                                  ; preds = %for.cond78.preheader.loopexit.unr-lcssa
  ...
  %26 = load double, ptr %arrayidx73.epil, align 8
  %add74.epil = fadd double %22, %26
  store double %add74.epil, ptr %arrayidx73.epil, align 8
...
for.body62:                                       ; preds = %for.body62.preheader, %for.body62
  ...
  %niter464 = phi i64 [ %niter464.next.1, %for.body62 ], [ 0, %for.body62.preheader ]
  ...
  %36 = load double, ptr %arrayidx73.1, align 8
  %add74.1 = fadd double %32, %36
  store double %add74.1, ptr %arrayidx73.1, align 8
  ...
  br i1 %niter464.ncmp.1, label %for.cond78.preheader.loopexit.unr-lcssa, label %for.body62
...
for.body81:                                       ; preds = %for.body81.preheader, %for.body81
  ...
  %niter469 = phi i64 [ %niter469.next.1, %for.body81 ], [ 0, %for.body81.preheader ]
  %arrayidx83 = getelementptr inbounds double, ptr %eff2, i64 %indvars.iv413
  %37 = load double, ptr %arrayidx83, align 8
  ...
  %46 = load double, ptr %arrayidx92.1, align 8
  %add93.1 = fadd double %42, %46
  store double %add93.1, ptr %arrayidx92.1, align 8
  ...
  br i1 %niter469.ncmp.1, label %for.body100.preheader.loopexit.unr-lcssa, label %for.body81
...
for.body100.preheader.loopexit.unr-lcssa:         ; preds = %for.body81, %for.body81.preheader
  ...
  br i1 %lcmp.mod467.not, label %for.body100.preheader, label %for.body81.epil
...
for.body81.epil:                                  ; preds = %for.body100.preheader.loopexit.unr-lcssa
  ...
  %51 = load double, ptr %arrayidx92.epil, align 8
  %add93.epil = fadd double %47, %51
  store double %add93.epil, ptr %arrayidx92.epil, align 8
...
for.body100:                                      ; preds = %for.body100.preheader, %for.inc115
  ...
  %52 = load double, ptr %arrayidx102, align 8
...
if.then104:                                       ; preds = %for.body100
  ...
  store i32 %53, ptr %arrayidx106, align 4
  br label %if.end107
...
if.end107:                                        ; preds = %if.then104, %for.body100
  ...
  %54 = load double, ptr %arrayidx109, align 8
...
if.then111:                                       ; preds = %if.end107
  ...
  store i32 %55, ptr %arrayidx113, align 4
  br label %for.inc115
...
for.inc115:                                       ; preds = %if.end107, %if.then111
  ...
  br i1 %cmp98.not, label %for.end116, label %for.body100
...
for.end116:                                       ; preds = %for.inc115
  ...
  %k.0367 = load i32, ptr getelementptr inbounds ([27 x i32], ptr @alignableReagion.hat1, i64 0, i64 26), align 8
...
for.cond127.preheader.lr.ph:                      ; preds = %for.end116
  %j.5363 = load i32, ptr getelementptr inbounds ([27 x i32], ptr @alignableReagion.hat2, i64 0, i64 26), align 8
...
for.cond127.preheader:                            ; preds = %for.cond127.preheader.lr.ph, %for.cond127.for.inc148_crit_edge
  ...
  %56 = load double, ptr %arrayidx137, align 8
...
for.body130:                                      ; preds = %for.cond127.preheader, %for.body130
  ...
  %59 = load double, ptr %arrayidx140, align 8
  ...
  %j.5 = load i32, ptr %arrayidx146, align 4
  %cmp128.not = icmp eq i32 %j.5, -1
  br i1 %cmp128.not, label %for.cond127.for.inc148_crit_edge, label %for.body130
...
for.cond127.for.inc148_crit_edge:                 ; preds = %for.body130
  ...
  %k.0 = load i32, ptr %arrayidx150, align 4
  %cmp124.not = icmp eq i32 %k.0, -1
  br i1 %cmp124.not, label %for.end151, label %for.cond127.preheader
...
for.body162.lr.ph:                                ; preds = %for.end157
  %63 = load ptr, ptr @alignableReagion.stra, align 8
  %wide.trip.count429 = zext i32 %62 to i64
  %xtraiter470 = and i64 %wide.trip.count429, 7
...
for.body162.lr.ph.new:                            ; preds = %for.body162.lr.ph
  %unroll_iter474 = and i64 %wide.trip.count429, 4294967288
...
for.cond169.preheader.loopexit.unr-lcssa:         ; preds = %for.body162, %for.body162.lr.ph
  ...
  br i1 %lcmp.mod472.not, label %for.cond169.preheader, label %for.body162.epil
...
for.body162.epil:                                 ; preds = %for.cond169.preheader.loopexit.unr-lcssa, %for.body162.epil
  ...
  %epil.iter471 = phi i64 [ %epil.iter471.next, %for.body162.epil ], [ 0, %for.cond169.preheader.loopexit.unr-lcssa ]
  %arrayidx164.epil = getelementptr inbounds double, ptr %63, i64 %indvars.iv426.epil
  %65 = load double, ptr %arrayidx164.epil, align 8
  %add165.epil = fadd double %score.0376.epil, %65
  %indvars.iv.next427.epil = add nuw nsw i64 %indvars.iv426.epil, 1
  %epil.iter471.next = add i64 %epil.iter471, 1
  %epil.iter471.cmp.not = icmp eq i64 %epil.iter471.next, %xtraiter470
  br i1 %epil.iter471.cmp.not, label %for.cond169.preheader, label %for.body162.epil
...
for.body172.preheader:                            ; preds = %for.cond169.preheader
  %.pre437 = load ptr, ptr @alignableReagion.stra, align 8
  %.pre439 = load double, ptr @alignableReagion.threshold, align 8
...
for.body162:                                      ; preds = %for.body162, %for.body162.lr.ph.new
  ...
  %niter475 = phi i64 [ 0, %for.body162.lr.ph.new ], [ %niter475.next.7, %for.body162 ]
  %arrayidx164 = getelementptr inbounds double, ptr %63, i64 %indvars.iv426
  %66 = load double, ptr %arrayidx164, align 8
  ...
  %67 = load double, ptr %arrayidx164.1, align 8
  ...
  %68 = load double, ptr %arrayidx164.2, align 8
  ...
  %69 = load double, ptr %arrayidx164.3, align 8
  ...
  %70 = load double, ptr %arrayidx164.4, align 8
  ...
  %71 = load double, ptr %arrayidx164.5, align 8
  ...
  %72 = load double, ptr %arrayidx164.6, align 8
  ...
  %73 = load double, ptr %arrayidx164.7, align 8
  %add165.7 = fadd double %add165.6, %73
  %indvars.iv.next427.7 = add nuw nsw i64 %indvars.iv426, 8
  %niter475.next.7 = add i64 %niter475, 8
  %niter475.ncmp.7 = icmp eq i64 %niter475.next.7, %unroll_iter474
  br i1 %niter475.ncmp.7, label %for.cond169.preheader.loopexit.unr-lcssa, label %for.body162
...
for.body172:                                      ; preds = %for.body172.preheader, %for.inc228
  ...
  %78 = load double, ptr %arrayidx175, align 8
  ...
  %80 = load double, ptr %arrayidx180, align 8
...
if.then200:                                       ; preds = %if.then197
  store i32 %starttmp.2, ptr %seg.addr.0384, align 8
  ...
  %84 = load i32, ptr @fftWinSize, align 4
  ...
  store i32 %div205, ptr %center, align 8
  %score206 = getelementptr inbounds %struct._Segment, ptr %seg.addr.0384, i64 0, i32 3
  store double %cumscore.2, ptr %score206, align 8
...
if.then224:                                       ; preds = %if.end221
  ...
  %.pre = load ptr, ptr @alignableReagion.stra, align 8
  %.pre438 = load double, ptr @alignableReagion.threshold, align 8
  %.pre440 = load i32, ptr @fftWinSize, align 4
  br label %for.inc228
...
for.inc228:                                       ; preds = %if.end190, %if.end221, %if.then224
  ...
  br i1 %cmp170, label %for.body172, label %for.end230

for.end230:                                       ; preds = %for.inc228
  %92 = icmp ne i32 %status.3, 0
  %cmp232 = icmp sgt i32 %length.3, %88
  %or.cond347 = select i1 %92, i1 %cmp232, i1 false
  br i1 %or.cond347, label %if.then234, label %if.end243

if.then234:                                       ; preds = %for.end230
  %93 = trunc i64 %indvars.iv.next432 to i32
  %end235 = getelementptr inbounds %struct._Segment, ptr %seg.addr.2, i64 0, i32 1
  store i32 %93, ptr %end235, align 4
  store i32 %starttmp.3, ptr %seg.addr.2, align 8
  %add237 = add nsw i32 %starttmp.3, %93
  %94 = load i32, ptr @fftWinSize, align 4
  %add238 = add nsw i32 %add237, %94
  %div239 = sdiv i32 %add238, 2
  %center240 = getelementptr inbounds %struct._Segment, ptr %seg.addr.2, i64 0, i32 2
  store i32 %div239, ptr %center240, align 8
  %score241 = getelementptr inbounds %struct._Segment, ptr %seg.addr.2, i64 0, i32 3
  store double %cumscore.3, ptr %score241, align 8
...
entry:
  %0 = load ptr, ptr @blockAlign.crossscore, align 8
  %cmp = icmp eq ptr %0, null
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %call = tail call ptr @AllocateDoubleMtx(i32 noundef 100000, i32 noundef 100000) #22
  store ptr %call, ptr @blockAlign.crossscore, align 8
  %call1 = tail call ptr @AllocateIntMtx(i32 noundef 100000, i32 noundef 100000) #22
  store ptr %call1, ptr @blockAlign.track, align 8
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %1 = load i32, ptr %ncut, align 4
...
for.cond3.preheader.us:                           ; preds = %for.cond3.for.inc12_crit_edge.us, %for.cond3.preheader.lr.ph
  ...
  %or.cond504 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond504, label %for.body5.us.preheader, label %vector.body
...
vector.body:                                      ; preds = %for.cond3.preheader.us, %vector.body
  ...
  %wide.load = load <2 x double>, ptr %8, align 8
  %9 = getelementptr inbounds double, ptr %8, i64 2
  %wide.load501 = load <2 x double>, ptr %9, align 8
  %10 = getelementptr inbounds double, ptr %4, i64 %index
  store <2 x double> %wide.load, ptr %10, align 8
  %11 = getelementptr inbounds double, ptr %10, i64 2
  store <2 x double> %wide.load501, ptr %11, align 8
  %index.next = add nuw i64 %index, 4
...
for.body5.us.prol:                                ; preds = %for.body5.us.preheader, %for.body5.us.prol
  ...
  %15 = load double, ptr %arrayidx7.us.prol, align 8
  %arrayidx11.us.prol = getelementptr inbounds double, ptr %4, i64 %indvars.iv.prol
  store double %15, ptr %arrayidx11.us.prol, align 8
  %indvars.iv.next.prol = add nuw nsw i64 %indvars.iv.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body5.us.prol.loopexit, label %for.body5.us.prol
...
for.cond3.for.inc12_crit_edge.us:                 ; preds = %for.body5.us.prol.loopexit, %for.body5.us, %middle.block
  ...
  br i1 %exitcond452.not, label %for.cond15.preheader, label %for.cond3.preheader.us
...
for.cond39.preheader:                             ; preds = %for.cond15.preheader
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 @blockAlign.ocut1, ptr align 4 %cut1, i64 %22, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 @blockAlign.ocut2, ptr align 4 %cut2, i64 %22, i1 false)
  %23 = zext i32 %1 to i64
  %24 = shl nuw nsw i64 %23, 3
  tail call void @llvm.memset.p0.i64(ptr nonnull align 16 @blockAlign.max, i8 0, i64 %24, i1 false)
  tail call void @llvm.memset.p0.i64(ptr nonnull align 16 @blockAlign.point, i8 0, i64 %24, i1 false)
...
for.cond145.preheader.preheader:                  ; preds = %for.cond39.preheader, %for.cond141.preheader
  %.ph = phi i32 [ 1, %for.cond39.preheader ], [ %47, %for.cond141.preheader ]
  br label %for.cond145.preheader

for.body41:                                       ; preds = %for.body41.preheader, %for.inc138
  %27 = phi i32 [ %1, %for.body41.preheader ], [ %47, %for.inc138 ]
  %indvars.iv463 = phi i64 [ 1, %for.body41.preheader ], [ %indvars.iv.next464, %for.inc138 ]
  %cmp43421 = icmp sgt i32 %27, 1
  br i1 %cmp43421, label %for.body44.lr.ph, label %for.body41.for.inc138_crit_edge

for.body41.for.inc138_crit_edge:                  ; preds = %for.body41
  %.pre481 = sext i32 %27 to i64
  br label %for.inc138
...
for.body44:                                       ; preds = %for.body44.lr.ph, %for.inc135
  ...
  %36 = load double, ptr %arrayidx49, align 8
  ...
  %37 = load double, ptr %arrayidx55, align 8
  %38 = load i32, ptr @penalty, align 4
...
if.then58:                                        ; preds = %for.body44
  ...
  store i32 %conv67, ptr %arrayidx53, align 4
  %.pre = load i32, ptr @penalty, align 4
...
if.then77:                                        ; preds = %if.end72
  ...
  store i32 %conv82, ptr %arrayidx53, align 4
  br label %if.end87
...
if.end87:                                         ; preds = %if.then77, %if.end72
  ...
  %41 = load double, ptr %arrayidx91, align 8
  %add92 = fadd double %maximum.1, %41
  store double %add92, ptr %arrayidx91, align 8
...
if.then121:                                       ; preds = %if.end87
  store double %42, ptr %arrayidx55, align 8
...
for.inc135:                                       ; preds = %if.end87, %if.then121
  ...
  %45 = load i32, ptr %ncut, align 4
  %46 = sext i32 %45 to i64
  %cmp43 = icmp slt i64 %indvars.iv.next460, %46
  br i1 %cmp43, label %for.body44, label %for.inc138

for.inc138:                                       ; preds = %for.inc135, %for.body41.for.inc138_crit_edge
  %.pre-phi = phi i64 [ %.pre481, %for.body41.for.inc138_crit_edge ], [ %46, %for.inc135 ]
  %47 = phi i32 [ %27, %for.body41.for.inc138_crit_edge ], [ %45, %for.inc135 ]
  %indvars.iv.next464 = add nuw nsw i64 %indvars.iv463, 1
  %cmp40 = icmp slt i64 %indvars.iv.next464, %.pre-phi
  br i1 %cmp40, label %for.body41, label %for.cond141.preheader
...
for.body148:                                      ; preds = %for.cond145.preheader, %for.body148
  ...
  %50 = load ptr, ptr @blockAlign.track, align 8
  %arrayidx150 = getelementptr inbounds ptr, ptr %50, i64 %indvars.iv470
  %51 = load ptr, ptr %arrayidx150, align 8
  ...
  %53 = load i32, ptr %ncut, align 4
  %54 = sext i32 %53 to i64
  %cmp146 = icmp slt i64 %indvars.iv.next468, %54
  br i1 %cmp146, label %for.body148, label %for.end156

for.end156:                                       ; preds = %for.body148, %for.cond145.preheader
  %55 = load ptr, ptr @stderr, align 8
  %fputc = tail call i32 @fputc(i32 10, ptr %55)
  %indvars.iv.next471 = add nuw nsw i64 %indvars.iv470, 1
  %56 = load i32, ptr %ncut, align 4
  %57 = sext i32 %56 to i64
  %cmp142 = icmp slt i64 %indvars.iv.next471, %57
  br i1 %cmp142, label %for.cond145.preheader, label %for.end160

for.end160:                                       ; preds = %for.end156, %if.end, %for.cond15.preheader, %for.cond141.preheader
  %.lcssa = phi i32 [ %47, %for.cond141.preheader ], [ %1, %for.cond15.preheader ], [ %1, %if.end ], [ %56, %for.end156 ]
  %sub161 = add nsw i32 %.lcssa, -1
  store i32 %sub161, ptr getelementptr inbounds ([100000 x i32], ptr @blockAlign.result1, i64 0, i64 99999), align 4
  store i32 %sub161, ptr getelementptr inbounds ([100000 x i32], ptr @blockAlign.result2, i64 0, i64 99999), align 4
...
for.body166:                                      ; preds = %for.end160, %for.inc218
  ...
  %59 = load i32, ptr %arrayidx168, align 4
...
if.end176:                                        ; preds = %for.body166
  ...
  %62 = load i32, ptr %arrayidx180, align 4
...
if.then194:                                       ; preds = %if.else
  ...
  store i32 %sub195, ptr %arrayidx187, align 4
  %sub199 = sub nsw i32 %60, %62
  store i32 %sub199, ptr %arrayidx202, align 4
  br label %for.inc218

if.then206:                                       ; preds = %if.else
  %add207 = add nsw i32 %62, %59
  store i32 %add207, ptr %arrayidx187, align 4
  %sub211 = add nsw i32 %60, -1
  store i32 %sub211, ptr %arrayidx202, align 4
  br label %for.inc218

for.inc218:                                       ; preds = %if.then206, %if.then194, %if.then183
  %cmp164 = icmp ugt i32 %i.4438, 1
  br i1 %cmp164, label %for.body166, label %for.body223.preheader
...
if.end235:                                        ; preds = %for.body223
  ...
  %69 = load i32, ptr %arrayidx240, align 4
  ...
  %.pre478 = load i32, ptr %arrayidx267.phi.trans.insert, align 4
...
if.then251:                                       ; preds = %if.end235.if.then251_crit_edge, %lor.lhs.false243
  ...
  %70 = load ptr, ptr %arrayidx264, align 8
  %arrayidx269 = getelementptr inbounds double, ptr %70, i64 %idxprom268.pre-phi
  %71 = load double, ptr %arrayidx269, align 8
...
if.end275:                                        ; preds = %if.then251, %if.then272, %lor.lhs.false243
  ...
  store i32 %73, ptr %arrayidx287, align 4
...
for.inc289:                                       ; preds = %for.body223, %if.end275
  ...
  br i1 %exitcond477.not, label %for.end291, label %for.body223

for.end291:                                       ; preds = %for.inc289, %for.end219
  %count.0.lcssa = phi i32 [ 0, %for.end219 ], [ %count.2, %for.inc289 ]
  store i32 %count.0.lcssa, ptr %ncut, align 4
  ret void
}
...
entry:
  %0 = load i32, ptr @blockAlign2.crossscoresize, align 4
  %1 = load i32, ptr %ncut, align 4
  %add = add nsw i32 %1, 2
...
if.then:                                          ; preds = %entry
  store i32 %add, ptr @blockAlign2.crossscoresize, align 4
  %2 = load i32, ptr @fftkeika, align 4
...
if.end:                                           ; preds = %if.then2, %if.then
  %4 = load ptr, ptr @blockAlign2.track, align 8
...
if.end5:                                          ; preds = %if.then4, %if.end
  %5 = load ptr, ptr @blockAlign2.crossscore, align 8
...
if.end8:                                          ; preds = %if.then7, %if.end5
  %6 = load i32, ptr @blockAlign2.crossscoresize, align 4
  %call9 = tail call ptr @AllocateIntMtx(i32 noundef %6, i32 noundef %6) #22
  store ptr %call9, ptr @blockAlign2.track, align 8
  %7 = load i32, ptr @blockAlign2.crossscoresize, align 4
  %call10 = tail call ptr @AllocateDoubleMtx(i32 noundef %7, i32 noundef %7) #22
  store ptr %call10, ptr @blockAlign2.crossscore, align 8
  %.pre = load i32, ptr %ncut, align 4
  br label %if.end11

if.end11:                                         ; preds = %if.end8, %entry
  %8 = phi i32 [ %.pre, %if.end8 ], [ %1, %entry ]
  %cmp12422 = icmp sgt i32 %8, 0
  br i1 %cmp12422, label %for.cond13.preheader.lr.ph, label %for.cond39.preheader.thread

for.cond13.preheader.lr.ph:                       ; preds = %if.end11
  %9 = load ptr, ptr @blockAlign2.crossscore, align 8
  %wide.trip.count482 = zext i32 %8 to i64
  %min.iters.check = icmp ult i32 %8, 6
  %n.vec = and i64 %wide.trip.count482, 4294967292
  %cmp.n = icmp eq i64 %n.vec, %wide.trip.count482
  %xtraiter = and i64 %wide.trip.count482, 3
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
...
for.cond13.preheader.us:                          ; preds = %for.cond13.for.inc22_crit_edge.us, %for.cond13.preheader.lr.ph
  %indvars.iv479 = phi i64 [ %indvars.iv.next480, %for.cond13.for.inc22_crit_edge.us ], [ 0, %for.cond13.preheader.lr.ph ]
  %arrayidx.us = getelementptr inbounds ptr, ptr %ocrossscore, i64 %indvars.iv479
  %10 = load ptr, ptr %arrayidx.us, align 8
  %arrayidx19.us = getelementptr inbounds ptr, ptr %9, i64 %indvars.iv479
  %11 = load ptr, ptr %arrayidx19.us, align 8
...
vector.body:                                      ; preds = %for.cond13.preheader.us, %vector.body
  ...
  %wide.load556 = load <2 x double>, ptr %16, align 8
  %17 = getelementptr inbounds double, ptr %11, i64 %index
  store <2 x double> %wide.load, ptr %17, align 8
  %18 = getelementptr inbounds double, ptr %17, i64 2
  store <2 x double> %wide.load556, ptr %18, align 8
  %index.next = add nuw i64 %index, 4
...
for.body15.us.preheader:                          ; preds = %for.cond13.preheader.us, %middle.block
  ...
  %21 = add nsw i64 %20, %wide.trip.count482
...
for.body15.us.prol:                               ; preds = %for.body15.us.preheader, %for.body15.us.prol
  ...
  %22 = load double, ptr %arrayidx17.us.prol, align 8
  %arrayidx21.us.prol = getelementptr inbounds double, ptr %11, i64 %indvars.iv.prol
  store double %22, ptr %arrayidx21.us.prol, align 8
  %indvars.iv.next.prol = add nuw nsw i64 %indvars.iv.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body15.us.prol.loopexit, label %for.body15.us.prol
...
for.cond13.for.inc22_crit_edge.us:                ; preds = %for.body15.us.prol.loopexit, %for.body15.us, %middle.block
  ...
  br i1 %exitcond483.not, label %for.cond25.preheader, label %for.cond13.preheader.us

for.cond25.preheader:                             ; preds = %for.cond13.for.inc22_crit_edge.us
  br i1 %cmp12422, label %for.cond39.preheader, label %for.cond39.preheader.thread

for.cond39.preheader.thread:                      ; preds = %for.cond25.preheader, %if.end11
  %.pre528535 = load ptr, ptr @blockAlign2.track, align 8
  br label %for.end160

for.cond39.preheader:                             ; preds = %for.cond25.preheader
  %28 = zext i32 %8 to i64
  %29 = shl nuw nsw i64 %28, 2
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 @blockAlign2.ocut1, ptr align 4 %cut1, i64 %29, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 @blockAlign2.ocut2, ptr align 4 %cut2, i64 %29, i1 false)
  %cmp40459.not = icmp eq i32 %8, 1
  %.pre528 = load ptr, ptr @blockAlign2.track, align 8
  br i1 %cmp40459.not, label %for.end160, label %for.cond42.preheader.preheader
...
for.cond42.preheader:                             ; preds = %for.cond42.preheader.preheader, %for.inc158
  %31 = phi i32 [ %8, %for.cond42.preheader.preheader ], [ %82, %for.inc158 ]
  %indvars.iv518 = phi i64 [ 1, %for.cond42.preheader.preheader ], [ %indvars.iv.next519, %for.inc158 ]
  %indvars.iv503 = phi i32 [ -1, %for.cond42.preheader.preheader ], [ %indvars.iv.next504, %for.inc158 ]
  %add121.lcssa458460 = phi double [ %blockAlign2.maxj.promoted, %for.cond42.preheader.preheader ], [ %add121.lcssa457, %for.inc158 ]
  %32 = zext i32 %indvars.iv503 to i64
  %cmp43447 = icmp sgt i32 %31, 1
  br i1 %cmp43447, label %for.body44.lr.ph, label %for.cond42.preheader.for.inc158_crit_edge

for.cond42.preheader.for.inc158_crit_edge:        ; preds = %for.cond42.preheader
  %.pre532 = sext i32 %31 to i64
  br label %for.inc158

for.body44.lr.ph:                                 ; preds = %for.cond42.preheader
  %33 = add nsw i64 %indvars.iv518, -1
  %arrayidx67 = getelementptr inbounds ptr, ptr %30, i64 %33
  %cmp83428 = icmp ugt i64 %indvars.iv518, 2
  %34 = load ptr, ptr %arrayidx67, align 8
  %arrayidx129 = getelementptr inbounds ptr, ptr %.pre528, i64 %indvars.iv518
  %35 = load ptr, ptr %arrayidx129, align 8
  %arrayidx151 = getelementptr inbounds ptr, ptr %30, i64 %indvars.iv518
  %36 = load ptr, ptr %arrayidx151, align 8
  %37 = trunc i64 %indvars.iv518 to i32
  %xtraiter570 = and i64 %32, 1
  %38 = icmp eq i32 %indvars.iv503, 1
  %unroll_iter575 = and i64 %32, 4294967294
...
for.body44:                                       ; preds = %for.body44.lr.ph, %for.end118
  ...
  %indvars.iv490 = phi i32 [ -1, %for.body44.lr.ph ], [ %indvars.iv.next491, %for.end118 ]
  %39 = phi i32 [ %31, %for.body44.lr.ph ], [ %80, %for.end118 ]
  %40 = phi double [ %add121.lcssa458460, %for.body44.lr.ph ], [ %add121, %for.end118 ]
  %41 = zext i32 %indvars.iv490 to i64
...
for.body47.lr.ph:                                 ; preds = %for.body44
  %sub49 = add nsw i32 %39, -1
  %42 = sext i32 %sub49 to i64
  %cmp53 = icmp slt i64 %indvars.iv513, %42
...
for.body47.preheader:                             ; preds = %for.body47.lr.ph
  %xtraiter566 = and i64 %41, 1
  %43 = icmp eq i32 %indvars.iv490, 1
  br i1 %43, label %for.end80.loopexit.unr-lcssa, label %for.body47.preheader.new

for.body47.preheader.new:                         ; preds = %for.body47.preheader
  %unroll_iter = and i64 %41, 4294967294
  br label %for.body47

if.end64.us.peel:                                 ; preds = %for.body47.lr.ph
  %44 = load double, ptr %34, align 8
  %cmp70.us.peel = fcmp ogt double %44, %40
  %45 = select i1 %cmp70.us.peel, double %44, double 0.000000e+00
  br label %for.end80

for.body47:                                       ; preds = %for.body47, %for.body47.preheader.new
  %indvars.iv487 = phi i64 [ 0, %for.body47.preheader.new ], [ %indvars.iv.next488.1, %for.body47 ]
  %46 = phi double [ 0.000000e+00, %for.body47.preheader.new ], [ %51, %for.body47 ]
  ...
  %arrayidx69 = getelementptr inbounds double, ptr %34, i64 %indvars.iv487
  %47 = load double, ptr %arrayidx69, align 8
  %cmp70 = fcmp ogt double %47, %40
  %48 = select i1 %cmp70, double %47, double %46
  %49 = trunc i64 %indvars.iv487 to i32
  %k.0427.us432 = select i1 %cmp70, i32 %49, i32 %k.0427.us433
  %indvars.iv.next488 = or i64 %indvars.iv487, 1
  %arrayidx69.1 = getelementptr inbounds double, ptr %34, i64 %indvars.iv.next488
  %50 = load double, ptr %arrayidx69.1, align 8
  %cmp70.1 = fcmp ogt double %50, %40
  %51 = select i1 %cmp70.1, double %50, double %48
  %52 = trunc i64 %indvars.iv.next488 to i32
  %k.0427.us432.1 = select i1 %cmp70.1, i32 %52, i32 %k.0427.us432
  %indvars.iv.next488.1 = add nuw nsw i64 %indvars.iv487, 2
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %for.end80.loopexit.unr-lcssa, label %for.body47

for.end80.loopexit.unr-lcssa:                     ; preds = %for.body47, %for.body47.preheader
  %.lcssa561.ph = phi double [ undef, %for.body47.preheader ], [ %51, %for.body47 ]
  %k.0427.us432.lcssa.ph = phi i32 [ undef, %for.body47.preheader ], [ %k.0427.us432.1, %for.body47 ]
  %indvars.iv487.unr = phi i64 [ 0, %for.body47.preheader ], [ %indvars.iv.next488.1, %for.body47 ]
  %.unr = phi double [ 0.000000e+00, %for.body47.preheader ], [ %51, %for.body47 ]
  %k.0427.us433.unr = phi i32 [ 0, %for.body47.preheader ], [ %k.0427.us432.1, %for.body47 ]
  %lcmp.mod567.not = icmp eq i64 %xtraiter566, 0
  br i1 %lcmp.mod567.not, label %for.end80, label %for.body47.epil

for.body47.epil:                                  ; preds = %for.end80.loopexit.unr-lcssa
  %arrayidx69.epil = getelementptr inbounds double, ptr %34, i64 %indvars.iv487.unr
  %53 = load double, ptr %arrayidx69.epil, align 8
  %cmp70.epil = fcmp ogt double %53, %40
  %54 = select i1 %cmp70.epil, double %53, double %.unr
  %55 = trunc i64 %indvars.iv487.unr to i32
  %k.0427.us432.epil = select i1 %cmp70.epil, i32 %55, i32 %k.0427.us433.unr
  br label %for.end80
...
for.end80:                                        ; preds = %for.body47.epil, %for.end80.loopexit.unr-lcssa, %if.end64.us.peel, %for.body44
  ...
  %56 = phi double [ 0.000000e+00, %for.body44 ], [ %45, %if.end64.us.peel ], [ %.lcssa561.ph, %for.end80.loopexit.unr-lcssa ], [ %54, %for.body47.epil ]
...
for.body84.lr.ph:                                 ; preds = %for.end80
  ...
  %57 = sext i32 %sub87 to i64
  %cmp91 = icmp slt i64 %indvars.iv518, %57
  %58 = add nsw i64 %indvars.iv513, -1
  %cmp91.fr = freeze i1 %cmp91
  br i1 %cmp91.fr, label %if.end102.us.peel, label %for.body84.preheader

for.body84.preheader:                             ; preds = %for.body84.lr.ph
  br i1 %38, label %for.end118.loopexit.unr-lcssa, label %for.body84

if.end102.us.peel:                                ; preds = %for.body84.lr.ph
  %59 = load ptr, ptr %30, align 8
  %arrayidx107.us.peel = getelementptr inbounds double, ptr %59, i64 %58
  %60 = load double, ptr %arrayidx107.us.peel, align 8
  %cmp108.us.peel = fcmp ogt double %60, 0.000000e+00
  %61 = select i1 %cmp108.us.peel, double %60, double 0.000000e+00
  br label %for.end118

for.body84:                                       ; preds = %for.body84.preheader, %for.body84
  %indvars.iv500 = phi i64 [ %indvars.iv.next501.1, %for.body84 ], [ 0, %for.body84.preheader ]
  %k.1429.us439 = phi i32 [ %k.1429.us438.1, %for.body84 ], [ 0, %for.body84.preheader ]
  %62 = phi double [ %70, %for.body84 ], [ 0.000000e+00, %for.body84.preheader ]
  %niter576 = phi i64 [ %niter576.next.1, %for.body84 ], [ 0, %for.body84.preheader ]
  %arrayidx104 = getelementptr inbounds ptr, ptr %30, i64 %indvars.iv500
  %63 = load ptr, ptr %arrayidx104, align 8
  %arrayidx107 = getelementptr inbounds double, ptr %63, i64 %58
  %64 = load double, ptr %arrayidx107, align 8
  %cmp108 = fcmp ogt double %64, %62
  %65 = trunc i64 %indvars.iv500 to i32
  %k.1429.us438 = select i1 %cmp108, i32 %65, i32 %k.1429.us439
  %66 = select i1 %cmp108, double %64, double %62
  %indvars.iv.next501 = or i64 %indvars.iv500, 1
  %arrayidx104.1 = getelementptr inbounds ptr, ptr %30, i64 %indvars.iv.next501
  %67 = load ptr, ptr %arrayidx104.1, align 8
  %arrayidx107.1 = getelementptr inbounds double, ptr %67, i64 %58
  %68 = load double, ptr %arrayidx107.1, align 8
  %cmp108.1 = fcmp ogt double %68, %66
  %69 = trunc i64 %indvars.iv.next501 to i32
  %k.1429.us438.1 = select i1 %cmp108.1, i32 %69, i32 %k.1429.us438
  %70 = select i1 %cmp108.1, double %68, double %66
  %indvars.iv.next501.1 = add nuw nsw i64 %indvars.iv500, 2
  %niter576.next.1 = add i64 %niter576, 2
  %niter576.ncmp.1 = icmp eq i64 %niter576.next.1, %unroll_iter575
  br i1 %niter576.ncmp.1, label %for.end118.loopexit.unr-lcssa, label %for.body84

for.end118.loopexit.unr-lcssa:                    ; preds = %for.body84, %for.body84.preheader
  %k.1429.us438.lcssa.ph = phi i32 [ undef, %for.body84.preheader ], [ %k.1429.us438.1, %for.body84 ]
  %.lcssa562.ph = phi double [ undef, %for.body84.preheader ], [ %70, %for.body84 ]
  %indvars.iv500.unr = phi i64 [ 0, %for.body84.preheader ], [ %indvars.iv.next501.1, %for.body84 ]
  %k.1429.us439.unr = phi i32 [ 0, %for.body84.preheader ], [ %k.1429.us438.1, %for.body84 ]
  %.unr571 = phi double [ 0.000000e+00, %for.body84.preheader ], [ %70, %for.body84 ]
  br i1 %lcmp.mod572.not, label %for.end118, label %for.body84.epil

for.body84.epil:                                  ; preds = %for.end118.loopexit.unr-lcssa
  %arrayidx104.epil = getelementptr inbounds ptr, ptr %30, i64 %indvars.iv500.unr
  %71 = load ptr, ptr %arrayidx104.epil, align 8
  %arrayidx107.epil = getelementptr inbounds double, ptr %71, i64 %58
  %72 = load double, ptr %arrayidx107.epil, align 8
  %cmp108.epil = fcmp ogt double %72, %.unr571
  %73 = trunc i64 %indvars.iv500.unr to i32
  %k.1429.us438.epil = select i1 %cmp108.epil, i32 %73, i32 %k.1429.us439.unr
  %74 = select i1 %cmp108.epil, double %72, double %.unr571
  br label %for.end118

for.end118:                                       ; preds = %for.body84.epil, %for.end118.loopexit.unr-lcssa, %if.end102.us.peel, %for.end80.for.end118_crit_edge
  %.pre-phi = phi i64 [ %.pre531, %for.end80.for.end118_crit_edge ], [ %58, %if.end102.us.peel ], [ %58, %for.end118.loopexit.unr-lcssa ], [ %58, %for.body84.epil ]
  %k.1429.us451 = phi i32 [ 0, %for.end80.for.end118_crit_edge ], [ 0, %if.end102.us.peel ], [ %k.1429.us438.lcssa.ph, %for.end118.loopexit.unr-lcssa ], [ %k.1429.us438.epil, %for.body84.epil ]
  %75 = phi double [ 0.000000e+00, %for.end80.for.end118_crit_edge ], [ %61, %if.end102.us.peel ], [ %.lcssa562.ph, %for.end118.loopexit.unr-lcssa ], [ %74, %for.body84.epil ]
  %76 = load i32, ptr @penalty, align 4
  %conv = sitofp i32 %76 to double
  %add119 = fadd double %56, %conv
  %add121 = fadd double %75, %conv
  %arrayidx127 = getelementptr inbounds double, ptr %34, i64 %.pre-phi
  %77 = load double, ptr %arrayidx127, align 8
  %arrayidx131 = getelementptr inbounds i32, ptr %35, i64 %indvars.iv513
  %cmp132 = fcmp olt double %77, %add119
  %maximum.0 = select i1 %cmp132, double %add119, double %77
  %cmp141 = fcmp olt double %maximum.0, %add121
  %maximum.1 = select i1 %cmp141, double %add121, double %maximum.0
  %sub144 = sub nsw i32 %k.1429.us451, %37
  %78 = trunc i64 %indvars.iv513 to i32
  %sub135 = sub nsw i32 %78, %k.0427.us449
  %simplifycfg.merge469 = select i1 %cmp132, i32 %sub135, i32 0
  %storemerge = select i1 %cmp141, i32 %sub144, i32 %simplifycfg.merge469
  store i32 %storemerge, ptr %arrayidx131, align 4
  %arrayidx153 = getelementptr inbounds double, ptr %36, i64 %indvars.iv513
  %79 = load double, ptr %arrayidx153, align 8
  %add154 = fadd double %maximum.1, %79
  store double %add154, ptr %arrayidx153, align 8
  %indvars.iv.next514 = add nuw nsw i64 %indvars.iv513, 1
  %80 = load i32, ptr %ncut, align 4
  %81 = sext i32 %80 to i64
  %cmp43 = icmp slt i64 %indvars.iv.next514, %81
  %indvars.iv.next491 = add i32 %indvars.iv490, 1
  br i1 %cmp43, label %for.body44, label %for.cond42.for.inc158_crit_edge

for.cond42.for.inc158_crit_edge:                  ; preds = %for.end118
  store double %add121, ptr @blockAlign2.maxj, align 8
  br label %for.inc158

for.inc158:                                       ; preds = %for.cond42.preheader.for.inc158_crit_edge, %for.cond42.for.inc158_crit_edge
  %.pre-phi533 = phi i64 [ %.pre532, %for.cond42.preheader.for.inc158_crit_edge ], [ %81, %for.cond42.for.inc158_crit_edge ]
  %82 = phi i32 [ %31, %for.cond42.preheader.for.inc158_crit_edge ], [ %80, %for.cond42.for.inc158_crit_edge ]
  %add121.lcssa457 = phi double [ %add121.lcssa458460, %for.cond42.preheader.for.inc158_crit_edge ], [ %add121, %for.cond42.for.inc158_crit_edge ]
  %indvars.iv.next519 = add nuw nsw i64 %indvars.iv518, 1
  %cmp40 = icmp slt i64 %indvars.iv.next519, %.pre-phi533
  %indvars.iv.next504 = add i32 %indvars.iv503, 1
  br i1 %cmp40, label %for.cond42.preheader, label %for.end160

for.end160:                                       ; preds = %for.inc158, %for.cond39.preheader.thread, %for.cond39.preheader
  %.pre528536 = phi ptr [ %.pre528, %for.cond39.preheader ], [ %.pre528535, %for.cond39.preheader.thread ], [ %.pre528, %for.inc158 ]
  %.lcssa = phi i32 [ 1, %for.cond39.preheader ], [ %8, %for.cond39.preheader.thread ], [ %82, %for.inc158 ]
  %sub161 = add nsw i32 %.lcssa, -1
  store i32 %sub161, ptr getelementptr inbounds ([100000 x i32], ptr @blockAlign2.result1, i64 0, i64 99999), align 4
  store i32 %sub161, ptr getelementptr inbounds ([100000 x i32], ptr @blockAlign2.result2, i64 0, i64 99999), align 4
  br label %for.body166
...
for.body166:                                      ; preds = %for.end160, %for.inc218
  ...
  %83 = load i32, ptr %arrayidx168, align 4
  %arrayidx170 = getelementptr inbounds [100000 x i32], ptr @blockAlign2.result2, i64 0, i64 %idxprom167
  %84 = load i32, ptr %arrayidx170, align 4
  %cmp171 = icmp eq i32 %83, 0
  %cmp173 = icmp eq i32 %84, 0
  %or.cond = select i1 %cmp171, i1 true, i1 %cmp173
  br i1 %or.cond, label %for.end219, label %if.end176

if.end176:                                        ; preds = %for.body166
  %idxprom177 = sext i32 %83 to i64
  %arrayidx178 = getelementptr inbounds ptr, ptr %.pre528536, i64 %idxprom177
  %85 = load ptr, ptr %arrayidx178, align 8
  %idxprom179 = sext i32 %84 to i64
  %arrayidx180 = getelementptr inbounds i32, ptr %85, i64 %idxprom179
  %86 = load i32, ptr %arrayidx180, align 4
  %cmp181 = icmp eq i32 %86, 0
...
for.body223.preheader:                            ; preds = %for.inc218, %for.end219
  %i.3.lcssa539 = phi i32 [ %i.3464, %for.end219 ], [ 0, %for.inc218 ]
  %87 = zext i32 %i.3.lcssa539 to i64
  br label %for.body223

for.body223:                                      ; preds = %for.body223.preheader, %for.inc289
  %indvars.iv523 = phi i64 [ %87, %for.body223.preheader ], [ %indvars.iv.next524, %for.inc289 ]
  ...
  %88 = load i32, ptr %arrayidx225, align 4
  %idxprom226 = sext i32 %88 to i64
  %arrayidx227 = getelementptr inbounds ptr, ptr %ocrossscore, i64 %idxprom226
  %89 = load ptr, ptr %arrayidx227, align 8
  %arrayidx229 = getelementptr inbounds [100000 x i32], ptr @blockAlign2.result2, i64 0, i64 %indvars.iv523
  %90 = load i32, ptr %arrayidx229, align 4
  %idxprom230 = sext i32 %90 to i64
  %arrayidx231 = getelementptr inbounds double, ptr %89, i64 %idxprom230
  %91 = load double, ptr %arrayidx231, align 8
  %cmp232 = fcmp oeq double %91, 0.000000e+00
  br i1 %cmp232, label %for.inc289, label %if.end235

if.end235:                                        ; preds = %for.body223
  %92 = add nsw i64 %indvars.iv523, -1
  %arrayidx240 = getelementptr inbounds [100000 x i32], ptr @blockAlign2.result1, i64 0, i64 %92
  %93 = load i32, ptr %arrayidx240, align 4
  %cmp241 = icmp eq i32 %88, %93
  %arrayidx267.phi.trans.insert = getelementptr inbounds [100000 x i32], ptr @blockAlign2.result2, i64 0, i64 %92
  %.pre529 = load i32, ptr %arrayidx267.phi.trans.insert, align 4
  br i1 %cmp241, label %if.end235.if.then251_crit_edge, label %lor.lhs.false243
...
lor.lhs.false243:                                 ; preds = %if.end235
  %cmp249 = icmp eq i32 %90, %.pre529
  br i1 %cmp249, label %if.then251, label %if.end275

if.then251:                                       ; preds = %if.end235.if.then251_crit_edge, %lor.lhs.false243
  %idxprom268.pre-phi = phi i64 [ %.pre530, %if.end235.if.then251_crit_edge ], [ %idxprom230, %lor.lhs.false243 ]
  %idxprom263 = sext i32 %93 to i64
  %arrayidx264 = getelementptr inbounds ptr, ptr %ocrossscore, i64 %idxprom263
  %94 = load ptr, ptr %arrayidx264, align 8
  %arrayidx269 = getelementptr inbounds double, ptr %94, i64 %idxprom268.pre-phi
  %95 = load double, ptr %arrayidx269, align 8
  %cmp270 = fcmp ogt double %91, %95
  br i1 %cmp270, label %if.then272, label %if.end275
...
if.end275:                                        ; preds = %if.then251, %if.then272, %lor.lhs.false243
  ...
  %96 = load i32, ptr %arrayidx279, align 4
  %idxprom280 = sext i32 %count.1 to i64
  %arrayidx281 = getelementptr inbounds i32, ptr %cut1, i64 %idxprom280
  store i32 %96, ptr %arrayidx281, align 4
  %arrayidx285 = getelementptr inbounds [100000 x i32], ptr @blockAlign2.ocut2, i64 0, i64 %idxprom230
  %97 = load i32, ptr %arrayidx285, align 4
  %arrayidx287 = getelementptr inbounds i32, ptr %cut2, i64 %idxprom280
  store i32 %97, ptr %arrayidx287, align 4
  %inc288 = add nsw i32 %count.1, 1
  br label %for.inc289
...
for.inc289:                                       ; preds = %for.body223, %if.end275
  ...
  br i1 %exitcond527.not, label %for.end291, label %for.body223
...
entry:
  %0 = load i32, ptr @blockAlign3.crossscoresize, align 4
  %1 = load i32, ptr %ncut, align 4
  %add = add nsw i32 %1, 2
  %cmp = icmp slt i32 %0, %add
...
if.then:                                          ; preds = %entry
  store i32 %add, ptr @blockAlign3.crossscoresize, align 4
  %2 = load i32, ptr @fftkeika, align 4
  %tobool.not = icmp eq i32 %2, 0
  br i1 %tobool.not, label %if.end, label %if.then2
...
if.end:                                           ; preds = %if.then2, %if.then
  %4 = load ptr, ptr @blockAlign3.track, align 8
  %tobool3.not = icmp eq ptr %4, null
  br i1 %tobool3.not, label %if.end5, label %if.then4
...
if.end5:                                          ; preds = %if.then4, %if.end
  %5 = load ptr, ptr @blockAlign3.crossscore, align 8
  %tobool6.not = icmp eq ptr %5, null
  br i1 %tobool6.not, label %if.end8, label %if.then7
...
if.end8:                                          ; preds = %if.then7, %if.end5
  %6 = load ptr, ptr @blockAlign3.jumppos, align 8
...
if.end11:                                         ; preds = %if.then10, %if.end8
  %7 = load ptr, ptr @blockAlign3.jumpscore, align 8
...
if.end14:                                         ; preds = %if.then13, %if.end11
  %8 = load i32, ptr @blockAlign3.crossscoresize, align 4
  %call15 = tail call ptr @AllocateIntMtx(i32 noundef %8, i32 noundef %8) #22
  store ptr %call15, ptr @blockAlign3.track, align 8
  %9 = load i32, ptr @blockAlign3.crossscoresize, align 4
  %call16 = tail call ptr @AllocateDoubleMtx(i32 noundef %9, i32 noundef %9) #22
  store ptr %call16, ptr @blockAlign3.crossscore, align 8
  %10 = load i32, ptr @blockAlign3.crossscoresize, align 4
  %call17 = tail call ptr @AllocateIntVec(i32 noundef %10) #22
  store ptr %call17, ptr @blockAlign3.jumppos, align 8
  %11 = load i32, ptr @blockAlign3.crossscoresize, align 4
  %call18 = tail call ptr @AllocateDoubleVec(i32 noundef %11) #22
  store ptr %call18, ptr @blockAlign3.jumpscore, align 8
  %.pre = load i32, ptr %ncut, align 4
  br label %if.end19
...
for.cond21.preheader.us:                          ; preds = %for.cond21.for.inc30_crit_edge.us, %for.cond21.preheader.lr.ph
  ...
  %15 = load ptr, ptr %arrayidx27.us, align 8
  %16 = ptrtoint ptr %15 to i64
  %17 = ptrtoint ptr %14 to i64
  %18 = sub i64 %16, %17
  %diff.check = icmp ult i64 %18, 32
  %or.cond477 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond477, label %for.body23.us.preheader, label %vector.body
...
vector.body:                                      ; preds = %for.cond21.preheader.us, %vector.body
  ...
  %wide.load474 = load <2 x double>, ptr %20, align 8
  %21 = getelementptr inbounds double, ptr %15, i64 %index
  store <2 x double> %wide.load, ptr %21, align 8
  %22 = getelementptr inbounds double, ptr %21, i64 2
  store <2 x double> %wide.load474, ptr %22, align 8
  %index.next = add nuw i64 %index, 4
...
for.body23.us.prol:                               ; preds = %for.body23.us.preheader, %for.body23.us.prol
  ...
  %26 = load double, ptr %arrayidx25.us.prol, align 8
  %arrayidx29.us.prol = getelementptr inbounds double, ptr %15, i64 %indvars.iv.prol
  store double %26, ptr %arrayidx29.us.prol, align 8
  %indvars.iv.next.prol = add nuw nsw i64 %indvars.iv.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body23.us.prol.loopexit, label %for.body23.us.prol
...
for.cond21.for.inc30_crit_edge.us:                ; preds = %for.body23.us.prol.loopexit, %for.body23.us, %middle.block
  ...
  br i1 %exitcond437.not, label %for.cond33.preheader, label %for.cond21.preheader.us
...
for.body49.lr.ph:                                 ; preds = %for.cond33.preheader
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 @blockAlign3.ocut1, ptr align 4 %cut1, i64 %33, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 @blockAlign3.ocut2, ptr align 4 %cut2, i64 %33, i1 false)
  %34 = load ptr, ptr @blockAlign3.jumpscore, align 8
  %35 = load ptr, ptr @blockAlign3.jumppos, align 8
  br label %for.body49
...
for.body49:                                       ; preds = %for.body49.lr.ph, %for.body49
  ...
  store double -9.999990e+02, ptr %arrayidx51, align 8
  %arrayidx53 = getelementptr inbounds i32, ptr %35, i64 %indvars.iv441
  store i32 -1, ptr %arrayidx53, align 4
  %indvars.iv.next442 = add nuw nsw i64 %indvars.iv441, 1
  %36 = load i32, ptr %ncut, align 4
  %37 = sext i32 %36 to i64
  %cmp48 = icmp slt i64 %indvars.iv.next442, %37
  br i1 %cmp48, label %for.body49, label %for.cond57.preheader

for.body59:                                       ; preds = %for.cond57.preheader, %for.inc153
  %38 = phi i32 [ %59, %for.inc153 ], [ %36, %for.cond57.preheader ]
  %indvars.iv448 = phi i64 [ %indvars.iv.next449, %for.inc153 ], [ 1, %for.cond57.preheader ]
  store double -9.999990e+02, ptr @blockAlign3.jumpscorei, align 8
  %cmp61419 = icmp sgt i32 %38, 1
  br i1 %cmp61419, label %for.body62.lr.ph, label %for.body59.for.inc153_crit_edge

for.body59.for.inc153_crit_edge:                  ; preds = %for.body59
  %.pre459 = sext i32 %38 to i64
  br label %for.inc153
...
for.body62:                                       ; preds = %for.body62.lr.ph, %for.inc150
  ...
  %43 = load ptr, ptr @blockAlign3.crossscore, align 8
  ...
  %46 = load double, ptr %arrayidx68, align 8
  %47 = load ptr, ptr @blockAlign3.track, align 8
  ...
  %49 = load double, ptr @blockAlign3.jumpscorei, align 8
  %50 = load ptr, ptr @blockAlign3.jumpscore, align 8
  ...
  %52 = load double, ptr %arrayidx114, align 8
  %add115 = fadd double %46, %52
  store double %add115, ptr %arrayidx114, align 8
...
if.then123:                                       ; preds = %for.body62
  store double %53, ptr @blockAlign3.jumpscorei, align 8
  br label %if.end129

if.end129:                                        ; preds = %if.then123, %for.body62
  %54 = load double, ptr %arrayidx88, align 8
  %arrayidx136 = getelementptr inbounds double, ptr %51, i64 %45
  %55 = load double, ptr %arrayidx136, align 8
  %cmp137 = fcmp olt double %54, %55
  br i1 %cmp137, label %if.then139, label %for.inc150

if.then139:                                       ; preds = %if.end129
  store double %55, ptr %arrayidx88, align 8
  %56 = load ptr, ptr @blockAlign3.jumppos, align 8
  %arrayidx148 = getelementptr inbounds i32, ptr %56, i64 %indvars.iv444
  store i32 %40, ptr %arrayidx148, align 4
  br label %for.inc150

for.inc150:                                       ; preds = %if.end129, %if.then139
  %indvars.iv.next445 = add nuw nsw i64 %indvars.iv444, 1
  %57 = load i32, ptr %ncut, align 4
  %58 = sext i32 %57 to i64
  %cmp61 = icmp slt i64 %indvars.iv.next445, %58
  br i1 %cmp61, label %for.body62, label %for.inc153

for.inc153:                                       ; preds = %for.inc150, %for.body59.for.inc153_crit_edge
  %.pre-phi = phi i64 [ %.pre459, %for.body59.for.inc153_crit_edge ], [ %58, %for.inc150 ]
  %59 = phi i32 [ %38, %for.body59.for.inc153_crit_edge ], [ %57, %for.inc150 ]
  %indvars.iv.next449 = add nuw nsw i64 %indvars.iv448, 1
  %cmp58 = icmp slt i64 %indvars.iv.next449, %.pre-phi
  br i1 %cmp58, label %for.body59, label %for.end155

for.end155:                                       ; preds = %for.inc153, %for.cond33.preheader, %if.end19, %for.cond57.preheader
  %.lcssa = phi i32 [ %36, %for.cond57.preheader ], [ %12, %if.end19 ], [ %12, %for.cond33.preheader ], [ %59, %for.inc153 ]
  %sub156 = add nsw i32 %.lcssa, -1
  store i32 %sub156, ptr getelementptr inbounds ([100000 x i32], ptr @blockAlign3.result1, i64 0, i64 99999), align 4
  store i32 %sub156, ptr getelementptr inbounds ([100000 x i32], ptr @blockAlign3.result2, i64 0, i64 99999), align 4
...
for.body161:                                      ; preds = %for.end155, %for.inc213
  ...
  %62 = load i32, ptr %arrayidx165, align 4
...
if.then189:                                       ; preds = %if.else
  ...
  store i32 %sub190, ptr %arrayidx182, align 4
  %sub194 = sub nsw i32 %62, %64
  store i32 %sub194, ptr %arrayidx197, align 4
  br label %for.inc213

if.then201:                                       ; preds = %if.else
  %add202 = add nsw i32 %64, %61
  store i32 %add202, ptr %arrayidx182, align 4
  %sub206 = add nsw i32 %62, -1
  store i32 %sub206, ptr %arrayidx197, align 4
  br label %for.inc213

for.inc213:                                       ; preds = %if.then201, %if.then189, %if.then178
  %cmp159 = icmp ugt i32 %i.3425, 1
  br i1 %cmp159, label %for.body161, label %for.body218.preheader
...
for.body218:                                      ; preds = %for.body218.preheader, %for.inc284
  ...
  %66 = load i32, ptr %arrayidx220, align 4
...
if.end230:                                        ; preds = %for.body218
  ...
  %71 = load i32, ptr %arrayidx235, align 4
  ...
  %.pre457 = load i32, ptr %arrayidx262.phi.trans.insert, align 4
...
if.then246:                                       ; preds = %if.end230.if.then246_crit_edge, %lor.lhs.false238
  ...
  %72 = load ptr, ptr %arrayidx259, align 8
  %arrayidx264 = getelementptr inbounds double, ptr %72, i64 %idxprom263.pre-phi
  %73 = load double, ptr %arrayidx264, align 8
...
for.inc284:                                       ; preds = %for.body218, %if.end270
  ...
  br i1 %exitcond456.not, label %for.end286, label %for.body218
...
attributes #12 = { nofree nounwind memory(readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
