; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/mafft/Lalign11.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/mafft/Lalign11.c"
...
if.end.if.end61_crit_edge:                        ; preds = %if.end
  %.pre427 = load ptr, ptr @L__align11.mseq, align 8
  br label %if.end61
...
if.then21:                                        ; preds = %if.then16
  %10 = load ptr, ptr @L__align11.w1, align 8
  tail call void @FreeFloatVec(ptr noundef %10) #6
  %11 = load ptr, ptr @L__align11.w2, align 8
  tail call void @FreeFloatVec(ptr noundef %11) #6
  %12 = load ptr, ptr @L__align11.match, align 8
  tail call void @FreeFloatVec(ptr noundef %12) #6
  %13 = load ptr, ptr @L__align11.initverticalw, align 8
  tail call void @FreeFloatVec(ptr noundef %13) #6
  %14 = load ptr, ptr @L__align11.lastverticalw, align 8
  tail call void @FreeFloatVec(ptr noundef %14) #6
  %15 = load ptr, ptr @L__align11.m, align 8
  tail call void @FreeFloatVec(ptr noundef %15) #6
  %16 = load ptr, ptr @L__align11.mp, align 8
  tail call void @FreeIntVec(ptr noundef %16) #6
  %17 = load ptr, ptr @L__align11.mseq, align 8
  tail call void @FreeCharMtx(ptr noundef %17) #6
  %.pre425 = load i32, ptr @L__align11.orlgth1, align 4
  %.pre426 = load i32, ptr @L__align11.orlgth2, align 4
  br label %if.end22
...
if.end22:                                         ; preds = %if.then21, %if.then16
  ...
  store ptr %call58, ptr @L__align11.mseq, align 8
  store i32 %conv24., ptr @L__align11.orlgth1, align 4
  store i32 %cond41, ptr @L__align11.orlgth2, align 4
  br label %if.end61
...
lor.lhs.false68.if.end93_crit_edge:               ; preds = %if.end61
  %.pre433 = load ptr, ptr @commonIP, align 8
  br label %if.end93
...
if.then76:                                        ; preds = %if.then71
  %29 = load ptr, ptr @commonIP, align 8
...
if.end77:                                         ; preds = %if.then76, %if.then71
  ...
  store ptr %call92, ptr @commonIP, align 8
  store i32 %cond83, ptr @commonAlloc1, align 4
  store i32 %cond89, ptr @commonAlloc2, align 4
  br label %if.end93
...
if.end93:                                         ; preds = %lor.lhs.false68.if.end93_crit_edge, %if.end77
  ...
  store ptr %34, ptr @L__align11.ijp, align 8
  %35 = load ptr, ptr @L__align11.w1, align 8
  %36 = ptrtoint ptr %35 to i64
  %37 = load ptr, ptr @L__align11.w2, align 8
  %38 = load ptr, ptr @L__align11.initverticalw, align 8
  %seq2.val343 = load ptr, ptr %seq2, align 8
  %seq1.val344 = load ptr, ptr %seq1, align 8
  %39 = load i8, ptr %seq2.val343, align 1
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  %43 = load i8, ptr %seq2.03.i, align 1
  ...
  %46 = load i32, ptr %arrayidx7.i.1, align 4
...
match_calc.exit:                                  ; preds = %while.body.i.prol.loopexit, %while.body.i, %if.end93
  %51 = load i8, ptr %seq1.val344, align 1
  ...
  br i1 %tobool.not1.i347, label %for.end, label %while.body.i348.preheader

while.body.i348.preheader:                        ; preds = %match_calc.exit
  %xtraiter452 = and i32 %conv11, 3
  %lcmp.mod453.not = icmp eq i32 %xtraiter452, 0
  br i1 %lcmp.mod453.not, label %while.body.i348.prol.loopexit, label %while.body.i348.prol

while.body.i348.prol:                             ; preds = %while.body.i348.preheader, %while.body.i348.prol
  %match.addr.04.i349.prol = phi ptr [ %incdec.ptr9.i357.prol, %while.body.i348.prol ], [ %35, %while.body.i348.preheader ]
  %seq2.03.i350.prol = phi ptr [ %incdec.ptr.i353.prol, %while.body.i348.prol ], [ %seq2.val343, %while.body.i348.preheader ]
  %lgth2.addr.02.i351.prol = phi i32 [ %dec.i352.prol, %while.body.i348.prol ], [ %conv11, %while.body.i348.preheader ]
  %prol.iter454 = phi i32 [ %prol.iter454.next, %while.body.i348.prol ], [ 0, %while.body.i348.preheader ]
  %dec.i352.prol = add nsw i32 %lgth2.addr.02.i351.prol, -1
  %incdec.ptr.i353.prol = getelementptr inbounds i8, ptr %seq2.03.i350.prol, i64 1
  %52 = load i8, ptr %seq2.03.i350.prol, align 1
  %idxprom6.i354.prol = sext i8 %52 to i64
  %arrayidx7.i355.prol = getelementptr inbounds i32, ptr %arrayidx4.i346, i64 %idxprom6.i354.prol
  %53 = load i32, ptr %arrayidx7.i355.prol, align 4
  %conv8.i356.prol = sitofp i32 %53 to float
  %incdec.ptr9.i357.prol = getelementptr inbounds float, ptr %match.addr.04.i349.prol, i64 1
  store float %conv8.i356.prol, ptr %match.addr.04.i349.prol, align 4
  %prol.iter454.next = add i32 %prol.iter454, 1
  %prol.iter454.cmp.not = icmp eq i32 %prol.iter454.next, %xtraiter452
  br i1 %prol.iter454.cmp.not, label %while.body.i348.prol.loopexit, label %while.body.i348.prol

while.body.i348.prol.loopexit:                    ; preds = %while.body.i348.prol, %while.body.i348.preheader
  %match.addr.04.i349.unr = phi ptr [ %35, %while.body.i348.preheader ], [ %incdec.ptr9.i357.prol, %while.body.i348.prol ]
  %seq2.03.i350.unr = phi ptr [ %seq2.val343, %while.body.i348.preheader ], [ %incdec.ptr.i353.prol, %while.body.i348.prol ]
  %lgth2.addr.02.i351.unr = phi i32 [ %conv11, %while.body.i348.preheader ], [ %dec.i352.prol, %while.body.i348.prol ]
  %54 = icmp ult i32 %conv11, 4
  br i1 %54, label %match_calc.exit359, label %while.body.i348

while.body.i348:                                  ; preds = %while.body.i348.prol.loopexit, %while.body.i348
  %match.addr.04.i349 = phi ptr [ %incdec.ptr9.i357.3, %while.body.i348 ], [ %match.addr.04.i349.unr, %while.body.i348.prol.loopexit ]
  %seq2.03.i350 = phi ptr [ %incdec.ptr.i353.3, %while.body.i348 ], [ %seq2.03.i350.unr, %while.body.i348.prol.loopexit ]
  %lgth2.addr.02.i351 = phi i32 [ %dec.i352.3, %while.body.i348 ], [ %lgth2.addr.02.i351.unr, %while.body.i348.prol.loopexit ]
  %incdec.ptr.i353 = getelementptr inbounds i8, ptr %seq2.03.i350, i64 1
  %55 = load i8, ptr %seq2.03.i350, align 1
  %idxprom6.i354 = sext i8 %55 to i64
  %arrayidx7.i355 = getelementptr inbounds i32, ptr %arrayidx4.i346, i64 %idxprom6.i354
  %56 = load i32, ptr %arrayidx7.i355, align 4
  %conv8.i356 = sitofp i32 %56 to float
  %incdec.ptr9.i357 = getelementptr inbounds float, ptr %match.addr.04.i349, i64 1
  store float %conv8.i356, ptr %match.addr.04.i349, align 4
  %incdec.ptr.i353.1 = getelementptr inbounds i8, ptr %seq2.03.i350, i64 2
  %57 = load i8, ptr %incdec.ptr.i353, align 1
  %idxprom6.i354.1 = sext i8 %57 to i64
  %arrayidx7.i355.1 = getelementptr inbounds i32, ptr %arrayidx4.i346, i64 %idxprom6.i354.1
  %58 = load i32, ptr %arrayidx7.i355.1, align 4
  %conv8.i356.1 = sitofp i32 %58 to float
  %incdec.ptr9.i357.1 = getelementptr inbounds float, ptr %match.addr.04.i349, i64 2
  store float %conv8.i356.1, ptr %incdec.ptr9.i357, align 4
  %incdec.ptr.i353.2 = getelementptr inbounds i8, ptr %seq2.03.i350, i64 3
  %59 = load i8, ptr %incdec.ptr.i353.1, align 1
  %idxprom6.i354.2 = sext i8 %59 to i64
  %arrayidx7.i355.2 = getelementptr inbounds i32, ptr %arrayidx4.i346, i64 %idxprom6.i354.2
  %60 = load i32, ptr %arrayidx7.i355.2, align 4
  %conv8.i356.2 = sitofp i32 %60 to float
  %incdec.ptr9.i357.2 = getelementptr inbounds float, ptr %match.addr.04.i349, i64 3
  store float %conv8.i356.2, ptr %incdec.ptr9.i357.1, align 4
  %dec.i352.3 = add nsw i32 %lgth2.addr.02.i351, -4
  %incdec.ptr.i353.3 = getelementptr inbounds i8, ptr %seq2.03.i350, i64 4
  %61 = load i8, ptr %incdec.ptr.i353.2, align 1
  %idxprom6.i354.3 = sext i8 %61 to i64
  %arrayidx7.i355.3 = getelementptr inbounds i32, ptr %arrayidx4.i346, i64 %idxprom6.i354.3
  %62 = load i32, ptr %arrayidx7.i355.3, align 4
  %conv8.i356.3 = sitofp i32 %62 to float
  %incdec.ptr9.i357.3 = getelementptr inbounds float, ptr %match.addr.04.i349, i64 4
  store float %conv8.i356.3, ptr %incdec.ptr9.i357.2, align 4
  %tobool.not.i358.3 = icmp eq i32 %dec.i352.3, 0
  br i1 %tobool.not.i358.3, label %match_calc.exit359, label %while.body.i348

match_calc.exit359:                               ; preds = %while.body.i348, %while.body.i348.prol.loopexit
...
for.body.lr.ph:                                   ; preds = %match_calc.exit359
  %63 = load ptr, ptr @L__align11.m, align 8
  %64 = load ptr, ptr @L__align11.mp, align 8
  %65 = add i64 %call10, 1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load440 = load <4 x float>, ptr %71, align 4
  %72 = getelementptr inbounds float, ptr %63, i64 %offset.idx
  store <4 x float> %wide.load, ptr %72, align 4
  %73 = getelementptr inbounds float, ptr %72, i64 4
  store <4 x float> %wide.load440, ptr %73, align 4
  %74 = getelementptr inbounds i32, ptr %64, i64 %offset.idx
  store <4 x i32> zeroinitializer, ptr %74, align 4
  %75 = getelementptr inbounds i32, ptr %74, i64 4
  store <4 x i32> zeroinitializer, ptr %75, align 4
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  ...
  %81 = load float, ptr %arrayidx98, align 4
  %arrayidx100 = getelementptr inbounds float, ptr %63, i64 %indvars.iv
  store float %81, ptr %arrayidx100, align 4
  ...
  %82 = load float, ptr %arrayidx98.1, align 4
  %arrayidx100.1 = getelementptr inbounds float, ptr %63, i64 %indvars.iv.next
  store float %82, ptr %arrayidx100.1, align 4
...
for.end:                                          ; preds = %for.body.prol.loopexit, %for.body, %middle.block, %match_calc.exit, %match_calc.exit359
  ...
  %83 = load float, ptr %arrayidx105, align 4
  %84 = load ptr, ptr @L__align11.lastverticalw, align 8
...
for.body113.lr.ph:                                ; preds = %for.end
  %85 = load ptr, ptr @L__align11.m, align 8
  %86 = load ptr, ptr @L__align11.mp, align 8
  %wide.trip.count423 = zext i32 %add108 to i64
  %xtraiter458 = and i32 %conv11, 3
...
for.body113:                                      ; preds = %for.body113.lr.ph, %for.end172
  ...
  %89 = load float, ptr %arrayidx116, align 4
  store float %89, ptr %currentw.0409, align 4
  ...
  br i1 %tobool.not1.i347, label %match_calc.exit374, label %while.body.i363.preheader

while.body.i363.preheader:                        ; preds = %for.body113
  br i1 %lcmp.mod459.not, label %while.body.i363.prol.loopexit, label %while.body.i363.prol

while.body.i363.prol:                             ; preds = %while.body.i363.preheader, %while.body.i363.prol
  %match.addr.04.i364.prol = phi ptr [ %incdec.ptr9.i372.prol, %while.body.i363.prol ], [ %previousw.0408, %while.body.i363.preheader ]
  %seq2.03.i365.prol = phi ptr [ %incdec.ptr.i368.prol, %while.body.i363.prol ], [ %seq2.val343, %while.body.i363.preheader ]
  %lgth2.addr.02.i366.prol = phi i32 [ %dec.i367.prol, %while.body.i363.prol ], [ %conv11, %while.body.i363.preheader ]
  %prol.iter460 = phi i32 [ %prol.iter460.next, %while.body.i363.prol ], [ 0, %while.body.i363.preheader ]
  %dec.i367.prol = add nsw i32 %lgth2.addr.02.i366.prol, -1
  %incdec.ptr.i368.prol = getelementptr inbounds i8, ptr %seq2.03.i365.prol, i64 1
  %91 = load i8, ptr %seq2.03.i365.prol, align 1
  %idxprom6.i369.prol = sext i8 %91 to i64
  %arrayidx7.i370.prol = getelementptr inbounds i32, ptr %arrayidx4.i361, i64 %idxprom6.i369.prol
  %92 = load i32, ptr %arrayidx7.i370.prol, align 4
  %conv8.i371.prol = sitofp i32 %92 to float
  %incdec.ptr9.i372.prol = getelementptr inbounds float, ptr %match.addr.04.i364.prol, i64 1
  store float %conv8.i371.prol, ptr %match.addr.04.i364.prol, align 4
  %prol.iter460.next = add i32 %prol.iter460, 1
  %prol.iter460.cmp.not = icmp eq i32 %prol.iter460.next, %xtraiter458
  br i1 %prol.iter460.cmp.not, label %while.body.i363.prol.loopexit, label %while.body.i363.prol

while.body.i363.prol.loopexit:                    ; preds = %while.body.i363.prol, %while.body.i363.preheader
  %match.addr.04.i364.unr = phi ptr [ %previousw.0408, %while.body.i363.preheader ], [ %incdec.ptr9.i372.prol, %while.body.i363.prol ]
  %seq2.03.i365.unr = phi ptr [ %seq2.val343, %while.body.i363.preheader ], [ %incdec.ptr.i368.prol, %while.body.i363.prol ]
  %lgth2.addr.02.i366.unr = phi i32 [ %conv11, %while.body.i363.preheader ], [ %dec.i367.prol, %while.body.i363.prol ]
  br i1 %87, label %match_calc.exit374, label %while.body.i363

while.body.i363:                                  ; preds = %while.body.i363.prol.loopexit, %while.body.i363
  %match.addr.04.i364 = phi ptr [ %incdec.ptr9.i372.3, %while.body.i363 ], [ %match.addr.04.i364.unr, %while.body.i363.prol.loopexit ]
  %seq2.03.i365 = phi ptr [ %incdec.ptr.i368.3, %while.body.i363 ], [ %seq2.03.i365.unr, %while.body.i363.prol.loopexit ]
  %lgth2.addr.02.i366 = phi i32 [ %dec.i367.3, %while.body.i363 ], [ %lgth2.addr.02.i366.unr, %while.body.i363.prol.loopexit ]
  %incdec.ptr.i368 = getelementptr inbounds i8, ptr %seq2.03.i365, i64 1
  %93 = load i8, ptr %seq2.03.i365, align 1
  %idxprom6.i369 = sext i8 %93 to i64
  %arrayidx7.i370 = getelementptr inbounds i32, ptr %arrayidx4.i361, i64 %idxprom6.i369
  %94 = load i32, ptr %arrayidx7.i370, align 4
  %conv8.i371 = sitofp i32 %94 to float
  %incdec.ptr9.i372 = getelementptr inbounds float, ptr %match.addr.04.i364, i64 1
  store float %conv8.i371, ptr %match.addr.04.i364, align 4
  %incdec.ptr.i368.1 = getelementptr inbounds i8, ptr %seq2.03.i365, i64 2
  %95 = load i8, ptr %incdec.ptr.i368, align 1
  %idxprom6.i369.1 = sext i8 %95 to i64
  %arrayidx7.i370.1 = getelementptr inbounds i32, ptr %arrayidx4.i361, i64 %idxprom6.i369.1
  %96 = load i32, ptr %arrayidx7.i370.1, align 4
  %conv8.i371.1 = sitofp i32 %96 to float
  %incdec.ptr9.i372.1 = getelementptr inbounds float, ptr %match.addr.04.i364, i64 2
  store float %conv8.i371.1, ptr %incdec.ptr9.i372, align 4
  %incdec.ptr.i368.2 = getelementptr inbounds i8, ptr %seq2.03.i365, i64 3
  %97 = load i8, ptr %incdec.ptr.i368.1, align 1
  %idxprom6.i369.2 = sext i8 %97 to i64
  %arrayidx7.i370.2 = getelementptr inbounds i32, ptr %arrayidx4.i361, i64 %idxprom6.i369.2
  %98 = load i32, ptr %arrayidx7.i370.2, align 4
  %conv8.i371.2 = sitofp i32 %98 to float
  %incdec.ptr9.i372.2 = getelementptr inbounds float, ptr %match.addr.04.i364, i64 3
  store float %conv8.i371.2, ptr %incdec.ptr9.i372.1, align 4
  %dec.i367.3 = add nsw i32 %lgth2.addr.02.i366, -4
  %incdec.ptr.i368.3 = getelementptr inbounds i8, ptr %seq2.03.i365, i64 4
  %99 = load i8, ptr %incdec.ptr.i368.2, align 1
  %idxprom6.i369.3 = sext i8 %99 to i64
  %arrayidx7.i370.3 = getelementptr inbounds i32, ptr %arrayidx4.i361, i64 %idxprom6.i369.3
  %100 = load i32, ptr %arrayidx7.i370.3, align 4
  %conv8.i371.3 = sitofp i32 %100 to float
  %incdec.ptr9.i372.3 = getelementptr inbounds float, ptr %match.addr.04.i364, i64 4
  store float %conv8.i371.3, ptr %incdec.ptr9.i372.2, align 4
  %tobool.not.i373.3 = icmp eq i32 %dec.i367.3, 0
  br i1 %tobool.not.i373.3, label %match_calc.exit374, label %while.body.i363

match_calc.exit374:                               ; preds = %while.body.i363.prol.loopexit, %while.body.i363, %for.body113
  %arrayidx119 = getelementptr inbounds float, ptr %38, i64 %indvars.iv419
  %101 = load float, ptr %arrayidx119, align 4
  store float %101, ptr %previousw.0408, align 4
  br i1 %cmp95.not378438, label %for.end172, label %for.body131.preheader

for.body131.preheader:                            ; preds = %match_calc.exit374
  %102 = load float, ptr %currentw.0409, align 4
  %arrayidx123 = getelementptr inbounds ptr, ptr %34, i64 %indvars.iv419
  %103 = load ptr, ptr %arrayidx123, align 8
...
for.body131:                                      ; preds = %for.body131.preheader, %if.end164
  ...
  %108 = load float, ptr %mjpt.0397, align 4
...
if.then148:                                       ; preds = %for.body131
  %109 = load i32, ptr %mpjpt.0396, align 4
  %sub149 = sub nsw i32 %104, %109
  store i32 %sub149, ptr %ijppt.0398, align 4
  br label %if.end150
...
if.then163:                                       ; preds = %if.end155
  store i32 %add109, ptr %ijppt.0398, align 4
  br label %if.end164

if.end164:                                        ; preds = %if.then163, %if.end155
  %wm.2 = phi float [ %conv, %if.then163 ], [ %wm.1, %if.end155 ]
  %111 = load float, ptr %curpt.0399, align 4
  %add165 = fadd float %wm.2, %111
  store float %add165, ptr %curpt.0399, align 4
  ...
  br i1 %exitcond418.not, label %for.end172, label %for.body131
...
if.end192:                                        ; preds = %for.end180
  %116 = load ptr, ptr @L__align11.mseq1, align 8
  %117 = load ptr, ptr @L__align11.mseq2, align 8
...
for.cond7.preheader.i.loopexit.unr-lcssa:         ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  br i1 %lcmp.mod462.not, label %for.cond7.preheader.i, label %for.body.i.epil
...
for.body.i.epil:                                  ; preds = %for.cond7.preheader.i.loopexit.unr-lcssa, %for.body.i.epil
  ...
  %121 = load ptr, ptr %arrayidx5.i.epil, align 8
  store i32 %add109, ptr %121, align 4
  %indvars.iv.next.i.epil = add nuw nsw i64 %indvars.iv.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter461
  br i1 %epil.iter.cmp.not, label %for.cond7.preheader.i, label %for.body.i.epil
...
vector.body449:                                   ; preds = %vector.body449, %vector.ph444
  %index450 = phi i64 [ 0, %vector.ph444 ], [ %index.next451, %vector.body449 ]
  %124 = getelementptr inbounds i32, ptr %122, i64 %index450
  store <4 x i32> %broadcast.splat, ptr %124, align 4
  %125 = getelementptr inbounds i32, ptr %124, i64 4
  store <4 x i32> %broadcast.splat, ptr %125, align 4
  %index.next451 = add nuw i64 %index450, 8
  %126 = icmp eq i64 %index.next451, %n.vec446
  br i1 %126, label %middle.block441, label %vector.body449
...
for.body11.i:                                     ; preds = %for.body11.i.preheader, %for.body11.i
  ...
  store i32 %add109, ptr %arrayidx14.i, align 4
  %indvars.iv.next26.i = add nuw nsw i64 %indvars.iv25.i, 1
  %exitcond29.not.i = icmp eq i64 %indvars.iv.next26.i, %wide.trip.count28.i
  br i1 %exitcond29.not.i, label %for.end17.i, label %for.body11.i
...
for.end17.i:                                      ; preds = %for.body11.i, %middle.block441, %for.cond7.preheader.i
  ...
  store ptr %add.ptr24.i, ptr %117, align 8
  store i8 0, ptr %add.ptr24.i, align 1
...
for.body30.lr.ph.i:                               ; preds = %for.end17.i
  %.pre.i = load ptr, ptr %arrayidx182, align 8
  %arrayidx34.phi.trans.insert.i = getelementptr inbounds i32, ptr %.pre.i, i64 %idxprom183
  %.pre38.i = load i32, ptr %arrayidx34.phi.trans.insert.i, align 4
...
while.body.preheader.i:                           ; preds = %if.end58.i
  ...
  %xtraiter463 = and i32 %dec5.i, 1
  %lcmp.mod464.not = icmp eq i32 %xtraiter463, 0
  br i1 %lcmp.mod464.not, label %while.body.i375.prol.loopexit, label %while.body.i375.prol

while.body.i375.prol:                             ; preds = %while.body.preheader.i
  %143 = load ptr, ptr %seq1, align 8
  %144 = add nsw i64 %139, %140
  %arrayidx63.i.prol = getelementptr inbounds i8, ptr %143, i64 %144
  %145 = load i8, ptr %arrayidx63.i.prol, align 1
  %146 = load ptr, ptr %116, align 8
  %incdec.ptr.i376.prol = getelementptr inbounds i8, ptr %146, i64 -1
  store ptr %incdec.ptr.i376.prol, ptr %116, align 8
  store i8 %145, ptr %incdec.ptr.i376.prol, align 1
  %147 = load ptr, ptr %117, align 8
  %incdec.ptr66.i.prol = getelementptr inbounds i8, ptr %147, i64 -1
  store ptr %incdec.ptr66.i.prol, ptr %117, align 8
  store i8 45, ptr %incdec.ptr66.i.prol, align 1
  %indvars.iv.next31.i.prol = add nsw i64 %139, -1
  br label %while.body.i375.prol.loopexit

while.body.i375.prol.loopexit:                    ; preds = %while.body.i375.prol, %while.body.preheader.i
  %indvars.iv30.i.unr = phi i64 [ %139, %while.body.preheader.i ], [ %indvars.iv.next31.i.prol, %while.body.i375.prol ]
  %148 = icmp eq i32 %142, %ifi.1.fr.i
  br i1 %148, label %while.end.loopexit.i, label %while.body.i375

while.body.i375:                                  ; preds = %while.body.i375.prol.loopexit, %while.body.i375
  %indvars.iv30.i = phi i64 [ %indvars.iv.next31.i.1, %while.body.i375 ], [ %indvars.iv30.i.unr, %while.body.i375.prol.loopexit ]
  %149 = load ptr, ptr %seq1, align 8
  %150 = add nsw i64 %indvars.iv30.i, %140
  %arrayidx63.i = getelementptr inbounds i8, ptr %149, i64 %150
  %151 = load i8, ptr %arrayidx63.i, align 1
  %152 = load ptr, ptr %116, align 8
  %incdec.ptr.i376 = getelementptr inbounds i8, ptr %152, i64 -1
  store ptr %incdec.ptr.i376, ptr %116, align 8
  store i8 %151, ptr %incdec.ptr.i376, align 1
  %153 = load ptr, ptr %117, align 8
  %incdec.ptr66.i = getelementptr inbounds i8, ptr %153, i64 -1
  store ptr %incdec.ptr66.i, ptr %117, align 8
  store i8 45, ptr %incdec.ptr66.i, align 1
  %indvars.iv.next31.i = add nsw i64 %indvars.iv30.i, -1
  %154 = load ptr, ptr %seq1, align 8
  %155 = add nsw i64 %indvars.iv.next31.i, %140
  %arrayidx63.i.1 = getelementptr inbounds i8, ptr %154, i64 %155
  %156 = load i8, ptr %arrayidx63.i.1, align 1
  %157 = load ptr, ptr %116, align 8
  %incdec.ptr.i376.1 = getelementptr inbounds i8, ptr %157, i64 -1
  store ptr %incdec.ptr.i376.1, ptr %116, align 8
  store i8 %156, ptr %incdec.ptr.i376.1, align 1
  %158 = load ptr, ptr %117, align 8
  %incdec.ptr66.i.1 = getelementptr inbounds i8, ptr %158, i64 -1
  store ptr %incdec.ptr66.i.1, ptr %117, align 8
  store i8 45, ptr %incdec.ptr66.i.1, align 1
  %indvars.iv.next31.i.1 = add nsw i64 %indvars.iv30.i, -2
  %159 = and i64 %indvars.iv.next31.i.1, 4294967295
  %tobool.not.i377.1 = icmp eq i64 %159, 0
  br i1 %tobool.not.i377.1, label %while.end.loopexit.i, label %while.body.i375

while.end.loopexit.i:                             ; preds = %while.body.i375, %while.body.i375.prol.loopexit
...
while.body72.preheader.i:                         ; preds = %while.end.i
  ...
  %xtraiter466 = and i32 %dec709.i, 1
  %lcmp.mod467.not = icmp eq i32 %xtraiter466, 0
  br i1 %lcmp.mod467.not, label %while.body72.i.prol.loopexit, label %while.body72.i.prol
...
while.body72.i.prol:                              ; preds = %while.body72.preheader.i
  ...
  store ptr %incdec.ptr75.i.prol, ptr %116, align 8
  store i8 45, ptr %incdec.ptr75.i.prol, align 1
  %165 = load ptr, ptr %seq2, align 8
  %166 = add nsw i64 %162, %163
  %arrayidx79.i.prol = getelementptr inbounds i8, ptr %165, i64 %166
  %167 = load i8, ptr %arrayidx79.i.prol, align 1
  %168 = load ptr, ptr %117, align 8
  %incdec.ptr81.i.prol = getelementptr inbounds i8, ptr %168, i64 -1
  store ptr %incdec.ptr81.i.prol, ptr %117, align 8
  store i8 %167, ptr %incdec.ptr81.i.prol, align 1
...
while.body72.i:                                   ; preds = %while.body72.i.prol.loopexit, %while.body72.i
  ...
  store ptr %incdec.ptr75.i, ptr %116, align 8
  store i8 45, ptr %incdec.ptr75.i, align 1
  %171 = load ptr, ptr %seq2, align 8
  %172 = add nsw i64 %indvars.iv34.i, %163
  %arrayidx79.i = getelementptr inbounds i8, ptr %171, i64 %172
  %173 = load i8, ptr %arrayidx79.i, align 1
  %174 = load ptr, ptr %117, align 8
  %incdec.ptr81.i = getelementptr inbounds i8, ptr %174, i64 -1
  store ptr %incdec.ptr81.i, ptr %117, align 8
  store i8 %173, ptr %incdec.ptr81.i, align 1
  ...
  store ptr %incdec.ptr75.i.1, ptr %116, align 8
  store i8 45, ptr %incdec.ptr75.i.1, align 1
  %176 = load ptr, ptr %seq2, align 8
  %177 = add nsw i64 %indvars.iv.next35.i, %163
  %arrayidx79.i.1 = getelementptr inbounds i8, ptr %176, i64 %177
  %178 = load i8, ptr %arrayidx79.i.1, align 1
  %179 = load ptr, ptr %117, align 8
  %incdec.ptr81.i.1 = getelementptr inbounds i8, ptr %179, i64 -1
  store ptr %incdec.ptr81.i.1, ptr %117, align 8
  store i8 %178, ptr %incdec.ptr81.i.1, align 1
  ...
  br i1 %tobool71.not.i.1, label %while.end83.i, label %while.body72.i
...
if.end89.i:                                       ; preds = %while.end83.i
  ...
  br i1 %or.cond48.i, label %for.end111.i, label %for.body30.i
...
Ltracking.exit:                                   ; preds = %.thread.i, %for.end111.i
  ...
  store i32 %189, ptr %off2pt, align 4
...
if.then202:                                       ; preds = %Ltracking.exit
  ...
  %.pre434 = load ptr, ptr @L__align11.mseq1, align 8
  %.pre435 = load ptr, ptr %.pre434, align 8
  %.pre436 = load ptr, ptr @L__align11.mseq2, align 8
  br label %if.end204
