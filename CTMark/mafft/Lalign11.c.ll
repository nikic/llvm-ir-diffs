...
while.body.i348.prol:                             ; preds = %while.body.i348.preheader, %while.body.i348.prol
  ...
  %52 = load i8, ptr %seq2.03.i350.prol, align 1, !tbaa !11
  ...
  %53 = load i32, ptr %arrayidx7.i355.prol, align 4, !tbaa !5
  ...
  store float %conv8.i356.prol, ptr %match.addr.04.i349.prol, align 4, !tbaa !12
  %prol.iter454.next = add i32 %prol.iter454, 1
  %prol.iter454.cmp.not = icmp eq i32 %prol.iter454.next, %xtraiter452
  br i1 %prol.iter454.cmp.not, label %while.body.i348.prol.loopexit, label %while.body.i348.prol, !llvm.loop !18
...
while.body.i363.prol:                             ; preds = %while.body.i363.preheader, %while.body.i363.prol
  ...
  %91 = load i8, ptr %seq2.03.i365.prol, align 1, !tbaa !11
  ...
  %92 = load i32, ptr %arrayidx7.i370.prol, align 4, !tbaa !5
  ...
  store float %conv8.i371.prol, ptr %match.addr.04.i364.prol, align 4, !tbaa !12
  %prol.iter460.next = add i32 %prol.iter460, 1
  %prol.iter460.cmp.not = icmp eq i32 %prol.iter460.next, %xtraiter458
  br i1 %prol.iter460.cmp.not, label %while.body.i363.prol.loopexit, label %while.body.i363.prol, !llvm.loop !23
...
vector.body449:                                   ; preds = %vector.body449, %vector.ph444
  ...
  store <4 x i32> %broadcast.splat, ptr %125, align 4, !tbaa !5
...
while.body.i375.prol:                             ; preds = %while.body.preheader.i
  ...
  store ptr %incdec.ptr.i376.prol, ptr %116, align 8, !tbaa !9
  store i8 %145, ptr %incdec.ptr.i376.prol, align 1, !tbaa !11
...
while.body.i375:                                  ; preds = %while.body.i375.prol.loopexit, %while.body.i375
  ...
  store ptr %incdec.ptr.i376, ptr %116, align 8, !tbaa !9
  store i8 %151, ptr %incdec.ptr.i376, align 1, !tbaa !11
  ...
  store ptr %incdec.ptr.i376.1, ptr %116, align 8, !tbaa !9
  store i8 %156, ptr %incdec.ptr.i376.1, align 1, !tbaa !11
  ...
  br i1 %tobool.not.i377.1, label %while.end.loopexit.i, label %while.body.i375, !llvm.loop !30
