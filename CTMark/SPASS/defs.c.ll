; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/defs.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/defs.c"
...
while.body.i.i:                                   ; preds = %if.then, %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i, label %list_Delete.exit.loopexit.i, label %while.body.i.i
...
list_Delete.exit.i:                               ; preds = %list_Delete.exit.loopexit.i, %if.then
  ...
  br i1 %cmp.i.not5.i12.i, label %if.end, label %while.body.i13.i

while.body.i13.i:                                 ; preds = %list_Delete.exit.i, %while.body.i13.i
  %Current.06.i14.i = phi ptr [ %Current.0.val.i15.i, %while.body.i13.i ], [ %D.val11.val.i, %list_Delete.exit.i ]
  %Current.0.val.i15.i = load ptr, ptr %Current.06.i14.i, align 8
  %9 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i16.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %9, i64 0, i32 4
  %10 = load i32, ptr %total_size.i.i.i16.i, align 8
  %conv26.i.i.i17.i = sext i32 %10 to i64
  %11 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i18.i = add i64 %11, %conv26.i.i.i17.i
  store i64 %add27.i.i.i18.i, ptr @memory_FREEDBYTES, align 8
  %12 = load ptr, ptr %9, align 8
  store ptr %12, ptr %Current.06.i14.i, align 8
  %13 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i14.i, ptr %13, align 8
  %cmp.i.not.i19.i = icmp eq ptr %Current.0.val.i15.i, null
  br i1 %cmp.i.not.i19.i, label %if.end.sink.split, label %while.body.i13.i
...
if.end.sink.split:                                ; preds = %while.body.i13.i, %if.then.i, %if.else
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %op.rdx61 = select i1 %op.rdx, i1 true, i1 %cmp.i.not.i45
  %op.rdx62 = select i1 %op.rdx61, i1 true, i1 %cmp.i31.not.i
  %op.rdx63 = select i1 %op.rdx62, i1 true, i1 %cmp.i33.not.i
  %op.rdx64 = select i1 %op.rdx63, i1 true, i1 %cmp.i35.not.i
  %op.rdx65 = select i1 %op.rdx64, i1 true, i1 %cmp.i37.i
  br i1 %op.rdx65, label %if.then11, label %if.end21
...
for.body:                                         ; preds = %if.then37, %for.body
  ...
  br i1 %cmp.i149.not, label %for.end, label %for.body
...
while.body.i:                                     ; preds = %for.end, %while.body.i
  ...
  br i1 %cmp.i.not.i152, label %list_Delete.exit, label %while.body.i
...
if.end56:                                         ; preds = %if.else53, %list_Delete.exit
  ...
  br i1 %cmp.i.not5.i155, label %list_Delete.exit163, label %while.body.i156

while.body.i156:                                  ; preds = %if.end56, %while.body.i156
  %Current.06.i157 = phi ptr [ %Current.0.val.i158, %while.body.i156 ], [ %univars.0192, %if.end56 ]
  ...
  %total_size.i.i.i159 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %23, i64 0, i32 4
  %24 = load i32, ptr %total_size.i.i.i159, align 8
  %conv26.i.i.i160 = sext i32 %24 to i64
  %25 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i161 = add i64 %25, %conv26.i.i.i160
  store i64 %add27.i.i.i161, ptr @memory_FREEDBYTES, align 8
  %26 = load ptr, ptr %23, align 8
  store ptr %26, ptr %Current.06.i157, align 8
  %27 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i157, ptr %27, align 8
  %cmp.i.not.i162 = icmp eq ptr %Current.0.val.i158, null
  br i1 %cmp.i.not.i162, label %list_Delete.exit163, label %while.body.i156

list_Delete.exit163:                              ; preds = %while.body.i156, %if.end56
...
if.else84:                                        ; preds = %if.end78
  ...
  br i1 %tobool.not.i175, label %if.end85, label %if.then.i176

if.then.i176:                                     ; preds = %if.else84
  %attributes.i173 = getelementptr inbounds %struct.DEF_HELP, ptr %call.i166, i64 0, i32 6
  %sub.i177 = add i32 %38, -2
  store i32 %sub.i177, ptr %attributes.i173, align 4
  br label %if.end85
...
if.end87:                                         ; preds = %if.end85, %for.body62
  ...
  br i1 %cmp.i164.not, label %for.end90, label %for.body62

for.end90:                                        ; preds = %if.end87
  br i1 %cmp.i164.not199, label %list_Delete.exit190, label %while.body.i183

while.body.i183:                                  ; preds = %for.end90, %while.body.i183
  %Current.06.i184 = phi ptr [ %Current.0.val.i185, %while.body.i183 ], [ %termlist.1, %for.end90 ]
  %Current.0.val.i185 = load ptr, ptr %Current.06.i184, align 8
  %40 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i186 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %40, i64 0, i32 4
  %41 = load i32, ptr %total_size.i.i.i186, align 8
  %conv26.i.i.i187 = sext i32 %41 to i64
  %42 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i188 = add i64 %42, %conv26.i.i.i187
  store i64 %add27.i.i.i188, ptr @memory_FREEDBYTES, align 8
  %43 = load ptr, ptr %40, align 8
  store ptr %43, ptr %Current.06.i184, align 8
  %44 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i184, ptr %44, align 8
  %cmp.i.not.i189 = icmp eq ptr %Current.0.val.i185, null
  br i1 %cmp.i.not.i189, label %list_Delete.exit190, label %while.body.i183

list_Delete.exit190:                              ; preds = %while.body.i183, %list_Delete.exit163, %for.end90
  %defslist.0.lcssa217 = phi ptr [ %defslist.1, %for.end90 ], [ null, %list_Delete.exit163 ], [ %defslist.1, %while.body.i183 ]
...
if.end29:                                         ; preds = %land.lhs.true, %if.then18, %for.body13
  ...
  br i1 %13, label %for.body13, label %for.end
...
for.body39:                                       ; preds = %if.then32, %for.body39
  ...
  br i1 %cmp.i195.not, label %for.end51, label %for.body39
...
for.body63:                                       ; preds = %for.end51, %for.inc71
  %Clause.val7.i290 = phi i32 [ %Clause.val7.i, %for.inc71 ], [ %Clause.val7.i272, %for.end51 ]
  %Clause.val6.i288 = phi i32 [ %Clause.val6.i, %for.inc71 ], [ %Clause.val6.i270, %for.end51 ]
  %Clause.val.i286 = phi i32 [ %Clause.val.i, %for.inc71 ], [ %Clause.val.i269, %for.end51 ]
...
for.inc71:                                        ; preds = %for.body63, %if.then66
  ...
  br i1 %cmp, label %for.body63, label %for.end72
...
list_Delete.exit:                                 ; preds = %while.body.i, %if.else
  ...
  br i1 %cmp.i.not5.i216, label %list_Delete.exit224, label %while.body.i217

while.body.i217:                                  ; preds = %list_Delete.exit, %while.body.i217
  %Current.06.i218 = phi ptr [ %Current.0.val.i219, %while.body.i217 ], [ %.val179, %list_Delete.exit ]
  %Current.0.val.i219 = load ptr, ptr %Current.06.i218, align 8
  %43 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i220 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %43, i64 0, i32 4
  %44 = load i32, ptr %total_size.i.i.i220, align 8
  %conv26.i.i.i221 = sext i32 %44 to i64
  %45 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i222 = add i64 %45, %conv26.i.i.i221
  store i64 %add27.i.i.i222, ptr @memory_FREEDBYTES, align 8
  %46 = load ptr, ptr %43, align 8
  store ptr %46, ptr %Current.06.i218, align 8
  %47 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i218, ptr %47, align 8
  %cmp.i.not.i223 = icmp eq ptr %Current.0.val.i219, null
  br i1 %cmp.i.not.i223, label %list_Delete.exit224.loopexit, label %while.body.i217

list_Delete.exit224.loopexit:                     ; preds = %while.body.i217
...
list_Delete.exit224:                              ; preds = %list_Delete.exit224.loopexit, %list_Delete.exit
  ...
  br i1 %cmp.i.not5.i225, label %if.end88, label %while.body.i226

while.body.i226:                                  ; preds = %list_Delete.exit224, %while.body.i226
  %Current.06.i227 = phi ptr [ %Current.0.val.i228, %while.body.i226 ], [ %.val, %list_Delete.exit224 ]
  %Current.0.val.i228 = load ptr, ptr %Current.06.i227, align 8
  %50 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i229 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %50, i64 0, i32 4
  %51 = load i32, ptr %total_size.i.i.i229, align 8
  %conv26.i.i.i230 = sext i32 %51 to i64
  %52 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i231 = add i64 %52, %conv26.i.i.i230
  store i64 %add27.i.i.i231, ptr @memory_FREEDBYTES, align 8
  %53 = load ptr, ptr %50, align 8
  store ptr %53, ptr %Current.06.i227, align 8
  %54 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i227, ptr %54, align 8
  %cmp.i.not.i232 = icmp eq ptr %Current.0.val.i228, null
  br i1 %cmp.i.not.i232, label %if.end88, label %while.body.i226

if.end88:                                         ; preds = %while.body.i226, %list_Delete.exit224, %for.end72, %if.then83
  %defslist.1 = phi ptr [ %call.i214, %if.then83 ], [ %call.i214, %for.end72 ], [ %defslist.0279, %list_Delete.exit224 ], [ %defslist.0279, %while.body.i226 ]
  %cmp.i.not5.i234 = icmp eq ptr %compl.1, null
  br i1 %cmp.i.not5.i234, label %list_Delete.exit242, label %while.body.i235

while.body.i235:                                  ; preds = %if.end88, %while.body.i235
  %Current.06.i236 = phi ptr [ %Current.0.val.i237, %while.body.i235 ], [ %compl.1, %if.end88 ]
  %Current.0.val.i237 = load ptr, ptr %Current.06.i236, align 8
  %55 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i238 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %55, i64 0, i32 4
  %56 = load i32, ptr %total_size.i.i.i238, align 8
  %conv26.i.i.i239 = sext i32 %56 to i64
  %57 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i240 = add i64 %57, %conv26.i.i.i239
  store i64 %add27.i.i.i240, ptr @memory_FREEDBYTES, align 8
  %58 = load ptr, ptr %55, align 8
  store ptr %58, ptr %Current.06.i236, align 8
  %59 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i236, ptr %59, align 8
  %cmp.i.not.i241 = icmp eq ptr %Current.0.val.i237, null
  br i1 %cmp.i.not.i241, label %list_Delete.exit242, label %while.body.i235

list_Delete.exit242:                              ; preds = %while.body.i235, %if.end88
...
for.body104:                                      ; preds = %if.then98, %for.body104
  %scan.1282 = phi ptr [ %defslist.2, %if.then98 ], [ %scan.1.val175, %for.body104 ]
  ...
  %scan.1.val175 = load ptr, ptr %scan.1282, align 8
  %cmp.i249.not = icmp eq ptr %scan.1.val175, null
  br i1 %cmp.i249.not, label %if.end111, label %for.body104
...
for.body116:                                      ; preds = %for.body116.lr.ph, %for.body116
  %scan.2284 = phi ptr [ %defslist.2, %for.body116.lr.ph ], [ %scan.2.val174, %for.body116 ]
  ...
  %scan.2.val174 = load ptr, ptr %scan.2284, align 8
  %cmp.i251.not = icmp eq ptr %scan.2.val174, null
  br i1 %cmp.i251.not, label %for.end122, label %for.body116
...
for.end122.thread:                                ; preds = %entry
  %Search.val186305 = load ptr, ptr %Search, align 8
  br label %list_Nconc.exit
...
list_Nconc.exit:                                  ; preds = %for.end122.thread, %for.end122, %for.end.i
  %retval.0.i = phi ptr [ %Search.val186, %for.end.i ], [ %defslist.2.lcssa.mux, %for.end122 ], [ %Search.val186305, %for.end122.thread ]
...
for.body:                                         ; preds = %if.then, %for.body
  ...
  br i1 %cmp.i79.not, label %for.end, label %for.body
...
if.end42:                                         ; preds = %if.end31
  ...
  br i1 %31, label %if.end50, label %if.then45
...
list_Delete.exit:                                 ; preds = %while.body.i, %if.end
  ...
  br i1 %cmp.i.not5.i90, label %while.cond.backedge, label %while.body.i91

while.cond.backedge:                              ; preds = %while.body.i91, %list_Delete.exit, %if.then22, %if.then28
  %oldtarget.0.be = phi ptr [ %call26, %if.then28 ], [ %call26, %if.then22 ], [ %call13, %list_Delete.exit ], [ %call13, %while.body.i91 ]
  br label %while.cond

while.body.i91:                                   ; preds = %list_Delete.exit, %while.body.i91
  %Current.06.i92 = phi ptr [ %Current.0.val.i93, %while.body.i91 ], [ %9, %list_Delete.exit ]
  ...
  %total_size.i.i.i94 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %10, i64 0, i32 4
  %11 = load i32, ptr %total_size.i.i.i94, align 8
  %conv26.i.i.i95 = sext i32 %11 to i64
  %12 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i96 = add i64 %12, %conv26.i.i.i95
  store i64 %add27.i.i.i96, ptr @memory_FREEDBYTES, align 8
  %13 = load ptr, ptr %10, align 8
  store ptr %13, ptr %Current.06.i92, align 8
  %14 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i92, ptr %14, align 8
  %cmp.i.not.i97 = icmp eq ptr %Current.0.val.i93, null
  br i1 %cmp.i.not.i97, label %while.cond.backedge, label %while.body.i91
...
if.else:                                          ; preds = %if.then
  ...
  br i1 %cmp.i.not5.i99, label %list_Delete.exit107, label %while.body.i100

while.body.i100:                                  ; preds = %if.else, %while.body.i100
  %Current.06.i101 = phi ptr [ %Current.0.val.i102, %while.body.i100 ], [ %21, %if.else ]
  ...
  %total_size.i.i.i103 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %22, i64 0, i32 4
  %23 = load i32, ptr %total_size.i.i.i103, align 8
  %conv26.i.i.i104 = sext i32 %23 to i64
  %24 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i105 = add i64 %24, %conv26.i.i.i104
  store i64 %add27.i.i.i105, ptr @memory_FREEDBYTES, align 8
  %25 = load ptr, ptr %22, align 8
  store ptr %25, ptr %Current.06.i101, align 8
  %26 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i101, ptr %26, align 8
  %cmp.i.not.i106 = icmp eq ptr %Current.0.val.i102, null
  br i1 %cmp.i.not.i106, label %list_Delete.exit107, label %while.body.i100

list_Delete.exit107:                              ; preds = %while.body.i100, %if.else
  %27 = load ptr, ptr %varsfortoplevel, align 8
  %cmp.i.not5.i108 = icmp eq ptr %27, null
  br i1 %cmp.i.not5.i108, label %list_Delete.exit116, label %while.body.i109

while.body.i109:                                  ; preds = %list_Delete.exit107, %while.body.i109
  %Current.06.i110 = phi ptr [ %Current.0.val.i111, %while.body.i109 ], [ %27, %list_Delete.exit107 ]
  %Current.0.val.i111 = load ptr, ptr %Current.06.i110, align 8
  %28 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i112 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %28, i64 0, i32 4
  %29 = load i32, ptr %total_size.i.i.i112, align 8
  %conv26.i.i.i113 = sext i32 %29 to i64
  %30 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i114 = add i64 %30, %conv26.i.i.i113
  store i64 %add27.i.i.i114, ptr @memory_FREEDBYTES, align 8
  %31 = load ptr, ptr %28, align 8
  store ptr %31, ptr %Current.06.i110, align 8
  %32 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i110, ptr %32, align 8
  %cmp.i.not.i115 = icmp eq ptr %Current.0.val.i111, null
  br i1 %cmp.i.not.i115, label %list_Delete.exit116, label %while.body.i109

list_Delete.exit116:                              ; preds = %while.body.i109, %list_Delete.exit107
...
while.cond.loopexit:                              ; preds = %for.inc
  ...
  br i1 %tobool.not, label %for.cond.preheaderthread-pre-split, label %while.end
...
while.end:                                        ; preds = %while.cond.loopexit, %for.cond.preheaderthread-pre-split, %entry
  %.us-phi = phi ptr [ %Term, %entry ], [ %oldterm.2, %for.cond.preheaderthread-pre-split ], [ %oldterm.2, %while.cond.loopexit ]
...
for.body:                                         ; preds = %entry, %for.inc
  %result.094 = phi ptr [ %call.i.i, %entry ], [ %result.1, %for.inc ]
  %l.093 = phi ptr [ %call.i.i, %entry ], [ %l.0.val83, %for.inc ]
  %1 = getelementptr i8, ptr %l.093, i64 8
...
if.then:                                          ; preds = %for.body
  ...
  %cmp.i.not.i = icmp eq ptr %result.094, null
  br i1 %cmp.i.not.i, label %list_Nconc.exit, label %if.end.i
...
for.cond.i:                                       ; preds = %if.end.i, %for.cond.i
  %List1.addr.0.i = phi ptr [ %List1.addr.0.val17.i, %for.cond.i ], [ %result.094, %if.end.i ]
  %List1.addr.0.val17.i = load ptr, ptr %List1.addr.0.i, align 8
  %cmp.i20.not.i = icmp eq ptr %List1.addr.0.val17.i, null
  br i1 %cmp.i20.not.i, label %for.end.i, label %for.cond.i
...
list_Nconc.exit:                                  ; preds = %if.then, %if.end.i, %for.end.i
  %retval.0.i = phi ptr [ %result.094, %for.end.i ], [ %call10, %if.then ], [ %result.094, %if.end.i ]
...
for.inc:                                          ; preds = %for.body, %if.end
  %result.1 = phi ptr [ %retval.0.i, %if.end ], [ %result.094, %for.body ]
  %l.0.val83 = load ptr, ptr %l.093, align 8
...
if.end26:                                         ; preds = %if.then20
  ...
  %cmp.i88.not95 = icmp eq ptr %L.val.i, null
  br i1 %cmp.i88.not95, label %for.end47, label %for.body31.lr.ph

for.body31.lr.ph:                                 ; preds = %if.then20, %if.end26
  %result.2103 = phi ptr [ %L.val.i, %if.end26 ], [ %call17, %if.then20 ]
  %8 = getelementptr i8, ptr %Def, i64 40
  %9 = getelementptr i8, ptr %Def, i64 24
  br label %for.body31

for.body31:                                       ; preds = %for.body31.lr.ph, %if.end37
  %l.196 = phi ptr [ %result.2103, %for.body31.lr.ph ], [ %l.1.val82, %if.end37 ]
  %10 = getelementptr i8, ptr %l.196, i64 8
...
if.end37:                                         ; preds = %if.then35, %for.body31
  ...
  %l.1.val82 = load ptr, ptr %l.196, align 8
  %cmp.i88.not = icmp eq ptr %l.1.val82, null
  br i1 %cmp.i88.not, label %for.end47, label %for.body31

for.end47:                                        ; preds = %if.end37, %for.end, %if.end26
  %result.299 = phi ptr [ null, %if.end26 ], [ null, %for.end ], [ %result.2103, %if.end37 ]
  ret ptr %result.299
}
...
for.cond.preheader:                               ; preds = %entry, %list_Delete.exit.loopexit
  %newclauses.089 = phi ptr [ %call.i.i, %entry ], [ %nextlist.1, %list_Delete.exit.loopexit ]
  %result.088 = phi ptr [ null, %entry ], [ %result.2, %list_Delete.exit.loopexit ]
  br label %for.body

for.body:                                         ; preds = %for.cond.preheader, %if.end35
  %nextlist.087 = phi ptr [ null, %for.cond.preheader ], [ %nextlist.1, %if.end35 ]
  %l.086 = phi ptr [ %newclauses.089, %for.cond.preheader ], [ %l.0.val60, %if.end35 ]
  %result.185 = phi ptr [ %result.088, %for.cond.preheader ], [ %result.2, %if.end35 ]
...
list_Nconc.exit:                                  ; preds = %for.body17, %if.end.i, %for.end.i
  ...
  br i1 %cmp.i66.not, label %for.end, label %for.body17
...
if.end28:                                         ; preds = %if.then27, %if.else, %if.then
  %cmp.i.not.i70 = icmp eq ptr %nextlist.087, null
  br i1 %cmp.i.not.i70, label %if.end35, label %for.cond.i73

for.cond.i73:                                     ; preds = %if.end28, %for.cond.i73
  %List1.addr.0.i74 = phi ptr [ %List1.addr.0.val17.i75, %for.cond.i73 ], [ %nextlist.087, %if.end28 ]
  %List1.addr.0.val17.i75 = load ptr, ptr %List1.addr.0.i74, align 8
  %cmp.i20.not.i76 = icmp eq ptr %List1.addr.0.val17.i75, null
  br i1 %cmp.i20.not.i76, label %for.end.i77, label %for.cond.i73

for.end.i77:                                      ; preds = %for.cond.i73
  store ptr %retval.0.i, ptr %List1.addr.0.i74, align 8
  br label %if.end35
...
if.end35:                                         ; preds = %if.end28, %for.end.i77, %if.else30, %if.then32
  ...
  br i1 %cmp.i64.not, label %while.body.i, label %for.body

while.body.i:                                     ; preds = %if.end35, %while.body.i
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i ], [ %newclauses.089, %if.end35 ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  ...
  br i1 %cmp.i.not.i80, label %list_Delete.exit.loopexit, label %while.body.i

list_Delete.exit.loopexit:                        ; preds = %while.body.i
  %cmp.i.not = icmp eq ptr %nextlist.1, null
  br i1 %cmp.i.not, label %while.end, label %for.cond.preheader

while.end:                                        ; preds = %list_Delete.exit.loopexit
  ret ptr %result.2
}
...
if.end29:                                         ; preds = %if.then26, %if.end20
  ...
  br i1 %brmerge, label %list_Nconc.exit66, label %for.cond.i60

for.cond.i60:                                     ; preds = %if.end29, %for.cond.i60
  %List1.addr.0.i61 = phi ptr [ %List1.addr.0.val17.i62, %for.cond.i60 ], [ %Clauselist.addr.0, %if.end29 ]
  %List1.addr.0.val17.i62 = load ptr, ptr %List1.addr.0.i61, align 8
  %cmp.i20.not.i63 = icmp eq ptr %List1.addr.0.val17.i62, null
  br i1 %cmp.i20.not.i63, label %for.end.i64, label %for.cond.i60

for.end.i64:                                      ; preds = %for.cond.i60
  store ptr %allnew.0.lcssa, ptr %List1.addr.0.i61, align 8
...
for.body36:                                       ; preds = %if.then30, %for.body36
  %l.179 = phi ptr [ %newterms.0.lcssa, %if.then30 ], [ %l.1.val69, %for.body36 ]
  %13 = load ptr, ptr @stdout, align 8
  %fputc = tail call i32 @fputc(i32 10, ptr %13)
  %14 = getelementptr i8, ptr %l.179, i64 8
  ...
  %l.1.val69 = load ptr, ptr %l.179, align 8
  %cmp.i74.not = icmp eq ptr %l.1.val69, null
  br i1 %cmp.i74.not, label %if.end44, label %for.body36
...
for.body16:                                       ; preds = %for.cond12.preheader, %list_Nconc.exit102
  ...
  br i1 %cmp.i.not.i93, label %list_Nconc.exit102, label %if.end.i94

if.end.i94:                                       ; preds = %for.body16
  %cmp.i18.not.i95 = icmp eq ptr %call23, null
  br i1 %cmp.i18.not.i95, label %list_Nconc.exit102, label %for.cond.i96

for.cond.i96:                                     ; preds = %if.end.i94, %for.cond.i96
  %List1.addr.0.i97 = phi ptr [ %List1.addr.0.val17.i98, %for.cond.i96 ], [ %deflist.1123, %if.end.i94 ]
  %List1.addr.0.val17.i98 = load ptr, ptr %List1.addr.0.i97, align 8
  %cmp.i20.not.i99 = icmp eq ptr %List1.addr.0.val17.i98, null
  br i1 %cmp.i20.not.i99, label %for.end.i100, label %for.cond.i96

for.end.i100:                                     ; preds = %for.cond.i96
  store ptr %call23, ptr %List1.addr.0.i97, align 8
  br label %list_Nconc.exit102

list_Nconc.exit102:                               ; preds = %for.body16, %if.end.i94, %for.end.i100
  %retval.0.i101 = phi ptr [ %deflist.1123, %for.end.i100 ], [ %call23, %for.body16 ], [ %deflist.1123, %if.end.i94 ]
  %l.1.val87 = load ptr, ptr %l.1124, align 8
  %cmp.i91.not = icmp eq ptr %l.1.val87, null
  br i1 %cmp.i91.not, label %for.cond28.preheader, label %for.body16
...
for.body32:                                       ; preds = %for.body32.lr.ph, %for.body32
  ...
  br i1 %cmp.i103.not, label %for.end38, label %for.body32

for.end38:                                        ; preds = %for.body32
  %Search.val90 = load ptr, ptr %Search, align 8
  %cmp.i.not.i105 = icmp eq ptr %Search.val90, null
  br i1 %cmp.i.not.i105, label %list_Nconc.exit114, label %if.end.i106

for.end38.thread:                                 ; preds = %for.cond28.preheader
  %Search.val90131 = load ptr, ptr %Search, align 8
  br label %list_Nconc.exit114.thread

if.end.i106:                                      ; preds = %for.end38
  br i1 %cmp.i103.not126, label %list_Nconc.exit114.thread, label %for.cond.i108

for.cond.i108:                                    ; preds = %if.end.i106, %for.cond.i108
  %List1.addr.0.i109 = phi ptr [ %List1.addr.0.val17.i110, %for.cond.i108 ], [ %Search.val90, %if.end.i106 ]
  %List1.addr.0.val17.i110 = load ptr, ptr %List1.addr.0.i109, align 8
  %cmp.i20.not.i111 = icmp eq ptr %List1.addr.0.val17.i110, null
  br i1 %cmp.i20.not.i111, label %for.end.i112, label %for.cond.i108

for.end.i112:                                     ; preds = %for.cond.i108
  store ptr %deflist.1.lcssa, ptr %List1.addr.0.i109, align 8
  br label %list_Nconc.exit114

list_Nconc.exit114.thread:                        ; preds = %for.end38.thread, %if.end.i106
  %retval.0.i113.ph = phi ptr [ %Search.val90, %if.end.i106 ], [ %Search.val90131, %for.end38.thread ]
...
for.body52:                                       ; preds = %if.then45, %for.body52
  ...
  br i1 %cmp.i117.not, label %if.end58, label %for.body52
...
if.end31:                                         ; preds = %if.then8, %if.then20, %if.then14, %for.body
  ...
  %cmp.i.not = icmp eq ptr %l.0, null
  br i1 %cmp.i.not, label %if.end33, label %for.body
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end27
  ...
  %4 = getelementptr i8, ptr %l.077, i64 8
  %l.0.val = load ptr, ptr %4, align 8
...
if.then13:                                        ; preds = %if.then7
  %Def.val = load ptr, ptr %Def, align 8
  %5 = getelementptr i8, ptr %l.0.val, i64 8
  %call5.val59 = load ptr, ptr %5, align 8
...
for.end:                                          ; preds = %if.end27, %if.then
  %9 = getelementptr i8, ptr %Def, i64 8
  %Def.val57 = load ptr, ptr %9, align 8
  %call29.val = load i32, ptr %Def.val57, align 8
  %sub.i.i66 = sub nsw i32 0, %call29.val
  %shr.i.i67 = ashr i32 %sub.i.i66, %.pre
  %10 = load ptr, ptr @symbol_SIGNATURE, align 8
  %idxprom.i.i68 = sext i32 %shr.i.i67 to i64
  %arrayidx.i.i69 = getelementptr inbounds ptr, ptr %10, i64 %idxprom.i.i68
  %11 = load ptr, ptr %arrayidx.i.i69, align 8
  %props.i70 = getelementptr inbounds %struct.signature, ptr %11, i64 0, i32 4
  %12 = load i32, ptr %props.i70, align 4
  %and.i71 = and i32 %12, 128
  %tobool.not.i72 = icmp eq i32 %and.i71, 0
  br i1 %tobool.not.i72, label %symbol_RemoveProperty.exit75, label %if.then.i73

if.then.i73:                                      ; preds = %for.end
  %sub.i74 = add i32 %12, -128
  store i32 %sub.i74, ptr %props.i70, align 4
  br label %symbol_RemoveProperty.exit75

symbol_RemoveProperty.exit75:                     ; preds = %for.end, %if.then.i73
...
if.end26:                                         ; preds = %if.then7, %symbol_RemoveProperty.exit, %if.then19, %for.body
  ...
  %cmp.i.not = icmp eq ptr %l.0, null
  br i1 %cmp.i.not, label %if.end28, label %for.body
...
if.end:                                           ; preds = %entry, %if.end
  ...
  %cmp.i.not = icmp eq ptr %l.0, null
  br i1 %cmp.i.not, label %for.end.loopexit, label %if.end
...
for.inc:                                          ; preds = %for.body, %if.then21
  ...
  br i1 %cmp.i270.not, label %for.end, label %for.body
...
while.body.i:                                     ; preds = %if.then32, %while.body.i
  ...
  %cmp.i.not.i = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i, label %if.end36, label %while.body.i
...
for.inc79:                                        ; preds = %for.body70, %if.then74
  ...
  br i1 %cmp.i276.not, label %for.end81, label %for.body70
...
entry:
  ...
  %cmp221.not = icmp eq i32 %0, 0
  br i1 %cmp221.not, label %while.end, label %for.cond.preheader.lr.ph

for.cond.preheader.lr.ph:                         ; preds = %entry
  %cmp.i214.not = icmp eq ptr %Defs, null
  %arrayidx.i184 = getelementptr inbounds i32, ptr %Flags, i64 37
  br i1 %cmp.i214.not, label %while.end, label %for.cond.preheader.lr.ph.split.us

for.cond.preheader.lr.ph.split.us:                ; preds = %for.cond.preheader.lr.ph
  %cmp.i156208.not = icmp eq ptr %Terms, null
  br i1 %cmp.i156208.not, label %for.body.us223, label %for.body.us.us.us

for.body.us.us.us:                                ; preds = %for.cond.preheader.lr.ph.split.us, %for.body.us.us.us.backedge
  %Applics.1217.us.us.us = phi i32 [ %Applics.3.lcssa.us.us.us237, %for.body.us.us.us.backedge ], [ %0, %for.cond.preheader.lr.ph.split.us ]
  %Apply.1216.us.us.us = phi i32 [ %Apply.1216.us.us.us.be, %for.body.us.us.us.backedge ], [ 0, %for.cond.preheader.lr.ph.split.us ]
  %Scan1.0215.us.us.us = phi ptr [ %Scan1.0215.us.us.us.be, %for.body.us.us.us.backedge ], [ %Defs, %for.cond.preheader.lr.ph.split.us ]
  %1 = getelementptr i8, ptr %Scan1.0215.us.us.us, i64 8
...
for.body16.us.us.us:                              ; preds = %list_Delete.exit.us.us.us, %for.body.us.us.us
  %Applics.2211.us.us.us = phi i32 [ %Applics.1217.us.us.us, %for.body.us.us.us ], [ %Applics.3.lcssa.us.us.us237, %list_Delete.exit.us.us.us ]
  %Apply.2210.us.us.us = phi i32 [ %Apply.1216.us.us.us, %for.body.us.us.us ], [ %Apply.3.lcssa.us.us.us236, %list_Delete.exit.us.us.us ]
  %Scan2.0209.us.us.us = phi ptr [ %Terms, %for.body.us.us.us ], [ %Scan2.0.val150.us.us.us, %list_Delete.exit.us.us.us ]
  %3 = getelementptr i8, ptr %Scan2.0209.us.us.us, i64 8
...
for.body27.us.us.us.preheader:                    ; preds = %for.body16.us.us.us
  ...
  %.pre233 = load i32, ptr @cont_STACKPOINTER, align 4
  br label %for.body27.us.us.us

for.end.us.us.us:                                 ; preds = %cont_BackTrack.exit199.us.us.us
  br i1 %cmp.i158203.us.us.us.not, label %list_Delete.exit.us.us.us, label %while.body.i200.us.us.us

while.body.i200.us.us.us:                         ; preds = %for.end.us.us.us, %while.body.i200.us.us.us
  %Current.06.i.us.us.us = phi ptr [ %Current.0.val.i.us.us.us, %while.body.i200.us.us.us ], [ %call20.us.us.us, %for.end.us.us.us ]
  ...
  %cmp.i.not.i201.us.us.us = icmp eq ptr %Current.0.val.i.us.us.us, null
  br i1 %cmp.i.not.i201.us.us.us, label %list_Delete.exit.us.us.us, label %while.body.i200.us.us.us

list_Delete.exit.us.us.us:                        ; preds = %while.body.i200.us.us.us, %for.body16.us.us.us, %for.end.us.us.us
  %Applics.3.lcssa.us.us.us237 = phi i32 [ %Applics.6.us.us.us, %for.end.us.us.us ], [ %Applics.2211.us.us.us, %for.body16.us.us.us ], [ %Applics.6.us.us.us, %while.body.i200.us.us.us ]
  %Apply.3.lcssa.us.us.us236 = phi i32 [ %Apply.6.us.us.us, %for.end.us.us.us ], [ %Apply.2210.us.us.us, %for.body16.us.us.us ], [ %Apply.6.us.us.us, %while.body.i200.us.us.us ]
  %Scan2.0.val150.us.us.us = load ptr, ptr %Scan2.0209.us.us.us, align 8
  %cmp.i156.us.us.us = icmp ne ptr %Scan2.0.val150.us.us.us, null
  %cmp14.us.us.us = icmp ne i32 %Applics.3.lcssa.us.us.us237, 0
  %9 = select i1 %cmp.i156.us.us.us, i1 %cmp14.us.us.us, i1 false
  br i1 %9, label %for.body16.us.us.us, label %for.cond10.for.end91_crit_edge.us.us.us

for.body27.us.us.us:                              ; preds = %for.body27.us.us.us.preheader, %cont_BackTrack.exit199.us.us.us
  %10 = phi i32 [ %66, %cont_BackTrack.exit199.us.us.us ], [ %.pre233, %for.body27.us.us.us.preheader ]
  %11 = phi i32 [ %67, %cont_BackTrack.exit199.us.us.us ], [ %.pre, %for.body27.us.us.us.preheader ]
  %Applics.3206.us.us.us = phi i32 [ %Applics.6.us.us.us, %cont_BackTrack.exit199.us.us.us ], [ %Applics.2211.us.us.us, %for.body27.us.us.us.preheader ]
  %Apply.3205.us.us.us = phi i32 [ %Apply.6.us.us.us, %cont_BackTrack.exit199.us.us.us ], [ %Apply.2210.us.us.us, %for.body27.us.us.us.preheader ]
...
while.body.i.us.us.us:                            ; preds = %while.body.i.us.us.us.prol.loopexit, %while.body.i.us.us.us
  ...
  %cmp.i162.us.us.us.1 = icmp ugt i32 %dec.i.i.i.us.us.us, 1
  br i1 %cmp.i162.us.us.us.1, label %while.body.i.us.us.us, label %while.end.i.us.us.us
...
if.then.i.us.us.us:                               ; preds = %while.end.i.us.us.us
  ...
  %idxprom.i.i160.us.us.us = sext i32 %dec.i.i.us.us.us to i64
  %arrayidx.i.i161.us.us.us = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i160.us.us.us
  %26 = load i32, ptr %arrayidx.i.i161.us.us.us, align 4
...
if.then64.us.us.us:                               ; preds = %if.else.us.us.us
  ...
  br i1 %cmp2.i168.us.us.us, label %while.body.i175.us.us.us.preheader, label %while.end.i169.us.us.us

while.body.i175.us.us.us.preheader:               ; preds = %if.then64.us.us.us
  %xtraiter241 = and i32 %.pr.i167.us.us.us, 1
  %lcmp.mod242.not = icmp eq i32 %xtraiter241, 0
  br i1 %lcmp.mod242.not, label %while.body.i175.us.us.us.prol.loopexit, label %while.body.i175.us.us.us.prol

while.body.i175.us.us.us.prol:                    ; preds = %while.body.i175.us.us.us.preheader
  %31 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %31, ptr @cont_CURRENTBINDING, align 8
  %32 = getelementptr i8, ptr %31, i64 24
  %call.val.i.i.i176.us.us.us.prol = load ptr, ptr %32, align 8
  store ptr %call.val.i.i.i176.us.us.us.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i177.us.us.us.prol = getelementptr inbounds %struct.binding, ptr %31, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i177.us.us.us.prol, i8 0, i64 20, i1 false)
  %33 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i178.us.us.us.prol = getelementptr inbounds %struct.binding, ptr %33, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i178.us.us.us.prol, align 8
  %dec.i.i.i179.us.us.us.prol = add nsw i32 %.pr.i167.us.us.us, -1
  store i32 %dec.i.i.i179.us.us.us.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i175.us.us.us.prol.loopexit

while.body.i175.us.us.us.prol.loopexit:           ; preds = %while.body.i175.us.us.us.prol, %while.body.i175.us.us.us.preheader
  %.unr243 = phi i32 [ %.pr.i167.us.us.us, %while.body.i175.us.us.us.preheader ], [ %dec.i.i.i179.us.us.us.prol, %while.body.i175.us.us.us.prol ]
  %34 = icmp eq i32 %.pr.i167.us.us.us, 1
  br i1 %34, label %while.end.i169.us.us.us, label %while.body.i175.us.us.us

while.body.i175.us.us.us:                         ; preds = %while.body.i175.us.us.us.prol.loopexit, %while.body.i175.us.us.us
  %35 = phi i32 [ %dec.i.i.i179.us.us.us.1, %while.body.i175.us.us.us ], [ %.unr243, %while.body.i175.us.us.us.prol.loopexit ]
  %36 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %36, ptr @cont_CURRENTBINDING, align 8
  %37 = getelementptr i8, ptr %36, i64 24
  %call.val.i.i.i176.us.us.us = load ptr, ptr %37, align 8
  store ptr %call.val.i.i.i176.us.us.us, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i177.us.us.us = getelementptr inbounds %struct.binding, ptr %36, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i177.us.us.us, i8 0, i64 20, i1 false)
  %38 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i178.us.us.us = getelementptr inbounds %struct.binding, ptr %38, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i178.us.us.us, align 8
  %dec.i.i.i179.us.us.us = add nsw i32 %35, -1
  store i32 %dec.i.i.i179.us.us.us, ptr @cont_BINDINGS, align 4
  %39 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %39, ptr @cont_CURRENTBINDING, align 8
  %40 = getelementptr i8, ptr %39, i64 24
  %call.val.i.i.i176.us.us.us.1 = load ptr, ptr %40, align 8
  store ptr %call.val.i.i.i176.us.us.us.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i177.us.us.us.1 = getelementptr inbounds %struct.binding, ptr %39, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i177.us.us.us.1, i8 0, i64 20, i1 false)
  %41 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i178.us.us.us.1 = getelementptr inbounds %struct.binding, ptr %41, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i178.us.us.us.1, align 8
  %dec.i.i.i179.us.us.us.1 = add nsw i32 %35, -2
  store i32 %dec.i.i.i179.us.us.us.1, ptr @cont_BINDINGS, align 4
  %cmp.i180.us.us.us.1 = icmp ugt i32 %dec.i.i.i179.us.us.us, 1
  br i1 %cmp.i180.us.us.us.1, label %while.body.i175.us.us.us, label %while.end.i169.us.us.us

while.end.i169.us.us.us:                          ; preds = %while.body.i175.us.us.us.prol.loopexit, %while.body.i175.us.us.us, %if.then64.us.us.us
  %42 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i170.us.us.us = icmp eq i32 %42, 0
  br i1 %cmp.i.not.i170.us.us.us, label %cont_BackTrack.exit181.us.us.us, label %if.then.i171.us.us.us

if.then.i171.us.us.us:                            ; preds = %while.end.i169.us.us.us
  %dec.i.i172.us.us.us = add nsw i32 %42, -1
  store i32 %dec.i.i172.us.us.us, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i173.us.us.us = sext i32 %dec.i.i172.us.us.us to i64
  %arrayidx.i.i174.us.us.us = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i173.us.us.us
  %43 = load i32, ptr %arrayidx.i.i174.us.us.us, align 4
  store i32 %43, ptr @cont_BINDINGS, align 4
  br label %cont_BackTrack.exit181.us.us.us

cont_BackTrack.exit181.us.us.us:                  ; preds = %if.then.i171.us.us.us, %while.end.i169.us.us.us
...
if.end86.us.us.us:                                ; preds = %if.end85.us.us.us, %for.body27.us.us.us
  ...
  br i1 %cmp2.i186.us.us.us, label %while.body.i193.us.us.us.preheader, label %while.end.i187.us.us.us

while.body.i193.us.us.us.preheader:               ; preds = %if.end86.us.us.us
  %xtraiter244 = and i32 %.pr.i185.us.us.us, 1
  %lcmp.mod245.not = icmp eq i32 %xtraiter244, 0
  br i1 %lcmp.mod245.not, label %while.body.i193.us.us.us.prol.loopexit, label %while.body.i193.us.us.us.prol

while.body.i193.us.us.us.prol:                    ; preds = %while.body.i193.us.us.us.preheader
  %52 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %52, ptr @cont_CURRENTBINDING, align 8
  %53 = getelementptr i8, ptr %52, i64 24
  %call.val.i.i.i194.us.us.us.prol = load ptr, ptr %53, align 8
  store ptr %call.val.i.i.i194.us.us.us.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i195.us.us.us.prol = getelementptr inbounds %struct.binding, ptr %52, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i195.us.us.us.prol, i8 0, i64 20, i1 false)
  %54 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i196.us.us.us.prol = getelementptr inbounds %struct.binding, ptr %54, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i196.us.us.us.prol, align 8
  %dec.i.i.i197.us.us.us.prol = add nsw i32 %.pr.i185.us.us.us, -1
  store i32 %dec.i.i.i197.us.us.us.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i193.us.us.us.prol.loopexit

while.body.i193.us.us.us.prol.loopexit:           ; preds = %while.body.i193.us.us.us.prol, %while.body.i193.us.us.us.preheader
  %.unr246 = phi i32 [ %.pr.i185.us.us.us, %while.body.i193.us.us.us.preheader ], [ %dec.i.i.i197.us.us.us.prol, %while.body.i193.us.us.us.prol ]
  %55 = icmp eq i32 %.pr.i185.us.us.us, 1
  br i1 %55, label %while.end.i187.us.us.us, label %while.body.i193.us.us.us

while.body.i193.us.us.us:                         ; preds = %while.body.i193.us.us.us.prol.loopexit, %while.body.i193.us.us.us
  %56 = phi i32 [ %dec.i.i.i197.us.us.us.1, %while.body.i193.us.us.us ], [ %.unr246, %while.body.i193.us.us.us.prol.loopexit ]
  %57 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %57, ptr @cont_CURRENTBINDING, align 8
  %58 = getelementptr i8, ptr %57, i64 24
  %call.val.i.i.i194.us.us.us = load ptr, ptr %58, align 8
  store ptr %call.val.i.i.i194.us.us.us, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i195.us.us.us = getelementptr inbounds %struct.binding, ptr %57, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i195.us.us.us, i8 0, i64 20, i1 false)
  %59 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i196.us.us.us = getelementptr inbounds %struct.binding, ptr %59, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i196.us.us.us, align 8
  %dec.i.i.i197.us.us.us = add nsw i32 %56, -1
  store i32 %dec.i.i.i197.us.us.us, ptr @cont_BINDINGS, align 4
  %60 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %60, ptr @cont_CURRENTBINDING, align 8
  %61 = getelementptr i8, ptr %60, i64 24
  %call.val.i.i.i194.us.us.us.1 = load ptr, ptr %61, align 8
  store ptr %call.val.i.i.i194.us.us.us.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i195.us.us.us.1 = getelementptr inbounds %struct.binding, ptr %60, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i195.us.us.us.1, i8 0, i64 20, i1 false)
  %62 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i196.us.us.us.1 = getelementptr inbounds %struct.binding, ptr %62, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i196.us.us.us.1, align 8
  %dec.i.i.i197.us.us.us.1 = add nsw i32 %56, -2
  store i32 %dec.i.i.i197.us.us.us.1, ptr @cont_BINDINGS, align 4
  %cmp.i198.us.us.us.1 = icmp ugt i32 %dec.i.i.i197.us.us.us, 1
  br i1 %cmp.i198.us.us.us.1, label %while.body.i193.us.us.us, label %while.end.i187.us.us.us

while.end.i187.us.us.us:                          ; preds = %while.body.i193.us.us.us.prol.loopexit, %while.body.i193.us.us.us, %if.end86.us.us.us
  %63 = phi i32 [ %.pr.i185.us.us.us, %if.end86.us.us.us ], [ 0, %while.body.i193.us.us.us ], [ 0, %while.body.i193.us.us.us.prol.loopexit ]
  %64 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i188.us.us.us = icmp eq i32 %64, 0
  br i1 %cmp.i.not.i188.us.us.us, label %cont_BackTrack.exit199.us.us.us, label %if.then.i189.us.us.us

if.then.i189.us.us.us:                            ; preds = %while.end.i187.us.us.us
  %dec.i.i190.us.us.us = add nsw i32 %64, -1
  store i32 %dec.i.i190.us.us.us, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i191.us.us.us = sext i32 %dec.i.i190.us.us.us to i64
  %arrayidx.i.i192.us.us.us = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i191.us.us.us
  %65 = load i32, ptr %arrayidx.i.i192.us.us.us, align 4
  store i32 %65, ptr @cont_BINDINGS, align 4
  br label %cont_BackTrack.exit199.us.us.us

cont_BackTrack.exit199.us.us.us:                  ; preds = %if.then.i189.us.us.us, %while.end.i187.us.us.us
  %66 = phi i32 [ %dec.i.i190.us.us.us, %if.then.i189.us.us.us ], [ 0, %while.end.i187.us.us.us ]
  %67 = phi i32 [ %65, %if.then.i189.us.us.us ], [ %63, %while.end.i187.us.us.us ]
  ...
  br i1 %68, label %for.body27.us.us.us, label %for.end.us.us.us
...
for.cond10.for.end91_crit_edge.us.us.us:          ; preds = %list_Delete.exit.us.us.us
  ...
  %Scan1.0.val149.us.us.us = load ptr, ptr %Scan1.0215.us.us.us, align 8
...
for.body.us.us.us.backedge:                       ; preds = %for.cond10.for.end91_crit_edge.us.us.us, %for.cond.while.cond.loopexit_crit_edge.split.us.us.us
  %Apply.1216.us.us.us.be = phi i32 [ %Apply.3.lcssa.us.us.us236, %for.cond10.for.end91_crit_edge.us.us.us ], [ 0, %for.cond.while.cond.loopexit_crit_edge.split.us.us.us ]
  %Scan1.0215.us.us.us.be = phi ptr [ %Scan1.0.val149.us.us.us, %for.cond10.for.end91_crit_edge.us.us.us ], [ %Defs, %for.cond.while.cond.loopexit_crit_edge.split.us.us.us ]
...
for.cond.while.cond.loopexit_crit_edge.split.us.us.us: ; preds = %for.cond10.for.end91_crit_edge.us.us.us
  %tobool.us.us = icmp ne i32 %Apply.3.lcssa.us.us.us236, 0
  %70 = select i1 %tobool.us.us, i1 %cmp14.us.us.us, i1 false
  br i1 %70, label %for.body.us.us.us.backedge, label %while.end

for.body.us223:                                   ; preds = %for.cond.preheader.lr.ph.split.us, %for.body.us223
  %Scan1.0215.us224 = phi ptr [ %Scan1.0.val149.us228, %for.body.us223 ], [ %Defs, %for.cond.preheader.lr.ph.split.us ]
  %71 = getelementptr i8, ptr %Scan1.0215.us224, i64 8
  %Scan1.0.val148.us225 = load ptr, ptr %71, align 8
  %72 = getelementptr i8, ptr %Scan1.0.val148.us225, i64 8
  %call7.val.us226 = load ptr, ptr %72, align 8
  %call9.us227 = tail call ptr @term_Copy(ptr noundef %call7.val.us226) #7
  tail call void @term_Delete(ptr noundef %call9.us227) #7
  %Scan1.0.val149.us228 = load ptr, ptr %Scan1.0215.us224, align 8
  %cmp.i.us229.not = icmp eq ptr %Scan1.0.val149.us228, null
  br i1 %cmp.i.us229.not, label %while.end, label %for.body.us223

while.end:                                        ; preds = %for.cond.while.cond.loopexit_crit_edge.split.us.us.us, %for.body.us223, %for.cond.preheader.lr.ph, %entry
  ret ptr %Terms
}
