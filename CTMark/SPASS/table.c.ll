; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/table.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/table.c"
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  br i1 %cmp3.not.not, label %for.body, label %for.end.loopexit
...
if.then.i:                                        ; preds = %for.end
  ...
  %sub6.i.i.i = sub i32 %7, %rem2.i.i.i
...
if.end13.i:                                       ; preds = %if.then9.i, %if.then.i
  ...
  %add.i = add i32 %RealSize.1.i.i.i, %13
...
memory_Free.exit:                                 ; preds = %if.end23.i, %if.else25.i
  ...
  br i1 %cmp.i.i54, label %if.else25.i82, label %if.then.i55

if.then.i55:                                      ; preds = %memory_Free.exit
  %23 = load i32, ptr @memory_ALIGN, align 4
  %rem2.i.i.i56 = urem i32 %mul20, %23
  %tobool3.not.i.i.i57 = icmp eq i32 %rem2.i.i.i56, 0
  %sub6.i.i.i58 = sub i32 %23, %rem2.i.i.i56
  %add7.i.i.i59 = select i1 %tobool3.not.i.i.i57, i32 0, i32 %sub6.i.i.i58
  %RealSize.1.i.i.i60 = add i32 %add7.i.i.i59, %mul20
  %24 = load i32, ptr @memory_OFFSET, align 4
  %idx.ext.i61 = zext i32 %24 to i64
  %idx.neg.i62 = sub nsw i64 0, %idx.ext.i61
  %add.ptr.i63 = getelementptr inbounds i8, ptr %table.val52, i64 %idx.neg.i62
  %add.ptr1.i64 = getelementptr inbounds i8, ptr %add.ptr.i63, i64 -16
  %25 = load ptr, ptr %add.ptr1.i64, align 8
  %cmp2.not.i65 = icmp eq ptr %25, null
  %next6.i66 = getelementptr inbounds i8, ptr %add.ptr.i63, i64 -8
  %26 = load ptr, ptr %next6.i66, align 8
  %next5.i67 = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %25, i64 0, i32 1
  %memory_BIGBLOCKS.sink.i68 = select i1 %cmp2.not.i65, ptr @memory_BIGBLOCKS, ptr %next5.i67
  store ptr %26, ptr %memory_BIGBLOCKS.sink.i68, align 8
  %27 = load ptr, ptr %next6.i66, align 8
  %cmp8.not.i70 = icmp eq ptr %27, null
  br i1 %cmp8.not.i70, label %if.end13.i72, label %if.then9.i71

if.then9.i71:                                     ; preds = %if.then.i55
  %28 = load ptr, ptr %add.ptr1.i64, align 8
  store ptr %28, ptr %27, align 8
  br label %if.end13.i72

if.end13.i72:                                     ; preds = %if.then9.i71, %if.then.i55
  %29 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i73 = add i32 %RealSize.1.i.i.i60, %29
  %conv.i74 = zext i32 %add.i73 to i64
  %add14.i75 = add nuw nsw i64 %conv.i74, 16
  %30 = load i64, ptr @memory_FREEDBYTES, align 8
  %add15.i76 = add i64 %add14.i75, %30
  store i64 %add15.i76, ptr @memory_FREEDBYTES, align 8
  %31 = load i64, ptr @memory_MAXMEM, align 8
  %cmp16.i77 = icmp sgt i64 %31, -1
  br i1 %cmp16.i77, label %if.then18.i80, label %if.end23.i78

if.then18.i80:                                    ; preds = %if.end13.i72
  %add22.i81 = add nuw i64 %31, %add14.i75
  store i64 %add22.i81, ptr @memory_MAXMEM, align 8
  br label %if.end23.i78

if.end23.i78:                                     ; preds = %if.then18.i80, %if.end13.i72
  %add.ptr24.i79 = getelementptr inbounds i8, ptr %table.val52, i64 -16
  tail call void @free(ptr noundef nonnull %add.ptr24.i79) #6
  br label %memory_Free.exit88

if.else25.i82:                                    ; preds = %memory_Free.exit
  %idxprom.i83 = zext i32 %mul20 to i64
  %arrayidx.i84 = getelementptr inbounds [0 x ptr], ptr @memory_ARRAY, i64 0, i64 %idxprom.i83
  %32 = load ptr, ptr %arrayidx.i84, align 8
  %total_size.i85 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %32, i64 0, i32 4
  %33 = load i32, ptr %total_size.i85, align 8
  %conv26.i86 = sext i32 %33 to i64
  %34 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i87 = add i64 %34, %conv26.i86
  store i64 %add27.i87, ptr @memory_FREEDBYTES, align 8
  %35 = load ptr, ptr %32, align 8
  store ptr %35, ptr %table.val52, align 8
  %36 = load ptr, ptr %arrayidx.i84, align 8
  store ptr %table.val52, ptr %36, align 8
  br label %memory_Free.exit88

memory_Free.exit88:                               ; preds = %if.end23.i78, %if.else25.i82
  ...
  br i1 %cmp.i.i89, label %if.else25.i117, label %if.then.i90

if.then.i90:                                      ; preds = %memory_Free.exit88
  %38 = load i32, ptr @memory_ALIGN, align 4
  %rem2.i.i.i91 = urem i32 %mul26, %38
  %tobool3.not.i.i.i92 = icmp eq i32 %rem2.i.i.i91, 0
  %sub6.i.i.i93 = sub i32 %38, %rem2.i.i.i91
  %add7.i.i.i94 = select i1 %tobool3.not.i.i.i92, i32 0, i32 %sub6.i.i.i93
  %RealSize.1.i.i.i95 = add i32 %add7.i.i.i94, %mul26
  %39 = load i32, ptr @memory_OFFSET, align 4
  %idx.ext.i96 = zext i32 %39 to i64
  %idx.neg.i97 = sub nsw i64 0, %idx.ext.i96
  %add.ptr.i98 = getelementptr inbounds i8, ptr %table.val53, i64 %idx.neg.i97
  %add.ptr1.i99 = getelementptr inbounds i8, ptr %add.ptr.i98, i64 -16
  %40 = load ptr, ptr %add.ptr1.i99, align 8
  %cmp2.not.i100 = icmp eq ptr %40, null
  %next6.i101 = getelementptr inbounds i8, ptr %add.ptr.i98, i64 -8
  %41 = load ptr, ptr %next6.i101, align 8
  %next5.i102 = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %40, i64 0, i32 1
  %memory_BIGBLOCKS.sink.i103 = select i1 %cmp2.not.i100, ptr @memory_BIGBLOCKS, ptr %next5.i102
  store ptr %41, ptr %memory_BIGBLOCKS.sink.i103, align 8
  %42 = load ptr, ptr %next6.i101, align 8
  %cmp8.not.i105 = icmp eq ptr %42, null
  br i1 %cmp8.not.i105, label %if.end13.i107, label %if.then9.i106

if.then9.i106:                                    ; preds = %if.then.i90
  %43 = load ptr, ptr %add.ptr1.i99, align 8
  store ptr %43, ptr %42, align 8
  br label %if.end13.i107

if.end13.i107:                                    ; preds = %if.then9.i106, %if.then.i90
  %44 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i108 = add i32 %RealSize.1.i.i.i95, %44
  %conv.i109 = zext i32 %add.i108 to i64
  %add14.i110 = add nuw nsw i64 %conv.i109, 16
  %45 = load i64, ptr @memory_FREEDBYTES, align 8
  %add15.i111 = add i64 %add14.i110, %45
  store i64 %add15.i111, ptr @memory_FREEDBYTES, align 8
  %46 = load i64, ptr @memory_MAXMEM, align 8
  %cmp16.i112 = icmp sgt i64 %46, -1
  br i1 %cmp16.i112, label %if.then18.i115, label %if.end23.i113

if.then18.i115:                                   ; preds = %if.end13.i107
  %add22.i116 = add nuw i64 %46, %add14.i110
  store i64 %add22.i116, ptr @memory_MAXMEM, align 8
  br label %if.end23.i113

if.end23.i113:                                    ; preds = %if.then18.i115, %if.end13.i107
  %add.ptr24.i114 = getelementptr inbounds i8, ptr %table.val53, i64 -16
  tail call void @free(ptr noundef nonnull %add.ptr24.i114) #6
  br label %memory_Free.exit123

if.else25.i117:                                   ; preds = %memory_Free.exit88
  %idxprom.i118 = zext i32 %mul26 to i64
  %arrayidx.i119 = getelementptr inbounds [0 x ptr], ptr @memory_ARRAY, i64 0, i64 %idxprom.i118
  %47 = load ptr, ptr %arrayidx.i119, align 8
  %total_size.i120 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %47, i64 0, i32 4
  %48 = load i32, ptr %total_size.i120, align 8
  %conv26.i121 = sext i32 %48 to i64
  %49 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i122 = add i64 %49, %conv26.i121
  store i64 %add27.i122, ptr @memory_FREEDBYTES, align 8
  %50 = load ptr, ptr %47, align 8
  store ptr %50, ptr %table.val53, align 8
  %51 = load ptr, ptr %arrayidx.i119, align 8
  store ptr %table.val53, ptr %51, align 8
  br label %memory_Free.exit123

memory_Free.exit123:                              ; preds = %if.end23.i113, %if.else25.i117
  %52 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 40), align 8
  %total_size.i125 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %52, i64 0, i32 4
  %53 = load i32, ptr %total_size.i125, align 8
  %conv26.i126 = sext i32 %53 to i64
  %54 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i127 = add i64 %54, %conv26.i126
  store i64 %add27.i127, ptr @memory_FREEDBYTES, align 8
...
if.then.i:                                        ; preds = %for.end
  ...
  %tobool3.not.i.i.i = icmp eq i32 %rem2.i.i.i, 0
  %sub6.i.i.i = sub i32 %1, %rem2.i.i.i
  %add7.i.i.i = select i1 %tobool3.not.i.i.i, i32 0, i32 %sub6.i.i.i
  %RealSize.1.i.i.i = add i32 %add7.i.i.i, %mul
...
if.end13.i:                                       ; preds = %if.then9.i, %if.then.i
  ...
  %add.i = add i32 %RealSize.1.i.i.i, %7
  %conv.i = zext i32 %add.i to i64
  %add14.i = add nuw nsw i64 %conv.i, 16
...
entry:
  ...
  %spec.select = tail call i32 @llvm.smax.i32(i32 %table.val134, i32 %opbound)
...
if.then:                                          ; preds = %entry
  ...
  store i32 %spec.select, ptr %opbound1.i.i, align 4
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  br i1 %cmp36.not.not, label %for.body, label %for.end.loopexit
...
if.then.i:                                        ; preds = %for.end
  ...
  %tobool3.not.i.i.i = icmp eq i32 %rem2.i.i.i, 0
  %sub6.i.i.i = sub i32 %8, %rem2.i.i.i
  %add7.i.i.i = select i1 %tobool3.not.i.i.i, i32 0, i32 %sub6.i.i.i
  %RealSize.1.i.i.i = add i32 %add7.i.i.i, %mul
...
if.end13.i:                                       ; preds = %if.then9.i, %if.then.i
  ...
  %add.i145 = add i32 %RealSize.1.i.i.i, %14
...
entry:
  ...
  %cmp.i.inv.i = icmp sgt i32 %term.val, 0
  %shr.i.i = select i1 %cmp.i.inv.i, i32 0, i32 %0
  ...
  %terms.057 = load ptr, ptr %1, align 8
  %cmp.i.not58 = icmp eq ptr %terms.057, null
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end
  %terms.060 = phi ptr [ %terms.057, %for.body.lr.ph ], [ %terms.0, %if.end ]
  %ta.059 = phi ptr [ %add.ptr, %for.body.lr.ph ], [ %add.ptr15, %if.end ]
  %3 = getelementptr i8, ptr %ta.059, i64 16
...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %4 = getelementptr i8, ptr %terms.060, i64 8
  ...
  %terms.0 = load ptr, ptr %terms.060, align 8
...
for.end:                                          ; preds = %if.end, %entry
  ...
  %cmp.i.not.i = icmp eq i32 %ta.val.i, %table.val9.i
  br i1 %cmp.i.not.i, label %table_DelayedInit.exit, label %table_DelayedInit.exit.thread
...
if.else:                                          ; preds = %table_DelayedInit.exit.thread, %table_DelayedInit.exit
  ...
  %cmp.i.not.i51 = icmp eq i32 %10, %table.val11.i
  br i1 %cmp.i.not.i51, label %table_DelayedPosInit.exit, label %if.then.i52
...
table_DelayedPosInit.exit:                        ; preds = %if.else, %if.then.i52
  %12 = getelementptr i8, ptr %table, i64 8
  %table.val.i54 = load ptr, ptr %12, align 8
  %arrayidx.i = getelementptr inbounds ptr, ptr %table.val.i54, i64 %idxprom.i.i.i
...
entry:
  ...
  %cmp.i.not.i = icmp eq i32 %3, %table.val11.i
  br i1 %cmp.i.not.i, label %table_DelayedPosInit.exit, label %if.then.i
