; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/tableau.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/tableau.c"
...
entry:
  %call = tail call ptr @memory_Malloc(i32 noundef 16) #13
  %add = shl i32 %MaxLevel, 3
  %mul = add i32 %add, 8
  %call2 = tail call ptr @memory_Malloc(i32 noundef %mul) #13
...
memory_Free.exit:                                 ; preds = %if.end23.i, %if.else25.i
  ...
  %total_size.i5 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %16, i64 0, i32 4
  %17 = load i32, ptr %total_size.i5, align 8
  %conv26.i6 = sext i32 %17 to i64
  %18 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i7 = add i64 %18, %conv26.i6
  store i64 %add27.i7, ptr @memory_FREEDBYTES, align 8
...
for.body.i:                                       ; preds = %for.cond.i
  ...
  br i1 %cmp7.i, label %return, label %for.cond.i
...
for.body.i11:                                     ; preds = %for.inc14.i, %for.body.lr.ph.i
  %indvars.iv.i = phi i64 [ 0, %for.body.lr.ph.i ], [ %indvars.iv.next.i, %for.inc14.i ]
  %arrayidx.i.i12 = getelementptr inbounds ptr, ptr %Path.val17.i, i64 %indvars.iv.i
  %5 = load ptr, ptr %arrayidx.i.i12, align 8
  br label %for.cond6.i

for.cond6.i:                                      ; preds = %for.body8.i, %for.body.i11
  %Scan.0.in.i13 = phi ptr [ %5, %for.body.i11 ], [ %Scan.0.i14, %for.body8.i ]
...
for.body8.i:                                      ; preds = %for.cond6.i
  ...
  br i1 %cmp10.i, label %if.then3, label %for.cond6.i

for.inc14.i:                                      ; preds = %for.cond6.i
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %return, label %for.body.i11

if.then3:                                         ; preds = %for.body8.i
  %7 = load ptr, ptr @stderr, align 8
  %8 = tail call i64 @fwrite(ptr nonnull @.str, i64 57, i64 1, ptr %7) #14
  %9 = load ptr, ptr @stderr, align 8
  tail call void @clause_PParentsFPrint(ptr noundef %9, ptr noundef %C) #13
...
entry:
  ...
  %call.i = tail call ptr @memory_Malloc(i32 noundef 56) #13
...
if.then:                                          ; preds = %entry
  ...
  tail call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.3) #13
...
if.end:                                           ; preds = %entry
  ...
  %call.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #13
...
if.else:                                          ; preds = %if.end, %tab_IsLeaf.exit
  ...
  %call8 = tail call i32 @misc_Max(i32 noundef %add, i32 noundef %call7) #13
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %Redundant) #13
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %Redundant) #13
  ret void
}
...
if.then5:                                         ; preds = %list_Delete.exit
  ...
  br i1 %cmp.i.not5.i26, label %if.end9, label %while.body.i27

while.body.i27:                                   ; preds = %if.then5, %while.body.i27
  %Current.06.i28 = phi ptr [ %Current.0.val.i29, %while.body.i27 ], [ %T.val, %if.then5 ]
  %Current.0.val.i29 = load ptr, ptr %Current.06.i28, align 8
  %8 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i30 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %8, i64 0, i32 4
  %9 = load i32, ptr %total_size.i.i.i30, align 8
  %conv26.i.i.i31 = sext i32 %9 to i64
  %10 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i32 = add i64 %10, %conv26.i.i.i31
  store i64 %add27.i.i.i32, ptr @memory_FREEDBYTES, align 8
  %11 = load ptr, ptr %8, align 8
  store ptr %11, ptr %Current.06.i28, align 8
  %12 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i28, ptr %12, align 8
  %cmp.i.not.i33 = icmp eq ptr %Current.0.val.i29, null
  br i1 %cmp.i.not.i33, label %if.end9, label %while.body.i27
...
if.end9:                                          ; preds = %while.body.i27, %if.then5, %list_Nconc.exit
...
for.body.i.us.prol:                               ; preds = %for.body.lr.ph.i.us, %for.body.i.us.prol
  ...
  br i1 %prol.iter.cmp.not, label %for.body.i.us.prol.loopexit, label %for.body.i.us.prol
...
for.body.i.us:                                    ; preds = %for.body.i.us.prol.loopexit, %for.body.i.us
  ...
  br i1 %cmp.not.i.us.3, label %clause_ClearSplitField.exit.us.loopexit, label %for.body.i.us
...
if.then.i.us:                                     ; preds = %clause_ClearSplitField.exit.us
  %call.i.i.us = tail call ptr @memory_Malloc(i32 noundef %mul.i.i) #13
...
for.body.i.i.us:                                  ; preds = %for.body.i.i.us, %for.body.lr.ph.i.i.us
  ...
  br i1 %cmp3.i.i.us, label %for.body.i.i.us, label %for.cond8.preheader.i.i.us
...
if.end23.i.i.i.us:                                ; preds = %if.then18.i.i.i.us, %if.end13.i.i.i.us
  ...
  tail call void @free(ptr noundef nonnull %add.ptr24.i.i.i.us) #13
...
clause_SetSplitFieldBit.exit.us:                  ; preds = %entry.if.end_crit_edge.i.us, %if.end.i.i.us
  ...
  br i1 %cmp.i32.not.us, label %for.end, label %for.body.us
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  br i1 %cmp.not.i39, label %for.inc, label %if.then.i40

if.then.i40:                                      ; preds = %for.body
  %splitfield.i41 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Scan.0.val, i64 0, i32 4
  %46 = load ptr, ptr %splitfield.i41, align 8
  %cmp1.not.i = icmp eq ptr %46, null
  br i1 %cmp1.not.i, label %if.else.i, label %if.then2.i

if.then2.i:                                       ; preds = %if.then.i40
  %mul.i = shl i32 %45, 3
...
if.else.i:                                        ; preds = %if.else25.i.i, %if.end23.i.i, %if.then.i40
  store ptr null, ptr %splitfield.i41, align 8
...
while.body.i:                                     ; preds = %if.then3, %while.body.i
  ...
  br i1 %cmp.i.not.i40, label %list_Delete.exit, label %while.body.i
...
if.end19:                                         ; preds = %for.cond.preheader, %if.then17, %tab_IsLeaf.exit, %for.end
  %cmp.i55.not88 = phi i1 [ true, %for.end ], [ false, %tab_IsLeaf.exit ], [ false, %if.then17 ], [ true, %for.cond.preheader ]
  %Empties.0.lcssa85 = phi ptr [ null, %for.end ], [ %Empties.1, %tab_IsLeaf.exit ], [ %Empties.1, %if.then17 ], [ null, %for.cond.preheader ]
  %tobool27.not = phi i1 [ true, %for.end ], [ true, %tab_IsLeaf.exit ], [ false, %if.then17 ], [ true, %for.cond.preheader ]
...
tab_IsLeaf.exit67:                                ; preds = %if.end19
  ...
  %T.val4.i64 = load ptr, ptr %7, align 8
  %cmp.i5.i65.not = icmp eq ptr %T.val4.i64, null
  br i1 %cmp.i5.i65.not, label %land.lhs.true22, label %if.end26

land.lhs.true22:                                  ; preds = %tab_IsLeaf.exit67
  %call23 = tail call i32 @list_Length(ptr noundef %Empties.0.lcssa85) #13
...
if.then28:                                        ; preds = %if.end26.thread, %if.end26
  ...
  tail call void @clause_PParentsListPrint(ptr noundef %T.val) #13
  br label %if.end31
...
if.end:                                           ; preds = %entry, %list_Nconc.exit
  ...
  %call2 = tail call ptr @list_Copy(ptr noundef %T.val) #13
...
; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @tab_LabelNodes(ptr noundef %T) local_unnamed_addr #7 {
entry:
...
; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define internal fastcc void @tab_LabelNodesRec(ptr noundef %T, ptr nocapture noundef %Num) unnamed_addr #7 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  tail call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.8) #13
...
if.end:                                           ; preds = %entry
  %call2 = tail call ptr @misc_OpenFile(ptr noundef %Filename, ptr noundef nonnull @.str.9) #13
...
if.end8:                                          ; preds = %if.end8.sink.split, %if.end
  tail call void @misc_CloseFile(ptr noundef %call2, ptr noundef %Filename) #13
  ret void
}
...
entry:
  ...
  tail call void @clause_PParentsFPrint(ptr noundef %File, ptr noundef %T.val75) #13
  ...
  tail call void @clause_PParentsFPrint(ptr noundef %File, ptr noundef %T.val76) #13
...
if.else:                                          ; preds = %entry
  ...
  tail call void @clause_PParentsFPrint(ptr noundef %File, ptr noundef %call9.val) #13
...
for.body:                                         ; preds = %if.else, %for.body
  ...
  tail call void @clause_PParentsFPrint(ptr noundef %File, ptr noundef %Scan.0.val) #13
  ...
  br i1 %cmp.i77.not, label %if.end, label %for.body
...
for.body33:                                       ; preds = %if.then21, %for.body33
  %Scan.186 = phi ptr [ %Scan.1.val70, %for.body33 ], [ %T.val69, %if.then21 ]
  %15 = getelementptr i8, ptr %Scan.186, i64 8
  %Scan.1.val = load ptr, ptr %15, align 8
  tail call void @clause_PParentsFPrint(ptr noundef %File, ptr noundef %Scan.1.val) #13
  %16 = tail call i64 @fwrite(ptr nonnull @.str.20, i64 2, i64 1, ptr %File)
  %Scan.1.val70 = load ptr, ptr %Scan.186, align 8
  %cmp.i81.not = icmp eq ptr %Scan.1.val70, null
  br i1 %cmp.i81.not, label %if.end40, label %for.body33
