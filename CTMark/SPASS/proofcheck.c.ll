...
for.cond.i23:                                     ; preds = %if.end.i21, %for.cond.i23
  ...
  br i1 %cmp.i20.not.i26, label %for.end.i27, label %for.cond.i23, !llvm.loop !5
...
for.cond.i33:                                     ; preds = %if.end.i31, %for.cond.i33
  ...
  br i1 %cmp.i20.not.i36, label %for.end.i37, label %for.cond.i33, !llvm.loop !5
...
while.body.i105.i.i:                              ; preds = %list_Delete.exit.i.i, %while.body.i105.i.i
  ...
  br i1 %cmp.i.not.i111.i.i, label %list_Delete.exit112.i.i, label %while.body.i105.i.i, !llvm.loop !11
...
for.body.i89:                                     ; preds = %for.body.i89, %if.end.i
  ...
  br i1 %cmp.i29.not.i, label %for.end.i, label %for.body.i89, !llvm.loop !22
...
list_Delete.exit.i.i:                             ; preds = %while.body.i38.i.i, %for.end.i.i
  ...
  br i1 %exitcond.not.i.i, label %pcheck_ParentNumbersToPointersInVector.exit.i, label %for.body.i.i123, !llvm.loop !24
...
while.body.i:                                     ; preds = %entry, %while.body.i
  ...
  %cmp.i.not.i = icmp eq ptr %Clauses.addr.0.val.i, null
  br i1 %cmp.i.not.i, label %pcheck_MaxSplitLevel.exit, label %while.body.i, !llvm.loop !25
...
while.body.i62:                                   ; preds = %pcheck_ClauseListRemoveFlag.exit, %while.body.i62
  ...
  br i1 %cmp.i.not.i68, label %list_Delete.exit69, label %while.body.i62, !llvm.loop !11
...
while.body.i71:                                   ; preds = %list_Delete.exit69, %while.body.i71
  ...
  br i1 %cmp.i.not.i77, label %list_Delete.exit78, label %while.body.i71, !llvm.loop !11
...
while.body.i.i:                                   ; preds = %land.lhs.true, %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i, label %pcheck_MaxParentSplitLevel.exit.loopexit, label %while.body.i.i, !llvm.loop !25
...
while.body.i12:                                   ; preds = %pcheck_ClauseListRemoveFlag.exit, %while.body.i12
  ...
  br i1 %cmp.i.not.i18, label %list_Delete.exit19, label %while.body.i12, !llvm.loop !11
...
while.body.i21:                                   ; preds = %list_Delete.exit19, %while.body.i21
  ...
  br i1 %cmp.i.not.i27, label %list_Delete.exit28, label %while.body.i21, !llvm.loop !11
...
while.body.i:                                     ; preds = %for.end, %while.body.i
  ...
  %cmp.i.not.i = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i, label %while.body.i33.preheader, label %while.body.i, !llvm.loop !11
...
while.body.i33:                                   ; preds = %while.body.i33.preheader, %while.body.i33
  ...
  br i1 %cmp.i.not.i39, label %list_Delete.exit40, label %while.body.i33, !llvm.loop !11

list_Delete.exit40:                               ; preds = %while.body.i33
  %Scan1.0.val = load ptr, ptr %Scan1.054, align 8
  %cmp.i.not = icmp eq ptr %Scan1.0.val, null
  br i1 %cmp.i.not, label %while.body.i42, label %while.body, !llvm.loop !37
...
while.body.i42:                                   ; preds = %list_Delete.exit40, %while.body.i42
  ...
  br i1 %cmp.i.not.i48, label %list_Delete.exit49, label %while.body.i42, !llvm.loop !11
