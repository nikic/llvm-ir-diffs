; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/proofcheck.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/proofcheck.c"
...
list_Nconc.exit:                                  ; preds = %entry, %if.end.i, %for.end.i
  ...
  br i1 %cmp.i.not.i20, label %list_Nconc.exit29, label %if.end.i21

if.end.i21:                                       ; preds = %list_Nconc.exit
  %cmp.i18.not.i22 = icmp eq ptr %retval.0.i, null
  br i1 %cmp.i18.not.i22, label %list_Nconc.exit29, label %for.cond.i23

for.cond.i23:                                     ; preds = %if.end.i21, %for.cond.i23
  %List1.addr.0.i24 = phi ptr [ %List1.addr.0.val17.i25, %for.cond.i23 ], [ %call5, %if.end.i21 ]
  %List1.addr.0.val17.i25 = load ptr, ptr %List1.addr.0.i24, align 8
  %cmp.i20.not.i26 = icmp eq ptr %List1.addr.0.val17.i25, null
  br i1 %cmp.i20.not.i26, label %for.end.i27, label %for.cond.i23

for.end.i27:                                      ; preds = %for.cond.i23
  store ptr %retval.0.i, ptr %List1.addr.0.i24, align 8
  br label %list_Nconc.exit29

list_Nconc.exit29:                                ; preds = %list_Nconc.exit, %if.end.i21, %for.end.i27
  %retval.0.i28 = phi ptr [ %call5, %for.end.i27 ], [ %retval.0.i, %list_Nconc.exit ], [ %call5, %if.end.i21 ]
  ...
  br i1 %cmp.i.not.i30, label %list_Nconc.exit39, label %if.end.i31

if.end.i31:                                       ; preds = %list_Nconc.exit29
  %cmp.i18.not.i32 = icmp eq ptr %retval.0.i28, null
  br i1 %cmp.i18.not.i32, label %list_Nconc.exit39, label %for.cond.i33

for.cond.i33:                                     ; preds = %if.end.i31, %for.cond.i33
  %List1.addr.0.i34 = phi ptr [ %List1.addr.0.val17.i35, %for.cond.i33 ], [ %call8, %if.end.i31 ]
  %List1.addr.0.val17.i35 = load ptr, ptr %List1.addr.0.i34, align 8
  %cmp.i20.not.i36 = icmp eq ptr %List1.addr.0.val17.i35, null
  br i1 %cmp.i20.not.i36, label %for.end.i37, label %for.cond.i33

for.end.i37:                                      ; preds = %for.cond.i33
  store ptr %retval.0.i28, ptr %List1.addr.0.i34, align 8
  br label %list_Nconc.exit39

list_Nconc.exit39:                                ; preds = %list_Nconc.exit29, %if.end.i31, %for.end.i37
  %retval.0.i38 = phi ptr [ %call8, %for.end.i37 ], [ %retval.0.i28, %list_Nconc.exit29 ], [ %call8, %if.end.i31 ]
...
for.body.i:                                       ; preds = %if.end.i41, %for.body.i
  ...
  br i1 %cmp.i.not.i42, label %for.end.i43, label %for.body.i
...
clause_RemoveFlag.exit.i.i:                       ; preds = %if.then.i.i.i, %for.body.i.i
  ...
  br i1 %tobool.not.i82.i.i, label %clause_RemoveFlag.exit85.i.i, label %if.then.i83.i.i
...
if.then.i83.i.i:                                  ; preds = %clause_RemoveFlag.exit.i.i
  ...
  %sub.i84.i.i = add i32 %6, -128
  store i32 %sub.i84.i.i, ptr %flags.i80.i.i, align 8
  br label %clause_RemoveFlag.exit85.i.i

clause_RemoveFlag.exit85.i.i:                     ; preds = %if.then.i83.i.i, %clause_RemoveFlag.exit.i.i
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1
  %exitcond.not.i.i = icmp eq i64 %indvars.iv.next.i.i, %wide.trip.count.i.i
  br i1 %exitcond.not.i.i, label %for.body5.i.i, label %for.body.i.i
...
if.end6.i.i.i:                                    ; preds = %if.then3.i.i.i, %while.body.i.i.i
  ...
  br i1 %cmp.i90.i.i, label %while.body.i.i.i, label %if.then21.i.i
...
if.end30.i.i:                                     ; preds = %if.end.i.i, %if.then21.i.i
  ...
  br i1 %cmp.i88.not.i.i, label %while.end.i.i, label %while.body.i.preheader.i.i
...
while.body.i103.i.i:                              ; preds = %while.end.i.i, %while.body.i103.i.i
  ...
  br i1 %cmp.i.not.i.i.i, label %list_Delete.exit.i.i, label %while.body.i103.i.i
...
list_Delete.exit.i.i:                             ; preds = %while.body.i103.i.i, %while.end.i.i, %if.then.i.i
  ...
  br i1 %cmp.i.not5.i104.i.i, label %list_Delete.exit112.i.i, label %while.body.i105.i.i

while.body.i105.i.i:                              ; preds = %list_Delete.exit.i.i, %while.body.i105.i.i
  %Current.06.i106.i.i = phi ptr [ %Current.0.val.i107.i.i, %while.body.i105.i.i ], [ %.val78.i.i, %list_Delete.exit.i.i ]
  %Current.0.val.i107.i.i = load ptr, ptr %Current.06.i106.i.i, align 8
  %31 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i108.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %31, i64 0, i32 4
  %32 = load i32, ptr %total_size.i.i.i108.i.i, align 8
  %conv26.i.i.i109.i.i = sext i32 %32 to i64
  %33 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i110.i.i = add i64 %33, %conv26.i.i.i109.i.i
  store i64 %add27.i.i.i110.i.i, ptr @memory_FREEDBYTES, align 8
  %34 = load ptr, ptr %31, align 8
  store ptr %34, ptr %Current.06.i106.i.i, align 8
  %35 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i106.i.i, ptr %35, align 8
  %cmp.i.not.i111.i.i = icmp eq ptr %Current.0.val.i107.i.i, null
  br i1 %cmp.i.not.i111.i.i, label %list_Delete.exit112.i.i, label %while.body.i105.i.i

list_Delete.exit112.i.i:                          ; preds = %while.body.i105.i.i, %list_Delete.exit.i.i
...
for.inc38.i.i:                                    ; preds = %list_Delete.exit112.i.i, %for.body5.i.i
  ...
  br i1 %exitcond139.not.i.i, label %pcheck_ForceParentNumbersToPointersInVector.exit.i, label %for.body5.i.i
...
while.body.i:                                     ; preds = %pcheck_ConvertParentsInList.exit, %while.body.i
  ...
  br i1 %cmp.i.not.i45, label %list_Delete.exit, label %while.body.i
...
clause_RemoveFlag.exit.i:                         ; preds = %if.then.i.i, %for.body.i
  ...
  br i1 %cmp.i.not.i, label %for.body, label %for.body.i
...
for.body10:                                       ; preds = %if.then, %for.body10
  ...
  br i1 %cmp.i33.not, label %for.end.loopexit, label %for.body10
...
for.inc15:                                        ; preds = %for.body, %for.end
  ...
  br i1 %cmp.i.not, label %for.end17, label %for.body
...
pcheck_LabelToNumber.exit:                        ; preds = %while.body18
  ...
  br i1 %cmp.i66.not, label %while.end, label %while.body18
...
for.body.i:                                       ; preds = %for.body.i.prol.loopexit, %for.body.i
  ...
  br i1 %cmp.not.i.3, label %clause_ClearSplitField.exit.loopexit, label %for.body.i
...
clause_ClearSplitField.exit:                      ; preds = %clause_ClearSplitField.exit.loopexit, %if.then
  ...
  br i1 %cmp.not.i74, label %entry.if.end_crit_edge.i, label %if.then.i75
...
if.then.i75:                                      ; preds = %clause_ClearSplitField.exit
  %add.i = add nuw nsw i32 %storemerge.i.i, 1
  %mul.i.i = shl nuw nsw i32 %add.i, 3
  %call.i.i76 = call ptr @memory_Malloc(i32 noundef %mul.i.i) #16
...
for.body.lr.ph.i.i:                               ; preds = %if.then.i75
...
for.body11.preheader.i.i:                         ; preds = %if.then.i75, %for.cond8.preheader.i.i
  %.lcssa.i11.i = phi i32 [ %40, %for.cond8.preheader.i.i ], [ 0, %if.then.i75 ]
  %32 = zext i32 %.lcssa.i11.i to i64
  %33 = shl nuw nsw i64 %32, 3
  %scevgep.i.i = getelementptr i8, ptr %call.i.i76, i64 %33
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  ...
  %arrayidx6.i.i = getelementptr inbounds i64, ptr %call.i.i76, i64 %indvars.iv.i.i
...
if.else:                                          ; preds = %while.end
  ...
  br i1 %cmp.not.i80, label %if.end, label %if.then.i81

if.then.i81:                                      ; preds = %if.else
  %splitfield.i82 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call10, i64 0, i32 4
  %59 = load ptr, ptr %splitfield.i82, align 8
...
if.else.i:                                        ; preds = %if.else25.i.i, %if.end23.i.i, %if.then.i81
  store ptr null, ptr %splitfield.i82, align 8
...
clause_RemoveFlag.exit:                           ; preds = %if.end, %if.then.i85
  ...
  br i1 %cmp.i.not, label %while.end28, label %while.body
...
for.body.i89:                                     ; preds = %for.body.i89, %if.end.i
  %indvars.iv.i = phi i64 [ 0, %if.end.i ], [ %indvars.iv.next.i, %for.body.i89 ]
  %ScanClauses.038.i = phi ptr [ %call29, %if.end.i ], [ %ScanClauses.0.val.i, %for.body.i89 ]
  %74 = getelementptr i8, ptr %ScanClauses.038.i, i64 8
  %ScanClauses.0.val28.i = load ptr, ptr %74, align 8
  %arrayidx.i90 = getelementptr inbounds ptr, ptr %call4.i, i64 %indvars.iv.i
  store ptr %ScanClauses.0.val28.i, ptr %arrayidx.i90, align 8
  %ScanClauses.0.val.i = load ptr, ptr %ScanClauses.038.i, align 8
  %indvars.iv.next.i = add nuw i64 %indvars.iv.i, 1
  %cmp.i29.not.i = icmp eq ptr %ScanClauses.0.val.i, null
  br i1 %cmp.i29.not.i, label %for.end.i, label %for.body.i89

for.end.i:                                        ; preds = %for.body.i89
  ...
  br i1 %cmp51.i.i, label %for.body.lr.ph.i.i122, label %pcheck_ParentNumbersToPointersInVector.exit.i

for.body.lr.ph.i.i122:                            ; preds = %for.end.i
  %conv6.i.i = zext i32 %call2.i to i64
  br label %for.body.i.i123

for.body.i.i123:                                  ; preds = %list_Delete.exit.i.i, %for.body.lr.ph.i.i122
  %indvars.iv.i.i124 = phi i64 [ 0, %for.body.lr.ph.i.i122 ], [ %indvars.iv.next.i.i131, %list_Delete.exit.i.i ]
  %arrayidx.i.i125 = getelementptr inbounds ptr, ptr %call4.i, i64 %indvars.iv.i.i124
  %75 = load ptr, ptr %arrayidx.i.i125, align 8
  %76 = getelementptr i8, ptr %75, i64 32
  %.val.i.i = load ptr, ptr %76, align 8
  %call1.i.i126 = call ptr @list_Copy(ptr noundef %.val.i.i) #16
  %cmp.i.not46.i.i = icmp eq ptr %call1.i.i126, null
  br i1 %cmp.i.not46.i.i, label %for.end.i.i, label %for.body4.i.i

for.body4.i.i:                                    ; preds = %for.body.i.i123, %if.then.i.i130
  %ScanParents.047.i.i = phi ptr [ %ScanParents.0.val.i.i, %if.then.i.i130 ], [ %call1.i.i126, %for.body.i.i123 ]
...
while.body.i.i.i:                                 ; preds = %if.end6.i.i.i, %for.body4.i.i
  ...
  %add.i.i.i127 = add i64 %__u.019.i.i.i, %__l.020.i.i.i
  %div17.i.i.i = lshr i64 %add.i.i.i127, 1
  %mul.i.i.i = shl i64 %div17.i.i.i, 3
  %add.ptr.i.i.i128 = getelementptr inbounds i8, ptr %call4.i, i64 %mul.i.i.i
  %80 = load ptr, ptr %add.ptr.i.i.i128, align 8
  %.val.i.i.i = load i32, ptr %80, align 8
  %cmp1.i.i.i = icmp sgt i32 %.val.i.i.i, %79
  br i1 %cmp1.i.i.i, label %if.end6.i.i.i, label %if.else.i.i.i

if.else.i.i.i:                                    ; preds = %while.body.i.i.i
  %cmp2.not.i.i.i129 = icmp eq i32 %.val.i.i.i, %79
  br i1 %cmp2.not.i.i.i129, label %if.then.i.i130, label %if.then3.i.i.i
...
for.end.i.i:                                      ; preds = %if.then.i.i130, %for.body.i.i123
  %86 = load ptr, ptr %arrayidx.i.i125, align 8
  %parentCls.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %86, i64 0, i32 6
  store ptr %call1.i.i126, ptr %parentCls.i.i.i, align 8
...
while.body.i38.i.i:                               ; preds = %for.end.i.i, %while.body.i38.i.i
  ...
  %cmp.i.not.i.i.i = icmp eq ptr %Current.0.val.i.i.i, null
  br i1 %cmp.i.not.i.i.i, label %list_Delete.exit.i.i, label %while.body.i38.i.i

list_Delete.exit.i.i:                             ; preds = %while.body.i38.i.i, %for.end.i.i
  %indvars.iv.next.i.i131 = add nuw nsw i64 %indvars.iv.i.i124, 1
  %exitcond.not.i.i = icmp eq i64 %indvars.iv.next.i.i131, %conv6.i.i
  br i1 %exitcond.not.i.i, label %pcheck_ParentNumbersToPointersInVector.exit.i, label %for.body.i.i123

pcheck_ParentNumbersToPointersInVector.exit.i:    ; preds = %list_Delete.exit.i.i, %for.end.i
  %cmp.i.i.i92 = icmp ult i32 %mul.i88, 1024
  br i1 %cmp.i.i.i92, label %if.else25.i.i117, label %if.then.i31.i

if.then.i31.i:                                    ; preds = %pcheck_ParentNumbersToPointersInVector.exit.i
  %92 = load i32, ptr @memory_ALIGN, align 4
  %rem2.i.i.i.i93 = urem i32 %mul.i88, %92
  %tobool3.not.i.i.i.i94 = icmp eq i32 %rem2.i.i.i.i93, 0
  %sub6.i.i.i.i95 = sub i32 %92, %rem2.i.i.i.i93
  %add7.i.i.i.i96 = select i1 %tobool3.not.i.i.i.i94, i32 0, i32 %sub6.i.i.i.i95
  %RealSize.1.i.i.i.i97 = add i32 %add7.i.i.i.i96, %mul.i88
  %93 = load i32, ptr @memory_OFFSET, align 4
  %idx.ext.i.i98 = zext i32 %93 to i64
  %idx.neg.i.i99 = sub nsw i64 0, %idx.ext.i.i98
  %add.ptr.i.i100 = getelementptr inbounds i8, ptr %call4.i, i64 %idx.neg.i.i99
  %add.ptr1.i.i101 = getelementptr inbounds i8, ptr %add.ptr.i.i100, i64 -16
  %94 = load ptr, ptr %add.ptr1.i.i101, align 8
  %cmp2.not.i.i102 = icmp eq ptr %94, null
  %next6.i.i103 = getelementptr inbounds i8, ptr %add.ptr.i.i100, i64 -8
  %95 = load ptr, ptr %next6.i.i103, align 8
  %next5.i.i104 = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %94, i64 0, i32 1
  %memory_BIGBLOCKS.sink.i.i105 = select i1 %cmp2.not.i.i102, ptr @memory_BIGBLOCKS, ptr %next5.i.i104
  store ptr %95, ptr %memory_BIGBLOCKS.sink.i.i105, align 8
  %96 = load ptr, ptr %next6.i.i103, align 8
  %cmp8.not.i.i106 = icmp eq ptr %96, null
  br i1 %cmp8.not.i.i106, label %if.end13.i.i108, label %if.then9.i.i107

if.then9.i.i107:                                  ; preds = %if.then.i31.i
  %97 = load ptr, ptr %add.ptr1.i.i101, align 8
  store ptr %97, ptr %96, align 8
  br label %if.end13.i.i108

if.end13.i.i108:                                  ; preds = %if.then9.i.i107, %if.then.i31.i
  %98 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i109 = add i32 %RealSize.1.i.i.i.i97, %98
  %conv.i32.i = zext i32 %add.i.i109 to i64
  %add14.i.i110 = add nuw nsw i64 %conv.i32.i, 16
  %99 = load i64, ptr @memory_FREEDBYTES, align 8
  %add15.i.i111 = add i64 %add14.i.i110, %99
  store i64 %add15.i.i111, ptr @memory_FREEDBYTES, align 8
  %100 = load i64, ptr @memory_MAXMEM, align 8
  %cmp16.i.i112 = icmp sgt i64 %100, -1
  br i1 %cmp16.i.i112, label %if.then18.i.i115, label %if.end23.i.i113

if.then18.i.i115:                                 ; preds = %if.end13.i.i108
  %add22.i.i116 = add nuw i64 %100, %add14.i.i110
  store i64 %add22.i.i116, ptr @memory_MAXMEM, align 8
  br label %if.end23.i.i113

if.end23.i.i113:                                  ; preds = %if.then18.i.i115, %if.end13.i.i108
  %add.ptr24.i.i114 = getelementptr inbounds i8, ptr %call4.i, i64 -16
  call void @free(ptr noundef nonnull %add.ptr24.i.i114) #16
  br label %pcheck_ParentNumbersToParents.exit

if.else25.i.i117:                                 ; preds = %pcheck_ParentNumbersToPointersInVector.exit.i
  %idxprom.i.i118 = zext i32 %mul.i88 to i64
  %arrayidx.i33.i = getelementptr inbounds [0 x ptr], ptr @memory_ARRAY, i64 0, i64 %idxprom.i.i118
  %101 = load ptr, ptr %arrayidx.i33.i, align 8
  %total_size.i.i119 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %101, i64 0, i32 4
  %102 = load i32, ptr %total_size.i.i119, align 8
  %conv26.i.i120 = sext i32 %102 to i64
  %103 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i121 = add i64 %103, %conv26.i.i120
  store i64 %add27.i.i121, ptr @memory_FREEDBYTES, align 8
...
pcheck_ParentNumbersToParents.exit:               ; preds = %while.end28, %if.end23.i.i113, %if.else25.i.i117
  ret ptr %call29
}
...
while.body.i:                                     ; preds = %entry, %while.body.i
  ...
  %cmp.i.not.i = icmp eq ptr %Clauses.addr.0.val.i, null
  br i1 %cmp.i.not.i, label %pcheck_MaxSplitLevel.exit, label %while.body.i

pcheck_MaxSplitLevel.exit:                        ; preds = %while.body.i
...
while.body:                                       ; preds = %pcheck_MaxSplitLevel.exit, %if.end56
  %ProofRest.0147 = phi ptr [ %Proof, %pcheck_MaxSplitLevel.exit ], [ %ProofRest.0.val, %if.end56 ]
...
while.body.i.i.i.i:                               ; preds = %while.body.i.i.i.i.preheader, %while.body.i.i.i.i
  ...
  br i1 %cmp.i.not.i.i.i.i, label %pcheck_ClauseIsFromSplit.exit, label %while.body.i.i.i.i
...
while.body.i.i.i:                                 ; preds = %while.body.i.i.i.preheader, %while.body.i.i.i
  ...
  br i1 %cmp.i.not.i.i.i118, label %pcheck_ClauseIsFromLeftSplit.exit, label %while.body.i.i.i
...
if.end56:                                         ; preds = %if.end50
  ...
  br i1 %cmp.i111.not, label %while.end, label %while.body
...
clause_RemoveFlag.exit.i:                         ; preds = %if.then.i.i, %for.body.i
  ...
  br i1 %cmp.i.not.i60, label %pcheck_ClauseListRemoveFlag.exit, label %for.body.i
...
pcheck_ClauseListRemoveFlag.exit:                 ; preds = %clause_RemoveFlag.exit.i, %list_Delete.exit
  ...
  br i1 %cmp.i.not5.i61, label %list_Delete.exit69, label %while.body.i62

while.body.i62:                                   ; preds = %pcheck_ClauseListRemoveFlag.exit, %while.body.i62
  %Current.06.i63 = phi ptr [ %Current.0.val.i64, %while.body.i62 ], [ %27, %pcheck_ClauseListRemoveFlag.exit ]
  ...
  %total_size.i.i.i65 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %29, i64 0, i32 4
  %30 = load i32, ptr %total_size.i.i.i65, align 8
  %conv26.i.i.i66 = sext i32 %30 to i64
  %31 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i67 = add i64 %31, %conv26.i.i.i66
  store i64 %add27.i.i.i67, ptr @memory_FREEDBYTES, align 8
  %32 = load ptr, ptr %29, align 8
  store ptr %32, ptr %Current.06.i63, align 8
  %33 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i63, ptr %33, align 8
  %cmp.i.not.i68 = icmp eq ptr %Current.0.val.i64, null
  br i1 %cmp.i.not.i68, label %list_Delete.exit69, label %while.body.i62

list_Delete.exit69:                               ; preds = %while.body.i62, %pcheck_ClauseListRemoveFlag.exit
  %34 = load ptr, ptr %EmptyClauses, align 8
  %cmp.i.not5.i70 = icmp eq ptr %34, null
  br i1 %cmp.i.not5.i70, label %list_Delete.exit78, label %while.body.i71

while.body.i71:                                   ; preds = %list_Delete.exit69, %while.body.i71
  %Current.06.i72 = phi ptr [ %Current.0.val.i73, %while.body.i71 ], [ %34, %list_Delete.exit69 ]
  %Current.0.val.i73 = load ptr, ptr %Current.06.i72, align 8
  %35 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i74 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %35, i64 0, i32 4
  %36 = load i32, ptr %total_size.i.i.i74, align 8
  %conv26.i.i.i75 = sext i32 %36 to i64
  %37 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i76 = add i64 %37, %conv26.i.i.i75
  store i64 %add27.i.i.i76, ptr @memory_FREEDBYTES, align 8
  %38 = load ptr, ptr %35, align 8
  store ptr %38, ptr %Current.06.i72, align 8
  %39 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i72, ptr %39, align 8
  %cmp.i.not.i77 = icmp eq ptr %Current.0.val.i73, null
  br i1 %cmp.i.not.i77, label %list_Delete.exit78, label %while.body.i71

list_Delete.exit78:                               ; preds = %while.body.i71, %list_Delete.exit69
...
while.body.i.i:                                   ; preds = %land.lhs.true, %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i, label %pcheck_MaxParentSplitLevel.exit.loopexit, label %while.body.i.i

pcheck_MaxParentSplitLevel.exit.loopexit:         ; preds = %while.body.i.i
...
if.then13:                                        ; preds = %pcheck_MaxParentSplitLevel.exit.loopexit
  %6 = load ptr, ptr @stdout, align 8
...
for.inc:                                          ; preds = %for.body, %land.lhs.true, %pcheck_MaxParentSplitLevel.exit.loopexit
...
while.body.i.preheader.i.i:                       ; preds = %if.end.i.i, %if.then.i.i, %clause_IsEmptyClause.exit.i.i, %land.lhs.true1.i.i.i, %land.lhs.true.i.i.i, %land.lhs.true.i.i
  %Ok.019.i.i = phi i1 [ true, %if.end.i.i ], [ true, %land.lhs.true.i.i ], [ true, %land.lhs.true.i.i.i ], [ true, %land.lhs.true1.i.i.i ], [ true, %clause_IsEmptyClause.exit.i.i ], [ %12, %if.then.i.i ]
  br label %while.body.i.i.i
...
while.body.i.i.i:                                 ; preds = %while.body.i.i.i, %while.body.i.preheader.i.i
  ...
  %total_size.i.i.i.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %13, i64 0, i32 4
  %14 = load i32, ptr %total_size.i.i.i.i.i, align 8
  %conv26.i.i.i.i.i = sext i32 %14 to i64
  %15 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i.i = add i64 %15, %conv26.i.i.i.i.i
  store i64 %add27.i.i.i.i.i, ptr @memory_FREEDBYTES, align 8
  %16 = load ptr, ptr %13, align 8
  store ptr %16, ptr %Current.06.i.i.i, align 8
  %17 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i.i, ptr %17, align 8
  %cmp.i.not.i14.i.i = icmp eq ptr %Current.0.val.i.i.i, null
  br i1 %cmp.i.not.i14.i.i, label %pcheck_IsRightSplitHalf.exit.i, label %while.body.i.i.i

pcheck_IsRightSplitHalf.exit.i:                   ; preds = %while.body.i.i.i
  br i1 %Ok.019.i.i, label %if.end.i, label %if.then.i

if.then.i:                                        ; preds = %pcheck_IsRightSplitHalf.exit.i
  %call4.val.i = load ptr, ptr %T.val81.i, align 8
  %T.val80.i = load ptr, ptr %4, align 8
  %18 = getelementptr i8, ptr %T.val80.i, i64 8
  %call10.val.i = load ptr, ptr %18, align 8
  %call12.i = tail call fastcc ptr @pcheck_ClauseToTerm(ptr noundef %call10.val.i)
  %19 = load i32, ptr @fol_OR, align 4
  ...
  %call16.i = tail call ptr @term_Create(i32 noundef %19, ptr noundef nonnull %call.i.i) #16
  ...
  %call20.i = tail call ptr @term_Create(i32 noundef %20, ptr noundef nonnull %call.i85.i) #16
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.i.preheader.i
  ...
  %21 = getelementptr i8, ptr %Clauses.addr.011.i.i, i64 8
  %Clauses.addr.0.val9.i.i = load ptr, ptr %21, align 8
  ...
  %Clauses.addr.0.val.i.i = load ptr, ptr %Clauses.addr.011.i.i, align 8
  %cmp.i.not.i.i = icmp eq ptr %Clauses.addr.0.val.i.i, null
  br i1 %cmp.i.not.i.i, label %pcheck_ClauseListToTermList.exit.i, label %for.body.i.i
...
while.body.i.i.preheader:                         ; preds = %pcheck_ClauseListToTermList.exit.i
  ...
  %total_size.i.i.i.i77 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %22, i64 0, i32 4
  %23 = load i32, ptr %total_size.i.i.i.i77, align 8
  %conv26.i.i.i.i78 = sext i32 %23 to i64
  %24 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i79 = add i64 %24, %conv26.i.i.i.i78
  store i64 %add27.i.i.i.i79, ptr @memory_FREEDBYTES, align 8
  %25 = load ptr, ptr %22, align 8
  store ptr %25, ptr %call.i.i92.i, align 8
  %26 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %call.i.i92.i, ptr %26, align 8
  br label %if.end39.i

if.else.i:                                        ; preds = %pcheck_ClauseListToTermList.exit.i
  %27 = load i32, ptr @fol_AND, align 4
  %call38.i = tail call ptr @term_Create(i32 noundef %27, ptr noundef nonnull %call.i.i92.i) #16
  br label %if.end39.i
...
if.end39.i:                                       ; preds = %while.body.i.i.preheader, %if.else.i
  ...
  %call42.i = tail call ptr @term_Create(i32 noundef %28, ptr noundef nonnull %call.i.i97.i) #16
  ...
  %call46.i = tail call ptr @term_Create(i32 noundef %29, ptr noundef nonnull %call.i101.i) #16
  ...
  %30 = getelementptr i8, ptr %T.val79.i, i64 8
  %call48.val.i = load ptr, ptr %30, align 8
...
for.body:                                         ; preds = %if.end4, %for.inc
  ...
  %31 = getelementptr i8, ptr %Scan.083, i64 8
  %Scan.0.val52 = load ptr, ptr %31, align 8
  %32 = getelementptr i8, ptr %Scan.0.val52, i64 76
  %call8.val55 = load i32, ptr %32, align 4
  %cmp.i62.not = icmp eq i32 %call8.val55, 15
  br i1 %cmp.i62.not, label %for.inc, label %land.lhs.true

land.lhs.true:                                    ; preds = %for.body
  %33 = getelementptr i8, ptr %Scan.0.val52, i64 32
  %call8.val53 = load ptr, ptr %33, align 8
...
for.body.i:                                       ; preds = %if.then14, %for.body.i
  ...
  %34 = getelementptr i8, ptr %Clauses.addr.011.i, i64 8
  %Clauses.addr.0.val9.i = load ptr, ptr %34, align 8
  ...
  br i1 %cmp.i.not.i69, label %while.body.i, label %for.body.i
...
while.body.i:                                     ; preds = %for.body.i, %while.body.i
  ...
  br i1 %cmp.i.not.i70, label %list_Delete.exit, label %while.body.i
...
for.end:                                          ; preds = %for.inc, %if.end4
  ...
  %40 = getelementptr i8, ptr %T.tr85, i64 32
  %T.val56 = load ptr, ptr %40, align 8
...
while.body.i:                                     ; preds = %if.then15, %while.body.i
  ...
  %cmp.i.not.i = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i, label %if.end19, label %while.body.i
...
for.inc.i:                                        ; preds = %land.rhs.i
  ...
  br i1 %cmp.not.i, label %for.end.loopexit.i, label %land.rhs.i
...
clause_RemoveFlag.exit.i:                         ; preds = %if.then.i.i, %for.body.i
  ...
  br i1 %cmp.i.not.i10, label %pcheck_ClauseListRemoveFlag.exit, label %for.body.i
...
pcheck_ClauseListRemoveFlag.exit:                 ; preds = %clause_RemoveFlag.exit.i, %list_Delete.exit
  ...
  br i1 %cmp.i.not5.i11, label %list_Delete.exit19, label %while.body.i12

while.body.i12:                                   ; preds = %pcheck_ClauseListRemoveFlag.exit, %while.body.i12
  %Current.06.i13 = phi ptr [ %Current.0.val.i14, %while.body.i12 ], [ %10, %pcheck_ClauseListRemoveFlag.exit ]
  %Current.0.val.i14 = load ptr, ptr %Current.06.i13, align 8
  %11 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i15 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %11, i64 0, i32 4
  %12 = load i32, ptr %total_size.i.i.i15, align 8
  %conv26.i.i.i16 = sext i32 %12 to i64
  %13 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i17 = add i64 %13, %conv26.i.i.i16
  store i64 %add27.i.i.i17, ptr @memory_FREEDBYTES, align 8
  %14 = load ptr, ptr %11, align 8
  store ptr %14, ptr %Current.06.i13, align 8
  %15 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i13, ptr %15, align 8
  %cmp.i.not.i18 = icmp eq ptr %Current.0.val.i14, null
  br i1 %cmp.i.not.i18, label %list_Delete.exit19, label %while.body.i12

list_Delete.exit19:                               ; preds = %while.body.i12, %pcheck_ClauseListRemoveFlag.exit
  ...
  br i1 %cmp.i.not5.i20, label %list_Delete.exit28, label %while.body.i21

while.body.i21:                                   ; preds = %list_Delete.exit19, %while.body.i21
  %Current.06.i22 = phi ptr [ %Current.0.val.i23, %while.body.i21 ], [ %17, %list_Delete.exit19 ]
  ...
  %total_size.i.i.i24 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %18, i64 0, i32 4
  %19 = load i32, ptr %total_size.i.i.i24, align 8
  %conv26.i.i.i25 = sext i32 %19 to i64
  %20 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i26 = add i64 %20, %conv26.i.i.i25
  store i64 %add27.i.i.i26, ptr @memory_FREEDBYTES, align 8
  %21 = load ptr, ptr %18, align 8
  store ptr %21, ptr %Current.06.i22, align 8
  %22 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i22, ptr %22, align 8
  %cmp.i.not.i27 = icmp eq ptr %Current.0.val.i23, null
  br i1 %cmp.i.not.i27, label %list_Delete.exit28, label %while.body.i21

list_Delete.exit28:                               ; preds = %while.body.i21, %list_Delete.exit19
...
if.end:                                           ; preds = %if.then, %while.body
  ...
  br i1 %cmp.i30.not51, label %while.body.i33.preheader, label %for.body
...
for.body:                                         ; preds = %if.end, %for.body
  ...
  br i1 %cmp.i30.not, label %for.end, label %for.body
...
for.end:                                          ; preds = %for.body
  ...
  br i1 %cmp.i.not5.i, label %while.body.i33.preheader, label %while.body.i
...
while.body.i:                                     ; preds = %for.end, %while.body.i
  ...
  %cmp.i.not.i = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i, label %while.body.i33.preheader, label %while.body.i

while.body.i33.preheader:                         ; preds = %while.body.i, %if.end, %for.end
  br label %while.body.i33

while.body.i33:                                   ; preds = %while.body.i33.preheader, %while.body.i33
  %Current.06.i34 = phi ptr [ %Current.0.val.i35, %while.body.i33 ], [ %Scan1.0.val25, %while.body.i33.preheader ]
  %Current.0.val.i35 = load ptr, ptr %Current.06.i34, align 8
  %10 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i36 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %10, i64 0, i32 4
  %11 = load i32, ptr %total_size.i.i.i36, align 8
  %conv26.i.i.i37 = sext i32 %11 to i64
  %12 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i38 = add i64 %12, %conv26.i.i.i37
  store i64 %add27.i.i.i38, ptr @memory_FREEDBYTES, align 8
  %13 = load ptr, ptr %10, align 8
  store ptr %13, ptr %Current.06.i34, align 8
  %14 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i34, ptr %14, align 8
  %cmp.i.not.i39 = icmp eq ptr %Current.0.val.i35, null
  br i1 %cmp.i.not.i39, label %list_Delete.exit40, label %while.body.i33

list_Delete.exit40:                               ; preds = %while.body.i33
  %Scan1.0.val = load ptr, ptr %Scan1.054, align 8
  %cmp.i.not = icmp eq ptr %Scan1.0.val, null
  br i1 %cmp.i.not, label %while.body.i42, label %while.body

while.body.i42:                                   ; preds = %list_Delete.exit40, %while.body.i42
  %Current.06.i43 = phi ptr [ %Current.0.val.i44, %while.body.i42 ], [ %Proof, %list_Delete.exit40 ]
  %Current.0.val.i44 = load ptr, ptr %Current.06.i43, align 8
  %15 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i45 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %15, i64 0, i32 4
  %16 = load i32, ptr %total_size.i.i.i45, align 8
  %conv26.i.i.i46 = sext i32 %16 to i64
  %17 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i47 = add i64 %17, %conv26.i.i.i46
  store i64 %add27.i.i.i47, ptr @memory_FREEDBYTES, align 8
  %18 = load ptr, ptr %15, align 8
  store ptr %18, ptr %Current.06.i43, align 8
  %19 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i43, ptr %19, align 8
  %cmp.i.not.i48 = icmp eq ptr %Current.0.val.i44, null
  br i1 %cmp.i.not.i48, label %list_Delete.exit49, label %while.body.i42

list_Delete.exit49:                               ; preds = %while.body.i42, %entry
  ret void
}
...
for.inc:                                          ; preds = %land.rhs
  ...
  br i1 %cmp.not, label %for.end.loopexit, label %land.rhs
...
entry:
  ...
  %and.i = lshr i32 %C.val, 6
  %and.i.lobit = and i32 %and.i, 1
  %lnot.ext = xor i32 %and.i.lobit, 1
  ret i32 %lnot.ext
}
...
for.cond.loopexit:                                ; preds = %for.inc, %for.inc.us, %for.body
  ...
  br i1 %cmp.i106.not, label %for.end35, label %for.body
...
for.inc.us:                                       ; preds = %for.body12.us
  ...
  br i1 %cmp.i108.not.us, label %for.cond.loopexit, label %for.body12.us
...
while.body.i.i.i:                                 ; preds = %land.lhs.true19, %while.body.i.i.i
  ...
  br i1 %cmp.i.not.i.i.i, label %pcheck_ClauseIsFromLeftSplit.exit, label %while.body.i.i.i
...
for.inc:                                          ; preds = %lor.lhs.false, %if.then24
  ...
  br i1 %cmp.i108.not, label %for.cond.loopexit, label %for.body12
