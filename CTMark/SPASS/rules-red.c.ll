; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/rules-red.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/rules-red.c"
...
@.str.16 = private unnamed_addr constant [60 x i8] c"/home/npopov/repos/llvm-test-suite/CTMark/SPASS/rules-red.c\00", align 1
...
entry:
  %call = tail call i32 @term_GetStampID() #12
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %Redundant) #12
  store ptr null, ptr %Redundant, align 8
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %Copy.i) #12
  ...
  br i1 %tobool6.not.i, label %if.end.i, label %entry.red_StaticReductions.exit.thread70_crit_edge

entry.red_StaticReductions.exit.thread70_crit_edge: ; preds = %entry
  %.pre.pre = load ptr, ptr %Clause.addr, align 8
...
if.then21.i:                                      ; preds = %if.end18.i
  ...
  br i1 %or.cond.i.i, label %red_ForwardSubsumption.exit.thread.i, label %red_ForwardSubsumption.exit.i

red_ForwardSubsumption.exit.thread.i:             ; preds = %if.then21.i
  %14 = load ptr, ptr @stdout, align 8
  %15 = tail call i64 @fwrite(ptr nonnull @.str.25, i64 15, i64 1, ptr %14)
  tail call void @clause_Print(ptr noundef %12) #12
  %call.val.i.i = load i32, ptr %call.i.i, align 8
  %16 = getelementptr i8, ptr %call.i.i, i64 12
  %call.val12.i.i = load i32, ptr %16, align 4
...
if.end27.i:                                       ; preds = %red_ForwardSubsumption.exit.i, %if.end18.i
  ...
  %17 = load i32, ptr %arrayidx.i204.i, align 4
...
land.lhs.true30.i:                                ; preds = %if.end27.i
  ...
  %Search.val198.i = load i32, ptr %19, align 4
  %call32.i = call fastcc i32 @red_RewriteRedClause(ptr noundef %18, ptr noundef %cond.i, ptr noundef nonnull %Search.val.i, ptr noundef %Search.val190.i, ptr noundef nonnull %Copy.i, i32 noundef %Search.val198.i)
...
lor.lhs.false.i:                                  ; preds = %land.lhs.true30.i, %if.end27.i
  ...
  %20 = load i32, ptr %arrayidx.i205.i, align 4
...
land.lhs.true36.i:                                ; preds = %lor.lhs.false.i
  %21 = load ptr, ptr %Clause.addr, align 8
  %22 = getelementptr i8, ptr %Search, i64 132
  %Search.val197.i = load i32, ptr %22, align 4
  %call38.i = call fastcc i32 @red_ContextualRewriting(ptr noundef nonnull %Search, ptr noundef %21, i32 noundef %Mode, i32 noundef %Search.val197.i, ptr noundef nonnull %Copy.i), !range !5
  %tobool39.not.i = icmp eq i32 %call38.i, 0
  br i1 %tobool39.not.i, label %if.end58.i, label %if.then40.i

if.then40.i:                                      ; preds = %land.lhs.true36.i, %land.lhs.true30.i
  %23 = phi ptr [ %21, %land.lhs.true36.i ], [ %18, %land.lhs.true30.i ]
  %24 = load ptr, ptr %Copy.i, align 8
  %tobool.not.i206.i = icmp eq ptr %24, null
  br i1 %tobool.not.i206.i, label %red_ExchangeClauses.exit210.i, label %if.then.i207.i

if.then.i207.i:                                   ; preds = %if.then40.i
  %25 = load ptr, ptr %Redundant, align 8
  %call.i.i208.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i209.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i208.i, i64 0, i32 1
  store ptr %23, ptr %car.i.i209.i, align 8
  store ptr %25, ptr %call.i.i208.i, align 8
  store ptr %call.i.i208.i, ptr %Redundant, align 8
  store ptr %24, ptr %Clause.addr, align 8
  store ptr null, ptr %Copy.i, align 8
  br label %red_ExchangeClauses.exit210.i

red_ExchangeClauses.exit210.i:                    ; preds = %if.then.i207.i, %if.then40.i
  ...
  %.pre.pre76 = load ptr, ptr %Clause.addr, align 8
...
if.end44.i:                                       ; preds = %red_ExchangeClauses.exit210.i
  %cmp.not.i211.i = icmp eq ptr %.pre.pre76, null
  br i1 %cmp.not.i211.i, label %if.end48.i, label %land.lhs.true.i212.i

land.lhs.true.i212.i:                             ; preds = %if.end44.i
  %26 = getelementptr i8, ptr %.pre.pre76, i64 68
  %C.val.i213.i = load i32, ptr %26, align 4
  %cmp.i.not.i214.i = icmp eq i32 %C.val.i213.i, 0
  br i1 %cmp.i.not.i214.i, label %land.lhs.true1.i216.i, label %if.end48.i

land.lhs.true1.i216.i:                            ; preds = %land.lhs.true.i212.i
  %27 = getelementptr i8, ptr %.pre.pre76, i64 72
  %C.val9.i217.i = load i32, ptr %27, align 8
  %cmp.i11.not.i218.i = icmp eq i32 %C.val9.i217.i, 0
  br i1 %cmp.i11.not.i218.i, label %clause_IsEmptyClause.exit223.i, label %if.end48.i

clause_IsEmptyClause.exit223.i:                   ; preds = %land.lhs.true1.i216.i
  %28 = getelementptr i8, ptr %.pre.pre76, i64 64
  %C.val10.i220.i = load i32, ptr %28, align 8
  %cmp.i13.i221.not.i = icmp eq i32 %C.val10.i220.i, 0
  br i1 %cmp.i13.i221.not.i, label %red_StaticReductions.exit.thread, label %if.end48.i

if.end48.i:                                       ; preds = %clause_IsEmptyClause.exit223.i, %land.lhs.true1.i216.i, %land.lhs.true.i212.i, %if.end44.i
  %29 = load i32, ptr %arrayidx.i202.i, align 4
  %tobool50.not.i = icmp eq i32 %29, 0
  br i1 %tobool50.not.i, label %if.end58.i, label %if.then51.i

if.then51.i:                                      ; preds = %if.end48.i
  %call.i = tail call fastcc ptr @red_ForwardSubsumer(ptr noundef %.pre.pre76, ptr noundef %cond.i)
  %arrayidx.i.i61 = getelementptr inbounds i32, ptr %Search.val.i, i64 12
  %30 = load i32, ptr %arrayidx.i.i61, align 4
...
red_ForwardSubsumption.exit.thread:               ; preds = %if.then51.i
  %31 = load ptr, ptr @stdout, align 8
  %32 = tail call i64 @fwrite(ptr nonnull @.str.25, i64 15, i64 1, ptr %31)
  tail call void @clause_Print(ptr noundef %.pre.pre76) #12
  %call.val.i = load i32, ptr %call.i, align 8
  %33 = getelementptr i8, ptr %call.i, i64 12
  %call.val12.i = load i32, ptr %33, align 4
...
if.end58.i:                                       ; preds = %red_ForwardSubsumption.exit, %if.end48.i, %land.lhs.true36.i, %lor.lhs.false.i
  br i1 %cmp.i.i, label %if.end58.i.if.end73.i_crit_edge, label %land.lhs.true61.i

if.end58.i.if.end73.i_crit_edge:                  ; preds = %if.end58.i
  %.pre75.pre.pre79.pre.pre.pre.pre = load ptr, ptr %Clause.addr, align 8
  br label %if.end73.i

land.lhs.true61.i:                                ; preds = %if.end58.i
  %arrayidx.i227.i = getelementptr inbounds i32, ptr %Search.val.i, i64 90
  %34 = load i32, ptr %arrayidx.i227.i, align 4
  %tobool63.not.i = icmp eq i32 %34, 0
  %.pre75.pre.pre79.pre.pre.pre.pre84 = load ptr, ptr %Clause.addr, align 8
  br i1 %tobool63.not.i, label %if.end73.i, label %if.then64.i

if.then64.i:                                      ; preds = %land.lhs.true61.i
  %35 = getelementptr i8, ptr %Search, i64 80
  %Search.val199.i = load ptr, ptr %35, align 8
  %36 = getelementptr i8, ptr %Search, i64 132
  %Search.val196.i = load i32, ptr %36, align 4
  %arrayidx.i228.i = getelementptr inbounds i32, ptr %Search.val.i, i64 9
  %37 = load i32, ptr %arrayidx.i228.i, align 4
  %call68.i = call fastcc i32 @red_SortSimplification(ptr noundef %Search.val199.i, ptr noundef %.pre75.pre.pre79.pre.pre.pre.pre84, i32 noundef %Search.val196.i, i32 noundef %37, ptr noundef nonnull %Search.val.i, ptr noundef %Search.val190.i, ptr noundef nonnull %Copy.i), !range !5
  %38 = load ptr, ptr %Copy.i, align 8
  %tobool.not.i229.i = icmp eq ptr %38, null
...
red_ExchangeClauses.exit233.thread.i:             ; preds = %if.then64.i
  %39 = load ptr, ptr %Redundant, align 8
  %call.i.i231.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i232.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i231.i, i64 0, i32 1
  store ptr %.pre75.pre.pre79.pre.pre.pre.pre84, ptr %car.i.i232.i, align 8
  store ptr %39, ptr %call.i.i231.i, align 8
  store ptr %call.i.i231.i, ptr %Redundant, align 8
  store ptr %38, ptr %Clause.addr, align 8
  store ptr null, ptr %Copy.i, align 8
  br label %land.lhs.true.i235.i

red_ExchangeClauses.exit233.i:                    ; preds = %if.then64.i
  %cmp.not.i234.i = icmp eq ptr %.pre75.pre.pre79.pre.pre.pre.pre84, null
  br i1 %cmp.not.i234.i, label %if.end73.i, label %land.lhs.true.i235.i

land.lhs.true.i235.i:                             ; preds = %red_ExchangeClauses.exit233.i, %red_ExchangeClauses.exit233.thread.i
  %40 = phi ptr [ %38, %red_ExchangeClauses.exit233.thread.i ], [ %.pre75.pre.pre79.pre.pre.pre.pre84, %red_ExchangeClauses.exit233.i ]
  %41 = getelementptr i8, ptr %40, i64 68
  %C.val.i236.i = load i32, ptr %41, align 4
  %cmp.i.not.i237.i = icmp eq i32 %C.val.i236.i, 0
  br i1 %cmp.i.not.i237.i, label %land.lhs.true1.i239.i, label %if.end73.i

land.lhs.true1.i239.i:                            ; preds = %land.lhs.true.i235.i
  %42 = getelementptr i8, ptr %40, i64 72
  %C.val9.i240.i = load i32, ptr %42, align 8
  %cmp.i11.not.i241.i = icmp eq i32 %C.val9.i240.i, 0
  br i1 %cmp.i11.not.i241.i, label %clause_IsEmptyClause.exit246.i, label %if.end73.i

clause_IsEmptyClause.exit246.i:                   ; preds = %land.lhs.true1.i239.i
  %43 = getelementptr i8, ptr %40, i64 64
  %C.val10.i243.i = load i32, ptr %43, align 8
  %cmp.i13.i244.not.i = icmp eq i32 %C.val10.i243.i, 0
  br i1 %cmp.i13.i244.not.i, label %red_StaticReductions.exit.thread, label %if.end73.i

if.end73.i:                                       ; preds = %if.end58.i.if.end73.i_crit_edge, %clause_IsEmptyClause.exit246.i, %land.lhs.true1.i239.i, %land.lhs.true.i235.i, %red_ExchangeClauses.exit233.i, %land.lhs.true61.i
  %.pre75.pre.pre79.pre.pre.pre = phi ptr [ %.pre75.pre.pre79.pre.pre.pre.pre, %if.end58.i.if.end73.i_crit_edge ], [ %40, %clause_IsEmptyClause.exit246.i ], [ %40, %land.lhs.true1.i239.i ], [ %40, %land.lhs.true.i235.i ], [ null, %red_ExchangeClauses.exit233.i ], [ %.pre75.pre.pre79.pre.pre.pre.pre84, %land.lhs.true61.i ]
  %arrayidx.i247.i = getelementptr inbounds i32, ptr %Search.val.i, i64 83
  %44 = load i32, ptr %arrayidx.i247.i, align 4
  %tobool75.not.i = icmp eq i32 %44, 0
  br i1 %tobool75.not.i, label %if.end83.i, label %if.then76.i

if.then76.i:                                      ; preds = %if.end73.i
  %45 = getelementptr i8, ptr %Search, i64 132
  %Search.val195.i = load i32, ptr %45, align 4
  call fastcc void @red_MatchingReplacementResolution(ptr noundef %.pre75.pre.pre79.pre.pre.pre, ptr noundef %cond.i, ptr noundef nonnull %Search.val.i, ptr noundef %Search.val190.i, ptr noundef nonnull %Copy.i, i32 noundef %Search.val195.i)
  %46 = load ptr, ptr %Copy.i, align 8
  %tobool.not.i248.i = icmp eq ptr %46, null
...
red_ExchangeClauses.exit252.thread.i:             ; preds = %if.then76.i
  %47 = load ptr, ptr %Redundant, align 8
  %call.i.i250.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i251.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i250.i, i64 0, i32 1
  store ptr %.pre75.pre.pre79.pre.pre.pre, ptr %car.i.i251.i, align 8
  store ptr %47, ptr %call.i.i250.i, align 8
  store ptr %call.i.i250.i, ptr %Redundant, align 8
  store ptr %46, ptr %Clause.addr, align 8
  store ptr null, ptr %Copy.i, align 8
  br label %land.lhs.true.i254.i

red_ExchangeClauses.exit252.i:                    ; preds = %if.then76.i
  %cmp.not.i253.i = icmp eq ptr %.pre75.pre.pre79.pre.pre.pre, null
  br i1 %cmp.not.i253.i, label %if.end83.i, label %land.lhs.true.i254.i

land.lhs.true.i254.i:                             ; preds = %red_ExchangeClauses.exit252.i, %red_ExchangeClauses.exit252.thread.i
  %48 = phi ptr [ %46, %red_ExchangeClauses.exit252.thread.i ], [ %.pre75.pre.pre79.pre.pre.pre, %red_ExchangeClauses.exit252.i ]
  %49 = getelementptr i8, ptr %48, i64 68
  %C.val.i255.i = load i32, ptr %49, align 4
  %cmp.i.not.i256.i = icmp eq i32 %C.val.i255.i, 0
  br i1 %cmp.i.not.i256.i, label %land.lhs.true1.i258.i, label %if.end83.i

land.lhs.true1.i258.i:                            ; preds = %land.lhs.true.i254.i
  %50 = getelementptr i8, ptr %48, i64 72
  %C.val9.i259.i = load i32, ptr %50, align 8
  %cmp.i11.not.i260.i = icmp eq i32 %C.val9.i259.i, 0
  br i1 %cmp.i11.not.i260.i, label %clause_IsEmptyClause.exit265.i, label %if.end83.i

clause_IsEmptyClause.exit265.i:                   ; preds = %land.lhs.true1.i258.i
  %51 = getelementptr i8, ptr %48, i64 64
  %C.val10.i262.i = load i32, ptr %51, align 8
  %cmp.i13.i263.not.i = icmp eq i32 %C.val10.i262.i, 0
  br i1 %cmp.i13.i263.not.i, label %red_StaticReductions.exit.thread, label %if.end83.i

if.end83.i:                                       ; preds = %clause_IsEmptyClause.exit265.i, %land.lhs.true1.i258.i, %land.lhs.true.i254.i, %red_ExchangeClauses.exit252.i, %if.end73.i
  %.pre75.pre.pre79.pre.pre = phi ptr [ %48, %clause_IsEmptyClause.exit265.i ], [ %48, %land.lhs.true1.i258.i ], [ %48, %land.lhs.true.i254.i ], [ null, %red_ExchangeClauses.exit252.i ], [ %.pre75.pre.pre79.pre.pre.pre, %if.end73.i ]
  %arrayidx.i266.i = getelementptr inbounds i32, ptr %Search.val.i, i64 86
  %52 = load i32, ptr %arrayidx.i266.i, align 4
  %tobool85.not.i = icmp eq i32 %52, 0
  br i1 %tobool85.not.i, label %if.end93.i, label %if.then86.i

if.then86.i:                                      ; preds = %if.end83.i
  %53 = getelementptr i8, ptr %Search, i64 132
  %Search.val194.i = load i32, ptr %53, align 4
  call fastcc void @red_UnitConflict(ptr noundef %.pre75.pre.pre79.pre.pre, ptr noundef %cond.i, ptr noundef nonnull %Search.val.i, ptr noundef %Search.val190.i, ptr noundef nonnull %Copy.i, i32 noundef %Search.val194.i)
  %54 = load ptr, ptr %Copy.i, align 8
  %tobool.not.i267.i = icmp eq ptr %54, null
...
red_ExchangeClauses.exit271.thread.i:             ; preds = %if.then86.i
  %55 = load ptr, ptr %Redundant, align 8
  %call.i.i269.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i270.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i269.i, i64 0, i32 1
  store ptr %.pre75.pre.pre79.pre.pre, ptr %car.i.i270.i, align 8
  store ptr %55, ptr %call.i.i269.i, align 8
  store ptr %call.i.i269.i, ptr %Redundant, align 8
  store ptr %54, ptr %Clause.addr, align 8
  br label %land.lhs.true.i273.i

red_ExchangeClauses.exit271.i:                    ; preds = %if.then86.i
  %cmp.not.i272.i = icmp eq ptr %.pre75.pre.pre79.pre.pre, null
  br i1 %cmp.not.i272.i, label %if.end93.i, label %land.lhs.true.i273.i

land.lhs.true.i273.i:                             ; preds = %red_ExchangeClauses.exit271.i, %red_ExchangeClauses.exit271.thread.i
  %56 = phi ptr [ %54, %red_ExchangeClauses.exit271.thread.i ], [ %.pre75.pre.pre79.pre.pre, %red_ExchangeClauses.exit271.i ]
  %57 = getelementptr i8, ptr %56, i64 68
  %C.val.i274.i = load i32, ptr %57, align 4
  %cmp.i.not.i275.i = icmp eq i32 %C.val.i274.i, 0
  br i1 %cmp.i.not.i275.i, label %land.lhs.true1.i277.i, label %if.end93.i

land.lhs.true1.i277.i:                            ; preds = %land.lhs.true.i273.i
  %58 = getelementptr i8, ptr %56, i64 72
  %C.val9.i278.i = load i32, ptr %58, align 8
  %cmp.i11.not.i279.i = icmp eq i32 %C.val9.i278.i, 0
  br i1 %cmp.i11.not.i279.i, label %clause_IsEmptyClause.exit284.i, label %if.end93.i

clause_IsEmptyClause.exit284.i:                   ; preds = %land.lhs.true1.i277.i
  %59 = getelementptr i8, ptr %56, i64 64
  %C.val10.i281.i = load i32, ptr %59, align 8
  %cmp.i13.i282.not.i = icmp eq i32 %C.val10.i281.i, 0
  %brmerge.i = or i1 %cmp.i.i, %cmp.i13.i282.not.i
  br i1 %brmerge.i, label %red_StaticReductions.exit.thread, label %land.lhs.true96.i

if.end93.i:                                       ; preds = %land.lhs.true1.i277.i, %land.lhs.true.i273.i, %red_ExchangeClauses.exit271.i, %if.end83.i
  %.pre75.pre.pre79.pre = phi ptr [ %56, %land.lhs.true1.i277.i ], [ %56, %land.lhs.true.i273.i ], [ null, %red_ExchangeClauses.exit271.i ], [ %.pre75.pre.pre79.pre.pre, %if.end83.i ]
...
land.lhs.true96.i:                                ; preds = %if.end93.i, %clause_IsEmptyClause.exit284.i
  %.pre75.pre.pre79 = phi ptr [ %.pre75.pre.pre79.pre, %if.end93.i ], [ %56, %clause_IsEmptyClause.exit284.i ]
  %arrayidx.i287.i = getelementptr inbounds i32, ptr %Search.val.i, i64 89
  %60 = load i32, ptr %arrayidx.i287.i, align 4
  %tobool98.not.i = icmp eq i32 %60, 0
  br i1 %tobool98.not.i, label %red_StaticReductions.exit.thread, label %red_StaticReductions.exit

red_StaticReductions.exit.thread:                 ; preds = %if.end93.i, %clause_IsEmptyClause.exit.i, %clause_IsEmptyClause.exit223.i, %clause_IsEmptyClause.exit246.i, %clause_IsEmptyClause.exit265.i, %clause_IsEmptyClause.exit284.i, %land.lhs.true96.i
  %.pre75.pre = phi ptr [ %7, %clause_IsEmptyClause.exit.i ], [ %.pre.pre76, %clause_IsEmptyClause.exit223.i ], [ %40, %clause_IsEmptyClause.exit246.i ], [ %48, %clause_IsEmptyClause.exit265.i ], [ %56, %clause_IsEmptyClause.exit284.i ], [ %.pre75.pre.pre79, %land.lhs.true96.i ], [ %.pre75.pre.pre79.pre, %if.end93.i ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %Copy.i) #12
  br label %if.else16

red_StaticReductions.exit.thread70:               ; preds = %entry.red_StaticReductions.exit.thread70_crit_edge, %red_ForwardSubsumption.exit.i, %red_ExchangeClauses.exit210.i, %red_ForwardSubsumption.exit, %red_ForwardSubsumption.exit.thread.i, %red_ForwardSubsumption.exit.thread
  %.pre = phi ptr [ %.pre.pre76, %red_ForwardSubsumption.exit.thread ], [ %.pre.pre, %entry.red_StaticReductions.exit.thread70_crit_edge ], [ %12, %red_ForwardSubsumption.exit.i ], [ %12, %red_ForwardSubsumption.exit.thread.i ], [ %.pre.pre76, %red_ExchangeClauses.exit210.i ], [ %.pre.pre76, %red_ForwardSubsumption.exit ]
  %RedClause.2.ph = phi ptr [ %call.i, %red_ForwardSubsumption.exit.thread ], [ null, %entry.red_StaticReductions.exit.thread70_crit_edge ], [ %call.i.i, %red_ForwardSubsumption.exit.i ], [ %call.i.i, %red_ForwardSubsumption.exit.thread.i ], [ null, %red_ExchangeClauses.exit210.i ], [ %call.i, %red_ForwardSubsumption.exit ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %Copy.i) #12
  br label %if.then

red_StaticReductions.exit:                        ; preds = %land.lhs.true96.i
  %61 = getelementptr i8, ptr %Search, i64 64
  %Search.val200.i = load ptr, ptr %61, align 8
  %call101.i = tail call i32 @red_ClauseDeletion(ptr noundef %Search.val200.i, ptr noundef %.pre75.pre.pre79, ptr noundef nonnull %Search.val.i, ptr noundef %Search.val190.i), !range !5
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %Copy.i) #12
...
if.then:                                          ; preds = %red_StaticReductions.exit.thread70, %red_StaticReductions.exit
  %62 = phi ptr [ %.pre, %red_StaticReductions.exit.thread70 ], [ %.pre75.pre.pre79, %red_StaticReductions.exit ]
  %RedClause.274 = phi ptr [ %RedClause.2.ph, %red_StaticReductions.exit.thread70 ], [ null, %red_StaticReductions.exit ]
  %63 = load ptr, ptr %Redundant, align 8
  %cmp.i.not28.i = icmp eq ptr %63, null
  br i1 %cmp.i.not28.i, label %list_Delete.exit, label %for.body.lr.ph.i

for.body.lr.ph.i:                                 ; preds = %if.then
  %64 = getelementptr i8, ptr %62, i64 12
  %65 = getelementptr i8, ptr %Search, i64 132
  br label %for.body.i

for.body.i:                                       ; preds = %for.inc.i, %for.body.lr.ph.i
  %Scan.029.i = phi ptr [ %63, %for.body.lr.ph.i ], [ %Scan.0.val24.i, %for.inc.i ]
  %66 = getelementptr i8, ptr %Scan.029.i, i64 8
  %Scan.0.val.i = load ptr, ptr %66, align 8
  %RedClause.val25.i = load i32, ptr %64, align 4
  %67 = getelementptr i8, ptr %Scan.0.val.i, i64 12
  %call1.val.i = load i32, ptr %67, align 4
  %Search.val26.i = load i32, ptr %65, align 4
...
if.then.i:                                        ; preds = %for.body.i
  tail call void @split_KeepClauseAtLevel(ptr noundef nonnull %Search, ptr noundef nonnull %Scan.0.val.i, i32 noundef %RedClause.val25.i) #12
  br label %for.inc.i

if.else.i:                                        ; preds = %for.body.i
  %Search.val.i27 = load ptr, ptr %0, align 8
  %arrayidx.i.i28 = getelementptr inbounds i32, ptr %Search.val.i27, i64 9
  %68 = load i32, ptr %arrayidx.i.i28, align 4
  %tobool10.not.i = icmp eq i32 %68, 0
  br i1 %tobool10.not.i, label %if.else12.i, label %if.then11.i

if.then11.i:                                      ; preds = %if.else.i
  tail call void @prfs_InsertDocProofClause(ptr noundef nonnull %Search, ptr noundef nonnull %Scan.0.val.i) #12
  br label %for.inc.i

if.else12.i:                                      ; preds = %if.else.i
  tail call void @clause_Delete(ptr noundef nonnull %Scan.0.val.i) #12
  br label %for.inc.i
...
while.body.i:                                     ; preds = %for.inc.i, %while.body.i
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i ], [ %63, %for.inc.i ]
  ...
  %total_size.i.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %69, i64 0, i32 4
  %70 = load i32, ptr %total_size.i.i.i, align 8
  %conv26.i.i.i = sext i32 %70 to i64
  %71 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i = add i64 %71, %conv26.i.i.i
  store i64 %add27.i.i.i, ptr @memory_FREEDBYTES, align 8
  %72 = load ptr, ptr %69, align 8
  store ptr %72, ptr %Current.06.i, align 8
  %73 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i, ptr %73, align 8
...
land.lhs.true:                                    ; preds = %list_Delete.exit
  %74 = getelementptr i8, ptr %RedClause.274, i64 12
  %.val25 = load i32, ptr %74, align 4
  %75 = getelementptr i8, ptr %62, i64 12
  %.val24 = load i32, ptr %75, align 4
  %76 = getelementptr i8, ptr %Search, i64 132
  %Search.val26 = load i32, ptr %76, align 4
...
if.then8:                                         ; preds = %land.lhs.true
  tail call void @split_KeepClauseAtLevel(ptr noundef nonnull %Search, ptr noundef nonnull %62, i32 noundef %.val25) #12
  br label %if.end17
...
if.else:                                          ; preds = %land.lhs.true, %list_Delete.exit
  ...
  %tobool12.not = icmp eq i32 %77, 0
  br i1 %tobool12.not, label %if.else14, label %if.then13

if.then13:                                        ; preds = %if.else
  tail call void @prfs_InsertDocProofClause(ptr noundef nonnull %Search, ptr noundef %62) #12
  br label %if.end17

if.else14:                                        ; preds = %if.else
  tail call void @clause_Delete(ptr noundef %62) #12
  br label %if.end17

if.else16:                                        ; preds = %red_StaticReductions.exit.thread, %red_StaticReductions.exit
  %.pre75 = phi ptr [ %.pre75.pre, %red_StaticReductions.exit.thread ], [ %.pre75.pre.pre79, %red_StaticReductions.exit ]
  %78 = load ptr, ptr %Redundant, align 8
  %cmp.i.not28.i30 = icmp eq ptr %78, null
  br i1 %cmp.i.not28.i30, label %if.end17, label %for.body.lr.ph.i31

for.body.lr.ph.i31:                               ; preds = %if.else16
  %79 = getelementptr i8, ptr %.pre75, i64 12
  %80 = getelementptr i8, ptr %Search, i64 132
  br label %for.body.i32

for.body.i32:                                     ; preds = %for.inc.i42, %for.body.lr.ph.i31
  %Scan.029.i33 = phi ptr [ %78, %for.body.lr.ph.i31 ], [ %Scan.0.val24.i43, %for.inc.i42 ]
  %81 = getelementptr i8, ptr %Scan.029.i33, i64 8
  %Scan.0.val.i34 = load ptr, ptr %81, align 8
  %RedClause.val25.i35 = load i32, ptr %79, align 4
  %82 = getelementptr i8, ptr %Scan.0.val.i34, i64 12
  %call1.val.i36 = load i32, ptr %82, align 4
  %Search.val26.i37 = load i32, ptr %80, align 4
  %cmp.i27.i38 = icmp ule i32 %RedClause.val25.i35, %call1.val.i36
  %cmp1.i.i39 = icmp ule i32 %RedClause.val25.i35, %Search.val26.i37
  %.not.i40 = and i1 %cmp.i27.i38, %cmp1.i.i39
  br i1 %.not.i40, label %if.else.i45, label %if.then.i41

if.then.i41:                                      ; preds = %for.body.i32
  tail call void @split_KeepClauseAtLevel(ptr noundef nonnull %Search, ptr noundef nonnull %Scan.0.val.i34, i32 noundef %RedClause.val25.i35) #12
  br label %for.inc.i42

if.else.i45:                                      ; preds = %for.body.i32
  %Search.val.i46 = load ptr, ptr %0, align 8
  %arrayidx.i.i47 = getelementptr inbounds i32, ptr %Search.val.i46, i64 9
  %83 = load i32, ptr %arrayidx.i.i47, align 4
  %tobool10.not.i48 = icmp eq i32 %83, 0
  br i1 %tobool10.not.i48, label %if.else12.i50, label %if.then11.i49

if.then11.i49:                                    ; preds = %if.else.i45
  tail call void @prfs_InsertDocProofClause(ptr noundef nonnull %Search, ptr noundef nonnull %Scan.0.val.i34) #12
  br label %for.inc.i42

if.else12.i50:                                    ; preds = %if.else.i45
  tail call void @clause_Delete(ptr noundef nonnull %Scan.0.val.i34) #12
  br label %for.inc.i42

for.inc.i42:                                      ; preds = %if.else12.i50, %if.then11.i49, %if.then.i41
  %Scan.0.val24.i43 = load ptr, ptr %Scan.029.i33, align 8
  %cmp.i.not.i44 = icmp eq ptr %Scan.0.val24.i43, null
  br i1 %cmp.i.not.i44, label %while.body.i53, label %for.body.i32, !llvm.loop !6

while.body.i53:                                   ; preds = %for.inc.i42, %while.body.i53
  %Current.06.i54 = phi ptr [ %Current.0.val.i55, %while.body.i53 ], [ %78, %for.inc.i42 ]
  ...
  %total_size.i.i.i56 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %84, i64 0, i32 4
  %85 = load i32, ptr %total_size.i.i.i56, align 8
  %conv26.i.i.i57 = sext i32 %85 to i64
  %86 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i58 = add i64 %86, %conv26.i.i.i57
  store i64 %add27.i.i.i58, ptr @memory_FREEDBYTES, align 8
  %87 = load ptr, ptr %84, align 8
  store ptr %87, ptr %Current.06.i54, align 8
  %88 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i54, ptr %88, align 8
  %cmp.i.not.i59 = icmp eq ptr %Current.0.val.i55, null
  br i1 %cmp.i.not.i59, label %if.end17, label %while.body.i53, !llvm.loop !8

if.end17:                                         ; preds = %while.body.i53, %if.then8, %if.else14, %if.then13, %if.else16
  %89 = phi ptr [ %.pre75, %if.else16 ], [ null, %if.then13 ], [ null, %if.else14 ], [ null, %if.then8 ], [ %.pre75, %while.body.i53 ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %Redundant) #12
  ret ptr %89
}
...
entry:
  ...
  %Redundant = alloca ptr, align 8
  store ptr %Clause, ptr %Clause.addr, align 8
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %RedClause) #12
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %Redundant) #12
  store ptr null, ptr %Redundant, align 8
...
if.then8:                                         ; preds = %land.lhs.true
  tail call void @split_KeepClauseAtLevel(ptr noundef nonnull %Search, ptr noundef nonnull %1, i32 noundef %.val25) #12
  br label %if.end17
...
if.then13:                                        ; preds = %if.else
  tail call void @prfs_InsertDocProofClause(ptr noundef nonnull %Search, ptr noundef %1) #12
  br label %if.end17

if.else14:                                        ; preds = %if.else
  tail call void @clause_Delete(ptr noundef %1) #12
  br label %if.end17
...
for.body.i30:                                     ; preds = %for.inc.i40, %for.body.lr.ph.i29
  %Scan.029.i31 = phi ptr [ %0, %for.body.lr.ph.i29 ], [ %Scan.0.val24.i41, %for.inc.i40 ]
  %22 = getelementptr i8, ptr %Scan.029.i31, i64 8
  %Scan.0.val.i32 = load ptr, ptr %22, align 8
  %RedClause.val25.i33 = load i32, ptr %19, align 4
  %23 = getelementptr i8, ptr %Scan.0.val.i32, i64 12
  %call1.val.i34 = load i32, ptr %23, align 4
  %Search.val26.i35 = load i32, ptr %20, align 4
  %cmp.i27.i36 = icmp ule i32 %RedClause.val25.i33, %call1.val.i34
  %cmp1.i.i37 = icmp ule i32 %RedClause.val25.i33, %Search.val26.i35
  %.not.i38 = and i1 %cmp.i27.i36, %cmp1.i.i37
  br i1 %.not.i38, label %if.else.i43, label %if.then.i39

if.then.i39:                                      ; preds = %for.body.i30
  tail call void @split_KeepClauseAtLevel(ptr noundef nonnull %Search, ptr noundef nonnull %Scan.0.val.i32, i32 noundef %RedClause.val25.i33) #12
  br label %for.inc.i40

if.else.i43:                                      ; preds = %for.body.i30
  %Search.val.i44 = load ptr, ptr %21, align 8
  %arrayidx.i.i45 = getelementptr inbounds i32, ptr %Search.val.i44, i64 9
  %24 = load i32, ptr %arrayidx.i.i45, align 4
  %tobool10.not.i46 = icmp eq i32 %24, 0
  br i1 %tobool10.not.i46, label %if.else12.i48, label %if.then11.i47

if.then11.i47:                                    ; preds = %if.else.i43
  tail call void @prfs_InsertDocProofClause(ptr noundef nonnull %Search, ptr noundef nonnull %Scan.0.val.i32) #12
  br label %for.inc.i40

if.else12.i48:                                    ; preds = %if.else.i43
  tail call void @clause_Delete(ptr noundef nonnull %Scan.0.val.i32) #12
  br label %for.inc.i40

for.inc.i40:                                      ; preds = %if.else12.i48, %if.then11.i47, %if.then.i39
  %Scan.0.val24.i41 = load ptr, ptr %Scan.029.i31, align 8
  %cmp.i.not.i42 = icmp eq ptr %Scan.0.val24.i41, null
  br i1 %cmp.i.not.i42, label %while.body.i51, label %for.body.i30, !llvm.loop !6

while.body.i51:                                   ; preds = %for.inc.i40, %while.body.i51
  %Current.06.i52 = phi ptr [ %Current.0.val.i53, %while.body.i51 ], [ %0, %for.inc.i40 ]
  ...
  %total_size.i.i.i54 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %25, i64 0, i32 4
  %26 = load i32, ptr %total_size.i.i.i54, align 8
  %conv26.i.i.i55 = sext i32 %26 to i64
  %27 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i56 = add i64 %27, %conv26.i.i.i55
  store i64 %add27.i.i.i56, ptr @memory_FREEDBYTES, align 8
  %28 = load ptr, ptr %25, align 8
  store ptr %28, ptr %Current.06.i52, align 8
  %29 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i52, ptr %29, align 8
  %cmp.i.not.i57 = icmp eq ptr %Current.0.val.i53, null
  br i1 %cmp.i.not.i57, label %if.end17, label %while.body.i51, !llvm.loop !8

if.end17:                                         ; preds = %while.body.i51, %if.then8, %if.else14, %if.then13, %if.else16
  %30 = phi ptr [ %.pre, %if.else16 ], [ null, %if.then13 ], [ null, %if.else14 ], [ null, %if.then8 ], [ %.pre, %while.body.i51 ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %Redundant) #12
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %RedClause) #12
  ret ptr %30
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %Copy) #12
  %0 = getelementptr i8, ptr %Search, i64 112
  %Search.val = load ptr, ptr %0, align 8
  %1 = getelementptr i8, ptr %Search, i64 104
...
red_ForwardSubsumption.exit.thread:               ; preds = %if.then30
  ...
  tail call void @clause_Print(ptr noundef %16) #12
  %call.val.i = load i32, ptr %call.i, align 8
...
red_ForwardSubsumption.exit392.thread:            ; preds = %if.then39
  ...
  tail call void @clause_Print(ptr noundef %21) #12
  %call.val.i389 = load i32, ptr %call.i383, align 8
  %25 = getelementptr i8, ptr %call.i383, i64 12
  %call.val12.i390 = load i32, ptr %25, align 4
  %call6.i391 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.26, i32 noundef %call.val.i389, i32 noundef %call.val12.i390)
...
if.then65:                                        ; preds = %land.lhs.true61, %land.lhs.true56
  ...
  br i1 %tobool.not.i395, label %red_ExchangeClauses.exit399, label %if.then.i396

if.then.i396:                                     ; preds = %if.then65
  %32 = load ptr, ptr %Clause, align 8
  %33 = load ptr, ptr %Result, align 8
  %call.i.i397 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i398 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i397, i64 0, i32 1
  store ptr %32, ptr %car.i.i398, align 8
  store ptr %33, ptr %call.i.i397, align 8
  store ptr %call.i.i397, ptr %Result, align 8
  store ptr %31, ptr %Clause, align 8
  store ptr null, ptr %Copy, align 8
  br label %red_ExchangeClauses.exit399

red_ExchangeClauses.exit399:                      ; preds = %if.then65, %if.then.i396
...
if.end69:                                         ; preds = %red_ExchangeClauses.exit399
  ...
  br i1 %cmp.not.i400, label %if.end73, label %land.lhs.true.i401

land.lhs.true.i401:                               ; preds = %if.end69
  %35 = getelementptr i8, ptr %34, i64 68
  %C.val.i402 = load i32, ptr %35, align 4
  %cmp.i.not.i403 = icmp eq i32 %C.val.i402, 0
  br i1 %cmp.i.not.i403, label %land.lhs.true1.i405, label %if.end73

land.lhs.true1.i405:                              ; preds = %land.lhs.true.i401
  %36 = getelementptr i8, ptr %34, i64 72
  %C.val9.i406 = load i32, ptr %36, align 8
  %cmp.i11.not.i407 = icmp eq i32 %C.val9.i406, 0
  br i1 %cmp.i11.not.i407, label %clause_IsEmptyClause.exit412, label %if.end73

clause_IsEmptyClause.exit412:                     ; preds = %land.lhs.true1.i405
  %37 = getelementptr i8, ptr %34, i64 64
  %C.val10.i409 = load i32, ptr %37, align 8
  %cmp.i13.i410.not = icmp eq i32 %C.val10.i409, 0
  br i1 %cmp.i13.i410.not, label %cleanup, label %if.end73

if.end73:                                         ; preds = %if.end69, %land.lhs.true.i401, %land.lhs.true1.i405, %clause_IsEmptyClause.exit412
...
red_ForwardSubsumption.exit423.thread:            ; preds = %if.then76
  ...
  tail call void @clause_Print(ptr noundef %39) #12
  %call.val.i420 = load i32, ptr %call.i414, align 8
  %43 = getelementptr i8, ptr %call.i414, i64 12
  %call.val12.i421 = load i32, ptr %43, align 4
  %call6.i422 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.26, i32 noundef %call.val.i420, i32 noundef %call.val12.i421)
...
red_ForwardSubsumption.exit433.thread:            ; preds = %if.then84
  ...
  tail call void @clause_Print(ptr noundef %44) #12
  %call.val.i430 = load i32, ptr %call.i424, align 8
  %48 = getelementptr i8, ptr %call.i424, i64 12
  %call.val12.i431 = load i32, ptr %48, align 4
  %call6.i432 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.26, i32 noundef %call.val.i430, i32 noundef %call.val12.i431)
...
if.then111:                                       ; preds = %land.lhs.true107, %land.lhs.true101
  ...
  br i1 %tobool.not.i434, label %red_ExchangeClauses.exit438, label %if.then.i435

if.then.i435:                                     ; preds = %if.then111
  %52 = load ptr, ptr %Clause, align 8
  %53 = load ptr, ptr %Result, align 8
  %call.i.i436 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i437 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i436, i64 0, i32 1
  store ptr %52, ptr %car.i.i437, align 8
  store ptr %53, ptr %call.i.i436, align 8
  store ptr %call.i.i436, ptr %Result, align 8
  store ptr %51, ptr %Clause, align 8
  store ptr null, ptr %Copy, align 8
  br label %red_ExchangeClauses.exit438

red_ExchangeClauses.exit438:                      ; preds = %if.then111, %if.then.i435
...
if.end115:                                        ; preds = %red_ExchangeClauses.exit438
  ...
  br i1 %cmp.not.i439, label %if.end119, label %land.lhs.true.i440

land.lhs.true.i440:                               ; preds = %if.end115
  %55 = getelementptr i8, ptr %54, i64 68
  %C.val.i441 = load i32, ptr %55, align 4
  %cmp.i.not.i442 = icmp eq i32 %C.val.i441, 0
  br i1 %cmp.i.not.i442, label %land.lhs.true1.i444, label %if.end119

land.lhs.true1.i444:                              ; preds = %land.lhs.true.i440
  %56 = getelementptr i8, ptr %54, i64 72
  %C.val9.i445 = load i32, ptr %56, align 8
  %cmp.i11.not.i446 = icmp eq i32 %C.val9.i445, 0
  br i1 %cmp.i11.not.i446, label %clause_IsEmptyClause.exit451, label %if.end119

clause_IsEmptyClause.exit451:                     ; preds = %land.lhs.true1.i444
  %57 = getelementptr i8, ptr %54, i64 64
  %C.val10.i448 = load i32, ptr %57, align 8
  %cmp.i13.i449.not = icmp eq i32 %C.val10.i448, 0
  br i1 %cmp.i13.i449.not, label %cleanup, label %if.end119

if.end119:                                        ; preds = %if.end115, %land.lhs.true.i440, %land.lhs.true1.i444, %clause_IsEmptyClause.exit451
...
if.end127.thread593:                              ; preds = %if.then125
  ...
  tail call void @clause_Print(ptr noundef %59) #12
  %call.val.i459 = load i32, ptr %call.i453, align 8
  %63 = getelementptr i8, ptr %call.i453, i64 12
  %call.val12.i460 = load i32, ptr %63, align 4
  %call6.i461 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.26, i32 noundef %call.val.i459, i32 noundef %call.val12.i460)
...
red_ForwardSubsumption.exit472.thread:            ; preds = %if.end131
  ...
  tail call void @clause_Print(ptr noundef %64) #12
  %call.val.i469 = load i32, ptr %call.i463, align 8
  %68 = getelementptr i8, ptr %call.i463, i64 12
  %call.val12.i470 = load i32, ptr %68, align 4
  %call6.i471 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.26, i32 noundef %call.val.i469, i32 noundef %call.val12.i470)
...
red_ExchangeClauses.exit479.thread:               ; preds = %if.then141
  ...
  %call.i.i477 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i478 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i477, i64 0, i32 1
  store ptr %.pr596, ptr %car.i.i478, align 8
  store ptr %75, ptr %call.i.i477, align 8
  store ptr %call.i.i477, ptr %Result, align 8
  store ptr %74, ptr %Clause, align 8
  store ptr null, ptr %Copy, align 8
  br label %land.lhs.true.i481

red_ExchangeClauses.exit479:                      ; preds = %if.then141
  %cmp.not.i480 = icmp eq ptr %.pr596, null
  br i1 %cmp.not.i480, label %if.end150, label %land.lhs.true.i481

land.lhs.true.i481:                               ; preds = %red_ExchangeClauses.exit479.thread, %red_ExchangeClauses.exit479
  %76 = phi ptr [ %74, %red_ExchangeClauses.exit479.thread ], [ %.pr596, %red_ExchangeClauses.exit479 ]
  %77 = getelementptr i8, ptr %76, i64 68
  %C.val.i482 = load i32, ptr %77, align 4
  %cmp.i.not.i483 = icmp eq i32 %C.val.i482, 0
  br i1 %cmp.i.not.i483, label %land.lhs.true1.i485, label %if.end150

land.lhs.true1.i485:                              ; preds = %land.lhs.true.i481
  %78 = getelementptr i8, ptr %76, i64 72
  %C.val9.i486 = load i32, ptr %78, align 8
  %cmp.i11.not.i487 = icmp eq i32 %C.val9.i486, 0
  br i1 %cmp.i11.not.i487, label %clause_IsEmptyClause.exit492, label %if.end150

clause_IsEmptyClause.exit492:                     ; preds = %land.lhs.true1.i485
  %79 = getelementptr i8, ptr %76, i64 64
  %C.val10.i489 = load i32, ptr %79, align 8
  %cmp.i13.i490.not = icmp eq i32 %C.val10.i489, 0
  br i1 %cmp.i13.i490.not, label %cleanup, label %if.end150

if.end150:                                        ; preds = %red_ExchangeClauses.exit479, %land.lhs.true.i481, %land.lhs.true1.i485, %clause_IsEmptyClause.exit492, %while.end
...
red_ExchangeClauses.exit498.thread:               ; preds = %if.end158
  ...
  %call.i.i496 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i497 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i496, i64 0, i32 1
  store ptr %.pr600, ptr %car.i.i497, align 8
  store ptr %84, ptr %call.i.i496, align 8
  store ptr %call.i.i496, ptr %Result, align 8
  store ptr %83, ptr %Clause, align 8
  store ptr null, ptr %Copy, align 8
  br label %land.lhs.true.i500

red_ExchangeClauses.exit498:                      ; preds = %if.end158
  %cmp.not.i499 = icmp eq ptr %.pr600, null
  br i1 %cmp.not.i499, label %if.end162, label %land.lhs.true.i500

land.lhs.true.i500:                               ; preds = %red_ExchangeClauses.exit498.thread, %red_ExchangeClauses.exit498
  %85 = phi ptr [ %83, %red_ExchangeClauses.exit498.thread ], [ %.pr600, %red_ExchangeClauses.exit498 ]
  %86 = getelementptr i8, ptr %85, i64 68
  %C.val.i501 = load i32, ptr %86, align 4
  %cmp.i.not.i502 = icmp eq i32 %C.val.i501, 0
  br i1 %cmp.i.not.i502, label %land.lhs.true1.i504, label %if.end162

land.lhs.true1.i504:                              ; preds = %land.lhs.true.i500
  %87 = getelementptr i8, ptr %85, i64 72
  %C.val9.i505 = load i32, ptr %87, align 8
  %cmp.i11.not.i506 = icmp eq i32 %C.val9.i505, 0
  br i1 %cmp.i11.not.i506, label %clause_IsEmptyClause.exit511, label %if.end162

clause_IsEmptyClause.exit511:                     ; preds = %land.lhs.true1.i504
  %88 = getelementptr i8, ptr %85, i64 64
  %C.val10.i508 = load i32, ptr %88, align 8
  %cmp.i13.i509.not = icmp eq i32 %C.val10.i508, 0
  br i1 %cmp.i13.i509.not, label %cleanup, label %if.end162

if.end162:                                        ; preds = %red_ExchangeClauses.exit498, %land.lhs.true.i500, %land.lhs.true1.i504, %clause_IsEmptyClause.exit511
  %89 = phi ptr [ %85, %clause_IsEmptyClause.exit511 ], [ null, %red_ExchangeClauses.exit498 ], [ %85, %land.lhs.true.i500 ], [ %85, %land.lhs.true1.i504 ]
...
red_ExchangeClauses.exit516.thread:               ; preds = %if.end167
  ...
  %call.i.i514 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i515 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i514, i64 0, i32 1
  store ptr %91, ptr %car.i.i515, align 8
  store ptr %92, ptr %call.i.i514, align 8
  store ptr %call.i.i514, ptr %Result, align 8
  store ptr %.pre, ptr %Clause, align 8
  store ptr null, ptr %Copy, align 8
  br label %land.lhs.true.i518
...
red_ExchangeClauses.exit516:                      ; preds = %if.end162, %if.end167
  ...
  br i1 %cmp.not.i517, label %if.end172, label %land.lhs.true.i518

land.lhs.true.i518:                               ; preds = %red_ExchangeClauses.exit516.thread, %red_ExchangeClauses.exit516
  %93 = phi ptr [ %.pre, %red_ExchangeClauses.exit516.thread ], [ %.pr604, %red_ExchangeClauses.exit516 ]
  %94 = getelementptr i8, ptr %93, i64 68
  %C.val.i519 = load i32, ptr %94, align 4
  %cmp.i.not.i520 = icmp eq i32 %C.val.i519, 0
  br i1 %cmp.i.not.i520, label %land.lhs.true1.i522, label %if.end172

land.lhs.true1.i522:                              ; preds = %land.lhs.true.i518
  %95 = getelementptr i8, ptr %93, i64 72
  %C.val9.i523 = load i32, ptr %95, align 8
  %cmp.i11.not.i524 = icmp eq i32 %C.val9.i523, 0
  br i1 %cmp.i11.not.i524, label %clause_IsEmptyClause.exit529, label %if.end172

clause_IsEmptyClause.exit529:                     ; preds = %land.lhs.true1.i522
  %96 = getelementptr i8, ptr %93, i64 64
  %C.val10.i526 = load i32, ptr %96, align 8
  %cmp.i13.i527.not = icmp eq i32 %C.val10.i526, 0
  br i1 %cmp.i13.i527.not, label %cleanup, label %if.end172

if.end172:                                        ; preds = %red_ExchangeClauses.exit516, %land.lhs.true.i518, %land.lhs.true1.i522, %clause_IsEmptyClause.exit529, %if.end150
...
red_ExchangeClauses.exit535.thread:               ; preds = %if.end180
  ...
  %call.i.i533 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i534 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i533, i64 0, i32 1
  store ptr %.pr608, ptr %car.i.i534, align 8
  store ptr %101, ptr %call.i.i533, align 8
  store ptr %call.i.i533, ptr %Result, align 8
  store ptr %100, ptr %Clause, align 8
  store ptr null, ptr %Copy, align 8
  br label %land.lhs.true.i537

red_ExchangeClauses.exit535:                      ; preds = %if.end180
  %cmp.not.i536 = icmp eq ptr %.pr608, null
  br i1 %cmp.not.i536, label %if.end184, label %land.lhs.true.i537

land.lhs.true.i537:                               ; preds = %red_ExchangeClauses.exit535.thread, %red_ExchangeClauses.exit535
  %102 = phi ptr [ %100, %red_ExchangeClauses.exit535.thread ], [ %.pr608, %red_ExchangeClauses.exit535 ]
  %103 = getelementptr i8, ptr %102, i64 68
  %C.val.i538 = load i32, ptr %103, align 4
  %cmp.i.not.i539 = icmp eq i32 %C.val.i538, 0
  br i1 %cmp.i.not.i539, label %land.lhs.true1.i541, label %if.end184

land.lhs.true1.i541:                              ; preds = %land.lhs.true.i537
  %104 = getelementptr i8, ptr %102, i64 72
  %C.val9.i542 = load i32, ptr %104, align 8
  %cmp.i11.not.i543 = icmp eq i32 %C.val9.i542, 0
  br i1 %cmp.i11.not.i543, label %clause_IsEmptyClause.exit548, label %if.end184

clause_IsEmptyClause.exit548:                     ; preds = %land.lhs.true1.i541
  %105 = getelementptr i8, ptr %102, i64 64
  %C.val10.i545 = load i32, ptr %105, align 8
  %cmp.i13.i546.not = icmp eq i32 %C.val10.i545, 0
  br i1 %cmp.i13.i546.not, label %cleanup, label %if.end184

if.end184:                                        ; preds = %red_ExchangeClauses.exit535, %land.lhs.true.i537, %land.lhs.true1.i541, %clause_IsEmptyClause.exit548
  %106 = phi ptr [ %102, %clause_IsEmptyClause.exit548 ], [ null, %red_ExchangeClauses.exit535 ], [ %102, %land.lhs.true.i537 ], [ %102, %land.lhs.true1.i541 ]
...
red_ExchangeClauses.exit553.thread:               ; preds = %if.end189
  ...
  %call.i.i551 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i552 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i551, i64 0, i32 1
  store ptr %108, ptr %car.i.i552, align 8
  store ptr %109, ptr %call.i.i551, align 8
  store ptr %call.i.i551, ptr %Result, align 8
  store ptr %.pre631, ptr %Clause, align 8
  br label %land.lhs.true.i555
...
red_ExchangeClauses.exit553:                      ; preds = %if.end184, %if.end189
  ...
  br i1 %cmp.not.i554, label %if.end194, label %land.lhs.true.i555

land.lhs.true.i555:                               ; preds = %red_ExchangeClauses.exit553.thread, %red_ExchangeClauses.exit553
  ...
  %C.val.i556 = load i32, ptr %111, align 4
  %cmp.i.not.i557 = icmp eq i32 %C.val.i556, 0
  br i1 %cmp.i.not.i557, label %land.lhs.true1.i559, label %if.end194

land.lhs.true1.i559:                              ; preds = %land.lhs.true.i555
  %112 = getelementptr i8, ptr %110, i64 72
  %C.val9.i560 = load i32, ptr %112, align 8
  %cmp.i11.not.i561 = icmp eq i32 %C.val9.i560, 0
  br i1 %cmp.i11.not.i561, label %clause_IsEmptyClause.exit566, label %if.end194

clause_IsEmptyClause.exit566:                     ; preds = %land.lhs.true1.i559
  %113 = getelementptr i8, ptr %110, i64 64
  %C.val10.i563 = load i32, ptr %113, align 8
  %cmp.i13.i564.not = icmp eq i32 %C.val10.i563, 0
  br i1 %cmp.i13.i564.not, label %cleanup, label %if.end194

if.end194:                                        ; preds = %red_ExchangeClauses.exit553, %land.lhs.true.i555, %land.lhs.true1.i559, %clause_IsEmptyClause.exit566, %if.end172
...
cleanup:                                          ; preds = %red_ForwardSubsumption.exit472, %if.end127, %clause_IsEmptyClause.exit451, %red_ExchangeClauses.exit438, %red_ForwardSubsumption.exit433, %red_ForwardSubsumption.exit423, %clause_IsEmptyClause.exit412, %red_ExchangeClauses.exit399, %red_ForwardSubsumption.exit472.thread, %if.end127.thread593, %red_ForwardSubsumption.exit433.thread, %red_ForwardSubsumption.exit423.thread, %red_ForwardSubsumption.exit392.thread, %red_ForwardSubsumption.exit.thread, %if.end194, %if.then197, %clause_IsEmptyClause.exit566, %clause_IsEmptyClause.exit548, %clause_IsEmptyClause.exit529, %clause_IsEmptyClause.exit511, %clause_IsEmptyClause.exit492, %red_ForwardSubsumption.exit392, %red_ForwardSubsumption.exit, %clause_IsEmptyClause.exit, %if.end8
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %Copy) #12
  ret i32 %retval.0
}
...
if.then30:                                        ; preds = %if.end27
  ...
  br i1 %cmp.i.not.i138, label %if.end34, label %if.end.i139

if.end.i139:                                      ; preds = %if.then30
  %cmp.i18.not.i140 = icmp eq ptr %call32, null
  br i1 %cmp.i18.not.i140, label %if.end34.thread, label %for.cond.i141
...
for.cond.i141:                                    ; preds = %if.end.i139, %for.cond.i141
  %List1.addr.0.i142 = phi ptr [ %List1.addr.0.val17.i143, %for.cond.i141 ], [ %Redundant.2, %if.end.i139 ]
  %List1.addr.0.val17.i143 = load ptr, ptr %List1.addr.0.i142, align 8
  %cmp.i20.not.i144 = icmp eq ptr %List1.addr.0.val17.i143, null
  br i1 %cmp.i20.not.i144, label %for.end.i145, label %for.cond.i141, !llvm.loop !10

for.end.i145:                                     ; preds = %for.cond.i141
  store ptr %call32, ptr %List1.addr.0.i142, align 8
  br label %if.end34
...
if.end34:                                         ; preds = %for.end.i145, %if.then30, %if.end27
  ...
  br i1 %cmp.i.not5.i148, label %if.end35, label %while.body.i149.preheader

while.body.i149.preheader:                        ; preds = %if.end34.thread, %if.end34
  %Current.06.i150.ph = phi ptr [ %Redundant.3, %if.end34 ], [ %Redundant.2, %if.end34.thread ]
  br label %while.body.i149

while.body.i149:                                  ; preds = %while.body.i149.preheader, %while.body.i149
  %Current.06.i150 = phi ptr [ %Current.0.val.i151, %while.body.i149 ], [ %Current.06.i150.ph, %while.body.i149.preheader ]
  %Current.0.val.i151 = load ptr, ptr %Current.06.i150, align 8
  %17 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i152 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %17, i64 0, i32 4
  %18 = load i32, ptr %total_size.i.i.i152, align 8
  %conv26.i.i.i153 = sext i32 %18 to i64
  %19 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i154 = add i64 %19, %conv26.i.i.i153
  store i64 %add27.i.i.i154, ptr @memory_FREEDBYTES, align 8
  %20 = load ptr, ptr %17, align 8
  store ptr %20, ptr %Current.06.i150, align 8
  %21 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i150, ptr %21, align 8
  %cmp.i.not.i155 = icmp eq ptr %Current.0.val.i151, null
  br i1 %cmp.i.not.i155, label %if.end35, label %while.body.i149, !llvm.loop !8

if.end35:                                         ; preds = %while.body.i149, %if.end34, %if.end17
...
if.then48:                                        ; preds = %if.end45
  ...
  br i1 %cmp.i.not.i160, label %if.end52, label %if.end.i161

if.end.i161:                                      ; preds = %if.then48
  %cmp.i18.not.i162 = icmp eq ptr %call50, null
  br i1 %cmp.i18.not.i162, label %if.end52.thread, label %for.cond.i163
...
if.end52.thread:                                  ; preds = %if.end.i161
  ...
  br label %while.body.i171.preheader

for.cond.i163:                                    ; preds = %if.end.i161, %for.cond.i163
  %List1.addr.0.i164 = phi ptr [ %List1.addr.0.val17.i165, %for.cond.i163 ], [ %Redundant.4, %if.end.i161 ]
  %List1.addr.0.val17.i165 = load ptr, ptr %List1.addr.0.i164, align 8
  %cmp.i20.not.i166 = icmp eq ptr %List1.addr.0.val17.i165, null
  br i1 %cmp.i20.not.i166, label %for.end.i167, label %for.cond.i163, !llvm.loop !10
...
if.end52:                                         ; preds = %for.end.i167, %if.then48, %if.end45
  ...
  br i1 %cmp.i.not5.i170, label %if.end53, label %while.body.i171.preheader

while.body.i171.preheader:                        ; preds = %if.end52.thread, %if.end52
  %Current.06.i172.ph = phi ptr [ %Redundant.5, %if.end52 ], [ %Redundant.4, %if.end52.thread ]
  br label %while.body.i171

while.body.i171:                                  ; preds = %while.body.i171.preheader, %while.body.i171
  %Current.06.i172 = phi ptr [ %Current.0.val.i173, %while.body.i171 ], [ %Current.06.i172.ph, %while.body.i171.preheader ]
  ...
  %total_size.i.i.i174 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %27, i64 0, i32 4
  %28 = load i32, ptr %total_size.i.i.i174, align 8
  %conv26.i.i.i175 = sext i32 %28 to i64
  %29 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i176 = add i64 %29, %conv26.i.i.i175
  store i64 %add27.i.i.i176, ptr @memory_FREEDBYTES, align 8
  %30 = load ptr, ptr %27, align 8
  store ptr %30, ptr %Current.06.i172, align 8
  %31 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i172, ptr %31, align 8
  %cmp.i.not.i177 = icmp eq ptr %Current.0.val.i173, null
  br i1 %cmp.i.not.i177, label %if.end53, label %while.body.i171, !llvm.loop !8

if.end53:                                         ; preds = %while.body.i171, %if.end52, %if.end35
...
if.then65:                                        ; preds = %if.end62
  ...
  br i1 %cmp.i.not.i182, label %if.end68, label %if.end.i183

if.end.i183:                                      ; preds = %if.then65
  %cmp.i18.not.i184 = icmp eq ptr %call66, null
  br i1 %cmp.i18.not.i184, label %if.end68.thread, label %for.cond.i185
...
for.cond.i185:                                    ; preds = %if.end.i183, %for.cond.i185
  %List1.addr.0.i186 = phi ptr [ %List1.addr.0.val17.i187, %for.cond.i185 ], [ %Redundant.6, %if.end.i183 ]
  %List1.addr.0.val17.i187 = load ptr, ptr %List1.addr.0.i186, align 8
  %cmp.i20.not.i188 = icmp eq ptr %List1.addr.0.val17.i187, null
  br i1 %cmp.i20.not.i188, label %for.end.i189, label %for.cond.i185, !llvm.loop !10

for.end.i189:                                     ; preds = %for.cond.i185
  store ptr %call66, ptr %List1.addr.0.i186, align 8
  br label %if.end68
...
if.end68:                                         ; preds = %for.end.i189, %if.then65, %if.end62
  ...
  br i1 %cmp.i.not5.i192, label %if.end69, label %while.body.i193.preheader

while.body.i193.preheader:                        ; preds = %if.end68.thread, %if.end68
  %Current.06.i194.ph = phi ptr [ %Redundant.7, %if.end68 ], [ %Redundant.6, %if.end68.thread ]
  br label %while.body.i193

while.body.i193:                                  ; preds = %while.body.i193.preheader, %while.body.i193
  %Current.06.i194 = phi ptr [ %Current.0.val.i195, %while.body.i193 ], [ %Current.06.i194.ph, %while.body.i193.preheader ]
  ...
  %total_size.i.i.i196 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %35, i64 0, i32 4
  %36 = load i32, ptr %total_size.i.i.i196, align 8
  %conv26.i.i.i197 = sext i32 %36 to i64
  %37 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i198 = add i64 %37, %conv26.i.i.i197
  store i64 %add27.i.i.i198, ptr @memory_FREEDBYTES, align 8
  %38 = load ptr, ptr %35, align 8
  store ptr %38, ptr %Current.06.i194, align 8
  %39 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i194, ptr %39, align 8
  %cmp.i.not.i199 = icmp eq ptr %Current.0.val.i195, null
  br i1 %cmp.i.not.i199, label %if.end69, label %while.body.i193, !llvm.loop !8

if.end69:                                         ; preds = %while.body.i193, %if.end68, %if.end53
...
clause_GetLiteralAtom.exit:                       ; preds = %for.end, %if.then.i.i
  ...
  %call19 = tail call ptr @st_ExistInstance(ptr noundef %29, ptr noundef %ShIndex.val241, ptr noundef %retval.0.i.i) #12
...
while.body:                                       ; preds = %while.body.lr.ph, %for.end56
  ...
  %call21 = tail call ptr @sharing_NAtomDataList(ptr noundef nonnull %CandTerm.016) #12
...
lor.lhs.false:                                    ; preds = %clause_LiteralIsFromConstraint.exit, %land.lhs.true
  br i1 %or.cond, label %lor.lhs.false40, label %while.cond.i.i254

while.cond.i.i254:                                ; preds = %lor.lhs.false, %while.cond.i.i254
  %indvars.iv.i.i255 = phi i64 [ %indvars.iv.next.i.i258, %while.cond.i.i254 ], [ 0, %lor.lhs.false ]
  %arrayidx.i.i.i256 = getelementptr inbounds ptr, ptr %call.val.i248, i64 %indvars.iv.i.i255
  %38 = load ptr, ptr %arrayidx.i.i.i256, align 8
  %cmp.not.i.i257 = icmp eq ptr %38, %Scan.0.val
  %indvars.iv.next.i.i258 = add nuw i64 %indvars.iv.i.i255, 1
  br i1 %cmp.not.i.i257, label %clause_LiteralIsFromAntecedent.exit, label %while.cond.i.i254, !llvm.loop !12

clause_LiteralIsFromAntecedent.exit:              ; preds = %while.cond.i.i254
  %39 = trunc i64 %indvars.iv.i.i255 to i32
...
lor.lhs.false40:                                  ; preds = %clause_LiteralIsFromAntecedent.exit, %lor.lhs.false
  br i1 %cmp41.not, label %for.inc54, label %while.cond.i.i266

while.cond.i.i266:                                ; preds = %lor.lhs.false40, %while.cond.i.i266
  %indvars.iv.i.i267 = phi i64 [ %indvars.iv.next.i.i270, %while.cond.i.i266 ], [ 0, %lor.lhs.false40 ]
  %arrayidx.i.i.i268 = getelementptr inbounds ptr, ptr %call.val.i248, i64 %indvars.iv.i.i267
  %42 = load ptr, ptr %arrayidx.i.i.i268, align 8
  %cmp.not.i.i269 = icmp eq ptr %42, %Scan.0.val
  %indvars.iv.next.i.i270 = add nuw i64 %indvars.iv.i.i267, 1
  br i1 %cmp.not.i.i269, label %clause_LiteralIsFromSuccedent.exit, label %while.cond.i.i266, !llvm.loop !12

clause_LiteralIsFromSuccedent.exit:               ; preds = %while.cond.i.i266
  %43 = trunc i64 %indvars.iv.i.i267 to i32
...
land.lhs.true48:                                  ; preds = %if.end.i, %land.lhs.true45
  %call49 = tail call i32 @subs_SubsumesBasic(ptr noundef %RedCl, ptr noundef %call26.val, i32 noundef %i.0.lcssa, i32 noundef %34) #12
...
for.end56:                                        ; preds = %for.inc54, %while.body
  ...
  %call57 = tail call ptr @st_NextCandidate() #12
...
if.then64:                                        ; preds = %land.lhs.true60
  ...
  %call67 = tail call ptr @list_Reverse(ptr noundef %call16.val242) #12
  %call68 = tail call ptr @term_Create(i32 noundef %call16.val, ptr noundef %call67) #12
  %52 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  %ShIndex.val = load ptr, ptr %ShIndex, align 8
  %call71 = tail call ptr @st_ExistInstance(ptr noundef %52, ptr noundef %ShIndex.val, ptr noundef %call68) #12
...
while.body74:                                     ; preds = %while.body74.lr.ph, %for.end115
  ...
  %call75 = tail call ptr @sharing_NAtomDataList(ptr noundef nonnull %CandTerm.124) #12
...
while.cond.i287:                                  ; preds = %while.cond.i287, %for.body80
  %indvars.iv.i288 = phi i64 [ %indvars.iv.next.i291, %while.cond.i287 ], [ 0, %for.body80 ]
  %arrayidx.i.i289 = getelementptr inbounds ptr, ptr %call.val.i286, i64 %indvars.iv.i288
  %56 = load ptr, ptr %arrayidx.i.i289, align 8
  %cmp.not.i290 = icmp eq ptr %56, %Scan.1.val233
  %indvars.iv.next.i291 = add nuw i64 %indvars.iv.i288, 1
  br i1 %cmp.not.i290, label %clause_LiteralGetIndex.exit292, label %while.cond.i287, !llvm.loop !12

clause_LiteralGetIndex.exit292:                   ; preds = %while.cond.i287
  %57 = trunc i64 %indvars.iv.i288 to i32
...
land.lhs.true87:                                  ; preds = %clause_LiteralGetIndex.exit292
  br i1 %cmp88.not, label %lor.lhs.false92, label %while.cond.i.i295

while.cond.i.i295:                                ; preds = %land.lhs.true87, %while.cond.i.i295
  %indvars.iv.i.i296 = phi i64 [ %indvars.iv.next.i.i299, %while.cond.i.i295 ], [ 0, %land.lhs.true87 ]
  %arrayidx.i.i.i297 = getelementptr inbounds ptr, ptr %call.val.i286, i64 %indvars.iv.i.i296
  %58 = load ptr, ptr %arrayidx.i.i.i297, align 8
  %cmp.not.i.i298 = icmp eq ptr %58, %Scan.1.val233
  %indvars.iv.next.i.i299 = add nuw i64 %indvars.iv.i.i296, 1
  br i1 %cmp.not.i.i298, label %clause_LiteralIsFromConstraint.exit305, label %while.cond.i.i295, !llvm.loop !12

clause_LiteralIsFromConstraint.exit305:           ; preds = %while.cond.i.i295
  %59 = trunc i64 %indvars.iv.i.i296 to i32
...
lor.lhs.false92:                                  ; preds = %clause_LiteralIsFromConstraint.exit305, %land.lhs.true87
  br i1 %or.cond225, label %lor.lhs.false99, label %while.cond.i.i308

while.cond.i.i308:                                ; preds = %lor.lhs.false92, %while.cond.i.i308
  %indvars.iv.i.i309 = phi i64 [ %indvars.iv.next.i.i312, %while.cond.i.i308 ], [ 0, %lor.lhs.false92 ]
  %arrayidx.i.i.i310 = getelementptr inbounds ptr, ptr %call.val.i286, i64 %indvars.iv.i.i309
  %61 = load ptr, ptr %arrayidx.i.i.i310, align 8
  %cmp.not.i.i311 = icmp eq ptr %61, %Scan.1.val233
  %indvars.iv.next.i.i312 = add nuw i64 %indvars.iv.i.i309, 1
  br i1 %cmp.not.i.i311, label %clause_LiteralIsFromAntecedent.exit321, label %while.cond.i.i308, !llvm.loop !12

clause_LiteralIsFromAntecedent.exit321:           ; preds = %while.cond.i.i308
  %62 = trunc i64 %indvars.iv.i.i309 to i32
...
lor.lhs.false99:                                  ; preds = %clause_LiteralIsFromAntecedent.exit321, %lor.lhs.false92
  br i1 %cmp100.not, label %for.inc113, label %while.cond.i.i324

while.cond.i.i324:                                ; preds = %lor.lhs.false99, %while.cond.i.i324
  %indvars.iv.i.i325 = phi i64 [ %indvars.iv.next.i.i328, %while.cond.i.i324 ], [ 0, %lor.lhs.false99 ]
  %arrayidx.i.i.i326 = getelementptr inbounds ptr, ptr %call.val.i286, i64 %indvars.iv.i.i325
  %65 = load ptr, ptr %arrayidx.i.i.i326, align 8
  %cmp.not.i.i327 = icmp eq ptr %65, %Scan.1.val233
  %indvars.iv.next.i.i328 = add nuw i64 %indvars.iv.i.i325, 1
  br i1 %cmp.not.i.i327, label %clause_LiteralIsFromSuccedent.exit339, label %while.cond.i.i324, !llvm.loop !12

clause_LiteralIsFromSuccedent.exit339:            ; preds = %while.cond.i.i324
  %66 = trunc i64 %indvars.iv.i.i325 to i32
...
land.lhs.true104:                                 ; preds = %clause_LiteralIsFromSuccedent.exit339, %clause_LiteralIsFromAntecedent.exit321, %clause_LiteralIsFromConstraint.exit305
  ...
  br i1 %cmp.i.not6.i340, label %land.lhs.true107, label %while.body.i341

while.body.i341:                                  ; preds = %land.lhs.true104, %if.end.i345
  %List.addr.07.i342 = phi ptr [ %List.addr.0.val5.i346, %if.end.i345 ], [ %SubsumedList.420, %land.lhs.true104 ]
  %70 = getelementptr i8, ptr %List.addr.07.i342, i64 8
  %List.addr.0.val.i343 = load ptr, ptr %70, align 8
  %cmp.i344 = icmp eq ptr %List.addr.0.val.i343, %call82.val
  br i1 %cmp.i344, label %for.inc113, label %if.end.i345

if.end.i345:                                      ; preds = %while.body.i341
  %List.addr.0.val5.i346 = load ptr, ptr %List.addr.07.i342, align 8
  %cmp.i.not.i347 = icmp eq ptr %List.addr.0.val5.i346, null
  br i1 %cmp.i.not.i347, label %land.lhs.true107, label %while.body.i341, !llvm.loop !13

land.lhs.true107:                                 ; preds = %if.end.i345, %land.lhs.true104
  %call108 = tail call i32 @subs_SubsumesBasic(ptr noundef %RedCl, ptr noundef %call82.val, i32 noundef %i.0.lcssa, i32 noundef %57) #12
  %tobool109.not = icmp eq i32 %call108, 0
  br i1 %tobool109.not, label %for.inc113, label %if.then110

if.then110:                                       ; preds = %land.lhs.true107
  %call.i350 = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
for.inc113:                                       ; preds = %while.body.i341, %clause_LiteralGetIndex.exit292, %lor.lhs.false99, %clause_LiteralIsFromSuccedent.exit339, %land.lhs.true107, %if.then110
  %SubsumedList.5 = phi ptr [ %call.i350, %if.then110 ], [ %SubsumedList.420, %land.lhs.true107 ], [ %SubsumedList.420, %clause_LiteralIsFromSuccedent.exit339 ], [ %SubsumedList.420, %lor.lhs.false99 ], [ %SubsumedList.420, %clause_LiteralGetIndex.exit292 ], [ %SubsumedList.420, %while.body.i341 ]
...
for.end115:                                       ; preds = %for.inc113, %while.body74
  ...
  %call116 = tail call ptr @st_NextCandidate() #12
...
while.end117:                                     ; preds = %for.end115, %if.then64
  ...
  br i1 %cmp.i.not5.i, label %list_Delete.exit, label %while.body.i352

while.body.i352:                                  ; preds = %while.end117, %while.body.i352
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i352 ], [ %call68.val, %while.end117 ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  ...
  %cmp.i.not.i353 = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i353, label %list_Delete.exit, label %while.body.i352, !llvm.loop !8

list_Delete.exit:                                 ; preds = %while.body.i352, %while.end117
...
for.body127:                                      ; preds = %if.end119, %for.body127
  ...
  tail call void @clause_Print(ptr noundef %Scan.2.val) #12
...
if.then:                                          ; preds = %for.body
  tail call void @split_DeleteClauseAtLevel(ptr noundef nonnull %Search, ptr noundef nonnull %Scan.0.val, i32 noundef %RedClause.val42) #12
  br label %for.inc
...
if.then14:                                        ; preds = %if.then11
  tail call void @prfs_MoveWorkedOffDocProof(ptr noundef nonnull %Search, ptr noundef nonnull %Scan.0.val) #12
  br label %for.inc

if.else15:                                        ; preds = %if.then11
  tail call void @prfs_DeleteWorkedOff(ptr noundef nonnull %Search, ptr noundef nonnull %Scan.0.val) #12
  br label %for.inc
...
if.then19:                                        ; preds = %if.else16
  tail call void @prfs_MoveUsableDocProof(ptr noundef nonnull %Search, ptr noundef nonnull %Scan.0.val) #12
  br label %for.inc

if.else20:                                        ; preds = %if.else16
  tail call void @prfs_DeleteUsable(ptr noundef nonnull %Search, ptr noundef nonnull %Scan.0.val) #12
  br label %for.inc
...
if.then:                                          ; preds = %entry
  ...
  br i1 %cmp.i.not.i, label %clause_LiteralAtom.exit, label %if.then.i256
...
if.then.i256:                                     ; preds = %if.then
  ...
  %call1.val.i257 = load ptr, ptr %9, align 8
  %10 = getelementptr i8, ptr %call1.val.i257, i64 8
  %call1.val.val.i258 = load ptr, ptr %10, align 8
  br label %clause_LiteralAtom.exit259

clause_LiteralAtom.exit259:                       ; preds = %clause_LiteralAtom.exit, %if.then.i256
  %retval.0.i255 = phi ptr [ %call1.val.val.i258, %if.then.i256 ], [ %call4.val239, %clause_LiteralAtom.exit ]
  %11 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  %ShIndex.val417 = load ptr, ptr %ShIndex, align 8
  %call13 = tail call ptr @st_ExistInstance(ptr noundef %11, ptr noundef %ShIndex.val417, ptr noundef %retval.0.i255) #12
...
while.body:                                       ; preds = %clause_LiteralAtom.exit259, %for.end
  ...
  %call17 = tail call ptr @sharing_NAtomDataList(ptr noundef nonnull %CandTerm.0392) #12
...
for.end:                                          ; preds = %for.inc, %while.body
  ...
  %call27 = tail call ptr @st_NextCandidate() #12
...
while.body32:                                     ; preds = %while.body32.lr.ph, %if.end84
  ...
  %call.i265 = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
if.then39:                                        ; preds = %while.body32
  ...
  tail call void @clause_Print(ptr noundef %call33.val) #12
...
for.end59:                                        ; preds = %for.end59.loopexit, %if.end44
  ...
  %call61 = tail call ptr @clause_Copy(ptr noundef %call33.val) #12
...
for.end71:                                        ; preds = %clause_LiteralGetIndex.exit
  tail call void @clause_DeleteLiterals(ptr noundef %call61, ptr noundef nonnull %PIndL.0.lcssa, ptr noundef %Flags, ptr noundef %Precedence) #12
  br i1 %tobool72.not, label %if.else79, label %if.then73

for.end71.thread:                                 ; preds = %clause_RemoveFlag.exit
  tail call void @clause_DeleteLiterals(ptr noundef nonnull %call61, ptr noundef %PIndL.0.lcssa, ptr noundef %Flags, ptr noundef %Precedence) #12
  br i1 %tobool72.not, label %if.end80, label %if.then73

if.then73:                                        ; preds = %for.end71.thread, %for.end71
  %call.i.i274 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i.i276 = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
if.then83:                                        ; preds = %if.end80
  tail call void @clause_Print(ptr noundef %call61) #12
  br label %if.end84

if.end84:                                         ; preds = %if.then83, %if.end80
  %41 = load ptr, ptr %Result, align 8
  %call.i280 = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
for.body100:                                      ; preds = %for.body100.lr.ph, %for.inc147
  ...
  br i1 %cmp.i.not.i289, label %if.then.i291, label %clause_LiteralAtom.exit294

if.then.i291:                                     ; preds = %for.body100
  %50 = getelementptr i8, ptr %call101.val, i64 16
  %call1.val.i292 = load ptr, ptr %50, align 8
  %51 = getelementptr i8, ptr %call1.val.i292, i64 8
  %call1.val.val.i293 = load ptr, ptr %51, align 8
  %call102.val.pre = load i32, ptr %call1.val.val.i293, align 8
  br label %clause_LiteralAtom.exit294

clause_LiteralAtom.exit294:                       ; preds = %for.body100, %if.then.i291
  %call102.val = phi i32 [ %call102.val.pre, %if.then.i291 ], [ %L.val7.val.i288, %for.body100 ]
...
clause_LiteralAtom.exit.i:                        ; preds = %if.then.i.i, %clause_LiteralGetIndex.exit.i
  ...
  %call5.i = tail call ptr @st_ExistInstance(ptr noundef %57, ptr noundef %ShIndex.val.i, ptr noundef %retval.0.i.i) #12
...
while.body.i297:                                  ; preds = %clause_LiteralAtom.exit.i, %for.end.i
  ...
  %call6.i = tail call ptr @sharing_NAtomDataList(ptr noundef nonnull %CandTerm.052.i) #12
...
land.lhs.true13.i:                                ; preds = %lor.rhs.i.i, %land.lhs.true.i.i
  ...
  br label %while.cond.i36.i

while.cond.i36.i:                                 ; preds = %while.cond.i36.i, %land.lhs.true13.i
  %indvars.iv.i37.i = phi i64 [ %indvars.iv.next.i40.i, %while.cond.i36.i ], [ 0, %land.lhs.true13.i ]
  %arrayidx.i.i38.i = getelementptr inbounds ptr, ptr %call.val.i35.i, i64 %indvars.iv.i37.i
  %65 = load ptr, ptr %arrayidx.i.i38.i, align 8
  %cmp.not.i39.i = icmp eq ptr %65, %LitScan.0.val.i
  %indvars.iv.next.i40.i = add nuw i64 %indvars.iv.i37.i, 1
  br i1 %cmp.not.i39.i, label %clause_LiteralGetIndex.exit41.i, label %while.cond.i36.i, !llvm.loop !12

clause_LiteralGetIndex.exit41.i:                  ; preds = %while.cond.i36.i
  %66 = trunc i64 %indvars.iv.i37.i to i32
  %call15.i = tail call i32 @subs_SubsumesBasic(ptr noundef nonnull %RedClause, ptr noundef %call9.val.i, i32 noundef %56, i32 noundef %66) #12
  %tobool16.not.i = icmp eq i32 %call15.i, 0
  br i1 %tobool16.not.i, label %for.inc.i, label %if.then.i300

if.then.i300:                                     ; preds = %clause_LiteralGetIndex.exit41.i
  %call.i.i301 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i302 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i301, i64 0, i32 1
  store ptr %LitScan.0.val.i, ptr %car.i.i302, align 8
  store ptr %PClLits.148.i, ptr %call.i.i301, align 8
  br label %for.inc.i

for.inc.i:                                        ; preds = %if.then.i300, %clause_LiteralGetIndex.exit41.i, %lor.rhs.i.i, %land.lhs.true.i.i, %for.body.i
  %PClLits.2.i = phi ptr [ %call.i.i301, %if.then.i300 ], [ %PClLits.148.i, %clause_LiteralGetIndex.exit41.i ], [ %PClLits.148.i, %for.body.i ], [ %PClLits.148.i, %lor.rhs.i.i ], [ %PClLits.148.i, %land.lhs.true.i.i ]
...
for.end.i:                                        ; preds = %for.inc.i, %while.body.i297
  ...
  %call19.i = tail call ptr @st_NextCandidate() #12
...
while.cond.i309:                                  ; preds = %while.cond.i309, %for.body111
  %indvars.iv.i310 = phi i64 [ %indvars.iv.next.i313, %while.cond.i309 ], [ 0, %for.body111 ]
  %arrayidx.i.i311 = getelementptr inbounds ptr, ptr %call.val.i308, i64 %indvars.iv.i310
  %72 = load ptr, ptr %arrayidx.i.i311, align 8
  %cmp.not.i312 = icmp eq ptr %72, %LitScan.0.val
  %indvars.iv.next.i313 = add nuw i64 %indvars.iv.i310, 1
  br i1 %cmp.not.i312, label %clause_LiteralGetIndex.exit314, label %while.cond.i309, !llvm.loop !12

clause_LiteralGetIndex.exit314:                   ; preds = %while.cond.i309
  %73 = trunc i64 %indvars.iv.i310 to i32
  %call115 = tail call ptr @clause_Copy(ptr noundef %call112.val) #12
  %cmp.i.not6.i = icmp eq ptr %Blocked.3381, null
  br i1 %cmp.i.not6.i, label %if.else123, label %while.body.i315

while.body.i315:                                  ; preds = %clause_LiteralGetIndex.exit314, %if.end.i
  ...
  %cmp.i316 = icmp eq ptr %List.addr.0.val.i, %call112.val
  br i1 %cmp.i316, label %if.then118, label %if.end.i

if.end.i:                                         ; preds = %while.body.i315
  %List.addr.0.val5.i = load ptr, ptr %List.addr.07.i, align 8
  %cmp.i.not.i317 = icmp eq ptr %List.addr.0.val5.i, null
  br i1 %cmp.i.not.i317, label %if.else123, label %while.body.i315, !llvm.loop !13
...
if.else123:                                       ; preds = %if.end.i, %clause_LiteralGetIndex.exit314
  %call.i320 = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
if.end125:                                        ; preds = %if.then118, %if.then121, %if.else123
  ...
  br i1 %tobool.not.i324, label %clause_RemoveFlag.exit328, label %if.then.i325

if.then.i325:                                     ; preds = %if.end125
  %sub.i326 = add i32 %77, -1
  store i32 %sub.i326, ptr %flags.i322, align 8
  br label %clause_RemoveFlag.exit328

clause_RemoveFlag.exit328:                        ; preds = %if.end125, %if.then.i325
  %78 = phi i32 [ %77, %if.end125 ], [ %sub.i326, %if.then.i325 ]
  %Partner.val20.i = load i32, ptr %43, align 8
  %79 = and i32 %Partner.val20.i, 8
  %tobool.not.i329 = icmp eq i32 %79, 0
  br i1 %tobool.not.i329, label %if.end.i331, label %if.then.i330
...
if.end.i331:                                      ; preds = %if.then.i330, %clause_RemoveFlag.exit328
  %Partner.val19.i = load i32, ptr %44, align 4
  %cmp.i332 = icmp eq i32 %Partner.val19.i, 0
  br i1 %cmp.i332, label %clause_UpdateSplitDataFromPartner.exit, label %if.end3.i

if.end3.i:                                        ; preds = %if.end.i331
...
if.then.i.i.i:                                    ; preds = %if.end3.i
  ...
  %call.i.i.i = tail call ptr @memory_Malloc(i32 noundef %mul.i.i.i) #12
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i
  ...
  %arrayidx.i.i.i336 = getelementptr inbounds i64, ptr %91, i64 %indvars.iv.i.i.i
  %92 = load i64, ptr %arrayidx.i.i.i336, align 8
...
if.end23.i.i.i.i:                                 ; preds = %if.then18.i.i.i.i, %if.end13.i.i.i.i
  ...
  tail call void @free(ptr noundef nonnull %add.ptr24.i.i.i.i) #12
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  %indvars.iv.i.i333 = phi i64 [ 0, %for.body.lr.ph.i.i ], [ %indvars.iv.next.i.i335, %for.body.i.i ]
  %111 = load ptr, ptr %splitfield.i.i, align 8
  %arrayidx.i.i334 = getelementptr inbounds i64, ptr %111, i64 %indvars.iv.i.i333
  %112 = load i64, ptr %arrayidx.i.i334, align 8
  %113 = load ptr, ptr %splitfield5.i.i, align 8
  %arrayidx7.i.i = getelementptr inbounds i64, ptr %113, i64 %indvars.iv.i.i333
  %114 = load i64, ptr %arrayidx7.i.i, align 8
  %or.i22.i = or i64 %114, %112
  store i64 %or.i22.i, ptr %arrayidx.i.i334, align 8
  %indvars.iv.next.i.i335 = add nuw nsw i64 %indvars.iv.i.i333, 1
  %115 = load i32, ptr %splitfield_length1.i.i, align 8
  %116 = zext i32 %115 to i64
  %cmp4.i.i = icmp ult i64 %indvars.iv.next.i.i335, %116
  br i1 %cmp4.i.i, label %for.body.i.i, label %clause_UpdateSplitDataFromPartner.exit, !llvm.loop !28

clause_UpdateSplitDataFromPartner.exit:           ; preds = %for.body.i.i, %if.end.i331, %if.end.i.i
  tail call void @clause_DeleteLiteral(ptr noundef nonnull %call115, i32 noundef %73, ptr noundef %Flags, ptr noundef %Precedence) #12
  br i1 %tobool126.not, label %if.end134, label %if.then127

if.then127:                                       ; preds = %clause_UpdateSplitDataFromPartner.exit
  %sext = shl i64 %indvars.iv.i310, 32
  %conv128 = ashr exact i64 %sext, 32
  %117 = inttoptr i64 %conv128 to ptr
  %call.i.i337 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i.i339 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i.i341 = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
for.body.i343:                                    ; preds = %if.then127, %for.body.i343
  %Help.043.i = phi ptr [ %call.i.i345, %for.body.i343 ], [ null, %if.then127 ]
  %Scan.042.i = phi ptr [ %Scan.0.val.i, %for.body.i343 ], [ %call.i.i337, %if.then127 ]
  %Clause.val20.i = load i32, ptr %call115, align 8
  %conv.i344 = sext i32 %Clause.val20.i to i64
  %118 = inttoptr i64 %conv.i344 to ptr
  %call.i.i345 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i346 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i345, i64 0, i32 1
  store ptr %118, ptr %car.i.i346, align 8
  store ptr %Help.043.i, ptr %call.i.i345, align 8
  %Scan.0.val.i = load ptr, ptr %Scan.042.i, align 8
  %cmp.i.not.i347 = icmp eq ptr %Scan.0.val.i, null
  br i1 %cmp.i.not.i347, label %for.end.i348, label %for.body.i343, !llvm.loop !29

for.end.i348:                                     ; preds = %for.body.i343
  %119 = getelementptr i8, ptr %call115, i64 32
  %Clause.val.i349 = load ptr, ptr %119, align 8
  %cmp.i.not5.i.i = icmp eq ptr %Clause.val.i349, null
  br i1 %cmp.i.not5.i.i, label %list_Delete.exit.i, label %while.body.i.i

while.body.i.i:                                   ; preds = %for.end.i348, %while.body.i.i
  %Current.06.i.i = phi ptr [ %Current.0.val.i.i, %while.body.i.i ], [ %Clause.val.i349, %for.end.i348 ]
...
list_Delete.exit.i:                               ; preds = %while.body.i.i, %for.end.i348
  ...
  br i1 %cmp.i.not5.i21.i, label %for.cond.i.i.preheader, label %while.body.i22.i

while.body.i22.i:                                 ; preds = %list_Delete.exit.i, %while.body.i22.i
  %Current.06.i23.i = phi ptr [ %Current.0.val.i24.i, %while.body.i22.i ], [ %Clause.val19.i, %list_Delete.exit.i ]
  %Current.0.val.i24.i = load ptr, ptr %Current.06.i23.i, align 8
  %126 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i25.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %126, i64 0, i32 4
  %127 = load i32, ptr %total_size.i.i.i25.i, align 8
  %conv26.i.i.i26.i = sext i32 %127 to i64
  %128 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i27.i = add i64 %128, %conv26.i.i.i26.i
  store i64 %add27.i.i.i27.i, ptr @memory_FREEDBYTES, align 8
  %129 = load ptr, ptr %126, align 8
  store ptr %129, ptr %Current.06.i23.i, align 8
  %130 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i23.i, ptr %130, align 8
  %cmp.i.not.i28.i = icmp eq ptr %Current.0.val.i24.i, null
  br i1 %cmp.i.not.i28.i, label %for.cond.i.i.preheader, label %while.body.i22.i, !llvm.loop !8

for.cond.i.i.preheader:                           ; preds = %while.body.i22.i, %list_Delete.exit.i
  br label %for.cond.i.i

for.cond.i.i:                                     ; preds = %for.cond.i.i.preheader, %for.cond.i.i
  %List1.addr.0.i.i = phi ptr [ %List1.addr.0.val17.i.i, %for.cond.i.i ], [ %call.i.i345, %for.cond.i.i.preheader ]
...
for.end.i.i:                                      ; preds = %for.cond.i.i
  ...
  store ptr %call.i.i345, ptr %119, align 8
  br label %for.cond.i34.i

for.cond.i34.i:                                   ; preds = %for.end.i.i, %for.cond.i34.i
  %List1.addr.0.i35.i = phi ptr [ %List1.addr.0.val17.i36.i, %for.cond.i34.i ], [ %call.i.i337, %for.end.i.i ]
  %List1.addr.0.val17.i36.i = load ptr, ptr %List1.addr.0.i35.i, align 8
  %cmp.i20.not.i37.i = icmp eq ptr %List1.addr.0.val17.i36.i, null
  br i1 %cmp.i20.not.i37.i, label %red_DocumentMatchingReplacementResolution.exit, label %for.cond.i34.i, !llvm.loop !10

red_DocumentMatchingReplacementResolution.exit:   ; preds = %for.cond.i34.i
  store ptr %call.i.i341, ptr %List1.addr.0.i35.i, align 8
...
if.then137:                                       ; preds = %if.end134
  ...
  tail call void @clause_Print(ptr noundef %call112.val) #12
  ...
  tail call void @clause_Print(ptr noundef nonnull %call115) #12
  br label %if.end141

if.end141:                                        ; preds = %if.then137, %if.end134
  %135 = load ptr, ptr %Result, align 8
  %call.i358 = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
for.end145:                                       ; preds = %if.end141
  br i1 %cmp.i305.not379, label %for.inc147, label %while.body.i361

while.body.i361:                                  ; preds = %for.end145, %while.body.i361
  %Current.06.i362 = phi ptr [ %Current.0.val.i363, %while.body.i361 ], [ %PClLits.1.lcssa.i, %for.end145 ]
  %Current.0.val.i363 = load ptr, ptr %Current.06.i362, align 8
  %136 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i364 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %136, i64 0, i32 4
  %137 = load i32, ptr %total_size.i.i.i364, align 8
  %conv26.i.i.i365 = sext i32 %137 to i64
  %138 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i366 = add i64 %138, %conv26.i.i.i365
  store i64 %add27.i.i.i366, ptr @memory_FREEDBYTES, align 8
  %139 = load ptr, ptr %136, align 8
  store ptr %139, ptr %Current.06.i362, align 8
  %140 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i362, ptr %140, align 8
  %cmp.i.not.i367 = icmp eq ptr %Current.0.val.i363, null
  br i1 %cmp.i.not.i367, label %for.inc147, label %while.body.i361, !llvm.loop !8

for.inc147:                                       ; preds = %while.body.i361, %clause_LiteralAtom.exit.i, %red_GetBackMRResLits.exit, %for.end145, %clause_LiteralAtom.exit294
  %Blocked.5 = phi ptr [ %Blocked.2385, %clause_LiteralAtom.exit294 ], [ %Blocked.4, %for.end145 ], [ %Blocked.2385, %red_GetBackMRResLits.exit ], [ %Blocked.2385, %clause_LiteralAtom.exit.i ], [ %Blocked.4, %while.body.i361 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
if.then:                                          ; preds = %for.body
  ...
  %ShIndex.val.i = load ptr, ptr %ShIndex, align 8
  %call5.i = tail call ptr @st_ExistInstance(ptr noundef %15, ptr noundef %ShIndex.val.i, ptr noundef %call3.val19.val.val) #12
...
if.then.i:                                        ; preds = %symbol_IsPredicate.exit.i, %land.lhs.true.i
  %call11.i = tail call ptr @sharing_GetDataList(ptr noundef nonnull %CandTerm.011.i, ptr noundef nonnull %ShIndex) #12
...
land.lhs.true25.i:                                ; preds = %if.end.i.i, %land.lhs.true22.i
  %call26.i = tail call i32 @subs_SubsumesBasic(ptr noundef nonnull %RedClause, ptr noundef nonnull %L.val.i.i, i32 noundef %17, i32 noundef %22) #12
...
if.then28.i:                                      ; preds = %land.lhs.true25.i
  ...
  %call30.i = tail call ptr @clause_Copy(ptr noundef nonnull %L.val.i.i) #12
...
list_Delete.exit.i.i.i:                           ; preds = %while.body.i.i.i.i, %if.then.i66.i
  ...
  br i1 %cmp.i.not5.i17.i.i.i, label %red_DocumentRewriting.exit.i.i, label %while.body.i18.i.i.i

while.body.i18.i.i.i:                             ; preds = %list_Delete.exit.i.i.i, %while.body.i18.i.i.i
  %Current.06.i19.i.i.i = phi ptr [ %Current.0.val.i20.i.i.i, %while.body.i18.i.i.i ], [ %Clause.val15.i.i.i, %list_Delete.exit.i.i.i ]
  %Current.0.val.i20.i.i.i = load ptr, ptr %Current.06.i19.i.i.i, align 8
  %34 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i21.i.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %34, i64 0, i32 4
  %35 = load i32, ptr %total_size.i.i.i21.i.i.i, align 8
  %conv26.i.i.i22.i.i.i = sext i32 %35 to i64
  %36 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i23.i.i.i = add i64 %36, %conv26.i.i.i22.i.i.i
  store i64 %add27.i.i.i23.i.i.i, ptr @memory_FREEDBYTES, align 8
  %37 = load ptr, ptr %34, align 8
  store ptr %37, ptr %Current.06.i19.i.i.i, align 8
  %38 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i19.i.i.i, ptr %38, align 8
  %cmp.i.not.i24.i.i.i = icmp eq ptr %Current.0.val.i20.i.i.i, null
  br i1 %cmp.i.not.i24.i.i.i, label %red_DocumentRewriting.exit.i.i, label %while.body.i18.i.i.i, !llvm.loop !8

red_DocumentRewriting.exit.i.i:                   ; preds = %while.body.i18.i.i.i, %list_Delete.exit.i.i.i
  ...
  %call.i.i26.i.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i.i29.i.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i.i33.i.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
if.then3.i.i:                                     ; preds = %if.end.i68.i
  ...
  tail call void @clause_Print(ptr noundef nonnull %call30.i) #12
...
if.end7.i.i:                                      ; preds = %if.then3.i.i, %if.end.i68.i
  ...
  %call12.i.i = tail call ptr @term_Copy(ptr noundef %call10.val.val.val.i.i) #12
  %call13.i.i = tail call ptr @cont_ApplyBindingsModuloMatchingReverse(ptr noundef %50, ptr noundef %call12.i.i) #12
  %55 = getelementptr i8, ptr %49, i64 24
  %call8.val.i.i = load ptr, ptr %55, align 8
  %call15.i.i = tail call i32 @term_ReplaceSubtermBy(ptr noundef %call8.val.i.i, ptr noundef nonnull %CandTerm.011.i, ptr noundef %call13.i.i) #12
  tail call void @term_Delete(ptr noundef %call13.i.i) #12
  tail call void @clause_OrientEqualities(ptr noundef nonnull %call30.i, ptr noundef nonnull %Flags, ptr noundef %Precedence) #12
  tail call void @clause_Normalize(ptr noundef nonnull %call30.i) #12
  tail call void @clause_SetMaxLitFlags(ptr noundef nonnull %call30.i, ptr noundef nonnull %Flags, ptr noundef %Precedence) #12
  %call.i.i.i38.i.i = tail call i32 @clause_ComputeWeight(ptr noundef nonnull %call30.i, ptr noundef nonnull %Flags) #12
  ...
  tail call void @clause_UpdateMaxVar(ptr noundef nonnull %call30.i) #12
...
if.end3.i:                                        ; preds = %if.end.i26
  ...
  br i1 %cmp.i21.i, label %if.then.i.i.i, label %if.end.i.i27
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i
  ...
  %arrayidx.i.i.i30 = getelementptr inbounds i64, ptr %69, i64 %indvars.iv.i.i.i
  %70 = load i64, ptr %arrayidx.i.i.i30, align 8
  %arrayidx6.i.i.i = getelementptr inbounds i64, ptr %call.i.i.i, i64 %indvars.iv.i.i.i
...
if.end13.i.i.i.i:                                 ; preds = %if.then9.i.i.i.i, %if.then.i.i.i.i
  ...
  %conv.i.i.i.i31 = zext i32 %add.i.i.i.i to i64
  %add14.i.i.i.i = add nuw nsw i64 %conv.i.i.i.i31, 16
...
if.else25.i.i.i.i:                                ; preds = %if.then20.i.i.i
  %idxprom.i.i.i.i = zext i32 %mul24.i.i.i to i64
  %arrayidx.i.i.i.i32 = getelementptr inbounds [0 x ptr], ptr @memory_ARRAY, i64 0, i64 %idxprom.i.i.i.i
  %83 = load ptr, ptr %arrayidx.i.i.i.i32, align 8
  %total_size.i.i.i.i33 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %83, i64 0, i32 4
  %84 = load i32, ptr %total_size.i.i.i.i33, align 8
  %conv26.i.i.i.i34 = sext i32 %84 to i64
  %85 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i35 = add i64 %85, %conv26.i.i.i.i34
  store i64 %add27.i.i.i.i35, ptr @memory_FREEDBYTES, align 8
  %86 = load ptr, ptr %83, align 8
  store ptr %86, ptr %73, align 8
  %87 = load ptr, ptr %arrayidx.i.i.i.i32, align 8
...
if.end.i.i27:                                     ; preds = %clause_ExpandSplitField.exit.i.i, %if.end3.i
  %88 = phi i32 [ %.pre.i.i, %clause_ExpandSplitField.exit.i.i ], [ %60, %if.end3.i ]
  %cmp421.not.i.i = icmp eq i32 %88, 0
  br i1 %cmp421.not.i.i, label %clause_UpdateSplitDataFromPartner.exit, label %for.body.lr.ph.i.i

for.body.lr.ph.i.i:                               ; preds = %if.end.i.i27
  %splitfield.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call30.i, i64 0, i32 4
  br label %for.body.i.i

for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  %indvars.iv.i.i28 = phi i64 [ 0, %for.body.lr.ph.i.i ], [ %indvars.iv.next.i.i29, %for.body.i.i ]
  %89 = load ptr, ptr %splitfield.i.i, align 8
  %arrayidx.i.i = getelementptr inbounds i64, ptr %89, i64 %indvars.iv.i.i28
  %90 = load i64, ptr %arrayidx.i.i, align 8
  %91 = load ptr, ptr %splitfield5.i.i, align 8
  %arrayidx7.i.i = getelementptr inbounds i64, ptr %91, i64 %indvars.iv.i.i28
  ...
  %94 = zext i32 %93 to i64
  %cmp4.i.i = icmp ult i64 %indvars.iv.next.i.i29, %94
  br i1 %cmp4.i.i, label %for.body.i.i, label %clause_UpdateSplitDataFromPartner.exit, !llvm.loop !28

clause_UpdateSplitDataFromPartner.exit:           ; preds = %for.body.i.i, %if.end.i26, %if.end.i.i27
...
red_ApplyRewriting.exit.i:                        ; preds = %if.then18.i.i, %clause_UpdateSplitDataFromPartner.exit
  ...
  %call.i69.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
if.end33.i:                                       ; preds = %if.end.i, %if.then.i, %symbol_IsPredicate.exit.i, %while.body.i
  ...
  %call34.i = tail call ptr @st_NextCandidate() #12
...
for.end:                                          ; preds = %for.inc, %entry
  ...
  %call7 = tail call ptr @list_PointerDeleteDuplicates(ptr noundef %Blocked.0.lcssa) #12
  ret ptr %call7
}
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %splitfield_length1.i.i78 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %RuleClause, i64 0, i32 5
  %10 = load i32, ptr @memory_ALIGN, align 4
  %splitfield5.i.i84 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %RuleClause, i64 0, i32 4
...
if.then9.i:                                       ; preds = %clause_LiteralAtom.exit.i
  ...
  %call11.i = tail call i32 @ord_Compare(ptr noundef %call.val.val.i, ptr noundef %call7.val.val.i, ptr noundef %Search.val, ptr noundef %Search.val30) #12
...
land.lhs.true.i:                                  ; preds = %lor.lhs.false.i
  ...
  %call16.i = tail call i32 @ord_Compare(ptr noundef %call.val.val.i, ptr noundef %call7.val47.val.val.i, ptr noundef %Search.val, ptr noundef %Search.val30) #12
...
if.else.i:                                        ; preds = %clause_LiteralAtom.exit.i
  %call19.i = tail call i32 @ord_Compare(ptr noundef %call.val.val.i, ptr noundef nonnull %retval.0.i.i, ptr noundef %Search.val, ptr noundef %Search.val30) #12
...
if.then:                                          ; preds = %clause_LiteralGetIndex.exit.i, %if.then.loopexit
  ...
  %call10.i = tail call ptr @st_GetInstance(ptr noundef %37, ptr noundef %ShIndex.0.val.i, ptr noundef %call6.val.val.i) #12
  %cmp.i.not180.i = icmp eq ptr %call10.i, null
  br i1 %cmp.i.not180.i, label %for.end, label %for.body.lr.ph.i35

for.body.lr.ph.i35:                               ; preds = %if.then
  %arrayidx.i.i36 = getelementptr inbounds i32, ptr %Search.val.i, i64 9
  %38 = inttoptr i64 %indvars.iv to ptr
  %arrayidx.i165.i = getelementptr inbounds i32, ptr %Search.val.i, i64 14
  %39 = trunc i64 %indvars.iv to i32
  br label %for.body.i37

for.body.i37:                                     ; preds = %for.inc83.i, %for.body.lr.ph.i35
  %Inst.0182.i = phi ptr [ %call10.i, %for.body.lr.ph.i35 ], [ %L.val.i169.i, %for.inc83.i ]
  %Blocked.0181.i = phi ptr [ null, %for.body.lr.ph.i35 ], [ %Blocked.3.i, %for.inc83.i ]
  ...
  br i1 %cmp.i.i.i, label %land.lhs.true.i39, label %for.inc83.i

land.lhs.true.i39:                                ; preds = %for.body.i37
...
if.then19.i:                                      ; preds = %symbol_IsPredicate.exit.i, %land.lhs.true.i39
  %call20.i = tail call ptr @sharing_GetDataList(ptr noundef nonnull %Inst.0.val.i, ptr noundef nonnull %ShIndex.0.i) #12
...
for.body25.i:                                     ; preds = %if.then19.i, %if.end80.i
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %HelpClause.i) #12
  ...
  %L.val.i.i40 = load ptr, ptr %42, align 8
  %43 = getelementptr i8, ptr %L.val.i.i40, i64 56
  %call.val.i.i41 = load ptr, ptr %43, align 8
  br label %while.cond.i.i42

while.cond.i.i42:                                 ; preds = %while.cond.i.i42, %for.body25.i
  %indvars.iv.i.i43 = phi i64 [ %indvars.iv.next.i.i46, %while.cond.i.i42 ], [ 0, %for.body25.i ]
  %arrayidx.i.i.i44 = getelementptr inbounds ptr, ptr %call.val.i.i41, i64 %indvars.iv.i.i43
  %44 = load ptr, ptr %arrayidx.i.i.i44, align 8
  %cmp.not.i.i45 = icmp eq ptr %44, %LitList.0.val.i
  %indvars.iv.next.i.i46 = add nuw i64 %indvars.iv.i.i43, 1
  br i1 %cmp.not.i.i45, label %clause_LiteralGetIndex.exit.i47, label %while.cond.i.i42, !llvm.loop !12

clause_LiteralGetIndex.exit.i47:                  ; preds = %while.cond.i.i42
  %45 = trunc i64 %indvars.iv.i.i43 to i32
...
land.lhs.true31.i:                                ; preds = %clause_LiteralGetIndex.exit.i47
  %46 = getelementptr i8, ptr %L.val.i.i40, i64 64
...
if.end.i.i:                                       ; preds = %while.body.i.i
  %List.addr.0.val5.i.i = load ptr, ptr %List.addr.07.i.i, align 8
  %cmp.i.not.i.i48 = icmp eq ptr %List.addr.0.val5.i.i, null
  br i1 %cmp.i.not.i.i48, label %land.lhs.true37.i, label %while.body.i.i, !llvm.loop !13

land.lhs.true37.i:                                ; preds = %if.end.i.i, %land.lhs.true34.i
  %call38.i = call fastcc i32 @red_CRwTautologyCheck(ptr noundef %Search, ptr noundef nonnull %L.val.i.i40, i32 noundef %45, ptr noundef nonnull %Inst.0.val.i, ptr noundef nonnull %RuleClause, i32 noundef %39, i32 noundef %Mode, ptr noundef nonnull %HelpClause.i), !range !5
  %tobool39.not.i = icmp eq i32 %call38.i, 0
...
if.then40.i:                                      ; preds = %land.lhs.true37.i
  ...
  %call42.i = tail call ptr @clause_Copy(ptr noundef nonnull %L.val.i.i40) #12
...
if.then.i.i49:                                    ; preds = %if.then40.i
  %sub.i.i50 = add i32 %48, -1
  store i32 %sub.i.i50, ptr %flags.i.i, align 8
  br label %clause_RemoveFlag.exit.i
...
clause_RemoveFlag.exit.i:                         ; preds = %if.then.i.i49, %if.then40.i
  ...
  %call44.i = tail call i32 @unify_MatchBindings(ptr noundef %51, ptr noundef %call6.val.val.i, ptr noundef nonnull %Inst.0.val.i) #12
  %52 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  ...
  %call51.i = tail call ptr @term_Copy(ptr noundef %call49.val.val.val.i) #12
  %call52.i = tail call ptr @cont_ApplyBindingsModuloMatching(ptr noundef %52, ptr noundef %call51.i, i32 noundef 1) #12
  %.pr.i.i = load i32, ptr @cont_BINDINGS, align 4
  %cmp2.i.i = icmp sgt i32 %.pr.i.i, 0
  br i1 %cmp2.i.i, label %while.body.i157.i.preheader, label %while.end.i.i

while.body.i157.i.preheader:                      ; preds = %clause_RemoveFlag.exit.i
  %xtraiter = and i32 %.pr.i.i, 1
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %while.body.i157.i.prol.loopexit, label %while.body.i157.i.prol

while.body.i157.i.prol:                           ; preds = %while.body.i157.i.preheader
  ...
  br label %while.body.i157.i.prol.loopexit

while.body.i157.i.prol.loopexit:                  ; preds = %while.body.i157.i.prol, %while.body.i157.i.preheader
  %.unr = phi i32 [ %.pr.i.i, %while.body.i157.i.preheader ], [ %dec.i.i.i.i.prol, %while.body.i157.i.prol ]
  %60 = icmp eq i32 %.pr.i.i, 1
  br i1 %60, label %while.end.i.i, label %while.body.i157.i

while.body.i157.i:                                ; preds = %while.body.i157.i.prol.loopexit, %while.body.i157.i
  %61 = phi i32 [ %dec.i.i.i.i.1, %while.body.i157.i ], [ %.unr, %while.body.i157.i.prol.loopexit ]
  ...
  %cmp.i158.i.1 = icmp ugt i32 %dec.i.i.i.i, 1
  br i1 %cmp.i158.i.1, label %while.body.i157.i, label %while.end.i.i, !llvm.loop !36

while.end.i.i:                                    ; preds = %while.body.i157.i.prol.loopexit, %while.body.i157.i, %clause_RemoveFlag.exit.i
  %68 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i152.i = icmp eq i32 %68, 0
  br i1 %cmp.i.not.i152.i, label %cont_BackTrack.exit.i, label %if.then.i153.i

if.then.i153.i:                                   ; preds = %while.end.i.i
  %dec.i.i.i = add nsw i32 %68, -1
  store i32 %dec.i.i.i, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i154.i = sext i32 %dec.i.i.i to i64
  %arrayidx.i.i155.i = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i154.i
  %69 = load i32, ptr %arrayidx.i.i155.i, align 4
  store i32 %69, ptr @cont_BINDINGS, align 4
  br label %cont_BackTrack.exit.i

cont_BackTrack.exit.i:                            ; preds = %if.then.i153.i, %while.end.i.i
  %70 = getelementptr i8, ptr %call42.i, i64 56
  %call42.val.i = load ptr, ptr %70, align 8
  %sext.i = shl i64 %indvars.iv.i.i43, 32
...
clause_GetLiteralAtom.exit.i:                     ; preds = %if.then.i.i.i, %cont_BackTrack.exit.i
  ...
  %call55.i = tail call i32 @term_ReplaceSubtermBy(ptr noundef %retval.0.i.i.i, ptr noundef nonnull %Inst.0.val.i, ptr noundef %call52.i) #12
  tail call void @term_Delete(ptr noundef %call52.i) #12
  %76 = load i32, ptr %arrayidx.i.i36, align 4
...
if.end67.i:                                       ; preds = %if.then60.i, %if.then58.i
  ...
  %Clause.val.i.i51 = load ptr, ptr %79, align 8
  %cmp.i.not5.i.i.i = icmp eq ptr %Clause.val.i.i51, null
...
while.body.i.i.i:                                 ; preds = %if.end67.i, %while.body.i.i.i
  %Current.06.i.i.i = phi ptr [ %Current.0.val.i.i.i, %while.body.i.i.i ], [ %Clause.val.i.i51, %if.end67.i ]
...
list_Delete.exit.i.i:                             ; preds = %while.body.i.i.i, %if.end67.i
  ...
  br i1 %cmp.i.not5.i16.i.i, label %red_DocumentContextualRewriting.exit.i, label %while.body.i17.i.i

while.body.i17.i.i:                               ; preds = %list_Delete.exit.i.i, %while.body.i17.i.i
  %Current.06.i18.i.i = phi ptr [ %Current.0.val.i19.i.i, %while.body.i17.i.i ], [ %Clause.val14.i.i, %list_Delete.exit.i.i ]
  ...
  %total_size.i.i.i20.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %86, i64 0, i32 4
  %87 = load i32, ptr %total_size.i.i.i20.i.i, align 8
  %conv26.i.i.i21.i.i = sext i32 %87 to i64
  %88 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i22.i.i = add i64 %88, %conv26.i.i.i21.i.i
  store i64 %add27.i.i.i22.i.i, ptr @memory_FREEDBYTES, align 8
  %89 = load ptr, ptr %86, align 8
  store ptr %89, ptr %Current.06.i18.i.i, align 8
  %90 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i18.i.i, ptr %90, align 8
  %cmp.i.not.i23.i.i = icmp eq ptr %Current.0.val.i19.i.i, null
  br i1 %cmp.i.not.i23.i.i, label %red_DocumentContextualRewriting.exit.i, label %while.body.i17.i.i, !llvm.loop !8

red_DocumentContextualRewriting.exit.i:           ; preds = %while.body.i17.i.i, %list_Delete.exit.i.i
  ...
  %call.i.i28.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i.i32.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i.i36.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
if.then.i68:                                      ; preds = %if.end68.i
  ...
  %or.i.i70 = or i32 %99, 8
  store i32 %or.i.i70, ptr %flags.i.i, align 8
  br label %if.end.i71

if.end.i71:                                       ; preds = %if.then.i68, %if.end68.i
  %Partner.val19.i72 = load i32, ptr %9, align 4
  %cmp.i73 = icmp eq i32 %Partner.val19.i72, 0
  br i1 %cmp.i73, label %clause_UpdateSplitDataFromPartner.exit149, label %if.end3.i74

if.end3.i74:                                      ; preds = %if.end.i71
  %100 = getelementptr i8, ptr %call42.i, i64 12
  %Result.val17.i75 = load i32, ptr %100, align 4
  %spec.select.i76 = tail call i32 @llvm.umax.i32(i32 %Partner.val19.i72, i32 %Result.val17.i75)
  store i32 %spec.select.i76, ptr %100, align 4
  %splitfield_length.i.i77 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call42.i, i64 0, i32 5
  %101 = load i32, ptr %splitfield_length.i.i77, align 8
  %102 = load i32, ptr %splitfield_length1.i.i78, align 8
  %cmp.i21.i79 = icmp ult i32 %101, %102
  br i1 %cmp.i21.i79, label %if.then.i.i.i92, label %if.end.i.i80

if.then.i.i.i92:                                  ; preds = %if.end3.i74
  %mul.i.i.i93 = shl i32 %102, 3
  %call.i.i.i94 = tail call ptr @memory_Malloc(i32 noundef %mul.i.i.i93) #12
  %103 = load i32, ptr %splitfield_length.i.i77, align 8
  %cmp349.not.i.i.i95 = icmp eq i32 %103, 0
  br i1 %cmp349.not.i.i.i95, label %for.cond8.preheader.i.i.i104, label %for.body.lr.ph.i.i.i96

for.body.lr.ph.i.i.i96:                           ; preds = %if.then.i.i.i92
  %splitfield.i.i.i97 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call42.i, i64 0, i32 4
  br label %for.body.i.i.i98

for.cond8.preheader.i.i.i104:                     ; preds = %for.body.i.i.i98, %if.then.i.i.i92
  %.lcssa.i.i.i105 = phi i32 [ 0, %if.then.i.i.i92 ], [ %113, %for.body.i.i.i98 ]
  %cmp951.i.i.i106 = icmp ult i32 %.lcssa.i.i.i105, %102
  br i1 %cmp951.i.i.i106, label %for.body11.preheader.i.i.i147, label %for.end16.i.i.i107

for.body11.preheader.i.i.i147:                    ; preds = %for.cond8.preheader.i.i.i104
  %104 = zext i32 %.lcssa.i.i.i105 to i64
  %105 = shl nuw nsw i64 %104, 3
  %scevgep.i.i.i148 = getelementptr i8, ptr %call.i.i.i94, i64 %105
  %106 = xor i32 %.lcssa.i.i.i105, -1
  %107 = add i32 %102, %106
  %108 = zext i32 %107 to i64
  %109 = shl nuw nsw i64 %108, 3
  %110 = add nuw nsw i64 %109, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep.i.i.i148, i8 0, i64 %110, i1 false)
  br label %for.end16.i.i.i107
...
for.body.i.i.i98:                                 ; preds = %for.body.i.i.i98, %for.body.lr.ph.i.i.i96
  ...
  %111 = load ptr, ptr %splitfield.i.i.i97, align 8
  %arrayidx.i.i.i100 = getelementptr inbounds i64, ptr %111, i64 %indvars.iv.i.i.i99
  %112 = load i64, ptr %arrayidx.i.i.i100, align 8
  %arrayidx6.i.i.i101 = getelementptr inbounds i64, ptr %call.i.i.i94, i64 %indvars.iv.i.i.i99
  store i64 %112, ptr %arrayidx6.i.i.i101, align 8
  %indvars.iv.next.i.i.i102 = add nuw nsw i64 %indvars.iv.i.i.i99, 1
  %113 = load i32, ptr %splitfield_length.i.i77, align 8
  %114 = zext i32 %113 to i64
  %cmp3.i.i.i103 = icmp ult i64 %indvars.iv.next.i.i.i102, %114
  br i1 %cmp3.i.i.i103, label %for.body.i.i.i98, label %for.cond8.preheader.i.i.i104, !llvm.loop !27

for.end16.i.i.i107:                               ; preds = %for.body11.preheader.i.i.i147, %for.cond8.preheader.i.i.i104
  %splitfield17.i.i.i108 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call42.i, i64 0, i32 4
  %115 = load ptr, ptr %splitfield17.i.i.i108, align 8
  %cmp18.not.i.i.i109 = icmp eq ptr %115, null
  br i1 %cmp18.not.i.i.i109, label %clause_ExpandSplitField.exit.i.i137, label %if.then20.i.i.i110

if.then20.i.i.i110:                               ; preds = %for.end16.i.i.i107
  %116 = load i32, ptr %splitfield_length.i.i77, align 8
  %mul24.i.i.i111 = shl i32 %116, 3
  %cmp.i.i.i.i.i112 = icmp ult i32 %mul24.i.i.i111, 1024
  br i1 %cmp.i.i.i.i.i112, label %if.else25.i.i.i.i141, label %if.then.i.i.i.i113

if.then.i.i.i.i113:                               ; preds = %if.then20.i.i.i110
  %rem2.i.i.i.i.i.i114 = urem i32 %mul24.i.i.i111, %10
  %tobool3.not.i.i.i.i.i.i115 = icmp eq i32 %rem2.i.i.i.i.i.i114, 0
  %sub6.i.i.i.i.i.i116 = sub i32 %10, %rem2.i.i.i.i.i.i114
  %add7.i.i.i.i.i.i117 = select i1 %tobool3.not.i.i.i.i.i.i115, i32 0, i32 %sub6.i.i.i.i.i.i116
  %RealSize.1.i.i.i.i.i.i118 = add i32 %add7.i.i.i.i.i.i117, %mul24.i.i.i111
  %117 = load i32, ptr @memory_OFFSET, align 4
  %idx.ext.i.i.i.i119 = zext i32 %117 to i64
  %idx.neg.i.i.i.i120 = sub nsw i64 0, %idx.ext.i.i.i.i119
  %add.ptr.i.i.i.i121 = getelementptr inbounds i8, ptr %115, i64 %idx.neg.i.i.i.i120
  %add.ptr1.i.i.i.i122 = getelementptr inbounds i8, ptr %add.ptr.i.i.i.i121, i64 -16
  %118 = load ptr, ptr %add.ptr1.i.i.i.i122, align 8
  %cmp2.not.i.i.i.i123 = icmp eq ptr %118, null
  %next6.i.i.i.i124 = getelementptr inbounds i8, ptr %add.ptr.i.i.i.i121, i64 -8
  %119 = load ptr, ptr %next6.i.i.i.i124, align 8
  %next5.i.i.i.i125 = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %118, i64 0, i32 1
  %memory_BIGBLOCKS.sink.i.i.i.i126 = select i1 %cmp2.not.i.i.i.i123, ptr @memory_BIGBLOCKS, ptr %next5.i.i.i.i125
  store ptr %119, ptr %memory_BIGBLOCKS.sink.i.i.i.i126, align 8
  %120 = load ptr, ptr %next6.i.i.i.i124, align 8
  %cmp8.not.i.i.i.i127 = icmp eq ptr %120, null
  br i1 %cmp8.not.i.i.i.i127, label %if.end13.i.i.i.i129, label %if.then9.i.i.i.i128

if.then9.i.i.i.i128:                              ; preds = %if.then.i.i.i.i113
  %121 = load ptr, ptr %add.ptr1.i.i.i.i122, align 8
  store ptr %121, ptr %120, align 8
  br label %if.end13.i.i.i.i129

if.end13.i.i.i.i129:                              ; preds = %if.then9.i.i.i.i128, %if.then.i.i.i.i113
  %122 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i.i.i130 = add i32 %RealSize.1.i.i.i.i.i.i118, %122
  %conv.i.i.i.i131 = zext i32 %add.i.i.i.i130 to i64
  %add14.i.i.i.i132 = add nuw nsw i64 %conv.i.i.i.i131, 16
  %123 = load i64, ptr @memory_FREEDBYTES, align 8
  %add15.i.i.i.i133 = add i64 %add14.i.i.i.i132, %123
  store i64 %add15.i.i.i.i133, ptr @memory_FREEDBYTES, align 8
  %124 = load i64, ptr @memory_MAXMEM, align 8
  %cmp16.i.i.i.i134 = icmp sgt i64 %124, -1
  br i1 %cmp16.i.i.i.i134, label %if.then18.i.i.i.i139, label %if.end23.i.i.i.i135

if.then18.i.i.i.i139:                             ; preds = %if.end13.i.i.i.i129
  %add22.i.i.i.i140 = add nuw i64 %124, %add14.i.i.i.i132
  store i64 %add22.i.i.i.i140, ptr @memory_MAXMEM, align 8
  br label %if.end23.i.i.i.i135

if.end23.i.i.i.i135:                              ; preds = %if.then18.i.i.i.i139, %if.end13.i.i.i.i129
  %add.ptr24.i.i.i.i136 = getelementptr inbounds i8, ptr %115, i64 -16
  tail call void @free(ptr noundef nonnull %add.ptr24.i.i.i.i136) #12
  br label %clause_ExpandSplitField.exit.i.i137

if.else25.i.i.i.i141:                             ; preds = %if.then20.i.i.i110
  %idxprom.i.i.i.i142 = zext i32 %mul24.i.i.i111 to i64
  %arrayidx.i.i.i.i143 = getelementptr inbounds [0 x ptr], ptr @memory_ARRAY, i64 0, i64 %idxprom.i.i.i.i142
  %125 = load ptr, ptr %arrayidx.i.i.i.i143, align 8
  %total_size.i.i.i.i144 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %125, i64 0, i32 4
  %126 = load i32, ptr %total_size.i.i.i.i144, align 8
  %conv26.i.i.i.i145 = sext i32 %126 to i64
  %127 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i146 = add i64 %127, %conv26.i.i.i.i145
  store i64 %add27.i.i.i.i146, ptr @memory_FREEDBYTES, align 8
  %128 = load ptr, ptr %125, align 8
  store ptr %128, ptr %115, align 8
  %129 = load ptr, ptr %arrayidx.i.i.i.i143, align 8
  store ptr %115, ptr %129, align 8
  br label %clause_ExpandSplitField.exit.i.i137

clause_ExpandSplitField.exit.i.i137:              ; preds = %if.else25.i.i.i.i141, %if.end23.i.i.i.i135, %for.end16.i.i.i107
  store ptr %call.i.i.i94, ptr %splitfield17.i.i.i108, align 8
  store i32 %102, ptr %splitfield_length.i.i77, align 8
  %.pre.i.i138 = load i32, ptr %splitfield_length1.i.i78, align 8
  br label %if.end.i.i80

if.end.i.i80:                                     ; preds = %clause_ExpandSplitField.exit.i.i137, %if.end3.i74
  %130 = phi i32 [ %.pre.i.i138, %clause_ExpandSplitField.exit.i.i137 ], [ %102, %if.end3.i74 ]
  %cmp421.not.i.i81 = icmp eq i32 %130, 0
  br i1 %cmp421.not.i.i81, label %clause_UpdateSplitDataFromPartner.exit149, label %for.body.lr.ph.i.i82

for.body.lr.ph.i.i82:                             ; preds = %if.end.i.i80
  %splitfield.i.i83 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call42.i, i64 0, i32 4
  br label %for.body.i.i85

for.body.i.i85:                                   ; preds = %for.body.i.i85, %for.body.lr.ph.i.i82
  %indvars.iv.i.i86 = phi i64 [ 0, %for.body.lr.ph.i.i82 ], [ %indvars.iv.next.i.i90, %for.body.i.i85 ]
  %131 = load ptr, ptr %splitfield.i.i83, align 8
  %arrayidx.i.i87 = getelementptr inbounds i64, ptr %131, i64 %indvars.iv.i.i86
  %132 = load i64, ptr %arrayidx.i.i87, align 8
  %133 = load ptr, ptr %splitfield5.i.i84, align 8
  %arrayidx7.i.i88 = getelementptr inbounds i64, ptr %133, i64 %indvars.iv.i.i86
  %134 = load i64, ptr %arrayidx7.i.i88, align 8
  %or.i22.i89 = or i64 %134, %132
  store i64 %or.i22.i89, ptr %arrayidx.i.i87, align 8
  %indvars.iv.next.i.i90 = add nuw nsw i64 %indvars.iv.i.i86, 1
  %135 = load i32, ptr %splitfield_length1.i.i78, align 8
  %136 = zext i32 %135 to i64
  %cmp4.i.i91 = icmp ult i64 %indvars.iv.next.i.i90, %136
  br i1 %cmp4.i.i91, label %for.body.i.i85, label %clause_UpdateSplitDataFromPartner.exit149, !llvm.loop !28

clause_UpdateSplitDataFromPartner.exit149:        ; preds = %for.body.i.i85, %if.end.i71, %if.end.i.i80
...
if.then70.i:                                      ; preds = %clause_UpdateSplitDataFromPartner.exit149
  ...
  br i1 %tobool.not.i, label %if.end.i56, label %if.then.i54

if.then.i54:                                      ; preds = %if.then70.i
  %139 = load i32, ptr %flags.i.i, align 8
  %or.i.i = or i32 %139, 8
  store i32 %or.i.i, ptr %flags.i.i, align 8
  br label %if.end.i56

if.end.i56:                                       ; preds = %if.then.i54, %if.then70.i
...
if.end3.i:                                        ; preds = %if.end.i56
  ...
  br i1 %cmp.i21.i, label %if.then.i.i.i61, label %if.end.i.i57

if.then.i.i.i61:                                  ; preds = %if.end3.i
...
for.body.lr.ph.i.i.i:                             ; preds = %if.then.i.i.i61
  %splitfield.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call42.i, i64 0, i32 4
  br label %for.body.i.i.i

for.cond8.preheader.i.i.i:                        ; preds = %for.body.i.i.i, %if.then.i.i.i61
  %.lcssa.i.i.i = phi i32 [ 0, %if.then.i.i.i61 ], [ %154, %for.body.i.i.i ]
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i
  ...
  %arrayidx.i.i.i62 = getelementptr inbounds i64, ptr %152, i64 %indvars.iv.i.i.i
  %153 = load i64, ptr %arrayidx.i.i.i62, align 8
  %arrayidx6.i.i.i = getelementptr inbounds i64, ptr %call.i.i.i, i64 %indvars.iv.i.i.i
...
if.else25.i.i.i.i:                                ; preds = %if.then20.i.i.i
  ...
  %total_size.i.i.i.i63 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %166, i64 0, i32 4
  %167 = load i32, ptr %total_size.i.i.i.i63, align 8
  %conv26.i.i.i.i64 = sext i32 %167 to i64
  %168 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i65 = add i64 %168, %conv26.i.i.i.i64
  store i64 %add27.i.i.i.i65, ptr @memory_FREEDBYTES, align 8
...
if.end.i.i57:                                     ; preds = %clause_ExpandSplitField.exit.i.i, %if.end3.i
  %171 = phi i32 [ %.pre.i.i, %clause_ExpandSplitField.exit.i.i ], [ %143, %if.end3.i ]
  %cmp421.not.i.i = icmp eq i32 %171, 0
  br i1 %cmp421.not.i.i, label %clause_UpdateSplitDataFromPartner.exit, label %for.body.lr.ph.i.i

for.body.lr.ph.i.i:                               ; preds = %if.end.i.i57
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  %indvars.iv.i.i58 = phi i64 [ 0, %for.body.lr.ph.i.i ], [ %indvars.iv.next.i.i60, %for.body.i.i ]
  %172 = load ptr, ptr %splitfield.i.i, align 8
  %arrayidx.i.i59 = getelementptr inbounds i64, ptr %172, i64 %indvars.iv.i.i58
  %173 = load i64, ptr %arrayidx.i.i59, align 8
  %174 = load ptr, ptr %splitfield5.i.i, align 8
  %arrayidx7.i.i = getelementptr inbounds i64, ptr %174, i64 %indvars.iv.i.i58
  %175 = load i64, ptr %arrayidx7.i.i, align 8
  %or.i22.i = or i64 %175, %173
  store i64 %or.i22.i, ptr %arrayidx.i.i59, align 8
  %indvars.iv.next.i.i60 = add nuw nsw i64 %indvars.iv.i.i58, 1
  %176 = load i32, ptr %splitfield_length1.i.i, align 8
  %177 = zext i32 %176 to i64
  %cmp4.i.i = icmp ult i64 %indvars.iv.next.i.i60, %177
  br i1 %cmp4.i.i, label %for.body.i.i, label %clause_UpdateSplitDataFromPartner.exit, !llvm.loop !28

clause_UpdateSplitDataFromPartner.exit:           ; preds = %for.body.i.i, %if.end.i56, %if.end.i.i57
  tail call void @clause_Delete(ptr noundef nonnull %.pre.i) #12
  br label %if.end71.i

if.end71.i:                                       ; preds = %clause_UpdateSplitDataFromPartner.exit, %clause_UpdateSplitDataFromPartner.exit149
  tail call void @clause_OrientEqualities(ptr noundef nonnull %call42.i, ptr noundef %Search.val.i, ptr noundef %Search.val134.i) #12
  tail call void @clause_Normalize(ptr noundef nonnull %call42.i) #12
  tail call void @clause_SetMaxLitFlags(ptr noundef nonnull %call42.i, ptr noundef %Search.val.i, ptr noundef %Search.val134.i) #12
  %call.i.i.i164.i = tail call i32 @clause_ComputeWeight(ptr noundef nonnull %call42.i, ptr noundef %Search.val.i) #12
  ...
  tail call void @clause_UpdateMaxVar(ptr noundef nonnull %call42.i) #12
...
if.then74.i:                                      ; preds = %if.end71.i
  ...
  tail call void @clause_Print(ptr noundef nonnull %L.val.i.i40) #12
  ...
  tail call void @clause_Print(ptr noundef nonnull %call42.i) #12
  br label %if.end78.i
...
if.end80.i:                                       ; preds = %while.body.i.i, %if.end78.i, %land.lhs.true37.i, %land.lhs.true31.i, %clause_LiteralGetIndex.exit.i47
  %Blocked.2.i = phi ptr [ %call.i.i, %if.end78.i ], [ %Blocked.1179.i, %land.lhs.true37.i ], [ %Blocked.1179.i, %land.lhs.true31.i ], [ %Blocked.1179.i, %clause_LiteralGetIndex.exit.i47 ], [ %Blocked.1179.i, %while.body.i.i ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %HelpClause.i) #12
...
for.inc83.i:                                      ; preds = %if.end80.i, %if.then19.i, %symbol_IsPredicate.exit.i, %for.body.i37
  ...
  %cmp.i.not.i38 = icmp eq ptr %L.val.i169.i, null
  br i1 %cmp.i.not.i38, label %for.end, label %for.body.i37, !llvm.loop !38
...
for.end:                                          ; preds = %for.inc, %for.inc83.i, %if.then, %entry
  ...
  %call15 = tail call ptr @list_PointerDeleteDuplicates(ptr noundef %Blocked.0.lcssa) #12
  ret ptr %call15
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %EmptyClauses) #12
  store ptr null, ptr %EmptyClauses, align 8
  %call1 = tail call ptr @clause_ListSortWeighed(ptr noundef %DerivedClauses) #12
...
sw.bb19:                                          ; preds = %if.then17
  %call20 = call i32 @clause_ComputeTermDepth(ptr noundef nonnull %Clause.0) #12
  br label %sw.epilog

sw.default:                                       ; preds = %if.then17
  %11 = load ptr, ptr @stdout, align 8
  %call21 = call i32 @fflush(ptr noundef %11)
  call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str) #12
  call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.1) #12
...
if.then26:                                        ; preds = %if.then23
  ...
  call void @clause_Print(ptr noundef nonnull %Clause.0) #12
  br label %if.end28

if.end28:                                         ; preds = %if.then26, %if.then23
  call void @clause_Delete(ptr noundef nonnull %Clause.0) #12
...
if.then46:                                        ; preds = %if.then43
  ...
  call void @clause_Print(ptr noundef nonnull %Clause.2151) #12
  br label %land.lhs.true.i
...
if.then51:                                        ; preds = %clause_IsEmptyClause.exit
  ...
  %call.i122 = call ptr @memory_Malloc(i32 noundef 16) #12
...
if.else:                                          ; preds = %land.lhs.true.i, %land.lhs.true1.i, %clause_IsEmptyClause.exit
  ...
  %call54 = call i32 @list_Length(ptr noundef %call53) #12
...
for.body:                                         ; preds = %if.else, %for.body
  ...
  call void @clause_Print(ptr noundef %Scan.0.val) #12
...
if.end64:                                         ; preds = %for.body, %if.else
  %call65 = call ptr @split_ExtractEmptyClauses(ptr noundef %call53, ptr noundef nonnull %EmptyClauses) #12
  call void @prfs_InsertUsableClause(ptr noundef %Search, ptr noundef nonnull %Clause.2151) #12
  %call66 = call ptr @list_NumberSort(ptr noundef %call65, ptr noundef nonnull @clause_Weight) #12
  %call.i127 = call ptr @list_NNumberMerge(ptr noundef %3, ptr noundef %call66, ptr noundef nonnull @clause_Weight) #12
  br label %if.end69
...
while.end:                                        ; preds = %while.end.loopexit, %entry
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %EmptyClauses) #12
  ret ptr %32
}
...
if.then6:                                         ; preds = %if.end
  ...
  tail call void @clause_Print(ptr noundef nonnull %RedClause) #12
  br label %if.end8

if.end8:                                          ; preds = %if.then6, %if.end
  %call9 = tail call ptr @st_IndexCreate() #12
...
clause_LiteralAtom.exit:                          ; preds = %for.body, %if.then.i
  ...
  %call17 = tail call ptr @term_Copy(ptr noundef %retval.0.i) #12
  %call.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i, i64 0, i32 1
...
for.end:                                          ; preds = %clause_LiteralAtom.exit, %if.end8
  ...
  %call19 = tail call ptr @list_NReverse(ptr noundef %Scan.0.lcssa) #12
  %call22 = tail call ptr @clause_Create(ptr noundef %call19, ptr noundef null, ptr noundef null, ptr noundef %Flags, ptr noundef %Precedence) #12
...
list_Delete.exit:                                 ; preds = %while.body.i, %for.end
  ...
  %call.i.i194 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  tail call void @clause_InsertFlatIntoIndex(ptr noundef %call22, ptr noundef %call9) #12
  %call.i.i196 = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
if.then30:                                        ; preds = %list_Delete.exit
  ...
  tail call void @clause_ListPrint(ptr noundef nonnull %call.i.i196) #12
  %call33 = tail call i32 @puts(ptr noundef nonnull dereferenceable(1) @.str.8)
  tail call void @clause_ListPrint(ptr noundef null) #12
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end101
  %ApproxWOList.0282 = phi ptr [ null, %while.body.lr.ph ], [ %ApproxWOList.6, %if.end101 ]
  %ApproxUsableList.0281 = phi ptr [ %call.i.i196, %while.body.lr.ph ], [ %ApproxUsableList.6, %if.end101 ]
  %21 = getelementptr i8, ptr %ApproxUsableList.0281, i64 8
...
if.then42:                                        ; preds = %while.body
  ...
  call void @clause_Print(ptr noundef nonnull %.val186) #12
  %26 = load ptr, ptr @stdout, align 8
  %call44 = call i32 @fflush(ptr noundef %26)
  br label %if.end45

if.end45:                                         ; preds = %if.then42, %while.body
  %call.i204 = call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i205 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i204, i64 0, i32 1
  store ptr %.val186, ptr %car.i205, align 8
  store ptr %ApproxWOList.0282, ptr %call.i204, align 8
  %call47 = call ptr @list_PointerDeleteOneElement(ptr noundef nonnull %ApproxUsableList.0281, ptr noundef nonnull %.val186) #12
  %call.i206 = call i32 @clause_HasTermSortConstraintLits(ptr noundef nonnull %.val186) #12
...
if.then.i207:                                     ; preds = %if.end45
  %call2.i = call ptr @inf_ForwardSortResolution(ptr noundef nonnull %.val186, ptr noundef %Theory.val.i, ptr noundef nonnull %Theory, i32 noundef 1, ptr noundef nonnull %Flags, ptr noundef %Precedence) #12
  br label %red_CDDerivables.exit

if.else.i:                                        ; preds = %if.end45
  %call4.i = call ptr @inf_ForwardEmptySort(ptr noundef nonnull %.val186, ptr noundef %Theory.val.i, ptr noundef nonnull %Theory, i32 noundef 1, ptr noundef nonnull %Flags, ptr noundef %Precedence) #12
  br label %red_CDDerivables.exit
...
red_CDDerivables.exit:                            ; preds = %if.then.i207, %if.else.i
  ...
  %call49 = call ptr @split_ExtractEmptyClauses(ptr noundef %ListOfDerivedClauses.0.i, ptr noundef nonnull %EmptyClauses) #12
...
clause_GetLiteralAtom.exit.i.i.i:                 ; preds = %if.then.i.i.i.i.i, %for.body.i.i.i
  ...
  %call3.i.i.i = call ptr @st_ExistGen(ptr noundef %44, ptr noundef %call9, ptr noundef %retval.0.i.i.i.i.i) #12
...
land.lhs.true.i.i.i:                              ; preds = %for.body8.i.i.i
  %call16.i.i.i = call i32 @subs_Subsumes(ptr noundef nonnull %call9.val.i.i.i, ptr noundef %Scan.1.val, i32 noundef 0, i32 noundef %45) #12
...
for.end.i.i.i:                                    ; preds = %for.inc.i.i.i, %while.body.i.i.i
  %call19.i.i.i = call ptr @st_NextCandidate() #12
...
for.inc20.i.i.i:                                  ; preds = %for.end.i.i.i, %clause_GetLiteralAtom.exit.i.i.i
  ...
  br i1 %exitcond.not.i.i.i, label %if.else.i219, label %for.body.i.i.i, !llvm.loop !45

if.then.i.i:                                      ; preds = %land.lhs.true.i.i.i
  call void @st_CancelExistRetrieval() #12
...
if.then6.i.i:                                     ; preds = %land.lhs.true.i28.i
  ...
  call void @clause_Print(ptr noundef %Scan.1.val) #12
...
if.else.i219:                                     ; preds = %for.inc20.i.i.i
  br i1 %cmp.not.i.i, label %if.then.i31.i, label %if.else.land.lhs.true.i.i29_crit_edge.i

if.else.land.lhs.true.i.i29_crit_edge.i:          ; preds = %if.else.i219
...
land.lhs.true.i.i29.i:                            ; preds = %if.else.land.lhs.true.i.i29_crit_edge.i, %if.end.i
  ...
  %cmp.i.not.i.i30.i = icmp eq i32 %C.val.i.i.i, 0
  br i1 %cmp.i.not.i.i30.i, label %land.lhs.true1.i.i.i, label %if.then.i31.i
...
if.then.i31.i:                                    ; preds = %clause_IsEmptyClause.exit.i.i, %land.lhs.true1.i.i.i, %land.lhs.true.i.i29.i, %if.else.i219
...
clause_GetLiteralAtom.exit.i.i:                   ; preds = %if.then.i.i.i.i, %if.then.i31.i
  ...
  %call5.i.i = call ptr @st_ExistInstance(ptr noundef %61, ptr noundef %call9, ptr noundef %retval.0.i.i.i.i) #12
...
clause_LiteralGetIndex.exit.i.i:                  ; preds = %while.cond.i.i.i
  ...
  %call15.i.i = call i32 @subs_Subsumes(ptr noundef %Scan.1.val, ptr noundef %call10.val.i.i, i32 noundef 0, i32 noundef %67) #12
...
land.lhs.true17.i.i:                              ; preds = %clause_LiteralGetIndex.exit.i.i
  ...
  br i1 %cmp.i.not6.i.i.i, label %if.then20.i.i, label %while.body.i.i36.i
...
if.end.i.i.i:                                     ; preds = %while.body.i.i36.i
  ...
  br i1 %cmp.i.not.i83.i.i, label %if.then20.i.i, label %while.body.i.i36.i, !llvm.loop !13

if.then20.i.i:                                    ; preds = %if.end.i.i.i, %land.lhs.true17.i.i
  %call.i.i.i = call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i.i, i64 0, i32 1
  store ptr %call10.val.i.i, ptr %car.i.i.i, align 8
  store ptr %SubsumedList.17.i.i, ptr %call.i.i.i, align 8
  br label %for.inc.i.i

for.inc.i.i:                                      ; preds = %while.body.i.i36.i, %if.then20.i.i, %clause_LiteralGetIndex.exit.i.i, %for.body.i.i
  %SubsumedList.2.i.i = phi ptr [ %call.i.i.i, %if.then20.i.i ], [ %SubsumedList.17.i.i, %clause_LiteralGetIndex.exit.i.i ], [ %SubsumedList.17.i.i, %for.body.i.i ], [ %SubsumedList.17.i.i, %while.body.i.i36.i ]
  %Scan.0.i.i = load ptr, ptr %Scan.08.i.i, align 8
  %cmp.i.not.i37.i = icmp eq ptr %Scan.0.i.i, null
  br i1 %cmp.i.not.i37.i, label %for.end.i.i, label %for.body.i.i, !llvm.loop !46
...
for.end.i.i:                                      ; preds = %for.inc.i.i, %while.body.i.i
  ...
  %call23.i.i = call ptr @st_NextCandidate() #12
...
if.then35.i.i:                                    ; preds = %land.lhs.true32.i.i
  ...
  call void @clause_Print(ptr noundef %Scan.1.val.i.i) #12
...
if.end39.i.i:                                     ; preds = %if.then35.i.i, %land.lhs.true32.i.i, %for.body28.i.i
  ...
  %call44.i.i = call ptr @list_PointerDeleteOneElement(ptr noundef %.sroa.speculated, ptr noundef nonnull %Scan.1.val.i.i) #12
  ...
  call void @clause_DeleteFlatFromIndex(ptr noundef nonnull %Scan.1.val.i.i, ptr noundef %call9) #12
  %Scan.1.val77.i.i = load ptr, ptr %Scan.114.i.i, align 8
  %cmp.i84.not.i.i = icmp eq ptr %Scan.1.val77.i.i, null
  br i1 %cmp.i84.not.i.i, label %while.body.i89.i.i, label %for.body28.i.i, !llvm.loop !48

while.body.i89.i.i:                               ; preds = %if.end39.i.i, %while.body.i89.i.i
  %Current.06.i.i.i = phi ptr [ %Current.0.val.i.i.i, %while.body.i89.i.i ], [ %SubsumedList.1.lcssa.i.i, %if.end39.i.i ]
  %Current.0.val.i.i.i = load ptr, ptr %Current.06.i.i.i, align 8
  ...
  %cmp.i.not.i90.i.i = icmp eq ptr %Current.0.val.i.i.i, null
  br i1 %cmp.i.not.i90.i.i, label %red_CDBackSubsumption.exit.i, label %while.body.i89.i.i, !llvm.loop !8

red_CDBackSubsumption.exit.i:                     ; preds = %while.body.i89.i.i, %for.cond24.preheader.i.i, %clause_GetLiteralAtom.exit.i.i, %clause_IsEmptyClause.exit.i.i
  %ApproxUsableList.4 = phi ptr [ %ApproxUsableList.1270, %clause_GetLiteralAtom.exit.i.i ], [ %ApproxUsableList.1270, %for.cond24.preheader.i.i ], [ %ApproxUsableList.1270, %clause_IsEmptyClause.exit.i.i ], [ %spec.select, %while.body.i89.i.i ]
  %ApproxWOList.4 = phi ptr [ %ApproxWOList.1271, %clause_GetLiteralAtom.exit.i.i ], [ %ApproxWOList.1271, %for.cond24.preheader.i.i ], [ %ApproxWOList.1271, %clause_IsEmptyClause.exit.i.i ], [ %spec.select261, %while.body.i89.i.i ]
  call void @clause_InsertFlatIntoIndex(ptr noundef %Scan.1.val, ptr noundef %call9) #12
  %call.i.i216 = call ptr @memory_Malloc(i32 noundef 16) #12
...
if.then71:                                        ; preds = %if.then6.i.i, %land.lhs.true.i28.i, %if.then.i.i
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %Copy.i) #12
  call void @clause_Delete(ptr noundef %Scan.1.val) #12
  br label %if.end84

if.else72:                                        ; preds = %red_CDBackSubsumption.exit.i, %clause_IsEmptyClause.exit.i
  %ApproxUsableList.5 = phi ptr [ %call.i.i216, %red_CDBackSubsumption.exit.i ], [ %ApproxUsableList.1270, %clause_IsEmptyClause.exit.i ]
...
if.then81:                                        ; preds = %clause_IsEmptyClause.exit
  ...
  %call.i223 = call ptr @memory_Malloc(i32 noundef 16) #12
...
for.end87:                                        ; preds = %if.end84
  ...
  br i1 %cmp.i226.not, label %while.body.i230, label %if.then90
...
while.body.i230:                                  ; preds = %for.end87, %while.body.i230
  %Current.06.i231 = phi ptr [ %Current.0.val.i232, %while.body.i230 ], [ %call49, %for.end87 ]
  %Current.0.val.i232 = load ptr, ptr %Current.06.i231, align 8
  %90 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i233 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %90, i64 0, i32 4
  %91 = load i32, ptr %total_size.i.i.i233, align 8
  %conv26.i.i.i234 = sext i32 %91 to i64
  %92 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i235 = add i64 %92, %conv26.i.i.i234
  store i64 %add27.i.i.i235, ptr @memory_FREEDBYTES, align 8
  %93 = load ptr, ptr %90, align 8
  store ptr %93, ptr %Current.06.i231, align 8
  %94 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i231, ptr %94, align 8
  %cmp.i.not.i236 = icmp eq ptr %Current.0.val.i232, null
  br i1 %cmp.i.not.i236, label %if.end101thread-pre-split, label %while.body.i230, !llvm.loop !8
...
if.end101thread-pre-split.sink.split.sink.split:  ; preds = %if.then55, %if.then93
  ...
  %.sink298 = load ptr, ptr %EmptyClauses, align 8
  %95 = getelementptr i8, ptr %.sink298, i64 8
  %.val = load ptr, ptr %95, align 8
  call void @clause_Print(ptr noundef %.val) #12
...
if.end101thread-pre-split.sink.split:             ; preds = %if.end101thread-pre-split.sink.split.sink.split, %if.then90, %if.then52
  ...
  call void @clause_DeleteClauseList(ptr noundef %call49) #12
  br label %if.end101thread-pre-split

if.end101thread-pre-split:                        ; preds = %while.body.i230, %if.end101thread-pre-split.sink.split
  %ApproxUsableList.6.ph = phi ptr [ %ApproxUsableList.6.ph.ph, %if.end101thread-pre-split.sink.split ], [ %ApproxUsableList.5255, %while.body.i230 ]
  %ApproxWOList.6.ph = phi ptr [ %ApproxWOList.6.ph.ph, %if.end101thread-pre-split.sink.split ], [ %ApproxWOList.5257, %while.body.i230 ]
...
if.then114:                                       ; preds = %if.else111
  ...
  call void @clause_Print(ptr noundef nonnull %RedClause) #12
  br label %if.end117

if.end117:                                        ; preds = %if.else111, %if.then114, %if.then104, %if.then107
  call void @clause_DeleteClauseListFlatFromIndex(ptr noundef %ApproxUsableList.6, ptr noundef %call9) #12
  call void @clause_DeleteClauseListFlatFromIndex(ptr noundef %ApproxWOList.6, ptr noundef %call9) #12
  call void @st_IndexDelete(ptr noundef %call9) #12
...
if.then120:                                       ; preds = %if.end117
  call void @clause_DeleteClauseList(ptr noundef nonnull %101) #12
  br label %cleanup
...
entry:
  ...
  %2 = load i32, ptr %arrayidx.i, align 4
  store ptr null, ptr %EmptyClauses, align 8
  %call4 = tail call ptr @clause_ListSortWeighed(ptr noundef %ClauseList) #12
...
if.then13:                                        ; preds = %clause_IsEmptyClause.exit
  %call.i.i = call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i, i64 0, i32 1
...
if.end25:                                         ; preds = %if.else
  ...
  %call18 = call ptr @inf_BoundedDepthUnitResolution(ptr noundef nonnull %call9, ptr noundef %Search.val71, i32 noundef 0, ptr noundef %Search.val, ptr noundef %Search.val70) #12
  %call19 = call i32 @list_Length(ptr noundef %call18) #12
...
list_Nconc.exit:                                  ; preds = %if.else, %if.end25, %if.end.i, %for.end.i
  ...
  %call27 = call ptr @split_ExtractEmptyClauses(ptr noundef %retval.0.i, ptr noundef nonnull %EmptyClauses) #12
  call void @prfs_InsertUsableClause(ptr noundef %Search, ptr noundef nonnull %call9) #12
...
for.end:                                          ; preds = %for.body
  ...
  br i1 %brmerge, label %if.end35, label %for.cond.i82
...
for.cond.i82:                                     ; preds = %for.end, %for.cond.i82
  %List1.addr.0.i83 = phi ptr [ %List1.addr.0.val17.i84, %for.cond.i82 ], [ %5, %for.end ]
  %List1.addr.0.val17.i84 = load ptr, ptr %List1.addr.0.i83, align 8
  %cmp.i20.not.i85 = icmp eq ptr %List1.addr.0.val17.i84, null
  br i1 %cmp.i20.not.i85, label %for.end.i86, label %for.cond.i82, !llvm.loop !10

for.end.i86:                                      ; preds = %for.cond.i82
  store ptr %call27, ptr %List1.addr.0.i83, align 8
  br label %if.end35
...
for.body40:                                       ; preds = %for.cond36.preheader, %for.body40
  ...
  call void @prfs_InsertUsableClause(ptr noundef %Search, ptr noundef %Scan.1.val) #12
...
entry:
  ...
  store ptr null, ptr %EmptyClauses, align 8
  %call3 = tail call ptr @list_Copy(ptr noundef %ClauseList) #12
  %call4 = tail call ptr @clause_ListSortWeighed(ptr noundef %call3) #12
  %call5 = call ptr @split_ExtractEmptyClauses(ptr noundef %call4, ptr noundef nonnull %EmptyClauses) #12
...
lor.rhs:                                          ; preds = %land.rhs
  ...
  %call11 = call float @clock_GetSeconds(i32 noundef 1) #12
...
for.body12.i:                                     ; preds = %for.inc21.i, %for.body12.lr.ph.i
  ...
  br i1 %cmp.i.not.i53.i, label %if.then.i55.i, label %clause_LiteralAtom.exit58.i

if.then.i55.i:                                    ; preds = %for.body12.i
  %30 = getelementptr i8, ptr %call13.val.i, i64 16
  %call1.val.i56.i = load ptr, ptr %30, align 8
  %31 = getelementptr i8, ptr %call1.val.i56.i, i64 8
  %call1.val.val.i57.i = load ptr, ptr %31, align 8
  %call14.val.pre.i = load i32, ptr %call1.val.val.i57.i, align 8
  br label %clause_LiteralAtom.exit58.i

clause_LiteralAtom.exit58.i:                      ; preds = %if.then.i55.i, %for.body12.i
  %call14.val.i = phi i32 [ %call14.val.pre.i, %if.then.i55.i ], [ %L.val7.val.i52.i, %for.body12.i ]
...
if.then17.i:                                      ; preds = %clause_LiteralAtom.exit58.i
  ...
  %call.i61.i = call ptr @memory_Malloc(i32 noundef 16) #12
...
for.end23.i:                                      ; preds = %for.inc21.i, %for.end.i
  ...
  call void @clause_DeleteLiterals(ptr noundef nonnull %4, ptr noundef %Indexes.2.lcssa.i, ptr noundef %Search.val, ptr noundef %Search.val52) #12
...
if.then20:                                        ; preds = %clause_IsEmptyClause.exit
  %call.i.i57 = call ptr @memory_Malloc(i32 noundef 16) #12
...
if.else:                                          ; preds = %land.lhs.true.i, %land.lhs.true1.i, %clause_IsEmptyClause.exit
  ...
  %call23 = call i32 @list_Length(ptr noundef %call22) #12
  %44 = load i32, ptr %derivedclauses.i, align 8
  %add.i = add nsw i32 %44, %call23
  store i32 %add.i, ptr %derivedclauses.i, align 8
  %call24 = call ptr @split_ExtractEmptyClauses(ptr noundef %call22, ptr noundef nonnull %EmptyClauses) #12
  call void @prfs_InsertUsableClause(ptr noundef nonnull %Search, ptr noundef nonnull %call16) #12
  %call25 = call ptr @clause_ListSortWeighed(ptr noundef %call24) #12
  %call.i = call ptr @list_NNumberMerge(ptr noundef %5, ptr noundef %call25, ptr noundef nonnull @clause_Weight) #12
  br label %if.end27
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  call void @prfs_InsertUsableClause(ptr noundef %Search, ptr noundef %Scan.0.val) #12
...
entry:
  ...
  %call5 = tail call i32 @list_Length(ptr noundef %Search.val112) #12
...
lor.rhs:                                          ; preds = %land.rhs
  ...
  %call10 = tail call float @clock_GetSeconds(i32 noundef 1) #12
...
if.then:                                          ; preds = %while.body
  ...
  %call17 = tail call ptr @inf_BoundedDepthUnitResolution(ptr noundef nonnull %Scan.0.val, ptr noundef %Search.val107, i32 noundef 0, ptr noundef nonnull %Search.val, ptr noundef %Search.val105) #12
  %call18 = tail call i32 @list_Length(ptr noundef %call17) #12
...
while.end:                                        ; preds = %lor.rhs, %if.end, %entry
  ...
  %call21 = tail call i32 @list_Length(ptr noundef %ClauseList.0.lcssa) #12
  %derivedclauses.i = getelementptr inbounds %struct.PROOFSEARCH_HELP, ptr %Search, i64 0, i32 20
...
lor.rhs38:                                        ; preds = %land.rhs34
  ...
  %call41 = tail call float @clock_GetSeconds(i32 noundef 1) #12
...
if.then53:                                        ; preds = %land.lhs.true50
  ...
  %call55 = tail call ptr @inf_BoundedDepthUnitResolution(ptr noundef nonnull %Scan.1.val, ptr noundef %Search.val106, i32 noundef 1, ptr noundef nonnull %Search.val, ptr noundef %Search.val105) #12
  %call56 = tail call i32 @list_Length(ptr noundef %call55) #12
  %sub57 = sub i32 %n.2163, %call56
  %cmp.i.not.i128 = icmp eq ptr %call55, null
  br i1 %cmp.i.not.i128, label %if.end59, label %if.end.i129

if.end.i129:                                      ; preds = %if.then53
  %cmp.i18.not.i130 = icmp eq ptr %ClauseList.2162, null
  br i1 %cmp.i18.not.i130, label %if.end59, label %for.cond.i131

for.cond.i131:                                    ; preds = %if.end.i129, %for.cond.i131
  %List1.addr.0.i132 = phi ptr [ %List1.addr.0.val17.i133, %for.cond.i131 ], [ %call55, %if.end.i129 ]
  %List1.addr.0.val17.i133 = load ptr, ptr %List1.addr.0.i132, align 8
  %cmp.i20.not.i134 = icmp eq ptr %List1.addr.0.val17.i133, null
  br i1 %cmp.i20.not.i134, label %for.end.i135, label %for.cond.i131, !llvm.loop !10

for.end.i135:                                     ; preds = %for.cond.i131
  store ptr %ClauseList.2162, ptr %List1.addr.0.i132, align 8
  br label %if.end59

if.end59:                                         ; preds = %for.end.i135, %if.end.i129, %if.then53, %land.lhs.true50, %while.body46
  %ClauseList.3 = phi ptr [ %ClauseList.2162, %land.lhs.true50 ], [ %ClauseList.2162, %while.body46 ], [ %call55, %for.end.i135 ], [ %ClauseList.2162, %if.then53 ], [ %call55, %if.end.i129 ]
  %n.3 = phi i32 [ %n.2163, %land.lhs.true50 ], [ %n.2163, %while.body46 ], [ %sub57, %for.end.i135 ], [ %sub57, %if.then53 ], [ %sub57, %if.end.i129 ]
...
while.end61:                                      ; preds = %lor.rhs38, %if.end59, %while.cond28.preheader
  ...
  %call62 = tail call i32 @list_Length(ptr noundef %ClauseList.2.lcssa) #12
  ...
  br i1 %cmp.i.not5.i140, label %if.end64, label %while.body.i141

while.body.i141:                                  ; preds = %while.end61, %while.body.i141
  %Current.06.i142 = phi ptr [ %Current.0.val.i143, %while.body.i141 ], [ %ClauseList.2.lcssa, %while.end61 ]
  ...
  br i1 %cmp.i.not.i147, label %if.end64, label %while.body.i141, !llvm.loop !8

if.end64:                                         ; preds = %while.body.i141, %while.end61, %list_Delete.exit
  %EmptyClauses.0 = phi ptr [ %call22, %list_Delete.exit ], [ %call63, %while.end61 ], [ %call63, %while.body.i141 ]
...
if.then:                                          ; preds = %land.lhs.true18
  ...
  %call23 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %11, ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.16, i32 noundef 4500) #14
  tail call void (ptr, ...) @misc_ErrorReport(ptr noundef nonnull @.str.17) #12
  tail call void @clause_Print(ptr noundef %Scan2.0.val) #12
  tail call void (ptr, ...) @misc_ErrorReport(ptr noundef nonnull @.str.18) #12
  %Scan1.0.val = load ptr, ptr %9, align 8
  tail call void @prfs_PrintSplit(ptr noundef %Scan1.0.val) #12
  %12 = load ptr, ptr @stderr, align 8
  %13 = tail call i64 @fwrite(ptr nonnull @.str.19, i64 132, i64 1, ptr %12) #14
  %14 = load ptr, ptr @stderr, align 8
  %15 = tail call i64 @fwrite(ptr nonnull @.str.47, i64 2, i64 1, ptr %14) #14
...
clause_GetLiteralAtom.exit:                       ; preds = %for.body, %if.then.i.i
  ...
  %call8 = tail call ptr @st_ExistGen(ptr noundef %14, ptr noundef %ShIndex.val194, ptr noundef %retval.0.i.i) #12
...
if.then.us:                                       ; preds = %while.body.us
  %call11.us = tail call ptr @sharing_NAtomDataList(ptr noundef nonnull %AtomGen.04.us) #12
...
if.end44.us:                                      ; preds = %for.inc.us.us, %for.inc.us.us.us, %for.body15.lr.ph.split.us.us.split.us, %if.then.us, %while.body.us
  %call45.us = tail call ptr @st_NextCandidate() #12
...
land.lhs.true38.us.us.us:                         ; preds = %clause_LiteralIsFromConstraint.exit.us.us.us
  %call40.us.us.us = tail call i32 @subs_SubsumesBasic(ptr noundef nonnull %call16.val.us.us.us, ptr noundef %RedCl, i32 noundef 0, i32 noundef %16) #12
...
land.lhs.true22.us.us:                            ; preds = %land.lhs.true.us.us
  br i1 %cmp23.not.fr, label %while.cond.i.i202.us.us.preheader, label %while.cond.i.i.us.us
...
clause_LiteralIsFromConstraint.exit.us.us:        ; preds = %while.cond.i.i.us.us
  ...
  br i1 %narrow.i.not.us.us, label %while.cond.i.i202.us.us.preheader, label %land.lhs.true38.us.us

while.cond.i.i202.us.us.preheader:                ; preds = %clause_LiteralIsFromConstraint.exit.us.us, %land.lhs.true22.us.us
  br label %while.cond.i.i202.us.us

while.cond.i.i202.us.us:                          ; preds = %while.cond.i.i202.us.us.preheader, %while.cond.i.i202.us.us
  %indvars.iv.i.i203.us.us = phi i64 [ %indvars.iv.next.i.i206.us.us, %while.cond.i.i202.us.us ], [ 0, %while.cond.i.i202.us.us.preheader ]
  %arrayidx.i.i.i204.us.us = getelementptr inbounds ptr, ptr %call17.val.us.us, i64 %indvars.iv.i.i203.us.us
  %31 = load ptr, ptr %arrayidx.i.i.i204.us.us, align 8
  %cmp.not.i.i205.us.us = icmp eq ptr %31, %LitScan.0.val.us.us
  %indvars.iv.next.i.i206.us.us = add nuw i64 %indvars.iv.i.i203.us.us, 1
  br i1 %cmp.not.i.i205.us.us, label %clause_LiteralIsFromAntecedent.exit.us.us, label %while.cond.i.i202.us.us, !llvm.loop !12

clause_LiteralIsFromAntecedent.exit.us.us:        ; preds = %while.cond.i.i202.us.us
  %32 = trunc i64 %indvars.iv.i.i203.us.us to i32
...
land.lhs.true38.us.us:                            ; preds = %clause_LiteralIsFromAntecedent.exit.us.us, %clause_LiteralIsFromConstraint.exit.us.us
  %call40.us.us = tail call i32 @subs_SubsumesBasic(ptr noundef nonnull %call16.val.us.us, ptr noundef %RedCl, i32 noundef 0, i32 noundef %15) #12
...
if.then:                                          ; preds = %while.body
  %call11 = tail call ptr @sharing_NAtomDataList(ptr noundef nonnull %AtomGen.04) #12
...
lor.lhs.false:                                    ; preds = %clause_LiteralIsFromConstraint.exit, %land.lhs.true22
  br i1 %or.cond.fr, label %while.cond.i.i213.preheader, label %while.cond.i.i202

while.cond.i.i202:                                ; preds = %lor.lhs.false, %while.cond.i.i202
  %indvars.iv.i.i203 = phi i64 [ %indvars.iv.next.i.i206, %while.cond.i.i202 ], [ 0, %lor.lhs.false ]
  %arrayidx.i.i.i204 = getelementptr inbounds ptr, ptr %call17.val, i64 %indvars.iv.i.i203
  %42 = load ptr, ptr %arrayidx.i.i.i204, align 8
  %cmp.not.i.i205 = icmp eq ptr %42, %LitScan.0.val
  %indvars.iv.next.i.i206 = add nuw i64 %indvars.iv.i.i203, 1
  br i1 %cmp.not.i.i205, label %clause_LiteralIsFromAntecedent.exit, label %while.cond.i.i202, !llvm.loop !12

clause_LiteralIsFromAntecedent.exit:              ; preds = %while.cond.i.i202
  %43 = trunc i64 %indvars.iv.i.i203 to i32
  ...
  br i1 %narrow.i209.not, label %while.cond.i.i213.preheader, label %land.lhs.true38

while.cond.i.i213.preheader:                      ; preds = %clause_LiteralIsFromAntecedent.exit, %lor.lhs.false
  br label %while.cond.i.i213

while.cond.i.i213:                                ; preds = %while.cond.i.i213.preheader, %while.cond.i.i213
  %indvars.iv.i.i214 = phi i64 [ %indvars.iv.next.i.i217, %while.cond.i.i213 ], [ 0, %while.cond.i.i213.preheader ]
  %arrayidx.i.i.i215 = getelementptr inbounds ptr, ptr %call17.val, i64 %indvars.iv.i.i214
  %46 = load ptr, ptr %arrayidx.i.i.i215, align 8
  %cmp.not.i.i216 = icmp eq ptr %46, %LitScan.0.val
  %indvars.iv.next.i.i217 = add nuw i64 %indvars.iv.i.i214, 1
  br i1 %cmp.not.i.i216, label %clause_LiteralIsFromSuccedent.exit, label %while.cond.i.i213, !llvm.loop !12

clause_LiteralIsFromSuccedent.exit:               ; preds = %while.cond.i.i213
  %47 = trunc i64 %indvars.iv.i.i214 to i32
...
land.lhs.true38:                                  ; preds = %clause_LiteralIsFromSuccedent.exit, %clause_LiteralIsFromAntecedent.exit, %clause_LiteralIsFromConstraint.exit
  %call40 = tail call i32 @subs_SubsumesBasic(ptr noundef nonnull %call16.val, ptr noundef %RedCl, i32 noundef 0, i32 noundef %15) #12
...
if.then42:                                        ; preds = %land.lhs.true38, %land.lhs.true38.us.us, %land.lhs.true38.us.us.us
  ...
  tail call void @st_CancelExistRetrieval() #12
  br label %cleanup
...
if.end44:                                         ; preds = %for.inc, %if.then, %while.body
  %call45 = tail call ptr @st_NextCandidate() #12
...
if.then52:                                        ; preds = %land.lhs.true48
  ...
  %call55 = tail call ptr @list_Reverse(ptr noundef %call5.val196) #12
  %call56 = tail call ptr @term_Create(i32 noundef %call5.val, ptr noundef %call55) #12
  %55 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  %ShIndex.val = load ptr, ptr %ShIndex, align 8
  %call59 = tail call ptr @st_ExistGen(ptr noundef %55, ptr noundef %ShIndex.val, ptr noundef %call56) #12
...
if.then65:                                        ; preds = %while.body62
  %call66 = tail call ptr @sharing_NAtomDataList(ptr noundef nonnull %AtomGen.112) #12
...
land.lhs.true79.us:                               ; preds = %land.lhs.true75.us
  br i1 %cmp80.not, label %lor.lhs.false84.us, label %while.cond.i.i232.us

while.cond.i.i232.us:                             ; preds = %land.lhs.true79.us, %while.cond.i.i232.us
  %indvars.iv.i.i233.us = phi i64 [ %indvars.iv.next.i.i236.us, %while.cond.i.i232.us ], [ 0, %land.lhs.true79.us ]
  %arrayidx.i.i.i234.us = getelementptr inbounds ptr, ptr %call73.val.us, i64 %indvars.iv.i.i233.us
  %62 = load ptr, ptr %arrayidx.i.i.i234.us, align 8
  %cmp.not.i.i235.us = icmp eq ptr %62, %LitScan.1.val.us
  %indvars.iv.next.i.i236.us = add nuw i64 %indvars.iv.i.i233.us, 1
  br i1 %cmp.not.i.i235.us, label %clause_LiteralIsFromConstraint.exit242.us, label %while.cond.i.i232.us, !llvm.loop !12

clause_LiteralIsFromConstraint.exit242.us:        ; preds = %while.cond.i.i232.us
  %63 = trunc i64 %indvars.iv.i.i233.us to i32
...
lor.lhs.false84.us:                               ; preds = %clause_LiteralIsFromConstraint.exit242.us, %land.lhs.true79.us
  br i1 %or.cond184, label %for.inc103.us, label %while.cond.i.i245.us

while.cond.i.i245.us:                             ; preds = %lor.lhs.false84.us, %while.cond.i.i245.us
  %indvars.iv.i.i246.us = phi i64 [ %indvars.iv.next.i.i249.us, %while.cond.i.i245.us ], [ 0, %lor.lhs.false84.us ]
  %arrayidx.i.i.i247.us = getelementptr inbounds ptr, ptr %call73.val.us, i64 %indvars.iv.i.i246.us
  %65 = load ptr, ptr %arrayidx.i.i.i247.us, align 8
  %cmp.not.i.i248.us = icmp eq ptr %65, %LitScan.1.val.us
  %indvars.iv.next.i.i249.us = add nuw i64 %indvars.iv.i.i246.us, 1
  br i1 %cmp.not.i.i248.us, label %clause_LiteralIsFromAntecedent.exit258.us, label %while.cond.i.i245.us, !llvm.loop !12

clause_LiteralIsFromAntecedent.exit258.us:        ; preds = %while.cond.i.i245.us
  %66 = trunc i64 %indvars.iv.i.i246.us to i32
...
land.lhs.true96.us:                               ; preds = %clause_LiteralIsFromAntecedent.exit258.us, %clause_LiteralIsFromConstraint.exit242.us
  %call98.us = tail call i32 @subs_SubsumesBasic(ptr noundef nonnull %call72.val.us, ptr noundef %RedCl, i32 noundef 0, i32 noundef %57) #12
...
land.lhs.true79:                                  ; preds = %land.lhs.true75
  br i1 %cmp80.not, label %lor.lhs.false84, label %while.cond.i.i232

while.cond.i.i232:                                ; preds = %land.lhs.true79, %while.cond.i.i232
  %indvars.iv.i.i233 = phi i64 [ %indvars.iv.next.i.i236, %while.cond.i.i232 ], [ 0, %land.lhs.true79 ]
  %arrayidx.i.i.i234 = getelementptr inbounds ptr, ptr %call73.val, i64 %indvars.iv.i.i233
  %73 = load ptr, ptr %arrayidx.i.i.i234, align 8
  %cmp.not.i.i235 = icmp eq ptr %73, %LitScan.1.val
  %indvars.iv.next.i.i236 = add nuw i64 %indvars.iv.i.i233, 1
  br i1 %cmp.not.i.i235, label %clause_LiteralIsFromConstraint.exit242, label %while.cond.i.i232, !llvm.loop !12

clause_LiteralIsFromConstraint.exit242:           ; preds = %while.cond.i.i232
  %74 = trunc i64 %indvars.iv.i.i233 to i32
...
lor.lhs.false84:                                  ; preds = %clause_LiteralIsFromConstraint.exit242, %land.lhs.true79
  br i1 %or.cond184, label %while.cond.i.i261.preheader, label %while.cond.i.i245

while.cond.i.i245:                                ; preds = %lor.lhs.false84, %while.cond.i.i245
  %indvars.iv.i.i246 = phi i64 [ %indvars.iv.next.i.i249, %while.cond.i.i245 ], [ 0, %lor.lhs.false84 ]
  %arrayidx.i.i.i247 = getelementptr inbounds ptr, ptr %call73.val, i64 %indvars.iv.i.i246
  %76 = load ptr, ptr %arrayidx.i.i.i247, align 8
  %cmp.not.i.i248 = icmp eq ptr %76, %LitScan.1.val
  %indvars.iv.next.i.i249 = add nuw i64 %indvars.iv.i.i246, 1
  br i1 %cmp.not.i.i248, label %clause_LiteralIsFromAntecedent.exit258, label %while.cond.i.i245, !llvm.loop !12

clause_LiteralIsFromAntecedent.exit258:           ; preds = %while.cond.i.i245
  %77 = trunc i64 %indvars.iv.i.i246 to i32
  ...
  br i1 %narrow.i256.not, label %while.cond.i.i261.preheader, label %land.lhs.true96

while.cond.i.i261.preheader:                      ; preds = %clause_LiteralIsFromAntecedent.exit258, %lor.lhs.false84
  br label %while.cond.i.i261

while.cond.i.i261:                                ; preds = %while.cond.i.i261.preheader, %while.cond.i.i261
  %indvars.iv.i.i262 = phi i64 [ %indvars.iv.next.i.i265, %while.cond.i.i261 ], [ 0, %while.cond.i.i261.preheader ]
  %arrayidx.i.i.i263 = getelementptr inbounds ptr, ptr %call73.val, i64 %indvars.iv.i.i262
  %80 = load ptr, ptr %arrayidx.i.i.i263, align 8
  %cmp.not.i.i264 = icmp eq ptr %80, %LitScan.1.val
  %indvars.iv.next.i.i265 = add nuw i64 %indvars.iv.i.i262, 1
  br i1 %cmp.not.i.i264, label %clause_LiteralIsFromSuccedent.exit276, label %while.cond.i.i261, !llvm.loop !12

clause_LiteralIsFromSuccedent.exit276:            ; preds = %while.cond.i.i261
  %81 = trunc i64 %indvars.iv.i.i262 to i32
...
land.lhs.true96:                                  ; preds = %clause_LiteralIsFromSuccedent.exit276, %clause_LiteralIsFromAntecedent.exit258, %clause_LiteralIsFromConstraint.exit242
  %call98 = tail call i32 @subs_SubsumesBasic(ptr noundef nonnull %call72.val, ptr noundef %RedCl, i32 noundef 0, i32 noundef %56) #12
...
if.end106:                                        ; preds = %for.inc103, %for.inc103.us, %if.then65, %while.body62
  %call107 = tail call ptr @st_NextCandidate() #12
...
while.end108:                                     ; preds = %if.end106, %if.then52
  ...
  br i1 %cmp.i.not5.i277, label %list_Delete.exit285, label %while.body.i278

while.body.i278:                                  ; preds = %while.end108, %while.body.i278
  %Current.06.i279 = phi ptr [ %Current.0.val.i280, %while.body.i278 ], [ %call56.val, %while.end108 ]
  %Current.0.val.i280 = load ptr, ptr %Current.06.i279, align 8
  %97 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i281 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %97, i64 0, i32 4
  %98 = load i32, ptr %total_size.i.i.i281, align 8
  %conv26.i.i.i282 = sext i32 %98 to i64
  %99 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i283 = add i64 %99, %conv26.i.i.i282
  store i64 %add27.i.i.i283, ptr @memory_FREEDBYTES, align 8
  %100 = load ptr, ptr %97, align 8
  store ptr %100, ptr %Current.06.i279, align 8
  %101 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i279, ptr %101, align 8
  %cmp.i.not.i284 = icmp eq ptr %Current.0.val.i280, null
  br i1 %cmp.i.not.i284, label %list_Delete.exit285, label %while.body.i278, !llvm.loop !8

list_Delete.exit285:                              ; preds = %while.body.i278, %while.end108
...
land.lhs.true10.us.i:                             ; preds = %land.lhs.true.us.i
  ...
  %call13.us.i = tail call i32 @term_Equal(ptr noundef %call4.val.val.us.i, ptr noundef %call4.val84.val.val.us.i) #12
  %tobool14.not.us.i = icmp ne i32 %call13.us.i, 0
  %spec.select.us.i = zext i1 %tobool14.not.us.i to i32
  %.pre.i = load i32, ptr @fol_NOT, align 4
...
if.end.us.i:                                      ; preds = %land.lhs.true10.us.i, %land.lhs.true.us.i, %clause_LiteralAtom.exit.us.i
  ...
  %Result.1.us.i = phi i32 [ 0, %land.lhs.true.us.i ], [ 0, %clause_LiteralAtom.exit.us.i ], [ %spec.select.us.i, %land.lhs.true10.us.i ]
  %indvars.iv.next.i = add nsw i64 %indvars.iv.i, 1
  %cmp.us.i = icmp slt i64 %indvars.iv.next.i, %8
  %tobool.not.us.i = icmp eq i32 %Result.1.us.i, 0
  %23 = select i1 %cmp.us.i, i1 %tobool.not.us.i, i1 false
  br i1 %23, label %for.body.us.i, label %for.end31.i, !llvm.loop !67
...
if.end.i:                                         ; preds = %land.lhs.true.i
  ...
  %call13.i = tail call i32 @term_Equal(ptr noundef %call4.val.val.i, ptr noundef %call4.val84.val.val.i) #12
...
for.body22.i:                                     ; preds = %for.body22.i.preheader, %clause_LiteralAtom.exit96.i
  ...
  br i1 %cmp.i.not.i91.i, label %if.then.i93.i, label %clause_LiteralAtom.exit96.i

if.then.i93.i:                                    ; preds = %for.body22.i
  %37 = getelementptr i8, ptr %call23.val.i, i64 16
  %call1.val.i94.i = load ptr, ptr %37, align 8
  %38 = getelementptr i8, ptr %call1.val.i94.i, i64 8
  %call1.val.val.i95.i = load ptr, ptr %38, align 8
  br label %clause_LiteralAtom.exit96.i

clause_LiteralAtom.exit96.i:                      ; preds = %if.then.i93.i, %for.body22.i
  %retval.0.i92.i = phi ptr [ %call1.val.val.i95.i, %if.then.i93.i ], [ %call23.val.i, %for.body22.i ]
  %call25.i = tail call i32 @term_Equal(ptr noundef nonnull %retval.0.i.i, ptr noundef %retval.0.i92.i) #12
  %tobool26.not.i = icmp eq i32 %call25.i, 0
  %indvars.iv.next20.i = add nuw nsw i64 %indvars.iv19.i, 1
  %cmp17.i = icmp ult i64 %indvars.iv19.i, %9
  %39 = select i1 %cmp17.i, i1 %tobool26.not.i, i1 false
  br i1 %39, label %for.body22.i, label %for.inc29.i, !llvm.loop !68
...
for.end31.i:                                      ; preds = %if.end.us.i, %for.inc29.i
  %tobool.not.lcssa.i = phi i1 [ %tobool26.not.i, %for.inc29.i ], [ %tobool.not.us.i, %if.end.us.i ]
...
if.end44.i:                                       ; preds = %land.lhs.true39.i
  %call43.i = tail call i32 @cc_Tautology(ptr noundef nonnull %2) #12
...
if.then49.i:                                      ; preds = %land.lhs.true46.i
  ...
  tail call void @clause_Print(ptr noundef nonnull %2) #12
  br label %cleanup
...
if.then10:                                        ; preds = %if.end7
  ...
  br i1 %tobool.not.i32, label %cleanup, label %if.then.i33

if.then.i33:                                      ; preds = %if.then10
  %53 = load ptr, ptr %RedClause, align 8
  %54 = load ptr, ptr %Result, align 8
  %call.i.i34 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i35 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i34, i64 0, i32 1
  store ptr %53, ptr %car.i.i35, align 8
  store ptr %54, ptr %call.i.i34, align 8
  store ptr %call.i.i34, ptr %Result, align 8
  store ptr %52, ptr %RedClause, align 8
  br label %cleanup

cleanup:                                          ; preds = %if.then.i33, %if.then10, %if.then49.i, %land.lhs.true46.i, %if.end7
  %retval.0 = phi i32 [ 0, %if.end7 ], [ 1, %land.lhs.true46.i ], [ 1, %if.then49.i ], [ 0, %if.then10 ], [ 0, %if.then.i33 ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %Copy) #12
  ret i32 %retval.0
}
...
entry:
  %call1 = tail call i32 @clause_ContainsNegativeEquations(ptr noundef %Clause) #12
  %tobool.not = icmp eq i32 %call1, 0
...
clause_GetLiteralAtom.exit177:                    ; preds = %clause_LiteralIsEquality.exit, %clause_LiteralIsEquality.exit.thread
  %retval.0.i.i173 = phi ptr [ %call4.val, %clause_LiteralIsEquality.exit.thread ], [ %call1.val.val.i.i, %clause_LiteralIsEquality.exit ]
  %call8.val.pn.in = getelementptr i8, ptr %retval.0.i.i173, i64 16
...
land.lhs.true:                                    ; preds = %clause_GetLiteralAtom.exit177
  %call15 = tail call i32 @clause_NumberOfSymbolOccurrences(ptr noundef nonnull %Clause, i32 noundef %call9.val161) #12
...
land.lhs.true19:                                  ; preds = %lor.lhs.false
  %call21 = tail call i32 @clause_NumberOfSymbolOccurrences(ptr noundef nonnull %Clause, i32 noundef %call11.val160) #12
...
land.lhs.true27:                                  ; preds = %if.else
  %call28 = tail call i32 @clause_ContainsPositiveEquations(ptr noundef %Clause) #12
...
clause_LiteralIsEquality.exit195:                 ; preds = %for.body36
  ...
  %call1.val.i.i192 = load ptr, ptr %19, align 8
  %20 = getelementptr i8, ptr %call1.val.i.i192, i64 8
  %call1.val.val.i.i193 = load ptr, ptr %20, align 8
  %call.val.pre.i194 = load i32, ptr %call1.val.val.i.i193, align 8
  %21 = load i32, ptr @fol_EQUALITY, align 4
  %cmp.i.i189.not = icmp eq i32 %21, %call.val.pre.i194
  br i1 %cmp.i.i189.not, label %clause_GetLiteralAtom.exit215, label %for.inc65

clause_LiteralIsEquality.exit195.thread:          ; preds = %for.body36
  %22 = load i32, ptr @fol_EQUALITY, align 4
  %cmp.i.i189237.not = icmp eq i32 %22, %L.val7.val.i.i186
  br i1 %cmp.i.i189237.not, label %clause_GetLiteralAtom.exit215, label %for.inc65

clause_GetLiteralAtom.exit215:                    ; preds = %clause_LiteralIsEquality.exit195, %clause_LiteralIsEquality.exit195.thread
  %retval.0.i.i211 = phi ptr [ %call37.val, %clause_LiteralIsEquality.exit195.thread ], [ %call1.val.val.i.i193, %clause_LiteralIsEquality.exit195 ]
  %call41.val.pn.in = getelementptr i8, ptr %retval.0.i.i211, i64 16
...
land.lhs.true47:                                  ; preds = %clause_GetLiteralAtom.exit215
  %call49 = tail call i32 @clause_NumberOfSymbolOccurrences(ptr noundef nonnull %Clause, i32 noundef %call42.val159) #12
...
land.lhs.true55:                                  ; preds = %lor.lhs.false52
  %call57 = tail call i32 @clause_NumberOfSymbolOccurrences(ptr noundef nonnull %Clause, i32 noundef %call44.val158) #12
...
if.then60:                                        ; preds = %land.lhs.true55, %land.lhs.true47
  ...
  %call.i220 = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
if.then75:                                        ; preds = %if.then72
  ...
  tail call void @clause_Print(ptr noundef nonnull %Clause) #12
...
if.then81:                                        ; preds = %if.end78
  %call82 = tail call ptr @clause_Copy(ptr noundef nonnull %Clause) #12
  tail call void @clause_DeleteLiterals(ptr noundef %call82, ptr noundef nonnull %Indexes.4, ptr noundef nonnull %Flags, ptr noundef %Precedence) #12
...
list_Delete.exit.i:                               ; preds = %while.body.i.i, %if.then81
  ...
  br i1 %cmp.i.not5.i17.i, label %list_Delete.exit25.i, label %while.body.i18.i

while.body.i18.i:                                 ; preds = %list_Delete.exit.i, %while.body.i18.i
  %Current.06.i19.i = phi ptr [ %Current.0.val.i20.i, %while.body.i18.i ], [ %Clause.val15.i, %list_Delete.exit.i ]
  %Current.0.val.i20.i = load ptr, ptr %Current.06.i19.i, align 8
  %38 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i21.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %38, i64 0, i32 4
  %39 = load i32, ptr %total_size.i.i.i21.i, align 8
  %conv26.i.i.i22.i = sext i32 %39 to i64
  %40 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i23.i = add i64 %40, %conv26.i.i.i22.i
  store i64 %add27.i.i.i23.i, ptr @memory_FREEDBYTES, align 8
  %41 = load ptr, ptr %38, align 8
  store ptr %41, ptr %Current.06.i19.i, align 8
  %42 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i19.i, ptr %42, align 8
  %cmp.i.not.i24.i = icmp eq ptr %Current.0.val.i20.i, null
  br i1 %cmp.i.not.i24.i, label %list_Delete.exit25.i, label %while.body.i18.i, !llvm.loop !8

list_Delete.exit25.i:                             ; preds = %while.body.i18.i, %list_Delete.exit.i
  store ptr null, ptr %31, align 8
...
red_DocumentAssignmentEquationDeletion.exit:      ; preds = %list_Delete.exit25.i, %if.then.i
  %48 = load i32, ptr %arrayidx.i222, align 4
...
if.then85:                                        ; preds = %red_DocumentAssignmentEquationDeletion.exit
  tail call void @clause_Print(ptr noundef nonnull %call82) #12
  br label %if.end86
...
if.else87:                                        ; preds = %if.end78
  tail call void @clause_DeleteLiterals(ptr noundef nonnull %Clause, ptr noundef nonnull %Indexes.4, ptr noundef nonnull %Flags, ptr noundef %Precedence) #12
  br label %while.body.i

while.body.i:                                     ; preds = %if.else87, %while.body.i
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i ], [ %Indexes.4, %if.else87 ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
...
if.end.i:                                         ; preds = %lor.lhs.false.i
  ...
  %call7.i = tail call i32 @term_StampOverflow(i32 noundef %16) #12
...
while.body.i:                                     ; preds = %while.cond.loopexit.i, %if.end13.i
  ...
  tail call void @sharing_PushListOnStackNoStamps(ptr noundef %RedAtom.0.val.i) #12
...
while.body20.i:                                   ; preds = %while.body.i, %if.end144.i
  ...
  %ShIndex.val.i = load ptr, ptr %ShIndex, align 8
  %call24.i = tail call ptr @st_ExistGen(ptr noundef %26, ptr noundef %ShIndex.val.i, ptr noundef %25) #12
...
if.end46.i:                                       ; preds = %if.then43.i, %if.then40.i
  ...
  %call47.i = tail call ptr @sharing_NAtomDataList(ptr noundef nonnull %EqScan.0.val.i) #12
...
if.then73.i:                                      ; preds = %if.then62.i
  ...
  tail call void @term_StartMaxRenaming(i32 noundef %call57.val265.i) #12
  %call75.i = tail call ptr @term_Rename(ptr noundef %RedAtom.1368.i) #12
  %44 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  %call78.i = tail call i32 @ord_ContGreater(ptr noundef %44, ptr noundef nonnull %TermS.0353.i, ptr noundef %44, ptr noundef %Right.0.i, ptr noundef %Flags, ptr noundef %Precedence) #12
  %.pre = load i32, ptr @fol_NOT, align 4
  br label %if.end79.i
...
if.then90.i:                                      ; preds = %lor.lhs.false85.i, %land.lhs.true83.i
  %call91.i = tail call ptr @clause_Copy(ptr noundef %RedClause) #12
  ...
  br i1 %cmp.i.not.i.i278.i, label %if.then.i.i280.i, label %if.end94.i

if.then.i.i280.i:                                 ; preds = %if.then90.i
  %51 = getelementptr i8, ptr %call.val.i276.i, i64 16
  %call1.val.i.i281.i = load ptr, ptr %51, align 8
  %52 = getelementptr i8, ptr %call1.val.i.i281.i, i64 8
  %call1.val.val.i.i282.i = load ptr, ptr %52, align 8
  br label %if.end94.i

if.end94.i:                                       ; preds = %if.then.i.i280.i, %if.then90.i, %if.then81.i
  %Copy.5.i = phi ptr [ %Copy.1366.i, %if.then81.i ], [ %call91.i, %if.then90.i ], [ %call91.i, %if.then.i.i280.i ]
  %RedAtom.5.i = phi ptr [ %RedAtom.1368.i, %if.then81.i ], [ %call.val.i276.i, %if.then90.i ], [ %call1.val.val.i.i282.i, %if.then.i.i280.i ]
...
if.then99.i:                                      ; preds = %if.then96.i
  ...
  tail call void @clause_Print(ptr noundef %Copy.5317.i) #12
...
list_Delete.exit.i.i:                             ; preds = %while.body.i.i.i, %if.then107.i
  ...
  br i1 %cmp.i.not5.i17.i.i, label %red_DocumentRewriting.exit.i, label %while.body.i18.i.i

while.body.i18.i.i:                               ; preds = %list_Delete.exit.i.i, %while.body.i18.i.i
  %Current.06.i19.i.i = phi ptr [ %Current.0.val.i20.i.i, %while.body.i18.i.i ], [ %Clause.val15.i.i, %list_Delete.exit.i.i ]
  %Current.0.val.i20.i.i = load ptr, ptr %Current.06.i19.i.i, align 8
  %65 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i21.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %65, i64 0, i32 4
  %66 = load i32, ptr %total_size.i.i.i21.i.i, align 8
  %conv26.i.i.i22.i.i = sext i32 %66 to i64
  %67 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i23.i.i = add i64 %67, %conv26.i.i.i22.i.i
  store i64 %add27.i.i.i23.i.i, ptr @memory_FREEDBYTES, align 8
  %68 = load ptr, ptr %65, align 8
  store ptr %68, ptr %Current.06.i19.i.i, align 8
  %69 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i19.i.i, ptr %69, align 8
  %cmp.i.not.i24.i.i = icmp eq ptr %Current.0.val.i20.i.i, null
  br i1 %cmp.i.not.i24.i.i, label %red_DocumentRewriting.exit.i, label %while.body.i18.i.i, !llvm.loop !8

red_DocumentRewriting.exit.i:                     ; preds = %while.body.i18.i.i, %list_Delete.exit.i.i
  ...
  %call.i.i26.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i.i29.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i.i33.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
if.else110.i:                                     ; preds = %if.end103.thread.i
  ...
  %call.i.i.i291.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i.i9.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i.i13.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i.i17.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
if.end114.i:                                      ; preds = %if.else110.i, %red_DocumentRewriting.exit.i, %if.end103.thread.i, %if.end103.i, %if.end94.thread.i
  ...
  %call116.i = tail call ptr @term_Copy(ptr noundef %Right.0.i) #12
  %call117.i = tail call ptr @cont_ApplyBindingsModuloMatching(ptr noundef %83, ptr noundef %call116.i, i32 noundef 1) #12
  %84 = load ptr, ptr @cont_RIGHTCONTEXT, align 8
  %call119.i = tail call i32 @cont_BindingsAreRenamingModuloMatching(ptr noundef %84) #12
...
if.then121.i:                                     ; preds = %if.end114.i
  tail call void @term_SetTermSubtermStamp(ptr noundef %call117.i) #12
  br label %if.end122.i

if.end122.i:                                      ; preds = %if.then121.i, %if.end114.i
  %call123.i = tail call i32 @term_ReplaceSubtermBy(ptr noundef %RedAtom.5319.i, ptr noundef %25, ptr noundef %call117.i) #12
...
if.then.i.i.i.i:                                  ; preds = %if.end3.i.i
  ...
  %call.i.i.i295.i = tail call ptr @memory_Malloc(i32 noundef %mul.i.i.i.i) #12
...
if.end23.i.i.i.i.i:                               ; preds = %if.then18.i.i.i.i.i, %if.end13.i.i.i.i.i
  ...
  tail call void @free(ptr noundef nonnull %add.ptr24.i.i.i.i.i) #12
...
clause_UpdateSplitDataFromPartner.exit.i:         ; preds = %for.body.i.i.i, %if.end.i.i.i, %if.end.i.i
  tail call void @term_Delete(ptr noundef %call117.i) #12
...
while.end.thread.i:                               ; preds = %if.then126.i, %clause_UpdateSplitDataFromPartner.exit.i
  %call.i.i = tail call i32 @clause_ComputeWeight(ptr noundef %Copy.5315.i, ptr noundef nonnull %Flags) #12
...
if.then139.i:                                     ; preds = %for.inc135.i, %while.body29.i
  ...
  %call140.i = tail call ptr @st_NextCandidate() #12
...
if.then148.i:                                     ; preds = %while.end146.i
  tail call void @clause_OrientEqualities(ptr noundef %Copy.1.lcssa388.i, ptr noundef %Flags, ptr noundef %Precedence) #12
  tail call void @clause_Normalize(ptr noundef %Copy.1.lcssa388.i) #12
  tail call void @clause_SetMaxLitFlags(ptr noundef %Copy.1.lcssa388.i, ptr noundef %Flags, ptr noundef %Precedence) #12
  %call.i.i.i301.i = tail call i32 @clause_ComputeWeight(ptr noundef %Copy.1.lcssa388.i, ptr noundef %Flags) #12
  ...
  tail call void @clause_UpdateMaxVar(ptr noundef %Copy.1.lcssa388.i) #12
...
if.then150.i:                                     ; preds = %if.then148.i
  tail call void @clause_OrientEqualities(ptr noundef %RedClause, ptr noundef %Flags, ptr noundef %Precedence) #12
  tail call void @clause_Normalize(ptr noundef %RedClause) #12
  tail call void @clause_SetMaxLitFlags(ptr noundef %RedClause, ptr noundef %Flags, ptr noundef %Precedence) #12
  %call.i.i.i302.i = tail call i32 @clause_ComputeWeight(ptr noundef %RedClause, ptr noundef %Flags) #12
  ...
  tail call void @clause_UpdateMaxVar(ptr noundef %RedClause) #12
...
if.then154.i:                                     ; preds = %if.end151.i
  ...
  tail call void @clause_Print(ptr noundef nonnull %Copy.1.lcssa388.i) #12
...
if.then162.i:                                     ; preds = %if.else160.i
  ...
  tail call void @clause_Normalize(ptr noundef %Copy.1.lcssa388.i) #12
  tail call void @clause_SetMaxLitFlags(ptr noundef %Copy.1.lcssa388.i, ptr noundef %Flags, ptr noundef %Precedence) #12
  %call.i.i.i305.i = tail call i32 @clause_ComputeWeight(ptr noundef %Copy.1.lcssa388.i, ptr noundef %Flags) #12
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc116
  ...
  br i1 %cmp.i.not.i.i, label %if.then.i.i227, label %clause_GetLiteralAtom.exit

if.then.i.i227:                                   ; preds = %for.body
  %137 = getelementptr i8, ptr %call.val.i, i64 16
  %call1.val.i.i228 = load ptr, ptr %137, align 8
  %138 = getelementptr i8, ptr %call1.val.i.i228, i64 8
  %call1.val.val.i.i = load ptr, ptr %138, align 8
  br label %clause_GetLiteralAtom.exit

clause_GetLiteralAtom.exit:                       ; preds = %for.body, %if.then.i.i227
  %retval.0.i.i = phi ptr [ %call1.val.val.i.i, %if.then.i.i227 ], [ %call.val.i, %for.body ]
...
while.body:                                       ; preds = %while.body.preheader, %while.cond
  ...
  br i1 %cmp.i.not.i.i234, label %if.then.i.i236, label %clause_GetLiteralAtom.exit239

if.then.i.i236:                                   ; preds = %while.body
  %146 = getelementptr i8, ptr %call.val.i232, i64 16
  %call1.val.i.i237 = load ptr, ptr %146, align 8
  %147 = getelementptr i8, ptr %call1.val.i.i237, i64 8
  %call1.val.val.i.i238 = load ptr, ptr %147, align 8
  br label %clause_GetLiteralAtom.exit239

clause_GetLiteralAtom.exit239:                    ; preds = %while.body, %if.then.i.i236
  %retval.0.i.i235 = phi ptr [ %call1.val.val.i.i238, %if.then.i.i236 ], [ %call.val.i232, %while.body ]
  %148 = load i32, ptr @stack_POINTER, align 4
  %149 = getelementptr i8, ptr %retval.0.i.i235, i64 16
  %call10.val = load ptr, ptr %149, align 8
  tail call void @sharing_PushListReverseOnStack(ptr noundef %call10.val) #12
...
while.body16:                                     ; preds = %clause_GetLiteralAtom.exit239, %while.end
  ...
  %RedAtom.0372 = phi ptr [ %RedAtom.1.lcssa, %while.end ], [ %retval.0.i.i235, %clause_GetLiteralAtom.exit239 ]
  ...
  %ShIndex.val = load ptr, ptr %ShIndex, align 8
  %call20 = tail call ptr @st_ExistGen(ptr noundef %153, ptr noundef %ShIndex.val, ptr noundef %152) #12
...
if.then43:                                        ; preds = %land.lhs.true
  %call44 = tail call ptr @sharing_NAtomDataList(ptr noundef nonnull %EqScan.0.val) #12
...
land.lhs.true61:                                  ; preds = %land.lhs.true58
  %call62 = tail call i32 @subs_SubsumesBasic(ptr noundef %call53.val220, ptr noundef %Copy.2370, i32 noundef %164, i32 noundef %141) #12
...
if.then72:                                        ; preds = %lor.lhs.false, %land.lhs.true66
  %call73 = tail call ptr @clause_Copy(ptr noundef %RedClause) #12
  ...
  br i1 %cmp.i.not.i.i258, label %if.then.i.i260, label %if.end75

if.then.i.i260:                                   ; preds = %if.then72
  %174 = getelementptr i8, ptr %call.val.i256, i64 16
  %call1.val.i.i261 = load ptr, ptr %174, align 8
  %175 = getelementptr i8, ptr %call1.val.i.i261, i64 8
  %call1.val.val.i.i262 = load ptr, ptr %175, align 8
  br label %if.end75

if.end75:                                         ; preds = %if.then.i.i260, %if.then72, %if.then64
  %Copy.6 = phi ptr [ %Copy.2370, %if.then64 ], [ %call73, %if.then72 ], [ %call73, %if.then.i.i260 ]
  %RedAtom.4 = phi ptr [ %RedAtom.0372, %if.then64 ], [ %call.val.i256, %if.then72 ], [ %call1.val.val.i.i262, %if.then.i.i260 ]
...
if.then80:                                        ; preds = %if.then77
  ...
  tail call void @clause_Print(ptr noundef %Copy.6323) #12
  %179 = load ptr, ptr @stdout, align 8
...
list_Delete.exit.i:                               ; preds = %while.body.i.i, %if.then88
  ...
  %cmp.i.not5.i17.i = icmp eq ptr %Clause.val15.i, null
  br i1 %cmp.i.not5.i17.i, label %red_DocumentRewriting.exit, label %while.body.i18.i

while.body.i18.i:                                 ; preds = %list_Delete.exit.i, %while.body.i18.i
  %Current.06.i19.i = phi ptr [ %Current.0.val.i20.i, %while.body.i18.i ], [ %Clause.val15.i, %list_Delete.exit.i ]
  %Current.0.val.i20.i = load ptr, ptr %Current.06.i19.i, align 8
  %188 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i21.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %188, i64 0, i32 4
  %189 = load i32, ptr %total_size.i.i.i21.i, align 8
  %conv26.i.i.i22.i = sext i32 %189 to i64
  %190 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i23.i = add i64 %190, %conv26.i.i.i22.i
  store i64 %add27.i.i.i23.i, ptr @memory_FREEDBYTES, align 8
  %191 = load ptr, ptr %188, align 8
  store ptr %191, ptr %Current.06.i19.i, align 8
  %192 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i19.i, ptr %192, align 8
  %cmp.i.not.i24.i = icmp eq ptr %Current.0.val.i20.i, null
  br i1 %cmp.i.not.i24.i, label %red_DocumentRewriting.exit, label %while.body.i18.i, !llvm.loop !8

red_DocumentRewriting.exit:                       ; preds = %while.body.i18.i, %list_Delete.exit.i
  ...
  %call.i.i26.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i.i33.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
if.else:                                          ; preds = %if.end84.thread
  ...
  %call.i.i.i273 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i.i9.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i.i13.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i.i17.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
if.end90:                                         ; preds = %if.end75.thread, %if.end84.thread, %red_DocumentRewriting.exit, %if.else, %if.end84
  ...
  %call93 = tail call ptr @term_Copy(ptr noundef %call38.val219.val.val) #12
  %call94 = tail call ptr @cont_ApplyBindingsModuloMatching(ptr noundef %208, ptr noundef %call93, i32 noundef 1) #12
  %call95 = tail call i32 @term_ReplaceSubtermBy(ptr noundef %RedAtom.4325, ptr noundef %152, ptr noundef %call94) #12
  ...
  br i1 %tobool.not.i, label %if.end.i276, label %if.then.i
...
if.end.i276:                                      ; preds = %if.then.i, %if.end90
  %213 = getelementptr i8, ptr %call53.val220, i64 12
  %Partner.val19.i = load i32, ptr %213, align 4
  %cmp.i277 = icmp eq i32 %Partner.val19.i, 0
  br i1 %cmp.i277, label %clause_UpdateSplitDataFromPartner.exit, label %if.end3.i

if.end3.i:                                        ; preds = %if.end.i276
  ...
  br i1 %cmp.i21.i, label %if.then.i.i.i280, label %if.end.i.i278

if.then.i.i.i280:                                 ; preds = %if.end3.i
  %mul.i.i.i = shl i32 %216, 3
  %call.i.i.i281 = tail call ptr @memory_Malloc(i32 noundef %mul.i.i.i) #12
  %217 = load i32, ptr %splitfield_length.i.i, align 8
  %cmp349.not.i.i.i = icmp eq i32 %217, 0
  br i1 %cmp349.not.i.i.i, label %for.cond8.preheader.i.i.i, label %for.body.lr.ph.i.i.i282

for.body.lr.ph.i.i.i282:                          ; preds = %if.then.i.i.i280
  %splitfield.i.i.i283 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6321, i64 0, i32 4
  br label %for.body.i.i.i284

for.cond8.preheader.i.i.i:                        ; preds = %for.body.i.i.i284, %if.then.i.i.i280
  %.lcssa.i.i.i = phi i32 [ 0, %if.then.i.i.i280 ], [ %227, %for.body.i.i.i284 ]
...
for.body11.preheader.i.i.i:                       ; preds = %for.cond8.preheader.i.i.i
  ...
  %scevgep.i.i.i = getelementptr i8, ptr %call.i.i.i281, i64 %219
...
for.body.i.i.i284:                                ; preds = %for.body.i.i.i284, %for.body.lr.ph.i.i.i282
  %indvars.iv.i.i.i285 = phi i64 [ 0, %for.body.lr.ph.i.i.i282 ], [ %indvars.iv.next.i.i.i287, %for.body.i.i.i284 ]
  %225 = load ptr, ptr %splitfield.i.i.i283, align 8
  %arrayidx.i.i.i286 = getelementptr inbounds i64, ptr %225, i64 %indvars.iv.i.i.i285
  %226 = load i64, ptr %arrayidx.i.i.i286, align 8
  %arrayidx6.i.i.i = getelementptr inbounds i64, ptr %call.i.i.i281, i64 %indvars.iv.i.i.i285
  store i64 %226, ptr %arrayidx6.i.i.i, align 8
  %indvars.iv.next.i.i.i287 = add nuw nsw i64 %indvars.iv.i.i.i285, 1
  %227 = load i32, ptr %splitfield_length.i.i, align 8
  %228 = zext i32 %227 to i64
  %cmp3.i.i.i = icmp ult i64 %indvars.iv.next.i.i.i287, %228
  br i1 %cmp3.i.i.i, label %for.body.i.i.i284, label %for.cond8.preheader.i.i.i, !llvm.loop !27
...
if.then20.i.i.i:                                  ; preds = %for.end16.i.i.i
  ...
  %cmp.i.i.i.i.i = icmp ult i32 %mul24.i.i.i, 1024
  br i1 %cmp.i.i.i.i.i, label %if.else25.i.i.i.i, label %if.then.i.i.i.i288

if.then.i.i.i.i288:                               ; preds = %if.then20.i.i.i
...
if.then9.i.i.i.i:                                 ; preds = %if.then.i.i.i.i288
  %235 = load ptr, ptr %add.ptr1.i.i.i.i, align 8
  store ptr %235, ptr %234, align 8
  br label %if.end13.i.i.i.i

if.end13.i.i.i.i:                                 ; preds = %if.then9.i.i.i.i, %if.then.i.i.i.i288
...
if.else25.i.i.i.i:                                ; preds = %if.then20.i.i.i
  %idxprom.i.i.i.i = zext i32 %mul24.i.i.i to i64
  %arrayidx.i.i.i.i289 = getelementptr inbounds [0 x ptr], ptr @memory_ARRAY, i64 0, i64 %idxprom.i.i.i.i
  %239 = load ptr, ptr %arrayidx.i.i.i.i289, align 8
  %total_size.i.i.i.i290 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %239, i64 0, i32 4
  %240 = load i32, ptr %total_size.i.i.i.i290, align 8
  %conv26.i.i.i.i291 = sext i32 %240 to i64
  %241 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i292 = add i64 %241, %conv26.i.i.i.i291
  store i64 %add27.i.i.i.i292, ptr @memory_FREEDBYTES, align 8
  %242 = load ptr, ptr %239, align 8
  store ptr %242, ptr %229, align 8
  %243 = load ptr, ptr %arrayidx.i.i.i.i289, align 8
  store ptr %229, ptr %243, align 8
  br label %clause_ExpandSplitField.exit.i.i

clause_ExpandSplitField.exit.i.i:                 ; preds = %if.else25.i.i.i.i, %if.end23.i.i.i.i, %for.end16.i.i.i
  store ptr %call.i.i.i281, ptr %splitfield17.i.i.i, align 8
  store i32 %216, ptr %splitfield_length.i.i, align 8
  %.pre.i.i = load i32, ptr %splitfield_length1.i.i, align 8
  br label %if.end.i.i278

if.end.i.i278:                                    ; preds = %clause_ExpandSplitField.exit.i.i, %if.end3.i
  %244 = phi i32 [ %.pre.i.i, %clause_ExpandSplitField.exit.i.i ], [ %216, %if.end3.i ]
  %cmp421.not.i.i = icmp eq i32 %244, 0
  br i1 %cmp421.not.i.i, label %clause_UpdateSplitDataFromPartner.exit, label %for.body.lr.ph.i.i

for.body.lr.ph.i.i:                               ; preds = %if.end.i.i278
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  ...
  %arrayidx.i.i279 = getelementptr inbounds i64, ptr %245, i64 %indvars.iv.i.i
  %246 = load i64, ptr %arrayidx.i.i279, align 8
  ...
  store i64 %or.i22.i, ptr %arrayidx.i.i279, align 8
...
clause_UpdateSplitDataFromPartner.exit:           ; preds = %for.body.i.i, %if.end.i276, %if.end.i.i278
  tail call void @term_Delete(ptr noundef %call94) #12
...
if.end112.thread:                                 ; preds = %if.then98, %clause_UpdateSplitDataFromPartner.exit
  %call.i = tail call i32 @clause_ComputeWeight(ptr noundef %Copy.6321, ptr noundef nonnull %Flags) #12
...
if.end112:                                        ; preds = %for.inc105, %if.then28, %while.body25
  %call111 = tail call ptr @st_NextCandidate() #12
...
if.then119:                                       ; preds = %for.end117
  tail call void @clause_OrientEqualities(ptr noundef %Copy.10, ptr noundef %Flags, ptr noundef %Precedence) #12
  tail call void @clause_Normalize(ptr noundef %Copy.10) #12
  tail call void @clause_SetMaxLitFlags(ptr noundef %Copy.10, ptr noundef %Flags, ptr noundef %Precedence) #12
  %call.i.i.i294 = tail call i32 @clause_ComputeWeight(ptr noundef %Copy.10, ptr noundef %Flags) #12
  ...
  tail call void @clause_UpdateMaxVar(ptr noundef %Copy.10) #12
...
if.then122:                                       ; preds = %if.then119
  ...
  tail call void @clause_Print(ptr noundef nonnull %Copy.10) #12
  br label %if.end124
...
if.then126:                                       ; preds = %if.end124
  tail call void @clause_OrientEqualities(ptr noundef %RedClause, ptr noundef nonnull %Flags, ptr noundef %Precedence) #12
  tail call void @clause_Normalize(ptr noundef %RedClause) #12
  tail call void @clause_SetMaxLitFlags(ptr noundef %RedClause, ptr noundef nonnull %Flags, ptr noundef %Precedence) #12
  %call.i.i.i296 = tail call i32 @clause_ComputeWeight(ptr noundef %RedClause, ptr noundef nonnull %Flags) #12
...
while.body:                                       ; preds = %while.cond.preheader, %while.cond.loopexit
  ...
  br i1 %cmp.i.not.i.i267, label %if.then.i.i269, label %clause_GetLiteralAtom.exit272

if.then.i.i269:                                   ; preds = %while.body
  %25 = getelementptr i8, ptr %call.val.i265, i64 16
  %call1.val.i.i270 = load ptr, ptr %25, align 8
  %26 = getelementptr i8, ptr %call1.val.i.i270, i64 8
  %call1.val.val.i.i271 = load ptr, ptr %26, align 8
  br label %clause_GetLiteralAtom.exit272

clause_GetLiteralAtom.exit272:                    ; preds = %while.body, %if.then.i.i269
  %retval.0.i.i268 = phi ptr [ %call1.val.val.i.i271, %if.then.i.i269 ], [ %call.val.i265, %while.body ]
  %27 = load i32, ptr @stack_POINTER, align 4
  %28 = getelementptr i8, ptr %retval.0.i.i268, i64 16
  %call14.val = load ptr, ptr %28, align 8
  tail call void @sharing_PushListReverseOnStack(ptr noundef %call14.val) #12
...
while.body20:                                     ; preds = %clause_GetLiteralAtom.exit272, %list_Delete.exit
  ...
  %RedAtom.0500 = phi ptr [ %RedAtom.1.lcssa, %list_Delete.exit ], [ %retval.0.i.i268, %clause_GetLiteralAtom.exit272 ]
  ...
  %call24 = tail call ptr @st_GetGen(ptr noundef %32, ptr noundef %ShIndex.0.val, ptr noundef %31) #12
...
if.then49:                                        ; preds = %land.lhs.true
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %HelpClause) #12
  %call50 = tail call ptr @sharing_NAtomDataList(ptr noundef nonnull %EqScan.0.val) #12
...
for.body.i:                                       ; preds = %for.inc.i, %for.body.lr.ph.i
  %indvars.iv.i288 = phi i64 [ 0, %for.body.lr.ph.i ], [ %indvars.iv.next.i293, %for.inc.i ]
...
if.then.i.i294:                                   ; preds = %if.then.i
  ...
  %call1.val.i.i295 = load ptr, ptr %60, align 8
  %61 = getelementptr i8, ptr %call1.val.i.i295, i64 8
  %call1.val.val.i.i296 = load ptr, ptr %61, align 8
  %call7.val45.pre.i = load i32, ptr %call1.val.val.i.i296, align 8
  br label %clause_LiteralAtom.exit.i
...
clause_LiteralAtom.exit.i:                        ; preds = %if.then.i.i294, %if.then.i
  ...
  %retval.0.i.i292 = phi ptr [ %call1.val.val.i.i296, %if.then.i.i294 ], [ %call6.val.i, %if.then.i ]
  %62 = load i32, ptr @fol_EQUALITY, align 4
  %cmp.i.not.i = icmp eq i32 %62, %call7.val45.i
  br i1 %cmp.i.not.i, label %if.then9.i, label %if.else.i

if.then9.i:                                       ; preds = %clause_LiteralAtom.exit.i
  %63 = getelementptr i8, ptr %retval.0.i.i292, i64 16
  %call7.val.i = load ptr, ptr %63, align 8
  %64 = getelementptr i8, ptr %call7.val.i, i64 8
  %call7.val.val.i = load ptr, ptr %64, align 8
  %call11.i = tail call i32 @ord_Compare(ptr noundef %call.val.val.i, ptr noundef %call7.val.val.i, ptr noundef %Search.val, ptr noundef %Search.val247) #12
  %cmp12.not.i = icmp eq i32 %call11.i, 3
  br i1 %cmp12.not.i, label %lor.lhs.false.i, label %for.inc
...
land.lhs.true.i:                                  ; preds = %lor.lhs.false.i
  ...
  %call16.i = tail call i32 @ord_Compare(ptr noundef %call.val.val.i, ptr noundef %call7.val47.val.val.i, ptr noundef %Search.val, ptr noundef %Search.val247) #12
  %cmp17.not.i = icmp eq i32 %call16.i, 3
  br i1 %cmp17.not.i, label %for.inc.i, label %for.inc

if.else.i:                                        ; preds = %clause_LiteralAtom.exit.i
  %call19.i = tail call i32 @ord_Compare(ptr noundef %call.val.val.i, ptr noundef nonnull %retval.0.i.i292, ptr noundef %Search.val, ptr noundef %Search.val247) #12
  %cmp20.not.i = icmp eq i32 %call19.i, 3
  br i1 %cmp20.not.i, label %for.inc.i, label %for.inc

for.inc.i:                                        ; preds = %if.else.i, %land.lhs.true.i, %lor.lhs.false.i, %for.body.i
  %indvars.iv.next.i293 = add nuw nsw i64 %indvars.iv.i288, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i293, %wide.trip.count.i
...
lor.lhs.false:                                    ; preds = %land.lhs.true78
  ...
  %.not461 = and i1 %cmp1.i, %cmp.i297
  br i1 %.not461, label %lor.lhs.false84, label %if.then89
...
lor.lhs.false84:                                  ; preds = %lor.lhs.false
  ...
  %.not462 = and i1 %cmp.i299, %cmp1.i300
  br i1 %.not462, label %if.end92, label %if.then89

if.then89:                                        ; preds = %lor.lhs.false84, %lor.lhs.false, %land.lhs.true78
  %call90 = tail call ptr @clause_Copy(ptr noundef %RedClause) #12
...
if.then.i.i309:                                   ; preds = %if.then89
  ...
  %call1.val.i.i310 = load ptr, ptr %74, align 8
  %75 = getelementptr i8, ptr %call1.val.i.i310, i64 8
  %call1.val.val.i.i311 = load ptr, ptr %75, align 8
  br label %if.end92
...
if.end92:                                         ; preds = %if.then.i.i309, %if.then89, %lor.lhs.false84, %if.then76
  ...
  %RedAtom.4 = phi ptr [ %RedAtom.2478, %lor.lhs.false84 ], [ %RedAtom.2478, %if.then76 ], [ %call.val.i304, %if.then89 ], [ %call1.val.val.i.i311, %if.then.i.i309 ]
...
if.then97:                                        ; preds = %land.lhs.true94
  ...
  tail call void @clause_Print(ptr noundef %Copy.6) #12
...
list_Delete.exit.i:                               ; preds = %while.body.i.i, %if.then114
  ...
  br i1 %cmp.i.not5.i16.i, label %red_DocumentContextualRewriting.exit, label %while.body.i17.i

while.body.i17.i:                                 ; preds = %list_Delete.exit.i, %while.body.i17.i
  %Current.06.i18.i = phi ptr [ %Current.0.val.i19.i, %while.body.i17.i ], [ %Clause.val14.i, %list_Delete.exit.i ]
  %Current.0.val.i19.i = load ptr, ptr %Current.06.i18.i, align 8
  %94 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i20.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %94, i64 0, i32 4
  %95 = load i32, ptr %total_size.i.i.i20.i, align 8
  %conv26.i.i.i21.i = sext i32 %95 to i64
  %96 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i22.i = add i64 %96, %conv26.i.i.i21.i
  store i64 %add27.i.i.i22.i, ptr @memory_FREEDBYTES, align 8
  %97 = load ptr, ptr %94, align 8
  store ptr %97, ptr %Current.06.i18.i, align 8
  %98 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i18.i, ptr %98, align 8
  %cmp.i.not.i23.i = icmp eq ptr %Current.0.val.i19.i, null
  br i1 %cmp.i.not.i23.i, label %red_DocumentContextualRewriting.exit, label %while.body.i17.i, !llvm.loop !8

red_DocumentContextualRewriting.exit:             ; preds = %while.body.i17.i, %list_Delete.exit.i
  ...
  %call.i.i28.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %sext463 = shl i64 %indvars.iv.i, 32
  %conv.i34.i = ashr exact i64 %sext463, 32
  %103 = inttoptr i64 %conv.i34.i to ptr
  %104 = load ptr, ptr %93, align 8
  %call.i.i36.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
list_Nconc.exit.i:                                ; preds = %for.end.i.i, %if.else115
  ...
  br i1 %cmp.i.not.i17.i, label %red_DocumentFurtherCRw.exit, label %if.end.i18.i

if.end.i18.i:                                     ; preds = %list_Nconc.exit.i
  %cmp.i18.not.i19.i = icmp eq ptr %Clause.val16.i, null
  br i1 %cmp.i18.not.i19.i, label %red_DocumentFurtherCRw.exit, label %for.cond.i20.i

for.cond.i20.i:                                   ; preds = %if.end.i18.i, %for.cond.i20.i
  %List1.addr.0.i21.i = phi ptr [ %List1.addr.0.val17.i22.i, %for.cond.i20.i ], [ %.val254, %if.end.i18.i ]
  %List1.addr.0.val17.i22.i = load ptr, ptr %List1.addr.0.i21.i, align 8
  %cmp.i20.not.i23.i = icmp eq ptr %List1.addr.0.val17.i22.i, null
  br i1 %cmp.i20.not.i23.i, label %for.end.i24.i, label %for.cond.i20.i, !llvm.loop !10

for.end.i24.i:                                    ; preds = %for.cond.i20.i
  store ptr %Clause.val16.i, ptr %List1.addr.0.i21.i, align 8
  %.pre.i = load ptr, ptr %106, align 8
  br label %red_DocumentFurtherCRw.exit

red_DocumentFurtherCRw.exit:                      ; preds = %list_Nconc.exit.i.thread, %list_Nconc.exit.i, %if.end.i18.i, %for.end.i24.i
  %109 = phi ptr [ %108, %for.end.i24.i ], [ %108, %list_Nconc.exit.i ], [ %108, %if.end.i18.i ], [ %86, %list_Nconc.exit.i.thread ]
  %110 = phi ptr [ %106, %for.end.i24.i ], [ %106, %list_Nconc.exit.i ], [ %106, %if.end.i18.i ], [ %84, %list_Nconc.exit.i.thread ]
  %call.val.val.i319454460 = phi ptr [ %call.val.val.i319, %for.end.i24.i ], [ %call.val.val.i319, %list_Nconc.exit.i ], [ %call.val.val.i319, %if.end.i18.i ], [ %call.val.val.i319451, %list_Nconc.exit.i.thread ]
  %111 = phi ptr [ %.pre.i, %for.end.i24.i ], [ %retval.0.i.i321, %list_Nconc.exit.i ], [ %retval.0.i.i321, %if.end.i18.i ], [ %Clause.val15.i317449, %list_Nconc.exit.i.thread ]
  %retval.0.i25.i = phi ptr [ %.val254, %for.end.i24.i ], [ %Clause.val16.i, %list_Nconc.exit.i ], [ %.val254, %if.end.i18.i ], [ %Clause.val16.i458, %list_Nconc.exit.i.thread ]
  ...
  %call.i.i.i323 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i.i30.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i.i34.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i.i38.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
if.end117:                                        ; preds = %red_DocumentContextualRewriting.exit, %red_DocumentFurtherCRw.exit, %if.end100
  ...
  %call119 = tail call i32 @unify_MatchBindings(ptr noundef %121, ptr noundef nonnull %Gen.0.val, ptr noundef %31) #12
  ...
  %call122 = tail call ptr @term_Copy(ptr noundef %call44.val253.val.val) #12
  %call123 = tail call ptr @cont_ApplyBindingsModuloMatching(ptr noundef %122, ptr noundef %call122, i32 noundef 1) #12
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  %cmp.i332.1 = icmp ugt i32 %dec.i.i.i, 1
  br i1 %cmp.i332.1, label %while.body.i, label %while.end.i, !llvm.loop !36

while.end.i:                                      ; preds = %while.body.i.prol.loopexit, %while.body.i, %if.end117
  %135 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i328 = icmp eq i32 %135, 0
  br i1 %cmp.i.not.i328, label %cont_BackTrack.exit, label %if.then.i329

if.then.i329:                                     ; preds = %while.end.i
...
cont_BackTrack.exit:                              ; preds = %while.end.i, %if.then.i329
  %call125 = tail call i32 @term_ReplaceSubtermBy(ptr noundef %RedAtom.4, ptr noundef %31, ptr noundef %call123) #12
...
if.then.i.i.i:                                    ; preds = %if.end3.i
  %mul.i.i.i = shl i32 %143, 3
  %call.i.i.i338 = tail call ptr @memory_Malloc(i32 noundef %mul.i.i.i) #12
  %144 = load i32, ptr %splitfield_length.i.i, align 8
  %cmp349.not.i.i.i = icmp eq i32 %144, 0
  br i1 %cmp349.not.i.i.i, label %for.cond8.preheader.i.i.i, label %for.body.lr.ph.i.i.i
...
for.body11.preheader.i.i.i:                       ; preds = %for.cond8.preheader.i.i.i
  %145 = zext i32 %.lcssa.i.i.i to i64
  %146 = shl nuw nsw i64 %145, 3
  %scevgep.i.i.i = getelementptr i8, ptr %call.i.i.i338, i64 %146
  %147 = xor i32 %.lcssa.i.i.i, -1
  %148 = add i32 %143, %147
  %149 = zext i32 %148 to i64
  %150 = shl nuw nsw i64 %149, 3
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i
  %indvars.iv.i.i.i = phi i64 [ 0, %for.body.lr.ph.i.i.i ], [ %indvars.iv.next.i.i.i, %for.body.i.i.i ]
  %152 = load ptr, ptr %splitfield.i.i.i, align 8
  %arrayidx.i.i.i339 = getelementptr inbounds i64, ptr %152, i64 %indvars.iv.i.i.i
  %153 = load i64, ptr %arrayidx.i.i.i339, align 8
  %arrayidx6.i.i.i = getelementptr inbounds i64, ptr %call.i.i.i338, i64 %indvars.iv.i.i.i
  store i64 %153, ptr %arrayidx6.i.i.i, align 8
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1
  %154 = load i32, ptr %splitfield_length.i.i, align 8
  %155 = zext i32 %154 to i64
...
if.else25.i.i.i.i:                                ; preds = %if.then20.i.i.i
  ...
  %arrayidx.i.i.i.i = getelementptr inbounds [0 x ptr], ptr @memory_ARRAY, i64 0, i64 %idxprom.i.i.i.i
  %166 = load ptr, ptr %arrayidx.i.i.i.i, align 8
  %total_size.i.i.i.i340 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %166, i64 0, i32 4
  %167 = load i32, ptr %total_size.i.i.i.i340, align 8
  %conv26.i.i.i.i341 = sext i32 %167 to i64
  %168 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i342 = add i64 %168, %conv26.i.i.i.i341
  store i64 %add27.i.i.i.i342, ptr @memory_FREEDBYTES, align 8
  %169 = load ptr, ptr %166, align 8
  store ptr %169, ptr %156, align 8
  %170 = load ptr, ptr %arrayidx.i.i.i.i, align 8
  store ptr %156, ptr %170, align 8
...
clause_ExpandSplitField.exit.i.i:                 ; preds = %if.else25.i.i.i.i, %if.end23.i.i.i.i, %for.end16.i.i.i
  store ptr %call.i.i.i338, ptr %splitfield17.i.i.i, align 8
  store i32 %143, ptr %splitfield_length.i.i, align 8
  %.pre.i.i = load i32, ptr %splitfield_length1.i.i, align 8
  br label %if.end.i.i
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  %indvars.iv.i.i335 = phi i64 [ 0, %for.body.lr.ph.i.i ], [ %indvars.iv.next.i.i337, %for.body.i.i ]
  %172 = load ptr, ptr %splitfield.i.i, align 8
  %arrayidx.i.i336 = getelementptr inbounds i64, ptr %172, i64 %indvars.iv.i.i335
  %173 = load i64, ptr %arrayidx.i.i336, align 8
  %174 = load ptr, ptr %splitfield5.i.i, align 8
  %arrayidx7.i.i = getelementptr inbounds i64, ptr %174, i64 %indvars.iv.i.i335
  %175 = load i64, ptr %arrayidx7.i.i, align 8
  %or.i22.i = or i64 %175, %173
  store i64 %or.i22.i, ptr %arrayidx.i.i336, align 8
  %indvars.iv.next.i.i337 = add nuw nsw i64 %indvars.iv.i.i335, 1
  %176 = load i32, ptr %splitfield_length1.i.i, align 8
  %177 = zext i32 %176 to i64
  %cmp4.i.i = icmp ult i64 %indvars.iv.next.i.i337, %177
  br i1 %cmp4.i.i, label %for.body.i.i, label %clause_UpdateSplitDataFromPartner.exit, !llvm.loop !28
...
if.then127:                                       ; preds = %clause_UpdateSplitDataFromPartner.exit
  ...
  br i1 %tobool.not.i344, label %if.end.i348, label %if.then.i345

if.then.i345:                                     ; preds = %if.then127
  %flags.i.i346 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6, i64 0, i32 8
  %181 = load i32, ptr %flags.i.i346, align 8
  %or.i.i347 = or i32 %181, 8
  store i32 %or.i.i347, ptr %flags.i.i346, align 8
  br label %if.end.i348

if.end.i348:                                      ; preds = %if.then.i345, %if.then127
  %182 = getelementptr i8, ptr %178, i64 12
  %Partner.val19.i349 = load i32, ptr %182, align 4
  %cmp.i350 = icmp eq i32 %Partner.val19.i349, 0
  br i1 %cmp.i350, label %clause_UpdateSplitDataFromPartner.exit426, label %if.end3.i351

if.end3.i351:                                     ; preds = %if.end.i348
  %183 = getelementptr i8, ptr %Copy.6, i64 12
  %Result.val17.i352 = load i32, ptr %183, align 4
  %spec.select.i353 = tail call i32 @llvm.umax.i32(i32 %Partner.val19.i349, i32 %Result.val17.i352)
  store i32 %spec.select.i353, ptr %183, align 4
  %splitfield_length.i.i354 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6, i64 0, i32 5
  %184 = load i32, ptr %splitfield_length.i.i354, align 8
  %splitfield_length1.i.i355 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %178, i64 0, i32 5
  %185 = load i32, ptr %splitfield_length1.i.i355, align 8
  %cmp.i21.i356 = icmp ult i32 %184, %185
  br i1 %cmp.i21.i356, label %if.then.i.i.i369, label %if.end.i.i357

if.then.i.i.i369:                                 ; preds = %if.end3.i351
  %mul.i.i.i370 = shl i32 %185, 3
  %call.i.i.i371 = tail call ptr @memory_Malloc(i32 noundef %mul.i.i.i370) #12
  %186 = load i32, ptr %splitfield_length.i.i354, align 8
  %cmp349.not.i.i.i372 = icmp eq i32 %186, 0
  br i1 %cmp349.not.i.i.i372, label %for.cond8.preheader.i.i.i381, label %for.body.lr.ph.i.i.i373

for.body.lr.ph.i.i.i373:                          ; preds = %if.then.i.i.i369
  %splitfield.i.i.i374 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6, i64 0, i32 4
  br label %for.body.i.i.i375

for.cond8.preheader.i.i.i381:                     ; preds = %for.body.i.i.i375, %if.then.i.i.i369
  %.lcssa.i.i.i382 = phi i32 [ 0, %if.then.i.i.i369 ], [ %196, %for.body.i.i.i375 ]
  %cmp951.i.i.i383 = icmp ult i32 %.lcssa.i.i.i382, %185
  br i1 %cmp951.i.i.i383, label %for.body11.preheader.i.i.i424, label %for.end16.i.i.i384

for.body11.preheader.i.i.i424:                    ; preds = %for.cond8.preheader.i.i.i381
  %187 = zext i32 %.lcssa.i.i.i382 to i64
  %188 = shl nuw nsw i64 %187, 3
  %scevgep.i.i.i425 = getelementptr i8, ptr %call.i.i.i371, i64 %188
  %189 = xor i32 %.lcssa.i.i.i382, -1
  %190 = add i32 %185, %189
  %191 = zext i32 %190 to i64
  %192 = shl nuw nsw i64 %191, 3
  %193 = add nuw nsw i64 %192, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep.i.i.i425, i8 0, i64 %193, i1 false)
  br label %for.end16.i.i.i384

for.body.i.i.i375:                                ; preds = %for.body.i.i.i375, %for.body.lr.ph.i.i.i373
  %indvars.iv.i.i.i376 = phi i64 [ 0, %for.body.lr.ph.i.i.i373 ], [ %indvars.iv.next.i.i.i379, %for.body.i.i.i375 ]
  %194 = load ptr, ptr %splitfield.i.i.i374, align 8
  %arrayidx.i.i.i377 = getelementptr inbounds i64, ptr %194, i64 %indvars.iv.i.i.i376
  %195 = load i64, ptr %arrayidx.i.i.i377, align 8
  %arrayidx6.i.i.i378 = getelementptr inbounds i64, ptr %call.i.i.i371, i64 %indvars.iv.i.i.i376
  store i64 %195, ptr %arrayidx6.i.i.i378, align 8
  %indvars.iv.next.i.i.i379 = add nuw nsw i64 %indvars.iv.i.i.i376, 1
  %196 = load i32, ptr %splitfield_length.i.i354, align 8
  %197 = zext i32 %196 to i64
  %cmp3.i.i.i380 = icmp ult i64 %indvars.iv.next.i.i.i379, %197
  br i1 %cmp3.i.i.i380, label %for.body.i.i.i375, label %for.cond8.preheader.i.i.i381, !llvm.loop !27

for.end16.i.i.i384:                               ; preds = %for.body11.preheader.i.i.i424, %for.cond8.preheader.i.i.i381
  %splitfield17.i.i.i385 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6, i64 0, i32 4
  %198 = load ptr, ptr %splitfield17.i.i.i385, align 8
  %cmp18.not.i.i.i386 = icmp eq ptr %198, null
  br i1 %cmp18.not.i.i.i386, label %clause_ExpandSplitField.exit.i.i414, label %if.then20.i.i.i387

if.then20.i.i.i387:                               ; preds = %for.end16.i.i.i384
  %199 = load i32, ptr %splitfield_length.i.i354, align 8
  %mul24.i.i.i388 = shl i32 %199, 3
  %cmp.i.i.i.i.i389 = icmp ult i32 %mul24.i.i.i388, 1024
  br i1 %cmp.i.i.i.i.i389, label %if.else25.i.i.i.i418, label %if.then.i.i.i.i390

if.then.i.i.i.i390:                               ; preds = %if.then20.i.i.i387
  %rem2.i.i.i.i.i.i391 = urem i32 %mul24.i.i.i388, %8
  %tobool3.not.i.i.i.i.i.i392 = icmp eq i32 %rem2.i.i.i.i.i.i391, 0
  %sub6.i.i.i.i.i.i393 = sub i32 %8, %rem2.i.i.i.i.i.i391
  %add7.i.i.i.i.i.i394 = select i1 %tobool3.not.i.i.i.i.i.i392, i32 0, i32 %sub6.i.i.i.i.i.i393
  %RealSize.1.i.i.i.i.i.i395 = add i32 %add7.i.i.i.i.i.i394, %mul24.i.i.i388
  %200 = load i32, ptr @memory_OFFSET, align 4
  %idx.ext.i.i.i.i396 = zext i32 %200 to i64
  %idx.neg.i.i.i.i397 = sub nsw i64 0, %idx.ext.i.i.i.i396
  %add.ptr.i.i.i.i398 = getelementptr inbounds i8, ptr %198, i64 %idx.neg.i.i.i.i397
  %add.ptr1.i.i.i.i399 = getelementptr inbounds i8, ptr %add.ptr.i.i.i.i398, i64 -16
  %201 = load ptr, ptr %add.ptr1.i.i.i.i399, align 8
  %cmp2.not.i.i.i.i400 = icmp eq ptr %201, null
  %next6.i.i.i.i401 = getelementptr inbounds i8, ptr %add.ptr.i.i.i.i398, i64 -8
  %202 = load ptr, ptr %next6.i.i.i.i401, align 8
  %next5.i.i.i.i402 = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %201, i64 0, i32 1
  %memory_BIGBLOCKS.sink.i.i.i.i403 = select i1 %cmp2.not.i.i.i.i400, ptr @memory_BIGBLOCKS, ptr %next5.i.i.i.i402
  store ptr %202, ptr %memory_BIGBLOCKS.sink.i.i.i.i403, align 8
  %203 = load ptr, ptr %next6.i.i.i.i401, align 8
  %cmp8.not.i.i.i.i404 = icmp eq ptr %203, null
  br i1 %cmp8.not.i.i.i.i404, label %if.end13.i.i.i.i406, label %if.then9.i.i.i.i405

if.then9.i.i.i.i405:                              ; preds = %if.then.i.i.i.i390
  %204 = load ptr, ptr %add.ptr1.i.i.i.i399, align 8
  store ptr %204, ptr %203, align 8
  br label %if.end13.i.i.i.i406

if.end13.i.i.i.i406:                              ; preds = %if.then9.i.i.i.i405, %if.then.i.i.i.i390
  %205 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i.i.i407 = add i32 %RealSize.1.i.i.i.i.i.i395, %205
  %conv.i.i.i.i408 = zext i32 %add.i.i.i.i407 to i64
  %add14.i.i.i.i409 = add nuw nsw i64 %conv.i.i.i.i408, 16
  %206 = load i64, ptr @memory_FREEDBYTES, align 8
  %add15.i.i.i.i410 = add i64 %add14.i.i.i.i409, %206
  store i64 %add15.i.i.i.i410, ptr @memory_FREEDBYTES, align 8
  %207 = load i64, ptr @memory_MAXMEM, align 8
  %cmp16.i.i.i.i411 = icmp sgt i64 %207, -1
  br i1 %cmp16.i.i.i.i411, label %if.then18.i.i.i.i416, label %if.end23.i.i.i.i412

if.then18.i.i.i.i416:                             ; preds = %if.end13.i.i.i.i406
  %add22.i.i.i.i417 = add nuw i64 %207, %add14.i.i.i.i409
  store i64 %add22.i.i.i.i417, ptr @memory_MAXMEM, align 8
  br label %if.end23.i.i.i.i412

if.end23.i.i.i.i412:                              ; preds = %if.then18.i.i.i.i416, %if.end13.i.i.i.i406
  %add.ptr24.i.i.i.i413 = getelementptr inbounds i8, ptr %198, i64 -16
  tail call void @free(ptr noundef nonnull %add.ptr24.i.i.i.i413) #12
  br label %clause_ExpandSplitField.exit.i.i414

if.else25.i.i.i.i418:                             ; preds = %if.then20.i.i.i387
  %idxprom.i.i.i.i419 = zext i32 %mul24.i.i.i388 to i64
  %arrayidx.i.i.i.i420 = getelementptr inbounds [0 x ptr], ptr @memory_ARRAY, i64 0, i64 %idxprom.i.i.i.i419
  %208 = load ptr, ptr %arrayidx.i.i.i.i420, align 8
  %total_size.i.i.i.i421 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %208, i64 0, i32 4
  %209 = load i32, ptr %total_size.i.i.i.i421, align 8
  %conv26.i.i.i.i422 = sext i32 %209 to i64
  %210 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i423 = add i64 %210, %conv26.i.i.i.i422
  store i64 %add27.i.i.i.i423, ptr @memory_FREEDBYTES, align 8
  %211 = load ptr, ptr %208, align 8
  store ptr %211, ptr %198, align 8
  %212 = load ptr, ptr %arrayidx.i.i.i.i420, align 8
  store ptr %198, ptr %212, align 8
  br label %clause_ExpandSplitField.exit.i.i414

clause_ExpandSplitField.exit.i.i414:              ; preds = %if.else25.i.i.i.i418, %if.end23.i.i.i.i412, %for.end16.i.i.i384
  store ptr %call.i.i.i371, ptr %splitfield17.i.i.i385, align 8
  store i32 %185, ptr %splitfield_length.i.i354, align 8
  %.pre.i.i415 = load i32, ptr %splitfield_length1.i.i355, align 8
  br label %if.end.i.i357

if.end.i.i357:                                    ; preds = %clause_ExpandSplitField.exit.i.i414, %if.end3.i351
  %213 = phi i32 [ %.pre.i.i415, %clause_ExpandSplitField.exit.i.i414 ], [ %185, %if.end3.i351 ]
  %cmp421.not.i.i358 = icmp eq i32 %213, 0
  br i1 %cmp421.not.i.i358, label %clause_UpdateSplitDataFromPartner.exit426, label %for.body.lr.ph.i.i359

for.body.lr.ph.i.i359:                            ; preds = %if.end.i.i357
  %splitfield.i.i360 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6, i64 0, i32 4
  %splitfield5.i.i361 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %178, i64 0, i32 4
  br label %for.body.i.i362

for.body.i.i362:                                  ; preds = %for.body.i.i362, %for.body.lr.ph.i.i359
  %indvars.iv.i.i363 = phi i64 [ 0, %for.body.lr.ph.i.i359 ], [ %indvars.iv.next.i.i367, %for.body.i.i362 ]
  %214 = load ptr, ptr %splitfield.i.i360, align 8
  %arrayidx.i.i364 = getelementptr inbounds i64, ptr %214, i64 %indvars.iv.i.i363
  %215 = load i64, ptr %arrayidx.i.i364, align 8
  %216 = load ptr, ptr %splitfield5.i.i361, align 8
  %arrayidx7.i.i365 = getelementptr inbounds i64, ptr %216, i64 %indvars.iv.i.i363
  %217 = load i64, ptr %arrayidx7.i.i365, align 8
  %or.i22.i366 = or i64 %217, %215
  store i64 %or.i22.i366, ptr %arrayidx.i.i364, align 8
  %indvars.iv.next.i.i367 = add nuw nsw i64 %indvars.iv.i.i363, 1
  %218 = load i32, ptr %splitfield_length1.i.i355, align 8
  %219 = zext i32 %218 to i64
  %cmp4.i.i368 = icmp ult i64 %indvars.iv.next.i.i367, %219
  br i1 %cmp4.i.i368, label %for.body.i.i362, label %clause_UpdateSplitDataFromPartner.exit426, !llvm.loop !28

clause_UpdateSplitDataFromPartner.exit426:        ; preds = %for.body.i.i362, %if.end.i348, %if.end.i.i357
  %220 = load ptr, ptr %HelpClause, align 8
  tail call void @clause_Delete(ptr noundef %220) #12
  br label %if.end128

if.end128:                                        ; preds = %clause_UpdateSplitDataFromPartner.exit426, %clause_UpdateSplitDataFromPartner.exit
  tail call void @term_Delete(ptr noundef %call123) #12
...
for.inc.thread:                                   ; preds = %if.end128, %if.then131
  %call.i = tail call i32 @clause_ComputeWeight(ptr noundef %Copy.6, ptr noundef nonnull %Search.val) #12
...
for.end:                                          ; preds = %for.inc, %for.inc.thread, %if.then49
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %HelpClause) #12
  br label %for.inc138
...
for.end144:                                       ; preds = %for.inc142, %while.body20
  ...
  br i1 %cmp.i276.lcssa, label %while.body.i429, label %list_Delete.exit

while.body.i429:                                  ; preds = %for.end144, %while.body.i429
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i429 ], [ %Gen.0.lcssa, %for.end144 ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  %229 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i430 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %229, i64 0, i32 4
  %230 = load i32, ptr %total_size.i.i.i430, align 8
  %conv26.i.i.i431 = sext i32 %230 to i64
  %231 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i432 = add i64 %231, %conv26.i.i.i431
  store i64 %add27.i.i.i432, ptr @memory_FREEDBYTES, align 8
  ...
  %cmp.i.not.i433 = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i433, label %list_Delete.exit, label %while.body.i429, !llvm.loop !8

list_Delete.exit:                                 ; preds = %while.body.i429, %for.end144
...
if.then150:                                       ; preds = %for.end148
  tail call void @clause_OrientEqualities(ptr noundef %Copy.10, ptr noundef %Search.val, ptr noundef %Search.val247) #12
  tail call void @clause_Normalize(ptr noundef %Copy.10) #12
  tail call void @clause_SetMaxLitFlags(ptr noundef %Copy.10, ptr noundef %Search.val, ptr noundef %Search.val247) #12
  %call.i.i.i435 = tail call i32 @clause_ComputeWeight(ptr noundef %Copy.10, ptr noundef %Search.val) #12
  %weight.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.10, i64 0, i32 1
...
if.then157:                                       ; preds = %if.end155
  tail call void @clause_OrientEqualities(ptr noundef %RedClause, ptr noundef nonnull %Search.val, ptr noundef %Search.val247) #12
  tail call void @clause_Normalize(ptr noundef %RedClause) #12
  tail call void @clause_SetMaxLitFlags(ptr noundef %RedClause, ptr noundef nonnull %Search.val, ptr noundef %Search.val247) #12
  %call.i.i.i437 = tail call i32 @clause_ComputeWeight(ptr noundef %RedClause, ptr noundef nonnull %Search.val) #12
...
clause_LiteralAtom.exit:                          ; preds = %while.body, %if.then.i
  ...
  %call9 = tail call ptr @sort_ComputeSortNoResidues(ptr noundef nonnull %Theory, ptr noundef %call7.val143.val, ptr noundef nonnull %Copy.0194, i32 noundef %i.0190, ptr noundef %Flags, ptr noundef %Precedence) #12
  ...
  %call16 = tail call ptr @sort_TheorySortOfSymbol(ptr noundef nonnull %Theory, i32 noundef %call7.val) #12
  %call17 = tail call ptr @sort_TheoryIsSubsortOfNoResidues(ptr noundef nonnull %Theory, ptr noundef %call9.val, ptr noundef %call16) #12
...
if.then22:                                        ; preds = %land.lhs.true
  ...
  tail call void @clause_Print(ptr noundef nonnull %Copy.0194) #12
  %16 = load ptr, ptr @stdout, align 8
...
list_Nconc.exit.thread:                           ; preds = %if.end.i
  ...
  tail call void @sort_ConditionDelete(ptr noundef nonnull %call17) #12
...
if.then37:                                        ; preds = %lor.lhs.false, %land.lhs.true31
  %call38 = tail call ptr @clause_Copy(ptr noundef %Clause) #12
  br label %if.end39
...
if.end39:                                         ; preds = %if.then37, %lor.lhs.false, %for.body
  ...
  br i1 %tobool.not.i, label %if.end.i154, label %if.then.i153
...
if.end.i154:                                      ; preds = %if.then.i153, %if.end39
  %25 = getelementptr i8, ptr %Scan.0.val141, i64 12
  %Partner.val19.i = load i32, ptr %25, align 4
  %cmp.i155 = icmp eq i32 %Partner.val19.i, 0
  br i1 %cmp.i155, label %clause_UpdateSplitDataFromPartner.exit, label %if.end3.i

if.end3.i:                                        ; preds = %if.end.i154
...
clause_UpdateSplitDataFromPartner.exit:           ; preds = %for.body.i.i, %if.end.i154, %if.end.i.i
...
if.end52:                                         ; preds = %if.then50, %for.end
  ...
  tail call void @clause_DeleteLiteral(ptr noundef %Copy.1.lcssa, i32 noundef %i.0190, ptr noundef %Flags, ptr noundef %Precedence) #12
  br i1 %cmp.i.not185204, label %list_Nconc.exit166, label %if.end.i158

if.end.i158:                                      ; preds = %if.end52
  %cmp.i18.not.i159 = icmp eq ptr %Clauses.0189, null
  br i1 %cmp.i18.not.i159, label %list_Nconc.exit166, label %for.cond.i160

for.cond.i160:                                    ; preds = %if.end.i158, %for.cond.i160
  %List1.addr.0.i161 = phi ptr [ %List1.addr.0.val17.i162, %for.cond.i160 ], [ %retval.0.i150202, %if.end.i158 ]
  %List1.addr.0.val17.i162 = load ptr, ptr %List1.addr.0.i161, align 8
  %cmp.i20.not.i163 = icmp eq ptr %List1.addr.0.val17.i162, null
  br i1 %cmp.i20.not.i163, label %for.end.i164, label %for.cond.i160, !llvm.loop !10

for.end.i164:                                     ; preds = %for.cond.i160
  store ptr %Clauses.0189, ptr %List1.addr.0.i161, align 8
  br label %list_Nconc.exit166

list_Nconc.exit166:                               ; preds = %if.end52, %if.end.i158, %for.end.i164
  %retval.0.i165 = phi ptr [ %retval.0.i150202, %for.end.i164 ], [ %Clauses.0189, %if.end52 ], [ %retval.0.i150202, %if.end.i158 ]
...
if.end55:                                         ; preds = %list_Delete.exit, %list_Nconc.exit166
  ...
  tail call void @sort_DeleteSortPair(ptr noundef nonnull %call9) #12
  tail call void @sort_Delete(ptr noundef %call16) #12
...
list_Delete.exit.i:                               ; preds = %while.body.i.i, %if.then60
  ...
  br i1 %cmp.i.not5.i47.i, label %list_Delete.exit55.i, label %while.body.i48.i

while.body.i48.i:                                 ; preds = %list_Delete.exit.i, %while.body.i48.i
  %Current.06.i49.i = phi ptr [ %Current.0.val.i50.i, %while.body.i48.i ], [ %Clause.val45.i, %list_Delete.exit.i ]
  %Current.0.val.i50.i = load ptr, ptr %Current.06.i49.i, align 8
  %77 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i51.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %77, i64 0, i32 4
  %78 = load i32, ptr %total_size.i.i.i51.i, align 8
  %conv26.i.i.i52.i = sext i32 %78 to i64
  %79 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i53.i = add i64 %79, %conv26.i.i.i52.i
  store i64 %add27.i.i.i53.i, ptr @memory_FREEDBYTES, align 8
  %80 = load ptr, ptr %77, align 8
  store ptr %80, ptr %Current.06.i49.i, align 8
  %81 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i49.i, ptr %81, align 8
  %cmp.i.not.i54.i = icmp eq ptr %Current.0.val.i50.i, null
  br i1 %cmp.i.not.i54.i, label %list_Delete.exit55.i, label %while.body.i48.i, !llvm.loop !8

list_Delete.exit55.i:                             ; preds = %while.body.i48.i, %list_Delete.exit.i
...
for.cond8.preheader.i:                            ; preds = %for.body.i
  ...
  br i1 %cmp.i56.not75.i, label %if.end.i63.thread.i, label %for.body12.preheader.i
...
for.body12.i:                                     ; preds = %for.body12.i, %for.body12.preheader.i
  ...
  %call.i58.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
list_Nconc.exit.i:                                ; preds = %for.end.i.i, %for.end22.i
  ...
  br i1 %cmp.i.not.i62.i, label %red_DocumentSortSimplification.exit, label %for.cond.i65.i

for.cond.i65.i:                                   ; preds = %list_Nconc.exit.i, %for.cond.i65.i
  %List1.addr.0.i66.i = phi ptr [ %List1.addr.0.val17.i67.i, %for.cond.i65.i ], [ %Self.0.lcssa86.i, %list_Nconc.exit.i ]
  %List1.addr.0.val17.i67.i = load ptr, ptr %List1.addr.0.i66.i, align 8
  %cmp.i20.not.i68.i = icmp eq ptr %List1.addr.0.val17.i67.i, null
  br i1 %cmp.i20.not.i68.i, label %for.end.i69.i, label %for.cond.i65.i, !llvm.loop !10

for.end.i69.i:                                    ; preds = %for.cond.i65.i
  store ptr %Clauses.1, ptr %List1.addr.0.i66.i, align 8
  br label %red_DocumentSortSimplification.exit

red_DocumentSortSimplification.exit:              ; preds = %list_Nconc.exit.thread99.i, %if.end.i63.thread.i, %list_Nconc.exit.i, %for.end.i69.i
  %retval.0.i70.i = phi ptr [ %Self.0.lcssa86.i, %for.end.i69.i ], [ %Clauses.1, %list_Nconc.exit.i ], [ null, %list_Nconc.exit.thread99.i ], [ %call.i.i, %if.end.i63.thread.i ]
...
if.else61:                                        ; preds = %if.then58
  ...
  br i1 %cmp.i.not5.i173, label %if.end62, label %while.body.i174

while.body.i174:                                  ; preds = %if.else61, %while.body.i174
  %Current.06.i175 = phi ptr [ %Current.0.val.i176, %while.body.i174 ], [ %Clauses.1, %if.else61 ]
  ...
  %total_size.i.i.i177 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %89, i64 0, i32 4
  %90 = load i32, ptr %total_size.i.i.i177, align 8
  %conv26.i.i.i178 = sext i32 %90 to i64
  %91 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i179 = add i64 %91, %conv26.i.i.i178
  store i64 %add27.i.i.i179, ptr @memory_FREEDBYTES, align 8
  %92 = load ptr, ptr %89, align 8
  store ptr %92, ptr %Current.06.i175, align 8
  %93 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i175, ptr %93, align 8
  %cmp.i.not.i180 = icmp eq ptr %Current.0.val.i176, null
  br i1 %cmp.i.not.i180, label %if.end62, label %while.body.i174, !llvm.loop !8

if.end62:                                         ; preds = %while.body.i174, %if.else61, %red_DocumentSortSimplification.exit
  tail call void @clause_Normalize(ptr noundef %Copy.3) #12
  tail call void @clause_SetMaxLitFlags(ptr noundef %Copy.3, ptr noundef %Flags, ptr noundef %Precedence) #12
  %call.i.i182 = tail call i32 @clause_ComputeWeight(ptr noundef %Copy.3, ptr noundef %Flags) #12
  %weight.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.3, i64 0, i32 1
  store i32 %call.i.i182, ptr %weight.i.i, align 4
  tail call void @clause_UpdateMaxVar(ptr noundef %Copy.3) #12
...
if.then65:                                        ; preds = %if.end62
  ...
  tail call void @clause_Print(ptr noundef nonnull %Copy.3) #12
  br label %if.end67
...
clause_LiteralAtom.exit.i:                        ; preds = %if.then.i.i, %clause_LiteralGetIndex.exit.i
  ...
  %call5.i = tail call ptr @st_ExistGen(ptr noundef %16, ptr noundef %ShIndex.val.i, ptr noundef %retval.0.i.i) #12
...
while.body.i:                                     ; preds = %clause_LiteralAtom.exit.i, %if.end26.i
  ...
  br i1 %cmp.i.i.i, label %if.then.i168, label %if.end26.i

if.then.i168:                                     ; preds = %while.body.i
  %call8.i = tail call ptr @sharing_NAtomDataList(ptr noundef nonnull %CandTerm.065.i) #12
...
if.then16.i:                                      ; preds = %lor.rhs.i.i, %land.lhs.true.i.i
  ...
  br i1 %cmp.i169, label %red_GetMRResLit.exit.thread, label %lor.lhs.false.i
...
while.cond.i51.i:                                 ; preds = %while.cond.i51.i, %lor.lhs.false.i
  %indvars.iv.i52.i = phi i64 [ %indvars.iv.next.i55.i, %while.cond.i51.i ], [ 0, %lor.lhs.false.i ]
  %arrayidx.i.i53.i = getelementptr inbounds ptr, ptr %call.val.i50.i, i64 %indvars.iv.i52.i
  ...
  br i1 %cmp.not.i54.i, label %clause_LiteralGetIndex.exit56.i, label %while.cond.i51.i, !llvm.loop !12

clause_LiteralGetIndex.exit56.i:                  ; preds = %while.cond.i51.i
  %28 = trunc i64 %indvars.iv.i52.i to i32
  %call21.i = tail call i32 @subs_SubsumesBasic(ptr noundef %call13.val45.i, ptr noundef %ActLit.val46.i, i32 noundef %28, i32 noundef %15) #12
...
if.end24.i:                                       ; preds = %clause_LiteralGetIndex.exit56.i, %lor.rhs.i.i, %land.lhs.true.i.i
  ...
  %cmp.i.not.i170 = icmp eq ptr %LitScan.0.val44.i, null
  br i1 %cmp.i.not.i170, label %if.end26.i, label %while.body12.i, !llvm.loop !92

if.end26.i:                                       ; preds = %if.end24.i, %if.then.i168, %while.body.i
  %call27.i = tail call ptr @st_NextCandidate() #12
...
if.then19:                                        ; preds = %land.lhs.true
  ...
  tail call void @clause_Print(ptr noundef %Copy.0215) #12
  br label %if.end
...
clause_LiteralGetIndex.exit:                      ; preds = %while.cond.i
  ...
  %call.i176 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i178 = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
if.then38:                                        ; preds = %lor.lhs.false33, %land.lhs.true31
  %call39 = tail call ptr @clause_Copy(ptr noundef %Clause) #12
  br label %if.end40
...
if.end40:                                         ; preds = %if.then38, %lor.lhs.false33, %clause_LiteralGetIndex.exit
  ...
  tail call void @clause_DeleteLiteral(ptr noundef %Copy.1, i32 noundef %i.0216, ptr noundef %Flags, ptr noundef %Precedence) #12
...
if.then50:                                        ; preds = %if.then48
  %call51 = tail call ptr @list_NReverse(ptr noundef nonnull %ReducedBy.1) #12
  %call52 = tail call ptr @list_NReverse(ptr noundef %ReducedLits.1) #12
  %call53 = tail call ptr @list_NReverse(ptr noundef %PLits.1) #12
...
for.end:                                          ; preds = %for.body, %if.then56
  ...
  tail call void @clause_Print(ptr noundef %Copy.2) #12
  br label %if.end86
...
if.else67:                                        ; preds = %if.then48
  ...
  br i1 %tobool69.not, label %while.body.i189.preheader, label %if.then70
...
for.body76:                                       ; preds = %if.then70, %for.body76
  %Scan2.1229 = phi ptr [ %ReducedLits.1, %if.then70 ], [ %Scan2.1.val159, %for.body76 ]
  %Scan1.1228 = phi ptr [ %ReducedBy.1, %if.then70 ], [ %Scan1.1.val160, %for.body76 ]
  %54 = getelementptr i8, ptr %Scan1.1228, i64 8
  %Scan1.1.val = load ptr, ptr %54, align 8
  %55 = ptrtoint ptr %Scan1.1.val to i64
  %56 = trunc i64 %55 to i32
  %57 = getelementptr i8, ptr %Scan2.1229, i64 8
  ...
  %Scan1.1.val160 = load ptr, ptr %Scan1.1228, align 8
  %Scan2.1.val159 = load ptr, ptr %Scan2.1229, align 8
...
for.end83:                                        ; preds = %for.body76
  ...
  tail call void @clause_Print(ptr noundef %Copy.2) #12
  br label %while.body.i189.preheader

while.body.i189.preheader:                        ; preds = %if.else67, %for.end83
  br label %while.body.i189

while.body.i189:                                  ; preds = %while.body.i189.preheader, %while.body.i189
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i189 ], [ %ReducedBy.1, %while.body.i189.preheader ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  ...
  %cmp.i.not.i190 = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i190, label %list_Delete.exit, label %while.body.i189, !llvm.loop !8

list_Delete.exit:                                 ; preds = %while.body.i189
  %cmp.i.not5.i191 = icmp eq ptr %ReducedLits.1, null
  br i1 %cmp.i.not5.i191, label %list_Delete.exit199, label %while.body.i192

while.body.i192:                                  ; preds = %list_Delete.exit, %while.body.i192
  %Current.06.i193 = phi ptr [ %Current.0.val.i194, %while.body.i192 ], [ %ReducedLits.1, %list_Delete.exit ]
  ...
  %total_size.i.i.i195 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %67, i64 0, i32 4
  %68 = load i32, ptr %total_size.i.i.i195, align 8
  %conv26.i.i.i196 = sext i32 %68 to i64
  %69 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i197 = add i64 %69, %conv26.i.i.i196
  store i64 %add27.i.i.i197, ptr @memory_FREEDBYTES, align 8
  %70 = load ptr, ptr %67, align 8
  store ptr %70, ptr %Current.06.i193, align 8
  %71 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i193, ptr %71, align 8
  %cmp.i.not.i198 = icmp eq ptr %Current.0.val.i194, null
  br i1 %cmp.i.not.i198, label %list_Delete.exit199, label %while.body.i192, !llvm.loop !8

list_Delete.exit199:                              ; preds = %while.body.i192, %list_Delete.exit
  %cmp.i.not5.i200 = icmp eq ptr %PLits.1, null
  br i1 %cmp.i.not5.i200, label %if.end86, label %while.body.i201

while.body.i201:                                  ; preds = %list_Delete.exit199, %while.body.i201
  %Current.06.i202 = phi ptr [ %Current.0.val.i203, %while.body.i201 ], [ %PLits.1, %list_Delete.exit199 ]
  %Current.0.val.i203 = load ptr, ptr %Current.06.i202, align 8
  %72 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i204 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %72, i64 0, i32 4
  %73 = load i32, ptr %total_size.i.i.i204, align 8
  %conv26.i.i.i205 = sext i32 %73 to i64
  %74 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i206 = add i64 %74, %conv26.i.i.i205
  store i64 %add27.i.i.i206, ptr @memory_FREEDBYTES, align 8
  %75 = load ptr, ptr %72, align 8
  store ptr %75, ptr %Current.06.i202, align 8
  %76 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i202, ptr %76, align 8
  %cmp.i.not.i207 = icmp eq ptr %Current.0.val.i203, null
  br i1 %cmp.i.not.i207, label %if.end86, label %while.body.i201, !llvm.loop !8

if.end86:                                         ; preds = %while.body.i201, %list_Delete.exit199, %if.then50, %for.end
...
clause_LiteralAtom.exit:                          ; preds = %if.then, %if.then.i
  ...
  %call8 = tail call ptr @st_ExistUnifier(ptr noundef %6, ptr noundef %ShIndex.val186, ptr noundef %7, ptr noundef %retval.0.i) #12
...
if.then12:                                        ; preds = %while.body
  %call13 = tail call ptr @sharing_NAtomDataList(ptr noundef nonnull %CandTerm.0285) #12
...
if.end31:                                         ; preds = %if.end, %if.then12, %while.body
  %call30 = tail call ptr @st_NextCandidate() #12
...
clause_LiteralAtom.exit203:                       ; preds = %land.lhs.true34
  ...
  %call1.val.i201 = load ptr, ptr %19, align 8
  %20 = getelementptr i8, ptr %call1.val.i201, i64 8
  %call1.val.val.i202 = load ptr, ptr %20, align 8
  %call35.val = load i32, ptr %call1.val.val.i202, align 8
  %21 = load i32, ptr @fol_EQUALITY, align 4
...
clause_LiteralAtom.exit212:                       ; preds = %clause_LiteralAtom.exit203, %clause_LiteralAtom.exit203.thread
  ...
  %retval.0.i208 = phi ptr [ %call3.val181, %clause_LiteralAtom.exit203.thread ], [ %call1.val.val.i202, %clause_LiteralAtom.exit203 ]
  %24 = getelementptr i8, ptr %retval.0.i208, i64 16
  %call40.val = load ptr, ptr %24, align 8
  %call42 = tail call ptr @list_Reverse(ptr noundef %call40.val) #12
  %call43 = tail call ptr @term_Create(i32 noundef %23, ptr noundef %call42) #12
  %25 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  %ShIndex.val = load ptr, ptr %ShIndex, align 8
  %26 = load ptr, ptr @cont_RIGHTCONTEXT, align 8
  %call47 = tail call ptr @st_ExistUnifier(ptr noundef %25, ptr noundef %ShIndex.val, ptr noundef %26, ptr noundef %call43) #12
...
if.then56:                                        ; preds = %while.body53
  %call57 = tail call ptr @sharing_NAtomDataList(ptr noundef nonnull %CandTerm.2292) #12
...
while.body62:                                     ; preds = %while.body62.preheader, %if.end74
  ...
  br i1 %cmp.i.not.i217, label %land.lhs.true.i227, label %lor.rhs.i220

land.lhs.true.i227:                               ; preds = %while.body62
  %cmp.i.i.not.i228 = icmp eq i32 %L2.val10.val.i219, %.pre297
  br i1 %cmp.i.i.not.i228, label %if.end74, label %land.lhs.true66

lor.rhs.i220:                                     ; preds = %while.body62
  %cmp.i11.not.i222 = icmp ne i32 %.pre297, %L2.val10.val.i219
  %or.cond281 = or i1 %cmp.i.not.i217, %cmp.i11.not.i222
  br i1 %or.cond281, label %if.end74, label %land.lhs.true66

land.lhs.true66:                                  ; preds = %lor.rhs.i220, %land.lhs.true.i227
...
if.end74:                                         ; preds = %land.lhs.true.i227, %land.lhs.true66, %lor.rhs.i220
...
if.end80:                                         ; preds = %if.end74, %if.then56, %while.body53
  %call79 = tail call ptr @st_NextCandidate() #12
...
if.then100:                                       ; preds = %lor.lhs.false, %if.end91
  %call101 = tail call ptr @clause_Copy(ptr noundef %Clause) #12
  br label %if.end102
...
if.end102:                                        ; preds = %if.then100, %lor.lhs.false
  ...
  tail call void @clause_DeleteLiteral(ptr noundef %Copy.0, i32 noundef 0, ptr noundef nonnull %Flags, ptr noundef %Precedence) #12
...
if.then105:                                       ; preds = %if.end102
  ...
  %call.i.i241 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  ...
  %call.i.i243 = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
list_Delete.exit.i:                               ; preds = %while.body.i.i, %if.then105
  ...
  br i1 %cmp.i.not5.i15.i, label %if.end.i26.i, label %while.body.i16.i

while.body.i16.i:                                 ; preds = %list_Delete.exit.i, %while.body.i16.i
  %Current.06.i17.i = phi ptr [ %Current.0.val.i18.i, %while.body.i16.i ], [ %Clause.val13.i, %list_Delete.exit.i ]
  ...
  %total_size.i.i.i19.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %58, i64 0, i32 4
  %59 = load i32, ptr %total_size.i.i.i19.i, align 8
  %conv26.i.i.i20.i = sext i32 %59 to i64
  %60 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i21.i = add i64 %60, %conv26.i.i.i20.i
  store i64 %add27.i.i.i21.i, ptr @memory_FREEDBYTES, align 8
  %61 = load ptr, ptr %58, align 8
  store ptr %61, ptr %Current.06.i17.i, align 8
  %62 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i17.i, ptr %62, align 8
  %cmp.i.not.i22.i = icmp eq ptr %Current.0.val.i18.i, null
  br i1 %cmp.i.not.i22.i, label %if.end.i26.i, label %while.body.i16.i, !llvm.loop !8

if.end.i26.i:                                     ; preds = %while.body.i16.i, %list_Delete.exit.i
...
for.cond.i28.i:                                   ; preds = %if.end.i26.i, %for.cond.i28.i
  %List1.addr.0.i29.i = phi ptr [ %List1.addr.0.val17.i30.i, %for.cond.i28.i ], [ %call.i.i, %if.end.i26.i ]
  %List1.addr.0.val17.i30.i = load ptr, ptr %List1.addr.0.i29.i, align 8
  %cmp.i20.not.i31.i = icmp eq ptr %List1.addr.0.val17.i30.i, null
  br i1 %cmp.i20.not.i31.i, label %red_DocumentUnitConflict.exit, label %for.cond.i28.i, !llvm.loop !10

red_DocumentUnitConflict.exit:                    ; preds = %for.cond.i28.i
  store ptr %call.i.i243, ptr %List1.addr.0.i29.i, align 8
...
if.then117:                                       ; preds = %if.end114
  ...
  tail call void @clause_Print(ptr noundef %Copy.0) #12
  br label %if.end121
...
land.lhs.true9:                                   ; preds = %land.lhs.true
  ...
  %call12 = tail call i32 @term_Equal(ptr noundef %call4.val240.val, ptr noundef %call4.val250.val.val) #12
...
for.body18:                                       ; preds = %for.body18.lr.ph, %for.inc
  ...
  br i1 %cmp.i.not.i262, label %if.then.i264, label %clause_LiteralAtom.exit267

if.then.i264:                                     ; preds = %for.body18
  %20 = getelementptr i8, ptr %call19.val, i64 16
  %call1.val.i265 = load ptr, ptr %20, align 8
  %21 = getelementptr i8, ptr %call1.val.i265, i64 8
  %call1.val.val.i266 = load ptr, ptr %21, align 8
  br label %clause_LiteralAtom.exit267

clause_LiteralAtom.exit267:                       ; preds = %for.body18, %if.then.i264
  %retval.0.i263 = phi ptr [ %call1.val.val.i266, %if.then.i264 ], [ %call19.val, %for.body18 ]
  %call21 = tail call i32 @term_Equal(ptr noundef %retval.0.i263, ptr noundef nonnull %retval.0.i) #12
...
land.lhs.true25:                                  ; preds = %lor.lhs.false
  %call20.val243 = load i32, ptr %retval.0.i263, align 8
...
land.lhs.true28:                                  ; preds = %land.lhs.true25
  ...
  %24 = getelementptr i8, ptr %retval.0.i263, i64 16
  ...
  %call31 = tail call i32 @term_Equal(ptr noundef %call4.val.val, ptr noundef %call20.val249.val.val) #12
...
land.lhs.true33:                                  ; preds = %land.lhs.true28
  ...
  %call36 = tail call i32 @term_Equal(ptr noundef %call20.val.val, ptr noundef %call4.val248.val.val) #12
...
for.body50:                                       ; preds = %for.body50.lr.ph, %for.cond47.loopexit
  ...
  br i1 %cmp.i.not.i279, label %if.then.i281, label %clause_LiteralAtom.exit284

if.then.i281:                                     ; preds = %for.body50
  %38 = getelementptr i8, ptr %call51.val, i64 16
  %call1.val.i282 = load ptr, ptr %38, align 8
  %39 = getelementptr i8, ptr %call1.val.i282, i64 8
  %call1.val.val.i283 = load ptr, ptr %39, align 8
  br label %clause_LiteralAtom.exit284

clause_LiteralAtom.exit284:                       ; preds = %for.body50, %if.then.i281
  %retval.0.i280 = phi ptr [ %call1.val.val.i283, %if.then.i281 ], [ %call51.val, %for.body50 ]
...
for.body57.lr.ph:                                 ; preds = %clause_LiteralAtom.exit284
  %40 = getelementptr i8, ptr %retval.0.i280, i64 16
...
for.body57:                                       ; preds = %for.body57.lr.ph, %for.inc82
  ...
  br i1 %cmp.i.not.i288, label %if.then.i290, label %clause_LiteralAtom.exit293

if.then.i290:                                     ; preds = %for.body57
  %46 = getelementptr i8, ptr %call58.val, i64 16
  %call1.val.i291 = load ptr, ptr %46, align 8
  %47 = getelementptr i8, ptr %call1.val.i291, i64 8
  %call1.val.val.i292 = load ptr, ptr %47, align 8
  br label %clause_LiteralAtom.exit293

clause_LiteralAtom.exit293:                       ; preds = %for.body57, %if.then.i290
  %retval.0.i289 = phi ptr [ %call1.val.val.i292, %if.then.i290 ], [ %call58.val, %for.body57 ]
  %call60 = tail call i32 @term_Equal(ptr noundef %retval.0.i289, ptr noundef %retval.0.i280) #12
  %tobool61.not = icmp eq i32 %call60, 0
  br i1 %tobool61.not, label %lor.lhs.false62, label %for.inc82.thread

lor.lhs.false62:                                  ; preds = %clause_LiteralAtom.exit293
  %call52.val242 = load i32, ptr %retval.0.i280, align 8
  %48 = load i32, ptr @fol_EQUALITY, align 4
...
land.lhs.true65:                                  ; preds = %lor.lhs.false62
  %call59.val241 = load i32, ptr %retval.0.i289, align 8
...
land.lhs.true68:                                  ; preds = %land.lhs.true65
  ...
  %50 = getelementptr i8, ptr %retval.0.i289, i64 16
  ...
  %call71 = tail call i32 @term_Equal(ptr noundef %call52.val.val, ptr noundef %call59.val247.val.val) #12
...
land.lhs.true73:                                  ; preds = %land.lhs.true68
  ...
  %call76 = tail call i32 @term_Equal(ptr noundef %call59.val.val, ptr noundef %call52.val246.val.val) #12
...
for.inc82.thread:                                 ; preds = %clause_LiteralAtom.exit293, %land.lhs.true73
  %call.i298 = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
if.then105:                                       ; preds = %clause_GetLiteralAtom.exit
  ...
  br i1 %cmp.i.not.i311, label %if.then.i322, label %clause_LiteralAtom.exit325

if.then.i322:                                     ; preds = %if.then105
  %68 = getelementptr i8, ptr %call108.val, i64 16
  %call1.val.i314 = load ptr, ptr %68, align 8
  %69 = getelementptr i8, ptr %call1.val.i314, i64 8
  %call1.val.val.i315 = load ptr, ptr %69, align 8
  br label %clause_LiteralAtom.exit325

clause_LiteralAtom.exit325:                       ; preds = %if.then105, %if.then.i322
  %retval.0.i321 = phi ptr [ %call1.val.val.i315, %if.then.i322 ], [ %call108.val, %if.then105 ]
  %call109.val349.pn.in = getelementptr i8, ptr %retval.0.i321, i64 16
  ...
  %call115 = tail call i32 @unify_UnifyCom(ptr noundef %65, ptr noundef %call109.val.val351, ptr noundef %call113.val.val.val) #12
...
if.then117:                                       ; preds = %clause_LiteralAtom.exit325
  ...
  %call.i326 = tail call ptr @memory_Malloc(i32 noundef 16) #12
...
if.end121:                                        ; preds = %if.then117, %clause_LiteralAtom.exit325
  ...
  %.pr.i = load i32, ptr @cont_BINDINGS, align 4
  %cmp2.i = icmp sgt i32 %.pr.i, 0
  br i1 %cmp2.i, label %while.body.i333.preheader, label %while.end.i

while.body.i333.preheader:                        ; preds = %if.end121
  %xtraiter = and i32 %.pr.i, 1
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %while.body.i333.prol.loopexit, label %while.body.i333.prol

while.body.i333.prol:                             ; preds = %while.body.i333.preheader
  ...
  %dec.i.i.i.prol = add nsw i32 %.pr.i, -1
  store i32 %dec.i.i.i.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i333.prol.loopexit

while.body.i333.prol.loopexit:                    ; preds = %while.body.i333.prol, %while.body.i333.preheader
  %.unr = phi i32 [ %.pr.i, %while.body.i333.preheader ], [ %dec.i.i.i.prol, %while.body.i333.prol ]
  %75 = icmp eq i32 %.pr.i, 1
  br i1 %75, label %while.end.i, label %while.body.i333

while.body.i333:                                  ; preds = %while.body.i333.prol.loopexit, %while.body.i333
  %76 = phi i32 [ %dec.i.i.i.1, %while.body.i333 ], [ %.unr, %while.body.i333.prol.loopexit ]
  ...
  store i32 %dec.i.i.i.1, ptr @cont_BINDINGS, align 4
  %cmp.i334.1 = icmp ugt i32 %dec.i.i.i, 1
  br i1 %cmp.i334.1, label %while.body.i333, label %while.end.i, !llvm.loop !36

while.end.i:                                      ; preds = %while.body.i333.prol.loopexit, %while.body.i333, %if.end121
  %83 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i328 = icmp eq i32 %83, 0
  br i1 %cmp.i.not.i328, label %if.end123, label %if.then.i329
...
if.end123:                                        ; preds = %while.body.i, %if.then.i329, %while.end.i, %clause_GetLiteralAtom.exit, %for.end87
  %Indexes.8 = phi ptr [ %Indexes.4.lcssa, %clause_GetLiteralAtom.exit ], [ %Indexes.4.lcssa, %for.end87 ], [ %Indexes.7, %while.end.i ], [ %Indexes.7, %if.then.i329 ], [ %Indexes.4.lcssa, %while.body.i ]
...
if.then134:                                       ; preds = %if.end132
  %call135 = tail call ptr @clause_Copy(ptr noundef %Clause) #12
  tail call void @clause_DeleteLiterals(ptr noundef %call135, ptr noundef nonnull %Indexes.8, ptr noundef nonnull %Flags, ptr noundef %Precedence) #12
...
list_Delete.exit.i:                               ; preds = %while.body.i.i, %if.then134
  ...
  br i1 %cmp.i.not5.i14.i, label %red_DocumentObviousReductions.exit, label %while.body.i15.i

while.body.i15.i:                                 ; preds = %list_Delete.exit.i, %while.body.i15.i
  %Current.06.i16.i = phi ptr [ %Current.0.val.i17.i, %while.body.i15.i ], [ %Clause.val12.i, %list_Delete.exit.i ]
  %Current.0.val.i17.i = load ptr, ptr %Current.06.i16.i, align 8
  %97 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i18.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %97, i64 0, i32 4
  %98 = load i32, ptr %total_size.i.i.i18.i, align 8
  %conv26.i.i.i19.i = sext i32 %98 to i64
  %99 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i20.i = add i64 %99, %conv26.i.i.i19.i
  store i64 %add27.i.i.i20.i, ptr @memory_FREEDBYTES, align 8
  %100 = load ptr, ptr %97, align 8
  store ptr %100, ptr %Current.06.i16.i, align 8
  %101 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i16.i, ptr %101, align 8
  %cmp.i.not.i21.i = icmp eq ptr %Current.0.val.i17.i, null
  br i1 %cmp.i.not.i21.i, label %red_DocumentObviousReductions.exit, label %while.body.i15.i, !llvm.loop !8

red_DocumentObviousReductions.exit:               ; preds = %while.body.i15.i, %list_Delete.exit.i
...
if.then138:                                       ; preds = %red_DocumentObviousReductions.exit
  tail call void @clause_Print(ptr noundef nonnull %call135) #12
  br label %if.end139
...
if.else140:                                       ; preds = %if.end132
  tail call void @clause_DeleteLiterals(ptr noundef %Clause, ptr noundef nonnull %Indexes.8, ptr noundef nonnull %Flags, ptr noundef %Precedence) #12
  br label %while.body.i342

while.body.i342:                                  ; preds = %if.else140, %while.body.i342
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i342 ], [ %Indexes.8, %if.else140 ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  ...
  br i1 %cmp.i.not.i343, label %list_Delete.exit, label %while.body.i342, !llvm.loop !8

list_Delete.exit:                                 ; preds = %while.body.i342
...
entry:
  %call = tail call ptr @cond_CondFast(ptr noundef %Clause) #12
...
if.then8:                                         ; preds = %if.end
  %call9 = tail call ptr @clause_Copy(ptr noundef %Clause) #12
  tail call void @clause_DeleteLiterals(ptr noundef %call9, ptr noundef nonnull %call, ptr noundef nonnull %Flags, ptr noundef %Precedence) #12
...
list_Delete.exit.i:                               ; preds = %while.body.i.i, %if.then8
  ...
  %cmp.i.not5.i14.i = icmp eq ptr %Clause.val12.i, null
  br i1 %cmp.i.not5.i14.i, label %red_DocumentCondensing.exit, label %while.body.i15.i

while.body.i15.i:                                 ; preds = %list_Delete.exit.i, %while.body.i15.i
  %Current.06.i16.i = phi ptr [ %Current.0.val.i17.i, %while.body.i15.i ], [ %Clause.val12.i, %list_Delete.exit.i ]
  %Current.0.val.i17.i = load ptr, ptr %Current.06.i16.i, align 8
  %12 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i18.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %12, i64 0, i32 4
  %13 = load i32, ptr %total_size.i.i.i18.i, align 8
  %conv26.i.i.i19.i = sext i32 %13 to i64
  %14 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i20.i = add i64 %14, %conv26.i.i.i19.i
  store i64 %add27.i.i.i20.i, ptr @memory_FREEDBYTES, align 8
  %15 = load ptr, ptr %12, align 8
  store ptr %15, ptr %Current.06.i16.i, align 8
  %16 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i16.i, ptr %16, align 8
  %cmp.i.not.i21.i = icmp eq ptr %Current.0.val.i17.i, null
  br i1 %cmp.i.not.i21.i, label %red_DocumentCondensing.exit, label %while.body.i15.i, !llvm.loop !8

red_DocumentCondensing.exit:                      ; preds = %while.body.i15.i, %list_Delete.exit.i
...
if.then12:                                        ; preds = %red_DocumentCondensing.exit
  tail call void @clause_Print(ptr noundef nonnull %call9) #12
  br label %if.end13
...
if.else:                                          ; preds = %if.end
  tail call void @clause_DeleteLiterals(ptr noundef %Clause, ptr noundef nonnull %call, ptr noundef nonnull %Flags, ptr noundef %Precedence) #12
  br label %while.body.i

while.body.i:                                     ; preds = %if.else, %while.body.i
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i ], [ %call, %if.else ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
...
if.then.i.i:                                      ; preds = %if.end3
  %mul.i.i = shl i32 %6, 3
  %call.i.i = tail call ptr @memory_Malloc(i32 noundef %mul.i.i) #12
...
if.end23.i.i.i:                                   ; preds = %if.then18.i.i.i, %if.end13.i.i.i
  ...
  tail call void @free(ptr noundef nonnull %add.ptr24.i.i.i) #12
...
entry:
  ...
  store ptr null, ptr %Result, align 8
  %call2 = tail call ptr @clause_Copy(ptr noundef %RuleClause) #12
  %2 = getelementptr i8, ptr %RedClause, i64 52
  %RedClause.val153 = load i32, ptr %2, align 4
  tail call void @clause_RenameVarsBiggerThan(ptr noundef %call2, i32 noundef %RedClause.val153) #12
...
list_Delete.exit:                                 ; preds = %while.body.i, %clause_GetLiteralAtom.exit
  ...
  br i1 %cmp.i.not5.i156, label %list_Delete.exit164, label %while.body.i157

while.body.i157:                                  ; preds = %list_Delete.exit, %while.body.i157
  %Current.06.i158 = phi ptr [ %Current.0.val.i159, %while.body.i157 ], [ %call2.val152, %list_Delete.exit ]
  %Current.0.val.i159 = load ptr, ptr %Current.06.i158, align 8
  %18 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i160 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %18, i64 0, i32 4
  %19 = load i32, ptr %total_size.i.i.i160, align 8
  %conv26.i.i.i161 = sext i32 %19 to i64
  %20 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i162 = add i64 %20, %conv26.i.i.i161
  store i64 %add27.i.i.i162, ptr @memory_FREEDBYTES, align 8
  %21 = load ptr, ptr %18, align 8
  store ptr %21, ptr %Current.06.i158, align 8
  %22 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i158, ptr %22, align 8
  %cmp.i.not.i163 = icmp eq ptr %Current.0.val.i159, null
  br i1 %cmp.i.not.i163, label %list_Delete.exit164, label %while.body.i157, !llvm.loop !8

list_Delete.exit164:                              ; preds = %while.body.i157, %list_Delete.exit
  ...
  store i32 0, ptr @cont_BINDINGS, align 4
  %25 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  %call11 = tail call i32 @unify_MatchBindings(ptr noundef %25, ptr noundef %call4.val.val, ptr noundef %TermSInstance) #12
  %26 = load ptr, ptr @cont_LEFTCONTEXT, align 8
...
if.then.i.i173:                                   ; preds = %list_Delete.exit164
  %30 = getelementptr i8, ptr %call.val.i169, i64 16
  %call1.val.i.i174 = load ptr, ptr %30, align 8
  %31 = getelementptr i8, ptr %call1.val.i.i174, i64 8
  %call1.val.val.i.i175 = load ptr, ptr %31, align 8
  br label %clause_GetLiteralAtom.exit176

clause_GetLiteralAtom.exit176:                    ; preds = %list_Delete.exit164, %if.then.i.i173
  %retval.0.i.i172 = phi ptr [ %call1.val.val.i.i175, %if.then.i.i173 ], [ %call.val.i169, %list_Delete.exit164 ]
  %call14 = tail call ptr @cont_ApplyBindingsModuloMatching(ptr noundef %26, ptr noundef %retval.0.i.i172, i32 noundef 1) #12
...
land.lhs.true:                                    ; preds = %clause_GetLiteralAtom.exit176
  ...
  br i1 %cmp.i.not.i.i178, label %if.then.i.i180, label %clause_LiteralIsEquality.exit

if.then.i.i180:                                   ; preds = %land.lhs.true
  %38 = getelementptr i8, ptr %call16.val, i64 16
  %call1.val.i.i181 = load ptr, ptr %38, align 8
  %39 = getelementptr i8, ptr %call1.val.i.i181, i64 8
  %call1.val.val.i.i182 = load ptr, ptr %39, align 8
  %call.val.pre.i = load i32, ptr %call1.val.val.i.i182, align 8
  br label %clause_LiteralIsEquality.exit

clause_LiteralIsEquality.exit:                    ; preds = %land.lhs.true, %if.then.i.i180
  %call.val.i179 = phi i32 [ %call.val.pre.i, %if.then.i.i180 ], [ %L.val7.val.i.i177, %land.lhs.true ]
  %40 = load i32, ptr @fol_EQUALITY, align 4
  %cmp.i.i.not = icmp eq i32 %40, %call.val.i179
...
land.lhs.true19:                                  ; preds = %clause_LiteralIsEquality.exit
  ...
  %call24 = tail call i32 @ord_LiteralCompare(ptr noundef nonnull %call16.val, i32 noundef %call21.val, ptr noundef %call.val.i190, i32 noundef 1, i32 noundef 0, ptr noundef %Search.val, ptr noundef %Search.val142) #12
...
if.then26:                                        ; preds = %land.lhs.true19
  %.pr.i = load i32, ptr @cont_BINDINGS, align 4
  %cmp2.i = icmp sgt i32 %.pr.i, 0
  br i1 %cmp2.i, label %while.body.i194.preheader, label %while.end.i

while.body.i194.preheader:                        ; preds = %if.then26
  %xtraiter = and i32 %.pr.i, 1
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %while.body.i194.prol.loopexit, label %while.body.i194.prol

while.body.i194.prol:                             ; preds = %while.body.i194.preheader
  ...
  %dec.i.i.i.prol = add nsw i32 %.pr.i, -1
  store i32 %dec.i.i.i.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i194.prol.loopexit

while.body.i194.prol.loopexit:                    ; preds = %while.body.i194.prol, %while.body.i194.preheader
  %.unr = phi i32 [ %.pr.i, %while.body.i194.preheader ], [ %dec.i.i.i.prol, %while.body.i194.prol ]
  %47 = icmp eq i32 %.pr.i, 1
  br i1 %47, label %while.end.i, label %while.body.i194

while.body.i194:                                  ; preds = %while.body.i194.prol.loopexit, %while.body.i194
  %48 = phi i32 [ %dec.i.i.i.1, %while.body.i194 ], [ %.unr, %while.body.i194.prol.loopexit ]
  ...
  br i1 %cmp.i.1, label %while.body.i194, label %while.end.i, !llvm.loop !36

while.end.i:                                      ; preds = %while.body.i194.prol.loopexit, %while.body.i194, %if.then26
  %55 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i191 = icmp eq i32 %55, 0
  br i1 %cmp.i.not.i191, label %cont_BackTrack.exit, label %if.then.i

if.then.i:                                        ; preds = %while.end.i
  %dec.i.i = add nsw i32 %55, -1
  store i32 %dec.i.i, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i192 = sext i32 %dec.i.i to i64
  %arrayidx.i.i193 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i192
  %56 = load i32, ptr %arrayidx.i.i193, align 4
  store i32 %56, ptr @cont_BINDINGS, align 4
  br label %cont_BackTrack.exit

cont_BackTrack.exit:                              ; preds = %while.end.i, %if.then.i
  tail call void @clause_Delete(ptr noundef %call2) #12
  br label %cleanup
...
if.end28:                                         ; preds = %land.lhs.true19, %clause_LiteralIsEquality.exit, %clause_GetLiteralAtom.exit176
  ...
  %add3.i.i = add i32 %add.i.i, -1
  %sub.i = add i32 %add3.i.i, %Clause.val7.i.i
  %cmp31.not344 = icmp slt i32 %sub.i, 0
  br i1 %cmp31.not344, label %for.end, label %for.body.preheader
...
if.then33:                                        ; preds = %for.body
  ...
  br i1 %cmp.i.not.i.i199, label %if.then.i.i201, label %clause_GetLiteralAtom.exit204

if.then.i.i201:                                   ; preds = %if.then33
  %66 = getelementptr i8, ptr %call.val.i197, i64 16
  %call1.val.i.i202 = load ptr, ptr %66, align 8
  %67 = getelementptr i8, ptr %call1.val.i.i202, i64 8
  %call1.val.val.i.i203 = load ptr, ptr %67, align 8
  br label %clause_GetLiteralAtom.exit204

clause_GetLiteralAtom.exit204:                    ; preds = %if.then33, %if.then.i.i201
  %retval.0.i.i200 = phi ptr [ %call1.val.val.i.i203, %if.then.i.i201 ], [ %call.val.i197, %if.then33 ]
  %call36 = tail call ptr @cont_ApplyBindingsModuloMatching(ptr noundef %62, ptr noundef %retval.0.i.i200, i32 noundef 0) #12
  br label %for.inc
...
for.end:                                          ; preds = %for.inc, %if.end28
  ...
  br i1 %cmp2.i206, label %while.body.i213.preheader, label %while.end.i207

while.body.i213.preheader:                        ; preds = %for.end
  %xtraiter428 = and i32 %.pr.i205, 1
  %lcmp.mod429.not = icmp eq i32 %xtraiter428, 0
  br i1 %lcmp.mod429.not, label %while.body.i213.prol.loopexit, label %while.body.i213.prol

while.body.i213.prol:                             ; preds = %while.body.i213.preheader
  %68 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %68, ptr @cont_CURRENTBINDING, align 8
  %69 = getelementptr i8, ptr %68, i64 24
  %call.val.i.i.i214.prol = load ptr, ptr %69, align 8
  store ptr %call.val.i.i.i214.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i215.prol = getelementptr inbounds %struct.binding, ptr %68, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i215.prol, i8 0, i64 20, i1 false)
  %70 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i216.prol = getelementptr inbounds %struct.binding, ptr %70, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i216.prol, align 8
  %dec.i.i.i217.prol = add nsw i32 %.pr.i205, -1
  store i32 %dec.i.i.i217.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i213.prol.loopexit

while.body.i213.prol.loopexit:                    ; preds = %while.body.i213.prol, %while.body.i213.preheader
  %.unr430 = phi i32 [ %.pr.i205, %while.body.i213.preheader ], [ %dec.i.i.i217.prol, %while.body.i213.prol ]
  %71 = icmp eq i32 %.pr.i205, 1
  br i1 %71, label %while.end.i207, label %while.body.i213

while.body.i213:                                  ; preds = %while.body.i213.prol.loopexit, %while.body.i213
  %72 = phi i32 [ %dec.i.i.i217.1, %while.body.i213 ], [ %.unr430, %while.body.i213.prol.loopexit ]
  %73 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %73, ptr @cont_CURRENTBINDING, align 8
  %74 = getelementptr i8, ptr %73, i64 24
  %call.val.i.i.i214 = load ptr, ptr %74, align 8
  store ptr %call.val.i.i.i214, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i215 = getelementptr inbounds %struct.binding, ptr %73, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i215, i8 0, i64 20, i1 false)
  %75 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i216 = getelementptr inbounds %struct.binding, ptr %75, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i216, align 8
  %dec.i.i.i217 = add nsw i32 %72, -1
  ...
  %call.val.i.i.i214.1 = load ptr, ptr %77, align 8
  store ptr %call.val.i.i.i214.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i215.1 = getelementptr inbounds %struct.binding, ptr %76, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i215.1, i8 0, i64 20, i1 false)
  %78 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i216.1 = getelementptr inbounds %struct.binding, ptr %78, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i216.1, align 8
  %dec.i.i.i217.1 = add nsw i32 %72, -2
  store i32 %dec.i.i.i217.1, ptr @cont_BINDINGS, align 4
  %cmp.i218.1 = icmp ugt i32 %dec.i.i.i217, 1
  br i1 %cmp.i218.1, label %while.body.i213, label %while.end.i207, !llvm.loop !36

while.end.i207:                                   ; preds = %while.body.i213.prol.loopexit, %while.body.i213, %for.end
  %79 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i208 = icmp eq i32 %79, 0
  br i1 %cmp.i.not.i208, label %cont_BackTrack.exit219, label %if.then.i209

if.then.i209:                                     ; preds = %while.end.i207
  %dec.i.i210 = add nsw i32 %79, -1
  store i32 %dec.i.i210, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i211 = sext i32 %dec.i.i210 to i64
  %arrayidx.i.i212 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i211
  %80 = load i32, ptr %arrayidx.i.i212, align 4
  store i32 %80, ptr @cont_BINDINGS, align 4
  br label %cont_BackTrack.exit219

cont_BackTrack.exit219:                           ; preds = %while.end.i207, %if.then.i209
  %call.i = tail call ptr @memory_Malloc(i32 noundef 384) #12
  ...
  tail call fastcc void @flag_TransferAllFlags(ptr noundef %Search.val, ptr noundef nonnull %call.i)
  tail call void @flag_ClearPrinting(ptr noundef %Search.val) #12
  tail call fastcc void @flag_SetFlagValue(ptr noundef %Search.val, i32 noundef 82)
  tail call fastcc void @flag_SetFlagValue(ptr noundef %Search.val, i32 noundef 81)
  %Clause.val6.i.i220 = load i32, ptr %57, align 8
  %Clause.val.i.i221 = load i32, ptr %58, align 4
  %Clause.val7.i.i222 = load i32, ptr %59, align 8
  %add.i.i223 = add i32 %Clause.val6.i.i220, -1
  %add3.i.i224 = add i32 %add.i.i223, %Clause.val.i.i221
  %sub.i225 = add i32 %add3.i.i224, %Clause.val7.i.i222
  %84 = load i32, ptr @clause_CLAUSECOUNTER, align 4
  %cmp45346 = icmp sgt i32 %sub.i225, -1
  br i1 %cmp45346, label %for.body46.lr.ph, label %for.end68

for.body46.lr.ph:                                 ; preds = %cont_BackTrack.exit219
  %85 = getelementptr i8, ptr %Search, i64 80
  %arrayidx.i228 = getelementptr inbounds i32, ptr %Search.val, i64 9
  %86 = zext i32 %j to i64
  %87 = zext i32 %sub.i225 to i64
  br label %for.body46

for.body46:                                       ; preds = %for.body46.lr.ph, %for.inc66
  %indvars.iv356 = phi i64 [ 0, %for.body46.lr.ph ], [ %indvars.iv.next357, %for.inc66 ]
  %cmp47.not = icmp eq i64 %indvars.iv356, %86
  br i1 %cmp47.not, label %for.inc66, label %if.then48

if.then48:                                        ; preds = %for.body46
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %aux.i) #12
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %NewClause.i) #12
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %RedundantList.i) #12
  %Search.val.i = load ptr, ptr %0, align 8
  %Search.val101.i = load ptr, ptr %1, align 8
  %arrayidx.i323 = getelementptr inbounds i32, ptr %Search.val.i, i64 9
  %88 = load i32, ptr %arrayidx.i323, align 4
  %RuleClause.val.i = load ptr, ptr %3, align 8
  %arrayidx.i322 = getelementptr inbounds ptr, ptr %RuleClause.val.i, i64 %indvars.iv356
  %89 = load ptr, ptr %arrayidx.i322, align 8
  %90 = getelementptr i8, ptr %89, i64 24
  %call3.val102.i = load ptr, ptr %90, align 8
  %L.val7.val.i = load i32, ptr %call3.val102.i, align 8
  %91 = load i32, ptr @fol_NOT, align 4
  %cmp.i.not.i318.not = icmp eq i32 %91, %L.val7.val.i
  br i1 %cmp.i.not.i318.not, label %if.then.i320, label %clause_LiteralAtom.exit

if.then.i320:                                     ; preds = %if.then48
  %92 = getelementptr i8, ptr %call3.val102.i, i64 16
  %call1.val.i = load ptr, ptr %92, align 8
  %93 = getelementptr i8, ptr %call1.val.i, i64 8
  %call1.val.val.i = load ptr, ptr %93, align 8
  br label %clause_LiteralAtom.exit

clause_LiteralAtom.exit:                          ; preds = %if.then48, %if.then.i320
  %retval.0.i319 = phi ptr [ %call1.val.val.i, %if.then.i320 ], [ %call3.val102.i, %if.then48 ]
  %RuleClause.val105.i = load i32, ptr %57, align 8
  %94 = sext i32 %RuleClause.val105.i to i64
  %cmp.not.i.not = icmp slt i64 %indvars.iv356, %94
  br i1 %cmp.not.i.not, label %if.then.i227, label %if.end22.i

if.then.i227:                                     ; preds = %clause_LiteralAtom.exit
  %call7.i = tail call ptr @term_Copy(ptr noundef %retval.0.i319) #12
  %call.i.i314 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i315 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i314, i64 0, i32 1
  store ptr %call7.i, ptr %car.i.i315, align 8
  store ptr null, ptr %call.i.i314, align 8
  %call11.i = tail call ptr @clause_Create(ptr noundef nonnull %call.i.i314, ptr noundef null, ptr noundef null, ptr noundef nonnull %Search.val.i, ptr noundef %Search.val101.i) #12
  %origin.i313 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call11.i, i64 0, i32 14
  store i32 27, ptr %origin.i313, align 4
  br label %while.body.i304

while.body.i304:                                  ; preds = %if.then.i227, %while.body.i304
  %Current.06.i305 = phi ptr [ %Current.0.val.i306, %while.body.i304 ], [ %call.i.i314, %if.then.i227 ]
  %Current.0.val.i306 = load ptr, ptr %Current.06.i305, align 8
  %95 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i307 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %95, i64 0, i32 4
  %96 = load i32, ptr %total_size.i.i.i307, align 8
  %conv26.i.i.i308 = sext i32 %96 to i64
  %97 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i309 = add i64 %97, %conv26.i.i.i308
  store i64 %add27.i.i.i309, ptr @memory_FREEDBYTES, align 8
  %98 = load ptr, ptr %95, align 8
  store ptr %98, ptr %Current.06.i305, align 8
  %99 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i305, ptr %99, align 8
  %cmp.i.not.i310 = icmp eq ptr %Current.0.val.i306, null
  br i1 %cmp.i.not.i310, label %list_Delete.exit312, label %while.body.i304, !llvm.loop !8

list_Delete.exit312:                              ; preds = %while.body.i304
  store ptr null, ptr %NewClause.i, align 8
  %.val103.i = load i32, ptr %call11.i, align 8
  %Search.val106.i = load ptr, ptr %85, align 8
  %call14.i = call fastcc i32 @red_SortSimplification(ptr noundef %Search.val106.i, ptr noundef nonnull %call11.i, i32 noundef -1, i32 noundef %88, ptr noundef %Search.val.i, ptr noundef %Search.val101.i, ptr noundef nonnull %NewClause.i), !range !5
  %tobool.not.i = icmp eq i32 %call14.i, 0
  br i1 %tobool.not.i, label %if.end21.i, label %if.then15.i

if.then15.i:                                      ; preds = %list_Delete.exit312
  %tobool16.not.i = icmp eq i32 %88, 0
  %.pre = load ptr, ptr %NewClause.i, align 8
  br i1 %tobool16.not.i, label %if.end.i, label %if.then17.i

if.then17.i:                                      ; preds = %if.then15.i
  %100 = getelementptr i8, ptr %.pre, i64 32
  %Reduced.val.i = load ptr, ptr %100, align 8
  store ptr null, ptr %100, align 8
  %conv9.i = sext i32 %.val103.i to i64
  %101 = inttoptr i64 %conv9.i to ptr
  %call10.i294 = tail call ptr @list_PointerDeleteElement(ptr noundef %Reduced.val.i, ptr noundef %101) #12
  %call23.i = tail call ptr @list_PointerDeleteDuplicates(ptr noundef %call10.i294) #12
  store ptr %call23.i, ptr %100, align 8
  %call24.i = tail call ptr @list_Copy(ptr noundef %call23.i) #12
...
for.body29.i:                                     ; preds = %if.then17.i, %for.body29.i
  ...
  br i1 %cmp.i62.not.i, label %for.end32.i, label %for.body29.i, !llvm.loop !106

for.end32.i:                                      ; preds = %for.body29.i, %if.then17.i
  %102 = getelementptr i8, ptr %.pre, i64 40
  %Reduced.val58.i = load ptr, ptr %102, align 8
  %cmp.i.not5.i.i295 = icmp eq ptr %Reduced.val58.i, null
  br i1 %cmp.i.not5.i.i295, label %if.end.i.thread, label %while.body.i.i296

while.body.i.i296:                                ; preds = %for.end32.i, %while.body.i.i296
  %Current.06.i.i297 = phi ptr [ %Current.0.val.i.i298, %while.body.i.i296 ], [ %Reduced.val58.i, %for.end32.i ]
  %Current.0.val.i.i298 = load ptr, ptr %Current.06.i.i297, align 8
  %103 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i299 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %103, i64 0, i32 4
  %104 = load i32, ptr %total_size.i.i.i.i299, align 8
  %conv26.i.i.i.i300 = sext i32 %104 to i64
  %105 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i301 = add i64 %105, %conv26.i.i.i.i300
  store i64 %add27.i.i.i.i301, ptr @memory_FREEDBYTES, align 8
  %106 = load ptr, ptr %103, align 8
  store ptr %106, ptr %Current.06.i.i297, align 8
  %107 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i297, ptr %107, align 8
  %cmp.i.not.i65.i = icmp eq ptr %Current.0.val.i.i298, null
  br i1 %cmp.i.not.i65.i, label %if.end.i.thread, label %while.body.i.i296, !llvm.loop !8

if.end.i.thread:                                  ; preds = %while.body.i.i296, %for.end32.i
  store ptr %call24.i, ptr %102, align 8
  br label %red_CRwLitTautologyCheck.exit.thread

if.end.i:                                         ; preds = %if.then15.i
  %cmp19.not.i = icmp eq ptr %.pre, null
  br i1 %cmp19.not.i, label %red_CRwLitTautologyCheck.exit.thread369, label %red_CRwLitTautologyCheck.exit.thread

red_CRwLitTautologyCheck.exit.thread369:          ; preds = %if.end.i
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %RedundantList.i) #12
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %NewClause.i) #12
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %aux.i) #12
  br label %if.else

red_CRwLitTautologyCheck.exit.thread:             ; preds = %if.end.i.thread, %if.end.i
  tail call void @clause_Delete(ptr noundef nonnull %call11.i) #12
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %RedundantList.i) #12
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %NewClause.i) #12
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %aux.i) #12
  br label %if.else

if.end21.i:                                       ; preds = %list_Delete.exit312
  tail call void @clause_Delete(ptr noundef nonnull %call11.i) #12
  br label %if.end22.i

if.end22.i:                                       ; preds = %if.end21.i, %clause_LiteralAtom.exit
  br i1 %cmp.i.not.i318.not, label %if.then24.i, label %if.else34.i

if.then24.i:                                      ; preds = %if.end22.i
  %RuleClause.val104.i = load i32, ptr %57, align 8
  %108 = sext i32 %RuleClause.val104.i to i64
  %cmp26.not.i.not = icmp slt i64 %indvars.iv356, %108
  br i1 %cmp26.not.i.not, label %if.then27.i, label %if.else29.i

if.then27.i:                                      ; preds = %if.then24.i
  %call28.i = tail call ptr @clause_CopyConstraint(ptr noundef %RedClause) #12
  br label %if.end31.i

if.else29.i:                                      ; preds = %if.then24.i
  %call30.i = tail call ptr @clause_CopyAntecedentExcept(ptr noundef %RedClause, i32 noundef %i) #12
  br label %if.end31.i

if.end31.i:                                       ; preds = %if.else29.i, %if.then27.i
  %NegLits.0.i = phi ptr [ %call28.i, %if.then27.i ], [ %call30.i, %if.else29.i ]
  %call32.i = tail call ptr @term_Copy(ptr noundef %retval.0.i319) #12
  %call.i.i289 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i290 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i289, i64 0, i32 1
  store ptr %call32.i, ptr %car.i.i290, align 8
  store ptr null, ptr %call.i.i289, align 8
  br label %if.end38.i

if.else34.i:                                      ; preds = %if.end22.i
  %call35.i = tail call ptr @term_Copy(ptr noundef %retval.0.i319) #12
  %call.i.i287 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i288 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i287, i64 0, i32 1
  store ptr %call35.i, ptr %car.i.i288, align 8
  store ptr null, ptr %call.i.i287, align 8
  %call37.i = tail call ptr @clause_CopySuccedentExcept(ptr noundef %RedClause, i32 noundef %i) #12
  br label %if.end38.i

if.end38.i:                                       ; preds = %if.else34.i, %if.end31.i
  %NegLits.1.i = phi ptr [ %NegLits.0.i, %if.end31.i ], [ %call.i.i287, %if.else34.i ]
  %PosLits.0.i = phi ptr [ %call.i.i289, %if.end31.i ], [ %call37.i, %if.else34.i ]
  %call40.i = tail call ptr @clause_Create(ptr noundef null, ptr noundef %NegLits.1.i, ptr noundef %PosLits.0.i, ptr noundef %Search.val.i, ptr noundef %Search.val101.i) #12
  store ptr %call40.i, ptr %aux.i, align 8
  %origin.i286 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call40.i, i64 0, i32 14
  store i32 27, ptr %origin.i286, align 4
  %cmp.i.not5.i276 = icmp eq ptr %NegLits.1.i, null
  br i1 %cmp.i.not5.i276, label %list_Delete.exit285, label %while.body.i277

while.body.i277:                                  ; preds = %if.end38.i, %while.body.i277
  %Current.06.i278 = phi ptr [ %Current.0.val.i279, %while.body.i277 ], [ %NegLits.1.i, %if.end38.i ]
  %Current.0.val.i279 = load ptr, ptr %Current.06.i278, align 8
  %109 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i280 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %109, i64 0, i32 4
  %110 = load i32, ptr %total_size.i.i.i280, align 8
  %conv26.i.i.i281 = sext i32 %110 to i64
  %111 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i282 = add i64 %111, %conv26.i.i.i281
  store i64 %add27.i.i.i282, ptr @memory_FREEDBYTES, align 8
  %112 = load ptr, ptr %109, align 8
  store ptr %112, ptr %Current.06.i278, align 8
  %113 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i278, ptr %113, align 8
  %cmp.i.not.i283 = icmp eq ptr %Current.0.val.i279, null
  br i1 %cmp.i.not.i283, label %list_Delete.exit285, label %while.body.i277, !llvm.loop !8

list_Delete.exit285:                              ; preds = %while.body.i277, %if.end38.i
  %cmp.i.not5.i266 = icmp eq ptr %PosLits.0.i, null
  br i1 %cmp.i.not5.i266, label %list_Delete.exit275, label %while.body.i267

while.body.i267:                                  ; preds = %list_Delete.exit285, %while.body.i267
  %Current.06.i268 = phi ptr [ %Current.0.val.i269, %while.body.i267 ], [ %PosLits.0.i, %list_Delete.exit285 ]
  ...
  %total_size.i.i.i270 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %114, i64 0, i32 4
  %115 = load i32, ptr %total_size.i.i.i270, align 8
  %conv26.i.i.i271 = sext i32 %115 to i64
  %116 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i272 = add i64 %116, %conv26.i.i.i271
  store i64 %add27.i.i.i272, ptr @memory_FREEDBYTES, align 8
  %117 = load ptr, ptr %114, align 8
  store ptr %117, ptr %Current.06.i268, align 8
  %118 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i268, ptr %118, align 8
  %cmp.i.not.i273 = icmp eq ptr %Current.0.val.i269, null
  br i1 %cmp.i.not.i273, label %list_Delete.exit275, label %while.body.i267, !llvm.loop !8

list_Delete.exit275:                              ; preds = %while.body.i267, %list_Delete.exit285
  %119 = load ptr, ptr %aux.i, align 8
  %120 = getelementptr i8, ptr %119, i64 64
  %Clause.val.i = load i32, ptr %120, align 8
  %121 = getelementptr i8, ptr %119, i64 68
  %Clause.val107.i = load i32, ptr %121, align 4
...
for.body.lr.ph.i:                                 ; preds = %list_Delete.exit275
  %122 = getelementptr i8, ptr %119, i64 56
  %123 = getelementptr i8, ptr %119, i64 72
  %124 = sext i32 %Clause.val.i to i64
  br label %for.body.i.outer

for.body.i.outer:                                 ; preds = %for.inc61.i.thread, %for.body.lr.ph.i
  %indvars.iv177.i.ph = phi i64 [ %indvars.iv.next178.i326, %for.inc61.i.thread ], [ %124, %for.body.lr.ph.i ]
...
for.body.i:                                       ; preds = %for.body.i.outer, %for.inc61.i
  %indvars.iv177.i = phi i64 [ %indvars.iv.next178.i, %for.inc61.i ], [ %indvars.iv177.i.ph, %for.body.i.outer ]
  %Clause.val109.i = load ptr, ptr %122, align 8
  %arrayidx.i.i250 = getelementptr inbounds ptr, ptr %Clause.val109.i, i64 %indvars.iv177.i
  %125 = load ptr, ptr %arrayidx.i.i250, align 8
  %126 = getelementptr i8, ptr %125, i64 24
  %Literal.val.i.i = load ptr, ptr %126, align 8
  %L.val7.val.i.i.i = load i32, ptr %Literal.val.i.i, align 8
  %127 = load i32, ptr @fol_NOT, align 4
  %cmp.i.not.i.i.i = icmp eq i32 %127, %L.val7.val.i.i.i
  br i1 %cmp.i.not.i.i.i, label %if.then.i.i.i, label %clause_LiteralAtom.exit.i.i

if.then.i.i.i:                                    ; preds = %for.body.i
  %128 = getelementptr i8, ptr %Literal.val.i.i, i64 16
  %call1.val.i.i.i = load ptr, ptr %128, align 8
  %129 = getelementptr i8, ptr %call1.val.i.i.i, i64 8
  %call1.val.val.i.i.i = load ptr, ptr %129, align 8
...
clause_LiteralAtom.exit.i.i:                      ; preds = %if.then.i.i.i, %for.body.i
  %call.val22.i.i = phi i32 [ %call.val22.pre.i.i, %if.then.i.i.i ], [ %L.val7.val.i.i.i, %for.body.i ]
  %retval.0.i.i.i = phi ptr [ %call1.val.val.i.i.i, %if.then.i.i.i ], [ %Literal.val.i.i, %for.body.i ]
  %130 = load i32, ptr @fol_EQUALITY, align 4
  %cmp.i.not.i.i251 = icmp eq i32 %130, %call.val22.i.i
  br i1 %cmp.i.not.i.i251, label %land.lhs.true.i.i, label %for.inc61.i

land.lhs.true.i.i:                                ; preds = %clause_LiteralAtom.exit.i.i
  %131 = getelementptr i8, ptr %125, i64 8
  %Literal.val23.i.i = load i32, ptr %131, align 8
  %tobool3.not.i.i = icmp eq i32 %Literal.val23.i.i, 0
  br i1 %tobool3.not.i.i, label %land.lhs.true4.i.i, label %for.inc61.i

land.lhs.true4.i.i:                               ; preds = %land.lhs.true.i.i
  %132 = getelementptr i8, ptr %retval.0.i.i.i, i64 16
  %call.val21.i.i = load ptr, ptr %132, align 8
  %133 = getelementptr i8, ptr %call.val21.i.i, i64 8
  %call.val21.val.i.i = load ptr, ptr %133, align 8
  ...
  %134 = getelementptr i8, ptr %call.val24.val.pre.i.i, i64 8
  %call.val25.val.val.i.i = load ptr, ptr %134, align 8
...
land.lhs.true11.i.i:                              ; preds = %lor.lhs.false.i.i, %land.lhs.true4.i.i
  %call14.i.i = tail call i32 @term_VariableEqual(ptr noundef nonnull %call.val21.val.i.i, ptr noundef %call.val25.val.val.i.i) #12
  %tobool15.not.i.i = icmp eq i32 %call14.i.i, 0
  br i1 %tobool15.not.i.i, label %if.then.i252, label %for.inc61.i

if.then.i252:                                     ; preds = %land.lhs.true11.i.i
  %call3.val111.i = load ptr, ptr %126, align 8
  %L.val7.val.i.i253 = load i32, ptr %call3.val111.i, align 8
  %135 = load i32, ptr @fol_NOT, align 4
  %cmp.i.not.i117.i = icmp eq i32 %135, %L.val7.val.i.i253
  %136 = getelementptr i8, ptr %call3.val111.i, i64 16
  %call1.val.i.i254 = load ptr, ptr %136, align 8
  %137 = getelementptr i8, ptr %call1.val.i.i254, i64 8
  %call1.val.val.i.i255 = load ptr, ptr %137, align 8
  br i1 %cmp.i.not.i117.i, label %clause_LiteralAtom.exit.i, label %clause_LiteralAtom.exit.thread.i

clause_LiteralAtom.exit.i:                        ; preds = %if.then.i252
  %138 = getelementptr i8, ptr %call1.val.val.i.i255, i64 16
  %call5.val.i = load ptr, ptr %138, align 8
  %139 = getelementptr i8, ptr %call5.val.i, i64 8
  %call5.val.val.i = load ptr, ptr %139, align 8
...
clause_LiteralAtom.exit.thread.i:                 ; preds = %if.then.i252
  %call6.val116157.i = load i32, ptr %call1.val.val.i.i255, align 8
...
clause_LiteralAtom.exit125.i:                     ; preds = %clause_LiteralAtom.exit.thread.i, %clause_LiteralAtom.exit.i
  %call11.val.i = phi ptr [ %call1.val.i.i254, %clause_LiteralAtom.exit.thread.i ], [ %call5.val.i, %clause_LiteralAtom.exit.i ]
  ...
  %140 = getelementptr i8, ptr %call11.val.val.i, i64 8
  %call11.val.val.val.i = load ptr, ptr %140, align 8
  br label %if.end.i256

clause_LiteralAtom.exit132.i:                     ; preds = %clause_LiteralAtom.exit.thread.i, %clause_LiteralAtom.exit.i
  %call13.val.i = phi ptr [ %call1.val.i.i254, %clause_LiteralAtom.exit.thread.i ], [ %call5.val.i, %clause_LiteralAtom.exit.i ]
  %call5.val.val161166.i = phi ptr [ %call1.val.val.i.i255, %clause_LiteralAtom.exit.thread.i ], [ %call5.val.val.i, %clause_LiteralAtom.exit.i ]
  %call13.val.val.i = load ptr, ptr %call13.val.i, align 8
  %141 = getelementptr i8, ptr %call13.val.val.i, i64 8
  %call13.val.val.val.i = load ptr, ptr %141, align 8
  %call14.val.i = load i32, ptr %call13.val.val.val.i, align 8
  br label %if.end.i256

if.end.i256:                                      ; preds = %clause_LiteralAtom.exit132.i, %clause_LiteralAtom.exit125.i
  ...
  %142 = load i32, ptr @cont_BINDINGS, align 4
  %143 = load i32, ptr @cont_STACKPOINTER, align 4
  %inc.i.i.i = add nsw i32 %143, 1
  store i32 %inc.i.i.i, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i.i = sext i32 %143 to i64
  %arrayidx.i.i.i = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i.i
  store i32 %142, ptr %arrayidx.i.i.i, align 4
  store i32 0, ptr @cont_BINDINGS, align 4
  %144 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  %145 = load ptr, ptr @cont_INSTANCECONTEXT, align 8
  %idxprom.i.i.i.i = sext i32 %Var.0.i to i64
  %arrayidx.i.i.i.i = getelementptr inbounds %struct.binding, ptr %144, i64 %idxprom.i.i.i.i
  store ptr %arrayidx.i.i.i.i, ptr @cont_CURRENTBINDING, align 8
  %term.i.i.i.i = getelementptr inbounds %struct.binding, ptr %144, i64 %idxprom.i.i.i.i, i32 2
  store ptr %Term.0.i, ptr %term.i.i.i.i, align 8
  %146 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %context.i.i.i.i = getelementptr inbounds %struct.binding, ptr %146, i64 0, i32 3
  store ptr %145, ptr %context.i.i.i.i, align 8
  %147 = load ptr, ptr @cont_LASTBINDING, align 8
  %link.i.i.i.i257 = getelementptr inbounds %struct.binding, ptr %146, i64 0, i32 4
  store ptr %147, ptr %link.i.i.i.i257, align 8
  store ptr %146, ptr @cont_LASTBINDING, align 8
  %148 = load i32, ptr @cont_BINDINGS, align 4
  %inc.i.i258 = add nsw i32 %148, 1
  store i32 %inc.i.i258, ptr @cont_BINDINGS, align 4
  %Clause.val6.i.i.i = load i32, ptr %120, align 8
  %Clause.val.i.i.i = load i32, ptr %121, align 4
  %Clause.val7.i.i.i = load i32, ptr %123, align 8
  ...
  br i1 %cmp22167.i, label %for.body24.preheader.i, label %for.end.i259

for.body24.preheader.i:                           ; preds = %if.end.i256
  %149 = and i64 %indvars.iv177.i, 4294967295
  %150 = zext i32 %sub.i134.i to i64
  br label %for.body24.i

for.body24.i:                                     ; preds = %for.inc.i, %for.body24.preheader.i
  %indvars.iv.i = phi i64 [ 0, %for.body24.preheader.i ], [ %indvars.iv.next.i, %for.inc.i ]
  %cmp25.not.i = icmp eq i64 %indvars.iv.i, %149
  br i1 %cmp25.not.i, label %for.inc.i, label %if.then26.i

if.then26.i:                                      ; preds = %for.body24.i
  %Clause.val108.i = load ptr, ptr %122, align 8
  %arrayidx.i136.i = getelementptr inbounds ptr, ptr %Clause.val108.i, i64 %indvars.iv.i
  %151 = load ptr, ptr %arrayidx.i136.i, align 8
  %152 = getelementptr i8, ptr %151, i64 24
  %call27.val.i = load ptr, ptr %152, align 8
  %L.val7.val.i137.i = load i32, ptr %call27.val.i, align 8
  %153 = load i32, ptr @fol_NOT, align 4
  %cmp.i.not.i138.i = icmp eq i32 %153, %L.val7.val.i137.i
  br i1 %cmp.i.not.i138.i, label %if.then.i140.i, label %clause_LiteralAtom.exit143.i

if.then.i140.i:                                   ; preds = %if.then26.i
  %154 = getelementptr i8, ptr %call27.val.i, i64 16
  %call1.val.i141.i = load ptr, ptr %154, align 8
  %155 = getelementptr i8, ptr %call1.val.i141.i, i64 8
  %call1.val.val.i142.i = load ptr, ptr %155, align 8
  %call28.val112.pre.i = load i32, ptr %call1.val.val.i142.i, align 8
  br label %clause_LiteralAtom.exit143.i

clause_LiteralAtom.exit143.i:                     ; preds = %if.then.i140.i, %if.then26.i
  %call28.val112.i = phi i32 [ %call28.val112.pre.i, %if.then.i140.i ], [ %L.val7.val.i137.i, %if.then26.i ]
  %retval.0.i139.i = phi ptr [ %call1.val.val.i142.i, %if.then.i140.i ], [ %call27.val.i, %if.then26.i ]
  %156 = load i32, ptr @fol_EQUALITY, align 4
  %cmp.i.not.i261 = icmp eq i32 %156, %call28.val112.i
  %157 = load ptr, ptr @cont_INSTANCECONTEXT, align 8
  %158 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  br i1 %cmp.i.not.i261, label %if.then31.i, label %if.else46.i

if.then31.i:                                      ; preds = %clause_LiteralAtom.exit143.i
  %159 = getelementptr i8, ptr %retval.0.i139.i, i64 16
  %call28.val.i = load ptr, ptr %159, align 8
  %160 = getelementptr i8, ptr %call28.val.i, i64 8
  %call28.val.val.i = load ptr, ptr %160, align 8
  %call35.i263 = tail call i32 @ord_ContGreater(ptr noundef %157, ptr noundef %TermSInstance, ptr noundef %158, ptr noundef %call28.val.val.i, ptr noundef %Search.val.i, ptr noundef %Search.val101.i) #12
  %tobool36.not.i = icmp eq i32 %call35.i263, 0
  br i1 %tobool36.not.i, label %for.end.loopexit.i, label %land.lhs.true.i264

land.lhs.true.i264:                               ; preds = %if.then31.i
  %161 = getelementptr i8, ptr %151, i64 8
  %call27.val113.i = load i32, ptr %161, align 8
  %tobool38.not.i = icmp eq i32 %call27.val113.i, 0
  br i1 %tobool38.not.i, label %lor.lhs.false.i265, label %for.inc.i

lor.lhs.false.i265:                               ; preds = %land.lhs.true.i264
  %162 = load ptr, ptr @cont_INSTANCECONTEXT, align 8
  %163 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  %call28.val114.i = load ptr, ptr %159, align 8
  %call28.val114.val.i = load ptr, ptr %call28.val114.i, align 8
  %164 = getelementptr i8, ptr %call28.val114.val.i, i64 8
  %call28.val114.val.val.i = load ptr, ptr %164, align 8
  %call42.i = tail call i32 @ord_ContGreater(ptr noundef %162, ptr noundef %TermSInstance, ptr noundef %163, ptr noundef %call28.val114.val.val.i, ptr noundef %Search.val.i, ptr noundef %Search.val101.i) #12
  %tobool43.not.i = icmp eq i32 %call42.i, 0
  br i1 %tobool43.not.i, label %for.end.loopexit.i, label %for.inc.i

if.else46.i:                                      ; preds = %clause_LiteralAtom.exit143.i
  %call49.i = tail call i32 @ord_ContGreater(ptr noundef %157, ptr noundef %TermSInstance, ptr noundef %158, ptr noundef nonnull %retval.0.i139.i, ptr noundef %Search.val.i, ptr noundef %Search.val101.i) #12
  %tobool50.not.i262 = icmp ne i32 %call49.i, 0
  br label %for.inc.i

for.inc.i:                                        ; preds = %if.else46.i, %lor.lhs.false.i265, %land.lhs.true.i264, %for.body24.i
  %success.1.i = phi i1 [ true, %for.body24.i ], [ %tobool50.not.i262, %if.else46.i ], [ true, %lor.lhs.false.i265 ], [ true, %land.lhs.true.i264 ]
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %cmp22.i = icmp ult i64 %indvars.iv.i, %150
  %165 = and i1 %cmp22.i, %success.1.i
  br i1 %165, label %for.body24.i, label %for.end.loopexit.i, !llvm.loop !107

for.end.loopexit.i:                               ; preds = %for.inc.i, %lor.lhs.false.i265, %if.then31.i
  %success.1187.i = phi i1 [ %success.1.i, %for.inc.i ], [ false, %lor.lhs.false.i265 ], [ false, %if.then31.i ]
  %.pr.i.pre.i = load i32, ptr @cont_BINDINGS, align 4
  br label %for.end.i259

for.end.i259:                                     ; preds = %for.end.loopexit.i, %if.end.i256
  %.pr.i.i = phi i32 [ %inc.i.i258, %if.end.i256 ], [ %.pr.i.pre.i, %for.end.loopexit.i ]
  %tobool23.lcssa.i = phi i1 [ true, %if.end.i256 ], [ %success.1187.i, %for.end.loopexit.i ]
  %cmp2.i.i = icmp sgt i32 %.pr.i.i, 0
  br i1 %cmp2.i.i, label %while.body.i.i.preheader, label %while.end.i.i

while.body.i.i.preheader:                         ; preds = %for.end.i259
  %xtraiter431 = and i32 %.pr.i.i, 1
  %lcmp.mod432.not = icmp eq i32 %xtraiter431, 0
  br i1 %lcmp.mod432.not, label %while.body.i.i.prol.loopexit, label %while.body.i.i.prol
...
while.body.i.i.prol:                              ; preds = %while.body.i.i.preheader
  ...
  %call.val.i.i.i.i.prol = load ptr, ptr %167, align 8
  store ptr %call.val.i.i.i.i.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i.i.prol = getelementptr inbounds %struct.binding, ptr %166, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i.i.prol, i8 0, i64 20, i1 false)
  %168 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i.i.prol = getelementptr inbounds %struct.binding, ptr %168, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i.i.prol, align 8
  %dec.i.i.i.i.prol = add nsw i32 %.pr.i.i, -1
  store i32 %dec.i.i.i.i.prol, ptr @cont_BINDINGS, align 4
...
while.body.i.i.prol.loopexit:                     ; preds = %while.body.i.i.prol, %while.body.i.i.preheader
  %.unr433 = phi i32 [ %.pr.i.i, %while.body.i.i.preheader ], [ %dec.i.i.i.i.prol, %while.body.i.i.prol ]
  %169 = icmp eq i32 %.pr.i.i, 1
  br i1 %169, label %while.end.i.i, label %while.body.i.i

while.body.i.i:                                   ; preds = %while.body.i.i.prol.loopexit, %while.body.i.i
  %170 = phi i32 [ %dec.i.i.i.i.1, %while.body.i.i ], [ %.unr433, %while.body.i.i.prol.loopexit ]
  %171 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %171, ptr @cont_CURRENTBINDING, align 8
  %172 = getelementptr i8, ptr %171, i64 24
  %call.val.i.i.i.i = load ptr, ptr %172, align 8
  store ptr %call.val.i.i.i.i, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i.i = getelementptr inbounds %struct.binding, ptr %171, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i.i, i8 0, i64 20, i1 false)
  %173 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i.i = getelementptr inbounds %struct.binding, ptr %173, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i.i, align 8
  %dec.i.i.i.i = add nsw i32 %170, -1
  store i32 %dec.i.i.i.i, ptr @cont_BINDINGS, align 4
  %174 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %174, ptr @cont_CURRENTBINDING, align 8
  %175 = getelementptr i8, ptr %174, i64 24
  %call.val.i.i.i.i.1 = load ptr, ptr %175, align 8
  store ptr %call.val.i.i.i.i.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i.i.1 = getelementptr inbounds %struct.binding, ptr %174, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i.i.1, i8 0, i64 20, i1 false)
  %176 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i.i.1 = getelementptr inbounds %struct.binding, ptr %176, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i.i.1, align 8
  %dec.i.i.i.i.1 = add nsw i32 %170, -2
  store i32 %dec.i.i.i.i.1, ptr @cont_BINDINGS, align 4
  %cmp.i148.i.1 = icmp ugt i32 %dec.i.i.i.i, 1
  br i1 %cmp.i148.i.1, label %while.body.i.i, label %while.end.i.i, !llvm.loop !36

while.end.i.i:                                    ; preds = %while.body.i.i.prol.loopexit, %while.body.i.i, %for.end.i259
  %177 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i144.i = icmp eq i32 %177, 0
  br i1 %cmp.i.not.i144.i, label %cont_BackTrack.exit.i, label %if.then.i145.i

if.then.i145.i:                                   ; preds = %while.end.i.i
  %dec.i.i.i260 = add nsw i32 %177, -1
  store i32 %dec.i.i.i260, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i146.i = sext i32 %dec.i.i.i260 to i64
  %arrayidx.i.i147.i = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i146.i
  %178 = load i32, ptr %arrayidx.i.i147.i, align 4
  store i32 %178, ptr @cont_BINDINGS, align 4
  br label %cont_BackTrack.exit.i

cont_BackTrack.exit.i:                            ; preds = %if.then.i145.i, %while.end.i.i
...
for.inc61.i:                                      ; preds = %cont_BackTrack.exit.i, %land.lhs.true11.i.i, %lor.lhs.false.i.i, %land.lhs.true.i.i, %clause_LiteralAtom.exit.i.i
  ...
  br i1 %exitcond.not.i, label %for.end63.i, label %for.body.i, !llvm.loop !108

for.inc61.i.thread:                               ; preds = %cont_BackTrack.exit.i
  tail call void @clause_ReplaceVariable(ptr noundef %119, i32 noundef %Var.0.i, ptr noundef %Term.0.i) #12
  %179 = inttoptr i64 %indvars.iv177.i to ptr
  %call.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i, i64 0, i32 1
  store ptr %179, ptr %car.i.i, align 8
  store ptr %litsToRemove.0173.i.ph, ptr %call.i.i, align 8
  %indvars.iv.next178.i326 = add nsw i64 %indvars.iv177.i, 1
  %lftr.wideiv.i327 = trunc i64 %indvars.iv.next178.i326 to i32
  %exitcond.not.i328 = icmp eq i32 %add.i.i.i, %lftr.wideiv.i327
  br i1 %exitcond.not.i328, label %if.then65.i.thread, label %for.body.i.outer, !llvm.loop !108

if.then65.i.thread:                               ; preds = %for.inc61.i.thread
  tail call void @clause_DeleteLiterals(ptr noundef %119, ptr noundef nonnull %call.i.i, ptr noundef %Search.val.i, ptr noundef %Search.val101.i) #12
  br label %while.body.i149.i.preheader
...
if.then65.i:                                      ; preds = %for.end63.i
  tail call void @clause_DeleteLiterals(ptr noundef %119, ptr noundef %litsToRemove.0173.i.ph, ptr noundef %Search.val.i, ptr noundef %Search.val101.i) #12
  %cmp.i.not5.i.i = icmp eq ptr %litsToRemove.0173.i.ph, null
  br i1 %cmp.i.not5.i.i, label %list_Delete.exit.i, label %while.body.i149.i.preheader

while.body.i149.i.preheader:                      ; preds = %if.then65.i.thread, %if.then65.i
  %Current.06.i.i.ph = phi ptr [ %litsToRemove.0173.i.ph, %if.then65.i ], [ %call.i.i, %if.then65.i.thread ]
  br label %while.body.i149.i

while.body.i149.i:                                ; preds = %while.body.i149.i.preheader, %while.body.i149.i
  %Current.06.i.i = phi ptr [ %Current.0.val.i.i, %while.body.i149.i ], [ %Current.06.i.i.ph, %while.body.i149.i.preheader ]
  %Current.0.val.i.i = load ptr, ptr %Current.06.i.i, align 8
  %180 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %180, i64 0, i32 4
  %181 = load i32, ptr %total_size.i.i.i.i, align 8
  %conv26.i.i.i.i = sext i32 %181 to i64
  %182 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i = add i64 %182, %conv26.i.i.i.i
  store i64 %add27.i.i.i.i, ptr @memory_FREEDBYTES, align 8
  %183 = load ptr, ptr %180, align 8
  store ptr %183, ptr %Current.06.i.i, align 8
  %184 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i, ptr %184, align 8
  %cmp.i.not.i150.i = icmp eq ptr %Current.0.val.i.i, null
  br i1 %cmp.i.not.i150.i, label %list_Delete.exit.i.loopexit, label %while.body.i149.i, !llvm.loop !8

list_Delete.exit.i.loopexit:                      ; preds = %while.body.i149.i
  %.pre359.pre = load ptr, ptr %aux.i, align 8
  br label %list_Delete.exit.i

list_Delete.exit.i:                               ; preds = %list_Delete.exit.i.loopexit, %if.then65.i
  %.pre359 = phi ptr [ %.pre359.pre, %list_Delete.exit.i.loopexit ], [ %119, %if.then65.i ]
  tail call void @clause_OrientEqualities(ptr noundef %119, ptr noundef %Search.val.i, ptr noundef %Search.val101.i) #12
  br label %red_PropagateDefinitions.exit

red_PropagateDefinitions.exit:                    ; preds = %list_Delete.exit275, %for.end63.i, %list_Delete.exit.i
  %185 = phi ptr [ %119, %list_Delete.exit275 ], [ %119, %for.end63.i ], [ %.pre359, %list_Delete.exit.i ]
  store ptr null, ptr %NewClause.i, align 8
  store ptr null, ptr %RedundantList.i, align 8
  %.val.i = load i32, ptr %185, align 8
  ...
  %186 = load ptr, ptr %aux.i, align 8
  %origin.i249 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %186, i64 0, i32 14
  store i32 27, ptr %origin.i249, align 4
  %tobool48.not.i = icmp eq i32 %call47.i, 0
  br i1 %tobool48.not.i, label %land.lhs.true.i247, label %if.then53.i

land.lhs.true.i247:                               ; preds = %red_PropagateDefinitions.exit
  %187 = getelementptr i8, ptr %186, i64 68
  %C.val.i = load i32, ptr %187, align 4
  %cmp.i.not.i248 = icmp eq i32 %C.val.i, 0
  br i1 %cmp.i.not.i248, label %land.lhs.true1.i, label %land.lhs.true.i

land.lhs.true1.i:                                 ; preds = %land.lhs.true.i247
  %188 = getelementptr i8, ptr %186, i64 72
  %C.val9.i = load i32, ptr %188, align 8
  %cmp.i11.not.i = icmp eq i32 %C.val9.i, 0
  br i1 %cmp.i11.not.i, label %clause_IsEmptyClause.exit, label %land.lhs.true.i

clause_IsEmptyClause.exit:                        ; preds = %land.lhs.true1.i
  %189 = getelementptr i8, ptr %186, i64 64
  %C.val10.i = load i32, ptr %189, align 8
  %cmp.i13.i.not = icmp eq i32 %C.val10.i, 0
  br i1 %cmp.i13.i.not, label %for.inc66.thread, label %land.lhs.true.i

land.lhs.true.i:                                  ; preds = %land.lhs.true.i247, %land.lhs.true1.i, %clause_IsEmptyClause.exit
  %call51.i = tail call i32 @cc_Tautology(ptr noundef nonnull %186) #12
...
if.then53.i:                                      ; preds = %land.lhs.true.i, %red_PropagateDefinitions.exit
  %190 = load ptr, ptr %NewClause.i, align 8
  %cmp54.not.i = icmp eq ptr %190, null
  br i1 %cmp54.not.i, label %if.end56.i, label %if.then55.i

if.then55.i:                                      ; preds = %if.then53.i
  tail call fastcc void @clause_UpdateSplitDataFromPartner(ptr noundef nonnull %186, ptr noundef nonnull %190)
  br label %if.end56.i

if.end56.i:                                       ; preds = %if.then55.i, %if.then53.i
  %tobool57.not.i = icmp eq i32 %88, 0
  %.pre361 = load ptr, ptr %RedundantList.i, align 8
  br i1 %tobool57.not.i, label %red_CRwLitTautologyCheck.exit.thread372, label %if.then58.i

if.then58.i:                                      ; preds = %if.end56.i
  %191 = getelementptr i8, ptr %186, i64 32
  %Reduced.val.i382 = load ptr, ptr %191, align 8
  store ptr null, ptr %191, align 8
  %cmp.i.not66.i = icmp eq ptr %.pre361, null
  br i1 %cmp.i.not66.i, label %for.end.i387, label %for.body.i383

for.body.i383:                                    ; preds = %if.then58.i, %list_Append.exit.i
  %Parents.068.i = phi ptr [ %retval.0.i.i385, %list_Append.exit.i ], [ %Reduced.val.i382, %if.then58.i ]
  %Scan.067.i = phi ptr [ %Scan.0.val57.i, %list_Append.exit.i ], [ %.pre361, %if.then58.i ]
  %192 = getelementptr i8, ptr %Scan.067.i, i64 8
  %Scan.0.val.i = load ptr, ptr %192, align 8
  %193 = getelementptr i8, ptr %Scan.0.val.i, i64 32
  %call3.val.i = load ptr, ptr %193, align 8
  %cmp.i.not.i.i384 = icmp eq ptr %call3.val.i, null
  br i1 %cmp.i.not.i.i384, label %list_Append.exit.i, label %if.end.i.i

if.end.i.i:                                       ; preds = %for.body.i383
  %cmp.i20.not.i.i = icmp eq ptr %Parents.068.i, null
  %call4.i.i = tail call ptr @list_Copy(ptr noundef nonnull %call3.val.i) #12
...
for.cond.i.i:                                     ; preds = %if.end.i.i, %for.cond.i.i
  ...
  br i1 %cmp.i22.not.i.i, label %for.end.i.i, label %for.cond.i.i, !llvm.loop !109

for.end.i.i:                                      ; preds = %for.cond.i.i
  store ptr %Parents.068.i, ptr %List1.addr.0.i.i, align 8
  br label %list_Append.exit.i

list_Append.exit.i:                               ; preds = %for.end.i.i, %if.end.i.i, %for.body.i383
  %retval.0.i.i385 = phi ptr [ %call4.i.i, %for.end.i.i ], [ %Parents.068.i, %for.body.i383 ], [ %call4.i.i, %if.end.i.i ]
  %Scan.0.val57.i = load ptr, ptr %Scan.067.i, align 8
  %cmp.i.not.i386 = icmp eq ptr %Scan.0.val57.i, null
  br i1 %cmp.i.not.i386, label %for.end.i387, label %for.body.i383, !llvm.loop !110

for.end.i387:                                     ; preds = %list_Append.exit.i, %if.then58.i
  %Parents.0.lcssa.i = phi ptr [ %Reduced.val.i382, %if.then58.i ], [ %retval.0.i.i385, %list_Append.exit.i ]
  br i1 %cmp54.not.i, label %if.end.i391, label %if.then.i388

if.then.i388:                                     ; preds = %for.end.i387
  %Subsumer.val.i = load i32, ptr %190, align 8
  %conv.i = sext i32 %Subsumer.val.i to i64
  %194 = inttoptr i64 %conv.i to ptr
  %call.i.i389 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i390 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i389, i64 0, i32 1
  store ptr %194, ptr %car.i.i390, align 8
  store ptr %Parents.0.lcssa.i, ptr %call.i.i389, align 8
  br label %if.end.i391

if.end.i391:                                      ; preds = %if.then.i388, %for.end.i387
  %Parents.1.i = phi ptr [ %call.i.i389, %if.then.i388 ], [ %Parents.0.lcssa.i, %for.end.i387 ]
  %conv9.i392 = sext i32 %.val.i to i64
  %195 = inttoptr i64 %conv9.i392 to ptr
  %call10.i = tail call ptr @list_PointerDeleteElement(ptr noundef %Parents.1.i, ptr noundef %195) #12
  br i1 %cmp.i.not66.i, label %for.end22.i, label %for.body15.i

for.body15.i:                                     ; preds = %if.end.i391, %for.body15.i
  %Parents.271.i = phi ptr [ %call19.i, %for.body15.i ], [ %call10.i, %if.end.i391 ]
  %Scan.170.i = phi ptr [ %Scan.1.val56.i, %for.body15.i ], [ %.pre361, %if.end.i391 ]
  %196 = getelementptr i8, ptr %Scan.170.i, i64 8
  %Scan.1.val.i = load ptr, ptr %196, align 8
  %call16.val.i = load i32, ptr %Scan.1.val.i, align 8
  %conv18.i = sext i32 %call16.val.i to i64
  %197 = inttoptr i64 %conv18.i to ptr
  %call19.i = tail call ptr @list_PointerDeleteElement(ptr noundef %Parents.271.i, ptr noundef %197) #12
  %Scan.1.val56.i = load ptr, ptr %Scan.170.i, align 8
  %cmp.i59.not.i = icmp eq ptr %Scan.1.val56.i, null
  br i1 %cmp.i59.not.i, label %for.end22.i, label %for.body15.i, !llvm.loop !111

for.end22.i:                                      ; preds = %for.body15.i, %if.end.i391
  %Parents.2.lcssa.i = phi ptr [ %call10.i, %if.end.i391 ], [ %call19.i, %for.body15.i ]
  %call23.i393 = tail call ptr @list_PointerDeleteDuplicates(ptr noundef %Parents.2.lcssa.i) #12
  store ptr %call23.i393, ptr %191, align 8
  %call24.i394 = tail call ptr @list_Copy(ptr noundef %call23.i393) #12
  %cmp.i62.not73.i395 = icmp eq ptr %call24.i394, null
  br i1 %cmp.i62.not73.i395, label %for.end32.i401, label %for.body29.i396

for.body29.i396:                                  ; preds = %for.end22.i, %for.body29.i396
  %Scan.274.i397 = phi ptr [ %Scan.2.val.i399, %for.body29.i396 ], [ %call24.i394, %for.end22.i ]
  %car.i64.i398 = getelementptr inbounds %struct.LIST_HELP, ptr %Scan.274.i397, i64 0, i32 1
  store ptr null, ptr %car.i64.i398, align 8
  %Scan.2.val.i399 = load ptr, ptr %Scan.274.i397, align 8
  %cmp.i62.not.i400 = icmp eq ptr %Scan.2.val.i399, null
  br i1 %cmp.i62.not.i400, label %for.end32.i401, label %for.body29.i396, !llvm.loop !106

for.end32.i401:                                   ; preds = %for.body29.i396, %for.end22.i
  %198 = getelementptr i8, ptr %186, i64 40
  %Reduced.val58.i402 = load ptr, ptr %198, align 8
  %cmp.i.not5.i.i403 = icmp eq ptr %Reduced.val58.i402, null
  br i1 %cmp.i.not5.i.i403, label %red_CRwCalculateAdditionalParents.exit, label %while.body.i.i404

while.body.i.i404:                                ; preds = %for.end32.i401, %while.body.i.i404
  %Current.06.i.i405 = phi ptr [ %Current.0.val.i.i406, %while.body.i.i404 ], [ %Reduced.val58.i402, %for.end32.i401 ]
  %Current.0.val.i.i406 = load ptr, ptr %Current.06.i.i405, align 8
  %199 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i407 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %199, i64 0, i32 4
  %200 = load i32, ptr %total_size.i.i.i.i407, align 8
  %conv26.i.i.i.i408 = sext i32 %200 to i64
  %201 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i409 = add i64 %201, %conv26.i.i.i.i408
  store i64 %add27.i.i.i.i409, ptr @memory_FREEDBYTES, align 8
  %202 = load ptr, ptr %199, align 8
  store ptr %202, ptr %Current.06.i.i405, align 8
  %203 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i405, ptr %203, align 8
  %cmp.i.not.i65.i410 = icmp eq ptr %Current.0.val.i.i406, null
  br i1 %cmp.i.not.i65.i410, label %red_CRwCalculateAdditionalParents.exit, label %while.body.i.i404, !llvm.loop !8

red_CRwCalculateAdditionalParents.exit:           ; preds = %while.body.i.i404, %for.end32.i401
  store ptr %call24.i394, ptr %198, align 8
  br label %red_CRwLitTautologyCheck.exit.thread372

red_CRwLitTautologyCheck.exit.thread372:          ; preds = %red_CRwCalculateAdditionalParents.exit, %if.end56.i
  tail call void @clause_DeleteClauseList(ptr noundef %.pre361) #12
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %RedundantList.i) #12
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %NewClause.i) #12
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %aux.i) #12
  br label %if.else
...
for.inc66.thread:                                 ; preds = %land.lhs.true.i, %clause_IsEmptyClause.exit
  tail call void @clause_Delete(ptr noundef nonnull %186) #12
  %.pre360 = load ptr, ptr %RedundantList.i, align 8
  tail call void @clause_DeleteClauseList(ptr noundef %.pre360) #12
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %RedundantList.i) #12
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %NewClause.i) #12
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %aux.i) #12
  br label %for.end68

if.else:                                          ; preds = %red_CRwLitTautologyCheck.exit.thread372, %red_CRwLitTautologyCheck.exit.thread369, %red_CRwLitTautologyCheck.exit.thread
  %retval.0.i340 = phi ptr [ %.pre, %red_CRwLitTautologyCheck.exit.thread ], [ %call11.i, %red_CRwLitTautologyCheck.exit.thread369 ], [ %186, %red_CRwLitTautologyCheck.exit.thread372 ]
  tail call fastcc void @clause_UpdateSplitDataFromPartner(ptr noundef %call2, ptr noundef nonnull %retval.0.i340)
  %204 = load i32, ptr %arrayidx.i228, align 4
  %tobool53.not = icmp eq i32 %204, 0
  br i1 %tobool53.not, label %if.end63, label %if.then54

if.then54:                                        ; preds = %if.else
  %205 = getelementptr i8, ptr %retval.0.i340, i64 32
  %call49.val = load ptr, ptr %205, align 8
  %call2.val148 = load ptr, ptr %11, align 8
  %cmp.i.not.i229 = icmp eq ptr %call49.val, null
  br i1 %cmp.i.not.i229, label %list_Nconc.exit, label %if.end.i230

if.end.i230:                                      ; preds = %if.then54
  %cmp.i18.not.i = icmp eq ptr %call2.val148, null
  br i1 %cmp.i18.not.i, label %list_Nconc.exit, label %for.cond.i

for.cond.i:                                       ; preds = %if.end.i230, %for.cond.i
  %List1.addr.0.i = phi ptr [ %List1.addr.0.val17.i, %for.cond.i ], [ %call49.val, %if.end.i230 ]
  %List1.addr.0.val17.i = load ptr, ptr %List1.addr.0.i, align 8
  %cmp.i20.not.i = icmp eq ptr %List1.addr.0.val17.i, null
  br i1 %cmp.i20.not.i, label %for.end.i, label %for.cond.i, !llvm.loop !10
...
list_Nconc.exit:                                  ; preds = %if.then54, %if.end.i230, %for.end.i
  %retval.0.i231 = phi ptr [ %call49.val, %for.end.i ], [ %call2.val148, %if.then54 ], [ %call49.val, %if.end.i230 ]
  store ptr %retval.0.i231, ptr %11, align 8
  %206 = getelementptr i8, ptr %retval.0.i340, i64 40
  %call49.val151 = load ptr, ptr %206, align 8
  %call2.val150 = load ptr, ptr %17, align 8
  %cmp.i.not.i233 = icmp eq ptr %call49.val151, null
  br i1 %cmp.i.not.i233, label %list_Nconc.exit242, label %if.end.i234

if.end.i234:                                      ; preds = %list_Nconc.exit
  %cmp.i18.not.i235 = icmp eq ptr %call2.val150, null
  br i1 %cmp.i18.not.i235, label %list_Nconc.exit242, label %for.cond.i236

for.cond.i236:                                    ; preds = %if.end.i234, %for.cond.i236
  %List1.addr.0.i237 = phi ptr [ %List1.addr.0.val17.i238, %for.cond.i236 ], [ %call49.val151, %if.end.i234 ]
  %List1.addr.0.val17.i238 = load ptr, ptr %List1.addr.0.i237, align 8
  %cmp.i20.not.i239 = icmp eq ptr %List1.addr.0.val17.i238, null
  br i1 %cmp.i20.not.i239, label %for.end.i240, label %for.cond.i236, !llvm.loop !10

for.end.i240:                                     ; preds = %for.cond.i236
  store ptr %call2.val150, ptr %List1.addr.0.i237, align 8
  br label %list_Nconc.exit242

list_Nconc.exit242:                               ; preds = %list_Nconc.exit, %if.end.i234, %for.end.i240
  %retval.0.i241 = phi ptr [ %call49.val151, %for.end.i240 ], [ %call2.val150, %list_Nconc.exit ], [ %call49.val151, %if.end.i234 ]
  store ptr %retval.0.i241, ptr %17, align 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %205, i8 0, i64 16, i1 false)
  br label %if.end63

if.end63:                                         ; preds = %list_Nconc.exit242, %if.else
  tail call void @clause_Delete(ptr noundef nonnull %retval.0.i340) #12
  br label %for.inc66

for.inc66:                                        ; preds = %for.body46, %if.end63
  %indvars.iv.next357 = add nuw nsw i64 %indvars.iv356, 1
  %exitcond.not418 = icmp eq i64 %indvars.iv356, %87
  br i1 %exitcond.not418, label %for.end68, label %for.body46, !llvm.loop !112

for.end68:                                        ; preds = %for.inc66, %for.inc66.thread, %cont_BackTrack.exit219
  %tobool44.lcssa = phi i1 [ true, %cont_BackTrack.exit219 ], [ false, %for.inc66.thread ], [ true, %for.inc66 ]
  store i32 %84, ptr @clause_CLAUSECOUNTER, align 4
  tail call fastcc void @flag_TransferAllFlags(ptr noundef nonnull %call.i, ptr noundef %Search.val)
  %207 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 384), align 8
  %total_size.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %207, i64 0, i32 4
  %208 = load i32, ptr %total_size.i.i, align 8
  %conv26.i.i = sext i32 %208 to i64
  %209 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i = add i64 %209, %conv26.i.i
  store i64 %add27.i.i, ptr @memory_FREEDBYTES, align 8
  %210 = load ptr, ptr %207, align 8
  store ptr %210, ptr %call.i, align 8
  %211 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 384), align 8
  store ptr %call.i, ptr %211, align 8
...
if.else71:                                        ; preds = %for.end68
  tail call void @clause_Delete(ptr noundef %call2) #12
  br label %cleanup

cleanup:                                          ; preds = %if.then70, %if.else71, %cont_BackTrack.exit
  %retval.0 = phi i32 [ 0, %cont_BackTrack.exit ], [ 0, %if.else71 ], [ 1, %if.then70 ]
  ret i32 %retval.0
}
...
define internal fastcc void @flag_TransferAllFlags(ptr nocapture noundef readonly %Source, ptr nocapture noundef writeonly %Destination) unnamed_addr #7 {
entry:
  %0 = load i32, ptr %Source, align 4
  store i32 %0, ptr %Destination, align 4
  %arrayidx.1 = getelementptr inbounds i32, ptr %Source, i64 1
  %1 = load i32, ptr %arrayidx.1, align 4
  %arrayidx2.1 = getelementptr inbounds i32, ptr %Destination, i64 1
  store i32 %1, ptr %arrayidx2.1, align 4
  %arrayidx.2 = getelementptr inbounds i32, ptr %Source, i64 2
  %2 = load i32, ptr %arrayidx.2, align 4
  %arrayidx2.2 = getelementptr inbounds i32, ptr %Destination, i64 2
  store i32 %2, ptr %arrayidx2.2, align 4
  %arrayidx.3 = getelementptr inbounds i32, ptr %Source, i64 3
  %3 = load i32, ptr %arrayidx.3, align 4
  %arrayidx2.3 = getelementptr inbounds i32, ptr %Destination, i64 3
  store i32 %3, ptr %arrayidx2.3, align 4
  %arrayidx.4 = getelementptr inbounds i32, ptr %Source, i64 4
  %4 = load i32, ptr %arrayidx.4, align 4
  %arrayidx2.4 = getelementptr inbounds i32, ptr %Destination, i64 4
  store i32 %4, ptr %arrayidx2.4, align 4
  %arrayidx.5 = getelementptr inbounds i32, ptr %Source, i64 5
  %5 = load i32, ptr %arrayidx.5, align 4
  %arrayidx2.5 = getelementptr inbounds i32, ptr %Destination, i64 5
  store i32 %5, ptr %arrayidx2.5, align 4
  %arrayidx.6 = getelementptr inbounds i32, ptr %Source, i64 6
  %6 = load i32, ptr %arrayidx.6, align 4
  %arrayidx2.6 = getelementptr inbounds i32, ptr %Destination, i64 6
  store i32 %6, ptr %arrayidx2.6, align 4
  %arrayidx.7 = getelementptr inbounds i32, ptr %Source, i64 7
  %7 = load i32, ptr %arrayidx.7, align 4
  %arrayidx2.7 = getelementptr inbounds i32, ptr %Destination, i64 7
  store i32 %7, ptr %arrayidx2.7, align 4
  %arrayidx.8 = getelementptr inbounds i32, ptr %Source, i64 8
  %8 = load i32, ptr %arrayidx.8, align 4
  %arrayidx2.8 = getelementptr inbounds i32, ptr %Destination, i64 8
  store i32 %8, ptr %arrayidx2.8, align 4
  %arrayidx.9 = getelementptr inbounds i32, ptr %Source, i64 9
  %9 = load i32, ptr %arrayidx.9, align 4
  %arrayidx2.9 = getelementptr inbounds i32, ptr %Destination, i64 9
  store i32 %9, ptr %arrayidx2.9, align 4
  %arrayidx.10 = getelementptr inbounds i32, ptr %Source, i64 10
  %10 = load i32, ptr %arrayidx.10, align 4
  %arrayidx2.10 = getelementptr inbounds i32, ptr %Destination, i64 10
  store i32 %10, ptr %arrayidx2.10, align 4
  %arrayidx.11 = getelementptr inbounds i32, ptr %Source, i64 11
  %11 = load i32, ptr %arrayidx.11, align 4
  %arrayidx2.11 = getelementptr inbounds i32, ptr %Destination, i64 11
  store i32 %11, ptr %arrayidx2.11, align 4
  %arrayidx.12 = getelementptr inbounds i32, ptr %Source, i64 12
  %12 = load i32, ptr %arrayidx.12, align 4
  %arrayidx2.12 = getelementptr inbounds i32, ptr %Destination, i64 12
  store i32 %12, ptr %arrayidx2.12, align 4
  %arrayidx.13 = getelementptr inbounds i32, ptr %Source, i64 13
  %13 = load i32, ptr %arrayidx.13, align 4
  %arrayidx2.13 = getelementptr inbounds i32, ptr %Destination, i64 13
  store i32 %13, ptr %arrayidx2.13, align 4
  %arrayidx.14 = getelementptr inbounds i32, ptr %Source, i64 14
  %14 = load i32, ptr %arrayidx.14, align 4
  %arrayidx2.14 = getelementptr inbounds i32, ptr %Destination, i64 14
  store i32 %14, ptr %arrayidx2.14, align 4
  %arrayidx.15 = getelementptr inbounds i32, ptr %Source, i64 15
  %15 = load i32, ptr %arrayidx.15, align 4
  %arrayidx2.15 = getelementptr inbounds i32, ptr %Destination, i64 15
  store i32 %15, ptr %arrayidx2.15, align 4
  %arrayidx.16 = getelementptr inbounds i32, ptr %Source, i64 16
  %16 = load i32, ptr %arrayidx.16, align 4
  %arrayidx2.16 = getelementptr inbounds i32, ptr %Destination, i64 16
  store i32 %16, ptr %arrayidx2.16, align 4
  %arrayidx.17 = getelementptr inbounds i32, ptr %Source, i64 17
  %17 = load i32, ptr %arrayidx.17, align 4
  %arrayidx2.17 = getelementptr inbounds i32, ptr %Destination, i64 17
  store i32 %17, ptr %arrayidx2.17, align 4
  %arrayidx.18 = getelementptr inbounds i32, ptr %Source, i64 18
  %18 = load i32, ptr %arrayidx.18, align 4
  %arrayidx2.18 = getelementptr inbounds i32, ptr %Destination, i64 18
  store i32 %18, ptr %arrayidx2.18, align 4
  %arrayidx.19 = getelementptr inbounds i32, ptr %Source, i64 19
  %19 = load i32, ptr %arrayidx.19, align 4
  %arrayidx2.19 = getelementptr inbounds i32, ptr %Destination, i64 19
  store i32 %19, ptr %arrayidx2.19, align 4
  %arrayidx.20 = getelementptr inbounds i32, ptr %Source, i64 20
  %20 = load i32, ptr %arrayidx.20, align 4
  %arrayidx2.20 = getelementptr inbounds i32, ptr %Destination, i64 20
  store i32 %20, ptr %arrayidx2.20, align 4
  %arrayidx.21 = getelementptr inbounds i32, ptr %Source, i64 21
  %21 = load i32, ptr %arrayidx.21, align 4
  %arrayidx2.21 = getelementptr inbounds i32, ptr %Destination, i64 21
  store i32 %21, ptr %arrayidx2.21, align 4
  %arrayidx.22 = getelementptr inbounds i32, ptr %Source, i64 22
  %22 = load i32, ptr %arrayidx.22, align 4
  %arrayidx2.22 = getelementptr inbounds i32, ptr %Destination, i64 22
  store i32 %22, ptr %arrayidx2.22, align 4
  %arrayidx.23 = getelementptr inbounds i32, ptr %Source, i64 23
  %23 = load i32, ptr %arrayidx.23, align 4
  %arrayidx2.23 = getelementptr inbounds i32, ptr %Destination, i64 23
  store i32 %23, ptr %arrayidx2.23, align 4
  %arrayidx.24 = getelementptr inbounds i32, ptr %Source, i64 24
  %24 = load i32, ptr %arrayidx.24, align 4
  %arrayidx2.24 = getelementptr inbounds i32, ptr %Destination, i64 24
  store i32 %24, ptr %arrayidx2.24, align 4
  %arrayidx.25 = getelementptr inbounds i32, ptr %Source, i64 25
  %25 = load i32, ptr %arrayidx.25, align 4
  %arrayidx2.25 = getelementptr inbounds i32, ptr %Destination, i64 25
  store i32 %25, ptr %arrayidx2.25, align 4
  %arrayidx.26 = getelementptr inbounds i32, ptr %Source, i64 26
  %26 = load i32, ptr %arrayidx.26, align 4
  %arrayidx2.26 = getelementptr inbounds i32, ptr %Destination, i64 26
  store i32 %26, ptr %arrayidx2.26, align 4
  %arrayidx.27 = getelementptr inbounds i32, ptr %Source, i64 27
  %27 = load i32, ptr %arrayidx.27, align 4
  %arrayidx2.27 = getelementptr inbounds i32, ptr %Destination, i64 27
  store i32 %27, ptr %arrayidx2.27, align 4
  %arrayidx.28 = getelementptr inbounds i32, ptr %Source, i64 28
  %28 = load i32, ptr %arrayidx.28, align 4
  %arrayidx2.28 = getelementptr inbounds i32, ptr %Destination, i64 28
  store i32 %28, ptr %arrayidx2.28, align 4
  %arrayidx.29 = getelementptr inbounds i32, ptr %Source, i64 29
  %29 = load i32, ptr %arrayidx.29, align 4
  %arrayidx2.29 = getelementptr inbounds i32, ptr %Destination, i64 29
  store i32 %29, ptr %arrayidx2.29, align 4
  %arrayidx.30 = getelementptr inbounds i32, ptr %Source, i64 30
  %30 = load i32, ptr %arrayidx.30, align 4
  %arrayidx2.30 = getelementptr inbounds i32, ptr %Destination, i64 30
  store i32 %30, ptr %arrayidx2.30, align 4
  %arrayidx.31 = getelementptr inbounds i32, ptr %Source, i64 31
  %31 = load i32, ptr %arrayidx.31, align 4
  %arrayidx2.31 = getelementptr inbounds i32, ptr %Destination, i64 31
  store i32 %31, ptr %arrayidx2.31, align 4
  %arrayidx.32 = getelementptr inbounds i32, ptr %Source, i64 32
  %32 = load i32, ptr %arrayidx.32, align 4
  %arrayidx2.32 = getelementptr inbounds i32, ptr %Destination, i64 32
  store i32 %32, ptr %arrayidx2.32, align 4
  %arrayidx.33 = getelementptr inbounds i32, ptr %Source, i64 33
  %33 = load i32, ptr %arrayidx.33, align 4
  %arrayidx2.33 = getelementptr inbounds i32, ptr %Destination, i64 33
  store i32 %33, ptr %arrayidx2.33, align 4
  %arrayidx.34 = getelementptr inbounds i32, ptr %Source, i64 34
  %34 = load i32, ptr %arrayidx.34, align 4
  %arrayidx2.34 = getelementptr inbounds i32, ptr %Destination, i64 34
  store i32 %34, ptr %arrayidx2.34, align 4
  %arrayidx.35 = getelementptr inbounds i32, ptr %Source, i64 35
  %35 = load i32, ptr %arrayidx.35, align 4
  %arrayidx2.35 = getelementptr inbounds i32, ptr %Destination, i64 35
  store i32 %35, ptr %arrayidx2.35, align 4
  %arrayidx.36 = getelementptr inbounds i32, ptr %Source, i64 36
  %36 = load i32, ptr %arrayidx.36, align 4
  %arrayidx2.36 = getelementptr inbounds i32, ptr %Destination, i64 36
  store i32 %36, ptr %arrayidx2.36, align 4
  %arrayidx.37 = getelementptr inbounds i32, ptr %Source, i64 37
  %37 = load i32, ptr %arrayidx.37, align 4
  %arrayidx2.37 = getelementptr inbounds i32, ptr %Destination, i64 37
  store i32 %37, ptr %arrayidx2.37, align 4
  %arrayidx.38 = getelementptr inbounds i32, ptr %Source, i64 38
  %38 = load i32, ptr %arrayidx.38, align 4
  %arrayidx2.38 = getelementptr inbounds i32, ptr %Destination, i64 38
  store i32 %38, ptr %arrayidx2.38, align 4
  %arrayidx.39 = getelementptr inbounds i32, ptr %Source, i64 39
  %39 = load i32, ptr %arrayidx.39, align 4
  %arrayidx2.39 = getelementptr inbounds i32, ptr %Destination, i64 39
  store i32 %39, ptr %arrayidx2.39, align 4
  %arrayidx.40 = getelementptr inbounds i32, ptr %Source, i64 40
  %40 = load i32, ptr %arrayidx.40, align 4
  %arrayidx2.40 = getelementptr inbounds i32, ptr %Destination, i64 40
  store i32 %40, ptr %arrayidx2.40, align 4
  %arrayidx.41 = getelementptr inbounds i32, ptr %Source, i64 41
  %41 = load i32, ptr %arrayidx.41, align 4
  %arrayidx2.41 = getelementptr inbounds i32, ptr %Destination, i64 41
  store i32 %41, ptr %arrayidx2.41, align 4
  %arrayidx.42 = getelementptr inbounds i32, ptr %Source, i64 42
  %42 = load i32, ptr %arrayidx.42, align 4
  %arrayidx2.42 = getelementptr inbounds i32, ptr %Destination, i64 42
  store i32 %42, ptr %arrayidx2.42, align 4
  %arrayidx.43 = getelementptr inbounds i32, ptr %Source, i64 43
  %43 = load i32, ptr %arrayidx.43, align 4
  %arrayidx2.43 = getelementptr inbounds i32, ptr %Destination, i64 43
  store i32 %43, ptr %arrayidx2.43, align 4
  %arrayidx.44 = getelementptr inbounds i32, ptr %Source, i64 44
  %44 = load i32, ptr %arrayidx.44, align 4
  %arrayidx2.44 = getelementptr inbounds i32, ptr %Destination, i64 44
  store i32 %44, ptr %arrayidx2.44, align 4
  %arrayidx.45 = getelementptr inbounds i32, ptr %Source, i64 45
  %45 = load i32, ptr %arrayidx.45, align 4
  %arrayidx2.45 = getelementptr inbounds i32, ptr %Destination, i64 45
  store i32 %45, ptr %arrayidx2.45, align 4
  %arrayidx.46 = getelementptr inbounds i32, ptr %Source, i64 46
  %46 = load i32, ptr %arrayidx.46, align 4
  %arrayidx2.46 = getelementptr inbounds i32, ptr %Destination, i64 46
  store i32 %46, ptr %arrayidx2.46, align 4
  %arrayidx.47 = getelementptr inbounds i32, ptr %Source, i64 47
  %47 = load i32, ptr %arrayidx.47, align 4
  %arrayidx2.47 = getelementptr inbounds i32, ptr %Destination, i64 47
  store i32 %47, ptr %arrayidx2.47, align 4
  %arrayidx.48 = getelementptr inbounds i32, ptr %Source, i64 48
  %48 = load i32, ptr %arrayidx.48, align 4
  %arrayidx2.48 = getelementptr inbounds i32, ptr %Destination, i64 48
  store i32 %48, ptr %arrayidx2.48, align 4
  %arrayidx.49 = getelementptr inbounds i32, ptr %Source, i64 49
  %49 = load i32, ptr %arrayidx.49, align 4
  %arrayidx2.49 = getelementptr inbounds i32, ptr %Destination, i64 49
  store i32 %49, ptr %arrayidx2.49, align 4
  %arrayidx.50 = getelementptr inbounds i32, ptr %Source, i64 50
  %50 = load i32, ptr %arrayidx.50, align 4
  %arrayidx2.50 = getelementptr inbounds i32, ptr %Destination, i64 50
  store i32 %50, ptr %arrayidx2.50, align 4
  %arrayidx.51 = getelementptr inbounds i32, ptr %Source, i64 51
  %51 = load i32, ptr %arrayidx.51, align 4
  %arrayidx2.51 = getelementptr inbounds i32, ptr %Destination, i64 51
  store i32 %51, ptr %arrayidx2.51, align 4
  %arrayidx.52 = getelementptr inbounds i32, ptr %Source, i64 52
  %52 = load i32, ptr %arrayidx.52, align 4
  %arrayidx2.52 = getelementptr inbounds i32, ptr %Destination, i64 52
  store i32 %52, ptr %arrayidx2.52, align 4
  %arrayidx.53 = getelementptr inbounds i32, ptr %Source, i64 53
  %53 = load i32, ptr %arrayidx.53, align 4
  %arrayidx2.53 = getelementptr inbounds i32, ptr %Destination, i64 53
  store i32 %53, ptr %arrayidx2.53, align 4
  %arrayidx.54 = getelementptr inbounds i32, ptr %Source, i64 54
  %54 = load i32, ptr %arrayidx.54, align 4
  %arrayidx2.54 = getelementptr inbounds i32, ptr %Destination, i64 54
  store i32 %54, ptr %arrayidx2.54, align 4
  %arrayidx.55 = getelementptr inbounds i32, ptr %Source, i64 55
  %55 = load i32, ptr %arrayidx.55, align 4
  %arrayidx2.55 = getelementptr inbounds i32, ptr %Destination, i64 55
  store i32 %55, ptr %arrayidx2.55, align 4
  %arrayidx.56 = getelementptr inbounds i32, ptr %Source, i64 56
  %56 = load i32, ptr %arrayidx.56, align 4
  %arrayidx2.56 = getelementptr inbounds i32, ptr %Destination, i64 56
  store i32 %56, ptr %arrayidx2.56, align 4
  %arrayidx.57 = getelementptr inbounds i32, ptr %Source, i64 57
  %57 = load i32, ptr %arrayidx.57, align 4
  %arrayidx2.57 = getelementptr inbounds i32, ptr %Destination, i64 57
  store i32 %57, ptr %arrayidx2.57, align 4
  %arrayidx.58 = getelementptr inbounds i32, ptr %Source, i64 58
  %58 = load i32, ptr %arrayidx.58, align 4
  %arrayidx2.58 = getelementptr inbounds i32, ptr %Destination, i64 58
  store i32 %58, ptr %arrayidx2.58, align 4
  %arrayidx.59 = getelementptr inbounds i32, ptr %Source, i64 59
  %59 = load i32, ptr %arrayidx.59, align 4
  %arrayidx2.59 = getelementptr inbounds i32, ptr %Destination, i64 59
  store i32 %59, ptr %arrayidx2.59, align 4
  %arrayidx.60 = getelementptr inbounds i32, ptr %Source, i64 60
  %60 = load i32, ptr %arrayidx.60, align 4
  %arrayidx2.60 = getelementptr inbounds i32, ptr %Destination, i64 60
  store i32 %60, ptr %arrayidx2.60, align 4
  %arrayidx.61 = getelementptr inbounds i32, ptr %Source, i64 61
  %61 = load i32, ptr %arrayidx.61, align 4
  %arrayidx2.61 = getelementptr inbounds i32, ptr %Destination, i64 61
  store i32 %61, ptr %arrayidx2.61, align 4
  %arrayidx.62 = getelementptr inbounds i32, ptr %Source, i64 62
  %62 = load i32, ptr %arrayidx.62, align 4
  %arrayidx2.62 = getelementptr inbounds i32, ptr %Destination, i64 62
  store i32 %62, ptr %arrayidx2.62, align 4
  %arrayidx.63 = getelementptr inbounds i32, ptr %Source, i64 63
  %63 = load i32, ptr %arrayidx.63, align 4
  %arrayidx2.63 = getelementptr inbounds i32, ptr %Destination, i64 63
  store i32 %63, ptr %arrayidx2.63, align 4
  %arrayidx.64 = getelementptr inbounds i32, ptr %Source, i64 64
  %64 = load i32, ptr %arrayidx.64, align 4
  %arrayidx2.64 = getelementptr inbounds i32, ptr %Destination, i64 64
  store i32 %64, ptr %arrayidx2.64, align 4
  %arrayidx.65 = getelementptr inbounds i32, ptr %Source, i64 65
  %65 = load i32, ptr %arrayidx.65, align 4
  %arrayidx2.65 = getelementptr inbounds i32, ptr %Destination, i64 65
  store i32 %65, ptr %arrayidx2.65, align 4
  %arrayidx.66 = getelementptr inbounds i32, ptr %Source, i64 66
  %66 = load i32, ptr %arrayidx.66, align 4
  %arrayidx2.66 = getelementptr inbounds i32, ptr %Destination, i64 66
  store i32 %66, ptr %arrayidx2.66, align 4
  %arrayidx.67 = getelementptr inbounds i32, ptr %Source, i64 67
  %67 = load i32, ptr %arrayidx.67, align 4
  %arrayidx2.67 = getelementptr inbounds i32, ptr %Destination, i64 67
  store i32 %67, ptr %arrayidx2.67, align 4
  %arrayidx.68 = getelementptr inbounds i32, ptr %Source, i64 68
  %68 = load i32, ptr %arrayidx.68, align 4
  %arrayidx2.68 = getelementptr inbounds i32, ptr %Destination, i64 68
  store i32 %68, ptr %arrayidx2.68, align 4
  %arrayidx.69 = getelementptr inbounds i32, ptr %Source, i64 69
  %69 = load i32, ptr %arrayidx.69, align 4
  %arrayidx2.69 = getelementptr inbounds i32, ptr %Destination, i64 69
  store i32 %69, ptr %arrayidx2.69, align 4
  %arrayidx.70 = getelementptr inbounds i32, ptr %Source, i64 70
  %70 = load i32, ptr %arrayidx.70, align 4
  %arrayidx2.70 = getelementptr inbounds i32, ptr %Destination, i64 70
  store i32 %70, ptr %arrayidx2.70, align 4
  %arrayidx.71 = getelementptr inbounds i32, ptr %Source, i64 71
  %71 = load i32, ptr %arrayidx.71, align 4
  %arrayidx2.71 = getelementptr inbounds i32, ptr %Destination, i64 71
  store i32 %71, ptr %arrayidx2.71, align 4
  %arrayidx.72 = getelementptr inbounds i32, ptr %Source, i64 72
  %72 = load i32, ptr %arrayidx.72, align 4
  %arrayidx2.72 = getelementptr inbounds i32, ptr %Destination, i64 72
  store i32 %72, ptr %arrayidx2.72, align 4
  %arrayidx.73 = getelementptr inbounds i32, ptr %Source, i64 73
  %73 = load i32, ptr %arrayidx.73, align 4
  %arrayidx2.73 = getelementptr inbounds i32, ptr %Destination, i64 73
  store i32 %73, ptr %arrayidx2.73, align 4
  %arrayidx.74 = getelementptr inbounds i32, ptr %Source, i64 74
  %74 = load i32, ptr %arrayidx.74, align 4
  %arrayidx2.74 = getelementptr inbounds i32, ptr %Destination, i64 74
  store i32 %74, ptr %arrayidx2.74, align 4
  %arrayidx.75 = getelementptr inbounds i32, ptr %Source, i64 75
  %75 = load i32, ptr %arrayidx.75, align 4
  %arrayidx2.75 = getelementptr inbounds i32, ptr %Destination, i64 75
  store i32 %75, ptr %arrayidx2.75, align 4
  %arrayidx.76 = getelementptr inbounds i32, ptr %Source, i64 76
  %76 = load i32, ptr %arrayidx.76, align 4
  %arrayidx2.76 = getelementptr inbounds i32, ptr %Destination, i64 76
  store i32 %76, ptr %arrayidx2.76, align 4
  %arrayidx.77 = getelementptr inbounds i32, ptr %Source, i64 77
  %77 = load i32, ptr %arrayidx.77, align 4
  %arrayidx2.77 = getelementptr inbounds i32, ptr %Destination, i64 77
  store i32 %77, ptr %arrayidx2.77, align 4
  %arrayidx.78 = getelementptr inbounds i32, ptr %Source, i64 78
  %78 = load i32, ptr %arrayidx.78, align 4
  %arrayidx2.78 = getelementptr inbounds i32, ptr %Destination, i64 78
  store i32 %78, ptr %arrayidx2.78, align 4
  %arrayidx.79 = getelementptr inbounds i32, ptr %Source, i64 79
  %79 = load i32, ptr %arrayidx.79, align 4
  %arrayidx2.79 = getelementptr inbounds i32, ptr %Destination, i64 79
  store i32 %79, ptr %arrayidx2.79, align 4
  %arrayidx.80 = getelementptr inbounds i32, ptr %Source, i64 80
  %80 = load i32, ptr %arrayidx.80, align 4
  %arrayidx2.80 = getelementptr inbounds i32, ptr %Destination, i64 80
  store i32 %80, ptr %arrayidx2.80, align 4
  %arrayidx.81 = getelementptr inbounds i32, ptr %Source, i64 81
  %81 = load i32, ptr %arrayidx.81, align 4
  %arrayidx2.81 = getelementptr inbounds i32, ptr %Destination, i64 81
  store i32 %81, ptr %arrayidx2.81, align 4
  %arrayidx.82 = getelementptr inbounds i32, ptr %Source, i64 82
  %82 = load i32, ptr %arrayidx.82, align 4
  %arrayidx2.82 = getelementptr inbounds i32, ptr %Destination, i64 82
  store i32 %82, ptr %arrayidx2.82, align 4
  %arrayidx.83 = getelementptr inbounds i32, ptr %Source, i64 83
  %83 = load i32, ptr %arrayidx.83, align 4
  %arrayidx2.83 = getelementptr inbounds i32, ptr %Destination, i64 83
  store i32 %83, ptr %arrayidx2.83, align 4
  %arrayidx.84 = getelementptr inbounds i32, ptr %Source, i64 84
  %84 = load i32, ptr %arrayidx.84, align 4
  %arrayidx2.84 = getelementptr inbounds i32, ptr %Destination, i64 84
  store i32 %84, ptr %arrayidx2.84, align 4
  %arrayidx.85 = getelementptr inbounds i32, ptr %Source, i64 85
  %85 = load i32, ptr %arrayidx.85, align 4
  %arrayidx2.85 = getelementptr inbounds i32, ptr %Destination, i64 85
  store i32 %85, ptr %arrayidx2.85, align 4
  %arrayidx.86 = getelementptr inbounds i32, ptr %Source, i64 86
  %86 = load i32, ptr %arrayidx.86, align 4
  %arrayidx2.86 = getelementptr inbounds i32, ptr %Destination, i64 86
  store i32 %86, ptr %arrayidx2.86, align 4
  %arrayidx.87 = getelementptr inbounds i32, ptr %Source, i64 87
  %87 = load i32, ptr %arrayidx.87, align 4
  %arrayidx2.87 = getelementptr inbounds i32, ptr %Destination, i64 87
  store i32 %87, ptr %arrayidx2.87, align 4
  %arrayidx.88 = getelementptr inbounds i32, ptr %Source, i64 88
  %88 = load i32, ptr %arrayidx.88, align 4
  %arrayidx2.88 = getelementptr inbounds i32, ptr %Destination, i64 88
  store i32 %88, ptr %arrayidx2.88, align 4
  %arrayidx.89 = getelementptr inbounds i32, ptr %Source, i64 89
  %89 = load i32, ptr %arrayidx.89, align 4
  %arrayidx2.89 = getelementptr inbounds i32, ptr %Destination, i64 89
  store i32 %89, ptr %arrayidx2.89, align 4
  %arrayidx.90 = getelementptr inbounds i32, ptr %Source, i64 90
  %90 = load i32, ptr %arrayidx.90, align 4
  %arrayidx2.90 = getelementptr inbounds i32, ptr %Destination, i64 90
  store i32 %90, ptr %arrayidx2.90, align 4
  %arrayidx.91 = getelementptr inbounds i32, ptr %Source, i64 91
  %91 = load i32, ptr %arrayidx.91, align 4
  %arrayidx2.91 = getelementptr inbounds i32, ptr %Destination, i64 91
  store i32 %91, ptr %arrayidx2.91, align 4
  %arrayidx.92 = getelementptr inbounds i32, ptr %Source, i64 92
  %92 = load i32, ptr %arrayidx.92, align 4
  %arrayidx2.92 = getelementptr inbounds i32, ptr %Destination, i64 92
  store i32 %92, ptr %arrayidx2.92, align 4
  %arrayidx.93 = getelementptr inbounds i32, ptr %Source, i64 93
  %93 = load i32, ptr %arrayidx.93, align 4
  %arrayidx2.93 = getelementptr inbounds i32, ptr %Destination, i64 93
  store i32 %93, ptr %arrayidx2.93, align 4
  %arrayidx.94 = getelementptr inbounds i32, ptr %Source, i64 94
  %94 = load i32, ptr %arrayidx.94, align 4
  %arrayidx2.94 = getelementptr inbounds i32, ptr %Destination, i64 94
  store i32 %94, ptr %arrayidx2.94, align 4
  %arrayidx.95 = getelementptr inbounds i32, ptr %Source, i64 95
  %95 = load i32, ptr %arrayidx.95, align 4
  %arrayidx2.95 = getelementptr inbounds i32, ptr %Destination, i64 95
  store i32 %95, ptr %arrayidx2.95, align 4
  ret void
}
...
entry:
  %call.i = tail call i32 @flag_Minimum(i32 noundef %FlagId) #12
...
if.then.i:                                        ; preds = %entry
  ...
  %call2.i = tail call ptr @flag_Name(i32 noundef %FlagId) #12
  tail call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.32, i32 noundef 0, ptr noundef %call2.i) #12
...
if.else.i:                                        ; preds = %entry
  %call3.i = tail call i32 @flag_Maximum(i32 noundef %FlagId) #12
...
if.then5.i:                                       ; preds = %if.else.i
  ...
  %call7.i = tail call ptr @flag_Name(i32 noundef %FlagId) #12
  tail call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.33, i32 noundef 0, ptr noundef %call7.i) #12
...
list_Delete.exit:                                 ; preds = %while.body.i, %for.end
  ...
  br i1 %cmp.i.not5.i21, label %list_Delete.exit29, label %while.body.i22

while.body.i22:                                   ; preds = %list_Delete.exit, %while.body.i22
  %Current.06.i23 = phi ptr [ %Current.0.val.i24, %while.body.i22 ], [ %Clause.val19, %list_Delete.exit ]
  %Current.0.val.i24 = load ptr, ptr %Current.06.i23, align 8
  %8 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i25 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %8, i64 0, i32 4
  %9 = load i32, ptr %total_size.i.i.i25, align 8
  %conv26.i.i.i26 = sext i32 %9 to i64
  %10 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i27 = add i64 %10, %conv26.i.i.i26
  store i64 %add27.i.i.i27, ptr @memory_FREEDBYTES, align 8
  %11 = load ptr, ptr %8, align 8
  store ptr %11, ptr %Current.06.i23, align 8
  %12 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i23, ptr %12, align 8
  %cmp.i.not.i28 = icmp eq ptr %Current.0.val.i24, null
  br i1 %cmp.i.not.i28, label %list_Delete.exit29, label %while.body.i22, !llvm.loop !8

list_Delete.exit29:                               ; preds = %while.body.i22, %list_Delete.exit
...
list_Nconc.exit:                                  ; preds = %list_Delete.exit29, %if.end.i, %for.end.i
  ...
  br i1 %cmp.i.not41, label %list_Nconc.exit40, label %if.end.i32

if.end.i32:                                       ; preds = %list_Nconc.exit
  %cmp.i18.not.i33 = icmp eq ptr %PLitInds, null
  br i1 %cmp.i18.not.i33, label %list_Nconc.exit40, label %for.cond.i34

for.cond.i34:                                     ; preds = %if.end.i32, %for.cond.i34
  %List1.addr.0.i35 = phi ptr [ %List1.addr.0.val17.i36, %for.cond.i34 ], [ %LitInds, %if.end.i32 ]
  %List1.addr.0.val17.i36 = load ptr, ptr %List1.addr.0.i35, align 8
  %cmp.i20.not.i37 = icmp eq ptr %List1.addr.0.val17.i36, null
  br i1 %cmp.i20.not.i37, label %for.end.i38, label %for.cond.i34, !llvm.loop !10

for.end.i38:                                      ; preds = %for.cond.i34
  store ptr %PLitInds, ptr %List1.addr.0.i35, align 8
  br label %list_Nconc.exit40

list_Nconc.exit40:                                ; preds = %list_Nconc.exit, %if.end.i32, %for.end.i38
  %retval.0.i39 = phi ptr [ %LitInds, %for.end.i38 ], [ %PLitInds, %list_Nconc.exit ], [ %LitInds, %if.end.i32 ]
