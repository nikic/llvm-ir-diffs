; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/strings.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/strings.c"
...
if.then.i:                                        ; preds = %entry
  ...
  %RealSize.1.i.i.i = add i32 %add7.i.i.i, %conv
...
if.end9.sink.split:                               ; preds = %entry, %if.then4
  ...
  %conv5 = sitofp i32 %neg.sink to double
  %call6 = tail call double @log10(double noundef %conv5) #15
  %conv7 = fptoui double %call6 to i32
  %add8 = add i32 %.sink, %conv7
  %0 = add i32 %add8, 1
  br label %if.end9

if.end9:                                          ; preds = %if.end9.sink.split, %if.else
  %size.0 = phi i32 [ 2, %if.else ], [ %0, %if.end9.sink.split ]
  %call12 = tail call ptr @memory_Malloc(i32 noundef %size.0) #15
  %call13 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %call12, ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %Number) #15
  ret ptr %call12
}
...
string_StringFree.exit:                           ; preds = %if.end23.i.i, %if.else25.i.i
  ...
  br i1 %cmp.i.i.i14, label %if.else25.i.i41, label %if.then.i.i15

if.then.i.i15:                                    ; preds = %string_StringFree.exit
  %17 = load i32, ptr @memory_ALIGN, align 4
  %rem2.i.i.i.i16 = urem i32 %conv.i13, %17
  %tobool3.not.i.i.i.i17 = icmp eq i32 %rem2.i.i.i.i16, 0
  %sub6.i.i.i.i18 = sub i32 %17, %rem2.i.i.i.i16
  %add7.i.i.i.i19 = select i1 %tobool3.not.i.i.i.i17, i32 0, i32 %sub6.i.i.i.i18
  %RealSize.1.i.i.i.i20 = add i32 %add7.i.i.i.i19, %conv.i13
  %18 = load i32, ptr @memory_OFFSET, align 4
  %idx.ext.i.i21 = zext i32 %18 to i64
  %idx.neg.i.i22 = sub nsw i64 0, %idx.ext.i.i21
  %add.ptr.i.i23 = getelementptr inbounds i8, ptr %s2, i64 %idx.neg.i.i22
  %add.ptr1.i.i24 = getelementptr inbounds i8, ptr %add.ptr.i.i23, i64 -16
  %19 = load ptr, ptr %add.ptr1.i.i24, align 8
  %cmp2.not.i.i25 = icmp eq ptr %19, null
  %next6.i.i26 = getelementptr inbounds i8, ptr %add.ptr.i.i23, i64 -8
  %20 = load ptr, ptr %next6.i.i26, align 8
  %next5.i.i27 = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %19, i64 0, i32 1
  %memory_BIGBLOCKS.sink.i.i28 = select i1 %cmp2.not.i.i25, ptr @memory_BIGBLOCKS, ptr %next5.i.i27
  store ptr %20, ptr %memory_BIGBLOCKS.sink.i.i28, align 8
  %21 = load ptr, ptr %next6.i.i26, align 8
  %cmp8.not.i.i29 = icmp eq ptr %21, null
  br i1 %cmp8.not.i.i29, label %if.end13.i.i31, label %if.then9.i.i30

if.then9.i.i30:                                   ; preds = %if.then.i.i15
  %22 = load ptr, ptr %add.ptr1.i.i24, align 8
  store ptr %22, ptr %21, align 8
  br label %if.end13.i.i31

if.end13.i.i31:                                   ; preds = %if.then9.i.i30, %if.then.i.i15
  %23 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i32 = add i32 %RealSize.1.i.i.i.i20, %23
  %conv.i.i33 = zext i32 %add.i.i32 to i64
  %add14.i.i34 = add nuw nsw i64 %conv.i.i33, 16
  %24 = load i64, ptr @memory_FREEDBYTES, align 8
  %add15.i.i35 = add i64 %add14.i.i34, %24
  store i64 %add15.i.i35, ptr @memory_FREEDBYTES, align 8
  %25 = load i64, ptr @memory_MAXMEM, align 8
  %cmp16.i.i36 = icmp sgt i64 %25, -1
  br i1 %cmp16.i.i36, label %if.then18.i.i39, label %if.end23.i.i37

if.then18.i.i39:                                  ; preds = %if.end13.i.i31
  %add22.i.i40 = add nuw i64 %25, %add14.i.i34
  store i64 %add22.i.i40, ptr @memory_MAXMEM, align 8
  br label %if.end23.i.i37

if.end23.i.i37:                                   ; preds = %if.then18.i.i39, %if.end13.i.i31
  %add.ptr24.i.i38 = getelementptr inbounds i8, ptr %s2, i64 -16
  tail call void @free(ptr noundef nonnull %add.ptr24.i.i38) #15
  br label %string_StringFree.exit47

if.else25.i.i41:                                  ; preds = %string_StringFree.exit
  %idxprom.i.i42 = zext i32 %conv.i13 to i64
  %arrayidx.i.i43 = getelementptr inbounds [0 x ptr], ptr @memory_ARRAY, i64 0, i64 %idxprom.i.i42
  %26 = load ptr, ptr %arrayidx.i.i43, align 8
  %total_size.i.i44 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %26, i64 0, i32 4
  %27 = load i32, ptr %total_size.i.i44, align 8
  %conv26.i.i45 = sext i32 %27 to i64
  %28 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i46 = add i64 %28, %conv26.i.i45
  store i64 %add27.i.i46, ptr @memory_FREEDBYTES, align 8
  %29 = load ptr, ptr %26, align 8
  store ptr %29, ptr %s2, align 8
  %30 = load ptr, ptr %arrayidx.i.i43, align 8
  store ptr %s2, ptr %30, align 8
  br label %string_StringFree.exit47

string_StringFree.exit47:                         ; preds = %if.end23.i.i37, %if.else25.i.i41
  ret ptr %call3
}
...
entry:
  ...
  %cmp.not79 = icmp ult ptr %add.ptr2, %String
  br i1 %cmp.not79, label %while.end28, label %while.cond3.preheader.lr.ph
...
while.cond3.preheader:                            ; preds = %while.cond3.preheader.lr.ph, %if.end
  %Substrings.081 = phi ptr [ null, %while.cond3.preheader.lr.ph ], [ %Substrings.1, %if.end ]
  %Scan.080 = phi ptr [ %add.ptr2, %while.cond3.preheader.lr.ph ], [ %Scan.3, %if.end ]
  %0 = load ptr, ptr %call5, align 8
  br label %land.rhs

land.rhs:                                         ; preds = %while.cond3.preheader, %while.body7
  %Scan.178 = phi ptr [ %Scan.080, %while.cond3.preheader ], [ %incdec.ptr, %while.body7 ]
  %1 = load i8, ptr %Scan.178, align 1
...
while.body7:                                      ; preds = %land.rhs
  %incdec.ptr = getelementptr inbounds i8, ptr %Scan.178, i64 -1
  %cmp4.not = icmp ult ptr %incdec.ptr, %String
  br i1 %cmp4.not, label %if.end, label %land.rhs

do.body:                                          ; preds = %land.rhs, %land.rhs13
  %Scan.2 = phi ptr [ %incdec.ptr10, %land.rhs13 ], [ %Scan.178, %land.rhs ]
...
land.rhs13:                                       ; preds = %do.body
  ...
  br i1 %tobool20.not, label %do.body, label %do.end

do.end:                                           ; preds = %do.body, %land.rhs13
  %add.ptr22 = getelementptr inbounds i8, ptr %Scan.178, i64 1
  ...
  store ptr %Substrings.081, ptr %call.i71, align 8
  store i8 %7, ptr %add.ptr22, align 1
  br label %if.end

if.end:                                           ; preds = %while.body7, %do.end
  %Scan.3 = phi ptr [ %incdec.ptr10, %do.end ], [ %incdec.ptr, %while.body7 ]
  %Substrings.1 = phi ptr [ %call.i71, %do.end ], [ %Substrings.081, %while.body7 ]
  %cmp.not = icmp ult ptr %Scan.3, %String
  br i1 %cmp.not, label %while.end28, label %while.cond3.preheader
...
while.end28:                                      ; preds = %if.end, %entry
  ...
  %cmp.i.not82 = icmp eq ptr %Substrings.0.lcssa, null
  br i1 %cmp.i.not82, label %for.end, label %for.body

for.body:                                         ; preds = %while.end28, %for.body
  %i.084 = phi i32 [ %inc, %for.body ], [ 1, %while.end28 ]
  %Substrings.283 = phi ptr [ %L.val.i, %for.body ], [ %Substrings.0.lcssa, %while.end28 ]
  %9 = getelementptr i8, ptr %Substrings.283, i64 8
  %Substrings.2.val = load ptr, ptr %9, align 8
  %idxprom39 = zext i32 %i.084 to i64
  %arrayidx40 = getelementptr inbounds ptr, ptr %call32, i64 %idxprom39
  store ptr %Substrings.2.val, ptr %arrayidx40, align 8
  %L.val.i = load ptr, ptr %Substrings.283, align 8
