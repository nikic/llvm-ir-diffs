; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/sharing.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/sharing.c"
...
entry:
  ...
  %1 = sub i32 %sub6.i.i.i, %rem2.i.i.i
  %RealSize.1.i.i.i = select i1 %tobool3.not.i.i.i, i32 56024, i32 %1
...
if.end.i.i:                                       ; preds = %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i, label %if.then, label %while.body.i.i
...
while.body:                                       ; preds = %if.then, %while.body
  ...
  br i1 %cmp.i16.not, label %if.end, label %while.body
...
entry:
  ...
  %cmp.i.not250.i = icmp eq i32 %1, %0
  br i1 %cmp.i.not250.i, label %sharing_InsertIntoSharing.exit, label %while.body.lr.ph.i
...
if.else.i:                                        ; preds = %while.body.i
  ...
  %cmp.i.not.i.not.i = icmp eq ptr %T.val4.i.i, null
  br i1 %cmp.i.not.i.not.i, label %if.then23.i, label %if.else40.i
...
if.then26.i:                                      ; preds = %if.then23.i
  ...
  %.pre253.i = sub nsw i32 0, %call3.val180.pre.i
  %.pre254.i = ashr i32 %.pre253.i, %3
  %.pre255.i = zext i32 %.pre254.i to i64
  %arrayidx.i219.i.phi.trans.insert = getelementptr inbounds %struct.SHARED_INDEX_NODE, ptr %SharedIndex, i64 0, i32 2, i64 %.pre255.i
...
while.body56.i:                                   ; preds = %if.else40.i, %if.end75.i
  %HelpList.0245.i6 = phi ptr [ %HelpList.0.val.i, %if.end75.i ], [ %call42.val.i, %if.else40.i ]
  %16 = getelementptr i8, ptr %HelpList.0245.i6, i64 8
...
while.body72.i:                                   ; preds = %land.rhs66.i
  ...
  br i1 %cmp.i225.not.i, label %if.end104.i, label %land.rhs66.i

if.end75.i:                                       ; preds = %land.rhs66.i, %while.body56.i
  %HelpList.0.val.i = load ptr, ptr %HelpList.0245.i6, align 8
...
if.then86.i:                                      ; preds = %if.end75.i, %if.else40.i
  ...
  %HelpList.1247.i = load ptr, ptr %9, align 8
  %cmp.i227.not248.i = icmp eq ptr %HelpList.1247.i, null
  br i1 %cmp.i227.not248.i, label %for.end.i, label %for.body.lr.ph.i
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  %HelpList.1249.i = phi ptr [ %HelpList.1247.i, %for.body.lr.ph.i ], [ %HelpList.1.i, %for.body.i ]
  %22 = getelementptr i8, ptr %HelpList.1249.i, i64 8
  ...
  %HelpList.1.i = load ptr, ptr %HelpList.1249.i, align 8
  %cmp.i227.not.i = icmp eq ptr %HelpList.1.i, null
  br i1 %cmp.i227.not.i, label %for.end.i, label %for.body.i
...
if.end104.i:                                      ; preds = %while.body72.i, %if.then23.i, %if.then26.i, %for.end.i, %if.then8.i, %if.then.i
  %.sink.i = phi ptr [ %.pre.i, %if.then8.i ], [ %6, %if.then.i ], [ %call49.i, %for.end.i ], [ %.pre, %if.then26.i ], [ %10, %if.then23.i ], [ %HelpList.0.val188.i, %while.body72.i ]
  ...
  br i1 %cmp.i.not.i, label %sharing_InsertIntoSharing.exit, label %while.body.i
...
while.body:                                       ; preds = %entry, %if.end
  %Args.057 = phi ptr [ %Args.0.val, %if.end ], [ %Term.val42, %entry ]
  %2 = getelementptr i8, ptr %Args.057, i64 8
  %Args.0.val44 = load ptr, ptr %2, align 8
  %Args.0.val = load ptr, ptr %Args.057, align 8
...
if.end:                                           ; preds = %if.then13, %while.body
  ...
  br i1 %cmp.i47.not, label %if.end21, label %while.body
...
while.body.i:                                     ; preds = %if.end21, %while.body.i
  ...
  br i1 %cmp.i.not.i51, label %list_Delete.exit, label %while.body.i
...
for.inc11.i:                                      ; preds = %if.then9.i, %for.body6.i
  ...
  br i1 %exitcond31.not.i, label %if.end, label %for.body6.i
...
for.inc11:                                        ; preds = %for.body6, %if.then9
  ...
  br i1 %exitcond31.not, label %for.end13, label %for.body6
...
for.body.preheader:                               ; preds = %if.else
  %.pre32 = load i32, ptr @term_STAMP, align 4
  br label %for.body

for.body:                                         ; preds = %for.body.preheader, %if.end
  %3 = phi i32 [ %7, %if.end ], [ %.pre32, %for.body.preheader ]
...
if.end:                                           ; preds = %list_Nconc.exit, %for.body
  %7 = phi i32 [ %3, %for.body ], [ %.pre, %list_Nconc.exit ]
...
land.rhs10:                                       ; preds = %do.body6
  ...
  br i1 %cmp.i79.not, label %do.body6, label %land.rhs25
...
land.rhs37:                                       ; preds = %while.cond34
  ...
  br i1 %cmp.i87.not, label %while.cond34, label %while.end
...
while.end44:                                      ; preds = %do.cond15, %while.cond34
  ...
  br i1 %cmp, label %do.body.preheader, label %if.end54
...
for.inc:                                          ; preds = %for.end.i, %if.end.i, %if.then6, %for.body
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 3001
  br i1 %exitcond.not, label %for.body13, label %for.body
...
if.then16:                                        ; preds = %for.body13
  ...
  br i1 %cmp.i.not.i38, label %for.inc20, label %if.end.i39

if.end.i39:                                       ; preds = %if.then16
  %cmp.i18.not.i40 = icmp eq ptr %Result.251, null
  br i1 %cmp.i18.not.i40, label %for.inc20, label %for.cond.i41

for.cond.i41:                                     ; preds = %if.end.i39, %for.cond.i41
  %List1.addr.0.i42 = phi ptr [ %List1.addr.0.val17.i43, %for.cond.i41 ], [ %call17, %if.end.i39 ]
  %List1.addr.0.val17.i43 = load ptr, ptr %List1.addr.0.i42, align 8
  %cmp.i20.not.i44 = icmp eq ptr %List1.addr.0.val17.i43, null
  br i1 %cmp.i20.not.i44, label %for.end.i45, label %for.cond.i41

for.end.i45:                                      ; preds = %for.cond.i41
  store ptr %Result.251, ptr %List1.addr.0.i42, align 8
  br label %for.inc20

for.inc20:                                        ; preds = %for.end.i45, %if.end.i39, %if.then16, %for.body13
  %Result.3 = phi ptr [ %Result.251, %for.body13 ], [ %call17, %for.end.i45 ], [ %Result.251, %if.then16 ], [ %call17, %if.end.i39 ]
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %exitcond56.not = icmp eq i64 %indvars.iv.next54, 4000
  br i1 %exitcond56.not, label %for.end22, label %for.body13
...
for.inc:                                          ; preds = %for.body, %if.then7
  ...
  %cmp.i.not = icmp eq ptr %SuperList.0, null
  br i1 %cmp.i.not, label %if.end9, label %for.body
...
for.inc16:                                        ; preds = %for.body9, %if.then12
  ...
  br i1 %exitcond41.not, label %for.end18, label %for.body9
...
while.body:                                       ; preds = %if.then5, %while.body
  %HelpList.027 = phi ptr [ %Term.val, %if.then5 ], [ %HelpList.0.val20, %while.body ]
  %4 = getelementptr i8, ptr %HelpList.027, i64 8
  %HelpList.0.val = load ptr, ptr %4, align 8
  tail call fastcc void @sharing_PrintWithSuperterms(ptr noundef %HelpList.0.val)
  %HelpList.0.val20 = load ptr, ptr %HelpList.027, align 8
  %cmp.i23.not = icmp eq ptr %HelpList.0.val20, null
  br i1 %cmp.i23.not, label %if.end12, label %while.body
