...
for.inc:                                          ; preds = %land.rhs
  ...
  br i1 %cmp.i48.not, label %cleanup, label %land.rhs
...
for.body13.i:                                     ; preds = %for.cond7.i.preheader, %for.body13.i
  ...
  %call.i130 = tail call i32 @rpos_GreaterEqual(ptr noundef %scan.0.val39.i, ptr noundef %l2.0.val.i)
  ...
  br i1 %.not, label %for.inc18.i, label %for.body13.i
...
for.inc18.i:                                      ; preds = %for.body13.i
  ...
  br i1 %13, label %for.cond7.i.preheader, label %while.body.i.preheader.loopexit
...
for.body.i:                                       ; preds = %if.end.i, %for.inc.i
  ...
  %call13.i = tail call i32 @rpos_GreaterEqual(ptr noundef %scan1.0.val107.i, ptr noundef %scan2.0.val106.i)
...
for.inc.i:                                        ; preds = %for.body.i
  ...
  br i1 %cmp.i183.not, label %if.end68.i, label %for.body.i
...
land.rhs.i:                                       ; preds = %for.cond28.i
  ...
  %call.i = tail call i32 @rpos_GreaterEqual(ptr noundef nonnull %T1, ptr noundef %scan2.1.val105.i)
  %cmp.i.i173.not = icmp eq i32 %call.i, 3
  br i1 %cmp.i.i173.not, label %for.cond28.i, label %if.end68.i
...
for.body56.i:                                     ; preds = %for.cond48.i.preheader, %for.body56.i
  ...
  %call58.i = tail call i32 @rpos_GreaterEqual(ptr noundef %scan1.1.val104.i, ptr noundef nonnull %T2)
  ...
  br i1 %or.cond, label %if.end68.i.loopexit, label %for.body56.i
...
while.body.i151:                                  ; preds = %if.then72.i, %while.body.i151
  ...
  br i1 %cmp.i.not.i157, label %list_Delete.exit158, label %while.body.i151
...
while.body.i142:                                  ; preds = %list_Delete.exit158, %while.body.i142
  ...
  br i1 %cmp.i.not.i148, label %cleanup, label %while.body.i142
...
for.body:                                         ; preds = %for.cond
  ...
  %call.i121 = tail call i32 @rpos_GreaterEqual(ptr noundef nonnull %T1, ptr noundef %scan.0.val93)
  %cmp.i191.not = icmp eq i32 %call.i121, 3
  br i1 %cmp.i191.not, label %for.cond, label %cleanup
...
for.body50:                                       ; preds = %for.cond46
  ...
  %call52 = tail call i32 @rpos_GreaterEqual(ptr noundef %scan.1.val92, ptr noundef nonnull %T2)
  %cmp.i125.not = icmp eq i32 %call52, 0
  br i1 %cmp.i125.not, label %for.cond46, label %cleanup
...
entry:
  %call = tail call i32 @rpos_GreaterEqual(ptr noundef %T1, ptr noundef %T2)
  %cmp.i.not = icmp eq i32 %call, 0
  br i1 %cmp.i.not, label %if.else, label %cleanup

if.else:                                          ; preds = %entry
  %call.i = tail call i32 @rpos_GreaterEqual(ptr noundef %T2, ptr noundef %T1)
...
while.body.i69:                                   ; preds = %if.then10, %while.body.i69
  ...
  br i1 %cmp.i.not.i70, label %cleanup, label %while.body.i69
...
for.inc:                                          ; preds = %land.rhs
  ...
  br i1 %cmp.i71.not, label %cleanup, label %land.rhs
...
for.inc:                                          ; preds = %for.body8, %land.lhs.true
  ...
  br i1 %cmp.i29.not, label %for.inc15, label %for.body8

for.inc15:                                        ; preds = %for.inc, %if.then
  %scan2.0 = load ptr, ptr %scan2.035, align 8
  %cmp.i.not = icmp eq ptr %scan2.0, null
  br i1 %cmp.i.not, label %for.end17, label %for.cond4.preheader
...
for.inc.i169:                                     ; preds = %land.lhs.true.i, %for.body8.i
  ...
  br i1 %cmp.i29.not.i, label %for.inc15.i, label %for.body8.i
...
for.inc15.i:                                      ; preds = %for.inc.i169, %if.then.i165
  ...
  br i1 %cmp.i.not.i167, label %rpos_ContMultisetDifference.exit, label %for.cond4.preheader.i
...
land.lhs.true.i311:                               ; preds = %for.body8.i307
  ...
  %call12.i = tail call i32 @rpos_ContEqual(ptr noundef %C2.addr.1, ptr noundef nonnull %scan1.0.val28.i309, ptr noundef %C1.addr.1, ptr noundef %scan2.0.val26.i312) #3
...
for.inc.i316:                                     ; preds = %land.lhs.true.i311, %for.body8.i307
  ...
  br i1 %cmp.i29.not.i317, label %for.inc15.i314, label %for.body8.i307
...
for.inc15.i314:                                   ; preds = %for.inc.i316, %if.then.i
  ...
  br i1 %cmp.i.not.i315, label %rpos_ContMultisetDifference.exit318, label %for.cond4.preheader.i305
...
for.body13.i:                                     ; preds = %for.cond7.i.preheader, %for.body13.i
  ...
  %call.i153 = tail call i32 @rpos_ContGreaterEqual(ptr noundef %C1.addr.1, ptr noundef %scan.0.val43.i, ptr noundef %C2.addr.1, ptr noundef %l2.0.val.i)
...
for.inc18.i:                                      ; preds = %for.body13.i
  ...
  br i1 %29, label %for.cond7.i.preheader, label %while.body.i148.preheader.loopexit
...
while.body.i148:                                  ; preds = %while.body.i148.preheader, %while.body.i148
  ...
  br i1 %cmp.i.not.i149, label %cleanup, label %while.body.i148
...
for.body.i:                                       ; preds = %if.end.i, %for.inc.i
  ...
  %call13.i = tail call i32 @rpos_ContGreaterEqual(ptr noundef %C1.addr.1, ptr noundef %scan1.0.val111.i, ptr noundef %C2.addr.1, ptr noundef %scan2.0.val110.i)
  switch i32 %call13.i, label %for.cond48.i.preheader [
    i32 2, label %for.inc.i
    i32 3, label %for.cond28.i
  ]
...
for.inc.i:                                        ; preds = %for.body.i
  ...
  br i1 %cmp.i213.not, label %if.end68.i, label %for.body.i
...
land.rhs.i134:                                    ; preds = %for.cond28.i
  ...
  %call.i = tail call i32 @rpos_ContGreaterEqual(ptr noundef %C1.addr.1, ptr noundef nonnull %Term.addr.0.lcssa.i, ptr noundef %C2.addr.1, ptr noundef %scan2.1.val109.i)
  %cmp.i.i203.not = icmp eq i32 %call.i, 3
  br i1 %cmp.i.i203.not, label %for.cond28.i, label %if.end68.i
...
for.body56.i:                                     ; preds = %for.cond48.i.preheader, %for.body56.i
  ...
  %call58.i = tail call i32 @rpos_ContGreaterEqual(ptr noundef %C1.addr.1, ptr noundef %scan1.1.val108.i, ptr noundef %C2.addr.1, ptr noundef nonnull %Term.addr.0.lcssa.i116)
...
while.body.i172:                                  ; preds = %list_Delete.exit188, %while.body.i172
  ...
  br i1 %cmp.i.not.i178, label %cleanup, label %while.body.i172
...
for.body:                                         ; preds = %for.cond
  ...
  %call.i142 = tail call i32 @rpos_ContGreaterEqual(ptr noundef %C1.addr.1, ptr noundef nonnull %Term.addr.0.lcssa.i, ptr noundef %C2.addr.1, ptr noundef %scan.0.val97)
  %cmp.i221.not = icmp eq i32 %call.i142, 3
  br i1 %cmp.i221.not, label %for.cond, label %cleanup
...
for.body52:                                       ; preds = %for.cond48
  ...
  %call54 = tail call i32 @rpos_ContGreaterEqual(ptr noundef %C1.addr.1, ptr noundef %scan.1.val96, ptr noundef %C2.addr.1, ptr noundef nonnull %Term.addr.0.lcssa.i116)
  %cmp.i146.not = icmp eq i32 %call54, 0
  br i1 %cmp.i146.not, label %for.cond48, label %cleanup
...
cont_Deref.exit31:                                ; preds = %while.body.i22, %cleanup.i26, %while.body.i22.preheader, %land.rhs.i18.preheader, %cont_Deref.exit
  ...
  %call2 = tail call i32 @rpos_ContGreaterEqual(ptr noundef %C1.addr.1, ptr noundef nonnull %Term.addr.0.lcssa.i, ptr noundef %C2.addr.1, ptr noundef nonnull %Term.addr.0.lcssa.i30)
  %cmp.i.not = icmp eq i32 %call2, 0
  br i1 %cmp.i.not, label %if.else, label %cleanup

if.else:                                          ; preds = %cont_Deref.exit31
  %call.i = tail call i32 @rpos_ContGreaterEqual(ptr noundef %C2.addr.1, ptr noundef nonnull %Term.addr.0.lcssa.i30, ptr noundef %C1.addr.1, ptr noundef nonnull %Term.addr.0.lcssa.i)
  %cmp.i.i.not = icmp eq i32 %call.i, 3
  %spec.select = zext i1 %cmp.i.i.not to i32
  br label %cleanup
