; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/renaming.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/renaming.c"
...
@.str.9 = private unnamed_addr constant [59 x i8] c"/home/npopov/repos/llvm-test-suite/CTMark/SPASS/renaming.c\00", align 1
...
if.then.i:                                        ; preds = %if.end.i.i, %for.body.i
  ...
  br label %while.body.i69.i

while.body.i69.i:                                 ; preds = %while.body.i69.i, %if.then.i
  %Current.06.i.i = phi ptr [ %Current.0.val.i.i, %while.body.i69.i ], [ %call.i.i, %if.then.i ]
  ...
  %cmp.i.not.i70.i = icmp eq ptr %Current.0.val.i.i, null
  br i1 %cmp.i.not.i70.i, label %list_Delete.exit.i, label %while.body.i69.i

list_Delete.exit.i:                               ; preds = %while.body.i69.i
  br i1 %cmp.i.not6.i.i, label %if.then11.i, label %while.body.i72.i

while.body.i72.i:                                 ; preds = %list_Delete.exit.i, %if.end.i76.i
  %List.addr.07.i73.i = phi ptr [ %List.addr.0.val.i77.i, %if.end.i76.i ], [ %Allmatches.0122.i, %list_Delete.exit.i ]
  %9 = getelementptr i8, ptr %List.addr.07.i73.i, i64 8
  %List.addr.0.val5.i74.i = load ptr, ptr %9, align 8
  %cmp.i75.i = icmp eq ptr %List.addr.0.val5.i74.i, %call8.i
  br i1 %cmp.i75.i, label %for.inc36.i, label %if.end.i76.i

if.end.i76.i:                                     ; preds = %while.body.i72.i
  %List.addr.0.val.i77.i = load ptr, ptr %List.addr.07.i73.i, align 8
  %cmp.i.not.i78.i = icmp eq ptr %List.addr.0.val.i77.i, null
  br i1 %cmp.i.not.i78.i, label %if.then11.i, label %while.body.i72.i

if.then11.i:                                      ; preds = %if.end.i76.i, %list_Delete.exit.i
...
while.body.i86.i:                                 ; preds = %if.end.i90.i, %for.body19.i
  %List.addr.07.i87.i = phi ptr [ %List.addr.0.val.i91.i, %if.end.i90.i ], [ %call.i81.i, %for.body19.i ]
  %11 = getelementptr i8, ptr %List.addr.07.i87.i, i64 8
  %List.addr.0.val5.i88.i = load ptr, ptr %11, align 8
  %cmp.i89.i = icmp eq ptr %List.addr.0.val5.i88.i, %Scan2.0.val66.i
  br i1 %cmp.i89.i, label %if.then23.i, label %if.end.i90.i

if.end.i90.i:                                     ; preds = %while.body.i86.i
  %List.addr.0.val.i91.i = load ptr, ptr %List.addr.07.i87.i, align 8
  %cmp.i.not.i92.i = icmp eq ptr %List.addr.0.val.i91.i, null
  br i1 %cmp.i.not.i92.i, label %if.else.i, label %while.body.i86.i

if.then23.i:                                      ; preds = %while.body.i86.i
  store ptr null, ptr %10, align 8
  br label %for.inc.i

if.else.i:                                        ; preds = %if.end.i90.i
...
for.inc.i:                                        ; preds = %if.else.i, %if.then23.i
  ...
  br i1 %cmp.i83.not.i, label %for.end.i, label %for.body19.i
...
for.inc36.i:                                      ; preds = %while.body.i.i, %while.body.i72.i, %list_Nconc.exit.i
  %Allmatches.1.i = phi ptr [ %retval.0.i98.i, %list_Nconc.exit.i ], [ %Allmatches.0122.i, %while.body.i72.i ], [ %Allmatches.0122.i, %while.body.i.i ]
  %Renamings.1.i = phi ptr [ %call.i100.i, %list_Nconc.exit.i ], [ %Renamings.0123.i, %while.body.i72.i ], [ %Renamings.0123.i, %while.body.i.i ]
  %Scan1.0.val.i = load ptr, ptr %Scan1.0124.i, align 8
  %cmp.i.not.i = icmp eq ptr %Scan1.0.val.i, null
  br i1 %cmp.i.not.i, label %while.body.i103.i, label %for.body.i

while.body.i103.i:                                ; preds = %for.inc36.i, %while.body.i103.i
  %Current.06.i104.i = phi ptr [ %Current.0.val.i105.i, %while.body.i103.i ], [ %Allmatches.1.i, %for.inc36.i ]
  %Current.0.val.i105.i = load ptr, ptr %Current.06.i104.i, align 8
  %12 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i106.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %12, i64 0, i32 4
  %13 = load i32, ptr %total_size.i.i.i106.i, align 8
  %conv26.i.i.i107.i = sext i32 %13 to i64
  %14 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i108.i = add i64 %14, %conv26.i.i.i107.i
  store i64 %add27.i.i.i108.i, ptr @memory_FREEDBYTES, align 8
  %15 = load ptr, ptr %12, align 8
  store ptr %15, ptr %Current.06.i104.i, align 8
  %16 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i104.i, ptr %16, align 8
  %cmp.i.not.i109.i = icmp eq ptr %Current.0.val.i105.i, null
  br i1 %cmp.i.not.i109.i, label %if.end16, label %while.body.i103.i
...
if.end16:                                         ; preds = %while.body.i103.i, %for.body, %for.cond.preheader, %if.then5
  %Renamings.1 = phi ptr [ null, %if.then5 ], [ null, %for.cond.preheader ], [ %call.i76, %for.body ], [ %Renamings.1.i, %while.body.i103.i ]
...
for.body30:                                       ; preds = %if.then24, %for.body30
  ...
  br i1 %cmp.i79.not, label %for.end35, label %for.body30
...
while.body.i:                                     ; preds = %list_Delete.exit.i99, %if.then.i82
  %AllMatches.0244.i = phi ptr [ null, %if.then.i82 ], [ %retval.0.i232.i, %list_Delete.exit.i99 ]
  %Renamings.addr.0243.i = phi ptr [ %call20, %if.then.i82 ], [ %Renamings.addr.0.val.i, %list_Delete.exit.i99 ]
  %DefTerm.0242.i = phi ptr [ null, %if.then.i82 ], [ %DefTerm.2.i, %list_Delete.exit.i99 ]
  %21 = getelementptr i8, ptr %Renamings.addr.0243.i, i64 8
  %Renamings.addr.0.val178.i = load ptr, ptr %21, align 8
  %Renamings.addr.0.val.i = load ptr, ptr %Renamings.addr.0243.i, align 8
...
sw.bb28.i:                                        ; preds = %if.end19.i
  ...
  %call30.i103 = tail call ptr @term_Copy(ptr noundef %call21.i) #10
  ...
  store ptr %call30.i103, ptr %car.i195.i, align 8
...
sw.epilog.i:                                      ; preds = %sw.bb34.i, %sw.bb28.i, %sw.bb.i, %if.end19.i
  %DefTerm.1.i = phi ptr [ %DefTerm.0242.i, %if.end19.i ], [ %call39.i, %sw.bb34.i ], [ %call33.i, %sw.bb28.i ], [ %call27.i, %sw.bb.i ]
...
if.end49.i:                                       ; preds = %if.then44.i, %sw.epilog.i
  ...
  %cmp.i.not.i.i87 = icmp eq ptr %call4.val.i, null
  br i1 %cmp.i.not.i.i87, label %list_Nconc.exit.i93, label %for.cond.i.i88

for.cond.i.i88:                                   ; preds = %if.end49.i, %for.cond.i.i88
  %List1.addr.0.i.i89 = phi ptr [ %List1.addr.0.val17.i.i90, %for.cond.i.i88 ], [ %call4.val.i, %if.end49.i ]
  ...
  br i1 %cmp.i20.not.i.i91, label %for.end.i.i92, label %for.cond.i.i88

for.end.i.i92:                                    ; preds = %for.cond.i.i88
  store ptr %call.i.i206.i, ptr %List1.addr.0.i.i89, align 8
  br label %list_Nconc.exit.i93

list_Nconc.exit.i93:                              ; preds = %for.end.i.i92, %if.end49.i
  %retval.0.i.i = phi ptr [ %call4.val.i, %for.end.i.i92 ], [ %call.i.i206.i, %if.end49.i ]
...
if.then55.i:                                      ; preds = %list_Nconc.exit.i93
...
for.cond.i:                                       ; preds = %for.body.i101, %if.then55.i
  %Args.0.in.i = phi ptr [ %34, %if.then55.i ], [ %Args.0.i, %for.body.i101 ]
  %Args.0.i = load ptr, ptr %Args.0.in.i, align 8
  %cmp.i209.not.i = icmp eq ptr %Args.0.i, null
  br i1 %cmp.i209.not.i, label %if.end66.i, label %for.body.i101

for.body.i101:                                    ; preds = %for.cond.i
  %35 = getelementptr i8, ptr %Args.0.i, i64 8
  %Args.0.val177.i = load ptr, ptr %35, align 8
  %cmp.i102 = icmp eq ptr %Args.0.val177.i, %Hit.0.i
  br i1 %cmp.i102, label %if.then62.i, label %for.cond.i

if.then62.i:                                      ; preds = %for.body.i101
  %36 = getelementptr i8, ptr %Args.0.i, i64 8
  store ptr %call21.i, ptr %36, align 8
  br label %if.end66.i

if.else65.i:                                      ; preds = %list_Nconc.exit.i93
...
if.then80.i:                                      ; preds = %for.body72.i
  ...
  br i1 %cmp2.i.i, label %while.body.i.i100.preheader, label %while.end.i.i

while.body.i.i100.preheader:                      ; preds = %if.then80.i
  %xtraiter = and i32 %.pr.i.i, 1
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %while.body.i.i100.prol.loopexit, label %while.body.i.i100.prol

while.body.i.i100.prol:                           ; preds = %while.body.i.i100.preheader
  ...
  br label %while.body.i.i100.prol.loopexit

while.body.i.i100.prol.loopexit:                  ; preds = %while.body.i.i100.prol, %while.body.i.i100.preheader
  %.unr = phi i32 [ %.pr.i.i, %while.body.i.i100.preheader ], [ %dec.i.i.i.i.prol, %while.body.i.i100.prol ]
  %47 = icmp eq i32 %.pr.i.i, 1
  br i1 %47, label %while.end.i.i, label %while.body.i.i100
...
while.body.i.i100:                                ; preds = %while.body.i.i100.prol.loopexit, %while.body.i.i100
  %57 = phi i32 [ %dec.i.i.i.i.1, %while.body.i.i100 ], [ %.unr, %while.body.i.i100.prol.loopexit ]
  ...
  %cmp.i219.i.1 = icmp ugt i32 %dec.i.i.i.i, 1
  br i1 %cmp.i219.i.1, label %while.body.i.i100, label %while.end.i.i

while.end.i.i:                                    ; preds = %while.body.i.i100.prol.loopexit, %while.body.i.i100, %if.then80.i
  %64 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i215.i = icmp eq i32 %64, 0
  br i1 %cmp.i.not.i215.i, label %cont_BackTrack.exit.i, label %if.then.i.i

if.then.i.i:                                      ; preds = %while.end.i.i
  %dec.i.i.i = add nsw i32 %64, -1
  store i32 %dec.i.i.i, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i216.i = sext i32 %dec.i.i.i to i64
  %arrayidx.i.i217.i = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i216.i
  %65 = load i32, ptr %arrayidx.i.i217.i, align 4
...
for.body94.i:                                     ; preds = %for.cond90.i
  ...
  br i1 %cmp96.i, label %if.then98.i, label %for.cond90.i
...
for.inc103.i:                                     ; preds = %for.cond90.i, %if.then98.i
  ...
  br i1 %cmp.i212.not.i, label %for.end105.i, label %for.body72.i

for.end105.i:                                     ; preds = %for.inc103.i
  %call7.val.pre.i = load ptr, ptr %37, align 8
  %cmp.i.not.i224.i = icmp eq ptr %call7.val.pre.i, null
  br i1 %cmp.i.not.i224.i, label %list_Nconc.exit233.i, label %if.end.i225.i

if.end.i225.i:                                    ; preds = %for.end105.i
  %cmp.i18.not.i226.i = icmp eq ptr %AllMatches.0244.i, null
  br i1 %cmp.i18.not.i226.i, label %list_Nconc.exit233.i, label %for.cond.i227.i

for.cond.i227.i:                                  ; preds = %if.end.i225.i, %for.cond.i227.i
  %List1.addr.0.i228.i = phi ptr [ %List1.addr.0.val17.i229.i, %for.cond.i227.i ], [ %call7.val.pre.i, %if.end.i225.i ]
  %List1.addr.0.val17.i229.i = load ptr, ptr %List1.addr.0.i228.i, align 8
  %cmp.i20.not.i230.i = icmp eq ptr %List1.addr.0.val17.i229.i, null
  br i1 %cmp.i20.not.i230.i, label %for.end.i231.i, label %for.cond.i227.i

for.end.i231.i:                                   ; preds = %for.cond.i227.i
  store ptr %AllMatches.0244.i, ptr %List1.addr.0.i228.i, align 8
  br label %list_Nconc.exit233.i

list_Nconc.exit233.i:                             ; preds = %for.end.i231.i, %if.end.i225.i, %for.end105.i, %if.end66.i
  %retval.0.i232.i = phi ptr [ %call7.val.pre.i, %for.end.i231.i ], [ %AllMatches.0244.i, %for.end105.i ], [ %call7.val.pre.i, %if.end.i225.i ], [ %AllMatches.0244.i, %if.end66.i ]
  store ptr null, ptr %37, align 8
  br i1 %cmp.i201.not.i, label %list_Delete.exit.i99, label %while.body.i234.i

while.body.i234.i:                                ; preds = %list_Nconc.exit233.i, %while.body.i234.i
  %Current.06.i.i94 = phi ptr [ %Current.0.val.i.i95, %while.body.i234.i ], [ %call11.i, %list_Nconc.exit233.i ]
  ...
  %total_size.i.i.i.i96 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %69, i64 0, i32 4
  %70 = load i32, ptr %total_size.i.i.i.i96, align 8
  %conv26.i.i.i.i97 = sext i32 %70 to i64
  %71 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i98 = add i64 %71, %conv26.i.i.i.i97
  store i64 %add27.i.i.i.i98, ptr @memory_FREEDBYTES, align 8
  %72 = load ptr, ptr %69, align 8
  store ptr %72, ptr %Current.06.i.i94, align 8
  %73 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i94, ptr %73, align 8
  %cmp.i.not.i235.i = icmp eq ptr %Current.0.val.i.i95, null
  br i1 %cmp.i.not.i235.i, label %list_Delete.exit.i99, label %while.body.i234.i

list_Delete.exit.i99:                             ; preds = %while.body.i234.i, %list_Nconc.exit233.i
  %cmp.i185.not.i = icmp eq ptr %Renamings.addr.0.val.i, null
  br i1 %cmp.i185.not.i, label %ren_FormulaRename.exit, label %while.body.i

ren_FormulaRename.exit:                           ; preds = %list_Delete.exit.i99
...
if.end46:                                         ; preds = %if.end37, %if.then43, %ren_FormulaRename.exit
  %retval.0.i121 = phi ptr [ %call4.i, %if.then43 ], [ %call4.i, %ren_FormulaRename.exit ], [ %Term, %if.end37 ]
...
while.body.i106:                                  ; preds = %if.end46, %while.body.i106
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i106 ], [ %call3, %if.end46 ]
  ...
  %cmp.i.not.i107 = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i107, label %list_Delete.exit, label %while.body.i106

list_Delete.exit:                                 ; preds = %while.body.i106, %if.end46
  ret ptr %retval.0.i121
}
...
for.body:                                         ; preds = %if.else, %for.body
  ...
  br i1 %cmp.i21.not, label %if.end11, label %for.body
...
for.body:                                         ; preds = %if.then32, %list_Nconc.exit147
  ...
  br i1 %cmp.i.not.i138, label %list_Nconc.exit147, label %if.end.i139

if.end.i139:                                      ; preds = %for.body
  %cmp.i18.not.i140 = icmp eq ptr %call37, null
  br i1 %cmp.i18.not.i140, label %list_Nconc.exit147, label %for.cond.i141

for.cond.i141:                                    ; preds = %if.end.i139, %for.cond.i141
  %List1.addr.0.i142 = phi ptr [ %List1.addr.0.val17.i143, %for.cond.i141 ], [ %Result.1208, %if.end.i139 ]
...
list_Nconc.exit147:                               ; preds = %for.body, %if.end.i139, %for.end.i145
  %retval.0.i146 = phi ptr [ %Result.1208, %for.end.i145 ], [ %call37, %for.body ], [ %Result.1208, %if.end.i139 ]
  %Scan.0 = load ptr, ptr %Scan.0209, align 8
  %cmp.i136.not = icmp eq ptr %Scan.0, null
  br i1 %cmp.i136.not, label %cleanup, label %for.body
...
if.then44:                                        ; preds = %if.else40
  ...
  br i1 %cmp.i.not.i150, label %list_Nconc.exit159, label %if.end.i151

if.end.i151:                                      ; preds = %if.then44
  %cmp.i18.not.i152 = icmp eq ptr %call47, null
  br i1 %cmp.i18.not.i152, label %list_Nconc.exit159, label %for.cond.i153

for.cond.i153:                                    ; preds = %if.end.i151, %for.cond.i153
  %List1.addr.0.i154 = phi ptr [ %List1.addr.0.val17.i155, %for.cond.i153 ], [ %Result.0, %if.end.i151 ]
  %List1.addr.0.val17.i155 = load ptr, ptr %List1.addr.0.i154, align 8
  %cmp.i20.not.i156 = icmp eq ptr %List1.addr.0.val17.i155, null
  br i1 %cmp.i20.not.i156, label %for.end.i157, label %for.cond.i153

for.end.i157:                                     ; preds = %for.cond.i153
  store ptr %call47, ptr %List1.addr.0.i154, align 8
  br label %list_Nconc.exit159

list_Nconc.exit159:                               ; preds = %if.then44, %if.end.i151, %for.end.i157
  %retval.0.i158 = phi ptr [ %Result.0, %for.end.i157 ], [ %call47, %if.then44 ], [ %Result.0, %if.end.i151 ]
  ...
  br i1 %cmp.i.not.i160, label %cleanup, label %if.end.i161

if.end.i161:                                      ; preds = %list_Nconc.exit159
  %cmp.i18.not.i162 = icmp eq ptr %call50, null
  br i1 %cmp.i18.not.i162, label %cleanup, label %for.cond.i163

for.cond.i163:                                    ; preds = %if.end.i161, %for.cond.i163
  %List1.addr.0.i164 = phi ptr [ %List1.addr.0.val17.i165, %for.cond.i163 ], [ %retval.0.i158, %if.end.i161 ]
...
if.then56:                                        ; preds = %if.else52
  ...
  br i1 %cmp.i.not.i172, label %list_Nconc.exit181, label %if.end.i173

if.end.i173:                                      ; preds = %if.then56
  %cmp.i18.not.i174 = icmp eq ptr %call58, null
  br i1 %cmp.i18.not.i174, label %list_Nconc.exit181, label %for.cond.i175

for.cond.i175:                                    ; preds = %if.end.i173, %for.cond.i175
  %List1.addr.0.i176 = phi ptr [ %List1.addr.0.val17.i177, %for.cond.i175 ], [ %Result.0, %if.end.i173 ]
  %List1.addr.0.val17.i177 = load ptr, ptr %List1.addr.0.i176, align 8
  %cmp.i20.not.i178 = icmp eq ptr %List1.addr.0.val17.i177, null
  br i1 %cmp.i20.not.i178, label %for.end.i179, label %for.cond.i175

for.end.i179:                                     ; preds = %for.cond.i175
  store ptr %call58, ptr %List1.addr.0.i176, align 8
  br label %list_Nconc.exit181

list_Nconc.exit181:                               ; preds = %if.then56, %if.end.i173, %for.end.i179
  %retval.0.i180 = phi ptr [ %Result.0, %for.end.i179 ], [ %call58, %if.then56 ], [ %Result.0, %if.end.i173 ]
  ...
  br i1 %cmp.i.not.i182, label %cleanup, label %if.end.i183

if.end.i183:                                      ; preds = %list_Nconc.exit181
  %cmp.i18.not.i184 = icmp eq ptr %call61, null
  br i1 %cmp.i18.not.i184, label %cleanup, label %for.cond.i185

for.cond.i185:                                    ; preds = %if.end.i183, %for.cond.i185
  %List1.addr.0.i186 = phi ptr [ %List1.addr.0.val17.i187, %for.cond.i185 ], [ %retval.0.i180, %if.end.i183 ]
...
cleanup:                                          ; preds = %list_Nconc.exit147, %if.then32, %for.end.i189, %if.end.i183, %list_Nconc.exit181, %for.end.i167, %if.end.i161, %list_Nconc.exit159, %for.end.i, %if.end.i, %if.then22, %term_IsAtom.exit
  %retval.0 = phi ptr [ null, %term_IsAtom.exit ], [ %Result.0, %for.end.i ], [ %call24, %if.then22 ], [ %Result.0, %if.end.i ], [ %retval.0.i158, %for.end.i167 ], [ %call50, %list_Nconc.exit159 ], [ %retval.0.i158, %if.end.i161 ], [ %retval.0.i180, %for.end.i189 ], [ %call61, %list_Nconc.exit181 ], [ %retval.0.i180, %if.end.i183 ], [ %Result.0, %if.then32 ], [ %retval.0.i146, %list_Nconc.exit147 ]
  ret ptr %retval.0
}
...
land.rhs:                                         ; preds = %while.cond
  ...
  br i1 %tobool10.not, label %while.end, label %while.cond
...
if.end6.i.i:                                      ; preds = %while.body.i.i
  ...
  br i1 %cmp.not.i.i, label %lor.rhs.i, label %while.body.i.i
...
while.body.lr.ph.i185.i:                          ; preds = %lor.rhs.i
  ...
  br label %while.body.i186.i

while.body.i186.i:                                ; preds = %if.end6.i191.i, %while.body.lr.ph.i185.i
  %n.addr.03.i187.i = phi i32 [ 2, %while.body.lr.ph.i185.i ], [ %n.addr.1.i192.i, %if.end6.i191.i ]
  %Term2.addr.02.i188.i = phi ptr [ %Term2.val182.i, %while.body.lr.ph.i185.i ], [ %Term2.addr.0.val12.i193.i, %if.end6.i191.i ]
  %Term2.addr.0.val.i189.i = load i32, ptr %Term2.addr.02.i188.i, align 8
  %cmp.i.not.i190.i = icmp eq i32 %Term2.addr.0.val.i189.i, %14
  br i1 %cmp.i.not.i190.i, label %if.then.i196.i, label %if.end6.i191.i

if.then.i196.i:                                   ; preds = %while.body.i186.i
  %cmp4.i197.i = icmp eq i32 %n.addr.03.i187.i, 1
  br i1 %cmp4.i197.i, label %if.else, label %if.end6.i191.i

if.end6.i191.i:                                   ; preds = %if.then.i196.i, %while.body.i186.i
  %n.addr.1.i192.i = phi i32 [ 1, %if.then.i196.i ], [ %n.addr.03.i187.i, %while.body.i186.i ]
  %15 = getelementptr i8, ptr %Term2.addr.02.i188.i, i64 8
  %Term2.addr.0.val12.i193.i = load ptr, ptr %15, align 8
  %cmp.not.i194.i = icmp eq ptr %Term2.addr.0.val12.i193.i, %Father.0
  br i1 %cmp.not.i194.i, label %if.then18, label %while.body.i186.i
...
if.then18:                                        ; preds = %if.end6.i191.i, %lor.lhs.false71.i, %lor.rhs.i, %lor.rhs103.i, %lor.rhs85.i, %ren_HasNonZeroBenefit.exit, %while.end
...
while.body.i.i49:                                 ; preds = %if.then18, %while.body.i.i49
  %Current.06.i.i = phi ptr [ %Current.0.val.i.i, %while.body.i.i49 ], [ %25, %if.then18 ]
  %Current.0.val.i.i = load ptr, ptr %Current.06.i.i, align 8
  ...
  %cmp.i.not.i.i50 = icmp eq ptr %Current.0.val.i.i, null
  br i1 %cmp.i.not.i.i50, label %ren_Delete.exit, label %while.body.i.i49
...
if.else:                                          ; preds = %while.body.i.i, %if.then.i196.i, %land.lhs.true98.i, %land.lhs.true80.i, %lor.lhs.false37.i, %land.lhs.true30.i, %land.lhs.true47.i, %land.lhs.true52.i, %land.lhs.true57.i, %land.lhs.true62.i, %land.lhs.true66.i, %ren_HasNonZeroBenefit.exit
...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %tobool46.not, label %for.cond, label %cleanup51
...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %tobool39.not, label %for.cond, label %cleanup44
...
for.inc:                                          ; preds = %for.body, %land.lhs.true
  ...
  br i1 %cmp.i132.not, label %tailrecurse.backedge, label %for.body
...
for.inc:                                          ; preds = %lor.lhs.false83, %for.body
  ...
  br i1 %cmp.i148.not, label %cleanup92, label %for.body
...
for.inc:                                          ; preds = %lor.lhs.false28, %for.body, %land.lhs.true
  ...
  br i1 %cmp.i208.not, label %for.end, label %for.body
...
for.inc:                                          ; preds = %lor.lhs.false76, %for.body
  ...
  br i1 %cmp.i134.not, label %cleanup86, label %for.body
...
for.inc78:                                        ; preds = %lor.lhs.false71, %for.body65
  ...
  br i1 %cmp.i234.not, label %cleanup, label %for.body65
...
for.inc:                                          ; preds = %lor.lhs.false28, %for.body, %land.lhs.true
  ...
  br i1 %cmp.i247.not, label %for.end, label %for.body
...
ren_Delete.exit.i:                                ; preds = %if.then.i
  %3 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 24), align 8
  ...
  store ptr %6, ptr %Scan.0.val24.i, align 8
  %7 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 24), align 8
  store ptr %Scan.0.val24.i, ptr %7, align 8
...
for.inc.i:                                        ; preds = %if.else7.i, %if.else.i, %ren_Delete.exit.i
  ...
  br i1 %cmp.i.not.i, label %ren_RemoveTerm.exit, label %for.body.i
...
if.then:                                          ; preds = %ren_RemoveTerm.exit, %symbol_IsPredicate.exit
  ...
  %cmp.i.not.i30 = icmp ne i32 %8, %Term.val25
  %9 = load i32, ptr @fol_EXIST, align 4
  %cmp.i4.i = icmp ne i32 %9, %Term.val25
  %narrow.i.not = select i1 %cmp.i.not.i30, i1 %cmp.i4.i, i1 false
  %10 = getelementptr i8, ptr %Term.tr, i64 16
  %Scan.037 = load ptr, ptr %10, align 8
  br i1 %narrow.i.not, label %if.else, label %if.then6

if.then6:                                         ; preds = %if.then
  %Term.val27.val = load ptr, ptr %Scan.037, align 8
  %11 = getelementptr i8, ptr %Term.val27.val, i64 8
  %Term.val27.val.val = load ptr, ptr %11, align 8
  br label %tailrecurse
...
for.body:                                         ; preds = %if.else, %for.body
  ...
  %12 = getelementptr i8, ptr %Scan.040, i64 8
  %Scan.0.val26 = load ptr, ptr %12, align 8
  ...
  br i1 %cmp.i31.not, label %if.end15, label %for.body
