; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/iaparser.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/iaparser.c"
...
if.else.i:                                        ; preds = %for.body.i
  ...
  br i1 %cmp.i.not.i145.i, label %list_Nconc.exit154.i, label %for.cond.i148.i

for.cond.i148.i:                                  ; preds = %if.else.i, %for.cond.i148.i
  %List1.addr.0.i149.i = phi ptr [ %List1.addr.0.val17.i150.i, %for.cond.i148.i ], [ %varlist.0227.i, %if.else.i ]
  ...
  br i1 %cmp.i20.not.i151.i, label %for.end.i152.i, label %for.cond.i148.i

for.end.i152.i:                                   ; preds = %for.cond.i148.i
  store ptr %call.i.i143.i, ptr %List1.addr.0.i149.i, align 8
...
list_Nconc.exit154.i:                             ; preds = %for.end.i152.i, %if.else.i
  ...
  br i1 %cmp.i.not.i157.i, label %for.inc.i, label %for.cond.i160.i

for.cond.i160.i:                                  ; preds = %list_Nconc.exit154.i, %for.cond.i160.i
  %List1.addr.0.i161.i = phi ptr [ %List1.addr.0.val17.i162.i, %for.cond.i160.i ], [ %sortlist.0228.i, %list_Nconc.exit154.i ]
  ...
  br i1 %cmp.i20.not.i163.i, label %for.end.i164.i, label %for.cond.i160.i

for.end.i164.i:                                   ; preds = %for.cond.i160.i
  store ptr %call.i.i155.i, ptr %List1.addr.0.i161.i, align 8
  br label %for.inc.i
...
for.inc.i:                                        ; preds = %for.end.i164.i, %list_Nconc.exit154.i, %list_Nconc.exit.i
  ...
  br i1 %cmp.i.not.i692, label %for.end.i693, label %for.body.i
...
for.body21.i:                                     ; preds = %for.end.i693, %for.body21.i
  ...
  br i1 %cmp.i167.not.i, label %for.end27.i, label %for.body21.i
...
for.body44.i:                                     ; preds = %if.then34.i, %for.body44.i
  %scan.1233.i = phi ptr [ %scan.1.val.i, %for.body44.i ], [ %sortlist.0.lcssa.i, %if.then34.i ]
  %58 = load i32, ptr @fol_NOT, align 4
  %59 = getelementptr i8, ptr %scan.1233.i, i64 8
  ...
  %scan.1.val.i = load ptr, ptr %scan.1233.i, align 8
  %cmp.i175.not.i = icmp eq ptr %scan.1.val.i, null
  br i1 %cmp.i175.not.i, label %for.end51.i, label %for.body44.i

for.end51.i:                                      ; preds = %for.body44.i
  %60 = getelementptr i8, ptr %42, i64 16
  %Term.val142.i = load ptr, ptr %60, align 8
  %cmp.i18.not.i182.i = icmp eq ptr %Term.val142.i, null
  br i1 %cmp.i18.not.i182.i, label %list_Nconc.exit189.i, label %for.cond.i183.i

for.cond.i183.i:                                  ; preds = %for.end51.i, %for.cond.i183.i
  %List1.addr.0.i184.i = phi ptr [ %List1.addr.0.val17.i185.i, %for.cond.i183.i ], [ %sortlist.0.lcssa.i, %for.end51.i ]
  ...
  br i1 %cmp.i20.not.i186.i, label %for.end.i187.i, label %for.cond.i183.i

for.end.i187.i:                                   ; preds = %for.cond.i183.i
  store ptr %Term.val142.i, ptr %List1.addr.0.i184.i, align 8
  br label %list_Nconc.exit189.i

list_Nconc.exit189.i:                             ; preds = %for.end.i187.i, %for.end51.i
...
if.then75.i:                                      ; preds = %if.else71.i
  ...
  br i1 %cmp.i199.not.i, label %if.then80.i, label %if.else83.i

if.then80.i:                                      ; preds = %if.then75.i
  %66 = getelementptr i8, ptr %42, i64 16
  %Term.val141.i = load ptr, ptr %66, align 8
  %cmp.i18.not.i203.i = icmp eq ptr %Term.val141.i, null
  br i1 %cmp.i18.not.i203.i, label %list_Nconc.exit210.i, label %for.cond.i204.i

for.cond.i204.i:                                  ; preds = %if.then80.i, %for.cond.i204.i
  %List1.addr.0.i205.i = phi ptr [ %List1.addr.0.val17.i206.i, %for.cond.i204.i ], [ %sortlist.0.lcssa.i, %if.then80.i ]
  ...
  br i1 %cmp.i20.not.i207.i, label %for.end.i208.i, label %for.cond.i204.i

for.end.i208.i:                                   ; preds = %for.cond.i204.i
  store ptr %Term.val141.i, ptr %List1.addr.0.i205.i, align 8
  br label %list_Nconc.exit210.i

list_Nconc.exit210.i:                             ; preds = %for.end.i208.i, %if.then80.i
...
if.else83.i:                                      ; preds = %if.then75.i
  ...
  br label %for.cond.i217.i

for.cond.i217.i:                                  ; preds = %for.cond.i217.i, %if.else83.i
  %List1.addr.0.i218.i = phi ptr [ %List1.addr.0.val17.i219.i, %for.cond.i217.i ], [ %sortlist.0.lcssa.i, %if.else83.i ]
  ...
  br i1 %cmp.i20.not.i220.i, label %for.end.i221.i, label %for.cond.i217.i

for.end.i221.i:                                   ; preds = %for.cond.i217.i
  store ptr %call.i.i212.i, ptr %List1.addr.0.i218.i, align 8
  %67 = load i32, ptr @fol_AND, align 4
  %call87.i = call ptr @term_Create(i32 noundef %67, ptr noundef nonnull %sortlist.0.lcssa.i) #13
  br label %ia_CreateQuantifier.exit

ia_CreateQuantifier.exit:                         ; preds = %for.end27.i, %list_Nconc.exit189.i, %if.then58.i, %if.else62.i, %if.else71.i, %list_Nconc.exit210.i, %for.end.i221.i
  %Term.addr.0.i = phi ptr [ %42, %for.end27.i ], [ %42, %list_Nconc.exit189.i ], [ %call61.i, %if.then58.i ], [ %call68.i, %if.else62.i ], [ %42, %list_Nconc.exit210.i ], [ %call87.i, %for.end.i221.i ], [ %42, %if.else71.i ]
...
sw.bb202:                                         ; preds = %yyreduce
  ...
  br i1 %cmp.i.not.i704, label %sw.epilog, label %for.cond.i707

for.cond.i707:                                    ; preds = %sw.bb202, %for.cond.i707
  %List1.addr.0.i708 = phi ptr [ %List1.addr.0.val17.i709, %for.cond.i707 ], [ %102, %sw.bb202 ]
  %List1.addr.0.val17.i709 = load ptr, ptr %List1.addr.0.i708, align 8
  %cmp.i20.not.i710 = icmp eq ptr %List1.addr.0.val17.i709, null
  br i1 %cmp.i20.not.i710, label %for.end.i711, label %for.cond.i707

for.end.i711:                                     ; preds = %for.cond.i707
  store ptr %call.i.i702, ptr %List1.addr.0.i708, align 8
  br label %sw.epilog
...
sw.bb246:                                         ; preds = %yyreduce
  ...
  br i1 %cmp.i.not.i745, label %sw.epilog, label %for.cond.i748

for.cond.i748:                                    ; preds = %sw.bb246, %for.cond.i748
  %List1.addr.0.i749 = phi ptr [ %List1.addr.0.val17.i750, %for.cond.i748 ], [ %136, %sw.bb246 ]
  %List1.addr.0.val17.i750 = load ptr, ptr %List1.addr.0.i749, align 8
  %cmp.i20.not.i751 = icmp eq ptr %List1.addr.0.val17.i750, null
  br i1 %cmp.i20.not.i751, label %for.end.i752, label %for.cond.i748

for.end.i752:                                     ; preds = %for.cond.i748
  store ptr %call.i.i743, ptr %List1.addr.0.i749, align 8
  br label %sw.epilog
...
for.inc:                                          ; preds = %for.body, %if.then325
  ...
  br i1 %cmp314, label %for.body, label %for.end.loopexit

for.end.loopexit:                                 ; preds = %for.inc
  %155 = add i64 %yysize297.1, 25
  %156 = icmp slt i32 %yycount.1, 5
  br label %for.end

for.end:                                          ; preds = %for.end.loopexit, %cond.end305
  %yysize297.0.lcssa = phi i64 [ 25, %cond.end305 ], [ %155, %for.end.loopexit ]
  %yycount.0.lcssa = phi i1 [ true, %cond.end305 ], [ %156, %for.end.loopexit ]
  %arrayidx336 = getelementptr inbounds [40 x ptr], ptr @yytname, i64 0, i64 %cond306
  %157 = load ptr, ptr %arrayidx336, align 8
  %call337 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %157) #15
  %add338 = add i64 %yysize297.0.lcssa, %call337
  %158 = alloca i8, i64 %add338, align 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(25) %158, ptr noundef nonnull align 1 dereferenceable(25) @.str.4, i64 25, i1 false)
  %scevgep = getelementptr i8, ptr %158, i64 24
  br label %while.cond.i755

while.cond.i755:                                  ; preds = %for.end, %while.cond.i755
  %yyd.0.i756 = phi ptr [ %incdec.ptr1.i759, %while.cond.i755 ], [ %scevgep, %for.end ]
  %yys.0.i757 = phi ptr [ %incdec.ptr.i758, %while.cond.i755 ], [ %157, %for.end ]
  %incdec.ptr.i758 = getelementptr inbounds i8, ptr %yys.0.i757, i64 1
  %159 = load i8, ptr %yys.0.i757, align 1
  %incdec.ptr1.i759 = getelementptr inbounds i8, ptr %yyd.0.i756, i64 1
  store i8 %159, ptr %yyd.0.i756, align 1
  %cmp.not.i760 = icmp eq i8 %159, 0
  br i1 %cmp.not.i760, label %yystpcpy.exit761, label %while.cond.i755

yystpcpy.exit761:                                 ; preds = %while.cond.i755
  %or.cond847 = and i1 %yycount.0.lcssa, %cmp314838
  br i1 %or.cond847, label %for.body359.preheader, label %if.end381

for.body359.preheader:                            ; preds = %yystpcpy.exit761
  %160 = sext i32 %cond313 to i64
  %161 = sext i8 %2 to i64
  br label %for.body359

for.body359:                                      ; preds = %for.body359.preheader, %for.inc378
  %indvars.iv885 = phi i64 [ %160, %for.body359.preheader ], [ %indvars.iv.next886, %for.inc378 ]
  %yyp.0846 = phi ptr [ %yyd.0.i756, %for.body359.preheader ], [ %yyp.1, %for.inc378 ]
  %yycount.2845 = phi i32 [ 0, %for.body359.preheader ], [ %yycount.3, %for.inc378 ]
  %162 = add nsw i64 %indvars.iv885, %161
  %arrayidx362 = getelementptr inbounds [84 x i8], ptr @yycheck, i64 0, i64 %162
  %163 = load i8, ptr %arrayidx362, align 1
  %conv363 = sext i8 %163 to i32
  %164 = trunc i64 %indvars.iv885 to i32
  %cmp364 = icmp eq i32 %164, %conv363
  %165 = icmp ne i64 %indvars.iv885, 1
  %or.cond480 = and i1 %165, %cmp364
...
if.then369:                                       ; preds = %for.body359
  ...
  br label %while.cond.i762

while.cond.i762:                                  ; preds = %while.cond.i762, %if.then369
  %yyd.0.i763 = phi ptr [ %yyp.0846, %if.then369 ], [ %incdec.ptr1.i766, %while.cond.i762 ]
  %yys.0.i764 = phi ptr [ %cond371, %if.then369 ], [ %incdec.ptr.i765, %while.cond.i762 ]
  %incdec.ptr.i765 = getelementptr inbounds i8, ptr %yys.0.i764, i64 1
  %166 = load i8, ptr %yys.0.i764, align 1
  %incdec.ptr1.i766 = getelementptr inbounds i8, ptr %yyd.0.i763, i64 1
  store i8 %166, ptr %yyd.0.i763, align 1
  %cmp.not.i767 = icmp eq i8 %166, 0
  br i1 %cmp.not.i767, label %yystpcpy.exit768, label %while.cond.i762

yystpcpy.exit768:                                 ; preds = %while.cond.i762
  %arrayidx374 = getelementptr inbounds [40 x ptr], ptr @yytname, i64 0, i64 %indvars.iv885
  %167 = load ptr, ptr %arrayidx374, align 8
  br label %while.cond.i769

while.cond.i769:                                  ; preds = %while.cond.i769, %yystpcpy.exit768
  %yyd.0.i770 = phi ptr [ %yyd.0.i763, %yystpcpy.exit768 ], [ %incdec.ptr1.i773, %while.cond.i769 ]
  %yys.0.i771 = phi ptr [ %167, %yystpcpy.exit768 ], [ %incdec.ptr.i772, %while.cond.i769 ]
  %incdec.ptr.i772 = getelementptr inbounds i8, ptr %yys.0.i771, i64 1
  %168 = load i8, ptr %yys.0.i771, align 1
  %incdec.ptr1.i773 = getelementptr inbounds i8, ptr %yyd.0.i770, i64 1
  store i8 %168, ptr %yyd.0.i770, align 1
  %cmp.not.i774 = icmp eq i8 %168, 0
  br i1 %cmp.not.i774, label %yystpcpy.exit775, label %while.cond.i769

yystpcpy.exit775:                                 ; preds = %while.cond.i769
...
for.inc378:                                       ; preds = %for.body359, %yystpcpy.exit775
  ...
  %yyp.1 = phi ptr [ %yyd.0.i770, %yystpcpy.exit775 ], [ %yyp.0846, %for.body359 ]
  %indvars.iv.next886 = add nsw i64 %indvars.iv885, 1
  %cmp357 = icmp slt i64 %indvars.iv885, 39
  br i1 %cmp357, label %for.body359, label %if.end381

if.end381:                                        ; preds = %for.inc378, %yystpcpy.exit761
  %169 = load ptr, ptr @stdout, align 8
  %call.i776 = call i32 @fflush(ptr noundef %169)
  %170 = load i32, ptr @dfg_LINENUMBER, align 4
  call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.10, i32 noundef %170, ptr noundef nonnull %158) #13
  %171 = load ptr, ptr @stderr, align 8
  %call.i.i777 = call i32 @fflush(ptr noundef %171)
  %172 = load ptr, ptr @stdout, align 8
  %call1.i.i = call i32 @fflush(ptr noundef %172)
  %173 = load ptr, ptr @stderr, align 8
  %call2.i.i = call i32 @fflush(ptr noundef %173)
  call void @exit(i32 noundef 1) #14
  unreachable

if.else387:                                       ; preds = %if.then287
  %174 = load ptr, ptr @stdout, align 8
  %call.i778 = call i32 @fflush(ptr noundef %174)
  %175 = load i32, ptr @dfg_LINENUMBER, align 4
  call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.10, i32 noundef %175, ptr noundef nonnull @.str.8) #13
  %176 = load ptr, ptr @stderr, align 8
  %call.i.i779 = call i32 @fflush(ptr noundef %176)
  %177 = load ptr, ptr @stdout, align 8
  %call1.i.i780 = call i32 @fflush(ptr noundef %177)
  %178 = load ptr, ptr @stderr, align 8
  %call2.i.i781 = call i32 @fflush(ptr noundef %178)
  call void @exit(i32 noundef 1) #14
  unreachable

yyoverflowlab:                                    ; preds = %if.then
  %179 = load ptr, ptr @stdout, align 8
  %call.i783 = call i32 @fflush(ptr noundef %179)
  %180 = load i32, ptr @dfg_LINENUMBER, align 4
  call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.10, i32 noundef %180, ptr noundef nonnull @.str.9) #13
  %181 = load ptr, ptr @stderr, align 8
  %call.i.i784 = call i32 @fflush(ptr noundef %181)
  %182 = load ptr, ptr @stdout, align 8
  %call1.i.i785 = call i32 @fflush(ptr noundef %182)
  %183 = load ptr, ptr @stderr, align 8
  %call2.i.i786 = call i32 @fflush(ptr noundef %183)
  call void @exit(i32 noundef 1) #14
  unreachable
...
land.rhs9.i:                                      ; preds = %while.cond6.i
  ...
  br i1 %cmp.i53.not.i, label %if.then.i14, label %while.cond6.i

while.end.i:                                      ; preds = %while.cond6.i
  %scan.0.i = load ptr, ptr %scan.065.i, align 8
  %cmp.i.not.not.i = icmp eq ptr %scan.0.i, null
  br i1 %cmp.i.not.not.i, label %if.else.i, label %while.body.i
...
ia_StringFree.exit.i:                             ; preds = %if.else25.i.i.i, %if.end23.i.i.i
  ...
  %53 = getelementptr i8, ptr %scan2.0.val.i, i64 8
...
if.then24.i:                                      ; preds = %if.else.i
  ...
  %54 = load i32, ptr @symbol_STANDARDVARCOUNTER, align 4
  ...
  %55 = load ptr, ptr @ia_VARLIST, align 8
  ...
  store ptr %call.i60.i, ptr %56, align 8
  br label %ia_VarLookup.exit

if.else31.i:                                      ; preds = %if.else.i
  %57 = load ptr, ptr @stdout, align 8
  %call32.i = tail call i32 @fflush(ptr noundef %57)
  %58 = load i32, ptr @dfg_LINENUMBER, align 4
  tail call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.55, i32 noundef %58, ptr noundef %Name) #13
  %59 = load ptr, ptr @stderr, align 8
  %call.i62.i = tail call i32 @fflush(ptr noundef %59)
  %60 = load ptr, ptr @stdout, align 8
  %call1.i.i17 = tail call i32 @fflush(ptr noundef %60)
  %61 = load ptr, ptr @stderr, align 8
  %call2.i.i18 = tail call i32 @fflush(ptr noundef %61)
  tail call void @exit(i32 noundef 1) #14
  unreachable

ia_VarLookup.exit:                                ; preds = %ia_StringFree.exit.i, %if.then24.i
  %symbol.0.in.i = phi ptr [ %symbol27.i, %if.then24.i ], [ %53, %ia_StringFree.exit.i ]
