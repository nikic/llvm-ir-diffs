; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/memory.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/memory.c"
...
@.str.26 = private unnamed_addr constant [57 x i8] c"/home/npopov/repos/llvm-test-suite/CTMark/SPASS/memory.c\00", align 1
...
if.end13:                                         ; preds = %if.then.if.end13_crit_edge, %if.else
  %conv14.pre-phi = phi i64 [ %.pre138, %if.then.if.end13_crit_edge ], [ %conv12, %if.else ]
...
if.then52:                                        ; preds = %if.else49
  ...
  %cmp54 = icmp ugt i32 %.pre, %conv53
  br i1 %cmp54, label %if.then56, label %if.else58

if.then56:                                        ; preds = %if.then52
  %24 = load ptr, ptr @stdout, align 8
  %call57 = tail call i32 @fflush(ptr noundef %24)
  tail call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str) #13
  tail call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.1) #13
  tail call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.9) #13
  %25 = load ptr, ptr @stderr, align 8
  %call.i130 = tail call i32 @fflush(ptr noundef %25)
  %26 = load ptr, ptr @stdout, align 8
  %call1.i131 = tail call i32 @fflush(ptr noundef %26)
  %27 = load ptr, ptr @stderr, align 8
  %call2.i132 = tail call i32 @fflush(ptr noundef %27)
  tail call void @exit(i32 noundef 1) #14
  unreachable

if.else58:                                        ; preds = %if.then52
  %conv59 = zext i32 %.pre to i64
...
if.end62:                                         ; preds = %if.else49.if.end62_crit_edge, %if.else58
  %conv63.pre-phi = phi i64 [ %.pre139, %if.else49.if.end62_crit_edge ], [ %conv59, %if.else58 ]
...
if.then67:                                        ; preds = %if.end62
  ...
  %call68 = tail call i32 @fflush(ptr noundef %28)
  tail call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str) #13
  tail call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.1) #13
  tail call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.10) #13
  %29 = load ptr, ptr @stderr, align 8
  %call.i134 = tail call i32 @fflush(ptr noundef %29)
  %30 = load ptr, ptr @stdout, align 8
  %call1.i135 = tail call i32 @fflush(ptr noundef %30)
  %31 = load ptr, ptr @stderr, align 8
  %call2.i136 = tail call i32 @fflush(ptr noundef %31)
  tail call void @exit(i32 noundef 1) #14
  unreachable
...
do.body:                                          ; preds = %for.body, %do.body
  ...
  br i1 %cmp2.not, label %do.end, label %do.body
...
for.body8:                                        ; preds = %for.end, %for.body8
  %thisblock.025 = phi ptr [ %6, %for.body8 ], [ %5, %for.end ]
  %next9 = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %thisblock.025, i64 0, i32 1
  %6 = load ptr, ptr %next9, align 8
  tail call void @free(ptr noundef nonnull %thisblock.025) #13
  %cmp7.not = icmp eq ptr %6, null
  br i1 %cmp7.not, label %for.end11, label %for.body8
...
while.cond:                                       ; preds = %while.cond, %for.body
  ...
  br i1 %cmp1.not, label %for.inc, label %while.cond
...
while.cond.1:                                     ; preds = %while.cond.1, %for.body.1
  ...
  br i1 %cmp1.not.1, label %for.inc.1, label %while.cond.1
...
while.body:                                       ; preds = %while.cond.preheader, %while.end
  %ActPage.061 = phi ptr [ %1, %while.cond.preheader ], [ %24, %while.end ]
  %18 = load ptr, ptr %ActPage.061, align 8
  %call11 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.36, ptr noundef nonnull %ActPage.061, ptr noundef %18)
  %add.ptr = getelementptr inbounds i8, ptr %ActPage.061, i64 8
  ...
  %add.ptr14 = getelementptr inbounds i8, ptr %ActPage.061, i64 %idx.ext13
...
for.body22:                                       ; preds = %for.body22, %while.body18
  ...
  br i1 %or.cond, label %for.body22, label %for.end
...
while.end:                                        ; preds = %for.end, %while.body
  %24 = load ptr, ptr %ActPage.061, align 8
  %.pr = load i32, ptr %24, align 4
  %cmp10.not = icmp eq i32 %.pr, -1
  br i1 %cmp10.not, label %while.end29, label %while.body

while.end29:                                      ; preds = %while.end
  tail call void @memory_PrintAllocatedBlocks(i32 noundef %6)
  tail call void @memory_PrintFreedBlocks(i32 noundef %6)
  br label %for.inc31

for.inc31:                                        ; preds = %while.end29, %if.then4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 1024
  br i1 %exitcond.not, label %for.end33, label %for.body
