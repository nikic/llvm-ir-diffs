; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/condensing.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/condensing.c"
...
for.cond4.loopexit:                               ; preds = %for.inc50, %for.cond8.preheader
  ...
  br i1 %cmp5, label %for.cond8.preheader, label %for.end54
...
if.else:                                          ; preds = %if.then
  br i1 %cmp2.i97, label %while.body.i104.preheader, label %while.end.i98

while.body.i104.preheader:                        ; preds = %if.else
  %xtraiter147 = and i32 %.pr.i96, 1
  %lcmp.mod148.not = icmp eq i32 %xtraiter147, 0
  br i1 %lcmp.mod148.not, label %while.body.i104.prol.loopexit, label %while.body.i104.prol

while.body.i104.prol:                             ; preds = %while.body.i104.preheader
  %44 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %44, ptr @cont_CURRENTBINDING, align 8
  %45 = getelementptr i8, ptr %44, i64 24
  %call.val.i.i.i105.prol = load ptr, ptr %45, align 8
  store ptr %call.val.i.i.i105.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i106.prol = getelementptr inbounds %struct.binding, ptr %44, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i106.prol, i8 0, i64 20, i1 false)
  %46 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i107.prol = getelementptr inbounds %struct.binding, ptr %46, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i107.prol, align 8
  %dec.i.i.i108.prol = add nsw i32 %.pr.i96, -1
  store i32 %dec.i.i.i108.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i104.prol.loopexit

while.body.i104.prol.loopexit:                    ; preds = %while.body.i104.prol, %while.body.i104.preheader
  %.unr149 = phi i32 [ %.pr.i96, %while.body.i104.preheader ], [ %dec.i.i.i108.prol, %while.body.i104.prol ]
  %47 = icmp eq i32 %.pr.i96, 1
  br i1 %47, label %while.end.i98, label %while.body.i104

while.body.i104:                                  ; preds = %while.body.i104.prol.loopexit, %while.body.i104
  %48 = phi i32 [ %dec.i.i.i108.1, %while.body.i104 ], [ %.unr149, %while.body.i104.prol.loopexit ]
  %49 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %49, ptr @cont_CURRENTBINDING, align 8
  %50 = getelementptr i8, ptr %49, i64 24
  %call.val.i.i.i105 = load ptr, ptr %50, align 8
  store ptr %call.val.i.i.i105, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i106 = getelementptr inbounds %struct.binding, ptr %49, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i106, i8 0, i64 20, i1 false)
  %51 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i107 = getelementptr inbounds %struct.binding, ptr %51, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i107, align 8
  %dec.i.i.i108 = add nsw i32 %48, -1
  store i32 %dec.i.i.i108, ptr @cont_BINDINGS, align 4
  %52 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %52, ptr @cont_CURRENTBINDING, align 8
  %53 = getelementptr i8, ptr %52, i64 24
  %call.val.i.i.i105.1 = load ptr, ptr %53, align 8
  store ptr %call.val.i.i.i105.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i106.1 = getelementptr inbounds %struct.binding, ptr %52, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i106.1, i8 0, i64 20, i1 false)
  %54 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i107.1 = getelementptr inbounds %struct.binding, ptr %54, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i107.1, align 8
  %dec.i.i.i108.1 = add nsw i32 %48, -2
  store i32 %dec.i.i.i108.1, ptr @cont_BINDINGS, align 4
  %cmp.i109.1 = icmp ugt i32 %dec.i.i.i108, 1
  br i1 %cmp.i109.1, label %while.body.i104, label %while.end.i98

while.end.i98:                                    ; preds = %while.body.i104.prol.loopexit, %while.body.i104, %if.else
  %55 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i99 = icmp eq i32 %55, 0
  br i1 %cmp.i.not.i99, label %for.inc50, label %if.then.i100

if.then.i100:                                     ; preds = %while.end.i98
  %dec.i.i101 = add nsw i32 %55, -1
  store i32 %dec.i.i101, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i102 = sext i32 %dec.i.i101 to i64
  %arrayidx.i.i103 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i102
  %56 = load i32, ptr %arrayidx.i.i103, align 4
  store i32 %56, ptr @cont_BINDINGS, align 4
  br label %for.inc50

for.inc50:                                        ; preds = %if.then.i100, %while.end.i98, %for.body12, %if.end45
  %i.2 = phi i32 [ %add, %if.end45 ], [ %i.1122, %for.body12 ], [ %i.1122, %while.end.i98 ], [ %i.1122, %if.then.i100 ]
  %indexlist.3 = phi ptr [ %indexlist.2, %if.end45 ], [ %indexlist.1123, %for.body12 ], [ %indexlist.1123, %while.end.i98 ], [ %indexlist.1123, %if.then.i100 ]
  %inc51 = add nsw i32 %i.2, 1
  %57 = load i32, ptr @vec_MAX, align 4
  %cmp10 = icmp slt i32 %inc51, %57
  br i1 %cmp10, label %for.body12, label %for.cond4.loopexit
