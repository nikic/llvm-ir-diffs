...
while.cond.i173:                                  ; preds = %while.cond.i173, %clause_LiteralAtom.exit169
  ...
  br i1 %cmp.not.i176, label %clause_LiteralGetIndex.exit178, label %while.cond.i173, !llvm.loop !5
...
while.body.i203:                                  ; preds = %list_Nconc.exit, %while.body.i203
  ...
  br i1 %cmp.i.not.i204, label %list_Delete.exit, label %while.body.i203, !llvm.loop !10
...
while.body.i206:                                  ; preds = %if.end80, %while.body.i206
  ...
  br i1 %cmp.i.not.i212, label %list_Delete.exit213, label %while.body.i206, !llvm.loop !10
...
while.body.i215:                                  ; preds = %list_Delete.exit213, %while.body.i215
  ...
  br i1 %cmp.i.not.i221, label %if.end81, label %while.body.i215, !llvm.loop !10
...
if.end.i379.i:                                    ; preds = %while.body.i375.i
  ...
  br i1 %cmp.i.not.i381.i, label %for.inc178.i, label %while.body.i375.i, !llvm.loop !17
...
while.body.i394.i:                                ; preds = %clause_GetLiteralAtom.exit393.i, %while.body.i394.i
  ...
  br i1 %cmp.i.not.i395.i, label %list_Delete.exit.i, label %while.body.i394.i, !llvm.loop !10
...
while.body.i397.i:                                ; preds = %list_Delete.exit.i, %while.body.i397.i
  ...
  br i1 %cmp.i.not.i403.i, label %list_Delete.exit404.i, label %while.body.i397.i, !llvm.loop !10
...
while.body.i406.i:                                ; preds = %list_Delete.exit404.i, %while.body.i406.i
  ...
  br i1 %cmp.i.not.i412.i, label %list_Delete.exit413.i, label %while.body.i406.i, !llvm.loop !10
...
while.body.i516.i:                                ; preds = %for.end180.i, %while.body.i516.i
  ...
  br i1 %cmp.i.not.i522.i, label %list_Delete.exit523.i, label %while.body.i516.i, !llvm.loop !10
...
while.body.i525.i:                                ; preds = %list_Delete.exit523.i, %while.body.i525.i
  ...
  br i1 %cmp.i.not.i531.i, label %list_Delete.exit532.i, label %while.body.i525.i, !llvm.loop !10
...
while.body.i534.i:                                ; preds = %list_Delete.exit532.i, %while.body.i534.i
  ...
  br i1 %cmp.i.not.i540.i, label %inf_BuildConstraintHyperResolvent.exit, label %while.body.i534.i, !llvm.loop !10
...
if.end.i.i80:                                     ; preds = %while.body.i.i77
  ...
  br i1 %cmp.i.not.i.i82, label %if.then30.i, label %while.body.i.i77, !llvm.loop !17
...
for.inc34.i:                                      ; preds = %for.inc.i, %if.then.i75, %term_IsAtom.exit.i, %for.body.i69
  ...
  br i1 %cmp.i.not.i74, label %inf_GetSortResolutionPartnerLits.exit, label %for.body.i69, !llvm.loop !26
...
while.body.i87:                                   ; preds = %list_Delete.exit, %while.body.i87
  ...
  br i1 %cmp.i.not.i93, label %cleanup, label %while.body.i87, !llvm.loop !10
...
while.cond.i209:                                  ; preds = %while.cond.i209, %clause_LiteralAtom.exit205
  ...
  br i1 %cmp.not.i212, label %clause_LiteralGetIndex.exit214, label %while.cond.i209, !llvm.loop !5
...
while.body.i248:                                  ; preds = %list_Nconc.exit, %while.body.i248
  ...
  br i1 %cmp.i.not.i249, label %list_Delete.exit, label %while.body.i248, !llvm.loop !10
...
while.body.i258:                                  ; preds = %if.end101, %while.body.i258
  ...
  br i1 %cmp.i.not.i264, label %list_Delete.exit265, label %while.body.i258, !llvm.loop !10
...
while.body.i267:                                  ; preds = %list_Delete.exit265, %while.body.i267
  ...
  br i1 %cmp.i.not.i273, label %if.end103, label %while.body.i267, !llvm.loop !10
...
while.body.i137:                                  ; preds = %list_Delete.exit, %while.body.i137
  ...
  br i1 %cmp.i.not.i143, label %cleanup, label %while.body.i137, !llvm.loop !10
...
for.cond.i.i106:                                  ; preds = %if.end.i.i104, %for.cond.i.i106
  ...
  br i1 %cmp.i20.not.i.i109, label %for.end.i.i110, label %for.cond.i.i106, !llvm.loop !9
...
sort_Intersect.exit.i:                            ; preds = %for.end.i.i.i, %if.end.i.i.i, %clause_LiteralPredicate.exit.i
  ...
  %Literals.addr.0.val12.i = load ptr, ptr %Literals.addr.016.i, align 8
  %cmp.i.not.i = icmp eq ptr %Literals.addr.0.val12.i, null
  br i1 %cmp.i.not.i, label %inf_GetSortFromLits.exit.loopexit, label %for.body.i, !llvm.loop !14
...
while.body.i:                                     ; preds = %list_Nconc.exit, %while.body.i
  ...
  br i1 %cmp.i.not.i114, label %while.body.i116, label %while.body.i, !llvm.loop !10
...
while.body.i116:                                  ; preds = %while.body.i, %while.body.i116
  ...
  br i1 %cmp.i.not.i122, label %for.inc39, label %while.body.i116, !llvm.loop !10
...
for.body.i188:                                    ; preds = %for.body.i188, %for.body.lr.ph.i
  ...
  br i1 %cmp.i.not.i189, label %inf_MakeClausesDisjoint.exit, label %for.body.i188, !llvm.loop !46
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  br i1 %cmp.i230.1, label %while.body.i, label %while.end.i, !llvm.loop !47
...
if.end80:                                         ; preds = %if.end80.sink.split, %if.then65
  ...
  br i1 %cmp.i202.not, label %if.end87, label %while.body, !llvm.loop !48
...
for.body.i237:                                    ; preds = %clause_GetLiteralAtom.exit.i, %for.body.i237
  ...
  br i1 %cmp.i.not.i238, label %for.end.i, label %for.body.i237, !llvm.loop !49
...
while.cond.i.i240:                                ; preds = %while.cond.i.i240, %for.body70.i
  ...
  br i1 %cmp.not.i.i242, label %clause_LiteralGetIndex.exit.i244, label %while.cond.i.i240, !llvm.loop !5
...
while.body.i447.i:                                ; preds = %for.end172.i, %while.body.i447.i
  ...
  br i1 %cmp.i.not.i448.i, label %list_Delete.exit.i, label %while.body.i447.i, !llvm.loop !10
...
while.body.i450.i:                                ; preds = %list_Delete.exit.i, %while.body.i450.i
  ...
  br i1 %cmp.i.not.i456.i, label %list_Delete.exit457.i, label %while.body.i450.i, !llvm.loop !10
...
while.body.i459.i:                                ; preds = %list_Delete.exit457.i, %while.body.i459.i
  ...
  br i1 %cmp.i.not.i465.i, label %while.body.lr.ph.i, label %while.body.i459.i, !llvm.loop !10
...
if.end.i338:                                      ; preds = %if.then.i336, %while.body.i334
  ...
  br i1 %cmp.i.not.i340, label %while.end.i341, label %while.body.i334, !llvm.loop !60
...
for.body.i343:                                    ; preds = %for.body.i343, %for.body.lr.ph.i342
  ...
  br i1 %cmp31.i, label %for.body.i343, label %while.body38.lr.ph.i, !llvm.loop !61

while.cond34.loopexit.i:                          ; preds = %for.body45.i, %while.body38.i
  %cmp.i105.not.i = icmp eq ptr %List.addr.0.val.i, null
  br i1 %cmp.i105.not.i, label %while.body.i469.i, label %while.body38.i, !llvm.loop !62
...
while.body.i469.i:                                ; preds = %while.cond34.loopexit.i, %while.body.i469.i
  ...
  br i1 %cmp.i.not.i475.i, label %if.end.i, label %while.body.i469.i, !llvm.loop !10
...
while.body.i266:                                  ; preds = %while.body.i266.prol.loopexit, %while.body.i266
  ...
  br i1 %cmp.i271.1, label %while.body.i266, label %while.end.i259, !llvm.loop !47
...
while.body.i289:                                  ; preds = %while.body.i289.prol.loopexit, %while.body.i289
  ...
  br i1 %cmp.i294.1, label %while.body.i289, label %while.end.i282, !llvm.loop !47
...
while.body.i304:                                  ; preds = %do.end, %while.body.i304
  ...
  br i1 %cmp.i.not.i308, label %if.end113, label %while.body.i304, !llvm.loop !10
...
for.body.i318:                                    ; preds = %sort_PairDelete.exit, %for.body.i318
  ...
  br i1 %cmp.i.not.i321, label %while.body.i324, label %for.body.i318, !llvm.loop !67
...
while.body.i324:                                  ; preds = %for.body.i318, %while.body.i324
  ...
  br i1 %cmp.i.not.i330, label %cleanup, label %while.body.i324, !llvm.loop !10
...
sort_Intersect.exit.i:                            ; preds = %for.end.i.i.i, %if.end.i.i.i, %clause_LiteralPredicate.exit.i112
  ...
  br i1 %cmp.i.not.i114, label %inf_GetSortFromLits.exit, label %for.body.i, !llvm.loop !14
...
for.cond.i.i140:                                  ; preds = %if.end.i.i138, %for.cond.i.i140
  ...
  br i1 %cmp.i20.not.i.i143, label %for.end.i.i144, label %for.cond.i.i140, !llvm.loop !9
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  br i1 %cmp.i156.1, label %while.body.i, label %while.end.i, !llvm.loop !47
...
while.body.i157:                                  ; preds = %while.body.i157.preheader, %while.body.i157
  ...
  br i1 %cmp.i.not.i158, label %list_Delete.exit, label %while.body.i157, !llvm.loop !10
...
list_Delete.exit:                                 ; preds = %while.body.i157
  ...
  br i1 %cmp.i119.not, label %while.body.i165.preheader, label %for.body20, !llvm.loop !69
...
while.body.i165:                                  ; preds = %while.body.i165.preheader, %while.body.i165
  ...
  br i1 %cmp.i.not.i171, label %list_Delete.exit173, label %while.body.i165, !llvm.loop !10
...
for.cond.i.i144:                                  ; preds = %if.end.i.i142, %for.cond.i.i144
  ...
  br i1 %cmp.i20.not.i.i147, label %for.end.i.i148, label %for.cond.i.i144, !llvm.loop !9
...
sort_Intersect.exit.i:                            ; preds = %for.end.i.i.i, %if.end.i.i.i, %clause_LiteralPredicate.exit.i
  ...
  br i1 %cmp.i.not.i151, label %inf_GetSortFromLits.exit.loopexit, label %for.body.i, !llvm.loop !14
...
while.body.i:                                     ; preds = %inf_GetSortFromLits.exit.loopexit, %while.body.i
  ...
  br i1 %cmp.i.not.i154, label %while.body.i156, label %while.body.i, !llvm.loop !10
...
while.body.i156:                                  ; preds = %while.body.i, %while.body.i156
  ...
  br i1 %cmp.i.not.i162, label %for.end61, label %while.body.i156, !llvm.loop !10
...
sort_Intersect.exit.i:                            ; preds = %for.end.i.i.i, %if.end.i.i.i, %clause_LiteralPredicate.exit.i143
  ...
  br i1 %cmp.i.not.i145, label %inf_GetSortFromLits.exit, label %for.body.i, !llvm.loop !14
...
for.cond.i.i187:                                  ; preds = %if.end.i.i185, %for.cond.i.i187
  ...
  br i1 %cmp.i20.not.i.i190, label %for.end.i.i191, label %for.cond.i.i187, !llvm.loop !9
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  br i1 %cmp.i203.1, label %while.body.i, label %while.end.i, !llvm.loop !47
...
while.body.i204:                                  ; preds = %while.body.i204.preheader, %while.body.i204
  ...
  br i1 %cmp.i.not.i205, label %if.end74, label %while.body.i204, !llvm.loop !10
...
if.end74:                                         ; preds = %while.body.i204, %for.end
  ...
  br i1 %cmp.i150.not, label %while.body.i212.preheader, label %for.body20, !llvm.loop !79
...
while.body.i212:                                  ; preds = %while.body.i212.preheader, %while.body.i212
  ...
  br i1 %cmp.i.not.i218, label %list_Delete.exit220, label %while.body.i212, !llvm.loop !10
