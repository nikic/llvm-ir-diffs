; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/rules-sort.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/rules-sort.c"
...
@.str.1 = private unnamed_addr constant [61 x i8] c"/home/npopov/repos/llvm-test-suite/CTMark/SPASS/rules-sort.c\00", align 1
...
if.then39:                                        ; preds = %land.lhs.true36
  ...
  br i1 %cmp.i.not.i164, label %if.then.i166, label %clause_LiteralAtom.exit169

if.then.i166:                                     ; preds = %if.then39
  %33 = getelementptr i8, ptr %call31.val, i64 16
  %call1.val.i167 = load ptr, ptr %33, align 8
  %34 = getelementptr i8, ptr %call1.val.i167, i64 8
  %call1.val.val.i168 = load ptr, ptr %34, align 8
  br label %clause_LiteralAtom.exit169

clause_LiteralAtom.exit169:                       ; preds = %if.then39, %if.then.i166
  %retval.0.i165 = phi ptr [ %call1.val.val.i168, %if.then.i166 ], [ %call31.val, %if.then39 ]
  br label %while.cond.i173

while.cond.i173:                                  ; preds = %while.cond.i173, %clause_LiteralAtom.exit169
  %indvars.iv.i174 = phi i64 [ %indvars.iv.next.i177, %while.cond.i173 ], [ 0, %clause_LiteralAtom.exit169 ]
  ...
  br i1 %cmp.not.i176, label %clause_LiteralGetIndex.exit178, label %while.cond.i173

clause_LiteralGetIndex.exit178:                   ; preds = %while.cond.i173
...
for.body49.lr.ph:                                 ; preds = %clause_LiteralGetIndex.exit178
  %37 = getelementptr i8, ptr %retval.0.i165, i64 16
...
land.lhs.true53:                                  ; preds = %for.body49
  ...
  br i1 %cmp.i.not.i182, label %if.then.i184, label %clause_LiteralAtom.exit187

if.then.i184:                                     ; preds = %land.lhs.true53
  %42 = getelementptr i8, ptr %call50.val, i64 16
  %call1.val.i185 = load ptr, ptr %42, align 8
  %43 = getelementptr i8, ptr %call1.val.i185, i64 8
  %call1.val.val.i186 = load ptr, ptr %43, align 8
  br label %clause_LiteralAtom.exit187

clause_LiteralAtom.exit187:                       ; preds = %land.lhs.true53, %if.then.i184
  %retval.0.i183 = phi ptr [ %call1.val.val.i186, %if.then.i184 ], [ %call50.val, %land.lhs.true53 ]
  %44 = getelementptr i8, ptr %retval.0.i183, i64 16
...
if.end:                                           ; preds = %if.then59, %clause_LiteralAtom.exit187, %for.body49
  ...
  br i1 %exitcond.not, label %for.end, label %for.body49
...
clause_GetLiteralAtom.exit:                       ; preds = %if.then67, %if.then.i.i
  ...
  %call74 = call i32 @unify_UnifyNoOC(ptr noundef %55, ptr noundef %retval.0.i165, ptr noundef %56, ptr noundef %retval.0.i.i) #11
...
while.body.i:                                     ; preds = %while.body.i, %while.body.preheader.i
  ...
  br i1 %tobool.not.i, label %cont_Reset.exit, label %while.body.i
...
while.body.i203:                                  ; preds = %list_Nconc.exit, %while.body.i203
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i203 ], [ %call.i.i190, %list_Nconc.exit ]
  ...
  br i1 %cmp.i.not.i204, label %list_Delete.exit, label %while.body.i203

list_Delete.exit:                                 ; preds = %while.body.i203
...
if.end80:                                         ; preds = %list_Delete.exit, %lor.lhs.false
  ...
  br i1 %cmp.i.not5.i205, label %list_Delete.exit213, label %while.body.i206

while.body.i206:                                  ; preds = %if.end80, %while.body.i206
  %Current.06.i207 = phi ptr [ %Current.0.val.i208, %while.body.i206 ], [ %tLits.0.lcssa, %if.end80 ]
  ...
  %total_size.i.i.i209 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %72, i64 0, i32 4
  %73 = load i32, ptr %total_size.i.i.i209, align 8
  %conv26.i.i.i210 = sext i32 %73 to i64
  %74 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i211 = add i64 %74, %conv26.i.i.i210
  store i64 %add27.i.i.i211, ptr @memory_FREEDBYTES, align 8
  %75 = load ptr, ptr %72, align 8
  store ptr %75, ptr %Current.06.i207, align 8
  %76 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i207, ptr %76, align 8
  %cmp.i.not.i212 = icmp eq ptr %Current.0.val.i208, null
  br i1 %cmp.i.not.i212, label %list_Delete.exit213, label %while.body.i206

list_Delete.exit213:                              ; preds = %while.body.i206, %if.end80
  %cmp.i.not5.i214 = icmp eq ptr %restLits.0.lcssa, null
  br i1 %cmp.i.not5.i214, label %if.end81, label %while.body.i215

while.body.i215:                                  ; preds = %list_Delete.exit213, %while.body.i215
  %Current.06.i216 = phi ptr [ %Current.0.val.i217, %while.body.i215 ], [ %restLits.0.lcssa, %list_Delete.exit213 ]
  %Current.0.val.i217 = load ptr, ptr %Current.06.i216, align 8
  %77 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i218 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %77, i64 0, i32 4
  %78 = load i32, ptr %total_size.i.i.i218, align 8
  %conv26.i.i.i219 = sext i32 %78 to i64
  %79 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i220 = add i64 %79, %conv26.i.i.i219
  store i64 %add27.i.i.i220, ptr @memory_FREEDBYTES, align 8
  %80 = load ptr, ptr %77, align 8
  store ptr %80, ptr %Current.06.i216, align 8
  %81 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i216, ptr %81, align 8
  %cmp.i.not.i221 = icmp eq ptr %Current.0.val.i217, null
  br i1 %cmp.i.not.i221, label %if.end81, label %while.body.i215

if.end81:                                         ; preds = %while.body.i215, %list_Delete.exit213, %land.lhs.true36, %clause_LiteralGetIndex.exit
  %result.4 = phi ptr [ %result.2246, %land.lhs.true36 ], [ %result.2246, %clause_LiteralGetIndex.exit ], [ %result.3, %list_Delete.exit213 ], [ %result.3, %while.body.i215 ]
  %litScan.0.val149 = load ptr, ptr %litScan.0245, align 8
  %cmp.i158.not = icmp eq ptr %litScan.0.val149, null
  br i1 %cmp.i158.not, label %for.inc86, label %for.body30
...
for.inc86:                                        ; preds = %if.end81, %if.then23, %for.body14, %term_IsAtom.exit, %land.lhs.true18
  ...
  br i1 %cmp.i152.not, label %if.end89, label %for.body14
...
if.end89:                                         ; preds = %for.inc86, %if.then, %clause_LiteralPredicate.exit.i, %symbol_IsPredicate.exit.i, %clause_LiteralAtom.exit.thread, %clause_LiteralIsSort.exit, %clause_LiteralAtom.exit
  ...
  br i1 %exitcond260.not, label %for.end92, label %for.body
...
sort_Intersect.exit.i:                            ; preds = %for.end.i.i.i, %if.end.i.i.i, %clause_LiteralPredicate.exit.i
  ...
  br i1 %cmp.i.not.i, label %inf_GetSortFromLits.exit, label %for.body.i
...
while.body.i:                                     ; preds = %inf_GetSortFromLits.exit, %while.body.i
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i ], [ %call2, %inf_GetSortFromLits.exit ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  ...
  br i1 %cmp.i.not.i36, label %list_Delete.exit, label %while.body.i
...
if.else:                                          ; preds = %for.end
  ...
  br i1 %cmp.i.not.i.i40, label %if.then.i.i42, label %clause_LiteralPredicate.exit

if.then.i.i42:                                    ; preds = %if.else
  %24 = getelementptr i8, ptr %Special.val, i64 16
  %call1.val.i.i43 = load ptr, ptr %24, align 8
  %25 = getelementptr i8, ptr %call1.val.i.i43, i64 8
  %call1.val.val.i.i44 = load ptr, ptr %25, align 8
  %call.val.pre.i = load i32, ptr %call1.val.val.i.i44, align 8
  br label %clause_LiteralPredicate.exit

clause_LiteralPredicate.exit:                     ; preds = %if.else, %if.then.i.i42
  %call.val.i41 = phi i32 [ %call.val.pre.i, %if.then.i.i42 ], [ %L.val7.val.i.i39, %if.else ]
  %call15 = tail call ptr @sort_TheorySortOfSymbol(ptr noundef %SortTheory, i32 noundef %call.val.i41) #11
...
if.end.i.i:                                       ; preds = %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i, label %if.then.i, label %while.body.i.i
...
if.then.i:                                        ; preds = %if.end.i.i
  ...
  br i1 %cmp.i.not.i.i334.i, label %if.then.i.i336.i, label %clause_GetLiteralAtom.exit339.i

if.then.i.i336.i:                                 ; preds = %if.then.i
  %21 = getelementptr i8, ptr %call.val.i332.i, i64 16
  %call1.val.i.i337.i = load ptr, ptr %21, align 8
  %22 = getelementptr i8, ptr %call1.val.i.i337.i, i64 8
  %call1.val.val.i.i338.i = load ptr, ptr %22, align 8
  br label %clause_GetLiteralAtom.exit339.i

clause_GetLiteralAtom.exit339.i:                  ; preds = %if.then.i.i336.i, %if.then.i
  %retval.0.i.i335.i = phi ptr [ %call1.val.val.i.i338.i, %if.then.i.i336.i ], [ %call.val.i332.i, %if.then.i ]
  %call26.i = tail call ptr @term_Copy(ptr noundef %retval.0.i.i335.i) #11
...
for.inc33.i:                                      ; preds = %if.else.i, %clause_GetLiteralAtom.exit339.i
  ...
  br i1 %exitcond.not.i, label %for.end34.loopexit.i, label %for.body22.i
...
for.body39.i:                                     ; preds = %clause_GetLiteralAtom.exit356.i, %for.body39.lr.ph.i
  ...
  br i1 %cmp.i.not.i.i351.i, label %if.then.i.i353.i, label %clause_GetLiteralAtom.exit356.i

if.then.i.i353.i:                                 ; preds = %for.body39.i
  %30 = getelementptr i8, ptr %call.val.i349.i, i64 16
  %call1.val.i.i354.i = load ptr, ptr %30, align 8
  %31 = getelementptr i8, ptr %call1.val.i.i354.i, i64 8
  %call1.val.val.i.i355.i = load ptr, ptr %31, align 8
  br label %clause_GetLiteralAtom.exit356.i

clause_GetLiteralAtom.exit356.i:                  ; preds = %if.then.i.i353.i, %for.body39.i
  %retval.0.i.i352.i = phi ptr [ %call1.val.val.i.i355.i, %if.then.i.i353.i ], [ %call.val.i349.i, %for.body39.i ]
  %call41.i = tail call ptr @term_Copy(ptr noundef %retval.0.i.i352.i) #11
  ...
  br i1 %exitcond616.not.i, label %for.end45.loopexit.i, label %for.body39.i
...
for.body50.i:                                     ; preds = %clause_GetLiteralAtom.exit370.i, %for.body50.lr.ph.i
  ...
  br i1 %cmp.i.not.i.i365.i, label %if.then.i.i367.i, label %clause_GetLiteralAtom.exit370.i

if.then.i.i367.i:                                 ; preds = %for.body50.i
  %38 = getelementptr i8, ptr %call.val.i363.i, i64 16
  %call1.val.i.i368.i = load ptr, ptr %38, align 8
  %39 = getelementptr i8, ptr %call1.val.i.i368.i, i64 8
  %call1.val.val.i.i369.i = load ptr, ptr %39, align 8
  br label %clause_GetLiteralAtom.exit370.i

clause_GetLiteralAtom.exit370.i:                  ; preds = %if.then.i.i367.i, %for.body50.i
  %retval.0.i.i366.i = phi ptr [ %call1.val.val.i.i369.i, %if.then.i.i367.i ], [ %call.val.i363.i, %for.body50.i ]
  %call52.i = tail call ptr @term_Copy(ptr noundef %retval.0.i.i366.i) #11
  ...
  br i1 %cmp48.not.not.i, label %for.body50.i, label %for.end56.i
...
for.body62.i:                                     ; preds = %for.inc178.i, %for.body62.preheader.i
  ...
  br label %while.body.i375.i

while.body.i375.i:                                ; preds = %if.end.i379.i, %for.body62.i
  %List.addr.07.i376.i = phi ptr [ %List.addr.0.val5.i380.i, %if.end.i379.i ], [ %Lits, %for.body62.i ]
  %44 = getelementptr i8, ptr %List.addr.07.i376.i, i64 8
  %List.addr.0.val.i377.i = load ptr, ptr %44, align 8
  %cmp.i378.i = icmp eq ptr %List.addr.0.val.i377.i, %43
  br i1 %cmp.i378.i, label %if.then66.i, label %if.end.i379.i

if.end.i379.i:                                    ; preds = %while.body.i375.i
  %List.addr.0.val5.i380.i = load ptr, ptr %List.addr.07.i376.i, align 8
  %cmp.i.not.i381.i = icmp eq ptr %List.addr.0.val5.i380.i, null
  br i1 %cmp.i.not.i381.i, label %for.inc178.i, label %while.body.i375.i

if.then66.i:                                      ; preds = %while.body.i375.i
  ...
  br i1 %cmp.i.not.i.i388.i, label %if.then.i.i390.i, label %clause_GetLiteralAtom.exit393.i

if.then.i.i390.i:                                 ; preds = %if.then66.i
  %48 = getelementptr i8, ptr %call.val.i386.i, i64 16
  %call1.val.i.i391.i = load ptr, ptr %48, align 8
  %49 = getelementptr i8, ptr %call1.val.i.i391.i, i64 8
  %call1.val.val.i.i392.i = load ptr, ptr %49, align 8
  br label %clause_GetLiteralAtom.exit393.i

clause_GetLiteralAtom.exit393.i:                  ; preds = %if.then.i.i390.i, %if.then66.i
  %retval.0.i.i389.i = phi ptr [ %call1.val.val.i.i392.i, %if.then.i.i390.i ], [ %call.val.i386.i, %if.then66.i ]
  ...
  br i1 %cmp.i.not5.i.i, label %list_Delete.exit.i, label %while.body.i394.i

while.body.i394.i:                                ; preds = %clause_GetLiteralAtom.exit393.i, %while.body.i394.i
  %Current.06.i.i = phi ptr [ %Current.0.val.i.i, %while.body.i394.i ], [ %Constraint.2598.i, %clause_GetLiteralAtom.exit393.i ]
  ...
  %cmp.i.not.i395.i = icmp eq ptr %Current.0.val.i.i, null
  br i1 %cmp.i.not.i395.i, label %list_Delete.exit.i, label %while.body.i394.i

list_Delete.exit.i:                               ; preds = %while.body.i394.i, %clause_GetLiteralAtom.exit393.i
  %cmp.i.not5.i396.i = icmp eq ptr %Antecedent.1597.i, null
  br i1 %cmp.i.not5.i396.i, label %list_Delete.exit404.i, label %while.body.i397.i

while.body.i397.i:                                ; preds = %list_Delete.exit.i, %while.body.i397.i
  %Current.06.i398.i = phi ptr [ %Current.0.val.i399.i, %while.body.i397.i ], [ %Antecedent.1597.i, %list_Delete.exit.i ]
  %Current.0.val.i399.i = load ptr, ptr %Current.06.i398.i, align 8
  %55 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i400.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %55, i64 0, i32 4
  %56 = load i32, ptr %total_size.i.i.i400.i, align 8
  %conv26.i.i.i401.i = sext i32 %56 to i64
  %57 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i402.i = add i64 %57, %conv26.i.i.i401.i
  store i64 %add27.i.i.i402.i, ptr @memory_FREEDBYTES, align 8
  %58 = load ptr, ptr %55, align 8
  store ptr %58, ptr %Current.06.i398.i, align 8
  %59 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i398.i, ptr %59, align 8
  %cmp.i.not.i403.i = icmp eq ptr %Current.0.val.i399.i, null
  br i1 %cmp.i.not.i403.i, label %list_Delete.exit404.i, label %while.body.i397.i

list_Delete.exit404.i:                            ; preds = %while.body.i397.i, %list_Delete.exit.i
  %cmp.i.not5.i405.i = icmp eq ptr %Succedent.1596.i, null
  br i1 %cmp.i.not5.i405.i, label %list_Delete.exit413.i, label %while.body.i406.i

while.body.i406.i:                                ; preds = %list_Delete.exit404.i, %while.body.i406.i
  %Current.06.i407.i = phi ptr [ %Current.0.val.i408.i, %while.body.i406.i ], [ %Succedent.1596.i, %list_Delete.exit404.i ]
  %Current.0.val.i408.i = load ptr, ptr %Current.06.i407.i, align 8
  %60 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i409.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %60, i64 0, i32 4
  %61 = load i32, ptr %total_size.i.i.i409.i, align 8
  %conv26.i.i.i410.i = sext i32 %61 to i64
  %62 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i411.i = add i64 %62, %conv26.i.i.i410.i
  store i64 %add27.i.i.i411.i, ptr @memory_FREEDBYTES, align 8
  %63 = load ptr, ptr %60, align 8
  store ptr %63, ptr %Current.06.i407.i, align 8
  %64 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i407.i, ptr %64, align 8
  %cmp.i.not.i412.i = icmp eq ptr %Current.0.val.i408.i, null
  br i1 %cmp.i.not.i412.i, label %list_Delete.exit413.i, label %while.body.i406.i

list_Delete.exit413.i:                            ; preds = %while.body.i406.i, %list_Delete.exit404.i
  %call67.val.i = load i32, ptr %retval.0.i.i389.i, align 8
...
clause_LiteralGetIndex.exit.i:                    ; preds = %while.cond.i.i
  ...
  br i1 %cmp.i.not.i425.i, label %if.then.i427.i, label %clause_LiteralAtom.exit430.i

if.then.i427.i:                                   ; preds = %clause_LiteralGetIndex.exit.i
  %79 = getelementptr i8, ptr %call97.val.i, i64 16
  %call1.val.i428.i = load ptr, ptr %79, align 8
  %80 = getelementptr i8, ptr %call1.val.i428.i, i64 8
  %call1.val.val.i429.i = load ptr, ptr %80, align 8
  br label %clause_LiteralAtom.exit430.i

clause_LiteralAtom.exit430.i:                     ; preds = %if.then.i427.i, %clause_LiteralGetIndex.exit.i
  %retval.0.i426.i = phi ptr [ %call1.val.val.i429.i, %if.then.i427.i ], [ %call97.val.i, %clause_LiteralGetIndex.exit.i ]
  call void @cont_Check() #11
  %81 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  %82 = load ptr, ptr @cont_RIGHTCONTEXT, align 8
  %call101.i = call i32 @unify_UnifyNoOC(ptr noundef %81, ptr noundef %retval.0.i426.i, ptr noundef %82, ptr noundef nonnull %retval.0.i.i389.i) #11
...
while.body.i431.i:                                ; preds = %while.body.i431.i, %while.body.preheader.i.i
  ...
  br i1 %tobool.not.i.i, label %cont_Reset.exit.i, label %while.body.i431.i
...
if.then120.i:                                     ; preds = %for.body117.i
  ...
  br i1 %cmp.i.not.i.i439.i, label %if.then.i.i441.i, label %clause_GetLiteralAtom.exit444.i

if.then.i.i441.i:                                 ; preds = %if.then120.i
  %112 = getelementptr i8, ptr %call.val.i437.i, i64 16
  %call1.val.i.i442.i = load ptr, ptr %112, align 8
  %113 = getelementptr i8, ptr %call1.val.i.i442.i, i64 8
  %call1.val.val.i.i443.i = load ptr, ptr %113, align 8
  br label %clause_GetLiteralAtom.exit444.i

clause_GetLiteralAtom.exit444.i:                  ; preds = %if.then.i.i441.i, %if.then120.i
  %retval.0.i.i440.i = phi ptr [ %call1.val.val.i.i443.i, %if.then.i.i441.i ], [ %call.val.i437.i, %if.then120.i ]
  %call122.i = call ptr @term_Copy(ptr noundef %retval.0.i.i440.i) #11
...
if.then128.i:                                     ; preds = %if.else125.i
  ...
  br i1 %cmp.i.not.i.i451.i, label %if.then.i.i453.i, label %clause_GetLiteralAtom.exit456.i

if.then.i.i453.i:                                 ; preds = %if.then128.i
  %118 = getelementptr i8, ptr %call.val.i449.i, i64 16
  %call1.val.i.i454.i = load ptr, ptr %118, align 8
  %119 = getelementptr i8, ptr %call1.val.i.i454.i, i64 8
  %call1.val.val.i.i455.i = load ptr, ptr %119, align 8
  br label %clause_GetLiteralAtom.exit456.i

clause_GetLiteralAtom.exit456.i:                  ; preds = %if.then.i.i453.i, %if.then128.i
  %retval.0.i.i452.i = phi ptr [ %call1.val.val.i.i455.i, %if.then.i.i453.i ], [ %call.val.i449.i, %if.then128.i ]
  %call130.i = call ptr @term_Copy(ptr noundef %retval.0.i.i452.i) #11
...
if.then136.i:                                     ; preds = %if.else133.i
  ...
  br i1 %cmp.i.not.i.i463.i, label %if.then.i.i465.i, label %clause_GetLiteralAtom.exit468.i

if.then.i.i465.i:                                 ; preds = %if.then136.i
  %124 = getelementptr i8, ptr %call.val.i461.i, i64 16
  %call1.val.i.i466.i = load ptr, ptr %124, align 8
  %125 = getelementptr i8, ptr %call1.val.i.i466.i, i64 8
  %call1.val.val.i.i467.i = load ptr, ptr %125, align 8
  br label %clause_GetLiteralAtom.exit468.i

clause_GetLiteralAtom.exit468.i:                  ; preds = %if.then.i.i465.i, %if.then136.i
  %retval.0.i.i464.i = phi ptr [ %call1.val.val.i.i467.i, %if.then.i.i465.i ], [ %call.val.i461.i, %if.then136.i ]
  %call138.i = call ptr @term_Copy(ptr noundef %retval.0.i.i464.i) #11
...
for.inc144.i:                                     ; preds = %clause_GetLiteralAtom.exit468.i, %if.else133.i, %clause_GetLiteralAtom.exit456.i, %clause_GetLiteralAtom.exit444.i
  ...
  br i1 %exitcond624.not.i, label %for.end146.i, label %for.body117.i
...
if.then157.i:                                     ; preds = %for.body154.i
  ...
  br i1 %cmp.i.not.i.i483.i, label %if.then.i.i485.i, label %clause_GetLiteralAtom.exit488.i

if.then.i.i485.i:                                 ; preds = %if.then157.i
  %136 = getelementptr i8, ptr %call.val.i481.i, i64 16
  %call1.val.i.i486.i = load ptr, ptr %136, align 8
  %137 = getelementptr i8, ptr %call1.val.i.i486.i, i64 8
  %call1.val.val.i.i487.i = load ptr, ptr %137, align 8
  br label %clause_GetLiteralAtom.exit488.i

clause_GetLiteralAtom.exit488.i:                  ; preds = %if.then.i.i485.i, %if.then157.i
  %retval.0.i.i484.i = phi ptr [ %call1.val.val.i.i487.i, %if.then.i.i485.i ], [ %call.val.i481.i, %if.then157.i ]
  %call159.i = call ptr @term_Copy(ptr noundef %retval.0.i.i484.i) #11
...
if.then164.i:                                     ; preds = %if.else161.i
  br i1 %cmp.i.not.i.i507.i, label %if.then.i.i497.i, label %clause_GetLiteralAtom.exit500.i

if.then.i.i497.i:                                 ; preds = %if.then164.i
  %141 = getelementptr i8, ptr %call.val.i505.i, i64 16
  %call1.val.i.i498.i = load ptr, ptr %141, align 8
  %142 = getelementptr i8, ptr %call1.val.i.i498.i, i64 8
  %call1.val.val.i.i499.i = load ptr, ptr %142, align 8
  br label %clause_GetLiteralAtom.exit500.i

clause_GetLiteralAtom.exit500.i:                  ; preds = %if.then.i.i497.i, %if.then164.i
  %retval.0.i.i496.i = phi ptr [ %call1.val.val.i.i499.i, %if.then.i.i497.i ], [ %call.val.i505.i, %if.then164.i ]
  %call166.i = call ptr @term_Copy(ptr noundef %retval.0.i.i496.i) #11
...
if.else168.i:                                     ; preds = %if.else161.i
  br i1 %cmp.i.not.i.i507.i, label %if.then.i.i509.i, label %clause_GetLiteralAtom.exit512.i

if.then.i.i509.i:                                 ; preds = %if.else168.i
  %143 = getelementptr i8, ptr %call.val.i505.i, i64 16
  %call1.val.i.i510.i = load ptr, ptr %143, align 8
  %144 = getelementptr i8, ptr %call1.val.i.i510.i, i64 8
  %call1.val.val.i.i511.i = load ptr, ptr %144, align 8
  br label %clause_GetLiteralAtom.exit512.i

clause_GetLiteralAtom.exit512.i:                  ; preds = %if.then.i.i509.i, %if.else168.i
  %retval.0.i.i508.i = phi ptr [ %call1.val.val.i.i511.i, %if.then.i.i509.i ], [ %call.val.i505.i, %if.else168.i ]
  %call170.i = call ptr @term_Copy(ptr noundef %retval.0.i.i508.i) #11
...
for.inc174.i:                                     ; preds = %clause_GetLiteralAtom.exit512.i, %clause_GetLiteralAtom.exit500.i, %clause_GetLiteralAtom.exit488.i
  ...
  br i1 %exitcond629.not.i, label %for.end176.i, label %for.body154.i
...
for.inc178.i:                                     ; preds = %if.end.i379.i, %for.end176.i
  %ParentLits.3.i = phi ptr [ %call.i422.i, %for.end176.i ], [ %ParentLits.2592.i, %if.end.i379.i ]
  %ParentCls.3.i = phi ptr [ %call.i420.i, %for.end176.i ], [ %ParentCls.2594.i, %if.end.i379.i ]
  %Partners.1.i = phi ptr [ %call.i418.i, %for.end176.i ], [ %Partners.0595.i, %if.end.i379.i ]
  %Succedent.6.i = phi ptr [ %Succedent.4.lcssa.i, %for.end176.i ], [ %Succedent.1596.i, %if.end.i379.i ]
  %Antecedent.6.i = phi ptr [ %Antecedent.4.lcssa.i, %for.end176.i ], [ %Antecedent.1597.i, %if.end.i379.i ]
  %Constraint.7.i = phi ptr [ %Constraint.5.lcssa.i, %for.end176.i ], [ %Constraint.2598.i, %if.end.i379.i ]
  ...
  br i1 %exitcond634.not.i, label %for.end180.i, label %for.body62.i
...
for.end180.i:                                     ; preds = %for.inc178.i, %for.body62.lr.ph.i, %for.end56.i
  ...
  br i1 %cmp.i.not5.i515.i, label %list_Delete.exit523.i, label %while.body.i516.i

while.body.i516.i:                                ; preds = %for.end180.i, %while.body.i516.i
  %Current.06.i517.i = phi ptr [ %Current.0.val.i518.i, %while.body.i516.i ], [ %Constraint.2.lcssa.i, %for.end180.i ]
  %Current.0.val.i518.i = load ptr, ptr %Current.06.i517.i, align 8
  %146 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i519.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %146, i64 0, i32 4
  %147 = load i32, ptr %total_size.i.i.i519.i, align 8
  %conv26.i.i.i520.i = sext i32 %147 to i64
  %148 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i521.i = add i64 %148, %conv26.i.i.i520.i
  store i64 %add27.i.i.i521.i, ptr @memory_FREEDBYTES, align 8
  %149 = load ptr, ptr %146, align 8
  store ptr %149, ptr %Current.06.i517.i, align 8
  %150 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i517.i, ptr %150, align 8
  %cmp.i.not.i522.i = icmp eq ptr %Current.0.val.i518.i, null
  br i1 %cmp.i.not.i522.i, label %list_Delete.exit523.i, label %while.body.i516.i

list_Delete.exit523.i:                            ; preds = %while.body.i516.i, %for.end180.i
  %cmp.i.not5.i524.i = icmp eq ptr %Antecedent.1.lcssa.i, null
  br i1 %cmp.i.not5.i524.i, label %list_Delete.exit532.i, label %while.body.i525.i

while.body.i525.i:                                ; preds = %list_Delete.exit523.i, %while.body.i525.i
  %Current.06.i526.i = phi ptr [ %Current.0.val.i527.i, %while.body.i525.i ], [ %Antecedent.1.lcssa.i, %list_Delete.exit523.i ]
  %Current.0.val.i527.i = load ptr, ptr %Current.06.i526.i, align 8
  %151 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i528.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %151, i64 0, i32 4
  %152 = load i32, ptr %total_size.i.i.i528.i, align 8
  %conv26.i.i.i529.i = sext i32 %152 to i64
  %153 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i530.i = add i64 %153, %conv26.i.i.i529.i
  store i64 %add27.i.i.i530.i, ptr @memory_FREEDBYTES, align 8
  %154 = load ptr, ptr %151, align 8
  store ptr %154, ptr %Current.06.i526.i, align 8
  %155 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i526.i, ptr %155, align 8
  %cmp.i.not.i531.i = icmp eq ptr %Current.0.val.i527.i, null
  br i1 %cmp.i.not.i531.i, label %list_Delete.exit532.i, label %while.body.i525.i

list_Delete.exit532.i:                            ; preds = %while.body.i525.i, %list_Delete.exit523.i
  %cmp.i.not5.i533.i = icmp eq ptr %Succedent.1.lcssa.i, null
  br i1 %cmp.i.not5.i533.i, label %inf_BuildConstraintHyperResolvent.exit, label %while.body.i534.i

while.body.i534.i:                                ; preds = %list_Delete.exit532.i, %while.body.i534.i
  %Current.06.i535.i = phi ptr [ %Current.0.val.i536.i, %while.body.i534.i ], [ %Succedent.1.lcssa.i, %list_Delete.exit532.i ]
  %Current.0.val.i536.i = load ptr, ptr %Current.06.i535.i, align 8
  %156 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i537.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %156, i64 0, i32 4
  %157 = load i32, ptr %total_size.i.i.i537.i, align 8
  %conv26.i.i.i538.i = sext i32 %157 to i64
  %158 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i539.i = add i64 %158, %conv26.i.i.i538.i
  store i64 %add27.i.i.i539.i, ptr @memory_FREEDBYTES, align 8
  %159 = load ptr, ptr %156, align 8
  store ptr %159, ptr %Current.06.i535.i, align 8
  %160 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i535.i, ptr %160, align 8
  %cmp.i.not.i540.i = icmp eq ptr %Current.0.val.i536.i, null
  br i1 %cmp.i.not.i540.i, label %inf_BuildConstraintHyperResolvent.exit, label %while.body.i534.i

inf_BuildConstraintHyperResolvent.exit:           ; preds = %while.body.i534.i, %list_Delete.exit532.i
...
for.body.i69:                                     ; preds = %for.inc34.i, %for.body.lr.ph.i
  ...
  %TermList.068.i = phi ptr [ %call3.i, %for.body.lr.ph.i ], [ %L.val.i.i70, %for.inc34.i ]
...
term_IsAtom.exit.i:                               ; preds = %for.body.i69
  ...
  br i1 %cmp.i.i.not.i, label %if.then.i75, label %for.inc34.i

if.then.i75:                                      ; preds = %term_IsAtom.exit.i
...
for.body14.i:                                     ; preds = %if.then.i75, %for.inc.i
  %Result.166.i = phi ptr [ %Result.2.i, %for.inc.i ], [ %Result.069.i, %if.then.i75 ]
  %LitScan.065.i = phi ptr [ %LitScan.0.val52.i, %for.inc.i ], [ %call9.i, %if.then.i75 ]
...
land.lhs.true21.i:                                ; preds = %land.lhs.true.i
  ...
  %call16.val.i76 = load i32, ptr %179, align 8
  %and.i56.i = and i32 %call16.val.i76, 1
...
land.lhs.true27.i:                                ; preds = %land.lhs.true24.i
  ...
  br i1 %cmp.i.not6.i.i, label %if.then30.i, label %while.body.i.i77

while.body.i.i77:                                 ; preds = %land.lhs.true27.i, %if.end.i.i80
  %List.addr.07.i.i78 = phi ptr [ %List.addr.0.val5.i.i81, %if.end.i.i80 ], [ %Result.166.i, %land.lhs.true27.i ]
  %180 = getelementptr i8, ptr %List.addr.07.i.i78, i64 8
  %List.addr.0.val.i.i79 = load ptr, ptr %180, align 8
  %cmp.i59.i = icmp eq ptr %List.addr.0.val.i.i79, %LitScan.0.val.i
  br i1 %cmp.i59.i, label %for.inc.i, label %if.end.i.i80

if.end.i.i80:                                     ; preds = %while.body.i.i77
  %List.addr.0.val5.i.i81 = load ptr, ptr %List.addr.07.i.i78, align 8
  %cmp.i.not.i.i82 = icmp eq ptr %List.addr.0.val5.i.i81, null
  br i1 %cmp.i.not.i.i82, label %if.then30.i, label %while.body.i.i77

if.then30.i:                                      ; preds = %if.end.i.i80, %land.lhs.true27.i
  %call.i.i83 = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i84 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i83, i64 0, i32 1
  store ptr %LitScan.0.val.i, ptr %car.i.i84, align 8
  store ptr %Result.166.i, ptr %call.i.i83, align 8
  br label %for.inc.i

for.inc.i:                                        ; preds = %while.body.i.i77, %if.then30.i, %land.lhs.true24.i, %land.lhs.true21.i, %land.lhs.true.i, %for.body14.i
  %Result.2.i = phi ptr [ %call.i.i83, %if.then30.i ], [ %Result.166.i, %land.lhs.true24.i ], [ %Result.166.i, %land.lhs.true21.i ], [ %Result.166.i, %land.lhs.true.i ], [ %Result.166.i, %for.body14.i ], [ %Result.166.i, %while.body.i.i77 ]
  %LitScan.0.val52.i = load ptr, ptr %LitScan.065.i, align 8
  %cmp.i53.not.i = icmp eq ptr %LitScan.0.val52.i, null
  br i1 %cmp.i53.not.i, label %for.inc34.i, label %for.body14.i

for.inc34.i:                                      ; preds = %for.inc.i, %if.then.i75, %term_IsAtom.exit.i, %for.body.i69
  %Result.3.i = phi ptr [ %Result.069.i, %term_IsAtom.exit.i ], [ %Result.069.i, %for.body.i69 ], [ %Result.069.i, %if.then.i75 ], [ %Result.2.i, %for.inc.i ]
  %L.val.i.i70 = load ptr, ptr %TermList.068.i, align 8
  %181 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i71 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %181, i64 0, i32 4
  %182 = load i32, ptr %total_size.i.i.i.i71, align 8
  %conv26.i.i.i.i72 = sext i32 %182 to i64
  %183 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i73 = add i64 %183, %conv26.i.i.i.i72
  ...
  %cmp.i.not.i74 = icmp eq ptr %L.val.i.i70, null
  br i1 %cmp.i.not.i74, label %inf_GetSortResolutionPartnerLits.exit, label %for.body.i69
...
clause_LiteralGetIndex.exit:                      ; preds = %while.cond.i
  ...
  br i1 %cmp.i.not.i95, label %if.then.i97, label %clause_LiteralAtom.exit100

if.then.i97:                                      ; preds = %clause_LiteralGetIndex.exit
  %197 = getelementptr i8, ptr %call21.val, i64 16
  %call1.val.i98 = load ptr, ptr %197, align 8
  %198 = getelementptr i8, ptr %call1.val.i98, i64 8
  %call1.val.val.i99 = load ptr, ptr %198, align 8
  br label %clause_LiteralAtom.exit100

clause_LiteralAtom.exit100:                       ; preds = %clause_LiteralGetIndex.exit, %if.then.i97
  %retval.0.i96 = phi ptr [ %call1.val.val.i99, %if.then.i97 ], [ %call21.val, %clause_LiteralGetIndex.exit ]
  %call25 = call i32 @unify_UnifyNoOC(ptr noundef %193, ptr noundef %call8, ptr noundef %194, ptr noundef %retval.0.i96) #11
...
for.cond.i:                                       ; preds = %if.end.i, %for.cond.i
  ...
  %List1.addr.0.val17.i = load ptr, ptr %List1.addr.0.i, align 8
  %cmp.i20.not.i = icmp eq ptr %List1.addr.0.val17.i, null
  br i1 %cmp.i20.not.i, label %for.end.i102, label %for.cond.i
...
if.end10:                                         ; preds = %while.end
  ...
  br i1 %cmp.i.not.i.i70, label %if.then.i.i72, label %clause_GetLiteralAtom.exit75

if.then.i.i72:                                    ; preds = %if.end10
  %14 = getelementptr i8, ptr %call.val.i68, i64 16
  %call1.val.i.i73 = load ptr, ptr %14, align 8
  %15 = getelementptr i8, ptr %call1.val.i.i73, i64 8
  %call1.val.val.i.i74 = load ptr, ptr %15, align 8
  br label %clause_GetLiteralAtom.exit75

clause_GetLiteralAtom.exit75:                     ; preds = %if.end10, %if.then.i.i72
  %retval.0.i.i71 = phi ptr [ %call1.val.val.i.i74, %if.then.i.i72 ], [ %call.val.i68, %if.end10 ]
...
for.body.lr.ph:                                   ; preds = %clause_GetLiteralAtom.exit75
  %17 = getelementptr i8, ptr %retval.0.i.i71, i64 16
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %cmp.i.not.i.i80 = icmp eq i32 %19, %L.val7.val.i.i79
  br i1 %cmp.i.not.i.i80, label %if.then.i.i82, label %clause_GetLiteralAtom.exit85

if.then.i.i82:                                    ; preds = %for.body
  %22 = getelementptr i8, ptr %call.val.i78, i64 16
  %call1.val.i.i83 = load ptr, ptr %22, align 8
  %23 = getelementptr i8, ptr %call1.val.i.i83, i64 8
  %call1.val.val.i.i84 = load ptr, ptr %23, align 8
  br label %clause_GetLiteralAtom.exit85

clause_GetLiteralAtom.exit85:                     ; preds = %for.body, %if.then.i.i82
  %retval.0.i.i81 = phi ptr [ %call1.val.val.i.i84, %if.then.i.i82 ], [ %call.val.i78, %for.body ]
  %24 = getelementptr i8, ptr %retval.0.i.i81, i64 16
...
list_Delete.exit:                                 ; preds = %while.body.i, %if.end33
  ...
  br i1 %cmp.i.not5.i86, label %cleanup, label %while.body.i87

while.body.i87:                                   ; preds = %list_Delete.exit, %while.body.i87
  %Current.06.i88 = phi ptr [ %Current.0.val.i89, %while.body.i87 ], [ %TLits.0.lcssa, %list_Delete.exit ]
  %Current.0.val.i89 = load ptr, ptr %Current.06.i88, align 8
  %34 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i90 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %34, i64 0, i32 4
  %35 = load i32, ptr %total_size.i.i.i90, align 8
  %conv26.i.i.i91 = sext i32 %35 to i64
  %36 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i92 = add i64 %36, %conv26.i.i.i91
  store i64 %add27.i.i.i92, ptr @memory_FREEDBYTES, align 8
  %37 = load ptr, ptr %34, align 8
  store ptr %37, ptr %Current.06.i88, align 8
  %38 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i88, ptr %38, align 8
  %cmp.i.not.i93 = icmp eq ptr %Current.0.val.i89, null
  br i1 %cmp.i.not.i93, label %cleanup, label %while.body.i87

cleanup:                                          ; preds = %while.body.i87, %entry, %list_Delete.exit, %while.end
  %retval.0 = phi ptr [ null, %while.end ], [ %Result.0, %list_Delete.exit ], [ null, %entry ], [ %Result.0, %while.body.i87 ]
  ret ptr %retval.0
}
...
if.then42:                                        ; preds = %land.lhs.true39
  ...
  br i1 %cmp.i.not.i200, label %if.then.i202, label %clause_LiteralAtom.exit205

if.then.i202:                                     ; preds = %if.then42
  %33 = getelementptr i8, ptr %call31.val, i64 16
  %call1.val.i203 = load ptr, ptr %33, align 8
  %34 = getelementptr i8, ptr %call1.val.i203, i64 8
  %call1.val.val.i204 = load ptr, ptr %34, align 8
  br label %clause_LiteralAtom.exit205

clause_LiteralAtom.exit205:                       ; preds = %if.then42, %if.then.i202
  %retval.0.i201 = phi ptr [ %call1.val.val.i204, %if.then.i202 ], [ %call31.val, %if.then42 ]
  %35 = getelementptr i8, ptr %retval.0.i201, i64 16
...
while.cond.i209:                                  ; preds = %while.cond.i209, %clause_LiteralAtom.exit205
  %indvars.iv.i210 = phi i64 [ %indvars.iv.next.i213, %while.cond.i209 ], [ 0, %clause_LiteralAtom.exit205 ]
  %arrayidx.i.i211 = getelementptr inbounds ptr, ptr %call.val.i208, i64 %indvars.iv.i210
  ...
  br i1 %cmp.not.i212, label %clause_LiteralGetIndex.exit214, label %while.cond.i209

clause_LiteralGetIndex.exit214:                   ; preds = %while.cond.i209
...
clause_GetLiteralAtom.exit:                       ; preds = %for.body53, %if.then.i.i
  ...
  br i1 %48, label %for.body53, label %for.end
...
land.lhs.true70:                                  ; preds = %for.body66
  ...
  br i1 %cmp.i.not.i226, label %if.then.i228, label %clause_LiteralAtom.exit231

if.then.i228:                                     ; preds = %land.lhs.true70
  %54 = getelementptr i8, ptr %call67.val, i64 16
  %call1.val.i229 = load ptr, ptr %54, align 8
  %55 = getelementptr i8, ptr %call1.val.i229, i64 8
  %call1.val.val.i230 = load ptr, ptr %55, align 8
  br label %clause_LiteralAtom.exit231

clause_LiteralAtom.exit231:                       ; preds = %land.lhs.true70, %if.then.i228
  %retval.0.i227 = phi ptr [ %call1.val.val.i230, %if.then.i228 ], [ %call67.val, %land.lhs.true70 ]
  %56 = getelementptr i8, ptr %retval.0.i227, i64 16
...
if.end81:                                         ; preds = %if.then76, %clause_LiteralAtom.exit231, %for.body66
  ...
  br i1 %exitcond.not, label %for.end84, label %for.body66
...
if.then88:                                        ; preds = %lor.lhs.false, %for.end84
  ...
  br i1 %cmp.i.not.i.i240, label %if.then.i.i242, label %clause_GetLiteralAtom.exit245

if.then.i.i242:                                   ; preds = %if.then88
  %65 = getelementptr i8, ptr %call.val.i238, i64 16
  %call1.val.i.i243 = load ptr, ptr %65, align 8
  %66 = getelementptr i8, ptr %call1.val.i.i243, i64 8
  %call1.val.val.i.i244 = load ptr, ptr %66, align 8
  br label %clause_GetLiteralAtom.exit245

clause_GetLiteralAtom.exit245:                    ; preds = %if.then88, %if.then.i.i242
  %retval.0.i.i241 = phi ptr [ %call1.val.val.i.i244, %if.then.i.i242 ], [ %call.val.i238, %if.then88 ]
  call void @cont_Check() #11
  %67 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  %68 = load ptr, ptr @cont_RIGHTCONTEXT, align 8
  %call95 = call i32 @unify_UnifyNoOC(ptr noundef %67, ptr noundef %retval.0.i201, ptr noundef %68, ptr noundef %retval.0.i.i241) #11
...
while.body.i248:                                  ; preds = %list_Nconc.exit, %while.body.i248
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i248 ], [ %call.i.i234, %list_Nconc.exit ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  ...
  %cmp.i.not.i249 = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i249, label %list_Delete.exit, label %while.body.i248

list_Delete.exit:                                 ; preds = %while.body.i248
...
if.end101:                                        ; preds = %list_Delete.exit, %lor.lhs.false
  ...
  br i1 %cmp.i.not5.i257, label %list_Delete.exit265, label %while.body.i258

while.body.i258:                                  ; preds = %if.end101, %while.body.i258
  %Current.06.i259 = phi ptr [ %Current.0.val.i260, %while.body.i258 ], [ %tLits.0.lcssa, %if.end101 ]
  ...
  %total_size.i.i.i261 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %84, i64 0, i32 4
  %85 = load i32, ptr %total_size.i.i.i261, align 8
  %conv26.i.i.i262 = sext i32 %85 to i64
  %86 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i263 = add i64 %86, %conv26.i.i.i262
  store i64 %add27.i.i.i263, ptr @memory_FREEDBYTES, align 8
  %87 = load ptr, ptr %84, align 8
  store ptr %87, ptr %Current.06.i259, align 8
  %88 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i259, ptr %88, align 8
  %cmp.i.not.i264 = icmp eq ptr %Current.0.val.i260, null
  br i1 %cmp.i.not.i264, label %list_Delete.exit265, label %while.body.i258

list_Delete.exit265:                              ; preds = %while.body.i258, %if.end101
  %cmp.i.not5.i266 = icmp eq ptr %restLits.0.lcssa, null
  br i1 %cmp.i.not5.i266, label %if.end103, label %while.body.i267

while.body.i267:                                  ; preds = %list_Delete.exit265, %while.body.i267
  %Current.06.i268 = phi ptr [ %Current.0.val.i269, %while.body.i267 ], [ %restLits.0.lcssa, %list_Delete.exit265 ]
  ...
  %total_size.i.i.i270 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %89, i64 0, i32 4
  %90 = load i32, ptr %total_size.i.i.i270, align 8
  %conv26.i.i.i271 = sext i32 %90 to i64
  %91 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i272 = add i64 %91, %conv26.i.i.i271
  store i64 %add27.i.i.i272, ptr @memory_FREEDBYTES, align 8
  %92 = load ptr, ptr %89, align 8
  store ptr %92, ptr %Current.06.i268, align 8
  %93 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i268, ptr %93, align 8
  %cmp.i.not.i273 = icmp eq ptr %Current.0.val.i269, null
  br i1 %cmp.i.not.i273, label %if.end103, label %while.body.i267

if.end103:                                        ; preds = %while.body.i267, %list_Delete.exit265, %for.end, %land.lhs.true39, %land.lhs.true36, %clause_LiteralGetIndex.exit
  %result.5 = phi ptr [ %result.2301, %land.lhs.true39 ], [ %result.2301, %land.lhs.true36 ], [ %result.2301, %clause_LiteralGetIndex.exit ], [ %result.2301, %for.end ], [ %result.3, %list_Delete.exit265 ], [ %result.3, %while.body.i267 ]
  %litScan.0.val184 = load ptr, ptr %litScan.0300, align 8
  %cmp.i194.not = icmp eq ptr %litScan.0.val184, null
  br i1 %cmp.i194.not, label %for.inc108, label %for.body30
...
for.inc108:                                       ; preds = %if.end103, %if.then23, %for.body14, %term_IsAtom.exit, %land.lhs.true18
  ...
  br i1 %cmp.i188.not, label %if.end111, label %for.body14
...
if.end111:                                        ; preds = %for.inc108, %if.then, %clause_LiteralPredicate.exit.i, %symbol_IsPredicate.exit.i, %clause_LiteralAtom.exit.thread, %clause_LiteralIsSort.exit, %clause_LiteralAtom.exit
  ...
  br i1 %exitcond318.not, label %for.end114, label %for.body
...
entry:
  ...
  %sub.i = add i32 %GivenClause.val100, -1
...
for.body:                                         ; preds = %for.body.preheader, %clause_GetLiteralAtom.exit115
  ...
  br i1 %cmp.i.not.i.i110, label %if.then.i.i112, label %clause_GetLiteralAtom.exit115

if.then.i.i112:                                   ; preds = %for.body
  %16 = getelementptr i8, ptr %call.val.i108, i64 16
  %call1.val.i.i113 = load ptr, ptr %16, align 8
  %17 = getelementptr i8, ptr %call1.val.i.i113, i64 8
  %call1.val.val.i.i114 = load ptr, ptr %17, align 8
  br label %clause_GetLiteralAtom.exit115

clause_GetLiteralAtom.exit115:                    ; preds = %for.body, %if.then.i.i112
  %retval.0.i.i111 = phi ptr [ %call1.val.val.i.i114, %if.then.i.i112 ], [ %call.val.i108, %for.body ]
  %call16 = tail call i32 @term_ContainsSymbol(ptr noundef %retval.0.i.i111, i32 noundef %call4.val) #11
  %tobool17.not = icmp eq i32 %call16, 0
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
  %cmp11 = icmp slt i64 %indvars.iv, %12
  %18 = and i1 %cmp11, %tobool17.not
  br i1 %18, label %for.body, label %if.end19.loopexit
...
if.end27:                                         ; preds = %if.then, %while.end
  ...
  %idxprom.i.i116 = sext i32 %i.0.lcssa174 to i64
  ...
  br i1 %cmp.i.not.i.i120, label %if.then.i.i122, label %clause_GetLiteralAtom.exit125

if.then.i.i122:                                   ; preds = %if.end27
  %24 = getelementptr i8, ptr %call.val.i118, i64 16
  %call1.val.i.i123 = load ptr, ptr %24, align 8
  %25 = getelementptr i8, ptr %call1.val.i.i123, i64 8
  %call1.val.val.i.i124 = load ptr, ptr %25, align 8
  br label %clause_GetLiteralAtom.exit125

clause_GetLiteralAtom.exit125:                    ; preds = %if.end27, %if.then.i.i122
  %retval.0.i.i121 = phi ptr [ %call1.val.val.i.i124, %if.then.i.i122 ], [ %call.val.i118, %if.end27 ]
  %26 = getelementptr i8, ptr %retval.0.i.i121, i64 16
...
for.body35:                                       ; preds = %for.body35.preheader, %if.end44
  ...
  br i1 %cmp.i.not.i.i130, label %if.then.i.i132, label %clause_GetLiteralAtom.exit135

if.then.i.i132:                                   ; preds = %for.body35
  %32 = getelementptr i8, ptr %call.val.i128, i64 16
  %call1.val.i.i133 = load ptr, ptr %32, align 8
  %33 = getelementptr i8, ptr %call1.val.i.i133, i64 8
  %call1.val.val.i.i134 = load ptr, ptr %33, align 8
  br label %clause_GetLiteralAtom.exit135

clause_GetLiteralAtom.exit135:                    ; preds = %for.body35, %if.then.i.i132
  %retval.0.i.i131 = phi ptr [ %call1.val.val.i.i134, %if.then.i.i132 ], [ %call.val.i128, %for.body35 ]
  %34 = getelementptr i8, ptr %retval.0.i.i131, i64 16
...
if.end44:                                         ; preds = %if.then41, %clause_GetLiteralAtom.exit135
  ...
  br i1 %exitcond.not, label %for.end47, label %for.body35
...
list_Delete.exit:                                 ; preds = %while.body.i, %if.end56
  ...
  br i1 %cmp.i.not5.i136, label %cleanup, label %while.body.i137

while.body.i137:                                  ; preds = %list_Delete.exit, %while.body.i137
  %Current.06.i138 = phi ptr [ %Current.0.val.i139, %while.body.i137 ], [ %TLits.0.lcssa, %list_Delete.exit ]
  ...
  %total_size.i.i.i140 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %43, i64 0, i32 4
  %44 = load i32, ptr %total_size.i.i.i140, align 8
  %conv26.i.i.i141 = sext i32 %44 to i64
  %45 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i142 = add i64 %45, %conv26.i.i.i141
  store i64 %add27.i.i.i142, ptr @memory_FREEDBYTES, align 8
  %46 = load ptr, ptr %43, align 8
  store ptr %46, ptr %Current.06.i138, align 8
  %47 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i138, ptr %47, align 8
  %cmp.i.not.i143 = icmp eq ptr %Current.0.val.i139, null
  br i1 %cmp.i.not.i143, label %cleanup, label %while.body.i137

cleanup:                                          ; preds = %while.body.i137, %entry, %list_Delete.exit, %while.end
  %retval.0 = phi ptr [ null, %while.end ], [ %Result.0, %list_Delete.exit ], [ null, %entry ], [ %Result.0, %while.body.i137 ]
  ret ptr %retval.0
}
...
if.then11:                                        ; preds = %if.then
  ...
  br i1 %cmp.i.not.i.i83, label %if.then.i.i85, label %clause_GetLiteralAtom.exit88

if.then.i.i85:                                    ; preds = %if.then11
  %15 = getelementptr i8, ptr %call.val.i81, i64 16
  %call1.val.i.i86 = load ptr, ptr %15, align 8
  %16 = getelementptr i8, ptr %call1.val.i.i86, i64 8
  %call1.val.val.i.i87 = load ptr, ptr %16, align 8
  br label %clause_GetLiteralAtom.exit88

clause_GetLiteralAtom.exit88:                     ; preds = %if.then11, %if.then.i.i85
  %retval.0.i.i84 = phi ptr [ %call1.val.val.i.i87, %if.then.i.i85 ], [ %call.val.i81, %if.then11 ]
...
for.body17.lr.ph:                                 ; preds = %clause_GetLiteralAtom.exit88
  %17 = getelementptr i8, ptr %retval.0.i.i84, i64 16
  br label %for.body17
...
for.body17:                                       ; preds = %for.body17.lr.ph, %if.end
  ...
  br i1 %cmp.i.not.i.i93, label %if.then.i.i95, label %clause_GetLiteralAtom.exit98

if.then.i.i95:                                    ; preds = %for.body17
  %21 = getelementptr i8, ptr %call.val.i91, i64 16
  %call1.val.i.i96 = load ptr, ptr %21, align 8
  %22 = getelementptr i8, ptr %call1.val.i.i96, i64 8
  %call1.val.val.i.i97 = load ptr, ptr %22, align 8
  br label %clause_GetLiteralAtom.exit98

clause_GetLiteralAtom.exit98:                     ; preds = %for.body17, %if.then.i.i95
  %retval.0.i.i94 = phi ptr [ %call1.val.val.i.i97, %if.then.i.i95 ], [ %call.val.i91, %for.body17 ]
  %23 = getelementptr i8, ptr %retval.0.i.i94, i64 16
...
if.then22:                                        ; preds = %clause_GetLiteralAtom.exit98
  ...
  %call18.val = load i32, ptr %retval.0.i.i94, align 8
...
for.end:                                          ; preds = %if.end, %clause_GetLiteralAtom.exit88
  ...
  %call12.val = load i32, ptr %retval.0.i.i84, align 8
  ...
  br i1 %cmp.i.not.i.i103, label %sort_Intersect.exit112, label %if.end.i.i104

if.end.i.i104:                                    ; preds = %for.end
  %cmp.i18.not.i.i105 = icmp eq ptr %tSort.0.lcssa, null
  br i1 %cmp.i18.not.i.i105, label %sort_Intersect.exit112, label %for.cond.i.i106

for.cond.i.i106:                                  ; preds = %if.end.i.i104, %for.cond.i.i106
  %List1.addr.0.i.i107 = phi ptr [ %List1.addr.0.val17.i.i108, %for.cond.i.i106 ], [ %call30, %if.end.i.i104 ]
  %List1.addr.0.val17.i.i108 = load ptr, ptr %List1.addr.0.i.i107, align 8
  %cmp.i20.not.i.i109 = icmp eq ptr %List1.addr.0.val17.i.i108, null
  br i1 %cmp.i20.not.i.i109, label %for.end.i.i110, label %for.cond.i.i106

for.end.i.i110:                                   ; preds = %for.cond.i.i106
  store ptr %tSort.0.lcssa, ptr %List1.addr.0.i.i107, align 8
  br label %sort_Intersect.exit112

sort_Intersect.exit112:                           ; preds = %for.end, %if.end.i.i104, %for.end.i.i110
  %retval.0.i.i111 = phi ptr [ %call30, %for.end.i.i110 ], [ %tSort.0.lcssa, %for.end ], [ %call30, %if.end.i.i104 ]
...
sort_Intersect.exit.i:                            ; preds = %for.end.i.i.i, %if.end.i.i.i, %clause_LiteralPredicate.exit.i
  ...
  %Literals.addr.0.val12.i = load ptr, ptr %Literals.addr.016.i, align 8
  %cmp.i.not.i = icmp eq ptr %Literals.addr.0.val12.i, null
  br i1 %cmp.i.not.i, label %inf_GetSortFromLits.exit.loopexit, label %for.body.i

inf_GetSortFromLits.exit.loopexit:                ; preds = %sort_Intersect.exit.i
  %call7.i = tail call ptr @list_PointerDeleteDuplicates(ptr noundef %retval.0.i.i.i) #11
...
if.end.i:                                         ; preds = %inf_GetSortFromLits.exit.loopexit
...
list_Nconc.exit:                                  ; preds = %inf_GetSortFromLits.exit.loopexit, %if.end.i, %for.end.i
  %retval.0.i = phi ptr [ %call35, %for.end.i ], [ %result.0132, %inf_GetSortFromLits.exit.loopexit ], [ %call35, %if.end.i ]
  br label %while.body.i
...
while.body.i:                                     ; preds = %list_Nconc.exit, %while.body.i
  ...
  br i1 %cmp.i.not.i114, label %while.body.i116, label %while.body.i

while.body.i116:                                  ; preds = %while.body.i, %while.body.i116
  %Current.06.i117 = phi ptr [ %Current.0.val.i118, %while.body.i116 ], [ %call8, %while.body.i ]
  %Current.0.val.i118 = load ptr, ptr %Current.06.i117, align 8
  %38 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i119 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %38, i64 0, i32 4
  %39 = load i32, ptr %total_size.i.i.i119, align 8
  %conv26.i.i.i120 = sext i32 %39 to i64
  %40 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i121 = add i64 %40, %conv26.i.i.i120
  store i64 %add27.i.i.i121, ptr @memory_FREEDBYTES, align 8
  %41 = load ptr, ptr %38, align 8
  store ptr %41, ptr %Current.06.i117, align 8
  %42 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i117, ptr %42, align 8
  %cmp.i.not.i122 = icmp eq ptr %Current.0.val.i118, null
  br i1 %cmp.i.not.i122, label %for.inc39, label %while.body.i116

for.inc39:                                        ; preds = %while.body.i116, %clause_GetLiteralAtom.exit
  %result.2 = phi ptr [ %result.0132, %clause_GetLiteralAtom.exit ], [ %retval.0.i, %while.body.i116 ]
  %indvars.iv.next136 = add nuw nsw i64 %indvars.iv135, 1
  %cmp = icmp ult i64 %indvars.iv.next136, %2
  %43 = and i1 %cmp.i.i, %cmp
  br i1 %43, label %for.body, label %for.end40
...
if.end:                                           ; preds = %if.then45, %land.lhs.true42, %lor.lhs.false, %land.lhs.true33, %land.lhs.true, %for.body26
  ...
  br i1 %cmp.i81.not, label %if.end48, label %for.body26
...
if.end48:                                         ; preds = %if.end, %if.then20, %for.body16, %term_IsAtom.exit.i, %term_IsDeclaration.exit
  ...
  br i1 %cmp.i78.not, label %for.inc53, label %for.body16
...
for.body12:                                       ; preds = %for.end, %for.body12
  ...
  br i1 %cmp.i181.not, label %for.end20, label %for.body12
...
clause_LiteralGetIndex.exit.i:                    ; preds = %while.cond.i.i
  ...
  br i1 %cmp.i.not.i, label %inf_CopyUnifierClauses.exit, label %for.body.i
...
for.body.i188:                                    ; preds = %for.body.i188, %for.body.lr.ph.i
  %Literals.addr.04.i = phi ptr [ %Literals.addr.01.i, %for.body.lr.ph.i ], [ %Literals.addr.0.i, %for.body.i188 ]
  %maxVar.03.i = phi i32 [ %Clause.val177, %for.body.lr.ph.i ], [ %cond.i, %for.body.i188 ]
  ...
  %cmp.i.not.i189 = icmp eq ptr %Literals.addr.0.i, null
  br i1 %cmp.i.not.i189, label %inf_MakeClausesDisjoint.exit, label %for.body.i188

inf_MakeClausesDisjoint.exit:                     ; preds = %for.body.i188, %inf_CopyUnifierClauses.exit
...
clause_GetLiteralAtom.exit:                       ; preds = %inf_MakeClausesDisjoint.exit, %if.then.i.i
...
for.body35:                                       ; preds = %clause_GetLiteralAtom.exit, %sort_PairDelete.exit
  %SojuList.addr.0377 = phi ptr [ %SojuList, %clause_GetLiteralAtom.exit ], [ %L.val.i314, %sort_PairDelete.exit ]
  %result.0376 = phi ptr [ null, %clause_GetLiteralAtom.exit ], [ %result.3, %sort_PairDelete.exit ]
  %45 = getelementptr i8, ptr %SojuList.addr.0377, i64 8
...
lor.lhs.false:                                    ; preds = %for.body35
  ...
  br i1 %cmp.i.not.i.i195, label %if.then.i.i197, label %clause_LiteralPredicate.exit

if.then.i.i197:                                   ; preds = %lor.lhs.false
  %51 = getelementptr i8, ptr %Special.val, i64 16
  %call1.val.i.i198 = load ptr, ptr %51, align 8
  %52 = getelementptr i8, ptr %call1.val.i.i198, i64 8
  %call1.val.val.i.i199 = load ptr, ptr %52, align 8
  %call.val.pre.i = load i32, ptr %call1.val.val.i.i199, align 8
  br label %clause_LiteralPredicate.exit

clause_LiteralPredicate.exit:                     ; preds = %lor.lhs.false, %if.then.i.i197
  %call.val.i196 = phi i32 [ %call.val.pre.i, %if.then.i.i197 ], [ %L.val7.val.i.i194, %lor.lhs.false ]
  %call41 = tail call i32 @sort_ContainsSymbol(ptr noundef %call36.val178, i32 noundef %call.val.i196) #11
...
do.body:                                          ; preds = %do.cond, %if.then43
  %result.1 = phi ptr [ %result.0376, %if.then43 ], [ %result.2, %do.cond ]
  ...
  br i1 %cmp.i200.not365, label %if.then83, label %land.rhs.preheader

land.rhs.preheader:                               ; preds = %do.body
  %cmp.i202.not410 = icmp eq ptr %unifierScan.0, null
  br i1 %cmp.i202.not410, label %if.end87, label %while.body

while.body:                                       ; preds = %land.rhs.preheader, %if.end80
  %symbolScan.1366413 = phi ptr [ %symbolScan.2, %if.end80 ], [ %symbolScan.0, %land.rhs.preheader ]
  %unifierScan.1367412 = phi ptr [ %unifierScan.2, %if.end80 ], [ %unifierScan.0, %land.rhs.preheader ]
  %subset.1368411 = phi ptr [ %subset.2, %if.end80 ], [ %subset.0, %land.rhs.preheader ]
  %54 = getelementptr i8, ptr %unifierScan.1367412, i64 8
  ...
  br i1 %cmp.i.not.i.i205, label %if.then.i.i207, label %clause_LiteralPredicate.exit211

if.then.i.i207:                                   ; preds = %while.body
  %57 = getelementptr i8, ptr %call53.val, i64 16
  %call1.val.i.i208 = load ptr, ptr %57, align 8
  %58 = getelementptr i8, ptr %call1.val.i.i208, i64 8
  %call1.val.val.i.i209 = load ptr, ptr %58, align 8
  %call.val.pre.i210 = load i32, ptr %call1.val.val.i.i209, align 8
  br label %clause_LiteralPredicate.exit211

clause_LiteralPredicate.exit211:                  ; preds = %while.body, %if.then.i.i207
  %call.val.i206 = phi i32 [ %call.val.pre.i210, %if.then.i.i207 ], [ %L.val7.val.i.i204, %while.body ]
  %59 = getelementptr i8, ptr %symbolScan.1366413, i64 8
  %symbolScan.1.val = load ptr, ptr %59, align 8
  %60 = ptrtoint ptr %symbolScan.1.val to i64
  %61 = trunc i64 %60 to i32
  %cmp.i212.not = icmp eq i32 %call.val.i206, %61
...
if.then65:                                        ; preds = %clause_LiteralAtom.exit
  ...
  store ptr %symbolScan.1366413, ptr %arrayidx.i219, align 8
  %unifierScan.1.val173 = load ptr, ptr %unifierScan.1367412, align 8
  ...
  store ptr %subset.1368411, ptr %call.i223, align 8
  %symbolScan.1.val172 = load ptr, ptr %symbolScan.1366413, align 8
...
if.end80.thread:                                  ; preds = %if.then65
  %unifierScan.1.val171 = load ptr, ptr %unifierScan.1367412, align 8
  br label %if.then83
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  %cmp.i230.1 = icmp ugt i32 %dec.i.i.i, 1
  br i1 %cmp.i230.1, label %while.body.i, label %while.end.i

while.end.i:                                      ; preds = %while.body.i.prol.loopexit, %while.body.i, %if.else74
  %82 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i226 = icmp eq i32 %82, 0
  br i1 %cmp.i.not.i226, label %if.end80.sink.split, label %if.then.i227

if.then.i227:                                     ; preds = %while.end.i
...
if.end80.sink.split:                              ; preds = %clause_LiteralPredicate.exit211, %if.then.i227, %while.end.i
  %unifierScan.1.val170 = load ptr, ptr %unifierScan.1367412, align 8
  br label %if.end80

if.end80:                                         ; preds = %if.end80.sink.split, %if.then65
  %symbolScan.2 = phi ptr [ %symbolScan.1.val172, %if.then65 ], [ %symbolScan.1366413, %if.end80.sink.split ]
  %unifierScan.2 = phi ptr [ %call26, %if.then65 ], [ %unifierScan.1.val170, %if.end80.sink.split ]
  %subset.2 = phi ptr [ %call.i223, %if.then65 ], [ %subset.1368411, %if.end80.sink.split ]
  %cmp.i202.not = icmp eq ptr %unifierScan.2, null
  br i1 %cmp.i202.not, label %if.end87, label %while.body

if.then83:                                        ; preds = %if.end80.thread, %do.body
  %unifierScan.1.lcssa = phi ptr [ %unifierScan.0, %do.body ], [ %unifierScan.1.val171, %if.end80.thread ]
  %subset.1.lcssa = phi ptr [ %subset.0, %do.body ], [ %call.i223, %if.end80.thread ]
...
clause_GetLiteralAtom.exit.i:                     ; preds = %if.then.i.i.i, %if.then83
  ...
  br i1 %cmp.i.not481.i, label %for.end.i, label %for.body.i237

for.body.i237:                                    ; preds = %clause_GetLiteralAtom.exit.i, %for.body.i237
  %scan.0483.i = phi ptr [ %scan.0.i, %for.body.i237 ], [ %scan.0480.i, %clause_GetLiteralAtom.exit.i ]
  %constraint.0482.i = phi ptr [ %call.i.i, %for.body.i237 ], [ null, %clause_GetLiteralAtom.exit.i ]
  ...
  %cmp.i.not.i238 = icmp eq ptr %scan.0.i, null
  br i1 %cmp.i.not.i238, label %for.end.i, label %for.body.i237
...
for.body21.i:                                     ; preds = %for.end.i, %for.body21.i
  ...
  br i1 %cmp.i328.not.i, label %for.end31.i, label %for.body21.i
...
for.body37.i:                                     ; preds = %for.end31.i, %for.body37.i
  ...
  br i1 %cmp.i332.not.i, label %for.end47.i, label %for.body37.i
...
for.body53.i:                                     ; preds = %for.end47.i, %for.body53.i
  ...
  br i1 %cmp.i336.not.i, label %for.cond66.preheader.i, label %for.body53.i
...
while.cond.i.i240:                                ; preds = %while.cond.i.i240, %for.body70.i
  %indvars.iv.i.i241 = phi i64 [ %indvars.iv.next.i.i243, %while.cond.i.i240 ], [ 0, %for.body70.i ]
  %arrayidx.i.i347.i = getelementptr inbounds ptr, ptr %call.val.i346.i, i64 %indvars.iv.i.i241
  %111 = load ptr, ptr %arrayidx.i.i347.i, align 8
  %cmp.not.i.i242 = icmp eq ptr %111, %scan.4.val.i
  %indvars.iv.next.i.i243 = add nuw i64 %indvars.iv.i.i241, 1
  br i1 %cmp.not.i.i242, label %clause_LiteralGetIndex.exit.i244, label %while.cond.i.i240

clause_LiteralGetIndex.exit.i244:                 ; preds = %while.cond.i.i240
...
for.body78.i:                                     ; preds = %clause_GetLiteralAtom.exit357.i, %for.body78.preheader.i
  ...
  br i1 %cmp.i.not.i.i352.i, label %if.then.i.i354.i, label %clause_GetLiteralAtom.exit357.i

if.then.i.i354.i:                                 ; preds = %for.body78.i
  %117 = getelementptr i8, ptr %call.val.i350.i, i64 16
  %call1.val.i.i355.i = load ptr, ptr %117, align 8
  %118 = getelementptr i8, ptr %call1.val.i.i355.i, i64 8
  %call1.val.val.i.i356.i = load ptr, ptr %118, align 8
  br label %clause_GetLiteralAtom.exit357.i

clause_GetLiteralAtom.exit357.i:                  ; preds = %if.then.i.i354.i, %for.body78.i
  %retval.0.i.i353.i = phi ptr [ %call1.val.val.i.i356.i, %if.then.i.i354.i ], [ %call.val.i350.i, %for.body78.i ]
  %call81.i = tail call ptr @cont_CopyAndApplyBindings(ptr noundef %113, ptr noundef %retval.0.i.i353.i) #11
  ...
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %for.end84.loopexit.i, label %for.body78.i
...
if.then.i.i367.i:                                 ; preds = %for.body90.i
  %125 = getelementptr i8, ptr %call.val.i363.i, i64 16
  %call1.val.i.i368.i = load ptr, ptr %125, align 8
  %126 = getelementptr i8, ptr %call1.val.i.i368.i, i64 8
  %call1.val.val.i.i369.i = load ptr, ptr %126, align 8
  br label %clause_GetLiteralAtom.exit370.i

clause_GetLiteralAtom.exit370.i:                  ; preds = %if.then.i.i367.i, %for.body90.i
  %retval.0.i.i366.i = phi ptr [ %call1.val.val.i.i369.i, %if.then.i.i367.i ], [ %call.val.i363.i, %for.body90.i ]
  %call93.i = tail call ptr @cont_CopyAndApplyBindings(ptr noundef %121, ptr noundef %retval.0.i.i366.i) #11
  %call.i371.i = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i372.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i371.i, i64 0, i32 1
  ...
  br i1 %exitcond553.not.i, label %for.end97.loopexit.i, label %for.body90.i
...
for.end97.loopexit.i:                             ; preds = %clause_GetLiteralAtom.exit370.i
  ...
  %.pre384 = add i32 %Clause.val.i.i.pre.i, %Clause.val6.i.i.pre.i
  br label %for.end97.i

for.end97.i:                                      ; preds = %for.end97.loopexit.i, %for.end84.i
  %add.i.i373.i.pre-phi = phi i32 [ %.pre384, %for.end97.loopexit.i ], [ %add.i.i.i, %for.end84.i ]
...
for.end97.i.for.end112.i_crit_edge:               ; preds = %for.end97.i
  %.pre385 = shl i64 %indvars.iv.i.i241, 32
  %.pre386 = ashr exact i64 %.pre385, 32
...
for.body103.preheader.i:                          ; preds = %for.end97.i
  ...
  %sext581.i = shl i64 %indvars.iv.i.i241, 32
...
if.then.i245:                                     ; preds = %for.body103.i
  ...
  br i1 %cmp.i.not.i.i380.i, label %if.then.i.i382.i, label %clause_GetLiteralAtom.exit385.i

if.then.i.i382.i:                                 ; preds = %if.then.i245
  %136 = getelementptr i8, ptr %call.val.i378.i, i64 16
  %call1.val.i.i383.i = load ptr, ptr %136, align 8
  %137 = getelementptr i8, ptr %call1.val.i.i383.i, i64 8
  %call1.val.val.i.i384.i = load ptr, ptr %137, align 8
  br label %clause_GetLiteralAtom.exit385.i

clause_GetLiteralAtom.exit385.i:                  ; preds = %if.then.i.i382.i, %if.then.i245
  %retval.0.i.i381.i = phi ptr [ %call1.val.val.i.i384.i, %if.then.i.i382.i ], [ %call.val.i378.i, %if.then.i245 ]
  %call108.i = tail call ptr @cont_CopyAndApplyBindings(ptr noundef %132, ptr noundef %retval.0.i.i381.i) #11
...
for.inc110.i:                                     ; preds = %clause_GetLiteralAtom.exit385.i, %for.body103.i
  ...
  br i1 %exitcond559.not.i, label %for.end112.i, label %for.body103.i

for.end112.i:                                     ; preds = %for.inc110.i, %for.end97.i.for.end112.i_crit_edge
  %conv117.i.pre-phi = phi i64 [ %.pre386, %for.end97.i.for.end112.i_crit_edge ], [ %sext556.i, %for.inc110.i ]
  ...
  br i1 %cmp.i344.not.i, label %for.end123.i, label %for.body70.i
...
if.end.i.i:                                       ; preds = %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i246, label %if.then133.i, label %while.body.i.i
...
if.then133.i:                                     ; preds = %if.end.i.i, %for.body129.i
  ...
  br i1 %cmp.i.not.i.i400.i, label %if.then.i.i402.i, label %clause_GetLiteralAtom.exit405.i

if.then.i.i402.i:                                 ; preds = %if.then133.i
  %147 = getelementptr i8, ptr %call.val.i398.i, i64 16
  %call1.val.i.i403.i = load ptr, ptr %147, align 8
  %148 = getelementptr i8, ptr %call1.val.i.i403.i, i64 8
  %call1.val.val.i.i404.i = load ptr, ptr %148, align 8
  br label %clause_GetLiteralAtom.exit405.i

clause_GetLiteralAtom.exit405.i:                  ; preds = %if.then.i.i402.i, %if.then133.i
  %retval.0.i.i401.i = phi ptr [ %call1.val.val.i.i404.i, %if.then.i.i402.i ], [ %call.val.i398.i, %if.then133.i ]
  %call136.i = tail call ptr @cont_CopyAndApplyBindings(ptr noundef %143, ptr noundef %retval.0.i.i401.i) #11
...
for.inc144.i:                                     ; preds = %if.else.i, %clause_GetLiteralAtom.exit405.i
  ...
  br i1 %exitcond564.not.i, label %for.end146.loopexit.i, label %for.body129.i
...
for.body152.i:                                    ; preds = %clause_GetLiteralAtom.exit423.i, %for.body152.preheader.i
  ...
  br i1 %cmp.i.not.i.i418.i, label %if.then.i.i420.i, label %clause_GetLiteralAtom.exit423.i

if.then.i.i420.i:                                 ; preds = %for.body152.i
  %155 = getelementptr i8, ptr %call.val.i416.i, i64 16
  %call1.val.i.i421.i = load ptr, ptr %155, align 8
  %156 = getelementptr i8, ptr %call1.val.i.i421.i, i64 8
  %call1.val.val.i.i422.i = load ptr, ptr %156, align 8
  br label %clause_GetLiteralAtom.exit423.i

clause_GetLiteralAtom.exit423.i:                  ; preds = %if.then.i.i420.i, %for.body152.i
  %retval.0.i.i419.i = phi ptr [ %call1.val.val.i.i422.i, %if.then.i.i420.i ], [ %call.val.i416.i, %for.body152.i ]
  %call155.i = tail call ptr @cont_CopyAndApplyBindings(ptr noundef %151, ptr noundef %retval.0.i.i419.i) #11
  ...
  br i1 %exitcond569.not.i, label %for.end159.loopexit.i, label %for.body152.i
...
for.end159.loopexit.i:                            ; preds = %clause_GetLiteralAtom.exit423.i
  ...
  %.pre383 = add i32 %Clause.val.i.i426.pre.i, %Clause.val6.i.i427.pre.i
  br label %for.end159.i

for.end159.i:                                     ; preds = %for.end159.loopexit.i, %for.end146.i
  %add.i.i429.i.pre-phi = phi i32 [ %.pre383, %for.end159.loopexit.i ], [ %add.i.i412.i, %for.end146.i ]
...
for.body165.i:                                    ; preds = %clause_GetLiteralAtom.exit442.i, %for.body165.preheader.i
  ...
  br i1 %cmp.i.not.i.i437.i, label %if.then.i.i439.i, label %clause_GetLiteralAtom.exit442.i

if.then.i.i439.i:                                 ; preds = %for.body165.i
  %164 = getelementptr i8, ptr %call.val.i435.i, i64 16
  %call1.val.i.i440.i = load ptr, ptr %164, align 8
  %165 = getelementptr i8, ptr %call1.val.i.i440.i, i64 8
  %call1.val.val.i.i441.i = load ptr, ptr %165, align 8
  br label %clause_GetLiteralAtom.exit442.i

clause_GetLiteralAtom.exit442.i:                  ; preds = %if.then.i.i439.i, %for.body165.i
  %retval.0.i.i438.i = phi ptr [ %call1.val.val.i.i441.i, %if.then.i.i439.i ], [ %call.val.i435.i, %for.body165.i ]
  %call168.i = tail call ptr @cont_CopyAndApplyBindings(ptr noundef %160, ptr noundef %retval.0.i.i438.i) #11
  ...
  br i1 %exitcond574.not.i, label %for.end172.i, label %for.body165.i
...
for.end172.i:                                     ; preds = %clause_GetLiteralAtom.exit442.i, %for.end159.i
  ...
  br i1 %cmp.i.not5.i.i, label %list_Delete.exit.i, label %while.body.i447.i

while.body.i447.i:                                ; preds = %for.end172.i, %while.body.i447.i
  %Current.06.i.i = phi ptr [ %Current.0.val.i.i, %while.body.i447.i ], [ %constraint.3.lcssa.i, %for.end172.i ]
  %Current.0.val.i.i = load ptr, ptr %Current.06.i.i, align 8
  ...
  %cmp.i.not.i448.i = icmp eq ptr %Current.0.val.i.i, null
  br i1 %cmp.i.not.i448.i, label %list_Delete.exit.i, label %while.body.i447.i

list_Delete.exit.i:                               ; preds = %while.body.i447.i, %for.end172.i
  %cmp.i.not5.i449.i = icmp eq ptr %antecedent.3.lcssa.i, null
  br i1 %cmp.i.not5.i449.i, label %list_Delete.exit457.i, label %while.body.i450.i

while.body.i450.i:                                ; preds = %list_Delete.exit.i, %while.body.i450.i
  %Current.06.i451.i = phi ptr [ %Current.0.val.i452.i, %while.body.i450.i ], [ %antecedent.3.lcssa.i, %list_Delete.exit.i ]
  %Current.0.val.i452.i = load ptr, ptr %Current.06.i451.i, align 8
  %171 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i453.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %171, i64 0, i32 4
  %172 = load i32, ptr %total_size.i.i.i453.i, align 8
  %conv26.i.i.i454.i = sext i32 %172 to i64
  %173 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i455.i = add i64 %173, %conv26.i.i.i454.i
  store i64 %add27.i.i.i455.i, ptr @memory_FREEDBYTES, align 8
  %174 = load ptr, ptr %171, align 8
  store ptr %174, ptr %Current.06.i451.i, align 8
  %175 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i451.i, ptr %175, align 8
  %cmp.i.not.i456.i = icmp eq ptr %Current.0.val.i452.i, null
  br i1 %cmp.i.not.i456.i, label %list_Delete.exit457.i, label %while.body.i450.i

list_Delete.exit457.i:                            ; preds = %while.body.i450.i, %list_Delete.exit.i
  %cmp.i.not5.i458.i = icmp eq ptr %succedent.4.lcssa.i, null
  br i1 %cmp.i.not5.i458.i, label %while.body.lr.ph.i, label %while.body.i459.i

while.body.i459.i:                                ; preds = %list_Delete.exit457.i, %while.body.i459.i
  %Current.06.i460.i = phi ptr [ %Current.0.val.i461.i, %while.body.i459.i ], [ %succedent.4.lcssa.i, %list_Delete.exit457.i ]
  %Current.0.val.i461.i = load ptr, ptr %Current.06.i460.i, align 8
  %176 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i462.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %176, i64 0, i32 4
  %177 = load i32, ptr %total_size.i.i.i462.i, align 8
  %conv26.i.i.i463.i = sext i32 %177 to i64
  %178 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i464.i = add i64 %178, %conv26.i.i.i463.i
  store i64 %add27.i.i.i464.i, ptr @memory_FREEDBYTES, align 8
  %179 = load ptr, ptr %176, align 8
  store ptr %179, ptr %Current.06.i460.i, align 8
  %180 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i460.i, ptr %180, align 8
  %cmp.i.not.i465.i = icmp eq ptr %Current.0.val.i461.i, null
  br i1 %cmp.i.not.i465.i, label %while.body.lr.ph.i, label %while.body.i459.i

while.body.lr.ph.i:                               ; preds = %while.body.i459.i, %list_Delete.exit457.i
...
while.body.i334:                                  ; preds = %if.end.i338, %while.body.lr.ph.i
  %185 = phi i32 [ %or.i.i, %while.body.lr.ph.i ], [ %189, %if.end.i338 ]
  %spec.select107111.i = phi i32 [ %.promoted.i, %while.body.lr.ph.i ], [ %spec.select107.i, %if.end.i338 ]
  %l.0110.i = phi i32 [ %183, %while.body.lr.ph.i ], [ %spec.select.i339, %if.end.i338 ]
  %Scan.0109.i = phi ptr [ %call.i445.i, %while.body.lr.ph.i ], [ %Scan.0.val.i, %if.end.i338 ]
  ...
  %call1.val.i335 = load i32, ptr %187, align 8
  %188 = and i32 %call1.val.i335, 8
  %tobool3.not.i = icmp eq i32 %188, 0
  br i1 %tobool3.not.i, label %if.end.i338, label %if.then.i336

if.then.i336:                                     ; preds = %while.body.i334
  %or.i.i337 = or i32 %185, 8
  store i32 %or.i.i337, ptr %flags.i.i, align 8
  br label %if.end.i338

if.end.i338:                                      ; preds = %if.then.i336, %while.body.i334
  %189 = phi i32 [ %or.i.i337, %if.then.i336 ], [ %185, %while.body.i334 ]
  %190 = getelementptr i8, ptr %Scan.0.val98.i, i64 12
  %call1.val101.i = load i32, ptr %190, align 4
  %spec.select107.i = tail call i32 @llvm.umax.i32(i32 %call1.val101.i, i32 %spec.select107111.i)
  ...
  %spec.select.i339 = tail call i32 @llvm.umax.i32(i32 %l.0110.i, i32 %191)
  %Scan.0.val.i = load ptr, ptr %Scan.0109.i, align 8
  %cmp.i.not.i340 = icmp eq ptr %Scan.0.val.i, null
  br i1 %cmp.i.not.i340, label %while.end.i341, label %while.body.i334

while.end.i341:                                   ; preds = %if.end.i338
  %cmp15.i = icmp ugt i32 %spec.select.i339, %183
...
if.then18.i:                                      ; preds = %if.then16.i
  %mul.i = shl i32 %183, 3
  %cmp.i.i.i347 = icmp ult i32 %mul.i, 1024
  br i1 %cmp.i.i.i347, label %if.else25.i.i, label %if.then.i.i348

if.then.i.i348:                                   ; preds = %if.then18.i
...
if.then9.i.i:                                     ; preds = %if.then.i.i348
  %197 = load ptr, ptr %add.ptr1.i.i, align 8
  store ptr %197, ptr %196, align 8
  br label %if.end13.i.i

if.end13.i.i:                                     ; preds = %if.then9.i.i, %if.then.i.i348
  %198 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i349 = add i32 %RealSize.1.i.i.i.i, %198
  %conv.i104.i = zext i32 %add.i.i349 to i64
...
if.else25.i.i:                                    ; preds = %if.then18.i
  %idxprom.i.i350 = zext i32 %mul.i to i64
  %arrayidx.i.i351 = getelementptr inbounds [0 x ptr], ptr @memory_ARRAY, i64 0, i64 %idxprom.i.i350
  %201 = load ptr, ptr %arrayidx.i.i351, align 8
  ...
  %205 = load ptr, ptr %arrayidx.i.i351, align 8
  store ptr %192, ptr %205, align 8
  br label %if.end29.thread.i

if.end29.thread.i:                                ; preds = %if.else25.i.i, %if.end23.i.i, %if.then16.i
  %mul24.i = shl i32 %spec.select.i339, 3
  %call26.i = tail call ptr @memory_Malloc(i32 noundef %mul24.i) #11
  store ptr %call26.i, ptr %splitfield.i, align 8
  store i32 %spec.select.i339, ptr %splitfield_length.i, align 8
  br label %for.body.lr.ph.i342

if.end29.i:                                       ; preds = %while.end.i341
  %cmp31112.not.i = icmp eq i32 %183, 0
  br i1 %cmp31112.not.i, label %while.body38.lr.ph.i, label %for.body.lr.ph.i342

for.body.lr.ph.i342:                              ; preds = %if.end29.i, %if.end29.thread.i
  %splitfield33.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call174.i, i64 0, i32 4
  br label %for.body.i343

while.body38.lr.ph.i:                             ; preds = %for.body.i343, %if.end29.i
  %splitfield46.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call174.i, i64 0, i32 4
  br label %while.body38.i

for.body.i343:                                    ; preds = %for.body.i343, %for.body.lr.ph.i342
  %indvars.iv.i344 = phi i64 [ 0, %for.body.lr.ph.i342 ], [ %indvars.iv.next.i346, %for.body.i343 ]
  %206 = load ptr, ptr %splitfield33.i, align 8
  %arrayidx.i345 = getelementptr inbounds i64, ptr %206, i64 %indvars.iv.i344
  ...
  %cmp31.i = icmp ult i64 %indvars.iv.next.i346, %208
  br i1 %cmp31.i, label %for.body.i343, label %while.body38.lr.ph.i

while.cond34.loopexit.i:                          ; preds = %for.body45.i, %while.body38.i
  %cmp.i105.not.i = icmp eq ptr %List.addr.0.val.i, null
  br i1 %cmp.i105.not.i, label %while.body.i469.i, label %while.body38.i
...
for.body45.i:                                     ; preds = %for.body45.i, %for.body45.lr.ph.i
  ...
  br i1 %cmp43.i, label %for.body45.i, label %while.cond34.loopexit.i

while.body.i469.i:                                ; preds = %while.cond34.loopexit.i, %while.body.i469.i
  %Current.06.i470.i = phi ptr [ %Current.0.val.i471.i, %while.body.i469.i ], [ %call.i445.i, %while.cond34.loopexit.i ]
  %Current.0.val.i471.i = load ptr, ptr %Current.06.i470.i, align 8
  %217 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i472.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %217, i64 0, i32 4
  %218 = load i32, ptr %total_size.i.i.i472.i, align 8
  %conv26.i.i.i473.i = sext i32 %218 to i64
  %219 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i474.i = add i64 %219, %conv26.i.i.i473.i
  store i64 %add27.i.i.i474.i, ptr @memory_FREEDBYTES, align 8
  %220 = load ptr, ptr %217, align 8
  store ptr %220, ptr %Current.06.i470.i, align 8
  %221 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i470.i, ptr %221, align 8
  %cmp.i.not.i475.i = icmp eq ptr %Current.0.val.i471.i, null
  br i1 %cmp.i.not.i475.i, label %if.end.i, label %while.body.i469.i

if.end.i:                                         ; preds = %while.body.i469.i
...
if.end87:                                         ; preds = %if.end80, %land.rhs.preheader, %if.end.i
  %symbolScan.1358 = phi ptr [ null, %if.end.i ], [ %symbolScan.0, %land.rhs.preheader ], [ %symbolScan.2, %if.end80 ]
  %unifierScan.1356 = phi ptr [ %unifierScan.1.lcssa, %if.end.i ], [ null, %land.rhs.preheader ], [ null, %if.end80 ]
  %subset.1354 = phi ptr [ %subset.1.lcssa, %if.end.i ], [ %subset.0, %land.rhs.preheader ], [ %subset.2, %if.end80 ]
  %result.2 = phi ptr [ %call.i.i.i, %if.end.i ], [ %result.1, %land.rhs.preheader ], [ %result.1, %if.end80 ]
...
while.body96:                                     ; preds = %land.rhs91
  ...
  br i1 %cmp2.i258, label %while.body.i266.preheader, label %while.end.i259

while.body.i266.preheader:                        ; preds = %while.body96
  %xtraiter419 = and i32 %.pr.i257, 1
  %lcmp.mod420.not = icmp eq i32 %xtraiter419, 0
  br i1 %lcmp.mod420.not, label %while.body.i266.prol.loopexit, label %while.body.i266.prol

while.body.i266.prol:                             ; preds = %while.body.i266.preheader
  ...
  %call.val.i.i.i267.prol = load ptr, ptr %226, align 8
  store ptr %call.val.i.i.i267.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i268.prol = getelementptr inbounds %struct.binding, ptr %225, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i268.prol, i8 0, i64 20, i1 false)
  %227 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i269.prol = getelementptr inbounds %struct.binding, ptr %227, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i269.prol, align 8
  %dec.i.i.i270.prol = add nsw i32 %.pr.i257, -1
  store i32 %dec.i.i.i270.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i266.prol.loopexit

while.body.i266.prol.loopexit:                    ; preds = %while.body.i266.prol, %while.body.i266.preheader
  %.unr421 = phi i32 [ %.pr.i257, %while.body.i266.preheader ], [ %dec.i.i.i270.prol, %while.body.i266.prol ]
  %228 = icmp eq i32 %.pr.i257, 1
  br i1 %228, label %while.end.i259, label %while.body.i266

while.body.i266:                                  ; preds = %while.body.i266.prol.loopexit, %while.body.i266
  %229 = phi i32 [ %dec.i.i.i270.1, %while.body.i266 ], [ %.unr421, %while.body.i266.prol.loopexit ]
  ...
  %call.val.i.i.i267 = load ptr, ptr %231, align 8
  store ptr %call.val.i.i.i267, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i268 = getelementptr inbounds %struct.binding, ptr %230, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i268, i8 0, i64 20, i1 false)
  %232 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i269 = getelementptr inbounds %struct.binding, ptr %232, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i269, align 8
  %dec.i.i.i270 = add nsw i32 %229, -1
  store i32 %dec.i.i.i270, ptr @cont_BINDINGS, align 4
  %233 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %233, ptr @cont_CURRENTBINDING, align 8
  %234 = getelementptr i8, ptr %233, i64 24
  %call.val.i.i.i267.1 = load ptr, ptr %234, align 8
  store ptr %call.val.i.i.i267.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i268.1 = getelementptr inbounds %struct.binding, ptr %233, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i268.1, i8 0, i64 20, i1 false)
  %235 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i269.1 = getelementptr inbounds %struct.binding, ptr %235, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i269.1, align 8
  %dec.i.i.i270.1 = add nsw i32 %229, -2
  store i32 %dec.i.i.i270.1, ptr @cont_BINDINGS, align 4
  %cmp.i271.1 = icmp ugt i32 %dec.i.i.i270, 1
  br i1 %cmp.i271.1, label %while.body.i266, label %while.end.i259

while.end.i259:                                   ; preds = %while.body.i266.prol.loopexit, %while.body.i266, %while.body96
  %236 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i260 = icmp eq i32 %236, 0
  br i1 %cmp.i.not.i260, label %cont_BackTrack.exit272, label %if.then.i261

if.then.i261:                                     ; preds = %while.end.i259
  %dec.i.i262 = add nsw i32 %236, -1
  ...
  %237 = load i32, ptr %arrayidx.i.i264, align 4
  store i32 %237, ptr @cont_BINDINGS, align 4
  br label %cont_BackTrack.exit272

cont_BackTrack.exit272:                           ; preds = %while.end.i259, %if.then.i261
  ...
  br i1 %cmp.i250.not, label %do.cond, label %land.rhs91
...
if.then102:                                       ; preds = %land.rhs91
  ...
  br i1 %cmp2.i281, label %while.body.i289.preheader, label %while.end.i282

while.body.i289.preheader:                        ; preds = %if.then102
  %xtraiter422 = and i32 %.pr.i280, 1
  %lcmp.mod423.not = icmp eq i32 %xtraiter422, 0
  br i1 %lcmp.mod423.not, label %while.body.i289.prol.loopexit, label %while.body.i289.prol

while.body.i289.prol:                             ; preds = %while.body.i289.preheader
  ...
  %call.val.i.i.i290.prol = load ptr, ptr %246, align 8
  store ptr %call.val.i.i.i290.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i291.prol = getelementptr inbounds %struct.binding, ptr %245, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i291.prol, i8 0, i64 20, i1 false)
  %247 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i292.prol = getelementptr inbounds %struct.binding, ptr %247, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i292.prol, align 8
  %dec.i.i.i293.prol = add nsw i32 %.pr.i280, -1
  store i32 %dec.i.i.i293.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i289.prol.loopexit

while.body.i289.prol.loopexit:                    ; preds = %while.body.i289.prol, %while.body.i289.preheader
  %.unr424 = phi i32 [ %.pr.i280, %while.body.i289.preheader ], [ %dec.i.i.i293.prol, %while.body.i289.prol ]
  %248 = icmp eq i32 %.pr.i280, 1
  br i1 %248, label %while.end.i282, label %while.body.i289

while.body.i289:                                  ; preds = %while.body.i289.prol.loopexit, %while.body.i289
  %249 = phi i32 [ %dec.i.i.i293.1, %while.body.i289 ], [ %.unr424, %while.body.i289.prol.loopexit ]
  ...
  %call.val.i.i.i290 = load ptr, ptr %251, align 8
  store ptr %call.val.i.i.i290, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i291 = getelementptr inbounds %struct.binding, ptr %250, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i291, i8 0, i64 20, i1 false)
  %252 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i292 = getelementptr inbounds %struct.binding, ptr %252, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i292, align 8
  %dec.i.i.i293 = add nsw i32 %249, -1
  store i32 %dec.i.i.i293, ptr @cont_BINDINGS, align 4
  ...
  %call.val.i.i.i290.1 = load ptr, ptr %254, align 8
  store ptr %call.val.i.i.i290.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i291.1 = getelementptr inbounds %struct.binding, ptr %253, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i291.1, i8 0, i64 20, i1 false)
  %255 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i292.1 = getelementptr inbounds %struct.binding, ptr %255, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i292.1, align 8
  %dec.i.i.i293.1 = add nsw i32 %249, -2
  store i32 %dec.i.i.i293.1, ptr @cont_BINDINGS, align 4
  %cmp.i294.1 = icmp ugt i32 %dec.i.i.i293, 1
  br i1 %cmp.i294.1, label %while.body.i289, label %while.end.i282

while.end.i282:                                   ; preds = %while.body.i289.prol.loopexit, %while.body.i289, %if.then102
  %256 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i283 = icmp eq i32 %256, 0
  br i1 %cmp.i.not.i283, label %cont_BackTrack.exit295, label %if.then.i284

if.then.i284:                                     ; preds = %while.end.i282
  %dec.i.i285 = add nsw i32 %256, -1
  store i32 %dec.i.i285, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i286 = sext i32 %dec.i.i285 to i64
  %arrayidx.i.i287 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i286
  %257 = load i32, ptr %arrayidx.i.i287, align 4
  store i32 %257, ptr @cont_BINDINGS, align 4
  br label %cont_BackTrack.exit295

cont_BackTrack.exit295:                           ; preds = %while.end.i282, %if.then.i284
...
do.end:                                           ; preds = %do.cond
  ...
  br i1 %cmp.i.not5.i, label %if.end113, label %while.body.i304

while.body.i304:                                  ; preds = %do.end, %while.body.i304
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i304 ], [ %call45, %do.end ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  %264 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i305 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %264, i64 0, i32 4
  %265 = load i32, ptr %total_size.i.i.i305, align 8
  %conv26.i.i.i306 = sext i32 %265 to i64
  %266 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i307 = add i64 %266, %conv26.i.i.i306
  store i64 %add27.i.i.i307, ptr @memory_FREEDBYTES, align 8
  ...
  %cmp.i.not.i308 = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i308, label %if.end113, label %while.body.i304

if.end113:                                        ; preds = %while.body.i304, %do.end, %clause_LiteralPredicate.exit
  %result.3 = phi ptr [ %result.0376, %clause_LiteralPredicate.exit ], [ %result.2, %do.end ], [ %result.2, %while.body.i304 ]
...
while.body.i.i.i:                                 ; preds = %if.end113, %while.body.i.i.i
  ...
  br i1 %cmp.i.not.i.i.i310, label %sort_PairDelete.exit, label %while.body.i.i.i
...
sort_PairDelete.exit:                             ; preds = %while.body.i.i.i, %if.end113
  ...
  %L.val.i314 = load ptr, ptr %SojuList.addr.0377, align 8
  ...
  store ptr %283, ptr %SojuList.addr.0377, align 8
  %284 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %SojuList.addr.0377, ptr %284, align 8
  %cmp.i192.not = icmp eq ptr %L.val.i314, null
  br i1 %cmp.i192.not, label %for.body.i318, label %for.body35
...
for.body.i318:                                    ; preds = %sort_PairDelete.exit, %for.body.i318
  ...
  %Literals.addr.0.val.i319 = load ptr, ptr %285, align 8
  %286 = getelementptr i8, ptr %Literals.addr.0.val.i319, i64 16
  %call1.val.i320 = load ptr, ptr %286, align 8
  tail call void @clause_Delete(ptr noundef %call1.val.i320) #11
  store ptr null, ptr %285, align 8
  %Literals.addr.0.val7.i = load ptr, ptr %Literals.addr.09.i, align 8
  %cmp.i.not.i321 = icmp eq ptr %Literals.addr.0.val7.i, null
  br i1 %cmp.i.not.i321, label %while.body.i324, label %for.body.i318

while.body.i324:                                  ; preds = %for.body.i318, %while.body.i324
  %Current.06.i325 = phi ptr [ %Current.0.val.i326, %while.body.i324 ], [ %call26, %for.body.i318 ]
  %Current.0.val.i326 = load ptr, ptr %Current.06.i325, align 8
  %287 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i327 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %287, i64 0, i32 4
  %288 = load i32, ptr %total_size.i.i.i327, align 8
  %conv26.i.i.i328 = sext i32 %288 to i64
  %289 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i329 = add i64 %289, %conv26.i.i.i328
  store i64 %add27.i.i.i329, ptr @memory_FREEDBYTES, align 8
  %290 = load ptr, ptr %287, align 8
  store ptr %290, ptr %Current.06.i325, align 8
  %291 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i325, ptr %291, align 8
  %cmp.i.not.i330 = icmp eq ptr %Current.0.val.i326, null
  br i1 %cmp.i.not.i330, label %cleanup, label %while.body.i324

cleanup:                                          ; preds = %while.body.i324, %for.end20
  %retval.0 = phi ptr [ null, %for.end20 ], [ %result.3, %while.body.i324 ]
  ret ptr %retval.0
}
...
for.body.i:                                       ; preds = %if.then, %sort_Intersect.exit.i
  ...
  br i1 %cmp.i.not.i.i.i111, label %if.then.i.i.i115, label %clause_LiteralPredicate.exit.i112

if.then.i.i.i115:                                 ; preds = %for.body.i
  %25 = getelementptr i8, ptr %call2.val.i, i64 16
  %call1.val.i.i.i116 = load ptr, ptr %25, align 8
  %26 = getelementptr i8, ptr %call1.val.i.i.i116, i64 8
  %call1.val.val.i.i.i117 = load ptr, ptr %26, align 8
  %call.val.pre.i.i118 = load i32, ptr %call1.val.val.i.i.i117, align 8
  br label %clause_LiteralPredicate.exit.i112

clause_LiteralPredicate.exit.i112:                ; preds = %if.then.i.i.i115, %for.body.i
  %call.val.i.i113 = phi i32 [ %call.val.pre.i.i118, %if.then.i.i.i115 ], [ %L.val7.val.i.i.i110, %for.body.i ]
  %call4.i = tail call ptr @sort_TheorySortOfSymbol(ptr noundef %SortTheory, i32 noundef %call.val.i.i113) #11
  %cmp.i.not.i.i13.i = icmp eq ptr %call4.i, null
  br i1 %cmp.i.not.i.i13.i, label %sort_Intersect.exit.i, label %if.end.i.i.i

if.end.i.i.i:                                     ; preds = %clause_LiteralPredicate.exit.i112
  %cmp.i18.not.i.i.i = icmp eq ptr %result.015.i, null
  br i1 %cmp.i18.not.i.i.i, label %sort_Intersect.exit.i, label %for.cond.i.i.i
...
sort_Intersect.exit.i:                            ; preds = %for.end.i.i.i, %if.end.i.i.i, %clause_LiteralPredicate.exit.i112
  %retval.0.i.i.i = phi ptr [ %call4.i, %for.end.i.i.i ], [ %result.015.i, %clause_LiteralPredicate.exit.i112 ], [ %call4.i, %if.end.i.i.i ]
  %Literals.addr.0.val12.i = load ptr, ptr %Literals.addr.016.i, align 8
  %cmp.i.not.i114 = icmp eq ptr %Literals.addr.0.val12.i, null
  br i1 %cmp.i.not.i114, label %inf_GetSortFromLits.exit, label %for.body.i

inf_GetSortFromLits.exit:                         ; preds = %sort_Intersect.exit.i
  %call7.i = tail call ptr @list_PointerDeleteDuplicates(ptr noundef %retval.0.i.i.i) #11
  %partners.promoted = load ptr, ptr %partners, align 8
  %cmp.i119.not191 = icmp eq ptr %partners.promoted, null
  br i1 %cmp.i119.not191, label %while.body.i165.preheader, label %for.body20
...
for.body20:                                       ; preds = %inf_GetSortFromLits.exit, %list_Delete.exit
  ...
  br i1 %cmp.i.not.i122, label %if.then.i124, label %clause_LiteralAtom.exit127

if.then.i124:                                     ; preds = %for.body20
  %31 = getelementptr i8, ptr %call21.val, i64 16
  %call1.val.i125 = load ptr, ptr %31, align 8
  %32 = getelementptr i8, ptr %call1.val.i125, i64 8
  %call1.val.val.i126 = load ptr, ptr %32, align 8
  br label %clause_LiteralAtom.exit127

clause_LiteralAtom.exit127:                       ; preds = %for.body20, %if.then.i124
  %retval.0.i123 = phi ptr [ %call1.val.val.i126, %if.then.i124 ], [ %call21.val, %for.body20 ]
...
for.end:                                          ; preds = %if.end, %clause_LiteralGetIndex.exit
  ...
  %call23.val = load i32, ptr %retval.0.i123, align 8
  ...
  br i1 %cmp.i.not.i.i137, label %sort_Intersect.exit146, label %if.end.i.i138

if.end.i.i138:                                    ; preds = %for.end
  %cmp.i18.not.i.i139 = icmp eq ptr %tSort.0.lcssa, null
  br i1 %cmp.i18.not.i.i139, label %sort_Intersect.exit146, label %for.cond.i.i140

for.cond.i.i140:                                  ; preds = %if.end.i.i138, %for.cond.i.i140
  %List1.addr.0.i.i141 = phi ptr [ %List1.addr.0.val17.i.i142, %for.cond.i.i140 ], [ %call46, %if.end.i.i138 ]
  %List1.addr.0.val17.i.i142 = load ptr, ptr %List1.addr.0.i.i141, align 8
  %cmp.i20.not.i.i143 = icmp eq ptr %List1.addr.0.val17.i.i142, null
  br i1 %cmp.i20.not.i.i143, label %for.end.i.i144, label %for.cond.i.i140

for.end.i.i144:                                   ; preds = %for.cond.i.i140
  store ptr %tSort.0.lcssa, ptr %List1.addr.0.i.i141, align 8
  br label %sort_Intersect.exit146

sort_Intersect.exit146:                           ; preds = %for.end, %if.end.i.i138, %for.end.i.i144
  %retval.0.i.i145 = phi ptr [ %call46, %for.end.i.i144 ], [ %tSort.0.lcssa, %for.end ], [ %call46, %if.end.i.i138 ]
  ...
  %call52 = tail call i32 @unify_UnifyNoOC(ptr noundef %51, ptr noundef nonnull %retval.0.i123, ptr noundef %52, ptr noundef nonnull %retval.0.i179181) #11
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  store i32 %dec.i.i.i.1, ptr @cont_BINDINGS, align 4
  %cmp.i156.1 = icmp ugt i32 %dec.i.i.i, 1
  br i1 %cmp.i156.1, label %while.body.i, label %while.end.i

while.end.i:                                      ; preds = %while.body.i.prol.loopexit, %while.body.i, %list_Nconc.exit
  %64 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i151 = icmp eq i32 %64, 0
  br i1 %cmp.i.not.i151, label %while.body.i157.preheader, label %if.then.i152

if.then.i152:                                     ; preds = %while.end.i
  ...
  br label %while.body.i157.preheader

while.body.i157.preheader:                        ; preds = %while.end.i, %if.then.i152
  br label %while.body.i157

while.body.i157:                                  ; preds = %while.body.i157.preheader, %while.body.i157
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i157 ], [ %call.i135, %while.body.i157.preheader ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  ...
  %cmp.i.not.i158 = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i158, label %list_Delete.exit, label %while.body.i157

list_Delete.exit:                                 ; preds = %while.body.i157
  ...
  br i1 %cmp.i119.not, label %while.body.i165.preheader, label %for.body20

while.body.i165.preheader:                        ; preds = %list_Delete.exit, %inf_GetSortFromLits.exit
  %result.1.lcssa = phi ptr [ %result.0198, %inf_GetSortFromLits.exit ], [ %retval.0.i150, %list_Delete.exit ]
  tail call void @sort_Delete(ptr noundef %retval.0.i.i.i) #11
  br label %while.body.i165

while.body.i165:                                  ; preds = %while.body.i165.preheader, %while.body.i165
  %Current.06.i166 = phi ptr [ %Current.0.val.i167, %while.body.i165 ], [ %call.i, %while.body.i165.preheader ]
  %Current.0.val.i167 = load ptr, ptr %Current.06.i166, align 8
  %76 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i168 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %76, i64 0, i32 4
  %77 = load i32, ptr %total_size.i.i.i168, align 8
  %conv26.i.i.i169 = sext i32 %77 to i64
  %78 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i170 = add i64 %78, %conv26.i.i.i169
  store i64 %add27.i.i.i170, ptr @memory_FREEDBYTES, align 8
  %79 = load ptr, ptr %76, align 8
  store ptr %79, ptr %Current.06.i166, align 8
  %80 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i166, ptr %80, align 8
  %cmp.i.not.i171 = icmp eq ptr %Current.0.val.i167, null
  br i1 %cmp.i.not.i171, label %list_Delete.exit173, label %while.body.i165

list_Delete.exit173:                              ; preds = %while.body.i165
...
if.end59:                                         ; preds = %clause_LiteralPredicate.exit.i, %symbol_IsPredicate.exit.i, %clause_LiteralAtom.exit.thread, %list_Delete.exit173, %lor.lhs.false, %clause_LiteralIsSort.exit, %clause_LiteralAtom.exit
  ...
  br i1 %exitcond.not, label %for.end61, label %for.body
...
clause_LiteralPredicate.exit:                     ; preds = %land.lhs.true44, %if.then.i.i
  ...
  br i1 %cmp.i.not.i.i137, label %if.then.i.i139, label %clause_LiteralPredicate.exit143

if.then.i.i139:                                   ; preds = %clause_LiteralPredicate.exit
  %26 = getelementptr i8, ptr %call26.val115, i64 16
  %call1.val.i.i140 = load ptr, ptr %26, align 8
  %27 = getelementptr i8, ptr %call1.val.i.i140, i64 8
  %call1.val.val.i.i141 = load ptr, ptr %27, align 8
  %call.val.pre.i142 = load i32, ptr %call1.val.val.i.i141, align 8
  br label %clause_LiteralPredicate.exit143

clause_LiteralPredicate.exit143:                  ; preds = %clause_LiteralPredicate.exit, %if.then.i.i139
  %call.val.i138 = phi i32 [ %call.val.pre.i142, %if.then.i.i139 ], [ %L.val7.val.i.i136, %clause_LiteralPredicate.exit ]
  %cmp.i144.not = icmp eq i32 %call.val.i, %call.val.i138
...
for.inc:                                          ; preds = %for.body25, %clause_LiteralGetIndex.exit, %lor.lhs.false59, %land.lhs.true65, %if.then68, %if.then33, %lor.lhs.false, %land.lhs.true41, %clause_LiteralPredicate.exit143, %if.then49
  ...
  br i1 %cmp.i126.not, label %if.end74, label %for.body25
...
if.end74:                                         ; preds = %for.inc, %if.then19, %for.body15, %term_IsAtom.exit.i, %term_IsDeclaration.exit
  ...
  br i1 %cmp.i123.not, label %for.inc79, label %for.body15
...
for.inc79:                                        ; preds = %if.end74, %if.then, %term_IsAtom.exit
  ...
  br i1 %cmp.i.not, label %for.end81, label %for.body
...
for.body17:                                       ; preds = %for.body17.preheader, %clause_GetLiteralAtom.exit119
  ...
  br i1 %cmp.i.not.i.i114, label %if.then.i.i116, label %clause_GetLiteralAtom.exit119

if.then.i.i116:                                   ; preds = %for.body17
  %19 = getelementptr i8, ptr %call.val.i112, i64 16
  %call1.val.i.i117 = load ptr, ptr %19, align 8
  %20 = getelementptr i8, ptr %call1.val.i.i117, i64 8
  %call1.val.val.i.i118 = load ptr, ptr %20, align 8
  br label %clause_GetLiteralAtom.exit119

clause_GetLiteralAtom.exit119:                    ; preds = %for.body17, %if.then.i.i116
  %retval.0.i.i115 = phi ptr [ %call1.val.val.i.i118, %if.then.i.i116 ], [ %call.val.i112, %for.body17 ]
  %call9.val = load i32, ptr %call8.val.val, align 8
  %call20 = tail call i32 @term_ContainsSymbol(ptr noundef %retval.0.i.i115, i32 noundef %call9.val) #11
  %tobool21.not = icmp eq i32 %call20, 0
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
  %cmp13 = icmp slt i64 %indvars.iv, %15
  %21 = and i1 %tobool21.not, %cmp13
  br i1 %21, label %for.body17, label %for.end
...
if.then28:                                        ; preds = %if.then24
  ...
  br i1 %cmp.i.not.i121, label %if.then.i123, label %clause_LiteralAtom.exit126

if.then.i123:                                     ; preds = %if.then28
  %26 = getelementptr i8, ptr %call7.val, i64 16
  %call1.val.i124 = load ptr, ptr %26, align 8
  %27 = getelementptr i8, ptr %call1.val.i124, i64 8
  %call1.val.val.i125 = load ptr, ptr %27, align 8
  br label %clause_LiteralAtom.exit126

clause_LiteralAtom.exit126:                       ; preds = %if.then28, %if.then.i123
  %retval.0.i122 = phi ptr [ %call1.val.val.i125, %if.then.i123 ], [ %call7.val, %if.then28 ]
...
for.body34:                                       ; preds = %clause_LiteralAtom.exit126, %if.end43
  ...
  br i1 %cmp.i.not.i.i131, label %if.then.i.i133, label %clause_GetLiteralAtom.exit136

if.then.i.i133:                                   ; preds = %for.body34
  %31 = getelementptr i8, ptr %call.val.i129, i64 16
  %call1.val.i.i134 = load ptr, ptr %31, align 8
  %32 = getelementptr i8, ptr %call1.val.i.i134, i64 8
  %call1.val.val.i.i135 = load ptr, ptr %32, align 8
  br label %clause_GetLiteralAtom.exit136

clause_GetLiteralAtom.exit136:                    ; preds = %for.body34, %if.then.i.i133
  %retval.0.i.i132 = phi ptr [ %call1.val.val.i.i135, %if.then.i.i133 ], [ %call.val.i129, %for.body34 ]
  %33 = getelementptr i8, ptr %retval.0.i.i132, i64 16
...
if.then38:                                        ; preds = %clause_GetLiteralAtom.exit136
  ...
  %call35.val = load i32, ptr %retval.0.i.i132, align 8
...
for.end45:                                        ; preds = %if.end43, %clause_LiteralAtom.exit126
  ...
  %call29.val = load i32, ptr %retval.0.i122, align 8
  ...
  br i1 %cmp.i.not.i.i141, label %sort_Intersect.exit150, label %if.end.i.i142

if.end.i.i142:                                    ; preds = %for.end45
  %cmp.i18.not.i.i143 = icmp eq ptr %tSort.0.lcssa, null
  br i1 %cmp.i18.not.i.i143, label %sort_Intersect.exit150, label %for.cond.i.i144

for.cond.i.i144:                                  ; preds = %if.end.i.i142, %for.cond.i.i144
  %List1.addr.0.i.i145 = phi ptr [ %List1.addr.0.val17.i.i146, %for.cond.i.i144 ], [ %call49, %if.end.i.i142 ]
  ...
  br i1 %cmp.i20.not.i.i147, label %for.end.i.i148, label %for.cond.i.i144

for.end.i.i148:                                   ; preds = %for.cond.i.i144
  store ptr %tSort.0.lcssa, ptr %List1.addr.0.i.i145, align 8
  br label %sort_Intersect.exit150

sort_Intersect.exit150:                           ; preds = %for.end45, %if.end.i.i142, %for.end.i.i148
  %retval.0.i.i149 = phi ptr [ %call49, %for.end.i.i148 ], [ %tSort.0.lcssa, %for.end45 ], [ %call49, %if.end.i.i142 ]
  %call51 = tail call ptr @list_PointerDeleteDuplicates(ptr noundef %retval.0.i.i149) #11
  br label %for.body.i

for.body.i:                                       ; preds = %sort_Intersect.exit150, %sort_Intersect.exit.i
  %Literals.addr.016.i = phi ptr [ %Literals.addr.0.val12.i, %sort_Intersect.exit.i ], [ %call25, %sort_Intersect.exit150 ]
  %result.015.i = phi ptr [ %retval.0.i.i.i, %sort_Intersect.exit.i ], [ null, %sort_Intersect.exit150 ]
...
sort_Intersect.exit.i:                            ; preds = %for.end.i.i.i, %if.end.i.i.i, %clause_LiteralPredicate.exit.i
  ...
  br i1 %cmp.i.not.i151, label %inf_GetSortFromLits.exit.loopexit, label %for.body.i
...
while.body.i:                                     ; preds = %inf_GetSortFromLits.exit.loopexit, %while.body.i
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i ], [ %call.i139, %inf_GetSortFromLits.exit.loopexit ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  %42 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  ...
  br i1 %cmp.i.not.i154, label %while.body.i156, label %while.body.i

while.body.i156:                                  ; preds = %while.body.i, %while.body.i156
  %Current.06.i157 = phi ptr [ %Current.0.val.i158, %while.body.i156 ], [ %call25, %while.body.i ]
  %Current.0.val.i158 = load ptr, ptr %Current.06.i157, align 8
  %47 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i159 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %47, i64 0, i32 4
  %48 = load i32, ptr %total_size.i.i.i159, align 8
  %conv26.i.i.i160 = sext i32 %48 to i64
  %49 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i161 = add i64 %49, %conv26.i.i.i160
  store i64 %add27.i.i.i161, ptr @memory_FREEDBYTES, align 8
  %50 = load ptr, ptr %47, align 8
  store ptr %50, ptr %Current.06.i157, align 8
  %51 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i157, ptr %51, align 8
  %cmp.i.not.i162 = icmp eq ptr %Current.0.val.i158, null
  br i1 %cmp.i.not.i162, label %for.end61, label %while.body.i156
...
for.end61:                                        ; preds = %for.inc59, %while.body.i156, %if.then24, %entry
  %result.0.lcssa = phi ptr [ null, %entry ], [ null, %if.then24 ], [ %call54, %while.body.i156 ], [ null, %for.inc59 ]
  ret ptr %result.0.lcssa
}
...
for.body.i:                                       ; preds = %if.then, %sort_Intersect.exit.i
  ...
  br i1 %cmp.i.not.i.i.i142, label %if.then.i.i.i146, label %clause_LiteralPredicate.exit.i143

if.then.i.i.i146:                                 ; preds = %for.body.i
  %25 = getelementptr i8, ptr %call2.val.i, i64 16
  %call1.val.i.i.i147 = load ptr, ptr %25, align 8
  %26 = getelementptr i8, ptr %call1.val.i.i.i147, i64 8
  %call1.val.val.i.i.i148 = load ptr, ptr %26, align 8
  %call.val.pre.i.i149 = load i32, ptr %call1.val.val.i.i.i148, align 8
  br label %clause_LiteralPredicate.exit.i143

clause_LiteralPredicate.exit.i143:                ; preds = %if.then.i.i.i146, %for.body.i
  %call.val.i.i144 = phi i32 [ %call.val.pre.i.i149, %if.then.i.i.i146 ], [ %L.val7.val.i.i.i141, %for.body.i ]
  %call4.i = tail call ptr @sort_TheorySortOfSymbol(ptr noundef %SortTheory, i32 noundef %call.val.i.i144) #11
  %cmp.i.not.i.i13.i = icmp eq ptr %call4.i, null
  br i1 %cmp.i.not.i.i13.i, label %sort_Intersect.exit.i, label %if.end.i.i.i

if.end.i.i.i:                                     ; preds = %clause_LiteralPredicate.exit.i143
  %cmp.i18.not.i.i.i = icmp eq ptr %result.015.i, null
  br i1 %cmp.i18.not.i.i.i, label %sort_Intersect.exit.i, label %for.cond.i.i.i
...
sort_Intersect.exit.i:                            ; preds = %for.end.i.i.i, %if.end.i.i.i, %clause_LiteralPredicate.exit.i143
  %retval.0.i.i.i = phi ptr [ %call4.i, %for.end.i.i.i ], [ %result.015.i, %clause_LiteralPredicate.exit.i143 ], [ %call4.i, %if.end.i.i.i ]
  %Literals.addr.0.val12.i = load ptr, ptr %Literals.addr.016.i, align 8
  %cmp.i.not.i145 = icmp eq ptr %Literals.addr.0.val12.i, null
  br i1 %cmp.i.not.i145, label %inf_GetSortFromLits.exit, label %for.body.i

inf_GetSortFromLits.exit:                         ; preds = %sort_Intersect.exit.i
  %call7.i = tail call ptr @list_PointerDeleteDuplicates(ptr noundef %retval.0.i.i.i) #11
  %partners.promoted = load ptr, ptr %partners, align 8
  %cmp.i150.not241 = icmp eq ptr %partners.promoted, null
  br i1 %cmp.i150.not241, label %while.body.i212.preheader, label %for.body20
...
for.body20:                                       ; preds = %inf_GetSortFromLits.exit, %if.end74
  ...
  br i1 %cmp.i.not.i153, label %if.then.i155, label %clause_LiteralAtom.exit158

if.then.i155:                                     ; preds = %for.body20
  %31 = getelementptr i8, ptr %call21.val, i64 16
...
clause_LiteralAtom.exit158:                       ; preds = %for.body20, %if.then.i155
  %retval.0.i154 = phi ptr [ %call1.val.val.i157, %if.then.i155 ], [ %call21.val, %for.body20 ]
...
clause_LiteralGetIndex.exit:                      ; preds = %while.cond.i
  ...
  %39 = getelementptr i8, ptr %retval.0.i154, i64 16
...
clause_GetLiteralAtom.exit:                       ; preds = %for.body31, %if.then.i.i
  ...
  br i1 %48, label %for.body31, label %for.end
...
for.body45:                                       ; preds = %for.body45.preheader, %if.end58
  ...
  br i1 %cmp.i.not.i.i172, label %if.then.i.i174, label %clause_GetLiteralAtom.exit177

if.then.i.i174:                                   ; preds = %for.body45
  %53 = getelementptr i8, ptr %call.val.i170, i64 16
  %call1.val.i.i175 = load ptr, ptr %53, align 8
  %54 = getelementptr i8, ptr %call1.val.i.i175, i64 8
  %call1.val.val.i.i176 = load ptr, ptr %54, align 8
  br label %clause_GetLiteralAtom.exit177

clause_GetLiteralAtom.exit177:                    ; preds = %for.body45, %if.then.i.i174
  %retval.0.i.i173 = phi ptr [ %call1.val.val.i.i176, %if.then.i.i174 ], [ %call.val.i170, %for.body45 ]
...
land.lhs.true48:                                  ; preds = %clause_GetLiteralAtom.exit177
  %55 = getelementptr i8, ptr %retval.0.i.i173, i64 16
...
if.then53:                                        ; preds = %land.lhs.true48
  ...
  %call46.val = load i32, ptr %retval.0.i.i173, align 8
...
for.end60:                                        ; preds = %if.end58, %if.then38
  ...
  %call23.val = load i32, ptr %retval.0.i154, align 8
  ...
  br i1 %cmp.i.not.i.i184, label %sort_Intersect.exit193, label %if.end.i.i185

if.end.i.i185:                                    ; preds = %for.end60
  %cmp.i18.not.i.i186 = icmp eq ptr %tSort.0.lcssa, null
  br i1 %cmp.i18.not.i.i186, label %sort_Intersect.exit193, label %for.cond.i.i187

for.cond.i.i187:                                  ; preds = %if.end.i.i185, %for.cond.i.i187
  %List1.addr.0.i.i188 = phi ptr [ %List1.addr.0.val17.i.i189, %for.cond.i.i187 ], [ %call64, %if.end.i.i185 ]
  %List1.addr.0.val17.i.i189 = load ptr, ptr %List1.addr.0.i.i188, align 8
  %cmp.i20.not.i.i190 = icmp eq ptr %List1.addr.0.val17.i.i189, null
  br i1 %cmp.i20.not.i.i190, label %for.end.i.i191, label %for.cond.i.i187

for.end.i.i191:                                   ; preds = %for.cond.i.i187
  store ptr %tSort.0.lcssa, ptr %List1.addr.0.i.i188, align 8
  br label %sort_Intersect.exit193

sort_Intersect.exit193:                           ; preds = %for.end60, %if.end.i.i185, %for.end.i.i191
  %retval.0.i.i192 = phi ptr [ %call64, %for.end.i.i191 ], [ %tSort.0.lcssa, %for.end60 ], [ %call64, %if.end.i.i185 ]
  ...
  %call70 = tail call i32 @unify_UnifyNoOC(ptr noundef %61, ptr noundef nonnull %retval.0.i154, ptr noundef %62, ptr noundef nonnull %retval.0.i226228) #11
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  store i32 %dec.i.i.i.1, ptr @cont_BINDINGS, align 4
  %cmp.i203.1 = icmp ugt i32 %dec.i.i.i, 1
  br i1 %cmp.i203.1, label %while.body.i, label %while.end.i

while.end.i:                                      ; preds = %while.body.i.prol.loopexit, %while.body.i, %list_Nconc.exit
  %74 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i198 = icmp eq i32 %74, 0
  br i1 %cmp.i.not.i198, label %while.body.i204.preheader, label %if.then.i199

if.then.i199:                                     ; preds = %while.end.i
  ...
  br label %while.body.i204.preheader

while.body.i204.preheader:                        ; preds = %while.end.i, %if.then.i199
  br label %while.body.i204

while.body.i204:                                  ; preds = %while.body.i204.preheader, %while.body.i204
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i204 ], [ %call.i182, %while.body.i204.preheader ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  %76 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  ...
  %cmp.i.not.i205 = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i205, label %if.end74, label %while.body.i204

if.end74:                                         ; preds = %while.body.i204, %for.end
  %result.2 = phi ptr [ %result.1243, %for.end ], [ %retval.0.i197, %while.body.i204 ]
  ...
  br i1 %cmp.i150.not, label %while.body.i212.preheader, label %for.body20

while.body.i212.preheader:                        ; preds = %if.end74, %inf_GetSortFromLits.exit
  %result.1.lcssa = phi ptr [ %result.0248, %inf_GetSortFromLits.exit ], [ %result.2, %if.end74 ]
  tail call void @sort_Delete(ptr noundef %retval.0.i.i.i) #11
  br label %while.body.i212

while.body.i212:                                  ; preds = %while.body.i212.preheader, %while.body.i212
  %Current.06.i213 = phi ptr [ %Current.0.val.i214, %while.body.i212 ], [ %call.i, %while.body.i212.preheader ]
  %Current.0.val.i214 = load ptr, ptr %Current.06.i213, align 8
  %86 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i215 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %86, i64 0, i32 4
  %87 = load i32, ptr %total_size.i.i.i215, align 8
  %conv26.i.i.i216 = sext i32 %87 to i64
  %88 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i217 = add i64 %88, %conv26.i.i.i216
  store i64 %add27.i.i.i217, ptr @memory_FREEDBYTES, align 8
  %89 = load ptr, ptr %86, align 8
  store ptr %89, ptr %Current.06.i213, align 8
  %90 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i213, ptr %90, align 8
  %cmp.i.not.i218 = icmp eq ptr %Current.0.val.i214, null
  br i1 %cmp.i.not.i218, label %list_Delete.exit220, label %while.body.i212

list_Delete.exit220:                              ; preds = %while.body.i212
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %partners) #11
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %unifiers) #11
  br label %if.end78
...
if.end78:                                         ; preds = %clause_LiteralPredicate.exit.i, %symbol_IsPredicate.exit.i, %clause_LiteralAtom.exit.thread, %list_Delete.exit220, %lor.lhs.false, %clause_LiteralIsSort.exit, %clause_LiteralAtom.exit
  ...
  %exitcond.not = icmp eq i32 %9, %lftr.wideiv
  br i1 %exitcond.not, label %for.end81, label %for.body
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end
  %spec.select107111 = phi i32 [ %.promoted, %while.body.lr.ph ], [ %spec.select107, %if.end ]
...
if.end:                                           ; preds = %if.then, %while.body
  ...
  %spec.select107 = tail call i32 @llvm.umax.i32(i32 %call1.val101, i32 %spec.select107111)
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  br i1 %cmp31, label %for.body, label %while.cond34.preheader

while.cond34.loopexit:                            ; preds = %for.body45, %while.body38
  %cmp.i105.not = icmp eq ptr %List.addr.0.val, null
  br i1 %cmp.i105.not, label %while.end58, label %while.body38
...
for.body45:                                       ; preds = %for.body45.lr.ph, %for.body45
  ...
  br i1 %cmp43, label %for.body45, label %while.cond34.loopexit
...
clause_LiteralAtom.exit:                          ; preds = %entry, %if.then.i
  ...
  br i1 %cmp.i.not.i12, label %if.then.i14, label %clause_LiteralAtom.exit17

if.then.i14:                                      ; preds = %clause_LiteralAtom.exit
  %7 = getelementptr i8, ptr %L2.val, i64 16
  %call1.val.i15 = load ptr, ptr %7, align 8
  %8 = getelementptr i8, ptr %call1.val.i15, i64 8
  %call1.val.val.i16 = load ptr, ptr %8, align 8
  br label %clause_LiteralAtom.exit17

clause_LiteralAtom.exit17:                        ; preds = %clause_LiteralAtom.exit, %if.then.i14
  %retval.0.i13 = phi ptr [ %call1.val.val.i16, %if.then.i14 ], [ %L2.val, %clause_LiteralAtom.exit ]
  %9 = getelementptr i8, ptr %retval.0.i13, i64 16
