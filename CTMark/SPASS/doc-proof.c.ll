...
for.cond.i163:                                    ; preds = %if.end.i161, %for.cond.i163
  ...
  br i1 %cmp.i20.not.i166, label %for.end.i167, label %for.cond.i163, !llvm.loop !7
...
for.cond.i184:                                    ; preds = %if.end.i182, %for.cond.i184
  ...
  br i1 %cmp.i20.not.i187, label %for.end.i188, label %for.cond.i184, !llvm.loop !7
...
while.body.i110.i:                                ; preds = %list_Delete.exit.i, %while.body.i110.i
  ...
  br i1 %cmp.i.not.i116.i, label %list_Delete.exit117.i, label %while.body.i110.i, !llvm.loop !14
...
while.body.i119.i:                                ; preds = %list_Delete.exit117.i, %while.body.i119.i
  ...
  br i1 %cmp.i.not.i125.i, label %list_Delete.exit126.i, label %while.body.i119.i, !llvm.loop !14
...
while.body.i211:                                  ; preds = %list_Delete.exit, %while.body.i211
  ...
  br i1 %cmp.i.not.i217, label %list_Delete.exit218, label %while.body.i211, !llvm.loop !14
...
while.body.i220:                                  ; preds = %list_Delete.exit218, %while.body.i220
  ...
  br i1 %cmp.i.not.i226, label %list_Delete.exit227, label %while.body.i220, !llvm.loop !14
...
while.body.i229:                                  ; preds = %list_Delete.exit227, %while.body.i229
  ...
  br i1 %cmp.i.not.i235, label %list_Delete.exit236, label %while.body.i229, !llvm.loop !14
...
while.body.i238:                                  ; preds = %list_Delete.exit236, %while.body.i238
  ...
  br i1 %cmp.i.not.i244, label %list_Delete.exit245, label %while.body.i238, !llvm.loop !14
