; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/doc-proof.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/doc-proof.c"
...
for.body:                                         ; preds = %if.then, %for.body
  ...
  br i1 %cmp.i158.not, label %for.end, label %for.body
...
if.end.i161:                                      ; preds = %list_Nconc.exit
  %cmp.i18.not.i162 = icmp eq ptr %retval.0.i, null
  br i1 %cmp.i18.not.i162, label %for.body25.preheader, label %for.cond.i163

for.cond.i163:                                    ; preds = %if.end.i161, %for.cond.i163
  %List1.addr.0.i164 = phi ptr [ %List1.addr.0.val17.i165, %for.cond.i163 ], [ %call13, %if.end.i161 ]
...
for.end.i167:                                     ; preds = %for.cond.i163
  store ptr %retval.0.i, ptr %List1.addr.0.i164, align 8
...
for.body25.preheader:                             ; preds = %if.end.i161, %list_Nconc.exit169
  %retval.0.i168261 = phi ptr [ %retval.0.i168, %list_Nconc.exit169 ], [ %call13, %if.end.i161 ]
  br label %for.body25
...
for.body25:                                       ; preds = %for.body25.preheader, %for.inc33
  ...
  %Scan.0248 = phi ptr [ %Scan.0.val153, %for.inc33 ], [ %retval.0.i168261, %for.body25.preheader ]
...
for.inc33:                                        ; preds = %for.body25, %if.then29
  ...
  br i1 %cmp.i170.not, label %for.end35, label %for.body25

for.end35:                                        ; preds = %for.inc33, %list_Nconc.exit169
  %cmp.i170.not247264 = phi i1 [ true, %list_Nconc.exit169 ], [ false, %for.inc33 ]
  %retval.0.i168262 = phi ptr [ null, %list_Nconc.exit169 ], [ %retval.0.i168261, %for.inc33 ]
  ...
  tail call void @pcheck_ClauseListRemoveFlag(ptr noundef %retval.0.i168262, i32 noundef 64) #7
  ...
  br i1 %cmp.i170.not247264, label %for.end51.thread, label %for.body41

for.end51.thread:                                 ; preds = %for.end35
  %call52266 = tail call ptr @list_Copy(ptr noundef %call10) #7
...
for.body41:                                       ; preds = %for.end35, %for.inc49
  ...
  %Scan.1251 = phi ptr [ %Scan.1.val152, %for.inc49 ], [ %retval.0.i168262, %for.end35 ]
...
for.inc49:                                        ; preds = %for.body41, %if.then45
  ...
  br i1 %cmp.i175.not, label %for.end51, label %for.body41
...
for.end51:                                        ; preds = %for.inc49
  ...
  br i1 %cmp.i.not.i181, label %list_Nconc.exit190, label %if.end.i182

if.end.i182:                                      ; preds = %for.end51
  %cmp.i18.not.i183 = icmp eq ptr %call52, null
  br i1 %cmp.i18.not.i183, label %list_Nconc.exit190, label %for.cond.i184

for.cond.i184:                                    ; preds = %if.end.i182, %for.cond.i184
  %List1.addr.0.i185 = phi ptr [ %List1.addr.0.val17.i186, %for.cond.i184 ], [ %ProofClauses.1, %if.end.i182 ]
  %List1.addr.0.val17.i186 = load ptr, ptr %List1.addr.0.i185, align 8
  %cmp.i20.not.i187 = icmp eq ptr %List1.addr.0.val17.i186, null
  br i1 %cmp.i20.not.i187, label %for.end.i188, label %for.cond.i184

for.end.i188:                                     ; preds = %for.cond.i184
  store ptr %call52, ptr %List1.addr.0.i185, align 8
  br label %list_Nconc.exit190

list_Nconc.exit190:                               ; preds = %for.end51.thread, %for.end51, %if.end.i182, %for.end.i188
  %retval.0.i189 = phi ptr [ %ProofClauses.1, %for.end.i188 ], [ %call52, %for.end51 ], [ %ProofClauses.1, %if.end.i182 ], [ %call52266, %for.end51.thread ]
  ...
  %call57 = tail call ptr @pcheck_ParentPointersToParentNumbers(ptr noundef %retval.0.i168262) #7
...
for.inc72:                                        ; preds = %for.body64, %if.then68
  ...
  br i1 %cmp.i191.not, label %for.end74, label %for.body64
...
for.body83:                                       ; preds = %if.then77, %for.body83
  %Scan.3258 = phi ptr [ %Incomplete.1, %if.then77 ], [ %Scan.3.val150, %for.body83 ]
  %21 = getelementptr i8, ptr %Scan.3258, i64 8
  ...
  %Scan.3.val150 = load ptr, ptr %Scan.3258, align 8
  %cmp.i200.not = icmp eq ptr %Scan.3.val150, null
  br i1 %cmp.i200.not, label %for.end89, label %for.body83
...
if.end91:                                         ; preds = %list_Nconc.exit190, %for.end89, %for.end74
  %cmp.i198.not271 = phi i1 [ %cmp.i198.not, %for.end89 ], [ true, %for.end74 ], [ true, %list_Nconc.exit190 ]
  %Incomplete.0.lcssa270 = phi ptr [ %Incomplete.1, %for.end89 ], [ null, %for.end74 ], [ null, %list_Nconc.exit190 ]
...
if.then97:                                        ; preds = %if.end91
  ...
  br i1 %cmp.i191.not254, label %for.end.i205, label %for.body.i
...
for.inc.i:                                        ; preds = %if.else27.i, %if.else.i, %if.then24.i
  ...
  br i1 %cmp.i.not.i204, label %for.end.i205, label %for.body.i
...
for.body39.i:                                     ; preds = %for.end.i205, %for.body39.i
  ...
  br i1 %cmp.i107.not.i, label %for.end43.i, label %for.body39.i
...
list_Delete.exit.i:                               ; preds = %while.body.i.i, %for.end43.i
  ...
  br i1 %cmp.i.not5.i109.i, label %list_Delete.exit117.i, label %while.body.i110.i

while.body.i110.i:                                ; preds = %list_Delete.exit.i, %while.body.i110.i
  %Current.06.i111.i = phi ptr [ %Current.0.val.i112.i, %while.body.i110.i ], [ %call32.i, %list_Delete.exit.i ]
  ...
  %total_size.i.i.i113.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %54, i64 0, i32 4
  %55 = load i32, ptr %total_size.i.i.i113.i, align 8
  %conv26.i.i.i114.i = sext i32 %55 to i64
  %56 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i115.i = add i64 %56, %conv26.i.i.i114.i
  store i64 %add27.i.i.i115.i, ptr @memory_FREEDBYTES, align 8
  %57 = load ptr, ptr %54, align 8
  store ptr %57, ptr %Current.06.i111.i, align 8
  %58 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i111.i, ptr %58, align 8
  %cmp.i.not.i116.i = icmp eq ptr %Current.0.val.i112.i, null
  br i1 %cmp.i.not.i116.i, label %list_Delete.exit117.i, label %while.body.i110.i

list_Delete.exit117.i:                            ; preds = %while.body.i110.i, %list_Delete.exit.i
  br i1 %cmp.i107.not135.i, label %list_Delete.exit126.i, label %while.body.i119.i

while.body.i119.i:                                ; preds = %list_Delete.exit117.i, %while.body.i119.i
  %Current.06.i120.i = phi ptr [ %Current.0.val.i121.i, %while.body.i119.i ], [ %call33.i, %list_Delete.exit117.i ]
  %Current.0.val.i121.i = load ptr, ptr %Current.06.i120.i, align 8
  %59 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i122.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %59, i64 0, i32 4
  %60 = load i32, ptr %total_size.i.i.i122.i, align 8
  %conv26.i.i.i123.i = sext i32 %60 to i64
  %61 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i124.i = add i64 %61, %conv26.i.i.i123.i
  store i64 %add27.i.i.i124.i, ptr @memory_FREEDBYTES, align 8
  %62 = load ptr, ptr %59, align 8
  store ptr %62, ptr %Current.06.i120.i, align 8
  %63 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i120.i, ptr %63, align 8
  %cmp.i.not.i125.i = icmp eq ptr %Current.0.val.i121.i, null
  br i1 %cmp.i.not.i125.i, label %list_Delete.exit126.i, label %while.body.i119.i

list_Delete.exit126.i:                            ; preds = %while.body.i119.i, %list_Delete.exit117.i
...
while.body.i:                                     ; preds = %if.end99, %while.body.i
  ...
  br i1 %cmp.i.not.i209, label %list_Delete.exit, label %while.body.i

list_Delete.exit:                                 ; preds = %while.body.i, %if.end99
  br i1 %cmp.i170.not247264, label %list_Delete.exit218, label %while.body.i211

while.body.i211:                                  ; preds = %list_Delete.exit, %while.body.i211
  %Current.06.i212 = phi ptr [ %Current.0.val.i213, %while.body.i211 ], [ %retval.0.i168262, %list_Delete.exit ]
  ...
  %total_size.i.i.i214 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %85, i64 0, i32 4
  %86 = load i32, ptr %total_size.i.i.i214, align 8
  %conv26.i.i.i215 = sext i32 %86 to i64
  %87 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i216 = add i64 %87, %conv26.i.i.i215
  store i64 %add27.i.i.i216, ptr @memory_FREEDBYTES, align 8
  %88 = load ptr, ptr %85, align 8
  store ptr %88, ptr %Current.06.i212, align 8
  %89 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i212, ptr %89, align 8
  %cmp.i.not.i217 = icmp eq ptr %Current.0.val.i213, null
  br i1 %cmp.i.not.i217, label %list_Delete.exit218, label %while.body.i211

list_Delete.exit218:                              ; preds = %while.body.i211, %list_Delete.exit
  %cmp.i.not5.i219 = icmp eq ptr %call54, null
  br i1 %cmp.i.not5.i219, label %list_Delete.exit227, label %while.body.i220

while.body.i220:                                  ; preds = %list_Delete.exit218, %while.body.i220
  %Current.06.i221 = phi ptr [ %Current.0.val.i222, %while.body.i220 ], [ %call54, %list_Delete.exit218 ]
  %Current.0.val.i222 = load ptr, ptr %Current.06.i221, align 8
  %90 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i223 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %90, i64 0, i32 4
  %91 = load i32, ptr %total_size.i.i.i223, align 8
  %conv26.i.i.i224 = sext i32 %91 to i64
  %92 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i225 = add i64 %92, %conv26.i.i.i224
  store i64 %add27.i.i.i225, ptr @memory_FREEDBYTES, align 8
  %93 = load ptr, ptr %90, align 8
  store ptr %93, ptr %Current.06.i221, align 8
  %94 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i221, ptr %94, align 8
  %cmp.i.not.i226 = icmp eq ptr %Current.0.val.i222, null
  br i1 %cmp.i.not.i226, label %list_Delete.exit227, label %while.body.i220

list_Delete.exit227:                              ; preds = %while.body.i220, %list_Delete.exit218
  %cmp.i.not5.i228 = icmp eq ptr %SplitClauses.0.lcssa, null
  br i1 %cmp.i.not5.i228, label %list_Delete.exit236, label %while.body.i229

while.body.i229:                                  ; preds = %list_Delete.exit227, %while.body.i229
  %Current.06.i230 = phi ptr [ %Current.0.val.i231, %while.body.i229 ], [ %SplitClauses.0.lcssa, %list_Delete.exit227 ]
  ...
  %total_size.i.i.i232 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %95, i64 0, i32 4
  %96 = load i32, ptr %total_size.i.i.i232, align 8
  %conv26.i.i.i233 = sext i32 %96 to i64
  %97 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i234 = add i64 %97, %conv26.i.i.i233
  store i64 %add27.i.i.i234, ptr @memory_FREEDBYTES, align 8
  %98 = load ptr, ptr %95, align 8
  store ptr %98, ptr %Current.06.i230, align 8
  %99 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i230, ptr %99, align 8
  %cmp.i.not.i235 = icmp eq ptr %Current.0.val.i231, null
  br i1 %cmp.i.not.i235, label %list_Delete.exit236, label %while.body.i229

list_Delete.exit236:                              ; preds = %while.body.i229, %list_Delete.exit227
  br i1 %cmp.i198.not271, label %list_Delete.exit245, label %while.body.i238

while.body.i238:                                  ; preds = %list_Delete.exit236, %while.body.i238
  %Current.06.i239 = phi ptr [ %Current.0.val.i240, %while.body.i238 ], [ %Incomplete.0.lcssa270, %list_Delete.exit236 ]
  %Current.0.val.i240 = load ptr, ptr %Current.06.i239, align 8
  %100 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i241 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %100, i64 0, i32 4
  %101 = load i32, ptr %total_size.i.i.i241, align 8
  %conv26.i.i.i242 = sext i32 %101 to i64
  %102 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i243 = add i64 %102, %conv26.i.i.i242
  store i64 %add27.i.i.i243, ptr @memory_FREEDBYTES, align 8
  %103 = load ptr, ptr %100, align 8
  store ptr %103, ptr %Current.06.i239, align 8
  %104 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i239, ptr %104, align 8
  %cmp.i.not.i244 = icmp eq ptr %Current.0.val.i240, null
  br i1 %cmp.i.not.i244, label %list_Delete.exit245, label %while.body.i238

list_Delete.exit245:                              ; preds = %while.body.i238, %list_Delete.exit236
  ret ptr %call55
}
