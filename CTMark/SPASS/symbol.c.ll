; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/symbol.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/symbol.c"
...
for.inc.i.us:                                     ; preds = %land.lhs.true.i.us, %for.body.i.us
  ...
  br i1 %exitcond.not.i.us, label %if.then8.us, label %for.body.i.us
...
for.inc.i:                                        ; preds = %land.lhs.true.i, %for.body.i
  ...
  br i1 %exitcond.not.i, label %if.then8, label %for.body.i
...
while.body.i.i:                                   ; preds = %if.then, %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i, label %symbol_FreeSignature.exit, label %while.body.i.i
...
for.body:                                         ; preds = %for.body.preheader, %for.inc
  %2 = phi ptr [ %.pre12, %for.body.preheader ], [ %21, %for.inc ]
  %indvars.iv = phi i64 [ 1, %for.body.preheader ], [ %indvars.iv.next, %for.inc ]
  %arrayidx.i = getelementptr inbounds ptr, ptr %2, i64 %indvars.iv
  %3 = load ptr, ptr %arrayidx.i, align 8
  %cmp2.not = icmp eq ptr %3, null
...
for.end:                                          ; preds = %for.inc, %for.cond.preheader
  %22 = phi ptr [ %.pre12, %for.cond.preheader ], [ %21, %for.inc ]
...
for.inc:                                          ; preds = %for.inc.sink.split, %for.body, %if.then6, %if.then12, %land.lhs.true, %sw.bb, %if.then23, %land.lhs.true20, %sw.bb17, %if.else, %land.lhs.true47, %if.then50, %if.then32, %land.lhs.true35, %if.then38, %if.then3
  ...
  br i1 %cmp, label %for.body, label %if.end60
...
for.inc.i:                                        ; preds = %if.then.i, %for.body6.i
  ...
  br i1 %cmp.i32.not.i, label %for.inc14.i, label %for.body6.i
...
for.inc14.i:                                      ; preds = %for.inc.i
  ...
  br i1 %cmp.i.not.i, label %symbol_SortByPrecedence.exit, label %for.cond2.preheader.i
...
for.inc27:                                        ; preds = %for.body16
  ...
  br i1 %cmp.i49.not, label %for.end29, label %for.body16
...
while.body.i:                                     ; preds = %while.body.i.preheader, %while.body.i
  ...
  br i1 %cmp.i.not.i54, label %if.end30, label %while.body.i
...
for.inc34:                                        ; preds = %if.then30, %if.else
  ...
  br i1 %cmp.i63.not, label %for.end36, label %for.body17
...
while.body.i:                                     ; preds = %for.end36, %while.body.i
  ...
  br i1 %cmp.i.not.i68, label %if.end38, label %while.body.i
...
if.else31:                                        ; preds = %land.rhs.i
  ...
  br i1 %cmp.i81, label %if.then34, label %if.else37
...
if.then:                                          ; preds = %entry
  ...
  %6 = load ptr, ptr @stdout, align 8
  %call.i.i154 = tail call i32 @putc(i32 noundef 45, ptr noundef %6)
  %7 = load ptr, ptr @stdout, align 8
  %call.i.i154.1 = tail call i32 @putc(i32 noundef 45, ptr noundef %7)
  %8 = load ptr, ptr @stdout, align 8
  %call.i.i154.2 = tail call i32 @putc(i32 noundef 45, ptr noundef %8)
  %9 = load ptr, ptr @stdout, align 8
  %call.i.i154.3 = tail call i32 @putc(i32 noundef 45, ptr noundef %9)
  %10 = load ptr, ptr @stdout, align 8
  %call.i.i154.4 = tail call i32 @putc(i32 noundef 45, ptr noundef %10)
  %11 = load ptr, ptr @stdout, align 8
  %call.i.i154.5 = tail call i32 @putc(i32 noundef 45, ptr noundef %11)
  %12 = load ptr, ptr @stdout, align 8
  %call.i158 = tail call i32 @putc(i32 noundef 43, ptr noundef %12)
  %13 = load ptr, ptr @stdout, align 8
  %call.i.i161 = tail call i32 @putc(i32 noundef 45, ptr noundef %13)
  %14 = load ptr, ptr @stdout, align 8
  %call.i.i161.1 = tail call i32 @putc(i32 noundef 45, ptr noundef %14)
  %15 = load ptr, ptr @stdout, align 8
  %call.i.i161.2 = tail call i32 @putc(i32 noundef 45, ptr noundef %15)
  %16 = load ptr, ptr @stdout, align 8
  %call.i.i161.3 = tail call i32 @putc(i32 noundef 45, ptr noundef %16)
  %17 = load ptr, ptr @stdout, align 8
  %call.i.i161.4 = tail call i32 @putc(i32 noundef 45, ptr noundef %17)
  %18 = load ptr, ptr @stdout, align 8
  %call.i.i161.5 = tail call i32 @putc(i32 noundef 45, ptr noundef %18)
  %19 = load ptr, ptr @stdout, align 8
  %call.i.i161.6 = tail call i32 @putc(i32 noundef 45, ptr noundef %19)
  %20 = load ptr, ptr @stdout, align 8
  %call.i165 = tail call i32 @putc(i32 noundef 43, ptr noundef %20)
  %21 = load ptr, ptr @stdout, align 8
  %call.i.i168 = tail call i32 @putc(i32 noundef 45, ptr noundef %21)
  %22 = load ptr, ptr @stdout, align 8
  %call.i.i168.1 = tail call i32 @putc(i32 noundef 45, ptr noundef %22)
  %23 = load ptr, ptr @stdout, align 8
  %call.i.i168.2 = tail call i32 @putc(i32 noundef 45, ptr noundef %23)
  %24 = load ptr, ptr @stdout, align 8
  %call.i.i168.3 = tail call i32 @putc(i32 noundef 45, ptr noundef %24)
  %25 = load ptr, ptr @stdout, align 8
  %call.i.i168.4 = tail call i32 @putc(i32 noundef 45, ptr noundef %25)
  %26 = load ptr, ptr @stdout, align 8
  %call.i.i168.5 = tail call i32 @putc(i32 noundef 45, ptr noundef %26)
  %27 = load ptr, ptr @stdout, align 8
  %call.i172 = tail call i32 @putc(i32 noundef 43, ptr noundef %27)
  %28 = load ptr, ptr @stdout, align 8
  %call.i.i175 = tail call i32 @putc(i32 noundef 45, ptr noundef %28)
  %29 = load ptr, ptr @stdout, align 8
  %call.i.i175.1 = tail call i32 @putc(i32 noundef 45, ptr noundef %29)
  %30 = load ptr, ptr @stdout, align 8
  %call.i.i175.2 = tail call i32 @putc(i32 noundef 45, ptr noundef %30)
  %31 = load ptr, ptr @stdout, align 8
  %call.i.i175.3 = tail call i32 @putc(i32 noundef 45, ptr noundef %31)
  %32 = load ptr, ptr @stdout, align 8
  %call.i.i175.4 = tail call i32 @putc(i32 noundef 45, ptr noundef %32)
  %33 = load ptr, ptr @stdout, align 8
  %call.i.i175.5 = tail call i32 @putc(i32 noundef 45, ptr noundef %33)
  %34 = load ptr, ptr @stdout, align 8
  %call.i.i175.6 = tail call i32 @putc(i32 noundef 45, ptr noundef %34)
  %35 = load ptr, ptr @stdout, align 8
  %call.i.i175.7 = tail call i32 @putc(i32 noundef 45, ptr noundef %35)
  %36 = load ptr, ptr @stdout, align 8
  %call.i179 = tail call i32 @putc(i32 noundef 43, ptr noundef %36)
  %37 = load ptr, ptr @stdout, align 8
  %call.i.i182 = tail call i32 @putc(i32 noundef 45, ptr noundef %37)
  %38 = load ptr, ptr @stdout, align 8
  %call.i.i182.1 = tail call i32 @putc(i32 noundef 45, ptr noundef %38)
  %39 = load ptr, ptr @stdout, align 8
  %call.i.i182.2 = tail call i32 @putc(i32 noundef 45, ptr noundef %39)
  %40 = load ptr, ptr @stdout, align 8
  %call.i.i182.3 = tail call i32 @putc(i32 noundef 45, ptr noundef %40)
  %41 = load ptr, ptr @stdout, align 8
  %call.i.i182.4 = tail call i32 @putc(i32 noundef 45, ptr noundef %41)
  %42 = load ptr, ptr @stdout, align 8
  %call.i.i182.5 = tail call i32 @putc(i32 noundef 45, ptr noundef %42)
  %43 = load ptr, ptr @stdout, align 8
  %call.i.i182.6 = tail call i32 @putc(i32 noundef 45, ptr noundef %43)
  %44 = load ptr, ptr @stdout, align 8
  %call.i.i182.7 = tail call i32 @putc(i32 noundef 45, ptr noundef %44)
  %45 = load ptr, ptr @stdout, align 8
  %call.i.i182.8 = tail call i32 @putc(i32 noundef 45, ptr noundef %45)
  %46 = load ptr, ptr @stdout, align 8
  %call.i.i182.9 = tail call i32 @putc(i32 noundef 45, ptr noundef %46)
  %47 = load ptr, ptr @stdout, align 8
  %call.i.i182.10 = tail call i32 @putc(i32 noundef 45, ptr noundef %47)
  %48 = load ptr, ptr @stdout, align 8
  %call.i.i182.11 = tail call i32 @putc(i32 noundef 45, ptr noundef %48)
  %49 = load ptr, ptr @stdout, align 8
  %call.i.i182.12 = tail call i32 @putc(i32 noundef 45, ptr noundef %49)
  %50 = load ptr, ptr @stdout, align 8
  %call.i.i182.13 = tail call i32 @putc(i32 noundef 45, ptr noundef %50)
  %51 = load ptr, ptr @stdout, align 8
  %call.i.i182.14 = tail call i32 @putc(i32 noundef 45, ptr noundef %51)
  %52 = load ptr, ptr @stdout, align 8
  %call.i.i182.15 = tail call i32 @putc(i32 noundef 45, ptr noundef %52)
  %53 = load ptr, ptr @stdout, align 8
  %call.i.i182.16 = tail call i32 @putc(i32 noundef 45, ptr noundef %53)
  %54 = load ptr, ptr @stdout, align 8
  %call.i.i182.17 = tail call i32 @putc(i32 noundef 45, ptr noundef %54)
  %55 = load ptr, ptr @stdout, align 8
  %call.i.i182.18 = tail call i32 @putc(i32 noundef 45, ptr noundef %55)
  %56 = load ptr, ptr @stdout, align 8
  %call.i.i182.19 = tail call i32 @putc(i32 noundef 45, ptr noundef %56)
  %57 = load ptr, ptr @stdout, align 8
  %call.i.i182.20 = tail call i32 @putc(i32 noundef 45, ptr noundef %57)
  %58 = load ptr, ptr @stdout, align 8
  %call.i.i182.21 = tail call i32 @putc(i32 noundef 45, ptr noundef %58)
  %59 = load ptr, ptr @stdout, align 8
  %call.i.i182.22 = tail call i32 @putc(i32 noundef 45, ptr noundef %59)
  %60 = load ptr, ptr @stdout, align 8
  %call.i.i182.23 = tail call i32 @putc(i32 noundef 45, ptr noundef %60)
  %61 = load ptr, ptr @stdout, align 8
  %call.i.i182.24 = tail call i32 @putc(i32 noundef 45, ptr noundef %61)
  %62 = load ptr, ptr @stdout, align 8
  %call.i.i182.25 = tail call i32 @putc(i32 noundef 45, ptr noundef %62)
  %63 = load ptr, ptr @stdout, align 8
  %call.i.i182.26 = tail call i32 @putc(i32 noundef 45, ptr noundef %63)
  %64 = load ptr, ptr @stdout, align 8
  %call.i.i182.27 = tail call i32 @putc(i32 noundef 45, ptr noundef %64)
  %65 = load ptr, ptr @stdout, align 8
  %call.i.i182.28 = tail call i32 @putc(i32 noundef 45, ptr noundef %65)
  %66 = load ptr, ptr @stdout, align 8
  %call.i.i182.29 = tail call i32 @putc(i32 noundef 45, ptr noundef %66)
  %67 = load ptr, ptr @stdout, align 8
  %call.i.i182.30 = tail call i32 @putc(i32 noundef 45, ptr noundef %67)
  %68 = load ptr, ptr @stdout, align 8
  %call.i.i182.31 = tail call i32 @putc(i32 noundef 45, ptr noundef %68)
  %69 = load ptr, ptr @stdout, align 8
  %call.i.i182.32 = tail call i32 @putc(i32 noundef 45, ptr noundef %69)
  %70 = load ptr, ptr @stdout, align 8
  %call.i.i182.33 = tail call i32 @putc(i32 noundef 45, ptr noundef %70)
  %71 = load ptr, ptr @stdout, align 8
  %call.i.i182.34 = tail call i32 @putc(i32 noundef 45, ptr noundef %71)
  %72 = load ptr, ptr @stdout, align 8
  %call.i.i182.35 = tail call i32 @putc(i32 noundef 45, ptr noundef %72)
  ...
  %call.i.i190 = tail call i32 @putc(i32 noundef 32, ptr noundef %75)
  %76 = load ptr, ptr @stdout, align 8
  %call.i.i190.1 = tail call i32 @putc(i32 noundef 32, ptr noundef %76)
  ...
  br i1 %cmp.not2.i, label %misc_PrintChar.exit200, label %for.body.i195

for.body.i195:                                    ; preds = %if.then, %for.body.i195
  %Counter.03.i196 = phi i32 [ %inc.i198, %for.body.i195 ], [ 1, %if.then ]
  %79 = load ptr, ptr @stdout, align 8
  %call.i.i197 = tail call i32 @putc(i32 noundef 32, ptr noundef %79)
  %inc.i198 = add i32 %Counter.03.i196, 1
  %cmp.not.i199 = icmp ugt i32 %inc.i198, %sub
  br i1 %cmp.not.i199, label %misc_PrintChar.exit200, label %for.body.i195

misc_PrintChar.exit200:                           ; preds = %for.body.i195, %if.then
  ...
  br i1 %cmp.not2.i202, label %misc_PrintChar.exit209, label %for.body.i204

for.body.i204:                                    ; preds = %misc_PrintChar.exit200, %for.body.i204
  %Counter.03.i205 = phi i32 [ %inc.i207, %for.body.i204 ], [ 1, %misc_PrintChar.exit200 ]
  %82 = load ptr, ptr @stdout, align 8
  %call.i.i206 = tail call i32 @putc(i32 noundef 32, ptr noundef %82)
  %inc.i207 = add i32 %Counter.03.i205, 1
  %cmp.not.i208 = icmp ugt i32 %inc.i207, %sub26
  br i1 %cmp.not.i208, label %misc_PrintChar.exit209, label %for.body.i204

misc_PrintChar.exit209:                           ; preds = %for.body.i204, %misc_PrintChar.exit200
  ...
  br i1 %cmp.not2.i211, label %misc_PrintChar.exit218, label %for.body.i213

for.body.i213:                                    ; preds = %misc_PrintChar.exit209, %for.body.i213
  %Counter.03.i214 = phi i32 [ %inc.i216, %for.body.i213 ], [ 1, %misc_PrintChar.exit209 ]
  %85 = load ptr, ptr @stdout, align 8
  %call.i.i215 = tail call i32 @putc(i32 noundef 32, ptr noundef %85)
  %inc.i216 = add i32 %Counter.03.i214, 1
  %cmp.not.i217 = icmp ugt i32 %inc.i216, %sub31
  br i1 %cmp.not.i217, label %misc_PrintChar.exit218, label %for.body.i213

misc_PrintChar.exit218:                           ; preds = %for.body.i213, %misc_PrintChar.exit209
  ...
  br i1 %cmp.not2.i220, label %misc_PrintChar.exit227, label %for.body.i222

for.body.i222:                                    ; preds = %misc_PrintChar.exit218, %for.body.i222
  %Counter.03.i223 = phi i32 [ %inc.i225, %for.body.i222 ], [ 1, %misc_PrintChar.exit218 ]
  %88 = load ptr, ptr @stdout, align 8
  %call.i.i224 = tail call i32 @putc(i32 noundef 32, ptr noundef %88)
  %inc.i225 = add i32 %Counter.03.i223, 1
  %cmp.not.i226 = icmp ugt i32 %inc.i225, %sub36
  br i1 %cmp.not.i226, label %misc_PrintChar.exit227, label %for.body.i222

misc_PrintChar.exit227:                           ; preds = %for.body.i222, %misc_PrintChar.exit218
  ...
  br i1 %cmp.not2.i229, label %misc_PrintChar.exit236, label %for.body.i231

for.body.i231:                                    ; preds = %misc_PrintChar.exit227, %for.body.i231
  %Counter.03.i232 = phi i32 [ %inc.i234, %for.body.i231 ], [ 1, %misc_PrintChar.exit227 ]
  %91 = load ptr, ptr @stdout, align 8
  %call.i.i233 = tail call i32 @putc(i32 noundef 32, ptr noundef %91)
  %inc.i234 = add i32 %Counter.03.i232, 1
  %cmp.not.i235 = icmp ugt i32 %inc.i234, %sub41
  br i1 %cmp.not.i235, label %misc_PrintChar.exit236, label %for.body.i231

misc_PrintChar.exit236:                           ; preds = %for.body.i231, %misc_PrintChar.exit227
  ...
  %call.i.i242 = tail call i32 @putc(i32 noundef 32, ptr noundef %94)
  %95 = load ptr, ptr @stdout, align 8
  %call.i.i242.1 = tail call i32 @putc(i32 noundef 32, ptr noundef %95)
  %96 = load ptr, ptr @stdout, align 8
  %call.i246 = tail call i32 @putc(i32 noundef 43, ptr noundef %96)
  %97 = load ptr, ptr @stdout, align 8
  %call.i.i250 = tail call i32 @putc(i32 noundef 45, ptr noundef %97)
  %98 = load ptr, ptr @stdout, align 8
  %call.i.i250.1 = tail call i32 @putc(i32 noundef 45, ptr noundef %98)
  %99 = load ptr, ptr @stdout, align 8
  %call.i.i250.2 = tail call i32 @putc(i32 noundef 45, ptr noundef %99)
  %100 = load ptr, ptr @stdout, align 8
  %call.i.i250.3 = tail call i32 @putc(i32 noundef 45, ptr noundef %100)
  %101 = load ptr, ptr @stdout, align 8
  %call.i.i250.4 = tail call i32 @putc(i32 noundef 45, ptr noundef %101)
  %102 = load ptr, ptr @stdout, align 8
  %call.i.i250.5 = tail call i32 @putc(i32 noundef 45, ptr noundef %102)
  ...
  %call.i.i258 = tail call i32 @putc(i32 noundef 45, ptr noundef %104)
  %105 = load ptr, ptr @stdout, align 8
  %call.i.i258.1 = tail call i32 @putc(i32 noundef 45, ptr noundef %105)
  %106 = load ptr, ptr @stdout, align 8
  %call.i.i258.2 = tail call i32 @putc(i32 noundef 45, ptr noundef %106)
  %107 = load ptr, ptr @stdout, align 8
  %call.i.i258.3 = tail call i32 @putc(i32 noundef 45, ptr noundef %107)
  %108 = load ptr, ptr @stdout, align 8
  %call.i.i258.4 = tail call i32 @putc(i32 noundef 45, ptr noundef %108)
  %109 = load ptr, ptr @stdout, align 8
  %call.i.i258.5 = tail call i32 @putc(i32 noundef 45, ptr noundef %109)
  %110 = load ptr, ptr @stdout, align 8
  %call.i.i258.6 = tail call i32 @putc(i32 noundef 45, ptr noundef %110)
  ...
  %call.i.i266 = tail call i32 @putc(i32 noundef 45, ptr noundef %112)
  %113 = load ptr, ptr @stdout, align 8
  %call.i.i266.1 = tail call i32 @putc(i32 noundef 45, ptr noundef %113)
  %114 = load ptr, ptr @stdout, align 8
  %call.i.i266.2 = tail call i32 @putc(i32 noundef 45, ptr noundef %114)
  %115 = load ptr, ptr @stdout, align 8
  %call.i.i266.3 = tail call i32 @putc(i32 noundef 45, ptr noundef %115)
  %116 = load ptr, ptr @stdout, align 8
  %call.i.i266.4 = tail call i32 @putc(i32 noundef 45, ptr noundef %116)
  %117 = load ptr, ptr @stdout, align 8
  %call.i.i266.5 = tail call i32 @putc(i32 noundef 45, ptr noundef %117)
  ...
  %call.i.i274 = tail call i32 @putc(i32 noundef 45, ptr noundef %119)
  %120 = load ptr, ptr @stdout, align 8
  %call.i.i274.1 = tail call i32 @putc(i32 noundef 45, ptr noundef %120)
  %121 = load ptr, ptr @stdout, align 8
  %call.i.i274.2 = tail call i32 @putc(i32 noundef 45, ptr noundef %121)
  %122 = load ptr, ptr @stdout, align 8
  %call.i.i274.3 = tail call i32 @putc(i32 noundef 45, ptr noundef %122)
  %123 = load ptr, ptr @stdout, align 8
  %call.i.i274.4 = tail call i32 @putc(i32 noundef 45, ptr noundef %123)
  %124 = load ptr, ptr @stdout, align 8
  %call.i.i274.5 = tail call i32 @putc(i32 noundef 45, ptr noundef %124)
  %125 = load ptr, ptr @stdout, align 8
  %call.i.i274.6 = tail call i32 @putc(i32 noundef 45, ptr noundef %125)
  %126 = load ptr, ptr @stdout, align 8
  %call.i.i274.7 = tail call i32 @putc(i32 noundef 45, ptr noundef %126)
  ...
  %call.i.i282 = tail call i32 @putc(i32 noundef 45, ptr noundef %128)
  %129 = load ptr, ptr @stdout, align 8
  %call.i.i282.1 = tail call i32 @putc(i32 noundef 45, ptr noundef %129)
  %130 = load ptr, ptr @stdout, align 8
  %call.i.i282.2 = tail call i32 @putc(i32 noundef 45, ptr noundef %130)
  %131 = load ptr, ptr @stdout, align 8
  %call.i.i282.3 = tail call i32 @putc(i32 noundef 45, ptr noundef %131)
  %132 = load ptr, ptr @stdout, align 8
  %call.i.i282.4 = tail call i32 @putc(i32 noundef 45, ptr noundef %132)
  %133 = load ptr, ptr @stdout, align 8
  %call.i.i282.5 = tail call i32 @putc(i32 noundef 45, ptr noundef %133)
  %134 = load ptr, ptr @stdout, align 8
  %call.i.i282.6 = tail call i32 @putc(i32 noundef 45, ptr noundef %134)
  %135 = load ptr, ptr @stdout, align 8
  %call.i.i282.7 = tail call i32 @putc(i32 noundef 45, ptr noundef %135)
  %136 = load ptr, ptr @stdout, align 8
  %call.i.i282.8 = tail call i32 @putc(i32 noundef 45, ptr noundef %136)
  %137 = load ptr, ptr @stdout, align 8
  %call.i.i282.9 = tail call i32 @putc(i32 noundef 45, ptr noundef %137)
  %138 = load ptr, ptr @stdout, align 8
  %call.i.i282.10 = tail call i32 @putc(i32 noundef 45, ptr noundef %138)
  %139 = load ptr, ptr @stdout, align 8
  %call.i.i282.11 = tail call i32 @putc(i32 noundef 45, ptr noundef %139)
  %140 = load ptr, ptr @stdout, align 8
  %call.i.i282.12 = tail call i32 @putc(i32 noundef 45, ptr noundef %140)
  %141 = load ptr, ptr @stdout, align 8
  %call.i.i282.13 = tail call i32 @putc(i32 noundef 45, ptr noundef %141)
  %142 = load ptr, ptr @stdout, align 8
  %call.i.i282.14 = tail call i32 @putc(i32 noundef 45, ptr noundef %142)
  %143 = load ptr, ptr @stdout, align 8
  %call.i.i282.15 = tail call i32 @putc(i32 noundef 45, ptr noundef %143)
  %144 = load ptr, ptr @stdout, align 8
  %call.i.i282.16 = tail call i32 @putc(i32 noundef 45, ptr noundef %144)
  %145 = load ptr, ptr @stdout, align 8
  %call.i.i282.17 = tail call i32 @putc(i32 noundef 45, ptr noundef %145)
  %146 = load ptr, ptr @stdout, align 8
  %call.i.i282.18 = tail call i32 @putc(i32 noundef 45, ptr noundef %146)
  %147 = load ptr, ptr @stdout, align 8
  %call.i.i282.19 = tail call i32 @putc(i32 noundef 45, ptr noundef %147)
  %148 = load ptr, ptr @stdout, align 8
  %call.i.i282.20 = tail call i32 @putc(i32 noundef 45, ptr noundef %148)
  %149 = load ptr, ptr @stdout, align 8
  %call.i.i282.21 = tail call i32 @putc(i32 noundef 45, ptr noundef %149)
  %150 = load ptr, ptr @stdout, align 8
  %call.i.i282.22 = tail call i32 @putc(i32 noundef 45, ptr noundef %150)
  %151 = load ptr, ptr @stdout, align 8
  %call.i.i282.23 = tail call i32 @putc(i32 noundef 45, ptr noundef %151)
  %152 = load ptr, ptr @stdout, align 8
  %call.i.i282.24 = tail call i32 @putc(i32 noundef 45, ptr noundef %152)
  %153 = load ptr, ptr @stdout, align 8
  %call.i.i282.25 = tail call i32 @putc(i32 noundef 45, ptr noundef %153)
  %154 = load ptr, ptr @stdout, align 8
  %call.i.i282.26 = tail call i32 @putc(i32 noundef 45, ptr noundef %154)
  %155 = load ptr, ptr @stdout, align 8
  %call.i.i282.27 = tail call i32 @putc(i32 noundef 45, ptr noundef %155)
  %156 = load ptr, ptr @stdout, align 8
  %call.i.i282.28 = tail call i32 @putc(i32 noundef 45, ptr noundef %156)
  %157 = load ptr, ptr @stdout, align 8
  %call.i.i282.29 = tail call i32 @putc(i32 noundef 45, ptr noundef %157)
  %158 = load ptr, ptr @stdout, align 8
  %call.i.i282.30 = tail call i32 @putc(i32 noundef 45, ptr noundef %158)
  %159 = load ptr, ptr @stdout, align 8
  %call.i.i282.31 = tail call i32 @putc(i32 noundef 45, ptr noundef %159)
  %160 = load ptr, ptr @stdout, align 8
  %call.i.i282.32 = tail call i32 @putc(i32 noundef 45, ptr noundef %160)
  %161 = load ptr, ptr @stdout, align 8
  %call.i.i282.33 = tail call i32 @putc(i32 noundef 45, ptr noundef %161)
  %162 = load ptr, ptr @stdout, align 8
  %call.i.i282.34 = tail call i32 @putc(i32 noundef 45, ptr noundef %162)
  %163 = load ptr, ptr @stdout, align 8
  %call.i.i282.35 = tail call i32 @putc(i32 noundef 45, ptr noundef %163)
  ...
  br i1 %cmp395, label %for.body.preheader, label %for.body.i347.preheader

for.body.preheader:                               ; preds = %misc_PrintChar.exit236
  %.pre398 = load ptr, ptr @symbol_SIGNATURE, align 8
  br label %for.body

for.body.i347.preheader:                          ; preds = %for.inc, %misc_PrintChar.exit236
  %167 = load ptr, ptr @stdout, align 8
  %call.i.i349 = tail call i32 @putc(i32 noundef 32, ptr noundef %167)
  %168 = load ptr, ptr @stdout, align 8
  %call.i.i349.1 = tail call i32 @putc(i32 noundef 32, ptr noundef %168)
  ...
  %call.i.i357 = tail call i32 @putc(i32 noundef 45, ptr noundef %170)
  %171 = load ptr, ptr @stdout, align 8
  %call.i.i357.1 = tail call i32 @putc(i32 noundef 45, ptr noundef %171)
  %172 = load ptr, ptr @stdout, align 8
  %call.i.i357.2 = tail call i32 @putc(i32 noundef 45, ptr noundef %172)
  %173 = load ptr, ptr @stdout, align 8
  %call.i.i357.3 = tail call i32 @putc(i32 noundef 45, ptr noundef %173)
  %174 = load ptr, ptr @stdout, align 8
  %call.i.i357.4 = tail call i32 @putc(i32 noundef 45, ptr noundef %174)
  %175 = load ptr, ptr @stdout, align 8
  %call.i.i357.5 = tail call i32 @putc(i32 noundef 45, ptr noundef %175)
  ...
  %call.i.i365 = tail call i32 @putc(i32 noundef 45, ptr noundef %177)
  %178 = load ptr, ptr @stdout, align 8
  %call.i.i365.1 = tail call i32 @putc(i32 noundef 45, ptr noundef %178)
  %179 = load ptr, ptr @stdout, align 8
  %call.i.i365.2 = tail call i32 @putc(i32 noundef 45, ptr noundef %179)
  %180 = load ptr, ptr @stdout, align 8
  %call.i.i365.3 = tail call i32 @putc(i32 noundef 45, ptr noundef %180)
  %181 = load ptr, ptr @stdout, align 8
  %call.i.i365.4 = tail call i32 @putc(i32 noundef 45, ptr noundef %181)
  %182 = load ptr, ptr @stdout, align 8
  %call.i.i365.5 = tail call i32 @putc(i32 noundef 45, ptr noundef %182)
  %183 = load ptr, ptr @stdout, align 8
  %call.i.i365.6 = tail call i32 @putc(i32 noundef 45, ptr noundef %183)
  ...
  %call.i.i373 = tail call i32 @putc(i32 noundef 45, ptr noundef %185)
  %186 = load ptr, ptr @stdout, align 8
  %call.i.i373.1 = tail call i32 @putc(i32 noundef 45, ptr noundef %186)
  %187 = load ptr, ptr @stdout, align 8
  %call.i.i373.2 = tail call i32 @putc(i32 noundef 45, ptr noundef %187)
  %188 = load ptr, ptr @stdout, align 8
  %call.i.i373.3 = tail call i32 @putc(i32 noundef 45, ptr noundef %188)
  %189 = load ptr, ptr @stdout, align 8
  %call.i.i373.4 = tail call i32 @putc(i32 noundef 45, ptr noundef %189)
  %190 = load ptr, ptr @stdout, align 8
  %call.i.i373.5 = tail call i32 @putc(i32 noundef 45, ptr noundef %190)
  ...
  %call.i.i381 = tail call i32 @putc(i32 noundef 45, ptr noundef %192)
  %193 = load ptr, ptr @stdout, align 8
  %call.i.i381.1 = tail call i32 @putc(i32 noundef 45, ptr noundef %193)
  %194 = load ptr, ptr @stdout, align 8
  %call.i.i381.2 = tail call i32 @putc(i32 noundef 45, ptr noundef %194)
  %195 = load ptr, ptr @stdout, align 8
  %call.i.i381.3 = tail call i32 @putc(i32 noundef 45, ptr noundef %195)
  %196 = load ptr, ptr @stdout, align 8
  %call.i.i381.4 = tail call i32 @putc(i32 noundef 45, ptr noundef %196)
  %197 = load ptr, ptr @stdout, align 8
  %call.i.i381.5 = tail call i32 @putc(i32 noundef 45, ptr noundef %197)
  %198 = load ptr, ptr @stdout, align 8
  %call.i.i381.6 = tail call i32 @putc(i32 noundef 45, ptr noundef %198)
  %199 = load ptr, ptr @stdout, align 8
  %call.i.i381.7 = tail call i32 @putc(i32 noundef 45, ptr noundef %199)
  ...
  %call.i.i389 = tail call i32 @putc(i32 noundef 45, ptr noundef %201)
  %202 = load ptr, ptr @stdout, align 8
  %call.i.i389.1 = tail call i32 @putc(i32 noundef 45, ptr noundef %202)
  %203 = load ptr, ptr @stdout, align 8
  %call.i.i389.2 = tail call i32 @putc(i32 noundef 45, ptr noundef %203)
  %204 = load ptr, ptr @stdout, align 8
  %call.i.i389.3 = tail call i32 @putc(i32 noundef 45, ptr noundef %204)
  %205 = load ptr, ptr @stdout, align 8
  %call.i.i389.4 = tail call i32 @putc(i32 noundef 45, ptr noundef %205)
  %206 = load ptr, ptr @stdout, align 8
  %call.i.i389.5 = tail call i32 @putc(i32 noundef 45, ptr noundef %206)
  %207 = load ptr, ptr @stdout, align 8
  %call.i.i389.6 = tail call i32 @putc(i32 noundef 45, ptr noundef %207)
  %208 = load ptr, ptr @stdout, align 8
  %call.i.i389.7 = tail call i32 @putc(i32 noundef 45, ptr noundef %208)
  %209 = load ptr, ptr @stdout, align 8
  %call.i.i389.8 = tail call i32 @putc(i32 noundef 45, ptr noundef %209)
  %210 = load ptr, ptr @stdout, align 8
  %call.i.i389.9 = tail call i32 @putc(i32 noundef 45, ptr noundef %210)
  %211 = load ptr, ptr @stdout, align 8
  %call.i.i389.10 = tail call i32 @putc(i32 noundef 45, ptr noundef %211)
  %212 = load ptr, ptr @stdout, align 8
  %call.i.i389.11 = tail call i32 @putc(i32 noundef 45, ptr noundef %212)
  %213 = load ptr, ptr @stdout, align 8
  %call.i.i389.12 = tail call i32 @putc(i32 noundef 45, ptr noundef %213)
  %214 = load ptr, ptr @stdout, align 8
  %call.i.i389.13 = tail call i32 @putc(i32 noundef 45, ptr noundef %214)
  %215 = load ptr, ptr @stdout, align 8
  %call.i.i389.14 = tail call i32 @putc(i32 noundef 45, ptr noundef %215)
  %216 = load ptr, ptr @stdout, align 8
  %call.i.i389.15 = tail call i32 @putc(i32 noundef 45, ptr noundef %216)
  %217 = load ptr, ptr @stdout, align 8
  %call.i.i389.16 = tail call i32 @putc(i32 noundef 45, ptr noundef %217)
  %218 = load ptr, ptr @stdout, align 8
  %call.i.i389.17 = tail call i32 @putc(i32 noundef 45, ptr noundef %218)
  %219 = load ptr, ptr @stdout, align 8
  %call.i.i389.18 = tail call i32 @putc(i32 noundef 45, ptr noundef %219)
  %220 = load ptr, ptr @stdout, align 8
  %call.i.i389.19 = tail call i32 @putc(i32 noundef 45, ptr noundef %220)
  %221 = load ptr, ptr @stdout, align 8
  %call.i.i389.20 = tail call i32 @putc(i32 noundef 45, ptr noundef %221)
  %222 = load ptr, ptr @stdout, align 8
  %call.i.i389.21 = tail call i32 @putc(i32 noundef 45, ptr noundef %222)
  %223 = load ptr, ptr @stdout, align 8
  %call.i.i389.22 = tail call i32 @putc(i32 noundef 45, ptr noundef %223)
  %224 = load ptr, ptr @stdout, align 8
  %call.i.i389.23 = tail call i32 @putc(i32 noundef 45, ptr noundef %224)
  %225 = load ptr, ptr @stdout, align 8
  %call.i.i389.24 = tail call i32 @putc(i32 noundef 45, ptr noundef %225)
  %226 = load ptr, ptr @stdout, align 8
  %call.i.i389.25 = tail call i32 @putc(i32 noundef 45, ptr noundef %226)
  %227 = load ptr, ptr @stdout, align 8
  %call.i.i389.26 = tail call i32 @putc(i32 noundef 45, ptr noundef %227)
  %228 = load ptr, ptr @stdout, align 8
  %call.i.i389.27 = tail call i32 @putc(i32 noundef 45, ptr noundef %228)
  %229 = load ptr, ptr @stdout, align 8
  %call.i.i389.28 = tail call i32 @putc(i32 noundef 45, ptr noundef %229)
  %230 = load ptr, ptr @stdout, align 8
  %call.i.i389.29 = tail call i32 @putc(i32 noundef 45, ptr noundef %230)
  %231 = load ptr, ptr @stdout, align 8
  %call.i.i389.30 = tail call i32 @putc(i32 noundef 45, ptr noundef %231)
  %232 = load ptr, ptr @stdout, align 8
  %call.i.i389.31 = tail call i32 @putc(i32 noundef 45, ptr noundef %232)
  %233 = load ptr, ptr @stdout, align 8
  %call.i.i389.32 = tail call i32 @putc(i32 noundef 45, ptr noundef %233)
  %234 = load ptr, ptr @stdout, align 8
  %call.i.i389.33 = tail call i32 @putc(i32 noundef 45, ptr noundef %234)
  %235 = load ptr, ptr @stdout, align 8
  %call.i.i389.34 = tail call i32 @putc(i32 noundef 45, ptr noundef %235)
  %236 = load ptr, ptr @stdout, align 8
  %call.i.i389.35 = tail call i32 @putc(i32 noundef 45, ptr noundef %236)
...
if.then53:                                        ; preds = %for.body
  ...
  %call.i.i291 = tail call i32 @putc(i32 noundef 32, ptr noundef %243)
  %244 = load ptr, ptr @stdout, align 8
  %call.i.i291.1 = tail call i32 @putc(i32 noundef 32, ptr noundef %244)
  ...
  %247 = zext i32 %and.i to i64
  %reltable.shift = shl i64 %247, 2
  %reltable.intrinsic = call ptr @llvm.load.relative.i64(ptr @reltable.symbol_PrintAll, i64 %reltable.shift)
  %call66 = tail call i32 @fputs(ptr noundef nonnull %reltable.intrinsic, ptr noundef %246)
  %sub68 = sub i32 6, %call66
  %cmp.not2.i296 = icmp eq i32 %call66, 6
  br i1 %cmp.not2.i296, label %misc_PrintChar.exit303, label %for.body.i298

for.body.i298:                                    ; preds = %if.then53, %for.body.i298
  %Counter.03.i299 = phi i32 [ %inc.i301, %for.body.i298 ], [ 1, %if.then53 ]
  %248 = load ptr, ptr @stdout, align 8
  %call.i.i300 = tail call i32 @putc(i32 noundef 32, ptr noundef %248)
  %inc.i301 = add i32 %Counter.03.i299, 1
  %cmp.not.i302 = icmp ugt i32 %inc.i301, %sub68
  br i1 %cmp.not.i302, label %misc_PrintChar.exit303, label %for.body.i298

misc_PrintChar.exit303:                           ; preds = %for.body.i298, %if.then53
  ...
  br i1 %cmp.not2.i305, label %misc_PrintChar.exit312, label %for.body.i307

for.body.i307:                                    ; preds = %misc_PrintChar.exit303, %for.body.i307
  %Counter.03.i308 = phi i32 [ %inc.i310, %for.body.i307 ], [ 1, %misc_PrintChar.exit303 ]
  %251 = load ptr, ptr @stdout, align 8
  %call.i.i309 = tail call i32 @putc(i32 noundef 32, ptr noundef %251)
  %inc.i310 = add i32 %Counter.03.i308, 1
  %cmp.not.i311 = icmp ugt i32 %inc.i310, %sub73
  br i1 %cmp.not.i311, label %misc_PrintChar.exit312, label %for.body.i307

misc_PrintChar.exit312:                           ; preds = %for.body.i307, %misc_PrintChar.exit303
  %252 = load ptr, ptr @stdout, align 8
  %call.i313 = tail call i32 @putc(i32 noundef 124, ptr noundef %252)
  %cmp77 = icmp eq i32 %and.i, 1
  br i1 %cmp77, label %if.then78, label %for.body.i320.preheader
...
if.then78:                                        ; preds = %misc_PrintChar.exit312
  ...
  br i1 %cmp.not2.i318, label %misc_PrintChar.exit325, label %for.body.i320.preheader

for.body.i320.preheader:                          ; preds = %misc_PrintChar.exit312, %if.then78
  %sub87403 = phi i32 [ %sub87, %if.then78 ], [ 6, %misc_PrintChar.exit312 ]
  br label %for.body.i320

for.body.i320:                                    ; preds = %for.body.i320.preheader, %for.body.i320
  %Counter.03.i321 = phi i32 [ %inc.i323, %for.body.i320 ], [ 1, %for.body.i320.preheader ]
  %255 = load ptr, ptr @stdout, align 8
  %call.i.i322 = tail call i32 @putc(i32 noundef 32, ptr noundef %255)
  %inc.i323 = add i32 %Counter.03.i321, 1
  %cmp.not.i324 = icmp ugt i32 %inc.i323, %sub87403
  br i1 %cmp.not.i324, label %misc_PrintChar.exit325, label %for.body.i320

misc_PrintChar.exit325:                           ; preds = %for.body.i320, %if.then78
  ...
  br i1 %cmp.not2.i327, label %misc_PrintChar.exit334, label %for.body.i329

for.body.i329:                                    ; preds = %misc_PrintChar.exit325, %for.body.i329
  %Counter.03.i330 = phi i32 [ %inc.i332, %for.body.i329 ], [ 1, %misc_PrintChar.exit325 ]
  %258 = load ptr, ptr @stdout, align 8
  %call.i.i331 = tail call i32 @putc(i32 noundef 32, ptr noundef %258)
  %inc.i332 = add i32 %Counter.03.i330, 1
  %cmp.not.i333 = icmp ugt i32 %inc.i332, %sub92
  br i1 %cmp.not.i333, label %misc_PrintChar.exit334, label %for.body.i329

misc_PrintChar.exit334:                           ; preds = %for.body.i329, %misc_PrintChar.exit325
  ...
  br i1 %cmp.not2.i336, label %misc_PrintChar.exit343, label %for.body.i338

for.body.i338:                                    ; preds = %misc_PrintChar.exit334, %for.body.i338
  %Counter.03.i339 = phi i32 [ %inc.i341, %for.body.i338 ], [ 1, %misc_PrintChar.exit334 ]
  %261 = load ptr, ptr @stdout, align 8
  %call.i.i340 = tail call i32 @putc(i32 noundef 32, ptr noundef %261)
  %inc.i341 = add i32 %Counter.03.i339, 1
  %cmp.not.i342 = icmp ugt i32 %inc.i341, %sub97
  br i1 %cmp.not.i342, label %misc_PrintChar.exit343, label %for.body.i338

misc_PrintChar.exit343:                           ; preds = %for.body.i338, %misc_PrintChar.exit334
...
for.inc:                                          ; preds = %for.body, %misc_PrintChar.exit343
  ...
  br i1 %cmp, label %for.body, label %for.body.i347.preheader

if.end108:                                        ; preds = %for.body.i347.preheader, %entry
  ret void
}
