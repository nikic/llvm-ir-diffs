...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  br i1 %cmp.not.not.i, label %for.body.i, label %clause_GetLiteralList.exit
...
while.body.i17:                                   ; preds = %list_Delete.exit, %while.body.i17
  ...
  br i1 %cmp.i.not.i23, label %list_Delete.exit24, label %while.body.i17
...
while.cond.i62.i:                                 ; preds = %while.cond.i62.i, %clause_LiteralGetIndex.exit.i
  ...
  br i1 %cmp.not.i65.i, label %clause_LiteralGetIndex.exit67.i, label %while.cond.i62.i
...
if.end.i.i:                                       ; preds = %if.then.i.i, %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i, label %while.end.i.i, label %while.body.i.i
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  ...
  br i1 %cmp31.i.i, label %for.body.i.i, label %while.cond34.preheader.i.i

while.cond34.loopexit.i.i:                        ; preds = %for.body45.i.i, %while.body38.i.i
  %cmp.i103.not.i.i = icmp eq ptr %List.addr.0.val.i.i, null
  br i1 %cmp.i103.not.i.i, label %while.body.i75.i, label %while.body38.i.i
...
while.body.i75.i:                                 ; preds = %while.cond34.loopexit.i.i, %while.body.i75.i
  ...
  br i1 %cmp.i.not.i76.i, label %return, label %while.body.i75.i
...
for.inc35.us.i:                                   ; preds = %for.inc32.us.us.i, %for.body.us.i
  ...
  br i1 %cmp.i.not.us.i, label %red_GetTerminatorPartnerLits.exit, label %for.body.us.i
...
for.inc32.us.us.i:                                ; preds = %for.inc.us.us.us.i, %if.then.us.us.i, %for.body11.us.us.i
  ...
  br i1 %cmp.i51.not.us.us.i, label %for.inc35.us.i, label %for.body11.us.us.i
...
for.inc.us.us.us.i:                               ; preds = %land.lhs.true.us.us.us.i, %lor.rhs.i.us.us.us.i, %land.lhs.true.i.us.us.us.i
  ...
  br i1 %cmp.i53.not.us.us.us.i, label %for.inc32.us.us.i, label %for.body21.us.us.us.i
...
for.inc.i:                                        ; preds = %if.then28.i, %land.lhs.true.i, %lor.rhs.i.i, %land.lhs.true.i.i
  ...
  br i1 %cmp.i53.not.i, label %for.inc32.i, label %for.body21.i
...
for.inc32.i:                                      ; preds = %for.inc.i, %if.then.i111, %for.body11.i
  ...
  br i1 %cmp.i51.not.i, label %for.inc35.i, label %for.body11.i
...
for.inc35.i:                                      ; preds = %for.inc32.i, %for.body.i105
  ...
  br i1 %cmp.i.not.i110, label %red_GetTerminatorPartnerLits.exit, label %for.body.i105
...
for.inc.i129:                                     ; preds = %if.then.i124, %for.body.i122
  ...
  br i1 %cmp.not.not.i, label %for.body.i122, label %clause_GetLiteralListExcept.exit
...
for.cond.i:                                       ; preds = %if.end.i, %for.cond.i
  ...
  br i1 %cmp.i20.not.i, label %for.end.i135, label %for.cond.i
...
for.cond.i149:                                    ; preds = %if.end.i148, %for.cond.i149
  ...
  br i1 %cmp4.not.i, label %for.end.i150, label %for.cond.i149
...
while.body.i152:                                  ; preds = %subst_NUnion.exit, %while.body.i152
  ...
  br i1 %cmp.i.not.i156, label %list_Delete.exit, label %while.body.i152
...
while.body.i171:                                  ; preds = %if.else57, %while.body.i171
  ...
  br i1 %cmp.i.not.i177, label %list_Delete.exit178, label %while.body.i171
