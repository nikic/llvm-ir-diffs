; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/component.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/component.c"
...
while.body.i.i:                                   ; preds = %for.body, %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i, label %literal_Delete.exit, label %while.body.i.i
...
if.end:                                           ; preds = %entry, %if.else25.i, %if.end23.i
  ...
  %total_size.i20 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %28, i64 0, i32 4
  %29 = load i32, ptr %total_size.i20, align 8
  %conv26.i21 = sext i32 %29 to i64
  %30 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i22 = add i64 %30, %conv26.i21
  store i64 %add27.i22, ptr @memory_FREEDBYTES, align 8
...
for.body:                                         ; preds = %for.cond.preheader, %for.inc
  %j.0142 = phi i32 [ 0, %for.cond.preheader ], [ %inc, %for.inc ]
  %compindexlist.0141 = phi ptr [ null, %for.cond.preheader ], [ %compindexlist.1, %for.inc ]
  %complist.0140 = phi ptr [ null, %for.cond.preheader ], [ %complist.1, %for.inc ]
  %call4 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.10, i32 noundef %j.0142)
  %litptr.val117 = load ptr, ptr %litptr, align 8
  %idxprom.i = sext i32 %j.0142 to i64
...
if.then7:                                         ; preds = %for.body
  ...
  store ptr %compindexlist.0141, ptr %call.i118, align 8
...
for.inc:                                          ; preds = %for.body, %if.then7
  %complist.1 = phi ptr [ %complist.0140, %for.body ], [ %call.i, %if.then7 ]
  %compindexlist.1 = phi ptr [ %compindexlist.0141, %for.body ], [ %call.i118, %if.then7 ]
  %j.1 = phi i32 [ %j.0142, %for.body ], [ %add, %if.then7 ]
...
for.cond20.preheader.us:                          ; preds = %for.end62.us, %for.cond20.preheader.us.preheader
  %compindexlist.2161.us = phi ptr [ %compindexlist.1, %for.cond20.preheader.us.preheader ], [ %compindexlist.5.us.us, %for.end62.us ]
  %complist.2160.us = phi ptr [ %complist.1, %for.cond20.preheader.us.preheader ], [ %complist.5.us.us, %for.end62.us ]
  %cmp.i.not150.us = icmp eq ptr %complist.2160.us, null
  br i1 %cmp.i.not150.us, label %cleanup, label %for.body23.us.us
...
if.then64.us:                                     ; preds = %for.end62.us
  ...
  br i1 %cmp.i.not5.i130.us, label %cleanup, label %while.body.i131.us

while.body.i131.us:                               ; preds = %if.then64.us, %while.body.i131.us
  %Current.06.i132.us = phi ptr [ %Current.0.val.i133.us, %while.body.i131.us ], [ %complist.5.us.us, %if.then64.us ]
  %Current.0.val.i133.us = load ptr, ptr %Current.06.i132.us, align 8
  %8 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i134.us = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %8, i64 0, i32 4
  %9 = load i32, ptr %total_size.i.i.i134.us, align 8
  %conv26.i.i.i135.us = sext i32 %9 to i64
  %10 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i136.us = add i64 %10, %conv26.i.i.i135.us
  store i64 %add27.i.i.i136.us, ptr @memory_FREEDBYTES, align 8
  %11 = load ptr, ptr %8, align 8
  store ptr %11, ptr %Current.06.i132.us, align 8
  %12 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i132.us, ptr %12, align 8
  %cmp.i.not.i137.us = icmp eq ptr %Current.0.val.i133.us, null
  br i1 %cmp.i.not.i137.us, label %if.end65.us, label %while.body.i131.us

if.end65.us:                                      ; preds = %while.body.i131.us
  br label %cleanup

for.body23.us.us:                                 ; preds = %for.cond20.preheader.us, %for.cond25.for.inc60_crit_edge.us.us
  %found.1154.us.us = phi i32 [ %found.3.us.us, %for.cond25.for.inc60_crit_edge.us.us ], [ 0, %for.cond20.preheader.us ]
  %compindexlist.3153.us.us = phi ptr [ %compindexlist.5.us.us, %for.cond25.for.inc60_crit_edge.us.us ], [ %compindexlist.2161.us, %for.cond20.preheader.us ]
  %complist.3152.us.us = phi ptr [ %complist.5.us.us, %for.cond25.for.inc60_crit_edge.us.us ], [ %complist.2160.us, %for.cond20.preheader.us ]
  %scan.0151.us.us = phi ptr [ %scan.0.val.us.us, %for.cond25.for.inc60_crit_edge.us.us ], [ %complist.2160.us, %for.cond20.preheader.us ]
  %13 = getelementptr i8, ptr %scan.0151.us.us, i64 8
...
for.body28.us.us:                                 ; preds = %for.inc57.us.us, %for.body23.us.us
  ...
  %found.2146.us.us = phi i32 [ %found.3.us.us, %for.inc57.us.us ], [ %found.1154.us.us, %for.body23.us.us ]
  %compindexlist.4145.us.us = phi ptr [ %compindexlist.5.us.us, %for.inc57.us.us ], [ %compindexlist.3153.us.us, %for.body23.us.us ]
  %complist.4144.us.us = phi ptr [ %complist.5.us.us, %for.inc57.us.us ], [ %complist.3152.us.us, %for.body23.us.us ]
...
if.then44.us.us:                                  ; preds = %if.then32.us.us
  ...
  store ptr %complist.4144.us.us, ptr %call.i124.us.us, align 8
  ...
  store ptr %compindexlist.4145.us.us, ptr %call.i126.us.us, align 8
...
for.inc57.us.us:                                  ; preds = %if.then44.us.us, %if.then32.us.us, %for.body28.us.us
  %complist.5.us.us = phi ptr [ %complist.4144.us.us, %for.body28.us.us ], [ %call.i124.us.us, %if.then44.us.us ], [ %complist.4144.us.us, %if.then32.us.us ]
  %compindexlist.5.us.us = phi ptr [ %compindexlist.4145.us.us, %for.body28.us.us ], [ %call.i126.us.us, %if.then44.us.us ], [ %compindexlist.4145.us.us, %if.then32.us.us ]
  %found.3.us.us = phi i32 [ %found.2146.us.us, %for.body28.us.us ], [ 1, %if.then44.us.us ], [ %found.2146.us.us, %if.then32.us.us ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.cond25.for.inc60_crit_edge.us.us, label %for.body28.us.us

for.cond25.for.inc60_crit_edge.us.us:             ; preds = %for.inc57.us.us
  %scan.0.val.us.us = load ptr, ptr %scan.0151.us.us, align 8
  %cmp.i.not.us.us = icmp eq ptr %scan.0.val.us.us, null
  br i1 %cmp.i.not.us.us, label %for.end62.us, label %for.body23.us.us
...
cleanup:                                          ; preds = %for.cond20.preheader.us, %while.body.i, %if.then64.us, %if.end65.us, %if.then17, %entry
  %retval.0 = phi ptr [ null, %entry ], [ %compindexlist.1, %if.then17 ], [ %compindexlist.5.us.us, %if.then64.us ], [ %compindexlist.5.us.us, %if.end65.us ], [ %compindexlist.1, %while.body.i ], [ %compindexlist.2161.us, %for.cond20.preheader.us ]
  ret ptr %retval.0
}
