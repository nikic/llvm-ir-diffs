...
for.inc.us40:                                     ; preds = %land.lhs.true.us36, %if.then26.us37, %lor.rhs.i.us31
  ...
  br i1 %cmp.i46.not.us43, label %for.inc30.us, label %for.body15.us14, !llvm.loop !13
...
for.inc30.us:                                     ; preds = %for.inc.us40, %if.then.us, %for.body.us
  ...
  br i1 %cmp.i.not.us, label %for.end32, label %for.body.us, !llvm.loop !14
...
for.inc.us:                                       ; preds = %if.then26.us, %land.lhs.true.us, %lor.rhs.i.us
  ...
  br i1 %cmp.i46.not.us, label %for.inc30, label %for.body15.us, !llvm.loop !13
...
for.inc30:                                        ; preds = %for.inc.us, %if.then, %for.body
  ...
  br i1 %cmp.i.not, label %for.end32, label %for.body, !llvm.loop !14
...
while.cond.i92.i:                                 ; preds = %while.cond.i92.i, %clause_LiteralGetIndex.exit.i
  ...
  br i1 %cmp.not.i95.i, label %clause_LiteralGetIndex.exit97.i, label %while.cond.i92.i, !llvm.loop !5
...
while.cond34.loopexit.i.i:                        ; preds = %for.body45.i.i, %while.body38.i.i
  ...
  br i1 %cmp.i103.not.i.i, label %while.body.i111.i, label %while.body38.i.i, !llvm.loop !18
...
while.body.i111.i:                                ; preds = %while.cond34.loopexit.i.i, %while.body.i111.i
  ...
  br i1 %cmp.i.not.i117.i, label %inf_CreateURUnitResolvent.exit, label %while.body.i111.i, !llvm.loop !11
...
while.body.i119:                                  ; preds = %while.end, %while.body.i119
  ...
  br i1 %cmp.i.not.i123, label %list_Delete.exit, label %while.body.i119, !llvm.loop !11
