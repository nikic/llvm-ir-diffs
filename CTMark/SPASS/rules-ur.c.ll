; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/rules-ur.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/rules-ur.c"
...
@.str.1 = private unnamed_addr constant [59 x i8] c"/home/npopov/repos/llvm-test-suite/CTMark/SPASS/rules-ur.c\00", align 1
...
clause_LiteralGetIndex.exit:                      ; preds = %while.cond.i
  ...
  br i1 %cmp.i.not.i70, label %if.then.i72, label %clause_LiteralAtom.exit75

if.then.i72:                                      ; preds = %clause_LiteralGetIndex.exit
  %19 = getelementptr i8, ptr %call12.val, i64 16
  %call1.val.i73 = load ptr, ptr %19, align 8
  %20 = getelementptr i8, ptr %call1.val.i73, i64 8
  %call1.val.val.i74 = load ptr, ptr %20, align 8
  br label %clause_LiteralAtom.exit75

clause_LiteralAtom.exit75:                        ; preds = %clause_LiteralGetIndex.exit, %if.then.i72
  %retval.0.i71 = phi ptr [ %call1.val.val.i74, %if.then.i72 ], [ %call12.val, %clause_LiteralGetIndex.exit ]
  %21 = load ptr, ptr @cont_RIGHTCONTEXT, align 8
  %call24 = call i32 @unify_UnifyNoOC(ptr noundef %16, ptr noundef %retval.0.i71, ptr noundef %21, ptr noundef %call9) #11
...
for.inc.i.i:                                      ; preds = %if.then.i.i, %for.body.i.i
  ...
  br i1 %cmp.not.not.i.i, label %for.body.i.i, label %clause_GetLiteralListExcept.exit.i

clause_GetLiteralListExcept.exit.i:               ; preds = %for.inc.i.i
  %37 = icmp slt i32 %sub.i.i.i, 0
  br i1 %37, label %for.end.i, label %for.body.lr.ph.i

for.body.lr.ph.i:                                 ; preds = %clause_GetLiteralListExcept.exit.i
  %38 = add i32 %add.i.i.i.i, %Clause.val.i.i.i.i
...
if.then.i79:                                      ; preds = %for.body.i
  ...
  %arrayidx.i.i80 = getelementptr inbounds ptr, ptr %Clause.val25.i, i64 %indvars.iv.i78
  %39 = load ptr, ptr %arrayidx.i.i80, align 8
  %call6.i = call ptr @list_PointerDeleteOneElement(ptr noundef %RestLits.030.i, ptr noundef %39) #11
  %40 = trunc i64 %indvars.iv.i78 to i32
  %call7.i = call fastcc ptr @inf_SearchURResolvents(ptr noundef %L.val.i, i32 noundef %40, ptr noundef nonnull %call.i.i76, ptr noundef %call6.i, ptr noundef %30, i32 noundef %spec.select, ptr noundef nonnull %Index, ptr noundef %Flags, ptr noundef %Precedence)
  %cmp.i.not.i.i = icmp eq ptr %call7.i, null
  br i1 %cmp.i.not.i.i, label %list_Nconc.exit.i, label %if.end.i.i

if.end.i.i:                                       ; preds = %if.then.i79
...
list_Nconc.exit.i:                                ; preds = %for.end.i.i, %if.end.i.i, %if.then.i79
  %retval.0.i.i = phi ptr [ %call7.i, %for.end.i.i ], [ %Result.032.i, %if.then.i79 ], [ %call7.i, %if.end.i.i ]
  %Clause.val.i81 = load ptr, ptr %13, align 8
  %arrayidx.i27.i = getelementptr inbounds ptr, ptr %Clause.val.i81, i64 %indvars.iv.i78
  %41 = load ptr, ptr %arrayidx.i27.i, align 8
  ...
  store ptr %41, ptr %car.i.i83, align 8
...
while.body.i.i:                                   ; preds = %for.end.i, %while.body.i.i
  ...
  %total_size.i.i.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %42, i64 0, i32 4
  %43 = load i32, ptr %total_size.i.i.i.i, align 8
  %conv26.i.i.i.i = sext i32 %43 to i64
  %44 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i = add i64 %44, %conv26.i.i.i.i
  store i64 %add27.i.i.i.i, ptr @memory_FREEDBYTES, align 8
  %45 = load ptr, ptr %42, align 8
  store ptr %45, ptr %Current.06.i.i, align 8
  %46 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i, ptr %46, align 8
  %cmp.i.not.i28.i = icmp eq ptr %Current.0.val.i.i, null
  br i1 %cmp.i.not.i28.i, label %inf_NonUnitURResolution.exit, label %while.body.i.i
...
for.cond.i:                                       ; preds = %if.end.i, %for.cond.i
  ...
  br i1 %cmp.i20.not.i, label %for.end.i86, label %for.cond.i
...
list_Nconc.exit:                                  ; preds = %cont_Reset.exit, %inf_NonUnitURResolution.exit, %if.end.i, %for.end.i86
  ...
  %47 = load ptr, ptr %LeftSubst, align 8
...
for.end:                                          ; preds = %list_Nconc.exit, %while.cond
  ...
  %53 = load i32, ptr @fol_EQUALITY, align 4
  %cmp.i89 = icmp ne i32 %53, %call9.val
...
if.else36:                                        ; preds = %for.end
  ...
  %54 = getelementptr i8, ptr %T.val.i, i64 8
  %T.val.val.i = load ptr, ptr %54, align 8
  %T.val10.val.i = load ptr, ptr %T.val.i, align 8
  %55 = getelementptr i8, ptr %T.val10.val.i, i64 8
  %T.val10.val.val.i = load ptr, ptr %55, align 8
  store ptr %T.val10.val.val.i, ptr %54, align 8
...
for.inc.i:                                        ; preds = %if.then.i, %for.body.i
  ...
  br i1 %cmp.not.not.i, label %for.body.i, label %clause_GetLiteralListExcept.exit
...
for.body.lr.ph:                                   ; preds = %clause_GetLiteralListExcept.exit
  ...
  %9 = zext i32 %SpecialLitIndex to i64
  %10 = add i32 %Clause.val.i.i.i, %Clause.val6.i.i.i
  %11 = add i32 %10, %Clause.val7.i.i.i
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %cmp4.not = icmp eq i64 %indvars.iv, %9
  br i1 %cmp4.not, label %for.inc, label %if.then

if.then:                                          ; preds = %for.body
  %Clause.val25 = load ptr, ptr %8, align 8
  %arrayidx.i = getelementptr inbounds ptr, ptr %Clause.val25, i64 %indvars.iv
  %12 = load ptr, ptr %arrayidx.i, align 8
  %call6 = tail call ptr @list_PointerDeleteOneElement(ptr noundef %RestLits.030, ptr noundef %12) #11
  %13 = trunc i64 %indvars.iv to i32
  %call7 = tail call fastcc ptr @inf_SearchURResolvents(ptr noundef %Clause, i32 noundef %13, ptr noundef %FoundMap, ptr noundef %call6, ptr noundef %Subst, i32 noundef %GlobalMaxVar, ptr noundef %Index, ptr noundef %Flags, ptr noundef %Precedence)
...
list_Nconc.exit:                                  ; preds = %if.then, %if.end.i, %for.end.i
  ...
  %Clause.val = load ptr, ptr %8, align 8
  %arrayidx.i27 = getelementptr inbounds ptr, ptr %Clause.val, i64 %indvars.iv
  %14 = load ptr, ptr %arrayidx.i27, align 8
...
while.body.i:                                     ; preds = %for.end, %while.body.i
  ...
  br i1 %cmp.i.not.i28, label %list_Delete.exit, label %while.body.i

list_Delete.exit:                                 ; preds = %while.body.i, %entry, %for.end
  %Result.0.lcssa48 = phi ptr [ %Result.0.lcssa, %for.end ], [ null, %entry ], [ %Result.0.lcssa, %while.body.i ]
  ret ptr %Result.0.lcssa48
}
...
if.then.us:                                       ; preds = %for.body.us
  ...
  br i1 %cmp.i46.not7.us, label %for.inc30.us, label %for.body15.us14.preheader

for.body15.us14.preheader:                        ; preds = %if.then.us
  %.pre53 = load i32, ptr @fol_NOT, align 4
  br label %for.body15.us14

for.body15.us14:                                  ; preds = %for.body15.us14.preheader, %for.inc.us40
  %4 = phi i32 [ %11, %for.inc.us40 ], [ %.pre53, %for.body15.us14.preheader ]
  %Result.19.us15 = phi ptr [ %Result.2.us41, %for.inc.us40 ], [ %Result.012.us, %for.body15.us14.preheader ]
  %LitScan.08.us16 = phi ptr [ %LitScan.0.val45.us42, %for.inc.us40 ], [ %call10.us, %for.body15.us14.preheader ]
  %5 = getelementptr i8, ptr %LitScan.08.us16, i64 8
  %LitScan.0.val.us17 = load ptr, ptr %5, align 8
  %6 = getelementptr i8, ptr %LitScan.0.val.us17, i64 16
  %call16.val.us18 = load ptr, ptr %6, align 8
  %7 = getelementptr i8, ptr %call16.val.us18, i64 64
  %Clause.val.i.us19 = load i32, ptr %7, align 8
  %8 = getelementptr i8, ptr %call16.val.us18, i64 68
  %Clause.val6.i.us20 = load i32, ptr %8, align 4
  %add.i.us21 = add nsw i32 %Clause.val6.i.us20, %Clause.val.i.us19
  %9 = getelementptr i8, ptr %call16.val.us18, i64 72
  %Clause.val7.i.us22 = load i32, ptr %9, align 8
  %add3.i.us23 = add nsw i32 %add.i.us21, %Clause.val7.i.us22
  %Lit.val.us24 = load ptr, ptr %2, align 8
  %Lit.val.val.us25 = load i32, ptr %Lit.val.us24, align 8
  %cmp.i.not.i.us26 = icmp eq i32 %4, %Lit.val.val.us25
  %10 = getelementptr i8, ptr %LitScan.0.val.us17, i64 24
  %L2.val10.i.us27 = load ptr, ptr %10, align 8
  %L2.val10.val.i.us28 = load i32, ptr %L2.val10.i.us27, align 8
  br i1 %cmp.i.not.i.us26, label %land.lhs.true.i.us29, label %lor.rhs.i.us31

land.lhs.true.i.us29:                             ; preds = %for.body15.us14
  %cmp.i.i.not.i.us30 = icmp eq i32 %L2.val10.val.i.us28, %4
  br i1 %cmp.i.i.not.i.us30, label %lor.rhs.i.us31, label %land.lhs.true.us36

lor.rhs.i.us31:                                   ; preds = %land.lhs.true.i.us29, %for.body15.us14
  %L2.val.val.i.us32 = phi i32 [ %4, %land.lhs.true.i.us29 ], [ %L2.val10.val.i.us28, %for.body15.us14 ]
  %cmp.i11.not.i.us33 = icmp eq i32 %4, %L2.val.val.i.us32
  %cmp.i.i13.i.not.us34 = icmp ne i32 %4, %Lit.val.val.us25
  %or.cond6.us35.not51 = and i1 %cmp.i.i13.i.not.us34, %cmp.i11.not.i.us33
  %cmp.us = icmp eq i32 %add3.i.us23, 1
  %or.cond49 = select i1 %or.cond6.us35.not51, i1 %cmp.us, i1 false
  br i1 %or.cond49, label %if.then26.us37, label %for.inc.us40

land.lhs.true.us36:                               ; preds = %land.lhs.true.i.us29
  %cmp.us.old = icmp eq i32 %add3.i.us23, 1
  br i1 %cmp.us.old, label %if.then26.us37, label %for.inc.us40

if.then26.us37:                                   ; preds = %lor.rhs.i.us31, %land.lhs.true.us36
  %call.i.us38 = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.us39 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.us38, i64 0, i32 1
  store ptr %LitScan.0.val.us17, ptr %car.i.us39, align 8
  store ptr %Result.19.us15, ptr %call.i.us38, align 8
  %.pre = load i32, ptr @fol_NOT, align 4
  br label %for.inc.us40

for.inc.us40:                                     ; preds = %land.lhs.true.us36, %if.then26.us37, %lor.rhs.i.us31
  %11 = phi i32 [ %.pre, %if.then26.us37 ], [ %4, %lor.rhs.i.us31 ], [ %4, %land.lhs.true.us36 ]
  %Result.2.us41 = phi ptr [ %call.i.us38, %if.then26.us37 ], [ %Result.19.us15, %lor.rhs.i.us31 ], [ %Result.19.us15, %land.lhs.true.us36 ]
  %LitScan.0.val45.us42 = load ptr, ptr %LitScan.08.us16, align 8
  %cmp.i46.not.us43 = icmp eq ptr %LitScan.0.val45.us42, null
  br i1 %cmp.i46.not.us43, label %for.inc30.us, label %for.body15.us14

for.inc30.us:                                     ; preds = %for.inc.us40, %if.then.us, %for.body.us
  %Result.3.us = phi ptr [ %Result.012.us, %for.body.us ], [ %Result.012.us, %if.then.us ], [ %Result.2.us41, %for.inc.us40 ]
  ...
  %total_size.i.i.i.us = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %12, i64 0, i32 4
  %13 = load i32, ptr %total_size.i.i.i.us, align 8
  %conv26.i.i.i.us = sext i32 %13 to i64
  %14 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.us = add i64 %14, %conv26.i.i.i.us
  store i64 %add27.i.i.i.us, ptr @memory_FREEDBYTES, align 8
  %15 = load ptr, ptr %12, align 8
  store ptr %15, ptr %Unifiers.011.us, align 8
  %16 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Unifiers.011.us, ptr %16, align 8
  %cmp.i.not.us = icmp eq ptr %L.val.i.us, null
  br i1 %cmp.i.not.us, label %for.end32, label %for.body.us
...
for.body15.us.preheader:                          ; preds = %if.then
  %.pre55 = load i32, ptr @fol_NOT, align 4
  br label %for.body15.us

for.body15.us:                                    ; preds = %for.body15.us.preheader, %for.inc.us
  %18 = phi i32 [ %25, %for.inc.us ], [ %.pre55, %for.body15.us.preheader ]
...
lor.rhs.i.us:                                     ; preds = %land.lhs.true.i.us, %for.body15.us
  ...
  %or.cond6.us.not50 = and i1 %cmp.i.i13.i.not.us, %cmp.i11.not.i.us
  %cmp25.us = icmp ne i32 %add3.i.us, 1
  %or.cond = select i1 %or.cond6.us.not50, i1 %cmp25.us, i1 false
...
if.then26.us:                                     ; preds = %lor.rhs.i.us, %land.lhs.true.us
  ...
  %.pre54 = load i32, ptr @fol_NOT, align 4
  br label %for.inc.us

for.inc.us:                                       ; preds = %if.then26.us, %land.lhs.true.us, %lor.rhs.i.us
  %25 = phi i32 [ %.pre54, %if.then26.us ], [ %18, %land.lhs.true.us ], [ %18, %lor.rhs.i.us ]
  ...
  br i1 %cmp.i46.not.us, label %for.inc30, label %for.body15.us
...
while.cond.i92.i:                                 ; preds = %while.cond.i92.i, %clause_LiteralGetIndex.exit.i
  %indvars.iv.i93.i = phi i64 [ %indvars.iv.next.i96.i, %while.cond.i92.i ], [ 0, %clause_LiteralGetIndex.exit.i ]
  %arrayidx.i.i94.i = getelementptr inbounds ptr, ptr %call.val.i91.i, i64 %indvars.iv.i93.i
  %28 = load ptr, ptr %arrayidx.i.i94.i, align 8
  %cmp.not.i95.i = icmp eq ptr %28, %call30.val.i
  %indvars.iv.next.i96.i = add nuw i64 %indvars.iv.i93.i, 1
  br i1 %cmp.not.i95.i, label %clause_LiteralGetIndex.exit97.i, label %while.cond.i92.i

clause_LiteralGetIndex.exit97.i:                  ; preds = %while.cond.i92.i
  %sext120.i = shl i64 %indvars.iv.i93.i, 32
  ...
  br i1 %cmp.i.not.i, label %while.body.lr.ph.i.i, label %for.body.i
...
while.body.i102.i:                                ; preds = %if.end.i.i, %while.body.lr.ph.i.i
  %spec.select105109.i.i = phi i32 [ %.promoted.i.i, %while.body.lr.ph.i.i ], [ %spec.select105.i.i, %if.end.i.i ]
...
if.end.i.i:                                       ; preds = %if.then.i.i, %while.body.i102.i
  ...
  br i1 %cmp.i.not.i103.i, label %while.end.i.i, label %while.body.i102.i
...
if.then18.i.i:                                    ; preds = %if.then16.i.i
  ...
  br i1 %cmp.i.i.i.i, label %if.else25.i.i.i, label %if.then.i.i106.i

if.then.i.i106.i:                                 ; preds = %if.then18.i.i
...
if.then9.i.i.i:                                   ; preds = %if.then.i.i106.i
  %45 = load ptr, ptr %add.ptr1.i.i.i, align 8
  store ptr %45, ptr %44, align 8
  br label %if.end13.i.i.i

if.end13.i.i.i:                                   ; preds = %if.then9.i.i.i, %if.then.i.i106.i
  %46 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i107.i = add i32 %RealSize.1.i.i.i.i.i, %46
  %conv.i102.i.i = zext i32 %add.i.i107.i to i64
...
if.else25.i.i.i:                                  ; preds = %if.then18.i.i
  %idxprom.i.i108.i = zext i32 %mul.i.i to i64
  %arrayidx.i.i109.i = getelementptr inbounds [0 x ptr], ptr @memory_ARRAY, i64 0, i64 %idxprom.i.i108.i
  %49 = load ptr, ptr %arrayidx.i.i109.i, align 8
  ...
  %53 = load ptr, ptr %arrayidx.i.i109.i, align 8
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  %indvars.iv.i104.i = phi i64 [ 0, %for.body.lr.ph.i.i ], [ %indvars.iv.next.i105.i, %for.body.i.i ]
  %54 = load ptr, ptr %splitfield33.i.i, align 8
  %arrayidx.i.i = getelementptr inbounds i64, ptr %54, i64 %indvars.iv.i104.i
  ...
  %cmp31.i.i = icmp ult i64 %indvars.iv.next.i105.i, %56
  br i1 %cmp31.i.i, label %for.body.i.i, label %while.body38.lr.ph.i.i

while.cond34.loopexit.i.i:                        ; preds = %for.body45.i.i, %while.body38.i.i
  %cmp.i103.not.i.i = icmp eq ptr %List.addr.0.val.i.i, null
  br i1 %cmp.i103.not.i.i, label %while.body.i111.i, label %while.body38.i.i
...
for.body45.i.i:                                   ; preds = %for.body45.i.i, %for.body45.lr.ph.i.i
  ...
  br i1 %cmp43.i.i, label %for.body45.i.i, label %while.cond34.loopexit.i.i

while.body.i111.i:                                ; preds = %while.cond34.loopexit.i.i, %while.body.i111.i
  %Current.06.i112.i = phi ptr [ %Current.0.val.i113.i, %while.body.i111.i ], [ %Parents.0.lcssa.i, %while.cond34.loopexit.i.i ]
  %Current.0.val.i113.i = load ptr, ptr %Current.06.i112.i, align 8
  %65 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i114.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %65, i64 0, i32 4
  %66 = load i32, ptr %total_size.i.i.i114.i, align 8
  %conv26.i.i.i115.i = sext i32 %66 to i64
  %67 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i116.i = add i64 %67, %conv26.i.i.i115.i
  store i64 %add27.i.i.i116.i, ptr @memory_FREEDBYTES, align 8
  %68 = load ptr, ptr %65, align 8
  store ptr %68, ptr %Current.06.i112.i, align 8
  %69 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i112.i, ptr %69, align 8
  %cmp.i.not.i117.i = icmp eq ptr %Current.0.val.i113.i, null
  br i1 %cmp.i.not.i117.i, label %inf_CreateURUnitResolvent.exit, label %while.body.i111.i

inf_CreateURUnitResolvent.exit:                   ; preds = %while.body.i111.i
...
for.body:                                         ; preds = %while.cond, %list_Nconc.exit
  ...
  br i1 %cmp.i.not.i92, label %if.then.i94, label %clause_LiteralAtom.exit97

if.then.i94:                                      ; preds = %for.body
  %84 = getelementptr i8, ptr %call14.val, i64 16
  %call1.val.i95 = load ptr, ptr %84, align 8
  %85 = getelementptr i8, ptr %call1.val.i95, i64 8
  %call1.val.val.i96 = load ptr, ptr %85, align 8
  br label %clause_LiteralAtom.exit97

clause_LiteralAtom.exit97:                        ; preds = %for.body, %if.then.i94
  %retval.0.i93 = phi ptr [ %call1.val.val.i96, %if.then.i94 ], [ %call14.val, %for.body ]
  %call16 = call ptr @term_Copy(ptr noundef %retval.0.i93) #11
...
while.end:                                        ; preds = %for.end
  ...
  br i1 %cmp.i.not5.i, label %list_Delete.exit, label %while.body.i119

while.body.i119:                                  ; preds = %while.end, %while.body.i119
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i119 ], [ %L.val.i, %while.end ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  %127 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i120 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %127, i64 0, i32 4
  %128 = load i32, ptr %total_size.i.i.i120, align 8
  %conv26.i.i.i121 = sext i32 %128 to i64
  %129 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i122 = add i64 %129, %conv26.i.i.i121
  ...
  %cmp.i.not.i123 = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i123, label %list_Delete.exit, label %while.body.i119

list_Delete.exit:                                 ; preds = %while.body.i119, %while.end
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %RightSubst) #11
