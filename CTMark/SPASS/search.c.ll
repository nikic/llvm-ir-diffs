; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/search.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/search.c"
...
lor.lhs.false9:                                   ; preds = %lor.lhs.false
  ...
  br i1 %cmp.i179.not, label %cleanup, label %for.cond
...
lor.lhs.false28:                                  ; preds = %lor.lhs.false25
  ...
  br i1 %cmp.i186.not, label %cleanup, label %for.cond15
...
for.body60:                                       ; preds = %for.cond56
  ...
  br i1 %cmp, label %cleanup, label %for.cond56
...
for.body74:                                       ; preds = %for.cond70
  ...
  br i1 %cmp78, label %cleanup, label %for.cond70
...
for.inc86:                                        ; preds = %for.cond70, %for.body42
  ...
  br i1 %cmp.i188.not, label %for.end88, label %for.body42
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %11 = sub i32 %sub6.i.i.i.i, %rem2.i.i.i.i
  %RealSize.1.i.i.i.i = select i1 %tobool3.not.i.i.i.i, i32 16000, i32 %11
...
symbol_DeletePrecedence.exit:                     ; preds = %if.end13.i.i, %if.then18.i.i
  ...
  %20 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 160), align 8
  %total_size.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %20, i64 0, i32 4
  %21 = load i32, ptr %total_size.i, align 8
  %conv26.i = sext i32 %21 to i64
  %22 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i = add i64 %22, %conv26.i
  store i64 %add27.i, ptr @memory_FREEDBYTES, align 8
  %23 = load ptr, ptr %20, align 8
  store ptr %23, ptr %Search, align 8
  %24 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 160), align 8
  store ptr %Search, ptr %24, align 8
  ret void
}
...
for.end:                                          ; preds = %prfs_SplitDelete.exit
  ...
  br i1 %cmp.i.not5.i68, label %list_Delete.exit76, label %while.body.i69

while.body.i69:                                   ; preds = %for.end, %while.body.i69
  %Current.06.i70 = phi ptr [ %Current.0.val.i71, %while.body.i69 ], [ %Search.val53.pre, %for.end ]
  %Current.0.val.i71 = load ptr, ptr %Current.06.i70, align 8
  %29 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i72 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %29, i64 0, i32 4
  %30 = load i32, ptr %total_size.i.i.i72, align 8
  %conv26.i.i.i73 = sext i32 %30 to i64
  %31 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i74 = add i64 %31, %conv26.i.i.i73
  store i64 %add27.i.i.i74, ptr @memory_FREEDBYTES, align 8
  %32 = load ptr, ptr %29, align 8
  store ptr %32, ptr %Current.06.i70, align 8
  %33 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i70, ptr %33, align 8
  %cmp.i.not.i75 = icmp eq ptr %Current.0.val.i71, null
  br i1 %cmp.i.not.i75, label %list_Delete.exit76, label %while.body.i69

list_Delete.exit76:                               ; preds = %while.body.i69, %list_Delete.exit, %for.end
  ret void
}
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  br i1 %11, label %symbol_ClearPrecedence.exit, label %vector.body
...
entry:
  ...
  %cmp.i.not43 = icmp eq ptr %Search.val37, null
  br i1 %cmp.i.not43, label %for.cond9.preheader, label %for.body

for.cond9.preheader.loopexit:                     ; preds = %clause_RemoveFlag.exit
  %Scan.145.pre = load ptr, ptr %1, align 8
  br label %for.cond9.preheader

for.cond9.preheader:                              ; preds = %for.cond9.preheader.loopexit, %entry
  %Scan.145 = phi ptr [ %Scan.145.pre, %for.cond9.preheader.loopexit ], [ %Search.val33, %entry ]
  %cmp.i40.not46 = icmp eq ptr %Scan.145, null
  br i1 %cmp.i40.not46, label %for.end17, label %for.body13

for.body:                                         ; preds = %entry, %clause_RemoveFlag.exit
  %Scan.044 = phi ptr [ %Scan.0.val35, %clause_RemoveFlag.exit ], [ %Search.val37, %entry ]
  %4 = getelementptr i8, ptr %Scan.044, i64 8
  %Scan.0.val = load ptr, ptr %4, align 8
...
clause_RemoveFlag.exit:                           ; preds = %for.body, %if.then.i
  %Scan.0.val35 = load ptr, ptr %Scan.044, align 8
  %cmp.i.not = icmp eq ptr %Scan.0.val35, null
  br i1 %cmp.i.not, label %for.cond9.preheader.loopexit, label %for.body

for.body13:                                       ; preds = %for.cond9.preheader, %for.body13
  %Scan.147 = phi ptr [ %Scan.1, %for.body13 ], [ %Scan.145, %for.cond9.preheader ]
  %6 = getelementptr i8, ptr %Scan.147, i64 8
  ...
  %Scan.1 = load ptr, ptr %Scan.147, align 8
  %cmp.i40.not = icmp eq ptr %Scan.1, null
  br i1 %cmp.i40.not, label %for.end17, label %for.body13
...
for.body13:                                       ; preds = %for.body13.lr.ph, %for.body13
  ...
  br i1 %cmp.i51.not, label %for.end18, label %for.body13
...
prfs_InsertDocProofClause.exit:                   ; preds = %if.then.i, %if.else.i
  ...
  br i1 %cmp.i56.not, label %for.end29, label %for.body24
...
list_Delete.exit:                                 ; preds = %while.body.i, %if.then18
  ...
  br i1 %cmp.i.not5.i93, label %list_Delete.exit101, label %while.body.i94

while.body.i94:                                   ; preds = %list_Delete.exit, %while.body.i94
  %Current.06.i95 = phi ptr [ %Current.0.val.i96, %while.body.i94 ], [ %call19.val90, %list_Delete.exit ]
  %Current.0.val.i96 = load ptr, ptr %Current.06.i95, align 8
  %24 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i97 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %24, i64 0, i32 4
  %25 = load i32, ptr %total_size.i.i.i97, align 8
  %conv26.i.i.i98 = sext i32 %25 to i64
  %26 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i99 = add i64 %26, %conv26.i.i.i98
  store i64 %add27.i.i.i99, ptr @memory_FREEDBYTES, align 8
  %27 = load ptr, ptr %24, align 8
  store ptr %27, ptr %Current.06.i95, align 8
  %28 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i95, ptr %28, align 8
  %cmp.i.not.i100 = icmp eq ptr %Current.0.val.i96, null
  br i1 %cmp.i.not.i100, label %list_Delete.exit101, label %while.body.i94

list_Delete.exit101:                              ; preds = %while.body.i94, %list_Delete.exit
...
for.body13:                                       ; preds = %for.cond9.preheader, %for.body13
  ...
  br i1 %cmp.i71.not, label %for.end17, label %for.body13
...
for.inc32:                                        ; preds = %for.body24, %if.then29
  ...
  br i1 %cmp.i73.not, label %for.cond35.preheader, label %for.body24
...
prfs_MoveUsableDocProof.exit:                     ; preds = %if.then.i, %if.else.i
  ...
  br i1 %cmp.i79.not, label %for.end43, label %for.body39
...
for.body27:                                       ; preds = %for.end, %for.body27
  ...
  br i1 %cmp.i53.not, label %for.end33, label %for.body27
...
for.body22:                                       ; preds = %for.end, %for.body22
  ...
  br i1 %cmp.i128.not, label %for.end28, label %for.body22
...
for.body35:                                       ; preds = %for.end28, %for.body35
  ...
  br i1 %cmp.i131.not, label %for.end41, label %for.body35
...
for.body48:                                       ; preds = %for.end41, %for.body48
  ...
  br i1 %cmp.i135.not, label %for.end54, label %for.body48
...
for.body61:                                       ; preds = %for.end54, %for.body61
  ...
  br i1 %cmp.i139.not, label %for.end70, label %for.body61
...
for.body.i:                                       ; preds = %for.end70, %for.body.i
  ...
  br i1 %cmp.i.not.i, label %prfs_PrintSplitStack.exit, label %for.body.i
...
entry:
  ...
  %validlevel.i.i = getelementptr inbounds %struct.PROOFSEARCH_HELP, ptr %PS, i64 0, i32 16
...
for.body.us:                                      ; preds = %for.body.us.preheader, %for.body.us
  ...
  br i1 %exitcond322.not, label %for.end, label %for.body.us
...
if.end.i:                                         ; preds = %while.body.i
  ...
  br i1 %cmp.i.not.i, label %if.else24, label %while.body.i
...
for.end:                                          ; preds = %for.inc, %for.body.us, %entry
  ...
  %c.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call3, i64 0, i32 11
  ...
  %a.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call3, i64 0, i32 12
  ...
  %s.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call3, i64 0, i32 13
...
for.body58:                                       ; preds = %for.body58.lr.ph, %list_Delete.exit
  ...
  br i1 %cmp.i.not.i271, label %if.then.i273, label %clause_LiteralAtom.exit

if.then.i273:                                     ; preds = %for.body58
...
clause_LiteralAtom.exit:                          ; preds = %for.body58, %if.then.i273
  %retval.0.i272 = phi ptr [ %call1.val.val.i, %if.then.i273 ], [ %call59.val, %for.body58 ]
...
while.body.i277:                                  ; preds = %if.end76, %while.body.i277
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i277 ], [ %call.i.i274, %if.end76 ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  ...
  br i1 %cmp.i.not.i278, label %list_Delete.exit, label %while.body.i277
...
list_Delete.exit:                                 ; preds = %while.body.i277
  ...
  br i1 %exitcond327.not, label %if.end85, label %for.body58
...
if.end13:                                         ; preds = %if.end, %entry
  %19 = getelementptr i8, ptr %Father, i64 48
  %Father.val = load i32, ptr %19, align 8
  %20 = and i32 %Father.val, 8
...
if.end16:                                         ; preds = %if.then15, %if.end13
  ...
  %22 = load i32, ptr %splitfield_length17, align 8
  %cmp1871.not = icmp eq i32 %22, 0
  br i1 %cmp1871.not, label %for.body29.lr.ph, label %for.body.lr.ph
...
for.cond25.preheader:                             ; preds = %for.body
  ...
  %cmp2773 = icmp ult i32 %27, %.pre
  br i1 %cmp2773, label %for.body29.lr.ph, label %for.end35

for.body29.lr.ph:                                 ; preds = %if.end16, %for.cond25.preheader
  %.lcssa82 = phi i32 [ %27, %for.cond25.preheader ], [ 0, %if.end16 ]
  %splitfield30 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Result, i64 0, i32 4
  %23 = zext i32 %.lcssa82 to i64
  br label %for.body29

for.body:                                         ; preds = %for.body.lr.ph, %for.body
  %indvars.iv = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next, %for.body ]
  %24 = load ptr, ptr %splitfield20, align 8
  %arrayidx = getelementptr inbounds i64, ptr %24, i64 %indvars.iv
  %25 = load i64, ptr %arrayidx, align 8
  %26 = load ptr, ptr %splitfield21, align 8
  %arrayidx23 = getelementptr inbounds i64, ptr %26, i64 %indvars.iv
  store i64 %25, ptr %arrayidx23, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %27 = load i32, ptr %splitfield_length17, align 8
  %28 = zext i32 %27 to i64
  %cmp18 = icmp ult i64 %indvars.iv.next, %28
  br i1 %cmp18, label %for.body, label %for.cond25.preheader

for.body29:                                       ; preds = %for.body29.lr.ph, %for.body29
  %indvars.iv77 = phi i64 [ %23, %for.body29.lr.ph ], [ %indvars.iv.next78, %for.body29 ]
  %29 = load ptr, ptr %splitfield30, align 8
  %arrayidx32 = getelementptr inbounds i64, ptr %29, i64 %indvars.iv77
  store i64 0, ptr %arrayidx32, align 8
  %indvars.iv.next78 = add nuw nsw i64 %indvars.iv77, 1
  %30 = load i32, ptr %splitfield_length, align 8
  %31 = zext i32 %30 to i64
  %cmp27 = icmp ult i64 %indvars.iv.next78, %31
...
for.cond.i.i:                                     ; preds = %for.body.i.i
  ...
  br i1 %cmp.i135.i, label %for.body.i.i, label %if.end18.i
...
for.body.lr.ph.i.i:                               ; preds = %if.then6.i
  %Clause.val6.i.i138.i = load i32, ptr %2, align 4
  %Clause.val.i.i139.i = load i32, ptr %3, align 8
  %add.i.i140.i = add i32 %Clause.val.i.i139.i, %Clause.val6.i.i138.i
  %add3.i.i141.i = add nsw i32 %add.i.i140.i, %Clause.val7.i.i136.i
  %9 = sext i32 %add.i.i140.i to i64
  %10 = sext i32 %add3.i.i141.i to i64
  br label %for.body.i143.i

for.cond.i149.i:                                  ; preds = %for.body.i143.i
  %indvars.iv.next.i150.i = add nsw i64 %indvars.iv.i144.i, 1
  %cmp.i151.i = icmp slt i64 %indvars.iv.next.i150.i, %10
  br i1 %cmp.i151.i, label %for.body.i143.i, label %clause_GetGroundSuccLit.exit.i

for.body.i143.i:                                  ; preds = %for.cond.i149.i, %for.body.lr.ph.i.i
  %indvars.iv.i144.i = phi i64 [ %9, %for.body.lr.ph.i.i ], [ %indvars.iv.next.i150.i, %for.cond.i149.i ]
  ...
  br i1 %tobool.not.i148.i, label %for.cond.i149.i, label %if.then.i.i

if.then.i.i:                                      ; preds = %for.body.i143.i
...
clause_GetGroundSuccLit.exit.i:                   ; preds = %for.cond.i149.i, %if.then.i.i, %if.then6.i
  %retval.0.i137.i = phi ptr [ %15, %if.then.i.i ], [ null, %if.then6.i ], [ null, %for.cond.i149.i ]
  %call.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #9
  %car.i.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i, i64 0, i32 1
  store ptr %retval.0.i137.i, ptr %car.i.i, align 8
  ...
  br i1 %cmp1110.i, label %for.body.preheader.i, label %prfs_GetSplitLiterals.exit.thread18
...
for.body.preheader.i:                             ; preds = %clause_GetGroundSuccLit.exit.i
  %16 = zext i32 %sub.i.i to i64
  br label %for.body.i

for.body.i:                                       ; preds = %for.inc.i, %for.body.preheader.i
  %indvars.iv.i = phi i64 [ %16, %for.body.preheader.i ], [ %indvars.iv.next.i, %for.inc.i ]
  %LitList.012.i = phi ptr [ %call.i.i, %for.body.preheader.i ], [ %LitList.1.i, %for.inc.i ]
  ...
  br i1 %cmp.i.not.i.i, label %if.then.i155.i, label %clause_LiteralAtom.exit.i

if.then.i155.i:                                   ; preds = %for.body.i
...
clause_LiteralAtom.exit.i:                        ; preds = %if.then.i155.i, %for.body.i
  %retval.0.i154.i = phi ptr [ %call1.val.val.i.i, %if.then.i155.i ], [ %call12.val.i, %for.body.i ]
...
for.inc.i:                                        ; preds = %if.then16.i, %clause_LiteralAtom.exit.i
  ...
  br i1 %cmp11.i, label %for.body.i, label %prfs_GetSplitLiterals.exit
...
if.end18.i:                                       ; preds = %for.cond.i.i
  ...
  br i1 %cmp.i.not.i167.i, label %if.then.i169.i, label %clause_LiteralAtom.exit172.i

if.then.i169.i:                                   ; preds = %if.end18.i
  %26 = getelementptr i8, ptr %call20.val.i, i64 16
  %call1.val.i170.i = load ptr, ptr %26, align 8
  %27 = getelementptr i8, ptr %call1.val.i170.i, i64 8
  %call1.val.val.i171.i = load ptr, ptr %27, align 8
  br label %clause_LiteralAtom.exit172.i

clause_LiteralAtom.exit172.i:                     ; preds = %if.then.i169.i, %if.end18.i
  %retval.0.i168.i = phi ptr [ %call1.val.val.i171.i, %if.then.i169.i ], [ %call20.val.i, %if.end18.i ]
  %call22.i = tail call ptr @term_VariableSymbols(ptr noundef %retval.0.i168.i) #9
...
while.cond.loopexit.i:                            ; preds = %for.inc49.i
  ...
  br i1 %tobool25.not.i, label %while.end.i, label %while.body.i
...
if.end.i.i:                                       ; preds = %while.body.i.i
  ...
  br i1 %cmp.i.not.i182.i, label %if.then34.i, label %while.body.i.i
...
if.then34.i:                                      ; preds = %if.end.i.i, %for.body30.i
  ...
  br i1 %cmp.i.not.i185.i, label %if.then.i187.i, label %clause_LiteralAtom.exit190.i

if.then.i187.i:                                   ; preds = %if.then34.i
  %33 = getelementptr i8, ptr %call31.val.i, i64 16
  %call1.val.i188.i = load ptr, ptr %33, align 8
  %34 = getelementptr i8, ptr %call1.val.i188.i, i64 8
  %call1.val.val.i189.i = load ptr, ptr %34, align 8
  br label %clause_LiteralAtom.exit190.i

clause_LiteralAtom.exit190.i:                     ; preds = %if.then.i187.i, %if.then34.i
  %retval.0.i186.i = phi ptr [ %call1.val.val.i189.i, %if.then.i187.i ], [ %call31.val.i, %if.then34.i ]
  %call36.i = tail call ptr @term_VariableSymbols(ptr noundef %retval.0.i186.i) #9
...
if.else.i:                                        ; preds = %clause_LiteralAtom.exit190.i
  ...
  br i1 %cmp.i.not5.i.i, label %for.inc49.i, label %while.body.i193.i

while.body.i193.i:                                ; preds = %if.else.i, %while.body.i193.i
  %Current.06.i.i = phi ptr [ %Current.0.val.i.i, %while.body.i193.i ], [ %call36.i, %if.else.i ]
  ...
  %cmp.i.not.i194.i = icmp eq ptr %Current.0.val.i.i, null
  br i1 %cmp.i.not.i194.i, label %for.inc49.i, label %while.body.i193.i

for.inc49.i:                                      ; preds = %while.body.i.i, %while.body.i193.i, %if.else.i, %if.then39.i
  %LitList.4.i = phi ptr [ %call.i191.i, %if.then39.i ], [ %LitList.315.i, %if.else.i ], [ %LitList.315.i, %while.body.i193.i ], [ %LitList.315.i, %while.body.i.i ]
  %VarOcc.2.i = phi ptr [ %call41.i, %if.then39.i ], [ %VarOcc.116.i, %if.else.i ], [ %VarOcc.116.i, %while.body.i193.i ], [ %VarOcc.116.i, %while.body.i.i ]
  %Change.2.i = phi i32 [ %spec.select.i, %if.then39.i ], [ %Change.117.i, %if.else.i ], [ %Change.117.i, %while.body.i193.i ], [ %Change.117.i, %while.body.i.i ]
  %40 = trunc i64 %indvars.iv31.i to i32
  %cmp29.i = icmp sgt i32 %40, 1
  br i1 %cmp29.i, label %for.body30.i, label %while.cond.loopexit.i
...
if.then54.i:                                      ; preds = %while.end.i
  ...
  br i1 %cmp.i.not5.i195.i, label %if.end56.i, label %while.body.i196.i

while.body.i196.i:                                ; preds = %if.then54.i, %while.body.i196.i
  %Current.06.i197.i = phi ptr [ %Current.0.val.i198.i, %while.body.i196.i ], [ %LitList.3.lcssa42.i, %if.then54.i ]
  %Current.0.val.i198.i = load ptr, ptr %Current.06.i197.i, align 8
  %41 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i199.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %41, i64 0, i32 4
  %42 = load i32, ptr %total_size.i.i.i199.i, align 8
  %conv26.i.i.i200.i = sext i32 %42 to i64
  %43 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i201.i = add i64 %43, %conv26.i.i.i200.i
  store i64 %add27.i.i.i201.i, ptr @memory_FREEDBYTES, align 8
  %44 = load ptr, ptr %41, align 8
  store ptr %44, ptr %Current.06.i197.i, align 8
  %45 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i197.i, ptr %45, align 8
  %cmp.i.not.i202.i = icmp eq ptr %Current.0.val.i198.i, null
  br i1 %cmp.i.not.i202.i, label %if.end56.i, label %while.body.i196.i

if.end56.i:                                       ; preds = %while.body.i196.i, %if.then54.i, %while.end.i
  %LitList.5.i = phi ptr [ %LitList.3.lcssa42.i, %while.end.i ], [ null, %if.then54.i ], [ null, %while.body.i196.i ]
...
while.body.i208.i:                                ; preds = %if.end.i212.i, %for.body61.i
  %List.addr.07.i209.i = phi ptr [ %List.addr.0.val5.i213.i, %if.end.i212.i ], [ %LitList.5.i, %for.body61.i ]
  %51 = getelementptr i8, ptr %List.addr.07.i209.i, i64 8
  %List.addr.0.val.i210.i = load ptr, ptr %51, align 8
  %cmp.i211.i = icmp eq ptr %List.addr.0.val.i210.i, %50
  br i1 %cmp.i211.i, label %list_PointerMember.exit216.loopexit.i, label %if.end.i212.i

if.end.i212.i:                                    ; preds = %while.body.i208.i
  %List.addr.0.val5.i213.i = load ptr, ptr %List.addr.07.i209.i, align 8
  %cmp.i.not.i214.i = icmp eq ptr %List.addr.0.val5.i213.i, null
  br i1 %cmp.i.not.i214.i, label %if.end72.i, label %while.body.i208.i

list_PointerMember.exit216.loopexit.i:            ; preds = %while.body.i208.i
  %indvars.iv.next35.i = add nsw i64 %indvars.iv34.i, 1
  %cmp59.i = icmp slt i64 %indvars.iv.next35.i, %49
  br i1 %cmp59.i, label %for.body61.i, label %if.then70.i

if.then70.i:                                      ; preds = %list_PointerMember.exit216.loopexit.i, %if.end56.i
  %cmp.i.not5.i217.i = icmp eq ptr %LitList.5.i, null
  br i1 %cmp.i.not5.i217.i, label %if.end72.i, label %while.body.i218.i

while.body.i218.i:                                ; preds = %if.then70.i, %while.body.i218.i
  %Current.06.i219.i = phi ptr [ %Current.0.val.i220.i, %while.body.i218.i ], [ %LitList.5.i, %if.then70.i ]
  %Current.0.val.i220.i = load ptr, ptr %Current.06.i219.i, align 8
  %52 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i221.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %52, i64 0, i32 4
  %53 = load i32, ptr %total_size.i.i.i221.i, align 8
  %conv26.i.i.i222.i = sext i32 %53 to i64
  %54 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i223.i = add i64 %54, %conv26.i.i.i222.i
  store i64 %add27.i.i.i223.i, ptr @memory_FREEDBYTES, align 8
  %55 = load ptr, ptr %52, align 8
  store ptr %55, ptr %Current.06.i219.i, align 8
  %56 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i219.i, ptr %56, align 8
  %cmp.i.not.i224.i = icmp eq ptr %Current.0.val.i220.i, null
  br i1 %cmp.i.not.i224.i, label %if.end72.i, label %while.body.i218.i

if.end72.i:                                       ; preds = %if.end.i212.i, %while.body.i218.i, %if.then70.i, %for.body61.lr.ph.i
  %LitList.6.i = phi ptr [ null, %if.then70.i ], [ null, %for.body61.lr.ph.i ], [ null, %while.body.i218.i ], [ %LitList.5.i, %if.end.i212.i ]
  %cmp.i.not5.i226.i = icmp eq ptr %VarOcc.1.lcssa43.i, null
  br i1 %cmp.i.not5.i226.i, label %prfs_GetSplitLiterals.exit, label %while.body.i227.i

while.body.i227.i:                                ; preds = %if.end72.i, %while.body.i227.i
  %Current.06.i228.i = phi ptr [ %Current.0.val.i229.i, %while.body.i227.i ], [ %VarOcc.1.lcssa43.i, %if.end72.i ]
  %Current.0.val.i229.i = load ptr, ptr %Current.06.i228.i, align 8
  %57 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i230.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %57, i64 0, i32 4
  %58 = load i32, ptr %total_size.i.i.i230.i, align 8
  %conv26.i.i.i231.i = sext i32 %58 to i64
  %59 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i232.i = add i64 %59, %conv26.i.i.i231.i
  store i64 %add27.i.i.i232.i, ptr @memory_FREEDBYTES, align 8
  %60 = load ptr, ptr %57, align 8
  store ptr %60, ptr %Current.06.i228.i, align 8
  %61 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i228.i, ptr %61, align 8
  %cmp.i.not.i233.i = icmp eq ptr %Current.0.val.i229.i, null
  br i1 %cmp.i.not.i233.i, label %prfs_GetSplitLiterals.exit, label %while.body.i227.i

prfs_GetSplitLiterals.exit:                       ; preds = %for.inc.i, %while.body.i227.i, %if.end72.i
  %retval.0.i = phi ptr [ %LitList.6.i, %if.end72.i ], [ %LitList.6.i, %while.body.i227.i ], [ %LitList.1.i, %for.inc.i ]
...
while.body.i12:                                   ; preds = %while.body.i12.preheader, %while.body.i12
  ...
  %cmp.i.not.i = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i, label %if.end6, label %while.body.i12
...
if.end.i:                                         ; preds = %while.body.i
  %List.addr.0.val5.i = load ptr, ptr %List.addr.07.i, align 8
  %cmp.i.not.i = icmp eq ptr %List.addr.0.val5.i, null
  br i1 %cmp.i.not.i, label %for.inc, label %while.body.i
...
while.body.i:                                     ; preds = %if.end18, %while.body.i
  ...
  br i1 %cmp.i.not.i63, label %list_Delete.exit, label %while.body.i
...
list_Delete.exit:                                 ; preds = %while.body.i, %if.end18
  ...
  br i1 %cmp.i.not.i65, label %if.then.i67, label %clause_LiteralAtom.exit70

if.then.i67:                                      ; preds = %list_Delete.exit
  %20 = getelementptr i8, ptr %Literal.val, i64 16
  %call1.val.i68 = load ptr, ptr %20, align 8
  %21 = getelementptr i8, ptr %call1.val.i68, i64 8
  %call1.val.val.i69 = load ptr, ptr %21, align 8
  br label %clause_LiteralAtom.exit70

clause_LiteralAtom.exit70:                        ; preds = %list_Delete.exit, %if.then.i67
  %retval.0.i66 = phi ptr [ %call1.val.val.i69, %if.then.i67 ], [ %Literal.val, %list_Delete.exit ]
...
if.then23:                                        ; preds = %clause_LiteralAtom.exit70
  %23 = getelementptr i8, ptr %retval.0.i66, i64 16
