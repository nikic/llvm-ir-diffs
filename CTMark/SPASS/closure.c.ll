...
for.body.i111:                                    ; preds = %for.body.i111, %for.body.preheader.i
  ...
  br i1 %cmp9.not.i, label %if.then.i.i, label %for.body.i111, !llvm.loop !12
...
ras_Push.exit:                                    ; preds = %for.body.i67, %if.end23.i.i.i, %if.else25.i.i.i
  ...
  br i1 %cmp5.i, label %for.body.i67, label %for.end.i68, !llvm.loop !13
...
for.inc.i90:                                      ; preds = %clause_GetLiteralAtom.exit.i87, %if.then.i94
  ...
  br i1 %.not.i, label %for.end.loopexit.i, label %for.body.i80, !llvm.loop !15
