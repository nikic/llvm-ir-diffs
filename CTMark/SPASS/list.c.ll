...
while.body.i29.i:                                 ; preds = %if.end.i23.i, %while.body.i29.i
  ...
  br i1 %cmp.i21.not.i36.i, label %for.cond.i.preheader, label %while.body.i29.i, !llvm.loop !5
...
list_Append.exit:                                 ; preds = %while.body.i.i, %list_Copy.exit, %if.end.i.i, %for.end.i
  ...
  br i1 %cmp.i30.not, label %for.inc15, label %for.body8, !llvm.loop !46
...
while.body.i47:                                   ; preds = %while.body.i35, %while.body.i47
  ...
  br i1 %cmp.i.not.i51, label %list_Delete.exit, label %while.body.i47, !llvm.loop !13
...
list_Delete.exit:                                 ; preds = %while.body.i47, %while.body.i35
  ...
  br i1 %cmp.i.not.i36, label %list_DeleteWithElement.exit, label %while.body.i35, !llvm.loop !20
...
while.body.i53:                                   ; preds = %while.body.i38, %while.body.i53
  ...
  br i1 %cmp.i.not.i59, label %list_Delete.exit60, label %while.body.i53, !llvm.loop !13
...
list_Delete.exit60:                               ; preds = %while.body.i53, %while.body.i38
  ...
  br i1 %cmp.i.not.i45, label %list_DeleteWithElement.exit46, label %while.body.i38, !llvm.loop !20
...
if.end.i57:                                       ; preds = %while.body.i51
  ...
  br i1 %cmp.i.not.i59, label %if.else, label %while.body.i51, !llvm.loop !49
...
if.end.i55:                                       ; preds = %while.body.i51
  ...
  br i1 %cmp.i.not.i57, label %if.else, label %while.body.i51, !llvm.loop !40
...
for.inc.i.i20:                                    ; preds = %for.body.i.i15
  ...
  br i1 %cmp.i.not.i.i22, label %if.else.i23, label %for.body.i.i15, !llvm.loop !61
...
if.end.i28:                                       ; preds = %if.else.i23, %if.then.i33
  ...
  br i1 %cmp.i.not.i31, label %list_MultisetDistribution.exit38, label %for.body.i10, !llvm.loop !62
...
if.end.i40:                                       ; preds = %while.body.i
  ...
  br i1 %cmp.i.not.i41, label %land.lhs.true.i, label %lor.rhs.i, !llvm.loop !63
...
while.body.i.i.i43:                               ; preds = %list_DeleteDistribution.exit, %while.body.i.i.i43
  ...
  br i1 %cmp.i.not.i.i.i53, label %list_DeleteDistribution.exit54, label %while.body.i.i.i43, !llvm.loop !20
