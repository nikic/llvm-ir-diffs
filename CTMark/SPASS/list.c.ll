; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/list.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/list.c"
...
while.body:                                       ; preds = %if.end, %while.body
  ...
  br i1 %cmp.i21.not, label %cleanup, label %while.body
...
while.body:                                       ; preds = %if.end, %while.body
  ...
  br i1 %cmp.i24.not, label %cleanup, label %while.body
...
for.body:                                         ; preds = %entry, %for.body
  ...
  br i1 %cmp.i.not, label %for.cond5.preheader, label %for.body
...
for.body9:                                        ; preds = %for.cond5.preheader, %for.body9
  ...
  br i1 %cmp.i27.not, label %while.body.i.preheader, label %for.body9
...
if.end:                                           ; preds = %land.lhs.true, %do.body
  ...
  br i1 %cmp.i35.not, label %cleanup, label %do.body
...
if.end25:                                         ; preds = %if.else23, %if.then21
  ...
  br i1 %cmp.i66.not, label %if.then29, label %land.rhs
...
land.rhs:                                         ; preds = %while.body
  ...
  br i1 %cmp.i34.not, label %while.end, label %while.body
...
while.body:                                       ; preds = %land.rhs.preheader, %land.rhs
  ...
  br i1 %cmp.i32.not, label %while.end, label %land.rhs
...
land.rhs.i:                                       ; preds = %while.body.i
  ...
  br i1 %cmp.i34.not.i, label %while.end.i, label %while.body.i
...
while.body.i:                                     ; preds = %land.rhs.i.preheader, %land.rhs.i
  ...
  br i1 %cmp.i32.not.i, label %while.end.i, label %land.rhs.i
...
if.end25.i:                                       ; preds = %if.else23.i, %if.then21.i
  ...
  br i1 %cmp.i66.not.i, label %if.then29.i, label %land.rhs.i15
...
if.end25.i:                                       ; preds = %if.else23.i, %if.then21.i
  ...
  %Scan2.2.i = phi ptr [ %Scan2.177.i, %if.then21.i ], [ %Scan2.1.val60.i, %if.else23.i ]
  %cmp.i66.not.i = icmp eq ptr %Scan1.2.i, null
  br i1 %cmp.i66.not.i, label %if.then29.i, label %land.rhs.i
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i.not, label %return, label %land.rhs
...
if.end20:                                         ; preds = %while.body12, %if.then16
  ...
  br i1 %cmp.i45.not, label %cleanup, label %while.body12
...
if.end20:                                         ; preds = %while.body12, %if.then16
  ...
  br i1 %cmp.i44.not, label %cleanup, label %while.body12
...
if.end22:                                         ; preds = %while.body13, %if.then17
  ...
  br i1 %cmp.i51.not, label %cleanup, label %while.body13
...
if.end22:                                         ; preds = %while.body13, %if.then17
  ...
  br i1 %cmp.i52.not, label %cleanup, label %while.body13
...
if.end17:                                         ; preds = %while.body10, %if.then13
  ...
  br i1 %cmp.i41.not, label %cleanup, label %while.body10
...
if.end19:                                         ; preds = %while.body11, %if.then14
  ...
  br i1 %cmp.i48.not, label %cleanup, label %while.body11
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i.not, label %if.end17, label %land.rhs
...
if.end:                                           ; preds = %while.body9, %if.then12
  ...
  br i1 %cmp.i39.not, label %if.end17, label %while.body9
...
for.body.loopexit:                                ; preds = %if.end.i
  ...
  br i1 %cond, label %return, label %while.body.i.preheader
...
if.end.i:                                         ; preds = %while.body.i
  ...
  br i1 %cmp.i.not.i, label %for.body.loopexit, label %while.body.i
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  br i1 %cmp.i.not.i, label %list_DeleteElement.exit.thread, label %land.rhs.i
...
if.end20.i:                                       ; preds = %if.then16.i, %while.body12.i
  ...
  br i1 %cmp.i45.not.i, label %list_DeleteElement.exit, label %while.body12.i
...
list_DeleteElement.exit:                          ; preds = %if.end20.i, %while.cond9.preheader.i
  ...
  br i1 %cmp.i.not52.i, label %list_DeleteElement.exit.thread, label %land.rhs.i.preheader
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  br i1 %cmp.i.not.i, label %list_DeleteElementFree.exit.thread, label %land.rhs.i
...
if.end22.i:                                       ; preds = %if.then17.i, %while.body13.i
  ...
  br i1 %cmp.i52.not.i, label %list_DeleteElementFree.exit, label %while.body13.i
...
list_DeleteElementFree.exit:                      ; preds = %if.end22.i, %while.cond10.preheader.i
  ...
  br i1 %cmp.i.not59.i, label %list_DeleteElementFree.exit.thread, label %land.rhs.i.preheader
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  br i1 %cmp.i.not.i, label %list_PointerDeleteElement.exit.thread, label %land.rhs.i
...
if.end17.i:                                       ; preds = %if.then13.i, %while.body10.i
  ...
  br i1 %cmp.i41.not.i, label %list_PointerDeleteElement.exit, label %while.body10.i
...
list_PointerDeleteElement.exit:                   ; preds = %if.end17.i, %while.cond7.preheader.i
  ...
  br i1 %cmp.i.not48.i, label %list_PointerDeleteElement.exit.thread, label %land.rhs.i.preheader
...
while.body.i.i:                                   ; preds = %land.rhs.i.i
  ...
  br i1 %cmp.i.not.i.i, label %list_PointerDeleteElement.exit.thread.i, label %land.rhs.i.i
...
if.end17.i.i:                                     ; preds = %if.then13.i.i, %while.body10.i.i
  ...
  br i1 %cmp.i41.not.i.i, label %list_PointerDeleteElement.exit.i, label %while.body10.i.i
...
while.body.i.i:                                   ; preds = %land.rhs.i.i
  ...
  br i1 %cmp.i.not.i.i, label %list_DeleteElement.exit.thread.i, label %land.rhs.i.i
...
if.end20.i.i:                                     ; preds = %if.then16.i.i, %while.body12.i.i
  ...
  br i1 %cmp.i45.not.i.i, label %list_DeleteElement.exit.i, label %while.body12.i.i
...
entry:
  ...
  %or.cond = or i1 %cmp.i.not, %cmp.i28.not63
  br i1 %or.cond, label %if.end, label %for.cond4.preheader

for.cond4.preheader:                              ; preds = %entry, %for.inc15
  %Scan1.065 = phi ptr [ %Scan1.0.val26, %for.inc15 ], [ %List1, %entry ]
  %Result.064 = phi ptr [ %call.i, %for.inc15 ], [ null, %entry ]
...
while.body.i:                                     ; preds = %if.end.i, %while.body.i
  ...
  br i1 %cmp.i21.not.i, label %list_Copy.exit, label %while.body.i
...
if.end.i33:                                       ; preds = %list_Copy.exit
  ...
  br i1 %cmp.i20.not.i, label %if.end.i.i, label %if.end.i23.i
...
while.body.i.i:                                   ; preds = %if.end.i.i, %while.body.i.i
  ...
  br i1 %cmp.i21.not.i.i, label %list_Append.exit, label %while.body.i.i

if.end.i23.i:                                     ; preds = %if.end.i33
  br i1 %cmp.i21.not26.i.i, label %for.cond.i.preheader, label %while.body.i29.i

while.body.i29.i:                                 ; preds = %if.end.i23.i, %while.body.i29.i
  %Scan2.028.i30.i = phi ptr [ %Scan2.0.i35.i, %while.body.i29.i ], [ %Scan2.025.i.i, %if.end.i23.i ]
  %Scan1.027.i31.i = phi ptr [ %call.i.i23.i33.i, %while.body.i29.i ], [ %call.i.i.i.i, %if.end.i23.i ]
  %6 = getelementptr i8, ptr %Scan2.028.i30.i, i64 8
  %Scan2.0.val.i32.i = load ptr, ptr %6, align 8
  %call.i.i23.i33.i = tail call ptr @memory_Malloc(i32 noundef 16) #8
  %car.i.i24.i34.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i23.i33.i, i64 0, i32 1
  store ptr %Scan2.0.val.i32.i, ptr %car.i.i24.i34.i, align 8
  store ptr null, ptr %call.i.i23.i33.i, align 8
  store ptr %call.i.i23.i33.i, ptr %Scan1.027.i31.i, align 8
  %Scan2.0.i35.i = load ptr, ptr %Scan2.028.i30.i, align 8
  %cmp.i21.not.i36.i = icmp eq ptr %Scan2.0.i35.i, null
  br i1 %cmp.i21.not.i36.i, label %for.cond.i.preheader, label %while.body.i29.i

for.cond.i.preheader:                             ; preds = %while.body.i29.i, %if.end.i23.i
  br label %for.cond.i
...
for.cond.i:                                       ; preds = %for.cond.i.preheader, %for.cond.i
  ...
  br i1 %cmp.i39.not.i, label %for.end.i, label %for.cond.i
...
list_Append.exit:                                 ; preds = %while.body.i.i, %list_Copy.exit, %if.end.i.i, %for.end.i
  ...
  br i1 %cmp.i30.not, label %for.inc15, label %for.body8

for.inc15:                                        ; preds = %list_Append.exit
  %Scan1.0.val26 = load ptr, ptr %Scan1.065, align 8
  %cmp.i28.not = icmp eq ptr %Scan1.0.val26, null
  br i1 %cmp.i28.not, label %if.end, label %for.cond4.preheader

if.end:                                           ; preds = %for.inc15, %entry
  %Result.2 = phi ptr [ null, %entry ], [ %call.i, %for.inc15 ]
...
while.body.i35:                                   ; preds = %if.end, %list_Delete.exit
  ...
  br i1 %cmp.i.not5.i, label %list_Delete.exit, label %while.body.i47

while.body.i47:                                   ; preds = %while.body.i35, %while.body.i47
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i47 ], [ %List.addr.0.val.i, %while.body.i35 ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  %8 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i48 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %8, i64 0, i32 4
  %9 = load i32, ptr %total_size.i.i.i48, align 8
  %conv26.i.i.i49 = sext i32 %9 to i64
  %10 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i50 = add i64 %10, %conv26.i.i.i49
  ...
  br i1 %cmp.i.not.i51, label %list_Delete.exit, label %while.body.i47

list_Delete.exit:                                 ; preds = %while.body.i47, %while.body.i35
  %13 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  ...
  %cmp.i.not.i36 = icmp eq ptr %List.addr.0.val6.i, null
  br i1 %cmp.i.not.i36, label %list_DeleteWithElement.exit, label %while.body.i35

list_DeleteWithElement.exit:                      ; preds = %list_Delete.exit, %if.end
  br i1 %cmp.i.not, label %list_DeleteWithElement.exit46, label %while.body.i38

while.body.i38:                                   ; preds = %list_DeleteWithElement.exit, %list_Delete.exit60
  %List.addr.08.i39 = phi ptr [ %List.addr.0.val6.i40, %list_Delete.exit60 ], [ %List2, %list_DeleteWithElement.exit ]
  %List.addr.0.val6.i40 = load ptr, ptr %List.addr.08.i39, align 8
  %18 = getelementptr i8, ptr %List.addr.08.i39, i64 8
  %List.addr.0.val.i41 = load ptr, ptr %18, align 8
  %cmp.i.not5.i52 = icmp eq ptr %List.addr.0.val.i41, null
  br i1 %cmp.i.not5.i52, label %list_Delete.exit60, label %while.body.i53

while.body.i53:                                   ; preds = %while.body.i38, %while.body.i53
  %Current.06.i54 = phi ptr [ %Current.0.val.i55, %while.body.i53 ], [ %List.addr.0.val.i41, %while.body.i38 ]
  %Current.0.val.i55 = load ptr, ptr %Current.06.i54, align 8
  %19 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i56 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %19, i64 0, i32 4
  %20 = load i32, ptr %total_size.i.i.i56, align 8
  %conv26.i.i.i57 = sext i32 %20 to i64
  %21 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i58 = add i64 %21, %conv26.i.i.i57
  store i64 %add27.i.i.i58, ptr @memory_FREEDBYTES, align 8
  %22 = load ptr, ptr %19, align 8
  store ptr %22, ptr %Current.06.i54, align 8
  %23 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i54, ptr %23, align 8
  %cmp.i.not.i59 = icmp eq ptr %Current.0.val.i55, null
  br i1 %cmp.i.not.i59, label %list_Delete.exit60, label %while.body.i53

list_Delete.exit60:                               ; preds = %while.body.i53, %while.body.i38
  %24 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i42 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %24, i64 0, i32 4
  %25 = load i32, ptr %total_size.i.i.i42, align 8
  %conv26.i.i.i43 = sext i32 %25 to i64
  %26 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i44 = add i64 %26, %conv26.i.i.i43
  store i64 %add27.i.i.i44, ptr @memory_FREEDBYTES, align 8
  %27 = load ptr, ptr %24, align 8
  store ptr %27, ptr %List.addr.08.i39, align 8
  %28 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %List.addr.08.i39, ptr %28, align 8
  %cmp.i.not.i45 = icmp eq ptr %List.addr.0.val6.i40, null
  br i1 %cmp.i.not.i45, label %list_DeleteWithElement.exit46, label %while.body.i38
...
land.rhs.us:                                      ; preds = %land.rhs.lr.ph, %land.rhs.us
  %List1.addr.072.us = phi ptr [ %List1.addr.0.val45.us, %land.rhs.us ], [ %List1, %land.rhs.lr.ph ]
  %List1.addr.0.val45.us = load ptr, ptr %List1.addr.072.us, align 8
  ...
  br i1 %cmp.i.not.us, label %cleanup, label %land.rhs.us

land.rhs:                                         ; preds = %land.rhs.lr.ph, %while.body.loopexit
  %List1.addr.072 = phi ptr [ %List1.addr.0.val45, %while.body.loopexit ], [ %List1, %land.rhs.lr.ph ]
...
if.end.i:                                         ; preds = %while.body.i
  ...
  br i1 %cmp.i.not.i, label %while.body.loopexit, label %while.body.i

while.body.loopexit:                              ; preds = %if.end.i
  %List1.addr.0.val45 = load ptr, ptr %List1.addr.072, align 8
  %7 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
...
while.cond8.preheader:                            ; preds = %while.body.i
  %Scan2.073 = load ptr, ptr %List1.addr.072, align 8
  %cmp.i48.not74 = icmp eq ptr %Scan2.073, null
  br i1 %cmp.i48.not74, label %cleanup, label %while.body12

while.body12:                                     ; preds = %while.cond8.preheader, %if.end21
  %Scan2.076 = phi ptr [ %Scan2.0, %if.end21 ], [ %Scan2.073, %while.cond8.preheader ]
  %Scan1.075 = phi ptr [ %Scan1.1, %if.end21 ], [ %List1.addr.072, %while.cond8.preheader ]
  %12 = getelementptr i8, ptr %Scan2.076, i64 8
  %Scan2.0.val = load ptr, ptr %12, align 8
  br label %while.body.i51

while.body.i51:                                   ; preds = %while.body12, %if.end.i57
  %List.addr.09.i52 = phi ptr [ %List.addr.0.val7.i58, %if.end.i57 ], [ %List2, %while.body12 ]
  %13 = getelementptr i8, ptr %List.addr.09.i52, i64 8
  %List.addr.0.val.i53 = load ptr, ptr %13, align 8
  %call2.i54 = tail call i32 %Test(ptr noundef %Scan2.0.val, ptr noundef %List.addr.0.val.i53) #8
  %tobool3.not.i55 = icmp eq i32 %call2.i54, 0
  br i1 %tobool3.not.i55, label %if.end.i57, label %if.then16

if.end.i57:                                       ; preds = %while.body.i51
  %List.addr.0.val7.i58 = load ptr, ptr %List.addr.09.i52, align 8
  %cmp.i.not.i59 = icmp eq ptr %List.addr.0.val7.i58, null
  br i1 %cmp.i.not.i59, label %if.else, label %while.body.i51

if.then16:                                        ; preds = %while.body.i51
  %Scan1.0.val42 = load ptr, ptr %Scan1.075, align 8
  br label %if.end21

if.else:                                          ; preds = %if.end.i57
  %Scan2.0.val41 = load ptr, ptr %Scan2.076, align 8
  store ptr %Scan2.0.val41, ptr %Scan1.075, align 8
  ...
  store ptr %17, ptr %Scan2.076, align 8
  %18 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Scan2.076, ptr %18, align 8
  br label %if.end21

if.end21:                                         ; preds = %if.else, %if.then16
  %Scan1.1 = phi ptr [ %Scan1.0.val42, %if.then16 ], [ %Scan1.075, %if.else ]
  %Scan2.1.in = phi ptr [ %Scan2.076, %if.then16 ], [ %Scan1.075, %if.else ]
  %Scan2.0 = load ptr, ptr %Scan2.1.in, align 8
  %cmp.i48.not = icmp eq ptr %Scan2.0, null
  br i1 %cmp.i48.not, label %cleanup, label %while.body12
...
entry:
  %cmp.i.not70 = icmp eq ptr %List1, null
  br i1 %cmp.i.not70, label %cleanup, label %land.rhs.lr.ph
...
land.rhs.us:                                      ; preds = %land.rhs.lr.ph, %land.rhs.us
  %List1.addr.071.us = phi ptr [ %List1.addr.0.val44.us, %land.rhs.us ], [ %List1, %land.rhs.lr.ph ]
  %List1.addr.0.val44.us = load ptr, ptr %List1.addr.071.us, align 8
  %0 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.us = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %0, i64 0, i32 4
  %1 = load i32, ptr %total_size.i.i.us, align 8
  %conv26.i.i.us = sext i32 %1 to i64
  ...
  store i64 %add27.i.i.us, ptr @memory_FREEDBYTES, align 8
  %3 = load ptr, ptr %0, align 8
  store ptr %3, ptr %List1.addr.071.us, align 8
  %4 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %List1.addr.071.us, ptr %4, align 8
  %cmp.i.not.us = icmp eq ptr %List1.addr.0.val44.us, null
  br i1 %cmp.i.not.us, label %cleanup, label %land.rhs.us

land.rhs:                                         ; preds = %land.rhs.lr.ph, %while.body.loopexit
  %List1.addr.071 = phi ptr [ %List1.addr.0.val44, %while.body.loopexit ], [ %List1, %land.rhs.lr.ph ]
  %5 = getelementptr i8, ptr %List1.addr.071, i64 8
  %List1.addr.0.val = load ptr, ptr %5, align 8
  br label %while.body.i
...
while.body.loopexit:                              ; preds = %if.end.i
  %List1.addr.0.val44 = load ptr, ptr %List1.addr.071, align 8
  %7 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %7, i64 0, i32 4
  %8 = load i32, ptr %total_size.i.i, align 8
  %conv26.i.i = sext i32 %8 to i64
  ...
  store i64 %add27.i.i, ptr @memory_FREEDBYTES, align 8
  %10 = load ptr, ptr %7, align 8
  store ptr %10, ptr %List1.addr.071, align 8
  %11 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %List1.addr.071, ptr %11, align 8
  %cmp.i.not = icmp eq ptr %List1.addr.0.val44, null
  br i1 %cmp.i.not, label %cleanup, label %land.rhs

while.cond8.preheader:                            ; preds = %while.body.i
  %Scan2.072 = load ptr, ptr %List1.addr.071, align 8
  %cmp.i48.not73 = icmp eq ptr %Scan2.072, null
  br i1 %cmp.i48.not73, label %cleanup, label %while.body12

while.body12:                                     ; preds = %while.cond8.preheader, %if.end21
  %Scan2.075 = phi ptr [ %Scan2.0, %if.end21 ], [ %Scan2.072, %while.cond8.preheader ]
  %Scan1.074 = phi ptr [ %Scan1.1, %if.end21 ], [ %List1.addr.071, %while.cond8.preheader ]
  %12 = getelementptr i8, ptr %Scan2.075, i64 8
  %Scan2.0.val = load ptr, ptr %12, align 8
  br label %while.body.i51

while.body.i51:                                   ; preds = %while.body12, %if.end.i55
  %List.addr.07.i52 = phi ptr [ %List.addr.0.val5.i56, %if.end.i55 ], [ %List2, %while.body12 ]
  %13 = getelementptr i8, ptr %List.addr.07.i52, i64 8
  %List.addr.0.val.i53 = load ptr, ptr %13, align 8
  %cmp.i54 = icmp eq ptr %List.addr.0.val.i53, %Scan2.0.val
  br i1 %cmp.i54, label %if.then16, label %if.end.i55

if.end.i55:                                       ; preds = %while.body.i51
  %List.addr.0.val5.i56 = load ptr, ptr %List.addr.07.i52, align 8
  %cmp.i.not.i57 = icmp eq ptr %List.addr.0.val5.i56, null
  br i1 %cmp.i.not.i57, label %if.else, label %while.body.i51

if.then16:                                        ; preds = %while.body.i51
  %Scan1.0.val41 = load ptr, ptr %Scan1.074, align 8
  br label %if.end21

if.else:                                          ; preds = %if.end.i55
  %Scan2.0.val40 = load ptr, ptr %Scan2.075, align 8
  store ptr %Scan2.0.val40, ptr %Scan1.074, align 8
  %14 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  ...
  %17 = load ptr, ptr %14, align 8
  store ptr %17, ptr %Scan2.075, align 8
  %18 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Scan2.075, ptr %18, align 8
  br label %if.end21

if.end21:                                         ; preds = %if.else, %if.then16
  %Scan1.1 = phi ptr [ %Scan1.0.val41, %if.then16 ], [ %Scan1.074, %if.else ]
  %Scan2.1.in = phi ptr [ %Scan2.075, %if.then16 ], [ %Scan1.074, %if.else ]
  %Scan2.0 = load ptr, ptr %Scan2.1.in, align 8
  %cmp.i48.not = icmp eq ptr %Scan2.0, null
  br i1 %cmp.i48.not, label %cleanup, label %while.body12

cleanup:                                          ; preds = %while.body.loopexit, %if.end21, %land.rhs.us, %entry, %while.cond8.preheader
  %List1.addr.069 = phi ptr [ %List1.addr.071, %while.cond8.preheader ], [ null, %entry ], [ null, %land.rhs.us ], [ %List1.addr.071, %if.end21 ], [ null, %while.body.loopexit ]
  ret ptr %List1.addr.069
}
...
entry:
  ...
  br i1 %cmp.i.not10, label %while.end, label %while.condthread-pre-split
...
while.condthread-pre-split:                       ; preds = %entry, %while.condthread-pre-split
  ...
  br i1 %cmp.i.not, label %while.end, label %while.condthread-pre-split
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  %cmp.i.not.i = icmp eq ptr %List.addr.0.val38.i, null
  br i1 %cmp.i.not.i, label %list_PointerDeleteElement.exit, label %land.rhs.i
...
list_PointerDeleteElement.exit:                   ; preds = %while.body.i, %if.end17.i, %for.body, %while.cond7.preheader.i
  ...
  br i1 %cmp.i11.not, label %if.end, label %for.body
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  %cmp.i.not.i = icmp eq ptr %Scan1.054.i, null
  br i1 %cmp.i.not.i, label %list_DeleteElement.exit, label %land.rhs.i
...
entry:
  %cmp.i.not7 = icmp eq ptr %List, null
  br i1 %cmp.i.not7, label %return, label %while.body

while.body:                                       ; preds = %entry, %if.end
  %List.addr.08 = phi ptr [ %List.addr.0.val6, %if.end ], [ %List, %entry ]
  %0 = getelementptr i8, ptr %List.addr.08, i64 8
  %List.addr.0.val = load ptr, ptr %0, align 8
...
if.then:                                          ; preds = %while.body
  %1 = getelementptr i8, ptr %List.addr.08, i64 8
...
for.inc.i:                                        ; preds = %for.body.i
  ...
  br i1 %cmp.i.not.i, label %if.else, label %for.body.i
...
for.inc.i.i:                                      ; preds = %for.body.i.i
  ...
  br i1 %cmp.i.not.i.i, label %if.else.i, label %for.body.i.i
...
if.end.i:                                         ; preds = %if.else.i, %if.then.i
  ...
  br i1 %cmp.i.not.i, label %list_MultisetDistribution.exit, label %for.body.i
...
list_MultisetDistribution.exit:                   ; preds = %if.end.i, %entry
  ...
  br i1 %cmp.i.not20.i9, label %list_MultisetDistribution.exit38, label %for.body.i10

for.body.i10:                                     ; preds = %list_MultisetDistribution.exit, %if.end.i28
  %Distribution.022.i11 = phi ptr [ %Distribution.1.i29, %if.end.i28 ], [ null, %list_MultisetDistribution.exit ]
  %Scan.021.i12 = phi ptr [ %Scan.0.val15.i30, %if.end.i28 ], [ %Right, %list_MultisetDistribution.exit ]
  %5 = getelementptr i8, ptr %Scan.021.i12, i64 8
  %Scan.0.val.i13 = load ptr, ptr %5, align 8
  %cmp.i.not11.i.i14 = icmp eq ptr %Distribution.022.i11, null
  br i1 %cmp.i.not11.i.i14, label %if.else.i23, label %for.body.i.i15

for.body.i.i15:                                   ; preds = %for.body.i10, %for.inc.i.i20
  %Scan.012.i.i16 = phi ptr [ %Scan.0.val10.i.i21, %for.inc.i.i20 ], [ %Distribution.022.i11, %for.body.i10 ]
  %6 = getelementptr i8, ptr %Scan.012.i.i16, i64 8
  %Scan.0.val9.i.i17 = load ptr, ptr %6, align 8
  %7 = getelementptr i8, ptr %Scan.0.val9.i.i17, i64 8
  %call1.val.i.i18 = load ptr, ptr %7, align 8
  %cmp.i16.i19 = icmp eq ptr %call1.val.i.i18, %Scan.0.val.i13
  br i1 %cmp.i16.i19, label %if.then.i33, label %for.inc.i.i20

for.inc.i.i20:                                    ; preds = %for.body.i.i15
  %Scan.0.val10.i.i21 = load ptr, ptr %Scan.012.i.i16, align 8
  %cmp.i.not.i.i22 = icmp eq ptr %Scan.0.val10.i.i21, null
  br i1 %cmp.i.not.i.i22, label %if.else.i23, label %for.body.i.i15

if.then.i33:                                      ; preds = %for.body.i.i15
  %call3.val.i34 = load ptr, ptr %Scan.0.val9.i.i17, align 8
  %8 = ptrtoint ptr %call3.val.i34 to i64
  %add.i35 = shl i64 %8, 32
  %sext.i36 = add i64 %add.i35, 4294967296
  %conv.i37 = ashr exact i64 %sext.i36, 32
  %9 = inttoptr i64 %conv.i37 to ptr
  store ptr %9, ptr %Scan.0.val9.i.i17, align 8
  br label %if.end.i28

if.else.i23:                                      ; preds = %for.inc.i.i20, %for.body.i10
  %call.i.i.i.i24 = tail call ptr @memory_Malloc(i32 noundef 16) #8
  %car.i.i.i.i25 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i.i.i24, i64 0, i32 1
  store ptr %Scan.0.val.i13, ptr %car.i.i.i.i25, align 8
  store ptr inttoptr (i64 1 to ptr), ptr %call.i.i.i.i24, align 8
  %call.i.i.i26 = tail call ptr @memory_Malloc(i32 noundef 16) #8
  %car.i.i.i27 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i.i26, i64 0, i32 1
  store ptr %call.i.i.i.i24, ptr %car.i.i.i27, align 8
  store ptr %Distribution.022.i11, ptr %call.i.i.i26, align 8
  br label %if.end.i28

if.end.i28:                                       ; preds = %if.else.i23, %if.then.i33
  %Distribution.1.i29 = phi ptr [ %Distribution.022.i11, %if.then.i33 ], [ %call.i.i.i26, %if.else.i23 ]
  %Scan.0.val15.i30 = load ptr, ptr %Scan.021.i12, align 8
  %cmp.i.not.i31 = icmp eq ptr %Scan.0.val15.i30, null
  br i1 %cmp.i.not.i31, label %list_MultisetDistribution.exit38, label %for.body.i10

list_MultisetDistribution.exit38:                 ; preds = %if.end.i28, %list_MultisetDistribution.exit
  %Distribution.0.lcssa.i32 = phi ptr [ null, %list_MultisetDistribution.exit ], [ %Distribution.1.i29, %if.end.i28 ]
  ...
  %call.i39 = tail call ptr @list_MergeSort(ptr noundef %Distribution.0.lcssa.i32, ptr noundef nonnull @list_CompareElementDistributionLEQ)
  %cmp.i.not52.i = icmp eq ptr %call.i, null
  br i1 %cmp.i.not52.i, label %land.lhs.true.i, label %lor.rhs.i

lor.rhs.i:                                        ; preds = %list_MultisetDistribution.exit38, %if.end.i40
  %scan2.054.i = phi ptr [ %scan2.0.val34.i, %if.end.i40 ], [ %call.i39, %list_MultisetDistribution.exit38 ]
  %scan.053.i = phi ptr [ %scan.0.val35.i, %if.end.i40 ], [ %call.i, %list_MultisetDistribution.exit38 ]
...
if.end.i40:                                       ; preds = %while.body.i
  ...
  %cmp.i.not.i41 = icmp eq ptr %scan.0.val35.i, null
  br i1 %cmp.i.not.i41, label %land.lhs.true.i, label %lor.rhs.i

land.lhs.true.i:                                  ; preds = %if.end.i40, %list_MultisetDistribution.exit38
  %scan2.0.lcssa.i = phi ptr [ %call.i39, %list_MultisetDistribution.exit38 ], [ %scan2.0.val34.i, %if.end.i40 ]
...
while.body.i.i.i:                                 ; preds = %list_CompareDistributions.exit, %while.body.i.i.i
  ...
  br i1 %cmp.i.not.i.i.i, label %list_DeleteDistribution.exit, label %while.body.i.i.i
...
list_DeleteDistribution.exit:                     ; preds = %while.body.i.i.i, %list_CompareDistributions.exit
  ...
  br i1 %cmp.i.not7.i.i.i42, label %list_DeleteDistribution.exit54, label %while.body.i.i.i43

while.body.i.i.i43:                               ; preds = %list_DeleteDistribution.exit, %while.body.i.i.i43
  %List.addr.08.i.i.i44 = phi ptr [ %List.addr.0.val6.i.i.i45, %while.body.i.i.i43 ], [ %call.i39, %list_DeleteDistribution.exit ]
  %List.addr.0.val6.i.i.i45 = load ptr, ptr %List.addr.08.i.i.i44, align 8
  %27 = getelementptr i8, ptr %List.addr.08.i.i.i44, i64 8
  %List.addr.0.val.i.i.i46 = load ptr, ptr %27, align 8
  %28 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i1.i.i47 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %28, i64 0, i32 4
  %29 = load i32, ptr %total_size.i.i.i1.i.i47, align 8
  %conv26.i.i.i2.i.i48 = sext i32 %29 to i64
  %30 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i3.i.i49 = add i64 %30, %conv26.i.i.i2.i.i48
  store i64 %add27.i.i.i3.i.i49, ptr @memory_FREEDBYTES, align 8
  %31 = load ptr, ptr %28, align 8
  store ptr %31, ptr %List.addr.0.val.i.i.i46, align 8
  %32 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %List.addr.0.val.i.i.i46, ptr %32, align 8
  %33 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i.i50 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %33, i64 0, i32 4
  %34 = load i32, ptr %total_size.i.i.i.i.i50, align 8
  %conv26.i.i.i.i.i51 = sext i32 %34 to i64
  %35 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i.i52 = add i64 %35, %conv26.i.i.i.i.i51
  store i64 %add27.i.i.i.i.i52, ptr @memory_FREEDBYTES, align 8
  %36 = load ptr, ptr %33, align 8
  store ptr %36, ptr %List.addr.08.i.i.i44, align 8
  %37 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %List.addr.08.i.i.i44, ptr %37, align 8
  %cmp.i.not.i.i.i53 = icmp eq ptr %List.addr.0.val6.i.i.i45, null
  br i1 %cmp.i.not.i.i.i53, label %list_DeleteDistribution.exit54, label %while.body.i.i.i43

list_DeleteDistribution.exit54:                   ; preds = %while.body.i.i.i43, %list_DeleteDistribution.exit
  ret i32 %result.2.i
}
...
while.body.i:                                     ; preds = %entry, %while.body.i
  ...
  br i1 %cmp.i.not.i, label %list_Length.exit.loopexit, label %while.body.i
