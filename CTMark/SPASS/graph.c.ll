; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/graph.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/graph.c"
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i.i.not, label %for.inc, label %land.rhs
...
while.body29:                                     ; preds = %land.rhs24
  ...
  br i1 %cmp.i.i63.not, label %while.end32, label %land.rhs24
...
for.body11:                                       ; preds = %for.body, %for.body11
  ...
  br i1 %cmp.i27.not, label %for.cond.loopexit, label %for.body11
