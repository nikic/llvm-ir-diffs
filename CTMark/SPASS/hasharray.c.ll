...
while.body.i27:                                   ; preds = %for.end, %while.body.i27
  ...
  br i1 %cmp.i.not.i33, label %list_Delete.exit34, label %while.body.i27, !llvm.loop !5
...
while.body.i27.i:                                 ; preds = %for.end.i, %while.body.i27.i
  ...
  br i1 %cmp.i.not.i33.i, label %list_Delete.exit34.i, label %while.body.i27.i, !llvm.loop !5
