; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/hasharray.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/hasharray.c"
...
list_Delete.exit:                                 ; preds = %while.body.i, %for.body2
  ...
  br i1 %cmp.i.not, label %for.end, label %for.body2

for.end:                                          ; preds = %list_Delete.exit
  %.pre = load ptr, ptr %arrayidx, align 8
  %cmp.i.not5.i26 = icmp eq ptr %.pre, null
  br i1 %cmp.i.not5.i26, label %list_Delete.exit34, label %while.body.i27

while.body.i27:                                   ; preds = %for.end, %while.body.i27
  %Current.06.i28 = phi ptr [ %Current.0.val.i29, %while.body.i27 ], [ %.pre, %for.end ]
  ...
  %total_size.i.i.i30 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %11, i64 0, i32 4
  %12 = load i32, ptr %total_size.i.i.i30, align 8
  %conv26.i.i.i31 = sext i32 %12 to i64
  %13 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i32 = add i64 %13, %conv26.i.i.i31
  store i64 %add27.i.i.i32, ptr @memory_FREEDBYTES, align 8
  %14 = load ptr, ptr %11, align 8
  store ptr %14, ptr %Current.06.i28, align 8
  %15 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i28, ptr %15, align 8
  %cmp.i.not.i33 = icmp eq ptr %Current.0.val.i29, null
  br i1 %cmp.i.not.i33, label %list_Delete.exit34, label %while.body.i27

list_Delete.exit34:                               ; preds = %while.body.i27, %for.body, %for.end
...
list_Delete.exit.i:                               ; preds = %while.body.i.i, %for.body2.i
  ...
  br i1 %cmp.i.not.i, label %for.end.i, label %for.body2.i

for.end.i:                                        ; preds = %list_Delete.exit.i
  %.pre.i = load ptr, ptr %arrayidx.i, align 8
  %cmp.i.not5.i26.i = icmp eq ptr %.pre.i, null
  br i1 %cmp.i.not5.i26.i, label %list_Delete.exit34.i, label %while.body.i27.i

while.body.i27.i:                                 ; preds = %for.end.i, %while.body.i27.i
  %Current.06.i28.i = phi ptr [ %Current.0.val.i29.i, %while.body.i27.i ], [ %.pre.i, %for.end.i ]
  %Current.0.val.i29.i = load ptr, ptr %Current.06.i28.i, align 8
  %11 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i30.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %11, i64 0, i32 4
  %12 = load i32, ptr %total_size.i.i.i30.i, align 8
  %conv26.i.i.i31.i = sext i32 %12 to i64
  %13 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i32.i = add i64 %13, %conv26.i.i.i31.i
  store i64 %add27.i.i.i32.i, ptr @memory_FREEDBYTES, align 8
  %14 = load ptr, ptr %11, align 8
  store ptr %14, ptr %Current.06.i28.i, align 8
  %15 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i28.i, ptr %15, align 8
  %cmp.i.not.i33.i = icmp eq ptr %Current.0.val.i29.i, null
  br i1 %cmp.i.not.i33.i, label %list_Delete.exit34.i, label %while.body.i27.i

list_Delete.exit34.i:                             ; preds = %while.body.i27.i, %for.end.i, %for.body.i
  store ptr null, ptr %arrayidx.i, align 8
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 29
  br i1 %exitcond.not.i, label %hsh_Reset.exit, label %for.body.i
...
define dso_local void @hsh_Check(ptr nocapture noundef readonly %H) local_unnamed_addr #3 {
entry:
  ret void
}
