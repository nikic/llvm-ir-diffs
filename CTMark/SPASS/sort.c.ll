; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/sort.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/sort.c"
...
for.inc16.us:                                     ; preds = %for.cond3.for.end_crit_edge.us
  ...
  br i1 %cmp.i.not.us, label %cleanup, label %for.cond3.preheader.us
...
for.body8.us:                                     ; preds = %for.cond3.preheader.us, %for.body8.us
  ...
  br i1 %2, label %for.body8.us, label %for.cond3.for.end_crit_edge.us
...
for.body.loopexit:                                ; preds = %for.inc
  ...
  br i1 %cond, label %cleanup, label %for.body6.lr.ph
...
for.inc:                                          ; preds = %for.body6
  ...
  br i1 %cmp.i24.not, label %for.body.loopexit, label %for.body6
...
if.end:                                           ; preds = %entry
  %mark.i = getelementptr inbounds %struct.SORTTHEORY_HELP, ptr %Theory, i64 0, i32 4
...
for.body.i:                                       ; preds = %if.end, %for.body.i
  ...
  br i1 %exitcond.not.i.4, label %sort_TheoryIncrementMark.exit, label %for.body.i
...
for.body:                                         ; preds = %sort_TheoryIncrementMark.exit, %for.body
  ...
  br i1 %cmp.i30.not, label %for.cond5.preheader, label %for.body
...
for.inc15:                                        ; preds = %for.body9
  ...
  br i1 %cmp.i32.not, label %cleanup, label %for.body9
...
while.body.i.i:                                   ; preds = %entry, %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i, label %sort_DeleteOne.exit, label %while.body.i.i
...
if.then.i:                                        ; preds = %sort_DeleteOne.exit
  ...
  br i1 %cmp.i.not5.i.i5, label %list_Delete.exit.i, label %while.body.i.i6

while.body.i.i6:                                  ; preds = %if.then.i, %while.body.i.i6
  %Current.06.i.i7 = phi ptr [ %Current.0.val.i.i8, %while.body.i.i6 ], [ %C.val11.i, %if.then.i ]
  %Current.0.val.i.i8 = load ptr, ptr %Current.06.i.i7, align 8
  %10 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i9 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %10, i64 0, i32 4
  %11 = load i32, ptr %total_size.i.i.i.i9, align 8
  %conv26.i.i.i.i10 = sext i32 %11 to i64
  %12 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i11 = add i64 %12, %conv26.i.i.i.i10
  store i64 %add27.i.i.i.i11, ptr @memory_FREEDBYTES, align 8
  %13 = load ptr, ptr %10, align 8
  store ptr %13, ptr %Current.06.i.i7, align 8
  %14 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i7, ptr %14, align 8
  %cmp.i.not.i.i12 = icmp eq ptr %Current.0.val.i.i8, null
  br i1 %cmp.i.not.i.i12, label %list_Delete.exit.i, label %while.body.i.i6

list_Delete.exit.i:                               ; preds = %while.body.i.i6, %if.then.i
...
for.body11.i:                                     ; preds = %for.end.i, %for.body11.i
  ...
  br i1 %cmp.i63.not.i, label %for.end16.i, label %for.body11.i
...
for.body22.i:                                     ; preds = %for.end16.i, %for.body22.i
  ...
  br i1 %cmp.i66.not.i, label %for.end27.i, label %for.body22.i
...
for.body33.i:                                     ; preds = %for.end27.i, %for.body33.i
  ...
  br i1 %cmp.i69.not.i, label %sort_ConditionPrint.exit, label %for.body33.i
...
for.inc27.i:                                      ; preds = %for.body19.i
  ...
  br i1 %cmp.i111.not.i, label %for.end29.i, label %for.body19.i
...
for.inc44.i:                                      ; preds = %for.body36.i
  ...
  br i1 %cmp.i116.not.i, label %for.end46.i, label %for.body36.i
...
for.inc61.i:                                      ; preds = %for.body53.i
  ...
  br i1 %cmp.i121.not.i, label %sort_LinkPrint.exit, label %for.body53.i
...
for.body17:                                       ; preds = %for.end, %for.body17
  ...
  br i1 %cmp.i36.not, label %cleanup, label %for.body17
...
while.body.i.i:                                   ; preds = %for.end.i, %while.body.i.i
  ...
  %cmp.i.not.i.i = icmp eq ptr %Current.0.val.i.i, null
  br i1 %cmp.i.not.i.i, label %sort_LinkDelete.exit, label %while.body.i.i
...
while.body.i:                                     ; preds = %sort_LinkDelete.exit, %while.body.i
  ...
  br i1 %cmp.i.not.i79, label %list_Delete.exit, label %while.body.i
...
for.end:                                          ; preds = %list_Delete.exit
  ...
  br i1 %cmp.i.not5.i80, label %list_Delete.exit88, label %while.body.i81

while.body.i81:                                   ; preds = %for.end, %while.body.i81
  %Current.06.i82 = phi ptr [ %Current.0.val.i83, %while.body.i81 ], [ %.pre, %for.end ]
  ...
  %total_size.i.i.i84 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %22, i64 0, i32 4
  %23 = load i32, ptr %total_size.i.i.i84, align 8
  %conv26.i.i.i85 = sext i32 %23 to i64
  %24 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i86 = add i64 %24, %conv26.i.i.i85
  store i64 %add27.i.i.i86, ptr @memory_FREEDBYTES, align 8
  %25 = load ptr, ptr %22, align 8
  store ptr %25, ptr %Current.06.i82, align 8
  %26 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i82, ptr %26, align 8
  %cmp.i.not.i87 = icmp eq ptr %Current.0.val.i83, null
  br i1 %cmp.i.not.i87, label %list_Delete.exit88, label %while.body.i81

list_Delete.exit88:                               ; preds = %while.body.i81, %if.then, %for.end
...
for.body10:                                       ; preds = %list_Delete.exit88, %list_Delete.exit118
  ...
  br i1 %cmp.i.not5.i91, label %list_Delete.exit99, label %while.body.i92

while.body.i92:                                   ; preds = %for.body10, %while.body.i92
  %Current.06.i93 = phi ptr [ %Current.0.val.i94, %while.body.i92 ], [ %call14.val, %for.body10 ]
  %Current.0.val.i94 = load ptr, ptr %Current.06.i93, align 8
  %36 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i95 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %36, i64 0, i32 4
  %37 = load i32, ptr %total_size.i.i.i95, align 8
  %conv26.i.i.i96 = sext i32 %37 to i64
  %38 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i97 = add i64 %38, %conv26.i.i.i96
  store i64 %add27.i.i.i97, ptr @memory_FREEDBYTES, align 8
  %39 = load ptr, ptr %36, align 8
  store ptr %39, ptr %Current.06.i93, align 8
  %40 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i93, ptr %40, align 8
  %cmp.i.not.i98 = icmp eq ptr %Current.0.val.i94, null
  br i1 %cmp.i.not.i98, label %list_Delete.exit99, label %while.body.i92

list_Delete.exit99:                               ; preds = %while.body.i92, %for.body10
  %call12.val = load ptr, ptr %29, align 8
  %cmp.i.not5.i100 = icmp eq ptr %call12.val, null
  br i1 %cmp.i.not5.i100, label %list_Delete.exit108, label %while.body.i101

while.body.i101:                                  ; preds = %list_Delete.exit99, %while.body.i101
  %Current.06.i102 = phi ptr [ %Current.0.val.i103, %while.body.i101 ], [ %call12.val, %list_Delete.exit99 ]
  %Current.0.val.i103 = load ptr, ptr %Current.06.i102, align 8
  %41 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i104 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %41, i64 0, i32 4
  %42 = load i32, ptr %total_size.i.i.i104, align 8
  %conv26.i.i.i105 = sext i32 %42 to i64
  %43 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i106 = add i64 %43, %conv26.i.i.i105
  store i64 %add27.i.i.i106, ptr @memory_FREEDBYTES, align 8
  %44 = load ptr, ptr %41, align 8
  store ptr %44, ptr %Current.06.i102, align 8
  %45 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i102, ptr %45, align 8
  %cmp.i.not.i107 = icmp eq ptr %Current.0.val.i103, null
  br i1 %cmp.i.not.i107, label %list_Delete.exit108, label %while.body.i101

list_Delete.exit108:                              ; preds = %while.body.i101, %list_Delete.exit99
...
while.body.i111:                                  ; preds = %list_Delete.exit108, %while.body.i111
  %Current.06.i112 = phi ptr [ %Current.0.val.i113, %while.body.i111 ], [ %Scan.1.val71, %list_Delete.exit108 ]
  %Current.0.val.i113 = load ptr, ptr %Current.06.i112, align 8
  %47 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i114 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %47, i64 0, i32 4
  %48 = load i32, ptr %total_size.i.i.i114, align 8
  %conv26.i.i.i115 = sext i32 %48 to i64
  %49 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i116 = add i64 %49, %conv26.i.i.i115
  store i64 %add27.i.i.i116, ptr @memory_FREEDBYTES, align 8
  %50 = load ptr, ptr %47, align 8
  store ptr %50, ptr %Current.06.i112, align 8
  %51 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i112, ptr %51, align 8
  %cmp.i.not.i117 = icmp eq ptr %Current.0.val.i113, null
  br i1 %cmp.i.not.i117, label %list_Delete.exit118, label %while.body.i111

list_Delete.exit118:                              ; preds = %while.body.i111
  %Scan.1 = load ptr, ptr %Scan.1145, align 8
  %cmp.i89.not = icmp eq ptr %Scan.1, null
  br i1 %cmp.i89.not, label %for.end27, label %for.body10

for.end27:                                        ; preds = %list_Delete.exit118
  %.pre149 = load ptr, ptr %termorigcls, align 8
  %cmp.i.not5.i119 = icmp eq ptr %.pre149, null
  br i1 %cmp.i.not5.i119, label %list_Delete.exit127, label %while.body.i120

while.body.i120:                                  ; preds = %for.end27, %while.body.i120
  %Current.06.i121 = phi ptr [ %Current.0.val.i122, %while.body.i120 ], [ %.pre149, %for.end27 ]
  %Current.0.val.i122 = load ptr, ptr %Current.06.i121, align 8
  %52 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i123 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %52, i64 0, i32 4
  %53 = load i32, ptr %total_size.i.i.i123, align 8
  %conv26.i.i.i124 = sext i32 %53 to i64
  %54 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i125 = add i64 %54, %conv26.i.i.i124
  store i64 %add27.i.i.i125, ptr @memory_FREEDBYTES, align 8
  %55 = load ptr, ptr %52, align 8
  store ptr %55, ptr %Current.06.i121, align 8
  %56 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i121, ptr %56, align 8
  %cmp.i.not.i126 = icmp eq ptr %Current.0.val.i122, null
  br i1 %cmp.i.not.i126, label %list_Delete.exit127, label %while.body.i120

list_Delete.exit127:                              ; preds = %while.body.i120, %list_Delete.exit88, %for.end27
...
if.then34:                                        ; preds = %for.body32
  ...
  br i1 %cmp.i.not5.i.i128, label %sort_NodeDelete.exit, label %while.body.i.i129

while.body.i.i129:                                ; preds = %if.then34, %while.body.i.i129
  %Current.06.i.i130 = phi ptr [ %Current.0.val.i.i131, %while.body.i.i129 ], [ %61, %if.then34 ]
  %Current.0.val.i.i131 = load ptr, ptr %Current.06.i.i130, align 8
  %62 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i132 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %62, i64 0, i32 4
  %63 = load i32, ptr %total_size.i.i.i.i132, align 8
  %conv26.i.i.i.i133 = sext i32 %63 to i64
  %64 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i134 = add i64 %64, %conv26.i.i.i.i133
  store i64 %add27.i.i.i.i134, ptr @memory_FREEDBYTES, align 8
  %65 = load ptr, ptr %62, align 8
  store ptr %65, ptr %Current.06.i.i130, align 8
  %66 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i130, ptr %66, align 8
  %cmp.i.not.i.i135 = icmp eq ptr %Current.0.val.i.i131, null
  br i1 %cmp.i.not.i.i135, label %sort_NodeDelete.exit, label %while.body.i.i129

sort_NodeDelete.exit:                             ; preds = %while.body.i.i129, %if.then34
...
for.end39:                                        ; preds = %for.inc38, %list_Delete.exit127
  ...
  %76 = sub i32 %sub6.i.i.i, %rem2.i.i.i
  %RealSize.1.i.i.i = select i1 %tobool3.not.i.i.i, i32 32032, i32 %76
  %77 = load i32, ptr @memory_OFFSET, align 4
...
clause_GetLiteralAtom.exit.i:                     ; preds = %for.body.i
  ...
  br i1 %cmp.i.not.i, label %if.then.i.i135.i, label %if.else.i
...
if.then.i.i135.i:                                 ; preds = %clause_GetLiteralAtom.exit.i
  %call15.val.pre.i = load i32, ptr %call1.val.val.i.i.i, align 8
  br label %clause_GetLiteralAtom.exit138.i

clause_GetLiteralAtom.exit138.i:                  ; preds = %if.then.i.i135.i, %clause_GetLiteralAtom.exit.thread.i
  %call15.val.i = phi i32 [ %call15.val.pre.i, %if.then.i.i135.i ], [ %L.val7.val.i.i.i, %clause_GetLiteralAtom.exit.thread.i ]
...
for.inc.i:                                        ; preds = %if.else.i, %clause_GetLiteralAtom.exit138.i
  ...
  br i1 %cmp.not.not.i, label %for.body.i, label %for.cond23.preheader.i
...
for.body26.i:                                     ; preds = %for.body26.i, %for.body26.lr.ph.i
  ...
  br i1 %cmp25.not.not.i, label %for.body26.i, label %for.end32.i
...
for.inc45.i:                                      ; preds = %if.then40.i, %for.body37.i
  ...
  br i1 %cmp36.not.not.i, label %for.body37.i, label %for.end47.i
...
while.body.i:                                     ; preds = %for.end47.i, %while.body.i
  ...
  br i1 %cmp.i164.not.i, label %sort_TheoryLinkCreate.exit, label %while.body.i
...
while.body.i:                                     ; preds = %sort_LinkDelete.exit, %while.body.i
  ...
  br i1 %cmp.i.not.i77, label %for.inc, label %while.body.i
...
if.then17:                                        ; preds = %for.body13
  ...
  br i1 %cmp.i.not5.i81, label %list_Delete.exit89, label %while.body.i82

while.body.i82:                                   ; preds = %if.then17, %while.body.i82
  %Current.06.i83 = phi ptr [ %Current.0.val.i84, %while.body.i82 ], [ %call20.val, %if.then17 ]
  %Current.0.val.i84 = load ptr, ptr %Current.06.i83, align 8
  %34 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i85 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %34, i64 0, i32 4
  %35 = load i32, ptr %total_size.i.i.i85, align 8
  %conv26.i.i.i86 = sext i32 %35 to i64
  %36 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i87 = add i64 %36, %conv26.i.i.i86
  store i64 %add27.i.i.i87, ptr @memory_FREEDBYTES, align 8
  %37 = load ptr, ptr %34, align 8
  store ptr %37, ptr %Current.06.i83, align 8
  %38 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i83, ptr %38, align 8
  %cmp.i.not.i88 = icmp eq ptr %Current.0.val.i84, null
  br i1 %cmp.i.not.i88, label %list_Delete.exit89, label %while.body.i82

list_Delete.exit89:                               ; preds = %while.body.i82, %if.then17
  %call18.val = load ptr, ptr %27, align 8
  %cmp.i.not5.i90 = icmp eq ptr %call18.val, null
  br i1 %cmp.i.not5.i90, label %list_Delete.exit98, label %while.body.i91

while.body.i91:                                   ; preds = %list_Delete.exit89, %while.body.i91
  %Current.06.i92 = phi ptr [ %Current.0.val.i93, %while.body.i91 ], [ %call18.val, %list_Delete.exit89 ]
  ...
  %total_size.i.i.i94 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %39, i64 0, i32 4
  %40 = load i32, ptr %total_size.i.i.i94, align 8
  %conv26.i.i.i95 = sext i32 %40 to i64
  %41 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i96 = add i64 %41, %conv26.i.i.i95
  store i64 %add27.i.i.i96, ptr @memory_FREEDBYTES, align 8
  %42 = load ptr, ptr %39, align 8
  store ptr %42, ptr %Current.06.i92, align 8
  %43 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i92, ptr %43, align 8
  %cmp.i.not.i97 = icmp eq ptr %Current.0.val.i93, null
  br i1 %cmp.i.not.i97, label %list_Delete.exit98, label %while.body.i91

list_Delete.exit98:                               ; preds = %while.body.i91, %list_Delete.exit89
...
while.body.i101:                                  ; preds = %list_Delete.exit98, %while.body.i101
  %Current.06.i102 = phi ptr [ %Current.0.val.i103, %while.body.i101 ], [ %Scan.1.val67, %list_Delete.exit98 ]
  %Current.0.val.i103 = load ptr, ptr %Current.06.i102, align 8
  %45 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i104 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %45, i64 0, i32 4
  %46 = load i32, ptr %total_size.i.i.i104, align 8
  %conv26.i.i.i105 = sext i32 %46 to i64
  %47 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i106 = add i64 %47, %conv26.i.i.i105
  store i64 %add27.i.i.i106, ptr @memory_FREEDBYTES, align 8
  %48 = load ptr, ptr %45, align 8
  store ptr %48, ptr %Current.06.i102, align 8
  %49 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i102, ptr %49, align 8
  %cmp.i.not.i107 = icmp eq ptr %Current.0.val.i103, null
  br i1 %cmp.i.not.i107, label %for.inc32, label %while.body.i101

for.inc32:                                        ; preds = %while.body.i101, %for.body13
  %Scan.1 = load ptr, ptr %Scan.1114, align 8
  %cmp.i78.not = icmp eq ptr %Scan.1, null
  br i1 %cmp.i78.not, label %for.end34.loopexit, label %for.body13
...
for.body10:                                       ; preds = %for.end, %for.body10
  ...
  br i1 %cmp.i102.not, label %for.end15, label %for.body10
...
for.body21:                                       ; preds = %for.end15, %for.body21
  ...
  br i1 %cmp.i104.not, label %for.end26, label %for.body21
...
for.body35:                                       ; preds = %for.end26, %for.body35
  ...
  br i1 %cmp.i106.not, label %for.cond41.preheader, label %for.body35
...
for.body45:                                       ; preds = %for.cond41.preheader, %for.body45
  ...
  br i1 %cmp.i108.not, label %for.cond51.preheader, label %for.body45
...
for.body55:                                       ; preds = %for.cond51.preheader, %for.body55
  ...
  br i1 %cmp.i110.not, label %for.end59, label %for.body55
...
for.body:                                         ; preds = %entry, %for.body
  ...
  br i1 %cmp.i.not, label %for.cond11.preheader, label %for.body
...
for.body15:                                       ; preds = %for.cond11.preheader, %for.body15
  ...
  br i1 %cmp.i187.not, label %for.cond21.preheader, label %for.body15
...
for.body25:                                       ; preds = %for.cond21.preheader, %for.body25
  ...
  br i1 %cmp.i189.not, label %for.end30, label %for.body25
...
for.body38:                                       ; preds = %for.end30, %for.body38
  ...
  br i1 %cmp.i191.not, label %for.cond43.preheader, label %for.body38
...
for.body47:                                       ; preds = %for.cond43.preheader, %for.body47
  ...
  br i1 %cmp.i193.not, label %for.cond52.preheader, label %for.body47
...
for.body56:                                       ; preds = %for.cond52.preheader, %for.body56
  ...
  br i1 %cmp.i195.not, label %for.end60, label %for.body56
...
for.body67:                                       ; preds = %for.end60, %for.body67
  ...
  br i1 %cmp.i197.not, label %for.end71, label %for.body67
...
for.body77:                                       ; preds = %for.end71, %for.body77
  ...
  br i1 %cmp.i199.not, label %for.end81, label %for.body77
...
for.body87:                                       ; preds = %for.end81, %for.body87
  ...
  br i1 %cmp.i201.not, label %for.end91, label %for.body87
...
list_Nconc.exit:                                  ; preds = %for.end91, %for.end.i
  ...
  br i1 %brmerge245, label %list_Nconc.exit212, label %for.cond.i206

for.cond.i206:                                    ; preds = %list_Nconc.exit, %for.cond.i206
  %List1.addr.0.i207 = phi ptr [ %List1.addr.0.val17.i208, %for.cond.i206 ], [ %Cond.val174, %list_Nconc.exit ]
  %List1.addr.0.val17.i208 = load ptr, ptr %List1.addr.0.i207, align 8
  %cmp.i20.not.i209 = icmp eq ptr %List1.addr.0.val17.i208, null
  br i1 %cmp.i20.not.i209, label %for.end.i210, label %for.cond.i206

for.end.i210:                                     ; preds = %for.cond.i206
  store ptr %call.i185, ptr %List1.addr.0.i207, align 8
...
list_Nconc.exit212:                               ; preds = %list_Nconc.exit, %for.end.i210
  ...
  br i1 %brmerge246, label %list_Nconc.exit222, label %for.cond.i216

for.cond.i216:                                    ; preds = %list_Nconc.exit212, %for.cond.i216
  %List1.addr.0.i217 = phi ptr [ %List1.addr.0.val17.i218, %for.cond.i216 ], [ %Cond.val176, %list_Nconc.exit212 ]
  %List1.addr.0.val17.i218 = load ptr, ptr %List1.addr.0.i217, align 8
  %cmp.i20.not.i219 = icmp eq ptr %List1.addr.0.val17.i218, null
  br i1 %cmp.i20.not.i219, label %for.end.i220, label %for.cond.i216

for.end.i220:                                     ; preds = %for.cond.i216
  store ptr %call.i186, ptr %List1.addr.0.i217, align 8
...
for.body15:                                       ; preds = %for.cond11.preheader, %for.body15
  ...
  br i1 %cmp.i188.not, label %for.cond21.preheader, label %for.body15
...
for.body25:                                       ; preds = %for.cond21.preheader, %for.body25
  ...
  br i1 %cmp.i190.not, label %for.end30, label %for.body25
...
for.body38:                                       ; preds = %for.end30, %for.body38
  ...
  br i1 %cmp.i192.not, label %for.cond43.preheader, label %for.body38
...
for.body47:                                       ; preds = %for.cond43.preheader, %for.body47
  ...
  br i1 %cmp.i194.not, label %for.cond52.preheader, label %for.body47
...
for.body56:                                       ; preds = %for.cond52.preheader, %for.body56
  ...
  br i1 %cmp.i196.not, label %for.end60, label %for.body56
...
for.body67:                                       ; preds = %for.end60, %for.body67
  ...
  br i1 %cmp.i198.not, label %for.end71, label %for.body67
...
for.body77:                                       ; preds = %for.end71, %for.body77
  ...
  br i1 %cmp.i200.not, label %for.end81, label %for.body77
...
for.body87:                                       ; preds = %for.end81, %for.body87
  ...
  br i1 %cmp.i202.not, label %for.end91, label %for.body87
...
list_Nconc.exit:                                  ; preds = %for.end91, %for.end.i
  ...
  br i1 %brmerge255, label %list_Nconc.exit213, label %for.cond.i207

for.cond.i207:                                    ; preds = %list_Nconc.exit, %for.cond.i207
  %List1.addr.0.i208 = phi ptr [ %List1.addr.0.val17.i209, %for.cond.i207 ], [ %Cond.val175, %list_Nconc.exit ]
  %List1.addr.0.val17.i209 = load ptr, ptr %List1.addr.0.i208, align 8
  %cmp.i20.not.i210 = icmp eq ptr %List1.addr.0.val17.i209, null
  br i1 %cmp.i20.not.i210, label %for.end.i211, label %for.cond.i207

for.end.i211:                                     ; preds = %for.cond.i207
  store ptr %call.i186, ptr %List1.addr.0.i208, align 8
...
list_Nconc.exit213:                               ; preds = %list_Nconc.exit, %for.end.i211
  ...
  br i1 %brmerge256, label %list_Nconc.exit223, label %for.cond.i217

for.cond.i217:                                    ; preds = %list_Nconc.exit213, %for.cond.i217
  %List1.addr.0.i218 = phi ptr [ %List1.addr.0.val17.i219, %for.cond.i217 ], [ %Cond.val178, %list_Nconc.exit213 ]
  %List1.addr.0.val17.i219 = load ptr, ptr %List1.addr.0.i218, align 8
  %cmp.i20.not.i220 = icmp eq ptr %List1.addr.0.val17.i219, null
  br i1 %cmp.i20.not.i220, label %for.end.i221, label %for.cond.i217

for.end.i221:                                     ; preds = %for.cond.i217
  store ptr %call.i187, ptr %List1.addr.0.i218, align 8
...
list_Nconc.exit223:                               ; preds = %list_Nconc.exit213, %for.end.i221
  ...
  br i1 %cmp.i.not.i224, label %list_Nconc.exit233, label %if.end.i225

if.end.i225:                                      ; preds = %list_Nconc.exit223
  %cmp.i18.not.i226 = icmp eq ptr %Cond.val181, null
  br i1 %cmp.i18.not.i226, label %list_Nconc.exit233, label %for.cond.i227

for.cond.i227:                                    ; preds = %if.end.i225, %for.cond.i227
  %List1.addr.0.i228 = phi ptr [ %List1.addr.0.val17.i229, %for.cond.i227 ], [ %call99, %if.end.i225 ]
  %List1.addr.0.val17.i229 = load ptr, ptr %List1.addr.0.i228, align 8
  %cmp.i20.not.i230 = icmp eq ptr %List1.addr.0.val17.i229, null
  br i1 %cmp.i20.not.i230, label %for.end.i231, label %for.cond.i227

for.end.i231:                                     ; preds = %for.cond.i227
  store ptr %Cond.val181, ptr %List1.addr.0.i228, align 8
  br label %list_Nconc.exit233

list_Nconc.exit233:                               ; preds = %list_Nconc.exit223, %if.end.i225, %for.end.i231
  %retval.0.i232 = phi ptr [ %call99, %for.end.i231 ], [ %Cond.val181, %list_Nconc.exit223 ], [ %call99, %if.end.i225 ]
...
for.body29:                                       ; preds = %if.else, %for.body29
  ...
  br i1 %cmp.i221.not, label %for.cond33.preheader, label %for.body29
...
for.body37:                                       ; preds = %for.cond33.preheader, %for.body37
  ...
  br i1 %cmp.i223.not, label %for.cond43.preheader, label %for.body37
...
for.body47:                                       ; preds = %for.cond43.preheader, %for.body47
  ...
  br i1 %cmp.i225.not, label %for.end52, label %for.body47
...
for.body60:                                       ; preds = %for.end52, %for.body60
  ...
  br i1 %cmp.i227.not, label %for.cond65.preheader, label %for.body60
...
for.body69:                                       ; preds = %for.cond65.preheader, %for.body69
  ...
  br i1 %cmp.i229.not, label %for.cond74.preheader, label %for.body69
...
for.body78:                                       ; preds = %for.cond74.preheader, %for.body78
  ...
  br i1 %cmp.i231.not, label %for.end82, label %for.body78
...
for.body88:                                       ; preds = %for.end82, %for.body88
  ...
  br i1 %cmp.i233.not, label %for.cond93.preheader, label %for.body88
...
for.body97:                                       ; preds = %for.cond93.preheader, %for.body97
  ...
  br i1 %cmp.i235.not, label %for.cond102.preheader, label %for.body97
...
for.body106:                                      ; preds = %for.cond102.preheader, %for.body106
  ...
  br i1 %cmp.i237.not, label %for.end110, label %for.body106
...
list_Nconc.exit:                                  ; preds = %for.end110, %for.end.i
  ...
  br i1 %brmerge292, label %list_Nconc.exit249, label %for.cond.i243

for.cond.i243:                                    ; preds = %list_Nconc.exit, %for.cond.i243
  %List1.addr.0.i244 = phi ptr [ %List1.addr.0.val17.i245, %for.cond.i243 ], [ %call.i212, %list_Nconc.exit ]
  %List1.addr.0.val17.i245 = load ptr, ptr %List1.addr.0.i244, align 8
  %cmp.i20.not.i246 = icmp eq ptr %List1.addr.0.val17.i245, null
  br i1 %cmp.i20.not.i246, label %for.end.i247, label %for.cond.i243

for.end.i247:                                     ; preds = %for.cond.i243
  store ptr %call.i219, ptr %List1.addr.0.i244, align 8
...
list_Nconc.exit249:                               ; preds = %list_Nconc.exit, %for.end.i247
  ...
  br i1 %brmerge293, label %list_Nconc.exit259, label %for.cond.i253

for.cond.i253:                                    ; preds = %list_Nconc.exit249, %for.cond.i253
  %List1.addr.0.i254 = phi ptr [ %List1.addr.0.val17.i255, %for.cond.i253 ], [ %call.i213, %list_Nconc.exit249 ]
  %List1.addr.0.val17.i255 = load ptr, ptr %List1.addr.0.i254, align 8
  %cmp.i20.not.i256 = icmp eq ptr %List1.addr.0.val17.i255, null
  br i1 %cmp.i20.not.i256, label %for.end.i257, label %for.cond.i253

for.end.i257:                                     ; preds = %for.cond.i253
  store ptr %call.i220, ptr %List1.addr.0.i254, align 8
...
for.inc121:                                       ; preds = %if.then, %list_Nconc.exit259
  ...
  br i1 %cmp.i.not, label %for.end123, label %for.body
...
for.body34:                                       ; preds = %if.then23, %for.body34
  ...
  br i1 %cmp.i232.not, label %for.cond38.preheader, label %for.body34
...
for.body42:                                       ; preds = %for.cond38.preheader, %for.body42
  ...
  br i1 %cmp.i234.not, label %for.cond48.preheader, label %for.body42
...
for.body52:                                       ; preds = %for.cond48.preheader, %for.body52
  ...
  br i1 %cmp.i236.not, label %for.end57, label %for.body52
...
for.body65:                                       ; preds = %for.end57, %for.body65
  ...
  br i1 %cmp.i238.not, label %for.cond70.preheader, label %for.body65
...
for.body74:                                       ; preds = %for.cond70.preheader, %for.body74
  ...
  br i1 %cmp.i240.not, label %for.cond79.preheader, label %for.body74
...
for.body83:                                       ; preds = %for.cond79.preheader, %for.body83
  ...
  br i1 %cmp.i242.not, label %for.cond88.preheader, label %for.body83
...
for.body92:                                       ; preds = %for.cond88.preheader, %for.body92
  ...
  br i1 %cmp.i244.not, label %for.cond97.preheader, label %for.body92
...
for.body101:                                      ; preds = %for.cond97.preheader, %for.body101
  ...
  br i1 %cmp.i246.not, label %for.cond106.preheader, label %for.body101
...
for.body110:                                      ; preds = %for.cond106.preheader, %for.body110
  ...
  br i1 %cmp.i248.not, label %for.end114, label %for.body110
...
list_Nconc.exit:                                  ; preds = %for.end114, %for.end.i
  ...
  br i1 %brmerge317, label %list_Nconc.exit260, label %for.cond.i254

for.cond.i254:                                    ; preds = %list_Nconc.exit, %for.cond.i254
  %List1.addr.0.i255 = phi ptr [ %List1.addr.0.val17.i256, %for.cond.i254 ], [ %call.i230, %list_Nconc.exit ]
  %List1.addr.0.val17.i256 = load ptr, ptr %List1.addr.0.i255, align 8
  %cmp.i20.not.i257 = icmp eq ptr %List1.addr.0.val17.i256, null
  br i1 %cmp.i20.not.i257, label %for.end.i258, label %for.cond.i254

for.end.i258:                                     ; preds = %for.cond.i254
  store ptr %NewAntecedent.0309, ptr %List1.addr.0.i255, align 8
...
list_Nconc.exit260:                               ; preds = %list_Nconc.exit, %for.end.i258
  ...
  br i1 %cmp.i236.not292, label %if.end118, label %if.end.i262

if.end.i262:                                      ; preds = %list_Nconc.exit260
  br i1 %cmp.i248.not304, label %if.end118, label %for.cond.i264

for.cond.i264:                                    ; preds = %if.end.i262, %for.cond.i264
  %List1.addr.0.i265 = phi ptr [ %List1.addr.0.val17.i266, %for.cond.i264 ], [ %call.i231, %if.end.i262 ]
  %List1.addr.0.val17.i266 = load ptr, ptr %List1.addr.0.i265, align 8
  %cmp.i20.not.i267 = icmp eq ptr %List1.addr.0.val17.i266, null
  br i1 %cmp.i20.not.i267, label %for.end.i268, label %for.cond.i264

for.end.i268:                                     ; preds = %for.cond.i264
  store ptr %NewSuccedent.0310, ptr %List1.addr.0.i265, align 8
  br label %if.end118

if.end118:                                        ; preds = %for.end.i268, %if.end.i262, %list_Nconc.exit260, %sort_ConditionNoResidues.exit
  %Act.1 = phi i32 [ %Act.0308, %sort_ConditionNoResidues.exit ], [ %inc.i, %list_Nconc.exit260 ], [ %inc.i, %if.end.i262 ], [ %inc.i, %for.end.i268 ]
  %NewAntecedent.1 = phi ptr [ %NewAntecedent.0309, %sort_ConditionNoResidues.exit ], [ %retval.0.i259, %list_Nconc.exit260 ], [ %retval.0.i259, %if.end.i262 ], [ %retval.0.i259, %for.end.i268 ]
  %NewSuccedent.1 = phi ptr [ %NewSuccedent.0310, %sort_ConditionNoResidues.exit ], [ %NewSuccedent.0310, %list_Nconc.exit260 ], [ %call.i231, %if.end.i262 ], [ %call.i231, %for.end.i268 ]
  %NewConstraint.1 = phi ptr [ %NewConstraint.0311, %sort_ConditionNoResidues.exit ], [ %retval.0.i, %list_Nconc.exit260 ], [ %retval.0.i, %if.end.i262 ], [ %retval.0.i, %for.end.i268 ]
  ...
  br i1 %cmp.i.not.i271, label %list_Nconc.exit280, label %if.end.i272

if.end.i272:                                      ; preds = %if.end118
  %cmp.i18.not.i273 = icmp eq ptr %NewClauses.0312, null
  br i1 %cmp.i18.not.i273, label %list_Nconc.exit280, label %for.cond.i274

for.cond.i274:                                    ; preds = %if.end.i272, %for.cond.i274
  %List1.addr.0.i275 = phi ptr [ %List1.addr.0.val17.i276, %for.cond.i274 ], [ %call120, %if.end.i272 ]
  %List1.addr.0.val17.i276 = load ptr, ptr %List1.addr.0.i275, align 8
  %cmp.i20.not.i277 = icmp eq ptr %List1.addr.0.val17.i276, null
  br i1 %cmp.i20.not.i277, label %for.end.i278, label %for.cond.i274

for.end.i278:                                     ; preds = %for.cond.i274
  store ptr %NewClauses.0312, ptr %List1.addr.0.i275, align 8
  br label %list_Nconc.exit280

list_Nconc.exit280:                               ; preds = %if.end118, %if.end.i272, %for.end.i278
  %retval.0.i279 = phi ptr [ %call120, %for.end.i278 ], [ %NewClauses.0312, %if.end118 ], [ %call120, %if.end.i272 ]
  %Scan.0.val = load ptr, ptr %Scan.0307, align 8
  %cmp.i227.not = icmp eq ptr %Scan.0.val, null
  br i1 %cmp.i227.not, label %for.end124, label %for.body
...
for.body:                                         ; preds = %sort_TheoryIncrementMark.exit, %for.body
  ...
  br i1 %cmp.i124.not, label %for.cond5.preheader, label %for.body
...
for.body9:                                        ; preds = %for.cond5.preheader, %for.body9
  ...
  br i1 %cmp.i125.not, label %for.cond24.preheader, label %for.body9
...
for.inc43:                                        ; preds = %land.lhs.true, %land.lhs.true.i, %for.body28, %sort_LinkNoResidues.exit, %if.then
  ...
  br i1 %cmp.i127.not, label %for.end45, label %for.body28
...
while.cond.loopexit.i:                            ; preds = %for.inc41.i, %while.body.i
  ...
  %cmp.i.not.i145 = icmp eq ptr %Nodes.addr.1.lcssa.i, null
  br i1 %cmp.i.not.i145, label %sort_EvalSubsortNoResidues.exit, label %while.body.i
...
while.body.i:                                     ; preds = %while.body.i.preheader, %while.cond.loopexit.i
  ...
  br i1 %cmp.i72.not91.i, label %while.cond.loopexit.i, label %for.body.i143

for.body.i143:                                    ; preds = %while.body.i, %for.inc41.i
...
land.lhs.true.i.i:                                ; preds = %for.body.i143
...
land.lhs.true.i146:                               ; preds = %sort_LinkNoResidues.exit.i
  ...
  %cmp.i147 = icmp eq i32 %dec.i.i, 0
  br i1 %cmp.i147, label %if.then.i, label %for.inc41.i
...
if.then27.i:                                      ; preds = %for.body22.i
  ...
  br i1 %cmp.i.not.i80.i, label %for.inc.i, label %if.end.i.i148

if.end.i.i148:                                    ; preds = %if.then27.i
  %cmp.i18.not.i.i149 = icmp eq ptr %Clauses.088.i, null
  br i1 %cmp.i18.not.i.i149, label %for.inc.i, label %for.cond.i.i150

for.cond.i.i150:                                  ; preds = %if.end.i.i148, %for.cond.i.i150
  %List1.addr.0.i.i151 = phi ptr [ %List1.addr.0.val17.i.i152, %for.cond.i.i150 ], [ %call32.i, %if.end.i.i148 ]
  %List1.addr.0.val17.i.i152 = load ptr, ptr %List1.addr.0.i.i151, align 8
  %cmp.i20.not.i.i153 = icmp eq ptr %List1.addr.0.val17.i.i152, null
  br i1 %cmp.i20.not.i.i153, label %for.end.i.i154, label %for.cond.i.i150

for.end.i.i154:                                   ; preds = %for.cond.i.i150
  store ptr %Clauses.088.i, ptr %List1.addr.0.i.i151, align 8
  br label %for.inc.i

for.inc.i:                                        ; preds = %for.end.i.i154, %if.end.i.i148, %if.then27.i, %for.body22.i
  %Clauses.1.i = phi ptr [ %Clauses.088.i, %for.body22.i ], [ %call32.i, %for.end.i.i154 ], [ %Clauses.088.i, %if.then27.i ], [ %call32.i, %if.end.i.i148 ]
  %Help.0.i = load ptr, ptr %Help.089.i, align 8
  %cmp.i76.not.i = icmp eq ptr %Help.0.i, null
  br i1 %cmp.i76.not.i, label %for.end.i, label %for.body22.i
...
for.inc41.i:                                      ; preds = %for.end.i, %if.then.i, %land.lhs.true.i146, %sort_LinkNoResidues.exit.i, %land.lhs.true.i.i, %for.body.i143
  %Nodes.addr.2.i = phi ptr [ %Nodes.addr.192.i, %if.then.i ], [ %call.i83.i, %for.end.i ], [ %Nodes.addr.192.i, %land.lhs.true.i146 ], [ %Nodes.addr.192.i, %sort_LinkNoResidues.exit.i ], [ %Nodes.addr.192.i, %land.lhs.true.i.i ], [ %Nodes.addr.192.i, %for.body.i143 ]
  %Scan.0.i = load ptr, ptr %Scan.093.i, align 8
  %cmp.i72.not.i = icmp eq ptr %Scan.0.i, null
  br i1 %cmp.i72.not.i, label %while.cond.loopexit.i, label %for.body.i143
...
if.then58:                                        ; preds = %for.body54
  ...
  br i1 %cmp.i.not5.i, label %cleanup, label %while.body.i161

while.body.i161:                                  ; preds = %if.then58, %while.body.i161
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i161 ], [ %Clauses.0190, %if.then58 ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  %42 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i162 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %42, i64 0, i32 4
  %43 = load i32, ptr %total_size.i.i.i162, align 8
  %conv26.i.i.i163 = sext i32 %43 to i64
  %44 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i164 = add i64 %44, %conv26.i.i.i163
  ...
  %cmp.i.not.i165 = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i165, label %cleanup, label %while.body.i161
...
for.cond.i:                                       ; preds = %if.end.i, %for.cond.i
  ...
  %List1.addr.0.val17.i = load ptr, ptr %List1.addr.0.i, align 8
  %cmp.i20.not.i = icmp eq ptr %List1.addr.0.val17.i, null
  br i1 %cmp.i20.not.i, label %for.end.i169, label %for.cond.i
...
for.inc70:                                        ; preds = %for.end.i169, %if.end.i, %if.then62, %if.else
  ...
  br i1 %cmp.i157.not, label %for.end72, label %for.body54
...
cleanup:                                          ; preds = %while.body.i161, %if.then58, %for.end72
  %retval.0 = phi ptr [ %call.i170, %for.end72 ], [ null, %if.then58 ], [ null, %while.body.i161 ]
  ret ptr %retval.0
}
...
for.body:                                         ; preds = %sort_TheoryIncrementMark.exit, %for.body
  ...
  br i1 %cmp.i47.not, label %for.cond5.preheader, label %for.body
...
for.body9:                                        ; preds = %for.cond5.preheader, %for.body9
  ...
  br i1 %cmp.i48.not, label %for.end13, label %for.body9
...
while.cond.loopexit.i:                            ; preds = %for.inc.i, %while.body.i
  ...
  br i1 %cmp.i.not.i, label %sort_EvalSubsortSpecial.exit, label %while.body.i
...
while.body.i:                                     ; preds = %for.end13, %while.cond.loopexit.i
  ...
  br i1 %cmp.i23.not31.i, label %while.cond.loopexit.i, label %for.body.i50

for.body.i50:                                     ; preds = %while.body.i, %for.inc.i
  ...
  store i32 %dec.i.i, ptr %fire.i.i, align 4
  %cmp.i51 = icmp eq i32 %dec.i.i, 0
  br i1 %cmp.i51, label %if.then.i, label %for.inc.i
...
for.inc.i:                                        ; preds = %if.then11.i, %if.then.i, %for.body.i50
  %Nodes.addr.2.i = phi ptr [ %call.i.i, %if.then11.i ], [ %Nodes.addr.132.i, %if.then.i ], [ %Nodes.addr.132.i, %for.body.i50 ]
  %Scan.0.i = load ptr, ptr %Scan.033.i, align 8
  %cmp.i23.not.i = icmp eq ptr %Scan.0.i, null
  br i1 %cmp.i23.not.i, label %while.cond.loopexit.i, label %for.body.i50
...
for.inc23:                                        ; preds = %for.body19
  ...
  br i1 %cmp.i52.not, label %cleanup, label %for.body19
...
for.body:                                         ; preds = %sort_TheoryIncrementMark.exit, %for.body
  ...
  br i1 %cmp.i51.not, label %for.cond5.preheader, label %for.body
...
for.body9:                                        ; preds = %for.cond5.preheader, %for.body9
  ...
  br i1 %cmp.i52.not, label %for.end13, label %for.body9
...
while.body.i:                                     ; preds = %for.end13, %while.cond.loopexit.i
  ...
  %Scan.030.i = load ptr, ptr %12, align 8
  %cmp.i23.not31.i = icmp eq ptr %Scan.030.i, null
  br i1 %cmp.i23.not31.i, label %while.cond.loopexit.i, label %for.body.i54

for.body.i54:                                     ; preds = %while.body.i, %for.inc.i
  %Scan.033.i = phi ptr [ %Scan.0.i, %for.inc.i ], [ %Scan.030.i, %while.body.i ]
  %Nodes.addr.132.i = phi ptr [ %Nodes.addr.2.i, %for.inc.i ], [ %13, %while.body.i ]
  %19 = getelementptr i8, ptr %Scan.033.i, i64 8
  %Scan.0.val21.i = load ptr, ptr %19, align 8
  ...
  %dec.i.i = add nsw i32 %20, -1
  store i32 %dec.i.i, ptr %fire.i.i, align 4
  %cmp.i55 = icmp eq i32 %dec.i.i, 0
  br i1 %cmp.i55, label %if.then.i, label %for.inc.i
...
for.inc.i:                                        ; preds = %if.then11.i, %if.then.i, %for.body.i54
  %Nodes.addr.2.i = phi ptr [ %call.i.i, %if.then11.i ], [ %Nodes.addr.132.i, %if.then.i ], [ %Nodes.addr.132.i, %for.body.i54 ]
  %Scan.0.i = load ptr, ptr %Scan.033.i, align 8
  %cmp.i23.not.i = icmp eq ptr %Scan.0.i, null
  br i1 %cmp.i23.not.i, label %while.cond.loopexit.i, label %for.body.i54
...
for.inc23:                                        ; preds = %for.body19
  ...
  br i1 %cmp.i56.not, label %for.end25, label %for.body19
...
while.body.lr.ph.i61:                             ; preds = %for.end25
  br i1 %cmp.i56.not87, label %while.body.us.i.preheader, label %while.body.i62
...
for.inc.us.i:                                     ; preds = %if.then10.us.i, %for.body.us.i
  ...
  br i1 %cmp.i30.not.us.i, label %while.cond.loopexit.us.i, label %for.body.us.i
...
while.cond.loopexit.us.i:                         ; preds = %for.inc.us.i, %while.body.us.i
  ...
  br i1 %cmp.i.not.us.i, label %cleanup, label %while.body.us.i

while.cond.loopexit.i72:                          ; preds = %for.inc.i69, %if.end.loopexit.i
  %Nodes.addr.1.lcssa.i73 = phi ptr [ %36, %if.end.loopexit.i ], [ %Nodes.addr.2.i70, %for.inc.i69 ]
  %cmp.i.not.i74 = icmp eq ptr %Nodes.addr.1.lcssa.i73, null
  br i1 %cmp.i.not.i74, label %cleanup, label %while.body.i62

while.body.i62:                                   ; preds = %while.body.lr.ph.i61, %while.cond.loopexit.i72
  %Nodes.addr.012.i = phi ptr [ %Nodes.addr.1.lcssa.i73, %while.cond.loopexit.i72 ], [ %call.i60, %while.body.lr.ph.i61 ]
  %car.i.i63 = getelementptr inbounds %struct.LIST_HELP, ptr %Nodes.addr.012.i, i64 0, i32 1
  %35 = load ptr, ptr %car.i.i63, align 8
  ...
  %total_size.i.i.i.i64 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %37, i64 0, i32 4
  %38 = load i32, ptr %total_size.i.i.i.i64, align 8
  %conv26.i.i.i.i65 = sext i32 %38 to i64
  %39 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i66 = add i64 %39, %conv26.i.i.i.i65
  store i64 %add27.i.i.i.i66, ptr @memory_FREEDBYTES, align 8
...
while.body.i.i:                                   ; preds = %if.end.i.i, %while.body.i62
  %List.addr.07.i.i = phi ptr [ %List.addr.0.val.i.i, %if.end.i.i ], [ %Sort2, %while.body.i62 ]
  ...
  br i1 %cmp.i24.i, label %if.then.i77, label %if.end.i.i

if.end.i.i:                                       ; preds = %while.body.i.i
  %List.addr.0.val.i.i = load ptr, ptr %List.addr.07.i.i, align 8
  %cmp.i.not.i.i = icmp eq ptr %List.addr.0.val.i.i, null
  br i1 %cmp.i.not.i.i, label %if.end.loopexit.i, label %while.body.i.i

if.then.i77:                                      ; preds = %while.body.i.i
  %cmp.i.not5.i.i = icmp eq ptr %36, null
  br i1 %cmp.i.not5.i.i, label %cleanup, label %while.body.i25.i

while.body.i25.i:                                 ; preds = %if.then.i77, %while.body.i25.i
  %Current.06.i.i = phi ptr [ %Current.0.val.i.i, %while.body.i25.i ], [ %36, %if.then.i77 ]
  %Current.0.val.i.i = load ptr, ptr %Current.06.i.i, align 8
  %43 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i26.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %43, i64 0, i32 4
  %44 = load i32, ptr %total_size.i.i.i26.i, align 8
  %conv26.i.i.i27.i = sext i32 %44 to i64
  %45 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i28.i = add i64 %45, %conv26.i.i.i27.i
  store i64 %add27.i.i.i28.i, ptr @memory_FREEDBYTES, align 8
  ...
  br i1 %cmp.i.not.i29.i, label %cleanup, label %while.body.i25.i

if.end.loopexit.i:                                ; preds = %if.end.i.i
  %Scan.07.i = load ptr, ptr %35, align 8
  %cmp.i30.not8.i = icmp eq ptr %Scan.07.i, null
  br i1 %cmp.i30.not8.i, label %while.cond.loopexit.i72, label %for.body.i67

for.body.i67:                                     ; preds = %if.end.loopexit.i, %for.inc.i69
  %Scan.010.i = phi ptr [ %Scan.0.i71, %for.inc.i69 ], [ %Scan.07.i, %if.end.loopexit.i ]
  %Nodes.addr.19.i = phi ptr [ %Nodes.addr.2.i70, %for.inc.i69 ], [ %36, %if.end.loopexit.i ]
  ...
  %cmp.i68 = icmp eq i32 %call8.val23.i, 0
  br i1 %cmp.i68, label %if.then10.i, label %for.inc.i69

if.then10.i:                                      ; preds = %for.body.i67
  %50 = getelementptr i8, ptr %Scan.0.val22.i, i64 8
  %call8.val.i75 = load ptr, ptr %50, align 8
  %call.i.i76 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i32.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i76, i64 0, i32 1
  store ptr %call8.val.i75, ptr %car.i32.i, align 8
  store ptr %Nodes.addr.19.i, ptr %call.i.i76, align 8
  br label %for.inc.i69

for.inc.i69:                                      ; preds = %if.then10.i, %for.body.i67
  %Nodes.addr.2.i70 = phi ptr [ %call.i.i76, %if.then10.i ], [ %Nodes.addr.19.i, %for.body.i67 ]
  %Scan.0.i71 = load ptr, ptr %Scan.010.i, align 8
  %cmp.i30.not.i = icmp eq ptr %Scan.0.i71, null
  br i1 %cmp.i30.not.i, label %while.cond.loopexit.i72, label %for.body.i67

cleanup:                                          ; preds = %for.body19, %while.cond.loopexit.i72, %while.body.i25.i, %while.cond.loopexit.us.i, %for.end25.thread, %if.then.i77, %for.end25
  %retval.0 = phi i32 [ 1, %if.then.i77 ], [ 0, %for.end25 ], [ 0, %for.end25.thread ], [ 0, %while.cond.loopexit.us.i ], [ 1, %while.body.i25.i ], [ 0, %while.cond.loopexit.i72 ], [ 0, %for.body19 ]
  ret i32 %retval.0
}
...
for.body:                                         ; preds = %sort_TheoryIncrementMark.exit, %for.body
  ...
  br i1 %cmp.i211.not, label %for.cond6.preheader, label %for.body
...
for.body10:                                       ; preds = %for.cond6.preheader, %for.body10
  ...
  br i1 %cmp.i212.not, label %for.end22, label %for.body10
...
while.cond.loopexit.i:                            ; preds = %for.inc41.i, %while.body.i
  %Nodes.addr.1.lcssa.i = phi ptr [ %Nodes.addr.0.val.i, %while.body.i ], [ %Nodes.addr.2.i, %for.inc41.i ]
  %cmp.i.not.i = icmp eq ptr %Nodes.addr.1.lcssa.i, null
  br i1 %cmp.i.not.i, label %sort_EvalSubsort.exit, label %while.body.i
...
while.body.i:                                     ; preds = %for.end22, %while.cond.loopexit.i
  ...
  br i1 %cmp.i71.not84.i, label %while.cond.loopexit.i, label %for.body.i216

for.body.i216:                                    ; preds = %while.body.i, %for.inc41.i
  ...
  %dec.i.i = add nsw i32 %20, -1
  store i32 %dec.i.i, ptr %fire.i.i, align 4
  %cmp.i217 = icmp eq i32 %dec.i.i, 0
  br i1 %cmp.i217, label %if.then.i, label %for.inc41.i

if.then.i:                                        ; preds = %for.body.i216
...
for.inc.i:                                        ; preds = %if.then29.i, %for.body24.i
  ...
  br i1 %cmp.i75.not.i, label %for.end.i, label %for.body24.i
...
for.inc41.i:                                      ; preds = %for.end.i, %if.then.i, %for.body.i216
  %Nodes.addr.2.i = phi ptr [ %Nodes.addr.185.i, %if.then.i ], [ %call.i79.i, %for.end.i ], [ %Nodes.addr.185.i, %for.body.i216 ]
  %Scan.0.i = load ptr, ptr %Scan.086.i, align 8
  %cmp.i71.not.i = icmp eq ptr %Scan.0.i, null
  br i1 %cmp.i71.not.i, label %while.cond.loopexit.i, label %for.body.i216

sort_EvalSubsort.exit:                            ; preds = %while.cond.loopexit.i, %for.end22
  %cmp.i220.not277 = icmp eq ptr %Sort2, null
  br i1 %cmp.i220.not277, label %for.end35, label %for.body28.lr.ph
...
for.inc33:                                        ; preds = %for.body28
  ...
  br i1 %cmp.i220.not, label %for.end35, label %for.body28

for.end35:                                        ; preds = %for.inc33, %sort_EvalSubsort.exit
...
while.body:                                       ; preds = %for.end35, %if.end123
  %Visited.0296 = phi ptr [ null, %for.end35 ], [ %Visited.1, %if.end123 ]
  %Search.0295 = phi ptr [ %call.i.i230, %for.end35 ], [ %Search.5, %if.end123 ]
  %Result.0294 = phi ptr [ null, %for.end35 ], [ %Result.3, %if.end123 ]
  ...
  %cmp.i.not11.i = icmp eq ptr %Visited.0296, null
...
while.body.lr.ph.i235:                            ; preds = %while.body
  ...
  br i1 %cmp.i32.not38.i.i, label %while.body.us.i, label %while.body.i236

while.body.us.i:                                  ; preds = %while.body.lr.ph.i235, %if.end.us.i
  %List.addr.012.us.i = phi ptr [ %List.addr.0.val.us.i, %if.end.us.i ], [ %Visited.0296, %while.body.lr.ph.i235 ]
...
for.body.i.i.us.i:                                ; preds = %if.end.i.us.i, %for.body.i.i.us.i
  ...
  br i1 %exitcond.not.i.i.us.i.4, label %sort_TheoryIncrementMark.exit.i.us.i, label %for.body.i.i.us.i
...
for.body.i.us.i:                                  ; preds = %sort_TheoryIncrementMark.exit.i.us.i, %for.body.i.us.i
  ...
  br i1 %cmp.i30.not.i.us.i, label %if.end123, label %for.body.i.us.i
...
if.end.us.i:                                      ; preds = %while.body.us.i
  ...
  br i1 %cmp.i.not.us.i, label %if.then53, label %while.body.us.i

while.body.i236:                                  ; preds = %while.body.lr.ph.i235, %if.end.i
  %List.addr.012.i = phi ptr [ %List.addr.0.val.i, %if.end.i ], [ %Visited.0296, %while.body.lr.ph.i235 ]
  %48 = getelementptr i8, ptr %List.addr.012.i, i64 8
  %List.addr.0.val7.i = load ptr, ptr %48, align 8
  %call.i.i237 = tail call i32 @list_Length(ptr noundef %List.addr.0.val7.i) #12
  %call1.i.i = tail call i32 @list_Length(ptr noundef nonnull %call47.val201) #12
  %cmp.not.i.i = icmp eq i32 %call.i.i237, %call1.i.i
  br i1 %cmp.not.i.i, label %if.end.i.i, label %if.end.i

if.end.i.i:                                       ; preds = %while.body.i236
...
for.body.i.i.i:                                   ; preds = %if.end.i.i, %for.body.i.i.i
  ...
  br i1 %exitcond.not.i.i.i.4, label %sort_TheoryIncrementMark.exit.i.i, label %for.body.i.i.i
...
for.body.i.i:                                     ; preds = %sort_TheoryIncrementMark.exit.i.i, %for.body.i.i
  ...
  br i1 %cmp.i30.not.i.i, label %for.cond5.preheader.i.loopexit.i, label %for.body.i.i
...
for.inc15.i.i:                                    ; preds = %for.body9.i.i
  ...
  br i1 %cmp.i32.not.i.i, label %if.end123, label %for.body9.i.i

if.end.i:                                         ; preds = %for.body9.i.i, %while.body.i236
  %List.addr.0.val.i = load ptr, ptr %List.addr.012.i, align 8
  %cmp.i.not.i238 = icmp eq ptr %List.addr.0.val.i, null
  br i1 %cmp.i.not.i238, label %if.then53, label %while.body.i236
...
for.inc72:                                        ; preds = %if.else, %for.body63
  ...
  br i1 %cmp.i241.not, label %for.end74, label %land.rhs
...
for.cond83.loopexit:                              ; preds = %for.inc116, %for.body87
  ...
  br i1 %cmp.i247.not, label %if.end122, label %for.body87thread-pre-split
...
for.inc116:                                       ; preds = %for.body94, %land.lhs.true, %sort_Intersect.exit
  ...
  br i1 %cmp.i249.not, label %for.cond83.loopexit, label %for.body94
...
if.end123:                                        ; preds = %for.body.i.us.i, %for.inc15.i.i, %sort_TheoryIncrementMark.exit.i.us.i, %if.end122
  ...
  br i1 %cmp.i232.not, label %while.end, label %while.body
...
for.cond.i.i.i.i:                                 ; preds = %if.then11.i.i, %for.cond.i.i.i.i
  ...
  br i1 %cmp.i20.not.i.i.i.i, label %for.end.i.i.i.i, label %for.cond.i.i.i.i
...
for.inc.i.i:                                      ; preds = %for.end.i.i.i.i, %if.then11.i.i, %land.lhs.true.i.i, %clause_LiteralAtom.exit.i.i, %for.body.i.i
  ...
  br i1 %cmp.not.not.i.i, label %for.body.i.i, label %sort_ComputeSortInternNoResidues.exit
...
if.else.i:                                        ; preds = %if.then
  ...
  %cmp.i.not102.i = icmp eq ptr %call7.i, null
  br i1 %cmp.i.not102.i, label %sort_ComputeSortInternNoResidues.exit, label %for.body.i

for.body.i:                                       ; preds = %if.else.i, %if.end31.i
  %Sort.0105.i = phi ptr [ %Sort.1.i, %if.end31.i ], [ null, %if.else.i ]
  %Scan.0104.i = phi ptr [ %Scan.0.val.i, %if.end31.i ], [ %call7.i, %if.else.i ]
  %Clauses.0103.i = phi ptr [ %Clauses.2.i, %if.end31.i ], [ null, %if.else.i ]
  %22 = getelementptr i8, ptr %Scan.0104.i, i64 8
...
while.body.i.i.i:                                 ; preds = %while.body.i.i.i.prol.loopexit, %while.body.i.i.i
  ...
  %cmp.i.i69.i.1 = icmp ugt i32 %dec.i.i.i.i.i, 1
  br i1 %cmp.i.i69.i.1, label %while.body.i.i.i, label %while.end.i.i.i
...
while.end.i.i.i:                                  ; preds = %while.body.i.i.i.prol.loopexit, %while.body.i.i.i, %land.lhs.true.i
  ...
  %cmp.i.not.i.i60.i = icmp eq i32 %45, 0
  br i1 %cmp.i.not.i.i60.i, label %cont_BackTrack.exit.i.i, label %if.then.i.i61.i

if.then.i.i61.i:                                  ; preds = %while.end.i.i.i
...
cont_BackTrack.exit.i.i:                          ; preds = %if.then.i.i61.i, %while.end.i.i.i
  %cmp.i49.not108.i.i = icmp eq ptr %call4.i.i, null
  br i1 %cmp.i49.not108.i.i, label %for.end.thread.i.i, label %for.body.lr.ph.i62.i

for.end.thread.i.i:                               ; preds = %cont_BackTrack.exit.i.i
  tail call void @subst_Free(ptr noundef null) #12
  br label %land.lhs.true24.i

for.body.lr.ph.i62.i:                             ; preds = %cont_BackTrack.exit.i.i
  %47 = getelementptr i8, ptr %call18.val.i, i64 56
  %48 = zext i32 %add3.i.i.i to i64
  br label %for.body.i63.i

for.body.i63.i:                                   ; preds = %sort_DeleteOne.exit91.i.i, %for.body.lr.ph.i62.i
  %scan.0110.i.i = phi ptr [ %call4.i.i, %for.body.lr.ph.i62.i ], [ %scan.0.val46.i.i, %sort_DeleteOne.exit91.i.i ]
  %NewClauses.0109.i.i = phi ptr [ null, %for.body.lr.ph.i62.i ], [ %retval.0.i67.i.i, %sort_DeleteOne.exit91.i.i ]
...
for.body.i.i.i:                                   ; preds = %for.body.i63.i, %for.inc.i.i.i
  %indvars.iv.i.i.i = phi i64 [ %indvars.iv.next.i.i.i, %for.inc.i.i.i ], [ 0, %for.body.i63.i ]
  %Result.036.i.i.i = phi ptr [ %Result.1.i.i.i, %for.inc.i.i.i ], [ null, %for.body.i63.i ]
  %cmp3.not.i.i.i = icmp eq i64 %indvars.iv.i.i.i, %48
  br i1 %cmp3.not.i.i.i, label %for.inc.i.i.i, label %if.then.i50.i.i

if.then.i50.i.i:                                  ; preds = %for.body.i.i.i
  %Clause.val.i51.i.i = load ptr, ptr %47, align 8
  %arrayidx.i.i52.i.i = getelementptr inbounds ptr, ptr %Clause.val.i51.i.i, i64 %indvars.iv.i.i.i
  %50 = load ptr, ptr %arrayidx.i.i52.i.i, align 8
  ...
  %cmp.i.not.i.i.i64.i = icmp eq i32 %52, %L.val7.val.i.i.i.i
  br i1 %cmp.i.not.i.i.i64.i, label %if.then.i.i.i.i, label %clause_LiteralAtom.exit.i.i.i

if.then.i.i.i.i:                                  ; preds = %if.then.i50.i.i
...
clause_LiteralAtom.exit.i.i.i:                    ; preds = %if.then.i.i.i.i, %if.then.i50.i.i
  %call5.val25.i.i.i = phi i32 [ %call5.val25.pre.i.i.i, %if.then.i.i.i.i ], [ %L.val7.val.i.i.i.i, %if.then.i50.i.i ]
  %retval.0.i.i.i.i = phi ptr [ %call1.val.val.i.i.i.i, %if.then.i.i.i.i ], [ %call4.val.i.i.i, %if.then.i50.i.i ]
...
if.then11.i.i.i:                                  ; preds = %land.lhs.true.i.i.i
  %arrayidx.i.i.i.i68.i = getelementptr inbounds %struct.SORTTHEORY_HELP, ptr %Theory, i64 0, i32 1, i64 %idxprom.i.i.i.i.i.i
  %60 = load ptr, ptr %arrayidx.i.i.i.i68.i, align 8
...
for.cond.i.i.i.i.i:                               ; preds = %if.then11.i.i.i, %for.cond.i.i.i.i.i
  ...
  br i1 %cmp.i20.not.i.i.i.i.i, label %for.end.i.i.i.i.i, label %for.cond.i.i.i.i.i
...
for.inc.i.i.i:                                    ; preds = %for.end.i.i.i.i.i, %if.then11.i.i.i, %land.lhs.true.i.i.i, %clause_LiteralAtom.exit.i.i.i, %for.body.i.i.i
  ...
  br i1 %cmp.not.not.i.i.i, label %for.body.i.i.i, label %sort_VarSort.exit.i.i

sort_VarSort.exit.i.i:                            ; preds = %for.inc.i.i.i, %for.body.i63.i
  %Result.0.lcssa.i.i.i = phi ptr [ null, %for.body.i63.i ], [ %Result.1.i.i.i, %for.inc.i.i.i ]
  ...
  %cmp.i65.i = icmp eq ptr %call12.i.i, null
  br i1 %cmp.i65.i, label %if.then.i67.i, label %if.else.i.i

if.then.i67.i:                                    ; preds = %sort_VarSort.exit.i.i
...
while.body.i.i.i.i:                               ; preds = %if.then.i67.i, %while.body.i.i.i.i
  %Current.06.i.i.i.i = phi ptr [ %Current.0.val.i.i.i.i, %while.body.i.i.i.i ], [ %Result.0.lcssa.i.i.i, %if.then.i67.i ]
  ...
  br i1 %cmp.i.not.i.i54.i.i, label %sort_DeleteOne.exit.i.i, label %while.body.i.i.i.i

sort_DeleteOne.exit.i.i:                          ; preds = %while.body.i.i.i.i, %if.then.i67.i
  %cmp.i.not5.i.i.i = icmp eq ptr %NewClauses.0109.i.i, null
  br i1 %cmp.i.not5.i.i.i, label %sort_MatchNoResidues.exit.i, label %while.body.i55.i.i

while.body.i55.i.i:                               ; preds = %sort_DeleteOne.exit.i.i, %while.body.i55.i.i
  %Current.06.i.i.i = phi ptr [ %Current.0.val.i.i.i, %while.body.i55.i.i ], [ %NewClauses.0109.i.i, %sort_DeleteOne.exit.i.i ]
  ...
  %cmp.i.not.i56.i.i = icmp eq ptr %Current.0.val.i.i.i, null
  br i1 %cmp.i.not.i56.i.i, label %sort_MatchNoResidues.exit.i, label %while.body.i55.i.i
...
list_Nconc.exit.i.i:                              ; preds = %for.end.i.i.i, %if.else.i.i
  %retval.0.i.i66.i = phi ptr [ %NewClauses.0109.i.i, %for.end.i.i.i ], [ %call15.i.i, %if.else.i.i ]
  %76 = getelementptr i8, ptr %call12.i.i, i64 32
  %call12.val.i.i = load ptr, ptr %76, align 8
  %cmp.i.not.i59.i.i = icmp eq ptr %retval.0.i.i66.i, null
  br i1 %cmp.i.not.i59.i.i, label %if.then.i69.i.i, label %if.end.i60.i.i

if.end.i60.i.i:                                   ; preds = %list_Nconc.exit.i.i, %list_Nconc.exit.thread.i.i
  ...
  %retval.0.i105.i.i = phi ptr [ %NewClauses.0109.i.i, %list_Nconc.exit.thread.i.i ], [ %retval.0.i.i66.i, %list_Nconc.exit.i.i ]
  %cmp.i18.not.i61.i.i = icmp eq ptr %call12.val106.i.i, null
  br i1 %cmp.i18.not.i61.i.i, label %if.then.i69.i.i, label %for.cond.i62.i.i

for.cond.i62.i.i:                                 ; preds = %if.end.i60.i.i, %for.cond.i62.i.i
  %List1.addr.0.i63.i.i = phi ptr [ %List1.addr.0.val17.i64.i.i, %for.cond.i62.i.i ], [ %retval.0.i105.i.i, %if.end.i60.i.i ]
  %List1.addr.0.val17.i64.i.i = load ptr, ptr %List1.addr.0.i63.i.i, align 8
  %cmp.i20.not.i65.i.i = icmp eq ptr %List1.addr.0.val17.i64.i.i, null
  br i1 %cmp.i20.not.i65.i.i, label %for.end.i66.i.i, label %for.cond.i62.i.i

for.end.i66.i.i:                                  ; preds = %for.cond.i62.i.i
  store ptr %call12.val106.i.i, ptr %List1.addr.0.i63.i.i, align 8
  br label %if.then.i69.i.i

if.then.i69.i.i:                                  ; preds = %for.end.i66.i.i, %if.end.i60.i.i, %list_Nconc.exit.i.i
  %78 = phi ptr [ %77, %for.end.i66.i.i ], [ %76, %list_Nconc.exit.i.i ], [ %77, %if.end.i60.i.i ]
  %retval.0.i67.i.i = phi ptr [ %retval.0.i105.i.i, %for.end.i66.i.i ], [ %call12.val.i.i, %list_Nconc.exit.i.i ], [ %retval.0.i105.i.i, %if.end.i60.i.i ]
  ...
  %cmp.i.not5.i.i70.i.i = icmp eq ptr %C.val11.i.i.i, null
  br i1 %cmp.i.not5.i.i70.i.i, label %sort_ConditionDelete.exit.i.i, label %while.body.i.i71.i.i

while.body.i.i71.i.i:                             ; preds = %if.then.i69.i.i, %while.body.i.i71.i.i
  %Current.06.i.i72.i.i = phi ptr [ %Current.0.val.i.i73.i.i, %while.body.i.i71.i.i ], [ %C.val11.i.i.i, %if.then.i69.i.i ]
  %Current.0.val.i.i73.i.i = load ptr, ptr %Current.06.i.i72.i.i, align 8
  %82 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i74.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %82, i64 0, i32 4
  %83 = load i32, ptr %total_size.i.i.i.i74.i.i, align 8
  %conv26.i.i.i.i75.i.i = sext i32 %83 to i64
  %84 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i76.i.i = add i64 %84, %conv26.i.i.i.i75.i.i
  store i64 %add27.i.i.i.i76.i.i, ptr @memory_FREEDBYTES, align 8
  %85 = load ptr, ptr %82, align 8
  store ptr %85, ptr %Current.06.i.i72.i.i, align 8
  %86 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i72.i.i, ptr %86, align 8
  %cmp.i.not.i.i77.i.i = icmp eq ptr %Current.0.val.i.i73.i.i, null
  br i1 %cmp.i.not.i.i77.i.i, label %sort_ConditionDelete.exit.i.i, label %while.body.i.i71.i.i

sort_ConditionDelete.exit.i.i:                    ; preds = %while.body.i.i71.i.i, %if.then.i69.i.i
  ...
  br i1 %cmp.i.not5.i.i82.i.i, label %sort_DeleteOne.exit91.i.i, label %while.body.i.i83.i.i

while.body.i.i83.i.i:                             ; preds = %sort_ConditionDelete.exit.i.i, %while.body.i.i83.i.i
  %Current.06.i.i84.i.i = phi ptr [ %Current.0.val.i.i85.i.i, %while.body.i.i83.i.i ], [ %Result.0.lcssa.i.i.i, %sort_ConditionDelete.exit.i.i ]
  %Current.0.val.i.i85.i.i = load ptr, ptr %Current.06.i.i84.i.i, align 8
  %92 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i86.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %92, i64 0, i32 4
  %93 = load i32, ptr %total_size.i.i.i.i86.i.i, align 8
  %conv26.i.i.i.i87.i.i = sext i32 %93 to i64
  %94 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i88.i.i = add i64 %94, %conv26.i.i.i.i87.i.i
  store i64 %add27.i.i.i.i88.i.i, ptr @memory_FREEDBYTES, align 8
  %95 = load ptr, ptr %92, align 8
  store ptr %95, ptr %Current.06.i.i84.i.i, align 8
  %96 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i84.i.i, ptr %96, align 8
  %cmp.i.not.i.i89.i.i = icmp eq ptr %Current.0.val.i.i85.i.i, null
  br i1 %cmp.i.not.i.i89.i.i, label %sort_DeleteOne.exit91.i.i, label %while.body.i.i83.i.i

sort_DeleteOne.exit91.i.i:                        ; preds = %while.body.i.i83.i.i, %sort_ConditionDelete.exit.i.i
  %scan.0.val46.i.i = load ptr, ptr %scan.0110.i.i, align 8
  %cmp.i49.not.i.i = icmp eq ptr %scan.0.val46.i.i, null
  br i1 %cmp.i49.not.i.i, label %for.end.i.i, label %for.body.i63.i
...
for.end.i.i:                                      ; preds = %sort_DeleteOne.exit91.i.i
  ...
  br i1 %cmp.i.not.i92.i.i, label %land.lhs.true24.i, label %if.end.i93.i.i

if.end.i93.i.i:                                   ; preds = %for.end.i.i
  %cmp.i18.not.i94.i.i = icmp eq ptr %Clauses.0103.i, null
  br i1 %cmp.i18.not.i94.i.i, label %land.lhs.true24.i, label %for.cond.i95.i.i

for.cond.i95.i.i:                                 ; preds = %if.end.i93.i.i, %for.cond.i95.i.i
  %List1.addr.0.i96.i.i = phi ptr [ %List1.addr.0.val17.i97.i.i, %for.cond.i95.i.i ], [ %retval.0.i67.i.i, %if.end.i93.i.i ]
  %List1.addr.0.val17.i97.i.i = load ptr, ptr %List1.addr.0.i96.i.i, align 8
  %cmp.i20.not.i98.i.i = icmp eq ptr %List1.addr.0.val17.i97.i.i, null
  br i1 %cmp.i20.not.i98.i.i, label %for.end.i99.i.i, label %for.cond.i95.i.i

for.end.i99.i.i:                                  ; preds = %for.cond.i95.i.i
  store ptr %Clauses.0103.i, ptr %List1.addr.0.i96.i.i, align 8
  br label %land.lhs.true24.i

sort_MatchNoResidues.exit.i:                      ; preds = %while.body.i55.i.i, %sort_DeleteOne.exit.i.i
  tail call void @subst_Free(ptr noundef nonnull %call4.i.i) #12
  br label %if.end31.i

land.lhs.true24.i:                                ; preds = %for.end.i99.i.i, %if.end.i93.i.i, %for.end.i.i, %for.end.thread.i.i
  %Clauses.1.ph.i = phi ptr [ %Clauses.0103.i, %for.end.thread.i.i ], [ %retval.0.i67.i.i, %if.end.i93.i.i ], [ %Clauses.0103.i, %for.end.i.i ], [ %retval.0.i67.i.i, %for.end.i99.i.i ]
  %cmp.i.not11.i.i = icmp eq ptr %Sort.0105.i, null
  br i1 %cmp.i.not11.i.i, label %if.then27.i, label %for.body.i70.i

for.body.i70.i:                                   ; preds = %land.lhs.true24.i, %for.inc.i71.i
  %Sort.addr.012.i.i = phi ptr [ %Sort.addr.0.val.i.i, %for.inc.i71.i ], [ %Sort.0105.i, %land.lhs.true24.i ]
  ...
  br i1 %cmp.i9.not.i.i, label %if.end31.i, label %for.inc.i71.i

for.inc.i71.i:                                    ; preds = %for.body.i70.i
  %Sort.addr.0.val.i.i = load ptr, ptr %Sort.addr.012.i.i, align 8
  %cmp.i.not.i72.i = icmp eq ptr %Sort.addr.0.val.i.i, null
  br i1 %cmp.i.not.i72.i, label %if.then27.i, label %for.body.i70.i

if.then27.i:                                      ; preds = %for.inc.i71.i, %land.lhs.true24.i
  ...
  br i1 %cmp.i.not11.i.i, label %sort_Intersect.exit.i, label %for.cond.i.i79.i

for.cond.i.i79.i:                                 ; preds = %if.then27.i, %for.cond.i.i79.i
  %List1.addr.0.i.i80.i = phi ptr [ %List1.addr.0.val17.i.i81.i, %for.cond.i.i79.i ], [ %Sort.0105.i, %if.then27.i ]
  %List1.addr.0.val17.i.i81.i = load ptr, ptr %List1.addr.0.i.i80.i, align 8
  %cmp.i20.not.i.i82.i = icmp eq ptr %List1.addr.0.val17.i.i81.i, null
  br i1 %cmp.i20.not.i.i82.i, label %for.end.i.i83.i, label %for.cond.i.i79.i

for.end.i.i83.i:                                  ; preds = %for.cond.i.i79.i
  store ptr %call.i.i.i.i, ptr %List1.addr.0.i.i80.i, align 8
  br label %sort_Intersect.exit.i

sort_Intersect.exit.i:                            ; preds = %for.end.i.i83.i, %if.then27.i
  %retval.0.i.i85.i = phi ptr [ %Sort.0105.i, %for.end.i.i83.i ], [ %call.i.i.i.i, %if.then27.i ]
  %call.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i, i64 0, i32 1
...
if.end31.i:                                       ; preds = %for.body.i70.i, %sort_Intersect.exit.i, %sort_MatchNoResidues.exit.i, %if.then13.i, %for.body.i
  %Clauses.2.i = phi ptr [ %Clauses.0103.i, %if.then13.i ], [ %Clauses.0103.i, %sort_MatchNoResidues.exit.i ], [ %call.i.i, %sort_Intersect.exit.i ], [ %Clauses.0103.i, %for.body.i ], [ %Clauses.1.ph.i, %for.body.i70.i ]
  %Sort.1.i = phi ptr [ %Sort.0105.i, %if.then13.i ], [ %Sort.0105.i, %sort_MatchNoResidues.exit.i ], [ %retval.0.i.i85.i, %sort_Intersect.exit.i ], [ %Sort.0105.i, %for.body.i ], [ %Sort.0105.i, %for.body.i70.i ]
  %Scan.0.val.i = load ptr, ptr %Scan.0104.i, align 8
  %cmp.i.not.i = icmp eq ptr %Scan.0.val.i, null
  br i1 %cmp.i.not.i, label %while.body.i.i, label %for.body.i
...
while.body.i.i:                                   ; preds = %if.end31.i, %while.body.i.i
  ...
  br i1 %cmp.i.not.i86.i, label %sort_ComputeSortInternNoResidues.exit, label %while.body.i.i
...
sort_ComputeSortInternNoResidues.exit:            ; preds = %for.inc.i.i, %while.body.i.i, %if.then.i, %if.else.i
  ...
  %clauses.i.i.i = getelementptr inbounds %struct.CONDITION_HELP, ptr %call.i87.i, i64 0, i32 4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %constraint.i.i.i, i8 0, i64 24, i1 false)
  store ptr %Clauses.3.i, ptr %clauses.i.i.i, align 8
  %call.i.i.i88.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i.i89.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i.i88.i, i64 0, i32 1
  store ptr %Sort.2.i, ptr %car.i.i.i89.i, align 8
  store ptr %call.i87.i, ptr %call.i.i.i88.i, align 8
  ...
  store ptr %call.i.i.i88.i, ptr %call.i.i.i, align 8
...
if.end:                                           ; preds = %sort_ComputeSortInternNoResidues.exit, %while.body
  %SortPair.1 = phi ptr [ %call3, %while.body ], [ %call.i.i.i88.i, %sort_ComputeSortInternNoResidues.exit ]
...
if.end32:                                         ; preds = %if.then, %if.then28, %for.end
  ...
  br i1 %cmp.i.not5.i, label %while.body.i91.preheader, label %while.body.i
...
while.body.i:                                     ; preds = %if.end32, %while.body.i
  ...
  br i1 %cmp.i.not.i89, label %while.body.i91.preheader, label %while.body.i

while.body.i91.preheader:                         ; preds = %while.body.i, %if.end32
  br label %while.body.i91

while.body.i91:                                   ; preds = %while.body.i91.preheader, %while.body.i91
  %Current.06.i92 = phi ptr [ %Current.0.val.i93, %while.body.i91 ], [ %call.i.i, %while.body.i91.preheader ]
  %Current.0.val.i93 = load ptr, ptr %Current.06.i92, align 8
  %27 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i94 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %27, i64 0, i32 4
  %28 = load i32, ptr %total_size.i.i.i94, align 8
  %conv26.i.i.i95 = sext i32 %28 to i64
  %29 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i96 = add i64 %29, %conv26.i.i.i95
  store i64 %add27.i.i.i96, ptr @memory_FREEDBYTES, align 8
  %30 = load ptr, ptr %27, align 8
  store ptr %30, ptr %Current.06.i92, align 8
  %31 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i92, ptr %31, align 8
  %cmp.i.not.i97 = icmp eq ptr %Current.0.val.i93, null
  br i1 %cmp.i.not.i97, label %list_Delete.exit98, label %while.body.i91

list_Delete.exit98:                               ; preds = %while.body.i91
...
for.body.us:                                      ; preds = %for.body.lr.ph, %for.body.us
  ...
  %cmp.i.not.us = icmp eq ptr %Scan1.0.val.us, null
  br i1 %cmp.i.not.us, label %for.end27, label %for.body.us
...
for.inc:                                          ; preds = %for.body12, %if.then
  ...
  br i1 %cmp.i44.not, label %for.cond8.for.inc25_crit_edge, label %for.body12
...
if.end.i.us:                                      ; preds = %while.body.i.us
  ...
  br i1 %cmp.i.not.i.us, label %land.lhs.true12.us, label %while.body.i.us
...
for.inc.us:                                       ; preds = %while.body.i.us, %land.lhs.true12.us, %for.body6.us
  ...
  br i1 %cmp.i46.us.not, label %for.cond2.for.inc22_crit_edge.us, label %for.body6.us
...
for.cond2.for.inc22_crit_edge.us:                 ; preds = %for.inc.us, %for.inc.us.thread
  ...
  br i1 %cmp.i.not.us, label %for.end24, label %for.cond2.preheader.us
...
for.inc.i:                                        ; preds = %if.then5.i, %land.lhs.true.i, %symbol_IsPredicate.exit.i, %if.then.i, %for.body.i
  ...
  br i1 %cmp.i, label %for.body.i, label %sort_TheoryCreate.exit
...
for.inc.i.i:                                      ; preds = %clause_LiteralAtom.exit.i.i, %for.body20.i.i
  ...
  br i1 %exitcond.not.i.i, label %for.end.i.i, label %for.body20.i.i
...
if.end35.i.i:                                     ; preds = %if.then31.i.i, %for.end.i.i, %if.then11.i.i
  ...
  %conv.i11.i = sext i32 %Clause.val.i.i to i64
  %29 = inttoptr i64 %conv.i11.i to ptr
  ...
  br i1 %cmp.i.not5.i.i.i, label %while.body.i99.i.i.preheader, label %while.body.i.i.i
...
while.body.i.i.i:                                 ; preds = %if.end35.i.i, %while.body.i.i.i
  ...
  br i1 %cmp.i.not.i97.i.i, label %while.body.i99.i.i.preheader, label %while.body.i.i.i

while.body.i99.i.i.preheader:                     ; preds = %while.body.i.i.i, %if.end35.i.i
  br label %while.body.i99.i.i

while.body.i99.i.i:                               ; preds = %while.body.i99.i.i.preheader, %while.body.i99.i.i
  %Current.06.i100.i.i = phi ptr [ %Current.0.val.i101.i.i, %while.body.i99.i.i ], [ %call.i.i.i.i, %while.body.i99.i.i.preheader ]
  %Current.0.val.i101.i.i = load ptr, ptr %Current.06.i100.i.i, align 8
  %37 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i102.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %37, i64 0, i32 4
  %38 = load i32, ptr %total_size.i.i.i102.i.i, align 8
  %conv26.i.i.i103.i.i = sext i32 %38 to i64
  %39 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i104.i.i = add i64 %39, %conv26.i.i.i103.i.i
  store i64 %add27.i.i.i104.i.i, ptr @memory_FREEDBYTES, align 8
  %40 = load ptr, ptr %37, align 8
  store ptr %40, ptr %Current.06.i100.i.i, align 8
  %41 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i100.i.i, ptr %41, align 8
  %cmp.i.not.i105.i.i = icmp eq ptr %Current.0.val.i101.i.i, null
  br i1 %cmp.i.not.i105.i.i, label %list_Delete.exit106.i.i, label %while.body.i99.i.i

list_Delete.exit106.i.i:                          ; preds = %while.body.i99.i.i
...
for.inc42.i.i:                                    ; preds = %list_Delete.exit106.i.i, %for.body.i.i
  ...
  %cmp.i10.i = icmp slt i64 %indvars.iv.next118.i.i, %16
  br i1 %cmp.i10.i, label %for.body.i.i, label %sort_ApproxHornClauses.exit.i
...
for.cond.i.i:                                     ; preds = %if.end.i.i, %for.cond.i.i
  ...
  %List1.addr.0.val17.i.i = load ptr, ptr %List1.addr.0.i.i, align 8
  %cmp.i20.not.i.i = icmp eq ptr %List1.addr.0.val17.i.i, null
  br i1 %cmp.i20.not.i.i, label %for.end.i13.i, label %for.cond.i.i
...
list_Nconc.exit.i:                                ; preds = %for.end.i13.i, %if.end.i.i, %sort_ApproxHornClauses.exit.i, %if.then.i.i, %land.lhs.true.i.i, %while.body.i
  ...
  br i1 %cmp.i.not.i38, label %sort_ApproxClauses.exit, label %while.body.i
...
for.end:                                          ; preds = %for.body
  br i1 %cmp.i39.not69, label %while.end19.thread.i, label %while.body.i41
...
while.body.i41:                                   ; preds = %for.end, %for.end.i
  %Clauses.addr.087.i = phi ptr [ %Clauses.addr.0.val.i43, %for.end.i ], [ %call2, %for.end ]
  ...
  %Clause.val.i.i42 = load i32, ptr %50, align 8
  %51 = getelementptr i8, ptr %Clauses.addr.0.val62.i, i64 68
  %Clause.val6.i.i = load i32, ptr %51, align 4
  %add.i.i = add nsw i32 %Clause.val6.i.i, %Clause.val.i.i42
  ...
  %Clauses.addr.0.val.i43 = load ptr, ptr %Clauses.addr.087.i, align 8
  %cmp82.i = icmp sgt i32 %add3.i.i, 0
  br i1 %cmp82.i, label %for.body.lr.ph.i58, label %for.end.i

for.body.lr.ph.i58:                               ; preds = %while.body.i41
  %53 = getelementptr i8, ptr %Clauses.addr.0.val62.i, i64 56
  %wide.trip.count.i = zext i32 %add3.i.i to i64
  br label %for.body.i59

for.body.i59:                                     ; preds = %clause_LiteralAtom.exit.i, %for.body.lr.ph.i58
  %indvars.iv.i60 = phi i64 [ 0, %for.body.lr.ph.i58 ], [ %indvars.iv.next.i65, %clause_LiteralAtom.exit.i ]
  %Sorts.183.i = phi ptr [ %Sorts.086.i, %for.body.lr.ph.i58 ], [ %call.i.i64, %clause_LiteralAtom.exit.i ]
  %call2.val.i = load ptr, ptr %53, align 8
  %arrayidx.i.i61 = getelementptr inbounds ptr, ptr %call2.val.i, i64 %indvars.iv.i60
  %54 = load ptr, ptr %arrayidx.i.i61, align 8
  %55 = getelementptr i8, ptr %54, i64 24
  %call6.val.i = load ptr, ptr %55, align 8
  %L.val7.val.i.i = load i32, ptr %call6.val.i, align 8
  %56 = load i32, ptr @fol_NOT, align 4
  %cmp.i.not.i.i62 = icmp eq i32 %56, %L.val7.val.i.i
  br i1 %cmp.i.not.i.i62, label %if.then.i.i66, label %clause_LiteralAtom.exit.i

if.then.i.i66:                                    ; preds = %for.body.i59
...
clause_LiteralAtom.exit.i:                        ; preds = %if.then.i.i66, %for.body.i59
  %call7.val.i = phi i32 [ %call7.val.pre.i, %if.then.i.i66 ], [ %L.val7.val.i.i, %for.body.i59 ]
  %conv.i63 = sext i32 %call7.val.i to i64
  %59 = inttoptr i64 %conv.i63 to ptr
  %call.i.i64 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i64, i64 0, i32 1
  store ptr %59, ptr %car.i.i, align 8
  store ptr %Sorts.183.i, ptr %call.i.i64, align 8
  %indvars.iv.next.i65 = add nuw nsw i64 %indvars.iv.i60, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i65, %wide.trip.count.i
  br i1 %exitcond.not.i, label %for.end.i, label %for.body.i59

for.end.i:                                        ; preds = %clause_LiteralAtom.exit.i, %while.body.i41
  %Sorts.1.lcssa.i = phi ptr [ %Sorts.086.i, %while.body.i41 ], [ %call.i.i64, %clause_LiteralAtom.exit.i ]
  %call10.i = tail call ptr @list_PointerDeleteDuplicates(ptr noundef %Sorts.1.lcssa.i) #12
  %cmp.i.not.i44 = icmp eq ptr %Clauses.addr.0.val.i43, null
  br i1 %cmp.i.not.i44, label %while.cond11.preheader.i, label %while.body.i41
...
while.body15.i:                                   ; preds = %while.body15.i, %while.body15.lr.ph.i
  ...
  %sub.i.i.i.i45 = sub nsw i32 0, %62
  %shr.i.i.i.i46 = ashr i32 %sub.i.i.i.i45, %48
  %idxprom.i.i.i = sext i32 %shr.i.i.i.i46 to i64
  %arrayidx.i.i.i47 = getelementptr inbounds %struct.SORTTHEORY_HELP, ptr %call.i, i64 0, i32 1, i64 %idxprom.i.i.i
  %63 = load ptr, ptr %arrayidx.i.i.i47, align 8
  %call.i.i.i.i48 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i.i.i49 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i.i.i48, i64 0, i32 1
  store ptr %63, ptr %car.i.i.i.i49, align 8
  store ptr null, ptr %call.i.i.i.i48, align 8
  store ptr %call.i.i.i.i48, ptr %60, align 8
  %Clauses.addr.1.val.i = load ptr, ptr %Clauses.addr.190.i, align 8
  %cmp.i63.not.i = icmp eq ptr %Clauses.addr.1.val.i, null
  br i1 %cmp.i63.not.i, label %while.end19.i, label %while.body15.i
...
if.then.i68.i:                                    ; preds = %while.body25.i
  ...
  %cmp.i.not5.i.i.i50 = icmp eq ptr %C.val11.i.i, null
  br i1 %cmp.i.not5.i.i.i50, label %sort_ConditionDelete.exit.i, label %while.body.i.i.i51

while.body.i.i.i51:                               ; preds = %if.then.i68.i, %while.body.i.i.i51
  %Current.06.i.i.i52 = phi ptr [ %Current.0.val.i.i.i53, %while.body.i.i.i51 ], [ %C.val11.i.i, %if.then.i68.i ]
  %Current.0.val.i.i.i53 = load ptr, ptr %Current.06.i.i.i52, align 8
  %69 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i.i54 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %69, i64 0, i32 4
  %70 = load i32, ptr %total_size.i.i.i.i.i54, align 8
  %conv26.i.i.i.i.i55 = sext i32 %70 to i64
  %71 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i.i56 = add i64 %71, %conv26.i.i.i.i.i55
  store i64 %add27.i.i.i.i.i56, ptr @memory_FREEDBYTES, align 8
  %72 = load ptr, ptr %69, align 8
  store ptr %72, ptr %Current.06.i.i.i52, align 8
  %73 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i.i52, ptr %73, align 8
  %cmp.i.not.i.i.i57 = icmp eq ptr %Current.0.val.i.i.i53, null
  br i1 %cmp.i.not.i.i.i57, label %sort_ConditionDelete.exit.i, label %while.body.i.i.i51

sort_ConditionDelete.exit.i:                      ; preds = %while.body.i.i.i51, %if.then.i68.i
...
if.end.i:                                         ; preds = %sort_ConditionDelete.exit.i, %while.body25.i
  ...
  br i1 %cmp.i.not5.i.i69.i, label %sort_DeleteOne.exit.i, label %while.body.i.i70.i

while.body.i.i70.i:                               ; preds = %if.end.i, %while.body.i.i70.i
  %Current.06.i.i71.i = phi ptr [ %Current.0.val.i.i72.i, %while.body.i.i70.i ], [ %Clauses.addr.2.val59.i, %if.end.i ]
  %Current.0.val.i.i72.i = load ptr, ptr %Current.06.i.i71.i, align 8
  %79 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i73.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %79, i64 0, i32 4
  %80 = load i32, ptr %total_size.i.i.i.i73.i, align 8
  %conv26.i.i.i.i74.i = sext i32 %80 to i64
  %81 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i75.i = add i64 %81, %conv26.i.i.i.i74.i
  store i64 %add27.i.i.i.i75.i, ptr @memory_FREEDBYTES, align 8
  %82 = load ptr, ptr %79, align 8
  store ptr %82, ptr %Current.06.i.i71.i, align 8
  %83 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i71.i, ptr %83, align 8
  %cmp.i.not.i.i76.i = icmp eq ptr %Current.0.val.i.i72.i, null
  br i1 %cmp.i.not.i.i76.i, label %sort_DeleteOne.exit.i, label %while.body.i.i70.i

sort_DeleteOne.exit.i:                            ; preds = %while.body.i.i70.i, %if.end.i
  %Clauses.addr.2.val.i = load ptr, ptr %Clauses.addr.293.i, align 8
  %cmp.i66.not.i = icmp eq ptr %Clauses.addr.2.val.i, null
  br i1 %cmp.i66.not.i, label %while.body.i.i, label %while.body25.i
...
while.body.i.i:                                   ; preds = %sort_DeleteOne.exit.i, %while.body.i.i
  ...
  br i1 %cmp.i.not.i81.i, label %sort_SortTheoryIsTrivial.exit, label %while.body.i.i
...
if.end19:                                         ; preds = %if.then15, %if.else, %if.end
  br i1 %cmp.i39.not69, label %list_Delete.exit, label %while.body.i67

while.body.i67:                                   ; preds = %if.end19, %while.body.i67
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i67 ], [ %call2, %if.end19 ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  ...
  br i1 %cmp.i.not.i68, label %list_Delete.exit, label %while.body.i67

list_Delete.exit:                                 ; preds = %while.body.i67, %if.end19
  ret ptr %Result.0
}
...
sort_TheoryCreate.exit:                           ; preds = %for.inc.i, %entry
  ...
  br i1 %cond, label %for.end73, label %for.body.lr.ph
...
while.body.i:                                     ; preds = %if.then, %while.body.i
  ...
  br i1 %cmp.i.not.i173, label %list_Delete.exit, label %while.body.i
...
list_Delete.exit:                                 ; preds = %while.body.i, %if.then
  ...
  br i1 %cmp.i.not5.i174, label %list_Delete.exit182, label %while.body.i175

while.body.i175:                                  ; preds = %list_Delete.exit, %while.body.i175
  %Current.06.i176 = phi ptr [ %Current.0.val.i177, %while.body.i175 ], [ %call5.val166, %list_Delete.exit ]
  %Current.0.val.i177 = load ptr, ptr %Current.06.i176, align 8
  %25 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i178 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %25, i64 0, i32 4
  %26 = load i32, ptr %total_size.i.i.i178, align 8
  %conv26.i.i.i179 = sext i32 %26 to i64
  %27 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i180 = add i64 %27, %conv26.i.i.i179
  store i64 %add27.i.i.i180, ptr @memory_FREEDBYTES, align 8
  %28 = load ptr, ptr %25, align 8
  store ptr %28, ptr %Current.06.i176, align 8
  %29 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i176, ptr %29, align 8
  %cmp.i.not.i181 = icmp eq ptr %Current.0.val.i177, null
  br i1 %cmp.i.not.i181, label %list_Delete.exit182, label %while.body.i175

list_Delete.exit182:                              ; preds = %while.body.i175, %list_Delete.exit
  store ptr null, ptr %24, align 8
...
for.inc:                                          ; preds = %for.body, %list_Delete.exit182
  ...
  br i1 %cmp.i169.not, label %for.body21, label %for.body

for.body21:                                       ; preds = %for.inc, %for.inc71
  %Decreasing.0276 = phi i32 [ %Decreasing.1.lcssa, %for.inc71 ], [ 1, %for.inc ]
  %ManySorted.0275 = phi i32 [ %ManySorted.1.lcssa, %for.inc71 ], [ 1, %for.inc ]
  %Scan.1274 = phi ptr [ %Scan.1.val, %for.inc71 ], [ %Clauses, %for.inc ]
  %31 = getelementptr i8, ptr %Scan.1274, i64 8
...
for.body29.lr.ph:                                 ; preds = %for.body21
  ...
  %.pre281 = load i32, ptr @fol_EQUALITY, align 4
  br label %for.body29

for.body29:                                       ; preds = %for.body29.lr.ph, %for.inc69
  %38 = phi i32 [ %.pre281, %for.body29.lr.ph ], [ %129, %for.inc69 ]
  %indvars.iv = phi i64 [ %36, %for.body29.lr.ph ], [ %indvars.iv.next, %for.inc69 ]
  %ManySorted.1271 = phi i32 [ %ManySorted.0275, %for.body29.lr.ph ], [ %ManySorted.3, %for.inc69 ]
...
for.inc16.us.i:                                   ; preds = %for.cond3.for.end_crit_edge.us.i
  ...
  br i1 %cmp.i.not.us.i, label %if.end67, label %for.cond3.preheader.us.i
...
for.body8.us.i:                                   ; preds = %for.body8.us.i, %for.cond3.preheader.us.i
  ...
  br i1 %49, label %for.body8.us.i, label %for.cond3.for.end_crit_edge.us.i
...
land.lhs.true:                                    ; preds = %if.then49
  ...
  br i1 %tobool56.not, label %if.then.i200, label %if.then.i205
...
while.body.i.i:                                   ; preds = %if.then.i200, %while.body.i.i
  ...
  %cmp.i.not.i.i = icmp eq ptr %Current.0.val.i.i, null
  br i1 %cmp.i.not.i.i, label %if.end61, label %while.body.i.i
...
if.end61:                                         ; preds = %while.body.i.i, %if.then.i200
  ...
  br i1 %tobool62.not, label %if.end67, label %if.then.i205

if.then.i205:                                     ; preds = %land.lhs.true, %if.end61
  %Cond.0266 = phi ptr [ %call60, %if.end61 ], [ %call52, %land.lhs.true ]
  %66 = getelementptr i8, ptr %Cond.0266, i64 8
  %C.val.i206 = load ptr, ptr %66, align 8
  tail call void @list_DeleteWithElement(ptr noundef %C.val.i206, ptr noundef nonnull @term_Delete) #12
  %67 = getelementptr i8, ptr %Cond.0266, i64 16
  %C.val9.i207 = load ptr, ptr %67, align 8
  tail call void @list_DeleteWithElement(ptr noundef %C.val9.i207, ptr noundef nonnull @term_Delete) #12
  %68 = getelementptr i8, ptr %Cond.0266, i64 24
  %C.val10.i208 = load ptr, ptr %68, align 8
  tail call void @list_DeleteWithElement(ptr noundef %C.val10.i208, ptr noundef nonnull @term_Delete) #12
  %69 = getelementptr i8, ptr %Cond.0266, i64 32
  %C.val11.i209 = load ptr, ptr %69, align 8
  %cmp.i.not5.i.i210 = icmp eq ptr %C.val11.i209, null
  br i1 %cmp.i.not5.i.i210, label %sort_ConditionDelete.exit222, label %while.body.i.i211

while.body.i.i211:                                ; preds = %if.then.i205, %while.body.i.i211
  %Current.06.i.i212 = phi ptr [ %Current.0.val.i.i213, %while.body.i.i211 ], [ %C.val11.i209, %if.then.i205 ]
  %Current.0.val.i.i213 = load ptr, ptr %Current.06.i.i212, align 8
  %70 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i214 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %70, i64 0, i32 4
  %71 = load i32, ptr %total_size.i.i.i.i214, align 8
  %conv26.i.i.i.i215 = sext i32 %71 to i64
  %72 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i216 = add i64 %72, %conv26.i.i.i.i215
  store i64 %add27.i.i.i.i216, ptr @memory_FREEDBYTES, align 8
  %73 = load ptr, ptr %70, align 8
  store ptr %73, ptr %Current.06.i.i212, align 8
  %74 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i212, ptr %74, align 8
  %cmp.i.not.i.i217 = icmp eq ptr %Current.0.val.i.i213, null
  br i1 %cmp.i.not.i.i217, label %sort_ConditionDelete.exit222, label %while.body.i.i211

sort_ConditionDelete.exit222:                     ; preds = %while.body.i.i211, %if.then.i205
  %75 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 40), align 8
  %total_size.i.i.i219 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %75, i64 0, i32 4
  %76 = load i32, ptr %total_size.i.i.i219, align 8
  %conv26.i.i.i220 = sext i32 %76 to i64
  %77 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i221 = add i64 %77, %conv26.i.i.i220
...
if.end67:                                         ; preds = %for.inc16.us.i, %if.then49, %if.end61, %if.then33, %lor.lhs.false, %sort_ConditionDelete.exit222
  %ManySorted.2 = phi i32 [ 0, %sort_ConditionDelete.exit222 ], [ 0, %lor.lhs.false ], [ 0, %if.then33 ], [ 0, %if.end61 ], [ 0, %if.then49 ], [ %ManySorted.1271, %for.inc16.us.i ]
...
while.body.i.i.i:                                 ; preds = %if.end67, %while.body.i.i.i
  ...
  br i1 %cmp.i.not.i.i.i, label %sort_DeleteOne.exit.i, label %while.body.i.i.i
...
if.then.i.i:                                      ; preds = %sort_DeleteOne.exit.i
  ...
  br i1 %cmp.i.not5.i.i5.i, label %list_Delete.exit.i.i, label %while.body.i.i6.i

while.body.i.i6.i:                                ; preds = %if.then.i.i, %while.body.i.i6.i
  %Current.06.i.i7.i = phi ptr [ %Current.0.val.i.i8.i, %while.body.i.i6.i ], [ %C.val11.i.i, %if.then.i.i ]
  %Current.0.val.i.i8.i = load ptr, ptr %Current.06.i.i7.i, align 8
  %90 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i9.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %90, i64 0, i32 4
  %91 = load i32, ptr %total_size.i.i.i.i9.i, align 8
  %conv26.i.i.i.i10.i = sext i32 %91 to i64
  %92 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i11.i = add i64 %92, %conv26.i.i.i.i10.i
  store i64 %add27.i.i.i.i11.i, ptr @memory_FREEDBYTES, align 8
  %93 = load ptr, ptr %90, align 8
  store ptr %93, ptr %Current.06.i.i7.i, align 8
  %94 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i7.i, ptr %94, align 8
  %cmp.i.not.i.i12.i = icmp eq ptr %Current.0.val.i.i8.i, null
  br i1 %cmp.i.not.i.i12.i, label %list_Delete.exit.i.i, label %while.body.i.i6.i

list_Delete.exit.i.i:                             ; preds = %while.body.i.i6.i, %if.then.i.i
...
sort_PairDelete.exit:                             ; preds = %sort_DeleteOne.exit.i, %list_Delete.exit.i.i
  ...
  br i1 %cmp.i.not5.i.i.i227, label %sort_DeleteOne.exit.i235, label %while.body.i.i.i228

while.body.i.i.i228:                              ; preds = %sort_PairDelete.exit, %while.body.i.i.i228
  %Current.06.i.i.i229 = phi ptr [ %Current.0.val.i.i.i230, %while.body.i.i.i228 ], [ %Pair.val.i226, %sort_PairDelete.exit ]
  %Current.0.val.i.i.i230 = load ptr, ptr %Current.06.i.i.i229, align 8
  %105 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i.i231 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %105, i64 0, i32 4
  %106 = load i32, ptr %total_size.i.i.i.i.i231, align 8
  %conv26.i.i.i.i.i232 = sext i32 %106 to i64
  %107 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i.i233 = add i64 %107, %conv26.i.i.i.i.i232
  store i64 %add27.i.i.i.i.i233, ptr @memory_FREEDBYTES, align 8
  %108 = load ptr, ptr %105, align 8
  store ptr %108, ptr %Current.06.i.i.i229, align 8
  %109 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i.i229, ptr %109, align 8
  %cmp.i.not.i.i.i234 = icmp eq ptr %Current.0.val.i.i.i230, null
  br i1 %cmp.i.not.i.i.i234, label %sort_DeleteOne.exit.i235, label %while.body.i.i.i228

sort_DeleteOne.exit.i235:                         ; preds = %while.body.i.i.i228, %sort_PairDelete.exit
  %Pair.val4.i236 = load ptr, ptr %call37, align 8
  %cmp.not.i.i237 = icmp eq ptr %Pair.val4.i236, null
  br i1 %cmp.not.i.i237, label %sort_PairDelete.exit258, label %if.then.i.i238

if.then.i.i238:                                   ; preds = %sort_DeleteOne.exit.i235
  %110 = getelementptr i8, ptr %Pair.val4.i236, i64 8
  %C.val.i.i239 = load ptr, ptr %110, align 8
  tail call void @list_DeleteWithElement(ptr noundef %C.val.i.i239, ptr noundef nonnull @term_Delete) #12
  %111 = getelementptr i8, ptr %Pair.val4.i236, i64 16
  %C.val9.i.i240 = load ptr, ptr %111, align 8
  tail call void @list_DeleteWithElement(ptr noundef %C.val9.i.i240, ptr noundef nonnull @term_Delete) #12
  %112 = getelementptr i8, ptr %Pair.val4.i236, i64 24
  %C.val10.i.i241 = load ptr, ptr %112, align 8
  tail call void @list_DeleteWithElement(ptr noundef %C.val10.i.i241, ptr noundef nonnull @term_Delete) #12
  %113 = getelementptr i8, ptr %Pair.val4.i236, i64 32
  %C.val11.i.i242 = load ptr, ptr %113, align 8
  %cmp.i.not5.i.i5.i243 = icmp eq ptr %C.val11.i.i242, null
  br i1 %cmp.i.not5.i.i5.i243, label %list_Delete.exit.i.i251, label %while.body.i.i6.i244

while.body.i.i6.i244:                             ; preds = %if.then.i.i238, %while.body.i.i6.i244
  %Current.06.i.i7.i245 = phi ptr [ %Current.0.val.i.i8.i246, %while.body.i.i6.i244 ], [ %C.val11.i.i242, %if.then.i.i238 ]
  %Current.0.val.i.i8.i246 = load ptr, ptr %Current.06.i.i7.i245, align 8
  %114 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i9.i247 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %114, i64 0, i32 4
  %115 = load i32, ptr %total_size.i.i.i.i9.i247, align 8
  %conv26.i.i.i.i10.i248 = sext i32 %115 to i64
  %116 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i11.i249 = add i64 %116, %conv26.i.i.i.i10.i248
  store i64 %add27.i.i.i.i11.i249, ptr @memory_FREEDBYTES, align 8
  %117 = load ptr, ptr %114, align 8
  store ptr %117, ptr %Current.06.i.i7.i245, align 8
  %118 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i7.i245, ptr %118, align 8
  %cmp.i.not.i.i12.i250 = icmp eq ptr %Current.0.val.i.i8.i246, null
  br i1 %cmp.i.not.i.i12.i250, label %list_Delete.exit.i.i251, label %while.body.i.i6.i244

list_Delete.exit.i.i251:                          ; preds = %while.body.i.i6.i244, %if.then.i.i238
  %119 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 40), align 8
  %total_size.i.i.i.i252 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %119, i64 0, i32 4
  %120 = load i32, ptr %total_size.i.i.i.i252, align 8
  %conv26.i.i.i.i253 = sext i32 %120 to i64
  %121 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i254 = add i64 %121, %conv26.i.i.i.i253
  store i64 %add27.i.i.i.i254, ptr @memory_FREEDBYTES, align 8
  %122 = load ptr, ptr %119, align 8
  store ptr %122, ptr %Pair.val4.i236, align 8
  %123 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 40), align 8
  store ptr %Pair.val4.i236, ptr %123, align 8
  br label %sort_PairDelete.exit258

sort_PairDelete.exit258:                          ; preds = %sort_DeleteOne.exit.i235, %list_Delete.exit.i.i251
...
for.inc69:                                        ; preds = %for.body29, %sort_PairDelete.exit258
  ...
  %ManySorted.3 = phi i32 [ %ManySorted.2, %sort_PairDelete.exit258 ], [ %ManySorted.1271, %for.body29 ]
  ...
  br i1 %130, label %for.body29, label %for.inc71

for.inc71:                                        ; preds = %for.inc69, %for.body21
  %ManySorted.1.lcssa = phi i32 [ %ManySorted.0275, %for.body21 ], [ %ManySorted.3, %for.inc69 ]
  %Decreasing.1.lcssa = phi i32 [ %Decreasing.0276, %for.body21 ], [ %Decreasing.3, %for.inc69 ]
  %Scan.1.val = load ptr, ptr %Scan.1274, align 8
  %cmp.i185 = icmp ne ptr %Scan.1.val, null
  %tobool20 = icmp ne i32 %Decreasing.1.lcssa, 0
  %131 = select i1 %cmp.i185, i1 %tobool20, i1 false
  br i1 %131, label %for.body21, label %for.end73.loopexit

for.end73.loopexit:                               ; preds = %for.inc71
  %132 = icmp eq i32 %ManySorted.1.lcssa, 0
  %133 = select i1 %tobool20, i32 2, i32 1
  %134 = select i1 %132, i32 %133, i32 3
  br label %for.end73

for.end73:                                        ; preds = %for.end73.loopexit, %sort_TheoryCreate.exit
  %ManySorted.0.lcssa = phi i32 [ 3, %sort_TheoryCreate.exit ], [ %134, %for.end73.loopexit ]
  tail call void @sort_TheoryDelete(ptr noundef nonnull %call.i)
  ret i32 %ManySorted.0.lcssa
}
