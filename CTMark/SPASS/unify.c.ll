; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/unify.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/unify.c"
...
while.end22.thread:                               ; preds = %land.rhs12.preheader, %land.rhs12
  ...
  %idxprom.i.i195.lcssa = phi i64 [ %idxprom.i.i195, %land.rhs12 ], [ %idxprom.i.i195486, %land.rhs12.preheader ]
...
if.then27:                                        ; preds = %while.end22.thread
  ...
  %or.cond331 = and i1 %cmp, %cmp.i.i207.not
  br i1 %or.cond331, label %if.end82, label %if.then30

if.then30:                                        ; preds = %if.then27
  %arrayidx.i.i.i = getelementptr inbounds %struct.binding, ptr %CtR.addr.1368.lcssa, i64 %idxprom.i.i195.lcssa
...
if.then.i:                                        ; preds = %if.end22.i, %for.cond.outer.i
  ...
  %or.cond.i = and i1 %cmp.i209, %cmp.i.not.i
...
if.then47:                                        ; preds = %while.end22.thread
  ...
  br i1 %tobool48.not, label %if.else54, label %for.cond.outer.i220

for.cond.outer.i220:                              ; preds = %if.then47, %for.cond.outer.backedge.i238
  %Term.addr.0.val6093.i224 = phi i32 [ %Term.addr.0.val6093.i224.pre, %for.cond.outer.backedge.i238 ], [ %TermL.addr.1.val178.lcssa, %if.then47 ]
  %stack_POINTER.promoted102.i221 = phi i32 [ %stack_POINTER.promoted98.i239, %for.cond.outer.backedge.i238 ], [ %1, %if.then47 ]
  %Term.addr.0.ph.i222 = phi ptr [ %Term.addr.0.ph.be.i240, %for.cond.outer.backedge.i238 ], [ %TermL.addr.1.lcssa, %if.then47 ]
  %CTerm.addr.0.ph.i223 = phi ptr [ %CTerm.addr.0.ph.be.i241, %for.cond.outer.backedge.i238 ], [ %CtL.addr.1.lcssa, %if.then47 ]
  %cmp.i.i94.i225 = icmp slt i32 %Term.addr.0.val6093.i224, 1
  br i1 %cmp.i.i94.i225, label %if.else12.i259, label %if.then.i226

if.then.i226:                                     ; preds = %if.end22.i276, %for.cond.outer.i220
  %stack_POINTER.promoted99.i227 = phi i32 [ %stack_POINTER.promoted102.i221, %for.cond.outer.i220 ], [ %stack_POINTER.promoted100.i277, %if.end22.i276 ]
  %Term.addr.0.val60.lcssa.i228 = phi i32 [ %Term.addr.0.val6093.i224, %for.cond.outer.i220 ], [ %Term.addr.0.val60.i280, %if.end22.i276 ]
  %cmp.i229 = icmp eq ptr %CTerm.addr.0.ph.i223, %CtR.addr.1368.lcssa
  %cmp.i.not.i230 = icmp eq i32 %Term.addr.0.val60.lcssa.i228, %TermR.addr.1.val177370.lcssa
  %or.cond.i231 = and i1 %cmp.i229, %cmp.i.not.i230
  br i1 %or.cond.i231, label %cleanup.sink.split, label %if.else.i232

if.else.i232:                                     ; preds = %if.then.i226
  %idxprom.i.i.i233 = zext i32 %Term.addr.0.val60.lcssa.i228 to i64
  %term.i.i.i234 = getelementptr inbounds %struct.binding, ptr %CTerm.addr.0.ph.i223, i64 %idxprom.i.i.i233, i32 2
  %17 = load ptr, ptr %term.i.i.i234, align 8
  %cmp.i67.not.i235 = icmp eq ptr %17, null
  br i1 %cmp.i67.not.i235, label %if.end25.i242, label %if.then8.i236

if.then8.i236:                                    ; preds = %if.else.i232
  %context.i.i237 = getelementptr inbounds %struct.binding, ptr %CTerm.addr.0.ph.i223, i64 %idxprom.i.i.i233, i32 3
  %18 = load ptr, ptr %context.i.i237, align 8
  br label %for.cond.outer.backedge.i238

for.cond.outer.backedge.i238:                     ; preds = %if.else38.i255, %if.then36.i256, %if.then8.i236
  %stack_POINTER.promoted98.i239 = phi i32 [ %stack_POINTER.promoted99.i227, %if.then8.i236 ], [ %sub.i.i250, %if.then36.i256 ], [ %stack_POINTER.promoted104.i243, %if.else38.i255 ]
  %Term.addr.0.ph.be.i240 = phi ptr [ %17, %if.then8.i236 ], [ %call30.val65.i249, %if.then36.i256 ], [ %call30.val65.i249, %if.else38.i255 ]
  %CTerm.addr.0.ph.be.i241 = phi ptr [ %18, %if.then8.i236 ], [ %23, %if.then36.i256 ], [ %23, %if.else38.i255 ]
  %Term.addr.0.val6093.i224.pre = load i32, ptr %Term.addr.0.ph.be.i240, align 8
  br label %for.cond.outer.i220

if.else12.i259:                                   ; preds = %for.cond.outer.i220, %if.end22.i276
  %stack_POINTER.promoted101.i260 = phi i32 [ %stack_POINTER.promoted100.i277, %if.end22.i276 ], [ %stack_POINTER.promoted102.i221, %for.cond.outer.i220 ]
  %Term.addr.096.i261 = phi ptr [ %call16.val66.i279, %if.end22.i276 ], [ %Term.addr.0.ph.i222, %for.cond.outer.i220 ]
  %inc.i759295.i262 = phi i32 [ %inc.i7591.i278, %if.end22.i276 ], [ %stack_POINTER.promoted102.i221, %for.cond.outer.i220 ]
  %19 = getelementptr i8, ptr %Term.addr.096.i261, i64 16
  %Term.addr.0.val62.i263 = load ptr, ptr %19, align 8
  %cmp.i70.not.i264 = icmp eq ptr %Term.addr.0.val62.i263, null
  br i1 %cmp.i70.not.i264, label %if.end25.i242, label %if.then15.i265

if.then15.i265:                                   ; preds = %if.else12.i259
  %call16.val64.i266 = load ptr, ptr %Term.addr.0.val62.i263, align 8
  %cmp.i72.not.i267 = icmp eq ptr %call16.val64.i266, null
  br i1 %cmp.i72.not.i267, label %if.end22.i276, label %if.then20.i268

if.then20.i268:                                   ; preds = %if.then15.i265
  %inc.i.i269 = add i32 %inc.i759295.i262, 1
  store i32 %inc.i.i269, ptr @stack_POINTER, align 4
  %idxprom.i74.i270 = zext i32 %inc.i759295.i262 to i64
  %arrayidx.i.i271 = getelementptr inbounds [10000 x ptr], ptr @stack_STACK, i64 0, i64 %idxprom.i74.i270
  store ptr %CTerm.addr.0.ph.i223, ptr %arrayidx.i.i271, align 8
  %call16.val.i272 = load ptr, ptr %Term.addr.0.val62.i263, align 8
  %inc.i75.i273 = add i32 %inc.i759295.i262, 2
  store i32 %inc.i75.i273, ptr @stack_POINTER, align 4
  %idxprom.i76.i274 = zext i32 %inc.i.i269 to i64
  %arrayidx.i77.i275 = getelementptr inbounds [10000 x ptr], ptr @stack_STACK, i64 0, i64 %idxprom.i76.i274
  store ptr %call16.val.i272, ptr %arrayidx.i77.i275, align 8
  br label %if.end22.i276

if.end22.i276:                                    ; preds = %if.then20.i268, %if.then15.i265
  %stack_POINTER.promoted100.i277 = phi i32 [ %inc.i75.i273, %if.then20.i268 ], [ %stack_POINTER.promoted101.i260, %if.then15.i265 ]
  %inc.i7591.i278 = phi i32 [ %inc.i75.i273, %if.then20.i268 ], [ %inc.i759295.i262, %if.then15.i265 ]
  %20 = getelementptr i8, ptr %Term.addr.0.val62.i263, i64 8
  %call16.val66.i279 = load ptr, ptr %20, align 8
  %Term.addr.0.val60.i280 = load i32, ptr %call16.val66.i279, align 8
  %cmp.i.i.i281 = icmp slt i32 %Term.addr.0.val60.i280, 1
  br i1 %cmp.i.i.i281, label %if.else12.i259, label %if.then.i226

if.end25.i242:                                    ; preds = %if.else12.i259, %if.else.i232
  %stack_POINTER.promoted104.i243 = phi i32 [ %stack_POINTER.promoted99.i227, %if.else.i232 ], [ %stack_POINTER.promoted101.i260, %if.else12.i259 ]
  %cmp.i78.not.i244 = icmp eq i32 %stack_POINTER.promoted104.i243, %1
  br i1 %cmp.i78.not.i244, label %if.else54.loopexit, label %if.else29.i245

if.else29.i245:                                   ; preds = %if.end25.i242
  %dec.i.i246 = add i32 %stack_POINTER.promoted104.i243, -1
  store i32 %dec.i.i246, ptr @stack_POINTER, align 4
  %idxprom.i80.i247 = zext i32 %dec.i.i246 to i64
  %arrayidx.i81.i248 = getelementptr inbounds [10000 x ptr], ptr @stack_STACK, i64 0, i64 %idxprom.i80.i247
  %21 = load ptr, ptr %arrayidx.i81.i248, align 8
  %22 = getelementptr i8, ptr %21, i64 8
  %call30.val65.i249 = load ptr, ptr %22, align 8
  %sub.i.i250 = add i32 %stack_POINTER.promoted104.i243, -2
  %idxprom.i82.i251 = zext i32 %sub.i.i250 to i64
  %arrayidx.i83.i252 = getelementptr inbounds [10000 x ptr], ptr @stack_STACK, i64 0, i64 %idxprom.i82.i251
  %23 = load ptr, ptr %arrayidx.i83.i252, align 8
  %call30.val63.i253 = load ptr, ptr %21, align 8
  %cmp.i84.not.i254 = icmp eq ptr %call30.val63.i253, null
  br i1 %cmp.i84.not.i254, label %if.then36.i256, label %if.else38.i255

if.then36.i256:                                   ; preds = %if.else29.i245
  store i32 %sub.i.i250, ptr @stack_POINTER, align 4
  br label %for.cond.outer.backedge.i238

if.else38.i255:                                   ; preds = %if.else29.i245
  store i32 %stack_POINTER.promoted104.i243, ptr @stack_POINTER, align 4
  store ptr %call30.val63.i253, ptr %arrayidx.i81.i248, align 8
  br label %for.cond.outer.backedge.i238

if.else54.loopexit:                               ; preds = %if.end25.i242
  %TermR.addr.1.val.pre = load i32, ptr %TermR.addr.1369.lcssa, align 8
  br label %if.else54

if.else54:                                        ; preds = %if.else54.loopexit, %if.then47
  %TermR.addr.1.val = phi i32 [ %TermR.addr.1.val.pre, %if.else54.loopexit ], [ %TermR.addr.1.val177370.lcssa, %if.then47 ]
  %idxprom.i.i.i283 = sext i32 %TermR.addr.1.val to i64
  %arrayidx.i.i.i284 = getelementptr inbounds %struct.binding, ptr %CtR.addr.1368.lcssa, i64 %idxprom.i.i.i283
  store ptr %arrayidx.i.i.i284, ptr @cont_CURRENTBINDING, align 8
  %term.i.i.i285 = getelementptr inbounds %struct.binding, ptr %CtR.addr.1368.lcssa, i64 %idxprom.i.i.i283, i32 2
...
cleanup.sink.split:                               ; preds = %if.else58, %if.then.i226, %if.then.i
  store i32 %0, ptr @stack_POINTER, align 4
  br label %cleanup
...
if.else53:                                        ; preds = %if.else
  br i1 %cmp.i.i156, label %cleanup.sink.split, label %for.cond.i189

for.cond.i189:                                    ; preds = %if.else53, %for.cond.backedge.i199
  %Term.addr.0.val55.i191 = phi i32 [ %Term.addr.0.val55.i191.pre, %for.cond.backedge.i199 ], [ %TermL.addr.1.val144, %if.else53 ]
  %17 = phi i32 [ %22, %for.cond.backedge.i199 ], [ %1, %if.else53 ]
  %Term.addr.0.i190 = phi ptr [ %Term.addr.0.be.i200, %for.cond.backedge.i199 ], [ %TermL.addr.1, %if.else53 ]
  %cmp.i.i.i192 = icmp slt i32 %Term.addr.0.val55.i191, 1
  br i1 %cmp.i.i.i192, label %if.else13.i213, label %if.then.i193

if.then.i193:                                     ; preds = %for.cond.i189
  %cmp.i.not.i194 = icmp eq i32 %Term.addr.0.val55.i191, %TermR.addr.1.val143
  br i1 %cmp.i.not.i194, label %cleanup.sink.split, label %if.else.i195

if.else.i195:                                     ; preds = %if.then.i193
  %idxprom.i.i.i196 = zext i32 %Term.addr.0.val55.i191 to i64
  ...
  br i1 %cmp.i62.not.i198, label %if.end26.i201, label %for.cond.backedge.i199

if.else13.i213:                                   ; preds = %for.cond.i189
  %19 = getelementptr i8, ptr %Term.addr.0.i190, i64 16
  %Term.addr.0.val57.i214 = load ptr, ptr %19, align 8
  %cmp.i64.not.i215 = icmp eq ptr %Term.addr.0.val57.i214, null
  br i1 %cmp.i64.not.i215, label %if.end26.i201, label %if.then16.i216

if.then16.i216:                                   ; preds = %if.else13.i213
  %call17.val59.i217 = load ptr, ptr %Term.addr.0.val57.i214, align 8
  %cmp.i66.not.i218 = icmp eq ptr %call17.val59.i217, null
  br i1 %cmp.i66.not.i218, label %if.end23.i223, label %if.then21.i219

if.then21.i219:                                   ; preds = %if.then16.i216
  %inc.i.i220 = add i32 %17, 1
  store i32 %inc.i.i220, ptr @stack_POINTER, align 4
  %idxprom.i68.i221 = zext i32 %17 to i64
  %arrayidx.i.i222 = getelementptr inbounds [10000 x ptr], ptr @stack_STACK, i64 0, i64 %idxprom.i68.i221
  store ptr %call17.val59.i217, ptr %arrayidx.i.i222, align 8
  br label %if.end23.i223

if.end23.i223:                                    ; preds = %if.then21.i219, %if.then16.i216
  %20 = phi i32 [ %inc.i.i220, %if.then21.i219 ], [ %17, %if.then16.i216 ]
  %21 = getelementptr i8, ptr %Term.addr.0.val57.i214, i64 8
  %call17.val61.i224 = load ptr, ptr %21, align 8
  br label %for.cond.backedge.i199

for.cond.backedge.i199:                           ; preds = %if.then36.i210, %if.else30.i203, %if.end23.i223, %if.else.i195
  %22 = phi i32 [ %20, %if.end23.i223 ], [ %17, %if.else.i195 ], [ %dec.i.i204, %if.else30.i203 ], [ %17, %if.then36.i210 ]
  %Term.addr.0.be.i200 = phi ptr [ %call17.val61.i224, %if.end23.i223 ], [ %18, %if.else.i195 ], [ %call31.val60.i207, %if.else30.i203 ], [ %call31.val60.i207, %if.then36.i210 ]
  %Term.addr.0.val55.i191.pre = load i32, ptr %Term.addr.0.be.i200, align 8
  br label %for.cond.i189

if.end26.i201:                                    ; preds = %if.else13.i213, %if.else.i195
  %cmp.i69.not.i202 = icmp eq i32 %17, %1
  br i1 %cmp.i69.not.i202, label %if.else61, label %if.else30.i203

if.else30.i203:                                   ; preds = %if.end26.i201
  %dec.i.i204 = add i32 %17, -1
  store i32 %dec.i.i204, ptr @stack_POINTER, align 4
  %idxprom.i71.i205 = zext i32 %dec.i.i204 to i64
  %arrayidx.i72.i206 = getelementptr inbounds [10000 x ptr], ptr @stack_STACK, i64 0, i64 %idxprom.i71.i205
  %23 = load ptr, ptr %arrayidx.i72.i206, align 8
  %24 = getelementptr i8, ptr %23, i64 8
  %call31.val60.i207 = load ptr, ptr %24, align 8
  %call31.val58.i208 = load ptr, ptr %23, align 8
  %cmp.i73.not.i209 = icmp eq ptr %call31.val58.i208, null
  br i1 %cmp.i73.not.i209, label %for.cond.backedge.i199, label %if.then36.i210

if.then36.i210:                                   ; preds = %if.else30.i203
  store i32 %17, ptr @stack_POINTER, align 4
  store ptr %call31.val58.i208, ptr %arrayidx.i72.i206, align 8
  br label %for.cond.backedge.i199

if.else61:                                        ; preds = %if.end26.i201
...
cleanup.sink.split:                               ; preds = %if.else53, %if.then.i, %if.then.i193
  store i32 %0, ptr @stack_POINTER, align 4
  br label %cleanup
...
if.then27:                                        ; preds = %while.end22.thread
  ...
  %or.cond231 = and i1 %cmp, %cmp.i.i177.not
  br i1 %or.cond231, label %if.end66, label %if.then30

if.then30:                                        ; preds = %if.then27
  %arrayidx.i.i.i = getelementptr inbounds %struct.binding, ptr %CtR.addr.1250, i64 %idxprom.i.i165
  store ptr %arrayidx.i.i.i, ptr @cont_CURRENTBINDING, align 8
...
if.then39:                                        ; preds = %while.end22.thread
  %arrayidx.i.i.i188 = getelementptr inbounds %struct.binding, ptr %CtR.addr.1250, i64 %idxprom.i.i165
...
while.body.preheader:                             ; preds = %entry
  %idxprom.i.i344 = zext i32 %TermL.addr.0.val168312 to i64
  %term.i.i345 = getelementptr inbounds %struct.binding, ptr %CtL, i64 %idxprom.i.i344, i32 2
  %0 = load ptr, ptr %term.i.i345, align 8
  %cmp.i.not346 = icmp eq ptr %0, null
  br i1 %cmp.i.not346, label %while.end, label %cleanup
...
cleanup:                                          ; preds = %while.body.preheader, %while.body
  ...
  %idxprom.i.i348 = phi i64 [ %idxprom.i.i, %while.body ], [ %idxprom.i.i344, %while.body.preheader ]
  %CtL.addr.0315347 = phi ptr [ %3, %while.body ], [ %CtL, %while.body.preheader ]
  %context.i = getelementptr inbounds %struct.binding, ptr %CtL.addr.0315347, i64 %idxprom.i.i348, i32 3
...
while.body9.preheader:                            ; preds = %while.end
  %idxprom.i.i183354 = zext i32 %TermR.addr.0.val167320 to i64
  %term.i.i184355 = getelementptr inbounds %struct.binding, ptr %CtR, i64 %idxprom.i.i183354, i32 2
  %4 = load ptr, ptr %term.i.i184355, align 8
  %cmp.i185.not356 = icmp eq ptr %4, null
  br i1 %cmp.i185.not356, label %while.end23, label %cleanup20
...
cleanup20:                                        ; preds = %while.body9.preheader, %while.body9
  ...
  %idxprom.i.i183358 = phi i64 [ %idxprom.i.i183, %while.body9 ], [ %idxprom.i.i183354, %while.body9.preheader ]
  %CtR.addr.0323357 = phi ptr [ %7, %while.body9 ], [ %CtR, %while.body9.preheader ]
  %context.i188 = getelementptr inbounds %struct.binding, ptr %CtR.addr.0323357, i64 %idxprom.i.i183358, i32 3
...
if.then29:                                        ; preds = %if.then26
  ...
  %or.cond309 = and i1 %cmp.not, %cmp.i.i195.not
...
if.then.i:                                        ; preds = %if.end22.i, %for.cond.outer.i
  ...
  %or.cond.i = and i1 %cmp.i210, %cmp.i.not.i
...
if.then63:                                        ; preds = %if.else60
  ...
  br label %for.cond.outer.i221

for.cond.outer.i221:                              ; preds = %for.cond.outer.backedge.i239, %if.then63
  %Term.addr.0.val6093.i225 = phi i32 [ %TermL.addr.2.val166, %if.then63 ], [ %Term.addr.0.val6093.i225.pre, %for.cond.outer.backedge.i239 ]
  %stack_POINTER.promoted102.i222 = phi i32 [ %32, %if.then63 ], [ %stack_POINTER.promoted98.i240, %for.cond.outer.backedge.i239 ]
  %Term.addr.0.ph.i223 = phi ptr [ %TermL.addr.0.lcssa, %if.then63 ], [ %Term.addr.0.ph.be.i241, %for.cond.outer.backedge.i239 ]
  %CTerm.addr.0.ph.i224 = phi ptr [ %CtL.addr.0.lcssa, %if.then63 ], [ %CTerm.addr.0.ph.be.i242, %for.cond.outer.backedge.i239 ]
  %cmp.i.i94.i226 = icmp slt i32 %Term.addr.0.val6093.i225, 1
  br i1 %cmp.i.i94.i226, label %if.else12.i260, label %if.then.i227

if.then.i227:                                     ; preds = %if.end22.i277, %for.cond.outer.i221
  %stack_POINTER.promoted99.i228 = phi i32 [ %stack_POINTER.promoted102.i222, %for.cond.outer.i221 ], [ %stack_POINTER.promoted100.i278, %if.end22.i277 ]
  %Term.addr.0.val60.lcssa.i229 = phi i32 [ %Term.addr.0.val6093.i225, %for.cond.outer.i221 ], [ %Term.addr.0.val60.i281, %if.end22.i277 ]
  %cmp.i230 = icmp eq ptr %CTerm.addr.0.ph.i224, %CtR.addr.0.lcssa
  %cmp.i.not.i231 = icmp eq i32 %Term.addr.0.val60.lcssa.i229, %TermR.addr.2.val164
  %or.cond.i232 = and i1 %cmp.i230, %cmp.i.not.i231
  br i1 %or.cond.i232, label %unify_OccurCheck.exit283, label %if.else.i233

if.else.i233:                                     ; preds = %if.then.i227
  %idxprom.i.i.i234 = zext i32 %Term.addr.0.val60.lcssa.i229 to i64
  %term.i.i.i235 = getelementptr inbounds %struct.binding, ptr %CTerm.addr.0.ph.i224, i64 %idxprom.i.i.i234, i32 2
  %33 = load ptr, ptr %term.i.i.i235, align 8
  %cmp.i67.not.i236 = icmp eq ptr %33, null
  br i1 %cmp.i67.not.i236, label %if.end25.i243, label %if.then8.i237

if.then8.i237:                                    ; preds = %if.else.i233
  %context.i.i238 = getelementptr inbounds %struct.binding, ptr %CTerm.addr.0.ph.i224, i64 %idxprom.i.i.i234, i32 3
  %34 = load ptr, ptr %context.i.i238, align 8
  br label %for.cond.outer.backedge.i239

for.cond.outer.backedge.i239:                     ; preds = %if.else38.i256, %if.then36.i257, %if.then8.i237
  %stack_POINTER.promoted98.i240 = phi i32 [ %stack_POINTER.promoted99.i228, %if.then8.i237 ], [ %sub.i.i251, %if.then36.i257 ], [ %stack_POINTER.promoted104.i244, %if.else38.i256 ]
  %Term.addr.0.ph.be.i241 = phi ptr [ %33, %if.then8.i237 ], [ %call30.val65.i250, %if.then36.i257 ], [ %call30.val65.i250, %if.else38.i256 ]
  %CTerm.addr.0.ph.be.i242 = phi ptr [ %34, %if.then8.i237 ], [ %39, %if.then36.i257 ], [ %39, %if.else38.i256 ]
  %Term.addr.0.val6093.i225.pre = load i32, ptr %Term.addr.0.ph.be.i241, align 8
  br label %for.cond.outer.i221

if.else12.i260:                                   ; preds = %for.cond.outer.i221, %if.end22.i277
  %stack_POINTER.promoted101.i261 = phi i32 [ %stack_POINTER.promoted100.i278, %if.end22.i277 ], [ %stack_POINTER.promoted102.i222, %for.cond.outer.i221 ]
  %Term.addr.096.i262 = phi ptr [ %call16.val66.i280, %if.end22.i277 ], [ %Term.addr.0.ph.i223, %for.cond.outer.i221 ]
  %inc.i759295.i263 = phi i32 [ %inc.i7591.i279, %if.end22.i277 ], [ %stack_POINTER.promoted102.i222, %for.cond.outer.i221 ]
  %35 = getelementptr i8, ptr %Term.addr.096.i262, i64 16
  %Term.addr.0.val62.i264 = load ptr, ptr %35, align 8
  %cmp.i70.not.i265 = icmp eq ptr %Term.addr.0.val62.i264, null
  br i1 %cmp.i70.not.i265, label %if.end25.i243, label %if.then15.i266

if.then15.i266:                                   ; preds = %if.else12.i260
  %call16.val64.i267 = load ptr, ptr %Term.addr.0.val62.i264, align 8
  %cmp.i72.not.i268 = icmp eq ptr %call16.val64.i267, null
  br i1 %cmp.i72.not.i268, label %if.end22.i277, label %if.then20.i269

if.then20.i269:                                   ; preds = %if.then15.i266
  %inc.i.i270 = add i32 %inc.i759295.i263, 1
  store i32 %inc.i.i270, ptr @stack_POINTER, align 4
  %idxprom.i74.i271 = zext i32 %inc.i759295.i263 to i64
  %arrayidx.i.i272 = getelementptr inbounds [10000 x ptr], ptr @stack_STACK, i64 0, i64 %idxprom.i74.i271
  store ptr %CTerm.addr.0.ph.i224, ptr %arrayidx.i.i272, align 8
  %call16.val.i273 = load ptr, ptr %Term.addr.0.val62.i264, align 8
  %inc.i75.i274 = add i32 %inc.i759295.i263, 2
  store i32 %inc.i75.i274, ptr @stack_POINTER, align 4
  %idxprom.i76.i275 = zext i32 %inc.i.i270 to i64
  %arrayidx.i77.i276 = getelementptr inbounds [10000 x ptr], ptr @stack_STACK, i64 0, i64 %idxprom.i76.i275
  store ptr %call16.val.i273, ptr %arrayidx.i77.i276, align 8
  br label %if.end22.i277

if.end22.i277:                                    ; preds = %if.then20.i269, %if.then15.i266
  %stack_POINTER.promoted100.i278 = phi i32 [ %inc.i75.i274, %if.then20.i269 ], [ %stack_POINTER.promoted101.i261, %if.then15.i266 ]
  %inc.i7591.i279 = phi i32 [ %inc.i75.i274, %if.then20.i269 ], [ %inc.i759295.i263, %if.then15.i266 ]
  %36 = getelementptr i8, ptr %Term.addr.0.val62.i264, i64 8
  %call16.val66.i280 = load ptr, ptr %36, align 8
  %Term.addr.0.val60.i281 = load i32, ptr %call16.val66.i280, align 8
  %cmp.i.i.i282 = icmp slt i32 %Term.addr.0.val60.i281, 1
  br i1 %cmp.i.i.i282, label %if.else12.i260, label %if.then.i227

if.end25.i243:                                    ; preds = %if.else12.i260, %if.else.i233
  %stack_POINTER.promoted104.i244 = phi i32 [ %stack_POINTER.promoted99.i228, %if.else.i233 ], [ %stack_POINTER.promoted101.i261, %if.else12.i260 ]
  %cmp.i78.not.i245 = icmp eq i32 %stack_POINTER.promoted104.i244, %32
  br i1 %cmp.i78.not.i245, label %if.else68, label %if.else29.i246

if.else29.i246:                                   ; preds = %if.end25.i243
  %dec.i.i247 = add i32 %stack_POINTER.promoted104.i244, -1
  store i32 %dec.i.i247, ptr @stack_POINTER, align 4
  %idxprom.i80.i248 = zext i32 %dec.i.i247 to i64
  %arrayidx.i81.i249 = getelementptr inbounds [10000 x ptr], ptr @stack_STACK, i64 0, i64 %idxprom.i80.i248
  %37 = load ptr, ptr %arrayidx.i81.i249, align 8
  %38 = getelementptr i8, ptr %37, i64 8
  %call30.val65.i250 = load ptr, ptr %38, align 8
  %sub.i.i251 = add i32 %stack_POINTER.promoted104.i244, -2
  %idxprom.i82.i252 = zext i32 %sub.i.i251 to i64
  %arrayidx.i83.i253 = getelementptr inbounds [10000 x ptr], ptr @stack_STACK, i64 0, i64 %idxprom.i82.i252
  %39 = load ptr, ptr %arrayidx.i83.i253, align 8
  %call30.val63.i254 = load ptr, ptr %37, align 8
  %cmp.i84.not.i255 = icmp eq ptr %call30.val63.i254, null
  br i1 %cmp.i84.not.i255, label %if.then36.i257, label %if.else38.i256

if.then36.i257:                                   ; preds = %if.else29.i246
  store i32 %sub.i.i251, ptr @stack_POINTER, align 4
  br label %for.cond.outer.backedge.i239

if.else38.i256:                                   ; preds = %if.else29.i246
  store i32 %stack_POINTER.promoted104.i244, ptr @stack_POINTER, align 4
  store ptr %call30.val63.i254, ptr %arrayidx.i81.i249, align 8
  br label %for.cond.outer.backedge.i239

unify_OccurCheck.exit283:                         ; preds = %if.then.i227
  store i32 %32, ptr @stack_POINTER, align 4
  br label %return

if.else68:                                        ; preds = %if.end25.i243
...
for.body:                                         ; preds = %if.then77, %for.inc
  %ArgR.0331.in = phi ptr [ %44, %if.then77 ], [ %ArgR.0331, %for.inc ]
  %ArgL.0330 = phi ptr [ %TermL.addr.2.val171, %if.then77 ], [ %ArgL.0.val, %for.inc ]
  %ArgR.0331 = load ptr, ptr %ArgR.0331.in, align 8
  %45 = getelementptr i8, ptr %ArgL.0330, i64 8
  %ArgL.0.val173 = load ptr, ptr %45, align 8
  %46 = getelementptr i8, ptr %ArgR.0331, i64 8
  %ArgR.0.val172 = load ptr, ptr %46, align 8
  %call84 = tail call i32 @unify_UnifyAllOC(ptr noundef %IndexContext, ptr noundef %CtL.addr.0.lcssa, ptr noundef %ArgL.0.val173, ptr noundef %CtR.addr.0.lcssa, ptr noundef %ArgR.0.val172), !range !12
  %tobool85.not = icmp eq i32 %call84, 0
  br i1 %tobool85.not, label %return, label %for.inc

for.inc:                                          ; preds = %for.body
  %ArgL.0.val = load ptr, ptr %ArgL.0330, align 8
  %cmp.i294.not = icmp eq ptr %ArgL.0.val, null
  br i1 %cmp.i294.not, label %return, label %for.body, !llvm.loop !13

return:                                           ; preds = %for.inc, %for.body, %if.then29, %if.then74, %unify_OccurCheck.exit283, %unify_OccurCheck.exit, %if.else71, %if.then43, %if.else46, %if.then35, %if.else68, %if.else57
  %retval.1 = phi i32 [ 1, %if.else57 ], [ 1, %if.else68 ], [ 1, %if.then35 ], [ 1, %if.else46 ], [ 1, %if.then43 ], [ 0, %unify_OccurCheck.exit ], [ 0, %unify_OccurCheck.exit283 ], [ 0, %if.else71 ], [ 1, %if.then74 ], [ 1, %if.then29 ], [ 1, %for.inc ], [ 0, %for.body ]
  ret i32 %retval.1
}
...
for.body:                                         ; preds = %if.then17, %for.inc
  %ArgR.065.in = phi ptr [ %6, %if.then17 ], [ %ArgR.065, %for.inc ]
  %ArgL.064 = phi ptr [ %TermL.val51, %if.then17 ], [ %ArgL.0.val, %for.inc ]
  %ArgR.065 = load ptr, ptr %ArgR.065.in, align 8
  %7 = getelementptr i8, ptr %ArgL.064, i64 8
  %ArgL.0.val53 = load ptr, ptr %7, align 8
  %8 = getelementptr i8, ptr %ArgR.065, i64 8
...
for.inc:                                          ; preds = %for.body
  %ArgL.0.val = load ptr, ptr %ArgL.064, align 8
  %cmp.i60.not = icmp eq ptr %ArgL.0.val, null
  br i1 %cmp.i60.not, label %return, label %for.body, !llvm.loop !14

return:                                           ; preds = %for.inc, %for.body, %if.then14, %if.else11, %if.else, %if.then4
  %retval.1 = phi i32 [ %call7, %if.then4 ], [ 1, %if.else ], [ 0, %if.else11 ], [ 1, %if.then14 ], [ 1, %for.inc ], [ 0, %for.body ]
  ret i32 %retval.1
}
...
for.body:                                         ; preds = %if.then18, %for.inc
  %ArgR.073.in = phi ptr [ %ArgR.073, %for.inc ], [ %6, %if.then18 ]
  %ArgL.072 = phi ptr [ %ArgL.0.val, %for.inc ], [ %TermL.val59, %if.then18 ]
  %ArgR.073 = load ptr, ptr %ArgR.073.in, align 8
  %7 = getelementptr i8, ptr %ArgL.072, i64 8
  %ArgL.0.val61 = load ptr, ptr %7, align 8
  %8 = getelementptr i8, ptr %ArgR.073, i64 8
...
for.inc:                                          ; preds = %for.body
  %ArgL.0.val = load ptr, ptr %ArgL.072, align 8
  %cmp.i68.not = icmp eq ptr %ArgL.0.val, null
  br i1 %cmp.i68.not, label %return, label %for.body, !llvm.loop !15

return:                                           ; preds = %for.inc, %for.body, %if.then18, %if.else11, %land.lhs.true, %if.else, %if.then4
  %retval.1 = phi i32 [ %call7, %if.then4 ], [ 1, %if.else ], [ 0, %land.lhs.true ], [ 0, %if.else11 ], [ 1, %if.then18 ], [ 1, %for.inc ], [ 0, %for.body ]
  ret i32 %retval.1
}
...
for.body:                                         ; preds = %if.then35, %for.inc
  %ArgR.0131.in = phi ptr [ %11, %if.then35 ], [ %ArgR.0131, %for.inc ]
  %ArgL.0130 = phi ptr [ %TermL.val92, %if.then35 ], [ %ArgL.0.val, %for.inc ]
  %ArgR.0131 = load ptr, ptr %ArgR.0131.in, align 8
  %12 = getelementptr i8, ptr %ArgL.0130, i64 8
  %ArgL.0.val94 = load ptr, ptr %12, align 8
  %13 = getelementptr i8, ptr %ArgR.0131, i64 8
...
for.inc:                                          ; preds = %for.body
  %ArgL.0.val = load ptr, ptr %ArgL.0130, align 8
  %cmp.i112.not = icmp eq ptr %ArgL.0.val, null
  br i1 %cmp.i112.not, label %return, label %for.body, !llvm.loop !17

return:                                           ; preds = %for.inc, %for.body, %if.then32, %if.else29, %if.else26, %if.then20
  %retval.1 = phi i32 [ %call25, %if.then20 ], [ 1, %if.else26 ], [ 0, %if.else29 ], [ 1, %if.then32 ], [ 1, %for.inc ], [ 0, %for.body ]
  ret i32 %retval.1
}
...
if.then16:                                        ; preds = %while.end
  ...
  %or.cond186 = and i1 %cmp18, %cmp.i.i140.not
  br i1 %or.cond186, label %return, label %if.else22
...
for.body:                                         ; preds = %if.then59, %for.inc
  %ArgR.0183.in = phi ptr [ %14, %if.then59 ], [ %ArgR.0183, %for.inc ]
  %ArgL.0182 = phi ptr [ %TermL.val127, %if.then59 ], [ %ArgL.0.val, %for.inc ]
  %ArgR.0183 = load ptr, ptr %ArgR.0183.in, align 8
  %15 = getelementptr i8, ptr %ArgL.0182, i64 8
  %ArgL.0.val129 = load ptr, ptr %15, align 8
  %16 = getelementptr i8, ptr %ArgR.0183, i64 8
  %ArgR.0.val128 = load ptr, ptr %16, align 8
  %call66 = tail call i32 @unify_MatchReverse(ptr noundef %IndexContext, ptr noundef %ArgL.0.val129, ptr noundef %CtR.addr.3, ptr noundef %ArgR.0.val128), !range !12
  %tobool67.not = icmp eq i32 %call66, 0
  br i1 %tobool67.not, label %return, label %for.inc

for.inc:                                          ; preds = %for.body
  %ArgL.0.val = load ptr, ptr %ArgL.0182, align 8
  %cmp.i164.not = icmp eq ptr %ArgL.0.val, null
  br i1 %cmp.i164.not, label %return, label %for.body, !llvm.loop !18
...
return.sink.split:                                ; preds = %land.lhs.true31, %if.else22, %if.then48
  ...
  %.sink189 = phi ptr [ %12, %if.then48 ], [ %CtR.addr.3, %if.else22 ], [ %5, %land.lhs.true31 ]
  ...
  store ptr %.sink189, ptr %context.i.i.i157, align 8
...
return:                                           ; preds = %for.inc, %for.body, %return.sink.split, %if.then16, %if.then56, %if.else53, %if.then43, %if.else28, %land.lhs.true31
  %retval.1 = phi i32 [ 0, %land.lhs.true31 ], [ 0, %if.else28 ], [ 0, %if.then43 ], [ 0, %if.else53 ], [ 1, %if.then56 ], [ 1, %if.then16 ], [ 1, %return.sink.split ], [ 1, %for.inc ], [ 0, %for.body ]
  ret i32 %retval.1
}
...
for.body:                                         ; preds = %if.then24, %for.inc
  %ArgR.081.in = phi ptr [ %7, %if.then24 ], [ %ArgR.081, %for.inc ]
  %ArgL.080 = phi ptr [ %TermL.val62, %if.then24 ], [ %ArgL.0.val, %for.inc ]
  %ArgR.081 = load ptr, ptr %ArgR.081.in, align 8
  %8 = getelementptr i8, ptr %ArgL.080, i64 8
  %ArgL.0.val64 = load ptr, ptr %8, align 8
  %9 = getelementptr i8, ptr %ArgR.081, i64 8
...
for.inc:                                          ; preds = %for.body
  %ArgL.0.val = load ptr, ptr %ArgL.080, align 8
  %cmp.i76.not = icmp eq ptr %ArgL.0.val, null
  br i1 %cmp.i76.not, label %return, label %for.body, !llvm.loop !19

return:                                           ; preds = %for.inc, %for.body, %if.then21, %if.else18, %if.else, %if.then, %if.else14, %if.then10
  %retval.1 = phi i32 [ %call13, %if.then10 ], [ 1, %if.else14 ], [ 1, %if.then ], [ 0, %if.else ], [ 0, %if.else18 ], [ 1, %if.then21 ], [ 1, %for.inc ], [ 0, %for.body ]
  ret i32 %retval.1
}
...
if.else22:                                        ; preds = %if.else
  ...
  br i1 %cmp.i.not.i59, label %if.end14.sink.split.i, label %for.cond.preheader.i
...
if.else7.i:                                       ; preds = %for.cond.i60
  ...
  br i1 %12, label %if.end14.sink.split.i, label %for.cond.i60
...
cont_NextIndexVariable.exit:                      ; preds = %for.cond.i60, %if.end14.sink.split.i
  %13 = phi i32 [ %inc.i19.sink23.i, %if.end14.sink.split.i ], [ %10, %for.cond.i60 ]
