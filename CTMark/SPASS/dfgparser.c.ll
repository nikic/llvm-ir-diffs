; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/dfgparser.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/dfgparser.c"
...
if.end:                                           ; preds = %if.then
  ...
  %div1518 = lshr i64 %add17, 3
  %add.ptr18 = getelementptr inbounds %union.yyalloc, ptr %2, i64 %div1518
  %mul21 = shl i64 %add, 3
...
symbol_IsPredicate.exit40.i:                      ; preds = %if.end.i
  %sub.i.i36.i = sub nsw i32 0, %call1.i
  %and.i.i37.i = and i32 %1, %sub.i.i36.i
  %cmp.i38.not.i = icmp eq i32 %and.i.i37.i, 2
  br i1 %cmp.i38.not.i, label %if.end8.i, label %if.then6.i
...
sw.bb178:                                         ; preds = %yyreduce
  ...
  br i1 %cmp.i.not.i1537, label %list_Nconc.exit1546, label %for.cond.i1540

for.cond.i1540:                                   ; preds = %sw.bb178, %for.cond.i1540
  %List1.addr.0.i1541 = phi ptr [ %List1.addr.0.val17.i1542, %for.cond.i1540 ], [ %68, %sw.bb178 ]
  %List1.addr.0.val17.i1542 = load ptr, ptr %List1.addr.0.i1541, align 8
  %cmp.i20.not.i1543 = icmp eq ptr %List1.addr.0.val17.i1542, null
  br i1 %cmp.i20.not.i1543, label %for.end.i1544, label %for.cond.i1540

for.end.i1544:                                    ; preds = %for.cond.i1540
  store ptr %call.i.i1535, ptr %List1.addr.0.i1541, align 8
...
sw.bb186:                                         ; preds = %yyreduce
  ...
  br i1 %tobool.not.i.i1547, label %if.then.i1552, label %symbol_IsPredicate.exit.i1548

symbol_IsPredicate.exit.i1548:                    ; preds = %sw.bb186
  %sub.i.i.i1549 = sub nsw i32 0, %call188
  %and.i.i.i1550 = and i32 %1, %sub.i.i.i1549
  %cmp.i.not.i1551 = icmp eq i32 %and.i.i.i1550, 2
  br i1 %cmp.i.not.i1551, label %if.end.i1557, label %if.then.i1552

if.then.i1552:                                    ; preds = %symbol_IsPredicate.exit.i1548, %sw.bb186
  %72 = load ptr, ptr @stdout, align 8
  %call1.i1553 = call i32 @fflush(ptr noundef %72)
  ...
  %call.i.i1554 = call i32 @fflush(ptr noundef %74)
  %75 = load ptr, ptr @stdout, align 8
  %call1.i.i1555 = call i32 @fflush(ptr noundef %75)
  %76 = load ptr, ptr @stderr, align 8
  %call2.i.i1556 = call i32 @fflush(ptr noundef %76)
  call void @exit(i32 noundef 1) #15
  unreachable

if.end.i1557:                                     ; preds = %symbol_IsPredicate.exit.i1548
  %shr.i.i.i = lshr i32 %sub.i.i.i1549, %0
...
symbol_RemoveProperty.exit.i:                     ; preds = %if.then.i.i, %if.end.i1557
  ...
  br i1 %tobool.not.i52.i, label %symbol_RemoveProperty.exit55.i, label %if.then.i53.i

if.then.i53.i:                                    ; preds = %symbol_RemoveProperty.exit.i
  %props.i50.i = getelementptr inbounds %struct.signature, ptr %81, i64 0, i32 4
  %sub.i54.i = add i32 %80, -256
  store i32 %sub.i54.i, ptr %props.i50.i, align 4
  %.pre122.i = load ptr, ptr %arrayidx.i.i.i, align 8
  br label %symbol_RemoveProperty.exit55.i

symbol_RemoveProperty.exit55.i:                   ; preds = %if.then.i53.i, %symbol_RemoveProperty.exit.i
  %82 = phi ptr [ %81, %symbol_RemoveProperty.exit.i ], [ %.pre122.i, %if.then.i53.i ]
...
while.body.i.i:                                   ; preds = %symbol_RemoveProperty.exit55.i, %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i1561, label %list_Delete.exit.loopexit.i, label %while.body.i.i
...
if.else.us.i:                                     ; preds = %for.body.us.i
  ...
  br i1 %tobool.not.i76.us.i, label %if.then15.i, label %land.rhs.i77.us.i

land.rhs.i77.us.i:                                ; preds = %if.else.us.i
  %sub.i.i78.us.i = sub nsw i32 0, %call9.us.i
  %and.i.i79.us.i = and i32 %1, %sub.i.i78.us.i
  %switch.us.i = icmp ult i32 %and.i.i79.us.i, 2
  br i1 %switch.us.i, label %if.end18.us.i, label %if.then15.i

if.end18.us.i:                                    ; preds = %land.rhs.i77.us.i
  ...
  %shr.i.i87.us.i = lshr i32 %sub.i.i78.us.i, %0
  ...
  br i1 %cmp.i71.not.us.i, label %dfg_SymbolGenerated.exit, label %for.body.us.i
...
if.then10.i:                                      ; preds = %for.body.i, %for.body.us.i
  ...
  %call11.i1564 = call i32 @fflush(ptr noundef %100)
...
if.else.i:                                        ; preds = %for.body.i
  ...
  br i1 %tobool.not.i76.i, label %if.then15.i, label %land.rhs.i77.i

land.rhs.i77.i:                                   ; preds = %if.else.i
  %sub.i.i78.i = sub nsw i32 0, %call9.i
  %and.i.i79.i = and i32 %1, %sub.i.i78.i
  %switch.i = icmp ult i32 %and.i.i79.i, 2
  br i1 %switch.i, label %if.end18.i, label %if.then15.i

if.then15.i:                                      ; preds = %land.rhs.i77.i, %if.else.i, %land.rhs.i77.us.i, %if.else.us.i
  %105 = load ptr, ptr @stdout, align 8
  %call16.i1562 = call i32 @fflush(ptr noundef %105)
...
if.end18.i:                                       ; preds = %land.rhs.i77.i
  ...
  %shr.i.i87.i = lshr i32 %sub.i.i78.i, %0
  ...
  br i1 %cmp.i71.not.i, label %dfg_SymbolGenerated.exit, label %for.body.i
...
if.then209:                                       ; preds = %sw.bb204
  ...
  br i1 %cmp.i.not.i1568, label %list_Nconc.exit1577, label %if.end.i1569

if.end.i1569:                                     ; preds = %if.then209
  %cmp.i18.not.i1570 = icmp eq ptr %125, null
  br i1 %cmp.i18.not.i1570, label %list_Nconc.exit1577, label %for.cond.i1571

for.cond.i1571:                                   ; preds = %if.end.i1569, %for.cond.i1571
  %List1.addr.0.i1572 = phi ptr [ %List1.addr.0.val17.i1573, %for.cond.i1571 ], [ %126, %if.end.i1569 ]
  %List1.addr.0.val17.i1573 = load ptr, ptr %List1.addr.0.i1572, align 8
  %cmp.i20.not.i1574 = icmp eq ptr %List1.addr.0.val17.i1573, null
  br i1 %cmp.i20.not.i1574, label %for.end.i1575, label %for.cond.i1571

for.end.i1575:                                    ; preds = %for.cond.i1571
  store ptr %125, ptr %List1.addr.0.i1572, align 8
  br label %list_Nconc.exit1577

list_Nconc.exit1577:                              ; preds = %if.then209, %if.end.i1569, %for.end.i1575
  %retval.0.i1576 = phi ptr [ %126, %for.end.i1575 ], [ %125, %if.then209 ], [ %126, %if.end.i1569 ]
...
if.else212:                                       ; preds = %sw.bb204
  ...
  br i1 %cmp.i.not.i1578, label %list_Nconc.exit1587, label %if.end.i1579

if.end.i1579:                                     ; preds = %if.else212
  %cmp.i18.not.i1580 = icmp eq ptr %125, null
  br i1 %cmp.i18.not.i1580, label %list_Nconc.exit1587, label %for.cond.i1581

for.cond.i1581:                                   ; preds = %if.end.i1579, %for.cond.i1581
  %List1.addr.0.i1582 = phi ptr [ %List1.addr.0.val17.i1583, %for.cond.i1581 ], [ %127, %if.end.i1579 ]
  %List1.addr.0.val17.i1583 = load ptr, ptr %List1.addr.0.i1582, align 8
  %cmp.i20.not.i1584 = icmp eq ptr %List1.addr.0.val17.i1583, null
  br i1 %cmp.i20.not.i1584, label %for.end.i1585, label %for.cond.i1581

for.end.i1585:                                    ; preds = %for.cond.i1581
  store ptr %125, ptr %List1.addr.0.i1582, align 8
  br label %list_Nconc.exit1587

list_Nconc.exit1587:                              ; preds = %if.else212, %if.end.i1579, %for.end.i1585
  %retval.0.i1586 = phi ptr [ %127, %for.end.i1585 ], [ %125, %if.else212 ], [ %127, %if.end.i1579 ]
...
if.end238:                                        ; preds = %if.else232, %if.end230
  %storemerge1519 = phi ptr [ %call.i1590, %if.else232 ], [ %130, %if.end230 ]
  store ptr %storemerge1519, ptr %yyval, align 8
  call fastcc void @dfg_VarCheck()
  br label %sw.epilog929
...
cond.false303:                                    ; preds = %sw.bb299
  ...
  br i1 %cmp.i.not.i1609, label %cond.end308, label %for.cond.i1612

for.cond.i1612:                                   ; preds = %cond.false303, %for.cond.i1612
  %List1.addr.0.i1613 = phi ptr [ %List1.addr.0.val17.i1614, %for.cond.i1612 ], [ %161, %cond.false303 ]
  %List1.addr.0.val17.i1614 = load ptr, ptr %List1.addr.0.i1613, align 8
  %cmp.i20.not.i1615 = icmp eq ptr %List1.addr.0.val17.i1614, null
  br i1 %cmp.i20.not.i1615, label %for.end.i1616, label %for.cond.i1612

for.end.i1616:                                    ; preds = %for.cond.i1612
  store ptr %call.i.i1607, ptr %List1.addr.0.i1613, align 8
...
cond.false373:                                    ; preds = %sw.bb369
  ...
  br i1 %cmp.i.not.i1623, label %cond.end378, label %for.cond.i1626

for.cond.i1626:                                   ; preds = %cond.false373, %for.cond.i1626
  %List1.addr.0.i1627 = phi ptr [ %List1.addr.0.val17.i1628, %for.cond.i1626 ], [ %180, %cond.false373 ]
  %List1.addr.0.val17.i1628 = load ptr, ptr %List1.addr.0.i1627, align 8
  %cmp.i20.not.i1629 = icmp eq ptr %List1.addr.0.val17.i1628, null
  br i1 %cmp.i20.not.i1629, label %for.end.i1630, label %for.cond.i1626

for.end.i1630:                                    ; preds = %for.cond.i1626
  store ptr %call.i.i1621, ptr %List1.addr.0.i1627, align 8
...
if.then420:                                       ; preds = %sw.bb415
  ...
  br i1 %cmp.i.not.i1642, label %list_Nconc.exit1651, label %if.end.i1643

if.end.i1643:                                     ; preds = %if.then420
  %cmp.i18.not.i1644 = icmp eq ptr %195, null
  br i1 %cmp.i18.not.i1644, label %list_Nconc.exit1651, label %for.cond.i1645

for.cond.i1645:                                   ; preds = %if.end.i1643, %for.cond.i1645
  %List1.addr.0.i1646 = phi ptr [ %List1.addr.0.val17.i1647, %for.cond.i1645 ], [ %196, %if.end.i1643 ]
  %List1.addr.0.val17.i1647 = load ptr, ptr %List1.addr.0.i1646, align 8
  %cmp.i20.not.i1648 = icmp eq ptr %List1.addr.0.val17.i1647, null
  br i1 %cmp.i20.not.i1648, label %for.end.i1649, label %for.cond.i1645

for.end.i1649:                                    ; preds = %for.cond.i1645
  store ptr %195, ptr %List1.addr.0.i1646, align 8
  br label %list_Nconc.exit1651

list_Nconc.exit1651:                              ; preds = %if.then420, %if.end.i1643, %for.end.i1649
  %retval.0.i1650 = phi ptr [ %196, %for.end.i1649 ], [ %195, %if.then420 ], [ %196, %if.end.i1643 ]
...
if.else423:                                       ; preds = %sw.bb415
  ...
  br i1 %cmp.i.not.i1652, label %list_Nconc.exit1661, label %if.end.i1653

if.end.i1653:                                     ; preds = %if.else423
  %cmp.i18.not.i1654 = icmp eq ptr %195, null
  br i1 %cmp.i18.not.i1654, label %list_Nconc.exit1661, label %for.cond.i1655

for.cond.i1655:                                   ; preds = %if.end.i1653, %for.cond.i1655
  %List1.addr.0.i1656 = phi ptr [ %List1.addr.0.val17.i1657, %for.cond.i1655 ], [ %197, %if.end.i1653 ]
  %List1.addr.0.val17.i1657 = load ptr, ptr %List1.addr.0.i1656, align 8
  %cmp.i20.not.i1658 = icmp eq ptr %List1.addr.0.val17.i1657, null
  br i1 %cmp.i20.not.i1658, label %for.end.i1659, label %for.cond.i1655

for.end.i1659:                                    ; preds = %for.cond.i1655
  store ptr %195, ptr %List1.addr.0.i1656, align 8
  br label %list_Nconc.exit1661

list_Nconc.exit1661:                              ; preds = %if.else423, %if.end.i1653, %for.end.i1659
  %retval.0.i1660 = phi ptr [ %197, %for.end.i1659 ], [ %195, %if.else423 ], [ %197, %if.end.i1653 ]
...
cond.false492:                                    ; preds = %sw.bb488
  ...
  br i1 %cmp.i.not.i1679, label %cond.end497, label %for.cond.i1682

for.cond.i1682:                                   ; preds = %cond.false492, %for.cond.i1682
  %List1.addr.0.i1683 = phi ptr [ %List1.addr.0.val17.i1684, %for.cond.i1682 ], [ %230, %cond.false492 ]
  %List1.addr.0.val17.i1684 = load ptr, ptr %List1.addr.0.i1683, align 8
  %cmp.i20.not.i1685 = icmp eq ptr %List1.addr.0.val17.i1684, null
  br i1 %cmp.i20.not.i1685, label %for.end.i1686, label %for.cond.i1682

for.end.i1686:                                    ; preds = %for.cond.i1682
  store ptr %call.i.i1677, ptr %List1.addr.0.i1683, align 8
...
sw.bb515:                                         ; preds = %yyreduce
  ...
  br i1 %cmp.i.not.i1695, label %list_Nconc.exit1704, label %for.cond.i1698

for.cond.i1698:                                   ; preds = %sw.bb515, %for.cond.i1698
  %List1.addr.0.i1699 = phi ptr [ %List1.addr.0.val17.i1700, %for.cond.i1698 ], [ %238, %sw.bb515 ]
  %List1.addr.0.val17.i1700 = load ptr, ptr %List1.addr.0.i1699, align 8
  %cmp.i20.not.i1701 = icmp eq ptr %List1.addr.0.val17.i1700, null
  br i1 %cmp.i20.not.i1701, label %for.end.i1702, label %for.cond.i1698

for.end.i1702:                                    ; preds = %for.cond.i1698
  store ptr %call.i.i1693, ptr %List1.addr.0.i1699, align 8
...
cond.false599:                                    ; preds = %sw.bb595
  ...
  br i1 %cmp.i.not.i1713, label %cond.end604, label %for.cond.i1716

for.cond.i1716:                                   ; preds = %cond.false599, %for.cond.i1716
  %List1.addr.0.i1717 = phi ptr [ %List1.addr.0.val17.i1718, %for.cond.i1716 ], [ %261, %cond.false599 ]
  %List1.addr.0.val17.i1718 = load ptr, ptr %List1.addr.0.i1717, align 8
  %cmp.i20.not.i1719 = icmp eq ptr %List1.addr.0.val17.i1718, null
  br i1 %cmp.i20.not.i1719, label %for.end.i1720, label %for.cond.i1716

for.end.i1720:                                    ; preds = %for.cond.i1716
  store ptr %call.i.i1711, ptr %List1.addr.0.i1717, align 8
...
cond.false692:                                    ; preds = %lor.lhs.false686
  ...
  br i1 %cmp.i.not.i1753, label %cond.end697, label %for.cond.i1756

for.cond.i1756:                                   ; preds = %cond.false692, %for.cond.i1756
  %List1.addr.0.i1757 = phi ptr [ %List1.addr.0.val17.i1758, %for.cond.i1756 ], [ %294, %cond.false692 ]
  %List1.addr.0.val17.i1758 = load ptr, ptr %List1.addr.0.i1757, align 8
  %cmp.i20.not.i1759 = icmp eq ptr %List1.addr.0.val17.i1758, null
  br i1 %cmp.i20.not.i1759, label %for.end.i1760, label %for.cond.i1756

for.end.i1760:                                    ; preds = %for.cond.i1756
  store ptr %call.i.i1751, ptr %List1.addr.0.i1757, align 8
  br label %cond.end697
...
sw.bb799:                                         ; preds = %yyreduce
  ...
  br i1 %cmp.i.not.i1784, label %list_Nconc.exit1793, label %for.cond.i1787

for.cond.i1787:                                   ; preds = %sw.bb799, %for.cond.i1787
  %List1.addr.0.i1788 = phi ptr [ %List1.addr.0.val17.i1789, %for.cond.i1787 ], [ %327, %sw.bb799 ]
  %List1.addr.0.val17.i1789 = load ptr, ptr %List1.addr.0.i1788, align 8
  %cmp.i20.not.i1790 = icmp eq ptr %List1.addr.0.val17.i1789, null
  br i1 %cmp.i20.not.i1790, label %for.end.i1791, label %for.cond.i1787

for.end.i1791:                                    ; preds = %for.cond.i1787
  store ptr %call.i.i1782, ptr %List1.addr.0.i1788, align 8
...
if.end827:                                        ; preds = %for.body.split
  %sub.i.i1801 = sub nsw i32 0, %call820
  %and.i.i1802 = and i32 %1, %sub.i.i1801
  %cmp.i1803.not = icmp eq i32 %and.i.i1802, 2
  br i1 %cmp.i1803.not, label %if.end834, label %if.then830
...
if.end834:                                        ; preds = %if.end827
  ...
  %shr.i.i = lshr i32 %sub.i.i1801, %0
  ...
  br i1 %cmp.i1797.not, label %sw.epilog929, label %for.body
...
if.then.i.i1819:                                  ; preds = %if.end848
  ...
  %call1.i.i1820 = call i32 @fflush(ptr noundef %365)
  %call2.i.i1821 = call ptr @flag_Name(i32 noundef %call842) #14
  call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.42, i32 noundef %364, ptr noundef %call2.i.i1821) #14
  %366 = load ptr, ptr @stderr, align 8
  %call.i.i.i1822 = call i32 @fflush(ptr noundef %366)
...
sw.bb924:                                         ; preds = %yyreduce
  ...
  br i1 %cmp.i.not.i1867, label %list_Nconc.exit1876, label %for.cond.i1870

for.cond.i1870:                                   ; preds = %sw.bb924, %for.cond.i1870
  %List1.addr.0.i1871 = phi ptr [ %List1.addr.0.val17.i1872, %for.cond.i1870 ], [ %410, %sw.bb924 ]
  %List1.addr.0.val17.i1872 = load ptr, ptr %List1.addr.0.i1871, align 8
  %cmp.i20.not.i1873 = icmp eq ptr %List1.addr.0.val17.i1872, null
  br i1 %cmp.i20.not.i1873, label %for.end.i1874, label %for.cond.i1870

for.end.i1874:                                    ; preds = %for.cond.i1870
  store ptr %call.i.i1865, ptr %List1.addr.0.i1871, align 8
...
for.inc1015:                                      ; preds = %for.body997, %if.then1007
  ...
  br i1 %cmp995, label %for.body997, label %for.end1017.loopexit

for.end1017.loopexit:                             ; preds = %for.inc1015
  %429 = add i64 %yysize977.1, 25
  %430 = icmp slt i32 %yycount.1, 5
  br label %for.end1017

for.end1017:                                      ; preds = %for.end1017.loopexit, %cond.end985
  %yysize977.0.lcssa = phi i64 [ 25, %cond.end985 ], [ %429, %for.end1017.loopexit ]
  %yycount.0.lcssa = phi i1 [ true, %cond.end985 ], [ %430, %for.end1017.loopexit ]
  %arrayidx1020 = getelementptr inbounds [172 x ptr], ptr @yytname, i64 0, i64 %cond986
  %431 = load ptr, ptr %arrayidx1020, align 8
  %call1021 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %431) #16
  %add1022 = add i64 %yysize977.0.lcssa, %call1021
  %432 = alloca i8, i64 %add1022, align 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(25) %432, ptr noundef nonnull align 1 dereferenceable(25) @.str.16, i64 25, i1 false)
  %scevgep = getelementptr i8, ptr %432, i64 24
  br label %while.cond.i1877

while.cond.i1877:                                 ; preds = %for.end1017, %while.cond.i1877
  %yyd.0.i1878 = phi ptr [ %incdec.ptr1.i1881, %while.cond.i1877 ], [ %scevgep, %for.end1017 ]
  %yys.0.i1879 = phi ptr [ %incdec.ptr.i1880, %while.cond.i1877 ], [ %431, %for.end1017 ]
  %incdec.ptr.i1880 = getelementptr inbounds i8, ptr %yys.0.i1879, i64 1
  %433 = load i8, ptr %yys.0.i1879, align 1
  %incdec.ptr1.i1881 = getelementptr inbounds i8, ptr %yyd.0.i1878, i64 1
  store i8 %433, ptr %yyd.0.i1878, align 1
  %cmp.not.i1882 = icmp eq i8 %433, 0
  br i1 %cmp.not.i1882, label %yystpcpy.exit1883, label %while.cond.i1877

yystpcpy.exit1883:                                ; preds = %while.cond.i1877
  %or.cond2076 = and i1 %yycount.0.lcssa, %cmp9952067
  br i1 %or.cond2076, label %for.body1043.preheader, label %if.end1066

for.body1043.preheader:                           ; preds = %yystpcpy.exit1883
  %434 = sext i32 %cond993 to i64
  %435 = sext i16 %3 to i64
  br label %for.body1043

for.body1043:                                     ; preds = %for.body1043.preheader, %for.inc1063
  %indvars.iv2215 = phi i64 [ %434, %for.body1043.preheader ], [ %indvars.iv.next2216, %for.inc1063 ]
  %yyp.02075 = phi ptr [ %yyd.0.i1878, %for.body1043.preheader ], [ %yyp.1, %for.inc1063 ]
  %yycount.22074 = phi i32 [ 0, %for.body1043.preheader ], [ %yycount.3, %for.inc1063 ]
  %436 = add nsw i64 %indvars.iv2215, %435
  %arrayidx1046 = getelementptr inbounds [507 x i16], ptr @yycheck, i64 0, i64 %436
  %437 = load i16, ptr %arrayidx1046, align 2
  %conv1047 = sext i16 %437 to i32
  %438 = trunc i64 %indvars.iv2215 to i32
  %cmp1048 = icmp eq i32 %438, %conv1047
  %439 = icmp ne i64 %indvars.iv2215, 1
  %or.cond1165 = and i1 %439, %cmp1048
...
if.then1053:                                      ; preds = %for.body1043
  ...
  br label %while.cond.i1884

while.cond.i1884:                                 ; preds = %while.cond.i1884, %if.then1053
  %yyd.0.i1885 = phi ptr [ %yyp.02075, %if.then1053 ], [ %incdec.ptr1.i1888, %while.cond.i1884 ]
  %yys.0.i1886 = phi ptr [ %cond1056, %if.then1053 ], [ %incdec.ptr.i1887, %while.cond.i1884 ]
  %incdec.ptr.i1887 = getelementptr inbounds i8, ptr %yys.0.i1886, i64 1
  %440 = load i8, ptr %yys.0.i1886, align 1
  %incdec.ptr1.i1888 = getelementptr inbounds i8, ptr %yyd.0.i1885, i64 1
  store i8 %440, ptr %yyd.0.i1885, align 1
  %cmp.not.i1889 = icmp eq i8 %440, 0
  br i1 %cmp.not.i1889, label %yystpcpy.exit1890, label %while.cond.i1884

yystpcpy.exit1890:                                ; preds = %while.cond.i1884
  %arrayidx1059 = getelementptr inbounds [172 x ptr], ptr @yytname, i64 0, i64 %indvars.iv2215
  %441 = load ptr, ptr %arrayidx1059, align 8
  br label %while.cond.i1891

while.cond.i1891:                                 ; preds = %while.cond.i1891, %yystpcpy.exit1890
  %yyd.0.i1892 = phi ptr [ %yyd.0.i1885, %yystpcpy.exit1890 ], [ %incdec.ptr1.i1895, %while.cond.i1891 ]
  %yys.0.i1893 = phi ptr [ %441, %yystpcpy.exit1890 ], [ %incdec.ptr.i1894, %while.cond.i1891 ]
  %incdec.ptr.i1894 = getelementptr inbounds i8, ptr %yys.0.i1893, i64 1
  %442 = load i8, ptr %yys.0.i1893, align 1
  %incdec.ptr1.i1895 = getelementptr inbounds i8, ptr %yyd.0.i1892, i64 1
  store i8 %442, ptr %yyd.0.i1892, align 1
  %cmp.not.i1896 = icmp eq i8 %442, 0
  br i1 %cmp.not.i1896, label %yystpcpy.exit1897, label %while.cond.i1891

yystpcpy.exit1897:                                ; preds = %while.cond.i1891
...
for.inc1063:                                      ; preds = %for.body1043, %yystpcpy.exit1897
  ...
  %yyp.1 = phi ptr [ %yyd.0.i1892, %yystpcpy.exit1897 ], [ %yyp.02075, %for.body1043 ]
  %indvars.iv.next2216 = add nsw i64 %indvars.iv2215, 1
  %cmp1041 = icmp slt i64 %indvars.iv2215, 171
  br i1 %cmp1041, label %for.body1043, label %if.end1066

if.end1066:                                       ; preds = %for.inc1063, %yystpcpy.exit1883
  %443 = load ptr, ptr @stdout, align 8
  %call.i1898 = call i32 @fflush(ptr noundef %443)
  %444 = load i32, ptr @dfg_LINENUMBER, align 4
  call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.22, i32 noundef %444, ptr noundef nonnull %432) #14
  %445 = load ptr, ptr @stderr, align 8
  %call.i.i1899 = call i32 @fflush(ptr noundef %445)
  %446 = load ptr, ptr @stdout, align 8
  %call1.i.i1900 = call i32 @fflush(ptr noundef %446)
  %447 = load ptr, ptr @stderr, align 8
  %call2.i.i1901 = call i32 @fflush(ptr noundef %447)
  call void @exit(i32 noundef 1) #15
  unreachable

if.else1072:                                      ; preds = %if.then967
  %448 = load ptr, ptr @stdout, align 8
  %call.i1902 = call i32 @fflush(ptr noundef %448)
  %449 = load i32, ptr @dfg_LINENUMBER, align 4
  call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.22, i32 noundef %449, ptr noundef nonnull @.str.20) #14
  %450 = load ptr, ptr @stderr, align 8
  %call.i.i1903 = call i32 @fflush(ptr noundef %450)
  %451 = load ptr, ptr @stdout, align 8
  %call1.i.i1904 = call i32 @fflush(ptr noundef %451)
  %452 = load ptr, ptr @stderr, align 8
  %call2.i.i1905 = call i32 @fflush(ptr noundef %452)
  call void @exit(i32 noundef 1) #15
  unreachable

yyoverflowlab:                                    ; preds = %if.then
  %453 = load ptr, ptr @stdout, align 8
  %call.i1907 = call i32 @fflush(ptr noundef %453)
  %454 = load i32, ptr @dfg_LINENUMBER, align 4
  call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.22, i32 noundef %454, ptr noundef nonnull @.str.21) #14
  %455 = load ptr, ptr @stderr, align 8
  %call.i.i1908 = call i32 @fflush(ptr noundef %455)
  %456 = load ptr, ptr @stdout, align 8
  %call1.i.i1909 = call i32 @fflush(ptr noundef %456)
  %457 = load ptr, ptr @stderr, align 8
  %call2.i.i1910 = call i32 @fflush(ptr noundef %457)
  call void @exit(i32 noundef 1) #15
  unreachable
...
land.lhs.true13:                                  ; preds = %if.then7
  ...
  %.pre128 = load i32, ptr @symbol_TYPEMASK, align 4
...
symbol_IsPredicate.exit:                          ; preds = %land.lhs.true13.symbol_IsPredicate.exit_crit_edge, %lor.lhs.false
  %sub.i.i90.pre-phi = phi i32 [ %.pre129, %land.lhs.true13.symbol_IsPredicate.exit_crit_edge ], [ %sub.i.i, %lor.lhs.false ]
  %8 = phi i32 [ %.pre128, %land.lhs.true13.symbol_IsPredicate.exit_crit_edge ], [ %.pre, %lor.lhs.false ]
  %and.i.i91 = and i32 %8, %sub.i.i90.pre-phi
  %cmp.i92.not = icmp eq i32 %and.i.i91, 2
  br i1 %cmp.i92.not, label %lor.lhs.false16, label %if.then25
...
land.lhs.true22:                                  ; preds = %if.then7, %if.then7
  ...
  %.pre127 = load i32, ptr @symbol_TYPEMASK, align 4
  br i1 %tobool.not.i94, label %if.then25, label %symbol_IsJunctor.exit

symbol_IsJunctor.exit:                            ; preds = %land.lhs.true22
  %.pre130 = sub nsw i32 0, %call4
  %.pre131 = and i32 %.pre127, %.pre130
  %9 = icmp eq i32 %.pre131, 3
  br i1 %9, label %if.end33, label %if.then25
...
if.then25:                                        ; preds = %lor.lhs.false, %lor.lhs.false, %lor.lhs.false16, %lor.lhs.false16, %land.rhs.i, %land.lhs.true22, %land.lhs.true13, %land.lhs.true, %symbol_IsJunctor.exit, %symbol_IsPredicate.exit
  %10 = phi i32 [ %.pre, %land.rhs.i ], [ %.pre127, %land.lhs.true22 ], [ %.pre128, %land.lhs.true13 ], [ %.pre, %land.lhs.true ], [ %.pre127, %symbol_IsJunctor.exit ], [ %8, %symbol_IsPredicate.exit ], [ %.pre, %lor.lhs.false ], [ %.pre, %lor.lhs.false ], [ %8, %lor.lhs.false16 ], [ %8, %lor.lhs.false16 ]
...
sw.bb46:                                          ; preds = %if.else
  %call47 = tail call i32 @symbol_CreatePredicate(ptr noundef %Name, i32 noundef %arity.0, i32 noundef 0, ptr noundef %30) #14
  br label %sw.epilog50

sw.default48:                                     ; preds = %if.else
  %call49 = tail call i32 @symbol_CreateJunctor(ptr noundef %Name, i32 noundef %arity.0, i32 noundef 0, ptr noundef %30) #14
  br label %sw.epilog50
...
if.then53:                                        ; preds = %sw.epilog50
  ...
  %31 = load ptr, ptr @dfg_SYMBOLLIST, align 8
  ...
  store ptr %31, ptr %call.i5.i, align 8
...
if.else:                                          ; preds = %for.body
  ...
  br i1 %cmp.i.not.i145, label %list_Nconc.exit154, label %for.cond.i148

for.cond.i148:                                    ; preds = %if.else, %for.cond.i148
  %List1.addr.0.i149 = phi ptr [ %List1.addr.0.val17.i150, %for.cond.i148 ], [ %varlist.0227, %if.else ]
  %List1.addr.0.val17.i150 = load ptr, ptr %List1.addr.0.i149, align 8
  %cmp.i20.not.i151 = icmp eq ptr %List1.addr.0.val17.i150, null
  br i1 %cmp.i20.not.i151, label %for.end.i152, label %for.cond.i148

for.end.i152:                                     ; preds = %for.cond.i148
  store ptr %call.i.i143, ptr %List1.addr.0.i149, align 8
...
list_Nconc.exit154:                               ; preds = %if.else, %for.end.i152
  ...
  br i1 %cmp.i.not.i157, label %for.inc, label %for.cond.i160

for.cond.i160:                                    ; preds = %list_Nconc.exit154, %for.cond.i160
  %List1.addr.0.i161 = phi ptr [ %List1.addr.0.val17.i162, %for.cond.i160 ], [ %sortlist.0228, %list_Nconc.exit154 ]
...
for.end.i164:                                     ; preds = %for.cond.i160
  store ptr %call.i.i155, ptr %List1.addr.0.i161, align 8
  br label %for.inc
...
for.body21:                                       ; preds = %for.end, %for.body21
  ...
  br i1 %cmp.i167.not, label %for.end27, label %for.body21
...
for.body44:                                       ; preds = %if.then34, %for.body44
  %scan.1233 = phi ptr [ %scan.1.val136, %for.body44 ], [ %sortlist.0.lcssa, %if.then34 ]
  %15 = load i32, ptr @fol_NOT, align 4
  %16 = getelementptr i8, ptr %scan.1233, i64 8
  ...
  %scan.1.val136 = load ptr, ptr %scan.1233, align 8
  %cmp.i175.not = icmp eq ptr %scan.1.val136, null
  br i1 %cmp.i175.not, label %for.end51, label %for.body44

for.end51:                                        ; preds = %for.body44
  %17 = getelementptr i8, ptr %Term, i64 16
  %Term.val142 = load ptr, ptr %17, align 8
  %cmp.i18.not.i182 = icmp eq ptr %Term.val142, null
  br i1 %cmp.i18.not.i182, label %list_Nconc.exit189, label %for.cond.i183

for.cond.i183:                                    ; preds = %for.end51, %for.cond.i183
  %List1.addr.0.i184 = phi ptr [ %List1.addr.0.val17.i185, %for.cond.i183 ], [ %sortlist.0.lcssa, %for.end51 ]
  %List1.addr.0.val17.i185 = load ptr, ptr %List1.addr.0.i184, align 8
  %cmp.i20.not.i186 = icmp eq ptr %List1.addr.0.val17.i185, null
  br i1 %cmp.i20.not.i186, label %for.end.i187, label %for.cond.i183

for.end.i187:                                     ; preds = %for.cond.i183
  store ptr %Term.val142, ptr %List1.addr.0.i184, align 8
  br label %list_Nconc.exit189

list_Nconc.exit189:                               ; preds = %for.end51, %for.end.i187
...
if.then75:                                        ; preds = %if.else71
  ...
  br i1 %cmp.i199.not, label %if.then80, label %if.else83

if.then80:                                        ; preds = %if.then75
  %23 = getelementptr i8, ptr %Term, i64 16
  %Term.val141 = load ptr, ptr %23, align 8
  %cmp.i18.not.i203 = icmp eq ptr %Term.val141, null
  br i1 %cmp.i18.not.i203, label %list_Nconc.exit210, label %for.cond.i204

for.cond.i204:                                    ; preds = %if.then80, %for.cond.i204
  %List1.addr.0.i205 = phi ptr [ %List1.addr.0.val17.i206, %for.cond.i204 ], [ %sortlist.0.lcssa, %if.then80 ]
  %List1.addr.0.val17.i206 = load ptr, ptr %List1.addr.0.i205, align 8
  %cmp.i20.not.i207 = icmp eq ptr %List1.addr.0.val17.i206, null
  br i1 %cmp.i20.not.i207, label %for.end.i208, label %for.cond.i204

for.end.i208:                                     ; preds = %for.cond.i204
  store ptr %Term.val141, ptr %List1.addr.0.i205, align 8
  br label %list_Nconc.exit210

list_Nconc.exit210:                               ; preds = %if.then80, %for.end.i208
...
for.cond.i217:                                    ; preds = %if.else83, %for.cond.i217
  %List1.addr.0.i218 = phi ptr [ %List1.addr.0.val17.i219, %for.cond.i217 ], [ %sortlist.0.lcssa, %if.else83 ]
...
for.end.i221:                                     ; preds = %for.cond.i217
  store ptr %call.i.i212, ptr %List1.addr.0.i218, align 8
  %24 = load i32, ptr @fol_AND, align 4
  %call87 = tail call ptr @term_Create(i32 noundef %24, ptr noundef nonnull %sortlist.0.lcssa) #14
  br label %if.end91

if.end91:                                         ; preds = %if.then58, %if.else62, %list_Nconc.exit189, %list_Nconc.exit210, %for.end.i221, %if.else71, %for.end27
  %Term.addr.0 = phi ptr [ %Term, %for.end27 ], [ %Term, %list_Nconc.exit189 ], [ %call61, %if.then58 ], [ %call68, %if.else62 ], [ %Term, %list_Nconc.exit210 ], [ %call87, %for.end.i221 ], [ %Term, %if.else71 ]
...
while.body.i:                                     ; preds = %while.cond.i
  ...
  br i1 %cmp.not.i, label %if.then.i, label %while.cond.i
...
while.body.i30:                                   ; preds = %if.end16, %while.end.i33
  %scan.063.i = phi ptr [ %scan.0.i34, %while.end.i33 ], [ %scan.061.i, %if.end16 ]
...
land.rhs9.i:                                      ; preds = %while.cond6.i
  ...
  br i1 %cmp.i53.not.i, label %if.then.i32, label %while.cond6.i

while.end.i33:                                    ; preds = %while.cond6.i
  %scan.0.i34 = load ptr, ptr %scan.063.i, align 8
  %cmp.i.not.not.i = icmp eq ptr %scan.0.i34, null
  br i1 %cmp.i.not.not.i, label %if.else.i35, label %while.body.i30

if.then.i32:                                      ; preds = %land.rhs9.i
  %36 = getelementptr i8, ptr %scan2.1.i, i64 8
  tail call void @string_StringFree(ptr noundef %Name) #14
  %scan2.0.val.i = load ptr, ptr %36, align 8
  %37 = getelementptr i8, ptr %scan2.0.val.i, i64 8
...
dfg_VarLookup.exit:                               ; preds = %if.then.i32, %if.then24.i
  %symbol.0.in.i = phi ptr [ %symbol27.i, %if.then24.i ], [ %37, %if.then.i32 ]
...
if.end.i:                                         ; preds = %if.then.i, %while.body.i
  ...
  br i1 %cmp.i.not.i, label %dfg_SymCleanUp.exit, label %while.body.i
...
if.end22:                                         ; preds = %if.then20, %for.body14
  ...
  br i1 %cmp.i66.not, label %for.end25.loopexit, label %for.body14
...
list_Delete.exit.i:                               ; preds = %while.body.i.i
  ...
  br i1 %cmp.i.not.i76, label %dfg_DeleteProofList.exit, label %for.body.i
...
list_Nconc.exit:                                  ; preds = %dfg_DeleteProofList.exit, %if.end.i78, %for.end.i
  ...
  br i1 %cmp.i.not.i79, label %list_Nconc.exit88, label %if.end.i80

if.end.i80:                                       ; preds = %list_Nconc.exit
  %cmp.i18.not.i81 = icmp eq ptr %52, null
  br i1 %cmp.i18.not.i81, label %list_Nconc.exit88, label %for.cond.i82

for.cond.i82:                                     ; preds = %if.end.i80, %for.cond.i82
  %List1.addr.0.i83 = phi ptr [ %List1.addr.0.val17.i84, %for.cond.i82 ], [ %51, %if.end.i80 ]
...
for.end.i86:                                      ; preds = %for.cond.i82
  store ptr %52, ptr %List1.addr.0.i83, align 8
  br label %list_Nconc.exit88

list_Nconc.exit88:                                ; preds = %list_Nconc.exit, %if.end.i80, %for.end.i86
  %retval.0.i87 = phi ptr [ %51, %for.end.i86 ], [ %52, %list_Nconc.exit ], [ %51, %if.end.i80 ]
  ...
  br i1 %cmp.i.not.i89, label %list_Nconc.exit98, label %if.end.i90

if.end.i90:                                       ; preds = %list_Nconc.exit88
  %cmp.i18.not.i91 = icmp eq ptr %54, null
  br i1 %cmp.i18.not.i91, label %list_Nconc.exit98, label %for.cond.i92

for.cond.i92:                                     ; preds = %if.end.i90, %for.cond.i92
  %List1.addr.0.i93 = phi ptr [ %List1.addr.0.val17.i94, %for.cond.i92 ], [ %53, %if.end.i90 ]
  %List1.addr.0.val17.i94 = load ptr, ptr %List1.addr.0.i93, align 8
  %cmp.i20.not.i95 = icmp eq ptr %List1.addr.0.val17.i94, null
  br i1 %cmp.i20.not.i95, label %for.end.i96, label %for.cond.i92

for.end.i96:                                      ; preds = %for.cond.i92
  store ptr %54, ptr %List1.addr.0.i93, align 8
  br label %list_Nconc.exit98

list_Nconc.exit98:                                ; preds = %list_Nconc.exit88, %if.end.i90, %for.end.i96
  %retval.0.i97 = phi ptr [ %53, %for.end.i96 ], [ %54, %list_Nconc.exit88 ], [ %53, %if.end.i90 ]
  ...
  br i1 %cmp.i.not.i99, label %list_Nconc.exit108, label %if.end.i100

if.end.i100:                                      ; preds = %list_Nconc.exit98
  %cmp.i18.not.i101 = icmp eq ptr %56, null
  br i1 %cmp.i18.not.i101, label %list_Nconc.exit108, label %for.cond.i102

for.cond.i102:                                    ; preds = %if.end.i100, %for.cond.i102
  %List1.addr.0.i103 = phi ptr [ %List1.addr.0.val17.i104, %for.cond.i102 ], [ %55, %if.end.i100 ]
  %List1.addr.0.val17.i104 = load ptr, ptr %List1.addr.0.i103, align 8
  %cmp.i20.not.i105 = icmp eq ptr %List1.addr.0.val17.i104, null
  br i1 %cmp.i20.not.i105, label %for.end.i106, label %for.cond.i102

for.end.i106:                                     ; preds = %for.cond.i102
  store ptr %56, ptr %List1.addr.0.i103, align 8
  br label %list_Nconc.exit108

list_Nconc.exit108:                               ; preds = %list_Nconc.exit98, %if.end.i100, %for.end.i106
  %retval.0.i107 = phi ptr [ %55, %for.end.i106 ], [ %56, %list_Nconc.exit98 ], [ %55, %if.end.i100 ]
  ...
  br i1 %cmp.i.not.i109, label %list_Nconc.exit118, label %if.end.i110

if.end.i110:                                      ; preds = %list_Nconc.exit108
  %cmp.i18.not.i111 = icmp eq ptr %59, null
  br i1 %cmp.i18.not.i111, label %list_Nconc.exit118, label %for.cond.i112

for.cond.i112:                                    ; preds = %if.end.i110, %for.cond.i112
  %List1.addr.0.i113 = phi ptr [ %List1.addr.0.val17.i114, %for.cond.i112 ], [ %58, %if.end.i110 ]
  %List1.addr.0.val17.i114 = load ptr, ptr %List1.addr.0.i113, align 8
  %cmp.i20.not.i115 = icmp eq ptr %List1.addr.0.val17.i114, null
  br i1 %cmp.i20.not.i115, label %for.end.i116, label %for.cond.i112

for.end.i116:                                     ; preds = %for.cond.i112
  store ptr %59, ptr %List1.addr.0.i113, align 8
  br label %list_Nconc.exit118

list_Nconc.exit118:                               ; preds = %list_Nconc.exit108, %if.end.i110, %for.end.i116
  %retval.0.i117 = phi ptr [ %58, %for.end.i116 ], [ %59, %list_Nconc.exit108 ], [ %58, %if.end.i110 ]
...
while.body.i:                                     ; preds = %for.end, %while.body.i
  ...
  br i1 %cmp.i.not.i, label %cleanup42, label %while.body.i
...
for.body.i:                                       ; preds = %for.end, %if.end.i38
  %FormulaPairs.addr.017.i = phi ptr [ %L.val.i.i42, %if.end.i38 ], [ %27, %for.end ]
  ...
  br i1 %cmp.not.i36, label %if.end.i38, label %if.then.i37

if.then.i37:                                      ; preds = %for.body.i
  tail call void @string_StringFree(ptr noundef nonnull %call1.val12.i) #14
  br label %if.end.i38

if.end.i38:                                       ; preds = %if.then.i37, %for.body.i
  %30 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i39 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %30, i64 0, i32 4
  %31 = load i32, ptr %total_size.i.i.i.i39, align 8
  %conv26.i.i.i.i40 = sext i32 %31 to i64
  %32 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i41 = add i64 %32, %conv26.i.i.i.i40
  store i64 %add27.i.i.i.i41, ptr @memory_FREEDBYTES, align 8
  ...
  %L.val.i.i42 = load ptr, ptr %FormulaPairs.addr.017.i, align 8
  ...
  %cmp.i.not.i43 = icmp eq ptr %L.val.i.i42, null
  br i1 %cmp.i.not.i43, label %dfg_DeleteFormulaPairList.exit, label %for.body.i

dfg_DeleteFormulaPairList.exit:                   ; preds = %if.end.i38, %for.end
  %40 = load ptr, ptr @dfg_CONJECLIST, align 8
  %cmp.i.not16.i45 = icmp eq ptr %40, null
  br i1 %cmp.i.not16.i45, label %dfg_DeleteFormulaPairList.exit63, label %for.body.i46

for.body.i46:                                     ; preds = %dfg_DeleteFormulaPairList.exit, %if.end.i53
  %FormulaPairs.addr.017.i47 = phi ptr [ %L.val.i.i57, %if.end.i53 ], [ %40, %dfg_DeleteFormulaPairList.exit ]
  %41 = getelementptr i8, ptr %FormulaPairs.addr.017.i47, i64 8
  %FormulaPairs.addr.0.val.i48 = load ptr, ptr %41, align 8
  %call1.val.i49 = load ptr, ptr %FormulaPairs.addr.0.val.i48, align 8
  tail call void @term_Delete(ptr noundef %call1.val.i49) #14
  %42 = getelementptr i8, ptr %FormulaPairs.addr.0.val.i48, i64 8
  %call1.val12.i50 = load ptr, ptr %42, align 8
  %cmp.not.i51 = icmp eq ptr %call1.val12.i50, null
  br i1 %cmp.not.i51, label %if.end.i53, label %if.then.i52

if.then.i52:                                      ; preds = %for.body.i46
  tail call void @string_StringFree(ptr noundef nonnull %call1.val12.i50) #14
  br label %if.end.i53

if.end.i53:                                       ; preds = %if.then.i52, %for.body.i46
  %43 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i54 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %43, i64 0, i32 4
  %44 = load i32, ptr %total_size.i.i.i.i54, align 8
  %conv26.i.i.i.i55 = sext i32 %44 to i64
  %45 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i56 = add i64 %45, %conv26.i.i.i.i55
  store i64 %add27.i.i.i.i56, ptr @memory_FREEDBYTES, align 8
  %46 = load ptr, ptr %43, align 8
  store ptr %46, ptr %FormulaPairs.addr.0.val.i48, align 8
  %47 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %FormulaPairs.addr.0.val.i48, ptr %47, align 8
  ...
  %total_size.i.i.i13.i58 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %48, i64 0, i32 4
  %49 = load i32, ptr %total_size.i.i.i13.i58, align 8
  %conv26.i.i.i14.i59 = sext i32 %49 to i64
  %50 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i15.i60 = add i64 %50, %conv26.i.i.i14.i59
  store i64 %add27.i.i.i15.i60, ptr @memory_FREEDBYTES, align 8
  %51 = load ptr, ptr %48, align 8
  store ptr %51, ptr %FormulaPairs.addr.017.i47, align 8
  %52 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %FormulaPairs.addr.017.i47, ptr %52, align 8
  %cmp.i.not.i61 = icmp eq ptr %L.val.i.i57, null
  br i1 %cmp.i.not.i61, label %dfg_DeleteFormulaPairList.exit63, label %for.body.i46

dfg_DeleteFormulaPairList.exit63:                 ; preds = %if.end.i53, %dfg_DeleteFormulaPairList.exit
  %53 = load ptr, ptr @dfg_SORTDECLLIST, align 8
  %cmp.i.not16.i64 = icmp eq ptr %53, null
  br i1 %cmp.i.not16.i64, label %dfg_DeleteFormulaPairList.exit82, label %for.body.i65

for.body.i65:                                     ; preds = %dfg_DeleteFormulaPairList.exit63, %if.end.i72
  %FormulaPairs.addr.017.i66 = phi ptr [ %L.val.i.i76, %if.end.i72 ], [ %53, %dfg_DeleteFormulaPairList.exit63 ]
  %54 = getelementptr i8, ptr %FormulaPairs.addr.017.i66, i64 8
  %FormulaPairs.addr.0.val.i67 = load ptr, ptr %54, align 8
  %call1.val.i68 = load ptr, ptr %FormulaPairs.addr.0.val.i67, align 8
  tail call void @term_Delete(ptr noundef %call1.val.i68) #14
  %55 = getelementptr i8, ptr %FormulaPairs.addr.0.val.i67, i64 8
  %call1.val12.i69 = load ptr, ptr %55, align 8
  %cmp.not.i70 = icmp eq ptr %call1.val12.i69, null
  br i1 %cmp.not.i70, label %if.end.i72, label %if.then.i71

if.then.i71:                                      ; preds = %for.body.i65
  tail call void @string_StringFree(ptr noundef nonnull %call1.val12.i69) #14
  br label %if.end.i72

if.end.i72:                                       ; preds = %if.then.i71, %for.body.i65
  %56 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i73 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %56, i64 0, i32 4
  %57 = load i32, ptr %total_size.i.i.i.i73, align 8
  %conv26.i.i.i.i74 = sext i32 %57 to i64
  %58 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i75 = add i64 %58, %conv26.i.i.i.i74
  store i64 %add27.i.i.i.i75, ptr @memory_FREEDBYTES, align 8
  %59 = load ptr, ptr %56, align 8
  store ptr %59, ptr %FormulaPairs.addr.0.val.i67, align 8
  %60 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %FormulaPairs.addr.0.val.i67, ptr %60, align 8
  %L.val.i.i76 = load ptr, ptr %FormulaPairs.addr.017.i66, align 8
  %61 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i13.i77 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %61, i64 0, i32 4
  %62 = load i32, ptr %total_size.i.i.i13.i77, align 8
  %conv26.i.i.i14.i78 = sext i32 %62 to i64
  %63 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i15.i79 = add i64 %63, %conv26.i.i.i14.i78
  store i64 %add27.i.i.i15.i79, ptr @memory_FREEDBYTES, align 8
  %64 = load ptr, ptr %61, align 8
  store ptr %64, ptr %FormulaPairs.addr.017.i66, align 8
  %65 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %FormulaPairs.addr.017.i66, ptr %65, align 8
  %cmp.i.not.i80 = icmp eq ptr %L.val.i.i76, null
  br i1 %cmp.i.not.i80, label %dfg_DeleteFormulaPairList.exit82, label %for.body.i65

dfg_DeleteFormulaPairList.exit82:                 ; preds = %if.end.i72, %dfg_DeleteFormulaPairList.exit63
  ...
  br i1 %cmp.i.not.i83, label %list_Nconc.exit92, label %if.end.i84

if.end.i84:                                       ; preds = %dfg_DeleteFormulaPairList.exit82
  %cmp.i18.not.i85 = icmp eq ptr %call15, null
  br i1 %cmp.i18.not.i85, label %list_Nconc.exit92, label %for.cond.i86

for.cond.i86:                                     ; preds = %if.end.i84, %for.cond.i86
  %List1.addr.0.i87 = phi ptr [ %List1.addr.0.val17.i88, %for.cond.i86 ], [ %68, %if.end.i84 ]
  %List1.addr.0.val17.i88 = load ptr, ptr %List1.addr.0.i87, align 8
  %cmp.i20.not.i89 = icmp eq ptr %List1.addr.0.val17.i88, null
  br i1 %cmp.i20.not.i89, label %for.end.i90, label %for.cond.i86

for.end.i90:                                      ; preds = %for.cond.i86
  store ptr %call15, ptr %List1.addr.0.i87, align 8
  br label %list_Nconc.exit92

list_Nconc.exit92:                                ; preds = %dfg_DeleteFormulaPairList.exit82, %if.end.i84, %for.end.i90
  %retval.0.i91 = phi ptr [ %68, %for.end.i90 ], [ %call15, %dfg_DeleteFormulaPairList.exit82 ], [ %68, %if.end.i84 ]
...
for.body.i:                                       ; preds = %dfg_SymCleanUp.exit, %if.end.i4
  %FormulaPairs.addr.017.i = phi ptr [ %L.val.i.i8, %if.end.i4 ], [ %17, %dfg_SymCleanUp.exit ]
  ...
  br i1 %cmp.not.i2, label %if.end.i4, label %if.then.i3

if.then.i3:                                       ; preds = %for.body.i
  tail call void @string_StringFree(ptr noundef nonnull %call1.val12.i) #14
  br label %if.end.i4

if.end.i4:                                        ; preds = %if.then.i3, %for.body.i
  %20 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i5 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %20, i64 0, i32 4
  %21 = load i32, ptr %total_size.i.i.i.i5, align 8
  %conv26.i.i.i.i6 = sext i32 %21 to i64
  %22 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i7 = add i64 %22, %conv26.i.i.i.i6
  store i64 %add27.i.i.i.i7, ptr @memory_FREEDBYTES, align 8
  ...
  %L.val.i.i8 = load ptr, ptr %FormulaPairs.addr.017.i, align 8
  %25 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  ...
  %cmp.i.not.i9 = icmp eq ptr %L.val.i.i8, null
  br i1 %cmp.i.not.i9, label %dfg_DeleteFormulaPairList.exit, label %for.body.i

dfg_DeleteFormulaPairList.exit:                   ; preds = %if.end.i4, %dfg_SymCleanUp.exit
  %30 = load ptr, ptr @dfg_CONCLAUSES, align 8
  %cmp.i.not16.i10 = icmp eq ptr %30, null
  br i1 %cmp.i.not16.i10, label %dfg_DeleteFormulaPairList.exit27, label %for.body.i11

for.body.i11:                                     ; preds = %dfg_DeleteFormulaPairList.exit, %if.end.i18
  %FormulaPairs.addr.017.i12 = phi ptr [ %L.val.i.i22, %if.end.i18 ], [ %30, %dfg_DeleteFormulaPairList.exit ]
  %31 = getelementptr i8, ptr %FormulaPairs.addr.017.i12, i64 8
  %FormulaPairs.addr.0.val.i13 = load ptr, ptr %31, align 8
  %call1.val.i14 = load ptr, ptr %FormulaPairs.addr.0.val.i13, align 8
  tail call void @term_Delete(ptr noundef %call1.val.i14) #14
  %32 = getelementptr i8, ptr %FormulaPairs.addr.0.val.i13, i64 8
  %call1.val12.i15 = load ptr, ptr %32, align 8
  %cmp.not.i16 = icmp eq ptr %call1.val12.i15, null
  br i1 %cmp.not.i16, label %if.end.i18, label %if.then.i17

if.then.i17:                                      ; preds = %for.body.i11
  tail call void @string_StringFree(ptr noundef nonnull %call1.val12.i15) #14
  br label %if.end.i18

if.end.i18:                                       ; preds = %if.then.i17, %for.body.i11
  %33 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i19 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %33, i64 0, i32 4
  %34 = load i32, ptr %total_size.i.i.i.i19, align 8
  %conv26.i.i.i.i20 = sext i32 %34 to i64
  %35 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i21 = add i64 %35, %conv26.i.i.i.i20
  store i64 %add27.i.i.i.i21, ptr @memory_FREEDBYTES, align 8
  %36 = load ptr, ptr %33, align 8
  store ptr %36, ptr %FormulaPairs.addr.0.val.i13, align 8
  %37 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %FormulaPairs.addr.0.val.i13, ptr %37, align 8
  %L.val.i.i22 = load ptr, ptr %FormulaPairs.addr.017.i12, align 8
  %38 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i13.i23 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %38, i64 0, i32 4
  %39 = load i32, ptr %total_size.i.i.i13.i23, align 8
  %conv26.i.i.i14.i24 = sext i32 %39 to i64
  %40 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i15.i25 = add i64 %40, %conv26.i.i.i14.i24
  store i64 %add27.i.i.i15.i25, ptr @memory_FREEDBYTES, align 8
  %41 = load ptr, ptr %38, align 8
  store ptr %41, ptr %FormulaPairs.addr.017.i12, align 8
  %42 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %FormulaPairs.addr.017.i12, ptr %42, align 8
  %cmp.i.not.i26 = icmp eq ptr %L.val.i.i22, null
  br i1 %cmp.i.not.i26, label %dfg_DeleteFormulaPairList.exit27, label %for.body.i11

dfg_DeleteFormulaPairList.exit27:                 ; preds = %if.end.i18, %dfg_DeleteFormulaPairList.exit
  %43 = load ptr, ptr @dfg_AXIOMLIST, align 8
  %cmp.i.not16.i28 = icmp eq ptr %43, null
  br i1 %cmp.i.not16.i28, label %dfg_DeleteFormulaPairList.exit45, label %for.body.i29

for.body.i29:                                     ; preds = %dfg_DeleteFormulaPairList.exit27, %if.end.i36
  %FormulaPairs.addr.017.i30 = phi ptr [ %L.val.i.i40, %if.end.i36 ], [ %43, %dfg_DeleteFormulaPairList.exit27 ]
  %44 = getelementptr i8, ptr %FormulaPairs.addr.017.i30, i64 8
  %FormulaPairs.addr.0.val.i31 = load ptr, ptr %44, align 8
  %call1.val.i32 = load ptr, ptr %FormulaPairs.addr.0.val.i31, align 8
  tail call void @term_Delete(ptr noundef %call1.val.i32) #14
  %45 = getelementptr i8, ptr %FormulaPairs.addr.0.val.i31, i64 8
  %call1.val12.i33 = load ptr, ptr %45, align 8
  %cmp.not.i34 = icmp eq ptr %call1.val12.i33, null
  br i1 %cmp.not.i34, label %if.end.i36, label %if.then.i35

if.then.i35:                                      ; preds = %for.body.i29
  tail call void @string_StringFree(ptr noundef nonnull %call1.val12.i33) #14
  br label %if.end.i36

if.end.i36:                                       ; preds = %if.then.i35, %for.body.i29
  %46 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i37 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %46, i64 0, i32 4
  %47 = load i32, ptr %total_size.i.i.i.i37, align 8
  %conv26.i.i.i.i38 = sext i32 %47 to i64
  %48 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i39 = add i64 %48, %conv26.i.i.i.i38
  store i64 %add27.i.i.i.i39, ptr @memory_FREEDBYTES, align 8
  %49 = load ptr, ptr %46, align 8
  store ptr %49, ptr %FormulaPairs.addr.0.val.i31, align 8
  %50 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %FormulaPairs.addr.0.val.i31, ptr %50, align 8
  %L.val.i.i40 = load ptr, ptr %FormulaPairs.addr.017.i30, align 8
  %51 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i13.i41 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %51, i64 0, i32 4
  %52 = load i32, ptr %total_size.i.i.i13.i41, align 8
  %conv26.i.i.i14.i42 = sext i32 %52 to i64
  %53 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i15.i43 = add i64 %53, %conv26.i.i.i14.i42
  store i64 %add27.i.i.i15.i43, ptr @memory_FREEDBYTES, align 8
  %54 = load ptr, ptr %51, align 8
  store ptr %54, ptr %FormulaPairs.addr.017.i30, align 8
  %55 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %FormulaPairs.addr.017.i30, ptr %55, align 8
  %cmp.i.not.i44 = icmp eq ptr %L.val.i.i40, null
  br i1 %cmp.i.not.i44, label %dfg_DeleteFormulaPairList.exit45, label %for.body.i29

dfg_DeleteFormulaPairList.exit45:                 ; preds = %if.end.i36, %dfg_DeleteFormulaPairList.exit27
  %56 = load ptr, ptr @dfg_CONJECLIST, align 8
  %cmp.i.not16.i46 = icmp eq ptr %56, null
  br i1 %cmp.i.not16.i46, label %dfg_DeleteFormulaPairList.exit63, label %for.body.i47

for.body.i47:                                     ; preds = %dfg_DeleteFormulaPairList.exit45, %if.end.i54
  %FormulaPairs.addr.017.i48 = phi ptr [ %L.val.i.i58, %if.end.i54 ], [ %56, %dfg_DeleteFormulaPairList.exit45 ]
  %57 = getelementptr i8, ptr %FormulaPairs.addr.017.i48, i64 8
  %FormulaPairs.addr.0.val.i49 = load ptr, ptr %57, align 8
  %call1.val.i50 = load ptr, ptr %FormulaPairs.addr.0.val.i49, align 8
  tail call void @term_Delete(ptr noundef %call1.val.i50) #14
  %58 = getelementptr i8, ptr %FormulaPairs.addr.0.val.i49, i64 8
  %call1.val12.i51 = load ptr, ptr %58, align 8
  %cmp.not.i52 = icmp eq ptr %call1.val12.i51, null
  br i1 %cmp.not.i52, label %if.end.i54, label %if.then.i53

if.then.i53:                                      ; preds = %for.body.i47
  tail call void @string_StringFree(ptr noundef nonnull %call1.val12.i51) #14
  br label %if.end.i54

if.end.i54:                                       ; preds = %if.then.i53, %for.body.i47
  %59 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i55 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %59, i64 0, i32 4
  %60 = load i32, ptr %total_size.i.i.i.i55, align 8
  %conv26.i.i.i.i56 = sext i32 %60 to i64
  %61 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i57 = add i64 %61, %conv26.i.i.i.i56
  store i64 %add27.i.i.i.i57, ptr @memory_FREEDBYTES, align 8
  %62 = load ptr, ptr %59, align 8
  store ptr %62, ptr %FormulaPairs.addr.0.val.i49, align 8
  %63 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %FormulaPairs.addr.0.val.i49, ptr %63, align 8
  %L.val.i.i58 = load ptr, ptr %FormulaPairs.addr.017.i48, align 8
  %64 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i13.i59 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %64, i64 0, i32 4
  %65 = load i32, ptr %total_size.i.i.i13.i59, align 8
  %conv26.i.i.i14.i60 = sext i32 %65 to i64
  %66 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i15.i61 = add i64 %66, %conv26.i.i.i14.i60
  store i64 %add27.i.i.i15.i61, ptr @memory_FREEDBYTES, align 8
  %67 = load ptr, ptr %64, align 8
  store ptr %67, ptr %FormulaPairs.addr.017.i48, align 8
  %68 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %FormulaPairs.addr.017.i48, ptr %68, align 8
  %cmp.i.not.i62 = icmp eq ptr %L.val.i.i58, null
  br i1 %cmp.i.not.i62, label %dfg_DeleteFormulaPairList.exit63, label %for.body.i47

dfg_DeleteFormulaPairList.exit63:                 ; preds = %if.end.i54, %dfg_DeleteFormulaPairList.exit45
  %69 = load ptr, ptr @dfg_PROOFLIST, align 8
  %cmp.i.not16.i64 = icmp eq ptr %69, null
  br i1 %cmp.i.not16.i64, label %dfg_DeleteProofList.exit, label %for.body.i65

for.body.i65:                                     ; preds = %dfg_DeleteFormulaPairList.exit63, %list_Delete.exit.i
  ...
  %call1.val.i66 = load ptr, ptr %71, align 8
  tail call void @string_StringFree(ptr noundef %call1.val.i66) #14
  %call1.val11.i = load ptr, ptr %Proof.addr.0.val.i, align 8
  %72 = getelementptr i8, ptr %call1.val11.i, i64 8
  %call1.val11.val.i = load ptr, ptr %72, align 8
  tail call void @term_Delete(ptr noundef %call1.val11.val.i) #14
  %call1.val12.i67 = load ptr, ptr %Proof.addr.0.val.i, align 8
  %call1.val12.val.i = load ptr, ptr %call1.val12.i67, align 8
  %73 = getelementptr i8, ptr %call1.val12.val.i, i64 8
  %call1.val12.val.val.i = load ptr, ptr %73, align 8
  tail call void @list_DeleteWithElement(ptr noundef %call1.val12.val.val.i, ptr noundef nonnull @string_StringFree) #14
  br label %while.body.i.i

while.body.i.i:                                   ; preds = %while.body.i.i, %for.body.i65
  %Current.06.i.i = phi ptr [ %Current.0.val.i.i, %while.body.i.i ], [ %Proof.addr.0.val.i, %for.body.i65 ]
  %Current.0.val.i.i = load ptr, ptr %Current.06.i.i, align 8
...
list_Delete.exit.i:                               ; preds = %while.body.i.i
  ...
  br i1 %cmp.i.not.i75, label %dfg_DeleteProofList.exit, label %for.body.i65
...
dfg_DeleteProofList.exit:                         ; preds = %list_Delete.exit.i, %dfg_DeleteFormulaPairList.exit63
  ...
  br i1 %cmp.i.not16.i76, label %dfg_DeleteFormulaPairList.exit93, label %for.body.i77

for.body.i77:                                     ; preds = %dfg_DeleteProofList.exit, %if.end.i84
  %FormulaPairs.addr.017.i78 = phi ptr [ %L.val.i.i88, %if.end.i84 ], [ %84, %dfg_DeleteProofList.exit ]
  %85 = getelementptr i8, ptr %FormulaPairs.addr.017.i78, i64 8
  %FormulaPairs.addr.0.val.i79 = load ptr, ptr %85, align 8
  %call1.val.i80 = load ptr, ptr %FormulaPairs.addr.0.val.i79, align 8
  tail call void @term_Delete(ptr noundef %call1.val.i80) #14
  %86 = getelementptr i8, ptr %FormulaPairs.addr.0.val.i79, i64 8
  %call1.val12.i81 = load ptr, ptr %86, align 8
  %cmp.not.i82 = icmp eq ptr %call1.val12.i81, null
  br i1 %cmp.not.i82, label %if.end.i84, label %if.then.i83

if.then.i83:                                      ; preds = %for.body.i77
  tail call void @string_StringFree(ptr noundef nonnull %call1.val12.i81) #14
  br label %if.end.i84

if.end.i84:                                       ; preds = %if.then.i83, %for.body.i77
  %87 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i85 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %87, i64 0, i32 4
  %88 = load i32, ptr %total_size.i.i.i.i85, align 8
  %conv26.i.i.i.i86 = sext i32 %88 to i64
  %89 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i87 = add i64 %89, %conv26.i.i.i.i86
  store i64 %add27.i.i.i.i87, ptr @memory_FREEDBYTES, align 8
  %90 = load ptr, ptr %87, align 8
  store ptr %90, ptr %FormulaPairs.addr.0.val.i79, align 8
  %91 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %FormulaPairs.addr.0.val.i79, ptr %91, align 8
  %L.val.i.i88 = load ptr, ptr %FormulaPairs.addr.017.i78, align 8
  %92 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i13.i89 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %92, i64 0, i32 4
  %93 = load i32, ptr %total_size.i.i.i13.i89, align 8
  %conv26.i.i.i14.i90 = sext i32 %93 to i64
  %94 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i15.i91 = add i64 %94, %conv26.i.i.i14.i90
  store i64 %add27.i.i.i15.i91, ptr @memory_FREEDBYTES, align 8
  %95 = load ptr, ptr %92, align 8
  store ptr %95, ptr %FormulaPairs.addr.017.i78, align 8
  %96 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %FormulaPairs.addr.017.i78, ptr %96, align 8
  %cmp.i.not.i92 = icmp eq ptr %L.val.i.i88, null
  br i1 %cmp.i.not.i92, label %dfg_DeleteFormulaPairList.exit93, label %for.body.i77

dfg_DeleteFormulaPairList.exit93:                 ; preds = %if.end.i84, %dfg_DeleteProofList.exit
