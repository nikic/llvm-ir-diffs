; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/term.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/term.c"
...
@.str.3 = private unnamed_addr constant [55 x i8] c"/home/npopov/repos/llvm-test-suite/CTMark/SPASS/term.c\00", align 1
...
for.body:                                         ; preds = %entry, %for.body
  %l.012 = phi ptr [ %l.0.val9, %for.body ], [ %List, %entry ]
  %0 = getelementptr i8, ptr %l.012, i64 8
  ...
  %l.0.val9 = load ptr, ptr %l.012, align 8
  %cmp.i.not = icmp eq ptr %l.0.val9, null
...
for.body:                                         ; preds = %entry, %for.body
  %Scan.017 = phi ptr [ %Scan.0.val13, %for.body ], [ %Term.val14, %entry ]
  %1 = getelementptr i8, ptr %Scan.017, i64 8
  %Scan.0.val = load ptr, ptr %1, align 8
  tail call void @term_Delete(ptr noundef %Scan.0.val)
  %Scan.0.val13 = load ptr, ptr %Scan.017, align 8
...
if.then5:                                         ; preds = %if.else2
  ...
  %cmp.i40.not49 = icmp eq ptr %Scan2.048, null
  br i1 %cmp.i40.not49, label %return, label %for.body

for.body:                                         ; preds = %if.then5, %for.inc
  %Scan2.051 = phi ptr [ %Scan2.0, %for.inc ], [ %Scan2.048, %if.then5 ]
  %Scan1.050 = phi ptr [ %Scan1.0.val37, %for.inc ], [ %Term1.val35, %if.then5 ]
  %2 = getelementptr i8, ptr %Scan1.050, i64 8
  %Scan1.0.val = load ptr, ptr %2, align 8
  %3 = getelementptr i8, ptr %Scan2.051, i64 8
...
for.inc:                                          ; preds = %for.body
  %Scan1.0.val37 = load ptr, ptr %Scan1.050, align 8
  %Scan2.0 = load ptr, ptr %Scan2.051, align 8
...
for.end:                                          ; preds = %for.inc
  ...
  %5 = icmp eq ptr %Scan2.0, null
  %narrow = select i1 %4, i1 %5, i1 false
  %spec.select = zext i1 %narrow to i32
  br label %return

return:                                           ; preds = %for.body, %for.end, %if.then5, %if.else2, %if.else, %entry
  %retval.1 = phi i32 [ 1, %entry ], [ 0, %if.else ], [ 1, %if.else2 ], [ 0, %if.then5 ], [ %spec.select, %for.end ], [ 0, %for.body ]
  ret i32 %retval.1
}
...
list_StackFree.exit:                              ; preds = %while.body.i, %if.then15
  ...
  br i1 %cmp.i.i.not4.i111, label %cleanup, label %while.body.i112

while.body.i112:                                  ; preds = %list_StackFree.exit, %while.body.i112
  %L.addr.05.i113 = phi ptr [ %L.val.i.i114, %while.body.i112 ], [ %Stack2.1221, %list_StackFree.exit ]
  %L.val.i.i114 = load ptr, ptr %L.addr.05.i113, align 8
  %9 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i115 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %9, i64 0, i32 4
  %10 = load i32, ptr %total_size.i.i.i.i115, align 8
  %conv26.i.i.i.i116 = sext i32 %10 to i64
  %11 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i117 = add i64 %11, %conv26.i.i.i.i116
  store i64 %add27.i.i.i.i117, ptr @memory_FREEDBYTES, align 8
  %12 = load ptr, ptr %9, align 8
  store ptr %12, ptr %L.addr.05.i113, align 8
  %13 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %L.addr.05.i113, ptr %13, align 8
  %cmp.i.i.not.i118 = icmp eq ptr %L.val.i.i114, null
  br i1 %cmp.i.i.not.i118, label %cleanup, label %while.body.i112, !llvm.loop !13
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i.i124.not, label %while.body.i133.preheader, label %land.lhs.true26

while.body.i133.preheader:                        ; preds = %land.lhs.true26, %while.body
...
land.lhs.true26:                                  ; preds = %while.body
  ...
  br i1 %cmp.i126.not, label %if.then30, label %while.body.i133.preheader
...
if.then30:                                        ; preds = %land.lhs.true26
  ...
  br i1 %cmp.i.i120.not, label %cleanup, label %land.rhs, !llvm.loop !14

while.body.i133:                                  ; preds = %while.body.i133.preheader, %while.body.i133
  %L.addr.05.i134 = phi ptr [ %L.val.i.i135, %while.body.i133 ], [ %Stack1.2192, %while.body.i133.preheader ]
  %L.val.i.i135 = load ptr, ptr %L.addr.05.i134, align 8
  %26 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i136 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %26, i64 0, i32 4
  %27 = load i32, ptr %total_size.i.i.i.i136, align 8
  %conv26.i.i.i.i137 = sext i32 %27 to i64
  %28 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i138 = add i64 %28, %conv26.i.i.i.i137
  store i64 %add27.i.i.i.i138, ptr @memory_FREEDBYTES, align 8
  %29 = load ptr, ptr %26, align 8
  store ptr %29, ptr %L.addr.05.i134, align 8
  %30 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %L.addr.05.i134, ptr %30, align 8
  %cmp.i.i.not.i139 = icmp eq ptr %L.val.i.i135, null
  br i1 %cmp.i.i.not.i139, label %list_StackFree.exit140, label %while.body.i133, !llvm.loop !13

list_StackFree.exit140:                           ; preds = %while.body.i133
  br i1 %cmp.i.i124.not, label %cleanup, label %while.body.i142

while.body.i142:                                  ; preds = %list_StackFree.exit140, %while.body.i142
  %L.addr.05.i143 = phi ptr [ %L.val.i.i144, %while.body.i142 ], [ %Stack2.2193, %list_StackFree.exit140 ]
  %L.val.i.i144 = load ptr, ptr %L.addr.05.i143, align 8
  %31 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i145 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %31, i64 0, i32 4
  %32 = load i32, ptr %total_size.i.i.i.i145, align 8
  %conv26.i.i.i.i146 = sext i32 %32 to i64
  %33 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i147 = add i64 %33, %conv26.i.i.i.i146
  store i64 %add27.i.i.i.i147, ptr @memory_FREEDBYTES, align 8
  %34 = load ptr, ptr %31, align 8
  store ptr %34, ptr %L.addr.05.i143, align 8
  %35 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %L.addr.05.i143, ptr %35, align 8
  %cmp.i.i.not.i148 = icmp eq ptr %L.val.i.i144, null
  br i1 %cmp.i.i.not.i148, label %cleanup, label %while.body.i142, !llvm.loop !13
...
if.then38:                                        ; preds = %land.rhs
  ...
  br i1 %cmp.i152.not, label %while.body.i157, label %do.cond

while.body.i157:                                  ; preds = %if.then38, %while.body.i157
  %L.addr.05.i158 = phi ptr [ %L.val.i.i159, %while.body.i157 ], [ %Stack1.2192, %if.then38 ]
  %L.val.i.i159 = load ptr, ptr %L.addr.05.i158, align 8
  %37 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i160 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %37, i64 0, i32 4
  %38 = load i32, ptr %total_size.i.i.i.i160, align 8
  %conv26.i.i.i.i161 = sext i32 %38 to i64
  %39 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i162 = add i64 %39, %conv26.i.i.i.i161
  store i64 %add27.i.i.i.i162, ptr @memory_FREEDBYTES, align 8
  %40 = load ptr, ptr %37, align 8
  store ptr %40, ptr %L.addr.05.i158, align 8
  %41 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %L.addr.05.i158, ptr %41, align 8
  %cmp.i.i.not.i163 = icmp eq ptr %L.val.i.i159, null
  br i1 %cmp.i.i.not.i163, label %list_StackFree.exit164, label %while.body.i157, !llvm.loop !13

list_StackFree.exit164:                           ; preds = %while.body.i157
  %cmp.i.i.not4.i165 = icmp eq ptr %Stack2.2193, null
  br i1 %cmp.i.i.not4.i165, label %cleanup, label %while.body.i166

while.body.i166:                                  ; preds = %list_StackFree.exit164, %while.body.i166
  %L.addr.05.i167 = phi ptr [ %L.val.i.i168, %while.body.i166 ], [ %Stack2.2193, %list_StackFree.exit164 ]
  %L.val.i.i168 = load ptr, ptr %L.addr.05.i167, align 8
  %42 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i169 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %42, i64 0, i32 4
  %43 = load i32, ptr %total_size.i.i.i.i169, align 8
  %conv26.i.i.i.i170 = sext i32 %43 to i64
  %44 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i171 = add i64 %44, %conv26.i.i.i.i170
  store i64 %add27.i.i.i.i171, ptr @memory_FREEDBYTES, align 8
  %45 = load ptr, ptr %42, align 8
  store ptr %45, ptr %L.addr.05.i167, align 8
  %46 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %L.addr.05.i167, ptr %46, align 8
  %cmp.i.i.not.i172 = icmp eq ptr %L.val.i.i168, null
  br i1 %cmp.i.i.not.i172, label %cleanup, label %while.body.i166, !llvm.loop !13
...
cleanup:                                          ; preds = %while.cond.preheader, %if.then30, %while.body.i112, %while.body.i166, %while.body.i142, %list_StackFree.exit164, %list_StackFree.exit140, %list_StackFree.exit
  %retval.0 = phi i32 [ 0, %list_StackFree.exit ], [ 0, %list_StackFree.exit140 ], [ 0, %list_StackFree.exit164 ], [ 0, %while.body.i142 ], [ 0, %while.body.i166 ], [ 0, %while.body.i112 ], [ 1, %if.then30 ], [ 1, %while.cond.preheader ]
  ret i32 %retval.0
}
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i.i52.not, label %return, label %land.rhs, !llvm.loop !16
...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %cmp.i.i, label %cleanup, label %for.cond, !llvm.loop !19
...
entry:
  ...
  br i1 %cmp.i.not, label %if.else51, label %if.then
...
if.then:                                          ; preds = %entry
  ...
  %car.i.i92 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i91, i64 0, i32 1
...
while.body.outer:                                 ; preds = %while.body.outer.backedge, %if.then
  %ActStack.0130.ph = phi ptr [ %call.i.i93, %if.then ], [ %ActStack.0130.ph.be, %while.body.outer.backedge ]
  %ArgumentStack.0129.ph = phi ptr [ %call.i.i91, %if.then ], [ %ArgumentStack.0129.ph.be, %while.body.outer.backedge ]
  %TopStack.0128.ph = phi ptr [ %call.i.i, %if.then ], [ %TopStack.0128.ph.be, %while.body.outer.backedge ]
  %2 = getelementptr i8, ptr %ActStack.0130.ph, i64 8
  br label %while.body
...
if.then16:                                        ; preds = %while.body
  %3 = getelementptr i8, ptr %TopStack.0128.ph, i64 8
  %TopStack.0.val = load ptr, ptr %3, align 8
  %4 = ptrtoint ptr %TopStack.0.val to i64
  %5 = trunc i64 %4 to i32
  %6 = getelementptr i8, ptr %ArgumentStack.0129.ph, i64 8
  ...
  %size.i = getelementptr inbounds %struct.term, ptr %call.i, i64 0, i32 4
  store i32 0, ptr %size.i, align 4
  %L.val.i = load ptr, ptr %TopStack.0128.ph, align 8
  %7 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %7, i64 0, i32 4
  %8 = load i32, ptr %total_size.i.i.i, align 8
  %conv26.i.i.i = sext i32 %8 to i64
  ...
  store i64 %add27.i.i.i, ptr @memory_FREEDBYTES, align 8
  %10 = load ptr, ptr %7, align 8
  store ptr %10, ptr %TopStack.0128.ph, align 8
  %11 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %TopStack.0128.ph, ptr %11, align 8
  %L.val.i97 = load ptr, ptr %ArgumentStack.0129.ph, align 8
  ...
  store ptr %15, ptr %ArgumentStack.0129.ph, align 8
  %16 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %ArgumentStack.0129.ph, ptr %16, align 8
  %L.val.i101 = load ptr, ptr %ActStack.0130.ph, align 8
  ...
  store ptr %20, ptr %ActStack.0130.ph, align 8
  %21 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %ActStack.0130.ph, ptr %21, align 8
...
while.body.outer.backedge:                        ; preds = %if.then25, %if.then33
  %ActStack.0130.ph.be = phi ptr [ %call.i.i114, %if.then33 ], [ %L.val.i101, %if.then25 ]
  %ArgumentStack.0129.ph.be = phi ptr [ %call.i.i112, %if.then33 ], [ %L.val.i97, %if.then25 ]
  %TopStack.0128.ph.be = phi ptr [ %call.i.i110, %if.then33 ], [ %L.val.i, %if.then25 ]
...
if.then33:                                        ; preds = %if.else
  ...
  store ptr %TopStack.0128.ph, ptr %call.i.i110, align 8
  ...
  %car.i.i113 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i112, i64 0, i32 1
  store ptr %call38, ptr %car.i.i113, align 8
  store ptr %ArgumentStack.0129.ph, ptr %call.i.i112, align 8
  ...
  store ptr %ActStack.0130.ph, ptr %call.i.i114, align 8
  br label %while.body.outer.backedge
...
while.body27:                                     ; preds = %land.rhs
  ...
  br i1 %cmp.i58.not, label %if.end30, label %land.rhs, !llvm.loop !23
...
; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @term_ExchangeVariable(ptr nocapture noundef %Term, i32 noundef %Old, i32 noundef %New) local_unnamed_addr #3 {
entry:
...
if.then:                                          ; preds = %land.rhs.i
  ...
  br i1 %tobool.not.i52, label %cleanup, label %land.rhs.i53

land.rhs.i53:                                     ; preds = %if.then
  %sub.i.i54 = sub nsw i32 0, %Right.val50
  %and.i.i55 = and i32 %0, %sub.i.i54
  %switch86 = icmp ult i32 %and.i.i55, 2
  br i1 %switch86, label %if.then5, label %cleanup

if.then5:                                         ; preds = %land.rhs.i53
...
if.else25:                                        ; preds = %land.rhs.i, %entry
  ...
  br i1 %tobool.not.i62, label %if.end30, label %land.rhs.i63

land.rhs.i63:                                     ; preds = %if.else25
  %sub.i.i64 = sub nsw i32 0, %Right.val50
  %5 = load i32, ptr @symbol_TYPEMASK, align 4
  %and.i.i65 = and i32 %5, %sub.i.i64
  %switch87 = icmp ult i32 %and.i.i65, 2
  br i1 %switch87, label %cleanup, label %if.end30

if.end30:                                         ; preds = %while.body, %while.cond, %land.rhs.i63, %if.else25
  %result.1 = phi i32 [ 0, %if.else25 ], [ 0, %land.rhs.i63 ], [ 0, %while.cond ], [ %call18, %while.body ]
  br label %cleanup

cleanup:                                          ; preds = %land.rhs.i63, %land.rhs.i53, %if.then, %if.end, %if.then5, %if.end30
  %retval.0 = phi i32 [ %result.1, %if.end30 ], [ -1, %if.then5 ], [ 1, %if.end ], [ -1, %if.then ], [ -1, %land.rhs.i53 ], [ 1, %land.rhs.i63 ]
  ret i32 %retval.0
}
...
list_Delete.exit.i:                               ; preds = %while.body.i.i, %for.cond.1
  ...
  br i1 %cmp.i.not5.i5.i, label %term_CompareByConstants.exit, label %while.body.i6.i

while.body.i6.i:                                  ; preds = %list_Delete.exit.i, %while.body.i6.i
  %Current.06.i7.i = phi ptr [ %Current.0.val.i8.i, %while.body.i6.i ], [ %call1.i, %list_Delete.exit.i ]
  %Current.0.val.i8.i = load ptr, ptr %Current.06.i7.i, align 8
  %5 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i9.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %5, i64 0, i32 4
  %6 = load i32, ptr %total_size.i.i.i9.i, align 8
  %conv26.i.i.i10.i = sext i32 %6 to i64
  %7 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i11.i = add i64 %7, %conv26.i.i.i10.i
  store i64 %add27.i.i.i11.i, ptr @memory_FREEDBYTES, align 8
  %8 = load ptr, ptr %5, align 8
  store ptr %8, ptr %Current.06.i7.i, align 8
  %9 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i7.i, ptr %9, align 8
  %cmp.i.not.i12.i = icmp eq ptr %Current.0.val.i8.i, null
  br i1 %cmp.i.not.i12.i, label %term_CompareByConstants.exit, label %while.body.i6.i, !llvm.loop !8

term_CompareByConstants.exit:                     ; preds = %while.body.i6.i, %list_Delete.exit.i
...
for.cond.3:                                       ; preds = %for.cond.2
  ...
  br i1 %cmp.i.not5.i.i13, label %list_Delete.exit.i21, label %while.body.i.i14

while.body.i.i14:                                 ; preds = %for.cond.3, %while.body.i.i14
  %Current.06.i.i15 = phi ptr [ %Current.0.val.i.i16, %while.body.i.i14 ], [ %call.i10, %for.cond.3 ]
  %Current.0.val.i.i16 = load ptr, ptr %Current.06.i.i15, align 8
  %10 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i17 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %10, i64 0, i32 4
  %11 = load i32, ptr %total_size.i.i.i.i17, align 8
  %conv26.i.i.i.i18 = sext i32 %11 to i64
  %12 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i19 = add i64 %12, %conv26.i.i.i.i18
  store i64 %add27.i.i.i.i19, ptr @memory_FREEDBYTES, align 8
  %13 = load ptr, ptr %10, align 8
  store ptr %13, ptr %Current.06.i.i15, align 8
  %14 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i15, ptr %14, align 8
  %cmp.i.not.i.i20 = icmp eq ptr %Current.0.val.i.i16, null
  br i1 %cmp.i.not.i.i20, label %list_Delete.exit.i21, label %while.body.i.i14, !llvm.loop !8

list_Delete.exit.i21:                             ; preds = %while.body.i.i14, %for.cond.3
  %cmp.i.not5.i5.i22 = icmp eq ptr %call1.i11, null
  br i1 %cmp.i.not5.i5.i22, label %cleanup, label %while.body.i6.i23

while.body.i6.i23:                                ; preds = %list_Delete.exit.i21, %while.body.i6.i23
  %Current.06.i7.i24 = phi ptr [ %Current.0.val.i8.i25, %while.body.i6.i23 ], [ %call1.i11, %list_Delete.exit.i21 ]
  %Current.0.val.i8.i25 = load ptr, ptr %Current.06.i7.i24, align 8
  %15 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i9.i26 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %15, i64 0, i32 4
  %16 = load i32, ptr %total_size.i.i.i9.i26, align 8
  %conv26.i.i.i10.i27 = sext i32 %16 to i64
  %17 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i11.i28 = add i64 %17, %conv26.i.i.i10.i27
  store i64 %add27.i.i.i11.i28, ptr @memory_FREEDBYTES, align 8
  %18 = load ptr, ptr %15, align 8
  store ptr %18, ptr %Current.06.i7.i24, align 8
  %19 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i7.i24, ptr %19, align 8
  %cmp.i.not.i12.i29 = icmp eq ptr %Current.0.val.i8.i25, null
  br i1 %cmp.i.not.i12.i29, label %cleanup, label %while.body.i6.i23, !llvm.loop !8

cleanup:                                          ; preds = %while.body.i6.i23, %list_Delete.exit.i21, %for.cond.2, %term_CompareByConstants.exit, %for.cond, %entry
  %retval.0 = phi i32 [ %call, %entry ], [ %call.1, %for.cond ], [ %call2.i, %term_CompareByConstants.exit ], [ %call.3, %for.cond.2 ], [ %call2.i12, %list_Delete.exit.i21 ], [ %call2.i12, %while.body.i6.i23 ]
  ret i32 %retval.0
}
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  br i1 %cmp.i.i42.not.i, label %term_ListOfVariables.exit, label %land.rhs.i, !llvm.loop !35
...
do.body.i5:                                       ; preds = %do.cond.i21, %term_ListOfVariables.exit
  %Term.addr.0.i6 = phi ptr [ %Right, %term_ListOfVariables.exit ], [ %call19.val.i22, %do.cond.i21 ]
  %Stack.0.i7 = phi ptr [ null, %term_ListOfVariables.exit ], [ %Stack.254.i18, %do.cond.i21 ]
  %Variables.0.i8 = phi ptr [ null, %term_ListOfVariables.exit ], [ %Variables.164.i15, %do.cond.i21 ]
  %9 = getelementptr i8, ptr %Term.addr.0.i6, i64 16
  %Term.addr.0.val38.i9 = load ptr, ptr %9, align 8
  %cmp.i.not.i10 = icmp eq ptr %Term.addr.0.val38.i9, null
  br i1 %cmp.i.not.i10, label %if.else.i31, label %if.end9.thread.i11

if.end9.thread.i11:                               ; preds = %do.body.i5
  %call.i.i.i12 = tail call ptr @memory_Malloc(i32 noundef 16) #18
  %car.i.i.i13 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i.i12, i64 0, i32 1
  store ptr %Term.addr.0.val38.i9, ptr %car.i.i.i13, align 8
  store ptr %Stack.0.i7, ptr %call.i.i.i12, align 8
  br label %land.rhs.preheader.i14

if.else.i31:                                      ; preds = %do.body.i5
  %Term.addr.0.val41.i32 = load i32, ptr %Term.addr.0.i6, align 8
  %cmp.i.i.i33 = icmp slt i32 %Term.addr.0.val41.i32, 1
  br i1 %cmp.i.i.i33, label %if.end9.i37, label %if.then7.i34

if.then7.i34:                                     ; preds = %if.else.i31
  %call.i.i35 = tail call ptr @memory_Malloc(i32 noundef 16) #18
  %car.i.i36 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i35, i64 0, i32 1
  store ptr %Term.addr.0.i6, ptr %car.i.i36, align 8
  store ptr %Variables.0.i8, ptr %call.i.i35, align 8
  br label %if.end9.i37

if.end9.i37:                                      ; preds = %if.then7.i34, %if.else.i31
  %Variables.1.i38 = phi ptr [ %call.i.i35, %if.then7.i34 ], [ %Variables.0.i8, %if.else.i31 ]
  %cmp.i.i42.not53.i39 = icmp eq ptr %Stack.0.i7, null
  br i1 %cmp.i.i42.not53.i39, label %term_ListOfVariables.exit40, label %land.rhs.preheader.i14

land.rhs.preheader.i14:                           ; preds = %if.end9.i37, %if.end9.thread.i11
  %Variables.164.i15 = phi ptr [ %Variables.0.i8, %if.end9.thread.i11 ], [ %Variables.1.i38, %if.end9.i37 ]
  %Stack.163.i16 = phi ptr [ %call.i.i.i12, %if.end9.thread.i11 ], [ %Stack.0.i7, %if.end9.i37 ]
  br label %land.rhs.i17

land.rhs.i17:                                     ; preds = %while.body.i24, %land.rhs.preheader.i14
  %Stack.254.i18 = phi ptr [ %L.val.i.i25, %while.body.i24 ], [ %Stack.163.i16, %land.rhs.preheader.i14 ]
  %10 = getelementptr i8, ptr %Stack.254.i18, i64 8
  %Stack.2.val40.i19 = load ptr, ptr %10, align 8
  %cmp.i44.not.i20 = icmp eq ptr %Stack.2.val40.i19, null
  br i1 %cmp.i44.not.i20, label %while.body.i24, label %do.cond.i21

while.body.i24:                                   ; preds = %land.rhs.i17
  %L.val.i.i25 = load ptr, ptr %Stack.254.i18, align 8
  %11 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i26 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %11, i64 0, i32 4
  %12 = load i32, ptr %total_size.i.i.i.i26, align 8
  %conv26.i.i.i.i27 = sext i32 %12 to i64
  %13 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i28 = add i64 %13, %conv26.i.i.i.i27
  store i64 %add27.i.i.i.i28, ptr @memory_FREEDBYTES, align 8
  %14 = load ptr, ptr %11, align 8
  store ptr %14, ptr %Stack.254.i18, align 8
  %15 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Stack.254.i18, ptr %15, align 8
  %cmp.i.i42.not.i29 = icmp eq ptr %L.val.i.i25, null
  br i1 %cmp.i.i42.not.i29, label %term_ListOfVariables.exit40, label %land.rhs.i17, !llvm.loop !35

do.cond.i21:                                      ; preds = %land.rhs.i17
  %16 = getelementptr i8, ptr %Stack.254.i18, i64 8
  %17 = getelementptr i8, ptr %Stack.2.val40.i19, i64 8
  %call19.val.i22 = load ptr, ptr %17, align 8
  %call21.val.i23 = load ptr, ptr %Stack.2.val40.i19, align 8
  store ptr %call21.val.i23, ptr %16, align 8
  br label %do.body.i5, !llvm.loop !36

term_ListOfVariables.exit40:                      ; preds = %if.end9.i37, %while.body.i24
  %Variables.165.i30 = phi ptr [ %Variables.164.i15, %while.body.i24 ], [ %Variables.1.i38, %if.end9.i37 ]
  %call2 = tail call i32 @list_CompareMultisetsByElementDistribution(ptr noundef %Variables.165.i, ptr noundef %Variables.165.i30) #18
  %cmp.i.not5.i = icmp eq ptr %Variables.165.i, null
  br i1 %cmp.i.not5.i, label %list_Delete.exit, label %while.body.i41

while.body.i41:                                   ; preds = %term_ListOfVariables.exit40, %while.body.i41
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i41 ], [ %Variables.165.i, %term_ListOfVariables.exit40 ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  %18 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  ...
  %cmp.i.not.i42 = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i42, label %list_Delete.exit, label %while.body.i41, !llvm.loop !8

list_Delete.exit:                                 ; preds = %while.body.i41, %term_ListOfVariables.exit40
  %cmp.i.not5.i43 = icmp eq ptr %Variables.165.i30, null
  br i1 %cmp.i.not5.i43, label %list_Delete.exit51, label %while.body.i44

while.body.i44:                                   ; preds = %list_Delete.exit, %while.body.i44
  %Current.06.i45 = phi ptr [ %Current.0.val.i46, %while.body.i44 ], [ %Variables.165.i30, %list_Delete.exit ]
  %Current.0.val.i46 = load ptr, ptr %Current.06.i45, align 8
  %23 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i47 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %23, i64 0, i32 4
  %24 = load i32, ptr %total_size.i.i.i47, align 8
  %conv26.i.i.i48 = sext i32 %24 to i64
  %25 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i49 = add i64 %25, %conv26.i.i.i48
  store i64 %add27.i.i.i49, ptr @memory_FREEDBYTES, align 8
  %26 = load ptr, ptr %23, align 8
  store ptr %26, ptr %Current.06.i45, align 8
  %27 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i45, ptr %27, align 8
  %cmp.i.not.i50 = icmp eq ptr %Current.0.val.i46, null
  br i1 %cmp.i.not.i50, label %list_Delete.exit51, label %while.body.i44, !llvm.loop !8

list_Delete.exit51:                               ; preds = %while.body.i44, %list_Delete.exit
  ret i32 %call2
}
...
while.cond.i:                                     ; preds = %while.cond.i, %entry
  ...
  br i1 %cmp.not.i, label %while.cond.i2, label %while.cond.i, !llvm.loop !38

while.cond.i2:                                    ; preds = %while.cond.i, %while.cond.i2
  %Term.addr.0.i3 = phi ptr [ %Term.addr.0.val4.i5, %while.cond.i2 ], [ %Term2, %while.cond.i ]
  %Distance.0.i4 = phi i32 [ %inc.i7, %while.cond.i2 ], [ 0, %while.cond.i ]
  %1 = getelementptr i8, ptr %Term.addr.0.i3, i64 8
  %Term.addr.0.val4.i5 = load ptr, ptr %1, align 8
  %cmp.not.i6 = icmp eq ptr %Term.addr.0.val4.i5, null
  %inc.i7 = add i32 %Distance.0.i4, 1
  br i1 %cmp.not.i6, label %term_RootDistance.exit8, label %while.cond.i2, !llvm.loop !38

term_RootDistance.exit8:                          ; preds = %while.cond.i2
  %cmp = icmp ult i32 %Distance.0.i, %Distance.0.i4
  %conv = zext i1 %cmp to i32
  ret i32 %conv
}

; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @term_InstallSize(ptr nocapture noundef %Term) local_unnamed_addr #3 {
entry:
  %0 = getelementptr i8, ptr %Term, i64 16
...
define dso_local i32 @term_ContainsSymbol(ptr nocapture noundef readonly %Term, i32 noundef %Symbol) local_unnamed_addr #7 {
entry:
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i29.not, label %cleanup, label %land.rhs, !llvm.loop !41
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, argmem: read, inaccessiblemem: none) uwtable
define dso_local ptr @term_FindSubterm(ptr noundef readonly %Term, i32 noundef %Symbol) local_unnamed_addr #7 {
entry:
  %0 = load i32, ptr @stack_POINTER, align 4
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i30.not, label %cleanup, label %land.rhs, !llvm.loop !43
...
do.cond:                                          ; preds = %land.rhs
  ...
  br i1 %cmp, label %if.then, label %if.else, !llvm.loop !44
...
define dso_local i32 @term_Sharing(ptr noundef %Term) local_unnamed_addr #8 {
while.body.lr.ph:
  %0 = load i32, ptr @stack_POINTER, align 4
  %inc.i = add i32 %0, 1
...
if.else:                                          ; preds = %for.body
  ...
  br i1 %cmp.i33.not, label %if.end18, label %for.body, !llvm.loop !45
...
if.end18:                                         ; preds = %if.else, %if.then7, %if.end
  ...
  br i1 %cmp.i.not, label %cleanup, label %while.body, !llvm.loop !46
...
lor.lhs.false:                                    ; preds = %for.body
  ...
  br i1 %tobool6.not, label %cleanup, label %for.cond, !llvm.loop !50
...
while.cond:                                       ; preds = %while.cond, %entry
  ...
  br i1 %tobool.not, label %while.end, label %while.cond, !llvm.loop !51
...
while.body:                                       ; preds = %while.cond
  ...
  br i1 %tobool4.not, label %while.cond, label %cleanup, !llvm.loop !52
...
while.body:                                       ; preds = %while.cond
  ...
  %tobool6.not = icmp eq i32 %call5, 0
  br i1 %tobool6.not, label %while.cond, label %cleanup, !llvm.loop !53
...
if.else:                                          ; preds = %while.body
  ...
  br i1 %cmp1.not, label %return, label %while.body, !llvm.loop !54
...
for.inc20:                                        ; preds = %for.body13
  ...
  br i1 %cmp.i57.not, label %for.end22, label %for.body13, !llvm.loop !57

for.end22:                                        ; preds = %for.body13, %for.inc20, %if.then5
  %9 = load ptr, ptr @stdout, align 8
  %call.i61 = tail call i32 @putc(i32 noundef 41, ptr noundef %9)
  br label %if.end35

if.else28:                                        ; preds = %if.then
  %10 = load ptr, ptr @stdout, align 8
  %call.i62 = tail call i32 @putc(i32 noundef 40, ptr noundef %10)
  %Term.val51 = load i32, ptr %Term, align 8
  tail call void @symbol_Print(i32 noundef %Term.val51) #18
  %11 = load ptr, ptr @stdout, align 8
  %call.i63 = tail call i32 @putc(i32 noundef 41, ptr noundef %11)
  br label %if.end35
...
for.inc.i:                                        ; preds = %for.body.i
  %3 = load ptr, ptr @stdout, align 8
  %call.i14 = tail call i32 @putc(i32 noundef 44, ptr noundef %3)
  %List.addr.0.i.pre = load ptr, ptr %List.addr.0.i21, align 8
  %cmp.i17.not = icmp eq ptr %List.addr.0.i.pre, null
  br i1 %cmp.i17.not, label %term_TermListPrintPrefix.exit, label %for.body.i, !llvm.loop !59

term_TermListPrintPrefix.exit:                    ; preds = %for.body.i, %for.inc.i, %if.then
  %4 = load ptr, ptr @stdout, align 8
  %call.i13 = tail call i32 @putc(i32 noundef 41, ptr noundef %4)
  br label %if.end
...
for.inc:                                          ; preds = %for.body
  %1 = load ptr, ptr @stdout, align 8
  %call.i = tail call i32 @putc(i32 noundef 44, ptr noundef %1)
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i.i42.not, label %do.end, label %land.rhs, !llvm.loop !35
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, argmem: read, inaccessiblemem: none) uwtable
define dso_local void @term_MarkVariables(ptr nocapture noundef readonly %Term, i32 noundef %Mark) local_unnamed_addr #7 {
entry:
  %0 = load i32, ptr @stack_POINTER, align 4
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i33.not, label %do.end, label %land.rhs, !llvm.loop !64
...
for.body.i:                                       ; preds = %entry, %for.body.i.1
  ...
  br i1 %exitcond.not.i, label %term_ActMark.exit, label %for.body.i.1, !llvm.loop !66
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i48.not, label %do.end, label %land.rhs, !llvm.loop !67
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, argmem: read, inaccessiblemem: none) uwtable
define dso_local i32 @term_NumberOfVarOccs(ptr nocapture noundef readonly %Term) local_unnamed_addr #7 {
entry:
  %0 = load i32, ptr @stack_POINTER, align 4
  br label %do.body
...
while.body:                                       ; preds = %land.rhs
  store i32 %sub.i, ptr @stack_POINTER, align 4
  %cmp.i33.not = icmp eq i32 %sub.i, %0
  br i1 %cmp.i33.not, label %do.end, label %land.rhs, !llvm.loop !69
...
for.body:                                         ; preds = %entry, %for.body
  ...
  br i1 %cmp.i16.not, label %for.end, label %for.body, !llvm.loop !71
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, argmem: read, inaccessiblemem: none) uwtable
define dso_local i32 @term_ContainsFunctions(ptr nocapture noundef readonly %Term) local_unnamed_addr #7 {
entry:
  %0 = load i32, ptr @stack_POINTER, align 4
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i43.not, label %cleanup, label %land.rhs, !llvm.loop !72
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, argmem: read, inaccessiblemem: none) uwtable
define dso_local i32 @term_ContainsVariable(ptr nocapture noundef readonly %Term, i32 noundef %Var) local_unnamed_addr #7 {
entry:
  %0 = load i32, ptr @stack_POINTER, align 4
  br label %do.body
...
while.body:                                       ; preds = %land.rhs
  store i32 %sub.i, ptr @stack_POINTER, align 4
  %cmp.i33.not = icmp eq i32 %sub.i, %0
  br i1 %cmp.i33.not, label %cleanup, label %land.rhs, !llvm.loop !74
...
while.body37:                                     ; preds = %land.rhs
  ...
  br i1 %cmp.i75.not, label %while.end39, label %land.rhs, !llvm.loop !76

while.end:                                        ; preds = %land.rhs
  %cmp.i62.not = icmp eq i32 %stack_POINTER.promoted87, %0
  br i1 %cmp.i62.not, label %while.end39, label %while.body, !llvm.loop !77
...
define dso_local void @term_StartMinRenaming() local_unnamed_addr #10 {
entry:
...
for.body.i:                                       ; preds = %entry, %for.body.i.1
  ...
  %indvars.iv.next.i = or i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 3001
  br i1 %exitcond.not.i, label %term_NewMark.exit, label %for.body.i.1, !llvm.loop !78
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, argmem: none, inaccessiblemem: none) uwtable
define dso_local void @term_StartMaxRenaming(i32 noundef %MaxVar) local_unnamed_addr #10 {
entry:
...
define dso_local ptr @term_Rename(ptr noundef returned %Term) local_unnamed_addr #11 {
entry:
  %0 = load i32, ptr @stack_POINTER, align 4
  %1 = load i32, ptr @term_MARK, align 4
  %sub.i = add i32 %1, -1
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i51.not, label %do.end, label %land.rhs, !llvm.loop !79
...
define dso_local i32 @term_GetRenamedVarSymbol(i32 noundef %Var) local_unnamed_addr #12 {
entry:
  %0 = load i32, ptr @term_MARK, align 4
  %sub.i = add i32 %0, -1
...
for.body.i:                                       ; preds = %entry, %for.body.i.1
  ...
  %indvars.iv.next.i = or i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 3001
  br i1 %exitcond.not.i, label %term_ActMark.exit, label %for.body.i.1, !llvm.loop !78
...
term_NewMark.exit:                                ; preds = %entry
  ...
  br i1 %cmp.i2, label %for.body.i4, label %term_ActMark.exit

for.body.i4:                                      ; preds = %term_NewMark.exit, %for.body.i4.1
  %indvars.iv.i5 = phi i64 [ %indvars.iv.next.i7.3, %for.body.i4.1 ], [ 0, %term_NewMark.exit ]
  %arrayidx.i6 = getelementptr inbounds [3001 x [2 x ptr]], ptr @term_BIND, i64 0, i64 %indvars.iv.i5
  store ptr null, ptr %arrayidx.i6, align 16
  %indvars.iv.next.i7 = or i64 %indvars.iv.i5, 1
  %exitcond.not.i8 = icmp eq i64 %indvars.iv.next.i7, 3001
  br i1 %exitcond.not.i8, label %term_ActMark.exit, label %for.body.i4.1, !llvm.loop !66

for.body.i4.1:                                    ; preds = %for.body.i4
  %arrayidx.i6.1 = getelementptr inbounds [3001 x [2 x ptr]], ptr @term_BIND, i64 0, i64 %indvars.iv.next.i7
  store ptr null, ptr %arrayidx.i6.1, align 16
  %indvars.iv.next.i7.1 = or i64 %indvars.iv.i5, 2
  %arrayidx.i6.2 = getelementptr inbounds [3001 x [2 x ptr]], ptr @term_BIND, i64 0, i64 %indvars.iv.next.i7.1
  store ptr null, ptr %arrayidx.i6.2, align 16
  %indvars.iv.next.i7.2 = or i64 %indvars.iv.i5, 3
  %arrayidx.i6.3 = getelementptr inbounds [3001 x [2 x ptr]], ptr @term_BIND, i64 0, i64 %indvars.iv.next.i7.2
  store ptr null, ptr %arrayidx.i6.3, align 16
  %indvars.iv.next.i7.3 = add nuw nsw i64 %indvars.iv.i5, 4
  br label %for.body.i4

term_ActMark.exit:                                ; preds = %for.body.i4, %for.body.i, %term_NewMark.exit
  %1 = phi i32 [ %inc4.i, %term_NewMark.exit ], [ 2, %for.body.i ], [ 1, %for.body.i4 ]
  %inc4.i3 = add nuw i32 %1, 1
  store i32 %inc4.i3, ptr @term_MARK, align 4
...
for.body:                                         ; preds = %for.cond.preheader, %list_Nconc.exit
  %Result.057 = phi ptr [ null, %for.cond.preheader ], [ %retval.0.i, %list_Nconc.exit ]
  %Scan.056 = phi ptr [ %Term.val45, %for.cond.preheader ], [ %Scan.0.val44, %list_Nconc.exit ]
  %1 = getelementptr i8, ptr %Scan.056, i64 8
  %Scan.0.val = load ptr, ptr %1, align 8
...
if.end.i:                                         ; preds = %for.body
  %cmp.i18.not.i = icmp eq ptr %Result.057, null
  br i1 %cmp.i18.not.i, label %list_Nconc.exit, label %for.cond.i
...
for.end.i:                                        ; preds = %for.cond.i
  store ptr %Result.057, ptr %List1.addr.0.i, align 8
  br label %list_Nconc.exit

list_Nconc.exit:                                  ; preds = %for.body, %if.end.i, %for.end.i
  %retval.0.i = phi ptr [ %call6, %for.end.i ], [ %Result.057, %for.body ], [ %call6, %if.end.i ]
  %Scan.0.val44 = load ptr, ptr %Scan.056, align 8
  %cmp.i48.not = icmp eq ptr %Scan.0.val44, null
  br i1 %cmp.i48.not, label %if.end27, label %for.body, !llvm.loop !81
...
define dso_local i32 @term_StampOverflow(i32 noundef %ID) local_unnamed_addr #13 {
entry:
...
list_Nconc.exit:                                  ; preds = %for.body, %if.end.i, %for.end.i
  ...
  br i1 %cmp.i19.not, label %return, label %for.body, !llvm.loop !82
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i32.not, label %do.end, label %land.rhs, !llvm.loop !83
...
lor.lhs.false:                                    ; preds = %for.body
  ...
  br i1 %tobool30.not, label %cleanup, label %for.cond, !llvm.loop !85
...
lor.lhs.false44:                                  ; preds = %for.body39
  ...
  br i1 %tobool47.not, label %cleanup, label %for.cond35, !llvm.loop !86
