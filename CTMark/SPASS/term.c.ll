...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i.i.not, label %if.end22, label %land.rhs
...
while.body.i:                                     ; preds = %if.then15, %while.body.i
  ...
  br i1 %cmp.i.i.not.i, label %list_StackFree.exit, label %while.body.i
...
while.body.i112:                                  ; preds = %list_StackFree.exit, %while.body.i112
  ...
  br i1 %cmp.i.i.not.i118, label %cleanup, label %while.body.i112
...
if.then30:                                        ; preds = %land.lhs.true26
  ...
  br i1 %cmp.i.i120.not, label %cleanup, label %land.rhs
...
while.body.i133:                                  ; preds = %while.body.i133.preheader, %while.body.i133
  ...
  br i1 %cmp.i.i.not.i139, label %list_StackFree.exit140, label %while.body.i133
...
while.body.i142:                                  ; preds = %list_StackFree.exit140, %while.body.i142
  ...
  br i1 %cmp.i.i.not.i148, label %cleanup, label %while.body.i142
...
while.body.i157:                                  ; preds = %if.then38, %while.body.i157
  ...
  br i1 %cmp.i.i.not.i163, label %list_StackFree.exit164, label %while.body.i157
...
while.body.i166:                                  ; preds = %list_StackFree.exit164, %while.body.i166
  ...
  br i1 %cmp.i.i.not.i172, label %cleanup, label %while.body.i166
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i.i52.not, label %return, label %land.rhs
...
while.body27:                                     ; preds = %land.rhs
  ...
  br i1 %cmp.i58.not, label %if.end30, label %land.rhs

while.end:                                        ; preds = %land.rhs
  %cmp.i46.not = icmp eq i32 %7, %1
  br i1 %cmp.i46.not, label %if.end30, label %while.body
...
for.body:                                         ; preds = %if.else, %for.body
  ...
  br i1 %cmp.i21.not, label %if.end, label %for.body
...
for.body:                                         ; preds = %if.else, %for.body
  ...
  br i1 %cmp.i22.not, label %return, label %for.body
...
list_Nconc.exit:                                  ; preds = %for.body, %if.end.i, %for.end.i
  ...
  br i1 %cmp.i20.not, label %return, label %for.body
...
list_Nconc.exit:                                  ; preds = %for.body, %if.end.i, %for.end.i
  ...
  br i1 %cmp.i22.not, label %for.end, label %for.body
...
land.rhs.i53:                                     ; preds = %if.then
  ...
  %switch88 = icmp ult i32 %and.i.i55, 2
  br i1 %switch88, label %if.then5, label %cleanup
...
while.cond:                                       ; preds = %while.body, %if.end11
  ...
  br i1 %cmp.i61.not, label %cleanup, label %while.body
...
while.body:                                       ; preds = %while.cond
  ...
  br i1 %cmp19.not, label %while.cond, label %cleanup

if.else25:                                        ; preds = %land.rhs.i, %entry
  %tobool.not.i62 = icmp sgt i32 %Right.val50, -1
  br i1 %tobool.not.i62, label %symbol_IsFunction.exit70.thread, label %land.rhs.i63
...
land.rhs.i63:                                     ; preds = %if.else25
  ...
  %and.i.i65.fr = freeze i32 %and.i.i65
  %switch89 = icmp ult i32 %and.i.i65.fr, 2
  br i1 %switch89, label %cleanup, label %symbol_IsFunction.exit70.thread

symbol_IsFunction.exit70.thread:                  ; preds = %land.rhs.i63, %if.else25
  br label %cleanup

cleanup:                                          ; preds = %while.cond, %while.body, %land.rhs.i63, %land.rhs.i53, %if.then, %symbol_IsFunction.exit70.thread, %if.end, %if.then5
  %retval.0 = phi i32 [ -1, %if.then5 ], [ 1, %if.end ], [ 0, %symbol_IsFunction.exit70.thread ], [ -1, %if.then ], [ -1, %land.rhs.i53 ], [ 1, %land.rhs.i63 ], [ 0, %while.cond ], [ %call18, %while.body ]
  ret i32 %retval.0
}
...
while.body.i6.i:                                  ; preds = %list_Delete.exit.i, %while.body.i6.i
  ...
  br i1 %cmp.i.not.i12.i, label %term_CompareByConstants.exit, label %while.body.i6.i
...
while.body.i.i14:                                 ; preds = %for.cond.3, %while.body.i.i14
  ...
  br i1 %cmp.i.not.i.i20, label %list_Delete.exit.i21, label %while.body.i.i14
...
while.body.i6.i23:                                ; preds = %list_Delete.exit.i21, %while.body.i6.i23
  ...
  br i1 %cmp.i.not.i12.i29, label %cleanup, label %while.body.i6.i23
...
while.body:                                       ; preds = %while.cond
  ...
  br i1 %cmp25.not, label %while.cond, label %cleanup
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  br i1 %cmp.i.i42.not.i, label %term_ListOfVariables.exit, label %land.rhs.i
...
while.body.i24:                                   ; preds = %land.rhs.i17
  ...
  br i1 %cmp.i.i42.not.i29, label %term_ListOfVariables.exit40, label %land.rhs.i17
...
while.body.i41:                                   ; preds = %term_ListOfVariables.exit40, %while.body.i41
  ...
  br i1 %cmp.i.not.i42, label %list_Delete.exit, label %while.body.i41
...
while.body.i44:                                   ; preds = %list_Delete.exit, %while.body.i44
  ...
  br i1 %cmp.i.not.i50, label %list_Delete.exit51, label %while.body.i44
...
while.cond.i:                                     ; preds = %while.cond.i, %entry
  ...
  br i1 %cmp.not.i, label %while.cond.i2, label %while.cond.i
...
while.cond.i2:                                    ; preds = %while.cond.i, %while.cond.i2
  ...
  br i1 %cmp.not.i6, label %term_RootDistance.exit8, label %while.cond.i2
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i29.not, label %cleanup, label %land.rhs
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i30.not, label %cleanup, label %land.rhs
...
if.else:                                          ; preds = %for.body
  ...
  br i1 %cmp.i33.not, label %if.end18, label %for.body
...
while.body:                                       ; preds = %while.cond
  ...
  br i1 %tobool4.not, label %while.cond, label %cleanup
...
while.body:                                       ; preds = %while.cond
  ...
  %tobool6.not = icmp eq i32 %call5, 0
  br i1 %tobool6.not, label %while.cond, label %cleanup
...
for.inc20:                                        ; preds = %for.body13
  ...
  br i1 %cmp.i57.not, label %for.end22, label %for.body13
...
for.inc.i:                                        ; preds = %for.body.i
  ...
  br i1 %cmp.i17.not, label %term_TermListPrintPrefix.exit, label %for.body.i
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i.i42.not, label %do.end, label %land.rhs
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i33.not, label %do.end, label %land.rhs
...
for.body.i:                                       ; preds = %entry, %for.body.i.1
  ...
  br i1 %exitcond.not.i, label %term_ActMark.exit, label %for.body.i.1
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i48.not, label %do.end, label %land.rhs
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i43.not, label %cleanup, label %land.rhs
...
while.body:                                       ; preds = %land.rhs
  store i32 %sub.i, ptr @stack_POINTER, align 4
  %cmp.i33.not = icmp eq i32 %sub.i, %0
  br i1 %cmp.i33.not, label %cleanup, label %land.rhs
...
while.body37:                                     ; preds = %land.rhs
  ...
  br i1 %cmp.i75.not, label %while.end39, label %land.rhs

while.end:                                        ; preds = %land.rhs
  %cmp.i62.not = icmp eq i32 %stack_POINTER.promoted87, %0
  br i1 %cmp.i62.not, label %while.end39, label %while.body
...
for.body.i:                                       ; preds = %entry, %for.body.i.1
  ...
  %indvars.iv.next.i = or i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 3001
  br i1 %exitcond.not.i, label %term_NewMark.exit, label %for.body.i.1
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i51.not, label %do.end, label %land.rhs
...
for.body.i4:                                      ; preds = %term_NewMark.exit, %for.body.i4.1
  ...
  br i1 %exitcond.not.i8, label %term_ActMark.exit, label %for.body.i4.1
...
list_Nconc.exit:                                  ; preds = %for.body, %if.end.i, %for.end.i
  ...
  br i1 %cmp.i48.not, label %if.end27, label %for.body
...
list_Nconc.exit:                                  ; preds = %for.body, %if.end.i, %for.end.i
  ...
  br i1 %cmp.i19.not, label %return, label %for.body
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i32.not, label %do.end, label %land.rhs
...
lor.lhs.false:                                    ; preds = %for.body
  ...
  br i1 %tobool30.not, label %cleanup, label %for.cond
...
lor.lhs.false44:                                  ; preds = %for.body39
  ...
  br i1 %tobool47.not, label %cleanup, label %for.cond35
