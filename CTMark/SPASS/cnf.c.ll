; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/cnf.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/cnf.c"
...
@.str.3 = private unnamed_addr constant [54 x i8] c"/home/npopov/repos/llvm-test-suite/CTMark/SPASS/cnf.c\00", align 1
...
if.end:                                           ; preds = %memory_Free.exit, %entry
  ...
  tail call void @prfs_Delete(ptr noundef %13) #17
...
entry:
  ...
  %Def.val288386443 = load i32, ptr %Def, align 8
  %cmp.i387444 = icmp eq i32 %Def.val288386443, %0
...
lor.lhs.false.lr.ph.preheader:                    ; preds = %entry
  %.pre520 = load i32, ptr @fol_OR, align 4
  %.pre522 = load i32, ptr @fol_ALL, align 4
  %.pre524 = load i32, ptr @fol_EXIST, align 4
...
lor.lhs.false.lr.ph:                              ; preds = %lor.lhs.false.lr.ph.preheader, %tailrecurse.outer.backedge
  ...
  %2 = phi i32 [ %22, %tailrecurse.outer.backedge ], [ %.pre524, %lor.lhs.false.lr.ph.preheader ]
  %3 = phi i32 [ %23, %tailrecurse.outer.backedge ], [ %.pre522, %lor.lhs.false.lr.ph.preheader ]
  %4 = phi i32 [ %24, %tailrecurse.outer.backedge ], [ %.pre520, %lor.lhs.false.lr.ph.preheader ]
  %cmp.i387451 = phi i1 [ %cmp.i387, %tailrecurse.outer.backedge ], [ %cmp.i387444, %lor.lhs.false.lr.ph.preheader ]
  %Def.val288386450 = phi i32 [ %Def.val288386, %tailrecurse.outer.backedge ], [ %Def.val288386443, %lor.lhs.false.lr.ph.preheader ]
...
lor.lhs.false.us.peel:                            ; preds = %lor.lhs.false.lr.ph.split.us
  %cmp.i307.us.peel = icmp eq i32 %Def.val288386450, %4
  %or.cond366.demorgan.us.peel = or i1 %cmp.i387451, %cmp.i307.us.peel
  br i1 %or.cond366.demorgan.us.peel, label %if.then18, label %if.end28.us.peel

if.end28.us.peel:                                 ; preds = %lor.lhs.false.us.peel
  %cmp.i.not.i.us.peel = icmp ne i32 %3, %Def.val288386450
  %cmp.i4.i.us.peel = icmp ne i32 %2, %Def.val288386450
...
if.then32.us.peel:                                ; preds = %if.end28.us.peel
  ...
  %Def.val301.us.peel = load ptr, ptr %5, align 8
  %Def.val301.val.us.peel = load ptr, ptr %Def.val301.us.peel, align 8
  %6 = getelementptr i8, ptr %Def.val301.val.us.peel, i64 8
  %Def.val301.val.val.us.peel = load ptr, ptr %6, align 8
  %Def.val288.us.peel = load i32, ptr %Def.val301.val.val.us.peel, align 8
  %cmp.i.us.peel = icmp eq i32 %Def.val288.us.peel, %1
...
lor.lhs.false.lr.ph.split.us.split.us:            ; preds = %lor.lhs.false.lr.ph.split.us
  %cmp.i307.us.us435 = icmp eq i32 %Def.val288386450, %4
  %or.cond366.demorgan.us.us436 = or i1 %cmp.i387451, %cmp.i307.us.us435
  br i1 %or.cond366.demorgan.us.us436, label %if.then18, label %if.end28.us.us

if.end28.us.us:                                   ; preds = %lor.lhs.false.lr.ph.split.us.split.us, %if.then32.us.us
  %Def.tr389.us.us438 = phi ptr [ %Def.val301.val.val.us.us, %if.then32.us.us ], [ %Def.tr.ph446, %lor.lhs.false.lr.ph.split.us.split.us ]
  %Def.val288390.us.us437 = phi i32 [ %Def.val288.us.us, %if.then32.us.us ], [ %Def.val288386450, %lor.lhs.false.lr.ph.split.us.split.us ]
  %cmp.i.not.i.us.us = icmp ne i32 %3, %Def.val288390.us.us437
  %cmp.i4.i.us.us = icmp ne i32 %2, %Def.val288390.us.us437
...
if.then32.us.us:                                  ; preds = %if.end28.us.us
  ...
  %Def.val301.us.us = load ptr, ptr %7, align 8
  %Def.val301.val.us.us = load ptr, ptr %Def.val301.us.us, align 8
  %8 = getelementptr i8, ptr %Def.val301.val.us.us, i64 8
  %Def.val301.val.val.us.us = load ptr, ptr %8, align 8
  %Def.val288.us.us = load i32, ptr %Def.val301.val.val.us.us, align 8
  %cmp.i.us.us = icmp eq i32 %Def.val288.us.us, %1
  %cmp.i307.us.us = icmp eq i32 %Def.val288.us.us, %4
  %or.cond366.demorgan.us.us = or i1 %cmp.i.us.us, %cmp.i307.us.us
  br i1 %or.cond366.demorgan.us.us, label %if.then18, label %if.end28.us.us

lor.lhs.false.us:                                 ; preds = %if.then32.us.peel, %if.then32.us
  %Def.val288390.us = phi i32 [ %Def.val288.us, %if.then32.us ], [ %Def.val288.us.peel, %if.then32.us.peel ]
  %Def.tr389.us = phi ptr [ %Def.val301.val.val.us, %if.then32.us ], [ %Def.val301.val.val.us.peel, %if.then32.us.peel ]
  %cmp.i307.us = icmp eq i32 %Def.val288390.us, %4
  br i1 %cmp.i307.us, label %if.then18, label %if.end28.us

if.end28.us:                                      ; preds = %lor.lhs.false.us
  %cmp.i.not.i.us = icmp ne i32 %3, %Def.val288390.us
  %cmp.i4.i.us = icmp ne i32 %2, %Def.val288390.us
...
if.then32.us:                                     ; preds = %if.end28.us
  ...
  %Def.val301.us = load ptr, ptr %9, align 8
  %Def.val301.val.us = load ptr, ptr %Def.val301.us, align 8
  %10 = getelementptr i8, ptr %Def.val301.val.us, i64 8
  %Def.val301.val.val.us = load ptr, ptr %10, align 8
  %Def.val288.us = load i32, ptr %Def.val301.val.val.us, align 8
  %cmp.i.us = icmp eq i32 %Def.val288.us, %1
...
lor.lhs.false.peel:                               ; preds = %lor.lhs.false.lr.ph.split
  %cmp.i307.peel = icmp eq i32 %Def.val288386450, %4
  br i1 %cmp.i307.peel, label %return, label %if.end.peel

if.end.peel:                                      ; preds = %lor.lhs.false.peel
  br i1 %cmp.i387451, label %if.then18, label %if.end28.peel

if.end28.peel:                                    ; preds = %if.end.peel
  %cmp.i.not.i.peel = icmp ne i32 %3, %Def.val288386450
  %cmp.i4.i.peel = icmp ne i32 %2, %Def.val288386450
...
if.then32.peel:                                   ; preds = %if.end28.peel
  ...
  %Def.val301.peel = load ptr, ptr %11, align 8
  %Def.val301.val.peel = load ptr, ptr %Def.val301.peel, align 8
  %12 = getelementptr i8, ptr %Def.val301.val.peel, i64 8
  %Def.val301.val.val.peel = load ptr, ptr %12, align 8
  %Def.val288.peel = load i32, ptr %Def.val301.val.val.peel, align 8
  %cmp.i.peel = icmp eq i32 %Def.val288.peel, %1
  br i1 %cmp.i.peel, label %return, label %lor.lhs.false

lor.lhs.false.lr.ph.split.split.us:               ; preds = %lor.lhs.false.lr.ph.split
  %cmp.i307.us400424 = icmp eq i32 %Def.val288386450, %4
  br i1 %cmp.i307.us400424, label %return, label %if.end.us401

if.end.us401:                                     ; preds = %lor.lhs.false.lr.ph.split.split.us, %if.then32.us407
  %Def.tr389.us399427 = phi ptr [ %Def.val301.val.val.us410, %if.then32.us407 ], [ %Def.tr.ph446, %lor.lhs.false.lr.ph.split.split.us ]
  %Def.val288390.us398426 = phi i32 [ %Def.val288.us411, %if.then32.us407 ], [ %Def.val288386450, %lor.lhs.false.lr.ph.split.split.us ]
...
if.end28.us403:                                   ; preds = %if.end.us401
  %cmp.i.not.i.us404 = icmp ne i32 %3, %Def.val288390.us398426
  %cmp.i4.i.us405 = icmp ne i32 %2, %Def.val288390.us398426
...
if.then32.us407:                                  ; preds = %if.end28.us403
  ...
  %Def.val301.us408 = load ptr, ptr %13, align 8
  %Def.val301.val.us409 = load ptr, ptr %Def.val301.us408, align 8
  %14 = getelementptr i8, ptr %Def.val301.val.us409, i64 8
  %Def.val301.val.val.us410 = load ptr, ptr %14, align 8
  %Def.val288.us411 = load i32, ptr %Def.val301.val.val.us410, align 8
  %cmp.i.us412 = icmp eq i32 %Def.val288.us411, %1
  %cmp.i307.us400 = icmp eq i32 %Def.val288.us411, %4
  br i1 %cmp.i307.us400, label %return, label %if.end.us401

lor.lhs.false:                                    ; preds = %if.then32.peel, %if.then32
  %Def.val288390 = phi i32 [ %Def.val288, %if.then32 ], [ %Def.val288.peel, %if.then32.peel ]
  %Def.tr389 = phi ptr [ %Def.val301.val.val, %if.then32 ], [ %Def.val301.val.val.peel, %if.then32.peel ]
  %cmp.i307 = icmp eq i32 %Def.val288390, %4
  br i1 %cmp.i307, label %return, label %if.end28
...
if.then18:                                        ; preds = %lor.lhs.false.lr.ph.split.us.split.us, %if.then32.us.us, %lor.lhs.false.us, %lor.lhs.false.us.peel, %if.end.us401, %if.end.peel
  %Polarity.tr.ph447519 = phi i32 [ -1, %if.end.peel ], [ -1, %if.end.us401 ], [ %Polarity.tr.ph447, %lor.lhs.false.us.peel ], [ %Polarity.tr.ph447, %lor.lhs.false.us ], [ %Polarity.tr.ph447, %if.then32.us.us ], [ %Polarity.tr.ph447, %lor.lhs.false.lr.ph.split.us.split.us ]
  %.us-phi392 = phi ptr [ %Def.tr.ph446, %if.end.peel ], [ %Def.tr389.us399427, %if.end.us401 ], [ %Def.tr389.us, %lor.lhs.false.us ], [ %Def.tr.ph446, %lor.lhs.false.us.peel ], [ %Def.val301.val.val.us.us, %if.then32.us.us ], [ %Def.tr.ph446, %lor.lhs.false.lr.ph.split.us.split.us ]
...
for.cond:                                         ; preds = %for.body, %if.then18
  ...
  %cmp.i313.not = icmp eq ptr %l.0, null
  br i1 %cmp.i313.not, label %return, label %for.body

for.body:                                         ; preds = %for.cond
  %16 = getelementptr i8, ptr %l.0, i64 8
  %l.0.val = load ptr, ptr %16, align 8
  %call23 = tail call fastcc i32 @cnf_ContainsDefinitionIntern(ptr noundef %l.0.val, i32 noundef %Polarity.tr.ph447519, ptr noundef %FoundPred)
  %tobool24.not = icmp eq i32 %call23, 0
  br i1 %tobool24.not, label %for.cond, label %return

if.end28:                                         ; preds = %lor.lhs.false
  %cmp.i.not.i = icmp ne i32 %3, %Def.val288390
  %cmp.i4.i = icmp ne i32 %2, %Def.val288390
...
if.then32:                                        ; preds = %if.end28
  ...
  %Def.val301 = load ptr, ptr %17, align 8
  %Def.val301.val = load ptr, ptr %Def.val301, align 8
  %18 = getelementptr i8, ptr %Def.val301.val, i64 8
  %Def.val301.val.val = load ptr, ptr %18, align 8
  %Def.val288 = load i32, ptr %Def.val301.val.val, align 8
  %cmp.i = icmp eq i32 %Def.val288, %1
...
if.end35:                                         ; preds = %if.end28.us.us, %if.end28.us.peel, %if.end28.us, %if.end28.us403, %if.end28.peel, %if.end28
  ...
  %.us-phi394 = phi i32 [ %Def.val288386450, %if.end28.peel ], [ %Def.val288390, %if.end28 ], [ %Def.val288390.us398426, %if.end28.us403 ], [ %Def.val288386450, %if.end28.us.peel ], [ %Def.val288390.us, %if.end28.us ], [ %Def.val288390.us.us437, %if.end28.us.us ]
  ...
  %cmp.i315.not = icmp eq i32 %.us-phi394, %19
  br i1 %cmp.i315.not, label %if.then40, label %if.end43
...
tailrecurse.outer.backedge:                       ; preds = %if.then40, %if.end56
  %21 = phi i32 [ %.pre525, %if.end56 ], [ %1, %if.then40 ]
  %22 = phi i32 [ %.pre523, %if.end56 ], [ %2, %if.then40 ]
  %23 = phi i32 [ %.pre521, %if.end56 ], [ %3, %if.then40 ]
  %24 = phi i32 [ %.pre, %if.end56 ], [ %4, %if.then40 ]
  %Def.val300.val.pn.in = phi ptr [ %Def.val300, %if.end56 ], [ %20, %if.then40 ]
  %Polarity.tr.ph.be = phi i32 [ 1, %if.end56 ], [ %sub, %if.then40 ]
  %Def.val300.val.pn = load ptr, ptr %Def.val300.val.pn.in, align 8
  %Def.tr.ph.be.in = getelementptr i8, ptr %Def.val300.val.pn, i64 8
  %Def.tr.ph.be = load ptr, ptr %Def.tr.ph.be.in, align 8
  %cmp = icmp eq i32 %Polarity.tr.ph.be, 1
  %Def.val288386 = load i32, ptr %Def.tr.ph.be, align 8
  %cmp.i387 = icmp eq i32 %Def.val288386, %21
...
if.end43:                                         ; preds = %if.end35
  ...
  %cmp.i317.not = icmp eq i32 %.us-phi394, %25
  br i1 %cmp.i317.not, label %if.then48, label %if.end60
...
if.then50:                                        ; preds = %if.then48
  ...
  %Def.val302 = load ptr, ptr %26, align 8
  %27 = getelementptr i8, ptr %Def.val302, i64 8
  %Def.val302.val = load ptr, ptr %27, align 8
  %call53 = tail call fastcc i32 @cnf_ContainsDefinitionIntern(ptr noundef %Def.val302.val, i32 noundef -1, ptr noundef %FoundPred)
  %tobool54.not = icmp eq i32 %call53, 0
  br i1 %tobool54.not, label %if.end56, label %return

if.end56:                                         ; preds = %if.then50
  %.pre523 = load i32, ptr @fol_EXIST, align 4
  %.pre521 = load i32, ptr @fol_ALL, align 4
  %.pre = load i32, ptr @fol_OR, align 4
  %Def.val300 = load ptr, ptr %26, align 8
  %.pre525 = load i32, ptr @fol_AND, align 4
  br label %tailrecurse.outer.backedge

if.end60:                                         ; preds = %if.end43
  %28 = load i32, ptr @fol_EQUIV, align 4
  %cmp.i319 = icmp eq i32 %.us-phi394, %28
  %or.cond204 = and i1 %.us-phi395, %cmp.i319
...
while.body:                                       ; preds = %while.body.preheader, %while.body
  ...
  %defpath.0453 = phi ptr [ %call.i321, %while.body ], [ null, %while.body.preheader ]
  %call.i321 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i321, i64 0, i32 1
  store ptr %super.0454, ptr %car.i, align 8
  store ptr %defpath.0453, ptr %call.i321, align 8
  %29 = getelementptr i8, ptr %super.0454, i64 8
  %super.0.val = load ptr, ptr %29, align 8
  %cmp75.not = icmp eq ptr %super.0.val, null
  br i1 %cmp75.not, label %for.body82, label %while.body

for.body82:                                       ; preds = %while.body, %for.inc116
  %pol.0459 = phi i32 [ %pol.1, %for.inc116 ], [ 1, %while.body ]
  %l71.0457 = phi ptr [ %l71.0.val297, %for.inc116 ], [ %call.i321, %while.body ]
  %30 = getelementptr i8, ptr %l71.0457, i64 8
  %l71.0.val293 = load ptr, ptr %30, align 8
  ...
  store ptr %l71.0.val293, ptr %car.i.i, align 8
  ...
  %cmp.i325.not = icmp eq i32 %call85.val, %32
  br i1 %cmp.i325.not, label %if.then90, label %if.else
...
if.else:                                          ; preds = %for.body82
  ...
  %cmp.i327.not = icmp eq i32 %call85.val, %33
  br i1 %cmp.i327.not, label %land.lhs.true97, label %if.else106
...
land.lhs.true97:                                  ; preds = %if.else
  ...
  %l71.0.val298 = load ptr, ptr %l71.0457, align 8
  %36 = getelementptr i8, ptr %l71.0.val298, i64 8
...
if.else106:                                       ; preds = %land.lhs.true97, %if.else
  ...
  %cmp.i329.not = icmp eq i32 %call85.val, %37
  %spec.select = select i1 %cmp.i329.not, i32 0, i32 %pol.0459
  br label %for.inc116
...
for.inc116:                                       ; preds = %if.else106, %if.then90, %if.then104
  ...
  %cmp.i322.not = icmp eq ptr %l71.0.val297, null
  br i1 %cmp.i322.not, label %land.rhs, label %for.body82

land.rhs:                                         ; preds = %for.inc116, %for.inc188
  %allquantifierfound.0471 = phi i32 [ %allquantifierfound.2.ph, %for.inc188 ], [ 0, %for.inc116 ]
  %l71.1470 = phi ptr [ %l71.1.val294, %for.inc188 ], [ %call.i321, %for.inc116 ]
  %predicate_vars.0469 = phi ptr [ %predicate_vars.3.ph, %for.inc188 ], [ %call.i, %for.inc116 ]
  %cmp.i333.not = icmp eq ptr %predicate_vars.0469, null
  br i1 %cmp.i333.not, label %for.end190, label %for.body125

for.body125:                                      ; preds = %land.rhs
  %38 = getelementptr i8, ptr %l71.1470, i64 8
  %l71.1.val = load ptr, ptr %38, align 8
  %39 = getelementptr i8, ptr %l71.1.val, i64 8
  %call126.val = load ptr, ptr %39, align 8
  %call127.val281 = load i32, ptr %call126.val, align 8
  %40 = load i32, ptr @fol_ALL, align 4
  %cmp.i.not.i335 = icmp eq i32 %40, %call127.val281
  %41 = load i32, ptr @fol_EXIST, align 4
  %cmp.i4.i336 = icmp eq i32 %41, %call127.val281
  %narrow.i337 = select i1 %cmp.i.not.i335, i1 true, i1 %cmp.i4.i336
  br i1 %narrow.i337, label %if.then132, label %for.inc188

if.then132:                                       ; preds = %for.body125
  %call126.val304 = load ptr, ptr %l71.1.val, align 8
  %42 = ptrtoint ptr %call126.val304 to i64
  %43 = trunc i64 %42 to i32
  %cmp138 = icmp eq i32 %43, 1
  %or.cond205 = select i1 %cmp.i.not.i335, i1 %cmp138, i1 false
  %cmp146 = icmp eq i32 %43, -1
  %or.cond206 = select i1 %cmp.i4.i336, i1 %cmp146, i1 false
  %or.cond367 = select i1 %or.cond205, i1 true, i1 %or.cond206
  br i1 %or.cond367, label %if.then148, label %if.else160

if.then148:                                       ; preds = %if.then132
  %44 = getelementptr i8, ptr %call126.val, i64 16
  %call127.val306 = load ptr, ptr %44, align 8
  %45 = getelementptr i8, ptr %call127.val306, i64 8
  %call127.val306.val = load ptr, ptr %45, align 8
  %46 = getelementptr i8, ptr %call127.val306.val, i64 16
  %scan.0463 = load ptr, ptr %46, align 8
  %cmp.i343.not464 = icmp eq ptr %scan.0463, null
  br i1 %cmp.i343.not464, label %for.inc188, label %for.body154
...
for.body154:                                      ; preds = %if.then148, %for.body154
  ...
  %call156 = tail call ptr @list_DeleteElement(ptr noundef %predicate_vars.1465, ptr noundef %scan.0.val, ptr noundef nonnull @term_Equal) #17
  %scan.0 = load ptr, ptr %scan.0466, align 8
  %cmp.i343.not = icmp eq ptr %scan.0, null
  br i1 %cmp.i343.not, label %for.inc188, label %for.body154

if.else160:                                       ; preds = %if.then132
  %tobool161.not = icmp eq i32 %allquantifierfound.0471, 0
...
while.body.i:                                     ; preds = %if.else160, %while.body.i
  ...
  %cmp.i.not.i345 = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i345, label %list_Delete.exit, label %while.body.i

list_Delete.exit:                                 ; preds = %while.body.i
  tail call void @list_DeleteWithElement(ptr noundef nonnull %call.i321, ptr noundef nonnull @list_PairFree) #17
  br label %return

if.else163:                                       ; preds = %if.else160
  %53 = getelementptr i8, ptr %call126.val, i64 16
  %call127.val305 = load ptr, ptr %53, align 8
  %54 = getelementptr i8, ptr %call127.val305, i64 8
  %call127.val305.val = load ptr, ptr %54, align 8
  %55 = getelementptr i8, ptr %call127.val305.val, i64 16
  %scan164.0460 = load ptr, ptr %55, align 8
  %cmp.i346.not461 = icmp eq ptr %scan164.0460, null
  br i1 %cmp.i346.not461, label %for.inc188, label %for.body170
...
while.body.i.i:                                   ; preds = %for.body170, %if.end.i.i
  ...
  %call2.i.i = tail call i32 @term_Equal(ptr noundef %scan164.0.val, ptr noundef %List.addr.0.val.i.i) #17
  %tobool3.not.i.i = icmp eq i32 %call2.i.i, 0
  br i1 %tobool3.not.i.i, label %if.end.i.i, label %while.body.i349

if.end.i.i:                                       ; preds = %while.body.i.i
  %List.addr.0.val7.i.i = load ptr, ptr %List.addr.09.i.i, align 8
  %cmp.i.not.i.i = icmp eq ptr %List.addr.0.val7.i.i, null
  br i1 %cmp.i.not.i.i, label %for.inc176.loopexit, label %while.body.i.i

while.body.i349:                                  ; preds = %while.body.i.i, %while.body.i349
  %Current.06.i350 = phi ptr [ %Current.0.val.i351, %while.body.i349 ], [ %predicate_vars.0469, %while.body.i.i ]
  %Current.0.val.i351 = load ptr, ptr %Current.06.i350, align 8
  %58 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i352 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %58, i64 0, i32 4
  %59 = load i32, ptr %total_size.i.i.i352, align 8
  %conv26.i.i.i353 = sext i32 %59 to i64
  %60 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i354 = add i64 %60, %conv26.i.i.i353
  store i64 %add27.i.i.i354, ptr @memory_FREEDBYTES, align 8
  %61 = load ptr, ptr %58, align 8
  store ptr %61, ptr %Current.06.i350, align 8
  %62 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i350, ptr %62, align 8
  %cmp.i.not.i355 = icmp eq ptr %Current.0.val.i351, null
  br i1 %cmp.i.not.i355, label %list_Delete.exit356, label %while.body.i349

list_Delete.exit356:                              ; preds = %while.body.i349
  tail call void @list_DeleteWithElement(ptr noundef nonnull %call.i321, ptr noundef nonnull @list_PairFree) #17
  br label %return

for.inc176.loopexit:                              ; preds = %if.end.i.i
  %scan164.0 = load ptr, ptr %scan164.0462, align 8
  %cmp.i346.not = icmp eq ptr %scan164.0, null
  br i1 %cmp.i346.not, label %for.inc188, label %for.body170
...
for.inc188:                                       ; preds = %for.inc176.loopexit, %for.body154, %if.else163, %if.then148, %for.body125
  ...
  %allquantifierfound.2.ph = phi i32 [ %allquantifierfound.0471, %for.body125 ], [ 1, %if.then148 ], [ 0, %if.else163 ], [ 1, %for.body154 ], [ 0, %for.inc176.loopexit ]
  %l71.1.val294 = load ptr, ptr %l71.1470, align 8
  %cmp.i331.not = icmp eq ptr %l71.1.val294, null
  br i1 %cmp.i331.not, label %for.end190, label %land.rhs
...
return:                                           ; preds = %lor.lhs.false.lr.ph.split.split.us, %tailrecurse.outer.backedge, %if.then48, %if.then50, %if.then32.us, %if.then32.us.peel, %if.then32.us407, %lor.lhs.false, %if.then32, %lor.lhs.false.peel, %if.then32.peel, %for.body, %for.cond, %entry, %if.end60, %if.then67, %for.end190, %list_Delete.exit356, %list_Delete.exit
  %retval.7 = phi i32 [ 1, %for.end190 ], [ 0, %list_Delete.exit356 ], [ 0, %list_Delete.exit ], [ 0, %if.then67 ], [ 0, %if.end60 ], [ 0, %entry ], [ 0, %for.cond ], [ 1, %for.body ], [ 0, %if.then32.peel ], [ 0, %lor.lhs.false.peel ], [ 0, %if.then32 ], [ 0, %lor.lhs.false ], [ 0, %if.then32.us407 ], [ 0, %if.then32.us.peel ], [ 0, %if.then32.us ], [ 0, %lor.lhs.false.lr.ph.split.split.us ], [ 0, %tailrecurse.outer.backedge ], [ 1, %if.then50 ], [ 0, %if.then48 ]
  ret i32 %retval.7
}
...
if.end121.us:                                     ; preds = %if.then115.us
  ...
  br i1 %cmp.i.us, label %if.then, label %lor.lhs.false.us
...
if.then115.us359:                                 ; preds = %if.end110.us358
  ...
  %call118.us362 = tail call fastcc i32 @cnf_ContainsPredicateIntern(ptr noundef %Target.val248.val.us361, i32 noundef %Predicate, i32 noundef %sub117, ptr noundef %TargetPredicate, ptr noundef %ToTopLevel, ptr noundef %TargetVars, ptr noundef %VarsForTopLevel)
...
list_Nconc.exit:                                  ; preds = %for.body, %if.end.i, %for.end.i
  ...
  br i1 %cmp.i257.not, label %return.sink.split, label %for.body
...
for.body50:                                       ; preds = %for.cond46
  ...
  %call52 = tail call fastcc i32 @cnf_ContainsPredicateIntern(ptr noundef %l44.0.val, i32 noundef %Predicate, i32 noundef %Polarity.tr.ph427548, ptr noundef %TargetPredicate, ptr noundef %ToTopLevel, ptr noundef %TargetVars, ptr noundef %VarsForTopLevel)
  %tobool53.not = icmp eq i32 %call52, 0
  br i1 %tobool53.not, label %for.cond46, label %return
...
if.then64:                                        ; preds = %if.end60.us.us, %if.end60.us, %if.end60.us.peel, %if.end60.us352, %if.end60, %if.end60.peel
  ...
  %call66 = tail call fastcc i32 @cnf_ContainsPredicateIntern(ptr noundef %Target.val247.val.val, i32 noundef %Predicate, i32 noundef %Polarity.tr.ph427549, ptr noundef %TargetPredicate, ptr noundef %ToTopLevel, ptr noundef %TargetVars, ptr noundef %VarsForTopLevel)
...
while.body.i.i:                                   ; preds = %for.body88, %if.end.i.i
  ...
  %call2.i.i = tail call i32 @term_Equal(ptr noundef %l83.0.val241, ptr noundef %List.addr.0.val.i.i) #17
  %tobool3.not.i.i = icmp eq i32 %call2.i.i, 0
...
if.end.i.i:                                       ; preds = %while.body.i.i
  %List.addr.0.val7.i.i = load ptr, ptr %List.addr.09.i.i, align 8
  %cmp.i.not.i.i = icmp eq ptr %List.addr.0.val7.i.i, null
  br i1 %cmp.i.not.i.i, label %for.inc97, label %while.body.i.i
...
for.inc97:                                        ; preds = %if.end.i.i, %for.body88, %if.then93
  ...
  br i1 %cmp.i270.not, label %return, label %for.body88
...
for.body135:                                      ; preds = %if.then128, %list_Nconc.exit290
  ...
  br i1 %cmp.i.not.i281, label %list_Nconc.exit290, label %if.end.i282

if.end.i282:                                      ; preds = %for.body135
  %cmp.i18.not.i283 = icmp eq ptr %95, null
  br i1 %cmp.i18.not.i283, label %list_Nconc.exit290, label %for.cond.i284

for.cond.i284:                                    ; preds = %if.end.i282, %for.cond.i284
  %List1.addr.0.i285 = phi ptr [ %List1.addr.0.val17.i286, %for.cond.i284 ], [ %call137, %if.end.i282 ]
  %List1.addr.0.val17.i286 = load ptr, ptr %List1.addr.0.i285, align 8
  %cmp.i20.not.i287 = icmp eq ptr %List1.addr.0.val17.i286, null
  br i1 %cmp.i20.not.i287, label %for.end.i288, label %for.cond.i284

for.end.i288:                                     ; preds = %for.cond.i284
  store ptr %95, ptr %List1.addr.0.i285, align 8
  br label %list_Nconc.exit290

list_Nconc.exit290:                               ; preds = %for.body135, %if.end.i282, %for.end.i288
  %retval.0.i289 = phi ptr [ %call137, %for.end.i288 ], [ %95, %for.body135 ], [ %call137, %if.end.i282 ]
  store ptr %retval.0.i289, ptr %TargetVars, align 8
  %l129.0 = load ptr, ptr %l129.0438, align 8
  %cmp.i279.not = icmp eq ptr %l129.0, null
  br i1 %cmp.i279.not, label %return.sink.split, label %for.body135
...
for.inc:                                          ; preds = %for.body, %if.then8
  ...
  br i1 %cmp.i.not, label %while.body.i, label %for.body
...
while.body.i:                                     ; preds = %for.inc, %while.body.i
  ...
  br i1 %cmp.i.not.i, label %list_Delete.exit, label %while.body.i
...
for.body:                                         ; preds = %if.then12, %for.body
  ...
  br i1 %cmp.i75.not, label %common.ret110, label %for.body
...
for.inc.us.thread.i:                              ; preds = %for.body.us.i
  ...
  %call.i.us.i = tail call ptr @list_CopyWithElement(ptr noundef %call16.val.us.i, ptr noundef nonnull @term_Copy) #17
...
for.inc.us.i:                                     ; preds = %for.body.us.i
  ...
  br i1 %cmp.i59.us.i.not, label %if.end36.us.i, label %for.body.us.i
...
for.body30.us.i:                                  ; preds = %if.else.us.i, %for.body30.us.i
  ...
  %scan.176.us.i = phi ptr [ %scan.1.val54.us.i, %for.body30.us.i ], [ %call2.val52.us.i, %if.else.us.i ]
  %23 = getelementptr i8, ptr %scan.176.us.i, i64 8
  ...
  %scan.1.val54.us.i = load ptr, ptr %scan.176.us.i, align 8
  %cmp.i65.not.us.i = icmp eq ptr %scan.1.val54.us.i, null
  br i1 %cmp.i65.not.us.i, label %if.end36.us.i, label %for.body30.us.i
...
if.end36.us.i:                                    ; preds = %for.inc.us.i, %for.body30.us.i, %for.inc.us.thread.i, %if.else.us.i
  ...
  br i1 %cmp.not.us.i, label %cnf_RplacVar.exit, label %while.body.us.i
...
while.body.i:                                     ; preds = %if.then26, %if.end36.i
  %26 = phi i32 [ %vec_MAX.promoted79.i, %if.end36.i ], [ %inc.i.i, %if.then26 ]
...
for.body30.i:                                     ; preds = %for.body30.i, %for.body30.preheader.i
  %indvars.iv83.i = phi i64 [ %30, %for.body30.preheader.i ], [ %indvars.iv.next84.i, %for.body30.i ]
  %scan.176.i = phi ptr [ %call2.val52.i, %for.body30.preheader.i ], [ %scan.1.val54.i, %for.body30.i ]
  %31 = getelementptr i8, ptr %scan.176.i, i64 8
  %scan.1.val.i = load ptr, ptr %31, align 8
  %indvars.iv.next84.i = add i64 %indvars.iv83.i, 1
  %32 = trunc i64 %indvars.iv.next84.i to i32
  store i32 %32, ptr @vec_MAX, align 4
  %arrayidx.i69.i = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %indvars.iv83.i
  store ptr %scan.1.val.i, ptr %arrayidx.i69.i, align 8
  %scan.1.val54.i = load ptr, ptr %scan.176.i, align 8
  %cmp.i65.not.i = icmp eq ptr %scan.1.val54.i, null
  br i1 %cmp.i65.not.i, label %if.end36.i, label %for.body30.i

if.end36.i:                                       ; preds = %for.body30.i, %if.else.i, %while.body.i
  %vec_MAX.promoted79.i = phi i32 [ %dec.i.i, %if.else.i ], [ %dec.i.i, %while.body.i ], [ %32, %for.body30.i ]
  %cmp.not.i = icmp eq i32 %16, %vec_MAX.promoted79.i
  br i1 %cmp.not.i, label %cnf_RplacVar.exit, label %while.body.i
...
list_Delete.exit:                                 ; preds = %while.body.i
  ...
  br i1 %cmp.i.not5.i141, label %list_Delete.exit149, label %while.body.i142

while.body.i142:                                  ; preds = %list_Delete.exit, %while.body.i142
  %Current.06.i143 = phi ptr [ %Current.0.val.i144, %while.body.i142 ], [ %call7.val128, %list_Delete.exit ]
  ...
  %total_size.i.i.i145 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %21, i64 0, i32 4
  %22 = load i32, ptr %total_size.i.i.i145, align 8
  %conv26.i.i.i146 = sext i32 %22 to i64
  %23 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i147 = add i64 %23, %conv26.i.i.i146
  store i64 %add27.i.i.i147, ptr @memory_FREEDBYTES, align 8
  %24 = load ptr, ptr %21, align 8
  store ptr %24, ptr %Current.06.i143, align 8
  %25 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i143, ptr %25, align 8
  %cmp.i.not.i148 = icmp eq ptr %Current.0.val.i144, null
  br i1 %cmp.i.not.i148, label %list_Delete.exit149, label %while.body.i142

list_Delete.exit149:                              ; preds = %while.body.i142, %list_Delete.exit
...
cnf_GetDualSymbol.exit:                           ; preds = %if.else
  ...
  br i1 %cmp.i.not5.i159, label %list_Delete.exit167, label %while.body.i160

while.body.i160:                                  ; preds = %cnf_GetDualSymbol.exit, %while.body.i160
  %Current.06.i161 = phi ptr [ %Current.0.val.i162, %while.body.i160 ], [ %call2.val126, %cnf_GetDualSymbol.exit ]
  %Current.0.val.i162 = load ptr, ptr %Current.06.i161, align 8
  %36 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i163 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %36, i64 0, i32 4
  %37 = load i32, ptr %total_size.i.i.i163, align 8
  %conv26.i.i.i164 = sext i32 %37 to i64
  %38 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i165 = add i64 %38, %conv26.i.i.i164
  store i64 %add27.i.i.i165, ptr @memory_FREEDBYTES, align 8
  %39 = load ptr, ptr %36, align 8
  store ptr %39, ptr %Current.06.i161, align 8
  %40 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i161, ptr %40, align 8
  %cmp.i.not.i166 = icmp eq ptr %Current.0.val.i162, null
  br i1 %cmp.i.not.i166, label %list_Delete.exit167, label %while.body.i160

list_Delete.exit167:                              ; preds = %while.body.i160, %cnf_GetDualSymbol.exit
...
if.else8.i176:                                    ; preds = %if.else34
  %spec.select.i180 = select i1 %cmp.i171.not, i32 %41, i32 %call7.val119
  %spec.select = select i1 %cmp.i169.not, i32 %42, i32 %spec.select.i180
...
for.end.thread:                                   ; preds = %if.else8.i176
  ...
  br label %while.body.i188.preheader

for.body:                                         ; preds = %if.else8.i176, %for.body
  %scan.0209 = phi ptr [ %scan.0, %for.body ], [ %scan.0207, %if.else8.i176 ]
  %44 = getelementptr i8, ptr %scan.0209, i64 8
  %scan.0.val = load ptr, ptr %44, align 8
  %45 = load i32, ptr @fol_NOT, align 4
  %call.i.i185 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  ...
  %call52 = tail call ptr @term_Create(i32 noundef %45, ptr noundef nonnull %call.i.i185) #17
  store ptr %call52, ptr %44, align 8
  %scan.0 = load ptr, ptr %scan.0209, align 8
  %cmp.i183.not = icmp eq ptr %scan.0, null
  br i1 %cmp.i183.not, label %for.end, label %for.body

for.end:                                          ; preds = %for.body
  %call2.val123.pre = load ptr, ptr %4, align 8
  store i32 %spec.select, ptr %2, align 8
  %cmp.i.not5.i187 = icmp eq ptr %call2.val123.pre, null
  br i1 %cmp.i.not5.i187, label %list_Delete.exit195, label %while.body.i188.preheader

while.body.i188.preheader:                        ; preds = %for.end.thread, %for.end
  %Current.06.i189.ph = phi ptr [ %call2.val123.pre, %for.end ], [ %call2.val130, %for.end.thread ]
  br label %while.body.i188

while.body.i188:                                  ; preds = %while.body.i188.preheader, %while.body.i188
  %Current.06.i189 = phi ptr [ %Current.0.val.i190, %while.body.i188 ], [ %Current.06.i189.ph, %while.body.i188.preheader ]
  %Current.0.val.i190 = load ptr, ptr %Current.06.i189, align 8
  %46 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i191 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %46, i64 0, i32 4
  %47 = load i32, ptr %total_size.i.i.i191, align 8
  %conv26.i.i.i192 = sext i32 %47 to i64
  %48 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i193 = add i64 %48, %conv26.i.i.i192
  store i64 %add27.i.i.i193, ptr @memory_FREEDBYTES, align 8
  %49 = load ptr, ptr %46, align 8
  store ptr %49, ptr %Current.06.i189, align 8
  %50 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i189, ptr %50, align 8
  %cmp.i.not.i194 = icmp eq ptr %Current.0.val.i190, null
  br i1 %cmp.i.not.i194, label %list_Delete.exit195, label %while.body.i188

list_Delete.exit195:                              ; preds = %while.body.i188, %for.end
  %call7.val122 = load ptr, ptr %43, align 8
  %call.i196 = tail call ptr @list_CopyWithElement(ptr noundef %call7.val122, ptr noundef nonnull @term_Copy) #17
...
for.body69:                                       ; preds = %for.cond65.preheader, %for.body69
  ...
  %scan.1212 = phi ptr [ %call2.val121, %for.cond65.preheader ], [ %scan.1.val131, %for.body69 ]
  %53 = getelementptr i8, ptr %scan.1212, i64 8
  ...
  %scan.1.val131 = load ptr, ptr %scan.1212, align 8
  %cmp.i200.not = icmp eq ptr %scan.1.val131, null
  br i1 %cmp.i200.not, label %if.end74, label %for.body69
...
list_Nconc.exit:                                  ; preds = %if.end36, %if.end.i, %for.end.i
  ...
  br i1 %cmp.i132.not, label %for.cond19.for.inc41_crit_edge, label %for.body23
...
for.cond19.for.inc41_crit_edge:                   ; preds = %list_Nconc.exit
  ...
  br i1 %cmp.i130.not, label %for.end43, label %for.cond19.preheader
...
while.body.i:                                     ; preds = %while.body.i.preheader, %while.body.i
  ...
  br i1 %cmp.i.not.i141, label %list_Delete.exit, label %while.body.i
...
list_Delete.exit:                                 ; preds = %while.body.i, %for.body, %for.end43
  ...
  br i1 %cmp.i.not5.i142, label %list_Delete.exit150, label %while.body.i143

while.body.i143:                                  ; preds = %list_Delete.exit, %while.body.i143
  %Current.06.i144 = phi ptr [ %Current.0.val.i145, %while.body.i143 ], [ %Result.0187, %list_Delete.exit ]
  ...
  %total_size.i.i.i146 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %11, i64 0, i32 4
  %12 = load i32, ptr %total_size.i.i.i146, align 8
  %conv26.i.i.i147 = sext i32 %12 to i64
  %13 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i148 = add i64 %13, %conv26.i.i.i147
  store i64 %add27.i.i.i148, ptr @memory_FREEDBYTES, align 8
  %14 = load ptr, ptr %11, align 8
  store ptr %14, ptr %Current.06.i144, align 8
  %15 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i144, ptr %15, align 8
  %cmp.i.not.i149 = icmp eq ptr %Current.0.val.i145, null
  br i1 %cmp.i.not.i149, label %list_Delete.exit150, label %while.body.i143

list_Delete.exit150:                              ; preds = %while.body.i143, %list_Delete.exit
  %Scan.0 = load ptr, ptr %Scan.0189, align 8
  %cmp.i128.not = icmp eq ptr %Scan.0, null
  br i1 %cmp.i128.not, label %cleanup, label %for.body
...
for.body61:                                       ; preds = %if.then51, %list_Nconc.exit164
  ...
  br i1 %cmp.i.not.i155, label %list_Nconc.exit164, label %if.end.i156

if.end.i156:                                      ; preds = %for.body61
  %cmp.i18.not.i157 = icmp eq ptr %Result.1175, null
  br i1 %cmp.i18.not.i157, label %list_Nconc.exit164, label %for.cond.i158

for.cond.i158:                                    ; preds = %if.end.i156, %for.cond.i158
  %List1.addr.0.i159 = phi ptr [ %List1.addr.0.val17.i160, %for.cond.i158 ], [ %call63, %if.end.i156 ]
  %List1.addr.0.val17.i160 = load ptr, ptr %List1.addr.0.i159, align 8
  %cmp.i20.not.i161 = icmp eq ptr %List1.addr.0.val17.i160, null
  br i1 %cmp.i20.not.i161, label %for.end.i162, label %for.cond.i158

for.end.i162:                                     ; preds = %for.cond.i158
  store ptr %Result.1175, ptr %List1.addr.0.i159, align 8
  br label %list_Nconc.exit164

list_Nconc.exit164:                               ; preds = %for.body61, %if.end.i156, %for.end.i162
  %retval.0.i163 = phi ptr [ %call63, %for.end.i162 ], [ %Result.1175, %for.body61 ], [ %call63, %if.end.i156 ]
  %Scan.1 = load ptr, ptr %Scan.1176, align 8
  %cmp.i153.not = icmp eq ptr %Scan.1, null
  br i1 %cmp.i153.not, label %cleanup, label %for.body61
...
if.then74:                                        ; preds = %symbol_IsPredicate.exit, %if.end68
  ...
  store ptr null, ptr %call.i.i, align 8
  %call.i.i168 = tail call ptr @memory_Malloc(i32 noundef 16) #17
...
entry:
  ...
  %1 = tail call i64 @fwrite(ptr nonnull @.str.20, i64 2, i64 1, ptr %0) #18
...
for.body:                                         ; preds = %if.then, %for.body
  ...
  br i1 %cmp.i22.not, label %if.end, label %for.body
...
for.body:                                         ; preds = %if.then, %for.body
  ...
  br i1 %cmp.i40.not, label %if.end24, label %for.body
...
for.body.i:                                       ; preds = %if.then.i, %for.body.i
  ...
  br i1 %cmp.i22.not.i, label %if.end.i, label %for.body.i
...
if.end.i:                                         ; preds = %for.body.i, %if.else.i, %if.then.i
  ...
  br i1 %cmp.not.i, label %cnf_FPrintClause.exit, label %while.body.i
...
entry:
  ...
  %scan.058 = load ptr, ptr %0, align 8
  %cmp.i.not59 = icmp eq ptr %scan.058, null
  br i1 %cmp.i.not59, label %for.end28, label %for.body.lr.ph
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc26
  %scan.060 = phi ptr [ %scan.058, %for.body.lr.ph ], [ %scan.0, %for.inc26 ]
  %2 = getelementptr i8, ptr %scan.060, i64 8
...
lor.lhs.false:                                    ; preds = %for.body, %symbol_IsPredicate.exit
  ...
  br i1 %cmp.i.not.i, label %land.rhs.i44, label %if.end
...
fol_IsNegativeLiteral.exit:                       ; preds = %land.rhs.i44
...
for.body19.preheader:                             ; preds = %fol_IsNegativeLiteral.exit, %land.rhs.i44, %if.end
  br label %for.body19

for.body19:                                       ; preds = %for.body19.preheader, %for.body19
  %scan1.057 = phi ptr [ %scan1.0.val41, %for.body19 ], [ %T.val8.i, %for.body19.preheader ]
  ...
  %scan1.0.val41 = load ptr, ptr %scan1.057, align 8
  %cmp.i47.not = icmp eq ptr %scan1.0.val41, null
  br i1 %cmp.i47.not, label %for.inc26, label %for.body19
...
entry:
  %0 = getelementptr i8, ptr %term, i64 16
  %scan.061 = load ptr, ptr %0, align 8
  %cmp.i.not62 = icmp eq ptr %scan.061, null
  br i1 %cmp.i.not62, label %for.end28, label %for.body.lr.ph
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc26
  %scan.063 = phi ptr [ %scan.061, %for.body.lr.ph ], [ %scan.0, %for.inc26 ]
  %2 = getelementptr i8, ptr %scan.063, i64 8
...
lor.lhs.false:                                    ; preds = %for.body, %symbol_IsPredicate.exit
  ...
  %T.val8.i = load ptr, ptr %4, align 8
  br i1 %cmp.i.not.i, label %land.rhs.i47, label %if.end

land.rhs.i47:                                     ; preds = %lor.lhs.false
  %5 = getelementptr i8, ptr %T.val8.i, i64 8
  %T.val8.val.i = load ptr, ptr %5, align 8
  %call3.val.i = load i32, ptr %T.val8.val.i, align 8
  %tobool.not.i.i = icmp sgt i32 %call3.val.i, -1
...
fol_IsNegativeLiteral.exit:                       ; preds = %land.rhs.i47
  %sub.i.i.i = sub nsw i32 0, %call3.val.i
  %and.i.i.i = and i32 %1, %sub.i.i.i
  %cmp.i9.i.not = icmp eq i32 %and.i.i.i, 2
  br i1 %cmp.i9.i.not, label %if.else, label %for.body19.preheader
...
for.body19.preheader:                             ; preds = %fol_IsNegativeLiteral.exit, %land.rhs.i47, %if.end
  br label %for.body19

for.body19:                                       ; preds = %for.body19.preheader, %for.body19
  %scan1.060 = phi ptr [ %scan1.0.val44, %for.body19 ], [ %T.val8.i, %for.body19.preheader ]
  %6 = getelementptr i8, ptr %scan1.060, i64 8
  %scan1.0.val = load ptr, ptr %6, align 8
  tail call void @term_FPrint(ptr noundef %file, ptr noundef %scan1.0.val) #17
  %scan1.0.val44 = load ptr, ptr %scan1.060, align 8
  %cmp.i50.not = icmp eq ptr %scan1.0.val44, null
  br i1 %cmp.i50.not, label %for.inc26, label %for.body19
...
for.inc26:                                        ; preds = %for.body19, %if.else
  ...
  %scan.0 = load ptr, ptr %scan.063, align 8
  %cmp.i.not = icmp eq ptr %scan.0, null
  br i1 %cmp.i.not, label %for.end28, label %for.body
...
entry:
  %0 = getelementptr i8, ptr %term, i64 16
  %scan.072 = load ptr, ptr %0, align 8
  %cmp.i.not73 = icmp eq ptr %scan.072, null
  br i1 %cmp.i.not73, label %for.end34, label %for.body.lr.ph
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc32
  %scan.074 = phi ptr [ %scan.072, %for.body.lr.ph ], [ %scan.0, %for.inc32 ]
  %2 = getelementptr i8, ptr %scan.074, i64 8
...
lor.lhs.false:                                    ; preds = %for.body, %symbol_IsPredicate.exit
  ...
  %T.val8.i = load ptr, ptr %4, align 8
  br i1 %cmp.i.not.i, label %land.rhs.i56, label %if.end

land.rhs.i56:                                     ; preds = %lor.lhs.false
  %5 = getelementptr i8, ptr %T.val8.i, i64 8
  %T.val8.val.i = load ptr, ptr %5, align 8
  %call3.val.i = load i32, ptr %T.val8.val.i, align 8
  %tobool.not.i.i = icmp sgt i32 %call3.val.i, -1
...
fol_IsNegativeLiteral.exit:                       ; preds = %land.rhs.i56
  %sub.i.i.i = sub nsw i32 0, %call3.val.i
  %and.i.i.i = and i32 %1, %sub.i.i.i
  %cmp.i9.i.not = icmp eq i32 %and.i.i.i, 2
  br i1 %cmp.i9.i.not, label %if.else, label %for.body19.preheader
...
for.body19.preheader:                             ; preds = %fol_IsNegativeLiteral.exit, %land.rhs.i56, %if.end
  br label %for.body19

for.body19:                                       ; preds = %for.body19.preheader, %for.inc
  %scan1.071 = phi ptr [ %scan1.0.val52.pre, %for.inc ], [ %T.val8.i, %for.body19.preheader ]
  %6 = getelementptr i8, ptr %scan1.071, i64 8
  %scan1.0.val = load ptr, ptr %6, align 8
  tail call void @term_FPrintPrefix(ptr noundef %file, ptr noundef %scan1.0.val) #17
  %scan1.0.val53 = load ptr, ptr %scan1.071, align 8
...
for.inc:                                          ; preds = %for.body19
  ...
  %scan1.0.val52.pre = load ptr, ptr %scan1.071, align 8
  %cmp.i59.not = icmp eq ptr %scan1.0.val52.pre, null
  br i1 %cmp.i59.not, label %for.inc32, label %for.body19
...
for.inc32:                                        ; preds = %for.inc, %for.body19, %if.else
  ...
  %scan.0 = load ptr, ptr %scan.074, align 8
  %cmp.i.not = icmp eq ptr %scan.0, null
  br i1 %cmp.i.not, label %for.end34, label %for.body
...
if.end:                                           ; preds = %if.then10, %while.body
  ...
  br i1 %cmp.i36.not, label %if.end17, label %while.body
...
while.body.outer:                                 ; preds = %if.end, %if.end24.thread
  ...
  %Scan.0552.ph = phi ptr [ %Scan.0.val388573, %if.end24.thread ], [ %Term.val398549, %if.end ]
  br label %while.body

while.body:                                       ; preds = %while.body.outer, %if.end24
  %Scan.0552 = phi ptr [ %Scan.0.val388, %if.end24 ], [ %Scan.0552.ph, %while.body.outer ]
  %2 = getelementptr i8, ptr %Scan.0552, i64 8
...
if.end24:                                         ; preds = %if.else
  %Scan.0.val388 = load ptr, ptr %Scan.0552, align 8
  %cmp.i401.not = icmp eq ptr %Scan.0.val388, null
  br i1 %cmp.i401.not, label %while.end, label %while.body

if.end24.thread:                                  ; preds = %while.body
  %Scan.0.val388573 = load ptr, ptr %Scan.0552, align 8
  %cmp.i401.not574 = icmp eq ptr %Scan.0.val388573, null
  br i1 %cmp.i401.not574, label %if.then27, label %while.body.outer
...
while.body47.outer:                               ; preds = %if.else37, %if.end64.thread
  ...
  %Scan.1550.ph = phi ptr [ %Scan.1.val387579, %if.end64.thread ], [ %Term.val398549, %if.else37 ]
  br label %while.body47

while.body47:                                     ; preds = %while.body47.outer, %if.end64
  %Scan.1550 = phi ptr [ %Scan.1.val387, %if.end64 ], [ %Scan.1550.ph, %while.body47.outer ]
  %7 = getelementptr i8, ptr %Scan.1550, i64 8
...
if.end64:                                         ; preds = %if.else55
  %Scan.1.val387 = load ptr, ptr %Scan.1550, align 8
  %cmp.i412.not = icmp eq ptr %Scan.1.val387, null
  br i1 %cmp.i412.not, label %while.end66, label %while.body47

if.end64.thread:                                  ; preds = %while.body47
  %Scan.1.val387579 = load ptr, ptr %Scan.1550, align 8
  %cmp.i412.not580 = icmp eq ptr %Scan.1.val387579, null
  br i1 %cmp.i412.not580, label %if.then68, label %while.body47.outer
...
if.end93:                                         ; preds = %lor.lhs.false, %if.then87
  %Term.val398549.lcssa607.sink = phi ptr [ %Term.val393.val, %if.then87 ], [ %Term.val398549, %lor.lhs.false ]
  %14 = getelementptr i8, ptr %Term.val398549.lcssa607.sink, i64 8
...
if.then108:                                       ; preds = %if.end93, %land.lhs.true105
  store i32 %.pre, ptr %Term, align 8
...
land.lhs.true124:                                 ; preds = %lor.lhs.false120
  ...
  %cmp.i.not.i446 = icmp ne i32 %19, %Term.val
  %20 = load i32, ptr @fol_EXIST, align 4
  %cmp.i4.i447 = icmp ne i32 %20, %Term.val
...
if.else148:                                       ; preds = %if.then137
  %cmp.i456.not = icmp eq i32 %call139.val, %24
...
while.body.ithread-pre-split.preheader:           ; preds = %if.else148
  ...
  %25 = getelementptr i8, ptr %Term.val392.val, i64 8
  %Term.val392.val.val = load ptr, ptr %25, align 8
  %26 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i542 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %26, i64 0, i32 4
  %27 = load i32, ptr %total_size.i.i.i542, align 8
  %conv26.i.i.i543 = sext i32 %27 to i64
  %28 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i544 = add i64 %28, %conv26.i.i.i543
  store i64 %add27.i.i.i544, ptr @memory_FREEDBYTES, align 8
  %29 = load ptr, ptr %26, align 8
  store ptr %29, ptr %Term.val392, align 8
  %30 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Term.val392, ptr %30, align 8
...
while.body.ithread-pre-split:                     ; preds = %while.body.ithread-pre-split.preheader, %while.body.ithread-pre-split
  ...
  store ptr %34, ptr %Current.0.val.i546, align 8
  %35 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.0.val.i546, ptr %35, align 8
  %cmp.i.not.i458 = icmp eq ptr %Current.0.val.i.pr, null
  br i1 %cmp.i.not.i458, label %tailrecurse.backedgethread-pre-split, label %while.body.ithread-pre-split

tailrecurse.backedgethread-pre-split:             ; preds = %while.body.i478thread-pre-split, %while.body.ithread-pre-split
  %Term.val390.val.val.sink615 = phi ptr [ %Term.val392.val.val, %while.body.ithread-pre-split ], [ %Term.val390.val.val, %while.body.i478thread-pre-split ]
  %call207.val = load i32, ptr %Term.val390.val.val.sink615, align 8
  store i32 %call207.val, ptr %Term, align 8
  %36 = getelementptr i8, ptr %Term.val390.val.val.sink615, i64 16
  %call207.val368 = load ptr, ptr %36, align 8
  ...
  %total_size.i.i487 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %37, i64 0, i32 4
  %38 = load i32, ptr %total_size.i.i487, align 8
  %conv26.i.i488 = sext i32 %38 to i64
  %39 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i489 = add i64 %39, %conv26.i.i488
  store i64 %add27.i.i489, ptr @memory_FREEDBYTES, align 8
  %40 = load ptr, ptr %37, align 8
  store ptr %40, ptr %Term.val390.val.val.sink615, align 8
  %41 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 32), align 8
  store ptr %Term.val390.val.val.sink615, ptr %41, align 8
...
if.end159:                                        ; preds = %if.else148
  ...
  %42 = getelementptr i8, ptr %Term.val391.val, i64 8
  %Term.val391.val.val = load ptr, ptr %42, align 8
  ...
  %43 = load i32, ptr @fol_TRUE, align 4
  %cmp.i460.not = icmp eq i32 %call161.val, %43
...
if.else170:                                       ; preds = %if.end159
  %44 = load i32, ptr @fol_FALSE, align 4
  %cmp.i463.not = icmp eq i32 %call161.val, %44
  br i1 %cmp.i463.not, label %if.then174, label %cleanup

if.then174:                                       ; preds = %if.else170
  %45 = load i32, ptr @fol_NOT, align 4
  store i32 %45, ptr %Term, align 8
  %Term.val372 = load ptr, ptr %0, align 8
  %call.i465 = tail call ptr @list_DeleteElementIfFree(ptr noundef %Term.val372, ptr noundef nonnull @fol_IsFalse, ptr noundef nonnull @term_Delete) #17
  store ptr %call.i465, ptr %0, align 8
  br label %cleanup

if.else180:                                       ; preds = %if.else133
  %46 = load i32, ptr @fol_EQUIV, align 4
  %cmp.i467.not = icmp eq i32 %Term.val, %46
  br i1 %cmp.i467.not, label %if.then184, label %cleanup

if.then184:                                       ; preds = %if.else180
  %47 = getelementptr i8, ptr %Term.val398549, i64 8
  %Term.val395.val = load ptr, ptr %47, align 8
  %call186 = tail call ptr @cnf_RemoveTrivialAtoms(ptr noundef %Term.val395.val)
  %call186.val = load i32, ptr %Term.val395.val, align 8
  %48 = load i32, ptr @fol_FALSE, align 4
  %cmp.i469.not = icmp eq i32 %call186.val, %48
  br i1 %cmp.i469.not, label %if.then191, label %if.else202

if.then191:                                       ; preds = %if.then184
  %49 = load i32, ptr @fol_NOT, align 4
  store i32 %49, ptr %Term, align 8
  %Term.val371 = load ptr, ptr %0, align 8
  %call.i471 = tail call ptr @list_DeleteElementIfFree(ptr noundef %Term.val371, ptr noundef nonnull @fol_IsFalse, ptr noundef nonnull @term_Delete) #17
...
if.then198:                                       ; preds = %if.then191
  %50 = load i32, ptr @fol_TRUE, align 4
  store i32 %50, ptr %Term, align 8
  br label %cleanup

if.else202:                                       ; preds = %if.then184
  %51 = load i32, ptr @fol_TRUE, align 4
  %cmp.i475.not = icmp eq i32 %call186.val, %51
  br i1 %cmp.i475.not, label %while.body.i478thread-pre-split.preheader, label %if.end213

while.body.i478thread-pre-split.preheader:        ; preds = %if.else202
  ...
  %52 = getelementptr i8, ptr %Term.val390.val, i64 8
  %Term.val390.val.val = load ptr, ptr %52, align 8
  %53 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i481537 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %53, i64 0, i32 4
  %54 = load i32, ptr %total_size.i.i.i481537, align 8
  %conv26.i.i.i482538 = sext i32 %54 to i64
  %55 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i483539 = add i64 %55, %conv26.i.i.i482538
  store i64 %add27.i.i.i483539, ptr @memory_FREEDBYTES, align 8
  %56 = load ptr, ptr %53, align 8
  store ptr %56, ptr %Term.val390, align 8
  %57 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Term.val390, ptr %57, align 8
  br label %while.body.i478thread-pre-split

while.body.i478thread-pre-split:                  ; preds = %while.body.i478thread-pre-split.preheader, %while.body.i478thread-pre-split
  %Current.0.val.i480541 = phi ptr [ %Current.0.val.i480.pr, %while.body.i478thread-pre-split ], [ %Term.val390.val, %while.body.i478thread-pre-split.preheader ]
  %Current.0.val.i480.pr = load ptr, ptr %Current.0.val.i480541, align 8
  %58 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i481 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %58, i64 0, i32 4
  %59 = load i32, ptr %total_size.i.i.i481, align 8
  %conv26.i.i.i482 = sext i32 %59 to i64
  %60 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i483 = add i64 %60, %conv26.i.i.i482
  store i64 %add27.i.i.i483, ptr @memory_FREEDBYTES, align 8
  %61 = load ptr, ptr %58, align 8
  store ptr %61, ptr %Current.0.val.i480541, align 8
  %62 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.0.val.i480541, ptr %62, align 8
  %cmp.i.not.i484 = icmp eq ptr %Current.0.val.i480.pr, null
  br i1 %cmp.i.not.i484, label %tailrecurse.backedgethread-pre-split, label %while.body.i478thread-pre-split

if.end213:                                        ; preds = %if.else202
  %Term.val389 = load ptr, ptr %0, align 8
  %Term.val389.val = load ptr, ptr %Term.val389, align 8
  %63 = getelementptr i8, ptr %Term.val389.val, i64 8
  %Term.val389.val.val = load ptr, ptr %63, align 8
  ...
  %64 = load i32, ptr @fol_FALSE, align 4
  %cmp.i490.not = icmp eq i32 %call215.val, %64
  br i1 %cmp.i490.not, label %if.then220, label %if.else224

if.then220:                                       ; preds = %if.end213
  %65 = load i32, ptr @fol_NOT, align 4
  store i32 %65, ptr %Term, align 8
  %Term.val367 = load ptr, ptr %0, align 8
  %call.i492 = tail call ptr @list_DeleteElementIfFree(ptr noundef %Term.val367, ptr noundef nonnull @fol_IsFalse, ptr noundef nonnull @term_Delete) #17
  store ptr %call.i492, ptr %0, align 8
  br label %cleanup

if.else224:                                       ; preds = %if.end213
  %66 = load i32, ptr @fol_TRUE, align 4
  %cmp.i494.not = icmp eq i32 %call215.val, %66
...
if.then228:                                       ; preds = %if.else224
  ...
  %67 = getelementptr i8, ptr %Term.val394, i64 8
  %Term.val394.val = load ptr, ptr %67, align 8
  br label %while.body.i497

while.body.i497:                                  ; preds = %if.then228, %while.body.i497
  %Current.06.i498 = phi ptr [ %Current.0.val.i499, %while.body.i497 ], [ %Term.val394, %if.then228 ]
  %Current.0.val.i499 = load ptr, ptr %Current.06.i498, align 8
  %68 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i500 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %68, i64 0, i32 4
  %69 = load i32, ptr %total_size.i.i.i500, align 8
  %conv26.i.i.i501 = sext i32 %69 to i64
  %70 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i502 = add i64 %70, %conv26.i.i.i501
  store i64 %add27.i.i.i502, ptr @memory_FREEDBYTES, align 8
  %71 = load ptr, ptr %68, align 8
  store ptr %71, ptr %Current.06.i498, align 8
  %72 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i498, ptr %72, align 8
  %cmp.i.not.i503 = icmp eq ptr %Current.0.val.i499, null
  br i1 %cmp.i.not.i503, label %list_Delete.exit504, label %while.body.i497

list_Delete.exit504:                              ; preds = %while.body.i497
  %call229.val = load i32, ptr %Term.val394.val, align 8
  store i32 %call229.val, ptr %Term, align 8
  %73 = getelementptr i8, ptr %Term.val394.val, i64 16
  %call229.val365 = load ptr, ptr %73, align 8
  ...
  %total_size.i.i506 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %74, i64 0, i32 4
  %75 = load i32, ptr %total_size.i.i506, align 8
  %conv26.i.i507 = sext i32 %75 to i64
  %76 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i508 = add i64 %76, %conv26.i.i507
  store i64 %add27.i.i508, ptr @memory_FREEDBYTES, align 8
  %77 = load ptr, ptr %74, align 8
  store ptr %77, ptr %Term.val394.val, align 8
  %78 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 32), align 8
  store ptr %Term.val394.val, ptr %78, align 8
  br label %cleanup
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  br i1 %cmp.i54.not, label %cleanup, label %for.body
...
while.body.ithread-pre-split:                     ; preds = %while.body.ithread-pre-split.preheader, %while.body.ithread-pre-split
  ...
  br i1 %cmp.i.not.i123, label %list_Delete.exit, label %while.body.ithread-pre-split
...
list_Delete.exit:                                 ; preds = %while.body.ithread-pre-split
  ...
  br i1 %cmp.i120.not, label %while.body, label %while.end.loopexit
...
for.inc:                                          ; preds = %for.body, %if.then28
  ...
  br i1 %cmp.i127.not, label %for.end, label %for.body
...
if.then41:                                        ; preds = %if.then34
  ...
  br i1 %cmp.i.not5.i135, label %cleanup, label %while.body.i136

while.body.i136:                                  ; preds = %if.then41, %while.body.i136
  %Current.06.i137 = phi ptr [ %Current.0.val.i138, %while.body.i136 ], [ %Term.val103, %if.then41 ]
  %Current.0.val.i138 = load ptr, ptr %Current.06.i137, align 8
  %40 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i139 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %40, i64 0, i32 4
  %41 = load i32, ptr %total_size.i.i.i139, align 8
  %conv26.i.i.i140 = sext i32 %41 to i64
  %42 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i141 = add i64 %42, %conv26.i.i.i140
  store i64 %add27.i.i.i141, ptr @memory_FREEDBYTES, align 8
  %43 = load ptr, ptr %40, align 8
  store ptr %43, ptr %Current.06.i137, align 8
  %44 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i137, ptr %44, align 8
  %cmp.i.not.i142 = icmp eq ptr %Current.0.val.i138, null
  br i1 %cmp.i.not.i142, label %cleanup, label %while.body.i136

cleanup:                                          ; preds = %while.body.i136, %if.then41
...
for.body57:                                       ; preds = %if.end51, %for.body57
  ...
  br i1 %cmp.i147.not, label %cleanup63, label %for.body57
...
vector.body:                                      ; preds = %entry, %vector.body
  ...
  br i1 %23, label %for.cond.preheader, label %vector.body
...
for.body.i:                                       ; preds = %entry, %for.body.i
  ...
  br i1 %exitcond.not.i.4, label %for.cond.preheader, label %for.body.i
...
for.end:                                          ; preds = %list_Nconc.exit, %for.cond.preheader
  ...
  br i1 %cmp.i.not.i59, label %list_Nconc.exit68, label %if.end.i60

if.end.i60:                                       ; preds = %for.end
  %cmp.i18.not.i61 = icmp eq ptr %usables.0.lcssa, null
  br i1 %cmp.i18.not.i61, label %list_Nconc.exit68.thread, label %for.cond.i62

list_Nconc.exit68.thread:                         ; preds = %if.end.i60
  call void @term_Delete(ptr noundef %call14) #17
  br label %for.body21.preheader

for.cond.i62:                                     ; preds = %if.end.i60, %for.cond.i62
  %List1.addr.0.i63 = phi ptr [ %List1.addr.0.val17.i64, %for.cond.i62 ], [ %call15, %if.end.i60 ]
  %List1.addr.0.val17.i64 = load ptr, ptr %List1.addr.0.i63, align 8
  %cmp.i20.not.i65 = icmp eq ptr %List1.addr.0.val17.i64, null
  br i1 %cmp.i20.not.i65, label %for.end.i66, label %for.cond.i62

for.end.i66:                                      ; preds = %for.cond.i62
  store ptr %usables.0.lcssa, ptr %List1.addr.0.i63, align 8
...
for.body21:                                       ; preds = %for.body21.preheader, %for.body21
  ...
  br i1 %cmp.i69.not, label %for.end25, label %for.body21
...
for.body.i:                                       ; preds = %entry, %for.body.i
  ...
  br i1 %cmp.i.not.i, label %cnf_DistributiveFormula.exit, label %for.body.i
...
if.then8:                                         ; preds = %symbol_IsPredicate.exit, %fol_IsNegativeLiteral.exit
  ...
  %call.i.i242 = tail call ptr @memory_Malloc(i32 noundef 16) #17
...
while.body.i:                                     ; preds = %if.then8, %while.body.i
  ...
  br i1 %cmp.i.not.i244, label %cleanup, label %while.body.i
...
lor.rhs.i.i:                                      ; preds = %for.cond.i.i
  ...
  br i1 %cmp.i73.i.i, label %for.cond11.preheader.i.i, label %for.cond.i.i
...
for.cond29.preheader.i.i:                         ; preds = %for.inc26.i.i
  ...
  br i1 %cond.i.i, label %cnf_MakeOneAndTerm.exit, label %for.body33.preheader.i.i

for.body33.preheader.i.i:                         ; preds = %for.cond29.preheader.i.i
...
symbol_IsPredicate.exit.i.i:                      ; preds = %for.body15.i.i
  ...
  br i1 %or.cond.i.i, label %land.rhs.i81.i.i, label %for.inc26.i.i

land.rhs.i81.i.i:                                 ; preds = %symbol_IsPredicate.exit.i.i
...
fol_IsNegativeLiteral.exit.i.i:                   ; preds = %land.rhs.i81.i.i
...
for.inc26.i.i:                                    ; preds = %if.then23.i.i, %fol_IsNegativeLiteral.exit.i.i, %land.rhs.i81.i.i, %symbol_IsPredicate.exit.i.i, %for.body15.i.i
  %predlist.1.i.i = phi ptr [ %call.i.i.i, %if.then23.i.i ], [ %predlist.094.i.i, %fol_IsNegativeLiteral.exit.i.i ], [ %predlist.094.i.i, %symbol_IsPredicate.exit.i.i ], [ %predlist.094.i.i, %for.body15.i.i ], [ %predlist.094.i.i, %land.rhs.i81.i.i ]
  %scan.0.val71.i.i = load ptr, ptr %scan.093.i.i, align 8
  %cmp.i77.not.i.i = icmp eq ptr %scan.0.val71.i.i, null
  br i1 %cmp.i77.not.i.i, label %for.cond29.preheader.i.i, label %for.body15.i.i

for.body33.i.i:                                   ; preds = %for.body33.i.i, %for.body33.preheader.i.i
  %term.val66.i.i = phi ptr [ %call36.i.i, %for.body33.i.i ], [ %term.val66.pre.i.i, %for.body33.preheader.i.i ]
  %scan.196.i.i = phi ptr [ %scan.1.val70.i.i, %for.body33.i.i ], [ %predlist.1.i.i, %for.body33.preheader.i.i ]
  ...
  br i1 %cmp.i82.not.i.i, label %if.then42.i.i, label %for.body33.i.i
...
symbol_IsPredicate.exit254:                       ; preds = %for.body
  %sub.i.i250 = sub nsw i32 0, %call30.val
  %and.i.i251 = and i32 %24, %sub.i.i250
  %cmp.i252.not = icmp eq i32 %and.i.i251, 2
  br i1 %cmp.i252.not, label %if.end46.thread, label %lor.lhs.false34
...
lor.lhs.false34:                                  ; preds = %for.body, %symbol_IsPredicate.exit254
  ...
  %T.val8.i259 = load ptr, ptr %27, align 8
  br i1 %cmp.i.not.i256, label %land.rhs.i258, label %if.end46

land.rhs.i258:                                    ; preds = %lor.lhs.false34
  %28 = getelementptr i8, ptr %T.val8.i259, i64 8
  %T.val8.val.i260 = load ptr, ptr %28, align 8
  %call3.val.i261 = load i32, ptr %T.val8.val.i260, align 8
  %tobool.not.i.i262 = icmp sgt i32 %call3.val.i261, -1
  br i1 %tobool.not.i.i262, label %if.end46, label %fol_IsNegativeLiteral.exit267

fol_IsNegativeLiteral.exit267:                    ; preds = %land.rhs.i258
  %sub.i.i.i264 = sub nsw i32 0, %call3.val.i261
  %and.i.i.i265 = and i32 %24, %sub.i.i.i264
  %cmp.i9.i266.not = icmp eq i32 %and.i.i.i265, 2
  br i1 %cmp.i9.i266.not, label %if.end46.thread, label %if.end46
...
if.end46:                                         ; preds = %lor.lhs.false34, %land.rhs.i258, %fol_IsNegativeLiteral.exit267
  %call.i268 = tail call ptr @list_CopyWithElement(ptr noundef %T.val8.i259, ptr noundef nonnull @term_Copy) #17
...
if.then49:                                        ; preds = %if.end46.thread, %if.end46
  ...
  %call50 = tail call ptr @clause_CreateFromLiterals(ptr noundef nonnull %termlist.0381, i32 noundef 0, i32 noundef 0, i32 noundef 1, ptr noundef %Flags, ptr noundef %Precedence) #17
  tail call void @term_StartMinRenaming() #17
  ...
  br i1 %cmp407, label %for.body53.lr.ph, label %while.body.i278.preheader
...
for.body53:                                       ; preds = %for.body53.lr.ph, %for.body53
  ...
  br i1 %cmp, label %for.body53, label %while.body.i278.preheader

while.body.i278.preheader:                        ; preds = %for.body53, %if.then49
...
while.body.i278:                                  ; preds = %while.body.i278.preheader, %while.body.i278
  %Current.06.i279 = phi ptr [ %Current.0.val.i280, %while.body.i278 ], [ %termlist.0381, %while.body.i278.preheader ]
  %Current.0.val.i280 = load ptr, ptr %Current.06.i279, align 8
  %36 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i281 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %36, i64 0, i32 4
  %37 = load i32, ptr %total_size.i.i.i281, align 8
  %conv26.i.i.i282 = sext i32 %37 to i64
  %38 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i283 = add i64 %38, %conv26.i.i.i282
  store i64 %add27.i.i.i283, ptr @memory_FREEDBYTES, align 8
  %39 = load ptr, ptr %36, align 8
  store ptr %39, ptr %Current.06.i279, align 8
  %40 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i279, ptr %40, align 8
  %cmp.i.not.i284 = icmp eq ptr %Current.0.val.i280, null
  br i1 %cmp.i.not.i284, label %for.inc58, label %while.body.i278

for.inc58:                                        ; preds = %while.body.i278, %if.end46
  %clauselist.1 = phi ptr [ %clauselist.0411, %if.end46 ], [ %call.i275, %while.body.i278 ]
  %scan.0 = load ptr, ptr %scan.0413, align 8
  %cmp.i246.not = icmp eq ptr %scan.0, null
  br i1 %cmp.i246.not, label %if.end92, label %for.body
...
symbol_IsPredicate.exit292:                       ; preds = %if.else61
  %sub.i.i288 = sub nsw i32 0, %call62.val
  %41 = load i32, ptr @symbol_TYPEMASK, align 4
  %and.i.i289 = and i32 %41, %sub.i.i288
  %cmp.i290.not = icmp eq i32 %and.i.i289, 2
  br i1 %cmp.i290.not, label %if.end76.thread, label %lor.lhs.false66

lor.lhs.false66:                                  ; preds = %if.else61, %symbol_IsPredicate.exit292
  %42 = load i32, ptr @fol_NOT, align 4
  %cmp.i.not.i294 = icmp eq i32 %call62.val, %42
  %call62.val228.pre = load ptr, ptr %14, align 8
  br i1 %cmp.i.not.i294, label %land.rhs.i296, label %if.end76

land.rhs.i296:                                    ; preds = %lor.lhs.false66
  %43 = getelementptr i8, ptr %call62.val228.pre, i64 8
  %T.val8.val.i298 = load ptr, ptr %43, align 8
  %call3.val.i299 = load i32, ptr %T.val8.val.i298, align 8
  %tobool.not.i.i300 = icmp sgt i32 %call3.val.i299, -1
  br i1 %tobool.not.i.i300, label %if.end76, label %fol_IsNegativeLiteral.exit305

fol_IsNegativeLiteral.exit305:                    ; preds = %land.rhs.i296
  %sub.i.i.i302 = sub nsw i32 0, %call3.val.i299
  %44 = load i32, ptr @symbol_TYPEMASK, align 4
  %and.i.i.i303 = and i32 %44, %sub.i.i.i302
  %cmp.i9.i304.not = icmp eq i32 %and.i.i.i303, 2
  br i1 %cmp.i9.i304.not, label %if.end76.thread, label %if.end76
...
if.end76:                                         ; preds = %land.rhs.i296, %lor.lhs.false66, %fol_IsNegativeLiteral.exit305
  %call.i306 = tail call ptr @list_CopyWithElement(ptr noundef %call62.val228.pre, ptr noundef nonnull @term_Copy) #17
...
if.then79:                                        ; preds = %if.end76.thread, %if.end76
  ...
  %call80 = tail call ptr @clause_CreateFromLiterals(ptr noundef nonnull %termlist.1391, i32 noundef 0, i32 noundef 0, i32 noundef 1, ptr noundef %Flags, ptr noundef %Precedence) #17
  tail call void @term_StartMinRenaming() #17
  ...
  br i1 %cmp83400, label %for.body84.lr.ph, label %while.body.i323.preheader
...
for.body84:                                       ; preds = %for.body84.lr.ph, %for.body84
  ...
  br i1 %cmp83, label %for.body84, label %while.body.i323.preheader

while.body.i323.preheader:                        ; preds = %for.body84, %if.then79
...
while.body.i323:                                  ; preds = %while.body.i323.preheader, %while.body.i323
  %Current.06.i324 = phi ptr [ %Current.0.val.i325, %while.body.i323 ], [ %termlist.1391, %while.body.i323.preheader ]
  %Current.0.val.i325 = load ptr, ptr %Current.06.i324, align 8
  %52 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i326 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %52, i64 0, i32 4
  %53 = load i32, ptr %total_size.i.i.i326, align 8
  %conv26.i.i.i327 = sext i32 %53 to i64
  %54 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i328 = add i64 %54, %conv26.i.i.i327
  store i64 %add27.i.i.i328, ptr @memory_FREEDBYTES, align 8
  %55 = load ptr, ptr %52, align 8
  store ptr %55, ptr %Current.06.i324, align 8
  %56 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i324, ptr %56, align 8
  %cmp.i.not.i329 = icmp eq ptr %Current.0.val.i325, null
  br i1 %cmp.i.not.i329, label %if.end92, label %while.body.i323

if.end92:                                         ; preds = %while.body.i323, %for.inc58
  %clauselist.2 = phi ptr [ %clauselist.1, %for.inc58 ], [ %call.i320, %while.body.i323 ]
...
while.body.i336:                                  ; preds = %if.then102, %while.body.i336
  %Current.06.i337 = phi ptr [ %Current.0.val.i338, %while.body.i336 ], [ %call99, %if.then102 ]
  %Current.0.val.i338 = load ptr, ptr %Current.06.i337, align 8
  %58 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i339 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %58, i64 0, i32 4
  %59 = load i32, ptr %total_size.i.i.i339, align 8
  %conv26.i.i.i340 = sext i32 %59 to i64
  %60 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i341 = add i64 %60, %conv26.i.i.i340
  store i64 %add27.i.i.i341, ptr @memory_FREEDBYTES, align 8
  %61 = load ptr, ptr %58, align 8
  store ptr %61, ptr %Current.06.i337, align 8
  %62 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i337, ptr %62, align 8
  %cmp.i.not.i342 = icmp eq ptr %Current.0.val.i338, null
  br i1 %cmp.i.not.i342, label %list_Delete.exit343, label %while.body.i336

list_Delete.exit343:                              ; preds = %while.body.i336, %for.body97
  %scan.1.val238 = load ptr, ptr %scan.1415, align 8
  %cmp.i331.not = icmp eq ptr %scan.1.val238, null
  br i1 %cmp.i331.not, label %for.end107, label %for.body97

for.end107.thread:                                ; preds = %if.end92, %if.end76, %for.cond.preheader
  %call.i344441 = tail call ptr @st_IndexCreate() #17
...
for.body.i:                                       ; preds = %for.end107, %for.body.i
  ...
  br i1 %cmp.i.not.i345, label %for.body9.i, label %for.body.i
...
if.then.i:                                        ; preds = %for.body9.i
  ...
  %call.i.i347 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i.i348 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i347, i64 0, i32 1
  store ptr %scan.1.val.i, ptr %car.i.i348, align 8
  store ptr %result.071.i, ptr %call.i.i347, align 8
  br label %for.inc14.i

for.inc14.i:                                      ; preds = %if.then.i, %for.body9.i
  %result.1.i = phi ptr [ %result.071.i, %for.body9.i ], [ %call.i.i347, %if.then.i ]
  %scan.1.val60.i = load ptr, ptr %scan.172.i, align 8
  %cmp.i62.not.i = icmp eq ptr %scan.1.val60.i, null
  br i1 %cmp.i62.not.i, label %for.end16.i, label %for.body9.i

for.end16.i:                                      ; preds = %for.inc14.i, %for.end107.thread, %for.end107
  %call.i344444 = phi ptr [ %call.i344, %for.end107 ], [ %call.i344441, %for.end107.thread ], [ %call.i344, %for.inc14.i ]
  %clauselist.2437443 = phi ptr [ %clauselist.2, %for.end107 ], [ null, %for.end107.thread ], [ %clauselist.2, %for.inc14.i ]
  %cmp.i331.not414438442 = phi i1 [ true, %for.end107 ], [ true, %for.end107.thread ], [ %cmp.i331.not414, %for.inc14.i ]
  ...
  %call18.i = tail call i32 @list_Length(ptr noundef %clauselist.2437443) #17
...
cnf_SubsumeClauseList.exit.thread:                ; preds = %for.cond20.preheader.i
  tail call void @st_IndexDelete(ptr noundef %call.i344444) #17
  br label %for.end141

for.body24.i:                                     ; preds = %for.cond20.preheader.i, %for.body24.i
  %clauselist.addr.075.i = phi ptr [ %call26.i, %for.body24.i ], [ %clauselist.2437443, %for.cond20.preheader.i ]
  ...
  br i1 %cmp.i64.not.i, label %if.then32.i, label %for.body24.i
...
if.else.i:                                        ; preds = %for.end16.i
  br i1 %cmp.i331.not414438442, label %cnf_SubsumeClauseList.exit, label %while.body.i.i

while.body.i.i:                                   ; preds = %if.else.i, %while.body.i.i
  %Current.06.i.i = phi ptr [ %Current.0.val.i.i, %while.body.i.i ], [ %clauselist.2437443, %if.else.i ]
  ...
  %cmp.i.not.i.i346 = icmp eq ptr %Current.0.val.i.i, null
  br i1 %cmp.i.not.i.i346, label %cnf_SubsumeClauseList.exit, label %while.body.i.i
...
while.body:                                       ; preds = %cnf_SubsumeClauseList.exit, %list_Nconc.exit
  ...
  %call113 = tail call ptr @res_SelectLightestClause(ptr noundef nonnull %clauselist.3417) #17
  %call.i.i351 = tail call ptr @memory_Malloc(i32 noundef 16) #17
...
list_Nconc.exit:                                  ; preds = %while.body, %for.end.i
  ...
  %call116 = tail call ptr @list_PointerDeleteElement(ptr noundef nonnull %clauselist.3417, ptr noundef %call113) #17
  %cmp.i349.not = icmp eq ptr %call116, null
  br i1 %cmp.i349.not, label %for.body121, label %while.body
...
if.then125:                                       ; preds = %for.body121
  ...
  %call.i365 = tail call ptr @memory_Malloc(i32 noundef 16) #17
...
for.inc129:                                       ; preds = %for.body121, %if.then125
  ...
  br i1 %cmp.i363.not, label %for.cond132.preheader, label %for.body121
...
for.body136:                                      ; preds = %for.cond132.preheader, %for.body136
  ...
  %call138 = tail call ptr @list_PointerDeleteElement(ptr noundef %newclauselist.1426, ptr noundef %scan.3.val) #17
  %scan.3.val236 = load ptr, ptr %scan.3425, align 8
  %cmp.i367.not = icmp eq ptr %scan.3.val236, null
  br i1 %cmp.i367.not, label %for.end141, label %for.body136

for.end141:                                       ; preds = %for.body136, %cnf_SubsumeClauseList.exit.thread, %cnf_SubsumeClauseList.exit, %for.cond132.preheader
  %delclauselist.0.lcssa452 = phi ptr [ null, %for.cond132.preheader ], [ null, %cnf_SubsumeClauseList.exit ], [ null, %cnf_SubsumeClauseList.exit.thread ], [ %delclauselist.1, %for.body136 ]
  ...
  tail call void @clause_DeleteClauseList(ptr noundef %delclauselist.0.lcssa452) #17
  br label %cleanup
...
if.end28:                                         ; preds = %for.end.i, %if.end.i, %if.then16
  ...
  br i1 %cmp.i.not.i73, label %list_Nconc.exit82, label %if.end.i74

if.end.i74:                                       ; preds = %if.end28
  %cmp.i18.not.i75 = icmp eq ptr %retval.0.i, null
  br i1 %cmp.i18.not.i75, label %list_Nconc.exit82, label %for.cond.i76

for.cond.i76:                                     ; preds = %if.end.i74, %for.cond.i76
  %List1.addr.0.i77 = phi ptr [ %List1.addr.0.val17.i78, %for.cond.i76 ], [ %call15, %if.end.i74 ]
  %List1.addr.0.val17.i78 = load ptr, ptr %List1.addr.0.i77, align 8
  %cmp.i20.not.i79 = icmp eq ptr %List1.addr.0.val17.i78, null
  br i1 %cmp.i20.not.i79, label %for.end.i80, label %for.cond.i76

for.end.i80:                                      ; preds = %for.cond.i76
  store ptr %retval.0.i, ptr %List1.addr.0.i77, align 8
  br label %list_Nconc.exit82

list_Nconc.exit82:                                ; preds = %if.else, %if.end28, %if.end.i74, %for.end.i80
  %Derived.1100 = phi i32 [ %spec.select, %for.end.i80 ], [ %spec.select, %if.end28 ], [ %spec.select, %if.end.i74 ], [ 0, %if.else ]
  %retval.0.i81 = phi ptr [ %call15, %for.end.i80 ], [ %retval.0.i, %if.end28 ], [ %call15, %if.end.i74 ], [ %call15, %if.else ]
...
for.body:                                         ; preds = %list_Nconc.exit82, %for.body
  ...
  %call34 = call ptr @clause_InsertWeighed(ptr noundef %Scan.0.val, ptr noundef %ClauseList.addr.1106, ptr noundef %Search.val, ptr noundef %Search.val67) #17
...
while.body.i:                                     ; preds = %for.end, %while.body.i
  ...
  br i1 %cmp.i.not.i88, label %if.end37, label %while.body.i
...
entry:
  %0 = load i32, ptr @fol_ALL, align 4
  %1 = load i32, ptr @fol_EXIST, align 4
  %Term.val127156 = load i32, ptr %Term, align 8
  %cmp.i.not.i157 = icmp ne i32 %0, %Term.val127156
  %cmp.i4.i158 = icmp ne i32 %1, %Term.val127156
  %narrow.i.not159 = select i1 %cmp.i.not.i157, i1 %cmp.i4.i158, i1 false
  br i1 %narrow.i.not159, label %if.end, label %if.then

if.then:                                          ; preds = %entry, %if.then
  %Term.tr160 = phi ptr [ %Term.val139.val.val, %if.then ], [ %Term, %entry ]
  %2 = getelementptr i8, ptr %Term.tr160, i64 16
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %Term.val127.lcssa = phi i32 [ %Term.val127156, %entry ], [ %Term.val127, %if.then ]
...
for.cond:                                         ; preds = %for.cond, %for.cond.preheader.new
  ...
  br i1 %niter.ncmp.7, label %for.end.unr-lcssa, label %for.cond
...
for.cond.epil:                                    ; preds = %for.end.unr-lcssa, %for.cond.epil
  ...
  br i1 %epil.iter.cmp.not, label %for.end, label %for.cond.epil
...
for.end:                                          ; preds = %for.cond.epil, %for.end.unr-lcssa
  ...
  %SkolScan.1162 = load ptr, ptr %13, align 8
  %cmp24163.not = icmp eq ptr %SkolScan.1162, null
  br i1 %cmp24163.not, label %if.then40, label %for.body26.lr.ph
...
for.body26:                                       ; preds = %for.body26.lr.ph, %if.end34
  %SkolScan.1165 = phi ptr [ %SkolScan.1162, %for.body26.lr.ph ], [ %SkolScan.1, %if.end34 ]
  %14 = getelementptr i8, ptr %SkolScan.1165, i64 8
...
if.end34:                                         ; preds = %for.body26
  %SkolScan.1 = load ptr, ptr %SkolScan.1165, align 8
  %cmp24 = icmp ne ptr %SkolScan.1, null
  %18 = and i1 %cmp30, %cmp24
  br i1 %18, label %for.body26, label %if.then40
...
if.then40:                                        ; preds = %if.end34, %for.end, %if.end15
  %SkolScan42.0168 = load ptr, ptr %SkolToExVar, align 8
  %cmp44169.not = icmp eq i32 %call10, 0
  br i1 %cmp44169.not, label %for.end55, label %for.body45

for.body45:                                       ; preds = %if.then40, %if.end51
  %SkolScan42.0171 = phi ptr [ %SkolScan42.0, %if.end51 ], [ %SkolScan42.0168, %if.then40 ]
  %i41.0170 = phi i32 [ %inc54, %if.end51 ], [ 0, %if.then40 ]
  %SkolScan42.0.val136 = load ptr, ptr %SkolScan42.0171, align 8
...
if.then49:                                        ; preds = %for.body45
  ...
  store ptr %call.i.i, ptr %SkolScan42.0171, align 8
  br label %if.end51

if.end51:                                         ; preds = %if.then49, %for.body45
  %SkolScan42.0 = phi ptr [ %call.i.i, %if.then49 ], [ %SkolScan42.0.val136, %for.body45 ]
  %inc54 = add nuw i32 %i41.0170, 1
  %exitcond180.not = icmp eq i32 %inc54, %call10
  br i1 %exitcond180.not, label %for.end55, label %for.body45

for.end55:                                        ; preds = %if.end51, %if.then40
  %SkolScan42.0.lcssa = phi ptr [ %SkolScan42.0168, %if.then40 ], [ %SkolScan42.0, %if.end51 ]
...
for.cond.i:                                       ; preds = %for.end55, %for.cond.i
  ...
  %List1.addr.0.val17.i = load ptr, ptr %List1.addr.0.i, align 8
  %cmp.i20.not.i = icmp eq ptr %List1.addr.0.val17.i, null
  br i1 %cmp.i20.not.i, label %list_Nconc.exit, label %for.cond.i
...
if.else72:                                        ; preds = %land.rhs.i, %if.end, %land.lhs.true
  ...
  %Scan.0173 = load ptr, ptr %25, align 8
  %cmp76.not174 = icmp eq ptr %Scan.0173, null
  br i1 %cmp76.not174, label %cleanup, label %for.body78

for.body78:                                       ; preds = %if.else72, %for.body78
  %Scan.0176 = phi ptr [ %Scan.0, %for.body78 ], [ %Scan.0173, %if.else72 ]
  %ArgList.addr.1175 = phi ptr [ %call80, %for.body78 ], [ %ArgList, %if.else72 ]
  %26 = getelementptr i8, ptr %Scan.0176, i64 8
  %Scan.0.val = load ptr, ptr %26, align 8
  %call80 = tail call ptr @cnf_GetSkolemFunctions(ptr noundef %Scan.0.val, ptr noundef %ArgList.addr.1175, ptr noundef %SkolToExVar)
  %Scan.0 = load ptr, ptr %Scan.0176, align 8
  %cmp76.not = icmp eq ptr %Scan.0, null
  br i1 %cmp76.not, label %cleanup, label %for.body78
...
for.body:                                         ; preds = %if.else, %for.body
  ...
  br i1 %cmp.i15.not, label %if.end, label %for.body
...
for.cond12.preheader:                             ; preds = %for.end, %if.end30
  %Scan.074 = phi ptr [ %Scan.0.val58, %if.end30 ], [ %call5, %for.end ]
  %Vars.addr.073 = phi ptr [ %Vars.addr.1.val, %if.end30 ], [ %Vars, %for.end ]
  %7 = getelementptr i8, ptr %Scan.074, i64 8
  %8 = getelementptr i8, ptr %Vars.addr.073, i64 8
  br label %for.body15
...
for.body15:                                       ; preds = %for.cond12.preheader, %for.body15
  ...
  br i1 %cmp14.not, label %for.cond12.for.end22_crit_edge, label %for.body15

for.cond12.for.end22_crit_edge:                   ; preds = %for.body15
  %Vars.addr.0.val59 = load ptr, ptr %Vars.addr.073, align 8
...
for.cond.i:                                       ; preds = %if.end.i, %for.cond.i
  %List1.addr.0.i = phi ptr [ %List1.addr.0.val17.i, %for.cond.i ], [ %Vars.addr.073, %if.end.i ]
  %List1.addr.0.val17.i = load ptr, ptr %List1.addr.0.i, align 8
  %cmp.i20.not.i = icmp eq ptr %List1.addr.0.val17.i, null
  br i1 %cmp.i20.not.i, label %list_Nconc.exit, label %for.cond.i
...
list_Nconc.exit:                                  ; preds = %for.cond.i
  ...
  %Vars.addr.1.val.pre = load ptr, ptr %Vars.addr.073, align 8
  br label %if.end30
...
if.end30:                                         ; preds = %list_Nconc.exit, %for.cond12.for.end22_crit_edge
  ...
  %Scan.0.val58 = load ptr, ptr %Scan.074, align 8
  %cmp10.not = icmp eq ptr %Scan.0.val58, null
  br i1 %cmp10.not, label %for.end34, label %for.cond12.preheader
...
cleanup:                                          ; preds = %entry, %for.end, %for.end34
  %TermList.0.lcssa82 = phi ptr [ %call.i, %for.end ], [ %call.i, %for.end34 ], [ null, %entry ]
  ret ptr %TermList.0.lcssa82
}
...
if.end:                                           ; preds = %list_Delete.exit, %for.body
  ...
  br i1 %cmp.not, label %for.body24.preheader, label %for.body

for.body24.preheader:                             ; preds = %if.end, %entry
  br label %for.body24

for.body24:                                       ; preds = %for.body24.preheader, %for.inc104
  %tobool89.not224 = phi i1 [ true, %for.inc104 ], [ false, %for.body24.preheader ]
  %TopTerm.0223 = phi ptr [ %TopTerm.3215, %for.inc104 ], [ %call4, %for.body24.preheader ]
  %Scan.1222 = phi ptr [ %Scan.1.val153, %for.inc104 ], [ %call.i.i, %for.body24.preheader ]
  %VarScan.0221 = phi ptr [ %VarScan.1, %for.inc104 ], [ %call.i.i157, %for.body24.preheader ]
  %12 = getelementptr i8, ptr %Scan.1222, i64 8
...
if.then33:                                        ; preds = %if.then28
  ...
  %17 = getelementptr i8, ptr %TopTerm.0223, i64 16
...
if.end38:                                         ; preds = %if.then33, %if.then28
  br i1 %tobool89.not224, label %if.then40, label %for.inc104

if.then40:                                        ; preds = %if.end38
  %18 = load i32, ptr @fol_ALL, align 4
  %19 = getelementptr i8, ptr %VarScan.0221, i64 8
  ...
  store ptr %TopTerm.0223, ptr %car.i.i170, align 8
...
for.body54:                                       ; preds = %for.body24, %for.body54
  ...
  br i1 %cmp52.not, label %for.end72, label %for.body54

for.end72:                                        ; preds = %for.body54
  %Scan.1.val = load ptr, ptr %12, align 8
  %cmp.i.not5.i178 = icmp eq ptr %Scan.1.val, null
  br i1 %cmp.i.not5.i178, label %list_Delete.exit186, label %while.body.i179

while.body.i179:                                  ; preds = %for.end72, %while.body.i179
  %Current.06.i180 = phi ptr [ %Current.0.val.i181, %while.body.i179 ], [ %Scan.1.val, %for.end72 ]
  %Current.0.val.i181 = load ptr, ptr %Current.06.i180, align 8
  %31 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i182 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %31, i64 0, i32 4
  %32 = load i32, ptr %total_size.i.i.i182, align 8
  %conv26.i.i.i183 = sext i32 %32 to i64
  %33 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i184 = add i64 %33, %conv26.i.i.i183
  store i64 %add27.i.i.i184, ptr @memory_FREEDBYTES, align 8
  %34 = load ptr, ptr %31, align 8
  store ptr %34, ptr %Current.06.i180, align 8
  %35 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i180, ptr %35, align 8
  %cmp.i.not.i185 = icmp eq ptr %Current.0.val.i181, null
  br i1 %cmp.i.not.i185, label %list_Delete.exit186, label %while.body.i179

list_Delete.exit186:                              ; preds = %while.body.i179, %for.end72
  store ptr null, ptr %12, align 8
  %TopTerm.0.val = load i32, ptr %TopTerm.0223, align 8
...
if.then78:                                        ; preds = %list_Delete.exit186
  %37 = getelementptr i8, ptr %TopTerm.0223, i64 16
...
if.else83:                                        ; preds = %list_Delete.exit186
  %call.i.i190 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i.i191 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i190, i64 0, i32 1
  store ptr %TopTerm.0223, ptr %car.i.i191, align 8
  store ptr null, ptr %call.i.i190, align 8
  %call86 = tail call ptr @fol_CreateQuantifier(i32 noundef %36, ptr noundef nonnull %call.i.i171, ptr noundef nonnull %call.i.i190) #17
  br label %if.end87

if.end87:                                         ; preds = %if.else83, %list_Nconc.exit
  %TopTerm.1 = phi ptr [ %TopTerm.0223, %list_Nconc.exit ], [ %call86, %if.else83 ]
  br i1 %tobool89.not224, label %if.then90, label %for.inc104

if.then90:                                        ; preds = %if.end87
  %40 = load i32, ptr @fol_ALL, align 4
  %41 = getelementptr i8, ptr %VarScan.0221, i64 8
  ...
  %call.i.i192 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  ...
  %call.i.i194 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  ...
  %call96 = tail call ptr @fol_CreateQuantifier(i32 noundef %40, ptr noundef nonnull %call.i.i192, ptr noundef nonnull %call.i.i194) #17
  br label %if.then100

if.then100:                                       ; preds = %if.then90, %if.then40
  %TopTerm.3.ph = phi ptr [ %call96, %if.then90 ], [ %call46, %if.then40 ]
  %VarScan.0.val154 = load ptr, ptr %VarScan.0221, align 8
  br label %for.inc104

for.inc104:                                       ; preds = %if.end38, %if.end87, %if.then100
  %TopTerm.3215 = phi ptr [ %TopTerm.3.ph, %if.then100 ], [ %TopTerm.0223, %if.end38 ], [ %TopTerm.1, %if.end87 ]
  %VarScan.1 = phi ptr [ %VarScan.0.val154, %if.then100 ], [ %VarScan.0221, %if.end38 ], [ %VarScan.0221, %if.end87 ]
  %Scan.1.val153 = load ptr, ptr %Scan.1222, align 8
  %cmp22.not = icmp eq ptr %Scan.1.val153, null
  br i1 %cmp22.not, label %for.end106, label %for.body24

for.end106:                                       ; preds = %for.inc104
  %44 = load ptr, ptr %SkolToExVar, align 8
  %cmp.i.not5.i196 = icmp eq ptr %44, null
  br i1 %cmp.i.not5.i196, label %while.body.i206.preheader, label %while.body.i197

while.body.i197:                                  ; preds = %for.end106, %while.body.i197
  %Current.06.i198 = phi ptr [ %Current.0.val.i199, %while.body.i197 ], [ %44, %for.end106 ]
  ...
  %total_size.i.i.i200 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %45, i64 0, i32 4
  %46 = load i32, ptr %total_size.i.i.i200, align 8
  %conv26.i.i.i201 = sext i32 %46 to i64
  %47 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i202 = add i64 %47, %conv26.i.i.i201
  store i64 %add27.i.i.i202, ptr @memory_FREEDBYTES, align 8
  %48 = load ptr, ptr %45, align 8
  store ptr %48, ptr %Current.06.i198, align 8
  %49 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i198, ptr %49, align 8
  %cmp.i.not.i203 = icmp eq ptr %Current.0.val.i199, null
  br i1 %cmp.i.not.i203, label %while.body.i206.preheader, label %while.body.i197

while.body.i206.preheader:                        ; preds = %while.body.i197, %for.end106
  br label %while.body.i206

while.body.i206:                                  ; preds = %while.body.i206.preheader, %while.body.i206
  %Current.06.i207 = phi ptr [ %Current.0.val.i208, %while.body.i206 ], [ %call.i.i157, %while.body.i206.preheader ]
  %Current.0.val.i208 = load ptr, ptr %Current.06.i207, align 8
  %50 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i209 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %50, i64 0, i32 4
  %51 = load i32, ptr %total_size.i.i.i209, align 8
  %conv26.i.i.i210 = sext i32 %51 to i64
  %52 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i211 = add i64 %52, %conv26.i.i.i210
  store i64 %add27.i.i.i211, ptr @memory_FREEDBYTES, align 8
  %53 = load ptr, ptr %50, align 8
  store ptr %53, ptr %Current.06.i207, align 8
  %54 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i207, ptr %54, align 8
  %cmp.i.not.i212 = icmp eq ptr %Current.0.val.i208, null
  br i1 %cmp.i.not.i212, label %list_Delete.exit213, label %while.body.i206

list_Delete.exit213:                              ; preds = %while.body.i206
...
vector.body:                                      ; preds = %entry, %vector.body
  ...
  br i1 %22, label %symbol_TransferPrecedence.exit, label %vector.body
...
for.body.i:                                       ; preds = %entry, %for.body.i
  ...
  %indvars.iv.next.i.4 = add nuw nsw i64 %indvars.iv.i, 5
  %exitcond.not.i.4 = icmp eq i64 %indvars.iv.next.i.4, 4000
  br i1 %exitcond.not.i.4, label %symbol_TransferPrecedence.exit, label %for.body.i
...
if.end25:                                         ; preds = %if.then22, %if.end18
  ...
  br i1 %cmp.i.not, label %for.cond30.preheader, label %for.body
...
if.then37:                                        ; preds = %for.body34
  %call38 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %buf, ptr noundef nonnull dereferenceable(1) @.str.9, i32 noundef %Count.0615) #17
...
if.end65:                                         ; preds = %if.then62, %if.end58
  ...
  br i1 %cmp.i394.not, label %for.end72, label %for.body34
...
for.cond.i:                                       ; preds = %if.end.i, %for.cond.i
  ...
  br i1 %cmp.i22.not.i, label %list_Append.exit, label %for.cond.i
...
for.body78:                                       ; preds = %for.body78.preheader, %for.body78
  ...
  br i1 %cmp.i404.not, label %for.end83, label %for.body78
...
for.body90:                                       ; preds = %for.end83, %list_Nconc.exit
  ...
  br i1 %cmp.i.not14.i, label %cnf_DistributiveFormula.exit, label %for.body.i410

for.body.i410:                                    ; preds = %for.body90, %for.body.i410
  %Scan.015.i = phi ptr [ %Scan.0.val13.i, %for.body.i410 ], [ %call.i409, %for.body90 ]
  %42 = load i32, ptr @fol_OR, align 4
  %43 = getelementptr i8, ptr %Scan.015.i, i64 8
  %Scan.0.val.i = load ptr, ptr %43, align 8
  %call4.i411 = call ptr @term_Create(i32 noundef %42, ptr noundef %Scan.0.val.i) #17
  store ptr %call4.i411, ptr %43, align 8
  %Scan.0.val13.i = load ptr, ptr %Scan.015.i, align 8
  %cmp.i.not.i412 = icmp eq ptr %Scan.0.val13.i, null
  br i1 %cmp.i.not.i412, label %cnf_DistributiveFormula.exit, label %for.body.i410

cnf_DistributiveFormula.exit:                     ; preds = %for.body.i410, %for.body90
...
for.cond.i418:                                    ; preds = %for.body.i420, %for.body104
  %Scan.0.in.i = phi ptr [ %arrayidx.i417, %for.body104 ], [ %Scan.0.i, %for.body.i420 ]
  %Scan.0.i = load ptr, ptr %Scan.0.in.i, align 8
  %cmp.i.not.i419 = icmp eq ptr %Scan.0.i, null
  br i1 %cmp.i.not.i419, label %for.end.i423, label %for.body.i420

for.body.i420:                                    ; preds = %for.cond.i418
  %49 = getelementptr i8, ptr %Scan.0.i, i64 8
  %Scan.0.val.i421 = load ptr, ptr %49, align 8
  %50 = getelementptr i8, ptr %Scan.0.val.i421, i64 8
  %call2.val.i = load ptr, ptr %50, align 8
  %cmp.i422 = icmp eq ptr %call2.val.i, %Scan2.0.val
  br i1 %cmp.i422, label %if.then.i, label %for.cond.i418

if.then.i:                                        ; preds = %for.body.i420
  %call2.val34.i = load ptr, ptr %Scan.0.val.i421, align 8
...
if.end.i.i:                                       ; preds = %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i, label %if.then7.i, label %while.body.i.i
...
if.then7.i:                                       ; preds = %if.end.i.i, %if.then.i
  ...
  store ptr %call.i.i, ptr %Scan.0.val.i421, align 8
  br label %hsh_Put.exit

for.end.i423:                                     ; preds = %for.cond.i418
...
hsh_Put.exit:                                     ; preds = %while.body.i.i, %if.then7.i, %for.end.i423
  ...
  br i1 %cmp.i415.not, label %if.end111, label %for.body104
...
for.cond.i426:                                    ; preds = %if.end111, %for.cond.i426
  %List1.addr.0.i427 = phi ptr [ %List1.addr.0.val17.i, %for.cond.i426 ], [ %FormulaClauses.0622, %if.end111 ]
  %List1.addr.0.val17.i = load ptr, ptr %List1.addr.0.i427, align 8
  %cmp.i20.not.i428 = icmp eq ptr %List1.addr.0.val17.i, null
  br i1 %cmp.i20.not.i428, label %for.end.i429, label %for.cond.i426

for.end.i429:                                     ; preds = %for.cond.i426
  store ptr %call96, ptr %List1.addr.0.i427, align 8
  br label %list_Nconc.exit
...
list_Nconc.exit:                                  ; preds = %if.end111, %for.end.i429
  ...
  br i1 %cmp.i407.not, label %for.cond117.preheader, label %for.body90
...
for.body121:                                      ; preds = %for.cond117.preheader, %for.body121
  ...
  br i1 %cmp.i431.not, label %for.end125, label %for.body121
...
for.end125:                                       ; preds = %for.body121, %for.end83, %for.cond117.preheader
  ...
  %call126 = call ptr @red_SatUnit(ptr noundef %call, ptr noundef %FormulaClauses.0.lcssa646) #17
...
for.body137:                                      ; preds = %if.end130, %for.body137
  ...
  br i1 %cmp.i435.not, label %while.body.i, label %for.body137
...
while.body.i:                                     ; preds = %for.body137, %while.body.i
  ...
  br i1 %cmp.i.not.i437, label %list_Delete.exit, label %while.body.i
...
vector.memcheck655:                               ; preds = %list_Delete.exit544, %list_Delete.exit
  ...
  br i1 %diff.check656, label %for.body.i545, label %vector.body661

vector.body661:                                   ; preds = %vector.memcheck655, %vector.body661
  %index662 = phi i64 [ %index.next665.3, %vector.body661 ], [ 0, %vector.memcheck655 ]
  %63 = getelementptr inbounds i32, ptr %call.val386, i64 %index662
  %wide.load663 = load <4 x i32>, ptr %63, align 4
  %64 = getelementptr inbounds i32, ptr %63, i64 4
  %wide.load664 = load <4 x i32>, ptr %64, align 4
  %65 = getelementptr inbounds i32, ptr %InputPrecedence, i64 %index662
  store <4 x i32> %wide.load663, ptr %65, align 4
  %66 = getelementptr inbounds i32, ptr %65, i64 4
  store <4 x i32> %wide.load664, ptr %66, align 4
  %index.next665 = or i64 %index662, 8
  %67 = getelementptr inbounds i32, ptr %call.val386, i64 %index.next665
  %wide.load663.1 = load <4 x i32>, ptr %67, align 4
  %68 = getelementptr inbounds i32, ptr %67, i64 4
  %wide.load664.1 = load <4 x i32>, ptr %68, align 4
  %69 = getelementptr inbounds i32, ptr %InputPrecedence, i64 %index.next665
  store <4 x i32> %wide.load663.1, ptr %69, align 4
  %70 = getelementptr inbounds i32, ptr %69, i64 4
  store <4 x i32> %wide.load664.1, ptr %70, align 4
  %index.next665.1 = or i64 %index662, 16
  %71 = getelementptr inbounds i32, ptr %call.val386, i64 %index.next665.1
  %wide.load663.2 = load <4 x i32>, ptr %71, align 4
  %72 = getelementptr inbounds i32, ptr %71, i64 4
  %wide.load664.2 = load <4 x i32>, ptr %72, align 4
  %73 = getelementptr inbounds i32, ptr %InputPrecedence, i64 %index.next665.1
  store <4 x i32> %wide.load663.2, ptr %73, align 4
  %74 = getelementptr inbounds i32, ptr %73, i64 4
  store <4 x i32> %wide.load664.2, ptr %74, align 4
  %index.next665.2 = or i64 %index662, 24
  %75 = getelementptr inbounds i32, ptr %call.val386, i64 %index.next665.2
  %wide.load663.3 = load <4 x i32>, ptr %75, align 4
  %76 = getelementptr inbounds i32, ptr %75, i64 4
  %wide.load664.3 = load <4 x i32>, ptr %76, align 4
  %77 = getelementptr inbounds i32, ptr %InputPrecedence, i64 %index.next665.2
  store <4 x i32> %wide.load663.3, ptr %77, align 4
  %78 = getelementptr inbounds i32, ptr %77, i64 4
  store <4 x i32> %wide.load664.3, ptr %78, align 4
  %index.next665.3 = add nuw nsw i64 %index662, 32
  %79 = icmp eq i64 %index.next665.3, 4000
  br i1 %79, label %symbol_TransferPrecedence.exit552, label %vector.body661
...
for.body148:                                      ; preds = %list_Delete.exit, %list_Delete.exit544
  ...
  br i1 %cmp.i394.not614, label %if.end169, label %while.body.i440

while.body.i440:                                  ; preds = %for.body148, %if.end.i442
  %List.addr.07.i = phi ptr [ %List.addr.0.val5.i, %if.end.i442 ], [ %ConjectureList, %for.body148 ]
  %82 = getelementptr i8, ptr %List.addr.07.i, i64 8
  %List.addr.0.val.i = load ptr, ptr %82, align 8
  %cmp.i441 = icmp eq ptr %List.addr.0.val.i, %call151.val384
  br i1 %cmp.i441, label %for.cond160.preheader, label %if.end.i442

for.cond160.preheader:                            ; preds = %while.body.i440
  %cmp.i445.not628 = icmp eq ptr %call155, null
  br i1 %cmp.i445.not628, label %if.end169, label %for.body164

if.end.i442:                                      ; preds = %while.body.i440
  %List.addr.0.val5.i = load ptr, ptr %List.addr.07.i, align 8
  %cmp.i.not.i443 = icmp eq ptr %List.addr.0.val5.i, null
  br i1 %cmp.i.not.i443, label %if.end169, label %while.body.i440
...
for.body164:                                      ; preds = %for.cond160.preheader, %for.body164
  ...
  br i1 %cmp.i445.not, label %if.end169, label %for.body164

if.end169:                                        ; preds = %if.end.i442, %for.body164, %for.cond160.preheader, %for.body148
...
if.then172:                                       ; preds = %if.end169
  ...
  %call.i.i450 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call151.val381) #20
...
for.body.i.i:                                     ; preds = %for.body.i.i, %if.then172.new
  ...
  br i1 %niter.ncmp.7, label %hsh_StringHashKey.exit.i.unr-lcssa, label %for.body.i.i
...
for.body.i.i.epil:                                ; preds = %hsh_StringHashKey.exit.i.unr-lcssa, %for.body.i.i.epil
  ...
  br i1 %epil.iter.cmp.not, label %hsh_StringHashKey.exit.i, label %for.body.i.i.epil
...
hsh_StringHashKey.exit.i:                         ; preds = %for.body.i.i.epil, %hsh_StringHashKey.exit.i.unr-lcssa
  ...
  br label %for.cond.i453

for.cond.i453:                                    ; preds = %for.body.i457, %hsh_StringHashKey.exit.i
  %Scan.0.in.i454 = phi ptr [ %arrayidx.i452, %hsh_StringHashKey.exit.i ], [ %Scan.0.i455, %for.body.i457 ]
  %Scan.0.i455 = load ptr, ptr %Scan.0.in.i454, align 8
  %cmp.i.not.i456 = icmp eq ptr %Scan.0.i455, null
  br i1 %cmp.i.not.i456, label %for.end.i464, label %for.body.i457

for.body.i457:                                    ; preds = %for.cond.i453
  %97 = getelementptr i8, ptr %Scan.0.i455, i64 8
  %Scan.0.val.i458 = load ptr, ptr %97, align 8
  %98 = getelementptr i8, ptr %Scan.0.val.i458, i64 8
  %call2.val.i459 = load ptr, ptr %98, align 8
  %call.i.i.i460 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %call2.val.i459, ptr noundef nonnull dereferenceable(1) %call151.val381) #20
  %cmp.i.i.not.i = icmp eq i32 %call.i.i.i460, 0
  br i1 %cmp.i.i.not.i, label %if.then.i461, label %for.cond.i453

if.then.i461:                                     ; preds = %for.body.i457
  %call2.val27.i = load ptr, ptr %Scan.0.val.i458, align 8
  %cmp.i.not.i.i462 = icmp eq ptr %call2.val27.i, null
  br i1 %cmp.i.not.i.i462, label %list_Nconc.exit.i, label %if.end.i.i463

if.end.i.i463:                                    ; preds = %if.then.i461
...
list_Nconc.exit.i:                                ; preds = %for.end.i.i, %if.end.i.i463, %if.then.i461
  %retval.0.i.i = phi ptr [ %call2.val27.i, %for.end.i.i ], [ %call174, %if.then.i461 ], [ %call2.val27.i, %if.end.i.i463 ]
  store ptr %retval.0.i.i, ptr %Scan.0.val.i458, align 8
  br label %hsh_PutListWithCompareFunc.exit

for.end.i464:                                     ; preds = %for.cond.i453
  %call.i.i29.i = call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i.i.i465 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i29.i, i64 0, i32 1
  store ptr %call151.val381, ptr %car.i.i.i465, align 8
  store ptr %call174, ptr %call.i.i29.i, align 8
  %99 = load ptr, ptr %arrayidx.i452, align 8
  %call.i30.i = call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i.i466 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i30.i, i64 0, i32 1
  store ptr %call.i.i29.i, ptr %car.i.i466, align 8
  store ptr %99, ptr %call.i30.i, align 8
  store ptr %call.i30.i, ptr %arrayidx.i452, align 8
  br label %hsh_PutListWithCompareFunc.exit

hsh_PutListWithCompareFunc.exit:                  ; preds = %list_Nconc.exit.i, %for.end.i464
  %call151.val = load ptr, ptr %81, align 8
  %100 = load ptr, ptr %UsedTerms, align 8
  %call.i467 = call ptr @memory_Malloc(i32 noundef 16) #17
  ...
  %call.i469 = call ptr @list_DeleteDuplicates(ptr noundef nonnull %call.i467, ptr noundef nonnull @cnf_LabelEqual) #17
...
for.cond.i474:                                    ; preds = %for.body.i478, %for.body182
  %Scan.0.in.i475 = phi ptr [ %arrayidx.i473, %for.body182 ], [ %Scan.0.i476, %for.body.i478 ]
  %Scan.0.i476 = load ptr, ptr %Scan.0.in.i475, align 8
  %cmp.i.not.i477 = icmp eq ptr %Scan.0.i476, null
  br i1 %cmp.i.not.i477, label %for.end.i493, label %for.body.i478

for.body.i478:                                    ; preds = %for.cond.i474
  %104 = getelementptr i8, ptr %Scan.0.i476, i64 8
  %Scan.0.val.i479 = load ptr, ptr %104, align 8
  %105 = getelementptr i8, ptr %Scan.0.val.i479, i64 8
  %call2.val.i480 = load ptr, ptr %105, align 8
  %cmp.i481 = icmp eq ptr %call2.val.i480, %Scan2.1.val364
  br i1 %cmp.i481, label %if.then.i482, label %for.cond.i474

if.then.i482:                                     ; preds = %for.body.i478
  %call2.val25.i = load ptr, ptr %Scan.0.val.i479, align 8
  %cmp.i.not.i.i483 = icmp eq ptr %call2.val25.i, null
  br i1 %cmp.i.not.i.i483, label %list_Nconc.exit.i491, label %if.end.i.i484

if.end.i.i484:                                    ; preds = %if.then.i482
  %cmp.i18.not.i.i485 = icmp eq ptr %call184, null
  br i1 %cmp.i18.not.i.i485, label %list_Nconc.exit.i491, label %for.cond.i.i486

for.cond.i.i486:                                  ; preds = %if.end.i.i484, %for.cond.i.i486
  %List1.addr.0.i.i487 = phi ptr [ %List1.addr.0.val17.i.i488, %for.cond.i.i486 ], [ %call2.val25.i, %if.end.i.i484 ]
  %List1.addr.0.val17.i.i488 = load ptr, ptr %List1.addr.0.i.i487, align 8
  %cmp.i20.not.i.i489 = icmp eq ptr %List1.addr.0.val17.i.i488, null
  br i1 %cmp.i20.not.i.i489, label %for.end.i.i490, label %for.cond.i.i486

for.end.i.i490:                                   ; preds = %for.cond.i.i486
  store ptr %call184, ptr %List1.addr.0.i.i487, align 8
  br label %list_Nconc.exit.i491

list_Nconc.exit.i491:                             ; preds = %for.end.i.i490, %if.end.i.i484, %if.then.i482
  %retval.0.i.i492 = phi ptr [ %call2.val25.i, %for.end.i.i490 ], [ %call184, %if.then.i482 ], [ %call2.val25.i, %if.end.i.i484 ]
  store ptr %retval.0.i.i492, ptr %Scan.0.val.i479, align 8
  br label %hsh_PutList.exit

for.end.i493:                                     ; preds = %for.cond.i474
  %call.i.i.i494 = call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i.i.i495 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i.i494, i64 0, i32 1
  store ptr %Scan2.1.val364, ptr %car.i.i.i495, align 8
  store ptr %call184, ptr %call.i.i.i494, align 8
  %106 = load ptr, ptr %arrayidx.i473, align 8
  %call.i.i496 = call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i.i497 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i496, i64 0, i32 1
  store ptr %call.i.i.i494, ptr %car.i.i497, align 8
  store ptr %106, ptr %call.i.i496, align 8
  store ptr %call.i.i496, ptr %arrayidx.i473, align 8
  br label %hsh_PutList.exit

hsh_PutList.exit:                                 ; preds = %list_Nconc.exit.i491, %for.end.i493
...
for.cond.i500:                                    ; preds = %for.body.i504, %hsh_PutList.exit
  %Scan.0.in.i501 = phi ptr [ %arrayidx.i499, %hsh_PutList.exit ], [ %Scan.0.i502, %for.body.i504 ]
  %Scan.0.i502 = load ptr, ptr %Scan.0.in.i501, align 8
  %cmp.i.not.i503 = icmp eq ptr %Scan.0.i502, null
  br i1 %cmp.i.not.i503, label %for.end.i520, label %for.body.i504

for.body.i504:                                    ; preds = %for.cond.i500
  %109 = getelementptr i8, ptr %Scan.0.i502, i64 8
  %Scan.0.val.i505 = load ptr, ptr %109, align 8
  %110 = getelementptr i8, ptr %Scan.0.val.i505, i64 8
  %call2.val.i506 = load ptr, ptr %110, align 8
  %cmp.i507 = icmp eq ptr %call2.val.i506, %Scan2.1.val
  br i1 %cmp.i507, label %if.then.i508, label %for.cond.i500

if.then.i508:                                     ; preds = %for.body.i504
  %call2.val25.i509 = load ptr, ptr %Scan.0.val.i505, align 8
  %cmp.i.not.i.i510 = icmp eq ptr %call2.val25.i509, null
  br i1 %cmp.i.not.i.i510, label %list_Nconc.exit.i518, label %if.end.i.i511

if.end.i.i511:                                    ; preds = %if.then.i508
  %cmp.i18.not.i.i512 = icmp eq ptr %call186, null
  br i1 %cmp.i18.not.i.i512, label %list_Nconc.exit.i518, label %for.cond.i.i513

for.cond.i.i513:                                  ; preds = %if.end.i.i511, %for.cond.i.i513
  %List1.addr.0.i.i514 = phi ptr [ %List1.addr.0.val17.i.i515, %for.cond.i.i513 ], [ %call2.val25.i509, %if.end.i.i511 ]
  %List1.addr.0.val17.i.i515 = load ptr, ptr %List1.addr.0.i.i514, align 8
  %cmp.i20.not.i.i516 = icmp eq ptr %List1.addr.0.val17.i.i515, null
  br i1 %cmp.i20.not.i.i516, label %for.end.i.i517, label %for.cond.i.i513

for.end.i.i517:                                   ; preds = %for.cond.i.i513
  store ptr %call186, ptr %List1.addr.0.i.i514, align 8
  br label %list_Nconc.exit.i518

list_Nconc.exit.i518:                             ; preds = %for.end.i.i517, %if.end.i.i511, %if.then.i508
  %retval.0.i.i519 = phi ptr [ %call2.val25.i509, %for.end.i.i517 ], [ %call186, %if.then.i508 ], [ %call2.val25.i509, %if.end.i.i511 ]
  store ptr %retval.0.i.i519, ptr %Scan.0.val.i505, align 8
  br label %hsh_PutList.exit525

for.end.i520:                                     ; preds = %for.cond.i500
  %call.i.i.i521 = call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i.i.i522 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i.i521, i64 0, i32 1
  store ptr %Scan2.1.val, ptr %car.i.i.i522, align 8
  store ptr %call186, ptr %call.i.i.i521, align 8
  %111 = load ptr, ptr %arrayidx.i499, align 8
  %call.i.i523 = call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i.i524 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i523, i64 0, i32 1
  store ptr %call.i.i.i521, ptr %car.i.i524, align 8
  store ptr %111, ptr %call.i.i523, align 8
  store ptr %call.i.i523, ptr %arrayidx.i499, align 8
  br label %hsh_PutList.exit525

hsh_PutList.exit525:                              ; preds = %list_Nconc.exit.i518, %for.end.i520
  %Scan2.1.val372 = load ptr, ptr %Scan2.1631, align 8
  %cmp.i470.not = icmp eq ptr %Scan2.1.val372, null
  br i1 %cmp.i470.not, label %if.end190, label %for.body182

if.end190:                                        ; preds = %hsh_PutList.exit525, %if.end169
  %112 = load ptr, ptr %AxClauses, align 8
  %cmp.i.not.i526 = icmp eq ptr %112, null
  br i1 %cmp.i.not.i526, label %list_Nconc.exit535thread-pre-split, label %if.end.i527
...
if.end.i527:                                      ; preds = %if.end190
  %cmp.i18.not.i528 = icmp eq ptr %call155, null
  br i1 %cmp.i18.not.i528, label %list_Nconc.exit535thread-pre-split, label %for.cond.i529

for.cond.i529:                                    ; preds = %if.end.i527, %for.cond.i529
  %List1.addr.0.i530 = phi ptr [ %List1.addr.0.val17.i531, %for.cond.i529 ], [ %112, %if.end.i527 ]
  %List1.addr.0.val17.i531 = load ptr, ptr %List1.addr.0.i530, align 8
  %cmp.i20.not.i532 = icmp eq ptr %List1.addr.0.val17.i531, null
  br i1 %cmp.i20.not.i532, label %for.end.i533, label %for.cond.i529

for.end.i533:                                     ; preds = %for.cond.i529
  store ptr %call155, ptr %List1.addr.0.i530, align 8
  br label %list_Nconc.exit535thread-pre-split

list_Nconc.exit535thread-pre-split:               ; preds = %if.end190.thread, %for.end.i533, %if.end.i527, %if.end190
  %retval.0.i534.ph = phi ptr [ %112, %if.end.i527 ], [ %call155, %if.end190 ], [ %112, %for.end.i533 ], [ %113, %if.end190.thread ]
...
list_Nconc.exit535:                               ; preds = %list_Nconc.exit535thread-pre-split, %if.end190.thread
  ...
  br i1 %cmp.i.not5.i536, label %list_Delete.exit544, label %while.body.i537

while.body.i537:                                  ; preds = %list_Nconc.exit535, %while.body.i537
  %Current.06.i538 = phi ptr [ %Current.0.val.i539, %while.body.i537 ], [ %114, %list_Nconc.exit535 ]
  %Current.0.val.i539 = load ptr, ptr %Current.06.i538, align 8
  %115 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i540 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %115, i64 0, i32 4
  %116 = load i32, ptr %total_size.i.i.i540, align 8
  %conv26.i.i.i541 = sext i32 %116 to i64
  %117 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i542 = add i64 %117, %conv26.i.i.i541
  store i64 %add27.i.i.i542, ptr @memory_FREEDBYTES, align 8
  %118 = load ptr, ptr %115, align 8
  store ptr %118, ptr %Current.06.i538, align 8
  %119 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i538, ptr %119, align 8
  %cmp.i.not.i543 = icmp eq ptr %Current.0.val.i539, null
  br i1 %cmp.i.not.i543, label %list_Delete.exit544, label %while.body.i537

list_Delete.exit544:                              ; preds = %while.body.i537, %list_Nconc.exit535
  %Scan.6.val371 = load ptr, ptr %Scan.6633, align 8
  %cmp.i438.not = icmp eq ptr %Scan.6.val371, null
  br i1 %cmp.i438.not, label %vector.memcheck655, label %for.body148

for.body.i545:                                    ; preds = %vector.memcheck655, %for.body.i545
  %indvars.iv.i546 = phi i64 [ %indvars.iv.next.i549.4, %for.body.i545 ], [ 0, %vector.memcheck655 ]
  %arrayidx.i547 = getelementptr inbounds i32, ptr %call.val386, i64 %indvars.iv.i546
  %120 = load i32, ptr %arrayidx.i547, align 4
  %arrayidx2.i548 = getelementptr inbounds i32, ptr %InputPrecedence, i64 %indvars.iv.i546
  store i32 %120, ptr %arrayidx2.i548, align 4
  %indvars.iv.next.i549 = add nuw nsw i64 %indvars.iv.i546, 1
  %arrayidx.i547.1 = getelementptr inbounds i32, ptr %call.val386, i64 %indvars.iv.next.i549
  %121 = load i32, ptr %arrayidx.i547.1, align 4
  %arrayidx2.i548.1 = getelementptr inbounds i32, ptr %InputPrecedence, i64 %indvars.iv.next.i549
  store i32 %121, ptr %arrayidx2.i548.1, align 4
  %indvars.iv.next.i549.1 = add nuw nsw i64 %indvars.iv.i546, 2
  %arrayidx.i547.2 = getelementptr inbounds i32, ptr %call.val386, i64 %indvars.iv.next.i549.1
  %122 = load i32, ptr %arrayidx.i547.2, align 4
  %arrayidx2.i548.2 = getelementptr inbounds i32, ptr %InputPrecedence, i64 %indvars.iv.next.i549.1
  store i32 %122, ptr %arrayidx2.i548.2, align 4
  %indvars.iv.next.i549.2 = add nuw nsw i64 %indvars.iv.i546, 3
  %arrayidx.i547.3 = getelementptr inbounds i32, ptr %call.val386, i64 %indvars.iv.next.i549.2
  %123 = load i32, ptr %arrayidx.i547.3, align 4
  %arrayidx2.i548.3 = getelementptr inbounds i32, ptr %InputPrecedence, i64 %indvars.iv.next.i549.2
  store i32 %123, ptr %arrayidx2.i548.3, align 4
  %indvars.iv.next.i549.3 = add nuw nsw i64 %indvars.iv.i546, 4
  %arrayidx.i547.4 = getelementptr inbounds i32, ptr %call.val386, i64 %indvars.iv.next.i549.3
  %124 = load i32, ptr %arrayidx.i547.4, align 4
  %arrayidx2.i548.4 = getelementptr inbounds i32, ptr %InputPrecedence, i64 %indvars.iv.next.i549.3
  store i32 %124, ptr %arrayidx2.i548.4, align 4
  %indvars.iv.next.i549.4 = add nuw nsw i64 %indvars.iv.i546, 5
  %exitcond.not.i550.4 = icmp eq i64 %indvars.iv.next.i549.4, 4000
  br i1 %exitcond.not.i550.4, label %symbol_TransferPrecedence.exit552, label %for.body.i545

symbol_TransferPrecedence.exit552:                ; preds = %vector.body661, %for.body.i545
  br i1 %cmp.i394.not614, label %list_Delete.exit561, label %while.body.i554

while.body.i554:                                  ; preds = %symbol_TransferPrecedence.exit552, %while.body.i554
  %Current.06.i555 = phi ptr [ %Current.0.val.i556, %while.body.i554 ], [ %ConjectureList, %symbol_TransferPrecedence.exit552 ]
  %Current.0.val.i556 = load ptr, ptr %Current.06.i555, align 8
  %125 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i557 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %125, i64 0, i32 4
  %126 = load i32, ptr %total_size.i.i.i557, align 8
  %conv26.i.i.i558 = sext i32 %126 to i64
  %127 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i559 = add i64 %127, %conv26.i.i.i558
  store i64 %add27.i.i.i559, ptr @memory_FREEDBYTES, align 8
  %128 = load ptr, ptr %125, align 8
  store ptr %128, ptr %Current.06.i555, align 8
  %129 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i555, ptr %129, align 8
  %cmp.i.not.i560 = icmp eq ptr %Current.0.val.i556, null
  br i1 %cmp.i.not.i560, label %list_Delete.exit561, label %while.body.i554

list_Delete.exit561:                              ; preds = %while.body.i554, %symbol_TransferPrecedence.exit552
...
if.then201:                                       ; preds = %if.end198
  ...
  br i1 %cmp.i.not5.i564, label %if.end202, label %while.body.i565

while.body.i565:                                  ; preds = %if.then201, %while.body.i565
  %Current.06.i566 = phi ptr [ %Current.0.val.i567, %while.body.i565 ], [ %132, %if.then201 ]
  %Current.0.val.i567 = load ptr, ptr %Current.06.i566, align 8
  %133 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i568 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %133, i64 0, i32 4
  %134 = load i32, ptr %total_size.i.i.i568, align 8
  %conv26.i.i.i569 = sext i32 %134 to i64
  %135 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i570 = add i64 %135, %conv26.i.i.i569
  store i64 %add27.i.i.i570, ptr @memory_FREEDBYTES, align 8
  %136 = load ptr, ptr %133, align 8
  store ptr %136, ptr %Current.06.i566, align 8
  %137 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i566, ptr %137, align 8
  %cmp.i.not.i571 = icmp eq ptr %Current.0.val.i567, null
  br i1 %cmp.i.not.i571, label %if.end202, label %while.body.i565

if.end202:                                        ; preds = %while.body.i565, %if.then201, %if.end198
...
for.body208:                                      ; preds = %if.end202, %for.body208
  ...
  %call.i575 = call ptr @memory_Malloc(i32 noundef 16) #17
  ...
  br i1 %cmp.i573.not, label %while.body.i581, label %for.body208

while.body.i581:                                  ; preds = %for.body208, %while.body.i581
  %Current.06.i582 = phi ptr [ %Current.0.val.i583, %while.body.i581 ], [ %retval.0.i640, %for.body208 ]
  %Current.0.val.i583 = load ptr, ptr %Current.06.i582, align 8
  %146 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i584 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %146, i64 0, i32 4
  %147 = load i32, ptr %total_size.i.i.i584, align 8
  %conv26.i.i.i585 = sext i32 %147 to i64
  %148 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i586 = add i64 %148, %conv26.i.i.i585
  store i64 %add27.i.i.i586, ptr @memory_FREEDBYTES, align 8
  %149 = load ptr, ptr %146, align 8
  store ptr %149, ptr %Current.06.i582, align 8
  %150 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i582, ptr %150, align 8
  %cmp.i.not.i587 = icmp eq ptr %Current.0.val.i583, null
  br i1 %cmp.i.not.i587, label %list_Delete.exit588, label %while.body.i581

list_Delete.exit588:                              ; preds = %while.body.i581, %if.end202
  %151 = load ptr, ptr %SkolemFunctions, align 8
  %cmp.i.not5.i589 = icmp eq ptr %151, null
  br i1 %cmp.i.not5.i589, label %list_Delete.exit597, label %while.body.i590

while.body.i590:                                  ; preds = %list_Delete.exit588, %while.body.i590
  %Current.06.i591 = phi ptr [ %Current.0.val.i592, %while.body.i590 ], [ %151, %list_Delete.exit588 ]
  %Current.0.val.i592 = load ptr, ptr %Current.06.i591, align 8
  %152 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i593 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %152, i64 0, i32 4
  %153 = load i32, ptr %total_size.i.i.i593, align 8
  %conv26.i.i.i594 = sext i32 %153 to i64
  %154 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i595 = add i64 %154, %conv26.i.i.i594
  store i64 %add27.i.i.i595, ptr @memory_FREEDBYTES, align 8
  %155 = load ptr, ptr %152, align 8
  store ptr %155, ptr %Current.06.i591, align 8
  %156 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i591, ptr %156, align 8
  %cmp.i.not.i596 = icmp eq ptr %Current.0.val.i592, null
  br i1 %cmp.i.not.i596, label %list_Delete.exit597, label %while.body.i590

list_Delete.exit597:                              ; preds = %while.body.i590, %list_Delete.exit588
  %157 = load ptr, ptr %SkolemPredicates, align 8
  %cmp.i.not5.i598 = icmp eq ptr %157, null
  br i1 %cmp.i.not5.i598, label %list_Delete.exit606, label %while.body.i599

while.body.i599:                                  ; preds = %list_Delete.exit597, %while.body.i599
  %Current.06.i600 = phi ptr [ %Current.0.val.i601, %while.body.i599 ], [ %157, %list_Delete.exit597 ]
  %Current.0.val.i601 = load ptr, ptr %Current.06.i600, align 8
  %158 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i602 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %158, i64 0, i32 4
  %159 = load i32, ptr %total_size.i.i.i602, align 8
  %conv26.i.i.i603 = sext i32 %159 to i64
  %160 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i604 = add i64 %160, %conv26.i.i.i603
  store i64 %add27.i.i.i604, ptr @memory_FREEDBYTES, align 8
  %161 = load ptr, ptr %158, align 8
  store ptr %161, ptr %Current.06.i600, align 8
  %162 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i600, ptr %162, align 8
  %cmp.i.not.i605 = icmp eq ptr %Current.0.val.i601, null
  br i1 %cmp.i.not.i605, label %list_Delete.exit606, label %while.body.i599

list_Delete.exit606:                              ; preds = %while.body.i599, %list_Delete.exit597
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %call2.val74.pre111 = load ptr, ptr %1, align 8
  br i1 %tobool13.not, label %if.end, label %land.lhs.true20

if.end:                                           ; preds = %land.lhs.true
  %4 = getelementptr i8, ptr %call2.val74.pre111, i64 8
  ...
  br i1 %tobool19.not, label %if.end.land.lhs.true20_crit_edge, label %if.then38

if.end.land.lhs.true20_crit_edge:                 ; preds = %if.end
  %call2.val74.pre = load ptr, ptr %1, align 8
  br label %land.lhs.true20

land.lhs.true20:                                  ; preds = %if.end.land.lhs.true20_crit_edge, %for.body, %land.lhs.true
  %call2.val74 = phi ptr [ %call2.val74.pre, %if.end.land.lhs.true20_crit_edge ], [ %call2.val81, %for.body ], [ %call2.val74.pre111, %land.lhs.true ]
...
if.then17:                                        ; preds = %if.else
  ...
  %inc.i116.i = add nsw i32 %1, 1
  %idxprom.i117.i = sext i32 %1 to i64
  %arrayidx.i118.i = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %idxprom.i117.i
  store ptr %term, ptr %arrayidx.i118.i, align 8
  %9 = load i32, ptr @fol_NOT, align 4
...
do.body.i:                                        ; preds = %do.cond.i, %if.then17
  %vec_MAX.promoted191.i = phi i32 [ %vec_MAX.promoted189.i, %do.cond.i ], [ %inc.i116.i, %if.then17 ]
  %dec.i.i = add nsw i32 %vec_MAX.promoted191.i, -1
  %idxprom.i119.i = sext i32 %dec.i.i to i64
  %arrayidx.i120.i = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %idxprom.i119.i
  %14 = load ptr, ptr %arrayidx.i120.i, align 8
  %dec.i121.i = add nsw i32 %vec_MAX.promoted191.i, -2
  store i32 %dec.i121.i, ptr @vec_MAX, align 4
  %idxprom.i122.i = sext i32 %dec.i121.i to i64
  %arrayidx.i123.i = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %idxprom.i122.i
  %15 = load ptr, ptr %arrayidx.i123.i, align 8
  %16 = ptrtoint ptr %15 to i64
  %cmp.i116 = icmp eq ptr %14, %2
  br i1 %cmp.i116, label %cnf_GetFormulaPolarity.exit, label %if.else.i

if.else.i:                                        ; preds = %do.body.i
  %call1.val107.i = load i32, ptr %14, align 8
  %cmp.i.not.i = icmp eq i32 %call1.val107.i, %9
  br i1 %cmp.i.not.i, label %if.then6.i, label %if.end9.i

if.then6.i:                                       ; preds = %if.else.i
  %.neg.i = mul i64 %16, -4294967296
  %conv.i117 = ashr exact i64 %.neg.i, 32
  %17 = inttoptr i64 %conv.i117 to ptr
  store i32 %dec.i.i, ptr @vec_MAX, align 4
  store ptr %17, ptr %arrayidx.i123.i, align 8
  %18 = getelementptr i8, ptr %14, i64 16
  %call1.val114.i = load ptr, ptr %18, align 8
  %19 = getelementptr i8, ptr %call1.val114.i, i64 8
  %call7.val.i = load ptr, ptr %19, align 8
  store i32 %vec_MAX.promoted191.i, ptr @vec_MAX, align 4
  store ptr %call7.val.i, ptr %arrayidx.i120.i, align 8
  %call1.val106.pre.i = load i32, ptr %14, align 8
  br label %if.end9.i

if.end9.i:                                        ; preds = %if.then6.i, %if.else.i
  %call1.val106.i = phi i32 [ %call1.val107.i, %if.else.i ], [ %call1.val106.pre.i, %if.then6.i ]
  %vec_MAX.promoted188.i = phi i32 [ %dec.i121.i, %if.else.i ], [ %vec_MAX.promoted191.i, %if.then6.i ]
  %cmp.i130.not.i = icmp eq i32 %call1.val106.i, %10
  %cmp.i132.not.i = icmp eq i32 %call1.val106.i, %11
  %or.cond.i = select i1 %cmp.i130.not.i, i1 true, i1 %cmp.i132.not.i
  br i1 %or.cond.i, label %if.then18.i, label %if.else22.i

if.then18.i:                                      ; preds = %if.end9.i
  %sext101.i = shl i64 %16, 32
  %conv19.i = ashr exact i64 %sext101.i, 32
  %20 = inttoptr i64 %conv19.i to ptr
  %inc.i134.i = add nsw i32 %vec_MAX.promoted188.i, 1
  store i32 %inc.i134.i, ptr @vec_MAX, align 4
  %idxprom.i135.i = sext i32 %vec_MAX.promoted188.i to i64
  %arrayidx.i136.i = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %idxprom.i135.i
  store ptr %20, ptr %arrayidx.i136.i, align 8
  %21 = getelementptr i8, ptr %14, i64 16
  br label %do.cond.sink.split.i

if.else22.i:                                      ; preds = %if.end9.i
  %cmp.i140.not.i = icmp eq i32 %call1.val106.i, %3
  br i1 %cmp.i140.not.i, label %if.then27.i, label %if.else35.i

if.then27.i:                                      ; preds = %if.else22.i
  %.neg99.i = mul i64 %16, -4294967296
  %conv29.i = ashr exact i64 %.neg99.i, 32
  %22 = inttoptr i64 %conv29.i to ptr
  %inc.i142.i = add nsw i32 %vec_MAX.promoted188.i, 1
  store i32 %inc.i142.i, ptr @vec_MAX, align 4
  %idxprom.i143.i = sext i32 %vec_MAX.promoted188.i to i64
  %arrayidx.i144.i = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %idxprom.i143.i
  store ptr %22, ptr %arrayidx.i144.i, align 8
  %23 = getelementptr i8, ptr %14, i64 16
  %call1.val112.i = load ptr, ptr %23, align 8
  %24 = getelementptr i8, ptr %call1.val112.i, i64 8
  %call30.val.i = load ptr, ptr %24, align 8
  %inc.i145.i = add nsw i32 %vec_MAX.promoted188.i, 2
  %idxprom.i146.i = sext i32 %inc.i142.i to i64
  %arrayidx.i147.i = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %idxprom.i146.i
  store ptr %call30.val.i, ptr %arrayidx.i147.i, align 8
  %sext100.i = shl i64 %16, 32
  %conv32.i = ashr exact i64 %sext100.i, 32
  %25 = inttoptr i64 %conv32.i to ptr
  %inc.i148.i = add nsw i32 %vec_MAX.promoted188.i, 3
  store i32 %inc.i148.i, ptr @vec_MAX, align 4
  %idxprom.i149.i = sext i32 %inc.i145.i to i64
  %arrayidx.i150.i = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %idxprom.i149.i
  store ptr %25, ptr %arrayidx.i150.i, align 8
  br label %do.cond.sink.split.i

if.else35.i:                                      ; preds = %if.else22.i
  %cmp.i154.not.i = icmp eq i32 %call1.val106.i, %call2.val100
  br i1 %cmp.i154.not.i, label %if.then40.i, label %if.else45.i

if.then40.i:                                      ; preds = %if.else35.i
  %inc.i156.i = add nsw i32 %vec_MAX.promoted188.i, 1
  store i32 %inc.i156.i, ptr @vec_MAX, align 4
  %idxprom.i157.i = sext i32 %vec_MAX.promoted188.i to i64
  %arrayidx.i158.i = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %idxprom.i157.i
  store ptr null, ptr %arrayidx.i158.i, align 8
  %26 = getelementptr i8, ptr %14, i64 16
  %call1.val110.i = load ptr, ptr %26, align 8
  %27 = getelementptr i8, ptr %call1.val110.i, i64 8
  %call41.val.i = load ptr, ptr %27, align 8
  %inc.i159.i = add nsw i32 %vec_MAX.promoted188.i, 2
  %idxprom.i160.i = sext i32 %inc.i156.i to i64
  %arrayidx.i161.i = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %idxprom.i160.i
  store ptr %call41.val.i, ptr %arrayidx.i161.i, align 8
  %inc.i162.i = add nsw i32 %vec_MAX.promoted188.i, 3
  store i32 %inc.i162.i, ptr @vec_MAX, align 4
  %idxprom.i163.i = sext i32 %inc.i159.i to i64
  %arrayidx.i164.i = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %idxprom.i163.i
  store ptr null, ptr %arrayidx.i164.i, align 8
  br label %do.cond.sink.split.i

if.else45.i:                                      ; preds = %if.else35.i
  %cmp.i168.not.i = icmp eq i32 %call1.val106.i, %12
  %cmp.i170.not.i = icmp eq i32 %call1.val106.i, %13
  %or.cond180.i = select i1 %cmp.i168.not.i, i1 true, i1 %cmp.i170.not.i
  br i1 %or.cond180.i, label %if.then55.i, label %do.cond.i

if.then55.i:                                      ; preds = %if.else45.i
  %28 = getelementptr i8, ptr %14, i64 16
  %scan.0183.i = load ptr, ptr %28, align 8
  %cmp.i172.not184.i = icmp eq ptr %scan.0183.i, null
  br i1 %cmp.i172.not184.i, label %do.cond.i, label %for.body.lr.ph.i

for.body.lr.ph.i:                                 ; preds = %if.then55.i
  %sext.i = shl i64 %16, 32
  %conv59.i = ashr exact i64 %sext.i, 32
  %29 = inttoptr i64 %conv59.i to ptr
  %30 = sext i32 %vec_MAX.promoted188.i to i64
  br label %for.body.i

for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  %indvars.iv.i = phi i64 [ %30, %for.body.lr.ph.i ], [ %indvars.iv.next.i, %for.body.i ]
  %scan.0186.i = phi ptr [ %scan.0183.i, %for.body.lr.ph.i ], [ %scan.0.i, %for.body.i ]
  %31 = add nsw i64 %indvars.iv.i, 1
  %32 = trunc i64 %31 to i32
  store i32 %32, ptr @vec_MAX, align 4
  %arrayidx.i176.i = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %indvars.iv.i
  store ptr %29, ptr %arrayidx.i176.i, align 8
  %33 = getelementptr i8, ptr %scan.0186.i, i64 8
  ...
  %arrayidx.i179.i = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %31
  store ptr %scan.0.val.i, ptr %arrayidx.i179.i, align 8
  %scan.0.i = load ptr, ptr %scan.0186.i, align 8
  %cmp.i172.not.i = icmp eq ptr %scan.0.i, null
  br i1 %cmp.i172.not.i, label %do.cond.i, label %for.body.i

do.cond.sink.split.i:                             ; preds = %if.then40.i, %if.then27.i, %if.then18.i
  %.sink162 = phi ptr [ %26, %if.then40.i ], [ %23, %if.then27.i ], [ %21, %if.then18.i ]
  %.sink = phi i32 [ 4, %if.then40.i ], [ 4, %if.then27.i ], [ 2, %if.then18.i ]
  %inc.i134.sink.i = phi i32 [ %inc.i162.i, %if.then40.i ], [ %inc.i148.i, %if.then27.i ], [ %inc.i134.i, %if.then18.i ]
  %call1.val109.i = load ptr, ptr %.sink162, align 8
  %call43.val.i = load ptr, ptr %call1.val109.i, align 8
  %35 = getelementptr i8, ptr %call43.val.i, i64 8
  %inc.i165.i = add nsw i32 %vec_MAX.promoted188.i, %.sink
  %call20.val.val.sink.i = load ptr, ptr %35, align 8
  store i32 %inc.i165.i, ptr @vec_MAX, align 4
  %idxprom.i138.i = sext i32 %inc.i134.sink.i to i64
  %arrayidx.i139.i = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %idxprom.i138.i
  store ptr %call20.val.val.sink.i, ptr %arrayidx.i139.i, align 8
  br label %do.cond.i

do.cond.i:                                        ; preds = %for.body.i, %do.cond.sink.split.i, %if.then55.i, %if.else45.i
  %vec_MAX.promoted189.i = phi i32 [ %vec_MAX.promoted188.i, %if.else45.i ], [ %vec_MAX.promoted188.i, %if.then55.i ], [ %inc.i165.i, %do.cond.sink.split.i ], [ %34, %for.body.i ]
  %cmp67.not.i = icmp eq i32 %dec.i, %vec_MAX.promoted189.i
  br i1 %cmp67.not.i, label %do.end.i, label %do.body.i
...
for.body:                                         ; preds = %for.cond.preheader, %for.body
  ...
  %scan.0152 = phi ptr [ %call2.val102, %for.cond.preheader ], [ %scan.0.val111, %for.body ]
  %58 = getelementptr i8, ptr %scan.0152, i64 8
  ...
  %scan.0.val111 = load ptr, ptr %scan.0152, align 8
  %cmp.i143.not = icmp eq ptr %scan.0.val111, null
  br i1 %cmp.i143.not, label %if.end71, label %for.body
...
for.inc:                                          ; preds = %for.body, %if.else43, %list_Nconc.exit
  ...
  br i1 %cmp.i175.not, label %for.end, label %for.body
...
while.body.i:                                     ; preds = %for.end, %while.body.i
  ...
  br i1 %cmp.i.not.i182, label %list_Delete.exit, label %while.body.i
...
for.body57:                                       ; preds = %list_Delete.exit, %for.body57
  ...
  br i1 %cmp.i184.not, label %if.end101, label %for.body57
...
for.body72:                                       ; preds = %if.then66, %for.body72
  ...
  br i1 %cmp.i191.not, label %if.end101, label %for.body72
...
symbol_IsPredicate.exit201:                       ; preds = %land.lhs.true85
  %sub.i.i197 = sub nsw i32 0, %Term.val
  %31 = load i32, ptr @symbol_TYPEMASK, align 4
  %and.i.i198 = and i32 %31, %sub.i.i197
  %cmp.i199.not = icmp eq i32 %and.i.i198, 2
  br i1 %cmp.i199.not, label %if.end101, label %if.then88
...
for.body94:                                       ; preds = %if.then88, %for.body94
  ...
  br i1 %cmp.i202.not, label %if.end101, label %for.body94
...
while.body.ithread-pre-split:                     ; preds = %while.body.ithread-pre-split.preheader, %while.body.ithread-pre-split
  ...
  br i1 %cmp.i.not.i112, label %tailrecurse.backedge, label %while.body.ithread-pre-split

tailrecurse.backedge:                             ; preds = %while.body.i128thread-pre-split, %while.body.ithread-pre-split
  %Term.val108.val.val.sink171 = phi ptr [ %Term.val108.val.val, %while.body.ithread-pre-split ], [ %Term.val106.val.val, %while.body.i128thread-pre-split ]
...
for.body:                                         ; preds = %if.else, %for.body
  ...
  br i1 %cmp.i113.not, label %for.end, label %for.body

for.end:                                          ; preds = %for.body, %if.else
  %cmp.i.not5.i118 = icmp eq ptr %call13, null
  br i1 %cmp.i.not5.i118, label %while.body.i128thread-pre-split.preheader, label %while.body.i119

while.body.i119:                                  ; preds = %for.end, %while.body.i119
  %Current.06.i120 = phi ptr [ %Current.0.val.i121, %while.body.i119 ], [ %call13, %for.end ]
  ...
  %total_size.i.i.i122 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %34, i64 0, i32 4
  %35 = load i32, ptr %total_size.i.i.i122, align 8
  %conv26.i.i.i123 = sext i32 %35 to i64
  %36 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i124 = add i64 %36, %conv26.i.i.i123
  store i64 %add27.i.i.i124, ptr @memory_FREEDBYTES, align 8
  %37 = load ptr, ptr %34, align 8
  store ptr %37, ptr %Current.06.i120, align 8
  %38 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i120, ptr %38, align 8
  %cmp.i.not.i125 = icmp eq ptr %Current.0.val.i121, null
  br i1 %cmp.i.not.i125, label %while.body.i128thread-pre-split.preheader, label %while.body.i119

while.body.i128thread-pre-split.preheader:        ; preds = %while.body.i119, %for.end
  ...
  %total_size.i.i.i131149 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %41, i64 0, i32 4
  %42 = load i32, ptr %total_size.i.i.i131149, align 8
  %conv26.i.i.i132150 = sext i32 %42 to i64
  %43 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i133151 = add i64 %43, %conv26.i.i.i132150
  store i64 %add27.i.i.i133151, ptr @memory_FREEDBYTES, align 8
  %44 = load ptr, ptr %41, align 8
  store ptr %44, ptr %Term.val106, align 8
  %45 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Term.val106, ptr %45, align 8
  br label %while.body.i128thread-pre-split

while.body.i128thread-pre-split:                  ; preds = %while.body.i128thread-pre-split.preheader, %while.body.i128thread-pre-split
  %Current.0.val.i130153 = phi ptr [ %Current.0.val.i130.pr, %while.body.i128thread-pre-split ], [ %Term.val106.val, %while.body.i128thread-pre-split.preheader ]
  %Current.0.val.i130.pr = load ptr, ptr %Current.0.val.i130153, align 8
  %46 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i131 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %46, i64 0, i32 4
  %47 = load i32, ptr %total_size.i.i.i131, align 8
  %conv26.i.i.i132 = sext i32 %47 to i64
  %48 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i133 = add i64 %48, %conv26.i.i.i132
  store i64 %add27.i.i.i133, ptr @memory_FREEDBYTES, align 8
  %49 = load ptr, ptr %46, align 8
  store ptr %49, ptr %Current.0.val.i130153, align 8
  %50 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.0.val.i130153, ptr %50, align 8
  %cmp.i.not.i134 = icmp eq ptr %Current.0.val.i130.pr, null
  br i1 %cmp.i.not.i134, label %tailrecurse.backedge, label %while.body.i128thread-pre-split
...
for.body44:                                       ; preds = %if.then38, %for.body44
  ...
  br i1 %cmp.i144.not, label %cleanup, label %for.body44
...
fol_IsLiteral.exit:                               ; preds = %land.rhs.i
  %sub.i.i17.i = sub nsw i32 0, %call6.val.i
  %12 = load i32, ptr @symbol_TYPEMASK, align 4
  %and.i.i18.i = and i32 %12, %sub.i.i17.i
  %cmp.i19.i.not = icmp eq i32 %and.i.i18.i, 2
  br i1 %cmp.i19.i.not, label %if.end29, label %if.then12
...
if.then21:                                        ; preds = %if.then12
  ...
  store ptr null, ptr %call.i.i, align 8
  %call24 = tail call ptr @term_Create(i32 noundef %15, ptr noundef nonnull %call.i.i) #17
  br label %if.end25
...
while.body.i:                                     ; preds = %if.else, %while.body.i
  ...
  br i1 %cmp.i.not.i68, label %list_Delete.exit, label %while.body.i
...
for.body.i:                                       ; preds = %if.end37, %for.body.i
  ...
  %call4.i = tail call ptr @term_Create(i32 noundef %26, ptr noundef %Scan.0.val.i) #17
  store ptr %call4.i, ptr %27, align 8
  %Scan.0.val13.i = load ptr, ptr %Scan.015.i, align 8
  %cmp.i.not.i71 = icmp eq ptr %Scan.0.val13.i, null
  br i1 %cmp.i.not.i71, label %cnf_DistributiveFormula.exit, label %for.body.i

cnf_DistributiveFormula.exit:                     ; preds = %for.body.i, %if.end37
  %28 = load i32, ptr @fol_AND, align 4
  %call7.i = tail call ptr @term_Create(i32 noundef %28, ptr noundef %call.i) #17
...
for.body.i:                                       ; preds = %for.body.i, %entry
  ...
  br i1 %exitcond.not.i, label %flag_InitStoreByDefaults.exit, label %for.body.i
...
flag_InitStoreByDefaults.exit:                    ; preds = %for.body.i
  ...
  br i1 %diff.check, label %for.body.i92, label %vector.body
...
vector.body:                                      ; preds = %flag_InitStoreByDefaults.exit, %vector.body
  ...
  br i1 %26, label %symbol_TransferPrecedence.exit, label %vector.body

for.body.i92:                                     ; preds = %flag_InitStoreByDefaults.exit, %for.body.i92
  %indvars.iv.i93 = phi i64 [ %indvars.iv.next.i94.4, %for.body.i92 ], [ 0, %flag_InitStoreByDefaults.exit ]
  %arrayidx.i = getelementptr inbounds i32, ptr %Search.val89, i64 %indvars.iv.i93
  %27 = load i32, ptr %arrayidx.i, align 4
  %arrayidx2.i = getelementptr inbounds i32, ptr %.val88, i64 %indvars.iv.i93
  store i32 %27, ptr %arrayidx2.i, align 4
  %indvars.iv.next.i94 = add nuw nsw i64 %indvars.iv.i93, 1
  %arrayidx.i.1 = getelementptr inbounds i32, ptr %Search.val89, i64 %indvars.iv.next.i94
  %28 = load i32, ptr %arrayidx.i.1, align 4
  %arrayidx2.i.1 = getelementptr inbounds i32, ptr %.val88, i64 %indvars.iv.next.i94
  store i32 %28, ptr %arrayidx2.i.1, align 4
  %indvars.iv.next.i94.1 = add nuw nsw i64 %indvars.iv.i93, 2
  %arrayidx.i.2 = getelementptr inbounds i32, ptr %Search.val89, i64 %indvars.iv.next.i94.1
  %29 = load i32, ptr %arrayidx.i.2, align 4
  %arrayidx2.i.2 = getelementptr inbounds i32, ptr %.val88, i64 %indvars.iv.next.i94.1
  store i32 %29, ptr %arrayidx2.i.2, align 4
  %indvars.iv.next.i94.2 = add nuw nsw i64 %indvars.iv.i93, 3
  %arrayidx.i.3 = getelementptr inbounds i32, ptr %Search.val89, i64 %indvars.iv.next.i94.2
  %30 = load i32, ptr %arrayidx.i.3, align 4
  %arrayidx2.i.3 = getelementptr inbounds i32, ptr %.val88, i64 %indvars.iv.next.i94.2
  store i32 %30, ptr %arrayidx2.i.3, align 4
  %indvars.iv.next.i94.3 = add nuw nsw i64 %indvars.iv.i93, 4
  %arrayidx.i.4 = getelementptr inbounds i32, ptr %Search.val89, i64 %indvars.iv.next.i94.3
  %31 = load i32, ptr %arrayidx.i.4, align 4
  %arrayidx2.i.4 = getelementptr inbounds i32, ptr %.val88, i64 %indvars.iv.next.i94.3
  store i32 %31, ptr %arrayidx2.i.4, align 4
  %indvars.iv.next.i94.4 = add nuw nsw i64 %indvars.iv.i93, 5
  %exitcond.not.i95.4 = icmp eq i64 %indvars.iv.next.i94.4, 4000
  br i1 %exitcond.not.i95.4, label %symbol_TransferPrecedence.exit, label %for.body.i92

symbol_TransferPrecedence.exit:                   ; preds = %vector.body, %for.body.i92
  store ptr null, ptr %SkolemFunctions, align 8
  store ptr null, ptr %SkolemPredicates, align 8
...
for.body.i100:                                    ; preds = %if.end, %for.body.i100
  ...
  %Scan.0.val13.i = load ptr, ptr %Scan.015.i, align 8
  %cmp.i.not.i = icmp eq ptr %Scan.0.val13.i, null
  br i1 %cmp.i.not.i, label %cnf_DistributiveFormula.exit, label %for.body.i100
...
while.body:                                       ; preds = %if.end27, %while.body
  ...
  br i1 %cmp.i103.not, label %while.end, label %while.body
...
while.body.i:                                     ; preds = %if.end43, %while.body.i
  ...
  br i1 %cmp.i.not.i106, label %list_Delete.exit, label %while.body.i

list_Delete.exit:                                 ; preds = %while.body.i, %if.end43
  %55 = load ptr, ptr %SkolemFunctions, align 8
  %cmp.i.not5.i107 = icmp eq ptr %55, null
  br i1 %cmp.i.not5.i107, label %list_Delete.exit115, label %while.body.i108

while.body.i108:                                  ; preds = %list_Delete.exit, %while.body.i108
  %Current.06.i109 = phi ptr [ %Current.0.val.i110, %while.body.i108 ], [ %55, %list_Delete.exit ]
  %Current.0.val.i110 = load ptr, ptr %Current.06.i109, align 8
  %56 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i111 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %56, i64 0, i32 4
  %57 = load i32, ptr %total_size.i.i.i111, align 8
  %conv26.i.i.i112 = sext i32 %57 to i64
  %58 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i113 = add i64 %58, %conv26.i.i.i112
  store i64 %add27.i.i.i113, ptr @memory_FREEDBYTES, align 8
  %59 = load ptr, ptr %56, align 8
  store ptr %59, ptr %Current.06.i109, align 8
  %60 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i109, ptr %60, align 8
  %cmp.i.not.i114 = icmp eq ptr %Current.0.val.i110, null
  br i1 %cmp.i.not.i114, label %list_Delete.exit115, label %while.body.i108

list_Delete.exit115:                              ; preds = %while.body.i108, %list_Delete.exit
...
for.body48:                                       ; preds = %list_Delete.exit115, %for.body48
  ...
  br i1 %cmp.i116.not, label %for.end52, label %for.body48
...
for.body22.i:                                     ; preds = %if.then16.i, %for.body22.i
  ...
  %call24.i = tail call ptr @list_DeleteElementFree(ptr noundef %quantifiervars.0138.i, ptr noundef %predicatevarscan.0.val.i, ptr noundef nonnull @term_Equal, ptr noundef nonnull @term_Delete) #17
  ...
  br i1 %cmp.i119.not.i, label %for.end.i.loopexit, label %for.body22.i
...
while.body.i.i:                                   ; preds = %if.else.i, %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i, label %list_Delete.exit.i, label %while.body.i.i
...
if.end35.i:                                       ; preds = %if.end33.i, %for.body.i
  ...
  br i1 %cmp.i115.not.i, label %if.end39.loopexit.i, label %for.body.i
...
if.end39.i:                                       ; preds = %if.end39.loopexit.i, %while.body.i
  ...
  br i1 %cmp.not.i, label %for.cond40.preheader.i, label %while.body.i

for.body44.i:                                     ; preds = %for.cond40.preheader.i, %for.body44.i
  %scan.1143.i = phi ptr [ %scan.1.val104.i, %for.body44.i ], [ %VarsForTopLevel, %for.cond40.preheader.i ]
  %31 = getelementptr i8, ptr %scan.1143.i, i64 8
  %scan.1.val.i = load ptr, ptr %31, align 8
  %call46.i = tail call ptr @term_Copy(ptr noundef %scan.1.val.i) #17
  store ptr %call46.i, ptr %31, align 8
  %scan.1.val104.i = load ptr, ptr %scan.1143.i, align 8
  %cmp.i129.not.i = icmp eq ptr %scan.1.val104.i, null
  br i1 %cmp.i129.not.i, label %for.end49.i, label %for.body44.i
...
cnf_MovePredicateVariablesUp.exit:                ; preds = %list_Nconc.exit.i, %if.else60.i
  ...
  br i1 %cmp.i.not78.i, label %while.body.i178, label %while.end.i

while.body.i178:                                  ; preds = %cnf_MovePredicateVariablesUp.exit, %while.body.i178
  %subterm.079.i = phi ptr [ %subterm.0.val65.val.val.i, %while.body.i178 ], [ %Term.addr.0.i, %cnf_MovePredicateVariablesUp.exit ]
  ...
  %cmp.i.not.i179 = icmp eq i32 %subterm.0.val57.i, %37
  br i1 %cmp.i.not.i179, label %while.body.i178, label %while.end.i

while.end.i:                                      ; preds = %while.body.i178, %cnf_MovePredicateVariablesUp.exit
  %subterm.0.lcssa.i = phi ptr [ %Term.addr.0.i, %cnf_MovePredicateVariablesUp.exit ], [ %subterm.0.val65.val.val.i, %while.body.i178 ]
  %subterm.0.val57.lcssa.i = phi i32 [ %subterm.0.val5777.i, %cnf_MovePredicateVariablesUp.exit ], [ %subterm.0.val57.i, %while.body.i178 ]
...
if.then22.i:                                      ; preds = %if.then17.i
  %call24.i172 = tail call ptr @cnf_Flatten(ptr noundef nonnull %scan1.0.val.i, i32 noundef %call13.val.i)
  %44 = getelementptr i8, ptr %scan1.0.val.i, i64 16
  %l.081.i = load ptr, ptr %44, align 8
  br label %for.body.i173

for.body.i173:                                    ; preds = %for.body.i173, %if.then22.i
  %l.083.i = phi ptr [ %l.0.i, %for.body.i173 ], [ %l.081.i, %if.then22.i ]
  %45 = getelementptr i8, ptr %l.083.i, i64 8
  %l.0.val.i = load ptr, ptr %45, align 8
  %super.i.i174 = getelementptr inbounds %struct.term, ptr %l.0.val.i, i64 0, i32 1
  store ptr %subterm.0.lcssa.i, ptr %super.i.i174, align 8
  %l.0.i = load ptr, ptr %l.083.i, align 8
  %cmp.i72.not.i = icmp eq ptr %l.0.i, null
  br i1 %cmp.i72.not.i, label %for.end.loopexit.i, label %for.body.i173

for.end.loopexit.i:                               ; preds = %for.body.i173
  ...
  %total_size.i.i.i175 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %47, i64 0, i32 4
  %48 = load i32, ptr %total_size.i.i.i175, align 8
  %conv26.i.i.i176 = sext i32 %48 to i64
  %49 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i177 = add i64 %49, %conv26.i.i.i176
  store i64 %add27.i.i.i177, ptr @memory_FREEDBYTES, align 8
...
if.end36.i:                                       ; preds = %for.end.loopexit.i, %if.then17.i, %while.body12.i
  ...
  br i1 %cmp.i68.not.i, label %cnf_FlattenPath.exit.loopexit, label %while.body12.i
...
for.inc:                                          ; preds = %lor.lhs.false
  ...
  br i1 %cmp.i182.not, label %for.end, label %for.body
...
for.body50:                                       ; preds = %if.end42, %for.body50
  ...
  br i1 %cmp.i186.not, label %while.body.i188, label %for.body50

while.body.i188:                                  ; preds = %for.body50, %while.body.i188
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i188 ], [ %call.i, %for.body50 ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  %68 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i189 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %68, i64 0, i32 4
  %69 = load i32, ptr %total_size.i.i.i189, align 8
  %conv26.i.i.i190 = sext i32 %69 to i64
  %70 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i191 = add i64 %70, %conv26.i.i.i190
  ...
  br i1 %cmp.i.not.i192, label %list_Delete.exit, label %while.body.i188

list_Delete.exit:                                 ; preds = %while.body.i188, %if.end42
...
for.body61:                                       ; preds = %list_Delete.exit, %for.body61
  ...
  br i1 %cmp.i194.not, label %for.end68, label %for.body61
...
for.end68:                                        ; preds = %for.body61, %list_Delete.exit
  ...
  %call71 = tail call ptr @term_Create(i32 noundef %75, ptr noundef nonnull %call.i.i196) #17
  %call72 = tail call ptr @cnf_NegationNormalFormula(ptr noundef %call71)
  %76 = load i32, ptr @fol_IMPLIES, align 4
  %call.i.i197 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  ...
  %call.i199 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  ...
  %call76 = tail call ptr @term_Create(i32 noundef %76, ptr noundef nonnull %call.i199) #17
  ...
  %call.i.i200 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  ...
  %call80 = tail call ptr @fol_CreateQuantifier(i32 noundef %77, ptr noundef %call77, ptr noundef nonnull %call.i.i200) #17
...
while.body:                                       ; preds = %while.body.preheader, %if.end26
  ...
  br i1 %tobool.not, label %while.body.if.end26_crit_edge, label %if.then
...
if.end:                                           ; preds = %if.then8, %if.then
  ...
  %.pre58 = load i32, ptr @vec_MAX, align 4
  br i1 %cmp.i46.not, label %if.end26, label %for.cond.preheader

for.cond.preheader:                               ; preds = %if.end
  %9 = sext i32 %.pre58 to i64
  br label %for.body

for.body:                                         ; preds = %for.cond.preheader, %for.body
  %indvars.iv = phi i64 [ %9, %for.cond.preheader ], [ %indvars.iv.next, %for.body ]
  %scan.055 = phi ptr [ %call2.val40, %for.cond.preheader ], [ %scan.0.val43, %for.body ]
  %10 = getelementptr i8, ptr %scan.055, i64 8
  ...
  %scan.0.val43 = load ptr, ptr %scan.055, align 8
  %cmp.i48.not = icmp eq ptr %scan.0.val43, null
  br i1 %cmp.i48.not, label %if.end26, label %for.body

if.end26:                                         ; preds = %for.body, %while.body.if.end26_crit_edge, %if.end
  %12 = phi i32 [ %.pre, %while.body.if.end26_crit_edge ], [ %.pre58, %if.end ], [ %11, %for.body ]
...
list_Delete.exit:                                 ; preds = %while.body.i
  ...
  br i1 %cmp.i.not5.i204, label %list_Delete.exit212, label %while.body.i205

while.body.i205:                                  ; preds = %list_Delete.exit, %while.body.i205
  %Current.06.i206 = phi ptr [ %Current.0.val.i207, %while.body.i205 ], [ %call3.val189, %list_Delete.exit ]
  %Current.0.val.i207 = load ptr, ptr %Current.06.i206, align 8
  %18 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i208 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %18, i64 0, i32 4
  %19 = load i32, ptr %total_size.i.i.i208, align 8
  %conv26.i.i.i209 = sext i32 %19 to i64
  %20 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i210 = add i64 %20, %conv26.i.i.i209
  store i64 %add27.i.i.i210, ptr @memory_FREEDBYTES, align 8
  %21 = load ptr, ptr %18, align 8
  store ptr %21, ptr %Current.06.i206, align 8
  %22 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i206, ptr %22, align 8
  %cmp.i.not.i211 = icmp eq ptr %Current.0.val.i207, null
  br i1 %cmp.i.not.i211, label %list_Delete.exit212, label %while.body.i205

list_Delete.exit212:                              ; preds = %while.body.i205, %list_Delete.exit
...
for.body:                                         ; preds = %list_Delete.exit212, %for.body
  ...
  br i1 %cmp.i216.not, label %if.end113, label %for.body
...
cnf_GetDualSymbol.exit:                           ; preds = %if.else
  ...
  br i1 %cmp.i.not5.i222, label %list_Delete.exit230, label %while.body.i223

while.body.i223:                                  ; preds = %cnf_GetDualSymbol.exit, %while.body.i223
  %Current.06.i224 = phi ptr [ %Current.0.val.i225, %while.body.i223 ], [ %term1.0.val186, %cnf_GetDualSymbol.exit ]
  %Current.0.val.i225 = load ptr, ptr %Current.06.i224, align 8
  %33 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i226 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %33, i64 0, i32 4
  %34 = load i32, ptr %total_size.i.i.i226, align 8
  %conv26.i.i.i227 = sext i32 %34 to i64
  %35 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i228 = add i64 %35, %conv26.i.i.i227
  store i64 %add27.i.i.i228, ptr @memory_FREEDBYTES, align 8
  %36 = load ptr, ptr %33, align 8
  store ptr %36, ptr %Current.06.i224, align 8
  %37 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i224, ptr %37, align 8
  %cmp.i.not.i229 = icmp eq ptr %Current.0.val.i225, null
  br i1 %cmp.i.not.i229, label %list_Delete.exit230, label %while.body.i223

list_Delete.exit230:                              ; preds = %while.body.i223, %cnf_GetDualSymbol.exit
  %call3.val185 = load ptr, ptr %31, align 8
  store ptr %call3.val185, ptr %1, align 8
  %cmp.i232.not287 = icmp eq ptr %call3.val185, null
  br i1 %cmp.i232.not287, label %for.end44, label %for.body40

for.body40:                                       ; preds = %list_Delete.exit230, %for.body40
  %l25.0288 = phi ptr [ %l25.0.val195, %for.body40 ], [ %call3.val185, %list_Delete.exit230 ]
  ...
  store ptr %term1.0293, ptr %super.i234, align 8
  %l25.0.val195 = load ptr, ptr %l25.0288, align 8
  %cmp.i232.not = icmp eq ptr %l25.0.val195, null
  br i1 %cmp.i232.not, label %for.end44, label %for.body40
...
if.else8.i243:                                    ; preds = %if.else46
  %spec.select.i247 = select i1 %cmp.i238.not, i32 %39, i32 %call3.val178
  %spec.select = select i1 %cmp.i236.not, i32 %40, i32 %spec.select.i247
...
for.end71.thread:                                 ; preds = %if.else8.i243
  store i32 %spec.select, ptr %term1.0293, align 8
  br label %while.body.i256.preheader

for.body64:                                       ; preds = %if.else8.i243, %for.body64
  %scan.0283 = phi ptr [ %scan.0, %for.body64 ], [ %scan.0281, %if.else8.i243 ]
  %42 = getelementptr i8, ptr %scan.0283, i64 8
  %scan.0.val = load ptr, ptr %42, align 8
  %43 = load i32, ptr @fol_NOT, align 4
  %call.i.i252 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  ...
  %call68 = tail call ptr @term_CreateAddFather(i32 noundef %43, ptr noundef nonnull %call.i.i252) #17
  ...
  br i1 %cmp.i250.not, label %for.end71, label %for.body64

for.end71:                                        ; preds = %for.body64
  %term1.0.val182.pre = load ptr, ptr %1, align 8
  store i32 %spec.select, ptr %term1.0293, align 8
  %cmp.i.not5.i255 = icmp eq ptr %term1.0.val182.pre, null
  br i1 %cmp.i.not5.i255, label %list_Delete.exit263, label %while.body.i256.preheader

while.body.i256.preheader:                        ; preds = %for.end71.thread, %for.end71
  %Current.06.i257.ph = phi ptr [ %term1.0.val182.pre, %for.end71 ], [ %term1.0.val201, %for.end71.thread ]
  br label %while.body.i256

while.body.i256:                                  ; preds = %while.body.i256.preheader, %while.body.i256
  %Current.06.i257 = phi ptr [ %Current.0.val.i258, %while.body.i256 ], [ %Current.06.i257.ph, %while.body.i256.preheader ]
  %Current.0.val.i258 = load ptr, ptr %Current.06.i257, align 8
  %44 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i259 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %44, i64 0, i32 4
  %45 = load i32, ptr %total_size.i.i.i259, align 8
  %conv26.i.i.i260 = sext i32 %45 to i64
  %46 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i261 = add i64 %46, %conv26.i.i.i260
  store i64 %add27.i.i.i261, ptr @memory_FREEDBYTES, align 8
  %47 = load ptr, ptr %44, align 8
  store ptr %47, ptr %Current.06.i257, align 8
  %48 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i257, ptr %48, align 8
  %cmp.i.not.i262 = icmp eq ptr %Current.0.val.i258, null
  br i1 %cmp.i.not.i262, label %list_Delete.exit263, label %while.body.i256

list_Delete.exit263:                              ; preds = %while.body.i256, %for.end71
  %call3.val181 = load ptr, ptr %41, align 8
  store ptr %call3.val181, ptr %1, align 8
  %cmp.i265.not284 = icmp eq ptr %call3.val181, null
  br i1 %cmp.i265.not284, label %for.end83, label %for.body79

for.body79:                                       ; preds = %list_Delete.exit263, %for.body79
  %l56.0285 = phi ptr [ %l56.0.val193, %for.body79 ], [ %call3.val181, %list_Delete.exit263 ]
  %49 = getelementptr i8, ptr %l56.0285, i64 8
  %l56.0.val = load ptr, ptr %49, align 8
  %super.i267 = getelementptr inbounds %struct.term, ptr %l56.0.val, i64 0, i32 1
  store ptr %term1.0293, ptr %super.i267, align 8
  %l56.0.val193 = load ptr, ptr %l56.0285, align 8
  %cmp.i265.not = icmp eq ptr %l56.0.val193, null
  br i1 %cmp.i265.not, label %for.end83, label %for.body79
...
for.body99:                                       ; preds = %if.then89, %for.inc106
  %scan.1286 = phi ptr [ %scan.1.val192, %for.inc106 ], [ %term1.1.val179, %if.then89 ]
  %51 = getelementptr i8, ptr %scan.1286, i64 8
...
for.inc106:                                       ; preds = %for.body99
  %scan.1.val192 = load ptr, ptr %scan.1286, align 8
  %cmp.i271.not = icmp eq ptr %scan.1.val192, null
  br i1 %cmp.i271.not, label %while.end, label %for.body99

if.end109:                                        ; preds = %for.body99
  %52 = getelementptr i8, ptr %scan.1286, i64 8
...
for.inc:                                          ; preds = %for.body, %if.else43, %list_Nconc.exit
  ...
  br i1 %cmp.i215.not, label %for.end, label %for.body
...
while.body.i:                                     ; preds = %for.end, %while.body.i
  ...
  br i1 %cmp.i.not.i222, label %list_Delete.exit, label %while.body.i
...
for.inc68:                                        ; preds = %for.body57, %if.then62
  ...
  br i1 %cmp.i224.not, label %if.end119, label %for.body57
...
for.inc88:                                        ; preds = %for.body80, %if.then84
  ...
  br i1 %cmp.i232.not, label %if.end119, label %for.body80
...
symbol_IsPredicate.exit242:                       ; preds = %land.lhs.true98
  %sub.i.i238 = sub nsw i32 0, %Term.val
  %31 = load i32, ptr @symbol_TYPEMASK, align 4
  %and.i.i239 = and i32 %31, %sub.i.i238
  %cmp.i240.not = icmp eq i32 %and.i.i239, 2
  br i1 %cmp.i240.not, label %if.end119, label %if.then101
...
for.inc115:                                       ; preds = %for.body107, %if.then111
  ...
  br i1 %cmp.i243.not, label %if.end119, label %for.body107
...
entry:
  ...
  %cmp.not135.i = icmp eq ptr %SubTerm.val.i, %call.i
  br i1 %cmp.not135.i, label %while.end56.i, label %while.cond2.preheader.i

while.cond2.preheader.i:                          ; preds = %entry, %if.end55.i
  %Term1.0136.i = phi ptr [ %Term1.1.lcssa.i, %if.end55.i ], [ %SubTerm.val.i, %entry ]
  %2 = load i32, ptr @fol_OR, align 4
  %Term1.1.val103127.i = load i32, ptr %Term1.0136.i, align 8
...
while.body7.i:                                    ; preds = %while.cond2.preheader.i, %while.body7.i
  %Term1.1129.i = phi ptr [ %Term1.1.val111.i, %while.body7.i ], [ %Term1.0136.i, %while.cond2.preheader.i ]
  %3 = getelementptr i8, ptr %Term1.1129.i, i64 8
  ...
  br i1 %4, label %while.body7.i, label %while.end.i

while.end.i:                                      ; preds = %while.body7.i, %while.cond2.preheader.i
  %Term1.1.lcssa.i = phi ptr [ %Term1.0136.i, %while.cond2.preheader.i ], [ %Term1.1.val111.i, %while.body7.i ]
...
if.then.i:                                        ; preds = %while.end.i
  ...
  %cmp.i113.not132.i = icmp eq ptr %Term1.1.val112.val.val.i, null
  br i1 %cmp.i113.not132.i, label %while.end28.i, label %while.body19.i

while.body19.i:                                   ; preds = %if.then.i, %if.end.i
  %Scan1.0133.i = phi ptr [ %Scan1.0.val108.i, %if.end.i ], [ %Term1.1.val112.val.val.i, %if.then.i ]
  %11 = getelementptr i8, ptr %Scan1.0133.i, i64 8
  ...
  %Scan1.0.val108.i = load ptr, ptr %Scan1.0133.i, align 8
...
if.end.i:                                         ; preds = %if.then23.i, %while.body19.i
  ...
  br i1 %cmp.i113.not.i, label %while.end28.i, label %while.body19.i
...
while.end28.i:                                    ; preds = %if.end.i, %if.then.i
  ...
  br i1 %narrow.i117.not.i, label %if.end55.i, label %if.then32.i

if.then32.i:                                      ; preds = %while.end28.i
...
while.body47.i:                                   ; preds = %while.body47.i, %if.then32.i
  %Scan1.2134.i = phi ptr [ %call.i.i, %if.then32.i ], [ %Scan1.2.val107.i, %while.body47.i ]
  %16 = getelementptr i8, ptr %Scan1.2134.i, i64 8
  ...
  %Scan1.2.val107.i = load ptr, ptr %Scan1.2134.i, align 8
  %cmp.i121.not.i = icmp eq ptr %Scan1.2.val107.i, null
  br i1 %cmp.i121.not.i, label %if.end55.i, label %while.body47.i
...
if.end55.i:                                       ; preds = %while.body47.i, %if.else52.i, %while.end28.i
  ...
  br i1 %cmp.not.i, label %while.end56.i, label %while.cond2.preheader.i
...
land.lhs.true:                                    ; preds = %if.then
  ...
  %call3.val111.pre = load ptr, ptr %19, align 8
  %call3.val114.val = load ptr, ptr %call3.val111.pre, align 8
...
if.else44:                                        ; preds = %if.then38
  ...
  %call49 = tail call ptr @term_Copy(ptr noundef nonnull %orterm.0147) #17
...
list_Nconc.exit.thread:                           ; preds = %if.end.i
  %call7171 = call ptr @list_Copy(ptr noundef %Conjectures) #17
...
list_Nconc.exit:                                  ; preds = %if.then, %for.end.i
  ...
  br i1 %cmp.i.not.i119, label %list_Nconc.exit128, label %if.end.i120

if.end.i120:                                      ; preds = %list_Nconc.exit.thread, %list_Nconc.exit
  ...
  %cmp.i18.not.i121 = icmp eq ptr %call7174, null
  br i1 %cmp.i18.not.i121, label %list_Nconc.exit128, label %for.cond.i122

for.cond.i122:                                    ; preds = %if.end.i120, %for.cond.i122
  %List1.addr.0.i123 = phi ptr [ %List1.addr.0.val17.i124, %for.cond.i122 ], [ %retval.0.i173, %if.end.i120 ]
  %List1.addr.0.val17.i124 = load ptr, ptr %List1.addr.0.i123, align 8
  %cmp.i20.not.i125 = icmp eq ptr %List1.addr.0.val17.i124, null
  br i1 %cmp.i20.not.i125, label %for.end.i126, label %for.cond.i122

for.end.i126:                                     ; preds = %for.cond.i122
  store ptr %call7174, ptr %List1.addr.0.i123, align 8
  br label %list_Nconc.exit128

list_Nconc.exit128:                               ; preds = %list_Nconc.exit, %if.end.i120, %for.end.i126
  %retval.0.i127 = phi ptr [ %retval.0.i173, %for.end.i126 ], [ %call7, %list_Nconc.exit ], [ %retval.0.i173, %if.end.i120 ]
...
if.end65.us:                                      ; preds = %if.else63.us, %if.then60.us
  ...
  br i1 %cmp.i.not5.i143.us, label %list_Delete.exit151.us, label %while.body.i144.us

while.body.i144.us:                               ; preds = %if.end65.us, %while.body.i144.us
  %Current.06.i145.us = phi ptr [ %Current.0.val.i146.us, %while.body.i144.us ], [ %19, %if.end65.us ]
  %Current.0.val.i146.us = load ptr, ptr %Current.06.i145.us, align 8
  %20 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i147.us = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %20, i64 0, i32 4
  %21 = load i32, ptr %total_size.i.i.i147.us, align 8
  %conv26.i.i.i148.us = sext i32 %21 to i64
  %22 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i149.us = add i64 %22, %conv26.i.i.i148.us
  store i64 %add27.i.i.i149.us, ptr @memory_FREEDBYTES, align 8
  %23 = load ptr, ptr %20, align 8
  store ptr %23, ptr %Current.06.i145.us, align 8
  %24 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i145.us, ptr %24, align 8
  %cmp.i.not.i150.us = icmp eq ptr %Current.0.val.i146.us, null
  br i1 %cmp.i.not.i150.us, label %list_Delete.exit151.us, label %while.body.i144.us

list_Delete.exit151.us:                           ; preds = %while.body.i144.us, %if.end65.us
  %25 = load ptr, ptr %varsfortoplevel, align 8
  %cmp.i.not5.i152.us = icmp eq ptr %25, null
  br i1 %cmp.i.not5.i152.us, label %list_Delete.exit160.us, label %while.body.i153.us

while.body.i153.us:                               ; preds = %list_Delete.exit151.us, %while.body.i153.us
  %Current.06.i154.us = phi ptr [ %Current.0.val.i155.us, %while.body.i153.us ], [ %25, %list_Delete.exit151.us ]
  %Current.0.val.i155.us = load ptr, ptr %Current.06.i154.us, align 8
  %26 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i156.us = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %26, i64 0, i32 4
  %27 = load i32, ptr %total_size.i.i.i156.us, align 8
  %conv26.i.i.i157.us = sext i32 %27 to i64
  %28 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i158.us = add i64 %28, %conv26.i.i.i157.us
  store i64 %add27.i.i.i158.us, ptr @memory_FREEDBYTES, align 8
  %29 = load ptr, ptr %26, align 8
  store ptr %29, ptr %Current.06.i154.us, align 8
  %30 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i154.us, ptr %30, align 8
  %cmp.i.not.i159.us = icmp eq ptr %Current.0.val.i155.us, null
  br i1 %cmp.i.not.i159.us, label %list_Delete.exit160.us, label %while.body.i153.us

list_Delete.exit160.us:                           ; preds = %while.body.i153.us, %list_Delete.exit151.us
...
if.end70.us:                                      ; preds = %if.else68.us, %list_Delete.exit160.us
  ...
  br i1 %cmp.i.not.us, label %while.body.i162.preheader, label %while.body.us
...
while.body.i:                                     ; preds = %if.then44, %while.body.i
  ...
  br i1 %cmp.i.not.i132, label %list_Delete.exit, label %while.body.i

list_Delete.exit:                                 ; preds = %while.body.i, %if.then44
  %45 = load ptr, ptr %varsfortoplevel, align 8
  %cmp.i.not5.i133 = icmp eq ptr %45, null
  br i1 %cmp.i.not5.i133, label %list_Delete.exit141, label %while.body.i134

while.body.i134:                                  ; preds = %list_Delete.exit, %while.body.i134
  %Current.06.i135 = phi ptr [ %Current.0.val.i136, %while.body.i134 ], [ %45, %list_Delete.exit ]
  %Current.0.val.i136 = load ptr, ptr %Current.06.i135, align 8
  %46 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i137 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %46, i64 0, i32 4
  %47 = load i32, ptr %total_size.i.i.i137, align 8
  %conv26.i.i.i138 = sext i32 %47 to i64
  %48 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i139 = add i64 %48, %conv26.i.i.i138
  store i64 %add27.i.i.i139, ptr @memory_FREEDBYTES, align 8
  %49 = load ptr, ptr %46, align 8
  store ptr %49, ptr %Current.06.i135, align 8
  %50 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i135, ptr %50, align 8
  %cmp.i.not.i140 = icmp eq ptr %Current.0.val.i136, null
  br i1 %cmp.i.not.i140, label %list_Delete.exit141, label %while.body.i134

list_Delete.exit141:                              ; preds = %while.body.i134, %list_Delete.exit
  store ptr null, ptr %varsfortoplevel, align 8
  store ptr null, ptr %targettermvars, align 8
...
if.end70:                                         ; preds = %if.else68, %if.end67
  ...
  br i1 %cmp.i.not, label %while.body.i162.preheader, label %while.body

while.body.i162.preheader:                        ; preds = %if.end70, %if.end70.us
  br label %while.body.i162

while.body.i162:                                  ; preds = %while.body.i162.preheader, %while.body.i162
  %Current.06.i163 = phi ptr [ %Current.0.val.i164, %while.body.i162 ], [ %retval.0.i127, %while.body.i162.preheader ]
  %Current.0.val.i164 = load ptr, ptr %Current.06.i163, align 8
  %54 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i165 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %54, i64 0, i32 4
  %55 = load i32, ptr %total_size.i.i.i165, align 8
  %conv26.i.i.i166 = sext i32 %55 to i64
  %56 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i167 = add i64 %56, %conv26.i.i.i166
  store i64 %add27.i.i.i167, ptr @memory_FREEDBYTES, align 8
  %57 = load ptr, ptr %54, align 8
  store ptr %57, ptr %Current.06.i163, align 8
  %58 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i163, ptr %58, align 8
  %cmp.i.not.i168 = icmp eq ptr %Current.0.val.i164, null
  br i1 %cmp.i.not.i168, label %list_Delete.exit169.loopexit, label %while.body.i162

list_Delete.exit169.loopexit:                     ; preds = %while.body.i162
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  %cmp.i108.1 = icmp ugt i32 %dec.i.i.i, 1
  br i1 %cmp.i108.1, label %while.body.i, label %while.end.i
...
if.then.i:                                        ; preds = %while.end.i
  ...
  %idxprom.i.i106 = sext i32 %dec.i.i to i64
  %arrayidx.i.i107 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i106
  %28 = load i32, ptr %arrayidx.i.i107, align 4
...
for.end35:                                        ; preds = %cont_BackTrack.exit
  %29 = icmp eq i32 %changed.1, 0
  br i1 %29, label %if.else63, label %if.then37
...
if.end44:                                         ; preds = %if.then40, %if.then37
  ...
  %31 = load ptr, ptr %symblist, align 8
  %cmp.i.not5.i = icmp eq ptr %31, null
  br i1 %cmp.i.not5.i, label %list_Delete.exit, label %while.body.i109

while.body.i109:                                  ; preds = %if.end44, %while.body.i109
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i109 ], [ %31, %if.end44 ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  ...
  store ptr %35, ptr %Current.06.i, align 8
  %36 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i, ptr %36, align 8
  %cmp.i.not.i110 = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i110, label %list_Delete.exit, label %while.body.i109
...
for.body56:                                       ; preds = %if.then50, %for.body56
  ...
  %38 = getelementptr i8, ptr %l.0129, i64 8
  %l.0.val = load ptr, ptr %38, align 8
  ...
  br i1 %cmp.i113.not, label %cleanup, label %for.body56
...
symbol_IsPredicate.exit60:                        ; preds = %symbol_IsPredicate.exit, %if.end
  ...
  %sub.i.i56 = sub nsw i32 0, %call5.val96
  %4 = load i32, ptr @symbol_TYPEMASK, align 4
  %and.i.i57 = and i32 %4, %sub.i.i56
  %cmp.i58.not = icmp eq i32 %and.i.i57, 2
  br i1 %cmp.i58.not, label %if.end10, label %cleanup
...
for.body:                                         ; preds = %if.end10, %for.body
  ...
  %call20 = tail call ptr @list_DeleteElement(ptr noundef %freevars.089, ptr noundef %l.0.val, ptr noundef nonnull @term_Equal) #17
...
list_Delete.exit:                                 ; preds = %while.body.i
  br i1 %cmp.i62.not87, label %cleanup, label %while.body.i66

while.body.i66:                                   ; preds = %list_Delete.exit, %while.body.i66
  %Current.06.i67 = phi ptr [ %Current.0.val.i68, %while.body.i66 ], [ %call.i61, %list_Delete.exit ]
  %Current.0.val.i68 = load ptr, ptr %Current.06.i67, align 8
  %13 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i69 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %13, i64 0, i32 4
  %14 = load i32, ptr %total_size.i.i.i69, align 8
  %conv26.i.i.i70 = sext i32 %14 to i64
  %15 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i71 = add i64 %15, %conv26.i.i.i70
  store i64 %add27.i.i.i71, ptr @memory_FREEDBYTES, align 8
  %16 = load ptr, ptr %13, align 8
  store ptr %16, ptr %Current.06.i67, align 8
  %17 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i67, ptr %17, align 8
  %cmp.i.not.i72 = icmp eq ptr %Current.0.val.i68, null
  br i1 %cmp.i.not.i72, label %cleanup, label %while.body.i66

if.end25:                                         ; preds = %for.end
  br i1 %cmp.i62.not87, label %list_Delete.exit82, label %while.body.i75

while.body.i75:                                   ; preds = %if.end25, %while.body.i75
  %Current.06.i76 = phi ptr [ %Current.0.val.i77, %while.body.i75 ], [ %call.i61, %if.end25 ]
  %Current.0.val.i77 = load ptr, ptr %Current.06.i76, align 8
  %18 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i78 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %18, i64 0, i32 4
  %19 = load i32, ptr %total_size.i.i.i78, align 8
  %conv26.i.i.i79 = sext i32 %19 to i64
  %20 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i80 = add i64 %20, %conv26.i.i.i79
  store i64 %add27.i.i.i80, ptr @memory_FREEDBYTES, align 8
  %21 = load ptr, ptr %18, align 8
  store ptr %21, ptr %Current.06.i76, align 8
  %22 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i76, ptr %22, align 8
  %cmp.i.not.i81 = icmp eq ptr %Current.0.val.i77, null
  br i1 %cmp.i.not.i81, label %list_Delete.exit82, label %while.body.i75

list_Delete.exit82:                               ; preds = %while.body.i75, %for.end.thread, %if.end25
  %Def.val47 = load ptr, ptr %0, align 8
  %23 = getelementptr i8, ptr %Def.val47, i64 8
  %Def.val47.val = load ptr, ptr %23, align 8
  br label %cleanup

cleanup:                                          ; preds = %while.body.i66, %if.end, %list_Delete.exit, %symbol_IsPredicate.exit60, %list_Delete.exit82
  %retval.0 = phi ptr [ %Def.val47.val, %list_Delete.exit82 ], [ null, %symbol_IsPredicate.exit60 ], [ null, %list_Delete.exit ], [ null, %if.end ], [ null, %while.body.i66 ]
  ret ptr %retval.0
}
...
for.inc.i.i:                                      ; preds = %for.body.i.i
  ...
  br i1 %cmp.i.not.i.i, label %cnf_MakeOneOrPredicate.exit, label %for.body.i.i

lor.rhs.i:                                        ; preds = %for.body.i.i, %for.inc.i
  %scan1.0106.i = phi ptr [ %scan1.0.val79.i, %for.inc.i ], [ %term.val74.i, %for.body.i.i ]
  %3 = getelementptr i8, ptr %scan1.0106.i, i64 8
  %scan1.0.val.i = load ptr, ptr %3, align 8
  %call5.val.i = load i32, ptr %scan1.0.val.i, align 8
  %cmp.i81.i = icmp eq i32 %call5.val.i, %1
  br i1 %cmp.i81.i, label %for.cond15.preheader.i, label %for.inc.i

for.cond15.preheader.i:                           ; preds = %lor.rhs.i
  %4 = load i32, ptr @symbol_TYPEMASK, align 4
  br label %for.body19.i

for.inc.i:                                        ; preds = %lor.rhs.i
  %scan1.0.val79.i = load ptr, ptr %scan1.0106.i, align 8
  %cmp.i80.not.i = icmp eq ptr %scan1.0.val79.i, null
  br i1 %cmp.i80.not.i, label %cnf_MakeOneOrPredicate.exit, label %lor.rhs.i

for.cond33.preheader.i:                           ; preds = %for.inc30.i
  %cond.i = icmp eq ptr %predlist.1.i, null
  br i1 %cond.i, label %cnf_MakeOneOrPredicate.exit, label %for.body37.preheader.i

for.body37.preheader.i:                           ; preds = %for.cond33.preheader.i
  %term.val72.pre.i = load ptr, ptr %0, align 8
  br label %for.body37.i

for.body19.i:                                     ; preds = %for.inc30.i, %for.cond15.preheader.i
  %predlist.0108.i = phi ptr [ null, %for.cond15.preheader.i ], [ %predlist.1.i, %for.inc30.i ]
  %scan.0107.i = phi ptr [ %scan1.0106.i, %for.cond15.preheader.i ], [ %scan.0.val78.i, %for.inc30.i ]
...
lor.lhs.false.i:                                  ; preds = %symbol_IsPredicate.exit.i, %for.body19.i
  ...
  br i1 %cmp.i.not.i88.i, label %land.rhs.i90.i, label %for.inc30.i

land.rhs.i90.i:                                   ; preds = %lor.lhs.false.i
...
fol_IsNegativeLiteral.exit.i:                     ; preds = %land.rhs.i90.i
...
for.inc30.i:                                      ; preds = %if.then27.i, %fol_IsNegativeLiteral.exit.i, %land.rhs.i90.i, %lor.lhs.false.i
  %predlist.1.i = phi ptr [ %call.i.i, %if.then27.i ], [ %predlist.0108.i, %fol_IsNegativeLiteral.exit.i ], [ %predlist.0108.i, %lor.lhs.false.i ], [ %predlist.0108.i, %land.rhs.i90.i ]
  %scan.0.val78.i = load ptr, ptr %scan.0107.i, align 8
  %cmp.i85.not.i = icmp eq ptr %scan.0.val78.i, null
  br i1 %cmp.i85.not.i, label %for.cond33.preheader.i, label %for.body19.i

for.body37.i:                                     ; preds = %for.body37.i, %for.body37.preheader.i
  %term.val72.i = phi ptr [ %call40.i, %for.body37.i ], [ %term.val72.pre.i, %for.body37.preheader.i ]
  %scan.1110.i = phi ptr [ %scan.1.val77.i, %for.body37.i ], [ %predlist.1.i, %for.body37.preheader.i ]
  ...
  br i1 %cmp.i91.not.i, label %if.then46.i, label %for.body37.i
...
if.end:                                           ; preds = %while.body, %list_Nconc.exit
  ...
  br i1 %cmp.i57.not, label %if.end32, label %while.body
...
for.body:                                         ; preds = %if.then23, %for.body
  ...
  br i1 %cmp.i62.not, label %if.end32, label %for.body
...
for.inc:                                          ; preds = %for.body14, %if.then
  ...
  br i1 %cmp.i118.not, label %for.end, label %for.body14
...
while.body.i:                                     ; preds = %if.then34, %while.body.i
  ...
  %cmp.i.not.i = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i, label %if.end47, label %while.body.i
...
if.then59:                                        ; preds = %for.end55
  ...
  br i1 %cmp.i.not5.i138, label %list_Delete.exit146, label %while.body.i139

while.body.i139:                                  ; preds = %if.then59, %while.body.i139
  %Current.06.i140 = phi ptr [ %Current.0.val.i141, %while.body.i139 ], [ %Term.val103, %if.then59 ]
  %Current.0.val.i141 = load ptr, ptr %Current.06.i140, align 8
  %25 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i142 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %25, i64 0, i32 4
  %26 = load i32, ptr %total_size.i.i.i142, align 8
  %conv26.i.i.i143 = sext i32 %26 to i64
  %27 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i144 = add i64 %27, %conv26.i.i.i143
  store i64 %add27.i.i.i144, ptr @memory_FREEDBYTES, align 8
  %28 = load ptr, ptr %25, align 8
  store ptr %28, ptr %Current.06.i140, align 8
  %29 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i140, ptr %29, align 8
  %cmp.i.not.i145 = icmp eq ptr %Current.0.val.i141, null
  br i1 %cmp.i.not.i145, label %list_Delete.exit146, label %while.body.i139

list_Delete.exit146:                              ; preds = %while.body.i139, %if.then59
...
if.end63:                                         ; preds = %list_Delete.exit146, %for.end55
  br i1 %cmp.i.not164, label %list_Delete.exit159, label %while.body.i152

while.body.i152:                                  ; preds = %if.end63, %while.body.i152
  %Current.06.i153 = phi ptr [ %Current.0.val.i154, %while.body.i152 ], [ %call2, %if.end63 ]
  %Current.0.val.i154 = load ptr, ptr %Current.06.i153, align 8
  %36 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i155 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %36, i64 0, i32 4
  %37 = load i32, ptr %total_size.i.i.i155, align 8
  %conv26.i.i.i156 = sext i32 %37 to i64
  %38 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i157 = add i64 %38, %conv26.i.i.i156
  store i64 %add27.i.i.i157, ptr @memory_FREEDBYTES, align 8
  %39 = load ptr, ptr %36, align 8
  store ptr %39, ptr %Current.06.i153, align 8
  %40 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i153, ptr %40, align 8
  %cmp.i.not.i158 = icmp eq ptr %Current.0.val.i154, null
  br i1 %cmp.i.not.i158, label %list_Delete.exit159, label %while.body.i152

list_Delete.exit159:                              ; preds = %while.body.i152, %if.end63
  ret void
}
...
entry:
  %0 = getelementptr i8, ptr %Search, i64 112
  %1 = getelementptr i8, ptr %Search, i64 104
  %term.val570626 = load i32, ptr %term, align 8
  %2 = load i32, ptr @fol_ALL, align 4
  %cmp.i.not.i571627 = icmp eq i32 %2, %term.val570626
  %3 = load i32, ptr @fol_EXIST, align 4
  %cmp.i4.i572628 = icmp eq i32 %3, %term.val570626
  %narrow.i.not573629 = select i1 %cmp.i.not.i571627, i1 true, i1 %cmp.i4.i572628
  br i1 %narrow.i.not573629, label %if.then.lr.ph.lr.ph, label %if.else87
...
if.then.lr.ph:                                    ; preds = %if.then.lr.ph.lr.ph, %list_Delete.exit
  %cmp.i.not.i571634 = phi i1 [ %cmp.i.not.i571627, %if.then.lr.ph.lr.ph ], [ %cmp.i.not.i571, %list_Delete.exit ]
  %Depth.tr.ph631 = phi i32 [ %Depth, %if.then.lr.ph.lr.ph ], [ %Depth.tr574, %list_Delete.exit ]
  %TopAnd.tr.ph630 = phi i32 [ %TopAnd, %if.then.lr.ph.lr.ph ], [ %TopAnd.addr.0548, %list_Delete.exit ]
  br label %if.then

if.then:                                          ; preds = %if.then.lr.ph, %cnf_PopAllQuantifier.exit
  %cmp.i.not.i577 = phi i1 [ %cmp.i.not.i571634, %if.then.lr.ph ], [ %cmp.i.not.i, %cnf_PopAllQuantifier.exit ]
  %Depth.tr574 = phi i32 [ %Depth.tr.ph631, %if.then.lr.ph ], [ %Depth.addr.0, %cnf_PopAllQuantifier.exit ]
  %Search.val575 = load ptr, ptr %0, align 8
  %Search.val221576 = load ptr, ptr %1, align 8
  br i1 %cmp.i.not.i577, label %if.then8, label %if.end19

if.then8:                                         ; preds = %if.then
  %arrayidx.i = getelementptr inbounds i32, ptr %Search.val575, i64 54
  %7 = load i32, ptr %arrayidx.i, align 4
  %tobool10.not = icmp eq i32 %7, 0
  %term.val17.i.pre660 = load ptr, ptr %4, align 8
  br i1 %tobool10.not, label %if.end, label %if.then11

if.then11:                                        ; preds = %if.then8
  %8 = getelementptr i8, ptr %term.val17.i.pre660, i64 8
  %term.val220.val = load ptr, ptr %8, align 8
  %9 = getelementptr i8, ptr %term.val220.val, i64 16
  %scan.0565 = load ptr, ptr %9, align 8
  %cmp.i222.not566 = icmp eq ptr %scan.0565, null
  br i1 %cmp.i222.not566, label %for.end, label %for.body.lr.ph
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  %scan.0567 = phi ptr [ %scan.0565, %for.body.lr.ph ], [ %scan.0, %for.body ]
  %11 = getelementptr i8, ptr %scan.0567, i64 8
  %scan.0.val = load ptr, ptr %11, align 8
  ...
  store i32 %Depth.tr574, ptr %arrayidx, align 4
  %scan.0 = load ptr, ptr %scan.0567, align 8
  %cmp.i222.not = icmp eq ptr %scan.0, null
  br i1 %cmp.i222.not, label %for.end.loopexit, label %for.body

for.end.loopexit:                                 ; preds = %for.body
  %term.val17.i.pre.pre = load ptr, ptr %4, align 8
  br label %for.end

for.end:                                          ; preds = %for.end.loopexit, %if.then11
  %term.val17.i.pre = phi ptr [ %term.val17.i.pre.pre, %for.end.loopexit ], [ %term.val17.i.pre660, %if.then11 ]
  %inc = add nsw i32 %Depth.tr574, 1
  br label %if.end

if.end:                                           ; preds = %for.end, %if.then8
  %term.val17.i = phi ptr [ %term.val17.i.pre, %for.end ], [ %term.val17.i.pre660, %if.then8 ]
  %Depth.addr.0 = phi i32 [ %inc, %for.end ], [ %Depth.tr574, %if.then8 ]
...
while.body.ithread-pre-split.i:                   ; preds = %while.body.ithread-pre-split.i, %if.end
  ...
  br i1 %cmp.i.not.i.i, label %cnf_PopAllQuantifier.exit, label %while.body.ithread-pre-split.i
...
if.then26:                                        ; preds = %if.end19
  %arrayidx.i226 = getelementptr inbounds i32, ptr %Search.val575, i64 53
...
if.then29:                                        ; preds = %if.then26
  ...
  %call32.val = load ptr, ptr %44, align 8
  %cmp.i227583.not = icmp eq ptr %call30.val, null
  br i1 %cmp.i227583.not, label %if.then76, label %while.body.lr.ph

while.body.lr.ph:                                 ; preds = %if.then29
  %tobool40.not = icmp eq i32 %TopAnd.tr.ph630, 0
  %arrayidx.i229 = getelementptr inbounds i32, ptr %Search.val575, i64 33
  %cmp10.not137.i = icmp eq ptr %call32.val, null
  %cmp.i.not.i262 = icmp eq ptr %call20, null
  br label %while.body

while.body:                                       ; preds = %while.body.lr.ph, %if.end73
  %scan.1584 = phi ptr [ %call30.val, %while.body.lr.ph ], [ %scan.1.val215, %if.end73 ]
...
if.else:                                          ; preds = %if.then39
  %48 = getelementptr i8, ptr %scan.1584, i64 8
...
while.body.i.i:                                   ; preds = %while.body.i.i, %if.then.i
  ...
  br i1 %cmp.i.not.i.i234, label %list_Delete.exit.i, label %while.body.i.i
...
for.body.i.i:                                     ; preds = %for.cond.i.i
  ...
  br i1 %cmp.i74.i, label %if.then.i.i, label %for.cond.i.i
...
if.end.i.i.i:                                     ; preds = %while.body.i.i.i
  ...
  br i1 %cmp.i.not.i.i.i, label %if.then7.i.i, label %while.body.i.i.i
...
for.inc.i:                                        ; preds = %while.body.i.i.i, %for.end.i.i, %if.then7.i.i, %for.body.i
  ...
  br i1 %cmp.i.not.i240, label %for.end.i, label %for.body.i
...
for.cond.i79.i:                                   ; preds = %if.end.i.i, %for.cond.i79.i
  ...
  %List1.addr.0.val17.i.i = load ptr, ptr %List1.addr.0.i.i, align 8
  %cmp.i20.not.i.i = icmp eq ptr %List1.addr.0.val17.i.i, null
  br i1 %cmp.i20.not.i.i, label %for.end.i80.i, label %for.cond.i79.i
...
if.end21.i:                                       ; preds = %list_Nconc.exit.i, %if.then14.i
  %call22.i = tail call ptr @list_PointerDeleteDuplicates(ptr noundef nonnull %call11.i241) #17
...
for.inc37.i:                                      ; preds = %if.else.i, %if.then33.i
  ...
  br i1 %cmp.i81.not.i, label %while.body.i.i242, label %for.body30.i

while.body.i.i242:                                ; preds = %for.inc37.i, %while.body.i.i242
  %Current.06.i.i243 = phi ptr [ %Current.0.val.i.i244, %while.body.i.i242 ], [ %call25.i, %for.inc37.i ]
  %Current.0.val.i.i244 = load ptr, ptr %Current.06.i.i243, align 8
  %70 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i245 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %70, i64 0, i32 4
  %71 = load i32, ptr %total_size.i.i.i.i245, align 8
  %conv26.i.i.i.i246 = sext i32 %71 to i64
  %72 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i247 = add i64 %72, %conv26.i.i.i.i246
  store i64 %add27.i.i.i.i247, ptr @memory_FREEDBYTES, align 8
  %73 = load ptr, ptr %70, align 8
  store ptr %73, ptr %Current.06.i.i243, align 8
  %74 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i243, ptr %74, align 8
  %cmp.i.not.i84.i = icmp eq ptr %Current.0.val.i.i244, null
  br i1 %cmp.i.not.i84.i, label %if.end51, label %while.body.i.i242

if.end51:                                         ; preds = %while.body.i.i242, %if.end23.i
...
if.then57:                                        ; preds = %if.then54
  ...
  %79 = getelementptr i8, ptr %scan.1584, i64 8
...
if.end62:                                         ; preds = %if.then41, %if.then57, %if.then54
  %80 = getelementptr i8, ptr %scan.1584, i64 8
  ...
  %call4.i250 = tail call i32 @list_Length(ptr noundef %call2.i) #17
  %cmp.i251 = icmp ult i32 %call4.i250, 2
  br i1 %cmp.i251, label %if.then.i270, label %if.end.i

if.then.i270:                                     ; preds = %if.end62
  %call.val71.i = load ptr, ptr %82, align 8
  %83 = getelementptr i8, ptr %call.val71.i, i64 8
  %call.val71.val.i = load ptr, ptr %83, align 8
  br label %while.body.i.i271

while.body.i.i271:                                ; preds = %while.body.i.i271, %if.then.i270
  %Current.06.i.i272 = phi ptr [ %Current.0.val.i.i273, %while.body.i.i271 ], [ %call.val71.i, %if.then.i270 ]
  %Current.0.val.i.i273 = load ptr, ptr %Current.06.i.i272, align 8
  %84 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i274 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %84, i64 0, i32 4
  %85 = load i32, ptr %total_size.i.i.i.i274, align 8
  %conv26.i.i.i.i275 = sext i32 %85 to i64
  %86 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i276 = add i64 %86, %conv26.i.i.i.i275
  store i64 %add27.i.i.i.i276, ptr @memory_FREEDBYTES, align 8
  %87 = load ptr, ptr %84, align 8
  store ptr %87, ptr %Current.06.i.i272, align 8
  %88 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i272, ptr %88, align 8
  %cmp.i.not.i.i277 = icmp eq ptr %Current.0.val.i.i273, null
  br i1 %cmp.i.not.i.i277, label %list_Delete.exit.i278, label %while.body.i.i271

list_Delete.exit.i278:                            ; preds = %while.body.i.i271
  ...
  %total_size.i.i.i279 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %90, i64 0, i32 4
  %91 = load i32, ptr %total_size.i.i.i279, align 8
  %conv26.i.i.i280 = sext i32 %91 to i64
  %92 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i281 = add i64 %92, %conv26.i.i.i280
...
if.end.i:                                         ; preds = %list_Delete.exit.i278, %if.end62
  br i1 %cmp10.not137.i, label %for.end.i261, label %for.body.i252

for.body.i252:                                    ; preds = %if.end.i, %cnf_RplacVarsymbFunction.exit104.i
  %scan.0138.i = phi ptr [ %scan.0.val68.i260, %cnf_RplacVarsymbFunction.exit104.i ], [ %call32.val, %if.end.i ]
  %95 = getelementptr i8, ptr %scan.0138.i, i64 8
  %scan.0.val.i253 = load ptr, ptr %95, align 8
  %call11.val.i254 = load i32, ptr %scan.0.val.i253, align 8
  %call.i.i255 = tail call i32 @list_Length(ptr noundef %call20) #17
  %call1.i.i = tail call i32 @symbol_CreateSkolemFunction(i32 noundef %call.i.i255, ptr noundef %Search.val221576) #17
  %call.i.i.i256 = tail call ptr @list_CopyWithElement(ptr noundef %call20, ptr noundef nonnull @term_Copy) #17
  %call3.i.i = tail call ptr @term_Create(i32 noundef %call1.i.i, ptr noundef %call.i.i.i256) #17
...
while.body.i73.i:                                 ; preds = %if.end17.i.i, %for.body.i252
  %98 = phi i32 [ %inc.i.i.i, %for.body.i252 ], [ %103, %if.end17.i.i ]
  ...
  %call2.val.i.i257 = load i32, ptr %99, align 8
  %cmp.i.not.i74.i = icmp eq i32 %call2.val.i.i257, %call11.val.i254
  br i1 %cmp.i.not.i74.i, label %if.then.i.i269, label %if.else.i.i

if.then.i.i269:                                   ; preds = %while.body.i73.i
  ...
  %call.i.i75.i = tail call ptr @list_CopyWithElement(ptr noundef %function.val28.i.i, ptr noundef nonnull @term_Copy) #17
...
if.else.i.i:                                      ; preds = %while.body.i73.i
  ...
  br i1 %cmp.i32.not.i.i, label %if.end17.i.i, label %for.body.i.i258

for.body.i.i258:                                  ; preds = %if.else.i.i, %for.body.i.i258
  %indvars.iv.i.i = phi i64 [ %indvars.iv.next.i.i, %for.body.i.i258 ], [ %idxprom.i30.i.i, %if.else.i.i ]
  %scan.041.i.i = phi ptr [ %scan.0.val29.i.i, %for.body.i.i258 ], [ %call2.val27.i.i, %if.else.i.i ]
  %101 = getelementptr i8, ptr %scan.041.i.i, i64 8
  ...
  %scan.0.val29.i.i = load ptr, ptr %scan.041.i.i, align 8
  %cmp.i34.not.i.i = icmp eq ptr %scan.0.val29.i.i, null
  br i1 %cmp.i34.not.i.i, label %if.end17.i.i, label %for.body.i.i258

if.end17.i.i:                                     ; preds = %for.body.i.i258, %if.else.i.i, %if.then.i.i269
  %103 = phi i32 [ %dec.i.i.i, %if.else.i.i ], [ %.pre.i.i, %if.then.i.i269 ], [ %102, %for.body.i.i258 ]
  %cmp.not.i.i = icmp eq i32 %96, %103
  br i1 %cmp.not.i.i, label %cnf_RplacVarsymbFunction.exit.i, label %while.body.i73.i
...
while.body.i79.i:                                 ; preds = %if.end17.i96.i, %cnf_RplacVarsymbFunction.exit.i
  %104 = phi i32 [ %inc.i.i.i, %cnf_RplacVarsymbFunction.exit.i ], [ %109, %if.end17.i96.i ]
  %dec.i.i80.i = add nsw i32 %104, -1
  store i32 %dec.i.i80.i, ptr @vec_MAX, align 4
  %idxprom.i30.i81.i = sext i32 %dec.i.i80.i to i64
  %arrayidx.i31.i82.i = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %idxprom.i30.i81.i
  %105 = load ptr, ptr %arrayidx.i31.i82.i, align 8
  %call2.val.i83.i = load i32, ptr %105, align 8
  %cmp.i.not.i84.i259 = icmp eq i32 %call2.val.i83.i, %call11.val.i254
  br i1 %cmp.i.not.i84.i259, label %if.then.i98.i, label %if.else.i85.i

if.then.i98.i:                                    ; preds = %while.body.i79.i
  %function.val.i99.i = load i32, ptr %call3.i.i, align 8
  store i32 %function.val.i99.i, ptr %105, align 8
  %function.val28.i100.i = load ptr, ptr %97, align 8
  %call.i.i101.i = tail call ptr @list_CopyWithElement(ptr noundef %function.val28.i100.i, ptr noundef nonnull @term_Copy) #17
  %args.i.i102.i = getelementptr inbounds %struct.term, ptr %105, i64 0, i32 2
  store ptr %call.i.i101.i, ptr %args.i.i102.i, align 8
  %.pre.i103.i = load i32, ptr @vec_MAX, align 4
  br label %if.end17.i96.i

if.else.i85.i:                                    ; preds = %while.body.i79.i
  %106 = getelementptr i8, ptr %105, i64 16
  %call2.val27.i86.i = load ptr, ptr %106, align 8
  %cmp.i32.not.i87.i = icmp eq ptr %call2.val27.i86.i, null
  br i1 %cmp.i32.not.i87.i, label %if.end17.i96.i, label %for.body.i88.i

for.body.i88.i:                                   ; preds = %if.else.i85.i, %for.body.i88.i
  %indvars.iv.i89.i = phi i64 [ %indvars.iv.next.i92.i, %for.body.i88.i ], [ %idxprom.i30.i81.i, %if.else.i85.i ]
  %scan.041.i90.i = phi ptr [ %scan.0.val29.i94.i, %for.body.i88.i ], [ %call2.val27.i86.i, %if.else.i85.i ]
  %107 = getelementptr i8, ptr %scan.041.i90.i, i64 8
  %scan.0.val.i91.i = load ptr, ptr %107, align 8
  %indvars.iv.next.i92.i = add i64 %indvars.iv.i89.i, 1
  %108 = trunc i64 %indvars.iv.next.i92.i to i32
  store i32 %108, ptr @vec_MAX, align 4
  %arrayidx.i38.i93.i = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %indvars.iv.i89.i
  store ptr %scan.0.val.i91.i, ptr %arrayidx.i38.i93.i, align 8
  %scan.0.val29.i94.i = load ptr, ptr %scan.041.i90.i, align 8
  %cmp.i34.not.i95.i = icmp eq ptr %scan.0.val29.i94.i, null
  br i1 %cmp.i34.not.i95.i, label %if.end17.i96.i, label %for.body.i88.i

if.end17.i96.i:                                   ; preds = %for.body.i88.i, %if.else.i85.i, %if.then.i98.i
  %109 = phi i32 [ %dec.i.i80.i, %if.else.i85.i ], [ %.pre.i103.i, %if.then.i98.i ], [ %108, %for.body.i88.i ]
  %cmp.not.i97.i = icmp eq i32 %96, %109
  br i1 %cmp.not.i97.i, label %cnf_RplacVarsymbFunction.exit104.i, label %while.body.i79.i

cnf_RplacVarsymbFunction.exit104.i:               ; preds = %if.end17.i96.i
  store i32 %96, ptr @vec_MAX, align 4
  tail call void @term_Delete(ptr noundef %call3.i.i) #17
  %scan.0.val68.i260 = load ptr, ptr %scan.0138.i, align 8
  %cmp10.not.i = icmp eq ptr %scan.0.val68.i260, null
  br i1 %cmp10.not.i, label %for.end.i261, label %for.body.i252

for.end.i261:                                     ; preds = %cnf_RplacVarsymbFunction.exit104.i, %if.end.i
  br i1 %cmp.i.not.i262, label %if.end26.i, label %if.then16.i

if.then16.i:                                      ; preds = %for.end.i261
  %110 = load i32, ptr @fol_ALL, align 4
  %call.i105.i = tail call ptr @list_CopyWithElement(ptr noundef nonnull %call20, ptr noundef nonnull @term_Copy) #17
  %call.i.i106.i = tail call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i.i.i263 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i106.i, i64 0, i32 1
  store ptr %scan.1.val, ptr %car.i.i.i263, align 8
  store ptr null, ptr %call.i.i106.i, align 8
  %call20.i = tail call ptr @fol_CreateQuantifier(i32 noundef %110, ptr noundef %call.i105.i, ptr noundef nonnull %call.i.i106.i) #17
...
while.body.i110.i:                                ; preds = %if.end51.i.i, %if.then23.i
  ...
  %dec.i.i111.i = add nsw i32 %112, -1
  ...
  %cmp.i.not.i.i.i265 = icmp ne i32 %114, %call2.val73.i.i
  %115 = load i32, ptr @fol_EXIST, align 4
  %cmp.i4.i.i.i = icmp ne i32 %115, %call2.val73.i.i
  %narrow.i.not.i.i = select i1 %cmp.i.not.i.i.i265, i1 %cmp.i4.i.i.i, i1 false
...
if.then10.i.i:                                    ; preds = %if.then.i112.i
  ...
  br i1 %cond.i.i, label %if.end36.i.i, label %for.body.i117.i

for.body.i117.i:                                  ; preds = %if.then10.i.i, %for.body.i117.i
  %scan.0100.i.i = phi ptr [ %scan.0.val78.i.i, %for.body.i117.i ], [ %call14.i.i, %if.then10.i.i ]
  ...
  %scan.0.val.i118.i = load ptr, ptr %122, align 8
  %call.i.i.i.i266 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i.i.i.i267 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i.i.i266, i64 0, i32 1
  store ptr %scan.0.val.i118.i, ptr %car.i.i.i.i267, align 8
  store ptr null, ptr %call.i.i.i.i266, align 8
  ...
  %call21.i.i = tail call ptr @fol_CreateQuantifier(i32 noundef %call2.val73.i.i, ptr noundef nonnull %call.i.i.i.i266, ptr noundef nonnull %call.i.i87.i.i) #17
  ...
  %cmp.i.not.i119.i = icmp eq ptr %scan.0.val78.i.i, null
  br i1 %cmp.i.not.i119.i, label %for.body27.i.i, label %for.body.i117.i

for.body27.i.i:                                   ; preds = %for.body.i117.i, %for.body27.i.i
  %scan.1102.i.i = phi ptr [ %scan.1.val77.i.i, %for.body27.i.i ], [ %call14.i.i, %for.body.i117.i ]
  ...
  br i1 %cmp.i89.not.i.i, label %while.body.i.i.i268, label %for.body27.i.i

while.body.i.i.i268:                              ; preds = %for.body27.i.i, %while.body.i.i.i268
  %Current.06.i.i.i = phi ptr [ %Current.0.val.i.i.i, %while.body.i.i.i268 ], [ %call14.i.i, %for.body27.i.i ]
  ...
  br i1 %cmp.i.not.i91.i.i, label %if.end36.i.i, label %while.body.i.i.i268

if.end36.i.i:                                     ; preds = %while.body.i.i.i268, %if.then10.i.i, %if.then.i112.i, %while.body.i110.i
...
for.body46.i.i:                                   ; preds = %for.body46.i.i, %for.cond42.preheader.i.i
  ...
  %indvars.iv.next.i115.i = add i64 %indvars.iv.i114.i, 1
  %134 = trunc i64 %indvars.iv.next.i115.i to i32
  store i32 %134, ptr @vec_MAX, align 4
  %arrayidx.i98.i.i = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %indvars.iv.i114.i
  ...
  br i1 %cmp.i94.not.i.i, label %if.end51.i.i, label %for.body46.i.i

if.end51.i.i:                                     ; preds = %for.body46.i.i, %if.end36.i.i
  %135 = phi i32 [ %.pre.i113.i, %if.end36.i.i ], [ %134, %for.body46.i.i ]
  %cmp.not.i116.i = icmp eq i32 %111, %135
  br i1 %cmp.not.i116.i, label %cnf_QuantMakeOneVar.exit.i, label %while.body.i110.i

cnf_QuantMakeOneVar.exit.i:                       ; preds = %if.end51.i.i
  store i32 %111, ptr @vec_MAX, align 4
  br label %if.end26.i

if.end26.i:                                       ; preds = %cnf_QuantMakeOneVar.exit.i, %if.then16.i, %for.end.i261
  %Proved.addr.0.i = phi ptr [ %scan.1.val, %for.end.i261 ], [ %call20.i, %cnf_QuantMakeOneVar.exit.i ], [ %call20.i, %if.then16.i ]
  ...
  br i1 %cmp.i.not5.i120.i, label %cnf_MoveProvedTermToTopLevel.exit, label %while.body.i121.i

while.body.i121.i:                                ; preds = %if.end26.i, %while.body.i121.i
  %Current.06.i122.i = phi ptr [ %Current.0.val.i123.i, %while.body.i121.i ], [ %Term1.val.i, %if.end26.i ]
  %Current.0.val.i123.i = load ptr, ptr %Current.06.i122.i, align 8
  %137 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i124.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %137, i64 0, i32 4
  %138 = load i32, ptr %total_size.i.i.i124.i, align 8
  %conv26.i.i.i125.i = sext i32 %138 to i64
  %139 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i126.i = add i64 %139, %conv26.i.i.i125.i
  store i64 %add27.i.i.i126.i, ptr @memory_FREEDBYTES, align 8
  %140 = load ptr, ptr %137, align 8
  store ptr %140, ptr %Current.06.i122.i, align 8
  %141 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i122.i, ptr %141, align 8
  %cmp.i.not.i127.i = icmp eq ptr %Current.0.val.i123.i, null
  br i1 %cmp.i.not.i127.i, label %cnf_MoveProvedTermToTopLevel.exit, label %while.body.i121.i

cnf_MoveProvedTermToTopLevel.exit:                ; preds = %while.body.i121.i, %if.end26.i
  %call.val.i264 = load i32, ptr %Term1.val69.val.val.i, align 8
  store i32 %call.val.i264, ptr %term, align 8
  ...
  %call.i133.i = tail call ptr @memory_Malloc(i32 noundef 16) #17
...
if.then67:                                        ; preds = %cnf_MoveProvedTermToTopLevel.exit
  ...
  %call.i283 = tail call i32 @putc(i32 noundef 10, ptr noundef %150)
  br label %if.end74

if.end73:                                         ; preds = %if.end51
  %scan.1.val215 = load ptr, ptr %scan.1584, align 8
  %cmp.i227.not = icmp eq ptr %scan.1.val215, null
  br i1 %cmp.i227.not, label %if.then76, label %while.body

if.end74:                                         ; preds = %cnf_MoveProvedTermToTopLevel.exit, %if.then67
  tail call fastcc void @cnf_OptimizedSkolemFormula(ptr noundef %Search, ptr noundef nonnull %topterm, ptr noundef %toplabel, i32 noundef 1, ptr noundef %Proved.addr.0.i, ptr noundef %UsedTerms, ptr noundef %Symblist, i32 noundef %Result1, ptr noundef %InputClauseToTermLabellist, i32 noundef %Depth.tr574)
  br label %if.end86

if.then76:                                        ; preds = %if.end73, %if.then29, %if.then26
  %arrayidx.i284 = getelementptr inbounds i32, ptr %Search.val575, i64 54
  %151 = load i32, ptr %arrayidx.i284, align 4
...
if.then79:                                        ; preds = %if.then76
  %Search.val.i285 = load ptr, ptr %0, align 8
  %Search.val229.i = load ptr, ptr %1, align 8
  %arrayidx.i532 = getelementptr inbounds i32, ptr %Search.val.i285, i64 54
  %152 = load i32, ptr %arrayidx.i532, align 4
  %tobool.not.i = icmp eq i32 %152, 0
  br i1 %tobool.not.i, label %if.end.i290, label %if.then.i288

if.then.i288:                                     ; preds = %if.then79
  %call3.i289 = tail call i32 @term_MaxVar(ptr noundef %topterm) #17
  store i32 %call3.i289, ptr @symbol_STANDARDVARCOUNTER, align 4
  br label %if.end.i290

if.end.i290:                                      ; preds = %if.then.i288, %if.then79
  ...
  br i1 %cmp.i.not10.i, label %while.body.i515thread-pre-split.preheader, label %for.body.i524

for.body.i524:                                    ; preds = %if.end.i290, %for.body.i524
  %result.012.i = phi ptr [ %call.i.i528, %for.body.i524 ], [ null, %if.end.i290 ]
  %scan.011.i = phi ptr [ %scan.0.val9.i, %for.body.i524 ], [ %call4.val.i, %if.end.i290 ]
  %155 = getelementptr i8, ptr %scan.011.i, i64 8
  %scan.0.val.i525 = load ptr, ptr %155, align 8
  %call2.val.i526 = load i32, ptr %scan.0.val.i525, align 8
  %conv.i527 = sext i32 %call2.val.i526 to i64
  %156 = inttoptr i64 %conv.i527 to ptr
  %call.i.i528 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i.i529 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i528, i64 0, i32 1
  store ptr %156, ptr %car.i.i529, align 8
  store ptr %result.012.i, ptr %call.i.i528, align 8
  %scan.0.val9.i = load ptr, ptr %scan.011.i, align 8
  %cmp.i.not.i530 = icmp eq ptr %scan.0.val9.i, null
  br i1 %cmp.i.not.i530, label %cnf_GetSymbolList.exit.loopexit, label %for.body.i524

cnf_GetSymbolList.exit.loopexit:                  ; preds = %for.body.i524
  ...
  br label %while.body.i515thread-pre-split.preheader

while.body.i515thread-pre-split.preheader:        ; preds = %if.end.i290, %cnf_GetSymbolList.exit.loopexit
  %Term.val226.val.i = phi ptr [ %Term.val227.val.i, %if.end.i290 ], [ %Term.val226.val.i.pre, %cnf_GetSymbolList.exit.loopexit ]
  %result.0.lcssa.i = phi ptr [ null, %if.end.i290 ], [ %call.i.i528, %cnf_GetSymbolList.exit.loopexit ]
  ...
  %158 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i518587 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %158, i64 0, i32 4
  %159 = load i32, ptr %total_size.i.i.i518587, align 8
  %conv26.i.i.i519588 = sext i32 %159 to i64
  %160 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i520589 = add i64 %160, %conv26.i.i.i519588
  store i64 %add27.i.i.i520589, ptr @memory_FREEDBYTES, align 8
  %161 = load ptr, ptr %158, align 8
  store ptr %161, ptr %Term.val225.i, align 8
  %162 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Term.val225.i, ptr %162, align 8
  br label %while.body.i515thread-pre-split

while.body.i515thread-pre-split:                  ; preds = %while.body.i515thread-pre-split.preheader, %while.body.i515thread-pre-split
  %Current.0.val.i517591 = phi ptr [ %Current.0.val.i517.pr, %while.body.i515thread-pre-split ], [ %Term.val225.val.i, %while.body.i515thread-pre-split.preheader ]
  %Current.0.val.i517.pr = load ptr, ptr %Current.0.val.i517591, align 8
  %163 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i518 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %163, i64 0, i32 4
  %164 = load i32, ptr %total_size.i.i.i518, align 8
  %conv26.i.i.i519 = sext i32 %164 to i64
  %165 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i520 = add i64 %165, %conv26.i.i.i519
  store i64 %add27.i.i.i520, ptr @memory_FREEDBYTES, align 8
  %166 = load ptr, ptr %163, align 8
  store ptr %166, ptr %Current.0.val.i517591, align 8
  %167 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.0.val.i517591, ptr %167, align 8
  %cmp.i.not.i521 = icmp eq ptr %Current.0.val.i517.pr, null
  br i1 %cmp.i.not.i521, label %list_Delete.exit523, label %while.body.i515thread-pre-split

list_Delete.exit523:                              ; preds = %while.body.i515thread-pre-split
  ...
  %scan.0.i594 = load ptr, ptr %4, align 8
  %cmp.i512.not595 = icmp eq ptr %scan.0.i594, null
  br i1 %cmp.i512.not595, label %for.end.i296, label %for.body.i299.lr.ph

for.body.i299.lr.ph:                              ; preds = %list_Delete.exit523
  %cmp.i.not8.i.i490 = icmp eq ptr %result.0.lcssa.i, null
  br label %for.body.i299

for.body.i299:                                    ; preds = %for.body.i299.lr.ph, %for.inc.i303
  %scan.0.i597 = phi ptr [ %scan.0.i594, %for.body.i299.lr.ph ], [ %scan.0.i, %for.inc.i303 ]
  %pairlist.0.i596 = phi ptr [ null, %for.body.i299.lr.ph ], [ %pairlist.2.i, %for.inc.i303 ]
  %174 = getelementptr i8, ptr %scan.0.i597, i64 8
  %scan.0.val219.i = load ptr, ptr %174, align 8
  %call.i488 = tail call ptr @fol_FreeVariables(ptr noundef %scan.0.val219.i) #17
  %cmp.i.not16.i489 = icmp eq ptr %call.i488, null
  %or.cond.i491 = or i1 %cmp.i.not8.i.i490, %cmp.i.not16.i489
  br i1 %or.cond.i491, label %cnf_FreeVariablesBut.exit511, label %for.body.i492

for.body.i492:                                    ; preds = %for.body.i299, %for.inc.i503
  %Scan.017.i493 = phi ptr [ %Scan.0.val13.i504, %for.inc.i503 ], [ %call.i488, %for.body.i299 ]
  %175 = getelementptr i8, ptr %Scan.017.i493, i64 8
  %Scan.0.val.i494 = load ptr, ptr %175, align 8
  %call2.val.i495 = load i32, ptr %Scan.0.val.i494, align 8
  %conv.i496 = sext i32 %call2.val.i495 to i64
  %176 = inttoptr i64 %conv.i496 to ptr
  br label %while.body.i.i497

while.body.i.i497:                                ; preds = %if.end.i.i508, %for.body.i492
  %List.addr.09.i.i498 = phi ptr [ %List.addr.0.val7.i.i509, %if.end.i.i508 ], [ %result.0.lcssa.i, %for.body.i492 ]
  %177 = getelementptr i8, ptr %List.addr.09.i.i498, i64 8
  %List.addr.0.val.i.i499 = load ptr, ptr %177, align 8
  %call2.i.i500 = tail call i32 @symbol_Equal(ptr noundef %176, ptr noundef %List.addr.0.val.i.i499) #17
  %tobool3.not.i.i501 = icmp eq i32 %call2.i.i500, 0
  br i1 %tobool3.not.i.i501, label %if.end.i.i508, label %if.then.i502

if.end.i.i508:                                    ; preds = %while.body.i.i497
  %List.addr.0.val7.i.i509 = load ptr, ptr %List.addr.09.i.i498, align 8
  %cmp.i.not.i.i510 = icmp eq ptr %List.addr.0.val7.i.i509, null
  br i1 %cmp.i.not.i.i510, label %for.inc.i503, label %while.body.i.i497

if.then.i502:                                     ; preds = %while.body.i.i497
  store ptr null, ptr %175, align 8
  br label %for.inc.i503

for.inc.i503:                                     ; preds = %if.end.i.i508, %if.then.i502
  %Scan.0.val13.i504 = load ptr, ptr %Scan.017.i493, align 8
  %cmp.i.not.i505 = icmp eq ptr %Scan.0.val13.i504, null
  br i1 %cmp.i.not.i505, label %cnf_FreeVariablesBut.exit511, label %for.body.i492

cnf_FreeVariablesBut.exit511:                     ; preds = %for.inc.i503, %for.body.i299
  %call7.i507 = tail call ptr @list_PointerDeleteElement(ptr noundef %call.i488, ptr noundef null) #17
  %call.i.i486 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i.i487 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i486, i64 0, i32 1
  store ptr %scan.0.val219.i, ptr %car.i.i487, align 8
  store ptr %call7.i507, ptr %call.i.i486, align 8
  %cmp.i484.not = icmp eq ptr %pairlist.0.i596, null
  br i1 %cmp.i484.not, label %if.then22.i, label %if.else.i304

if.then22.i:                                      ; preds = %cnf_FreeVariablesBut.exit511
  %call.i.i482 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i.i483 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i482, i64 0, i32 1
  store ptr %call.i.i486, ptr %car.i.i483, align 8
  store ptr null, ptr %call.i.i482, align 8
  br label %for.inc.i303

if.else.i304:                                     ; preds = %cnf_FreeVariablesBut.exit511
  %call25.i305 = tail call i32 @list_Length(ptr noundef %call7.i507) #17
  br label %while.body.i

while.body.i:                                     ; preds = %if.else.i304, %if.end49.i
  %pairscan.0.i593 = phi ptr [ %pairlist.0.i596, %if.else.i304 ], [ %pairscan.1.i, %if.end49.i ]
  %pairscan_pred.0.i592 = phi ptr [ null, %if.else.i304 ], [ %pairscan.0.i593, %if.end49.i ]
  %178 = getelementptr i8, ptr %pairscan.0.i593, i64 8
  ...
  %cmp.i306 = icmp slt i32 %call32.i, %call25.i305
  br i1 %cmp.i306, label %if.end49.i, label %if.else35.i

if.else35.i:                                      ; preds = %while.body.i
  %cmp36.i = icmp eq i32 %call32.i, %call25.i305
...
if.then37.i:                                      ; preds = %if.else35.i
  ...
  %call19.val.i = load ptr, ptr %call.i.i486, align 8
  %cmp.i.not33.i = icmp eq ptr %call38.val.i, null
  br i1 %cmp.i.not33.i, label %for.cond4.preheader.i, label %for.body.lr.ph.i472

for.body.lr.ph.i472:                              ; preds = %if.then37.i
  %179 = load ptr, ptr @cnf_VARIABLEDEPTHARRAY, align 8
  br label %for.body.i473

for.cond4.preheader.i:                            ; preds = %for.body.i473, %if.then37.i
  %maxdepth1.0.lcssa.i = phi i32 [ 0, %if.then37.i ], [ %spec.select.i477, %for.body.i473 ]
...
for.body.i473:                                    ; preds = %for.body.i473, %for.body.lr.ph.i472
  %scan.035.i = phi ptr [ %call38.val.i, %for.body.lr.ph.i472 ], [ %scan.0.val30.i, %for.body.i473 ]
  %maxdepth1.034.i = phi i32 [ 0, %for.body.lr.ph.i472 ], [ %spec.select.i477, %for.body.i473 ]
  %181 = getelementptr i8, ptr %scan.035.i, i64 8
  %scan.0.val.i474 = load ptr, ptr %181, align 8
  %call1.val.i475 = load i32, ptr %scan.0.val.i474, align 8
  %idxprom.i = sext i32 %call1.val.i475 to i64
  %arrayidx.i476 = getelementptr inbounds i32, ptr %179, i64 %idxprom.i
  %182 = load i32, ptr %arrayidx.i476, align 4
  %spec.select.i477 = tail call i32 @llvm.smax.i32(i32 %182, i32 %maxdepth1.034.i)
  %scan.0.val30.i = load ptr, ptr %scan.035.i, align 8
  %cmp.i.not.i478 = icmp eq ptr %scan.0.val30.i, null
  br i1 %cmp.i.not.i478, label %for.cond4.preheader.i, label %for.body.i473
...
for.body8.i:                                      ; preds = %for.inc17.i, %for.body8.lr.ph.i
  ...
  %scan.1.val.i479 = load ptr, ptr %183, align 8
  %call10.val.i = load i32, ptr %scan.1.val.i479, align 8
...
for.inc17.i:                                      ; preds = %for.body8.i
  ...
  br i1 %cmp.i31.not.i, label %if.end49.i, label %for.body8.i

if.end49.i:                                       ; preds = %for.inc17.i, %for.cond4.preheader.i, %while.body.i
  %pairscan.1.i = load ptr, ptr %pairscan.0.i593, align 8
  %cmp.i480.not = icmp eq ptr %pairscan.1.i, null
  br i1 %cmp.i480.not, label %if.then52.i.loopexit, label %while.body.i

if.then52.i.loopexit:                             ; preds = %if.end49.i
  %call.i.i468 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i.i469 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i468, i64 0, i32 1
  store ptr %call.i.i486, ptr %car.i.i469, align 8
  store ptr null, ptr %call.i.i468, align 8
  store ptr %call.i.i468, ptr %pairscan.0.i593, align 8
  br label %for.inc.i303

if.else54.i:                                      ; preds = %if.else35.i, %for.body8.i
  %cmp.i466.not = icmp eq ptr %pairscan_pred.0.i592, null
  br i1 %cmp.i466.not, label %if.then59.i, label %if.else61.i

if.then59.i:                                      ; preds = %if.else54.i
  %call.i464 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i465 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i464, i64 0, i32 1
  store ptr %call.i.i486, ptr %car.i465, align 8
  store ptr %pairlist.0.i596, ptr %call.i464, align 8
  br label %for.inc.i303

if.else61.i:                                      ; preds = %if.else54.i
  tail call void @list_InsertNext(ptr noundef nonnull %pairscan_pred.0.i592, ptr noundef nonnull %call.i.i486) #17
  br label %for.inc.i303

for.inc.i303:                                     ; preds = %if.else61.i, %if.then59.i, %if.then52.i.loopexit, %if.then22.i
  %pairlist.2.i = phi ptr [ %call.i.i482, %if.then22.i ], [ %pairlist.0.i596, %if.then52.i.loopexit ], [ %call.i464, %if.then59.i ], [ %pairlist.0.i596, %if.else61.i ]
  %scan.0.i = load ptr, ptr %scan.0.i597, align 8
  %cmp.i512.not = icmp eq ptr %scan.0.i, null
  br i1 %cmp.i512.not, label %for.end.i296, label %for.body.i299

for.end.i296:                                     ; preds = %for.inc.i303, %list_Delete.exit523
  %pairlist.0.i.lcssa = phi ptr [ null, %list_Delete.exit523 ], [ %pairlist.2.i, %for.inc.i303 ]
  %call.i450 = tail call ptr @fol_FreeVariables(ptr noundef nonnull %term) #17
  %cmp.i.not16.i = icmp eq ptr %call.i450, null
  %cmp.i.not8.i.i = icmp eq ptr %result.0.lcssa.i, null
  %or.cond.i451 = or i1 %cmp.i.not8.i.i, %cmp.i.not16.i
  br i1 %or.cond.i451, label %cnf_FreeVariablesBut.exit, label %for.body.i452

for.body.i452:                                    ; preds = %for.end.i296, %for.inc.i458
  %Scan.017.i = phi ptr [ %Scan.0.val13.i, %for.inc.i458 ], [ %call.i450, %for.end.i296 ]
  %185 = getelementptr i8, ptr %Scan.017.i, i64 8
  %Scan.0.val.i = load ptr, ptr %185, align 8
  %call2.val.i453 = load i32, ptr %Scan.0.val.i, align 8
  %conv.i454 = sext i32 %call2.val.i453 to i64
  %186 = inttoptr i64 %conv.i454 to ptr
  br label %while.body.i.i455

while.body.i.i455:                                ; preds = %if.end.i.i462, %for.body.i452
  %List.addr.09.i.i = phi ptr [ %List.addr.0.val7.i.i, %if.end.i.i462 ], [ %result.0.lcssa.i, %for.body.i452 ]
  %187 = getelementptr i8, ptr %List.addr.09.i.i, i64 8
  %List.addr.0.val.i.i = load ptr, ptr %187, align 8
  %call2.i.i456 = tail call i32 @symbol_Equal(ptr noundef %186, ptr noundef %List.addr.0.val.i.i) #17
  %tobool3.not.i.i = icmp eq i32 %call2.i.i456, 0
  br i1 %tobool3.not.i.i, label %if.end.i.i462, label %if.then.i457

if.end.i.i462:                                    ; preds = %while.body.i.i455
  %List.addr.0.val7.i.i = load ptr, ptr %List.addr.09.i.i, align 8
  %cmp.i.not.i.i463 = icmp eq ptr %List.addr.0.val7.i.i, null
  br i1 %cmp.i.not.i.i463, label %for.inc.i458, label %while.body.i.i455

if.then.i457:                                     ; preds = %while.body.i.i455
  store ptr null, ptr %185, align 8
  br label %for.inc.i458

for.inc.i458:                                     ; preds = %if.end.i.i462, %if.then.i457
  %Scan.0.val13.i = load ptr, ptr %Scan.017.i, align 8
  %cmp.i.not.i459 = icmp eq ptr %Scan.0.val13.i, null
  br i1 %cmp.i.not.i459, label %cnf_FreeVariablesBut.exit, label %for.body.i452

cnf_FreeVariablesBut.exit:                        ; preds = %for.inc.i458, %for.end.i296
  %call7.i461 = tail call ptr @list_PointerDeleteElement(ptr noundef %call.i450, ptr noundef null) #17
...
for.body74.i:                                     ; preds = %cnf_FreeVariablesBut.exit, %for.body74.i
  %mapping.0.i601 = phi ptr [ %call.i442, %for.body74.i ], [ null, %cnf_FreeVariablesBut.exit ]
  %scan.1.i600 = phi ptr [ %scan.1.val221.i, %for.body74.i ], [ %result.0.lcssa.i, %cnf_FreeVariablesBut.exit ]
  %call75.i = tail call i32 @symbol_CreateSkolemFunction(i32 noundef %call68.i, ptr noundef %Search.val229.i) #17
  %conv.i297 = sext i32 %call75.i to i64
  %188 = inttoptr i64 %conv.i297 to ptr
  %189 = load ptr, ptr %Symblist, align 8
  %call.i446 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i447 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i446, i64 0, i32 1
  store ptr %188, ptr %car.i447, align 8
  store ptr %189, ptr %call.i446, align 8
  store ptr %call.i446, ptr %Symblist, align 8
  %190 = getelementptr i8, ptr %scan.1.i600, i64 8
  %scan.1.val.i298 = load ptr, ptr %190, align 8
  %call.i.i444 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i.i445 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i444, i64 0, i32 1
  store ptr %scan.1.val.i298, ptr %car.i.i445, align 8
  store ptr %188, ptr %call.i.i444, align 8
  %call.i442 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i443 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i442, i64 0, i32 1
  store ptr %call.i.i444, ptr %car.i443, align 8
  store ptr %mapping.0.i601, ptr %call.i442, align 8
  %scan.1.val221.i = load ptr, ptr %scan.1.i600, align 8
  %cmp.i448.not = icmp eq ptr %scan.1.val221.i, null
  br i1 %cmp.i448.not, label %for.end83.i, label %for.body74.i

for.end83.i:                                      ; preds = %for.body74.i, %cnf_FreeVariablesBut.exit
  %mapping.0.i.lcssa = phi ptr [ null, %cnf_FreeVariablesBut.exit ], [ %call.i442, %for.body74.i ]
  %cmp.i.not5.i432 = icmp eq ptr %call7.i461, null
  br i1 %cmp.i.not5.i432, label %list_Delete.exit441, label %while.body.i433

while.body.i433:                                  ; preds = %for.end83.i, %while.body.i433
  %Current.06.i434 = phi ptr [ %Current.0.val.i435, %while.body.i433 ], [ %call7.i461, %for.end83.i ]
  %Current.0.val.i435 = load ptr, ptr %Current.06.i434, align 8
  %191 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i436 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %191, i64 0, i32 4
  %192 = load i32, ptr %total_size.i.i.i436, align 8
  %conv26.i.i.i437 = sext i32 %192 to i64
  %193 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i438 = add i64 %193, %conv26.i.i.i437
  store i64 %add27.i.i.i438, ptr @memory_FREEDBYTES, align 8
  %194 = load ptr, ptr %191, align 8
  store ptr %194, ptr %Current.06.i434, align 8
  %195 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i434, ptr %195, align 8
  %cmp.i.not.i439 = icmp eq ptr %Current.0.val.i435, null
  br i1 %cmp.i.not.i439, label %list_Delete.exit441, label %while.body.i433

list_Delete.exit441:                              ; preds = %while.body.i433, %for.end83.i
  %cmp86.i603 = icmp sgt i32 %call68.i, 0
  br i1 %cmp86.i603, label %for.body88.i, label %for.cond94.i.preheader

for.cond94.i.preheader:                           ; preds = %for.body88.i, %list_Delete.exit441
  %newvariables.0.i.lcssa = phi ptr [ null, %list_Delete.exit441 ], [ %call.i431, %for.body88.i ]
  %cmp.i429.not613 = icmp eq ptr %pairlist.0.i.lcssa, null
  br i1 %cmp.i429.not613, label %while.cond128.i.preheader, label %for.body98.i.lr.ph

for.body98.i.lr.ph:                               ; preds = %for.cond94.i.preheader
  %cmp.i.not61.i = icmp eq ptr %mapping.0.i.lcssa, null
  br label %for.body98.i

for.body88.i:                                     ; preds = %list_Delete.exit441, %for.body88.i
  %newvariables.0.i605 = phi ptr [ %call.i431, %for.body88.i ], [ null, %list_Delete.exit441 ]
  %i.0.i604 = phi i32 [ %inc.i, %for.body88.i ], [ 0, %list_Delete.exit441 ]
  %call89.i = tail call ptr @term_CreateStandardVariable() #17
  %call.i431 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i431, i64 0, i32 1
  store ptr %call89.i, ptr %car.i, align 8
  store ptr %newvariables.0.i605, ptr %call.i431, align 8
  %inc.i = add nuw nsw i32 %i.0.i604, 1
  %exitcond.not = icmp eq i32 %inc.i, %call68.i
  br i1 %exitcond.not, label %for.cond94.i.preheader, label %for.body88.i

while.cond128.i.preheader:                        ; preds = %list_Delete.exit390, %for.cond94.i.preheader
  %accumulatedvariables.0.i.lcssa = phi ptr [ null, %for.cond94.i.preheader ], [ %call.i418, %list_Delete.exit390 ]
  %strskolemsuccess.0.i.lcssa = phi i32 [ 0, %for.cond94.i.preheader ], [ %spec.select.i, %list_Delete.exit390 ]
  %newvariables.1.i.lcssa = phi ptr [ %newvariables.0.i.lcssa, %for.cond94.i.preheader ], [ %newvariables.2.i.lcssa, %list_Delete.exit390 ]
  %cmp.i379.not622 = icmp eq ptr %newvariables.1.i.lcssa, null
  br i1 %cmp.i379.not622, label %while.end135.i, label %while.body132.i

for.body98.i:                                     ; preds = %for.body98.i.lr.ph, %list_Delete.exit390
  %newvariables.1.i618 = phi ptr [ %newvariables.0.i.lcssa, %for.body98.i.lr.ph ], [ %newvariables.2.i.lcssa, %list_Delete.exit390 ]
  %acc_length.0.i617 = phi i32 [ 0, %for.body98.i.lr.ph ], [ %call113.i, %list_Delete.exit390 ]
  %strskolemsuccess.0.i616 = phi i32 [ 0, %for.body98.i.lr.ph ], [ %spec.select.i, %list_Delete.exit390 ]
  %pairscan.2.i615 = phi ptr [ %pairlist.0.i.lcssa, %for.body98.i.lr.ph ], [ %pairscan.2.val220.i, %list_Delete.exit390 ]
  %accumulatedvariables.0.i614 = phi ptr [ null, %for.body98.i.lr.ph ], [ %call.i418, %list_Delete.exit390 ]
  %196 = getelementptr i8, ptr %pairscan.2.i615, i64 8
  %pairscan.2.val217.i = load ptr, ptr %196, align 8
  %call99.val.i = load ptr, ptr %pairscan.2.val217.i, align 8
  %cmp.i.not.i419 = icmp eq ptr %accumulatedvariables.0.i614, null
  br i1 %cmp.i.not.i419, label %list_Nconc.exit428, label %if.end.i420

if.end.i420:                                      ; preds = %for.body98.i
  %cmp.i18.not.i421 = icmp eq ptr %call99.val.i, null
  br i1 %cmp.i18.not.i421, label %list_Nconc.exit428, label %for.cond.i422

for.cond.i422:                                    ; preds = %if.end.i420, %for.cond.i422
  %List1.addr.0.i423 = phi ptr [ %List1.addr.0.val17.i424, %for.cond.i422 ], [ %accumulatedvariables.0.i614, %if.end.i420 ]
  %List1.addr.0.val17.i424 = load ptr, ptr %List1.addr.0.i423, align 8
  %cmp.i20.not.i425 = icmp eq ptr %List1.addr.0.val17.i424, null
  br i1 %cmp.i20.not.i425, label %for.end.i426, label %for.cond.i422

for.end.i426:                                     ; preds = %for.cond.i422
  store ptr %call99.val.i, ptr %List1.addr.0.i423, align 8
  br label %list_Nconc.exit428

list_Nconc.exit428:                               ; preds = %for.body98.i, %if.end.i420, %for.end.i426
  %retval.0.i427 = phi ptr [ %accumulatedvariables.0.i614, %for.end.i426 ], [ %call99.val.i, %for.body98.i ], [ %accumulatedvariables.0.i614, %if.end.i420 ]
  %call.i418 = tail call ptr @list_DeleteDuplicates(ptr noundef %retval.0.i427, ptr noundef nonnull @term_Equal) #17
  %call104.i607 = tail call i32 @list_Length(ptr noundef %call.i418) #17
  %cmp105.i609.not = icmp eq i32 %call104.i607, %acc_length.0.i617
  br i1 %cmp105.i609.not, label %for.end112.i, label %for.body107.i

for.body107.i:                                    ; preds = %list_Nconc.exit428, %for.body107.i
  %newvariables.2.i611 = phi ptr [ %L.val.i414, %for.body107.i ], [ %newvariables.1.i618, %list_Nconc.exit428 ]
  %i.1.i610 = phi i32 [ %inc111.i, %for.body107.i ], [ 0, %list_Nconc.exit428 ]
  %197 = getelementptr i8, ptr %newvariables.2.i611, i64 8
  %newvariables.2.val.i = load ptr, ptr %197, align 8
  tail call void @term_Delete(ptr noundef %newvariables.2.val.i) #17
  %L.val.i414 = load ptr, ptr %newvariables.2.i611, align 8
  %198 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i415 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %198, i64 0, i32 4
  %199 = load i32, ptr %total_size.i.i.i415, align 8
  %conv26.i.i.i416 = sext i32 %199 to i64
  %200 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i417 = add i64 %200, %conv26.i.i.i416
  store i64 %add27.i.i.i417, ptr @memory_FREEDBYTES, align 8
  %201 = load ptr, ptr %198, align 8
  store ptr %201, ptr %newvariables.2.i611, align 8
  %202 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %newvariables.2.i611, ptr %202, align 8
  %inc111.i = add nuw nsw i32 %i.1.i610, 1
  %call104.i = tail call i32 @list_Length(ptr noundef %call.i418) #17
  %sub.i = sub i32 %call104.i, %acc_length.0.i617
  %cmp105.i = icmp ult i32 %inc111.i, %sub.i
  br i1 %cmp105.i, label %for.body107.i, label %for.end112.i

for.end112.i:                                     ; preds = %for.body107.i, %list_Nconc.exit428
  %newvariables.2.i.lcssa = phi ptr [ %newvariables.1.i618, %list_Nconc.exit428 ], [ %L.val.i414, %for.body107.i ]
  %call113.i = tail call i32 @list_Length(ptr noundef %call.i418) #17
  %cmp.i412.not = icmp eq ptr %newvariables.2.i.lcssa, null
  %spec.select.i = select i1 %cmp.i412.not, i32 %strskolemsuccess.0.i616, i32 1
  %call118.i = tail call ptr @list_Copy(ptr noundef %call.i418) #17
  %call119.i = tail call ptr @list_Copy(ptr noundef %newvariables.2.i.lcssa) #17
  %cmp.i.not.i408 = icmp eq ptr %call118.i, null
  br i1 %cmp.i.not.i408, label %list_Nconc.exit, label %if.end.i409

if.end.i409:                                      ; preds = %for.end112.i
  %cmp.i18.not.i = icmp eq ptr %call119.i, null
  br i1 %cmp.i18.not.i, label %list_Nconc.exit, label %for.cond.i410

for.cond.i410:                                    ; preds = %if.end.i409, %for.cond.i410
  %List1.addr.0.i = phi ptr [ %List1.addr.0.val17.i, %for.cond.i410 ], [ %call118.i, %if.end.i409 ]
  %List1.addr.0.val17.i = load ptr, ptr %List1.addr.0.i, align 8
  %cmp.i20.not.i = icmp eq ptr %List1.addr.0.val17.i, null
  br i1 %cmp.i20.not.i, label %for.end.i411, label %for.cond.i410

for.end.i411:                                     ; preds = %for.cond.i410
  store ptr %call119.i, ptr %List1.addr.0.i, align 8
  br label %list_Nconc.exit

list_Nconc.exit:                                  ; preds = %for.end112.i, %if.end.i409, %for.end.i411
  %retval.0.i = phi ptr [ %call118.i, %for.end.i411 ], [ %call119.i, %for.end112.i ], [ %call118.i, %if.end.i409 ]
  ...
  br i1 %cmp.i.not61.i, label %cnf_SkolemFunctionFormulaMapped.exit, label %for.body.preheader.i

for.body.preheader.i:                             ; preds = %list_Nconc.exit
  %inc.i.i = add nsw i32 %204, 1
  %idxprom.i.i = sext i32 %204 to i64
  %arrayidx.i.i391 = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %idxprom.i.i
  br label %while.body.preheader.i

while.body.preheader.i:                           ; preds = %for.inc26.i, %for.body.preheader.i
  %scan1.062.i = phi ptr [ %scan1.0.val44.i, %for.inc26.i ], [ %mapping.0.i.lcssa, %for.body.preheader.i ]
  store i32 %inc.i.i, ptr @vec_MAX, align 4
  store ptr %call121.val.i, ptr %arrayidx.i.i391, align 8
  %205 = getelementptr i8, ptr %scan1.062.i, i64 8
  ...
  %call4.val.i392 = load ptr, ptr %scan1.0.val43.i, align 8
  %209 = ptrtoint ptr %call4.val.i392 to i64
  %210 = trunc i64 %209 to i32
  br label %while.body.i393

while.body.i393:                                  ; preds = %if.end25.i, %while.body.preheader.i
  ...
  br i1 %cmp.i48.not.i, label %if.then.i398, label %while.body.if.end_crit_edge.i

while.body.if.end_crit_edge.i:                    ; preds = %while.body.i393
  %.phi.trans.insert.i394 = getelementptr i8, ptr %212, i64 16
  %call7.val41.pre.i = load ptr, ptr %.phi.trans.insert.i394, align 8
  br label %if.end.i395

if.then.i398:                                     ; preds = %while.body.i393
  ...
  br i1 %cmp.i.not5.i.i, label %list_Delete.exit.i406, label %while.body.i.i399

while.body.i.i399:                                ; preds = %if.then.i398, %while.body.i.i399
  %Current.06.i.i400 = phi ptr [ %Current.0.val.i.i401, %while.body.i.i399 ], [ %call7.val42.i, %if.then.i398 ]
  %Current.0.val.i.i401 = load ptr, ptr %Current.06.i.i400, align 8
  %214 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i402 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %214, i64 0, i32 4
  %215 = load i32, ptr %total_size.i.i.i.i402, align 8
  %conv26.i.i.i.i403 = sext i32 %215 to i64
  %216 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i404 = add i64 %216, %conv26.i.i.i.i403
  store i64 %add27.i.i.i.i404, ptr @memory_FREEDBYTES, align 8
  %217 = load ptr, ptr %214, align 8
  store ptr %217, ptr %Current.06.i.i400, align 8
  %218 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i400, ptr %218, align 8
  %cmp.i.not.i.i405 = icmp eq ptr %Current.0.val.i.i401, null
  br i1 %cmp.i.not.i.i405, label %list_Delete.exit.i406, label %while.body.i.i399

list_Delete.exit.i406:                            ; preds = %while.body.i.i399, %if.then.i398
  %call.i.i407 = tail call ptr @list_CopyWithElement(ptr noundef %retval.0.i, ptr noundef nonnull @term_Copy) #17
  store ptr %call.i.i407, ptr %213, align 8
  %.pre.pre.i = load i32, ptr @vec_MAX, align 4
  br label %if.end.i395

if.end.i395:                                      ; preds = %list_Delete.exit.i406, %while.body.if.end_crit_edge.i
  %.pre.i = phi i32 [ %dec.i.i, %while.body.if.end_crit_edge.i ], [ %.pre.pre.i, %list_Delete.exit.i406 ]
  %call7.val41.i = phi ptr [ %call7.val41.pre.i, %while.body.if.end_crit_edge.i ], [ %call.i.i407, %list_Delete.exit.i406 ]
  %cmp.i50.not.i = icmp eq ptr %call7.val41.i, null
  br i1 %cmp.i50.not.i, label %if.end25.i, label %for.cond18.preheader.i

for.cond18.preheader.i:                           ; preds = %if.end.i395
...
for.body22.i:                                     ; preds = %for.body22.i, %for.cond18.preheader.i
  ...
  %scan.059.i = phi ptr [ %call7.val41.i, %for.cond18.preheader.i ], [ %scan.0.val45.i, %for.body22.i ]
  %220 = getelementptr i8, ptr %scan.059.i, i64 8
  %scan.0.val.i396 = load ptr, ptr %220, align 8
  %indvars.iv.next.i = add i64 %indvars.iv.i, 1
  ...
  store ptr %scan.0.val.i396, ptr %arrayidx.i56.i, align 8
  %scan.0.val45.i = load ptr, ptr %scan.059.i, align 8
  %cmp.i52.not.i = icmp eq ptr %scan.0.val45.i, null
  br i1 %cmp.i52.not.i, label %if.end25.i, label %for.body22.i

if.end25.i:                                       ; preds = %for.body22.i, %if.end.i395
  %222 = phi i32 [ %.pre.i, %if.end.i395 ], [ %221, %for.body22.i ]
  %cmp.not.i = icmp eq i32 %204, %222
  br i1 %cmp.not.i, label %for.inc26.i, label %while.body.i393

for.inc26.i:                                      ; preds = %if.end25.i
  %scan1.0.val44.i = load ptr, ptr %scan1.062.i, align 8
  %cmp.i.not.i397 = icmp eq ptr %scan1.0.val44.i, null
  br i1 %cmp.i.not.i397, label %cnf_SkolemFunctionFormulaMapped.exit, label %while.body.preheader.i

cnf_SkolemFunctionFormulaMapped.exit:             ; preds = %for.inc26.i, %list_Nconc.exit
  store i32 %204, ptr @vec_MAX, align 4
  %cmp.i.not5.i381 = icmp eq ptr %retval.0.i, null
  br i1 %cmp.i.not5.i381, label %list_Delete.exit390, label %while.body.i382

while.body.i382:                                  ; preds = %cnf_SkolemFunctionFormulaMapped.exit, %while.body.i382
  %Current.06.i383 = phi ptr [ %Current.0.val.i384, %while.body.i382 ], [ %retval.0.i, %cnf_SkolemFunctionFormulaMapped.exit ]
  %Current.0.val.i384 = load ptr, ptr %Current.06.i383, align 8
  %223 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i385 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %223, i64 0, i32 4
  %224 = load i32, ptr %total_size.i.i.i385, align 8
  %conv26.i.i.i386 = sext i32 %224 to i64
  %225 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i387 = add i64 %225, %conv26.i.i.i386
  store i64 %add27.i.i.i387, ptr @memory_FREEDBYTES, align 8
  %226 = load ptr, ptr %223, align 8
  store ptr %226, ptr %Current.06.i383, align 8
  %227 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i383, ptr %227, align 8
  %cmp.i.not.i388 = icmp eq ptr %Current.0.val.i384, null
  br i1 %cmp.i.not.i388, label %list_Delete.exit390, label %while.body.i382

list_Delete.exit390:                              ; preds = %while.body.i382, %cnf_SkolemFunctionFormulaMapped.exit
  ...
  tail call fastcc void @cnf_OptimizedSkolemFormula(ptr noundef %Search, ptr noundef %topterm, ptr noundef %toplabel, i32 noundef %TopAnd.tr.ph630, ptr noundef %call123.val.i, ptr noundef %UsedTerms, ptr noundef %Symblist, i32 noundef %Result1, ptr noundef %InputClauseToTermLabellist, i32 noundef %Depth.tr574)
  %pairscan.2.val220.i = load ptr, ptr %pairscan.2.i615, align 8
  %cmp.i429.not = icmp eq ptr %pairscan.2.val220.i, null
  br i1 %cmp.i429.not, label %while.cond128.i.preheader, label %for.body98.i

while.body132.i:                                  ; preds = %while.cond128.i.preheader, %while.body132.i
  %newvariables.3.i623 = phi ptr [ %L.val.i, %while.body132.i ], [ %newvariables.1.i.lcssa, %while.cond128.i.preheader ]
  %229 = getelementptr i8, ptr %newvariables.3.i623, i64 8
  %newvariables.3.val.i = load ptr, ptr %229, align 8
  tail call void @term_Delete(ptr noundef %newvariables.3.val.i) #17
  %L.val.i = load ptr, ptr %newvariables.3.i623, align 8
  %230 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i376 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %230, i64 0, i32 4
  %231 = load i32, ptr %total_size.i.i.i376, align 8
  %conv26.i.i.i377 = sext i32 %231 to i64
  %232 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i378 = add i64 %232, %conv26.i.i.i377
  store i64 %add27.i.i.i378, ptr @memory_FREEDBYTES, align 8
  %233 = load ptr, ptr %230, align 8
  store ptr %233, ptr %newvariables.3.i623, align 8
  %234 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %newvariables.3.i623, ptr %234, align 8
  %cmp.i379.not = icmp eq ptr %L.val.i, null
  br i1 %cmp.i379.not, label %while.end135.i, label %while.body132.i

while.end135.i:                                   ; preds = %while.body132.i, %while.cond128.i.preheader
  %cmp.i.not5.i366 = icmp eq ptr %accumulatedvariables.0.i.lcssa, null
  br i1 %cmp.i.not5.i366, label %list_Delete.exit375, label %while.body.i367

while.body.i367:                                  ; preds = %while.end135.i, %while.body.i367
  %Current.06.i368 = phi ptr [ %Current.0.val.i369, %while.body.i367 ], [ %accumulatedvariables.0.i.lcssa, %while.end135.i ]
  %Current.0.val.i369 = load ptr, ptr %Current.06.i368, align 8
  %235 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i370 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %235, i64 0, i32 4
  %236 = load i32, ptr %total_size.i.i.i370, align 8
  %conv26.i.i.i371 = sext i32 %236 to i64
  %237 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i372 = add i64 %237, %conv26.i.i.i371
  store i64 %add27.i.i.i372, ptr @memory_FREEDBYTES, align 8
  %238 = load ptr, ptr %235, align 8
  store ptr %238, ptr %Current.06.i368, align 8
  %239 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i368, ptr %239, align 8
  %cmp.i.not.i373 = icmp eq ptr %Current.0.val.i369, null
  br i1 %cmp.i.not.i373, label %list_Delete.exit375, label %while.body.i367

list_Delete.exit375:                              ; preds = %while.body.i367, %while.end135.i
  tail call void @list_DeleteWithElement(ptr noundef %pairlist.0.i.lcssa, ptr noundef nonnull @list_PairFree) #17
  br i1 %cmp.i.not8.i.i, label %list_Delete.exit365, label %while.body.i357

while.body.i357:                                  ; preds = %list_Delete.exit375, %while.body.i357
  %Current.06.i358 = phi ptr [ %Current.0.val.i359, %while.body.i357 ], [ %result.0.lcssa.i, %list_Delete.exit375 ]
  %Current.0.val.i359 = load ptr, ptr %Current.06.i358, align 8
  %240 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i360 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %240, i64 0, i32 4
  %241 = load i32, ptr %total_size.i.i.i360, align 8
  %conv26.i.i.i361 = sext i32 %241 to i64
  %242 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i362 = add i64 %242, %conv26.i.i.i361
  store i64 %add27.i.i.i362, ptr @memory_FREEDBYTES, align 8
  %243 = load ptr, ptr %240, align 8
  store ptr %243, ptr %Current.06.i358, align 8
  %244 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i358, ptr %244, align 8
  %cmp.i.not.i363 = icmp eq ptr %Current.0.val.i359, null
  br i1 %cmp.i.not.i363, label %list_Delete.exit365, label %while.body.i357

list_Delete.exit365:                              ; preds = %while.body.i357, %list_Delete.exit375
  tail call void @list_DeleteWithElement(ptr noundef %mapping.0.i.lcssa, ptr noundef nonnull @list_PairFree) #17
  %arrayidx.i355 = getelementptr inbounds i32, ptr %Search.val.i285, i64 34
  %245 = load i32, ptr %arrayidx.i355, align 4
...
if.then139.i:                                     ; preds = %list_Delete.exit365
...
if.then85:                                        ; preds = %if.then76.if.then85_crit_edge, %if.end19
  ...
  %TopAnd.addr.0 = phi i32 [ %TopAnd.tr.ph630, %if.then76.if.then85_crit_edge ], [ 0, %if.end19 ]
  ...
  br i1 %cmp.i.not10.i.i, label %while.body.ithread-pre-split.preheader.i, label %for.body.i.i308

for.body.i.i308:                                  ; preds = %if.then85, %for.body.i.i308
  %result.012.i.i = phi ptr [ %call.i.i.i311, %for.body.i.i308 ], [ null, %if.then85 ]
  %scan.011.i.i = phi ptr [ %scan.0.val9.i.i, %for.body.i.i308 ], [ %call1.val.i, %if.then85 ]
  %250 = getelementptr i8, ptr %scan.011.i.i, i64 8
  %scan.0.val.i.i309 = load ptr, ptr %250, align 8
  %call2.val.i.i310 = load i32, ptr %scan.0.val.i.i309, align 8
  %conv.i.i = sext i32 %call2.val.i.i310 to i64
  %251 = inttoptr i64 %conv.i.i to ptr
  %call.i.i.i311 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i.i.i312 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i.i311, i64 0, i32 1
  store ptr %251, ptr %car.i.i.i312, align 8
  store ptr %result.012.i.i, ptr %call.i.i.i311, align 8
  %scan.0.val9.i.i = load ptr, ptr %scan.011.i.i, align 8
  %cmp.i.not.i.i313 = icmp eq ptr %scan.0.val9.i.i, null
  br i1 %cmp.i.not.i.i313, label %cnf_GetSymbolList.exit.loopexit.i, label %for.body.i.i308

cnf_GetSymbolList.exit.loopexit.i:                ; preds = %for.body.i.i308
...
while.body.ithread-pre-split.preheader.i:         ; preds = %cnf_GetSymbolList.exit.loopexit.i, %if.then85
  ...
  %result.0.lcssa.i.i = phi ptr [ null, %if.then85 ], [ %call.i.i.i311, %cnf_GetSymbolList.exit.loopexit.i ]
  ...
  br label %while.body.ithread-pre-split.i314

while.body.ithread-pre-split.i314:                ; preds = %while.body.ithread-pre-split.i314, %while.body.ithread-pre-split.preheader.i
  %Current.0.val.i57.i = phi ptr [ %Current.0.val.i.pr.i315, %while.body.ithread-pre-split.i314 ], [ %Term.val20.val.i, %while.body.ithread-pre-split.preheader.i ]
  %Current.0.val.i.pr.i315 = load ptr, ptr %Current.0.val.i57.i, align 8
  %258 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i316 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %258, i64 0, i32 4
  %259 = load i32, ptr %total_size.i.i.i.i316, align 8
  %conv26.i.i.i.i317 = sext i32 %259 to i64
  %260 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i318 = add i64 %260, %conv26.i.i.i.i317
  store i64 %add27.i.i.i.i318, ptr @memory_FREEDBYTES, align 8
  ...
  %cmp.i.not.i23.i = icmp eq ptr %Current.0.val.i.pr.i315, null
  br i1 %cmp.i.not.i23.i, label %list_Delete.exit.i319, label %while.body.ithread-pre-split.i314

list_Delete.exit.i319:                            ; preds = %while.body.ithread-pre-split.i314
  %call5.val.i320 = load i32, ptr %Term.val20.val.val.i, align 8
  store i32 %call5.val.i320, ptr %term, align 8
  ...
  %total_size.i.i.i321 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %264, i64 0, i32 4
  %265 = load i32, ptr %total_size.i.i.i321, align 8
  %conv26.i.i.i322 = sext i32 %265 to i64
  %266 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i323 = add i64 %266, %conv26.i.i.i322
  store i64 %add27.i.i.i323, ptr @memory_FREEDBYTES, align 8
  ...
  %cmp.i.not65.i.i = icmp eq ptr %result.0.lcssa.i.i, null
  br i1 %cmp.i.not65.i.i, label %list_Delete.exit39.thread.i, label %for.body.preheader.i.i

list_Delete.exit39.thread.i:                      ; preds = %list_Delete.exit.i319
  store i32 %269, ptr @vec_MAX, align 4
  br label %if.end86

for.body.preheader.i.i:                           ; preds = %list_Delete.exit.i319
  %.pre.i.i324 = load i32, ptr @vec_MAX, align 4
  br label %for.body.i24.i

for.body.i24.i:                                   ; preds = %for.inc28.i.i, %for.body.preheader.i.i
  %270 = phi i32 [ %269, %for.inc28.i.i ], [ %.pre.i.i324, %for.body.preheader.i.i ]
  %scan1.067.i.i = phi ptr [ %scan1.0.val47.i.i, %for.inc28.i.i ], [ %result.0.lcssa.i.i, %for.body.preheader.i.i ]
  %Result.066.i.i = phi ptr [ %call.i.i26.i, %for.inc28.i.i ], [ null, %for.body.preheader.i.i ]
  %inc.i.i.i325 = add nsw i32 %270, 1
  store i32 %inc.i.i.i325, ptr @vec_MAX, align 4
  %idxprom.i.i.i326 = sext i32 %270 to i64
  %arrayidx.i.i.i327 = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %idxprom.i.i.i326
  store ptr %term, ptr %arrayidx.i.i.i327, align 8
  %call4.i.i = tail call i32 @symbol_CreateSkolemFunction(i32 noundef %call2.i.i, ptr noundef %Search.val221576) #17
  %conv.i25.i = sext i32 %call4.i.i to i64
  %271 = inttoptr i64 %conv.i25.i to ptr
  %call.i.i26.i = tail call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i.i27.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i26.i, i64 0, i32 1
  store ptr %271, ptr %car.i.i27.i, align 8
  store ptr %Result.066.i.i, ptr %call.i.i26.i, align 8
  %272 = load i32, ptr @vec_MAX, align 4
  %cmp.not64.i.i = icmp eq i32 %269, %272
  br i1 %cmp.not64.i.i, label %for.inc28.i.i, label %while.body.lr.ph.i.i

while.body.lr.ph.i.i:                             ; preds = %for.body.i24.i
  %273 = getelementptr i8, ptr %scan1.067.i.i, i64 8
...
while.body.i28.i:                                 ; preds = %if.end27.i.i, %while.body.lr.ph.i.i
  ...
  %dec.i.i.i328 = add nsw i32 %274, -1
  store i32 %dec.i.i.i328, ptr @vec_MAX, align 4
  %idxprom.i49.i.i = sext i32 %dec.i.i.i328 to i64
  ...
  br i1 %cmp.i51.not.i.i, label %if.then.i.i333, label %while.body.if.end_crit_edge.i.i
...
while.body.if.end_crit_edge.i.i:                  ; preds = %while.body.i28.i
  ...
  br label %if.end.i.i329

if.then.i.i333:                                   ; preds = %while.body.i28.i
  ...
  br i1 %cmp.i.not5.i.i.i, label %list_Delete.exit.i.i, label %while.body.i.i.i334

while.body.i.i.i334:                              ; preds = %if.then.i.i333, %while.body.i.i.i334
  %Current.06.i.i.i335 = phi ptr [ %Current.0.val.i.i.i336, %while.body.i.i.i334 ], [ %call8.val46.i.i, %if.then.i.i333 ]
  %Current.0.val.i.i.i336 = load ptr, ptr %Current.06.i.i.i335, align 8
  %279 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i.i337 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %279, i64 0, i32 4
  %280 = load i32, ptr %total_size.i.i.i.i.i337, align 8
  %conv26.i.i.i.i.i338 = sext i32 %280 to i64
  %281 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i.i339 = add i64 %281, %conv26.i.i.i.i.i338
  store i64 %add27.i.i.i.i.i339, ptr @memory_FREEDBYTES, align 8
  %282 = load ptr, ptr %279, align 8
  store ptr %282, ptr %Current.06.i.i.i335, align 8
  %283 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i.i335, ptr %283, align 8
  %cmp.i.not.i.i.i340 = icmp eq ptr %Current.0.val.i.i.i336, null
  br i1 %cmp.i.not.i.i.i340, label %list_Delete.exit.i.i, label %while.body.i.i.i334

list_Delete.exit.i.i:                             ; preds = %while.body.i.i.i334, %if.then.i.i333
  ...
  %.pre70.pre.i.i = load i32, ptr @vec_MAX, align 4
  br label %if.end.i.i329

if.end.i.i329:                                    ; preds = %list_Delete.exit.i.i, %while.body.if.end_crit_edge.i.i
  %.pre70.i.i = phi i32 [ %dec.i.i.i328, %while.body.if.end_crit_edge.i.i ], [ %.pre70.pre.i.i, %list_Delete.exit.i.i ]
...
for.cond20.preheader.i.i:                         ; preds = %if.end.i.i329
  %284 = sext i32 %.pre70.i.i to i64
  br label %for.body24.i.i

for.body24.i.i:                                   ; preds = %for.body24.i.i, %for.cond20.preheader.i.i
  %indvars.iv.i.i330 = phi i64 [ %284, %for.cond20.preheader.i.i ], [ %indvars.iv.next.i.i331, %for.body24.i.i ]
  %scan.063.i.i = phi ptr [ %call8.val45.i.i, %for.cond20.preheader.i.i ], [ %scan.0.val48.i.i, %for.body24.i.i ]
  %285 = getelementptr i8, ptr %scan.063.i.i, i64 8
  %scan.0.val.i29.i = load ptr, ptr %285, align 8
  %indvars.iv.next.i.i331 = add i64 %indvars.iv.i.i330, 1
  %286 = trunc i64 %indvars.iv.next.i.i331 to i32
  store i32 %286, ptr @vec_MAX, align 4
  %arrayidx.i60.i.i = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %indvars.iv.i.i330
  store ptr %scan.0.val.i29.i, ptr %arrayidx.i60.i.i, align 8
  %scan.0.val48.i.i = load ptr, ptr %scan.063.i.i, align 8
  %cmp.i56.not.i.i = icmp eq ptr %scan.0.val48.i.i, null
  br i1 %cmp.i56.not.i.i, label %if.end27.i.i, label %for.body24.i.i

if.end27.i.i:                                     ; preds = %for.body24.i.i, %if.end.i.i329
  %287 = phi i32 [ %.pre70.i.i, %if.end.i.i329 ], [ %286, %for.body24.i.i ]
  %cmp.not.i.i332 = icmp eq i32 %269, %287
  br i1 %cmp.not.i.i332, label %for.inc28.i.i, label %while.body.i28.i

for.inc28.i.i:                                    ; preds = %if.end27.i.i, %for.body.i24.i
  %scan1.0.val47.i.i = load ptr, ptr %scan1.067.i.i, align 8
  %cmp.i.not.i30.i = icmp eq ptr %scan1.0.val47.i.i, null
  br i1 %cmp.i.not.i30.i, label %cnf_SkolemFunctionFormula.exit.i, label %for.body.i24.i

cnf_SkolemFunctionFormula.exit.i:                 ; preds = %for.inc28.i.i
  store i32 %269, ptr @vec_MAX, align 4
  br label %while.body.i32.i

while.body.i32.i:                                 ; preds = %while.body.i32.i, %cnf_SkolemFunctionFormula.exit.i
  %Current.06.i33.i = phi ptr [ %Current.0.val.i34.i, %while.body.i32.i ], [ %result.0.lcssa.i.i, %cnf_SkolemFunctionFormula.exit.i ]
  %Current.0.val.i34.i = load ptr, ptr %Current.06.i33.i, align 8
  %288 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i35.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %288, i64 0, i32 4
  %289 = load i32, ptr %total_size.i.i.i35.i, align 8
  %conv26.i.i.i36.i = sext i32 %289 to i64
  %290 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i37.i = add i64 %290, %conv26.i.i.i36.i
  store i64 %add27.i.i.i37.i, ptr @memory_FREEDBYTES, align 8
  %291 = load ptr, ptr %288, align 8
  store ptr %291, ptr %Current.06.i33.i, align 8
  %292 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i33.i, ptr %292, align 8
  %cmp.i.not.i38.i = icmp eq ptr %Current.0.val.i34.i, null
  br i1 %cmp.i.not.i38.i, label %while.body.i41.i, label %while.body.i32.i

while.body.i41.i:                                 ; preds = %while.body.i32.i, %while.body.i41.i
  %Current.06.i42.i = phi ptr [ %Current.0.val.i43.i, %while.body.i41.i ], [ %call.i.i26.i, %while.body.i32.i ]
  %Current.0.val.i43.i = load ptr, ptr %Current.06.i42.i, align 8
  %293 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i44.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %293, i64 0, i32 4
  %294 = load i32, ptr %total_size.i.i.i44.i, align 8
  %conv26.i.i.i45.i = sext i32 %294 to i64
  %295 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i46.i = add i64 %295, %conv26.i.i.i45.i
  store i64 %add27.i.i.i46.i, ptr @memory_FREEDBYTES, align 8
  %296 = load ptr, ptr %293, align 8
  store ptr %296, ptr %Current.06.i42.i, align 8
  %297 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i42.i, ptr %297, align 8
  %cmp.i.not.i47.i = icmp eq ptr %Current.0.val.i43.i, null
  br i1 %cmp.i.not.i47.i, label %if.end86, label %while.body.i41.i

if.end86:                                         ; preds = %while.body.i41.i, %if.end74, %if.then139.i, %list_Delete.exit365, %list_Delete.exit39.thread.i
  %TopAnd.addr.0548 = phi i32 [ %TopAnd.addr.0, %list_Delete.exit39.thread.i ], [ %TopAnd.tr.ph630, %if.end74 ], [ %TopAnd.tr.ph630, %list_Delete.exit365 ], [ %TopAnd.tr.ph630, %if.then139.i ], [ %TopAnd.addr.0, %while.body.i41.i ]
  %cmp.i.not5.i = icmp eq ptr %call20, null
  br i1 %cmp.i.not5.i, label %list_Delete.exit, label %while.body.i341

while.body.i341:                                  ; preds = %if.end86, %while.body.i341
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i341 ], [ %call20, %if.end86 ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  %298 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i342 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %298, i64 0, i32 4
  %299 = load i32, ptr %total_size.i.i.i342, align 8
  %conv26.i.i.i343 = sext i32 %299 to i64
  %300 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i344 = add i64 %300, %conv26.i.i.i343
  store i64 %add27.i.i.i344, ptr @memory_FREEDBYTES, align 8
  ...
  %cmp.i.not.i345 = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i345, label %list_Delete.exit, label %while.body.i341

list_Delete.exit:                                 ; preds = %while.body.i341, %if.end86
  %term.val570 = load i32, ptr %term, align 8
  %303 = load i32, ptr @fol_ALL, align 4
  %cmp.i.not.i571 = icmp eq i32 %303, %term.val570
  %304 = load i32, ptr @fol_EXIST, align 4
  %cmp.i4.i572 = icmp eq i32 %304, %term.val570
  %narrow.i.not573 = select i1 %cmp.i.not.i571, i1 true, i1 %cmp.i4.i572
  br i1 %narrow.i.not573, label %if.then.lr.ph, label %if.else87

if.else87:                                        ; preds = %list_Delete.exit, %cnf_PopAllQuantifier.exit, %entry
  %TopAnd.tr.ph.lcssa = phi i32 [ %TopAnd, %entry ], [ %TopAnd.tr.ph630, %cnf_PopAllQuantifier.exit ], [ %TopAnd.addr.0548, %list_Delete.exit ]
  %Depth.tr.lcssa = phi i32 [ %Depth, %entry ], [ %Depth.addr.0, %cnf_PopAllQuantifier.exit ], [ %Depth.tr574, %list_Delete.exit ]
  %term.val.lcssa = phi i32 [ %term.val570626, %entry ], [ %term.val, %cnf_PopAllQuantifier.exit ], [ %term.val570, %list_Delete.exit ]
  %305 = load i32, ptr @fol_AND, align 4
  %cmp.i347.not = icmp eq i32 %term.val.lcssa, %305
  %306 = load i32, ptr @fol_OR, align 4
  %cmp.i349.not = icmp eq i32 %term.val.lcssa, %306
  %or.cond549 = select i1 %cmp.i347.not, i1 true, i1 %cmp.i349.not
  br i1 %or.cond549, label %if.then95, label %cleanup

if.then95:                                        ; preds = %if.else87
  %spec.select = select i1 %cmp.i349.not, i32 0, i32 %TopAnd.tr.ph.lcssa
  %307 = getelementptr i8, ptr %term, i64 16
  %scan.3638 = load ptr, ptr %307, align 8
  %cmp.i353.not639 = icmp eq ptr %scan.3638, null
  br i1 %cmp.i353.not639, label %cleanup, label %for.body106

for.body106:                                      ; preds = %if.then95, %for.body106
  %scan.3640 = phi ptr [ %scan.3, %for.body106 ], [ %scan.3638, %if.then95 ]
  %308 = getelementptr i8, ptr %scan.3640, i64 8
  ...
  %scan.3 = load ptr, ptr %scan.3640, align 8
  %cmp.i353.not = icmp eq ptr %scan.3, null
  br i1 %cmp.i353.not, label %cleanup, label %for.body106
...
for.cond.i46:                                     ; preds = %if.end.i, %for.cond.i46
  ...
  %List1.addr.0.val17.i = load ptr, ptr %List1.addr.0.i, align 8
  %cmp.i20.not.i = icmp eq ptr %List1.addr.0.val17.i, null
  br i1 %cmp.i20.not.i, label %for.end.i, label %for.cond.i46
...
list_Nconc.exit:                                  ; preds = %if.end18, %if.end.i, %for.end.i
  ...
  br i1 %cmp.i43.not, label %cleanup, label %for.body
...
for.inc:                                          ; preds = %for.body14, %if.then
  ...
  br i1 %cmp.i144.not, label %for.end, label %for.body14
...
for.inc58:                                        ; preds = %for.body, %for.end, %if.end52
  ...
  br i1 %cmp.i.not, label %for.end60, label %for.body
...
if.then64:                                        ; preds = %for.end60
  ...
  br i1 %cmp.i.not5.i164, label %list_Delete.exit172, label %while.body.i165

while.body.i165:                                  ; preds = %if.then64, %while.body.i165
  %Current.06.i166 = phi ptr [ %Current.0.val.i167, %while.body.i165 ], [ %Term.val128, %if.then64 ]
  %Current.0.val.i167 = load ptr, ptr %Current.06.i166, align 8
  %25 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i168 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %25, i64 0, i32 4
  %26 = load i32, ptr %total_size.i.i.i168, align 8
  %conv26.i.i.i169 = sext i32 %26 to i64
  %27 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i170 = add i64 %27, %conv26.i.i.i169
  store i64 %add27.i.i.i170, ptr @memory_FREEDBYTES, align 8
  %28 = load ptr, ptr %25, align 8
  store ptr %28, ptr %Current.06.i166, align 8
  %29 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i166, ptr %29, align 8
  %cmp.i.not.i171 = icmp eq ptr %Current.0.val.i167, null
  br i1 %cmp.i.not.i171, label %list_Delete.exit172, label %while.body.i165

list_Delete.exit172:                              ; preds = %while.body.i165, %if.then64
  store i32 %call3.val, ptr %Term, align 8
...
for.body73:                                       ; preds = %list_Delete.exit172, %for.body73
  ...
  br i1 %cmp.i177.not, label %if.end78, label %for.body73

if.end78:                                         ; preds = %for.body73, %list_Delete.exit172, %for.end60
  br i1 %cmp.i.not193, label %list_Delete.exit188, label %while.body.i181

while.body.i181:                                  ; preds = %if.end78, %while.body.i181
  %Current.06.i182 = phi ptr [ %Current.0.val.i183, %while.body.i181 ], [ %call2, %if.end78 ]
  %Current.0.val.i183 = load ptr, ptr %Current.06.i182, align 8
  %37 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i184 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %37, i64 0, i32 4
  %38 = load i32, ptr %total_size.i.i.i184, align 8
  %conv26.i.i.i185 = sext i32 %38 to i64
  %39 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i186 = add i64 %39, %conv26.i.i.i185
  store i64 %add27.i.i.i186, ptr @memory_FREEDBYTES, align 8
  %40 = load ptr, ptr %37, align 8
  store ptr %40, ptr %Current.06.i182, align 8
  %41 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i182, ptr %41, align 8
  %cmp.i.not.i187 = icmp eq ptr %Current.0.val.i183, null
  br i1 %cmp.i.not.i187, label %list_Delete.exit188, label %while.body.i181

list_Delete.exit188:                              ; preds = %while.body.i181, %if.end78
  ret void
}
...
attributes #7 = { inlinehint mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #8 = { inlinehint mustprogress nofree nounwind willreturn memory(argmem: read) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
