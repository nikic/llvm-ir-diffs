; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/flags.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/flags.c"
...
entry:
  ...
  store <4 x i32> <i32 -1, i32 -1, i32 0, i32 0>, ptr getelementptr inbounds ([96 x i32], ptr @flag_DEFAULTSTORE, i64 0, i64 6), align 8
...
for.inc.i:                                        ; preds = %for.body.i
  ...
  br i1 %exitcond.not.i, label %flag_Id.exit, label %for.body.i
...
for.inc.i:                                        ; preds = %if.then.i, %for.body.i
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 96
  br i1 %exitcond.not.i, label %for.body.i16, label %for.body.i

for.body.i16:                                     ; preds = %for.inc.i, %for.inc.i20
  %indvars.iv.i17 = phi i64 [ %indvars.iv.next.i21, %for.inc.i20 ], [ 0, %for.inc.i ]
  %type.i.i.i.i18 = getelementptr inbounds [96 x %struct.FLAG_PROPERTY], ptr @flag_PROPERTIES, i64 0, i64 %indvars.iv.i17, i32 2
  %2 = load i32, ptr %type.i.i.i.i18, align 8
  %cmp.i.i.not.i19 = icmp eq i32 %2, 0
  br i1 %cmp.i.i.not.i19, label %if.then.i23, label %for.inc.i20

if.then.i23:                                      ; preds = %for.body.i16
  %3 = trunc i64 %indvars.iv.i17 to i32
  tail call fastcc void @flag_CheckFlagValueInRange(i32 noundef %3, i32 noundef 0)
  %arrayidx.i.i24 = getelementptr inbounds i32, ptr %Target, i64 %indvars.iv.i17
  store i32 0, ptr %arrayidx.i.i24, align 4
  br label %for.inc.i20

for.inc.i20:                                      ; preds = %if.then.i23, %for.body.i16
  %indvars.iv.next.i21 = add nuw nsw i64 %indvars.iv.i17, 1
  %exitcond.not.i22 = icmp eq i64 %indvars.iv.next.i21, 96
  br i1 %exitcond.not.i22, label %for.body.i25, label %for.body.i16

for.body.i25:                                     ; preds = %for.inc.i20, %for.inc.i29
  %indvars.iv.i26 = phi i64 [ %indvars.iv.next.i30, %for.inc.i29 ], [ 0, %for.inc.i20 ]
  %type.i.i.i.i27 = getelementptr inbounds [96 x %struct.FLAG_PROPERTY], ptr @flag_PROPERTIES, i64 0, i64 %indvars.iv.i26, i32 2
  %4 = load i32, ptr %type.i.i.i.i27, align 8
  %cmp.i.i.not.i28 = icmp eq i32 %4, 2
  br i1 %cmp.i.i.not.i28, label %if.then.i32, label %for.inc.i29

if.then.i32:                                      ; preds = %for.body.i25
  %arrayidx.i.i.i = getelementptr inbounds i32, ptr @flag_DEFAULTSTORE, i64 %indvars.iv.i26
  %5 = load i32, ptr %arrayidx.i.i.i, align 4
  %6 = trunc i64 %indvars.iv.i26 to i32
  tail call fastcc void @flag_CheckFlagValueInRange(i32 noundef %6, i32 noundef %5)
  %arrayidx.i4.i.i = getelementptr inbounds i32, ptr %Target, i64 %indvars.iv.i26
  store i32 %5, ptr %arrayidx.i4.i.i, align 4
  br label %for.inc.i29

for.inc.i29:                                      ; preds = %if.then.i32, %for.body.i25
  %indvars.iv.next.i30 = add nuw nsw i64 %indvars.iv.i26, 1
  %exitcond.not.i31 = icmp eq i64 %indvars.iv.next.i30, 96
  br i1 %exitcond.not.i31, label %flag_SetReductionsToDefaults.exit, label %for.body.i25

flag_SetReductionsToDefaults.exit:                ; preds = %for.inc.i29
