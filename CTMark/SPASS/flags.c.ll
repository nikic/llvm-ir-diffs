...
for.inc.i:                                        ; preds = %if.then.i, %for.body.i
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 96
  br i1 %exitcond.not.i, label %for.body.i16, label %for.body.i, !llvm.loop !10
...
for.inc.i20:                                      ; preds = %if.then.i23, %for.body.i16
  ...
  br i1 %exitcond.not.i22, label %for.body.i25, label %for.body.i16, !llvm.loop !8
...
for.inc.i29:                                      ; preds = %if.then.i32, %for.body.i25
  ...
  br i1 %exitcond.not.i31, label %flag_SetReductionsToDefaults.exit, label %for.body.i25, !llvm.loop !11
