; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/top.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/top.c"
...
entry:
  ...
  %call.i1286 = ptrtoint ptr %call.i to i64
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  br i1 %10, label %symbol_CreatePrecedence.exit, label %vector.body
...
lor.lhs.false:                                    ; preds = %if.then9
  ...
  %spec.select1275 = select i1 %tobool15.not, ptr @.str.4, ptr @.str.3
  br label %if.end19

if.end19:                                         ; preds = %lor.lhs.false, %if.then9
  %.str.4.sink = phi ptr [ @.str.3, %if.then9 ], [ %spec.select1275, %lor.lhs.false ]
...
if.end30:                                         ; preds = %if.else26, %if.then25
  ...
  %call2.val7191285 = ptrtoint ptr %call2.val719 to i64
  br label %for.body.i764

for.body.i764:                                    ; preds = %for.inc.i, %if.end30
  %indvars.iv.i765 = phi i64 [ 0, %if.end30 ], [ %indvars.iv.next.i766, %for.inc.i ]
  %arrayidx.i.i.i = getelementptr inbounds i32, ptr %call.i758, i64 %indvars.iv.i765
  %27 = load i32, ptr %arrayidx.i.i.i, align 4
  %cmp.i.not.i = icmp eq i32 %27, %11
  br i1 %cmp.i.not.i, label %for.inc.i, label %if.then.i

if.then.i:                                        ; preds = %for.body.i764
  %28 = trunc i64 %indvars.iv.i765 to i32
  call fastcc void @flag_SetFlagValue(ptr noundef %call2.val, i32 noundef %28, i32 noundef %27)
  br label %for.inc.i

for.inc.i:                                        ; preds = %if.then.i, %for.body.i764
  %indvars.iv.next.i766 = add nuw nsw i64 %indvars.iv.i765, 1
  %exitcond.not.i767 = icmp eq i64 %indvars.iv.next.i766, 96
  br i1 %exitcond.not.i767, label %vector.memcheck, label %for.body.i764

vector.memcheck:                                  ; preds = %for.inc.i
  %29 = sub i64 %call2.val7191285, %call.i1286
  %diff.check = icmp ult i64 %29, 32
  br i1 %diff.check, label %for.body.i768, label %vector.body1291
...
vector.body1291:                                  ; preds = %vector.memcheck, %vector.body1291
  ...
  %30 = getelementptr inbounds i32, ptr %call.i, i64 %index1292
  %wide.load = load <4 x i32>, ptr %30, align 4
  %31 = getelementptr inbounds i32, ptr %30, i64 4
  %wide.load1293 = load <4 x i32>, ptr %31, align 4
  %32 = getelementptr inbounds i32, ptr %call2.val719, i64 %index1292
  store <4 x i32> %wide.load, ptr %32, align 4
  %33 = getelementptr inbounds i32, ptr %32, i64 4
  store <4 x i32> %wide.load1293, ptr %33, align 4
  %index.next1294 = or i64 %index1292, 8
  %34 = getelementptr inbounds i32, ptr %call.i, i64 %index.next1294
  %wide.load.1 = load <4 x i32>, ptr %34, align 4
  %35 = getelementptr inbounds i32, ptr %34, i64 4
  %wide.load1293.1 = load <4 x i32>, ptr %35, align 4
  %36 = getelementptr inbounds i32, ptr %call2.val719, i64 %index.next1294
  store <4 x i32> %wide.load.1, ptr %36, align 4
  %37 = getelementptr inbounds i32, ptr %36, i64 4
  store <4 x i32> %wide.load1293.1, ptr %37, align 4
  %index.next1294.1 = or i64 %index1292, 16
  %38 = getelementptr inbounds i32, ptr %call.i, i64 %index.next1294.1
  %wide.load.2 = load <4 x i32>, ptr %38, align 4
  %39 = getelementptr inbounds i32, ptr %38, i64 4
  %wide.load1293.2 = load <4 x i32>, ptr %39, align 4
  %40 = getelementptr inbounds i32, ptr %call2.val719, i64 %index.next1294.1
  store <4 x i32> %wide.load.2, ptr %40, align 4
  %41 = getelementptr inbounds i32, ptr %40, i64 4
  store <4 x i32> %wide.load1293.2, ptr %41, align 4
  %index.next1294.2 = or i64 %index1292, 24
  %42 = getelementptr inbounds i32, ptr %call.i, i64 %index.next1294.2
  %wide.load.3 = load <4 x i32>, ptr %42, align 4
  %43 = getelementptr inbounds i32, ptr %42, i64 4
  %wide.load1293.3 = load <4 x i32>, ptr %43, align 4
  %44 = getelementptr inbounds i32, ptr %call2.val719, i64 %index.next1294.2
  store <4 x i32> %wide.load.3, ptr %44, align 4
  %45 = getelementptr inbounds i32, ptr %44, i64 4
  store <4 x i32> %wide.load1293.3, ptr %45, align 4
  %index.next1294.3 = add nuw nsw i64 %index1292, 32
  %46 = icmp eq i64 %index.next1294.3, 4000
  br i1 %46, label %symbol_TransferPrecedence.exit, label %vector.body1291

for.body.i768:                                    ; preds = %vector.memcheck, %for.body.i768
  %indvars.iv.i769 = phi i64 [ %indvars.iv.next.i771.4, %for.body.i768 ], [ 0, %vector.memcheck ]
  %arrayidx.i770 = getelementptr inbounds i32, ptr %call.i, i64 %indvars.iv.i769
  %47 = load i32, ptr %arrayidx.i770, align 4
  %arrayidx2.i = getelementptr inbounds i32, ptr %call2.val719, i64 %indvars.iv.i769
  store i32 %47, ptr %arrayidx2.i, align 4
  %indvars.iv.next.i771 = add nuw nsw i64 %indvars.iv.i769, 1
  %arrayidx.i770.1 = getelementptr inbounds i32, ptr %call.i, i64 %indvars.iv.next.i771
  %48 = load i32, ptr %arrayidx.i770.1, align 4
  %arrayidx2.i.1 = getelementptr inbounds i32, ptr %call2.val719, i64 %indvars.iv.next.i771
  store i32 %48, ptr %arrayidx2.i.1, align 4
  %indvars.iv.next.i771.1 = add nuw nsw i64 %indvars.iv.i769, 2
  %arrayidx.i770.2 = getelementptr inbounds i32, ptr %call.i, i64 %indvars.iv.next.i771.1
  %49 = load i32, ptr %arrayidx.i770.2, align 4
  %arrayidx2.i.2 = getelementptr inbounds i32, ptr %call2.val719, i64 %indvars.iv.next.i771.1
  store i32 %49, ptr %arrayidx2.i.2, align 4
  %indvars.iv.next.i771.2 = add nuw nsw i64 %indvars.iv.i769, 3
  %arrayidx.i770.3 = getelementptr inbounds i32, ptr %call.i, i64 %indvars.iv.next.i771.2
  %50 = load i32, ptr %arrayidx.i770.3, align 4
  %arrayidx2.i.3 = getelementptr inbounds i32, ptr %call2.val719, i64 %indvars.iv.next.i771.2
  store i32 %50, ptr %arrayidx2.i.3, align 4
  %indvars.iv.next.i771.3 = add nuw nsw i64 %indvars.iv.i769, 4
  %arrayidx.i770.4 = getelementptr inbounds i32, ptr %call.i, i64 %indvars.iv.next.i771.3
  %51 = load i32, ptr %arrayidx.i770.4, align 4
  %arrayidx2.i.4 = getelementptr inbounds i32, ptr %call2.val719, i64 %indvars.iv.next.i771.3
  store i32 %51, ptr %arrayidx2.i.4, align 4
  %indvars.iv.next.i771.4 = add nuw nsw i64 %indvars.iv.i769, 5
  %exitcond.not.i772.4 = icmp eq i64 %indvars.iv.next.i771.4, 4000
  br i1 %exitcond.not.i772.4, label %symbol_TransferPrecedence.exit, label %for.body.i768

symbol_TransferPrecedence.exit:                   ; preds = %vector.body1291, %for.body.i768
...
for.body:                                         ; preds = %if.end62, %for.body
  ...
  br i1 %cmp.i785.not, label %for.end, label %for.body
...
for.inc107:                                       ; preds = %for.body87, %if.end105
  ...
  br i1 %cmp.i790.not, label %for.cond110.preheader, label %for.body87
...
if.end131:                                        ; preds = %if.then127, %land.lhs.true124, %for.body114
  ...
  br i1 %cmp.i794.not, label %for.end135, label %for.body114
...
list_Nconc.exit:                                  ; preds = %for.end135.thread, %for.end135, %if.end.i, %for.end.i
  %Sortlabellist.0.lcssa1250 = phi ptr [ %call.i799, %for.end.i ], [ %call.i799, %for.end135 ], [ %call.i799, %if.end.i ], [ null, %for.end135.thread ]
...
if.end142:                                        ; preds = %if.then139, %list_Nconc.exit
...
for.body150:                                      ; preds = %if.end142, %for.body150
  ...
  br i1 %cmp.i803.not, label %if.end171, label %for.body150
...
for.body164:                                      ; preds = %for.body164.preheader, %for.body164
  ...
  br i1 %cmp.i806.not, label %if.end171, label %for.body164
...
if.end171:                                        ; preds = %for.body164, %for.body150, %if.then158, %if.end142, %if.else155
  ...
  %Sortlabellist.1 = phi ptr [ null, %if.else155 ], [ %Sortlabellist.0.lcssa1250, %if.end142 ], [ null, %if.then158 ], [ %Sortlabellist.0.lcssa1250, %for.body150 ], [ null, %for.body164 ]
...
if.then178:                                       ; preds = %lor.lhs.false175, %if.end171
  ...
  br i1 %cmp.i819, label %if.then.i826, label %if.else.i

if.then.i826:                                     ; preds = %if.then178
  %95 = load ptr, ptr @stdout, align 8
  br label %if.end.i822

if.else.i:                                        ; preds = %if.then178
  %call1.i820 = call i32 @opts_Indicator() #14
  %add2.i = add nsw i32 %call1.i820, 1
  %idxprom.i = sext i32 %add2.i to i64
  %arrayidx.i821 = getelementptr inbounds ptr, ptr %argv, i64 %idxprom.i
  %96 = load ptr, ptr %arrayidx.i821, align 8
  %call3.i = call ptr @misc_OpenFile(ptr noundef %96, ptr noundef nonnull @.str.34) #14
  br label %if.end.i822

if.end.i822:                                      ; preds = %if.else.i, %if.then.i826
  %Output.0.i = phi ptr [ %95, %if.then.i826 ], [ %call3.i, %if.else.i ]
...
if.end34.i:                                       ; preds = %if.then29.i, %if.end.i822
...
if.end13.i.i:                                     ; preds = %if.then9.i.i, %if.then.i.i
  ...
  %conv.i.i824 = zext i32 %add.i.i to i64
  %add14.i.i = add nuw nsw i64 %conv.i.i824, 16
...
if.else25.i.i:                                    ; preds = %if.end34.i
  ...
  %arrayidx.i.i825 = getelementptr inbounds [0 x ptr], ptr @memory_ARRAY, i64 0, i64 %idxprom.i.i
  %114 = load ptr, ptr %arrayidx.i.i825, align 8
  ...
  %118 = load ptr, ptr %arrayidx.i.i825, align 8
...
if.end179:                                        ; preds = %top_Flotter.exit, %lor.lhs.false175
  ...
  %loops.i = getelementptr inbounds %struct.PROOFSEARCH_HELP, ptr %call2, i64 0, i32 21
  %backtracked.i = getelementptr inbounds %struct.PROOFSEARCH_HELP, ptr %call2, i64 0, i32 22
  ...
  %emptyclauses.i.i = getelementptr inbounds %struct.PROOFSEARCH_HELP, ptr %call2, i64 0, i32 1
  ...
  %130 = sub i64 %call2.val7191285, %call.i1286
  %diff.check1296 = icmp ult i64 %130, 32
...
for.body.i.i834:                                  ; preds = %for.body.i.i834, %for.body196.new
  %s.07.i.i = phi i64 [ 0, %for.body196.new ], [ %add.i.i837.7, %for.body.i.i834 ]
  %i.06.i.i = phi i64 [ 0, %for.body196.new ], [ %inc.i.i838.7, %for.body.i.i834 ]
  %niter = phi i64 [ 0, %for.body196.new ], [ %niter.next.7, %for.body.i.i834 ]
  %arrayidx.i.i835 = getelementptr inbounds i8, ptr %Scan.5.val, i64 %i.06.i.i
  %134 = load i8, ptr %arrayidx.i.i835, align 1
  %conv.i.i836 = sext i8 %134 to i64
  %add.i.i837 = add i64 %s.07.i.i, %conv.i.i836
  %inc.i.i838 = or i64 %i.06.i.i, 1
  %arrayidx.i.i835.1 = getelementptr inbounds i8, ptr %Scan.5.val, i64 %inc.i.i838
  %135 = load i8, ptr %arrayidx.i.i835.1, align 1
  %conv.i.i836.1 = sext i8 %135 to i64
  %add.i.i837.1 = add i64 %add.i.i837, %conv.i.i836.1
  %inc.i.i838.1 = or i64 %i.06.i.i, 2
  %arrayidx.i.i835.2 = getelementptr inbounds i8, ptr %Scan.5.val, i64 %inc.i.i838.1
  %136 = load i8, ptr %arrayidx.i.i835.2, align 1
  %conv.i.i836.2 = sext i8 %136 to i64
  %add.i.i837.2 = add i64 %add.i.i837.1, %conv.i.i836.2
  %inc.i.i838.2 = or i64 %i.06.i.i, 3
  %arrayidx.i.i835.3 = getelementptr inbounds i8, ptr %Scan.5.val, i64 %inc.i.i838.2
  %137 = load i8, ptr %arrayidx.i.i835.3, align 1
  %conv.i.i836.3 = sext i8 %137 to i64
  %add.i.i837.3 = add i64 %add.i.i837.2, %conv.i.i836.3
  %inc.i.i838.3 = or i64 %i.06.i.i, 4
  %arrayidx.i.i835.4 = getelementptr inbounds i8, ptr %Scan.5.val, i64 %inc.i.i838.3
  %138 = load i8, ptr %arrayidx.i.i835.4, align 1
  %conv.i.i836.4 = sext i8 %138 to i64
  %add.i.i837.4 = add i64 %add.i.i837.3, %conv.i.i836.4
  %inc.i.i838.4 = or i64 %i.06.i.i, 5
  %arrayidx.i.i835.5 = getelementptr inbounds i8, ptr %Scan.5.val, i64 %inc.i.i838.4
  %139 = load i8, ptr %arrayidx.i.i835.5, align 1
  %conv.i.i836.5 = sext i8 %139 to i64
  %add.i.i837.5 = add i64 %add.i.i837.4, %conv.i.i836.5
  %inc.i.i838.5 = or i64 %i.06.i.i, 6
  %arrayidx.i.i835.6 = getelementptr inbounds i8, ptr %Scan.5.val, i64 %inc.i.i838.5
  %140 = load i8, ptr %arrayidx.i.i835.6, align 1
  %conv.i.i836.6 = sext i8 %140 to i64
  %add.i.i837.6 = add i64 %add.i.i837.5, %conv.i.i836.6
  %inc.i.i838.6 = or i64 %i.06.i.i, 7
  %arrayidx.i.i835.7 = getelementptr inbounds i8, ptr %Scan.5.val, i64 %inc.i.i838.6
  %141 = load i8, ptr %arrayidx.i.i835.7, align 1
  %conv.i.i836.7 = sext i8 %141 to i64
  %add.i.i837.7 = add i64 %add.i.i837.6, %conv.i.i836.7
  %inc.i.i838.7 = add nuw i64 %i.06.i.i, 8
  %niter.next.7 = add i64 %niter, 8
  %niter.ncmp.7 = icmp eq i64 %niter.next.7, %unroll_iter
  br i1 %niter.ncmp.7, label %hsh_StringHashKey.exit.i.unr-lcssa, label %for.body.i.i834

hsh_StringHashKey.exit.i.unr-lcssa:               ; preds = %for.body.i.i834, %for.body196
  %add.i.i837.lcssa.ph = phi i64 [ undef, %for.body196 ], [ %add.i.i837.7, %for.body.i.i834 ]
  %s.07.i.i.unr = phi i64 [ 0, %for.body196 ], [ %add.i.i837.7, %for.body.i.i834 ]
  %i.06.i.i.unr = phi i64 [ 0, %for.body196 ], [ %inc.i.i838.7, %for.body.i.i834 ]
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %hsh_StringHashKey.exit.i, label %for.body.i.i834.epil

for.body.i.i834.epil:                             ; preds = %hsh_StringHashKey.exit.i.unr-lcssa, %for.body.i.i834.epil
  %s.07.i.i.epil = phi i64 [ %add.i.i837.epil, %for.body.i.i834.epil ], [ %s.07.i.i.unr, %hsh_StringHashKey.exit.i.unr-lcssa ]
  %i.06.i.i.epil = phi i64 [ %inc.i.i838.epil, %for.body.i.i834.epil ], [ %i.06.i.i.unr, %hsh_StringHashKey.exit.i.unr-lcssa ]
  %epil.iter = phi i64 [ %epil.iter.next, %for.body.i.i834.epil ], [ 0, %hsh_StringHashKey.exit.i.unr-lcssa ]
  %arrayidx.i.i835.epil = getelementptr inbounds i8, ptr %Scan.5.val, i64 %i.06.i.i.epil
  %142 = load i8, ptr %arrayidx.i.i835.epil, align 1
  %conv.i.i836.epil = sext i8 %142 to i64
  %add.i.i837.epil = add i64 %s.07.i.i.epil, %conv.i.i836.epil
  %inc.i.i838.epil = add nuw i64 %i.06.i.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %hsh_StringHashKey.exit.i, label %for.body.i.i834.epil

hsh_StringHashKey.exit.i:                         ; preds = %for.body.i.i834.epil, %hsh_StringHashKey.exit.i.unr-lcssa
  %add.i.i837.lcssa = phi i64 [ %add.i.i837.lcssa.ph, %hsh_StringHashKey.exit.i.unr-lcssa ], [ %add.i.i837.epil, %for.body.i.i834.epil ]
  %rem.i.i = urem i64 %add.i.i837.lcssa, 29
  %arrayidx.i839 = getelementptr inbounds ptr, ptr %TermLabelToClauselist.0, i64 %rem.i.i
  br label %for.cond.i840

for.cond.i840:                                    ; preds = %for.body.i842, %hsh_StringHashKey.exit.i
  ...
  %cmp.i.not.i841 = icmp eq ptr %Scan.0.i, null
  br i1 %cmp.i.not.i841, label %hsh_GetWithCompareFunc.exit, label %for.body.i842

for.body.i842:                                    ; preds = %for.cond.i840
  ...
  br i1 %cmp.i.i.not.i, label %if.then.i843, label %for.cond.i840

if.then.i843:                                     ; preds = %for.body.i842
  %call2.val.i = load ptr, ptr %Scan.0.val.i, align 8
  br label %hsh_GetWithCompareFunc.exit

hsh_GetWithCompareFunc.exit:                      ; preds = %for.cond.i840, %if.then.i843
  %retval.0.i844 = phi ptr [ %call2.val.i, %if.then.i843 ], [ null, %for.cond.i840 ]
  ...
  br i1 %cmp.i.not.i845, label %list_Nconc.exit854, label %if.end.i846

if.end.i846:                                      ; preds = %hsh_GetWithCompareFunc.exit
  %cmp.i18.not.i847 = icmp eq ptr %LabelClauses.01206, null
  br i1 %cmp.i18.not.i847, label %list_Nconc.exit854, label %for.cond.i848

for.cond.i848:                                    ; preds = %if.end.i846, %for.cond.i848
  %List1.addr.0.i849 = phi ptr [ %List1.addr.0.val17.i850, %for.cond.i848 ], [ %call200, %if.end.i846 ]
  %List1.addr.0.val17.i850 = load ptr, ptr %List1.addr.0.i849, align 8
  %cmp.i20.not.i851 = icmp eq ptr %List1.addr.0.val17.i850, null
  br i1 %cmp.i20.not.i851, label %for.end.i852, label %for.cond.i848

for.end.i852:                                     ; preds = %for.cond.i848
  store ptr %LabelClauses.01206, ptr %List1.addr.0.i849, align 8
  br label %list_Nconc.exit854

list_Nconc.exit854:                               ; preds = %hsh_GetWithCompareFunc.exit, %if.end.i846, %for.end.i852
  %retval.0.i853 = phi ptr [ %call200, %for.end.i852 ], [ %LabelClauses.01206, %hsh_GetWithCompareFunc.exit ], [ %call200, %if.end.i846 ]
  %Scan.5 = load ptr, ptr %Scan.51207, align 8
  %cmp.i831.not = icmp eq ptr %Scan.5, null
  br i1 %cmp.i831.not, label %for.cond205.preheader, label %for.body196
...
for.body209:                                      ; preds = %for.cond205.preheader, %list_Nconc.exit892
  ...
  %xtraiter1320 = and i64 %umax.i.i858, 7
  %147 = icmp ult i64 %146, 8
  br i1 %147, label %hsh_StringHashKey.exit.i867.unr-lcssa, label %for.body209.new

for.body209.new:                                  ; preds = %for.body209
  %unroll_iter1324 = and i64 %umax.i.i858, -8
  br label %for.body.i.i859

for.body.i.i859:                                  ; preds = %for.body.i.i859, %for.body209.new
  %s.07.i.i860 = phi i64 [ 0, %for.body209.new ], [ %add.i.i864.7, %for.body.i.i859 ]
  %i.06.i.i861 = phi i64 [ 0, %for.body209.new ], [ %inc.i.i865.7, %for.body.i.i859 ]
  %niter1325 = phi i64 [ 0, %for.body209.new ], [ %niter1325.next.7, %for.body.i.i859 ]
  %arrayidx.i.i862 = getelementptr inbounds i8, ptr %Scan.6.val, i64 %i.06.i.i861
  %148 = load i8, ptr %arrayidx.i.i862, align 1
  %conv.i.i863 = sext i8 %148 to i64
  %add.i.i864 = add i64 %s.07.i.i860, %conv.i.i863
  %inc.i.i865 = or i64 %i.06.i.i861, 1
  %arrayidx.i.i862.1 = getelementptr inbounds i8, ptr %Scan.6.val, i64 %inc.i.i865
  %149 = load i8, ptr %arrayidx.i.i862.1, align 1
  %conv.i.i863.1 = sext i8 %149 to i64
  %add.i.i864.1 = add i64 %add.i.i864, %conv.i.i863.1
  %inc.i.i865.1 = or i64 %i.06.i.i861, 2
  %arrayidx.i.i862.2 = getelementptr inbounds i8, ptr %Scan.6.val, i64 %inc.i.i865.1
  %150 = load i8, ptr %arrayidx.i.i862.2, align 1
  %conv.i.i863.2 = sext i8 %150 to i64
  %add.i.i864.2 = add i64 %add.i.i864.1, %conv.i.i863.2
  %inc.i.i865.2 = or i64 %i.06.i.i861, 3
  %arrayidx.i.i862.3 = getelementptr inbounds i8, ptr %Scan.6.val, i64 %inc.i.i865.2
  %151 = load i8, ptr %arrayidx.i.i862.3, align 1
  %conv.i.i863.3 = sext i8 %151 to i64
  %add.i.i864.3 = add i64 %add.i.i864.2, %conv.i.i863.3
  %inc.i.i865.3 = or i64 %i.06.i.i861, 4
  %arrayidx.i.i862.4 = getelementptr inbounds i8, ptr %Scan.6.val, i64 %inc.i.i865.3
  %152 = load i8, ptr %arrayidx.i.i862.4, align 1
  %conv.i.i863.4 = sext i8 %152 to i64
  %add.i.i864.4 = add i64 %add.i.i864.3, %conv.i.i863.4
  %inc.i.i865.4 = or i64 %i.06.i.i861, 5
  %arrayidx.i.i862.5 = getelementptr inbounds i8, ptr %Scan.6.val, i64 %inc.i.i865.4
  %153 = load i8, ptr %arrayidx.i.i862.5, align 1
  %conv.i.i863.5 = sext i8 %153 to i64
  %add.i.i864.5 = add i64 %add.i.i864.4, %conv.i.i863.5
  %inc.i.i865.5 = or i64 %i.06.i.i861, 6
  %arrayidx.i.i862.6 = getelementptr inbounds i8, ptr %Scan.6.val, i64 %inc.i.i865.5
  %154 = load i8, ptr %arrayidx.i.i862.6, align 1
  %conv.i.i863.6 = sext i8 %154 to i64
  %add.i.i864.6 = add i64 %add.i.i864.5, %conv.i.i863.6
  %inc.i.i865.6 = or i64 %i.06.i.i861, 7
  %arrayidx.i.i862.7 = getelementptr inbounds i8, ptr %Scan.6.val, i64 %inc.i.i865.6
  %155 = load i8, ptr %arrayidx.i.i862.7, align 1
  %conv.i.i863.7 = sext i8 %155 to i64
  %add.i.i864.7 = add i64 %add.i.i864.6, %conv.i.i863.7
  %inc.i.i865.7 = add nuw i64 %i.06.i.i861, 8
  %niter1325.next.7 = add i64 %niter1325, 8
  %niter1325.ncmp.7 = icmp eq i64 %niter1325.next.7, %unroll_iter1324
  br i1 %niter1325.ncmp.7, label %hsh_StringHashKey.exit.i867.unr-lcssa, label %for.body.i.i859

hsh_StringHashKey.exit.i867.unr-lcssa:            ; preds = %for.body.i.i859, %for.body209
  %add.i.i864.lcssa.ph = phi i64 [ undef, %for.body209 ], [ %add.i.i864.7, %for.body.i.i859 ]
  %s.07.i.i860.unr = phi i64 [ 0, %for.body209 ], [ %add.i.i864.7, %for.body.i.i859 ]
  %i.06.i.i861.unr = phi i64 [ 0, %for.body209 ], [ %inc.i.i865.7, %for.body.i.i859 ]
  %lcmp.mod1322.not = icmp eq i64 %xtraiter1320, 0
  br i1 %lcmp.mod1322.not, label %hsh_StringHashKey.exit.i867, label %for.body.i.i859.epil

for.body.i.i859.epil:                             ; preds = %hsh_StringHashKey.exit.i867.unr-lcssa, %for.body.i.i859.epil
  %s.07.i.i860.epil = phi i64 [ %add.i.i864.epil, %for.body.i.i859.epil ], [ %s.07.i.i860.unr, %hsh_StringHashKey.exit.i867.unr-lcssa ]
  %i.06.i.i861.epil = phi i64 [ %inc.i.i865.epil, %for.body.i.i859.epil ], [ %i.06.i.i861.unr, %hsh_StringHashKey.exit.i867.unr-lcssa ]
  %epil.iter1321 = phi i64 [ %epil.iter1321.next, %for.body.i.i859.epil ], [ 0, %hsh_StringHashKey.exit.i867.unr-lcssa ]
  %arrayidx.i.i862.epil = getelementptr inbounds i8, ptr %Scan.6.val, i64 %i.06.i.i861.epil
  %156 = load i8, ptr %arrayidx.i.i862.epil, align 1
  %conv.i.i863.epil = sext i8 %156 to i64
  %add.i.i864.epil = add i64 %s.07.i.i860.epil, %conv.i.i863.epil
  %inc.i.i865.epil = add nuw i64 %i.06.i.i861.epil, 1
  %epil.iter1321.next = add i64 %epil.iter1321, 1
  %epil.iter1321.cmp.not = icmp eq i64 %epil.iter1321.next, %xtraiter1320
  br i1 %epil.iter1321.cmp.not, label %hsh_StringHashKey.exit.i867, label %for.body.i.i859.epil

hsh_StringHashKey.exit.i867:                      ; preds = %for.body.i.i859.epil, %hsh_StringHashKey.exit.i867.unr-lcssa
  %add.i.i864.lcssa = phi i64 [ %add.i.i864.lcssa.ph, %hsh_StringHashKey.exit.i867.unr-lcssa ], [ %add.i.i864.epil, %for.body.i.i859.epil ]
  %rem.i.i868 = urem i64 %add.i.i864.lcssa, 29
  %arrayidx.i869 = getelementptr inbounds ptr, ptr %TermLabelToClauselist.0, i64 %rem.i.i868
  br label %for.cond.i870

for.cond.i870:                                    ; preds = %for.body.i874, %hsh_StringHashKey.exit.i867
  %Scan.0.in.i871 = phi ptr [ %arrayidx.i869, %hsh_StringHashKey.exit.i867 ], [ %Scan.0.i872, %for.body.i874 ]
  %Scan.0.i872 = load ptr, ptr %Scan.0.in.i871, align 8
  %cmp.i.not.i873 = icmp eq ptr %Scan.0.i872, null
  br i1 %cmp.i.not.i873, label %hsh_GetWithCompareFunc.exit882, label %for.body.i874

for.body.i874:                                    ; preds = %for.cond.i870
  %157 = getelementptr i8, ptr %Scan.0.i872, i64 8
  %Scan.0.val.i875 = load ptr, ptr %157, align 8
  %158 = getelementptr i8, ptr %Scan.0.val.i875, i64 8
  %call2.val14.i876 = load ptr, ptr %158, align 8
  %call.i.i.i877 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %call2.val14.i876, ptr noundef nonnull dereferenceable(1) %Scan.6.val) #15
  %cmp.i.i.not.i878 = icmp eq i32 %call.i.i.i877, 0
  br i1 %cmp.i.i.not.i878, label %if.then.i879, label %for.cond.i870

if.then.i879:                                     ; preds = %for.body.i874
  %call2.val.i880 = load ptr, ptr %Scan.0.val.i875, align 8
  br label %hsh_GetWithCompareFunc.exit882

hsh_GetWithCompareFunc.exit882:                   ; preds = %for.cond.i870, %if.then.i879
  %retval.0.i881 = phi ptr [ %call2.val.i880, %if.then.i879 ], [ null, %for.cond.i870 ]
  ...
  br i1 %cmp.i.not.i883, label %list_Nconc.exit892, label %if.end.i884

if.end.i884:                                      ; preds = %hsh_GetWithCompareFunc.exit882
  %cmp.i18.not.i885 = icmp eq ptr %LabelClauses.11210, null
  br i1 %cmp.i18.not.i885, label %list_Nconc.exit892, label %for.cond.i886

for.cond.i886:                                    ; preds = %if.end.i884, %for.cond.i886
  %List1.addr.0.i887 = phi ptr [ %List1.addr.0.val17.i888, %for.cond.i886 ], [ %call214, %if.end.i884 ]
  %List1.addr.0.val17.i888 = load ptr, ptr %List1.addr.0.i887, align 8
  %cmp.i20.not.i889 = icmp eq ptr %List1.addr.0.val17.i888, null
  br i1 %cmp.i20.not.i889, label %for.end.i890, label %for.cond.i886

for.end.i890:                                     ; preds = %for.cond.i886
  store ptr %LabelClauses.11210, ptr %List1.addr.0.i887, align 8
  br label %list_Nconc.exit892

list_Nconc.exit892:                               ; preds = %hsh_GetWithCompareFunc.exit882, %if.end.i884, %for.end.i890
  %retval.0.i891 = phi ptr [ %call214, %for.end.i890 ], [ %LabelClauses.11210, %hsh_GetWithCompareFunc.exit882 ], [ %call214, %if.end.i884 ]
  %Scan.6.val734 = load ptr, ptr %Scan.61211, align 8
  %cmp.i855.not = icmp eq ptr %Scan.6.val734, null
  br i1 %cmp.i855.not, label %for.cond219.preheader, label %for.body209
...
for.cond.i897:                                    ; preds = %for.body.i901, %for.body223
  %Scan.0.in.i898 = phi ptr [ %arrayidx.i896, %for.body223 ], [ %Scan.0.i899, %for.body.i901 ]
  %Scan.0.i899 = load ptr, ptr %Scan.0.in.i898, align 8
  %cmp.i.not.i900 = icmp eq ptr %Scan.0.i899, null
  br i1 %cmp.i.not.i900, label %hsh_Get.exit, label %for.body.i901

for.body.i901:                                    ; preds = %for.cond.i897
  %161 = getelementptr i8, ptr %Scan.0.i899, i64 8
  %Scan.0.val.i902 = load ptr, ptr %161, align 8
  %162 = getelementptr i8, ptr %Scan.0.val.i902, i64 8
  %call2.val12.i = load ptr, ptr %162, align 8
  %cmp.i903 = icmp eq ptr %call2.val12.i, %Scan.7.val722
  br i1 %cmp.i903, label %if.then.i904, label %for.cond.i897

if.then.i904:                                     ; preds = %for.body.i901
  %call2.val.i905 = load ptr, ptr %Scan.0.val.i902, align 8
  br label %hsh_Get.exit

hsh_Get.exit:                                     ; preds = %for.cond.i897, %if.then.i904
  %retval.0.i906 = phi ptr [ %call2.val.i905, %if.then.i904 ], [ null, %for.cond.i897 ]
...
for.cond.i911:                                    ; preds = %for.body.i915, %hsh_Get.exit
  %Scan.0.in.i912 = phi ptr [ %arrayidx.i910, %hsh_Get.exit ], [ %Scan.0.i913, %for.body.i915 ]
  %Scan.0.i913 = load ptr, ptr %Scan.0.in.i912, align 8
  %cmp.i.not.i914 = icmp eq ptr %Scan.0.i913, null
  br i1 %cmp.i.not.i914, label %for.end.i920, label %for.body.i915

for.body.i915:                                    ; preds = %for.cond.i911
  %164 = getelementptr i8, ptr %Scan.0.i913, i64 8
  %Scan.0.val.i916 = load ptr, ptr %164, align 8
  %165 = getelementptr i8, ptr %Scan.0.val.i916, i64 8
  %call2.val25.i = load ptr, ptr %165, align 8
  %cmp.i917 = icmp eq ptr %call2.val25.i, %call229
  br i1 %cmp.i917, label %if.then.i918, label %for.cond.i911

if.then.i918:                                     ; preds = %for.body.i915
  %call2.val.i919 = load ptr, ptr %Scan.0.val.i916, align 8
  %cmp.i.not.i.i = icmp eq ptr %call2.val.i919, null
...
for.cond.i.i:                                     ; preds = %if.end.i.i, %for.cond.i.i
  %List1.addr.0.i.i = phi ptr [ %List1.addr.0.val17.i.i, %for.cond.i.i ], [ %call2.val.i919, %if.end.i.i ]
...
list_Nconc.exit.i:                                ; preds = %for.end.i.i, %if.end.i.i, %if.then.i918
  %retval.0.i.i = phi ptr [ %call2.val.i919, %for.end.i.i ], [ %call.i907, %if.then.i918 ], [ %call2.val.i919, %if.end.i.i ]
  store ptr %retval.0.i.i, ptr %Scan.0.val.i916, align 8
  br label %hsh_PutList.exit

for.end.i920:                                     ; preds = %for.cond.i911
  %call.i.i.i921 = call ptr @memory_Malloc(i32 noundef 16) #14
  %car.i.i.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i.i921, i64 0, i32 1
  store ptr %call229, ptr %car.i.i.i, align 8
  store ptr %call.i907, ptr %call.i.i.i921, align 8
  %166 = load ptr, ptr %arrayidx.i910, align 8
  %call.i.i922 = call ptr @memory_Malloc(i32 noundef 16) #14
  %car.i.i923 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i922, i64 0, i32 1
  store ptr %call.i.i.i921, ptr %car.i.i923, align 8
  store ptr %166, ptr %call.i.i922, align 8
  store ptr %call.i.i922, ptr %arrayidx.i910, align 8
  br label %hsh_PutList.exit

hsh_PutList.exit:                                 ; preds = %list_Nconc.exit.i, %for.end.i920
  %Scan.7.val733 = load ptr, ptr %Scan.71214, align 8
  %cmp.i893.not = icmp eq ptr %Scan.7.val733, null
  br i1 %cmp.i893.not, label %for.end233, label %for.body223
...
for.end233:                                       ; preds = %hsh_PutList.exit
  ...
  br i1 %brmerge, label %list_Nconc.exit933, label %for.cond.i927

for.end233.thread:                                ; preds = %for.cond219.preheader
  %168 = getelementptr i8, ptr %call186, i64 8
  %call186.val7431253 = load ptr, ptr %168, align 8
  %call2351254 = call ptr @cnf_QueryFlotter(ptr noundef %FlotterSearch.0, ptr noundef %call186.val7431253, ptr noundef nonnull %Symblist) #14
  br label %list_Nconc.exit933

for.cond.i927:                                    ; preds = %for.end233, %for.cond.i927
  %List1.addr.0.i928 = phi ptr [ %List1.addr.0.val17.i929, %for.cond.i927 ], [ %call235, %for.end233 ]
  %List1.addr.0.val17.i929 = load ptr, ptr %List1.addr.0.i928, align 8
  %cmp.i20.not.i930 = icmp eq ptr %List1.addr.0.val17.i929, null
  br i1 %cmp.i20.not.i930, label %for.end.i931, label %for.cond.i927

for.end.i931:                                     ; preds = %for.cond.i927
  store ptr %LabelClauses.1.lcssa, ptr %List1.addr.0.i928, align 8
  br label %list_Nconc.exit933

list_Nconc.exit933:                               ; preds = %for.end233.thread, %for.end233, %for.end.i931
  %retval.0.i932 = phi ptr [ %call235, %for.end.i931 ], [ %LabelClauses.1.lcssa.mux, %for.end233 ], [ %call2351254, %for.end233.thread ]
...
for.body242:                                      ; preds = %list_Nconc.exit933, %for.body242
  ...
  br i1 %cmp.i934.not, label %for.end246, label %for.body242
...
while.body.i:                                     ; preds = %for.end246, %while.body.i
  ...
  br i1 %cmp.i.not.i936, label %list_Delete.exit, label %while.body.i
...
for.body.i.i943:                                  ; preds = %for.inc.i.i, %if.then.i942
  %indvars.iv.i.i944 = phi i64 [ 0, %if.then.i942 ], [ %indvars.iv.next.i.i947, %for.inc.i.i ]
  %arrayidx.i.i.i.i = getelementptr inbounds i32, ptr %call.i758, i64 %indvars.iv.i.i944
  %186 = load i32, ptr %arrayidx.i.i.i.i, align 4
  %cmp.i.not.i.i945 = icmp eq i32 %186, %11
  br i1 %cmp.i.not.i.i945, label %for.inc.i.i, label %if.then.i.i946

if.then.i.i946:                                   ; preds = %for.body.i.i943
  %187 = trunc i64 %indvars.iv.i.i944 to i32
  call fastcc void @flag_SetFlagValue(ptr noundef %Search.val435.i, i32 noundef %187, i32 noundef %186)
  br label %for.inc.i.i

for.inc.i.i:                                      ; preds = %if.then.i.i946, %for.body.i.i943
  %indvars.iv.next.i.i947 = add nuw nsw i64 %indvars.iv.i.i944, 1
  %exitcond.not.i.i948 = icmp eq i64 %indvars.iv.next.i.i947, 96
  br i1 %exitcond.not.i.i948, label %if.end.i949, label %for.body.i.i943
...
if.end.i949:                                      ; preds = %for.inc.i.i, %if.end250
  ...
  br i1 %cmp.i.not718.i, label %for.end.i953, label %for.body.i950

for.body.i950:                                    ; preds = %if.end.i949, %for.body.i950
  %Scan.0719.i = phi ptr [ %Scan.0.val446.i, %for.body.i950 ], [ %ProblemClauses.0, %if.end.i949 ]
  %188 = getelementptr i8, ptr %Scan.0719.i, i64 8
  %Scan.0.val.i951 = load ptr, ptr %188, align 8
  call void @clause_OrientEqualities(ptr noundef %Scan.0.val.i951, ptr noundef %Search.val435.i, ptr noundef %Search.val437.i) #14
  call void @clause_Normalize(ptr noundef %Scan.0.val.i951) #14
  call void @clause_SetMaxLitFlags(ptr noundef %Scan.0.val.i951, ptr noundef %Search.val435.i, ptr noundef %Search.val437.i) #14
  %call.i.i.i.i = call i32 @clause_ComputeWeight(ptr noundef %Scan.0.val.i951, ptr noundef %Search.val435.i) #14
  %weight.i.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Scan.0.val.i951, i64 0, i32 1
  store i32 %call.i.i.i.i, ptr %weight.i.i.i.i, align 4
  call void @clause_UpdateMaxVar(ptr noundef %Scan.0.val.i951) #14
  %Scan.0.val446.i = load ptr, ptr %Scan.0719.i, align 8
  %cmp.i.not.i952 = icmp eq ptr %Scan.0.val446.i, null
  br i1 %cmp.i.not.i952, label %for.end.i953, label %for.body.i950

for.end.i953:                                     ; preds = %for.body.i950, %if.end.i949
...
for.body.i464.i:                                  ; preds = %for.inc.i469.i, %if.then13.i
  %indvars.iv.i465.i = phi i64 [ 0, %if.then13.i ], [ %indvars.iv.next.i470.i, %for.inc.i469.i ]
  %arrayidx.i.i.i466.i = getelementptr inbounds i32, ptr %call.i758, i64 %indvars.iv.i465.i
  %190 = load i32, ptr %arrayidx.i.i.i466.i, align 4
  %cmp.i.not.i467.i = icmp eq i32 %190, %11
  br i1 %cmp.i.not.i467.i, label %for.inc.i469.i, label %if.then.i468.i

if.then.i468.i:                                   ; preds = %for.body.i464.i
  %191 = trunc i64 %indvars.iv.i465.i to i32
  call fastcc void @flag_SetFlagValue(ptr noundef nonnull %Search.val435.i, i32 noundef %191, i32 noundef %190)
  br label %for.inc.i469.i

for.inc.i469.i:                                   ; preds = %if.then.i468.i, %for.body.i464.i
  %indvars.iv.next.i470.i = add nuw nsw i64 %indvars.iv.i465.i, 1
  %exitcond.not.i471.i = icmp eq i64 %indvars.iv.next.i470.i, 96
  br i1 %exitcond.not.i471.i, label %if.end14.i, label %for.body.i464.i

if.end14.i:                                       ; preds = %for.inc.i469.i, %for.end.i953
...
for.body34.i:                                     ; preds = %if.then27.i, %for.body34.i
  ...
  br i1 %cmp.i479.not.i, label %if.end39.i, label %for.body34.i
...
for.body55.i:                                     ; preds = %for.cond51.preheader.i, %for.body55.i
  ...
  br i1 %cmp.i485.not.i, label %if.end60.i, label %for.body55.i
...
for.body84.i:                                     ; preds = %if.end78.i, %for.body84.i
  ...
  br i1 %cmp.i489.not.i, label %for.cond94.preheader.i, label %for.body84.i
...
for.body98.i:                                     ; preds = %for.cond94.preheader.i, %for.body98.i
  ...
  br i1 %cmp.i491.not.i, label %for.end103.loopexit.i, label %for.body98.i
...
for.inc122.i:                                     ; preds = %if.then119.i, %for.body115.i
  ...
  br i1 %cmp.i494.not.i, label %while.body.i.i, label %for.body115.i
...
while.body.i.i:                                   ; preds = %for.inc122.i, %while.body.i.i
  ...
  br i1 %cmp.i.not.i496.i, label %if.end125.i, label %while.body.i.i
...
if.end.i.i961:                                    ; preds = %if.then197.i
  %cmp.i18.not.i.i962 = icmp eq ptr %call193.i, null
  br i1 %cmp.i18.not.i.i962, label %if.end225.i, label %for.cond.i.i963

for.cond.i.i963:                                  ; preds = %if.end.i.i961, %for.cond.i.i963
  %List1.addr.0.i.i964 = phi ptr [ %List1.addr.0.val17.i.i965, %for.cond.i.i963 ], [ %227, %if.end.i.i961 ]
  %List1.addr.0.val17.i.i965 = load ptr, ptr %List1.addr.0.i.i964, align 8
  %cmp.i20.not.i.i966 = icmp eq ptr %List1.addr.0.val17.i.i965, null
  br i1 %cmp.i20.not.i.i966, label %for.end.i.i967, label %for.cond.i.i963

for.end.i.i967:                                   ; preds = %for.cond.i.i963
  store ptr %call193.i, ptr %List1.addr.0.i.i964, align 8
...
for.inc211.i:                                     ; preds = %if.then208.i, %for.body204.i
  ...
  br i1 %cmp.i519.not.i, label %for.end213.i, label %for.body204.i
...
if.then216.i:                                     ; preds = %for.end213.i
  ...
  %car.i.i960 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i525.i, i64 0, i32 1
  store ptr %HighestLevelEmptyClause.1.i, ptr %car.i.i960, align 8
...
if.end225.i:                                      ; preds = %if.then221.i, %if.end218.i, %for.end.i.i967, %if.end.i.i961, %if.then197.i
  %UsedEmptyClauses.3.i = phi ptr [ %UsedEmptyClauses.2.i, %if.then221.i ], [ %UsedEmptyClauses.2.i, %if.end218.i ], [ %UsedEmptyClauses.1.i, %if.then197.i ], [ %UsedEmptyClauses.1.i, %if.end.i.i961 ], [ %UsedEmptyClauses.1.i, %for.end.i.i967 ]
  %Derivables.0.i = phi ptr [ %call193.i, %if.then221.i ], [ %call193.i, %if.end218.i ], [ %call193.i, %if.then197.i ], [ %227, %if.end.i.i961 ], [ %227, %for.end.i.i967 ]
  store ptr null, ptr %EmptyClauses.i, align 8
...
while.body.i.i.i:                                 ; preds = %land.lhs.true.i.i, %if.end.i.i.i
  ...
  br i1 %cmp.i.i.i968, label %if.end.i530.i, label %if.end.i.i.i
...
if.end.i.i.i:                                     ; preds = %while.body.i.i.i
  ...
  br i1 %cmp.i.not.i.i.i, label %if.end.thread.i.i, label %while.body.i.i.i
...
if.end.i530.i:                                    ; preds = %while.body.i.i.i
  store ptr null, ptr %SplitClause.i, align 8
...
if.then13.i.i:                                    ; preds = %if.end11.i.i
  ...
  br label %while.body.i146.i.i

while.body.i146.i.i:                              ; preds = %while.body.i146.i.i, %if.then13.i.i
  %Current.06.i.i.i = phi ptr [ %Current.0.val.i.i.i, %while.body.i146.i.i ], [ %call.i.i.i528.i, %if.then13.i.i ]
  ...
  %cmp.i.not.i147.i.i = icmp eq ptr %Current.0.val.i.i.i, null
  br i1 %cmp.i.not.i147.i.i, label %if.end34.i.i, label %while.body.i146.i.i
...
if.else.i.i:                                      ; preds = %if.end11.i.i, %if.end.thread.i.i
  ...
  %rem.i.i972 = srem i32 %Counter.1.i, %249
  %cmp18.i.i = icmp eq i32 %rem.i.i972, 0
...
if.then32.i.i.i:                                  ; preds = %if.else30.i.i.i
  %List.addr.0.val.i151.i.i = load ptr, ptr %253, align 8
  %257 = getelementptr i8, ptr %List.addr.0.val.i151.i.i, i64 4
...
if.end39.i.i.i:                                   ; preds = %if.then32.i.i.i, %if.else30.i.i.i, %if.then27.i.i.i, %if.then25.i.i.i, %if.else.i.i.i, %if.then12.i.i.i, %while.body.i149.i.i
  ...
  %Result.1.i.i.i = phi ptr [ %List.addr.0.val74.i.i.i, %if.then12.i.i.i ], [ %List.addr.0.val68.i.i.i, %if.then27.i.i.i ], [ %Result.081.i.i.i, %if.then25.i.i.i ], [ %List.addr.0.val.i151.i.i, %if.then32.i.i.i ], [ %Result.081.i.i.i, %if.else30.i.i.i ], [ %Result.081.i.i.i, %if.else.i.i.i ], [ %Result.081.i.i.i, %while.body.i149.i.i ]
  ...
  %cmp.i.not.i150.i.i = icmp eq ptr %List.addr.0.i.i.i, null
  br i1 %cmp.i.not.i150.i.i, label %if.end32.i.i, label %while.body.i149.i.i
...
while.body.i158.i.i:                              ; preds = %if.end39.i161.i.i, %while.body.lr.ph.i157.i.i
  %List.addr.085.i.i.i = phi ptr [ %List.addr.080.i.i.i, %while.body.lr.ph.i157.i.i ], [ %List.addr.0.i164.i.i, %if.end39.i161.i.i ]
  %Vars.084.i.i.i = phi i32 [ %call5.i.i.i, %while.body.lr.ph.i157.i.i ], [ %Vars.1.i163.i.i, %if.end39.i161.i.i ]
  %Result.083.i.i.i = phi ptr [ %List.val.i169.i.i, %while.body.lr.ph.i157.i.i ], [ %Result.1.i162.i.i, %if.end39.i161.i.i ]
  %Weight.182.i.i.i = phi i32 [ %Weight.0.i.i.i, %while.body.lr.ph.i157.i.i ], [ %Weight.2.i.i.i, %if.end39.i161.i.i ]
...
if.then22.i.i.i:                                  ; preds = %if.else.i160.i.i
  ...
  br i1 %tobool26.not.i.i.i, label %if.else32.i.i.i, label %if.then27.i167.i.i

if.then27.i167.i.i:                               ; preds = %if.then22.i.i.i
  %cmp28.i.i.i = icmp ult i32 %Vars.084.i.i.i, %call24.i.i.i
  br i1 %cmp28.i.i.i, label %if.then29.i.i.i, label %if.end39.i161.i.i

if.then29.i.i.i:                                  ; preds = %if.then27.i167.i.i
...
if.else32.i.i.i:                                  ; preds = %if.then22.i.i.i
  ...
  br i1 %cmp33.i.i.i, label %if.then34.i.i.i, label %if.end39.i161.i.i

if.then34.i.i.i:                                  ; preds = %if.else32.i.i.i
  %List.addr.0.val.i168.i.i = load ptr, ptr %263, align 8
  br label %if.end39.i161.i.i

if.end39.i161.i.i:                                ; preds = %if.then34.i.i.i, %if.else32.i.i.i, %if.then29.i.i.i, %if.then27.i167.i.i, %if.else.i160.i.i, %if.then17.i.i.i
  %Weight.2.i.i.i = phi i32 [ %NewWeight.0.i.i.i, %if.then17.i.i.i ], [ %Weight.182.i.i.i, %if.then29.i.i.i ], [ %Weight.182.i.i.i, %if.then27.i167.i.i ], [ %Weight.182.i.i.i, %if.then34.i.i.i ], [ %Weight.182.i.i.i, %if.else32.i.i.i ], [ %Weight.182.i.i.i, %if.else.i160.i.i ]
  %Result.1.i162.i.i = phi ptr [ %List.addr.0.val72.i.i.i, %if.then17.i.i.i ], [ %List.addr.0.val67.i.i.i, %if.then29.i.i.i ], [ %Result.083.i.i.i, %if.then27.i167.i.i ], [ %List.addr.0.val.i168.i.i, %if.then34.i.i.i ], [ %Result.083.i.i.i, %if.else32.i.i.i ], [ %Result.083.i.i.i, %if.else.i160.i.i ]
  %Vars.1.i163.i.i = phi i32 [ %call20.i.i.i, %if.then17.i.i.i ], [ %call24.i.i.i, %if.then29.i.i.i ], [ %Vars.084.i.i.i, %if.then27.i167.i.i ], [ %call24.i.i.i, %if.then34.i.i.i ], [ %Vars.084.i.i.i, %if.else32.i.i.i ], [ %Vars.084.i.i.i, %if.else.i160.i.i ]
  %List.addr.0.i164.i.i = load ptr, ptr %List.addr.085.i.i.i, align 8
  %cmp.i.not.i165.i.i = icmp eq ptr %List.addr.0.i164.i.i, null
  br i1 %cmp.i.not.i165.i.i, label %if.end32.i.i, label %while.body.i158.i.i
...
if.else28.i.i:                                    ; preds = %if.else22.i.i
  ...
  br i1 %cmp.i.not50.i.i.i, label %if.end32.i.i, label %while.body.lr.ph.i171.i.i

while.body.lr.ph.i171.i.i:                        ; preds = %if.else28.i.i
  %arrayidx.i.i172.i.i = getelementptr inbounds i32, ptr %Search.val.i.i, i64 47
  br label %while.body.i173.i.i

while.body.i173.i.i:                              ; preds = %if.end23.i.i.i, %while.body.lr.ph.i171.i.i
  %List.addr.054.i.i.i = phi ptr [ %List.addr.049.i.i.i, %while.body.lr.ph.i171.i.i ], [ %List.addr.0.i180.i.i, %if.end23.i.i.i ]
  %Weight.053.i.i.i = phi i32 [ %call.val.i170.i.i, %while.body.lr.ph.i171.i.i ], [ %Weight.1.i179.i.i, %if.end23.i.i.i ]
  %Vars.052.i.i.i = phi i32 [ %call2.i.i.i, %while.body.lr.ph.i171.i.i ], [ %Vars.1.i178.i.i, %if.end23.i.i.i ]
  %Result.051.i.i.i = phi ptr [ %List.val.i169.i.i, %while.body.lr.ph.i171.i.i ], [ %Result.1.i177.i.i, %if.end23.i.i.i ]
  ...
  %cmp.i174.i.i = icmp eq i32 %call5.val.i.i.i, %Weight.053.i.i.i
  br i1 %cmp.i174.i.i, label %if.then.i176.i.i, label %if.end32.i.i

if.then.i176.i.i:                                 ; preds = %while.body.i173.i.i
  %call8.i.i.i = call i32 @clause_NumberOfVarOccs(ptr noundef nonnull %List.addr.0.val46.i.i.i) #14
  %270 = load i32, ptr %arrayidx.i.i172.i.i, align 4
  %tobool10.not.i.i.i = icmp eq i32 %270, 0
  br i1 %tobool10.not.i.i.i, label %if.else.i182.i.i, label %if.then11.i.i.i

if.then11.i.i.i:                                  ; preds = %if.then.i176.i.i
...
if.else.i182.i.i:                                 ; preds = %if.then.i176.i.i
...
if.end23.sink.split.i.i.i:                        ; preds = %if.else.i182.i.i, %if.then11.i.i.i
...
if.end23.i.i.i:                                   ; preds = %if.end23.sink.split.i.i.i, %if.else.i182.i.i, %if.then11.i.i.i
  %Result.1.i177.i.i = phi ptr [ %Result.051.i.i.i, %if.then11.i.i.i ], [ %Result.051.i.i.i, %if.else.i182.i.i ], [ %List.addr.0.val44.sink.i.i.i, %if.end23.sink.split.i.i.i ]
  %Vars.1.i178.i.i = phi i32 [ %Vars.052.i.i.i, %if.then11.i.i.i ], [ %Vars.052.i.i.i, %if.else.i182.i.i ], [ %call8.i.i.i, %if.end23.sink.split.i.i.i ]
  %Weight.1.i179.i.i = phi i32 [ %Weight.053.i.i.i, %if.then11.i.i.i ], [ %Weight.053.i.i.i, %if.else.i182.i.i ], [ %call14.val.i.i.i, %if.end23.sink.split.i.i.i ]
  %List.addr.0.i180.i.i = load ptr, ptr %List.addr.054.i.i.i, align 8
  %cmp.i.not.i181.i.i = icmp eq ptr %List.addr.0.i180.i.i, null
  br i1 %cmp.i.not.i181.i.i, label %if.end32.i.i, label %while.body.i173.i.i

if.end32.i.i:                                     ; preds = %if.end39.i161.i.i, %if.end23.i.i.i, %while.body.i173.i.i, %if.end39.i.i.i, %if.else28.i.i, %if.end.i156.i.i, %if.then19.i.i
  %GivenClause.2.i.i = phi ptr [ %List.val.i.i.i, %if.then19.i.i ], [ %List.val.i169.i.i, %if.end.i156.i.i ], [ %List.val.i169.i.i, %if.else28.i.i ], [ %Result.1.i.i.i, %if.end39.i.i.i ], [ %Result.051.i.i.i, %while.body.i173.i.i ], [ %Result.1.i177.i.i, %if.end23.i.i.i ], [ %Result.1.i162.i.i, %if.end39.i161.i.i ]
  %inc.i.i973 = add nsw i32 %Counter.1.i, 1
  br label %if.end34.i.i

if.end34.i.i:                                     ; preds = %while.body.i146.i.i, %if.end32.i.i
  %Counter.2.i = phi i32 [ %inc.i.i973, %if.end32.i.i ], [ %Counter.1.i, %while.body.i146.i.i ]
  %GivenClause.3.ph.i.i = phi ptr [ %GivenClause.2.i.i, %if.end32.i.i ], [ %call10.i.i, %while.body.i146.i.i ]
...
land.lhs.true36.i.i:                              ; preds = %if.end34.i.i, %if.end.i530.i
  %Counter.3.i = phi i32 [ %Counter.2.i, %if.end34.i.i ], [ %Counter.1.i, %if.end.i530.i ]
  %GivenClause.3219.i.i = phi ptr [ %GivenClause.3.ph.i.i, %if.end34.i.i ], [ %239, %if.end.i530.i ]
...
for.body.i.i.i:                                   ; preds = %for.inc.i.i.i, %for.body.lr.ph.i.i.i
  %Result.016.i.i.i = phi i32 [ -1, %for.body.lr.ph.i.i.i ], [ %Result.1.i186.i.i, %for.inc.i.i.i ]
  ...
  br i1 %cmp.i185.i.i, label %if.then.i189.i.i, label %for.inc.i.i.i

if.then.i189.i.i:                                 ; preds = %for.body.i.i.i
  %SplitLits.0.val.i.i.i = load ptr, ptr %273, align 8
  %276 = ptrtoint ptr %SplitLits.0.val.i.i.i to i64
  %277 = trunc i64 %276 to i32
  br label %for.inc.i.i.i

for.inc.i.i.i:                                    ; preds = %if.then.i189.i.i, %for.body.i.i.i
  %MaxInstances.1.i.i.i = phi i32 [ %call4.i.i.i, %if.then.i189.i.i ], [ %MaxInstances.015.i.i.i, %for.body.i.i.i ]
  %Result.1.i186.i.i = phi i32 [ %277, %if.then.i189.i.i ], [ %Result.016.i.i.i, %for.body.i.i.i ]
  ...
  %cmp.i.not.i187.i.i = icmp eq ptr %L.val.i.i.i.i, null
  br i1 %cmp.i.not.i187.i.i, label %top_GetOptimalSplitLiteralIndex.exit.i.i, label %for.body.i.i.i

top_GetOptimalSplitLiteralIndex.exit.i.i:         ; preds = %for.inc.i.i.i
  %cmp41.i.i = icmp sgt i32 %Result.1.i186.i.i, -1
...
if.then42.i.i:                                    ; preds = %top_GetOptimalSplitLiteralIndex.exit.i.i
  ...
  %idxprom.i190.i.i = zext i32 %Result.1.i186.i.i to i64
  ...
  br label %while.body.i195.i.i

while.body.i195.i.i:                              ; preds = %while.body.i195.i.i, %if.then42.i.i
  %Current.06.i196.i.i = phi ptr [ %Current.0.val.i197.i.i, %while.body.i195.i.i ], [ %call.i.i192.i.i, %if.then42.i.i ]
  %Current.0.val.i197.i.i = load ptr, ptr %Current.06.i196.i.i, align 8
  %284 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i198.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %284, i64 0, i32 4
  %285 = load i32, ptr %total_size.i.i.i198.i.i, align 8
  %conv26.i.i.i199.i.i = sext i32 %285 to i64
  %286 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i200.i.i = add i64 %286, %conv26.i.i.i199.i.i
  store i64 %add27.i.i.i200.i.i, ptr @memory_FREEDBYTES, align 8
  %287 = load ptr, ptr %284, align 8
  store ptr %287, ptr %Current.06.i196.i.i, align 8
  %288 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i196.i.i, ptr %288, align 8
  %cmp.i.not.i201.i.i = icmp eq ptr %Current.0.val.i197.i.i, null
  br i1 %cmp.i.not.i201.i.i, label %if.end49.i.i, label %while.body.i195.i.i
...
if.end49.i.i:                                     ; preds = %while.body.i195.i.i, %if.else46.i.i, %land.lhs.true36.i.i, %if.end34.i.i
  %Counter.4.i = phi i32 [ %Counter.3.i, %land.lhs.true36.i.i ], [ %Counter.3.i, %if.else46.i.i ], [ %Counter.2.i, %if.end34.i.i ], [ %Counter.3.i, %while.body.i195.i.i ]
  %GivenClause.3220.i.i = phi ptr [ %GivenClause.3219.i.i, %land.lhs.true36.i.i ], [ %GivenClause.3219.i.i, %if.else46.i.i ], [ %GivenClause.3.ph.i.i, %if.end34.i.i ], [ %GivenClause.3219.i.i, %while.body.i195.i.i ]
...
land.rhs.i.i:                                     ; preds = %if.end34.i545.i, %if.else232.i
  %Counter.5.i = phi i32 [ %Counter.1.i, %if.else232.i ], [ %Counter.6.i, %if.end34.i545.i ]
...
while.body.i536.i:                                ; preds = %land.rhs.i.i
  ...
  br i1 %cmp5.not.i.i, label %if.end.thread.i543.i, label %while.body.i.i537.i

while.body.i.i537.i:                              ; preds = %while.body.i536.i, %if.end.i.i540.i
  %List.addr.07.i.i538.i = phi ptr [ %List.addr.0.val5.i.i541.i, %if.end.i.i540.i ], [ %Search.val163.i.i, %while.body.i536.i ]
  %298 = getelementptr i8, ptr %List.addr.07.i.i538.i, i64 8
  %List.addr.0.val.i.i539.i = load ptr, ptr %298, align 8
  %cmp.i168.i.i = icmp eq ptr %List.addr.0.val.i.i539.i, %297
  br i1 %cmp.i168.i.i, label %if.end.i681.i, label %if.end.i.i540.i

if.end.i.i540.i:                                  ; preds = %while.body.i.i537.i
  %List.addr.0.val5.i.i541.i = load ptr, ptr %List.addr.07.i.i538.i, align 8
  %cmp.i.not.i.i542.i = icmp eq ptr %List.addr.0.val5.i.i541.i, null
  br i1 %cmp.i.not.i.i542.i, label %if.end.thread.i543.i, label %while.body.i.i537.i

if.end.thread.i543.i:                             ; preds = %if.end.i.i540.i, %while.body.i536.i
  store ptr null, ptr %SplitClause.i, align 8
  %Search.val166.i.i = load i32, ptr %splitcounter.i, align 8
  %cmp12.not.i544.i = icmp eq i32 %Search.val166.i.i, 0
  br i1 %cmp12.not.i544.i, label %if.then17.i.i, label %if.end15.i.i

if.end.i681.i:                                    ; preds = %while.body.i.i537.i
  store ptr null, ptr %SplitClause.i, align 8
  br label %if.end34.i545.i
...
if.end15.i.i:                                     ; preds = %if.end.thread.i543.i
  ...
  br i1 %cmp16.i.i974, label %if.then17.i.i, label %if.end34.i545.i

if.then17.i.i:                                    ; preds = %if.end15.i.i, %if.end.thread.i543.i
  %299 = load i32, ptr %arrayidx.i.i533.i, align 4
  %rem.i582.i = srem i32 %Counter.5.i, %299
  %cmp19.i.i = icmp eq i32 %rem.i582.i, 0
  br i1 %cmp19.i.i, label %if.then20.i.i, label %if.else.i583.i
...
if.then20.i.i:                                    ; preds = %if.then17.i.i
  ...
  %List.val.i.i639.i = load ptr, ptr %300, align 8
  %301 = getelementptr i8, ptr %List.val.i.i639.i, i64 8
  %call.val.i.i640.i = load i32, ptr %301, align 8
  %302 = getelementptr i8, ptr %List.val.i.i639.i, i64 4
  %call.val77.i.i641.i = load i32, ptr %302, align 4
  %call3.i.i642.i = call i32 @clause_NumberOfVarOccs(ptr noundef %List.val.i.i639.i) #14
  %List.addr.078.i.i643.i = load ptr, ptr %Search.val161.i.i, align 8
  %cmp.i.not79.i.i644.i = icmp eq ptr %List.addr.078.i.i643.i, null
  br i1 %cmp.i.not79.i.i644.i, label %if.end32.i606.i, label %while.body.i169.i.i

while.body.i169.i.i:                              ; preds = %if.then20.i.i, %if.end39.i.i661.i
  %List.addr.084.i.i645.i = phi ptr [ %List.addr.0.i.i666.i, %if.end39.i.i661.i ], [ %List.addr.078.i.i643.i, %if.then20.i.i ]
  %Depth.083.i.i646.i = phi i32 [ %Depth.1.i.i665.i, %if.end39.i.i661.i ], [ %call.val.i.i640.i, %if.then20.i.i ]
  %Weight.082.i.i647.i = phi i32 [ %Weight.1.i.i664.i, %if.end39.i.i661.i ], [ %call.val77.i.i641.i, %if.then20.i.i ]
  %Result.081.i.i648.i = phi ptr [ %Result.1.i.i663.i, %if.end39.i.i661.i ], [ %List.val.i.i639.i, %if.then20.i.i ]
  %Vars.080.i.i649.i = phi i32 [ %Vars.1.i.i662.i, %if.end39.i.i661.i ], [ %call3.i.i642.i, %if.then20.i.i ]
  %303 = getelementptr i8, ptr %List.addr.084.i.i645.i, i64 8
  %List.addr.0.val74.i.i650.i = load ptr, ptr %303, align 8
  %304 = getelementptr i8, ptr %List.addr.0.val74.i.i650.i, i64 8
  %call6.val.i.i651.i = load i32, ptr %304, align 8
  %cmp.not.i.i652.i = icmp ugt i32 %call6.val.i.i651.i, %Depth.083.i.i646.i
  br i1 %cmp.not.i.i652.i, label %if.end39.i.i661.i, label %if.then.i.i653.i

if.then.i.i653.i:                                 ; preds = %while.body.i169.i.i
  %cmp8.i.i654.i = icmp ult i32 %call6.val.i.i651.i, %Depth.083.i.i646.i
  %.phi.trans.insert.i.i655.i = getelementptr i8, ptr %List.addr.0.val74.i.i650.i, i64 4
  %call13.val.pre.i.i656.i = load i32, ptr %.phi.trans.insert.i.i655.i, align 4
  %cmp11.i.i657.i = icmp ult i32 %call13.val.pre.i.i656.i, %Weight.082.i.i647.i
  %or.cond.i.i658.i = select i1 %cmp8.i.i654.i, i1 true, i1 %cmp11.i.i657.i
  br i1 %or.cond.i.i658.i, label %if.then12.i.i679.i, label %if.else.i.i659.i

if.then12.i.i679.i:                               ; preds = %if.then.i.i653.i
  %call16.i.i680.i = call i32 @clause_NumberOfVarOccs(ptr noundef nonnull %List.addr.0.val74.i.i650.i) #14
  br label %if.end39.i.i661.i

if.else.i.i659.i:                                 ; preds = %if.then.i.i653.i
  %cmp19.i.i660.i = icmp eq i32 %call13.val.pre.i.i656.i, %Weight.082.i.i647.i
  br i1 %cmp19.i.i660.i, label %if.then20.i.i667.i, label %if.end39.i.i661.i

if.then20.i.i667.i:                               ; preds = %if.else.i.i659.i
  %call22.i.i668.i = call i32 @clause_NumberOfVarOccs(ptr noundef nonnull %List.addr.0.val74.i.i650.i) #14
  %305 = load i32, ptr %arrayidx.i79.i.i534.i, align 4
  %tobool24.not.i.i669.i = icmp eq i32 %305, 0
  br i1 %tobool24.not.i.i669.i, label %if.else30.i.i675.i, label %if.then25.i.i670.i

if.then25.i.i670.i:                               ; preds = %if.then20.i.i667.i
  %cmp26.i.i671.i = icmp ult i32 %Vars.080.i.i649.i, %call22.i.i668.i
  br i1 %cmp26.i.i671.i, label %if.then27.i.i672.i, label %if.end39.i.i661.i

if.then27.i.i672.i:                               ; preds = %if.then25.i.i670.i
  %List.addr.0.val68.i.i673.i = load ptr, ptr %303, align 8
  %306 = getelementptr i8, ptr %List.addr.0.val68.i.i673.i, i64 4
  %call28.val.i.i674.i = load i32, ptr %306, align 4
  br label %if.end39.i.i661.i

if.else30.i.i675.i:                               ; preds = %if.then20.i.i667.i
  %cmp31.i.i676.i = icmp ugt i32 %Vars.080.i.i649.i, %call22.i.i668.i
  br i1 %cmp31.i.i676.i, label %if.then32.i.i677.i, label %if.end39.i.i661.i

if.then32.i.i677.i:                               ; preds = %if.else30.i.i675.i
  %List.addr.0.val.i171.i.i = load ptr, ptr %303, align 8
  %307 = getelementptr i8, ptr %List.addr.0.val.i171.i.i, i64 4
  %call33.val.i.i678.i = load i32, ptr %307, align 4
  br label %if.end39.i.i661.i

if.end39.i.i661.i:                                ; preds = %if.then32.i.i677.i, %if.else30.i.i675.i, %if.then27.i.i672.i, %if.then25.i.i670.i, %if.else.i.i659.i, %if.then12.i.i679.i, %while.body.i169.i.i
  %Vars.1.i.i662.i = phi i32 [ %call16.i.i680.i, %if.then12.i.i679.i ], [ %call22.i.i668.i, %if.then27.i.i672.i ], [ %Vars.080.i.i649.i, %if.then25.i.i670.i ], [ %call22.i.i668.i, %if.then32.i.i677.i ], [ %Vars.080.i.i649.i, %if.else30.i.i675.i ], [ %Vars.080.i.i649.i, %if.else.i.i659.i ], [ %Vars.080.i.i649.i, %while.body.i169.i.i ]
  %Result.1.i.i663.i = phi ptr [ %List.addr.0.val74.i.i650.i, %if.then12.i.i679.i ], [ %List.addr.0.val68.i.i673.i, %if.then27.i.i672.i ], [ %Result.081.i.i648.i, %if.then25.i.i670.i ], [ %List.addr.0.val.i171.i.i, %if.then32.i.i677.i ], [ %Result.081.i.i648.i, %if.else30.i.i675.i ], [ %Result.081.i.i648.i, %if.else.i.i659.i ], [ %Result.081.i.i648.i, %while.body.i169.i.i ]
  %Weight.1.i.i664.i = phi i32 [ %call13.val.pre.i.i656.i, %if.then12.i.i679.i ], [ %call28.val.i.i674.i, %if.then27.i.i672.i ], [ %Weight.082.i.i647.i, %if.then25.i.i670.i ], [ %call33.val.i.i678.i, %if.then32.i.i677.i ], [ %Weight.082.i.i647.i, %if.else30.i.i675.i ], [ %Weight.082.i.i647.i, %if.else.i.i659.i ], [ %Weight.082.i.i647.i, %while.body.i169.i.i ]
  %Depth.1.i.i665.i = phi i32 [ %call6.val.i.i651.i, %if.then12.i.i679.i ], [ %call6.val.i.i651.i, %if.then27.i.i672.i ], [ %Depth.083.i.i646.i, %if.then25.i.i670.i ], [ %call6.val.i.i651.i, %if.then32.i.i677.i ], [ %Depth.083.i.i646.i, %if.else30.i.i675.i ], [ %Depth.083.i.i646.i, %if.else.i.i659.i ], [ %Depth.083.i.i646.i, %while.body.i169.i.i ]
  %List.addr.0.i.i666.i = load ptr, ptr %List.addr.084.i.i645.i, align 8
  %cmp.i.not.i170.i.i = icmp eq ptr %List.addr.0.i.i666.i, null
  br i1 %cmp.i.not.i170.i.i, label %if.end32.i606.i, label %while.body.i169.i.i

if.else.i583.i:                                   ; preds = %if.then17.i.i
  %308 = load i32, ptr %arrayidx.i172.i.i, align 4
  %cmp24.not.i584.i = icmp eq i32 %308, 1
  ...
  br i1 %cmp24.not.i584.i, label %if.else28.i619.i, label %if.then25.i585.i

if.then25.i585.i:                                 ; preds = %if.else.i583.i
  ...
  %tobool.not.i.i586.i = icmp eq i32 %312, 0
  br i1 %tobool.not.i.i586.i, label %if.end.i176.i.i, label %if.then.i175.i.i

if.then.i175.i.i:                                 ; preds = %if.then25.i585.i
  %div.i.i587.i = udiv i32 %call.val.i190.i.i, %308
  br label %if.end.i176.i.i

if.end.i176.i.i:                                  ; preds = %if.then.i175.i.i, %if.then25.i585.i
  %Weight.0.i.i588.i = phi i32 [ %div.i.i587.i, %if.then.i175.i.i ], [ %call.val.i190.i.i, %if.then25.i585.i ]
  %call5.i.i589.i = call i32 @clause_NumberOfVarOccs(ptr noundef nonnull %List.val.i189.i.i) #14
  %List.addr.080.i.i590.i = load ptr, ptr %Search.val159.i.i, align 8
  %cmp.i.not81.i.i591.i = icmp eq ptr %List.addr.080.i.i590.i, null
  br i1 %cmp.i.not81.i.i591.i, label %if.end32.i606.i, label %while.body.i178.i.i

while.body.i178.i.i:                              ; preds = %if.end.i176.i.i, %if.end39.i181.i.i
  %List.addr.085.i.i592.i = phi ptr [ %List.addr.0.i184.i.i, %if.end39.i181.i.i ], [ %List.addr.080.i.i590.i, %if.end.i176.i.i ]
  %Vars.084.i.i593.i = phi i32 [ %Vars.1.i183.i.i, %if.end39.i181.i.i ], [ %call5.i.i589.i, %if.end.i176.i.i ]
  %Result.083.i.i594.i = phi ptr [ %Result.1.i182.i.i, %if.end39.i181.i.i ], [ %List.val.i189.i.i, %if.end.i176.i.i ]
  %Weight.182.i.i595.i = phi i32 [ %Weight.2.i.i605.i, %if.end39.i181.i.i ], [ %Weight.0.i.i588.i, %if.end.i176.i.i ]
  %313 = getelementptr i8, ptr %List.addr.085.i.i592.i, i64 8
  %List.addr.0.val72.i.i596.i = load ptr, ptr %313, align 8
  %314 = getelementptr i8, ptr %List.addr.0.val72.i.i596.i, i64 4
  %call9.val.i.i597.i = load i32, ptr %314, align 4
  %315 = getelementptr i8, ptr %List.addr.0.val72.i.i596.i, i64 48
  %call11.val.i.i598.i = load i32, ptr %315, align 8
  %316 = and i32 %call11.val.i.i598.i, 8
  %tobool13.not.i.i599.i = icmp eq i32 %316, 0
  br i1 %tobool13.not.i.i599.i, label %if.end16.i.i602.i, label %if.then14.i.i600.i

if.then14.i.i600.i:                               ; preds = %while.body.i178.i.i
  %div15.i.i601.i = udiv i32 %call9.val.i.i597.i, %308
  br label %if.end16.i.i602.i

if.end16.i.i602.i:                                ; preds = %if.then14.i.i600.i, %while.body.i178.i.i
  %NewWeight.0.i.i603.i = phi i32 [ %div15.i.i601.i, %if.then14.i.i600.i ], [ %call9.val.i.i597.i, %while.body.i178.i.i ]
  %cmp.i179.i.i = icmp ult i32 %NewWeight.0.i.i603.i, %Weight.182.i.i595.i
  br i1 %cmp.i179.i.i, label %if.then17.i.i617.i, label %if.else.i180.i.i

if.then17.i.i617.i:                               ; preds = %if.end16.i.i602.i
  %call20.i.i618.i = call i32 @clause_NumberOfVarOccs(ptr noundef nonnull %List.addr.0.val72.i.i596.i) #14
  br label %if.end39.i181.i.i

if.else.i180.i.i:                                 ; preds = %if.end16.i.i602.i
  %cmp21.i.i604.i = icmp eq i32 %NewWeight.0.i.i603.i, %Weight.182.i.i595.i
  br i1 %cmp21.i.i604.i, label %if.then22.i.i608.i, label %if.end39.i181.i.i

if.then22.i.i608.i:                               ; preds = %if.else.i180.i.i
  %call24.i.i609.i = call i32 @clause_NumberOfVarOccs(ptr noundef nonnull %List.addr.0.val72.i.i596.i) #14
  %317 = load i32, ptr %arrayidx.i79.i.i534.i, align 4
  %tobool26.not.i.i610.i = icmp eq i32 %317, 0
  br i1 %tobool26.not.i.i610.i, label %if.else32.i.i614.i, label %if.then27.i187.i.i

if.then27.i187.i.i:                               ; preds = %if.then22.i.i608.i
  %cmp28.i.i611.i = icmp ult i32 %Vars.084.i.i593.i, %call24.i.i609.i
  br i1 %cmp28.i.i611.i, label %if.then29.i.i612.i, label %if.end39.i181.i.i

if.then29.i.i612.i:                               ; preds = %if.then27.i187.i.i
  %List.addr.0.val67.i.i613.i = load ptr, ptr %313, align 8
  br label %if.end39.i181.i.i

if.else32.i.i614.i:                               ; preds = %if.then22.i.i608.i
  %cmp33.i.i615.i = icmp ugt i32 %Vars.084.i.i593.i, %call24.i.i609.i
  br i1 %cmp33.i.i615.i, label %if.then34.i.i616.i, label %if.end39.i181.i.i

if.then34.i.i616.i:                               ; preds = %if.else32.i.i614.i
  %List.addr.0.val.i188.i.i = load ptr, ptr %313, align 8
  br label %if.end39.i181.i.i

if.end39.i181.i.i:                                ; preds = %if.then34.i.i616.i, %if.else32.i.i614.i, %if.then29.i.i612.i, %if.then27.i187.i.i, %if.else.i180.i.i, %if.then17.i.i617.i
  %Weight.2.i.i605.i = phi i32 [ %NewWeight.0.i.i603.i, %if.then17.i.i617.i ], [ %Weight.182.i.i595.i, %if.then29.i.i612.i ], [ %Weight.182.i.i595.i, %if.then27.i187.i.i ], [ %Weight.182.i.i595.i, %if.then34.i.i616.i ], [ %Weight.182.i.i595.i, %if.else32.i.i614.i ], [ %Weight.182.i.i595.i, %if.else.i180.i.i ]
  %Result.1.i182.i.i = phi ptr [ %List.addr.0.val72.i.i596.i, %if.then17.i.i617.i ], [ %List.addr.0.val67.i.i613.i, %if.then29.i.i612.i ], [ %Result.083.i.i594.i, %if.then27.i187.i.i ], [ %List.addr.0.val.i188.i.i, %if.then34.i.i616.i ], [ %Result.083.i.i594.i, %if.else32.i.i614.i ], [ %Result.083.i.i594.i, %if.else.i180.i.i ]
  %Vars.1.i183.i.i = phi i32 [ %call20.i.i618.i, %if.then17.i.i617.i ], [ %call24.i.i609.i, %if.then29.i.i612.i ], [ %Vars.084.i.i593.i, %if.then27.i187.i.i ], [ %call24.i.i609.i, %if.then34.i.i616.i ], [ %Vars.084.i.i593.i, %if.else32.i.i614.i ], [ %Vars.084.i.i593.i, %if.else.i180.i.i ]
  %List.addr.0.i184.i.i = load ptr, ptr %List.addr.085.i.i592.i, align 8
  %cmp.i.not.i185.i.i = icmp eq ptr %List.addr.0.i184.i.i, null
  br i1 %cmp.i.not.i185.i.i, label %if.end32.i606.i, label %while.body.i178.i.i

if.else28.i619.i:                                 ; preds = %if.else.i583.i
  %call2.i.i620.i = call i32 @clause_NumberOfVarOccs(ptr noundef nonnull %List.val.i189.i.i) #14
  %List.addr.049.i.i621.i = load ptr, ptr %Search.val159.i.i, align 8
  %cmp.i.not50.i.i622.i = icmp eq ptr %List.addr.049.i.i621.i, null
  br i1 %cmp.i.not50.i.i622.i, label %if.end32.i606.i, label %while.body.i193.i.i

while.body.i193.i.i:                              ; preds = %if.else28.i619.i, %if.end23.i.i633.i
  %List.addr.054.i.i623.i = phi ptr [ %List.addr.0.i200.i.i, %if.end23.i.i633.i ], [ %List.addr.049.i.i621.i, %if.else28.i619.i ]
  %Weight.053.i.i624.i = phi i32 [ %Weight.1.i199.i.i, %if.end23.i.i633.i ], [ %call.val.i190.i.i, %if.else28.i619.i ]
  %Vars.052.i.i625.i = phi i32 [ %Vars.1.i198.i.i, %if.end23.i.i633.i ], [ %call2.i.i620.i, %if.else28.i619.i ]
  %Result.051.i.i626.i = phi ptr [ %Result.1.i197.i.i, %if.end23.i.i633.i ], [ %List.val.i189.i.i, %if.else28.i619.i ]
  %318 = getelementptr i8, ptr %List.addr.054.i.i623.i, i64 8
  %List.addr.0.val46.i.i627.i = load ptr, ptr %318, align 8
  %319 = getelementptr i8, ptr %List.addr.0.val46.i.i627.i, i64 4
  %call5.val.i.i628.i = load i32, ptr %319, align 4
  %cmp.i194.i.i = icmp eq i32 %call5.val.i.i628.i, %Weight.053.i.i624.i
  br i1 %cmp.i194.i.i, label %if.then.i196.i.i, label %if.end32.i606.i

if.then.i196.i.i:                                 ; preds = %while.body.i193.i.i
  %call8.i.i629.i = call i32 @clause_NumberOfVarOccs(ptr noundef nonnull %List.addr.0.val46.i.i627.i) #14
  %320 = load i32, ptr %arrayidx.i79.i.i534.i, align 4
  %tobool10.not.i.i630.i = icmp eq i32 %320, 0
  br i1 %tobool10.not.i.i630.i, label %if.else.i202.i.i, label %if.then11.i.i631.i

if.then11.i.i631.i:                               ; preds = %if.then.i196.i.i
  %cmp12.i.i632.i = icmp ult i32 %Vars.052.i.i625.i, %call8.i.i629.i
  br i1 %cmp12.i.i632.i, label %if.end23.sink.split.i.i635.i, label %if.end23.i.i633.i

if.else.i202.i.i:                                 ; preds = %if.then.i196.i.i
  %cmp16.i.i638.i = icmp ugt i32 %Vars.052.i.i625.i, %call8.i.i629.i
  br i1 %cmp16.i.i638.i, label %if.end23.sink.split.i.i635.i, label %if.end23.i.i633.i

if.end23.sink.split.i.i635.i:                     ; preds = %if.else.i202.i.i, %if.then11.i.i631.i
  %List.addr.0.val44.sink.i.i636.i = load ptr, ptr %318, align 8
  %321 = getelementptr i8, ptr %List.addr.0.val44.sink.i.i636.i, i64 4
  %call14.val.i.i637.i = load i32, ptr %321, align 4
  br label %if.end23.i.i633.i

if.end23.i.i633.i:                                ; preds = %if.end23.sink.split.i.i635.i, %if.else.i202.i.i, %if.then11.i.i631.i
  %Result.1.i197.i.i = phi ptr [ %Result.051.i.i626.i, %if.then11.i.i631.i ], [ %Result.051.i.i626.i, %if.else.i202.i.i ], [ %List.addr.0.val44.sink.i.i636.i, %if.end23.sink.split.i.i635.i ]
  %Vars.1.i198.i.i = phi i32 [ %Vars.052.i.i625.i, %if.then11.i.i631.i ], [ %Vars.052.i.i625.i, %if.else.i202.i.i ], [ %call8.i.i629.i, %if.end23.sink.split.i.i635.i ]
  %Weight.1.i199.i.i = phi i32 [ %Weight.053.i.i624.i, %if.then11.i.i631.i ], [ %Weight.053.i.i624.i, %if.else.i202.i.i ], [ %call14.val.i.i637.i, %if.end23.sink.split.i.i635.i ]
  %List.addr.0.i200.i.i = load ptr, ptr %List.addr.054.i.i623.i, align 8
  %cmp.i.not.i201.i634.i = icmp eq ptr %List.addr.0.i200.i.i, null
  br i1 %cmp.i.not.i201.i634.i, label %if.end32.i606.i, label %while.body.i193.i.i

if.end32.i606.i:                                  ; preds = %if.end39.i181.i.i, %if.end23.i.i633.i, %while.body.i193.i.i, %if.end39.i.i661.i, %if.else28.i619.i, %if.end.i176.i.i, %if.then20.i.i
  %GivenClause.3.i.i = phi ptr [ %List.val.i.i639.i, %if.then20.i.i ], [ %List.val.i189.i.i, %if.end.i176.i.i ], [ %List.val.i189.i.i, %if.else28.i619.i ], [ %Result.1.i.i663.i, %if.end39.i.i661.i ], [ %Result.051.i.i626.i, %while.body.i193.i.i ], [ %Result.1.i197.i.i, %if.end23.i.i633.i ], [ %Result.1.i182.i.i, %if.end39.i181.i.i ]
  %inc.i607.i = add nsw i32 %Counter.5.i, 1
  br label %if.end34.i545.i

if.end34.i545.i:                                  ; preds = %if.end32.i606.i, %if.end15.i.i, %if.end.i681.i
  %Counter.6.i = phi i32 [ %inc.i607.i, %if.end32.i606.i ], [ %Counter.5.i, %if.end15.i.i ], [ %Counter.5.i, %if.end.i681.i ]
  %GivenClause.4.i.i = phi ptr [ %GivenClause.3.i.i, %if.end32.i606.i ], [ %call14.i.i, %if.end15.i.i ], [ %297, %if.end.i681.i ]
  ...
  call void @clock_StopAddPassedTime(i32 noundef 4) #14
  %cmp.i546.i = icmp eq ptr %call35.i.i, null
  br i1 %cmp.i546.i, label %land.rhs.i.i, label %if.end39.i.i

if.end39.i.i:                                     ; preds = %if.end34.i545.i
...
clause_IsEmptyClause.exit.i.i:                    ; preds = %land.lhs.true1.i.i.i
  ...
  br i1 %cmp.i13.i.not.i.i, label %if.then42.i579.i, label %if.else44.i.i

if.then42.i579.i:                                 ; preds = %clause_IsEmptyClause.exit.i.i
  %call.i.i.i580.i = call ptr @memory_Malloc(i32 noundef 16) #14
  %car.i.i.i581.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i.i580.i, i64 0, i32 1
  store ptr %call35.i.i, ptr %car.i.i.i581.i, align 8
  store ptr null, ptr %call.i.i.i580.i, align 8
...
if.else44.i.i:                                    ; preds = %clause_IsEmptyClause.exit.i.i, %land.lhs.true1.i.i.i, %if.end39.i.i
  call void @clock_StartCounter(i32 noundef 4) #14
  %call45.i547.i = call ptr @red_BackReduction(ptr noundef %call2, ptr noundef nonnull %call35.i.i, i32 noundef %126) #14
  call void @clock_StopAddPassedTime(i32 noundef 4) #14
...
if.then55.i.i:                                    ; preds = %if.end52.i.i
  %call.i.i548.i = call fastcc ptr @top_GetLiteralsForSplitting(ptr noundef nonnull %call35.i.i)
  %cmp.i.not13.i.i549.i = icmp eq ptr %call.i.i548.i, null
  br i1 %cmp.i.not13.i.i549.i, label %if.else62.i.i, label %for.body.lr.ph.i.i550.i

for.body.lr.ph.i.i550.i:                          ; preds = %if.then55.i.i
  %329 = getelementptr i8, ptr %call35.i.i, i64 56
  br label %for.body.i.i551.i

for.body.i.i551.i:                                ; preds = %for.inc.i.i560.i, %for.body.lr.ph.i.i550.i
  %Result.016.i.i552.i = phi i32 [ -1, %for.body.lr.ph.i.i550.i ], [ %Result.1.i208.i.i, %for.inc.i.i560.i ]
  %MaxInstances.015.i.i553.i = phi i32 [ -1, %for.body.lr.ph.i.i550.i ], [ %MaxInstances.1.i.i561.i, %for.inc.i.i560.i ]
  %SplitLits.014.i.i554.i = phi ptr [ %call.i.i548.i, %for.body.lr.ph.i.i550.i ], [ %L.val.i.i.i562.i, %for.inc.i.i560.i ]
  %330 = getelementptr i8, ptr %SplitLits.014.i.i554.i, i64 8
  %SplitLits.0.val12.i.i555.i = load ptr, ptr %330, align 8
  %331 = ptrtoint ptr %SplitLits.0.val12.i.i555.i to i64
  %Clause.val.i.i556.i = load ptr, ptr %329, align 8
  %sext.i.i557.i = shl i64 %331, 32
  %idxprom.i.i.i558.i = ashr exact i64 %sext.i.i557.i, 32
  %arrayidx.i.i206.i.i = getelementptr inbounds ptr, ptr %Clause.val.i.i556.i, i64 %idxprom.i.i.i558.i
  %332 = load ptr, ptr %arrayidx.i.i206.i.i, align 8
  %call4.i.i559.i = call i32 @prfs_GetNumberOfInstances(ptr noundef %call2, ptr noundef %332, i32 noundef 0) #14
  %cmp.i207.i.i = icmp ugt i32 %call4.i.i559.i, %MaxInstances.015.i.i553.i
  br i1 %cmp.i207.i.i, label %if.then.i211.i.i, label %for.inc.i.i560.i

if.then.i211.i.i:                                 ; preds = %for.body.i.i551.i
  %SplitLits.0.val.i.i578.i = load ptr, ptr %330, align 8
  %333 = ptrtoint ptr %SplitLits.0.val.i.i578.i to i64
  %334 = trunc i64 %333 to i32
  br label %for.inc.i.i560.i

for.inc.i.i560.i:                                 ; preds = %if.then.i211.i.i, %for.body.i.i551.i
  %MaxInstances.1.i.i561.i = phi i32 [ %call4.i.i559.i, %if.then.i211.i.i ], [ %MaxInstances.015.i.i553.i, %for.body.i.i551.i ]
  %Result.1.i208.i.i = phi i32 [ %334, %if.then.i211.i.i ], [ %Result.016.i.i552.i, %for.body.i.i551.i ]
  %L.val.i.i.i562.i = load ptr, ptr %SplitLits.014.i.i554.i, align 8
  %335 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i.i563.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %335, i64 0, i32 4
  %336 = load i32, ptr %total_size.i.i.i.i.i563.i, align 8
  %conv26.i.i.i.i.i564.i = sext i32 %336 to i64
  %337 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i.i565.i = add i64 %337, %conv26.i.i.i.i.i564.i
  store i64 %add27.i.i.i.i.i565.i, ptr @memory_FREEDBYTES, align 8
  %338 = load ptr, ptr %335, align 8
  store ptr %338, ptr %SplitLits.014.i.i554.i, align 8
  %339 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %SplitLits.014.i.i554.i, ptr %339, align 8
  %cmp.i.not.i209.i.i = icmp eq ptr %L.val.i.i.i562.i, null
  br i1 %cmp.i.not.i209.i.i, label %top_GetOptimalSplitLiteralIndex.exit.i566.i, label %for.body.i.i551.i

top_GetOptimalSplitLiteralIndex.exit.i566.i:      ; preds = %for.inc.i.i560.i
  %cmp57.i.i = icmp sgt i32 %Result.1.i208.i.i, -1
  br i1 %cmp57.i.i, label %if.then58.i.i, label %if.else62.i.i

if.then58.i.i:                                    ; preds = %top_GetOptimalSplitLiteralIndex.exit.i566.i
  %GivenClause.0.val.i.i = load ptr, ptr %329, align 8
  %idxprom.i.i571.i = zext i32 %Result.1.i208.i.i to i64
  %arrayidx.i212.i.i = getelementptr inbounds ptr, ptr %GivenClause.0.val.i.i, i64 %idxprom.i.i571.i
...
while.body.i215.i.i:                              ; preds = %while.body.i215.i.i, %if.then58.i.i
  %Current.06.i.i572.i = phi ptr [ %Current.0.val.i.i573.i, %while.body.i215.i.i ], [ %call.i.i213.i.i, %if.then58.i.i ]
  %Current.0.val.i.i573.i = load ptr, ptr %Current.06.i.i572.i, align 8
  %341 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i574.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %341, i64 0, i32 4
  %342 = load i32, ptr %total_size.i.i.i.i574.i, align 8
  %conv26.i.i.i.i575.i = sext i32 %342 to i64
  %343 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i576.i = add i64 %343, %conv26.i.i.i.i575.i
  store i64 %add27.i.i.i.i576.i, ptr @memory_FREEDBYTES, align 8
  %344 = load ptr, ptr %341, align 8
  store ptr %344, ptr %Current.06.i.i572.i, align 8
  %345 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i572.i, ptr %345, align 8
  %cmp.i.not.i216.i.i = icmp eq ptr %Current.0.val.i.i573.i, null
  br i1 %cmp.i.not.i216.i.i, label %if.end65thread-pre-split.i.i, label %while.body.i215.i.i

if.else62.i.i:                                    ; preds = %top_GetOptimalSplitLiteralIndex.exit.i566.i, %if.then55.i.i
...
if.end65thread-pre-split.i.i:                     ; preds = %while.body.i215.i.i, %if.end52.i.i
  %.pr.i577.i = load ptr, ptr %SplitClause.i, align 8
  br label %if.end65.i.i

if.end65.i.i:                                     ; preds = %if.end65thread-pre-split.i.i, %if.else62.i.i
  %346 = phi ptr [ %.pr.i577.i, %if.end65thread-pre-split.i.i ], [ %call63.i.i, %if.else62.i.i ]
...
if.then67.i.i:                                    ; preds = %if.end65.i.i
  ...
  store ptr %call45.i547.i, ptr %call.i217.i.i, align 8
...
if.end81.i.i:                                     ; preds = %if.then72.i.i
  ...
  store ptr %call45.i547.i, ptr %call.i220.i.i, align 8
...
if.then83.i.i:                                    ; preds = %if.then72.i.i, %if.else69.i.i
  ...
  %cmp.i.not.i222.i.i = icmp eq ptr %call45.i547.i, null
...
for.cond.i.i.i:                                   ; preds = %if.end.i223.i.i, %for.cond.i.i.i
  %List1.addr.0.i.i.i = phi ptr [ %List1.addr.0.val17.i.i.i, %for.cond.i.i.i ], [ %call45.i547.i, %if.end.i223.i.i ]
...
list_Nconc.exit.i.i:                              ; preds = %for.end.i.i.i, %if.end.i223.i.i, %if.then83.i.i
  %retval.0.i224.i.i = phi ptr [ %call45.i547.i, %for.end.i.i.i ], [ %call84.i.i, %if.then83.i.i ], [ %call45.i547.i, %if.end.i223.i.i ]
  call void @clock_StopAddPassedTime(i32 noundef 5) #14
  br label %if.end87.i.i

if.end87.i.i:                                     ; preds = %list_Nconc.exit.i.i, %if.end81.i.i, %if.then67.i.i
  %Derivables.1.i567.i = phi ptr [ %call.i217.i.i, %if.then67.i.i ], [ %retval.0.i224.i.i, %list_Nconc.exit.i.i ], [ %call.i220.i.i, %if.end81.i.i ]
  %call88.i.i = call i32 @list_Length(ptr noundef %Derivables.1.i567.i) #14
  %348 = load i32, ptr %derivedclauses.i.i.i, align 8
  %add.i.i569.i = add nsw i32 %348, %call88.i.i
  store i32 %add.i.i569.i, ptr %derivedclauses.i.i.i, align 8
  br label %top_LazyReductionSelectGivenComputeDerivables.exit.i

top_LazyReductionSelectGivenComputeDerivables.exit.i: ; preds = %land.rhs.i.i, %if.end87.i.i, %if.then42.i579.i
  %Counter.7.i = phi i32 [ %Counter.6.i, %if.then42.i579.i ], [ %Counter.6.i, %if.end87.i.i ], [ %Counter.5.i, %land.rhs.i.i ]
  %retval.0.i570.i = phi ptr [ %call.i.i.i580.i, %if.then42.i579.i ], [ %Derivables.1.i567.i, %if.end87.i.i ], [ null, %land.rhs.i.i ]
...
if.end235.i:                                      ; preds = %top_LazyReductionSelectGivenComputeDerivables.exit.i, %top_FullReductionSelectGivenComputeDerivables.exit.i, %if.end225.i
  ...
  %Derivables.1.i = phi ptr [ %Derivables.0.i, %if.end225.i ], [ %retval.0.i570.i, %top_LazyReductionSelectGivenComputeDerivables.exit.i ], [ %Derivables.1.i.i, %top_FullReductionSelectGivenComputeDerivables.exit.i ]
...
for.body243.i:                                    ; preds = %if.end235.i, %for.body243.i
  ...
  br i1 %cmp.i683.not.i, label %if.end249.i, label %for.body243.i
...
if.then253.i:                                     ; preds = %if.end249.i
  ...
  br i1 %cmp.i.not.i696.i, label %if.end259.i, label %if.end.i687.i

if.end.i687.i:                                    ; preds = %if.then253.i
  %cmp.i18.not.i688.i = icmp eq ptr %call254.i, null
  br i1 %cmp.i18.not.i688.i, label %if.end259.i, label %for.cond.i689.i

for.cond.i689.i:                                  ; preds = %if.end.i687.i, %for.cond.i689.i
  %List1.addr.0.i690.i = phi ptr [ %List1.addr.0.val17.i691.i, %for.cond.i689.i ], [ %354, %if.end.i687.i ]
  %List1.addr.0.val17.i691.i = load ptr, ptr %List1.addr.0.i690.i, align 8
  %cmp.i20.not.i692.i = icmp eq ptr %List1.addr.0.val17.i691.i, null
  br i1 %cmp.i20.not.i692.i, label %for.end.i693.i, label %for.cond.i689.i

for.end.i693.i:                                   ; preds = %for.cond.i689.i
  store ptr %call254.i, ptr %List1.addr.0.i690.i, align 8
...
if.else256.i:                                     ; preds = %if.end249.i
  ...
  br i1 %cmp.i.not.i696.i, label %if.end259.i, label %if.end.i697.i

if.end.i697.i:                                    ; preds = %if.else256.i
  %cmp.i18.not.i698.i = icmp eq ptr %call257.i, null
  br i1 %cmp.i18.not.i698.i, label %if.end259.i, label %for.cond.i699.i

for.cond.i699.i:                                  ; preds = %if.end.i697.i, %for.cond.i699.i
  %List1.addr.0.i700.i = phi ptr [ %List1.addr.0.val17.i701.i, %for.cond.i699.i ], [ %354, %if.end.i697.i ]
  %List1.addr.0.val17.i701.i = load ptr, ptr %List1.addr.0.i700.i, align 8
  %cmp.i20.not.i702.i = icmp eq ptr %List1.addr.0.val17.i701.i, null
  br i1 %cmp.i20.not.i702.i, label %for.end.i703.i, label %for.cond.i699.i

for.end.i703.i:                                   ; preds = %for.cond.i699.i
  store ptr %call257.i, ptr %List1.addr.0.i700.i, align 8
  br label %if.end259.i

if.end259.i:                                      ; preds = %for.end.i703.i, %if.end.i697.i, %if.else256.i, %for.end.i693.i, %if.end.i687.i, %if.then253.i
  %storemerge.i = phi ptr [ %354, %for.end.i693.i ], [ %call254.i, %if.then253.i ], [ %354, %if.end.i687.i ], [ %354, %for.end.i703.i ], [ %call257.i, %if.else256.i ], [ %354, %if.end.i697.i ]
...
while.end.i:                                      ; preds = %lor.rhs181.i, %land.lhs.true170.i, %land.lhs.true166.i, %lor.lhs.false163.i
  br i1 %or.cond.i, label %if.then275.i, label %while.cond.i
...
land.lhs.true267:                                 ; preds = %land.lhs.true263
  ...
  %or.cond1274 = select i1 %cmp268, i1 %cmp.i978.not, i1 false
  br i1 %or.cond1274, label %if.end281, label %if.then274
...
if.end281:                                        ; preds = %land.lhs.true267, %if.then274, %land.lhs.true263, %lor.lhs.false257
  ...
  %cmp335 = phi i1 [ false, %land.lhs.true263 ], [ false, %lor.lhs.false257 ], [ %not.cmp.i980, %if.then274 ], [ false, %land.lhs.true267 ]
...
if.end343:                                        ; preds = %if.else340, %if.then337
  ...
  br i1 %cmp335, label %if.then363, label %if.else366
...
if.then376:                                       ; preds = %if.end370
  br i1 %cmp335, label %if.then379, label %if.else382
...
for.cond.i997:                                    ; preds = %for.body.i1001, %if.then397
  %Scan.0.in.i998 = phi ptr [ %arrayidx.i996, %if.then397 ], [ %Scan.0.i999, %for.body.i1001 ]
  %Scan.0.i999 = load ptr, ptr %Scan.0.in.i998, align 8
  %cmp.i.not.i1000 = icmp eq ptr %Scan.0.i999, null
  br i1 %cmp.i.not.i1000, label %hsh_Get.exit1008, label %for.body.i1001

for.body.i1001:                                   ; preds = %for.cond.i997
  %397 = getelementptr i8, ptr %Scan.0.i999, i64 8
  %Scan.0.val.i1002 = load ptr, ptr %397, align 8
  %398 = getelementptr i8, ptr %Scan.0.val.i1002, i64 8
  %call2.val12.i1003 = load ptr, ptr %398, align 8
  %cmp.i1004 = icmp eq ptr %call2.val12.i1003, %Scan.9.val721
  br i1 %cmp.i1004, label %if.then.i1005, label %for.cond.i997

if.then.i1005:                                    ; preds = %for.body.i1001
  %call2.val.i1006 = load ptr, ptr %Scan.0.val.i1002, align 8
  br label %hsh_Get.exit1008

hsh_Get.exit1008:                                 ; preds = %for.cond.i997, %if.then.i1005
  %retval.0.i1007 = phi ptr [ %call2.val.i1006, %if.then.i1005 ], [ null, %for.cond.i997 ]
  ...
  br i1 %cmp.i.not.i1010, label %for.inc405, label %if.end.i1011

if.end.i1011:                                     ; preds = %hsh_Get.exit1008
  %cmp.i18.not.i1012 = icmp eq ptr %call.i1009, null
  br i1 %cmp.i18.not.i1012, label %for.inc405, label %for.cond.i1013

for.cond.i1013:                                   ; preds = %if.end.i1011, %for.cond.i1013
  %List1.addr.0.i1014 = phi ptr [ %List1.addr.0.val17.i1015, %for.cond.i1013 ], [ %UsedTerms.01220, %if.end.i1011 ]
  %List1.addr.0.val17.i1015 = load ptr, ptr %List1.addr.0.i1014, align 8
  %cmp.i20.not.i1016 = icmp eq ptr %List1.addr.0.val17.i1015, null
  br i1 %cmp.i20.not.i1016, label %for.end.i1017, label %for.cond.i1013

for.end.i1017:                                    ; preds = %for.cond.i1013
  store ptr %call.i1009, ptr %List1.addr.0.i1014, align 8
  br label %for.inc405

for.inc405:                                       ; preds = %for.end.i1017, %if.end.i1011, %hsh_Get.exit1008, %for.body393
  %UsedTerms.1 = phi ptr [ %UsedTerms.01220, %for.body393 ], [ %UsedTerms.01220, %for.end.i1017 ], [ %call.i1009, %hsh_Get.exit1008 ], [ %UsedTerms.01220, %if.end.i1011 ]
  %Scan.9.val731 = load ptr, ptr %Scan.91219, align 8
  %cmp.i991.not = icmp eq ptr %Scan.9.val731, null
  br i1 %cmp.i991.not, label %for.end407, label %for.body393

for.end407:                                       ; preds = %for.inc405
  br i1 %cmp.i991.not1218, label %list_Delete.exit1029, label %while.body.i1021

while.body.i1021:                                 ; preds = %for.end407, %while.body.i1021
  %Current.06.i1022 = phi ptr [ %Current.0.val.i1023, %while.body.i1021 ], [ %call387, %for.end407 ]
  %Current.0.val.i1023 = load ptr, ptr %Current.06.i1022, align 8
  %399 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i1024 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %399, i64 0, i32 4
  %400 = load i32, ptr %total_size.i.i.i1024, align 8
  %conv26.i.i.i1025 = sext i32 %400 to i64
  %401 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i1026 = add i64 %401, %conv26.i.i.i1025
  store i64 %add27.i.i.i1026, ptr @memory_FREEDBYTES, align 8
  %402 = load ptr, ptr %399, align 8
  store ptr %402, ptr %Current.06.i1022, align 8
  %403 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i1022, ptr %403, align 8
  %cmp.i.not.i1027 = icmp eq ptr %Current.0.val.i1023, null
  br i1 %cmp.i.not.i1027, label %list_Delete.exit1029, label %while.body.i1021

list_Delete.exit1029:                             ; preds = %while.body.i1021, %if.end385, %for.end407
  %UsedTerms.0.lcssa1261 = phi ptr [ %UsedTerms.1, %for.end407 ], [ null, %if.end385 ], [ %UsedTerms.1, %while.body.i1021 ]
  %call.i1030 = call ptr @list_DeleteDuplicates(ptr noundef %UsedTerms.0.lcssa1261, ptr noundef nonnull @cnf_LabelEqual) #14
...
for.end425.thread:                                ; preds = %list_Delete.exit1029
  ...
  %call.i10331262 = call i32 @putc(i32 noundef 10, ptr noundef %406)
  br label %if.end429
...
for.inc423:                                       ; preds = %for.body414, %if.then419
  ...
  br i1 %cmp.i1031.not, label %for.end425, label %for.body414

for.end425:                                       ; preds = %for.inc423
  %408 = load ptr, ptr @stdout, align 8
  %call.i1033 = call i32 @putc(i32 noundef 10, ptr noundef %408)
  br i1 %cmp.i1031.not1222, label %if.end429, label %while.body.i1035

while.body.i1035:                                 ; preds = %for.end425, %while.body.i1035
  %Current.06.i1036 = phi ptr [ %Current.0.val.i1037, %while.body.i1035 ], [ %call.i1030, %for.end425 ]
  %Current.0.val.i1037 = load ptr, ptr %Current.06.i1036, align 8
  %409 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i1038 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %409, i64 0, i32 4
  %410 = load i32, ptr %total_size.i.i.i1038, align 8
  %conv26.i.i.i1039 = sext i32 %410 to i64
  %411 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i1040 = add i64 %411, %conv26.i.i.i1039
  store i64 %add27.i.i.i1040, ptr @memory_FREEDBYTES, align 8
  %412 = load ptr, ptr %409, align 8
  store ptr %412, ptr %Current.06.i1036, align 8
  %413 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i1036, ptr %413, align 8
  %cmp.i.not.i1041 = icmp eq ptr %Current.0.val.i1037, null
  br i1 %cmp.i.not.i1041, label %if.end429, label %while.body.i1035

if.end429:                                        ; preds = %while.body.i1035, %for.end425.thread, %for.end425, %if.end370, %if.then379, %if.end281
...
for.cond.i1048:                                   ; preds = %for.body.i1052, %for.body434
  %Scan.0.in.i1049 = phi ptr [ %arrayidx.i1047, %for.body434 ], [ %Scan.0.i1050, %for.body.i1052 ]
  %Scan.0.i1050 = load ptr, ptr %Scan.0.in.i1049, align 8
  %cmp.i.not.i1051 = icmp eq ptr %Scan.0.i1050, null
  br i1 %cmp.i.not.i1051, label %hsh_DelItem.exit, label %for.body.i1052

for.body.i1052:                                   ; preds = %for.cond.i1048
  %416 = getelementptr i8, ptr %Scan.0.i1050, i64 8
  %Scan.0.val.i1053 = load ptr, ptr %416, align 8
  %417 = getelementptr i8, ptr %Scan.0.val.i1053, i64 8
  %call2.val22.i = load ptr, ptr %417, align 8
  %cmp.i1054 = icmp eq ptr %call2.val22.i, %Scan.11.val
  br i1 %cmp.i1054, label %if.then.i1055, label %for.cond.i1048

if.then.i1055:                                    ; preds = %for.body.i1052
  %call2.val.i1056 = load ptr, ptr %Scan.0.val.i1053, align 8
  %cmp.i.not5.i.i = icmp eq ptr %call2.val.i1056, null
  br i1 %cmp.i.not5.i.i, label %list_Delete.exit.i, label %while.body.i.i1057

while.body.i.i1057:                               ; preds = %if.then.i1055, %while.body.i.i1057
  %Current.06.i.i1058 = phi ptr [ %Current.0.val.i.i1059, %while.body.i.i1057 ], [ %call2.val.i1056, %if.then.i1055 ]
  %Current.0.val.i.i1059 = load ptr, ptr %Current.06.i.i1058, align 8
  %418 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i1060 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %418, i64 0, i32 4
  %419 = load i32, ptr %total_size.i.i.i.i1060, align 8
  %conv26.i.i.i.i1061 = sext i32 %419 to i64
  %420 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i1062 = add i64 %420, %conv26.i.i.i.i1061
  store i64 %add27.i.i.i.i1062, ptr @memory_FREEDBYTES, align 8
  %421 = load ptr, ptr %418, align 8
  store ptr %421, ptr %Current.06.i.i1058, align 8
  %422 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i1058, ptr %422, align 8
  %cmp.i.not.i.i1063 = icmp eq ptr %Current.0.val.i.i1059, null
  br i1 %cmp.i.not.i.i1063, label %list_Delete.exit.i, label %while.body.i.i1057

list_Delete.exit.i:                               ; preds = %while.body.i.i1057, %if.then.i1055
  ...
  store ptr %426, ptr %Scan.0.val.i1053, align 8
  %427 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Scan.0.val.i1053, ptr %427, align 8
  %428 = load ptr, ptr %arrayidx.i1047, align 8
  %call6.i1064 = call ptr @list_PointerDeleteElement(ptr noundef %428, ptr noundef nonnull %Scan.0.val.i1053) #14
...
hsh_DelItem.exit:                                 ; preds = %for.cond.i1048, %list_Delete.exit.i
  ...
  br i1 %cmp.i1044.not, label %for.end438, label %for.body434

for.end438:                                       ; preds = %hsh_DelItem.exit, %if.end429
  br i1 %cmp.i.not718.i, label %list_Delete.exit1074, label %while.body.i1066

while.body.i1066:                                 ; preds = %for.end438, %while.body.i1066
  %Current.06.i1067 = phi ptr [ %Current.0.val.i1068, %while.body.i1066 ], [ %ProblemClauses.0, %for.end438 ]
  %Current.0.val.i1068 = load ptr, ptr %Current.06.i1067, align 8
  %429 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i1069 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %429, i64 0, i32 4
  %430 = load i32, ptr %total_size.i.i.i1069, align 8
  %conv26.i.i.i1070 = sext i32 %430 to i64
  %431 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i1071 = add i64 %431, %conv26.i.i.i1070
  store i64 %add27.i.i.i1071, ptr @memory_FREEDBYTES, align 8
  %432 = load ptr, ptr %429, align 8
  store ptr %432, ptr %Current.06.i1067, align 8
  %433 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i1067, ptr %433, align 8
  %cmp.i.not.i1072 = icmp eq ptr %Current.0.val.i1068, null
  br i1 %cmp.i.not.i1072, label %list_Delete.exit1074, label %while.body.i1066

list_Delete.exit1074:                             ; preds = %while.body.i1066, %for.end438
  ...
  br i1 %diff.check1296, label %for.body.i1075, label %vector.body1301

vector.body1301:                                  ; preds = %list_Delete.exit1074, %vector.body1301
  %index1302 = phi i64 [ %index.next1305.3, %vector.body1301 ], [ 0, %list_Delete.exit1074 ]
  %435 = getelementptr inbounds i32, ptr %call.i, i64 %index1302
  %wide.load1303 = load <4 x i32>, ptr %435, align 4
  %436 = getelementptr inbounds i32, ptr %435, i64 4
  %wide.load1304 = load <4 x i32>, ptr %436, align 4
  %437 = getelementptr inbounds i32, ptr %call2.val719, i64 %index1302
  store <4 x i32> %wide.load1303, ptr %437, align 4
  %438 = getelementptr inbounds i32, ptr %437, i64 4
  store <4 x i32> %wide.load1304, ptr %438, align 4
  %index.next1305 = or i64 %index1302, 8
  %439 = getelementptr inbounds i32, ptr %call.i, i64 %index.next1305
  %wide.load1303.1 = load <4 x i32>, ptr %439, align 4
  %440 = getelementptr inbounds i32, ptr %439, i64 4
  %wide.load1304.1 = load <4 x i32>, ptr %440, align 4
  %441 = getelementptr inbounds i32, ptr %call2.val719, i64 %index.next1305
  store <4 x i32> %wide.load1303.1, ptr %441, align 4
  %442 = getelementptr inbounds i32, ptr %441, i64 4
  store <4 x i32> %wide.load1304.1, ptr %442, align 4
  %index.next1305.1 = or i64 %index1302, 16
  %443 = getelementptr inbounds i32, ptr %call.i, i64 %index.next1305.1
  %wide.load1303.2 = load <4 x i32>, ptr %443, align 4
  %444 = getelementptr inbounds i32, ptr %443, i64 4
  %wide.load1304.2 = load <4 x i32>, ptr %444, align 4
  %445 = getelementptr inbounds i32, ptr %call2.val719, i64 %index.next1305.1
  store <4 x i32> %wide.load1303.2, ptr %445, align 4
  %446 = getelementptr inbounds i32, ptr %445, i64 4
  store <4 x i32> %wide.load1304.2, ptr %446, align 4
  %index.next1305.2 = or i64 %index1302, 24
  %447 = getelementptr inbounds i32, ptr %call.i, i64 %index.next1305.2
  %wide.load1303.3 = load <4 x i32>, ptr %447, align 4
  %448 = getelementptr inbounds i32, ptr %447, i64 4
  %wide.load1304.3 = load <4 x i32>, ptr %448, align 4
  %449 = getelementptr inbounds i32, ptr %call2.val719, i64 %index.next1305.2
  store <4 x i32> %wide.load1303.3, ptr %449, align 4
  %450 = getelementptr inbounds i32, ptr %449, i64 4
  store <4 x i32> %wide.load1304.3, ptr %450, align 4
  %index.next1305.3 = add nuw nsw i64 %index1302, 32
  %451 = icmp eq i64 %index.next1305.3, 4000
  br i1 %451, label %symbol_TransferPrecedence.exit1082, label %vector.body1301

for.body.i1075:                                   ; preds = %list_Delete.exit1074, %for.body.i1075
  %indvars.iv.i1076 = phi i64 [ %indvars.iv.next.i1079.4, %for.body.i1075 ], [ 0, %list_Delete.exit1074 ]
  %arrayidx.i1077 = getelementptr inbounds i32, ptr %call.i, i64 %indvars.iv.i1076
  %452 = load i32, ptr %arrayidx.i1077, align 4
  %arrayidx2.i1078 = getelementptr inbounds i32, ptr %call2.val719, i64 %indvars.iv.i1076
  store i32 %452, ptr %arrayidx2.i1078, align 4
  %indvars.iv.next.i1079 = add nuw nsw i64 %indvars.iv.i1076, 1
  %arrayidx.i1077.1 = getelementptr inbounds i32, ptr %call.i, i64 %indvars.iv.next.i1079
  %453 = load i32, ptr %arrayidx.i1077.1, align 4
  %arrayidx2.i1078.1 = getelementptr inbounds i32, ptr %call2.val719, i64 %indvars.iv.next.i1079
  store i32 %453, ptr %arrayidx2.i1078.1, align 4
  %indvars.iv.next.i1079.1 = add nuw nsw i64 %indvars.iv.i1076, 2
  %arrayidx.i1077.2 = getelementptr inbounds i32, ptr %call.i, i64 %indvars.iv.next.i1079.1
  %454 = load i32, ptr %arrayidx.i1077.2, align 4
  %arrayidx2.i1078.2 = getelementptr inbounds i32, ptr %call2.val719, i64 %indvars.iv.next.i1079.1
  store i32 %454, ptr %arrayidx2.i1078.2, align 4
  %indvars.iv.next.i1079.2 = add nuw nsw i64 %indvars.iv.i1076, 3
  %arrayidx.i1077.3 = getelementptr inbounds i32, ptr %call.i, i64 %indvars.iv.next.i1079.2
  %455 = load i32, ptr %arrayidx.i1077.3, align 4
  %arrayidx2.i1078.3 = getelementptr inbounds i32, ptr %call2.val719, i64 %indvars.iv.next.i1079.2
  store i32 %455, ptr %arrayidx2.i1078.3, align 4
  %indvars.iv.next.i1079.3 = add nuw nsw i64 %indvars.iv.i1076, 4
  %arrayidx.i1077.4 = getelementptr inbounds i32, ptr %call.i, i64 %indvars.iv.next.i1079.3
  %456 = load i32, ptr %arrayidx.i1077.4, align 4
  %arrayidx2.i1078.4 = getelementptr inbounds i32, ptr %call2.val719, i64 %indvars.iv.next.i1079.3
  store i32 %456, ptr %arrayidx2.i1078.4, align 4
  %indvars.iv.next.i1079.4 = add nuw nsw i64 %indvars.iv.i1076, 5
  %exitcond.not.i1080.4 = icmp eq i64 %indvars.iv.next.i1079.4, 4000
  br i1 %exitcond.not.i1080.4, label %symbol_TransferPrecedence.exit1082, label %for.body.i1075

symbol_TransferPrecedence.exit1082:               ; preds = %vector.body1301, %for.body.i1075
...
land.rhs:                                         ; preds = %do.cond
  ...
  br i1 %cmp451.not, label %do.end, label %if.then185.critedge
...
for.body457:                                      ; preds = %do.end, %for.body457
  ...
  br i1 %cmp.i1086.not, label %for.end461, label %for.body457
...
if.then467:                                       ; preds = %if.then464
  ...
  br i1 %cmp.i.not5.i1091, label %if.end469, label %while.body.i1092

while.body.i1092:                                 ; preds = %if.then467, %while.body.i1092
  %Current.06.i1093 = phi ptr [ %Current.0.val.i1094, %while.body.i1092 ], [ %465, %if.then467 ]
  %Current.0.val.i1094 = load ptr, ptr %Current.06.i1093, align 8
  %466 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i1095 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %466, i64 0, i32 4
  %467 = load i32, ptr %total_size.i.i.i1095, align 8
  %conv26.i.i.i1096 = sext i32 %467 to i64
  %468 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i1097 = add i64 %468, %conv26.i.i.i1096
  store i64 %add27.i.i.i1097, ptr @memory_FREEDBYTES, align 8
  %469 = load ptr, ptr %466, align 8
  store ptr %469, ptr %Current.06.i1093, align 8
  %470 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i1093, ptr %470, align 8
  %cmp.i.not.i1098 = icmp eq ptr %Current.0.val.i1094, null
  br i1 %cmp.i.not.i1098, label %if.end469, label %while.body.i1092

if.else468:                                       ; preds = %if.then464
  call void @list_DeleteWithElement(ptr noundef %465, ptr noundef nonnull @symbol_Delete) #14
  br label %if.end469

if.end469:                                        ; preds = %while.body.i1092, %if.then467, %if.else468
...
for.body488:                                      ; preds = %if.end483, %for.body488
  ...
  br i1 %cmp.i1104.not, label %for.end492, label %for.body488

for.end492:                                       ; preds = %for.body488
  %.pre1246 = load ptr, ptr %Labellist, align 8
  %cmp.i.not5.i1106 = icmp eq ptr %.pre1246, null
  br i1 %cmp.i.not5.i1106, label %list_Delete.exit1115, label %while.body.i1107

while.body.i1107:                                 ; preds = %for.end492, %while.body.i1107
  %Current.06.i1108 = phi ptr [ %Current.0.val.i1109, %while.body.i1107 ], [ %.pre1246, %for.end492 ]
  %Current.0.val.i1109 = load ptr, ptr %Current.06.i1108, align 8
  %475 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i1110 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %475, i64 0, i32 4
  %476 = load i32, ptr %total_size.i.i.i1110, align 8
  %conv26.i.i.i1111 = sext i32 %476 to i64
  %477 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i1112 = add i64 %477, %conv26.i.i.i1111
  store i64 %add27.i.i.i1112, ptr @memory_FREEDBYTES, align 8
  %478 = load ptr, ptr %475, align 8
  store ptr %478, ptr %Current.06.i1108, align 8
  %479 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i1108, ptr %479, align 8
  %cmp.i.not.i1113 = icmp eq ptr %Current.0.val.i1109, null
  br i1 %cmp.i.not.i1113, label %list_Delete.exit1115, label %while.body.i1107

list_Delete.exit1115:                             ; preds = %while.body.i1107, %if.end483, %for.end492
  br i1 %cmp.i855.not1209, label %list_Delete.exit1125, label %while.body.i1117

while.body.i1117:                                 ; preds = %list_Delete.exit1115, %while.body.i1117
  %Current.06.i1118 = phi ptr [ %Current.0.val.i1119, %while.body.i1117 ], [ %Sortlabellist.1, %list_Delete.exit1115 ]
  %Current.0.val.i1119 = load ptr, ptr %Current.06.i1118, align 8
  %480 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i1120 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %480, i64 0, i32 4
  %481 = load i32, ptr %total_size.i.i.i1120, align 8
  %conv26.i.i.i1121 = sext i32 %481 to i64
  %482 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i1122 = add i64 %482, %conv26.i.i.i1121
  store i64 %add27.i.i.i1122, ptr @memory_FREEDBYTES, align 8
  %483 = load ptr, ptr %480, align 8
  store ptr %483, ptr %Current.06.i1118, align 8
  %484 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i1118, ptr %484, align 8
  %cmp.i.not.i1123 = icmp eq ptr %Current.0.val.i1119, null
  br i1 %cmp.i.not.i1123, label %list_Delete.exit1125, label %while.body.i1117

list_Delete.exit1125:                             ; preds = %while.body.i1117, %list_Delete.exit1115
  %485 = load ptr, ptr %UserPrecedence, align 8
  %cmp.i.not5.i1126 = icmp eq ptr %485, null
  br i1 %cmp.i.not5.i1126, label %list_Delete.exit1135, label %while.body.i1127

while.body.i1127:                                 ; preds = %list_Delete.exit1125, %while.body.i1127
  %Current.06.i1128 = phi ptr [ %Current.0.val.i1129, %while.body.i1127 ], [ %485, %list_Delete.exit1125 ]
  %Current.0.val.i1129 = load ptr, ptr %Current.06.i1128, align 8
  %486 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i1130 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %486, i64 0, i32 4
  %487 = load i32, ptr %total_size.i.i.i1130, align 8
  %conv26.i.i.i1131 = sext i32 %487 to i64
  %488 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i1132 = add i64 %488, %conv26.i.i.i1131
  store i64 %add27.i.i.i1132, ptr @memory_FREEDBYTES, align 8
  %489 = load ptr, ptr %486, align 8
  store ptr %489, ptr %Current.06.i1128, align 8
  %490 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i1128, ptr %490, align 8
  %cmp.i.not.i1133 = icmp eq ptr %Current.0.val.i1129, null
  br i1 %cmp.i.not.i1133, label %list_Delete.exit1135, label %while.body.i1127

list_Delete.exit1135:                             ; preds = %while.body.i1127, %list_Delete.exit1125
  ...
  br i1 %cmp8.not.i.i1151, label %if.end13.i.i1153, label %if.then9.i.i1152

if.then9.i.i1152:                                 ; preds = %list_Delete.exit1135
  %503 = load ptr, ptr %add.ptr1.i.i1146, align 8
  store ptr %503, ptr %502, align 8
  br label %if.end13.i.i1153

if.end13.i.i1153:                                 ; preds = %if.then9.i.i1152, %list_Delete.exit1135
  %504 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i1154 = add i32 %504, %RealSize.1.i.i.i.i1142
  %conv.i.i1155 = zext i32 %add.i.i1154 to i64
  %add14.i.i1156 = add nuw nsw i64 %conv.i.i1155, 16
  %505 = load i64, ptr @memory_FREEDBYTES, align 8
  %add15.i.i1157 = add i64 %add14.i.i1156, %505
  store i64 %add15.i.i1157, ptr @memory_FREEDBYTES, align 8
  %506 = load i64, ptr @memory_MAXMEM, align 8
  %cmp16.i.i1158 = icmp sgt i64 %506, -1
  br i1 %cmp16.i.i1158, label %if.then18.i.i1160, label %symbol_DeletePrecedence.exit

if.then18.i.i1160:                                ; preds = %if.end13.i.i1153
  %add22.i.i1161 = add nuw i64 %506, %add14.i.i1156
  store i64 %add22.i.i1161, ptr @memory_MAXMEM, align 8
  br label %symbol_DeletePrecedence.exit

symbol_DeletePrecedence.exit:                     ; preds = %if.end13.i.i1153, %if.then18.i.i1160
  ...
  br i1 %cmp.i.not5.i.i1162, label %ana_Free.exit, label %while.body.i.i1163

while.body.i.i1163:                               ; preds = %symbol_DeletePrecedence.exit, %while.body.i.i1163
  %Current.06.i.i1164 = phi ptr [ %Current.0.val.i.i1165, %while.body.i.i1163 ], [ %507, %symbol_DeletePrecedence.exit ]
  %Current.0.val.i.i1165 = load ptr, ptr %Current.06.i.i1164, align 8
  %508 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i1166 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %508, i64 0, i32 4
  %509 = load i32, ptr %total_size.i.i.i.i1166, align 8
  %conv26.i.i.i.i1167 = sext i32 %509 to i64
  %510 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i1168 = add i64 %510, %conv26.i.i.i.i1167
  store i64 %add27.i.i.i.i1168, ptr @memory_FREEDBYTES, align 8
  %511 = load ptr, ptr %508, align 8
  store ptr %511, ptr %Current.06.i.i1164, align 8
  %512 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i1164, ptr %512, align 8
  %cmp.i.not.i.i1169 = icmp eq ptr %Current.0.val.i.i1165, null
  br i1 %cmp.i.not.i.i1169, label %ana_Free.exit, label %while.body.i.i1163

ana_Free.exit:                                    ; preds = %while.body.i.i1163, %symbol_DeletePrecedence.exit
...
if.end43:                                         ; preds = %lor.lhs.false34, %land.lhs.true36, %if.then40, %clause_LiteralAtom.exit
  ...
  br i1 %cmp.i89.not, label %for.inc46, label %for.body25
...
for.end48:                                        ; preds = %for.inc46
  %28 = icmp eq i32 %MaxNrOfInstances.3, 0
...
clause_GetLiteralAtom.exit:                       ; preds = %for.body18, %if.then.i.i
  ...
  br i1 %cmp16.not.not, label %for.body18, label %for.cond25.preheader
...
if.end.i:                                         ; preds = %while.body.i
  ...
  br i1 %cmp.i.not.i, label %if.then40, label %while.body.i
...
for.inc62:                                        ; preds = %for.body47, %land.lhs.true, %if.then56
  %tobool46.not = phi i1 [ false, %if.then56 ], [ true, %land.lhs.true ], [ true, %for.body47 ]
  %Failed.2 = phi ptr [ %call.i174, %if.then56 ], [ %Failed.1221, %land.lhs.true ], [ %Failed.1221, %for.body47 ]
  ...
  br i1 %24, label %for.body47, label %for.end64
...
for.inc72:                                        ; preds = %while.body.i, %for.inc72.sink.split, %for.end64
  ...
  br i1 %cmp27.not.not, label %for.body29, label %for.cond76.preheader.loopexit
...
for.body80:                                       ; preds = %for.cond76.preheader, %list_Delete.exit
  ...
  br i1 %cmp.i.not5.i, label %list_Delete.exit, label %while.body.i184

while.body.i184:                                  ; preds = %for.body80, %while.body.i184
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i184 ], [ %26, %for.body80 ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  %27 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  ...
  %cmp.i.not.i185 = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i185, label %list_Delete.exit.loopexit, label %while.body.i184

list_Delete.exit.loopexit:                        ; preds = %while.body.i184
...
list_Delete.exit:                                 ; preds = %list_Delete.exit.loopexit, %for.body80
  ...
  br i1 %cmp78.not.not, label %for.body80, label %for.end85
...
memory_Free.exit:                                 ; preds = %if.end23.i, %if.else25.i
  ...
  br i1 %cmp.i.not5.i193, label %cleanup, label %while.body.i194

while.body.i194:                                  ; preds = %memory_Free.exit, %while.body.i194
  %Current.06.i195 = phi ptr [ %Current.0.val.i196, %while.body.i194 ], [ %Failed.0.lcssa, %memory_Free.exit ]
  %Current.0.val.i196 = load ptr, ptr %Current.06.i195, align 8
  %47 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i197 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %47, i64 0, i32 4
  %48 = load i32, ptr %total_size.i.i.i197, align 8
  %conv26.i.i.i198 = sext i32 %48 to i64
  %49 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i199 = add i64 %49, %conv26.i.i.i198
  store i64 %add27.i.i.i199, ptr @memory_FREEDBYTES, align 8
  %50 = load ptr, ptr %47, align 8
  store ptr %50, ptr %Current.06.i195, align 8
  %51 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i195, ptr %51, align 8
  %cmp.i.not.i200 = icmp eq ptr %Current.0.val.i196, null
  br i1 %cmp.i.not.i200, label %cleanup, label %while.body.i194

cleanup:                                          ; preds = %while.body.i194, %for.body, %if.then4, %memory_Free.exit, %entry
  %retval.0 = phi ptr [ null, %entry ], [ %Result.1.lcssa, %memory_Free.exit ], [ null, %if.then4 ], [ %call.i, %for.body ], [ %Result.1.lcssa, %while.body.i194 ]
  ret ptr %retval.0
}
...
attributes #6 = { inlinehint mustprogress nofree nounwind willreturn memory(argmem: read) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
