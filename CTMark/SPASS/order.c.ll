; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/order.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/order.c"
...
@.str.1 = private unnamed_addr constant [56 x i8] c"/home/npopov/repos/llvm-test-suite/CTMark/SPASS/order.c\00", align 1
...
term_IsAtom.exit69.i:                             ; preds = %lor.lhs.false.i
  %sub.i.i.i65.i = sub nsw i32 0, %T2.val61.i
  %5 = load i32, ptr @symbol_TYPEMASK, align 4
  %and.i.i.i66.i = and i32 %5, %sub.i.i.i65.i
  %cmp.i.i67.not.i = icmp eq i32 %and.i.i.i66.i, 2
  br i1 %cmp.i.i67.not.i, label %land.lhs.true6.i, label %if.else

land.lhs.true6.i:                                 ; preds = %term_IsAtom.exit69.i
  %6 = load i32, ptr @symbol_TYPESTATBITS, align 4
  %shr.i.i71.i = lshr i32 %sub.i.i.i65.i, %6
...
term_IsAtom.exit82.i:                             ; preds = %if.then.term_IsAtom.exit82_crit_edge.i, %land.lhs.true.i
  %sub.i.i.i78.pre-phi.i = phi i32 [ %.pre.i, %if.then.term_IsAtom.exit82_crit_edge.i ], [ %sub.i.i.i.i, %land.lhs.true.i ]
  ...
  %and.i.i.i79.i = and i32 %12, %sub.i.i.i78.pre-phi.i
  %cmp.i.i80.not.i = icmp eq i32 %and.i.i.i79.i, 2
  br i1 %cmp.i.i80.not.i, label %if.then12.i, label %cleanup
...
term_IsAtom.exit89.i:                             ; preds = %if.then12.i
  %sub.i.i.i85.i = sub nsw i32 0, %T2.val59.i
  %and.i.i.i86.i = and i32 %12, %sub.i.i.i85.i
  %cmp.i.i87.not.i = icmp eq i32 %and.i.i.i86.i, 2
  br i1 %cmp.i.i87.not.i, label %if.then15.i, label %cleanup

if.then15.i:                                      ; preds = %term_IsAtom.exit89.i
  %shr.i.i91.i = lshr i32 %sub.i.i.i78.pre-phi.i, %11
...
land.lhs.true19.i:                                ; preds = %if.then15.i
  %shr.i.i97.i = lshr i32 %sub.i.i.i85.i, %11
...
cleanup:                                          ; preds = %if.then15.i, %if.then12.i, %if.then.i, %term_IsAtom.exit82.i, %term_IsAtom.exit89.i, %lor.lhs.false32.i, %land.lhs.true19.i, %lor.lhs.false23.i, %sw.bb4, %sw.bb
  %retval.0 = phi i32 [ %conv.i.i, %sw.bb4 ], [ %call3, %sw.bb ], [ 0, %if.then15.i ], [ 1, %if.then12.i ], [ 0, %if.then.i ], [ 0, %term_IsAtom.exit82.i ], [ 1, %term_IsAtom.exit89.i ], [ 0, %lor.lhs.false32.i ], [ 1, %land.lhs.true19.i ], [ 1, %lor.lhs.false23.i ]
  ret i32 %retval.0
}
...
sw.bb1:                                           ; preds = %entry
  %2 = tail call i64 @fwrite(ptr nonnull @.str.9, i64 7, i64 1, ptr %0)
  br label %sw.epilog

sw.bb3:                                           ; preds = %entry
  %3 = tail call i64 @fwrite(ptr nonnull @.str.10, i64 14, i64 1, ptr %0)
  br label %sw.epilog

sw.bb5:                                           ; preds = %entry
  %4 = tail call i64 @fwrite(ptr nonnull @.str.11, i64 14, i64 1, ptr %0)
  br label %sw.epilog

sw.default:                                       ; preds = %entry
  %5 = tail call i64 @fwrite(ptr nonnull @.str.12, i64 11, i64 1, ptr %0)
  br label %sw.epilog
...
if.then:                                          ; preds = %entry
  ...
  %Lit1.val765 = load ptr, ptr %1, align 8
  %2 = getelementptr i8, ptr %Lit1.val765, i64 8
  %Lit1.val765.val = load ptr, ptr %2, align 8
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %Lit1.addr.0 = phi ptr [ %Lit1.val765.val, %if.then ], [ %Lit1, %entry ]
  %Lit2.val = load i32, ptr %Lit2, align 8
  %cmp.i774 = icmp ne i32 %Lit2.val, %0
  br i1 %cmp.i774, label %if.end10, label %if.then8

if.then8:                                         ; preds = %if.end
  %3 = getelementptr i8, ptr %Lit2, i64 16
  %Lit2.val764 = load ptr, ptr %3, align 8
  %4 = getelementptr i8, ptr %Lit2.val764, i64 8
  %Lit2.val764.val = load ptr, ptr %4, align 8
  br label %if.end10

if.end10:                                         ; preds = %if.then8, %if.end
  %Lit2.addr.0 = phi ptr [ %Lit2.val764.val, %if.then8 ], [ %Lit2, %if.end ]
  %Lit1.addr.0.val768 = load i32, ptr %Lit1.addr.0, align 8
  %5 = load i32, ptr @fol_EQUALITY, align 4
  %cmp.i776.not = icmp eq i32 %5, %Lit1.addr.0.val768
  %Lit2.addr.0.val767 = load i32, ptr %Lit2.addr.0, align 8
  br i1 %cmp.i776.not, label %if.then13, label %if.else387

if.then13:                                        ; preds = %if.end10
  %cmp.i778.not = icmp eq i32 %Lit1.addr.0.val768, %Lit2.addr.0.val767
  %6 = getelementptr i8, ptr %Lit1.addr.0, i64 16
  %Lit1.addr.0.val763 = load ptr, ptr %6, align 8
  %7 = getelementptr i8, ptr %Lit1.addr.0.val763, i64 8
  %Lit1.addr.0.val763.val = load ptr, ptr %7, align 8
  br i1 %cmp.i778.not, label %if.then16, label %if.else366

if.then16:                                        ; preds = %if.then13
  %Lit1.addr.0.val773.val = load ptr, ptr %Lit1.addr.0.val763, align 8
  %8 = getelementptr i8, ptr %Lit1.addr.0.val773.val, i64 8
  %Lit1.addr.0.val773.val.val = load ptr, ptr %8, align 8
  %9 = getelementptr i8, ptr %Lit2.addr.0, i64 16
  %Lit2.addr.0.val762 = load ptr, ptr %9, align 8
  %10 = getelementptr i8, ptr %Lit2.addr.0.val762, i64 8
  %Lit2.addr.0.val762.val = load ptr, ptr %10, align 8
  %Lit2.addr.0.val772.val = load ptr, ptr %Lit2.addr.0.val762, align 8
  %11 = getelementptr i8, ptr %Lit2.addr.0.val772.val, i64 8
  %Lit2.addr.0.val772.val.val = load ptr, ptr %11, align 8
...
land.lhs.true:                                    ; preds = %lor.lhs.false
  %call23 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val763.val, ptr noundef %Lit1.addr.0.val773.val.val, ptr noundef %FlagStore, ptr noundef %Precedence)
  %12 = and i32 %call23, -3
...
if.then26:                                        ; preds = %land.lhs.true, %if.then16
  ...
  %spec.select = select i1 %cmp27, ptr %Lit1.addr.0.val773.val.val, ptr %Lit1.addr.0.val763.val
  %spec.select749 = select i1 %cmp27, ptr %Lit1.addr.0.val763.val, ptr %Lit1.addr.0.val773.val.val
...
land.lhs.true33:                                  ; preds = %lor.lhs.false31
  %call34 = tail call i32 @ord_Compare(ptr noundef %Lit2.addr.0.val762.val, ptr noundef %Lit2.addr.0.val772.val.val, ptr noundef %FlagStore, ptr noundef %Precedence)
  %13 = and i32 %call34, -3
...
if.then38:                                        ; preds = %land.lhs.true33, %if.then26
  ...
  %spec.select750 = select i1 %cmp39, ptr %Lit2.addr.0.val772.val.val, ptr %Lit2.addr.0.val762.val
  %spec.select751 = select i1 %cmp39, ptr %Lit2.addr.0.val762.val, ptr %Lit2.addr.0.val772.val.val
...
if.then46:                                        ; preds = %if.then44
  br i1 %cmp.i774, label %if.then48, label %cleanup429
...
if.else50:                                        ; preds = %if.then44
  br i1 %cmp.i774, label %cleanup429, label %if.else53
...
if.else56:                                        ; preds = %land.lhs.true33, %lor.lhs.false31
  %call57 = tail call i32 @term_Equal(ptr noundef %spec.select, ptr noundef %Lit2.addr.0.val762.val) #8
  %tobool58.not = icmp eq i32 %call57, 0
  br i1 %tobool58.not, label %if.end75, label %if.then59

if.then59:                                        ; preds = %if.else56
  %call60 = tail call i32 @ord_Compare(ptr noundef %spec.select749, ptr noundef %Lit2.addr.0.val772.val.val, ptr noundef %FlagStore, ptr noundef %Precedence)
  %cmp61 = icmp eq i32 %call60, 2
  br i1 %cmp61, label %if.then62, label %if.end74

if.then62:                                        ; preds = %if.then59
  %or.cond439 = or i1 %cmp.i, %cmp.i774
  br i1 %or.cond439, label %if.else67, label %cleanup429

if.else67:                                        ; preds = %if.then62
  %or.cond440 = and i1 %cmp.i, %cmp.i774
...
if.end75:                                         ; preds = %if.else56
  %call76 = tail call i32 @term_Equal(ptr noundef %spec.select, ptr noundef %Lit2.addr.0.val772.val.val) #8
  %tobool77.not = icmp eq i32 %call76, 0
  br i1 %tobool77.not, label %if.end94, label %if.then78

if.then78:                                        ; preds = %if.end75
  %call79 = tail call i32 @ord_Compare(ptr noundef %spec.select749, ptr noundef %Lit2.addr.0.val762.val, ptr noundef %FlagStore, ptr noundef %Precedence)
  %cmp80 = icmp eq i32 %call79, 2
  br i1 %cmp80, label %if.then81, label %if.end93

if.then81:                                        ; preds = %if.then78
  %or.cond441 = or i1 %cmp.i, %cmp.i774
  br i1 %or.cond441, label %if.else86, label %cleanup429

if.else86:                                        ; preds = %if.then81
  %or.cond442 = and i1 %cmp.i, %cmp.i774
...
if.end94:                                         ; preds = %if.end75
  %call95 = tail call i32 @ord_Compare(ptr noundef %spec.select, ptr noundef %Lit2.addr.0.val762.val, ptr noundef %FlagStore, ptr noundef %Precedence)
  %call96 = tail call i32 @ord_Compare(ptr noundef %spec.select, ptr noundef %Lit2.addr.0.val772.val.val, ptr noundef %FlagStore, ptr noundef %Precedence)
  %cmp97 = icmp eq i32 %call95, %call96
  br i1 %cmp97, label %cleanup429, label %if.end99

if.end99:                                         ; preds = %if.end94
  %call100 = tail call i32 @ord_Compare(ptr noundef %spec.select749, ptr noundef %Lit2.addr.0.val772.val.val, ptr noundef %FlagStore, ptr noundef %Precedence)
...
if.end108:                                        ; preds = %if.end103
  %call109 = tail call i32 @ord_Compare(ptr noundef %spec.select749, ptr noundef %Lit2.addr.0.val762.val, ptr noundef %FlagStore, ptr noundef %Precedence)
...
if.else115.thread:                                ; preds = %land.lhs.true
  %tobool116.not782 = icmp eq i32 %Orient2, 0
  br i1 %tobool116.not782, label %land.lhs.true119, label %if.then127

land.lhs.true119:                                 ; preds = %if.else115.thread
  %Lit2.addr.0.val761 = load ptr, ptr %9, align 8
  %16 = getelementptr i8, ptr %Lit2.addr.0.val761, i64 8
  %Lit2.addr.0.val761.val = load ptr, ptr %16, align 8
  %Lit2.addr.0.val771.val = load ptr, ptr %Lit2.addr.0.val761, align 8
  %17 = getelementptr i8, ptr %Lit2.addr.0.val771.val, i64 8
  %Lit2.addr.0.val771.val.val = load ptr, ptr %17, align 8
  %call122 = tail call i32 @ord_Compare(ptr noundef %Lit2.addr.0.val761.val, ptr noundef %Lit2.addr.0.val771.val.val, ptr noundef %FlagStore, ptr noundef %Precedence)
  %cmp123 = icmp eq i32 %call122, 3
  br i1 %cmp123, label %if.then127, label %if.else198

if.then127:                                       ; preds = %if.else115.thread, %if.else115, %land.lhs.true119
  %18 = phi ptr [ %Lit2.addr.0.val772.val.val, %land.lhs.true119 ], [ %Lit2.addr.0.val762.val, %if.else115 ], [ %Lit2.addr.0.val762.val, %if.else115.thread ]
  %19 = phi ptr [ %Lit2.addr.0.val762.val, %land.lhs.true119 ], [ %Lit2.addr.0.val772.val.val, %if.else115 ], [ %Lit2.addr.0.val772.val.val, %if.else115.thread ]
  %call132 = tail call i32 @term_Equal(ptr noundef %Lit1.addr.0.val763.val, ptr noundef %18) #8
  %tobool133.not = icmp eq i32 %call132, 0
  br i1 %tobool133.not, label %if.end151, label %if.then134

if.then134:                                       ; preds = %if.then127
  %call135 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val773.val.val, ptr noundef %19, ptr noundef %FlagStore, ptr noundef %Precedence)
  %cmp136 = icmp eq i32 %call135, 2
  br i1 %cmp136, label %if.then138, label %if.end150

if.then138:                                       ; preds = %if.then134
  %or.cond446 = or i1 %cmp.i, %cmp.i774
  br i1 %or.cond446, label %if.else143, label %cleanup429

if.else143:                                       ; preds = %if.then138
  %or.cond447 = and i1 %cmp.i, %cmp.i774
...
if.end151:                                        ; preds = %if.then127
  %call152 = tail call i32 @term_Equal(ptr noundef %Lit1.addr.0.val773.val.val, ptr noundef %18) #8
  %tobool153.not = icmp eq i32 %call152, 0
  br i1 %tobool153.not, label %if.end171, label %if.then154

if.then154:                                       ; preds = %if.end151
  %call155 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val763.val, ptr noundef %19, ptr noundef %FlagStore, ptr noundef %Precedence)
  %cmp156 = icmp eq i32 %call155, 2
  br i1 %cmp156, label %if.then158, label %if.end170

if.then158:                                       ; preds = %if.then154
  %or.cond448 = or i1 %cmp.i, %cmp.i774
  br i1 %or.cond448, label %if.else163, label %cleanup429

if.else163:                                       ; preds = %if.then158
  %or.cond449 = and i1 %cmp.i, %cmp.i774
...
if.end171:                                        ; preds = %if.end151
  %call172 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val763.val, ptr noundef %18, ptr noundef %FlagStore, ptr noundef %Precedence)
  %call173 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val773.val.val, ptr noundef %18, ptr noundef %FlagStore, ptr noundef %Precedence)
  %cmp174 = icmp eq i32 %call172, %call173
  br i1 %cmp174, label %cleanup429, label %if.end177

if.end177:                                        ; preds = %if.end171
  %call178 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val773.val.val, ptr noundef %19, ptr noundef %FlagStore, ptr noundef %Precedence)
...
if.end189:                                        ; preds = %if.end182
  %call190 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val763.val, ptr noundef %19, ptr noundef %FlagStore, ptr noundef %Precedence)
...
if.else198:                                       ; preds = %if.else115, %land.lhs.true119
  %call199 = tail call i32 @term_Equal(ptr noundef %Lit1.addr.0.val763.val, ptr noundef %Lit2.addr.0.val762.val) #8
  %tobool200.not = icmp eq i32 %call199, 0
  br i1 %tobool200.not, label %if.end218, label %if.then201

if.then201:                                       ; preds = %if.else198
  %call202 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val773.val.val, ptr noundef %Lit2.addr.0.val772.val.val, ptr noundef %FlagStore, ptr noundef %Precedence)
  %cmp203 = icmp eq i32 %call202, 2
  br i1 %cmp203, label %if.then205, label %if.end217

if.then205:                                       ; preds = %if.then201
  %or.cond452 = or i1 %cmp.i, %cmp.i774
  br i1 %or.cond452, label %if.else210, label %cleanup429

if.else210:                                       ; preds = %if.then205
  %or.cond453 = and i1 %cmp.i, %cmp.i774
...
if.end218:                                        ; preds = %if.else198
  %call219 = tail call i32 @term_Equal(ptr noundef %Lit1.addr.0.val773.val.val, ptr noundef %Lit2.addr.0.val762.val) #8
  %tobool220.not = icmp eq i32 %call219, 0
  br i1 %tobool220.not, label %if.end238, label %if.then221

if.then221:                                       ; preds = %if.end218
  %call222 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val763.val, ptr noundef %Lit2.addr.0.val772.val.val, ptr noundef %FlagStore, ptr noundef %Precedence)
  %cmp223 = icmp eq i32 %call222, 2
  br i1 %cmp223, label %if.then225, label %if.end237

if.then225:                                       ; preds = %if.then221
  %or.cond454 = or i1 %cmp.i, %cmp.i774
  br i1 %or.cond454, label %if.else230, label %cleanup429

if.else230:                                       ; preds = %if.then225
  %or.cond455 = and i1 %cmp.i, %cmp.i774
...
if.end238:                                        ; preds = %if.end218
  %call239 = tail call i32 @term_Equal(ptr noundef %Lit1.addr.0.val763.val, ptr noundef %Lit2.addr.0.val772.val.val) #8
  %tobool240.not = icmp eq i32 %call239, 0
  br i1 %tobool240.not, label %if.end258, label %if.then241

if.then241:                                       ; preds = %if.end238
  %call242 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val773.val.val, ptr noundef %Lit2.addr.0.val762.val, ptr noundef %FlagStore, ptr noundef %Precedence)
  %cmp243 = icmp eq i32 %call242, 2
  br i1 %cmp243, label %if.then245, label %if.end257

if.then245:                                       ; preds = %if.then241
  %or.cond456 = or i1 %cmp.i, %cmp.i774
  br i1 %or.cond456, label %if.else250, label %cleanup429

if.else250:                                       ; preds = %if.then245
  %or.cond457 = and i1 %cmp.i, %cmp.i774
...
if.end258:                                        ; preds = %if.end238
  %call259 = tail call i32 @term_Equal(ptr noundef %Lit1.addr.0.val773.val.val, ptr noundef %Lit2.addr.0.val772.val.val) #8
  %tobool260.not = icmp eq i32 %call259, 0
  %call279 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val763.val, ptr noundef %Lit2.addr.0.val762.val, ptr noundef %FlagStore, ptr noundef %Precedence)
...
if.then282:                                       ; preds = %if.end278
  %call283 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val763.val, ptr noundef %Lit2.addr.0.val772.val.val, ptr noundef %FlagStore, ptr noundef %Precedence)
...
if.then286:                                       ; preds = %if.then282
  %call287 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val773.val.val, ptr noundef %Lit2.addr.0.val762.val, ptr noundef %FlagStore, ptr noundef %Precedence)
  %cmp288 = icmp eq i32 %call287, 3
  br i1 %cmp288, label %land.lhs.true290, label %if.end295

land.lhs.true290:                                 ; preds = %if.then286
  %call291 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val773.val.val, ptr noundef %Lit2.addr.0.val772.val.val, ptr noundef %FlagStore, ptr noundef %Precedence)
...
if.then299:                                       ; preds = %if.then282
  %call300 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val773.val.val, ptr noundef %Lit2.addr.0.val762.val, ptr noundef %FlagStore, ptr noundef %Precedence)
  %cmp301 = icmp eq i32 %call300, 3
  %.755 = select i1 %cmp301, i32 3, i32 0
  br label %cleanup429

if.then308:                                       ; preds = %if.then282
  %call309 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val773.val.val, ptr noundef %Lit2.addr.0.val762.val, ptr noundef %FlagStore, ptr noundef %Precedence)
  %cmp310 = icmp eq i32 %call309, 1
  br i1 %cmp310, label %cleanup429, label %lor.lhs.false312

lor.lhs.false312:                                 ; preds = %if.then308
  %call313 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val773.val.val, ptr noundef %Lit2.addr.0.val772.val.val, ptr noundef %FlagStore, ptr noundef %Precedence)
...
if.then322:                                       ; preds = %if.end319
  %call323 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val763.val, ptr noundef %Lit2.addr.0.val772.val.val, ptr noundef %FlagStore, ptr noundef %Precedence)
  %cmp324 = icmp eq i32 %call323, 3
  br i1 %cmp324, label %cleanup429, label %lor.lhs.false326

lor.lhs.false326:                                 ; preds = %if.then322
  %call327 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val773.val.val, ptr noundef %Lit2.addr.0.val772.val.val, ptr noundef %FlagStore, ptr noundef %Precedence)
...
if.then342:                                       ; preds = %if.end319
  %call343 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val773.val.val, ptr noundef %Lit2.addr.0.val762.val, ptr noundef %FlagStore, ptr noundef %Precedence)
  %cmp344 = icmp eq i32 %call343, 1
  br i1 %cmp344, label %cleanup429, label %lor.lhs.false346

lor.lhs.false346:                                 ; preds = %if.then342
  %call347 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val773.val.val, ptr noundef %Lit2.addr.0.val772.val.val, ptr noundef %FlagStore, ptr noundef %Precedence)
...
if.else366:                                       ; preds = %if.then13
  %call368 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val763.val, ptr noundef nonnull %Lit2.addr.0, ptr noundef %FlagStore, ptr noundef %Precedence)
...
if.then373:                                       ; preds = %if.else366
  %Lit1.addr.0.val770 = load ptr, ptr %6, align 8
  %Lit1.addr.0.val770.val = load ptr, ptr %Lit1.addr.0.val770, align 8
  %22 = getelementptr i8, ptr %Lit1.addr.0.val770.val, i64 8
  %Lit1.addr.0.val770.val.val = load ptr, ptr %22, align 8
  %call375 = tail call i32 @ord_Compare(ptr noundef %Lit1.addr.0.val770.val.val, ptr noundef nonnull %Lit2.addr.0, ptr noundef %FlagStore, ptr noundef %Precedence)
...
if.else387:                                       ; preds = %if.end10
  %cmp.i780.not = icmp eq i32 %5, %Lit2.addr.0.val767
  br i1 %cmp.i780.not, label %if.then390, label %if.else410
...
if.then397:                                       ; preds = %if.then390
  %Lit2.addr.0.val769 = load ptr, ptr %23, align 8
  %Lit2.addr.0.val769.val = load ptr, ptr %Lit2.addr.0.val769, align 8
  %25 = getelementptr i8, ptr %Lit2.addr.0.val769.val, i64 8
  %Lit2.addr.0.val769.val.val = load ptr, ptr %25, align 8
  %call399 = tail call i32 @ord_Compare(ptr noundef nonnull %Lit1.addr.0, ptr noundef %Lit2.addr.0.val769.val.val, ptr noundef %FlagStore, ptr noundef %Precedence)
