...
if.then127:                                       ; preds = %if.else115.thread, %if.else115, %land.lhs.true119
  %18 = phi ptr [ %Lit2.addr.0.val771.val.val, %land.lhs.true119 ], [ %Lit2.addr.0.val761.val, %if.else115 ], [ %Lit2.addr.0.val761.val, %if.else115.thread ]
  %19 = phi ptr [ %Lit2.addr.0.val761.val, %land.lhs.true119 ], [ %Lit2.addr.0.val771.val.val, %if.else115 ], [ %Lit2.addr.0.val771.val.val, %if.else115.thread ]
