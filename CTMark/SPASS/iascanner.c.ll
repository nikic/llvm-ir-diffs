; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/iascanner.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/iascanner.c"
...
while.cond13:                                     ; preds = %while.cond13, %yy_match
  ...
  br i1 %cmp, label %while.cond13, label %while.end
...
cond.end.i.1:                                     ; preds = %cond.true.i.1, %cond.end.i
  ...
  br i1 %exitcond.not.i.1, label %yy_get_previous_state.exit, label %for.body.i
...
yy_find_action.backedge:                          ; preds = %for.body.i182.prol.loopexit, %cond.end.i190.1, %yy_get_previous_state.exit, %sw.bb109
  %yy_bp.1.be = phi ptr [ %134, %sw.bb109 ], [ %55, %yy_get_previous_state.exit ], [ %134, %cond.end.i190.1 ], [ %134, %for.body.i182.prol.loopexit ]
  %yy_cp.2.be = phi ptr [ %arrayidx112, %sw.bb109 ], [ %add.ptr, %yy_get_previous_state.exit ], [ %arrayidx112, %cond.end.i190.1 ], [ %arrayidx112, %for.body.i182.prol.loopexit ]
  %yy_current_state.2.be = phi i32 [ %136, %sw.bb109 ], [ %yy_current_state.0.lcssa.i, %yy_get_previous_state.exit ], [ %conv6.i194.lcssa.unr, %for.body.i182.prol.loopexit ], [ %conv6.i194.1, %cond.end.i190.1 ]
  br label %yy_find_action
...
yy_match.backedge:                                ; preds = %for.body.i160.prol.loopexit, %cond.end.i168.1, %if.then94, %sw.bb104
  %yy_bp.0.be = phi ptr [ %121, %sw.bb104 ], [ %55, %if.then94 ], [ %121, %cond.end.i168.1 ], [ %121, %for.body.i160.prol.loopexit ]
  %yy_cp.0.be = phi ptr [ %add.ptr106, %sw.bb104 ], [ %incdec.ptr95, %if.then94 ], [ %add.ptr106, %cond.end.i168.1 ], [ %add.ptr106, %for.body.i160.prol.loopexit ]
  %yy_current_state.0.be = phi i32 [ %122, %sw.bb104 ], [ %conv.i, %if.then94 ], [ %conv6.i172.lcssa.unr, %for.body.i160.prol.loopexit ], [ %conv6.i172.1, %cond.end.i168.1 ]
  br label %yy_match
...
iter.check:                                       ; preds = %if.end6.i
  ...
  br i1 %or.cond625, label %for.body.i151.preheader, label %vector.main.loop.iter.check
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %for.body.i151.preheader, label %vec.epilog.ph

vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %n.vec609 = and i64 %76, 8589934584
...
vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  ...
  br i1 %cmp.n619, label %for.end.i.loopexit, label %for.body.i151.preheader

for.body.i151.preheader:                          ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %dest.0196.i.ph = phi ptr [ %53, %iter.check ], [ %ind.end611, %vec.epilog.iter.check ], [ %ind.end610, %vec.epilog.middle.block ]
  %source.0195.i.ph = phi ptr [ %70, %iter.check ], [ %ind.end614, %vec.epilog.iter.check ], [ %ind.end613, %vec.epilog.middle.block ]
  %i.0194.i.ph = phi i32 [ 0, %iter.check ], [ %ind.end617, %vec.epilog.iter.check ], [ %ind.end616, %vec.epilog.middle.block ]
  br label %for.body.i151

for.body.i151:                                    ; preds = %for.body.i151.preheader, %for.body.i151
  %dest.0196.i = phi ptr [ %incdec.ptr13.i, %for.body.i151 ], [ %dest.0196.i.ph, %for.body.i151.preheader ]
  %source.0195.i = phi ptr [ %incdec.ptr.i152, %for.body.i151 ], [ %source.0195.i.ph, %for.body.i151.preheader ]
  %i.0194.i = phi i32 [ %inc.i, %for.body.i151 ], [ %i.0194.i.ph, %for.body.i151.preheader ]
  %incdec.ptr.i152 = getelementptr inbounds i8, ptr %source.0195.i, i64 1
  ...
  %exitcond.not.i153 = icmp eq i32 %inc.i, %sub10.i
  br i1 %exitcond.not.i153, label %for.end.i.loopexit, label %for.body.i151

for.end.i.loopexit:                               ; preds = %for.body.i151, %vec.epilog.middle.block, %middle.block
...
while.body.i:                                     ; preds = %if.end49.i, %while.body.lr.ph.i
  ...
  %tobool.not.i150 = icmp eq i32 %86, 0
  br i1 %tobool.not.i150, label %if.end45.thread.i, label %if.end45.i
...
if.end45.i:                                       ; preds = %while.body.i
  ...
  %div171.i = lshr i32 %84, 3
  %add34.i = add i32 %div171.i, %84
  %storemerge170.i = select i1 %cmp29.i, i32 %add34.i, i32 %mul.i
  store i32 %storemerge170.i, ptr %.pn.in.i, align 8
  %add41.i = add i32 %storemerge170.i, 2
  %conv.i.i = zext i32 %add41.i to i64
  %call.i173.i = tail call noalias ptr @realloc(ptr noundef %85, i64 noundef %conv.i.i) #21
...
if.end49.i:                                       ; preds = %if.end45.i
  ...
  br i1 %cmp20.i, label %while.body.i, label %while.end.i
...
for.body70.i:                                     ; preds = %land.lhs.true.i
  ...
  br i1 %exitcond213.not.i, label %for.end79.i, label %land.lhs.true.i
...
if.end114.thread188.i:                            ; preds = %if.else98.i
  ...
  store i32 %conv104.i, ptr %yy_n_chars113189.i, align 4
  br label %sw.bb104
...
sw.bb104:                                         ; preds = %sw.bb104.loopexit, %if.end114.thread188.i, %if.end114.thread218.i
  %conv78366.in = phi i64 [ %sub.ptr.sub77.le433, %if.end114.thread218.i ], [ %sub.ptr.sub77.le, %if.end114.thread188.i ], [ %sub.ptr.sub77.le430, %sw.bb104.loopexit ]
  %.ph = phi ptr [ %93, %if.end114.thread218.i ], [ %99, %if.end114.thread188.i ], [ %103, %sw.bb104.loopexit ]
  %.ph202 = phi i32 [ %inc87.i, %if.end114.thread218.i ], [ %conv104.i, %if.end114.thread188.i ], [ %n.0.lcssa.ph.i, %sw.bb104.loopexit ]
  ...
  br i1 %cmp11.i155, label %for.body.i160.preheader, label %yy_match.backedge

for.body.i160.preheader:                          ; preds = %sw.bb104
  %123 = and i64 %sext453, 4294967296
  %lcmp.mod777.not = icmp eq i64 %123, 0
  br i1 %lcmp.mod777.not, label %for.body.i160.prol.loopexit, label %for.body.i160.prol

for.body.i160.prol:                               ; preds = %for.body.i160.preheader
  %idxprom.i163.prol = zext i1 %.b.i154 to i64
  %124 = load i8, ptr %121, align 1
  %tobool.not.i164.prol = icmp eq i8 %124, 0
  br i1 %tobool.not.i164.prol, label %cond.end.i168.prol, label %cond.true.i165.prol

cond.true.i165.prol:                              ; preds = %for.body.i160.prol
  %idxprom2.i166.prol = zext i8 %124 to i64
  %arrayidx3.i167.prol = getelementptr inbounds [256 x i32], ptr @yy_ec, i64 0, i64 %idxprom2.i166.prol
  %125 = load i32, ptr %arrayidx3.i167.prol, align 4
  br label %cond.end.i168.prol

cond.end.i168.prol:                               ; preds = %cond.true.i165.prol, %for.body.i160.prol
  %cond.i169.prol = phi i32 [ %125, %cond.true.i165.prol ], [ 1, %for.body.i160.prol ]
  %idxprom4.i170.prol = sext i32 %cond.i169.prol to i64
  %arrayidx5.i171.prol = getelementptr inbounds [60 x [24 x i16]], ptr @yy_nxt, i64 0, i64 %idxprom.i163.prol, i64 %idxprom4.i170.prol
  %126 = load i16, ptr %arrayidx5.i171.prol, align 2
  %conv6.i172.prol = sext i16 %126 to i32
  %incdec.ptr.i173.prol = getelementptr inbounds i8, ptr %121, i64 1
  br label %for.body.i160.prol.loopexit

for.body.i160.prol.loopexit:                      ; preds = %cond.end.i168.prol, %for.body.i160.preheader
  %conv6.i172.lcssa.unr = phi i32 [ undef, %for.body.i160.preheader ], [ %conv6.i172.prol, %cond.end.i168.prol ]
  %yy_cp.013.i161.unr = phi ptr [ %121, %for.body.i160.preheader ], [ %incdec.ptr.i173.prol, %cond.end.i168.prol ]
  %yy_current_state.012.i162.unr = phi i32 [ %122, %for.body.i160.preheader ], [ %conv6.i172.prol, %cond.end.i168.prol ]
  %127 = icmp eq i64 %sext453, 4294967296
  br i1 %127, label %yy_match.backedge, label %for.body.i160

for.body.i160:                                    ; preds = %for.body.i160.prol.loopexit, %cond.end.i168.1
  %yy_cp.013.i161 = phi ptr [ %incdec.ptr.i173.1, %cond.end.i168.1 ], [ %yy_cp.013.i161.unr, %for.body.i160.prol.loopexit ]
  %yy_current_state.012.i162 = phi i32 [ %conv6.i172.1, %cond.end.i168.1 ], [ %yy_current_state.012.i162.unr, %for.body.i160.prol.loopexit ]
  %idxprom.i163 = sext i32 %yy_current_state.012.i162 to i64
  %128 = load i8, ptr %yy_cp.013.i161, align 1
  %tobool.not.i164 = icmp eq i8 %128, 0
  br i1 %tobool.not.i164, label %cond.end.i168, label %cond.true.i165

cond.true.i165:                                   ; preds = %for.body.i160
  %idxprom2.i166 = zext i8 %128 to i64
  %arrayidx3.i167 = getelementptr inbounds [256 x i32], ptr @yy_ec, i64 0, i64 %idxprom2.i166
  %129 = load i32, ptr %arrayidx3.i167, align 4
  br label %cond.end.i168

cond.end.i168:                                    ; preds = %cond.true.i165, %for.body.i160
  %cond.i169 = phi i32 [ %129, %cond.true.i165 ], [ 1, %for.body.i160 ]
  %idxprom4.i170 = sext i32 %cond.i169 to i64
  %arrayidx5.i171 = getelementptr inbounds [60 x [24 x i16]], ptr @yy_nxt, i64 0, i64 %idxprom.i163, i64 %idxprom4.i170
  %130 = load i16, ptr %arrayidx5.i171, align 2
  %incdec.ptr.i173 = getelementptr inbounds i8, ptr %yy_cp.013.i161, i64 1
  %idxprom.i163.1 = sext i16 %130 to i64
  %131 = load i8, ptr %incdec.ptr.i173, align 1
  %tobool.not.i164.1 = icmp eq i8 %131, 0
  br i1 %tobool.not.i164.1, label %cond.end.i168.1, label %cond.true.i165.1

cond.true.i165.1:                                 ; preds = %cond.end.i168
  %idxprom2.i166.1 = zext i8 %131 to i64
  %arrayidx3.i167.1 = getelementptr inbounds [256 x i32], ptr @yy_ec, i64 0, i64 %idxprom2.i166.1
  %132 = load i32, ptr %arrayidx3.i167.1, align 4
  br label %cond.end.i168.1

cond.end.i168.1:                                  ; preds = %cond.true.i165.1, %cond.end.i168
  %cond.i169.1 = phi i32 [ %132, %cond.true.i165.1 ], [ 1, %cond.end.i168 ]
  %idxprom4.i170.1 = sext i32 %cond.i169.1 to i64
  %arrayidx5.i171.1 = getelementptr inbounds [60 x [24 x i16]], ptr @yy_nxt, i64 0, i64 %idxprom.i163.1, i64 %idxprom4.i170.1
  %133 = load i16, ptr %arrayidx5.i171.1, align 2
  %conv6.i172.1 = sext i16 %133 to i32
  %incdec.ptr.i173.1 = getelementptr inbounds i8, ptr %yy_cp.013.i161, i64 2
  %exitcond.not.i174.1 = icmp eq ptr %incdec.ptr.i173.1, %add.ptr106
  br i1 %exitcond.not.i174.1, label %yy_match.backedge, label %for.body.i160
...
sw.bb109:                                         ; preds = %if.then3.i, %yy_get_next_buffer.exit
  ...
  br i1 %cmp11.i177, label %for.body.preheader.i180, label %yy_find_action.backedge

for.body.preheader.i180:                          ; preds = %sw.bb109
  %137 = ptrtoint ptr %135 to i64
  %138 = ptrtoint ptr %arrayidx112 to i64
  %139 = ptrtoint ptr %134 to i64
  %140 = sub i64 %138, %139
  %scevgep.i181 = getelementptr i8, ptr %134, i64 %140
  %141 = add nsw i64 %idxprom111.pre-phi, -1
  %142 = add i64 %141, %137
  %xtraiter774 = and i64 %140, 1
  %lcmp.mod775.not = icmp eq i64 %xtraiter774, 0
  br i1 %lcmp.mod775.not, label %for.body.i182.prol.loopexit, label %for.body.i182.prol

for.body.i182.prol:                               ; preds = %for.body.preheader.i180
  %idxprom.i185.prol = zext i1 %.b.i176 to i64
  %143 = load i8, ptr %134, align 1
  %tobool.not.i186.prol = icmp eq i8 %143, 0
  br i1 %tobool.not.i186.prol, label %cond.end.i190.prol, label %cond.true.i187.prol

cond.true.i187.prol:                              ; preds = %for.body.i182.prol
  %idxprom2.i188.prol = zext i8 %143 to i64
  %arrayidx3.i189.prol = getelementptr inbounds [256 x i32], ptr @yy_ec, i64 0, i64 %idxprom2.i188.prol
  %144 = load i32, ptr %arrayidx3.i189.prol, align 4
  br label %cond.end.i190.prol

cond.end.i190.prol:                               ; preds = %cond.true.i187.prol, %for.body.i182.prol
  %cond.i191.prol = phi i32 [ %144, %cond.true.i187.prol ], [ 1, %for.body.i182.prol ]
  %idxprom4.i192.prol = sext i32 %cond.i191.prol to i64
  %arrayidx5.i193.prol = getelementptr inbounds [60 x [24 x i16]], ptr @yy_nxt, i64 0, i64 %idxprom.i185.prol, i64 %idxprom4.i192.prol
  %145 = load i16, ptr %arrayidx5.i193.prol, align 2
  %conv6.i194.prol = sext i16 %145 to i32
  %incdec.ptr.i195.prol = getelementptr inbounds i8, ptr %134, i64 1
  br label %for.body.i182.prol.loopexit

for.body.i182.prol.loopexit:                      ; preds = %cond.end.i190.prol, %for.body.preheader.i180
  %conv6.i194.lcssa.unr = phi i32 [ undef, %for.body.preheader.i180 ], [ %conv6.i194.prol, %cond.end.i190.prol ]
  %yy_cp.013.i183.unr = phi ptr [ %134, %for.body.preheader.i180 ], [ %incdec.ptr.i195.prol, %cond.end.i190.prol ]
  %yy_current_state.012.i184.unr = phi i32 [ %136, %for.body.preheader.i180 ], [ %conv6.i194.prol, %cond.end.i190.prol ]
  %146 = icmp eq i64 %142, %139
  br i1 %146, label %yy_find_action.backedge, label %for.body.i182

for.body.i182:                                    ; preds = %for.body.i182.prol.loopexit, %cond.end.i190.1
  %yy_cp.013.i183 = phi ptr [ %incdec.ptr.i195.1, %cond.end.i190.1 ], [ %yy_cp.013.i183.unr, %for.body.i182.prol.loopexit ]
  %yy_current_state.012.i184 = phi i32 [ %conv6.i194.1, %cond.end.i190.1 ], [ %yy_current_state.012.i184.unr, %for.body.i182.prol.loopexit ]
  %idxprom.i185 = sext i32 %yy_current_state.012.i184 to i64
  %147 = load i8, ptr %yy_cp.013.i183, align 1
  %tobool.not.i186 = icmp eq i8 %147, 0
  br i1 %tobool.not.i186, label %cond.end.i190, label %cond.true.i187

cond.true.i187:                                   ; preds = %for.body.i182
  %idxprom2.i188 = zext i8 %147 to i64
  %arrayidx3.i189 = getelementptr inbounds [256 x i32], ptr @yy_ec, i64 0, i64 %idxprom2.i188
  %148 = load i32, ptr %arrayidx3.i189, align 4
  br label %cond.end.i190

cond.end.i190:                                    ; preds = %cond.true.i187, %for.body.i182
  %cond.i191 = phi i32 [ %148, %cond.true.i187 ], [ 1, %for.body.i182 ]
  %idxprom4.i192 = sext i32 %cond.i191 to i64
  %arrayidx5.i193 = getelementptr inbounds [60 x [24 x i16]], ptr @yy_nxt, i64 0, i64 %idxprom.i185, i64 %idxprom4.i192
  %149 = load i16, ptr %arrayidx5.i193, align 2
  %incdec.ptr.i195 = getelementptr inbounds i8, ptr %yy_cp.013.i183, i64 1
  %idxprom.i185.1 = sext i16 %149 to i64
  %150 = load i8, ptr %incdec.ptr.i195, align 1
  %tobool.not.i186.1 = icmp eq i8 %150, 0
  br i1 %tobool.not.i186.1, label %cond.end.i190.1, label %cond.true.i187.1

cond.true.i187.1:                                 ; preds = %cond.end.i190
  %idxprom2.i188.1 = zext i8 %150 to i64
  %arrayidx3.i189.1 = getelementptr inbounds [256 x i32], ptr @yy_ec, i64 0, i64 %idxprom2.i188.1
  %151 = load i32, ptr %arrayidx3.i189.1, align 4
  br label %cond.end.i190.1

cond.end.i190.1:                                  ; preds = %cond.true.i187.1, %cond.end.i190
  %cond.i191.1 = phi i32 [ %151, %cond.true.i187.1 ], [ 1, %cond.end.i190 ]
  %idxprom4.i192.1 = sext i32 %cond.i191.1 to i64
  %arrayidx5.i193.1 = getelementptr inbounds [60 x [24 x i16]], ptr @yy_nxt, i64 0, i64 %idxprom.i185.1, i64 %idxprom4.i192.1
  %152 = load i16, ptr %arrayidx5.i193.1, align 2
  %conv6.i194.1 = sext i16 %152 to i32
  %incdec.ptr.i195.1 = getelementptr inbounds i8, ptr %yy_cp.013.i183, i64 2
  %exitcond.not.i196.1 = icmp eq ptr %incdec.ptr.i195.1, %scevgep.i181
  br i1 %exitcond.not.i196.1, label %yy_find_action.backedge, label %for.body.i182
