; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/resolution.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/resolution.c"
...
for.inc.us:                                       ; preds = %land.lhs.true.us, %for.body9.us
  ...
  br i1 %9, label %for.body9.us, label %for.cond3.for.end_crit_edge.us
...
for.cond3.for.end_crit_edge.us:                   ; preds = %for.inc.us
  ...
  br i1 %10, label %for.body.us, label %for.end16
...
for.inc:                                          ; preds = %for.body6, %land.lhs.true, %land.lhs.true15, %land.lhs.true20
  ...
  br i1 %cmp.i.not, label %while.body.i62, label %for.body6

while.body.i62:                                   ; preds = %for.inc, %while.body.i62
  %Current.06.i63 = phi ptr [ %Current.0.val.i64, %while.body.i62 ], [ %call3, %for.inc ]
  ...
  %total_size.i.i.i65 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %21, i64 0, i32 4
  %22 = load i32, ptr %total_size.i.i.i65, align 8
  %conv26.i.i.i66 = sext i32 %22 to i64
  %23 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i67 = add i64 %23, %conv26.i.i.i66
  store i64 %add27.i.i.i67, ptr @memory_FREEDBYTES, align 8
  %24 = load ptr, ptr %21, align 8
  store ptr %24, ptr %Current.06.i63, align 8
  %25 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i63, ptr %25, align 8
  %cmp.i.not.i68 = icmp eq ptr %Current.0.val.i64, null
  br i1 %cmp.i.not.i68, label %list_Delete.exit69, label %while.body.i62

list_Delete.exit69:                               ; preds = %while.body.i62, %for.body
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
