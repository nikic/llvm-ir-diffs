; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/subst.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/subst.c"
...
if.end:                                           ; preds = %if.then, %while.body
  %1 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 24), align 8
  ...
  %5 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 24), align 8
...
while.body:                                       ; preds = %entry, %while.body
  ...
  %0 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 24), align 8
...
for.body:                                         ; preds = %if.else, %for.body
  ...
  br i1 %cmp.i29.not, label %if.end, label %for.body
...
for.body4:                                        ; preds = %for.body4.lr.ph, %for.body4
  ...
  br i1 %cmp.i28.not, label %for.end, label %for.body4
...
for.inc16:                                        ; preds = %for.end, %if.then10
  ...
  br i1 %cmp.i.not, label %for.end18, label %for.cond1.preheader
...
for.cond2.preheader.us.us:                        ; preds = %for.cond2.preheader.lr.ph, %for.cond2.preheader.us.us
  ...
  br i1 %cmp.i.not.us.us, label %for.end19, label %for.cond2.preheader.us.us
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  br i1 %cmp.i37.not, label %for.cond2.for.end_crit_edge, label %for.body5
...
for.inc.i:                                        ; preds = %for.body.i
  ...
  br i1 %cmp.i.not.i, label %if.then.loopexit, label %for.body.i
...
for.inc17:                                        ; preds = %for.body.i, %if.then.loopexit
  ...
  br i1 %cmp.i.not, label %for.end19, label %for.cond2.preheader
...
for.cond.i:                                       ; preds = %if.end.i, %for.cond.i
  ...
  br i1 %cmp4.not.i, label %for.end.i, label %for.cond.i
...
for.inc:                                          ; preds = %for.body9, %land.lhs.true13
  ...
  br i1 %cmp8.not, label %if.end19, label %for.body9
...
if.end19:                                         ; preds = %for.inc, %if.then, %land.lhs.true, %for.body
  ...
  br i1 %cmp.not, label %cleanup26, label %for.body
...
if.end42:                                         ; preds = %if.then11, %if.else34, %if.then24, %if.then
  ...
  br i1 %cmp.i118.not, label %do.end, label %do.body
