; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/foldfg.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/foldfg.c"
...
@.str.27 = private unnamed_addr constant [57 x i8] c"/home/npopov/repos/llvm-test-suite/CTMark/SPASS/foldfg.c\00", align 1
...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %cmp.i13.not, label %cleanup, label %for.cond
...
for.body:                                         ; preds = %if.else, %list_Nconc.exit
  %Result.040 = phi ptr [ %retval.0.i, %list_Nconc.exit ], [ null, %if.else ]
  %Scan.039 = phi ptr [ %Scan.0.val26, %list_Nconc.exit ], [ %Term.val28, %if.else ]
  %8 = getelementptr i8, ptr %Scan.039, i64 8
...
if.end.i:                                         ; preds = %for.body
  %cmp.i18.not.i = icmp eq ptr %Result.040, null
...
for.end.i:                                        ; preds = %for.cond.i
  store ptr %Result.040, ptr %List1.addr.0.i, align 8
  br label %list_Nconc.exit

list_Nconc.exit:                                  ; preds = %for.body, %if.end.i, %for.end.i
  %retval.0.i = phi ptr [ %call13, %for.end.i ], [ %Result.040, %for.body ], [ %call13, %if.end.i ]
  %Scan.0.val26 = load ptr, ptr %Scan.039, align 8
  %cmp.i30.not = icmp eq ptr %Scan.0.val26, null
  br i1 %cmp.i30.not, label %return, label %for.body
...
list_Nconc.exit:                                  ; preds = %for.body, %for.end.i
  ...
  br i1 %cmp.i84.not, label %for.end.loopexit, label %for.body
...
for.body23:                                       ; preds = %for.end, %for.body23
  ...
  br i1 %cmp.i87.not, label %for.end33, label %for.body23
...
while.body.i:                                     ; preds = %for.end33, %while.body.i
  ...
  br i1 %cmp.i.not.i96, label %if.end50, label %while.body.i

for.body39:                                       ; preds = %if.then, %for.body39
  %Scan1.2112 = phi ptr [ %Scan1.2.val75, %for.body39 ], [ %Formula.val81, %if.then ]
  %26 = getelementptr i8, ptr %Scan1.2112, i64 8
  %Scan1.2.val = load ptr, ptr %26, align 8
  tail call fastcc void @fol_NormalizeVarsIntern(ptr noundef %Scan1.2.val)
  %Scan1.2.val75 = load ptr, ptr %Scan1.2112, align 8
  %cmp.i97.not = icmp eq ptr %Scan1.2.val75, null
  br i1 %cmp.i97.not, label %if.end50, label %for.body39
...
fol_IsLiteral.exit:                               ; preds = %land.rhs.i
  ...
  %and.i.i18.i = and i32 %0, %sub.i.i17.i
  %cmp.i19.i.not = icmp eq i32 %and.i.i18.i, 2
  br i1 %cmp.i19.i.not, label %if.end20, label %if.then
...
for.body:                                         ; preds = %if.end, %for.body
  ...
  br i1 %cmp.i37.not, label %if.end20, label %for.body
...
while.body:                                       ; preds = %land.rhs35
  ...
  br i1 %cmp.i84.not, label %cleanup, label %land.rhs35
...
for.body.i:                                       ; preds = %entry, %for.body.i.1
  ...
  %indvars.iv.next.i = or i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 3001
  br i1 %exitcond.not.i, label %term_ActMark.exit122, label %for.body.i.1
...
term_ActMark.exit:                                ; preds = %entry
  ...
  br i1 %cmp.i115, label %for.body.i117, label %term_ActMark.exit122

for.body.i117:                                    ; preds = %term_ActMark.exit, %for.body.i117.1
  %indvars.iv.i118 = phi i64 [ %indvars.iv.next.i120.3, %for.body.i117.1 ], [ 0, %term_ActMark.exit ]
  %arrayidx.i119 = getelementptr inbounds [3001 x [2 x ptr]], ptr @term_BIND, i64 0, i64 %indvars.iv.i118
  store ptr null, ptr %arrayidx.i119, align 16
  %indvars.iv.next.i120 = or i64 %indvars.iv.i118, 1
  %exitcond.not.i121 = icmp eq i64 %indvars.iv.next.i120, 3001
  br i1 %exitcond.not.i121, label %term_ActMark.exit122, label %for.body.i117.1

for.body.i117.1:                                  ; preds = %for.body.i117
  %arrayidx.i119.1 = getelementptr inbounds [3001 x [2 x ptr]], ptr @term_BIND, i64 0, i64 %indvars.iv.next.i120
  store ptr null, ptr %arrayidx.i119.1, align 16
  %indvars.iv.next.i120.1 = or i64 %indvars.iv.i118, 2
  %arrayidx.i119.2 = getelementptr inbounds [3001 x [2 x ptr]], ptr @term_BIND, i64 0, i64 %indvars.iv.next.i120.1
  store ptr null, ptr %arrayidx.i119.2, align 16
  %indvars.iv.next.i120.2 = or i64 %indvars.iv.i118, 3
  %arrayidx.i119.3 = getelementptr inbounds [3001 x [2 x ptr]], ptr @term_BIND, i64 0, i64 %indvars.iv.next.i120.2
  store ptr null, ptr %arrayidx.i119.3, align 16
  %indvars.iv.next.i120.3 = add nuw nsw i64 %indvars.iv.i118, 4
  br label %for.body.i117

term_ActMark.exit122:                             ; preds = %for.body.i117, %for.body.i, %term_ActMark.exit
  %2 = phi i32 [ %1, %term_ActMark.exit ], [ 1, %for.body.i ], [ %1, %for.body.i117 ]
  %3 = phi i32 [ %inc4.i, %term_ActMark.exit ], [ 2, %for.body.i ], [ 1, %for.body.i117 ]
  %inc4.i116 = add nuw i32 %3, 1
  store i32 %inc4.i116, ptr @term_MARK, align 4
...
do.body:                                          ; preds = %do.cond, %term_ActMark.exit122
  %stack_POINTER.promoted202 = phi i32 [ %0, %term_ActMark.exit122 ], [ %stack_POINTER.promoted203, %do.cond ]
...
for.end:                                          ; preds = %for.end.loopexit, %if.then8
  ...
  %inc.i = add i32 %stack_POINTER.promoted202, 1
  store i32 %inc.i, ptr @stack_POINTER, align 4
  %idxprom.i = zext i32 %stack_POINTER.promoted202 to i64
  ...
  %inc.i131 = add i32 %stack_POINTER.promoted202, 2
...
for.body32:                                       ; preds = %if.else, %for.inc41
  %Scan.1192 = phi ptr [ %Scan.1.val107, %for.inc41 ], [ %Term.addr.0.val113, %if.else ]
  %16 = getelementptr i8, ptr %Scan.1192, i64 8
...
for.inc41:                                        ; preds = %for.body32, %if.then37
  %Scan.1.val107 = load ptr, ptr %Scan.1192, align 8
  %cmp.i136.not = icmp eq ptr %Scan.1.val107, null
  br i1 %cmp.i136.not, label %for.end43, label %for.body32

for.end43:                                        ; preds = %for.inc41
  %sub.i = add i32 %stack_POINTER.promoted202, -1
...
if.else46:                                        ; preds = %if.else
  %inc.i149 = add i32 %stack_POINTER.promoted202, 1
  store i32 %inc.i149, ptr @stack_POINTER, align 4
  %idxprom.i150 = zext i32 %stack_POINTER.promoted202 to i64
...
if.end61:                                         ; preds = %if.else50, %land.lhs.true, %if.then58, %for.end, %if.else46, %for.end43
  %stack_POINTER.promoted = phi i32 [ %inc.i131, %for.end ], [ %stack_POINTER.promoted202, %for.end43 ], [ %inc.i149, %if.else46 ], [ %stack_POINTER.promoted202, %land.lhs.true ], [ %stack_POINTER.promoted.pre, %if.then58 ], [ %stack_POINTER.promoted202, %if.else50 ]
  ...
  %cmp.i165.not194 = icmp eq i32 %stack_POINTER.promoted, %0
  br i1 %cmp.i165.not194, label %do.end, label %land.rhs

land.rhs:                                         ; preds = %if.end61, %while.body
  %stack_POINTER.promoted203 = phi i32 [ %sub.i167, %while.body ], [ %stack_POINTER.promoted, %if.end61 ]
  %sub.i167 = add i32 %stack_POINTER.promoted203, -1
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i165.not, label %do.end, label %land.rhs
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i47.not, label %do.end, label %land.rhs
...
fol_IsLiteral.exit:                               ; preds = %land.rhs.i
  %sub.i.i17.i = sub nsw i32 0, %call6.val.i
  %and.i.i18.i = and i32 %5, %sub.i.i17.i
  %cmp.i19.i.not = icmp eq i32 %and.i.i18.i, 2
  br i1 %cmp.i19.i.not, label %if.end12, label %cleanup
...
for.body17.preheader:                             ; preds = %if.then11, %if.then
  br label %for.body17

for.body17:                                       ; preds = %for.body17.preheader, %if.end24
  %Scan.161 = phi ptr [ %Scan.1.val52, %if.end24 ], [ %Formulae, %for.body17.preheader ]
  %5 = getelementptr i8, ptr %Scan.161, i64 8
...
if.end24:                                         ; preds = %if.then20, %for.body17
  ...
  %Scan.1.val52 = load ptr, ptr %Scan.161, align 8
  %cmp.i56.not = icmp eq ptr %Scan.1.val52, null
  br i1 %cmp.i56.not, label %for.end30, label %for.body17
...
if.end23:                                         ; preds = %if.else21, %if.then19
  ...
  br i1 %cmp.i186.not, label %for.end.loopexit, label %for.body
...
for.body33:                                       ; preds = %for.end, %for.body33
  ...
  br i1 %cmp.i190.not, label %common.ret238, label %for.body33
...
lor.rhs.i:                                        ; preds = %symbol_IsPredicate.exit.i, %for.body69
  ...
  br i1 %cmp.i14.not.i, label %land.rhs.i206, label %if.else75

land.rhs.i206:                                    ; preds = %lor.rhs.i
...
fol_IsLiteral.exit:                               ; preds = %land.rhs.i206
  %sub.i.i17.i = sub nsw i32 0, %call6.val.i
  %and.i.i18.i = and i32 %28, %sub.i.i17.i
  %cmp.i19.i.not = icmp eq i32 %and.i.i18.i, 2
  br i1 %cmp.i19.i.not, label %if.then73, label %if.else75
...
if.else75:                                        ; preds = %land.rhs.i206, %lor.rhs.i, %fol_IsLiteral.exit
...
for.inc109:                                       ; preds = %if.then105, %if.end101
  ...
  br i1 %cmp.i202.not, label %for.end111, label %for.body69
...
do.cond:                                          ; preds = %if.then13, %if.else
  ...
  br i1 %cmp.i77.not, label %do.end, label %do.body
...
do.cond41:                                        ; preds = %if.then36, %if.else38
  ...
  br i1 %cmp.i96.not, label %do.end45, label %do.body24
...
for.inc29:                                        ; preds = %for.body18
  ...
  br i1 %cmp.i54.not, label %while.body.i.preheader, label %for.body18
...
while.body.i:                                     ; preds = %while.body.i.preheader, %while.body.i
  ...
  br i1 %cmp.i.not.i59, label %if.end32, label %while.body.i
...
for.inc49:                                        ; preds = %if.then45, %if.else
  ...
  br i1 %cmp.i92.not, label %for.end51, label %for.body19
...
while.body.i:                                     ; preds = %for.end51, %while.body.i
  ...
  br i1 %cmp.i.not.i104, label %if.end53, label %while.body.i
...
return:                                           ; preds = %land.rhs.i, %if.then, %if.end25, %land.lhs.true30, %land.lhs.true36, %land.lhs.true42, %land.lhs.true47, %land.lhs.true53, %land.lhs.true59, %land.lhs.true, %land.lhs.true7, %entry, %if.then64, %if.else
  %retval.3 = phi i32 [ 1, %if.then64 ], [ 0, %if.else ], [ 0, %entry ], [ 0, %land.lhs.true7 ], [ 0, %land.lhs.true ], [ 0, %land.lhs.true59 ], [ 0, %land.lhs.true53 ], [ 0, %land.lhs.true47 ], [ 0, %land.lhs.true42 ], [ 0, %land.lhs.true36 ], [ 0, %land.lhs.true30 ], [ 0, %if.end25 ], [ 0, %if.then ], [ 0, %land.rhs.i ]
  ret i32 %retval.3
}
...
symbol_IsFunction.exit:                           ; preds = %land.rhs.i
  ...
  br i1 %or.cond186, label %cleanup, label %land.rhs.i140

lor.lhs.false8:                                   ; preds = %land.rhs.i
  %tobool.not.i139.old = icmp sgt i32 %call2.val137, -1
  br i1 %tobool.not.i139.old, label %cleanup, label %land.rhs.i140

land.rhs.i140:                                    ; preds = %symbol_IsFunction.exit, %lor.lhs.false8
  %sub.i.i141 = sub nsw i32 0, %call2.val137
  %and.i.i142 = and i32 %4, %sub.i.i141
  %switch = icmp ult i32 %and.i.i142, 2
  br i1 %switch, label %lor.lhs.false12, label %cleanup

lor.lhs.false12:                                  ; preds = %land.rhs.i140
  %5 = load i32, ptr @symbol_TYPESTATBITS, align 4
  %shr.i.i = lshr i32 %sub.i.i, %5
  %6 = load ptr, ptr @symbol_SIGNATURE, align 8
  %idxprom.i.i = zext i32 %shr.i.i to i64
...
lor.lhs.false15:                                  ; preds = %lor.lhs.false12
  %shr.i.i150 = lshr i32 %sub.i.i141, %5
...
cleanup:                                          ; preds = %land.rhs.i140, %lor.lhs.false8, %if.end46, %land.lhs.true, %land.lhs.true55, %land.lhs.true60, %land.lhs.true65, %land.lhs.true70, %if.end33, %lor.lhs.false37, %lor.lhs.false41, %if.else, %if.end, %symbol_IsFunction.exit, %lor.lhs.false12, %lor.lhs.false15, %entry, %if.then75
  %retval.0 = phi i32 [ 1, %if.then75 ], [ 0, %entry ], [ 0, %lor.lhs.false15 ], [ 0, %lor.lhs.false12 ], [ 0, %symbol_IsFunction.exit ], [ 0, %if.end ], [ 0, %if.else ], [ 0, %lor.lhs.false41 ], [ 0, %lor.lhs.false37 ], [ 0, %if.end33 ], [ 0, %land.lhs.true70 ], [ 0, %land.lhs.true65 ], [ 0, %land.lhs.true60 ], [ 0, %land.lhs.true55 ], [ 0, %land.lhs.true ], [ 0, %if.end46 ], [ 0, %lor.lhs.false8 ], [ 0, %land.rhs.i140 ]
  ret i32 %retval.0
}
...
while.body.i.i:                                   ; preds = %while.body.i.i.prol.loopexit, %while.body.i.i
  ...
  %cmp.i61.i.1 = icmp ugt i32 %dec.i.i.i.i, 1
  br i1 %cmp.i61.i.1, label %while.body.i.i, label %while.end.i.i

while.end.i.i:                                    ; preds = %while.body.i.i.prol.loopexit, %while.body.i.i, %if.end21.i
  %22 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i58.i = icmp eq i32 %22, 0
  br i1 %cmp.i.not.i58.i, label %if.end23.i, label %if.then.i.i

if.then.i.i:                                      ; preds = %while.end.i.i
  %dec.i.i.i = add nsw i32 %22, -1
  store i32 %dec.i.i.i, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i59.i = sext i32 %dec.i.i.i to i64
  %arrayidx.i.i60.i = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i59.i
  %23 = load i32, ptr %arrayidx.i.i60.i, align 4
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  br i1 %cmp.i62.not.i, label %fol_InstancesIntern.exit, label %land.rhs.i
...
while.body.i.i:                                   ; preds = %while.body.i.i.prol.loopexit, %while.body.i.i
  ...
  store i32 %dec.i.i.i.i.1, ptr @cont_BINDINGS, align 4
  %cmp.i86.i.1 = icmp ugt i32 %dec.i.i.i.i, 1
  br i1 %cmp.i86.i.1, label %while.body.i.i, label %while.end.i.i

while.end.i.i:                                    ; preds = %while.body.i.i.prol.loopexit, %while.body.i.i, %if.end22.i
  %23 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i83.i = icmp eq i32 %23, 0
  br i1 %cmp.i.not.i83.i, label %if.end40.i, label %if.then.i.i

if.then.i.i:                                      ; preds = %while.end.i.i
  %dec.i.i.i = add nsw i32 %23, -1
  store i32 %dec.i.i.i, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i84.i = sext i32 %dec.i.i.i to i64
  %arrayidx.i.i85.i = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i84.i
  %24 = load i32, ptr %arrayidx.i.i85.i, align 4
...
symbol_IsPredicate.exit93.i:                      ; preds = %if.else24.i
  %sub.i.i89.i = sub nsw i32 0, %Formula.addr.0.val72.i
  %and.i.i90.i = and i32 %1, %sub.i.i89.i
  %cmp.i91.not.i = icmp eq i32 %and.i.i90.i, 2
  br i1 %cmp.i91.not.i, label %if.end40.i, label %if.then28.i
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  br i1 %cmp.i104.not.i, label %fol_GeneralizationsIntern.exit, label %land.rhs.i
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  %cmp.i18.1 = icmp ugt i32 %dec.i.i.i, 1
  br i1 %cmp.i18.1, label %while.body.i, label %while.end.i
...
if.then.i:                                        ; preds = %while.end.i
  ...
  %idxprom.i.i16 = sext i32 %dec.i.i to i64
  %arrayidx.i.i17 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i16
...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %cmp.i56.not, label %cleanup, label %for.cond
...
for.body26:                                       ; preds = %if.else, %for.body26
  ...
  br i1 %cmp.i60.not, label %cleanup, label %for.body26
...
fol_IsLiteral.exit:                               ; preds = %land.rhs.i
  ...
  %and.i.i18.i = and i32 %7, %sub.i.i17.i
  %cmp.i19.i.not = icmp eq i32 %and.i.i18.i, 2
  br i1 %cmp.i19.i.not, label %if.then6, label %if.else
...
symbol_IsJunctor.exit:                            ; preds = %if.else
  ...
  %cmp.i75.not = icmp eq i32 %and.i.i, 3
  br i1 %cmp.i75.not, label %if.then9, label %if.else43
...
for.inc30:                                        ; preds = %for.body22
  ...
  br i1 %cmp.i81.not, label %for.end32, label %for.body22
...
for.body:                                         ; preds = %if.end, %for.inc
  %l.047 = phi ptr [ %l.0.val34, %for.inc ], [ %Term.val37, %if.end ]
  %5 = getelementptr i8, ptr %l.047, i64 8
...
for.inc:                                          ; preds = %cleanup
  %l.0.val34 = load ptr, ptr %l.047, align 8
  %cmp.i38.not = icmp eq ptr %l.0.val34, null
  br i1 %cmp.i38.not, label %cleanup22, label %for.body

cleanup22:                                        ; preds = %for.body, %for.inc, %cleanup, %if.end
  %retval.2 = phi ptr [ null, %if.end ], [ %l.0.val33, %for.body ], [ null, %for.inc ], [ %call16, %cleanup ]
  ret ptr %retval.2
}

; Function Attrs: nofree nosync nounwind memory(read, inaccessiblemem: none) uwtable
define dso_local void @fol_CheckFatherLinks(ptr nocapture noundef readonly %Term) local_unnamed_addr #10 {
entry:
...
for.inc24:                                        ; preds = %for.body16
  ...
  br i1 %cmp.i99.not, label %for.end26, label %for.body16
...
for.inc45:                                        ; preds = %for.body36
  ...
  br i1 %cmp.i103.not, label %for.end47, label %for.body36
...
list_Nconc.exit:                                  ; preds = %for.body, %if.end.i, %for.end.i
  ...
  br i1 %cmp.i83.not, label %cleanup, label %for.body
...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %cmp.i23.not, label %cleanup, label %for.cond
...
if.end.lr.ph.i24:                                 ; preds = %if.then8
  ...
  %Subterm.val.i2877 = load ptr, ptr %22, align 8
  %cmp1.i2978 = icmp eq ptr %Subterm.val.i2877, %Term
  br i1 %cmp1.i2978, label %cleanup, label %if.end3.i30

if.end3.i30:                                      ; preds = %if.end.lr.ph.i24, %if.then25.i57
  %Subterm.val.i2881 = phi ptr [ %Subterm.val.i28, %if.then25.i57 ], [ %Subterm.val.i2877, %if.end.lr.ph.i24 ]
  %Subterm.tr59.i2780 = phi ptr [ %Subterm.val.i2881, %if.then25.i57 ], [ %Subterm, %if.end.lr.ph.i24 ]
  %SubtermPolar.tr60.i2679 = phi i32 [ %retval.0.i.i42, %if.then25.i57 ], [ 1, %if.end.lr.ph.i24 ]
  %call.val.i31 = load i32, ptr %Subterm.val.i2881, align 8
  %cmp.i.i32 = icmp eq ptr %Subterm.val.i2881, %Subterm.tr59.i2780
  %cmp.i.not.i.i33 = icmp eq i32 %call.val.i31, %15
  %or.cond.i.i34 = select i1 %cmp.i.i32, i1 true, i1 %cmp.i.not.i.i33
  %cmp.i40.not.i.i35 = icmp eq i32 %call.val.i31, %16
  %or.cond48.i.i36 = select i1 %or.cond.i.i34, i1 true, i1 %cmp.i40.not.i.i35
  br i1 %or.cond48.i.i36, label %fol_PolarCheckCount.exit.i41, label %lor.lhs.false4.i.i37

lor.lhs.false4.i.i37:                             ; preds = %if.end3.i30
  %cmp.i.not.i.i.i38 = icmp ne i32 %17, %call.val.i31
  %cmp.i4.i.i.i39 = icmp ne i32 %Term.val, %call.val.i31
  %narrow.i.not.i.i40 = and i1 %cmp.i.not.i.i.i38, %cmp.i4.i.i.i39
  br i1 %narrow.i.not.i.i40, label %lor.lhs.false7.i.i58, label %fol_PolarCheckCount.exit.i41

lor.lhs.false7.i.i58:                             ; preds = %lor.lhs.false4.i.i37
  %cmp.i42.not.i.i59 = icmp eq i32 %call.val.i31, %18
  br i1 %cmp.i42.not.i.i59, label %land.lhs.true.i.i70, label %lor.lhs.false12.i.i60

land.lhs.true.i.i70:                              ; preds = %lor.lhs.false7.i.i58
  %23 = getelementptr i8, ptr %Subterm.val.i2881, i64 16
  %SuperTerm.val39.i.i71 = load ptr, ptr %23, align 8
  %SuperTerm.val39.val.i.i72 = load ptr, ptr %SuperTerm.val39.i.i71, align 8
  %24 = getelementptr i8, ptr %SuperTerm.val39.val.i.i72, i64 8
  %SuperTerm.val39.val.val.i.i73 = load ptr, ptr %24, align 8
  %cmp11.i.i74 = icmp eq ptr %SuperTerm.val39.val.val.i.i73, %Subterm.tr59.i2780
  br i1 %cmp11.i.i74, label %fol_PolarCheckCount.exit.i41, label %lor.lhs.false12.i.i60

lor.lhs.false12.i.i60:                            ; preds = %land.lhs.true.i.i70, %lor.lhs.false7.i.i58
  %cmp.i44.not.i.i61 = icmp eq i32 %call.val.i31, %19
  br i1 %cmp.i44.not.i.i61, label %land.lhs.true15.i.i66, label %if.end19.i.i62

land.lhs.true15.i.i66:                            ; preds = %lor.lhs.false12.i.i60
  %25 = getelementptr i8, ptr %Subterm.val.i2881, i64 16
  %SuperTerm.val38.i.i67 = load ptr, ptr %25, align 8
  %26 = getelementptr i8, ptr %SuperTerm.val38.i.i67, i64 8
  %SuperTerm.val38.val.i.i68 = load ptr, ptr %26, align 8
  %cmp17.i.i69 = icmp eq ptr %SuperTerm.val38.val.i.i68, %Subterm.tr59.i2780
  br i1 %cmp17.i.i69, label %fol_PolarCheckCount.exit.i41, label %if.end19.i.i62

if.end19.i.i62:                                   ; preds = %land.lhs.true15.i.i66, %lor.lhs.false12.i.i60
  %cmp.i46.not.i.i63 = icmp eq i32 %call.val.i31, %20
  %sub.i.i64 = sub nsw i32 0, %SubtermPolar.tr60.i2679
  %spec.select.i.i65 = select i1 %cmp.i46.not.i.i63, i32 0, i32 %sub.i.i64
  br label %fol_PolarCheckCount.exit.i41

fol_PolarCheckCount.exit.i41:                     ; preds = %if.end19.i.i62, %land.lhs.true15.i.i66, %land.lhs.true.i.i70, %lor.lhs.false4.i.i37, %if.end3.i30
  %retval.0.i.i42 = phi i32 [ %SubtermPolar.tr60.i2679, %if.end3.i30 ], [ %SubtermPolar.tr60.i2679, %land.lhs.true15.i.i66 ], [ %SubtermPolar.tr60.i2679, %land.lhs.true.i.i70 ], [ %SubtermPolar.tr60.i2679, %lor.lhs.false4.i.i37 ], [ %spec.select.i.i65, %if.end19.i.i62 ]
  %cmp.i48.not.i43 = icmp eq i32 %call.val.i31, %21
  br i1 %cmp.i48.not.i43, label %if.then25.i57, label %lor.lhs.false.i44

lor.lhs.false.i44:                                ; preds = %fol_PolarCheckCount.exit.i41
  %cmp9.i45 = icmp eq i32 %retval.0.i.i42, -1
  %or.cond.i46 = select i1 %cmp.i.not.i.i33, i1 %cmp9.i45, i1 false
  %cmp14.i47 = icmp eq i32 %retval.0.i.i42, 1
  %or.cond30.i48 = select i1 %cmp.i40.not.i.i35, i1 %cmp14.i47, i1 false
  %or.cond57.i49 = select i1 %or.cond.i46, i1 true, i1 %or.cond30.i48
  %cmp.i53.i50 = icmp eq i32 %call.val.i31, %18
  %or.cond31.i51 = select i1 %cmp.i53.i50, i1 %cmp9.i45, i1 false
  %or.cond63.i52 = select i1 %or.cond57.i49, i1 true, i1 %or.cond31.i51
  %cmp.i55.i53 = icmp eq i32 %call.val.i31, %19
  %or.cond32.i54 = select i1 %cmp.i55.i53, i1 %cmp9.i45, i1 false
  %or.cond64.i55 = select i1 %or.cond63.i52, i1 true, i1 %or.cond32.i54
  br i1 %or.cond64.i55, label %if.then25.i57, label %cleanup

if.then25.i57:                                    ; preds = %lor.lhs.false.i44, %fol_PolarCheckCount.exit.i41
  %27 = getelementptr i8, ptr %Subterm.val.i2881, i64 8
  %Subterm.val.i28 = load ptr, ptr %27, align 8
  %cmp1.i29 = icmp eq ptr %Subterm.val.i28, %Term
  br i1 %cmp1.i29, label %cleanup, label %if.end3.i30

cleanup:                                          ; preds = %if.then25.i57, %lor.lhs.false.i44, %if.then25.i, %lor.lhs.false.i, %if.end.lr.ph.i24, %if.end.lr.ph.i, %if.then8, %land.lhs.true, %if.then, %land.lhs.true5, %entry
  %retval.0 = phi i32 [ 0, %entry ], [ 0, %land.lhs.true5 ], [ 1, %if.then ], [ 0, %land.lhs.true ], [ 1, %if.then8 ], [ 1, %if.end.lr.ph.i ], [ 1, %if.end.lr.ph.i24 ], [ 1, %if.then25.i ], [ 0, %lor.lhs.false.i ], [ 1, %if.then25.i57 ], [ 0, %lor.lhs.false.i44 ]
  ret i32 %retval.0
}
...
while.body.ithread-pre-split:                     ; preds = %while.body.ithread-pre-split.preheader, %while.body.ithread-pre-split
  ...
  br i1 %cmp.i.not.i, label %list_Delete.exit, label %while.body.ithread-pre-split
...
list_Delete.exit:                                 ; preds = %while.body.ithread-pre-split
  ...
  %cmp.i.not34 = icmp eq ptr %call1.val25, null
  br i1 %cmp.i.not34, label %for.end, label %for.body

for.body:                                         ; preds = %list_Delete.exit, %for.inc
  %Scan.035 = phi ptr [ %Scan.0.val24, %for.inc ], [ %call1.val25, %list_Delete.exit ]
  %14 = getelementptr i8, ptr %Scan.035, i64 8
...
for.inc:                                          ; preds = %for.body, %if.then
  %Scan.0.val24 = load ptr, ptr %Scan.035, align 8
...
while.body.ithread-pre-split.i:                   ; preds = %while.body.ithread-pre-split.i, %if.then14
  ...
  br i1 %cmp.i.not.i.i, label %list_Delete.exit.i, label %while.body.ithread-pre-split.i
...
list_Delete.exit.i:                               ; preds = %while.body.ithread-pre-split.i
  ...
  %cmp.i.not34.i = icmp eq ptr %call1.val25.i, null
  br i1 %cmp.i.not34.i, label %fol_PopQuantifier.exit, label %for.body.i

for.body.i:                                       ; preds = %list_Delete.exit.i, %for.inc.i
  %Scan.035.i = phi ptr [ %Scan.0.val24.i, %for.inc.i ], [ %call1.val25.i, %list_Delete.exit.i ]
  %19 = getelementptr i8, ptr %Scan.035.i, i64 8
...
for.inc.i:                                        ; preds = %if.then.i, %for.body.i
  %Scan.0.val24.i = load ptr, ptr %Scan.035.i, align 8
  %cmp.i.not.i = icmp eq ptr %Scan.0.val24.i, null
  br i1 %cmp.i.not.i, label %fol_PopQuantifier.exit, label %for.body.i
...
for.body.i:                                       ; preds = %if.then32, %for.body.i
  ...
  br i1 %cmp.i.not.i69, label %for.end.i, label %for.body.i
...
list_Delete.exit.i:                               ; preds = %while.body.i.i, %for.end.i, %if.then32
  ...
  br i1 %cmp.i.not5.i53.i, label %list_Delete.exit61.i, label %while.body.i54.i

while.body.i54.i:                                 ; preds = %list_Delete.exit.i, %while.body.i54.i
  %Current.06.i55.i = phi ptr [ %Current.0.val.i56.i, %while.body.i54.i ], [ %call1.val.i, %list_Delete.exit.i ]
  %Current.0.val.i56.i = load ptr, ptr %Current.06.i55.i, align 8
  %27 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i57.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %27, i64 0, i32 4
  %28 = load i32, ptr %total_size.i.i.i57.i, align 8
  %conv26.i.i.i58.i = sext i32 %28 to i64
  %29 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i59.i = add i64 %29, %conv26.i.i.i58.i
  store i64 %add27.i.i.i59.i, ptr @memory_FREEDBYTES, align 8
  %30 = load ptr, ptr %27, align 8
  store ptr %30, ptr %Current.06.i55.i, align 8
  %31 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i55.i, ptr %31, align 8
  %cmp.i.not.i60.i = icmp eq ptr %Current.0.val.i56.i, null
  br i1 %cmp.i.not.i60.i, label %list_Delete.exit61.i, label %while.body.i54.i

list_Delete.exit61.i:                             ; preds = %while.body.i54.i, %list_Delete.exit.i
...
while.body.i65.i:                                 ; preds = %while.body.i65.i, %list_Delete.exit61.i
  %Current.06.i66.i = phi ptr [ %Current.0.val.i67.i, %while.body.i65.i ], [ %Term.val55, %list_Delete.exit61.i ]
  %Current.0.val.i67.i = load ptr, ptr %Current.06.i66.i, align 8
  %32 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i68.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %32, i64 0, i32 4
  %33 = load i32, ptr %total_size.i.i.i68.i, align 8
  %conv26.i.i.i69.i = sext i32 %33 to i64
  %34 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i70.i = add i64 %34, %conv26.i.i.i69.i
  store i64 %add27.i.i.i70.i, ptr @memory_FREEDBYTES, align 8
  %35 = load ptr, ptr %32, align 8
  store ptr %35, ptr %Current.06.i66.i, align 8
  %36 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i66.i, ptr %36, align 8
  %cmp.i.not.i71.i = icmp eq ptr %Current.0.val.i67.i, null
  br i1 %cmp.i.not.i71.i, label %cleanup, label %while.body.i65.i

cleanup:                                          ; preds = %while.body.i65.i, %for.body, %if.then6, %if.then18, %land.lhs.true, %if.else
  %retval.0 = phi i32 [ 0, %land.lhs.true ], [ 0, %if.then18 ], [ 0, %if.else ], [ 0, %if.then6 ], [ %spec.select, %for.body ], [ 1, %while.body.i65.i ]
  ret i32 %retval.0
}
...
for.body:                                         ; preds = %if.end42, %for.body
  ...
  br i1 %cmp.i85.not, label %cleanup, label %for.body
...
if.end20:                                         ; preds = %if.end14, %if.then17
  ...
  %Predicat.0.val124.pre = load i32, ptr %Predicat.0, align 8
  br i1 %or.cond, label %land.lhs.true28, label %if.end20.if.end50_crit_edge

if.end20.if.end50_crit_edge:                      ; preds = %if.end20
  %.pre = load i32, ptr @symbol_TYPESTATBITS, align 4
  %.pre178 = load ptr, ptr @symbol_SIGNATURE, align 8
  br label %if.end50

land.lhs.true28:                                  ; preds = %if.end20
  %9 = load i32, ptr @fol_NOT, align 4
  %cmp.i141.not = icmp eq i32 %Predicat.0.val124.pre, %9
  %.pre177 = load i32, ptr @symbol_TYPESTATBITS, align 4
  %.pre179 = load ptr, ptr @symbol_SIGNATURE, align 8
  br i1 %cmp.i141.not, label %land.lhs.true33, label %if.end50
...
land.lhs.true33:                                  ; preds = %land.lhs.true28
  ...
  %shr.i.i = ashr i32 %sub.i.i, %.pre177
  %idxprom.i.i = sext i32 %shr.i.i to i64
  %arrayidx.i.i = getelementptr inbounds ptr, ptr %.pre179, i64 %idxprom.i.i
  ...
  %14 = and i32 %13, 768
  %or.cond.not = icmp eq i32 %14, 768
  br i1 %or.cond.not, label %land.lhs.true43, label %if.end50

land.lhs.true43:                                  ; preds = %land.lhs.true33
  %15 = getelementptr i8, ptr %Predicat.0.val133.val, i64 16
  %call44.val = load ptr, ptr %15, align 8
  %16 = getelementptr i8, ptr %call44.val, i64 8
  %call44.val.val = load ptr, ptr %16, align 8
...
if.end50:                                         ; preds = %if.end20.if.end50_crit_edge, %land.lhs.true43, %land.lhs.true33, %land.lhs.true28
  %17 = phi ptr [ %.pre178, %if.end20.if.end50_crit_edge ], [ %.pre179, %land.lhs.true43 ], [ %.pre179, %land.lhs.true33 ], [ %.pre179, %land.lhs.true28 ]
  %18 = phi i32 [ %.pre, %if.end20.if.end50_crit_edge ], [ %.pre177, %land.lhs.true43 ], [ %.pre177, %land.lhs.true33 ], [ %.pre177, %land.lhs.true28 ]
  %sub.i.i151 = sub nsw i32 0, %Predicat.0.val124.pre
  %shr.i.i152 = ashr i32 %sub.i.i151, %18
  %idxprom.i.i153 = sext i32 %shr.i.i152 to i64
  %arrayidx.i.i154 = getelementptr inbounds ptr, ptr %17, i64 %idxprom.i.i153
  %19 = load ptr, ptr %arrayidx.i.i154, align 8
  %props.i155 = getelementptr inbounds %struct.signature, ptr %19, i64 0, i32 4
  %20 = load i32, ptr %props.i155, align 4
  %21 = and i32 %20, 768
  %or.cond176.not = icmp eq i32 %21, 768
  br i1 %or.cond176.not, label %lor.lhs.false58, label %cleanup

lor.lhs.false58:                                  ; preds = %if.end50
  %22 = getelementptr i8, ptr %Predicat.0, i64 16
  %Predicat.0.val130 = load ptr, ptr %22, align 8
  %23 = getelementptr i8, ptr %Predicat.0.val130, i64 8
  %Predicat.0.val130.val = load ptr, ptr %23, align 8
...
if.else86:                                        ; preds = %if.end64
  ...
  %cmp.i173.not = icmp eq i32 %call.val, %27
...
cleanup.sink.split:                               ; preds = %if.else86, %land.lhs.true81, %if.then69, %land.lhs.true43
  ...
  %28 = getelementptr i8, ptr %call.val138, i64 16
  %Term.val.i175 = load ptr, ptr %28, align 8
  tail call void @list_DeleteWithElement(ptr noundef %Term.val.i175, ptr noundef nonnull @term_Delete) #18
  store ptr null, ptr %28, align 8
  %29 = load i32, ptr %fol_TRUE.sink, align 4
  store i32 %29, ptr %call.val138, align 8
  br label %cleanup
...
for.body.i.i:                                     ; preds = %land.lhs.true, %for.body.i.i.1
  ...
  br i1 %exitcond.not.i.i, label %fol_AlphaEqual.exit, label %for.body.i.i.1
...
for.body62:                                       ; preds = %if.end54, %for.body62
  ...
  br i1 %cmp.i127.not, label %cleanup, label %for.body62
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  br i1 %cmp.i146.not, label %for.end.loopexit, label %for.body
...
for.body46:                                       ; preds = %for.body46.preheader, %for.body46
  ...
  br i1 %cmp.i150.not, label %cleanup, label %for.body46
...
for.body69:                                       ; preds = %for.cond65
  ...
  br i1 %tobool73.not, label %cleanup, label %for.cond65
...
if.then27:                                        ; preds = %for.body22
  ...
  br i1 %cmp.i80.not, label %for.end34.loopexit, label %for.body22
...
for.body45:                                       ; preds = %if.end39, %for.body45
  ...
  br i1 %cmp.i85.not, label %cleanup, label %for.body45
...
for.body:                                         ; preds = %if.end8, %for.body
  ...
  br i1 %cmp.i31.not, label %for.end.loopexit, label %for.body
...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %cmp.i62.not, label %for.cond, label %cleanup
...
for.body17:                                       ; preds = %for.end, %for.body17
  ...
  br i1 %cmp.i64.not, label %cleanup, label %for.body17
...
for.body31:                                       ; preds = %if.else, %for.body31
  ...
  br i1 %cmp.i66.not, label %cleanup, label %for.body31
...
for.body:                                         ; preds = %if.else12, %for.body
  ...
  %cmp.i37.not = icmp eq ptr %Scan.0, null
  br i1 %cmp.i37.not, label %if.end19, label %for.body
...
symbol_IsJunctor.exit134:                         ; preds = %land.lhs.true
  %sub.i.i130 = sub nsw i32 0, %ActInstance.0.val
  %and.i.i131 = and i32 %4, %sub.i.i130
  %cmp.i132.not = icmp eq i32 %and.i.i131, 3
  br i1 %cmp.i132.not, label %if.else, label %land.lhs.true12
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i177.not, label %cleanup, label %land.rhs
...
symbol_IsJunctor.exit147:                         ; preds = %land.lhs.true
  %sub.i.i143 = sub nsw i32 0, %ActInstance.0.val
  %and.i.i144 = and i32 %3, %sub.i.i143
  %cmp.i145.not = icmp eq i32 %and.i.i144, 3
  br i1 %cmp.i145.not, label %if.else, label %land.lhs.true12
...
for.cond.i.4:                                     ; preds = %for.cond.i.3
  ...
  br i1 %exitcond.not.i.4, label %if.then21, label %for.body.i
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i193.not, label %cleanup, label %land.rhs
...
attributes #3 = { inlinehint mustprogress nofree norecurse nosync nounwind willreturn memory(read, argmem: none, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #12 = { nofree nosync nounwind memory(readwrite, argmem: read, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
