; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/SPASS/st.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/SPASS/st.c"
...
@.str.1 = private unnamed_addr constant [53 x i8] c"/home/npopov/repos/llvm-test-suite/CTMark/SPASS/st.c\00", align 1
...
entry:
  ...
  br i1 %cmp.i.not.i, label %if.end14.sink.split.i, label %for.cond.preheader.i
...
if.end13:                                         ; preds = %if.else, %if.then12, %if.then
  ...
  %StIndex.addr.0.val151 = load ptr, ptr %12, align 8
...
if.then10.i:                                      ; preds = %if.else9.i
  ...
  %call12.i = tail call i32 @subst_MatchTops(ptr noundef %Context, ptr noundef %19) #9
...
while.body.i.i:                                   ; preds = %while.body.i.i.prol.loopexit, %while.body.i.i
  ...
  %cmp.i38.i.1 = icmp ugt i32 %dec.i.i.i.i, 1
  br i1 %cmp.i38.i.1, label %while.body.i.i, label %while.end.i.i
...
if.then.i.i:                                      ; preds = %while.end.i.i
  ...
  %idxprom.i.i36.i = sext i32 %dec.i.i.i to i64
  %arrayidx.i.i37.i = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i36.i
  %33 = load i32, ptr %arrayidx.i.i37.i, align 4
  store i32 %33, ptr @cont_BINDINGS, align 4
  br label %for.inc.i

st_FirstVariant.exit.thread127:                   ; preds = %if.then.i99
  tail call void @subst_CloseVariables(ptr noundef %Context, ptr noundef nonnull %18) #9
  br label %while.body
...
for.inc.i:                                        ; preds = %if.then.i.i, %while.end.i.i
  ...
  br i1 %cmp.i.not.i100, label %st_FirstVariant.exit, label %for.body.i
...
if.end31:                                         ; preds = %if.else23, %if.then29, %if.then22
  ...
  %StIndex.addr.0.val = load ptr, ptr %38, align 8
  %cmp.i.i.not = icmp eq ptr %StIndex.addr.0.val, null
  br i1 %cmp.i.i.not, label %land.rhs, label %while.end

while.end:                                        ; preds = %if.end31, %if.end13
  %Current.1.val = phi ptr [ %StIndex.addr.0.val151, %if.end13 ], [ %StIndex.addr.0.val, %if.end31 ]
...
if.then39:                                        ; preds = %while.end
  %40 = getelementptr i8, ptr %StIndex.addr.0.lcssa, i64 16
  ...
  store ptr %Current.1.val, ptr %call.i, align 8
...
if.then44:                                        ; preds = %if.else42
  ...
  %41 = getelementptr i8, ptr %BestNonVariant.4138, i64 16
...
if.then47:                                        ; preds = %if.then44
  ...
  %42 = load ptr, ptr %subnodes48, align 8
  tail call fastcc void @st_CloseUsedVariables(ptr noundef %Context, ptr noundef %42)
  br label %if.end49

if.end49:                                         ; preds = %if.then47, %if.then44
  %43 = load ptr, ptr %BestNonVariant.4138, align 8
  %call50 = call ptr @subst_ComGen(ptr noundef %Context, ptr noundef %43, ptr noundef nonnull %SubstOld, ptr noundef nonnull %SubstNew) #9
  %44 = load ptr, ptr %SubstOld, align 8
  %45 = load ptr, ptr %SubstNew, align 8
  %call51 = call ptr @subst_CloseOpenVariables(ptr noundef %45) #9
  %call.i.i = call ptr @memory_Malloc(i32 noundef 32) #9
  store ptr %44, ptr %call.i.i, align 8
  %46 = load ptr, ptr %41, align 8
  %entries1.i = getelementptr inbounds %struct.st, ptr %call.i.i, i64 0, i32 2
  store ptr %46, ptr %entries1.i, align 8
  %subnodes.i = getelementptr inbounds %struct.st, ptr %BestNonVariant.4138, i64 0, i32 1
  %47 = load ptr, ptr %subnodes.i, align 8
  %subnodes2.i = getelementptr inbounds %struct.st, ptr %call.i.i, i64 0, i32 1
  store ptr %47, ptr %subnodes2.i, align 8
  %48 = getelementptr i8, ptr %BestNonVariant.4138, i64 24
  %StIndex.val43.i = load i16, ptr %48, align 8
  %max.i.i = getelementptr inbounds %struct.st, ptr %call.i.i, i64 0, i32 3
  store i16 %StIndex.val43.i, ptr %max.i.i, align 8
  %49 = getelementptr i8, ptr %BestNonVariant.4138, i64 26
  %StIndex.val45.i = load i16, ptr %49, align 2
  %min.i.i = getelementptr inbounds %struct.st, ptr %call.i.i, i64 0, i32 4
  store i16 %StIndex.val45.i, ptr %min.i.i, align 2
  %50 = load ptr, ptr %BestNonVariant.4138, align 8
  call void @subst_Delete(ptr noundef %50) #9
...
if.else52:                                        ; preds = %land.rhs, %if.else42
  ...
  %51 = load ptr, ptr %subnodes56, align 8
  ...
  store ptr %51, ptr %call.i116, align 8
...
if.end60:                                         ; preds = %st_NodeAddInner.exit, %if.else52, %if.then39
  ...
  %tobool.not2.i = icmp eq ptr %52, null
...
while.body.i:                                     ; preds = %while.body.i, %while.body.preheader.i
  %53 = phi ptr [ %56, %while.body.i ], [ %52, %while.body.preheader.i ]
  ...
  %call.val.i.i.i = load ptr, ptr %54, align 8
  store ptr %call.val.i.i.i, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i = getelementptr inbounds %struct.binding, ptr %53, i64 0, i32 1
  ...
  %link.i.i.i.i = getelementptr inbounds %struct.binding, ptr %55, i64 0, i32 4
...
for.inc:                                          ; preds = %for.body5, %if.then
  ...
  br i1 %cmp.i35.not, label %for.end.loopexit, label %for.body5
...
while.body.i:                                     ; preds = %if.else, %while.body.i
  ...
  br i1 %cmp.i.not.i, label %if.end3, label %while.body.i
...
if.then15:                                        ; preds = %if.then8
  ...
  %max.i = getelementptr inbounds %struct.st, ptr %StIndex, i64 0, i32 3
  store i16 %call17.val, ptr %max.i, align 8
  %10 = getelementptr i8, ptr %.val, i64 26
  %call17.val86 = load i16, ptr %10, align 2
  %min.i = getelementptr inbounds %struct.st, ptr %StIndex, i64 0, i32 4
...
for.body25:                                       ; preds = %if.then15, %for.inc
  %call26.val85120 = phi i16 [ %call26.val85119, %for.inc ], [ %call17.val86, %if.then15 ]
  %call26.val82118 = phi i16 [ %call26.val82117, %for.inc ], [ %call17.val, %if.then15 ]
  ...
  %cmp = icmp ugt i16 %call26.val82, %call26.val82118
...
if.end:                                           ; preds = %if.then31, %for.body25
  %call26.val82117 = phi i16 [ %call26.val82, %if.then31 ], [ %call26.val82118, %for.body25 ]
  %13 = getelementptr i8, ptr %Subnodes.1.val, i64 26
  %call26.val85 = load i16, ptr %13, align 2
  %cmp37 = icmp ult i16 %call26.val85, %call26.val85120
...
for.inc:                                          ; preds = %if.end, %if.then39
  %call26.val85119 = phi i16 [ %call26.val85120, %if.end ], [ %call26.val85, %if.then39 ]
  %Subnodes.1 = load ptr, ptr %Subnodes.1116, align 8
  %cmp.i91.not = icmp eq ptr %Subnodes.1, null
  br i1 %cmp.i91.not, label %for.end49, label %for.body25
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  %cmp.i99.1 = icmp ugt i32 %dec.i.i.i, 1
  br i1 %cmp.i99.1, label %while.body.i, label %while.end.i
...
if.then.i:                                        ; preds = %while.end.i
  ...
  %idxprom.i.i97 = sext i32 %dec.i.i to i64
  %arrayidx.i.i98 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i97
  %27 = load i32, ptr %arrayidx.i.i98, align 4
...
while.body.i100:                                  ; preds = %while.body.i100, %while.body.preheader.i
  %32 = phi ptr [ %35, %while.body.i100 ], [ %31, %while.body.preheader.i ]
  %dec.i.i13.i = phi i32 [ %dec.i.i.i104, %while.body.i100 ], [ %cont_BINDINGS.promoted.i, %while.body.preheader.i ]
  store ptr %32, ptr @cont_CURRENTBINDING, align 8
  %33 = getelementptr i8, ptr %32, i64 24
  %call.val.i.i.i101 = load ptr, ptr %33, align 8
  store ptr %call.val.i.i.i101, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i102 = getelementptr inbounds %struct.binding, ptr %32, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i102, i8 0, i64 20, i1 false)
  %34 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i103 = getelementptr inbounds %struct.binding, ptr %34, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i103, align 8
  %dec.i.i.i104 = add nsw i32 %dec.i.i13.i, -1
  store i32 %dec.i.i.i104, ptr @cont_BINDINGS, align 4
  %35 = load ptr, ptr @cont_LASTBINDING, align 8
  %tobool.not.i = icmp eq ptr %35, null
  br i1 %tobool.not.i, label %cont_Reset.exit, label %while.body.i100

cont_Reset.exit:                                  ; preds = %while.body.i100, %for.end49
  store i32 0, ptr @cont_BINDINGS, align 4
  store i32 1, ptr @cont_STACKPOINTER, align 4
  store i32 2000, ptr @cont_INDEXVARSCANNER, align 4
...
for.body:                                         ; preds = %for.body.preheader, %for.inc58
  %2 = phi i32 [ %39, %for.inc58 ], [ %.pre136, %for.body.preheader ]
...
if.end26:                                         ; preds = %if.then20, %if.then16
  ...
  %Subnodes.1128 = load ptr, ptr %.pre137, align 8
...
for.body36:                                       ; preds = %if.end26, %for.inc
  %call37.val102134 = phi i16 [ %call37.val102133, %for.inc ], [ %call28.val103, %if.end26 ]
  %call37.val99132 = phi i16 [ %call37.val99131, %for.inc ], [ %call28.val, %if.end26 ]
  ...
  %cmp = icmp ugt i16 %call37.val99, %call37.val99132
...
if.end44:                                         ; preds = %if.then42, %for.body36
  %call37.val99131 = phi i16 [ %call37.val99, %if.then42 ], [ %call37.val99132, %for.body36 ]
  %24 = getelementptr i8, ptr %Subnodes.1.val, i64 26
  %call37.val102 = load i16, ptr %24, align 2
  %cmp49 = icmp ult i16 %call37.val102, %call37.val102134
...
for.inc:                                          ; preds = %if.end44, %if.then51
  %call37.val102133 = phi i16 [ %call37.val102134, %if.end44 ], [ %call37.val102, %if.then51 ]
  %Subnodes.1 = load ptr, ptr %Subnodes.1130, align 8
  %cmp.i112.not = icmp eq ptr %Subnodes.1, null
  br i1 %cmp.i112.not, label %return, label %for.body36
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  store i32 %dec.i.i.i.1, ptr @cont_BINDINGS, align 4
  %cmp.i118.1 = icmp ugt i32 %dec.i.i.i, 1
  br i1 %cmp.i118.1, label %while.body.i, label %while.end.i
...
if.then.i:                                        ; preds = %while.end.i
  ...
  store i32 %dec.i.i, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i116 = sext i32 %dec.i.i to i64
  %arrayidx.i.i117 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i116
  %38 = load i32, ptr %arrayidx.i.i117, align 4
...
for.inc58:                                        ; preds = %while.end.i, %if.then.i
  ...
  br i1 %cmp.i108.not, label %return, label %for.body
...
while.body.i.i:                                   ; preds = %while.body.i.i.prol.loopexit, %while.body.i.i
  ...
  br i1 %cmp.i42.i.1, label %while.body.i.i, label %cont_StopAndBackTrack.exit.i
...
if.end8.i:                                        ; preds = %if.end.i, %for.cond.i
  ...
  %CurrentNode.0.in3.i = getelementptr i8, ptr %CurrentList.1.i, i64 8
  %CurrentNode.04.i = load ptr, ptr %CurrentNode.0.in3.i, align 8
  %19 = load ptr, ptr %CurrentNode.04.i, align 8
  %call115.i = tail call i32 @subst_Unify(ptr noundef %IndexContext, ptr noundef %19) #9
  %tobool12.not6.i = icmp eq i32 %call115.i, 0
  br i1 %tobool12.not6.i, label %for.end.i, label %for.body.i

for.body.i:                                       ; preds = %if.end8.i, %for.inc.i
  %CurrentNode.08.i = phi ptr [ %CurrentNode.0.i, %for.inc.i ], [ %CurrentNode.04.i, %if.end8.i ]
  %CurrentList.27.i = phi ptr [ %27, %for.inc.i ], [ %CurrentList.1.i, %if.end8.i ]
  %20 = getelementptr i8, ptr %CurrentNode.08.i, i64 16
...
if.else.i:                                        ; preds = %for.body.i
  %CurrentList.2.val39.i = load ptr, ptr %CurrentList.27.i, align 8
...
for.inc.i:                                        ; preds = %if.else22.i, %if.then20.i
  store i32 0, ptr @cont_BINDINGS, align 4
  %subnodes25.i = getelementptr inbounds %struct.st, ptr %CurrentNode.08.i, i64 0, i32 1
  ...
  br i1 %tobool12.not.i, label %for.end.i, label %for.body.i

for.end.i:                                        ; preds = %for.inc.i, %for.end.i.i, %if.end.i.i, %if.end8.i
  %CurrentList.22.i = phi ptr [ %CurrentList.27.i, %for.end.i.i ], [ %CurrentList.27.i, %if.end.i.i ], [ %CurrentList.1.i, %if.end8.i ], [ %27, %for.inc.i ]
  %Result.1.i = phi ptr [ %call4.i.i, %for.end.i.i ], [ %call4.i.i, %if.end.i.i ], [ %Result.0.i, %if.end8.i ], [ %Result.0.i, %for.inc.i ]
  %CurrentList.2.val.i = load ptr, ptr %CurrentList.22.i, align 8
  %.pr.i.i = load i32, ptr @cont_BINDINGS, align 4
  %cmp1.i54.i = icmp sgt i32 %.pr.i.i, 0
  br i1 %cmp1.i54.i, label %while.body.i55.i.preheader, label %for.cond.i.backedge

for.cond.i.backedge:                              ; preds = %while.body.i55.i.prol.loopexit, %while.body.i55.i, %for.end.i
  br label %for.cond.i

while.body.i55.i.preheader:                       ; preds = %for.end.i
  %xtraiter17 = and i32 %.pr.i.i, 1
  %lcmp.mod18.not = icmp eq i32 %xtraiter17, 0
  br i1 %lcmp.mod18.not, label %while.body.i55.i.prol.loopexit, label %while.body.i55.i.prol

while.body.i55.i.prol:                            ; preds = %while.body.i55.i.preheader
  ...
  br label %while.body.i55.i.prol.loopexit

while.body.i55.i.prol.loopexit:                   ; preds = %while.body.i55.i.prol, %while.body.i55.i.preheader
  %.unr = phi i32 [ %.pr.i.i, %while.body.i55.i.preheader ], [ %dec.i.i.i59.i.prol, %while.body.i55.i.prol ]
  %32 = icmp eq i32 %.pr.i.i, 1
  br i1 %32, label %for.cond.i.backedge, label %while.body.i55.i

while.body.i55.i:                                 ; preds = %while.body.i55.i.prol.loopexit, %while.body.i55.i
  %33 = phi i32 [ %dec.i.i.i59.i.1, %while.body.i55.i ], [ %.unr, %while.body.i55.i.prol.loopexit ]
  ...
  br i1 %cmp.i60.i.1, label %while.body.i55.i, label %for.cond.i.backedge
...
while.body.i.i:                                   ; preds = %while.body.i.i.prol.loopexit, %while.body.i.i
  ...
  br i1 %cmp.i41.i.1, label %while.body.i.i, label %cont_StopAndBackTrack.exit.i
...
if.end8.i:                                        ; preds = %if.end.i, %for.cond.i
  ...
  %CurrentNode.0.in3.i = getelementptr i8, ptr %CurrentList.1.i, i64 8
  %CurrentNode.04.i = load ptr, ptr %CurrentNode.0.in3.i, align 8
  %20 = load ptr, ptr %CurrentNode.04.i, align 8
  %call115.i = tail call i32 @subst_Match(ptr noundef %IndexContext, ptr noundef %20) #9
  %tobool12.not6.i = icmp eq i32 %call115.i, 0
  br i1 %tobool12.not6.i, label %for.end.i, label %for.body.i

for.body.i:                                       ; preds = %if.end8.i, %for.inc.i
  %CurrentNode.08.i = phi ptr [ %CurrentNode.0.i, %for.inc.i ], [ %CurrentNode.04.i, %if.end8.i ]
  %CurrentList.27.i = phi ptr [ %28, %for.inc.i ], [ %CurrentList.1.i, %if.end8.i ]
  %21 = getelementptr i8, ptr %CurrentNode.08.i, i64 16
...
if.else.i:                                        ; preds = %for.body.i
  %CurrentList.2.val38.i = load ptr, ptr %CurrentList.27.i, align 8
...
for.inc.i:                                        ; preds = %if.else21.i, %if.then19.i
  store i32 0, ptr @cont_BINDINGS, align 4
  %subnodes24.i = getelementptr inbounds %struct.st, ptr %CurrentNode.08.i, i64 0, i32 1
...
for.end.i:                                        ; preds = %for.inc.i, %for.end.i.i, %if.end.i.i, %if.end8.i
  %CurrentList.22.i = phi ptr [ %CurrentList.27.i, %for.end.i.i ], [ %CurrentList.27.i, %if.end.i.i ], [ %CurrentList.1.i, %if.end8.i ], [ %28, %for.inc.i ]
  %Result.1.i = phi ptr [ %call4.i.i, %for.end.i.i ], [ %call4.i.i, %if.end.i.i ], [ %Result.0.i, %if.end8.i ], [ %Result.0.i, %for.inc.i ]
  %CurrentList.2.val.i = load ptr, ptr %CurrentList.22.i, align 8
  %.pr.i.i = load i32, ptr @cont_BINDINGS, align 4
  %cmp1.i51.i = icmp sgt i32 %.pr.i.i, 0
  br i1 %cmp1.i51.i, label %while.body.i52.i.preheader, label %for.cond.i.backedge

for.cond.i.backedge:                              ; preds = %while.body.i52.i.prol.loopexit, %while.body.i52.i, %for.end.i
  br label %for.cond.i

while.body.i52.i.preheader:                       ; preds = %for.end.i
  %xtraiter18 = and i32 %.pr.i.i, 1
  %lcmp.mod19.not = icmp eq i32 %xtraiter18, 0
  br i1 %lcmp.mod19.not, label %while.body.i52.i.prol.loopexit, label %while.body.i52.i.prol

while.body.i52.i.prol:                            ; preds = %while.body.i52.i.preheader
  %30 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %30, ptr @cont_CURRENTBINDING, align 8
  %31 = getelementptr i8, ptr %30, i64 24
  ...
  br label %while.body.i52.i.prol.loopexit

while.body.i52.i.prol.loopexit:                   ; preds = %while.body.i52.i.prol, %while.body.i52.i.preheader
  %.unr = phi i32 [ %.pr.i.i, %while.body.i52.i.preheader ], [ %dec.i.i.i56.i.prol, %while.body.i52.i.prol ]
  %33 = icmp eq i32 %.pr.i.i, 1
  br i1 %33, label %for.cond.i.backedge, label %while.body.i52.i

while.body.i52.i:                                 ; preds = %while.body.i52.i.prol.loopexit, %while.body.i52.i
  %34 = phi i32 [ %dec.i.i.i56.i.1, %while.body.i52.i ], [ %.unr, %while.body.i52.i.prol.loopexit ]
  %35 = load ptr, ptr @cont_LASTBINDING, align 8
  ...
  br i1 %cmp.i57.i.1, label %while.body.i52.i, label %for.cond.i.backedge
...
while.body.i.i:                                   ; preds = %while.body.i.i.prol.loopexit, %while.body.i.i
  ...
  br i1 %cmp.i46.i.1, label %while.body.i.i, label %cont_StopAndBackTrack.exit.i
...
if.end8.i:                                        ; preds = %if.end.i, %for.cond.i
  ...
  %CurrentNode.0.in3.i = getelementptr i8, ptr %CurrentList.1.i, i64 8
  %CurrentNode.04.i = load ptr, ptr %CurrentNode.0.in3.i, align 8
  %21 = getelementptr i8, ptr %CurrentNode.04.i, i64 26
  %CurrentNode.0.val5.i = load i16, ptr %21, align 2
  %cmp.not6.i = icmp ugt i16 %CurrentNode.0.val5.i, %conv
  br i1 %cmp.not6.i, label %for.end.i, label %land.rhs.i

land.rhs.i:                                       ; preds = %if.end8.i, %for.inc.i
  %CurrentNode.08.i = phi ptr [ %CurrentNode.0.i, %for.inc.i ], [ %CurrentNode.04.i, %if.end8.i ]
  %CurrentList.27.i = phi ptr [ %30, %for.inc.i ], [ %CurrentList.1.i, %if.end8.i ]
  %22 = load ptr, ptr %CurrentNode.08.i, align 8
...
for.body.i:                                       ; preds = %land.rhs.i
  %23 = getelementptr i8, ptr %CurrentNode.08.i, i64 16
...
if.else.i:                                        ; preds = %for.body.i
  %CurrentList.2.val43.i = load ptr, ptr %CurrentList.27.i, align 8
...
for.inc.i:                                        ; preds = %if.else24.i, %if.then22.i
  store i32 0, ptr @cont_BINDINGS, align 4
  %subnodes27.i = getelementptr inbounds %struct.st, ptr %CurrentNode.08.i, i64 0, i32 1
  ...
  br i1 %cmp.not.i, label %for.end.i, label %land.rhs.i

for.end.i:                                        ; preds = %for.inc.i, %land.rhs.i, %for.end.i.i, %if.end.i.i, %if.end8.i
  %CurrentList.22.i = phi ptr [ %CurrentList.27.i, %for.end.i.i ], [ %CurrentList.27.i, %if.end.i.i ], [ %CurrentList.1.i, %if.end8.i ], [ %30, %for.inc.i ], [ %CurrentList.27.i, %land.rhs.i ]
  ...
  br i1 %cmp1.i56.i, label %while.body.i57.i.preheader, label %for.cond.i.backedge
...
while.body.i57.i.preheader:                       ; preds = %for.end.i
  ...
  br i1 %lcmp.mod16.not, label %while.body.i57.i.prol.loopexit, label %while.body.i57.i.prol
...
while.body.i57.i.prol.loopexit:                   ; preds = %while.body.i57.i.prol, %while.body.i57.i.preheader
  %.unr = phi i32 [ %.pr.i.i, %while.body.i57.i.preheader ], [ %dec.i.i.i61.i.prol, %while.body.i57.i.prol ]
  %35 = icmp eq i32 %.pr.i.i, 1
  br i1 %35, label %for.cond.i.backedge, label %while.body.i57.i

while.body.i57.i:                                 ; preds = %while.body.i57.i.prol.loopexit, %while.body.i57.i
  %36 = phi i32 [ %dec.i.i.i61.i.1, %while.body.i57.i ], [ %.unr, %while.body.i57.i.prol.loopexit ]
  %37 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %37, ptr @cont_CURRENTBINDING, align 8
  %38 = getelementptr i8, ptr %37, i64 24
  ...
  br i1 %cmp.i62.i.1, label %while.body.i57.i, label %for.cond.i.backedge
...
if.end8.i:                                        ; preds = %if.end.i, %for.cond.i
  ...
  %CurrentNode.04.i = load ptr, ptr %CurrentNode.0.in3.i, align 8
  %19 = load ptr, ptr %CurrentNode.04.i, align 8
  %call115.i = tail call i32 @subst_MatchReverse(ptr noundef %IndexContext, ptr noundef %19) #9
  %tobool12.not6.i = icmp eq i32 %call115.i, 0
  br i1 %tobool12.not6.i, label %for.end.i, label %for.body.i
...
while.body.i52.i.prol.loopexit:                   ; preds = %while.body.i52.i.prol, %while.body.i52.i.preheader
  %.unr = phi i32 [ %.pr.i.i, %while.body.i52.i.preheader ], [ %dec.i.i.i56.i.prol, %while.body.i52.i.prol ]
  %32 = icmp eq i32 %.pr.i.i, 1
  br i1 %32, label %for.cond.i.backedge, label %while.body.i52.i

while.body.i52.i:                                 ; preds = %while.body.i52.i.prol.loopexit, %while.body.i52.i
  %33 = phi i32 [ %dec.i.i.i56.i.1, %while.body.i52.i ], [ %.unr, %while.body.i52.i.prol.loopexit ]
  %34 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %34, ptr @cont_CURRENTBINDING, align 8
  %35 = getelementptr i8, ptr %34, i64 24
...
if.end8.i:                                        ; preds = %if.end.i, %for.cond.i
  ...
  %CurrentNode.0.in3.i = getelementptr i8, ptr %CurrentList.1.i, i64 8
  %CurrentNode.04.i = load ptr, ptr %CurrentNode.0.in3.i, align 8
  %20 = getelementptr i8, ptr %CurrentNode.04.i, i64 24
  %CurrentNode.0.val5.i = load i16, ptr %20, align 8
  %cmp.not6.i = icmp ult i16 %CurrentNode.0.val5.i, %conv
  br i1 %cmp.not6.i, label %for.end.i, label %land.rhs.i

land.rhs.i:                                       ; preds = %if.end8.i, %for.inc.i
  %CurrentNode.08.i = phi ptr [ %CurrentNode.0.i, %for.inc.i ], [ %CurrentNode.04.i, %if.end8.i ]
  %CurrentList.27.i = phi ptr [ %29, %for.inc.i ], [ %CurrentList.1.i, %if.end8.i ]
  %21 = load ptr, ptr %CurrentNode.08.i, align 8
  %call14.i = tail call i32 @subst_MatchReverse(ptr noundef %IndexContext, ptr noundef %21) #9
  %tobool15.not.i = icmp eq i32 %call14.i, 0
  br i1 %tobool15.not.i, label %for.end.i, label %for.body.i

for.body.i:                                       ; preds = %land.rhs.i
  %22 = getelementptr i8, ptr %CurrentNode.08.i, i64 16
...
for.end.i:                                        ; preds = %for.inc.i, %land.rhs.i, %for.end.i.i, %if.end.i.i, %if.end8.i
  %CurrentList.22.i = phi ptr [ %CurrentList.27.i, %for.end.i.i ], [ %CurrentList.27.i, %if.end.i.i ], [ %CurrentList.1.i, %if.end8.i ], [ %29, %for.inc.i ], [ %CurrentList.27.i, %land.rhs.i ]
  %Result.1.i = phi ptr [ %call4.i.i, %for.end.i.i ], [ %call4.i.i, %if.end.i.i ], [ %Result.0.i, %if.end8.i ], [ %Result.0.i, %land.rhs.i ], [ %Result.0.i, %for.inc.i ]
  %CurrentList.2.val.i = load ptr, ptr %CurrentList.22.i, align 8
  %.pr.i.i = load i32, ptr @cont_BINDINGS, align 4
  %cmp1.i56.i = icmp sgt i32 %.pr.i.i, 0
...
while.body.i57.i.prol.loopexit:                   ; preds = %while.body.i57.i.prol, %while.body.i57.i.preheader
  ...
  br i1 %34, label %for.cond.i.backedge, label %while.body.i57.i

while.body.i57.i:                                 ; preds = %while.body.i57.i.prol.loopexit, %while.body.i57.i
  %35 = phi i32 [ %dec.i.i.i61.i.1, %while.body.i57.i ], [ %.unr, %while.body.i57.i.prol.loopexit ]
...
while.body.i.i:                                   ; preds = %while.body.i.i, %while.body.preheader.i.i
  ...
  br i1 %tobool.not.i.i, label %cont_Reset.exit.i, label %while.body.i.i
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  br i1 %cmp.i42.1, label %while.body.i, label %cont_StopAndBackTrack.exit
...
if.end7:                                          ; preds = %if.end, %for.cond
  ...
  %CurrentNode.0.in64 = getelementptr i8, ptr %CurrentList.1, i64 8
  %CurrentNode.065 = load ptr, ptr %CurrentNode.0.in64, align 8
  %15 = load ptr, ptr %CurrentNode.065, align 8
  %call1066 = tail call i32 @subst_Unify(ptr noundef %IndexContext, ptr noundef %15) #9
  %tobool11.not67 = icmp eq i32 %call1066, 0
  br i1 %tobool11.not67, label %for.end, label %for.body

for.body:                                         ; preds = %if.end7, %for.inc
  %CurrentNode.069 = phi ptr [ %CurrentNode.0, %for.inc ], [ %CurrentNode.065, %if.end7 ]
  %CurrentList.268 = phi ptr [ %27, %for.inc ], [ %CurrentList.1, %if.end7 ]
  %CurrentList.2.val41 = load ptr, ptr %CurrentList.268, align 8
...
if.end17:                                         ; preds = %if.else, %if.then15
  store i32 0, ptr @cont_BINDINGS, align 4
  %22 = getelementptr i8, ptr %CurrentNode.069, i64 16
...
if.then20:                                        ; preds = %if.end17
  %23 = getelementptr i8, ptr %CurrentNode.069, i64 16
...
for.inc:                                          ; preds = %if.end17
  %subnodes = getelementptr inbounds %struct.st, ptr %CurrentNode.069, i64 0, i32 1
...
for.end:                                          ; preds = %for.inc, %if.end7
  ...
  br i1 %cmp1.i56, label %while.body.i57.preheader, label %for.cond.backedge

for.cond.backedge:                                ; preds = %while.body.i57.prol.loopexit, %while.body.i57, %for.end
  br label %for.cond

while.body.i57.preheader:                         ; preds = %for.end
  %xtraiter79 = and i32 %.pr.i, 1
  %lcmp.mod80.not = icmp eq i32 %xtraiter79, 0
  br i1 %lcmp.mod80.not, label %while.body.i57.prol.loopexit, label %while.body.i57.prol

while.body.i57.prol:                              ; preds = %while.body.i57.preheader
  %29 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %29, ptr @cont_CURRENTBINDING, align 8
  %30 = getelementptr i8, ptr %29, i64 24
  %call.val.i.i.i58.prol = load ptr, ptr %30, align 8
  store ptr %call.val.i.i.i58.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i59.prol = getelementptr inbounds %struct.binding, ptr %29, i64 0, i32 1
  ...
  %31 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i60.prol = getelementptr inbounds %struct.binding, ptr %31, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i60.prol, align 8
  %dec.i.i.i61.prol = add nsw i32 %.pr.i, -1
...
while.body.i57.prol.loopexit:                     ; preds = %while.body.i57.prol, %while.body.i57.preheader
  %.unr = phi i32 [ %.pr.i, %while.body.i57.preheader ], [ %dec.i.i.i61.prol, %while.body.i57.prol ]
  %32 = icmp eq i32 %.pr.i, 1
  br i1 %32, label %for.cond.backedge, label %while.body.i57

while.body.i57:                                   ; preds = %while.body.i57.prol.loopexit, %while.body.i57
  %33 = phi i32 [ %dec.i.i.i61.1, %while.body.i57 ], [ %.unr, %while.body.i57.prol.loopexit ]
  %34 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %34, ptr @cont_CURRENTBINDING, align 8
  %35 = getelementptr i8, ptr %34, i64 24
  %call.val.i.i.i58 = load ptr, ptr %35, align 8
  store ptr %call.val.i.i.i58, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i59 = getelementptr inbounds %struct.binding, ptr %34, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i59, i8 0, i64 20, i1 false)
  %36 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i60 = getelementptr inbounds %struct.binding, ptr %36, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i60, align 8
  %dec.i.i.i61 = add nsw i32 %33, -1
  store i32 %dec.i.i.i61, ptr @cont_BINDINGS, align 4
  %37 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %37, ptr @cont_CURRENTBINDING, align 8
  %38 = getelementptr i8, ptr %37, i64 24
  %call.val.i.i.i58.1 = load ptr, ptr %38, align 8
  store ptr %call.val.i.i.i58.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i59.1 = getelementptr inbounds %struct.binding, ptr %37, i64 0, i32 1
  ...
  %39 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i60.1 = getelementptr inbounds %struct.binding, ptr %39, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i60.1, align 8
  %dec.i.i.i61.1 = add nsw i32 %33, -2
  store i32 %dec.i.i.i61.1, ptr @cont_BINDINGS, align 4
  %cmp.i62.1 = icmp ugt i32 %dec.i.i.i61, 1
  br i1 %cmp.i62.1, label %while.body.i57, label %for.cond.backedge
...
if.end7:                                          ; preds = %if.end, %for.cond
  ...
  %CurrentNode.065 = load ptr, ptr %CurrentNode.0.in64, align 8
  %15 = load ptr, ptr %CurrentNode.065, align 8
  %call1066 = tail call i32 @subst_Match(ptr noundef %IndexContext, ptr noundef %15) #9
  %tobool11.not67 = icmp eq i32 %call1066, 0
  br i1 %tobool11.not67, label %for.end, label %for.body
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  br i1 %cmp.i47.1, label %while.body.i, label %cont_StopAndBackTrack.exit
...
if.end7:                                          ; preds = %if.end, %for.cond
  %CurrentList.1 = phi ptr [ %14, %if.end ], [ %CurrentList.0, %for.cond ]
  %CurrentNode.0.in69 = getelementptr i8, ptr %CurrentList.1, i64 8
  %CurrentNode.070 = load ptr, ptr %CurrentNode.0.in69, align 8
  %15 = load i16, ptr @st_EXIST_MINMAX, align 2
  %16 = getelementptr i8, ptr %CurrentNode.070, i64 26
  %CurrentNode.0.val71 = load i16, ptr %16, align 2
  %cmp.not72 = icmp ult i16 %15, %CurrentNode.0.val71
  br i1 %cmp.not72, label %for.end, label %land.rhs

land.rhs:                                         ; preds = %if.end7, %for.inc
  %CurrentNode.074 = phi ptr [ %CurrentNode.0, %for.inc ], [ %CurrentNode.070, %if.end7 ]
  %CurrentList.273 = phi ptr [ %29, %for.inc ], [ %CurrentList.1, %if.end7 ]
  %17 = load ptr, ptr %CurrentNode.074, align 8
...
for.body:                                         ; preds = %land.rhs
  %CurrentList.2.val46 = load ptr, ptr %CurrentList.273, align 8
...
if.end20:                                         ; preds = %if.else, %if.then18
  store i32 0, ptr @cont_BINDINGS, align 4
  %24 = getelementptr i8, ptr %CurrentNode.074, i64 16
...
if.then23:                                        ; preds = %if.end20
  %25 = getelementptr i8, ptr %CurrentNode.074, i64 16
...
for.inc:                                          ; preds = %if.end20
  %subnodes = getelementptr inbounds %struct.st, ptr %CurrentNode.074, i64 0, i32 1
...
for.end:                                          ; preds = %land.rhs, %for.inc, %if.end7
  %CurrentList.2.lcssa = phi ptr [ %CurrentList.1, %if.end7 ], [ %29, %for.inc ], [ %CurrentList.273, %land.rhs ]
  %CurrentList.2.val = load ptr, ptr %CurrentList.2.lcssa, align 8
  %.pr.i = load i32, ptr @cont_BINDINGS, align 4
  %cmp1.i61 = icmp sgt i32 %.pr.i, 0
  br i1 %cmp1.i61, label %while.body.i62.preheader, label %for.cond.backedge
...
while.body.i62.prol:                              ; preds = %while.body.i62.preheader
  ...
  store ptr %32, ptr @cont_CURRENTBINDING, align 8
  %33 = getelementptr i8, ptr %32, i64 24
  %call.val.i.i.i63.prol = load ptr, ptr %33, align 8
  store ptr %call.val.i.i.i63.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i64.prol = getelementptr inbounds %struct.binding, ptr %32, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i64.prol, i8 0, i64 20, i1 false)
  %34 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i65.prol = getelementptr inbounds %struct.binding, ptr %34, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i65.prol, align 8
  %dec.i.i.i66.prol = add nsw i32 %.pr.i, -1
  store i32 %dec.i.i.i66.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i62.prol.loopexit

while.body.i62.prol.loopexit:                     ; preds = %while.body.i62.prol, %while.body.i62.preheader
  %.unr = phi i32 [ %.pr.i, %while.body.i62.preheader ], [ %dec.i.i.i66.prol, %while.body.i62.prol ]
  %35 = icmp eq i32 %.pr.i, 1
  br i1 %35, label %for.cond.backedge, label %while.body.i62

while.body.i62:                                   ; preds = %while.body.i62.prol.loopexit, %while.body.i62
  %36 = phi i32 [ %dec.i.i.i66.1, %while.body.i62 ], [ %.unr, %while.body.i62.prol.loopexit ]
  %37 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %37, ptr @cont_CURRENTBINDING, align 8
  %38 = getelementptr i8, ptr %37, i64 24
  %call.val.i.i.i63 = load ptr, ptr %38, align 8
  store ptr %call.val.i.i.i63, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i64 = getelementptr inbounds %struct.binding, ptr %37, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i64, i8 0, i64 20, i1 false)
  %39 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i65 = getelementptr inbounds %struct.binding, ptr %39, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i65, align 8
  %dec.i.i.i66 = add nsw i32 %36, -1
  store i32 %dec.i.i.i66, ptr @cont_BINDINGS, align 4
  %40 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %40, ptr @cont_CURRENTBINDING, align 8
  %41 = getelementptr i8, ptr %40, i64 24
  %call.val.i.i.i63.1 = load ptr, ptr %41, align 8
  store ptr %call.val.i.i.i63.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i64.1 = getelementptr inbounds %struct.binding, ptr %40, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i64.1, i8 0, i64 20, i1 false)
  %42 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i65.1 = getelementptr inbounds %struct.binding, ptr %42, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i65.1, align 8
  %dec.i.i.i66.1 = add nsw i32 %36, -2
  store i32 %dec.i.i.i66.1, ptr @cont_BINDINGS, align 4
  %cmp.i67.1 = icmp ugt i32 %dec.i.i.i66, 1
  br i1 %cmp.i67.1, label %while.body.i62, label %for.cond.backedge
...
if.end7:                                          ; preds = %if.end, %for.cond
  ...
  %CurrentNode.065 = load ptr, ptr %CurrentNode.0.in64, align 8
  %15 = load ptr, ptr %CurrentNode.065, align 8
  %call1066 = tail call i32 @subst_MatchReverse(ptr noundef %IndexContext, ptr noundef %15) #9
  %tobool11.not67 = icmp eq i32 %call1066, 0
  br i1 %tobool11.not67, label %for.end, label %for.body
...
if.end7:                                          ; preds = %if.end, %for.cond
  ...
  %CurrentNode.070 = load ptr, ptr %CurrentNode.0.in69, align 8
  %15 = load i16, ptr @st_EXIST_MINMAX, align 2
  %16 = getelementptr i8, ptr %CurrentNode.070, i64 24
  %CurrentNode.0.val71 = load i16, ptr %16, align 8
  %cmp.not72 = icmp ugt i16 %15, %CurrentNode.0.val71
  br i1 %cmp.not72, label %for.end, label %land.rhs
...
st_Empty.exit:                                    ; preds = %lor.rhs.i
  ...
  %ST.val5.i = load ptr, ptr %1, align 8
  %cmp.i.i6.i.not = icmp eq ptr %ST.val5.i, null
  br i1 %cmp.i.i6.i.not, label %cleanup, label %if.end
...
if.then10:                                        ; preds = %if.end
  ...
  br i1 %tobool12.not, label %if.else, label %for.cond.preheader
...
for.body:                                         ; preds = %for.cond.preheader, %for.body
  %Scan.060 = phi ptr [ %Scan.0, %for.body ], [ %10, %for.cond.preheader ]
...
for.body26:                                       ; preds = %if.else22, %for.body26
  ...
  br i1 %cmp24.not, label %cleanup, label %for.body26

cleanup:                                          ; preds = %for.body, %for.body26, %if.else, %if.else22, %for.cond.preheader, %st_Empty.exit, %entry
  %.str.11.sink = phi ptr [ @.str.6, %entry ], [ @.str.6, %st_Empty.exit ], [ @.str.11, %for.cond.preheader ], [ @.str.11, %if.else22 ], [ @.str.11, %if.else ], [ @.str.11, %for.body26 ], [ @.str.11, %for.body ]
...
for.body5:                                        ; preds = %for.end, %for.body5
  ...
  br i1 %exitcond96.not, label %for.end9, label %for.body5
...
for.body21:                                       ; preds = %for.cond18.preheader, %for.body21
  ...
  br i1 %exitcond97.not, label %for.end25, label %for.body21
...
for.end25:                                        ; preds = %for.body21, %for.cond18.preheader
  ...
  br i1 %tobool27.not, label %if.else, label %for.cond29.preheader

for.cond29.preheader:                             ; preds = %for.end25
...
for.body32:                                       ; preds = %for.cond29.preheader, %for.body32
  %Scan.092 = phi ptr [ %Scan.0, %for.body32 ], [ %12, %for.cond29.preheader ]
  %13 = load ptr, ptr @stdout, align 8
  ...
  br i1 %cmp30.not, label %if.end41, label %for.body32
...
if.end41:                                         ; preds = %for.body32, %for.cond29.preheader, %if.else
...
for.body48:                                       ; preds = %for.body48.lr.ph, %for.body48
  ...
  br i1 %cmp46.not, label %cleanup, label %for.body48
