; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_rtf.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_rtf.c"
...
if.end25:                                         ; preds = %load_actions.exit
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(104) %state, ptr noundef nonnull align 8 dereferenceable(104) @base_state, i64 104, i1 false)
  %parse_state.i = getelementptr inbounds %struct.rtf_state, ptr %state, i64 0, i32 3
  store i32 0, ptr %parse_state.i, align 8
  %controlword_cnt.i = getelementptr inbounds %struct.rtf_state, ptr %state, i64 0, i32 1
  store i64 0, ptr %controlword_cnt.i, align 8
...
while.cond.loopexit:                              ; preds = %sw.epilog295
  ...
  br i1 %cmp, label %while.body31.lr.ph, label %while.end296
...
sw.bb:                                            ; preds = %while.body31
  ...
  %15 = load i8, ptr %ptr.0483, align 1
...
sw.bb33:                                          ; preds = %sw.bb
  %inc.i = add i64 %13, 1
  store i64 %inc.i, ptr %elements, align 8
  %16 = load i64, ptr %controlword_param242, align 8
...
if.then2.i:                                       ; preds = %if.end.i
  %add.i = add i64 %8, 128
  store i64 %add.i, ptr %stack_size, align 8
  %mul.i = mul i64 %add.i, 104
  %call5.i = call ptr @cli_realloc2(ptr noundef %7, i64 noundef %mul.i) #11
  store ptr %call5.i, ptr %stack, align 8
...
if.end11.i:                                       ; preds = %if.then2.i, %if.end.i
  ...
  %inc14.i = add i64 %9, 1
  store i64 %inc14.i, ptr %stack_cnt, align 8
  %arrayidx.i = getelementptr inbounds %struct.rtf_state, ptr %.pre.i492, i64 %9
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(104) %arrayidx.i, ptr noundef nonnull align 8 dereferenceable(104) %state, i64 104, i1 false)
  %24 = load i32, ptr %encounteredTopLevel2.i, align 8
  %25 = load i64, ptr %state, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(104) %state, ptr noundef nonnull align 8 dereferenceable(104) @base_state, i64 104, i1 false)
  store i32 %24, ptr %encounteredTopLevel2.i, align 8
  br label %push_state.exit.thread
...
if.end42:                                         ; preds = %if.then39, %if.then36
  ...
  %32 = load i8, ptr @cli_leavetemps_flag, align 1
...
sw.bb49:                                          ; preds = %sw.bb
  %34 = load ptr, ptr %cb_data279, align 8
...
if.then59:                                        ; preds = %if.then55
  %36 = load ptr, ptr %cb_data279, align 8
...
if.end68:                                         ; preds = %if.then65, %if.then59
  ...
  call fastcc void @cleanup_stack(ptr noundef nonnull %stack, ptr noundef nonnull %state, ptr noundef %ctx)
  call void @free(ptr noundef %call5) #11
  %38 = load i8, ptr @cli_leavetemps_flag, align 1
...
if.end75:                                         ; preds = %if.then55, %sw.bb49
  %dec.i = add i64 %13, -1
  store i64 %dec.i, ptr %elements, align 8
  %40 = load i64, ptr %state, align 8
  %tobool.not.i = icmp eq i64 %40, 0
  br i1 %tobool.not.i, label %if.end.i425, label %if.then.i423

if.then.i423:                                     ; preds = %if.end75
  %sub.i = add i64 %40, -1
  %41 = load i32, ptr %encounteredTopLevel2.i, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(104) %state, ptr noundef nonnull align 8 dereferenceable(104) @base_state, i64 104, i1 false)
  store i64 %sub.i, ptr %state, align 8
  store i32 %41, ptr %encounteredTopLevel2.i, align 8
  br label %sw.epilog295

if.end.i425:                                      ; preds = %if.end75
  %tobool5.not.i = icmp eq i64 %12, 0
  br i1 %tobool5.not.i, label %if.then6.i, label %if.end11.i427

if.then6.i:                                       ; preds = %if.end.i425
...
if.then8.i:                                       ; preds = %if.then6.i
  ...
  store i32 1, ptr %warned, align 8
  br label %if.end10.i
...
if.end11.i427:                                    ; preds = %if.end.i425
  %dec13.i = add i64 %12, -1
  store i64 %dec13.i, ptr %stack_cnt, align 8
  %arrayidx.i428 = getelementptr inbounds %struct.rtf_state, ptr %11, i64 %dec13.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(104) %state, ptr noundef nonnull align 8 dereferenceable(104) %arrayidx.i428, i64 104, i1 false)
  br label %sw.epilog295

sw.bb94:                                          ; preds = %sw.bb
  store i32 1, ptr %parse_state.i, align 8
  br label %sw.epilog295
...
for.body:                                         ; preds = %sw.default, %for.inc
  ...
  %43 = load i8, ptr %arrayidx99, align 1
...
if.then112:                                       ; preds = %if.then108
  %47 = load ptr, ptr %cb_data279, align 8
...
while.body.i:                                     ; preds = %if.end121, %if.end.i431
  %.pr494 = phi i64 [ %.pr495, %if.end.i431 ], [ %9, %if.end121 ]
  %49 = phi i64 [ %dec.i.i, %if.end.i431 ], [ %13, %if.end121 ]
  %dec.i.i = add i64 %49, -1
  store i64 %dec.i.i, ptr %elements, align 8
  %50 = load i64, ptr %state, align 8
...
pop_state.exit.thread.i:                          ; preds = %while.body.i
  ...
  %51 = load i32, ptr %encounteredTopLevel2.i, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(104) %state, ptr noundef nonnull align 8 dereferenceable(104) @base_state, i64 104, i1 false)
  store i64 %sub.i.i, ptr %state, align 8
  store i32 %51, ptr %encounteredTopLevel2.i, align 8
  br label %if.end.i431

pop_state.exit.i:                                 ; preds = %while.body.i
  %dec13.i.i = add i64 %.pr494, -1
  store i64 %dec13.i.i, ptr %stack_cnt, align 8
  %arrayidx.i.i = getelementptr inbounds %struct.rtf_state, ptr %7, i64 %dec13.i.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(104) %state, ptr noundef nonnull align 8 dereferenceable(104) %arrayidx.i.i, i64 104, i1 false)
  %.pre.i432 = load ptr, ptr %cb_data279, align 8
  %tobool2.not.i = icmp eq ptr %.pre.i432, null
  br i1 %tobool2.not.i, label %if.end.i431, label %land.lhs.true.i

land.lhs.true.i:                                  ; preds = %pop_state.exit.i
  %52 = load ptr, ptr %cb_end282, align 8
  %tobool3.not.i = icmp eq ptr %52, null
  br i1 %tobool3.not.i, label %if.end.i431, label %if.then.i433

if.then.i433:                                     ; preds = %land.lhs.true.i
  %call5.i434 = call i32 %52(ptr noundef nonnull %state, ptr noundef %ctx) #11
  br label %if.end.i431

if.end.i431:                                      ; preds = %if.then.i433, %land.lhs.true.i, %pop_state.exit.thread.i, %pop_state.exit.i
...
cleanup_stack.exit:                               ; preds = %if.end.i431, %if.end121
  call void @free(ptr noundef %call5) #11
  %53 = load i8, ptr @cli_leavetemps_flag, align 1
...
if.end128:                                        ; preds = %if.then108, %if.then105
  %55 = load ptr, ptr %cb_process.i, align 8
...
if.then131:                                       ; preds = %if.end128
  %56 = load ptr, ptr %cb_end282, align 8
...
if.end137:                                        ; preds = %if.then131
  ...
  %57 = load ptr, ptr %cb_data279, align 8
...
if.end146:                                        ; preds = %if.then131, %if.then143, %if.end137
  ...
  br i1 %tobool1.not12.i440, label %cleanup_stack.exit457, label %while.body.i441

while.body.i441:                                  ; preds = %if.end146, %if.end.i446
  %.pr467497 = phi i64 [ %.pr467498, %if.end.i446 ], [ %9, %if.end146 ]
  %58 = phi i64 [ %dec.i.i442, %if.end.i446 ], [ %13, %if.end146 ]
  %dec.i.i442 = add i64 %58, -1
  store i64 %dec.i.i442, ptr %elements, align 8
  %59 = load i64, ptr %state, align 8
  %tobool.not.i.i443 = icmp eq i64 %59, 0
  br i1 %tobool.not.i.i443, label %pop_state.exit.i448, label %pop_state.exit.thread.i444

pop_state.exit.thread.i444:                       ; preds = %while.body.i441
  %sub.i.i445 = add i64 %59, -1
  %60 = load i32, ptr %encounteredTopLevel2.i, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(104) %state, ptr noundef nonnull align 8 dereferenceable(104) @base_state, i64 104, i1 false)
  store i64 %sub.i.i445, ptr %state, align 8
  store i32 %60, ptr %encounteredTopLevel2.i, align 8
  br label %if.end.i446

pop_state.exit.i448:                              ; preds = %while.body.i441
  %dec13.i.i449 = add i64 %.pr467497, -1
  store i64 %dec13.i.i449, ptr %stack_cnt, align 8
  %arrayidx.i.i450 = getelementptr inbounds %struct.rtf_state, ptr %7, i64 %dec13.i.i449
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(104) %state, ptr noundef nonnull align 8 dereferenceable(104) %arrayidx.i.i450, i64 104, i1 false)
  %.pre.i451 = load ptr, ptr %cb_data279, align 8
  %tobool2.not.i452 = icmp eq ptr %.pre.i451, null
  br i1 %tobool2.not.i452, label %if.end.i446, label %land.lhs.true.i453

land.lhs.true.i453:                               ; preds = %pop_state.exit.i448
  %61 = load ptr, ptr %cb_end282, align 8
  %tobool3.not.i454 = icmp eq ptr %61, null
  br i1 %tobool3.not.i454, label %if.end.i446, label %if.then.i455

if.then.i455:                                     ; preds = %land.lhs.true.i453
  %call5.i456 = call i32 %61(ptr noundef nonnull %state, ptr noundef %ctx) #11
  br label %if.end.i446

if.end.i446:                                      ; preds = %if.then.i455, %land.lhs.true.i453, %pop_state.exit.thread.i444, %pop_state.exit.i448
  %.pr467498 = phi i64 [ %dec13.i.i449, %pop_state.exit.i448 ], [ %.pr467497, %pop_state.exit.thread.i444 ], [ %dec13.i.i449, %land.lhs.true.i453 ], [ %dec13.i.i449, %if.then.i455 ]
  %tobool1.not.i447 = icmp eq i64 %.pr467498, 0
  br i1 %tobool1.not.i447, label %cleanup_stack.exit457, label %while.body.i441

cleanup_stack.exit457:                            ; preds = %if.end.i446, %if.end146
  call void @free(ptr noundef %call5) #11
  %62 = load i8, ptr @cli_leavetemps_flag, align 1
...
sw.bb171:                                         ; preds = %while.body31
  %68 = load i64, ptr %controlword_cnt.i, align 8
...
if.else178:                                       ; preds = %sw.bb171
  ...
  %69 = load ptr, ptr %call179, align 8
  %70 = load i8, ptr %ptr.0483, align 1
  %idxprom181 = zext i8 %70 to i64
  %arrayidx182 = getelementptr inbounds i16, ptr %69, i64 %idxprom181
  %71 = load i16, ptr %arrayidx182, align 2
...
if.then186:                                       ; preds = %if.else178
  ...
  %inc190 = add i64 %68, 1
  store i64 %inc190, ptr %controlword_cnt.i, align 8
  %arrayidx191 = getelementptr inbounds %struct.rtf_state, ptr %state, i64 0, i32 6, i64 %68
  store i8 %70, ptr %arrayidx191, align 1
  br label %sw.epilog295
...
if.then200:                                       ; preds = %if.else192
  ...
  %inc204 = add i64 %68, 1
  store i64 %inc204, ptr %controlword_cnt.i, align 8
  %arrayidx205 = getelementptr inbounds %struct.rtf_state, ptr %state, i64 0, i32 6, i64 %68
  store i8 %70, ptr %arrayidx205, align 1
  store i32 5, ptr %parse_state.i, align 8
  br label %sw.epilog295
...
if.then215:                                       ; preds = %if.else207
  store i32 4, ptr %parse_state.i, align 8
  store i64 0, ptr %controlword_param242, align 8
  store i32 1, ptr %controlword_param_sign258, align 4
  br label %sw.epilog295
...
sw.bb233:                                         ; preds = %while.body31
  ...
  %72 = load ptr, ptr %call234, align 8
  %73 = load i8, ptr %ptr.0483, align 1
  %idxprom236 = zext i8 %73 to i64
  %arrayidx237 = getelementptr inbounds i16, ptr %72, i64 %idxprom236
  %74 = load i16, ptr %arrayidx237, align 2
...
if.then241:                                       ; preds = %sw.bb233
  %75 = load i64, ptr %controlword_param242, align 8
  ...
  store i64 %sub, ptr %controlword_param242, align 8
  br label %sw.epilog295
...
if.else257:                                       ; preds = %if.else247
  %76 = load i32, ptr %controlword_param_sign258, align 4
  %cmp259 = icmp slt i32 %76, 0
  br i1 %cmp259, label %if.then261, label %if.end265

if.then261:                                       ; preds = %if.else257
  %77 = load i64, ptr %controlword_param242, align 8
  %sub263 = sub nsw i64 0, %77
  store i64 %sub263, ptr %controlword_param242, align 8
  br label %if.end265
...
sw.bb269:                                         ; preds = %while.body31
  %78 = load i64, ptr %controlword_cnt.i, align 8
...
if.then278:                                       ; preds = %sw.bb269
  %79 = load ptr, ptr %cb_data279, align 8
...
if.then284:                                       ; preds = %if.then278
  ...
  store ptr null, ptr %cb_begin287, align 8
...
sw.bb.i:                                          ; preds = %if.end290
  %81 = load i32, ptr %encounteredTopLevel2.i, align 8
  %or.i = or i32 %81, 1
  store i32 %or.i, ptr %encounteredTopLevel2.i, align 8
  br label %if.end292

sw.bb1.i:                                         ; preds = %if.end290
  %82 = load i32, ptr %encounteredTopLevel2.i, align 8
  %and.i = and i32 %82, 1
  %tobool.not.i458 = icmp eq i32 %and.i, 0
  br i1 %tobool.not.i458, label %if.end292, label %if.then.i459

if.then.i459:                                     ; preds = %sw.bb1.i
  store ptr @rtf_object_begin, ptr %cb_begin287, align 8
  store ptr @rtf_object_process, ptr %cb_process.i, align 8
  store ptr @rtf_object_end, ptr %cb_end282, align 8
  br label %if.end292

if.end292:                                        ; preds = %if.then.i459, %sw.bb1.i, %sw.bb.i, %if.end290, %sw.bb269
  store i32 0, ptr %parse_state.i, align 8
  br label %sw.epilog295

sw.epilog295:                                     ; preds = %cleanup, %if.end11.i427, %if.end10.i, %if.then.i423, %push_state.exit.thread, %if.then241, %if.end265, %if.then255, %if.then175, %if.then200, %if.then221, %if.else226, %if.then215, %if.then186, %if.then164, %if.else, %sw.bb94, %while.body31, %if.end292, %sw.bb168
  %.pre.i490 = phi ptr [ %7, %while.body31 ], [ %7, %if.end292 ], [ %7, %if.then241 ], [ %7, %if.then255 ], [ %7, %if.end265 ], [ %7, %if.then175 ], [ %7, %if.then186 ], [ %7, %if.then200 ], [ %7, %if.then215 ], [ %7, %if.then221 ], [ %7, %if.else226 ], [ %7, %sw.bb168 ], [ %7, %if.then164 ], [ %7, %if.else ], [ %7, %cleanup ], [ %7, %sw.bb94 ], [ %.pre.i491, %push_state.exit.thread ], [ %7, %if.then.i423 ], [ %7, %if.end10.i ], [ %7, %if.end11.i427 ]
  %83 = phi i64 [ %8, %while.body31 ], [ %8, %if.end292 ], [ %8, %if.then241 ], [ %8, %if.then255 ], [ %8, %if.end265 ], [ %8, %if.then175 ], [ %8, %if.then186 ], [ %8, %if.then200 ], [ %8, %if.then215 ], [ %8, %if.then221 ], [ %8, %if.else226 ], [ %8, %sw.bb168 ], [ %8, %if.then164 ], [ %8, %if.else ], [ %8, %cleanup ], [ %8, %sw.bb94 ], [ %26, %push_state.exit.thread ], [ %8, %if.then.i423 ], [ %8, %if.end10.i ], [ %8, %if.end11.i427 ]
  %84 = phi i64 [ %9, %while.body31 ], [ %9, %if.end292 ], [ %9, %if.then241 ], [ %9, %if.then255 ], [ %9, %if.end265 ], [ %9, %if.then175 ], [ %9, %if.then186 ], [ %9, %if.then200 ], [ %9, %if.then215 ], [ %9, %if.then221 ], [ %9, %if.else226 ], [ %9, %sw.bb168 ], [ %9, %if.then164 ], [ %9, %if.else ], [ %9, %cleanup ], [ %9, %sw.bb94 ], [ %27, %push_state.exit.thread ], [ %9, %if.then.i423 ], [ %9, %if.end10.i ], [ %dec13.i, %if.end11.i427 ]
  %85 = phi i32 [ %10, %while.body31 ], [ %10, %if.end292 ], [ %10, %if.then241 ], [ %10, %if.then255 ], [ %10, %if.end265 ], [ %10, %if.then175 ], [ %10, %if.then186 ], [ %10, %if.then200 ], [ %10, %if.then215 ], [ %10, %if.then221 ], [ %10, %if.else226 ], [ %10, %sw.bb168 ], [ %10, %if.then164 ], [ %10, %if.else ], [ %10, %cleanup ], [ %10, %sw.bb94 ], [ %10, %push_state.exit.thread ], [ %10, %if.then.i423 ], [ %42, %if.end10.i ], [ %10, %if.end11.i427 ]
  %86 = phi ptr [ %11, %while.body31 ], [ %11, %if.end292 ], [ %11, %if.then241 ], [ %11, %if.then255 ], [ %11, %if.end265 ], [ %11, %if.then175 ], [ %11, %if.then186 ], [ %11, %if.then200 ], [ %11, %if.then215 ], [ %11, %if.then221 ], [ %11, %if.else226 ], [ %11, %sw.bb168 ], [ %11, %if.then164 ], [ %11, %if.else ], [ %11, %cleanup ], [ %11, %sw.bb94 ], [ %28, %push_state.exit.thread ], [ %11, %if.then.i423 ], [ %11, %if.end10.i ], [ %11, %if.end11.i427 ]
  %87 = phi i64 [ %12, %while.body31 ], [ %12, %if.end292 ], [ %12, %if.then241 ], [ %12, %if.then255 ], [ %12, %if.end265 ], [ %12, %if.then175 ], [ %12, %if.then186 ], [ %12, %if.then200 ], [ %12, %if.then215 ], [ %12, %if.then221 ], [ %12, %if.else226 ], [ %12, %sw.bb168 ], [ %12, %if.then164 ], [ %12, %if.else ], [ %12, %cleanup ], [ %12, %sw.bb94 ], [ %29, %push_state.exit.thread ], [ %12, %if.then.i423 ], [ 0, %if.end10.i ], [ %dec13.i, %if.end11.i427 ]
  %88 = phi i64 [ %13, %while.body31 ], [ %13, %if.end292 ], [ %13, %if.then241 ], [ %13, %if.then255 ], [ %13, %if.end265 ], [ %13, %if.then175 ], [ %13, %if.then186 ], [ %13, %if.then200 ], [ %13, %if.then215 ], [ %13, %if.then221 ], [ %13, %if.else226 ], [ %13, %sw.bb168 ], [ %13, %if.then164 ], [ %13, %if.else ], [ %13, %cleanup ], [ %13, %sw.bb94 ], [ %inc.i, %push_state.exit.thread ], [ %dec.i, %if.then.i423 ], [ %dec.i, %if.end10.i ], [ %dec.i, %if.end11.i427 ]
  %ptr.2 = phi ptr [ %ptr.0483, %while.body31 ], [ %ptr.0483, %if.end292 ], [ %incdec.ptr244, %if.then241 ], [ %incdec.ptr256, %if.then255 ], [ %ptr.0483, %if.end265 ], [ %ptr.0483, %if.then175 ], [ %incdec.ptr187, %if.then186 ], [ %incdec.ptr201, %if.then200 ], [ %ptr.0483, %if.then215 ], [ %incdec.ptr222, %if.then221 ], [ %ptr.0483, %if.else226 ], [ %incdec.ptr169, %sw.bb168 ], [ %ptr.0483, %if.then164 ], [ %ptr.0483, %if.else ], [ %add.ptr154, %cleanup ], [ %incdec.ptr, %sw.bb94 ], [ %incdec.ptr, %push_state.exit.thread ], [ %incdec.ptr, %if.then.i423 ], [ %incdec.ptr, %if.end10.i ], [ %incdec.ptr, %if.end11.i427 ]
  %cmp29 = icmp ult ptr %ptr.2, %add.ptr
  br i1 %cmp29, label %while.body31, label %while.cond.loopexit

while.end296:                                     ; preds = %while.cond.loopexit, %if.end25
  %cb_data297 = getelementptr inbounds %struct.rtf_state, ptr %state, i64 0, i32 10
  %89 = load ptr, ptr %cb_data297, align 8
...
if.end305:                                        ; preds = %if.then302, %while.end296
  ...
  call fastcc void @cleanup_stack(ptr noundef nonnull %stack, ptr noundef nonnull %state, ptr noundef %ctx)
  call void @free(ptr noundef %call5) #11
  %91 = load i8, ptr @cli_leavetemps_flag, align 1
...
land.rhs.lr.ph:                                   ; preds = %entry
  ...
  %0 = load i64, ptr %stack_cnt, align 8
...
while.body:                                       ; preds = %land.rhs.lr.ph, %if.end
  ...
  %dec.i = add i64 %2, -1
  store i64 %dec.i, ptr %elements.i, align 8
...
pop_state.exit.thread:                            ; preds = %while.body
  %sub.i = add i64 %3, -1
  %4 = load i32, ptr %encounteredTopLevel.i, align 8
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(104) %state, ptr noundef nonnull align 8 dereferenceable(104) @base_state, i64 104, i1 false)
  store i64 %sub.i, ptr %state, align 8
  store i32 %4, ptr %encounteredTopLevel.i, align 8
  br label %if.end
...
pop_state.exit:                                   ; preds = %while.body
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(104) %state, ptr noundef nonnull align 8 dereferenceable(104) %arrayidx.i, i64 104, i1 false)
  %.pre = load ptr, ptr %cb_data, align 8
  %tobool2.not = icmp eq ptr %.pre, null
  br i1 %tobool2.not, label %if.end, label %land.lhs.true

land.lhs.true:                                    ; preds = %pop_state.exit
  %6 = load ptr, ptr %cb_end, align 8
...
if.end:                                           ; preds = %pop_state.exit.thread, %if.then, %land.lhs.true, %pop_state.exit
  %7 = load i64, ptr %stack_cnt, align 8
...
if.end:                                           ; preds = %entry
  ...
  %partial = getelementptr inbounds %struct.rtf_object_data, ptr %call, i64 0, i32 2
  store i32 0, ptr %partial, align 4
  %has_partial = getelementptr inbounds %struct.rtf_object_data, ptr %call, i64 0, i32 3
  store i32 0, ptr %has_partial, align 8
  %bread = getelementptr inbounds %struct.rtf_object_data, ptr %call, i64 0, i32 9
  store i64 0, ptr %bread, align 8
  %internal_state = getelementptr inbounds %struct.rtf_object_data, ptr %call, i64 0, i32 4
  store i32 0, ptr %internal_state, align 4
  %tmpdir1 = getelementptr inbounds %struct.rtf_object_data, ptr %call, i64 0, i32 6
  store ptr %tmpdir, ptr %tmpdir1, align 8
  ...
  store ptr null, ptr %desc_name, align 8
  %cb_data = getelementptr inbounds %struct.rtf_state, ptr %state, i64 0, i32 10
...
if.end:                                           ; preds = %entry
  ...
  %1 = load i32, ptr %has_partial, align 8
  %tobool2.not = icmp eq i32 %1, 0
  br i1 %tobool2.not, label %if.end21, label %for.cond.preheader
...
land.rhs:                                         ; preds = %for.cond.preheader, %for.inc
  %i.0578 = phi i64 [ 0, %for.cond.preheader ], [ %inc, %for.inc ]
  %arrayidx = getelementptr inbounds i8, ptr %input, i64 %i.0578
...
for.inc:                                          ; preds = %land.rhs
  %inc = add nuw i64 %i.0578, 1
  %exitcond.not = icmp eq i64 %inc, %len
  br i1 %exitcond.not, label %cleanup361, label %land.rhs

if.then9:                                         ; preds = %land.rhs
  %partial = getelementptr inbounds %struct.rtf_object_data, ptr %0, i64 0, i32 2
  %6 = load i32, ptr %partial, align 4
  %inc10 = add nuw i64 %i.0578, 1
  ...
  store i8 %conv15, ptr %outdata, align 16
  store i32 0, ptr %has_partial, align 8
  br label %if.end21
...
if.end21:                                         ; preds = %if.end, %if.then9
  ...
  %cmp23579 = icmp ult i64 %i.1, %len
  br i1 %cmp23579, label %for.body25.lr.ph, label %for.end74
...
for.body25:                                       ; preds = %for.body25.lr.ph, %for.inc72
  %out_cnt.1581 = phi i64 [ %out_cnt.0, %for.body25.lr.ph ], [ %out_cnt.3, %for.inc72 ]
  %i.2580 = phi i64 [ %i.1, %for.body25.lr.ph ], [ %inc73, %for.inc72 ]
  %8 = load ptr, ptr %call26, align 8
  %arrayidx27 = getelementptr inbounds i8, ptr %input, i64 %i.2580
...
if.then34:                                        ; preds = %for.body25
  ...
  %12 = load i16, ptr %arrayidx38, align 2
  %conv39 = trunc i16 %12 to i8
  %shl = shl i8 %conv39, 4
  %13 = add nuw i64 %i.2580, 1
  %umax = tail call i64 @llvm.umax.i64(i64 %len, i64 %13)
  %14 = add i64 %umax, -1
  br label %while.cond

while.cond:                                       ; preds = %land.rhs43, %if.then34
  %i.3.in = phi i64 [ %i.2580, %if.then34 ], [ %i.3, %land.rhs43 ]
  %exitcond608.not = icmp eq i64 %i.3.in, %14
  br i1 %exitcond608.not, label %while.end, label %land.rhs43
...
land.rhs43:                                       ; preds = %while.cond
  ...
  %idxprom47 = zext i8 %15 to i64
  %arrayidx48 = getelementptr inbounds i16, ptr %8, i64 %idxprom47
  %16 = load i16, ptr %arrayidx48, align 2
  %17 = and i16 %16, 4096
  %tobool51.not = icmp eq i16 %17, 0
  br i1 %tobool51.not, label %while.cond, label %while.end
...
cleanup.thread:                                   ; preds = %while.end
  ...
  %idxprom64 = zext i8 %18 to i64
  %arrayidx65 = getelementptr inbounds [256 x i16], ptr @hextable, i64 0, i64 %idxprom64
  %19 = load i16, ptr %arrayidx65, align 2
  %conv66 = trunc i16 %19 to i8
  %or67 = or i8 %shl, %conv66
  %inc69 = add i64 %out_cnt.1581, 1
  %arrayidx70 = getelementptr inbounds [8192 x i8], ptr %outdata, i64 0, i64 %out_cnt.1581
  store i8 %or67, ptr %arrayidx70, align 1
  br label %for.inc72
...
cleanup:                                          ; preds = %while.end
  ...
  store i32 %conv58, ptr %partial59, align 4
  store i32 1, ptr %has_partial, align 8
  br label %for.end74

for.inc72:                                        ; preds = %cleanup.thread, %for.body25
  %i.4 = phi i64 [ %i.2580, %for.body25 ], [ %i.3.lcssa, %cleanup.thread ]
  %out_cnt.3 = phi i64 [ %out_cnt.1581, %for.body25 ], [ %inc69, %cleanup.thread ]
  %inc73 = add i64 %i.4, 1
  %cmp23 = icmp ult i64 %inc73, %len
  br i1 %cmp23, label %for.body25, label %for.end74

for.end74:                                        ; preds = %for.inc72, %if.end21, %cleanup
  %out_cnt.1576 = phi i64 [ %out_cnt.1581, %cleanup ], [ %out_cnt.0, %if.end21 ], [ %out_cnt.3, %for.inc72 ]
  %tobool78.not590 = icmp eq i64 %out_cnt.1576, 0
  br i1 %tobool78.not590, label %cleanup361, label %while.body80.lr.ph
...
while.body80:                                     ; preds = %while.body80.lr.ph, %sw.epilog
  %out_data.0592 = phi ptr [ %outdata, %while.body80.lr.ph ], [ %out_data.2, %sw.epilog ]
  %out_cnt.5591 = phi i64 [ %out_cnt.1576, %while.body80.lr.ph ], [ %out_cnt.8, %sw.epilog ]
  %20 = load i32, ptr %internal_state, align 4
  switch i32 %20, label %cleanup361 [
    i32 0, label %sw.bb
...
sw.bb:                                            ; preds = %while.body80
  ...
  %.pre619 = load i64, ptr %bread301, align 8
  br label %land.rhs84

land.rhs84:                                       ; preds = %sw.bb, %for.inc103
  %21 = phi i64 [ %.pre619, %sw.bb ], [ %inc106, %for.inc103 ]
  %i.5589 = phi i64 [ 0, %sw.bb ], [ %inc104, %for.inc103 ]
  %cmp85 = icmp ult i64 %21, 8
  br i1 %cmp85, label %for.body88, label %for.end107

for.body88:                                       ; preds = %land.rhs84
  %arrayidx90 = getelementptr inbounds [8 x i8], ptr @rtf_data_magic, i64 0, i64 %21
  %22 = load i8, ptr %arrayidx90, align 1
  %arrayidx92 = getelementptr inbounds i8, ptr %out_data.0592, i64 %i.5589
  %23 = load i8, ptr %arrayidx92, align 1
  %cmp94.not = icmp eq i8 %22, %23
  br i1 %cmp94.not, label %for.inc103, label %if.then96

if.then96:                                        ; preds = %for.body88
  %conv93 = zext i8 %23 to i32
  %arrayidx97 = getelementptr inbounds [8 x i8], ptr @rtf_data_magic, i64 0, i64 %i.5589
  %24 = load i8, ptr %arrayidx97, align 1
  %conv98 = zext i8 %24 to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.10, i32 noundef %conv98, i32 noundef %conv93, i64 noundef %21) #11
  %.pre620 = load i64, ptr %bread301, align 8
  br label %for.inc103

for.inc103:                                       ; preds = %for.body88, %if.then96
  %25 = phi i64 [ %21, %for.body88 ], [ %.pre620, %if.then96 ]
  %inc104 = add nuw i64 %i.5589, 1
  %inc106 = add i64 %25, 1
  store i64 %inc106, ptr %bread301, align 8
  %exitcond616.not = icmp eq i64 %inc104, %out_cnt.5591
  br i1 %exitcond616.not, label %for.end107, label %land.rhs84

for.end107:                                       ; preds = %for.inc103, %land.rhs84
  %26 = phi i64 [ %inc106, %for.inc103 ], [ %21, %land.rhs84 ]
  %i.5.lcssa = phi i64 [ %out_cnt.5591, %for.inc103 ], [ %i.5589, %land.rhs84 ]
  %sub = sub i64 %out_cnt.5591, %i.5.lcssa
  %cmp109 = icmp eq i64 %26, 8
  br i1 %cmp109, label %if.then111, label %sw.epilog

if.then111:                                       ; preds = %for.end107
  %add.ptr = getelementptr inbounds i8, ptr %out_data.0592, i64 %i.5.lcssa
  store i64 0, ptr %bread301, align 8
  store i32 1, ptr %internal_state, align 4
  br label %sw.epilog

sw.bb115:                                         ; preds = %while.body80
  %27 = load i64, ptr %bread301, align 8
  %cmp117 = icmp eq i64 %27, 0
  br i1 %cmp117, label %if.then119, label %land.rhs124

if.then119:                                       ; preds = %sw.bb115
  store i64 0, ptr %desc_len297, align 8
  br label %land.rhs124

land.rhs124:                                      ; preds = %sw.bb115, %if.then119
  %cmp126 = icmp ult i64 %27, 4
  br i1 %cmp126, label %for.body129, label %for.end140

for.body129:                                      ; preds = %land.rhs124
  %28 = load i8, ptr %out_data.0592, align 1
  %conv131 = zext i8 %28 to i64
  %mul = shl nuw nsw i64 %27, 3
  %shl133 = shl nuw nsw i64 %conv131, %mul
  %29 = load i64, ptr %desc_len297, align 8
  %or135 = or i64 %shl133, %29
  store i64 %or135, ptr %desc_len297, align 8
  %inc139 = add nuw nsw i64 %27, 1
  store i64 %inc139, ptr %bread301, align 8
  %exitcond614.not = icmp eq i64 %out_cnt.5591, 1
  br i1 %exitcond614.not, label %for.end140, label %land.rhs124.1

land.rhs124.1:                                    ; preds = %for.body129
  %cmp126.1 = icmp ult i64 %27, 3
  br i1 %cmp126.1, label %for.body129.1, label %for.end140

for.body129.1:                                    ; preds = %land.rhs124.1
  %arrayidx130.1 = getelementptr inbounds i8, ptr %out_data.0592, i64 1
  %30 = load i8, ptr %arrayidx130.1, align 1
  %conv131.1 = zext i8 %30 to i64
  %mul.1 = shl nuw nsw i64 %inc139, 3
  %shl133.1 = shl nuw nsw i64 %conv131.1, %mul.1
  %31 = load i64, ptr %desc_len297, align 8
  %or135.1 = or i64 %shl133.1, %31
  store i64 %or135.1, ptr %desc_len297, align 8
  %inc139.1 = add nuw nsw i64 %27, 2
  store i64 %inc139.1, ptr %bread301, align 8
  %exitcond614.not.1 = icmp eq i64 %out_cnt.5591, 2
  br i1 %exitcond614.not.1, label %for.end140, label %land.rhs124.2

land.rhs124.2:                                    ; preds = %for.body129.1
  %cmp126.2 = icmp ult i64 %27, 2
  br i1 %cmp126.2, label %for.body129.2, label %for.end140

for.body129.2:                                    ; preds = %land.rhs124.2
  %arrayidx130.2 = getelementptr inbounds i8, ptr %out_data.0592, i64 2
  %32 = load i8, ptr %arrayidx130.2, align 1
  %conv131.2 = zext i8 %32 to i64
  %mul.2 = shl nuw nsw i64 %inc139.1, 3
  %shl133.2 = shl nuw nsw i64 %conv131.2, %mul.2
  %33 = load i64, ptr %desc_len297, align 8
  %or135.2 = or i64 %shl133.2, %33
  store i64 %or135.2, ptr %desc_len297, align 8
  %inc139.2 = add nuw nsw i64 %27, 3
  store i64 %inc139.2, ptr %bread301, align 8
  %exitcond614.not.2 = icmp eq i64 %out_cnt.5591, 3
  br i1 %exitcond614.not.2, label %for.end140, label %land.rhs124.3

land.rhs124.3:                                    ; preds = %for.body129.2
  %cmp126.3 = icmp eq i64 %27, 0
  br i1 %cmp126.3, label %for.body129.3, label %for.end140

for.body129.3:                                    ; preds = %land.rhs124.3
  %arrayidx130.3 = getelementptr inbounds i8, ptr %out_data.0592, i64 3
  %34 = load i8, ptr %arrayidx130.3, align 1
  %conv131.3 = zext i8 %34 to i64
  %mul.3 = shl nuw nsw i64 %inc139.2, 3
  %shl133.3 = shl nuw nsw i64 %conv131.3, %mul.3
  %35 = load i64, ptr %desc_len297, align 8
  %or135.3 = or i64 %shl133.3, %35
  store i64 %or135.3, ptr %desc_len297, align 8
  %inc139.3 = add nuw nsw i64 %27, 4
  store i64 %inc139.3, ptr %bread301, align 8
  %exitcond614.not.3 = icmp eq i64 %out_cnt.5591, 4
  %spec.select = select i1 %exitcond614.not.3, i64 %out_cnt.5591, i64 4
  br label %for.end140
...
for.end140:                                       ; preds = %for.body129.3, %land.rhs124.3, %for.body129.2, %land.rhs124.2, %for.body129.1, %land.rhs124.1, %land.rhs124, %for.body129
  %i.6570 = phi i64 [ %out_cnt.5591, %for.body129 ], [ 0, %land.rhs124 ], [ 1, %land.rhs124.1 ], [ %out_cnt.5591, %for.body129.1 ], [ 2, %land.rhs124.2 ], [ %out_cnt.5591, %for.body129.2 ], [ 3, %land.rhs124.3 ], [ %spec.select, %for.body129.3 ]
  %36 = phi i64 [ %inc139, %for.body129 ], [ %27, %land.rhs124 ], [ %inc139, %land.rhs124.1 ], [ %inc139.1, %for.body129.1 ], [ %inc139.1, %land.rhs124.2 ], [ %inc139.2, %for.body129.2 ], [ %inc139.2, %land.rhs124.3 ], [ %inc139.3, %for.body129.3 ]
  %sub141 = sub i64 %out_cnt.5591, %i.6570
  %cmp143 = icmp eq i64 %36, 4
  br i1 %cmp143, label %if.then145, label %sw.epilog

if.then145:                                       ; preds = %for.end140
  %add.ptr146 = getelementptr inbounds i8, ptr %out_data.0592, i64 %i.6570
  store i64 0, ptr %bread301, align 8
  %37 = load i64, ptr %desc_len297, align 8
  %cmp149 = icmp ugt i64 %37, 64
  br i1 %cmp149, label %if.then151, label %if.else154

if.then151:                                       ; preds = %if.then145
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.11, i64 noundef %37) #11
  br label %if.end158

if.else154:                                       ; preds = %if.then145
  %add = add nuw nsw i64 %37, 1
  br label %if.end158
...
if.end158:                                        ; preds = %if.else154, %if.then151
  ...
  store ptr %call156, ptr %desc_name181, align 8
  %tobool160.not = icmp eq ptr %call156, null
  br i1 %tobool160.not, label %cleanup361, label %if.end162

if.end162:                                        ; preds = %if.end158
  store i32 2, ptr %internal_state, align 4
  %38 = load i64, ptr %desc_len297, align 8
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.12, i64 noundef %38) #11
  br label %sw.epilog

sw.bb166:                                         ; preds = %while.body80
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.13) #11
  %.pre617 = load i64, ptr %bread301, align 8
  br label %land.lhs.true

land.lhs.true:                                    ; preds = %sw.bb166, %for.body179
  %39 = phi i64 [ %.pre617, %sw.bb166 ], [ %inc187, %for.body179 ]
  %i.7585 = phi i64 [ 0, %sw.bb166 ], [ %inc185, %for.body179 ]
  %40 = load i64, ptr %desc_len297, align 8
  %cmp172 = icmp ult i64 %39, %40
  %cmp176 = icmp ult i64 %39, 64
  %or.cond553 = and i1 %cmp176, %cmp172
  br i1 %or.cond553, label %for.body179, label %for.end188

for.body179:                                      ; preds = %land.lhs.true
  %arrayidx180 = getelementptr inbounds i8, ptr %out_data.0592, i64 %i.7585
  %41 = load i8, ptr %arrayidx180, align 1
  %42 = load ptr, ptr %desc_name181, align 8
  %arrayidx183 = getelementptr inbounds i8, ptr %42, i64 %39
  store i8 %41, ptr %arrayidx183, align 1
  %inc185 = add nuw i64 %i.7585, 1
  %43 = load i64, ptr %bread301, align 8
  %inc187 = add i64 %43, 1
  store i64 %inc187, ptr %bread301, align 8
  %exitcond612.not = icmp eq i64 %inc185, %out_cnt.5591
  br i1 %exitcond612.not, label %for.body179.for.end188_crit_edge, label %land.lhs.true

for.body179.for.end188_crit_edge:                 ; preds = %for.body179
  %.pre618 = load i64, ptr %desc_len297, align 8
  br label %for.end188

for.end188:                                       ; preds = %land.lhs.true, %for.body179.for.end188_crit_edge
  %44 = phi i64 [ %.pre618, %for.body179.for.end188_crit_edge ], [ %40, %land.lhs.true ]
  %45 = phi i64 [ %inc187, %for.body179.for.end188_crit_edge ], [ %39, %land.lhs.true ]
  %i.7.lcssa = phi i64 [ %out_cnt.5591, %for.body179.for.end188_crit_edge ], [ %i.7585, %land.lhs.true ]
  %sub189 = sub i64 %out_cnt.5591, %i.7.lcssa
  %add.ptr190 = getelementptr inbounds i8, ptr %out_data.0592, i64 %i.7.lcssa
  %cmp193 = icmp ult i64 %45, %44
  %cmp197 = icmp ult i64 %45, 64
  %or.cond554 = and i1 %cmp197, %cmp193
  br i1 %or.cond554, label %cleanup361.sink.split, label %if.end200

if.end200:                                        ; preds = %for.end188
  %46 = load ptr, ptr %desc_name181, align 8
  %arrayidx203 = getelementptr inbounds i8, ptr %46, i64 %45
  store i8 0, ptr %arrayidx203, align 1
  %47 = load i64, ptr %desc_len297, align 8
  %48 = load i64, ptr %bread301, align 8
  %sub206 = sub i64 %47, %48
  %cmp207 = icmp ugt i64 %sub206, %sub189
  br i1 %cmp207, label %if.then209, label %if.end212

if.then209:                                       ; preds = %if.end200
  %sub211 = sub i64 %47, %sub189
  store i64 %sub211, ptr %desc_len297, align 8
  br label %cleanup361.sink.split

if.end212:                                        ; preds = %if.end200
  %sub216 = sub i64 %sub189, %sub206
  %cmp219.not = icmp ult i64 %48, %47
...
if.then221:                                       ; preds = %if.end212
  ...
  store i64 0, ptr %bread301, align 8
  %49 = load ptr, ptr %desc_name181, align 8
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.16, ptr noundef %49) #11
  %50 = load ptr, ptr %desc_name181, align 8
  call void @free(ptr noundef %50) #11
  store ptr null, ptr %desc_name181, align 8
  store i32 3, ptr %internal_state, align 4
  br label %sw.epilog

sw.bb232:                                         ; preds = %while.body80
  %51 = load i64, ptr %bread301, align 8
  %sub234 = sub i64 8, %51
  %cmp235 = icmp ult i64 %out_cnt.5591, %sub234
  br i1 %cmp235, label %if.end245, label %if.end245.thread

if.end245.thread:                                 ; preds = %sw.bb232
  %sub243 = sub i64 %out_cnt.5591, %sub234
  br label %if.then249

if.end245:                                        ; preds = %sw.bb232
  %cmp247 = icmp eq i64 %51, 8
...
if.then249:                                       ; preds = %if.end245.thread, %if.end245
  ...
  %add.ptr250 = getelementptr inbounds i8, ptr %out_data.0592, i64 8
  store i64 0, ptr %bread301, align 8
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.17) #11
  store i32 4, ptr %internal_state, align 4
  br label %sw.epilog

sw.bb254:                                         ; preds = %while.body80
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.18) #11
  %52 = load i64, ptr %bread301, align 8
  %cmp256 = icmp eq i64 %52, 0
...
land.rhs264:                                      ; preds = %sw.bb254, %if.then258
  %cmp266 = icmp ult i64 %52, 4
  br i1 %cmp266, label %for.body269, label %for.end281

for.body269:                                      ; preds = %land.rhs264
  %53 = load i8, ptr %out_data.0592, align 1
  %conv271 = zext i8 %53 to i64
  %mul273 = shl nuw nsw i64 %52, 3
  %shl274 = shl nuw nsw i64 %conv271, %mul273
  %54 = load i64, ptr %desc_len297, align 8
  %or276 = or i64 %shl274, %54
  store i64 %or276, ptr %desc_len297, align 8
  %inc280 = add nuw nsw i64 %52, 1
  store i64 %inc280, ptr %bread301, align 8
  %exitcond610.not = icmp eq i64 %out_cnt.5591, 1
  br i1 %exitcond610.not, label %for.end281, label %land.rhs264.1

land.rhs264.1:                                    ; preds = %for.body269
  %cmp266.1 = icmp ult i64 %52, 3
  br i1 %cmp266.1, label %for.body269.1, label %for.end281

for.body269.1:                                    ; preds = %land.rhs264.1
  %arrayidx270.1 = getelementptr inbounds i8, ptr %out_data.0592, i64 1
  %55 = load i8, ptr %arrayidx270.1, align 1
  %conv271.1 = zext i8 %55 to i64
  %mul273.1 = shl nuw nsw i64 %inc280, 3
  %shl274.1 = shl nuw nsw i64 %conv271.1, %mul273.1
  %56 = load i64, ptr %desc_len297, align 8
  %or276.1 = or i64 %shl274.1, %56
  store i64 %or276.1, ptr %desc_len297, align 8
  %inc280.1 = add nuw nsw i64 %52, 2
  store i64 %inc280.1, ptr %bread301, align 8
  %exitcond610.not.1 = icmp eq i64 %out_cnt.5591, 2
  br i1 %exitcond610.not.1, label %for.end281, label %land.rhs264.2

land.rhs264.2:                                    ; preds = %for.body269.1
  %cmp266.2 = icmp ult i64 %52, 2
  br i1 %cmp266.2, label %for.body269.2, label %for.end281

for.body269.2:                                    ; preds = %land.rhs264.2
  %arrayidx270.2 = getelementptr inbounds i8, ptr %out_data.0592, i64 2
  %57 = load i8, ptr %arrayidx270.2, align 1
  %conv271.2 = zext i8 %57 to i64
  %mul273.2 = shl nuw nsw i64 %inc280.1, 3
  %shl274.2 = shl nuw nsw i64 %conv271.2, %mul273.2
  %58 = load i64, ptr %desc_len297, align 8
  %or276.2 = or i64 %shl274.2, %58
  store i64 %or276.2, ptr %desc_len297, align 8
  %inc280.2 = add nuw nsw i64 %52, 3
  store i64 %inc280.2, ptr %bread301, align 8
  %exitcond610.not.2 = icmp eq i64 %out_cnt.5591, 3
  br i1 %exitcond610.not.2, label %for.end281, label %land.rhs264.3

land.rhs264.3:                                    ; preds = %for.body269.2
  %cmp266.3 = icmp eq i64 %52, 0
  br i1 %cmp266.3, label %for.body269.3, label %for.end281

for.body269.3:                                    ; preds = %land.rhs264.3
  %arrayidx270.3 = getelementptr inbounds i8, ptr %out_data.0592, i64 3
  %59 = load i8, ptr %arrayidx270.3, align 1
  %conv271.3 = zext i8 %59 to i64
  %mul273.3 = shl nuw nsw i64 %inc280.2, 3
  %shl274.3 = shl nuw nsw i64 %conv271.3, %mul273.3
  %60 = load i64, ptr %desc_len297, align 8
  %or276.3 = or i64 %shl274.3, %60
  store i64 %or276.3, ptr %desc_len297, align 8
  %inc280.3 = add nuw nsw i64 %52, 4
  store i64 %inc280.3, ptr %bread301, align 8
  %exitcond610.not.3 = icmp eq i64 %out_cnt.5591, 4
  %spec.select663 = select i1 %exitcond610.not.3, i64 %out_cnt.5591, i64 4
  br label %for.end281
...
for.end281:                                       ; preds = %for.body269.3, %land.rhs264.3, %for.body269.2, %land.rhs264.2, %for.body269.1, %land.rhs264.1, %land.rhs264, %for.body269
  %i.8568 = phi i64 [ %out_cnt.5591, %for.body269 ], [ 0, %land.rhs264 ], [ 1, %land.rhs264.1 ], [ %out_cnt.5591, %for.body269.1 ], [ 2, %land.rhs264.2 ], [ %out_cnt.5591, %for.body269.2 ], [ 3, %land.rhs264.3 ], [ %spec.select663, %for.body269.3 ]
  %61 = phi i64 [ %inc280, %for.body269 ], [ %52, %land.rhs264 ], [ %inc280, %land.rhs264.1 ], [ %inc280.1, %for.body269.1 ], [ %inc280.1, %land.rhs264.2 ], [ %inc280.2, %for.body269.2 ], [ %inc280.2, %land.rhs264.3 ], [ %inc280.3, %for.body269.3 ]
  %sub282 = sub i64 %out_cnt.5591, %i.8568
  %cmp284 = icmp eq i64 %61, 4
  br i1 %cmp284, label %if.then286, label %sw.epilog

if.then286:                                       ; preds = %for.end281
  store i64 0, ptr %bread301, align 8
  %62 = load i64, ptr %desc_len297, align 8
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.19, i64 noundef %62) #11
  %63 = load ptr, ptr %tmpdir, align 8
  %call290 = call i32 @cli_gentempfd(ptr noundef %63, ptr noundef nonnull %0, ptr noundef nonnull %fd318) #11
  %tobool291.not = icmp eq i32 %call290, 0
  br i1 %tobool291.not, label %if.end293, label %cleanup361

if.end293:                                        ; preds = %if.then286
  %add.ptr287 = getelementptr inbounds i8, ptr %out_data.0592, i64 %i.8568
  store i32 5, ptr %internal_state, align 4
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.20) #11
  br label %sw.epilog

sw.bb296:                                         ; preds = %while.body80
  %64 = load i64, ptr %desc_len297, align 8
  %out_cnt.5. = call i64 @llvm.umin.i64(i64 %out_cnt.5591, i64 %64)
  %65 = load i64, ptr %bread301, align 8
  %tobool302.not = icmp eq i64 %65, 0
  br i1 %tobool302.not, label %if.then303, label %if.end331

if.then303:                                       ; preds = %sw.bb296
  %66 = load i8, ptr %out_data.0592, align 1
  %cmp306.not = icmp eq i8 %66, -48
  br i1 %cmp306.not, label %lor.lhs.false308, label %if.then313

lor.lhs.false308:                                 ; preds = %if.then303
  %arrayidx309 = getelementptr inbounds i8, ptr %out_data.0592, i64 1
  %67 = load i8, ptr %arrayidx309, align 1
  %cmp311.not = icmp eq i8 %67, -49
...
if.then313:                                       ; preds = %lor.lhs.false308, %if.then303
  ...
  store i64 1, ptr %bread301, align 8
  %conv317 = trunc i64 %64 to i32
  store i32 %conv317, ptr %out, align 4
  %68 = load i32, ptr %fd318, align 8
  %call320 = call i32 @cli_writen(i32 noundef %68, ptr noundef nonnull %out, i32 noundef 4) #11
...
if.then313.if.end331_crit_edge:                   ; preds = %if.then313
  %.pre = load i64, ptr %desc_len297, align 8
  br label %if.end331

if.else328:                                       ; preds = %lor.lhs.false308
  store i64 2, ptr %bread301, align 8
  br label %if.end331

if.end331:                                        ; preds = %if.then313.if.end331_crit_edge, %if.else328, %sw.bb296
  %69 = phi i64 [ %.pre, %if.then313.if.end331_crit_edge ], [ %64, %if.else328 ], [ %64, %sw.bb296 ]
  %sub333 = sub i64 %69, %out_cnt.5.
  store i64 %sub333, ptr %desc_len297, align 8
  %70 = load i32, ptr %fd318, align 8
  %conv335 = trunc i64 %out_cnt.5. to i32
  %call336 = call i32 @cli_writen(i32 noundef %70, ptr noundef nonnull %out_data.0592, i32 noundef %conv335) #11
...
if.end341:                                        ; preds = %if.end331
  %add.ptr342 = getelementptr inbounds i8, ptr %out_data.0592, i64 %out_cnt.5.
  %sub343 = sub i64 %out_cnt.5591, %out_cnt.5.
  %71 = load i64, ptr %desc_len297, align 8
  %tobool345.not = icmp eq i64 %71, 0
  br i1 %tobool345.not, label %if.then346, label %sw.epilog

if.then346:                                       ; preds = %if.end341
  %72 = load ptr, ptr %ctx, align 8
  %call347 = call fastcc i32 @decode_and_scan(ptr noundef nonnull %0, ptr noundef %72)
  %tobool348.not = icmp eq i32 %call347, 0
  br i1 %tobool348.not, label %if.end350, label %cleanup361
...
sw.epilog:                                        ; preds = %if.end341, %if.end350, %for.end281, %if.end293, %if.then249, %if.end212, %if.then221, %for.end140, %if.end162, %for.end107, %if.then111
  %out_cnt.8 = phi i64 [ %sub282, %if.end293 ], [ %sub282, %for.end281 ], [ %out_cnt.6560, %if.then249 ], [ %sub216, %if.then221 ], [ %sub216, %if.end212 ], [ %sub141, %if.end162 ], [ %sub141, %for.end140 ], [ %sub, %if.then111 ], [ %sub, %for.end107 ], [ %sub343, %if.end341 ], [ %sub343, %if.end350 ]
  %out_data.2 = phi ptr [ %add.ptr287, %if.end293 ], [ %out_data.0592, %for.end281 ], [ %add.ptr250, %if.then249 ], [ %add.ptr225, %if.then221 ], [ %add.ptr190, %if.end212 ], [ %add.ptr146, %if.end162 ], [ %out_data.0592, %for.end140 ], [ %add.ptr, %if.then111 ], [ %out_data.0592, %for.end107 ], [ %add.ptr342, %if.end341 ], [ %add.ptr342, %if.end350 ]
  %tobool78.not = icmp eq i64 %out_cnt.8, 0
  br i1 %tobool78.not, label %cleanup361, label %while.body80
...
if.end6:                                          ; preds = %if.then4, %if.end2
  ...
  %3 = load ptr, ptr %desc_name, align 8
...
if.end21:                                         ; preds = %if.then18, %if.end15
  store i32 -1, ptr %fd16, align 8
  %7 = load ptr, ptr %data, align 8
  %tobool.not = icmp eq ptr %7, null
  br i1 %tobool.not, label %if.end32, label %if.then24

if.then24:                                        ; preds = %if.end21
  %8 = load i8, ptr @cli_leavetemps_flag, align 1
...
if.then26:                                        ; preds = %if.then24
  ...
  %.pre57 = load ptr, ptr %data, align 8
  br label %if.end29
