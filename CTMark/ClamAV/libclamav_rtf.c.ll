...
if.end11.i427:                                    ; preds = %if.end.i425
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(104) %state, ptr noundef nonnull align 8 dereferenceable(104) %arrayidx.i428, i64 104, i1 false), !tbaa.struct !17
  br label %sw.epilog295
...
pop_state.exit.i:                                 ; preds = %while.body.i
  ...
  %.pre.i432 = load ptr, ptr %cb_data279, align 8, !tbaa !29
...
pop_state.exit.i448:                              ; preds = %while.body.i441
  ...
  store i64 %dec13.i.i449, ptr %stack_cnt, align 8, !tbaa !8
  %arrayidx.i.i450 = getelementptr inbounds %struct.rtf_state, ptr %7, i64 %dec13.i.i449
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(104) %state, ptr noundef nonnull align 8 dereferenceable(104) %arrayidx.i.i450, i64 104, i1 false), !tbaa.struct !17
  %.pre.i451 = load ptr, ptr %cb_data279, align 8, !tbaa !29
...
if.end:                                           ; preds = %entry
  ...
  %1 = load i32, ptr %has_partial, align 8, !tbaa !41
...
land.rhs:                                         ; preds = %for.cond.preheader, %for.inc
  %i.0579 = phi i64 [ 0, %for.cond.preheader ], [ %inc, %for.inc ]
  %arrayidx = getelementptr inbounds i8, ptr %input, i64 %i.0579
...
for.inc:                                          ; preds = %land.rhs
  %inc = add nuw i64 %i.0579, 1
  %exitcond.not = icmp eq i64 %inc, %len
  br i1 %exitcond.not, label %cleanup361, label %land.rhs, !llvm.loop !48

if.then9:                                         ; preds = %land.rhs
  %partial = getelementptr inbounds %struct.rtf_object_data, ptr %0, i64 0, i32 2
  %6 = load i32, ptr %partial, align 4, !tbaa !40
  %inc10 = add nuw i64 %i.0579, 1
...
if.end21:                                         ; preds = %if.end, %if.then9
  ...
  %cmp23580 = icmp ult i64 %i.1, %len
  br i1 %cmp23580, label %for.body25.lr.ph, label %for.end74
...
for.body25:                                       ; preds = %for.body25.lr.ph, %for.inc72
  %out_cnt.1582 = phi i64 [ %out_cnt.0, %for.body25.lr.ph ], [ %out_cnt.3, %for.inc72 ]
  %i.2581 = phi i64 [ %i.1, %for.body25.lr.ph ], [ %inc73, %for.inc72 ]
  %8 = load ptr, ptr %call26, align 8, !tbaa !20
  %arrayidx27 = getelementptr inbounds i8, ptr %input, i64 %i.2581
...
if.then34:                                        ; preds = %for.body25
  ...
  %shl = shl i8 %conv39, 4
  %13 = add nuw i64 %i.2581, 1
  %umax = tail call i64 @llvm.umax.i64(i64 %len, i64 %13)
  %14 = add i64 %umax, -1
  br label %while.cond

while.cond:                                       ; preds = %land.rhs43, %if.then34
  %i.3.in = phi i64 [ %i.2581, %if.then34 ], [ %i.3, %land.rhs43 ]
  %exitcond609.not = icmp eq i64 %i.3.in, %14
  br i1 %exitcond609.not, label %while.end, label %land.rhs43

land.rhs43:                                       ; preds = %while.cond
  %i.3 = add nuw i64 %i.3.in, 1
  %arrayidx45 = getelementptr inbounds i8, ptr %input, i64 %i.3
  %15 = load i8, ptr %arrayidx45, align 1, !tbaa !5
  %idxprom47 = zext i8 %15 to i64
  %arrayidx48 = getelementptr inbounds i16, ptr %8, i64 %idxprom47
  %16 = load i16, ptr %arrayidx48, align 2, !tbaa !34
  %17 = and i16 %16, 4096
  %tobool51.not = icmp eq i16 %17, 0
  br i1 %tobool51.not, label %while.cond, label %while.end, !llvm.loop !49
...
cleanup.thread:                                   ; preds = %while.end
  ...
  %19 = load i16, ptr %arrayidx65, align 2, !tbaa !34
  %conv66 = trunc i16 %19 to i8
  %or67 = or i8 %shl, %conv66
  %inc69 = add i64 %out_cnt.1582, 1
  %arrayidx70 = getelementptr inbounds [8192 x i8], ptr %outdata, i64 0, i64 %out_cnt.1582
...
cleanup:                                          ; preds = %while.end
  ...
  store i32 %conv58, ptr %partial59, align 4, !tbaa !40
  store i32 1, ptr %has_partial, align 8, !tbaa !41
  br label %for.end74

for.inc72:                                        ; preds = %cleanup.thread, %for.body25
  %i.4 = phi i64 [ %i.2581, %for.body25 ], [ %i.3.lcssa, %cleanup.thread ]
  %out_cnt.3 = phi i64 [ %out_cnt.1582, %for.body25 ], [ %inc69, %cleanup.thread ]
  %inc73 = add i64 %i.4, 1
  %cmp23 = icmp ult i64 %inc73, %len
  br i1 %cmp23, label %for.body25, label %for.end74, !llvm.loop !50

for.end74:                                        ; preds = %for.inc72, %if.end21, %cleanup
  %out_cnt.1577 = phi i64 [ %out_cnt.1582, %cleanup ], [ %out_cnt.0, %if.end21 ], [ %out_cnt.3, %for.inc72 ]
  %tobool78.not591 = icmp eq i64 %out_cnt.1577, 0
  br i1 %tobool78.not591, label %cleanup361, label %while.body80.lr.ph
...
while.body80:                                     ; preds = %while.body80.lr.ph, %sw.epilog
  %out_data.0593 = phi ptr [ %outdata, %while.body80.lr.ph ], [ %out_data.2, %sw.epilog ]
  %out_cnt.5592 = phi i64 [ %out_cnt.1577, %while.body80.lr.ph ], [ %out_cnt.8, %sw.epilog ]
  %20 = load i32, ptr %internal_state, align 4, !tbaa !43
...
sw.bb:                                            ; preds = %while.body80
  ...
  %.pre620 = load i64, ptr %bread301, align 8, !tbaa !42
  br label %land.rhs84

land.rhs84:                                       ; preds = %sw.bb, %for.inc103
  %21 = phi i64 [ %.pre620, %sw.bb ], [ %inc106, %for.inc103 ]
  %i.5590 = phi i64 [ 0, %sw.bb ], [ %inc104, %for.inc103 ]
...
for.body88:                                       ; preds = %land.rhs84
  ...
  %22 = load i8, ptr %arrayidx90, align 1, !tbaa !5
  %arrayidx92 = getelementptr inbounds i8, ptr %out_data.0593, i64 %i.5590
  %23 = load i8, ptr %arrayidx92, align 1, !tbaa !5
...
if.then96:                                        ; preds = %for.body88
  ...
  %arrayidx97 = getelementptr inbounds [8 x i8], ptr @rtf_data_magic, i64 0, i64 %i.5590
  %24 = load i8, ptr %arrayidx97, align 1, !tbaa !5
  ...
  %.pre621 = load i64, ptr %bread301, align 8, !tbaa !42
  br label %for.inc103

for.inc103:                                       ; preds = %for.body88, %if.then96
  %25 = phi i64 [ %21, %for.body88 ], [ %.pre621, %if.then96 ]
  %inc104 = add nuw i64 %i.5590, 1
  %inc106 = add i64 %25, 1
  store i64 %inc106, ptr %bread301, align 8, !tbaa !42
  %exitcond617.not = icmp eq i64 %inc104, %out_cnt.5592
  br i1 %exitcond617.not, label %for.end107, label %land.rhs84, !llvm.loop !51

for.end107:                                       ; preds = %for.inc103, %land.rhs84
  %26 = phi i64 [ %inc106, %for.inc103 ], [ %21, %land.rhs84 ]
  %i.5.lcssa = phi i64 [ %out_cnt.5592, %for.inc103 ], [ %i.5590, %land.rhs84 ]
  %sub = sub i64 %out_cnt.5592, %i.5.lcssa
  %cmp109 = icmp eq i64 %26, 8
  br i1 %cmp109, label %if.then111, label %sw.epilog

if.then111:                                       ; preds = %for.end107
  %add.ptr = getelementptr inbounds i8, ptr %out_data.0593, i64 %i.5.lcssa
  store i64 0, ptr %bread301, align 8, !tbaa !42
  store i32 1, ptr %internal_state, align 4, !tbaa !43
  br label %sw.epilog

sw.bb115:                                         ; preds = %while.body80
  %27 = load i64, ptr %bread301, align 8, !tbaa !42
  %cmp117 = icmp eq i64 %27, 0
  br i1 %cmp117, label %if.then119, label %land.rhs124

if.then119:                                       ; preds = %sw.bb115
  store i64 0, ptr %desc_len297, align 8, !tbaa !52
...
for.body129:                                      ; preds = %land.rhs124
  %28 = load i8, ptr %out_data.0593, align 1, !tbaa !5
  %conv131 = zext i8 %28 to i64
  %mul = shl nuw nsw i64 %27, 3
  %shl133 = shl nuw nsw i64 %conv131, %mul
  %29 = load i64, ptr %desc_len297, align 8, !tbaa !52
  %or135 = or i64 %shl133, %29
  store i64 %or135, ptr %desc_len297, align 8, !tbaa !52
  %inc139 = add nuw nsw i64 %27, 1
  store i64 %inc139, ptr %bread301, align 8, !tbaa !42
  %exitcond615.not = icmp eq i64 %out_cnt.5592, 1
  br i1 %exitcond615.not, label %for.end140, label %land.rhs124.1, !llvm.loop !53
...
for.body129.1:                                    ; preds = %land.rhs124.1
  %arrayidx130.1 = getelementptr inbounds i8, ptr %out_data.0593, i64 1
  %30 = load i8, ptr %arrayidx130.1, align 1, !tbaa !5
  %conv131.1 = zext i8 %30 to i64
  %mul.1 = shl nuw nsw i64 %inc139, 3
  %shl133.1 = shl nuw nsw i64 %conv131.1, %mul.1
  %31 = load i64, ptr %desc_len297, align 8, !tbaa !52
  %or135.1 = or i64 %shl133.1, %31
  store i64 %or135.1, ptr %desc_len297, align 8, !tbaa !52
  %inc139.1 = add nuw nsw i64 %27, 2
  store i64 %inc139.1, ptr %bread301, align 8, !tbaa !42
  %exitcond615.not.1 = icmp eq i64 %out_cnt.5592, 2
  br i1 %exitcond615.not.1, label %for.end140, label %land.rhs124.2, !llvm.loop !53
...
for.body129.2:                                    ; preds = %land.rhs124.2
  %arrayidx130.2 = getelementptr inbounds i8, ptr %out_data.0593, i64 2
  %32 = load i8, ptr %arrayidx130.2, align 1, !tbaa !5
  %conv131.2 = zext i8 %32 to i64
  %mul.2 = shl nuw nsw i64 %inc139.1, 3
  %shl133.2 = shl nuw nsw i64 %conv131.2, %mul.2
  %33 = load i64, ptr %desc_len297, align 8, !tbaa !52
  %or135.2 = or i64 %shl133.2, %33
  store i64 %or135.2, ptr %desc_len297, align 8, !tbaa !52
  %inc139.2 = add nuw nsw i64 %27, 3
  store i64 %inc139.2, ptr %bread301, align 8, !tbaa !42
  %exitcond615.not.2 = icmp eq i64 %out_cnt.5592, 3
  br i1 %exitcond615.not.2, label %for.end140, label %land.rhs124.3, !llvm.loop !53
...
for.body129.3:                                    ; preds = %land.rhs124.3
  %arrayidx130.3 = getelementptr inbounds i8, ptr %out_data.0593, i64 3
  %34 = load i8, ptr %arrayidx130.3, align 1, !tbaa !5
  %conv131.3 = zext i8 %34 to i64
  %mul.3 = shl nuw nsw i64 %inc139.2, 3
  %shl133.3 = shl nuw nsw i64 %conv131.3, %mul.3
  %35 = load i64, ptr %desc_len297, align 8, !tbaa !52
  %or135.3 = or i64 %shl133.3, %35
  store i64 %or135.3, ptr %desc_len297, align 8, !tbaa !52
  %inc139.3 = add nuw nsw i64 %27, 4
  store i64 %inc139.3, ptr %bread301, align 8, !tbaa !42
  %exitcond615.not.3 = icmp eq i64 %out_cnt.5592, 4
  %spec.select = select i1 %exitcond615.not.3, i64 %out_cnt.5592, i64 4
  br label %for.end140, !llvm.loop !53
...
for.end140:                                       ; preds = %for.body129.3, %land.rhs124.3, %for.body129.2, %land.rhs124.2, %for.body129.1, %land.rhs124.1, %land.rhs124, %for.body129
  %i.6571 = phi i64 [ %out_cnt.5592, %for.body129 ], [ 0, %land.rhs124 ], [ 1, %land.rhs124.1 ], [ %out_cnt.5592, %for.body129.1 ], [ 2, %land.rhs124.2 ], [ %out_cnt.5592, %for.body129.2 ], [ 3, %land.rhs124.3 ], [ %spec.select, %for.body129.3 ]
  ...
  %sub141 = sub i64 %out_cnt.5592, %i.6571
  %cmp143 = icmp eq i64 %36, 4
  br i1 %cmp143, label %if.then145, label %sw.epilog

if.then145:                                       ; preds = %for.end140
  %add.ptr146 = getelementptr inbounds i8, ptr %out_data.0593, i64 %i.6571
  store i64 0, ptr %bread301, align 8, !tbaa !42
  %37 = load i64, ptr %desc_len297, align 8, !tbaa !52
...
if.end158:                                        ; preds = %if.else154, %if.then151
  ...
  store ptr %call156, ptr %desc_name181, align 8, !tbaa !47
  %tobool160.not = icmp eq ptr %call156, null
  br i1 %tobool160.not, label %cleanup361, label %if.end162

if.end162:                                        ; preds = %if.end158
  store i32 2, ptr %internal_state, align 4, !tbaa !43
  %38 = load i64, ptr %desc_len297, align 8, !tbaa !52
...
sw.bb166:                                         ; preds = %while.body80
  ...
  %.pre618 = load i64, ptr %bread301, align 8, !tbaa !42
  br label %land.lhs.true

land.lhs.true:                                    ; preds = %sw.bb166, %for.body179
  %39 = phi i64 [ %.pre618, %sw.bb166 ], [ %inc187, %for.body179 ]
  %i.7586 = phi i64 [ 0, %sw.bb166 ], [ %inc185, %for.body179 ]
  %40 = load i64, ptr %desc_len297, align 8, !tbaa !52
...
for.body179:                                      ; preds = %land.lhs.true
  %arrayidx180 = getelementptr inbounds i8, ptr %out_data.0593, i64 %i.7586
  %41 = load i8, ptr %arrayidx180, align 1, !tbaa !5
  %42 = load ptr, ptr %desc_name181, align 8, !tbaa !47
  %arrayidx183 = getelementptr inbounds i8, ptr %42, i64 %39
  store i8 %41, ptr %arrayidx183, align 1, !tbaa !5
  %inc185 = add nuw i64 %i.7586, 1
  %43 = load i64, ptr %bread301, align 8, !tbaa !42
  %inc187 = add i64 %43, 1
  store i64 %inc187, ptr %bread301, align 8, !tbaa !42
  %exitcond613.not = icmp eq i64 %inc185, %out_cnt.5592
  br i1 %exitcond613.not, label %for.body179.for.end188_crit_edge, label %land.lhs.true, !llvm.loop !54

for.body179.for.end188_crit_edge:                 ; preds = %for.body179
  %.pre619 = load i64, ptr %desc_len297, align 8, !tbaa !52
  br label %for.end188

for.end188:                                       ; preds = %land.lhs.true, %for.body179.for.end188_crit_edge
  %44 = phi i64 [ %.pre619, %for.body179.for.end188_crit_edge ], [ %40, %land.lhs.true ]
  %45 = phi i64 [ %inc187, %for.body179.for.end188_crit_edge ], [ %39, %land.lhs.true ]
  %i.7.lcssa = phi i64 [ %out_cnt.5592, %for.body179.for.end188_crit_edge ], [ %i.7586, %land.lhs.true ]
  %sub189 = sub i64 %out_cnt.5592, %i.7.lcssa
  %add.ptr190 = getelementptr inbounds i8, ptr %out_data.0593, i64 %i.7.lcssa
...
if.end200:                                        ; preds = %for.end188
  %46 = load ptr, ptr %desc_name181, align 8, !tbaa !47
  %arrayidx203 = getelementptr inbounds i8, ptr %46, i64 %45
  store i8 0, ptr %arrayidx203, align 1, !tbaa !5
  %47 = load i64, ptr %desc_len297, align 8, !tbaa !52
  %48 = load i64, ptr %bread301, align 8, !tbaa !42
...
if.then209:                                       ; preds = %if.end200
  ...
  store i64 %sub211, ptr %desc_len297, align 8, !tbaa !52
...
if.then221:                                       ; preds = %if.end212
  ...
  store i64 0, ptr %bread301, align 8, !tbaa !42
  %49 = load ptr, ptr %desc_name181, align 8, !tbaa !47
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.16, ptr noundef %49) #11
  %50 = load ptr, ptr %desc_name181, align 8, !tbaa !47
  call void @free(ptr noundef %50) #11
  store ptr null, ptr %desc_name181, align 8, !tbaa !47
  store i32 3, ptr %internal_state, align 4, !tbaa !43
  br label %sw.epilog

sw.bb232:                                         ; preds = %while.body80
  %51 = load i64, ptr %bread301, align 8, !tbaa !42
  %sub234 = sub i64 8, %51
  %cmp235 = icmp ult i64 %out_cnt.5592, %sub234
  br i1 %cmp235, label %if.end245, label %if.end245.thread

if.end245.thread:                                 ; preds = %sw.bb232
  %sub243 = sub i64 %out_cnt.5592, %sub234
  br label %if.then249
...
if.then249:                                       ; preds = %if.end245.thread, %if.end245
  ...
  %add.ptr250 = getelementptr inbounds i8, ptr %out_data.0593, i64 8
  store i64 0, ptr %bread301, align 8, !tbaa !42
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.17) #11
  store i32 4, ptr %internal_state, align 4, !tbaa !43
  br label %sw.epilog

sw.bb254:                                         ; preds = %while.body80
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.18) #11
  %52 = load i64, ptr %bread301, align 8, !tbaa !42
...
for.body269:                                      ; preds = %land.rhs264
  %53 = load i8, ptr %out_data.0593, align 1, !tbaa !5
  %conv271 = zext i8 %53 to i64
  %mul273 = shl nuw nsw i64 %52, 3
  %shl274 = shl nuw nsw i64 %conv271, %mul273
  %54 = load i64, ptr %desc_len297, align 8, !tbaa !52
  %or276 = or i64 %shl274, %54
  store i64 %or276, ptr %desc_len297, align 8, !tbaa !52
  %inc280 = add nuw nsw i64 %52, 1
  store i64 %inc280, ptr %bread301, align 8, !tbaa !42
  %exitcond611.not = icmp eq i64 %out_cnt.5592, 1
  br i1 %exitcond611.not, label %for.end281, label %land.rhs264.1, !llvm.loop !55
...
for.body269.1:                                    ; preds = %land.rhs264.1
  %arrayidx270.1 = getelementptr inbounds i8, ptr %out_data.0593, i64 1
  %55 = load i8, ptr %arrayidx270.1, align 1, !tbaa !5
  %conv271.1 = zext i8 %55 to i64
  %mul273.1 = shl nuw nsw i64 %inc280, 3
  %shl274.1 = shl nuw nsw i64 %conv271.1, %mul273.1
  %56 = load i64, ptr %desc_len297, align 8, !tbaa !52
  %or276.1 = or i64 %shl274.1, %56
  store i64 %or276.1, ptr %desc_len297, align 8, !tbaa !52
  %inc280.1 = add nuw nsw i64 %52, 2
  store i64 %inc280.1, ptr %bread301, align 8, !tbaa !42
  %exitcond611.not.1 = icmp eq i64 %out_cnt.5592, 2
  br i1 %exitcond611.not.1, label %for.end281, label %land.rhs264.2, !llvm.loop !55
...
for.body269.2:                                    ; preds = %land.rhs264.2
  %arrayidx270.2 = getelementptr inbounds i8, ptr %out_data.0593, i64 2
  %57 = load i8, ptr %arrayidx270.2, align 1, !tbaa !5
  %conv271.2 = zext i8 %57 to i64
  %mul273.2 = shl nuw nsw i64 %inc280.1, 3
  %shl274.2 = shl nuw nsw i64 %conv271.2, %mul273.2
  %58 = load i64, ptr %desc_len297, align 8, !tbaa !52
  %or276.2 = or i64 %shl274.2, %58
  store i64 %or276.2, ptr %desc_len297, align 8, !tbaa !52
  %inc280.2 = add nuw nsw i64 %52, 3
  store i64 %inc280.2, ptr %bread301, align 8, !tbaa !42
  %exitcond611.not.2 = icmp eq i64 %out_cnt.5592, 3
  br i1 %exitcond611.not.2, label %for.end281, label %land.rhs264.3, !llvm.loop !55
...
for.body269.3:                                    ; preds = %land.rhs264.3
  %arrayidx270.3 = getelementptr inbounds i8, ptr %out_data.0593, i64 3
  %59 = load i8, ptr %arrayidx270.3, align 1, !tbaa !5
  %conv271.3 = zext i8 %59 to i64
  %mul273.3 = shl nuw nsw i64 %inc280.2, 3
  %shl274.3 = shl nuw nsw i64 %conv271.3, %mul273.3
  %60 = load i64, ptr %desc_len297, align 8, !tbaa !52
  %or276.3 = or i64 %shl274.3, %60
  store i64 %or276.3, ptr %desc_len297, align 8, !tbaa !52
  %inc280.3 = add nuw nsw i64 %52, 4
  store i64 %inc280.3, ptr %bread301, align 8, !tbaa !42
  %exitcond611.not.3 = icmp eq i64 %out_cnt.5592, 4
  %spec.select664 = select i1 %exitcond611.not.3, i64 %out_cnt.5592, i64 4
  br label %for.end281, !llvm.loop !55
...
for.end281:                                       ; preds = %for.body269.3, %land.rhs264.3, %for.body269.2, %land.rhs264.2, %for.body269.1, %land.rhs264.1, %land.rhs264, %for.body269
  %i.8569 = phi i64 [ %out_cnt.5592, %for.body269 ], [ 0, %land.rhs264 ], [ 1, %land.rhs264.1 ], [ %out_cnt.5592, %for.body269.1 ], [ 2, %land.rhs264.2 ], [ %out_cnt.5592, %for.body269.2 ], [ 3, %land.rhs264.3 ], [ %spec.select664, %for.body269.3 ]
...
if.end293:                                        ; preds = %if.then286
  %add.ptr287 = getelementptr inbounds i8, ptr %out_data.0593, i64 %i.8569
  store i32 5, ptr %internal_state, align 4, !tbaa !43
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.20) #11
  br label %sw.epilog

sw.bb296:                                         ; preds = %while.body80
  %64 = load i64, ptr %desc_len297, align 8, !tbaa !52
  %out_cnt.5. = call i64 @llvm.umin.i64(i64 %out_cnt.5592, i64 %64)
  %65 = load i64, ptr %bread301, align 8, !tbaa !42
  %tobool302.not = icmp eq i64 %65, 0
  br i1 %tobool302.not, label %if.then303, label %if.end331

if.then303:                                       ; preds = %sw.bb296
  %66 = load i8, ptr %out_data.0593, align 1, !tbaa !5
  %cmp306.not = icmp eq i8 %66, -48
  br i1 %cmp306.not, label %lor.lhs.false308, label %if.then313

lor.lhs.false308:                                 ; preds = %if.then303
  %arrayidx309 = getelementptr inbounds i8, ptr %out_data.0593, i64 1
  %67 = load i8, ptr %arrayidx309, align 1, !tbaa !5
...
if.then313:                                       ; preds = %lor.lhs.false308, %if.then303
  ...
  store i64 1, ptr %bread301, align 8, !tbaa !42
  %conv317 = trunc i64 %64 to i32
  store i32 %conv317, ptr %out, align 4
  %68 = load i32, ptr %fd318, align 8, !tbaa !38
...
if.then313.if.end331_crit_edge:                   ; preds = %if.then313
  %.pre = load i64, ptr %desc_len297, align 8, !tbaa !52
  br label %if.end331

if.else328:                                       ; preds = %lor.lhs.false308
  store i64 2, ptr %bread301, align 8, !tbaa !42
  br label %if.end331
...
if.end331:                                        ; preds = %if.then313.if.end331_crit_edge, %if.else328, %sw.bb296
  ...
  store i64 %sub333, ptr %desc_len297, align 8, !tbaa !52
  %70 = load i32, ptr %fd318, align 8, !tbaa !38
  %conv335 = trunc i64 %out_cnt.5. to i32
  %call336 = call i32 @cli_writen(i32 noundef %70, ptr noundef nonnull %out_data.0593, i32 noundef %conv335) #11
...
if.end341:                                        ; preds = %if.end331
  %add.ptr342 = getelementptr inbounds i8, ptr %out_data.0593, i64 %out_cnt.5.
  %sub343 = sub i64 %out_cnt.5592, %out_cnt.5.
  %71 = load i64, ptr %desc_len297, align 8, !tbaa !52
  %tobool345.not = icmp eq i64 %71, 0
  br i1 %tobool345.not, label %if.then346, label %sw.epilog

if.then346:                                       ; preds = %if.end341
  %72 = load ptr, ptr %ctx, align 8, !tbaa !45
...
sw.epilog:                                        ; preds = %cleanup353.thread, %if.end341, %for.end281, %if.end293, %if.then249, %if.end212, %if.then221, %for.end140, %if.end162, %for.end107, %if.then111
  ...
  %out_data.2 = phi ptr [ %add.ptr287, %if.end293 ], [ %out_data.0593, %for.end281 ], [ %add.ptr250, %if.then249 ], [ %add.ptr225, %if.then221 ], [ %add.ptr190, %if.end212 ], [ %add.ptr146, %if.end162 ], [ %out_data.0593, %for.end140 ], [ %add.ptr, %if.then111 ], [ %out_data.0593, %for.end107 ], [ %add.ptr342, %cleanup353.thread ], [ %add.ptr342, %if.end341 ]
...
if.end:                                           ; preds = %entry
  ...
  %1 = load i32, ptr %fd, align 8, !tbaa !38
...
if.end6:                                          ; preds = %if.then4, %if.end2
  ...
  %3 = load ptr, ptr %desc_name, align 8, !tbaa !47
...
entry:
  ...
  %1 = load i64, ptr %bread, align 8, !tbaa !42
  %cmp = icmp eq i64 %1, 1
  %fd = getelementptr inbounds %struct.rtf_object_data, ptr %data, i64 0, i32 1
  %2 = load i32, ptr %fd, align 8, !tbaa !38
...
if.end15:                                         ; preds = %land.lhs.true, %if.else, %if.then11, %if.then, %if.then6
  ...
  %6 = load i32, ptr %fd16, align 8, !tbaa !38
...
if.end21:                                         ; preds = %if.then18, %if.end15
  store i32 -1, ptr %fd16, align 8, !tbaa !38
