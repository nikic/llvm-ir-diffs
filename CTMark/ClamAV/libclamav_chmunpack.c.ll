...
if.end3.i:                                        ; preds = %if.end.i104
  ...
  %15 = load i32, ptr %version.i108, align 1, !tbaa !26
...
if.end26:                                         ; preds = %if.end3.i
  ...
  %21 = load i32, ptr %version.i108, align 1, !tbaa !26
  ...
  %29 = load i32, ptr %lang_id.i125, align 1, !tbaa !35
...
if.then13.i.i:                                    ; preds = %if.end11.i.i
  ...
  store ptr %call14.i.i, ptr %call.i135.i, align 8, !tbaa !11
...
if.else.i137.i:                                   ; preds = %if.end11.i.i, %read_enc_int.exit.thread.i.i
  ...
  store ptr %call19.i.i, ptr %call.i135.i, align 8, !tbaa !11
...
if.end24.i.i:                                     ; preds = %if.else.i137.i
  ...
  %45 = load ptr, ptr %call.i135.i, align 8, !tbaa !11
...
if.end4.i105.i.i:                                 ; preds = %do.body.i101.i.i
  ...
  %46 = load i8, ptr %current.0.i103.i.i, align 1, !tbaa !16
  %47 = and i8 %46, 127
  ...
  br i1 %tobool.not.i110.i.i, label %read_enc_int.exit113.i.i, label %do.body.i101.i.i, !llvm.loop !40
...
if.end4.i119.i.i:                                 ; preds = %do.body.i115.i.i
  ...
  %48 = load i8, ptr %current.0.i117.i.i, align 1, !tbaa !16
  %49 = and i8 %48, 127
  ...
  br i1 %tobool.not.i124.i.i, label %read_enc_int.exit127.i.i, label %do.body.i115.i.i, !llvm.loop !40
...
if.end4.i133.i.i:                                 ; preds = %do.body.i129.i.i
  ...
  %50 = load i8, ptr %current.0.i131.i.i, align 1, !tbaa !16
  %51 = and i8 %50, 127
  ...
  br i1 %tobool.not.i138.i.i, label %read_enc_int.exit141.i.i, label %do.body.i129.i.i, !llvm.loop !40
...
land.lhs.true38.i.i:                              ; preds = %land.lhs.true.i.i
  ...
  %53 = load i8, ptr %arrayidx40.i.i, align 1, !tbaa !16
...
if.end52.i.i:                                     ; preds = %if.else48.i.i, %land.lhs.true38.i.i
  ...
  %54 = load ptr, ptr %next49.sink180.i.i, align 8, !tbaa !5
  store ptr %54, ptr %next.i.i, align 8, !tbaa !5
  store ptr %call.i135.i, ptr %next49.sink180.i.i, align 8, !tbaa !5
...
if.end52.i:                                       ; preds = %if.end52.i.i, %if.end.i134.i, %if.else.i, %if.then23.i.i, %if.then17.i.i, %if.then10.i.i, %if.then.i.i, %if.end30.i
  ...
  %59 = load i32, ptr %free_space.i.i, align 4, !tbaa !46
...
if.then.i142.i:                                   ; preds = %if.end52.i
  ...
  %60 = load i32, ptr %block_prev.i.i, align 4, !tbaa !47
  ...
  %61 = load i32, ptr %block_next.i.i, align 8, !tbaa !48
  ...
  %62 = load i16, ptr %num_entries.i.i, align 8, !tbaa !39
...
read_chunk.exit:                                  ; preds = %if.end52.i, %if.then.i142.i
  %63 = load ptr, ptr %chunk_data.i, align 8, !tbaa !36
  call void @free(ptr noundef %63) #12
  call void @free(ptr noundef nonnull %call.i) #12
  %dec = add i32 %num_chunks.0224, -1
  %64 = load i32, ptr %block_len.i, align 1, !tbaa !28
...
while.cond.preheader.i:                           ; preds = %while.end
  %entry1.0235.i = load ptr, ptr %next6, align 8, !tbaa !5
...
while.body.i:                                     ; preds = %if.end23.i, %while.body.lr.ph.i
  ...
  %65 = load ptr, ptr %entry1.0240.i, align 8, !tbaa !11
...
if.end10.i.i:                                     ; preds = %if.end12.i.i.i, %if.end9.i.i.i
  ...
  %69 = load i32, ptr %version.i.i, align 1, !tbaa !50
  %reset_interval.i.i = getelementptr inbounds %struct.lzx_control_tag, ptr %call.i.i164, i64 0, i32 3
  %70 = load i32, ptr %reset_interval.i.i, align 1, !tbaa !52
...
sw.bb.i.i:                                        ; preds = %if.end20.i.i
  ...
  %71 = load i32, ptr %window_size.i.i, align 1, !tbaa !53
...
sw.epilog.i.i:                                    ; preds = %sw.bb.i.i, %if.end20.i.i
  ...
  %72 = load i32, ptr %call.i.i164, align 1, !tbaa !54
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.53, i32 noundef %72) #12
  %73 = load i8, ptr %signature.i.i, align 1, !tbaa !16
  ...
  %74 = load i8, ptr %arrayidx2.i.i.i, align 1, !tbaa !16
  ...
  %75 = load i8, ptr %arrayidx5.i.i.i, align 1, !tbaa !16
  ...
  %76 = load i8, ptr %arrayidx8.i.i.i, align 1, !tbaa !16
  ...
  %77 = load i32, ptr %version.i.i, align 1, !tbaa !50
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.4, i32 noundef %77) #12
  %78 = load i32, ptr %reset_interval.i.i, align 1, !tbaa !52
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.54, i32 noundef %78) #12
  %79 = load i32, ptr %window_size.i.i, align 1, !tbaa !53
  ...
  %80 = load i32, ptr %cache_size.i.i.i, align 1, !tbaa !55
...
lor.lhs.false2.i.i203.i:                          ; preds = %if.end5.i.i
  ...
  store i64 %add.i200.i, ptr %rt_offset.i.i, align 1, !tbaa !59
...
if.end11.i.i159:                                  ; preds = %if.end12.i.i215.i, %if.end9.i.i208.i
  ...
  %89 = load i32, ptr %entry_size.i.i, align 1, !tbaa !61
  %frame_len.i.i = getelementptr inbounds %struct.lzx_reset_table_tag, ptr %call.i201.i, i64 0, i32 5
  %90 = load i64, ptr %frame_len.i.i, align 1, !tbaa !62
...
if.end29.i.i:                                     ; preds = %if.end22.i.i, %if.end22.i.i
  ...
  %91 = load i32, ptr %call.i201.i, align 1, !tbaa !63
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.63, i32 noundef %91) #12
  %92 = load i32, ptr %entry_size.i.i, align 1, !tbaa !61
  ...
  %93 = load i32, ptr %table_offset.i.i.i, align 1, !tbaa !64
  ...
  %94 = load i64, ptr %uncom_len.i.i.i, align 1, !tbaa !65
  ...
  %95 = load i64, ptr %com_len.i.i.i, align 1, !tbaa !66
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.67, i64 noundef %95) #12
  %96 = load i64, ptr %frame_len.i.i, align 1, !tbaa !62
...
if.end23.i:                                       ; preds = %abort.i210.i, %if.end29.i.i, %if.end5.i.i, %if.end.i197.i, %if.then19.i, %if.else15.i, %if.end.i192.i, %if.then13.i, %abort.i.i, %sw.epilog.i.i, %if.end4.i.i163, %if.end.i.i, %if.then8.i
  ...
  br i1 %tobool.not.i146, label %while.end.i, label %while.body.i, !llvm.loop !67
...
if.end30.i149:                                    ; preds = %while.end.i
  ...
  %97 = load i32, ptr %window_size.i, align 1, !tbaa !53
...
sw.epilog.i:                                      ; preds = %sw.bb36.i, %sw.bb35.i, %sw.bb34.i, %sw.bb33.i, %sw.bb32.i, %sw.bb31.i, %if.end30.i149
  ...
  %98 = load i32, ptr %reset_interval.i, align 1, !tbaa !52
...
if.end50.i:                                       ; preds = %if.end41.i
  ...
  %102 = load ptr, ptr %next, align 8, !tbaa !5
...
while.body65.i:                                   ; preds = %while.cond63.backedge.i, %while.body65.lr.ph.i
  ...
  %103 = load i64, ptr %section.i, align 8, !tbaa !42
...
if.end70.i:                                       ; preds = %while.body65.i
  ...
  %104 = load i64, ptr %offset71.i, align 8, !tbaa !43
...
if.end88.i:                                       ; preds = %if.end78.i
  ...
  %106 = load i64, ptr %length89.i, align 8, !tbaa !44
...
if.end15.i.i:                                     ; preds = %if.end.i220.i
  ...
  br i1 %cmp.not.i221.i, label %chm_copy_file_data.exit.i, label %while.body.i.i153, !llvm.loop !69
...
chm_copy_file_data.exit.i:                        ; preds = %if.end15.i.i, %if.then12.i.i, %if.then.i.i156, %if.end88.i
  ...
  %108 = load i64, ptr %length89.i, align 8, !tbaa !44
...
if.end96.i:                                       ; preds = %if.then94.i, %chm_copy_file_data.exit.i
  ...
  %109 = load ptr, ptr %next98.i, align 8, !tbaa !5
  %inc.i = add nuw nsw i32 %count.0.ph246.i, 1
  %tobool64.not243.i = icmp eq ptr %109, null
  br i1 %tobool64.not243.i, label %if.end105.i, label %while.body65.lr.ph.i, !llvm.loop !68
...
abort.critedge:                                   ; preds = %if.end12.i127.i, %if.else.i124.i, %if.then5.i118.i, %if.end12.i107.i, %lor.lhs.false2.i93.thread.i, %lor.lhs.false2.i93.i, %if.end12.i.i139, %if.else.i.i136, %if.then5.i.i131, %if.end9.i, %if.else.i
  %110 = load ptr, ptr %chunk_data.i, align 8, !tbaa !36
...
while.body.i166:                                  ; preds = %abort, %if.end.i168
  ...
  %111 = load ptr, ptr %next1.i, align 8, !tbaa !5
  %112 = load ptr, ptr %file_l.addr.09.i, align 8, !tbaa !11
...
if.end.i168:                                      ; preds = %if.then.i167, %while.body.i166
  ...
  br i1 %tobool.not.i169, label %while.body.i172, label %while.body.i166, !llvm.loop !70
...
while.body.i172:                                  ; preds = %if.end.i168, %if.end.i177
  ...
  %113 = load ptr, ptr %next1.i174, align 8, !tbaa !5
  %114 = load ptr, ptr %file_l.addr.09.i173, align 8, !tbaa !11
...
if.end.i177:                                      ; preds = %if.then.i176, %while.body.i172
  ...
  br i1 %tobool.not.i178, label %free_file_list.exit180, label %while.body.i172, !llvm.loop !70
