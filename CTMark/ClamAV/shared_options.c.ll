...
while.body.i112:                                  ; preds = %if.end.i110, %if.end9.i121
  ...
  %10 = load ptr, ptr %optarg.i114, align 8, !tbaa !10
...
if.end5.i117:                                     ; preds = %if.then3.i116, %while.body.i112
  ...
  %11 = load ptr, ptr %optlong.i118, align 8, !tbaa !12
...
while.body.i133:                                  ; preds = %if.end.i131, %if.end9.i142
  ...
  %15 = load ptr, ptr %optarg.i135, align 8, !tbaa !10
...
if.end5.i138:                                     ; preds = %if.then3.i137, %while.body.i133
  ...
  %16 = load ptr, ptr %optlong.i139, align 8, !tbaa !12
...
while.body.i154:                                  ; preds = %if.end.i152, %if.end9.i163
  ...
  %25 = load ptr, ptr %optarg.i156, align 8, !tbaa !10
...
if.end5.i159:                                     ; preds = %if.then3.i158, %while.body.i154
  ...
  %26 = load ptr, ptr %optlong.i160, align 8, !tbaa !12
...
if.end9.i163:                                     ; preds = %if.then7.i162, %if.end5.i159
  ...
  %27 = load ptr, ptr %next.i164, align 8, !tbaa !13
  call void @free(ptr noundef nonnull %handler.028.i155) #8
  %tobool1.not.i165 = icmp eq ptr %27, null
  br i1 %tobool1.not.i165, label %opt_free.exit171, label %while.body.i154, !llvm.loop !14
...
for.inc61:                                        ; preds = %for.body46, %if.then57
  ...
  br i1 %exitcond181.not, label %cleanup, label %for.body46, !llvm.loop !24
