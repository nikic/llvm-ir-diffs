; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/shared_options.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/shared_options.c"
...
if.end5:                                          ; preds = %if.then3, %while.body
  ...
  %2 = load ptr, ptr %optlong, align 8
...
while.cond:                                       ; preds = %entry, %while.cond.backedge
  store i32 0, ptr %opt_index, align 4
...
sw.bb:                                            ; preds = %while.cond
  %0 = load i32, ptr %opt_index, align 4
  %idxprom = sext i32 %0 to i64
  %arrayidx = getelementptr inbounds %struct.option, ptr %options_long, i64 %idxprom
  %1 = load ptr, ptr %arrayidx, align 8
  %call4 = call fastcc i32 @register_option(ptr noundef nonnull %call, ptr noundef %1, i8 noundef signext 0, ptr noundef %options_long, ptr noundef %accepted_long)
...
while.body.i:                                     ; preds = %if.end.i, %if.end9.i
  ...
  %3 = load ptr, ptr %optarg.i, align 8
...
if.end5.i:                                        ; preds = %if.then3.i, %while.body.i
  ...
  %4 = load ptr, ptr %optlong.i, align 8
...
while.end.i:                                      ; preds = %if.end9.i, %if.end.i
  ...
  %6 = load ptr, ptr %filename.i, align 8
...
sw.default:                                       ; preds = %while.cond
  ...
  br i1 %tobool9.not, label %if.end.i131, label %if.then10

if.then10:                                        ; preds = %sw.default
  %7 = load i32, ptr %opt_index, align 4
...
if.end16:                                         ; preds = %if.then10, %if.then12
  ...
  %call17 = call fastcc i32 @register_option(ptr noundef nonnull %call, ptr noundef %longname.0, i8 noundef signext %conv, ptr noundef %options_long, ptr noundef %accepted_long)
...
if.end.i110:                                      ; preds = %if.end16
  ...
  %tobool1.not27.i111 = icmp eq ptr %9, null
  br i1 %tobool1.not27.i111, label %while.end.i124, label %while.body.i112

while.body.i112:                                  ; preds = %if.end.i110, %if.end9.i121
  %handler.028.i113 = phi ptr [ %12, %if.end9.i121 ], [ %9, %if.end.i110 ]
  %optarg.i114 = getelementptr inbounds %struct.optnode, ptr %handler.028.i113, i64 0, i32 2
  %10 = load ptr, ptr %optarg.i114, align 8
  %tobool2.not.i115 = icmp eq ptr %10, null
  br i1 %tobool2.not.i115, label %if.end5.i117, label %if.then3.i116

if.then3.i116:                                    ; preds = %while.body.i112
  call void @free(ptr noundef nonnull %10) #8
  br label %if.end5.i117

if.end5.i117:                                     ; preds = %if.then3.i116, %while.body.i112
  %optlong.i118 = getelementptr inbounds %struct.optnode, ptr %handler.028.i113, i64 0, i32 1
  %11 = load ptr, ptr %optlong.i118, align 8
  %tobool6.not.i119 = icmp eq ptr %11, null
  br i1 %tobool6.not.i119, label %if.end9.i121, label %if.then7.i120

if.then7.i120:                                    ; preds = %if.end5.i117
  call void @free(ptr noundef nonnull %11) #8
  br label %if.end9.i121

if.end9.i121:                                     ; preds = %if.then7.i120, %if.end5.i117
  %next.i122 = getelementptr inbounds %struct.optnode, ptr %handler.028.i113, i64 0, i32 3
  %12 = load ptr, ptr %next.i122, align 8
  call void @free(ptr noundef nonnull %handler.028.i113) #8
  %tobool1.not.i123 = icmp eq ptr %12, null
  br i1 %tobool1.not.i123, label %while.end.i124, label %while.body.i112

while.end.i124:                                   ; preds = %if.end9.i121, %if.end.i110
  %filename.i125 = getelementptr inbounds %struct.optstruct, ptr %call, i64 0, i32 1
  %13 = load ptr, ptr %filename.i125, align 8
  %tobool10.not.i126 = icmp eq ptr %13, null
  br i1 %tobool10.not.i126, label %opt_free.exit129, label %if.then11.i127

if.then11.i127:                                   ; preds = %while.end.i124
  call void @free(ptr noundef nonnull %13) #8
  br label %opt_free.exit129

opt_free.exit129:                                 ; preds = %while.end.i124, %if.then11.i127
  call void @free(ptr noundef nonnull %call) #8
  br label %cleanup

if.end.i131:                                      ; preds = %sw.default
  call void (ptr, ...) @mprintf(ptr noundef nonnull @.str.1) #8
  %14 = load ptr, ptr %call, align 8
  %tobool1.not27.i132 = icmp eq ptr %14, null
  br i1 %tobool1.not27.i132, label %while.end.i145, label %while.body.i133

while.body.i133:                                  ; preds = %if.end.i131, %if.end9.i142
  %handler.028.i134 = phi ptr [ %17, %if.end9.i142 ], [ %14, %if.end.i131 ]
  %optarg.i135 = getelementptr inbounds %struct.optnode, ptr %handler.028.i134, i64 0, i32 2
  %15 = load ptr, ptr %optarg.i135, align 8
  %tobool2.not.i136 = icmp eq ptr %15, null
  br i1 %tobool2.not.i136, label %if.end5.i138, label %if.then3.i137

if.then3.i137:                                    ; preds = %while.body.i133
  call void @free(ptr noundef nonnull %15) #8
  br label %if.end5.i138

if.end5.i138:                                     ; preds = %if.then3.i137, %while.body.i133
  %optlong.i139 = getelementptr inbounds %struct.optnode, ptr %handler.028.i134, i64 0, i32 1
  %16 = load ptr, ptr %optlong.i139, align 8
  %tobool6.not.i140 = icmp eq ptr %16, null
  br i1 %tobool6.not.i140, label %if.end9.i142, label %if.then7.i141

if.then7.i141:                                    ; preds = %if.end5.i138
  call void @free(ptr noundef nonnull %16) #8
  br label %if.end9.i142

if.end9.i142:                                     ; preds = %if.then7.i141, %if.end5.i138
  %next.i143 = getelementptr inbounds %struct.optnode, ptr %handler.028.i134, i64 0, i32 3
  %17 = load ptr, ptr %next.i143, align 8
  call void @free(ptr noundef nonnull %handler.028.i134) #8
  %tobool1.not.i144 = icmp eq ptr %17, null
  br i1 %tobool1.not.i144, label %while.end.i145, label %while.body.i133

while.end.i145:                                   ; preds = %if.end9.i142, %if.end.i131
  %filename.i146 = getelementptr inbounds %struct.optstruct, ptr %call, i64 0, i32 1
  %18 = load ptr, ptr %filename.i146, align 8
  %tobool10.not.i147 = icmp eq ptr %18, null
  br i1 %tobool10.not.i147, label %opt_free.exit150, label %if.then11.i148

if.then11.i148:                                   ; preds = %while.end.i145
  call void @free(ptr noundef nonnull %18) #8
  br label %opt_free.exit150

opt_free.exit150:                                 ; preds = %while.end.i145, %if.then11.i148
  call void @free(ptr noundef nonnull %call) #8
  br label %cleanup
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %len.0173 = phi i32 [ 0, %for.body.preheader ], [ %conv33, %for.body ]
...
for.end:                                          ; preds = %for.body
  ...
  store ptr %call38, ptr %filename, align 8
  %tobool40.not = icmp eq ptr %call38, null
  br i1 %tobool40.not, label %if.end.i152, label %for.body46.lr.ph
...
if.end.i152:                                      ; preds = %for.end
  call void (ptr, ...) @mprintf(ptr noundef nonnull @.str) #8
  %24 = load ptr, ptr %call, align 8
  %tobool1.not27.i153 = icmp eq ptr %24, null
  br i1 %tobool1.not27.i153, label %opt_free.exit171, label %while.body.i154

while.body.i154:                                  ; preds = %if.end.i152, %if.end9.i163
  %handler.028.i155 = phi ptr [ %27, %if.end9.i163 ], [ %24, %if.end.i152 ]
  %optarg.i156 = getelementptr inbounds %struct.optnode, ptr %handler.028.i155, i64 0, i32 2
  %25 = load ptr, ptr %optarg.i156, align 8
  %tobool2.not.i157 = icmp eq ptr %25, null
  br i1 %tobool2.not.i157, label %if.end5.i159, label %if.then3.i158

if.then3.i158:                                    ; preds = %while.body.i154
  call void @free(ptr noundef nonnull %25) #8
  br label %if.end5.i159

if.end5.i159:                                     ; preds = %if.then3.i158, %while.body.i154
  %optlong.i160 = getelementptr inbounds %struct.optnode, ptr %handler.028.i155, i64 0, i32 1
  %26 = load ptr, ptr %optlong.i160, align 8
  %tobool6.not.i161 = icmp eq ptr %26, null
  br i1 %tobool6.not.i161, label %if.end9.i163, label %if.then7.i162

if.then7.i162:                                    ; preds = %if.end5.i159
  call void @free(ptr noundef nonnull %26) #8
  br label %if.end9.i163

if.end9.i163:                                     ; preds = %if.then7.i162, %if.end5.i159
  %next.i164 = getelementptr inbounds %struct.optnode, ptr %handler.028.i155, i64 0, i32 3
  %27 = load ptr, ptr %next.i164, align 8
  call void @free(ptr noundef nonnull %handler.028.i155) #8
  %tobool1.not.i165 = icmp eq ptr %27, null
  br i1 %tobool1.not.i165, label %opt_free.exit171, label %while.body.i154

opt_free.exit171:                                 ; preds = %if.end9.i163, %if.end.i152
  call void @free(ptr noundef nonnull %call) #8
  br label %cleanup

for.body46:                                       ; preds = %for.body46.lr.ph, %for.inc61
  %indvars.iv177 = phi i64 [ %20, %for.body46.lr.ph ], [ %indvars.iv.next178, %for.inc61 ]
  %arrayidx49 = getelementptr inbounds ptr, ptr %argv, i64 %indvars.iv177
  ...
  %29 = icmp eq i64 %indvars.iv177, %sext
...
for.inc61:                                        ; preds = %for.body46, %if.then57
  ...
  br i1 %exitcond181.not, label %cleanup, label %for.body46
...
for.cond.preheader:                               ; preds = %entry
  %0 = load ptr, ptr %options_long, align 8
...
for.cond:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  br i1 %tobool1.not, label %if.then11, label %for.body
...
for.cond16.preheader:                             ; preds = %if.end13
  %4 = load ptr, ptr %accepted_long, align 8
...
for.body20:                                       ; preds = %for.cond16.preheader, %for.body20
  ...
  br i1 %tobool19.not, label %for.end28, label %for.body20
...
if.end41:                                         ; preds = %if.end37
  store i8 %optshort, ptr %call38, align 8
...
if.then44:                                        ; preds = %if.end41
  ...
  store ptr %call46, ptr %optarg, align 8
...
if.else53:                                        ; preds = %if.end41
  ...
  store ptr null, ptr %optarg54, align 8
  br label %if.end55
...
if.end55:                                         ; preds = %if.else53, %if.end50
  ...
  store ptr %call58, ptr %optlong59, align 8
...
if.end64:                                         ; preds = %if.end55
  ...
  store ptr %call38, ptr %opt, align 8
  br label %cleanup
...
while.cond.preheader:                             ; preds = %entry
  %handler.012 = load ptr, ptr %opt, align 8
...
while.body:                                       ; preds = %while.cond.preheader, %if.end7
  ...
  %0 = load ptr, ptr %optlong2, align 8
...
if.end7:                                          ; preds = %land.lhs.true, %while.body
  ...
  %handler.0 = load ptr, ptr %next, align 8
...
while.cond.preheader:                             ; preds = %entry
  %handler.014 = load ptr, ptr %opt, align 8
...
while.cond.preheader:                             ; preds = %entry
  %handler.016 = load ptr, ptr %opt, align 8
...
if.then6:                                         ; preds = %land.lhs.true
  store ptr %handler.018, ptr %optnode, align 8
...
while.end:                                        ; preds = %if.end7, %while.cond.preheader
  store ptr null, ptr %optnode, align 8
  br label %cleanup
...
lor.lhs.false:                                    ; preds = %entry
  %0 = load ptr, ptr %optnode, align 8
...
while.cond.preheader:                             ; preds = %lor.lhs.false
  ...
  %handler.022 = load ptr, ptr %handler.0.in21, align 8
...
while.body:                                       ; preds = %while.cond.preheader, %if.end8
  ...
  %1 = load ptr, ptr %optlong3, align 8
...
if.then7:                                         ; preds = %land.lhs.true
  store ptr %handler.024, ptr %optnode, align 8
...
if.end8:                                          ; preds = %land.lhs.true, %while.body
  ...
  %handler.0 = load ptr, ptr %handler.0.in, align 8
