...
for.inc105:                                       ; preds = %if.then97, %if.end66, %if.then80, %if.end94
  ...
  br i1 %cmp23.not, label %for.end107, label %for.body25, !llvm.loop !18
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load539 = load <4 x i8>, ptr %15, align 1, !tbaa !12
...
for.body122:                                      ; preds = %for.body122.preheader545, %for.body122
  ...
  br i1 %exitcond481.not, label %for.end133, label %for.body122, !llvm.loop !22
...
if.end.i203:                                      ; preds = %if.then99
  store i32 0, ptr %entries, align 8, !tbaa !64
  %5 = load ptr, ptr %dbstat, align 8, !tbaa !66
...
if.end138:                                        ; preds = %if.else134, %if.then126
  %8 = load ptr, ptr %stattab, align 8, !tbaa !67
  %9 = load i32, ptr %entries, align 8, !tbaa !64
  %sub = add i32 %9, -1
