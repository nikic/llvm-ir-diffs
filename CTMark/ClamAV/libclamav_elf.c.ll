...
sw.epilog47:                                      ; preds = %sw.default43, %sw.bb42, %sw.bb41, %sw.bb40, %sw.bb39, %sw.bb38, %sw.bb37, %sw.bb36, %sw.bb35, %sw.bb34, %sw.bb33, %sw.bb32, %sw.bb31, %sw.bb30
  ...
  %4 = load i32, ptr %e_entry, align 4
  ...
  %5 = load i16, ptr %e_phnum, align 4
...
if.then66:                                        ; preds = %if.end62
  ...
  %8 = load i16, ptr %e_phentsize, align 2
...
if.then71:                                        ; preds = %if.then66
  ...
  %9 = load i32, ptr %options72, align 8
  %and73 = and i32 %9, 64
...
if.end82:                                         ; preds = %if.then66
  ...
  %11 = load i32, ptr %e_phoff, align 4
...
if.then89:                                        ; preds = %if.end82
  ...
  %12 = load i32, ptr %options90, align 8
  %and91 = and i32 %12, 64
...
if.end125.us:                                     ; preds = %for.body.us
  ...
  %15 = load i32, ptr %arrayidx110.us, align 4
  ...
  %16 = load i32, ptr %p_offset.us, align 4
  ...
  %17 = load i32, ptr %p_vaddr.us, align 4
  ...
  %18 = load i32, ptr %p_filesz.us, align 4
  ...
  %19 = load i32, ptr %p_memsz.us, align 4
  ...
  br i1 %exitcond491.not, label %for.end, label %for.body.us
...
if.then114:                                       ; preds = %for.body.us, %for.body
  ...
  %20 = load i32, ptr %options115, align 8
...
if.end125:                                        ; preds = %for.body
  ...
  %23 = load i32, ptr %arrayidx110, align 4
  ...
  %24 = load i32, ptr %p_offset, align 4
  ...
  %26 = load i32, ptr %p_filesz, align 4
  ...
  %27 = load i32, ptr %p_memsz, align 4
...
if.then143:                                       ; preds = %for.end
  ...
  %29 = load i32, ptr %options144, align 8
...
if.end155:                                        ; preds = %if.end154, %if.end62
  ...
  %31 = load i16, ptr %e_shnum, align 4
...
if.then161:                                       ; preds = %if.end155
  ...
  %32 = load i32, ptr %options162, align 8
...
if.end172:                                        ; preds = %if.end155
  ...
  %34 = load i16, ptr %e_shentsize, align 2
...
if.then177:                                       ; preds = %if.end172
  ...
  %35 = load i32, ptr %options178, align 8
...
if.end188:                                        ; preds = %if.end172
  ...
  %37 = load i32, ptr %e_shoff, align 4
...
if.then195:                                       ; preds = %if.end188
  ...
  %38 = load i32, ptr %options196, align 8
...
if.then223:                                       ; preds = %for.body217
  ...
  %40 = load i32, ptr %options224, align 8
...
if.end234:                                        ; preds = %for.body217
  ...
  %43 = load i32, ptr %sh_offset, align 4
  ...
  %44 = load i32, ptr %sh_size, align 4
  ...
  %45 = load i32, ptr %sh_type, align 4
...
sw.epilog262:                                     ; preds = %if.end234, %sw.default261, %sw.bb260, %sw.bb259, %sw.bb258, %sw.bb257, %sw.bb256, %sw.bb255, %sw.bb254, %sw.bb253, %sw.bb252, %sw.bb251, %sw.bb250, %sw.bb249, %sw.bb248, %sw.bb247, %sw.bb246, %sw.bb245
  ...
  %46 = load i32, ptr %sh_flags, align 4
...
if.then268:                                       ; preds = %sw.epilog262
  ...
  %.pre = load i32, ptr %sh_flags, align 4
...
if.then276:                                       ; preds = %if.end269
  ...
  %.pre497 = load i32, ptr %sh_flags, align 4
...
if.end285:                                        ; preds = %if.then284, %if.end277
  ...
  br i1 %exitcond496.not, label %for.end288, label %for.body217
...
for.body.us:                                      ; preds = %for.body.lr.ph, %for.inc.us
  ...
  %0 = load i32, ptr %p_vaddr.us, align 4
...
land.lhs.true.us:                                 ; preds = %for.body.us
  ...
  %1 = load i32, ptr %p_memsz.us, align 4
  %add.us = add i32 %1, %0
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %3 = load i32, ptr %p_memsz, align 4
...
for.inc:                                          ; preds = %for.body, %land.lhs.true
  ...
  br i1 %exitcond.not, label %if.then15, label %for.body
...
if.end16:                                         ; preds = %land.lhs.true, %land.lhs.true.us
  ...
  %4 = load i32, ptr %.us-phi57, align 4
...
if.end11:                                         ; preds = %if.end5
  ...
  %e_phnum = getelementptr inbounds %struct.elf_file_hdr32, ptr %file_hdr, i64 0, i32 10
  %2 = load i16, ptr %e_phnum, align 4
  %add.i = tail call i16 @llvm.bswap.i16(i16 %2)
  %retval.0.i = select i1 %cmp15, i16 %add.i, i16 %2
...
if.then29:                                        ; preds = %if.end24
  %e_phentsize = getelementptr inbounds %struct.elf_file_hdr32, ptr %file_hdr, i64 0, i32 9
  %4 = load i16, ptr %e_phentsize, align 2
...
if.end65:                                         ; preds = %for.end, %if.end24
  ...
  store i32 %fentry.0, ptr %elfinfo, align 8
  %e_shnum = getelementptr inbounds %struct.elf_file_hdr32, ptr %file_hdr, i64 0, i32 12
  %8 = load i16, ptr %e_shnum, align 4
...
if.end71:                                         ; preds = %if.end65
  ...
  store i16 %retval.0.i215, ptr %nsections, align 4
  %e_shentsize = getelementptr inbounds %struct.elf_file_hdr32, ptr %file_hdr, i64 0, i32 11
  %9 = load i16, ptr %e_shentsize, align 2
...
if.end77:                                         ; preds = %if.end71
  %e_shoff = getelementptr inbounds %struct.elf_file_hdr32, ptr %file_hdr, i64 0, i32 6
  %10 = load i32, ptr %e_shoff, align 4
...
if.end85:                                         ; preds = %if.end77
  %11 = load i16, ptr %nsections, align 4
  ...
  store ptr %call88, ptr %section, align 8
...
if.end115.us:                                     ; preds = %for.body106.us
  ...
  %12 = load i32, ptr %sh_addr.us, align 4
  ...
  store i32 %or5.i224.us, ptr %rsz.us, align 4
  %indvars.iv.next240 = add nuw nsw i64 %indvars.iv239, 1
  %exitcond243.not = icmp eq i64 %indvars.iv.next240, %conv93
  br i1 %exitcond243.not, label %for.end136, label %for.body106.us
...
if.end115:                                        ; preds = %for.body106
  ...
  %20 = load <2 x i32>, ptr %sh_offset, align 4
  store <2 x i32> %20, ptr %raw, align 4
  %indvars.iv.next235 = add nuw nsw i64 %indvars.iv234, 1
  %exitcond238.not = icmp eq i64 %indvars.iv.next235, %conv93
  br i1 %exitcond238.not, label %for.end136, label %for.body106
