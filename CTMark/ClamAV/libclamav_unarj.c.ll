...
if.end57.i:                                       ; preds = %for.body.i
  %13 = load i8, ptr %arrayidx.i, align 1, !tbaa !20
...
for.cond76.i:                                     ; preds = %if.end88.i
  ...
  store i16 %indvars18, ptr %count.i, align 2, !tbaa !5
...
if.end88.i:                                       ; preds = %for.body81.i
  %17 = load i8, ptr %arrayidx83.i, align 1, !tbaa !20
...
if.end61.i:                                       ; preds = %for.body.i
  %16 = load i8, ptr %arrayidx.i, align 1, !tbaa !20
...
for.cond80.preheader.i:                           ; preds = %if.end74.i
  store i16 0, ptr %count.i, align 2, !tbaa !5
  %18 = load i16, ptr %header_size.i, align 2, !tbaa !5
...
for.cond80.i:                                     ; preds = %if.end92.i
  ...
  store i16 %indvars21, ptr %count.i, align 2, !tbaa !5
...
if.end92.i:                                       ; preds = %for.body85.i
  %20 = load i8, ptr %arrayidx87.i, align 1, !tbaa !20
...
if.end121.i:                                      ; preds = %for.cond116.i
  %23 = load i16, ptr %count.i, align 2, !tbaa !5
...
for.end135.i:                                     ; preds = %if.end121.i
  %25 = load <2 x i32>, ptr %comp_size.i, align 1, !tbaa !38
  store <2 x i32> %25, ptr %metadata, align 8, !tbaa !38
  %26 = load i8, ptr %method.i, align 1, !tbaa !28
  %method141.i = getelementptr inbounds %struct.arj_metadata_tag, ptr %metadata, i64 0, i32 2
  store i8 %26, ptr %method141.i, align 8, !tbaa !39
  %27 = load i8, ptr %flags.i, align 1, !tbaa !27
  %28 = and i8 %27, 1
  ...
  %29 = load ptr, ptr %filename110.i, align 8, !tbaa !35
...
if.end.i58:                                       ; preds = %sw.bb29
  ...
  %call.i.i.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i, i32 noundef 16), !range !52
...
while.cond.preheader.i:                           ; preds = %if.end.i58
  ...
  %7 = load i32, ptr %orig_size.i, align 4, !tbaa !53
...
if.then.i.i:                                      ; preds = %while.body.i61
  ...
  %call.i.i148.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i, i32 noundef 16), !range !52
  ...
  %11 = lshr i16 %10, 7
  %call.i.i.i.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i, i32 noundef 9), !range !52
...
if.then.i.i.i:                                    ; preds = %if.then.i.i
  ...
  %call.i168.i.i.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i, i32 noundef 9), !range !52
...
vector.body:                                      ; preds = %vector.body, %if.then.i.i.i
  ...
  store <8 x i16> %broadcast.splat, ptr %21, align 2, !tbaa !5
  %index.next.3 = add nuw nsw i64 %index, 64
  %22 = icmp eq i64 %index.next.3, 4096
  br i1 %22, label %read_c_len.exit.i.i, label %vector.body, !llvm.loop !54
...
while.body107.preheader.i.i.i:                    ; preds = %while.cond103.preheader.i.i.i
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %scevgep.i.i.i, i8 0, i64 %27, i1 false), !tbaa !20
...
if.end.i.i.i:                                     ; preds = %do.body.i.i.i
  ...
  br i1 %cmp45.i.i.i, label %do.body.i.i.i, label %if.end47.i.i.i, !llvm.loop !57
...
if.end47.i.i.i:                                   ; preds = %if.end.i.i.i, %while.body.i.i.i
  ...
  %call51.i.i.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i, i32 noundef %conv50.i.i.i), !range !52
...
while.body79.preheader.sink.split.i.i.i:          ; preds = %if.else68.i.i.i, %if.then55.i.i.i
  ...
  %call.i178.i.i.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i, i32 noundef %.sink206.i.i.i), !range !52
...
vector.body130:                                   ; preds = %vector.body130, %vector.ph126
  ...
  br i1 %42, label %while.body79.i.i.i.preheader, label %vector.body130, !llvm.loop !58
...
if.end84.i.i.i:                                   ; preds = %while.body79.i.i.i
  ...
  br i1 %cmp77.i.i.i, label %while.body79.i.i.i, label %if.end101.loopexit.i.i.i, !llvm.loop !59
...
if.end101.i.i.i:                                  ; preds = %if.end101.loopexit.i.i.i, %if.end94.i.i.i
  ...
  br i1 %cmp18.i.i.i, label %while.body.i.i.i, label %while.cond103.preheader.i.i.i, !llvm.loop !60
...
if.end14.i.i:                                     ; preds = %do.body.i.i
  ...
  br i1 %cmp28.i.i, label %do.body.i.i, label %decode_c.exit.i, !llvm.loop !61
...
decode_c.exit.i:                                  ; preds = %if.end14.i.i, %if.end.i.i
  ...
  %call34.i.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i, i32 noundef %conv33.i.i), !range !52
...
if.end.i162.i:                                    ; preds = %do.body.i159.i
  ...
  %j.1.i166.i = load i16, ptr %j.1.in.i165.i, align 2, !tbaa !5
  %conv9.i.i = lshr i32 %mask.0.i161.i, 1
  %cmp20.i.i = icmp ugt i16 %j.1.i166.i, 16
  br i1 %cmp20.i.i, label %do.body.i159.i, label %if.end22.i.i, !llvm.loop !62
...
if.end22.i.i:                                     ; preds = %if.end.i162.i, %if.else.i
  ...
  %call.i154.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i, i32 noundef %conv25.i.i), !range !52
...
if.then29.i.i:                                    ; preds = %if.end22.i.i
  ...
  %call.i.i156.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i, i32 noundef %conv30.i.i), !range !52
...
while.body61.i:                                   ; preds = %while.body61.i, %while.cond51.preheader.i
  ...
  br i1 %or.cond117.i, label %while.body61.i, label %if.end99.loopexit.i, !llvm.loop !63
...
if.end90.i:                                       ; preds = %if.then86.i, %while.body76.i
  ...
  br i1 %cmp74.i, label %while.body76.i, label %if.end99.i, !llvm.loop !64
...
if.end99.i:                                       ; preds = %if.end90.i, %if.end99.loopexit.i, %if.then17.i, %if.then11.i
  ...
  %70 = load i32, ptr %orig_size.i, align 4, !tbaa !53
  %cmp7.i = icmp ult i32 %count.1.i, %70
  br i1 %cmp7.i, label %while.body.i61, label %while.end100.i, !llvm.loop !65
...
if.end.i67:                                       ; preds = %sw.bb31
  ...
  store i32 %74, ptr %comp_size3.i68, align 4, !tbaa !47
  ...
  %call.i.i69 = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef 16), !range !52
...
if.end6.i:                                        ; preds = %if.end.i67
  ...
  store i16 0, ptr %getbuf.i, align 2, !tbaa !66
  %getlen.i = getelementptr inbounds %struct.arj_decode_tag, ptr %decode_data.i63, i64 0, i32 7
  store i16 0, ptr %getlen.i, align 8, !tbaa !67
  %orig_size.i72 = getelementptr inbounds %struct.arj_metadata_tag, ptr %metadata, i64 0, i32 1
  %75 = load i32, ptr %orig_size.i72, align 4, !tbaa !53
  %cmp7251.not.i = icmp eq i32 %75, 0
  br i1 %cmp7251.not.i, label %if.end107.i91, label %while.body.i74

while.body.i74thread-pre-split:                   ; preds = %if.end99.i83
  %.pr = load i16, ptr %getlen.i, align 8, !tbaa !67
  %.pre256.i.pre = load i16, ptr %getbuf.i, align 2, !tbaa !66
  br label %while.body.i74

while.body.i74:                                   ; preds = %if.end6.i, %while.body.i74thread-pre-split
  %.pre256.i = phi i16 [ %.pre256.i.pre, %while.body.i74thread-pre-split ], [ 0, %if.end6.i ]
  %76 = phi i16 [ %.pr, %while.body.i74thread-pre-split ], [ 0, %if.end6.i ]
  %out_ptr.0253.i = phi i32 [ %out_ptr.3.i85, %while.body.i74thread-pre-split ], [ 0, %if.end6.i ]
  %count.0252.i = phi i32 [ %count.1.i84, %while.body.i74thread-pre-split ], [ 0, %if.end6.i ]
  %cmp3.i.i = icmp slt i16 %76, 1
  br i1 %cmp3.i.i, label %if.end.i.thread.i, label %if.end.i.i75

if.end.i.i75:                                     ; preds = %while.body.i74
  %shl.i.i76 = shl i16 %.pre256.i, 1
  %dec.i.i77 = add nsw i16 %76, -1
  store i16 %dec.i.i77, ptr %getlen.i, align 8, !tbaa !67
  %cmp23.i.i = icmp sgt i16 %.pre256.i, -1
  br i1 %cmp23.i.i, label %if.then11.i93, label %if.end26.i.i

if.end.i.thread.i:                                ; preds = %while.body.i74
  %77 = load i16, ptr %bit_buf.i.i, align 2, !tbaa !49
  ...
  %conv9.i.i98 = or i16 %.pre256.i, %78
  store i16 %conv9.i.i98, ptr %getbuf.i, align 2, !tbaa !66
  %conv11.i.i = sext i16 %76 to i32
  %sub.i.i = sub nsw i32 16, %conv11.i.i
  %call.i149.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef %sub.i.i), !range !52
  %.pre.i = load i16, ptr %getbuf.i, align 2, !tbaa !66
  %shl.i259.i = shl i16 %.pre.i, 1
  %cmp23.i261.i = icmp sgt i16 %.pre.i, -1
  br i1 %cmp23.i261.i, label %if.end27.i, label %if.end.1.i.i
...
if.then.1.i.i:                                    ; preds = %if.end26.i.i
  %79 = load i16, ptr %bit_buf.i.i, align 2, !tbaa !49
  ...
  store i16 %conv9.1.i.i, ptr %getbuf.i, align 2, !tbaa !66
  %sub.1.i.i = sub nuw nsw i32 16, %conv2108.1.i.i
  %call.1.i.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef %sub.1.i.i), !range !52
  %.pre.i.i92 = load i16, ptr %getbuf.i, align 2, !tbaa !66
...
if.end.1.i.i:                                     ; preds = %if.then.1.i.i, %if.end26.i.i, %if.end.i.thread.i
  ...
  %82 = phi i16 [ %.pre.i.i92, %if.then.1.i.i ], [ %shl.i.i76, %if.end26.i.i ], [ %shl.i259.i, %if.end.i.thread.i ]
  %shl.1.i.i = shl i16 %82, 1
  %dec.1.i.i = add nsw i16 %81, -1
  store i16 %dec.1.i.i, ptr %getlen.i, align 8, !tbaa !67
...
if.end.2.i.i:                                     ; preds = %if.end26.1.i.i
  ...
  store i16 %dec.2.i.i, ptr %getlen.i, align 8, !tbaa !67
...
if.end.2.thread.i.i:                              ; preds = %if.end26.1.i.i
  %83 = load i16, ptr %bit_buf.i.i, align 2, !tbaa !49
  %conv9.2.i.i = or i16 %83, %shl.1.i.i
  store i16 %conv9.2.i.i, ptr %getbuf.i, align 2, !tbaa !66
  %call.2.i.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef 16), !range !52
  %.pre131.i.i = load i16, ptr %getbuf.i, align 2, !tbaa !66
  %shl.2137.i.i = shl i16 %.pre131.i.i, 1
  store i16 15, ptr %getlen.i, align 8, !tbaa !67
  %cmp23.2139.i.i = icmp sgt i16 %.pre131.i.i, -1
  br i1 %cmp23.2139.i.i, label %for.end.thread.i.i, label %if.end.3.i.i
...
if.then.3.i.i:                                    ; preds = %if.end26.2.i.i
  %84 = load i16, ptr %bit_buf.i.i, align 2, !tbaa !49
  ...
  store i16 %conv9.3.i.i, ptr %getbuf.i, align 2, !tbaa !66
  %sub.3.i.i = sub nuw nsw i32 16, %conv2108.3.i.i
  %call.3.i.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef %sub.3.i.i), !range !52
  %.pre132.i.i = load i16, ptr %getbuf.i, align 2, !tbaa !66
...
if.end.3.i.i:                                     ; preds = %if.then.3.i.i, %if.end26.2.i.i, %if.end.2.thread.i.i
  ...
  store i16 %dec.3.i.i, ptr %getlen.i, align 8, !tbaa !67
...
if.end.4.i.i:                                     ; preds = %if.end26.3.i.i
  ...
  store i16 %dec.4.i.i, ptr %getlen.i, align 8, !tbaa !67
...
if.end.4.thread.i.i:                              ; preds = %if.end26.3.i.i
  ...
  store i16 %conv9.4.i.i, ptr %getbuf.i, align 2, !tbaa !66
  %conv11.4.i.i = sext i16 %dec.3.i.i to i32
  %sub.4.i.i = sub nsw i32 16, %conv11.4.i.i
  %call.4.i.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef %sub.4.i.i), !range !52
  %.pre133.i.i = load i16, ptr %getbuf.i, align 2, !tbaa !66
  %shl.4145.i.i = shl i16 %.pre133.i.i, 1
  store i16 15, ptr %getlen.i, align 8, !tbaa !67
  %cmp23.4147.i.i = icmp sgt i16 %.pre133.i.i, -1
  br i1 %cmp23.4147.i.i, label %for.end.thread.i.i, label %if.end.5.i.i
...
if.then.5.i.i:                                    ; preds = %if.end26.4.i.i
  %90 = load i16, ptr %bit_buf.i.i, align 2, !tbaa !49
  ...
  store i16 %conv9.5.i.i, ptr %getbuf.i, align 2, !tbaa !66
  %sub.5.i.i = sub nuw nsw i32 16, %conv2108.5.i.i
  %call.5.i.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef %sub.5.i.i), !range !52
  %.pre134.i.i = load i16, ptr %getbuf.i, align 2, !tbaa !66
...
if.end.5.i.i:                                     ; preds = %if.then.5.i.i, %if.end26.4.i.i, %if.end.4.thread.i.i
  ...
  store i16 %dec.5.i.i, ptr %getlen.i, align 8, !tbaa !67
...
if.then.6.i.i:                                    ; preds = %if.end26.5.i.i
  ...
  store i16 %conv9.6.i.i, ptr %getbuf.i, align 2, !tbaa !66
  %sub.6.i.i = sub nuw nsw i32 16, %conv2108.6.i.i
  %call.6.i.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef %sub.6.i.i), !range !52
  %.pre135.i.i = load i16, ptr %getbuf.i, align 2, !tbaa !66
...
if.end.6.i.i:                                     ; preds = %if.then.6.i.i, %if.end26.5.i.i
  ...
  store i16 %dec.6.i.i, ptr %getlen.i, align 8, !tbaa !67
  %cmp23.6.i.i = icmp sgt i16 %97, -1
  br i1 %cmp23.6.i.i, label %for.end.thread.i.i, label %if.then36.i.i

for.end.thread.i.i:                               ; preds = %if.end.6.i.i, %if.end.5.i.i, %if.end.4.thread.i.i, %if.end.4.i.i, %if.end.3.i.i, %if.end.2.thread.i.i, %if.end.2.i.i, %if.end.1.i.i
  %.ph.i.i = phi i16 [ %shl.4145.i.i, %if.end.4.thread.i.i ], [ %shl.2137.i.i, %if.end.2.thread.i.i ], [ %shl.6.i.i, %if.end.6.i.i ], [ %shl.5.i.i, %if.end.5.i.i ], [ %shl.4.i.i, %if.end.4.i.i ], [ %shl.3.i.i, %if.end.3.i.i ], [ %shl.2.i.i, %if.end.2.i.i ], [ %shl.1.i.i, %if.end.1.i.i ]
  %.ph153.i.i = phi i16 [ 15, %if.end.4.thread.i.i ], [ 15, %if.end.2.thread.i.i ], [ %dec.6.i.i, %if.end.6.i.i ], [ %dec.5.i.i, %if.end.5.i.i ], [ %dec.4.i.i, %if.end.4.i.i ], [ %dec.3.i.i, %if.end.3.i.i ], [ %dec.2.i.i, %if.end.2.i.i ], [ %dec.1.i.i, %if.end.1.i.i ]
  %plus.0126.lcssa.ph.i.i = phi i16 [ 15, %if.end.4.thread.i.i ], [ 3, %if.end.2.thread.i.i ], [ 63, %if.end.6.i.i ], [ 31, %if.end.5.i.i ], [ 15, %if.end.4.i.i ], [ 7, %if.end.3.i.i ], [ 3, %if.end.2.i.i ], [ 1, %if.end.1.i.i ]
  %width.0125.lcssa.ph.i.i = phi i16 [ 4, %if.end.4.thread.i.i ], [ 2, %if.end.2.thread.i.i ], [ 6, %if.end.6.i.i ], [ 5, %if.end.5.i.i ], [ 4, %if.end.4.i.i ], [ 3, %if.end.3.i.i ], [ 2, %if.end.2.i.i ], [ 1, %if.end.1.i.i ]
  br label %if.then36.i.i

if.then36.i.i:                                    ; preds = %for.end.thread.i.i, %if.end.6.i.i
  %98 = phi i16 [ %shl.6.i.i, %if.end.6.i.i ], [ %.ph.i.i, %for.end.thread.i.i ]
  %99 = phi i16 [ %dec.6.i.i, %if.end.6.i.i ], [ %.ph153.i.i, %for.end.thread.i.i ]
...
if.then42.i.i:                                    ; preds = %if.then36.i.i
  ...
  %100 = load i16, ptr %bit_buf.i.i, align 2, !tbaa !49
  ...
  store i16 %conv51.i.i, ptr %getbuf.i, align 2, !tbaa !66
  %sub54.i.i = sub nsw i32 16, %conv38.i.i
  %call55.i.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef %sub54.i.i), !range !52
  %.pre136.i.i = load i16, ptr %getbuf.i, align 2, !tbaa !66
  br label %decode_len.exit.i

decode_len.exit.i:                                ; preds = %if.then42.i.i, %if.then36.i.i
  %102 = phi i16 [ 16, %if.then42.i.i ], [ %99, %if.then36.i.i ]
  %103 = phi i16 [ %.pre136.i.i, %if.then42.i.i ], [ %98, %if.then36.i.i ]
  ...
  %sub72.i.i = sub nsw i16 %102, %width.0121.i.i
  store i16 %sub72.i.i, ptr %getlen.i, align 8, !tbaa !67
  %104 = add nuw nsw i16 %plus.0118.i.i, 2
  %add.i78 = add nuw nsw i16 %104, %conv63.i.i
  %conv51.i = zext i16 %add.i78 to i32
  %add52.i = add i32 %count.0252.i, %conv51.i
...
if.then16.i:                                      ; preds = %if.then11.i93
  %105 = load i16, ptr %bit_buf.i.i, align 2, !tbaa !49
  ...
  store i16 %conv22.i, ptr %getbuf.i, align 2, !tbaa !66
  %sub.i97 = sub nuw nsw i32 16, %conv13146.i
  %call25.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef %sub.i97), !range !52
  %.pre257.i = load i16, ptr %getbuf.i, align 2, !tbaa !66
  br label %if.end27.i
...
if.end27.i:                                       ; preds = %if.then16.i, %if.then11.i93, %if.end.i.thread.i
  ...
  %108 = phi i16 [ %.pre257.i, %if.then16.i ], [ %shl.i.i76, %if.then11.i93 ], [ %shl.i259.i, %if.end.i.thread.i ]
  %109 = lshr i16 %108, 8
  %shl.i = shl i16 %108, 8
  store i16 %shl.i, ptr %getbuf.i, align 2, !tbaa !66
  %sub37.i = add nsw i16 %107, -8
  store i16 %sub37.i, ptr %getlen.i, align 8, !tbaa !67
  %conv39.i = trunc i16 %109 to i8
  %110 = load ptr, ptr %text.i65, align 8, !tbaa !44
  %idxprom.i94 = zext i32 %out_ptr.0253.i to i64
  %arrayidx.i95 = getelementptr inbounds i8, ptr %110, i64 %idxprom.i94
  store i8 %conv39.i, ptr %arrayidx.i95, align 1, !tbaa !20
  %inc.i96 = add nuw i32 %count.0252.i, 1
  %inc41.i = add i32 %out_ptr.0253.i, 1
  %cmp42.i = icmp ugt i32 %inc41.i, 26623
  br i1 %cmp42.i, label %if.then44.i, label %if.end99.i83

if.then44.i:                                      ; preds = %if.end27.i
  %111 = load i32, ptr %ofd, align 4, !tbaa !41
  %112 = load ptr, ptr %text.i65, align 8, !tbaa !44
...
if.end.i155.i:                                    ; preds = %decode_len.exit.i
  ...
  store i16 %dec.i157.i, ptr %getlen.i, align 8, !tbaa !67
  %cmp23.i158.i = icmp sgt i16 %conv68.i.i, -1
  br i1 %cmp23.i158.i, label %if.then36.i177.i, label %if.end26.i159.i

if.end.i155.thread.i:                             ; preds = %decode_len.exit.i
  %113 = load i16, ptr %bit_buf.i.i, align 2, !tbaa !49
  %conv5.i218.i = zext i16 %113 to i32
  %conv2108.i219.i = zext i16 %sub72.i.i to i32
  %shr.i220.i = lshr i32 %conv5.i218.i, %conv2108.i219.i
  %conv9.i221258.i = or i32 %shr.i220.i, %shl67.i.i
  %conv9.i221.i = trunc i32 %conv9.i221258.i to i16
  store i16 %conv9.i221.i, ptr %getbuf.i, align 2, !tbaa !66
  %conv11.i222.i = sext i16 %sub72.i.i to i32
  %sub.i223.i = sub nsw i32 16, %conv11.i222.i
  %call.i224.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef %sub.i223.i), !range !52
  %114 = load i16, ptr %getbuf.i, align 2, !tbaa !66
  %shl.i156233.i = shl i16 %114, 1
  %cmp23.i158235.i = icmp sgt i16 %114, -1
  br i1 %cmp23.i158235.i, label %decode_ptr.exit.i, label %if.end.1.i161.i

if.end26.i159.i:                                  ; preds = %if.end.i155.i
  %cmp3.1.i160.i = icmp ult i16 %sub72.i.i, 2
  br i1 %cmp3.1.i160.i, label %if.then.1.i208.i, label %if.end.1.i161.i

if.then.1.i208.i:                                 ; preds = %if.end26.i159.i
  %115 = load i16, ptr %bit_buf.i.i, align 2, !tbaa !49
  %conv5.1.i209.i = zext i16 %115 to i32
  %conv2108.1.i210.i = zext i16 %dec.i157.i to i32
  %shr.1.i211.i = lshr i32 %conv5.1.i209.i, %conv2108.1.i210.i
  %116 = trunc i32 %shr.1.i211.i to i16
  %conv9.1.i212.i = or i16 %shl.i156.i, %116
  store i16 %conv9.1.i212.i, ptr %getbuf.i, align 2, !tbaa !66
  %sub.1.i214.i = sub nuw nsw i32 16, %conv2108.1.i210.i
  %call.1.i215.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef %sub.1.i214.i), !range !52
  %.pre.i216.i = load i16, ptr %getbuf.i, align 2, !tbaa !66
  br label %if.end.1.i161.i

if.end.1.i161.i:                                  ; preds = %if.then.1.i208.i, %if.end26.i159.i, %if.end.i155.thread.i
  %117 = phi i16 [ 16, %if.then.1.i208.i ], [ %dec.i157.i, %if.end26.i159.i ], [ 15, %if.end.i155.thread.i ]
  %118 = phi i16 [ %.pre.i216.i, %if.then.1.i208.i ], [ %shl.i156.i, %if.end26.i159.i ], [ %shl.i156233.i, %if.end.i155.thread.i ]
  %shl.1.i162.i = shl i16 %118, 1
  %dec.1.i163.i = add nsw i16 %117, -1
  store i16 %dec.1.i163.i, ptr %getlen.i, align 8, !tbaa !67
  %cmp23.1.i164.i = icmp sgt i16 %118, -1
  br i1 %cmp23.1.i164.i, label %if.then36.i177.i, label %if.end26.1.i165.i

if.end26.1.i165.i:                                ; preds = %if.end.1.i161.i
  %cmp3.2.i166.i = icmp eq i16 %dec.1.i163.i, 0
  br i1 %cmp3.2.i166.i, label %if.end.2.thread.i200.i, label %if.end.2.i167.i

if.end.2.i167.i:                                  ; preds = %if.end26.1.i165.i
  %shl.2.i168.i = shl i16 %118, 2
  %dec.2.i169.i = add nsw i16 %117, -2
  store i16 %dec.2.i169.i, ptr %getlen.i, align 8, !tbaa !67
  %cmp23.2.i170.i = icmp sgt i16 %shl.1.i162.i, -1
  br i1 %cmp23.2.i170.i, label %if.then36.i177.i, label %if.end26.2.i171.i

if.end.2.thread.i200.i:                           ; preds = %if.end26.1.i165.i
  %119 = load i16, ptr %bit_buf.i.i, align 2, !tbaa !49
  %conv9.2.i204.i = or i16 %119, %shl.1.i162.i
  store i16 %conv9.2.i204.i, ptr %getbuf.i, align 2, !tbaa !66
  %call.2.i207.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef 16), !range !52
  %.pre119.i.i = load i16, ptr %getbuf.i, align 2, !tbaa !66
...
if.end26.2.i171.i:                                ; preds = %if.end.2.i167.i
  ...
  br i1 %cmp3.3.i172.i, label %if.then.3.i192.i, label %if.end.3.i173.i

if.then.3.i192.i:                                 ; preds = %if.end26.2.i171.i
  %120 = load i16, ptr %bit_buf.i.i, align 2, !tbaa !49
  %conv5.3.i193.i = zext i16 %120 to i32
  %conv2108.3.i194.i = zext i16 %dec.2.i169.i to i32
  %shr.3.i195.i = lshr i32 %conv5.3.i193.i, %conv2108.3.i194.i
  %121 = trunc i32 %shr.3.i195.i to i16
  %conv9.3.i196.i = or i16 %shl.2.i168.i, %121
  store i16 %conv9.3.i196.i, ptr %getbuf.i, align 2, !tbaa !66
  %sub.3.i198.i = sub nuw nsw i32 16, %conv2108.3.i194.i
  %call.3.i199.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef %sub.3.i198.i), !range !52
  %.pre120.i.i = load i16, ptr %getbuf.i, align 2, !tbaa !66
  br label %if.end.3.i173.i

if.end.3.i173.i:                                  ; preds = %if.then.3.i192.i, %if.end26.2.i171.i, %if.end.2.thread.i200.i
  %122 = phi i16 [ 16, %if.then.3.i192.i ], [ %dec.2.i169.i, %if.end26.2.i171.i ], [ 15, %if.end.2.thread.i200.i ]
  %123 = phi i16 [ %.pre120.i.i, %if.then.3.i192.i ], [ %shl.2.i168.i, %if.end26.2.i171.i ], [ %shl.2122.i.i, %if.end.2.thread.i200.i ]
  %shl.3.i174.i = shl i16 %123, 1
  %dec.3.i175.i = add nsw i16 %122, -1
  store i16 %dec.3.i175.i, ptr %getlen.i, align 8, !tbaa !67
  %cmp23.3.i176.i = icmp sgt i16 %123, -1
  %spec.select.i.i = select i1 %cmp23.3.i176.i, i16 12, i16 13
  %spec.select135.i.i = select i1 %cmp23.3.i176.i, i16 3584, i16 7680
  br label %if.then36.i177.i

if.then36.i177.i:                                 ; preds = %if.end.3.i173.i, %if.end.2.i167.i, %if.end.1.i161.i, %if.end.i155.i
  ...
  %width.0.lcssa115.i.i = phi i16 [ 9, %if.end.i155.i ], [ 10, %if.end.1.i161.i ], [ 11, %if.end.2.i167.i ], [ %spec.select.i.i, %if.end.3.i173.i ]
  %plus.0.lcssa.i.i = phi i16 [ 0, %if.end.i155.i ], [ 512, %if.end.1.i161.i ], [ 1536, %if.end.2.i167.i ], [ %spec.select135.i.i, %if.end.3.i173.i ]
  %cmp40.i178.i = icmp slt i16 %125, %width.0.lcssa115.i.i
  br i1 %cmp40.i178.i, label %if.then42.i185.i, label %decode_ptr.exit.i

if.then42.i185.i:                                 ; preds = %if.then36.i177.i
  %conv38.i186.i = sext i16 %125 to i32
  %126 = load i16, ptr %bit_buf.i.i, align 2, !tbaa !49
  %conv44.i187.i = zext i16 %126 to i32
  %shr47.i188.i = lshr i32 %conv44.i187.i, %conv38.i186.i
  %127 = trunc i32 %shr47.i188.i to i16
  %conv51.i189.i = or i16 %124, %127
  store i16 %conv51.i189.i, ptr %getbuf.i, align 2, !tbaa !66
  %sub54.i190.i = sub nsw i32 16, %conv38.i186.i
  %call55.i191.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef %sub54.i190.i), !range !52
  %.pre121.i.i = load i16, ptr %getbuf.i, align 2, !tbaa !66
  br label %decode_ptr.exit.i

decode_ptr.exit.i:                                ; preds = %if.then42.i185.i, %if.then36.i177.i, %if.end.2.thread.i200.i, %if.end.i155.thread.i
  %plus.0.lcssa134.i.i = phi i16 [ %plus.0.lcssa.i.i, %if.then42.i185.i ], [ %plus.0.lcssa.i.i, %if.then36.i177.i ], [ 1536, %if.end.2.thread.i200.i ], [ 0, %if.end.i155.thread.i ]
  %width.0.lcssa115133.i.i = phi i16 [ %width.0.lcssa115.i.i, %if.then42.i185.i ], [ %width.0.lcssa115.i.i, %if.then36.i177.i ], [ 11, %if.end.2.thread.i200.i ], [ 9, %if.end.i155.thread.i ]
  %128 = phi i16 [ 16, %if.then42.i185.i ], [ %125, %if.then36.i177.i ], [ 15, %if.end.2.thread.i200.i ], [ 15, %if.end.i155.thread.i ]
  %129 = phi i16 [ %.pre121.i.i, %if.then42.i185.i ], [ %124, %if.then36.i177.i ], [ %shl.2122.i.i, %if.end.2.thread.i200.i ], [ %shl.i156233.i, %if.end.i155.thread.i ]
  %sub61.i180.i = sub nuw nsw i16 16, %width.0.lcssa115133.i.i
  %shr62.i181.i = lshr i16 %129, %sub61.i180.i
  %shl67.i182.i = shl i16 %129, %width.0.lcssa115133.i.i
  store i16 %shl67.i182.i, ptr %getbuf.i, align 2, !tbaa !66
  %sub72.i183.i = sub nsw i16 %128, %width.0.lcssa115133.i.i
  store i16 %sub72.i183.i, ptr %getlen.i, align 8, !tbaa !67
  %add77.i184.i = add nuw nsw i16 %shr62.i181.i, %plus.0.lcssa134.i.i
  %130 = xor i16 %add77.i184.i, -1
  %131 = trunc i32 %out_ptr.0253.i to i16
...
while.body78.i:                                   ; preds = %decode_ptr.exit.i, %if.end92.i
  %dec250.in.i = phi i16 [ %dec250.i, %if.end92.i ], [ %add.i78, %decode_ptr.exit.i ]
  %i.1249.i = phi i16 [ %spec.store.select.i82, %if.end92.i ], [ %spec.select.i80, %decode_ptr.exit.i ]
  %out_ptr.1248.i = phi i32 [ %out_ptr.2.i, %if.end92.i ], [ %out_ptr.0253.i, %decode_ptr.exit.i ]
  %dec250.i = add nsw i16 %dec250.in.i, -1
  %132 = load ptr, ptr %text.i65, align 8, !tbaa !44
  %idxprom80.i = sext i16 %i.1249.i to i64
  %arrayidx81.i = getelementptr inbounds i8, ptr %132, i64 %idxprom80.i
  %133 = load i8, ptr %arrayidx81.i, align 1, !tbaa !20
  %idxprom83.i = zext i32 %out_ptr.1248.i to i64
  %arrayidx84.i = getelementptr inbounds i8, ptr %132, i64 %idxprom83.i
  store i8 %133, ptr %arrayidx84.i, align 1, !tbaa !20
  %inc85.i = add i32 %out_ptr.1248.i, 1
  %cmp86.i = icmp ugt i32 %inc85.i, 26623
  br i1 %cmp86.i, label %if.then88.i, label %if.end92.i

if.then88.i:                                      ; preds = %while.body78.i
  %134 = load i32, ptr %ofd, align 4, !tbaa !41
  %135 = load ptr, ptr %text.i65, align 8, !tbaa !44
  %call.i225.i = call i32 @cli_writen(i32 noundef %134, ptr noundef %135, i32 noundef 26624) #11
  br label %if.end92.i

if.end92.i:                                       ; preds = %if.then88.i, %while.body78.i
  %out_ptr.2.i = phi i32 [ 0, %if.then88.i ], [ %inc85.i, %while.body78.i ]
  %inc93.i = add i16 %i.1249.i, 1
  %cmp95.i = icmp sgt i16 %inc93.i, 26623
  %spec.store.select.i82 = select i1 %cmp95.i, i16 0, i16 %inc93.i
  %cmp76.i = icmp ugt i16 %dec250.in.i, 1
  br i1 %cmp76.i, label %while.body78.i, label %if.end99.i83, !llvm.loop !68
...
if.end99.i83:                                     ; preds = %if.end92.i, %if.then44.i, %if.end27.i
  ...
  %136 = load i32, ptr %orig_size.i72, align 4, !tbaa !53
  %cmp7.i86 = icmp ult i32 %count.1.i84, %136
  br i1 %cmp7.i86, label %while.body.i74thread-pre-split, label %while.end100.i87, !llvm.loop !69

while.end100.i87:                                 ; preds = %if.end99.i83, %if.then72.i
  %out_ptr.0245.i = phi i32 [ %out_ptr.0253.i, %if.then72.i ], [ %out_ptr.3.i85, %if.end99.i83 ]
  %cmp101.not.i88 = icmp eq i32 %out_ptr.0245.i, 0
  br i1 %cmp101.not.i88, label %if.end107.i91, label %if.then103.i89

if.then103.i89:                                   ; preds = %while.end100.i87
  %137 = load i32, ptr %ofd, align 4, !tbaa !41
  %138 = load ptr, ptr %text.i65, align 8, !tbaa !44
  %call.i228.i = call i32 @cli_writen(i32 noundef %137, ptr noundef %138, i32 noundef %out_ptr.0245.i) #11
  br label %if.end107.i91

if.end107.i91:                                    ; preds = %if.then103.i89, %while.end100.i87, %if.end6.i
  %139 = load ptr, ptr %text.i65, align 8, !tbaa !44
...
entry:
  ...
  %call.i = tail call fastcc i32 @fill_buf(ptr noundef %decode_data, i32 noundef 5), !range !52
...
if.then:                                          ; preds = %entry
  ...
  %call.i123 = tail call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data, i32 noundef 5), !range !52
  ...
  store <8 x i16> %broadcast.splat, ptr %5, align 2, !tbaa !5
  ...
  store <8 x i16> %broadcast.splat, ptr %7, align 2, !tbaa !5
  ...
  store <8 x i16> %broadcast.splat, ptr %9, align 2, !tbaa !5
  ...
  store <8 x i16> %broadcast.splat, ptr %11, align 2, !tbaa !5
  ...
  store <8 x i16> %broadcast.splat, ptr %23, align 2, !tbaa !5
  ...
  store <8 x i16> %broadcast.splat, ptr %25, align 2, !tbaa !5
  ...
  store <8 x i16> %broadcast.splat, ptr %27, align 2, !tbaa !5
  ...
  store <8 x i16> %broadcast.splat, ptr %29, align 2, !tbaa !5
  ...
  store <8 x i16> %broadcast.splat, ptr %31, align 2, !tbaa !5
  ...
  store <8 x i16> %broadcast.splat, ptr %33, align 2, !tbaa !5
  ...
  store <8 x i16> %broadcast.splat, ptr %35, align 2, !tbaa !5
  br label %if.end80
...
while.cond24.preheader:                           ; preds = %while.body
  ...
  br i1 %tobool.not130, label %if.end.thread164, label %while.body28
...
if.end:                                           ; preds = %while.body28
  ...
  br i1 %cmp34, label %if.end.thread, label %if.end.thread164

if.end.thread:                                    ; preds = %while.body, %if.end
  %c.1163 = phi i16 [ %inc32, %if.end ], [ %42, %while.body ]
  br label %if.end.thread164

if.end.thread164:                                 ; preds = %while.cond24.preheader, %if.end, %if.end.thread
  %c.1162 = phi i16 [ %c.1163, %if.end.thread ], [ %inc32, %if.end ], [ 7, %while.cond24.preheader ]
  %43 = phi i32 [ 3, %if.end.thread ], [ %sub, %if.end ], [ 4, %while.cond24.preheader ]
  %call37 = tail call fastcc i32 @fill_buf(ptr noundef %decode_data, i32 noundef %43), !range !52
...
if.then45:                                        ; preds = %if.end.thread164
  %44 = load i16, ptr %bit_buf.i, align 2, !tbaa !49
  %call.i128 = tail call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data, i32 noundef 2), !range !52
...
if.end61:                                         ; preds = %while.body55.1, %while.body55.preheader, %if.then45, %if.end.thread164
  %i.4 = phi i32 [ %inc40, %if.end.thread164 ], [ %i_special, %if.then45 ], [ %indvars.iv.next, %while.body55.preheader ], [ %spec.select, %while.body55.1 ]
...
while.body69.prol:                                ; preds = %while.body69.preheader31, %while.body69.prol
  ...
  br i1 %prol.iter37.cmp.not, label %while.body69.prol.loopexit, label %while.body69.prol, !llvm.loop !85
...
vector.body25:                                    ; preds = %vector.body25, %vector.ph19
  ...
  store <8 x i16> %broadcast.splat29, ptr %75, align 2, !tbaa !5
