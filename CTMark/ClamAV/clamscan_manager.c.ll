; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/clamscan_manager.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/clamscan_manager.c"
...
if.then104:                                       ; preds = %if.end101
  ...
  %2 = load ptr, ptr %call106, align 8
  ...
  %4 = load i32, ptr %arrayidx109, align 4
...
if.then112:                                       ; preds = %if.then104
  ...
  store i64 %conv120, ptr %maxfilesize, align 8
...
if.end145:                                        ; preds = %if.end137, %if.then140
  ...
  store i32 %storemerge, ptr %limits, align 8
...
if.then245:                                       ; preds = %if.end232
  ...
  store i64 %9, ptr @procdev, align 8
  br label %if.end246
...
for.body287:                                      ; preds = %if.else279, %for.inc
  ...
  %14 = load i8, ptr %arrayidx289, align 1
...
for.inc:                                          ; preds = %for.body287
  ...
  br i1 %15, label %for.body287, label %for.end
...
land.lhs.true299:                                 ; preds = %for.end
  %16 = load i8, ptr %call271547, align 1
...
land.lhs.true309:                                 ; preds = %land.lhs.true299
  ...
  %17 = load i8, ptr %arrayidx310, align 1
...
land.lhs.true334:                                 ; preds = %sw.epilog
  %21 = load i8, ptr %call271547, align 1
...
land.lhs.true344:                                 ; preds = %land.lhs.true334
  ...
  %22 = load i8, ptr %arrayidx345, align 1
...
if.end354:                                        ; preds = %sw.epilog, %land.lhs.true344, %if.then349, %land.lhs.true334, %land.lhs.true334, %if.then277
  ...
  br i1 %cmp272.not, label %if.end361, label %for.body
...
if.end361:                                        ; preds = %if.end354, %for.cond.preheader, %if.then267, %if.then257, %if.else259
  ...
  %25 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 3), align 4
...
entry:
  ...
  %call1 = tail call i32 @checkaccess(ptr noundef nonnull %spec.store.select, ptr noundef nonnull @.str.9, i32 noundef 2) #18
...
if.end5:                                          ; preds = %entry
  %call6 = tail call ptr @cli_gentemp(ptr noundef nonnull %spec.store.select) #18
...
while.body:                                       ; preds = %while.cond
  ...
  br i1 %cmp17, label %if.then19, label %while.cond
...
while.end:                                        ; preds = %while.cond
  ...
  %2 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 2), align 8
  %inc = add i32 %2, 1
  store i32 %inc, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 2), align 8
...
if.then27:                                        ; preds = %while.end
  %3 = load ptr, ptr %virname, align 8
  %call28 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.81, ptr noundef %3) #18
  %4 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 3), align 4
  %inc29 = add i32 %4, 1
  store i32 %inc29, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 3), align 4
  %5 = load i16, ptr @bell, align 2
...
if.then36:                                        ; preds = %while.end
  %7 = load i16, ptr @printinfected, align 2
...
if.else40:                                        ; preds = %while.end
  %8 = load i16, ptr @printinfected, align 2
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 144, ptr nonnull %sb) #18
  %0 = load i64, ptr @procdev, align 8
...
if.then1:                                         ; preds = %if.then
  ...
  %2 = load i64, ptr @procdev, align 8
  %cmp2 = icmp eq i64 %1, %2
  br i1 %cmp2, label %if.then3, label %if.end9

if.then3:                                         ; preds = %if.then1
  %3 = load i16, ptr @printinfected, align 2
...
if.end18:                                         ; preds = %while.body
  ...
  br i1 %tobool14.not, label %if.end20, label %while.body
...
if.end32:                                         ; preds = %while.body28
  ...
  br i1 %tobool26.not, label %if.then36, label %while.body28

if.then36:                                        ; preds = %if.end32, %if.then23
  %4 = load i16, ptr @printinfected, align 2
...
if.then45:                                        ; preds = %if.end42
  %5 = load i16, ptr @printinfected, align 2
...
if.then56:                                        ; preds = %if.then53
  %6 = load i16, ptr @printinfected, align 2
...
if.end62:                                         ; preds = %if.then53, %if.end50
  %7 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 2), align 8
  %inc = add i32 %7, 1
  store i32 %inc, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 2), align 8
...
if.then77:                                        ; preds = %if.then74
  ...
  %8 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 4), align 8
  %inc79 = add i32 %8, 1
  store i32 %inc79, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 4), align 8
  br label %cleanup
...
if.then169:                                       ; preds = %sw.bb166
  %9 = load i16, ptr @printinfected, align 2
...
land.lhs.true176:                                 ; preds = %if.else174
  %maxfilesize = getelementptr inbounds %struct.cl_limits, ptr %limits, i64 0, i32 5
  %10 = load i64, ptr %maxfilesize, align 8
...
if.end.i:                                         ; preds = %sw.bb192
  ...
  %call6.i = call i32 @checkaccess(ptr noundef nonnull %spec.store.select.i, ptr noundef nonnull @.str.9, i32 noundef 2) #18
...
if.end10.i:                                       ; preds = %if.end.i
  %call11.i = call ptr @cli_gentemp(ptr noundef nonnull %spec.store.select.i) #18
...
if.then22.i:                                      ; preds = %if.end19.i
  ...
  store ptr %filename, ptr %arrayidx.i, align 16
  ...
  %call28.i = call fastcc i32 @clamav_unpack(ptr noundef nonnull %.str.call23.i, ptr noundef nonnull %args.i, ptr noundef %call11.i, ptr noundef %user, ptr noundef %opt)
...
if.then33.i:                                      ; preds = %if.else30.i
  ...
  store ptr %filename, ptr %arrayidx35.i, align 16
  ...
  %call43.i = call fastcc i32 @clamav_unpack(ptr noundef nonnull %.str.1.call36.i, ptr noundef nonnull %args34.i, ptr noundef %call11.i, ptr noundef %user, ptr noundef %opt)
...
if.then48.i:                                      ; preds = %if.else45.i
  ...
  store ptr %filename, ptr %arrayidx50.i, align 8
  ...
  %call58.i = call fastcc i32 @clamav_unpack(ptr noundef nonnull %.str.2.call51.i, ptr noundef nonnull %args49.i, ptr noundef %call11.i, ptr noundef %user, ptr noundef %opt)
...
if.then63.i:                                      ; preds = %if.else60.i
  ...
  store ptr %filename, ptr %arrayidx65.i, align 16
  ...
  %call73.i = call fastcc i32 @clamav_unpack(ptr noundef nonnull %.str.3.call66.i, ptr noundef nonnull %args64.i, ptr noundef %call11.i, ptr noundef %user, ptr noundef %opt)
...
if.then78.i:                                      ; preds = %if.else75.i
  ...
  store ptr %filename, ptr %arrayidx80.i, align 16
  ...
  %call88.i = call fastcc i32 @clamav_unpack(ptr noundef nonnull %.str.call81.i, ptr noundef nonnull %args79.i, ptr noundef %call11.i, ptr noundef %user, ptr noundef %opt)
...
if.then93.i:                                      ; preds = %if.else90.i
  ...
  store ptr %filename, ptr %arrayidx95.i, align 16
  ...
  %call103.i = call fastcc i32 @clamav_unpack(ptr noundef nonnull %.str.5.call96.i, ptr noundef nonnull %args94.i, ptr noundef %call11.i, ptr noundef %user, ptr noundef %opt)
...
if.then108.i:                                     ; preds = %if.else105.i
  ...
  store ptr %filename, ptr %arrayidx110.i, align 16
  ...
  %call118.i = call fastcc i32 @clamav_unpack(ptr noundef nonnull %.str.6.call111.i, ptr noundef nonnull %args109.i, ptr noundef %call11.i, ptr noundef %user, ptr noundef %opt)
...
if.then123.i:                                     ; preds = %if.else120.i
  ...
  store ptr %filename, ptr %arrayidx125.i, align 16
  ...
  %call133.i = call fastcc i32 @clamav_unpack(ptr noundef nonnull %.str.128.call126.i, ptr noundef nonnull %args124.i, ptr noundef %call11.i, ptr noundef %user, ptr noundef %opt)
...
if.then140.i:                                     ; preds = %lor.lhs.false.i, %if.else135.i
  ...
  store ptr %filename, ptr %arrayidx142.i, align 16
  ...
  %call150.i = call fastcc i32 @clamav_unpack(ptr noundef nonnull %.str.6.call143.i, ptr noundef nonnull %args141.i, ptr noundef %call11.i, ptr noundef %user, ptr noundef %opt)
...
if.then163.i:                                     ; preds = %if.end160.i, %if.end160.thread.i
  %16 = load i16, ptr @recursion, align 2
  ...
  store i16 %16, ptr @recursion, align 2
...
if.then182.i:                                     ; preds = %if.then179.i
  ...
  %17 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 4), align 8
  %inc.i = add i32 %17, 1
  store i32 %inc.i, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 4), align 8
  br label %scancompressed.exit
...
if.then207.i:                                     ; preds = %if.then204.i
  ...
  %18 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 4), align 8
  %inc209.i = add i32 %18, 1
  store i32 %inc209.i, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 4), align 8
  br label %scancompressed.exit
...
if.then234.i:                                     ; preds = %if.then231.i
  ...
  %21 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 4), align 8
  %inc236.i = add i32 %21, 1
  store i32 %inc236.i, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 4), align 8
  br label %scancompressed.exit
...
if.then205:                                       ; preds = %if.then202
  ...
  %22 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 4), align 8
  %inc207 = add i32 %22, 1
  store i32 %inc207, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 4), align 8
  br label %cleanup
...
if.then6:                                         ; preds = %if.end
  %0 = load ptr, ptr %virname, align 8
  %call7 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.87, ptr noundef %filename, ptr noundef %0) #18
  %1 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 3), align 4
  %inc = add i32 %1, 1
  store i32 %inc, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 3), align 4
  %2 = load i16, ptr @bell, align 2
...
if.then:                                          ; preds = %land.lhs.true4, %land.lhs.true
  ...
  %0 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 5), align 4
  %inc = add i32 %0, 1
  store i32 %inc, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 5), align 4
  br label %cleanup
...
if.then9:                                         ; preds = %if.end
  ...
  %2 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 5), align 4
  %inc14 = add i32 %2, 1
  store i32 %inc14, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 5), align 4
  br label %cleanup
...
if.then32:                                        ; preds = %if.end29
  ...
  %3 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 5), align 4
  %inc34 = add i32 %3, 1
  store i32 %inc34, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 5), align 4
...
if.then46:                                        ; preds = %if.end42
  %4 = load i64, ptr %ofstat, align 8
  %5 = load i64, ptr %mfstat, align 8
...
land.lhs.true50:                                  ; preds = %if.then46
  ...
  %7 = load i64, ptr %st_ino51, align 8
...
if.then54:                                        ; preds = %land.lhs.true50
  ...
  %8 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 5), align 4
  %inc56 = add i32 %8, 1
  store i32 %inc56, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 5), align 4
  tail call void @free(ptr noundef nonnull %call25) #18
  br label %cleanup
...
do.body:                                          ; preds = %do.body, %if.else
  ...
  br i1 %9, label %do.body, label %if.end68
...
if.then78:                                        ; preds = %if.then74
  ...
  %10 = load i32, ptr %call81, align 4
  ...
  %11 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 5), align 4
  %inc84 = add i32 %11, 1
  store i32 %inc84, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 5), align 4
  tail call void @free(ptr noundef nonnull %call25) #18
  br label %cleanup
...
if.then94:                                        ; preds = %land.lhs.true91
  ...
  %17 = load i32, ptr %call95, align 4
  ...
  %18 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 4), align 8
  %inc98 = add i32 %18, 1
  store i32 %inc98, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 4), align 8
  tail call void @free(ptr noundef nonnull %call25) #18
  br label %cleanup
...
if.end:                                           ; preds = %entry
  ...
  %call6 = tail call i32 @checkaccess(ptr noundef nonnull %spec.store.select, ptr noundef nonnull @.str.9, i32 noundef 2) #18
  %cmp7.not = icmp eq i32 %call6, 1
  br i1 %cmp7.not, label %if.end10, label %if.then8

if.then8:                                         ; preds = %if.end
  %call9 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.104, ptr noundef nonnull %spec.store.select) #18
  tail call void @exit(i32 noundef 64) #19
  unreachable

if.end10:                                         ; preds = %if.end
  %call11 = tail call ptr @cli_gentemp(ptr noundef nonnull %spec.store.select) #18
...
if.then47:                                        ; preds = %if.then44
  ...
  %5 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 4), align 8
  %inc = add i32 %5, 1
  store i32 %inc, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 4), align 8
  br label %if.end60
...
if.end47:                                         ; preds = %if.end41
  %10 = load i16, ptr @printinfected, align 2
...
if.then53:                                        ; preds = %if.then49
  ...
  store i16 0, ptr @printinfected, align 2
  br label %if.end59
...
while.body.us.us:                                 ; preds = %while.body.lr.ph.split.us, %while.body.us.us
  ...
  br i1 %tobool71.not.us.us, label %while.body.us.us, label %if.end94
...
if.end91.us:                                      ; preds = %if.then85.us, %if.then74.us, %while.body.us
  ...
  br i1 %tobool71.not.us, label %while.body.us, label %if.end94
...
if.end91.us169:                                   ; preds = %if.then74.us162, %if.then85.us166, %while.body.us159
  ...
  br i1 %tobool71.not.us171, label %while.body.us159, label %if.end94
...
if.end91:                                         ; preds = %if.then74, %if.then85, %while.body
  ...
  br i1 %tobool71.not, label %while.body, label %if.end94
