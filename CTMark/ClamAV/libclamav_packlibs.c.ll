...
if.end.i393:                                      ; preds = %if.then.i386
  %8 = load i8, ptr %csrc.7611, align 1
...
if.end.i412:                                      ; preds = %if.then.i405
  %12 = load i8, ptr %csrc.10, align 1
...
if.end.i431:                                      ; preds = %if.then.i424
  %15 = load i8, ptr %csrc.11, align 1
...
if.end.i450:                                      ; preds = %if.then.i443
  %17 = load i8, ptr %csrc.15, align 1
...
if.end.i469:                                      ; preds = %if.then.i462
  %20 = load i8, ptr %csrc.16, align 1
...
if.end87:                                         ; preds = %if.else81
  %21 = load i8, ptr %csrc.13, align 1
...
if.end.i488:                                      ; preds = %if.then.i481
  %23 = load i8, ptr %csrc.20, align 1
...
if.end.i507:                                      ; preds = %if.then.i500
  %26 = load i8, ptr %csrc.21, align 1
...
while.body183.prol:                               ; preds = %while.body183.preheader741, %while.body183.prol
  ...
  %33 = load i8, ptr %add.ptr186.prol, align 1
  store i8 %33, ptr %cdst.1629.prol, align 1
  %incdec.ptr187.prol = getelementptr inbounds i8, ptr %cdst.1629.prol, i64 1
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %while.body183.prol.loopexit, label %while.body183.prol
...
while.body183:                                    ; preds = %while.body183.prol.loopexit, %while.body183
  ...
  %35 = load i8, ptr %add.ptr186, align 1
  store i8 %35, ptr %cdst.1629, align 1
  ...
  %36 = load i8, ptr %add.ptr186.1, align 1
  store i8 %36, ptr %incdec.ptr187, align 1
  ...
  %37 = load i8, ptr %add.ptr186.2, align 1
  store i8 %37, ptr %incdec.ptr187.1, align 1
  ...
  %38 = load i8, ptr %add.ptr186.3, align 1
  store i8 %38, ptr %incdec.ptr187.2, align 1
  ...
  %39 = load i8, ptr %add.ptr186.4, align 1
  store i8 %39, ptr %incdec.ptr187.3, align 1
  ...
  %40 = load i8, ptr %add.ptr186.5, align 1
  store i8 %40, ptr %incdec.ptr187.4, align 1
  ...
  %41 = load i8, ptr %add.ptr186.6, align 1
  store i8 %41, ptr %incdec.ptr187.5, align 1
  ...
  %42 = load i8, ptr %add.ptr186.7, align 1
  store i8 %42, ptr %incdec.ptr187.6, align 1
  %incdec.ptr187.7 = getelementptr inbounds i8, ptr %cdst.1629, i64 8
  %tobool182.not.7 = icmp eq i32 %dec.7, 0
  br i1 %tobool182.not.7, label %while.cond.outer.outer.backedge, label %while.body183
...
if.end206:                                        ; preds = %lor.lhs.false197
  ...
  %43 = load i8, ptr %csrc.1, align 1
  %incdec.ptr208 = getelementptr inbounds i8, ptr %cdst.0, i64 1
  store i8 %43, ptr %cdst.0, align 1
  br label %while.cond.outer
...
if.then212:                                       ; preds = %while.end210
  store ptr %incdec.ptr42, ptr %endsrc, align 8
  br label %if.end213
...
if.then215:                                       ; preds = %if.end213
  store ptr %cdst.0, ptr %enddst, align 8
  br label %cleanup
...
if.end.i495:                                      ; preds = %if.then.i488
  %8 = load i8, ptr %csrc.7723, align 1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %27, align 1
  %28 = getelementptr inbounds i8, ptr %27, i64 16
  %wide.load880 = load <16 x i8>, ptr %28, align 1
  store <16 x i8> %wide.load, ptr %next.gep, align 1
  %29 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load880, ptr %29, align 1
  %index.next = add nuw i64 %index, 32
...
while.body237.prol:                               ; preds = %while.body237.preheader881, %while.body237.prol
  ...
  %32 = load i8, ptr %add.ptr240.prol, align 1
  store i8 %32, ptr %cdst.1745.prol, align 1
  %incdec.ptr241.prol = getelementptr inbounds i8, ptr %cdst.1745.prol, i64 1
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %while.body237.prol.loopexit, label %while.body237.prol
...
while.body237:                                    ; preds = %while.body237.prol.loopexit, %while.body237
  ...
  %35 = load i8, ptr %add.ptr240, align 1
  store i8 %35, ptr %cdst.1745, align 1
  ...
  %36 = load i8, ptr %add.ptr240.1, align 1
  store i8 %36, ptr %incdec.ptr241, align 1
  ...
  %37 = load i8, ptr %add.ptr240.2, align 1
  store i8 %37, ptr %incdec.ptr241.1, align 1
  ...
  %38 = load i8, ptr %add.ptr240.3, align 1
  store i8 %38, ptr %incdec.ptr241.2, align 1
  ...
  %39 = load i8, ptr %add.ptr240.4, align 1
  store i8 %39, ptr %incdec.ptr241.3, align 1
  ...
  %40 = load i8, ptr %add.ptr240.5, align 1
  store i8 %40, ptr %incdec.ptr241.4, align 1
  ...
  %41 = load i8, ptr %add.ptr240.6, align 1
  store i8 %41, ptr %incdec.ptr241.5, align 1
  ...
  %42 = load i8, ptr %add.ptr240.7, align 1
  store i8 %42, ptr %incdec.ptr241.6, align 1
  %incdec.ptr241.7 = getelementptr inbounds i8, ptr %cdst.1745, i64 8
  %tobool236.not.7 = icmp eq i32 %dec.7, 0
  br i1 %tobool236.not.7, label %while.cond.outer.outer.backedge, label %while.body237
...
while.end268:                                     ; preds = %if.end33
  store ptr %incdec.ptr38, ptr %endsrc, align 8
  store ptr %cdst.0, ptr %enddst, align 8
  br label %cleanup
