; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_phish_domaincheck_db.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_phish_domaincheck_db.c"
...
entry:
  ...
  %0 = load ptr, ptr %domainlist_matcher, align 8
...
land.lhs.true25:                                  ; preds = %land.lhs.true18
  ...
  %7 = load i16, ptr %arrayidx30, align 2
  %8 = and i16 %7, 4096
...
if.then43:                                        ; preds = %land.lhs.true34
  ...
  store i16 0, ptr %notwantedflags, align 2
  ...
  %12 = load i16, ptr %notwantedflags, align 2
  %not = xor i16 %12, -1
  %13 = load i16, ptr %flags, align 2
  %and47 = and i16 %13, %not
  store i16 %and47, ptr %flags, align 2
...
if.then:                                          ; preds = %entry
  ...
  %domainlist_matcher = getelementptr inbounds %struct.cl_engine, ptr %engine, i64 0, i32 9
  store ptr %call, ptr %domainlist_matcher, align 8
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %1 = load ptr, ptr %domainlist_matcher, align 8
  tail call void @free(ptr noundef %1) #7
  store ptr null, ptr %domainlist_matcher, align 8
  br label %if.end
