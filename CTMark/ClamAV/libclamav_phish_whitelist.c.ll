; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_phish_whitelist.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_phish_whitelist.c"
...
entry:
  ...
  %0 = load ptr, ptr %whitelist_matcher, align 8
...
if.then:                                          ; preds = %entry
  ...
  %whitelist_matcher = getelementptr inbounds %struct.cl_engine, ptr %engine, i64 0, i32 8
  store ptr %call, ptr %whitelist_matcher, align 8
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %1 = load ptr, ptr %whitelist_matcher, align 8
  tail call void @free(ptr noundef %1) #4
  store ptr null, ptr %whitelist_matcher, align 8
  br label %if.end
