...
if.end4.i.i:                                      ; preds = %if.end.i.i
  store ptr %call.i.i, ptr %strip, align 8
...
while.body.i:                                     ; preds = %if.then36, %while.body.i
  ...
  br i1 %cmp3.i, label %while.body.i, label %if.end39
...
doemit.exit161.thread:                            ; preds = %if.end39
  ...
  store i64 %sub41200, ptr %laststate201, align 8
  br label %categorize.exit

if.end.i137:                                      ; preds = %if.end39
  %12 = load i64, ptr %ssize, align 8
...
if.end4.i.i155:                                   ; preds = %if.end.i.i150
  store ptr %call.i.i153, ptr %strip, align 8
  store i64 %mul.i144, ptr %ssize, align 8
  %pa.val.pr.pre = load i32, ptr %error, align 8
...
doemit.exit161:                                   ; preds = %if.end.i137, %if.then2.i141, %seterr.exit.i.i158, %if.end4.i.i155
  ...
  store i64 134217728, ptr %arrayidx.i149, align 8
...
for.body.lr.ph.i.i:                               ; preds = %land.lhs.true.i
  ...
  %22 = load ptr, ptr %setbits, align 8
...
for.inc.i.i:                                      ; preds = %for.body.i.i
  ...
  %24 = load i32, ptr %csetsize, align 8
  ...
  br i1 %exitcond.not.i.i, label %for.inc26.i, label %for.body.i.i

if.then4.i:                                       ; preds = %for.body.i.i
  %25 = load i32, ptr %ncategories, align 4
  %inc.i164 = add nsw i32 %25, 1
  store i32 %inc.i164, ptr %ncategories, align 4
  %conv5.i = trunc i32 %25 to i8
  store i8 %conv5.i, ptr %arrayidx.i163, align 1
...
land.lhs.true17.i:                                ; preds = %for.body11.i
  %27 = load i32, ptr %ncsets, align 4
...
for.body.lr.ph.i53.i:                             ; preds = %land.lhs.true17.i
  ...
  %28 = load ptr, ptr %setbits, align 8
...
for.body.i57.i:                                   ; preds = %for.inc.i59.i, %for.body.lr.ph.i53.i
  ...
  %29 = load i8, ptr %arrayidx.i58.i, align 1
...
for.inc.i59.i:                                    ; preds = %for.body.i57.i
  ...
  %31 = load i32, ptr %csetsize, align 8
  ...
  br i1 %exitcond.not.i63.i, label %if.then20.i, label %for.body.i57.i
...
for.inc.i:                                        ; preds = %for.body.i57.i, %if.then20.i, %for.body11.i
  ...
  br i1 %exitcond.not.i, label %for.inc26.i, label %for.body11.i
...
for.inc26.i:                                      ; preds = %for.inc.i.i, %for.inc.i, %if.then4.i, %land.lhs.true.i, %for.body.i
  ...
  br i1 %exitcond15.not.i, label %categorize.exit.loopexit, label %for.body.i
...
categorize.exit:                                  ; preds = %categorize.exit.loopexit, %doemit.exit161.thread, %doemit.exit161
  ...
  store i64 %32, ptr %nstates.i, align 8
  ...
  store ptr %call.i, ptr %strip2.i, align 8
  %cmp.i168 = icmp eq ptr %call.i, null
  %pa.val133.pre = load i32, ptr %error, align 8
...
stripsnug.exit.thread:                            ; preds = %if.then.i, %if.then.i.i172
  ...
  store ptr @nuls, ptr %pa, align 8
  store ptr @nuls, ptr %end, align 8
  %34 = load ptr, ptr %strip, align 8
  store ptr %34, ptr %strip2.i, align 8
...
do.body.i:                                        ; preds = %do.cond30.i, %if.end.i174
  ...
  %35 = load i64, ptr %scan.0.i, align 8
...
do.body8.i:                                       ; preds = %do.body8.i.preheader, %switch.early.test.i
  ...
  %38 = load i64, ptr %add.ptr10.i, align 8
  %.fr.i = freeze i64 %38
...
do.cond30.i:                                      ; preds = %if.then26.i, %sw.default.i, %sw.bb.i, %do.body.i, %do.body.i, %do.body.i
  ...
  br i1 %cmp32.not.i, label %do.end34.i, label %do.body.i
...
if.end39.i:                                       ; preds = %do.end34.i
  ...
  store ptr %call.i179, ptr %must, align 8
...
while.cond.i.prol:                                ; preds = %while.cond.preheader.preheader.i, %while.cond.i.prol
  ...
  %43 = load i64, ptr %scan.5.i.prol, align 8
  %and54.i.prol = and i64 %43, 4160749568
  %cmp55.not.i.prol = icmp eq i64 %and54.i.prol, 268435456
  br i1 %cmp55.not.i.prol, label %while.end.i.prol, label %while.cond.i.prol
...
while.end.i.prol:                                 ; preds = %while.cond.i.prol
  ...
  store i8 %conv58.i.prol, ptr %call.i179, align 1
...
while.cond.i:                                     ; preds = %while.cond.i, %while.cond.preheader.i
  ...
  %45 = load i64, ptr %scan.5.i, align 8
  %and54.i = and i64 %45, 4160749568
  %cmp55.not.i = icmp eq i64 %and54.i, 268435456
  br i1 %cmp55.not.i, label %while.end.i, label %while.cond.i
...
while.cond.i.1:                                   ; preds = %while.cond.i.1, %while.end.i
  ...
  %46 = load i64, ptr %scan.5.i.1, align 8
  %and54.i.1 = and i64 %46, 4160749568
  %cmp55.not.i.1 = icmp eq i64 %and54.i.1, 268435456
  br i1 %cmp55.not.i.1, label %while.end.i.1, label %while.cond.i.1
...
while.end.i.1:                                    ; preds = %while.cond.i.1
  ...
  store i8 %conv58.i.1, ptr %incdec.ptr59.i, align 1
  %dec.i.1 = add nsw i64 %i.08.i, -2
  %cmp51.i.1 = icmp sgt i64 %i.08.i, 2
  br i1 %cmp51.i.1, label %while.cond.preheader.i, label %for.end.i
...
findmust.exit:                                    ; preds = %if.then18.i, %do.end34.i, %if.then45.i, %for.end.i
  %pa.val134.pr = load i32, ptr %error, align 8
...
if.end.i182:                                      ; preds = %findmust.exit
  %47 = load ptr, ptr %strip2.i, align 8
...
do.body.i184:                                     ; preds = %do.cond.i, %if.end.i182
  ...
  %48 = load i64, ptr %scan.0.i185, align 8
...
do.cond.i:                                        ; preds = %sw.bb1.i, %sw.bb.i192, %do.body.i184
  ...
  br i1 %cmp6.not.i, label %do.end.i, label %do.body.i184
...
if.then8.i:                                       ; preds = %do.end.i
  %49 = load i32, ptr %iflags, align 8
  %or.i191 = or i32 %49, 4
  store i32 %or.i191, ptr %iflags, align 8
  br label %pluscount.exit
...
pluscount.exit:                                   ; preds = %stripsnug.exit.thread, %stripsnug.exit, %findmust.exit, %do.end.i, %if.then8.i
  ...
  %52 = load i32, ptr %iflags, align 8
  %and45 = and i32 %52, 4
...
if.then52:                                        ; preds = %if.end49
  ...
  %.pre219 = load i32, ptr %error, align 8
  br label %cleanup
...
land.lhs.true:                                    ; preds = %land.lhs.true.preheader, %p_ere_exp.exit
  ...
  %.pre637.pre645 = load i64, ptr %slen, align 8
...
if.then.i:                                        ; preds = %lor.end.i
  ...
  store i64 %.pre637.pre645, ptr %arrayidx.i, align 8
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i, %lor.end.i
  %15 = load i32, ptr %error.i417, align 8
...
if.end.i566:                                      ; preds = %if.end.i
  ...
  %17 = load i64, ptr %ssize.i433, align 8
...
if.end.i.i580:                                    ; preds = %if.then2.i570
  %18 = load ptr, ptr %strip.i.i445, align 8
...
if.then2.i.i586:                                  ; preds = %if.end.i.i580
  %19 = load i32, ptr %error.i417, align 8
...
if.then.i.i.i590:                                 ; preds = %if.then2.i.i586
  store i32 12, ptr %error.i417, align 8
...
if.end4.i.i585:                                   ; preds = %if.end.i.i580
  store ptr %call.i.i583, ptr %strip.i.i445, align 8
  store i64 %mul.i573, ptr %ssize.i433, align 8
  %.pre.pre = load ptr, ptr %p, align 8
  %.pre627.pre = load ptr, ptr %end, align 8
  br label %if.end4.i575
...
if.end4.i575:                                     ; preds = %if.end4.i.i585, %seterr.exit.i.i588, %if.then2.i570, %if.end.i566
  ...
  %20 = load ptr, ptr %strip.i.i445, align 8
  ...
  store i64 %or.i576, ptr %arrayidx.i579, align 8
...
if.then20.i:                                      ; preds = %if.end17.i
  ...
  store i64 %25, ptr %arrayidx22.i, align 8
  br label %if.end23.i

if.end23.i:                                       ; preds = %if.then20.i, %if.end17.i
  %26 = load i32, ptr %error.i417, align 8
...
if.end.i538:                                      ; preds = %if.end23.i
  ...
  %28 = load i64, ptr %ssize.i433, align 8
...
if.end.i.i552:                                    ; preds = %if.then2.i542
  %29 = load ptr, ptr %strip.i.i445, align 8
...
if.then2.i.i558:                                  ; preds = %if.end.i.i552
  %30 = load i32, ptr %error.i417, align 8
...
if.end4.i.i557:                                   ; preds = %if.end.i.i552
  store ptr %call.i.i555, ptr %strip.i.i445, align 8
  store i64 %mul.i545, ptr %ssize.i433, align 8
  br label %if.end4.i547

if.end4.i547:                                     ; preds = %if.end4.i.i557, %seterr.exit.i.i560, %if.then2.i542, %if.end.i538
  %or.i548 = or i64 %inc.i, 1879048192
  %31 = load ptr, ptr %strip.i.i445, align 8
  %32 = load i64, ptr %slen, align 8
  %inc.i550 = add nsw i64 %32, 1
  store i64 %inc.i550, ptr %slen, align 8
  %arrayidx.i551 = getelementptr inbounds i64, ptr %31, i64 %32
  store i64 %or.i548, ptr %arrayidx.i551, align 8
...
lor.rhs34.i:                                      ; preds = %land.lhs.true28.i, %doemit.exit563
  %36 = load i32, ptr %error.i417, align 8
...
sw.bb39.i:                                        ; preds = %while.body
  %37 = load i32, ptr %error.i417, align 8
...
if.end.i.i512:                                    ; preds = %if.then2.i503
  %40 = load ptr, ptr %strip.i.i445, align 8
...
if.then2.i.i518:                                  ; preds = %if.end.i.i512
  %41 = load i32, ptr %error.i417, align 8
...
if.end.i.i485:                                    ; preds = %if.then2.i476
  %49 = load ptr, ptr %strip.i.i445, align 8
...
if.then2.i.i491:                                  ; preds = %if.end.i.i485
  %50 = load i32, ptr %error.i417, align 8
...
if.then58.i:                                      ; preds = %sw.bb55.i
  ...
  store ptr %add.ptr.i457, ptr %end, align 8
...
if.end.i.i444:                                    ; preds = %if.then2.i435
  %62 = load ptr, ptr %strip.i.i445, align 8
...
if.then2.i.i450:                                  ; preds = %if.end.i.i444
  %63 = load i32, ptr %error.i417, align 8
...
if.end4.i.i449:                                   ; preds = %if.end.i.i444
  store ptr %call.i.i447, ptr %strip.i.i445, align 8
  store i64 %mul.i438, ptr %ssize.i433, align 8
  br label %if.end4.i440

if.end4.i440:                                     ; preds = %if.end4.i.i449, %seterr.exit.i.i452, %if.then2.i435, %if.end.i431
  %64 = load ptr, ptr %strip.i.i445, align 8
  %65 = load i64, ptr %slen, align 8
  %inc.i442 = add nsw i64 %65, 1
  store i64 %inc.i442, ptr %slen, align 8
  %arrayidx.i443 = getelementptr inbounds i64, ptr %64, i64 %65
  store i64 671088640, ptr %arrayidx.i443, align 8
  br label %sw.epilog.i
...
lor.lhs.false.i:                                  ; preds = %sw.bb74.i
  ...
  %69 = load ptr, ptr %call79.i, align 8
  %70 = load i8, ptr %incdec.ptr.i, align 1
  %idxprom.i = zext i8 %70 to i64
  %arrayidx82.i = getelementptr inbounds i16, ptr %69, i64 %idxprom.i
  %71 = load i16, ptr %arrayidx82.i, align 2
  %72 = and i16 %71, 2048
...
lor.rhs86.i:                                      ; preds = %lor.lhs.false.i
  %73 = load i32, ptr %error.i417, align 8
...
land.lhs.true119.i:                               ; preds = %land.lhs.true114.i
  ...
  %77 = load ptr, ptr %call120.i, align 8
  ...
  %79 = load i16, ptr %arrayidx125.i, align 2
  %80 = and i16 %79, 2048
...
if.end.i.i399:                                    ; preds = %if.then2.i389
  %87 = load ptr, ptr %strip.i.i445, align 8
...
if.then2.i.i405:                                  ; preds = %if.end.i.i399
  %88 = load i32, ptr %error.i417, align 8
...
if.end4.i.i404:                                   ; preds = %if.end.i.i399
  store ptr %call.i.i402, ptr %strip.i.i445, align 8
  store i64 %mul.i392, ptr %ssize.i433, align 8
  br label %if.end4.i394

if.end4.i394:                                     ; preds = %if.end4.i.i404, %seterr.exit.i.i407, %if.then2.i389, %if.end.i385
  %or.i395 = or i64 %sub143.i, 1342177280
  %89 = load ptr, ptr %strip.i.i445, align 8
  %90 = load i64, ptr %slen, align 8
  %inc.i397 = add nsw i64 %90, 1
  store i64 %inc.i397, ptr %slen, align 8
  %arrayidx.i398 = getelementptr inbounds i64, ptr %89, i64 %90
  store i64 %or.i395, ptr %arrayidx.i398, align 8
  %.pre636 = load i64, ptr %slen, align 8
...
if.end.i.i371:                                    ; preds = %if.then2.i361
  %94 = load ptr, ptr %strip.i.i445, align 8
...
if.then2.i.i377:                                  ; preds = %if.end.i.i371
  %95 = load i32, ptr %error.i417, align 8
...
if.end4.i.i376:                                   ; preds = %if.end.i.i371
  store ptr %call.i.i374, ptr %strip.i.i445, align 8
  store i64 %mul.i364, ptr %ssize.i433, align 8
  br label %if.end4.i366

if.end4.i366:                                     ; preds = %if.end4.i.i376, %seterr.exit.i.i379, %if.then2.i361, %if.end.i357
  %or.i367 = or i64 %sub148.i, 1610612736
  %96 = load ptr, ptr %strip.i.i445, align 8
  %97 = load i64, ptr %slen, align 8
  %inc.i369 = add nsw i64 %97, 1
  store i64 %inc.i369, ptr %slen, align 8
  %arrayidx.i370 = getelementptr inbounds i64, ptr %96, i64 %97
  store i64 %or.i367, ptr %arrayidx.i370, align 8
  br label %sw.epilog243.i

sw.bb149.i:                                       ; preds = %lor.end137.i
  %98 = load i64, ptr %slen, align 8
...
if.end.i.i343:                                    ; preds = %if.then2.i333
  %102 = load ptr, ptr %strip.i.i445, align 8
...
if.then2.i.i349:                                  ; preds = %if.end.i.i343
  %103 = load i32, ptr %error.i417, align 8
...
if.end4.i.i348:                                   ; preds = %if.end.i.i343
  store ptr %call.i.i346, ptr %strip.i.i445, align 8
  store i64 %mul.i336, ptr %ssize.i433, align 8
  br label %if.end4.i338

if.end4.i338:                                     ; preds = %if.end4.i.i348, %seterr.exit.i.i351, %if.then2.i333, %if.end.i329
  %or.i339 = or i64 %sub154.i, 1342177280
  %104 = load ptr, ptr %strip.i.i445, align 8
  %105 = load i64, ptr %slen, align 8
  %inc.i341 = add nsw i64 %105, 1
  store i64 %inc.i341, ptr %slen, align 8
  %arrayidx.i342 = getelementptr inbounds i64, ptr %104, i64 %105
  store i64 %or.i339, ptr %arrayidx.i342, align 8
  br label %sw.epilog243.i
...
if.end.i.i315:                                    ; preds = %if.then2.i305
  %110 = load ptr, ptr %strip.i.i445, align 8
...
if.then2.i.i321:                                  ; preds = %if.end.i.i315
  %111 = load i32, ptr %error.i417, align 8
...
if.end4.i.i320:                                   ; preds = %if.end.i.i315
  store ptr %call.i.i318, ptr %strip.i.i445, align 8
  store i64 %mul.i308, ptr %ssize.i433, align 8
  %.pr.pre = load i32, ptr %error.i417, align 8
  br label %doemit.exit326
...
if.then2.i.i285:                                  ; preds = %if.end.i.i279
  %118 = load i32, ptr %error.i417, align 8
...
doemit.exit290.thread652:                         ; preds = %if.then2.i.i285, %if.then.i.i.i289
  store ptr @nuls, ptr %p, align 8
  store ptr @nuls, ptr %end, align 8
  %.pre632 = load ptr, ptr %strip.i.i445, align 8
  %119 = load i64, ptr %slen, align 8
  %inc.i277654 = add nsw i64 %119, 1
  store i64 %inc.i277654, ptr %slen, align 8
  %arrayidx.i278655 = getelementptr inbounds i64, ptr %.pre632, i64 %119
  store i64 2281701376, ptr %arrayidx.i278655, align 8
  br label %sw.epilog243.i

doemit.exit290.thread:                            ; preds = %if.end.i266, %if.then2.i270
  %120 = load i64, ptr %slen, align 8
  %inc.i277649 = add nsw i64 %120, 1
  store i64 %inc.i277649, ptr %slen, align 8
  %arrayidx.i278650 = getelementptr inbounds i64, ptr %112, i64 %120
  store i64 2281701376, ptr %arrayidx.i278650, align 8
  br label %if.end.i231

doemit.exit290:                                   ; preds = %if.end.i.i279
  store ptr %call.i.i282, ptr %strip.i.i445, align 8
  store i64 %mul.i273, ptr %ssize.i433, align 8
  %.pr613.pre = load i32, ptr %error.i417, align 8
  %121 = load i64, ptr %slen, align 8
  %inc.i277 = add nsw i64 %121, 1
  store i64 %inc.i277, ptr %slen, align 8
  %arrayidx.i278 = getelementptr inbounds i64, ptr %call.i.i282, i64 %121
  store i64 2281701376, ptr %arrayidx.i278, align 8
...
if.then2.i.i250:                                  ; preds = %if.end.i.i244
  %127 = load i32, ptr %error.i417, align 8
...
seterr.exit.i.i252:                               ; preds = %if.then.i.i.i254, %if.then2.i.i250
  store ptr @nuls, ptr %p, align 8
  store ptr @nuls, ptr %end, align 8
  %.pre635 = load ptr, ptr %strip.i.i445, align 8
  br label %if.end4.i240

if.end4.i.i249:                                   ; preds = %if.end.i.i244
  store ptr %call.i.i247, ptr %strip.i.i445, align 8
  store i64 %mul.i238, ptr %ssize.i433, align 8
  br label %if.end4.i240
...
if.end4.i240:                                     ; preds = %if.end4.i.i249, %seterr.exit.i.i252, %if.then2.i235, %if.end.i231
  ...
  %129 = load i64, ptr %slen, align 8
  %inc.i242 = add nsw i64 %129, 1
  store i64 %inc.i242, ptr %slen, align 8
  %arrayidx.i243 = getelementptr inbounds i64, ptr %128, i64 %129
  store i64 2415919106, ptr %arrayidx.i243, align 8
  br label %sw.epilog243.i
...
land.lhs.true.i206:                               ; preds = %while.body.i220, %land.lhs.true.lr.ph.i202
  ...
  %132 = load ptr, ptr %call.i204, align 8
  %133 = load i8, ptr %incdec.ptr2325.i209, align 1
  %idxprom.i210 = zext i8 %133 to i64
  %arrayidx.i211 = getelementptr inbounds i16, ptr %132, i64 %idxprom.i210
  %134 = load i16, ptr %arrayidx.i211, align 2
...
while.body.i220:                                  ; preds = %land.lhs.true.i206
  ...
  store ptr %incdec.ptr.i222, ptr %p, align 8
  %136 = load i8, ptr %incdec.ptr2325.i209, align 1
  ...
  br i1 %exitcond.not.i227, label %while.end.i215, label %land.lhs.true.i206
...
lor.rhs.i194:                                     ; preds = %while.end.i215, %sw.bb173.i
  ...
  %139 = load i32, ptr %error.i417, align 8
...
cond.true.i:                                      ; preds = %land.lhs.true179.i
  ...
  store ptr %incdec.ptr185.i, ptr %p, align 8
  %call187.i = tail call ptr @__ctype_b_loc() #13
  %141 = load ptr, ptr %call187.i, align 8
  %142 = load i8, ptr %incdec.ptr185.i, align 1
  %idxprom190.i = zext i8 %142 to i64
  %arrayidx191.i = getelementptr inbounds i16, ptr %141, i64 %idxprom190.i
  %143 = load i16, ptr %arrayidx191.i, align 2
...
land.lhs.true.i180:                               ; preds = %while.body.i185, %land.lhs.true.lr.ph.i
  ...
  %147 = load ptr, ptr %call187.i, align 8
  %148 = load i8, ptr %incdec.ptr2325.i, align 1
  %idxprom.i181 = zext i8 %148 to i64
  %arrayidx.i182 = getelementptr inbounds i16, ptr %147, i64 %idxprom.i181
  %149 = load i16, ptr %arrayidx.i182, align 2
...
while.body.i185:                                  ; preds = %land.lhs.true.i180
  ...
  store ptr %incdec.ptr.i187, ptr %p, align 8
  %151 = load i8, ptr %incdec.ptr2325.i, align 1
  ...
  br i1 %exitcond.not.i, label %while.end.i183, label %land.lhs.true.i180
...
lor.rhs199.i:                                     ; preds = %p_count.exit
  %154 = load i32, ptr %error.i417, align 8
...
cond.true217.i:                                   ; preds = %land.lhs.true212.i
  ...
  store ptr %incdec.ptr219.i, ptr %p, align 8
  br label %sw.epilog243.i
...
land.rhs.i:                                       ; preds = %land.rhs.i.preheader, %while.body.i
  ...
  %160 = load i8, ptr %incdec.ptr231.i617619, align 1
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  store ptr %incdec.ptr231.i, ptr %p, align 8
  %exitcond.not = icmp eq ptr %incdec.ptr231.i, %scevgep
  br i1 %exitcond.not, label %lor.rhs236.i, label %land.rhs.i

lor.rhs236.i:                                     ; preds = %while.body.i, %if.end207.i
  %161 = load i32, ptr %error.i417, align 8
...
lor.end239.i:                                     ; preds = %land.rhs.i
  %.pre629 = load i32, ptr %error.i417, align 8
...
seterr.exit163.sink.split:                        ; preds = %lor.end239.i, %lor.rhs236.i
  ...
  store i32 %.sink, ptr %error.i417, align 8
...
land.lhs.true272.i:                               ; preds = %land.lhs.true266.i
  ...
  %165 = load ptr, ptr %call273.i, align 8
  %166 = load i8, ptr %add.ptr268.i, align 1
  %idxprom277.i = zext i8 %166 to i64
  %arrayidx278.i = getelementptr inbounds i16, ptr %165, i64 %idxprom277.i
  %167 = load i16, ptr %arrayidx278.i, align 2
...
if.end283.i:                                      ; preds = %land.lhs.true272.i, %if.end249.i, %if.end249.i, %if.end249.i
  %169 = load i32, ptr %error.i417, align 8
...
p_ere_exp.exit:                                   ; preds = %sw.epilog.i, %if.end97.i, %land.lhs.true114.i, %land.lhs.true119.i, %sw.epilog243.i, %if.end249.i, %land.lhs.true266.i, %land.lhs.true272.i
  ...
  br i1 %cmp, label %land.lhs.true, label %p_ere_exp.exit.while.end.loopexit_crit_edge
...
p_ere_exp.exit.while.end.loopexit_crit_edge:      ; preds = %p_ere_exp.exit, %p_ere_exp.exit.thread
  ...
  %.pre637.pre = load i64, ptr %slen, align 8
  br label %while.end
...
lor.rhs:                                          ; preds = %while.end, %doemit.exit115, %entry
  ...
  %178 = load i32, ptr %error.i417, align 8
...
if.then21:                                        ; preds = %cond.true
  ...
  %.pre639 = load i64, ptr %slen, align 8
  br label %if.end23
...
if.end.i.i:                                       ; preds = %if.then2.i
  %183 = load ptr, ptr %strip.i.i445, align 8
  %mul.i.i = mul i64 %div.i, 24
...
if.then2.i.i:                                     ; preds = %if.end.i.i
  %184 = load i32, ptr %error.i417, align 8
...
if.end4.i.i:                                      ; preds = %if.end.i.i
  store ptr %call.i.i, ptr %strip.i.i445, align 8
  store i64 %mul.i, ptr %ssize.i433, align 8
  %.pr602.pre = load i32, ptr %error.i417, align 8
  br label %doemit.exit
...
doemit.exit:                                      ; preds = %if.end.i76, %if.then2.i, %seterr.exit.i.i, %if.end4.i.i
  ...
  %185 = load ptr, ptr %strip.i.i445, align 8
  %186 = load i64, ptr %slen, align 8
  %inc.i80 = add nsw i64 %186, 1
  store i64 %inc.i80, ptr %slen, align 8
  %arrayidx.i81 = getelementptr inbounds i64, ptr %185, i64 %186
  store i64 %or.i79, ptr %arrayidx.i81, align 8
  %187 = load i64, ptr %slen, align 8
...
if.end.i91:                                       ; preds = %doemit.exit
  ...
  %188 = load i64, ptr %arrayidx.i86, align 8
  %and.i87 = and i64 %188, 4160749568
  %or.i88 = or i64 %and.i87, %sub29
  store i64 %or.i88, ptr %arrayidx.i86, align 8
  %189 = load i64, ptr %slen, align 8
  %190 = load i64, ptr %ssize.i433, align 8
...
if.then2.i.i110:                                  ; preds = %if.end.i.i104
  %191 = load i32, ptr %error.i417, align 8
...
seterr.exit.i.i112:                               ; preds = %if.then.i.i.i114, %if.then2.i.i110
  store ptr @nuls, ptr %p, align 8
  store ptr @nuls, ptr %end, align 8
  %.pre642 = load ptr, ptr %strip.i.i445, align 8
  br label %if.end4.i100

if.end4.i.i109:                                   ; preds = %if.end.i.i104
  store ptr %call.i.i107, ptr %strip.i.i445, align 8
  store i64 %mul.i98, ptr %ssize.i433, align 8
  br label %if.end4.i100
...
if.end4.i100:                                     ; preds = %if.end4.i.i109, %seterr.exit.i.i112, %if.then2.i95, %if.end.i91
  ...
  %193 = load i64, ptr %slen, align 8
  %inc.i102 = add nsw i64 %193, 1
  store i64 %inc.i102, ptr %slen, align 8
  %arrayidx.i103 = getelementptr inbounds i64, ptr %192, i64 %193
  store i64 2281701376, ptr %arrayidx.i103, align 8
...
if.then32:                                        ; preds = %for.end
  %199 = load i32, ptr %error.i417, align 8
...
if.end.i126:                                      ; preds = %if.then32
  ...
  %200 = load ptr, ptr %strip.i.i445, align 8
  %arrayidx.i120 = getelementptr inbounds i64, ptr %200, i64 %prevfwd.0694
  %201 = load i64, ptr %arrayidx.i120, align 8
  %and.i121 = and i64 %201, 4160749568
  %or.i122 = or i64 %and.i121, %sub34
  store i64 %or.i122, ptr %arrayidx.i120, align 8
  %202 = load i64, ptr %slen, align 8
  %sub36611 = sub nsw i64 %202, %prevback.0692
  %203 = load i64, ptr %ssize.i433, align 8
...
if.then2.i.i146:                                  ; preds = %if.end.i.i140
  %204 = load i32, ptr %error.i417, align 8
...
seterr.exit.i.i148:                               ; preds = %if.then.i.i.i150, %if.then2.i.i146
  store ptr @nuls, ptr %p, align 8
  store ptr @nuls, ptr %end, align 8
  %.pre638 = load ptr, ptr %strip.i.i445, align 8
  br label %if.end4.i135

if.end4.i.i145:                                   ; preds = %if.end.i.i140
  store ptr %call.i.i143, ptr %strip.i.i445, align 8
  store i64 %mul.i133, ptr %ssize.i433, align 8
  br label %if.end4.i135
...
if.end4.i135:                                     ; preds = %if.end4.i.i145, %seterr.exit.i.i148, %if.then2.i130, %if.end.i126
  ...
  %206 = load i64, ptr %slen, align 8
  %inc.i138 = add nsw i64 %206, 1
  store i64 %inc.i138, ptr %slen, align 8
  %arrayidx.i139 = getelementptr inbounds i64, ptr %205, i64 %206
  store i64 %or.i136, ptr %arrayidx.i139, align 8
  br label %if.end37
...
if.end4.i.i:                                      ; preds = %if.end.i.i
  store ptr %call.i.i, ptr %strip.i.i, align 8
  store i64 %mul.i, ptr %ssize.i, align 8
  %.pre.pre.pre = load ptr, ptr %p, align 8
  %.pre440.pre.pre = load ptr, ptr %end, align 8
  br label %if.end4.i
...
while.end.thread:                                 ; preds = %if.end
  %.pre451465 = load i64, ptr %slen, align 8
  br label %if.end38
...
lor.rhs.i:                                        ; preds = %while.body.thread
  %23 = load i32, ptr %error.i423, align 8
  %cmp.i424 = icmp eq i32 %23, 0
  br i1 %cmp.i424, label %if.then.i427, label %seterr.exit428

if.then.i427:                                     ; preds = %lor.rhs.i
  store i32 5, ptr %error.i423, align 8
  br label %seterr.exit428
...
if.then9.i:                                       ; preds = %sw.bb.i
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %bracket.i) #11
  store ptr %bracket.i, ptr %p, align 8
  store ptr %add.ptr.i422, ptr %end, align 8
  store <4 x i8> <i8 94, i8 10, i8 93, i8 0>, ptr %bracket.i, align 4
  call fastcc void @p_bracket(ptr noundef nonnull %p)
...
if.end.i.i409:                                    ; preds = %if.then2.i400
  %35 = load ptr, ptr %strip.i.i309, align 8
...
if.then2.i.i415:                                  ; preds = %if.end.i.i409
  %36 = load i32, ptr %error.i423, align 8
...
if.then.i.i.i419:                                 ; preds = %if.then2.i.i415
  store i32 12, ptr %error.i423, align 8
...
if.end4.i.i414:                                   ; preds = %if.end.i.i409
  store ptr %call.i.i412, ptr %strip.i.i309, align 8
  store i64 %mul.i403, ptr %ssize.i296, align 8
  br label %if.end4.i405

if.end4.i405:                                     ; preds = %if.end4.i.i414, %seterr.exit.i.i417, %if.then2.i400, %if.end.i396
  %37 = load ptr, ptr %strip.i.i309, align 8
  %38 = load i64, ptr %slen, align 8
  %inc.i407 = add nsw i64 %38, 1
  store i64 %inc.i407, ptr %slen, align 8
  %arrayidx.i408 = getelementptr inbounds i64, ptr %37, i64 %38
  store i64 671088640, ptr %arrayidx.i408, align 8
  br label %sw.epilog.i
...
if.end.i.i376:                                    ; preds = %if.then2.i366
  %45 = load ptr, ptr %strip.i.i309, align 8
...
if.then2.i.i382:                                  ; preds = %if.end.i.i376
  %46 = load i32, ptr %error.i423, align 8
...
if.end4.i.i381:                                   ; preds = %if.end.i.i376
  store ptr %call.i.i379, ptr %strip.i.i309, align 8
  store i64 %mul.i369, ptr %ssize.i296, align 8
  %.pre444.pre = load ptr, ptr %p, align 8
  %.pre445.pre = load ptr, ptr %end, align 8
  br label %if.end4.i371
...
if.end4.i371:                                     ; preds = %if.end4.i.i381, %seterr.exit.i.i384, %if.then2.i366, %if.end.i362
  ...
  %47 = load ptr, ptr %strip.i.i309, align 8
  %48 = load i64, ptr %slen, align 8
  %inc.i374 = add nsw i64 %48, 1
  store i64 %inc.i374, ptr %slen, align 8
  %arrayidx.i375 = getelementptr inbounds i64, ptr %47, i64 %48
  store i64 %or.i372, ptr %arrayidx.i375, align 8
...
if.then51.i:                                      ; preds = %if.end48.i
  ...
  store i64 %53, ptr %arrayidx53.i, align 8
  br label %if.end54.i

if.end54.i:                                       ; preds = %if.then51.i, %if.end48.i
  %54 = load i32, ptr %error.i423, align 8
...
if.end.i334:                                      ; preds = %if.end54.i
  ...
  %56 = load i64, ptr %ssize.i296, align 8
...
if.end.i.i348:                                    ; preds = %if.then2.i338
  %57 = load ptr, ptr %strip.i.i309, align 8
...
if.then2.i.i354:                                  ; preds = %if.end.i.i348
  %58 = load i32, ptr %error.i423, align 8
...
land.lhs.true70.i:                                ; preds = %land.lhs.true65.i
  %64 = load i8, ptr %add.ptr61.i, align 1
...
sw.bb83.i:                                        ; preds = %if.end.i69, %if.end.i69
  %66 = load i32, ptr %error.i423, align 8
...
sw.bb85.i:                                        ; preds = %if.end.i69, %if.end.i69, %if.end.i69, %if.end.i69, %if.end.i69, %if.end.i69, %if.end.i69, %if.end.i69, %if.end.i69
  ...
  %67 = load i64, ptr %arrayidx88.i, align 8
  %cmp89.not.i = icmp eq i64 %67, 0
  %68 = load i32, ptr %error.i423, align 8
...
if.end.i294:                                      ; preds = %if.then91.i
  %69 = load i64, ptr %ssize.i296, align 8
...
if.end.i.i308:                                    ; preds = %if.then2.i298
  %70 = load ptr, ptr %strip.i.i309, align 8
...
if.then2.i.i314:                                  ; preds = %if.end.i.i308
  %71 = load i32, ptr %error.i423, align 8
...
if.end4.i.i313:                                   ; preds = %if.end.i.i308
  store ptr %call.i.i311, ptr %strip.i.i309, align 8
  store i64 %mul.i301, ptr %ssize.i296, align 8
  br label %if.end4.i303

if.end4.i303:                                     ; preds = %if.end4.i.i313, %seterr.exit.i.i316, %if.then2.i298, %if.end.i294
  %or.i304 = or i64 %idxprom.i, 939524096
  %72 = load ptr, ptr %strip.i.i309, align 8
  %73 = load i64, ptr %slen, align 8
  %inc.i306 = add nsw i64 %73, 1
  store i64 %inc.i306, ptr %slen, align 8
  %arrayidx.i307 = getelementptr inbounds i64, ptr %72, i64 %73
  store i64 %or.i304, ptr %arrayidx.i307, align 8
  %.pre441 = load i64, ptr %arrayidx88.i, align 8
...
doemit.exit319:                                   ; preds = %if.then91.i, %if.end4.i303
  ...
  %75 = load i64, ptr %arrayidx95.i, align 8
...
if.end.i273:                                      ; preds = %doemit.exit319
  ...
  %76 = load i64, ptr %ssize.i296, align 8
  %add.i276 = add nsw i64 %76, %sub.i274
  %cmp.not.i.i277 = icmp sgt i64 %sub.i274, 0
  %.pre443 = load ptr, ptr %strip.i.i309, align 8
...
if.then2.i.i287:                                  ; preds = %if.end.i.i281
  %77 = load i32, ptr %error.i423, align 8
...
seterr.exit.i.i289:                               ; preds = %if.then.i.i.i291, %if.then2.i.i287
  store ptr @nuls, ptr %p, align 8
  store ptr @nuls, ptr %end, align 8
  %.pre442 = load ptr, ptr %strip.i.i309, align 8
  br label %enlarge.exit.i

if.end4.i.i286:                                   ; preds = %if.end.i.i281
  store ptr %call.i.i284, ptr %strip.i.i309, align 8
  store i64 %add.i276, ptr %ssize.i296, align 8
  br label %enlarge.exit.i
...
if.end.i.i259:                                    ; preds = %if.then2.i249
  %84 = load ptr, ptr %strip.i.i309, align 8
...
if.then2.i.i265:                                  ; preds = %if.end.i.i259
  %85 = load i32, ptr %error.i423, align 8
...
if.then.i241:                                     ; preds = %if.else101.i
  store i32 6, ptr %error.i423, align 8
...
if.end103.i:                                      ; preds = %if.end4.i254, %dupl.exit, %seterr.exit242
  %88 = load ptr, ptr %g104.i, align 8
...
lor.rhs107.i:                                     ; preds = %sw.bb105.i
  %89 = load i32, ptr %error.i423, align 8
...
if.end.i.i219:                                    ; preds = %if.then2.i209
  %97 = load ptr, ptr %strip.i.i309, align 8
...
if.then2.i.i225:                                  ; preds = %if.end.i.i219
  %98 = load i32, ptr %error.i423, align 8
...
if.end4.i.i224:                                   ; preds = %if.end.i.i219
  store ptr %call.i.i222, ptr %strip.i.i309, align 8
  store i64 %mul.i212, ptr %ssize.i296, align 8
  br label %if.end4.i214

if.end4.i214:                                     ; preds = %if.end4.i.i224, %seterr.exit.i.i227, %if.then2.i209, %if.end.i205
  %or.i215 = or i64 %sub132.i, 1342177280
  %99 = load ptr, ptr %strip.i.i309, align 8
  %100 = load i64, ptr %slen, align 8
  %inc.i217 = add nsw i64 %100, 1
  store i64 %inc.i217, ptr %slen, align 8
  %arrayidx.i218 = getelementptr inbounds i64, ptr %99, i64 %100
  store i64 %or.i215, ptr %arrayidx.i218, align 8
  %.pre447 = load i64, ptr %slen, align 8
...
if.end.i.i191:                                    ; preds = %if.then2.i181
  %104 = load ptr, ptr %strip.i.i309, align 8
...
if.then2.i.i197:                                  ; preds = %if.end.i.i191
  %105 = load i32, ptr %error.i423, align 8
...
if.end4.i.i196:                                   ; preds = %if.end.i.i191
  store ptr %call.i.i194, ptr %strip.i.i309, align 8
  store i64 %mul.i184, ptr %ssize.i296, align 8
  br label %if.end4.i186

if.end4.i186:                                     ; preds = %if.end4.i.i196, %seterr.exit.i.i199, %if.then2.i181, %if.end.i177
  %or.i187 = or i64 %sub137.i, 1610612736
  %106 = load ptr, ptr %strip.i.i309, align 8
  %107 = load i64, ptr %slen, align 8
  %inc.i189 = add nsw i64 %107, 1
  store i64 %inc.i189, ptr %slen, align 8
  %arrayidx.i190 = getelementptr inbounds i64, ptr %106, i64 %107
  store i64 %or.i187, ptr %arrayidx.i190, align 8
...
land.lhs.true154.i:                               ; preds = %land.lhs.true143.i
  %108 = load i8, ptr %incdec.ptr125.i, align 1
...
land.lhs.true.i152:                               ; preds = %while.body.i166, %land.lhs.true.lr.ph.i148
  ...
  %111 = load ptr, ptr %call.i150, align 8
  %112 = load i8, ptr %incdec.ptr2325.i155, align 1
  %idxprom.i156 = zext i8 %112 to i64
  %arrayidx.i157 = getelementptr inbounds i16, ptr %111, i64 %idxprom.i156
  %113 = load i16, ptr %arrayidx.i157, align 2
...
while.body.i166:                                  ; preds = %land.lhs.true.i152
  ...
  store ptr %incdec.ptr.i168, ptr %p, align 8
  %115 = load i8, ptr %incdec.ptr2325.i155, align 1
  ...
  br i1 %exitcond.not.i173, label %while.end.i161, label %land.lhs.true.i152
...
lor.rhs.i140:                                     ; preds = %while.end.i161, %cond.true160.i
  ...
  %118 = load i32, ptr %error.i423, align 8
...
land.lhs.true184.i:                               ; preds = %cond.true175.i
  ...
  %120 = load ptr, ptr %call185.i, align 8
  %121 = load i8, ptr %incdec.ptr177.i, align 1
  %idxprom188.i = zext i8 %121 to i64
  %arrayidx189.i = getelementptr inbounds i16, ptr %120, i64 %idxprom188.i
  %122 = load i16, ptr %arrayidx189.i, align 2
...
while.body.i131:                                  ; preds = %land.lhs.true.i
  ...
  store ptr %incdec.ptr.i133, ptr %p, align 8
  %130 = load i8, ptr %incdec.ptr2325.i, align 1
  ...
  br i1 %exitcond.not.i, label %while.end.i130, label %land.lhs.true.i
...
lor.rhs.i124:                                     ; preds = %while.end.i130
  %132 = load i32, ptr %error.i423, align 8
  %cmp.i.i = icmp eq i32 %132, 0
  br i1 %cmp.i.i, label %if.then.i.i, label %seterr.exit.i

if.then.i.i:                                      ; preds = %lor.rhs.i124
  store i32 10, ptr %error.i423, align 8
  br label %seterr.exit.i
...
lor.rhs197.i:                                     ; preds = %p_count.exit
  %133 = load i32, ptr %error.i423, align 8
...
land.lhs.true221.i:                               ; preds = %land.lhs.true216.i
  %138 = load i8, ptr %add.ptr212.i, align 1
...
land.lhs.true246.i:                               ; preds = %land.lhs.true240.i
  %140 = load i8, ptr %add.ptr242.i431433, align 1
...
while.body.i:                                     ; preds = %land.rhs251.i, %land.lhs.true246.i, %land.lhs.true240.i
  ...
  br i1 %exitcond.not, label %lor.rhs264.i, label %land.lhs.true240.i

lor.rhs264.i:                                     ; preds = %while.body.i, %if.end205.i
  %142 = load i32, ptr %error.i423, align 8
...
lor.end267.i:                                     ; preds = %land.rhs251.i
  %.pre446 = load i32, ptr %error.i423, align 8
...
seterr.exit110.sink.split:                        ; preds = %lor.end267.i, %lor.rhs264.i
  ...
  store i32 %.sink, ptr %error.i423, align 8
...
if.end277.i:                                      ; preds = %if.end4.i186, %doemit.exit230, %if.else271.i, %seterr.exit110, %cond.true227.i
  %.pre448 = load ptr, ptr %p, align 8
  %.pre449 = load ptr, ptr %end, align 8
...
p_simp_re.exit:                                   ; preds = %if.else271.i, %if.end277.i
  ...
  br i1 %cmp8, label %land.lhs.true14, label %while.end
...
while.end:                                        ; preds = %land.rhs24, %p_simp_re.exit
  ...
  %.pre451 = load i64, ptr %slen, align 8
...
if.then31:                                        ; preds = %while.end
  ...
  %146 = load i32, ptr %error.i73, align 8
...
if.end.i75:                                       ; preds = %if.then31
  ...
  %147 = load i64, ptr %ssize.i77, align 8
...
if.end.i.i88:                                     ; preds = %if.then2.i79
  ...
  %148 = load ptr, ptr %strip.i.i89, align 8
...
if.then2.i.i94:                                   ; preds = %if.end.i.i88
  %149 = load i32, ptr %error.i73, align 8
...
if.then.i.i.i98:                                  ; preds = %if.then2.i.i94
  store i32 12, ptr %error.i73, align 8
...
if.end4.i.i93:                                    ; preds = %if.end.i.i88
  store ptr %call.i.i91, ptr %strip.i.i89, align 8
  store i64 %mul.i82, ptr %ssize.i77, align 8
  br label %if.end4.i84
...
if.end4.i84:                                      ; preds = %if.end4.i.i93, %seterr.exit.i.i96, %if.then2.i79, %if.end.i75
  ...
  %150 = load ptr, ptr %strip.i85, align 8
  %151 = load i64, ptr %slen, align 8
  %inc.i86 = add nsw i64 %151, 1
  store i64 %inc.i86, ptr %slen, align 8
  %arrayidx.i87 = getelementptr inbounds i64, ptr %150, i64 %151
  store i64 536870912, ptr %arrayidx.i87, align 8
  %.pre450.pre = load i64, ptr %slen, align 8
...
for.inc:                                          ; preds = %if.end8, %if.then12
  ...
  %10 = load i64, ptr %arrayidx2.1, align 8
...
if.then12.8:                                      ; preds = %if.end8.8
  ...
  store i64 %inc16.8, ptr %arrayidx10.8, align 8
  br label %for.inc.8
...
for.inc.8:                                        ; preds = %if.then12.8, %if.end8.8
  ...
  %28 = load ptr, ptr %strip.i, align 8
  %arrayidx26 = getelementptr inbounds i64, ptr %28, i64 %pos
  store i64 %7, ptr %arrayidx26, align 8
  br label %cleanup
...
if.end4.i.i:                                      ; preds = %if.end.i.i
  store ptr %call.i.i, ptr %strip.i.i, align 8
  store i64 %mul.i, ptr %ssize.i, align 8
  %.pre654.pre = load ptr, ptr %p, align 8
  br label %if.end4.i
...
if.then13:                                        ; preds = %land.lhs.true9
  ...
  %10 = load i32, ptr %error.i395, align 8
...
if.end.i397:                                      ; preds = %if.then13
  ...
  %11 = load i64, ptr %slen.i398, align 8
  %ssize.i399 = getelementptr inbounds %struct.parse, ptr %p, i64 0, i32 4
  %12 = load i64, ptr %ssize.i399, align 8
...
if.end.i.i410:                                    ; preds = %if.then2.i401
  ...
  %13 = load ptr, ptr %strip.i.i411, align 8
...
if.then2.i.i416:                                  ; preds = %if.end.i.i410
  %14 = load i32, ptr %error.i395, align 8
...
if.then.i.i.i420:                                 ; preds = %if.then2.i.i416
  store i32 12, ptr %error.i395, align 8
...
if.end4.i.i415:                                   ; preds = %if.end.i.i410
  store ptr %call.i.i413, ptr %strip.i.i411, align 8
  store i64 %mul.i404, ptr %ssize.i399, align 8
  %.pre653.pre = load ptr, ptr %p, align 8
  br label %if.end4.i406
...
if.end4.i406:                                     ; preds = %if.end4.i.i415, %seterr.exit.i.i418, %if.then2.i401, %if.end.i397
  ...
  %15 = load ptr, ptr %strip.i407, align 8
  %16 = load i64, ptr %slen.i398, align 8
  %inc.i408 = add nsw i64 %16, 1
  store i64 %inc.i408, ptr %slen.i398, align 8
  %arrayidx.i409 = getelementptr inbounds i64, ptr %15, i64 %16
  store i64 2684354560, ptr %arrayidx.i409, align 8
...
if.then.i:                                        ; preds = %if.end16
  ...
  %22 = load ptr, ptr %sets.i, align 8
...
if.end.i426:                                      ; preds = %if.then.i
  ...
  store ptr %call.i, ptr %sets12.i, align 8
  %setbits.i = getelementptr inbounds %struct.re_guts, ptr %23, i64 0, i32 5
  %24 = load ptr, ptr %setbits.i, align 8
...
if.end18.i:                                       ; preds = %if.end.i426
  %25 = load ptr, ptr %g.i, align 8
  %setbits20.i = getelementptr inbounds %struct.re_guts, ptr %25, i64 0, i32 5
  store ptr %call14.i, ptr %setbits20.i, align 8
...
for.body.lr.ph.i:                                 ; preds = %if.end18.i
  ...
  %26 = load ptr, ptr %sets29.i, align 8
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i.new
  ...
  store ptr %add.ptr.i, ptr %arrayidx.i427, align 8
  ...
  store ptr %add.ptr.i.1, ptr %arrayidx.i427.1, align 8
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %cleanup.i.loopexit.unr-lcssa, label %for.body.i
...
for.body.i.epil:                                  ; preds = %cleanup.i.loopexit.unr-lcssa
  ...
  store ptr %add.ptr.i.epil, ptr %arrayidx.i427.epil, align 8
  br label %cleanup.i
...
if.end20:                                         ; preds = %cleanup.i, %if.end16
  ...
  %35 = load ptr, ptr %sets37.i, align 8
  ...
  %36 = load ptr, ptr %setbits41.i, align 8
  ...
  store ptr %add.ptr45.i, ptr %arrayidx39.i, align 8
  ...
  store i8 %conv47.i, ptr %mask.i, align 8
...
if.end76.sink.split:                              ; preds = %land.lhs.true35, %cond.true59
  ...
  store i8 %or69388, ptr %arrayidx, align 1
  %43 = load i8, ptr %hash.i, align 1
  %add73 = add i8 %43, %41
...
lor.rhs31.i:                                      ; preds = %lor.end.i, %lor.end.i
  %56 = load i32, ptr %error.i302.i, align 8
...
if.then.i289.i:                                   ; preds = %lor.rhs31.i
  store i32 4, ptr %error.i302.i, align 8
...
land.rhs.i.i:                                     ; preds = %while.body.i.i, %land.rhs.lr.ph.i.i
  ...
  %60 = load ptr, ptr %call.i.i445, align 8
  %61 = load i8, ptr %incdec.ptr8082.i.i, align 1
...
while.body.i.i:                                   ; preds = %land.rhs.i.i
  ...
  br i1 %exitcond.not.i.i, label %while.end.loopexit.i.i, label %land.rhs.i.i
...
land.lhs.true.i.i:                                ; preds = %while.end.i.i
  ...
  %66 = load i8, ptr %arrayidx13.i.i, align 1
...
land.lhs.true.1.i.i:                              ; preds = %for.inc.i.i
  ...
  %67 = load i8, ptr %arrayidx13.1.i.i, align 1
...
land.lhs.true.2.i.i:                              ; preds = %for.inc.1.i.i
  ...
  %68 = load i8, ptr %arrayidx13.2.i.i, align 1
...
land.lhs.true.3.i.i:                              ; preds = %for.inc.2.i.i
  ...
  %69 = load i8, ptr %arrayidx13.3.i.i, align 1
...
land.lhs.true.4.i.i:                              ; preds = %for.inc.3.i.i
  ...
  %70 = load i8, ptr %arrayidx13.4.i.i, align 1
...
land.lhs.true.5.i.i:                              ; preds = %for.inc.4.i.i
  ...
  %71 = load i8, ptr %arrayidx13.5.i.i, align 1
...
land.lhs.true.6.i.i:                              ; preds = %for.inc.5.i.i
  ...
  %72 = load i8, ptr %arrayidx13.6.i.i, align 1
...
land.lhs.true.7.i.i:                              ; preds = %for.inc.6.i.i
  ...
  %73 = load i8, ptr %arrayidx13.7.i.i, align 1
...
land.lhs.true.8.i.i:                              ; preds = %for.inc.7.i.i
  ...
  %74 = load i8, ptr %arrayidx13.8.i.i, align 1
...
land.lhs.true.9.i.i:                              ; preds = %for.inc.8.i.i
  ...
  %75 = load i8, ptr %arrayidx13.9.i.i, align 1
...
land.lhs.true.10.i.i:                             ; preds = %for.inc.9.i.i
  ...
  %76 = load i8, ptr %arrayidx13.10.i.i, align 1
...
land.lhs.true.11.i.i:                             ; preds = %for.inc.10.i.i
  ...
  %77 = load i8, ptr %arrayidx13.11.i.i, align 1
...
for.inc.11.i.i:                                   ; preds = %land.lhs.true.11.i.i, %for.inc.10.i.i
  %78 = load i32, ptr %error.i302.i, align 8
...
if.end23.i.i:                                     ; preds = %land.lhs.true.11.i.i, %land.lhs.true.10.i.i, %land.lhs.true.9.i.i, %land.lhs.true.8.i.i, %land.lhs.true.7.i.i, %land.lhs.true.6.i.i, %land.lhs.true.5.i.i, %land.lhs.true.4.i.i, %land.lhs.true.3.i.i, %land.lhs.true.2.i.i, %land.lhs.true.1.i.i, %land.lhs.true.i.i
  ...
  %79 = load ptr, ptr %chars.i.i, align 8
...
while.body29.i.i:                                 ; preds = %if.end23.i.i, %while.body29.i.i
  ...
  %82 = load i8, ptr %mask.i, align 8
  %83 = load ptr, ptr %arrayidx39.i, align 8
  %idxprom31.i.i = zext i8 %81 to i64
  %arrayidx32.i.i = getelementptr inbounds i8, ptr %83, i64 %idxprom31.i.i
  %84 = load i8, ptr %arrayidx32.i.i, align 1
  %or76.i.i = or i8 %84, %82
  store i8 %or76.i.i, ptr %arrayidx32.i.i, align 1
  %85 = load i8, ptr %hash.i, align 1
  %add.i.i = add i8 %85, %81
  store i8 %add.i.i, ptr %hash.i, align 1
  %86 = load i8, ptr %incdec.ptr25.i.i, align 1
  %cmp27.not.i.i = icmp eq i8 %86, 0
  br i1 %cmp27.not.i.i, label %while.end38.i.i, label %while.body29.i.i
...
while.end38.i.i:                                  ; preds = %while.body29.i.i, %if.end23.i.i
  ...
  %87 = load ptr, ptr %multis.i.i, align 8
...
for.body43.i.i:                                   ; preds = %while.end38.i.i, %mcadd.exit.i.i
  ...
  %89 = load i64, ptr %smultis.i, align 8
  ...
  %90 = load ptr, ptr %multis.i.i.i, align 8
...
if.then9.i.i.i:                                   ; preds = %if.end.i.i.i
  %91 = load ptr, ptr %multis.i.i.i, align 8
...
if.end13.i.i.i:                                   ; preds = %if.then11.i.i.i, %if.then9.i.i.i
  ...
  %92 = load i32, ptr %error.i302.i, align 8
...
if.then.i.i.i.i:                                  ; preds = %if.end13.i.i.i
  store i32 12, ptr %error.i302.i, align 8
...
if.end16.i.i.i:                                   ; preds = %if.end.i.i.i
  store ptr %np.0.i.i.i, ptr %multis.i.i.i, align 8
  ...
  %93 = load i64, ptr %smultis.i, align 8
...
mcadd.exit.i.i:                                   ; preds = %if.end16.i.i.i, %seterr.exit.i.i.i
  ...
  %94 = load i8, ptr %add.ptr.i.i, align 1
  %cmp41.not.i.i = icmp eq i8 %94, 0
  br i1 %cmp41.not.i.i, label %p_b_cclass.exit.i, label %for.body43.i.i
...
lor.rhs40.i:                                      ; preds = %p_b_cclass.exit.i
  %97 = load i32, ptr %error.i302.i, align 8
...
land.lhs.true60.i:                                ; preds = %land.lhs.true55.i
  %99 = load i8, ptr %add.ptr51.i, align 1
...
lor.rhs70.i:                                      ; preds = %land.lhs.true60.i, %land.lhs.true55.i, %land.lhs.true49.i
  %.pr = load i32, ptr %error.i302.i, align 8
...
lor.rhs82.i:                                      ; preds = %sw.bb75.i
  %100 = load i32, ptr %error.i302.i, align 8
...
lor.rhs95.i:                                      ; preds = %lor.end85.i, %lor.end85.i
  %104 = load i32, ptr %error.i302.i, align 8
...
land.lhs.true8.i.i.i:                             ; preds = %land.lhs.true.i.i.i
  %108 = load i8, ptr %add.ptr8284.i.i.i, align 1
...
land.rhs12.i.i.i:                                 ; preds = %land.lhs.true8.i.i.i
  %109 = load i8, ptr %add.ptr.i.i322.i, align 1
...
while.body.i.i.i:                                 ; preds = %land.rhs12.i.i.i, %land.lhs.true8.i.i.i, %land.lhs.true.i.i.i
  store ptr %add.ptr.i.i322.i, ptr %p, align 8
  %exitcond.not.i.i.i = icmp eq ptr %add.ptr.i.i322.i, %scevgep.i.i.i
  br i1 %exitcond.not.i.i.i, label %if.then.i.i312.i, label %land.lhs.true.i.i.i

if.then.i.i312.i:                                 ; preds = %while.body.i.i.i, %lor.end98.i
  %.pr660 = load i32, ptr %error.i302.i, align 8
...
seterr.exit.i.i315.i.sink.split:                  ; preds = %if.then.i.i312.i, %lor.rhs95.i
  ...
  store i32 %.sink696, ptr %error.i302.i, align 8
...
land.lhs.true33.i.i.i:                            ; preds = %for.body.i.i.i
  ...
  %111 = load i8, ptr %arrayidx.i.i.i, align 1
...
if.then38.i.i.i:                                  ; preds = %land.lhs.true33.i.i.i
  ...
  %112 = load i8, ptr %code.i.i.i, align 8
  br label %p_b_eclass.exit.i
...
for.inc.i.i.i:                                    ; preds = %land.lhs.true33.i.i.i, %for.body.i.i.i
  ...
  %113 = load ptr, ptr %incdec.ptr40.i.i.i, align 8
  %cmp26.not.i.i.i = icmp eq ptr %113, null
  br i1 %cmp26.not.i.i.i, label %for.end.i.i.i, label %for.body.i.i.i
...
if.end44.i.i.i:                                   ; preds = %for.end.i.i.i
  %116 = load i32, ptr %error.i302.i, align 8
...
if.then.i76.i.i.i:                                ; preds = %if.end44.i.i.i
  store i32 3, ptr %error.i302.i, align 8
...
p_b_eclass.exit.i:                                ; preds = %seterr.exit77.i.i.i, %if.then43.i.i.i, %if.then38.i.i.i, %seterr.exit.i.i315.i
  ...
  %117 = load i8, ptr %mask.i, align 8
  %118 = load ptr, ptr %arrayidx39.i, align 8
  %idxprom.i317.i = zext i8 %retval.0.i.i.i to i64
  %arrayidx.i318.i = getelementptr inbounds i8, ptr %118, i64 %idxprom.i317.i
  %119 = load i8, ptr %arrayidx.i318.i, align 1
  %or9.i.i = or i8 %119, %117
  store i8 %or9.i.i, ptr %arrayidx.i318.i, align 1
  %120 = load i8, ptr %hash.i, align 1
  %add.i320.i = add i8 %120, %retval.0.i.i.i
  store i8 %add.i320.i, ptr %hash.i, align 1
...
lor.rhs104.i:                                     ; preds = %p_b_eclass.exit.i
  %123 = load i32, ptr %error.i302.i, align 8
...
land.lhs.true124.i:                               ; preds = %land.lhs.true119.i
  %125 = load i8, ptr %add.ptr115.i, align 1
...
lor.rhs134.i:                                     ; preds = %land.lhs.true124.i, %land.lhs.true119.i, %land.lhs.true113.i
  %.pr662 = load i32, ptr %error.i302.i, align 8
...
land.lhs.true156.i:                               ; preds = %land.lhs.true150.i
  %129 = load i8, ptr %add.ptr152.i, align 1
...
land.lhs.true167.i:                               ; preds = %land.lhs.true156.i
  ...
  %130 = load i8, ptr %add.ptr152.i, align 1
...
lor.rhs184.i:                                     ; preds = %if.end179.i
  %131 = load i32, ptr %error.i302.i, align 8
...
for.body.i431.prol:                               ; preds = %for.body.lr.ph.i428
  ...
  %135 = load ptr, ptr %arrayidx39.i, align 8
  ...
  %137 = load i8, ptr %arrayidx.i432.prol, align 1
  %or280.i.prol = or i8 %137, %134
  store i8 %or280.i.prol, ptr %arrayidx.i432.prol, align 1
  %138 = load i8, ptr %hash.i, align 1
  %conv198.i.prol = add i8 %138, %call140.i
  store i8 %conv198.i.prol, ptr %hash.i, align 1
...
for.body.i431:                                    ; preds = %for.body.i431.prol.loopexit, %for.body.i431
  ...
  %140 = load i8, ptr %mask.i, align 8
  %141 = load ptr, ptr %arrayidx39.i, align 8
  %142 = and i32 %i.0351.i, 255
  %idxprom.i = zext i32 %142 to i64
  %arrayidx.i432 = getelementptr inbounds i8, ptr %141, i64 %idxprom.i
  %143 = load i8, ptr %arrayidx.i432, align 1
  %or280.i = or i8 %143, %140
  store i8 %or280.i, ptr %arrayidx.i432, align 1
  %144 = load i8, ptr %hash.i, align 1
...
p_b_term.exit:                                    ; preds = %p_b_term.exit.loopexit, %cond.true66.i, %cond.true130.i
  ...
  br i1 %cmp79, label %land.lhs.true81, label %if.end133

cond.true117:                                     ; preds = %land.rhs101
  store ptr %add.ptr92, ptr %p, align 8
  %154 = load i8, ptr %mask.i, align 8
  %155 = load ptr, ptr %arrayidx39.i, align 8
  %arrayidx125 = getelementptr inbounds i8, ptr %155, i64 45
  %156 = load i8, ptr %arrayidx125, align 1
  %or127390 = or i8 %156, %154
  store i8 %or127390, ptr %arrayidx125, align 1
  %157 = load i8, ptr %hash.i, align 1
  %add131 = add i8 %157, 45
  store i8 %add131, ptr %hash.i, align 1
  %.pre647 = load ptr, ptr %p, align 8
  %.pre648 = load ptr, ptr %end, align 8
  br label %if.end133
...
lor.rhs.sink.split:                               ; preds = %lor.rhs184.i, %lor.rhs104.i, %lor.rhs134.i, %lor.rhs40.i, %lor.rhs70.i, %sw.bb14.i
  ...
  store i32 %.sink697.sink, ptr %error.i302.i, align 8
  br label %lor.rhs
...
if.then147:                                       ; preds = %lor.end.thread, %lor.end
  ...
  %165 = load i32, ptr %csetsize.i456, align 8
...
for.body.i461:                                    ; preds = %for.body.i461, %for.body.i461.preheader.new
  ...
  br i1 %niter744.ncmp.1, label %for.end.i.loopexit.unr-lcssa, label %for.body.i461
...
for.body.i461.epil:                               ; preds = %for.end.i.loopexit.unr-lcssa
  %177 = load i8, ptr %mask.i, align 8
  %not.i.epil = xor i8 %177, -1
  %178 = load ptr, ptr %arrayidx39.i, align 8
  %idxprom6.i.epil = and i64 %i.026.i.unr, 255
  %arrayidx7.i.epil = getelementptr inbounds i8, ptr %178, i64 %idxprom6.i.epil
  %179 = load i8, ptr %arrayidx7.i.epil, align 1
  %and.i.epil = and i8 %179, %not.i.epil
  store i8 %and.i.epil, ptr %arrayidx7.i.epil, align 1
  %180 = load i8, ptr %hash.i, align 1
  %181 = trunc i64 %i.026.i.unr to i8
  %conv11.i.epil = sub i8 %180, %181
  store i8 %conv11.i.epil, ptr %hash.i, align 1
  br label %for.end.i
...
if.then150:                                       ; preds = %if.end148
  ...
  %186 = load i32, ptr %csetsize, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %188 = load ptr, ptr %arrayidx39.i, align 8
  %idxprom = and i64 %indvars.iv.next, 255
  %arrayidx156 = getelementptr inbounds i8, ptr %188, i64 %idxprom
  %189 = load i8, ptr %arrayidx156, align 1
  %190 = load i8, ptr %mask.i, align 8
...
if.then169:                                       ; preds = %land.lhs.true162
  ...
  %194 = load i16, ptr %arrayidx.i469, align 2
...
return.sink.split.i:                              ; preds = %if.then19.i, %if.then.i471
  ...
  %195 = load ptr, ptr %call30.sink.i, align 8
  %arrayidx32.i = getelementptr inbounds i32, ptr %195, i64 %idxprom
  %196 = load i32, ptr %arrayidx32.i, align 4
...
if.then174:                                       ; preds = %othercase.exit
  ...
  %197 = load i8, ptr %arrayidx180, align 1
  %or182393 = or i8 %197, %190
  store i8 %or182393, ptr %arrayidx180, align 1
  %198 = load i8, ptr %hash.i, align 1
...
for.inc:                                          ; preds = %for.body, %land.lhs.true162, %if.then174, %othercase.exit
  ...
  br i1 %cmp152, label %for.body, label %if.end194.loopexit

if.end194.loopexit:                               ; preds = %for.inc
  %p.val.pre651.pre = load ptr, ptr %g.i, align 8
  br label %if.end194
...
if.then196:                                       ; preds = %if.end194
  ...
  %199 = load i32, ptr %csetsize199, align 8
...
if.then214:                                       ; preds = %for.body204
  ...
  %204 = load i8, ptr %hash.i, align 1
...
if.else228:                                       ; preds = %for.body204
  ...
  %206 = load i8, ptr %hash.i, align 1
...
for.inc243:                                       ; preds = %if.then214, %if.else228
  ...
  br i1 %cmp202, label %for.body204, label %for.end245.loopexit

for.end245.loopexit:                              ; preds = %for.inc243
  %.pre650 = load ptr, ptr %g.i, align 8
  br label %for.end245
...
for.end245:                                       ; preds = %for.end245.loopexit, %if.then196
  ...
  %209 = load i32, ptr %cflags247, align 8
...
if.then250:                                       ; preds = %for.end245
  ...
  %not253 = xor i8 %210, -1
  %211 = load ptr, ptr %arrayidx39.i, align 8
  %arrayidx255 = getelementptr inbounds i8, ptr %211, i64 10
  %212 = load i8, ptr %arrayidx255, align 1
...
if.end269:                                        ; preds = %for.end245, %if.then250, %if.end194
  ...
  %p.val.val = load i32, ptr %214, align 8
...
for.body.lr.ph.i475:                              ; preds = %if.end269
  %215 = load ptr, ptr %arrayidx39.i, align 8
  %216 = load i8, ptr %mask.i, align 8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i8>, ptr %220, align 1
  %221 = getelementptr inbounds i8, ptr %220, i64 4
  %wide.load717 = load <4 x i8>, ptr %221, align 1
  ...
  br i1 %230, label %middle.block, label %vector.body
...
for.body.i477.prol:                               ; preds = %for.body.i477.preheader
  ...
  %233 = load i8, ptr %arrayidx.i479.prol, align 1
  %and10.i.prol = and i8 %233, %216
...
for.body.i477:                                    ; preds = %for.body.i477.prol.loopexit, %for.body.i477
  ...
  %236 = load i8, ptr %arrayidx.i479, align 1
  ...
  %237 = load i8, ptr %arrayidx.i479.1, align 1
  ...
  br i1 %exitcond.not.i482.1, label %nch.exit, label %for.body.i477
...
for.body.i487:                                    ; preds = %nch.exit, %for.inc.i
  ...
  %238 = load i8, ptr %arrayidx.i489, align 1
...
for.inc.i:                                        ; preds = %for.body.i487
  ...
  br i1 %exitcond.not.i496, label %firstch.exit, label %for.body.i487
...
firstch.exit:                                     ; preds = %for.inc.i, %if.then.i491
  ...
  %239 = load ptr, ptr %categories.i, align 8
  %cflags.i = getelementptr inbounds %struct.re_guts, ptr %p.val, i64 0, i32 6
  %240 = load i32, ptr %cflags.i, align 8
...
land.lhs.true.i:                                  ; preds = %firstch.exit
  ...
  %241 = load ptr, ptr %call.i500, align 8
  ...
  %242 = load i16, ptr %arrayidx.i503, align 2
...
if.end.i582:                                      ; preds = %if.else.i507
  ...
  %245 = load i64, ptr %slen.i583, align 8
  %ssize.i584 = getelementptr inbounds %struct.parse, ptr %p, i64 0, i32 4
  %246 = load i64, ptr %ssize.i584, align 8
...
if.end.i.i596:                                    ; preds = %if.then2.i586
  ...
  %247 = load ptr, ptr %strip.i.i597, align 8
...
if.then2.i.i602:                                  ; preds = %if.end.i.i596
  %248 = load i32, ptr %error, align 8
...
if.end4.i.i601:                                   ; preds = %if.end.i.i596
  store ptr %call.i.i599, ptr %strip.i.i597, align 8
  store i64 %mul.i589, ptr %ssize.i584, align 8
  br label %if.end4.i591
...
if.end4.i591:                                     ; preds = %if.end4.i.i601, %seterr.exit.i.i604, %if.then2.i586, %if.end.i582
  ...
  %250 = load ptr, ptr %strip.i593, align 8
  %251 = load i64, ptr %slen.i583, align 8
  %inc.i594 = add nsw i64 %251, 1
  store i64 %inc.i594, ptr %slen.i583, align 8
  %arrayidx.i595 = getelementptr inbounds i64, ptr %250, i64 %251
  store i64 %or.i592, ptr %arrayidx.i595, align 8
...
ordinary.exit:                                    ; preds = %if.then.i506, %doemit.exit607, %if.then17.i
  ...
  %258 = load i32, ptr %csetsize.i516, align 8
...
for.body.i522:                                    ; preds = %for.body.i522, %for.body.i522.preheader.new
  ...
  br i1 %niter750.ncmp.1, label %for.end.i531.loopexit.unr-lcssa, label %for.body.i522
...
for.body.i522.epil:                               ; preds = %for.end.i531.loopexit.unr-lcssa
  %270 = load i8, ptr %mask.i, align 8
  %not.i524.epil = xor i8 %270, -1
  %271 = load ptr, ptr %arrayidx39.i, align 8
  ...
  %272 = load i8, ptr %arrayidx7.i526.epil, align 1
  %and.i527.epil = and i8 %272, %not.i524.epil
  store i8 %and.i527.epil, ptr %arrayidx7.i526.epil, align 1
  %273 = load i8, ptr %hash.i, align 1
  %274 = trunc i64 %i.026.i523.unr to i8
  %conv11.i528.epil = sub i8 %273, %274
  store i8 %conv11.i528.epil, ptr %hash.i, align 1
...
for.body.us.i:                                    ; preds = %for.body.lr.ph.i547, %for.inc45.us.i
  ...
  %285 = load i8, ptr %hash7.us.i, align 1
...
for.body17.us.i:                                  ; preds = %for.cond14.preheader.us.i, %for.inc.us.i
  ...
  %286 = load i8, ptr %arrayidx20.us.i, align 1
  ...
  %287 = load i8, ptr %arrayidx27.us.i, align 1
...
for.inc.us.i:                                     ; preds = %for.body17.us.i
  ...
  br i1 %exitcond.not.i552, label %if.then49.i, label %for.body17.us.i
...
for.inc45.us.i:                                   ; preds = %for.end.us.i, %for.body.us.i
  ...
  br i1 %cmp.us.i, label %for.body.us.i, label %freezeset.exit

for.cond14.preheader.us.i:                        ; preds = %for.body.us.i
  %288 = load ptr, ptr %cs2.084.us.i, align 8
  %mask.us.i = getelementptr inbounds %struct.cset, ptr %cs2.084.us.i, i64 0, i32 1
  %289 = load i8, ptr %mask.us.i, align 8
  %290 = load ptr, ptr %arrayidx39.i, align 8
  %291 = load i8, ptr %mask.i, align 8
...
for.body.us85.i:                                  ; preds = %for.body.us85.i.preheader, %for.inc45.us91.i
  ...
  %292 = load i8, ptr %hash7.us87.i, align 1
...
for.inc45.us91.i:                                 ; preds = %for.body.us85.i
  ...
  br i1 %cmp.us93.i, label %for.body.us85.i, label %freezeset.exit
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.i.i.preheader.new
  ...
  br i1 %niter754.ncmp.1, label %for.end.i.loopexit.i.unr-lcssa, label %for.body.i.i
...
if.then.i.i551:                                   ; preds = %for.end.i.i
  ...
  %309 = load i32, ptr %ncsets15.i.i, align 4
...
freezeset.exit:                                   ; preds = %for.inc45.us.i, %for.inc45.us91.i, %if.else275.thread, %if.else275, %for.end.i.i, %if.then.i.i551
  ...
  %311 = load ptr, ptr %sets52.i, align 8
  ...
  %312 = load i32, ptr %error, align 8
...
if.end.i555:                                      ; preds = %freezeset.exit
  ...
  %313 = load i64, ptr %slen.i556, align 8
  %ssize.i557 = getelementptr inbounds %struct.parse, ptr %p, i64 0, i32 4
  %314 = load i64, ptr %ssize.i557, align 8
...
if.end.i.i568:                                    ; preds = %if.then2.i559
  ...
  %315 = load ptr, ptr %strip.i.i569, align 8
...
if.then2.i.i574:                                  ; preds = %if.end.i.i568
  %316 = load i32, ptr %error, align 8
...
if.end4.i.i573:                                   ; preds = %if.end.i.i568
  store ptr %call.i.i571, ptr %strip.i.i569, align 8
  store i64 %mul.i562, ptr %ssize.i557, align 8
  br label %if.end4.i564
...
if.end4.i564:                                     ; preds = %if.end4.i.i573, %seterr.exit.i.i576, %if.then2.i559, %if.end.i555
  ...
  %317 = load ptr, ptr %strip.i565, align 8
  %318 = load i64, ptr %slen.i556, align 8
  %inc.i566 = add nsw i64 %318, 1
  store i64 %inc.i566, ptr %slen.i556, align 8
  %arrayidx.i567 = getelementptr inbounds i64, ptr %317, i64 %318
  store i64 %or.i, ptr %arrayidx.i567, align 8
  br label %cleanup
...
return.sink.split.i:                              ; preds = %if.then19.i, %if.then.i
  ...
  %6 = load ptr, ptr %call30.sink.i, align 8
...
if.end.i:                                         ; preds = %if.else
  %slen.i = getelementptr inbounds %struct.parse, ptr %p, i64 0, i32 5
  %10 = load i64, ptr %slen.i, align 8
  %ssize.i = getelementptr inbounds %struct.parse, ptr %p, i64 0, i32 4
  %11 = load i64, ptr %ssize.i, align 8
...
if.end.i.i:                                       ; preds = %if.then2.i
  %strip.i.i = getelementptr inbounds %struct.parse, ptr %p, i64 0, i32 3
  %12 = load ptr, ptr %strip.i.i, align 8
  %mul.i.i = mul i64 %div.i, 24
...
if.end4.i:                                        ; preds = %if.end4.i.i, %seterr.exit.i.i, %if.then2.i, %if.end.i
  ...
  %strip.i = getelementptr inbounds %struct.parse, ptr %p, i64 0, i32 3
  %15 = load ptr, ptr %strip.i, align 8
  %16 = load i64, ptr %slen.i, align 8
  %inc.i = add nsw i64 %16, 1
  store i64 %inc.i, ptr %slen.i, align 8
  %arrayidx.i34 = getelementptr inbounds i64, ptr %15, i64 %16
  store i64 %or.i, ptr %arrayidx.i34, align 8
  br label %doemit.exit
...
if.then17:                                        ; preds = %doemit.exit
  ...
  %19 = load i32, ptr %ncategories, align 4
...
sw.bb:                                            ; preds = %if.end
  store i64 %start.tr469, ptr %slen, align 8
  br label %cleanup
...
if.end.i:                                         ; preds = %sw.bb13
  %4 = load i64, ptr %ssize.i384, align 8
...
if.end.i.i:                                       ; preds = %if.then2.i
  %5 = load ptr, ptr %strip.i.i394, align 8
  %mul.i.i = mul i64 %div.i, 24
  %call.i.i = tail call ptr @cli_realloc(ptr noundef %5, i64 noundef %mul.i.i) #11
  %cmp1.i.i = icmp eq ptr %call.i.i, null
...
doemit.exit.thread:                               ; preds = %if.end.i, %if.then2.i
  ...
  store i64 %or.i530, ptr %arrayidx.i532, align 8
  br label %if.end.i150

doemit.exit:                                      ; preds = %if.end.i.i
  store ptr %call.i.i, ptr %strip.i.i394, align 8
  store i64 %mul.i, ptr %ssize.i384, align 8
  %.pr.pre = load i32, ptr %error, align 8
...
if.end.i185:                                      ; preds = %doemit.exit174.thread, %doemit.exit174
  ...
  %25 = load i64, ptr %arrayidx.i179, align 8
  %and.i180 = and i64 %25, 4160749568
  %or.i181 = or i64 %and.i180, 1
  store i64 %or.i181, ptr %arrayidx.i179, align 8
  %26 = load i64, ptr %slen, align 8
  %27 = load i64, ptr %ssize.i384, align 8
...
seterr.exit.i.i206:                               ; preds = %if.then.i.i.i208, %if.then2.i.i204
  store ptr @nuls, ptr %p, align 8
  store ptr @nuls, ptr %end.i.i.i403, align 8
  %.pre522 = load ptr, ptr %strip.i.i394, align 8
  br label %if.end4.i194

if.end4.i.i203:                                   ; preds = %if.end.i.i198
  store ptr %call.i.i201, ptr %strip.i.i394, align 8
  store i64 %mul.i192, ptr %ssize.i384, align 8
  br label %if.end4.i194
...
if.end4.i194:                                     ; preds = %if.end4.i.i203, %seterr.exit.i.i206, %if.then2.i189, %if.end.i185
  ...
  store i64 %inc.i196, ptr %slen, align 8
  %arrayidx.i197 = getelementptr inbounds i64, ptr %29, i64 %30
  store i64 2415919106, ptr %arrayidx.i197, align 8
  br label %cleanup
...
if.end.i212:                                      ; preds = %sw.bb32
  %33 = load i64, ptr %ssize.i384, align 8
...
if.end.i.i226:                                    ; preds = %if.then2.i216
  %34 = load ptr, ptr %strip.i.i394, align 8
...
if.end4.i.i231:                                   ; preds = %if.end.i.i226
  store ptr %call.i.i229, ptr %strip.i.i394, align 8
  store i64 %mul.i219, ptr %ssize.i384, align 8
  %.pr413.pre = load i32, ptr %error, align 8
  br label %doemit.exit237
...
doemit.exit237:                                   ; preds = %if.end.i212, %if.then2.i216, %seterr.exit.i.i234, %if.end4.i.i231
  ...
  %36 = load ptr, ptr %strip.i.i394, align 8
  ...
  %.pre513 = load i64, ptr %slen, align 8
...
if.end.i248:                                      ; preds = %doemit.exit237
  ...
  %38 = load i64, ptr %arrayidx.i242, align 8
  %and.i243 = and i64 %38, 4160749568
  %or.i244 = or i64 %and.i243, %sub39
  store i64 %or.i244, ptr %arrayidx.i242, align 8
  %39 = load i64, ptr %slen, align 8
  %40 = load i64, ptr %ssize.i384, align 8
...
if.end.i283:                                      ; preds = %doemit.exit272.thread, %doemit.exit272
  ...
  %46 = load i64, ptr %arrayidx.i277, align 8
  %and.i278 = and i64 %46, 4160749568
  %or.i279 = or i64 %and.i278, 1
  store i64 %or.i279, ptr %arrayidx.i277, align 8
  %47 = load i64, ptr %slen, align 8
  %48 = load i64, ptr %ssize.i384, align 8
...
seterr.exit.i.i304:                               ; preds = %if.then.i.i.i306, %if.then2.i.i302
  store ptr @nuls, ptr %p, align 8
  store ptr @nuls, ptr %end.i.i.i403, align 8
  %.pre511 = load ptr, ptr %strip.i.i394, align 8
  br label %if.end4.i292

if.end4.i.i301:                                   ; preds = %if.end.i.i296
  store ptr %call.i.i299, ptr %strip.i.i394, align 8
  store i64 %mul.i290, ptr %ssize.i384, align 8
  br label %if.end4.i292
...
seterr.exit.i.i323:                               ; preds = %if.then.i.i.i325, %if.then2.i.i321
  store ptr @nuls, ptr %p, align 8
  store ptr @nuls, ptr %end.i.i.i403, align 8
  %.pre515 = load ptr, ptr %strip.i.i394, align 8
  br label %enlarge.exit.i

if.end4.i.i320:                                   ; preds = %if.end.i.i315
  store ptr %call.i.i318, ptr %strip.i.i394, align 8
  store i64 %add.i311, ptr %ssize.i384, align 8
  br label %enlarge.exit.i
...
if.end.i328:                                      ; preds = %sw.bb53
  %61 = load i64, ptr %ssize.i384, align 8
...
if.end.i.i342:                                    ; preds = %if.then2.i332
  %62 = load ptr, ptr %strip.i.i394, align 8
...
if.end4.i.i347:                                   ; preds = %if.end.i.i342
  store ptr %call.i.i345, ptr %strip.i.i394, align 8
  store i64 %mul.i335, ptr %ssize.i384, align 8
  br label %if.end4.i337

if.end4.i337:                                     ; preds = %if.end4.i.i347, %seterr.exit.i.i350, %if.then2.i332, %if.end.i328
  %or.i338 = or i64 %sub58, 1342177280
  %64 = load ptr, ptr %strip.i.i394, align 8
  %65 = load i64, ptr %slen, align 8
  %inc.i340 = add nsw i64 %65, 1
  store i64 %inc.i340, ptr %slen, align 8
  %arrayidx.i341 = getelementptr inbounds i64, ptr %64, i64 %65
  store i64 %or.i338, ptr %arrayidx.i341, align 8
  br label %cleanup
...
if.end.i356:                                      ; preds = %sw.bb59
  ...
  %66 = load i64, ptr %ssize.i384, align 8
  %add.i359 = add nsw i64 %66, %sub.i357
  %cmp.not.i.i360 = icmp sgt i64 %sub.i357, 0
  %.pre505 = load ptr, ptr %strip.i.i394, align 8
...
seterr.exit.i.i376:                               ; preds = %if.then.i.i.i378, %if.then2.i.i373
  store ptr @nuls, ptr %p, align 8
  store ptr @nuls, ptr %end.i.i.i403, align 8
  %.pre504 = load ptr, ptr %strip.i.i394, align 8
  br label %enlarge.exit.i361

if.end4.i.i372:                                   ; preds = %if.end.i.i367
  store ptr %call.i.i370, ptr %strip.i.i394, align 8
  store i64 %add.i359, ptr %ssize.i384, align 8
  br label %enlarge.exit.i361
...
enlarge.exit.i361:                                ; preds = %if.end4.i.i372, %seterr.exit.i.i376, %if.end.i356
  ...
  store i64 %add5.i366, ptr %slen, align 8
...
if.end.i382:                                      ; preds = %sw.bb63
  ...
  %71 = load i64, ptr %ssize.i384, align 8
  %add.i385 = add nsw i64 %71, %sub.i383
  %cmp.not.i.i386 = icmp sgt i64 %sub.i383, 0
  %.pre502 = load ptr, ptr %strip.i.i394, align 8
...
seterr.exit.i.i402:                               ; preds = %if.then.i.i.i404, %if.then2.i.i399
  store ptr @nuls, ptr %p, align 8
  store ptr @nuls, ptr %end.i.i.i403, align 8
  %.pre501 = load ptr, ptr %strip.i.i394, align 8
  br label %enlarge.exit.i387

if.end4.i.i398:                                   ; preds = %if.end.i.i393
  store ptr %call.i.i396, ptr %strip.i.i394, align 8
  store i64 %add.i385, ptr %ssize.i384, align 8
  br label %enlarge.exit.i387
...
enlarge.exit.i387:                                ; preds = %if.end4.i.i398, %seterr.exit.i.i402, %if.end.i382
  ...
  %75 = load i64, ptr %slen, align 8
  %add5.i392 = add nsw i64 %75, %sub.i383
  store i64 %add5.i392, ptr %slen, align 8
  %.pre503 = load i32, ptr %error, align 8
...
return.sink.split:                                ; preds = %if.then, %if.then19
  ...
  %2 = load ptr, ptr %call30.sink, align 8
  %arrayidx32 = getelementptr inbounds i32, ptr %2, i64 %idxprom
  %3 = load i32, ptr %arrayidx32, align 4
  br label %return
...
land.lhs.true8.i:                                 ; preds = %land.lhs.true.i
  %8 = load i8, ptr %add.ptr8284.i, align 1
...
while.body.i:                                     ; preds = %land.rhs12.i, %land.lhs.true8.i, %land.lhs.true.i
  ...
  br i1 %exitcond.not.i, label %if.then.i74, label %land.lhs.true.i
...
for.inc.i:                                        ; preds = %land.lhs.true33.i, %for.body.i
  ...
  %13 = load ptr, ptr %incdec.ptr40.i, align 8
...
land.lhs.true31:                                  ; preds = %land.lhs.true25
  %18 = load i8, ptr %add.ptr8284.i, align 1
...
lor.rhs46:                                        ; preds = %if.end44.i, %if.then.i76.i, %if.then.i74, %if.then.i.i, %p_b_coll_elem.exit, %land.lhs.true25, %land.lhs.true31, %land.lhs.true36
  ...
  %20 = load i32, ptr %error.i75, align 8
