...
while.cond.i:                                     ; preds = %if.end3.i, %while.cond.i
  ...
  br i1 %tobool.not.i, label %while.end.i, label %while.cond.i, !llvm.loop !14
...
while.body10.i:                                   ; preds = %if.end20.i, %while.end.i
  ...
  %5 = load ptr, ptr %t.addr.045.i, align 8, !tbaa !10
...
while.cond.i13:                                   ; preds = %if.end10.i, %while.cond.i13
  ...
  br i1 %tobool.not.i15, label %while.end.i16, label %while.cond.i13, !llvm.loop !16
...
while.body9.i40:                                  ; preds = %if.end17, %addToBlob.exit
  ...
  %5 = load ptr, ptr %t_text.addr.129.i41, align 8, !tbaa !10
...
addToBlob.exit:                                   ; preds = %while.body9.i40, %if.then.i54
  ...
  %6 = load ptr, ptr %t_next11.i42, align 8, !tbaa !5
  %tobool8.not.i43 = icmp eq ptr %6, null
  br i1 %tobool8.not.i43, label %textIterate.exit44, label %while.body9.i40, !llvm.loop !18
...
if.end.i47:                                       ; preds = %if.then.i, %while.body.i45
  ...
  br i1 %tobool.not.i48, label %textDestroy.exit, label %while.body.i45, !llvm.loop !11
...
if.end.i24:                                       ; preds = %if.then.i, %while.body.i22
  ...
  br i1 %tobool.not.i25, label %textDestroy.exit, label %while.body.i22, !llvm.loop !11
