; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_text.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_text.c"
...
while.body:                                       ; preds = %entry, %if.end
  ...
  %0 = load ptr, ptr %t_next1, align 8
  %1 = load ptr, ptr %t_head.addr.09, align 8
...
if.else.i.i:                                      ; preds = %while.body.i.i
  ...
  store ptr %call.i.i, ptr %t_next.i.i, align 8
  br label %if.end.i.i
...
while.body.i.i.i:                                 ; preds = %if.then4.i.i, %if.end.i.i.i
  ...
  %0 = load ptr, ptr %t_next1.i.i.i, align 8
  %1 = load ptr, ptr %t_head.addr.09.i.i.i, align 8
...
if.end.i.i.i:                                     ; preds = %if.then.i.i.i, %while.body.i.i.i
  ...
  br i1 %tobool.not.i.i.i, label %return, label %while.body.i.i.i

if.end8.i.i:                                      ; preds = %if.end.i.i
  %2 = load ptr, ptr %t_head.addr.038.i.i, align 8
...
if.then19.i.i:                                    ; preds = %while.end.i.i
  ...
  store ptr null, ptr %t_next20.i.i, align 8
  br label %return
...
while.cond.i:                                     ; preds = %if.end3.i, %while.cond.i
  ...
  %4 = load ptr, ptr %t_next.i, align 8
...
while.body10.i:                                   ; preds = %if.end20.i, %while.end.i
  %t.addr.045.i = phi ptr [ %call1, %while.end.i ], [ %6, %if.end20.i ]
  %t_head.addr.144.i = phi ptr [ %t_head.addr.0.i, %while.end.i ], [ %call11.i, %if.end20.i ]
  %call11.i = tail call ptr @cli_malloc(i64 noundef 16) #5
  %t_next12.i = getelementptr inbounds %struct.text, ptr %t_head.addr.144.i, i64 0, i32 1
  store ptr %call11.i, ptr %t_next12.i, align 8
  %5 = load ptr, ptr %t.addr.045.i, align 8
...
if.end20.i:                                       ; preds = %if.then15.i, %while.body10.i
  ...
  store ptr %storemerge.i, ptr %call11.i, align 8
  %t_next21.i = getelementptr inbounds %struct.text, ptr %t.addr.045.i, i64 0, i32 1
  %6 = load ptr, ptr %t_next21.i, align 8
  %tobool9.not.i = icmp eq ptr %6, null
  br i1 %tobool9.not.i, label %while.end22.i, label %while.body10.i

while.end22.i:                                    ; preds = %if.end20.i
  %t_next23.i = getelementptr inbounds %struct.text, ptr %call11.i, i64 0, i32 1
  store ptr null, ptr %t_next23.i, align 8
  br label %return
...
if.end10.i:                                       ; preds = %if.else
  ...
  br i1 %cmp1.i12, label %return, label %while.cond.i13

while.cond.i13:                                   ; preds = %if.end10.i, %while.cond.i13
  %t_head.addr.0.i14 = phi ptr [ %7, %while.cond.i13 ], [ %aText, %if.end10.i ]
  %t_next14.i = getelementptr inbounds %struct.text, ptr %t_head.addr.0.i14, i64 0, i32 1
  %7 = load ptr, ptr %t_next14.i, align 8
  %tobool.not.i15 = icmp eq ptr %7, null
  br i1 %tobool.not.i15, label %while.end.i16, label %while.cond.i13

while.end.i16:                                    ; preds = %while.cond.i13
  %t_next14.i.le = getelementptr inbounds %struct.text, ptr %t_head.addr.0.i14, i64 0, i32 1
  %call16.i = tail call ptr @cli_malloc(i64 noundef 16) #5
  store ptr %call16.i, ptr %t_next14.i.le, align 8
  %cmp19.i = icmp eq ptr %call16.i, null
  br i1 %cmp19.i, label %return, label %if.end21.i

if.end21.i:                                       ; preds = %while.end.i16
...
if.then25.i:                                      ; preds = %if.end21.i
  store ptr %8, ptr %call16.i, align 8
  br label %if.end30.i

if.end30.i:                                       ; preds = %if.then25.i, %if.end21.i
  %call16.sink.i = phi ptr [ %call3, %if.then25.i ], [ %call16.i, %if.end21.i ]
  store ptr null, ptr %call16.sink.i, align 8
  %t_next31.i = getelementptr inbounds %struct.text, ptr %call3, i64 0, i32 1
  %9 = load ptr, ptr %t_next31.i, align 8
  %t_next32.i = getelementptr inbounds %struct.text, ptr %call16.i, i64 0, i32 1
  store ptr %9, ptr %t_next32.i, align 8
  store ptr null, ptr %t_next31.i, align 8
  br label %return

return:                                           ; preds = %if.end.i.i.i, %if.end30.i, %while.end.i16, %if.end10.i, %while.end22.i, %if.end3.i, %if.then19.i.i, %while.end.i.i, %if.then4.i.i, %if.then2.i, %if.else
  %retval.1 = phi ptr [ %call3, %if.else ], [ null, %if.then2.i ], [ %aText, %while.end22.i ], [ %aText, %if.end3.i ], [ null, %if.then4.i.i ], [ %first.1.i.i, %if.then19.i.i ], [ null, %while.end.i.i ], [ %aText, %if.end30.i ], [ %aText, %if.end10.i ], [ null, %while.end.i16 ], [ null, %if.end.i.i.i ]
  ret ptr %retval.1
}
...
while.cond:                                       ; preds = %if.end10, %while.cond
  ...
  %1 = load ptr, ptr %t_next14, align 8
...
while.end:                                        ; preds = %while.cond
  ...
  store ptr %call16, ptr %t_next14.le, align 8
...
while.body9.i:                                    ; preds = %entry, %getLength.exit
  ...
  %0 = load ptr, ptr %t_text.addr.129.i, align 8
  %tobool.not.i49 = icmp eq ptr %0, null
  br i1 %tobool.not.i49, label %getLength.exit, label %if.then.i50

if.then.i50:                                      ; preds = %while.body9.i
  %call.i51 = tail call ptr @lineGetData(ptr noundef nonnull %0) #5
  %call1.i = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call.i51) #6
  %add.i = add i64 %call1.i, 1
  br label %getLength.exit

getLength.exit:                                   ; preds = %while.body9.i, %if.then.i50
  %.sink5.i = phi i64 [ %s.0, %if.then.i50 ], [ 1, %while.body9.i ]
  %.sink.i = phi i64 [ %add.i, %if.then.i50 ], [ %s.0, %while.body9.i ]
  %inc.i = add i64 %.sink.i, %.sink5.i
  %t_next11.i = getelementptr inbounds %struct.text, ptr %t_text.addr.129.i, i64 0, i32 1
  %1 = load ptr, ptr %t_next11.i, align 8
  %tobool8.not.i = icmp eq ptr %1, null
  br i1 %tobool8.not.i, label %textIterate.exit, label %while.body9.i
...
if.end17:                                         ; preds = %if.end10
  ...
  br i1 %tobool.not.i, label %while.body9.i40, label %while.body.i

while.body.i:                                     ; preds = %if.end17, %if.end.i
  %t_text.addr.027.i = phi ptr [ %4, %if.end.i ], [ %t, %if.end17 ]
  %2 = load ptr, ptr %t_text.addr.027.i, align 8
  %tobool.not.i58 = icmp eq ptr %2, null
  br i1 %tobool.not.i58, label %addToBlob.exit65, label %if.then.i59

if.then.i59:                                      ; preds = %while.body.i
  %call.i60 = tail call ptr @lineGetData(ptr noundef nonnull %2) #5
  %call1.i61 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call.i60) #6
  %call2.i62 = tail call i32 @blobAddData(ptr noundef nonnull %b.addr.0, ptr noundef %call.i60, i64 noundef %call1.i61) #5
  br label %addToBlob.exit65

addToBlob.exit65:                                 ; preds = %while.body.i, %if.then.i59
  %call3.i64 = tail call i32 @blobAddData(ptr noundef nonnull %b.addr.0, ptr noundef nonnull @.str.6, i64 noundef 1) #5
  %3 = load ptr, ptr %t_text.addr.027.i, align 8
...
if.then4.i:                                       ; preds = %addToBlob.exit65
  ...
  store ptr null, ptr %t_text.addr.027.i, align 8
  br label %if.end.i
...
if.end.i:                                         ; preds = %if.then4.i, %addToBlob.exit65
  ...
  br i1 %tobool1.not.i, label %textIterate.exit44, label %while.body.i

while.body9.i40:                                  ; preds = %if.end17, %addToBlob.exit
  %t_text.addr.129.i41 = phi ptr [ %6, %addToBlob.exit ], [ %t, %if.end17 ]
  %5 = load ptr, ptr %t_text.addr.129.i41, align 8
  %tobool.not.i53 = icmp eq ptr %5, null
  br i1 %tobool.not.i53, label %addToBlob.exit, label %if.then.i54

if.then.i54:                                      ; preds = %while.body9.i40
  %call.i55 = tail call ptr @lineGetData(ptr noundef nonnull %5) #5
  %call1.i56 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call.i55) #6
  %call2.i = tail call i32 @blobAddData(ptr noundef nonnull %b.addr.0, ptr noundef %call.i55, i64 noundef %call1.i56) #5
  br label %addToBlob.exit

addToBlob.exit:                                   ; preds = %while.body9.i40, %if.then.i54
  %call3.i = tail call i32 @blobAddData(ptr noundef nonnull %b.addr.0, ptr noundef nonnull @.str.6, i64 noundef 1) #5
  %t_next11.i42 = getelementptr inbounds %struct.text, ptr %t_text.addr.129.i41, i64 0, i32 1
  %6 = load ptr, ptr %t_next11.i42, align 8
  %tobool8.not.i43 = icmp eq ptr %6, null
  br i1 %tobool8.not.i43, label %textIterate.exit44, label %while.body9.i40
...
land.lhs.true:                                    ; preds = %textIterate.exit44
  ...
  %7 = load ptr, ptr %t_next, align 8
  %tobool19.not = icmp eq ptr %7, null
  br i1 %tobool19.not, label %if.end23, label %while.body.i45

while.body.i45:                                   ; preds = %land.lhs.true, %if.end.i47
  %t_head.addr.09.i = phi ptr [ %8, %if.end.i47 ], [ %7, %land.lhs.true ]
  %t_next1.i = getelementptr inbounds %struct.text, ptr %t_head.addr.09.i, i64 0, i32 1
  %8 = load ptr, ptr %t_next1.i, align 8
  %9 = load ptr, ptr %t_head.addr.09.i, align 8
  %tobool2.not.i = icmp eq ptr %9, null
  br i1 %tobool2.not.i, label %if.end.i47, label %if.then.i

if.then.i:                                        ; preds = %while.body.i45
  %call.i46 = tail call ptr @lineUnlink(ptr noundef nonnull %9) #5
  br label %if.end.i47

if.end.i47:                                       ; preds = %if.then.i, %while.body.i45
  tail call void @free(ptr noundef nonnull %t_head.addr.09.i) #5
  %tobool.not.i48 = icmp eq ptr %8, null
  br i1 %tobool.not.i48, label %textDestroy.exit, label %while.body.i45

textDestroy.exit:                                 ; preds = %if.end.i47
  store ptr null, ptr %t_next, align 8
  br label %if.end23

if.end23:                                         ; preds = %textDestroy.exit, %land.lhs.true, %textIterate.exit44
  tail call void @blobClose(ptr noundef nonnull %b.addr.0) #5
  br label %cleanup
...
while.body.i:                                     ; preds = %while.cond.preheader.i, %if.end.i
  ...
  %0 = load ptr, ptr %t_text.addr.027.i, align 8
  %tobool.not.i30 = icmp eq ptr %0, null
  br i1 %tobool.not.i30, label %addToFileblob.exit37, label %if.then.i31

if.then.i31:                                      ; preds = %while.body.i
  %call.i32 = tail call ptr @lineGetData(ptr noundef nonnull %0) #5
  %call1.i33 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call.i32) #6
  %call2.i34 = tail call i32 @fileblobAddData(ptr noundef nonnull %fb.addr.0, ptr noundef %call.i32, i64 noundef %call1.i33) #5
  br label %addToFileblob.exit37

addToFileblob.exit37:                             ; preds = %while.body.i, %if.then.i31
  %call3.i36 = tail call i32 @fileblobAddData(ptr noundef nonnull %fb.addr.0, ptr noundef nonnull @.str.6, i64 noundef 1) #5
  %1 = load ptr, ptr %t_text.addr.027.i, align 8
...
if.end.i:                                         ; preds = %if.then4.i, %addToFileblob.exit37
  %t_next.i = getelementptr inbounds %struct.text, ptr %t_text.addr.027.i, i64 0, i32 1
  %2 = load ptr, ptr %t_next.i, align 8
  %tobool1.not.i = icmp eq ptr %2, null
  br i1 %tobool1.not.i, label %textIterate.exit, label %while.body.i
...
while.body9.i:                                    ; preds = %while.cond7.preheader.i, %addToFileblob.exit
  ...
  %3 = load ptr, ptr %t_text.addr.129.i, align 8
  %tobool.not.i26 = icmp eq ptr %3, null
  br i1 %tobool.not.i26, label %addToFileblob.exit, label %if.then.i27

if.then.i27:                                      ; preds = %while.body9.i
  %call.i28 = tail call ptr @lineGetData(ptr noundef nonnull %3) #5
  %call1.i = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call.i28) #6
  %call2.i = tail call i32 @fileblobAddData(ptr noundef nonnull %fb.addr.0, ptr noundef %call.i28, i64 noundef %call1.i) #5
  br label %addToFileblob.exit

addToFileblob.exit:                               ; preds = %while.body9.i, %if.then.i27
  %call3.i = tail call i32 @fileblobAddData(ptr noundef nonnull %fb.addr.0, ptr noundef nonnull @.str.6, i64 noundef 1) #5
  %t_next11.i = getelementptr inbounds %struct.text, ptr %t_text.addr.129.i, i64 0, i32 1
  %4 = load ptr, ptr %t_next11.i, align 8
...
land.lhs.true:                                    ; preds = %while.cond.preheader.i, %textIterate.exit
  %t_next = getelementptr inbounds %struct.text, ptr %t, i64 0, i32 1
  %5 = load ptr, ptr %t_next, align 8
  %tobool6.not = icmp eq ptr %5, null
  br i1 %tobool6.not, label %return, label %while.body.i22

while.body.i22:                                   ; preds = %land.lhs.true, %if.end.i24
  %t_head.addr.09.i = phi ptr [ %6, %if.end.i24 ], [ %5, %land.lhs.true ]
  %t_next1.i = getelementptr inbounds %struct.text, ptr %t_head.addr.09.i, i64 0, i32 1
  %6 = load ptr, ptr %t_next1.i, align 8
  %7 = load ptr, ptr %t_head.addr.09.i, align 8
  %tobool2.not.i = icmp eq ptr %7, null
  br i1 %tobool2.not.i, label %if.end.i24, label %if.then.i

if.then.i:                                        ; preds = %while.body.i22
  %call.i23 = tail call ptr @lineUnlink(ptr noundef nonnull %7) #5
  br label %if.end.i24

if.end.i24:                                       ; preds = %if.then.i, %while.body.i22
  tail call void @free(ptr noundef nonnull %t_head.addr.09.i) #5
  %tobool.not.i25 = icmp eq ptr %6, null
  br i1 %tobool.not.i25, label %textDestroy.exit, label %while.body.i22

textDestroy.exit:                                 ; preds = %if.end.i24
  store ptr null, ptr %t_next, align 8
  br label %return
