; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_regex_strlcpy.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_regex_strlcpy.c"
...
while.body:                                       ; preds = %while.cond
  ...
  %cmp3 = icmp eq i8 %0, 0
  br i1 %cmp3, label %if.end18, label %while.cond
...
while.cond14:                                     ; preds = %while.cond14.preheader, %while.cond14
  ...
  br i1 %tobool.not, label %if.end18, label %while.cond14
