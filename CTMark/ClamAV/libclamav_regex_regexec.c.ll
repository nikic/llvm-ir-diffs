; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_regex_regexec.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_regex_regexec.c"
...
for.body.i:                                       ; preds = %for.inc.i, %for.body.lr.ph.i
  ...
  %12 = load i8, ptr %dp.0389.i, align 1
...
land.lhs.true66.land.lhs.true69_crit_edge.i.i:    ; preds = %land.lhs.true66.i.i
  ...
  %.pre.i = load ptr, ptr %.pre241.i.i, align 8
...
land.lhs.true69.i.i:                              ; preds = %land.lhs.true66.land.lhs.true69_crit_edge.i.i, %land.lhs.true58.i.i
  ...
  %28 = load i16, ptr %arrayidx72.i.i, align 2
  %29 = and i16 %28, 8
...
if.end80.land.lhs.true83_crit_edge.i.i:           ; preds = %if.end80.i.i
  ...
  %.pre405.i = load ptr, ptr %.pre.i.i, align 8
  %arrayidx86.i.phi.trans.insert.i = getelementptr inbounds i16, ptr %.pre405.i, i64 %.pre240.i.i
  %.pre406.i = load i16, ptr %arrayidx86.i.phi.trans.insert.i, align 2
  %.pre409.i = and i16 %.pre406.i, 8
  br label %land.lhs.true83.i.i

land.lhs.true83.i.i:                              ; preds = %if.end80.land.lhs.true83_crit_edge.i.i, %land.lhs.true58.i.i
  %.pre-phi.i = phi i16 [ %.pre409.i, %if.end80.land.lhs.true83_crit_edge.i.i ], [ %26, %land.lhs.true58.i.i ]
  %30 = phi ptr [ %.pre405.i, %if.end80.land.lhs.true83_crit_edge.i.i ], [ %24, %land.lhs.true58.i.i ]
...
land.lhs.true99.i.i:                              ; preds = %lor.lhs.false96.i.i
  ...
  %31 = load i16, ptr %arrayidx102.i.i, align 2
  %32 = and i16 %31, 8
...
if.end119.i.i:                                    ; preds = %if.then116.i.i, %if.end110.i.i
  ...
  %or.cond.i.i = or i1 %cmp125.i.i, %cmp122.not.i.i
...
sfast.exit.i:                                     ; preds = %if.end119.i.i
  store ptr %spec.select.i.i, ptr %coldp132.i.i, align 8
...
if.end59.i:                                       ; preds = %if.end53.i, %if.end59.i
  ...
  store ptr %incdec.ptr61.i, ptr %coldp132.i.i, align 8
...
land.lhs.true65.i:                                ; preds = %for.end62.i
  %39 = load i32, ptr %backrefs.i, align 8
...
if.end184.thread.i:                               ; preds = %land.lhs.true65.i
  %40 = load ptr, ptr %offp.i, align 8
  %sub.ptr.lhs.cast173412.i = ptrtoint ptr %38 to i64
  %sub.ptr.rhs.cast174413.i = ptrtoint ptr %40 to i64
  %sub.ptr.sub175414.i = sub i64 %sub.ptr.lhs.cast173412.i, %sub.ptr.rhs.cast174413.i
  store i64 %sub.ptr.sub175414.i, ptr %pmatch, align 8
  %sub.ptr.lhs.cast179415.i = ptrtoint ptr %call55.lcssa.i to i64
  %sub.ptr.sub181416.i = sub i64 %sub.ptr.lhs.cast179415.i, %sub.ptr.rhs.cast174413.i
  %rm_eo183417.i = getelementptr inbounds %struct.regmatch_t, ptr %pmatch, i64 0, i32 1
  store i64 %sub.ptr.sub181416.i, ptr %rm_eo183417.i, align 8
  br label %if.end209.i

if.end69.i:                                       ; preds = %land.lhs.true65.i, %for.end62.i
  %41 = load ptr, ptr %pmatch37.i, align 8
...
for.body89.preheader.i:                           ; preds = %for.cond84.preheader.i
  ...
  %47 = shl i64 %umax.i, 4
  %48 = add i64 %47, -16
  call void @llvm.memset.p0.i64(ptr align 8 %scevgep.i, i8 -1, i64 %48, i1 false)
  br label %for.end97.i

for.end97.i:                                      ; preds = %for.body89.preheader.i, %for.cond84.preheader.i
  %49 = load i32, ptr %backrefs.i, align 8
...
land.lhs.true100.i:                               ; preds = %for.end97.i
  %50 = load i32, ptr %eflags36.i, align 8
...
if.then104.i:                                     ; preds = %land.lhs.true100.i
  %51 = load ptr, ptr %coldp132.i.i, align 8
...
if.else107.i:                                     ; preds = %land.lhs.true100.i, %for.end97.i
  %52 = load i64, ptr %nplus.i, align 8
...
if.then128.i:                                     ; preds = %if.end120.i
  %56 = load ptr, ptr %pmatch37.i, align 8
  call void @free(ptr noundef %56) #15
  br label %smatcher.exit

if.end130.i:                                      ; preds = %if.end120.i
  %57 = load ptr, ptr %coldp132.i.i, align 8
...
lor.lhs.false.i:                                  ; preds = %if.end133.i, %if.end152.i
  ...
  %58 = load ptr, ptr %coldp132.i.i, align 8
...
if.end184.i:                                      ; preds = %for.end167.i
  %.pre408.i = load ptr, ptr %coldp132.i.i, align 8
  %59 = load ptr, ptr %offp.i, align 8
  %sub.ptr.lhs.cast173.i = ptrtoint ptr %.pre408.i to i64
...
for.body191.i:                                    ; preds = %for.inc206.i, %for.cond188.preheader.i
  %i.1397.i = phi i64 [ 1, %for.cond188.preheader.i ], [ %inc207.i, %for.inc206.i ]
  %62 = load i64, ptr %nsub193.i, align 8
  %cmp194.not.i = icmp ugt i64 %i.1397.i, %62
  %arrayidx201.i = getelementptr inbounds %struct.regmatch_t, ptr %pmatch, i64 %i.1397.i
  br i1 %cmp194.not.i, label %if.else200.i, label %if.then196.i

if.then196.i:                                     ; preds = %for.body191.i
  %arrayidx199.i = getelementptr inbounds %struct.regmatch_t, ptr %61, i64 %i.1397.i
...
for.inc206.i:                                     ; preds = %if.else200.i, %if.then196.i
  %inc207.i = add nuw i64 %i.1397.i, 1
  %exitcond.not.i = icmp eq i64 %inc207.i, %spec.select.i
  br i1 %exitcond.not.i, label %if.end209.i, label %for.body191.i

if.end209.i:                                      ; preds = %land.lhs.true50.i, %for.inc206.i, %if.end184.i, %for.end167.i, %if.end184.thread.i
  %63 = load ptr, ptr %pmatch37.i, align 8
  %cmp211.not.i = icmp eq ptr %63, null
...
if.end215.i:                                      ; preds = %if.then213.i, %if.end209.i
  %64 = load ptr, ptr %lastpos.i, align 8
  %cmp217.not.i = icmp eq ptr %64, null
...
if.else:                                          ; preds = %if.end3
  ...
  %65 = load i64, ptr %firststate.i, align 8
  %add.i23 = add nsw i64 %65, 1
  %66 = load i64, ptr %laststate.i, align 8
  %67 = load i32, ptr %cflags.i, align 8
  %and.i26 = and i32 %67, 4
  %tobool.not.i27 = icmp eq i32 %and.i26, 0
  %spec.select.i28 = select i1 %tobool.not.i27, i64 %nmatch, i64 0
  br i1 %tobool2.not.i, label %if.else.i121, label %if.then3.i31

if.then3.i31:                                     ; preds = %if.else
  %68 = load i64, ptr %pmatch, align 8
  %add.ptr.i32 = getelementptr inbounds i8, ptr %string, i64 %68
  %rm_eo.i33 = getelementptr inbounds %struct.regmatch_t, ptr %pmatch, i64 0, i32 1
  %69 = load i64, ptr %rm_eo.i33, align 8
  br label %if.end7.i34

if.else.i121:                                     ; preds = %if.else
  %call.i122 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %string) #16
  br label %if.end7.i34

if.end7.i34:                                      ; preds = %if.else.i121, %if.then3.i31
  %start.0.i35 = phi ptr [ %add.ptr.i32, %if.then3.i31 ], [ %string, %if.else.i121 ]
  %.pn.i36 = phi i64 [ %69, %if.then3.i31 ], [ %call.i122, %if.else.i121 ]
  %stop.0.i37 = getelementptr inbounds i8, ptr %string, i64 %.pn.i36
  %cmp.i38 = icmp ult ptr %stop.0.i37, %start.0.i35
  br i1 %cmp.i38, label %lmatcher.exit, label %if.end9.i39

if.end9.i39:                                      ; preds = %if.end7.i34
  %must.i40 = getelementptr inbounds %struct.re_guts, ptr %0, i64 0, i32 15
  %70 = load ptr, ptr %must.i40, align 8
  %cmp10.not.i41 = icmp eq ptr %70, null
  br i1 %cmp10.not.i41, label %if.end34.i46, label %for.cond.preheader.i42

for.cond.preheader.i42:                           ; preds = %if.end9.i39
  %cmp12451.i = icmp ult ptr %start.0.i35, %stop.0.i37
  br i1 %cmp12451.i, label %for.body.lr.ph.i105, label %for.end.i43

for.body.lr.ph.i105:                              ; preds = %for.cond.preheader.i42
  %71 = load i8, ptr %70, align 1
  %sub.ptr.lhs.cast.i106 = ptrtoint ptr %stop.0.i37 to i64
  %mlen.i107 = getelementptr inbounds %struct.re_guts, ptr %0, i64 0, i32 16
  br label %for.body.i108

for.body.i108:                                    ; preds = %for.inc.i110, %for.body.lr.ph.i105
  %dp.0452.i = phi ptr [ %start.0.i35, %for.body.lr.ph.i105 ], [ %incdec.ptr.i111, %for.inc.i110 ]
  %72 = load i8, ptr %dp.0452.i, align 1
  %cmp16.i109 = icmp eq i8 %72, %71
  br i1 %cmp16.i109, label %land.lhs.true.i113, label %for.inc.i110

land.lhs.true.i113:                               ; preds = %for.body.i108
  %sub.ptr.rhs.cast.i114 = ptrtoint ptr %dp.0452.i to i64
  %sub.ptr.sub.i115 = sub i64 %sub.ptr.lhs.cast.i106, %sub.ptr.rhs.cast.i114
  %73 = load i32, ptr %mlen.i107, align 8
  %conv18.i116 = sext i32 %73 to i64
  %cmp19.not.i117 = icmp slt i64 %sub.ptr.sub.i115, %conv18.i116
  br i1 %cmp19.not.i117, label %for.inc.i110, label %land.lhs.true21.i118

land.lhs.true21.i118:                             ; preds = %land.lhs.true.i113
  %bcmp.i119 = tail call i32 @bcmp(ptr nonnull %dp.0452.i, ptr nonnull %70, i64 %conv18.i116)
  %cmp26.i120 = icmp eq i32 %bcmp.i119, 0
  br i1 %cmp26.i120, label %for.end.i43, label %for.inc.i110

for.inc.i110:                                     ; preds = %land.lhs.true21.i118, %land.lhs.true.i113, %for.body.i108
  %incdec.ptr.i111 = getelementptr inbounds i8, ptr %dp.0452.i, i64 1
  %cmp12.i112 = icmp ult ptr %incdec.ptr.i111, %stop.0.i37
  br i1 %cmp12.i112, label %for.body.i108, label %for.end.i43

for.end.i43:                                      ; preds = %for.inc.i110, %land.lhs.true21.i118, %for.cond.preheader.i42
  %dp.0.lcssa.i44 = phi ptr [ %start.0.i35, %for.cond.preheader.i42 ], [ %incdec.ptr.i111, %for.inc.i110 ], [ %dp.0452.i, %land.lhs.true21.i118 ]
  %cmp30.i45 = icmp eq ptr %dp.0.lcssa.i44, %stop.0.i37
  br i1 %cmp30.i45, label %lmatcher.exit, label %if.end34.i46

if.end34.i46:                                     ; preds = %for.end.i43, %if.end9.i39
  store ptr %0, ptr %mv.i21, align 8
  %eflags36.i47 = getelementptr inbounds %struct.lmat, ptr %mv.i21, i64 0, i32 1
  store i32 %and4, ptr %eflags36.i47, align 8
  %pmatch37.i48 = getelementptr inbounds %struct.lmat, ptr %mv.i21, i64 0, i32 2
  store ptr null, ptr %pmatch37.i48, align 8
  %lastpos.i49 = getelementptr inbounds %struct.lmat, ptr %mv.i21, i64 0, i32 7
  store ptr null, ptr %lastpos.i49, align 8
  %offp.i50 = getelementptr inbounds %struct.lmat, ptr %mv.i21, i64 0, i32 3
  store ptr %string, ptr %offp.i50, align 8
  %beginp.i51 = getelementptr inbounds %struct.lmat, ptr %mv.i21, i64 0, i32 4
  store ptr %start.0.i35, ptr %beginp.i51, align 8
  %endp38.i52 = getelementptr inbounds %struct.lmat, ptr %mv.i21, i64 0, i32 5
  store ptr %stop.0.i37, ptr %endp38.i52, align 8
  %mul.i53 = shl nsw i64 %4, 2
  %call40.i = tail call ptr @cli_malloc(i64 noundef %mul.i53) #15
...
if.end45.i:                                       ; preds = %if.end34.i46
  %vn.i = getelementptr inbounds %struct.lmat, ptr %mv.i21, i64 0, i32 8
  %st.i54 = getelementptr inbounds %struct.lmat, ptr %mv.i21, i64 0, i32 10
  store ptr %call40.i, ptr %st.i54, align 8
  %74 = load i64, ptr %nstates, align 8
  %arrayidx58.i = getelementptr inbounds i8, ptr %call40.i, i64 %74
  %fresh.i = getelementptr inbounds %struct.lmat, ptr %mv.i21, i64 0, i32 11
  store ptr %arrayidx58.i, ptr %fresh.i, align 8
  %mul64.i = shl nsw i64 %74, 1
  ...
  tail call void @llvm.memset.p0.i64(ptr nonnull align 1 %arrayidx72.i, i8 0, i64 %74, i1 false)
  %coldp142.i.i = getelementptr inbounds %struct.lmat, ptr %mv.i21, i64 0, i32 6
  %cmp85.i = icmp eq i64 %spec.select.i28, 0
  %backrefs.i55 = getelementptr inbounds %struct.re_guts, ptr %0, i64 0, i32 18
  %cmp100.i = icmp eq i64 %spec.select.i28, 1
  %nplus.i56 = getelementptr inbounds %struct.re_guts, ptr %0, i64 0, i32 19
  br label %for.cond76.i

for.cond76.i:                                     ; preds = %if.end200.i, %if.end45.i
  %start.1.i57 = phi ptr [ %start.0.i35, %if.end45.i ], [ %add.ptr207.i, %if.end200.i ]
  %75 = load ptr, ptr %st.i54, align 8
  %76 = load ptr, ptr %fresh.i, align 8
  %77 = load ptr, ptr %tmp.i, align 8
  %78 = load ptr, ptr %beginp.i51, align 8
  %cmp.i.i58 = icmp eq ptr %78, %start.1.i57
  br i1 %cmp.i.i58, label %cond.end.i.i62, label %cond.false.i.i59

cond.false.i.i59:                                 ; preds = %for.cond76.i
  %add.ptr.i.i60 = getelementptr inbounds i8, ptr %start.1.i57, i64 -1
  %79 = load i8, ptr %add.ptr.i.i60, align 1
  %conv.i.i61 = sext i8 %79 to i32
  br label %cond.end.i.i62

cond.end.i.i62:                                   ; preds = %cond.false.i.i59, %for.cond76.i
  %cond.i.i63 = phi i32 [ %conv.i.i61, %cond.false.i.i59 ], [ 128, %for.cond76.i ]
  %80 = load ptr, ptr %mv.i21, align 8
  %nstates.i.i = getelementptr inbounds %struct.re_guts, ptr %80, i64 0, i32 7
  %81 = load i64, ptr %nstates.i.i, align 8
  call void @llvm.memset.p0.i64(ptr align 1 %75, i8 0, i64 %81, i1 false)
  %arrayidx.i.i64 = getelementptr inbounds i8, ptr %75, i64 %add.i23
  store i8 1, ptr %arrayidx.i.i64, align 1
  %82 = load ptr, ptr %mv.i21, align 8
  %call.i.i65 = call fastcc ptr @lstep(ptr noundef %82, i64 noundef %add.i23, i64 noundef %66, ptr noundef %75, i32 noundef 132, ptr noundef %75)
  %83 = load ptr, ptr %mv.i21, align 8
  %nstates6.i.i = getelementptr inbounds %struct.re_guts, ptr %83, i64 0, i32 7
  %84 = load i64, ptr %nstates6.i.i, align 8
  call void @llvm.memmove.p0.p0.i64(ptr align 1 %76, ptr align 1 %75, i64 %84, i1 false)
  %arrayidx127.i.i = getelementptr inbounds i8, ptr %75, i64 %66
  br label %for.cond.i.i66

for.cond.i.i66:                                   ; preds = %if.end134.i.i, %cond.end.i.i62
  %p.0.i.i67 = phi ptr [ %start.1.i57, %cond.end.i.i62 ], [ %incdec.ptr.i.i80, %if.end134.i.i ]
  %c.0.i.i68 = phi i32 [ %cond.i.i63, %cond.end.i.i62 ], [ %cond13.i.i, %if.end134.i.i ]
  %coldp.0.i.i69 = phi ptr [ null, %cond.end.i.i62 ], [ %spec.select.i.i70, %if.end134.i.i ]
  %85 = load ptr, ptr %endp38.i52, align 8
  %cmp7.i.i = icmp eq ptr %p.0.i.i67, %85
  br i1 %cmp7.i.i, label %cond.end12.i.i, label %cond.false10.i.i

cond.false10.i.i:                                 ; preds = %for.cond.i.i66
  %86 = load i8, ptr %p.0.i.i67, align 1
  %conv11.i.i = sext i8 %86 to i32
  br label %cond.end12.i.i

cond.end12.i.i:                                   ; preds = %cond.false10.i.i, %for.cond.i.i66
  %cond13.i.i = phi i32 [ %conv11.i.i, %cond.false10.i.i ], [ 128, %for.cond.i.i66 ]
  %87 = load ptr, ptr %mv.i21, align 8
  %nstates15.i.i = getelementptr inbounds %struct.re_guts, ptr %87, i64 0, i32 7
  %88 = load i64, ptr %nstates15.i.i, align 8
  %bcmp.i.i = call i32 @bcmp(ptr nonnull %75, ptr %76, i64 %88)
  %cmp17.i.i = icmp eq i32 %bcmp.i.i, 0
  %spec.select.i.i70 = select i1 %cmp17.i.i, ptr %p.0.i.i67, ptr %coldp.0.i.i69
  switch i32 %c.0.i.i68, label %if.end29.i.i [
    i32 10, label %land.lhs.true.i.i101
    i32 128, label %land.lhs.true24.i.i
  ]

land.lhs.true.i.i101:                             ; preds = %cond.end12.i.i
  %cflags.i.i102 = getelementptr inbounds %struct.re_guts, ptr %87, i64 0, i32 6
  %89 = load i32, ptr %cflags.i.i102, align 8
  %and.i.i103 = and i32 %89, 8
  %tobool.not.i.i104 = icmp eq i32 %and.i.i103, 0
  br i1 %tobool.not.i.i104, label %if.end29.i.i, label %if.then27.i.i

land.lhs.true24.i.i:                              ; preds = %cond.end12.i.i
  %90 = load i32, ptr %eflags36.i47, align 8
  %and25.i.i = and i32 %90, 1
  %tobool26.not.i.i = icmp eq i32 %and25.i.i, 0
  br i1 %tobool26.not.i.i, label %if.then27.i.i, label %if.end29.i.i

if.then27.i.i:                                    ; preds = %land.lhs.true24.i.i, %land.lhs.true.i.i101
  %nbol.i.i100 = getelementptr inbounds %struct.re_guts, ptr %87, i64 0, i32 11
  %91 = load i32, ptr %nbol.i.i100, align 4
  br label %if.end29.i.i

if.end29.i.i:                                     ; preds = %if.then27.i.i, %land.lhs.true24.i.i, %land.lhs.true.i.i101, %cond.end12.i.i
  %cmp45.i.i = phi i32 [ 131, %if.then27.i.i ], [ 130, %land.lhs.true24.i.i ], [ 130, %cond.end12.i.i ], [ 130, %land.lhs.true.i.i101 ]
  %flagch.0.i.i71 = phi i32 [ 129, %if.then27.i.i ], [ 0, %land.lhs.true24.i.i ], [ 0, %cond.end12.i.i ], [ 0, %land.lhs.true.i.i101 ]
  %i.0.i.i72 = phi i32 [ %91, %if.then27.i.i ], [ 0, %land.lhs.true24.i.i ], [ 0, %cond.end12.i.i ], [ 0, %land.lhs.true.i.i101 ]
...
land.lhs.true32.i.i:                              ; preds = %if.end29.i.i
  %cflags34.i.i = getelementptr inbounds %struct.re_guts, ptr %87, i64 0, i32 6
  %92 = load i32, ptr %cflags34.i.i, align 8
  %and35.i.i = and i32 %92, 8
...
land.lhs.true40.i.i:                              ; preds = %if.end29.i.i
  %93 = load i32, ptr %eflags36.i47, align 8
  %and42.i.i = and i32 %93, 2
...
if.then44.i.i:                                    ; preds = %land.lhs.true40.i.i, %land.lhs.true32.i.i
  %neol.i.i98 = getelementptr inbounds %struct.re_guts, ptr %87, i64 0, i32 12
  %94 = load i32, ptr %neol.i.i98, align 8
  %add.i.i99 = add nsw i32 %94, %i.0.i.i72
  br label %if.end49.i.i

if.end49.i.i:                                     ; preds = %if.then44.i.i, %land.lhs.true40.i.i, %land.lhs.true32.i.i, %if.end29.i.i
  %flagch.1.i.i73 = phi i32 [ %cmp45.i.i, %if.then44.i.i ], [ %flagch.0.i.i71, %land.lhs.true40.i.i ], [ %flagch.0.i.i71, %if.end29.i.i ], [ %flagch.0.i.i71, %land.lhs.true32.i.i ]
  %i.1.i.i74 = phi i32 [ %add.i.i99, %if.then44.i.i ], [ %i.0.i.i72, %land.lhs.true40.i.i ], [ %i.0.i.i72, %if.end29.i.i ], [ %i.0.i.i72, %land.lhs.true32.i.i ]
  %cmp54.i.i = icmp sgt i32 %i.1.i.i74, 0
  br i1 %cmp54.i.i, label %for.body.i.i95, label %if.end58.i.i

for.body.i.i95:                                   ; preds = %if.end49.i.i, %for.body.i.i95
  %i.2.i.i96 = phi i32 [ %dec.i.i97, %for.body.i.i95 ], [ %i.1.i.i74, %if.end49.i.i ]
  %95 = load ptr, ptr %mv.i21, align 8
  %call57.i.i = call fastcc ptr @lstep(ptr noundef %95, i64 noundef %add.i23, i64 noundef %66, ptr noundef %75, i32 noundef %flagch.1.i.i73, ptr noundef %75)
  %dec.i.i97 = add nsw i32 %i.2.i.i96, -1
  %cmp54.old.i.i = icmp ugt i32 %i.2.i.i96, 1
  br i1 %cmp54.old.i.i, label %for.body.i.i95, label %if.end58.i.i

if.end58.i.i:                                     ; preds = %for.body.i.i95, %if.end49.i.i
  %cmp59.i.i = icmp eq i32 %flagch.1.i.i73, 129
  br i1 %cmp59.i.i, label %land.lhs.true73.i.i, label %lor.lhs.false61.i.i

lor.lhs.false61.i.i:                              ; preds = %if.end58.i.i
  %cmp62.not.i.i = icmp eq i32 %c.0.i.i68, 128
...
land.lhs.true64.i.i:                              ; preds = %lor.lhs.false61.i.i
  ...
  %96 = load ptr, ptr %call65.i.i, align 8
  %idxprom.i.i75 = sext i32 %c.0.i.i68 to i64
  %arrayidx66.i.i = getelementptr inbounds i16, ptr %96, i64 %idxprom.i.i75
  %97 = load i16, ptr %arrayidx66.i.i, align 2
  %98 = and i16 %97, 8
  %tobool69.i.i = icmp eq i16 %98, 0
  %cmp71.i.i = icmp ne i32 %c.0.i.i68, 95
  %or.cond.not246.i.i = select i1 %tobool69.i.i, i1 %cmp71.i.i, i1 false
  %cmp74.i.i = icmp ne i32 %cond13.i.i, 128
  %or.cond155.i.i76 = select i1 %or.cond.not246.i.i, i1 %cmp74.i.i, i1 false
  br i1 %or.cond155.i.i76, label %land.lhs.true76.i.i, label %land.lhs.true90.i.i
...
land.lhs.true73.land.lhs.true76_crit_edge.i.i:    ; preds = %land.lhs.true73.i.i
  ...
  %.pre.i94 = load ptr, ptr %.pre258.i.i, align 8
  br label %land.lhs.true76.i.i

land.lhs.true76.i.i:                              ; preds = %land.lhs.true73.land.lhs.true76_crit_edge.i.i, %land.lhs.true64.i.i
  %99 = phi ptr [ %.pre.i94, %land.lhs.true73.land.lhs.true76_crit_edge.i.i ], [ %96, %land.lhs.true64.i.i ]
  %idxprom78.i.i = sext i32 %cond13.i.i to i64
  %arrayidx79.i.i = getelementptr inbounds i16, ptr %99, i64 %idxprom78.i.i
  %100 = load i16, ptr %arrayidx79.i.i, align 2
  %101 = and i16 %100, 8
  %tobool82.i.i = icmp ne i16 %101, 0
  %cmp84.i.i = icmp eq i32 %cond13.i.i, 95
  %or.cond157.i.i = select i1 %tobool82.i.i, i1 true, i1 %cmp84.i.i
  %spec.select247.i.i = select i1 %or.cond157.i.i, i32 133, i32 %flagch.1.i.i73
  br label %if.end87.i.i

if.end87.i.i:                                     ; preds = %land.lhs.true76.i.i, %land.lhs.true73.i.i
  %flagch.2.i.i92 = phi i32 [ 129, %land.lhs.true73.i.i ], [ %spec.select247.i.i, %land.lhs.true76.i.i ]
  %cmp88.not.i.i = icmp eq i32 %c.0.i.i68, 128
...
if.end87.land.lhs.true90_crit_edge.i.i:           ; preds = %if.end87.i.i
  %.pre.i.i93 = tail call ptr @__ctype_b_loc() #17
  %.pre257.i.i = sext i32 %c.0.i.i68 to i64
  %.pre468.i = load ptr, ptr %.pre.i.i93, align 8
  %arrayidx93.i.phi.trans.insert.i = getelementptr inbounds i16, ptr %.pre468.i, i64 %.pre257.i.i
  %.pre469.i = load i16, ptr %arrayidx93.i.phi.trans.insert.i, align 2
  %.pre472.i = and i16 %.pre469.i, 8
  br label %land.lhs.true90.i.i

land.lhs.true90.i.i:                              ; preds = %if.end87.land.lhs.true90_crit_edge.i.i, %land.lhs.true64.i.i
  %.pre-phi.i77 = phi i16 [ %.pre472.i, %if.end87.land.lhs.true90_crit_edge.i.i ], [ %98, %land.lhs.true64.i.i ]
  %102 = phi ptr [ %.pre468.i, %if.end87.land.lhs.true90_crit_edge.i.i ], [ %96, %land.lhs.true64.i.i ]
  %flagch.2253.i.i = phi i32 [ %flagch.2.i.i92, %if.end87.land.lhs.true90_crit_edge.i.i ], [ %flagch.1.i.i73, %land.lhs.true64.i.i ]
  %tobool96.i.i = icmp ne i16 %.pre-phi.i77, 0
  %cmp98.i.i = icmp eq i32 %c.0.i.i68, 95
...
land.lhs.true106.i.i:                             ; preds = %lor.lhs.false103.i.i
  ...
  %arrayidx109.i.i = getelementptr inbounds i16, ptr %102, i64 %idxprom108.i.i
  %103 = load i16, ptr %arrayidx109.i.i, align 2
  %104 = and i16 %103, 8
  %tobool112.i.i = icmp ne i16 %104, 0
...
if.end117.i.i:                                    ; preds = %land.lhs.true106.i.i, %lor.lhs.false103.i.i, %land.lhs.true90.i.i, %if.end87.i.i, %lor.lhs.false61.i.i
  %flagch.3.i.i78 = phi i32 [ %flagch.2253.i.i, %land.lhs.true106.i.i ], [ %flagch.2253.i.i, %lor.lhs.false103.i.i ], [ %flagch.2253.i.i, %land.lhs.true90.i.i ], [ %flagch.2.i.i92, %if.end87.i.i ], [ %flagch.1.i.i73, %lor.lhs.false61.i.i ]
  %105 = add i32 %flagch.3.i.i78, -133
  %or.cond163.i.i = icmp ult i32 %105, 2
...
if.then123.i.i:                                   ; preds = %if.end117.i.i, %land.lhs.true106.i.i, %land.lhs.true100.i.i
  %flagch.3256.i.i = phi i32 [ %flagch.3.i.i78, %if.end117.i.i ], [ 134, %land.lhs.true100.i.i ], [ 134, %land.lhs.true106.i.i ]
  %106 = load ptr, ptr %mv.i21, align 8
  %call125.i.i = call fastcc ptr @lstep(ptr noundef %106, i64 noundef %add.i23, i64 noundef %66, ptr noundef %75, i32 noundef %flagch.3256.i.i, ptr noundef %75)
  br label %if.end126.i.i

if.end126.i.i:                                    ; preds = %if.then123.i.i, %if.end117.i.i
  %107 = load i8, ptr %arrayidx127.i.i, align 1
  %tobool129.not.i.i = icmp ne i8 %107, 0
  %cmp131.i.i = icmp eq ptr %p.0.i.i67, %stop.0.i37
  %or.cond.i.i79 = or i1 %cmp131.i.i, %tobool129.not.i.i
  br i1 %or.cond.i.i79, label %lfast.exit.i, label %if.end134.i.i

if.end134.i.i:                                    ; preds = %if.end126.i.i
  %108 = load ptr, ptr %mv.i21, align 8
  %nstates136.i.i = getelementptr inbounds %struct.re_guts, ptr %108, i64 0, i32 7
  %109 = load i64, ptr %nstates136.i.i, align 8
  call void @llvm.memmove.p0.p0.i64(ptr align 1 %77, ptr nonnull align 1 %75, i64 %109, i1 false)
  %110 = load ptr, ptr %mv.i21, align 8
  %nstates138.i.i = getelementptr inbounds %struct.re_guts, ptr %110, i64 0, i32 7
  %111 = load i64, ptr %nstates138.i.i, align 8
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 1 %75, ptr align 1 %76, i64 %111, i1 false)
  %112 = load ptr, ptr %mv.i21, align 8
  %call140.i.i = call fastcc ptr @lstep(ptr noundef %112, i64 noundef %add.i23, i64 noundef %66, ptr noundef %77, i32 noundef %cond13.i.i, ptr noundef nonnull %75)
  %incdec.ptr.i.i80 = getelementptr inbounds i8, ptr %p.0.i.i67, i64 1
  br label %for.cond.i.i66

lfast.exit.i:                                     ; preds = %if.end126.i.i
  store ptr %spec.select.i.i70, ptr %coldp142.i.i, align 8
  %113 = load i8, ptr %arrayidx127.i.i, align 1
  %tobool144.not.i.i = icmp eq i8 %113, 0
  br i1 %tobool144.not.i.i, label %if.then80.i, label %if.end84.i

if.then80.i:                                      ; preds = %lfast.exit.i
  %114 = load ptr, ptr %pmatch37.i48, align 8
  call void @free(ptr noundef %114) #15
  %115 = load ptr, ptr %lastpos.i49, align 8
...
land.lhs.true87.i:                                ; preds = %if.end84.i
  %116 = load i32, ptr %backrefs.i55, align 8
  %tobool88.not.i = icmp eq i32 %116, 0
  br i1 %tobool88.not.i, label %if.end250.i, label %if.end90.i

if.end90.i:                                       ; preds = %land.lhs.true87.i, %if.end84.i
  %call92454.i = call fastcc ptr @lslow(ptr noundef nonnull %mv.i21, ptr noundef %spec.select.i.i70, ptr noundef %stop.0.i37, i64 noundef %add.i23, i64 noundef %66)
...
if.end96.i:                                       ; preds = %if.end90.i, %if.end96.i
  %117 = load ptr, ptr %coldp142.i.i, align 8
  %incdec.ptr98.i = getelementptr inbounds i8, ptr %117, i64 1
  store ptr %incdec.ptr98.i, ptr %coldp142.i.i, align 8
  %call92.i = call fastcc ptr @lslow(ptr noundef nonnull %mv.i21, ptr noundef nonnull %incdec.ptr98.i, ptr noundef %stop.0.i37, i64 noundef %add.i23, i64 noundef %66)
...
land.lhs.true102.i:                               ; preds = %for.end99.i
  %118 = load i32, ptr %backrefs.i55, align 8
  %tobool104.not.i = icmp eq i32 %118, 0
  br i1 %tobool104.not.i, label %if.end225.i, label %if.end106.i

if.end106.i:                                      ; preds = %land.lhs.true102.i, %for.end99.i
  %119 = load ptr, ptr %pmatch37.i48, align 8
  %cmp108.i81 = icmp eq ptr %119, null
  br i1 %cmp108.i81, label %if.end116.i, label %for.cond123.preheader.i

if.end116.i:                                      ; preds = %if.end106.i
  %120 = load ptr, ptr %mv.i21, align 8
  %nsub.i91 = getelementptr inbounds %struct.re_guts, ptr %120, i64 0, i32 17
  %121 = load i64, ptr %nsub.i91, align 8
  %add112.i = shl i64 %121, 4
  %mul113.i = add i64 %add112.i, 16
  %call114.i = call ptr @cli_malloc(i64 noundef %mul113.i) #15
  store ptr %call114.i, ptr %pmatch37.i48, align 8
...
for.cond123.preheader.i:                          ; preds = %if.end116.i, %if.end106.i
  %122 = phi ptr [ %call114.i, %if.end116.i ], [ %119, %if.end106.i ]
  %123 = load ptr, ptr %mv.i21, align 8
  %nsub125.i = getelementptr inbounds %struct.re_guts, ptr %123, i64 0, i32 17
  %124 = load i64, ptr %nsub125.i, align 8
  %cmp126.not457.i = icmp eq i64 %124, 0
...
for.body128.preheader.i:                          ; preds = %for.cond123.preheader.i
  %scevgep.i82 = getelementptr i8, ptr %122, i64 16
  %125 = add i64 %124, 1
  %umax.i83 = call i64 @llvm.umax.i64(i64 %125, i64 2)
  %126 = shl i64 %umax.i83, 4
  %127 = add i64 %126, -16
  call void @llvm.memset.p0.i64(ptr align 8 %scevgep.i82, i8 -1, i64 %127, i1 false)
  br label %for.end137.i

for.end137.i:                                     ; preds = %for.body128.preheader.i, %for.cond123.preheader.i
  %128 = load i32, ptr %backrefs.i55, align 8
...
land.lhs.true140.i:                               ; preds = %for.end137.i
  %129 = load i32, ptr %eflags36.i47, align 8
...
if.then144.i:                                     ; preds = %land.lhs.true140.i
  %130 = load ptr, ptr %coldp142.i.i, align 8
  %call146.i = call fastcc ptr @ldissect(ptr noundef nonnull %mv.i21, ptr noundef %130, ptr noundef nonnull %call92.lcssa.i, i64 noundef %add.i23, i64 noundef %66)
  br label %if.end174.i

if.else147.i:                                     ; preds = %land.lhs.true140.i, %for.end137.i
  %131 = load i64, ptr %nplus.i56, align 8
  %cmp148.i = icmp sgt i64 %131, 0
  %132 = load ptr, ptr %lastpos.i49, align 8
  %cmp152.i = icmp eq ptr %132, null
  %or.cond.i84 = select i1 %cmp148.i, i1 %cmp152.i, i1 false
  br i1 %or.cond.i84, label %if.then154.i, label %if.end160.i
...
if.then154.i:                                     ; preds = %if.else147.i
  ...
  store ptr %call158.i, ptr %lastpos.i49, align 8
  %.pre470.i = load i64, ptr %nplus.i56, align 8
  br label %if.end160.i

if.end160.i:                                      ; preds = %if.then154.i, %if.else147.i
  %133 = phi ptr [ %call158.i, %if.then154.i ], [ %132, %if.else147.i ]
  %134 = phi i64 [ %.pre470.i, %if.then154.i ], [ %131, %if.else147.i ]
...
if.then168.i:                                     ; preds = %if.end160.i
  %135 = load ptr, ptr %pmatch37.i48, align 8
  call void @free(ptr noundef %135) #15
  br label %cleanup.sink.split.i

if.end171.i:                                      ; preds = %if.end160.i
  %136 = load ptr, ptr %coldp142.i.i, align 8
  %call173.i = call fastcc ptr @lbackref(ptr noundef nonnull %mv.i21, ptr noundef %136, ptr noundef nonnull %call92.lcssa.i, i64 noundef %add.i23, i64 noundef %66, i64 noundef 0, i32 noundef 0)
  br label %if.end174.i

if.end174.i:                                      ; preds = %if.end171.i, %if.then144.i
  %dp.1.i85 = phi ptr [ %call173.i, %if.end171.i ], [ %call146.i, %if.then144.i ]
  %cmp175.not.i = icmp eq ptr %dp.1.i85, null
  br i1 %cmp175.not.i, label %lor.lhs.false.i89, label %for.end208.i

lor.lhs.false.i89:                                ; preds = %if.end174.i, %if.end193.i
  %endp.0459.i = phi ptr [ %call189.i, %if.end193.i ], [ %call92.lcssa.i, %if.end174.i ]
  %137 = load ptr, ptr %coldp142.i.i, align 8
  %cmp183.not.i = icmp ugt ptr %endp.0459.i, %137
  br i1 %cmp183.not.i, label %if.end186.i, label %if.end200.i

if.end186.i:                                      ; preds = %lor.lhs.false.i89
  %add.ptr188.i = getelementptr inbounds i8, ptr %endp.0459.i, i64 -1
  %call189.i = call fastcc ptr @lslow(ptr noundef nonnull %mv.i21, ptr noundef %137, ptr noundef nonnull %add.ptr188.i, i64 noundef %add.i23, i64 noundef %66)
  %cmp190.i = icmp eq ptr %call189.i, null
  %.pre471.i = load ptr, ptr %coldp142.i.i, align 8
  br i1 %cmp190.i, label %if.end200.i, label %if.end193.i

if.end193.i:                                      ; preds = %if.end186.i
  %call195.i = call fastcc ptr @lbackref(ptr noundef nonnull %mv.i21, ptr noundef %.pre471.i, ptr noundef nonnull %call189.i, i64 noundef %add.i23, i64 noundef %66, i64 noundef 0, i32 noundef 0)
  %cmp180.not.i = icmp eq ptr %call195.i, null
  br i1 %cmp180.not.i, label %lor.lhs.false.i89, label %for.end208.i

if.end200.i:                                      ; preds = %if.end186.i, %lor.lhs.false.i89
  %138 = phi ptr [ %.pre471.i, %if.end186.i ], [ %137, %lor.lhs.false.i89 ]
  %endp.1.ph.i90 = phi ptr [ null, %if.end186.i ], [ %endp.0459.i, %lor.lhs.false.i89 ]
  %cmp202.i = icmp eq ptr %138, %stop.0.i37
...
for.end208.i:                                     ; preds = %if.end200.i, %if.end174.i, %if.end193.i
  %endp.2.i86 = phi ptr [ %call189.i, %if.end193.i ], [ %call92.lcssa.i, %if.end174.i ], [ %endp.1.ph.i90, %if.end200.i ]
  br i1 %cmp85.i, label %if.end250.i, label %if.end225.i

if.end225.i:                                      ; preds = %land.lhs.true102.i, %for.end208.i
  %endp.2428.i = phi ptr [ %endp.2.i86, %for.end208.i ], [ %call92.lcssa.i, %land.lhs.true102.i ]
  %139 = load ptr, ptr %coldp142.i.i, align 8
  %140 = load ptr, ptr %offp.i50, align 8
...
for.cond229.preheader.i:                          ; preds = %if.end225.i
  %141 = load ptr, ptr %mv.i21, align 8
  %nsub234.i = getelementptr inbounds %struct.re_guts, ptr %141, i64 0, i32 17
  %142 = load ptr, ptr %pmatch37.i48, align 8
  br label %for.body232.i

for.body232.i:                                    ; preds = %for.inc247.i, %for.cond229.preheader.i
  %i.1460.i = phi i64 [ 1, %for.cond229.preheader.i ], [ %inc248.i, %for.inc247.i ]
  %143 = load i64, ptr %nsub234.i, align 8
  %cmp235.not.i = icmp ugt i64 %i.1460.i, %143
  %arrayidx242.i = getelementptr inbounds %struct.regmatch_t, ptr %pmatch, i64 %i.1460.i
  br i1 %cmp235.not.i, label %if.else241.i, label %if.then237.i

if.then237.i:                                     ; preds = %for.body232.i
  %arrayidx240.i = getelementptr inbounds %struct.regmatch_t, ptr %142, i64 %i.1460.i
...
for.inc247.i:                                     ; preds = %if.else241.i, %if.then237.i
  %inc248.i = add nuw i64 %i.1460.i, 1
  %exitcond.not.i88 = icmp eq i64 %inc248.i, %spec.select.i28
  br i1 %exitcond.not.i88, label %if.end250.i, label %for.body232.i

if.end250.i:                                      ; preds = %land.lhs.true87.i, %for.inc247.i, %if.end225.i, %for.end208.i
  %144 = load ptr, ptr %pmatch37.i48, align 8
  %cmp252.not.i = icmp eq ptr %144, null
...
if.end256.i:                                      ; preds = %if.then254.i, %if.end250.i
  %145 = load ptr, ptr %lastpos.i49, align 8
  %cmp258.not.i = icmp eq ptr %145, null
...
cleanup.sink.split.i:                             ; preds = %if.end116.i, %if.then260.i, %if.end256.i, %if.then168.i, %if.then80.i
  ...
  %146 = load ptr, ptr %space.i, align 8
  call void @free(ptr noundef %146) #15
  br label %lmatcher.exit

lmatcher.exit:                                    ; preds = %if.end7.i34, %for.end.i43, %if.end34.i46, %cleanup.sink.split.i
  %retval.0.i87 = phi i32 [ 16, %if.end7.i34 ], [ 1, %for.end.i43 ], [ 12, %if.end34.i46 ], [ %retval.0.ph.i, %cleanup.sink.split.i ]
...
cleanup:                                          ; preds = %if.end, %entry, %lor.lhs.false, %lmatcher.exit, %smatcher.exit
  %retval.0 = phi i32 [ %retval.0.i87, %lmatcher.exit ], [ %retval.0.i, %smatcher.exit ], [ 2, %lor.lhs.false ], [ 2, %entry ], [ 2, %if.end ]
  ret i32 %retval.0
}
...
land.lhs.true65:                                  ; preds = %land.lhs.true62.land.lhs.true65_crit_edge, %land.lhs.true54
  ...
  %15 = load ptr, ptr %call66.pre-phi, align 8
...
land.lhs.true79:                                  ; preds = %if.end76.land.lhs.true79_crit_edge, %land.lhs.true54
  ...
  %18 = load ptr, ptr %call80.pre-phi, align 8
  %arrayidx82 = getelementptr inbounds i16, ptr %18, i64 %idxprom81.pre-phi
  %19 = load i16, ptr %arrayidx82, align 2
  %20 = and i16 %19, 8
...
land.lhs.true95:                                  ; preds = %lor.lhs.false92
  ...
  %21 = load i16, ptr %arrayidx98, align 2
  %22 = and i16 %21, 8
...
while.body:                                       ; preds = %while.cond.preheader, %while.body
  ...
  br i1 %cmp10.not, label %sw.epilog, label %while.body
...
sw.bb97:                                          ; preds = %sw.epilog
  ...
  store i64 %sub.ptr.sub, ptr %arrayidx102, align 8
  br label %for.inc
...
sw.bb103:                                         ; preds = %sw.epilog
  ...
  store i64 %sub.ptr.sub112, ptr %rm_eo, align 8
  br label %for.inc
...
entry:
  ...
  %cmp670892896902 = icmp slt i64 %startst, %stopst
  br i1 %cmp670892896902, label %for.body.lr.ph.lr.ph.lr.ph, label %if.then199

for.body.lr.ph.lr.ph.lr.ph:                       ; preds = %entry, %tailrecurse.outer.backedge
  %rec.tr.ph906 = phi i32 [ %rec.tr.ph613899, %tailrecurse.outer.backedge ], [ %rec, %entry ]
  %lev.tr.ph905 = phi i64 [ %lev.tr.ph.be, %tailrecurse.outer.backedge ], [ %lev, %entry ]
  %startst.tr.ph904 = phi i64 [ %inc197743, %tailrecurse.outer.backedge ], [ %startst, %entry ]
  %start.tr.ph903 = phi ptr [ %sp.0672, %tailrecurse.outer.backedge ], [ %start, %entry ]
  br label %for.body.lr.ph.lr.ph

for.body.lr.ph.lr.ph:                             ; preds = %for.body.lr.ph.lr.ph.lr.ph, %while.end
  %rec.tr.ph613899 = phi i32 [ %rec.tr.ph906, %for.body.lr.ph.lr.ph.lr.ph ], [ %rec.addr.0, %while.end ]
  %startst.tr.ph612898 = phi i64 [ %startst.tr.ph904, %for.body.lr.ph.lr.ph.lr.ph ], [ %inc254, %while.end ]
  %start.tr.ph611897 = phi ptr [ %start.tr.ph903, %for.body.lr.ph.lr.ph.lr.ph ], [ %add.ptr255, %while.end ]
  br label %for.body.lr.ph

for.body.lr.ph:                                   ; preds = %for.body.lr.ph.lr.ph, %if.end264
  %startst.tr894 = phi i64 [ %startst.tr.ph612898, %for.body.lr.ph.lr.ph ], [ %add267, %if.end264 ]
  %start.tr893 = phi ptr [ %start.tr.ph611897, %for.body.lr.ph.lr.ph ], [ %sp.0672, %if.end264 ]
  %0 = load ptr, ptr %m, align 8
  %strip = getelementptr inbounds %struct.re_guts, ptr %0, i64 0, i32 1
  %1 = load ptr, ptr %strip, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %sp.0672 = phi ptr [ %start.tr893, %for.body.lr.ph ], [ %sp.1, %for.inc ]
  %ss.0671 = phi i64 [ %startst.tr894, %for.body.lr.ph ], [ %inc197, %for.inc ]
...
sw.bb70.lor.lhs.false78_crit_edge:                ; preds = %sw.bb70
  %.pre738 = load ptr, ptr %endp129, align 8
  br label %lor.lhs.false78

land.lhs.true74:                                  ; preds = %sw.bb70
  %21 = load i32, ptr %eflags133, align 8
  %and76 = and i32 %21, 1
  %tobool77.not = icmp eq i32 %and76, 0
  %.pre739 = load ptr, ptr %endp129, align 8
  br i1 %tobool77.not, label %land.lhs.true109, label %lor.lhs.false78

lor.lhs.false78:                                  ; preds = %sw.bb70.lor.lhs.false78_crit_edge, %land.lhs.true74
  %22 = phi ptr [ %.pre738, %sw.bb70.lor.lhs.false78_crit_edge ], [ %.pre739, %land.lhs.true74 ]
...
land.lhs.true87:                                  ; preds = %land.lhs.true82
  %24 = load i32, ptr %cflags146, align 8
  %and90 = and i32 %24, 8
...
land.lhs.true96:                                  ; preds = %lor.lhs.false92
  ...
  %or.cond = or i1 %cmp107, %tobool103.not
  br i1 %or.cond, label %cleanup, label %land.lhs.true109

land.lhs.true109:                                 ; preds = %land.lhs.true74, %land.lhs.true96, %land.lhs.true87
  %29 = phi ptr [ %22, %land.lhs.true96 ], [ %22, %land.lhs.true87 ], [ %.pre739, %land.lhs.true74 ]
...
land.lhs.true165:                                 ; preds = %land.lhs.true153, %land.lhs.true144, %land.lhs.true132
  %41 = load ptr, ptr %beginp166, align 8
...
sw.bb186:                                         ; preds = %for.body
  ...
  %46 = load i64, ptr %arrayidx189, align 8
  br label %do.body
...
do.body:                                          ; preds = %do.body, %sw.bb186
  ...
  %47 = load i64, ptr %arrayidx193, align 8
  %and194 = and i64 %47, 4160749568
  %cmp195.not = icmp eq i64 %and194, 2415919104
  br i1 %cmp195.not, label %for.inc, label %do.body
...
for.inc:                                          ; preds = %do.body, %if.end11, %for.body, %lor.lhs.false, %lor.lhs.false19, %land.lhs.true, %land.lhs.true40, %land.lhs.true50, %land.lhs.true62, %land.lhs.true113, %land.lhs.true169
  ...
  br i1 %cmp, label %for.body, label %if.then199
...
if.end217:                                        ; preds = %sw.bb209
  ...
  %55 = load i64, ptr %arrayidx213, align 8
...
land.lhs.true227:                                 ; preds = %if.end217
  %inc228 = add nsw i32 %rec.tr.ph613899, 1
  %cmp229 = icmp sgt i32 %rec.tr.ph613899, 100
  br i1 %cmp229, label %cleanup, label %if.end232

if.end232:                                        ; preds = %land.lhs.true227, %if.end217
  %rec.addr.0 = phi i32 [ %inc228, %land.lhs.true227 ], [ %rec.tr.ph613899, %if.end217 ]
...
while.cond:                                       ; preds = %while.cond, %while.cond.preheader
  ...
  %57 = load i64, ptr %arrayidx250, align 8
  %cmp252.not = icmp eq i64 %57, %or
  %inc254 = add nsw i64 %ss.3, 1
  br i1 %cmp252.not, label %while.end, label %while.cond

while.end:                                        ; preds = %while.cond
  %add.ptr255 = getelementptr inbounds i8, ptr %sp.0672, i64 %sub
  %cmp670892 = icmp slt i64 %inc254, %stopst
  br i1 %cmp670892, label %for.body.lr.ph.lr.ph, label %if.then199

sw.bb258:                                         ; preds = %if.end204
  %call260 = tail call fastcc ptr @sbackref(ptr noundef nonnull %m, ptr noundef %sp.0672, ptr noundef %stop, i64 noundef %inc197743, i64 noundef %stopst, i64 noundef %lev.tr.ph905, i32 noundef %rec.tr.ph613899)
...
tailrecurse.outer.backedge:                       ; preds = %sw.bb269, %if.then280, %if.then293
  ...
  %cmp670892896 = icmp slt i64 %inc197743, %stopst
  br i1 %cmp670892896, label %for.body.lr.ph.lr.ph.lr.ph, label %if.then199

sw.bb275:                                         ; preds = %if.end204
  %59 = load ptr, ptr %lastpos276, align 8
  %arrayidx277 = getelementptr inbounds ptr, ptr %59, i64 %lev.tr.ph905
  %60 = load ptr, ptr %arrayidx277, align 8
  %cmp278 = icmp eq ptr %sp.0672, %60
  br i1 %cmp278, label %if.then280, label %if.end284

if.then280:                                       ; preds = %sw.bb275
  %sub282 = add nsw i64 %lev.tr.ph905, -1
  br label %tailrecurse.outer.backedge

if.end284:                                        ; preds = %sw.bb275
  store ptr %sp.0672, ptr %arrayidx277, align 8
  %and287 = and i64 %50, 134217727
  %add289 = sub i64 %inc197743, %and287
  %call290 = tail call fastcc ptr @sbackref(ptr noundef nonnull %m, ptr noundef %sp.0672, ptr noundef %stop, i64 noundef %add289, i64 noundef %stopst, i64 noundef %lev.tr.ph905, i32 noundef %rec.tr.ph613899)
  %cmp291 = icmp eq ptr %call290, null
  br i1 %cmp291, label %if.then293, label %cleanup

if.then293:                                       ; preds = %if.end284
  %sub295 = add nsw i64 %lev.tr.ph905, -1
  br label %tailrecurse.outer.backedge
...
sw.bb298:                                         ; preds = %if.end204
  ...
  %call304676 = tail call fastcc ptr @sbackref(ptr noundef nonnull %m, ptr noundef %sp.0672, ptr noundef %stop, i64 noundef %inc197743, i64 noundef %sub302, i64 noundef %lev.tr.ph905, i32 noundef %rec.tr.ph613899)
...
if.end308:                                        ; preds = %sw.bb298, %if.end316
  ...
  %62 = load ptr, ptr %strip310, align 8
  %arrayidx311 = getelementptr inbounds i64, ptr %62, i64 %esub.0678
  %63 = load i64, ptr %arrayidx311, align 8
...
if.end316:                                        ; preds = %if.end308
  ...
  %call304 = tail call fastcc ptr @sbackref(ptr noundef nonnull %m, ptr noundef %sp.0672, ptr noundef %stop, i64 noundef %add318, i64 noundef %spec.select, i64 noundef %lev.tr.ph905, i32 noundef %rec.tr.ph613899)
...
sw.bb334:                                         ; preds = %if.end204
  ...
  %67 = load i64, ptr %arrayidx339, align 8
  %68 = load ptr, ptr %offp, align 8
  %sub.ptr.lhs.cast = ptrtoint ptr %sp.0672 to i64
  %sub.ptr.rhs.cast = ptrtoint ptr %68 to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  store i64 %sub.ptr.sub, ptr %arrayidx339, align 8
  %call347 = tail call fastcc ptr @sbackref(ptr noundef nonnull %m, ptr noundef %sp.0672, ptr noundef %stop, i64 noundef %inc197743, i64 noundef %stopst, i64 noundef %lev.tr.ph905, i32 noundef %rec.tr.ph613899)
...
if.end351:                                        ; preds = %sw.bb334
  ...
  store i64 %67, ptr %arrayidx354, align 8
  br label %cleanup
...
sw.bb356:                                         ; preds = %if.end204
  ...
  %71 = load i64, ptr %rm_eo362, align 8
  ...
  store i64 %sub.ptr.sub366, ptr %rm_eo362, align 8
  %call372 = tail call fastcc ptr @sbackref(ptr noundef nonnull %m, ptr noundef %sp.0672, ptr noundef %stop, i64 noundef %inc197743, i64 noundef %stopst, i64 noundef %lev.tr.ph905, i32 noundef %rec.tr.ph613899)
...
if.end376:                                        ; preds = %sw.bb356
  ...
  store i64 %71, ptr %rm_eo380, align 8
  br label %cleanup
...
for.cond128.preheader:                            ; preds = %sw.bb123
  ...
  %11 = load i64, ptr %arrayidx131271, align 8
...
for.inc:                                          ; preds = %for.cond128.preheader, %for.inc
  ...
  br i1 %cmp133.not, label %for.end, label %for.inc
...
for.inc163:                                       ; preds = %sw.bb68, %sw.bb72, %sw.bb99, %sw.bb107, %sw.bb111, %sw.bb115, %sw.bb159, %if.then, %sw.bb1, %sw.bb8, %if.then13, %sw.bb18, %if.then24, %if.then32, %sw.bb29, %if.then40, %sw.bb37, %if.then48, %sw.bb45, %if.then63, %land.lhs.true, %sw.bb53, %if.then95, %sw.bb76, %for.end, %sw.bb123, %if.then153, %sw.bb142, %for.body
  ...
  br i1 %cmp.not, label %for.end165, label %for.body
...
land.lhs.true55:                                  ; preds = %lor.lhs.false52
  ...
  %22 = load i16, ptr %arrayidx57, align 2
  %23 = and i16 %22, 8
...
land.lhs.true67:                                  ; preds = %land.lhs.true64.land.lhs.true67_crit_edge, %land.lhs.true55
  ...
  %24 = load ptr, ptr %call68.pre-phi, align 8
...
land.lhs.true81:                                  ; preds = %if.end78.land.lhs.true81_crit_edge, %land.lhs.true55
  ...
  %27 = load ptr, ptr %call82.pre-phi, align 8
  %arrayidx84 = getelementptr inbounds i16, ptr %27, i64 %idxprom83.pre-phi
  %28 = load i16, ptr %arrayidx84, align 2
  %29 = and i16 %28, 8
...
land.lhs.true97:                                  ; preds = %lor.lhs.false94
  ...
  %30 = load i16, ptr %arrayidx100, align 2
  %31 = and i16 %30, 8
...
if.end117:                                        ; preds = %if.end108, %if.then114
  %34 = load i8, ptr %arrayidx118, align 1
...
if.end131:                                        ; preds = %if.end117
  ...
  %38 = load i64, ptr %nstates135, align 8
...
for.end66:                                        ; preds = %for.cond59
  ...
  %9 = load ptr, ptr %strip69, align 8
...
if.end78:                                         ; preds = %for.end66, %if.end78
  ...
  %12 = load ptr, ptr %strip82, align 8
  %arrayidx83 = getelementptr inbounds i64, ptr %12, i64 %inc79
  %13 = load i64, ptr %arrayidx83, align 8
...
sw.bb258:                                         ; preds = %if.end204
  %call260 = tail call fastcc ptr @lbackref(ptr noundef nonnull %m, ptr noundef %sp.0672, ptr noundef %stop, i64 noundef %inc197743, i64 noundef %stopst, i64 noundef %lev.tr.ph905, i32 noundef %rec.tr.ph613899)
  %cmp261.not = icmp eq ptr %call260, null
  br i1 %cmp261.not, label %if.end264, label %cleanup
...
if.end284:                                        ; preds = %sw.bb275
  ...
  %and287 = and i64 %50, 134217727
  %add289 = sub i64 %inc197743, %and287
  %call290 = tail call fastcc ptr @lbackref(ptr noundef nonnull %m, ptr noundef %sp.0672, ptr noundef %stop, i64 noundef %add289, i64 noundef %stopst, i64 noundef %lev.tr.ph905, i32 noundef %rec.tr.ph613899)
  %cmp291 = icmp eq ptr %call290, null
  br i1 %cmp291, label %if.then293, label %cleanup
...
sw.bb298:                                         ; preds = %if.end204
  ...
  %add301 = add i64 %ss.0671, -1
  %sub302 = add i64 %add301, %and300
  %call304676 = tail call fastcc ptr @lbackref(ptr noundef nonnull %m, ptr noundef %sp.0672, ptr noundef %stop, i64 noundef %inc197743, i64 noundef %sub302, i64 noundef %lev.tr.ph905, i32 noundef %rec.tr.ph613899)
  %cmp305.not677 = icmp eq ptr %call304676, null
  br i1 %cmp305.not677, label %if.end308, label %cleanup
...
if.end316:                                        ; preds = %if.end308
  ...
  %dec331 = add i64 %and322, %esub.0678
  %spec.select = select i1 %cmp328, i64 %dec331, i64 %add323
  %call304 = tail call fastcc ptr @lbackref(ptr noundef nonnull %m, ptr noundef %sp.0672, ptr noundef %stop, i64 noundef %add318, i64 noundef %spec.select, i64 noundef %lev.tr.ph905, i32 noundef %rec.tr.ph613899)
  %cmp305.not = icmp eq ptr %call304, null
  br i1 %cmp305.not, label %if.end308, label %cleanup
...
sw.bb334:                                         ; preds = %if.end204
  ...
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  store i64 %sub.ptr.sub, ptr %arrayidx339, align 8
  %call347 = tail call fastcc ptr @lbackref(ptr noundef nonnull %m, ptr noundef %sp.0672, ptr noundef %stop, i64 noundef %inc197743, i64 noundef %stopst, i64 noundef %lev.tr.ph905, i32 noundef %rec.tr.ph613899)
  %cmp348.not = icmp eq ptr %call347, null
  br i1 %cmp348.not, label %if.end351, label %cleanup
...
sw.bb356:                                         ; preds = %if.end204
  ...
  %sub.ptr.sub366 = sub i64 %sub.ptr.lhs.cast364, %sub.ptr.rhs.cast365
  store i64 %sub.ptr.sub366, ptr %rm_eo362, align 8
  %call372 = tail call fastcc ptr @lbackref(ptr noundef nonnull %m, ptr noundef %sp.0672, ptr noundef %stop, i64 noundef %inc197743, i64 noundef %stopst, i64 noundef %lev.tr.ph905, i32 noundef %rec.tr.ph613899)
  %cmp373.not = icmp eq ptr %call372, null
  br i1 %cmp373.not, label %if.end376, label %cleanup
...
if.then:                                          ; preds = %sw.bb1
  ...
  %or391 = or i8 %8, %7
  store i8 %or391, ptr %arrayidx8, align 1
  br label %for.inc245
...
if.then16:                                        ; preds = %sw.bb11
  ...
  %or22390 = or i8 %10, %9
  store i8 %or22390, ptr %arrayidx20, align 1
  br label %for.inc245
...
if.then31:                                        ; preds = %sw.bb25
  ...
  %or37389 = or i8 %12, %11
  store i8 %or37389, ptr %arrayidx35, align 1
  br label %for.inc245
...
if.then43:                                        ; preds = %sw.bb40
  ...
  %or49388 = or i8 %14, %13
  store i8 %or49388, ptr %arrayidx47, align 1
  br label %for.inc245
...
if.then55:                                        ; preds = %sw.bb52
  ...
  %or61387 = or i8 %16, %15
  store i8 %or61387, ptr %arrayidx59, align 1
  br label %for.inc245
...
if.then67:                                        ; preds = %sw.bb64
  ...
  %18 = load i8, ptr %arrayidx71, align 1
  %or73386 = or i8 %18, %17
  store i8 %or73386, ptr %arrayidx71, align 1
  br label %for.inc245
...
if.then86:                                        ; preds = %land.lhs.true
  ...
  %or92385 = or i8 %24, %23
  store i8 %or92385, ptr %arrayidx90, align 1
  br label %for.inc245
...
sw.bb95:                                          ; preds = %for.body, %for.body
  ...
  store i8 %or101383, ptr %arrayidx99, align 1
  br label %for.inc245
...
sw.bb103:                                         ; preds = %for.body
  ...
  store i8 %or109382, ptr %arrayidx107, align 1
  br label %for.inc245
...
sw.bb111:                                         ; preds = %for.body
  ...
  store i8 %or117380, ptr %arrayidx115, align 1
  ...
  store i8 %or128381, ptr %arrayidx120, align 1
...
sw.bb142:                                         ; preds = %for.body
  ...
  store i8 %or148378, ptr %arrayidx146, align 1
  ...
  store i8 %or156379, ptr %arrayidx154, align 1
  br label %for.inc245
...
sw.bb158:                                         ; preds = %for.body
  ...
  store i8 %or164377, ptr %arrayidx162, align 1
  br label %for.inc245
...
sw.bb166:                                         ; preds = %for.body, %for.body
  ...
  store i8 %or172376, ptr %arrayidx170, align 1
  br label %for.inc245
...
sw.bb174:                                         ; preds = %for.body
  ...
  store i8 %or180374, ptr %arrayidx178, align 1
  ...
  store i8 %or188375, ptr %arrayidx186, align 1
  br label %for.inc245
...
for.cond194.preheader:                            ; preds = %sw.bb190
  ...
  %43 = load i64, ptr %arrayidx197395, align 8
...
for.inc:                                          ; preds = %for.cond194.preheader, %for.inc
  ...
  br i1 %cmp199.not, label %for.end, label %for.inc
...
for.end:                                          ; preds = %for.inc, %for.cond194.preheader
  ...
  store i8 %or209373, ptr %arrayidx207, align 1
  br label %for.inc245
...
sw.bb212:                                         ; preds = %for.body
  ...
  store i8 %or218371, ptr %arrayidx216, align 1
  ...
  %50 = load i64, ptr %arrayidx223, align 8
...
if.then227:                                       ; preds = %sw.bb212
  ...
  %51 = load i8, ptr %arrayidx232, align 1
  %or234372 = or i8 %51, %47
  store i8 %or234372, ptr %arrayidx232, align 1
  br label %for.inc245

sw.bb237:                                         ; preds = %for.body
  %arrayidx238 = getelementptr inbounds i8, ptr %aft, i64 %here.0401
  %52 = load i8, ptr %arrayidx238, align 1
  ...
  store i8 %or243392, ptr %arrayidx241, align 1
  br label %for.inc245
...
for.inc245:                                       ; preds = %sw.bb95, %sw.bb103, %sw.bb142, %sw.bb158, %sw.bb166, %sw.bb174, %sw.bb237, %if.then, %sw.bb1, %sw.bb11, %if.then16, %sw.bb25, %if.then31, %if.then43, %sw.bb40, %if.then55, %sw.bb52, %if.then67, %sw.bb64, %if.then86, %land.lhs.true, %sw.bb76, %if.then137, %sw.bb111, %for.end, %sw.bb190, %if.then227, %sw.bb212, %for.body
  ...
  %cmp.not = icmp eq i64 %inc, %stop
  br i1 %cmp.not, label %for.end247, label %for.body
