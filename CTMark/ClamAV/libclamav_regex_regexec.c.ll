...
if.end80.land.lhs.true83_crit_edge.i.i:           ; preds = %if.end80.i.i
  ...
  %.pre405.i = load ptr, ptr %.pre.i.i, align 8, !tbaa !38
  %arrayidx86.i.phi.trans.insert.i = getelementptr inbounds i16, ptr %.pre405.i, i64 %.pre240.i.i
  %.pre406.i = load i16, ptr %arrayidx86.i.phi.trans.insert.i, align 2, !tbaa !39
...
if.end184.thread.i:                               ; preds = %land.lhs.true65.i
  ...
  store i64 %sub.ptr.sub175414.i, ptr %pmatch, align 8, !tbaa !20
  ...
  store i64 %sub.ptr.sub181416.i, ptr %rm_eo183417.i, align 8, !tbaa !22
...
if.then114.i:                                     ; preds = %if.else107.i
  ...
  %.pre407.i = load i64, ptr %nplus.i, align 8, !tbaa !45
...
if.end184.i:                                      ; preds = %for.end167.i
  %.pre408.i = load ptr, ptr %coldp132.i.i, align 8, !tbaa !41
...
if.else:                                          ; preds = %if.end3
  ...
  %70 = load i64, ptr %laststate.i, align 8, !tbaa !18
  %71 = load i32, ptr %cflags.i, align 8, !tbaa !19
...
if.then3.i31:                                     ; preds = %if.else
  ...
  %73 = load i64, ptr %rm_eo.i33, align 8, !tbaa !22
...
if.end9.i39:                                      ; preds = %if.end7.i34
  ...
  %74 = load ptr, ptr %must.i40, align 8, !tbaa !23
...
land.lhs.true.i113:                               ; preds = %for.body.i108
  ...
  %77 = load i32, ptr %mlen.i107, align 8, !tbaa !25
...
for.inc.i110:                                     ; preds = %land.lhs.true21.i118, %land.lhs.true.i113, %for.body.i108
  ...
  br i1 %cmp12.i112, label %for.body.i108, label %for.end.i43, !llvm.loop !48
...
if.end45.i:                                       ; preds = %if.end34.i46
  ...
  store ptr %call40.i, ptr %st.i54, align 8, !tbaa !58
...
for.cond76.i:                                     ; preds = %if.end200.i, %if.end45.i
  ...
  %79 = load ptr, ptr %st.i54, align 8, !tbaa !58
  %80 = load ptr, ptr %fresh.i, align 8, !tbaa !59
  %81 = load ptr, ptr %tmp.i, align 8, !tbaa !60
  %82 = load ptr, ptr %beginp.i51, align 8, !tbaa !55
...
cond.false.i.i59:                                 ; preds = %for.cond76.i
  ...
  %83 = load i8, ptr %add.ptr.i.i60, align 1, !tbaa !24
...
cond.end.i.i62:                                   ; preds = %cond.false.i.i59, %for.cond76.i
  ...
  store i8 1, ptr %arrayidx.i.i64, align 1, !tbaa !24
...
for.cond.i.i66:                                   ; preds = %if.end134.i.i, %cond.end.i.i62
  ...
  %89 = load ptr, ptr %endp38.i52, align 8, !tbaa !56
...
cond.false10.i.i:                                 ; preds = %for.cond.i.i66
  %90 = load i8, ptr %p.0.i.i67, align 1, !tbaa !24
...
land.lhs.true.i.i101:                             ; preds = %cond.end12.i.i
  ...
  %93 = load i32, ptr %cflags.i.i102, align 8, !tbaa !19
...
land.lhs.true24.i.i:                              ; preds = %cond.end12.i.i
  %94 = load i32, ptr %eflags36.i47, align 8, !tbaa !51
...
if.then27.i.i:                                    ; preds = %land.lhs.true24.i.i, %land.lhs.true.i.i101
  ...
  %95 = load i32, ptr %nbol.i.i100, align 4, !tbaa !36
...
land.lhs.true40.i.i:                              ; preds = %if.end29.i.i
  %97 = load i32, ptr %eflags36.i47, align 8, !tbaa !51
...
if.then44.i.i:                                    ; preds = %land.lhs.true40.i.i, %land.lhs.true32.i.i
  ...
  %98 = load i32, ptr %neol.i.i98, align 8, !tbaa !37
...
land.lhs.true73.land.lhs.true76_crit_edge.i.i:    ; preds = %land.lhs.true73.i.i
  ...
  %.pre.i94 = load ptr, ptr %.pre258.i.i, align 8, !tbaa !38
...
if.end87.land.lhs.true90_crit_edge.i.i:           ; preds = %if.end87.i.i
  ...
  %.pre468.i = load ptr, ptr %.pre.i.i93, align 8, !tbaa !38
  %arrayidx93.i.phi.trans.insert.i = getelementptr inbounds i16, ptr %.pre468.i, i64 %.pre257.i.i
  %.pre469.i = load i16, ptr %arrayidx93.i.phi.trans.insert.i, align 2, !tbaa !39
...
lfast.exit.i:                                     ; preds = %if.end126.i.i
  store ptr %spec.select.i.i70, ptr %coldp142.i.i, align 8, !tbaa !63
...
if.then80.i:                                      ; preds = %lfast.exit.i
  %118 = load ptr, ptr %pmatch37.i48, align 8, !tbaa !52
  call void @free(ptr noundef %118) #15
  %119 = load ptr, ptr %lastpos.i49, align 8, !tbaa !53
...
land.lhs.true87.i:                                ; preds = %if.end84.i
  %120 = load i32, ptr %backrefs.i55, align 8, !tbaa !42
...
land.lhs.true102.i:                               ; preds = %for.end99.i
  %122 = load i32, ptr %backrefs.i55, align 8, !tbaa !42
...
if.end106.i:                                      ; preds = %land.lhs.true102.i, %for.end99.i
  %123 = load ptr, ptr %pmatch37.i48, align 8, !tbaa !52
...
for.body128.preheader.i:                          ; preds = %for.cond123.preheader.i
  ...
  %131 = add i64 %130, -16
  call void @llvm.memset.p0.i64(ptr align 8 %scevgep.i82, i8 -1, i64 %131, i1 false), !tbaa !44
  br label %for.end137.i

for.end137.i:                                     ; preds = %for.body128.preheader.i, %for.cond123.preheader.i
  %132 = load i32, ptr %backrefs.i55, align 8, !tbaa !42
...
land.lhs.true140.i:                               ; preds = %for.end137.i
  %133 = load i32, ptr %eflags36.i47, align 8, !tbaa !51
...
if.else147.i:                                     ; preds = %land.lhs.true140.i, %for.end137.i
  %135 = load i64, ptr %nplus.i56, align 8, !tbaa !45
...
if.then154.i:                                     ; preds = %if.else147.i
  ...
  store ptr %call158.i, ptr %lastpos.i49, align 8, !tbaa !53
  %.pre470.i = load i64, ptr %nplus.i56, align 8, !tbaa !45
...
if.then168.i:                                     ; preds = %if.end160.i
  %139 = load ptr, ptr %pmatch37.i48, align 8, !tbaa !52
...
if.end186.i:                                      ; preds = %lor.lhs.false.i89
  ...
  %.pre471.i = load ptr, ptr %coldp142.i.i, align 8, !tbaa !63
...
if.end225.i:                                      ; preds = %land.lhs.true102.i, %for.end208.i
  ...
  %144 = load ptr, ptr %offp.i50, align 8, !tbaa !54
...
if.end250.i:                                      ; preds = %land.lhs.true87.i, %if.end250.i.loopexit.unr-lcssa, %if.else241.i.epil, %if.then237.i.epil, %if.end225.i, %for.end208.i
  %152 = load ptr, ptr %pmatch37.i48, align 8, !tbaa !52
...
if.end256.i:                                      ; preds = %if.then254.i, %if.end250.i
  %153 = load ptr, ptr %lastpos.i49, align 8, !tbaa !53
...
sw.bb70.lor.lhs.false78_crit_edge:                ; preds = %sw.bb70
  %.pre738 = load ptr, ptr %endp129, align 8, !tbaa !35
...
land.lhs.true74:                                  ; preds = %sw.bb70
  ...
  %.pre739 = load ptr, ptr %endp129, align 8, !tbaa !35
...
sw.bb70.lor.lhs.false78_crit_edge:                ; preds = %sw.bb70
  %.pre738 = load ptr, ptr %endp129, align 8, !tbaa !56
  br label %lor.lhs.false78
...
land.lhs.true74:                                  ; preds = %sw.bb70
  ...
  %and76 = and i32 %21, 1
  %tobool77.not = icmp eq i32 %and76, 0
  %.pre739 = load ptr, ptr %endp129, align 8, !tbaa !56
  br i1 %tobool77.not, label %land.lhs.true109, label %lor.lhs.false78
