...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <16 x i8> %reverse1382, ptr %gep, align 1, !tbaa !12
  ...
  br i1 %11, label %vec.epilog.ph, label %vector.body, !llvm.loop !13
...
vec.epilog.ph:                                    ; preds = %vector.body
  ...
  %wide.load1399 = load <4 x i8>, ptr %12, align 1, !tbaa !12
  ...
  store <4 x i8> %reverse1401.2, ptr %16, align 1, !tbaa !12
  %18 = load i8, ptr %ind.end1385, align 1, !tbaa !12
  %dec118 = add i8 %5, 3
  %xor = xor i8 %18, %ind.end1388
  store i8 %xor, ptr %ind.end1385, align 1, !tbaa !12
...
while.body134:                                    ; preds = %while.body134, %if.end129
  ...
  %20 = load i8, ptr %curr.11264, align 1, !tbaa !12
  %21 = trunc i32 %key32.1 to i8
  %conv144 = xor i8 %20, %21
  store i8 %conv144, ptr %curr.11264, align 1, !tbaa !12
...
while.body352:                                    ; preds = %land.lhs.true336, %cleanup361
  ...
  %43 = load i8, ptr %emu.01275, align 1, !tbaa !12
  ...
  store i8 %call356, ptr %emu.01275, align 1, !tbaa !12
...
if.end422.us:                                     ; preds = %for.body371.us
  ...
  br i1 %exitcond1316.not, label %for.end426, label %for.body371.us, !llvm.loop !23
...
while.body405:                                    ; preds = %while.body405.preheader, %cleanup415
  ...
  %47 = load i8, ptr %emu.21278, align 1, !tbaa !12
  ...
  store i8 %call410, ptr %emu.21278, align 1, !tbaa !12
...
cleanup415:                                       ; preds = %while.body405
  ...
  br i1 %tobool404.not, label %if.end422, label %while.body405, !llvm.loop !24
...
if.end422:                                        ; preds = %cleanup415, %while.cond403.preheader, %for.body371
  ...
  br i1 %exitcond1315.not, label %for.end426, label %for.body371, !llvm.loop !23
...
for.inc516:                                       ; preds = %if.end480, %if.else502
  ...
  br i1 %exitcond1321.not, label %if.end536, label %for.body438, !llvm.loop !33
...
if.end530:                                        ; preds = %if.then527, %for.body524
  ...
  br i1 %exitcond1326.not, label %for.end534, label %for.body524, !llvm.loop !34
...
for.inc562:                                       ; preds = %for.body544, %land.lhs.true550
  ...
  br i1 %exitcond1331.not, label %if.else681, label %for.body544, !llvm.loop !35
...
if.end761:                                        ; preds = %if.then758, %cond.end713
  ...
  br i1 %exitcond1337.not, label %for.end765, label %cond.end713, !llvm.loop !37
...
for.body780:                                      ; preds = %for.body780.preheader, %for.body780
  ...
  br i1 %exitcond1343.not, label %for.end790, label %for.body780, !llvm.loop !39
