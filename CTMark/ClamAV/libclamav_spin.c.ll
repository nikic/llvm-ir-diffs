; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_spin.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_spin.c"
...
if.end19:                                         ; preds = %if.end
  ...
  %6 = load i8, ptr %add.ptr20, align 1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %reverse1382 = shufflevector <16 x i8> %10, <16 x i8> poison, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  store <16 x i8> %reverse1382, ptr %gep, align 1
  ...
  br i1 %11, label %vec.epilog.ph, label %vector.body

vec.epilog.ph:                                    ; preds = %vector.body
  %ind.end1385 = getelementptr i8, ptr %add.ptr13, i64 8166
  %ind.end1388 = add i8 %5, 4
  %.splatinsert1394 = insertelement <4 x i8> poison, i8 %ind.end1383, i64 0
  %.splat1395 = shufflevector <4 x i8> %.splatinsert1394, <4 x i8> poison, <4 x i32> zeroinitializer
  %induction1396 = add <4 x i8> %.splat1395, <i8 0, i8 -1, i8 -2, i8 -3>
  %12 = getelementptr i8, ptr %add.ptr13, i64 8175
  %wide.load1399 = load <4 x i8>, ptr %12, align 1
  %reverse1400 = shufflevector <4 x i8> %wide.load1399, <4 x i8> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %13 = xor <4 x i8> %reverse1400, %induction1396
  %reverse1401 = shufflevector <4 x i8> %13, <4 x i8> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  store <4 x i8> %reverse1401, ptr %12, align 1
  %vec.ind.next1398 = add <4 x i8> %.splat1395, <i8 -4, i8 -5, i8 -6, i8 -7>
  %14 = getelementptr i8, ptr %add.ptr13, i64 8171
  %wide.load1399.1 = load <4 x i8>, ptr %14, align 1
  %reverse1400.1 = shufflevector <4 x i8> %wide.load1399.1, <4 x i8> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %15 = xor <4 x i8> %reverse1400.1, %vec.ind.next1398
  %reverse1401.1 = shufflevector <4 x i8> %15, <4 x i8> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  store <4 x i8> %reverse1401.1, ptr %14, align 1
  %vec.ind.next1398.1 = add <4 x i8> %.splat1395, <i8 -8, i8 -9, i8 -10, i8 -11>
  %16 = getelementptr i8, ptr %add.ptr13, i64 8167
  %wide.load1399.2 = load <4 x i8>, ptr %16, align 1
  %reverse1400.2 = shufflevector <4 x i8> %wide.load1399.2, <4 x i8> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %17 = xor <4 x i8> %reverse1400.2, %vec.ind.next1398.1
  %reverse1401.2 = shufflevector <4 x i8> %17, <4 x i8> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  store <4 x i8> %reverse1401.2, ptr %16, align 1
  %18 = load i8, ptr %ind.end1385, align 1
  %dec118 = add i8 %5, 3
  %xor = xor i8 %18, %ind.end1388
  store i8 %xor, ptr %ind.end1385, align 1
  %incdec.ptr121 = getelementptr i8, ptr %add.ptr13, i64 8165
  %19 = load i8, ptr %incdec.ptr121, align 1
  %xor.1 = xor i8 %19, %dec118
  store i8 %xor.1, ptr %incdec.ptr121, align 1
...
if.then128:                                       ; preds = %vec.epilog.ph
  tail call void @free(ptr noundef nonnull %call) #8
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.1) #8
  br label %cleanup791

if.end129:                                        ; preds = %vec.epilog.ph
...
while.body134:                                    ; preds = %while.body134, %if.end129
  %curr.11264 = phi ptr [ %add.ptr130, %if.end129 ], [ %incdec.ptr145.1, %while.body134 ]
  %len.11263 = phi i32 [ 1440, %if.end129 ], [ %dec132.1, %while.body134 ]
  ...
  %20 = load i8, ptr %curr.11264, align 1
  %21 = trunc i32 %key32.1 to i8
  %conv144 = xor i8 %20, %21
  store i8 %conv144, ptr %curr.11264, align 1
  %incdec.ptr145 = getelementptr inbounds i8, ptr %curr.11264, i64 1
  %dec132.1 = add nsw i32 %len.11263, -2
  ...
  store i8 %conv144.1, ptr %incdec.ptr145, align 1
  %incdec.ptr145.1 = getelementptr inbounds i8, ptr %curr.11264, i64 2
  %tobool133.not.1 = icmp eq i32 %dec132.1, 0
  br i1 %tobool133.not.1, label %while.end146, label %while.body134
...
land.lhs.true189:                                 ; preds = %land.lhs.true185
  %add.ptr191 = getelementptr inbounds i8, ptr %add.ptr179.fr, i64 12811
...
if.end202:                                        ; preds = %land.lhs.true189
  ...
  %cmp2051269 = icmp slt i32 %sectcnt, 1
  br i1 %cmp2051269, label %for.end, label %for.body.preheader
...
for.body:                                         ; preds = %for.body.preheader, %if.end263
  ...
  %bitmap.01271 = phi i32 [ %add.ptr186.val, %for.body.preheader ], [ %shr264, %if.end263 ]
  %and207 = and i32 %bitmap.01271, 1
...
if.then209:                                       ; preds = %for.body
  ...
  %29 = load i32, ptr %rsz212, align 4
  %30 = add i32 %29, -1
...
land.lhs.true229:                                 ; preds = %if.then209
  ...
  %31 = load i32, ptr %raw215, align 4
...
while.body246.prol:                               ; preds = %while.body246.preheader
  %dec244.prol = add i32 %29, -1
  %32 = load i8, ptr %add.ptr217, align 1
  %conv258.prol = xor i8 %32, %28
  store i8 %conv258.prol, ptr %add.ptr217, align 1
...
while.body246.prol.loopexit:                      ; preds = %while.body246.prol, %while.body246.preheader
  ...
  %size.01266.unr = phi i32 [ %29, %while.body246.preheader ], [ %dec244.prol, %while.body246.prol ]
  %33 = icmp eq i32 %30, 0
...
while.body246:                                    ; preds = %while.body246.prol.loopexit, %while.body246
  ...
  %size.01266 = phi i32 [ %dec244.1, %while.body246 ], [ %size.01266.unr, %while.body246.prol.loopexit ]
  ...
  %37 = load i8, ptr %incdec.ptr259, align 1
  %38 = trunc i32 %keydup.1.1 to i8
  %conv258.1 = xor i8 %37, %38
  store i8 %conv258.1, ptr %incdec.ptr259, align 1
  %incdec.ptr259.1 = getelementptr inbounds i8, ptr %ptr.01267, i64 2
  %tobool245.not.1 = icmp eq i32 %dec244.1, 0
  br i1 %tobool245.not.1, label %if.end263, label %while.body246

if.end263:                                        ; preds = %while.body246.prol.loopexit, %while.body246, %for.body
  %shr264 = lshr i32 %bitmap.01271, 1
...
for.end:                                          ; preds = %if.end263, %if.end202
  ...
  %add.ptr265 = getelementptr inbounds i8, ptr %add.ptr179.fr, i64 1604
...
if.end270:                                        ; preds = %for.end
  %add.ptr271 = getelementptr inbounds i8, ptr %add.ptr179.fr, i64 1616
  ...
  %add.ptr273 = getelementptr inbounds i8, ptr %add.ptr179.fr, i64 10451
...
land.lhs.true285:                                 ; preds = %if.end270
  %add.ptr287 = getelementptr inbounds i8, ptr %add.ptr179.fr, i64 10835
...
while.body302:                                    ; preds = %land.lhs.true285, %while.body302
  ...
  %len.21273 = phi i32 [ %dec300.1, %while.body302 ], [ 384, %land.lhs.true285 ]
  %key32.21272 = phi i32 [ %key32.3.1, %while.body302 ], [ %add.ptr271.val, %land.lhs.true285 ]
  %and303 = and i32 %key32.21272, 1
  %tobool304.not = icmp eq i32 %and303, 0
  %shr306 = lshr i32 %key32.21272, 1
  %xor307 = xor i32 %shr306, -314331342
  %key32.3 = select i1 %tobool304.not, i32 %shr306, i32 %xor307
  %39 = load i8, ptr %curr.21274, align 1
  %40 = trunc i32 %key32.3 to i8
  %conv314 = xor i8 %39, %40
  store i8 %conv314, ptr %curr.21274, align 1
  %incdec.ptr315 = getelementptr inbounds i8, ptr %curr.21274, i64 1
  %dec300.1 = add nsw i32 %len.21273, -2
  ...
  %41 = load i8, ptr %incdec.ptr315, align 1
  %42 = trunc i32 %key32.3.1 to i8
  %conv314.1 = xor i8 %41, %42
  store i8 %conv314.1, ptr %incdec.ptr315, align 1
  %incdec.ptr315.1 = getelementptr inbounds i8, ptr %curr.21274, i64 2
  %tobool301.not.1 = icmp eq i32 %dec300.1, 0
  br i1 %tobool301.not.1, label %while.end316, label %while.body302

while.end316:                                     ; preds = %while.body302
  %add.ptr317 = getelementptr inbounds i8, ptr %add.ptr179.fr, i64 10461
...
if.end322:                                        ; preds = %while.end316
  ...
  %add.ptr323 = getelementptr inbounds i8, ptr %add.ptr179.fr, i64 10476
  %add.ptr324 = getelementptr inbounds i8, ptr %add.ptr179.fr, i64 1748
...
land.lhs.true336:                                 ; preds = %if.end322
  %add.ptr338 = getelementptr inbounds i8, ptr %add.ptr179.fr, i64 2165
...
while.body352:                                    ; preds = %land.lhs.true336, %cleanup361
  %len.31276 = phi i32 [ %dec353, %cleanup361 ], [ 417, %land.lhs.true336 ]
  %emu.01275 = phi ptr [ %incdec.ptr360, %cleanup361 ], [ %add.ptr324, %land.lhs.true336 ]
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %xcfailure) #8
  store i32 0, ptr %xcfailure, align 4
  %43 = load i8, ptr %emu.01275, align 1
  %conv355 = trunc i32 %len.31276 to i8
  ...
  store i8 %call356, ptr %emu.01275, align 1
  %44 = load i32, ptr %xcfailure, align 4
...
cleanup361:                                       ; preds = %while.body352
  %dec353 = add nsw i32 %len.31276, -1
  %incdec.ptr360 = getelementptr inbounds i8, ptr %emu.01275, i64 1
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %xcfailure) #8
  %tobool351.not = icmp eq i32 %dec353, 0
  br i1 %tobool351.not, label %while.end364, label %while.body352

while.end364:                                     ; preds = %cleanup361
  %add.ptr365 = getelementptr inbounds i8, ptr %add.ptr179.fr, i64 1777
  ...
  %add.ptr367 = getelementptr i8, ptr %add.ptr179.fr, i64 1877
  br i1 %cmp2051269, label %for.end426, label %for.body371.lr.ph

for.body371.lr.ph:                                ; preds = %while.end364
  %cmp389.not = icmp ult ptr %add.ptr367, %src
  %add.ptr392 = getelementptr inbounds i8, ptr %add.ptr179.fr, i64 1913
  %cmp395.not = icmp ule ptr %add.ptr392, %add.ptr193
  %cmp399 = icmp ugt ptr %add.ptr392, %src
  %or.cond1234 = and i1 %cmp395.not, %cmp399
  br i1 %cmp389.not, label %for.body371.us, label %for.body371.preheader

for.body371.preheader:                            ; preds = %for.body371.lr.ph
  %wide.trip.count1314 = zext i32 %sectcnt to i64
  br label %for.body371

for.body371.us:                                   ; preds = %for.body371.lr.ph, %if.end422.us
  %bitmap.11282.us = phi i32 [ %shr423.us, %if.end422.us ], [ %add.ptr365.val, %for.body371.lr.ph ]
  %j.11281.us = phi i32 [ %inc425.us, %if.end422.us ], [ 0, %for.body371.lr.ph ]
  %and372.us = and i32 %bitmap.11282.us, 1
  %tobool373.not.us = icmp eq i32 %and372.us, 0
  br i1 %tobool373.not.us, label %if.end422.us, label %if.then401

if.end422.us:                                     ; preds = %for.body371.us
  %shr423.us = lshr i32 %bitmap.11282.us, 1
  %inc425.us = add nuw nsw i32 %j.11281.us, 1
  %exitcond1316.not = icmp eq i32 %inc425.us, %sectcnt
  br i1 %exitcond1316.not, label %for.end426, label %for.body371.us

for.body371:                                      ; preds = %for.body371.preheader, %if.end422
  %indvars.iv1311 = phi i64 [ 0, %for.body371.preheader ], [ %indvars.iv.next1312, %if.end422 ]
  %bitmap.11282 = phi i32 [ %add.ptr365.val, %for.body371.preheader ], [ %shr423, %if.end422 ]
  %and372 = and i32 %bitmap.11282, 1
  %tobool373.not = icmp eq i32 %and372, 0
  br i1 %tobool373.not, label %if.end422, label %if.then374

if.then374:                                       ; preds = %for.body371
  br i1 %or.cond1234, label %while.cond403.preheader, label %if.then401
...
while.cond403.preheader:                          ; preds = %if.then374
  ...
  %45 = load i32, ptr %rsz377, align 4
  %tobool404.not1277 = icmp eq i32 %45, 0
  br i1 %tobool404.not1277, label %if.end422, label %while.body405.preheader
...
while.body405.preheader:                          ; preds = %while.cond403.preheader
  ...
  %46 = load i32, ptr %raw380, align 4
  %idx.ext381 = zext i32 %46 to i64
  %add.ptr382 = getelementptr inbounds i8, ptr %src, i64 %idx.ext381
  br label %while.body405

if.then401:                                       ; preds = %if.then374, %for.body371.us
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.17) #8
  br label %cleanup791

while.body405:                                    ; preds = %while.body405.preheader, %cleanup415
  %notthesamelen.01279 = phi i32 [ %dec407, %cleanup415 ], [ %45, %while.body405.preheader ]
  %emu.21278 = phi ptr [ %incdec.ptr414, %cleanup415 ], [ %add.ptr382, %while.body405.preheader ]
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %xcfailure406) #8
  store i32 0, ptr %xcfailure406, align 4
  %47 = load i8, ptr %emu.21278, align 1
  %conv409 = trunc i32 %notthesamelen.01279 to i8
  ...
  store i8 %call410, ptr %emu.21278, align 1
  %48 = load i32, ptr %xcfailure406, align 4
...
cleanup415:                                       ; preds = %while.body405
  %dec407 = add i32 %notthesamelen.01279, -1
  %incdec.ptr414 = getelementptr inbounds i8, ptr %emu.21278, i64 1
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %xcfailure406) #8
  %tobool404.not = icmp eq i32 %dec407, 0
  br i1 %tobool404.not, label %if.end422, label %while.body405

if.end422:                                        ; preds = %cleanup415, %while.cond403.preheader, %for.body371
  %shr423 = lshr i32 %bitmap.11282, 1
  %indvars.iv.next1312 = add nuw nsw i64 %indvars.iv1311, 1
  %exitcond1315.not = icmp eq i64 %indvars.iv.next1312, %wide.trip.count1314
  br i1 %exitcond1315.not, label %for.end426, label %for.body371

for.end426:                                       ; preds = %if.end422, %if.end422.us, %while.end364
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.12) #8
  %add.ptr427 = getelementptr inbounds i8, ptr %add.ptr179.fr, i64 12385
...
for.cond435.preheader:                            ; preds = %for.end426
  br i1 %cmp2051269, label %if.end536.thread, label %for.body438.lr.ph

for.body438.lr.ph:                                ; preds = %for.cond435.preheader
  %limits = getelementptr inbounds %struct.cli_ctx, ptr %ctx, i64 0, i32 4
  %wide.trip.count1320 = zext i32 %sectcnt to i64
  br label %for.body438

for.body438:                                      ; preds = %for.body438.lr.ph, %for.inc516
  %indvars.iv1317 = phi i64 [ 0, %for.body438.lr.ph ], [ %indvars.iv.next1318, %for.inc516 ]
  %bitmap.21286 = phi i32 [ %add.ptr427.val, %for.body438.lr.ph ], [ %shr512, %for.inc516 ]
  %blobsz.01284 = phi i32 [ 0, %for.body438.lr.ph ], [ %blobsz.1, %for.inc516 ]
  %and439 = and i32 %bitmap.21286, 1
  %tobool440.not = icmp eq i32 %and439, 0
  %vsz = getelementptr inbounds %struct.cli_exe_section, ptr %sections, i64 %indvars.iv1317, i32 1
  %rsz445 = getelementptr inbounds %struct.cli_exe_section, ptr %sections, i64 %indvars.iv1317, i32 3
  %cond.in = select i1 %tobool440.not, ptr %rsz445, ptr %vsz
  %cond = load i32, ptr %cond.in, align 4
  %49 = load ptr, ptr %limits, align 8
...
land.lhs.true447:                                 ; preds = %for.body438
  ...
  %50 = load i64, ptr %maxfilesize, align 8
...
lor.lhs.false456:                                 ; preds = %land.lhs.true450
  %conv457 = sext i32 %blobsz.01284 to i64
...
if.then464:                                       ; preds = %lor.lhs.false456, %land.lhs.true450
  %51 = trunc i64 %indvars.iv1317 to i32
...
if.else502:                                       ; preds = %if.end468
  %raw506 = getelementptr inbounds %struct.cli_exe_section, ptr %sections, i64 %indvars.iv1317, i32 2
  %58 = load i32, ptr %raw506, align 4
  %idx.ext507 = zext i32 %58 to i64
  %add.ptr508 = getelementptr inbounds i8, ptr %src, i64 %idx.ext507
  %arrayidx510 = getelementptr inbounds ptr, ptr %call430, i64 %indvars.iv1317
  store ptr %add.ptr508, ptr %arrayidx510, align 8
  %59 = trunc i64 %indvars.iv1317 to i32
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.24, i32 noundef %59) #8
  br label %for.inc516

for.inc516:                                       ; preds = %if.end480, %if.else502
  %blobsz.1 = add i32 %cond, %blobsz.01284
  %shr512 = lshr i32 %bitmap.21286, 1
  %indvars.iv.next1318 = add nuw nsw i64 %indvars.iv1317, 1
  %exitcond1321.not = icmp eq i64 %indvars.iv.next1318, %wide.trip.count1320
  br i1 %exitcond1321.not, label %if.end536, label %for.body438
...
for.end518:                                       ; preds = %if.then464, %if.then478, %if.then498
  ...
  %cmp5221297 = icmp sgt i32 %j.3.ph, 0
  br i1 %cmp5221297, label %for.body524.preheader, label %for.end534

for.body524.preheader:                            ; preds = %for.end518
  %wide.trip.count1325 = zext i32 %j.3.ph to i64
  br label %for.body524

for.body524:                                      ; preds = %for.body524.preheader, %if.end530
  %indvars.iv1322 = phi i64 [ 0, %for.body524.preheader ], [ %indvars.iv.next1323, %if.end530 ]
  %bitman.01298 = phi i32 [ %add.ptr427.val, %for.body524.preheader ], [ %shr531, %if.end530 ]
  %and525 = and i32 %bitman.01298, 1
  %tobool526.not = icmp eq i32 %and525, 0
  br i1 %tobool526.not, label %if.end530, label %if.then527

if.then527:                                       ; preds = %for.body524
  %arrayidx529 = getelementptr inbounds ptr, ptr %call430, i64 %indvars.iv1322
  %60 = load ptr, ptr %arrayidx529, align 8
  tail call void @free(ptr noundef %60) #8
  br label %if.end530

if.end530:                                        ; preds = %if.then527, %for.body524
  %shr531 = lshr i32 %bitman.01298, 1
  %indvars.iv.next1323 = add nuw nsw i64 %indvars.iv1322, 1
  %exitcond1326.not = icmp eq i64 %indvars.iv.next1323, %wide.trip.count1325
  br i1 %exitcond1326.not, label %for.end534, label %for.body524
...
if.end536:                                        ; preds = %for.inc516
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.25) #8
  %add.ptr537 = getelementptr inbounds i8, ptr %add.ptr179.fr, i64 12270
...
if.end536.thread:                                 ; preds = %for.cond435.preheader
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.25) #8
  %add.ptr5371345 = getelementptr inbounds i8, ptr %add.ptr179.fr, i64 12270
  %add.ptr537.val1346 = load i32, ptr %add.ptr5371345, align 1
  %tobool539.not1347 = icmp eq i32 %add.ptr537.val1346, 0
  br i1 %tobool539.not1347, label %if.end683, label %for.end564

for.cond541.preheader:                            ; preds = %if.end536
  br i1 %cmp2051269, label %for.end564, label %for.body544.preheader

for.body544.preheader:                            ; preds = %for.cond541.preheader
  %wide.trip.count1330 = zext i32 %sectcnt to i64
  br label %for.body544

for.body544:                                      ; preds = %for.body544.preheader, %for.inc562
  %indvars.iv1327 = phi i64 [ 0, %for.body544.preheader ], [ %indvars.iv.next1328, %for.inc562 ]
  %arrayidx546 = getelementptr inbounds %struct.cli_exe_section, ptr %sections, i64 %indvars.iv1327
  %61 = load i32, ptr %arrayidx546, align 4
...
land.lhs.true550:                                 ; preds = %for.body544
  %rsz556 = getelementptr inbounds %struct.cli_exe_section, ptr %sections, i64 %indvars.iv1327, i32 3
  %62 = load i32, ptr %rsz556, align 4
...
for.inc562:                                       ; preds = %for.body544, %land.lhs.true550
  ...
  br i1 %exitcond1331.not, label %if.else681, label %for.body544

for.end564.loopexit:                              ; preds = %land.lhs.true550
  %63 = trunc i64 %indvars.iv1327 to i32
  br label %for.end564

for.end564:                                       ; preds = %for.end564.loopexit, %if.end536.thread, %for.cond541.preheader
  %blobsz.0.lcssa13481353 = phi i32 [ %blobsz.1, %for.cond541.preheader ], [ 0, %if.end536.thread ], [ %blobsz.1, %for.end564.loopexit ]
  %add.ptr537.val13491352 = phi i32 [ %add.ptr537.val, %for.cond541.preheader ], [ %add.ptr537.val1346, %if.end536.thread ], [ %add.ptr537.val, %for.end564.loopexit ]
...
if.then571:                                       ; preds = %land.lhs.true567
  ...
  %64 = load i32, ptr %arrayidx573, align 4
  %sub578 = sub i32 %add.ptr537.val13491352, %64
  %vsz581 = getelementptr inbounds %struct.cli_exe_section, ptr %sections, i64 %idxprom572, i32 1
  %65 = load i32, ptr %vsz581, align 4
  %sub586 = sub i32 %65, %sub578
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.26, i32 noundef %j.5.lcssa, i32 noundef %64, i32 noundef %sub578, i32 noundef %add.ptr537.val13491352, i32 noundef %sub586) #8
  %66 = load i32, ptr %vsz581, align 4
...
if.then594:                                       ; preds = %if.then571
  ...
  %67 = load i32, ptr %raw597, align 4
  %idx.ext598 = zext i32 %67 to i64
  %add.ptr599 = getelementptr inbounds i8, ptr %src, i64 %idx.ext598
  %68 = load i32, ptr %arrayidx573, align 4
  %sub603 = sub i32 %add.ptr537.val13491352, %68
  ...
  %idx.ext605 = zext i32 %add.ptr537.val13491352 to i64
  %add.ptr606 = getelementptr inbounds i8, ptr %call591, i64 %idx.ext605
  %69 = load i32, ptr %arrayidx573, align 4
  ...
  %70 = load i32, ptr %vsz581, align 4
  %sub619.neg = sub i32 %69, %add.ptr537.val13491352
  ...
  %71 = load i32, ptr %raw597, align 4
  ...
  %72 = load i32, ptr %arrayidx573, align 4
  ...
  %73 = load i32, ptr %rsz645, align 4
  %sub649 = sub i32 %add.ptr537.val13491352, %72
  %sub650 = sub i32 %73, %sub649
  %74 = load i32, ptr %vsz581, align 4
...
if.then661:                                       ; preds = %if.then594
  ...
  %75 = load i32, ptr %rsz645, align 4
  %add665 = add i32 %75, %blobsz.0.lcssa13481353
  br label %if.end683

if.else666:                                       ; preds = %if.then594
  %arrayidx668 = getelementptr inbounds ptr, ptr %call430, i64 %idxprom572
  store ptr %call591, ptr %arrayidx668, align 8
  %or = or i32 %shl, %add.ptr427.val
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.28) #8
  %76 = load i32, ptr %vsz581, align 4
  %add673 = add i32 %76, %blobsz.0.lcssa13481353
  br label %if.end683

if.else675:                                       ; preds = %if.then571
  %rsz678 = getelementptr inbounds %struct.cli_exe_section, ptr %sections, i64 %idxprom572, i32 3
  %77 = load i32, ptr %rsz678, align 4
  %add679 = add i32 %77, %blobsz.0.lcssa13481353
  br label %if.end683

if.else681:                                       ; preds = %for.inc562, %land.lhs.true567, %for.end564
  %blobsz.0.lcssa134813531358 = phi i32 [ %blobsz.0.lcssa13481353, %land.lhs.true567 ], [ %blobsz.0.lcssa13481353, %for.end564 ], [ %blobsz.1, %for.inc562 ]
...
if.end683:                                        ; preds = %if.end536.thread, %if.else681, %if.then661, %if.else666, %if.else675, %if.end536
  %blobsz.4 = phi i32 [ %add665, %if.then661 ], [ %add673, %if.else666 ], [ %add679, %if.else675 ], [ %blobsz.0.lcssa134813531358, %if.else681 ], [ %blobsz.1, %if.end536 ], [ 0, %if.end536.thread ]
...
for.cond696.preheader:                            ; preds = %if.then688
  br i1 %cmp2051269, label %for.end765, label %cond.end713.peel

cond.end713.peel:                                 ; preds = %for.cond696.preheader
  %wide.trip.count1336 = zext i32 %sectcnt to i64
  %raw717.peel = getelementptr inbounds %struct.cli_exe_section, ptr %call691, i64 0, i32 2
  store i32 0, ptr %raw717.peel, align 4
  ...
  %cond729.peel = load i32, ptr %cond729.in.peel, align 4
  %rsz732.peel = getelementptr inbounds %struct.cli_exe_section, ptr %call691, i64 0, i32 3
  store i32 %cond729.peel, ptr %rsz732.peel, align 4
  %78 = load <2 x i32>, ptr %sections, align 4
  store <2 x i32> %78, ptr %call691, align 4
  %79 = load ptr, ptr %call430, align 8
  ...
  %80 = load i32, ptr %rsz732.peel, align 4
...
if.then758.peel:                                  ; preds = %cond.end713.peel
  %81 = load ptr, ptr %call430, align 8
  tail call void @free(ptr noundef %81) #8
  br label %if.end761.peel

if.end761.peel:                                   ; preds = %if.then758.peel, %cond.end713.peel
  %exitcond1337.peel.not = icmp eq i32 %sectcnt, 1
  br i1 %exitcond1337.peel.not, label %for.end765, label %cond.end713

cond.end713:                                      ; preds = %if.end761.peel, %if.end761
  %indvars.iv1332 = phi i64 [ %indvars.iv.next1333, %if.end761 ], [ 1, %if.end761.peel ]
  %to.01294 = phi ptr [ %add.ptr755, %if.end761 ], [ %add.ptr755.peel, %if.end761.peel ]
  %bitmap.41293.in = phi i32 [ %bitmap.41293, %if.end761 ], [ %bitman.1, %if.end761.peel ]
  %bitmap.41293 = lshr i32 %bitmap.41293.in, 1
  %82 = add nuw i64 %indvars.iv1332, 4294967295
  %idxprom704 = and i64 %82, 4294967295
  %rsz710 = getelementptr inbounds %struct.cli_exe_section, ptr %call691, i64 %idxprom704, i32 3
  %83 = load i32, ptr %rsz710, align 4
  %raw706 = getelementptr inbounds %struct.cli_exe_section, ptr %call691, i64 %idxprom704, i32 2
  %84 = load i32, ptr %raw706, align 4
  %add711 = add i32 %83, %84
  %arrayidx716 = getelementptr inbounds %struct.cli_exe_section, ptr %call691, i64 %indvars.iv1332
  %raw717 = getelementptr inbounds %struct.cli_exe_section, ptr %call691, i64 %indvars.iv1332, i32 2
  store i32 %add711, ptr %raw717, align 4
  %85 = and i32 %bitmap.41293.in, 2
  %tobool719.not = icmp eq i32 %85, 0
  %vsz723 = getelementptr inbounds %struct.cli_exe_section, ptr %sections, i64 %indvars.iv1332, i32 1
  %rsz727 = getelementptr inbounds %struct.cli_exe_section, ptr %sections, i64 %indvars.iv1332, i32 3
  %cond729.in = select i1 %tobool719.not, ptr %rsz727, ptr %vsz723
  %cond729 = load i32, ptr %cond729.in, align 4
  %rsz732 = getelementptr inbounds %struct.cli_exe_section, ptr %call691, i64 %indvars.iv1332, i32 3
  store i32 %cond729, ptr %rsz732, align 4
  %arrayidx734 = getelementptr inbounds %struct.cli_exe_section, ptr %sections, i64 %indvars.iv1332
  %86 = load <2 x i32>, ptr %arrayidx734, align 4
  store <2 x i32> %86, ptr %arrayidx716, align 4
  %arrayidx746 = getelementptr inbounds ptr, ptr %call430, i64 %indvars.iv1332
  %87 = load ptr, ptr %arrayidx746, align 8
  %conv750 = zext i32 %cond729 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %to.01294, ptr align 1 %87, i64 %conv750, i1 false)
  %88 = load i32, ptr %rsz732, align 4
  %idx.ext754 = zext i32 %88 to i64
  %add.ptr755 = getelementptr inbounds i8, ptr %to.01294, i64 %idx.ext754
  br i1 %tobool719.not, label %if.end761, label %if.then758

if.then758:                                       ; preds = %cond.end713
  %89 = load ptr, ptr %arrayidx746, align 8
...
if.end761:                                        ; preds = %if.then758, %cond.end713
  ...
  br i1 %exitcond1337.not, label %for.end765, label %cond.end713
...
if.end776:                                        ; preds = %cleanup773.thread, %if.end683
  ...
  %or.cond = or i1 %cmp2051269, %tobool782.not
  br i1 %or.cond, label %for.end790, label %for.body780.preheader

for.body780.preheader:                            ; preds = %if.end776
  %wide.trip.count1342 = zext i32 %sectcnt to i64
  br label %for.body780

for.body780:                                      ; preds = %for.body780.preheader, %for.body780
  %indvars.iv1339 = phi i64 [ 0, %for.body780.preheader ], [ %indvars.iv.next1340, %for.body780 ]
  %arrayidx785 = getelementptr inbounds ptr, ptr %call430, i64 %indvars.iv1339
  %90 = load ptr, ptr %arrayidx785, align 8
  ...
  br i1 %exitcond1343.not, label %for.end790, label %for.body780
...
while.body:                                       ; preds = %entry, %while.body
  ...
  %0 = load i8, ptr %src.addr.035, align 1
...
sw.bb45:                                          ; preds = %while.body
  ...
  %aelle.addr.1 = add i8 %aelle.addr.1.v, %aelle.addr.0169
