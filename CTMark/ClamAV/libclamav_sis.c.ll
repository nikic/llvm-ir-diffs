; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_sis.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_sis.c"
...
land.lhs.true128:                                 ; preds = %if.end125
  ...
  %6 = load i32, ptr %maxfiles, align 4
...
if.then137:                                       ; preds = %land.lhs.true128
  ...
  %7 = load i32, ptr %options140, align 8
...
for.body169.lr.ph:                                ; preds = %for.cond165.preheader
  ...
  %add225 = add nuw nsw i32 %mul223, 36
...
if.then190:                                       ; preds = %sw.bb184
  ...
  %10 = load i8, ptr @cli_leavetemps_flag, align 1
...
if.then211:                                       ; preds = %sw.bb205
  ...
  %11 = load i8, ptr @cli_leavetemps_flag, align 1
...
if.then221:                                       ; preds = %if.end217
  %add226 = add i32 %add225, %frecord.0492
  br label %for.inc307
...
if.then260:                                       ; preds = %lor.lhs.false252, %if.end245
  ...
  %13 = load i8, ptr @cli_leavetemps_flag, align 1
...
if.end266:                                        ; preds = %lor.lhs.false252
  %add271 = add i32 %frecord.0492, 24
  %add272 = add i32 %add271, %mul255
  br label %for.inc307
...
if.then278:                                       ; preds = %sw.bb273
  ...
  %14 = load i8, ptr @cli_leavetemps_flag, align 1
...
if.then292:                                       ; preds = %if.end284
  ...
  %15 = load i8, ptr @cli_leavetemps_flag, align 1
...
for.inc307:                                       ; preds = %if.end266, %if.end298, %sw.bb301, %sw.bb303, %sw.default305, %if.else202, %if.then200, %if.else227, %if.then221
  ...
  br i1 %exitcond495.not, label %for.end309, label %for.body169
...
for.end309:                                       ; preds = %for.inc307, %for.cond165.preheader
  ...
  %16 = load i8, ptr @cli_leavetemps_flag, align 1
...
sw.epilog29:                                      ; preds = %sw.epilog, %sw.bb18, %sw.bb19, %sw.default20, %sw.default28, %sw.bb4, %sw.bb3, %sw.bb
  %tobool55.not = phi i1 [ false, %sw.default28 ], [ false, %sw.default20 ], [ false, %sw.bb19 ], [ false, %sw.bb18 ], [ false, %sw.epilog ], [ true, %sw.bb4 ], [ true, %sw.bb3 ], [ false, %sw.bb ]
  %tobool98.not = phi i1 [ true, %sw.default28 ], [ false, %sw.default20 ], [ false, %sw.bb19 ], [ false, %sw.bb18 ], [ false, %sw.epilog ], [ false, %sw.bb4 ], [ false, %sw.bb3 ], [ false, %sw.bb ]
  %typedir.0 = phi ptr [ null, %sw.default28 ], [ @.str.157, %sw.default20 ], [ @.str.157, %sw.bb19 ], [ @.str.157, %sw.bb18 ], [ @.str.157, %sw.epilog ], [ @.str.155, %sw.bb4 ], [ @.str.153, %sw.bb3 ], [ @.str.151, %sw.bb ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <32 x i8>, ptr %gep, align 1
  ...
  store <16 x i8> %13, ptr %10, align 1
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.vec24 = load <16 x i8>, ptr %gep101, align 1
  ...
  store <8 x i8> %20, ptr %17, align 1
...
for.body.i.preheader:                             ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv50.i.ph = phi i64 [ 0, %iter.check ], [ 0, %vector.memcheck ], [ %ind.end19, %vec.epilog.iter.check ], [ %ind.end, %vec.epilog.middle.block ]
...
for.body.i.prol:                                  ; preds = %for.body.i.preheader
  %25 = or i64 %indvars.iv50.i.ph, 1
  %arrayidx.i.prol = getelementptr inbounds i8, ptr %add.ptr49, i64 %25
  %26 = load i8, ptr %arrayidx.i.prol, align 1
  %shl.i.prol = shl i8 %26, 4
  %arrayidx10.i.prol = getelementptr inbounds i8, ptr %call.i, i64 %indvars.iv.i.ph
  store i8 %shl.i.prol, ptr %arrayidx10.i.prol, align 1
  %arrayidx12.i.prol = getelementptr inbounds i8, ptr %add.ptr49, i64 %indvars.iv50.i.ph
  %27 = load i8, ptr %arrayidx12.i.prol, align 1
  ...
  store i8 %spec.select.i.prol, ptr %arrayidx10.i.prol, align 1
  %indvars.iv.next51.i.prol = add nuw nsw i64 %indvars.iv50.i.ph, 2
  %indvars.iv.next.i.prol = or i64 %indvars.iv.i.ph, 1
  br label %for.body.i.prol.loopexit

for.body.i.prol.loopexit:                         ; preds = %for.body.i.prol, %for.body.i.preheader
  %indvars.iv50.i.unr = phi i64 [ %indvars.iv50.i.ph, %for.body.i.preheader ], [ %indvars.iv.next51.i.prol, %for.body.i.prol ]
  %indvars.iv.i.unr = phi i64 [ %indvars.iv.i.ph, %for.body.i.preheader ], [ %indvars.iv.next.i.prol, %for.body.i.prol ]
  %28 = icmp eq i64 %indvars.iv.i.ph, %23
  br i1 %28, label %if.then51, label %for.body.i

for.body.i:                                       ; preds = %for.body.i.prol.loopexit, %for.body.i
  %indvars.iv50.i = phi i64 [ %indvars.iv.next51.i.1, %for.body.i ], [ %indvars.iv50.i.unr, %for.body.i.prol.loopexit ]
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i.1, %for.body.i ], [ %indvars.iv.i.unr, %for.body.i.prol.loopexit ]
  %29 = or i64 %indvars.iv50.i, 1
  ...
  %arrayidx12.i = getelementptr inbounds i8, ptr %add.ptr49, i64 %indvars.iv50.i
  ...
  store i8 %spec.select.i, ptr %arrayidx10.i, align 1
  %indvars.iv.next51.i = add nuw nsw i64 %indvars.iv50.i, 2
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %32 = or i64 %indvars.iv.next51.i, 1
  ...
  store i8 %shl.i.1, ptr %arrayidx10.i.1, align 1
  %arrayidx12.i.1 = getelementptr inbounds i8, ptr %add.ptr49, i64 %indvars.iv.next51.i
  %34 = load i8, ptr %arrayidx12.i.1, align 1
  %add17.i.1 = add i8 %34, %shl.i.1
  %cmp22.i.1 = icmp eq i8 %add17.i.1, 37
  %spec.select.i.1 = select i1 %cmp22.i.1, i8 95, i8 %add17.i.1
  store i8 %spec.select.i.1, ptr %arrayidx10.i.1, align 1
  %indvars.iv.next51.i.1 = add nuw nsw i64 %indvars.iv50.i, 4
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2
  %exitcond.not.i.1 = icmp eq i64 %indvars.iv.next.i.1, %wide.trip.count.i
  br i1 %exitcond.not.i.1, label %if.then51, label %for.body.i
...
if.end79:                                         ; preds = %if.else64
  ...
  br i1 %or.cond.i435, label %if.end.i438, label %if.then.i436

if.then.i436:                                     ; preds = %if.end79
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.193, i32 noundef %add.ptr59.val) #11
  br label %if.else85

if.end.i438:                                      ; preds = %if.end79
  %div47.i439 = lshr i32 %add.ptr59.val, 1
  %add.i440 = add nuw nsw i32 %div47.i439, 1
  %conv.i441 = zext i32 %add.i440 to i64
  %call.i442 = tail call ptr @cli_calloc(i64 noundef %conv.i441, i64 noundef 1) #11
  %tobool2.not.i443 = icmp eq ptr %call.i442, null
  br i1 %tobool2.not.i443, label %if.else85, label %iter.check37

iter.check37:                                     ; preds = %if.end.i438
  %35 = add i32 %add.ptr59.val, -1
  %36 = lshr i32 %35, 1
  %37 = add nuw nsw i32 %36, 1
  %wide.trip.count.i445 = zext i32 %37 to i64
  %min.iters.check35 = icmp ult i32 %add.ptr59.val, 15
  br i1 %min.iters.check35, label %for.body.i446.preheader, label %vector.memcheck28

vector.memcheck28:                                ; preds = %iter.check37
  %scevgep29 = getelementptr i8, ptr %call.i442, i64 %wide.trip.count.i445
  %38 = and i32 %35, -2
  %39 = zext i32 %38 to i64
  %40 = add nuw nsw i64 %39, %idx.ext80
  %41 = add nuw nsw i64 %40, 2
  %scevgep30 = getelementptr i8, ptr %mfile, i64 %41
  %bound031 = icmp ult ptr %call.i442, %scevgep30
  %bound132 = icmp ult ptr %add.ptr81, %scevgep29
  %found.conflict33 = and i1 %bound031, %bound132
  br i1 %found.conflict33, label %for.body.i446.preheader, label %vector.main.loop.iter.check39
...
vector.ph40:                                      ; preds = %vector.main.loop.iter.check39
  %n.vec42 = and i64 %wide.trip.count.i445, 2147483632
...
vector.body44:                                    ; preds = %vector.body44, %vector.ph40
  ...
  %wide.vec47 = load <32 x i8>, ptr %gep103, align 1
  ...
  %44 = getelementptr inbounds i8, ptr %call.i442, i64 %index45
  ...
  store <16 x i8> %47, ptr %44, align 1
  %index.next50 = add nuw i64 %index45, 16
  %48 = icmp eq i64 %index.next50, %n.vec42
  br i1 %48, label %middle.block34, label %vector.body44

middle.block34:                                   ; preds = %vector.body44
  %cmp.n43 = icmp eq i64 %n.vec42, %wide.trip.count.i445
...
vec.epilog.iter.check53:                          ; preds = %middle.block34
  ...
  %n.vec.remaining55 = and i64 %wide.trip.count.i445, 8
  %min.epilog.iters.check56.not.not = icmp eq i64 %n.vec.remaining55, 0
  br i1 %min.epilog.iters.check56.not.not, label %for.body.i446.preheader, label %vec.epilog.ph54
...
vec.epilog.ph54:                                  ; preds = %vector.main.loop.iter.check39, %vec.epilog.iter.check53
  ...
  %n.vec59 = and i64 %wide.trip.count.i445, 2147483640
...
vec.epilog.vector.body65:                         ; preds = %vec.epilog.vector.body65, %vec.epilog.ph54
  ...
  %wide.vec68 = load <16 x i8>, ptr %gep105, align 1
  ...
  %51 = getelementptr inbounds i8, ptr %call.i442, i64 %index66
  ...
  store <8 x i8> %54, ptr %51, align 1
  %index.next71 = add nuw i64 %index66, 8
  %55 = icmp eq i64 %index.next71, %n.vec59
  br i1 %55, label %vec.epilog.middle.block51, label %vec.epilog.vector.body65

vec.epilog.middle.block51:                        ; preds = %vec.epilog.vector.body65
  %cmp.n64 = icmp eq i64 %n.vec59, %wide.trip.count.i445
  br i1 %cmp.n64, label %if.then84, label %for.body.i446.preheader

for.body.i446.preheader:                          ; preds = %vector.memcheck28, %iter.check37, %vec.epilog.iter.check53, %vec.epilog.middle.block51
  %indvars.iv50.i447.ph = phi i64 [ 0, %iter.check37 ], [ 0, %vector.memcheck28 ], [ %ind.end61, %vec.epilog.iter.check53 ], [ %ind.end60, %vec.epilog.middle.block51 ]
  %indvars.iv.i448.ph = phi i64 [ 0, %iter.check37 ], [ 0, %vector.memcheck28 ], [ %n.vec42, %vec.epilog.iter.check53 ], [ %n.vec59, %vec.epilog.middle.block51 ]
  %56 = lshr i32 %35, 1
  %57 = zext i32 %56 to i64
  %58 = and i64 %57, 1
  %lcmp.mod86.not.not = icmp eq i64 %58, 0
  br i1 %lcmp.mod86.not.not, label %for.body.i446.prol, label %for.body.i446.prol.loopexit

for.body.i446.prol:                               ; preds = %for.body.i446.preheader
  %59 = or i64 %indvars.iv50.i447.ph, 1
  %arrayidx.i449.prol = getelementptr inbounds i8, ptr %add.ptr81, i64 %59
  %60 = load i8, ptr %arrayidx.i449.prol, align 1
  %shl.i450.prol = shl i8 %60, 4
  %arrayidx10.i451.prol = getelementptr inbounds i8, ptr %call.i442, i64 %indvars.iv.i448.ph
  store i8 %shl.i450.prol, ptr %arrayidx10.i451.prol, align 1
  %arrayidx12.i452.prol = getelementptr inbounds i8, ptr %add.ptr81, i64 %indvars.iv50.i447.ph
  %61 = load i8, ptr %arrayidx12.i452.prol, align 1
  %add17.i453.prol = add i8 %61, %shl.i450.prol
  %cmp22.i454.prol = icmp eq i8 %add17.i453.prol, 37
  %spec.select.i455.prol = select i1 %cmp22.i454.prol, i8 95, i8 %add17.i453.prol
  store i8 %spec.select.i455.prol, ptr %arrayidx10.i451.prol, align 1
  %indvars.iv.next51.i456.prol = add nuw nsw i64 %indvars.iv50.i447.ph, 2
  %indvars.iv.next.i457.prol = or i64 %indvars.iv.i448.ph, 1
  br label %for.body.i446.prol.loopexit

for.body.i446.prol.loopexit:                      ; preds = %for.body.i446.prol, %for.body.i446.preheader
  %indvars.iv50.i447.unr = phi i64 [ %indvars.iv50.i447.ph, %for.body.i446.preheader ], [ %indvars.iv.next51.i456.prol, %for.body.i446.prol ]
  %indvars.iv.i448.unr = phi i64 [ %indvars.iv.i448.ph, %for.body.i446.preheader ], [ %indvars.iv.next.i457.prol, %for.body.i446.prol ]
  %62 = icmp eq i64 %indvars.iv.i448.ph, %57
  br i1 %62, label %if.then84, label %for.body.i446

for.body.i446:                                    ; preds = %for.body.i446.prol.loopexit, %for.body.i446
  %indvars.iv50.i447 = phi i64 [ %indvars.iv.next51.i456.1, %for.body.i446 ], [ %indvars.iv50.i447.unr, %for.body.i446.prol.loopexit ]
  %indvars.iv.i448 = phi i64 [ %indvars.iv.next.i457.1, %for.body.i446 ], [ %indvars.iv.i448.unr, %for.body.i446.prol.loopexit ]
  %63 = or i64 %indvars.iv50.i447, 1
  %arrayidx.i449 = getelementptr inbounds i8, ptr %add.ptr81, i64 %63
  %64 = load i8, ptr %arrayidx.i449, align 1
  %shl.i450 = shl i8 %64, 4
  %arrayidx10.i451 = getelementptr inbounds i8, ptr %call.i442, i64 %indvars.iv.i448
  store i8 %shl.i450, ptr %arrayidx10.i451, align 1
  %arrayidx12.i452 = getelementptr inbounds i8, ptr %add.ptr81, i64 %indvars.iv50.i447
  %65 = load i8, ptr %arrayidx12.i452, align 1
  %add17.i453 = add i8 %65, %shl.i450
  %cmp22.i454 = icmp eq i8 %add17.i453, 37
  %spec.select.i455 = select i1 %cmp22.i454, i8 95, i8 %add17.i453
  store i8 %spec.select.i455, ptr %arrayidx10.i451, align 1
  %indvars.iv.next51.i456 = add nuw nsw i64 %indvars.iv50.i447, 2
  %indvars.iv.next.i457 = add nuw nsw i64 %indvars.iv.i448, 1
  %66 = or i64 %indvars.iv.next51.i456, 1
  %arrayidx.i449.1 = getelementptr inbounds i8, ptr %add.ptr81, i64 %66
  %67 = load i8, ptr %arrayidx.i449.1, align 1
  %shl.i450.1 = shl i8 %67, 4
  %arrayidx10.i451.1 = getelementptr inbounds i8, ptr %call.i442, i64 %indvars.iv.next.i457
  store i8 %shl.i450.1, ptr %arrayidx10.i451.1, align 1
  %arrayidx12.i452.1 = getelementptr inbounds i8, ptr %add.ptr81, i64 %indvars.iv.next51.i456
  %68 = load i8, ptr %arrayidx12.i452.1, align 1
  %add17.i453.1 = add i8 %68, %shl.i450.1
  %cmp22.i454.1 = icmp eq i8 %add17.i453.1, 37
  %spec.select.i455.1 = select i1 %cmp22.i454.1, i8 95, i8 %add17.i453.1
  store i8 %spec.select.i455.1, ptr %arrayidx10.i451.1, align 1
  %indvars.iv.next51.i456.1 = add nuw nsw i64 %indvars.iv50.i447, 4
  %indvars.iv.next.i457.1 = add nuw nsw i64 %indvars.iv.i448, 2
  %exitcond.not.i458.1 = icmp eq i64 %indvars.iv.next.i457.1, %wide.trip.count.i445
  br i1 %exitcond.not.i458.1, label %if.then84, label %for.body.i446

if.then84:                                        ; preds = %for.body.i446.prol.loopexit, %for.body.i446, %vec.epilog.middle.block51, %middle.block34
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.173, ptr noundef nonnull %call.i442) #11
  br label %if.end88

if.else85:                                        ; preds = %if.then.i436, %if.end.i438
  tail call void (ptr, ...) @cli_warnmsg(ptr noundef nonnull @.str.174) #11
  br label %if.end88

if.end88:                                         ; preds = %if.then63, %if.else85, %if.then84, %if.end54
  %dname.0 = phi ptr [ null, %if.then63 ], [ %call.i442, %if.then84 ], [ null, %if.else85 ], [ null, %if.end54 ]
...
if.end165:                                        ; preds = %if.end157
  %call166 = call ptr @cli_gentemp(ptr noundef nonnull %subdir.0) #11
...
if.then171:                                       ; preds = %if.end169
  ...
  store i64 %conv184, ptr %osize, align 8
...
land.lhs.true:                                    ; preds = %if.end187
  ...
  %74 = load i64, ptr %maxfilesize, align 8
...
if.then198:                                       ; preds = %land.lhs.true193
  ...
  %76 = load i32, ptr %options, align 8
...
lor.lhs.false210:                                 ; preds = %if.end206
  %79 = load ptr, ptr %limits, align 8
...
land.lhs.true213:                                 ; preds = %lor.lhs.false210
  ...
  %80 = load i64, ptr %maxfilesize215, align 8
...
if.then222:                                       ; preds = %land.lhs.true213, %if.end206
  store i64 %mul207, ptr %osize, align 8
  br label %if.end224
