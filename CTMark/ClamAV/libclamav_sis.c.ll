...
for.body.i446.prol:                               ; preds = %for.body.i446.preheader
  ...
  store i8 %spec.select.i455.prol, ptr %arrayidx10.i451.prol, align 1, !tbaa !5
...
for.body.i446:                                    ; preds = %for.body.i446.prol.loopexit, %for.body.i446
  ...
  store i8 %spec.select.i455, ptr %arrayidx10.i451, align 1, !tbaa !5
  ...
  store i8 %spec.select.i455.1, ptr %arrayidx10.i451.1, align 1, !tbaa !5
  ...
  br i1 %exitcond.not.i458.1, label %if.then84, label %for.body.i446, !llvm.loop !54
