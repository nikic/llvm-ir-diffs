; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_matcher-bm.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_matcher-bm.c"
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %2 = load ptr, ptr %bm_suffix, align 8
  br label %for.body
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %i.0199 = phi i16 [ 0, %for.body.lr.ph ], [ %inc, %for.inc ]
  %idxprom = zext i16 %i.0199 to i64
...
if.then25:                                        ; preds = %for.body
  %tobool26.not = icmp eq i16 %i.0199, 0
...
if.then27:                                        ; preds = %if.then25
  ...
  store i16 %i.0199, ptr %prefix_length, align 2
  store ptr %arrayidx.le, ptr %pattern, align 8
  %sub36 = sub i16 %1, %i.0199
  store i16 %sub36, ptr %length, align 8
  br label %for.end

for.inc:                                          ; preds = %for.body
  %inc = add nuw i16 %i.0199, 1
  %conv3 = zext i16 %inc to i32
  %cmp6 = icmp ugt i16 %add, %inc
...
for.end:                                          ; preds = %for.inc, %if.then25, %if.then27
  ...
  %11 = load ptr, ptr %bm_shift, align 8
  ...
  %12 = load ptr, ptr %bm_suffix84, align 8
...
while.body:                                       ; preds = %if.end96
  ...
  br i1 %cmp93.not, label %if.end96, label %while.end
...
if.end96:                                         ; preds = %while.body.lr.ph, %while.body
  ...
  %19 = load ptr, ptr %next97, align 8
  %tobool87.not = icmp eq ptr %19, null
  br i1 %tobool87.not, label %while.end, label %while.body
...
if.then103:                                       ; preds = %while.end
  ...
  store ptr %13, ptr %next107, align 8
  %20 = load ptr, ptr %arrayidx86, align 8
...
if.end124:                                        ; preds = %if.else, %if.end117
  ...
  %24 = load ptr, ptr %arrayidx127, align 8
  %cnt128 = getelementptr inbounds %struct.cli_bm_patt, ptr %24, i64 0, i32 8
  %25 = load i16, ptr %cnt128, align 8
  %inc129 = add i16 %25, 1
  store i16 %inc129, ptr %cnt128, align 8
  br label %cleanup
...
entry:
  ...
  %bm_shift = getelementptr inbounds %struct.cli_matcher, ptr %root, i64 0, i32 2
  store ptr %call, ptr %bm_shift, align 8
...
for.body:                                         ; preds = %if.end, %for.body
  ...
  br i1 %exitcond.not.3, label %cleanup, label %for.body
...
if.end:                                           ; preds = %if.then, %entry
  %bm_suffix = getelementptr inbounds %struct.cli_matcher, ptr %root, i64 0, i32 3
  %1 = load ptr, ptr %bm_suffix, align 8
...
if.end19:                                         ; preds = %if.then17, %if.end15
  ...
  br i1 %tobool7.not, label %for.inc, label %while.body
...
for.end:                                          ; preds = %for.inc
  %9 = load ptr, ptr %bm_suffix, align 8
...
if.then22:                                        ; preds = %for.body
  %6 = load ptr, ptr %bm_suffix, align 8
  %arrayidx28 = getelementptr inbounds ptr, ptr %6, i64 %add14
  %p.0276 = load ptr, ptr %arrayidx28, align 8
...
while.cond.backedge:                              ; preds = %for.body115, %land.lhs.true, %lor.lhs.false153, %if.then142, %if.then64, %lor.lhs.false74, %if.else, %lor.lhs.false, %if.then35
  ...
  %p.0 = load ptr, ptr %p.0.in.be, align 8
  %tobool29.not = icmp eq ptr %p.0, null
  br i1 %tobool29.not, label %if.end173, label %while.body

if.else:                                          ; preds = %while.body
  %length42 = getelementptr inbounds %struct.cli_bm_patt, ptr %p.0279, i64 0, i32 2
  %9 = load i16, ptr %length42, align 8
...
lor.lhs.false:                                    ; preds = %if.else
  ...
  %10 = load i16, ptr %prefix_length, align 2
...
if.end90:                                         ; preds = %lor.lhs.false74, %if.end52
  ...
  %sub96 = sub i32 %i.0281, %conv47
  %idx.ext99 = zext i16 %10 to i64
  %idx.neg = sub nsw i64 0, %idx.ext99
  %add.ptr100 = getelementptr inbounds i8, ptr %arrayidx, i64 %idx.neg
  ...
  %pt.0 = load ptr, ptr %pt.0.in, align 8
  %add110 = add nuw nsw i32 %conv47, %conv43
  %cmp111271 = icmp ne i32 %add110, 0
  %cmp113272 = icmp ult i32 %sub96, %length
...
for.body115:                                      ; preds = %for.body115.preheader, %for.inc
  ...
  %off.1273 = phi i32 [ %sub96, %for.body115.preheader ], [ %inc126, %for.inc ]
  %arrayidx117 = getelementptr inbounds i8, ptr %add.ptr100, i64 %indvars.iv
  %19 = load i8, ptr %arrayidx117, align 1
...
for.inc:                                          ; preds = %for.body115
  ...
  br i1 %21, label %for.body115, label %land.lhs.true.loopexit
...
lor.lhs.false139:                                 ; preds = %if.then136
  ...
  %24 = load ptr, ptr %offset140, align 8
...
if.then163:                                       ; preds = %if.end161
  ...
  %27 = load ptr, ptr %virname164, align 8
  store ptr %27, ptr %virname, align 8
  br label %if.end165
...
if.end173:                                        ; preds = %if.then35, %while.cond.backedge, %if.then22, %for.body
  ...
  br i1 %cmp3, label %for.body, label %for.end176
...
for.end176:                                       ; preds = %if.end173
  ...
  %.pre = load ptr, ptr %section178.phi.trans.insert, align 8
