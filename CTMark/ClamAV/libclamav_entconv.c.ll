...
normalize_encoding.exit:                          ; preds = %if.end12, %for.end.i
  ...
  %.pre75 = load ptr, ptr %conv, align 8, !tbaa !18
...
land.lhs.true.i:                                  ; preds = %if.else3.i
  %4 = load ptr, ptr %call4.i49, align 8, !tbaa !14
...
if.end8.i:                                        ; preds = %land.lhs.true.i
  ...
  %5 = load i64, ptr %data.i, align 8, !tbaa !16
...
land.lhs.true.i58:                                ; preds = %if.else3.i54
  %9 = load ptr, ptr %call4.i56, align 8, !tbaa !14
...
if.end8.i63:                                      ; preds = %land.lhs.true.i58
  ...
  %10 = load i64, ptr %data.i61, align 8, !tbaa !16
...
encoding_bytes.exit71:                            ; preds = %land.lhs.true.i58, %if.else3.i54, %if.end8.i63, %switch.lookup76, %encoding_bytes.exit
  ...
  %.pre = load ptr, ptr %conv, align 8, !tbaa !18
...
if.then.i467:                                     ; preds = %33
  ...
  switch i8 %36, label %output_first.exit [
    i8 1, label %sw.bb.i468
    i8 2, label %if.end10.sink.split.i
    i8 4, label %sw.bb7.i
  ]

sw.bb.i468:                                       ; preds = %if.then.i467
...
if.end10.sink.split.i:                            ; preds = %sw.bb7.i, %sw.bb.i468, %if.then.i467
  %.sink2.i = phi i64 [ 4, %sw.bb7.i ], [ 3, %sw.bb.i468 ], [ 2, %if.then.i467 ]
  %.sink1.i = phi i64 [ -4, %sw.bb7.i ], [ -3, %sw.bb.i468 ], [ -2, %if.then.i467 ]
  %add.ptr5.i = getelementptr inbounds i8, ptr %20, i64 %.sink2.i
  %sub6.i = add nsw i64 %.sink1.i, %19
  br label %output_first.exit

output_first.exit:                                ; preds = %33, %if.then.i467, %sw.bb.i468, %if.end10.sink.split.i
  %tmpbuff.0 = phi ptr [ %20, %33 ], [ %20, %if.then.i467 ], [ %add.ptr5.i, %if.end10.sink.split.i ], [ %20, %sw.bb.i468 ]
  %inleft.0 = phi i64 [ %19, %33 ], [ %19, %if.then.i467 ], [ %sub6.i, %if.end10.sink.split.i ], [ %19, %sw.bb.i468 ]
...
if.then101:                                       ; preds = %if.end96
  ...
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.10, ptr noundef nonnull %.str.5.encoding.i472) #14
...
if.then122:                                       ; preds = %land.lhs.true118
  ...
  switch i32 %iconv_struct.0.val, label %sw.epilog.i [
    i32 0, label %sw.bb.i482
    i32 2, label %sw.bb.i482
...
sw.bb.i482:                                       ; preds = %if.then122, %if.then122
  %cmp132.not.i = icmp eq i64 %and.i, 0
  br i1 %cmp132.not.i, label %sw.epilog.i, label %for.body.i483

for.body.i483:                                    ; preds = %sw.bb.i482, %for.inc.i488
  %i.033.i = phi i64 [ %add17.i, %for.inc.i488 ], [ 0, %sw.bb.i482 ]
  %add.i484 = or i64 %i.033.i, 2
  %arrayidx.i485 = getelementptr inbounds i8, ptr %tmpbuff.1, i64 %add.i484
  %46 = load i8, ptr %arrayidx.i485, align 1, !tbaa !17
  %tobool.not.i486 = icmp eq i8 %46, 0
  br i1 %tobool.not.i486, label %land.lhs.true.i489, label %if.else.i487

land.lhs.true.i489:                               ; preds = %for.body.i483
  %add2.i = or i64 %i.033.i, 3
  %arrayidx3.i490 = getelementptr inbounds i8, ptr %tmpbuff.1, i64 %add2.i
  %47 = load i8, ptr %arrayidx3.i490, align 1, !tbaa !17
  %tobool4.not.i = icmp eq i8 %47, 0
  br i1 %tobool4.not.i, label %if.then.i491, label %if.else.i487

if.then.i491:                                     ; preds = %land.lhs.true.i489
  %add5.i = or i64 %i.033.i, 1
  %arrayidx6.i492 = getelementptr inbounds i8, ptr %tmpbuff.1, i64 %add5.i
  %48 = load i8, ptr %arrayidx6.i492, align 1, !tbaa !17
...
if.else.i487:                                     ; preds = %land.lhs.true.i489, %for.body.i483
...
for.inc.i488:                                     ; preds = %if.else.i487, %if.then.i491
  %div477.sink.i = phi i64 [ %div477.i, %if.then.i491 ], [ %div12478.i, %if.else.i487 ]
  %.sink.i = phi i8 [ %49, %if.then.i491 ], [ -1, %if.else.i487 ]
  ...
  br i1 %cmp1.i, label %for.body.i483, label %sw.epilog.i, !llvm.loop !51
...
for.body91.i:                                     ; preds = %for.body91.i, %for.body91.i.preheader.new
  ...
  %arrayidx97.i480 = getelementptr inbounds i8, ptr %arrayidx33, i64 %add92.i
  store i8 %63, ptr %arrayidx97.i480, align 1, !tbaa !17
  ...
  %arrayidx97.i480.1 = getelementptr inbounds i8, ptr %arrayidx33, i64 %add92.i.1
  store i8 %65, ptr %arrayidx97.i480.1, align 1, !tbaa !17
...
for.body112.i.prol:                               ; preds = %for.body112.i.preheader656
  ...
  %inc.i477.prol = or i64 %i.521.i.ph, 1
  br label %for.body112.i.prol.loopexit

for.body112.i.prol.loopexit:                      ; preds = %for.body112.i.prol, %for.body112.i.preheader656
  %i.521.i.unr = phi i64 [ %i.521.i.ph, %for.body112.i.preheader656 ], [ %inc.i477.prol, %for.body112.i.prol ]
...
for.body112.i:                                    ; preds = %for.body112.i.prol.loopexit, %for.body112.i
  %i.521.i = phi i64 [ %inc.i477.1, %for.body112.i ], [ %i.521.i.unr, %for.body112.i.prol.loopexit ]
  ...
  %inc.i477 = add nuw nsw i64 %i.521.i, 1
  %mul.i.1 = shl nuw i64 %inc.i477, 1
  %arrayidx113.i.1 = getelementptr inbounds i8, ptr %arrayidx33, i64 %mul.i.1
  store i8 0, ptr %arrayidx113.i.1, align 1, !tbaa !17
  %arrayidx114.i.1 = getelementptr inbounds i8, ptr %tmpbuff.1, i64 %inc.i477
  ...
  %inc.i477.1 = add nuw nsw i64 %i.521.i, 2
  %exitcond.not.i478.1 = icmp eq i64 %inc.i477.1, %div103468..i
  br i1 %exitcond.not.i478.1, label %for.end119.i, label %for.body112.i, !llvm.loop !63
...
for.end119.i:                                     ; preds = %for.body112.i.prol.loopexit, %for.body112.i, %middle.block, %sw.bb102.i
  ...
  %add.ptr.i479 = getelementptr inbounds i8, ptr %tmpbuff.1, i64 %div103468..i
...
for.body132.i:                                    ; preds = %if.then122, %if.end264.i
  ...
  %arrayidx133.i474 = getelementptr inbounds i8, ptr %tmpbuff.1, i64 %i.617.i
  %80 = load i8, ptr %arrayidx133.i474, align 1, !tbaa !17
...
if.then136.i:                                     ; preds = %for.body132.i
  ...
  %arrayidx138.i476 = getelementptr inbounds i8, ptr %arrayidx33, i64 %j.018.i
  store i8 0, ptr %arrayidx138.i476, align 1, !tbaa !17
  %inc139.i = add nuw i64 %i.617.i, 1
  %81 = load i8, ptr %arrayidx133.i474, align 1, !tbaa !17
...
if.then156.i:                                     ; preds = %if.then149.i
  ...
  %84 = load i8, ptr %arrayidx133.i474, align 1, !tbaa !17
  %shl.i = shl i8 %84, 6
...
if.then183.i:                                     ; preds = %if.else143.i
  ...
  %arrayidx185.i475 = getelementptr inbounds i8, ptr %tmpbuff.1, i64 %add184.i
  %87 = load i8, ptr %arrayidx185.i475, align 1, !tbaa !17
  %88 = and i8 %87, -64
...
if.then197.i:                                     ; preds = %land.lhs.true190.i
  ...
  %91 = load i8, ptr %arrayidx185.i475, align 1, !tbaa !17
...
for.body91.i.epil:                                ; preds = %sw.epilog.i.loopexit655.unr-lcssa
  ...
  %arrayidx97.i480.epil = getelementptr inbounds i8, ptr %arrayidx33, i64 %add92.i.epil
  store i8 %103, ptr %arrayidx97.i480.epil, align 1, !tbaa !17
  br label %sw.epilog.i

sw.epilog.i:                                      ; preds = %for.body91.i.epil, %sw.epilog.i.loopexit655.unr-lcssa, %for.inc85.i, %for.inc55.i, %for.inc34.i, %for.inc.i488, %sw.bb101.i, %sw.bb88.i, %sw.bb.i482, %for.cond19.preheader.i, %for.cond40.preheader.i, %for.cond59.preheader.i, %if.then122
...
if.end145:                                        ; preds = %if.then276.i, %if.then287.i, %sw.epilog.i, %for.end265.i, %for.end119.i, %land.lhs.true118, %if.end116, %if.then133
  %tmpbuff.3 = phi ptr [ %tmpbuff.1, %if.end116 ], [ %incdec.ptr143, %if.then133 ], [ %tmpbuff.1, %land.lhs.true118 ], [ %add.ptr284.i, %sw.epilog.i ], [ %add.ptr268.i, %for.end265.i ], [ %add.ptr.i479, %for.end119.i ], [ %add.ptr268.i, %if.then276.i ], [ %add.ptr284.i, %if.then287.i ]
