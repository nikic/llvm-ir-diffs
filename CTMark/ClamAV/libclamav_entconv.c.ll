; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_entconv.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_entconv.c"
...
if.end:                                           ; preds = %if.then14
  ...
  store i8 %conv18, ptr %call15, align 1
...
if.then2:                                         ; preds = %if.end
  ...
  store i8 0, ptr %entity_buffcnt, align 8
  %buffer_size4 = getelementptr inbounds %struct.entity_conv, ptr %conv, i64 0, i32 11
  store i64 %buffer_size, ptr %buffer_size4, align 8
  ...
  store ptr %call6, ptr %tmp_area, align 8
...
if.end:                                           ; preds = %entry
  %priority = getelementptr inbounds %struct.entity_conv, ptr %conv, i64 0, i32 2
  %0 = load i32, ptr %priority, align 8
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  %1 = load ptr, ptr %call6.i, align 8
...
normalize_encoding.exit:                          ; preds = %if.end12, %for.end.i
  ...
  %.pre75 = load ptr, ptr %conv, align 8
  br i1 %cmp13, label %if.then15, label %if.end24

if.then15:                                        ; preds = %normalize_encoding.exit
  %cmp.i = icmp eq ptr %.pre75, @.str.1682
  %cmp1.i = icmp eq ptr %.pre75, @.str.1666
  %or.cond73 = or i1 %cmp.i, %cmp1.i
  br i1 %or.cond73, label %encoding_bytes.exit, label %if.else3.i

if.else3.i:                                       ; preds = %if.then15
  %call.i48 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %.pre75) #13
  %call4.i49 = tail call ptr @hashtab_find(ptr noundef nonnull @aliases_htable, ptr noundef %.pre75, i64 noundef %call.i48) #14
...
land.lhs.true.i:                                  ; preds = %if.else3.i
  %4 = load ptr, ptr %call4.i49, align 8
...
if.end8.i:                                        ; preds = %land.lhs.true.i
  ...
  %7 = icmp eq i64 %6, 0
  br i1 %7, label %switch.lookup, label %encoding_bytes.exit
...
encoding_bytes.exit:                              ; preds = %land.lhs.true.i, %if.else3.i, %if.end8.i, %switch.lookup, %if.then15
  ...
  br i1 %or.cond74, label %encoding_bytes.exit71, label %if.else3.i54

if.else3.i54:                                     ; preds = %encoding_bytes.exit
  %call.i55 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call1.i) #13
  %call4.i56 = tail call ptr @hashtab_find(ptr noundef nonnull @aliases_htable, ptr noundef %call1.i, i64 noundef %call.i55) #14
  %tobool.not.i57 = icmp eq ptr %call4.i56, null
  br i1 %tobool.not.i57, label %encoding_bytes.exit71, label %land.lhs.true.i58

land.lhs.true.i58:                                ; preds = %if.else3.i54
  %9 = load ptr, ptr %call4.i56, align 8
  %tobool5.not.i59 = icmp eq ptr %9, null
  br i1 %tobool5.not.i59, label %encoding_bytes.exit71, label %if.end8.i63

if.end8.i63:                                      ; preds = %land.lhs.true.i58
  %data.i61 = getelementptr inbounds %struct.element, ptr %call4.i56, i64 0, i32 1
  %10 = load i64, ptr %data.i61, align 8
  %11 = and i64 %10, 4294967288
  %12 = icmp eq i64 %11, 0
  br i1 %12, label %switch.lookup76, label %encoding_bytes.exit71

switch.lookup76:                                  ; preds = %if.end8.i63
  %sext79 = shl i64 %10, 32
  %13 = ashr exact i64 %sext79, 32
  %switch.gep77 = getelementptr inbounds [8 x i64], ptr @switch.table.iconv_open_cached, i64 0, i64 %13
  %switch.load78 = load i64, ptr %switch.gep77, align 8
  br label %encoding_bytes.exit71

encoding_bytes.exit71:                            ; preds = %land.lhs.true.i58, %if.else3.i54, %if.end8.i63, %switch.lookup76, %encoding_bytes.exit
  %retval.0.i65 = phi i64 [ 4, %encoding_bytes.exit ], [ %switch.load78, %switch.lookup76 ], [ 1, %if.end8.i63 ], [ 1, %if.else3.i54 ], [ 1, %land.lhs.true.i58 ]
  %cmp19.not = icmp eq i64 %retval.0.i, %retval.0.i65
  %.pre = load ptr, ptr %conv, align 8
  br i1 %cmp19.not, label %if.end24, label %if.then21

if.then21:                                        ; preds = %encoding_bytes.exit71
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.8, ptr noundef %.pre, i64 noundef %retval.0.i, ptr noundef %call1.i, i64 noundef %retval.0.i65) #14
  tail call void @free(ptr noundef %call1.i) #14
  br label %cleanup

if.end24:                                         ; preds = %encoding_bytes.exit71, %normalize_encoding.exit
  %14 = phi ptr [ %.pre, %encoding_bytes.exit71 ], [ %.pre75, %normalize_encoding.exit ]
  tail call void @free(ptr noundef %14) #14
  store ptr %call1.i, ptr %conv, align 8
...
lor.lhs.false:                                    ; preds = %entry
  %out_area = getelementptr inbounds %struct.entity_conv, ptr %conv, i64 0, i32 16
  %0 = load ptr, ptr %out_area, align 8
...
land.rhs.i:                                       ; preds = %while.body.i, %land.rhs.preheader.i
  ...
  %12 = load i8, ptr %src.0105.i, align 1
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  store i8 %12, ptr %outbuff.addr.0103.i, align 1
  %dec.i = add i64 %area_maxcopy.0104.i, -1
  %tobool12.not.i = icmp eq i64 %dec.i, 0
  br i1 %tobool12.not.i, label %if.end27.i, label %land.rhs.i
...
if.then19.i:                                      ; preds = %while.end.i
  ...
  store i8 10, ptr %outbuff.addr.0103.i, align 1
  ...
  store i8 %13, ptr %incdec.ptr21.i, align 1
  %14 = load i8, ptr %incdec.ptr22.i, align 1
  store i8 %14, ptr %incdec.ptr23.i, align 1
...
if.end27.i:                                       ; preds = %while.body.i, %if.then19.i, %while.end.i, %if.end.i
  ...
  store i64 %sub29.i, ptr %offset.i, align 8
...
if.else35.i:                                      ; preds = %if.else.i
  %sext578 = shl i64 %cond, 32
  %conv36.i = ashr exact i64 %sext578, 32
...
for.inc.i:                                        ; preds = %for.body.i
  ...
  br i1 %exitcond.not.i, label %read_raw.exit, label %for.body.i
...
if.then52:                                        ; preds = %read_raw.exit
  %17 = load ptr, ptr %out_area, align 8
...
if.end60:                                         ; preds = %if.then52, %read_raw.exit
  ...
  store i64 0, ptr %offset17, align 8
  %20 = load ptr, ptr %tmp_area, align 8
  %bom_cnt = getelementptr inbounds %struct.entity_conv, ptr %conv, i64 0, i32 8
  %21 = load i8, ptr %bom_cnt, align 1
  %tobool67.not = icmp eq i8 %21, 0
  %cmp70 = icmp sgt i64 %19, 3
  %or.cond575 = select i1 %tobool67.not, i1 %cmp70, i1 false
  br i1 %or.cond575, label %if.then72, label %if.end77
...
sw.bb.i:                                          ; preds = %if.then72
  switch i8 %25, label %process_bom.exit.thread [
    i8 0, label %if.then.i465
    i8 60, label %if.then55.i
  ]

if.then.i465:                                     ; preds = %sw.bb.i
...
land.lhs.true.i:                                  ; preds = %if.then.i465
  %cmp12.i = icmp eq i8 %29, -1
  br i1 %cmp12.i, label %process_bom.exit.thread545, label %if.else36.thread.i

land.lhs.true19.i:                                ; preds = %if.then.i465
  %cmp22.i = icmp eq i8 %29, -2
  br i1 %cmp22.i, label %process_bom.exit.thread545, label %if.else36.thread.i

land.lhs.true30.i:                                ; preds = %if.then.i465
...
land.lhs.true41.i:                                ; preds = %if.then.i465
  %cmp44.i466 = icmp eq i8 %29, 0
  %spec.select.i = select i1 %cmp44.i466, ptr @.str.1682, ptr @.str.6
  br label %process_bom.exit.thread
...
if.then82.i:                                      ; preds = %sw.bb77.i
  %30 = or i8 %27, %29
  %or.cond635 = icmp eq i8 %30, 0
  %spec.select638 = select i1 %or.cond635, ptr @.str.1674, ptr @.str.1664
  %spec.select639 = select i1 %or.cond635, i8 4, i8 2
  br label %process_bom.exit.thread545
...
if.then101.i:                                     ; preds = %sw.bb96.i
  %31 = or i8 %27, %29
  %or.cond636 = icmp eq i8 %31, 0
  %spec.select640 = select i1 %or.cond636, ptr @.str.1666, ptr @.str.1668
  %spec.select641 = select i1 %or.cond636, i8 4, i8 2
  br label %process_bom.exit.thread545
...
sw.bb174.i:                                       ; preds = %if.then72
  ...
  %or.cond637 = and i1 %cmp177.i, %cmp182.i
  br i1 %or.cond637, label %land.lhs.true184.i, label %process_bom.exit.thread
...
process_bom.exit.thread:                          ; preds = %if.then72, %sw.bb174.i, %land.lhs.true161.i, %sw.bb115.i, %sw.bb96.i, %sw.bb77.i, %if.then71.i, %if.then55.i, %land.lhs.true30.i, %land.lhs.true41.i, %sw.bb.i, %if.then60.i, %sw.epilog.fold.split.i, %land.lhs.true148.i, %sw.bb127.i, %land.lhs.true166.i, %land.lhs.true184.i, %if.else36.thread.i, %if.then.i465, %land.lhs.true137.i, %if.then132.i
  %encoding.0.i.ph = phi ptr [ @.str.6, %if.then132.i ], [ %spec.select241.i, %land.lhs.true137.i ], [ @.str.6, %if.then.i465 ], [ @.str.6, %if.else36.thread.i ], [ %spec.select235.i, %land.lhs.true184.i ], [ %spec.select233.i, %land.lhs.true166.i ], [ @.str.6, %sw.bb127.i ], [ %spec.select231.i, %land.lhs.true148.i ], [ @.str.6, %sw.epilog.fold.split.i ], [ @.str.1666, %if.then60.i ], [ @.str.6, %sw.bb.i ], [ %spec.select.i, %land.lhs.true41.i ], [ @.str.1665, %land.lhs.true30.i ], [ @.str.6, %if.then55.i ], [ @.str.1668, %if.then71.i ], [ @.str.6, %sw.bb77.i ], [ @.str.6, %sw.bb96.i ], [ @.str.6, %sw.bb115.i ], [ @.str.6, %land.lhs.true161.i ], [ @.str.6, %sw.bb174.i ], [ @.str.6, %if.then72 ]
  %enc_bytes.0.i.ph = phi i8 [ 4, %if.then132.i ], [ 4, %land.lhs.true137.i ], [ 4, %if.then.i465 ], [ 4, %if.else36.thread.i ], [ %spec.select236.i, %land.lhs.true184.i ], [ %spec.select234.i, %land.lhs.true166.i ], [ 4, %sw.bb127.i ], [ %spec.select232.i, %land.lhs.true148.i ], [ 4, %sw.epilog.fold.split.i ], [ 4, %if.then60.i ], [ 4, %sw.bb.i ], [ 4, %land.lhs.true41.i ], [ 4, %land.lhs.true30.i ], [ 4, %if.then55.i ], [ 2, %if.then71.i ], [ 4, %sw.bb77.i ], [ 4, %sw.bb96.i ], [ 4, %sw.bb115.i ], [ 4, %land.lhs.true161.i ], [ 4, %sw.bb174.i ], [ 4, %if.then72 ]
  %autodetected.i529 = getelementptr inbounds %struct.entity_conv, ptr %conv, i64 0, i32 1
  store ptr %encoding.0.i.ph, ptr %autodetected.i529, align 8
  %enc_bytes191.i530 = getelementptr inbounds %struct.entity_conv, ptr %conv, i64 0, i32 6
  store i8 %enc_bytes.0.i.ph, ptr %enc_bytes191.i530, align 1
  %has_bom193.i531 = getelementptr inbounds %struct.entity_conv, ptr %conv, i64 0, i32 5
  store i8 0, ptr %has_bom193.i531, align 8
  br label %32

process_bom.exit.thread545:                       ; preds = %if.then101.i, %if.then82.i, %land.lhs.true.i, %land.lhs.true19.i
  %encoding.0.i.ph543 = phi ptr [ @.str.1682, %land.lhs.true19.i ], [ @.str.1665, %land.lhs.true.i ], [ %spec.select638, %if.then82.i ], [ %spec.select640, %if.then101.i ]
  %enc_bytes.0.i.ph544 = phi i8 [ 4, %land.lhs.true19.i ], [ 4, %land.lhs.true.i ], [ %spec.select639, %if.then82.i ], [ %spec.select641, %if.then101.i ]
  %autodetected.i549 = getelementptr inbounds %struct.entity_conv, ptr %conv, i64 0, i32 1
  store ptr %encoding.0.i.ph543, ptr %autodetected.i549, align 8
  %enc_bytes191.i550 = getelementptr inbounds %struct.entity_conv, ptr %conv, i64 0, i32 6
  store i8 %enc_bytes.0.i.ph544, ptr %enc_bytes191.i550, align 1
  %has_bom193.i551 = getelementptr inbounds %struct.entity_conv, ptr %conv, i64 0, i32 5
  store i8 1, ptr %has_bom193.i551, align 8
  br label %32
...
process_bom.exit:                                 ; preds = %sw.bb115.i
  ...
  store ptr %spec.select229.i, ptr %autodetected.i, align 8
  %enc_bytes191.i = getelementptr inbounds %struct.entity_conv, ptr %conv, i64 0, i32 6
  store i8 4, ptr %enc_bytes191.i, align 1
  %has_bom193.i = getelementptr inbounds %struct.entity_conv, ptr %conv, i64 0, i32 5
  store i8 %spec.select230.i, ptr %has_bom193.i, align 8
  %spec.select576 = select i1 %cmp123.i, i32 2, i32 3
  br label %32

32:                                               ; preds = %process_bom.exit, %process_bom.exit.thread, %process_bom.exit.thread545
  %has_bom193.i540 = phi ptr [ %has_bom193.i551, %process_bom.exit.thread545 ], [ %has_bom193.i531, %process_bom.exit.thread ], [ %has_bom193.i, %process_bom.exit ]
  %enc_bytes191.i538 = phi ptr [ %enc_bytes191.i550, %process_bom.exit.thread545 ], [ %enc_bytes191.i530, %process_bom.exit.thread ], [ %enc_bytes191.i, %process_bom.exit ]
  %autodetected.i536 = phi ptr [ %autodetected.i549, %process_bom.exit.thread545 ], [ %autodetected.i529, %process_bom.exit.thread ], [ %autodetected.i, %process_bom.exit ]
  %encoding.0.i534 = phi ptr [ %encoding.0.i.ph543, %process_bom.exit.thread545 ], [ %encoding.0.i.ph, %process_bom.exit.thread ], [ %spec.select229.i, %process_bom.exit ]
  %33 = phi i32 [ 2, %process_bom.exit.thread545 ], [ 3, %process_bom.exit.thread ], [ %spec.select576, %process_bom.exit ]
  tail call void @process_encoding_set(ptr noundef nonnull %conv, ptr noundef %encoding.0.i534, i32 noundef %33)
  %34 = load i8, ptr %has_bom193.i540, align 8
  %tobool.not.i467 = icmp eq i8 %34, 0
  br i1 %tobool.not.i467, label %output_first.exit, label %if.then.i468

if.then.i468:                                     ; preds = %32
  %35 = load i8, ptr %enc_bytes191.i538, align 1
  switch i8 %35, label %output_first.exit [
    i8 1, label %sw.bb.i469
    i8 2, label %if.end10.sink.split.i
    i8 4, label %sw.bb7.i
  ]

sw.bb.i469:                                       ; preds = %if.then.i468
  %36 = load ptr, ptr %autodetected.i536, align 8
  %cmp.i = icmp eq ptr %36, @.str.1679
  br i1 %cmp.i, label %if.end10.sink.split.i, label %output_first.exit

sw.bb7.i:                                         ; preds = %if.then.i468
  br label %if.end10.sink.split.i

if.end10.sink.split.i:                            ; preds = %sw.bb7.i, %sw.bb.i469, %if.then.i468
  %.sink2.i = phi i64 [ 4, %sw.bb7.i ], [ 3, %sw.bb.i469 ], [ 2, %if.then.i468 ]
  %.sink1.i = phi i64 [ -4, %sw.bb7.i ], [ -3, %sw.bb.i469 ], [ -2, %if.then.i468 ]
  %add.ptr5.i = getelementptr inbounds i8, ptr %20, i64 %.sink2.i
  %sub6.i = add nsw i64 %.sink1.i, %19
  br label %output_first.exit

output_first.exit:                                ; preds = %32, %if.then.i468, %sw.bb.i469, %if.end10.sink.split.i
  %tmpbuff.0 = phi ptr [ %20, %32 ], [ %20, %if.then.i468 ], [ %add.ptr5.i, %if.end10.sink.split.i ], [ %20, %sw.bb.i469 ]
  %inleft.0 = phi i64 [ %19, %32 ], [ %19, %if.then.i468 ], [ %sub6.i, %if.end10.sink.split.i ], [ %19, %sw.bb.i469 ]
  %37 = load i8, ptr %bom_cnt, align 1
  %inc = add i8 %37, 1
  store i8 %inc, ptr %bom_cnt, align 1
  br label %if.end77
...
for.body.preheader:                               ; preds = %if.end77
  ...
  %39 = sub nuw nsw i64 4, %inleft.1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %scevgep, i8 0, i64 %39, i1 false)
  br label %if.end96
...
if.end96:                                         ; preds = %for.body.preheader, %if.end77
  ...
  %40 = load ptr, ptr %conv, align 8
  %tobool.not.i471 = icmp eq ptr %40, null
  %.str.5.encoding.i = select i1 %tobool.not.i471, ptr @.str.5, ptr %40
  %call98 = tail call fastcc ptr @iconv_open_cached(ptr noundef nonnull %.str.5.encoding.i)
  %cmp99 = icmp eq ptr %call98, inttoptr (i64 -1 to ptr)
  br i1 %cmp99, label %if.then101, label %if.end116

if.then101:                                       ; preds = %if.end96
  %41 = load ptr, ptr %conv, align 8
  %tobool.not.i472 = icmp eq ptr %41, null
  %.str.5.encoding.i473 = select i1 %tobool.not.i472, ptr @.str.5, ptr %41
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.10, ptr noundef nonnull %.str.5.encoding.i473) #14
  %42 = load ptr, ptr %conv, align 8
  tail call void @free(ptr noundef %42) #14
  %call105 = tail call ptr @cli_strdup(ptr noundef nonnull @.str.5) #14
  store ptr %call105, ptr %conv, align 8
...
land.lhs.true118:                                 ; preds = %if.end116
  %43 = load i64, ptr %buffer_size, align 8
  %div461 = lshr i64 %43, 1
  %cmp120 = icmp ugt i64 %sub30, %div461
  br i1 %cmp120, label %if.then122, label %if.end145

if.then122:                                       ; preds = %land.lhs.true118
  %iconv_struct.0.val = load i32, ptr %iconv_struct.0, align 8
  %44 = getelementptr i8, ptr %iconv_struct.0, i64 8
  %iconv_struct.0.val464 = load i64, ptr %44, align 8
  %..i = tail call i64 @llvm.umin.i64(i64 %inleft.2, i64 %sub30)
  %not.i = sub i64 0, %iconv_struct.0.val464
  %and.i = and i64 %..i, %not.i
  switch i32 %iconv_struct.0.val, label %sw.epilog.i [
    i32 0, label %sw.bb.i483
    i32 2, label %sw.bb.i483
...
sw.bb.i483:                                       ; preds = %if.then122, %if.then122
  %cmp132.not.i = icmp eq i64 %and.i, 0
  br i1 %cmp132.not.i, label %sw.epilog.i, label %for.body.i484

for.body.i484:                                    ; preds = %sw.bb.i483, %for.inc.i489
  %i.033.i = phi i64 [ %add17.i, %for.inc.i489 ], [ 0, %sw.bb.i483 ]
  %add.i485 = or i64 %i.033.i, 2
  %arrayidx.i486 = getelementptr inbounds i8, ptr %tmpbuff.1, i64 %add.i485
  %45 = load i8, ptr %arrayidx.i486, align 1
  %tobool.not.i487 = icmp eq i8 %45, 0
  br i1 %tobool.not.i487, label %land.lhs.true.i490, label %if.else.i488

land.lhs.true.i490:                               ; preds = %for.body.i484
  %add2.i = or i64 %i.033.i, 3
  %arrayidx3.i491 = getelementptr inbounds i8, ptr %tmpbuff.1, i64 %add2.i
  %46 = load i8, ptr %arrayidx3.i491, align 1
  %tobool4.not.i = icmp eq i8 %46, 0
  br i1 %tobool4.not.i, label %if.then.i492, label %if.else.i488

if.then.i492:                                     ; preds = %land.lhs.true.i490
  %add5.i = or i64 %i.033.i, 1
  %arrayidx6.i493 = getelementptr inbounds i8, ptr %tmpbuff.1, i64 %add5.i
  %47 = load i8, ptr %arrayidx6.i493, align 1
  ...
  %48 = load i8, ptr %arrayidx8.i, align 1
  br label %for.inc.i489

if.else.i488:                                     ; preds = %land.lhs.true.i490, %for.body.i484
...
for.inc.i489:                                     ; preds = %if.else.i488, %if.then.i492
  %div477.sink.i = phi i64 [ %div477.i, %if.then.i492 ], [ %div12478.i, %if.else.i488 ]
  %.sink.i = phi i8 [ %48, %if.then.i492 ], [ -1, %if.else.i488 ]
  %add10.i = or i64 %div477.sink.i, 1
  %arrayidx11.i = getelementptr inbounds i8, ptr %arrayidx33, i64 %add10.i
  store i8 %.sink.i, ptr %arrayidx11.i, align 1
  %add17.i = add i64 %i.033.i, 4
  %cmp1.i = icmp ult i64 %add17.i, %and.i
  br i1 %cmp1.i, label %for.body.i484, label %sw.epilog.i
...
for.body22.i:                                     ; preds = %for.cond19.preheader.i, %for.inc34.i
  ...
  %49 = load i16, ptr %arrayidx23.i, align 2
  %tobool24.not.i = icmp eq i16 %49, 0
...
for.body43.i:                                     ; preds = %for.cond40.preheader.i, %for.inc55.i
  ...
  %51 = load i16, ptr %arrayidx45.i, align 2
  %tobool46.not.i = icmp eq i16 %51, 0
...
for.body61.i:                                     ; preds = %for.cond59.preheader.i, %for.inc85.i
  ...
  %tobool63.not.i = icmp eq i8 %53, 0
...
land.lhs.true64.i:                                ; preds = %for.body61.i
  ...
  %54 = load i8, ptr %arrayidx66.i, align 1
  %tobool67.not.i = icmp eq i8 %54, 0
...
for.body91.i.preheader:                           ; preds = %sw.bb88.i
  ...
  %58 = lshr i64 %57, 1
  %59 = add nuw i64 %58, 1
  %xtraiter671 = and i64 %59, 1
  %60 = icmp ult i64 %and.i, 3
  br i1 %60, label %sw.epilog.i.loopexit663.unr-lcssa, label %for.body91.i.preheader.new

for.body91.i.preheader.new:                       ; preds = %for.body91.i.preheader
  %unroll_iter = and i64 %59, -2
...
sw.bb102.i:                                       ; preds = %if.then122, %if.then122
  ...
  %cmp11120.not.i = icmp ult i64 %sub30, 2
...
for.body112.i.preheader:                          ; preds = %sw.bb102.i
  ...
  br i1 %min.iters.check, label %for.body112.i.preheader664, label %vector.memcheck

vector.memcheck:                                  ; preds = %for.body112.i.preheader
  %smax = tail call i64 @llvm.smax.i64(i64 %5, i64 %6)
  %65 = shl nuw i64 %div103468..i, 1
  %66 = add i64 %smax, %65
  %67 = sub i64 %66, %6
  %scevgep654 = getelementptr i8, ptr %0, i64 %67
  %scevgep655 = getelementptr i8, ptr %tmpbuff.1, i64 %div103468..i
  %bound0 = icmp ult ptr %arrayidx33, %scevgep655
  %bound1 = icmp ult ptr %tmpbuff.1, %scevgep654
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %for.body112.i.preheader664, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %div103468..i, 9223372036854775792
  %invariant.gep = getelementptr i8, ptr %arrayidx33, i64 -1
  %invariant.gep681 = getelementptr i8, ptr %arrayidx33, i64 -1
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %68 = shl nuw i64 %index, 1
  %69 = shl i64 %index, 1
  %70 = getelementptr inbounds i8, ptr %tmpbuff.1, i64 %index
  %wide.load = load <8 x i8>, ptr %70, align 1
  %71 = getelementptr inbounds i8, ptr %70, i64 8
  %wide.load656 = load <8 x i8>, ptr %71, align 1
  %72 = or i64 %68, 1
  %73 = or i64 %69, 17
  %gep = getelementptr i8, ptr %invariant.gep, i64 %72
  %gep682 = getelementptr i8, ptr %invariant.gep681, i64 %73
  ...
  store <16 x i8> %interleaved.vec, ptr %gep, align 1
  %interleaved.vec657 = shufflevector <8 x i8> zeroinitializer, <8 x i8> %wide.load656, <16 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11, i32 4, i32 12, i32 5, i32 13, i32 6, i32 14, i32 7, i32 15>
  store <16 x i8> %interleaved.vec657, ptr %gep682, align 1
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.end119.i, label %for.body112.i.preheader664

for.body112.i.preheader664:                       ; preds = %vector.memcheck, %for.body112.i.preheader, %middle.block
...
for.body112.i.prol:                               ; preds = %for.body112.i.preheader664
  %mul.i.prol = shl nuw i64 %i.521.i.ph, 1
  %arrayidx113.i.prol = getelementptr inbounds i8, ptr %arrayidx33, i64 %mul.i.prol
  store i8 0, ptr %arrayidx113.i.prol, align 1
  %arrayidx114.i.prol = getelementptr inbounds i8, ptr %tmpbuff.1, i64 %i.521.i.ph
  %75 = load i8, ptr %arrayidx114.i.prol, align 1
  %add116.i.prol = or i64 %mul.i.prol, 1
  %arrayidx117.i.prol = getelementptr inbounds i8, ptr %arrayidx33, i64 %add116.i.prol
  store i8 %75, ptr %arrayidx117.i.prol, align 1
  %inc.i478.prol = or i64 %i.521.i.ph, 1
  br label %for.body112.i.prol.loopexit

for.body112.i.prol.loopexit:                      ; preds = %for.body112.i.prol, %for.body112.i.preheader664
  %i.521.i.unr = phi i64 [ %i.521.i.ph, %for.body112.i.preheader664 ], [ %inc.i478.prol, %for.body112.i.prol ]
  %76 = icmp eq i64 %div103468..i, %.neg
  br i1 %76, label %for.end119.i, label %for.body112.i

for.body112.i:                                    ; preds = %for.body112.i.prol.loopexit, %for.body112.i
  %i.521.i = phi i64 [ %inc.i478.1, %for.body112.i ], [ %i.521.i.unr, %for.body112.i.prol.loopexit ]
  ...
  %77 = load i8, ptr %arrayidx114.i, align 1
  %add116.i = or i64 %mul.i, 1
  %arrayidx117.i = getelementptr inbounds i8, ptr %arrayidx33, i64 %add116.i
  store i8 %77, ptr %arrayidx117.i, align 1
  %inc.i478 = add nuw nsw i64 %i.521.i, 1
  %mul.i.1 = shl nuw i64 %inc.i478, 1
  %arrayidx113.i.1 = getelementptr inbounds i8, ptr %arrayidx33, i64 %mul.i.1
  store i8 0, ptr %arrayidx113.i.1, align 1
  %arrayidx114.i.1 = getelementptr inbounds i8, ptr %tmpbuff.1, i64 %inc.i478
  %78 = load i8, ptr %arrayidx114.i.1, align 1
  %add116.i.1 = or i64 %mul.i.1, 1
  %arrayidx117.i.1 = getelementptr inbounds i8, ptr %arrayidx33, i64 %add116.i.1
  store i8 %78, ptr %arrayidx117.i.1, align 1
  %inc.i478.1 = add nuw nsw i64 %i.521.i, 2
  %exitcond.not.i479.1 = icmp eq i64 %inc.i478.1, %div103468..i
  br i1 %exitcond.not.i479.1, label %for.end119.i, label %for.body112.i
...
for.end119.i:                                     ; preds = %for.body112.i.prol.loopexit, %for.body112.i, %middle.block, %sw.bb102.i
  ...
  %add.ptr.i480 = getelementptr inbounds i8, ptr %tmpbuff.1, i64 %div103468..i
...
for.body132.i:                                    ; preds = %if.then122, %if.end264.i
  ...
  %arrayidx133.i475 = getelementptr inbounds i8, ptr %tmpbuff.1, i64 %i.617.i
  %79 = load i8, ptr %arrayidx133.i475, align 1
  %cmp134.i = icmp ult i8 %79, 127
  br i1 %cmp134.i, label %if.then136.i, label %if.else143.i

if.then136.i:                                     ; preds = %for.body132.i
  %inc137.i = or i64 %j.018.i, 1
  %arrayidx138.i477 = getelementptr inbounds i8, ptr %arrayidx33, i64 %j.018.i
  store i8 0, ptr %arrayidx138.i477, align 1
  %inc139.i = add nuw i64 %i.617.i, 1
  %80 = load i8, ptr %arrayidx133.i475, align 1
  %arrayidx142.i = getelementptr inbounds i8, ptr %arrayidx33, i64 %inc137.i
  store i8 %80, ptr %arrayidx142.i, align 1
  br label %if.end264.i

if.else143.i:                                     ; preds = %for.body132.i
  %and146.i = and i8 %79, -32
...
if.then149.i:                                     ; preds = %if.else143.i
  ...
  %81 = load i8, ptr %arrayidx151.i, align 1
  %82 = and i8 %81, -64
  %cmp154.i = icmp eq i8 %82, -128
  br i1 %cmp154.i, label %if.then156.i, label %for.end265.sink.split.i

if.then156.i:                                     ; preds = %if.then149.i
  %and159.i = lshr i8 %79, 2
  %shr.i = and i8 %and159.i, 7
  %inc162.i = or i64 %j.018.i, 1
  %arrayidx163.i = getelementptr inbounds i8, ptr %arrayidx33, i64 %j.018.i
  store i8 %shr.i, ptr %arrayidx163.i, align 1
  %83 = load i8, ptr %arrayidx133.i475, align 1
  %shl.i = shl i8 %83, 6
  %84 = load i8, ptr %arrayidx151.i, align 1
  %85 = and i8 %84, 63
  %or.i = or i8 %85, %shl.i
  %arrayidx173.i = getelementptr inbounds i8, ptr %arrayidx33, i64 %inc162.i
  store i8 %or.i, ptr %arrayidx173.i, align 1
  %add176.i = add i64 %i.617.i, 2
  br label %if.end264.i

if.then183.i:                                     ; preds = %if.else143.i
  %add184.i = add nuw i64 %i.617.i, 1
  %arrayidx185.i476 = getelementptr inbounds i8, ptr %tmpbuff.1, i64 %add184.i
  %86 = load i8, ptr %arrayidx185.i476, align 1
  %87 = and i8 %86, -64
  %cmp188.i = icmp eq i8 %87, -128
...
land.lhs.true190.i:                               ; preds = %if.then183.i
  ...
  %88 = load i8, ptr %arrayidx192.i, align 1
  %89 = and i8 %88, -64
  %cmp195.i = icmp eq i8 %89, -128
  br i1 %cmp195.i, label %if.then197.i, label %for.end265.sink.split.i

if.then197.i:                                     ; preds = %land.lhs.true190.i
  %shl200.i = shl i8 %79, 4
  %shr204.i = lshr i8 %86, 2
  ...
  store i8 %or206.i, ptr %arrayidx209.i, align 1
  %90 = load i8, ptr %arrayidx185.i476, align 1
  %shl213.i = shl i8 %90, 6
  %91 = load i8, ptr %arrayidx192.i, align 1
  %92 = and i8 %91, 63
  %or218.i = or i8 %92, %shl213.i
  %arrayidx221.i = getelementptr inbounds i8, ptr %arrayidx33, i64 %inc208.i
  store i8 %or218.i, ptr %arrayidx221.i, align 1
  %add224.i = add i64 %i.617.i, 3
  br label %if.end264.i

if.else225.i:                                     ; preds = %if.else143.i
  %93 = and i8 %79, -8
  %cmp229.i = icmp eq i8 %93, -16
...
if.then231.i:                                     ; preds = %if.else225.i
  ...
  %94 = load i8, ptr %arrayidx233.i, align 1
  %95 = and i8 %94, -64
  %cmp236.i = icmp eq i8 %95, -128
...
land.lhs.true238.i:                               ; preds = %if.then231.i
  ...
  %96 = load i8, ptr %arrayidx240.i, align 1
  %97 = and i8 %96, -64
  %cmp243.i = icmp eq i8 %97, -128
...
land.lhs.true245.i:                               ; preds = %land.lhs.true238.i
  ...
  %98 = load i8, ptr %arrayidx247.i, align 1
  %99 = and i8 %98, -64
  %cmp250.i = icmp eq i8 %99, -128
...
if.then252.i:                                     ; preds = %land.lhs.true245.i
  ...
  store i8 -1, ptr %arrayidx256.i, align 1
...
if.end264.i:                                      ; preds = %if.then252.i, %if.then197.i, %if.then156.i, %if.then136.i
  ...
  %100 = select i1 %cmp130.i, i1 %cmp131.i, i1 false
  br i1 %100, label %for.body132.i, label %for.end265.i
...
if.then276.i:                                     ; preds = %land.lhs.true271.i
  store i32 7, ptr %call277.i, align 4
  br label %if.end145

sw.epilog.i.loopexit663.unr-lcssa:                ; preds = %for.body91.i, %for.body91.i.preheader
  %i.423.i.unr = phi i64 [ 0, %for.body91.i.preheader ], [ %add99.i.1, %for.body91.i ]
  %lcmp.mod672.not = icmp eq i64 %xtraiter671, 0
  br i1 %lcmp.mod672.not, label %sw.epilog.i, label %for.body91.i.epil

for.body91.i.epil:                                ; preds = %sw.epilog.i.loopexit663.unr-lcssa
  %add92.i.epil = or i64 %i.423.i.unr, 1
  %arrayidx93.i.epil = getelementptr inbounds i8, ptr %tmpbuff.1, i64 %add92.i.epil
  %101 = load i8, ptr %arrayidx93.i.epil, align 1
  %arrayidx94.i.epil = getelementptr inbounds i8, ptr %arrayidx33, i64 %i.423.i.unr
  store i8 %101, ptr %arrayidx94.i.epil, align 1
  %arrayidx95.i.epil = getelementptr inbounds i8, ptr %tmpbuff.1, i64 %i.423.i.unr
  %102 = load i8, ptr %arrayidx95.i.epil, align 1
  %arrayidx97.i481.epil = getelementptr inbounds i8, ptr %arrayidx33, i64 %add92.i.epil
  store i8 %102, ptr %arrayidx97.i481.epil, align 1
  br label %sw.epilog.i

sw.epilog.i:                                      ; preds = %for.body91.i.epil, %sw.epilog.i.loopexit663.unr-lcssa, %for.inc85.i, %for.inc55.i, %for.inc34.i, %for.inc.i489, %sw.bb101.i, %sw.bb88.i, %sw.bb.i483, %for.cond19.preheader.i, %for.cond40.preheader.i, %for.cond59.preheader.i, %if.then122
...
if.end145:                                        ; preds = %if.then276.i, %if.then287.i, %sw.epilog.i, %for.end265.i, %for.end119.i, %land.lhs.true118, %if.end116, %if.then133
  %tmpbuff.3 = phi ptr [ %tmpbuff.1, %if.end116 ], [ %incdec.ptr143, %if.then133 ], [ %tmpbuff.1, %land.lhs.true118 ], [ %add.ptr284.i, %sw.epilog.i ], [ %add.ptr268.i, %for.end265.i ], [ %add.ptr.i480, %for.end119.i ], [ %add.ptr268.i, %if.then276.i ], [ %add.ptr284.i, %if.then287.i ]
  ...
  %106 = tail call i8 @llvm.smax.i8(i8 %alignfix.0, i8 0)
  %conv154 = zext i8 %106 to i64
  %add155 = add i64 %inleft.4, %conv154
  %107 = load ptr, ptr %out_area, align 8
  %sub.ptr.lhs.cast160 = ptrtoint ptr %out.1 to i64
  %sub.ptr.rhs.cast161 = ptrtoint ptr %107 to i64
  %108 = add i64 %spec.select, %sub.ptr.rhs.cast161
  %sub163 = sub i64 %sub.ptr.lhs.cast160, %108
  store i64 %sub163, ptr %length15, align 8
  %109 = load ptr, ptr %tmp_area, align 8
  %sub.ptr.lhs.cast168 = ptrtoint ptr %tmpbuff.3 to i64
  %sub.ptr.rhs.cast169 = ptrtoint ptr %109 to i64
  %sub.ptr.sub170 = sub i64 %sub.ptr.lhs.cast168, %sub.ptr.rhs.cast169
  store i64 %sub.ptr.sub170, ptr %offset, align 8
  %add177 = add nsw i64 %sub.ptr.sub170, %add155
  store i64 %add177, ptr %length, align 8
  %tobool178.not = icmp eq i64 %7, %8
  br i1 %tobool178.not, label %if.else204, label %if.then179

if.then179:                                       ; preds = %if.end145
  %110 = load i64, ptr %buffer_size, align 8
  %div181462 = lshr i64 %110, 1
  %cmp182 = icmp ult i64 %sub37, %div181462
  %111 = load ptr, ptr %norm_area, align 8
  br i1 %cmp182, label %if.then184, label %if.else197

if.then184:                                       ; preds = %if.then179
  %112 = load i64, ptr %offset36, align 8
  %add.ptr191 = getelementptr inbounds i8, ptr %111, i64 %112
  tail call void @llvm.memmove.p0.p0.i64(ptr align 1 %111, ptr align 1 %add.ptr191, i64 %sub37, i1 false)
  store i64 0, ptr %offset36, align 8
  %113 = load ptr, ptr %norm_area, align 8
  %add.ptr196 = getelementptr inbounds i8, ptr %113, i64 %sub37
  %.pre = load ptr, ptr %out_area, align 8
  %.pre615 = load i64, ptr %length15, align 8
  br label %if.end209

if.else197:                                       ; preds = %if.then179
  %114 = load i64, ptr %length34, align 8
  %add.ptr202 = getelementptr inbounds i8, ptr %111, i64 %114
  br label %if.end209

if.else204:                                       ; preds = %if.end145
  store i64 0, ptr %offset36, align 8
  %115 = load ptr, ptr %norm_area, align 8
  br label %if.end209

if.end209:                                        ; preds = %if.then184, %if.else197, %if.else204
  %116 = phi i64 [ %.pre615, %if.then184 ], [ %sub163, %if.else197 ], [ %sub163, %if.else204 ]
  %117 = phi ptr [ %113, %if.then184 ], [ %111, %if.else197 ], [ %115, %if.else204 ]
  %118 = phi ptr [ %.pre, %if.then184 ], [ %107, %if.else197 ], [ %107, %if.else204 ]
  %norm.0 = phi ptr [ %add.ptr196, %if.then184 ], [ %add.ptr202, %if.else197 ], [ %115, %if.else204 ]
  %119 = load i64, ptr %buffer_size, align 8
  %add.ptr215 = getelementptr inbounds i8, ptr %117, i64 %119
  %cmp218 = icmp sgt i64 %116, 0
  br i1 %cmp218, label %land.lhs.true220, label %if.else231

land.lhs.true220:                                 ; preds = %if.end209
  %120 = load i8, ptr %118, align 1
  %cmp223 = icmp eq i8 %120, -1
  br i1 %cmp223, label %land.lhs.true225, label %if.else231

land.lhs.true225:                                 ; preds = %land.lhs.true220
  %arrayidx226 = getelementptr inbounds i8, ptr %118, i64 1
  %121 = load i8, ptr %arrayidx226, align 1
  %cmp228 = icmp eq i8 %121, -2
...
if.end232:                                        ; preds = %land.lhs.true225, %if.else231
  ...
  %cmp236595 = icmp slt i64 %i.0, %116
  br i1 %cmp236595, label %for.body238.lr.ph, label %for.end311
...
for.body238:                                      ; preds = %for.body238.lr.ph, %for.inc309
  %norm.1597 = phi ptr [ %norm.0, %for.body238.lr.ph ], [ %norm.4566, %for.inc309 ]
  %i.1596 = phi i64 [ %i.0, %for.body238.lr.ph ], [ %add310, %for.inc309 ]
  %arrayidx239 = getelementptr inbounds i8, ptr %118, i64 %i.1596
  %122 = load i8, ptr %arrayidx239, align 1
  %conv241 = zext i8 %122 to i16
  %shl = shl nuw i16 %conv241, 8
  %add242 = or i64 %i.1596, 1
  %arrayidx243 = getelementptr inbounds i8, ptr %118, i64 %add242
  %123 = load i8, ptr %arrayidx243, align 1
  %conv244 = zext i8 %123 to i16
...
land.lhs.true251:                                 ; preds = %if.then247
  %124 = load i32, ptr %msg_zero_shown, align 8
  %tobool252.not = icmp eq i32 %124, 0
  br i1 %tobool252.not, label %if.then253, label %for.inc309

if.then253:                                       ; preds = %land.lhs.true251
  store i32 1, ptr %msg_zero_shown, align 8
...
if.end270:                                        ; preds = %if.then269, %if.end264
  %incdec.ptr272 = getelementptr inbounds i8, ptr %norm.1597, i64 1
  store i8 %123, ptr %norm.1597, align 1
  br label %for.inc309
...
if.then277:                                       ; preds = %if.else273
  %cmp278.not = icmp ult ptr %norm.1597, %add.ptr215
  br i1 %cmp278.not, label %if.end281, label %for.end311

if.end281:                                        ; preds = %if.then277
  %incdec.ptr282 = getelementptr inbounds i8, ptr %norm.1597, i64 1
  store i8 32, ptr %norm.1597, align 1
  br label %for.inc309
...
if.else283:                                       ; preds = %if.else273
  ...
  %sub.ptr.rhs.cast292 = ptrtoint ptr %norm.1597 to i64
  ...
  br i1 %cmp295.not, label %select.unfold, label %cleanup306

select.unfold:                                    ; preds = %if.else283
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %norm.1597, ptr nonnull align 1 %buff, i64 %conv294, i1 false)
  %add.ptr301 = getelementptr inbounds i8, ptr %norm.1597, i64 %conv294
  call void @llvm.lifetime.end.p0(i64 10, ptr nonnull %buff) #14
  br label %for.inc309

cleanup306:                                       ; preds = %if.else283
  call void @llvm.lifetime.end.p0(i64 10, ptr nonnull %buff) #14
  br label %for.end311

for.inc309:                                       ; preds = %select.unfold, %if.then253, %land.lhs.true251, %if.then247, %if.end281, %if.end270
  %norm.4566 = phi ptr [ %add.ptr301, %select.unfold ], [ %norm.1597, %if.then247 ], [ %norm.1597, %if.then253 ], [ %norm.1597, %land.lhs.true251 ], [ %incdec.ptr282, %if.end281 ], [ %incdec.ptr272, %if.end270 ]
  %add310 = add nuw nsw i64 %i.1596, 2
  %125 = load i64, ptr %length15, align 8
  %cmp236 = icmp slt i64 %add310, %125
  br i1 %cmp236, label %for.body238, label %for.end311

for.end311:                                       ; preds = %for.inc309, %if.then260, %if.then277, %if.end232, %cleanup306
  %i.1586 = phi i64 [ %i.1596, %cleanup306 ], [ %i.0, %if.end232 ], [ %add310, %for.inc309 ], [ %i.1596, %if.then260 ], [ %i.1596, %if.then277 ]
  %norm.1584 = phi ptr [ %norm.1597, %cleanup306 ], [ %norm.0, %if.end232 ], [ %norm.4566, %for.inc309 ], [ %norm.1597, %if.then260 ], [ %norm.1597, %if.then277 ]
  store i64 %i.1586, ptr %offset17, align 8
  %126 = load ptr, ptr %norm_area, align 8
  %sub.ptr.lhs.cast316 = ptrtoint ptr %norm.1584 to i64
  %sub.ptr.rhs.cast317 = ptrtoint ptr %126 to i64
  %sub.ptr.sub318 = sub i64 %sub.ptr.lhs.cast316, %sub.ptr.rhs.cast317
  store i64 %sub.ptr.sub318, ptr %length34, align 8
  br label %return.sink.split
...
if.then.i:                                        ; preds = %entry
  ...
  store ptr %call.i, ptr @global_iconv_cache, align 8
...
init_iconv_pool_ifneeded.exit:                    ; preds = %entry, %if.then2.i
  %.pr = load ptr, ptr @global_iconv_cache, align 8
...
if.end.i:                                         ; preds = %if.end12
  store i32 10, ptr %call.i73, align 4
  %cmp.i.i = icmp eq ptr %fromcode, @.str.1682
  br i1 %cmp.i.i, label %if.then.i.i, label %if.else.i.i

if.then.i.i:                                      ; preds = %if.end.i
  store i32 4, ptr %call.i73, align 4
...
if.then2.i.i:                                     ; preds = %if.else.i.i
  store i32 5, ptr %call.i73, align 4
  br label %iconv_open.exit
...
land.lhs.true.i.i:                                ; preds = %if.else3.i.i
  %4 = load ptr, ptr %call4.i.i, align 8
...
if.then6.i.i:                                     ; preds = %land.lhs.true.i.i
  ...
  store i32 %conv.i.i, ptr %call.i73, align 4
  br label %if.end8.i.i

if.end8thread-pre-split.i.i:                      ; preds = %land.lhs.true.i.i, %if.else3.i.i
  %.pr.i.i = load i32, ptr %call.i73, align 4
  br label %if.end8.i.i
...
iconv_open.exit:                                  ; preds = %if.end8.i.i, %switch.lookup, %if.then.i.i, %if.then2.i.i
  ...
  store i64 %retval.0.i.i, ptr %size.i, align 8
...
if.end29:                                         ; preds = %if.then18, %if.then15
  ...
  store ptr %call.i73, ptr %arrayidx33, align 8
...
entry:
  %0 = load ptr, ptr @global_iconv_cache, align 8
...
iconv_close.exit.i:                               ; preds = %if.then.i.i, %for.body.i
  ...
  %6 = load i64, ptr %last.i, align 8
  %cmp.i = icmp ult i64 %inc.i, %6
  br i1 %cmp.i, label %for.body.i, label %iconv_cache_destroy.exit
...
iconv_cache_destroy.exit:                         ; preds = %iconv_close.exit.i, %entry
  ...
  %7 = load ptr, ptr %hashtab.i, align 8
