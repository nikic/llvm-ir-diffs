; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/shared_misc.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/shared_misc.c"
...
if.then:                                          ; preds = %entry
  ...
  %0 = load i16, ptr %enabled, align 4
...
lor.lhs.false:                                    ; preds = %if.then
  ...
  %1 = load i16, ptr %enabled5, align 4
...
if.then36:                                        ; preds = %if.end33
  ...
  %5 = load i32, ptr %version37, align 8
  %cmp38 = icmp ugt i32 %4, %5
  br i1 %cmp38, label %if.then40, label %if.end42

if.then40:                                        ; preds = %if.then36
  %6 = load ptr, ptr %strarg, align 8
  br label %if.end42
...
while.body:                                       ; preds = %while.cond
  ...
  br i1 %cmp13, label %if.then15, label %while.cond
...
while.body:                                       ; preds = %while.cond.preheader, %while.cond.backedge
  ...
  %0 = load i64, ptr %call854, align 8
...
while.cond.backedge:                              ; preds = %while.body, %if.end19, %if.then11, %lor.lhs.false
  ...
  %tobool9.not = icmp eq ptr %call8, null
  br i1 %tobool9.not, label %cleanup.sink.split, label %while.body
