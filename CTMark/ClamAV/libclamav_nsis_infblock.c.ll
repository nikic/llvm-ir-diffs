; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_nsis_infblock.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_nsis_infblock.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.inflate_huft_s = type { %union.anon.4, i16 }
...
for.cond.sw.bb789_crit_edge:                      ; preds = %for.cond
  %.pre3413 = load i32, ptr %need955, align 8
  br label %sw.bb789

for.cond.sw.bb782_crit_edge:                      ; preds = %for.cond
  %.pre3411 = load i8, ptr %lbits761, align 8
  %.pre3412 = load ptr, ptr %ltree768, align 8
  br label %sw.bb782

for.cond.sw.bb491_crit_edge:                      ; preds = %for.cond
  %index497.promoted.pre = load i32, ptr %index, align 4
  br label %sw.bb491

for.cond.sw.bb960_crit_edge:                      ; preds = %for.cond
  %.pre3407 = load i32, ptr %need955, align 8
  br label %sw.bb960

for.cond.sw.bb1113_crit_edge:                     ; preds = %for.cond
  %.pre3405 = load i32, ptr %dist1103, align 4
  br label %sw.bb1113
...
if.then:                                          ; preds = %while.body
  store i64 %_state.sroa.561588.0, ptr %bitb, align 8
  store i32 %_state.sroa.130.0, ptr %bitk, align 4
  store i32 0, ptr %avail_in, align 8
  store ptr %_state.sroa.2191703.0, ptr %z, align 8
  store ptr %_state.sroa.3231780.0, ptr %write, align 8
...
cond.false.peel.i:                                ; preds = %if.then
  %13 = load ptr, ptr %end14.i2884, align 8
...
cond.end.peel.i:                                  ; preds = %cond.false.peel.i, %if.then
  ...
  %14 = load i32, ptr %avail_out.i2882, align 8
  %conv..peel.i = tail call i32 @llvm.umin.i32(i32 %14, i32 %conv.peel.i)
  %sub.peel.i = sub i32 %14, %conv..peel.i
  store i32 %sub.peel.i, ptr %avail_out.i2882, align 8
  %15 = load ptr, ptr %next_out.i2883, align 8
...
again.i.sink.split:                               ; preds = %if.then.peel.i, %if.then21.i
  ...
  %.ph3725 = phi ptr [ %add.ptr13.i, %if.then21.i ], [ %add.ptr13.peel.i, %if.then.peel.i ]
  store ptr %window.i2885, ptr %write, align 8
  br label %again.i.preheader

again.i.preheader:                                ; preds = %if.then.peel.i, %again.i.sink.split
  %.ph3758 = phi ptr [ %.ph, %again.i.sink.split ], [ %add.ptr.peel.i, %if.then.peel.i ]
  %.ph3759 = phi ptr [ %.ph3725, %again.i.sink.split ], [ %add.ptr13.peel.i, %if.then.peel.i ]
  %.ph3760 = phi ptr [ %window.i2885, %again.i.sink.split ], [ %18, %if.then.peel.i ]
  br label %again.i

again.i:                                          ; preds = %again.i.preheader, %if.then.i
  %19 = phi ptr [ %add.ptr.i, %if.then.i ], [ %.ph3758, %again.i.preheader ]
  %20 = phi ptr [ %add.ptr13.i, %if.then.i ], [ %.ph3759, %again.i.preheader ]
  %21 = phi ptr [ %25, %if.then.i ], [ %.ph3760, %again.i.preheader ]
  ...
  %22 = load i32, ptr %avail_out.i2882, align 8
  %conv..i = tail call i32 @llvm.umin.i32(i32 %22, i32 %conv.i)
  %sub.i = sub i32 %22, %conv..i
  store i32 %sub.i, ptr %avail_out.i2882, align 8
...
if.then.i:                                        ; preds = %again.i
  ...
  br i1 %cmp19.i, label %if.then21.i, label %again.i

if.then21.i:                                      ; preds = %if.then.i
  br label %again.i.sink.split
...
inflate_flush.exit:                               ; preds = %again.i, %cond.end.peel.i
  ...
  store ptr %add.ptr13.lcssa.i, ptr %read, align 8
...
if.end:                                           ; preds = %while.body
  ...
  %26 = load i8, ptr %_state.sroa.2191703.0, align 1
...
while.end:                                        ; preds = %if.end, %while.cond.preheader
  ...
  store i32 %cond37, ptr %last1482, align 8
...
sw.bb40:                                          ; preds = %while.end
  ...
  store i32 9, ptr %blocks, align 8
  br label %for.cond.backedge

sw.bb51:                                          ; preds = %while.end
  %27 = load i8, ptr @fixed_built, align 1
...
for.body:                                         ; preds = %if.then53, %if.end69
  %indvars.iv3398 = phi i64 [ 0, %if.then53 ], [ %indvars.iv.next3399, %if.end69 ]
...
if.end69:                                         ; preds = %if.else, %if.then59, %for.body
  ...
  store i32 %v.0, ptr %arrayidx, align 4
  %indvars.iv.next3399 = add nuw nsw i64 %indvars.iv3398, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next3399, 288
...
for.end:                                          ; preds = %if.end69
  ...
  store <4 x i32> <i32 5, i32 5, i32 5, i32 5>, ptr @nsis_inflate.lc, align 16
  store <4 x i32> <i32 5, i32 5, i32 5, i32 5>, ptr getelementptr inbounds ([288 x i32], ptr @nsis_inflate.lc, i64 0, i64 4), align 16
  store <4 x i32> <i32 5, i32 5, i32 5, i32 5>, ptr getelementptr inbounds ([288 x i32], ptr @nsis_inflate.lc, i64 0, i64 8), align 16
  store <4 x i32> <i32 5, i32 5, i32 5, i32 5>, ptr getelementptr inbounds ([288 x i32], ptr @nsis_inflate.lc, i64 0, i64 12), align 16
  store <4 x i32> <i32 5, i32 5, i32 5, i32 5>, ptr getelementptr inbounds ([288 x i32], ptr @nsis_inflate.lc, i64 0, i64 16), align 16
  store <4 x i32> <i32 5, i32 5, i32 5, i32 5>, ptr getelementptr inbounds ([288 x i32], ptr @nsis_inflate.lc, i64 0, i64 20), align 16
  store <4 x i32> <i32 5, i32 5, i32 5, i32 5>, ptr getelementptr inbounds ([288 x i32], ptr @nsis_inflate.lc, i64 0, i64 24), align 16
  store i32 5, ptr getelementptr inbounds ([288 x i32], ptr @nsis_inflate.lc, i64 0, i64 28), align 16
  store i32 5, ptr getelementptr inbounds ([288 x i32], ptr @nsis_inflate.lc, i64 0, i64 29), align 4
  ...
  %28 = load i8, ptr @fixed_built, align 1
  %inc82 = add i8 %28, 1
  store i8 %inc82, ptr @fixed_built, align 1
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %f) #5
  br label %if.end83

if.end83:                                         ; preds = %for.end, %sw.bb51
  %29 = load i32, ptr @fixed_bl, align 4
  %conv84 = trunc i32 %29 to i8
  store i8 %conv84, ptr %lbits761, align 8
  %30 = load i32, ptr @fixed_bd, align 4
  %conv87 = trunc i32 %30 to i8
  store i8 %conv87, ptr %dbits952, align 1
  %31 = load ptr, ptr @fixed_tl, align 8
  store ptr %31, ptr %ltree768, align 8
  %32 = load ptr, ptr @fixed_td, align 8
  store ptr %32, ptr %dtree956, align 8
  store i32 0, ptr %blocks, align 8
  br label %for.cond.backedge

sw.bb95:                                          ; preds = %while.end
  store i32 11, ptr %blocks, align 8
  br label %for.cond.backedge
...
if.then106:                                       ; preds = %while.body103.1, %while.body103.preheader
  ...
  store i64 %_state.sroa.561588.23239.lcssa, ptr %bitb, align 8
  store i32 %33, ptr %bitk, align 4
  store i32 0, ptr %avail_in, align 8
  store ptr %_state.sroa.2191703.23237.lcssa, ptr %z, align 8
  store ptr %_state.sroa.3231780.0, ptr %write, align 8
  %34 = load ptr, ptr %read, align 8
  %cmp.not.peel.i2241 = icmp ugt ptr %34, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2241, label %cond.false.peel.i2276, label %cond.end.peel.i2242

cond.false.peel.i2276:                            ; preds = %if.then106
  %35 = load ptr, ptr %end14.i2884, align 8
  br label %cond.end.peel.i2242

cond.end.peel.i2242:                              ; preds = %cond.false.peel.i2276, %if.then106
  %cond.peel.i2243 = phi ptr [ %35, %cond.false.peel.i2276 ], [ %_state.sroa.3231780.0, %if.then106 ]
  ...
  %36 = load i32, ptr %avail_out.i2882, align 8
  %conv..peel.i2248 = tail call i32 @llvm.umin.i32(i32 %36, i32 %conv.peel.i2247)
  %sub.peel.i2249 = sub i32 %36, %conv..peel.i2248
  store i32 %sub.peel.i2249, ptr %avail_out.i2882, align 8
  %37 = load ptr, ptr %next_out.i2883, align 8
  ...
  %38 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.peel.i2251 = getelementptr inbounds i8, ptr %38, i64 %conv10.peel.i2250
  store ptr %add.ptr.peel.i2251, ptr %next_out.i2883, align 8
  %add.ptr13.peel.i2252 = getelementptr inbounds i8, ptr %34, i64 %conv10.peel.i2250
  %39 = load ptr, ptr %end14.i2884, align 8
  %cmp15.peel.i2253 = icmp eq ptr %add.ptr13.peel.i2252, %39
  br i1 %cmp15.peel.i2253, label %if.then.peel.i2255, label %inflate_flush.exit2277

if.then.peel.i2255:                               ; preds = %cond.end.peel.i2242
  %40 = load ptr, ptr %write, align 8
  %cmp19.peel.i2256 = icmp eq ptr %40, %add.ptr13.peel.i2252
  br i1 %cmp19.peel.i2256, label %again.i2259.sink.split, label %again.i2259.preheader

again.i2259.sink.split:                           ; preds = %if.then.peel.i2255, %if.then21.i2274
  %.ph3726 = phi ptr [ %add.ptr.i2268, %if.then21.i2274 ], [ %add.ptr.peel.i2251, %if.then.peel.i2255 ]
  %.ph3727 = phi ptr [ %add.ptr13.i2269, %if.then21.i2274 ], [ %add.ptr13.peel.i2252, %if.then.peel.i2255 ]
  store ptr %window.i2885, ptr %write, align 8
  br label %again.i2259.preheader

again.i2259.preheader:                            ; preds = %if.then.peel.i2255, %again.i2259.sink.split
  %.ph3763 = phi ptr [ %.ph3726, %again.i2259.sink.split ], [ %add.ptr.peel.i2251, %if.then.peel.i2255 ]
  %.ph3764 = phi ptr [ %.ph3727, %again.i2259.sink.split ], [ %add.ptr13.peel.i2252, %if.then.peel.i2255 ]
  %.ph3765 = phi ptr [ %window.i2885, %again.i2259.sink.split ], [ %40, %if.then.peel.i2255 ]
  br label %again.i2259

again.i2259:                                      ; preds = %again.i2259.preheader, %if.then.i2271
  %41 = phi ptr [ %add.ptr.i2268, %if.then.i2271 ], [ %.ph3763, %again.i2259.preheader ]
  %42 = phi ptr [ %add.ptr13.i2269, %if.then.i2271 ], [ %.ph3764, %again.i2259.preheader ]
  %43 = phi ptr [ %47, %if.then.i2271 ], [ %.ph3765, %again.i2259.preheader ]
  ...
  %45 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.i2268 = getelementptr inbounds i8, ptr %45, i64 %conv10.i2267
  store ptr %add.ptr.i2268, ptr %next_out.i2883, align 8
  %add.ptr13.i2269 = getelementptr inbounds i8, ptr %window.i2885, i64 %conv10.i2267
  %46 = load ptr, ptr %end14.i2884, align 8
  %cmp15.i2270 = icmp eq ptr %add.ptr13.i2269, %46
  br i1 %cmp15.i2270, label %if.then.i2271, label %inflate_flush.exit2277

if.then.i2271:                                    ; preds = %again.i2259
  %47 = load ptr, ptr %write, align 8
  %cmp19.i2272 = icmp eq ptr %47, %add.ptr13.i2269
  br i1 %cmp19.i2272, label %if.then21.i2274, label %again.i2259

if.then21.i2274:                                  ; preds = %if.then.i2271
  br label %again.i2259.sink.split

inflate_flush.exit2277:                           ; preds = %again.i2259, %cond.end.peel.i2242
  %add.ptr13.lcssa.i2254 = phi ptr [ %add.ptr13.peel.i2252, %cond.end.peel.i2242 ], [ %add.ptr13.i2269, %again.i2259 ]
  store ptr %add.ptr13.lcssa.i2254, ptr %read, align 8
  br label %cleanup1511
...
if.end117:                                        ; preds = %while.body103.preheader
  ...
  %48 = load i8, ptr %_state.sroa.2191703.0, align 1
  ...
  br i1 %cmp101, label %while.body103.1, label %while.end130
...
if.end117.1:                                      ; preds = %while.body103.1
  ...
  %49 = load i8, ptr %incdec.ptr121, align 1
...
while.end130:                                     ; preds = %if.end117, %if.end117.1, %while.cond99.preheader
  ...
  store i32 %and133, ptr %sub, align 8
...
if.then149:                                       ; preds = %sw.bb145
  ...
  store ptr %_state.sroa.2191703.0, ptr %z, align 8
  store ptr %_state.sroa.3231780.0, ptr %write, align 8
  %51 = load ptr, ptr %read, align 8
  %cmp.not.peel.i2284 = icmp ugt ptr %51, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2284, label %cond.false.peel.i2319, label %cond.end.peel.i2285

cond.false.peel.i2319:                            ; preds = %if.then149
  %52 = load ptr, ptr %end14.i2884, align 8
  br label %cond.end.peel.i2285

cond.end.peel.i2285:                              ; preds = %cond.false.peel.i2319, %if.then149
  %cond.peel.i2286 = phi ptr [ %52, %cond.false.peel.i2319 ], [ %_state.sroa.3231780.0, %if.then149 ]
  ...
  %53 = load i32, ptr %avail_out.i2882, align 8
  %conv..peel.i2291 = tail call i32 @llvm.umin.i32(i32 %53, i32 %conv.peel.i2290)
  %sub.peel.i2292 = sub i32 %53, %conv..peel.i2291
  store i32 %sub.peel.i2292, ptr %avail_out.i2882, align 8
  %54 = load ptr, ptr %next_out.i2883, align 8
  ...
  %55 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.peel.i2294 = getelementptr inbounds i8, ptr %55, i64 %conv10.peel.i2293
  store ptr %add.ptr.peel.i2294, ptr %next_out.i2883, align 8
  %add.ptr13.peel.i2295 = getelementptr inbounds i8, ptr %51, i64 %conv10.peel.i2293
  %56 = load ptr, ptr %end14.i2884, align 8
  %cmp15.peel.i2296 = icmp eq ptr %add.ptr13.peel.i2295, %56
  br i1 %cmp15.peel.i2296, label %if.then.peel.i2298, label %inflate_flush.exit2320

if.then.peel.i2298:                               ; preds = %cond.end.peel.i2285
  %57 = load ptr, ptr %write, align 8
  %cmp19.peel.i2299 = icmp eq ptr %57, %add.ptr13.peel.i2295
  br i1 %cmp19.peel.i2299, label %again.i2302.sink.split, label %again.i2302.preheader

again.i2302.sink.split:                           ; preds = %if.then.peel.i2298, %if.then21.i2317
  %.ph3728 = phi ptr [ %add.ptr.i2311, %if.then21.i2317 ], [ %add.ptr.peel.i2294, %if.then.peel.i2298 ]
  %.ph3729 = phi ptr [ %add.ptr13.i2312, %if.then21.i2317 ], [ %add.ptr13.peel.i2295, %if.then.peel.i2298 ]
  store ptr %window.i2885, ptr %write, align 8
  br label %again.i2302.preheader

again.i2302.preheader:                            ; preds = %if.then.peel.i2298, %again.i2302.sink.split
  %.ph3768 = phi ptr [ %.ph3728, %again.i2302.sink.split ], [ %add.ptr.peel.i2294, %if.then.peel.i2298 ]
  %.ph3769 = phi ptr [ %.ph3729, %again.i2302.sink.split ], [ %add.ptr13.peel.i2295, %if.then.peel.i2298 ]
  %.ph3770 = phi ptr [ %window.i2885, %again.i2302.sink.split ], [ %57, %if.then.peel.i2298 ]
  br label %again.i2302

again.i2302:                                      ; preds = %again.i2302.preheader, %if.then.i2314
  %58 = phi ptr [ %add.ptr.i2311, %if.then.i2314 ], [ %.ph3768, %again.i2302.preheader ]
  %59 = phi ptr [ %add.ptr13.i2312, %if.then.i2314 ], [ %.ph3769, %again.i2302.preheader ]
  %60 = phi ptr [ %64, %if.then.i2314 ], [ %.ph3770, %again.i2302.preheader ]
  ...
  %62 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.i2311 = getelementptr inbounds i8, ptr %62, i64 %conv10.i2310
  store ptr %add.ptr.i2311, ptr %next_out.i2883, align 8
  %add.ptr13.i2312 = getelementptr inbounds i8, ptr %window.i2885, i64 %conv10.i2310
  %63 = load ptr, ptr %end14.i2884, align 8
  %cmp15.i2313 = icmp eq ptr %add.ptr13.i2312, %63
  br i1 %cmp15.i2313, label %if.then.i2314, label %inflate_flush.exit2320

if.then.i2314:                                    ; preds = %again.i2302
  %64 = load ptr, ptr %write, align 8
  %cmp19.i2315 = icmp eq ptr %64, %add.ptr13.i2312
  br i1 %cmp19.i2315, label %if.then21.i2317, label %again.i2302

if.then21.i2317:                                  ; preds = %if.then.i2314
  br label %again.i2302.sink.split

inflate_flush.exit2320:                           ; preds = %again.i2302, %cond.end.peel.i2285
  %add.ptr13.lcssa.i2297 = phi ptr [ %add.ptr13.peel.i2295, %cond.end.peel.i2285 ], [ %add.ptr13.i2312, %again.i2302 ]
  store ptr %add.ptr13.lcssa.i2297, ptr %read, align 8
  br label %cleanup1511
...
if.then164:                                       ; preds = %if.end160
  %65 = load ptr, ptr %end14.i2884, align 8
...
if.then201:                                       ; preds = %if.then164, %land.lhs.true, %if.end197
  ...
  store ptr %_state.sroa.3231780.12926, ptr %write, align 8
...
if.then266:                                       ; preds = %cond.end223
  store i64 %_state.sroa.561588.0, ptr %bitb, align 8
  store i32 %_state.sroa.130.0, ptr %bitk, align 4
  store i32 %_state.sroa.265.0, ptr %avail_in, align 8
  store ptr %_state.sroa.2191703.0, ptr %z, align 8
  store ptr %_state.sroa.3231780.2, ptr %write, align 8
  tail call fastcc void @inflate_flush(ptr noundef nonnull %z)
  br label %cleanup1511
...
if.end279:                                        ; preds = %if.end197, %cond.end223, %if.end160
  ...
  %73 = load i32, ptr %sub, align 8
  %sub317 = sub i32 %73, %.cond289
  store i32 %sub317, ptr %sub, align 8
...
if.then319:                                       ; preds = %if.end279
  %74 = load i32, ptr %last1482, align 8
  store i32 %74, ptr %blocks, align 8
  br label %for.cond.backedge
...
if.then331:                                       ; preds = %while.body328.1, %while.body328.preheader
  ...
  store i64 %_state.sroa.561588.33168.lcssa, ptr %bitb, align 8
  store i32 %75, ptr %bitk, align 4
  store i32 0, ptr %avail_in, align 8
  store ptr %_state.sroa.2191703.43166.lcssa, ptr %z, align 8
  store ptr %_state.sroa.3231780.0, ptr %write, align 8
  %76 = load ptr, ptr %read, align 8
  %cmp.not.peel.i2327 = icmp ugt ptr %76, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2327, label %cond.false.peel.i2362, label %cond.end.peel.i2328

cond.false.peel.i2362:                            ; preds = %if.then331
  %77 = load ptr, ptr %end14.i2884, align 8
  br label %cond.end.peel.i2328

cond.end.peel.i2328:                              ; preds = %cond.false.peel.i2362, %if.then331
  %cond.peel.i2329 = phi ptr [ %77, %cond.false.peel.i2362 ], [ %_state.sroa.3231780.0, %if.then331 ]
  ...
  %78 = load i32, ptr %avail_out.i2882, align 8
  %conv..peel.i2334 = tail call i32 @llvm.umin.i32(i32 %78, i32 %conv.peel.i2333)
  %sub.peel.i2335 = sub i32 %78, %conv..peel.i2334
  store i32 %sub.peel.i2335, ptr %avail_out.i2882, align 8
  %79 = load ptr, ptr %next_out.i2883, align 8
  ...
  %80 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.peel.i2337 = getelementptr inbounds i8, ptr %80, i64 %conv10.peel.i2336
  store ptr %add.ptr.peel.i2337, ptr %next_out.i2883, align 8
  %add.ptr13.peel.i2338 = getelementptr inbounds i8, ptr %76, i64 %conv10.peel.i2336
  %81 = load ptr, ptr %end14.i2884, align 8
  %cmp15.peel.i2339 = icmp eq ptr %add.ptr13.peel.i2338, %81
  br i1 %cmp15.peel.i2339, label %if.then.peel.i2341, label %inflate_flush.exit2363

if.then.peel.i2341:                               ; preds = %cond.end.peel.i2328
  %82 = load ptr, ptr %write, align 8
  %cmp19.peel.i2342 = icmp eq ptr %82, %add.ptr13.peel.i2338
  br i1 %cmp19.peel.i2342, label %again.i2345.sink.split, label %again.i2345.preheader

again.i2345.sink.split:                           ; preds = %if.then.peel.i2341, %if.then21.i2360
  %.ph3730 = phi ptr [ %add.ptr.i2354, %if.then21.i2360 ], [ %add.ptr.peel.i2337, %if.then.peel.i2341 ]
  %.ph3731 = phi ptr [ %add.ptr13.i2355, %if.then21.i2360 ], [ %add.ptr13.peel.i2338, %if.then.peel.i2341 ]
  store ptr %window.i2885, ptr %write, align 8
  br label %again.i2345.preheader

again.i2345.preheader:                            ; preds = %if.then.peel.i2341, %again.i2345.sink.split
  %.ph3773 = phi ptr [ %.ph3730, %again.i2345.sink.split ], [ %add.ptr.peel.i2337, %if.then.peel.i2341 ]
  %.ph3774 = phi ptr [ %.ph3731, %again.i2345.sink.split ], [ %add.ptr13.peel.i2338, %if.then.peel.i2341 ]
  %.ph3775 = phi ptr [ %window.i2885, %again.i2345.sink.split ], [ %82, %if.then.peel.i2341 ]
  br label %again.i2345

again.i2345:                                      ; preds = %again.i2345.preheader, %if.then.i2357
  %83 = phi ptr [ %add.ptr.i2354, %if.then.i2357 ], [ %.ph3773, %again.i2345.preheader ]
  %84 = phi ptr [ %add.ptr13.i2355, %if.then.i2357 ], [ %.ph3774, %again.i2345.preheader ]
  %85 = phi ptr [ %89, %if.then.i2357 ], [ %.ph3775, %again.i2345.preheader ]
  ...
  %87 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.i2354 = getelementptr inbounds i8, ptr %87, i64 %conv10.i2353
  store ptr %add.ptr.i2354, ptr %next_out.i2883, align 8
  %add.ptr13.i2355 = getelementptr inbounds i8, ptr %window.i2885, i64 %conv10.i2353
  %88 = load ptr, ptr %end14.i2884, align 8
  %cmp15.i2356 = icmp eq ptr %add.ptr13.i2355, %88
  br i1 %cmp15.i2356, label %if.then.i2357, label %inflate_flush.exit2363

if.then.i2357:                                    ; preds = %again.i2345
  %89 = load ptr, ptr %write, align 8
  %cmp19.i2358 = icmp eq ptr %89, %add.ptr13.i2355
  br i1 %cmp19.i2358, label %if.then21.i2360, label %again.i2345

if.then21.i2360:                                  ; preds = %if.then.i2357
  br label %again.i2345.sink.split

inflate_flush.exit2363:                           ; preds = %again.i2345, %cond.end.peel.i2328
  %add.ptr13.lcssa.i2340 = phi ptr [ %add.ptr13.peel.i2338, %cond.end.peel.i2328 ], [ %add.ptr13.i2355, %again.i2345 ]
  store ptr %add.ptr13.lcssa.i2340, ptr %read, align 8
  br label %cleanup1511
...
if.end342:                                        ; preds = %while.body328.preheader
  ...
  %90 = load i8, ptr %_state.sroa.2191703.0, align 1
  ...
  br i1 %cmp326, label %while.body328.1, label %while.end355.loopexit
...
if.end342.1:                                      ; preds = %while.body328.1
  ...
  %91 = load i8, ptr %incdec.ptr346, align 1
...
while.end355:                                     ; preds = %while.end355.loopexit, %while.cond324.preheader
  ...
  store i32 %and358, ptr %sub, align 8
...
if.then370:                                       ; preds = %while.end355
  store i32 17, ptr %blocks, align 8
  store i64 %_state.sroa.561588.3.lcssa, ptr %bitb, align 8
  store i32 %_state.sroa.130.3.lcssa, ptr %bitk, align 4
  store i32 %_state.sroa.265.4.lcssa, ptr %avail_in, align 8
  store ptr %_state.sroa.2191703.4.lcssa, ptr %z, align 8
  store ptr %_state.sroa.3231780.0, ptr %write, align 8
  tail call fastcc void @inflate_flush(ptr noundef nonnull %z)
  br label %cleanup1511
...
sw.bb389.thread:                                  ; preds = %while.end355
  ...
  store i32 12, ptr %blocks, align 8
  br label %while.cond400.preheader.preheader

sw.bb389:                                         ; preds = %for.cond
  %.pre3408 = load i32, ptr %index, align 4
  %.pre3409 = load i32, ptr %sub, align 8
...
while.cond400.preheader.preheader:                ; preds = %sw.bb389.thread, %sw.bb389
  %.ph3831 = phi i32 [ %.pre3408, %sw.bb389 ], [ 0, %sw.bb389.thread ]
...
while.cond400.preheader:                          ; preds = %while.cond400.preheader.preheader, %while.end431
  %94 = phi i32 [ %111, %while.end431 ], [ %.ph3831, %while.cond400.preheader.preheader ]
...
if.then407:                                       ; preds = %while.body404
  store i64 %_state.sroa.561588.53188, ptr %bitb, align 8
  store i32 %_state.sroa.130.53187, ptr %bitk, align 4
  store i32 0, ptr %avail_in, align 8
  store ptr %_state.sroa.2191703.63186, ptr %z, align 8
  store ptr %_state.sroa.3231780.0, ptr %write, align 8
  %95 = load ptr, ptr %read, align 8
  %cmp.not.peel.i2370 = icmp ugt ptr %95, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2370, label %cond.false.peel.i2405, label %cond.end.peel.i2371

cond.false.peel.i2405:                            ; preds = %if.then407
  %96 = load ptr, ptr %end14.i2884, align 8
  br label %cond.end.peel.i2371

cond.end.peel.i2371:                              ; preds = %cond.false.peel.i2405, %if.then407
  %cond.peel.i2372 = phi ptr [ %96, %cond.false.peel.i2405 ], [ %_state.sroa.3231780.0, %if.then407 ]
  ...
  %97 = load i32, ptr %avail_out.i2882, align 8
  %conv..peel.i2377 = tail call i32 @llvm.umin.i32(i32 %97, i32 %conv.peel.i2376)
  %sub.peel.i2378 = sub i32 %97, %conv..peel.i2377
  store i32 %sub.peel.i2378, ptr %avail_out.i2882, align 8
  %98 = load ptr, ptr %next_out.i2883, align 8
  ...
  %99 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.peel.i2380 = getelementptr inbounds i8, ptr %99, i64 %conv10.peel.i2379
  store ptr %add.ptr.peel.i2380, ptr %next_out.i2883, align 8
  %add.ptr13.peel.i2381 = getelementptr inbounds i8, ptr %95, i64 %conv10.peel.i2379
  %100 = load ptr, ptr %end14.i2884, align 8
  %cmp15.peel.i2382 = icmp eq ptr %add.ptr13.peel.i2381, %100
  br i1 %cmp15.peel.i2382, label %if.then.peel.i2384, label %inflate_flush.exit2406

if.then.peel.i2384:                               ; preds = %cond.end.peel.i2371
  %101 = load ptr, ptr %write, align 8
  %cmp19.peel.i2385 = icmp eq ptr %101, %add.ptr13.peel.i2381
  br i1 %cmp19.peel.i2385, label %again.i2388.sink.split, label %again.i2388.preheader

again.i2388.sink.split:                           ; preds = %if.then.peel.i2384, %if.then21.i2403
  %.ph3732 = phi ptr [ %add.ptr.i2397, %if.then21.i2403 ], [ %add.ptr.peel.i2380, %if.then.peel.i2384 ]
  %.ph3733 = phi ptr [ %add.ptr13.i2398, %if.then21.i2403 ], [ %add.ptr13.peel.i2381, %if.then.peel.i2384 ]
  store ptr %window.i2885, ptr %write, align 8
  br label %again.i2388.preheader

again.i2388.preheader:                            ; preds = %if.then.peel.i2384, %again.i2388.sink.split
  %.ph3778 = phi ptr [ %.ph3732, %again.i2388.sink.split ], [ %add.ptr.peel.i2380, %if.then.peel.i2384 ]
  %.ph3779 = phi ptr [ %.ph3733, %again.i2388.sink.split ], [ %add.ptr13.peel.i2381, %if.then.peel.i2384 ]
  %.ph3780 = phi ptr [ %window.i2885, %again.i2388.sink.split ], [ %101, %if.then.peel.i2384 ]
  br label %again.i2388

again.i2388:                                      ; preds = %again.i2388.preheader, %if.then.i2400
  %102 = phi ptr [ %add.ptr.i2397, %if.then.i2400 ], [ %.ph3778, %again.i2388.preheader ]
  %103 = phi ptr [ %add.ptr13.i2398, %if.then.i2400 ], [ %.ph3779, %again.i2388.preheader ]
  %104 = phi ptr [ %108, %if.then.i2400 ], [ %.ph3780, %again.i2388.preheader ]
  ...
  %106 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.i2397 = getelementptr inbounds i8, ptr %106, i64 %conv10.i2396
  store ptr %add.ptr.i2397, ptr %next_out.i2883, align 8
  %add.ptr13.i2398 = getelementptr inbounds i8, ptr %window.i2885, i64 %conv10.i2396
  %107 = load ptr, ptr %end14.i2884, align 8
  %cmp15.i2399 = icmp eq ptr %add.ptr13.i2398, %107
  br i1 %cmp15.i2399, label %if.then.i2400, label %inflate_flush.exit2406

if.then.i2400:                                    ; preds = %again.i2388
  %108 = load ptr, ptr %write, align 8
  %cmp19.i2401 = icmp eq ptr %108, %add.ptr13.i2398
  br i1 %cmp19.i2401, label %if.then21.i2403, label %again.i2388

if.then21.i2403:                                  ; preds = %if.then.i2400
  br label %again.i2388.sink.split

inflate_flush.exit2406:                           ; preds = %again.i2388, %cond.end.peel.i2371
  %add.ptr13.lcssa.i2383 = phi ptr [ %add.ptr13.peel.i2381, %cond.end.peel.i2371 ], [ %add.ptr13.i2398, %again.i2388 ]
  store ptr %add.ptr13.lcssa.i2383, ptr %read, align 8
  br label %cleanup1511
...
if.end418:                                        ; preds = %while.body404
  ...
  %109 = load i8, ptr %_state.sroa.2191703.63186, align 1
...
while.body454:                                    ; preds = %while.cond449.preheader, %while.body454
  ...
  store i32 0, ptr %arrayidx464, align 4
  %.pr = load i32, ptr %index, align 4
  %cmp452 = icmp ult i32 %.pr, 19
  br i1 %cmp452, label %while.body454, label %while.end465
...
cleanup.cont:                                     ; preds = %lor.lhs.false479
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %hn) #5
  store i32 0, ptr %index, align 4
  store i32 13, ptr %blocks, align 8
  br label %sw.bb491
...
if.then519:                                       ; preds = %while.body516
  ...
  store i64 %_state.sroa.561588.93200, ptr %bitb, align 8
  store i32 %120, ptr %bitk, align 4
  store i32 0, ptr %avail_in, align 8
  store ptr %scevgep3389.le, ptr %z, align 8
  store ptr %_state.sroa.3231780.0, ptr %write, align 8
  %122 = load ptr, ptr %read, align 8
  %cmp.not.peel.i2413 = icmp ugt ptr %122, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2413, label %cond.false.peel.i2448, label %cond.end.peel.i2414

cond.false.peel.i2448:                            ; preds = %if.then519
  %123 = load ptr, ptr %end14.i2884, align 8
  br label %cond.end.peel.i2414

cond.end.peel.i2414:                              ; preds = %cond.false.peel.i2448, %if.then519
  %cond.peel.i2415 = phi ptr [ %123, %cond.false.peel.i2448 ], [ %_state.sroa.3231780.0, %if.then519 ]
  ...
  %124 = load i32, ptr %avail_out.i2882, align 8
  %conv..peel.i2420 = tail call i32 @llvm.umin.i32(i32 %124, i32 %conv.peel.i2419)
  %sub.peel.i2421 = sub i32 %124, %conv..peel.i2420
  store i32 %sub.peel.i2421, ptr %avail_out.i2882, align 8
  %125 = load ptr, ptr %next_out.i2883, align 8
  ...
  %126 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.peel.i2423 = getelementptr inbounds i8, ptr %126, i64 %conv10.peel.i2422
  store ptr %add.ptr.peel.i2423, ptr %next_out.i2883, align 8
  %add.ptr13.peel.i2424 = getelementptr inbounds i8, ptr %122, i64 %conv10.peel.i2422
  %127 = load ptr, ptr %end14.i2884, align 8
  %cmp15.peel.i2425 = icmp eq ptr %add.ptr13.peel.i2424, %127
  br i1 %cmp15.peel.i2425, label %if.then.peel.i2427, label %inflate_flush.exit2449

if.then.peel.i2427:                               ; preds = %cond.end.peel.i2414
  %128 = load ptr, ptr %write, align 8
  %cmp19.peel.i2428 = icmp eq ptr %128, %add.ptr13.peel.i2424
  br i1 %cmp19.peel.i2428, label %again.i2431.sink.split, label %again.i2431.preheader

again.i2431.sink.split:                           ; preds = %if.then.peel.i2427, %if.then21.i2446
  %.ph3734 = phi ptr [ %add.ptr.i2440, %if.then21.i2446 ], [ %add.ptr.peel.i2423, %if.then.peel.i2427 ]
  %.ph3735 = phi ptr [ %add.ptr13.i2441, %if.then21.i2446 ], [ %add.ptr13.peel.i2424, %if.then.peel.i2427 ]
  store ptr %window.i2885, ptr %write, align 8
  br label %again.i2431.preheader

again.i2431.preheader:                            ; preds = %if.then.peel.i2427, %again.i2431.sink.split
  %.ph3783 = phi ptr [ %.ph3734, %again.i2431.sink.split ], [ %add.ptr.peel.i2423, %if.then.peel.i2427 ]
  %.ph3784 = phi ptr [ %.ph3735, %again.i2431.sink.split ], [ %add.ptr13.peel.i2424, %if.then.peel.i2427 ]
  %.ph3785 = phi ptr [ %window.i2885, %again.i2431.sink.split ], [ %128, %if.then.peel.i2427 ]
  br label %again.i2431

again.i2431:                                      ; preds = %again.i2431.preheader, %if.then.i2443
  %129 = phi ptr [ %add.ptr.i2440, %if.then.i2443 ], [ %.ph3783, %again.i2431.preheader ]
  %130 = phi ptr [ %add.ptr13.i2441, %if.then.i2443 ], [ %.ph3784, %again.i2431.preheader ]
  %131 = phi ptr [ %135, %if.then.i2443 ], [ %.ph3785, %again.i2431.preheader ]
  ...
  %133 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.i2440 = getelementptr inbounds i8, ptr %133, i64 %conv10.i2439
  store ptr %add.ptr.i2440, ptr %next_out.i2883, align 8
  %add.ptr13.i2441 = getelementptr inbounds i8, ptr %window.i2885, i64 %conv10.i2439
  %134 = load ptr, ptr %end14.i2884, align 8
  %cmp15.i2442 = icmp eq ptr %add.ptr13.i2441, %134
  br i1 %cmp15.i2442, label %if.then.i2443, label %inflate_flush.exit2449

if.then.i2443:                                    ; preds = %again.i2431
  %135 = load ptr, ptr %write, align 8
  %cmp19.i2444 = icmp eq ptr %135, %add.ptr13.i2441
  br i1 %cmp19.i2444, label %if.then21.i2446, label %again.i2431

if.then21.i2446:                                  ; preds = %if.then.i2443
  br label %again.i2431.sink.split

inflate_flush.exit2449:                           ; preds = %again.i2431, %cond.end.peel.i2414
  %add.ptr13.lcssa.i2426 = phi ptr [ %add.ptr13.peel.i2424, %cond.end.peel.i2414 ], [ %add.ptr13.i2441, %again.i2431 ]
  store ptr %add.ptr13.lcssa.i2426, ptr %read, align 8
  br label %cleanup1511
...
if.end530:                                        ; preds = %while.body516
  ...
  %136 = load i8, ptr %_state.sroa.2191703.103198, align 1
  ...
  br i1 %cmp514, label %while.body516, label %while.end543
...
if.then560:                                       ; preds = %while.end543
  ...
  store i32 %inc572, ptr %index, align 4
  ...
  store i32 %conv557, ptr %arrayidx574, align 4
  br label %cleanup690
...
if.then591:                                       ; preds = %while.body588
  ...
  store i64 %_state.sroa.561588.103209, ptr %bitb, align 8
  store i32 %145, ptr %bitk, align 4
  store i32 0, ptr %avail_in, align 8
  store ptr %scevgep3392.le, ptr %z, align 8
  store ptr %_state.sroa.3231780.0, ptr %write, align 8
  %146 = load ptr, ptr %read, align 8
  %cmp.not.peel.i2456 = icmp ugt ptr %146, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2456, label %cond.false.peel.i2491, label %cond.end.peel.i2457

cond.false.peel.i2491:                            ; preds = %if.then591
  %147 = load ptr, ptr %end14.i2884, align 8
  br label %cond.end.peel.i2457

cond.end.peel.i2457:                              ; preds = %cond.false.peel.i2491, %if.then591
  %cond.peel.i2458 = phi ptr [ %147, %cond.false.peel.i2491 ], [ %_state.sroa.3231780.0, %if.then591 ]
  ...
  %148 = load i32, ptr %avail_out.i2882, align 8
  %conv..peel.i2463 = tail call i32 @llvm.umin.i32(i32 %148, i32 %conv.peel.i2462)
  %sub.peel.i2464 = sub i32 %148, %conv..peel.i2463
  store i32 %sub.peel.i2464, ptr %avail_out.i2882, align 8
  %149 = load ptr, ptr %next_out.i2883, align 8
  ...
  %150 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.peel.i2466 = getelementptr inbounds i8, ptr %150, i64 %conv10.peel.i2465
  store ptr %add.ptr.peel.i2466, ptr %next_out.i2883, align 8
  %add.ptr13.peel.i2467 = getelementptr inbounds i8, ptr %146, i64 %conv10.peel.i2465
  %151 = load ptr, ptr %end14.i2884, align 8
  %cmp15.peel.i2468 = icmp eq ptr %add.ptr13.peel.i2467, %151
  br i1 %cmp15.peel.i2468, label %if.then.peel.i2470, label %inflate_flush.exit2492

if.then.peel.i2470:                               ; preds = %cond.end.peel.i2457
  %152 = load ptr, ptr %write, align 8
  %cmp19.peel.i2471 = icmp eq ptr %152, %add.ptr13.peel.i2467
  br i1 %cmp19.peel.i2471, label %again.i2474.sink.split, label %again.i2474.preheader

again.i2474.sink.split:                           ; preds = %if.then.peel.i2470, %if.then21.i2489
  %.ph3736 = phi ptr [ %add.ptr.i2483, %if.then21.i2489 ], [ %add.ptr.peel.i2466, %if.then.peel.i2470 ]
  %.ph3737 = phi ptr [ %add.ptr13.i2484, %if.then21.i2489 ], [ %add.ptr13.peel.i2467, %if.then.peel.i2470 ]
  store ptr %window.i2885, ptr %write, align 8
  br label %again.i2474.preheader

again.i2474.preheader:                            ; preds = %if.then.peel.i2470, %again.i2474.sink.split
  %.ph3798 = phi ptr [ %.ph3736, %again.i2474.sink.split ], [ %add.ptr.peel.i2466, %if.then.peel.i2470 ]
  %.ph3799 = phi ptr [ %.ph3737, %again.i2474.sink.split ], [ %add.ptr13.peel.i2467, %if.then.peel.i2470 ]
  %.ph3800 = phi ptr [ %window.i2885, %again.i2474.sink.split ], [ %152, %if.then.peel.i2470 ]
  br label %again.i2474

again.i2474:                                      ; preds = %again.i2474.preheader, %if.then.i2486
  %153 = phi ptr [ %add.ptr.i2483, %if.then.i2486 ], [ %.ph3798, %again.i2474.preheader ]
  %154 = phi ptr [ %add.ptr13.i2484, %if.then.i2486 ], [ %.ph3799, %again.i2474.preheader ]
  %155 = phi ptr [ %159, %if.then.i2486 ], [ %.ph3800, %again.i2474.preheader ]
  ...
  %157 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.i2483 = getelementptr inbounds i8, ptr %157, i64 %conv10.i2482
  store ptr %add.ptr.i2483, ptr %next_out.i2883, align 8
  %add.ptr13.i2484 = getelementptr inbounds i8, ptr %window.i2885, i64 %conv10.i2482
  %158 = load ptr, ptr %end14.i2884, align 8
  %cmp15.i2485 = icmp eq ptr %add.ptr13.i2484, %158
  br i1 %cmp15.i2485, label %if.then.i2486, label %inflate_flush.exit2492

if.then.i2486:                                    ; preds = %again.i2474
  %159 = load ptr, ptr %write, align 8
  %cmp19.i2487 = icmp eq ptr %159, %add.ptr13.i2484
  br i1 %cmp19.i2487, label %if.then21.i2489, label %again.i2474

if.then21.i2489:                                  ; preds = %if.then.i2486
  br label %again.i2474.sink.split

inflate_flush.exit2492:                           ; preds = %again.i2474, %cond.end.peel.i2457
  %add.ptr13.lcssa.i2469 = phi ptr [ %add.ptr13.peel.i2467, %cond.end.peel.i2457 ], [ %add.ptr13.i2484, %again.i2474 ]
  store ptr %add.ptr13.lcssa.i2469, ptr %read, align 8
  br label %cleanup1511
...
if.end602:                                        ; preds = %while.body588
  ...
  %160 = load i8, ptr %_state.sroa.2191703.113207, align 1
  ...
  br i1 %cmp586, label %while.body588, label %while.end615.loopexit
...
while.end615:                                     ; preds = %while.end615.loopexit, %if.else575
  ...
  %162 = load i16, ptr %arrayidx626, align 2
...
if.then656:                                       ; preds = %lor.lhs.false650, %while.end615
  store i32 17, ptr %blocks, align 8
  store i64 %shr632, ptr %bitb, align 8
  store i32 %sub634, ptr %bitk, align 4
  store i32 %_state.sroa.265.11.lcssa, ptr %avail_in, align 8
  store ptr %_state.sroa.2191703.11.lcssa, ptr %z, align 8
  store ptr %_state.sroa.3231780.0, ptr %write, align 8
  %163 = load ptr, ptr %read, align 8
  %cmp.not.peel.i2499 = icmp ugt ptr %163, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2499, label %cond.false.peel.i2534, label %cond.end.peel.i2500

cond.false.peel.i2534:                            ; preds = %if.then656
  %164 = load ptr, ptr %end14.i2884, align 8
  br label %cond.end.peel.i2500

cond.end.peel.i2500:                              ; preds = %cond.false.peel.i2534, %if.then656
  %cond.peel.i2501 = phi ptr [ %164, %cond.false.peel.i2534 ], [ %_state.sroa.3231780.0, %if.then656 ]
  ...
  %165 = load i32, ptr %avail_out.i2882, align 8
  %conv..peel.i2506 = tail call i32 @llvm.umin.i32(i32 %165, i32 %conv.peel.i2505)
  %sub.peel.i2507 = sub i32 %165, %conv..peel.i2506
  store i32 %sub.peel.i2507, ptr %avail_out.i2882, align 8
  %166 = load ptr, ptr %next_out.i2883, align 8
  ...
  %167 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.peel.i2509 = getelementptr inbounds i8, ptr %167, i64 %conv10.peel.i2508
  store ptr %add.ptr.peel.i2509, ptr %next_out.i2883, align 8
  %add.ptr13.peel.i2510 = getelementptr inbounds i8, ptr %163, i64 %conv10.peel.i2508
  %168 = load ptr, ptr %end14.i2884, align 8
  %cmp15.peel.i2511 = icmp eq ptr %add.ptr13.peel.i2510, %168
  br i1 %cmp15.peel.i2511, label %if.then.peel.i2513, label %inflate_flush.exit2535

if.then.peel.i2513:                               ; preds = %cond.end.peel.i2500
  %169 = load ptr, ptr %write, align 8
  %cmp19.peel.i2514 = icmp eq ptr %169, %add.ptr13.peel.i2510
  br i1 %cmp19.peel.i2514, label %again.i2517.sink.split, label %again.i2517.preheader

again.i2517.sink.split:                           ; preds = %if.then.peel.i2513, %if.then21.i2532
  %.ph3738 = phi ptr [ %add.ptr.i2526, %if.then21.i2532 ], [ %add.ptr.peel.i2509, %if.then.peel.i2513 ]
  %.ph3739 = phi ptr [ %add.ptr13.i2527, %if.then21.i2532 ], [ %add.ptr13.peel.i2510, %if.then.peel.i2513 ]
  store ptr %window.i2885, ptr %write, align 8
  br label %again.i2517.preheader

again.i2517.preheader:                            ; preds = %if.then.peel.i2513, %again.i2517.sink.split
  %.ph3803 = phi ptr [ %.ph3738, %again.i2517.sink.split ], [ %add.ptr.peel.i2509, %if.then.peel.i2513 ]
  %.ph3804 = phi ptr [ %.ph3739, %again.i2517.sink.split ], [ %add.ptr13.peel.i2510, %if.then.peel.i2513 ]
  %.ph3805 = phi ptr [ %window.i2885, %again.i2517.sink.split ], [ %169, %if.then.peel.i2513 ]
  br label %again.i2517

again.i2517:                                      ; preds = %again.i2517.preheader, %if.then.i2529
  %170 = phi ptr [ %add.ptr.i2526, %if.then.i2529 ], [ %.ph3803, %again.i2517.preheader ]
  %171 = phi ptr [ %add.ptr13.i2527, %if.then.i2529 ], [ %.ph3804, %again.i2517.preheader ]
  %172 = phi ptr [ %176, %if.then.i2529 ], [ %.ph3805, %again.i2517.preheader ]
  ...
  %174 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.i2526 = getelementptr inbounds i8, ptr %174, i64 %conv10.i2525
  store ptr %add.ptr.i2526, ptr %next_out.i2883, align 8
  %add.ptr13.i2527 = getelementptr inbounds i8, ptr %window.i2885, i64 %conv10.i2525
  %175 = load ptr, ptr %end14.i2884, align 8
  %cmp15.i2528 = icmp eq ptr %add.ptr13.i2527, %175
  br i1 %cmp15.i2528, label %if.then.i2529, label %inflate_flush.exit2535

if.then.i2529:                                    ; preds = %again.i2517
  %176 = load ptr, ptr %write, align 8
  %cmp19.i2530 = icmp eq ptr %176, %add.ptr13.i2527
  br i1 %cmp19.i2530, label %if.then21.i2532, label %again.i2517

if.then21.i2532:                                  ; preds = %if.then.i2529
  br label %again.i2517.sink.split

inflate_flush.exit2535:                           ; preds = %again.i2517, %cond.end.peel.i2500
  %add.ptr13.lcssa.i2512 = phi ptr [ %add.ptr13.peel.i2510, %cond.end.peel.i2500 ], [ %add.ptr13.i2527, %again.i2517 ]
  store ptr %add.ptr13.lcssa.i2512, ptr %read, align 8
  br label %cleanup1511
...
cond.true671:                                     ; preds = %if.end668
  ...
  %177 = load i32, ptr %arrayidx676, align 4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> %broadcast.splat, ptr %183, align 4
  %184 = getelementptr inbounds i32, ptr %183, i64 4
  store <4 x i32> %broadcast.splat, ptr %184, align 4
...
do.body.prol:                                     ; preds = %do.body.preheader, %do.body.prol
  ...
  store i32 %cond679, ptr %arrayidx684.prol, align 4
  %dec685.prol = add nsw i32 %j.1.prol, -1
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %do.body.prol.loopexit, label %do.body.prol

do.body.prol.loopexit:                            ; preds = %do.body.prol, %do.body.preheader
  %inc682.lcssa3863.unr = phi i32 [ undef, %do.body.preheader ], [ %inc682.prol, %do.body.prol ]
...
do.body:                                          ; preds = %do.body.prol.loopexit, %do.body
  ...
  store i32 %cond679, ptr %arrayidx684, align 4
  ...
  store i32 %cond679, ptr %arrayidx684.1, align 4
  ...
  store i32 %cond679, ptr %arrayidx684.2, align 4
  ...
  store i32 %cond679, ptr %arrayidx684.3, align 4
  %dec685.3 = add nsw i32 %j.1, -4
  %tobool686.not.3 = icmp eq i32 %dec685.3, 0
  br i1 %tobool686.not.3, label %do.end, label %do.body

do.end:                                           ; preds = %do.body.prol.loopexit, %do.body, %middle.block
  %inc682.lcssa = phi i32 [ %ind.end, %middle.block ], [ %inc682.lcssa3863.unr, %do.body.prol.loopexit ], [ %inc682.3, %do.body ]
  store i32 %inc682.lcssa, ptr %index, align 4
  br label %cleanup690
...
cleanup690:                                       ; preds = %if.then560, %do.end
  ...
  br i1 %cmp505, label %while.body507, label %while.end696
...
while.end696:                                     ; preds = %cleanup690, %sw.bb491
  ...
  store i32 9, ptr %bl, align 4
  store i32 6, ptr %bd, align 4
...
if.then745:                                       ; preds = %while.end696, %lor.lhs.false739, %if.end735
  store i32 17, ptr %blocks, align 8
  store i64 %_state.sroa.561588.8.lcssa, ptr %bitb, align 8
  store i32 %_state.sroa.130.8.lcssa, ptr %bitk, align 4
  store i32 %_state.sroa.265.9.lcssa, ptr %avail_in, align 8
  store ptr %_state.sroa.2191703.9.lcssa, ptr %z, align 8
  store ptr %_state.sroa.3231780.0, ptr %write, align 8
  %191 = load ptr, ptr %read, align 8
  %cmp.not.peel.i2542 = icmp ugt ptr %191, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2542, label %cond.false.peel.i2577, label %cond.end.peel.i2543

cond.false.peel.i2577:                            ; preds = %if.then745
  %192 = load ptr, ptr %end14.i2884, align 8
  br label %cond.end.peel.i2543

cond.end.peel.i2543:                              ; preds = %cond.false.peel.i2577, %if.then745
  %cond.peel.i2544 = phi ptr [ %192, %cond.false.peel.i2577 ], [ %_state.sroa.3231780.0, %if.then745 ]
  ...
  %193 = load i32, ptr %avail_out.i2882, align 8
  %conv..peel.i2549 = tail call i32 @llvm.umin.i32(i32 %193, i32 %conv.peel.i2548)
  %sub.peel.i2550 = sub i32 %193, %conv..peel.i2549
  store i32 %sub.peel.i2550, ptr %avail_out.i2882, align 8
  %194 = load ptr, ptr %next_out.i2883, align 8
  ...
  %195 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.peel.i2552 = getelementptr inbounds i8, ptr %195, i64 %conv10.peel.i2551
  store ptr %add.ptr.peel.i2552, ptr %next_out.i2883, align 8
  %add.ptr13.peel.i2553 = getelementptr inbounds i8, ptr %191, i64 %conv10.peel.i2551
  %196 = load ptr, ptr %end14.i2884, align 8
  %cmp15.peel.i2554 = icmp eq ptr %add.ptr13.peel.i2553, %196
  br i1 %cmp15.peel.i2554, label %if.then.peel.i2556, label %cleanup772

if.then.peel.i2556:                               ; preds = %cond.end.peel.i2543
  %197 = load ptr, ptr %write, align 8
  %cmp19.peel.i2557 = icmp eq ptr %197, %add.ptr13.peel.i2553
  br i1 %cmp19.peel.i2557, label %again.i2560.sink.split, label %again.i2560.preheader

again.i2560.sink.split:                           ; preds = %if.then.peel.i2556, %if.then21.i2575
  %.ph3740 = phi ptr [ %add.ptr.i2569, %if.then21.i2575 ], [ %add.ptr.peel.i2552, %if.then.peel.i2556 ]
  %.ph3741 = phi ptr [ %add.ptr13.i2570, %if.then21.i2575 ], [ %add.ptr13.peel.i2553, %if.then.peel.i2556 ]
  store ptr %window.i2885, ptr %write, align 8
  br label %again.i2560.preheader

again.i2560.preheader:                            ; preds = %if.then.peel.i2556, %again.i2560.sink.split
  %.ph3788 = phi ptr [ %.ph3740, %again.i2560.sink.split ], [ %add.ptr.peel.i2552, %if.then.peel.i2556 ]
  %.ph3789 = phi ptr [ %.ph3741, %again.i2560.sink.split ], [ %add.ptr13.peel.i2553, %if.then.peel.i2556 ]
  %.ph3790 = phi ptr [ %window.i2885, %again.i2560.sink.split ], [ %197, %if.then.peel.i2556 ]
  br label %again.i2560

again.i2560:                                      ; preds = %again.i2560.preheader, %if.then.i2572
  %198 = phi ptr [ %add.ptr.i2569, %if.then.i2572 ], [ %.ph3788, %again.i2560.preheader ]
  %199 = phi ptr [ %add.ptr13.i2570, %if.then.i2572 ], [ %.ph3789, %again.i2560.preheader ]
  %200 = phi ptr [ %204, %if.then.i2572 ], [ %.ph3790, %again.i2560.preheader ]
  ...
  %202 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.i2569 = getelementptr inbounds i8, ptr %202, i64 %conv10.i2568
  store ptr %add.ptr.i2569, ptr %next_out.i2883, align 8
  %add.ptr13.i2570 = getelementptr inbounds i8, ptr %window.i2885, i64 %conv10.i2568
  %203 = load ptr, ptr %end14.i2884, align 8
  %cmp15.i2571 = icmp eq ptr %add.ptr13.i2570, %203
  br i1 %cmp15.i2571, label %if.then.i2572, label %cleanup772

if.then.i2572:                                    ; preds = %again.i2560
  %204 = load ptr, ptr %write, align 8
  %cmp19.i2573 = icmp eq ptr %204, %add.ptr13.i2570
  br i1 %cmp19.i2573, label %if.then21.i2575, label %again.i2560

if.then21.i2575:                                  ; preds = %if.then.i2572
  br label %again.i2560.sink.split

cleanup772:                                       ; preds = %again.i2560, %cond.end.peel.i2543
  %add.ptr13.lcssa.i2555 = phi ptr [ %add.ptr13.peel.i2553, %cond.end.peel.i2543 ], [ %add.ptr13.i2570, %again.i2560 ]
  store ptr %add.ptr13.lcssa.i2555, ptr %read, align 8
...
cleanup.cont780:                                  ; preds = %lor.lhs.false739
  ...
  store i8 %conv758, ptr %lbits761, align 8
  %conv762 = trunc i32 %190 to i8
  store i8 %conv762, ptr %dbits952, align 1
  %205 = load ptr, ptr %tl, align 8
  store ptr %205, ptr %ltree768, align 8
  %206 = load ptr, ptr %td, align 8
  store ptr %206, ptr %dtree956, align 8
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %td) #5
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %tl) #5
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %bd) #5
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %bl) #5
...
sw.bb782:                                         ; preds = %for.cond.sw.bb782_crit_edge, %cleanup.cont780
  ...
  store i32 %conv784, ptr %need955, align 8
  store ptr %207, ptr %sub1416, align 8
  store i32 1, ptr %blocks, align 8
  br label %sw.bb789
...
if.then801:                                       ; preds = %while.body798
  ...
  store i64 %_state.sroa.561588.153230, ptr %bitb, align 8
  store i32 %211, ptr %bitk, align 4
  store i32 0, ptr %avail_in, align 8
  store ptr %scevgep3394.le, ptr %z, align 8
  store ptr %_state.sroa.3231780.0, ptr %write, align 8
  %213 = load ptr, ptr %read, align 8
  %cmp.not.peel.i2585 = icmp ugt ptr %213, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2585, label %cond.false.peel.i2620, label %cond.end.peel.i2586

cond.false.peel.i2620:                            ; preds = %if.then801
  %214 = load ptr, ptr %end14.i2884, align 8
  br label %cond.end.peel.i2586

cond.end.peel.i2586:                              ; preds = %cond.false.peel.i2620, %if.then801
  %cond.peel.i2587 = phi ptr [ %214, %cond.false.peel.i2620 ], [ %_state.sroa.3231780.0, %if.then801 ]
  ...
  %215 = load i32, ptr %avail_out.i2882, align 8
  %conv..peel.i2592 = tail call i32 @llvm.umin.i32(i32 %215, i32 %conv.peel.i2591)
  %sub.peel.i2593 = sub i32 %215, %conv..peel.i2592
  store i32 %sub.peel.i2593, ptr %avail_out.i2882, align 8
  %216 = load ptr, ptr %next_out.i2883, align 8
  ...
  %217 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.peel.i2595 = getelementptr inbounds i8, ptr %217, i64 %conv10.peel.i2594
  store ptr %add.ptr.peel.i2595, ptr %next_out.i2883, align 8
  %add.ptr13.peel.i2596 = getelementptr inbounds i8, ptr %213, i64 %conv10.peel.i2594
  %218 = load ptr, ptr %end14.i2884, align 8
  %cmp15.peel.i2597 = icmp eq ptr %add.ptr13.peel.i2596, %218
  br i1 %cmp15.peel.i2597, label %if.then.peel.i2599, label %inflate_flush.exit2621

if.then.peel.i2599:                               ; preds = %cond.end.peel.i2586
  %219 = load ptr, ptr %write, align 8
  %cmp19.peel.i2600 = icmp eq ptr %219, %add.ptr13.peel.i2596
  br i1 %cmp19.peel.i2600, label %again.i2603.sink.split, label %again.i2603.preheader

again.i2603.sink.split:                           ; preds = %if.then.peel.i2599, %if.then21.i2618
  %.ph3742 = phi ptr [ %add.ptr.i2612, %if.then21.i2618 ], [ %add.ptr.peel.i2595, %if.then.peel.i2599 ]
  %.ph3743 = phi ptr [ %add.ptr13.i2613, %if.then21.i2618 ], [ %add.ptr13.peel.i2596, %if.then.peel.i2599 ]
  store ptr %window.i2885, ptr %write, align 8
  br label %again.i2603.preheader

again.i2603.preheader:                            ; preds = %if.then.peel.i2599, %again.i2603.sink.split
  %.ph3793 = phi ptr [ %.ph3742, %again.i2603.sink.split ], [ %add.ptr.peel.i2595, %if.then.peel.i2599 ]
  %.ph3794 = phi ptr [ %.ph3743, %again.i2603.sink.split ], [ %add.ptr13.peel.i2596, %if.then.peel.i2599 ]
  %.ph3795 = phi ptr [ %window.i2885, %again.i2603.sink.split ], [ %219, %if.then.peel.i2599 ]
  br label %again.i2603

again.i2603:                                      ; preds = %again.i2603.preheader, %if.then.i2615
  %220 = phi ptr [ %add.ptr.i2612, %if.then.i2615 ], [ %.ph3793, %again.i2603.preheader ]
  %221 = phi ptr [ %add.ptr13.i2613, %if.then.i2615 ], [ %.ph3794, %again.i2603.preheader ]
  %222 = phi ptr [ %226, %if.then.i2615 ], [ %.ph3795, %again.i2603.preheader ]
  ...
  %224 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.i2612 = getelementptr inbounds i8, ptr %224, i64 %conv10.i2611
  store ptr %add.ptr.i2612, ptr %next_out.i2883, align 8
  %add.ptr13.i2613 = getelementptr inbounds i8, ptr %window.i2885, i64 %conv10.i2611
  %225 = load ptr, ptr %end14.i2884, align 8
  %cmp15.i2614 = icmp eq ptr %add.ptr13.i2613, %225
  br i1 %cmp15.i2614, label %if.then.i2615, label %inflate_flush.exit2621

if.then.i2615:                                    ; preds = %again.i2603
  %226 = load ptr, ptr %write, align 8
  %cmp19.i2616 = icmp eq ptr %226, %add.ptr13.i2613
  br i1 %cmp19.i2616, label %if.then21.i2618, label %again.i2603

if.then21.i2618:                                  ; preds = %if.then.i2615
  br label %again.i2603.sink.split

inflate_flush.exit2621:                           ; preds = %again.i2603, %cond.end.peel.i2586
  %add.ptr13.lcssa.i2598 = phi ptr [ %add.ptr13.peel.i2596, %cond.end.peel.i2586 ], [ %add.ptr13.i2613, %again.i2603 ]
  store ptr %add.ptr13.lcssa.i2598, ptr %read, align 8
  br label %cleanup1511
...
if.end812:                                        ; preds = %while.body798
  ...
  %227 = load i8, ptr %_state.sroa.2191703.163228, align 1
  ...
  br i1 %cmp796, label %while.body798, label %while.end825
...
while.end825:                                     ; preds = %if.end812, %sw.bb789
  ...
  %229 = load i16, ptr %arrayidx832, align 2
  ...
  %Bits840 = getelementptr inbounds %struct.anon.5, ptr %add.ptr836, i64 0, i32 1
  %230 = load i8, ptr %Bits840, align 1
  ...
  %231 = load i8, ptr %add.ptr836, align 2
...
if.then857:                                       ; preds = %while.end825
  ...
  %232 = load i16, ptr %base859, align 2
  %conv860 = zext i16 %232 to i32
  store i32 %conv860, ptr %sub1416, align 8
  store i32 6, ptr %blocks, align 8
  br label %for.cond.backedge
...
if.then867:                                       ; preds = %if.end863
  ...
  store i32 %and869, ptr %sub1416, align 8
  %base872 = getelementptr inbounds %struct.inflate_huft_s, ptr %228, i64 %and834, i32 1
  %233 = load i16, ptr %base872, align 2
  %conv873 = zext i16 %233 to i32
  store i32 %conv873, ptr %sub, align 8
  store i32 2, ptr %blocks, align 8
  br label %for.cond.backedge
...
if.then896:                                       ; preds = %if.end892
  store i32 7, ptr %blocks, align 8
  br label %for.cond.backedge

sw.bb899:                                         ; preds = %for.cond
  %235 = load i32, ptr %sub1416, align 8
...
if.then911:                                       ; preds = %while.body908
  ...
  store i64 %_state.sroa.561588.163150, ptr %bitb, align 8
  store i32 %237, ptr %bitk, align 4
  store i32 0, ptr %avail_in, align 8
  store ptr %scevgep3386.le, ptr %z, align 8
  store ptr %_state.sroa.3231780.0, ptr %write, align 8
  %239 = load ptr, ptr %read, align 8
  %cmp.not.peel.i2628 = icmp ugt ptr %239, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2628, label %cond.false.peel.i2663, label %cond.end.peel.i2629

cond.false.peel.i2663:                            ; preds = %if.then911
  %240 = load ptr, ptr %end14.i2884, align 8
  br label %cond.end.peel.i2629

cond.end.peel.i2629:                              ; preds = %cond.false.peel.i2663, %if.then911
  %cond.peel.i2630 = phi ptr [ %240, %cond.false.peel.i2663 ], [ %_state.sroa.3231780.0, %if.then911 ]
  ...
  %241 = load i32, ptr %avail_out.i2882, align 8
  %conv..peel.i2635 = tail call i32 @llvm.umin.i32(i32 %241, i32 %conv.peel.i2634)
  %sub.peel.i2636 = sub i32 %241, %conv..peel.i2635
  store i32 %sub.peel.i2636, ptr %avail_out.i2882, align 8
  %242 = load ptr, ptr %next_out.i2883, align 8
  ...
  %243 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.peel.i2638 = getelementptr inbounds i8, ptr %243, i64 %conv10.peel.i2637
  store ptr %add.ptr.peel.i2638, ptr %next_out.i2883, align 8
  %add.ptr13.peel.i2639 = getelementptr inbounds i8, ptr %239, i64 %conv10.peel.i2637
  %244 = load ptr, ptr %end14.i2884, align 8
  %cmp15.peel.i2640 = icmp eq ptr %add.ptr13.peel.i2639, %244
  br i1 %cmp15.peel.i2640, label %if.then.peel.i2642, label %inflate_flush.exit2664

if.then.peel.i2642:                               ; preds = %cond.end.peel.i2629
  %245 = load ptr, ptr %write, align 8
  %cmp19.peel.i2643 = icmp eq ptr %245, %add.ptr13.peel.i2639
  br i1 %cmp19.peel.i2643, label %again.i2646.sink.split, label %again.i2646.preheader

again.i2646.sink.split:                           ; preds = %if.then.peel.i2642, %if.then21.i2661
  %.ph3744 = phi ptr [ %add.ptr.i2655, %if.then21.i2661 ], [ %add.ptr.peel.i2638, %if.then.peel.i2642 ]
  %.ph3745 = phi ptr [ %add.ptr13.i2656, %if.then21.i2661 ], [ %add.ptr13.peel.i2639, %if.then.peel.i2642 ]
  store ptr %window.i2885, ptr %write, align 8
  br label %again.i2646.preheader

again.i2646.preheader:                            ; preds = %if.then.peel.i2642, %again.i2646.sink.split
  %.ph3808 = phi ptr [ %.ph3744, %again.i2646.sink.split ], [ %add.ptr.peel.i2638, %if.then.peel.i2642 ]
  %.ph3809 = phi ptr [ %.ph3745, %again.i2646.sink.split ], [ %add.ptr13.peel.i2639, %if.then.peel.i2642 ]
  %.ph3810 = phi ptr [ %window.i2885, %again.i2646.sink.split ], [ %245, %if.then.peel.i2642 ]
  br label %again.i2646

again.i2646:                                      ; preds = %again.i2646.preheader, %if.then.i2658
  %246 = phi ptr [ %add.ptr.i2655, %if.then.i2658 ], [ %.ph3808, %again.i2646.preheader ]
  %247 = phi ptr [ %add.ptr13.i2656, %if.then.i2658 ], [ %.ph3809, %again.i2646.preheader ]
  %248 = phi ptr [ %252, %if.then.i2658 ], [ %.ph3810, %again.i2646.preheader ]
  ...
  %250 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.i2655 = getelementptr inbounds i8, ptr %250, i64 %conv10.i2654
  store ptr %add.ptr.i2655, ptr %next_out.i2883, align 8
  %add.ptr13.i2656 = getelementptr inbounds i8, ptr %window.i2885, i64 %conv10.i2654
  %251 = load ptr, ptr %end14.i2884, align 8
  %cmp15.i2657 = icmp eq ptr %add.ptr13.i2656, %251
  br i1 %cmp15.i2657, label %if.then.i2658, label %inflate_flush.exit2664

if.then.i2658:                                    ; preds = %again.i2646
  %252 = load ptr, ptr %write, align 8
  %cmp19.i2659 = icmp eq ptr %252, %add.ptr13.i2656
  br i1 %cmp19.i2659, label %if.then21.i2661, label %again.i2646

if.then21.i2661:                                  ; preds = %if.then.i2658
  br label %again.i2646.sink.split

inflate_flush.exit2664:                           ; preds = %again.i2646, %cond.end.peel.i2629
  %add.ptr13.lcssa.i2641 = phi ptr [ %add.ptr13.peel.i2639, %cond.end.peel.i2629 ], [ %add.ptr13.i2656, %again.i2646 ]
  store ptr %add.ptr13.lcssa.i2641, ptr %read, align 8
  br label %cleanup1511
...
if.end922:                                        ; preds = %while.body908
  ...
  %253 = load i8, ptr %_state.sroa.2191703.173148, align 1
  ...
  br i1 %cmp906, label %while.body908, label %while.end935
...
while.end935:                                     ; preds = %if.end922, %sw.bb899
  ...
  %254 = load i16, ptr %arrayidx940, align 2
  %conv941 = zext i16 %254 to i32
  %and942 = and i32 %conv941, %conv937
  %255 = load i32, ptr %sub, align 8
  %add944 = add i32 %and942, %255
  store i32 %add944, ptr %sub, align 8
  %shr948 = lshr i64 %_state.sroa.561588.16.lcssa, %idxprom939
  %sub951 = sub i32 %_state.sroa.130.16.lcssa, %235
  %256 = load i8, ptr %dbits952, align 1
  %conv953 = zext i8 %256 to i32
  store i32 %conv953, ptr %need955, align 8
  %257 = load ptr, ptr %dtree956, align 8
  store ptr %257, ptr %sub1416, align 8
  store i32 3, ptr %blocks, align 8
  br label %sw.bb960
...
if.then972:                                       ; preds = %while.body969
  ...
  store i64 %_state.sroa.561588.183159, ptr %bitb, align 8
  store i32 %260, ptr %bitk, align 4
  store i32 0, ptr %avail_in, align 8
  store ptr %scevgep3387.le, ptr %z, align 8
  store ptr %_state.sroa.3231780.0, ptr %write, align 8
  %262 = load ptr, ptr %read, align 8
  %cmp.not.peel.i2671 = icmp ugt ptr %262, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2671, label %cond.false.peel.i2706, label %cond.end.peel.i2672

cond.false.peel.i2706:                            ; preds = %if.then972
  %263 = load ptr, ptr %end14.i2884, align 8
  br label %cond.end.peel.i2672

cond.end.peel.i2672:                              ; preds = %cond.false.peel.i2706, %if.then972
  %cond.peel.i2673 = phi ptr [ %263, %cond.false.peel.i2706 ], [ %_state.sroa.3231780.0, %if.then972 ]
  ...
  %264 = load i32, ptr %avail_out.i2882, align 8
  %conv..peel.i2678 = tail call i32 @llvm.umin.i32(i32 %264, i32 %conv.peel.i2677)
  %sub.peel.i2679 = sub i32 %264, %conv..peel.i2678
  store i32 %sub.peel.i2679, ptr %avail_out.i2882, align 8
  %265 = load ptr, ptr %next_out.i2883, align 8
  ...
  %266 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.peel.i2681 = getelementptr inbounds i8, ptr %266, i64 %conv10.peel.i2680
  store ptr %add.ptr.peel.i2681, ptr %next_out.i2883, align 8
  %add.ptr13.peel.i2682 = getelementptr inbounds i8, ptr %262, i64 %conv10.peel.i2680
  %267 = load ptr, ptr %end14.i2884, align 8
  %cmp15.peel.i2683 = icmp eq ptr %add.ptr13.peel.i2682, %267
  br i1 %cmp15.peel.i2683, label %if.then.peel.i2685, label %inflate_flush.exit2707

if.then.peel.i2685:                               ; preds = %cond.end.peel.i2672
  %268 = load ptr, ptr %write, align 8
  %cmp19.peel.i2686 = icmp eq ptr %268, %add.ptr13.peel.i2682
  br i1 %cmp19.peel.i2686, label %again.i2689.sink.split, label %again.i2689.preheader

again.i2689.sink.split:                           ; preds = %if.then.peel.i2685, %if.then21.i2704
  %.ph3746 = phi ptr [ %add.ptr.i2698, %if.then21.i2704 ], [ %add.ptr.peel.i2681, %if.then.peel.i2685 ]
  %.ph3747 = phi ptr [ %add.ptr13.i2699, %if.then21.i2704 ], [ %add.ptr13.peel.i2682, %if.then.peel.i2685 ]
  store ptr %window.i2885, ptr %write, align 8
  br label %again.i2689.preheader

again.i2689.preheader:                            ; preds = %if.then.peel.i2685, %again.i2689.sink.split
  %.ph3813 = phi ptr [ %.ph3746, %again.i2689.sink.split ], [ %add.ptr.peel.i2681, %if.then.peel.i2685 ]
  %.ph3814 = phi ptr [ %.ph3747, %again.i2689.sink.split ], [ %add.ptr13.peel.i2682, %if.then.peel.i2685 ]
  %.ph3815 = phi ptr [ %window.i2885, %again.i2689.sink.split ], [ %268, %if.then.peel.i2685 ]
  br label %again.i2689

again.i2689:                                      ; preds = %again.i2689.preheader, %if.then.i2701
  %269 = phi ptr [ %add.ptr.i2698, %if.then.i2701 ], [ %.ph3813, %again.i2689.preheader ]
  %270 = phi ptr [ %add.ptr13.i2699, %if.then.i2701 ], [ %.ph3814, %again.i2689.preheader ]
  %271 = phi ptr [ %275, %if.then.i2701 ], [ %.ph3815, %again.i2689.preheader ]
  ...
  %273 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.i2698 = getelementptr inbounds i8, ptr %273, i64 %conv10.i2697
  store ptr %add.ptr.i2698, ptr %next_out.i2883, align 8
  %add.ptr13.i2699 = getelementptr inbounds i8, ptr %window.i2885, i64 %conv10.i2697
  %274 = load ptr, ptr %end14.i2884, align 8
  %cmp15.i2700 = icmp eq ptr %add.ptr13.i2699, %274
  br i1 %cmp15.i2700, label %if.then.i2701, label %inflate_flush.exit2707

if.then.i2701:                                    ; preds = %again.i2689
  %275 = load ptr, ptr %write, align 8
  %cmp19.i2702 = icmp eq ptr %275, %add.ptr13.i2699
  br i1 %cmp19.i2702, label %if.then21.i2704, label %again.i2689

if.then21.i2704:                                  ; preds = %if.then.i2701
  br label %again.i2689.sink.split

inflate_flush.exit2707:                           ; preds = %again.i2689, %cond.end.peel.i2672
  %add.ptr13.lcssa.i2684 = phi ptr [ %add.ptr13.peel.i2682, %cond.end.peel.i2672 ], [ %add.ptr13.i2699, %again.i2689 ]
  store ptr %add.ptr13.lcssa.i2684, ptr %read, align 8
  br label %cleanup1511
...
if.end983:                                        ; preds = %while.body969
  ...
  %276 = load i8, ptr %_state.sroa.2191703.193157, align 1
  ...
  br i1 %cmp967, label %while.body969, label %while.end996
...
while.end996:                                     ; preds = %if.end983, %sw.bb960
  ...
  %Bits1011 = getelementptr inbounds %struct.anon.5, ptr %add.ptr1007, i64 0, i32 1
  %279 = load i8, ptr %Bits1011, align 1
  ...
  %280 = load i8, ptr %add.ptr1007, align 2
...
if.then1030:                                      ; preds = %while.end996
  ...
  store i32 %and1032, ptr %sub1416, align 8
  %base1036 = getelementptr inbounds %struct.inflate_huft_s, ptr %277, i64 %and1005, i32 1
  %281 = load i16, ptr %base1036, align 2
  %conv1037 = zext i16 %281 to i32
  store i32 %conv1037, ptr %dist1103, align 4
  store i32 4, ptr %blocks, align 8
  br label %for.cond.backedge
...
if.then1070:                                      ; preds = %while.body1067
  ...
  store i64 %_state.sroa.561588.193136, ptr %bitb, align 8
  store i32 %285, ptr %bitk, align 4
  store i32 0, ptr %avail_in, align 8
  store ptr %scevgep.le, ptr %z, align 8
  store ptr %_state.sroa.3231780.0, ptr %write, align 8
  %287 = load ptr, ptr %read, align 8
  %cmp.not.peel.i2714 = icmp ugt ptr %287, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2714, label %cond.false.peel.i2749, label %cond.end.peel.i2715

cond.false.peel.i2749:                            ; preds = %if.then1070
  %288 = load ptr, ptr %end14.i2884, align 8
  br label %cond.end.peel.i2715

cond.end.peel.i2715:                              ; preds = %cond.false.peel.i2749, %if.then1070
  %cond.peel.i2716 = phi ptr [ %288, %cond.false.peel.i2749 ], [ %_state.sroa.3231780.0, %if.then1070 ]
  ...
  %289 = load i32, ptr %avail_out.i2882, align 8
  %conv..peel.i2721 = tail call i32 @llvm.umin.i32(i32 %289, i32 %conv.peel.i2720)
  %sub.peel.i2722 = sub i32 %289, %conv..peel.i2721
  store i32 %sub.peel.i2722, ptr %avail_out.i2882, align 8
  %290 = load ptr, ptr %next_out.i2883, align 8
  ...
  %291 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.peel.i2724 = getelementptr inbounds i8, ptr %291, i64 %conv10.peel.i2723
  store ptr %add.ptr.peel.i2724, ptr %next_out.i2883, align 8
  %add.ptr13.peel.i2725 = getelementptr inbounds i8, ptr %287, i64 %conv10.peel.i2723
  %292 = load ptr, ptr %end14.i2884, align 8
  %cmp15.peel.i2726 = icmp eq ptr %add.ptr13.peel.i2725, %292
  br i1 %cmp15.peel.i2726, label %if.then.peel.i2728, label %inflate_flush.exit2750

if.then.peel.i2728:                               ; preds = %cond.end.peel.i2715
  %293 = load ptr, ptr %write, align 8
  %cmp19.peel.i2729 = icmp eq ptr %293, %add.ptr13.peel.i2725
  br i1 %cmp19.peel.i2729, label %again.i2732.sink.split, label %again.i2732.preheader

again.i2732.sink.split:                           ; preds = %if.then.peel.i2728, %if.then21.i2747
  %.ph3748 = phi ptr [ %add.ptr.i2741, %if.then21.i2747 ], [ %add.ptr.peel.i2724, %if.then.peel.i2728 ]
  %.ph3749 = phi ptr [ %add.ptr13.i2742, %if.then21.i2747 ], [ %add.ptr13.peel.i2725, %if.then.peel.i2728 ]
  store ptr %window.i2885, ptr %write, align 8
  br label %again.i2732.preheader

again.i2732.preheader:                            ; preds = %if.then.peel.i2728, %again.i2732.sink.split
  %.ph3818 = phi ptr [ %.ph3748, %again.i2732.sink.split ], [ %add.ptr.peel.i2724, %if.then.peel.i2728 ]
  %.ph3819 = phi ptr [ %.ph3749, %again.i2732.sink.split ], [ %add.ptr13.peel.i2725, %if.then.peel.i2728 ]
  %.ph3820 = phi ptr [ %window.i2885, %again.i2732.sink.split ], [ %293, %if.then.peel.i2728 ]
  br label %again.i2732

again.i2732:                                      ; preds = %again.i2732.preheader, %if.then.i2744
  %294 = phi ptr [ %add.ptr.i2741, %if.then.i2744 ], [ %.ph3818, %again.i2732.preheader ]
  %295 = phi ptr [ %add.ptr13.i2742, %if.then.i2744 ], [ %.ph3819, %again.i2732.preheader ]
  %296 = phi ptr [ %300, %if.then.i2744 ], [ %.ph3820, %again.i2732.preheader ]
  ...
  %298 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.i2741 = getelementptr inbounds i8, ptr %298, i64 %conv10.i2740
  store ptr %add.ptr.i2741, ptr %next_out.i2883, align 8
  %add.ptr13.i2742 = getelementptr inbounds i8, ptr %window.i2885, i64 %conv10.i2740
  %299 = load ptr, ptr %end14.i2884, align 8
  %cmp15.i2743 = icmp eq ptr %add.ptr13.i2742, %299
  br i1 %cmp15.i2743, label %if.then.i2744, label %inflate_flush.exit2750

if.then.i2744:                                    ; preds = %again.i2732
  %300 = load ptr, ptr %write, align 8
  %cmp19.i2745 = icmp eq ptr %300, %add.ptr13.i2742
  br i1 %cmp19.i2745, label %if.then21.i2747, label %again.i2732

if.then21.i2747:                                  ; preds = %if.then.i2744
  br label %again.i2732.sink.split

inflate_flush.exit2750:                           ; preds = %again.i2732, %cond.end.peel.i2715
  %add.ptr13.lcssa.i2727 = phi ptr [ %add.ptr13.peel.i2725, %cond.end.peel.i2715 ], [ %add.ptr13.i2742, %again.i2732 ]
  store ptr %add.ptr13.lcssa.i2727, ptr %read, align 8
  br label %cleanup1511
...
if.end1081:                                       ; preds = %while.body1067
  ...
  %301 = load i8, ptr %_state.sroa.2191703.203134, align 1
  ...
  br i1 %cmp1065, label %while.body1067, label %while.end1094
...
cond.true1125:                                    ; preds = %sw.bb1113
  %305 = load ptr, ptr %end14.i2884, align 8
...
cond.end1145:                                     ; preds = %sw.bb1113, %cond.true1125
  ...
  %.pr2946 = load i32, ptr %sub, align 8
...
if.then1155:                                      ; preds = %while.body1151
  %306 = load ptr, ptr %end14.i2884, align 8
  %cmp1158 = icmp ne ptr %_state.sroa.3231780.53141, %306
  %.pre3406 = load ptr, ptr %read, align 8
  %cmp1164.not = icmp eq ptr %.pre3406, %window.i2885
  %or.cond3582 = select i1 %cmp1158, i1 true, i1 %cmp1164.not
  br i1 %or.cond3582, label %if.then1195, label %if.end1191

if.end1191:                                       ; preds = %if.then1155
  %cmp1172 = icmp ult ptr %window.i2885, %.pre3406
  %sub.ptr.lhs.cast1177 = ptrtoint ptr %.pre3406 to i64
...
if.then1195:                                      ; preds = %if.then1155, %if.end1191
  ...
  store ptr %_state.sroa.3231780.62950, ptr %write, align 8
  %cmp.not.peel.i2757 = icmp ugt ptr %.pre3406, %_state.sroa.3231780.62950
  ...
  %sub.ptr.rhs.cast.peel.i2761 = ptrtoint ptr %.pre3406 to i64
  ...
  %307 = load i32, ptr %avail_out.i2882, align 8
  %conv..peel.i2764 = tail call i32 @llvm.umin.i32(i32 %307, i32 %conv.peel.i2763)
  %sub.peel.i2765 = sub i32 %307, %conv..peel.i2764
  store i32 %sub.peel.i2765, ptr %avail_out.i2882, align 8
  %308 = load ptr, ptr %next_out.i2883, align 8
  %conv10.peel.i2766 = zext i32 %conv..peel.i2764 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %308, ptr align 1 %.pre3406, i64 %conv10.peel.i2766, i1 false)
  %309 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.peel.i2767 = getelementptr inbounds i8, ptr %309, i64 %conv10.peel.i2766
  store ptr %add.ptr.peel.i2767, ptr %next_out.i2883, align 8
  %add.ptr13.peel.i2768 = getelementptr inbounds i8, ptr %.pre3406, i64 %conv10.peel.i2766
  %310 = load ptr, ptr %end14.i2884, align 8
  %cmp15.peel.i2769 = icmp eq ptr %add.ptr13.peel.i2768, %310
  br i1 %cmp15.peel.i2769, label %if.then.peel.i2771, label %inflate_flush.exit2793

if.then.peel.i2771:                               ; preds = %if.then1195
  %311 = load ptr, ptr %write, align 8
  %cmp19.peel.i2772 = icmp eq ptr %311, %add.ptr13.peel.i2768
  br i1 %cmp19.peel.i2772, label %again.i2775.sink.split, label %again.i2775.preheader

again.i2775.sink.split:                           ; preds = %if.then.peel.i2771, %if.then21.i2790
  %.ph3750 = phi ptr [ %add.ptr.i2784, %if.then21.i2790 ], [ %add.ptr.peel.i2767, %if.then.peel.i2771 ]
  %.ph3751 = phi ptr [ %add.ptr13.i2785, %if.then21.i2790 ], [ %add.ptr13.peel.i2768, %if.then.peel.i2771 ]
  store ptr %window.i2885, ptr %write, align 8
  br label %again.i2775.preheader

again.i2775.preheader:                            ; preds = %if.then.peel.i2771, %again.i2775.sink.split
  %.ph3828 = phi ptr [ %.ph3750, %again.i2775.sink.split ], [ %add.ptr.peel.i2767, %if.then.peel.i2771 ]
  %.ph3829 = phi ptr [ %.ph3751, %again.i2775.sink.split ], [ %add.ptr13.peel.i2768, %if.then.peel.i2771 ]
  %.ph3830 = phi ptr [ %window.i2885, %again.i2775.sink.split ], [ %311, %if.then.peel.i2771 ]
  br label %again.i2775

again.i2775:                                      ; preds = %again.i2775.preheader, %if.then.i2787
  %312 = phi ptr [ %add.ptr.i2784, %if.then.i2787 ], [ %.ph3828, %again.i2775.preheader ]
  %313 = phi ptr [ %add.ptr13.i2785, %if.then.i2787 ], [ %.ph3829, %again.i2775.preheader ]
  %314 = phi ptr [ %318, %if.then.i2787 ], [ %.ph3830, %again.i2775.preheader ]
  %cmp.not.i2776 = icmp ugt ptr %window.i2885, %314
  %spec.select.i2777 = select i1 %cmp.not.i2776, ptr %313, ptr %314
  ...
  %315 = load i32, ptr %avail_out.i2882, align 8
  %conv..i2781 = tail call i32 @llvm.umin.i32(i32 %315, i32 %conv.i2780)
  %sub.i2782 = sub i32 %315, %conv..i2781
  store i32 %sub.i2782, ptr %avail_out.i2882, align 8
  %conv10.i2783 = zext i32 %conv..i2781 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %312, ptr nonnull align 1 %window.i2885, i64 %conv10.i2783, i1 false)
  %316 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.i2784 = getelementptr inbounds i8, ptr %316, i64 %conv10.i2783
  store ptr %add.ptr.i2784, ptr %next_out.i2883, align 8
  %add.ptr13.i2785 = getelementptr inbounds i8, ptr %window.i2885, i64 %conv10.i2783
  %317 = load ptr, ptr %end14.i2884, align 8
  %cmp15.i2786 = icmp eq ptr %add.ptr13.i2785, %317
  br i1 %cmp15.i2786, label %if.then.i2787, label %inflate_flush.exit2793

if.then.i2787:                                    ; preds = %again.i2775
  %318 = load ptr, ptr %write, align 8
  %cmp19.i2788 = icmp eq ptr %318, %add.ptr13.i2785
  br i1 %cmp19.i2788, label %if.then21.i2790, label %again.i2775

if.then21.i2790:                                  ; preds = %if.then.i2787
  br label %again.i2775.sink.split

inflate_flush.exit2793:                           ; preds = %again.i2775, %if.then1195
  %319 = phi ptr [ %add.ptr.peel.i2767, %if.then1195 ], [ %add.ptr.i2784, %again.i2775 ]
  %320 = phi ptr [ %310, %if.then1195 ], [ %317, %again.i2775 ]
  %add.ptr13.lcssa.i2770 = phi ptr [ %add.ptr13.peel.i2768, %if.then1195 ], [ %add.ptr13.i2785, %again.i2775 ]
  store ptr %add.ptr13.lcssa.i2770, ptr %read, align 8
  %321 = load ptr, ptr %write, align 8
  %cmp1202 = icmp ult ptr %321, %add.ptr13.lcssa.i2770
  %sub.ptr.rhs.cast1208 = ptrtoint ptr %321 to i64
  %sub.ptr.lhs.cast1214 = ptrtoint ptr %320 to i64
  %sub.ptr.sub1216 = sub i64 %sub.ptr.lhs.cast1214, %sub.ptr.rhs.cast1208
  %.pre3417 = ptrtoint ptr %add.ptr13.lcssa.i2770 to i64
  %sub.ptr.lhs.cast1207 = ptrtoint ptr %add.ptr13.lcssa.i2770 to i64
  %322 = xor i64 %sub.ptr.rhs.cast1208, -1
  %sub1210 = add i64 %322, %sub.ptr.lhs.cast1207
  %.pre3418 = ptrtoint ptr %320 to i64
  %sub.ptr.lhs.cast1249.pre-phi = select i1 %cmp1202, i64 %.pre3418, i64 %sub.ptr.lhs.cast1214
  %sub.ptr.lhs.cast1242.pre-phi = select i1 %cmp1202, i64 %sub.ptr.lhs.cast1207, i64 %.pre3417
  %cond1218 = select i1 %cmp1202, i64 %sub1210, i64 %sub.ptr.sub1216
  %cmp1223 = icmp ne ptr %321, %320
  %cmp1229.not = icmp eq ptr %add.ptr13.lcssa.i2770, %window.i2885
  %or.cond2956 = or i1 %cmp1229.not, %cmp1223
  %cmp1237 = icmp ult ptr %window.i2885, %add.ptr13.lcssa.i2770
  ...
  %_state.sroa.3231780.7 = select i1 %or.cond2956, ptr %321, ptr %window.i2885
...
if.then1260:                                      ; preds = %inflate_flush.exit2793
  store i64 %_state.sroa.561588.20, ptr %bitb, align 8
  store i32 %_state.sroa.130.20, ptr %bitk, align 4
  store i32 %_state.sroa.265.21, ptr %avail_in, align 8
  store ptr %_state.sroa.2191703.21, ptr %z, align 8
  store ptr %_state.sroa.3231780.7, ptr %write, align 8
  %cmp.not.peel.i2800 = icmp ugt ptr %add.ptr13.lcssa.i2770, %_state.sroa.3231780.7
  %spec.select2957 = select i1 %cmp.not.peel.i2800, ptr %320, ptr %_state.sroa.3231780.7
  ...
  %323 = load i32, ptr %avail_out.i2882, align 8
  %conv..peel.i2807 = tail call i32 @llvm.umin.i32(i32 %323, i32 %conv.peel.i2806)
  %sub.peel.i2808 = sub i32 %323, %conv..peel.i2807
  store i32 %sub.peel.i2808, ptr %avail_out.i2882, align 8
  %conv10.peel.i2809 = zext i32 %conv..peel.i2807 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %319, ptr align 1 %add.ptr13.lcssa.i2770, i64 %conv10.peel.i2809, i1 false)
  %324 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.peel.i2810 = getelementptr inbounds i8, ptr %324, i64 %conv10.peel.i2809
  store ptr %add.ptr.peel.i2810, ptr %next_out.i2883, align 8
  %add.ptr13.peel.i2811 = getelementptr inbounds i8, ptr %add.ptr13.lcssa.i2770, i64 %conv10.peel.i2809
  %325 = load ptr, ptr %end14.i2884, align 8
  %cmp15.peel.i2812 = icmp eq ptr %add.ptr13.peel.i2811, %325
  br i1 %cmp15.peel.i2812, label %if.then.peel.i2814, label %inflate_flush.exit2836

if.then.peel.i2814:                               ; preds = %if.then1260
  %326 = load ptr, ptr %write, align 8
  %cmp19.peel.i2815 = icmp eq ptr %326, %add.ptr13.peel.i2811
  br i1 %cmp19.peel.i2815, label %again.i2818.sink.split, label %again.i2818.preheader

again.i2818.sink.split:                           ; preds = %if.then.peel.i2814, %if.then21.i2833
  %.ph3752 = phi ptr [ %add.ptr.i2827, %if.then21.i2833 ], [ %add.ptr.peel.i2810, %if.then.peel.i2814 ]
  %.ph3753 = phi ptr [ %add.ptr13.i2828, %if.then21.i2833 ], [ %add.ptr13.peel.i2811, %if.then.peel.i2814 ]
  store ptr %window.i2885, ptr %write, align 8
  br label %again.i2818.preheader

again.i2818.preheader:                            ; preds = %if.then.peel.i2814, %again.i2818.sink.split
  %.ph3823 = phi ptr [ %.ph3752, %again.i2818.sink.split ], [ %add.ptr.peel.i2810, %if.then.peel.i2814 ]
  %.ph3824 = phi ptr [ %.ph3753, %again.i2818.sink.split ], [ %add.ptr13.peel.i2811, %if.then.peel.i2814 ]
  %.ph3825 = phi ptr [ %window.i2885, %again.i2818.sink.split ], [ %326, %if.then.peel.i2814 ]
  br label %again.i2818

again.i2818:                                      ; preds = %again.i2818.preheader, %if.then.i2830
  %327 = phi ptr [ %add.ptr.i2827, %if.then.i2830 ], [ %.ph3823, %again.i2818.preheader ]
  %328 = phi ptr [ %add.ptr13.i2828, %if.then.i2830 ], [ %.ph3824, %again.i2818.preheader ]
  %329 = phi ptr [ %333, %if.then.i2830 ], [ %.ph3825, %again.i2818.preheader ]
  %cmp.not.i2819 = icmp ugt ptr %window.i2885, %329
  %spec.select.i2820 = select i1 %cmp.not.i2819, ptr %328, ptr %329
  ...
  %330 = load i32, ptr %avail_out.i2882, align 8
  %conv..i2824 = tail call i32 @llvm.umin.i32(i32 %330, i32 %conv.i2823)
  %sub.i2825 = sub i32 %330, %conv..i2824
  store i32 %sub.i2825, ptr %avail_out.i2882, align 8
  %conv10.i2826 = zext i32 %conv..i2824 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %327, ptr nonnull align 1 %window.i2885, i64 %conv10.i2826, i1 false)
  %331 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.i2827 = getelementptr inbounds i8, ptr %331, i64 %conv10.i2826
  store ptr %add.ptr.i2827, ptr %next_out.i2883, align 8
  %add.ptr13.i2828 = getelementptr inbounds i8, ptr %window.i2885, i64 %conv10.i2826
  %332 = load ptr, ptr %end14.i2884, align 8
  %cmp15.i2829 = icmp eq ptr %add.ptr13.i2828, %332
  br i1 %cmp15.i2829, label %if.then.i2830, label %inflate_flush.exit2836

if.then.i2830:                                    ; preds = %again.i2818
  %333 = load ptr, ptr %write, align 8
  %cmp19.i2831 = icmp eq ptr %333, %add.ptr13.i2828
  br i1 %cmp19.i2831, label %if.then21.i2833, label %again.i2818

if.then21.i2833:                                  ; preds = %if.then.i2830
  br label %again.i2818.sink.split

inflate_flush.exit2836:                           ; preds = %again.i2818, %if.then1260
  %add.ptr13.lcssa.i2813 = phi ptr [ %add.ptr13.peel.i2811, %if.then1260 ], [ %add.ptr13.i2828, %again.i2818 ]
  store ptr %add.ptr13.lcssa.i2813, ptr %read, align 8
  br label %cleanup1511
...
if.end1273:                                       ; preds = %if.end1191, %inflate_flush.exit2793, %while.body1151
  ...
  %334 = load i8, ptr %_state.sroa.4621885.03143, align 1
  %incdec.ptr1277 = getelementptr inbounds i8, ptr %_state.sroa.3231780.8, i64 1
  store i8 %334, ptr %_state.sroa.3231780.8, align 1
  %dec1279 = add i32 %_state.sroa.407.8, -1
  %335 = load ptr, ptr %end14.i2884, align 8
  %cmp1282 = icmp eq ptr %incdec.ptr1275, %335
  %spec.select2234 = select i1 %cmp1282, ptr %window.i2885, ptr %incdec.ptr1275
  %336 = load i32, ptr %sub, align 8
  %dec1290 = add i32 %336, -1
  store i32 %dec1290, ptr %sub, align 8
  %tobool1150.not = icmp eq i32 %dec1290, 0
  br i1 %tobool1150.not, label %while.end1291, label %while.body1151
...
if.then1297:                                      ; preds = %sw.bb1293
  %337 = load ptr, ptr %end14.i2884, align 8
  %cmp1300 = icmp ne ptr %_state.sroa.3231780.0, %337
  %.pre = load ptr, ptr %read, align 8
  %cmp1306.not = icmp eq ptr %.pre, %window.i2885
  %or.cond3583 = select i1 %cmp1300, i1 true, i1 %cmp1306.not
  br i1 %or.cond3583, label %if.then1337, label %if.end1333

if.end1333:                                       ; preds = %if.then1297
  %cmp1314 = icmp ult ptr %window.i2885, %.pre
  %sub.ptr.lhs.cast1319 = ptrtoint ptr %.pre to i64
...
if.then1337:                                      ; preds = %if.then1297, %if.end1333
  ...
  store ptr %_state.sroa.3231780.92954, ptr %write, align 8
  %cmp.not.peel.i2843 = icmp ugt ptr %.pre, %_state.sroa.3231780.92954
  %spec.select2958 = select i1 %cmp.not.peel.i2843, ptr %337, ptr %_state.sroa.3231780.92954
  %sub.ptr.lhs.cast.peel.i2846 = ptrtoint ptr %spec.select2958 to i64
  %sub.ptr.rhs.cast.peel.i2847 = ptrtoint ptr %.pre to i64
  ...
  %338 = load i32, ptr %avail_out.i2882, align 8
  %conv..peel.i2850 = tail call i32 @llvm.umin.i32(i32 %338, i32 %conv.peel.i2849)
  %sub.peel.i2851 = sub i32 %338, %conv..peel.i2850
  store i32 %sub.peel.i2851, ptr %avail_out.i2882, align 8
  %339 = load ptr, ptr %next_out.i2883, align 8
  %conv10.peel.i2852 = zext i32 %conv..peel.i2850 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %339, ptr align 1 %.pre, i64 %conv10.peel.i2852, i1 false)
  %340 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.peel.i2853 = getelementptr inbounds i8, ptr %340, i64 %conv10.peel.i2852
  store ptr %add.ptr.peel.i2853, ptr %next_out.i2883, align 8
  %add.ptr13.peel.i2854 = getelementptr inbounds i8, ptr %.pre, i64 %conv10.peel.i2852
  %341 = load ptr, ptr %end14.i2884, align 8
  %cmp15.peel.i2855 = icmp eq ptr %add.ptr13.peel.i2854, %341
  br i1 %cmp15.peel.i2855, label %if.then.peel.i2857, label %inflate_flush.exit2879

if.then.peel.i2857:                               ; preds = %if.then1337
  %342 = load ptr, ptr %write, align 8
  %cmp19.peel.i2858 = icmp eq ptr %342, %add.ptr13.peel.i2854
  br i1 %cmp19.peel.i2858, label %again.i2861.sink.split, label %again.i2861.preheader

again.i2861.sink.split:                           ; preds = %if.then.peel.i2857, %if.then21.i2876
  %.ph3754 = phi ptr [ %add.ptr.i2870, %if.then21.i2876 ], [ %add.ptr.peel.i2853, %if.then.peel.i2857 ]
  %.ph3755 = phi ptr [ %add.ptr13.i2871, %if.then21.i2876 ], [ %add.ptr13.peel.i2854, %if.then.peel.i2857 ]
  store ptr %window.i2885, ptr %write, align 8
  br label %again.i2861.preheader

again.i2861.preheader:                            ; preds = %if.then.peel.i2857, %again.i2861.sink.split
  %.ph3832 = phi ptr [ %.ph3754, %again.i2861.sink.split ], [ %add.ptr.peel.i2853, %if.then.peel.i2857 ]
  %.ph3833 = phi ptr [ %.ph3755, %again.i2861.sink.split ], [ %add.ptr13.peel.i2854, %if.then.peel.i2857 ]
  %.ph3834 = phi ptr [ %window.i2885, %again.i2861.sink.split ], [ %342, %if.then.peel.i2857 ]
  br label %again.i2861

again.i2861:                                      ; preds = %again.i2861.preheader, %if.then.i2873
  %343 = phi ptr [ %add.ptr.i2870, %if.then.i2873 ], [ %.ph3832, %again.i2861.preheader ]
  %344 = phi ptr [ %add.ptr13.i2871, %if.then.i2873 ], [ %.ph3833, %again.i2861.preheader ]
  %345 = phi ptr [ %349, %if.then.i2873 ], [ %.ph3834, %again.i2861.preheader ]
  %cmp.not.i2862 = icmp ugt ptr %window.i2885, %345
  %spec.select.i2863 = select i1 %cmp.not.i2862, ptr %344, ptr %345
  ...
  %346 = load i32, ptr %avail_out.i2882, align 8
  %conv..i2867 = tail call i32 @llvm.umin.i32(i32 %346, i32 %conv.i2866)
  %sub.i2868 = sub i32 %346, %conv..i2867
  store i32 %sub.i2868, ptr %avail_out.i2882, align 8
  %conv10.i2869 = zext i32 %conv..i2867 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %343, ptr nonnull align 1 %window.i2885, i64 %conv10.i2869, i1 false)
  %347 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.i2870 = getelementptr inbounds i8, ptr %347, i64 %conv10.i2869
  store ptr %add.ptr.i2870, ptr %next_out.i2883, align 8
  %add.ptr13.i2871 = getelementptr inbounds i8, ptr %window.i2885, i64 %conv10.i2869
  %348 = load ptr, ptr %end14.i2884, align 8
  %cmp15.i2872 = icmp eq ptr %add.ptr13.i2871, %348
  br i1 %cmp15.i2872, label %if.then.i2873, label %inflate_flush.exit2879

if.then.i2873:                                    ; preds = %again.i2861
  %349 = load ptr, ptr %write, align 8
  %cmp19.i2874 = icmp eq ptr %349, %add.ptr13.i2871
  br i1 %cmp19.i2874, label %if.then21.i2876, label %again.i2861

if.then21.i2876:                                  ; preds = %if.then.i2873
  br label %again.i2861.sink.split

inflate_flush.exit2879:                           ; preds = %again.i2861, %if.then1337
  %350 = phi ptr [ %341, %if.then1337 ], [ %348, %again.i2861 ]
  %add.ptr13.lcssa.i2856 = phi ptr [ %add.ptr13.peel.i2854, %if.then1337 ], [ %add.ptr13.i2871, %again.i2861 ]
  store ptr %add.ptr13.lcssa.i2856, ptr %read, align 8
  %351 = load ptr, ptr %write, align 8
  %cmp1344 = icmp ult ptr %351, %add.ptr13.lcssa.i2856
  %sub.ptr.rhs.cast1350 = ptrtoint ptr %351 to i64
  %sub.ptr.lhs.cast1356 = ptrtoint ptr %350 to i64
  %sub.ptr.sub1358 = sub i64 %sub.ptr.lhs.cast1356, %sub.ptr.rhs.cast1350
  %.pre3419 = ptrtoint ptr %add.ptr13.lcssa.i2856 to i64
  %sub.ptr.lhs.cast1349 = ptrtoint ptr %add.ptr13.lcssa.i2856 to i64
  %352 = xor i64 %sub.ptr.rhs.cast1350, -1
  %sub1352 = add i64 %352, %sub.ptr.lhs.cast1349
  %.pre3420 = ptrtoint ptr %350 to i64
  %sub.ptr.lhs.cast1391.pre-phi = select i1 %cmp1344, i64 %.pre3420, i64 %sub.ptr.lhs.cast1356
  %sub.ptr.lhs.cast1384.pre-phi = select i1 %cmp1344, i64 %sub.ptr.lhs.cast1349, i64 %.pre3419
  %cond1360 = select i1 %cmp1344, i64 %sub1352, i64 %sub.ptr.sub1358
  %cmp1365 = icmp ne ptr %351, %350
  %cmp1371.not = icmp eq ptr %add.ptr13.lcssa.i2856, %window.i2885
  %or.cond2959 = select i1 %cmp1365, i1 true, i1 %cmp1371.not
  %cmp1379 = icmp ult ptr %window.i2885, %add.ptr13.lcssa.i2856
  ...
  %_state.sroa.3231780.10 = select i1 %or.cond2959, ptr %351, ptr %window.i2885
...
if.then1402:                                      ; preds = %inflate_flush.exit2879
  ...
  store i32 %_state.sroa.265.0, ptr %avail_in, align 8
  store ptr %_state.sroa.2191703.0, ptr %z, align 8
  store ptr %_state.sroa.3231780.10, ptr %write, align 8
  tail call fastcc void @inflate_flush(ptr noundef nonnull %z)
  br label %cleanup1511
...
if.end1415:                                       ; preds = %if.end1333, %inflate_flush.exit2879, %sw.bb1293
  ...
  %353 = load i32, ptr %sub1416, align 8
  %conv1417 = trunc i32 %353 to i8
  %incdec.ptr1419 = getelementptr inbounds i8, ptr %_state.sroa.3231780.11, i64 1
  store i8 %conv1417, ptr %_state.sroa.3231780.11, align 1
...
sw.bb1435:                                        ; preds = %sw.bb1423, %if.then1427, %for.cond
  ...
  store ptr %_state.sroa.3231780.0, ptr %write, align 8
  %354 = load ptr, ptr %read, align 8
  %cmp.not.peel.i2886 = icmp ugt ptr %354, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2886, label %cond.false.peel.i2921, label %cond.end.peel.i2887

cond.false.peel.i2921:                            ; preds = %sw.bb1435
  %355 = load ptr, ptr %end14.i2884, align 8
  br label %cond.end.peel.i2887

cond.end.peel.i2887:                              ; preds = %cond.false.peel.i2921, %sw.bb1435
  %cond.peel.i2888 = phi ptr [ %355, %cond.false.peel.i2921 ], [ %_state.sroa.3231780.0, %sw.bb1435 ]
  %sub.ptr.lhs.cast.peel.i2889 = ptrtoint ptr %cond.peel.i2888 to i64
  %sub.ptr.rhs.cast.peel.i2890 = ptrtoint ptr %354 to i64
  ...
  %356 = load i32, ptr %avail_out.i2882, align 8
  %conv..peel.i2893 = tail call i32 @llvm.umin.i32(i32 %356, i32 %conv.peel.i2892)
  %sub.peel.i2894 = sub i32 %356, %conv..peel.i2893
  store i32 %sub.peel.i2894, ptr %avail_out.i2882, align 8
  %357 = load ptr, ptr %next_out.i2883, align 8
  %conv10.peel.i2895 = zext i32 %conv..peel.i2893 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %357, ptr align 1 %354, i64 %conv10.peel.i2895, i1 false)
  %358 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.peel.i2896 = getelementptr inbounds i8, ptr %358, i64 %conv10.peel.i2895
  store ptr %add.ptr.peel.i2896, ptr %next_out.i2883, align 8
  %add.ptr13.peel.i2897 = getelementptr inbounds i8, ptr %354, i64 %conv10.peel.i2895
  %359 = load ptr, ptr %end14.i2884, align 8
  %cmp15.peel.i2898 = icmp eq ptr %add.ptr13.peel.i2897, %359
  br i1 %cmp15.peel.i2898, label %if.then.peel.i2900, label %inflate_flush.exit2922

if.then.peel.i2900:                               ; preds = %cond.end.peel.i2887
  %360 = load ptr, ptr %write, align 8
  %cmp19.peel.i2901 = icmp eq ptr %360, %add.ptr13.peel.i2897
  br i1 %cmp19.peel.i2901, label %again.i2904.sink.split, label %again.i2904.preheader

again.i2904.sink.split:                           ; preds = %if.then.peel.i2900, %if.then21.i2919
  %.ph3756 = phi ptr [ %add.ptr.i2913, %if.then21.i2919 ], [ %add.ptr.peel.i2896, %if.then.peel.i2900 ]
  %.ph3757 = phi ptr [ %add.ptr13.i2914, %if.then21.i2919 ], [ %add.ptr13.peel.i2897, %if.then.peel.i2900 ]
  store ptr %window.i2885, ptr %write, align 8
  br label %again.i2904.preheader

again.i2904.preheader:                            ; preds = %if.then.peel.i2900, %again.i2904.sink.split
  %.ph3835 = phi ptr [ %.ph3756, %again.i2904.sink.split ], [ %add.ptr.peel.i2896, %if.then.peel.i2900 ]
  %.ph3836 = phi ptr [ %.ph3757, %again.i2904.sink.split ], [ %add.ptr13.peel.i2897, %if.then.peel.i2900 ]
  %.ph3837 = phi ptr [ %window.i2885, %again.i2904.sink.split ], [ %360, %if.then.peel.i2900 ]
  br label %again.i2904

again.i2904:                                      ; preds = %again.i2904.preheader, %if.then.i2916
  %361 = phi ptr [ %add.ptr.i2913, %if.then.i2916 ], [ %.ph3835, %again.i2904.preheader ]
  %362 = phi ptr [ %add.ptr13.i2914, %if.then.i2916 ], [ %.ph3836, %again.i2904.preheader ]
  %363 = phi ptr [ %367, %if.then.i2916 ], [ %.ph3837, %again.i2904.preheader ]
  %cmp.not.i2905 = icmp ugt ptr %window.i2885, %363
  %spec.select.i2906 = select i1 %cmp.not.i2905, ptr %362, ptr %363
  ...
  %364 = load i32, ptr %avail_out.i2882, align 8
  %conv..i2910 = tail call i32 @llvm.umin.i32(i32 %364, i32 %conv.i2909)
  %sub.i2911 = sub i32 %364, %conv..i2910
  store i32 %sub.i2911, ptr %avail_out.i2882, align 8
  %conv10.i2912 = zext i32 %conv..i2910 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %361, ptr nonnull align 1 %window.i2885, i64 %conv10.i2912, i1 false)
  %365 = load ptr, ptr %next_out.i2883, align 8
  %add.ptr.i2913 = getelementptr inbounds i8, ptr %365, i64 %conv10.i2912
  store ptr %add.ptr.i2913, ptr %next_out.i2883, align 8
  %add.ptr13.i2914 = getelementptr inbounds i8, ptr %window.i2885, i64 %conv10.i2912
  %366 = load ptr, ptr %end14.i2884, align 8
  %cmp15.i2915 = icmp eq ptr %add.ptr13.i2914, %366
  br i1 %cmp15.i2915, label %if.then.i2916, label %inflate_flush.exit2922

if.then.i2916:                                    ; preds = %again.i2904
  %367 = load ptr, ptr %write, align 8
  %cmp19.i2917 = icmp eq ptr %367, %add.ptr13.i2914
  br i1 %cmp19.i2917, label %if.then21.i2919, label %again.i2904

if.then21.i2919:                                  ; preds = %if.then.i2916
  br label %again.i2904.sink.split

inflate_flush.exit2922:                           ; preds = %again.i2904, %cond.end.peel.i2887
  %368 = phi ptr [ %359, %cond.end.peel.i2887 ], [ %366, %again.i2904 ]
  %add.ptr13.lcssa.i2899 = phi ptr [ %add.ptr13.peel.i2897, %cond.end.peel.i2887 ], [ %add.ptr13.i2914, %again.i2904 ]
  store ptr %add.ptr13.lcssa.i2899, ptr %read, align 8
  %369 = load ptr, ptr %write, align 8
  %cmp1463.not = icmp eq ptr %369, %add.ptr13.lcssa.i2899
  br i1 %cmp1463.not, label %if.end1476, label %if.then1465

if.then1465:                                      ; preds = %inflate_flush.exit2922
  store i64 %_state.sroa.561588.0, ptr %bitb, align 8
  store i32 %_state.sroa.130.21, ptr %bitk, align 4
  store i32 %_state.sroa.265.22, ptr %avail_in, align 8
  store ptr %_state.sroa.2191703.22, ptr %z, align 8
  tail call fastcc void @inflate_flush(ptr noundef nonnull %z)
  br label %cleanup1511

if.end1476:                                       ; preds = %inflate_flush.exit2922
  %sub.ptr.lhs.cast1454 = ptrtoint ptr %368 to i64
  %sub.ptr.rhs.cast1448 = ptrtoint ptr %369 to i64
  %sub.ptr.sub1456 = sub i64 %sub.ptr.lhs.cast1454, %sub.ptr.rhs.cast1448
  %conv1459 = trunc i64 %sub.ptr.sub1456 to i32
  %370 = load i32, ptr %last1482, align 8
  store i32 %370, ptr %blocks, align 8
  %cmp1485 = icmp eq i32 %370, 8
...
bad:                                              ; preds = %for.cond, %if.end1040, %if.end892, %while.end
  ...
  store i32 17, ptr %blocks, align 8
  store i64 %_state.sroa.561588.21, ptr %bitb, align 8
  store i32 %_state.sroa.130.22, ptr %bitk, align 4
  store i32 %_state.sroa.265.23, ptr %avail_in, align 8
  store ptr %_state.sroa.2191703.23, ptr %z, align 8
  store ptr %_state.sroa.3231780.0, ptr %write, align 8
  tail call fastcc void @inflate_flush(ptr noundef nonnull %z)
  br label %cleanup1511
...
cond.end.peel:                                    ; preds = %cond.false.peel, %entry
  ...
  store i32 %sub.peel, ptr %avail_out, align 8
  ...
  store ptr %add.ptr.peel, ptr %next_out, align 8
  %add.ptr13.peel = getelementptr inbounds i8, ptr %0, i64 %conv10.peel
  %6 = load ptr, ptr %end14, align 8
...
if.then21.peel:                                   ; preds = %if.then.peel
  store ptr %window, ptr %write, align 8
...
if.end25:                                         ; preds = %again, %cond.end.peel
  ...
  store ptr %add.ptr13.lcssa, ptr %read, align 8
  ret void
}
...
do.body:                                          ; preds = %do.body.prol.loopexit, %do.body
  ...
  %inc.1 = add i32 %7, 1
  store i32 %inc.1, ptr %arrayidx.1, align 4
  ...
  %inc.2 = add i32 %9, 1
  store i32 %inc.2, ptr %arrayidx.2, align 4
  %incdec.ptr1.3 = getelementptr inbounds i32, ptr %p.1, i64 4
  %10 = load i32, ptr %incdec.ptr1.2, align 4
  ...
  %inc.3 = add i32 %11, 1
  store i32 %inc.3, ptr %arrayidx.3, align 4
  %dec2.3 = add i32 %i.0, -4
  %tobool3.not.3 = icmp eq i32 %dec2.3, 0
  br i1 %tobool3.not.3, label %do.end, label %do.body
...
for.inc:                                          ; preds = %if.end
  ...
  %15 = load i32, ptr %arrayidx7.1, align 8
...
for.inc.1:                                        ; preds = %for.inc
  ...
  %16 = load i32, ptr %arrayidx7.2, align 4
...
for.inc.2:                                        ; preds = %for.inc.1
  ...
  %17 = load i32, ptr %arrayidx7.3, align 16
...
for.inc.3:                                        ; preds = %for.inc.2
  ...
  %18 = load i32, ptr %arrayidx7.4, align 4
...
for.inc.4:                                        ; preds = %for.inc.3
  ...
  %19 = load i32, ptr %arrayidx7.5, align 8
...
for.inc.6:                                        ; preds = %for.inc.5
  ...
  %21 = load i32, ptr %arrayidx7.7, align 16
...
for.inc.7:                                        ; preds = %for.inc.6
  ...
  %22 = load i32, ptr %arrayidx7.8, align 4
...
for.inc.8:                                        ; preds = %for.inc.7
  ...
  %23 = load i32, ptr %arrayidx7.9, align 8
...
for.inc.9:                                        ; preds = %for.inc.8
  ...
  %24 = load i32, ptr %arrayidx7.10, align 4
...
for.inc.10:                                       ; preds = %for.inc.9
  ...
  %25 = load i32, ptr %arrayidx7.11, align 16
...
for.inc.11:                                       ; preds = %for.inc.10
  ...
  %26 = load i32, ptr %arrayidx7.12, align 4
...
for.inc.12:                                       ; preds = %for.inc.11
  ...
  %27 = load i32, ptr %arrayidx7.13, align 8
...
for.inc.13:                                       ; preds = %for.inc.12
  ...
  %28 = load i32, ptr %arrayidx7.14, align 4
...
for.inc23:                                        ; preds = %for.end
  ...
  %30 = load i32, ptr %arrayidx19.1, align 8
...
for.inc23.1:                                      ; preds = %for.inc23
  ...
  %31 = load i32, ptr %arrayidx19.2, align 4
...
for.inc23.2:                                      ; preds = %for.inc23.1
  ...
  %32 = load i32, ptr %arrayidx19.3, align 16
...
for.inc23.3:                                      ; preds = %for.inc23.2
  ...
  %33 = load i32, ptr %arrayidx19.4, align 4
...
for.inc23.4:                                      ; preds = %for.inc23.3
  ...
  %34 = load i32, ptr %arrayidx19.5, align 8
...
for.inc23.5:                                      ; preds = %for.inc23.4
  ...
  %35 = load i32, ptr %arrayidx19.6, align 4
...
for.inc23.6:                                      ; preds = %for.inc23.5
  ...
  %36 = load i32, ptr %arrayidx19.7, align 16
...
for.inc23.7:                                      ; preds = %for.inc23.6
  ...
  %37 = load i32, ptr %arrayidx19.8, align 4
...
for.inc23.8:                                      ; preds = %for.inc23.7
  ...
  %38 = load i32, ptr %arrayidx19.9, align 8
...
for.inc23.9:                                      ; preds = %for.inc23.8
  ...
  %39 = load i32, ptr %arrayidx19.10, align 4
...
for.inc23.10:                                     ; preds = %for.inc23.9
  ...
  %40 = load i32, ptr %arrayidx19.11, align 16
...
for.inc23.11:                                     ; preds = %for.inc23.10
  ...
  %41 = load i32, ptr %arrayidx19.12, align 4
...
for.inc23.12:                                     ; preds = %for.inc23.11
  ...
  %42 = load i32, ptr %arrayidx19.13, align 8
...
for.end25:                                        ; preds = %for.inc23.13, %for.inc23.12, %for.inc23.11, %for.inc23.10, %for.inc23.9, %for.inc23.8, %for.inc23.7, %for.inc23.6, %for.inc23.5, %for.inc23.4, %for.inc23.3, %for.inc23.2, %for.inc23.1, %for.inc23, %for.end
  %cmp230 = phi i1 [ true, %for.end ], [ true, %for.inc23 ], [ true, %for.inc23.1 ], [ true, %for.inc23.2 ], [ true, %for.inc23.3 ], [ true, %for.inc23.4 ], [ true, %for.inc23.5 ], [ true, %for.inc23.6 ], [ true, %for.inc23.7 ], [ true, %for.inc23.8 ], [ true, %for.inc23.9 ], [ true, %for.inc23.10 ], [ true, %for.inc23.11 ], [ true, %for.inc23.12 ], [ %tobool8.not, %for.inc23.13 ]
  %i.1.lcssa = phi i32 [ 15, %for.end ], [ 14, %for.inc23 ], [ 13, %for.inc23.1 ], [ 12, %for.inc23.2 ], [ 11, %for.inc23.3 ], [ 10, %for.inc23.4 ], [ 9, %for.inc23.5 ], [ 8, %for.inc23.6 ], [ 7, %for.inc23.7 ], [ 6, %for.inc23.8 ], [ 5, %for.inc23.9 ], [ 4, %for.inc23.10 ], [ 3, %for.inc23.11 ], [ 2, %for.inc23.12 ], [ %spec.select513, %for.inc23.13 ]
  %spec.select377 = tail call i32 @llvm.umin.i32(i32 %spec.select, i32 %i.1.lcssa)
  store i32 %spec.select377, ptr %m, align 4
...
for.inc37:                                        ; preds = %for.body31
  ...
  br i1 %exitcond.not, label %for.end40, label %for.body31
...
if.end46:                                         ; preds = %for.end40
  store i32 %y.1.lcssa, ptr %arrayidx42, align 4
...
while.body56:                                     ; preds = %while.body56, %while.body56.preheader.new
  ...
  %49 = load i32, ptr %p.2, align 4
  %add58 = add i32 %49, %j.2405
  %incdec.ptr59 = getelementptr inbounds i32, ptr %xp.0407, i64 1
  store i32 %add58, ptr %xp.0407, align 4
  %p.2.1 = getelementptr inbounds i32, ptr %c.pn406, i64 2
  %50 = load i32, ptr %p.2.1, align 4
  %add58.1 = add i32 %50, %add58
  %incdec.ptr59.1 = getelementptr inbounds i32, ptr %xp.0407, i64 2
  store i32 %add58.1, ptr %incdec.ptr59, align 4
  %p.2.2 = getelementptr inbounds i32, ptr %c.pn406, i64 3
  %51 = load i32, ptr %p.2.2, align 4
  %add58.2 = add i32 %51, %add58.1
  %incdec.ptr59.2 = getelementptr inbounds i32, ptr %xp.0407, i64 3
  store i32 %add58.2, ptr %incdec.ptr59.1, align 4
  %p.2.3 = getelementptr inbounds i32, ptr %c.pn406, i64 4
  %52 = load i32, ptr %p.2.3, align 4
  %add58.3 = add i32 %52, %add58.2
  %incdec.ptr59.3 = getelementptr inbounds i32, ptr %xp.0407, i64 4
  store i32 %add58.3, ptr %incdec.ptr59.2, align 4
  %niter.next.3 = add i32 %niter, 4
  %niter.ncmp.3 = icmp eq i32 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %do.body61.preheader.loopexit.unr-lcssa, label %while.body56

do.body61:                                        ; preds = %do.body61.preheader, %do.cond71
  %i.3 = phi i32 [ %inc72, %do.cond71 ], [ 0, %do.body61.preheader ]
  %p.3 = phi ptr [ %incdec.ptr62, %do.cond71 ], [ %b, %do.body61.preheader ]
  %incdec.ptr62 = getelementptr inbounds i32, ptr %p.3, i64 1
  %53 = load i32, ptr %p.3, align 4
  %cmp63.not = icmp eq i32 %53, 0
  br i1 %cmp63.not, label %do.cond71, label %if.then64

if.then64:                                        ; preds = %do.body61
  %idxprom65 = zext i32 %53 to i64
  ...
  store i32 %i.3, ptr %arrayidx69, align 4
  br label %do.cond71

do.cond71:                                        ; preds = %do.body61, %if.then64
  %inc72 = add nuw i32 %i.3, 1
  %exitcond476.not = icmp eq i32 %inc72, %umax
  br i1 %exitcond476.not, label %do.end74, label %do.body61

do.end74:                                         ; preds = %do.cond71
...
for.body82.lr.ph:                                 ; preds = %do.end74
  ...
  %idx.ext153 = zext i32 %55 to i64
  %add.ptr154 = getelementptr inbounds i32, ptr @huft_build.v, i64 %idx.ext153
  %56 = zext i32 %j.0.lcssa to i64
  %57 = add nuw nsw i32 %i.1.lcssa, 1
  %wide.trip.count488 = zext i32 %57 to i64
  br label %for.body82

for.body82:                                       ; preds = %for.body82.lr.ph, %for.inc224
  %indvars.iv485 = phi i64 [ %56, %for.body82.lr.ph ], [ %indvars.iv.next486, %for.inc224 ]
  ...
  %59 = trunc i64 %indvars.iv485 to i32
  %60 = add i32 %59, -1
  %shl203 = shl nuw i32 1, %60
  %.pre490 = trunc i64 %indvars.iv485 to i32
  %61 = trunc i64 %indvars.iv485 to i32
  %tobool87.not526 = icmp eq i32 %58, 0
...
while.cond89.preheader:                           ; preds = %for.body82, %cleanup
  ...
  %a.0527 = phi i32 [ %dec86535, %cleanup ], [ %58, %for.body82 ]
  %dec86535 = add i32 %a.0527, -1
  %add90416 = add nsw i32 %w.1533, %spec.select377
  %62 = sext i32 %add90416 to i64
  %cmp91.not417 = icmp sgt i64 %indvars.iv485, %62
...
while.body92.preheader:                           ; preds = %while.cond89.preheader
  %63 = sub i32 %i.1.lcssa, %add90416
  %64 = sext i32 %h.1528 to i64
  br label %while.body92

while.body92:                                     ; preds = %while.body92.preheader, %if.end147
  %indvars.iv480 = phi i64 [ %64, %while.body92.preheader ], [ %indvars.iv.next481, %if.end147 ]
  %indvars.iv477 = phi i32 [ %63, %while.body92.preheader ], [ %indvars.iv.next478, %if.end147 ]
...
while.cond107:                                    ; preds = %land.rhs
  %sub114 = sub i32 %shl110, %65
  %inc108 = add nuw nsw i32 %inc108413, 1
  %cmp109 = icmp ult i32 %inc108, %cond
  br i1 %cmp109, label %land.rhs, label %if.end117
...
land.rhs:                                         ; preds = %land.rhs.preheader, %while.cond107
  ...
  %65 = load i32, ptr %incdec.ptr111, align 4
  %cmp112 = icmp ugt i32 %shl110, %65
...
if.end122:                                        ; preds = %if.end117
  ...
  store ptr %add.ptr124, ptr %arrayidx126, align 8
  store i32 %add119, ptr %hn, align 4
  %67 = trunc i64 %indvars.iv.next481 to i32
  %tobool128.not = icmp eq i32 %67, 0
...
if.then129:                                       ; preds = %if.end122
  ...
  store i32 %i.5529, ptr %arrayidx131, align 4
  ...
  %68 = load ptr, ptr %arrayidx136, align 8
  %sub.ptr.lhs.cast = ptrtoint ptr %add.ptr124 to i64
  %sub.ptr.rhs.cast = ptrtoint ptr %68 to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  %conv137 = zext i32 %shr to i64
  %69 = trunc i64 %sub.ptr.sub to i32
  %70 = lshr i32 %69, 2
  %conv139 = sub i32 %70, %shr
  %conv140 = trunc i32 %conv139 to i16
  %arrayidx146 = getelementptr inbounds %struct.inflate_huft_s, ptr %68, i64 %conv137
  store i8 %conv132, ptr %arrayidx146, align 2
  %r.sroa.8.0.arrayidx146.sroa_idx = getelementptr inbounds i8, ptr %arrayidx146, i64 1
  store i8 %conv, ptr %r.sroa.8.0.arrayidx146.sroa_idx, align 1
  %r.sroa.10.0.arrayidx146.sroa_idx = getelementptr inbounds i8, ptr %arrayidx146, i64 2
  store i16 %conv140, ptr %r.sroa.10.0.arrayidx146.sroa_idx, align 2
  br label %if.end147

if.else:                                          ; preds = %if.end122
  store ptr %add.ptr124, ptr %t, align 8
  br label %if.end147
...
if.end147:                                        ; preds = %if.else, %if.then129
  ...
  %71 = sext i32 %add90 to i64
  %cmp91.not = icmp sgt i64 %indvars.iv485, %71
  %indvars.iv.next478 = sub i32 %indvars.iv477, %spec.select377
  br i1 %cmp91.not, label %while.body92, label %while.end148
...
while.end148:                                     ; preds = %if.end147, %while.cond89.preheader.while.end148_crit_edge
  ...
  %h.2.lcssa = phi i32 [ %h.1528, %while.cond89.preheader.while.end148_crit_edge ], [ %67, %if.end147 ]
...
if.else173:                                       ; preds = %if.else160
  ...
  %73 = load i16, ptr %arrayidx176, align 2
  %conv177 = trunc i16 %73 to i8
  ...
  %74 = load i16, ptr %arrayidx186, align 2
  br label %if.end189
...
if.end189:                                        ; preds = %while.end148, %if.then163, %if.else173
  ...
  %r.sroa.10.4 = phi i16 [ %conv171, %if.then163 ], [ %74, %if.else173 ], [ %r.sroa.10.2.lcssa, %while.end148 ]
...
for.body196:                                      ; preds = %if.end189, %for.body196
  ...
  store i8 %r.sroa.0.0, ptr %arrayidx198, align 2
  %r.sroa.8.0.arrayidx198.sroa_idx = getelementptr inbounds i8, ptr %arrayidx198, i64 1
  store i8 %conv150, ptr %r.sroa.8.0.arrayidx198.sroa_idx, align 1
  %r.sroa.10.0.arrayidx198.sroa_idx = getelementptr inbounds i8, ptr %arrayidx198, i64 2
  store i16 %r.sroa.10.4, ptr %r.sroa.10.0.arrayidx198.sroa_idx, align 2
...
for.body206:                                      ; preds = %for.end201, %for.body206
  ...
  br i1 %tobool205.not, label %for.end209, label %for.body206
...
for.end209:                                       ; preds = %for.body206, %for.end201
  ...
  %75 = load i32, ptr %arrayidx216442, align 4
  %cmp217.not443 = icmp eq i32 %and214440, %75
...
while.body219:                                    ; preds = %for.end209, %while.body219
  ...
  %76 = load i32, ptr %arrayidx216, align 4
  %cmp217.not = icmp eq i32 %and214, %76
  br i1 %cmp217.not, label %cleanup.loopexit, label %while.body219

cleanup.loopexit:                                 ; preds = %while.body219
  %77 = trunc i64 %indvars.iv.next483 to i32
  br label %cleanup

cleanup:                                          ; preds = %cleanup.loopexit, %for.end209
  %h.4 = phi i32 [ %h.2.lcssa, %for.end209 ], [ %77, %cleanup.loopexit ]
  %w.4 = phi i32 [ %w.2.lcssa, %for.end209 ], [ %sub221, %cleanup.loopexit ]
  %tobool87.not = icmp eq i32 %dec86535, 0
  br i1 %tobool87.not, label %for.inc224, label %while.cond89.preheader
...
for.inc224:                                       ; preds = %cleanup, %for.body82
  ...
  br i1 %exitcond489.not, label %for.end226, label %for.body82

for.end226:                                       ; preds = %for.inc224, %do.end74
  %cmp227 = icmp ne i32 %y.1.lcssa, %45
  %78 = and i1 %cmp230, %cmp227
  %cond233 = select i1 %78, i32 -5, i32 0
  br label %cleanup234
