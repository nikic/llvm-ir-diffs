...
if.then.i2271:                                    ; preds = %again.i2259
  ...
  br i1 %cmp19.i2272, label %if.then21.i2274, label %again.i2259, !llvm.loop !26

if.then21.i2274:                                  ; preds = %if.then.i2271
  br label %again.i2259.sink.split, !llvm.loop !26
...
inflate_flush.exit2277:                           ; preds = %again.i2259, %cond.end.peel.i2242
  ...
  store ptr %add.ptr13.lcssa.i2254, ptr %read, align 8, !tbaa !17
  br label %cleanup1511
...
if.then.i2314:                                    ; preds = %again.i2302
  ...
  br i1 %cmp19.i2315, label %if.then21.i2317, label %again.i2302, !llvm.loop !26

if.then21.i2317:                                  ; preds = %if.then.i2314
  br label %again.i2302.sink.split, !llvm.loop !26
...
inflate_flush.exit2320:                           ; preds = %again.i2302, %cond.end.peel.i2285
  ...
  store ptr %add.ptr13.lcssa.i2297, ptr %read, align 8, !tbaa !17
  br label %cleanup1511
...
if.then.i2357:                                    ; preds = %again.i2345
  ...
  br i1 %cmp19.i2358, label %if.then21.i2360, label %again.i2345, !llvm.loop !26

if.then21.i2360:                                  ; preds = %if.then.i2357
  br label %again.i2345.sink.split, !llvm.loop !26
...
inflate_flush.exit2363:                           ; preds = %again.i2345, %cond.end.peel.i2328
  ...
  store ptr %add.ptr13.lcssa.i2340, ptr %read, align 8, !tbaa !17
  br label %cleanup1511
...
if.then.i2400:                                    ; preds = %again.i2388
  ...
  br i1 %cmp19.i2401, label %if.then21.i2403, label %again.i2388, !llvm.loop !26

if.then21.i2403:                                  ; preds = %if.then.i2400
  br label %again.i2388.sink.split, !llvm.loop !26
...
inflate_flush.exit2406:                           ; preds = %again.i2388, %cond.end.peel.i2371
  ...
  store ptr %add.ptr13.lcssa.i2383, ptr %read, align 8, !tbaa !17
  br label %cleanup1511
...
if.then.i2443:                                    ; preds = %again.i2431
  ...
  br i1 %cmp19.i2444, label %if.then21.i2446, label %again.i2431, !llvm.loop !26

if.then21.i2446:                                  ; preds = %if.then.i2443
  br label %again.i2431.sink.split, !llvm.loop !26
...
inflate_flush.exit2449:                           ; preds = %again.i2431, %cond.end.peel.i2414
  ...
  store ptr %add.ptr13.lcssa.i2426, ptr %read, align 8, !tbaa !17
  br label %cleanup1511
...
if.then.i2486:                                    ; preds = %again.i2474
  ...
  br i1 %cmp19.i2487, label %if.then21.i2489, label %again.i2474, !llvm.loop !26

if.then21.i2489:                                  ; preds = %if.then.i2486
  br label %again.i2474.sink.split, !llvm.loop !26
...
inflate_flush.exit2492:                           ; preds = %again.i2474, %cond.end.peel.i2457
  ...
  store ptr %add.ptr13.lcssa.i2469, ptr %read, align 8, !tbaa !17
  br label %cleanup1511
...
if.then.i2529:                                    ; preds = %again.i2517
  ...
  br i1 %cmp19.i2530, label %if.then21.i2532, label %again.i2517, !llvm.loop !26

if.then21.i2532:                                  ; preds = %if.then.i2529
  br label %again.i2517.sink.split, !llvm.loop !26
...
inflate_flush.exit2535:                           ; preds = %again.i2517, %cond.end.peel.i2500
  ...
  store ptr %add.ptr13.lcssa.i2512, ptr %read, align 8, !tbaa !17
  br label %cleanup1511
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> %broadcast.splat, ptr %184, align 4, !tbaa !20
...
if.then.i2572:                                    ; preds = %again.i2560
  ...
  br i1 %cmp19.i2573, label %if.then21.i2575, label %again.i2560, !llvm.loop !26

if.then21.i2575:                                  ; preds = %if.then.i2572
  br label %again.i2560.sink.split, !llvm.loop !26
...
cleanup772:                                       ; preds = %again.i2560, %cond.end.peel.i2543
  ...
  store ptr %add.ptr13.lcssa.i2555, ptr %read, align 8, !tbaa !17
...
if.then.i2615:                                    ; preds = %again.i2603
  ...
  br i1 %cmp19.i2616, label %if.then21.i2618, label %again.i2603, !llvm.loop !26

if.then21.i2618:                                  ; preds = %if.then.i2615
  br label %again.i2603.sink.split, !llvm.loop !26
...
inflate_flush.exit2621:                           ; preds = %again.i2603, %cond.end.peel.i2586
  ...
  store ptr %add.ptr13.lcssa.i2598, ptr %read, align 8, !tbaa !17
  br label %cleanup1511
...
if.then.i2658:                                    ; preds = %again.i2646
  ...
  br i1 %cmp19.i2659, label %if.then21.i2661, label %again.i2646, !llvm.loop !26

if.then21.i2661:                                  ; preds = %if.then.i2658
  br label %again.i2646.sink.split, !llvm.loop !26
...
inflate_flush.exit2664:                           ; preds = %again.i2646, %cond.end.peel.i2629
  ...
  store ptr %add.ptr13.lcssa.i2641, ptr %read, align 8, !tbaa !17
  br label %cleanup1511
...
if.then.i2701:                                    ; preds = %again.i2689
  ...
  br i1 %cmp19.i2702, label %if.then21.i2704, label %again.i2689, !llvm.loop !26

if.then21.i2704:                                  ; preds = %if.then.i2701
  br label %again.i2689.sink.split, !llvm.loop !26
...
inflate_flush.exit2707:                           ; preds = %again.i2689, %cond.end.peel.i2672
  ...
  store ptr %add.ptr13.lcssa.i2684, ptr %read, align 8, !tbaa !17
  br label %cleanup1511
...
if.then.i2744:                                    ; preds = %again.i2732
  ...
  br i1 %cmp19.i2745, label %if.then21.i2747, label %again.i2732, !llvm.loop !26

if.then21.i2747:                                  ; preds = %if.then.i2744
  br label %again.i2732.sink.split, !llvm.loop !26
...
inflate_flush.exit2750:                           ; preds = %again.i2732, %cond.end.peel.i2715
  ...
  store ptr %add.ptr13.lcssa.i2727, ptr %read, align 8, !tbaa !17
  br label %cleanup1511
...
if.then1155:                                      ; preds = %while.body1151
  ...
  %.pre3406 = load ptr, ptr %read, align 8, !tbaa !17
...
if.then1195:                                      ; preds = %if.then1155, %if.end1191
  ...
  %307 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  ...
  %308 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  ...
  %309 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  ...
  %310 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
...
if.then.peel.i2771:                               ; preds = %if.then1195
  %311 = load ptr, ptr %write, align 8, !tbaa !16
...
again.i2775:                                      ; preds = %again.i2775.preheader, %if.then.i2787
  ...
  %315 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  ...
  %316 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  ...
  %317 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
...
if.then.i2787:                                    ; preds = %again.i2775
  %318 = load ptr, ptr %write, align 8, !tbaa !16
  %cmp19.i2788 = icmp eq ptr %318, %add.ptr13.i2785
  br i1 %cmp19.i2788, label %if.then21.i2790, label %again.i2775, !llvm.loop !26

if.then21.i2790:                                  ; preds = %if.then.i2787
  br label %again.i2775.sink.split, !llvm.loop !26
...
inflate_flush.exit2793:                           ; preds = %again.i2775, %if.then1195
  ...
  store ptr %add.ptr13.lcssa.i2770, ptr %read, align 8, !tbaa !17
...
if.then1260:                                      ; preds = %inflate_flush.exit2793
  ...
  %323 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  ...
  %324 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  ...
  %325 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
...
if.then.peel.i2814:                               ; preds = %if.then1260
  %326 = load ptr, ptr %write, align 8, !tbaa !16
...
again.i2818:                                      ; preds = %again.i2818.preheader, %if.then.i2830
  ...
  %330 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  ...
  %331 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  ...
  %332 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
...
if.then.i2830:                                    ; preds = %again.i2818
  %333 = load ptr, ptr %write, align 8, !tbaa !16
  %cmp19.i2831 = icmp eq ptr %333, %add.ptr13.i2828
  br i1 %cmp19.i2831, label %if.then21.i2833, label %again.i2818, !llvm.loop !26

if.then21.i2833:                                  ; preds = %if.then.i2830
  br label %again.i2818.sink.split, !llvm.loop !26
...
inflate_flush.exit2836:                           ; preds = %again.i2818, %if.then1260
  ...
  store ptr %add.ptr13.lcssa.i2813, ptr %read, align 8, !tbaa !17
  br label %cleanup1511
...
if.end1273:                                       ; preds = %if.end1191, %inflate_flush.exit2793, %while.body1151
  ...
  %334 = load i8, ptr %_state.sroa.4621885.03143, align 1, !tbaa !20
  %incdec.ptr1277 = getelementptr inbounds i8, ptr %_state.sroa.3231780.8, i64 1
  store i8 %334, ptr %_state.sroa.3231780.8, align 1, !tbaa !20
  ...
  %336 = load i32, ptr %sub, align 8, !tbaa !51
...
if.then1297:                                      ; preds = %sw.bb1293
  ...
  %.pre = load ptr, ptr %read, align 8, !tbaa !17
...
if.then1337:                                      ; preds = %if.then1297, %if.end1333
  ...
  %338 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  ...
  %339 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  ...
  %340 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
...
if.then.peel.i2857:                               ; preds = %if.then1337
  %342 = load ptr, ptr %write, align 8, !tbaa !16
...
again.i2861:                                      ; preds = %again.i2861.preheader, %if.then.i2873
  ...
  %346 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  ...
  %347 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  ...
  %348 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
...
if.then.i2873:                                    ; preds = %again.i2861
  %349 = load ptr, ptr %write, align 8, !tbaa !16
  %cmp19.i2874 = icmp eq ptr %349, %add.ptr13.i2871
  br i1 %cmp19.i2874, label %if.then21.i2876, label %again.i2861, !llvm.loop !26

if.then21.i2876:                                  ; preds = %if.then.i2873
  br label %again.i2861.sink.split, !llvm.loop !26
...
inflate_flush.exit2879:                           ; preds = %again.i2861, %if.then1337
  ...
  store ptr %add.ptr13.lcssa.i2856, ptr %read, align 8, !tbaa !17
  %351 = load ptr, ptr %write, align 8, !tbaa !16
...
if.end1415:                                       ; preds = %if.end1333, %inflate_flush.exit2879, %sw.bb1293
  ...
  %353 = load i32, ptr %sub1416, align 8, !tbaa !20
...
sw.bb1435:                                        ; preds = %sw.bb1423, %if.then1427, %for.cond
  ...
  store ptr %_state.sroa.3231780.0, ptr %write, align 8, !tbaa !16
  %354 = load ptr, ptr %read, align 8, !tbaa !17
...
cond.false.peel.i2921:                            ; preds = %sw.bb1435
  %355 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
...
cond.end.peel.i2887:                              ; preds = %cond.false.peel.i2921, %sw.bb1435
  ...
  %356 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  ...
  %357 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  ...
  %358 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
...
if.then.peel.i2900:                               ; preds = %cond.end.peel.i2887
  %360 = load ptr, ptr %write, align 8, !tbaa !16
...
again.i2904:                                      ; preds = %again.i2904.preheader, %if.then.i2916
  ...
  %364 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  ...
  %365 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  ...
  %366 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
...
if.then.i2916:                                    ; preds = %again.i2904
  %367 = load ptr, ptr %write, align 8, !tbaa !16
  %cmp19.i2917 = icmp eq ptr %367, %add.ptr13.i2914
  br i1 %cmp19.i2917, label %if.then21.i2919, label %again.i2904, !llvm.loop !26

if.then21.i2919:                                  ; preds = %if.then.i2916
  br label %again.i2904.sink.split, !llvm.loop !26
...
inflate_flush.exit2922:                           ; preds = %again.i2904, %cond.end.peel.i2887
  ...
  store ptr %add.ptr13.lcssa.i2899, ptr %read, align 8, !tbaa !17
  %369 = load ptr, ptr %write, align 8, !tbaa !16
...
if.end1476:                                       ; preds = %inflate_flush.exit2922
  ...
  %370 = load i32, ptr %last1482, align 8, !tbaa !28
  store i32 %370, ptr %blocks, align 8, !tbaa !19
