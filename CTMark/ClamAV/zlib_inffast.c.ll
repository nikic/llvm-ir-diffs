; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/zlib_inffast.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/zlib_inffast.c"
...
if.then35:                                        ; preds = %if.then280, %if.end
  ...
  store i8 %conv36, ptr %out.0, align 1
  br label %do.cond299
...
if.end54:                                         ; preds = %if.then47, %if.then44
  ...
  %notmask573 = shl nsw i32 -1, %and42
  %sub57 = xor i32 %notmask573, -1
...
if.then66:                                        ; preds = %if.end63
  ...
  %35 = load i8, ptr %incdec.ptr67, align 1
...
if.then107:                                       ; preds = %if.then98
  ...
  %37 = load i8, ptr %incdec.ptr99, align 1
...
if.then138:                                       ; preds = %if.end135
  ...
  %cmp142 = icmp ult i32 %sub128, %len.0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %next.gep722, align 1
  %47 = getelementptr i8, ptr %next.gep722, i64 16
  %wide.load724 = load <16 x i8>, ptr %47, align 1
  store <16 x i8> %wide.load, ptr %next.gep, align 1
  %48 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load724, ptr %48, align 1
...
do.body146.prol:                                  ; preds = %do.body146.preheader801, %do.body146.prol
  ...
  %51 = load i8, ptr %from.0.prol, align 1
  %incdec.ptr148.prol = getelementptr inbounds i8, ptr %out.1.prol, i64 1
  store i8 %51, ptr %out.1.prol, align 1
  ...
  br i1 %prol.iter845.cmp.not, label %do.body146.prol.loopexit, label %do.body146.prol
...
if.then157:                                       ; preds = %if.else154
  ...
  %cmp163 = icmp ult i32 %sub162, %len.0
...
vector.ph755:                                     ; preds = %vector.memcheck750
  %n.vec757 = and i64 %66, 8589934560
...
vector.body767:                                   ; preds = %vector.body767, %vector.ph755
  ...
  %wide.load773 = load <16 x i8>, ptr %next.gep771, align 1
  %69 = getelementptr i8, ptr %next.gep771, i64 16
  %wide.load774 = load <16 x i8>, ptr %69, align 1
  store <16 x i8> %wide.load773, ptr %next.gep769, align 1
  %70 = getelementptr i8, ptr %next.gep769, i64 16
  store <16 x i8> %wide.load774, ptr %70, align 1
  %index.next775 = add nuw i64 %index768, 32
  %71 = icmp eq i64 %index.next775, %n.vec757
  br i1 %71, label %middle.block752, label %vector.body767
...
do.body167.prol:                                  ; preds = %do.body167.preheader803, %do.body167.prol
  ...
  %73 = load i8, ptr %from.1.prol, align 1
  %incdec.ptr169.prol = getelementptr i8, ptr %out.2.prol, i64 1
  store i8 %73, ptr %out.2.prol, align 1
  ...
  br i1 %prol.iter839.cmp.not, label %do.body167.prol.loopexit, label %do.body167.prol
...
do.body167:                                       ; preds = %do.body167.prol.loopexit, %do.body167
  ...
  %75 = load i8, ptr %from.1, align 1
  %incdec.ptr169 = getelementptr i8, ptr %out.2, i64 1
  store i8 %75, ptr %out.2, align 1
  %incdec.ptr168.1 = getelementptr inbounds i8, ptr %from.1, i64 2
  %76 = load i8, ptr %incdec.ptr168, align 1
  %incdec.ptr169.1 = getelementptr i8, ptr %out.2, i64 2
  store i8 %76, ptr %incdec.ptr169, align 1
  %incdec.ptr168.2 = getelementptr inbounds i8, ptr %from.1, i64 3
  %77 = load i8, ptr %incdec.ptr168.1, align 1
  %incdec.ptr169.2 = getelementptr i8, ptr %out.2, i64 3
  store i8 %77, ptr %incdec.ptr169.1, align 1
  %incdec.ptr168.3 = getelementptr inbounds i8, ptr %from.1, i64 4
  %78 = load i8, ptr %incdec.ptr168.2, align 1
  %incdec.ptr169.3 = getelementptr i8, ptr %out.2, i64 4
  store i8 %78, ptr %incdec.ptr169.2, align 1
  %dec171.3 = add i32 %op.1, -4
  %tobool172.not.3 = icmp eq i32 %dec171.3, 0
  %indvar.next.3 = add i64 %indvar, 4
  br i1 %tobool172.not.3, label %do.end173.loopexit.unr-lcssa, label %do.body167
...
vector.body741:                                   ; preds = %vector.body741, %vector.ph730
  ...
  %wide.load747 = load <16 x i8>, ptr %next.gep745, align 1
  %82 = getelementptr i8, ptr %next.gep745, i64 16
  %wide.load748 = load <16 x i8>, ptr %82, align 1
  store <16 x i8> %wide.load747, ptr %next.gep743, align 1
  %83 = getelementptr i8, ptr %next.gep743, i64 16
  store <16 x i8> %wide.load748, ptr %83, align 1
  %index.next749 = add nuw i64 %index742, 32
  %84 = icmp eq i64 %index.next749, %n.vec732
  br i1 %84, label %middle.block727, label %vector.body741
...
do.body178.prol:                                  ; preds = %do.body178.preheader802, %do.body178.prol
  ...
  %86 = load i8, ptr %from.2.prol, align 1
  %incdec.ptr180.prol = getelementptr inbounds i8, ptr %out.3.prol, i64 1
  store i8 %86, ptr %out.3.prol, align 1
  ...
  br i1 %prol.iter842.cmp.not, label %do.body178.prol.loopexit, label %do.body178.prol
...
if.else190:                                       ; preds = %if.else154
  ...
  %cmp194 = icmp ult i32 %sub128, %len.0
...
vector.ph781:                                     ; preds = %vector.memcheck776
  %n.vec783 = and i64 %101, 8589934560
...
vector.body792:                                   ; preds = %vector.body792, %vector.ph781
  ...
  %wide.load798 = load <16 x i8>, ptr %next.gep796, align 1
  %104 = getelementptr i8, ptr %next.gep796, i64 16
  %wide.load799 = load <16 x i8>, ptr %104, align 1
  store <16 x i8> %wide.load798, ptr %next.gep794, align 1
  %105 = getelementptr i8, ptr %next.gep794, i64 16
  store <16 x i8> %wide.load799, ptr %105, align 1
  %index.next800 = add nuw i64 %index793, 32
  %106 = icmp eq i64 %index.next800, %n.vec783
  br i1 %106, label %middle.block778, label %vector.body792
...
do.body198.prol:                                  ; preds = %do.body198.preheader804, %do.body198.prol
  ...
  %108 = load i8, ptr %from.3.prol, align 1
  %incdec.ptr200.prol = getelementptr inbounds i8, ptr %out.4.prol, i64 1
  store i8 %108, ptr %out.4.prol, align 1
  %dec202.prol = add i32 %op.3.prol, -1
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %do.body198.prol.loopexit, label %do.body198.prol
...
if.then221:                                       ; preds = %while.end
  %131 = load i8, ptr %from.5.lcssa, align 1
  %incdec.ptr223 = getelementptr inbounds i8, ptr %out.6.lcssa, i64 1
  store i8 %131, ptr %out.6.lcssa, align 1
...
if.then226:                                       ; preds = %if.then221
  ...
  %132 = load i8, ptr %incdec.ptr222, align 1
  %incdec.ptr228 = getelementptr inbounds i8, ptr %out.6.lcssa, i64 2
  store i8 %132, ptr %incdec.ptr223, align 1
  br label %do.cond299
...
if.then248:                                       ; preds = %do.end246
  %136 = load i8, ptr %incdec.ptr240, align 1
  %incdec.ptr250 = getelementptr inbounds i8, ptr %out.7, i64 4
  store i8 %136, ptr %incdec.ptr241, align 1
...
if.then253:                                       ; preds = %if.then248
  ...
  %137 = load i8, ptr %incdec.ptr249, align 1
  %incdec.ptr255 = getelementptr inbounds i8, ptr %out.7, i64 5
  store i8 %137, ptr %incdec.ptr250, align 1
  br label %do.cond299
...
if.then280:                                       ; preds = %if.else276
  ...
  %notmask572 = shl nsw i32 -1, %conv32611
  %sub284 = xor i32 %notmask572, -1
...
do.cond299:                                       ; preds = %if.then35, %do.end246, %if.then253, %if.then248, %while.end, %if.then226, %if.then221
  ...
  br i1 %138, label %do.body, label %do.end304
...
do.end304.sink.split:                             ; preds = %do.end304.sink.split.sink.split, %if.else289
  ...
  store i32 %.sink, ptr %mode296, align 8
  br label %do.end304
...
do.end304:                                        ; preds = %do.cond299, %do.end304.sink.split
  ...
  store ptr %add.ptr308, ptr %strm, align 8
  ...
  store i32 %conv327, ptr %avail_in, align 8
  ...
  %notmask576 = shl nsw i32 -1, %sub310
  %sub312 = xor i32 %notmask576, -1
  %conv313 = zext i32 %sub312 to i64
  %and314 = and i64 %hold.9, %conv313
  %140 = trunc i64 %sub.ptr.sub334 to i32
  %conv343 = add i32 %140, 257
  store i32 %conv343, ptr %avail_out, align 8
  store i64 %and314, ptr %hold13, align 8
  store i32 %sub310, ptr %bits14, align 8
  ret void
}
