...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %30, align 1, !tbaa !9
  %31 = getelementptr inbounds i8, ptr %30, i64 16
  %wide.load513 = load <16 x i8>, ptr %31, align 1, !tbaa !9
  ...
  store <16 x i8> %wide.load513, ptr %35, align 1, !tbaa !9
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load518 = load <8 x i8>, ptr %40, align 1, !tbaa !9
  %41 = add nuw i64 %offset.idx517, %indvars.iv
  %42 = and i64 %41, 4294967295
  %43 = getelementptr inbounds i8, ptr %dst, i64 %42
  store <8 x i8> %wide.load518, ptr %43, align 1, !tbaa !9
...
for.body.prol:                                    ; preds = %for.body.preheader
  ...
  store i8 %46, ptr %arrayidx149.prol, align 1, !tbaa !9
...
for.body.prol.loopexit:                           ; preds = %for.body.prol, %for.body.preheader
  ...
  %47 = sub nsw i64 0, %idx.ext91
  %48 = xor i64 %indvars.iv453.ph, %47
  %49 = icmp eq i64 %48, -1
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  ...
  %53 = load i8, ptr %arrayidx146.1, align 1, !tbaa !9
  ...
  store i8 %53, ptr %arrayidx149.1, align 1, !tbaa !9
...
if.end21:                                         ; preds = %land.lhs.true11, %land.lhs.true, %while.body
  ...
  br i1 %tobool.not, label %land.lhs.true23, label %while.body, !llvm.loop !17
...
if.end60:                                         ; preds = %land.lhs.true45, %while.body40
  ...
  br i1 %tobool39.not, label %if.end203, label %while.body40, !llvm.loop !18
...
land.rhs186:                                      ; preds = %while.cond167
  ...
  br i1 %tobool188.not, label %while.end192, label %while.cond167, !llvm.loop !19
...
while.end192:                                     ; preds = %while.cond167, %land.rhs186
  ...
  br i1 %cmp149.not, label %while.end194, label %land.lhs.true151, !llvm.loop !20
...
while.end194:                                     ; preds = %land.rhs161, %land.lhs.true151, %while.end192, %while.cond142.preheader
  ...
  br i1 %cmp126.not, label %while.end196, label %land.lhs.true128, !llvm.loop !21
...
if.end220:                                        ; preds = %while.body216, %if.end.i581, %if.end12.i585, %if.end16.i589, %land.lhs.true25.i597, %land.lhs.true36.i600
  ...
  br i1 %cmp214, label %while.body216, label %while.end222, !llvm.loop !22
...
for.body345:                                      ; preds = %for.body345, %for.body345.lr.ph.new
  ...
  br i1 %niter.ncmp.1, label %for.end363.loopexit.unr-lcssa, label %for.body345, !llvm.loop !24
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %28, align 1, !tbaa !9
  %29 = getelementptr inbounds i8, ptr %28, i64 16
  %wide.load542 = load <16 x i8>, ptr %29, align 1, !tbaa !9
  ...
  store <16 x i8> %wide.load542, ptr %33, align 1, !tbaa !9
  %index.next = add nuw i64 %offset.idx, 32
  %34 = icmp eq i64 %index.next, %n.vec
  br i1 %34, label %middle.block, label %vector.body, !llvm.loop !26
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load547 = load <8 x i8>, ptr %38, align 1, !tbaa !9
  %39 = add nuw i64 %offset.idx546, %indvars.iv
  %40 = and i64 %39, 4294967295
  %41 = getelementptr inbounds i8, ptr %dst, i64 %40
  store <8 x i8> %wide.load547, ptr %41, align 1, !tbaa !9
  %index.next548 = add nuw i64 %offset.idx546, 8
  %42 = icmp eq i64 %index.next548, %n.vec544
  br i1 %42, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !27
...
for.body.prol:                                    ; preds = %for.body.preheader
  ...
  store i8 %44, ptr %arrayidx155.prol, align 1, !tbaa !9
...
for.body.prol.loopexit:                           ; preds = %for.body.prol, %for.body.preheader
  ...
  %45 = sub nsw i64 0, %idx.ext97
  %46 = xor i64 %indvars.iv495.ph, %45
  %47 = icmp eq i64 %46, -1
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  ...
  %51 = load i8, ptr %arrayidx152.1, align 1, !tbaa !9
  ...
  store i8 %51, ptr %arrayidx155.1, align 1, !tbaa !9
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %28, align 1, !tbaa !9
  %29 = getelementptr inbounds i8, ptr %28, i64 16
  %wide.load614 = load <16 x i8>, ptr %29, align 1, !tbaa !9
  %30 = add nuw i64 %offset.idx, %indvars.iv
  %31 = and i64 %30, 4294967295
  %32 = getelementptr inbounds i8, ptr %dst, i64 %31
  store <16 x i8> %wide.load, ptr %32, align 1, !tbaa !9
  %33 = getelementptr inbounds i8, ptr %32, i64 16
  store <16 x i8> %wide.load614, ptr %33, align 1, !tbaa !9
  %index.next = add nuw i64 %offset.idx, 32
  %34 = icmp eq i64 %index.next, %n.vec
  br i1 %34, label %middle.block, label %vector.body, !llvm.loop !30
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %37 = zext i32 %36 to i64
  %38 = getelementptr inbounds i8, ptr %dst, i64 %37
  %wide.load619 = load <8 x i8>, ptr %38, align 1, !tbaa !9
  %39 = add nuw i64 %offset.idx618, %indvars.iv
  %40 = and i64 %39, 4294967295
  %41 = getelementptr inbounds i8, ptr %dst, i64 %40
  store <8 x i8> %wide.load619, ptr %41, align 1, !tbaa !9
  %index.next620 = add nuw i64 %offset.idx618, 8
  %42 = icmp eq i64 %index.next620, %n.vec616
  br i1 %42, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !31
...
for.body.prol:                                    ; preds = %for.body.preheader
  ...
  store i8 %44, ptr %arrayidx165.prol, align 1, !tbaa !9
...
for.body.prol.loopexit:                           ; preds = %for.body.prol, %for.body.preheader
  ...
  %45 = sub nsw i64 0, %idx.ext106
  %46 = xor i64 %indvars.iv567.ph, %45
  %47 = icmp eq i64 %46, -1
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  ...
  %51 = load i8, ptr %arrayidx162.1, align 1, !tbaa !9
