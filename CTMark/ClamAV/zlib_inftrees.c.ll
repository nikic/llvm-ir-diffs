...
for.inc42:                                        ; preds = %for.body34
  ...
  br i1 %exitcond502.not, label %for.end44, label %for.body34, !llvm.loop !21
...
for.cond49.4:                                     ; preds = %for.cond49.3
  ...
  %48 = load i16, ptr %arrayidx54.5, align 4, !tbaa !5
...
for.cond49.5:                                     ; preds = %for.cond49.4
  ...
  %50 = load i16, ptr %arrayidx54.6, align 2, !tbaa !5
...
for.cond49.6:                                     ; preds = %for.cond49.5
  ...
  %51 = load i16, ptr %arrayidx54.7, align 16, !tbaa !5
...
for.cond49.7:                                     ; preds = %for.cond49.6
  ...
  %52 = load i16, ptr %arrayidx54.8, align 2, !tbaa !5
...
for.cond49.8:                                     ; preds = %for.cond49.7
  ...
  %53 = load i16, ptr %arrayidx54.9, align 4, !tbaa !5
...
for.cond49.9:                                     ; preds = %for.cond49.8
  ...
  %54 = load i16, ptr %arrayidx54.10, align 2, !tbaa !5
...
for.cond49.10:                                    ; preds = %for.cond49.9
  ...
  %55 = load i16, ptr %arrayidx54.11, align 8, !tbaa !5
...
for.cond49.11:                                    ; preds = %for.cond49.10
  ...
  %56 = load i16, ptr %arrayidx54.12, align 2, !tbaa !5
...
for.cond49.12:                                    ; preds = %for.cond49.11
  ...
  %57 = load i16, ptr %arrayidx54.13, align 4, !tbaa !5
...
for.body92:                                       ; preds = %for.inc108.1, %for.body92.preheader.new
  ...
  %59 = load i16, ptr %arrayidx94, align 2, !tbaa !5
...
if.then98:                                        ; preds = %for.body92
  ...
  %60 = load i16, ptr %arrayidx103, align 2, !tbaa !5
  %inc104 = add i16 %60, 1
...
for.inc108:                                       ; preds = %for.body92, %if.then98
  ...
  %61 = load i16, ptr %arrayidx94.1, align 2, !tbaa !5
...
if.then98.1:                                      ; preds = %for.inc108
  ...
  %62 = load i16, ptr %arrayidx103.1, align 2, !tbaa !5
...
for.inc108.1:                                     ; preds = %if.then98.1, %for.inc108
  ...
  br i1 %niter576.ncmp.1, label %for.end110.loopexit.unr-lcssa, label %for.body92, !llvm.loop !22
...
for.body92.epil:                                  ; preds = %for.end110.loopexit.unr-lcssa
  ...
  %63 = load i16, ptr %arrayidx94.epil, align 2, !tbaa !5
...
if.then98.epil:                                   ; preds = %for.body92.epil
  ...
  %64 = load i16, ptr %arrayidx103.epil, align 2, !tbaa !5
...
for.cond127.preheader:                            ; preds = %sw.epilog, %for.end110, %lor.lhs.false119
  ...
  %65 = load ptr, ptr %table, align 8, !tbaa !15
...
for.cond127:                                      ; preds = %for.cond127.backedge, %for.cond127.outer
  ...
  %66 = load i16, ptr %arrayidx132, align 2, !tbaa !5
...
while.end:                                        ; preds = %while.cond
  ...
  %69 = load i16, ptr %arrayidx190, align 2, !tbaa !5
  %dec191 = add i16 %69, -1
...
if.end199:                                        ; preds = %if.then195
  ...
  %70 = load i16, ptr %arrayidx201, align 2, !tbaa !5
...
while.body223:                                    ; preds = %while.body223.preheader, %if.end232
  ...
  %73 = load i16, ptr %arrayidx226, align 2, !tbaa !5
...
if.end276:                                        ; preds = %if.then268, %for.end265
  %76 = load ptr, ptr %table, align 8, !tbaa !15
