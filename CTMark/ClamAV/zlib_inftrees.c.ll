; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/zlib_inftrees.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/zlib_inftrees.c"
...
for.end11:                                        ; preds = %for.body3.epil, %for.end11.unr-lcssa
  ...
  %.pre = load i16, ptr %arrayidx16.phi.trans.insert, align 2
...
for.inc19:                                        ; preds = %for.end11.thread, %for.end11
  ...
  %14 = load i16, ptr %arrayidx16.1, align 4
...
for.inc19.1:                                      ; preds = %for.inc19
  ...
  %15 = load i16, ptr %arrayidx16.2, align 2
...
for.inc19.2:                                      ; preds = %for.inc19.1
  ...
  %16 = load i16, ptr %arrayidx16.3, align 8
...
for.inc19.3:                                      ; preds = %for.inc19.2
  ...
  %17 = load i16, ptr %arrayidx16.4, align 2
...
for.inc19.4:                                      ; preds = %for.inc19.3
  ...
  %18 = load i16, ptr %arrayidx16.5, align 4
...
for.inc19.5:                                      ; preds = %for.inc19.4
  ...
  %19 = load i16, ptr %arrayidx16.6, align 2
...
for.inc19.6:                                      ; preds = %for.inc19.5
  ...
  %20 = load i16, ptr %arrayidx16.7, align 16
...
for.inc19.7:                                      ; preds = %for.inc19.6
  ...
  %21 = load i16, ptr %arrayidx16.8, align 2
...
for.inc19.8:                                      ; preds = %for.inc19.7
  ...
  %22 = load i16, ptr %arrayidx16.9, align 4
...
for.inc19.9:                                      ; preds = %for.inc19.8
  ...
  %23 = load i16, ptr %arrayidx16.10, align 2
...
for.inc19.10:                                     ; preds = %for.inc19.9
  ...
  %24 = load i16, ptr %arrayidx16.11, align 8
...
for.inc19.11:                                     ; preds = %for.inc19.10
  ...
  %25 = load i16, ptr %arrayidx16.12, align 2
...
for.inc19.12:                                     ; preds = %for.inc19.11
  ...
  %26 = load i16, ptr %arrayidx16.13, align 4
...
for.inc19.13:                                     ; preds = %for.inc19.12
  ...
  %27 = load i16, ptr %arrayidx16.14, align 2
...
for.body34.preheader:                             ; preds = %for.end11, %for.inc19, %for.inc19.1, %for.inc19.2, %for.inc19.3, %for.inc19.4, %for.inc19.5, %for.inc19.6, %for.inc19.7, %for.inc19.8, %for.inc19.9, %for.inc19.10, %for.inc19.11, %for.inc19.12
  %.ph = phi i32 [ %13, %for.inc19.12 ], [ %13, %for.inc19.11 ], [ %13, %for.inc19.10 ], [ %13, %for.inc19.9 ], [ %13, %for.inc19.8 ], [ %13, %for.inc19.7 ], [ %13, %for.inc19.6 ], [ %13, %for.inc19.5 ], [ %13, %for.inc19.4 ], [ %13, %for.inc19.3 ], [ %13, %for.inc19.2 ], [ %13, %for.inc19.1 ], [ %13, %for.inc19 ], [ %12, %for.end11 ]
  %.ph518 = phi i16 [ 0, %for.inc19.12 ], [ 0, %for.inc19.11 ], [ 0, %for.inc19.10 ], [ 0, %for.inc19.9 ], [ 0, %for.inc19.8 ], [ 0, %for.inc19.7 ], [ 0, %for.inc19.6 ], [ 0, %for.inc19.5 ], [ 0, %for.inc19.4 ], [ 0, %for.inc19.3 ], [ 0, %for.inc19.2 ], [ 0, %for.inc19.1 ], [ 0, %for.inc19 ], [ %.pre, %for.end11 ]
  %max.0473.lcssa.ph = phi i32 [ 2, %for.inc19.12 ], [ 3, %for.inc19.11 ], [ 4, %for.inc19.10 ], [ 5, %for.inc19.9 ], [ 6, %for.inc19.8 ], [ 7, %for.inc19.7 ], [ 8, %for.inc19.6 ], [ 9, %for.inc19.5 ], [ 10, %for.inc19.4 ], [ 11, %for.inc19.3 ], [ 12, %for.inc19.2 ], [ 13, %for.inc19.1 ], [ 14, %for.inc19 ], [ 15, %for.end11 ]
  %spec.select521 = tail call i32 @llvm.umin.i32(i32 %.ph, i32 %max.0473.lcssa.ph)
  %wide.trip.count501 = zext i32 %max.0473.lcssa.ph to i64
  br label %for.body34

for.body34:                                       ; preds = %for.body34.preheader, %for.inc42
  %indvars.iv498 = phi i64 [ 1, %for.body34.preheader ], [ %indvars.iv.next499, %for.inc42 ]
  %arrayidx36 = getelementptr inbounds [16 x i16], ptr %count, i64 0, i64 %indvars.iv498
...
for.inc42:                                        ; preds = %for.body34
  ...
  br i1 %exitcond502.not, label %for.end44, label %for.body34

for.end44.loopexit.split.loop.exit:               ; preds = %for.body34
  %32 = trunc i64 %indvars.iv498 to i32
  br label %for.end44

for.end44:                                        ; preds = %for.inc42, %for.end44.loopexit.split.loop.exit, %for.end20
  %spec.select526 = phi i32 [ %spec.select, %for.end20 ], [ %spec.select521, %for.end44.loopexit.split.loop.exit ], [ %spec.select521, %for.inc42 ]
  %max.0473.lcssa525 = phi i32 [ 1, %for.end20 ], [ %max.0473.lcssa.ph, %for.end44.loopexit.split.loop.exit ], [ %max.0473.lcssa.ph, %for.inc42 ]
  %cmp32474522 = phi i1 [ false, %for.end20 ], [ true, %for.end44.loopexit.split.loop.exit ], [ true, %for.inc42 ]
  %33 = phi i16 [ 0, %for.end20 ], [ %.ph518, %for.end44.loopexit.split.loop.exit ], [ %.ph518, %for.inc42 ]
  %min.0.lcssa = phi i32 [ 1, %for.end20 ], [ %32, %for.end44.loopexit.split.loop.exit ], [ %max.0473.lcssa.ph, %for.inc42 ]
  %spec.select443 = tail call i32 @llvm.umax.i32(i32 %spec.select526, i32 %min.0.lcssa)
  %arrayidx54 = getelementptr inbounds [16 x i16], ptr %count, i64 0, i64 1
  %34 = load i16, ptr %arrayidx54, align 2
...
for.cond49:                                       ; preds = %for.end44
  ...
  %36 = load i16, ptr %arrayidx54.1, align 4
...
for.cond49.1:                                     ; preds = %for.cond49
  ...
  %39 = load i16, ptr %arrayidx54.2, align 2
...
for.cond49.2:                                     ; preds = %for.cond49.1
  ...
  %42 = load i16, ptr %arrayidx54.3, align 8
  %conv55.3 = zext i16 %42 to i32
  %43 = add nuw nsw i32 %41, %conv55.3
  %cmp56.3 = icmp ugt i32 %43, 16
...
for.cond49.3:                                     ; preds = %for.cond49.2
  ...
  %45 = load i16, ptr %arrayidx54.4, align 2
  %conv55.4 = zext i16 %45 to i32
  %46 = add nuw nsw i32 %44, %conv55.4
  %cmp56.4 = icmp ugt i32 %46, 32
...
for.cond49.4:                                     ; preds = %for.cond49.3
  ...
  %48 = load i16, ptr %arrayidx54.5, align 4
  %conv55.5 = zext i16 %48 to i32
  %49 = add i32 %47, %conv55.5
  %sub.5 = sub i32 64, %49
...
for.cond49.5:                                     ; preds = %for.cond49.4
  ...
  %50 = load i16, ptr %arrayidx54.6, align 2
  %conv55.6 = zext i16 %50 to i32
...
for.cond49.6:                                     ; preds = %for.cond49.5
  ...
  %51 = load i16, ptr %arrayidx54.7, align 16
  %conv55.7 = zext i16 %51 to i32
...
for.cond49.7:                                     ; preds = %for.cond49.6
  ...
  %52 = load i16, ptr %arrayidx54.8, align 2
  %conv55.8 = zext i16 %52 to i32
...
for.cond49.8:                                     ; preds = %for.cond49.7
  ...
  %53 = load i16, ptr %arrayidx54.9, align 4
  %conv55.9 = zext i16 %53 to i32
...
for.cond49.9:                                     ; preds = %for.cond49.8
  ...
  %54 = load i16, ptr %arrayidx54.10, align 2
  %conv55.10 = zext i16 %54 to i32
...
for.cond49.10:                                    ; preds = %for.cond49.9
  ...
  %55 = load i16, ptr %arrayidx54.11, align 8
  %conv55.11 = zext i16 %55 to i32
...
for.cond49.11:                                    ; preds = %for.cond49.10
  ...
  %56 = load i16, ptr %arrayidx54.12, align 2
  %conv55.12 = zext i16 %56 to i32
...
for.cond49.12:                                    ; preds = %for.cond49.11
  ...
  %57 = load i16, ptr %arrayidx54.13, align 4
  %conv55.13 = zext i16 %57 to i32
...
for.cond49.14:                                    ; preds = %for.cond49.13
  ...
  %or.cond = or i1 %cmp65, %cmp32474522
  %or.cond559 = and i1 %cmp63.not, %or.cond
  br i1 %or.cond559, label %cleanup, label %if.end70
...
if.end70:                                         ; preds = %for.cond49.14
  ...
  store i16 %34, ptr %arrayidx85, align 4
  %add.1 = add i16 %36, %34
  %arrayidx85.1 = getelementptr inbounds [16 x i16], ptr %offs, i64 0, i64 3
  store i16 %add.1, ptr %arrayidx85.1, align 2
  %add.2 = add i16 %39, %add.1
  %arrayidx85.2 = getelementptr inbounds [16 x i16], ptr %offs, i64 0, i64 4
  store i16 %add.2, ptr %arrayidx85.2, align 8
  %add.3 = add i16 %42, %add.2
  %arrayidx85.3 = getelementptr inbounds [16 x i16], ptr %offs, i64 0, i64 5
  store i16 %add.3, ptr %arrayidx85.3, align 2
  %add.4 = add i16 %45, %add.3
  %arrayidx85.4 = getelementptr inbounds [16 x i16], ptr %offs, i64 0, i64 6
  store i16 %add.4, ptr %arrayidx85.4, align 4
  %add.5 = add i16 %48, %add.4
  %arrayidx85.5 = getelementptr inbounds [16 x i16], ptr %offs, i64 0, i64 7
  store i16 %add.5, ptr %arrayidx85.5, align 2
  %add.6 = add i16 %50, %add.5
  %arrayidx85.6 = getelementptr inbounds [16 x i16], ptr %offs, i64 0, i64 8
  store i16 %add.6, ptr %arrayidx85.6, align 16
  %add.7 = add i16 %51, %add.6
  %arrayidx85.7 = getelementptr inbounds [16 x i16], ptr %offs, i64 0, i64 9
  store i16 %add.7, ptr %arrayidx85.7, align 2
  %add.8 = add i16 %52, %add.7
  %arrayidx85.8 = getelementptr inbounds [16 x i16], ptr %offs, i64 0, i64 10
  store i16 %add.8, ptr %arrayidx85.8, align 4
  %add.9 = add i16 %53, %add.8
  %arrayidx85.9 = getelementptr inbounds [16 x i16], ptr %offs, i64 0, i64 11
  store i16 %add.9, ptr %arrayidx85.9, align 2
  %add.10 = add i16 %54, %add.9
  %arrayidx85.10 = getelementptr inbounds [16 x i16], ptr %offs, i64 0, i64 12
  store i16 %add.10, ptr %arrayidx85.10, align 8
  %add.11 = add i16 %55, %add.10
  %arrayidx85.11 = getelementptr inbounds [16 x i16], ptr %offs, i64 0, i64 13
  store i16 %add.11, ptr %arrayidx85.11, align 2
  %add.12 = add i16 %56, %add.11
  %arrayidx85.12 = getelementptr inbounds [16 x i16], ptr %offs, i64 0, i64 14
  store i16 %add.12, ptr %arrayidx85.12, align 4
  %add.13 = add i16 %57, %add.12
  %arrayidx85.13 = getelementptr inbounds [16 x i16], ptr %offs, i64 0, i64 15
  store i16 %add.13, ptr %arrayidx85.13, align 2
  br i1 %cmp2471.not, label %for.end110, label %for.body92.preheader

for.body92.preheader:                             ; preds = %if.end70
  %wide.trip.count514 = zext i32 %codes to i64
  %xtraiter572 = and i64 %wide.trip.count514, 1
  %58 = icmp eq i32 %codes, 1
  br i1 %58, label %for.end110.loopexit.unr-lcssa, label %for.body92.preheader.new

for.body92.preheader.new:                         ; preds = %for.body92.preheader
  %unroll_iter575 = and i64 %wide.trip.count514, 4294967294
  br label %for.body92

for.body92:                                       ; preds = %for.inc108.1, %for.body92.preheader.new
  %indvars.iv511 = phi i64 [ 0, %for.body92.preheader.new ], [ %indvars.iv.next512.1, %for.inc108.1 ]
  %niter576 = phi i64 [ 0, %for.body92.preheader.new ], [ %niter576.next.1, %for.inc108.1 ]
  %arrayidx94 = getelementptr inbounds i16, ptr %lens, i64 %indvars.iv511
  %59 = load i16, ptr %arrayidx94, align 2
  %cmp96.not = icmp eq i16 %59, 0
  br i1 %cmp96.not, label %for.inc108, label %if.then98

if.then98:                                        ; preds = %for.body92
  %conv99 = trunc i64 %indvars.iv511 to i16
...
for.inc108:                                       ; preds = %for.body92, %if.then98
  ...
  %arrayidx94.1 = getelementptr inbounds i16, ptr %lens, i64 %indvars.iv.next512
  %61 = load i16, ptr %arrayidx94.1, align 2
  %cmp96.not.1 = icmp eq i16 %61, 0
  br i1 %cmp96.not.1, label %for.inc108.1, label %if.then98.1

if.then98.1:                                      ; preds = %for.inc108
  %conv99.1 = trunc i64 %indvars.iv.next512 to i16
  %idxprom102.1 = zext i16 %61 to i64
  %arrayidx103.1 = getelementptr inbounds [16 x i16], ptr %offs, i64 0, i64 %idxprom102.1
  %62 = load i16, ptr %arrayidx103.1, align 2
  %inc104.1 = add i16 %62, 1
  store i16 %inc104.1, ptr %arrayidx103.1, align 2
  %idxprom105.1 = zext i16 %62 to i64
  %arrayidx106.1 = getelementptr inbounds i16, ptr %work, i64 %idxprom105.1
  store i16 %conv99.1, ptr %arrayidx106.1, align 2
...
for.inc108.1:                                     ; preds = %if.then98.1, %for.inc108
  ...
  br i1 %niter576.ncmp.1, label %for.end110.loopexit.unr-lcssa, label %for.body92

for.end110.loopexit.unr-lcssa:                    ; preds = %for.inc108.1, %for.body92.preheader
  %indvars.iv511.unr = phi i64 [ 0, %for.body92.preheader ], [ %indvars.iv.next512.1, %for.inc108.1 ]
  %lcmp.mod574.not = icmp eq i64 %xtraiter572, 0
  br i1 %lcmp.mod574.not, label %for.end110, label %for.body92.epil

for.body92.epil:                                  ; preds = %for.end110.loopexit.unr-lcssa
  %arrayidx94.epil = getelementptr inbounds i16, ptr %lens, i64 %indvars.iv511.unr
  %63 = load i16, ptr %arrayidx94.epil, align 2
  %cmp96.not.epil = icmp eq i16 %63, 0
  br i1 %cmp96.not.epil, label %for.end110, label %if.then98.epil

if.then98.epil:                                   ; preds = %for.body92.epil
  %conv99.epil = trunc i64 %indvars.iv511.unr to i16
  %idxprom102.epil = zext i16 %63 to i64
  %arrayidx103.epil = getelementptr inbounds [16 x i16], ptr %offs, i64 0, i64 %idxprom102.epil
  %64 = load i16, ptr %arrayidx103.epil, align 2
  %inc104.epil = add i16 %64, 1
  store i16 %inc104.epil, ptr %arrayidx103.epil, align 2
  %idxprom105.epil = zext i16 %64 to i64
  %arrayidx106.epil = getelementptr inbounds i16, ptr %work, i64 %idxprom105.epil
  store i16 %conv99.epil, ptr %arrayidx106.epil, align 2
  br label %for.end110
...
for.cond127.preheader:                            ; preds = %sw.epilog, %for.end110, %lor.lhs.false119
  %cmp120543 = phi i1 [ %cmp120, %lor.lhs.false119 ], [ false, %for.end110 ], [ false, %sw.epilog ]
  %base.0456540 = phi ptr [ @inflate_table.dbase, %lor.lhs.false119 ], [ %work, %for.end110 ], [ @inflate_table.lbase, %sw.epilog ]
  %extra.0457539 = phi ptr [ @inflate_table.dext, %lor.lhs.false119 ], [ %work, %for.end110 ], [ @inflate_table.lext, %sw.epilog ]
  %match.0458538 = phi i32 [ 0, %lor.lhs.false119 ], [ 20, %for.end110 ], [ 257, %sw.epilog ]
  %cmp114461537 = phi i1 [ false, %lor.lhs.false119 ], [ false, %for.end110 ], [ true, %sw.epilog ]
  %shl112459541 = shl nuw i32 1, %spec.select443
  %sub113460542 = add i32 %shl112459541, -1
...
for.cond127.outer:                                ; preds = %if.end250, %for.cond127.preheader
  ...
  %used.0.ph = phi i32 [ %add237, %if.end250 ], [ %shl112459541, %for.cond127.preheader ]
  %huff.0.ph = phi i32 [ %huff.1, %if.end250 ], [ 0, %for.cond127.preheader ]
  %low.0.ph = phi i32 [ %and209, %if.end250 ], [ -1, %for.cond127.preheader ]
  %next.0.ph = phi ptr [ %add.ptr, %if.end250 ], [ %65, %for.cond127.preheader ]
...
for.cond127:                                      ; preds = %for.cond127.backedge, %for.cond127.outer
  ...
  %conv133 = zext i16 %66 to i32
  %add134 = add nuw nsw i32 %conv133, 1
  %cmp135 = icmp ult i32 %add134, %match.0458538
  br i1 %cmp135, label %if.end167, label %if.else

if.else:                                          ; preds = %for.cond127
  %cmp145.not = icmp ugt i32 %match.0458538, %conv133
  br i1 %cmp145.not, label %if.end167, label %if.then147

if.then147:                                       ; preds = %if.else
  %sub151 = sub nsw i32 %conv133, %match.0458538
  %idxprom152 = zext i32 %sub151 to i64
  %arrayidx153 = getelementptr inbounds i16, ptr %extra.0457539, i64 %idxprom152
  %67 = load i16, ptr %arrayidx153, align 2
  %conv154 = trunc i16 %67 to i8
  %arrayidx161 = getelementptr inbounds i16, ptr %base.0456540, i64 %idxprom152
  %68 = load i16, ptr %arrayidx161, align 2
  br label %if.end167

if.end167:                                        ; preds = %if.else, %for.cond127, %if.then147
  %here.sroa.14.0 = phi i16 [ %68, %if.then147 ], [ %66, %for.cond127 ], [ 0, %if.else ]
...
do.body:                                          ; preds = %do.body, %if.end167
  ...
  store i8 %conv129, ptr %here.sroa.11.0.arrayidx174.sroa_idx, align 1
  %here.sroa.14.0.arrayidx174.sroa_idx = getelementptr inbounds i8, ptr %arrayidx174, i64 2
  store i16 %here.sroa.14.0, ptr %here.sroa.14.0.arrayidx174.sroa_idx, align 2
  %cmp175.not = icmp eq i32 %sub171, 0
  br i1 %cmp175.not, label %do.end, label %do.body
...
while.end:                                        ; preds = %while.cond
  ...
  %69 = load i16, ptr %arrayidx190, align 2
  %dec191 = add i16 %69, -1
...
if.then195:                                       ; preds = %while.end
  %cmp196 = icmp eq i32 %len.3, %max.0473.lcssa525
...
if.end199:                                        ; preds = %if.then195
  ...
  %70 = load i16, ptr %arrayidx201, align 2
  %idxprom202 = zext i16 %70 to i64
  %arrayidx203 = getelementptr inbounds i16, ptr %lens, i64 %idxprom202
  %71 = load i16, ptr %arrayidx203, align 2
  %conv204 = zext i16 %71 to i32
  br label %if.end205
...
land.lhs.true208:                                 ; preds = %if.end205
  %and209 = and i32 %huff.1, %sub113460542
...
if.then212:                                       ; preds = %land.lhs.true208
  ...
  %cmp221482 = icmp ult i32 %len.4, %max.0473.lcssa525
  br i1 %cmp221482, label %while.body223.preheader, label %while.end235

while.body223.preheader:                          ; preds = %if.then212
  %72 = sub i32 %max.0473.lcssa525, %spec.select444
  br label %while.body223

while.body223:                                    ; preds = %while.body223.preheader, %if.end232
  %add220485 = phi i32 [ %add220, %if.end232 ], [ %len.4, %while.body223.preheader ]
  %left.1484 = phi i32 [ %shl234, %if.end232 ], [ %shl218, %while.body223.preheader ]
  %curr.1483 = phi i32 [ %inc233, %if.end232 ], [ %sub217, %while.body223.preheader ]
  %idxprom225 = zext i32 %add220485 to i64
  %arrayidx226 = getelementptr inbounds [16 x i16], ptr %count, i64 0, i64 %idxprom225
  %73 = load i16, ptr %arrayidx226, align 2
  %conv227 = zext i16 %73 to i32
  %sub228 = sub nsw i32 %left.1484, %conv227
  %cmp229 = icmp slt i32 %sub228, 1
  br i1 %cmp229, label %while.end235.loopexit, label %if.end232

if.end232:                                        ; preds = %while.body223
  %inc233 = add i32 %curr.1483, 1
  %shl234 = shl nuw i32 %sub228, 1
  %add220 = add i32 %inc233, %spec.select444
  %cmp221 = icmp ult i32 %add220, %max.0473.lcssa525
  br i1 %cmp221, label %while.body223, label %while.end235.loopexit

while.end235.loopexit:                            ; preds = %while.body223, %if.end232
  %curr.1.lcssa.ph = phi i32 [ %72, %if.end232 ], [ %curr.1483, %while.body223 ]
  %.pre516 = shl nuw i32 1, %curr.1.lcssa.ph
  br label %while.end235

while.end235:                                     ; preds = %while.end235.loopexit, %if.then212
  %shl236.pre-phi = phi i32 [ %.pre516, %while.end235.loopexit ], [ %shl218, %if.then212 ]
  ...
  %or.cond301 = select i1 %cmp114461537, i1 %cmp241, i1 false
  %cmp247 = icmp ugt i32 %add237, 592
  %or.cond302 = select i1 %cmp120543, i1 %cmp247, i1 false
...
if.end250:                                        ; preds = %while.end235
  ...
  %arrayidx254 = getelementptr inbounds %struct.code, ptr %74, i64 %idxprom253
  store i8 %conv252, ptr %arrayidx254, align 2
  %bits259 = getelementptr inbounds %struct.code, ptr %74, i64 %idxprom253, i32 1
  store i8 %conv256, ptr %bits259, align 1
  %sub.ptr.lhs.cast = ptrtoint ptr %add.ptr to i64
  %sub.ptr.rhs.cast = ptrtoint ptr %74 to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  %75 = lshr exact i64 %sub.ptr.sub, 2
  %conv260 = trunc i64 %75 to i16
  %val263 = getelementptr inbounds %struct.code, ptr %74, i64 %idxprom253, i32 2
...
if.then268:                                       ; preds = %for.end265
  ...
  store i8 %conv129, ptr %here.sroa.11.0.arrayidx275.sroa_idx, align 1
  %here.sroa.14.0.arrayidx275.sroa_idx = getelementptr inbounds i8, ptr %arrayidx275, i64 2
  store i16 0, ptr %here.sroa.14.0.arrayidx275.sroa_idx, align 2
  br label %if.end276

if.end276:                                        ; preds = %if.then268, %for.end265
  %76 = load ptr, ptr %table, align 8
  %idx.ext277 = zext i32 %used.0.ph to i64
  %add.ptr278 = getelementptr inbounds %struct.code, ptr %76, i64 %idx.ext277
...
cleanup.sink.split:                               ; preds = %for.inc19.14, %if.end276
  ...
  store i32 %spec.select443.sink, ptr %bits, align 4
  br label %cleanup
