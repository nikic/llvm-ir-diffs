; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_special.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_special.c"
...
if.end.1:                                         ; preds = %for.inc22
  ...
  %21 = load i32, ptr %record, align 16
...
if.end.2:                                         ; preds = %for.inc22.1
  ...
  store i32 %xor.2.2, ptr %arrayidx9.2, align 4
  %add.2.2 = add nsw i32 %xor.2.2, %add.1.2
  %28 = load i32, ptr %arrayidx9.3, align 16
  %or7.i47.3.2 = call i32 @llvm.bswap.i32(i32 %28)
  %xor.3.2 = xor i32 %or7.i47.3.2, %24
  store i32 %xor.3.2, ptr %arrayidx9.3, align 16
  ...
  %32 = load i32, ptr %record, align 16
...
if.end.3:                                         ; preds = %for.inc22.2
  ...
  %43 = load i32, ptr %record, align 16
...
do.body.i:                                        ; preds = %jpeg_check_photoshop_8bim.exit, %if.end6.i
  ...
  br i1 %cmp.not.i111, label %if.end.i113, label %if.then.i

if.then.i:                                        ; preds = %do.body.i
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.11) #6
  br label %jpeg_check_photoshop_8bim.exit

if.end.i113:                                      ; preds = %do.body.i
  %bcmp.i114 = call i32 @bcmp(ptr noundef nonnull dereferenceable(4) %bim.i, ptr noundef nonnull dereferenceable(4) @.str.12, i64 4)
  %cmp4.not.i115 = icmp eq i32 %bcmp.i114, 0
  br i1 %cmp4.not.i115, label %if.end7.i, label %if.then5.i
...
if.end19.i:                                       ; preds = %if.end11.i
  %8 = load i8, ptr %nlength.i, align 1
...
if.end32.i:                                       ; preds = %if.end19.i
  ...
  store i32 %or41.i, ptr %size.i, align 4
...
jpeg_check_photoshop_8bim.exit:                   ; preds = %if.then.i, %if.then5.i, %if.end7.i, %if.end11.i, %if.end19.i, %if.end32.i, %if.then57.i, %if.end67.i
  %retval.0.i112 = phi i32 [ -1, %if.then.i ], [ -1, %if.then5.i ], [ 0, %if.then57.i ], [ %call63.i, %if.end67.i ], [ -1, %if.end7.i ], [ -1, %if.end11.i ], [ -1, %if.end19.i ], [ -1, %if.end32.i ]
  ...
  %cmp13.i = icmp eq i32 %retval.0.i112, 0
...
do.end.i:                                         ; preds = %jpeg_check_photoshop_8bim.exit
  %cmp14.i = icmp eq i32 %retval.0.i112, -1
...
cleanup:                                          ; preds = %for.cond.backedge, %if.end60, %if.end66, %jpeg_check_photoshop.exit, %if.end88, %cleanup.loopexit.split.loop.exit127, %for.cond.preheader, %if.end, %entry
  %retval.0 = phi i32 [ 0, %entry ], [ 0, %if.end ], [ %.mux.le, %cleanup.loopexit.split.loop.exit127 ], [ 0, %for.cond.preheader ], [ 0, %for.cond.backedge ], [ 0, %if.end60 ], [ 1, %if.end66 ], [ %retval.0.i112, %jpeg_check_photoshop.exit ], [ -1, %if.end88 ]
...
if.end22:                                         ; preds = %if.end18
  %0 = load i32, ptr %chunk_size, align 4
  %or5.i = call i32 @llvm.bswap.i32(i32 %0)
  %retval.0.i = select i1 %tobool.not.i, i32 %0, i32 %or5.i
  store i32 %retval.0.i, ptr %chunk_size, align 4
  br label %do.body

do.body:                                          ; preds = %do.body, %if.end22
  %call24 = call fastcc i32 @riff_read_chunk(i32 noundef %fd, i32 noundef %big_endian.0, i32 noundef 1)
...
if.end32:                                         ; preds = %if.then27
  ...
  %call33 = call fastcc i32 @riff_read_chunk(i32 noundef %fd, i32 noundef %big_endian, i32 noundef %inc)
  br label %cleanup
