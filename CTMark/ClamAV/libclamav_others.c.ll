; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_others.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_others.c"
...
entry:
  %0 = load i8, ptr @cli_debug_flag, align 1
...
for.body.preheader:                               ; preds = %while.end
  ...
  %6 = load i8, ptr %arrayidx.4, align 4
  ...
  %8 = load i8, ptr %arrayidx.6, align 2
  ...
  %9 = load i8, ptr %arrayidx.7, align 1
  ...
  %10 = load i8, ptr %arrayidx.8, align 8
  ...
  %11 = load i8, ptr %arrayidx.9, align 1
  ...
  %12 = load i8, ptr %arrayidx.10, align 2
  ...
  %13 = load i8, ptr %arrayidx.11, align 1
  ...
  %14 = load i8, ptr %arrayidx.12, align 4
  ...
  %15 = load i8, ptr %arrayidx.13, align 1
  ...
  %16 = load i8, ptr %arrayidx.14, align 2
  ...
  %17 = load i8, ptr %arrayidx.15, align 1
...
if.then5:                                         ; preds = %cli_malloc.exit
  ...
  br i1 %tobool.not.i, label %if.end6, label %if.then.i11

if.then.i11:                                      ; preds = %if.then5
  %call.i12 = tail call i32 @puts(ptr noundef nonnull dereferenceable(1) @.str.50)
  br label %if.end6
...
if.end6:                                          ; preds = %if.then.i11, %if.then5, %if.else, %entry
  %conv = trunc i16 %leavetemps to i8
  store i8 %conv, ptr @cli_leavetemps_flag, align 1
  ret void
}
...
if.then16:                                        ; preds = %for.end
  ...
  br i1 %tobool.not.i38, label %cleanup, label %if.then.i39

if.then.i39:                                      ; preds = %if.then16
  %call.i40 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @.str.54)
  br label %cleanup
...
if.end17:                                         ; preds = %for.end
  ...
  %5 = load i8, ptr %arrayidx.2.i, align 2
  ...
  %7 = load i8, ptr %arrayidx.4.i, align 4
  ...
  %8 = load i8, ptr %arrayidx.5.i, align 1
  ...
  %9 = load i8, ptr %arrayidx.6.i, align 2
  ...
  %10 = load i8, ptr %arrayidx.7.i, align 1
  ...
  %11 = load i8, ptr %arrayidx.8.i, align 8
  ...
  %12 = load i8, ptr %arrayidx.9.i, align 1
  ...
  %13 = load i8, ptr %arrayidx.10.i, align 2
  ...
  %14 = load i8, ptr %arrayidx.11.i, align 1
  ...
  %15 = load i8, ptr %arrayidx.12.i, align 4
  ...
  %16 = load i8, ptr %arrayidx.13.i, align 1
  ...
  %17 = load i8, ptr %arrayidx.14.i, align 2
  ...
  %18 = load i8, ptr %arrayidx.15.i, align 1
  ...
  call void @llvm.lifetime.end.p0(i64 152, ptr nonnull %ctx.i) #23
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %digest.i) #23
  %call18 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %call.i, ptr noundef nonnull dereferenceable(1) @.str.55, ptr noundef nonnull %mdir.0) #23
...
cleanup:                                          ; preds = %if.then.i39, %if.then16, %if.then.i, %if.then9, %if.end17
  %retval.0 = phi ptr [ %call.i, %if.end17 ], [ null, %if.then9 ], [ null, %if.then.i ], [ null, %if.then16 ], [ null, %if.then.i39 ]
...
while.body21:                                     ; preds = %if.end17, %if.end78
  ...
  %1 = load i64, ptr %call19136, align 8
...
if.end61:                                         ; preds = %if.then56
  %call62 = tail call i32 @cli_rmdirs(ptr noundef nonnull %call.i)
...
if.end78:                                         ; preds = %if.then23, %land.lhs.true26, %if.end76, %while.body21
  ...
  br i1 %tobool20.not, label %while.end, label %while.body21
...
while.end:                                        ; preds = %if.end78, %if.end17
  ...
  br i1 %cmp3.not, label %if.end81, label %while.body
...
do.cond:                                          ; preds = %if.then, %if.end10
  ...
  br i1 %cmp11.not, label %cleanup, label %do.body
...
do.cond.i:                                        ; preds = %if.end14.i, %if.then6.i
  ...
  %current.1.i = phi ptr [ %current.0.i, %if.then6.i ], [ %add.ptr.i, %if.end14.i ]
  %cmp16.not.i = icmp eq i32 %todo.1.i, 0
  br i1 %cmp16.not.i, label %do.body.i26.preheader, label %do.body.i

cli_readn.exit:                                   ; preds = %do.body.i
  %sub.i = sub i32 8192, %todo.0.i
  %cmp1076 = icmp sgt i32 %sub.i, 0
  br i1 %cmp1076, label %do.body.i26.preheader, label %while.end

do.body.i26.preheader:                            ; preds = %do.cond.i, %cli_readn.exit
  %todo.0.i27.ph = phi i32 [ %sub.i, %cli_readn.exit ], [ 8192, %do.cond.i ]
  br label %do.body.i26

do.body.i26:                                      ; preds = %do.body.i26.backedge, %do.body.i26.preheader
  %todo.0.i27 = phi i32 [ %todo.0.i27.ph, %do.body.i26.preheader ], [ %todo.0.i27.be, %do.body.i26.backedge ]
  %current.0.i28 = phi ptr [ %call.i, %do.body.i26.preheader ], [ %current.0.i28.be, %do.body.i26.backedge ]
  %conv.i29 = zext i32 %todo.0.i27 to i64
  %call.i30 = tail call i64 @write(i32 noundef %call1, ptr noundef %current.0.i28, i64 noundef %conv.i29) #23
  %conv2.i31 = trunc i64 %call.i30 to i32
  %cmp.i32 = icmp slt i32 %conv2.i31, 0
  br i1 %cmp.i32, label %if.then.i40, label %if.end10.i

if.then.i40:                                      ; preds = %do.body.i26
  %call4.i = tail call ptr @__errno_location() #26
  %1 = load i32, ptr %call4.i, align 4
  %cmp5.i = icmp eq i32 %1, 4
  br i1 %cmp5.i, label %do.cond.i36, label %if.end.i41

if.end.i41:                                       ; preds = %if.then.i40
  ...
  br label %do.body.i42.preheader

if.end10.i:                                       ; preds = %do.body.i26
  %sub.i33 = sub i32 %todo.0.i27, %conv2.i31
  %idx.ext.i34 = and i64 %call.i30, 4294967295
  %add.ptr.i35 = getelementptr inbounds i8, ptr %current.0.i28, i64 %idx.ext.i34
  br label %do.cond.i36

do.cond.i36:                                      ; preds = %if.end10.i, %if.then.i40
  %todo.1.i37 = phi i32 [ %todo.0.i27, %if.then.i40 ], [ %sub.i33, %if.end10.i ]
  %current.1.i38 = phi ptr [ %current.0.i28, %if.then.i40 ], [ %add.ptr.i35, %if.end10.i ]
  %cmp11.not.i = icmp eq i32 %todo.1.i37, 0
  br i1 %cmp11.not.i, label %do.body.i42.preheader, label %do.body.i26.backedge

do.body.i26.backedge:                             ; preds = %do.cond.i36, %cli_readn.exit67
  %todo.0.i27.be = phi i32 [ %todo.1.i37, %do.cond.i36 ], [ %retval.0.i59, %cli_readn.exit67 ]
  %current.0.i28.be = phi ptr [ %current.1.i38, %do.cond.i36 ], [ %call.i, %cli_readn.exit67 ]
  br label %do.body.i26

do.body.i42.preheader:                            ; preds = %do.cond.i36, %if.end.i41
  br label %do.body.i42

do.body.i42:                                      ; preds = %do.body.i42.preheader, %do.cond.i55
  %todo.0.i43 = phi i32 [ %todo.1.i56, %do.cond.i55 ], [ 8192, %do.body.i42.preheader ]
  %current.0.i44 = phi ptr [ %current.1.i57, %do.cond.i55 ], [ %call.i, %do.body.i42.preheader ]
  %conv.i45 = zext i32 %todo.0.i43 to i64
  %call.i46 = tail call i64 @read(i32 noundef %call, ptr noundef %current.0.i44, i64 noundef %conv.i45) #23
  %conv2.i47 = trunc i64 %call.i46 to i32
  %cmp.i48 = icmp eq i32 %conv2.i47, 0
  br i1 %cmp.i48, label %if.then.i65, label %if.end.i49

if.then.i65:                                      ; preds = %do.body.i42
  %sub.i66 = sub i32 8192, %todo.0.i43
  br label %cli_readn.exit67

if.end.i49:                                       ; preds = %do.body.i42
  %cmp4.i50 = icmp slt i32 %conv2.i47, 0
  br i1 %cmp4.i50, label %if.then6.i60, label %if.end14.i51

if.then6.i60:                                     ; preds = %if.end.i49
  %call7.i61 = tail call ptr @__errno_location() #26
  %2 = load i32, ptr %call7.i61, align 4
  %cmp8.i62 = icmp eq i32 %2, 4
  br i1 %cmp8.i62, label %do.cond.i55, label %while.end.sink.split

if.end14.i51:                                     ; preds = %if.end.i49
  %sub15.i52 = sub i32 %todo.0.i43, %conv2.i47
  %idx.ext.i53 = and i64 %call.i46, 4294967295
  %add.ptr.i54 = getelementptr inbounds i8, ptr %current.0.i44, i64 %idx.ext.i53
  br label %do.cond.i55

do.cond.i55:                                      ; preds = %if.end14.i51, %if.then6.i60
  %todo.1.i56 = phi i32 [ %todo.0.i43, %if.then6.i60 ], [ %sub15.i52, %if.end14.i51 ]
  %current.1.i57 = phi ptr [ %current.0.i44, %if.then6.i60 ], [ %add.ptr.i54, %if.end14.i51 ]
  %cmp16.not.i58 = icmp eq i32 %todo.1.i56, 0
  br i1 %cmp16.not.i58, label %cli_readn.exit67, label %do.body.i42

cli_readn.exit67:                                 ; preds = %do.cond.i55, %if.then.i65
  %retval.0.i59 = phi i32 [ %sub.i66, %if.then.i65 ], [ 8192, %do.cond.i55 ]
  %cmp10 = icmp sgt i32 %retval.0.i59, 0
  br i1 %cmp10, label %do.body.i26.backedge, label %while.end

while.end.sink.split:                             ; preds = %if.then6.i, %if.then6.i60
  %.lcssa92.sink = phi i32 [ %2, %if.then6.i60 ], [ %0, %if.then6.i ]
  %call13.i64 = tail call ptr @strerror(i32 noundef %.lcssa92.sink) #23
  tail call void (ptr, ...) @cli_errmsg(ptr noundef nonnull @.str.64, ptr noundef %call13.i64)
  br label %while.end
...
if.end:                                           ; preds = %entry
  ...
  br i1 %tobool1.not.i6, label %if.then2.i8, label %cli_calloc.exit

if.then2.i8:                                      ; preds = %if.end
  tail call void (ptr, ...) @cli_errmsg(ptr noundef nonnull @.str.39, i64 noundef 1024)
  tail call void @perror(ptr noundef nonnull @.str.40) #24
  br label %cli_calloc.exit

cli_calloc.exit:                                  ; preds = %if.end, %if.then2.i8
  store ptr %call.i5, ptr %call.i, align 8
  br label %cleanup
...
while.cond.i.i:                                   ; preds = %entry, %while.cond.i.i
  ...
  br i1 %cmp.i.i.not, label %nearest_power.exit.i, label %while.cond.i.i
...
bitset_realloc.exit:                              ; preds = %if.end.i.i
  store ptr %call.i.i, ptr %bs, align 8
  ...
  store i64 %n.0.i.i, ptr %length, align 8
  br label %if.end2
