...
do.cond.i:                                        ; preds = %if.end14.i, %if.then6.i
  ...
  %current.1.i = phi ptr [ %current.0.i, %if.then6.i ], [ %add.ptr.i, %if.end14.i ]
  %cmp16.not.i = icmp eq i32 %todo.1.i, 0
  br i1 %cmp16.not.i, label %do.body.i26.preheader, label %do.body.i, !llvm.loop !14
...
do.body.i26.backedge:                             ; preds = %do.cond.i36, %cli_readn.exit67
  ...
  br label %do.body.i26, !llvm.loop !30
...
if.then6.i60:                                     ; preds = %if.end.i49
  ...
  %2 = load i32, ptr %call7.i61, align 4, !tbaa !10
...
do.cond.i55:                                      ; preds = %if.end14.i51, %if.then6.i60
  ...
  br i1 %cmp16.not.i58, label %cli_readn.exit67, label %do.body.i42, !llvm.loop !14
