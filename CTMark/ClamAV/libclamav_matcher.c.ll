; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_matcher.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_matcher.c"
...
if.then12:                                        ; preds = %if.end10
  ...
  %3 = load i32, ptr %ac_partsigs, align 8
...
if.end27:                                         ; preds = %if.end, %if.then20, %if.end10
  ...
  %6 = load i32, ptr %ac_partsigs28, align 8
...
if.end32:                                         ; preds = %if.end27
  ...
  %7 = load i8, ptr %ac_only33, align 2
...
entry:
  ...
  %0 = load ptr, ptr %md5_hlist, align 8
  %1 = load i8, ptr %md5, align 1
...
while.body:                                       ; preds = %entry, %if.end6
  %pt.011 = phi ptr [ %4, %if.end6 ], [ %2, %entry ]
  %md53 = getelementptr inbounds %struct.cli_md5_node, ptr %pt.011, i64 0, i32 1
  %3 = load ptr, ptr %md53, align 8
...
if.end6:                                          ; preds = %while.body
  %next = getelementptr inbounds %struct.cli_md5_node, ptr %pt.011, i64 0, i32 4
  %4 = load ptr, ptr %next, align 8
  %tobool2.not = icmp eq ptr %4, null
  br i1 %tobool2.not, label %cleanup, label %while.body

cleanup:                                          ; preds = %if.end6, %while.body, %entry
  %retval.0 = phi ptr [ null, %entry ], [ null, %if.end6 ], [ %pt.011, %while.body ]
  ret ptr %retval.0
}
...
if.end24:                                         ; preds = %if.then18
  ...
  %call26 = tail call i32 %einfo.0.ph(i32 noundef %fd, ptr noundef nonnull %exeinfo) #13
...
if.else52:                                        ; preds = %if.end42
  ...
  %6 = load i8, ptr %status53, align 8
...
if.then62:                                        ; preds = %lor.lhs.false59, %land.lhs.true
  ...
  %8 = load i32, ptr %exeinfo68, align 8
...
land.lhs.true90:                                  ; preds = %if.then87
  ...
  %10 = load i16, ptr %nsections, align 4
...
if.end103:                                        ; preds = %if.then98
  ...
  %13 = load i16, ptr %nsections, align 4
...
if.end119:                                        ; preds = %if.else114
  ...
  %15 = load i16, ptr %nsections121, align 4
...
if.end141:                                        ; preds = %if.end133, %if.end103
  ...
  %.sink234 = load i32, ptr %val, align 4
  %18 = load i32, ptr %raw138.sink, align 4
...
if.then151:                                       ; preds = %if.then147
  store i32 -1, ptr %ret, align 4
  store i8 -1, ptr %status53, align 8
  br label %cleanup
...
entry:
  ...
  store i32 0, ptr %maxshift, align 4
...
if.end:                                           ; preds = %if.then
  %1 = load i32, ptr %maxshift, align 4
...
if.end20:                                         ; preds = %if.then17
  %5 = load i16, ptr %troot.0, align 8
  br label %if.end38
...
if.then23:                                        ; preds = %if.else
  %6 = load i16, ptr %troot.0, align 8
  %7 = load i16, ptr %groot.0, align 8
  %. = tail call i16 @llvm.umax.i16(i16 %6, i16 %7)
  br label %if.end38

if.else34:                                        ; preds = %if.else
  %8 = load i16, ptr %groot.0, align 8
  br label %if.end38
...
land.lhs.true:                                    ; preds = %if.end42
  ...
  %9 = load i32, ptr %ac_partsigs, align 8
...
if.then49:                                        ; preds = %if.end47
  ...
  %10 = load i32, ptr %ac_partsigs50, align 8
...
land.lhs.true57:                                  ; preds = %if.end55
  ...
  %12 = load ptr, ptr %md5_hlist, align 8
...
if.then71:                                        ; preds = %while.body
  ...
  store i64 %add74, ptr %13, align 8
  br label %if.end75
...
if.then83:                                        ; preds = %if.end75
  %15 = load i8, ptr %ac_only, align 2
...
if.then108:                                       ; preds = %if.end106
  %19 = load i8, ptr %ac_only109, align 2
...
if.end126:                                        ; preds = %if.then125, %if.then123
  ...
  %22 = load ptr, ptr %engine, align 8
...
if.else133:                                       ; preds = %if.end120
  ...
  %24 = load ptr, ptr %md5_hlist147, align 8
...
land.lhs.true176:                                 ; preds = %if.end174
  ...
  %26 = load ptr, ptr %md5_hlist178, align 8
...
if.then199:                                       ; preds = %if.else196
  %32 = load ptr, ptr %call183, align 8
...
if.end:                                           ; preds = %if.then
  %1 = load ptr, ptr %md5_hlist, align 8
...
while.body.i:                                     ; preds = %if.end, %if.end6.i
  %pt.011.i = phi ptr [ %5, %if.end6.i ], [ %3, %if.end ]
  %md53.i = getelementptr inbounds %struct.cli_md5_node, ptr %pt.011.i, i64 0, i32 1
  %4 = load ptr, ptr %md53.i, align 8
...
if.end6.i:                                        ; preds = %while.body.i
  %next.i = getelementptr inbounds %struct.cli_md5_node, ptr %pt.011.i, i64 0, i32 4
  %5 = load ptr, ptr %next.i, align 8
  %tobool2.not.i = icmp eq ptr %5, null
  br i1 %tobool2.not.i, label %if.end15, label %while.body.i

land.lhs.true:                                    ; preds = %while.body.i
  %fp = getelementptr inbounds %struct.cli_md5_node, ptr %pt.011.i, i64 0, i32 3
  %6 = load i16, ptr %fp, align 4
...
if.end10:                                         ; preds = %if.then6
  ...
  %size = getelementptr inbounds %struct.cli_md5_node, ptr %pt.011.i, i64 0, i32 2
  %8 = load i32, ptr %size, align 8
  %cmp.not = icmp eq i32 %8, %conv11
  br i1 %cmp.not, label %if.else, label %cleanup

if.else:                                          ; preds = %if.end10
  %9 = load ptr, ptr %pt.011.i, align 8
