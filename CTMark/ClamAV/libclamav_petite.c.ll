...
land.lhs.true138.lr.ph:                           ; preds = %while.cond131.preheader
  %tobool180.not = icmp eq i32 %mangled.02099.fr, 0
...
land.lhs.true138.us.preheader:                    ; preds = %land.lhs.true138.lr.ph
  ...
  %scevgep2296 = getelementptr i8, ptr %scevgep, i64 %idx.ext127
  %cmp137.not.us = icmp ult ptr %scevgep2296, %buf
...
land.lhs.true162.us2148.preheader:                ; preds = %if.end151.us
  %scevgep2295 = getelementptr i8, ptr %scevgep, i64 %idx.ext153.us
  %cmp161.not.us2165 = icmp ult ptr %scevgep2295, %buf
...
if.end177.us2156:                                 ; preds = %while.body171.us2153
  %cmp178.us = icmp sgt i32 %imports.0.val.us2154, -1
...
land.lhs.true138.lr.ph.split:                     ; preds = %land.lhs.true138.lr.ph
  ...
  %scevgep2297 = getelementptr i8, ptr %buf, i64 %18
  %scevgep2299 = getelementptr i8, ptr %scevgep2297, i64 %idx.ext127
  %cmp137.not = icmp ult ptr %scevgep2299, %buf
...
land.lhs.true162.us.preheader:                    ; preds = %if.end151
  %scevgep2298 = getelementptr i8, ptr %scevgep2297, i64 %idx.ext153
  %cmp161.not.us = icmp ult ptr %scevgep2298, %buf
...
while.cond666:                                    ; preds = %doubledl.exit, %doubledl.exit1747
  ...
  %mydl.2 = phi i8 [ %mydl.0.i1732, %doubledl.exit1747 ], [ %mydl.0.i, %doubledl.exit ]
  ...
  br i1 %tobool.not.i1711, label %if.then.i1717, label %doubledl.exit1728

if.then.i1717:                                    ; preds = %while.cond666
  %cmp.i1718 = icmp uge ptr %ssrc.3, %buf
  %cmp5.not.i1722 = icmp ult ptr %ssrc.3, %add.ptr4.i
  %or.cond.i1723 = select i1 %cmp.i1718, i1 %cmp5.not.i1722, i1 false
  br i1 %or.cond.i1723, label %if.end.i1724, label %if.then671

if.end.i1724:                                     ; preds = %if.then.i1717
  %47 = load i8, ptr %ssrc.3, align 1, !tbaa !22
  %mul9.i1725 = shl i8 %47, 1
  %add.i1726 = or i8 %mul9.i1725, 1
  %add.ptr11.i1727 = getelementptr inbounds i8, ptr %ssrc.3, i64 1
  br label %doubledl.exit1728

doubledl.exit1728:                                ; preds = %while.cond666, %if.end.i1724
  %ssrc.4 = phi ptr [ %add.ptr11.i1727, %if.end.i1724 ], [ %ssrc.3, %while.cond666 ]
  %mydl.0.i1713 = phi i8 [ %add.i1726, %if.end.i1724 ], [ %mul.i1710, %while.cond666 ]
  %olddl.0.i1714 = phi i8 [ %47, %if.end.i1724 ], [ %mydl.2, %while.cond666 ]
  %48 = lshr i8 %olddl.0.i1714, 7
  %shr.i1715 = zext i8 %48 to i32
  %mul673 = shl nsw i32 %backbytes.1, 1
  %add674 = or i32 %mul673, %shr.i1715
  %mul.i1729 = shl i8 %mydl.0.i1713, 1
  %49 = and i8 %mydl.0.i1713, 127
  %tobool.not.i1730 = icmp eq i8 %49, 0
  br i1 %tobool.not.i1730, label %if.then.i1736, label %doubledl.exit1747

if.then671:                                       ; preds = %if.then.i1717
  tail call void @free(ptr noundef %call478) #5
  br label %cleanup1126

if.then.i1736:                                    ; preds = %doubledl.exit1728
  %cmp.i1737 = icmp uge ptr %ssrc.4, %buf
  %cmp5.not.i1741 = icmp ult ptr %ssrc.4, %add.ptr4.i
  %or.cond.i1742 = select i1 %cmp.i1737, i1 %cmp5.not.i1741, i1 false
  br i1 %or.cond.i1742, label %if.end.i1743, label %if.then678

if.end.i1743:                                     ; preds = %if.then.i1736
  %50 = load i8, ptr %ssrc.4, align 1, !tbaa !22
  %mul9.i1744 = shl i8 %50, 1
  %add.i1745 = or i8 %mul9.i1744, 1
  %add.ptr11.i1746 = getelementptr inbounds i8, ptr %ssrc.4, i64 1
  br label %doubledl.exit1747

doubledl.exit1747:                                ; preds = %doubledl.exit1728, %if.end.i1743
  %ssrc.6 = phi ptr [ %add.ptr11.i1746, %if.end.i1743 ], [ %ssrc.4, %doubledl.exit1728 ]
  %mydl.0.i1732 = phi i8 [ %add.i1745, %if.end.i1743 ], [ %mul.i1729, %doubledl.exit1728 ]
  %olddl.0.i1733 = phi i8 [ %50, %if.end.i1743 ], [ %mydl.0.i1713, %doubledl.exit1728 ]
  %cond1952 = icmp sgt i8 %olddl.0.i1733, -1
  br i1 %cond1952, label %while.end683, label %while.cond666

if.then678:                                       ; preds = %if.then.i1736
  tail call void @free(ptr noundef %call478) #5
  br label %cleanup1126
...
do.body:                                          ; preds = %doubledl.exit1766, %if.then687
  ...
  %mydl.5 = phi i8 [ %mydl.0.i1732, %if.then687 ], [ %mydl.0.i1751, %doubledl.exit1766 ]
  ...
  br i1 %tobool.not.i1749, label %if.then.i1755, label %doubledl.exit1766

if.then.i1755:                                    ; preds = %do.body
  %cmp.i1756 = icmp uge ptr %ssrc.8, %buf
  %cmp5.not.i1760 = icmp ult ptr %ssrc.8, %add.ptr4.i
  %or.cond.i1761 = select i1 %cmp.i1756, i1 %cmp5.not.i1760, i1 false
  br i1 %or.cond.i1761, label %if.end.i1762, label %if.then692

if.end.i1762:                                     ; preds = %if.then.i1755
  %52 = load i8, ptr %ssrc.8, align 1, !tbaa !22
  %mul9.i1763 = shl i8 %52, 1
  %add.i1764 = or i8 %mul9.i1763, 1
  %add.ptr11.i1765 = getelementptr inbounds i8, ptr %ssrc.8, i64 1
  br label %doubledl.exit1766

doubledl.exit1766:                                ; preds = %do.body, %if.end.i1762
  %ssrc.9 = phi ptr [ %add.ptr11.i1765, %if.end.i1762 ], [ %ssrc.8, %do.body ]
  %mydl.0.i1751 = phi i8 [ %add.i1764, %if.end.i1762 ], [ %mul.i1748, %do.body ]
  %olddl.0.i1752 = phi i8 [ %52, %if.end.i1762 ], [ %mydl.5, %do.body ]
  %53 = lshr i8 %olddl.0.i1752, 7
  %shr.i1753 = zext i8 %53 to i32
  %mul694 = shl nsw i32 %backbytes.2, 1
  %add695 = or i32 %mul694, %shr.i1753
...
if.then692:                                       ; preds = %if.then.i1755
  tail call void @free(ptr noundef %call478) #5
  br label %cleanup1126
...
if.end708:                                        ; preds = %if.else706, %do.end
  ...
  %mydl.7 = phi i8 [ %mydl.0.i1751, %do.end ], [ %mydl.0.i1732, %if.else706 ]
  ...
  br i1 %tobool.not.i1768, label %if.then.i1774, label %doubledl.exit1785

if.then.i1774:                                    ; preds = %if.end708
  %cmp.i1775 = icmp uge ptr %ssrc.11, %buf
  %cmp5.not.i1779 = icmp ult ptr %ssrc.11, %add.ptr4.i
  %or.cond.i1780 = select i1 %cmp.i1775, i1 %cmp5.not.i1779, i1 false
  br i1 %or.cond.i1780, label %if.end.i1781, label %if.then712

if.end.i1781:                                     ; preds = %if.then.i1774
  %55 = load i8, ptr %ssrc.11, align 1, !tbaa !22
  %mul9.i1782 = shl i8 %55, 1
  %add.i1783 = or i8 %mul9.i1782, 1
  %add.ptr11.i1784 = getelementptr inbounds i8, ptr %ssrc.11, i64 1
  br label %doubledl.exit1785

doubledl.exit1785:                                ; preds = %if.end708, %if.end.i1781
  %ssrc.12 = phi ptr [ %add.ptr11.i1784, %if.end.i1781 ], [ %ssrc.11, %if.end708 ]
  %mydl.0.i1770 = phi i8 [ %add.i1783, %if.end.i1781 ], [ %mul.i1767, %if.end708 ]
  %olddl.0.i1771 = phi i8 [ %55, %if.end.i1781 ], [ %mydl.7, %if.end708 ]
  %mul.i1786 = shl i8 %mydl.0.i1770, 1
  %56 = and i8 %mydl.0.i1770, 127
  %tobool.not.i1787 = icmp eq i8 %56, 0
  br i1 %tobool.not.i1787, label %if.then.i1793, label %doubledl.exit1804

if.then712:                                       ; preds = %if.then.i1774
  tail call void @free(ptr noundef %call478) #5
  br label %cleanup1126

if.then.i1793:                                    ; preds = %doubledl.exit1785
  %cmp.i1794 = icmp uge ptr %ssrc.12, %buf
  %cmp5.not.i1798 = icmp ult ptr %ssrc.12, %add.ptr4.i
  %or.cond.i1799 = select i1 %cmp.i1794, i1 %cmp5.not.i1798, i1 false
  br i1 %or.cond.i1799, label %if.end.i1800, label %if.then719

if.end.i1800:                                     ; preds = %if.then.i1793
  %57 = load i8, ptr %ssrc.12, align 1, !tbaa !22
  %mul9.i1801 = shl i8 %57, 1
  %add.i1802 = or i8 %mul9.i1801, 1
  %add.ptr11.i1803 = getelementptr inbounds i8, ptr %ssrc.12, i64 1
  br label %doubledl.exit1804

doubledl.exit1804:                                ; preds = %doubledl.exit1785, %if.end.i1800
  %ssrc.14 = phi ptr [ %add.ptr11.i1803, %if.end.i1800 ], [ %ssrc.12, %doubledl.exit1785 ]
  %mydl.0.i1789 = phi i8 [ %add.i1802, %if.end.i1800 ], [ %mul.i1786, %doubledl.exit1785 ]
  %olddl.0.i1790 = phi i8 [ %57, %if.end.i1800 ], [ %mydl.0.i1770, %doubledl.exit1785 ]
  %58 = lshr i8 %olddl.0.i1790, 7
  %shr.i1791 = zext i8 %58 to i32
  %59 = shl i32 %backsize.1, 2
  %60 = lshr i8 %olddl.0.i1771, 6
  %61 = and i8 %60, 2
  %62 = zext i8 %61 to i32
  %mul721 = or i32 %59, %62
  %add722 = or i32 %mul721, %shr.i1791
  %tobool723.not = icmp eq i32 %add722, 0
  br i1 %tobool723.not, label %while.cond726, label %if.end745

if.then719:                                       ; preds = %if.then.i1793
  tail call void @free(ptr noundef %call478) #5
  br label %cleanup1126
...
while.cond726:                                    ; preds = %doubledl.exit1804, %doubledl.exit1842
  ...
  %mydl.10 = phi i8 [ %mydl.0.i1827, %doubledl.exit1842 ], [ %mydl.0.i1789, %doubledl.exit1804 ]
  ...
  br i1 %tobool.not.i1806, label %if.then.i1812, label %doubledl.exit1823

if.then.i1812:                                    ; preds = %while.cond726
  %cmp.i1813 = icmp uge ptr %ssrc.16, %buf
  %cmp5.not.i1817 = icmp ult ptr %ssrc.16, %add.ptr4.i
  %or.cond.i1818 = select i1 %cmp.i1813, i1 %cmp5.not.i1817, i1 false
  br i1 %or.cond.i1818, label %if.end.i1819, label %if.then731

if.end.i1819:                                     ; preds = %if.then.i1812
  %64 = load i8, ptr %ssrc.16, align 1, !tbaa !22
  %mul9.i1820 = shl i8 %64, 1
  %add.i1821 = or i8 %mul9.i1820, 1
  %add.ptr11.i1822 = getelementptr inbounds i8, ptr %ssrc.16, i64 1
  br label %doubledl.exit1823

doubledl.exit1823:                                ; preds = %while.cond726, %if.end.i1819
  %ssrc.17 = phi ptr [ %add.ptr11.i1822, %if.end.i1819 ], [ %ssrc.16, %while.cond726 ]
  %mydl.0.i1808 = phi i8 [ %add.i1821, %if.end.i1819 ], [ %mul.i1805, %while.cond726 ]
  %olddl.0.i1809 = phi i8 [ %64, %if.end.i1819 ], [ %mydl.10, %while.cond726 ]
  %65 = lshr i8 %olddl.0.i1809, 7
  %shr.i1810 = zext i8 %65 to i32
  %mul733 = shl nsw i32 %backsize.2, 1
  %add734 = or i32 %mul733, %shr.i1810
  %mul.i1824 = shl i8 %mydl.0.i1808, 1
  %66 = and i8 %mydl.0.i1808, 127
  %tobool.not.i1825 = icmp eq i8 %66, 0
  br i1 %tobool.not.i1825, label %if.then.i1831, label %doubledl.exit1842

if.then731:                                       ; preds = %if.then.i1812
  tail call void @free(ptr noundef %call478) #5
  br label %cleanup1126

if.then.i1831:                                    ; preds = %doubledl.exit1823
  %cmp.i1832 = icmp uge ptr %ssrc.17, %buf
  %cmp5.not.i1836 = icmp ult ptr %ssrc.17, %add.ptr4.i
  %or.cond.i1837 = select i1 %cmp.i1832, i1 %cmp5.not.i1836, i1 false
  br i1 %or.cond.i1837, label %if.end.i1838, label %if.then738

if.end.i1838:                                     ; preds = %if.then.i1831
  %67 = load i8, ptr %ssrc.17, align 1, !tbaa !22
  %mul9.i1839 = shl i8 %67, 1
  %add.i1840 = or i8 %mul9.i1839, 1
  %add.ptr11.i1841 = getelementptr inbounds i8, ptr %ssrc.17, i64 1
  br label %doubledl.exit1842

doubledl.exit1842:                                ; preds = %doubledl.exit1823, %if.end.i1838
  %ssrc.19 = phi ptr [ %add.ptr11.i1841, %if.end.i1838 ], [ %ssrc.17, %doubledl.exit1823 ]
  %mydl.0.i1827 = phi i8 [ %add.i1840, %if.end.i1838 ], [ %mul.i1824, %doubledl.exit1823 ]
  %olddl.0.i1828 = phi i8 [ %67, %if.end.i1838 ], [ %mydl.0.i1808, %doubledl.exit1823 ]
  %cond1953 = icmp sgt i8 %olddl.0.i1828, -1
  br i1 %cond1953, label %while.end743, label %while.cond726

if.then738:                                       ; preds = %if.then.i1831
  tail call void @free(ptr noundef %call478) #5
  br label %cleanup1126
...
if.end745:                                        ; preds = %while.end743, %doubledl.exit1804
  ...
  %mydl.13 = phi i8 [ %mydl.0.i1827, %while.end743 ], [ %mydl.0.i1789, %doubledl.exit1804 ]
...
if.then999:                                       ; preds = %land.lhs.true973
  ...
  %90 = xor i32 %add.ptr1017.val, %add.ptr970.val
  %cmp1025 = icmp eq i32 %90, 1953408297
