...
entry:
  ...
  %0 = load i32, ptr %list_inited, align 8
...
if.then24:                                        ; preds = %if.then20
  ...
  store i8 47, ptr %arrayidx25, align 1
  br label %if.end28
...
for.cond.preheader:                               ; preds = %if.then30
  ...
  %1 = load i64, ptr %root_hosts_cnt, align 8
...
cond.end47:                                       ; preds = %if.then40, %cond.true43
  ...
  %call50 = call fastcc i64 @get_char_at_pos_with_skip(ptr noundef %pre_fixup, ptr noundef nonnull %call9, i64 noundef %add8)
...
land.lhs.true73:                                  ; preds = %lor.lhs.false70
  ...
  %call75 = call fastcc i64 @get_char_at_pos_with_skip(ptr noundef %pre_fixup, ptr noundef nonnull %call9, i64 noundef %sub74)
...
if.then88:                                        ; preds = %if.then84
  ...
  store i8 46, ptr %arrayidx91, align 1
...
for.inc:                                          ; preds = %cleanup, %for.body
  ...
  %7 = load i64, ptr %root_hosts_cnt, align 8
  %cmp = icmp ult i64 %inc, %7
  br i1 %cmp, label %for.body, label %if.then100
...
if.then100:                                       ; preds = %for.inc, %for.cond.preheader, %if.end28
  ...
  %cond105 = load ptr, ptr %cond105.in, align 8
...
sw.bb12.i:                                        ; preds = %for.cond.i
  ...
  %18 = load i8, ptr %c.addr.0.i, align 1
...
sw.bb23.i:                                        ; preds = %for.cond.i
  ...
  %20 = load ptr, ptr %preg.i, align 8
...
if.then40.i:                                      ; preds = %sw.epilog.i
  %22 = load i8, ptr %alternatives.i, align 8
...
while.body.lr.ph.i:                               ; preds = %if.then40.i
  ...
  %23 = load i8, ptr %incdec.ptr38.i, align 1
...
while.body.i:                                     ; preds = %if.else53.i, %while.body.lr.ph.i
  ...
  %24 = load ptr, ptr %arrayidx46.i, align 8
  %c47.i = getelementptr inbounds %struct.tree_node, ptr %24, i64 0, i32 1
  %25 = load i8, ptr %c47.i, align 8
...
if.else53.i:                                      ; preds = %while.body.i
  ...
  br i1 %cmp42.not.i, label %if.else72.i, label %while.body.i
...
if.then75.i:                                      ; preds = %if.else72.i
  %26 = load ptr, ptr %children.0.i, align 8
  %listend.i = getelementptr inbounds %struct.tree_node, ptr %26, i64 0, i32 4
  %27 = load i8, ptr %listend.i, align 1
...
land.rhs.i:                                       ; preds = %while.body88.i, %land.rhs.preheader.i
  ...
  %28 = load i8, ptr %listend85.i, align 1
  %tobool87.not.i = icmp eq i8 %28, 0
  %29 = load ptr, ptr %node.addr.2263.i, align 8
...
while.body88.i:                                   ; preds = %land.rhs.i
  ...
  br i1 %tobool84.not.i, label %cleanup115.sink.split, label %land.rhs.i
...
land.rhs125.i:                                    ; preds = %land.rhs125.i.preheader, %while.body130.i
  ...
  %31 = load i8, ptr %listend126.i, align 1
  %tobool128.not.i = icmp eq i8 %31, 0
  %32 = load ptr, ptr %node.addr.5267.i, align 8
...
while.body130.i:                                  ; preds = %land.rhs125.i
  ...
  br i1 %tobool124.not.i, label %cleanup115.sink.split, label %land.rhs125.i
...
if.end:                                           ; preds = %entry
  ...
  %3 = load i64, ptr %host_start, align 8
  %add = add i64 %3, %pos
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %tobool10.not, label %while.end.thread, label %land.rhs
...
while.cond24:                                     ; preds = %while.cond24, %while.cond24.preheader
  ...
  br i1 %cmp27, label %while.cond24, label %while.end31
...
while.end31:                                      ; preds = %while.cond24
  ...
  br i1 %11, label %while.cond24.preheader, label %while.cond33.preheader
...
while.cond33:                                     ; preds = %while.cond33, %while.cond33.preheader
  ...
  br i1 %cmp36, label %while.cond33, label %while.end40
...
land.lhs.true:                                    ; preds = %while.end40
  %13 = load i8, ptr %arrayidx34.le, align 1
...
entry:
  %list_inited = getelementptr inbounds %struct.regex_matcher, ptr %matcher, i64 0, i32 4
  store i32 0, ptr %list_inited, align 8
  %root_hosts_cnt = getelementptr inbounds %struct.regex_matcher, ptr %matcher, i64 0, i32 3
  store ptr null, ptr %matcher, align 8
  store i64 0, ptr %root_hosts_cnt, align 8
...
if.then6:                                         ; preds = %if.end
  ...
  store ptr null, ptr %root_regex_hostonly59, align 8
  %0 = load ptr, ptr %root_regex, align 8
  tail call void @free(ptr noundef %0) #17
  br label %cleanup

if.end8:                                          ; preds = %if.end
  %alternatives.i.i45 = getelementptr inbounds %struct.tree_node, ptr %call.i.i42, i64 0, i32 3
  store i8 0, ptr %alternatives.i.i45, align 8
...
if.end10:                                         ; preds = %if.then5, %if.end2
  %call11300 = call ptr @fgets(ptr noundef nonnull %buffer, i32 noundef 8192, ptr noundef nonnull %fd)
  %tobool12.not301 = icmp eq ptr %call11300, null
  br i1 %tobool12.not301, label %while.end, label %while.body.lr.ph
...
for.body.lr.ph.i:                                 ; preds = %if.else.i
  ...
  %4 = load ptr, ptr %call6.i, align 8
...
for.cond.i:                                       ; preds = %for.body.i
  ...
  br i1 %exitcond.not.i, label %for.cond12.preheader.i, label %for.body.i
...
for.body16.lr.ph.i:                               ; preds = %for.cond12.preheader.i
  ...
  %7 = load ptr, ptr %call17.i, align 8
...
for.body.i:                                       ; preds = %for.cond.i, %for.body.lr.ph.i
  ...
  %8 = load i8, ptr %add.ptr85.i, align 1
...
for.cond12.i:                                     ; preds = %for.body16.i
  ...
  br i1 %exitcond91.not.i, label %for.end29.i, label %for.body16.i
...
for.body16.i:                                     ; preds = %for.cond12.i, %for.body16.lr.ph.i
  ...
  %12 = load i16, ptr %arrayidx21.i, align 2
  %13 = and i16 %12, 2048
...
if.end47.i:                                       ; preds = %if.end40.i
  ...
  br i1 %cmp50.i, label %cleanup121, label %if.end53.i
...
if.then28.i.i:                                    ; preds = %land.lhs.true23.i.i
  store ptr %pat.addr.0.i.i, ptr %arrayidx.i.i, align 8
...
if.else.i.i:                                      ; preds = %land.lhs.true23.i.i, %if.then21.i.i
  ...
  store ptr %pat.addr.0.i.i, ptr %arrayidx31.i.i, align 8
...
if.then50.i.i:                                    ; preds = %if.else48.i.i
  %22 = load ptr, ptr %altpositions.0.i.i, align 8
  br label %do.cond.i.i
...
do.cond.i.i:                                      ; preds = %if.then50.i.i, %if.else48.i.i, %if.else41.i.i, %if.then34.i.i, %if.else.i.i, %if.then28.i.i
  ...
  %23 = load i8, ptr %call1.i.i, align 1
...
find_regex_start.exit.i:                          ; preds = %if.then34.i.i, %do.end.i.i, %if.then53
  ...
  store i64 0, ptr %cnt.i.i, align 8
  store i64 0, ptr %cnt.i186.i, align 8
  %27 = load i64, ptr %capacity.i.i, align 8
  %cmp.i.i = icmp eq i64 %27, 0
  %.pre.i.i = load ptr, ptr %node_stack.i, align 8
  br i1 %cmp.i.i, label %if.then.i.i, label %if.end6.i.i

if.then.i.i:                                      ; preds = %find_regex_start.exit.i
  store i64 4096, ptr %capacity.i.i, align 8
  %call.i193.i = call ptr @cli_realloc2(ptr noundef %.pre.i.i, i64 noundef 32768) #17
  store ptr %call.i193.i, ptr %node_stack.i, align 8
...
if.then.if.end6_crit_edge.i.i:                    ; preds = %if.then.i.i
  %.pre17.i.i = load i64, ptr %cnt.i.i, align 8
...
if.end6.i.i:                                      ; preds = %if.then.if.end6_crit_edge.i.i, %find_regex_start.exit.i
  ...
  store i64 %inc.i188.i, ptr %cnt.i.i, align 8
  %arrayidx.i189.i = getelementptr inbounds ptr, ptr %29, i64 %28
  store ptr %cond.i, ptr %arrayidx.i189.i, align 8
...
stack_push.exit.i:                                ; preds = %if.end6.i.i, %if.then.i.i
  ...
  %30 = load i32, ptr %op398.i, align 4
...
if.end9.i:                                        ; preds = %for.body.i199
  ...
  %.pre.i = load i8, ptr %type.i, align 8
...
tree_node_get_children.exit.i.i:                  ; preds = %cond.true.i.i.i, %sw.bb.i
  ...
  %36 = load i8, ptr %alternatives.i.i, align 8
...
while.body.i.i:                                   ; preds = %if.else.i198.i, %while.body.lr.ph.i.i
  ...
  %38 = load ptr, ptr %arrayidx.i197.i, align 8
  %c.i.i = getelementptr inbounds %struct.tree_node, ptr %38, i64 0, i32 1
  %39 = load i8, ptr %c.i.i, align 8
...
land.lhs.true2.i.i.i:                             ; preds = %tree_node_get_children.exit.i.i.i
  %42 = load ptr, ptr %cond6.i.i.i.i, align 8
...
if.else8.i.i.i:                                   ; preds = %if.else.i.i.i
  %43 = load ptr, ptr %cond6.i.i.i.i, align 8
...
tree_get_next.exit.i.i:                           ; preds = %if.else8.i.i.i, %if.else.i.i.i, %land.lhs.true2.i.i.i
  ...
  store i8 %inc.i201.i, ptr %alternatives.i.i, align 8
  ...
  store ptr %call2.i.i, ptr %u.i.i.i, align 8
...
if.end.i.i:                                       ; preds = %tree_get_next.exit.i.i
  %45 = load i32, ptr %op402.i, align 4
...
if.then.if.end6_crit_edge.i230.i:                 ; preds = %if.then.i225.i
  %.pre17.i231.i = load i64, ptr %cnt.i186.i, align 8
...
if.then.if.end6_crit_edge.i246.i:                 ; preds = %if.then.i241.i
  %.pre17.i247.i = load i64, ptr %cnt.i.i, align 8
...
if.end6.i237.i:                                   ; preds = %if.then.if.end6_crit_edge.i246.i, %stack_push.exit232.i
  ...
  store i64 %inc.i238.i, ptr %cnt.i.i, align 8
  %arrayidx.i239.i = getelementptr inbounds ptr, ptr %55, i64 %54
  store ptr %node.0400.i, ptr %arrayidx.i239.i, align 8
  br label %sw.epilog.i
...
if.then.i251.i:                                   ; preds = %sw.bb24.i
  ...
  store i8 0, ptr %alternatives.i252.i, align 8
  store ptr null, ptr %call.i249.i, align 8
...
tree_node_alloc.exit.i:                           ; preds = %if.then.i251.i, %sw.bb24.i
  ...
  store i32 6, ptr %op26.i, align 4
...
stack_pop.exit.i:                                 ; preds = %tree_node_alloc.exit.i, %tree_node_insert_nonbin.exit.i
  ...
  %58 = load ptr, ptr %node_stack_alt.i, align 8
  %dec.i256.i = add i64 %57, -1
  store i64 %dec.i256.i, ptr %cnt.i186.i, align 8
  %arrayidx.i257.i = getelementptr inbounds ptr, ptr %58, i64 %dec.i256.i
  %59 = load ptr, ptr %arrayidx.i257.i, align 8
...
cond.true.i.i270.i:                               ; preds = %while.body.i
  ...
  %62 = load ptr, ptr %arrayidx.i.i271.i, align 8
...
tree_node_get_children.exit.i262.i:               ; preds = %cond.true.i.i270.i, %while.body.i
  ...
  %63 = load i8, ptr %alternatives.i264.i, align 8
...
if.then.i266.i:                                   ; preds = %tree_node_get_children.exit.i262.i
  %64 = load ptr, ptr %cond6.i.i263.i, align 8
...
for.body.preheader.i.i:                           ; preds = %if.then1.i.i
  ...
  %xtraiter442 = and i64 %conv.i268.i, 3
  %66 = icmp ult i8 %63, 4
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.preheader.i.i.new
  ...
  %67 = load ptr, ptr %arrayidx5.i.i, align 8
  store ptr %call.i249.i, ptr %67, align 8
  %68 = load ptr, ptr %arrayidx5.i.i, align 8
  %listend9.i.i = getelementptr inbounds %struct.tree_node, ptr %68, i64 0, i32 4
  store i8 0, ptr %listend9.i.i, align 1
  ...
  %69 = load ptr, ptr %arrayidx5.i.i.1, align 8
  store ptr %call.i249.i, ptr %69, align 8
  %70 = load ptr, ptr %arrayidx5.i.i.1, align 8
  %listend9.i.i.1 = getelementptr inbounds %struct.tree_node, ptr %70, i64 0, i32 4
  store i8 0, ptr %listend9.i.i.1, align 1
  ...
  %71 = load ptr, ptr %arrayidx5.i.i.2, align 8
  store ptr %call.i249.i, ptr %71, align 8
  %72 = load ptr, ptr %arrayidx5.i.i.2, align 8
  %listend9.i.i.2 = getelementptr inbounds %struct.tree_node, ptr %72, i64 0, i32 4
  store i8 0, ptr %listend9.i.i.2, align 1
  ...
  %73 = load ptr, ptr %arrayidx5.i.i.3, align 8
  store ptr %call.i249.i, ptr %73, align 8
  %74 = load ptr, ptr %arrayidx5.i.i.3, align 8
  %listend9.i.i.3 = getelementptr inbounds %struct.tree_node, ptr %74, i64 0, i32 4
  store i8 0, ptr %listend9.i.i.3, align 1
  %indvars.iv.next.i.i.3 = add nuw nsw i64 %indvars.iv.i.i, 4
  %niter.next.3 = add i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %tree_node_insert_nonbin.exit.i.loopexit.unr-lcssa, label %for.body.i.i

for.cond12.i.i:                                   ; preds = %if.then.i266.i, %for.cond12.i.i
  %p.0.i.i = phi ptr [ %75, %for.cond12.i.i ], [ %65, %if.then.i266.i ]
  %75 = load ptr, ptr %p.0.i.i, align 8
  %cmp14.not.i.i = icmp eq ptr %75, %59
  br i1 %cmp14.not.i.i, label %for.end19.i.i, label %for.cond12.i.i

for.end19.i.i:                                    ; preds = %for.cond12.i.i
  store i8 1, ptr %listend.i, align 1
  %listend21.i.i = getelementptr inbounds %struct.tree_node, ptr %p.0.i.i, i64 0, i32 4
  store i8 0, ptr %listend21.i.i, align 1
  store ptr %call.i249.i, ptr %p.0.i.i, align 8
...
if.then27.i.i:                                    ; preds = %if.else23.i.i
  ...
  %76 = load ptr, ptr %arrayidx30.i269.i, align 8
...
while.cond.i.i:                                   ; preds = %if.then27.i.i, %land.rhs.i.i
  ...
  %77 = load ptr, ptr %node.addr.0.i.i, align 8
...
land.rhs.i.i:                                     ; preds = %while.cond.i.i
  ...
  %78 = load i8, ptr %listend38.i.i, align 1
  %tobool39.not.i.i = icmp eq i8 %78, 0
  br i1 %tobool39.not.i.i, label %while.cond.i.i, label %while.end.i.i
...
while.end.i.i:                                    ; preds = %land.rhs.i.i, %while.cond.i.i
  ...
  store i8 0, ptr %listend41.i.i, align 1
  store ptr %77, ptr %call.i249.i, align 8
  store ptr %call.i249.i, ptr %node.addr.0.i.i, align 8
  store i8 1, ptr %listend.i, align 1
  br label %tree_node_insert_nonbin.exit.i

if.end47.i.i:                                     ; preds = %if.then27.i.i, %if.else23.i.i
  %call49.i.i = call ptr @cli_realloc2(ptr noundef %61, i64 noundef 16) #17
  store ptr %call49.i.i, ptr %u.i.i261.i, align 8
...
if.then53.i.i:                                    ; preds = %if.end47.i.i
  ...
  store ptr %call.i249.i, ptr %arrayidx56.i.i, align 8
  br label %tree_node_insert_nonbin.exit.i
...
tree_node_insert_nonbin.exit.i.loopexit.unr-lcssa: ; preds = %for.body.i.i, %for.body.preheader.i.i
  ...
  br i1 %lcmp.mod443.not, label %tree_node_insert_nonbin.exit.i, label %for.body.i.i.epil
...
for.body.i.i.epil:                                ; preds = %tree_node_insert_nonbin.exit.i.loopexit.unr-lcssa, %for.body.i.i.epil
  ...
  %79 = load ptr, ptr %arrayidx5.i.i.epil, align 8
  store ptr %call.i249.i, ptr %79, align 8
  %80 = load ptr, ptr %arrayidx5.i.i.epil, align 8
  %listend9.i.i.epil = getelementptr inbounds %struct.tree_node, ptr %80, i64 0, i32 4
  store i8 0, ptr %listend9.i.i.epil, align 1
  %indvars.iv.next.i.i.epil = add nuw nsw i64 %indvars.iv.i.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter442
  br i1 %epil.iter.cmp.not, label %tree_node_insert_nonbin.exit.i, label %for.body.i.i.epil
...
tree_node_insert_nonbin.exit.i:                   ; preds = %tree_node_insert_nonbin.exit.i.loopexit.unr-lcssa, %for.body.i.i.epil, %if.then53.i.i, %if.end47.i.i, %while.end.i.i, %for.end19.i.i, %if.then1.i.i
  %81 = load i64, ptr %cnt.i186.i, align 8
  %tobool.not.i255.i = icmp eq i64 %81, 0
  br i1 %tobool.not.i255.i, label %while.end.i, label %stack_pop.exit.i

while.end.i:                                      ; preds = %tree_node_insert_nonbin.exit.i, %stack_pop.exit.i, %tree_node_alloc.exit.i
  %82 = load i64, ptr %cnt.i.i, align 8
...
if.then.if.end6_crit_edge.i294.i:                 ; preds = %if.then.i289.i
  %.pre17.i295.i = load i64, ptr %cnt.i186.i, align 8
...
cond.true.i299.i:                                 ; preds = %stack_push.exit296.i
  ...
  store i64 %dec.i300.i, ptr %cnt.i.i, align 8
  %arrayidx.i301.i = getelementptr inbounds ptr, ptr %.pre.i307.pre.i, i64 %dec.i300.i
  %88 = load ptr, ptr %arrayidx.i301.i, align 8
...
stack_pop.exit303.i:                              ; preds = %cond.true.i299.i, %stack_push.exit296.i
  ...
  %90 = load i64, ptr %capacity.i.i, align 8
...
if.then.if.end6_crit_edge.i317.i:                 ; preds = %if.then.i312.i
  %.pre17.i318.i = load i64, ptr %cnt.i.i, align 8
...
cond.true.i.i332.i:                               ; preds = %sw.bb39.i
  ...
  %95 = load ptr, ptr %arrayidx.i.i333.i, align 8
...
tree_node_get_children.exit.i323.i:               ; preds = %cond.true.i.i332.i, %sw.bb39.i
  ...
  %96 = load i8, ptr %alternatives.i325.i, align 8
...
land.lhs.true2.i.i:                               ; preds = %tree_node_get_children.exit.i323.i
  %97 = load ptr, ptr %cond6.i.i324.i, align 8
...
if.else8.i.i:                                     ; preds = %if.else.i327.i
  %98 = load ptr, ptr %cond6.i.i324.i, align 8
...
if.end54.i:                                       ; preds = %if.then47.i
  store ptr %100, ptr %call49.i, align 8
  %101 = load ptr, ptr %u50.i, align 8
  %arrayidx58.i = getelementptr inbounds ptr, ptr %101, i64 1
  store ptr null, ptr %arrayidx58.i, align 8
...
if.else59.i:                                      ; preds = %for.inc.10.i.i, %for.inc.9.i.i, %for.inc.8.i.i, %for.inc.7.i.i, %for.inc.6.i.i, %for.inc.5.i.i, %for.inc.4.i.i, %for.inc.3.i.i, %for.inc.2.i.i, %for.inc.1.i.i, %for.inc.i.i, %tree_node_alloc.exit343.i
  ...
  store i32 1, ptr %op60.i, align 4
  %c61.i = getelementptr inbounds %struct.tree_node, ptr %call.i336.i, i64 0, i32 1
  store i8 %retval.0.i347.ph.i, ptr %c61.i, align 8
...
cond.true.i.i365.i:                               ; preds = %sw.bb64.i
  ...
  %104 = load ptr, ptr %arrayidx.i.i366.i, align 8
...
tree_node_get_children.exit.i351.i:               ; preds = %cond.true.i.i365.i, %sw.bb64.i
  ...
  %105 = load i8, ptr %alternatives.i353.i, align 8
...
land.lhs.true2.i362.i:                            ; preds = %tree_node_get_children.exit.i351.i
  %106 = load ptr, ptr %cond6.i.i352.i, align 8
...
if.else8.i359.i:                                  ; preds = %if.else.i357.i
  %107 = load ptr, ptr %cond6.i.i352.i, align 8
...
if.then.i372.i:                                   ; preds = %tree_get_next.exit369.i
  ...
  store i8 0, ptr %alternatives.i373.i, align 8
  store ptr %retval.0.i361.i, ptr %call.i370.i, align 8
  %listend2.i374.i = getelementptr inbounds %struct.tree_node, ptr %call.i370.i, i64 0, i32 4
  store i8 1, ptr %listend2.i374.i, align 1
  %u.i375.i = getelementptr inbounds %struct.tree_node, ptr %call.i370.i, i64 0, i32 5
  store ptr null, ptr %u.i375.i, align 8
...
tree_node_alloc.exit377.i:                        ; preds = %if.then.i372.i, %tree_get_next.exit369.i
  ...
  store i32 3, ptr %op68.i, align 4
...
if.end74.i:                                       ; preds = %sw.bb70.i
  ...
  store ptr %call75.i, ptr %call71.i, align 8
...
if.end86.i:                                       ; preds = %if.then81.i
  %110 = load ptr, ptr %token.i, align 8
  ...
  store ptr %call83.i, ptr %preg91.i, align 8
...
sw.epilog.i:                                      ; preds = %while.body.i.i, %tree_node_alloc.exit377.i, %if.else59.i, %if.end54.i, %if.end6.i308.i, %if.then.i312.i, %cond.true.i276.i, %while.end.i, %if.end6.i237.i, %if.then.i241.i, %if.end28.i.i, %tree_get_next.exit.i.i, %if.end9.i
  ...
  %111 = load i32, ptr %op.i, align 4
  %cmp.not.i = icmp eq i32 %111, 4
  br i1 %cmp.not.i, label %add_pattern.exit, label %for.body.i199
...
if.end90:                                         ; preds = %if.then80
  ...
  %118 = load i8, ptr @cli_ac_mindepth, align 1
  %119 = load i8, ptr @cli_ac_maxdepth, align 1
...
cleanup99:                                        ; preds = %if.end90
  store i32 0, ptr %list_built, align 8
  br label %if.end107
...
if.end.i205:                                      ; preds = %if.end107
  ...
  store i8 0, ptr %target.i, align 8
  ...
  store i16 %conv.i208, ptr %length.i, align 8
  %120 = trunc i64 %call1.i206 to i32
  %conv3.i = and i32 %120, 65535
  %121 = load i16, ptr %root.2, align 8
...
if.then6.i213:                                    ; preds = %if.end.i205
  store i16 %conv.i208, ptr %root.2, align 8
...
if.end9.i209:                                     ; preds = %if.then6.i213, %if.end.i205
  ...
  store ptr %call10.i, ptr %call.i203, align 8
...
for.body.i210.preheader:                          ; preds = %for.cond.preheader.i
  ...
  br i1 %min.iters.check, label %for.body.i210.preheader406, label %vector.memcheck

vector.memcheck:                                  ; preds = %for.body.i210.preheader
  %122 = shl i64 %call1.i206, 1
  %scevgep = getelementptr i8, ptr %call10.i, i64 %122
  %scevgep403 = getelementptr i8, ptr %call25, i64 1
  %scevgep404 = getelementptr i8, ptr %scevgep403, i64 %call1.i206
  %bound0 = icmp ult ptr %call10.i, %scevgep404
  %bound1 = icmp ult ptr %incdec.ptr, %scevgep
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %for.body.i210.preheader406, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <8 x i8>, ptr %123, align 1
  %124 = getelementptr inbounds i8, ptr %123, i64 8
  %wide.load405 = load <8 x i8>, ptr %124, align 1
  %125 = sext <8 x i8> %wide.load to <8 x i16>
  %126 = sext <8 x i8> %wide.load405 to <8 x i16>
  %127 = getelementptr inbounds i16, ptr %call10.i, i64 %index
  store <8 x i16> %125, ptr %127, align 2
  %128 = getelementptr inbounds i16, ptr %127, i64 8
  store <8 x i16> %126, ptr %128, align 2
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.end.i, label %for.body.i210.preheader406

for.body.i210.preheader406:                       ; preds = %vector.memcheck, %for.body.i210.preheader, %middle.block
...
for.body.i210.prol:                               ; preds = %for.body.i210.preheader406, %for.body.i210.prol
  %i.060.i.prol = phi i64 [ %inc.i211.prol, %for.body.i210.prol ], [ %i.060.i.ph, %for.body.i210.preheader406 ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body.i210.prol ], [ 0, %for.body.i210.preheader406 ]
  %arrayidx.i.prol = getelementptr inbounds i8, ptr %incdec.ptr, i64 %i.060.i.prol
  %132 = load i8, ptr %arrayidx.i.prol, align 1
  %conv18.i.prol = sext i8 %132 to i16
  %arrayidx20.i.prol = getelementptr inbounds i16, ptr %call10.i, i64 %i.060.i.prol
  store i16 %conv18.i.prol, ptr %arrayidx20.i.prol, align 2
  %inc.i211.prol = add nuw i64 %i.060.i.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body.i210.prol.loopexit, label %for.body.i210.prol

for.body.i210.prol.loopexit:                      ; preds = %for.body.i210.prol, %for.body.i210.preheader406
  %i.060.i.unr = phi i64 [ %i.060.i.ph, %for.body.i210.preheader406 ], [ %inc.i211.prol, %for.body.i210.prol ]
...
for.end.i:                                        ; preds = %for.body.i210.prol.loopexit, %for.body.i210, %middle.block, %for.cond.preheader.i
  ...
  store ptr %call21.i, ptr %virname.i, align 8
...
if.then110:                                       ; preds = %for.end.i
  ...
  %138 = load ptr, ptr %virname.i.le, align 8
  call void @free(ptr noundef %138) #17
  %139 = load ptr, ptr %call.i203, align 8
...
cleanup121:                                       ; preds = %for.end.i, %add_pattern.exit, %if.end47.i, %if.then45.i, %while.body
  %line.1 = phi i32 [ %line.0302, %while.body ], [ %inc, %add_pattern.exit ], [ %line.0302, %if.then45.i ], [ %line.0302, %if.end47.i ], [ %inc, %for.end.i ]
...
while.end:                                        ; preds = %cleanup121, %if.end10
  %list_loaded = getelementptr inbounds %struct.regex_matcher, ptr %matcher, i64 0, i32 5
  store i32 1, ptr %list_loaded, align 4
  %140 = load i32, ptr %list_inited, align 8
...
if.end.i216:                                      ; preds = %while.end
  ...
  %141 = load ptr, ptr %matcher, align 8
...
if.then3.i:                                       ; preds = %if.end.i216
  ...
  %142 = load i64, ptr %root_hosts_cnt.i, align 8
  %sub.i = add i64 %142, -1
...
stack_destroy.exit.i:                             ; preds = %if.then.i.i225, %if.end128
  ...
  %144 = load ptr, ptr %node_stack_alt.i226, align 8
...
entry:
  %node_stack = getelementptr inbounds %struct.regex_matcher, ptr %matcher, i64 0, i32 7
  %0 = load ptr, ptr %node_stack, align 8
...
stack_destroy.exit:                               ; preds = %entry, %if.then.i
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %node_stack, i8 0, i64 16, i1 false)
  %node_stack_alt = getelementptr inbounds %struct.regex_matcher, ptr %matcher, i64 0, i32 8
  %1 = load ptr, ptr %node_stack_alt, align 8
...
entry:
  %node_stack.i = getelementptr inbounds %struct.regex_matcher, ptr %matcher, i64 0, i32 7
  %0 = load ptr, ptr %node_stack.i, align 8
...
stack_destroy.exit.i:                             ; preds = %if.then.i.i, %entry
  ...
  %node_stack_alt.i = getelementptr inbounds %struct.regex_matcher, ptr %matcher, i64 0, i32 8
  %1 = load ptr, ptr %node_stack_alt.i, align 8
...
regex_list_cleanup.exit:                          ; preds = %stack_destroy.exit.i, %if.then.i8.i
  ...
  store i64 1024, ptr %capacity.i.i, align 8
  %call.i.i = tail call ptr @cli_malloc(i64 noundef 8192) #17
  store ptr %call.i.i, ptr %node_stack.i, align 8
  %cnt.i11.i = getelementptr inbounds %struct.regex_matcher, ptr %matcher, i64 0, i32 8, i32 2
  store i64 0, ptr %cnt.i11.i, align 8
  %capacity.i12.i = getelementptr inbounds %struct.regex_matcher, ptr %matcher, i64 0, i32 8, i32 1
  store i64 1024, ptr %capacity.i12.i, align 8
  %call.i13.i = tail call ptr @cli_malloc(i64 noundef 8192) #17
  store ptr %call.i13.i, ptr %node_stack_alt.i, align 8
  %list_loaded = getelementptr inbounds %struct.regex_matcher, ptr %matcher, i64 0, i32 5
  %2 = load i32, ptr %list_loaded, align 4
...
for.cond.preheader:                               ; preds = %if.then
  %root_hosts_cnt = getelementptr inbounds %struct.regex_matcher, ptr %matcher, i64 0, i32 3
  %4 = load i64, ptr %root_hosts_cnt, align 8
...
for.body:                                         ; preds = %for.cond.preheader, %for.body
  ...
  %6 = load i64, ptr %root_hosts_cnt, align 8
  %cmp = icmp ult i64 %inc, %6
  br i1 %cmp, label %for.body, label %for.end.loopexit

for.end.loopexit:                                 ; preds = %for.body
  %.pre = load ptr, ptr %matcher, align 8
  br label %for.end
...
stack_pop.exit.i:                                 ; preds = %if.end, %if.end.i
  ...
  %12 = load ptr, ptr %node_stack.i, align 8
  %dec.i.i = add i64 %11, -1
  store i64 %dec.i.i, ptr %cnt.i.i, align 8
...
if.then.i:                                        ; preds = %stack_pop.exit.i
  ...
  %.pre.i = load i64, ptr %cnt.i.i, align 8
  br label %if.end.i
...
if.end.i:                                         ; preds = %if.then.i, %stack_pop.exit.i
  ...
  br i1 %tobool.not.i, label %destroy_tree.exit, label %stack_pop.exit.i
...
if.end8:                                          ; preds = %destroy_tree.exit, %regex_list_cleanup.exit
  %list_inited = getelementptr inbounds %struct.regex_matcher, ptr %matcher, i64 0, i32 4
  %15 = load i32, ptr %list_inited, align 8
...
if.end12:                                         ; preds = %if.then10, %if.end8
  %16 = load ptr, ptr %node_stack.i, align 8
...
stack_destroy.exit:                               ; preds = %if.end12, %if.then.i32
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %node_stack.i, i8 0, i64 16, i1 false)
  %17 = load ptr, ptr %node_stack_alt.i, align 8
...
if.end29:                                         ; preds = %if.else28, %if.then26
  ...
  %.pr = load i8, ptr %pat.addr.0, align 1
  br label %do.body
...
if.then34:                                        ; preds = %do.body
  ...
  %8 = load i8, ptr %incdec.ptr36, align 1
...
for.body.prol:                                    ; preds = %for.body.preheader
  ...
  %15 = load i8, ptr %arrayidx75.prol, align 1
  %16 = trunc i32 %shl.prol to i8
  %conv77.prol = xor i8 %15, %16
  store i8 %conv77.prol, ptr %arrayidx75.prol, align 1
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  ...
  %21 = load i8, ptr %arrayidx75.1, align 1
  %22 = trunc i32 %shl.1 to i8
  %conv77.1 = xor i8 %21, %22
  store i8 %conv77.1, ptr %arrayidx75.1, align 1
  %exitcond273.not.1 = icmp eq i32 %c35.0.1, %conv70
  br i1 %exitcond273.not.1, label %do.condthread-pre-split, label %for.body
...
if.then123:                                       ; preds = %for.body117
  ...
  %26 = load i8, ptr %arrayidx127, align 1
  %xor129 = xor i8 %26, %shl125
  store i8 %xor129, ptr %arrayidx127, align 1
  br label %for.inc132

for.inc132:                                       ; preds = %for.body117, %if.then123
  %inc133 = add nuw nsw i64 %i.1268, 1
  %exitcond.not = icmp eq i64 %inc133, 256
  br i1 %exitcond.not, label %do.condthread-pre-split, label %for.body117
...
if.else144:                                       ; preds = %land.lhs.true84, %if.else79
  ...
  %28 = load i8, ptr %arrayidx151, align 1
  %xor153 = xor i8 %28, %shl147
  store i8 %xor153, ptr %arrayidx151, align 1
  %incdec.ptr155 = getelementptr inbounds i8, ptr %pat.addr.1, i64 1
  %29 = load i8, ptr %incdec.ptr155, align 1
  br label %do.cond
...
do.condthread-pre-split:                          ; preds = %for.inc132, %for.body.prol.loopexit, %for.body, %if.end68
  ...
  %.pr260 = load i8, ptr %pat.addr.4.ph, align 1
  br label %do.cond
...
do.cond:                                          ; preds = %do.condthread-pre-split, %if.else144
  ...
  br i1 %cmp159.not, label %cleanup163, label %do.body
...
if.then1:                                         ; preds = %if.then
  ...
  store i8 1, ptr %listend, align 1
...
while.cond:                                       ; preds = %if.then27, %land.rhs
  ...
  %17 = load ptr, ptr %node.addr.0, align 8
...
if.then53:                                        ; preds = %if.end47
  ...
  store ptr %new, ptr %arrayidx56, align 8
  br label %cleanup59
...
for.body.epil:                                    ; preds = %cleanup59.loopexit.unr-lcssa, %for.body.epil
  ...
  %19 = load ptr, ptr %arrayidx5.epil, align 8
  store ptr %new, ptr %19, align 8
  %20 = load ptr, ptr %arrayidx5.epil, align 8
  %listend9.epil = getelementptr inbounds %struct.tree_node, ptr %20, i64 0, i32 4
  store i8 0, ptr %listend9.epil, align 1
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %cleanup59, label %for.body.epil
...
if.end:                                           ; preds = %if.then2, %land.lhs.true, %if.then
  ...
  %node_stack = getelementptr inbounds %struct.regex_matcher, ptr %matcher, i64 0, i32 7
  %cnt.i = getelementptr inbounds %struct.regex_matcher, ptr %matcher, i64 0, i32 7, i32 2
  %6 = load i64, ptr %cnt.i, align 8
  %cmp9.not.i = icmp eq i64 %6, 0
  %.pre.i.pre.i = load ptr, ptr %node_stack, align 8
...
for.body.i:                                       ; preds = %if.end, %for.cond.i
  ...
  %7 = load ptr, ptr %arrayidx.i125, align 8
...
if.then.i.i:                                      ; preds = %for.end.i
  ...
  store i64 %add.i.i, ptr %capacity.i.i, align 8
  %mul.i.i = shl i64 %add.i.i, 3
  %call.i.i = tail call ptr @cli_realloc2(ptr noundef %.pre.i.pre.i, i64 noundef %mul.i.i) #17
  store ptr %call.i.i, ptr %node_stack, align 8
  %tobool.not.i.i = icmp eq ptr %call.i.i, null
  %.pr.pre = load i64, ptr %cnt.i, align 8
...
for.cond.i133:                                    ; preds = %for.body.i129
  ...
  br i1 %exitcond.not.i135, label %for.end.i136, label %for.body.i129
...
for.body.i129:                                    ; preds = %stack_push_once.exit, %for.cond.i133
  ...
  %12 = load ptr, ptr %arrayidx.i131, align 8
...
for.end.i136:                                     ; preds = %for.cond.i133, %stack_push_once.exit
  ...
  %13 = load i64, ptr %capacity.i.i137, align 8
...
if.then.i.i142:                                   ; preds = %for.end.i136
  ...
  store i64 %add.i.i143, ptr %capacity.i.i137, align 8
  ...
  store ptr %call.i.i145, ptr %node_stack, align 8
...
if.then.if.end6_crit_edge.i.i147:                 ; preds = %if.then.i.i142
  %.pre17.i.i148 = load i64, ptr %cnt.i, align 8
...
if.end6.i.i139:                                   ; preds = %if.then.if.end6_crit_edge.i.i147, %for.end.i136
  ...
  store i64 %inc.i.i140, ptr %cnt.i, align 8
  %arrayidx.i.i141 = getelementptr inbounds ptr, ptr %15, i64 %14
  store ptr %node, ptr %arrayidx.i.i141, align 8
...
for.body:                                         ; preds = %cond.end, %for.body
  ...
  %24 = load i8, ptr %alternatives, align 8
...
if.then35:                                        ; preds = %if.else
  %26 = load ptr, ptr %cond6.i200, align 8
...
land.lhs.true49:                                  ; preds = %land.lhs.true46
  ...
  %29 = load i8, ptr %listend50, align 1
...
if.then57:                                        ; preds = %if.end54
  ...
  %31 = load i64, ptr %cnt.i150, align 8
  %cmp9.not.i151 = icmp eq i64 %31, 0
  %.pre.i.pre.i152 = load ptr, ptr %node_stack58, align 8
...
for.cond.i157:                                    ; preds = %for.body.i153
  ...
  br i1 %exitcond.not.i159, label %for.end.i160, label %for.body.i153
...
for.body.i153:                                    ; preds = %if.then57, %for.cond.i157
  ...
  %32 = load ptr, ptr %arrayidx.i155, align 8
...
for.end.i160:                                     ; preds = %for.cond.i157, %if.then57
  ...
  %33 = load i64, ptr %capacity.i.i161, align 8
...
if.then.i.i166:                                   ; preds = %for.end.i160
  ...
  store i64 %add.i.i167, ptr %capacity.i.i161, align 8
  ...
  store ptr %call.i.i169, ptr %node_stack58, align 8
...
if.then.if.end6_crit_edge.i.i171:                 ; preds = %if.then.i.i166
  %.pre17.i.i172 = load i64, ptr %cnt.i150, align 8
...
if.end6.i.i163:                                   ; preds = %if.then.if.end6_crit_edge.i.i171, %for.end.i160
  ...
  store i64 %inc.i.i164, ptr %cnt.i150, align 8
  %arrayidx.i.i165 = getelementptr inbounds ptr, ptr %35, i64 %34
  store ptr %30, ptr %arrayidx.i.i165, align 8
  br label %if.end60
...
if.end73:                                         ; preds = %if.then68, %land.lhs.true64, %if.end60
  ...
  %40 = load i64, ptr %cnt.i174, align 8
  %cmp9.not.i175 = icmp eq i64 %40, 0
  %.pre.i.pre.i176 = load ptr, ptr %node_stack74, align 8
...
for.cond.i181:                                    ; preds = %for.body.i177
  ...
  br i1 %exitcond.not.i183, label %for.end.i184, label %for.body.i177
...
for.body.i177:                                    ; preds = %if.end73, %for.cond.i181
  ...
  %41 = load ptr, ptr %arrayidx.i179, align 8
...
for.end.i184:                                     ; preds = %for.cond.i181, %if.end73
  ...
  %42 = load i64, ptr %capacity.i.i185, align 8
...
if.then.i.i190:                                   ; preds = %for.end.i184
  ...
  store i64 %add.i.i191, ptr %capacity.i.i185, align 8
  ...
  store ptr %call.i.i193, ptr %node_stack74, align 8
...
if.then.if.end6_crit_edge.i.i195:                 ; preds = %if.then.i.i190
  %.pre17.i.i196 = load i64, ptr %cnt.i174, align 8
...
if.end6.i.i187:                                   ; preds = %if.then.if.end6_crit_edge.i.i195, %for.end.i184
  ...
  store i64 %inc.i.i188, ptr %cnt.i174, align 8
  %arrayidx.i.i189 = getelementptr inbounds ptr, ptr %44, i64 %43
  store ptr %node, ptr %arrayidx.i.i189, align 8
