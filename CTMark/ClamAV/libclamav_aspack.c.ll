...
while.body.lr.ph.i210.i.i:                        ; preds = %if.then59.i.i
  ...
  %input.promoted.i213.i.i = load ptr, ptr %input, align 8, !tbaa !20
...
if.end.i217.i.i:                                  ; preds = %while.body.i214.i.i
  ...
  %27 = load i8, ptr %incdec.ptr15.i215.i.i, align 1, !tbaa !17
  %conv.i219.i.i = zext i8 %27 to i32
  %or.i220.i.i = or i32 %shl.i218.i.i, %conv.i219.i.i
  store i32 %or.i220.i.i, ptr %hash, align 4, !tbaa !15
  %incdec.ptr.i221.i.i = getelementptr inbounds i8, ptr %incdec.ptr15.i215.i.i, i64 1
  store ptr %incdec.ptr.i221.i.i, ptr %input, align 8, !tbaa !20
  %sub.i222.i.i = add i32 %26, -8
  store i32 %sub.i222.i.i, ptr %stream, align 8, !tbaa !22
  %cmp.i223.i.i = icmp ugt i32 %sub.i222.i.i, 7
  br i1 %cmp.i223.i.i, label %while.body.i214.i.i, label %if.end63.i.i, !llvm.loop !25
...
if.else.if.end78_crit_edge.i.i:                   ; preds = %if.else.i.i
  %.pre265.i.i = load i32, ptr %hash, align 4, !tbaa !15
  br label %if.end78.i.i

while.body.lr.ph.i229.i.i:                        ; preds = %if.else.i.i
  %30 = load ptr, ptr %iend, align 8, !tbaa !21
  %input.promoted.i232.i.i = load ptr, ptr %input, align 8, !tbaa !20
...
if.end.i236.i.i:                                  ; preds = %while.body.i233.i.i
  ...
  %33 = load i8, ptr %incdec.ptr15.i234.i.i, align 1, !tbaa !17
  %conv.i238.i.i = zext i8 %33 to i32
  %or.i239.i.i = or i32 %shl.i237.i.i, %conv.i238.i.i
  store i32 %or.i239.i.i, ptr %hash, align 4, !tbaa !15
  %incdec.ptr.i240.i.i = getelementptr inbounds i8, ptr %incdec.ptr15.i234.i.i, i64 1
  store ptr %incdec.ptr.i240.i.i, ptr %input, align 8, !tbaa !20
  %sub.i241.i.i = add i32 %32, -8
  store i32 %sub.i241.i.i, ptr %stream, align 8, !tbaa !22
  %cmp.i242.i.i = icmp ugt i32 %sub.i241.i.i, 7
  br i1 %cmp.i242.i.i, label %while.body.i233.i.i, label %if.end78.i.i, !llvm.loop !25
...
if.end.thread339:                                 ; preds = %getbits.exit
  ...
  %8 = load ptr, ptr %decrypt_dict340, align 8, !tbaa !13
...
for.body.us.getbits.exit195.us_crit_edge:         ; preds = %for.body.us
  %.pre333 = load i32, ptr %hash.i.i182, align 4, !tbaa !15
  br label %getbits.exit195.us

while.body.lr.ph.i.i180.us:                       ; preds = %for.body.us
  %10 = load ptr, ptr %iend.i.i181, align 8, !tbaa !21
  %input.promoted.i.i183.us = load ptr, ptr %input.i.i, align 8, !tbaa !20
...
if.end.i.i188.us:                                 ; preds = %while.body.i.i184.us
  %12 = load i32, ptr %hash.i.i182, align 4, !tbaa !15
  %shl.i.i189.us = shl i32 %12, 8
  %13 = load i8, ptr %incdec.ptr15.i.i185.us, align 1, !tbaa !17
  %conv.i.i190.us = zext i8 %13 to i32
  %or.i.i191.us = or i32 %shl.i.i189.us, %conv.i.i190.us
  store i32 %or.i.i191.us, ptr %hash.i.i182, align 4, !tbaa !15
  %incdec.ptr.i.i192.us = getelementptr inbounds i8, ptr %incdec.ptr15.i.i185.us, i64 1
  store ptr %incdec.ptr.i.i192.us, ptr %input.i.i, align 8, !tbaa !20
  %sub.i.i193.us = add i32 %11, -8
  store i32 %sub.i.i193.us, ptr %stream, align 8, !tbaa !22
  %cmp.i.i194.us = icmp ugt i32 %sub.i.i193.us, 7
  br i1 %cmp.i.i194.us, label %while.body.i.i184.us, label %getbits.exit195.us, !llvm.loop !25
...
getbits.exit195.us:                               ; preds = %if.end.i.i188.us, %for.body.us.getbits.exit195.us_crit_edge
  ...
  store i32 %add.i178.us, ptr %stream, align 8, !tbaa !22
  %arrayidx.us = getelementptr inbounds %struct.ASPK, ptr %stream, i64 0, i32 2, i64 %indvars.iv
  store i8 %conv.i177.us, ptr %arrayidx.us, align 1, !tbaa !17
...
if.then23.if.end.i199_crit_edge:                  ; preds = %if.then23
  %.pre334 = load i32, ptr %hash.i.i182, align 4, !tbaa !15
  br label %if.end.i199

while.body.lr.ph.i.i208:                          ; preds = %if.then23
  %17 = load ptr, ptr %iend.i.i181, align 8, !tbaa !21
  %input.promoted.i.i211 = load ptr, ptr %input.i.i, align 8, !tbaa !20
...
if.end.i.i216:                                    ; preds = %while.body.i.i212
  %19 = load i32, ptr %hash.i.i182, align 4, !tbaa !15
  %shl.i.i217 = shl i32 %19, 8
  %20 = load i8, ptr %incdec.ptr15.i.i213, align 1, !tbaa !17
  %conv.i.i218 = zext i8 %20 to i32
  %or.i.i219 = or i32 %shl.i.i217, %conv.i.i218
  store i32 %or.i.i219, ptr %hash.i.i182, align 4, !tbaa !15
  %incdec.ptr.i.i220 = getelementptr inbounds i8, ptr %incdec.ptr15.i.i213, i64 1
  store ptr %incdec.ptr.i.i220, ptr %input.i.i, align 8, !tbaa !20
  %sub.i.i221 = add i32 %18, -8
  store i32 %sub.i.i221, ptr %stream, align 8, !tbaa !22
  %cmp.i.i222 = icmp ugt i32 %sub.i.i221, 7
  br i1 %cmp.i.i222, label %while.body.i.i212, label %if.end.i199, !llvm.loop !25
...
if.end.i199:                                      ; preds = %if.end.i.i216, %if.then23.if.end.i199_crit_edge
  ...
  store i32 %add.i206, ptr %stream, align 8, !tbaa !22
  br label %getbits.exit223
...
if.else.if.end.i227_crit_edge:                    ; preds = %if.else
  %.pre337 = load i32, ptr %hash.i.i182, align 4, !tbaa !15
  br label %if.end.i227

while.body.lr.ph.i.i236:                          ; preds = %if.else
  %24 = load ptr, ptr %iend.i.i181, align 8, !tbaa !21
  %input.promoted.i.i239 = load ptr, ptr %input.i.i, align 8, !tbaa !20
...
if.end.i.i244:                                    ; preds = %while.body.i.i240
  %26 = load i32, ptr %hash.i.i182, align 4, !tbaa !15
  %shl.i.i245 = shl i32 %26, 8
  %27 = load i8, ptr %incdec.ptr15.i.i241, align 1, !tbaa !17
  %conv.i.i246 = zext i8 %27 to i32
  %or.i.i247 = or i32 %shl.i.i245, %conv.i.i246
  store i32 %or.i.i247, ptr %hash.i.i182, align 4, !tbaa !15
  %incdec.ptr.i.i248 = getelementptr inbounds i8, ptr %incdec.ptr15.i.i241, i64 1
  store ptr %incdec.ptr.i.i248, ptr %input.i.i, align 8, !tbaa !20
  %sub.i.i249 = add i32 %25, -8
  store i32 %sub.i.i249, ptr %stream, align 8, !tbaa !22
  %cmp.i.i250 = icmp ugt i32 %sub.i.i249, 7
  br i1 %cmp.i.i250, label %while.body.i.i240, label %if.end.i227, !llvm.loop !25
...
if.end.i227:                                      ; preds = %if.end.i.i244, %if.else.if.end.i227_crit_edge
  ...
  store i32 %add.i234, ptr %stream, align 8, !tbaa !22
  br label %getbits.exit251
...
if.end38.preheader:                               ; preds = %while.cond32.preheader
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %scevgep324, i8 0, i64 %36, i1 false), !tbaa !17
  br label %if.end38
...
while.cond50.preheader.thread:                    ; preds = %if.else43
  %.pre335 = load i32, ptr %hash.i.i182, align 4, !tbaa !15
  store i32 0, ptr %oob, align 4, !tbaa !16
  %add.i262342 = add nuw nsw i32 %.pr.i.i224, 2
  store i32 %add.i262342, ptr %stream, align 8, !tbaa !22
  br label %if.end56.preheader

while.body.lr.ph.i.i264:                          ; preds = %if.else43
  %37 = load ptr, ptr %iend.i.i181, align 8, !tbaa !21
  %input.promoted.i.i267 = load ptr, ptr %input.i.i, align 8, !tbaa !20
...
if.end.i.i272:                                    ; preds = %while.body.i.i268
  %39 = load i32, ptr %hash.i.i182, align 4, !tbaa !15
  %shl.i.i273 = shl i32 %39, 8
  %40 = load i8, ptr %incdec.ptr15.i.i269, align 1, !tbaa !17
  %conv.i.i274 = zext i8 %40 to i32
  %or.i.i275 = or i32 %shl.i.i273, %conv.i.i274
  store i32 %or.i.i275, ptr %hash.i.i182, align 4, !tbaa !15
  %incdec.ptr.i.i276 = getelementptr inbounds i8, ptr %incdec.ptr15.i.i269, i64 1
  store ptr %incdec.ptr.i.i276, ptr %input.i.i, align 8, !tbaa !20
  %sub.i.i277 = add i32 %38, -8
  store i32 %sub.i.i277, ptr %stream, align 8, !tbaa !22
  %cmp.i.i278 = icmp ugt i32 %sub.i.i277, 7
  br i1 %cmp.i.i278, label %while.body.i.i268, label %while.cond50.preheader, !llvm.loop !25

while.cond50.preheader:                           ; preds = %if.end.i.i272
  store i32 0, ptr %oob, align 4, !tbaa !16
  %add.i262 = add i32 %38, -6
  store i32 %add.i262, ptr %stream, align 8, !tbaa !22
...
if.end56.preheader:                               ; preds = %while.cond50.preheader.thread, %while.cond50.preheader
  ...
  %.pre336 = load i8, ptr %arrayidx59.phi.trans.insert, align 1, !tbaa !17
  ...
  store i8 %.pre336, ptr %arrayidx63, align 1, !tbaa !17
  %cmp53 = icmp ugt i32 %counter.1312, 755
  br i1 %cmp53, label %if.end80.loopexit314, label %if.end56.1, !llvm.loop !42
...
if.end56.1:                                       ; preds = %if.end56.preheader
  ...
  store i8 %.pre336, ptr %arrayidx63.1, align 1, !tbaa !17
  %cmp53.1 = icmp eq i32 %counter.1312, 755
  br i1 %cmp53.1, label %if.end80.loopexit314, label %if.end56.2, !llvm.loop !42
...
if.end56.2:                                       ; preds = %if.end56.1
  ...
  store i8 %.pre336, ptr %arrayidx63.2, align 1, !tbaa !17
  %tobool51.2 = icmp eq i32 %conv.i261, 0
  %cmp53.2 = icmp ugt i32 %counter.1312, 753
  %or.cond119.2 = or i1 %cmp53.2, %tobool51.2
  br i1 %or.cond119.2, label %if.end80.loopexit314, label %if.end56.3, !llvm.loop !42
...
if.end56.3:                                       ; preds = %if.end56.2
  ...
  store i8 %.pre336, ptr %arrayidx63.3, align 1, !tbaa !17
  %tobool51.3 = icmp eq i32 %conv.i261, 1
  %cmp53.3 = icmp ugt i32 %counter.1312, 752
  %or.cond119.3 = or i1 %cmp53.3, %tobool51.3
  br i1 %or.cond119.3, label %if.end80.loopexit314, label %if.end56.4, !llvm.loop !42
...
if.end56.4:                                       ; preds = %if.end56.3
  ...
  store i8 %.pre336, ptr %arrayidx63.4, align 1, !tbaa !17
  %tobool51.4 = icmp eq i32 %conv.i261, 2
  %cmp53.4 = icmp ugt i32 %counter.1312, 751
  %or.cond119.4 = or i1 %cmp53.4, %tobool51.4
  br i1 %or.cond119.4, label %if.end80.loopexit314, label %if.end56.5, !llvm.loop !42
...
if.end56.5:                                       ; preds = %if.end56.4
  ...
  store i8 %.pre336, ptr %arrayidx63.5, align 1, !tbaa !17
...
if.end113:                                        ; preds = %if.end102, %if.then44, %if.end27
  ...
  br i1 %exitcond278.not, label %while.end, label %while.body, !llvm.loop !45
