; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_aspack.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_aspack.c"
...
if.end:                                           ; preds = %entry
  ...
  store ptr %call, ptr %dict_helper, align 8
  ...
  store ptr %arrayidx19, ptr %arrayidx21, align 8
  ...
  store ptr %arrayidx30, ptr %arrayidx32, align 8
  ...
  store ptr %arrayidx41, ptr %decrypt_dict, align 8
  %hash = getelementptr inbounds %struct.ASPK, ptr %stream, i64 0, i32 1
  store i32 65536, ptr %hash, align 4
  %add = add i32 %ep, 1806
  br label %for.body
...
for.body:                                         ; preds = %for.body, %if.end
  ...
  store i32 %add46, ptr %arrayidx42.1, align 8
  ...
  %3 = load i8, ptr %arrayidx45.1, align 1
...
if.end107:                                        ; preds = %while.body
  store ptr %call104, ptr %input, align 8
  %arrayidx110 = getelementptr inbounds i8, ptr %call104, i64 %conv103
  store ptr %arrayidx110, ptr %iend, align 8
...
while.cond.i.i:                                   ; preds = %if.then6.i.i, %while.cond.i.preheader.i
  ...
  %10 = load i32, ptr %oob.i.i, align 4
...
while.cond.outer.backedge.i.i:                    ; preds = %while.body129.i.i.prol.loopexit, %while.body129.i.i, %middle.block, %if.then2.i.i
  ...
  br i1 %cmp.i.i, label %while.cond.i.preheader.i, label %if.end122
...
if.then6.i.i:                                     ; preds = %if.end3.i.i
  ...
  br i1 %tobool8.not.i.i, label %decomp_block.exit.thread356, label %while.cond.i.i
...
if.end11.i.if.end48.i_crit_edge.i:                ; preds = %if.end11.i.i
  %.pr.i206.i.pre.i = load i32, ptr %stream, align 8
...
if.then20.i.i:                                    ; preds = %if.end11.i.i
  ...
  %12 = load i32, ptr %oob.i.i, align 4
...
if.end26.i.i:                                     ; preds = %if.then20.i.i
  ...
  %.pr.i.i.i = load i32, ptr %stream, align 8
...
if.end26.cleanup_crit_edge.i.i:                   ; preds = %if.end26.i.i
  %.pre.i.i = load i32, ptr %hash, align 4
  br label %cleanup.i.i

while.body.lr.ph.i.i.i:                           ; preds = %if.end26.i.i
  %14 = load ptr, ptr %iend, align 8
  %input.promoted.i.i.i = load ptr, ptr %input, align 8
  %hash.promoted = load i32, ptr %hash, align 4
...
if.end.i.i.i:                                     ; preds = %while.body.i.i.i
  ...
  %17 = load i8, ptr %incdec.ptr15.i.i.i, align 1
  %conv.i.i.i = zext i8 %17 to i32
  %or.i.i.i = or i32 %shl.i.i.i, %conv.i.i.i
  store i32 %or.i.i.i, ptr %hash, align 4
  %incdec.ptr.i.i.i = getelementptr inbounds i8, ptr %incdec.ptr15.i.i.i, i64 1
  store ptr %incdec.ptr.i.i.i, ptr %input, align 8
  %sub.i.i.i = add i32 %16, -8
  store i32 %sub.i.i.i, ptr %stream, align 8
  %cmp.i.i.i = icmp ugt i32 %sub.i.i.i, 7
  br i1 %cmp.i.i.i, label %while.body.i.i.i, label %cleanup.i.i
...
cleanup.i.i:                                      ; preds = %if.end.i.i.i, %if.end26.cleanup_crit_edge.i.i
  ...
  %20 = load i8, ptr %arrayidx35.i.i, align 1
  ...
  store i32 %add47.i.i, ptr %stream, align 8
  br label %if.end48.i.i
...
if.end48.i.i:                                     ; preds = %cleanup.i.i, %if.end11.i.if.end48.i_crit_edge.i
  ...
  %21 = load i32, ptr %arrayidx50.i.i, align 4
  ...
  %23 = load i32, ptr %dict_ok.i.i, align 8
...
if.then59.i.i:                                    ; preds = %if.end48.i.i
  br i1 %cmp13.i208.i.i, label %while.body.lr.ph.i210.i.i, label %if.then59.if.end63_crit_edge.i.i

if.then59.if.end63_crit_edge.i.i:                 ; preds = %if.then59.i.i
  %.pre266.i.i = load i32, ptr %hash, align 4
  br label %if.end63.i.i

while.body.lr.ph.i210.i.i:                        ; preds = %if.then59.i.i
  %24 = load ptr, ptr %iend, align 8
  %input.promoted.i213.i.i = load ptr, ptr %input, align 8
  %hash.promoted375 = load i32, ptr %hash, align 4
  br label %while.body.i214.i.i

while.body.i214.i.i:                              ; preds = %if.end.i217.i.i, %while.body.lr.ph.i210.i.i
  %25 = phi i32 [ %hash.promoted375, %while.body.lr.ph.i210.i.i ], [ %or.i220.i.i, %if.end.i217.i.i ]
  %incdec.ptr15.i215.i.i = phi ptr [ %input.promoted.i213.i.i, %while.body.lr.ph.i210.i.i ], [ %incdec.ptr.i221.i.i, %if.end.i217.i.i ]
  %26 = phi i32 [ %.pr.i206.i.i, %while.body.lr.ph.i210.i.i ], [ %sub.i222.i.i, %if.end.i217.i.i ]
  %cmp1.not.i216.i.i = icmp ult ptr %incdec.ptr15.i215.i.i, %24
  br i1 %cmp1.not.i216.i.i, label %if.end.i217.i.i, label %decomp_block.exit.thread356

if.end.i217.i.i:                                  ; preds = %while.body.i214.i.i
  %shl.i218.i.i = shl i32 %25, 8
  %27 = load i8, ptr %incdec.ptr15.i215.i.i, align 1
  %conv.i219.i.i = zext i8 %27 to i32
  %or.i220.i.i = or i32 %shl.i218.i.i, %conv.i219.i.i
  store i32 %or.i220.i.i, ptr %hash, align 4
  %incdec.ptr.i221.i.i = getelementptr inbounds i8, ptr %incdec.ptr15.i215.i.i, i64 1
  store ptr %incdec.ptr.i221.i.i, ptr %input, align 8
  %sub.i222.i.i = add i32 %26, -8
  store i32 %sub.i222.i.i, ptr %stream, align 8
  %cmp.i223.i.i = icmp ugt i32 %sub.i222.i.i, 7
  br i1 %cmp.i223.i.i, label %while.body.i214.i.i, label %if.end63.i.i

if.end63.i.i:                                     ; preds = %if.end.i217.i.i, %if.then59.if.end63_crit_edge.i.i
  %28 = phi i32 [ %.pr.i206.i.i, %if.then59.if.end63_crit_edge.i.i ], [ %sub.i222.i.i, %if.end.i217.i.i ]
  %29 = phi i32 [ %.pre266.i.i, %if.then59.if.end63_crit_edge.i.i ], [ %or.i220.i.i, %if.end.i217.i.i ]
  ...
  store i32 %add73.i.i, ptr %stream, align 8
  br label %if.end94.i.i

if.else.i.i:                                      ; preds = %if.end48.i.i
  br i1 %cmp13.i208.i.i, label %while.body.lr.ph.i229.i.i, label %if.else.if.end78_crit_edge.i.i

if.else.if.end78_crit_edge.i.i:                   ; preds = %if.else.i.i
  %.pre265.i.i = load i32, ptr %hash, align 4
  br label %if.end78.i.i

while.body.lr.ph.i229.i.i:                        ; preds = %if.else.i.i
  %30 = load ptr, ptr %iend, align 8
  %input.promoted.i232.i.i = load ptr, ptr %input, align 8
  %hash.promoted374 = load i32, ptr %hash, align 4
  br label %while.body.i233.i.i

while.body.i233.i.i:                              ; preds = %if.end.i236.i.i, %while.body.lr.ph.i229.i.i
  %31 = phi i32 [ %hash.promoted374, %while.body.lr.ph.i229.i.i ], [ %or.i239.i.i, %if.end.i236.i.i ]
  %incdec.ptr15.i234.i.i = phi ptr [ %input.promoted.i232.i.i, %while.body.lr.ph.i229.i.i ], [ %incdec.ptr.i240.i.i, %if.end.i236.i.i ]
  %32 = phi i32 [ %.pr.i206.i.i, %while.body.lr.ph.i229.i.i ], [ %sub.i241.i.i, %if.end.i236.i.i ]
  %cmp1.not.i235.i.i = icmp ult ptr %incdec.ptr15.i234.i.i, %30
  br i1 %cmp1.not.i235.i.i, label %if.end.i236.i.i, label %decomp_block.exit.thread356

if.end.i236.i.i:                                  ; preds = %while.body.i233.i.i
  %shl.i237.i.i = shl i32 %31, 8
  %33 = load i8, ptr %incdec.ptr15.i234.i.i, align 1
  %conv.i238.i.i = zext i8 %33 to i32
  %or.i239.i.i = or i32 %shl.i237.i.i, %conv.i238.i.i
  store i32 %or.i239.i.i, ptr %hash, align 4
  %incdec.ptr.i240.i.i = getelementptr inbounds i8, ptr %incdec.ptr15.i234.i.i, i64 1
  store ptr %incdec.ptr.i240.i.i, ptr %input, align 8
  %sub.i241.i.i = add i32 %32, -8
  store i32 %sub.i241.i.i, ptr %stream, align 8
  %cmp.i242.i.i = icmp ugt i32 %sub.i241.i.i, 7
  br i1 %cmp.i242.i.i, label %while.body.i233.i.i, label %if.end78.i.i

if.end78.i.i:                                     ; preds = %if.end.i236.i.i, %if.else.if.end78_crit_edge.i.i
  %34 = phi i32 [ %.pr.i206.i.i, %if.else.if.end78_crit_edge.i.i ], [ %sub.i241.i.i, %if.end.i236.i.i ]
  %35 = phi i32 [ %.pre265.i.i, %if.else.if.end78_crit_edge.i.i ], [ %or.i239.i.i, %if.end.i236.i.i ]
  ...
  store i32 %add88.i.i, ptr %stream, align 8
  ...
  %36 = load i32, ptr %oob.i.i, align 4
...
if.then97.i.i:                                    ; preds = %if.end94.i.i
  ...
  %37 = load i32, ptr %arrayidx99.i.i, align 4
...
if.then102.i.i:                                   ; preds = %if.then97.i.i
  store i32 %9, ptr %arrayidx99.i.i, align 4
  store i32 %37, ptr %hist.i.i, align 16
  br label %if.end115.i.i

if.else108.i.i:                                   ; preds = %if.end94.i.i
  %38 = load i32, ptr %arrayidx109.i.i, align 4
  store i32 %38, ptr %arrayidx110.i.i, align 8
  store i32 %9, ptr %arrayidx109.i.i, align 4
  %sub113.i.i = add i32 %useold.0.i.i, -3
  store i32 %sub113.i.i, ptr %hist.i.i, align 16
  br label %if.end115.i.i
...
vector.scevcheck:                                 ; preds = %while.body129.i.i.preheader
  %40 = add nsw i32 %backsize.1.i.i, -1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %55, align 1
  %56 = getelementptr inbounds i8, ptr %55, i64 16
  %wide.load432 = load <16 x i8>, ptr %56, align 1
  ...
  store <16 x i8> %wide.load432, ptr %59, align 1
...
while.body129.i.i.preheader433:                   ; preds = %vector.memcheck, %vector.scevcheck, %while.body129.i.i.preheader, %middle.block
  %counter.1258.i.i.ph = phi i32 [ %counter.0.ph.i15.i, %vector.memcheck ], [ %counter.0.ph.i15.i, %vector.scevcheck ], [ %counter.0.ph.i15.i, %while.body129.i.i.preheader ], [ %ind.end, %middle.block ]
  %backsize.2257.i.i.ph = phi i32 [ %backsize.1.i.i, %vector.memcheck ], [ %backsize.1.i.i, %vector.scevcheck ], [ %backsize.1.i.i, %while.body129.i.i.preheader ], [ %ind.end430, %middle.block ]
  %61 = add nsw i32 %backsize.2257.i.i.ph, -1
  %xtraiter = and i32 %backsize.2257.i.i.ph, 3
...
while.body129.i.i.prol:                           ; preds = %while.body129.i.i.preheader433, %while.body129.i.i.prol
  %counter.1258.i.i.prol = phi i32 [ %inc135.i.i.prol, %while.body129.i.i.prol ], [ %counter.1258.i.i.ph, %while.body129.i.i.preheader433 ]
  %backsize.2257.i.i.prol = phi i32 [ %dec.i.i.prol, %while.body129.i.i.prol ], [ %backsize.2257.i.i.ph, %while.body129.i.i.preheader433 ]
  %prol.iter = phi i32 [ %prol.iter.next, %while.body129.i.i.prol ], [ 0, %while.body129.i.i.preheader433 ]
  %dec.i.i.prol = add nsw i32 %backsize.2257.i.i.prol, -1
  %sub130.i.i.prol = add i32 %counter.1258.i.i.prol, %inc116.neg.i.i
  ...
  %62 = load i8, ptr %arrayidx132.i.i.prol, align 1
  %idxprom133.i.i.prol = zext i32 %counter.1258.i.i.prol to i64
  %arrayidx134.i.i.prol = getelementptr inbounds i8, ptr %add.ptr82, i64 %idxprom133.i.i.prol
  store i8 %62, ptr %arrayidx134.i.i.prol, align 1
  %inc135.i.i.prol = add i32 %counter.1258.i.i.prol, 1
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %while.body129.i.i.prol.loopexit, label %while.body129.i.i.prol
...
while.body129.i.i.prol.loopexit:                  ; preds = %while.body129.i.i.prol, %while.body129.i.i.preheader433
  ...
  %counter.1258.i.i.unr = phi i32 [ %counter.1258.i.i.ph, %while.body129.i.i.preheader433 ], [ %inc135.i.i.prol, %while.body129.i.i.prol ]
  %backsize.2257.i.i.unr = phi i32 [ %backsize.2257.i.i.ph, %while.body129.i.i.preheader433 ], [ %dec.i.i.prol, %while.body129.i.i.prol ]
...
while.body129.i.i:                                ; preds = %while.body129.i.i.prol.loopexit, %while.body129.i.i
  %counter.1258.i.i = phi i32 [ %inc135.i.i.3, %while.body129.i.i ], [ %counter.1258.i.i.unr, %while.body129.i.i.prol.loopexit ]
  %backsize.2257.i.i = phi i32 [ %dec.i.i.3, %while.body129.i.i ], [ %backsize.2257.i.i.unr, %while.body129.i.i.prol.loopexit ]
  %sub130.i.i = add i32 %counter.1258.i.i, %inc116.neg.i.i
  %idxprom131.i.i = zext i32 %sub130.i.i to i64
  %arrayidx132.i.i = getelementptr inbounds i8, ptr %add.ptr82, i64 %idxprom131.i.i
  %64 = load i8, ptr %arrayidx132.i.i, align 1
  %idxprom133.i.i = zext i32 %counter.1258.i.i to i64
  %arrayidx134.i.i = getelementptr inbounds i8, ptr %add.ptr82, i64 %idxprom133.i.i
  store i8 %64, ptr %arrayidx134.i.i, align 1
  %inc135.i.i = add i32 %counter.1258.i.i, 1
  %sub130.i.i.1 = sub i32 %counter.1258.i.i, %backbytes.0.i.i
  ...
  %65 = load i8, ptr %arrayidx132.i.i.1, align 1
  ...
  store i8 %65, ptr %arrayidx134.i.i.1, align 1
  %inc135.i.i.1 = add i32 %counter.1258.i.i, 2
  ...
  %66 = load i8, ptr %arrayidx132.i.i.2, align 1
  ...
  store i8 %66, ptr %arrayidx134.i.i.2, align 1
  %inc135.i.i.2 = add i32 %counter.1258.i.i, 3
  %dec.i.i.3 = add nsw i32 %backsize.2257.i.i, -4
  ...
  %67 = load i8, ptr %arrayidx132.i.i.3, align 1
  ...
  store i8 %67, ptr %arrayidx134.i.i.3, align 1
  %inc135.i.i.3 = add i32 %counter.1258.i.i, 4
  %tobool128.not.i.i.3 = icmp eq i32 %dec.i.i.3, 0
  br i1 %tobool128.not.i.i.3, label %while.cond.outer.backedge.i.i, label %while.body129.i.i

decomp_block.exit.thread356:                      ; preds = %if.end115.i.i, %if.end78.i.i, %if.then20.i.i, %if.then6.i.i, %while.cond.i.i, %while.body.i.i.i, %while.body.i233.i.i, %while.body.i214.i.i
...
if.end160:                                        ; preds = %if.then142, %if.then154, %while.body132
  ...
  br i1 %cmp130, label %while.body132, label %if.end162

if.end162:                                        ; preds = %if.end160, %if.end122
  %i.4 = phi i32 [ %i.1381, %if.end122 ], [ %inc161, %if.end160 ]
  br i1 %cmp53.not, label %if.then169.critedge, label %land.lhs.true55

while.end164:                                     ; preds = %land.lhs.true65
  %72 = load ptr, ptr %dict_helper, align 8
...
if.then169.critedge:                              ; preds = %while.body, %land.lhs.true80, %land.lhs.true68, %land.lhs.true55, %if.end162, %for.end, %if.then121
  %73 = load ptr, ptr %dict_helper, align 8
...
for.body204:                                      ; preds = %for.body204, %for.body204.preheader.new
  ...
  %77 = load <2 x i32>, ptr %arrayidx206, align 4
  store <2 x i32> %77, ptr %raw, align 4
  ...
  %78 = load <2 x i32>, ptr %arrayidx206.1, align 4
  store <2 x i32> %78, ptr %raw.1, align 4
  ...
  %79 = load <2 x i32>, ptr %arrayidx206.2, align 4
  store <2 x i32> %79, ptr %raw.2, align 4
  ...
  %80 = load <2 x i32>, ptr %arrayidx206.3, align 4
  store <2 x i32> %80, ptr %raw.3, align 4
  %indvars.iv.next400.3 = add nuw nsw i64 %indvars.iv399, 4
  %niter.next.3 = add i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %for.end217.loopexit.unr-lcssa, label %for.body204
...
for.body204.epil:                                 ; preds = %for.end217.loopexit.unr-lcssa, %for.body204.epil
  ...
  %81 = load <2 x i32>, ptr %arrayidx206.epil, align 4
  store <2 x i32> %81, ptr %raw.epil, align 4
  ...
  br i1 %epil.iter.cmp.not, label %for.end217, label %for.body204.epil
...
entry:
  ...
  %.pr.i.i = load i32, ptr %stream, align 8
...
if.end.i.i:                                       ; preds = %while.body.i.i
  %2 = load i32, ptr %hash.i.i, align 4
  %shl.i.i = shl i32 %2, 8
  %3 = load i8, ptr %incdec.ptr15.i.i, align 1
  %conv.i.i = zext i8 %3 to i32
  %or.i.i = or i32 %shl.i.i, %conv.i.i
  store i32 %or.i.i, ptr %hash.i.i, align 4
  %incdec.ptr.i.i = getelementptr inbounds i8, ptr %incdec.ptr15.i.i, i64 1
  store ptr %incdec.ptr.i.i, ptr %input.i.i, align 8
  %sub.i.i = add i32 %1, -8
  store i32 %sub.i.i, ptr %stream, align 8
  %cmp.i.i = icmp ugt i32 %sub.i.i, 7
  br i1 %cmp.i.i, label %while.body.i.i, label %getbits.exit
...
getbits.exit:                                     ; preds = %if.end.i.i, %entry.getbits.exit_crit_edge
  ...
  store i32 %add.i, ptr %stream, align 8
  %6 = shl nuw i32 8388608, %sub.i
  %7 = and i32 %6, %5
  %tobool.not = icmp eq i32 %7, 0
  br i1 %tobool.not, label %if.end.thread339, label %for.body.us.preheader

if.end.thread339:                                 ; preds = %getbits.exit
  %decrypt_dict340 = getelementptr inbounds %struct.ASPK, ptr %stream, i64 0, i32 8
  %8 = load ptr, ptr %decrypt_dict340, align 8
...
if.end:                                           ; preds = %while.body.i.i
  %decrypt_dict = getelementptr inbounds %struct.ASPK, ptr %stream, i64 0, i32 8
  %9 = load ptr, ptr %decrypt_dict, align 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(757) %9, i8 0, i64 757, i1 false)
  br label %cleanup

for.body.us.preheader:                            ; preds = %getbits.exit, %if.end.thread339
  %iend.i.i181 = getelementptr inbounds %struct.ASPK, ptr %stream, i64 0, i32 7
  %hash.i.i182 = getelementptr inbounds %struct.ASPK, ptr %stream, i64 0, i32 1
  %stream.promoted = load i32, ptr %stream, align 8
...
for.body.us:                                      ; preds = %for.body.us.preheader, %getbits.exit195.us
  ...
  %sub.i.i193296301.us = phi i32 [ %stream.promoted, %for.body.us.preheader ], [ %add.i178.us, %getbits.exit195.us ]
  %cmp13.i.i170.us = icmp ugt i32 %sub.i.i193296301.us, 7
  br i1 %cmp13.i.i170.us, label %while.body.lr.ph.i.i180.us, label %for.body.us.getbits.exit195.us_crit_edge

for.body.us.getbits.exit195.us_crit_edge:         ; preds = %for.body.us
  %.pre333 = load i32, ptr %hash.i.i182, align 4
  br label %getbits.exit195.us

while.body.lr.ph.i.i180.us:                       ; preds = %for.body.us
  %10 = load ptr, ptr %iend.i.i181, align 8
  %input.promoted.i.i183.us = load ptr, ptr %input.i.i, align 8
  br label %while.body.i.i184.us

while.body.i.i184.us:                             ; preds = %if.end.i.i188.us, %while.body.lr.ph.i.i180.us
  %incdec.ptr15.i.i185.us = phi ptr [ %input.promoted.i.i183.us, %while.body.lr.ph.i.i180.us ], [ %incdec.ptr.i.i192.us, %if.end.i.i188.us ]
  %11 = phi i32 [ %sub.i.i193296301.us, %while.body.lr.ph.i.i180.us ], [ %sub.i.i193.us, %if.end.i.i188.us ]
  %cmp1.not.i.i186.us = icmp ult ptr %incdec.ptr15.i.i185.us, %10
  br i1 %cmp1.not.i.i186.us, label %if.end.i.i188.us, label %getbits.exit195.thread

if.end.i.i188.us:                                 ; preds = %while.body.i.i184.us
  %12 = load i32, ptr %hash.i.i182, align 4
  %shl.i.i189.us = shl i32 %12, 8
  %13 = load i8, ptr %incdec.ptr15.i.i185.us, align 1
  %conv.i.i190.us = zext i8 %13 to i32
  %or.i.i191.us = or i32 %shl.i.i189.us, %conv.i.i190.us
  store i32 %or.i.i191.us, ptr %hash.i.i182, align 4
  %incdec.ptr.i.i192.us = getelementptr inbounds i8, ptr %incdec.ptr15.i.i185.us, i64 1
  store ptr %incdec.ptr.i.i192.us, ptr %input.i.i, align 8
  %sub.i.i193.us = add i32 %11, -8
  store i32 %sub.i.i193.us, ptr %stream, align 8
  %cmp.i.i194.us = icmp ugt i32 %sub.i.i193.us, 7
  br i1 %cmp.i.i194.us, label %while.body.i.i184.us, label %getbits.exit195.us

getbits.exit195.us:                               ; preds = %if.end.i.i188.us, %for.body.us.getbits.exit195.us_crit_edge
  %14 = phi i32 [ %.pre333, %for.body.us.getbits.exit195.us_crit_edge ], [ %or.i.i191.us, %if.end.i.i188.us ]
  %sub.i.i193297.us = phi i32 [ %sub.i.i193296301.us, %for.body.us.getbits.exit195.us_crit_edge ], [ %sub.i.i193.us, %if.end.i.i188.us ]
  %sub.i173.us = sub nuw nsw i32 8, %sub.i.i193297.us
  %shr.i174.us = lshr i32 %14, %sub.i173.us
  %and.i175.us = lshr i32 %shr.i174.us, 20
  %15 = trunc i32 %and.i175.us to i8
  %conv.i177.us = and i8 %15, 15
  %add.i178.us = add nuw nsw i32 %sub.i.i193297.us, 4
  store i32 %add.i178.us, ptr %stream, align 8
  %arrayidx.us = getelementptr inbounds %struct.ASPK, ptr %stream, i64 0, i32 2, i64 %indvars.iv
  store i8 %conv.i177.us, ptr %arrayidx.us, align 1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 19
  br i1 %exitcond.not, label %for.end, label %for.body.us

getbits.exit195.thread:                           ; preds = %while.body.i.i184.us
...
if.then19:                                        ; preds = %if.end17
  %.pr.i.i224 = load i32, ptr %stream, align 8
...
if.then23:                                        ; preds = %if.then19
  br i1 %cmp13.i.i226, label %while.body.lr.ph.i.i208, label %if.then23.if.end.i199_crit_edge

if.then23.if.end.i199_crit_edge:                  ; preds = %if.then23
  %.pre334 = load i32, ptr %hash.i.i182, align 4
  br label %if.end.i199

while.body.lr.ph.i.i208:                          ; preds = %if.then23
  %17 = load ptr, ptr %iend.i.i181, align 8
  %input.promoted.i.i211 = load ptr, ptr %input.i.i, align 8
  br label %while.body.i.i212

while.body.i.i212:                                ; preds = %if.end.i.i216, %while.body.lr.ph.i.i208
  %incdec.ptr15.i.i213 = phi ptr [ %input.promoted.i.i211, %while.body.lr.ph.i.i208 ], [ %incdec.ptr.i.i220, %if.end.i.i216 ]
  %18 = phi i32 [ %.pr.i.i224, %while.body.lr.ph.i.i208 ], [ %sub.i.i221, %if.end.i.i216 ]
  %cmp1.not.i.i214 = icmp ult ptr %incdec.ptr15.i.i213, %17
  br i1 %cmp1.not.i.i214, label %if.end.i.i216, label %if.then.i215

if.end.i.i216:                                    ; preds = %while.body.i.i212
  %19 = load i32, ptr %hash.i.i182, align 4
  %shl.i.i217 = shl i32 %19, 8
  %20 = load i8, ptr %incdec.ptr15.i.i213, align 1
  %conv.i.i218 = zext i8 %20 to i32
  %or.i.i219 = or i32 %shl.i.i217, %conv.i.i218
  store i32 %or.i.i219, ptr %hash.i.i182, align 4
  %incdec.ptr.i.i220 = getelementptr inbounds i8, ptr %incdec.ptr15.i.i213, i64 1
  store ptr %incdec.ptr.i.i220, ptr %input.i.i, align 8
  %sub.i.i221 = add i32 %18, -8
  store i32 %sub.i.i221, ptr %stream, align 8
  %cmp.i.i222 = icmp ugt i32 %sub.i.i221, 7
  br i1 %cmp.i.i222, label %while.body.i.i212, label %if.end.i199

if.then.i215:                                     ; preds = %while.body.i.i212
  store i32 1, ptr %oob, align 4
  br label %getbits.exit223

if.end.i199:                                      ; preds = %if.end.i.i216, %if.then23.if.end.i199_crit_edge
  %21 = phi i32 [ %.pr.i.i224, %if.then23.if.end.i199_crit_edge ], [ %sub.i.i221, %if.end.i.i216 ]
  %22 = phi i32 [ %.pre334, %if.then23.if.end.i199_crit_edge ], [ %or.i.i219, %if.end.i.i216 ]
  store i32 0, ptr %oob, align 4
  %sub.i201 = sub nuw nsw i32 8, %21
  %shr.i202 = lshr i32 %22, %sub.i201
  %and.i203 = lshr i32 %shr.i202, 21
  %conv.i205 = and i32 %and.i203, 7
  %add.i206 = add nuw nsw i32 %21, 3
  store i32 %add.i206, ptr %stream, align 8
  br label %getbits.exit223

getbits.exit223:                                  ; preds = %if.then.i215, %if.end.i199
  %23 = phi i32 [ 0, %if.end.i199 ], [ 1, %if.then.i215 ]
  %retval.0.i207 = phi i32 [ %conv.i205, %if.end.i199 ], [ 0, %if.then.i215 ]
  %add = add nuw nsw i32 %retval.0.i207, 3
  br label %if.end28

if.else:                                          ; preds = %if.then19
  br i1 %cmp13.i.i226, label %while.body.lr.ph.i.i236, label %if.else.if.end.i227_crit_edge

if.else.if.end.i227_crit_edge:                    ; preds = %if.else
  %.pre337 = load i32, ptr %hash.i.i182, align 4
  br label %if.end.i227

while.body.lr.ph.i.i236:                          ; preds = %if.else
  %24 = load ptr, ptr %iend.i.i181, align 8
  %input.promoted.i.i239 = load ptr, ptr %input.i.i, align 8
  br label %while.body.i.i240

while.body.i.i240:                                ; preds = %if.end.i.i244, %while.body.lr.ph.i.i236
  %incdec.ptr15.i.i241 = phi ptr [ %input.promoted.i.i239, %while.body.lr.ph.i.i236 ], [ %incdec.ptr.i.i248, %if.end.i.i244 ]
  %25 = phi i32 [ %.pr.i.i224, %while.body.lr.ph.i.i236 ], [ %sub.i.i249, %if.end.i.i244 ]
  %cmp1.not.i.i242 = icmp ult ptr %incdec.ptr15.i.i241, %24
  br i1 %cmp1.not.i.i242, label %if.end.i.i244, label %if.then.i243

if.end.i.i244:                                    ; preds = %while.body.i.i240
  %26 = load i32, ptr %hash.i.i182, align 4
  %shl.i.i245 = shl i32 %26, 8
  %27 = load i8, ptr %incdec.ptr15.i.i241, align 1
  %conv.i.i246 = zext i8 %27 to i32
  %or.i.i247 = or i32 %shl.i.i245, %conv.i.i246
  store i32 %or.i.i247, ptr %hash.i.i182, align 4
  %incdec.ptr.i.i248 = getelementptr inbounds i8, ptr %incdec.ptr15.i.i241, i64 1
  store ptr %incdec.ptr.i.i248, ptr %input.i.i, align 8
  %sub.i.i249 = add i32 %25, -8
  store i32 %sub.i.i249, ptr %stream, align 8
  %cmp.i.i250 = icmp ugt i32 %sub.i.i249, 7
  br i1 %cmp.i.i250, label %while.body.i.i240, label %if.end.i227

if.then.i243:                                     ; preds = %while.body.i.i240
  store i32 1, ptr %oob, align 4
  br label %getbits.exit251

if.end.i227:                                      ; preds = %if.end.i.i244, %if.else.if.end.i227_crit_edge
  %28 = phi i32 [ %.pr.i.i224, %if.else.if.end.i227_crit_edge ], [ %sub.i.i249, %if.end.i.i244 ]
  %29 = phi i32 [ %.pre337, %if.else.if.end.i227_crit_edge ], [ %or.i.i247, %if.end.i.i244 ]
  store i32 0, ptr %oob, align 4
  %sub.i229 = sub nuw nsw i32 8, %28
  %shr.i230 = lshr i32 %29, %sub.i229
  %and.i231 = lshr i32 %shr.i230, 17
  %conv.i233 = and i32 %and.i231, 127
  %add.i234 = add nuw nsw i32 %28, 7
  store i32 %add.i234, ptr %stream, align 8
  br label %getbits.exit251

getbits.exit251:                                  ; preds = %if.then.i243, %if.end.i227
  %30 = phi i32 [ 0, %if.end.i227 ], [ 1, %if.then.i243 ]
  %retval.0.i235 = phi i32 [ %conv.i233, %if.end.i227 ], [ 0, %if.then.i243 ]
  %add27 = add nuw nsw i32 %retval.0.i235, 11
  br label %if.end28
...
while.cond32.preheader:                           ; preds = %if.end28
  %cmp35308 = icmp ugt i32 %counter.1312, 756
  br i1 %cmp35308, label %while.end81, label %if.end38.preheader

if.end38.preheader:                               ; preds = %while.cond32.preheader
  %32 = zext i32 %counter.1312 to i64
  %scevgep324 = getelementptr i8, ptr %scevgep, i64 %32
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %scevgep324, i8 0, i64 %36, i1 false)
  br label %if.end38

if.end38:                                         ; preds = %if.end38.preheader, %if.end38
  %indvars.iv325 = phi i64 [ %32, %if.end38.preheader ], [ %indvars.iv.next326, %if.end38 ]
  %ret.1310 = phi i32 [ %ret.0, %if.end38.preheader ], [ %dec, %if.end38 ]
  %indvars.iv.next326 = add nuw nsw i64 %indvars.iv325, 1
  %dec = add nsw i32 %ret.1310, -1
  %tobool33 = icmp eq i32 %dec, 0
  %cmp35 = icmp ugt i64 %indvars.iv325, 755
  %or.cond = or i1 %cmp35, %tobool33
  br i1 %or.cond, label %if.end80.loopexit, label %if.end38

if.else43:                                        ; preds = %if.then19
  br i1 %cmp13.i.i226, label %while.body.lr.ph.i.i264, label %while.cond50.preheader.thread

while.cond50.preheader.thread:                    ; preds = %if.else43
  %.pre335 = load i32, ptr %hash.i.i182, align 4
  store i32 0, ptr %oob, align 4
  %add.i262342 = add nuw nsw i32 %.pr.i.i224, 2
  store i32 %add.i262342, ptr %stream, align 8
  br label %if.end56.preheader

while.body.lr.ph.i.i264:                          ; preds = %if.else43
  %37 = load ptr, ptr %iend.i.i181, align 8
  %input.promoted.i.i267 = load ptr, ptr %input.i.i, align 8
  br label %while.body.i.i268

while.body.i.i268:                                ; preds = %if.end.i.i272, %while.body.lr.ph.i.i264
  %incdec.ptr15.i.i269 = phi ptr [ %input.promoted.i.i267, %while.body.lr.ph.i.i264 ], [ %incdec.ptr.i.i276, %if.end.i.i272 ]
  %38 = phi i32 [ %.pr.i.i224, %while.body.lr.ph.i.i264 ], [ %sub.i.i277, %if.end.i.i272 ]
  %cmp1.not.i.i270 = icmp ult ptr %incdec.ptr15.i.i269, %37
  br i1 %cmp1.not.i.i270, label %if.end.i.i272, label %cleanup

if.end.i.i272:                                    ; preds = %while.body.i.i268
  %39 = load i32, ptr %hash.i.i182, align 4
  %shl.i.i273 = shl i32 %39, 8
  %40 = load i8, ptr %incdec.ptr15.i.i269, align 1
  %conv.i.i274 = zext i8 %40 to i32
  %or.i.i275 = or i32 %shl.i.i273, %conv.i.i274
  store i32 %or.i.i275, ptr %hash.i.i182, align 4
  %incdec.ptr.i.i276 = getelementptr inbounds i8, ptr %incdec.ptr15.i.i269, i64 1
  store ptr %incdec.ptr.i.i276, ptr %input.i.i, align 8
  %sub.i.i277 = add i32 %38, -8
  store i32 %sub.i.i277, ptr %stream, align 8
  %cmp.i.i278 = icmp ugt i32 %sub.i.i277, 7
  br i1 %cmp.i.i278, label %while.body.i.i268, label %while.cond50.preheader

while.cond50.preheader:                           ; preds = %if.end.i.i272
  store i32 0, ptr %oob, align 4
  %add.i262 = add i32 %38, -6
  store i32 %add.i262, ptr %stream, align 8
  %cmp53305 = icmp ugt i32 %counter.1312, 756
  br i1 %cmp53305, label %while.end81, label %if.end56.preheader

if.end56.preheader:                               ; preds = %while.cond50.preheader.thread, %while.cond50.preheader
  %41 = phi i32 [ %.pre335, %while.cond50.preheader.thread ], [ %or.i.i275, %while.cond50.preheader ]
  %42 = phi i32 [ %.pr.i.i224, %while.cond50.preheader.thread ], [ %sub.i.i277, %while.cond50.preheader ]
  %sub.i257 = sub nuw nsw i32 8, %42
  %shr.i258 = lshr i32 %41, %sub.i257
  %and.i259 = lshr i32 %shr.i258, 22
  %conv.i261 = and i32 %and.i259, 3
  ...
  %.pre336 = load i8, ptr %arrayidx59.phi.trans.insert, align 1
  %indvars.iv.next322 = add nuw nsw i64 %43, 1
  %arrayidx63 = getelementptr inbounds %struct.ASPK, ptr %stream, i64 0, i32 3, i64 %indvars.iv.next322
  store i8 %.pre336, ptr %arrayidx63, align 1
  %cmp53 = icmp ugt i32 %counter.1312, 755
  br i1 %cmp53, label %if.end80.loopexit314, label %if.end56.1

if.end56.1:                                       ; preds = %if.end56.preheader
  %indvars.iv.next322.1 = add nuw nsw i64 %43, 2
  %arrayidx63.1 = getelementptr inbounds %struct.ASPK, ptr %stream, i64 0, i32 3, i64 %indvars.iv.next322.1
  store i8 %.pre336, ptr %arrayidx63.1, align 1
  %cmp53.1 = icmp eq i32 %counter.1312, 755
  br i1 %cmp53.1, label %if.end80.loopexit314, label %if.end56.2

if.end56.2:                                       ; preds = %if.end56.1
  %indvars.iv.next322.2 = add nuw nsw i64 %43, 3
  %arrayidx63.2 = getelementptr inbounds %struct.ASPK, ptr %stream, i64 0, i32 3, i64 %indvars.iv.next322.2
  store i8 %.pre336, ptr %arrayidx63.2, align 1
  %tobool51.2 = icmp eq i32 %conv.i261, 0
  %cmp53.2 = icmp ugt i32 %counter.1312, 753
  %or.cond119.2 = or i1 %cmp53.2, %tobool51.2
  br i1 %or.cond119.2, label %if.end80.loopexit314, label %if.end56.3

if.end56.3:                                       ; preds = %if.end56.2
  %indvars.iv.next322.3 = add nuw nsw i64 %43, 4
  %arrayidx63.3 = getelementptr inbounds %struct.ASPK, ptr %stream, i64 0, i32 3, i64 %indvars.iv.next322.3
  store i8 %.pre336, ptr %arrayidx63.3, align 1
  %tobool51.3 = icmp eq i32 %conv.i261, 1
  %cmp53.3 = icmp ugt i32 %counter.1312, 752
  %or.cond119.3 = or i1 %cmp53.3, %tobool51.3
  br i1 %or.cond119.3, label %if.end80.loopexit314, label %if.end56.4

if.end56.4:                                       ; preds = %if.end56.3
  %indvars.iv.next322.4 = add nuw nsw i64 %43, 5
  %arrayidx63.4 = getelementptr inbounds %struct.ASPK, ptr %stream, i64 0, i32 3, i64 %indvars.iv.next322.4
  store i8 %.pre336, ptr %arrayidx63.4, align 1
  %tobool51.4 = icmp eq i32 %conv.i261, 2
  %cmp53.4 = icmp ugt i32 %counter.1312, 751
  %or.cond119.4 = or i1 %cmp53.4, %tobool51.4
  br i1 %or.cond119.4, label %if.end80.loopexit314, label %if.end56.5

if.end56.5:                                       ; preds = %if.end56.4
  %indvars.iv.next322.5 = add nuw nsw i64 %43, 6
  %arrayidx63.5 = getelementptr inbounds %struct.ASPK, ptr %stream, i64 0, i32 3, i64 %indvars.iv.next322.5
  store i8 %.pre336, ptr %arrayidx63.5, align 1
  br label %if.end80.loopexit314

if.else68:                                        ; preds = %if.end17
  %44 = load ptr, ptr %decrypt_dict69, align 8
...
if.end80.loopexit:                                ; preds = %if.end38
  %48 = trunc i64 %indvars.iv.next326 to i32
  br label %if.end80

if.end80.loopexit314:                             ; preds = %if.end56.5, %if.end56.4, %if.end56.3, %if.end56.2, %if.end56.1, %if.end56.preheader
  %indvars.iv.next322.lcssa = phi i64 [ %indvars.iv.next322, %if.end56.preheader ], [ %indvars.iv.next322.1, %if.end56.1 ], [ %indvars.iv.next322.2, %if.end56.2 ], [ %indvars.iv.next322.3, %if.end56.3 ], [ %indvars.iv.next322.4, %if.end56.4 ], [ %indvars.iv.next322.5, %if.end56.5 ]
  %49 = trunc i64 %indvars.iv.next322.lcssa to i32
  br label %if.end80
...
if.end80:                                         ; preds = %if.end80.loopexit314, %if.end80.loopexit, %if.else68
  ...
  br i1 %cmp13, label %while.body, label %while.end81
...
if.end96:                                         ; preds = %lor.lhs.false90
  ...
  store i32 0, ptr %dict_ok, align 8
...
for.cond97:                                       ; preds = %if.end96
  ...
  %51 = load i8, ptr %arrayidx104.1, align 1
...
for.cond97.2:                                     ; preds = %for.cond97.1
  ...
  %53 = load i8, ptr %arrayidx104.3, align 1
...
for.cond97.3:                                     ; preds = %for.cond97.2
  ...
  %54 = load i8, ptr %arrayidx104.4, align 1
...
for.cond97.4:                                     ; preds = %for.cond97.3
  ...
  %55 = load i8, ptr %arrayidx104.5, align 1
...
for.cond97.5:                                     ; preds = %for.cond97.4
  ...
  %56 = load i8, ptr %arrayidx104.6, align 1
...
for.cond97.6:                                     ; preds = %for.cond97.5
  ...
  %57 = load i8, ptr %arrayidx104.7, align 1
...
if.then108:                                       ; preds = %for.cond97.6, %for.cond97.5, %for.cond97.4, %for.cond97.3, %for.cond97.2, %for.cond97.1, %for.cond97, %if.end96
  store i32 1, ptr %dict_ok, align 8
  br label %for.end113

for.end113:                                       ; preds = %for.cond97.6, %if.then108
  %58 = load ptr, ptr %decrypt_dict69, align 8
...
cleanup:                                          ; preds = %if.end28, %while.body, %while.body.i.i268, %if.end, %getbits.exit195.thread, %while.end81, %lor.lhs.false, %lor.lhs.false90, %for.end, %for.end113
  %retval.0 = phi i32 [ 1, %for.end113 ], [ 0, %if.end ], [ 0, %for.end ], [ 0, %lor.lhs.false90 ], [ 0, %lor.lhs.false ], [ 0, %while.end81 ], [ 0, %getbits.exit195.thread ], [ 0, %while.body.i.i268 ], [ 0, %while.body ], [ 0, %if.end28 ]
...
if.end27:                                         ; preds = %while.body
  ...
  store i32 %add23, ptr %arrayidx30, align 4
  ...
  store i32 %add35, ptr %arrayidx38, align 4
...
if.end113:                                        ; preds = %if.end102, %if.then44, %if.end27
  ...
  br i1 %exitcond278.not, label %while.end, label %while.body
...
for.body126:                                      ; preds = %for.cond119.preheader, %for.inc165
  ...
  %11 = load i8, ptr %arrayidx128, align 1
...
if.end149:                                        ; preds = %if.end137
  ...
  store i32 %14, ptr %arrayidx158, align 4
  %15 = load i8, ptr %arrayidx128, align 1
  %idxprom161 = zext i8 %15 to i64
  %arrayidx162 = getelementptr inbounds [18 x i32], ptr %dict, i64 0, i64 %idxprom161
  %16 = load i32, ptr %arrayidx162, align 4
  %inc163 = add i32 %16, 1
  store i32 %inc163, ptr %arrayidx162, align 4
...
for.inc165:                                       ; preds = %for.body126, %if.end149
  ...
  br i1 %cmp124, label %for.body126, label %cleanup168
...
if.end.i:                                         ; preds = %while.body.i
  ...
  %shl.i = shl i32 %2, 8
  %3 = load i8, ptr %incdec.ptr15.i, align 1
  %conv.i = zext i8 %3 to i32
  %or.i = or i32 %shl.i, %conv.i
  store i32 %or.i, ptr %hash.i, align 4
  %incdec.ptr.i = getelementptr inbounds i8, ptr %incdec.ptr15.i, i64 1
  store ptr %incdec.ptr.i, ptr %input.i, align 8
  %sub.i = add i32 %1, -8
  store i32 %sub.i, ptr %stream, align 8
