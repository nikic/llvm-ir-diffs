; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_vba_extract.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_vba_extract.c"
...
if.else:                                          ; preds = %for.cond.preheader, %for.inc, %for.inc.1, %for.inc.2, %for.inc.3, %for.inc.4, %for.inc.5, %for.inc.6, %for.inc.7, %for.inc.8, %for.inc.9, %for.inc.10, %for.inc.11, %for.inc.12
  ...
  %6 = load i32, ptr %is_mac51, align 8
  br label %if.end52
...
if.end52:                                         ; preds = %sw.bb, %sw.bb45, %if.else
  ...
  br i1 %cmp.not107.i, label %if.end.lr.ph.i, label %if.then54
...
if.end10.i:                                       ; preds = %if.end6.i
  ...
  %9 = load i16, ptr %length.i, align 2
...
if.end46.i:                                       ; preds = %lor.lhs.false34.i
  ...
  br i1 %cmp48.not.i, label %if.end51.i, label %if.then54

if.end51.i:                                       ; preds = %if.end46.i
  %14 = load i16, ptr %length.i, align 2
  %rev.i91.i = call i16 @llvm.bswap.i16(i16 %14)
  %retval.0.i92.i = select i1 %tobool.not.i.i, i16 %14, i16 %rev.i91.i
  store i16 %retval.0.i92.i, ptr %length.i, align 2
...
vba_read_project_strings.exit:                    ; preds = %if.then4.i, %if.then18.i, %if.then39.i, %if.then44.i
  call void @llvm.lifetime.end.p0(i64 2, ptr nonnull %length.i) #12
  br label %do.body

if.then54:                                        ; preds = %if.end46.i, %cleanup.i, %if.end52, %if.then9.i
  call void @llvm.lifetime.end.p0(i64 2, ptr nonnull %length.i) #12
...
do.cond:                                          ; preds = %do.body
  %16 = load i16, ptr %ffff, align 2
  %cmp64.not = icmp eq i16 %16, -1
  br i1 %cmp64.not, label %do.end, label %do.body
...
if.then88:                                        ; preds = %if.end84
  ...
  store i16 %retval.0.i, ptr %ffff, align 2
...
if.then102:                                       ; preds = %if.end98
  ...
  store i16 %retval.0.i423, ptr %ffff, align 2
...
if.end132:                                        ; preds = %if.end127
  %22 = load i16, ptr %record_count, align 2
  ...
  store ptr %call134, ptr %name135, align 8
...
if.end140:                                        ; preds = %if.end132
  ...
  store ptr %call141, ptr %dir142, align 8
  %23 = load i16, ptr %record_count, align 2
...
if.end153:                                        ; preds = %if.end140
  %26 = load i16, ptr %record_count, align 2
  %conv154 = zext i16 %26 to i32
  store i32 %conv154, ptr %call128, align 8
  %cmp157479.not = icmp eq i16 %26, 0
  br i1 %cmp157479.not, label %for.end285, label %for.body159
...
if.end164:                                        ; preds = %for.body159
  ...
  store i16 %retval.0.i429, ptr %length, align 2
...
if.then192:                                       ; preds = %if.end182
  ...
  store i32 %conv194, ptr %offset, align 4
  %call195 = call ptr @cli_malloc(i64 noundef 18) #12
  %36 = load ptr, ptr %name135, align 8
  %arrayidx198 = getelementptr inbounds ptr, ptr %36, i64 %indvars.iv
  store ptr %call195, ptr %arrayidx198, align 8
  %37 = load ptr, ptr %name135, align 8
  %arrayidx201 = getelementptr inbounds ptr, ptr %37, i64 %indvars.iv
  %38 = load ptr, ptr %arrayidx201, align 8
...
if.end205:                                        ; preds = %if.then192
  ...
  %.pre = load ptr, ptr %name135, align 8
  %arrayidx213.phi.trans.insert = getelementptr inbounds ptr, ptr %.pre, i64 %indvars.iv
  %.pre519 = load ptr, ptr %arrayidx213.phi.trans.insert, align 8
  br label %if.end210

if.end210:                                        ; preds = %if.end205, %if.end182
  %40 = phi ptr [ %.pre519, %if.end205 ], [ %35, %if.end182 ]
...
if.then217:                                       ; preds = %if.end210
  ...
  %42 = load ptr, ptr %name135, align 8
  %arrayidx220 = getelementptr inbounds ptr, ptr %42, i64 %indvars.iv
  %43 = load ptr, ptr %arrayidx220, align 8
...
if.end221:                                        ; preds = %if.end210
  ...
  store i16 %retval.0.i432, ptr %length, align 2
...
if.then273:                                       ; preds = %if.end263
  ...
  %58 = load ptr, ptr %name135, align 8
  %arrayidx276 = getelementptr inbounds ptr, ptr %58, i64 %indvars.iv
  %59 = load ptr, ptr %arrayidx276, align 8
...
if.end277:                                        ; preds = %if.end263
  ...
  store i32 %retval.0.i443, ptr %offset, align 4
  %61 = load ptr, ptr %offset146, align 8
  %arrayidx281 = getelementptr inbounds i32, ptr %61, i64 %indvars.iv
  store i32 %retval.0.i443, ptr %arrayidx281, align 4
  ...
  %63 = load i16, ptr %record_count, align 2
  %64 = zext i16 %63 to i64
  %cmp157 = icmp ult i64 %indvars.iv.next, %64
  br i1 %cmp157, label %for.body159, label %for.end285.loopexit
...
for.end285:                                       ; preds = %for.end285.loopexit, %if.end153, %if.then273, %if.then259, %if.then242, %if.then228, %if.then217, %if.then181, %if.then174, %if.then169
  ...
  %65 = load i16, ptr %record_count, align 2
...
while.cond.preheader:                             ; preds = %for.end285
  %cmp291483 = icmp sgt i32 %i.1455, 0
  br i1 %cmp291483, label %while.body.preheader, label %while.end
...
while.body:                                       ; preds = %while.body.preheader, %while.body
  %indvars.iv515 = phi i64 [ %66, %while.body.preheader ], [ %indvars.iv.next516, %while.body ]
  %indvars.iv.next516 = add nsw i64 %indvars.iv515, -1
  %67 = load ptr, ptr %name135, align 8
  %arrayidx295 = getelementptr inbounds ptr, ptr %67, i64 %indvars.iv.next516
  %68 = load ptr, ptr %arrayidx295, align 8
  call void @free(ptr noundef %68) #12
  %cmp291 = icmp ugt i64 %indvars.iv515, 1
  br i1 %cmp291, label %while.body, label %while.end

while.end:                                        ; preds = %while.body, %while.cond.preheader
  %69 = load ptr, ptr %name135, align 8
  call void @free(ptr noundef %69) #12
  %70 = load ptr, ptr %dir142, align 8
  call void @free(ptr noundef %70) #12
  %71 = load ptr, ptr %offset146, align 8
...
if.then24:                                        ; preds = %for.body
  store i8 %3, ptr %ret.0116, align 1
  br label %for.inc
...
if.then38:                                        ; preds = %if.else
  store i8 95, ptr %ret.0116, align 1
...
if.else45:                                        ; preds = %if.else
  ...
  store i8 %conv69, ptr %incdec.ptr64, align 1
  br label %if.end71
...
for.end:                                          ; preds = %for.inc, %if.end13
  ...
  store i8 0, ptr %ret.0.lcssa, align 1
  br label %cleanup
...
entry:
  ...
  %buffer207 = ptrtoint ptr %buffer to i64
...
vector.memcheck:                                  ; preds = %vector.scevcheck
  ...
  %19 = add i64 %buffer207, %18
  %20 = xor i32 %shr, -1
  %21 = zext i32 %20 to i64
  %22 = add nuw nsw i64 %21, %17
  %23 = and i64 %22, 4095
  %24 = add i64 %23, %buffer207
  %25 = sub i64 %19, %24
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load209 = load <16 x i8>, ptr %30, align 1
  %31 = and i32 %offset.idx, 4095
  %32 = zext i32 %31 to i64
  %33 = getelementptr inbounds [4096 x i8], ptr %buffer, i64 0, i64 %32
  store <16 x i8> %wide.load, ptr %33, align 1
  %34 = getelementptr inbounds i8, ptr %33, i64 16
  store <16 x i8> %wide.load209, ptr %34, align 1
...
for.body57.prol:                                  ; preds = %for.body57.preheader
  ...
  %39 = load i8, ptr %arrayidx.prol, align 1
  ...
  store i8 %39, ptr %arrayidx63.prol, align 1
...
for.body57:                                       ; preds = %for.body57.prol.loopexit, %for.body57
  ...
  store i8 %41, ptr %arrayidx63, align 1
  ...
  %42 = load i8, ptr %arrayidx.1, align 1
  ...
  store i8 %42, ptr %arrayidx63.1, align 1
  %inc64.1 = add nuw nsw i32 %i.0191, 2
  %exitcond.not.1 = icmp eq i32 %inc64.1, %conv54
  br i1 %exitcond.not.1, label %for.inc93, label %for.body57
...
if.then121:                                       ; preds = %if.end119
  ...
  store i32 %conv122, ptr %size, align 4
  br label %if.end123
...
do.cond:                                          ; preds = %do.body
  ...
  br i1 %tobool.not, label %do.body19, label %do.body
...
do.cond25:                                        ; preds = %do.body19
  ...
  br i1 %tobool26.not, label %do.end27, label %do.body19
...
do.cond39:                                        ; preds = %do.body33
  ...
  br i1 %tobool40.not, label %do.end41, label %do.body33
...
if.end55:                                         ; preds = %if.end48
  %5 = load i32, ptr %object_size, align 4
...
if.end.i:                                         ; preds = %while.body.i
  ...
  br i1 %or.cond, label %ole_copy_file_data.exit, label %while.body.i
...
while.cond.preheader.i:                           ; preds = %if.end
  ...
  store i64 %call.i79.i, ptr %atom_header.i, align 8
...
if.end.i.i:                                       ; preds = %if.end40.i, %if.end.i.lr.ph.i
  %0 = load i16, ptr %ver_inst.i.i, align 8
  %1 = trunc i16 %0 to i8
  %conv6.i.i = and i8 %1, 15
  store i8 %conv6.i.i, ptr %version.i.i, align 2
  %2 = lshr i16 %0, 4
  store i16 %2, ptr %instance.i.i, align 4
...
if.end6.i:                                        ; preds = %while.body.i
  %8 = load i16, ptr %type.i.i, align 2
...
if.end15.i:                                       ; preds = %if.then9.i
  %9 = load i32, ptr %ole_id.i, align 4
  %10 = load i32, ptr %length.i.i, align 8
...
if.end24.i.i:                                     ; preds = %if.then23.i.i, %if.end18.i.i
  store ptr %outbuff.i.i, ptr %next_out.i.i, align 8
  store i32 8192, ptr %avail_out.i.i, align 8
  br label %do.body.i.i

do.bodythread-pre-split.i.i:                      ; preds = %if.end69.i.i
  %.pr.i.i = load i32, ptr %avail_out.i.i, align 8
  br label %do.body.i.i
...
if.end41.i.i:                                     ; preds = %if.end37.i.i, %do.body.i.i
  %13 = load i32, ptr %avail_in.i.i, align 8
...
if.then45.i.i:                                    ; preds = %if.end41.i.i
  ...
  store i32 %cond53.i.i, ptr %avail_in.i.i, align 8
  ...
  %14 = load i32, ptr %avail_in.i.i, align 8
...
if.end69.i.i:                                     ; preds = %if.end66.i.i, %if.end41.i.i
  ...
  br i1 %cmp71.i.i, label %do.bodythread-pre-split.i.i, label %do.end.i.i
...
if.end40.i:                                       ; preds = %if.else.i, %ppt_unlzw.exit.i
  ...
  store i64 %call.i.i, ptr %atom_header.i, align 8
  ...
  br i1 %cmp.not.i.i, label %if.end.i.i, label %ppt_read_atom_header.exit.thread.i
...
entry:
  %count.i256 = alloca i16, align 2
  %length.i257 = alloca i8, align 1
...
if.end6:                                          ; preds = %if.end4.i
  %0 = load i32, ptr %macro_len.i, align 4
...
if.end19:                                         ; preds = %if.end10
  %5 = load i32, ptr %macro_len.i, align 4
  %add22 = add i32 %5, %4
  %conv23 = zext i32 %add22 to i64
  %call24285 = call i64 @lseek(i32 noundef %call2, i64 noundef 0, i32 noundef 1) #12
  %cmp25286 = icmp slt i64 %call24285, %conv23
  br i1 %cmp25286, label %while.body, label %while.end.thread

while.end.thread:                                 ; preds = %if.end19
  %call66300 = call i32 @close(i32 noundef %call2) #12
  br label %cleanup

while.body:                                       ; preds = %if.end19, %sw.epilog
  %macro_info.0288 = phi ptr [ %macro_info.1, %sw.epilog ], [ null, %if.end19 ]
...
sw.bb:                                            ; preds = %if.end33
  %tobool35.not = icmp eq ptr %macro_info.0288, null
  br i1 %tobool35.not, label %if.end37, label %if.then36

if.then36:                                        ; preds = %sw.bb
  %macro_entry.i = getelementptr inbounds %struct.macro_info_tag, ptr %macro_info.0288, i64 0, i32 1
  %7 = load ptr, ptr %macro_entry.i, align 8
  call void @free(ptr noundef %7) #12
  call void @free(ptr noundef nonnull %macro_info.0288) #12
  br label %if.end37

if.end37:                                         ; preds = %if.then36, %sw.bb
  %call.i227 = call ptr @cli_malloc(i64 noundef 16) #12
  %tobool.not.i = icmp eq ptr %call.i227, null
  br i1 %tobool.not.i, label %wm_read_macro_info.exit, label %if.end.i228

if.end.i228:                                      ; preds = %if.end37
  %call1.i229 = call i32 @cli_readn(i32 noundef %call2, ptr noundef nonnull %call.i227, i32 noundef 2) #12
  %cmp.not.i230 = icmp eq i32 %call1.i229, 2
  br i1 %cmp.not.i230, label %if.end3.i, label %if.then2.i
...
if.end3.i:                                        ; preds = %if.end.i228
  %8 = load i16, ptr %call.i227, align 8
  %conv.i = zext i16 %8 to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.65, i32 noundef %conv.i) #12
  %9 = load i16, ptr %call.i227, align 8
  %conv9.i = zext i16 %9 to i64
  %mul.i = mul nuw nsw i64 %conv9.i, 24
  %call10.i = call ptr @cli_malloc(i64 noundef %mul.i) #12
  %macro_entry.i232 = getelementptr inbounds %struct.macro_info_tag, ptr %call.i227, i64 0, i32 1
  store ptr %call10.i, ptr %macro_entry.i232, align 8
...
for.cond.preheader.i:                             ; preds = %if.end3.i
  %10 = load i16, ptr %call.i227, align 8
...
if.then22.i:                                      ; preds = %if.end28.i.i, %if.end24.i.i, %if.end20.i.i, %if.end16.i.i, %if.end12.i.i, %if.end8.i.i, %if.end4.i.i, %if.end.i.i, %for.body.i
  ...
  %14 = load ptr, ptr %macro_entry.i232, align 8
...
wm_read_macro_info.exit:                          ; preds = %for.cond.i, %if.end37, %for.cond.preheader.i, %cleanup.sink.split.i
  %retval.0.i231 = phi ptr [ null, %if.end37 ], [ %call.i227, %for.cond.preheader.i ], [ null, %cleanup.sink.split.i ], [ %call.i227, %for.cond.i ]
  %cmp39 = icmp eq ptr %retval.0.i231, null
...
sw.bb43:                                          ; preds = %if.end33
  ...
  br i1 %cmp.not.i234, label %if.end.i236, label %if.then.i

if.end.i236:                                      ; preds = %sw.bb43
  %15 = load i8, ptr %count.i, align 1
  %conv.i237 = zext i8 %15 to i64
  %mul.i238 = mul nuw nsw i64 %conv.i237, 14
  %call2.i = call i64 @lseek(i32 noundef %call2, i64 noundef %mul.i238, i32 noundef 1) #12
  %cmp3.i = icmp eq i64 %call2.i, -1
  br i1 %cmp3.i, label %if.then.i, label %if.end6.i

if.end6.i:                                        ; preds = %if.end.i236
...
if.end12.i:                                       ; preds = %if.end6.i
  %17 = load i8, ptr %count.i, align 1
...
if.end21.i:                                       ; preds = %if.then16.i
  %18 = load i8, ptr %count.i, align 1
...
if.then37.if.end46_crit_edge.i:                   ; preds = %if.then37.i
  %.pre.i = load i8, ptr %count.i, align 1
...
if.then.i:                                        ; preds = %if.then37.i, %if.end27.i, %if.then16.i, %if.end6.i, %if.end.i236, %sw.bb43
  %.str.67.sink = phi ptr [ @.str.67, %sw.bb43 ], [ @.str.68, %if.end.i236 ], [ @.str.70, %if.end6.i ], [ @.str.71, %if.then16.i ], [ @.str.71, %if.end27.i ], [ @.str.72, %if.then37.i ]
...
if.end.i244:                                      ; preds = %sw.bb48
  %21 = load i16, ptr %count.i239, align 2
  %conv3.i = zext i16 %21 to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.75, i32 noundef %conv3.i) #12
  %22 = load i16, ptr %count.i239, align 2
  %tobool.not.i245 = icmp eq i16 %22, 0
  br i1 %tobool.not.i245, label %wm_skip_menu_info.exit, label %if.then4.i

if.then4.i:                                       ; preds = %if.end.i244
  %conv5.i = zext i16 %22 to i64
  %mul.i246 = mul nuw nsw i64 %conv5.i, 12
  %call7.i = call i64 @lseek(i32 noundef %call2, i64 noundef %mul.i246, i32 noundef 1) #12
...
if.then7.i:                                       ; preds = %if.end.i252
  %call8.i254 = call i32 @cli_readn(i32 noundef %call2, ptr noundef nonnull %size.i, i32 noundef 2) #12
  %cmp10.not.i = icmp eq i32 %call8.i254, 2
  br i1 %cmp10.not.i, label %if.then7.if.end15_crit_edge.i, label %if.then12.i

if.then7.if.end15_crit_edge.i:                    ; preds = %if.then7.i
  %.pre.i255 = load i16, ptr %size.i, align 2
  br label %if.end15.i
...
if.end15.i:                                       ; preds = %if.then7.if.end15_crit_edge.i, %if.end.i252
  %25 = phi i16 [ %.pre.i255, %if.then7.if.end15_crit_edge.i ], [ %24, %if.end.i252 ]
  ...
  %add.i253 = add nsw i64 %call.i248, %conv17.i
  %call1850.i = call i64 @lseek(i32 noundef %call2, i64 noundef 0, i32 noundef 1) #12
  %cmp1951.i = icmp slt i64 %call1850.i, %add.i253
  br i1 %cmp1951.i, label %while.body.lr.ph.i, label %wm_skip_macro_extnames.exit

while.body.lr.ph.i:                               ; preds = %if.end15.i
  br i1 %cmp5.not.i, label %while.body.us.i, label %while.body.i

while.body.us.i:                                  ; preds = %while.body.lr.ph.i, %cleanup.us.i
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %length.i) #12
  %call21.us.i = call i32 @cli_readn(i32 noundef %call2, ptr noundef nonnull %length.i, i32 noundef 1) #12
  %cmp22.not.us.i = icmp eq i32 %call21.us.i, 1
  br i1 %cmp22.not.us.i, label %if.end25.us.i, label %cleanup39.critedge.i

if.end25.us.i:                                    ; preds = %while.body.us.i
  %27 = load i8, ptr %length.i, align 1
  %conv27.us.i = zext i8 %27 to i64
  %mul.us.i = shl nuw nsw i64 %conv27.us.i, 1
  %add32.us.i = add nuw nsw i64 %mul.us.i, 3
  %call33.us.i = call i64 @lseek(i32 noundef %call2, i64 noundef %add32.us.i, i32 noundef 1) #12
  %cmp34.us.i = icmp eq i64 %call33.us.i, -1
  br i1 %cmp34.us.i, label %cleanup39.critedge.i, label %cleanup.us.i

cleanup.us.i:                                     ; preds = %if.end25.us.i
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %length.i) #12
  %call18.us.i = call i64 @lseek(i32 noundef %call2, i64 noundef 0, i32 noundef 1) #12
  %cmp19.us.i = icmp slt i64 %call18.us.i, %add.i253
  br i1 %cmp19.us.i, label %while.body.us.i, label %wm_skip_macro_extnames.exit

while.body.i:                                     ; preds = %while.body.lr.ph.i, %cleanup.i
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %length.i) #12
...
if.end25.i:                                       ; preds = %while.body.i
  %28 = load i8, ptr %length.i, align 1
  %conv27.i = zext i8 %28 to i64
  %add32.i = add nuw nsw i64 %conv27.i, 2
...
cleanup.i:                                        ; preds = %if.end25.i
  ...
  %cmp19.i = icmp slt i64 %call18.i, %add.i253
  br i1 %cmp19.i, label %while.body.i, label %wm_skip_macro_extnames.exit

cleanup39.critedge.i:                             ; preds = %if.end25.i, %while.body.i, %if.end25.us.i, %while.body.us.i
  %.str.78.sink.i = phi ptr [ @.str.78, %if.end25.us.i ], [ @.str.76, %while.body.us.i ], [ @.str.78, %if.end25.i ], [ @.str.76, %while.body.i ]
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull %.str.78.sink.i) #12
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %length.i) #12
  br label %29

wm_skip_macro_extnames.exit:                      ; preds = %cleanup.i, %cleanup.us.i, %if.end15.i
  call void @llvm.lifetime.end.p0(i64 2, ptr nonnull %size.i) #12
  br label %sw.epilog

29:                                               ; preds = %if.then.i251, %if.then12.i, %cleanup39.critedge.i
  call void @llvm.lifetime.end.p0(i64 2, ptr nonnull %size.i) #12
  br label %sw.epilog

sw.bb58:                                          ; preds = %if.end33
  call void @llvm.lifetime.start.p0(i64 2, ptr nonnull %count.i256) #12
  %call.i258 = call i32 @cli_readn(i32 noundef %call2, ptr noundef nonnull %count.i256, i32 noundef 2) #12
  %cmp.not.i259 = icmp eq i32 %call.i258, 2
  br i1 %cmp.not.i259, label %if.end.i262, label %if.then.i260

if.then.i260:                                     ; preds = %sw.bb58
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.79) #12
  br label %34

if.end.i262:                                      ; preds = %sw.bb58
  %30 = load i16, ptr %count.i256, align 2
  %conv3.i263 = zext i16 %30 to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.80, i32 noundef %conv3.i263) #12
  %31 = load i16, ptr %count.i256, align 2
  %cmp632.not.i = icmp eq i16 %31, 0
  br i1 %cmp632.not.i, label %wm_skip_macro_intnames.exit, label %for.body.i264

for.body.i264:                                    ; preds = %if.end.i262, %cleanup.i269
  %i.033.i = phi i16 [ %inc.i, %cleanup.i269 ], [ 0, %if.end.i262 ]
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %length.i257) #12
  %call8.i265 = call i64 @lseek(i32 noundef %call2, i64 noundef 2, i32 noundef 1) #12
  %cmp9.i = icmp eq i64 %call8.i265, -1
  br i1 %cmp9.i, label %cleanup26.critedge.i, label %if.end12.i266

if.end12.i266:                                    ; preds = %for.body.i264
  %call13.i = call i32 @cli_readn(i32 noundef %call2, ptr noundef nonnull %length.i257, i32 noundef 1) #12
...
if.end18.i:                                       ; preds = %if.end12.i266
  %32 = load i8, ptr %length.i257, align 1
...
cleanup.i269:                                     ; preds = %if.end18.i
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %length.i257) #12
  %inc.i = add nuw i16 %i.033.i, 1
  %33 = load i16, ptr %count.i256, align 2
  %cmp6.i = icmp ult i16 %inc.i, %33
  br i1 %cmp6.i, label %for.body.i264, label %wm_skip_macro_intnames.exit

cleanup26.critedge.i:                             ; preds = %if.end18.i, %if.end12.i266, %for.body.i264
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.81) #12
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %length.i257) #12
  br label %34

wm_skip_macro_intnames.exit:                      ; preds = %cleanup.i269, %if.end.i262
  call void @llvm.lifetime.end.p0(i64 2, ptr nonnull %count.i256) #12
  br label %sw.epilog

34:                                               ; preds = %if.then.i260, %cleanup26.critedge.i
  call void @llvm.lifetime.end.p0(i64 2, ptr nonnull %count.i256) #12
  br label %sw.epilog
...
sw.epilog:                                        ; preds = %34, %wm_skip_macro_intnames.exit, %29, %wm_skip_macro_extnames.exit, %23, %wm_skip_menu_info.exit, %if.then.i, %wm_read_oxo3.exit, %wm_read_macro_info.exit, %if.end33, %if.end33, %sw.default
  %done.1 = phi i32 [ 1, %sw.default ], [ %spec.select, %wm_read_macro_info.exit ], [ 1, %if.end33 ], [ 1, %if.end33 ], [ 1, %if.then.i ], [ 0, %wm_read_oxo3.exit ], [ 1, %23 ], [ 0, %wm_skip_menu_info.exit ], [ 1, %29 ], [ 0, %wm_skip_macro_extnames.exit ], [ 1, %34 ], [ 0, %wm_skip_macro_intnames.exit ]
  %macro_info.1 = phi ptr [ %macro_info.0288, %sw.default ], [ %retval.0.i231, %wm_read_macro_info.exit ], [ %macro_info.0288, %if.end33 ], [ %macro_info.0288, %if.end33 ], [ %macro_info.0288, %if.then.i ], [ %macro_info.0288, %wm_read_oxo3.exit ], [ %macro_info.0288, %23 ], [ %macro_info.0288, %wm_skip_menu_info.exit ], [ %macro_info.0288, %29 ], [ %macro_info.0288, %wm_skip_macro_extnames.exit ], [ %macro_info.0288, %34 ], [ %macro_info.0288, %wm_skip_macro_intnames.exit ]
...
if.end72:                                         ; preds = %if.then68
  %36 = load i16, ptr %macro_info.1, align 8
  %conv73 = zext i16 %36 to i64
  ...
  store ptr %call74, ptr %name, align 8
...
if.end78:                                         ; preds = %if.end72
  ...
  store ptr %call79, ptr %dir80, align 8
  %37 = load i16, ptr %macro_info.1, align 8
  %conv82 = zext i16 %37 to i64
  ...
  store ptr %call84, ptr %offset, align 8
...
if.end94:                                         ; preds = %if.end78
  %40 = load i16, ptr %macro_info.1, align 8
  %conv96 = zext i16 %40 to i64
  ...
  store ptr %call98, ptr %length, align 8
...
if.then101:                                       ; preds = %if.end94
  ...
  %43 = load ptr, ptr %dir80, align 8
  call void @free(ptr noundef %43) #12
  br label %abort.sink.split

if.end105:                                        ; preds = %if.end94
  %44 = load i16, ptr %macro_info.1, align 8
  %conv107 = zext i16 %44 to i64
...
if.then112:                                       ; preds = %if.end105
  ...
  call void @free(ptr noundef %47) #12
  %48 = load ptr, ptr %dir80, align 8
  call void @free(ptr noundef %48) #12
  br label %abort.sink.split

if.else:                                          ; preds = %if.end105
  %49 = load i16, ptr %macro_info.1, align 8
  %conv118 = zext i16 %49 to i32
  store i32 %conv118, ptr %call69, align 8
  %cmp122293.not = icmp eq i16 %49, 0
  br i1 %cmp122293.not, label %abort, label %for.body.lr.ph
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %arrayidx = getelementptr inbounds ptr, ptr %50, i64 %indvars.iv
  store ptr %call124, ptr %arrayidx, align 8
  %51 = load ptr, ptr %macro_entry, align 8
  %offset128 = getelementptr inbounds %struct.macro_entry_tag, ptr %51, i64 %indvars.iv, i32 8
  %52 = load i32, ptr %offset128, align 4
  %53 = load ptr, ptr %offset, align 8
  %arrayidx131 = getelementptr inbounds i32, ptr %53, i64 %indvars.iv
  store i32 %52, ptr %arrayidx131, align 4
  %len = getelementptr inbounds %struct.macro_entry_tag, ptr %51, i64 %indvars.iv, i32 6
  %54 = load i32, ptr %len, align 4
  %55 = load ptr, ptr %length, align 8
  %arrayidx137 = getelementptr inbounds i32, ptr %55, i64 %indvars.iv
  store i32 %54, ptr %arrayidx137, align 4
  %key141 = getelementptr inbounds %struct.macro_entry_tag, ptr %51, i64 %indvars.iv, i32 1
  %56 = load i8, ptr %key141, align 1
  %57 = load ptr, ptr %key, align 8
  %arrayidx144 = getelementptr inbounds i8, ptr %57, i64 %indvars.iv
  store i8 %56, ptr %arrayidx144, align 1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %58 = load i16, ptr %macro_info.1, align 8
  %59 = zext i16 %58 to i64
  %cmp122 = icmp ult i64 %indvars.iv.next, %59
  br i1 %cmp122, label %for.body, label %abort
...
abort:                                            ; preds = %for.body, %abort.sink.split, %if.else, %if.then68
  ...
  %macro_entry.i270 = getelementptr inbounds %struct.macro_info_tag, ptr %macro_info.1, i64 0, i32 1
  %60 = load ptr, ptr %macro_entry.i270, align 8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load40 = load <16 x i8>, ptr %1, align 1
  %2 = xor <16 x i8> %wide.load, %broadcast.splat
  %3 = xor <16 x i8> %wide.load40, %broadcast.splat
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec42 = and i64 %conv3, 4294967288
  %broadcast.splatinsert46 = insertelement <8 x i8> poison, i8 %key, i64 0
  %broadcast.splat47 = shufflevector <8 x i8> %broadcast.splatinsert46, <8 x i8> poison, <8 x i32> zeroinitializer
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index44 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next48, %vec.epilog.vector.body ]
  %5 = getelementptr inbounds i8, ptr %call4, i64 %index44
  %wide.load45 = load <8 x i8>, ptr %5, align 1
  %6 = xor <8 x i8> %wide.load45, %broadcast.splat47
  store <8 x i8> %6, ptr %5, align 1
  %index.next48 = add nuw i64 %index44, 8
  %7 = icmp eq i64 %index.next48, %n.vec42
  br i1 %7, label %vec.epilog.middle.block, label %vec.epilog.vector.body

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n43 = icmp eq i64 %n.vec42, %conv3
  br i1 %cmp.n43, label %cleanup, label %for.body.preheader
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %xor35 = xor i8 %8, %key
  store i8 %xor35, ptr %arrayidx, align 1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
