; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/shared_cdiff.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/shared_cdiff.c"
...
for.inc.4:                                        ; preds = %for.inc.3
  ...
  br i1 %cmp20.4, label %if.then29, label %for.body
...
if.end97:                                         ; preds = %if.end91
  %8 = load i32, ptr %difflen, align 4
...
if.else175:                                       ; preds = %if.end167
  ...
  br i1 %tobool153.not260, label %while.end178, label %while.body154.lr.ph
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %1 = load ptr, ptr %add_start, align 8
...
while.cond18.preheader:                           ; preds = %while.body10, %while.end
  ...
  %8 = load ptr, ptr %xchg_start, align 8
...
while.body10:                                     ; preds = %while.end, %while.body10
  ...
  %10 = load ptr, ptr %str12, align 8
  tail call void @free(ptr noundef %10) #18
  %11 = load ptr, ptr %del_start, align 8
  %next15 = getelementptr inbounds %struct.cdiff_node, ptr %11, i64 0, i32 3
  %12 = load ptr, ptr %next15, align 8
  store ptr %12, ptr %del_start, align 8
  tail call void @free(ptr noundef %11) #18
  %13 = load ptr, ptr %del_start, align 8
  %tobool9.not = icmp eq ptr %13, null
  br i1 %tobool9.not, label %while.cond18.preheader, label %while.body10
...
for.inc30.i:                                      ; preds = %for.cond18.i
  ...
  %.pre = load i8, ptr %arrayidx20.i.phi.trans.insert, align 1
...
for.body.i:                                       ; preds = %for.body.i.preheader, %for.body.i
  ...
  br i1 %6, label %for.body.i, label %for.end.i
...
for.end32:                                        ; preds = %for.cond18, %for.cond18
  %cmp33 = icmp eq i32 %i.0.lcssa, %j.0
...
for.body:                                         ; preds = %for.cond.preheader, %for.cond
  ...
  %i.050 = phi i32 [ %inc, %for.cond ], [ 0, %for.cond.preheader ]
...
if.end6:                                          ; preds = %if.end
  ...
  %add_last = getelementptr inbounds %struct.cdiff_ctx, ptr %ctx, i64 0, i32 2
  %4 = load ptr, ptr %add_last, align 8
  %tobool7.not = icmp eq ptr %4, null
  br i1 %tobool7.not, label %if.then8, label %if.else

if.then8:                                         ; preds = %if.end6
  store ptr %call2, ptr %add_last, align 8
  %add_start = getelementptr inbounds %struct.cdiff_ctx, ptr %ctx, i64 0, i32 1
  store ptr %call2, ptr %add_start, align 8
  br label %cleanup
...
for.end32.i:                                      ; preds = %for.cond18.i, %for.cond18.i
  %cmp33.i = icmp eq i32 %inc7.i, %j.0.i
  br i1 %cmp33.i, label %if.then, label %if.end36.i
...
if.end:                                           ; preds = %if.end36.i
  ...
  tail call void @free(ptr noundef nonnull %call38.i) #18
  %5 = load i8, ptr %cmdstr, align 1
  %tobool77.i70.not = icmp eq i8 %5, 0
  br i1 %tobool77.i70.not, label %if.then5, label %for.body.i80

for.body.i80:                                     ; preds = %if.end, %for.body.i80
  %6 = phi i8 [ %7, %for.body.i80 ], [ %5, %if.end ]
  %i.080.i81 = phi i32 [ %inc7.i86, %for.body.i80 ], [ 0, %if.end ]
  %counter.079.i82 = phi i32 [ %spec.select.i85, %for.body.i80 ], [ 0, %if.end ]
  ...
  %7 = load i8, ptr %arrayidx.i88, align 1
  %tobool.i89 = icmp ne i8 %7, 0
  %cmp.i90 = icmp ne i32 %spec.select.i85, 2
  %8 = select i1 %tobool.i89, i1 %cmp.i90, i1 false
  br i1 %8, label %for.body.i80, label %for.end.i71

for.end.i71:                                      ; preds = %for.body.i80
  %tobool10.not.i76 = icmp eq i8 %7, 0
  br i1 %tobool10.not.i76, label %if.then5, label %cdiff_token.exit91

cdiff_token.exit91:                               ; preds = %for.end.i71
  %arrayidx.i88.le = getelementptr inbounds i8, ptr %cmdstr, i64 %idxprom.i87
  %call.i78 = tail call noalias ptr @strdup(ptr noundef nonnull %arrayidx.i88.le) #18
  %tobool4.not = icmp eq ptr %call.i78, null
  br i1 %tobool4.not, label %if.then5, label %if.end7

if.then5:                                         ; preds = %if.end, %for.end.i71, %cdiff_token.exit91
...
if.then10:                                        ; preds = %if.end7
  ...
  tail call void @free(ptr noundef nonnull %call.i78) #18
  br label %cleanup

if.end12:                                         ; preds = %if.end7
  %str = getelementptr inbounds %struct.cdiff_node, ptr %call8, i64 0, i32 1
  store ptr %call.i78, ptr %str, align 8
  store i32 %conv.i, ptr %call8, align 8
  %del_start = getelementptr inbounds %struct.cdiff_ctx, ptr %ctx, i64 0, i32 3
  %9 = load ptr, ptr %del_start, align 8
  %tobool14.not = icmp eq ptr %9, null
  br i1 %tobool14.not, label %if.then15, label %if.else

if.then15:                                        ; preds = %if.end12
  store ptr %call8, ptr %del_start, align 8
  br label %cleanup
...
while.body:                                       ; preds = %if.else, %if.end33
  ...
  %11 = load i32, ptr %pt.0106, align 8
...
while.end:                                        ; preds = %land.lhs.true, %lor.lhs.false, %if.end33
  %14 = phi ptr [ null, %land.lhs.true ], [ %12, %lor.lhs.false ], [ null, %if.end33 ]
  ...
  store ptr %14, ptr %next36, align 8
  store ptr %call8, ptr %next35, align 8
  br label %cleanup
...
if.end:                                           ; preds = %if.end36.i
  ...
  br i1 %tobool77.i80.not, label %if.then5, label %for.body.i107

for.body.i107:                                    ; preds = %if.end, %for.body.i107
  %6 = phi i8 [ %7, %for.body.i107 ], [ %5, %if.end ]
  %i.080.i108 = phi i32 [ %inc7.i113, %for.body.i107 ], [ 0, %if.end ]
  %counter.079.i109 = phi i32 [ %spec.select.i112, %for.body.i107 ], [ 0, %if.end ]
  %cmp5.i110 = icmp eq i8 %6, 32
  %inc.i111 = zext i1 %cmp5.i110 to i32
  %spec.select.i112 = add i32 %counter.079.i109, %inc.i111
  %inc7.i113 = add i32 %i.080.i108, 1
  %idxprom.i114 = zext i32 %inc7.i113 to i64
  %arrayidx.i115 = getelementptr inbounds i8, ptr %cmdstr, i64 %idxprom.i114
  %7 = load i8, ptr %arrayidx.i115, align 1
  %tobool.i116 = icmp ne i8 %7, 0
  %cmp.i117 = icmp ne i32 %spec.select.i112, 2
  %8 = select i1 %tobool.i116, i1 %cmp.i117, i1 false
  br i1 %8, label %for.body.i107, label %for.end.i81

for.end.i81:                                      ; preds = %for.body.i107
  %arrayidx.i115.le = getelementptr inbounds i8, ptr %cmdstr, i64 %idxprom.i114
  %tobool10.not.i86 = icmp eq i8 %7, 0
  br i1 %tobool10.not.i86, label %if.then5, label %for.cond18.i88

for.cond18.i88:                                   ; preds = %for.end.i81, %for.inc30.i105
  %9 = phi i8 [ %.pre166, %for.inc30.i105 ], [ %7, %for.end.i81 ]
  %j.0.i89 = phi i32 [ %inc31.i106, %for.inc30.i105 ], [ %inc7.i113, %for.end.i81 ]
  switch i8 %9, label %for.inc30.i105 [
    i8 0, label %for.end32.i92
    i8 32, label %for.end32.i92
  ]

for.inc30.i105:                                   ; preds = %for.cond18.i88
  %inc31.i106 = add i32 %j.0.i89, 1
  %idxprom19.i90.phi.trans.insert = zext i32 %inc31.i106 to i64
  %arrayidx20.i91.phi.trans.insert = getelementptr inbounds i8, ptr %cmdstr, i64 %idxprom19.i90.phi.trans.insert
  %.pre166 = load i8, ptr %arrayidx20.i91.phi.trans.insert, align 1
  br label %for.cond18.i88

for.end32.i92:                                    ; preds = %for.cond18.i88, %for.cond18.i88
  %cmp33.i93 = icmp eq i32 %inc7.i113, %j.0.i89
  br i1 %cmp33.i93, label %if.then5, label %if.end36.i94

if.end36.i94:                                     ; preds = %for.end32.i92
  %sub.i95 = sub i32 %j.0.i89, %inc7.i113
  %add.i96 = add i32 %sub.i95, 1
  %conv37.i97 = zext i32 %add.i96 to i64
  %call38.i98 = tail call noalias ptr @malloc(i64 noundef %conv37.i97) #20
  %tobool39.not.i99 = icmp eq ptr %call38.i98, null
  br i1 %tobool39.not.i99, label %if.then5, label %if.end7

if.then5:                                         ; preds = %if.end, %for.end.i81, %for.end32.i92, %if.end36.i94
  %call6 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.38) #18
  br label %cleanup

if.end7:                                          ; preds = %if.end36.i94
  %conv43.i101 = zext i32 %sub.i95 to i64
  %call44.i102 = tail call ptr @strncpy(ptr noundef nonnull %call38.i98, ptr noundef nonnull %arrayidx.i115.le, i64 noundef %conv43.i101) #18
  %arrayidx47.i103 = getelementptr inbounds i8, ptr %call38.i98, i64 %conv43.i101
  store i8 0, ptr %arrayidx47.i103, align 1
  br label %for.body.i129

for.body.i129:                                    ; preds = %if.end7, %for.body.i129
  %10 = phi i8 [ %11, %for.body.i129 ], [ %5, %if.end7 ]
  %i.080.i130 = phi i32 [ %inc7.i135, %for.body.i129 ], [ 0, %if.end7 ]
  %counter.079.i131 = phi i32 [ %spec.select.i134, %for.body.i129 ], [ 0, %if.end7 ]
  %cmp5.i132 = icmp eq i8 %10, 32
  %inc.i133 = zext i1 %cmp5.i132 to i32
  %spec.select.i134 = add i32 %counter.079.i131, %inc.i133
  %inc7.i135 = add i32 %i.080.i130, 1
  %idxprom.i136 = zext i32 %inc7.i135 to i64
  %arrayidx.i137 = getelementptr inbounds i8, ptr %cmdstr, i64 %idxprom.i136
  %11 = load i8, ptr %arrayidx.i137, align 1
  %tobool.i138 = icmp ne i8 %11, 0
  %cmp.i139 = icmp ne i32 %spec.select.i134, 3
  %12 = select i1 %tobool.i138, i1 %cmp.i139, i1 false
  br i1 %12, label %for.body.i129, label %for.end.i120

for.end.i120:                                     ; preds = %for.body.i129
  %tobool10.not.i125 = icmp eq i8 %11, 0
  br i1 %tobool10.not.i125, label %if.then10, label %cdiff_token.exit140

cdiff_token.exit140:                              ; preds = %for.end.i120
  %arrayidx.i137.le = getelementptr inbounds i8, ptr %cmdstr, i64 %idxprom.i136
  %call.i127 = tail call noalias ptr @strdup(ptr noundef nonnull %arrayidx.i137.le) #18
  %tobool9.not = icmp eq ptr %call.i127, null
  br i1 %tobool9.not, label %if.then10, label %if.end12

if.then10:                                        ; preds = %for.end.i120, %cdiff_token.exit140
  tail call void @free(ptr noundef %call38.i98) #18
...
if.then15:                                        ; preds = %if.end12
  ...
  tail call void @free(ptr noundef %call38.i98) #18
  tail call void @free(ptr noundef nonnull %call.i127) #18
  br label %cleanup

if.end17:                                         ; preds = %if.end12
  %str = getelementptr inbounds %struct.cdiff_node, ptr %call13, i64 0, i32 1
  store ptr %call38.i98, ptr %str, align 8
  %str2 = getelementptr inbounds %struct.cdiff_node, ptr %call13, i64 0, i32 2
  store ptr %call.i127, ptr %str2, align 8
  store i32 %conv.i, ptr %call13, align 8
  %xchg_start = getelementptr inbounds %struct.cdiff_ctx, ptr %ctx, i64 0, i32 4
  %13 = load ptr, ptr %xchg_start, align 8
  %tobool19.not = icmp eq ptr %13, null
  br i1 %tobool19.not, label %if.then20, label %if.else

if.then20:                                        ; preds = %if.end17
  store ptr %call13, ptr %xchg_start, align 8
  br label %cleanup
...
while.body:                                       ; preds = %if.else, %if.end38
  %pt.0163 = phi ptr [ %16, %if.end38 ], [ %13, %if.else ]
  %15 = load i32, ptr %pt.0163, align 8
  %cmp31 = icmp ult i32 %15, %conv.i
  %next32 = getelementptr inbounds %struct.cdiff_node, ptr %pt.0163, i64 0, i32 3
...
while.end:                                        ; preds = %land.lhs.true, %lor.lhs.false, %if.end38
  %18 = phi ptr [ null, %land.lhs.true ], [ %16, %lor.lhs.false ], [ null, %if.end38 ]
  %next40 = getelementptr inbounds %struct.cdiff_node, ptr %pt.0163, i64 0, i32 3
  %next41 = getelementptr inbounds %struct.cdiff_node, ptr %call13, i64 0, i32 3
  store ptr %18, ptr %next41, align 8
  store ptr %call13, ptr %next40, align 8
  br label %cleanup
...
if.end:                                           ; preds = %entry
  ...
  %1 = load ptr, ptr %add_start, align 8
  %del_start = getelementptr inbounds %struct.cdiff_ctx, ptr %ctx, i64 0, i32 3
  %2 = load ptr, ptr %del_start, align 8
  %.fr = freeze ptr %2
  %xchg_start = getelementptr inbounds %struct.cdiff_ctx, ptr %ctx, i64 0, i32 4
  %3 = load ptr, ptr %xchg_start, align 8
  %.fr382 = freeze ptr %3
  %tobool1 = icmp ne ptr %.fr, null
  %tobool2 = icmp ne ptr %.fr382, null
...
while.body:                                       ; preds = %while.cond
  ...
  %5 = load i32, ptr %del.0.ph338, align 8
...
if.end38:                                         ; preds = %if.then26
  ...
  %.fr346 = freeze ptr %8
  %tobool25.not = icmp eq ptr %.fr346, null
  br i1 %tobool25.not, label %while.cond.outer.split.us, label %while.cond.outer.split

while.cond.outer.split.us:                        ; preds = %if.end38, %while.cond.preheader
  %xchg.0.ph.lcssa = phi ptr [ %.fr382, %while.cond.preheader ], [ %.us-phi246, %if.end38 ]
  %lines.0.ph.lcssa = phi i32 [ 0, %while.cond.preheader ], [ %.us-phi247, %if.end38 ]
  %tobool40.not.us430 = icmp eq ptr %xchg.0.ph.lcssa, null
  br i1 %tobool40.not.us430, label %while.cond.us.us.preheader, label %while.cond.us.us292.preheader
...
while.cond.us.us292.preheader:                    ; preds = %while.cond.outer.split.us, %if.end68.us
  %xchg.0.ph217.us.fr432 = phi ptr [ %xchg.0.ph217.us.fr, %if.end68.us ], [ %xchg.0.ph.lcssa, %while.cond.outer.split.us ]
  %lines.0.ph218.us431 = phi i32 [ %inc.us.us297, %if.end68.us ], [ %lines.0.ph.lcssa, %while.cond.outer.split.us ]
  br label %while.cond.us.us292

if.end57.us:                                      ; preds = %if.then44.split.us.us
  %str2.us = getelementptr inbounds %struct.cdiff_node, ptr %xchg.0.ph217.us.fr432, i64 0, i32 2
  %9 = load ptr, ptr %str2.us, align 8
...
if.end68.us:                                      ; preds = %lor.lhs.false60.us
  %next69.us = getelementptr inbounds %struct.cdiff_node, ptr %xchg.0.ph217.us.fr432, i64 0, i32 3
  %10 = load ptr, ptr %next69.us, align 8
  %xchg.0.ph217.us.fr = freeze ptr %10
  %tobool40.not.us = icmp eq ptr %xchg.0.ph217.us.fr, null
  br i1 %tobool40.not.us, label %while.cond.us.us.preheader, label %while.cond.us.us292.preheader

while.cond.us.us292:                              ; preds = %while.cond.us.us292.preheader, %if.end70.us.us298
  %lines.0.us.us293 = phi i32 [ %inc.us.us297, %if.end70.us.us298 ], [ %lines.0.ph218.us431, %while.cond.us.us292.preheader ]
...
while.body.us.us296:                              ; preds = %while.cond.us.us292
  ...
  %11 = load i32, ptr %xchg.0.ph217.us.fr432, align 8
...
if.end70.us.us298:                                ; preds = %while.body.us.us296
  ...
  br i1 %cmp73.us.us300, label %if.then74, label %while.cond.us.us292

if.then44.split.us.us:                            ; preds = %while.body.us.us296
  %str46.us = getelementptr inbounds %struct.cdiff_node, ptr %xchg.0.ph217.us.fr432, i64 0, i32 1
  %12 = load ptr, ptr %str46.us, align 8
...
while.cond.outer.split:                           ; preds = %while.cond.preheader, %if.end38
  ...
  %xchg.0.ph339 = phi ptr [ %.us-phi246, %if.end38 ], [ %.fr382, %while.cond.preheader ]
  %del.0.ph338 = phi ptr [ %.fr346, %if.end38 ], [ %.fr, %while.cond.preheader ]
...
if.end39:                                         ; preds = %while.body
  %13 = load i32, ptr %xchg.0.ph217333, align 8
...
if.end68:                                         ; preds = %lor.lhs.false60
  ...
  %.fr345 = freeze ptr %17
  %tobool40.not = icmp eq ptr %.fr345, null
  br i1 %tobool40.not, label %while.cond.us232.preheader, label %while.cond.outer216.split.split
...
while.body.us.us:                                 ; preds = %while.cond.us.us
  ...
  br i1 %cmp73.us.us, label %if.then74, label %while.cond.us.us
...
while.body.us236:                                 ; preds = %while.cond.us232
  ...
  %18 = load i32, ptr %del.0.ph338, align 8
...
if.end70.us239:                                   ; preds = %while.body.us236
  ...
  br i1 %cmp73.us241, label %if.then74, label %while.cond.us232
...
while.cond.outer216.split.split:                  ; preds = %while.cond.outer.split, %if.end68
  ...
  %xchg.0.ph217333 = phi ptr [ %.fr345, %if.end68 ], [ %xchg.0.ph339, %while.cond.outer.split ]
  br label %while.cond
...
while.end:                                        ; preds = %while.cond.us232, %while.cond, %while.cond.us.us292, %while.cond.us.us
  %.us-phi = phi i1 [ false, %while.cond.us.us ], [ false, %while.cond.us.us292 ], [ true, %while.cond ], [ true, %while.cond.us232 ]
  %.us-phi230 = phi i1 [ false, %while.cond.us.us ], [ true, %while.cond.us.us292 ], [ true, %while.cond ], [ false, %while.cond.us232 ]
  %call80 = call i32 @fclose(ptr noundef nonnull %call5)
  %call81 = call i32 @fclose(ptr noundef nonnull %call17)
  %or.cond140 = or i1 %.us-phi, %.us-phi230
...
while.body117:                                    ; preds = %if.then107, %if.end128
  %add.0344 = phi ptr [ %26, %if.end128 ], [ %1, %if.then107 ]
  %str118 = getelementptr inbounds %struct.cdiff_node, ptr %add.0344, i64 0, i32 1
  %24 = load ptr, ptr %str118, align 8
...
if.end128:                                        ; preds = %lor.lhs.false121
  %next129 = getelementptr inbounds %struct.cdiff_node, ptr %add.0344, i64 0, i32 3
  %26 = load ptr, ptr %next129, align 8
  %tobool116.not = icmp eq ptr %26, null
  br i1 %tobool116.not, label %while.end130, label %while.body117
...
if.end6:                                          ; preds = %if.end36.i
  ...
  %conv.i = trunc i64 %call.i to i32
  tail call void @free(ptr noundef nonnull %call38.i) #18
  %6 = load i8, ptr %cmdstr, align 1
  %tobool77.i258.not = icmp eq i8 %6, 0
  br i1 %tobool77.i258.not, label %if.then10, label %for.body.i285

for.body.i285:                                    ; preds = %if.end6, %for.body.i285
  %7 = phi i8 [ %8, %for.body.i285 ], [ %6, %if.end6 ]
  %i.080.i286 = phi i32 [ %inc7.i291, %for.body.i285 ], [ 0, %if.end6 ]
  %counter.079.i287 = phi i32 [ %spec.select.i290, %for.body.i285 ], [ 0, %if.end6 ]
  %cmp5.i288 = icmp eq i8 %7, 32
  %inc.i289 = zext i1 %cmp5.i288 to i32
  %spec.select.i290 = add i32 %counter.079.i287, %inc.i289
  %inc7.i291 = add i32 %i.080.i286, 1
  %idxprom.i292 = zext i32 %inc7.i291 to i64
  %arrayidx.i293 = getelementptr inbounds i8, ptr %cmdstr, i64 %idxprom.i292
  %8 = load i8, ptr %arrayidx.i293, align 1
  %tobool.i294 = icmp ne i8 %8, 0
  %cmp.i295 = icmp ne i32 %spec.select.i290, 5
  %9 = select i1 %tobool.i294, i1 %cmp.i295, i1 false
  br i1 %9, label %for.body.i285, label %for.end.i259

for.end.i259:                                     ; preds = %for.body.i285
  %arrayidx.i293.le = getelementptr inbounds i8, ptr %cmdstr, i64 %idxprom.i292
  %tobool10.not.i264 = icmp eq i8 %8, 0
  br i1 %tobool10.not.i264, label %if.then10, label %for.cond18.i266

for.cond18.i266:                                  ; preds = %for.end.i259, %for.inc30.i283
  %10 = phi i8 [ %.pre473, %for.inc30.i283 ], [ %8, %for.end.i259 ]
  %j.0.i267 = phi i32 [ %inc31.i284, %for.inc30.i283 ], [ %inc7.i291, %for.end.i259 ]
  switch i8 %10, label %for.inc30.i283 [
    i8 0, label %for.end32.i270
    i8 32, label %for.end32.i270
  ]

for.inc30.i283:                                   ; preds = %for.cond18.i266
  %inc31.i284 = add i32 %j.0.i267, 1
  %idxprom19.i268.phi.trans.insert = zext i32 %inc31.i284 to i64
  %arrayidx20.i269.phi.trans.insert = getelementptr inbounds i8, ptr %cmdstr, i64 %idxprom19.i268.phi.trans.insert
  %.pre473 = load i8, ptr %arrayidx20.i269.phi.trans.insert, align 1
  br label %for.cond18.i266

for.end32.i270:                                   ; preds = %for.cond18.i266, %for.cond18.i266
  %cmp33.i271 = icmp eq i32 %inc7.i291, %j.0.i267
  br i1 %cmp33.i271, label %if.then10, label %if.end36.i272

if.end36.i272:                                    ; preds = %for.end32.i270
  %sub.i273 = sub i32 %j.0.i267, %inc7.i291
  %add.i274 = add i32 %sub.i273, 1
  %conv37.i275 = zext i32 %add.i274 to i64
  %call38.i276 = tail call noalias ptr @malloc(i64 noundef %conv37.i275) #20
  %tobool39.not.i277 = icmp eq ptr %call38.i276, null
  br i1 %tobool39.not.i277, label %if.then10, label %if.end12

if.then10:                                        ; preds = %if.end6, %for.end.i259, %for.end32.i270, %if.end36.i272
  %call11 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.56) #18
  br label %cleanup

if.end12:                                         ; preds = %if.end36.i272
  %conv43.i279 = zext i32 %sub.i273 to i64
  %call44.i280 = tail call ptr @strncpy(ptr noundef nonnull %call38.i276, ptr noundef nonnull %arrayidx.i293.le, i64 noundef %conv43.i279) #18
  %arrayidx47.i281 = getelementptr inbounds i8, ptr %call38.i276, i64 %conv43.i279
  store i8 0, ptr %arrayidx47.i281, align 1
  %call.i297 = tail call i64 @strtol(ptr nocapture noundef nonnull %call38.i276, ptr noundef null, i32 noundef 10) #18
  %conv.i298 = trunc i64 %call.i297 to i32
  tail call void @free(ptr noundef nonnull %call38.i276) #18
...
if.end16:                                         ; preds = %if.end12
  %11 = load i8, ptr %cmdstr, align 1
  %tobool77.i299.not = icmp eq i8 %11, 0
  br i1 %tobool77.i299.not, label %if.then19, label %for.body.i326

for.body.i326:                                    ; preds = %if.end16, %for.body.i326
  %12 = phi i8 [ %13, %for.body.i326 ], [ %11, %if.end16 ]
  %i.080.i327 = phi i32 [ %inc7.i332, %for.body.i326 ], [ 0, %if.end16 ]
  %counter.079.i328 = phi i32 [ %spec.select.i331, %for.body.i326 ], [ 0, %if.end16 ]
  %cmp5.i329 = icmp eq i8 %12, 32
  %inc.i330 = zext i1 %cmp5.i329 to i32
  %spec.select.i331 = add i32 %counter.079.i328, %inc.i330
  %inc7.i332 = add i32 %i.080.i327, 1
  %idxprom.i333 = zext i32 %inc7.i332 to i64
  %arrayidx.i334 = getelementptr inbounds i8, ptr %cmdstr, i64 %idxprom.i333
  %13 = load i8, ptr %arrayidx.i334, align 1
  %tobool.i335 = icmp ne i8 %13, 0
  %cmp.i336 = icmp ne i32 %spec.select.i331, 4
  %14 = select i1 %tobool.i335, i1 %cmp.i336, i1 false
  br i1 %14, label %for.body.i326, label %for.end.i300

for.end.i300:                                     ; preds = %for.body.i326
  %arrayidx.i334.le = getelementptr inbounds i8, ptr %cmdstr, i64 %idxprom.i333
  %tobool10.not.i305 = icmp eq i8 %13, 0
  br i1 %tobool10.not.i305, label %if.then19, label %for.cond18.i307

for.cond18.i307:                                  ; preds = %for.end.i300, %for.inc30.i324
  %15 = phi i8 [ %.pre474, %for.inc30.i324 ], [ %13, %for.end.i300 ]
  %j.0.i308 = phi i32 [ %inc31.i325, %for.inc30.i324 ], [ %inc7.i332, %for.end.i300 ]
  switch i8 %15, label %for.inc30.i324 [
    i8 0, label %for.end32.i311
    i8 32, label %for.end32.i311
  ]

for.inc30.i324:                                   ; preds = %for.cond18.i307
  %inc31.i325 = add i32 %j.0.i308, 1
  %idxprom19.i309.phi.trans.insert = zext i32 %inc31.i325 to i64
  %arrayidx20.i310.phi.trans.insert = getelementptr inbounds i8, ptr %cmdstr, i64 %idxprom19.i309.phi.trans.insert
  %.pre474 = load i8, ptr %arrayidx20.i310.phi.trans.insert, align 1
  br label %for.cond18.i307

for.end32.i311:                                   ; preds = %for.cond18.i307, %for.cond18.i307
  %cmp33.i312 = icmp eq i32 %inc7.i332, %j.0.i308
  br i1 %cmp33.i312, label %if.then19, label %if.end36.i313

if.end36.i313:                                    ; preds = %for.end32.i311
  %sub.i314 = sub i32 %j.0.i308, %inc7.i332
  %add.i315 = add i32 %sub.i314, 1
  %conv37.i316 = zext i32 %add.i315 to i64
  %call38.i317 = tail call noalias ptr @malloc(i64 noundef %conv37.i316) #20
  %tobool39.not.i318 = icmp eq ptr %call38.i317, null
  br i1 %tobool39.not.i318, label %if.then19, label %if.end21

if.then19:                                        ; preds = %if.end16, %for.end.i300, %for.end32.i311, %if.end36.i313
  %call20 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.58) #18
  br label %cleanup

if.end21:                                         ; preds = %if.end36.i313
  %conv43.i320 = zext i32 %sub.i314 to i64
  %call44.i321 = tail call ptr @strncpy(ptr noundef nonnull %call38.i317, ptr noundef nonnull %arrayidx.i334.le, i64 noundef %conv43.i320) #18
  %arrayidx47.i322 = getelementptr inbounds i8, ptr %call38.i317, i64 %conv43.i320
  store i8 0, ptr %arrayidx47.i322, align 1
  br label %for.body.i365

for.body.i365:                                    ; preds = %if.end21, %for.body.i365
  %16 = phi i8 [ %17, %for.body.i365 ], [ %11, %if.end21 ]
  %i.080.i366 = phi i32 [ %inc7.i371, %for.body.i365 ], [ 0, %if.end21 ]
  %counter.079.i367 = phi i32 [ %spec.select.i370, %for.body.i365 ], [ 0, %if.end21 ]
  %cmp5.i368 = icmp eq i8 %16, 32
  %inc.i369 = zext i1 %cmp5.i368 to i32
  %spec.select.i370 = add i32 %counter.079.i367, %inc.i369
  %inc7.i371 = add i32 %i.080.i366, 1
  %idxprom.i372 = zext i32 %inc7.i371 to i64
  %arrayidx.i373 = getelementptr inbounds i8, ptr %cmdstr, i64 %idxprom.i372
  %17 = load i8, ptr %arrayidx.i373, align 1
  %tobool.i374 = icmp ne i8 %17, 0
  %cmp.i375 = icmp ne i32 %spec.select.i370, 6
  %18 = select i1 %tobool.i374, i1 %cmp.i375, i1 false
  br i1 %18, label %for.body.i365, label %for.end.i339

for.end.i339:                                     ; preds = %for.body.i365
  %arrayidx.i373.le = getelementptr inbounds i8, ptr %cmdstr, i64 %idxprom.i372
  %tobool10.not.i344 = icmp eq i8 %17, 0
  br i1 %tobool10.not.i344, label %if.then24, label %for.cond18.i346

for.cond18.i346:                                  ; preds = %for.end.i339, %for.inc30.i363
  %19 = phi i8 [ %.pre475, %for.inc30.i363 ], [ %17, %for.end.i339 ]
  %j.0.i347 = phi i32 [ %inc31.i364, %for.inc30.i363 ], [ %inc7.i371, %for.end.i339 ]
  switch i8 %19, label %for.inc30.i363 [
    i8 0, label %for.end32.i350
    i8 32, label %for.end32.i350
  ]

for.inc30.i363:                                   ; preds = %for.cond18.i346
  %inc31.i364 = add i32 %j.0.i347, 1
  %idxprom19.i348.phi.trans.insert = zext i32 %inc31.i364 to i64
  %arrayidx20.i349.phi.trans.insert = getelementptr inbounds i8, ptr %cmdstr, i64 %idxprom19.i348.phi.trans.insert
  %.pre475 = load i8, ptr %arrayidx20.i349.phi.trans.insert, align 1
  br label %for.cond18.i346

for.end32.i350:                                   ; preds = %for.cond18.i346, %for.cond18.i346
  %cmp33.i351 = icmp eq i32 %inc7.i371, %j.0.i347
  br i1 %cmp33.i351, label %if.then24, label %if.end36.i352

if.end36.i352:                                    ; preds = %for.end32.i350
  %sub.i353 = sub i32 %j.0.i347, %inc7.i371
  %add.i354 = add i32 %sub.i353, 1
  %conv37.i355 = zext i32 %add.i354 to i64
  %call38.i356 = tail call noalias ptr @malloc(i64 noundef %conv37.i355) #20
  %tobool39.not.i357 = icmp eq ptr %call38.i356, null
  br i1 %tobool39.not.i357, label %if.then24, label %if.end26

if.then24:                                        ; preds = %for.end.i339, %for.end32.i350, %if.end36.i352
  %call25 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.59) #18
  tail call void @free(ptr noundef %call38.i317) #18
  br label %cleanup

if.end26:                                         ; preds = %if.end36.i352
  %conv43.i359 = zext i32 %sub.i353 to i64
  %call44.i360 = tail call ptr @strncpy(ptr noundef nonnull %call38.i356, ptr noundef nonnull %arrayidx.i373.le, i64 noundef %conv43.i359) #18
  %arrayidx47.i361 = getelementptr inbounds i8, ptr %call38.i356, i64 %conv43.i359
  store i8 0, ptr %arrayidx47.i361, align 1
  br label %for.body.i404

for.body.i404:                                    ; preds = %if.end26, %for.body.i404
  %20 = phi i8 [ %21, %for.body.i404 ], [ %11, %if.end26 ]
  %i.080.i405 = phi i32 [ %inc7.i410, %for.body.i404 ], [ 0, %if.end26 ]
  %counter.079.i406 = phi i32 [ %spec.select.i409, %for.body.i404 ], [ 0, %if.end26 ]
  %cmp5.i407 = icmp eq i8 %20, 32
  %inc.i408 = zext i1 %cmp5.i407 to i32
  %spec.select.i409 = add i32 %counter.079.i406, %inc.i408
  %inc7.i410 = add i32 %i.080.i405, 1
  %idxprom.i411 = zext i32 %inc7.i410 to i64
  %arrayidx.i412 = getelementptr inbounds i8, ptr %cmdstr, i64 %idxprom.i411
  %21 = load i8, ptr %arrayidx.i412, align 1
  %tobool.i413 = icmp ne i8 %21, 0
  %cmp.i414 = icmp ne i32 %spec.select.i409, 1
  %22 = select i1 %tobool.i413, i1 %cmp.i414, i1 false
  br i1 %22, label %for.body.i404, label %for.end.i378

for.end.i378:                                     ; preds = %for.body.i404
  %arrayidx.i412.le = getelementptr inbounds i8, ptr %cmdstr, i64 %idxprom.i411
  %tobool10.not.i383 = icmp eq i8 %21, 0
  br i1 %tobool10.not.i383, label %if.then29, label %for.cond18.i385

for.cond18.i385:                                  ; preds = %for.end.i378, %for.inc30.i402
  %23 = phi i8 [ %.pre476, %for.inc30.i402 ], [ %21, %for.end.i378 ]
  %j.0.i386 = phi i32 [ %inc31.i403, %for.inc30.i402 ], [ %inc7.i410, %for.end.i378 ]
  switch i8 %23, label %for.inc30.i402 [
    i8 0, label %for.end32.i389
    i8 32, label %for.end32.i389
  ]

for.inc30.i402:                                   ; preds = %for.cond18.i385
  %inc31.i403 = add i32 %j.0.i386, 1
  %idxprom19.i387.phi.trans.insert = zext i32 %inc31.i403 to i64
  %arrayidx20.i388.phi.trans.insert = getelementptr inbounds i8, ptr %cmdstr, i64 %idxprom19.i387.phi.trans.insert
  %.pre476 = load i8, ptr %arrayidx20.i388.phi.trans.insert, align 1
  br label %for.cond18.i385

for.end32.i389:                                   ; preds = %for.cond18.i385, %for.cond18.i385
  %cmp33.i390 = icmp eq i32 %inc7.i410, %j.0.i386
  br i1 %cmp33.i390, label %if.then29, label %if.end36.i391

if.end36.i391:                                    ; preds = %for.end32.i389
  %sub.i392 = sub i32 %j.0.i386, %inc7.i410
  %add.i393 = add i32 %sub.i392, 1
  %conv37.i394 = zext i32 %add.i393 to i64
  %call38.i395 = tail call noalias ptr @malloc(i64 noundef %conv37.i394) #20
  %tobool39.not.i396 = icmp eq ptr %call38.i395, null
  br i1 %tobool39.not.i396, label %if.then29, label %if.end31

if.then29:                                        ; preds = %for.end.i378, %for.end32.i389, %if.end36.i391
  %call30 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.60) #18
  tail call void @free(ptr noundef %call38.i317) #18
  tail call void @free(ptr noundef %call38.i356) #18
  br label %cleanup

if.end31:                                         ; preds = %if.end36.i391
  %conv43.i398 = zext i32 %sub.i392 to i64
  %call44.i399 = tail call ptr @strncpy(ptr noundef nonnull %call38.i395, ptr noundef nonnull %arrayidx.i412.le, i64 noundef %conv43.i398) #18
  %arrayidx47.i400 = getelementptr inbounds i8, ptr %call38.i395, i64 %conv43.i398
  store i8 0, ptr %arrayidx47.i400, align 1
  %call32 = tail call noalias ptr @fopen(ptr noundef nonnull %call38.i395, ptr noundef nonnull @.str.13)
  %tobool33.not = icmp eq ptr %call32, null
  br i1 %tobool33.not, label %if.then34, label %if.end36

if.then34:                                        ; preds = %if.end31
  %call35 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.61, ptr noundef nonnull %call38.i395) #18
  tail call void @free(ptr noundef %call38.i317) #18
  tail call void @free(ptr noundef %call38.i356) #18
  tail call void @free(ptr noundef nonnull %call38.i395) #18
  br label %cleanup
...
if.then66:                                        ; preds = %while.body
  %call68 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call38.i317) #19
  %call69 = call i32 @strncmp(ptr noundef nonnull %line, ptr noundef nonnull %call38.i317, i64 noundef %call68) #19
  %tobool70.not = icmp eq i32 %call69, 0
  br i1 %tobool70.not, label %do.body, label %if.then71

if.then71:                                        ; preds = %if.then66
  call void @free(ptr noundef %call38.i317) #18
  call void @free(ptr noundef %call38.i356) #18
  call void @free(ptr noundef %call38.i395) #18
...
land.rhs:                                         ; preds = %land.lhs.true
  ...
  br i1 %tobool93.not, label %do.end, label %do.body
...
do.end:                                           ; preds = %land.lhs.true, %do.cond, %land.rhs
  ...
  call void @free(ptr noundef %dstdb.0.ph) #18
  call void @free(ptr noundef %call38.i317) #18
  %call96 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call38.i356) #19
  %call97 = call i32 @strncmp(ptr noundef nonnull %line, ptr noundef nonnull %call38.i356, i64 noundef %call96) #19
  %tobool98.not = icmp eq i32 %call97, 0
  call void @free(ptr noundef %call38.i356) #18
  br i1 %tobool98.not, label %while.cond.outer, label %if.then99
...
if.end105:                                        ; preds = %while.body
  ...
  br i1 %cmp108, label %if.then109, label %while.cond
...
if.then118:                                       ; preds = %while.end
  ...
  call void @free(ptr noundef %call49) #18
  %call121 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.68, ptr noundef %call38.i395, ptr noundef nonnull %dstdb.0.ph) #18
  call void @free(ptr noundef %call38.i395) #18
  call void @free(ptr noundef nonnull %dstdb.0.ph) #18
  br label %cleanup

if.end122:                                        ; preds = %while.end
  %call123 = call i32 @unlink(ptr noundef %call38.i395) #18
  %cmp124 = icmp eq i32 %call123, -1
  br i1 %cmp124, label %if.then125, label %if.end128

if.then125:                                       ; preds = %if.end122
  %call126 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.69, ptr noundef %call38.i395) #18
  call void @free(ptr noundef %call38.i395) #18
...
if.end128:                                        ; preds = %if.end122
  %call129 = call i32 @rename(ptr noundef %call49, ptr noundef %call38.i395) #18
  %cmp130 = icmp eq i32 %call129, -1
  br i1 %cmp130, label %if.then131, label %if.end134

if.then131:                                       ; preds = %if.end128
  %call132 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.70, ptr noundef %call49, ptr noundef %call38.i395) #18
  call void @free(ptr noundef %call38.i395) #18
...
for.body:                                         ; preds = %for.cond.preheader, %for.cond
  ...
  %i.055 = phi i32 [ %inc, %for.cond ], [ 0, %for.cond.preheader ]
