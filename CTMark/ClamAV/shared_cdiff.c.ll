...
for.body.i80:                                     ; preds = %if.end, %for.body.i80
  ...
  br i1 %8, label %for.body.i80, label %for.end.i71, !llvm.loop !38
...
if.end12:                                         ; preds = %if.end7
  ...
  store ptr %call.i78, ptr %str, align 8, !tbaa !23
...
for.inc30.i105:                                   ; preds = %for.cond18.i88
  ...
  %.pre166 = load i8, ptr %arrayidx20.i91.phi.trans.insert, align 1, !tbaa !5
  br label %for.cond18.i88, !llvm.loop !33
...
if.end7:                                          ; preds = %if.end36.i94
  ...
  store i8 0, ptr %arrayidx47.i103, align 1, !tbaa !5
...
if.end17:                                         ; preds = %if.end12
  ...
  store ptr %call38.i98, ptr %str, align 8, !tbaa !23
  %str2 = getelementptr inbounds %struct.cdiff_node, ptr %call13, i64 0, i32 2
  store ptr %call.i127, ptr %str2, align 8, !tbaa !31
...
while.body:                                       ; preds = %if.else, %if.end38
  ...
  %15 = load i32, ptr %pt.0163, align 8, !tbaa !42
...
while.body.us.us296:                              ; preds = %while.cond.us.us292
  ...
  %11 = load i32, ptr %xchg.0.ph217.us.fr432, align 8, !tbaa !42
...
for.inc30.i283:                                   ; preds = %for.cond18.i266
  ...
  %.pre473 = load i8, ptr %arrayidx20.i269.phi.trans.insert, align 1, !tbaa !5
  br label %for.cond18.i266, !llvm.loop !33
...
if.end12:                                         ; preds = %if.end36.i272
  ...
  store i8 0, ptr %arrayidx47.i281, align 1, !tbaa !5
...
for.inc30.i324:                                   ; preds = %for.cond18.i307
  ...
  %.pre474 = load i8, ptr %arrayidx20.i310.phi.trans.insert, align 1, !tbaa !5
  br label %for.cond18.i307, !llvm.loop !33
...
if.end21:                                         ; preds = %if.end36.i313
  ...
  store i8 0, ptr %arrayidx47.i322, align 1, !tbaa !5
...
for.inc30.i363:                                   ; preds = %for.cond18.i346
  ...
  %.pre475 = load i8, ptr %arrayidx20.i349.phi.trans.insert, align 1, !tbaa !5
  br label %for.cond18.i346, !llvm.loop !33
...
if.end26:                                         ; preds = %if.end36.i352
  ...
  store i8 0, ptr %arrayidx47.i361, align 1, !tbaa !5
...
for.inc30.i402:                                   ; preds = %for.cond18.i385
  ...
  %.pre476 = load i8, ptr %arrayidx20.i388.phi.trans.insert, align 1, !tbaa !5
  br label %for.cond18.i385, !llvm.loop !33
...
if.end31:                                         ; preds = %if.end36.i391
  ...
  store i8 0, ptr %arrayidx47.i400, align 1, !tbaa !5
