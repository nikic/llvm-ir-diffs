; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/clamscan_clamscan.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/clamscan_clamscan.c"
...
entry:
  ...
  %0 = load ptr, ptr @clamscan_shortopt, align 8
...
if.then48:                                        ; preds = %if.end45
  ...
  store ptr %call49, ptr @logg_file, align 8
...
if.then128:                                       ; preds = %land.lhs.true125
  ...
  %2 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 1), align 4
  %call143 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.33, i32 noundef %2) #6
  %3 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 2), align 8
...
if.end149:                                        ; preds = %if.then147, %if.then128
  %6 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 5), align 4
...
if.then151:                                       ; preds = %if.end149
  ...
  %7 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 5), align 4
...
if.end156:                                        ; preds = %if.then151, %if.end149
  %8 = load i64, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 6), align 8
  %mul = shl i64 %8, 2
