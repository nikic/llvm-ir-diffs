; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_table.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_table.c"
...
while.body:                                       ; preds = %entry, %if.end
  ...
  %2 = load ptr, ptr %tableItem.09, align 8
...
entry:
  ...
  %.pr.pre = load ptr, ptr %table, align 8
...
for.body.i:                                       ; preds = %for.cond.preheader.i, %for.inc.i
  ...
  %0 = load ptr, ptr %tableItem.015.i, align 8
...
for.inc.i:                                        ; preds = %land.lhs.true.i, %for.body.i
  ...
  %tableItem.0.i = load ptr, ptr %next.i, align 8
...
if.then3:                                         ; preds = %for.cond.preheader.i, %if.end
  ...
  store ptr %call4, ptr %tableLast, align 8
  br label %if.end23
...
for.body:                                         ; preds = %if.else, %for.inc
  %tableItem.067 = phi ptr [ %4, %for.inc ], [ %.pr.pre, %if.else ]
  %3 = load ptr, ptr %tableItem.067, align 8
  %cmp10 = icmp eq ptr %3, null
  br i1 %cmp10, label %cleanup, label %for.inc

for.inc:                                          ; preds = %for.body
  %next = getelementptr inbounds %struct.tableEntry, ptr %tableItem.067, i64 0, i32 2
  %4 = load ptr, ptr %next, align 8
  %tobool8.not = icmp eq ptr %4, null
  br i1 %tobool8.not, label %cleanup.thread, label %for.body
...
cleanup:                                          ; preds = %for.body
  ...
  store ptr %call12, ptr %tableItem.067, align 8
  %value14 = getelementptr inbounds %struct.tableEntry, ptr %tableItem.067, i64 0, i32 1
  store i32 %value, ptr %value14, align 8
  br label %cleanup35
...
if.end18:                                         ; preds = %cleanup.thread, %if.else
  ...
  %5 = load ptr, ptr %tableLast20, align 8
  %next21 = getelementptr inbounds %struct.tableEntry, ptr %5, i64 0, i32 2
  store ptr %call19, ptr %next21, align 8
  store ptr %call19, ptr %tableLast20, align 8
  br label %if.end23
...
if.end27:                                         ; preds = %if.end23
  ...
  %7 = load ptr, ptr %tableLast24, align 8
  store ptr %call30, ptr %7, align 8
  %value34 = getelementptr inbounds %struct.tableEntry, ptr %7, i64 0, i32 1
  store i32 %value, ptr %value34, align 8
  br label %cleanup35
...
for.cond.preheader:                               ; preds = %entry
  %tableItem.013 = load ptr, ptr %table, align 8
...
for.body:                                         ; preds = %for.cond.preheader, %for.inc
  ...
  %0 = load ptr, ptr %tableItem.015, align 8
...
for.inc:                                          ; preds = %for.body, %land.lhs.true
  ...
  %tableItem.0 = load ptr, ptr %next, align 8
...
for.cond.preheader:                               ; preds = %entry
  %tableItem.018 = load ptr, ptr %table, align 8
...
for.body:                                         ; preds = %for.cond.preheader, %for.inc
  ...
  %0 = load ptr, ptr %tableItem.020, align 8
  %tobool2.not = icmp eq ptr %0, null
  br i1 %tobool2.not, label %for.inc, label %land.lhs.true
...
if.then5:                                         ; preds = %land.lhs.true
  ...
  store i32 %new_value, ptr %value, align 8
  br label %cleanup
...
for.cond.preheader:                               ; preds = %entry
  %tableItem.016 = load ptr, ptr %table, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %0 = load ptr, ptr %tableItem.018, align 8
  %tobool2.not = icmp eq ptr %0, null
  br i1 %tobool2.not, label %for.inc, label %land.lhs.true
...
if.then5:                                         ; preds = %land.lhs.true
  ...
  store ptr null, ptr %tableItem.018, align 8
...
for.cond.preheader:                               ; preds = %entry
  %tableItem.010 = load ptr, ptr %table, align 8
...
for.body:                                         ; preds = %for.cond.preheader, %for.inc
  ...
  %0 = load ptr, ptr %tableItem.012, align 8
...
attributes #3 = { nofree nounwind memory(read) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
