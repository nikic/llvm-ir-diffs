; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/zlib_gzlib.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/zlib_gzlib.c"
...
if.then41:                                        ; preds = %while.end
  %12 = icmp eq i32 %5, 0
  br i1 %12, label %if.end45, label %if.then44
...
if.end47:                                         ; preds = %while.end, %if.end45
  ...
  store ptr %call49, ptr %path50, align 8
...
cond.end77.thread:                                ; preds = %if.end55
  %fd79167 = getelementptr inbounds %struct.gz_state, ptr %call, i64 0, i32 2
  store i32 %fd, ptr %fd79167, align 4
  br label %if.end85

cond.end77:                                       ; preds = %if.end55
  %cmp66 = icmp eq i32 %6, 31153
  %cond68 = select i1 %cmp66, i32 512, i32 1024
  %or69 = or i32 %cond68, %11
  %cond70 = select i1 %cmp61, i32 0, i32 %or69
  %or71 = or i32 %cond70, %9
  ...
  store i32 %call76, ptr %fd79, align 4
