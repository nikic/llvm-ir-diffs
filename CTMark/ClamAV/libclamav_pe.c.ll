...
cond.true278:                                     ; preds = %land.lhs.true276
  ...
  %or.cond7622 = and i1 %tobool280.not, %tobool292.not
  br i1 %or.cond7622, label %cond.true307, label %if.then293
...
cond.false281:                                    ; preds = %land.lhs.true276
  ...
  %rem7135 = and i32 %61, 4095
  %tobool292.not7136 = icmp eq i32 %rem7135, 0
  %or.cond7623 = and i1 %tobool283.not, %tobool292.not7136
  br i1 %or.cond7623, label %cond.false310, label %if.then293
...
for.cond.preheader:                               ; preds = %if.end344
  %cmp3797368.not = icmp eq i32 %69, 512
  br i1 %cmp3797368.not, label %for.end, label %for.body.preheader
...
if.then367:                                       ; preds = %if.end344
  ...
  %71 = load i32, ptr %options271, align 8, !tbaa !9
...
cond.end407:                                      ; preds = %for.end, %cond.true401
  ...
  %cmp4117374.not = icmp eq i16 %8, 0
  br i1 %cmp4117374.not, label %for.end883, label %for.body413.lr.ph
...
for.body413:                                      ; preds = %for.body413.lr.ph, %for.inc881
  ...
  %polipos.07379 = phi i8 [ 0, %for.body413.lr.ph ], [ %polipos.2, %for.inc881 ]
  %min.07376 = phi i32 [ 0, %for.body413.lr.ph ], [ %min.2, %for.inc881 ]
  %max.07375 = phi i32 [ 0, %for.body413.lr.ph ], [ %max.1, %for.inc881 ]
...
cond.false446:                                    ; preds = %for.body413
  %arrayidx4327138 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7470
  store i32 %.fr, ptr %arrayidx4327138, align 4, !tbaa !37
...
cond.end450:                                      ; preds = %cond.false446, %cond.true434
  ...
  %arrayidx4327139 = phi ptr [ %arrayidx432, %cond.true434 ], [ %arrayidx4327138, %cond.false446 ]
...
cond.false483:                                    ; preds = %cond.end450
  %raw7142 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7470, i32 2
  store i32 %.fr7065, ptr %raw7142, align 4, !tbaa !41
...
cond.end487:                                      ; preds = %cond.false483, %cond.true470
  ...
  %raw7145 = phi ptr [ %raw, %cond.true470 ], [ %raw7142, %cond.false483 ]
  %cond4667143 = phi i32 [ %mul460, %cond.true470 ], [ %.fr7065, %cond.false483 ]
  ...
  store i32 %.fr, ptr %urva, align 4, !tbaa !45
  ...
  store i32 %.fr7065, ptr %uraw, align 4, !tbaa !47
...
if.then525:                                       ; preds = %land.lhs.true520
  br i1 %tobool400.not, label %if.end549.thread7148, label %cond.true527
...
cond.true527:                                     ; preds = %if.then525
  ...
  br label %if.end549.thread7148

if.end549.thread7148:                             ; preds = %cond.true527, %if.then525
  %cond545 = phi i32 [ %mul539, %cond.true527 ], [ %84, %if.then525 ]
  store i32 %cond545, ptr %vsz, align 4, !tbaa !40
  %conv558.old = zext i32 %cond4667143 to i64
...
if.end549:                                        ; preds = %cond.end487
  ...
  %conv558 = zext i32 %cond4667143 to i64
  %cmp559 = icmp ugt i64 %67, %conv558
  %or.cond7308 = select i1 %tobool553.not, i1 %cmp559, i1 false
  br i1 %or.cond7308, label %land.lhs.true561, label %if.end616

land.lhs.true561:                                 ; preds = %if.end549, %if.end549.thread7148
...
if.then606:                                       ; preds = %land.lhs.true584, %land.lhs.true561
  %conv612 = sub i32 %conv562, %cond4667143
  store i32 %conv612, ptr %rsz, align 4, !tbaa !42
  br label %if.end616

if.end616:                                        ; preds = %land.lhs.true520, %land.lhs.true584, %if.then606, %if.end549.thread7148, %if.end549
  ...
  %91 = load i32, ptr %arrayidx4327139, align 4, !tbaa !37
  ...
  %95 = load i32, ptr %raw7145, align 4, !tbaa !41
...
if.then693:                                       ; preds = %if.end688
  %105 = load i32, ptr %raw7145, align 4, !tbaa !41
...
if.end714:                                        ; preds = %if.then693
  ...
  %.pre7532 = load ptr, ptr %dconf719, align 8, !tbaa !25
  %.pre7533 = load i32, ptr %.pre7532, align 4, !tbaa !26
  br i1 %tobool717.not, label %if.end746, label %land.lhs.true718

land.lhs.true718:                                 ; preds = %if.end714
  %and721 = and i32 %.pre7533, 8
...
land.lhs.true738:                                 ; preds = %land.lhs.true726
  ...
  %spec.select = select i1 %cmp742, i8 %conv745, i8 %polipos.07379
  br label %if.end746

if.end746:                                        ; preds = %land.lhs.true738, %land.lhs.true726, %land.lhs.true718, %if.end714
  %polipos.1 = phi i8 [ %polipos.07379, %land.lhs.true718 ], [ %polipos.07379, %land.lhs.true726 ], [ %polipos.07379, %if.end714 ], [ %spec.select, %land.lhs.true738 ]
...
for.cond755.preheader:                            ; preds = %if.end746
  ...
  %cmp7567372.not = icmp eq i32 %114, 0
  br i1 %cmp7567372.not, label %if.end797, label %land.rhs758.lr.ph
...
if.then776:                                       ; preds = %for.body767
  ...
  %call780 = call fastcc i32 @cli_md5sect(i32 noundef %desc, ptr noundef nonnull %arrayidx4327139, ptr noundef nonnull %md5_dig), !range !56
...
if.end797:                                        ; preds = %land.rhs758, %for.cond755, %for.cond755.preheader, %cleanup, %if.end746, %if.end688
  %polipos.2 = phi i8 [ %polipos.1, %cleanup ], [ %polipos.1, %if.end746 ], [ %polipos.07379, %if.end688 ], [ %polipos.1, %for.cond755.preheader ], [ %polipos.1, %for.cond755 ], [ %polipos.1, %land.rhs758 ]
...
if.end815:                                        ; preds = %land.lhs.true803, %if.then799
  %123 = load i32, ptr %arrayidx4327139, align 4, !tbaa !37
...
if.end851:                                        ; preds = %land.lhs.true830, %if.else826
  %130 = load i32, ptr %arrayidx4327139, align 4, !tbaa !37
  %spec.select7069 = call i32 @llvm.umin.i32(i32 %130, i32 %min.07376)
  %131 = load i32, ptr %rsz, align 4, !tbaa !42
  %add868 = add i32 %131, %130
  %spec.select7107 = call i32 @llvm.umax.i32(i32 %add868, i32 %max.07375)
  br label %for.inc881
...
if.end1041:                                       ; preds = %if.end1041.preheader, %cleanup1184
  ...
  %kzstate.07391 = phi ptr [ %kzstate.7, %cleanup1184 ], [ %kzs, %if.end1041.preheader ]
  %kzcode.07390 = phi ptr [ %kzcode.3, %cleanup1184 ], [ %add.ptr1034, %if.end1041.preheader ]
  %kzdptr.07389 = phi i8 [ %kzdptr.3, %cleanup1184 ], [ -1, %if.end1041.preheader ]
  %kzxorlen.07388 = phi i32 [ %kzxorlen.2, %cleanup1184 ], [ -1, %if.end1041.preheader ]
  %kzinitlen.07387 = phi i32 [ %kzinitlen.6, %cleanup1184 ], [ 65535, %if.end1041.preheader ]
  %kzlen.07386 = phi i32 [ %kzlen.3, %cleanup1184 ], [ 197, %if.end1041.preheader ]
  %kzdsize.07385 = phi i8 [ %kzdsize.6, %cleanup1184 ], [ -1, %if.end1041.preheader ]
  %incdec.ptr = getelementptr inbounds i8, ptr %kzcode.07390, i64 1
  %148 = load i8, ptr %kzcode.07390, align 1, !tbaa !24
  %dec = add nsw i32 %kzlen.07386, -1
...
sw.bb1045:                                        ; preds = %sw.bb1043
  %add.ptr1046 = getelementptr inbounds i8, ptr %kzcode.07390, i64 6
  %sub1047 = add nsw i32 %kzlen.07386, -6
...
land.lhs.true1052:                                ; preds = %sw.bb1048
  %incdec.ptr.val7120 = load i32, ptr %incdec.ptr, align 1
  %cmp1054 = icmp eq i32 %incdec.ptr.val7120, 4050
  br i1 %cmp1054, label %if.then1056, label %sw.bb1064

if.then1056:                                      ; preds = %land.lhs.true1052
  %sub1057 = add nsw i32 %kzlen.07386, -6
  %sub1059 = add nsw i8 %148, 72
  %incdec.ptr1061 = getelementptr inbounds i8, ptr %kzstate.07391, i64 1
...
sw.bb1064:                                        ; preds = %sw.bb1048, %land.lhs.true1052, %if.then1056, %sw.bb1043, %sw.bb1043, %sw.bb1043, %sw.bb1043, %sw.bb1043, %sw.bb1043, %sw.bb1043
  %kzdsize.2 = phi i8 [ %kzdsize.07385, %sw.bb1043 ], [ %kzdsize.07385, %sw.bb1043 ], [ %kzdsize.07385, %sw.bb1043 ], [ %kzdsize.07385, %sw.bb1043 ], [ %kzdsize.07385, %sw.bb1043 ], [ %kzdsize.07385, %sw.bb1043 ], [ %kzdsize.07385, %sw.bb1043 ], [ %sub1059, %if.then1056 ], [ %kzdsize.07385, %land.lhs.true1052 ], [ %kzdsize.07385, %sw.bb1048 ]
  %kzinitlen.2 = phi i32 [ %kzinitlen.07387, %sw.bb1043 ], [ %kzinitlen.07387, %sw.bb1043 ], [ %kzinitlen.07387, %sw.bb1043 ], [ %kzinitlen.07387, %sw.bb1043 ], [ %kzinitlen.07387, %sw.bb1043 ], [ %kzinitlen.07387, %sw.bb1043 ], [ %kzinitlen.07387, %sw.bb1043 ], [ %sub1057, %if.then1056 ], [ %kzinitlen.07387, %land.lhs.true1052 ], [ %kzinitlen.07387, %sw.bb1048 ]
  ...
  %kzstate.2 = phi ptr [ %kzstate.07391, %sw.bb1043 ], [ %kzstate.07391, %sw.bb1043 ], [ %kzstate.07391, %sw.bb1043 ], [ %kzstate.07391, %sw.bb1043 ], [ %kzstate.07391, %sw.bb1043 ], [ %kzstate.07391, %sw.bb1043 ], [ %kzstate.07391, %sw.bb1043 ], [ %incdec.ptr1061, %if.then1056 ], [ %kzstate.07391, %land.lhs.true1052 ], [ %kzstate.07391, %sw.bb1048 ]
  %149 = and i8 %op.1, 7
  %cmp1070.not = icmp eq i8 %149, %kzdptr.07389
...
sw.default1081:                                   ; preds = %sw.bb1064, %sw.bb1043
  %kzdsize.3 = phi i8 [ %kzdsize.07385, %sw.bb1043 ], [ %kzdsize.2, %sw.bb1064 ]
  %kzinitlen.3 = phi i32 [ %kzinitlen.07387, %sw.bb1043 ], [ %kzinitlen.2, %sw.bb1064 ]
  %kzstate.3 = phi ptr [ %kzstate.07391, %sw.bb1043 ], [ %kzstate.2, %sw.bb1064 ]
...
if.then1095:                                      ; preds = %land.lhs.true1091
  ...
  %incdec.ptr1103 = getelementptr inbounds i8, ptr %kzstate.07391, i64 1
  br label %cleanup1184

if.else1104:                                      ; preds = %land.lhs.true1091, %sw.bb1087
  store i8 8, ptr %kzstate.07391, align 1, !tbaa !24
  br label %cleanup1184
...
if.then1118:                                      ; preds = %land.lhs.true1111
  ...
  %incdec.ptr1119 = getelementptr inbounds i8, ptr %kzstate.07391, i64 1
...
if.else1121:                                      ; preds = %land.lhs.true1111, %sw.bb1106
  %kzdptr.1 = phi i8 [ 4, %land.lhs.true1111 ], [ %kzdptr.07389, %sw.bb1106 ]
  store i8 8, ptr %kzstate.07391, align 1, !tbaa !24
  br label %cleanup1184

sw.bb1123:                                        ; preds = %if.end1041
  %incdec.ptr1124 = getelementptr inbounds i8, ptr %kzstate.07391, i64 1
  %cmp1126 = icmp eq i8 %148, 62
  br i1 %cmp1126, label %cleanup1184, label %sw.bb1130

sw.bb1130:                                        ; preds = %sw.bb1123, %if.end1041
  %kzstate.5 = phi ptr [ %kzstate.07391, %if.end1041 ], [ %incdec.ptr1124, %sw.bb1123 ]
...
land.lhs.true1134:                                ; preds = %sw.bb1130
  ...
  %conv1136 = zext i8 %kzdptr.07389 to i32
...
if.then1140:                                      ; preds = %land.lhs.true1134
  %add.ptr1141 = getelementptr inbounds i8, ptr %kzcode.07390, i64 7
  %sub1142 = add nsw i32 %kzlen.07386, -7
...
sw.bb1146:                                        ; preds = %if.end1041
  ...
  %conv1148 = zext i8 %kzdptr.07389 to i32
...
if.then1152:                                      ; preds = %sw.bb1146
  %incdec.ptr1153 = getelementptr inbounds i8, ptr %kzstate.07391, i64 1
  br label %cleanup1184
...
sw.bb1156:                                        ; preds = %if.end1041
  ...
  %conv1158 = zext i8 %kzdsize.07385 to i32
...
land.lhs.true1166:                                ; preds = %land.lhs.true1162
  %arrayidx1167 = getelementptr inbounds i8, ptr %kzcode.07390, i64 2
  ...
  %cmp1171.not = icmp sgt i32 %sub1170, %kzinitlen.07387
  %cmp1177.not = icmp slt i32 %sub1169, %kzxorlen.07388
...
if.end1181:                                       ; preds = %land.lhs.true1166, %land.lhs.true1162, %sw.bb1156
  ...
  %incdec.ptr1182 = getelementptr inbounds i8, ptr %kzstate.07391, i64 1
  br label %cleanup1184
...
cleanup1184:                                      ; preds = %if.end1041, %if.end1181, %if.else1104, %if.then1095, %if.else1121, %if.then1118, %sw.bb1123, %if.else1144, %if.then1140, %if.else1154, %if.then1152, %sw.default1081, %if.then1077, %sw.bb1045
  %kzdsize.6 = phi i8 [ %kzdsize.07385, %if.end1041 ], [ %kzdsize.07385, %if.end1181 ], [ %kzdsize.07385, %if.then1152 ], [ %kzdsize.07385, %if.else1154 ], [ %kzdsize.07385, %if.then1140 ], [ %kzdsize.07385, %if.else1144 ], [ %kzdsize.07385, %sw.bb1123 ], [ %kzdsize.07385, %if.then1118 ], [ %kzdsize.07385, %if.else1121 ], [ %kzdsize.07385, %if.then1095 ], [ %kzdsize.07385, %if.else1104 ], [ %kzdsize.3, %sw.default1081 ], [ %kzdsize.2, %if.then1077 ], [ %kzdsize.07385, %sw.bb1045 ]
  %kzlen.3 = phi i32 [ %dec, %if.end1041 ], [ %dec, %if.end1181 ], [ %dec, %if.then1152 ], [ %dec, %if.else1154 ], [ %sub1142, %if.then1140 ], [ %dec, %if.else1144 ], [ %dec, %sw.bb1123 ], [ %dec, %if.then1118 ], [ %dec, %if.else1121 ], [ %sub1098, %if.then1095 ], [ %dec, %if.else1104 ], [ %kzlen.07386, %sw.default1081 ], [ %sub1079, %if.then1077 ], [ %sub1047, %sw.bb1045 ]
  %kzinitlen.6 = phi i32 [ %kzinitlen.07387, %if.end1041 ], [ %kzinitlen.07387, %if.end1181 ], [ %kzinitlen.07387, %if.then1152 ], [ %kzinitlen.07387, %if.else1154 ], [ %kzinitlen.07387, %if.then1140 ], [ %kzinitlen.07387, %if.else1144 ], [ %kzinitlen.07387, %sw.bb1123 ], [ %kzinitlen.07387, %if.then1118 ], [ %kzinitlen.07387, %if.else1121 ], [ %kzinitlen.07387, %if.then1095 ], [ %kzinitlen.07387, %if.else1104 ], [ %kzinitlen.3, %sw.default1081 ], [ %kzinitlen.2, %if.then1077 ], [ %kzinitlen.07387, %sw.bb1045 ]
  %kzxorlen.2 = phi i32 [ %kzxorlen.07388, %if.end1041 ], [ %kzxorlen.07388, %if.end1181 ], [ %kzxorlen.07388, %if.then1152 ], [ %kzxorlen.07388, %if.else1154 ], [ %dec, %if.then1140 ], [ %kzxorlen.07388, %if.else1144 ], [ %kzxorlen.07388, %sw.bb1123 ], [ %kzxorlen.07388, %if.then1118 ], [ %kzxorlen.07388, %if.else1121 ], [ %kzxorlen.07388, %if.then1095 ], [ %kzxorlen.07388, %if.else1104 ], [ %kzxorlen.07388, %sw.default1081 ], [ %kzxorlen.07388, %if.then1077 ], [ %kzxorlen.07388, %sw.bb1045 ]
  %kzdptr.3 = phi i8 [ %kzdptr.07389, %if.end1041 ], [ %kzdptr.07389, %if.end1181 ], [ %kzdptr.07389, %if.then1152 ], [ %kzdptr.07389, %if.else1154 ], [ %kzdptr.07389, %if.then1140 ], [ %kzdptr.07389, %if.else1144 ], [ %kzdptr.07389, %sw.bb1123 ], [ %sub1113, %if.then1118 ], [ %kzdptr.1, %if.else1121 ], [ %kzdptr.07389, %if.then1095 ], [ %kzdptr.07389, %if.else1104 ], [ %kzdptr.07389, %sw.default1081 ], [ %kzdptr.07389, %if.then1077 ], [ %kzdptr.07389, %sw.bb1045 ]
  %kzcode.3 = phi ptr [ %incdec.ptr, %if.end1041 ], [ %incdec.ptr, %if.end1181 ], [ %incdec.ptr, %if.then1152 ], [ %incdec.ptr, %if.else1154 ], [ %add.ptr1141, %if.then1140 ], [ %incdec.ptr, %if.else1144 ], [ %incdec.ptr, %sw.bb1123 ], [ %incdec.ptr, %if.then1118 ], [ %incdec.ptr, %if.else1121 ], [ %add.ptr1102, %if.then1095 ], [ %incdec.ptr, %if.else1104 ], [ %kzcode.07390, %sw.default1081 ], [ %add.ptr1078, %if.then1077 ], [ %add.ptr1046, %sw.bb1045 ]
  %kzstate.7 = phi ptr [ %kzstate.07391, %if.end1041 ], [ %incdec.ptr1182, %if.end1181 ], [ %incdec.ptr1153, %if.then1152 ], [ %kzstate.07391, %if.else1154 ], [ %incdec.ptr1143, %if.then1140 ], [ %kzstate.5, %if.else1144 ], [ %incdec.ptr1124, %sw.bb1123 ], [ %incdec.ptr1119, %if.then1118 ], [ %kzstate.07391, %if.else1121 ], [ %incdec.ptr1103, %if.then1095 ], [ %kzstate.07391, %if.else1104 ], [ %incdec.ptr1084, %sw.default1081 ], [ %kzstate.2, %if.then1077 ], [ %kzstate.07391, %sw.bb1045 ]
  %154 = load i8, ptr %kzstate.7, align 1, !tbaa !24
  %cmp1036.not = icmp eq i8 %154, 8
  %cmp1038 = icmp slt i32 %kzlen.3, 7
  %or.cond7309 = select i1 %cmp1036.not, i1 true, i1 %cmp1038
  br i1 %or.cond7309, label %if.end1197, label %if.end1041
...
if.end1197:                                       ; preds = %cleanup1184
  call void @llvm.lifetime.end.p0(i64 12, ptr nonnull %kzs) #13
  %.pre7534 = load i32, ptr %options271, align 8, !tbaa !9
  %.pre7543 = and i32 %.pre7534, 512
  %tobool1200.not = icmp eq i32 %.pre7543, 0
...
for.cond1402.preheader:                           ; preds = %if.end1392
  %cmp14067398.not = icmp eq i32 %call1395, 5
  br i1 %cmp14067398.not, label %while.end1569.sink.split, label %for.body1408.lr.ph
...
for.body1408:                                     ; preds = %for.body1408.lr.ph, %for.inc1511
  ...
  %xsjs.07400 = phi i32 [ 0, %for.body1408.lr.ph ], [ %xsjs.2, %for.inc1511 ]
  %jumps.07399 = phi ptr [ null, %for.body1408.lr.ph ], [ %jumps.2, %for.inc1511 ]
...
for.body1408.for.inc1511_crit_edge:               ; preds = %for.body1408
  %.pre7549 = add nuw nsw i64 %indvars.iv7480, 1
...
if.end1475:                                       ; preds = %if.then1471
  %add1476 = add i32 %xsjs.07400, 128
  %conv1477 = zext i32 %add1476 to i64
  %mul1478 = shl nuw nsw i64 %conv1477, 2
  %call1479 = call ptr @cli_realloc2(ptr noundef %jumps.07399, i64 noundef %mul1478) #13
...
if.end1483:                                       ; preds = %if.end1475
  %cmp14857392.not = icmp eq i32 %xsjs.07400, 0
  br i1 %cmp14857392.not, label %for.end1507, label %for.body1487.preheader

for.body1487.preheader:                           ; preds = %if.end1467, %if.end1483
  %jumps.17562 = phi ptr [ %call1479, %if.end1483 ], [ %jumps.07399, %if.end1467 ]
  %wide.trip.count7478 = zext i32 %xsjs.07400 to i64
...
for.body1487:                                     ; preds = %for.body1487.preheader, %for.inc1505
  ...
  %jump.07393 = phi i32 [ %call1428, %for.body1487.preheader ], [ %jump.1, %for.inc1505 ]
  %arrayidx1489 = getelementptr inbounds i32, ptr %jumps.17562, i64 %indvars.iv7475
  %190 = load i32, ptr %arrayidx1489, align 4, !tbaa !5
  %cmp1490 = icmp ult i32 %190, %jump.07393
  br i1 %cmp1490, label %for.inc1505, label %if.end1493

if.end1493:                                       ; preds = %for.body1487
  %cmp1496 = icmp eq i32 %190, %jump.07393
  br i1 %cmp1496, label %if.then1498, label %if.end1500

if.then1498:                                      ; preds = %if.end1493
  %191 = trunc i64 %indvars.iv7475 to i32
  %dec1499 = add i32 %xsjs.07400, -1
  br label %for.end1507

if.end1500:                                       ; preds = %if.end1493
  store i32 %jump.07393, ptr %arrayidx1489, align 4, !tbaa !5
  br label %for.inc1505

for.inc1505:                                      ; preds = %for.body1487, %if.end1500
  %jump.1 = phi i32 [ %jump.07393, %for.body1487 ], [ %190, %if.end1500 ]
...
for.end1507:                                      ; preds = %for.inc1505, %if.end1483, %if.then1498
  %jumps.17563 = phi ptr [ %jumps.17562, %if.then1498 ], [ %call1479, %if.end1483 ], [ %jumps.17562, %for.inc1505 ]
  %jump.07337 = phi i32 [ %jump.07393, %if.then1498 ], [ %call1428, %if.end1483 ], [ %jump.1, %for.inc1505 ]
  %j.17335 = phi i32 [ %191, %if.then1498 ], [ 0, %if.end1483 ], [ %xsjs.07400, %for.inc1505 ]
  %xsjs.1 = phi i32 [ %dec1499, %if.then1498 ], [ 0, %if.end1483 ], [ %xsjs.07400, %for.inc1505 ]
  %idxprom1508 = zext i32 %j.17335 to i64
  %arrayidx1509 = getelementptr inbounds i32, ptr %jumps.17563, i64 %idxprom1508
  store i32 %jump.07337, ptr %arrayidx1509, align 4, !tbaa !5
  %inc1510 = add i32 %xsjs.1, 1
  %.pre7535 = load i32, ptr %rsz1376, align 4, !tbaa !42
  br label %for.inc1511
...
for.inc1511:                                      ; preds = %for.body1408.for.inc1511_crit_edge, %if.end1418, %lor.lhs.false1430, %land.lhs.true1442, %land.lhs.true1448, %for.end1507
  %indvars.iv.next7481.pre-phi = phi i64 [ %.pre7549, %for.body1408.for.inc1511_crit_edge ], [ %185, %if.end1418 ], [ %185, %lor.lhs.false1430 ], [ %185, %land.lhs.true1442 ], [ %185, %land.lhs.true1448 ], [ %185, %for.end1507 ]
  %192 = phi i32 [ %181, %for.body1408.for.inc1511_crit_edge ], [ %181, %if.end1418 ], [ %181, %lor.lhs.false1430 ], [ %181, %land.lhs.true1442 ], [ %181, %land.lhs.true1448 ], [ %.pre7535, %for.end1507 ]
  %jumps.2 = phi ptr [ %jumps.07399, %for.body1408.for.inc1511_crit_edge ], [ %jumps.07399, %if.end1418 ], [ %jumps.07399, %lor.lhs.false1430 ], [ %jumps.07399, %land.lhs.true1442 ], [ %jumps.07399, %land.lhs.true1448 ], [ %jumps.17563, %for.end1507 ]
  %xsjs.2 = phi i32 [ %xsjs.07400, %for.body1408.for.inc1511_crit_edge ], [ %xsjs.07400, %if.end1418 ], [ %xsjs.07400, %lor.lhs.false1430 ], [ %xsjs.07400, %land.lhs.true1442 ], [ %xsjs.07400, %land.lhs.true1448 ], [ %inc1510, %for.end1507 ]
...
if.end1516:                                       ; preds = %for.end1513.thread, %for.end1513
  %jumps.07345 = phi ptr [ %jumps.07399, %for.end1513.thread ], [ %jumps.2, %for.end1513 ]
  %xsjs.07342 = phi i32 [ 1280, %for.end1513.thread ], [ %xsjs.2, %for.end1513 ]
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.119, i32 noundef %xsjs.07342) #13
  ...
  %wide.trip.count7487 = zext i32 %xsjs.07342 to i64
  br label %for.body1520

for.body1520:                                     ; preds = %if.end1516, %for.inc1560
  %indvars.iv7484 = phi i64 [ 0, %if.end1516 ], [ %indvars.iv.next7485, %for.inc1560 ]
  %arrayidx1522 = getelementptr inbounds i32, ptr %jumps.07345, i64 %indvars.iv7484
...
if.then1557:                                      ; preds = %lor.lhs.false1548, %land.lhs.true1540, %if.end1530
  ...
  call void @free(ptr noundef nonnull %jumps.07345) #13
  call void @free(ptr noundef %call341) #13
  br label %cleanup4880
...
while.end1569.sink.split:                         ; preds = %for.inc1560, %for.cond1402.preheader
  %call1389.sink = phi ptr [ %call1389, %for.cond1402.preheader ], [ %jumps.07345, %for.inc1560 ]
  %i.5.ph = phi i32 [ 0, %for.cond1402.preheader ], [ %xsjs.07342, %for.inc1560 ]
...
if.then1622:                                      ; preds = %land.lhs.true1609
  ...
  %add.ptr1624.val7119 = load i32, ptr %add.ptr1624, align 1
  %add1626 = add i32 %add.ptr1624.val7119, %vep.0
...
while.body1633:                                   ; preds = %if.then1622, %if.then1622
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.122, i32 noundef %add.ptr1624.val7119, i32 noundef %vep.0, i32 noundef %add1627) #13
...
if.end1695.if.end1788_crit_edge:                  ; preds = %if.end1695
  %.pre7536 = load i32, ptr %dsize, align 4, !tbaa !5
  br label %if.end1788
...
if.then1719:                                      ; preds = %land.lhs.true1707
  ...
  call void @free(ptr noundef nonnull %call341) #13
  %220 = load i32, ptr %options271, align 8, !tbaa !9
...
if.then1731:                                      ; preds = %if.then1719
  %221 = load ptr, ptr %ctx, align 8, !tbaa !12
  store ptr @.str.130, ptr %221, align 8, !tbaa !13
  br label %cleanup4880

land.lhs.true1741:                                ; preds = %land.lhs.true1707
  %add1742 = add i32 %.pre7537.pre, %216
  %rsz1746 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %idxprom1664, i32 3
  %222 = load i32, ptr %rsz1746, align 4, !tbaa !42
...
if.then1763:                                      ; preds = %land.lhs.true1741
  ...
  call void @free(ptr noundef nonnull %call341) #13
  %223 = load i32, ptr %options271, align 8, !tbaa !9
...
if.then1785:                                      ; preds = %if.then1763
  %224 = load ptr, ptr %ctx, align 8, !tbaa !12
  store ptr @.str.130, ptr %224, align 8, !tbaa !13
  br label %cleanup4880

if.end1788:                                       ; preds = %land.lhs.true1704, %if.end1695.if.end1788_crit_edge, %land.lhs.true1741
  %225 = phi i32 [ %.pre7536, %if.end1695.if.end1788_crit_edge ], [ %.pre7537.pre, %land.lhs.true1741 ], [ %.pre7537.pre, %land.lhs.true1704 ]
...
if.end1794:                                       ; preds = %if.end1788
  ...
  %226 = load i32, ptr %rsz1798, align 4, !tbaa !42
...
if.end1835:                                       ; preds = %if.end1814
  ...
  %229 = load i8, ptr %arrayidx1836, align 1, !tbaa !24
...
if.then1840:                                      ; preds = %if.end1835
  ...
  %230 = load i32, ptr %vsz1842, align 4, !tbaa !40
  %switch7108 = icmp ult i32 %230, 4
  br i1 %switch7108, label %if.then1885, label %land.lhs.true1850
...
land.lhs.true1850:                                ; preds = %if.then1840
  ...
  %add.ptr1852.val7117 = load i32, ptr %add.ptr1852, align 4
  %add1854 = add i32 %add.ptr1852.val7117, %add1627
  %add1855 = add i32 %add1854, 128
  %231 = load i32, ptr %arrayidx1841, align 4, !tbaa !37
...
land.lhs.true1860:                                ; preds = %land.lhs.true1850
  ...
  %or.cond7310 = and i1 %cmp1872.not, %cmp1883
  br i1 %or.cond7310, label %if.end1886, label %if.then1885
...
if.end1886:                                       ; preds = %land.lhs.true1860
  %232 = load i32, ptr %call341, align 4, !tbaa !37
  %sub1892.neg = add nuw nsw i32 %add1626, 133
  %sub1893.neg = add i32 %sub1892.neg, %add.ptr1852.val7117
...
if.end1905:                                       ; preds = %if.end1900
  %233 = load i32, ptr %dsize, align 4, !tbaa !5
  %234 = load i32, ptr %ImageBase, align 4, !tbaa !24
  %235 = load i32, ptr %call341, align 4, !tbaa !37
...
sw.bb1910:                                        ; preds = %if.end1905
  %236 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
if.end1914:                                       ; preds = %if.else1913, %if.then1912
  ...
  %237 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
if.end1943:                                       ; preds = %for.inc1604, %for.cond1575.preheader, %if.then1622, %sw.default1932, %if.then1885, %if.then1809, %if.then1682, %if.then1652, %while.end1569, %land.lhs.true1609
  %i.77176 = phi i32 [ %209, %land.lhs.true1609 ], [ %i.5, %while.end1569 ], [ %209, %if.then1652 ], [ %209, %if.then1682 ], [ %209, %if.then1809 ], [ %209, %if.then1885 ], [ %209, %sw.default1932 ], [ %209, %if.then1622 ], [ 0, %for.cond1575.preheader ], [ %203, %for.inc1604 ]
  %tobool16087175 = phi i1 [ true, %land.lhs.true1609 ], [ false, %while.end1569 ], [ true, %if.then1652 ], [ true, %if.then1682 ], [ true, %if.then1809 ], [ true, %if.then1885 ], [ true, %sw.default1932 ], [ true, %if.then1622 ], [ false, %for.cond1575.preheader ], [ false, %for.inc1604 ]
...
if.end1947:                                       ; preds = %if.end1943
  ...
  %or.cond4970 = select i1 %tobool16087175, i1 true, i1 %tobool1950
...
land.lhs.true1958:                                ; preds = %while.cond1952
  %238 = load i8, ptr %epbuff, align 16, !tbaa !24
...
land.lhs.true1963:                                ; preds = %land.lhs.true1958
  ...
  %239 = load i32, ptr %ImageBase1967, align 4, !tbaa !24
...
land.rhs2010:                                     ; preds = %lor.rhs2004
  %242 = load i8, ptr %epbuff, align 16, !tbaa !24
...
land.lhs.true2031:                                ; preds = %lor.rhs2026
  %arrayidx2016.val7114 = load i32, ptr %arrayidx2016, align 1
  %ImageBase2035 = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 9
  %244 = load i32, ptr %ImageBase2035, align 4, !tbaa !24
  %sub2036 = sub i32 %arrayidx2016.val7114, %244
...
land.lhs.true2039:                                ; preds = %land.lhs.true2031
  %cmp2045 = icmp ne i32 %arrayidx2016.val7114, %244
...
if.then2072:                                      ; preds = %land.lhs.true1963, %land.lhs.true1986
  ...
  %vsz20687187 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 0, i32 1
  %248 = load i32, ptr %vsz20687187, align 4, !tbaa !40
  %arrayidx20697188 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 1
  %vsz20707189 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 1, i32 1
  %249 = load i32, ptr %vsz20707189, align 4, !tbaa !40
  ...
  %250 = load i32, ptr %vsz2074, align 4, !tbaa !40
  %ursz2076 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 0, i32 8
  %251 = load i32, ptr %ursz2076, align 4, !tbaa !48
  %uraw2078 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 0, i32 7
  %252 = load i32, ptr %uraw2078, align 4, !tbaa !47
  %add2079 = add i32 %252, %251
  %253 = load i32, ptr %call341, align 4, !tbaa !37
  %254 = load i32, ptr %ImageBase1967, align 4, !tbaa !24
...
if.else2086:                                      ; preds = %land.lhs.true2039, %land.lhs.true2020
  ...
  %255 = load i32, ptr %vsz2068, align 4, !tbaa !40
...
if.end2096:                                       ; preds = %if.else2086, %if.then2072
  ...
  %261 = load ptr, ptr %limits2099, align 8, !tbaa !62
...
land.lhs.true2101:                                ; preds = %if.end2096
  ...
  %262 = load i64, ptr %maxfilesize2103, align 8, !tbaa !63
...
land.lhs.true2105:                                ; preds = %land.lhs.true2101
  ...
  %263 = load i32, ptr %ursz2113, align 4, !tbaa !48
...
if.then2133:                                      ; preds = %land.lhs.true2105
  ...
  call void @free(ptr noundef nonnull %call341) #13
  %264 = load i32, ptr %options271, align 8, !tbaa !9
...
if.then2161:                                      ; preds = %if.then2133
  %265 = load ptr, ptr %ctx, align 8, !tbaa !12
  store ptr @.str.144, ptr %265, align 8, !tbaa !13
  br label %cleanup4880

if.end2164:                                       ; preds = %land.lhs.true2105, %land.lhs.true2101, %if.end2096
  %266 = load i32, ptr %arrayidx20697190, align 4, !tbaa !37
...
lor.lhs.false2170:                                ; preds = %if.end2164
  ...
  %267 = load i32, ptr %ursz2175, align 4, !tbaa !48
...
land.lhs.true2181:                                ; preds = %lor.lhs.false2179
  ...
  %268 = load i32, ptr %arrayidx2182, align 4, !tbaa !37
  %269 = load i32, ptr %call341, align 4, !tbaa !37
  ...
  %or.cond7311 = select i1 %or.cond7080, i1 true, i1 %cmp2199
  br i1 %or.cond7311, label %if.then2201, label %if.end2202
...
if.then2218:                                      ; preds = %if.end2216
  ...
  %270 = load i32, ptr %arrayidx2219, align 4, !tbaa !37
...
if.end2228:                                       ; preds = %if.then2218, %if.end2216
  ...
  %274 = load i32, ptr %ursz2175, align 4, !tbaa !48
  ...
  %275 = load i32, ptr %ursz2175, align 4, !tbaa !48
...
if.end2259:                                       ; preds = %if.end2254
  %276 = load i32, ptr %dsize, align 4, !tbaa !5
  %ImageBase2261 = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 9
  %277 = load i32, ptr %ImageBase2261, align 4, !tbaa !24
  %278 = load i32, ptr %call341, align 4, !tbaa !37
...
sw.bb2265:                                        ; preds = %if.end2259
  %279 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
if.end2269:                                       ; preds = %if.else2268, %if.then2267
  ...
  %280 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
while.cond2299:                                   ; preds = %land.lhs.true2020, %land.lhs.true1986, %land.lhs.true1958, %if.then2201, %sw.default2287, %if.end1947, %lor.rhs2004, %land.lhs.true2039, %land.lhs.true2031, %lor.rhs2026
  br i1 %tobool16087175, label %land.lhs.true2301, label %if.end3780

land.lhs.true2301:                                ; preds = %while.cond2299
  %281 = load ptr, ptr %dconf1570, align 8, !tbaa !25
...
while.body2317:                                   ; preds = %land.lhs.true2301
  ...
  %285 = load i32, ptr %rsz2321, align 4, !tbaa !42
  %idxprom2322 = zext i32 %i.77176 to i64
  ...
  %286 = load i32, ptr %vsz2324, align 4, !tbaa !40
  store i32 %286, ptr %dsize, align 4, !tbaa !5
  %limits2325 = getelementptr inbounds %struct.cli_ctx, ptr %ctx, i64 0, i32 4
  %287 = load ptr, ptr %limits2325, align 8, !tbaa !62
...
land.lhs.true2327:                                ; preds = %while.body2317
  ...
  %288 = load i64, ptr %maxfilesize2329, align 8, !tbaa !63
...
if.then2343:                                      ; preds = %land.lhs.true2331
  ...
  call void @free(ptr noundef nonnull %call341) #13
  %289 = load i32, ptr %options271, align 8, !tbaa !9
...
if.then2355:                                      ; preds = %if.then2343
  %290 = load ptr, ptr %ctx, align 8, !tbaa !12
  store ptr @.str.153, ptr %290, align 8, !tbaa !13
  br label %cleanup4880
...
if.end2365:                                       ; preds = %if.end2358
  ...
  %291 = load i32, ptr %ImageBase2369, align 4, !tbaa !24
  %sub2370 = sub i32 %add.ptr2367.val, %291
  %292 = load i32, ptr %rsz2321, align 4, !tbaa !42
  %switch7109 = icmp ult i32 %292, 4
  br i1 %switch7109, label %if.then2412, label %land.lhs.true2384

land.lhs.true2384:                                ; preds = %if.end2365
  %293 = load i32, ptr %arrayidx2320, align 4, !tbaa !37
...
if.end2431:                                       ; preds = %lor.lhs.false2425
  ...
  %294 = load i32, ptr %arrayidx2320, align 4, !tbaa !37
...
if.end2467:                                       ; preds = %land.lhs.true2456
  ...
  %295 = load i32, ptr %ImageBase2369, align 4, !tbaa !24
  %sub2470 = sub i32 %add.ptr2440.val, %295
  %296 = load i32, ptr %rsz2321, align 4, !tbaa !42
  %switch7110 = icmp ult i32 %296, 4
  %cmp2489.not = icmp ult i32 %sub2470, %294
  %or.cond7312 = select i1 %switch7110, i1 true, i1 %cmp2489.not
  br i1 %or.cond7312, label %if.then2512, label %land.lhs.true2491
...
if.end2542:                                       ; preds = %land.lhs.true2531
  ...
  %297 = load i32, ptr %arrayidx2323, align 4, !tbaa !37
...
if.end2565:                                       ; preds = %if.end2542
  ...
  %or.cond7313 = and i1 %cmp2570, %cmp2582.not
  br i1 %or.cond7313, label %land.lhs.true2592, label %if.then2584
...
if.end2628:                                       ; preds = %land.lhs.true2606
  ...
  %298 = load i32, ptr %dsize, align 4, !tbaa !5
...
if.end2654:                                       ; preds = %if.end2649
  %299 = load i32, ptr %arrayidx2320, align 4, !tbaa !37
  ...
  %301 = load i32, ptr %ImageBase2369, align 4, !tbaa !24
...
sw.bb2670:                                        ; preds = %if.end2654
  %302 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
if.end2674:                                       ; preds = %if.else2673, %if.then2672
  ...
  %303 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
land.lhs.true2707:                                ; preds = %land.lhs.true2301, %if.then2561, %if.then2584, %if.then2627, %if.then2541, %if.then2512, %if.then2466, %if.then2412, %sw.default2695
  %304 = load ptr, ptr %dconf1570, align 8, !tbaa !25
...
land.rhs2717:                                     ; preds = %land.lhs.true2707
  %add.ptr2719.val7113 = load i32, ptr %arrayidx2312, align 1
  %ImageBase2721 = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 9
  %307 = load i32, ptr %ImageBase2721, align 4, !tbaa !24
  %sub2722 = sub i32 %add.ptr2719.val7113, %307
...
while.body2726:                                   ; preds = %land.rhs2717
  ...
  %308 = load i32, ptr %rsz2732, align 4, !tbaa !42
  %idxprom2733 = zext i32 %i.77176 to i64
  ...
  %309 = load i32, ptr %vsz2735, align 4, !tbaa !40
  store i32 %309, ptr %dsize, align 4, !tbaa !5
  %limits2736 = getelementptr inbounds %struct.cli_ctx, ptr %ctx, i64 0, i32 4
  %310 = load ptr, ptr %limits2736, align 8, !tbaa !62
...
land.lhs.true2738:                                ; preds = %while.body2726
  ...
  %311 = load i64, ptr %maxfilesize2740, align 8, !tbaa !63
...
if.then2754:                                      ; preds = %land.lhs.true2742
  ...
  call void @free(ptr noundef nonnull %call341) #13
  %312 = load i32, ptr %options271, align 8, !tbaa !9
...
if.then2766:                                      ; preds = %if.then2754
  %313 = load ptr, ptr %ctx, align 8, !tbaa !12
  store ptr @.str.153, ptr %313, align 8, !tbaa !13
  br label %cleanup4880
...
if.end2776:                                       ; preds = %if.end2769
  ...
  %narrow7314 = select i1 %cmp.i, i1 true, i1 %cmp1.not.i
  %.sink.i = zext i1 %narrow7314 to i32
  %retval.0.i = select i1 %narrow7314, i32 0, i32 %sub2722
  store i32 %.sink.i, ptr %err, align 4, !tbaa !5
  %tobool2783 = icmp eq i32 %retval.0.i, 0
  %or.cond4985 = and i1 %tobool2783, %narrow7314
...
if.end2787:                                       ; preds = %if.end2776
  ...
  %314 = load i32, ptr %raw2793, align 4, !tbaa !41
  %sub2794 = sub i32 %314, %retval.0.i
  %315 = load ptr, ptr %limits2736, align 8, !tbaa !62
...
if.then2807:                                      ; preds = %land.lhs.true2797
  ...
  call void @free(ptr noundef nonnull %call341) #13
  %317 = load i32, ptr %options271, align 8, !tbaa !9
...
if.then2813:                                      ; preds = %if.then2807
  %318 = load ptr, ptr %ctx, align 8, !tbaa !12
  store ptr @.str.153, ptr %318, align 8, !tbaa !13
  br label %cleanup4880

if.end2816:                                       ; preds = %if.end2787.if.end2816_crit_edge, %land.lhs.true2797
  %conv2817.pre-phi = phi i64 [ %.pre7548, %if.end2787.if.end2816_crit_edge ], [ %conv2802, %land.lhs.true2797 ]
...
if.end2827:                                       ; preds = %if.end2822
  ...
  %319 = load i32, ptr %ImageBase2721, align 4, !tbaa !24
  ...
  %320 = load i32, ptr %arrayidx2731, align 4, !tbaa !37
...
lor.lhs.false2842:                                ; preds = %if.end2827
  ...
  %321 = load i32, ptr %rsz2732, align 4, !tbaa !42
...
if.end2855:                                       ; preds = %lor.lhs.false2842
  %322 = load i32, ptr %arrayidx2734, align 4, !tbaa !37
...
if.end2877:                                       ; preds = %for.body2870
  %324 = load i32, ptr %ImageBase2721, align 4, !tbaa !24
...
if.then2884:                                      ; preds = %if.end2877
  ...
  %.pre7538 = load i32, ptr %arrayidx2734, align 4, !tbaa !37
  br label %if.end2885

if.end2885:                                       ; preds = %if.then2884, %if.end2877
  %325 = phi i32 [ %.pre7538, %if.then2884 ], [ %323, %if.end2877 ]
...
lor.lhs.false2891:                                ; preds = %if.end2885
  ...
  %326 = load i32, ptr %vsz2735, align 4, !tbaa !40
...
if.end2918:                                       ; preds = %for.body2870, %lor.lhs.false2912
  %sectcnt.1.ph7572 = phi i32 [ %inc2881, %lor.lhs.false2912 ], [ %sectcnt.07410, %for.body2870 ]
  %add2919 = add i32 %sectcnt.1.ph7572, 1
...
if.end2926:                                       ; preds = %if.end2918
  ...
  %cmp2930.not7412 = icmp eq i32 %sectcnt.1.ph7572, 0
  br i1 %cmp2930.not7412, label %for.end2946, label %for.body2932.preheader

for.body2932.preheader:                           ; preds = %if.end2926
  %umax7498 = call i32 @llvm.umax.i32(i32 %add2919, i32 2)
  %wide.trip.count7499 = zext i32 %umax7498 to i64
  %327 = add nsw i64 %wide.trip.count7499, -1
  %min.iters.check = icmp ult i32 %add2919, 21
  br i1 %min.iters.check, label %for.body2932.preheader7668, label %vector.scevcheck

vector.scevcheck:                                 ; preds = %for.body2932.preheader
  %328 = add nsw i64 %wide.trip.count7499, -2
  %329 = and i64 %328, 1073741823
  %330 = icmp eq i64 %329, 1073741823
  %331 = icmp ugt i64 %328, 1073741823
  %332 = or i1 %330, %331
  br i1 %332, label %for.body2932.preheader7668, label %vector.memcheck

vector.memcheck:                                  ; preds = %vector.scevcheck
  %scevgep = getelementptr i8, ptr %call2922, i64 36
  %333 = mul nuw nsw i64 %wide.trip.count7499, 36
  %334 = add nsw i64 %333, -32
  %scevgep7645 = getelementptr i8, ptr %call2922, i64 %334
  %scevgep7646 = getelementptr inbounds i8, ptr %pe_opt, i64 32
  %scevgep7647 = getelementptr i8, ptr %call2818, i64 12
  %335 = shl nuw nsw i64 %wide.trip.count7499, 2
  %336 = add nuw nsw i64 %335, 8
  %scevgep7648 = getelementptr i8, ptr %call2818, i64 %336
  %bound0 = icmp ult ptr %scevgep, %scevgep7646
  %bound1 = icmp ult ptr %ImageBase2721, %scevgep7645
  %found.conflict = and i1 %bound0, %bound1
  %bound07649 = icmp ult ptr %scevgep, %scevgep7648
  %bound17650 = icmp ult ptr %scevgep7647, %scevgep7645
  %found.conflict7651 = and i1 %bound07649, %bound17650
  %conflict.rdx = or i1 %found.conflict, %found.conflict7651
  br i1 %conflict.rdx, label %for.body2932.preheader7668, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %342, align 1, !alias.scope !66
  ...
  store i32 %351, ptr %347, align 4, !tbaa !37, !alias.scope !69, !noalias !71
  %352 = extractelement <4 x i32> %346, i64 1
  store i32 %352, ptr %348, align 4, !tbaa !37, !alias.scope !69, !noalias !71
  ...
  br i1 %355, label %middle.block, label %vector.body, !llvm.loop !73

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %327, %n.vec
  br i1 %cmp.n, label %for.end2946, label %for.body2932.preheader7668

for.body2932.preheader7668:                       ; preds = %vector.memcheck, %vector.scevcheck, %for.body2932.preheader, %middle.block
  %indvars.iv7495.ph = phi i64 [ 1, %vector.memcheck ], [ 1, %vector.scevcheck ], [ 1, %for.body2932.preheader ], [ %ind.end, %middle.block ]
  %356 = and i64 %wide.trip.count7499, 1
  %lcmp.mod.not.not = icmp eq i64 %356, 0
  br i1 %lcmp.mod.not.not, label %for.body2932.prol, label %for.body2932.prol.loopexit

for.body2932.prol:                                ; preds = %for.body2932.preheader7668
  ...
  %357 = load i32, ptr %ImageBase2721, align 4, !tbaa !24
  %358 = xor i32 %357, -1
  %sub2940.prol = add i32 %add.ptr2936.val.prol, %358
...
for.body2932.prol.loopexit:                       ; preds = %for.body2932.prol, %for.body2932.preheader7668
  %indvars.iv7495.unr = phi i64 [ %indvars.iv7495.ph, %for.body2932.preheader7668 ], [ %indvars.iv.next7496.prol, %for.body2932.prol ]
  %359 = sub nsw i64 0, %wide.trip.count7499
  %360 = xor i64 %indvars.iv7495.ph, %359
...
for.body2932:                                     ; preds = %for.body2932.prol.loopexit, %for.body2932
  ...
  %362 = load i32, ptr %ImageBase2721, align 4, !tbaa !24
  %363 = xor i32 %362, -1
  ...
  %exitcond7500.1 = icmp eq i64 %indvars.iv.next7496.1, %wide.trip.count7499
  br i1 %exitcond7500.1, label %for.end2946, label %for.body2932, !llvm.loop !76
...
if.then2962:                                      ; preds = %lor.lhs.false2958, %if.end2952
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.156, i32 noundef %i.77176) #13
  call void @free(ptr noundef %call341) #13
  call void @free(ptr noundef nonnull %call2922) #13
...
if.end2963:                                       ; preds = %lor.lhs.false2958
  %366 = load i32, ptr %dsize, align 4, !tbaa !5
...
if.end2984:                                       ; preds = %if.end2979
  ...
  %367 = load i32, ptr %arrayidx2731, align 4, !tbaa !37
  ...
  %369 = load i32, ptr %ImageBase2721, align 4, !tbaa !24
  %call3001 = call i32 @unfsg_133(ptr noundef nonnull %add.ptr2993, ptr noundef nonnull %call2965, i32 noundef %sub2999, i32 noundef %368, ptr noundef nonnull %call2922, i32 noundef %sectcnt.1.ph7572, i32 noundef %369, i32 noundef %add2975, i32 noundef %call2980) #13
...
sw.bb3002:                                        ; preds = %if.end2984
  %370 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
if.end3006:                                       ; preds = %if.else3005, %if.then3004
  ...
  %371 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
land.lhs.true3043:                                ; preds = %land.rhs2717, %land.lhs.true2707, %if.then2786, %if.then2854, %if.then2861, %if.then2917, %sw.default3027
  %372 = load ptr, ptr %dconf1570, align 8, !tbaa !25
...
land.lhs.true3053:                                ; preds = %land.lhs.true3043
  %add.ptr3055.val7112 = load i32, ptr %arrayidx2312, align 1
  %ImageBase3057 = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 9
  %375 = load i32, ptr %ImageBase3057, align 4, !tbaa !24
  %sub3058 = sub i32 %add.ptr3055.val7112, %375
...
land.lhs.true3071:                                ; preds = %land.lhs.true3053
  ...
  %378 = load i32, ptr %arrayidx3074, align 4, !tbaa !37
...
while.body3092:                                   ; preds = %land.rhs3078
  %cmp.i7121 = icmp uge i32 %sub3058, %cond408
  %conv.i7126 = zext i32 %sub3058 to i64
  %cmp1.not.i7127 = icmp ule i64 %67, %conv.i7126
  %narrow7315 = select i1 %cmp.i7121, i1 true, i1 %cmp1.not.i7127
  %.sink.i7123 = zext i1 %narrow7315 to i32
  store i32 %.sink.i7123, ptr %err, align 4, !tbaa !5
  ...
  %379 = load i32, ptr %rsz3125, align 4, !tbaa !42
  %idxprom3126 = zext i32 %i.77176 to i64
  ...
  %380 = load i32, ptr %vsz3128, align 4, !tbaa !40
  store i32 %380, ptr %dsize, align 4, !tbaa !5
  br i1 %narrow7315, label %if.then3130, label %if.end3131
...
if.end3131:                                       ; preds = %while.body3092
  %381 = load i32, ptr %arrayidx3074, align 4, !tbaa !37
...
lor.lhs.false3138:                                ; preds = %if.end3131
  ...
  %382 = load i32, ptr %raw3147, align 4, !tbaa !41
...
if.end3151:                                       ; preds = %lor.lhs.false3138
  %383 = load i32, ptr %arrayidx3127, align 4, !tbaa !37
...
if.end3161:                                       ; preds = %if.end3151
  ...
  %384 = load ptr, ptr %limits3162, align 8, !tbaa !62
...
land.lhs.true3164:                                ; preds = %if.end3161
  ...
  %385 = load i64, ptr %maxfilesize3166, align 8, !tbaa !63
...
if.then3180:                                      ; preds = %land.lhs.true3168
  ...
  call void @free(ptr noundef nonnull %call341) #13
  %386 = load i32, ptr %options271, align 8, !tbaa !9
...
if.then3192:                                      ; preds = %if.then3180
  %387 = load ptr, ptr %ctx, align 8, !tbaa !12
  store ptr @.str.153, ptr %387, align 8, !tbaa !13
  br label %cleanup4880
...
if.end3202:                                       ; preds = %if.end3195
  ...
  %388 = load i32, ptr %raw3147, align 4, !tbaa !41
  %sub3209 = sub i32 %388, %sub3058
  %389 = load ptr, ptr %limits3162, align 8, !tbaa !62
...
if.then3222:                                      ; preds = %land.lhs.true3212
  ...
  call void @free(ptr noundef nonnull %call341) #13
  %391 = load i32, ptr %options271, align 8, !tbaa !9
...
if.then3228:                                      ; preds = %if.then3222
  %392 = load ptr, ptr %ctx, align 8, !tbaa !12
  store ptr @.str.153, ptr %392, align 8, !tbaa !13
  br label %cleanup4880

if.end3231:                                       ; preds = %if.end3202.if.end3231_crit_edge, %land.lhs.true3212
  %conv3232.pre-phi = phi i64 [ %.pre7547, %if.end3202.if.end3231_crit_edge ], [ %conv3217, %land.lhs.true3212 ]
...
for.body3247:                                     ; preds = %for.body3247.lr.ph, %for.inc3288
  ...
  %394 = load i8, ptr %arrayidx3250, align 1, !tbaa !24
  ...
  %395 = load i8, ptr %arrayidx3254, align 1, !tbaa !24
...
if.end3262:                                       ; preds = %for.body3247
  ...
  %397 = load i32, ptr %arrayidx3127, align 4, !tbaa !37
...
lor.lhs.false3273:                                ; preds = %if.end3262
  ...
  %398 = load i32, ptr %vsz3128, align 4, !tbaa !40
...
for.end3290:                                      ; preds = %for.inc3288, %for.body3247, %for.cond3243.preheader, %if.then3283
  %t3094.07325 = phi i32 [ %t3094.07416, %if.then3283 ], [ 0, %for.cond3243.preheader ], [ %add3289, %for.inc3288 ], [ %t3094.07416, %for.body3247 ]
...
if.end3310:                                       ; preds = %if.end3302
  ...
  %umax7504 = call i32 @llvm.umax.i32(i32 %sectcnt3093.2, i32 1)
  %wide.trip.count7505 = zext i32 %umax7504 to i64
  br label %for.body3317

for.body3317:                                     ; preds = %if.end3310, %for.body3317
  %indvars.iv7501 = phi i64 [ 0, %if.end3310 ], [ %indvars.iv.next7502, %for.body3317 ]
  %399 = trunc i64 %indvars.iv7501 to i32
  ...
  %400 = load i8, ptr %arrayidx3320, align 1, !tbaa !24
  ...
  %401 = load i8, ptr %arrayidx3325, align 1, !tbaa !24
  %conv3326 = sext i8 %401 to i32
  %402 = shl nsw i32 %conv3326, 20
  %403 = shl nsw i32 %conv3321, 12
  %sub3329 = or i32 %402, %403
  %404 = load i32, ptr %ImageBase3057, align 4, !tbaa !24
  %reass.sub7442 = sub i32 %sub3329, %404
  %sub3332 = add i32 %reass.sub7442, -8192
  %indvars.iv.next7502 = add nuw nsw i64 %indvars.iv7501, 1
  %arrayidx3335 = getelementptr inbounds %struct.cli_exe_section, ptr %call3306, i64 %indvars.iv.next7502
  store i32 %sub3332, ptr %arrayidx3335, align 4, !tbaa !37
  %exitcond7506 = icmp eq i64 %indvars.iv.next7502, %wide.trip.count7505
  br i1 %exitcond7506, label %for.end3339, label %for.body3317, !llvm.loop !78
...
if.then3355:                                      ; preds = %lor.lhs.false3351, %if.end3345
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.174, i32 noundef %i.77176) #13
  call void @free(ptr noundef %call341) #13
  call void @free(ptr noundef nonnull %call3306) #13
...
if.end3356:                                       ; preds = %lor.lhs.false3351
  %405 = load i32, ptr %dsize, align 4, !tbaa !5
...
if.end3362:                                       ; preds = %if.end3356
  ...
  %406 = load i8, ptr %arrayidx3363, align 16, !tbaa !24
...
if.end3386:                                       ; preds = %if.end3381
  ...
  %407 = load i32, ptr %arrayidx3074, align 4, !tbaa !37
  ...
  %408 = load i32, ptr %dsize, align 4, !tbaa !5
  %409 = load i32, ptr %ImageBase3057, align 4, !tbaa !24
...
sw.bb3404:                                        ; preds = %if.end3386
  %410 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
if.end3408:                                       ; preds = %if.else3407, %if.then3406
  ...
  %411 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
land.lhs.true3444:                                ; preds = %land.rhs3078, %land.lhs.true3071, %land.lhs.true3053, %land.lhs.true3043, %if.then3130, %if.then3150, %if.then3157, %if.then3301, %sw.default3429
  %412 = load ptr, ptr %dconf1570, align 8, !tbaa !25
...
if.then3449:                                      ; preds = %land.lhs.true3444
  ...
  %414 = load i32, ptr %rsz3453, align 4, !tbaa !42
  %idxprom3454 = zext i32 %i.77176 to i64
  ...
  %417 = load ptr, ptr %limits3462, align 8, !tbaa !62
...
land.lhs.true3464:                                ; preds = %if.then3449
  ...
  %418 = load i64, ptr %maxfilesize3466, align 8, !tbaa !63
...
if.then3480:                                      ; preds = %land.lhs.true3468
  ...
  call void @free(ptr noundef nonnull %call341) #13
  %419 = load i32, ptr %options271, align 8, !tbaa !9
...
if.then3492:                                      ; preds = %if.then3480
  %420 = load ptr, ptr %ctx, align 8, !tbaa !12
  store ptr @.str.176, ptr %420, align 8, !tbaa !13
  br label %cleanup4880
...
if.end3511:                                       ; preds = %if.end3505
  %421 = load i32, ptr %dsize, align 4, !tbaa !5
...
if.then3570:                                      ; preds = %if.else3554, %lor.lhs.false3559, %if.else3542, %lor.lhs.false3547, %if.end3530, %lor.lhs.false3535
  ...
  %422 = load i32, ptr %ImageBase3574, align 4, !tbaa !24
  %423 = load i32, ptr %arrayidx3452, align 4, !tbaa !37
  %424 = add i32 %422, %423
  %sub3580 = sub i32 %add.ptr3572.val, %424
  %425 = load i8, ptr %arrayidx2312, align 1, !tbaa !24
...
if.then3591:                                      ; preds = %if.then3570
  %426 = load i32, ptr %arrayidx3455, align 4, !tbaa !37
  %call3599 = call i32 %upxfn.0.ph(ptr noundef nonnull %call3507, i32 noundef %414, ptr noundef nonnull %call3514, ptr noundef nonnull %dsize, i32 noundef %426, i32 noundef %423, i32 noundef %vep.0) #13, !callees !79
...
if.else3604:                                      ; preds = %if.then3570
  ...
  %427 = load i32, ptr %arrayidx3455, align 4, !tbaa !37
  %428 = load i32, ptr %arrayidx3452, align 4, !tbaa !37
  %sub3615 = sub i32 %vep.0, %sub3580
  %call3616 = call i32 %upxfn.0.ph(ptr noundef nonnull %add.ptr3606, i32 noundef %sub3607, ptr noundef nonnull %call3514, ptr noundef nonnull %dsize, i32 noundef %427, i32 noundef %428, i32 noundef %sub3615) #13, !callees !79
...
lor.lhs.false3619:                                ; preds = %if.else3604
  ...
  %call3627 = call i32 %upxfn.0.ph(ptr noundef nonnull %call3507, i32 noundef %414, ptr noundef nonnull %call3514, ptr noundef nonnull %dsize, i32 noundef %429, i32 noundef %430, i32 noundef %vep.0) #13, !callees !79
...
if.then3642:                                      ; preds = %lor.lhs.false3559, %if.end3637
  %cmp367372607580 = phi i1 [ %cmp3673.ph, %if.end3637 ], [ true, %lor.lhs.false3559 ]
  %cmp370672627578 = phi i1 [ %cmp3706.ph, %if.end3637 ], [ true, %lor.lhs.false3559 ]
...
if.then3667:                                      ; preds = %land.lhs.true3653
  ...
  br i1 %cmp367372607580, label %if.then3675, label %if.end3703
...
if.then3675:                                      ; preds = %if.then3667, %if.end3670
  %cmp3706726275777582 = phi i1 [ %cmp370672627578, %if.then3667 ], [ %cmp3706.ph, %if.end3670 ]
...
if.then3700:                                      ; preds = %land.lhs.true3686
  ...
  br i1 %cmp3706726275777582, label %if.then3708, label %if.then3738
...
if.end3703:                                       ; preds = %if.then3667, %if.end3670
  %cmp3706726275777581 = phi i1 [ %cmp370672627578, %if.then3667 ], [ %cmp3706.ph, %if.end3670 ]
  br i1 %cmp3706726275777581, label %if.then3708, label %if.then3738
...
if.end3751:                                       ; preds = %if.end3746
  %443 = load i32, ptr %dsize, align 4, !tbaa !5
  ...
  %444 = load i32, ptr %dsize, align 4, !tbaa !5
...
if.end3759:                                       ; preds = %if.end3751
  ...
  %445 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
if.end3764:                                       ; preds = %if.then3763, %if.end3759
  ...
  %446 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
lor.lhs.false3789:                                ; preds = %if.end3784
  ...
  %448 = load i32, ptr %arrayidx3796, align 4, !tbaa !37
  %ImageBase3798 = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 9
  %449 = load i32, ptr %ImageBase3798, align 4, !tbaa !24
...
lor.lhs.false3811:                                ; preds = %if.then3802
  ...
  %450 = load i32, ptr %arrayidx3818, align 4, !tbaa !37
...
land.lhs.true3829:                                ; preds = %lor.lhs.false3811, %lor.lhs.false3789
  ...
  %451 = load ptr, ptr %dconf1570, align 8, !tbaa !25
...
if.else3841:                                      ; preds = %if.then3834
  ...
  %453 = load ptr, ptr %limits3843, align 8, !tbaa !62
...
if.then3855:                                      ; preds = %land.lhs.true3845
  ...
  call void @free(ptr noundef nonnull %call341) #13
  %455 = load i32, ptr %options271, align 8, !tbaa !9
...
if.then3861:                                      ; preds = %if.then3855
  %456 = load ptr, ptr %ctx, align 8, !tbaa !12
  store ptr @.str.202, ptr %456, align 8, !tbaa !13
  br label %cleanup4880

if.end3864:                                       ; preds = %if.else3841.if.end3864_crit_edge, %land.lhs.true3845
  %conv3865.pre-phi = phi i64 [ %.pre7546, %if.else3841.if.end3864_crit_edge ], [ %conv3850, %land.lhs.true3845 ]
...
for.cond3871.preheader:                           ; preds = %if.end3864
  br i1 %cmp4117374.not, label %for.end3908, label %for.body3875.lr.ph
...
for.body3875.lr.ph:                               ; preds = %for.cond3871.preheader
  ...
  %wide.trip.count7510 = zext i16 %8 to i64
  br label %for.body3875

if.then3869:                                      ; preds = %if.end3864
  %457 = load i32, ptr %dsize, align 4, !tbaa !5
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.203, i32 noundef %457) #13
  call void @free(ptr noundef nonnull %call341) #13
  br label %cleanup4880

for.body3875:                                     ; preds = %for.body3875.lr.ph, %for.inc3906
  %indvars.iv7507 = phi i64 [ 0, %for.body3875.lr.ph ], [ %indvars.iv.next7508, %for.inc3906 ]
  %arrayidx3877 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7507
  %raw3878 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7507, i32 2
  %458 = load i32, ptr %raw3878, align 4, !tbaa !41
...
lor.lhs.false3885:                                ; preds = %if.then3880
  %459 = load i32, ptr %arrayidx3877, align 4, !tbaa !37
  %idx.ext3889 = zext i32 %459 to i64
  %gep = getelementptr i8, ptr %invariant.gep, i64 %idx.ext3889
  %ursz3896 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7507, i32 8
  %460 = load i32, ptr %ursz3896, align 4, !tbaa !48
  %call3897 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %gep, i32 noundef %460) #13
  %461 = load i32, ptr %ursz3896, align 4, !tbaa !48
...
for.inc3906:                                      ; preds = %for.body3875, %lor.lhs.false3885
  %indvars.iv.next7508 = add nuw nsw i64 %indvars.iv7507, 1
  %exitcond7511.not = icmp eq i64 %indvars.iv.next7508, %wide.trip.count7510
  br i1 %exitcond7511.not, label %for.end3908, label %for.body3875, !llvm.loop !80
...
sw.bb3930:                                        ; preds = %if.end3917
  %465 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
if.end3934:                                       ; preds = %if.else3933, %if.then3932
  ...
  %466 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
if.end3957:                                       ; preds = %if.end3784, %lor.lhs.false3811, %if.then3840, %sw.default3952, %land.lhs.true3829
  %467 = load ptr, ptr %dconf1570, align 8, !tbaa !25
...
land.lhs.true3966:                                ; preds = %if.end3957
  ...
  %469 = load i32, ptr %arrayidx3970, align 4, !tbaa !37
...
land.lhs.true3974:                                ; preds = %land.lhs.true3966
  ...
  %470 = load i32, ptr %rsz3984, align 4, !tbaa !42
...
if.then3996:                                      ; preds = %land.lhs.true3990
  ...
  %471 = load ptr, ptr %limits3997, align 8, !tbaa !62
...
land.lhs.true3999:                                ; preds = %if.then3996
  ...
  %472 = load i64, ptr %maxfilesize4001, align 8, !tbaa !63
...
if.then4008:                                      ; preds = %land.lhs.true3999
  ...
  call void @free(ptr noundef nonnull %call341) #13
  %473 = load i32, ptr %options271, align 8, !tbaa !9
...
if.then4014:                                      ; preds = %if.then4008
  %474 = load ptr, ptr %ctx, align 8, !tbaa !12
  store ptr @.str.210, ptr %474, align 8, !tbaa !13
  br label %cleanup4880
...
sw.bb4044:                                        ; preds = %if.end4039
  %475 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
if.end4048:                                       ; preds = %if.else4047, %if.then4046
  ...
  %476 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
sw.bb4066:                                        ; preds = %if.end4039
  ...
  %477 = load i32, ptr %options271, align 8, !tbaa !9
...
if.then4072:                                      ; preds = %sw.bb4066
  call void @free(ptr noundef nonnull %call341) #13
  %478 = load ptr, ptr %ctx, align 8, !tbaa !12
  store ptr @.str.216, ptr %478, align 8, !tbaa !13
  br label %cleanup4880
...
if.end4082:                                       ; preds = %sw.bb4066, %sw.default4075, %land.lhs.true3990, %land.lhs.true3974, %land.lhs.true3966, %if.end3957
  %479 = load ptr, ptr %dconf1570, align 8, !tbaa !25
...
land.lhs.true4091:                                ; preds = %if.end4082
  ...
  %481 = load i32, ptr %AddressOfEntryPoint4092, align 8, !tbaa !24
  ...
  %482 = load i32, ptr %arrayidx4096, align 4, !tbaa !37
...
land.lhs.true4106:                                ; preds = %land.lhs.true4101
  ...
  %483 = load i32, ptr %raw4111, align 4, !tbaa !41
...
if.end4140:                                       ; preds = %if.end4135
  %484 = load i32, ptr %e_lfanew, align 4, !tbaa !5
...
sw.bb4145:                                        ; preds = %if.end4140
  %485 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
if.end4149:                                       ; preds = %if.else4148, %if.then4147
  ...
  %486 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
cleanup4171:                                      ; preds = %if.end4140
  ...
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call4119, i32 noundef 0)
  call void @free(ptr noundef nonnull %call4132) #13
  %.pre7540 = load ptr, ptr %dconf1570, align 8, !tbaa !25
  %.pre7541 = load i32, ptr %.pre7540, align 4, !tbaa !26
  br label %if.end4174

if.end4174:                                       ; preds = %cleanup4171, %land.lhs.true4106, %land.lhs.true4101, %land.lhs.true4091, %if.end4082
  %487 = phi i32 [ %.pre7541, %cleanup4171 ], [ %480, %land.lhs.true4106 ], [ %480, %land.lhs.true4101 ], [ %480, %land.lhs.true4091 ], [ %480, %if.end4082 ]
...
land.lhs.true4183:                                ; preds = %if.end4174
  ...
  %488 = load i32, ptr %raw4188, align 4, !tbaa !41
...
land.lhs.true4191:                                ; preds = %land.lhs.true4183
  %489 = load i32, ptr %arrayidx4187, align 4, !tbaa !37
...
land.lhs.true4199:                                ; preds = %land.lhs.true4191
  ...
  %490 = load i32, ptr %rsz4209, align 4, !tbaa !42
...
for.body4236.preheader:                           ; preds = %for.cond4231.preheader
  %min.iters.check7654 = icmp ult i16 %8, 9
  br i1 %min.iters.check7654, label %for.body4236.preheader7665, label %vector.ph7655

vector.ph7655:                                    ; preds = %for.body4236.preheader
  %n.vec7657 = and i64 %idxprom4186, 4294967288
  ...
  br label %vector.body7660

vector.body7660:                                  ; preds = %vector.body7660, %vector.ph7655
  %index7661 = phi i64 [ 0, %vector.ph7655 ], [ %index.next7663, %vector.body7660 ]
  %vec.phi = phi <4 x i32> [ %minmax.ident.splat, %vector.ph7655 ], [ %522, %vector.body7660 ]
  %vec.phi7662 = phi <4 x i32> [ %minmax.ident.splat, %vector.ph7655 ], [ %523, %vector.body7660 ]
  %491 = or i64 %index7661, 1
  %492 = or i64 %index7661, 2
  %493 = or i64 %index7661, 3
  %494 = or i64 %index7661, 4
  %495 = or i64 %index7661, 5
  %496 = or i64 %index7661, 6
  %497 = or i64 %index7661, 7
  %498 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %index7661, i32 2
  ...
  %506 = load i32, ptr %498, align 4, !tbaa !41
  %507 = load i32, ptr %499, align 4, !tbaa !41
  ...
  %514 = load i32, ptr %502, align 4, !tbaa !41
  %515 = load i32, ptr %503, align 4, !tbaa !41
  ...
  %523 = call <4 x i32> @llvm.umin.v4i32(<4 x i32> %521, <4 x i32> %vec.phi7662)
  %index.next7663 = add nuw i64 %index7661, 8
  %524 = icmp eq i64 %index.next7663, %n.vec7657
  br i1 %524, label %middle.block7652, label %vector.body7660, !llvm.loop !81

middle.block7652:                                 ; preds = %vector.body7660
  ...
  %cmp.n7659 = icmp eq i64 %n.vec7657, %idxprom4186
  br i1 %cmp.n7659, label %for.end4249, label %for.body4236.preheader7665

for.body4236.preheader7665:                       ; preds = %for.body4236.preheader, %middle.block7652
  %indvars.iv7512.ph = phi i64 [ 0, %for.body4236.preheader ], [ %n.vec7657, %middle.block7652 ]
  %headsize.07425.ph = phi i32 [ %488, %for.body4236.preheader ], [ %525, %middle.block7652 ]
  br label %for.body4236

for.body4236:                                     ; preds = %for.body4236.preheader7665, %for.body4236
  %indvars.iv7512 = phi i64 [ %indvars.iv.next7513, %for.body4236 ], [ %indvars.iv7512.ph, %for.body4236.preheader7665 ]
  %headsize.07425 = phi i32 [ %spec.select7100, %for.body4236 ], [ %headsize.07425.ph, %for.body4236.preheader7665 ]
  %raw4239 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7512, i32 2
  %526 = load i32, ptr %raw4239, align 4, !tbaa !41
  %spec.select7100 = call i32 @llvm.umin.i32(i32 %526, i32 %headsize.07425)
  %indvars.iv.next7513 = add nuw nsw i64 %indvars.iv7512, 1
  %exitcond7516.not = icmp eq i64 %indvars.iv.next7513, %idxprom4186
  br i1 %exitcond7516.not, label %for.end4249, label %for.body4236, !llvm.loop !82

for.end4249:                                      ; preds = %for.body4236, %middle.block7652, %for.cond4231.preheader
  %headsize.0.lcssa = phi i32 [ %488, %for.cond4231.preheader ], [ %525, %middle.block7652 ], [ %spec.select7100, %for.body4236 ]
  ...
  %529 = load ptr, ptr %limits4258, align 8, !tbaa !62
...
if.then4270:                                      ; preds = %land.lhs.true4260
  ...
  call void @free(ptr noundef nonnull %call341) #13
  %531 = load i32, ptr %options271, align 8, !tbaa !9
...
if.then4276:                                      ; preds = %if.then4270
  %532 = load ptr, ptr %ctx, align 8, !tbaa !12
  store ptr @.str.227, ptr %532, align 8, !tbaa !13
  br label %cleanup4880

if.end4279:                                       ; preds = %for.end4249.if.end4279_crit_edge, %land.lhs.true4260
  %conv4280.pre-phi = phi i64 [ %.pre7544, %for.end4249.if.end4279_crit_edge ], [ %conv4265, %land.lhs.true4260 ]
...
if.then4284:                                      ; preds = %if.end4279
  %533 = load i32, ptr %dsize, align 4, !tbaa !5
...
for.body4299:                                     ; preds = %for.body4299.lr.ph, %for.inc4332
  %indvars.iv7517 = phi i64 [ 0, %for.body4299.lr.ph ], [ %indvars.iv.next7518, %for.inc4332 ]
  %arrayidx4301 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7517
  %rsz4302 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7517, i32 3
  %534 = load i32, ptr %rsz4302, align 4, !tbaa !42
...
lor.lhs.false4309:                                ; preds = %if.then4304
  %535 = load i32, ptr %arrayidx4301, align 4, !tbaa !37
  ...
  %call4323 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %gep7431, i32 noundef %536) #13
  %537 = load i32, ptr %rsz4302, align 4, !tbaa !42
...
for.inc4332:                                      ; preds = %for.body4299, %lor.lhs.false4309
  ...
  %exitcond7521.not = icmp eq i64 %indvars.iv.next7518, %idxprom4186
  br i1 %exitcond7521.not, label %for.end4334, label %for.body4299, !llvm.loop !83

for.end4334:                                      ; preds = %for.inc4332, %for.cond4294.preheader
  %538 = load i32, ptr %rsz4209, align 4, !tbaa !42
...
if.then4344:                                      ; preds = %for.end4334
  %539 = load i32, ptr %rsz4209, align 4, !tbaa !42
...
if.end4350:                                       ; preds = %for.end4334
  ...
  %.pre7542 = load i32, ptr %rsz4209, align 4, !tbaa !42
  br i1 %tobool4356.not, label %if.then4373, label %lor.lhs.false4357

lor.lhs.false4357:                                ; preds = %if.end4350
  %call4363 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %call4341, i32 noundef %.pre7542) #13
...
if.then4373:                                      ; preds = %lor.lhs.false4357, %if.end4350
  %541 = phi i32 [ %540, %lor.lhs.false4357 ], [ %.pre7542, %if.end4350 ]
...
if.end4379:                                       ; preds = %lor.lhs.false4357
  %542 = load i32, ptr %dsize, align 4, !tbaa !5
  %543 = load i32, ptr %arrayidx4187, align 4, !tbaa !37
  %544 = load i32, ptr %e_lfanew, align 4, !tbaa !5
...
if.end4404:                                       ; preds = %if.end4399
  %545 = load i32, ptr %dsize, align 4, !tbaa !5
  ...
  %546 = load i32, ptr %dsize, align 4, !tbaa !5
...
if.end4412:                                       ; preds = %if.end4404
  call void @free(ptr noundef %call4281) #13
  %547 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
if.then4422:                                      ; preds = %if.end4416
  ...
  %548 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
while.cond4442:                                   ; preds = %if.then3802, %if.else4434, %if.end4433, %if.end4174, %land.lhs.true4183, %land.lhs.true4191, %land.lhs.true4199, %land.lhs.true4213, %land.lhs.true4218
  %550 = load ptr, ptr %dconf1570, align 8, !tbaa !25
...
lor.lhs.false4461:                                ; preds = %land.rhs4453
  ...
  %brmerge = or i1 %tobool4465.not, %cmp4117374.not
  br i1 %brmerge, label %while.cond4656, label %for.body4472.preheader

for.body4472.preheader:                           ; preds = %lor.lhs.false4461
  %wide.trip.count7525 = zext i16 %8 to i64
  %xtraiter7689 = and i64 %wide.trip.count7525, 1
  %553 = icmp eq i16 %8, 1
...
for.body4472.preheader.new:                       ; preds = %for.body4472.preheader
  %unroll_iter = and i64 %wide.trip.count7525, 65534
  br label %for.body4472

for.body4472:                                     ; preds = %for.body4472, %for.body4472.preheader.new
  %indvars.iv7522 = phi i64 [ 0, %for.body4472.preheader.new ], [ %indvars.iv.next7523.1, %for.body4472 ]
  ...
  %arrayidx4474 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7522
  %555 = load i32, ptr %arrayidx4474, align 4, !tbaa !37
  %vsz4478 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7522, i32 1
  %556 = load i32, ptr %vsz4478, align 4, !tbaa !40
  %add4479 = add i32 %556, %555
  %add4479.fr = freeze i32 %add4479
  %spec.select7103 = call i32 @llvm.umax.i32(i32 %554, i32 %add4479.fr)
  %indvars.iv.next7523 = or i64 %indvars.iv7522, 1
  %arrayidx4474.1 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv.next7523
  %557 = load i32, ptr %arrayidx4474.1, align 4, !tbaa !37
  %vsz4478.1 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv.next7523, i32 1
  %558 = load i32, ptr %vsz4478.1, align 4, !tbaa !40
  ...
  %indvars.iv.next7523.1 = add nuw nsw i64 %indvars.iv7522, 2
...
for.end4493.unr-lcssa:                            ; preds = %for.body4472, %for.body4472.preheader
  ...
  %indvars.iv7522.unr = phi i64 [ 0, %for.body4472.preheader ], [ %indvars.iv.next7523.1, %for.body4472 ]
  %.unr = phi i32 [ 0, %for.body4472.preheader ], [ %spec.select7103.1, %for.body4472 ]
  %lcmp.mod7690.not = icmp eq i64 %xtraiter7689, 0
  br i1 %lcmp.mod7690.not, label %for.end4493, label %for.body4472.epil

for.body4472.epil:                                ; preds = %for.end4493.unr-lcssa
  %arrayidx4474.epil = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7522.unr
  %559 = load i32, ptr %arrayidx4474.epil, align 4, !tbaa !37
  %vsz4478.epil = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7522.unr, i32 1
  %560 = load i32, ptr %vsz4478.epil, align 4, !tbaa !40
...
if.end4496:                                       ; preds = %for.end4493
  ...
  %561 = load ptr, ptr %limits4497, align 8, !tbaa !62
...
if.then4509:                                      ; preds = %land.lhs.true4499
  ...
  call void @free(ptr noundef nonnull %call341) #13
  %563 = load i32, ptr %options271, align 8, !tbaa !9
...
if.then4515:                                      ; preds = %if.then4509
  %564 = load ptr, ptr %ctx, align 8, !tbaa !12
  store ptr @.str.239, ptr %564, align 8, !tbaa !13
  br label %cleanup4880

if.end4518:                                       ; preds = %if.end4496.if.end4518_crit_edge, %land.lhs.true4499
  %conv4519.pre-phi = phi i64 [ %.pre7545, %if.end4496.if.end4518_crit_edge ], [ %conv4504, %land.lhs.true4499 ]
...
for.body4528:                                     ; preds = %for.body4528.lr.ph, %for.inc4609
  %indvars.iv7527 = phi i64 [ 0, %for.body4528.lr.ph ], [ %indvars.iv.next7528, %for.inc4609 ]
  %arrayidx4530 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7527
  %rsz4531 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7527, i32 3
  %565 = load i32, ptr %rsz4531, align 4, !tbaa !42
...
land.lhs.true4543:                                ; preds = %if.end4534
  %566 = load i32, ptr %rsz4531, align 4, !tbaa !42
  %567 = add i32 %566, -1
...
land.lhs.true4555:                                ; preds = %land.lhs.true4543
  %568 = load i32, ptr %arrayidx4530, align 4, !tbaa !37
...
if.end4592:                                       ; preds = %land.lhs.true4555
  ...
  %569 = load i32, ptr %rsz4531, align 4, !tbaa !42
...
for.inc4609:                                      ; preds = %if.end4592, %for.body4528
  ...
  br i1 %exitcond7531.not, label %if.end4616, label %for.body4528, !llvm.loop !85

for.end4611.loopexit:                             ; preds = %if.end4592, %land.lhs.true4543, %land.lhs.true4555, %if.end4534
  %570 = trunc i64 %indvars.iv7527 to i32
...
if.end4625:                                       ; preds = %if.end4620
  ...
  %571 = load i32, ptr %ImageBase4627, align 4, !tbaa !24
...
sw.bb4629:                                        ; preds = %if.end4625
  %572 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
if.end4633:                                       ; preds = %if.else4632, %if.then4631
  ...
  %573 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
while.cond4656:                                   ; preds = %lor.lhs.false4461, %land.rhs4453, %if.then4615, %sw.default4651, %for.end4493, %while.cond4442
  %574 = load ptr, ptr %dconf1570, align 8, !tbaa !25
...
while.body4661:                                   ; preds = %while.cond4656
  ...
  %576 = load i8, ptr %epbuff, align 16, !tbaa !24
...
if.end4716:                                       ; preds = %if.end4710
  %nbuff.val7111 = load i32, ptr %nbuff, align 16
  %add4719 = add i32 %nbuff.val7111, %rep.0
...
if.end4731:                                       ; preds = %if.end4725
  ...
  %src4664.1.sroa.sel7133.v = select i1 %tobool4735.not, i64 9, i64 5
  %src4664.1.sroa.sel7133 = getelementptr inbounds i8, ptr %nbuff, i64 %src4664.1.sroa.sel7133.v
  %add.ptr4740.val = load i32, ptr %src4664.1.sroa.sel7133, align 1
  ...
  %578 = load ptr, ptr %limits4745, align 8, !tbaa !62
...
land.lhs.true4747:                                ; preds = %if.end4731
  ...
  %579 = load i64, ptr %maxfilesize4749, align 8, !tbaa !63
...
if.then4763:                                      ; preds = %land.lhs.true4751
  ...
  call void @free(ptr noundef %call341) #13
  %580 = load i32, ptr %options271, align 8, !tbaa !9
...
if.then4775:                                      ; preds = %if.then4763
  %581 = load ptr, ptr %ctx, align 8, !tbaa !12
  store ptr @.str.248, ptr %581, align 8, !tbaa !13
...
lor.lhs.false4782:                                ; preds = %if.end4778
  ...
  %582 = load i32, ptr %vsz4784, align 4, !tbaa !40
...
sw.bb4843:                                        ; preds = %if.end4838
  %586 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
if.end4847:                                       ; preds = %if.else4846, %if.then4845
  ...
  %587 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !24
...
for.inc:                                          ; preds = %land.lhs.true144, %for.body, %land.lhs.true142
  ...
  br i1 %or.cond547, label %for.body, label %for.cond157.preheader, !llvm.loop !92
...
cond.false191:                                    ; preds = %for.body162
  ...
  store i32 %.fr, ptr %arrayidx177537, align 4, !tbaa !37
