; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/zlib_compress.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/zlib_compress.c"
...
if.then3:                                         ; preds = %do.body
  %cond50 = call i64 @llvm.umin.i64(i64 %left.0, i64 4294967295)
  %cond = trunc i64 %cond50 to i32
  store i32 %cond, ptr %avail_out, align 8
  %sub = sub i64 %left.0, %cond50
  br label %if.end8
...
if.then12:                                        ; preds = %if.end8
  %cond1951 = call i64 @llvm.umin.i64(i64 %sourceLen.addr.0, i64 4294967295)
  %cond19 = trunc i64 %cond1951 to i32
  store i32 %cond19, ptr %avail_in, align 8
  %sub23 = sub i64 %sourceLen.addr.0, %cond1951
  br label %if.end24
...
if.end24:                                         ; preds = %if.then12, %if.end8
  ...
  br i1 %cmp27, label %do.bodythread-pre-split, label %do.end
...
if.then3.i:                                       ; preds = %do.body.i
  %cond50.i = call i64 @llvm.umin.i64(i64 %left.0.i, i64 4294967295)
  %cond.i = trunc i64 %cond50.i to i32
  store i32 %cond.i, ptr %avail_out.i, align 8
  %sub.i = sub i64 %left.0.i, %cond50.i
  br label %if.end8.i
...
if.then12.i:                                      ; preds = %if.end8.i
  %cond1951.i = call i64 @llvm.umin.i64(i64 %sourceLen.addr.0.i, i64 4294967295)
  %cond19.i = trunc i64 %cond1951.i to i32
  store i32 %cond19.i, ptr %avail_in.i, align 8
  %sub23.i = sub i64 %sourceLen.addr.0.i, %cond1951.i
  br label %if.end24.i
...
if.end24.i:                                       ; preds = %if.then12.i, %if.end8.i
  ...
  br i1 %cmp27.i, label %do.bodythread-pre-split.i, label %do.end.i
