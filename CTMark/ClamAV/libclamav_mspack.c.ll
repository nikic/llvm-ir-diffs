...
if.end3:                                          ; preds = %if.end
  ...
  store ptr %call4, ptr %inbuf, align 8
...
if.end8:                                          ; preds = %if.end3
  ...
  store ptr %call4, ptr %i_ptr, align 8
...
entry:
  ...
  %0 = load i32, ptr %bytes_output, align 8
  %add = add i32 %0, %data_flushed
  store i32 %add, ptr %bytes_output, align 8
...
land.lhs.true.if.end21_crit_edge:                 ; preds = %land.lhs.true
  %.pre = load ptr, ptr %o_ptr, align 8
  br label %if.end21
...
if.end21:                                         ; preds = %land.lhs.true.if.end21_crit_edge, %if.then13
  ...
  store ptr %add.ptr, ptr %o_ptr, align 8
...
do.body:                                          ; preds = %do.body.lr.ph, %if.end138
  ...
  %6 = load ptr, ptr %i_ptr31, align 8
  %7 = load ptr, ptr %i_end32, align 8
  %8 = load i32, ptr %bit_buffer33, align 8
  %9 = load i32, ptr %bits_left34, align 4
  %and = and i32 %9, 7
  %shr = lshr i32 %8, %and
  %sub35 = and i32 %9, -8
  br label %do.body36
...
if.then45:                                        ; preds = %while.body42
  %10 = load ptr, ptr %read1.i, align 8
  %tobool.not.i = icmp eq ptr %10, null
  %11 = load ptr, ptr %inbuf.i, align 8
  %12 = load i32, ptr %inbuf_size.i, align 8
...
if.then7.i:                                       ; preds = %if.end.i
  %15 = load i32, ptr %input_end.i, align 4
...
if.end53:                                         ; preds = %if.end50, %while.body42
  ...
  %18 = load i8, ptr %i_ptr.2, align 1
  ...
  br i1 %cmp40, label %while.body42, label %do.end56
...
do.end56:                                         ; preds = %if.end53, %do.body36
  ...
  br i1 %or.cond155, label %do.end77, label %do.body36

do.end77:                                         ; preds = %do.end56
  store i32 0, ptr %window_posn, align 4
  store i32 0, ptr %bytes_output, align 8
  store ptr %i_ptr.1.lcssa, ptr %i_ptr31, align 8
  store ptr %i_end.1.lcssa, ptr %i_end32, align 8
  store i32 %shr58, ptr %bit_buffer33, align 8
  store i32 %sub59, ptr %bits_left34, align 4
...
for.body.preheader:                               ; preds = %if.then89
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %scevgep278, i8 0, i64 %25, i1 false)
  br label %for.end

for.end:                                          ; preds = %for.body.preheader, %if.then89
  store i32 32768, ptr %bytes_output, align 8
  br label %if.end101
...
land.lhs.true134:                                 ; preds = %if.end131
  %29 = load i32, ptr %repair_mode, align 4
...
cleanup.sink.split:                               ; preds = %land.lhs.true123, %cond.end.i, %if.then9.i, %land.lhs.true, %if.else96, %if.then146
  ...
  store i32 %.sink, ptr %error1, align 8
  br label %cleanup
...
if.then:                                          ; preds = %while.body
  %6 = load ptr, ptr %read1.i, align 8
  %tobool.not.i = icmp eq ptr %6, null
  %7 = load ptr, ptr %inbuf.i, align 8
  %8 = load i32, ptr %inbuf_size.i, align 8
  br i1 %tobool.not.i, label %cond.false.i, label %cond.true.i
...
if.then.i:                                        ; preds = %cond.end.i
  ...
  store i32 -123, ptr %error.i, align 8
  br label %cleanup619
...
if.then7.i:                                       ; preds = %if.end.i
  %11 = load i32, ptr %input_end.i, align 4
...
if.then9.i:                                       ; preds = %if.then7.i
  ...
  store i32 -123, ptr %error10.i, align 8
  br label %cleanup619

if.else.i:                                        ; preds = %if.then7.i
  %12 = load ptr, ptr %inbuf.i, align 8
...
if.end:                                           ; preds = %if.else.i, %if.end.i
  %read.0.i = phi i32 [ 1, %if.else.i ], [ %cond.i, %if.end.i ]
  %13 = load ptr, ptr %inbuf.i, align 8
  store ptr %13, ptr %i_ptr1, align 8
  %idxprom.i = zext i32 %read.0.i to i64
  %arrayidx18.i = getelementptr inbounds i8, ptr %13, i64 %idxprom.i
  store ptr %arrayidx18.i, ptr %i_end2, align 8
  br label %if.end12
...
if.end12:                                         ; preds = %if.end, %while.body
  ...
  %incdec.ptr = getelementptr inbounds i8, ptr %i_ptr.2, i64 1
  %14 = load i8, ptr %i_ptr.2, align 1
  ...
  br i1 %cmp, label %while.body, label %do.end14
...
if.then25:                                        ; preds = %while.body22
  %15 = load ptr, ptr %read1.i, align 8
  %tobool.not.i908 = icmp eq ptr %15, null
  %16 = load ptr, ptr %inbuf.i, align 8
  %17 = load i32, ptr %inbuf_size.i, align 8
...
if.then.i934:                                     ; preds = %cond.end.i914
  ...
  store i32 -123, ptr %error.i935, align 8
  br label %cleanup619
...
if.then7.i927:                                    ; preds = %if.end.i917
  %20 = load i32, ptr %input_end.i, align 4
...
if.then9.i930:                                    ; preds = %if.then7.i927
  ...
  store i32 -123, ptr %error10.i931, align 8
  br label %cleanup619

if.else.i932:                                     ; preds = %if.then7.i927
  %21 = load ptr, ptr %inbuf.i, align 8
...
if.end30:                                         ; preds = %if.else.i932, %if.end.i917
  ...
  %22 = load ptr, ptr %inbuf.i, align 8
  store ptr %22, ptr %i_ptr1, align 8
  %idxprom.i923 = zext i32 %read.0.i920 to i64
  %arrayidx18.i924 = getelementptr inbounds i8, ptr %22, i64 %idxprom.i923
  store ptr %arrayidx18.i924, ptr %i_end2, align 8
  br label %if.end33
...
if.end33:                                         ; preds = %if.end30, %while.body22
  ...
  %23 = load i8, ptr %i_ptr.4, align 1
  ...
  br i1 %cmp20, label %while.body22, label %do.end41
...
for.body.preheader:                               ; preds = %if.then49
  ...
  store i8 %conv60, ptr %lens_buf, align 1
  %shr61 = lshr i32 %shr51, 8
  %cmp53.not = icmp eq i32 %sub52, 8
  br i1 %cmp53.not, label %while.body70.preheader, label %for.body.1
...
for.body.1:                                       ; preds = %for.body.preheader
  ...
  store i8 %conv60.1, ptr %arrayidx89, align 1
  %shr61.1 = lshr i32 %shr51, 16
  %cmp53.not.1 = icmp eq i32 %sub52, 16
  br i1 %cmp53.not.1, label %while.body70.preheader, label %for.body.2

for.body.2:                                       ; preds = %for.body.1
  %conv60.2 = trunc i32 %shr61.1 to i8
  store i8 %conv60.2, ptr %arrayidx93, align 1
  %shr61.2 = lshr i32 %shr51, 24
  %cmp53.not.2 = icmp eq i32 %sub52, 24
  br i1 %cmp53.not.2, label %while.body70.preheader, label %for.body.3

for.body.3:                                       ; preds = %for.body.2
  %conv60.3 = trunc i32 %shr61.2 to i8
  store i8 %conv60.3, ptr %arrayidx.3, align 1
  %cmp53.not.3 = icmp eq i32 %sub52, 32
  br i1 %cmp53.not.3, label %while.end86, label %cleanup.thread
...
if.then73:                                        ; preds = %while.body70
  %24 = load ptr, ptr %read1.i, align 8
  %tobool.not.i942 = icmp eq ptr %24, null
  %25 = load ptr, ptr %inbuf.i, align 8
  %26 = load i32, ptr %inbuf_size.i, align 8
...
if.then7.i961:                                    ; preds = %if.end.i951
  %29 = load i32, ptr %input_end.i, align 4
...
if.else.i966:                                     ; preds = %if.then7.i961
  %30 = load ptr, ptr %inbuf.i, align 8
...
if.end81:                                         ; preds = %if.end78, %while.body70
  ...
  %32 = load i8, ptr %i_ptr.6, align 1
  ...
  br i1 %exitcond.not, label %while.end86.loopexit, label %while.body70

while.end86.loopexit:                             ; preds = %if.end81
  %.pre = load i8, ptr %lens_buf, align 1
...
while.end86:                                      ; preds = %for.body.3, %while.end86.loopexit
  ...
  %34 = load i8, ptr %arrayidx89, align 1
...
if.then110:                                       ; preds = %while.body107
  %37 = load ptr, ptr %read1.i, align 8
  %tobool.not.i976 = icmp eq ptr %37, null
  %38 = load ptr, ptr %inbuf.i, align 8
  %39 = load i32, ptr %inbuf_size.i, align 8
...
cond.true.i977:                                   ; preds = %if.then110
  ...
  %call.i981 = tail call i32 %37(ptr noundef %40, ptr noundef %38, i32 noundef %39) #11
  br label %cond.end.i982

cond.false.i1004:                                 ; preds = %if.then110
  %41 = load i32, ptr %zip, align 8
  %call5.i1007 = tail call i32 @cli_readn(i32 noundef %41, ptr noundef %38, i32 noundef %39) #11
  br label %cond.end.i982
...
if.end115:                                        ; preds = %if.else.i1000, %if.end.i985
  ...
  %44 = load ptr, ptr %inbuf.i, align 8
  store ptr %44, ptr %i_ptr1, align 8
  %idxprom.i991 = zext i32 %read.0.i988 to i64
  %arrayidx18.i992 = getelementptr inbounds i8, ptr %44, i64 %idxprom.i991
  store ptr %arrayidx18.i992, ptr %i_end2, align 8
  br label %if.end118
...
if.end118:                                        ; preds = %if.end115, %while.body107
  ...
  %45 = load i32, ptr %window_posn, align 4
  ...
  %46 = load i32, ptr %window_posn, align 4
  %add140 = add i32 %this_run.1, %46
  store i32 %add140, ptr %window_posn, align 4
...
if.then145:                                       ; preds = %if.end118
  %47 = load ptr, ptr %flush_window, align 8
...
if.end151:                                        ; preds = %if.end149, %if.end118
  ...
  br i1 %cmp105.not, label %cleanup, label %while.body107
...
cleanup.thread.sink.split:                        ; preds = %cond.end.i948, %cond.end.i982, %cleanup.thread.sink.split.sink.split
  ...
  store i32 -123, ptr %error10.i999, align 8
...
for.cond197.preheader:                            ; preds = %do.end41
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(144) %LITERAL_len.i, i8 8, i64 144, i1 false)
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(112) %scevgep1519, i8 9, i64 112, i1 false)
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(24) %scevgep1521, i8 7, i64 24, i1 false)
  store i64 578721382704613384, ptr %scevgep1523, align 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(32) %DISTANCE_len.i, i8 5, i64 32, i1 false)
  br label %if.end225

do.body207:                                       ; preds = %do.end41
  store ptr %i_ptr.3.lcssa, ptr %i_ptr1, align 8
  store ptr %i_end.3.lcssa, ptr %i_end2, align 8
  store i32 %shr43, ptr %bit_buffer3, align 8
  store i32 %sub44, ptr %bits_left4, align 4
...
if.then.i1011:                                    ; preds = %while.body.i
  %48 = load ptr, ptr %read1.i, align 8
  %tobool.not.i.i = icmp eq ptr %48, null
  %49 = load ptr, ptr %inbuf.i, align 8
  %50 = load i32, ptr %inbuf_size.i, align 8
...
if.then.i.i:                                      ; preds = %cond.end.i.i
  ...
  store i32 -123, ptr %error.i.i, align 8
...
if.then7.i.i:                                     ; preds = %if.end.i.i
  %53 = load i32, ptr %input_end.i, align 4
...
if.then9.i.i:                                     ; preds = %if.then7.i.i
  ...
  store i32 -123, ptr %error10.i.i, align 8
  br label %mszip_read_lens.exit.thread

if.else.i.i:                                      ; preds = %if.then7.i.i
  %54 = load ptr, ptr %inbuf.i, align 8
...
if.end11.i:                                       ; preds = %if.end.i1012, %while.body.i
  ...
  %56 = load i8, ptr %i_ptr.1.i, align 1
  ...
  br i1 %cmp.i1013, label %while.body.i, label %do.end13.i
...
if.then25.i:                                      ; preds = %while.body22.i
  %57 = load ptr, ptr %read1.i, align 8
  %tobool.not.i504.i = icmp eq ptr %57, null
  %58 = load ptr, ptr %inbuf.i, align 8
  %59 = load i32, ptr %inbuf_size.i, align 8
  br i1 %tobool.not.i504.i, label %cond.false.i532.i, label %cond.true.i505.i

cond.true.i505.i:                                 ; preds = %if.then25.i
  %60 = load ptr, ptr %file.i, align 8
  %call.i509.i = tail call i32 %57(ptr noundef %60, ptr noundef %58, i32 noundef %59) #11
  br label %cond.end.i510.i

cond.false.i532.i:                                ; preds = %if.then25.i
  %61 = load i32, ptr %zip, align 8
  %call5.i535.i = tail call i32 @cli_readn(i32 noundef %61, ptr noundef %58, i32 noundef %59) #11
  br label %cond.end.i510.i
...
if.then.i530.i:                                   ; preds = %cond.end.i510.i
  ...
  store i32 -123, ptr %error.i531.i, align 8
  br label %mszip_read_lens.exit.thread
...
if.then7.i523.i:                                  ; preds = %if.end.i513.i
  %62 = load i32, ptr %input_end.i, align 4
  %tobool8.not.i525.i = icmp eq i32 %62, 0
...
if.then9.i526.i:                                  ; preds = %if.then7.i523.i
  ...
  store i32 -123, ptr %error10.i527.i, align 8
  br label %mszip_read_lens.exit.thread

if.else.i528.i:                                   ; preds = %if.then7.i523.i
  %63 = load ptr, ptr %inbuf.i, align 8
...
if.end30.i:                                       ; preds = %if.else.i528.i, %if.end.i513.i
  ...
  %64 = load ptr, ptr %inbuf.i, align 8
  store ptr %64, ptr %i_ptr1, align 8
  %idxprom.i519.i = zext i32 %read.0.i516.i to i64
  %arrayidx18.i520.i = getelementptr inbounds i8, ptr %64, i64 %idxprom.i519.i
  store ptr %arrayidx18.i520.i, ptr %i_end2, align 8
  br label %if.end33.i
...
if.end33.i:                                       ; preds = %if.end30.i, %while.body22.i
  ...
  %65 = load i8, ptr %i_ptr.3.i, align 1
  ...
  br i1 %cmp20.i, label %while.body22.i, label %do.end41.i
...
if.then56.i:                                      ; preds = %while.body53.i
  %66 = load ptr, ptr %read1.i, align 8
  %tobool.not.i538.i = icmp eq ptr %66, null
  %67 = load ptr, ptr %inbuf.i, align 8
  %68 = load i32, ptr %inbuf_size.i, align 8
  br i1 %tobool.not.i538.i, label %cond.false.i566.i, label %cond.true.i539.i

cond.true.i539.i:                                 ; preds = %if.then56.i
  %69 = load ptr, ptr %file.i, align 8
  %call.i543.i = tail call i32 %66(ptr noundef %69, ptr noundef %67, i32 noundef %68) #11
  br label %cond.end.i544.i

cond.false.i566.i:                                ; preds = %if.then56.i
  %70 = load i32, ptr %zip, align 8
  %call5.i569.i = tail call i32 @cli_readn(i32 noundef %70, ptr noundef %67, i32 noundef %68) #11
  br label %cond.end.i544.i
...
if.then.i564.i:                                   ; preds = %cond.end.i544.i
  ...
  store i32 -123, ptr %error.i565.i, align 8
  br label %mszip_read_lens.exit.thread
...
if.then7.i557.i:                                  ; preds = %if.end.i547.i
  %71 = load i32, ptr %input_end.i, align 4
  %tobool8.not.i559.i = icmp eq i32 %71, 0
...
if.then9.i560.i:                                  ; preds = %if.then7.i557.i
  ...
  store i32 -123, ptr %error10.i561.i, align 8
  br label %mszip_read_lens.exit.thread

if.else.i562.i:                                   ; preds = %if.then7.i557.i
  %72 = load ptr, ptr %inbuf.i, align 8
...
if.end61.i:                                       ; preds = %if.else.i562.i, %if.end.i547.i
  ...
  %73 = load ptr, ptr %inbuf.i, align 8
  store ptr %73, ptr %i_ptr1, align 8
  %idxprom.i553.i = zext i32 %read.0.i550.i to i64
  %arrayidx18.i554.i = getelementptr inbounds i8, ptr %73, i64 %idxprom.i553.i
  store ptr %arrayidx18.i554.i, ptr %i_end2, align 8
  br label %if.end64.i
...
if.end64.i:                                       ; preds = %if.end61.i, %while.body53.i
  ...
  %74 = load i8, ptr %i_ptr.5.i, align 1
  ...
  br i1 %cmp51.i, label %while.body53.i, label %do.end72.i
...
while.body125.i.prol:                             ; preds = %while.body125.i.preheader, %while.body125.i.prol
  ...
  %78 = load i8, ptr %arrayidx128.i.prol, align 1
  ...
  store i8 0, ptr %arrayidx130.i.prol, align 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %while.body125.i.prol.loopexit, label %while.body125.i.prol
...
if.then97.i:                                      ; preds = %while.body94.i
  %81 = load ptr, ptr %read1.i, align 8
  %tobool.not.i572.i = icmp eq ptr %81, null
  %82 = load ptr, ptr %inbuf.i, align 8
  %83 = load i32, ptr %inbuf_size.i, align 8
  br i1 %tobool.not.i572.i, label %cond.false.i600.i, label %cond.true.i573.i

cond.true.i573.i:                                 ; preds = %if.then97.i
  %84 = load ptr, ptr %file.i, align 8
  %call.i577.i = tail call i32 %81(ptr noundef %84, ptr noundef %82, i32 noundef %83) #11
  br label %cond.end.i578.i

cond.false.i600.i:                                ; preds = %if.then97.i
  %85 = load i32, ptr %zip, align 8
  %call5.i603.i = tail call i32 @cli_readn(i32 noundef %85, ptr noundef %82, i32 noundef %83) #11
  br label %cond.end.i578.i
...
if.then.i598.i:                                   ; preds = %cond.end.i578.i
  ...
  store i32 -123, ptr %error.i599.i, align 8
  br label %mszip_read_lens.exit.thread
...
if.then7.i591.i:                                  ; preds = %if.end.i581.i
  %86 = load i32, ptr %input_end.i, align 4
  %tobool8.not.i593.i = icmp eq i32 %86, 0
...
if.then9.i594.i:                                  ; preds = %if.then7.i591.i
  ...
  store i32 -123, ptr %error10.i595.i, align 8
  br label %mszip_read_lens.exit.thread

if.else.i596.i:                                   ; preds = %if.then7.i591.i
  %87 = load ptr, ptr %inbuf.i, align 8
...
if.end102.i:                                      ; preds = %if.else.i596.i, %if.end.i581.i
  ...
  %88 = load ptr, ptr %inbuf.i, align 8
  store ptr %88, ptr %i_ptr1, align 8
  %idxprom.i587.i = zext i32 %read.0.i584.i to i64
  %arrayidx18.i588.i = getelementptr inbounds i8, ptr %88, i64 %idxprom.i587.i
  store ptr %arrayidx18.i588.i, ptr %i_end2, align 8
...
if.end105.i:                                      ; preds = %if.end102.i, %while.body94.i
  ...
  %89 = load i8, ptr %i_ptr.8.i, align 1
  ...
  br i1 %cmp92.i, label %while.body94.i, label %do.end113.i
...
while.body125.i:                                  ; preds = %while.body125.i.prol.loopexit, %while.body125.i
  ...
  %92 = load i8, ptr %arrayidx128.i, align 1
...
if.then150.i:                                     ; preds = %while.body147.i
  %96 = load ptr, ptr %read1.i, align 8
  %tobool.not.i606.i = icmp eq ptr %96, null
  %97 = load ptr, ptr %inbuf.i, align 8
  %98 = load i32, ptr %inbuf_size.i, align 8
  br i1 %tobool.not.i606.i, label %cond.false.i634.i, label %cond.true.i607.i

cond.true.i607.i:                                 ; preds = %if.then150.i
  %99 = load ptr, ptr %file.i, align 8
  %call.i611.i = tail call i32 %96(ptr noundef %99, ptr noundef %97, i32 noundef %98) #11
  br label %cond.end.i612.i

cond.false.i634.i:                                ; preds = %if.then150.i
  %100 = load i32, ptr %zip, align 8
  %call5.i637.i = tail call i32 @cli_readn(i32 noundef %100, ptr noundef %97, i32 noundef %98) #11
  br label %cond.end.i612.i
...
if.then.i632.i:                                   ; preds = %cond.end.i612.i
  ...
  store i32 -123, ptr %error.i633.i, align 8
  br label %mszip_read_lens.exit.thread
...
if.then7.i625.i:                                  ; preds = %if.end.i615.i
  %101 = load i32, ptr %input_end.i, align 4
  %tobool8.not.i627.i = icmp eq i32 %101, 0
...
if.then9.i628.i:                                  ; preds = %if.then7.i625.i
  ...
  store i32 -123, ptr %error10.i629.i, align 8
  br label %mszip_read_lens.exit.thread

if.else.i630.i:                                   ; preds = %if.then7.i625.i
  %102 = load ptr, ptr %inbuf.i, align 8
...
if.end155.i:                                      ; preds = %if.else.i630.i, %if.end.i615.i
  ...
  %103 = load ptr, ptr %inbuf.i, align 8
  store ptr %103, ptr %i_ptr1, align 8
  %idxprom.i621.i = zext i32 %read.0.i618.i to i64
  %arrayidx18.i622.i = getelementptr inbounds i8, ptr %103, i64 %idxprom.i621.i
  store ptr %arrayidx18.i622.i, ptr %i_end2, align 8
...
if.end158.i:                                      ; preds = %if.end155.i, %while.body147.i
  ...
  %104 = load i8, ptr %i_ptr.11.i, align 1
  ...
  br i1 %cmp145.i, label %while.body147.i, label %do.end166.i
...
do.end166.i:                                      ; preds = %if.end158.i, %while.cond144.preheader.i
  ...
  %105 = load i16, ptr %arrayidx169.i, align 2
  ...
  %106 = load i8, ptr %arrayidx172.i, align 1
...
if.then181.i:                                     ; preds = %do.end166.i
  ...
  store i8 %conv182.i, ptr %arrayidx184.i, align 1
...
if.then193.i:                                     ; preds = %while.body190.i
  %107 = load ptr, ptr %read1.i, align 8
  %tobool.not.i640.i = icmp eq ptr %107, null
  %108 = load ptr, ptr %inbuf.i, align 8
  %109 = load i32, ptr %inbuf_size.i, align 8
  br i1 %tobool.not.i640.i, label %cond.false.i668.i, label %cond.true.i641.i

cond.true.i641.i:                                 ; preds = %if.then193.i
  %110 = load ptr, ptr %file.i, align 8
  %call.i645.i = tail call i32 %107(ptr noundef %110, ptr noundef %108, i32 noundef %109) #11
  br label %cond.end.i646.i

cond.false.i668.i:                                ; preds = %if.then193.i
  %111 = load i32, ptr %zip, align 8
  %call5.i671.i = tail call i32 @cli_readn(i32 noundef %111, ptr noundef %108, i32 noundef %109) #11
  br label %cond.end.i646.i
...
if.then.i666.i:                                   ; preds = %cond.end.i646.i
  ...
  store i32 -123, ptr %error.i667.i, align 8
  br label %mszip_read_lens.exit.thread
...
if.then7.i659.i:                                  ; preds = %if.end.i649.i
  %112 = load i32, ptr %input_end.i, align 4
  %tobool8.not.i661.i = icmp eq i32 %112, 0
...
if.then9.i662.i:                                  ; preds = %if.then7.i659.i
  ...
  store i32 -123, ptr %error10.i663.i, align 8
  br label %mszip_read_lens.exit.thread

if.else.i664.i:                                   ; preds = %if.then7.i659.i
  %113 = load ptr, ptr %inbuf.i, align 8
...
if.end198.i:                                      ; preds = %if.else.i664.i, %if.end.i649.i
  ...
  %114 = load ptr, ptr %inbuf.i, align 8
  store ptr %114, ptr %i_ptr1, align 8
  %idxprom.i655.i = zext i32 %read.0.i652.i to i64
  %arrayidx18.i656.i = getelementptr inbounds i8, ptr %114, i64 %idxprom.i655.i
  store ptr %arrayidx18.i656.i, ptr %i_end2, align 8
...
if.end201.i:                                      ; preds = %if.end198.i, %while.body190.i
  ...
  %115 = load i8, ptr %i_ptr.13.i, align 1
  ...
  br i1 %cmp188.i, label %while.body190.i, label %do.end209.i
...
if.then225.i:                                     ; preds = %while.body222.i
  %116 = load ptr, ptr %read1.i, align 8
  %tobool.not.i674.i = icmp eq ptr %116, null
  %117 = load ptr, ptr %inbuf.i, align 8
  %118 = load i32, ptr %inbuf_size.i, align 8
  br i1 %tobool.not.i674.i, label %cond.false.i702.i, label %cond.true.i675.i

cond.true.i675.i:                                 ; preds = %if.then225.i
  %119 = load ptr, ptr %file.i, align 8
  %call.i679.i = tail call i32 %116(ptr noundef %119, ptr noundef %117, i32 noundef %118) #11
  br label %cond.end.i680.i

cond.false.i702.i:                                ; preds = %if.then225.i
  %120 = load i32, ptr %zip, align 8
  %call5.i705.i = tail call i32 @cli_readn(i32 noundef %120, ptr noundef %117, i32 noundef %118) #11
  br label %cond.end.i680.i
...
if.then.i700.i:                                   ; preds = %cond.end.i680.i
  ...
  store i32 -123, ptr %error.i701.i, align 8
  br label %mszip_read_lens.exit.thread
...
if.then7.i693.i:                                  ; preds = %if.end.i683.i
  %121 = load i32, ptr %input_end.i, align 4
  %tobool8.not.i695.i = icmp eq i32 %121, 0
...
if.then9.i696.i:                                  ; preds = %if.then7.i693.i
  ...
  store i32 -123, ptr %error10.i697.i, align 8
  br label %mszip_read_lens.exit.thread

if.else.i698.i:                                   ; preds = %if.then7.i693.i
  %122 = load ptr, ptr %inbuf.i, align 8
...
if.end230.i:                                      ; preds = %if.else.i698.i, %if.end.i683.i
  ...
  %123 = load ptr, ptr %inbuf.i, align 8
  store ptr %123, ptr %i_ptr1, align 8
  %idxprom.i689.i = zext i32 %read.0.i686.i to i64
  %arrayidx18.i690.i = getelementptr inbounds i8, ptr %123, i64 %idxprom.i689.i
  store ptr %arrayidx18.i690.i, ptr %i_end2, align 8
...
if.end233.i:                                      ; preds = %if.end230.i, %while.body222.i
  ...
  %124 = load i8, ptr %i_ptr.15.i, align 1
  ...
  br i1 %cmp220.i, label %while.body222.i, label %do.end241.i
...
if.then257.i:                                     ; preds = %while.body254.i
  %125 = load ptr, ptr %read1.i, align 8
  %tobool.not.i708.i = icmp eq ptr %125, null
  %126 = load ptr, ptr %inbuf.i, align 8
  %127 = load i32, ptr %inbuf_size.i, align 8
  br i1 %tobool.not.i708.i, label %cond.false.i736.i, label %cond.true.i709.i

cond.true.i709.i:                                 ; preds = %if.then257.i
  %128 = load ptr, ptr %file.i, align 8
  %call.i713.i = tail call i32 %125(ptr noundef %128, ptr noundef %126, i32 noundef %127) #11
  br label %cond.end.i714.i

cond.false.i736.i:                                ; preds = %if.then257.i
  %129 = load i32, ptr %zip, align 8
  %call5.i739.i = tail call i32 @cli_readn(i32 noundef %129, ptr noundef %126, i32 noundef %127) #11
  br label %cond.end.i714.i
...
if.then.i734.i:                                   ; preds = %cond.end.i714.i
  ...
  store i32 -123, ptr %error.i735.i, align 8
  br label %mszip_read_lens.exit.thread
...
if.then7.i727.i:                                  ; preds = %if.end.i717.i
  %130 = load i32, ptr %input_end.i, align 4
  %tobool8.not.i729.i = icmp eq i32 %130, 0
...
if.then9.i730.i:                                  ; preds = %if.then7.i727.i
  ...
  store i32 -123, ptr %error10.i731.i, align 8
  br label %mszip_read_lens.exit.thread

if.else.i732.i:                                   ; preds = %if.then7.i727.i
  %131 = load ptr, ptr %inbuf.i, align 8
...
if.end262.i:                                      ; preds = %if.else.i732.i, %if.end.i717.i
  ...
  %132 = load ptr, ptr %inbuf.i, align 8
  store ptr %132, ptr %i_ptr1, align 8
  %idxprom.i723.i = zext i32 %read.0.i720.i to i64
  %arrayidx18.i724.i = getelementptr inbounds i8, ptr %132, i64 %idxprom.i723.i
  store ptr %arrayidx18.i724.i, ptr %i_end2, align 8
...
if.end265.i:                                      ; preds = %if.end262.i, %while.body254.i
  ...
  %133 = load i8, ptr %i_ptr.17.i, align 1
  ...
  br i1 %cmp252.i, label %while.body254.i, label %do.end273.i
...
vector.ph1727:                                    ; preds = %vector.scevcheck
  ...
  store <16 x i8> %broadcast.splat, ptr %138, align 1
  %139 = getelementptr inbounds i8, ptr %138, i64 16
  store <16 x i8> %broadcast.splat, ptr %139, align 1
  %140 = icmp eq i32 %n.vec1729, 32
  br i1 %140, label %middle.block1725, label %vector.body1735.1
...
vector.body1735.1:                                ; preds = %vector.ph1727
  ...
  store <16 x i8> %broadcast.splat, ptr %142, align 1
  %143 = getelementptr inbounds i8, ptr %142, i64 16
  store <16 x i8> %broadcast.splat, ptr %143, align 1
  %144 = icmp eq i32 %n.vec1729, 64
  br i1 %144, label %middle.block1725, label %vector.body1735.2
...
vector.body1735.2:                                ; preds = %vector.body1735.1
  ...
  store <16 x i8> %broadcast.splat, ptr %146, align 1
  %147 = getelementptr inbounds i8, ptr %146, i64 16
  store <16 x i8> %broadcast.splat, ptr %147, align 1
  %148 = icmp eq i32 %n.vec1729, 96
  br i1 %148, label %middle.block1725, label %vector.body1735.3
...
vector.body1735.3:                                ; preds = %vector.body1735.2
  ...
  store <16 x i8> %broadcast.splat, ptr %150, align 1
  %151 = getelementptr inbounds i8, ptr %150, i64 16
  store <16 x i8> %broadcast.splat, ptr %151, align 1
...
while.body288.i.prol:                             ; preds = %while.body288.i.preheader, %while.body288.i.prol
  ...
  store i8 %conv289.i, ptr %arrayidx292.i.prol, align 1
  %prol.iter1852.next = add i32 %prol.iter1852, 1
  %prol.iter1852.cmp.not = icmp eq i32 %prol.iter1852.next, %xtraiter1850
  br i1 %prol.iter1852.cmp.not, label %while.body288.i.prol.loopexit, label %while.body288.i.prol
...
while.body288.i:                                  ; preds = %while.body288.i.prol.loopexit, %while.body288.i
  ...
  store i8 %conv289.i, ptr %arrayidx292.i, align 1
  ...
  store i8 %conv289.i, ptr %arrayidx292.i.1, align 1
  ...
  store i8 %conv289.i, ptr %arrayidx292.i.2, align 1
  ...
  store i8 %conv289.i, ptr %arrayidx292.i.3, align 1
  %tobool287.not.i.3 = icmp eq i32 %dec.i.3, 0
  br i1 %tobool287.not.i.3, label %for.inc296.i, label %while.body288.i
...
for.inc296.i:                                     ; preds = %while.body288.i.prol.loopexit, %while.body288.i, %middle.block1725, %if.then181.i
  ...
  br i1 %cmp140.i, label %while.cond144.preheader.i, label %for.end298.i
...
while.body305.preheader.i:                        ; preds = %for.end298.i
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %scevgep.i, i8 0, i64 %157, i1 false)
...
while.body318.preheader.i:                        ; preds = %while.end310.i
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %scevgep988.i, i8 0, i64 %161, i1 false)
  br label %do.body218
...
do.body218:                                       ; preds = %while.body318.preheader.i, %while.end310.i
  store ptr %i_ptr.19.i, ptr %i_ptr1, align 8
  store ptr %i_end.19.i, ptr %i_end2, align 8
  store i32 %bit_buffer.11.i, ptr %bit_buffer3, align 8
  store i32 %bits_left.11.i, ptr %bits_left4, align 4
  call void @llvm.lifetime.end.p0(i64 320, ptr nonnull %lens.i) #11
  call void @llvm.lifetime.end.p0(i64 19, ptr nonnull %bl_len.i) #11
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %bl_table.i) #11
  br label %if.end225
...
if.end239:                                        ; preds = %if.end232
  %162 = load i32, ptr %window_posn, align 4
...
if.then251:                                       ; preds = %while.body248
  %163 = load ptr, ptr %read1.i, align 8
  %tobool.not.i1015 = icmp eq ptr %163, null
  %164 = load ptr, ptr %inbuf.i, align 8
  %165 = load i32, ptr %inbuf_size.i, align 8
  br i1 %tobool.not.i1015, label %cond.false.i1043, label %cond.true.i1016

cond.true.i1016:                                  ; preds = %if.then251
  %166 = load ptr, ptr %file.i, align 8
  %call.i1020 = tail call i32 %163(ptr noundef %166, ptr noundef %164, i32 noundef %165) #11
  br label %cond.end.i1021

cond.false.i1043:                                 ; preds = %if.then251
  %167 = load i32, ptr %zip, align 8
  %call5.i1046 = tail call i32 @cli_readn(i32 noundef %167, ptr noundef %164, i32 noundef %165) #11
  br label %cond.end.i1021
...
if.then.i1041:                                    ; preds = %cond.end.i1021
  ...
  store i32 -123, ptr %error.i1042, align 8
  br label %cleanup619
...
if.then7.i1034:                                   ; preds = %if.end.i1024
  %168 = load i32, ptr %input_end.i, align 4
  %tobool8.not.i1036 = icmp eq i32 %168, 0
...
if.then9.i1037:                                   ; preds = %if.then7.i1034
  ...
  store i32 -123, ptr %error10.i1038, align 8
  br label %cleanup619

if.else.i1039:                                    ; preds = %if.then7.i1034
  %169 = load ptr, ptr %inbuf.i, align 8
...
if.end256:                                        ; preds = %if.else.i1039, %if.end.i1024
  ...
  %170 = load ptr, ptr %inbuf.i, align 8
  store ptr %170, ptr %i_ptr1, align 8
  %idxprom.i1030 = zext i32 %read.0.i1027 to i64
  %arrayidx18.i1031 = getelementptr inbounds i8, ptr %170, i64 %idxprom.i1030
  store ptr %arrayidx18.i1031, ptr %i_end2, align 8
  br label %if.end259
...
if.end259:                                        ; preds = %if.end256, %while.body248
  ...
  %171 = load i8, ptr %i_ptr.13, align 1
  ...
  br i1 %cmp246, label %while.body248, label %do.end267
...
do.end267:                                        ; preds = %if.end259, %while.cond241
  ...
  %172 = load i16, ptr %arrayidx271, align 2
...
if.end292:                                        ; preds = %do.body276.preheader
  ...
  %174 = load i16, ptr %arrayidx295, align 2
  %cmp298 = icmp ugt i16 %174, 287
  br i1 %cmp298, label %do.body276.1, label %if.end301
...
if.end292.1:                                      ; preds = %do.body276.1
  ...
  %176 = load i16, ptr %arrayidx295.1, align 2
  %cmp298.1 = icmp ugt i16 %176, 287
  br i1 %cmp298.1, label %do.body276.2, label %if.end301
...
if.end292.2:                                      ; preds = %do.body276.2
  ...
  %178 = load i16, ptr %arrayidx295.2, align 2
  %cmp298.2 = icmp ugt i16 %178, 287
  br i1 %cmp298.2, label %do.body276.3, label %if.end301
...
if.end292.3:                                      ; preds = %do.body276.3
  ...
  %180 = load i16, ptr %arrayidx295.3, align 2
  %cmp298.3 = icmp ugt i16 %180, 287
  br i1 %cmp298.3, label %do.body276.4, label %if.end301
...
if.end292.4:                                      ; preds = %do.body276.4
  ...
  %182 = load i16, ptr %arrayidx295.4, align 2
  %cmp298.4 = icmp ugt i16 %182, 287
  br i1 %cmp298.4, label %do.body276.5, label %if.end301
...
if.end292.5:                                      ; preds = %do.body276.5
  ...
  %184 = load i16, ptr %arrayidx295.5, align 2
  %cmp298.5 = icmp ugt i16 %184, 287
  br i1 %cmp298.5, label %do.body276.6, label %if.end301
...
if.end292.6:                                      ; preds = %do.body276.6
  ...
  %186 = load i16, ptr %arrayidx295.6, align 2
  %cmp298.6 = icmp ugt i16 %186, 287
  br i1 %cmp298.6, label %do.body276.7, label %if.end301
...
if.end292.7:                                      ; preds = %do.body276.7
  ...
  %188 = load i16, ptr %arrayidx295.7, align 2
  %cmp298.7 = icmp ugt i16 %188, 287
  br i1 %cmp298.7, label %do.body276.8, label %if.end301
...
if.end292.8:                                      ; preds = %do.body276.8
  ...
  %190 = load i16, ptr %arrayidx295.8, align 2
  %cmp298.8 = icmp ugt i16 %190, 287
  br i1 %cmp298.8, label %if.then280, label %if.end301
...
if.end301:                                        ; preds = %if.end292, %if.end292.1, %if.end292.2, %if.end292.3, %if.end292.4, %if.end292.5, %if.end292.6, %if.end292.7, %if.end292.8, %do.end267
  ...
  %191 = load i8, ptr %arrayidx305, align 1
...
if.then313:                                       ; preds = %if.end301
  ...
  store i8 %conv314, ptr %arrayidx318, align 1
...
if.then321:                                       ; preds = %if.then313
  %192 = load ptr, ptr %flush_window, align 8
...
while.cond340.preheader:                          ; preds = %if.else332
  ...
  %193 = load i8, ptr %arrayidx342, align 1
...
if.then349:                                       ; preds = %while.body346
  %194 = load ptr, ptr %read1.i, align 8
  %tobool.not.i1049 = icmp eq ptr %194, null
  %195 = load ptr, ptr %inbuf.i, align 8
  %196 = load i32, ptr %inbuf_size.i, align 8
  br i1 %tobool.not.i1049, label %cond.false.i1077, label %cond.true.i1050

cond.true.i1050:                                  ; preds = %if.then349
  %197 = load ptr, ptr %file.i, align 8
  %call.i1054 = tail call i32 %194(ptr noundef %197, ptr noundef %195, i32 noundef %196) #11
  br label %cond.end.i1055

cond.false.i1077:                                 ; preds = %if.then349
  %198 = load i32, ptr %zip, align 8
  %call5.i1080 = tail call i32 @cli_readn(i32 noundef %198, ptr noundef %195, i32 noundef %196) #11
  br label %cond.end.i1055
...
if.then.i1075:                                    ; preds = %cond.end.i1055
  ...
  store i32 -123, ptr %error.i1076, align 8
  br label %cleanup619
...
if.then7.i1068:                                   ; preds = %if.end.i1058
  %199 = load i32, ptr %input_end.i, align 4
  %tobool8.not.i1070 = icmp eq i32 %199, 0
...
if.then9.i1071:                                   ; preds = %if.then7.i1068
  ...
  store i32 -123, ptr %error10.i1072, align 8
  br label %cleanup619

if.else.i1073:                                    ; preds = %if.then7.i1068
  %200 = load ptr, ptr %inbuf.i, align 8
...
if.end354:                                        ; preds = %if.else.i1073, %if.end.i1058
  ...
  %201 = load ptr, ptr %inbuf.i, align 8
  store ptr %201, ptr %i_ptr1, align 8
  %idxprom.i1064 = zext i32 %read.0.i1061 to i64
  %arrayidx18.i1065 = getelementptr inbounds i8, ptr %201, i64 %idxprom.i1064
  store ptr %arrayidx18.i1065, ptr %i_end2, align 8
  br label %if.end357
...
if.end357:                                        ; preds = %if.end354, %while.body346
  ...
  %202 = load i8, ptr %i_ptr.15, align 1
  ...
  br i1 %cmp344, label %while.body346, label %do.end365
...
do.end365:                                        ; preds = %if.end357, %while.cond340.preheader
  ...
  %203 = load i16, ptr %arrayidx369, align 2
  ...
  %204 = load i16, ptr %arrayidx383, align 2
...
if.then394:                                       ; preds = %while.body391
  %205 = load ptr, ptr %read1.i, align 8
  %tobool.not.i1083 = icmp eq ptr %205, null
  %206 = load ptr, ptr %inbuf.i, align 8
  %207 = load i32, ptr %inbuf_size.i, align 8
  br i1 %tobool.not.i1083, label %cond.false.i1111, label %cond.true.i1084

cond.true.i1084:                                  ; preds = %if.then394
  %208 = load ptr, ptr %file.i, align 8
  %call.i1088 = tail call i32 %205(ptr noundef %208, ptr noundef %206, i32 noundef %207) #11
  br label %cond.end.i1089

cond.false.i1111:                                 ; preds = %if.then394
  %209 = load i32, ptr %zip, align 8
  %call5.i1114 = tail call i32 @cli_readn(i32 noundef %209, ptr noundef %206, i32 noundef %207) #11
  br label %cond.end.i1089
...
if.then.i1109:                                    ; preds = %cond.end.i1089
  ...
  store i32 -123, ptr %error.i1110, align 8
  br label %cleanup619
...
if.then7.i1102:                                   ; preds = %if.end.i1092
  %210 = load i32, ptr %input_end.i, align 4
  %tobool8.not.i1104 = icmp eq i32 %210, 0
...
if.then9.i1105:                                   ; preds = %if.then7.i1102
  ...
  store i32 -123, ptr %error10.i1106, align 8
  br label %cleanup619

if.else.i1107:                                    ; preds = %if.then7.i1102
  %211 = load ptr, ptr %inbuf.i, align 8
...
if.end399:                                        ; preds = %if.else.i1107, %if.end.i1092
  ...
  %212 = load ptr, ptr %inbuf.i, align 8
  store ptr %212, ptr %i_ptr1, align 8
  %idxprom.i1098 = zext i32 %read.0.i1095 to i64
  %arrayidx18.i1099 = getelementptr inbounds i8, ptr %212, i64 %idxprom.i1098
  store ptr %arrayidx18.i1099, ptr %i_end2, align 8
  br label %if.end402
...
if.end402:                                        ; preds = %if.end399, %while.body391
  ...
  %213 = load i8, ptr %i_ptr.17, align 1
  ...
  br i1 %cmp389, label %while.body391, label %do.end410
...
do.end410:                                        ; preds = %if.end402, %do.end365
  ...
  %214 = load i16, ptr %arrayidx414, align 2
...
if.end435:                                        ; preds = %do.body419.preheader
  ...
  %217 = load i16, ptr %arrayidx438, align 2
  %cmp441 = icmp ugt i16 %217, 31
  br i1 %cmp441, label %do.body419.1, label %if.end444
...
if.end435.1:                                      ; preds = %do.body419.1
  ...
  %220 = load i16, ptr %arrayidx438.1, align 2
  %cmp441.1 = icmp ugt i16 %220, 31
  br i1 %cmp441.1, label %do.body419.2, label %if.end444
...
if.end435.2:                                      ; preds = %do.body419.2
  ...
  %223 = load i16, ptr %arrayidx438.2, align 2
  %cmp441.2 = icmp ugt i16 %223, 31
  br i1 %cmp441.2, label %do.body419.3, label %if.end444
...
if.end435.3:                                      ; preds = %do.body419.3
  ...
  %226 = load i16, ptr %arrayidx438.3, align 2
  %cmp441.3 = icmp ugt i16 %226, 31
  br i1 %cmp441.3, label %do.body419.4, label %if.end444
...
if.end435.4:                                      ; preds = %do.body419.4
  ...
  %229 = load i16, ptr %arrayidx438.4, align 2
  %cmp441.4 = icmp ugt i16 %229, 31
  br i1 %cmp441.4, label %do.body419.5, label %if.end444
...
if.end435.5:                                      ; preds = %do.body419.5
  ...
  %232 = load i16, ptr %arrayidx438.5, align 2
  %cmp441.5 = icmp ugt i16 %232, 31
  br i1 %cmp441.5, label %do.body419.6, label %if.end444
...
if.end435.6:                                      ; preds = %do.body419.6
  ...
  %235 = load i16, ptr %arrayidx438.6, align 2
  %cmp441.6 = icmp ugt i16 %235, 31
  br i1 %cmp441.6, label %do.body419.7, label %if.end444
...
if.end435.7:                                      ; preds = %do.body419.7
  ...
  %238 = load i16, ptr %arrayidx438.7, align 2
  %cmp441.7 = icmp ugt i16 %238, 31
  br i1 %cmp441.7, label %do.body419.8, label %if.end444
...
if.end435.8:                                      ; preds = %do.body419.8
  ...
  %241 = load i16, ptr %arrayidx438.8, align 2
  %cmp441.8 = icmp ugt i16 %241, 31
  br i1 %cmp441.8, label %do.body419.9, label %if.end444
...
if.end435.9:                                      ; preds = %do.body419.9
  ...
  %244 = load i16, ptr %arrayidx438.9, align 2
  %cmp441.9 = icmp ugt i16 %244, 31
  br i1 %cmp441.9, label %do.body419.10, label %if.end444
...
if.end435.10:                                     ; preds = %do.body419.10
  ...
  %247 = load i16, ptr %arrayidx438.10, align 2
  %cmp441.10 = icmp ugt i16 %247, 31
  br i1 %cmp441.10, label %do.body419.11, label %if.end444
...
if.end435.11:                                     ; preds = %do.body419.11
  ...
  %250 = load i16, ptr %arrayidx438.11, align 2
  %cmp441.11 = icmp ugt i16 %250, 31
  br i1 %cmp441.11, label %if.then423, label %if.end444
...
while.cond460.preheader:                          ; preds = %if.end444
  ...
  %251 = load i8, ptr %arrayidx448, align 1
  ...
  %252 = load i8, ptr %arrayidx462, align 1
...
if.then469:                                       ; preds = %while.body466
  %253 = load ptr, ptr %read1.i, align 8
  %tobool.not.i1117 = icmp eq ptr %253, null
  %254 = load ptr, ptr %inbuf.i, align 8
  %255 = load i32, ptr %inbuf_size.i, align 8
  br i1 %tobool.not.i1117, label %cond.false.i1145, label %cond.true.i1118

cond.true.i1118:                                  ; preds = %if.then469
  %256 = load ptr, ptr %file.i, align 8
  %call.i1122 = tail call i32 %253(ptr noundef %256, ptr noundef %254, i32 noundef %255) #11
  br label %cond.end.i1123

cond.false.i1145:                                 ; preds = %if.then469
  %257 = load i32, ptr %zip, align 8
  %call5.i1148 = tail call i32 @cli_readn(i32 noundef %257, ptr noundef %254, i32 noundef %255) #11
  br label %cond.end.i1123
...
if.then.i1143:                                    ; preds = %cond.end.i1123
  ...
  store i32 -123, ptr %error.i1144, align 8
  br label %cleanup619
...
if.then7.i1136:                                   ; preds = %if.end.i1126
  %258 = load i32, ptr %input_end.i, align 4
  %tobool8.not.i1138 = icmp eq i32 %258, 0
...
if.then9.i1139:                                   ; preds = %if.then7.i1136
  ...
  store i32 -123, ptr %error10.i1140, align 8
  br label %cleanup619

if.else.i1141:                                    ; preds = %if.then7.i1136
  %259 = load ptr, ptr %inbuf.i, align 8
...
if.end474:                                        ; preds = %if.else.i1141, %if.end.i1126
  ...
  %260 = load ptr, ptr %inbuf.i, align 8
  store ptr %260, ptr %i_ptr1, align 8
  %idxprom.i1132 = zext i32 %read.0.i1129 to i64
  %arrayidx18.i1133 = getelementptr inbounds i8, ptr %260, i64 %idxprom.i1132
  store ptr %arrayidx18.i1133, ptr %i_end2, align 8
  br label %if.end477
...
if.end477:                                        ; preds = %if.end474, %while.body466
  ...
  %261 = load i8, ptr %i_ptr.19, align 1
  ...
  br i1 %cmp464, label %while.body466, label %do.end485
...
do.body536.preheader:                             ; preds = %do.end485
  ...
  %263 = load i16, ptr %arrayidx503.le1974, align 2
  %conv504.le1971 = zext i16 %263 to i32
...
while.body515.preheader:                          ; preds = %while.cond513.preheader
  ...
  %264 = load i16, ptr %arrayidx489.le1982, align 2
  %conv490.le1979 = zext i16 %264 to i32
  ...
  %265 = load i16, ptr %arrayidx503.le, align 2
...
while.body515:                                    ; preds = %while.body515.preheader, %if.end533
  ...
  %266 = load i8, ptr %arrayidx519, align 1
  ...
  store i8 %266, ptr %arrayidx523, align 1
...
if.then527:                                       ; preds = %while.body515
  %267 = load ptr, ptr %flush_window, align 8
...
if.end533:                                        ; preds = %if.then527, %while.body515
  ...
  br i1 %tobool514.not, label %while.cond241.outer.backedge, label %while.body515
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %next.gep1702, align 1
  %272 = getelementptr i8, ptr %next.gep1702, i64 16
  %wide.load1704 = load <16 x i8>, ptr %272, align 1
  store <16 x i8> %wide.load, ptr %next.gep, align 1
  %273 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load1704, ptr %273, align 1
  %index.next = add nuw i64 %index, 32
  %274 = icmp eq i64 %index.next, %n.vec
  br i1 %274, label %middle.block, label %vector.body
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load1723 = load <8 x i8>, ptr %next.gep1722, align 1
  store <8 x i8> %wide.load1723, ptr %next.gep1721, align 1
  %index.next1724 = add nuw i64 %index1720, 8
  %275 = icmp eq i64 %index.next1724, %n.vec1708
  br i1 %275, label %vec.epilog.middle.block, label %vec.epilog.vector.body
...
if.then567:                                       ; preds = %while.end564
  %287 = load ptr, ptr %flush_window, align 8
...
if.end573:                                        ; preds = %if.then567, %while.end564
  ...
  br i1 %cmp579.not, label %while.cond241.outer.backedge, label %do.body536

cleanup591:                                       ; preds = %if.else328
  store i32 %window_posn158.0.ph, ptr %window_posn, align 4
  br label %do.cond599
...
do.body612:                                       ; preds = %do.end601, %if.then604
  store ptr %i_ptr.22, ptr %i_ptr1, align 8
  store ptr %i_end.22, ptr %i_end2, align 8
  store i32 %bit_buffer.12, ptr %bit_buffer3, align 8
  store i32 %bits_left.12, ptr %bits_left4, align 4
  br label %cleanup619
...
if.end3:                                          ; preds = %if.end
  ...
  br i1 %tobool4.not, label %cleanup, label %for.body.peel.next

for.body.peel.next:                               ; preds = %if.end3
  %arrayidx.peel = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 0
  store i8 0, ptr %arrayidx.peel, align 1
  %arrayidx15.peel = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 1
  store i8 0, ptr %arrayidx15.peel, align 1
  %arrayidx = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 2
  store i8 0, ptr %arrayidx, align 1
  %arrayidx15 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 3
  store i8 0, ptr %arrayidx15, align 1
  %arrayidx.1 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 4
  store i8 1, ptr %arrayidx.1, align 1
  %arrayidx15.1 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 5
  store i8 1, ptr %arrayidx15.1, align 1
  %arrayidx.2 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 6
  store i8 2, ptr %arrayidx.2, align 1
  %arrayidx15.2 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 7
  store i8 2, ptr %arrayidx15.2, align 1
  %arrayidx.3 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 8
  store i8 3, ptr %arrayidx.3, align 1
  %arrayidx15.3 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 9
  store i8 3, ptr %arrayidx15.3, align 1
  %arrayidx.4 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 10
  store i8 4, ptr %arrayidx.4, align 1
  %arrayidx15.4 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 11
  store i8 4, ptr %arrayidx15.4, align 1
  %arrayidx.5 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 12
  store i8 5, ptr %arrayidx.5, align 1
  %arrayidx15.5 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 13
  store i8 5, ptr %arrayidx15.5, align 1
  %arrayidx.6 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 14
  store i8 6, ptr %arrayidx.6, align 1
  %arrayidx15.6 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 15
  store i8 6, ptr %arrayidx15.6, align 1
  %arrayidx.7 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 16
  store i8 7, ptr %arrayidx.7, align 1
  %arrayidx15.7 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 17
  store i8 7, ptr %arrayidx15.7, align 1
  %arrayidx.8 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 18
  store i8 8, ptr %arrayidx.8, align 1
  %arrayidx15.8 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 19
  store i8 8, ptr %arrayidx15.8, align 1
  %arrayidx.9 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 20
  store i8 9, ptr %arrayidx.9, align 1
  %arrayidx15.9 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 21
  store i8 9, ptr %arrayidx15.9, align 1
  %arrayidx.10 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 22
  store i8 10, ptr %arrayidx.10, align 1
  %arrayidx15.10 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 23
  store i8 10, ptr %arrayidx15.10, align 1
  %arrayidx.11 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 24
  store i8 11, ptr %arrayidx.11, align 1
  %arrayidx15.11 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 25
  store i8 11, ptr %arrayidx15.11, align 1
  %arrayidx.12 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 26
  store i8 12, ptr %arrayidx.12, align 1
  %arrayidx15.12 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 27
  store i8 12, ptr %arrayidx15.12, align 1
  %arrayidx.13 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 28
  store i8 13, ptr %arrayidx.13, align 1
  %arrayidx15.13 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 29
  store i8 13, ptr %arrayidx15.13, align 1
  %arrayidx.14 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 30
  store i8 14, ptr %arrayidx.14, align 1
  %arrayidx15.14 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 31
  store i8 14, ptr %arrayidx15.14, align 1
  %arrayidx.15 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 32
  store i8 15, ptr %arrayidx.15, align 1
  %arrayidx15.15 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 33
  store i8 15, ptr %arrayidx15.15, align 1
  %arrayidx.16 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 34
  store i8 16, ptr %arrayidx.16, align 1
  %arrayidx15.16 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 35
  store i8 16, ptr %arrayidx15.16, align 1
  %arrayidx.17 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 36
  store i8 17, ptr %arrayidx.17, align 1
  %arrayidx15.17 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 37
  store i8 17, ptr %arrayidx15.17, align 1
  %arrayidx.18 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 38
  store i8 17, ptr %arrayidx.18, align 1
  %arrayidx15.18 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 39
  store i8 17, ptr %arrayidx15.18, align 1
  %arrayidx.19 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 40
  store i8 17, ptr %arrayidx.19, align 1
  %arrayidx15.19 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 41
  store i8 17, ptr %arrayidx15.19, align 1
  %arrayidx.20 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 42
  store i8 17, ptr %arrayidx.20, align 1
  %arrayidx15.20 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 43
  store i8 17, ptr %arrayidx15.20, align 1
  %arrayidx.21 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 44
  store i8 17, ptr %arrayidx.21, align 1
  %arrayidx15.21 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 45
  store i8 17, ptr %arrayidx15.21, align 1
  %arrayidx.22 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 46
  store i8 17, ptr %arrayidx.22, align 1
  %arrayidx15.22 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 47
  store i8 17, ptr %arrayidx15.22, align 1
  %arrayidx.23 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 48
  store i8 17, ptr %arrayidx.23, align 1
  %arrayidx15.23 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 49
  store i8 17, ptr %arrayidx15.23, align 1
  %arrayidx.24 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 50
  store i8 17, ptr %arrayidx.24, align 1
  br label %for.body27

for.body27:                                       ; preds = %for.body27, %for.body.peel.next
  %indvars.iv145 = phi i64 [ 0, %for.body.peel.next ], [ %indvars.iv.next146.2, %for.body27 ]
  %j.2141 = phi i32 [ 0, %for.body.peel.next ], [ %add35.2, %for.body27 ]
  %arrayidx29 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 40, i64 %indvars.iv145
  store i32 %j.2141, ptr %arrayidx29, align 4
  %arrayidx32 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 %indvars.iv145
  ...
  %arrayidx29.1 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 40, i64 %indvars.iv.next146
  store i32 %add35, ptr %arrayidx29.1, align 4
  %arrayidx32.1 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 %indvars.iv.next146
  %2 = load i8, ptr %arrayidx32.1, align 1
  %conv33.1 = zext i8 %2 to i32
  %shl34.1 = shl nuw i32 1, %conv33.1
  %add35.1 = add nsw i32 %shl34.1, %add35
  %indvars.iv.next146.1 = add nuw nsw i64 %indvars.iv145, 2
  %arrayidx29.2 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 40, i64 %indvars.iv.next146.1
  store i32 %add35.1, ptr %arrayidx29.2, align 4
  %arrayidx32.2 = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 41, i64 %indvars.iv.next146.1
  %3 = load i8, ptr %arrayidx32.2, align 1
  %conv33.2 = zext i8 %3 to i32
  %shl34.2 = shl nuw i32 1, %conv33.2
  %add35.2 = add nsw i32 %shl34.2, %add35.1
  %indvars.iv.next146.2 = add nuw nsw i64 %indvars.iv145, 3
  %exitcond.not.2 = icmp eq i64 %indvars.iv.next146.2, 51
  br i1 %exitcond.not.2, label %for.end38, label %for.body27
...
for.end38:                                        ; preds = %for.body27
  ...
  store ptr %call40, ptr %window, align 8
...
if.end44:                                         ; preds = %for.end38
  ...
  store ptr %call46, ptr %inbuf, align 8
...
if.end51:                                         ; preds = %if.end44
  ...
  store i32 %ofd, ptr %ofd53, align 4
  ...
  store i32 %shl, ptr %window_size57, align 8
  ...
  store i32 0, ptr %frame_posn, align 8
  ...
  store ptr %call46, ptr %i_end, align 8
  %i_ptr = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 25
  store ptr %call46, ptr %i_ptr, align 8
  ...
  store ptr %e8_buf, ptr %o_end, align 8
  %o_ptr = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 27
  store ptr %e8_buf, ptr %o_ptr, align 8
...
if.then:                                          ; preds = %entry
  ...
  store i64 %out_bytes, ptr %length, align 8
  br label %if.end
...
if.then18:                                        ; preds = %land.lhs.true
  store i32 -123, ptr %error, align 8
  br label %cleanup
...
do.body:                                          ; preds = %if.end24
  ...
  %7 = load ptr, ptr %window33, align 8
  ...
  %9 = load i64, ptr %offset38, align 8
  ...
  %10 = load i32, ptr %frame, align 4
  %cmp424690 = icmp ult i32 %10, %add41
  br i1 %cmp424690, label %while.body.lr.ph, label %if.then1646

while.body.lr.ph:                                 ; preds = %do.body
  %11 = load i32, ptr %R237, align 4
  %12 = load i32, ptr %R136, align 8
  %13 = load i32, ptr %R035, align 4
  %14 = load i32, ptr %window_posn34, align 4
  %15 = load i32, ptr %bits_left32, align 4
  %16 = load i32, ptr %bit_buffer31, align 8
  %17 = load ptr, ptr %i_end30, align 8
  %18 = load ptr, ptr %i_ptr29, align 8
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end1643
  ...
  %20 = load i32, ptr %reset_interval, align 8
...
if.then50:                                        ; preds = %land.lhs.true45
  %21 = load i32, ptr %block_remaining, align 4
...
if.then52:                                        ; preds = %if.then50
  ...
  store i32 -124, ptr %error, align 8
  br label %cleanup

if.end56.thread:                                  ; preds = %if.then50
  store i32 1, ptr %R035, align 4
  store i32 1, ptr %R136, align 8
  store i32 1, ptr %R237, align 4
  store i8 0, ptr %header_read.i, align 2
  store i32 0, ptr %block_remaining, align 4
  store i8 0, ptr %block_type.i, align 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(656) %scevgep.i, i8 0, i64 656, i1 false)
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(250) %scevgep24.i, i8 0, i64 250, i1 false)
...
if.end56:                                         ; preds = %land.lhs.true45, %while.body
  %.pr = load i8, ptr %header_read.i, align 2
...
if.then67:                                        ; preds = %while.body63
  ...
  %23 = load ptr, ptr %inbuf.i, align 8
  %24 = load i32, ptr %inbuf_size.i, align 8
  br i1 %tobool.not.i, label %cond.false.i, label %cond.true.i
...
if.then7.i:                                       ; preds = %if.end.i
  %27 = load i8, ptr %input_end.i, align 4
...
if.else.i:                                        ; preds = %if.then7.i
  %28 = load ptr, ptr %inbuf.i, align 8
  %arrayidx12.i = getelementptr inbounds i8, ptr %28, i64 1
  store i8 0, ptr %arrayidx12.i, align 1
  %29 = load ptr, ptr %inbuf.i, align 8
  store i8 0, ptr %29, align 1
  store i8 1, ptr %input_end.i, align 4
  br label %if.end72
...
if.then99:                                        ; preds = %while.body95
  ...
  %34 = load ptr, ptr %inbuf.i, align 8
  %35 = load i32, ptr %inbuf_size.i, align 8
...
if.then7.i2551:                                   ; preds = %if.end.i2541
  %38 = load i8, ptr %input_end.i, align 4
...
if.else.i2556:                                    ; preds = %if.then7.i2551
  %39 = load ptr, ptr %inbuf.i, align 8
  %arrayidx12.i2558 = getelementptr inbounds i8, ptr %39, i64 1
  store i8 0, ptr %arrayidx12.i2558, align 1
  %40 = load ptr, ptr %inbuf.i, align 8
...
if.end107:                                        ; preds = %if.end104, %while.body95
  ...
  br i1 %cmp93, label %while.body95, label %while.end121
...
if.then135:                                       ; preds = %while.body131
  %44 = load ptr, ptr %read.i, align 8
  %tobool.not.i2567 = icmp eq ptr %44, null
  %45 = load ptr, ptr %inbuf.i, align 8
  %46 = load i32, ptr %inbuf_size.i, align 8
...
if.then7.i2586:                                   ; preds = %if.end.i2576
  %49 = load i8, ptr %input_end.i, align 4
...
if.else.i2591:                                    ; preds = %if.then7.i2586
  %50 = load ptr, ptr %inbuf.i, align 8
  %arrayidx12.i2593 = getelementptr inbounds i8, ptr %50, i64 1
  store i8 0, ptr %arrayidx12.i2593, align 1
  %51 = load ptr, ptr %inbuf.i, align 8
...
if.end143:                                        ; preds = %if.end140, %while.body131
  ...
  br i1 %cmp129, label %while.body131, label %while.end157
...
if.end163:                                        ; preds = %while.end157, %while.end
  ...
  store i32 %or165, ptr %intel_filesize, align 8
  store i8 1, ptr %header_read.i, align 2
  br label %if.end167
...
land.lhs.true169:                                 ; preds = %if.end167
  %57 = load i64, ptr %offset38, align 8
...
if.end181:                                        ; preds = %land.lhs.true169, %if.end167
  ...
  %58 = load i32, ptr %frame_posn, align 8
...
if.then203:                                       ; preds = %if.then200
  %62 = load i32, ptr %error, align 8
  br label %cleanup

if.end205:                                        ; preds = %if.then200
  %63 = load ptr, ptr %i_ptr29, align 8
  %64 = load ptr, ptr %i_end30, align 8
  br label %if.end208
...
if.then7.i2621:                                   ; preds = %if.end.i2611
  %70 = load i8, ptr %input_end.i, align 4
...
if.else.i2626:                                    ; preds = %if.then7.i2621
  %71 = load ptr, ptr %inbuf.i, align 8
  %arrayidx12.i2628 = getelementptr inbounds i8, ptr %71, i64 1
  store i8 0, ptr %arrayidx12.i2628, align 1
  %72 = load ptr, ptr %inbuf.i, align 8
  store i8 0, ptr %72, align 1
  store i8 1, ptr %input_end.i, align 4
  br label %if.end223
...
if.end226:                                        ; preds = %if.end223, %while.body214
  ...
  br i1 %cmp212, label %while.body214, label %while.end240
...
while.end240:                                     ; preds = %if.end226, %do.body210
  ...
  store i8 %conv242, ptr %block_type.i, align 1
...
if.then7.i2656:                                   ; preds = %if.end.i2646
  %81 = load i8, ptr %input_end.i, align 4
...
if.else.i2661:                                    ; preds = %if.then7.i2656
  ...
  store i8 0, ptr %arrayidx12.i2663, align 1
  %83 = load ptr, ptr %inbuf.i, align 8
...
if.end264:                                        ; preds = %if.end261, %while.body252
  ...
  br i1 %cmp250, label %while.body252, label %while.end278
...
if.then7.i2691:                                   ; preds = %if.end.i2681
  %92 = load i8, ptr %input_end.i, align 4
...
if.else.i2696:                                    ; preds = %if.then7.i2691
  %93 = load ptr, ptr %inbuf.i, align 8
  %arrayidx12.i2698 = getelementptr inbounds i8, ptr %93, i64 1
  store i8 0, ptr %arrayidx12.i2698, align 1
  %94 = load ptr, ptr %inbuf.i, align 8
...
if.end300:                                        ; preds = %if.end297, %while.body288
  ...
  br i1 %cmp286, label %while.body288, label %while.end314
...
while.end314:                                     ; preds = %if.end300, %while.end278
  ...
  store i32 %or321, ptr %block_length, align 8
  store i32 %or321, ptr %block_remaining, align 4
  %99 = load i8, ptr %block_type.i, align 1
...
if.then7.i2726:                                   ; preds = %if.end.i2716
  %105 = load i8, ptr %input_end.i, align 4
...
if.else.i2731:                                    ; preds = %if.then7.i2726
  %106 = load ptr, ptr %inbuf.i, align 8
  %arrayidx12.i2733 = getelementptr inbounds i8, ptr %106, i64 1
  store i8 0, ptr %arrayidx12.i2733, align 1
  %107 = load ptr, ptr %inbuf.i, align 8
...
if.end344:                                        ; preds = %if.end341, %while.body332
  ...
  br i1 %cmp330, label %while.body332, label %while.end358
...
while.end358:                                     ; preds = %if.end344, %while.cond329.preheader
  ...
  store i8 %conv364, ptr %arrayidx365, align 1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 8
  br i1 %exitcond.not, label %for.end, label %while.cond329.preheader
...
do.body376:                                       ; preds = %for.end, %while.end314
  ...
  store ptr %i_ptr.21, ptr %i_ptr29, align 8
  store ptr %i_end.21, ptr %i_end30, align 8
  store i32 %bit_buffer.12, ptr %bit_buffer31, align 8
  store i32 %bits_left.12, ptr %bits_left32, align 4
...
do.body389:                                       ; preds = %do.body376
  %112 = load i8, ptr %posn_slots, align 1
...
if.then413:                                       ; preds = %do.body389
  %113 = load i32, ptr %error, align 8
  br label %cleanup

do.body416:                                       ; preds = %do.body389
  %114 = load <2 x ptr>, ptr %i_ptr29, align 8
  %115 = load <2 x i32>, ptr %bit_buffer31, align 8
  %call428 = tail call fastcc i32 @lzx_make_decode_table(i32 noundef 656, i32 noundef 12, ptr noundef nonnull %scevgep.i, ptr noundef nonnull %MAINTREE_table)
...
if.end432:                                        ; preds = %do.body416
  %116 = load i8, ptr %arrayidx434, align 8
  %cmp436.not = icmp eq i8 %116, 0
  br i1 %cmp436.not, label %do.body441, label %if.then438

if.then438:                                       ; preds = %if.end432
  store i8 1, ptr %intel_started472, align 8
  br label %do.body441

do.body441:                                       ; preds = %if.then438, %if.end432
  store <2 x ptr> %114, ptr %i_ptr29, align 8
  store <2 x i32> %115, ptr %bit_buffer31, align 8
...
if.then451:                                       ; preds = %do.body441
  %117 = load i32, ptr %error, align 8
  br label %cleanup

do.body454:                                       ; preds = %do.body441
  %118 = load ptr, ptr %i_ptr29, align 8
  %119 = load ptr, ptr %i_end30, align 8
  %120 = load i32, ptr %bit_buffer31, align 8
  %121 = load i32, ptr %bits_left32, align 4
  %call466 = tail call fastcc i32 @lzx_make_decode_table(i32 noundef 250, i32 noundef 12, ptr noundef nonnull %scevgep24.i, ptr noundef nonnull %LENGTH_table)
...
if.then7.i2761:                                   ; preds = %if.end.i2751
  %127 = load i8, ptr %input_end.i, align 4
...
if.else.i2766:                                    ; preds = %if.then7.i2761
  %128 = load ptr, ptr %inbuf.i, align 8
  %arrayidx12.i2768 = getelementptr inbounds i8, ptr %128, i64 1
  store i8 0, ptr %arrayidx12.i2768, align 1
  %129 = load ptr, ptr %inbuf.i, align 8
...
if.end485:                                        ; preds = %if.else.i2766, %if.end.i2751
  ...
  %130 = load ptr, ptr %inbuf.i, align 8
  store ptr %130, ptr %i_ptr29, align 8
  %idxprom.i2757 = zext i32 %bread.0.i2754 to i64
  %arrayidx21.i2758 = getelementptr inbounds i8, ptr %130, i64 %idxprom.i2757
  store ptr %arrayidx21.i2758, ptr %i_end30, align 8
  br label %if.end488
...
if.end488:                                        ; preds = %if.end485, %while.body476
  ...
  br i1 %cmp474, label %while.body476, label %while.end502
...
if.then518:                                       ; preds = %if.then515.11, %if.then515.10, %if.then515.9, %if.then515.8, %if.then515.7, %if.then515.6, %if.then515.5, %if.then515.4, %if.then515.3, %if.then515.2, %if.then515.1, %if.then515
  %131 = load i32, ptr %error, align 8
  br label %cleanup

if.end520:                                        ; preds = %if.then515
  %132 = load ptr, ptr %i_ptr29, align 8
  %133 = load ptr, ptr %i_end30, align 8
  br label %if.end523
...
if.end523:                                        ; preds = %if.end520, %while.end502
  ...
  %134 = load i8, ptr %i_ptr.26, align 1
...
if.end520.1:                                      ; preds = %if.then515.1
  %135 = load ptr, ptr %i_ptr29, align 8
  %136 = load ptr, ptr %i_end30, align 8
...
if.end523.1:                                      ; preds = %if.end520.1, %if.end523
  ...
  %137 = load i8, ptr %i_ptr.26.1, align 1
...
if.end520.2:                                      ; preds = %if.then515.2
  %138 = load ptr, ptr %i_ptr29, align 8
  %139 = load ptr, ptr %i_end30, align 8
...
if.end523.2:                                      ; preds = %if.end520.2, %if.end523.1
  ...
  %140 = load i8, ptr %i_ptr.26.2, align 1
...
if.end520.3:                                      ; preds = %if.then515.3
  %141 = load ptr, ptr %i_ptr29, align 8
  %142 = load ptr, ptr %i_end30, align 8
...
if.end523.3:                                      ; preds = %if.end520.3, %if.end523.2
  ...
  %143 = load i8, ptr %i_ptr.26.3, align 1
...
if.end520.4:                                      ; preds = %if.then515.4
  %144 = load ptr, ptr %i_ptr29, align 8
  %145 = load ptr, ptr %i_end30, align 8
...
if.end523.4:                                      ; preds = %if.end520.4, %if.end523.3
  ...
  %146 = load i8, ptr %i_ptr.26.4, align 1
...
if.end520.5:                                      ; preds = %if.then515.5
  %147 = load ptr, ptr %i_ptr29, align 8
  %148 = load ptr, ptr %i_end30, align 8
...
if.end523.5:                                      ; preds = %if.end520.5, %if.end523.4
  ...
  %149 = load i8, ptr %i_ptr.26.5, align 1
...
if.end520.6:                                      ; preds = %if.then515.6
  %150 = load ptr, ptr %i_ptr29, align 8
  %151 = load ptr, ptr %i_end30, align 8
...
if.end523.6:                                      ; preds = %if.end520.6, %if.end523.5
  ...
  %152 = load i8, ptr %i_ptr.26.6, align 1
...
if.end520.7:                                      ; preds = %if.then515.7
  %153 = load ptr, ptr %i_ptr29, align 8
  %154 = load ptr, ptr %i_end30, align 8
...
if.end523.7:                                      ; preds = %if.end520.7, %if.end523.6
  ...
  %155 = load i8, ptr %i_ptr.26.7, align 1
...
if.end520.8:                                      ; preds = %if.then515.8
  %156 = load ptr, ptr %i_ptr29, align 8
  %157 = load ptr, ptr %i_end30, align 8
...
if.end523.8:                                      ; preds = %if.end520.8, %if.end523.7
  ...
  %158 = load i8, ptr %i_ptr.26.8, align 1
...
if.end520.9:                                      ; preds = %if.then515.9
  %159 = load ptr, ptr %i_ptr29, align 8
  %160 = load ptr, ptr %i_end30, align 8
...
if.end523.9:                                      ; preds = %if.end520.9, %if.end523.8
  ...
  %161 = load i8, ptr %i_ptr.26.9, align 1
...
if.end520.10:                                     ; preds = %if.then515.10
  %162 = load ptr, ptr %i_ptr29, align 8
  %163 = load ptr, ptr %i_end30, align 8
...
if.end523.10:                                     ; preds = %if.end520.10, %if.end523.9
  ...
  %164 = load i8, ptr %i_ptr.26.10, align 1
...
if.end520.11:                                     ; preds = %if.then515.11
  %165 = load ptr, ptr %i_ptr29, align 8
  %166 = load ptr, ptr %i_end30, align 8
...
if.end523.11:                                     ; preds = %if.end520.11, %if.end523.10
  ...
  %167 = load i8, ptr %i_ptr.26.11, align 1
...
if.end574:                                        ; preds = %if.end523.11, %do.body454, %while.body187
  ...
  %168 = load i32, ptr %block_remaining, align 4
  ...
  store i32 %sub582, ptr %block_remaining, align 4
  %169 = load i8, ptr %block_type.i, align 1
...
if.then7.i2796:                                   ; preds = %if.end.i2786
  %175 = load i8, ptr %input_end.i, align 4
...
if.else.i2801:                                    ; preds = %if.then7.i2796
  %176 = load ptr, ptr %inbuf.i, align 8
  %arrayidx12.i2803 = getelementptr inbounds i8, ptr %176, i64 1
  store i8 0, ptr %arrayidx12.i2803, align 1
  %177 = load ptr, ptr %inbuf.i, align 8
...
if.end603:                                        ; preds = %if.else.i2801, %if.end.i2786
  ...
  %178 = load ptr, ptr %inbuf.i, align 8
  store ptr %178, ptr %i_ptr29, align 8
  %idxprom.i2792 = zext i32 %bread.0.i2789 to i64
  %arrayidx21.i2793 = getelementptr inbounds i8, ptr %178, i64 %idxprom.i2792
  store ptr %arrayidx21.i2793, ptr %i_end30, align 8
  br label %if.end606
...
if.end606:                                        ; preds = %if.end603, %while.body594
  ...
  br i1 %cmp592, label %while.body594, label %while.end620
...
while.end620:                                     ; preds = %if.end606, %while.cond591.preheader
  ...
  %181 = load i16, ptr %arrayidx624, align 2
...
if.end649:                                        ; preds = %do.body629.preheader
  ...
  %185 = load i16, ptr %arrayidx652, align 2
  %cmp655 = icmp ugt i16 %185, 655
  br i1 %cmp655, label %do.body629.1, label %if.end658
...
if.end649.1:                                      ; preds = %do.body629.1
  ...
  %189 = load i16, ptr %arrayidx652.1, align 2
  %cmp655.1 = icmp ugt i16 %189, 655
  br i1 %cmp655.1, label %do.body629.2, label %if.end658
...
if.end649.2:                                      ; preds = %do.body629.2
  ...
  %193 = load i16, ptr %arrayidx652.2, align 2
  %cmp655.2 = icmp ugt i16 %193, 655
  br i1 %cmp655.2, label %do.body629.3, label %if.end658
...
if.end649.3:                                      ; preds = %do.body629.3
  ...
  %197 = load i16, ptr %arrayidx652.3, align 2
  %cmp655.3 = icmp ugt i16 %197, 655
  br i1 %cmp655.3, label %do.body629.4, label %if.end658
...
if.end649.4:                                      ; preds = %do.body629.4
  ...
  %200 = load i16, ptr %arrayidx652.4, align 2
  %cmp655.4 = icmp ugt i16 %200, 655
  br i1 %cmp655.4, label %do.body629.5, label %if.end658
...
if.end649.5:                                      ; preds = %do.body629.5
  ...
  %205 = load i16, ptr %arrayidx652.5, align 2
  %cmp655.5 = icmp ugt i16 %205, 655
  br i1 %cmp655.5, label %do.body629.6, label %if.end658
...
if.end649.6:                                      ; preds = %do.body629.6
  ...
  %210 = load i16, ptr %arrayidx652.6, align 2
  %cmp655.6 = icmp ugt i16 %210, 655
  br i1 %cmp655.6, label %do.body629.7, label %if.end658
...
if.end649.7:                                      ; preds = %do.body629.7
  ...
  %215 = load i16, ptr %arrayidx652.7, align 2
  %cmp655.7 = icmp ugt i16 %215, 655
  br i1 %cmp655.7, label %do.body629.8, label %if.end658
...
if.end649.8:                                      ; preds = %do.body629.8
  ...
  %220 = load i16, ptr %arrayidx652.8, align 2
  %cmp655.8 = icmp ugt i16 %220, 655
  br i1 %cmp655.8, label %do.body629.9, label %if.end658
...
if.end649.9:                                      ; preds = %do.body629.9
  ...
  %225 = load i16, ptr %arrayidx652.9, align 2
  %cmp655.9 = icmp ugt i16 %225, 655
  br i1 %cmp655.9, label %do.body629.10, label %if.end658
...
if.end649.10:                                     ; preds = %do.body629.10
  ...
  %230 = load i16, ptr %arrayidx652.10, align 2
  %cmp655.10 = icmp ugt i16 %230, 655
  br i1 %cmp655.10, label %do.body629.11, label %if.end658
...
if.end649.11:                                     ; preds = %do.body629.11
  ...
  %235 = load i16, ptr %arrayidx652.11, align 2
  %cmp655.11 = icmp ugt i16 %235, 655
  br i1 %cmp655.11, label %do.body629.12, label %if.end658
...
if.end649.12:                                     ; preds = %do.body629.12
  ...
  %240 = load i16, ptr %arrayidx652.12, align 2
  %cmp655.12 = icmp ugt i16 %240, 655
  br i1 %cmp655.12, label %do.body629.13, label %if.end658
...
if.end649.13:                                     ; preds = %do.body629.13
  ...
  %245 = load i16, ptr %arrayidx652.13, align 2
  %cmp655.13 = icmp ugt i16 %245, 655
  br i1 %cmp655.13, label %do.body629.14, label %if.end658
...
if.end649.14:                                     ; preds = %do.body629.14
  ...
  %250 = load i16, ptr %arrayidx652.14, align 2
  %cmp655.14 = icmp ugt i16 %250, 655
  br i1 %cmp655.14, label %do.body629.15, label %if.end658
...
if.end649.15:                                     ; preds = %do.body629.15
  ...
  %255 = load i16, ptr %arrayidx652.15, align 2
  %cmp655.15 = icmp ugt i16 %255, 655
  br i1 %cmp655.15, label %do.body629.16, label %if.end658
...
if.end649.16:                                     ; preds = %do.body629.16
  ...
  %260 = load i16, ptr %arrayidx652.16, align 2
  %cmp655.16 = icmp ugt i16 %260, 655
  br i1 %cmp655.16, label %do.body629.17, label %if.end658
...
if.end649.17:                                     ; preds = %do.body629.17
  ...
  %265 = load i16, ptr %arrayidx652.17, align 2
  %cmp655.17 = icmp ugt i16 %265, 655
  br i1 %cmp655.17, label %do.body629.18, label %if.end658
...
if.end649.18:                                     ; preds = %do.body629.18
  ...
  %270 = load i16, ptr %arrayidx652.18, align 2
  %cmp655.18 = icmp ugt i16 %270, 655
  br i1 %cmp655.18, label %do.body629.19, label %if.end658
...
if.end649.19:                                     ; preds = %do.body629.19
  ...
  %274 = load i16, ptr %arrayidx652.19, align 2
  %cmp655.19 = icmp ugt i16 %274, 655
  br i1 %cmp655.19, label %if.then633, label %if.end658
...
if.end658:                                        ; preds = %if.end649, %if.end649.1, %if.end649.2, %if.end649.3, %if.end649.4, %if.end649.5, %if.end649.6, %if.end649.7, %if.end649.8, %if.end649.9, %if.end649.10, %if.end649.11, %if.end649.12, %if.end649.13, %if.end649.14, %if.end649.15, %if.end649.16, %if.end649.17, %if.end649.18, %if.end649.19, %while.end620
  ...
  %275 = load i8, ptr %arrayidx662, align 1
...
if.then670:                                       ; preds = %if.end658
  ...
  store i8 %conv671, ptr %arrayidx674, align 1
...
if.then7.i2831:                                   ; preds = %if.end.i2821
  %281 = load i8, ptr %input_end.i, align 4
...
if.else.i2836:                                    ; preds = %if.then7.i2831
  %282 = load ptr, ptr %inbuf.i, align 8
  %arrayidx12.i2838 = getelementptr inbounds i8, ptr %282, i64 1
  store i8 0, ptr %arrayidx12.i2838, align 1
  %283 = load ptr, ptr %inbuf.i, align 8
...
if.end693:                                        ; preds = %if.else.i2836, %if.end.i2821
  ...
  %284 = load ptr, ptr %inbuf.i, align 8
  store ptr %284, ptr %i_ptr29, align 8
  %idxprom.i2827 = zext i32 %bread.0.i2824 to i64
  %arrayidx21.i2828 = getelementptr inbounds i8, ptr %284, i64 %idxprom.i2827
  store ptr %arrayidx21.i2828, ptr %i_end30, align 8
  br label %if.end696
...
if.end696:                                        ; preds = %if.end693, %while.body684
  ...
  br i1 %cmp682, label %while.body684, label %while.end710
...
while.end710:                                     ; preds = %if.end696, %while.cond681.preheader
  ...
  %287 = load i16, ptr %arrayidx714, align 2
...
if.end740:                                        ; preds = %do.body719.preheader
  ...
  %291 = load i16, ptr %arrayidx743, align 2
  %cmp746 = icmp ugt i16 %291, 249
  br i1 %cmp746, label %do.body719.1, label %if.end749
...
if.end740.1:                                      ; preds = %do.body719.1
  ...
  %295 = load i16, ptr %arrayidx743.1, align 2
  %cmp746.1 = icmp ugt i16 %295, 249
  br i1 %cmp746.1, label %do.body719.2, label %if.end749
...
if.end740.2:                                      ; preds = %do.body719.2
  ...
  %299 = load i16, ptr %arrayidx743.2, align 2
  %cmp746.2 = icmp ugt i16 %299, 249
  br i1 %cmp746.2, label %do.body719.3, label %if.end749
...
if.end740.3:                                      ; preds = %do.body719.3
  ...
  %303 = load i16, ptr %arrayidx743.3, align 2
  %cmp746.3 = icmp ugt i16 %303, 249
  br i1 %cmp746.3, label %do.body719.4, label %if.end749
...
if.end740.4:                                      ; preds = %do.body719.4
  ...
  %306 = load i16, ptr %arrayidx743.4, align 2
  %cmp746.4 = icmp ugt i16 %306, 249
  br i1 %cmp746.4, label %do.body719.5, label %if.end749
...
if.end740.5:                                      ; preds = %do.body719.5
  ...
  %311 = load i16, ptr %arrayidx743.5, align 2
  %cmp746.5 = icmp ugt i16 %311, 249
  br i1 %cmp746.5, label %do.body719.6, label %if.end749
...
if.end740.6:                                      ; preds = %do.body719.6
  ...
  %316 = load i16, ptr %arrayidx743.6, align 2
  %cmp746.6 = icmp ugt i16 %316, 249
  br i1 %cmp746.6, label %do.body719.7, label %if.end749
...
if.end740.7:                                      ; preds = %do.body719.7
  ...
  %321 = load i16, ptr %arrayidx743.7, align 2
  %cmp746.7 = icmp ugt i16 %321, 249
  br i1 %cmp746.7, label %do.body719.8, label %if.end749
...
if.end740.8:                                      ; preds = %do.body719.8
  ...
  %326 = load i16, ptr %arrayidx743.8, align 2
  %cmp746.8 = icmp ugt i16 %326, 249
  br i1 %cmp746.8, label %do.body719.9, label %if.end749
...
if.end740.9:                                      ; preds = %do.body719.9
  ...
  %331 = load i16, ptr %arrayidx743.9, align 2
  %cmp746.9 = icmp ugt i16 %331, 249
  br i1 %cmp746.9, label %do.body719.10, label %if.end749
...
if.end740.10:                                     ; preds = %do.body719.10
  ...
  %336 = load i16, ptr %arrayidx743.10, align 2
  %cmp746.10 = icmp ugt i16 %336, 249
  br i1 %cmp746.10, label %do.body719.11, label %if.end749
...
if.end740.11:                                     ; preds = %do.body719.11
  ...
  %341 = load i16, ptr %arrayidx743.11, align 2
  %cmp746.11 = icmp ugt i16 %341, 249
  br i1 %cmp746.11, label %do.body719.12, label %if.end749
...
if.end740.12:                                     ; preds = %do.body719.12
  ...
  %346 = load i16, ptr %arrayidx743.12, align 2
  %cmp746.12 = icmp ugt i16 %346, 249
  br i1 %cmp746.12, label %do.body719.13, label %if.end749
...
if.end740.13:                                     ; preds = %do.body719.13
  ...
  %351 = load i16, ptr %arrayidx743.13, align 2
  %cmp746.13 = icmp ugt i16 %351, 249
  br i1 %cmp746.13, label %do.body719.14, label %if.end749
...
if.end740.14:                                     ; preds = %do.body719.14
  ...
  %356 = load i16, ptr %arrayidx743.14, align 2
  %cmp746.14 = icmp ugt i16 %356, 249
  br i1 %cmp746.14, label %do.body719.15, label %if.end749
...
if.end740.15:                                     ; preds = %do.body719.15
  ...
  %361 = load i16, ptr %arrayidx743.15, align 2
  %cmp746.15 = icmp ugt i16 %361, 249
  br i1 %cmp746.15, label %do.body719.16, label %if.end749
...
if.end740.16:                                     ; preds = %do.body719.16
  ...
  %366 = load i16, ptr %arrayidx743.16, align 2
  %cmp746.16 = icmp ugt i16 %366, 249
  br i1 %cmp746.16, label %do.body719.17, label %if.end749
...
if.end740.17:                                     ; preds = %do.body719.17
  ...
  %371 = load i16, ptr %arrayidx743.17, align 2
  %cmp746.17 = icmp ugt i16 %371, 249
  br i1 %cmp746.17, label %do.body719.18, label %if.end749
...
if.end740.18:                                     ; preds = %do.body719.18
  ...
  %376 = load i16, ptr %arrayidx743.18, align 2
  %cmp746.18 = icmp ugt i16 %376, 249
  br i1 %cmp746.18, label %do.body719.19, label %if.end749
...
if.end740.19:                                     ; preds = %do.body719.19
  ...
  %380 = load i16, ptr %arrayidx743.19, align 2
  %cmp746.19 = icmp ugt i16 %380, 249
  br i1 %cmp746.19, label %if.then723, label %if.end749
...
if.end749:                                        ; preds = %if.end740, %if.end740.1, %if.end740.2, %if.end740.3, %if.end740.4, %if.end740.5, %if.end740.6, %if.end740.7, %if.end740.8, %if.end740.9, %if.end740.10, %if.end740.11, %if.end740.12, %if.end740.13, %if.end740.14, %if.end740.15, %if.end740.16, %if.end740.17, %if.end740.18, %if.end740.19, %while.end710
  ...
  %381 = load i8, ptr %arrayidx753, align 1
...
sw.default767:                                    ; preds = %if.end760
  ...
  %382 = load i8, ptr %arrayidx769, align 1
...
if.then782:                                       ; preds = %if.then779
  %383 = load i32, ptr %error, align 8
  br label %cleanup

if.end784:                                        ; preds = %if.then779
  %384 = load ptr, ptr %i_ptr29, align 8
  %385 = load ptr, ptr %i_end30, align 8
  br label %if.end787
...
if.end787:                                        ; preds = %if.end784, %while.body775
  ...
  br i1 %cmp773, label %while.body775, label %while.end801
...
while.end801:                                     ; preds = %if.end787, %sw.default767
  ...
  %388 = load i32, ptr %arrayidx811, align 4
...
sw.epilog814:                                     ; preds = %if.end760, %while.end801, %sw.bb766, %sw.bb765, %sw.bb764
  ...
  %389 = load i32, ptr %window_size1326, align 8
...
vector.ph5109:                                    ; preds = %vector.memcheck5105
  %n.vec5111 = and i64 %393, 8589934560
...
vector.body5120:                                  ; preds = %vector.body5120, %vector.ph5109
  ...
  %wide.load5126 = load <16 x i8>, ptr %next.gep5124, align 1
  %397 = getelementptr i8, ptr %next.gep5124, i64 16
  %wide.load5127 = load <16 x i8>, ptr %397, align 1
  store <16 x i8> %wide.load5126, ptr %next.gep5122, align 1
  %398 = getelementptr i8, ptr %next.gep5122, i64 16
  store <16 x i8> %wide.load5127, ptr %398, align 1
  %index.next5128 = add nuw i64 %index5121, 32
  %399 = icmp eq i64 %index.next5128, %n.vec5111
  br i1 %399, label %middle.block5107, label %vector.body5120
...
while.body845:                                    ; preds = %while.body845.preheader5321, %while.body845
  ...
  %400 = load i8, ptr %runsrc.04643, align 1
  %incdec.ptr847 = getelementptr inbounds i8, ptr %rundest.14644, i64 1
  store i8 %400, ptr %rundest.14644, align 1
  %cmp843 = icmp ugt i32 %j.14642, 1
  br i1 %cmp843, label %while.body845, label %if.end849
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %next.gep5082, align 1
  %403 = getelementptr i8, ptr %next.gep5082, i64 16
  %wide.load5084 = load <16 x i8>, ptr %403, align 1
  store <16 x i8> %wide.load, ptr %next.gep, align 1
  %404 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load5084, ptr %404, align 1
  %index.next = add nuw i64 %index, 32
  %405 = icmp eq i64 %index.next, %n.vec
  br i1 %405, label %middle.block, label %vector.body
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load5103 = load <8 x i8>, ptr %next.gep5102, align 1
  store <8 x i8> %wide.load5103, ptr %next.gep5101, align 1
  %index.next5104 = add nuw i64 %index5100, 8
  %406 = icmp eq i64 %index.next5104, %n.vec5088
  br i1 %406, label %vec.epilog.middle.block, label %vec.epilog.vector.body
...
while.body854:                                    ; preds = %while.body854.preheader, %while.body854
  ...
  %407 = load i8, ptr %runsrc.24647, align 1
  %incdec.ptr856 = getelementptr inbounds i8, ptr %rundest.34648, i64 1
  store i8 %407, ptr %rundest.34648, align 1
  %cmp852 = icmp ugt i32 %i.74649, 1
  br i1 %cmp852, label %while.body854, label %if.end869
...
vector.ph5138:                                    ; preds = %vector.main.loop.iter.check5137
  ...
  %wide.load5148 = load <16 x i8>, ptr %add.ptr860, align 1
  %409 = getelementptr i8, ptr %add.ptr860, i64 16
  %wide.load5149 = load <16 x i8>, ptr %409, align 1
  store <16 x i8> %wide.load5148, ptr %arrayidx822, align 1
  %410 = getelementptr i8, ptr %arrayidx822, i64 16
  store <16 x i8> %wide.load5149, ptr %410, align 1
  %411 = icmp eq i64 %n.vec5140, 32
  br i1 %411, label %middle.block5131, label %vector.body5142.1
...
vector.body5142.1:                                ; preds = %vector.ph5138
  ...
  %wide.load5148.1 = load <16 x i8>, ptr %next.gep5146.1, align 1
  %412 = getelementptr i8, ptr %add.ptr860, i64 48
  %wide.load5149.1 = load <16 x i8>, ptr %412, align 1
  store <16 x i8> %wide.load5148.1, ptr %next.gep5144.1, align 1
  %413 = getelementptr i8, ptr %arrayidx822, i64 48
  store <16 x i8> %wide.load5149.1, ptr %413, align 1
  %414 = icmp eq i64 %n.vec5140, 64
  br i1 %414, label %middle.block5131, label %vector.body5142.2
...
vector.body5142.2:                                ; preds = %vector.body5142.1
  ...
  %wide.load5148.2 = load <16 x i8>, ptr %next.gep5146.2, align 1
  %415 = getelementptr i8, ptr %add.ptr860, i64 80
  %wide.load5149.2 = load <16 x i8>, ptr %415, align 1
  store <16 x i8> %wide.load5148.2, ptr %next.gep5144.2, align 1
  %416 = getelementptr i8, ptr %arrayidx822, i64 80
  store <16 x i8> %wide.load5149.2, ptr %416, align 1
  %417 = icmp eq i64 %n.vec5140, 96
  br i1 %417, label %middle.block5131, label %vector.body5142.3
...
vector.body5142.3:                                ; preds = %vector.body5142.2
  ...
  %wide.load5148.3 = load <16 x i8>, ptr %next.gep5146.3, align 1
  %418 = getelementptr i8, ptr %add.ptr860, i64 112
  %wide.load5149.3 = load <16 x i8>, ptr %418, align 1
  store <16 x i8> %wide.load5148.3, ptr %next.gep5144.3, align 1
  %419 = getelementptr i8, ptr %arrayidx822, i64 112
  store <16 x i8> %wide.load5149.3, ptr %419, align 1
  %420 = icmp eq i64 %n.vec5140, 128
  br i1 %420, label %middle.block5131, label %vector.body5142.4
...
vector.body5142.4:                                ; preds = %vector.body5142.3
  ...
  %wide.load5148.4 = load <16 x i8>, ptr %next.gep5146.4, align 1
  %421 = getelementptr i8, ptr %add.ptr860, i64 144
  %wide.load5149.4 = load <16 x i8>, ptr %421, align 1
  store <16 x i8> %wide.load5148.4, ptr %next.gep5144.4, align 1
  %422 = getelementptr i8, ptr %arrayidx822, i64 144
  store <16 x i8> %wide.load5149.4, ptr %422, align 1
  %423 = icmp eq i64 %n.vec5140, 160
  br i1 %423, label %middle.block5131, label %vector.body5142.5
...
vector.body5142.5:                                ; preds = %vector.body5142.4
  ...
  %wide.load5148.5 = load <16 x i8>, ptr %next.gep5146.5, align 1
  %424 = getelementptr i8, ptr %add.ptr860, i64 176
  %wide.load5149.5 = load <16 x i8>, ptr %424, align 1
  store <16 x i8> %wide.load5148.5, ptr %next.gep5144.5, align 1
  %425 = getelementptr i8, ptr %arrayidx822, i64 176
  store <16 x i8> %wide.load5149.5, ptr %425, align 1
  %426 = icmp eq i64 %n.vec5140, 192
  br i1 %426, label %middle.block5131, label %vector.body5142.6
...
vector.body5142.6:                                ; preds = %vector.body5142.5
  ...
  %wide.load5148.6 = load <16 x i8>, ptr %next.gep5146.6, align 1
  %427 = getelementptr i8, ptr %add.ptr860, i64 208
  %wide.load5149.6 = load <16 x i8>, ptr %427, align 1
  store <16 x i8> %wide.load5148.6, ptr %next.gep5144.6, align 1
  %428 = getelementptr i8, ptr %arrayidx822, i64 208
  store <16 x i8> %wide.load5149.6, ptr %428, align 1
  %429 = icmp eq i64 %n.vec5140, 224
  br i1 %429, label %middle.block5131, label %vector.body5142.7
...
vector.body5142.7:                                ; preds = %vector.body5142.6
  ...
  %wide.load5148.7 = load <16 x i8>, ptr %next.gep5146.7, align 1
  %430 = getelementptr i8, ptr %add.ptr860, i64 240
  %wide.load5149.7 = load <16 x i8>, ptr %430, align 1
  store <16 x i8> %wide.load5148.7, ptr %next.gep5144.7, align 1
  %431 = getelementptr i8, ptr %arrayidx822, i64 240
  store <16 x i8> %wide.load5149.7, ptr %431, align 1
...
vec.epilog.vector.body5176:                       ; preds = %vec.epilog.vector.body5176, %vec.epilog.ph5158
  ...
  %wide.load5180 = load <8 x i8>, ptr %next.gep5179, align 1
  store <8 x i8> %wide.load5180, ptr %next.gep5178, align 1
  %index.next5181 = add nuw i64 %index5177, 8
  %432 = icmp eq i64 %index.next5181, %n.vec5163
  br i1 %432, label %vec.epilog.middle.block5155, label %vec.epilog.vector.body5176
...
while.body865:                                    ; preds = %while.body865.preheader, %while.body865
  ...
  %433 = load i8, ptr %runsrc.34638, align 1
  %incdec.ptr867 = getelementptr inbounds i8, ptr %rundest.44639, i64 1
  store i8 %433, ptr %rundest.44639, align 1
  %cmp863 = icmp sgt i32 %i.84640, 1
  br i1 %cmp863, label %while.body865, label %if.end869
...
if.end872:                                        ; preds = %if.end869, %if.then670
  ...
  br i1 %cmp587, label %while.cond591.preheader, label %sw.epilog1422
...
if.then7.i2866:                                   ; preds = %if.end.i2856
  %439 = load i8, ptr %input_end.i, align 4
...
if.else.i2871:                                    ; preds = %if.then7.i2866
  %440 = load ptr, ptr %inbuf.i, align 8
  %arrayidx12.i2873 = getelementptr inbounds i8, ptr %440, i64 1
  store i8 0, ptr %arrayidx12.i2873, align 1
  %441 = load ptr, ptr %inbuf.i, align 8
...
if.end892:                                        ; preds = %if.else.i2871, %if.end.i2856
  ...
  %442 = load ptr, ptr %inbuf.i, align 8
  store ptr %442, ptr %i_ptr29, align 8
  %idxprom.i2862 = zext i32 %bread.0.i2859 to i64
  %arrayidx21.i2863 = getelementptr inbounds i8, ptr %442, i64 %idxprom.i2862
  store ptr %arrayidx21.i2863, ptr %i_end30, align 8
  br label %if.end895
...
if.end895:                                        ; preds = %if.end892, %while.body883
  ...
  br i1 %cmp881, label %while.body883, label %while.end909
...
while.end909:                                     ; preds = %if.end895, %while.cond880.preheader
  ...
  %445 = load i16, ptr %arrayidx913, align 2
...
if.end939:                                        ; preds = %do.body918.preheader
  ...
  %449 = load i16, ptr %arrayidx942, align 2
  %cmp945 = icmp ugt i16 %449, 655
  br i1 %cmp945, label %do.body918.1, label %if.end948
...
if.end939.1:                                      ; preds = %do.body918.1
  ...
  %453 = load i16, ptr %arrayidx942.1, align 2
  %cmp945.1 = icmp ugt i16 %453, 655
  br i1 %cmp945.1, label %do.body918.2, label %if.end948
...
if.end939.2:                                      ; preds = %do.body918.2
  ...
  %457 = load i16, ptr %arrayidx942.2, align 2
  %cmp945.2 = icmp ugt i16 %457, 655
  br i1 %cmp945.2, label %do.body918.3, label %if.end948
...
if.end939.3:                                      ; preds = %do.body918.3
  ...
  %461 = load i16, ptr %arrayidx942.3, align 2
  %cmp945.3 = icmp ugt i16 %461, 655
  br i1 %cmp945.3, label %do.body918.4, label %if.end948
...
if.end939.4:                                      ; preds = %do.body918.4
  ...
  %464 = load i16, ptr %arrayidx942.4, align 2
  %cmp945.4 = icmp ugt i16 %464, 655
  br i1 %cmp945.4, label %do.body918.5, label %if.end948
...
if.end939.5:                                      ; preds = %do.body918.5
  ...
  %469 = load i16, ptr %arrayidx942.5, align 2
  %cmp945.5 = icmp ugt i16 %469, 655
  br i1 %cmp945.5, label %do.body918.6, label %if.end948
...
if.end939.6:                                      ; preds = %do.body918.6
  ...
  %474 = load i16, ptr %arrayidx942.6, align 2
  %cmp945.6 = icmp ugt i16 %474, 655
  br i1 %cmp945.6, label %do.body918.7, label %if.end948
...
if.end939.7:                                      ; preds = %do.body918.7
  ...
  %479 = load i16, ptr %arrayidx942.7, align 2
  %cmp945.7 = icmp ugt i16 %479, 655
  br i1 %cmp945.7, label %do.body918.8, label %if.end948
...
if.end939.8:                                      ; preds = %do.body918.8
  ...
  %484 = load i16, ptr %arrayidx942.8, align 2
  %cmp945.8 = icmp ugt i16 %484, 655
  br i1 %cmp945.8, label %do.body918.9, label %if.end948
...
if.end939.9:                                      ; preds = %do.body918.9
  ...
  %489 = load i16, ptr %arrayidx942.9, align 2
  %cmp945.9 = icmp ugt i16 %489, 655
  br i1 %cmp945.9, label %do.body918.10, label %if.end948
...
if.end939.10:                                     ; preds = %do.body918.10
  ...
  %494 = load i16, ptr %arrayidx942.10, align 2
  %cmp945.10 = icmp ugt i16 %494, 655
  br i1 %cmp945.10, label %do.body918.11, label %if.end948
...
if.end939.11:                                     ; preds = %do.body918.11
  ...
  %499 = load i16, ptr %arrayidx942.11, align 2
  %cmp945.11 = icmp ugt i16 %499, 655
  br i1 %cmp945.11, label %do.body918.12, label %if.end948
...
if.end939.12:                                     ; preds = %do.body918.12
  ...
  %504 = load i16, ptr %arrayidx942.12, align 2
  %cmp945.12 = icmp ugt i16 %504, 655
  br i1 %cmp945.12, label %do.body918.13, label %if.end948
...
if.end939.13:                                     ; preds = %do.body918.13
  ...
  %509 = load i16, ptr %arrayidx942.13, align 2
  %cmp945.13 = icmp ugt i16 %509, 655
  br i1 %cmp945.13, label %do.body918.14, label %if.end948
...
if.end939.14:                                     ; preds = %do.body918.14
  ...
  %514 = load i16, ptr %arrayidx942.14, align 2
  %cmp945.14 = icmp ugt i16 %514, 655
  br i1 %cmp945.14, label %do.body918.15, label %if.end948
...
if.end939.15:                                     ; preds = %do.body918.15
  ...
  %519 = load i16, ptr %arrayidx942.15, align 2
  %cmp945.15 = icmp ugt i16 %519, 655
  br i1 %cmp945.15, label %do.body918.16, label %if.end948
...
if.end939.16:                                     ; preds = %do.body918.16
  ...
  %524 = load i16, ptr %arrayidx942.16, align 2
  %cmp945.16 = icmp ugt i16 %524, 655
  br i1 %cmp945.16, label %do.body918.17, label %if.end948
...
if.end939.17:                                     ; preds = %do.body918.17
  ...
  %529 = load i16, ptr %arrayidx942.17, align 2
  %cmp945.17 = icmp ugt i16 %529, 655
  br i1 %cmp945.17, label %do.body918.18, label %if.end948
...
if.end939.18:                                     ; preds = %do.body918.18
  ...
  %534 = load i16, ptr %arrayidx942.18, align 2
  %cmp945.18 = icmp ugt i16 %534, 655
  br i1 %cmp945.18, label %do.body918.19, label %if.end948
...
if.end939.19:                                     ; preds = %do.body918.19
  ...
  %538 = load i16, ptr %arrayidx942.19, align 2
  %cmp945.19 = icmp ugt i16 %538, 655
  br i1 %cmp945.19, label %if.then922, label %if.end948
...
if.end948:                                        ; preds = %if.end939, %if.end939.1, %if.end939.2, %if.end939.3, %if.end939.4, %if.end939.5, %if.end939.6, %if.end939.7, %if.end939.8, %if.end939.9, %if.end939.10, %if.end939.11, %if.end939.12, %if.end939.13, %if.end939.14, %if.end939.15, %if.end939.16, %if.end939.17, %if.end939.18, %if.end939.19, %while.end909
  ...
  %539 = load i8, ptr %arrayidx952, align 1
...
if.then960:                                       ; preds = %if.end948
  ...
  store i8 %conv961, ptr %arrayidx964, align 1
...
if.then7.i2901:                                   ; preds = %if.end.i2891
  %545 = load i8, ptr %input_end.i, align 4
...
if.else.i2906:                                    ; preds = %if.then7.i2901
  %546 = load ptr, ptr %inbuf.i, align 8
  %arrayidx12.i2908 = getelementptr inbounds i8, ptr %546, i64 1
  store i8 0, ptr %arrayidx12.i2908, align 1
  %547 = load ptr, ptr %inbuf.i, align 8
...
if.end985:                                        ; preds = %if.else.i2906, %if.end.i2891
  ...
  %548 = load ptr, ptr %inbuf.i, align 8
  store ptr %548, ptr %i_ptr29, align 8
  %idxprom.i2897 = zext i32 %bread.0.i2894 to i64
  %arrayidx21.i2898 = getelementptr inbounds i8, ptr %548, i64 %idxprom.i2897
  store ptr %arrayidx21.i2898, ptr %i_end30, align 8
  br label %if.end988
...
if.end988:                                        ; preds = %if.end985, %while.body976
  ...
  br i1 %cmp974, label %while.body976, label %while.end1002
...
while.end1002:                                    ; preds = %if.end988, %while.cond973.preheader
  ...
  %551 = load i16, ptr %arrayidx1006, align 2
...
if.end1032:                                       ; preds = %do.body1011.preheader
  ...
  %555 = load i16, ptr %arrayidx1035, align 2
  %cmp1038 = icmp ugt i16 %555, 249
  br i1 %cmp1038, label %do.body1011.1, label %if.end1041
...
if.end1032.1:                                     ; preds = %do.body1011.1
  ...
  %559 = load i16, ptr %arrayidx1035.1, align 2
  %cmp1038.1 = icmp ugt i16 %559, 249
  br i1 %cmp1038.1, label %do.body1011.2, label %if.end1041
...
if.end1032.2:                                     ; preds = %do.body1011.2
  ...
  %563 = load i16, ptr %arrayidx1035.2, align 2
  %cmp1038.2 = icmp ugt i16 %563, 249
  br i1 %cmp1038.2, label %do.body1011.3, label %if.end1041
...
if.end1032.3:                                     ; preds = %do.body1011.3
  ...
  %567 = load i16, ptr %arrayidx1035.3, align 2
  %cmp1038.3 = icmp ugt i16 %567, 249
  br i1 %cmp1038.3, label %do.body1011.4, label %if.end1041
...
if.end1032.4:                                     ; preds = %do.body1011.4
  ...
  %570 = load i16, ptr %arrayidx1035.4, align 2
  %cmp1038.4 = icmp ugt i16 %570, 249
  br i1 %cmp1038.4, label %do.body1011.5, label %if.end1041
...
if.end1032.5:                                     ; preds = %do.body1011.5
  ...
  %575 = load i16, ptr %arrayidx1035.5, align 2
  %cmp1038.5 = icmp ugt i16 %575, 249
  br i1 %cmp1038.5, label %do.body1011.6, label %if.end1041
...
if.end1032.6:                                     ; preds = %do.body1011.6
  ...
  %580 = load i16, ptr %arrayidx1035.6, align 2
  %cmp1038.6 = icmp ugt i16 %580, 249
  br i1 %cmp1038.6, label %do.body1011.7, label %if.end1041
...
if.end1032.7:                                     ; preds = %do.body1011.7
  ...
  %585 = load i16, ptr %arrayidx1035.7, align 2
  %cmp1038.7 = icmp ugt i16 %585, 249
  br i1 %cmp1038.7, label %do.body1011.8, label %if.end1041
...
if.end1032.8:                                     ; preds = %do.body1011.8
  ...
  %590 = load i16, ptr %arrayidx1035.8, align 2
  %cmp1038.8 = icmp ugt i16 %590, 249
  br i1 %cmp1038.8, label %do.body1011.9, label %if.end1041
...
if.end1032.9:                                     ; preds = %do.body1011.9
  ...
  %595 = load i16, ptr %arrayidx1035.9, align 2
  %cmp1038.9 = icmp ugt i16 %595, 249
  br i1 %cmp1038.9, label %do.body1011.10, label %if.end1041
...
if.end1032.10:                                    ; preds = %do.body1011.10
  ...
  %600 = load i16, ptr %arrayidx1035.10, align 2
  %cmp1038.10 = icmp ugt i16 %600, 249
  br i1 %cmp1038.10, label %do.body1011.11, label %if.end1041
...
if.end1032.11:                                    ; preds = %do.body1011.11
  ...
  %605 = load i16, ptr %arrayidx1035.11, align 2
  %cmp1038.11 = icmp ugt i16 %605, 249
  br i1 %cmp1038.11, label %do.body1011.12, label %if.end1041
...
if.end1032.12:                                    ; preds = %do.body1011.12
  ...
  %610 = load i16, ptr %arrayidx1035.12, align 2
  %cmp1038.12 = icmp ugt i16 %610, 249
  br i1 %cmp1038.12, label %do.body1011.13, label %if.end1041
...
if.end1032.13:                                    ; preds = %do.body1011.13
  ...
  %615 = load i16, ptr %arrayidx1035.13, align 2
  %cmp1038.13 = icmp ugt i16 %615, 249
  br i1 %cmp1038.13, label %do.body1011.14, label %if.end1041
...
if.end1032.14:                                    ; preds = %do.body1011.14
  ...
  %620 = load i16, ptr %arrayidx1035.14, align 2
  %cmp1038.14 = icmp ugt i16 %620, 249
  br i1 %cmp1038.14, label %do.body1011.15, label %if.end1041
...
if.end1032.15:                                    ; preds = %do.body1011.15
  ...
  %625 = load i16, ptr %arrayidx1035.15, align 2
  %cmp1038.15 = icmp ugt i16 %625, 249
  br i1 %cmp1038.15, label %do.body1011.16, label %if.end1041
...
if.end1032.16:                                    ; preds = %do.body1011.16
  ...
  %630 = load i16, ptr %arrayidx1035.16, align 2
  %cmp1038.16 = icmp ugt i16 %630, 249
  br i1 %cmp1038.16, label %do.body1011.17, label %if.end1041
...
if.end1032.17:                                    ; preds = %do.body1011.17
  ...
  %635 = load i16, ptr %arrayidx1035.17, align 2
  %cmp1038.17 = icmp ugt i16 %635, 249
  br i1 %cmp1038.17, label %do.body1011.18, label %if.end1041
...
if.end1032.18:                                    ; preds = %do.body1011.18
  ...
  %640 = load i16, ptr %arrayidx1035.18, align 2
  %cmp1038.18 = icmp ugt i16 %640, 249
  br i1 %cmp1038.18, label %do.body1011.19, label %if.end1041
...
if.end1032.19:                                    ; preds = %do.body1011.19
  ...
  %644 = load i16, ptr %arrayidx1035.19, align 2
  %cmp1038.19 = icmp ugt i16 %644, 249
  br i1 %cmp1038.19, label %if.then1015, label %if.end1041
...
if.end1041:                                       ; preds = %if.end1032, %if.end1032.1, %if.end1032.2, %if.end1032.3, %if.end1032.4, %if.end1032.5, %if.end1032.6, %if.end1032.7, %if.end1032.8, %if.end1032.9, %if.end1032.10, %if.end1032.11, %if.end1032.12, %if.end1032.13, %if.end1032.14, %if.end1032.15, %if.end1032.16, %if.end1032.17, %if.end1032.18, %if.end1032.19, %while.end1002
  ...
  %645 = load i8, ptr %arrayidx1045, align 1
...
if.then1082:                                      ; preds = %if.then1079
  %648 = load i32, ptr %error, align 8
  br label %cleanup

if.end1084:                                       ; preds = %if.then1079
  %649 = load ptr, ptr %i_ptr29, align 8
  %650 = load ptr, ptr %i_end30, align 8
  br label %if.end1087
...
if.then1123:                                      ; preds = %if.then1120
  %653 = load i32, ptr %error, align 8
  br label %cleanup

if.end1125:                                       ; preds = %if.then1120
  %654 = load ptr, ptr %i_ptr29, align 8
  %655 = load ptr, ptr %i_end30, align 8
  br label %if.end1128
...
if.end1128:                                       ; preds = %if.end1125, %while.body1116
  ...
  br i1 %cmp1114, label %while.body1116, label %while.end1142
...
while.end1142:                                    ; preds = %if.end1128, %while.end1101
  ...
  %658 = load i16, ptr %arrayidx1146, align 2
...
if.end1172:                                       ; preds = %do.body1151
  ...
  %661 = load i16, ptr %arrayidx1175, align 2
  %cmp1178 = icmp ugt i16 %661, 7
  br i1 %cmp1178, label %do.body1151.1, label %if.end1181
...
if.end1172.1:                                     ; preds = %if.end1157.1
  ...
  %664 = load i16, ptr %arrayidx1175.1, align 2
  %cmp1178.1 = icmp ugt i16 %664, 7
  br i1 %cmp1178.1, label %do.body1151, label %if.end1181
...
if.end1181:                                       ; preds = %if.end1172, %if.end1172.1, %while.end1142
  ...
  %665 = load i8, ptr %arrayidx1185, align 1
...
if.then1207:                                      ; preds = %if.then1204
  %666 = load i32, ptr %error, align 8
  br label %cleanup

if.end1209:                                       ; preds = %if.then1204
  %667 = load ptr, ptr %i_ptr29, align 8
  %668 = load ptr, ptr %i_end30, align 8
  br label %if.end1212
...
if.end1212:                                       ; preds = %if.end1209, %while.body1200
  ...
  br i1 %cmp1198, label %while.body1200, label %while.end1226
...
while.end1226:                                    ; preds = %if.end1212, %while.cond1197.preheader
  ...
  %671 = load i16, ptr %arrayidx1230, align 2
...
if.end1256:                                       ; preds = %do.body1235
  ...
  %674 = load i16, ptr %arrayidx1259, align 2
  %cmp1262 = icmp ugt i16 %674, 7
  br i1 %cmp1262, label %do.body1235.1, label %if.end1265
...
if.end1256.1:                                     ; preds = %if.end1241.1
  ...
  %677 = load i16, ptr %arrayidx1259.1, align 2
  %cmp1262.1 = icmp ugt i16 %677, 7
  br i1 %cmp1262.1, label %do.body1235, label %if.end1265
...
if.end1265:                                       ; preds = %if.end1256, %if.end1256.1, %while.end1226
  ...
  %678 = load i8, ptr %arrayidx1269, align 1
...
if.then1291:                                      ; preds = %if.then1288
  %679 = load i32, ptr %error, align 8
  br label %cleanup

if.end1293:                                       ; preds = %if.then1288
  %680 = load ptr, ptr %i_ptr29, align 8
  %681 = load ptr, ptr %i_end30, align 8
  br label %if.end1296
...
if.end1296:                                       ; preds = %if.end1293, %while.body1284
  ...
  br i1 %cmp1282, label %while.body1284, label %while.end1310
...
sw.epilog1324:                                    ; preds = %if.end1181, %while.end1310, %if.end1265, %if.else1192, %if.end1052, %sw.bb1057, %sw.bb1056
  ...
  %684 = load i32, ptr %window_size1326, align 8
...
if.then1336:                                      ; preds = %if.end1331
  ...
  %cmp1339 = icmp sgt i32 %sub1337, %684
...
vector.ph5242:                                    ; preds = %vector.memcheck5237
  %n.vec5244 = and i64 %688, 8589934560
...
vector.body5253:                                  ; preds = %vector.body5253, %vector.ph5242
  ...
  %wide.load5259 = load <16 x i8>, ptr %next.gep5257, align 1
  %692 = getelementptr i8, ptr %next.gep5257, i64 16
  %wide.load5260 = load <16 x i8>, ptr %692, align 1
  store <16 x i8> %wide.load5259, ptr %next.gep5255, align 1
  %693 = getelementptr i8, ptr %next.gep5255, i64 16
  store <16 x i8> %wide.load5260, ptr %693, align 1
  %index.next5261 = add nuw i64 %index5254, 32
  %694 = icmp eq i64 %index.next5261, %n.vec5244
  br i1 %694, label %middle.block5239, label %vector.body5253
...
while.body1356:                                   ; preds = %while.body1356.preheader5323, %while.body1356
  ...
  %695 = load i8, ptr %runsrc.44584, align 1
  %incdec.ptr1358 = getelementptr inbounds i8, ptr %rundest.54585, i64 1
  store i8 %695, ptr %rundest.54585, align 1
  %cmp1354 = icmp ugt i32 %j.24583, 1
  br i1 %cmp1354, label %while.body1356, label %if.end1360
...
vector.body5197:                                  ; preds = %vector.body5197, %vector.ph5193
  ...
  %wide.load5203 = load <16 x i8>, ptr %next.gep5201, align 1
  %698 = getelementptr i8, ptr %next.gep5201, i64 16
  %wide.load5204 = load <16 x i8>, ptr %698, align 1
  store <16 x i8> %wide.load5203, ptr %next.gep5199, align 1
  %699 = getelementptr i8, ptr %next.gep5199, i64 16
  store <16 x i8> %wide.load5204, ptr %699, align 1
  %index.next5205 = add nuw i64 %index5198, 32
  %700 = icmp eq i64 %index.next5205, %n.vec5195
  br i1 %700, label %middle.block5186, label %vector.body5197
...
vec.epilog.vector.body5231:                       ; preds = %vec.epilog.vector.body5231, %vec.epilog.ph5213
  ...
  %wide.load5235 = load <8 x i8>, ptr %next.gep5234, align 1
  store <8 x i8> %wide.load5235, ptr %next.gep5233, align 1
  %index.next5236 = add nuw i64 %index5232, 8
  %701 = icmp eq i64 %index.next5236, %n.vec5218
  br i1 %701, label %vec.epilog.middle.block5210, label %vec.epilog.vector.body5231
...
while.body1365:                                   ; preds = %while.body1365.preheader, %while.body1365
  ...
  %702 = load i8, ptr %runsrc.64588, align 1
  %incdec.ptr1367 = getelementptr inbounds i8, ptr %rundest.74589, i64 1
  store i8 %702, ptr %rundest.74589, align 1
  %cmp1363 = icmp ugt i32 %i.144590, 1
  br i1 %cmp1363, label %while.body1365, label %if.end1381
...
vector.ph5271:                                    ; preds = %vector.main.loop.iter.check5270
  ...
  %wide.load5281 = load <16 x i8>, ptr %add.ptr1372, align 1
  %704 = getelementptr i8, ptr %add.ptr1372, i64 16
  %wide.load5282 = load <16 x i8>, ptr %704, align 1
  store <16 x i8> %wide.load5281, ptr %arrayidx1333, align 1
  %705 = getelementptr i8, ptr %arrayidx1333, i64 16
  store <16 x i8> %wide.load5282, ptr %705, align 1
  %706 = icmp eq i64 %n.vec5273, 32
  br i1 %706, label %middle.block5264, label %vector.body5275.1
...
vector.body5275.1:                                ; preds = %vector.ph5271
  ...
  %wide.load5281.1 = load <16 x i8>, ptr %next.gep5279.1, align 1
  %707 = getelementptr i8, ptr %add.ptr1372, i64 48
  %wide.load5282.1 = load <16 x i8>, ptr %707, align 1
  store <16 x i8> %wide.load5281.1, ptr %next.gep5277.1, align 1
  %708 = getelementptr i8, ptr %arrayidx1333, i64 48
  store <16 x i8> %wide.load5282.1, ptr %708, align 1
  %709 = icmp eq i64 %n.vec5273, 64
  br i1 %709, label %middle.block5264, label %vector.body5275.2
...
vector.body5275.2:                                ; preds = %vector.body5275.1
  ...
  %wide.load5281.2 = load <16 x i8>, ptr %next.gep5279.2, align 1
  %710 = getelementptr i8, ptr %add.ptr1372, i64 80
  %wide.load5282.2 = load <16 x i8>, ptr %710, align 1
  store <16 x i8> %wide.load5281.2, ptr %next.gep5277.2, align 1
  %711 = getelementptr i8, ptr %arrayidx1333, i64 80
  store <16 x i8> %wide.load5282.2, ptr %711, align 1
  %712 = icmp eq i64 %n.vec5273, 96
  br i1 %712, label %middle.block5264, label %vector.body5275.3
...
vector.body5275.3:                                ; preds = %vector.body5275.2
  ...
  %wide.load5281.3 = load <16 x i8>, ptr %next.gep5279.3, align 1
  %713 = getelementptr i8, ptr %add.ptr1372, i64 112
  %wide.load5282.3 = load <16 x i8>, ptr %713, align 1
  store <16 x i8> %wide.load5281.3, ptr %next.gep5277.3, align 1
  %714 = getelementptr i8, ptr %arrayidx1333, i64 112
  store <16 x i8> %wide.load5282.3, ptr %714, align 1
  %715 = icmp eq i64 %n.vec5273, 128
  br i1 %715, label %middle.block5264, label %vector.body5275.4
...
vector.body5275.4:                                ; preds = %vector.body5275.3
  ...
  %wide.load5281.4 = load <16 x i8>, ptr %next.gep5279.4, align 1
  %716 = getelementptr i8, ptr %add.ptr1372, i64 144
  %wide.load5282.4 = load <16 x i8>, ptr %716, align 1
  store <16 x i8> %wide.load5281.4, ptr %next.gep5277.4, align 1
  %717 = getelementptr i8, ptr %arrayidx1333, i64 144
  store <16 x i8> %wide.load5282.4, ptr %717, align 1
  %718 = icmp eq i64 %n.vec5273, 160
  br i1 %718, label %middle.block5264, label %vector.body5275.5
...
vector.body5275.5:                                ; preds = %vector.body5275.4
  ...
  %wide.load5281.5 = load <16 x i8>, ptr %next.gep5279.5, align 1
  %719 = getelementptr i8, ptr %add.ptr1372, i64 176
  %wide.load5282.5 = load <16 x i8>, ptr %719, align 1
  store <16 x i8> %wide.load5281.5, ptr %next.gep5277.5, align 1
  %720 = getelementptr i8, ptr %arrayidx1333, i64 176
  store <16 x i8> %wide.load5282.5, ptr %720, align 1
  %721 = icmp eq i64 %n.vec5273, 192
  br i1 %721, label %middle.block5264, label %vector.body5275.6
...
vector.body5275.6:                                ; preds = %vector.body5275.5
  ...
  %wide.load5281.6 = load <16 x i8>, ptr %next.gep5279.6, align 1
  %722 = getelementptr i8, ptr %add.ptr1372, i64 208
  %wide.load5282.6 = load <16 x i8>, ptr %722, align 1
  store <16 x i8> %wide.load5281.6, ptr %next.gep5277.6, align 1
  %723 = getelementptr i8, ptr %arrayidx1333, i64 208
  store <16 x i8> %wide.load5282.6, ptr %723, align 1
  %724 = icmp eq i64 %n.vec5273, 224
  br i1 %724, label %middle.block5264, label %vector.body5275.7
...
vector.body5275.7:                                ; preds = %vector.body5275.6
  ...
  %wide.load5281.7 = load <16 x i8>, ptr %next.gep5279.7, align 1
  %725 = getelementptr i8, ptr %add.ptr1372, i64 240
  %wide.load5282.7 = load <16 x i8>, ptr %725, align 1
  store <16 x i8> %wide.load5281.7, ptr %next.gep5277.7, align 1
  %726 = getelementptr i8, ptr %arrayidx1333, i64 240
  store <16 x i8> %wide.load5282.7, ptr %726, align 1
...
vec.epilog.vector.body5309:                       ; preds = %vec.epilog.vector.body5309, %vec.epilog.ph5291
  ...
  %wide.load5313 = load <8 x i8>, ptr %next.gep5312, align 1
  store <8 x i8> %wide.load5313, ptr %next.gep5311, align 1
  %index.next5314 = add nuw i64 %index5310, 8
  %727 = icmp eq i64 %index.next5314, %n.vec5296
  br i1 %727, label %vec.epilog.middle.block5288, label %vec.epilog.vector.body5309
...
while.body1377:                                   ; preds = %while.body1377.preheader, %while.body1377
  ...
  %728 = load i8, ptr %runsrc.74579, align 1
  %incdec.ptr1379 = getelementptr inbounds i8, ptr %rundest.84580, i64 1
  store i8 %728, ptr %rundest.84580, align 1
  %cmp1375 = icmp sgt i32 %i.154581, 1
  br i1 %cmp1375, label %while.body1377, label %if.end1381
...
if.end1384:                                       ; preds = %if.end1381, %if.then960
  ...
  br i1 %cmp876, label %while.cond880.preheader, label %sw.epilog1422
...
if.else1410:                                      ; preds = %while.body1393
  %729 = load ptr, ptr %read.i, align 8
  %tobool.not.i2917 = icmp eq ptr %729, null
  %730 = load ptr, ptr %inbuf.i, align 8
  %731 = load i32, ptr %inbuf_size.i, align 8
  br i1 %tobool.not.i2917, label %cond.false.i2946, label %cond.true.i2918

cond.true.i2918:                                  ; preds = %if.else1410
  %732 = load ptr, ptr %file.i, align 8
  %call.i2922 = tail call i32 %729(ptr noundef %732, ptr noundef %730, i32 noundef %731) #11
  br label %cond.end.i2923

cond.false.i2946:                                 ; preds = %if.else1410
  %733 = load i32, ptr %lzx, align 8
  %call5.i2949 = tail call i32 @cli_readn(i32 noundef %733, ptr noundef %730, i32 noundef %731) #11
  br label %cond.end.i2923
...
if.then7.i2936:                                   ; preds = %if.end.i2926
  %734 = load i8, ptr %input_end.i, align 4
  %tobool8.not.i2938 = icmp eq i8 %734, 0
...
if.else.i2941:                                    ; preds = %if.then7.i2936
  %735 = load ptr, ptr %inbuf.i, align 8
  %arrayidx12.i2943 = getelementptr inbounds i8, ptr %735, i64 1
  store i8 0, ptr %arrayidx12.i2943, align 1
  %736 = load ptr, ptr %inbuf.i, align 8
...
if.end1415:                                       ; preds = %if.else.i2941, %if.end.i2926
  ...
  %737 = load ptr, ptr %inbuf.i, align 8
  store ptr %737, ptr %i_ptr29, align 8
  %idxprom.i2932 = zext i32 %bread.0.i2929 to i64
  %arrayidx21.i2933 = getelementptr inbounds i8, ptr %737, i64 %idxprom.i2932
  store ptr %arrayidx21.i2933, ptr %i_end30, align 8
  br label %if.end1418
...
if.end1418:                                       ; preds = %if.end1415, %if.then1399
  ...
  br i1 %cmp1391, label %while.body1393, label %sw.epilog1422
...
if.then1425:                                      ; preds = %sw.epilog1422
  ...
  %738 = load i32, ptr %block_remaining, align 4
...
if.end1434:                                       ; preds = %if.then1425
  ...
  store i32 %sub1437, ptr %block_remaining, align 4
  br label %if.end1438

if.end1438:                                       ; preds = %if.end1434, %sw.epilog1422
  %cmp185 = icmp sgt i32 %sub580, 0
  br i1 %cmp185, label %while.body187, label %while.end1439.loopexit

while.end1439.loopexit:                           ; preds = %if.end1438
  %.pre4827 = load i32, ptr %frame_posn, align 8
...
if.then1462:                                      ; preds = %if.then1459
  %741 = load i32, ptr %error, align 8
  br label %cleanup

if.end1464:                                       ; preds = %if.then1459
  %742 = load ptr, ptr %i_ptr29, align 8
  %743 = load ptr, ptr %i_end30, align 8
  br label %if.end1467
...
if.end1482:                                       ; preds = %if.end1467, %if.end1448
  ...
  %746 = load ptr, ptr %o_ptr, align 8
  %747 = load ptr, ptr %o_end, align 8
...
if.end1502:                                       ; preds = %if.end1482
  %748 = load i8, ptr %intel_started472, align 8
  %tobool1505.not = icmp eq i8 %748, 0
  %.pre4829 = load i32, ptr %intel_filesize, align 8
...
if.else1583.thread4837:                           ; preds = %land.lhs.true1509
  %752 = load ptr, ptr %window33, align 8
  %753 = load i32, ptr %frame_posn, align 8
  %idxprom15864838 = zext i32 %753 to i64
  %arrayidx15874839 = getelementptr inbounds i8, ptr %752, i64 %idxprom15864838
  store ptr %arrayidx15874839, ptr %o_ptr, align 8
...
if.then1516:                                      ; preds = %land.lhs.true1509
  ...
  %754 = load i32, ptr %intel_curpos, align 4
  store ptr %e8_buf, ptr %o_ptr, align 8
  %755 = load ptr, ptr %window33, align 8
  %756 = load i32, ptr %frame_posn, align 8
...
while.body1532:                                   ; preds = %if.then1516, %while.cond1529.backedge
  ...
  %757 = load i8, ptr %data.04688, align 1
...
while.cond1529.backedge:                          ; preds = %while.body1532, %if.end1577
  ...
  br i1 %cmp1530, label %while.body1532, label %while.end1580.loopexit
...
if.end1539:                                       ; preds = %while.body1532
  ...
  %760 = load i8, ptr %arrayidx1546, align 1
  ...
  %761 = load i8, ptr %arrayidx1550, align 1
...
if.then1560:                                      ; preds = %if.end1539
  ...
  store i8 %conv1566, ptr %incdec.ptr1533, align 1
  %762 = lshr i32 %cond1565, 8
  %conv1569 = trunc i32 %762 to i8
  store i8 %conv1569, ptr %arrayidx1542, align 1
  %763 = lshr i32 %cond1565, 16
  %conv1572 = trunc i32 %763 to i8
  store i8 %conv1572, ptr %arrayidx1546, align 1
  %764 = lshr i32 %cond1565, 24
  %conv1575 = trunc i32 %764 to i8
  store i8 %conv1575, ptr %arrayidx1550, align 1
  br label %if.end1577
...
while.end1580.loopexit:                           ; preds = %while.cond1529.backedge
  %.pre4828 = load i32, ptr %intel_curpos, align 4
  %.pre4830.pre = load ptr, ptr %o_ptr, align 8
...
while.end1580:                                    ; preds = %while.end1580.loopexit, %if.then1516
  ...
  store i32 %add1582, ptr %intel_curpos, align 4
  br label %if.end1595

if.else1583:                                      ; preds = %if.end1502
  %766 = load ptr, ptr %window33, align 8
  %767 = load i32, ptr %frame_posn, align 8
  %idxprom1586 = zext i32 %767 to i64
  %arrayidx1587 = getelementptr inbounds i8, ptr %766, i64 %idxprom1586
  store ptr %arrayidx1587, ptr %o_ptr, align 8
...
if.then1591:                                      ; preds = %if.else1583.thread4837, %if.else1583
  ...
  %768 = load i32, ptr %intel_curpos, align 4
  %add1593 = add i32 %768, %frame_size.0
  store i32 %add1593, ptr %intel_curpos, align 4
  br label %if.end1595
...
if.end1595:                                       ; preds = %if.else1583.thread, %if.else1583, %if.then1591, %while.end1580
  ...
  store ptr %arrayidx1598, ptr %o_end, align 8
  ...
  %770 = load i8, ptr %wflag1608, align 8
...
land.lhs.true1611:                                ; preds = %if.end1595
  %771 = load i32, ptr %ofd1612, align 4
...
land.lhs.true1611.if.end1619_crit_edge:           ; preds = %land.lhs.true1611
  %.pre4831 = load ptr, ptr %o_ptr, align 8
  br label %if.end1619
...
if.end1619:                                       ; preds = %land.lhs.true1611.if.end1619_crit_edge, %if.end1595
  ...
  store ptr %add.ptr1622, ptr %o_ptr, align 8
  %773 = load i64, ptr %offset38, align 8
  %add1625 = add nsw i64 %773, %idx.ext1621
  store i64 %add1625, ptr %offset38, align 8
  %sub1627 = sub nsw i64 %out_bytes.addr.14699, %idx.ext1621
  %774 = load i32, ptr %frame_posn, align 8
  %add1629 = add i32 %774, %frame_size.0
  store i32 %add1629, ptr %frame_posn, align 8
  %775 = load i32, ptr %frame, align 4
  %inc1631 = add i32 %775, 1
  store i32 %inc1631, ptr %frame, align 4
  %776 = load i32, ptr %window_size1326, align 8
...
if.end1643:                                       ; preds = %if.then1641, %if.end1619
  ...
  br i1 %cmp42, label %while.body, label %while.end1644
...
do.body1649:                                      ; preds = %while.end1644
  store ptr %i_ptr.60, ptr %i_ptr29, align 8
  store ptr %i_end.59, ptr %i_end30, align 8
  store i32 %shl1487, ptr %bit_buffer31, align 8
  store i32 %sub1489, ptr %bits_left32, align 4
  store i32 %spec.store.select, ptr %window_posn34, align 4
  store i32 %R0.1.lcssa, ptr %R035, align 4
  store i32 %R1.1.lcssa, ptr %R136, align 8
  store i32 %R2.1.lcssa, ptr %R237, align 4
  br label %cleanup
...
if.then7:                                         ; preds = %if.end
  ...
  %7 = load i8, ptr %input_end, align 4
...
if.end17:                                         ; preds = %if.else, %if.end
  ...
  store ptr %arrayidx21, ptr %i_end, align 8
  br label %cleanup
...
for.body6.us221:                                  ; preds = %for.body6.us221.preheader, %for.inc.us230
  ...
  %1 = load i8, ptr %arrayidx.us225, align 1
...
for.body18.us.prol:                               ; preds = %for.body18.us.preheader346, %for.body18.us.prol
  ...
  store i16 %sym.0211.us223, ptr %arrayidx20.us.prol, align 2
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body18.us.prol.loopexit, label %for.body18.us.prol
...
for.body18.us:                                    ; preds = %for.body18.us.prol.loopexit, %for.body18.us
  ...
  store i16 %sym.0211.us223, ptr %arrayidx20.us, align 2
  ...
  store i16 %sym.0211.us223, ptr %arrayidx20.us.1, align 2
  ...
  store i16 %sym.0211.us223, ptr %arrayidx20.us.2, align 2
  ...
  store i16 %sym.0211.us223, ptr %arrayidx20.us.3, align 2
  %cmp16.not.us.3 = icmp eq i32 %dec.us.3, 0
  br i1 %cmp16.not.us.3, label %for.inc.us230, label %for.body18.us
...
for.inc.us230:                                    ; preds = %for.body18.us.prol.loopexit, %for.body18.us, %middle.block, %for.body6.us221
  ...
  br i1 %cmp4.us234, label %for.body6.us221, label %for.cond2.for.end22_crit_edge.us
...
for.cond2.for.end22_crit_edge.us:                 ; preds = %for.inc.us230, %for.inc.us.us
  ...
  br i1 %cmp.not.us, label %for.end26, label %for.cond2.preheader.us
...
for.body6.us.us:                                  ; preds = %for.body6.us.us.preheader, %for.inc.us.us
  ...
  %10 = load i8, ptr %arrayidx.us.us, align 1
...
for.inc.us.us:                                    ; preds = %for.body6.us.us
  ...
  br i1 %cmp4.us.us, label %for.body6.us.us, label %for.cond2.for.end22_crit_edge.us
...
vector.body335:                                   ; preds = %vector.body335, %vector.ph329
  ...
  store <8 x i16> <i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1>, ptr %28, align 2
  %29 = getelementptr inbounds i16, ptr %28, i64 8
  store <8 x i16> <i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1>, ptr %29, align 2
  %index.next339 = add nuw i32 %index336, 16
  %30 = icmp eq i32 %index.next339, %n.vec331
  br i1 %30, label %middle.block326, label %vector.body335
...
for.body36:                                       ; preds = %for.body36.preheader345, %for.body36
  ...
  store i16 -1, ptr %arrayidx38, align 2
...
for.body55.us264:                                 ; preds = %for.cond51.preheader.us, %for.inc107.us276
  ...
  %34 = load i8, ptr %arrayidx57.us268, align 1
...
if.end63.us270:                                   ; preds = %for.body55.us264
  ...
  store i16 %sym.2249.us266, ptr %arrayidx101.us273, align 2
...
for.inc107.us276:                                 ; preds = %if.end63.us270, %for.body55.us264
  ...
  br i1 %cmp53.us280, label %for.body55.us264, label %for.cond51.for.end109_crit_edge.us
...
for.cond51.for.end109_crit_edge.us:               ; preds = %for.inc107.us.us, %for.inc107.us276
  ...
  br i1 %exitcond303.not, label %for.end113, label %for.cond51.preheader.us
...
for.body55.us.us:                                 ; preds = %for.cond51.preheader.us, %for.inc107.us.us
  ...
  %37 = load i8, ptr %arrayidx57.us.us, align 1
...
for.inc107.us.us:                                 ; preds = %for.cond65.for.end99_crit_edge.us.us, %for.body55.us.us
  ...
  br i1 %cmp53.us.us, label %for.body55.us.us, label %for.cond51.for.end109_crit_edge.us
...
for.body69.us.us:                                 ; preds = %if.end87.us.us, %if.end63.us.us
  ...
  %39 = load i16, ptr %arrayidx71.us.us, align 2
...
if.then75.us.us:                                  ; preds = %for.body69.us.us
  ...
  store i16 -1, ptr %arrayidx78.us.us, align 2
...
if.end87.us.us:                                   ; preds = %if.then75.us.us, %for.body69.us.us
  ...
  br i1 %exitcond.not, label %for.cond65.for.end99_crit_edge.us.us, label %for.body69.us.us
...
for.cond65.for.end99_crit_edge.us.us:             ; preds = %if.end87.us.us
  ...
  store i16 %sym.2249.us.us, ptr %arrayidx101.us.us, align 2
...
for.cond118:                                      ; preds = %for.body122
  ...
  br i1 %cmp120, label %for.body122, label %cleanup
...
for.body122:                                      ; preds = %for.end113, %for.cond118
  ...
  %42 = load i8, ptr %arrayidx124, align 1
...
if.then:                                          ; preds = %while.body
  %4 = load ptr, ptr %read.i, align 8
  %tobool.not.i = icmp eq ptr %4, null
  %5 = load ptr, ptr %inbuf.i, align 8
  %6 = load i32, ptr %inbuf_size.i, align 8
  br i1 %tobool.not.i, label %cond.false.i, label %cond.true.i
...
if.then7.i:                                       ; preds = %if.end.i
  %9 = load i8, ptr %input_end.i, align 4
...
if.else.i:                                        ; preds = %if.then7.i
  %10 = load ptr, ptr %inbuf.i, align 8
...
if.end:                                           ; preds = %if.else.i, %if.end.i
  %bread.0.i = phi i32 [ 2, %if.else.i ], [ %cond.i, %if.end.i ]
  %12 = load ptr, ptr %inbuf.i, align 8
  store ptr %12, ptr %i_ptr1, align 8
  %idxprom.i = zext i32 %bread.0.i to i64
  %arrayidx21.i = getelementptr inbounds i8, ptr %12, i64 %idxprom.i
  store ptr %arrayidx21.i, ptr %i_end2, align 8
  br label %if.end11
...
while.end:                                        ; preds = %if.end11, %while.cond.preheader
  ...
  br i1 %exitcond.not, label %for.end, label %while.cond.preheader
...
if.then29:                                        ; preds = %for.end
  ...
  store i32 -124, ptr %error30, align 8
  br label %cleanup
...
if.then44:                                        ; preds = %while.body40
  %15 = load ptr, ptr %read.i, align 8
...
if.then.i581:                                     ; preds = %cond.end.i560
  ...
  store i32 -123, ptr %error.i582, align 8
  br label %cleanup
...
if.then7.i573:                                    ; preds = %if.end.i563
  %20 = load i8, ptr %input_end.i, align 4
...
if.end52:                                         ; preds = %if.end49, %while.body40
  ...
  br i1 %cmp38, label %while.body40, label %while.end66
...
while.end66:                                      ; preds = %if.end52, %while.cond37.preheader
  ...
  %26 = load i16, ptr %arrayidx70, align 2
...
if.then79:                                        ; preds = %do.body75
  ...
  store i32 -124, ptr %error80, align 8
  br label %cleanup
...
if.then92:                                        ; preds = %do.body75.1, %if.end81
  ...
  store i32 -124, ptr %error93, align 8
  br label %cleanup
...
if.end94:                                         ; preds = %if.end81
  ...
  br i1 %cmp100, label %do.body75.1, label %if.end103
...
if.end94.1:                                       ; preds = %do.body75.1
  ...
  %32 = load i16, ptr %arrayidx97.1, align 2
  %cmp100.1 = icmp ugt i16 %32, 19
  br i1 %cmp100.1, label %do.body75, label %if.end103
...
if.then124:                                       ; preds = %while.body120
  ...
  %35 = load ptr, ptr %inbuf.i, align 8
  %36 = load i32, ptr %inbuf_size.i, align 8
...
cond.true.i590:                                   ; preds = %if.then124
  ...
  %call.i594 = tail call i32 %34(ptr noundef %37, ptr noundef %35, i32 noundef %36) #11
  br label %cond.end.i595

cond.false.i618:                                  ; preds = %if.then124
  %38 = load i32, ptr %lzx, align 8
  %call5.i621 = tail call i32 @cli_readn(i32 noundef %38, ptr noundef %35, i32 noundef %36) #11
  br label %cond.end.i595
...
if.then.i616:                                     ; preds = %cond.end.i595
  ...
  store i32 -123, ptr %error.i617, align 8
  br label %cleanup
...
if.then7.i608:                                    ; preds = %if.end.i598
  %39 = load i8, ptr %input_end.i, align 4
  %tobool8.not.i610 = icmp eq i8 %39, 0
...
if.then9.i611:                                    ; preds = %if.then7.i608
  ...
  store i32 -123, ptr %error10.i612, align 8
  br label %cleanup

if.else.i613:                                     ; preds = %if.then7.i608
  %40 = load ptr, ptr %inbuf.i, align 8
  %arrayidx12.i615 = getelementptr inbounds i8, ptr %40, i64 1
  store i8 0, ptr %arrayidx12.i615, align 1
  %41 = load ptr, ptr %inbuf.i, align 8
...
if.end129:                                        ; preds = %if.else.i613, %if.end.i598
  ...
  %42 = load ptr, ptr %inbuf.i, align 8
  store ptr %42, ptr %i_ptr1, align 8
  %idxprom.i604 = zext i32 %bread.0.i601 to i64
  %arrayidx21.i605 = getelementptr inbounds i8, ptr %42, i64 %idxprom.i604
  store ptr %arrayidx21.i605, ptr %i_end2, align 8
  br label %if.end132
...
if.end132:                                        ; preds = %if.end129, %while.body120
  ...
  br i1 %cmp118, label %while.body120, label %while.end146
...
while.body155.prol:                               ; preds = %while.body155.preheader, %while.body155.prol
  ...
  store i8 0, ptr %arrayidx158.prol, align 1
  %prol.iter958.next = add i32 %prol.iter958, 1
  %prol.iter958.cmp.not = icmp eq i32 %prol.iter958.next, %xtraiter956
  br i1 %prol.iter958.cmp.not, label %while.body155.prol.loopexit, label %while.body155.prol
...
while.body155:                                    ; preds = %while.body155.prol.loopexit, %while.body155
  ...
  store i8 0, ptr %arrayidx158.1, align 1
  ...
  store i8 0, ptr %arrayidx158.2, align 1
  ...
  store i8 0, ptr %arrayidx158.3, align 1
  %tobool154.not.3 = icmp eq i32 %dec.3, 0
  br i1 %tobool154.not.3, label %if.end362.loopexit, label %while.body155
...
if.then171:                                       ; preds = %while.body167
  %52 = load ptr, ptr %read.i, align 8
  %tobool.not.i624 = icmp eq ptr %52, null
  %53 = load ptr, ptr %inbuf.i, align 8
  %54 = load i32, ptr %inbuf_size.i, align 8
...
cond.true.i625:                                   ; preds = %if.then171
  ...
  %call.i629 = tail call i32 %52(ptr noundef %55, ptr noundef %53, i32 noundef %54) #11
  br label %cond.end.i630

cond.false.i653:                                  ; preds = %if.then171
  %56 = load i32, ptr %lzx, align 8
  %call5.i656 = tail call i32 @cli_readn(i32 noundef %56, ptr noundef %53, i32 noundef %54) #11
  br label %cond.end.i630
...
if.then.i651:                                     ; preds = %cond.end.i630
  ...
  store i32 -123, ptr %error.i652, align 8
  br label %cleanup
...
if.then7.i643:                                    ; preds = %if.end.i633
  %57 = load i8, ptr %input_end.i, align 4
  %tobool8.not.i645 = icmp eq i8 %57, 0
...
if.then9.i646:                                    ; preds = %if.then7.i643
  ...
  store i32 -123, ptr %error10.i647, align 8
  br label %cleanup

if.else.i648:                                     ; preds = %if.then7.i643
  %58 = load ptr, ptr %inbuf.i, align 8
  %arrayidx12.i650 = getelementptr inbounds i8, ptr %58, i64 1
  store i8 0, ptr %arrayidx12.i650, align 1
  %59 = load ptr, ptr %inbuf.i, align 8
...
if.end176:                                        ; preds = %if.else.i648, %if.end.i633
  ...
  %60 = load ptr, ptr %inbuf.i, align 8
  store ptr %60, ptr %i_ptr1, align 8
  %idxprom.i639 = zext i32 %bread.0.i636 to i64
  %arrayidx21.i640 = getelementptr inbounds i8, ptr %60, i64 %idxprom.i639
  store ptr %arrayidx21.i640, ptr %i_end2, align 8
  br label %if.end179
...
if.end179:                                        ; preds = %if.end176, %while.body167
  ...
  br i1 %cmp165, label %while.body167, label %while.end193
...
vector.ph941:                                     ; preds = %while.end193
  ...
  store <16 x i8> zeroinitializer, ptr %67, align 1
  %68 = icmp eq i32 %n.vec943, 16
  br i1 %68, label %middle.block938, label %vector.body949.1
...
vector.body949.1:                                 ; preds = %vector.ph941
  ...
  store <16 x i8> zeroinitializer, ptr %70, align 1
  %71 = icmp eq i32 %n.vec943, 32
  br i1 %71, label %middle.block938, label %vector.body949.2
...
vector.body949.2:                                 ; preds = %vector.body949.1
  ...
  store <16 x i8> zeroinitializer, ptr %73, align 1
...
while.body203.prol:                               ; preds = %while.body203.preheader, %while.body203.prol
  ...
  store i8 0, ptr %arrayidx206.prol, align 1
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %while.body203.prol.loopexit, label %while.body203.prol
...
while.body203:                                    ; preds = %while.body203.prol.loopexit, %while.body203
  ...
  store i8 0, ptr %arrayidx206.1, align 1
  ...
  store i8 0, ptr %arrayidx206.2, align 1
  ...
  store i8 0, ptr %arrayidx206.3, align 1
  %tobool202.not.3 = icmp eq i32 %dec201.3, 0
  br i1 %tobool202.not.3, label %if.end362.loopexit929, label %while.body203
...
cond.true.i660:                                   ; preds = %if.then220
  %79 = load ptr, ptr %file.i, align 8
  %call.i664 = tail call i32 %76(ptr noundef %79, ptr noundef %77, i32 noundef %78) #11
  br label %cond.end.i665

cond.false.i688:                                  ; preds = %if.then220
  %80 = load i32, ptr %lzx, align 8
  %call5.i691 = tail call i32 @cli_readn(i32 noundef %80, ptr noundef %77, i32 noundef %78) #11
  br label %cond.end.i665
...
if.then.i686:                                     ; preds = %cond.end.i665
  ...
  store i32 -123, ptr %error.i687, align 8
  br label %cleanup
...
if.then7.i678:                                    ; preds = %if.end.i668
  %81 = load i8, ptr %input_end.i, align 4
  %tobool8.not.i680 = icmp eq i8 %81, 0
...
if.then9.i681:                                    ; preds = %if.then7.i678
  ...
  store i32 -123, ptr %error10.i682, align 8
  br label %cleanup

if.else.i683:                                     ; preds = %if.then7.i678
  %82 = load ptr, ptr %inbuf.i, align 8
  %arrayidx12.i685 = getelementptr inbounds i8, ptr %82, i64 1
  store i8 0, ptr %arrayidx12.i685, align 1
  %83 = load ptr, ptr %inbuf.i, align 8
  store i8 0, ptr %83, align 1
  store i8 1, ptr %input_end.i, align 4
  br label %if.end225
...
if.end225:                                        ; preds = %if.else.i683, %if.end.i668
  ...
  %84 = load ptr, ptr %inbuf.i, align 8
  store ptr %84, ptr %i_ptr1, align 8
  %idxprom.i674 = zext i32 %bread.0.i671 to i64
  %arrayidx21.i675 = getelementptr inbounds i8, ptr %84, i64 %idxprom.i674
  store ptr %arrayidx21.i675, ptr %i_end2, align 8
  br label %if.end228
...
if.end228:                                        ; preds = %if.end225, %while.body216
  ...
  br i1 %cmp214, label %while.body216, label %while.end242
...
cond.true.i695:                                   ; preds = %if.then257
  %90 = load ptr, ptr %file.i, align 8
  %call.i699 = tail call i32 %87(ptr noundef %90, ptr noundef %88, i32 noundef %89) #11
  br label %cond.end.i700

cond.false.i723:                                  ; preds = %if.then257
  %91 = load i32, ptr %lzx, align 8
  %call5.i726 = tail call i32 @cli_readn(i32 noundef %91, ptr noundef %88, i32 noundef %89) #11
  br label %cond.end.i700
...
if.then.i721:                                     ; preds = %cond.end.i700
  ...
  store i32 -123, ptr %error.i722, align 8
  br label %cleanup
...
if.then7.i713:                                    ; preds = %if.end.i703
  %92 = load i8, ptr %input_end.i, align 4
  %tobool8.not.i715 = icmp eq i8 %92, 0
...
if.then9.i716:                                    ; preds = %if.then7.i713
  ...
  store i32 -123, ptr %error10.i717, align 8
  br label %cleanup

if.else.i718:                                     ; preds = %if.then7.i713
  %93 = load ptr, ptr %inbuf.i, align 8
  %arrayidx12.i720 = getelementptr inbounds i8, ptr %93, i64 1
  store i8 0, ptr %arrayidx12.i720, align 1
  %94 = load ptr, ptr %inbuf.i, align 8
  store i8 0, ptr %94, align 1
  store i8 1, ptr %input_end.i, align 4
  br label %if.end262
...
if.end262:                                        ; preds = %if.else.i718, %if.end.i703
  ...
  %95 = load ptr, ptr %inbuf.i, align 8
  store ptr %95, ptr %i_ptr1, align 8
  %idxprom.i709 = zext i32 %bread.0.i706 to i64
  %arrayidx21.i710 = getelementptr inbounds i8, ptr %95, i64 %idxprom.i709
  store ptr %arrayidx21.i710, ptr %i_end2, align 8
  br label %if.end265
...
if.end265:                                        ; preds = %if.end262, %while.body253
  ...
  br i1 %cmp251, label %while.body253, label %while.end279
...
while.end279:                                     ; preds = %if.end265, %while.end242
  ...
  %98 = load i16, ptr %arrayidx283, align 2
...
if.then292:                                       ; preds = %do.body288
  ...
  store i32 -124, ptr %error293, align 8
  br label %cleanup
...
if.then307:                                       ; preds = %do.body288.1, %if.end294
  ...
  store i32 -124, ptr %error308, align 8
  br label %cleanup
...
if.end309:                                        ; preds = %if.end294
  ...
  %101 = load i16, ptr %arrayidx312, align 2
  %cmp315 = icmp ugt i16 %101, 19
  br i1 %cmp315, label %do.body288.1, label %if.end318
...
if.end309.1:                                      ; preds = %do.body288.1
  ...
  %104 = load i16, ptr %arrayidx312.1, align 2
  %cmp315.1 = icmp ugt i16 %104, 19
  br i1 %cmp315.1, label %do.body288, label %if.end318
...
if.end318:                                        ; preds = %if.end309, %if.end309.1, %while.end279
  ...
  %105 = load i8, ptr %arrayidx322, align 1
  ...
  %106 = load i8, ptr %arrayidx329, align 1
  ...
  store i8 %conv341, ptr %arrayidx344, align 1
  ...
  store i8 %conv341, ptr %arrayidx344.1, align 1
  ...
  store i8 %conv341, ptr %arrayidx344.2, align 1
  ...
  store i8 %conv341, ptr %arrayidx344.3, align 1
  %tobool339.not.3 = icmp sgt i32 %bit_buffer.6.lcssa, -1
  br i1 %tobool339.not.3, label %if.end362.loopexit930, label %while.body340.4
...
while.body340.4:                                  ; preds = %if.end318
  ...
  store i8 %conv341, ptr %arrayidx344.4, align 1
...
if.else346:                                       ; preds = %if.end103
  ...
  %107 = load i8, ptr %arrayidx348, align 1
  ...
  store i8 %conv356, ptr %arrayidx348, align 1
  br label %if.end362
...
if.end362:                                        ; preds = %if.end362.loopexit930, %if.end362.loopexit929, %if.end362.loopexit, %if.else346
  ...
  br i1 %cmp33, label %while.cond37.preheader, label %do.body364
...
do.body364:                                       ; preds = %if.end362, %for.cond32.preheader
  ...
  store ptr %i_ptr.3.lcssa, ptr %i_ptr1, align 8
  store ptr %i_end.3.lcssa, ptr %i_end2, align 8
  store i32 %bit_buffer.2.lcssa, ptr %bit_buffer3, align 8
  store i32 %bits_left.2.lcssa, ptr %bits_left4, align 4
  br label %cleanup
...
for.body:                                         ; preds = %if.end4, %for.body
  ...
  %offset.0273 = phi i32 [ %add16.1, %for.body ], [ 0, %if.end4 ]
  %arrayidx = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 20, i64 %indvars.iv
  store i32 %offset.0273, ptr %arrayidx, align 4
  ...
  store i8 %conv.1, ptr %arrayidx10.1, align 1
  %shl15.1 = shl nuw nsw i32 1, %shr.1
  %add16.1 = add i32 %shl15.1, %add16
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1, 42
  br i1 %exitcond.not.1, label %for.body20.preheader, label %for.body

for.body20.preheader:                             ; preds = %for.body
  %arrayidx23 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 22, i64 0
  %arrayidx34.5 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 23, i64 5
  store <16 x i8> <i8 0, i8 1, i8 2, i8 3, i8 4, i8 5, i8 6, i8 8, i8 10, i8 12, i8 14, i8 18, i8 22, i8 26, i8 30, i8 38>, ptr %arrayidx23, align 1
  %arrayidx23.16 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 22, i64 16
  store <16 x i8> <i8 0, i8 1, i8 1, i8 1, i8 1, i8 2, i8 2, i8 2, i8 2, i8 3, i8 3, i8 3, i8 3, i8 4, i8 4, i8 4>, ptr %arrayidx34.5, align 1
  %arrayidx34.21 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 23, i64 21
  store <4 x i8> <i8 4, i8 5, i8 5, i8 5>, ptr %arrayidx34.21, align 1
  %arrayidx34.25 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 23, i64 25
  store i8 5, ptr %arrayidx34.25, align 1
  store <16 x i8> <i8 46, i8 54, i8 62, i8 78, i8 94, i8 110, i8 126, i8 -98, i8 -66, i8 -34, i8 -2, i8 0, i8 0, i8 0, i8 0, i8 0>, ptr %arrayidx23.16, align 1
  ...
  store ptr %call49, ptr %window, align 8
...
if.end53:                                         ; preds = %for.body20.preheader
  ...
  store ptr %call55, ptr %inbuf, align 8
...
if.end60:                                         ; preds = %if.end53
  ...
  store i32 %ofd, ptr %ofd62, align 4
  ...
  store i32 %and, ptr %inbuf_size, align 4
  %window_size63 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 4
  store i32 %shl, ptr %window_size63, align 8
  ...
  store i32 0, ptr %frame_start, align 8
  ...
  store i32 4, ptr %model0, align 8
  %entries.i = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 24, i32 1
  store i32 64, ptr %entries.i, align 4
  %syms1.i = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 24, i32 2
  store ptr %m0sym, ptr %syms1.i, align 8
  store <8 x i16> <i16 0, i16 64, i16 1, i16 63, i16 2, i16 62, i16 3, i16 61>, ptr %m0sym, align 2
  %5 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 4
  store <8 x i16> <i16 4, i16 60, i16 5, i16 59, i16 6, i16 58, i16 7, i16 57>, ptr %5, align 2
  %6 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 8
  store <8 x i16> <i16 8, i16 56, i16 9, i16 55, i16 10, i16 54, i16 11, i16 53>, ptr %6, align 2
  %7 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 12
  store <8 x i16> <i16 12, i16 52, i16 13, i16 51, i16 14, i16 50, i16 15, i16 49>, ptr %7, align 2
  %8 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 16
  store <8 x i16> <i16 16, i16 48, i16 17, i16 47, i16 18, i16 46, i16 19, i16 45>, ptr %8, align 2
  %9 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 20
  store <8 x i16> <i16 20, i16 44, i16 21, i16 43, i16 22, i16 42, i16 23, i16 41>, ptr %9, align 2
  %10 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 24
  store <8 x i16> <i16 24, i16 40, i16 25, i16 39, i16 26, i16 38, i16 27, i16 37>, ptr %10, align 2
  %11 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 28
  store <8 x i16> <i16 28, i16 36, i16 29, i16 35, i16 30, i16 34, i16 31, i16 33>, ptr %11, align 2
  %12 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 32
  store <8 x i16> <i16 32, i16 32, i16 33, i16 31, i16 34, i16 30, i16 35, i16 29>, ptr %12, align 2
  %13 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 36
  store <8 x i16> <i16 36, i16 28, i16 37, i16 27, i16 38, i16 26, i16 39, i16 25>, ptr %13, align 2
  %14 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 40
  store <8 x i16> <i16 40, i16 24, i16 41, i16 23, i16 42, i16 22, i16 43, i16 21>, ptr %14, align 2
  %15 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 44
  store <8 x i16> <i16 44, i16 20, i16 45, i16 19, i16 46, i16 18, i16 47, i16 17>, ptr %15, align 2
  %16 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 48
  store <8 x i16> <i16 48, i16 16, i16 49, i16 15, i16 50, i16 14, i16 51, i16 13>, ptr %16, align 2
  %17 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 52
  store <8 x i16> <i16 52, i16 12, i16 53, i16 11, i16 54, i16 10, i16 55, i16 9>, ptr %17, align 2
  %18 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 56
  store <8 x i16> <i16 56, i16 8, i16 57, i16 7, i16 58, i16 6, i16 59, i16 5>, ptr %18, align 2
  %19 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 60
  store <8 x i16> <i16 60, i16 4, i16 61, i16 3, i16 62, i16 2, i16 63, i16 1>, ptr %19, align 2
  %arrayidx.i = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 64
  store i16 64, ptr %arrayidx.i, align 2
  %cumfreq.i = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 64, i32 1
  store i16 0, ptr %cumfreq.i, align 2
  ...
  store i32 4, ptr %model1, align 8
  %entries.i174 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 25, i32 1
  store i32 64, ptr %entries.i174, align 4
  %syms1.i175 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 25, i32 2
  store ptr %m1sym, ptr %syms1.i175, align 8
  store <8 x i16> <i16 64, i16 64, i16 65, i16 63, i16 66, i16 62, i16 67, i16 61>, ptr %m1sym, align 2
  %20 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 4
  store <8 x i16> <i16 68, i16 60, i16 69, i16 59, i16 70, i16 58, i16 71, i16 57>, ptr %20, align 2
  %21 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 8
  store <8 x i16> <i16 72, i16 56, i16 73, i16 55, i16 74, i16 54, i16 75, i16 53>, ptr %21, align 2
  %22 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 12
  store <8 x i16> <i16 76, i16 52, i16 77, i16 51, i16 78, i16 50, i16 79, i16 49>, ptr %22, align 2
  %23 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 16
  store <8 x i16> <i16 80, i16 48, i16 81, i16 47, i16 82, i16 46, i16 83, i16 45>, ptr %23, align 2
  %24 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 20
  store <8 x i16> <i16 84, i16 44, i16 85, i16 43, i16 86, i16 42, i16 87, i16 41>, ptr %24, align 2
  %25 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 24
  store <8 x i16> <i16 88, i16 40, i16 89, i16 39, i16 90, i16 38, i16 91, i16 37>, ptr %25, align 2
  %26 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 28
  store <8 x i16> <i16 92, i16 36, i16 93, i16 35, i16 94, i16 34, i16 95, i16 33>, ptr %26, align 2
  %27 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 32
  store <8 x i16> <i16 96, i16 32, i16 97, i16 31, i16 98, i16 30, i16 99, i16 29>, ptr %27, align 2
  %28 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 36
  store <8 x i16> <i16 100, i16 28, i16 101, i16 27, i16 102, i16 26, i16 103, i16 25>, ptr %28, align 2
  %29 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 40
  store <8 x i16> <i16 104, i16 24, i16 105, i16 23, i16 106, i16 22, i16 107, i16 21>, ptr %29, align 2
  %30 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 44
  store <8 x i16> <i16 108, i16 20, i16 109, i16 19, i16 110, i16 18, i16 111, i16 17>, ptr %30, align 2
  %31 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 48
  store <8 x i16> <i16 112, i16 16, i16 113, i16 15, i16 114, i16 14, i16 115, i16 13>, ptr %31, align 2
  %32 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 52
  store <8 x i16> <i16 116, i16 12, i16 117, i16 11, i16 118, i16 10, i16 119, i16 9>, ptr %32, align 2
  %33 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 56
  store <8 x i16> <i16 120, i16 8, i16 121, i16 7, i16 122, i16 6, i16 123, i16 5>, ptr %33, align 2
  %34 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 60
  store <8 x i16> <i16 124, i16 4, i16 125, i16 3, i16 126, i16 2, i16 127, i16 1>, ptr %34, align 2
  %arrayidx.i179 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 64
  store i16 128, ptr %arrayidx.i179, align 2
  %cumfreq.i182 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 64, i32 1
  store i16 0, ptr %cumfreq.i182, align 2
  ...
  store i32 4, ptr %model2, align 8
  %entries.i186 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 26, i32 1
  store i32 64, ptr %entries.i186, align 4
  %syms1.i187 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 26, i32 2
  store ptr %m2sym, ptr %syms1.i187, align 8
  store <8 x i16> <i16 128, i16 64, i16 129, i16 63, i16 130, i16 62, i16 131, i16 61>, ptr %m2sym, align 2
  %35 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 4
  store <8 x i16> <i16 132, i16 60, i16 133, i16 59, i16 134, i16 58, i16 135, i16 57>, ptr %35, align 2
  %36 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 8
  store <8 x i16> <i16 136, i16 56, i16 137, i16 55, i16 138, i16 54, i16 139, i16 53>, ptr %36, align 2
  %37 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 12
  store <8 x i16> <i16 140, i16 52, i16 141, i16 51, i16 142, i16 50, i16 143, i16 49>, ptr %37, align 2
  %38 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 16
  store <8 x i16> <i16 144, i16 48, i16 145, i16 47, i16 146, i16 46, i16 147, i16 45>, ptr %38, align 2
  %39 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 20
  store <8 x i16> <i16 148, i16 44, i16 149, i16 43, i16 150, i16 42, i16 151, i16 41>, ptr %39, align 2
  %40 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 24
  store <8 x i16> <i16 152, i16 40, i16 153, i16 39, i16 154, i16 38, i16 155, i16 37>, ptr %40, align 2
  %41 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 28
  store <8 x i16> <i16 156, i16 36, i16 157, i16 35, i16 158, i16 34, i16 159, i16 33>, ptr %41, align 2
  %42 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 32
  store <8 x i16> <i16 160, i16 32, i16 161, i16 31, i16 162, i16 30, i16 163, i16 29>, ptr %42, align 2
  %43 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 36
  store <8 x i16> <i16 164, i16 28, i16 165, i16 27, i16 166, i16 26, i16 167, i16 25>, ptr %43, align 2
  %44 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 40
  store <8 x i16> <i16 168, i16 24, i16 169, i16 23, i16 170, i16 22, i16 171, i16 21>, ptr %44, align 2
  %45 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 44
  store <8 x i16> <i16 172, i16 20, i16 173, i16 19, i16 174, i16 18, i16 175, i16 17>, ptr %45, align 2
  %46 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 48
  store <8 x i16> <i16 176, i16 16, i16 177, i16 15, i16 178, i16 14, i16 179, i16 13>, ptr %46, align 2
  %47 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 52
  store <8 x i16> <i16 180, i16 12, i16 181, i16 11, i16 182, i16 10, i16 183, i16 9>, ptr %47, align 2
  %48 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 56
  store <8 x i16> <i16 184, i16 8, i16 185, i16 7, i16 186, i16 6, i16 187, i16 5>, ptr %48, align 2
  %49 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 60
  store <8 x i16> <i16 188, i16 4, i16 189, i16 3, i16 190, i16 2, i16 191, i16 1>, ptr %49, align 2
  %arrayidx.i192 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 64
  store i16 192, ptr %arrayidx.i192, align 2
  %cumfreq.i195 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 64, i32 1
  store i16 0, ptr %cumfreq.i195, align 2
  ...
  store i32 4, ptr %model3, align 8
  %entries.i199 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 27, i32 1
  store i32 64, ptr %entries.i199, align 4
  %syms1.i200 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 27, i32 2
  store ptr %m3sym, ptr %syms1.i200, align 8
  store <8 x i16> <i16 192, i16 64, i16 193, i16 63, i16 194, i16 62, i16 195, i16 61>, ptr %m3sym, align 2
  %50 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 4
  store <8 x i16> <i16 196, i16 60, i16 197, i16 59, i16 198, i16 58, i16 199, i16 57>, ptr %50, align 2
  %51 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 8
  store <8 x i16> <i16 200, i16 56, i16 201, i16 55, i16 202, i16 54, i16 203, i16 53>, ptr %51, align 2
  %52 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 12
  store <8 x i16> <i16 204, i16 52, i16 205, i16 51, i16 206, i16 50, i16 207, i16 49>, ptr %52, align 2
  %53 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 16
  store <8 x i16> <i16 208, i16 48, i16 209, i16 47, i16 210, i16 46, i16 211, i16 45>, ptr %53, align 2
  %54 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 20
  store <8 x i16> <i16 212, i16 44, i16 213, i16 43, i16 214, i16 42, i16 215, i16 41>, ptr %54, align 2
  %55 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 24
  store <8 x i16> <i16 216, i16 40, i16 217, i16 39, i16 218, i16 38, i16 219, i16 37>, ptr %55, align 2
  %56 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 28
  store <8 x i16> <i16 220, i16 36, i16 221, i16 35, i16 222, i16 34, i16 223, i16 33>, ptr %56, align 2
  %57 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 32
  store <8 x i16> <i16 224, i16 32, i16 225, i16 31, i16 226, i16 30, i16 227, i16 29>, ptr %57, align 2
  %58 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 36
  store <8 x i16> <i16 228, i16 28, i16 229, i16 27, i16 230, i16 26, i16 231, i16 25>, ptr %58, align 2
  %59 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 40
  store <8 x i16> <i16 232, i16 24, i16 233, i16 23, i16 234, i16 22, i16 235, i16 21>, ptr %59, align 2
  %60 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 44
  store <8 x i16> <i16 236, i16 20, i16 237, i16 19, i16 238, i16 18, i16 239, i16 17>, ptr %60, align 2
  %61 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 48
  store <8 x i16> <i16 240, i16 16, i16 241, i16 15, i16 242, i16 14, i16 243, i16 13>, ptr %61, align 2
  %62 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 52
  store <8 x i16> <i16 244, i16 12, i16 245, i16 11, i16 246, i16 10, i16 247, i16 9>, ptr %62, align 2
  %63 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 56
  store <8 x i16> <i16 248, i16 8, i16 249, i16 7, i16 250, i16 6, i16 251, i16 5>, ptr %63, align 2
  %64 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 60
  store <8 x i16> <i16 252, i16 4, i16 253, i16 3, i16 254, i16 2, i16 255, i16 1>, ptr %64, align 2
  %arrayidx.i205 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 64
  store i16 256, ptr %arrayidx.i205, align 2
  %cumfreq.i208 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 64, i32 1
  store i16 0, ptr %cumfreq.i208, align 2
...
vector.body316:                                   ; preds = %vector.body316, %vector.ph314
  %index317 = phi i64 [ 0, %vector.ph314 ], [ %index.next323, %vector.body316 ]
  %vec.ind318 = phi <4 x i32> [ <i32 0, i32 1, i32 2, i32 3>, %vector.ph314 ], [ %vec.ind.next319, %vector.body316 ]
  %vec.ind320 = phi <4 x i16> [ <i16 0, i16 1, i16 2, i16 3>, %vector.ph314 ], [ %vec.ind.next321, %vector.body316 ]
  %66 = sub nsw <4 x i32> %broadcast.splat, %vec.ind318
  %67 = trunc <4 x i32> %66 to <4 x i16>
  %68 = getelementptr inbounds %struct.qtm_modelsym, ptr %m5sym, i64 %index317
  %interleaved.vec322 = shufflevector <4 x i16> %vec.ind320, <4 x i16> %67, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x i16> %interleaved.vec322, ptr %68, align 2
  %index.next323 = add nuw i64 %index317, 4
  %vec.ind.next319 = add <4 x i32> %vec.ind318, <i32 4, i32 4, i32 4, i32 4>
  %vec.ind.next321 = add <4 x i16> %vec.ind320, <i16 4, i16 4, i16 4, i16 4>
  %69 = icmp eq i64 %index.next323, %n.vec
  br i1 %69, label %for.body.i226.preheader, label %vector.body316

for.body.i226.preheader:                          ; preds = %vector.body316, %if.end60
  %indvars.iv.i227.ph = phi i64 [ 0, %if.end60 ], [ %n.vec, %vector.body316 ]
...
for.body.i226:                                    ; preds = %for.body.i226.preheader, %for.body.i226
  ...
  %70 = trunc i64 %indvars.iv.i227 to i32
  ...
  store i16 %conv.i228, ptr %arrayidx.i229, align 2
  %sub.i230 = sub nsw i32 %cond85, %70
  ...
  store i16 %conv2.i231, ptr %cumfreq.i232, align 2
  ...
  br i1 %exitcond.not.i234, label %qtm_init_model.exit235, label %for.body.i226
...
qtm_init_model.exit235:                           ; preds = %for.body.i226
  ...
  store i32 4, ptr %model6, align 8
  %entries.i236 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 30, i32 1
  store i32 %mul, ptr %entries.i236, align 4
  %syms1.i237 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 30, i32 2
  store ptr %m6sym, ptr %syms1.i237, align 8
  %71 = or i32 %mul, 1
  %wide.trip.count.i238 = zext i32 %71 to i64
  %min.iters.check326 = icmp ult i32 %71, 4
  br i1 %min.iters.check326, label %for.body.i239.preheader, label %vector.ph327

vector.ph327:                                     ; preds = %qtm_init_model.exit235
  %n.vec329 = and i64 %wide.trip.count.i238, 2147483644
  %broadcast.splatinsert338 = insertelement <4 x i32> poison, i32 %mul, i64 0
...
vector.body332:                                   ; preds = %vector.body332, %vector.ph327
  %index333 = phi i64 [ 0, %vector.ph327 ], [ %index.next341, %vector.body332 ]
  %vec.ind334 = phi <4 x i32> [ <i32 0, i32 1, i32 2, i32 3>, %vector.ph327 ], [ %vec.ind.next335, %vector.body332 ]
  %vec.ind336 = phi <4 x i16> [ <i16 0, i16 1, i16 2, i16 3>, %vector.ph327 ], [ %vec.ind.next337, %vector.body332 ]
  %72 = sub nsw <4 x i32> %broadcast.splat339, %vec.ind334
  %73 = trunc <4 x i32> %72 to <4 x i16>
  %74 = getelementptr inbounds %struct.qtm_modelsym, ptr %m6sym, i64 %index333
  %interleaved.vec340 = shufflevector <4 x i16> %vec.ind336, <4 x i16> %73, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x i16> %interleaved.vec340, ptr %74, align 2
  %index.next341 = add nuw i64 %index333, 4
  %vec.ind.next335 = add <4 x i32> %vec.ind334, <i32 4, i32 4, i32 4, i32 4>
  %vec.ind.next337 = add <4 x i16> %vec.ind336, <i16 4, i16 4, i16 4, i16 4>
  %75 = icmp eq i64 %index.next341, %n.vec329
  br i1 %75, label %for.body.i239.preheader, label %vector.body332

for.body.i239.preheader:                          ; preds = %vector.body332, %qtm_init_model.exit235
  %indvars.iv.i240.ph = phi i64 [ 0, %qtm_init_model.exit235 ], [ %n.vec329, %vector.body332 ]
...
for.body.i239:                                    ; preds = %for.body.i239.preheader, %for.body.i239
  ...
  %76 = trunc i64 %indvars.iv.i240 to i32
  ...
  store i16 %conv.i241, ptr %arrayidx.i242, align 2
  %sub.i243 = sub nsw i32 %mul, %76
  ...
  store i16 %conv2.i244, ptr %cumfreq.i245, align 2
  ...
  br i1 %exitcond.not.i247, label %qtm_init_model.exit248, label %for.body.i239
...
qtm_init_model.exit248:                           ; preds = %for.body.i239
  ...
  store i32 4, ptr %model6len, align 8
  %entries.i249 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 31, i32 1
  store i32 27, ptr %entries.i249, align 4
  %syms1.i250 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 31, i32 2
  store ptr %m6lsym, ptr %syms1.i250, align 8
  store <8 x i16> <i16 0, i16 27, i16 1, i16 26, i16 2, i16 25, i16 3, i16 24>, ptr %m6lsym, align 2
  %arrayidx.i254.4 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 40, i64 4
  store <8 x i16> <i16 4, i16 23, i16 5, i16 22, i16 6, i16 21, i16 7, i16 20>, ptr %arrayidx.i254.4, align 2
  %arrayidx.i254.8 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 40, i64 8
  store <8 x i16> <i16 8, i16 19, i16 9, i16 18, i16 10, i16 17, i16 11, i16 16>, ptr %arrayidx.i254.8, align 2
  %arrayidx.i254.12 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 40, i64 12
  store <8 x i16> <i16 12, i16 15, i16 13, i16 14, i16 14, i16 13, i16 15, i16 12>, ptr %arrayidx.i254.12, align 2
  %arrayidx.i254.16 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 40, i64 16
  store <8 x i16> <i16 16, i16 11, i16 17, i16 10, i16 18, i16 9, i16 19, i16 8>, ptr %arrayidx.i254.16, align 2
  %arrayidx.i254.20 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 40, i64 20
  store <8 x i16> <i16 20, i16 7, i16 21, i16 6, i16 22, i16 5, i16 23, i16 4>, ptr %arrayidx.i254.20, align 2
  %arrayidx.i254.24 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 40, i64 24
  store <8 x i16> <i16 24, i16 3, i16 25, i16 2, i16 26, i16 1, i16 27, i16 0>, ptr %arrayidx.i254.24, align 2
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end1752
  ...
  %21 = load i8, ptr %header_read, align 2
...
if.then58:                                        ; preds = %if.then55
  %22 = load ptr, ptr %read1.i, align 8
  %tobool.not.i = icmp eq ptr %22, null
  %23 = load ptr, ptr %inbuf.i, align 8
  %24 = load i32, ptr %inbuf_size.i, align 4
  br i1 %tobool.not.i, label %cond.false.i, label %cond.true.i
...
if.end63:                                         ; preds = %cond.end.i
  %27 = load ptr, ptr %inbuf.i, align 8
  store ptr %27, ptr %i_ptr28, align 8
  %idxprom.i = zext i32 %cond.i to i64
  %arrayidx10.i = getelementptr inbounds i8, ptr %27, i64 %idxprom.i
  store ptr %arrayidx10.i, ptr %i_end29, align 8
  br label %if.end66
...
do.end79:                                         ; preds = %if.end66, %do.body51
  ...
  br i1 %cmp49.not, label %do.end106, label %do.body51

do.end106:                                        ; preds = %do.end79
  %conv94 = trunc i32 %or93 to i16
  store i8 1, ptr %header_read, align 2
  %.pre3364 = load ptr, ptr %o_end, align 8
  %.pre3365 = load ptr, ptr %o_ptr, align 8
  br label %if.end108
...
do.body128:                                       ; preds = %if.end108, %if.end1617
  ...
  %35 = load i16, ptr %cumfreq, align 2
...
for.body146:                                      ; preds = %for.body146.lr.ph, %for.inc157
  ...
  %38 = load i16, ptr %cumfreq150, align 2
...
for.inc157:                                       ; preds = %for.body146
  ...
  br i1 %exitcond.not, label %for.end158, label %for.body146
...
for.end158:                                       ; preds = %for.inc157, %for.end158.loopexit.split.loop.exit, %do.body128
  ...
  %43 = load i16, ptr %cumfreq193, align 2
...
do.body200:                                       ; preds = %do.body200, %for.end158
  ...
  %46 = load i16, ptr %cumfreq205, align 2
  %add207 = add i16 %46, 8
  store i16 %add207, ptr %cumfreq205, align 2
  %cmp210 = icmp sgt i64 %indvars.iv3321, 1
  br i1 %cmp210, label %do.body200, label %do.end212

do.end212:                                        ; preds = %do.body200
  %47 = trunc i32 %div184 to i16
  %conv187 = add i16 %42, %47
  %conv199 = add i16 %L.23217, %44
  %48 = load i16, ptr %cumfreq, align 2
...
if.then264:                                       ; preds = %if.then261
  %51 = load ptr, ptr %read1.i, align 8
  %tobool.not.i2480 = icmp eq ptr %51, null
  %52 = load ptr, ptr %inbuf.i, align 8
  %53 = load i32, ptr %inbuf_size.i, align 4
...
if.end269:                                        ; preds = %cond.end.i2486
  %56 = load ptr, ptr %inbuf.i, align 8
  store ptr %56, ptr %i_ptr28, align 8
  %idxprom.i2492 = zext i32 %cond.i2487 to i64
  %arrayidx10.i2493 = getelementptr inbounds i8, ptr %56, i64 %idxprom.i2492
  store ptr %arrayidx10.i2493, ptr %i_end29, align 8
  br label %if.end272
...
for.body346:                                      ; preds = %for.body346.lr.ph, %for.inc357
  ...
  %63 = load i16, ptr %cumfreq350, align 2
...
for.inc357:                                       ; preds = %for.body346
  ...
  br i1 %exitcond3360.not, label %for.end359, label %for.body346
...
for.end359:                                       ; preds = %for.inc357, %for.end359.loopexit.split.loop.exit, %cond.end321
  ...
  %68 = load i16, ptr %cumfreq390, align 2
...
do.body397:                                       ; preds = %do.body397, %for.end359
  ...
  %71 = load i16, ptr %cumfreq402, align 2
  %add404 = add i16 %71, 8
  store i16 %add404, ptr %cumfreq402, align 2
  %cmp407 = icmp sgt i64 %indvars.iv3361, 1
  br i1 %cmp407, label %do.body397, label %do.end409

do.end409:                                        ; preds = %do.body397
  %72 = trunc i32 %div382 to i16
  %conv385 = add i16 %67, %72
  %conv396 = add i16 %L.3, %69
  %73 = load i16, ptr %cumfreq335, align 2
...
if.then461:                                       ; preds = %if.then458
  %76 = load ptr, ptr %read1.i, align 8
  %tobool.not.i2504 = icmp eq ptr %76, null
  %77 = load ptr, ptr %inbuf.i, align 8
  %78 = load i32, ptr %inbuf_size.i, align 4
...
cleanup.thread:                                   ; preds = %if.then426
  ...
  store i8 %conv500, ptr %arrayidx503, align 1
  br label %if.end1617
...
do.body505:                                       ; preds = %if.else504
  ...
  %84 = load ptr, ptr %syms515, align 8
  %cumfreq517 = getelementptr inbounds %struct.qtm_modelsym, ptr %84, i64 0, i32 1
  %85 = load i16, ptr %cumfreq517, align 2
  %conv518 = zext i16 %85 to i32
  %86 = load i32, ptr %entries526, align 4
...
for.body529:                                      ; preds = %for.body529.lr.ph, %for.inc541
  ...
  %88 = load i16, ptr %cumfreq534, align 2
...
for.inc541:                                       ; preds = %for.body529
  ...
  br i1 %exitcond3352.not, label %for.end543, label %for.body529
...
for.end543:                                       ; preds = %for.inc541, %for.end543.loopexit.split.loop.exit, %do.body505
  ...
  %93 = load i16, ptr %cumfreq578, align 2
...
do.body585:                                       ; preds = %do.body585, %for.end543
  ...
  %96 = load i16, ptr %cumfreq591, align 2
  %add593 = add i16 %96, 8
  store i16 %add593, ptr %cumfreq591, align 2
  %cmp596 = icmp sgt i64 %indvars.iv3353, 1
  br i1 %cmp596, label %do.body585, label %do.end598

do.end598:                                        ; preds = %do.body585
  %97 = trunc i32 %div569 to i16
  %conv572 = add i16 %92, %97
  %conv584 = add i16 %L.3, %94
  %98 = load i16, ptr %cumfreq517, align 2
...
do.body691:                                       ; preds = %if.then617
  ...
  %109 = load i8, ptr %arrayidx693, align 1
...
if.end711:                                        ; preds = %cond.end.i2558
  %115 = load ptr, ptr %inbuf.i, align 8
  store ptr %115, ptr %i_ptr28, align 8
  %idxprom.i2564 = zext i32 %cond.i2559 to i64
  %arrayidx10.i2565 = getelementptr inbounds i8, ptr %115, i64 %idxprom.i2564
  store ptr %arrayidx10.i2565, ptr %i_end29, align 8
  br label %if.end714
...
for.body794:                                      ; preds = %for.body794.lr.ph, %for.inc806
  ...
  %123 = load i16, ptr %cumfreq799, align 2
...
for.inc806:                                       ; preds = %for.body794
  ...
  br i1 %exitcond3344.not, label %for.end808, label %for.body794
...
for.end808:                                       ; preds = %for.inc806, %for.end808.loopexit.split.loop.exit, %do.body770
  ...
  %128 = load i16, ptr %cumfreq843, align 2
...
if.end922:                                        ; preds = %cond.end.i2582
  %141 = load ptr, ptr %inbuf.i, align 8
  store ptr %141, ptr %i_ptr28, align 8
  %idxprom.i2588 = zext i32 %cond.i2583 to i64
  %arrayidx10.i2589 = getelementptr inbounds i8, ptr %141, i64 %idxprom.i2588
  store ptr %arrayidx10.i2589, ptr %i_end29, align 8
  br label %if.end925
...
do.body956:                                       ; preds = %if.then882
  ...
  %144 = load i8, ptr %arrayidx959, align 1
...
if.end977:                                        ; preds = %cond.end.i2606
  %150 = load ptr, ptr %inbuf.i, align 8
  store ptr %150, ptr %i_ptr28, align 8
  %idxprom.i2612 = zext i32 %cond.i2607 to i64
  %arrayidx10.i2613 = getelementptr inbounds i8, ptr %150, i64 %idxprom.i2612
  store ptr %arrayidx10.i2613, ptr %i_end29, align 8
  br label %if.end980
...
for.body1061:                                     ; preds = %for.body1061.lr.ph, %for.inc1073
  ...
  %158 = load i16, ptr %cumfreq1066, align 2
...
for.inc1073:                                      ; preds = %for.body1061
  ...
  br i1 %exitcond3328.not, label %for.end1075, label %for.body1061
...
for.end1075:                                      ; preds = %for.inc1073, %for.end1075.loopexit.split.loop.exit, %do.body1037
  ...
  %163 = load i16, ptr %cumfreq1110, align 2
...
do.body1223:                                      ; preds = %if.then1149
  ...
  %179 = load i8, ptr %arrayidx1225, align 1
...
if.end1243:                                       ; preds = %cond.end.i2654
  %185 = load ptr, ptr %inbuf.i, align 8
  store ptr %185, ptr %i_ptr28, align 8
  %idxprom.i2660 = zext i32 %cond.i2655 to i64
  %arrayidx10.i2661 = getelementptr inbounds i8, ptr %185, i64 %idxprom.i2660
  store ptr %arrayidx10.i2661, ptr %i_end29, align 8
  br label %if.end1246
...
do.end1264:                                       ; preds = %if.end1246, %do.body1231
  ...
  br i1 %cmp1228.not, label %do.end1296, label %do.body1231
...
do.end1296:                                       ; preds = %do.end1264, %do.body1223
  ...
  %189 = load i8, ptr %arrayidx1298, align 1
  ...
  %190 = load ptr, ptr %syms1312, align 8
  %cumfreq1314 = getelementptr inbounds %struct.qtm_modelsym, ptr %190, i64 0, i32 1
  %191 = load i16, ptr %cumfreq1314, align 2
  %conv1315 = zext i16 %191 to i32
  %192 = load i32, ptr %entries1323, align 4
...
for.body1326:                                     ; preds = %for.body1326.lr.ph, %for.inc1338
  ...
  %194 = load i16, ptr %cumfreq1331, align 2
...
for.inc1338:                                      ; preds = %for.body1326
  ...
  br i1 %exitcond3336.not, label %for.end1340, label %for.body1326
...
for.end1340:                                      ; preds = %for.inc1338, %for.end1340.loopexit.split.loop.exit, %do.end1296
  ...
  %199 = load i16, ptr %cumfreq1375, align 2
...
do.body1488:                                      ; preds = %if.then1414
  ...
  %215 = load i8, ptr %arrayidx1491, align 1
...
if.end1509:                                       ; preds = %cond.end.i2702
  %221 = load ptr, ptr %inbuf.i, align 8
  store ptr %221, ptr %i_ptr28, align 8
  %idxprom.i2708 = zext i32 %cond.i2703 to i64
  %arrayidx10.i2709 = getelementptr inbounds i8, ptr %221, i64 %idxprom.i2708
  store ptr %arrayidx10.i2709, ptr %i_end29, align 8
  br label %if.end1512
...
do.end1530:                                       ; preds = %if.end1512, %do.body1497
  ...
  br i1 %cmp1494.not, label %sw.epilog, label %do.body1497

sw.default:                                       ; preds = %if.else504
  store i32 -124, ptr %error, align 4
  br label %cleanup1785
...
sw.epilog:                                        ; preds = %do.end1530, %do.end998, %do.end732, %do.body1488, %do.body956, %do.body691
  ...
  %225 = load i32, ptr %arrayidx1565, align 4
...
if.then1573:                                      ; preds = %sw.epilog
  ...
  %226 = load i32, ptr %window_size, align 8
...
vector.body3544:                                  ; preds = %vector.body3544, %vector.ph3533
  ...
  %wide.load3550 = load <16 x i8>, ptr %next.gep3548, align 1
  %234 = getelementptr i8, ptr %next.gep3548, i64 16
  %wide.load3551 = load <16 x i8>, ptr %234, align 1
  store <16 x i8> %wide.load3550, ptr %next.gep3546, align 1
  %235 = getelementptr i8, ptr %next.gep3546, i64 16
  store <16 x i8> %wide.load3551, ptr %235, align 1
  %index.next3552 = add nuw i64 %index3545, 32
  %236 = icmp eq i64 %index.next3552, %n.vec3535
  br i1 %236, label %middle.block3531, label %vector.body3544
...
while.body1592:                                   ; preds = %while.body1592.preheader3608, %while.body1592
  ...
  %237 = load i8, ptr %runsrc.03200, align 1
  %incdec.ptr1593 = getelementptr inbounds i8, ptr %rundest.03201, i64 1
  store i8 %237, ptr %rundest.03201, align 1
  %cmp1590 = icmp ugt i32 %j.03202, 1
  br i1 %cmp1590, label %while.body1592, label %if.end1595
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %next.gep3506, align 1
  %240 = getelementptr i8, ptr %next.gep3506, i64 16
  %wide.load3508 = load <16 x i8>, ptr %240, align 1
  store <16 x i8> %wide.load, ptr %next.gep, align 1
  %241 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load3508, ptr %241, align 1
  %index.next = add nuw i64 %index, 32
  %242 = icmp eq i64 %index.next, %n.vec
  br i1 %242, label %middle.block, label %vector.body
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load3527 = load <8 x i8>, ptr %next.gep3526, align 1
  store <8 x i8> %wide.load3527, ptr %next.gep3525, align 1
  %index.next3528 = add nuw i64 %index3524, 8
  %243 = icmp eq i64 %index.next3528, %n.vec3512
  br i1 %243, label %vec.epilog.middle.block, label %vec.epilog.vector.body
...
while.body1600:                                   ; preds = %while.body1600.preheader, %while.body1600
  ...
  %244 = load i8, ptr %runsrc.23205, align 1
  %incdec.ptr1602 = getelementptr inbounds i8, ptr %rundest.23206, i64 1
  store i8 %244, ptr %rundest.23206, align 1
  %cmp1598 = icmp ugt i32 %i.143207, 1
  br i1 %cmp1598, label %while.body1600, label %if.end1617
...
vector.body3566:                                  ; preds = %vector.body3566, %vector.ph3562
  ...
  %wide.load3572 = load <16 x i8>, ptr %next.gep3570, align 1
  %246 = getelementptr i8, ptr %next.gep3570, i64 16
  %wide.load3573 = load <16 x i8>, ptr %246, align 1
  store <16 x i8> %wide.load3572, ptr %next.gep3568, align 1
  %247 = getelementptr i8, ptr %next.gep3568, i64 16
  store <16 x i8> %wide.load3573, ptr %247, align 1
  %index.next3574 = add nuw i64 %index3567, 32
  %248 = icmp eq i64 %index.next3574, %n.vec3564
  br i1 %248, label %middle.block3555, label %vector.body3566
...
vec.epilog.vector.body3600:                       ; preds = %vec.epilog.vector.body3600, %vec.epilog.ph3582
  ...
  %wide.load3604 = load <8 x i8>, ptr %next.gep3603, align 1
  store <8 x i8> %wide.load3604, ptr %next.gep3602, align 1
  %index.next3605 = add nuw i64 %index3601, 8
  %249 = icmp eq i64 %index.next3605, %n.vec3587
  br i1 %249, label %vec.epilog.middle.block3579, label %vec.epilog.vector.body3600
...
while.body1611:                                   ; preds = %while.body1611.preheader, %while.body1611
  ...
  %250 = load i8, ptr %runsrc.33196, align 1
  %incdec.ptr1613 = getelementptr inbounds i8, ptr %rundest.33197, i64 1
  store i8 %250, ptr %rundest.33197, align 1
  %cmp1609 = icmp ugt i32 %i.153198, 1
  br i1 %cmp1609, label %while.body1611, label %if.end1617
...
if.end1617:                                       ; preds = %while.body1611, %while.body1600, %middle.block3555, %vec.epilog.middle.block3579, %middle.block, %vec.epilog.middle.block, %if.else1604, %if.end1595, %cleanup.thread
  ...
  br i1 %cmp125, label %do.body128, label %while.end1618
...
while.end1618:                                    ; preds = %if.end1617, %if.end108
  ...
  store ptr %arrayidx1620, ptr %o_end, align 8
...
while.end1618.if.end1752_crit_edge:               ; preds = %while.end1618
  %.pre3367 = load ptr, ptr %o_ptr, align 8
  br label %if.end1752
...
if.end1664:                                       ; preds = %cond.end.i2726
  %257 = load ptr, ptr %inbuf.i, align 8
  store ptr %257, ptr %i_ptr28, align 8
  %idxprom.i2732 = zext i32 %cond.i2727 to i64
  %arrayidx10.i2733 = getelementptr inbounds i8, ptr %257, i64 %idxprom.i2732
  store ptr %arrayidx10.i2733, ptr %i_end29, align 8
  br label %if.end1667
...
do.end1721:                                       ; preds = %do.cond1718
  store i8 0, ptr %header_read, align 2
  %261 = load i32, ptr %window_size, align 8
  %cmp1724 = icmp eq i32 %window_posn.1.lcssa, %261
  %.pre3366 = load ptr, ptr %o_end, align 8
  %.pre3368 = load ptr, ptr %o_ptr, align 8
...
if.then1726:                                      ; preds = %do.end1721
  ...
  %262 = load i8, ptr %wflag1733, align 8
...
land.lhs.true1736:                                ; preds = %if.then1726
  ...
  %263 = load i32, ptr %ofd1737, align 4
...
if.end1744:                                       ; preds = %land.lhs.true1736, %if.then1726
  ...
  store ptr %11, ptr %o_ptr, align 8
  store ptr %11, ptr %o_end, align 8
  br label %if.end1752
...
if.end1752:                                       ; preds = %while.end1618.if.end1752_crit_edge, %do.end1721, %if.end1744
  ...
  br i1 %cmp43, label %while.body, label %while.end1753
...
if.then1755:                                      ; preds = %while.end1753
  ...
  %266 = load i8, ptr %wflag1757, align 8
...
land.lhs.true1760:                                ; preds = %if.then1755
  ...
  %267 = load i32, ptr %ofd1761, align 4
...
land.lhs.true1760.if.end1768_crit_edge:           ; preds = %land.lhs.true1760
  %.pre3369 = load ptr, ptr %o_ptr, align 8
  br label %if.end1768
...
if.end1768:                                       ; preds = %land.lhs.true1760.if.end1768_crit_edge, %if.then1755
  ...
  store ptr %add.ptr1771, ptr %o_ptr, align 8
  br label %do.body1773

do.body1773:                                      ; preds = %while.end1753, %if.end1768
  store ptr %i_ptr.0.lcssa, ptr %i_ptr28, align 8
  store ptr %i_end.0.lcssa, ptr %i_end29, align 8
  store i32 %bit_buffer.0.lcssa, ptr %bit_buffer30, align 8
  store i8 %bits_left.0.lcssa, ptr %bits_left31, align 8
  store i32 %window_posn.0.lcssa, ptr %window_posn33, align 4
  store i32 %frame_start.0.lcssa, ptr %frame_start34, align 8
  store i16 %H.0.lcssa, ptr %H35, align 4
  store i16 %L.0.lcssa, ptr %L36, align 2
  store i16 %C.0.lcssa, ptr %C37, align 8
  br label %cleanup1785
...
entry:
  %0 = load i32, ptr %model, align 8
  %dec = add nsw i32 %0, -1
  store i32 %dec, ptr %model, align 8
...
do.body.us:                                       ; preds = %if.end.us, %do.body.us
  ...
  br i1 %niter.ncmp.3, label %do.end.us.unr-lcssa, label %do.body.us
...
do.body.us.epil:                                  ; preds = %do.end.us.unr-lcssa, %do.body.us.epil
  ...
  br i1 %epil.iter.cmp.not, label %do.end.us, label %do.body.us.epil
...
do.body24.us.prol:                                ; preds = %do.body24.us.preheader, %do.body24.us.prol
  ...
  store i16 %sym.0250.us, ptr %arrayidx26.us.prol, align 2
  ...
  br i1 %prol.iter.cmp.not, label %do.body24.us.prol.loopexit, label %do.body24.us.prol
...
do.body24.us:                                     ; preds = %do.body24.us.prol.loopexit, %do.body24.us
  ...
  store i16 %sym.0250.us, ptr %arrayidx26.us, align 2
  ...
  store i16 %sym.0250.us, ptr %arrayidx26.us.1, align 2
  ...
  store i16 %sym.0250.us, ptr %arrayidx26.us.2, align 2
...
for.cond2.for.end_crit_edge.us:                   ; preds = %for.inc.us
  ...
  %cmp.not.us = icmp ugt i32 %conv.us, %nbits
  br i1 %cmp.not.us, label %for.end36, label %for.cond2.preheader.us
...
do.body48:                                        ; preds = %do.body48.preheader, %do.body48
  ...
  br i1 %niter350.ncmp.3, label %do.end56.unr-lcssa, label %do.body48
...
do.body48.epil:                                   ; preds = %do.end56.unr-lcssa, %do.body48.epil
  ...
  br i1 %epil.iter346.cmp.not, label %do.end56, label %do.body48.epil
...
do.end56:                                         ; preds = %do.body48.epil, %do.end56.unr-lcssa
  ...
  br i1 %cmp44, label %do.body48.preheader, label %for.end61
...
for.body80.us285:                                 ; preds = %for.cond76.preheader.us, %for.inc142.us303
  ...
  %18 = load i8, ptr %arrayidx82.us289, align 1
...
do.body90.us293:                                  ; preds = %if.end88.us291, %do.body90.us293
  ...
  br i1 %niter362.ncmp.3, label %for.cond99.preheader.us308.unr-lcssa, label %do.body90.us293
...
for.inc142.us303:                                 ; preds = %for.cond99.preheader.us308, %for.body80.us285
  ...
  br i1 %cmp78.us307, label %for.body80.us285, label %for.cond76.for.end144_crit_edge.us
...
do.body90.us293.epil:                             ; preds = %for.cond99.preheader.us308.unr-lcssa, %do.body90.us293.epil
  ...
  br i1 %epil.iter358.cmp.not, label %for.cond99.preheader.us308, label %do.body90.us293.epil
...
for.cond99.preheader.us308:                       ; preds = %do.body90.us293.epil, %for.cond99.preheader.us308.unr-lcssa
  ...
  store i16 %sym.2268.us287, ptr %arrayidx136.us311, align 2
...
for.cond76.for.end144_crit_edge.us:               ; preds = %for.inc142.us.us, %for.inc142.us303
  ...
  br i1 %exitcond327.not, label %for.end148, label %for.cond76.preheader.us
...
for.body80.us.us:                                 ; preds = %for.cond76.preheader.us, %for.inc142.us.us
  ...
  %23 = load i8, ptr %arrayidx82.us.us, align 1
...
do.body90.us.us:                                  ; preds = %if.end88.us.us, %do.body90.us.us
  ...
  br i1 %niter356.ncmp.3, label %for.body104.us.us.preheader.unr-lcssa, label %do.body90.us.us
...
do.body90.us.us.epil:                             ; preds = %for.body104.us.us.preheader.unr-lcssa, %do.body90.us.us.epil
  ...
  br i1 %epil.iter352.cmp.not, label %for.body104.us.us.preheader, label %do.body90.us.us.epil
...
for.inc142.us.us:                                 ; preds = %for.cond99.for.end134_crit_edge.us.us, %for.body80.us.us
  ...
  br i1 %cmp78.us.us, label %for.body80.us.us, label %for.cond76.for.end144_crit_edge.us
...
for.body104.us.us:                                ; preds = %for.body104.us.us.preheader, %if.end123.us.us
  ...
  %27 = load i16, ptr %arrayidx106.us.us, align 2
...
if.then110.us.us:                                 ; preds = %for.body104.us.us
  ...
  store i16 -1, ptr %arrayidx114.us.us, align 2
  ...
  store i16 -1, ptr %arrayidx119.us.us, align 2
  %inc120.us.us = add i16 %next_sym.2265.us.us, 1
  store i16 %next_sym.2265.us.us, ptr %arrayidx106.us.us, align 2
  br label %if.end123.us.us
...
if.end123.us.us:                                  ; preds = %for.body104.us.us.if.end123.us.us_crit_edge, %if.then110.us.us
  ...
  br i1 %exitcond.not, label %for.cond99.for.end134_crit_edge.us.us, label %for.body104.us.us
...
for.cond99.for.end134_crit_edge.us.us:            ; preds = %if.end123.us.us
  ...
  store i16 %sym.2268.us.us, ptr %arrayidx136.us.us, align 2
...
!144 = distinct !{!144, !30}
!145 = distinct !{!145, !30}
!146 = distinct !{!146, !30, !55, !56}
!147 = distinct !{!147, !30, !55}
!148 = distinct !{!148, !30, !55, !56}
!149 = distinct !{!149, !30, !55, !56}
!150 = distinct !{!150, !30, !55}
!151 = distinct !{!151, !30, !55, !56}
!152 = distinct !{!152, !30, !55, !56}
!153 = distinct !{!153, !30, !55}
!154 = distinct !{!154, !30}
!155 = distinct !{!155, !30}
!156 = distinct !{!156, !30}
!157 = distinct !{!157, !30}
!158 = distinct !{!158, !30}
!159 = distinct !{!159, !30, !55, !56}
!160 = distinct !{!160, !43}
!161 = distinct !{!161, !30, !55}
!162 = distinct !{!162, !30}
!163 = distinct !{!163, !30}
!164 = distinct !{!164, !30, !55, !56}
!165 = distinct !{!165, !30, !55}
!166 = distinct !{!166, !30}
!167 = distinct !{!167, !30}
!168 = distinct !{!168, !30}
!169 = distinct !{!169, !30}
...
!174 = distinct !{!174, !30}
!175 = distinct !{!175, !43}
!176 = distinct !{!176, !30, !55}
!177 = distinct !{!177, !30}
!178 = distinct !{!178, !30, !55, !56}
!179 = distinct !{!179, !43}
!180 = distinct !{!180, !30, !55}
!181 = distinct !{!181, !30}
!182 = distinct !{!182, !30}
!183 = distinct !{!183, !30}
!184 = distinct !{!184, !30}
...
!186 = distinct !{!186, !30}
!187 = !{!188, !10, i64 16}
!188 = !{!"qtm_stream", !7, i64 0, !7, i64 4, !8, i64 8, !10, i64 16, !7, i64 24, !7, i64 28, !7, i64 32, !50, i64 36, !50, i64 38, !50, i64 40, !8, i64 42, !7, i64 44, !10, i64 48, !10, i64 56, !10, i64 64, !10, i64 72, !10, i64 80, !7, i64 88, !7, i64 92, !8, i64 96, !8, i64 100, !8, i64 268, !8, i64 310, !8, i64 337, !189, i64 368, !189, i64 384, !189, i64 400, !189, i64 416, !189, i64 432, !189, i64 448, !189, i64 464, !189, i64 480, !189, i64 496, !8, i64 512, !8, i64 772, !8, i64 1032, !8, i64 1292, !8, i64 1552, !8, i64 1652, !8, i64 1800, !8, i64 1972, !8, i64 2084, !10, i64 2120, !10, i64 2128}
!189 = !{!"qtm_model", !7, i64 0, !7, i64 4, !10, i64 8}
!190 = !{!188, !10, i64 48}
!191 = !{!188, !7, i64 0}
!192 = !{!188, !7, i64 4}
!193 = !{!188, !8, i64 8}
...
!208 = !{!189, !10, i64 8}
!209 = !{!210, !50, i64 0}
!210 = !{!"qtm_modelsym", !50, i64 0, !50, i64 2}
!211 = !{!210, !50, i64 2}
!212 = distinct !{!212, !30, !55, !56}
!213 = distinct !{!213, !30, !56, !55}
!214 = distinct !{!214, !30, !55, !56}
!215 = distinct !{!215, !30, !56, !55}
!216 = !{!188, !10, i64 2120}
!217 = !{!188, !10, i64 2128}
!218 = !{!188, !50, i64 36}
!219 = !{!188, !50, i64 38}
...
!249 = distinct !{!249, !30, !55}
!250 = distinct !{!250, !30, !55, !56}
!251 = distinct !{!251, !30, !55, !56}
!252 = distinct !{!252, !30, !55}
!253 = distinct !{!253, !30, !55, !56}
!254 = distinct !{!254, !30, !55, !56}
!255 = distinct !{!255, !30, !55}
!256 = distinct !{!256, !30}
!257 = distinct !{!257, !30}
!258 = distinct !{!258, !30}
!259 = distinct !{!259, !30}
