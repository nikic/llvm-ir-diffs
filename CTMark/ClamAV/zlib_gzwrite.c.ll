; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/zlib_gzwrite.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/zlib_gzwrite.c"
...
do.body.if.end20_crit_edge:                       ; preds = %do.body
  ...
  %.pre147 = load ptr, ptr %in25, align 8
  br label %if.end20

if.then18:                                        ; preds = %do.body
  %5 = load ptr, ptr %in25, align 8
...
do.body66:                                        ; preds = %do.cond89, %if.end63
  ...
  store i32 %spec.select141, ptr %avail_in, align 8
  %12 = load i64, ptr %pos77, align 8
...
do.cond89:                                        ; preds = %do.body66
  ...
  br i1 %tobool90.not, label %cleanup93, label %do.body66
...
if.then13.if.end16_crit_edge:                     ; preds = %if.then13
  ...
  %.pre63 = load ptr, ptr %in19.phi.trans.insert, align 8
  br label %if.end16

if.then15:                                        ; preds = %if.then13
  %in = getelementptr inbounds %struct.gz_state, ptr %file, i64 0, i32 6
  %6 = load ptr, ptr %in, align 8
  store ptr %6, ptr %strm1, align 8
  br label %if.end16
...
if.end10.peel:                                    ; preds = %if.end
  ...
  store i32 %cond.peel, ptr %avail_in, align 8
  %3 = load ptr, ptr %in, align 8
  store ptr %3, ptr %strm1, align 8
  %4 = load i64, ptr %pos, align 8
  %add.peel = add nsw i64 %4, %conv9.peel
  store i64 %add.peel, ptr %pos, align 8
...
while.cond:                                       ; preds = %if.end10
  ...
  br i1 %tobool2.not, label %cleanup, label %if.end10
...
if.end10:                                         ; preds = %while.cond.peel, %while.cond
  ...
  %.pre42 = load i64, ptr %pos, align 8
  store i32 %cond, ptr %avail_in, align 8
  store ptr %.pre, ptr %strm1, align 8
...
if.end18.if.end21_crit_edge:                      ; preds = %if.end18
  %.pre125 = load ptr, ptr %strm1, align 8
  br label %if.end21
...
if.end64:                                         ; preds = %if.then53
  ...
  %19 = load ptr, ptr %in22, align 8
  store ptr %19, ptr %strm1, align 8
...
if.end21.thread:                                  ; preds = %if.end
  ...
  store i32 %0, ptr %size59, align 8
  br label %cleanup
...
do.body.preheader:                                ; preds = %if.end
  ...
  %out = getelementptr inbounds %struct.gz_state, ptr %state, i64 0, i32 7
  %.pre158 = load i32, ptr %avail_out, align 8
...
while.end67.us:                                   ; preds = %if.end62.us
  %.pre159 = load i32, ptr %avail_out, align 8
...
if.end85.us:                                      ; preds = %if.end79.us
  ...
  br i1 %tobool88.not.us, label %do.end, label %do.body.us
...
if.end62.us:                                      ; preds = %while.body33.us
  ...
  store ptr %add.ptr66.us, ptr %next, align 8
  %15 = load ptr, ptr %next_out, align 8
  %cmp31.us = icmp ugt ptr %15, %add.ptr66.us
  br i1 %cmp31.us, label %while.body33.us, label %while.end67.us
...
if.end15:                                         ; preds = %while.body
  ...
  br i1 %tobool4.not, label %cleanup, label %while.body

do.body:                                          ; preds = %do.body.preheader, %if.end85
  %22 = phi i32 [ %36, %if.end85 ], [ %.pre158, %do.body.preheader ]
...
while.body33:                                     ; preds = %if.then29, %if.end62
  ...
  %27 = load i32, ptr %fd51, align 4
  %conv54 = and i64 %.sub.ptr.sub, 4294967295
  %call55 = tail call i64 @write(i32 noundef %27, ptr noundef %25, i64 noundef %conv54) #14
  %28 = and i64 %call55, 2147483648
  %cmp57.not = icmp eq i64 %28, 0
...
if.then59:                                        ; preds = %while.body33, %while.body33.us
  ...
  %call61 = tail call ptr @strerror(i32 noundef %29) #14
...
if.end62:                                         ; preds = %while.body33
  ...
  %add.ptr66 = getelementptr inbounds i8, ptr %30, i64 %idx.ext65
  store ptr %add.ptr66, ptr %next, align 8
  %31 = load ptr, ptr %next_out, align 8
  %cmp31 = icmp ugt ptr %31, %add.ptr66
  br i1 %cmp31, label %while.body33, label %while.end67.loopexit

while.end67.loopexit:                             ; preds = %if.end62
  %.pre157 = load i32, ptr %avail_out, align 8
  br label %while.end67

while.end67:                                      ; preds = %while.end67.loopexit, %if.then29
  %32 = phi i32 [ %.pre157, %while.end67.loopexit ], [ %22, %if.then29 ]
...
if.end79:                                         ; preds = %do.body, %while.end67, %if.then71
  %35 = phi i32 [ %22, %do.body ], [ %32, %while.end67 ], [ %33, %if.then71 ]
...
if.end85:                                         ; preds = %if.end79
  %36 = load i32, ptr %avail_out, align 8
  %tobool88.not = icmp eq i32 %35, %36
  br i1 %tobool88.not, label %do.end, label %do.body
...
if.end29:                                         ; preds = %if.end27, %if.end18
  ...
  store i32 %strategy, ptr %strategy31, align 4
  br label %cleanup
