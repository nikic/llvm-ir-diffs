; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_nsis_bzlib.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_nsis_bzlib.c"
...
if.end10:                                         ; preds = %entry
  ...
  %0 = load ptr, ptr %bzalloc, align 8
  %cmp11 = icmp eq ptr %0, null
  br i1 %cmp11, label %if.then12, label %if.end14

if.then12:                                        ; preds = %if.end10
  store ptr @default_bzalloc, ptr %bzalloc, align 8
  br label %if.end14
...
if.end14:                                         ; preds = %if.then12, %if.end10
  ...
  %2 = load ptr, ptr %bzfree, align 8
  %cmp15 = icmp eq ptr %2, null
  br i1 %cmp15, label %if.then16, label %if.end18

if.then16:                                        ; preds = %if.end14
  store ptr @default_bzfree, ptr %bzfree, align 8
  br label %if.end18
...
if.end23:                                         ; preds = %if.end18
  ...
  store i32 %verbosity, ptr %verbosity26, align 4
  br label %cleanup
...
entry:
  ...
  %pos.i383 = ptrtoint ptr %pos.i to i64
  %cmp = icmp eq ptr %strm, null
...
while.cond.preheader:                             ; preds = %if.end3
  ...
  %.pre = load i32, ptr %state8, align 8
  %scevgep = getelementptr i8, ptr %0, i64 3724
  %scevgep310 = getelementptr i8, ptr %0, i64 3724
  %3 = add i64 %1, 3724
  %4 = add i64 %1, 3724
  ...
  %invariant.gep590 = getelementptr i8, ptr %pos.i, i64 -15
  %invariant.gep592 = getelementptr i8, ptr %pos.i, i64 -7
  %invariant.gep594 = getelementptr i8, ptr %pos.i, i64 -7
  %invariant.gep596 = getelementptr i8, ptr %0, i64 -15
  %invariant.gep598 = getelementptr i8, ptr %0, i64 -15
  %invariant.gep600 = getelementptr i8, ptr %0, i64 -7
  %invariant.gep602 = getelementptr i8, ptr %0, i64 -7
...
while.cond.outer:                                 ; preds = %cleanup, %while.cond.preheader
  %.ph525 = phi i32 [ 2, %cleanup ], [ %.pre, %while.cond.preheader ]
  %cmp29 = icmp sgt i32 %.ph525, 9
  br label %while.cond

while.cond:                                       ; preds = %while.cond.outer, %if.end27
  switch i32 %.ph525, label %if.end27 [
    i32 1, label %cleanup40
    i32 2, label %if.then14
  ]

if.then14:                                        ; preds = %while.cond
  %276 = load i8, ptr %smallDecompress, align 4
...
if.then15:                                        ; preds = %if.then14
  ...
  %278 = load i32, ptr %avail_out336338.i, align 8
...
if.end.lr.ph.lr.ph.i:                             ; preds = %if.then15
  %.pre.pre.i = load i32, ptr %state_out_len.i, align 8
  br label %if.end.i.outer

if.end.i.outer:                                   ; preds = %if.end.lr.ph.lr.ph.i, %if.end20.i
  %.ph521 = phi ptr [ %277, %if.end.lr.ph.lr.ph.i ], [ %283, %if.end20.i ]
  %.ph522 = phi i32 [ %.pre.pre.i, %if.end.lr.ph.lr.ph.i ], [ %dec.i, %if.end20.i ]
  %avail_out336.i = getelementptr inbounds %struct.nsis_bzstream, ptr %.ph521, i64 0, i32 5
  br label %if.end.i

if.end.i:                                         ; preds = %if.end.i.outer, %while.cond.backedge.i
  %279 = phi i32 [ 1, %while.cond.backedge.i ], [ %.ph522, %if.end.i.outer ]
  %cmp3.i = icmp eq i32 %279, 0
  br i1 %cmp3.i, label %while.end.i, label %if.end5.i

if.end5.i:                                        ; preds = %if.end.i
  %280 = load i8, ptr %state_out_ch.i, align 4
  %next_out.i = getelementptr inbounds %struct.nsis_bzstream, ptr %.ph521, i64 0, i32 4
  %281 = load ptr, ptr %next_out.i, align 8
  store i8 %280, ptr %281, align 1
  %282 = load i32, ptr %state_out_len.i, align 8
  %dec.i = add nsw i32 %282, -1
  store i32 %dec.i, ptr %state_out_len.i, align 8
  %283 = load ptr, ptr %0, align 8
  %next_out9.i = getelementptr inbounds %struct.nsis_bzstream, ptr %283, i64 0, i32 4
  %284 = load ptr, ptr %next_out9.i, align 8
  %incdec.ptr.i = getelementptr inbounds i8, ptr %284, i64 1
  store ptr %incdec.ptr.i, ptr %next_out9.i, align 8
  %avail_out11.i = getelementptr inbounds %struct.nsis_bzstream, ptr %283, i64 0, i32 5
  %285 = load i32, ptr %avail_out11.i, align 8
  %dec12.i = add i32 %285, -1
  store i32 %dec12.i, ptr %avail_out11.i, align 8
  %total_out_lo32.i = getelementptr inbounds %struct.nsis_bzstream, ptr %283, i64 0, i32 6
  %286 = load i32, ptr %total_out_lo32.i, align 4
  %inc.i = add i32 %286, 1
  store i32 %inc.i, ptr %total_out_lo32.i, align 4
...
if.then17.i:                                      ; preds = %if.end5.i
  ...
  %287 = load i32, ptr %total_out_hi32.i, align 8
  %inc19.i = add i32 %287, 1
  store i32 %inc19.i, ptr %total_out_hi32.i, align 8
  br label %if.end20.i
...
while.end.i:                                      ; preds = %if.end.i
  %288 = load i32, ptr %nblock_used.i, align 4
  %289 = load i32, ptr %save_nblock.i, align 8
...
if.end29.i:                                       ; preds = %if.end23.i
  store i32 1, ptr %state_out_len.i, align 8
  %290 = load i32, ptr %k0.i, align 8
  %conv.i = trunc i32 %290 to i8
  store i8 %conv.i, ptr %state_out_ch.i, align 4
  %291 = load i32, ptr %tPos.i, align 4
...
do.body.i.i:                                      ; preds = %do.body.i.i, %if.end29.i
  ...
  %292 = load i32, ptr %arrayidx.i.i, align 4
...
indexIntoF.exit.i:                                ; preds = %do.body.i.i
  ...
  store i32 %or.i, ptr %tPos.i, align 4
  %inc45.i = add nsw i32 %288, 1
  store i32 %inc45.i, ptr %nblock_used.i, align 4
...
if.then57.i:                                      ; preds = %if.end52.i
  store i32 %conv53.i, ptr %k0.i, align 8
...
while.cond.backedge.i:                            ; preds = %indexIntoF.exit334.i, %if.then141.i, %indexIntoF.exit308.i, %if.then99.i, %indexIntoF.exit295.i, %if.then57.i, %indexIntoF.exit.i
  %297 = load i32, ptr %avail_out336.i, align 8
  %cmp337.i = icmp eq i32 %297, 0
  br i1 %cmp337.i, label %if.end20, label %if.end.i

if.end60.i:                                       ; preds = %if.end52.i
  store i32 2, ptr %state_out_len.i, align 8
  br label %do.body.i283.i

do.body.i283.i:                                   ; preds = %do.body.i283.i, %if.end60.i
  %na.0.i284.i = phi i32 [ 256, %if.end60.i ], [ %shr.na.0.i291.i, %do.body.i283.i ]
  %nb.0.i285.i = phi i32 [ 0, %if.end60.i ], [ %nb.0.shr.i292.i, %do.body.i283.i ]
  %add.i286.i = add nsw i32 %nb.0.i285.i, %na.0.i284.i
  %shr.i287.i = ashr i32 %add.i286.i, 1
  %idxprom.i288.i = sext i32 %shr.i287.i to i64
  %arrayidx.i289.i = getelementptr inbounds i32, ptr %cftab.i, i64 %idxprom.i288.i
  %298 = load i32, ptr %arrayidx.i289.i, align 4
  %cmp.not.i290.i = icmp sgt i32 %298, %or.i
  %shr.na.0.i291.i = select i1 %cmp.not.i290.i, i32 %shr.i287.i, i32 %na.0.i284.i
  %nb.0.shr.i292.i = select i1 %cmp.not.i290.i, i32 %nb.0.i285.i, i32 %shr.i287.i
  %sub.i293.i = sub nsw i32 %shr.na.0.i291.i, %nb.0.shr.i292.i
  %cmp1.not.i294.i = icmp eq i32 %sub.i293.i, 1
  br i1 %cmp1.not.i294.i, label %indexIntoF.exit295.i, label %do.body.i283.i

indexIntoF.exit295.i:                             ; preds = %do.body.i283.i
  %idxprom69.i = zext i32 %or.i to i64
  %arrayidx70.i = getelementptr inbounds i16, ptr %293, i64 %idxprom69.i
  %299 = load i16, ptr %arrayidx70.i, align 2
  ...
  %300 = load i8, ptr %arrayidx76.i, align 1
  ...
  store i32 %or84.i, ptr %tPos.i, align 4
  %inc87.i = add nsw i32 %288, 2
  store i32 %inc87.i, ptr %nblock_used.i, align 4
...
if.end94.i:                                       ; preds = %indexIntoF.exit295.i
  %conv95.i = and i32 %nb.0.shr.i292.i, 255
  %cmp97.not.i = icmp eq i32 %conv95.i, %290
  br i1 %cmp97.not.i, label %if.end102.i, label %if.then99.i

if.then99.i:                                      ; preds = %if.end94.i
  store i32 %conv95.i, ptr %k0.i, align 8
  br label %while.cond.backedge.i

if.end102.i:                                      ; preds = %if.end94.i
  store i32 3, ptr %state_out_len.i, align 8
  br label %do.body.i296.i

do.body.i296.i:                                   ; preds = %do.body.i296.i, %if.end102.i
  %na.0.i297.i = phi i32 [ 256, %if.end102.i ], [ %shr.na.0.i304.i, %do.body.i296.i ]
  %nb.0.i298.i = phi i32 [ 0, %if.end102.i ], [ %nb.0.shr.i305.i, %do.body.i296.i ]
  %add.i299.i = add nsw i32 %nb.0.i298.i, %na.0.i297.i
  %shr.i300.i = ashr i32 %add.i299.i, 1
  %idxprom.i301.i = sext i32 %shr.i300.i to i64
  %arrayidx.i302.i = getelementptr inbounds i32, ptr %cftab.i, i64 %idxprom.i301.i
  %301 = load i32, ptr %arrayidx.i302.i, align 4
  %cmp.not.i303.i = icmp sgt i32 %301, %or84.i
  %shr.na.0.i304.i = select i1 %cmp.not.i303.i, i32 %shr.i300.i, i32 %na.0.i297.i
  %nb.0.shr.i305.i = select i1 %cmp.not.i303.i, i32 %nb.0.i298.i, i32 %shr.i300.i
  %sub.i306.i = sub nsw i32 %shr.na.0.i304.i, %nb.0.shr.i305.i
  %cmp1.not.i307.i = icmp eq i32 %sub.i306.i, 1
  br i1 %cmp1.not.i307.i, label %indexIntoF.exit308.i, label %do.body.i296.i

indexIntoF.exit308.i:                             ; preds = %do.body.i296.i
  %idxprom111.i = zext i32 %or84.i to i64
  %arrayidx112.i = getelementptr inbounds i16, ptr %293, i64 %idxprom111.i
  %302 = load i16, ptr %arrayidx112.i, align 2
  ...
  %303 = load i8, ptr %arrayidx118.i, align 1
  ...
  store i32 %or126.i, ptr %tPos.i, align 4
  %inc129.i = add nsw i32 %288, 3
  store i32 %inc129.i, ptr %nblock_used.i, align 4
...
if.end136.i:                                      ; preds = %indexIntoF.exit308.i
  %conv137.i = and i32 %nb.0.shr.i305.i, 255
  %cmp139.not.i = icmp eq i32 %conv137.i, %290
  br i1 %cmp139.not.i, label %do.body.i309.i, label %if.then141.i

if.then141.i:                                     ; preds = %if.end136.i
  store i32 %conv137.i, ptr %k0.i, align 8
  br label %while.cond.backedge.i

do.body.i309.i:                                   ; preds = %if.end136.i, %do.body.i309.i
  %na.0.i310.i = phi i32 [ %shr.na.0.i317.i, %do.body.i309.i ], [ 256, %if.end136.i ]
  %nb.0.i311.i = phi i32 [ %nb.0.shr.i318.i, %do.body.i309.i ], [ 0, %if.end136.i ]
  %add.i312.i = add nsw i32 %nb.0.i311.i, %na.0.i310.i
  %shr.i313.i = ashr i32 %add.i312.i, 1
  %idxprom.i314.i = sext i32 %shr.i313.i to i64
  %arrayidx.i315.i = getelementptr inbounds i32, ptr %cftab.i, i64 %idxprom.i314.i
  %304 = load i32, ptr %arrayidx.i315.i, align 4
  %cmp.not.i316.i = icmp sgt i32 %304, %or126.i
  %shr.na.0.i317.i = select i1 %cmp.not.i316.i, i32 %shr.i313.i, i32 %na.0.i310.i
  %nb.0.shr.i318.i = select i1 %cmp.not.i316.i, i32 %nb.0.i311.i, i32 %shr.i313.i
  %sub.i319.i = sub nsw i32 %shr.na.0.i317.i, %nb.0.shr.i318.i
  %cmp1.not.i320.i = icmp eq i32 %sub.i319.i, 1
  br i1 %cmp1.not.i320.i, label %indexIntoF.exit321.i, label %do.body.i309.i

indexIntoF.exit321.i:                             ; preds = %do.body.i309.i
  %idxprom152.i = zext i32 %or126.i to i64
  %arrayidx153.i = getelementptr inbounds i16, ptr %293, i64 %idxprom152.i
  %305 = load i16, ptr %arrayidx153.i, align 2
  ...
  %306 = load i8, ptr %arrayidx159.i, align 1
  ...
  store i32 %or167.i, ptr %tPos.i, align 4
  %inc170.i = add nsw i32 %288, 4
  store i32 %inc170.i, ptr %nblock_used.i, align 4
  %conv171.i = and i32 %nb.0.shr.i318.i, 255
  %add172.i = add nuw nsw i32 %conv171.i, 4
  store i32 %add172.i, ptr %state_out_len.i, align 8
  br label %do.body.i322.i

do.body.i322.i:                                   ; preds = %do.body.i322.i, %indexIntoF.exit321.i
  %na.0.i323.i = phi i32 [ 256, %indexIntoF.exit321.i ], [ %shr.na.0.i330.i, %do.body.i322.i ]
  %nb.0.i324.i = phi i32 [ 0, %indexIntoF.exit321.i ], [ %nb.0.shr.i331.i, %do.body.i322.i ]
  %add.i325.i = add nsw i32 %nb.0.i324.i, %na.0.i323.i
  %shr.i326.i = ashr i32 %add.i325.i, 1
  %idxprom.i327.i = sext i32 %shr.i326.i to i64
  %arrayidx.i328.i = getelementptr inbounds i32, ptr %cftab.i, i64 %idxprom.i327.i
  %307 = load i32, ptr %arrayidx.i328.i, align 4
  %cmp.not.i329.i = icmp sgt i32 %307, %or167.i
  %shr.na.0.i330.i = select i1 %cmp.not.i329.i, i32 %shr.i326.i, i32 %na.0.i323.i
  %nb.0.shr.i331.i = select i1 %cmp.not.i329.i, i32 %nb.0.i324.i, i32 %shr.i326.i
  %sub.i332.i = sub nsw i32 %shr.na.0.i330.i, %nb.0.shr.i331.i
  %cmp1.not.i333.i = icmp eq i32 %sub.i332.i, 1
  br i1 %cmp1.not.i333.i, label %indexIntoF.exit334.i, label %do.body.i322.i

indexIntoF.exit334.i:                             ; preds = %do.body.i322.i
  store i32 %nb.0.shr.i331.i, ptr %k0.i, align 8
  %idxprom181.i = zext i32 %or167.i to i64
  %arrayidx182.i = getelementptr inbounds i16, ptr %293, i64 %idxprom181.i
  %308 = load i16, ptr %arrayidx182.i, align 2
  ...
  %309 = load i8, ptr %arrayidx188.i, align 1
  ...
  store i32 %or196.i, ptr %tPos.i, align 4
  %inc199.i = add nsw i32 %288, 5
  store i32 %inc199.i, ptr %nblock_used.i, align 4
  br label %while.cond.backedge.i

if.else:                                          ; preds = %if.then14
  %310 = load i32, ptr %calculatedBlockCRC.i, align 8
  %311 = load i8, ptr %state_out_ch.i, align 4
  %312 = load i32, ptr %state_out_len.i, align 8
  %313 = load i32, ptr %nblock_used.i, align 4
  %314 = load i32, ptr %k0.i, align 8
  %315 = load ptr, ptr %tt.i, align 8
  %316 = load i32, ptr %tPos.i, align 4
  %317 = load ptr, ptr %0, align 8
  %next_out.i65 = getelementptr inbounds %struct.nsis_bzstream, ptr %317, i64 0, i32 4
  %318 = load ptr, ptr %next_out.i65, align 8
  %avail_out.i = getelementptr inbounds %struct.nsis_bzstream, ptr %317, i64 0, i32 5
  %319 = load i32, ptr %avail_out.i, align 8
  %320 = load i32, ptr %save_nblock.i, align 8
...
while.cond.i:                                     ; preds = %while.cond.i.backedge, %if.else
  ...
  %c_state_out_ch.0.i = phi i8 [ %311, %if.else ], [ %conv.i70, %while.cond.i.backedge ]
...
while.cond2.preheader.i:                          ; preds = %while.cond.i
  ...
  br i1 %cmp4247.i, label %return_notr.i, label %if.end.i82.preheader

if.end.i82.preheader:                             ; preds = %while.cond2.preheader.i
  %321 = add i32 %cs_avail_out.0.i.fr, -1
  %322 = add i32 %c_state_out_len.0.i, -1
  %323 = call i32 @llvm.umin.i32(i32 %321, i32 %322)
  %min.iters.check464 = icmp ult i32 %323, 32
  br i1 %min.iters.check464, label %if.end.i82.preheader480, label %vector.ph465

vector.ph465:                                     ; preds = %if.end.i82.preheader
  %umin = zext i32 %323 to i64
  %324 = add nuw nsw i64 %umin, 1
  %n.mod.vf466 = and i64 %324, 31
  %325 = icmp eq i64 %n.mod.vf466, 0
  %326 = select i1 %325, i64 32, i64 %n.mod.vf466
  %n.vec467 = sub nsw i64 %324, %326
  %.cast = trunc i64 %n.vec467 to i32
  %ind.end468 = sub i32 %cs_avail_out.0.i.fr, %.cast
  %ind.end470 = getelementptr i8, ptr %cs_next_out.0.i, i64 %n.vec467
  %.cast472 = trunc i64 %n.vec467 to i32
  %ind.end473 = sub i32 %c_state_out_len.0.i, %.cast472
  %broadcast.splatinsert = insertelement <16 x i8> poison, i8 %c_state_out_ch.0.i, i64 0
  %broadcast.splat = shufflevector <16 x i8> %broadcast.splatinsert, <16 x i8> poison, <16 x i32> zeroinitializer
  br label %vector.body475

vector.body475:                                   ; preds = %vector.body475, %vector.ph465
  %index476 = phi i64 [ 0, %vector.ph465 ], [ %index.next478, %vector.body475 ]
  %next.gep = getelementptr i8, ptr %cs_next_out.0.i, i64 %index476
  store <16 x i8> %broadcast.splat, ptr %next.gep, align 1
  %327 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %broadcast.splat, ptr %327, align 1
  %index.next478 = add nuw i64 %index476, 32
  %328 = icmp eq i64 %index.next478, %n.vec467
  br i1 %328, label %if.end.i82.preheader480, label %vector.body475

if.end.i82.preheader480:                          ; preds = %vector.body475, %if.end.i82.preheader
  %cs_avail_out.1250.i.ph = phi i32 [ %cs_avail_out.0.i.fr, %if.end.i82.preheader ], [ %ind.end468, %vector.body475 ]
  %cs_next_out.1249.i.ph = phi ptr [ %cs_next_out.0.i, %if.end.i82.preheader ], [ %ind.end470, %vector.body475 ]
  %c_state_out_len.1248.i.ph = phi i32 [ %c_state_out_len.0.i, %if.end.i82.preheader ], [ %ind.end473, %vector.body475 ]
  br label %if.end.i82

if.end.i82:                                       ; preds = %if.end.i82.preheader480, %if.end8.i
  %cs_avail_out.1250.i = phi i32 [ %dec9.i, %if.end8.i ], [ %cs_avail_out.1250.i.ph, %if.end.i82.preheader480 ]
  %cs_next_out.1249.i = phi ptr [ %incdec.ptr.i84, %if.end8.i ], [ %cs_next_out.1249.i.ph, %if.end.i82.preheader480 ]
  %c_state_out_len.1248.i = phi i32 [ %dec.i83, %if.end8.i ], [ %c_state_out_len.1248.i.ph, %if.end.i82.preheader480 ]
...
if.end8.i:                                        ; preds = %if.end.i82
  store i8 %c_state_out_ch.0.i, ptr %cs_next_out.1249.i, align 1
  %dec.i83 = add nsw i32 %c_state_out_len.1248.i, -1
  %incdec.ptr.i84 = getelementptr inbounds i8, ptr %cs_next_out.1249.i, i64 1
  %dec9.i = add i32 %cs_avail_out.1250.i, -1
  %cmp4.i = icmp eq i32 %dec9.i, 0
  br i1 %cmp4.i, label %return_notr.i, label %if.end.i82

s_state_out_len_eq_one.i:                         ; preds = %if.end.i82, %if.end32.i, %if.end25.i
  %c_nblock_used.1.i = phi i32 [ %inc.i74, %if.end32.i ], [ %inc.i74, %if.end25.i ], [ %c_nblock_used.0.i, %if.end.i82 ]
  %c_k0.1.i = phi i32 [ %c_k0.2.i, %if.end32.i ], [ %conv27.i, %if.end25.i ], [ %c_k0.0.i, %if.end.i82 ]
  %c_tPos.1.i = phi i32 [ %shr.i73, %if.end32.i ], [ %shr.i73, %if.end25.i ], [ %c_tPos.0.i, %if.end.i82 ]
  %cs_next_out.2.i = phi ptr [ %cs_next_out.3.i, %if.end32.i ], [ %cs_next_out.3.i, %if.end25.i ], [ %cs_next_out.1249.i, %if.end.i82 ]
  %cs_avail_out.2.i = phi i32 [ %cs_avail_out.3.i, %if.end32.i ], [ %cs_avail_out.3.i, %if.end25.i ], [ %cs_avail_out.1250.i, %if.end.i82 ]
  %c_state_out_ch.1.i = phi i8 [ %conv.i70, %if.end32.i ], [ %conv.i70, %if.end25.i ], [ %c_state_out_ch.0.i, %if.end.i82 ]
...
if.end12.i:                                       ; preds = %s_state_out_len_eq_one.i
  store i8 %c_state_out_ch.1.i, ptr %cs_next_out.2.i, align 1
...
if.end15.i:                                       ; preds = %if.end12.i, %while.cond.i
  ...
  %cmp16.i69 = icmp sgt i32 %c_nblock_used.2.i, %add.i67
  br i1 %cmp16.i69, label %cleanup40, label %if.end18.i
...
if.end21.i:                                       ; preds = %if.end18.i
  %conv.i70 = trunc i32 %c_k0.2.i to i8
  %329 = load i32, ptr %blockSize100k.i, align 8
...
if.end25.i:                                       ; preds = %if.end21.i
  %idxprom.i71 = zext i32 %c_tPos.2.i to i64
  %arrayidx.i72 = getelementptr inbounds i32, ptr %315, i64 %idxprom.i71
  %330 = load i32, ptr %arrayidx.i72, align 4
  %shr.i73 = lshr i32 %330, 8
  %inc.i74 = add nsw i32 %c_nblock_used.2.i, 1
...
if.end36.i:                                       ; preds = %if.end32.i
  %cmp39.not.i = icmp ult i32 %shr.i73, %mul.i
  br i1 %cmp39.not.i, label %if.end42.i, label %cleanup40

if.end42.i:                                       ; preds = %if.end36.i
  %idxprom43.i = zext i32 %shr.i73 to i64
  %arrayidx44.i = getelementptr inbounds i32, ptr %315, i64 %idxprom43.i
  %331 = load i32, ptr %arrayidx44.i, align 4
  %shr47.i = lshr i32 %331, 8
  %inc48.i = add nsw i32 %c_nblock_used.2.i, 2
  %cmp49.i77 = icmp eq i32 %inc48.i, %add.i67
  br i1 %cmp49.i77, label %while.cond.i.backedge, label %if.end52.i78

if.end52.i78:                                     ; preds = %if.end42.i
...
if.end64.i:                                       ; preds = %if.end58.i
  ...
  %332 = load i32, ptr %arrayidx66.i, align 4
...
if.end86.i:                                       ; preds = %if.end80.i
  ...
  %333 = load i32, ptr %arrayidx88.i, align 4
...
if.end100.i:                                      ; preds = %if.end86.i
  ...
  %334 = load i32, ptr %arrayidx102.i, align 4
  %conv105.i = and i32 %334, 255
  %shr106.i = lshr i32 %334, 8
  %inc107.i = add nsw i32 %c_nblock_used.2.i, 5
  br label %while.cond.i.backedge

while.cond.i.backedge:                            ; preds = %if.end100.i, %if.end74.i, %if.end64.i, %if.end52.i78, %if.end42.i
  %c_nblock_used.0.i.be = phi i32 [ %add.i67, %if.end42.i ], [ %add.i67, %if.end64.i ], [ %inc107.i, %if.end100.i ], [ %inc48.i, %if.end52.i78 ], [ %inc70.i, %if.end74.i ]
  %c_k0.0.i.be = phi i32 [ %c_k0.2.i, %if.end42.i ], [ %c_k0.2.i, %if.end64.i ], [ %conv105.i, %if.end100.i ], [ %conv53.i79, %if.end52.i78 ], [ %conv75.i, %if.end74.i ]
  %c_state_out_len.0.i.be = phi i32 [ 2, %if.end42.i ], [ 3, %if.end64.i ], [ %add94.i, %if.end100.i ], [ 2, %if.end52.i78 ], [ 3, %if.end74.i ]
  %c_tPos.0.i.be = phi i32 [ %shr47.i, %if.end42.i ], [ %shr69.i, %if.end64.i ], [ %shr106.i, %if.end100.i ], [ %shr47.i, %if.end52.i78 ], [ %shr69.i, %if.end74.i ]
  br label %while.cond.i
...
return_notr.i:                                    ; preds = %if.end18.i, %s_state_out_len_eq_one.i, %while.cond2.preheader.i, %if.end8.i
  ...
  %c_state_out_len.2.i = phi i32 [ %dec.i83, %if.end8.i ], [ 1, %s_state_out_len_eq_one.i ], [ 0, %if.end18.i ], [ %c_state_out_len.0.i, %while.cond2.preheader.i ]
  ...
  %cs_next_out.4.i = phi ptr [ %incdec.ptr.i84, %if.end8.i ], [ %cs_next_out.2.i, %s_state_out_len_eq_one.i ], [ %cs_next_out.3.i, %if.end18.i ], [ %cs_next_out.0.i, %while.cond2.preheader.i ]
  ...
  %total_out_lo32.i75 = getelementptr inbounds %struct.nsis_bzstream, ptr %335, i64 0, i32 6
  %336 = load i32, ptr %total_out_lo32.i75, align 4
  %sub.i = sub i32 %319, %cs_avail_out.4.i
  %add111.i = add i32 %336, %sub.i
  store i32 %add111.i, ptr %total_out_lo32.i75, align 4
  %cmp114.i = icmp ult i32 %add111.i, %336
  br i1 %cmp114.i, label %if.then116.i, label %338

if.then116.i:                                     ; preds = %return_notr.i
  %total_out_hi32.i76 = getelementptr inbounds %struct.nsis_bzstream, ptr %335, i64 0, i32 7
  %337 = load i32, ptr %total_out_hi32.i76, align 8
  %inc118.i = add i32 %337, 1
  store i32 %inc118.i, ptr %total_out_hi32.i76, align 8
  br label %338

338:                                              ; preds = %if.then116.i, %return_notr.i
  store i32 %310, ptr %calculatedBlockCRC.i, align 8
  store i8 %c_state_out_ch.3.i, ptr %state_out_ch.i, align 4
  store i32 %c_state_out_len.2.i, ptr %state_out_len.i, align 8
  store i32 %c_nblock_used.3.i, ptr %nblock_used.i, align 4
  store i32 %c_k0.3.i, ptr %k0.i, align 8
  store ptr %315, ptr %tt.i, align 8
  store i32 %c_tPos.3.i, ptr %tPos.i, align 4
  %next_out128.i = getelementptr inbounds %struct.nsis_bzstream, ptr %335, i64 0, i32 4
  store ptr %cs_next_out.4.i, ptr %next_out128.i, align 8
  %avail_out130.i = getelementptr inbounds %struct.nsis_bzstream, ptr %335, i64 0, i32 5
  store i32 %cs_avail_out.4.i, ptr %avail_out130.i, align 8
  br label %if.end20

if.end20:                                         ; preds = %while.end.i, %while.cond.backedge.i, %if.end20.i, %if.then15, %338
  %339 = load i32, ptr %nblock_used.i, align 4
  %340 = load i32, ptr %save_nblock.i, align 8
  %add = add nsw i32 %340, 1
  %cmp21 = icmp eq i32 %339, %add
  br i1 %cmp21, label %land.lhs.true, label %cleanup40

land.lhs.true:                                    ; preds = %if.end20
  %341 = load i32, ptr %state_out_len.i, align 8
  %cmp22 = icmp eq i32 %341, 0
  br i1 %cmp22, label %if.then30.thread, label %cleanup40

if.then30.thread:                                 ; preds = %land.lhs.true
  store i32 14, ptr %state8, align 8
  br label %if.end.i86
...
if.then30:                                        ; preds = %if.end27
  %cmp.i85 = icmp eq i32 %.ph525, 10
  br i1 %cmp.i85, label %if.end.thread.i, label %if.then30.if.end.i86_crit_edge

if.then30.if.end.i86_crit_edge:                   ; preds = %if.then30
  %.pre3404.i.pre = load i32, ptr %save_nblock.i, align 8
  br label %if.end.i86
...
if.end.thread.i:                                  ; preds = %if.then30
  ...
  store i32 9, ptr %blockSize100k.i, align 8
  %343 = load i8, ptr %smallDecompress, align 4
  %tobool.not.i = icmp eq i8 %343, 0
  %bzalloc47.i = getelementptr inbounds %struct.nsis_bzstream, ptr %342, i64 0, i32 9
  %344 = load ptr, ptr %bzalloc47.i, align 8
  %opaque48.i = getelementptr inbounds %struct.nsis_bzstream, ptr %342, i64 0, i32 11
  %345 = load ptr, ptr %opaque48.i, align 8
  br i1 %tobool.not.i, label %if.else.i, label %if.then27.i

if.end.i86:                                       ; preds = %if.then30.if.end.i86_crit_edge, %if.then30.thread
  %.pre3404.i = phi i32 [ %340, %if.then30.thread ], [ %.pre3404.i.pre, %if.then30.if.end.i86_crit_edge ]
  %346 = phi i32 [ 14, %if.then30.thread ], [ %.ph525, %if.then30.if.end.i86_crit_edge ]
  %.pre.i87 = load i32, ptr %save_i.i124, align 4
  %.pre3394.i = load i32, ptr %save_j3.phi.trans.insert.i, align 8
  %.pre3395.i = load i32, ptr %save_t4.phi.trans.insert.i, align 4
  %.pre3396.i = load i32, ptr %save_alphaSize5.phi.trans.insert.i, align 8
  %.pre3397.i = load i32, ptr %save_nGroups6.phi.trans.insert.i, align 4
  %.pre3398.i = load i32, ptr %save_nSelectors7.phi.trans.insert.i, align 8
  %.pre3399.i = load i32, ptr %save_EOB8.phi.trans.insert.i, align 4
  %.pre3400.i = load i32, ptr %save_groupNo9.phi.trans.insert.i, align 8
  %.pre3401.i = load i32, ptr %save_groupPos10.phi.trans.insert.i, align 4
  %.pre3402.i = load i32, ptr %save_nextSym11.phi.trans.insert.i, align 8
  %.pre3403.i = load i32, ptr %save_nblockMAX12.phi.trans.insert.i, align 4
  %.pre3405.i = load i32, ptr %save_es14.phi.trans.insert.i, align 4
  %.pre3406.i = load i32, ptr %save_N15.phi.trans.insert.i, align 8
  %.pre3407.i = load i32, ptr %save_curr16.phi.trans.insert.i, align 4
  %.pre3408.i = load i32, ptr %save_zt17.phi.trans.insert.i, align 8
  %.pre3409.i = load i32, ptr %save_zn18.phi.trans.insert.i, align 4
  %.pre3410.i = load i32, ptr %save_zvec19.phi.trans.insert.i, align 8
  %.pre3411.i = load i32, ptr %save_zj20.phi.trans.insert.i, align 4
  %.pre3412.i = load i32, ptr %save_gSel21.phi.trans.insert.i, align 8
  %.pre3413.i = load i32, ptr %save_gMinlen22.phi.trans.insert.i, align 4
  %.pre3414.i = load ptr, ptr %save_gLimit23.phi.trans.insert.i, align 8
  %.pre3415.i = load ptr, ptr %save_gBase24.phi.trans.insert.i, align 8
  %.pre3416.i = load ptr, ptr %save_gPerm25.phi.trans.insert.i, align 8
...
if.end.sw.bb803_crit_edge.i:                      ; preds = %if.end.i86
  %bsLive807.promoted.pre.i = load i32, ptr %bsLive1264.phi.trans.insert.i, align 4
  br label %sw.bb803.i

if.end.sw.bb1067_crit_edge.i:                     ; preds = %if.end.i86
  %bsLive1071.promoted.pre.i = load i32, ptr %bsLive1264.phi.trans.insert.i, align 4
  br label %sw.bb1067.i

if.end.sw.bb1260_crit_edge.i:                     ; preds = %if.end.i86
  %bsLive1264.promoted.pre.i = load i32, ptr %bsLive1264.phi.trans.insert.i, align 4
  br label %sw.bb1260.i

if.end.sw.bb1676_crit_edge.i:                     ; preds = %if.end.i86
  %bsLive1680.promoted.pre.i = load i32, ptr %bsLive1264.phi.trans.insert.i, align 4
  br label %sw.bb1676.i

if.end.sw.bb509_crit_edge.i:                      ; preds = %if.end.i86
  %bsLive513.promoted.pre.i = load i32, ptr %bsLive1264.phi.trans.insert.i, align 4
  br label %sw.bb509.i

if.end.sw.bb220_crit_edge.i:                      ; preds = %if.end.i86
  %bsLive224.promoted.pre.i = load i32, ptr %bsLive1264.phi.trans.insert.i, align 4
  br label %sw.bb220.i

if.end.sw.bb163_crit_edge.i:                      ; preds = %if.end.i86
  %bsLive167.promoted.pre.i = load i32, ptr %bsLive1264.phi.trans.insert.i, align 4
  br label %sw.bb163.i

if.end.sw.bb106_crit_edge.i:                      ; preds = %if.end.i86
  %bsLive110.promoted.pre.i = load i32, ptr %bsLive1264.phi.trans.insert.i, align 4
  br label %sw.bb106.i

if.then27.i:                                      ; preds = %if.end.thread.i
  %call.i = tail call ptr %344(ptr noundef %345, i32 noundef 1800000, i32 noundef 1) #7
  store ptr %call.i, ptr %ll16.i, align 8
  %347 = load ptr, ptr %bzalloc47.i, align 8
  %348 = load ptr, ptr %opaque48.i, align 8
  %349 = load i32, ptr %blockSize100k.i, align 8
  %mul34.i = mul nsw i32 %349, 100000
  %shr.i117 = ashr exact i32 %mul34.i, 1
  %call38.i = tail call ptr %347(ptr noundef %348, i32 noundef %shr.i117, i32 noundef 1) #7
  store ptr %call38.i, ptr %ll4.i, align 8
  %350 = load ptr, ptr %ll16.i, align 8
...
if.else.i:                                        ; preds = %if.end.thread.i
  ...
  store ptr %call54.i, ptr %tt.i, align 8
  %cmp56.i = icmp eq ptr %call54.i, null
  br i1 %cmp56.i, label %BZ2_decompress.exit, label %sw.bb61.i

sw.bb61.i:                                        ; preds = %if.else.i, %if.then27.i, %if.end.i86
  %351 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre.i87, %if.end.i86 ]
  %352 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre3394.i, %if.end.i86 ]
  %353 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre3395.i, %if.end.i86 ]
  %354 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre3396.i, %if.end.i86 ]
  %355 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre3397.i, %if.end.i86 ]
  %356 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre3398.i, %if.end.i86 ]
  %357 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre3399.i, %if.end.i86 ]
  %358 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre3400.i, %if.end.i86 ]
  %359 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre3401.i, %if.end.i86 ]
  %360 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre3402.i, %if.end.i86 ]
  %361 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre3403.i, %if.end.i86 ]
  %362 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre3404.i, %if.end.i86 ]
  %363 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre3405.i, %if.end.i86 ]
  %364 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre3406.i, %if.end.i86 ]
  %365 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre3407.i, %if.end.i86 ]
  %366 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre3408.i, %if.end.i86 ]
  %367 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre3409.i, %if.end.i86 ]
  %368 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre3410.i, %if.end.i86 ]
  %369 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre3411.i, %if.end.i86 ]
  %370 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre3412.i, %if.end.i86 ]
  %371 = phi i32 [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %.pre3413.i, %if.end.i86 ]
  %372 = phi ptr [ null, %if.then27.i ], [ null, %if.else.i ], [ %.pre3414.i, %if.end.i86 ]
  %373 = phi ptr [ null, %if.then27.i ], [ null, %if.else.i ], [ %.pre3415.i, %if.end.i86 ]
  %374 = phi ptr [ null, %if.then27.i ], [ null, %if.else.i ], [ %.pre3416.i, %if.end.i86 ]
  store i32 14, ptr %state8, align 8
  %bsLive.promoted.i = load i32, ptr %bsLive1264.phi.trans.insert.i, align 4
...
sw.bb61.if.then65_crit_edge.i:                    ; preds = %sw.bb61.i
  %.pre3417.i = load i32, ptr %bsBuff77.i, align 8
...
if.end71.lr.ph.i:                                 ; preds = %sw.bb61.i
  ...
  %avail_in.promoted.i = load i32, ptr %avail_in.i, align 8
  br label %if.end71.i

if.then65.i:                                      ; preds = %if.end95.i, %sw.bb61.if.then65_crit_edge.i
  %376 = phi i32 [ %.pre3417.i, %sw.bb61.if.then65_crit_edge.i ], [ %or.i110, %if.end95.i ]
  %.lcssa3072.i = phi i32 [ %bsLive.promoted.i, %sw.bb61.if.then65_crit_edge.i ], [ %add82.i, %if.end95.i ]
  %sub.i114 = add nsw i32 %.lcssa3072.i, -8
  %shr67.i = lshr i32 %376, %sub.i114
  store i32 %sub.i114, ptr %bsLive1264.phi.trans.insert.i, align 4
...
if.end71.i:                                       ; preds = %if.end95.i, %if.end71.lr.ph.i
  %dec3079.i = phi i32 [ %avail_in.promoted.i, %if.end71.lr.ph.i ], [ %dec.i112, %if.end95.i ]
...
if.end76.i:                                       ; preds = %if.end71.i
  %377 = load i32, ptr %bsBuff77.i, align 8
  %shl.i109 = shl i32 %377, 8
  %378 = load ptr, ptr %375, align 8
  %379 = load i8, ptr %378, align 1
  %conv79.i = zext i8 %379 to i32
  %or.i110 = or i32 %shl.i109, %conv79.i
  store i32 %or.i110, ptr %bsBuff77.i, align 8
  %add82.i = add nsw i32 %add8230753077.i, 8
  store i32 %add82.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %incdec.ptr.i111 = getelementptr inbounds i8, ptr %378, i64 1
  store ptr %incdec.ptr.i111, ptr %375, align 8
  %dec.i112 = add i32 %dec3079.i, -1
  store i32 %dec.i112, ptr %avail_in.i, align 8
  %380 = load i32, ptr %total_in_lo32.i, align 4
  %inc.i113 = add i32 %380, 1
  store i32 %inc.i113, ptr %total_in_lo32.i, align 4
  %cmp90.i = icmp eq i32 %inc.i113, 0
  br i1 %cmp90.i, label %if.then92.i, label %if.end95.i

if.then92.i:                                      ; preds = %if.end76.i
  %381 = load i32, ptr %total_in_hi32.i, align 8
  %inc94.i = add i32 %381, 1
  store i32 %inc94.i, ptr %total_in_hi32.i, align 8
  br label %if.end95.i
...
if.end105.i:                                      ; preds = %if.then65.i
  store i32 0, ptr %origPtr.i, align 8
  br label %sw.bb106.i
...
sw.bb106.i:                                       ; preds = %if.end105.i, %if.end.sw.bb106_crit_edge.i
  ...
  %bsLive110.promoted.i = phi i32 [ %bsLive110.promoted.pre.i, %if.end.sw.bb106_crit_edge.i ], [ %sub.i114, %if.end105.i ]
  store i32 25, ptr %state8, align 8
...
sw.bb106.if.then113_crit_edge.i:                  ; preds = %sw.bb106.i
  %.pre3419.i = load i32, ptr %bsBuff77.i, align 8
...
if.end123.lr.ph.i:                                ; preds = %sw.bb106.i
  ...
  %avail_in125.promoted.i = load i32, ptr %avail_in125.i, align 8
...
if.then113.i:                                     ; preds = %if.end156.i, %sw.bb106.if.then113_crit_edge.i
  ...
  store i32 %sub117.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %408 = load i32, ptr %origPtr.i, align 8
  %shl159.i = shl i32 %408, 8
  %conv160.i108 = and i32 %shr118.i, 255
  %or161.i = or i32 %shl159.i, %conv160.i108
  store i32 %or161.i, ptr %origPtr.i, align 8
  br label %sw.bb163.i
...
if.end129.i:                                      ; preds = %if.end123.i
  %409 = load i32, ptr %bsBuff77.i, align 8
  %shl131.i = shl i32 %409, 8
  %410 = load ptr, ptr %406, align 8
  %411 = load i8, ptr %410, align 1
  %conv134.i = zext i8 %411 to i32
  %or135.i = or i32 %shl131.i, %conv134.i
  store i32 %or135.i, ptr %bsBuff77.i, align 8
  %add138.i = add nsw i32 %add13830803082.i, 8
  store i32 %add138.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %incdec.ptr141.i = getelementptr inbounds i8, ptr %410, i64 1
  store ptr %incdec.ptr141.i, ptr %406, align 8
  %dec144.i = add i32 %dec1443085.i, -1
  store i32 %dec144.i, ptr %avail_in125.i, align 8
  %412 = load i32, ptr %total_in_lo32146.i, align 4
  %inc147.i = add i32 %412, 1
  store i32 %inc147.i, ptr %total_in_lo32146.i, align 4
  %cmp150.i = icmp eq i32 %inc147.i, 0
  br i1 %cmp150.i, label %if.then152.i, label %if.end156.i

if.then152.i:                                     ; preds = %if.end129.i
  %413 = load i32, ptr %total_in_hi32154.i, align 8
  %inc155.i = add i32 %413, 1
  store i32 %inc155.i, ptr %total_in_hi32154.i, align 8
...
sw.bb163.i:                                       ; preds = %if.then113.i, %if.end.sw.bb163_crit_edge.i
  ...
  store i32 26, ptr %state8, align 8
...
sw.bb163.if.then170_crit_edge.i:                  ; preds = %sw.bb163.i
  %.pre3421.i = load i32, ptr %bsBuff77.i, align 8
...
if.end180.lr.ph.i:                                ; preds = %sw.bb163.i
  ...
  %avail_in182.promoted.i = load i32, ptr %avail_in182.i, align 8
...
if.then170.i:                                     ; preds = %if.end213.i, %sw.bb163.if.then170_crit_edge.i
  ...
  store i32 %sub174.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %440 = load i32, ptr %origPtr.i, align 8
  %shl216.i = shl i32 %440, 8
  %conv217.i = and i32 %shr175.i, 255
  %or218.i = or i32 %shl216.i, %conv217.i
  store i32 %or218.i, ptr %origPtr.i, align 8
  br label %sw.bb220.i
...
if.end186.i:                                      ; preds = %if.end180.i
  %441 = load i32, ptr %bsBuff77.i, align 8
  %shl188.i = shl i32 %441, 8
  %442 = load ptr, ptr %438, align 8
  %443 = load i8, ptr %442, align 1
  %conv191.i = zext i8 %443 to i32
  %or192.i = or i32 %shl188.i, %conv191.i
  store i32 %or192.i, ptr %bsBuff77.i, align 8
  %add195.i = add nsw i32 %add19530863088.i, 8
  store i32 %add195.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %incdec.ptr198.i = getelementptr inbounds i8, ptr %442, i64 1
  store ptr %incdec.ptr198.i, ptr %438, align 8
  %dec201.i = add i32 %dec2013091.i, -1
  store i32 %dec201.i, ptr %avail_in182.i, align 8
  %444 = load i32, ptr %total_in_lo32203.i, align 4
  %inc204.i = add i32 %444, 1
  store i32 %inc204.i, ptr %total_in_lo32203.i, align 4
  %cmp207.i = icmp eq i32 %inc204.i, 0
  br i1 %cmp207.i, label %if.then209.i, label %if.end213.i

if.then209.i:                                     ; preds = %if.end186.i
  %445 = load i32, ptr %total_in_hi32211.i, align 8
  %inc212.i = add i32 %445, 1
  store i32 %inc212.i, ptr %total_in_hi32211.i, align 8
...
sw.bb220.i:                                       ; preds = %if.then170.i, %if.end.sw.bb220_crit_edge.i
  ...
  store i32 27, ptr %state8, align 8
...
sw.bb220.if.then227_crit_edge.i:                  ; preds = %sw.bb220.i
  %.pre3423.i = load i32, ptr %bsBuff77.i, align 8
...
if.end237.lr.ph.i:                                ; preds = %sw.bb220.i
  ...
  %avail_in239.promoted.i = load i32, ptr %avail_in239.i, align 8
...
if.then227.i:                                     ; preds = %if.end270.i, %sw.bb220.if.then227_crit_edge.i
  ...
  store i32 %sub231.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %472 = load i32, ptr %origPtr.i, align 8
  %shl273.i = shl i32 %472, 8
  %conv274.i = and i32 %shr232.i, 255
  %or275.i = or i32 %shl273.i, %conv274.i
  store i32 %or275.i, ptr %origPtr.i, align 8
...
if.end243.i:                                      ; preds = %if.end237.i
  %473 = load i32, ptr %bsBuff77.i, align 8
  %shl245.i = shl i32 %473, 8
  %474 = load ptr, ptr %470, align 8
  %475 = load i8, ptr %474, align 1
  %conv248.i = zext i8 %475 to i32
  %or249.i = or i32 %shl245.i, %conv248.i
  store i32 %or249.i, ptr %bsBuff77.i, align 8
  %add252.i = add nsw i32 %add25230923094.i, 8
  store i32 %add252.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %incdec.ptr255.i = getelementptr inbounds i8, ptr %474, i64 1
  store ptr %incdec.ptr255.i, ptr %470, align 8
  %dec258.i = add i32 %dec2583097.i, -1
  store i32 %dec258.i, ptr %avail_in239.i, align 8
  %476 = load i32, ptr %total_in_lo32260.i, align 4
  %inc261.i = add i32 %476, 1
  store i32 %inc261.i, ptr %total_in_lo32260.i, align 4
  %cmp264.i = icmp eq i32 %inc261.i, 0
  br i1 %cmp264.i, label %if.then266.i, label %if.end270.i

if.then266.i:                                     ; preds = %if.end243.i
  %477 = load i32, ptr %total_in_hi32268.i, align 8
  %inc269.i = add i32 %477, 1
  store i32 %inc269.i, ptr %total_in_hi32268.i, align 8
...
if.end281.i:                                      ; preds = %if.then227.i
  %478 = load i32, ptr %blockSize100k.i, align 8
...
for.body357.preheader.i:                          ; preds = %for.cond.i
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(256) %scevgep.i, i8 0, i64 256, i1 false)
  br label %for.cond363.i

sw.bb292.i:                                       ; preds = %for.cond.i, %if.end.i86
  %502 = phi i32 [ %.pre3394.i, %if.end.i86 ], [ %479, %for.cond.i ]
  %503 = phi i32 [ %.pre3395.i, %if.end.i86 ], [ %480, %for.cond.i ]
  %504 = phi i32 [ %.pre3396.i, %if.end.i86 ], [ %481, %for.cond.i ]
  %505 = phi i32 [ %.pre3397.i, %if.end.i86 ], [ %482, %for.cond.i ]
  %506 = phi i32 [ %.pre3398.i, %if.end.i86 ], [ %483, %for.cond.i ]
  %507 = phi i32 [ %.pre3399.i, %if.end.i86 ], [ %484, %for.cond.i ]
  %508 = phi i32 [ %.pre3400.i, %if.end.i86 ], [ %485, %for.cond.i ]
  %509 = phi i32 [ %.pre3401.i, %if.end.i86 ], [ %486, %for.cond.i ]
  %510 = phi i32 [ %.pre3402.i, %if.end.i86 ], [ %487, %for.cond.i ]
  %511 = phi i32 [ %.pre3403.i, %if.end.i86 ], [ %488, %for.cond.i ]
  %512 = phi i32 [ %.pre3404.i, %if.end.i86 ], [ %489, %for.cond.i ]
  %513 = phi i32 [ %.pre3405.i, %if.end.i86 ], [ %490, %for.cond.i ]
  %514 = phi i32 [ %.pre3406.i, %if.end.i86 ], [ %491, %for.cond.i ]
  %515 = phi i32 [ %.pre3407.i, %if.end.i86 ], [ %492, %for.cond.i ]
  %516 = phi i32 [ %.pre3408.i, %if.end.i86 ], [ %493, %for.cond.i ]
  %517 = phi i32 [ %.pre3409.i, %if.end.i86 ], [ %494, %for.cond.i ]
  %518 = phi i32 [ %.pre3410.i, %if.end.i86 ], [ %495, %for.cond.i ]
  %519 = phi i32 [ %.pre3411.i, %if.end.i86 ], [ %496, %for.cond.i ]
  %520 = phi i32 [ %.pre3412.i, %if.end.i86 ], [ %497, %for.cond.i ]
  %521 = phi i32 [ %.pre3413.i, %if.end.i86 ], [ %498, %for.cond.i ]
  %522 = phi ptr [ %.pre3414.i, %if.end.i86 ], [ %499, %for.cond.i ]
  %523 = phi ptr [ %.pre3415.i, %if.end.i86 ], [ %500, %for.cond.i ]
  %524 = phi ptr [ %.pre3416.i, %if.end.i86 ], [ %501, %for.cond.i ]
  %i.1.i = phi i32 [ %.pre.i87, %if.end.i86 ], [ %i.0.i, %for.cond.i ]
  store i32 28, ptr %state8, align 8
  %bsLive296.promoted.i = load i32, ptr %bsLive1264.phi.trans.insert.i, align 4
...
sw.bb292.if.then299_crit_edge.i:                  ; preds = %sw.bb292.i
  %.pre3450.i = load i32, ptr %bsBuff77.i, align 8
...
if.end309.lr.ph.i:                                ; preds = %sw.bb292.i
  ...
  %avail_in311.promoted.i = load i32, ptr %avail_in311.i, align 8
...
if.then299.i:                                     ; preds = %if.end342.i, %sw.bb292.if.then299_crit_edge.i
  ...
  store i32 %sub303.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  ...
  store i8 %..i, ptr %arrayidx351.i, align 1
...
if.end315.i:                                      ; preds = %if.end309.i
  %529 = load i32, ptr %bsBuff77.i, align 8
  %shl317.i = shl i32 %529, 8
  %530 = load ptr, ptr %525, align 8
  %531 = load i8, ptr %530, align 1
  %conv320.i = zext i8 %531 to i32
  %or321.i = or i32 %shl317.i, %conv320.i
  store i32 %or321.i, ptr %bsBuff77.i, align 8
  %add324.i = add nsw i32 %add32432313233.i, 8
  store i32 %add324.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %incdec.ptr327.i = getelementptr inbounds i8, ptr %530, i64 1
  store ptr %incdec.ptr327.i, ptr %525, align 8
  %dec330.i = add i32 %dec3303236.i, -1
  store i32 %dec330.i, ptr %avail_in311.i, align 8
  %532 = load i32, ptr %total_in_lo32332.i, align 4
  %inc333.i = add i32 %532, 1
  store i32 %inc333.i, ptr %total_in_lo32332.i, align 4
  %cmp336.i = icmp eq i32 %inc333.i, 0
  br i1 %cmp336.i, label %if.then338.i, label %if.end342.i

if.then338.i:                                     ; preds = %if.end315.i
  %533 = load i32, ptr %total_in_hi32340.i, align 8
  %inc341.i = add i32 %533, 1
  store i32 %inc341.i, ptr %total_in_hi32340.i, align 8
...
for.body366.i:                                    ; preds = %for.cond363.i
  ...
  %556 = load i8, ptr %arrayidx369.i, align 1
...
sw.bb376.i:                                       ; preds = %for.cond372.i, %if.end.i86
  %579 = phi i32 [ %.pre3395.i, %if.end.i86 ], [ %557, %for.cond372.i ]
  %580 = phi i32 [ %.pre3396.i, %if.end.i86 ], [ %558, %for.cond372.i ]
  %581 = phi i32 [ %.pre3397.i, %if.end.i86 ], [ %559, %for.cond372.i ]
  %582 = phi i32 [ %.pre3398.i, %if.end.i86 ], [ %560, %for.cond372.i ]
  %583 = phi i32 [ %.pre3399.i, %if.end.i86 ], [ %561, %for.cond372.i ]
  %584 = phi i32 [ %.pre3400.i, %if.end.i86 ], [ %562, %for.cond372.i ]
  %585 = phi i32 [ %.pre3401.i, %if.end.i86 ], [ %563, %for.cond372.i ]
  %586 = phi i32 [ %.pre3402.i, %if.end.i86 ], [ %564, %for.cond372.i ]
  %587 = phi i32 [ %.pre3403.i, %if.end.i86 ], [ %565, %for.cond372.i ]
  %588 = phi i32 [ %.pre3404.i, %if.end.i86 ], [ %566, %for.cond372.i ]
  %589 = phi i32 [ %.pre3405.i, %if.end.i86 ], [ %567, %for.cond372.i ]
  %590 = phi i32 [ %.pre3406.i, %if.end.i86 ], [ %568, %for.cond372.i ]
  %591 = phi i32 [ %.pre3407.i, %if.end.i86 ], [ %569, %for.cond372.i ]
  %592 = phi i32 [ %.pre3408.i, %if.end.i86 ], [ %570, %for.cond372.i ]
  %593 = phi i32 [ %.pre3409.i, %if.end.i86 ], [ %571, %for.cond372.i ]
  %594 = phi i32 [ %.pre3410.i, %if.end.i86 ], [ %572, %for.cond372.i ]
  %595 = phi i32 [ %.pre3411.i, %if.end.i86 ], [ %573, %for.cond372.i ]
  %596 = phi i32 [ %.pre3412.i, %if.end.i86 ], [ %574, %for.cond372.i ]
  %597 = phi i32 [ %.pre3413.i, %if.end.i86 ], [ %575, %for.cond372.i ]
  %598 = phi ptr [ %.pre3414.i, %if.end.i86 ], [ %576, %for.cond372.i ]
  %599 = phi ptr [ %.pre3415.i, %if.end.i86 ], [ %577, %for.cond372.i ]
  %600 = phi ptr [ %.pre3416.i, %if.end.i86 ], [ %578, %for.cond372.i ]
  %j.2.i = phi i32 [ %.pre3394.i, %if.end.i86 ], [ %j.1.i, %for.cond372.i ]
  %i.5.i = phi i32 [ %.pre.i87, %if.end.i86 ], [ %i.4.i, %for.cond372.i ]
  store i32 29, ptr %state8, align 8
  %bsLive380.promoted.i = load i32, ptr %bsLive1264.phi.trans.insert.i, align 4
...
sw.bb376.if.then383_crit_edge.i:                  ; preds = %sw.bb376.i
  %.pre3449.i = load i32, ptr %bsBuff77.i, align 8
...
if.end393.lr.ph.i:                                ; preds = %sw.bb376.i
  ...
  %avail_in395.promoted.i = load i32, ptr %avail_in395.i, align 8
...
if.then383.i:                                     ; preds = %if.end426.i, %sw.bb376.if.then383_crit_edge.i
  ...
  store i32 %sub387.i, ptr %bsLive1264.phi.trans.insert.i, align 4
...
if.end399.i:                                      ; preds = %if.end393.i
  %605 = load i32, ptr %bsBuff77.i, align 8
  %shl401.i = shl i32 %605, 8
  %606 = load ptr, ptr %601, align 8
  %607 = load i8, ptr %606, align 1
  %conv404.i = zext i8 %607 to i32
  %or405.i = or i32 %shl401.i, %conv404.i
  store i32 %or405.i, ptr %bsBuff77.i, align 8
  %add408.i = add nsw i32 %add40832253227.i, 8
  store i32 %add408.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %incdec.ptr411.i = getelementptr inbounds i8, ptr %606, i64 1
  store ptr %incdec.ptr411.i, ptr %601, align 8
  %dec414.i = add i32 %dec4143230.i, -1
  store i32 %dec414.i, ptr %avail_in395.i, align 8
  %608 = load i32, ptr %total_in_lo32416.i, align 4
  %inc417.i = add i32 %608, 1
  store i32 %inc417.i, ptr %total_in_lo32416.i, align 4
  %cmp420.i = icmp eq i32 %inc417.i, 0
  br i1 %cmp420.i, label %if.then422.i, label %if.end426.i

if.then422.i:                                     ; preds = %if.end399.i
  %609 = load i32, ptr %total_in_hi32424.i, align 8
  %inc425.i = add i32 %609, 1
  store i32 %inc425.i, ptr %total_in_hi32424.i, align 8
...
if.then431.i:                                     ; preds = %if.then383.i
  ...
  store i8 1, ptr %arrayidx436.i, align 1
...
for.end444.i:                                     ; preds = %for.cond363.i
  store i32 0, ptr %nInUse.i.i, align 8
...
for.body.i.i:                                     ; preds = %for.inc.i.i.1, %for.end444.i
  ...
  %arrayidx.i.i107 = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 28, i64 %indvars.iv.i.i
  %633 = load i8, ptr %arrayidx.i.i107, align 1
...
if.then.i.i:                                      ; preds = %for.body.i.i
  ...
  %634 = load i32, ptr %nInUse.i.i, align 8
  %inc.i.i = add nsw i32 %634, 1
  store i32 %inc.i.i, ptr %nInUse.i.i, align 8
  br label %for.inc.i.i

for.inc.i.i:                                      ; preds = %if.then.i.i, %for.body.i.i
  %635 = phi i32 [ %632, %for.body.i.i ], [ %inc.i.i, %if.then.i.i ]
  %indvars.iv.next.i.i = or i64 %indvars.iv.i.i, 1
  %arrayidx.i.i107.1 = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 28, i64 %indvars.iv.next.i.i
  %636 = load i8, ptr %arrayidx.i.i107.1, align 1
...
if.then.i.i.1:                                    ; preds = %for.inc.i.i
  ...
  store i8 %conv.i.i.1, ptr %arrayidx3.i.i.1, align 1
  %637 = load i32, ptr %nInUse.i.i, align 8
  %inc.i.i.1 = add nsw i32 %637, 1
  store i32 %inc.i.i.1, ptr %nInUse.i.i, align 8
...
for.inc.i.i.1:                                    ; preds = %if.then.i.i.1, %for.inc.i.i
  ...
  br i1 %exitcond.not.i.i.1, label %makeMaps_d.exit.i, label %for.body.i.i
...
sw.bb451.i:                                       ; preds = %if.end448.i, %if.end.i86
  %639 = phi i32 [ %.pre3395.i, %if.end.i86 ], [ %534, %if.end448.i ]
  %640 = phi i32 [ %.pre3397.i, %if.end.i86 ], [ %536, %if.end448.i ]
  %641 = phi i32 [ %.pre3398.i, %if.end.i86 ], [ %537, %if.end448.i ]
  %642 = phi i32 [ %.pre3399.i, %if.end.i86 ], [ %538, %if.end448.i ]
  %643 = phi i32 [ %.pre3400.i, %if.end.i86 ], [ %539, %if.end448.i ]
  %644 = phi i32 [ %.pre3401.i, %if.end.i86 ], [ %540, %if.end448.i ]
  %645 = phi i32 [ %.pre3402.i, %if.end.i86 ], [ %541, %if.end448.i ]
  %646 = phi i32 [ %.pre3403.i, %if.end.i86 ], [ %542, %if.end448.i ]
  %647 = phi i32 [ %.pre3404.i, %if.end.i86 ], [ %543, %if.end448.i ]
  %648 = phi i32 [ %.pre3405.i, %if.end.i86 ], [ %544, %if.end448.i ]
  %649 = phi i32 [ %.pre3406.i, %if.end.i86 ], [ %545, %if.end448.i ]
  %650 = phi i32 [ %.pre3407.i, %if.end.i86 ], [ %546, %if.end448.i ]
  %651 = phi i32 [ %.pre3408.i, %if.end.i86 ], [ %547, %if.end448.i ]
  %652 = phi i32 [ %.pre3409.i, %if.end.i86 ], [ %548, %if.end448.i ]
  %653 = phi i32 [ %.pre3410.i, %if.end.i86 ], [ %549, %if.end448.i ]
  %654 = phi i32 [ %.pre3411.i, %if.end.i86 ], [ %550, %if.end448.i ]
  %655 = phi i32 [ %.pre3412.i, %if.end.i86 ], [ %551, %if.end448.i ]
  %656 = phi i32 [ %.pre3413.i, %if.end.i86 ], [ %552, %if.end448.i ]
  %657 = phi ptr [ %.pre3414.i, %if.end.i86 ], [ %553, %if.end448.i ]
  %658 = phi ptr [ %.pre3415.i, %if.end.i86 ], [ %554, %if.end448.i ]
  %659 = phi ptr [ %.pre3416.i, %if.end.i86 ], [ %555, %if.end448.i ]
  %alphaSize.0.i = phi i32 [ %.pre3396.i, %if.end.i86 ], [ %add450.i, %if.end448.i ]
  %j.4.i = phi i32 [ %.pre3394.i, %if.end.i86 ], [ %j.0.i, %if.end448.i ]
  %i.7.i = phi i32 [ %.pre.i87, %if.end.i86 ], [ %i.3.i, %if.end448.i ]
  store i32 30, ptr %state8, align 8
  %bsLive455.promoted.i = load i32, ptr %bsLive1264.phi.trans.insert.i, align 4
...
sw.bb451.if.then458_crit_edge.i:                  ; preds = %sw.bb451.i
  %.pre3424.i = load i32, ptr %bsBuff77.i, align 8
...
if.end467.lr.ph.i:                                ; preds = %sw.bb451.i
  ...
  %avail_in469.promoted.i = load i32, ptr %avail_in469.i, align 8
...
if.then458.i:                                     ; preds = %if.end500.i, %sw.bb451.if.then458_crit_edge.i
  ...
  store i32 %sub462.i, ptr %bsLive1264.phi.trans.insert.i, align 4
...
if.end473.i:                                      ; preds = %if.end467.i
  %662 = load i32, ptr %bsBuff77.i, align 8
  %shl475.i = shl i32 %662, 8
  %663 = load ptr, ptr %660, align 8
  %664 = load i8, ptr %663, align 1
  %conv478.i = zext i8 %664 to i32
  %or479.i = or i32 %shl475.i, %conv478.i
  store i32 %or479.i, ptr %bsBuff77.i, align 8
  %add482.i = add nsw i32 %add48230993101.i, 8
  store i32 %add482.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %incdec.ptr485.i = getelementptr inbounds i8, ptr %663, i64 1
  store ptr %incdec.ptr485.i, ptr %660, align 8
  %dec488.i = add i32 %dec4883104.i, -1
  store i32 %dec488.i, ptr %avail_in469.i, align 8
  %665 = load i32, ptr %total_in_lo32490.i, align 4
  %inc491.i = add i32 %665, 1
  store i32 %inc491.i, ptr %total_in_lo32490.i, align 4
  %cmp494.i = icmp eq i32 %inc491.i, 0
  br i1 %cmp494.i, label %if.then496.i, label %if.end500.i

if.then496.i:                                     ; preds = %if.end473.i
  %666 = load i32, ptr %total_in_hi32498.i, align 8
  %inc499.i = add i32 %666, 1
  store i32 %inc499.i, ptr %total_in_hi32498.i, align 8
...
sw.bb509.i:                                       ; preds = %if.then458.i, %if.end.sw.bb509_crit_edge.i
  ...
  store i32 31, ptr %state8, align 8
...
sw.bb509.if.then516_crit_edge.i:                  ; preds = %sw.bb509.i
  %.pre3426.i = load i32, ptr %bsBuff77.i, align 8
...
if.end525.lr.ph.i:                                ; preds = %sw.bb509.i
  ...
  %avail_in527.promoted.i = load i32, ptr %avail_in527.i, align 8
...
if.then516.i:                                     ; preds = %if.end558.i, %sw.bb509.if.then516_crit_edge.i
  ...
  store i32 %sub520.i, ptr %bsLive1264.phi.trans.insert.i, align 4
...
if.end531.i:                                      ; preds = %if.end525.i
  %689 = load i32, ptr %bsBuff77.i, align 8
  %shl533.i = shl i32 %689, 8
  %690 = load ptr, ptr %687, align 8
  %691 = load i8, ptr %690, align 1
  %conv536.i = zext i8 %691 to i32
  %or537.i = or i32 %shl533.i, %conv536.i
  store i32 %or537.i, ptr %bsBuff77.i, align 8
  %add540.i = add nsw i32 %add54031053107.i, 8
  store i32 %add540.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %incdec.ptr543.i = getelementptr inbounds i8, ptr %690, i64 1
  store ptr %incdec.ptr543.i, ptr %687, align 8
  %dec546.i = add i32 %dec5463110.i, -1
  store i32 %dec546.i, ptr %avail_in527.i, align 8
  %692 = load i32, ptr %total_in_lo32548.i, align 4
  %inc549.i = add i32 %692, 1
  store i32 %inc549.i, ptr %total_in_lo32548.i, align 4
  %cmp552.i = icmp eq i32 %inc549.i, 0
  br i1 %cmp552.i, label %if.then554.i, label %if.end558.i

if.then554.i:                                     ; preds = %if.end531.i
  %693 = load i32, ptr %total_in_hi32556.i, align 8
  %inc557.i = add i32 %693, 1
  store i32 %inc557.i, ptr %total_in_hi32556.i, align 8
...
for.cond564.i:                                    ; preds = %while.end632.i, %if.then516.i
  ...
  %695 = phi i32 [ %.ph483, %while.end632.i ], [ %669, %if.then516.i ]
  %696 = phi i32 [ %.ph484, %while.end632.i ], [ %670, %if.then516.i ]
  %697 = phi i32 [ %.ph485, %while.end632.i ], [ %671, %if.then516.i ]
  %698 = phi i32 [ %.ph486, %while.end632.i ], [ %672, %if.then516.i ]
  %699 = phi i32 [ %.ph487, %while.end632.i ], [ %673, %if.then516.i ]
  %700 = phi i32 [ %.ph488, %while.end632.i ], [ %674, %if.then516.i ]
  %701 = phi i32 [ %.ph489, %while.end632.i ], [ %675, %if.then516.i ]
  %702 = phi i32 [ %.ph490, %while.end632.i ], [ %676, %if.then516.i ]
  %703 = phi i32 [ %.ph491, %while.end632.i ], [ %677, %if.then516.i ]
  %704 = phi i32 [ %.ph492, %while.end632.i ], [ %678, %if.then516.i ]
  %705 = phi i32 [ %.ph493, %while.end632.i ], [ %679, %if.then516.i ]
  %706 = phi i32 [ %.ph494, %while.end632.i ], [ %680, %if.then516.i ]
  %707 = phi i32 [ %.ph495, %while.end632.i ], [ %681, %if.then516.i ]
  %708 = phi i32 [ %.ph496, %while.end632.i ], [ %682, %if.then516.i ]
  %709 = phi i32 [ %.ph497, %while.end632.i ], [ %683, %if.then516.i ]
  %710 = phi ptr [ %.ph498, %while.end632.i ], [ %684, %if.then516.i ]
  %711 = phi ptr [ %.ph499, %while.end632.i ], [ %685, %if.then516.i ]
  %712 = phi ptr [ %.ph500, %while.end632.i ], [ %686, %if.then516.i ]
...
sw.bb570.i.preheader:                             ; preds = %if.end.i86, %for.cond564.i
  %.ph = phi i32 [ %694, %for.cond564.i ], [ %.pre3395.i, %if.end.i86 ]
  %.ph483 = phi i32 [ %695, %for.cond564.i ], [ %.pre3399.i, %if.end.i86 ]
  %.ph484 = phi i32 [ %696, %for.cond564.i ], [ %.pre3400.i, %if.end.i86 ]
  %.ph485 = phi i32 [ %697, %for.cond564.i ], [ %.pre3401.i, %if.end.i86 ]
  %.ph486 = phi i32 [ %698, %for.cond564.i ], [ %.pre3402.i, %if.end.i86 ]
  %.ph487 = phi i32 [ %699, %for.cond564.i ], [ %.pre3403.i, %if.end.i86 ]
  %.ph488 = phi i32 [ %700, %for.cond564.i ], [ %.pre3404.i, %if.end.i86 ]
  %.ph489 = phi i32 [ %701, %for.cond564.i ], [ %.pre3405.i, %if.end.i86 ]
  %.ph490 = phi i32 [ %702, %for.cond564.i ], [ %.pre3406.i, %if.end.i86 ]
  %.ph491 = phi i32 [ %703, %for.cond564.i ], [ %.pre3407.i, %if.end.i86 ]
  %.ph492 = phi i32 [ %704, %for.cond564.i ], [ %.pre3408.i, %if.end.i86 ]
  %.ph493 = phi i32 [ %705, %for.cond564.i ], [ %.pre3409.i, %if.end.i86 ]
  %.ph494 = phi i32 [ %706, %for.cond564.i ], [ %.pre3410.i, %if.end.i86 ]
  %.ph495 = phi i32 [ %707, %for.cond564.i ], [ %.pre3411.i, %if.end.i86 ]
  %.ph496 = phi i32 [ %708, %for.cond564.i ], [ %.pre3412.i, %if.end.i86 ]
  %.ph497 = phi i32 [ %709, %for.cond564.i ], [ %.pre3413.i, %if.end.i86 ]
  %.ph498 = phi ptr [ %710, %for.cond564.i ], [ %.pre3414.i, %if.end.i86 ]
  %.ph499 = phi ptr [ %711, %for.cond564.i ], [ %.pre3415.i, %if.end.i86 ]
  %.ph500 = phi ptr [ %712, %for.cond564.i ], [ %.pre3416.i, %if.end.i86 ]
  %nSelectors.2.i.ph = phi i32 [ %nSelectors.0.i, %for.cond564.i ], [ %.pre3398.i, %if.end.i86 ]
  %nGroups.3.i.ph = phi i32 [ %nGroups.1.i, %for.cond564.i ], [ %.pre3397.i, %if.end.i86 ]
  %alphaSize.4.i.ph = phi i32 [ %alphaSize.2.i, %for.cond564.i ], [ %.pre3396.i, %if.end.i86 ]
  %j.8.i.ph = phi i32 [ 0, %for.cond564.i ], [ %.pre3394.i, %if.end.i86 ]
  %i.11.i.ph = phi i32 [ %i.9.i, %for.cond564.i ], [ %.pre.i87, %if.end.i86 ]
  %bsLive1264.phi.trans.insert.i.promoted = load i32, ptr %bsLive1264.phi.trans.insert.i, align 4
  br label %sw.bb570.i

sw.bb570.i:                                       ; preds = %sw.bb570.i.preheader, %if.end626.i
  %bsLive574.promoted.i604 = phi i32 [ %sub581.i, %if.end626.i ], [ %bsLive1264.phi.trans.insert.i.promoted, %sw.bb570.i.preheader ]
  %j.8.i = phi i32 [ %inc627.i, %if.end626.i ], [ %j.8.i.ph, %sw.bb570.i.preheader ]
  store i32 32, ptr %state8, align 8
  %cmp5753220.i = icmp sgt i32 %bsLive574.promoted.i604, 0
...
sw.bb570.if.then577_crit_edge.i:                  ; preds = %sw.bb570.i
  %.pre3448.i = load i32, ptr %bsBuff77.i, align 8
...
if.end587.lr.ph.i:                                ; preds = %sw.bb570.i
  ...
  %avail_in589.promoted.i = load i32, ptr %avail_in589.i, align 8
...
if.then577.i:                                     ; preds = %if.end620.i, %sw.bb570.if.then577_crit_edge.i
  ...
  %.lcssa3020.i = phi i32 [ %bsLive574.promoted.i604, %sw.bb570.if.then577_crit_edge.i ], [ %add602.i, %if.end620.i ]
  %sub581.i = add nsw i32 %.lcssa3020.i, -1
  store i32 %sub581.i, ptr %bsLive1264.phi.trans.insert.i, align 4
...
if.end587.i:                                      ; preds = %if.end620.i, %if.end587.lr.ph.i
  ...
  %add60232193221.i = phi i32 [ %bsLive574.promoted.i604, %if.end587.lr.ph.i ], [ %add602.i, %if.end620.i ]
...
if.end593.i:                                      ; preds = %if.end587.i
  %717 = load i32, ptr %bsBuff77.i, align 8
  %shl595.i = shl i32 %717, 8
  %718 = load ptr, ptr %713, align 8
  %719 = load i8, ptr %718, align 1
  %conv598.i = zext i8 %719 to i32
  %or599.i = or i32 %shl595.i, %conv598.i
  store i32 %or599.i, ptr %bsBuff77.i, align 8
  %add602.i = add nsw i32 %add60232193221.i, 8
  store i32 %add602.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %incdec.ptr605.i = getelementptr inbounds i8, ptr %718, i64 1
  store ptr %incdec.ptr605.i, ptr %713, align 8
  %dec608.i = add i32 %dec6083224.i, -1
  store i32 %dec608.i, ptr %avail_in589.i, align 8
  %720 = load i32, ptr %total_in_lo32610.i, align 4
  %inc611.i = add i32 %720, 1
  store i32 %inc611.i, ptr %total_in_lo32610.i, align 4
  %cmp614.i = icmp eq i32 %inc611.i, 0
  br i1 %cmp614.i, label %if.then616.i, label %if.end620.i

if.then616.i:                                     ; preds = %if.end593.i
  %721 = load i32, ptr %total_in_hi32618.i, align 8
  %inc619.i = add i32 %721, 1
  store i32 %inc619.i, ptr %total_in_hi32618.i, align 8
...
while.end632.i:                                   ; preds = %if.then577.i
  ...
  store i8 %conv633.i, ptr %arrayidx635.i, align 1
  %inc637.i = add nsw i32 %i.11.i.ph, 1
  br label %for.cond564.i
...
for.end638.i:                                     ; preds = %for.cond564.i
  ...
  br i1 %cmp6423111.i, label %iter.check428, label %for.cond650.preheader.i

iter.check428:                                    ; preds = %for.end638.i
  %min.iters.check426 = icmp ult i32 %nGroups.1.i, 8
  br i1 %min.iters.check426, label %for.body644.i.preheader, label %vector.scevcheck423

vector.scevcheck423:                              ; preds = %iter.check428
  %722 = add i32 %nGroups.1.i, -1
  %723 = and i32 %722, 255
  %724 = icmp eq i32 %723, 255
  %725 = icmp ugt i32 %722, 255
  %726 = or i1 %724, %725
  br i1 %726, label %for.body644.i.preheader, label %vector.main.loop.iter.check430

vector.main.loop.iter.check430:                   ; preds = %vector.scevcheck423
  %min.iters.check429 = icmp ult i32 %nGroups.1.i, 32
  br i1 %min.iters.check429, label %vec.epilog.ph445, label %vector.ph431

vector.ph431:                                     ; preds = %vector.main.loop.iter.check430
  %n.vec433 = and i32 %nGroups.1.i, -32
  %ind.end440 = trunc i32 %n.vec433 to i8
  store <16 x i8> <i8 0, i8 1, i8 2, i8 3, i8 4, i8 5, i8 6, i8 7, i8 8, i8 9, i8 10, i8 11, i8 12, i8 13, i8 14, i8 15>, ptr %pos.i, align 16
  store <16 x i8> <i8 16, i8 17, i8 18, i8 19, i8 20, i8 21, i8 22, i8 23, i8 24, i8 25, i8 26, i8 27, i8 28, i8 29, i8 30, i8 31>, ptr %5, align 16
  %727 = icmp eq i32 %n.vec433, 32
  br i1 %727, label %middle.block424, label %vector.body435.1

vector.body435.1:                                 ; preds = %vector.ph431
  store <16 x i8> <i8 32, i8 33, i8 34, i8 35, i8 36, i8 37, i8 38, i8 39, i8 40, i8 41, i8 42, i8 43, i8 44, i8 45, i8 46, i8 47>, ptr %6, align 16
  store <16 x i8> <i8 48, i8 49, i8 50, i8 51, i8 52, i8 53, i8 54, i8 55, i8 56, i8 57, i8 58, i8 59, i8 60, i8 61, i8 62, i8 63>, ptr %7, align 16
  %728 = icmp eq i32 %n.vec433, 64
  br i1 %728, label %middle.block424, label %vector.body435.2

vector.body435.2:                                 ; preds = %vector.body435.1
  store <16 x i8> <i8 64, i8 65, i8 66, i8 67, i8 68, i8 69, i8 70, i8 71, i8 72, i8 73, i8 74, i8 75, i8 76, i8 77, i8 78, i8 79>, ptr %8, align 16
  store <16 x i8> <i8 80, i8 81, i8 82, i8 83, i8 84, i8 85, i8 86, i8 87, i8 88, i8 89, i8 90, i8 91, i8 92, i8 93, i8 94, i8 95>, ptr %9, align 16
  %729 = icmp eq i32 %n.vec433, 96
  br i1 %729, label %middle.block424, label %vector.body435.3

vector.body435.3:                                 ; preds = %vector.body435.2
  store <16 x i8> <i8 96, i8 97, i8 98, i8 99, i8 100, i8 101, i8 102, i8 103, i8 104, i8 105, i8 106, i8 107, i8 108, i8 109, i8 110, i8 111>, ptr %10, align 16
  store <16 x i8> <i8 112, i8 113, i8 114, i8 115, i8 116, i8 117, i8 118, i8 119, i8 120, i8 121, i8 122, i8 123, i8 124, i8 125, i8 126, i8 127>, ptr %11, align 16
  %730 = icmp eq i32 %n.vec433, 128
  br i1 %730, label %middle.block424, label %vector.body435.4

vector.body435.4:                                 ; preds = %vector.body435.3
  store <16 x i8> <i8 -128, i8 -127, i8 -126, i8 -125, i8 -124, i8 -123, i8 -122, i8 -121, i8 -120, i8 -119, i8 -118, i8 -117, i8 -116, i8 -115, i8 -114, i8 -113>, ptr %12, align 16
  store <16 x i8> <i8 -112, i8 -111, i8 -110, i8 -109, i8 -108, i8 -107, i8 -106, i8 -105, i8 -104, i8 -103, i8 -102, i8 -101, i8 -100, i8 -99, i8 -98, i8 -97>, ptr %13, align 16
  %731 = icmp eq i32 %n.vec433, 160
  br i1 %731, label %middle.block424, label %vector.body435.5

vector.body435.5:                                 ; preds = %vector.body435.4
  store <16 x i8> <i8 -96, i8 -95, i8 -94, i8 -93, i8 -92, i8 -91, i8 -90, i8 -89, i8 -88, i8 -87, i8 -86, i8 -85, i8 -84, i8 -83, i8 -82, i8 -81>, ptr %14, align 16
  store <16 x i8> <i8 -80, i8 -79, i8 -78, i8 -77, i8 -76, i8 -75, i8 -74, i8 -73, i8 -72, i8 -71, i8 -70, i8 -69, i8 -68, i8 -67, i8 -66, i8 -65>, ptr %15, align 16
  %732 = icmp eq i32 %n.vec433, 192
  br i1 %732, label %middle.block424, label %vector.body435.6

vector.body435.6:                                 ; preds = %vector.body435.5
  store <16 x i8> <i8 -64, i8 -63, i8 -62, i8 -61, i8 -60, i8 -59, i8 -58, i8 -57, i8 -56, i8 -55, i8 -54, i8 -53, i8 -52, i8 -51, i8 -50, i8 -49>, ptr %16, align 16
  store <16 x i8> <i8 -48, i8 -47, i8 -46, i8 -45, i8 -44, i8 -43, i8 -42, i8 -41, i8 -40, i8 -39, i8 -38, i8 -37, i8 -36, i8 -35, i8 -34, i8 -33>, ptr %17, align 16
  %733 = icmp eq i32 %n.vec433, 224
  br i1 %733, label %middle.block424, label %vector.body435.7

vector.body435.7:                                 ; preds = %vector.body435.6
  store <16 x i8> <i8 -32, i8 -31, i8 -30, i8 -29, i8 -28, i8 -27, i8 -26, i8 -25, i8 -24, i8 -23, i8 -22, i8 -21, i8 -20, i8 -19, i8 -18, i8 -17>, ptr %18, align 16
  store <16 x i8> <i8 -16, i8 -15, i8 -14, i8 -13, i8 -12, i8 -11, i8 -10, i8 -9, i8 -8, i8 -7, i8 -6, i8 -5, i8 -4, i8 -3, i8 -2, i8 -1>, ptr %19, align 16
  br label %middle.block424

middle.block424:                                  ; preds = %vector.body435.7, %vector.body435.6, %vector.body435.5, %vector.body435.4, %vector.body435.3, %vector.body435.2, %vector.body435.1, %vector.ph431
  %cmp.n434 = icmp eq i32 %nGroups.1.i, %n.vec433
  br i1 %cmp.n434, label %for.cond650.preheader.i, label %vec.epilog.iter.check444

vec.epilog.iter.check444:                         ; preds = %middle.block424
  %ind.end452 = trunc i32 %n.vec433 to i8
  %n.vec.remaining446 = and i32 %nGroups.1.i, 24
  %min.epilog.iters.check447 = icmp eq i32 %n.vec.remaining446, 0
  br i1 %min.epilog.iters.check447, label %for.body644.i.preheader, label %vec.epilog.ph445

vec.epilog.ph445:                                 ; preds = %vector.main.loop.iter.check430, %vec.epilog.iter.check444
  %bc.resume.val441 = phi i8 [ %ind.end440, %vec.epilog.iter.check444 ], [ 0, %vector.main.loop.iter.check430 ]
  %vec.epilog.resume.val448 = phi i32 [ %n.vec433, %vec.epilog.iter.check444 ], [ 0, %vector.main.loop.iter.check430 ]
  %n.vec450 = and i32 %nGroups.1.i, -8
  %ind.end451 = trunc i32 %n.vec450 to i8
  %.splatinsert = insertelement <8 x i8> poison, i8 %bc.resume.val441, i64 0
...
vec.epilog.vector.body455:                        ; preds = %vec.epilog.vector.body455, %vec.epilog.ph445
  %index456 = phi i32 [ %vec.epilog.resume.val448, %vec.epilog.ph445 ], [ %index.next461, %vec.epilog.vector.body455 ]
  %vec.ind457 = phi <8 x i8> [ %induction, %vec.epilog.ph445 ], [ %vec.ind.next459, %vec.epilog.vector.body455 ]
  %734 = and i32 %index456, 248
  %735 = zext i32 %734 to i64
  %736 = getelementptr inbounds [6 x i8], ptr %pos.i, i64 0, i64 %735
  store <8 x i8> %vec.ind457, ptr %736, align 8
  %index.next461 = add nuw i32 %index456, 8
  %vec.ind.next459 = add <8 x i8> %vec.ind457, <i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8>
  %737 = icmp eq i32 %index.next461, %n.vec450
  br i1 %737, label %vec.epilog.middle.block442, label %vec.epilog.vector.body455

vec.epilog.middle.block442:                       ; preds = %vec.epilog.vector.body455
  %cmp.n454 = icmp eq i32 %nGroups.1.i, %n.vec450
  br i1 %cmp.n454, label %for.cond650.preheader.i, label %for.body644.i.preheader

for.body644.i.preheader:                          ; preds = %vector.scevcheck423, %iter.check428, %vec.epilog.iter.check444, %vec.epilog.middle.block442
  %v639.03112.i.ph = phi i8 [ 0, %iter.check428 ], [ 0, %vector.scevcheck423 ], [ %ind.end452, %vec.epilog.iter.check444 ], [ %ind.end451, %vec.epilog.middle.block442 ]
  br label %for.body644.i

for.cond650.preheader.i:                          ; preds = %for.body644.i, %middle.block424, %vec.epilog.middle.block442, %for.end638.i
...
for.body644.i:                                    ; preds = %for.body644.i.preheader, %for.body644.i
  ...
  store i8 %v639.03112.i, ptr %arrayidx646.i, align 1
  %inc648.i = add i8 %v639.03112.i, 1
  %conv641.i = zext i8 %inc648.i to i32
  %cmp642.i = icmp sgt i32 %nGroups.1.i, %conv641.i
  br i1 %cmp642.i, label %for.body644.i, label %for.cond650.preheader.i
...
for.body653.i:                                    ; preds = %while.end671.i, %for.body653.preheader.i
  ...
  %738 = load i8, ptr %arrayidx656.i, align 1
  %idxprom657.i = zext i8 %738 to i64
  %arrayidx658.i = getelementptr inbounds [6 x i8], ptr %pos.i, i64 0, i64 %idxprom657.i
  %739 = load i8, ptr %arrayidx658.i, align 1
  %cmp661.not3113.i = icmp eq i8 %738, 0
  br i1 %cmp661.not3113.i, label %while.end671.i, label %iter.check389

iter.check389:                                    ; preds = %for.body653.i
  %min.iters.check387 = icmp ult i8 %738, 8
  br i1 %min.iters.check387, label %while.body663.i.preheader, label %vector.scevcheck370

vector.scevcheck370:                              ; preds = %iter.check389
  %740 = add i8 %738, -1
  %741 = zext i8 %738 to i32
  %742 = add nsw i32 %741, -1
  %743 = zext i8 %740 to i32
  %744 = icmp ult i32 %742, %743
  %scevgep374 = getelementptr i8, ptr %pos.i, i64 %idxprom657.i
  %745 = zext i8 %740 to i64
  %746 = sub nsw i64 0, %745
  %747 = getelementptr i8, ptr %scevgep374, i64 %746
  %748 = icmp ugt ptr %747, %scevgep374
  %749 = zext i32 %742 to i64
  %scevgep378 = getelementptr i8, ptr %pos.i, i64 %749
  %750 = zext i8 %740 to i64
  %751 = sub nsw i64 0, %750
  %752 = getelementptr i8, ptr %scevgep378, i64 %751
  %753 = icmp ugt ptr %752, %scevgep378
  %754 = or i1 %744, %748
  %755 = or i1 %754, %753
  br i1 %755, label %while.body663.i.preheader, label %vector.memcheck382

vector.memcheck382:                               ; preds = %vector.scevcheck370
  %756 = zext i8 %738 to i64
  %757 = add nuw nsw i64 %756, 4294967295
  %758 = and i64 %757, 4294967295
  %759 = add i64 %758, %pos.i383
  %760 = add i64 %pos.i383, %idxprom657.i
  %761 = sub i64 %759, %760
  %diff.check384 = icmp ult i64 %761, 16
  br i1 %diff.check384, label %while.body663.i.preheader, label %vector.main.loop.iter.check391

vector.main.loop.iter.check391:                   ; preds = %vector.memcheck382
  %min.iters.check390 = icmp ult i8 %738, 16
  br i1 %min.iters.check390, label %vec.epilog.ph406, label %vector.ph392

vector.ph392:                                     ; preds = %vector.main.loop.iter.check391
  %n.vec394 = and i64 %idxprom657.i, 240
  br label %vector.body396

vector.body396:                                   ; preds = %vector.body396, %vector.ph392
  %index397 = phi i64 [ 0, %vector.ph392 ], [ %index.next402, %vector.body396 ]
  %offset.idx398 = sub i64 %idxprom657.i, %index397
  %762 = add nuw nsw i64 %offset.idx398, 4294967295
  %763 = and i64 %762, 4294967295
  %gep = getelementptr [6 x i8], ptr %invariant.gep, i64 0, i64 %763
  %wide.load399 = load <16 x i8>, ptr %gep, align 1
  %gep591 = getelementptr [6 x i8], ptr %invariant.gep590, i64 0, i64 %offset.idx398
  store <16 x i8> %wide.load399, ptr %gep591, align 1
  %index.next402 = add nuw i64 %index397, 16
  %764 = icmp eq i64 %index.next402, %n.vec394
  br i1 %764, label %middle.block385, label %vector.body396

middle.block385:                                  ; preds = %vector.body396
  %cmp.n395 = icmp eq i64 %n.vec394, %idxprom657.i
  br i1 %cmp.n395, label %while.end671.i, label %vec.epilog.iter.check405

vec.epilog.iter.check405:                         ; preds = %middle.block385
  %ind.end413 = and i64 %idxprom657.i, 15
  %n.vec.remaining407 = and i64 %idxprom657.i, 8
  %min.epilog.iters.check408.not.not = icmp eq i64 %n.vec.remaining407, 0
  br i1 %min.epilog.iters.check408.not.not, label %while.body663.i.preheader, label %vec.epilog.ph406

vec.epilog.ph406:                                 ; preds = %vector.main.loop.iter.check391, %vec.epilog.iter.check405
  %vec.epilog.resume.val409 = phi i64 [ %n.vec394, %vec.epilog.iter.check405 ], [ 0, %vector.main.loop.iter.check391 ]
  %n.vec411 = and i64 %idxprom657.i, 248
  %ind.end412 = and i64 %idxprom657.i, 7
  br label %vec.epilog.vector.body416

vec.epilog.vector.body416:                        ; preds = %vec.epilog.vector.body416, %vec.epilog.ph406
  %index417 = phi i64 [ %vec.epilog.resume.val409, %vec.epilog.ph406 ], [ %index.next422, %vec.epilog.vector.body416 ]
  %offset.idx418 = sub i64 %idxprom657.i, %index417
  %765 = add nuw nsw i64 %offset.idx418, 4294967295
  %766 = and i64 %765, 4294967295
  %gep593 = getelementptr [6 x i8], ptr %invariant.gep592, i64 0, i64 %766
  %wide.load419 = load <8 x i8>, ptr %gep593, align 1
  %gep595 = getelementptr [6 x i8], ptr %invariant.gep594, i64 0, i64 %offset.idx418
  store <8 x i8> %wide.load419, ptr %gep595, align 1
  %index.next422 = add nuw i64 %index417, 8
  %767 = icmp eq i64 %index.next422, %n.vec411
  br i1 %767, label %vec.epilog.middle.block403, label %vec.epilog.vector.body416

vec.epilog.middle.block403:                       ; preds = %vec.epilog.vector.body416
  %cmp.n415 = icmp eq i64 %n.vec411, %idxprom657.i
  br i1 %cmp.n415, label %while.end671.i, label %while.body663.i.preheader

while.body663.i.preheader:                        ; preds = %vector.memcheck382, %vector.scevcheck370, %iter.check389, %vec.epilog.iter.check405, %vec.epilog.middle.block403
  %indvars.iv.i.ph = phi i64 [ %idxprom657.i, %iter.check389 ], [ %idxprom657.i, %vector.memcheck382 ], [ %idxprom657.i, %vector.scevcheck370 ], [ %ind.end413, %vec.epilog.iter.check405 ], [ %ind.end412, %vec.epilog.middle.block403 ]
...
while.body663.i.prol:                             ; preds = %while.body663.i.preheader
  ...
  %769 = load i8, ptr %arrayidx667.i.prol, align 1
  %arrayidx669.i.prol = getelementptr inbounds [6 x i8], ptr %pos.i, i64 0, i64 %indvars.iv.i.ph
  store i8 %769, ptr %arrayidx669.i.prol, align 1
...
while.body663.i:                                  ; preds = %while.body663.i.prol.loopexit, %while.body663.i
  ...
  %772 = load i8, ptr %arrayidx667.i.1, align 1
  %arrayidx669.i.1 = getelementptr inbounds [6 x i8], ptr %pos.i, i64 0, i64 %indvars.iv.next.i
  store i8 %772, ptr %arrayidx669.i.1, align 1
  %indvars.iv.next.i.1 = add nsw i64 %indvars.iv.i, -2
  %773 = and i64 %indvars.iv.next.i.1, 255
  %cmp661.not.i.1 = icmp eq i64 %773, 0
  br i1 %cmp661.not.i.1, label %while.end671.i, label %while.body663.i

while.end671.i:                                   ; preds = %while.body663.i.prol.loopexit, %while.body663.i, %middle.block385, %vec.epilog.middle.block403, %for.body653.i
  store i8 %739, ptr %pos.i, align 16
  %arrayidx674.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 33, i64 %indvars.iv3267.i
  store i8 %739, ptr %arrayidx674.i, align 1
...
for.cond879.preheader.lr.ph.i:                    ; preds = %for.cond875.preheader.i
  ...
  %xtraiter550 = and i64 %wide.trip.count.i.i, 1
  %792 = icmp eq i64 %791, 0
  %unroll_iter = and i64 %wide.trip.count.i.i, 4294967294
  %lcmp.mod551.not = icmp eq i64 %xtraiter550, 0
  %xtraiter553 = and i64 %wide.trip.count.i.i, 1
  %793 = icmp eq i64 %791, 0
  %unroll_iter555 = and i64 %wide.trip.count.i.i, 4294967294
  %lcmp.mod554.not = icmp eq i64 %xtraiter553, 0
  br label %for.cond879.preheader.i

sw.bb682.i:                                       ; preds = %for.cond678.i, %if.end.i86
  %794 = phi i32 [ %774, %for.cond678.i ], [ %.pre3399.i, %if.end.i86 ]
  %795 = phi i32 [ %775, %for.cond678.i ], [ %.pre3400.i, %if.end.i86 ]
  %796 = phi i32 [ %776, %for.cond678.i ], [ %.pre3401.i, %if.end.i86 ]
  %797 = phi i32 [ %777, %for.cond678.i ], [ %.pre3402.i, %if.end.i86 ]
  %798 = phi i32 [ %778, %for.cond678.i ], [ %.pre3403.i, %if.end.i86 ]
  %799 = phi i32 [ %779, %for.cond678.i ], [ %.pre3404.i, %if.end.i86 ]
  %800 = phi i32 [ %780, %for.cond678.i ], [ %.pre3405.i, %if.end.i86 ]
  %801 = phi i32 [ %781, %for.cond678.i ], [ %.pre3406.i, %if.end.i86 ]
  %802 = phi i32 [ %782, %for.cond678.i ], [ %.pre3408.i, %if.end.i86 ]
  %803 = phi i32 [ %783, %for.cond678.i ], [ %.pre3409.i, %if.end.i86 ]
  %804 = phi i32 [ %784, %for.cond678.i ], [ %.pre3410.i, %if.end.i86 ]
  %805 = phi i32 [ %785, %for.cond678.i ], [ %.pre3411.i, %if.end.i86 ]
  %806 = phi i32 [ %786, %for.cond678.i ], [ %.pre3412.i, %if.end.i86 ]
  %807 = phi i32 [ %787, %for.cond678.i ], [ %.pre3413.i, %if.end.i86 ]
  %808 = phi ptr [ %788, %for.cond678.i ], [ %.pre3414.i, %if.end.i86 ]
  %809 = phi ptr [ %789, %for.cond678.i ], [ %.pre3415.i, %if.end.i86 ]
  %810 = phi ptr [ %790, %for.cond678.i ], [ %.pre3416.i, %if.end.i86 ]
  %curr.1.i = phi i32 [ %curr.0.i, %for.cond678.i ], [ %.pre3407.i, %if.end.i86 ]
  %nSelectors.4.i = phi i32 [ %nSelectors.3.i, %for.cond678.i ], [ %.pre3398.i, %if.end.i86 ]
  %nGroups.5.i = phi i32 [ %nGroups.4.i, %for.cond678.i ], [ %.pre3397.i, %if.end.i86 ]
  %alphaSize.6.i = phi i32 [ %alphaSize.5.i, %for.cond678.i ], [ %.pre3396.i, %if.end.i86 ]
  %t.1.i = phi i32 [ %t.0.i, %for.cond678.i ], [ %.pre3395.i, %if.end.i86 ]
  %j.10.i = phi i32 [ %j.9.i, %for.cond678.i ], [ %.pre3394.i, %if.end.i86 ]
  %i.14.i = phi i32 [ %i.13.i, %for.cond678.i ], [ %.pre.i87, %if.end.i86 ]
  store i32 33, ptr %state8, align 8
  %bsLive686.promoted.i = load i32, ptr %bsLive1264.phi.trans.insert.i, align 4
...
sw.bb682.if.then689_crit_edge.i:                  ; preds = %sw.bb682.i
  %.pre3444.i = load i32, ptr %bsBuff77.i, align 8
...
if.end698.lr.ph.i:                                ; preds = %sw.bb682.i
  ...
  %avail_in700.promoted.i = load i32, ptr %avail_in700.i, align 8
...
if.then689.i:                                     ; preds = %if.end731.i, %sw.bb682.if.then689_crit_edge.i
  ...
  store i32 %sub693.i, ptr %bsLive1264.phi.trans.insert.i, align 4
...
if.end704.i:                                      ; preds = %if.end698.i
  %813 = load i32, ptr %bsBuff77.i, align 8
  %shl706.i = shl i32 %813, 8
  %814 = load ptr, ptr %811, align 8
  %815 = load i8, ptr %814, align 1
  %conv709.i = zext i8 %815 to i32
  %or710.i = or i32 %shl706.i, %conv709.i
  store i32 %or710.i, ptr %bsBuff77.i, align 8
  %add713.i = add nsw i32 %add71332013203.i, 8
  store i32 %add713.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %incdec.ptr716.i = getelementptr inbounds i8, ptr %814, i64 1
  store ptr %incdec.ptr716.i, ptr %811, align 8
  %dec719.i = add i32 %dec7193206.i, -1
  store i32 %dec719.i, ptr %avail_in700.i, align 8
  %816 = load i32, ptr %total_in_lo32721.i, align 4
  %inc722.i = add i32 %816, 1
  store i32 %inc722.i, ptr %total_in_lo32721.i, align 4
  %cmp725.i = icmp eq i32 %inc722.i, 0
  br i1 %cmp725.i, label %if.then727.i, label %if.end731.i

if.then727.i:                                     ; preds = %if.end704.i
  %817 = load i32, ptr %total_in_hi32729.i, align 8
  %inc730.i = add i32 %817, 1
  store i32 %inc730.i, ptr %total_in_hi32729.i, align 8
...
sw.bb746.i:                                       ; preds = %while.cond737.i, %if.end.i86
  %853 = phi i32 [ %835, %while.cond737.i ], [ %.pre3399.i, %if.end.i86 ]
  %854 = phi i32 [ %836, %while.cond737.i ], [ %.pre3400.i, %if.end.i86 ]
  %855 = phi i32 [ %837, %while.cond737.i ], [ %.pre3401.i, %if.end.i86 ]
  %856 = phi i32 [ %838, %while.cond737.i ], [ %.pre3402.i, %if.end.i86 ]
  %857 = phi i32 [ %839, %while.cond737.i ], [ %.pre3403.i, %if.end.i86 ]
  %858 = phi i32 [ %840, %while.cond737.i ], [ %.pre3404.i, %if.end.i86 ]
  %859 = phi i32 [ %841, %while.cond737.i ], [ %.pre3405.i, %if.end.i86 ]
  %860 = phi i32 [ %842, %while.cond737.i ], [ %.pre3406.i, %if.end.i86 ]
  %861 = phi i32 [ %843, %while.cond737.i ], [ %.pre3408.i, %if.end.i86 ]
  %862 = phi i32 [ %844, %while.cond737.i ], [ %.pre3409.i, %if.end.i86 ]
  %863 = phi i32 [ %845, %while.cond737.i ], [ %.pre3410.i, %if.end.i86 ]
  %864 = phi i32 [ %846, %while.cond737.i ], [ %.pre3411.i, %if.end.i86 ]
  %865 = phi i32 [ %847, %while.cond737.i ], [ %.pre3412.i, %if.end.i86 ]
  %866 = phi i32 [ %848, %while.cond737.i ], [ %.pre3413.i, %if.end.i86 ]
  %867 = phi ptr [ %849, %while.cond737.i ], [ %.pre3414.i, %if.end.i86 ]
  %868 = phi ptr [ %850, %while.cond737.i ], [ %.pre3415.i, %if.end.i86 ]
  %869 = phi ptr [ %851, %while.cond737.i ], [ %.pre3416.i, %if.end.i86 ]
  %curr.4.i = phi i32 [ %curr.3.i, %while.cond737.i ], [ %.pre3407.i, %if.end.i86 ]
  %nSelectors.7.i = phi i32 [ %nSelectors.6.i, %while.cond737.i ], [ %.pre3398.i, %if.end.i86 ]
  %nGroups.8.i = phi i32 [ %nGroups.7.i, %while.cond737.i ], [ %.pre3397.i, %if.end.i86 ]
  %alphaSize.9.i = phi i32 [ %alphaSize.8.i, %while.cond737.i ], [ %.pre3396.i, %if.end.i86 ]
  %t.4.i = phi i32 [ %t.3.i, %while.cond737.i ], [ %.pre3395.i, %if.end.i86 ]
  %j.13.i = phi i32 [ %j.12.i, %while.cond737.i ], [ %.pre3394.i, %if.end.i86 ]
  %i.17.i = phi i32 [ %i.16.i, %while.cond737.i ], [ %.pre.i87, %if.end.i86 ]
  store i32 34, ptr %state8, align 8
  %bsLive750.promoted.i = load i32, ptr %bsLive1264.phi.trans.insert.i, align 4
...
sw.bb746.if.then753_crit_edge.i:                  ; preds = %sw.bb746.i
  %.pre3445.i = load i32, ptr %bsBuff77.i, align 8
...
if.end763.lr.ph.i:                                ; preds = %sw.bb746.i
  ...
  %avail_in765.promoted.i = load i32, ptr %avail_in765.i, align 8
...
if.then753.i:                                     ; preds = %if.end796.i, %sw.bb746.if.then753_crit_edge.i
  ...
  store i32 %sub757.i, ptr %bsLive1264.phi.trans.insert.i, align 4
...
if.end769.i:                                      ; preds = %if.end763.i
  %874 = load i32, ptr %bsBuff77.i, align 8
  ...
  store i32 %or775.i, ptr %bsBuff77.i, align 8
  %add778.i = add nsw i32 %add77832073209.i, 8
  store i32 %add778.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %incdec.ptr781.i = getelementptr inbounds i8, ptr %875, i64 1
  store ptr %incdec.ptr781.i, ptr %870, align 8
  %dec784.i = add i32 %dec7843212.i, -1
  store i32 %dec784.i, ptr %avail_in765.i, align 8
  %877 = load i32, ptr %total_in_lo32786.i, align 4
  %inc787.i = add i32 %877, 1
  store i32 %inc787.i, ptr %total_in_lo32786.i, align 4
  %cmp790.i = icmp eq i32 %inc787.i, 0
  br i1 %cmp790.i, label %if.then792.i, label %if.end796.i

if.then792.i:                                     ; preds = %if.end769.i
  %878 = load i32, ptr %total_in_hi32794.i, align 8
  %inc795.i = add i32 %878, 1
  store i32 %inc795.i, ptr %total_in_hi32794.i, align 8
...
sw.bb803.i:                                       ; preds = %if.then753.i, %if.end.sw.bb803_crit_edge.i
  ...
  store i32 35, ptr %state8, align 8
...
sw.bb803.if.then810_crit_edge.i:                  ; preds = %sw.bb803.i
  %.pre3447.i = load i32, ptr %bsBuff77.i, align 8
...
if.end820.lr.ph.i:                                ; preds = %sw.bb803.i
  ...
  %avail_in822.promoted.i = load i32, ptr %avail_in822.i, align 8
...
if.then810.i:                                     ; preds = %if.end853.i, %sw.bb803.if.then810_crit_edge.i
  ...
  store i32 %sub814.i, ptr %bsLive1264.phi.trans.insert.i, align 4
...
if.end826.i:                                      ; preds = %if.end820.i
  %900 = load i32, ptr %bsBuff77.i, align 8
  ...
  store i32 %or832.i, ptr %bsBuff77.i, align 8
  %add835.i = add nsw i32 %add83532133215.i, 8
  store i32 %add835.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %incdec.ptr838.i = getelementptr inbounds i8, ptr %901, i64 1
  store ptr %incdec.ptr838.i, ptr %896, align 8
  %dec841.i = add i32 %dec8413218.i, -1
  store i32 %dec841.i, ptr %avail_in822.i, align 8
  %903 = load i32, ptr %total_in_lo32843.i, align 4
  %inc844.i = add i32 %903, 1
  store i32 %inc844.i, ptr %total_in_lo32843.i, align 4
  %cmp847.i = icmp eq i32 %inc844.i, 0
  br i1 %cmp847.i, label %if.then849.i, label %if.end853.i

if.then849.i:                                     ; preds = %if.end826.i
  %904 = load i32, ptr %total_in_hi32851.i, align 8
  %inc852.i = add i32 %904, 1
  store i32 %inc852.i, ptr %total_in_hi32851.i, align 8
...
while.end863.i:                                   ; preds = %if.then753.i
  ...
  store i8 %conv864.i, ptr %arrayidx868.i, align 1
...
for.body882.i.preheader:                          ; preds = %for.cond879.preheader.i
  br i1 %min.iters.check354, label %for.body882.i.preheader479, label %vector.body360
...
vector.body360:                                   ; preds = %for.body882.i.preheader, %vector.body360
  ...
  %vec.phi = phi <4 x i32> [ %911, %vector.body360 ], [ <i32 32, i32 32, i32 32, i32 32>, %for.body882.i.preheader ]
  %vec.phi362 = phi <4 x i32> [ %912, %vector.body360 ], [ <i32 32, i32 32, i32 32, i32 32>, %for.body882.i.preheader ]
  %vec.phi363 = phi <4 x i32> [ %909, %vector.body360 ], [ zeroinitializer, %for.body882.i.preheader ]
  %vec.phi364 = phi <4 x i32> [ %910, %vector.body360 ], [ zeroinitializer, %for.body882.i.preheader ]
  %905 = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 35, i64 %indvars.iv3277.i, i64 %index361
  %wide.load365 = load <4 x i8>, ptr %905, align 1
  %906 = getelementptr inbounds i8, ptr %905, i64 4
  %wide.load366 = load <4 x i8>, ptr %906, align 1
  %907 = zext <4 x i8> %wide.load365 to <4 x i32>
  %908 = zext <4 x i8> %wide.load366 to <4 x i32>
  %909 = call <4 x i32> @llvm.smax.v4i32(<4 x i32> %vec.phi363, <4 x i32> %907)
  %910 = call <4 x i32> @llvm.smax.v4i32(<4 x i32> %vec.phi364, <4 x i32> %908)
  %911 = call <4 x i32> @llvm.smin.v4i32(<4 x i32> %vec.phi, <4 x i32> %907)
  %912 = call <4 x i32> @llvm.smin.v4i32(<4 x i32> %vec.phi362, <4 x i32> %908)
  %index.next367 = add nuw i64 %index361, 8
  %913 = icmp eq i64 %index.next367, %n.vec357
  br i1 %913, label %middle.block352, label %vector.body360

middle.block352:                                  ; preds = %vector.body360
  %rdx.minmax368 = call <4 x i32> @llvm.smax.v4i32(<4 x i32> %909, <4 x i32> %910)
  %914 = call i32 @llvm.vector.reduce.smax.v4i32(<4 x i32> %rdx.minmax368)
  ...
  br i1 %cmp.n359, label %for.cond1.preheader.lr.ph.i.i, label %for.body882.i.preheader479

for.body882.i.preheader479:                       ; preds = %for.body882.i.preheader, %middle.block352
  %indvars.iv3271.i.ph = phi i64 [ 0, %for.body882.i.preheader ], [ %n.vec357, %middle.block352 ]
  %minLen.03121.i.ph = phi i32 [ 32, %for.body882.i.preheader ], [ %915, %middle.block352 ]
  %maxLen.03120.i.ph = phi i32 [ 0, %for.body882.i.preheader ], [ %914, %middle.block352 ]
  br label %for.body882.i

for.cond12.preheader.i.thread.i:                  ; preds = %for.cond879.preheader.i
  %arrayidx9224294.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 37, i64 %indvars.iv3277.i
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(92) %arrayidx9224294.i, i8 0, i64 92, i1 false)
  br label %for.cond34.preheader.i.i

for.body882.i:                                    ; preds = %for.body882.i.preheader479, %for.body882.i
  %indvars.iv3271.i = phi i64 [ %indvars.iv.next3272.i, %for.body882.i ], [ %indvars.iv3271.i.ph, %for.body882.i.preheader479 ]
  %minLen.03121.i = phi i32 [ %minLen.1.i, %for.body882.i ], [ %minLen.03121.i.ph, %for.body882.i.preheader479 ]
  %maxLen.03120.i = phi i32 [ %spec.select.i, %for.body882.i ], [ %maxLen.03120.i.ph, %for.body882.i.preheader479 ]
  %arrayidx887.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 35, i64 %indvars.iv3277.i, i64 %indvars.iv3271.i
  %916 = load i8, ptr %arrayidx887.i, align 1
  ...
  br i1 %exitcond3276.not.i, label %for.cond1.preheader.lr.ph.i.i, label %for.body882.i

for.cond1.preheader.lr.ph.i.i:                    ; preds = %for.body882.i, %middle.block352
  %spec.select.i.lcssa = phi i32 [ %914, %middle.block352 ], [ %spec.select.i, %for.body882.i ]
  %minLen.1.i.lcssa = phi i32 [ %915, %middle.block352 ], [ %minLen.1.i, %for.body882.i ]
...
for.cond1.preheader.us.i.i:                       ; preds = %for.cond1.preheader.lr.ph.i.i, %for.cond1.for.inc9_crit_edge.us.i.i
  %i.0141.us.i.i = phi i32 [ %inc10.us.i.i, %for.cond1.for.inc9_crit_edge.us.i.i ], [ %minLen.1.i.lcssa, %for.cond1.preheader.lr.ph.i.i ]
  %pp.0140.us.i.i = phi i32 [ %pp.2.us.i.i.lcssa, %for.cond1.for.inc9_crit_edge.us.i.i ], [ 0, %for.cond1.preheader.lr.ph.i.i ]
...
for.body3.us.i.i:                                 ; preds = %for.cond1.preheader.us.i.i, %for.inc.us.i.i.1
  ...
  %917 = load i8, ptr %arrayidx.us.i.i, align 1
...
if.then.us.i.i:                                   ; preds = %for.body3.us.i.i
  ...
  store i32 %918, ptr %arrayidx7.us.i.i, align 4
...
for.inc.us.i.i:                                   ; preds = %if.then.us.i.i, %for.body3.us.i.i
  ...
  %919 = load i8, ptr %arrayidx.us.i.i.1, align 1
...
if.then.us.i.i.1:                                 ; preds = %for.inc.us.i.i
  ...
  store i32 %920, ptr %arrayidx7.us.i.i.1, align 4
...
for.inc.us.i.i.1:                                 ; preds = %if.then.us.i.i.1, %for.inc.us.i.i
  ...
  br i1 %niter.ncmp.1, label %for.cond1.for.inc9_crit_edge.us.i.i.unr-lcssa, label %for.body3.us.i.i
...
for.cond1.for.inc9_crit_edge.us.i.i.unr-lcssa:    ; preds = %for.inc.us.i.i.1, %for.cond1.preheader.us.i.i
  ...
  br i1 %lcmp.mod551.not, label %for.cond1.for.inc9_crit_edge.us.i.i, label %for.body3.us.i.i.epil
...
for.body3.us.i.i.epil:                            ; preds = %for.cond1.for.inc9_crit_edge.us.i.i.unr-lcssa
  ...
  %921 = load i8, ptr %arrayidx.us.i.i.epil, align 1
...
if.then.us.i.i.epil:                              ; preds = %for.body3.us.i.i.epil
  ...
  store i32 %922, ptr %arrayidx7.us.i.i.epil, align 4
...
for.cond1.for.inc9_crit_edge.us.i.i:              ; preds = %for.body3.us.i.i.epil, %if.then.us.i.i.epil, %for.cond1.for.inc9_crit_edge.us.i.i.unr-lcssa
  ...
  br i1 %exitcond154.not.i.i, label %for.cond12.preheader.i.i, label %for.cond1.preheader.us.i.i

for.cond12.preheader.i.i:                         ; preds = %for.cond1.for.inc9_crit_edge.us.i.i
  %arrayidx922.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 37, i64 %indvars.iv3277.i
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(92) %arrayidx922.i, i8 0, i64 92, i1 false)
  br i1 %793, label %for.cond34.preheader.loopexit.i.i.unr-lcssa, label %for.body24.i.i

for.cond34.preheader.loopexit.i.i.unr-lcssa:      ; preds = %for.body24.i.i, %for.cond12.preheader.i.i
  %indvars.iv158.i.i.unr = phi i64 [ 0, %for.cond12.preheader.i.i ], [ %indvars.iv.next159.i.i.1, %for.body24.i.i ]
  br i1 %lcmp.mod554.not, label %for.cond34.preheader.loopexit.i.i, label %for.body24.i.i.epil
...
for.body24.i.i.epil:                              ; preds = %for.cond34.preheader.loopexit.i.i.unr-lcssa
  ...
  %923 = load i8, ptr %arrayidx26.i.i.epil, align 1
  %conv27.i.i.epil = zext i8 %923 to i64
  %add.i.i106.epil = add nuw nsw i64 %conv27.i.i.epil, 1
  %arrayidx29.i.i.epil = getelementptr inbounds i32, ptr %arrayidx922.i, i64 %add.i.i106.epil
  %924 = load i32, ptr %arrayidx29.i.i.epil, align 4
  %inc30.i.i.epil = add nsw i32 %924, 1
  store i32 %inc30.i.i.epil, ptr %arrayidx29.i.i.epil, align 4
...
for.cond34.preheader.i.i:                         ; preds = %for.cond34.preheader.loopexit.i.i, %for.cond12.preheader.i.thread.i
  ...
  %arrayidx9194302.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 36, i64 %indvars.iv3277.i
  %arrayidx41.i.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 37, i64 %indvars.iv3277.i, i64 1
  store i32 %946, ptr %arrayidx41.i.i, align 4
  ...
  store i32 %add42.1.i.i, ptr %arrayidx41.1.i.i, align 4
  ...
  store i32 %add42.2.i.i, ptr %arrayidx41.2.i.i, align 4
  ...
  store i32 %add42.3.i.i, ptr %arrayidx41.3.i.i, align 4
  ...
  store i32 %add42.4.i.i, ptr %arrayidx41.4.i.i, align 4
  ...
  store i32 %add42.5.i.i, ptr %arrayidx41.5.i.i, align 4
  ...
  store i32 %add42.6.i.i, ptr %arrayidx41.6.i.i, align 4
  ...
  store i32 %add42.7.i.i, ptr %arrayidx41.7.i.i, align 4
  ...
  store i32 %add42.8.i.i, ptr %arrayidx41.8.i.i, align 4
  ...
  store i32 %add42.9.i.i, ptr %arrayidx41.9.i.i, align 4
  ...
  store i32 %add42.10.i.i, ptr %arrayidx41.10.i.i, align 4
  ...
  store i32 %add42.11.i.i, ptr %arrayidx41.11.i.i, align 4
  ...
  store i32 %add42.12.i.i, ptr %arrayidx41.12.i.i, align 4
  ...
  store i32 %add42.13.i.i, ptr %arrayidx41.13.i.i, align 4
  ...
  store i32 %add42.14.i.i, ptr %arrayidx41.14.i.i, align 4
  ...
  store i32 %add42.15.i.i, ptr %arrayidx41.15.i.i, align 4
  ...
  store i32 %add42.16.i.i, ptr %arrayidx41.16.i.i, align 4
  ...
  store i32 %add42.17.i.i, ptr %arrayidx41.17.i.i, align 4
  ...
  store i32 %add42.18.i.i, ptr %arrayidx41.18.i.i, align 4
  ...
  store i32 %add42.19.i.i, ptr %arrayidx41.19.i.i, align 4
  ...
  store i32 %add42.20.i.i, ptr %arrayidx41.20.i.i, align 4
  ...
  store i32 %add42.21.i.i, ptr %arrayidx41.21.i.i, align 4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(92) %arrayidx9194302.i, i8 0, i64 92, i1 false)
  br i1 %cmp8803118.i, label %for.cond73.preheader.i.i, label %for.body58.preheader.i.i

for.body24.i.i:                                   ; preds = %for.cond12.preheader.i.i, %for.body24.i.i
  %indvars.iv158.i.i = phi i64 [ %indvars.iv.next159.i.i.1, %for.body24.i.i ], [ 0, %for.cond12.preheader.i.i ]
  %niter556 = phi i64 [ %niter556.next.1, %for.body24.i.i ], [ 0, %for.cond12.preheader.i.i ]
  %arrayidx26.i.i = getelementptr inbounds i8, ptr %arrayidx929.i, i64 %indvars.iv158.i.i
  %947 = load i8, ptr %arrayidx26.i.i, align 1
  %conv27.i.i = zext i8 %947 to i64
  %add.i.i106 = add nuw nsw i64 %conv27.i.i, 1
  %arrayidx29.i.i = getelementptr inbounds i32, ptr %arrayidx922.i, i64 %add.i.i106
  %948 = load i32, ptr %arrayidx29.i.i, align 4
  %inc30.i.i = add nsw i32 %948, 1
  store i32 %inc30.i.i, ptr %arrayidx29.i.i, align 4
  ...
  %949 = load i8, ptr %arrayidx26.i.i.1, align 1
  %conv27.i.i.1 = zext i8 %949 to i64
  %add.i.i106.1 = add nuw nsw i64 %conv27.i.i.1, 1
  %arrayidx29.i.i.1 = getelementptr inbounds i32, ptr %arrayidx922.i, i64 %add.i.i106.1
  %950 = load i32, ptr %arrayidx29.i.i.1, align 4
  %inc30.i.i.1 = add nsw i32 %950, 1
  store i32 %inc30.i.i.1, ptr %arrayidx29.i.i.1, align 4
  %indvars.iv.next159.i.i.1 = add nuw nsw i64 %indvars.iv158.i.i, 2
  %niter556.next.1 = add i64 %niter556, 2
  %niter556.ncmp.1 = icmp eq i64 %niter556.next.1, %unroll_iter555
  br i1 %niter556.ncmp.1, label %for.cond34.preheader.loopexit.i.i.unr-lcssa, label %for.body24.i.i
...
for.body58.preheader.i.i:                         ; preds = %for.cond34.preheader.i.i
  ...
  %952 = zext i32 %minLen.0.lcssa4300.i to i64
  %arrayidx63.i.phi.trans.insert.i = getelementptr inbounds i32, ptr %951, i64 %952
  %.pre3427.i = load i32, ptr %arrayidx63.i.phi.trans.insert.i, align 4
  %953 = add i32 %maxLen.0.lcssa4298.i, 1
  %954 = sub i32 %953, %minLen.0.lcssa4300.i
  %xtraiter557 = and i32 %954, 1
  %955 = icmp eq i32 %maxLen.0.lcssa4298.i, %minLen.0.lcssa4300.i
...
for.cond73.preheader.i.i.loopexit.unr-lcssa:      ; preds = %for.body58.i.i, %for.body58.preheader.i.i
  ...
  %lcmp.mod558.not = icmp eq i32 %xtraiter557, 0
  br i1 %lcmp.mod558.not, label %for.cond73.preheader.i.i, label %for.body58.i.i.epil
...
for.body58.i.i.epil:                              ; preds = %for.cond73.preheader.i.i.loopexit.unr-lcssa
  ...
  %956 = load i32, ptr %arrayidx61.i.i.epil, align 4
  ...
  %arrayidx68.i.i.epil = getelementptr inbounds i32, ptr %arrayidx9194302.i, i64 %indvars.iv171.i.i.unr
  store i32 %sub66.i.i.epil, ptr %arrayidx68.i.i.epil, align 4
...
for.cond73.preheader.i.i:                         ; preds = %for.body58.i.i.epil, %for.cond73.preheader.i.i.loopexit.unr-lcssa, %for.cond34.preheader.i.i
  %cmp74.not.not150.i.i = icmp slt i32 %minLen.0.lcssa4300.i, %maxLen.0.lcssa4298.i
...
for.body76.preheader.i.i:                         ; preds = %for.cond73.preheader.i.i
  %957 = zext i32 %minLen.0.lcssa4300.i to i64
  %wide.trip.count178.i.i = zext i32 %maxLen.0.lcssa4298.i to i64
...
vector.body346:                                   ; preds = %vector.body346, %vector.ph340
  ...
  %offset.idx348 = add i64 %index347, %957
  %960 = add nuw nsw i64 %offset.idx348, 1
  %961 = getelementptr inbounds i32, ptr %arrayidx9194302.i, i64 %offset.idx348
  %wide.load349 = load <4 x i32>, ptr %961, align 4
  %962 = shl <4 x i32> %wide.load349, <i32 1, i32 1, i32 1, i32 1>
  %963 = add <4 x i32> %962, <i32 2, i32 2, i32 2, i32 2>
  %964 = getelementptr inbounds i32, ptr %958, i64 %960
  %wide.load350 = load <4 x i32>, ptr %964, align 4
  %965 = sub <4 x i32> %963, %wide.load350
  store <4 x i32> %965, ptr %964, align 4
  %index.next351 = add nuw i64 %index347, 4
  %966 = icmp eq i64 %index.next351, %n.vec342
  br i1 %966, label %middle.block337, label %vector.body346

middle.block337:                                  ; preds = %vector.body346
  %cmp.n345 = icmp eq i64 %959, %n.vec342
...
for.body76.i.i.preheader:                         ; preds = %for.body76.preheader.i.i, %middle.block337
  %indvars.iv175.i.i.ph = phi i64 [ %957, %for.body76.preheader.i.i ], [ %ind.end343, %middle.block337 ]
...
for.body58.i.i:                                   ; preds = %for.body58.i.i, %for.body58.preheader.i.i.new
  ...
  %niter560 = phi i32 [ 0, %for.body58.preheader.i.i.new ], [ %niter560.next.1, %for.body58.i.i ]
  ...
  %968 = load i32, ptr %arrayidx61.i.i, align 4
  %sub64.i.i = sub nsw i32 %968, %967
  %add65.i.i = add nsw i32 %sub64.i.i, %vec.0149.i.i
  %sub66.i.i = add nsw i32 %add65.i.i, -1
  %arrayidx68.i.i = getelementptr inbounds i32, ptr %arrayidx9194302.i, i64 %indvars.iv171.i.i
  store i32 %sub66.i.i, ptr %arrayidx68.i.i, align 4
  ...
  %969 = load i32, ptr %arrayidx61.i.i.1, align 4
  %sub64.i.i.1 = sub nsw i32 %969, %968
  %add65.i.i.1 = add nsw i32 %sub64.i.i.1, %shl.i.i
  %sub66.i.i.1 = add nsw i32 %add65.i.i.1, -1
  %arrayidx68.i.i.1 = getelementptr inbounds i32, ptr %arrayidx9194302.i, i64 %indvars.iv.next172.i.i
  store i32 %sub66.i.i.1, ptr %arrayidx68.i.i.1, align 4
  %shl.i.i.1 = shl i32 %add65.i.i.1, 1
  %niter560.next.1 = add i32 %niter560, 2
  %niter560.ncmp.1 = icmp eq i32 %niter560.next.1, %unroll_iter559
  br i1 %niter560.ncmp.1, label %for.cond73.preheader.i.i.loopexit.unr-lcssa, label %for.body58.i.i
...
for.body76.i.i:                                   ; preds = %for.body76.i.i.preheader, %for.body76.i.i
  ...
  %arrayidx79.i.i = getelementptr inbounds i32, ptr %arrayidx9194302.i, i64 %indvars.iv175.i.i
  %970 = load i32, ptr %arrayidx79.i.i, align 4
  ...
  %971 = load i32, ptr %arrayidx83.i.i, align 4
  %sub84.i.i = sub i32 %shl81.i.i, %971
  store i32 %sub84.i.i, ptr %arrayidx83.i.i, align 4
  %exitcond179.not.i.i = icmp eq i64 %indvars.iv.next176.i.i, %wide.trip.count178.i.i
  br i1 %exitcond179.not.i.i, label %CreateDecodeTables.exit.i, label %for.body76.i.i
...
CreateDecodeTables.exit.i:                        ; preds = %for.body76.i.i, %middle.block337, %for.cond73.preheader.i.i
  ...
  store i32 %minLen.0.lcssa4300.i, ptr %arrayidx932.i, align 4
  ...
  br i1 %exitcond3282.not.i, label %for.end935.i, label %for.cond879.preheader.i
...
for.end935.i:                                     ; preds = %CreateDecodeTables.exit.i, %for.cond875.preheader.i
  ...
  %972 = load i32, ptr %nInUse.i.i, align 8
  %973 = load i32, ptr %blockSize100k.i, align 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1024) %scevgep3283.i, i8 0, i64 1024, i1 false)
...
for.cond953.preheader.i:                          ; preds = %for.cond953.preheader.i, %for.end935.i
  ...
  store i8 %conv959.i, ptr %arrayidx961.i, align 1
  ...
  store i8 %conv959.1.i, ptr %arrayidx961.1.i, align 1
  ...
  store i8 %conv959.2.i, ptr %arrayidx961.2.i, align 1
  ...
  store <4 x i8> %976, ptr %arrayidx961.6.i, align 1
  ...
  store <8 x i8> %979, ptr %arrayidx961.14.i, align 1
  ...
  store i8 %mul957.i, ptr %arrayidx961.15.i, align 1
  ...
  store i32 %980, ptr %arrayidx968.i, align 4
  %indvars.iv.next3296.i = add nsw i64 %indvars.iv3295.i, -1
  %cmp950.not.i = icmp eq i64 %indvars.iv3295.i, 0
  br i1 %cmp950.not.i, label %if.then974.i, label %for.cond953.preheader.i
...
if.end999.i:                                      ; preds = %if.then974.i
  %981 = load i8, ptr %selector980.i, align 1
  ...
  %982 = load i32, ptr %arrayidx986.i, align 4
  %conv983.i = zext i8 %981 to i32
  br label %sw.bb1001.i

sw.bb1001.i:                                      ; preds = %if.end999.i, %if.end.i86
  %983 = phi i32 [ %.pre3402.i, %if.end.i86 ], [ %777, %if.end999.i ]
  %984 = phi i32 [ %.pre3405.i, %if.end.i86 ], [ %780, %if.end999.i ]
  %985 = phi i32 [ %.pre3406.i, %if.end.i86 ], [ %781, %if.end999.i ]
  %986 = phi i32 [ %.pre3408.i, %if.end.i86 ], [ %782, %if.end999.i ]
  %987 = phi i32 [ %.pre3410.i, %if.end.i86 ], [ %784, %if.end999.i ]
  %988 = phi i32 [ %.pre3411.i, %if.end.i86 ], [ %785, %if.end999.i ]
  %gSel.1.i = phi i32 [ %.pre3412.i, %if.end.i86 ], [ %conv983.i, %if.end999.i ]
  %gMinlen.1.i = phi i32 [ %.pre3413.i, %if.end.i86 ], [ %982, %if.end999.i ]
  %gLimit.1.i = phi ptr [ %.pre3414.i, %if.end.i86 ], [ %arrayidx989.i, %if.end999.i ]
  %gBase.1.i = phi ptr [ %.pre3415.i, %if.end.i86 ], [ %arrayidx997.i, %if.end999.i ]
  %gPerm.1.i = phi ptr [ %.pre3416.i, %if.end.i86 ], [ %arrayidx993.i, %if.end999.i ]
  %zn.0.i = phi i32 [ %.pre3409.i, %if.end.i86 ], [ %982, %if.end999.i ]
  %curr.7.i = phi i32 [ %.pre3407.i, %if.end.i86 ], [ %curr.0.i, %if.end999.i ]
  %nblock.0.i = phi i32 [ %.pre3404.i, %if.end.i86 ], [ 0, %if.end999.i ]
  %nblockMAX.0.i = phi i32 [ %.pre3403.i, %if.end.i86 ], [ %mul939.i, %if.end999.i ]
  %groupPos.1.i = phi i32 [ %.pre3401.i, %if.end.i86 ], [ 49, %if.end999.i ]
  %groupNo.1.i = phi i32 [ %.pre3400.i, %if.end.i86 ], [ 0, %if.end999.i ]
  %EOB.0.i = phi i32 [ %.pre3399.i, %if.end.i86 ], [ %add937.i, %if.end999.i ]
  %nSelectors.9.i = phi i32 [ %.pre3398.i, %if.end.i86 ], [ %nSelectors.3.i, %if.end999.i ]
  %nGroups.10.i = phi i32 [ %.pre3397.i, %if.end.i86 ], [ %nGroups.4.i, %if.end999.i ]
  %alphaSize.11.i = phi i32 [ %.pre3396.i, %if.end.i86 ], [ %alphaSize.5.i, %if.end999.i ]
  %t.7.i = phi i32 [ %.pre3395.i, %if.end.i86 ], [ %t.6.lcssa.i, %if.end999.i ]
  %j.15.i = phi i32 [ %.pre3394.i, %if.end.i86 ], [ %j.9.i, %if.end999.i ]
  %i.21.i = phi i32 [ %.pre.i87, %if.end.i86 ], [ 256, %if.end999.i ]
  store i32 36, ptr %state8, align 8
  %bsLive1005.promoted.i = load i32, ptr %bsLive1264.phi.trans.insert.i, align 4
...
sw.bb1001.if.then1008_crit_edge.i:                ; preds = %sw.bb1001.i
  %.pre3428.i = load i32, ptr %bsBuff77.i, align 8
...
if.end1019.lr.ph.i:                               ; preds = %sw.bb1001.i
  ...
  %avail_in1021.promoted.i = load i32, ptr %avail_in1021.i, align 8
...
if.then1008.i:                                    ; preds = %if.end1052.i, %sw.bb1001.if.then1008_crit_edge.i
  ...
  %notmask.i = shl nsw i32 -1, %zn.0.i
  %sub1015.i = xor i32 %notmask.i, -1
  %and1016.i = and i32 %shr1013.i, %sub1015.i
  store i32 %sub1012.i, ptr %bsLive1264.phi.trans.insert.i, align 4
...
if.end1025.i:                                     ; preds = %if.end1019.i
  %991 = load i32, ptr %bsBuff77.i, align 8
  ...
  store i32 %or1031.i, ptr %bsBuff77.i, align 8
  %add1034.i = add nsw i32 %add103431323134.i, 8
  store i32 %add1034.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %incdec.ptr1037.i = getelementptr inbounds i8, ptr %992, i64 1
  store ptr %incdec.ptr1037.i, ptr %989, align 8
  %dec1040.i = add i32 %dec10403137.i, -1
  store i32 %dec1040.i, ptr %avail_in1021.i, align 8
  %994 = load i32, ptr %total_in_lo321042.i, align 4
  %inc1043.i = add i32 %994, 1
  store i32 %inc1043.i, ptr %total_in_lo321042.i, align 4
  %cmp1046.i = icmp eq i32 %inc1043.i, 0
  br i1 %cmp1046.i, label %if.then1048.i, label %if.end1052.i

if.then1048.i:                                    ; preds = %if.end1025.i
  %995 = load i32, ptr %total_in_hi321050.i, align 8
  %inc1051.i = add i32 %995, 1
  store i32 %inc1051.i, ptr %total_in_hi321050.i, align 8
...
if.end1059.i:                                     ; preds = %while.cond1054.i
  ...
  %1000 = load i32, ptr %arrayidx1061.i, align 4
...
sw.bb1067.i:                                      ; preds = %if.end1065.i, %if.end.sw.bb1067_crit_edge.i
  ...
  store i32 37, ptr %state8, align 8
...
sw.bb1067.if.then1074_crit_edge.i:                ; preds = %sw.bb1067.i
  %.pre3443.i = load i32, ptr %bsBuff77.i, align 8
...
if.end1083.lr.ph.i:                               ; preds = %sw.bb1067.i
  ...
  %avail_in1085.promoted.i = load i32, ptr %avail_in1085.i, align 8
...
if.then1074.i:                                    ; preds = %if.end1116.i, %sw.bb1067.if.then1074_crit_edge.i
  ...
  store i32 %sub1078.i, ptr %bsLive1264.phi.trans.insert.i, align 4
...
if.end1089.i:                                     ; preds = %if.end1083.i
  %1007 = load i32, ptr %bsBuff77.i, align 8
  ...
  store i32 %or1095.i, ptr %bsBuff77.i, align 8
  %add1098.i = add nsw i32 %add109831953197.i, 8
  store i32 %add1098.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %incdec.ptr1101.i = getelementptr inbounds i8, ptr %1008, i64 1
  store ptr %incdec.ptr1101.i, ptr %1005, align 8
  %dec1104.i = add i32 %dec11043200.i, -1
  store i32 %dec1104.i, ptr %avail_in1085.i, align 8
  %1010 = load i32, ptr %total_in_lo321106.i, align 4
  %inc1107.i = add i32 %1010, 1
  store i32 %inc1107.i, ptr %total_in_lo321106.i, align 4
  %cmp1110.i = icmp eq i32 %inc1107.i, 0
  br i1 %cmp1110.i, label %if.then1112.i, label %if.end1116.i

if.then1112.i:                                    ; preds = %if.end1089.i
  %1011 = load i32, ptr %total_in_hi321114.i, align 8
  %inc1115.i = add i32 %1011, 1
  store i32 %inc1115.i, ptr %total_in_hi321114.i, align 8
...
while.end1120.i:                                  ; preds = %if.end1059.i
  ...
  %1012 = load i32, ptr %arrayidx1122.i, align 4
...
if.end1133.i:                                     ; preds = %while.end1120.i
  ...
  %1013 = load i32, ptr %arrayidx1138.i, align 4
...
if.end1172.i:                                     ; preds = %if.then1167.i
  ...
  %1016 = load i8, ptr %arrayidx1175.i, align 1
  ...
  %1017 = load i32, ptr %arrayidx1179.i, align 4
...
sw.bb1194.i:                                      ; preds = %if.end1192.i, %if.end.i86
  %1018 = phi i32 [ %1015, %if.end1192.i ], [ %.pre3408.i, %if.end.i86 ]
  %zj.4.i = phi i32 [ %zj.3.i, %if.end1192.i ], [ %.pre3411.i, %if.end.i86 ]
  %gSel.7.i = phi i32 [ %gSel.6.i, %if.end1192.i ], [ %.pre3412.i, %if.end.i86 ]
  %gMinlen.7.i = phi i32 [ %gMinlen.6.i, %if.end1192.i ], [ %.pre3413.i, %if.end.i86 ]
  %gLimit.7.i = phi ptr [ %gLimit.6.i, %if.end1192.i ], [ %.pre3414.i, %if.end.i86 ]
  %gBase.7.i = phi ptr [ %gBase.6.i, %if.end1192.i ], [ %.pre3415.i, %if.end.i86 ]
  %gPerm.7.i = phi ptr [ %gPerm.6.i, %if.end1192.i ], [ %.pre3416.i, %if.end.i86 ]
  %zvec.4.i = phi i32 [ %zvec.3.i, %if.end1192.i ], [ %.pre3410.i, %if.end.i86 ]
  %zn.5.i = phi i32 [ %gMinlen.6.i, %if.end1192.i ], [ %.pre3409.i, %if.end.i86 ]
  %curr.12.i = phi i32 [ %curr.11.i, %if.end1192.i ], [ %.pre3407.i, %if.end.i86 ]
  %N.2.i = phi i32 [ %mul1160.i, %if.end1192.i ], [ %.pre3406.i, %if.end.i86 ]
  %es.3.i = phi i32 [ %es.2.i, %if.end1192.i ], [ %.pre3405.i, %if.end.i86 ]
  %nblock.5.i = phi i32 [ %nblock.4.i, %if.end1192.i ], [ %.pre3404.i, %if.end.i86 ]
  %nblockMAX.5.i = phi i32 [ %nblockMAX.4.i, %if.end1192.i ], [ %.pre3403.i, %if.end.i86 ]
  %nextSym.2.i = phi i32 [ %nextSym.1.i, %if.end1192.i ], [ %.pre3402.i, %if.end.i86 ]
  %groupPos.7.i = phi i32 [ %dec1193.i, %if.end1192.i ], [ %.pre3401.i, %if.end.i86 ]
  %groupNo.7.i = phi i32 [ %groupNo.6.i, %if.end1192.i ], [ %.pre3400.i, %if.end.i86 ]
  %EOB.5.i = phi i32 [ %EOB.4.i, %if.end1192.i ], [ %.pre3399.i, %if.end.i86 ]
  %nSelectors.14.i = phi i32 [ %nSelectors.13.i, %if.end1192.i ], [ %.pre3398.i, %if.end.i86 ]
  %nGroups.15.i = phi i32 [ %nGroups.14.i, %if.end1192.i ], [ %.pre3397.i, %if.end.i86 ]
  %alphaSize.16.i = phi i32 [ %alphaSize.15.i, %if.end1192.i ], [ %.pre3396.i, %if.end.i86 ]
  %t.12.i = phi i32 [ %t.11.i, %if.end1192.i ], [ %.pre3395.i, %if.end.i86 ]
  %j.20.i = phi i32 [ %j.19.i, %if.end1192.i ], [ %.pre3394.i, %if.end.i86 ]
  %i.26.i = phi i32 [ %i.25.i, %if.end1192.i ], [ %.pre.i87, %if.end.i86 ]
  store i32 38, ptr %state8, align 8
  %bsLive1198.promoted.i = load i32, ptr %bsLive1264.phi.trans.insert.i, align 4
...
sw.bb1194.if.then1201_crit_edge.i:                ; preds = %sw.bb1194.i
  %.pre3433.i = load i32, ptr %bsBuff77.i, align 8
...
if.end1212.lr.ph.i:                               ; preds = %sw.bb1194.i
  ...
  %avail_in1214.promoted.i = load i32, ptr %avail_in1214.i, align 8
...
if.then1201.i:                                    ; preds = %if.end1245.i, %sw.bb1194.if.then1201_crit_edge.i
  ...
  %notmask2982.i = shl nsw i32 -1, %zn.5.i
  %sub1208.i = xor i32 %notmask2982.i, -1
  %and1209.i = and i32 %shr1206.i, %sub1208.i
  store i32 %sub1205.i, ptr %bsLive1264.phi.trans.insert.i, align 4
...
if.end1218.i:                                     ; preds = %if.end1212.i
  %1021 = load i32, ptr %bsBuff77.i, align 8
  ...
  store i32 %or1224.i, ptr %bsBuff77.i, align 8
  %add1227.i = add nsw i32 %add122731643166.i, 8
  store i32 %add1227.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %incdec.ptr1230.i = getelementptr inbounds i8, ptr %1022, i64 1
  store ptr %incdec.ptr1230.i, ptr %1019, align 8
  %dec1233.i = add i32 %dec12333169.i, -1
  store i32 %dec1233.i, ptr %avail_in1214.i, align 8
  %1024 = load i32, ptr %total_in_lo321235.i, align 4
  %inc1236.i = add i32 %1024, 1
  store i32 %inc1236.i, ptr %total_in_lo321235.i, align 4
  %cmp1239.i = icmp eq i32 %inc1236.i, 0
  br i1 %cmp1239.i, label %if.then1241.i, label %if.end1245.i

if.then1241.i:                                    ; preds = %if.end1218.i
  %1025 = load i32, ptr %total_in_hi321243.i, align 8
  %inc1244.i = add i32 %1025, 1
  store i32 %inc1244.i, ptr %total_in_hi321243.i, align 8
...
if.end1252.i:                                     ; preds = %while.cond1247.i
  ...
  %1027 = load i32, ptr %arrayidx1254.i, align 4
...
sw.bb1260.i:                                      ; preds = %if.end1258.i, %if.end.sw.bb1260_crit_edge.i
  ...
  store i32 39, ptr %state8, align 8
...
sw.bb1260.if.then1267_crit_edge.i:                ; preds = %sw.bb1260.i
  %.pre3436.i = load i32, ptr %bsBuff77.i, align 8
...
if.end1276.lr.ph.i:                               ; preds = %sw.bb1260.i
  ...
  %avail_in1278.promoted.i = load i32, ptr %avail_in1278.i, align 8
...
if.then1267.i:                                    ; preds = %if.end1309.i, %sw.bb1260.if.then1267_crit_edge.i
  ...
  store i32 %sub1271.i, ptr %bsLive1264.phi.trans.insert.i, align 4
...
if.end1282.i:                                     ; preds = %if.end1276.i
  %1031 = load i32, ptr %bsBuff77.i, align 8
  ...
  store i32 %or1288.i, ptr %bsBuff77.i, align 8
  %add1291.i = add nsw i32 %add129131803182.i, 8
  store i32 %add1291.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %incdec.ptr1294.i = getelementptr inbounds i8, ptr %1032, i64 1
  store ptr %incdec.ptr1294.i, ptr %1029, align 8
  %dec1297.i = add i32 %dec12973185.i, -1
  store i32 %dec1297.i, ptr %avail_in1278.i, align 8
  %1034 = load i32, ptr %total_in_lo321299.i, align 4
  %inc1300.i = add i32 %1034, 1
  store i32 %inc1300.i, ptr %total_in_lo321299.i, align 4
  %cmp1303.i = icmp eq i32 %inc1300.i, 0
  br i1 %cmp1303.i, label %if.then1305.i, label %if.end1309.i

if.then1305.i:                                    ; preds = %if.end1282.i
  %1035 = load i32, ptr %total_in_hi321307.i, align 8
  %inc1308.i = add i32 %1035, 1
  store i32 %inc1308.i, ptr %total_in_hi321307.i, align 8
...
while.end1313.i:                                  ; preds = %if.end1252.i
  ...
  %1036 = load i32, ptr %arrayidx1315.i, align 4
...
if.end1326.i:                                     ; preds = %while.end1313.i
  ...
  %1037 = load i32, ptr %arrayidx1331.i, align 4
  %1038 = icmp ult i32 %1037, 2
  br i1 %1038, label %do.body.i, label %do.end.i

do.end.i:                                         ; preds = %if.end1326.i
  %inc1336.i = add nsw i32 %es.4.i, 1
  %1039 = load i32, ptr %mtfbase1458.i, align 4
  ...
  %1040 = load i8, ptr %arrayidx1341.i, align 1
  ...
  %1041 = load i8, ptr %arrayidx1343.i, align 1
  ...
  %1042 = load i32, ptr %arrayidx1346.i, align 4
  %add1347.i = add nsw i32 %1042, %inc1336.i
  store i32 %add1347.i, ptr %arrayidx1346.i, align 4
  %1043 = load i8, ptr %smallDecompress, align 4
...
if.end1358.i:                                     ; preds = %while.body1354.i
  %1046 = load ptr, ptr %ll16.i, align 8
  %arrayidx1362.i = getelementptr inbounds i16, ptr %1046, i64 %indvars.iv3343.i
  store i16 %conv1359.i, ptr %arrayidx1362.i, align 2
  ...
  br i1 %cmp1352.i, label %while.body1354.i, label %if.end1382.loopexit3247.i
...
if.end1374.i:                                     ; preds = %while.body1370.i
  %1047 = load ptr, ptr %tt.i, align 8
  %arrayidx1378.i = getelementptr inbounds i32, ptr %1047, i64 %indvars.iv3349.i
  store i32 %conv1375.i, ptr %arrayidx1378.i, align 4
  ...
  br i1 %cmp1368.i, label %while.body1370.i, label %if.end1382.loopexit.i
...
if.then1394.i:                                    ; preds = %if.end1387.i
  %1050 = load i32, ptr %mtfbase1458.i, align 4
  ...
  %1051 = load i8, ptr %arrayidx1400.i, align 1
...
iter.check:                                       ; preds = %while.cond1439.preheader.i, %if.then1394.i
  %nn.0.lcssa4317.i = phi i32 [ %1107, %while.cond1439.preheader.i ], [ %sub1391.i, %if.then1394.i ]
  %1053 = zext i32 %nn.0.lcssa4317.i to i64
  %1054 = add i32 %nn.0.lcssa4317.i, -1
...
vector.scevcheck:                                 ; preds = %iter.check
  %1057 = add i32 %nn.0.lcssa4317.i, -1
  %1058 = add i32 %nn.0.lcssa4317.i, %1050
  %1059 = icmp ugt i32 %1057, %1058
  %1060 = add i32 %nn.0.lcssa4317.i, -1
  %1061 = add i32 %1060, %1050
  %1062 = icmp ugt i32 %1050, %1061
  %1063 = zext i32 %1058 to i64
  %scevgep306 = getelementptr i8, ptr %scevgep, i64 %1063
  %1064 = zext i32 %1057 to i64
  %1065 = sub nsw i64 0, %1064
  %1066 = getelementptr i8, ptr %scevgep306, i64 %1065
  %1067 = icmp ugt ptr %1066, %scevgep306
  %1068 = zext i32 %1061 to i64
  %scevgep311 = getelementptr i8, ptr %scevgep310, i64 %1068
  %1069 = zext i32 %1057 to i64
  %1070 = sub nsw i64 0, %1069
  %1071 = getelementptr i8, ptr %scevgep311, i64 %1070
  %1072 = icmp ugt ptr %1071, %scevgep311
...
vector.memcheck:                                  ; preds = %vector.scevcheck
  %1076 = add i32 %nn.0.lcssa4317.i, -1
  %1077 = add i32 %1076, %1050
  %1078 = zext i32 %1077 to i64
  %1079 = add i64 %3, %1078
  %1080 = add i32 %nn.0.lcssa4317.i, %1050
...
vector.main.loop.iter.check:                      ; preds = %vector.memcheck
  %min.iters.check318 = icmp ult i32 %1054, 15
  br i1 %min.iters.check318, label %vec.epilog.ph, label %vector.ph319

vector.ph319:                                     ; preds = %vector.main.loop.iter.check
  %n.vec = and i64 %1056, 8589934576
  br label %vector.body320

vector.body320:                                   ; preds = %vector.body320, %vector.ph319
  %index321 = phi i64 [ 0, %vector.ph319 ], [ %index.next325, %vector.body320 ]
  %1084 = trunc i64 %index321 to i32
  %1085 = sub i32 %nn.0.lcssa4317.i, %1084
  %1086 = add i32 %1050, %1085
  %1087 = add i32 %1086, -1
  %1088 = zext i32 %1087 to i64
  %gep597 = getelementptr %struct.DState, ptr %invariant.gep596, i64 0, i32 31, i64 %1088
  %wide.load323 = load <16 x i8>, ptr %gep597, align 1
  %1089 = zext i32 %1086 to i64
  %gep599 = getelementptr %struct.DState, ptr %invariant.gep598, i64 0, i32 31, i64 %1089
  store <16 x i8> %wide.load323, ptr %gep599, align 1
  %index.next325 = add nuw i64 %index321, 16
  %1090 = icmp eq i64 %index.next325, %n.vec
  br i1 %1090, label %middle.block315, label %vector.body320

middle.block315:                                  ; preds = %vector.body320
  %cmp.n = icmp eq i64 %1056, %n.vec
  br i1 %cmp.n, label %while.end1453.i, label %vec.epilog.iter.check

vec.epilog.iter.check:                            ; preds = %middle.block315
  %ind.end328 = sub nsw i64 %1053, %n.vec
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec327 = and i64 %1056, 8589934584
  %ind.end = sub nsw i64 %1053, %n.vec327
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index331 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next336, %vec.epilog.vector.body ]
  %1091 = trunc i64 %index331 to i32
  %1092 = sub i32 %nn.0.lcssa4317.i, %1091
  %1093 = add i32 %1050, %1092
  %1094 = add i32 %1093, -1
  %1095 = zext i32 %1094 to i64
  %gep601 = getelementptr %struct.DState, ptr %invariant.gep600, i64 0, i32 31, i64 %1095
  %wide.load333 = load <8 x i8>, ptr %gep601, align 1
  %1096 = zext i32 %1093 to i64
  %gep603 = getelementptr %struct.DState, ptr %invariant.gep602, i64 0, i32 31, i64 %1096
  store <8 x i8> %wide.load333, ptr %gep603, align 1
  %index.next336 = add nuw i64 %index331, 8
  %1097 = icmp eq i64 %index.next336, %n.vec327
  br i1 %1097, label %vec.epilog.middle.block, label %vec.epilog.vector.body

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n330 = icmp eq i64 %1056, %n.vec327
...
while.body1442.i.preheader:                       ; preds = %vector.memcheck, %vector.scevcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv3339.i.ph = phi i64 [ %1053, %iter.check ], [ %1053, %vector.memcheck ], [ %1053, %vector.scevcheck ], [ %ind.end328, %vec.epilog.iter.check ], [ %ind.end, %vec.epilog.middle.block ]
  %1098 = trunc i64 %indvars.iv3339.i.ph to i32
  %xtraiter561 = and i32 %1098, 1
  %lcmp.mod562.not = icmp eq i32 %xtraiter561, 0
  br i1 %lcmp.mod562.not, label %while.body1442.i.prol.loopexit, label %while.body1442.i.prol
...
while.body1442.i.prol:                            ; preds = %while.body1442.i.preheader
  ...
  %1100 = load i8, ptr %arrayidx1447.i.prol, align 1
  ...
  store i8 %1100, ptr %arrayidx1451.i.prol, align 1
...
while.body1404.i:                                 ; preds = %while.body1404.i, %while.body1404.preheader.i
  ...
  %1103 = load i8, ptr %arrayidx1409.i, align 1
  ...
  store i8 %1103, ptr %arrayidx1412.i, align 1
  ...
  %1104 = load i8, ptr %arrayidx1416.i, align 1
  store i8 %1104, ptr %arrayidx1409.i, align 1
  ...
  %1105 = load i8, ptr %arrayidx1424.i, align 1
  store i8 %1105, ptr %arrayidx1416.i, align 1
  ...
  %1106 = load i8, ptr %arrayidx1432.i, align 1
  store i8 %1106, ptr %arrayidx1424.i, align 1
  ...
  br i1 %cmp1402.i, label %while.body1404.i, label %while.cond1439.preheader.i
...
while.body1442.i:                                 ; preds = %while.body1442.i.prol.loopexit, %while.body1442.i
  ...
  %1109 = load i8, ptr %arrayidx1447.i, align 1
  ...
  store i8 %1109, ptr %arrayidx1451.i, align 1
  ...
  %1112 = load i8, ptr %arrayidx1447.i.1, align 1
  ...
  store i8 %1112, ptr %arrayidx1451.i.1, align 1
  ...
  br i1 %cmp1440.not.i.1, label %while.end1453.i, label %while.body1442.i

while.end1453.i:                                  ; preds = %while.body1442.i.prol.loopexit, %while.body1442.i, %middle.block315, %vec.epilog.middle.block, %while.cond1439.preheader.i
  ...
  store i8 %1051, ptr %arrayidx1456.i, align 1
...
if.else1457.i:                                    ; preds = %if.end1387.i
  ...
  %1114 = load i32, ptr %arrayidx1460.i, align 4
  ...
  %1115 = load i8, ptr %arrayidx1464.i, align 1
...
while.body1471.i:                                 ; preds = %while.body1471.i, %while.body1471.preheader.i
  ...
  %1121 = load i8, ptr %arrayidx1475.i, align 1
  %arrayidx1478.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 31, i64 %indvars.iv3317.i
  store i8 %1121, ptr %arrayidx1478.i, align 1
  %1122 = load i32, ptr %arrayidx1460.i, align 4
  %1123 = sext i32 %1122 to i64
  %cmp1469.i = icmp sgt i64 %indvars.iv.next3318.i, %1123
  br i1 %cmp1469.i, label %while.body1471.i, label %while.body1488.preheader.i
...
while.body1488.preheader.i:                       ; preds = %while.body1471.i, %if.else1457.i
  ...
  store i32 %inc1484.i, ptr %arrayidx1460.i, align 4
...
while.body1488.i:                                 ; preds = %while.body1488.i, %while.body1488.preheader.i
  ...
  %1124 = load i32, ptr %arrayidx1491.i, align 4
  %dec1492.i = add nsw i32 %1124, -1
  store i32 %dec1492.i, ptr %arrayidx1491.i, align 4
  ...
  %1125 = load i32, ptr %arrayidx1497.i, align 4
  ...
  %1126 = load i8, ptr %arrayidx1501.i, align 1
  ...
  store i8 %1126, ptr %arrayidx1507.i, align 1
  %cmp1486.i = icmp sgt i64 %indvars.iv3321.i, 1
  br i1 %cmp1486.i, label %while.body1488.i, label %while.end1509.i

while.end1509.i:                                  ; preds = %while.body1488.i
  %1127 = load i32, ptr %mtfbase1458.i, align 4
  %dec1512.i = add nsw i32 %1127, -1
  store i32 %dec1512.i, ptr %mtfbase1458.i, align 4
  ...
  store i8 %1115, ptr %arrayidx1517.i, align 1
  %1128 = load i32, ptr %mtfbase1458.i, align 4
...
for.cond1527.preheader.i:                         ; preds = %while.end1509.i, %for.cond1527.preheader.i
  ...
  %1129 = load i32, ptr %arrayidx1534.i, align 4
...
if.end1553.i:                                     ; preds = %for.cond1527.preheader.i, %while.end1509.i, %while.end1453.i
  ...
  %1162 = load i8, ptr %arrayidx1557.i, align 1
  ...
  %1163 = load i32, ptr %arrayidx1559.i, align 4
  %inc1560.i = add nsw i32 %1163, 1
  store i32 %inc1560.i, ptr %arrayidx1559.i, align 4
  %1164 = load i8, ptr %smallDecompress, align 4
...
if.end1588.i:                                     ; preds = %if.then1583.i
  ...
  %1167 = load i8, ptr %arrayidx1591.i, align 1
  ...
  %1168 = load i32, ptr %arrayidx1595.i, align 4
...
sw.bb1610.i:                                      ; preds = %if.end1608.i, %if.end.i86
  %1169 = phi i32 [ %1014, %if.end1608.i ], [ %.pre3408.i, %if.end.i86 ]
  %zj.7.i = phi i32 [ %zj.2.i, %if.end1608.i ], [ %.pre3411.i, %if.end.i86 ]
  %gSel.11.i = phi i32 [ %gSel.10.i, %if.end1608.i ], [ %.pre3412.i, %if.end.i86 ]
  %gMinlen.11.i = phi i32 [ %gMinlen.10.i, %if.end1608.i ], [ %.pre3413.i, %if.end.i86 ]
  %gLimit.11.i = phi ptr [ %gLimit.10.i, %if.end1608.i ], [ %.pre3414.i, %if.end.i86 ]
  %gBase.11.i = phi ptr [ %gBase.10.i, %if.end1608.i ], [ %.pre3415.i, %if.end.i86 ]
  %gPerm.11.i = phi ptr [ %gPerm.10.i, %if.end1608.i ], [ %.pre3416.i, %if.end.i86 ]
  %zvec.7.i = phi i32 [ %zvec.2.i, %if.end1608.i ], [ %.pre3410.i, %if.end.i86 ]
  %zn.8.i = phi i32 [ %gMinlen.10.i, %if.end1608.i ], [ %.pre3409.i, %if.end.i86 ]
  %curr.15.i = phi i32 [ %curr.10.i, %if.end1608.i ], [ %.pre3407.i, %if.end.i86 ]
  %N.5.i = phi i32 [ %N.0.i, %if.end1608.i ], [ %.pre3406.i, %if.end.i86 ]
  %es.9.i = phi i32 [ %es.0.i, %if.end1608.i ], [ %.pre3405.i, %if.end.i86 ]
  %nblock.11.i = phi i32 [ %inc1580.i, %if.end1608.i ], [ %.pre3404.i, %if.end.i86 ]
  %nblockMAX.8.i = phi i32 [ %nblockMAX.3.i, %if.end1608.i ], [ %.pre3403.i, %if.end.i86 ]
  %nextSym.5.i = phi i32 [ %nextSym.0.i, %if.end1608.i ], [ %.pre3402.i, %if.end.i86 ]
  %groupPos.11.i = phi i32 [ %dec1609.i, %if.end1608.i ], [ %.pre3401.i, %if.end.i86 ]
  %groupNo.11.i = phi i32 [ %groupNo.10.i, %if.end1608.i ], [ %.pre3400.i, %if.end.i86 ]
  %EOB.8.i = phi i32 [ %EOB.3.i, %if.end1608.i ], [ %.pre3399.i, %if.end.i86 ]
  %nSelectors.17.i = phi i32 [ %nSelectors.12.i, %if.end1608.i ], [ %.pre3398.i, %if.end.i86 ]
  %nGroups.18.i = phi i32 [ %nGroups.13.i, %if.end1608.i ], [ %.pre3397.i, %if.end.i86 ]
  %alphaSize.19.i = phi i32 [ %alphaSize.14.i, %if.end1608.i ], [ %.pre3396.i, %if.end.i86 ]
  %t.15.i = phi i32 [ %t.10.i, %if.end1608.i ], [ %.pre3395.i, %if.end.i86 ]
  %j.23.i = phi i32 [ %j.18.i, %if.end1608.i ], [ %.pre3394.i, %if.end.i86 ]
  %i.29.i = phi i32 [ %i.24.i, %if.end1608.i ], [ %.pre.i87, %if.end.i86 ]
  store i32 40, ptr %state8, align 8
  %bsLive1614.promoted.i = load i32, ptr %bsLive1264.phi.trans.insert.i, align 4
...
sw.bb1610.if.then1617_crit_edge.i:                ; preds = %sw.bb1610.i
  %.pre3429.i = load i32, ptr %bsBuff77.i, align 8
...
if.end1628.lr.ph.i:                               ; preds = %sw.bb1610.i
  ...
  %avail_in1630.promoted.i = load i32, ptr %avail_in1630.i, align 8
...
if.then1617.i:                                    ; preds = %if.end1661.i, %sw.bb1610.if.then1617_crit_edge.i
  ...
  %notmask2981.i = shl nsw i32 -1, %zn.8.i
  %sub1624.i = xor i32 %notmask2981.i, -1
  %and1625.i = and i32 %shr1622.i, %sub1624.i
  store i32 %sub1621.i, ptr %bsLive1264.phi.trans.insert.i, align 4
...
if.end1634.i:                                     ; preds = %if.end1628.i
  %1172 = load i32, ptr %bsBuff77.i, align 8
  ...
  store i32 %or1640.i, ptr %bsBuff77.i, align 8
  %add1643.i = add nsw i32 %add164331523154.i, 8
  store i32 %add1643.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %incdec.ptr1646.i = getelementptr inbounds i8, ptr %1173, i64 1
  store ptr %incdec.ptr1646.i, ptr %1170, align 8
  %dec1649.i = add i32 %dec16493157.i, -1
  store i32 %dec1649.i, ptr %avail_in1630.i, align 8
  %1175 = load i32, ptr %total_in_lo321651.i, align 4
  %inc1652.i = add i32 %1175, 1
  store i32 %inc1652.i, ptr %total_in_lo321651.i, align 4
  %cmp1655.i = icmp eq i32 %inc1652.i, 0
  br i1 %cmp1655.i, label %if.then1657.i, label %if.end1661.i

if.then1657.i:                                    ; preds = %if.end1634.i
  %1176 = load i32, ptr %total_in_hi321659.i, align 8
  %inc1660.i = add i32 %1176, 1
  store i32 %inc1660.i, ptr %total_in_hi321659.i, align 8
...
if.end1668.i:                                     ; preds = %while.cond1663.i
  ...
  %1178 = load i32, ptr %arrayidx1670.i, align 4
...
sw.bb1676.i:                                      ; preds = %if.end1674.i, %if.end.sw.bb1676_crit_edge.i
  ...
  store i32 41, ptr %state8, align 8
...
sw.bb1676.if.then1683_crit_edge.i:                ; preds = %sw.bb1676.i
  %.pre3432.i = load i32, ptr %bsBuff77.i, align 8
...
if.end1692.lr.ph.i:                               ; preds = %sw.bb1676.i
  ...
  %avail_in1694.promoted.i = load i32, ptr %avail_in1694.i, align 8
...
if.then1683.i:                                    ; preds = %if.end1725.i, %sw.bb1676.if.then1683_crit_edge.i
  ...
  store i32 %sub1687.i, ptr %bsLive1264.phi.trans.insert.i, align 4
...
if.end1698.i:                                     ; preds = %if.end1692.i
  %1182 = load i32, ptr %bsBuff77.i, align 8
  ...
  store i32 %or1704.i, ptr %bsBuff77.i, align 8
  %add1707.i = add nsw i32 %add170731583160.i, 8
  store i32 %add1707.i, ptr %bsLive1264.phi.trans.insert.i, align 4
  %incdec.ptr1710.i = getelementptr inbounds i8, ptr %1183, i64 1
  store ptr %incdec.ptr1710.i, ptr %1180, align 8
  %dec1713.i = add i32 %dec17133163.i, -1
  store i32 %dec1713.i, ptr %avail_in1694.i, align 8
  %1185 = load i32, ptr %total_in_lo321715.i, align 4
  %inc1716.i = add i32 %1185, 1
  store i32 %inc1716.i, ptr %total_in_lo321715.i, align 4
  %cmp1719.i = icmp eq i32 %inc1716.i, 0
  br i1 %cmp1719.i, label %if.then1721.i, label %if.end1725.i

if.then1721.i:                                    ; preds = %if.end1698.i
  %1186 = load i32, ptr %total_in_hi321723.i, align 8
  %inc1724.i = add i32 %1186, 1
  store i32 %inc1724.i, ptr %total_in_hi321723.i, align 8
...
while.end1729.i:                                  ; preds = %if.end1668.i
  ...
  %1187 = load i32, ptr %arrayidx1731.i, align 4
...
if.end1742.i:                                     ; preds = %while.end1729.i
  ...
  %1188 = load i32, ptr %arrayidx1747.i, align 4
  br label %while.cond1139.i

while.end1748.i:                                  ; preds = %while.cond1139.i
  %1189 = load i32, ptr %origPtr.i, align 8
...
if.end1757.i:                                     ; preds = %while.end1748.i
  store i32 0, ptr %cftab.i, align 8
  %wide.load300 = load <4 x i32>, ptr %20, align 4
  %wide.load301 = load <4 x i32>, ptr %21, align 4
  store <4 x i32> %wide.load300, ptr %22, align 4
  store <4 x i32> %wide.load301, ptr %23, align 4
  %wide.load300.1 = load <4 x i32>, ptr %24, align 4
  %wide.load301.1 = load <4 x i32>, ptr %25, align 4
  store <4 x i32> %wide.load300.1, ptr %26, align 4
  store <4 x i32> %wide.load301.1, ptr %27, align 4
  %wide.load300.2 = load <4 x i32>, ptr %28, align 4
  %wide.load301.2 = load <4 x i32>, ptr %29, align 4
  store <4 x i32> %wide.load300.2, ptr %30, align 4
  store <4 x i32> %wide.load301.2, ptr %31, align 4
  %wide.load300.3 = load <4 x i32>, ptr %32, align 4
  %wide.load301.3 = load <4 x i32>, ptr %33, align 4
  store <4 x i32> %wide.load300.3, ptr %34, align 4
  store <4 x i32> %wide.load301.3, ptr %35, align 4
  %wide.load300.4 = load <4 x i32>, ptr %36, align 4
  %wide.load301.4 = load <4 x i32>, ptr %37, align 4
  store <4 x i32> %wide.load300.4, ptr %38, align 4
  store <4 x i32> %wide.load301.4, ptr %39, align 4
  %wide.load300.5 = load <4 x i32>, ptr %40, align 4
  %wide.load301.5 = load <4 x i32>, ptr %41, align 4
  store <4 x i32> %wide.load300.5, ptr %42, align 4
  store <4 x i32> %wide.load301.5, ptr %43, align 4
  %wide.load300.6 = load <4 x i32>, ptr %44, align 4
  %wide.load301.6 = load <4 x i32>, ptr %45, align 4
  store <4 x i32> %wide.load300.6, ptr %46, align 4
  store <4 x i32> %wide.load301.6, ptr %47, align 4
  %wide.load300.7 = load <4 x i32>, ptr %48, align 4
  %wide.load301.7 = load <4 x i32>, ptr %49, align 4
  store <4 x i32> %wide.load300.7, ptr %50, align 4
  store <4 x i32> %wide.load301.7, ptr %51, align 4
  %wide.load300.8 = load <4 x i32>, ptr %52, align 4
  %wide.load301.8 = load <4 x i32>, ptr %53, align 4
  store <4 x i32> %wide.load300.8, ptr %54, align 4
  store <4 x i32> %wide.load301.8, ptr %55, align 4
  %wide.load300.9 = load <4 x i32>, ptr %56, align 4
  %wide.load301.9 = load <4 x i32>, ptr %57, align 4
  store <4 x i32> %wide.load300.9, ptr %58, align 4
  store <4 x i32> %wide.load301.9, ptr %59, align 4
  %wide.load300.10 = load <4 x i32>, ptr %60, align 4
  %wide.load301.10 = load <4 x i32>, ptr %61, align 4
  store <4 x i32> %wide.load300.10, ptr %62, align 4
  store <4 x i32> %wide.load301.10, ptr %63, align 4
  %wide.load300.11 = load <4 x i32>, ptr %64, align 4
  %wide.load301.11 = load <4 x i32>, ptr %65, align 4
  store <4 x i32> %wide.load300.11, ptr %66, align 4
  store <4 x i32> %wide.load301.11, ptr %67, align 4
  %wide.load300.12 = load <4 x i32>, ptr %68, align 4
  %wide.load301.12 = load <4 x i32>, ptr %69, align 4
  store <4 x i32> %wide.load300.12, ptr %70, align 4
  store <4 x i32> %wide.load301.12, ptr %71, align 4
  %wide.load300.13 = load <4 x i32>, ptr %72, align 4
  %wide.load301.13 = load <4 x i32>, ptr %73, align 4
  store <4 x i32> %wide.load300.13, ptr %74, align 4
  store <4 x i32> %wide.load301.13, ptr %75, align 4
  %wide.load300.14 = load <4 x i32>, ptr %76, align 4
  %wide.load301.14 = load <4 x i32>, ptr %77, align 4
  store <4 x i32> %wide.load300.14, ptr %78, align 4
  store <4 x i32> %wide.load301.14, ptr %79, align 4
  %wide.load300.15 = load <4 x i32>, ptr %80, align 4
  %wide.load301.15 = load <4 x i32>, ptr %81, align 4
  store <4 x i32> %wide.load300.15, ptr %82, align 4
  store <4 x i32> %wide.load301.15, ptr %83, align 4
  %wide.load300.16 = load <4 x i32>, ptr %84, align 4
  %wide.load301.16 = load <4 x i32>, ptr %85, align 4
  store <4 x i32> %wide.load300.16, ptr %86, align 4
  store <4 x i32> %wide.load301.16, ptr %87, align 4
  %wide.load300.17 = load <4 x i32>, ptr %88, align 4
  %wide.load301.17 = load <4 x i32>, ptr %89, align 4
  store <4 x i32> %wide.load300.17, ptr %90, align 4
  store <4 x i32> %wide.load301.17, ptr %91, align 4
  %wide.load300.18 = load <4 x i32>, ptr %92, align 4
  %wide.load301.18 = load <4 x i32>, ptr %93, align 4
  store <4 x i32> %wide.load300.18, ptr %94, align 4
  store <4 x i32> %wide.load301.18, ptr %95, align 4
  %wide.load300.19 = load <4 x i32>, ptr %96, align 4
  %wide.load301.19 = load <4 x i32>, ptr %97, align 4
  store <4 x i32> %wide.load300.19, ptr %98, align 4
  store <4 x i32> %wide.load301.19, ptr %99, align 4
  %wide.load300.20 = load <4 x i32>, ptr %100, align 4
  %wide.load301.20 = load <4 x i32>, ptr %101, align 4
  store <4 x i32> %wide.load300.20, ptr %102, align 4
  store <4 x i32> %wide.load301.20, ptr %103, align 4
  %wide.load300.21 = load <4 x i32>, ptr %104, align 4
  %wide.load301.21 = load <4 x i32>, ptr %105, align 4
  store <4 x i32> %wide.load300.21, ptr %106, align 4
  store <4 x i32> %wide.load301.21, ptr %107, align 4
  %wide.load300.22 = load <4 x i32>, ptr %108, align 4
  %wide.load301.22 = load <4 x i32>, ptr %109, align 4
  store <4 x i32> %wide.load300.22, ptr %110, align 4
  store <4 x i32> %wide.load301.22, ptr %111, align 4
  %wide.load300.23 = load <4 x i32>, ptr %112, align 4
  %wide.load301.23 = load <4 x i32>, ptr %113, align 4
  store <4 x i32> %wide.load300.23, ptr %114, align 4
  store <4 x i32> %wide.load301.23, ptr %115, align 4
  %wide.load300.24 = load <4 x i32>, ptr %116, align 4
  %wide.load301.24 = load <4 x i32>, ptr %117, align 4
  store <4 x i32> %wide.load300.24, ptr %118, align 4
  store <4 x i32> %wide.load301.24, ptr %119, align 4
  %wide.load300.25 = load <4 x i32>, ptr %120, align 4
  %wide.load301.25 = load <4 x i32>, ptr %121, align 4
  store <4 x i32> %wide.load300.25, ptr %122, align 4
  store <4 x i32> %wide.load301.25, ptr %123, align 4
  %wide.load300.26 = load <4 x i32>, ptr %124, align 4
  %wide.load301.26 = load <4 x i32>, ptr %125, align 4
  store <4 x i32> %wide.load300.26, ptr %126, align 4
  store <4 x i32> %wide.load301.26, ptr %127, align 4
  %wide.load300.27 = load <4 x i32>, ptr %128, align 4
  %wide.load301.27 = load <4 x i32>, ptr %129, align 4
  store <4 x i32> %wide.load300.27, ptr %130, align 4
  store <4 x i32> %wide.load301.27, ptr %131, align 4
  %wide.load300.28 = load <4 x i32>, ptr %132, align 4
  %wide.load301.28 = load <4 x i32>, ptr %133, align 4
  store <4 x i32> %wide.load300.28, ptr %134, align 4
  store <4 x i32> %wide.load301.28, ptr %135, align 4
  %wide.load300.29 = load <4 x i32>, ptr %136, align 4
  %wide.load301.29 = load <4 x i32>, ptr %137, align 4
  store <4 x i32> %wide.load300.29, ptr %138, align 4
  store <4 x i32> %wide.load301.29, ptr %139, align 4
  %wide.load300.30 = load <4 x i32>, ptr %140, align 4
  %wide.load301.30 = load <4 x i32>, ptr %141, align 4
  store <4 x i32> %wide.load300.30, ptr %142, align 4
  store <4 x i32> %wide.load301.30, ptr %143, align 4
  %wide.load300.31 = load <4 x i32>, ptr %144, align 4
  %wide.load301.31 = load <4 x i32>, ptr %145, align 4
  store <4 x i32> %wide.load300.31, ptr %146, align 4
  store <4 x i32> %wide.load301.31, ptr %147, align 4
...
for.body1776.i:                                   ; preds = %for.body1776.i, %if.end1757.i
  ...
  %1191 = load i32, ptr %arrayidx1783.i, align 4
  %add1784.i = add nsw i32 %1191, %1190
  store i32 %add1784.i, ptr %arrayidx1783.i, align 4
  ...
  %1192 = load i32, ptr %arrayidx1783.i.1, align 4
  %add1784.i.1 = add nsw i32 %1192, %add1784.i
  store i32 %add1784.i.1, ptr %arrayidx1783.i.1, align 4
  ...
  %1193 = load i32, ptr %arrayidx1783.i.2, align 4
  %add1784.i.2 = add nsw i32 %1193, %add1784.i.1
  store i32 %add1784.i.2, ptr %arrayidx1783.i.2, align 4
  ...
  %1194 = load i32, ptr %arrayidx1783.i.3, align 4
  %add1784.i.3 = add nsw i32 %1194, %add1784.i.2
  store i32 %add1784.i.3, ptr %arrayidx1783.i.3, align 4
  %indvars.iv.next3365.i.3 = add nuw nsw i64 %indvars.iv3364.i, 4
  %exitcond3369.not.i.3 = icmp eq i64 %indvars.iv.next3365.i.3, 257
  br i1 %exitcond3369.not.i.3, label %for.body1791.i, label %for.body1776.i
...
for.body1791.i:                                   ; preds = %for.body1776.i, %for.inc1805.i.3
  ...
  %1195 = load i32, ptr %arrayidx1794.i, align 4
...
for.inc1805.i:                                    ; preds = %for.body1791.i
  ...
  br i1 %exitcond3374.not.i, label %for.end1807.i, label %for.body1791.i.1
...
for.body1791.i.1:                                 ; preds = %for.inc1805.i
  ...
  %1196 = load i32, ptr %arrayidx1794.i.1, align 4
...
for.inc1805.i.1:                                  ; preds = %for.body1791.i.1
  ...
  %1197 = load i32, ptr %arrayidx1794.i.2, align 4
...
for.inc1805.i.2:                                  ; preds = %for.inc1805.i.1
  ...
  %1198 = load i32, ptr %arrayidx1794.i.3, align 4
...
for.end1807.i:                                    ; preds = %for.inc1805.i
  store i32 0, ptr %state_out_len.i, align 8
  store i8 0, ptr %state_out_ch.i, align 4
  store i32 2, ptr %state8, align 8
  %1199 = load i8, ptr %smallDecompress, align 4
...
vector.body:                                      ; preds = %for.end1807.i
  %wide.load = load <4 x i32>, ptr %148, align 4
  %wide.load293 = load <4 x i32>, ptr %149, align 4
  store <4 x i32> %wide.load, ptr %150, align 4
  store <4 x i32> %wide.load293, ptr %151, align 4
  %wide.load.1 = load <4 x i32>, ptr %152, align 4
  %wide.load293.1 = load <4 x i32>, ptr %153, align 4
  store <4 x i32> %wide.load.1, ptr %154, align 4
  store <4 x i32> %wide.load293.1, ptr %155, align 4
  %wide.load.2 = load <4 x i32>, ptr %156, align 4
  %wide.load293.2 = load <4 x i32>, ptr %157, align 4
  store <4 x i32> %wide.load.2, ptr %158, align 4
  store <4 x i32> %wide.load293.2, ptr %159, align 4
  %wide.load.3 = load <4 x i32>, ptr %160, align 4
  %wide.load293.3 = load <4 x i32>, ptr %161, align 4
  store <4 x i32> %wide.load.3, ptr %162, align 4
  store <4 x i32> %wide.load293.3, ptr %163, align 4
  %wide.load.4 = load <4 x i32>, ptr %164, align 4
  %wide.load293.4 = load <4 x i32>, ptr %165, align 4
  store <4 x i32> %wide.load.4, ptr %166, align 4
  store <4 x i32> %wide.load293.4, ptr %167, align 4
  %wide.load.5 = load <4 x i32>, ptr %168, align 4
  %wide.load293.5 = load <4 x i32>, ptr %169, align 4
  store <4 x i32> %wide.load.5, ptr %170, align 4
  store <4 x i32> %wide.load293.5, ptr %171, align 4
  %wide.load.6 = load <4 x i32>, ptr %172, align 4
  %wide.load293.6 = load <4 x i32>, ptr %173, align 4
  store <4 x i32> %wide.load.6, ptr %174, align 4
  store <4 x i32> %wide.load293.6, ptr %175, align 4
  %wide.load.7 = load <4 x i32>, ptr %176, align 4
  %wide.load293.7 = load <4 x i32>, ptr %177, align 4
  store <4 x i32> %wide.load.7, ptr %178, align 4
  store <4 x i32> %wide.load293.7, ptr %179, align 4
  %wide.load.8 = load <4 x i32>, ptr %180, align 4
  %wide.load293.8 = load <4 x i32>, ptr %181, align 4
  store <4 x i32> %wide.load.8, ptr %182, align 4
  store <4 x i32> %wide.load293.8, ptr %183, align 4
  %wide.load.9 = load <4 x i32>, ptr %184, align 4
  %wide.load293.9 = load <4 x i32>, ptr %185, align 4
  store <4 x i32> %wide.load.9, ptr %186, align 4
  store <4 x i32> %wide.load293.9, ptr %187, align 4
  %wide.load.10 = load <4 x i32>, ptr %188, align 4
  %wide.load293.10 = load <4 x i32>, ptr %189, align 4
  store <4 x i32> %wide.load.10, ptr %190, align 4
  store <4 x i32> %wide.load293.10, ptr %191, align 4
  %wide.load.11 = load <4 x i32>, ptr %192, align 4
  %wide.load293.11 = load <4 x i32>, ptr %193, align 4
  store <4 x i32> %wide.load.11, ptr %194, align 4
  store <4 x i32> %wide.load293.11, ptr %195, align 4
  %wide.load.12 = load <4 x i32>, ptr %196, align 4
  %wide.load293.12 = load <4 x i32>, ptr %197, align 4
  store <4 x i32> %wide.load.12, ptr %198, align 4
  store <4 x i32> %wide.load293.12, ptr %199, align 4
  %wide.load.13 = load <4 x i32>, ptr %200, align 4
  %wide.load293.13 = load <4 x i32>, ptr %201, align 4
  store <4 x i32> %wide.load.13, ptr %202, align 4
  store <4 x i32> %wide.load293.13, ptr %203, align 4
  %wide.load.14 = load <4 x i32>, ptr %204, align 4
  %wide.load293.14 = load <4 x i32>, ptr %205, align 4
  store <4 x i32> %wide.load.14, ptr %206, align 4
  store <4 x i32> %wide.load293.14, ptr %207, align 4
  %wide.load.15 = load <4 x i32>, ptr %208, align 4
  %wide.load293.15 = load <4 x i32>, ptr %209, align 4
  store <4 x i32> %wide.load.15, ptr %210, align 4
  store <4 x i32> %wide.load293.15, ptr %211, align 4
  %wide.load.16 = load <4 x i32>, ptr %212, align 4
  %wide.load293.16 = load <4 x i32>, ptr %213, align 4
  store <4 x i32> %wide.load.16, ptr %214, align 4
  store <4 x i32> %wide.load293.16, ptr %215, align 4
  %wide.load.17 = load <4 x i32>, ptr %216, align 4
  %wide.load293.17 = load <4 x i32>, ptr %217, align 4
  store <4 x i32> %wide.load.17, ptr %218, align 4
  store <4 x i32> %wide.load293.17, ptr %219, align 4
  %wide.load.18 = load <4 x i32>, ptr %220, align 4
  %wide.load293.18 = load <4 x i32>, ptr %221, align 4
  store <4 x i32> %wide.load.18, ptr %222, align 4
  store <4 x i32> %wide.load293.18, ptr %223, align 4
  %wide.load.19 = load <4 x i32>, ptr %224, align 4
  %wide.load293.19 = load <4 x i32>, ptr %225, align 4
  store <4 x i32> %wide.load.19, ptr %226, align 4
  store <4 x i32> %wide.load293.19, ptr %227, align 4
  %wide.load.20 = load <4 x i32>, ptr %228, align 4
  %wide.load293.20 = load <4 x i32>, ptr %229, align 4
  store <4 x i32> %wide.load.20, ptr %230, align 4
  store <4 x i32> %wide.load293.20, ptr %231, align 4
  %wide.load.21 = load <4 x i32>, ptr %232, align 4
  %wide.load293.21 = load <4 x i32>, ptr %233, align 4
  store <4 x i32> %wide.load.21, ptr %234, align 4
  store <4 x i32> %wide.load293.21, ptr %235, align 4
  %wide.load.22 = load <4 x i32>, ptr %236, align 4
  %wide.load293.22 = load <4 x i32>, ptr %237, align 4
  store <4 x i32> %wide.load.22, ptr %238, align 4
  store <4 x i32> %wide.load293.22, ptr %239, align 4
  %wide.load.23 = load <4 x i32>, ptr %240, align 4
  %wide.load293.23 = load <4 x i32>, ptr %241, align 4
  store <4 x i32> %wide.load.23, ptr %242, align 4
  store <4 x i32> %wide.load293.23, ptr %243, align 4
  %wide.load.24 = load <4 x i32>, ptr %244, align 4
  %wide.load293.24 = load <4 x i32>, ptr %245, align 4
  store <4 x i32> %wide.load.24, ptr %246, align 4
  store <4 x i32> %wide.load293.24, ptr %247, align 4
  %wide.load.25 = load <4 x i32>, ptr %248, align 4
  %wide.load293.25 = load <4 x i32>, ptr %249, align 4
  store <4 x i32> %wide.load.25, ptr %250, align 4
  store <4 x i32> %wide.load293.25, ptr %251, align 4
  %wide.load.26 = load <4 x i32>, ptr %252, align 4
  %wide.load293.26 = load <4 x i32>, ptr %253, align 4
  store <4 x i32> %wide.load.26, ptr %254, align 4
  store <4 x i32> %wide.load293.26, ptr %255, align 4
  %wide.load.27 = load <4 x i32>, ptr %256, align 4
  %wide.load293.27 = load <4 x i32>, ptr %257, align 4
  store <4 x i32> %wide.load.27, ptr %258, align 4
  store <4 x i32> %wide.load293.27, ptr %259, align 4
  %wide.load.28 = load <4 x i32>, ptr %260, align 4
  %wide.load293.28 = load <4 x i32>, ptr %261, align 4
  store <4 x i32> %wide.load.28, ptr %262, align 4
  store <4 x i32> %wide.load293.28, ptr %263, align 4
  %wide.load.29 = load <4 x i32>, ptr %264, align 4
  %wide.load293.29 = load <4 x i32>, ptr %265, align 4
  store <4 x i32> %wide.load.29, ptr %266, align 4
  store <4 x i32> %wide.load293.29, ptr %267, align 4
  %wide.load.30 = load <4 x i32>, ptr %268, align 4
  %wide.load293.30 = load <4 x i32>, ptr %269, align 4
  store <4 x i32> %wide.load.30, ptr %270, align 4
  store <4 x i32> %wide.load293.30, ptr %271, align 4
  %wide.load.31 = load <4 x i32>, ptr %272, align 4
  %wide.load293.31 = load <4 x i32>, ptr %273, align 4
  store <4 x i32> %wide.load.31, ptr %274, align 4
  store <4 x i32> %wide.load293.31, ptr %275, align 4
  %1200 = load i32, ptr %arrayidx1825.i, align 4
  store i32 %1200, ptr %arrayidx1827.i, align 4
  %wide.trip.count3386.i = zext i32 %nblock.3.i to i64
  br label %for.body1834.i

for.cond1995.preheader.i:                         ; preds = %for.end1807.i
  %1201 = load ptr, ptr %tt.i, align 8
  %wide.trip.count3392.i = zext i32 %nblock.3.i to i64
  %xtraiter563 = and i64 %wide.trip.count3392.i, 1
...
for.cond1995.preheader.i.new:                     ; preds = %for.cond1995.preheader.i
  %unroll_iter565 = and i64 %wide.trip.count3392.i, 4294967294
...
for.body1834.i:                                   ; preds = %if.end1885.i, %vector.body
  ...
  %1203 = load ptr, ptr %ll16.i, align 8
  %arrayidx1837.i = getelementptr inbounds i16, ptr %1203, i64 %indvars.iv3382.i
  %1204 = load i16, ptr %arrayidx1837.i, align 2
  ...
  %1206 = load i32, ptr %arrayidx1841.i, align 4
  %conv1843.i = trunc i32 %1206 to i16
  store i16 %conv1843.i, ptr %arrayidx1837.i, align 2
  %and18474343.i = and i64 %indvars.iv3382.i, 1
  %cmp1848.i = icmp eq i64 %and18474343.i, 0
  %1207 = load ptr, ptr %ll4.i, align 8
  ...
  %1208 = load i8, ptr %arrayidx1854.i, align 1
...
if.end1885.i:                                     ; preds = %if.else1867.i, %if.then1850.i
  ...
  store i8 %conv1880.sink.i, ptr %arrayidx1854.i, align 1
  %1216 = load i32, ptr %arrayidx1841.i, align 4
  %inc1889.i = add nsw i32 %1216, 1
  store i32 %inc1889.i, ptr %arrayidx1841.i, align 4
  ...
  br i1 %exitcond3387.not.i, label %for.end1892.loopexit.i, label %for.body1834.i

for.end1892.loopexit.i:                           ; preds = %if.end1885.i
  %.pre3438.i = load i32, ptr %origPtr.i, align 8
  %1217 = load ptr, ptr %ll16.i, align 8
  %idxprom1895.i = sext i32 %.pre3438.i to i64
  %arrayidx1896.i = getelementptr inbounds i16, ptr %1217, i64 %idxprom1895.i
  %1218 = load i16, ptr %arrayidx1896.i, align 2
  %conv1897.i = zext i16 %1218 to i32
  %1219 = load ptr, ptr %ll4.i, align 8
  ...
  %1220 = load i8, ptr %arrayidx1901.i, align 1
...
do.body1909.i:                                    ; preds = %if.end1963.i, %for.end1892.loopexit.i
  ...
  %1224 = load i8, ptr %arrayidx1918.i, align 1
  ...
  store i16 %conv1927.i, ptr %arrayidx1913.i, align 2
  %and1931.i = and i32 %j.26.i, 1
  %cmp1932.i = icmp eq i32 %and1931.i, 0
  %1225 = load i8, ptr %arrayidx1918.i, align 1
...
if.end1963.i:                                     ; preds = %if.else1948.i, %if.then1934.i
  ...
  store i8 %storemerge.i, ptr %arrayidx1918.i, align 1
  %1233 = load i32, ptr %origPtr.i, align 8
  %cmp1966.not.i = icmp eq i32 %j.26.i, %1233
  br i1 %cmp1966.not.i, label %do.end1968.i, label %do.body1909.i

do.end1968.i:                                     ; preds = %if.end1963.i
  store i32 %j.26.i, ptr %tPos.i, align 4
  store i32 0, ptr %nblock_used.i, align 4
  br label %do.body.i.i94

do.body.i.i94:                                    ; preds = %do.body.i.i94, %do.end1968.i
  %na.0.i.i95 = phi i32 [ 256, %do.end1968.i ], [ %shr.na.0.i.i100, %do.body.i.i94 ]
  %nb.0.i.i96 = phi i32 [ 0, %do.end1968.i ], [ %nb.0.shr.i.i101, %do.body.i.i94 ]
  %add.i2992.i = add nsw i32 %nb.0.i.i96, %na.0.i.i95
  %shr.i.i97 = ashr i32 %add.i2992.i, 1
  %idxprom.i.i98 = sext i32 %shr.i.i97 to i64
  %arrayidx.i2993.i = getelementptr inbounds i32, ptr %cftab.i, i64 %idxprom.i.i98
  %1234 = load i32, ptr %arrayidx.i2993.i, align 4
  %cmp.not.i.i99 = icmp sgt i32 %1234, %j.26.i
  %shr.na.0.i.i100 = select i1 %cmp.not.i.i99, i32 %shr.i.i97, i32 %na.0.i.i95
  %nb.0.shr.i.i101 = select i1 %cmp.not.i.i99, i32 %nb.0.i.i96, i32 %shr.i.i97
  %sub.i.i102 = sub nsw i32 %shr.na.0.i.i100, %nb.0.shr.i.i101
  %cmp1.not.i.i103 = icmp eq i32 %sub.i.i102, 1
  br i1 %cmp1.not.i.i103, label %indexIntoF.exit.i104, label %do.body.i.i94

indexIntoF.exit.i104:                             ; preds = %do.body.i.i94
  store i32 %nb.0.shr.i.i101, ptr %k0.i, align 8
  %1235 = load ptr, ptr %ll16.i, align 8
  %arrayidx1976.i = getelementptr inbounds i16, ptr %1235, i64 %idxprom1912.i
  %1236 = load i16, ptr %arrayidx1976.i, align 2
  %conv1977.i = zext i16 %1236 to i32
  %1237 = load ptr, ptr %ll4.i, align 8
  %arrayidx1982.i = getelementptr inbounds i8, ptr %1237, i64 %idxprom1917.i
  %1238 = load i8, ptr %arrayidx1982.i, align 1
  ...
  store i32 %or1990.i, ptr %tPos.i, align 4
  store i32 1, ptr %nblock_used.i, align 4
...
for.body1998.i:                                   ; preds = %for.body1998.i, %for.cond1995.preheader.i.new
  ...
  %niter566 = phi i64 [ 0, %for.cond1995.preheader.i.new ], [ %niter566.next.1, %for.body1998.i ]
  %arrayidx2001.i = getelementptr inbounds i32, ptr %1201, i64 %indvars.iv3388.i
  %1239 = load i32, ptr %arrayidx2001.i, align 4
  ...
  %1242 = load i32, ptr %arrayidx2008.i, align 4
  %idxprom2009.i = sext i32 %1242 to i64
  %arrayidx2010.i = getelementptr inbounds i32, ptr %1201, i64 %idxprom2009.i
  %1243 = load i32, ptr %arrayidx2010.i, align 4
  %or2011.i = or i32 %1243, %shl2004.i
  store i32 %or2011.i, ptr %arrayidx2010.i, align 4
  %1244 = load i32, ptr %arrayidx2008.i, align 4
  %inc2015.i = add nsw i32 %1244, 1
  store i32 %inc2015.i, ptr %arrayidx2008.i, align 4
  ...
  %1245 = load i32, ptr %arrayidx2001.i.1, align 4
  ...
  %1248 = load i32, ptr %arrayidx2008.i.1, align 4
  %idxprom2009.i.1 = sext i32 %1248 to i64
  %arrayidx2010.i.1 = getelementptr inbounds i32, ptr %1201, i64 %idxprom2009.i.1
  %1249 = load i32, ptr %arrayidx2010.i.1, align 4
  %or2011.i.1 = or i32 %1249, %shl2004.i.1
  store i32 %or2011.i.1, ptr %arrayidx2010.i.1, align 4
  %1250 = load i32, ptr %arrayidx2008.i.1, align 4
  %inc2015.i.1 = add nsw i32 %1250, 1
  store i32 %inc2015.i.1, ptr %arrayidx2008.i.1, align 4
  %indvars.iv.next3389.i.1 = add nuw nsw i64 %indvars.iv3388.i, 2
  %niter566.next.1 = add i64 %niter566, 2
  %niter566.ncmp.1 = icmp eq i64 %niter566.next.1, %unroll_iter565
  br i1 %niter566.ncmp.1, label %for.end2018.loopexit.i.unr-lcssa, label %for.body1998.i
...
for.end2018.loopexit.i.unr-lcssa:                 ; preds = %for.body1998.i, %for.cond1995.preheader.i
  ...
  br i1 %lcmp.mod564.not, label %for.end2018.loopexit.i, label %for.body1998.i.epil
...
for.body1998.i.epil:                              ; preds = %for.end2018.loopexit.i.unr-lcssa
  ...
  %1251 = load i32, ptr %arrayidx2001.i.epil, align 4
...
if.end2032.i:                                     ; preds = %for.end2018.loopexit.i
  ...
  %1259 = load i32, ptr %arrayidx2036.i, align 4
  %conv2041.i = and i32 %1259, 255
  store i32 %conv2041.i, ptr %k0.i, align 8
  %shr2044.i = lshr i32 %1259, 8
  store i32 %shr2044.i, ptr %tPos.i, align 4
  store i32 1, ptr %nblock_used.i, align 4
  br label %BZ2_decompress.exit

endhdr_2.i:                                       ; preds = %if.then65.i
  store i32 1, ptr %state8, align 8
  br label %BZ2_decompress.exit
...
BZ2_decompress.exit:                              ; preds = %if.end71.i, %if.end123.i, %if.end180.i, %if.end237.i, %if.end467.i, %if.end525.i, %if.end1019.i, %if.end1628.i, %if.end1692.i, %if.end1212.i, %while.body1354.i, %while.body1370.i, %if.end1276.i, %if.end1083.i, %if.end698.i, %if.end763.i, %if.end820.i, %if.end626.i, %if.end393.i, %if.end309.i, %if.end587.i, %if.end.i86, %if.then27.i, %if.else.i, %if.then65.i, %if.then227.i, %if.end281.i, %makeMaps_d.exit.i, %if.then458.i, %if.then458.i, %if.then458.i, %if.then516.i, %while.cond737.i, %if.then974.i, %while.cond1054.i, %while.end1120.i, %if.then1167.i, %while.cond1247.i, %while.end1313.i, %if.else1383.i, %if.then1583.i, %while.cond1663.i, %while.end1729.i, %while.end1748.i, %indexIntoF.exit.i104, %if.end2032.i, %endhdr_2.i, %save_state_and_return.loopexit3243.i
  %1261 = phi i32 [ %366, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %366, %if.then65.i ], [ %461, %if.then227.i ], [ %461, %if.end281.i ], [ %547, %makeMaps_d.exit.i ], [ %651, %if.then458.i ], [ %651, %if.then458.i ], [ %651, %if.then458.i ], [ %678, %if.then516.i ], [ %843, %while.cond737.i ], [ %782, %if.then974.i ], [ %999, %while.cond1054.i ], [ %999, %while.end1120.i ], [ %1015, %if.then1167.i ], [ %1026, %while.cond1247.i ], [ %1026, %while.end1313.i ], [ %1014, %if.else1383.i ], [ %1014, %if.then1583.i ], [ %1177, %while.cond1663.i ], [ %1177, %while.end1729.i ], [ %1014, %while.end1748.i ], [ %1014, %if.end2032.i ], [ %1014, %indexIntoF.exit.i104 ], [ %.pre3408.i, %if.end.i86 ], [ %1014, %save_state_and_return.loopexit3243.i ], [ %.ph492, %if.end587.i ], [ %516, %if.end309.i ], [ %592, %if.end393.i ], [ %.ph492, %if.end626.i ], [ %887, %if.end820.i ], [ %861, %if.end763.i ], [ %802, %if.end698.i ], [ %1004, %if.end1083.i ], [ %1028, %if.end1276.i ], [ %1026, %while.body1370.i ], [ %1026, %while.body1354.i ], [ %1018, %if.end1212.i ], [ %1179, %if.end1692.i ], [ %1169, %if.end1628.i ], [ %986, %if.end1019.i ], [ %678, %if.end525.i ], [ %651, %if.end467.i ], [ %461, %if.end237.i ], [ %429, %if.end180.i ], [ %397, %if.end123.i ], [ %366, %if.end71.i ]
  %zj.10.i = phi i32 [ %369, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %369, %if.then65.i ], [ %464, %if.then227.i ], [ %464, %if.end281.i ], [ %550, %makeMaps_d.exit.i ], [ %654, %if.then458.i ], [ %654, %if.then458.i ], [ %654, %if.then458.i ], [ %681, %if.then516.i ], [ %846, %while.cond737.i ], [ %785, %if.then974.i ], [ %zj.0.i, %while.cond1054.i ], [ %zj.0.i, %while.end1120.i ], [ %zj.3.i, %if.then1167.i ], [ %zj.5.i, %while.cond1247.i ], [ %zj.5.i, %while.end1313.i ], [ %zj.2.i, %if.else1383.i ], [ %zj.2.i, %if.then1583.i ], [ %zj.8.i, %while.cond1663.i ], [ %zj.8.i, %while.end1729.i ], [ %zj.2.i, %while.end1748.i ], [ %zj.2.i, %if.end2032.i ], [ %zj.2.i, %indexIntoF.exit.i104 ], [ %.pre3411.i, %if.end.i86 ], [ %zj.2.i, %save_state_and_return.loopexit3243.i ], [ %.ph495, %if.end587.i ], [ %519, %if.end309.i ], [ %595, %if.end393.i ], [ %.ph495, %if.end626.i ], [ %890, %if.end820.i ], [ %864, %if.end763.i ], [ %805, %if.end698.i ], [ %zj.1.i, %if.end1083.i ], [ %zj.6.i, %if.end1276.i ], [ %zj.5.i, %while.body1370.i ], [ %zj.5.i, %while.body1354.i ], [ %zj.4.i, %if.end1212.i ], [ %zj.9.i, %if.end1692.i ], [ %zj.7.i, %if.end1628.i ], [ %988, %if.end1019.i ], [ %681, %if.end525.i ], [ %654, %if.end467.i ], [ %464, %if.end237.i ], [ %432, %if.end180.i ], [ %400, %if.end123.i ], [ %369, %if.end71.i ]
  %gSel.14.i = phi i32 [ %370, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %370, %if.then65.i ], [ %465, %if.then227.i ], [ %465, %if.end281.i ], [ %551, %makeMaps_d.exit.i ], [ %655, %if.then458.i ], [ %655, %if.then458.i ], [ %655, %if.then458.i ], [ %682, %if.then516.i ], [ %847, %while.cond737.i ], [ %786, %if.then974.i ], [ %gSel.2.i, %while.cond1054.i ], [ %gSel.2.i, %while.end1120.i ], [ %gSel.5.i, %if.then1167.i ], [ %gSel.8.i, %while.cond1247.i ], [ %gSel.8.i, %while.end1313.i ], [ %gSel.4.i, %if.else1383.i ], [ %gSel.4.i, %if.then1583.i ], [ %gSel.12.i, %while.cond1663.i ], [ %gSel.12.i, %while.end1729.i ], [ %gSel.4.i, %while.end1748.i ], [ %gSel.4.i, %if.end2032.i ], [ %gSel.4.i, %indexIntoF.exit.i104 ], [ %.pre3412.i, %if.end.i86 ], [ %gSel.4.i, %save_state_and_return.loopexit3243.i ], [ %.ph496, %if.end587.i ], [ %520, %if.end309.i ], [ %596, %if.end393.i ], [ %.ph496, %if.end626.i ], [ %891, %if.end820.i ], [ %865, %if.end763.i ], [ %806, %if.end698.i ], [ %gSel.3.i, %if.end1083.i ], [ %gSel.9.i, %if.end1276.i ], [ %gSel.8.i, %while.body1370.i ], [ %gSel.8.i, %while.body1354.i ], [ %gSel.7.i, %if.end1212.i ], [ %gSel.13.i, %if.end1692.i ], [ %gSel.11.i, %if.end1628.i ], [ %gSel.1.i, %if.end1019.i ], [ %682, %if.end525.i ], [ %655, %if.end467.i ], [ %465, %if.end237.i ], [ %433, %if.end180.i ], [ %401, %if.end123.i ], [ %370, %if.end71.i ]
  %gMinlen.14.i = phi i32 [ %371, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %371, %if.then65.i ], [ %466, %if.then227.i ], [ %466, %if.end281.i ], [ %552, %makeMaps_d.exit.i ], [ %656, %if.then458.i ], [ %656, %if.then458.i ], [ %656, %if.then458.i ], [ %683, %if.then516.i ], [ %848, %while.cond737.i ], [ %787, %if.then974.i ], [ %gMinlen.2.i, %while.cond1054.i ], [ %gMinlen.2.i, %while.end1120.i ], [ %gMinlen.5.i, %if.then1167.i ], [ %gMinlen.8.i, %while.cond1247.i ], [ %gMinlen.8.i, %while.end1313.i ], [ %gMinlen.4.i, %if.else1383.i ], [ %gMinlen.4.i, %if.then1583.i ], [ %gMinlen.12.i, %while.cond1663.i ], [ %gMinlen.12.i, %while.end1729.i ], [ %gMinlen.4.i, %while.end1748.i ], [ %gMinlen.4.i, %if.end2032.i ], [ %gMinlen.4.i, %indexIntoF.exit.i104 ], [ %.pre3413.i, %if.end.i86 ], [ %gMinlen.4.i, %save_state_and_return.loopexit3243.i ], [ %.ph497, %if.end587.i ], [ %521, %if.end309.i ], [ %597, %if.end393.i ], [ %.ph497, %if.end626.i ], [ %892, %if.end820.i ], [ %866, %if.end763.i ], [ %807, %if.end698.i ], [ %gMinlen.3.i, %if.end1083.i ], [ %gMinlen.9.i, %if.end1276.i ], [ %gMinlen.8.i, %while.body1370.i ], [ %gMinlen.8.i, %while.body1354.i ], [ %gMinlen.7.i, %if.end1212.i ], [ %gMinlen.13.i, %if.end1692.i ], [ %gMinlen.11.i, %if.end1628.i ], [ %gMinlen.1.i, %if.end1019.i ], [ %683, %if.end525.i ], [ %656, %if.end467.i ], [ %466, %if.end237.i ], [ %434, %if.end180.i ], [ %402, %if.end123.i ], [ %371, %if.end71.i ]
  %gLimit.14.i = phi ptr [ %372, %endhdr_2.i ], [ null, %if.then27.i ], [ null, %if.else.i ], [ %372, %if.then65.i ], [ %467, %if.then227.i ], [ %467, %if.end281.i ], [ %553, %makeMaps_d.exit.i ], [ %657, %if.then458.i ], [ %657, %if.then458.i ], [ %657, %if.then458.i ], [ %684, %if.then516.i ], [ %849, %while.cond737.i ], [ %788, %if.then974.i ], [ %gLimit.2.i, %while.cond1054.i ], [ %gLimit.2.i, %while.end1120.i ], [ %gLimit.5.i, %if.then1167.i ], [ %gLimit.8.i, %while.cond1247.i ], [ %gLimit.8.i, %while.end1313.i ], [ %gLimit.4.i, %if.else1383.i ], [ %gLimit.4.i, %if.then1583.i ], [ %gLimit.12.i, %while.cond1663.i ], [ %gLimit.12.i, %while.end1729.i ], [ %gLimit.4.i, %while.end1748.i ], [ %gLimit.4.i, %if.end2032.i ], [ %gLimit.4.i, %indexIntoF.exit.i104 ], [ %.pre3414.i, %if.end.i86 ], [ %gLimit.4.i, %save_state_and_return.loopexit3243.i ], [ %.ph498, %if.end587.i ], [ %522, %if.end309.i ], [ %598, %if.end393.i ], [ %.ph498, %if.end626.i ], [ %893, %if.end820.i ], [ %867, %if.end763.i ], [ %808, %if.end698.i ], [ %gLimit.3.i, %if.end1083.i ], [ %gLimit.9.i, %if.end1276.i ], [ %gLimit.8.i, %while.body1370.i ], [ %gLimit.8.i, %while.body1354.i ], [ %gLimit.7.i, %if.end1212.i ], [ %gLimit.13.i, %if.end1692.i ], [ %gLimit.11.i, %if.end1628.i ], [ %gLimit.1.i, %if.end1019.i ], [ %684, %if.end525.i ], [ %657, %if.end467.i ], [ %467, %if.end237.i ], [ %435, %if.end180.i ], [ %403, %if.end123.i ], [ %372, %if.end71.i ]
  %gBase.14.i = phi ptr [ %373, %endhdr_2.i ], [ null, %if.then27.i ], [ null, %if.else.i ], [ %373, %if.then65.i ], [ %468, %if.then227.i ], [ %468, %if.end281.i ], [ %554, %makeMaps_d.exit.i ], [ %658, %if.then458.i ], [ %658, %if.then458.i ], [ %658, %if.then458.i ], [ %685, %if.then516.i ], [ %850, %while.cond737.i ], [ %789, %if.then974.i ], [ %gBase.2.i, %while.cond1054.i ], [ %gBase.2.i, %while.end1120.i ], [ %gBase.5.i, %if.then1167.i ], [ %gBase.8.i, %while.cond1247.i ], [ %gBase.8.i, %while.end1313.i ], [ %gBase.4.i, %if.else1383.i ], [ %gBase.4.i, %if.then1583.i ], [ %gBase.12.i, %while.cond1663.i ], [ %gBase.12.i, %while.end1729.i ], [ %gBase.4.i, %while.end1748.i ], [ %gBase.4.i, %if.end2032.i ], [ %gBase.4.i, %indexIntoF.exit.i104 ], [ %.pre3415.i, %if.end.i86 ], [ %gBase.4.i, %save_state_and_return.loopexit3243.i ], [ %.ph499, %if.end587.i ], [ %523, %if.end309.i ], [ %599, %if.end393.i ], [ %.ph499, %if.end626.i ], [ %894, %if.end820.i ], [ %868, %if.end763.i ], [ %809, %if.end698.i ], [ %gBase.3.i, %if.end1083.i ], [ %gBase.9.i, %if.end1276.i ], [ %gBase.8.i, %while.body1370.i ], [ %gBase.8.i, %while.body1354.i ], [ %gBase.7.i, %if.end1212.i ], [ %gBase.13.i, %if.end1692.i ], [ %gBase.11.i, %if.end1628.i ], [ %gBase.1.i, %if.end1019.i ], [ %685, %if.end525.i ], [ %658, %if.end467.i ], [ %468, %if.end237.i ], [ %436, %if.end180.i ], [ %404, %if.end123.i ], [ %373, %if.end71.i ]
  %gPerm.14.i = phi ptr [ %374, %endhdr_2.i ], [ null, %if.then27.i ], [ null, %if.else.i ], [ %374, %if.then65.i ], [ %469, %if.then227.i ], [ %469, %if.end281.i ], [ %555, %makeMaps_d.exit.i ], [ %659, %if.then458.i ], [ %659, %if.then458.i ], [ %659, %if.then458.i ], [ %686, %if.then516.i ], [ %851, %while.cond737.i ], [ %790, %if.then974.i ], [ %gPerm.2.i, %while.cond1054.i ], [ %gPerm.2.i, %while.end1120.i ], [ %gPerm.5.i, %if.then1167.i ], [ %gPerm.8.i, %while.cond1247.i ], [ %gPerm.8.i, %while.end1313.i ], [ %gPerm.4.i, %if.else1383.i ], [ %gPerm.4.i, %if.then1583.i ], [ %gPerm.12.i, %while.cond1663.i ], [ %gPerm.12.i, %while.end1729.i ], [ %gPerm.4.i, %while.end1748.i ], [ %gPerm.4.i, %if.end2032.i ], [ %gPerm.4.i, %indexIntoF.exit.i104 ], [ %.pre3416.i, %if.end.i86 ], [ %gPerm.4.i, %save_state_and_return.loopexit3243.i ], [ %.ph500, %if.end587.i ], [ %524, %if.end309.i ], [ %600, %if.end393.i ], [ %.ph500, %if.end626.i ], [ %895, %if.end820.i ], [ %869, %if.end763.i ], [ %810, %if.end698.i ], [ %gPerm.3.i, %if.end1083.i ], [ %gPerm.9.i, %if.end1276.i ], [ %gPerm.8.i, %while.body1370.i ], [ %gPerm.8.i, %while.body1354.i ], [ %gPerm.7.i, %if.end1212.i ], [ %gPerm.13.i, %if.end1692.i ], [ %gPerm.11.i, %if.end1628.i ], [ %gPerm.1.i, %if.end1019.i ], [ %686, %if.end525.i ], [ %659, %if.end467.i ], [ %469, %if.end237.i ], [ %437, %if.end180.i ], [ %405, %if.end123.i ], [ %374, %if.end71.i ]
  %zvec.10.i = phi i32 [ %368, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %368, %if.then65.i ], [ %463, %if.then227.i ], [ %463, %if.end281.i ], [ %549, %makeMaps_d.exit.i ], [ %653, %if.then458.i ], [ %653, %if.then458.i ], [ %653, %if.then458.i ], [ %680, %if.then516.i ], [ %845, %while.cond737.i ], [ %784, %if.then974.i ], [ %zvec.0.i, %while.cond1054.i ], [ %zvec.0.i, %while.end1120.i ], [ %zvec.3.i, %if.then1167.i ], [ %zvec.5.i, %while.cond1247.i ], [ %zvec.5.i, %while.end1313.i ], [ %zvec.2.i, %if.else1383.i ], [ %zvec.2.i, %if.then1583.i ], [ %zvec.8.i, %while.cond1663.i ], [ %zvec.8.i, %while.end1729.i ], [ %zvec.2.i, %while.end1748.i ], [ %zvec.2.i, %if.end2032.i ], [ %zvec.2.i, %indexIntoF.exit.i104 ], [ %.pre3410.i, %if.end.i86 ], [ %zvec.2.i, %save_state_and_return.loopexit3243.i ], [ %.ph494, %if.end587.i ], [ %518, %if.end309.i ], [ %594, %if.end393.i ], [ %.ph494, %if.end626.i ], [ %889, %if.end820.i ], [ %863, %if.end763.i ], [ %804, %if.end698.i ], [ %zvec.1.i, %if.end1083.i ], [ %zvec.6.i, %if.end1276.i ], [ %zvec.5.i, %while.body1370.i ], [ %zvec.5.i, %while.body1354.i ], [ %zvec.4.i, %if.end1212.i ], [ %zvec.9.i, %if.end1692.i ], [ %zvec.7.i, %if.end1628.i ], [ %987, %if.end1019.i ], [ %680, %if.end525.i ], [ %653, %if.end467.i ], [ %463, %if.end237.i ], [ %431, %if.end180.i ], [ %399, %if.end123.i ], [ %368, %if.end71.i ]
  %zn.11.i = phi i32 [ %367, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %367, %if.then65.i ], [ %462, %if.then227.i ], [ %462, %if.end281.i ], [ %548, %makeMaps_d.exit.i ], [ %652, %if.then458.i ], [ %652, %if.then458.i ], [ %652, %if.then458.i ], [ %679, %if.then516.i ], [ %844, %while.cond737.i ], [ %783, %if.then974.i ], [ %zn.1.i, %while.cond1054.i ], [ %zn.1.i, %while.end1120.i ], [ %zn.4.i, %if.then1167.i ], [ %zn.6.i, %while.cond1247.i ], [ %zn.6.i, %while.end1313.i ], [ %zn.3.i, %if.else1383.i ], [ %zn.3.i, %if.then1583.i ], [ %zn.9.i, %while.cond1663.i ], [ %zn.9.i, %while.end1729.i ], [ %zn.3.i, %while.end1748.i ], [ %zn.3.i, %if.end2032.i ], [ %zn.3.i, %indexIntoF.exit.i104 ], [ %.pre3409.i, %if.end.i86 ], [ %zn.3.i, %save_state_and_return.loopexit3243.i ], [ %.ph493, %if.end587.i ], [ %517, %if.end309.i ], [ %593, %if.end393.i ], [ %.ph493, %if.end626.i ], [ %888, %if.end820.i ], [ %862, %if.end763.i ], [ %803, %if.end698.i ], [ %zn.2.i, %if.end1083.i ], [ %zn.7.i, %if.end1276.i ], [ %zn.6.i, %while.body1370.i ], [ %zn.6.i, %while.body1354.i ], [ %zn.5.i, %if.end1212.i ], [ %zn.10.i, %if.end1692.i ], [ %zn.8.i, %if.end1628.i ], [ %zn.0.i, %if.end1019.i ], [ %679, %if.end525.i ], [ %652, %if.end467.i ], [ %462, %if.end237.i ], [ %430, %if.end180.i ], [ %398, %if.end123.i ], [ %367, %if.end71.i ]
  %curr.18.i = phi i32 [ %365, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %365, %if.then65.i ], [ %460, %if.then227.i ], [ %460, %if.end281.i ], [ %546, %makeMaps_d.exit.i ], [ %650, %if.then458.i ], [ %650, %if.then458.i ], [ %650, %if.then458.i ], [ %677, %if.then516.i ], [ %curr.3.i, %while.cond737.i ], [ %curr.0.i, %if.then974.i ], [ %curr.8.i, %while.cond1054.i ], [ %curr.8.i, %while.end1120.i ], [ %curr.11.i, %if.then1167.i ], [ %curr.13.i, %while.cond1247.i ], [ %curr.13.i, %while.end1313.i ], [ %curr.10.i, %if.else1383.i ], [ %curr.10.i, %if.then1583.i ], [ %curr.16.i, %while.cond1663.i ], [ %curr.16.i, %while.end1729.i ], [ %curr.10.i, %while.end1748.i ], [ %curr.10.i, %if.end2032.i ], [ %curr.10.i, %indexIntoF.exit.i104 ], [ %.pre3407.i, %if.end.i86 ], [ %curr.10.i, %save_state_and_return.loopexit3243.i ], [ %.ph491, %if.end587.i ], [ %515, %if.end309.i ], [ %591, %if.end393.i ], [ %.ph491, %if.end626.i ], [ %curr.5.i, %if.end820.i ], [ %curr.4.i, %if.end763.i ], [ %curr.1.i, %if.end698.i ], [ %curr.9.i, %if.end1083.i ], [ %curr.14.i, %if.end1276.i ], [ %curr.13.i, %while.body1370.i ], [ %curr.13.i, %while.body1354.i ], [ %curr.12.i, %if.end1212.i ], [ %curr.17.i, %if.end1692.i ], [ %curr.15.i, %if.end1628.i ], [ %curr.7.i, %if.end1019.i ], [ %677, %if.end525.i ], [ %650, %if.end467.i ], [ %460, %if.end237.i ], [ %428, %if.end180.i ], [ %396, %if.end123.i ], [ %365, %if.end71.i ]
  %N.8.i = phi i32 [ %364, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %364, %if.then65.i ], [ %459, %if.then227.i ], [ %459, %if.end281.i ], [ %545, %makeMaps_d.exit.i ], [ %649, %if.then458.i ], [ %649, %if.then458.i ], [ %649, %if.then458.i ], [ %676, %if.then516.i ], [ %842, %while.cond737.i ], [ %781, %if.then974.i ], [ %998, %while.cond1054.i ], [ %998, %while.end1120.i ], [ %mul1160.i, %if.then1167.i ], [ %N.3.i, %while.cond1247.i ], [ %N.3.i, %while.end1313.i ], [ %N.0.i, %if.else1383.i ], [ %N.0.i, %if.then1583.i ], [ %N.6.i, %while.cond1663.i ], [ %N.6.i, %while.end1729.i ], [ %N.0.i, %while.end1748.i ], [ %N.0.i, %if.end2032.i ], [ %N.0.i, %indexIntoF.exit.i104 ], [ %.pre3406.i, %if.end.i86 ], [ %N.0.i, %save_state_and_return.loopexit3243.i ], [ %.ph490, %if.end587.i ], [ %514, %if.end309.i ], [ %590, %if.end393.i ], [ %.ph490, %if.end626.i ], [ %886, %if.end820.i ], [ %860, %if.end763.i ], [ %801, %if.end698.i ], [ %1003, %if.end1083.i ], [ %N.4.i, %if.end1276.i ], [ %N.3.i, %while.body1370.i ], [ %N.3.i, %while.body1354.i ], [ %N.2.i, %if.end1212.i ], [ %N.7.i, %if.end1692.i ], [ %N.5.i, %if.end1628.i ], [ %985, %if.end1019.i ], [ %676, %if.end525.i ], [ %649, %if.end467.i ], [ %459, %if.end237.i ], [ %427, %if.end180.i ], [ %395, %if.end123.i ], [ %364, %if.end71.i ]
  %es.12.i = phi i32 [ %363, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %363, %if.then65.i ], [ %458, %if.then227.i ], [ %458, %if.end281.i ], [ %544, %makeMaps_d.exit.i ], [ %648, %if.then458.i ], [ %648, %if.then458.i ], [ %648, %if.then458.i ], [ %675, %if.then516.i ], [ %841, %while.cond737.i ], [ %780, %if.then974.i ], [ %997, %while.cond1054.i ], [ %997, %while.end1120.i ], [ %es.2.i, %if.then1167.i ], [ %es.4.i, %while.cond1247.i ], [ %es.4.i, %while.end1313.i ], [ %es.0.i, %if.else1383.i ], [ %es.0.i, %if.then1583.i ], [ %es.10.i, %while.cond1663.i ], [ %es.10.i, %while.end1729.i ], [ %es.0.i, %while.end1748.i ], [ %es.0.i, %if.end2032.i ], [ %es.0.i, %indexIntoF.exit.i104 ], [ %.pre3405.i, %if.end.i86 ], [ %es.0.i, %save_state_and_return.loopexit3243.i ], [ %.ph489, %if.end587.i ], [ %513, %if.end309.i ], [ %589, %if.end393.i ], [ %.ph489, %if.end626.i ], [ %885, %if.end820.i ], [ %859, %if.end763.i ], [ %800, %if.end698.i ], [ %1002, %if.end1083.i ], [ %es.5.i, %if.end1276.i ], [ %es.73176.i, %while.body1370.i ], [ %es.63171.i, %while.body1354.i ], [ %es.3.i, %if.end1212.i ], [ %es.11.i, %if.end1692.i ], [ %es.9.i, %if.end1628.i ], [ %984, %if.end1019.i ], [ %675, %if.end525.i ], [ %648, %if.end467.i ], [ %458, %if.end237.i ], [ %426, %if.end180.i ], [ %394, %if.end123.i ], [ %363, %if.end71.i ]
  %nblock.14.i = phi i32 [ %362, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %362, %if.then65.i ], [ %457, %if.then227.i ], [ %457, %if.end281.i ], [ %543, %makeMaps_d.exit.i ], [ %647, %if.then458.i ], [ %647, %if.then458.i ], [ %647, %if.then458.i ], [ %674, %if.then516.i ], [ %840, %while.cond737.i ], [ 0, %if.then974.i ], [ %nblock.1.i, %while.cond1054.i ], [ %nblock.1.i, %while.end1120.i ], [ %nblock.4.i, %if.then1167.i ], [ %nblock.6.i, %while.cond1247.i ], [ %nblock.6.i, %while.end1313.i ], [ %nblock.3.i, %if.else1383.i ], [ %inc1580.i, %if.then1583.i ], [ %nblock.12.i, %while.cond1663.i ], [ %nblock.12.i, %while.end1729.i ], [ %nblock.3.i, %while.end1748.i ], [ %nblock.3.i, %if.end2032.i ], [ %nblock.3.i, %indexIntoF.exit.i104 ], [ %.pre3404.i, %if.end.i86 ], [ %nblock.3.i, %save_state_and_return.loopexit3243.i ], [ %.ph488, %if.end587.i ], [ %512, %if.end309.i ], [ %588, %if.end393.i ], [ %.ph488, %if.end626.i ], [ %884, %if.end820.i ], [ %858, %if.end763.i ], [ %799, %if.end698.i ], [ %nblock.2.i, %if.end1083.i ], [ %nblock.7.i, %if.end1276.i ], [ %smax3353.i, %while.body1370.i ], [ %smax.i, %while.body1354.i ], [ %nblock.5.i, %if.end1212.i ], [ %nblock.13.i, %if.end1692.i ], [ %nblock.11.i, %if.end1628.i ], [ %nblock.0.i, %if.end1019.i ], [ %674, %if.end525.i ], [ %647, %if.end467.i ], [ %457, %if.end237.i ], [ %425, %if.end180.i ], [ %393, %if.end123.i ], [ %362, %if.end71.i ]
  %nblockMAX.11.i = phi i32 [ %361, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %361, %if.then65.i ], [ %456, %if.then227.i ], [ %456, %if.end281.i ], [ %542, %makeMaps_d.exit.i ], [ %646, %if.then458.i ], [ %646, %if.then458.i ], [ %646, %if.then458.i ], [ %673, %if.then516.i ], [ %839, %while.cond737.i ], [ %mul939.i, %if.then974.i ], [ %nblockMAX.1.i, %while.cond1054.i ], [ %nblockMAX.1.i, %while.end1120.i ], [ %nblockMAX.4.i, %if.then1167.i ], [ %nblockMAX.6.i, %while.cond1247.i ], [ %nblockMAX.6.i, %while.end1313.i ], [ %nblockMAX.3.i, %if.else1383.i ], [ %nblockMAX.3.i, %if.then1583.i ], [ %nblockMAX.9.i, %while.cond1663.i ], [ %nblockMAX.9.i, %while.end1729.i ], [ %nblockMAX.3.i, %while.end1748.i ], [ %nblockMAX.3.i, %if.end2032.i ], [ %nblockMAX.3.i, %indexIntoF.exit.i104 ], [ %.pre3403.i, %if.end.i86 ], [ %nblockMAX.3.i, %save_state_and_return.loopexit3243.i ], [ %.ph487, %if.end587.i ], [ %511, %if.end309.i ], [ %587, %if.end393.i ], [ %.ph487, %if.end626.i ], [ %883, %if.end820.i ], [ %857, %if.end763.i ], [ %798, %if.end698.i ], [ %nblockMAX.2.i, %if.end1083.i ], [ %nblockMAX.7.i, %if.end1276.i ], [ %nblockMAX.6.i, %while.body1370.i ], [ %nblockMAX.6.i, %while.body1354.i ], [ %nblockMAX.5.i, %if.end1212.i ], [ %nblockMAX.10.i, %if.end1692.i ], [ %nblockMAX.8.i, %if.end1628.i ], [ %nblockMAX.0.i, %if.end1019.i ], [ %673, %if.end525.i ], [ %646, %if.end467.i ], [ %456, %if.end237.i ], [ %424, %if.end180.i ], [ %392, %if.end123.i ], [ %361, %if.end71.i ]
  %nextSym.8.i = phi i32 [ %360, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %360, %if.then65.i ], [ %455, %if.then227.i ], [ %455, %if.end281.i ], [ %541, %makeMaps_d.exit.i ], [ %645, %if.then458.i ], [ %645, %if.then458.i ], [ %645, %if.then458.i ], [ %672, %if.then516.i ], [ %838, %while.cond737.i ], [ %777, %if.then974.i ], [ %996, %while.cond1054.i ], [ %996, %while.end1120.i ], [ %nextSym.1.i, %if.then1167.i ], [ %nextSym.3.i, %while.cond1247.i ], [ %nextSym.3.i, %while.end1313.i ], [ %nextSym.0.i, %if.else1383.i ], [ %nextSym.0.i, %if.then1583.i ], [ %nextSym.6.i, %while.cond1663.i ], [ %nextSym.6.i, %while.end1729.i ], [ %nextSym.0.i, %while.end1748.i ], [ %nextSym.0.i, %if.end2032.i ], [ %nextSym.0.i, %indexIntoF.exit.i104 ], [ %.pre3402.i, %if.end.i86 ], [ %nextSym.0.i, %save_state_and_return.loopexit3243.i ], [ %.ph486, %if.end587.i ], [ %510, %if.end309.i ], [ %586, %if.end393.i ], [ %.ph486, %if.end626.i ], [ %882, %if.end820.i ], [ %856, %if.end763.i ], [ %797, %if.end698.i ], [ %1001, %if.end1083.i ], [ %nextSym.4.i, %if.end1276.i ], [ %1037, %while.body1370.i ], [ %1037, %while.body1354.i ], [ %nextSym.2.i, %if.end1212.i ], [ %nextSym.7.i, %if.end1692.i ], [ %nextSym.5.i, %if.end1628.i ], [ %983, %if.end1019.i ], [ %672, %if.end525.i ], [ %645, %if.end467.i ], [ %455, %if.end237.i ], [ %423, %if.end180.i ], [ %391, %if.end123.i ], [ %360, %if.end71.i ]
  %groupPos.14.i = phi i32 [ %359, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %359, %if.then65.i ], [ %454, %if.then227.i ], [ %454, %if.end281.i ], [ %540, %makeMaps_d.exit.i ], [ %644, %if.then458.i ], [ %644, %if.then458.i ], [ %644, %if.then458.i ], [ %671, %if.then516.i ], [ %837, %while.cond737.i ], [ 0, %if.then974.i ], [ %groupPos.2.i, %while.cond1054.i ], [ %groupPos.2.i, %while.end1120.i ], [ 0, %if.then1167.i ], [ %groupPos.8.i, %while.cond1247.i ], [ %groupPos.8.i, %while.end1313.i ], [ %groupPos.4.i, %if.else1383.i ], [ 0, %if.then1583.i ], [ %groupPos.12.i, %while.cond1663.i ], [ %groupPos.12.i, %while.end1729.i ], [ %groupPos.4.i, %while.end1748.i ], [ %groupPos.4.i, %if.end2032.i ], [ %groupPos.4.i, %indexIntoF.exit.i104 ], [ %.pre3401.i, %if.end.i86 ], [ %groupPos.4.i, %save_state_and_return.loopexit3243.i ], [ %.ph485, %if.end587.i ], [ %509, %if.end309.i ], [ %585, %if.end393.i ], [ %.ph485, %if.end626.i ], [ %881, %if.end820.i ], [ %855, %if.end763.i ], [ %796, %if.end698.i ], [ %groupPos.3.i, %if.end1083.i ], [ %groupPos.9.i, %if.end1276.i ], [ %groupPos.8.i, %while.body1370.i ], [ %groupPos.8.i, %while.body1354.i ], [ %groupPos.7.i, %if.end1212.i ], [ %groupPos.13.i, %if.end1692.i ], [ %groupPos.11.i, %if.end1628.i ], [ %groupPos.1.i, %if.end1019.i ], [ %671, %if.end525.i ], [ %644, %if.end467.i ], [ %454, %if.end237.i ], [ %422, %if.end180.i ], [ %390, %if.end123.i ], [ %359, %if.end71.i ]
  %groupNo.14.i = phi i32 [ %358, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %358, %if.then65.i ], [ %453, %if.then227.i ], [ %453, %if.end281.i ], [ %539, %makeMaps_d.exit.i ], [ %643, %if.then458.i ], [ %643, %if.then458.i ], [ %643, %if.then458.i ], [ %670, %if.then516.i ], [ %836, %while.cond737.i ], [ 0, %if.then974.i ], [ %groupNo.2.i, %while.cond1054.i ], [ %groupNo.2.i, %while.end1120.i ], [ %inc1168.i, %if.then1167.i ], [ %groupNo.8.i, %while.cond1247.i ], [ %groupNo.8.i, %while.end1313.i ], [ %groupNo.4.i, %if.else1383.i ], [ %inc1584.i, %if.then1583.i ], [ %groupNo.12.i, %while.cond1663.i ], [ %groupNo.12.i, %while.end1729.i ], [ %groupNo.4.i, %while.end1748.i ], [ %groupNo.4.i, %if.end2032.i ], [ %groupNo.4.i, %indexIntoF.exit.i104 ], [ %.pre3400.i, %if.end.i86 ], [ %groupNo.4.i, %save_state_and_return.loopexit3243.i ], [ %.ph484, %if.end587.i ], [ %508, %if.end309.i ], [ %584, %if.end393.i ], [ %.ph484, %if.end626.i ], [ %880, %if.end820.i ], [ %854, %if.end763.i ], [ %795, %if.end698.i ], [ %groupNo.3.i, %if.end1083.i ], [ %groupNo.9.i, %if.end1276.i ], [ %groupNo.8.i, %while.body1370.i ], [ %groupNo.8.i, %while.body1354.i ], [ %groupNo.7.i, %if.end1212.i ], [ %groupNo.13.i, %if.end1692.i ], [ %groupNo.11.i, %if.end1628.i ], [ %groupNo.1.i, %if.end1019.i ], [ %670, %if.end525.i ], [ %643, %if.end467.i ], [ %453, %if.end237.i ], [ %421, %if.end180.i ], [ %389, %if.end123.i ], [ %358, %if.end71.i ]
  %EOB.11.i = phi i32 [ %357, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %357, %if.then65.i ], [ %452, %if.then227.i ], [ %452, %if.end281.i ], [ %538, %makeMaps_d.exit.i ], [ %642, %if.then458.i ], [ %642, %if.then458.i ], [ %642, %if.then458.i ], [ %669, %if.then516.i ], [ %835, %while.cond737.i ], [ %add937.i, %if.then974.i ], [ %EOB.1.i, %while.cond1054.i ], [ %EOB.1.i, %while.end1120.i ], [ %EOB.4.i, %if.then1167.i ], [ %EOB.6.i, %while.cond1247.i ], [ %EOB.6.i, %while.end1313.i ], [ %EOB.3.i, %if.else1383.i ], [ %EOB.3.i, %if.then1583.i ], [ %EOB.9.i, %while.cond1663.i ], [ %EOB.9.i, %while.end1729.i ], [ %nextSym.0.i, %while.end1748.i ], [ %nextSym.0.i, %if.end2032.i ], [ %nextSym.0.i, %indexIntoF.exit.i104 ], [ %.pre3399.i, %if.end.i86 ], [ %nextSym.0.i, %save_state_and_return.loopexit3243.i ], [ %.ph483, %if.end587.i ], [ %507, %if.end309.i ], [ %583, %if.end393.i ], [ %.ph483, %if.end626.i ], [ %879, %if.end820.i ], [ %853, %if.end763.i ], [ %794, %if.end698.i ], [ %EOB.2.i, %if.end1083.i ], [ %EOB.7.i, %if.end1276.i ], [ %EOB.6.i, %while.body1370.i ], [ %EOB.6.i, %while.body1354.i ], [ %EOB.5.i, %if.end1212.i ], [ %EOB.10.i, %if.end1692.i ], [ %EOB.8.i, %if.end1628.i ], [ %EOB.0.i, %if.end1019.i ], [ %669, %if.end525.i ], [ %642, %if.end467.i ], [ %452, %if.end237.i ], [ %420, %if.end180.i ], [ %388, %if.end123.i ], [ %357, %if.end71.i ]
  %nSelectors.20.i = phi i32 [ %356, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %356, %if.then65.i ], [ %451, %if.then227.i ], [ %451, %if.end281.i ], [ %537, %makeMaps_d.exit.i ], [ %641, %if.then458.i ], [ %641, %if.then458.i ], [ %641, %if.then458.i ], [ 0, %if.then516.i ], [ %nSelectors.6.i, %while.cond737.i ], [ %nSelectors.3.i, %if.then974.i ], [ %nSelectors.10.i, %while.cond1054.i ], [ %nSelectors.10.i, %while.end1120.i ], [ %nSelectors.13.i, %if.then1167.i ], [ %nSelectors.15.i, %while.cond1247.i ], [ %nSelectors.15.i, %while.end1313.i ], [ %nSelectors.12.i, %if.else1383.i ], [ %nSelectors.12.i, %if.then1583.i ], [ %nSelectors.18.i, %while.cond1663.i ], [ %nSelectors.18.i, %while.end1729.i ], [ %nSelectors.12.i, %while.end1748.i ], [ %nSelectors.12.i, %if.end2032.i ], [ %nSelectors.12.i, %indexIntoF.exit.i104 ], [ %.pre3398.i, %if.end.i86 ], [ %nSelectors.12.i, %save_state_and_return.loopexit3243.i ], [ %nSelectors.2.i.ph, %if.end587.i ], [ %506, %if.end309.i ], [ %582, %if.end393.i ], [ %nSelectors.2.i.ph, %if.end626.i ], [ %nSelectors.8.i, %if.end820.i ], [ %nSelectors.7.i, %if.end763.i ], [ %nSelectors.4.i, %if.end698.i ], [ %nSelectors.11.i, %if.end1083.i ], [ %nSelectors.16.i, %if.end1276.i ], [ %nSelectors.15.i, %while.body1370.i ], [ %nSelectors.15.i, %while.body1354.i ], [ %nSelectors.14.i, %if.end1212.i ], [ %nSelectors.19.i, %if.end1692.i ], [ %nSelectors.17.i, %if.end1628.i ], [ %nSelectors.9.i, %if.end1019.i ], [ %668, %if.end525.i ], [ %641, %if.end467.i ], [ %451, %if.end237.i ], [ %419, %if.end180.i ], [ %387, %if.end123.i ], [ %356, %if.end71.i ]
  %nGroups.21.i = phi i32 [ %355, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %355, %if.then65.i ], [ %450, %if.then227.i ], [ %450, %if.end281.i ], [ %536, %makeMaps_d.exit.i ], [ %and464.i, %if.then458.i ], [ %and464.i, %if.then458.i ], [ %and464.i, %if.then458.i ], [ %nGroups.0.i, %if.then516.i ], [ %nGroups.7.i, %while.cond737.i ], [ %nGroups.4.i, %if.then974.i ], [ %nGroups.11.i, %while.cond1054.i ], [ %nGroups.11.i, %while.end1120.i ], [ %nGroups.14.i, %if.then1167.i ], [ %nGroups.16.i, %while.cond1247.i ], [ %nGroups.16.i, %while.end1313.i ], [ %nGroups.13.i, %if.else1383.i ], [ %nGroups.13.i, %if.then1583.i ], [ %nGroups.19.i, %while.cond1663.i ], [ %nGroups.19.i, %while.end1729.i ], [ %nGroups.13.i, %while.end1748.i ], [ %nGroups.13.i, %if.end2032.i ], [ %nGroups.13.i, %indexIntoF.exit.i104 ], [ %.pre3397.i, %if.end.i86 ], [ %nGroups.13.i, %save_state_and_return.loopexit3243.i ], [ %nGroups.3.i.ph, %if.end587.i ], [ %505, %if.end309.i ], [ %581, %if.end393.i ], [ %nGroups.3.i.ph, %if.end626.i ], [ %nGroups.9.i, %if.end820.i ], [ %nGroups.8.i, %if.end763.i ], [ %nGroups.5.i, %if.end698.i ], [ %nGroups.12.i, %if.end1083.i ], [ %nGroups.17.i, %if.end1276.i ], [ %nGroups.16.i, %while.body1370.i ], [ %nGroups.16.i, %while.body1354.i ], [ %nGroups.15.i, %if.end1212.i ], [ %nGroups.20.i, %if.end1692.i ], [ %nGroups.18.i, %if.end1628.i ], [ %nGroups.10.i, %if.end1019.i ], [ %nGroups.0.i, %if.end525.i ], [ %640, %if.end467.i ], [ %450, %if.end237.i ], [ %418, %if.end180.i ], [ %386, %if.end123.i ], [ %355, %if.end71.i ]
  %alphaSize.22.i = phi i32 [ %354, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %354, %if.then65.i ], [ %449, %if.then227.i ], [ %449, %if.end281.i ], [ %535, %makeMaps_d.exit.i ], [ %alphaSize.0.i, %if.then458.i ], [ %alphaSize.0.i, %if.then458.i ], [ %alphaSize.0.i, %if.then458.i ], [ %alphaSize.1.i, %if.then516.i ], [ %alphaSize.8.i, %while.cond737.i ], [ %alphaSize.5.i, %if.then974.i ], [ %alphaSize.12.i, %while.cond1054.i ], [ %alphaSize.12.i, %while.end1120.i ], [ %alphaSize.15.i, %if.then1167.i ], [ %alphaSize.17.i, %while.cond1247.i ], [ %alphaSize.17.i, %while.end1313.i ], [ %alphaSize.14.i, %if.else1383.i ], [ %alphaSize.14.i, %if.then1583.i ], [ %alphaSize.20.i, %while.cond1663.i ], [ %alphaSize.20.i, %while.end1729.i ], [ %alphaSize.14.i, %while.end1748.i ], [ %alphaSize.14.i, %if.end2032.i ], [ %alphaSize.14.i, %indexIntoF.exit.i104 ], [ %.pre3396.i, %if.end.i86 ], [ %alphaSize.14.i, %save_state_and_return.loopexit3243.i ], [ %alphaSize.4.i.ph, %if.end587.i ], [ %504, %if.end309.i ], [ %580, %if.end393.i ], [ %alphaSize.4.i.ph, %if.end626.i ], [ %alphaSize.10.i, %if.end820.i ], [ %alphaSize.9.i, %if.end763.i ], [ %alphaSize.6.i, %if.end698.i ], [ %alphaSize.13.i, %if.end1083.i ], [ %alphaSize.18.i, %if.end1276.i ], [ %alphaSize.17.i, %while.body1370.i ], [ %alphaSize.17.i, %while.body1354.i ], [ %alphaSize.16.i, %if.end1212.i ], [ %alphaSize.21.i, %if.end1692.i ], [ %alphaSize.19.i, %if.end1628.i ], [ %alphaSize.11.i, %if.end1019.i ], [ %alphaSize.1.i, %if.end525.i ], [ %alphaSize.0.i, %if.end467.i ], [ %449, %if.end237.i ], [ %417, %if.end180.i ], [ %385, %if.end123.i ], [ %354, %if.end71.i ]
  %t.18.i = phi i32 [ %353, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %353, %if.then65.i ], [ %448, %if.then227.i ], [ %448, %if.end281.i ], [ %534, %makeMaps_d.exit.i ], [ %639, %if.then458.i ], [ %639, %if.then458.i ], [ %639, %if.then458.i ], [ %667, %if.then516.i ], [ %t.3.i, %while.cond737.i ], [ %t.6.lcssa.i, %if.then974.i ], [ %t.8.i, %while.cond1054.i ], [ %t.8.i, %while.end1120.i ], [ %t.11.i, %if.then1167.i ], [ %t.13.i, %while.cond1247.i ], [ %t.13.i, %while.end1313.i ], [ %t.10.i, %if.else1383.i ], [ %t.10.i, %if.then1583.i ], [ %t.16.i, %while.cond1663.i ], [ %t.16.i, %while.end1729.i ], [ %t.10.i, %while.end1748.i ], [ %t.10.i, %if.end2032.i ], [ %t.10.i, %indexIntoF.exit.i104 ], [ %.pre3395.i, %if.end.i86 ], [ %t.10.i, %save_state_and_return.loopexit3243.i ], [ %.ph, %if.end587.i ], [ %503, %if.end309.i ], [ %579, %if.end393.i ], [ %.ph, %if.end626.i ], [ %t.5.i, %if.end820.i ], [ %t.4.i, %if.end763.i ], [ %t.1.i, %if.end698.i ], [ %t.9.i, %if.end1083.i ], [ %t.14.i, %if.end1276.i ], [ %t.13.i, %while.body1370.i ], [ %t.13.i, %while.body1354.i ], [ %t.12.i, %if.end1212.i ], [ %t.17.i, %if.end1692.i ], [ %t.15.i, %if.end1628.i ], [ %t.7.i, %if.end1019.i ], [ %667, %if.end525.i ], [ %639, %if.end467.i ], [ %448, %if.end237.i ], [ %416, %if.end180.i ], [ %384, %if.end123.i ], [ %353, %if.end71.i ]
  %j.28.i = phi i32 [ %352, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %352, %if.then65.i ], [ %447, %if.then227.i ], [ %447, %if.end281.i ], [ %j.0.i, %makeMaps_d.exit.i ], [ %j.4.i, %if.then458.i ], [ %j.4.i, %if.then458.i ], [ %j.4.i, %if.then458.i ], [ %j.5.i, %if.then516.i ], [ %j.12.i, %while.cond737.i ], [ %j.9.i, %if.then974.i ], [ %j.16.i, %while.cond1054.i ], [ %j.16.i, %while.end1120.i ], [ %j.19.i, %if.then1167.i ], [ %j.21.i, %while.cond1247.i ], [ %j.21.i, %while.end1313.i ], [ %j.18.i, %if.else1383.i ], [ %j.18.i, %if.then1583.i ], [ %j.24.i, %while.cond1663.i ], [ %j.24.i, %while.end1729.i ], [ %j.18.i, %while.end1748.i ], [ %j.18.i, %if.end2032.i ], [ %or1925.i, %indexIntoF.exit.i104 ], [ %.pre3394.i, %if.end.i86 ], [ %j.18.i, %save_state_and_return.loopexit3243.i ], [ %j.8.i, %if.end587.i ], [ %502, %if.end309.i ], [ %j.2.i, %if.end393.i ], [ %inc627.i, %if.end626.i ], [ %j.14.i, %if.end820.i ], [ %j.13.i, %if.end763.i ], [ %j.10.i, %if.end698.i ], [ %j.17.i, %if.end1083.i ], [ %j.22.i, %if.end1276.i ], [ %j.21.i, %while.body1370.i ], [ %j.21.i, %while.body1354.i ], [ %j.20.i, %if.end1212.i ], [ %j.25.i, %if.end1692.i ], [ %j.23.i, %if.end1628.i ], [ %j.15.i, %if.end1019.i ], [ %j.5.i, %if.end525.i ], [ %j.4.i, %if.end467.i ], [ %447, %if.end237.i ], [ %415, %if.end180.i ], [ %383, %if.end123.i ], [ %352, %if.end71.i ]
  %i.40.i = phi i32 [ %351, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %351, %if.then65.i ], [ %446, %if.then227.i ], [ %446, %if.end281.i ], [ %i.3.i, %makeMaps_d.exit.i ], [ %i.7.i, %if.then458.i ], [ %i.7.i, %if.then458.i ], [ %i.7.i, %if.then458.i ], [ %i.8.i, %if.then516.i ], [ %i.16.i, %while.cond737.i ], [ 256, %if.then974.i ], [ %i.22.i, %while.cond1054.i ], [ %i.22.i, %while.end1120.i ], [ %i.25.i, %if.then1167.i ], [ %i.27.i, %while.cond1247.i ], [ %i.27.i, %while.end1313.i ], [ %i.24.i, %if.else1383.i ], [ %i.24.i, %if.then1583.i ], [ %i.30.i, %while.cond1663.i ], [ %i.30.i, %while.end1729.i ], [ %i.24.i, %while.end1748.i ], [ %nblock.3.i, %if.end2032.i ], [ %j.26.i, %indexIntoF.exit.i104 ], [ %.pre.i87, %if.end.i86 ], [ %1260, %save_state_and_return.loopexit3243.i ], [ %i.11.i.ph, %if.end587.i ], [ %i.1.i, %if.end309.i ], [ %i.5.i, %if.end393.i ], [ %i.11.i.ph, %if.end626.i ], [ %i.18.i, %if.end820.i ], [ %i.17.i, %if.end763.i ], [ %i.14.i, %if.end698.i ], [ %i.23.i, %if.end1083.i ], [ %i.28.i, %if.end1276.i ], [ %i.27.i, %while.body1370.i ], [ %i.27.i, %while.body1354.i ], [ %i.26.i, %if.end1212.i ], [ %i.31.i, %if.end1692.i ], [ %i.29.i, %if.end1628.i ], [ %i.21.i, %if.end1019.i ], [ %i.8.i, %if.end525.i ], [ %i.7.i, %if.end467.i ], [ %446, %if.end237.i ], [ %414, %if.end180.i ], [ %382, %if.end123.i ], [ %351, %if.end71.i ]
  %cmp32 = phi i1 [ true, %endhdr_2.i ], [ false, %if.then27.i ], [ false, %if.else.i ], [ false, %if.then65.i ], [ false, %if.then227.i ], [ false, %if.end281.i ], [ false, %makeMaps_d.exit.i ], [ false, %if.then458.i ], [ false, %if.then458.i ], [ false, %if.then458.i ], [ false, %if.then516.i ], [ false, %while.cond737.i ], [ false, %if.then974.i ], [ false, %while.cond1054.i ], [ false, %while.end1120.i ], [ false, %if.then1167.i ], [ false, %while.cond1247.i ], [ false, %while.end1313.i ], [ false, %if.else1383.i ], [ false, %if.then1583.i ], [ false, %while.cond1663.i ], [ false, %while.end1729.i ], [ false, %while.end1748.i ], [ false, %if.end2032.i ], [ false, %indexIntoF.exit.i104 ], [ false, %if.end.i86 ], [ false, %save_state_and_return.loopexit3243.i ], [ false, %if.end587.i ], [ false, %if.end309.i ], [ false, %if.end393.i ], [ false, %if.end626.i ], [ false, %if.end820.i ], [ false, %if.end763.i ], [ false, %if.end698.i ], [ false, %if.end1083.i ], [ false, %if.end1276.i ], [ false, %while.body1370.i ], [ false, %while.body1354.i ], [ false, %if.end1212.i ], [ false, %if.end1692.i ], [ false, %if.end1628.i ], [ false, %if.end1019.i ], [ false, %if.end525.i ], [ false, %if.end467.i ], [ false, %if.end237.i ], [ false, %if.end180.i ], [ false, %if.end123.i ], [ false, %if.end71.i ]
  %retVal.0.i = phi i32 [ 4, %endhdr_2.i ], [ -3, %if.then27.i ], [ -3, %if.else.i ], [ -4, %if.then65.i ], [ -4, %if.then227.i ], [ -4, %if.end281.i ], [ -4, %makeMaps_d.exit.i ], [ -4, %if.then458.i ], [ -4, %if.then458.i ], [ -4, %if.then458.i ], [ -4, %if.then516.i ], [ -4, %while.cond737.i ], [ -4, %if.then974.i ], [ -4, %while.cond1054.i ], [ -4, %while.end1120.i ], [ -4, %if.then1167.i ], [ -4, %while.cond1247.i ], [ -4, %while.end1313.i ], [ -4, %if.else1383.i ], [ -4, %if.then1583.i ], [ -4, %while.cond1663.i ], [ -4, %while.end1729.i ], [ -4, %while.end1748.i ], [ 0, %if.end2032.i ], [ 0, %indexIntoF.exit.i104 ], [ -4, %if.end.i86 ], [ -4, %save_state_and_return.loopexit3243.i ], [ 0, %if.end587.i ], [ 0, %if.end309.i ], [ 0, %if.end393.i ], [ -4, %if.end626.i ], [ 0, %if.end820.i ], [ 0, %if.end763.i ], [ 0, %if.end698.i ], [ 0, %if.end1083.i ], [ 0, %if.end1276.i ], [ -4, %while.body1370.i ], [ -4, %while.body1354.i ], [ 0, %if.end1212.i ], [ 0, %if.end1692.i ], [ 0, %if.end1628.i ], [ 0, %if.end1019.i ], [ 0, %if.end525.i ], [ 0, %if.end467.i ], [ 0, %if.end237.i ], [ 0, %if.end180.i ], [ 0, %if.end123.i ], [ 0, %if.end71.i ]
  store i32 %i.40.i, ptr %save_i.i124, align 4
  store i32 %j.28.i, ptr %save_j3.phi.trans.insert.i, align 8
  store i32 %t.18.i, ptr %save_t4.phi.trans.insert.i, align 4
  store i32 %alphaSize.22.i, ptr %save_alphaSize5.phi.trans.insert.i, align 8
  store i32 %nGroups.21.i, ptr %save_nGroups6.phi.trans.insert.i, align 4
  store i32 %nSelectors.20.i, ptr %save_nSelectors7.phi.trans.insert.i, align 8
  store i32 %EOB.11.i, ptr %save_EOB8.phi.trans.insert.i, align 4
  store i32 %groupNo.14.i, ptr %save_groupNo9.phi.trans.insert.i, align 8
  store i32 %groupPos.14.i, ptr %save_groupPos10.phi.trans.insert.i, align 4
  store i32 %nextSym.8.i, ptr %save_nextSym11.phi.trans.insert.i, align 8
  store i32 %nblockMAX.11.i, ptr %save_nblockMAX12.phi.trans.insert.i, align 4
  store i32 %nblock.14.i, ptr %save_nblock.i, align 8
  store i32 %es.12.i, ptr %save_es14.phi.trans.insert.i, align 4
  store i32 %N.8.i, ptr %save_N15.phi.trans.insert.i, align 8
  store i32 %curr.18.i, ptr %save_curr16.phi.trans.insert.i, align 4
  store i32 %1261, ptr %save_zt17.phi.trans.insert.i, align 8
  store i32 %zn.11.i, ptr %save_zn18.phi.trans.insert.i, align 4
  store i32 %zvec.10.i, ptr %save_zvec19.phi.trans.insert.i, align 8
  store i32 %zj.10.i, ptr %save_zj20.phi.trans.insert.i, align 4
  store i32 %gSel.14.i, ptr %save_gSel21.phi.trans.insert.i, align 8
  store i32 %gMinlen.14.i, ptr %save_gMinlen22.phi.trans.insert.i, align 4
  store ptr %gLimit.14.i, ptr %save_gLimit23.phi.trans.insert.i, align 8
  store ptr %gBase.14.i, ptr %save_gBase24.phi.trans.insert.i, align 8
  store ptr %gPerm.14.i, ptr %save_gPerm25.phi.trans.insert.i, align 8
  br i1 %cmp32, label %cleanup40, label %cleanup

cleanup:                                          ; preds = %for.end2018.loopexit.i, %BZ2_decompress.exit
  %retval.0.i88128 = phi i32 [ %retVal.0.i, %BZ2_decompress.exit ], [ 1, %for.end2018.loopexit.i ]
  %1262 = load i32, ptr %state8, align 8
...
cleanup40:                                        ; preds = %while.cond, %BZ2_decompress.exit, %if.end20, %land.lhs.true, %cleanup, %if.end23.i, %if.end86.i, %if.end80.i, %if.end58.i, %if.end36.i, %if.end21.i, %if.end15.i, %if.end3, %if.end, %entry
  %retval.3 = phi i32 [ -2, %entry ], [ -2, %if.end ], [ -2, %if.end3 ], [ -4, %if.end15.i ], [ -4, %if.end21.i ], [ -4, %if.end36.i ], [ -4, %if.end58.i ], [ -4, %if.end80.i ], [ -4, %if.end86.i ], [ -4, %if.end23.i ], [ -1, %while.cond ], [ %retval.0.i88128, %cleanup ], [ 0, %land.lhs.true ], [ 0, %if.end20 ], [ 4, %BZ2_decompress.exit ]
  ret i32 %retval.3
}
