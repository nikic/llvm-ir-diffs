; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_cvd.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_cvd.c"
...
if.end30:                                         ; preds = %if.then25
  ...
  store i8 0, ptr %arrayidx34, align 4
...
if.end40:                                         ; preds = %if.end30
  ...
  %2 = load i8, ptr %arrayidx44, align 4
...
if.end13:                                         ; preds = %if.end8
  ...
  store i32 %conv.i, ptr %version, align 8
...
if.end19:                                         ; preds = %if.end13
  ...
  store i32 %conv.i93, ptr %sigs, align 4
...
if.end25:                                         ; preds = %if.end19
  ...
  store i32 %conv.i95, ptr %fl, align 8
  ...
  store ptr %call27, ptr %md5, align 8
...
if.end31:                                         ; preds = %if.end25
  ...
  store ptr %call32, ptr %dsig, align 8
...
if.end37:                                         ; preds = %if.end31
  ...
  store ptr %call38, ptr %builder, align 8
...
if.then47:                                        ; preds = %if.end44
  ...
  store i32 %conv.i97, ptr %stime, align 8
...
if.else:                                          ; preds = %if.end44
  ...
  store i32 0, ptr %stime49, align 8
  br label %cleanup
...
for.inc:                                          ; preds = %land.rhs, %land.rhs, %land.rhs
  ...
  br i1 %cmp11, label %land.rhs, label %for.end
...
if.end:                                           ; preds = %entry
  %call1 = tail call fastcc i32 @cli_cvdverify(ptr noundef nonnull %call, ptr noundef null)
...
for.inc.1:                                        ; preds = %for.inc, %for.inc
  ...
  %2 = load i8, ptr %arrayidx3.2, align 1
...
entry:
  ...
  %call = call fastcc i32 @cli_cvdverify(ptr noundef %fs, ptr noundef nonnull %cvd)
  %tobool.not = icmp eq i32 %call, 0
  br i1 %tobool.not, label %if.end, label %cleanup

if.end:                                           ; preds = %entry
  %stime = getelementptr inbounds %struct.cl_cvd, ptr %cvd, i64 0, i32 7
  %0 = load i32, ptr %stime, align 8
...
if.then3:                                         ; preds = %if.end
  ...
  %1 = load i64, ptr %s_time, align 8
  %conv5 = trunc i64 %1 to i32
  %2 = load i32, ptr %stime, align 8
  %sub = sub i32 %conv5, %2
...
if.end26:                                         ; preds = %if.end20
  %call27 = call i32 @cli_untgz(i32 noundef %call21, ptr noundef %call16)
