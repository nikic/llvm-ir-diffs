; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_suecrypt.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_suecrypt.c"
...
while.body132.us.preheader:                       ; preds = %if.end117.us
  ...
  br i1 %min.iters.check, label %while.body132.us.preheader337, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %13 = xor <4 x i32> %wide.load336, %broadcast.splat
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.end138.us, label %while.body132.us.preheader337

while.body132.us.preheader337:                    ; preds = %while.body132.us.preheader, %middle.block
...
while.body132.us:                                 ; preds = %while.body132.us.preheader337, %while.body132.us
  %sz.1291.us = phi i32 [ %sub.us, %while.body132.us ], [ %sz.1291.us.ph, %while.body132.us.preheader337 ]
  %hunk.0290.us = phi ptr [ %add.ptr135.us, %while.body132.us ], [ %hunk.0290.us.ph, %while.body132.us.preheader337 ]
  ...
  br i1 %cmp130.us, label %while.body132.us, label %for.end138.us

for.inc136.us:                                    ; preds = %land.lhs.true99.us, %land.lhs.true94.us, %for.body82.us294
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %if.then142, label %for.body82.us294
