...
do.end29:                                         ; preds = %do.end23, %while.cond.preheader
  ...
  store i32 %and31, ptr %last4, align 4
...
do.end80:                                         ; preds = %if.then72, %do.body69
  ...
  store ptr %incdec.ptr82, ptr %next, align 8
  ...
  br i1 %cmp65, label %do.body69, label %do.end92.loopexit
...
if.end100:                                        ; preds = %do.end92
  ...
  store i32 %and102, ptr %length771, align 4
...
if.then127:                                       ; preds = %do.body124
  ...
  store i32 %17, ptr %whave, align 8
...
do.end137:                                        ; preds = %if.then127, %do.body124
  %put.2 = phi ptr [ %16, %if.then127 ], [ %put.11972, %do.body124 ]
  %left.2 = phi i32 [ %17, %if.then127 ], [ %left.11974, %do.body124 ]
  ...
  %20 = load i32, ptr %length771, align 4
  %sub152 = sub i32 %20, %copy.1
  store i32 %sub152, ptr %length771, align 4
  %cmp108.not = icmp eq i32 %sub152, 0
  br i1 %cmp108.not, label %while.end153, label %while.body110
...
do.end173:                                        ; preds = %if.then165, %do.body162
  ...
  store ptr %incdec.ptr175, ptr %next, align 8
  ...
  br i1 %cmp158, label %do.body162, label %do.end185.loopexit
...
while.cond229.preheader.preheader:                ; preds = %do.end185
  store i32 0, ptr %have221, align 4
...
if.then237.do.end245_crit_edge:                   ; preds = %if.then237
  %.pre2073.pre = load i32, ptr %have221, align 4
  %.pre2074.pre = load i32, ptr %ncode, align 8
  br label %do.end245
...
do.end257:                                        ; preds = %do.end245, %while.cond229.preheader
  ...
  %inc = add i32 %32, 1
  store i32 %inc, ptr %have221, align 4
  ...
  store i16 %and259, ptr %arrayidx263, align 2
  %shr265 = lshr i64 %hold.5.lcssa, 3
  %sub266 = add i32 %bits.5.lcssa, -3
  %cmp225 = icmp ult i32 %inc, %31
  br i1 %cmp225, label %while.cond229.preheader, label %while.cond270.preheader
...
for.cond305.preheader:                            ; preds = %if.end295, %if.end564
  ...
  %39 = load i32, ptr %lenbits, align 8
  %notmask1813 = shl nsw i32 -1, %39
  ...
  %here.sroa.18.0.copyload1819 = load i8, ptr %here.sroa.18.0.arrayidx313.sroa_idx1818, align 1
...
if.then324.do.end332_crit_edge:                   ; preds = %if.then324
  %.pre2075 = load ptr, ptr %lencode, align 8
  %.pre2076 = load i32, ptr %lenbits, align 8
  br label %do.end332
...
do.end332:                                        ; preds = %if.then324.do.end332_crit_edge, %do.body321
  ...
  store ptr %incdec.ptr334, ptr %next, align 8
  ...
  %here.sroa.18.0.copyload = load i8, ptr %here.sroa.18.0.arrayidx313.sroa_idx, align 1
...
do.body346:                                       ; preds = %for.end
  ...
  %49 = load i32, ptr %have221, align 4
  %inc359 = add i32 %49, 1
  store i32 %inc359, ptr %have221, align 4
  %idxprom360 = zext i32 %49 to i64
  %arrayidx361 = getelementptr inbounds %struct.inflate_state, ptr %0, i64 0, i32 29, i64 %idxprom360
  store i16 %here.sroa.40.0.copyload.lcssa, ptr %arrayidx361, align 2
  %.pre2077 = load i32, ptr %nlen, align 4
  %.pre2078 = load i32, ptr %ndist, align 8
...
do.end387:                                        ; preds = %if.then379, %do.body376
  ...
  store ptr %incdec.ptr389, ptr %next, align 8
  ...
  br i1 %cmp372, label %do.body376, label %do.body400.loopexit
...
do.body400:                                       ; preds = %do.body400.loopexit, %while.cond368.preheader
  ...
  %59 = load i32, ptr %have221, align 4
...
if.end416:                                        ; preds = %do.body400
  ...
  %60 = load i16, ptr %arrayidx421, align 2
...
do.end457:                                        ; preds = %if.then449, %do.body446
  ...
  store ptr %incdec.ptr459, ptr %next, align 8
  ...
  br i1 %cmp442, label %do.body446, label %do.body470.loopexit
...
do.end509:                                        ; preds = %if.then501, %do.body498
  ...
  store ptr %incdec.ptr511, ptr %next, align 8
  ...
  br i1 %cmp494, label %do.body498, label %do.body522.loopexit
...
if.end541:                                        ; preds = %do.body470, %do.body522, %if.end416
  ...
  %67 = load i32, ptr %have221, align 4
  %add543 = add i32 %67, %copy.2
  %68 = load i32, ptr %nlen, align 4
  %69 = load i32, ptr %ndist, align 8
...
vector.scevcheck:                                 ; preds = %while.body556.preheader
  ...
  br i1 %72, label %while.body556.preheader2233, label %vector.ph2221

vector.ph2221:                                    ; preds = %vector.scevcheck
  %n.vec2223 = and i32 %copy.2, -16
  %ind.end2224 = and i32 %copy.2, 15
  %ind.end2226 = add i32 %67, %n.vec2223
  ...
  store <8 x i16> %broadcast.splat, ptr %74, align 2
  %75 = getelementptr inbounds i16, ptr %74, i64 8
  store <8 x i16> %broadcast.splat, ptr %75, align 2
  %76 = icmp eq i32 %n.vec2223, 16
  br i1 %76, label %middle.block2218, label %vector.body2229.1
...
vector.body2229.1:                                ; preds = %vector.ph2221
  ...
  store <8 x i16> %broadcast.splat, ptr %78, align 2
  %79 = getelementptr inbounds i16, ptr %78, i64 8
  store <8 x i16> %broadcast.splat, ptr %79, align 2
  %80 = icmp eq i32 %n.vec2223, 32
  br i1 %80, label %middle.block2218, label %vector.body2229.2
...
vector.body2229.2:                                ; preds = %vector.body2229.1
  ...
  store <8 x i16> %broadcast.splat, ptr %82, align 2
  %83 = getelementptr inbounds i16, ptr %82, i64 8
  store <8 x i16> %broadcast.splat, ptr %83, align 2
  %84 = icmp eq i32 %n.vec2223, 48
  br i1 %84, label %middle.block2218, label %vector.body2229.3
...
vector.body2229.3:                                ; preds = %vector.body2229.2
  ...
  store <8 x i16> %broadcast.splat, ptr %86, align 2
  %87 = getelementptr inbounds i16, ptr %86, i64 8
  store <8 x i16> %broadcast.splat, ptr %87, align 2
  %88 = icmp eq i32 %n.vec2223, 64
  br i1 %88, label %middle.block2218, label %vector.body2229.4
...
vector.body2229.4:                                ; preds = %vector.body2229.3
  ...
  store <8 x i16> %broadcast.splat, ptr %90, align 2
  %91 = getelementptr inbounds i16, ptr %90, i64 8
  store <8 x i16> %broadcast.splat, ptr %91, align 2
  %92 = icmp eq i32 %n.vec2223, 80
  br i1 %92, label %middle.block2218, label %vector.body2229.5
...
vector.body2229.5:                                ; preds = %vector.body2229.4
  ...
  store <8 x i16> %broadcast.splat, ptr %94, align 2
  %95 = getelementptr inbounds i16, ptr %94, i64 8
  store <8 x i16> %broadcast.splat, ptr %95, align 2
  %96 = icmp eq i32 %n.vec2223, 96
  br i1 %96, label %middle.block2218, label %vector.body2229.6
...
vector.body2229.6:                                ; preds = %vector.body2229.5
  ...
  store <8 x i16> %broadcast.splat, ptr %98, align 2
  %99 = getelementptr inbounds i16, ptr %98, i64 8
  store <8 x i16> %broadcast.splat, ptr %99, align 2
  %100 = icmp eq i32 %n.vec2223, 112
  br i1 %100, label %middle.block2218, label %vector.body2229.7
...
vector.body2229.7:                                ; preds = %vector.body2229.6
  ...
  store <8 x i16> %broadcast.splat, ptr %102, align 2
  %103 = getelementptr inbounds i16, ptr %102, i64 8
  store <8 x i16> %broadcast.splat, ptr %103, align 2
...
while.body556.preheader2233:                      ; preds = %vector.scevcheck, %while.body556.preheader, %middle.block2218
  ...
  %.ph = phi i32 [ %67, %vector.scevcheck ], [ %67, %while.body556.preheader ], [ %ind.end2226, %middle.block2218 ]
...
while.body556.prol:                               ; preds = %while.body556.preheader2233, %while.body556.prol
  ...
  %105 = phi i32 [ %inc560.prol, %while.body556.prol ], [ %.ph, %while.body556.preheader2233 ]
  ...
  store i16 %len.0, ptr %arrayidx562.prol, align 2
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %while.body556.prol.loopexit, label %while.body556.prol
...
while.body556:                                    ; preds = %while.body556.prol.loopexit, %while.body556
  ...
  store i16 %len.0, ptr %arrayidx562, align 2
  ...
  store i16 %len.0, ptr %arrayidx562.1, align 2
  ...
  store i16 %len.0, ptr %arrayidx562.2, align 2
  ...
  store i16 %len.0, ptr %arrayidx562.3, align 2
  %tobool555.not.3 = icmp eq i32 %dec554.3, 0
  br i1 %tobool555.not.3, label %if.end564.loopexit, label %while.body556
...
if.end564.loopexit:                               ; preds = %while.body556.prol.loopexit, %while.body556, %middle.block2218
  ...
  store i32 %inc560.lcssa, ptr %have221, align 4
  br label %if.end564
...
if.end564:                                        ; preds = %if.end564.loopexit, %do.body346
  ...
  br i1 %cmp302, label %for.cond305.preheader, label %while.end565
...
for.cond650.preheader:                            ; preds = %sw.bb617
  %115 = load ptr, ptr %lencode, align 8
  %conv6521865 = trunc i64 %hold.14 to i32
  %116 = load i32, ptr %lenbits, align 8
  %notmask16411866 = shl nsw i32 -1, %116
  ...
  %here.sroa.18.0.copyload11741872 = load i8, ptr %here.sroa.18.0.arrayidx658.sroa_idx1871, align 1
...
do.body623:                                       ; preds = %sw.bb617
  ...
  store ptr %118, ptr %strm, align 8
  store i32 %have.24, ptr %avail_in625, align 8
  store i64 %hold.14, ptr %hold626, align 8
  store i32 %bits.14, ptr %bits627, align 8
  %119 = load i32, ptr %whave, align 8
  %120 = load i32, ptr %wsize, align 4
...
if.then634:                                       ; preds = %do.body623
  ...
  store i32 %sub636, ptr %whave, align 8
  br label %if.end638

if.end638:                                        ; preds = %if.then634, %do.body623
  call void @inflate_fast(ptr noundef nonnull %strm, i32 noundef %120) #5
  %121 = load ptr, ptr %next_out, align 8
  %122 = load i32, ptr %avail_out, align 8
  %123 = load ptr, ptr %strm, align 8
  store ptr %123, ptr %next, align 8
  %124 = load i32, ptr %avail_in625, align 8
  %125 = load i64, ptr %hold626, align 8
  %126 = load i32, ptr %bits627, align 8
  br label %sw.epilog1128
...
if.then669.do.end677_crit_edge:                   ; preds = %if.then669
  %.pre2079 = load ptr, ptr %lencode, align 8
  %.pre2080 = load i32, ptr %lenbits, align 8
  br label %do.end677
...
do.end677:                                        ; preds = %if.then669.do.end677_crit_edge, %do.body666
  ...
  store ptr %incdec.ptr679, ptr %next, align 8
  ...
  %here.sroa.18.0.copyload1174 = load i8, ptr %here.sroa.18.0.arrayidx658.sroa_idx, align 1
...
for.end687:                                       ; preds = %for.end687.loopexit, %for.cond650.preheader
  ...
  %here.sroa.0.0.copyload1170 = load i8, ptr %arrayidx658.lcssa, align 2
  %136 = add i8 %here.sroa.0.0.copyload1170, -1
...
for.cond697.preheader:                            ; preds = %for.end687
  ...
  %arrayidx7151892 = getelementptr inbounds %struct.code, ptr %135, i64 %idxprom7141891
  %here.sroa.18.0.arrayidx715.sroa_idx1893 = getelementptr inbounds i8, ptr %arrayidx7151892, i64 1
  %here.sroa.18.0.copyload11751894 = load i8, ptr %here.sroa.18.0.arrayidx715.sroa_idx1893, align 1
...
if.then729.do.end737_crit_edge:                   ; preds = %if.then729
  %.pre2081 = load ptr, ptr %lencode, align 8
  br label %do.end737
...
do.end737:                                        ; preds = %if.then729.do.end737_crit_edge, %do.body726
  ...
  store ptr %incdec.ptr739, ptr %next, align 8
  ...
  %here.sroa.18.0.copyload1175 = load i8, ptr %here.sroa.18.0.arrayidx715.sroa_idx, align 1
...
do.body748:                                       ; preds = %do.body748.loopexit, %for.cond697.preheader
  ...
  %here.sroa.40.0.copyload1198 = load i16, ptr %here.sroa.40.0.arrayidx715.sroa_idx, align 2
  %here.sroa.0.0.copyload1171 = load i8, ptr %arrayidx715.lcssa, align 2
...
do.body759:                                       ; preds = %for.end687, %do.body748
  ...
  store i32 %conv770, ptr %length771, align 4
...
if.then780:                                       ; preds = %do.body777
  %144 = load ptr, ptr %window, align 8
  %145 = load i32, ptr %wsize, align 4
  store i32 %145, ptr %whave, align 8
  %call784 = call i32 %out(ptr noundef %out_desc, ptr noundef %144, i32 noundef %145) #5
  %tobool785.not = icmp eq i32 %call784, 0
  br i1 %tobool785.not, label %if.then780.do.end790_crit_edge, label %inf_leave

if.then780.do.end790_crit_edge:                   ; preds = %if.then780
  %.pre2091 = load i32, ptr %length771, align 4
  br label %do.end790

do.end790:                                        ; preds = %if.then780.do.end790_crit_edge, %do.body777
  %146 = phi i32 [ %.pre2091, %if.then780.do.end790_crit_edge ], [ %conv770, %do.body777 ]
  ...
  store i8 %conv792, ptr %put.3, align 1
...
if.end811:                                        ; preds = %if.end803
  ...
  store i32 %and814, ptr %extra, align 4
...
if.then829.do.end837_crit_edge:                   ; preds = %if.then829
  %.pre2082 = load i32, ptr %extra, align 4
  br label %do.end837
...
do.end837:                                        ; preds = %if.then829.do.end837_crit_edge, %do.body826
  ...
  %149 = load ptr, ptr %next, align 8
  %incdec.ptr839 = getelementptr inbounds i8, ptr %149, i64 1
  store ptr %incdec.ptr839, ptr %next, align 8
  ...
  br i1 %cmp822, label %do.body826, label %do.end849.loopexit

do.end849.loopexit:                               ; preds = %do.end837
  %.pre2083 = load i32, ptr %length771, align 4
  br label %do.end849
...
do.end849:                                        ; preds = %do.end849.loopexit, %while.cond820.preheader
  ...
  store i32 %add856, ptr %length771, align 4
...
if.end865:                                        ; preds = %do.end849, %if.end811
  ...
  %152 = load ptr, ptr %distcode, align 8
  %conv8681914 = trunc i64 %hold.19 to i32
  %153 = load i32, ptr %distbits, align 4
  %notmask16441915 = shl nsw i32 -1, %153
  %sub8711916 = xor i32 %notmask16441915, -1
  %and8721917 = and i32 %sub8711916, %conv8681914
  %idxprom8731918 = zext i32 %and8721917 to i64
  %arrayidx8741919 = getelementptr inbounds %struct.code, ptr %152, i64 %idxprom8731918
  %here.sroa.18.0.arrayidx874.sroa_idx1920 = getelementptr inbounds i8, ptr %arrayidx8741919, i64 1
  %here.sroa.18.0.copyload11761921 = load i8, ptr %here.sroa.18.0.arrayidx874.sroa_idx1920, align 1
...
if.then885.do.end893_crit_edge:                   ; preds = %if.then885
  %.pre2084 = load ptr, ptr %distcode, align 8
  %.pre2085 = load i32, ptr %distbits, align 4
  br label %do.end893
...
do.end893:                                        ; preds = %if.then885.do.end893_crit_edge, %do.body882
  ...
  store ptr %incdec.ptr895, ptr %next, align 8
  ...
  %here.sroa.18.0.copyload1176 = load i8, ptr %here.sroa.18.0.arrayidx874.sroa_idx, align 1
...
for.end903:                                       ; preds = %for.end903.loopexit, %if.end865
  ...
  %here.sroa.0.0.copyload1172 = load i8, ptr %arrayidx874.lcssa, align 2
...
for.cond910.preheader:                            ; preds = %for.end903
  ...
  %arrayidx9281941 = getelementptr inbounds %struct.code, ptr %163, i64 %idxprom9271940
  %here.sroa.18.0.arrayidx928.sroa_idx1942 = getelementptr inbounds i8, ptr %arrayidx9281941, i64 1
  %here.sroa.18.0.copyload11771943 = load i8, ptr %here.sroa.18.0.arrayidx928.sroa_idx1942, align 1
...
if.then942.do.end950_crit_edge:                   ; preds = %if.then942
  %.pre2086 = load ptr, ptr %distcode, align 8
  br label %do.end950
...
do.end950:                                        ; preds = %if.then942.do.end950_crit_edge, %do.body939
  ...
  store ptr %incdec.ptr952, ptr %next, align 8
  ...
  %here.sroa.18.0.copyload1177 = load i8, ptr %here.sroa.18.0.arrayidx928.sroa_idx, align 1
...
do.body961:                                       ; preds = %do.body961.loopexit, %for.cond910.preheader
  ...
  %here.sroa.40.0.copyload1200 = load i16, ptr %here.sroa.40.0.arrayidx928.sroa_idx, align 2
  %here.sroa.0.0.copyload1173 = load i8, ptr %arrayidx928.lcssa, align 2
...
if.end989:                                        ; preds = %do.body972
  ...
  store i32 %conv991, ptr %offset, align 8
  %and994 = and i32 %conv983, 15
  store i32 %and994, ptr %extra, align 4
...
if.then1010.do.end1018_crit_edge:                 ; preds = %if.then1010
  %.pre2087 = load i32, ptr %extra, align 4
  br label %do.end1018
...
do.end1018:                                       ; preds = %if.then1010.do.end1018_crit_edge, %do.body1007
  ...
  store ptr %incdec.ptr1020, ptr %next, align 8
  ...
  br i1 %cmp1003, label %do.body1007, label %do.end1030.loopexit

do.end1030.loopexit:                              ; preds = %do.end1018
  %.pre2088 = load i32, ptr %offset, align 8
  br label %do.end1030
...
do.end1030:                                       ; preds = %do.end1030.loopexit, %while.cond1001.preheader
  ...
  store i32 %add1037, ptr %offset, align 8
...
if.end1046:                                       ; preds = %do.end1030, %if.end989
  ...
  %177 = load i32, ptr %wsize, align 4
  %178 = load i32, ptr %whave, align 8
...
do.body1064:                                      ; preds = %if.end1046, %do.cond1109
  ...
  %.pre2090 = load i32, ptr %wsize, align 4
  br i1 %cmp1066, label %if.then1068, label %do.end1078

if.then1068:                                      ; preds = %do.body1064
  %179 = load ptr, ptr %window, align 8
  store i32 %.pre2090, ptr %whave, align 8
  %call1072 = call i32 %out(ptr noundef %out_desc, ptr noundef %179, i32 noundef %.pre2090) #5
...
if.then1068.do.end1078_crit_edge:                 ; preds = %if.then1068
  %.pre2089 = load i32, ptr %wsize, align 4
  br label %do.end1078

do.end1078:                                       ; preds = %if.then1068.do.end1078_crit_edge, %do.body1064
  %180 = phi i32 [ %.pre2089, %if.then1068.do.end1078_crit_edge ], [ %.pre2090, %do.body1064 ]
  %put.5 = phi ptr [ %179, %if.then1068.do.end1078_crit_edge ], [ %put.4, %do.body1064 ]
  %left.5 = phi i32 [ %.pre2090, %if.then1068.do.end1078_crit_edge ], [ %left.4, %do.body1064 ]
  %181 = load i32, ptr %offset, align 8
  %sub1081 = sub i32 %180, %181
  %cmp1082 = icmp ult i32 %sub1081, %left.5
  %idx.ext1085 = zext i32 %sub1081 to i64
  %idx.ext1090 = zext i32 %181 to i64
  ...
  %182 = load i32, ptr %length771, align 4
  %copy.5 = call i32 @llvm.umin.i32(i32 %copy.4, i32 %182)
  %sub1100 = sub i32 %182, %copy.5
  store i32 %sub1100, ptr %length771, align 4
  %183 = add i32 %copy.5, -1
  %184 = zext i32 %183 to i64
  %185 = add nuw nsw i64 %184, 1
  %min.iters.check = icmp ult i32 %183, 31
  %186 = add nsw i64 %idx.ext1085.pn, 31
  %diff.check = icmp ult i64 %186, 32
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %next.gep2215, align 1
  %187 = getelementptr i8, ptr %next.gep2215, i64 16
  %wide.load2217 = load <16 x i8>, ptr %187, align 1
  store <16 x i8> %wide.load, ptr %next.gep, align 1
  %188 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load2217, ptr %188, align 1
  %index.next = add nuw i64 %index, 32
  %189 = icmp eq i64 %index.next, %n.vec
  br i1 %189, label %middle.block, label %vector.body
...
do.body1102.prol:                                 ; preds = %do.body1102.preheader, %do.body1102.prol
  ...
  %191 = load i8, ptr %from.1.prol, align 1
  %incdec.ptr1104.prol = getelementptr inbounds i8, ptr %put.6.prol, i64 1
  store i8 %191, ptr %put.6.prol, align 1
  ...
  br i1 %prol.iter2294.cmp.not, label %do.body1102.prol.loopexit, label %do.body1102.prol
...
do.body1102.prol.loopexit:                        ; preds = %do.body1102.prol, %do.body1102.preheader
  ...
  %192 = icmp ult i32 %190, 7
  br i1 %192, label %do.cond1109, label %do.body1102
...
do.cond1109:                                      ; preds = %do.body1102.prol.loopexit, %do.body1102, %middle.block
  ...
  %201 = load i32, ptr %length771, align 4
  %cmp1111.not = icmp eq i32 %201, 0
  br i1 %cmp1111.not, label %sw.epilog1128, label %do.body1064

sw.bb1114:                                        ; preds = %for.cond
  %202 = load i32, ptr %wsize, align 4
  %cmp1116 = icmp ult i32 %left.0, %202
  br i1 %cmp1116, label %if.then1118, label %inf_leave

if.then1118:                                      ; preds = %sw.bb1114
  %203 = load ptr, ptr %window, align 8
  %sub1121 = sub i32 %202, %left.0
  %call1122 = call i32 %out(ptr noundef %out_desc, ptr noundef %203, i32 noundef %sub1121) #5
...
inf_leave.loopexit2235:                           ; preds = %for.cond
  br label %inf_leave

inf_leave:                                        ; preds = %if.then780, %if.then1068, %if.then127, %for.cond, %inf_leave.loopexit2235, %if.then1118, %sw.bb1114, %if.then1014, %if.then946, %if.then889, %if.then833, %if.then733, %if.then673, %if.then505, %if.then453, %if.then383, %if.then328, %if.then241, %if.then169, %if.then119, %if.then76, %if.then19
  %have.42 = phi i32 [ %have.0, %sw.bb1114 ], [ 0, %if.then833 ], [ 0, %if.then1014 ], [ 0, %if.then946 ], [ 0, %if.then889 ], [ 0, %if.then733 ], [ 0, %if.then673 ], [ 0, %if.then169 ], [ 0, %if.then241 ], [ 0, %if.then383 ], [ 0, %if.then453 ], [ 0, %if.then505 ], [ 0, %if.then328 ], [ 0, %if.then76 ], [ 0, %if.then119 ], [ 0, %if.then19 ], [ %have.0, %if.then1118 ], [ %have.0, %for.cond ], [ %have.6, %if.then127 ], [ %have.40, %if.then1068 ], [ %have.29, %if.then780 ], [ %have.0, %inf_leave.loopexit2235 ]
  %ret.0 = phi i32 [ 1, %sw.bb1114 ], [ -5, %if.then833 ], [ -5, %if.then1014 ], [ -5, %if.then946 ], [ -5, %if.then889 ], [ -5, %if.then733 ], [ -5, %if.then673 ], [ -5, %if.then169 ], [ -5, %if.then241 ], [ -5, %if.then383 ], [ -5, %if.then453 ], [ -5, %if.then505 ], [ -5, %if.then328 ], [ -5, %if.then76 ], [ -5, %if.then119 ], [ -5, %if.then19 ], [ %spec.select1648, %if.then1118 ], [ -2, %for.cond ], [ -5, %if.then127 ], [ -5, %if.then1068 ], [ -5, %if.then780 ], [ -3, %inf_leave.loopexit2235 ]
  %204 = load ptr, ptr %next, align 8
  store ptr %204, ptr %strm, align 8
  store i32 %have.42, ptr %avail_in625, align 8
  br label %cleanup
