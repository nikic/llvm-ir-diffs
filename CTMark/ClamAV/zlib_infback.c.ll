; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/zlib_infback.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/zlib_infback.c"
...
for.cond:                                         ; preds = %sw.epilog1128, %cond.end
  ...
  switch i32 %5, label %inf_leave [
    ...
    i32 16209, label %inf_leave.loopexit2235
  ]
...
while.cond.preheader:                             ; preds = %sw.bb
  %cmp131978 = icmp ult i32 %bits.0, 3
  br i1 %cmp131978, label %do.body15, label %do.end29
...
do.body55:                                        ; preds = %for.cond
  ...
  %cmp651963 = icmp ult i32 %sub60, 32
  br i1 %cmp651963, label %do.body69.preheader, label %do.end92
...
do.body69:                                        ; preds = %do.body69.preheader, %do.end80
  ...
  %hold.21965 = phi i64 [ %shr58, %do.body69.preheader ], [ %add86, %do.end80 ]
  %have.31964 = phi i32 [ %have.0, %do.body69.preheader ], [ %dec81, %do.end80 ]
  %cmp70 = icmp eq i32 %have.31964, 0
...
do.end80:                                         ; preds = %if.then72, %do.body69
  %have.4 = phi i32 [ %call73, %if.then72 ], [ %have.31964, %do.body69 ]
  ...
  %add86 = add i64 %shl85, %hold.21965
...
do.end92:                                         ; preds = %do.end92.loopexit, %do.body55
  ...
  %16 = xor i64 %shr94, %and93
  %cmp95.not = icmp eq i64 %16, 65535
...
if.end100:                                        ; preds = %do.end92
  ...
  %cmp108.not1970 = icmp eq i32 %and102, 0
  br i1 %cmp108.not1970, label %while.end153, label %while.body110

while.body110:                                    ; preds = %if.end100, %do.end137
  %left.11974 = phi i32 [ %sub148, %do.end137 ], [ %left.0, %if.end100 ]
  %have.51973 = phi i32 [ %sub147, %do.end137 ], [ %have.3.lcssa, %if.end100 ]
  %put.11972 = phi ptr [ %add.ptr150, %do.end137 ], [ %put.0, %if.end100 ]
  %storemerge1971 = phi i32 [ %sub152, %do.end137 ], [ %and102, %if.end100 ]
  %cmp113 = icmp eq i32 %have.51973, 0
...
do.body124:                                       ; preds = %while.body110, %if.then115
  %have.6 = phi i32 [ %call116, %if.then115 ], [ %have.51973, %while.body110 ]
  %cmp125 = icmp eq i32 %left.11974, 0
  br i1 %cmp125, label %if.then127, label %do.end137

if.then127:                                       ; preds = %do.body124
  %17 = load ptr, ptr %window, align 8, !tbaa !21
  %18 = load i32, ptr %wsize, align 4, !tbaa !20
  store i32 %18, ptr %whave, align 8, !tbaa !23
  %call131 = call i32 %out(ptr noundef %out_desc, ptr noundef %17, i32 noundef %18) #5
  %tobool132.not = icmp eq i32 %call131, 0
  br i1 %tobool132.not, label %do.end137, label %inf_leave

do.end137:                                        ; preds = %if.then127, %do.body124
  %put.2 = phi ptr [ %17, %if.then127 ], [ %put.11972, %do.body124 ]
  %left.2 = phi i32 [ %18, %if.then127 ], [ %left.11974, %do.body124 ]
  %spec.select = call i32 @llvm.umin.i32(i32 %storemerge1971, i32 %have.6)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %put.2, ptr align 1 %19, i64 %conv146, i1 false)
  %sub147 = sub i32 %have.6, %copy.1
  %20 = load ptr, ptr %next, align 8, !tbaa !27
  %add.ptr = getelementptr inbounds i8, ptr %20, i64 %conv146
  ...
  %21 = load i32, ptr %length771, align 4, !tbaa !35
  %sub152 = sub i32 %21, %copy.1
...
do.end173:                                        ; preds = %if.then165, %do.body162
  ...
  %22 = load ptr, ptr %next, align 8, !tbaa !27
  %incdec.ptr175 = getelementptr inbounds i8, ptr %22, i64 1
  store ptr %incdec.ptr175, ptr %next, align 8, !tbaa !27
  %23 = load i8, ptr %22, align 1, !tbaa !5
  %conv176 = zext i8 %23 to i64
...
do.end185:                                        ; preds = %do.end185.loopexit, %while.cond157.preheader
  ...
  %bits.3.lcssa = phi i32 [ %bits.0, %while.cond157.preheader ], [ %24, %do.end185.loopexit ]
  ...
  %25 = lshr i32 %conv186, 5
  %and195 = and i32 %25, 31
  %add196 = add nuw nsw i32 %and195, 1
  store i32 %add196, ptr %ndist, align 8, !tbaa !39
  %26 = lshr i32 %conv186, 10
  %and203 = and i32 %26, 15
...
while.body274.preheader:                          ; preds = %while.cond270.preheader
  %27 = zext i32 %inc to i64
  br label %while.body274

while.cond229.preheader:                          ; preds = %while.cond229.preheader.preheader, %do.end257
  %.pre20742093 = phi i32 [ %.pre20742094, %do.end257 ], [ %add204, %while.cond229.preheader.preheader ]
  %28 = phi i32 [ %32, %do.end257 ], [ %add204, %while.cond229.preheader.preheader ]
  %29 = phi i32 [ %inc, %do.end257 ], [ 0, %while.cond229.preheader.preheader ]
...
do.end245:                                        ; preds = %if.then237.do.end245_crit_edge, %do.body234
  %.pre2074 = phi i32 [ %.pre2074.pre, %if.then237.do.end245_crit_edge ], [ %.pre20742093, %do.body234 ]
  %.pre2073 = phi i32 [ %.pre2073.pre, %if.then237.do.end245_crit_edge ], [ %29, %do.body234 ]
  %have.11 = phi i32 [ %call238, %if.then237.do.end245_crit_edge ], [ %have.91803, %do.body234 ]
  %dec246 = add i32 %have.11, -1
  %30 = load ptr, ptr %next, align 8, !tbaa !27
  %incdec.ptr247 = getelementptr inbounds i8, ptr %30, i64 1
  store ptr %incdec.ptr247, ptr %next, align 8, !tbaa !27
  %31 = load i8, ptr %30, align 1, !tbaa !5
  %conv248 = zext i8 %31 to i64
  %sh_prom249 = zext i32 %bits.41805 to i64
  %shl250 = shl nuw nsw i64 %conv248, %sh_prom249
  %add251 = add nuw i64 %shl250, %hold.41804
  %add252 = add nuw nsw i32 %bits.41805, 8
  br label %do.end257

do.end257:                                        ; preds = %do.end245, %while.cond229.preheader
  %.pre20742094 = phi i32 [ %.pre2074, %do.end245 ], [ %.pre20742093, %while.cond229.preheader ]
  %32 = phi i32 [ %.pre2074, %do.end245 ], [ %28, %while.cond229.preheader ]
  %33 = phi i32 [ %.pre2073, %do.end245 ], [ %29, %while.cond229.preheader ]
  ...
  %34 = load i16, ptr %arrayidx, align 2, !tbaa !42
  %idxprom262 = zext i16 %34 to i64
...
while.body274:                                    ; preds = %while.body274.preheader, %while.body274
  %indvars.iv2044 = phi i64 [ %27, %while.body274.preheader ], [ %indvars.iv.next2045, %while.body274 ]
  ...
  %35 = load i16, ptr %arrayidx279, align 2, !tbaa !42
  %idxprom280 = zext i16 %35 to i64
  ...
  %36 = and i64 %indvars.iv.next2045, 4294967295
...
if.end295:                                        ; preds = %while.end282
  store i32 0, ptr %have221, align 4, !tbaa !41
  %37 = load i32, ptr %nlen, align 4, !tbaa !38
  %38 = load i32, ptr %ndist, align 8, !tbaa !39
  %add3011857 = sub i32 0, %37
  %cmp3021858.not = icmp eq i32 %38, %add3011857
...
for.cond305.preheader:                            ; preds = %if.end295, %if.end564
  ...
  %39 = load ptr, ptr %lencode, align 8, !tbaa !29
  %conv3071812 = trunc i64 %hold.61860 to i32
  %40 = load i32, ptr %lenbits, align 8, !tbaa !30
  %notmask1813 = shl nsw i32 -1, %40
  %sub3101814 = xor i32 %notmask1813, -1
  %and3111815 = and i32 %sub3101814, %conv3071812
  %idxprom3121816 = zext i32 %and3111815 to i64
  %arrayidx3131817 = getelementptr inbounds %struct.code, ptr %39, i64 %idxprom3121816
...
do.body321.preheader:                             ; preds = %for.cond305.preheader
  %41 = zext i32 %bits.61861 to i64
  br label %do.body321

do.body321:                                       ; preds = %do.body321.preheader, %do.end332
  %42 = phi i32 [ %40, %do.body321.preheader ], [ %44, %do.end332 ]
  %43 = phi ptr [ %39, %do.body321.preheader ], [ %45, %do.end332 ]
  %indvars.iv2047 = phi i64 [ %41, %do.body321.preheader ], [ %indvars.iv.next2048, %do.end332 ]
...
do.end332:                                        ; preds = %if.then324.do.end332_crit_edge, %do.body321
  %44 = phi i32 [ %.pre2076, %if.then324.do.end332_crit_edge ], [ %42, %do.body321 ]
  %45 = phi ptr [ %.pre2075, %if.then324.do.end332_crit_edge ], [ %43, %do.body321 ]
  %have.14 = phi i32 [ %call325, %if.then324.do.end332_crit_edge ], [ %have.131824, %do.body321 ]
  %dec333 = add i32 %have.14, -1
  %46 = load ptr, ptr %next, align 8, !tbaa !27
  %incdec.ptr334 = getelementptr inbounds i8, ptr %46, i64 1
  store ptr %incdec.ptr334, ptr %next, align 8, !tbaa !27
  %47 = load i8, ptr %46, align 1, !tbaa !5
  %conv335 = zext i8 %47 to i64
  ...
  %sub310 = xor i32 %notmask, -1
  %and311 = and i32 %sub310, %conv307
  %idxprom312 = zext i32 %and311 to i64
  %arrayidx313 = getelementptr inbounds %struct.code, ptr %45, i64 %idxprom312
  ...
  %48 = zext i8 %here.sroa.18.0.copyload to i64
  %cmp316.not = icmp ult i64 %indvars.iv.next2048, %48
...
for.end.loopexit:                                 ; preds = %do.end332
  ...
  %49 = trunc i64 %indvars.iv.next2048 to i32
  br label %for.end
...
for.end:                                          ; preds = %for.end.loopexit, %for.cond305.preheader
  ...
  %bits.7.lcssa = phi i32 [ %bits.61861, %for.cond305.preheader ], [ %49, %for.end.loopexit ]
...
do.body346:                                       ; preds = %for.end
  ...
  %50 = load i32, ptr %have221, align 4, !tbaa !41
  %inc359 = add i32 %50, 1
  store i32 %inc359, ptr %have221, align 4, !tbaa !41
  %idxprom360 = zext i32 %50 to i64
  ...
  %.pre2096 = add i32 %.pre2078, %.pre2077
  br label %if.end564
...
do.body498.preheader:                             ; preds = %while.cond490.preheader
  ...
  %56 = zext i32 %add493 to i64
  br label %do.body498

do.body376:                                       ; preds = %do.body376.preheader, %do.end387
  %indvars.iv2053 = phi i64 [ %53, %do.body376.preheader ], [ %indvars.iv.next2054, %do.end387 ]
...
do.end387:                                        ; preds = %if.then379, %do.body376
  ...
  %57 = load ptr, ptr %next, align 8, !tbaa !27
  %incdec.ptr389 = getelementptr inbounds i8, ptr %57, i64 1
  store ptr %incdec.ptr389, ptr %next, align 8, !tbaa !27
  %58 = load i8, ptr %57, align 1, !tbaa !5
  %conv390 = zext i8 %58 to i64
...
do.body400:                                       ; preds = %do.body400.loopexit, %while.cond368.preheader
  ...
  %bits.8.lcssa = phi i32 [ %bits.7.lcssa, %while.cond368.preheader ], [ %59, %do.body400.loopexit ]
  ...
  %60 = load i32, ptr %have221, align 4, !tbaa !41
  %cmp411 = icmp eq i32 %60, 0
...
if.end416:                                        ; preds = %do.body400
  ...
  %61 = load i16, ptr %arrayidx421, align 2, !tbaa !42
...
do.body446:                                       ; preds = %do.body446.preheader, %do.end457
  %indvars.iv2050 = phi i64 [ %51, %do.body446.preheader ], [ %indvars.iv.next2051, %do.end457 ]
...
do.end457:                                        ; preds = %if.then449, %do.body446
  ...
  %62 = load ptr, ptr %next, align 8, !tbaa !27
  %incdec.ptr459 = getelementptr inbounds i8, ptr %62, i64 1
  store ptr %incdec.ptr459, ptr %next, align 8, !tbaa !27
  %63 = load i8, ptr %62, align 1, !tbaa !5
  %conv460 = zext i8 %63 to i64
...
do.body470:                                       ; preds = %do.body470.loopexit, %while.cond438.preheader
  ...
  %bits.9.lcssa = phi i32 [ %bits.7.lcssa, %while.cond438.preheader ], [ %64, %do.body470.loopexit ]
...
do.body498:                                       ; preds = %do.body498.preheader, %do.end509
  %indvars.iv2056 = phi i64 [ %55, %do.body498.preheader ], [ %indvars.iv.next2057, %do.end509 ]
...
do.end509:                                        ; preds = %if.then501, %do.body498
  ...
  %65 = load ptr, ptr %next, align 8, !tbaa !27
  %incdec.ptr511 = getelementptr inbounds i8, ptr %65, i64 1
  store ptr %incdec.ptr511, ptr %next, align 8, !tbaa !27
  %66 = load i8, ptr %65, align 1, !tbaa !5
  %conv512 = zext i8 %66 to i64
...
do.body522:                                       ; preds = %do.body522.loopexit, %while.cond490.preheader
  ...
  %bits.10.lcssa = phi i32 [ %bits.7.lcssa, %while.cond490.preheader ], [ %67, %do.body522.loopexit ]
  ...
  %reass.sub1985 = sub i32 %bits.10.lcssa, %conv315.lcssa1811
  %sub537 = add i32 %reass.sub1985, -7
  br label %if.end541
...
if.end541:                                        ; preds = %do.body470, %do.body522, %if.end416
  ...
  %len.0 = phi i16 [ %61, %if.end416 ], [ 0, %do.body470 ], [ 0, %do.body522 ]
  %68 = load i32, ptr %have221, align 4, !tbaa !41
  %add543 = add i32 %68, %copy.2
  %69 = load i32, ptr %nlen, align 4, !tbaa !38
  %70 = load i32, ptr %ndist, align 8, !tbaa !39
  %add546 = add i32 %70, %69
...
while.body556.preheader:                          ; preds = %if.end541
  %min.iters.check2220 = icmp ult i32 %copy.2, 16
  br i1 %min.iters.check2220, label %while.body556.preheader2233, label %vector.scevcheck

vector.scevcheck:                                 ; preds = %while.body556.preheader
  %71 = add nsw i32 %copy.2, -1
  %72 = xor i32 %68, -1
  %73 = icmp ugt i32 %71, %72
  br i1 %73, label %while.body556.preheader2233, label %vector.ph2221

vector.ph2221:                                    ; preds = %vector.scevcheck
  %n.vec2223 = and i32 %copy.2, -16
  %ind.end2224 = and i32 %copy.2, 15
  %ind.end2226 = add i32 %68, %n.vec2223
  ...
  %75 = getelementptr inbounds %struct.inflate_state, ptr %0, i64 0, i32 29, i64 %74
  store <8 x i16> %broadcast.splat, ptr %75, align 2, !tbaa !42
  %76 = getelementptr inbounds i16, ptr %75, i64 8
  store <8 x i16> %broadcast.splat, ptr %76, align 2, !tbaa !42
  %77 = icmp eq i32 %n.vec2223, 16
  br i1 %77, label %middle.block2218, label %vector.body2229.1, !llvm.loop !51

vector.body2229.1:                                ; preds = %vector.ph2221
  %offset.idx.1 = add i32 %68, 16
  %78 = zext i32 %offset.idx.1 to i64
  %79 = getelementptr inbounds %struct.inflate_state, ptr %0, i64 0, i32 29, i64 %78
  store <8 x i16> %broadcast.splat, ptr %79, align 2, !tbaa !42
  %80 = getelementptr inbounds i16, ptr %79, i64 8
  store <8 x i16> %broadcast.splat, ptr %80, align 2, !tbaa !42
  %81 = icmp eq i32 %n.vec2223, 32
  br i1 %81, label %middle.block2218, label %vector.body2229.2, !llvm.loop !51

vector.body2229.2:                                ; preds = %vector.body2229.1
  %offset.idx.2 = add i32 %68, 32
  %82 = zext i32 %offset.idx.2 to i64
  %83 = getelementptr inbounds %struct.inflate_state, ptr %0, i64 0, i32 29, i64 %82
  store <8 x i16> %broadcast.splat, ptr %83, align 2, !tbaa !42
  %84 = getelementptr inbounds i16, ptr %83, i64 8
  store <8 x i16> %broadcast.splat, ptr %84, align 2, !tbaa !42
  %85 = icmp eq i32 %n.vec2223, 48
  br i1 %85, label %middle.block2218, label %vector.body2229.3, !llvm.loop !51

vector.body2229.3:                                ; preds = %vector.body2229.2
  %offset.idx.3 = add i32 %68, 48
  %86 = zext i32 %offset.idx.3 to i64
  %87 = getelementptr inbounds %struct.inflate_state, ptr %0, i64 0, i32 29, i64 %86
  store <8 x i16> %broadcast.splat, ptr %87, align 2, !tbaa !42
  %88 = getelementptr inbounds i16, ptr %87, i64 8
  store <8 x i16> %broadcast.splat, ptr %88, align 2, !tbaa !42
  %89 = icmp eq i32 %n.vec2223, 64
  br i1 %89, label %middle.block2218, label %vector.body2229.4, !llvm.loop !51

vector.body2229.4:                                ; preds = %vector.body2229.3
  %offset.idx.4 = add i32 %68, 64
  %90 = zext i32 %offset.idx.4 to i64
  %91 = getelementptr inbounds %struct.inflate_state, ptr %0, i64 0, i32 29, i64 %90
  store <8 x i16> %broadcast.splat, ptr %91, align 2, !tbaa !42
  %92 = getelementptr inbounds i16, ptr %91, i64 8
  store <8 x i16> %broadcast.splat, ptr %92, align 2, !tbaa !42
  %93 = icmp eq i32 %n.vec2223, 80
  br i1 %93, label %middle.block2218, label %vector.body2229.5, !llvm.loop !51

vector.body2229.5:                                ; preds = %vector.body2229.4
  %offset.idx.5 = add i32 %68, 80
  %94 = zext i32 %offset.idx.5 to i64
  %95 = getelementptr inbounds %struct.inflate_state, ptr %0, i64 0, i32 29, i64 %94
  store <8 x i16> %broadcast.splat, ptr %95, align 2, !tbaa !42
  %96 = getelementptr inbounds i16, ptr %95, i64 8
  store <8 x i16> %broadcast.splat, ptr %96, align 2, !tbaa !42
  %97 = icmp eq i32 %n.vec2223, 96
  br i1 %97, label %middle.block2218, label %vector.body2229.6, !llvm.loop !51

vector.body2229.6:                                ; preds = %vector.body2229.5
  %offset.idx.6 = add i32 %68, 96
  %98 = zext i32 %offset.idx.6 to i64
  %99 = getelementptr inbounds %struct.inflate_state, ptr %0, i64 0, i32 29, i64 %98
  store <8 x i16> %broadcast.splat, ptr %99, align 2, !tbaa !42
  %100 = getelementptr inbounds i16, ptr %99, i64 8
  store <8 x i16> %broadcast.splat, ptr %100, align 2, !tbaa !42
  %101 = icmp eq i32 %n.vec2223, 112
  br i1 %101, label %middle.block2218, label %vector.body2229.7, !llvm.loop !51

vector.body2229.7:                                ; preds = %vector.body2229.6
  %offset.idx.7 = add i32 %68, 112
  %102 = zext i32 %offset.idx.7 to i64
  %103 = getelementptr inbounds %struct.inflate_state, ptr %0, i64 0, i32 29, i64 %102
  store <8 x i16> %broadcast.splat, ptr %103, align 2, !tbaa !42
  %104 = getelementptr inbounds i16, ptr %103, i64 8
  store <8 x i16> %broadcast.splat, ptr %104, align 2, !tbaa !42
  br label %middle.block2218

middle.block2218:                                 ; preds = %vector.body2229.7, %vector.body2229.6, %vector.body2229.5, %vector.body2229.4, %vector.body2229.3, %vector.body2229.2, %vector.body2229.1, %vector.ph2221
  %cmp.n2228 = icmp eq i32 %copy.2, %n.vec2223
  br i1 %cmp.n2228, label %if.end564.loopexit, label %while.body556.preheader2233

while.body556.preheader2233:                      ; preds = %vector.scevcheck, %while.body556.preheader, %middle.block2218
  %copy.31856.ph = phi i32 [ %copy.2, %vector.scevcheck ], [ %copy.2, %while.body556.preheader ], [ %ind.end2224, %middle.block2218 ]
  %.ph = phi i32 [ %68, %vector.scevcheck ], [ %68, %while.body556.preheader ], [ %ind.end2226, %middle.block2218 ]
  %105 = add nsw i32 %copy.31856.ph, -1
  %xtraiter = and i32 %copy.31856.ph, 3
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %while.body556.prol.loopexit, label %while.body556.prol

while.body556.prol:                               ; preds = %while.body556.preheader2233, %while.body556.prol
  %copy.31856.prol = phi i32 [ %dec554.prol, %while.body556.prol ], [ %copy.31856.ph, %while.body556.preheader2233 ]
  %106 = phi i32 [ %inc560.prol, %while.body556.prol ], [ %.ph, %while.body556.preheader2233 ]
  %prol.iter = phi i32 [ %prol.iter.next, %while.body556.prol ], [ 0, %while.body556.preheader2233 ]
  %dec554.prol = add nsw i32 %copy.31856.prol, -1
  %inc560.prol = add i32 %106, 1
  %idxprom561.prol = zext i32 %106 to i64
...
while.body556.prol.loopexit:                      ; preds = %while.body556.prol, %while.body556.preheader2233
  %inc560.lcssa2237.unr = phi i32 [ undef, %while.body556.preheader2233 ], [ %inc560.prol, %while.body556.prol ]
  %copy.31856.unr = phi i32 [ %copy.31856.ph, %while.body556.preheader2233 ], [ %dec554.prol, %while.body556.prol ]
  %.unr = phi i32 [ %.ph, %while.body556.preheader2233 ], [ %inc560.prol, %while.body556.prol ]
  %107 = icmp ult i32 %105, 3
  br i1 %107, label %if.end564.loopexit, label %while.body556
...
while.body556:                                    ; preds = %while.body556.prol.loopexit, %while.body556
  ...
  %108 = phi i32 [ %inc560.3, %while.body556 ], [ %.unr, %while.body556.prol.loopexit ]
  %inc560 = add i32 %108, 1
  %idxprom561 = zext i32 %108 to i64
...
if.end564.loopexit:                               ; preds = %while.body556.prol.loopexit, %while.body556, %middle.block2218
  %inc560.lcssa = phi i32 [ %ind.end2226, %middle.block2218 ], [ %inc560.lcssa2237.unr, %while.body556.prol.loopexit ], [ %inc560.3, %while.body556 ]
  store i32 %inc560.lcssa, ptr %have221, align 4, !tbaa !41
  br label %if.end564

if.end564:                                        ; preds = %if.end564.loopexit, %do.body346
  %add301.pre-phi = phi i32 [ %add546, %if.end564.loopexit ], [ %.pre2096, %do.body346 ]
  %109 = phi i32 [ %69, %if.end564.loopexit ], [ %.pre2077, %do.body346 ]
  %110 = phi i32 [ %inc560.lcssa, %if.end564.loopexit ], [ %inc359, %do.body346 ]
...
if.end570:                                        ; preds = %while.end565
  %112 = load i16, ptr %arrayidx572, align 8, !tbaa !42
  %cmp574 = icmp eq i16 %112, 0
...
if.end579:                                        ; preds = %if.end570
  ...
  store ptr %codes, ptr %lencode, align 8, !tbaa !29
  store i32 9, ptr %lenbits, align 8, !tbaa !30
  %call593 = call i32 @inflate_table(i32 noundef 1, ptr noundef nonnull %lens285, i32 noundef %111, ptr noundef nonnull %next283, ptr noundef nonnull %lenbits, ptr noundef nonnull %work) #5
...
if.end598:                                        ; preds = %if.end579
  %113 = load ptr, ptr %next283, align 8, !tbaa !46
  store ptr %113, ptr %distcode, align 8, !tbaa !31
  store i32 6, ptr %distbits, align 4, !tbaa !32
  %114 = load i32, ptr %nlen, align 4, !tbaa !38
  %idx.ext603 = zext i32 %114 to i64
  %add.ptr604 = getelementptr inbounds i16, ptr %lens285, i64 %idx.ext603
  %115 = load i32, ptr %ndist, align 8, !tbaa !39
  %call610 = call i32 @inflate_table(i32 noundef 2, ptr noundef nonnull %add.ptr604, i32 noundef %115, ptr noundef nonnull %next283, ptr noundef nonnull %distbits, ptr noundef nonnull %work) #5
...
for.cond650.preheader:                            ; preds = %sw.bb617
  %116 = load ptr, ptr %lencode, align 8, !tbaa !29
  %conv6521865 = trunc i64 %hold.14 to i32
  %117 = load i32, ptr %lenbits, align 8, !tbaa !30
  %notmask16411866 = shl nsw i32 -1, %117
  %sub6551867 = xor i32 %notmask16411866, -1
  %and6561868 = and i32 %sub6551867, %conv6521865
  %idxprom6571869 = zext i32 %and6561868 to i64
  %arrayidx6581870 = getelementptr inbounds %struct.code, ptr %116, i64 %idxprom6571869
  %here.sroa.18.0.arrayidx658.sroa_idx1871 = getelementptr inbounds i8, ptr %arrayidx6581870, i64 1
  %here.sroa.18.0.copyload11741872 = load i8, ptr %here.sroa.18.0.arrayidx658.sroa_idx1871, align 1, !tbaa.struct !47
  %conv6601875 = zext i8 %here.sroa.18.0.copyload11741872 to i32
  %cmp661.not1876 = icmp ult i32 %bits.14, %conv6601875
  br i1 %cmp661.not1876, label %do.body666.preheader, label %for.end687

do.body666.preheader:                             ; preds = %for.cond650.preheader
  %118 = zext i32 %bits.14 to i64
  br label %do.body666

do.body623:                                       ; preds = %sw.bb617
  store ptr %put.0, ptr %next_out, align 8, !tbaa !58
  store i32 %left.0, ptr %avail_out, align 8, !tbaa !59
  %119 = load ptr, ptr %next, align 8, !tbaa !27
  store ptr %119, ptr %strm, align 8, !tbaa !26
  ...
  %120 = load i32, ptr %whave, align 8, !tbaa !23
  %121 = load i32, ptr %wsize, align 4, !tbaa !20
  %cmp632 = icmp ult i32 %120, %121
  br i1 %cmp632, label %if.then634, label %if.end638

if.then634:                                       ; preds = %do.body623
  %sub636 = sub i32 %121, %left.0
  store i32 %sub636, ptr %whave, align 8, !tbaa !23
  br label %if.end638

if.end638:                                        ; preds = %if.then634, %do.body623
  call void @inflate_fast(ptr noundef nonnull %strm, i32 noundef %121) #5
  %122 = load ptr, ptr %next_out, align 8, !tbaa !58
  %123 = load i32, ptr %avail_out, align 8, !tbaa !59
  %124 = load ptr, ptr %strm, align 8, !tbaa !26
  store ptr %124, ptr %next, align 8, !tbaa !27
  %125 = load i32, ptr %avail_in625, align 8, !tbaa !28
  %126 = load i64, ptr %hold626, align 8, !tbaa !60
  %127 = load i32, ptr %bits627, align 8, !tbaa !61
  br label %sw.epilog1128

do.body666:                                       ; preds = %do.body666.preheader, %do.end677
  %128 = phi i32 [ %117, %do.body666.preheader ], [ %130, %do.end677 ]
  %129 = phi ptr [ %116, %do.body666.preheader ], [ %131, %do.end677 ]
  %indvars.iv2059 = phi i64 [ %118, %do.body666.preheader ], [ %indvars.iv.next2060, %do.end677 ]
  %hold.151878 = phi i64 [ %hold.14, %do.body666.preheader ], [ %add683, %do.end677 ]
  %have.251877 = phi i32 [ %have.24, %do.body666.preheader ], [ %dec678, %do.end677 ]
  %cmp667 = icmp eq i32 %have.251877, 0
...
do.end677:                                        ; preds = %if.then669.do.end677_crit_edge, %do.body666
  %130 = phi i32 [ %.pre2080, %if.then669.do.end677_crit_edge ], [ %128, %do.body666 ]
  %131 = phi ptr [ %.pre2079, %if.then669.do.end677_crit_edge ], [ %129, %do.body666 ]
  %have.26 = phi i32 [ %call670, %if.then669.do.end677_crit_edge ], [ %have.251877, %do.body666 ]
  %dec678 = add i32 %have.26, -1
  %132 = load ptr, ptr %next, align 8, !tbaa !27
  %incdec.ptr679 = getelementptr inbounds i8, ptr %132, i64 1
  store ptr %incdec.ptr679, ptr %next, align 8, !tbaa !27
  %133 = load i8, ptr %132, align 1, !tbaa !5
  %conv680 = zext i8 %133 to i64
  %shl682 = shl i64 %conv680, %indvars.iv2059
  %add683 = add i64 %shl682, %hold.151878
  %indvars.iv.next2060 = add nuw nsw i64 %indvars.iv2059, 8
  %conv652 = trunc i64 %add683 to i32
  %notmask1641 = shl nsw i32 -1, %130
  %sub655 = xor i32 %notmask1641, -1
  %and656 = and i32 %sub655, %conv652
  %idxprom657 = zext i32 %and656 to i64
  %arrayidx658 = getelementptr inbounds %struct.code, ptr %131, i64 %idxprom657
  ...
  %134 = zext i8 %here.sroa.18.0.copyload1174 to i64
  %cmp661.not = icmp ult i64 %indvars.iv.next2060, %134
...
for.end687.loopexit:                              ; preds = %do.end677
  ...
  %135 = trunc i64 %indvars.iv.next2060 to i32
  br label %for.end687

for.end687:                                       ; preds = %for.end687.loopexit, %for.cond650.preheader
  %136 = phi ptr [ %116, %for.cond650.preheader ], [ %131, %for.end687.loopexit ]
  ...
  %bits.15.lcssa = phi i32 [ %bits.14, %for.cond650.preheader ], [ %135, %for.end687.loopexit ]
  %arrayidx658.lcssa = phi ptr [ %arrayidx6581870, %for.cond650.preheader ], [ %arrayidx658, %for.end687.loopexit ]
  %here.sroa.18.0.copyload1174.lcssa = phi i8 [ %here.sroa.18.0.copyload11741872, %for.cond650.preheader ], [ %here.sroa.18.0.copyload1174, %for.end687.loopexit ]
  %conv660.lcssa = phi i32 [ %conv6601875, %for.cond650.preheader ], [ %conv660, %for.end687.loopexit ]
  %here.sroa.40.0.copyload1197.lcssa.in = getelementptr inbounds i8, ptr %arrayidx658.lcssa, i64 2
  %here.sroa.40.0.copyload1197.lcssa = load i16, ptr %here.sroa.40.0.copyload1197.lcssa.in, align 2
  %here.sroa.0.0.copyload1170 = load i8, ptr %arrayidx658.lcssa, align 2, !tbaa.struct !62
  %137 = add i8 %here.sroa.0.0.copyload1170, -1
  %or.cond1647 = icmp ult i8 %137, 15
  br i1 %or.cond1647, label %for.cond697.preheader, label %do.body759

for.cond697.preheader:                            ; preds = %for.end687
  %conv688 = zext i8 %here.sroa.0.0.copyload1170 to i32
  %conv700 = zext i16 %here.sroa.40.0.copyload1197.lcssa to i32
  %add706 = add nuw nsw i32 %conv660.lcssa, %conv688
  %notmask1642 = shl nsw i32 -1, %add706
  %sub708 = xor i32 %notmask1642, -1
  %conv7011887 = trunc i64 %hold.15.lcssa to i32
  %and7091888 = and i32 %conv7011887, %sub708
  %shr7121889 = lshr i32 %and7091888, %conv660.lcssa
  %add7131890 = add nuw i32 %shr7121889, %conv700
  %idxprom7141891 = zext i32 %add7131890 to i64
  %arrayidx7151892 = getelementptr inbounds %struct.code, ptr %136, i64 %idxprom7141891
  %here.sroa.18.0.arrayidx715.sroa_idx1893 = getelementptr inbounds i8, ptr %arrayidx7151892, i64 1
  %here.sroa.18.0.copyload11751894 = load i8, ptr %here.sroa.18.0.arrayidx715.sroa_idx1893, align 1, !tbaa.struct !47
  %conv7191895 = zext i8 %here.sroa.18.0.copyload11751894 to i32
  %add7201896 = add nuw nsw i32 %conv660.lcssa, %conv7191895
  %cmp721.not1897 = icmp ugt i32 %add7201896, %bits.15.lcssa
  br i1 %cmp721.not1897, label %do.body726.preheader, label %do.body748

do.body726.preheader:                             ; preds = %for.cond697.preheader
  %138 = zext i32 %bits.15.lcssa to i64
  br label %do.body726

do.body726:                                       ; preds = %do.body726.preheader, %do.end737
  %139 = phi ptr [ %136, %do.body726.preheader ], [ %140, %do.end737 ]
  %indvars.iv2062 = phi i64 [ %138, %do.body726.preheader ], [ %indvars.iv.next2063, %do.end737 ]
  %hold.161899 = phi i64 [ %hold.15.lcssa, %do.body726.preheader ], [ %add743, %do.end737 ]
  %have.271898 = phi i32 [ %have.25.lcssa, %do.body726.preheader ], [ %dec738, %do.end737 ]
  %cmp727 = icmp eq i32 %have.271898, 0
...
do.end737:                                        ; preds = %if.then729.do.end737_crit_edge, %do.body726
  %140 = phi ptr [ %.pre2081, %if.then729.do.end737_crit_edge ], [ %139, %do.body726 ]
  %have.28 = phi i32 [ %call730, %if.then729.do.end737_crit_edge ], [ %have.271898, %do.body726 ]
  %dec738 = add i32 %have.28, -1
  %141 = load ptr, ptr %next, align 8, !tbaa !27
  %incdec.ptr739 = getelementptr inbounds i8, ptr %141, i64 1
  store ptr %incdec.ptr739, ptr %next, align 8, !tbaa !27
  %142 = load i8, ptr %141, align 1, !tbaa !5
  %conv740 = zext i8 %142 to i64
  %shl742 = shl i64 %conv740, %indvars.iv2062
  %add743 = add i64 %shl742, %hold.161899
  ...
  %add713 = add nuw i32 %shr712, %conv700
  %idxprom714 = zext i32 %add713 to i64
  %arrayidx715 = getelementptr inbounds %struct.code, ptr %140, i64 %idxprom714
  ...
  %143 = zext i32 %add720 to i64
  %cmp721.not = icmp ult i64 %indvars.iv.next2063, %143
  br i1 %cmp721.not, label %do.body726, label %do.body748.loopexit

do.body748.loopexit:                              ; preds = %do.end737
  %144 = trunc i64 %indvars.iv.next2063 to i32
  br label %do.body748
...
do.body748:                                       ; preds = %do.body748.loopexit, %for.cond697.preheader
  ...
  %bits.16.lcssa = phi i32 [ %bits.15.lcssa, %for.cond697.preheader ], [ %144, %do.body748.loopexit ]
  %arrayidx715.lcssa = phi ptr [ %arrayidx7151892, %for.cond697.preheader ], [ %arrayidx715, %do.body748.loopexit ]
  %here.sroa.18.0.copyload1175.lcssa = phi i8 [ %here.sroa.18.0.copyload11751894, %for.cond697.preheader ], [ %here.sroa.18.0.copyload1175, %do.body748.loopexit ]
  %here.sroa.40.0.arrayidx715.sroa_idx = getelementptr inbounds i8, ptr %arrayidx715.lcssa, i64 2
  %here.sroa.40.0.copyload1198 = load i16, ptr %here.sroa.40.0.arrayidx715.sroa_idx, align 2, !tbaa.struct !63
  %here.sroa.0.0.copyload1171 = load i8, ptr %arrayidx715.lcssa, align 2, !tbaa.struct !62
...
do.body759:                                       ; preds = %for.end687, %do.body748
  ...
  %here.sroa.0.0 = phi i8 [ %here.sroa.0.0.copyload1171, %do.body748 ], [ %here.sroa.0.0.copyload1170, %for.end687 ]
...
if.then780:                                       ; preds = %do.body777
  %145 = load ptr, ptr %window, align 8, !tbaa !21
  %146 = load i32, ptr %wsize, align 4, !tbaa !20
  store i32 %146, ptr %whave, align 8, !tbaa !23
  %call784 = call i32 %out(ptr noundef %out_desc, ptr noundef %145, i32 noundef %146) #5
  %tobool785.not = icmp eq i32 %call784, 0
  br i1 %tobool785.not, label %if.then780.do.end790_crit_edge, label %inf_leave.loopexit2235

if.then780.do.end790_crit_edge:                   ; preds = %if.then780
  %.pre2091 = load i32, ptr %length771, align 4, !tbaa !35
  br label %do.end790

do.end790:                                        ; preds = %if.then780.do.end790_crit_edge, %do.body777
  %147 = phi i32 [ %.pre2091, %if.then780.do.end790_crit_edge ], [ %conv770, %do.body777 ]
  %put.3 = phi ptr [ %145, %if.then780.do.end790_crit_edge ], [ %put.0, %do.body777 ]
  %left.3 = phi i32 [ %146, %if.then780.do.end790_crit_edge ], [ %left.0, %do.body777 ]
  %conv792 = trunc i32 %147 to i8
...
while.cond820.preheader:                          ; preds = %if.end811
  %cmp8221906 = icmp ult i32 %sub766, %and814
  br i1 %cmp8221906, label %do.body826, label %do.end849

do.body826:                                       ; preds = %while.cond820.preheader, %do.end837
  %148 = phi i32 [ %149, %do.end837 ], [ %and814, %while.cond820.preheader ]
  %bits.181909 = phi i32 [ %add844, %do.end837 ], [ %sub766, %while.cond820.preheader ]
  %hold.181908 = phi i64 [ %add843, %do.end837 ], [ %shr763, %while.cond820.preheader ]
  %have.301907 = phi i32 [ %dec838, %do.end837 ], [ %have.29, %while.cond820.preheader ]
  %cmp827 = icmp eq i32 %have.301907, 0
...
do.end837:                                        ; preds = %if.then829.do.end837_crit_edge, %do.body826
  %149 = phi i32 [ %.pre2082, %if.then829.do.end837_crit_edge ], [ %148, %do.body826 ]
  %have.31 = phi i32 [ %call830, %if.then829.do.end837_crit_edge ], [ %have.301907, %do.body826 ]
  %dec838 = add i32 %have.31, -1
  %150 = load ptr, ptr %next, align 8, !tbaa !27
  %incdec.ptr839 = getelementptr inbounds i8, ptr %150, i64 1
  store ptr %incdec.ptr839, ptr %next, align 8, !tbaa !27
  %151 = load i8, ptr %150, align 1, !tbaa !5
  %conv840 = zext i8 %151 to i64
  %sh_prom841 = zext i32 %bits.181909 to i64
  %shl842 = shl i64 %conv840, %sh_prom841
  %add843 = add i64 %shl842, %hold.181908
  %add844 = add i32 %bits.181909, 8
  %cmp822 = icmp ult i32 %add844, %149
...
do.end849:                                        ; preds = %do.end849.loopexit, %while.cond820.preheader
  %152 = phi i32 [ %conv770, %while.cond820.preheader ], [ %.pre2083, %do.end849.loopexit ]
  ...
  %.lcssa1714 = phi i32 [ %and814, %while.cond820.preheader ], [ %149, %do.end849.loopexit ]
  %conv850 = trunc i64 %hold.18.lcssa to i32
  %notmask1643 = shl nsw i32 -1, %.lcssa1714
  %sub853 = xor i32 %notmask1643, -1
  %and854 = and i32 %sub853, %conv850
  %add856 = add i32 %152, %and854
...
if.end865:                                        ; preds = %do.end849, %if.end811
  ...
  %153 = load ptr, ptr %distcode, align 8, !tbaa !31
  %conv8681914 = trunc i64 %hold.19 to i32
  %154 = load i32, ptr %distbits, align 4, !tbaa !32
  %notmask16441915 = shl nsw i32 -1, %154
  %sub8711916 = xor i32 %notmask16441915, -1
  %and8721917 = and i32 %sub8711916, %conv8681914
  %idxprom8731918 = zext i32 %and8721917 to i64
  %arrayidx8741919 = getelementptr inbounds %struct.code, ptr %153, i64 %idxprom8731918
  %here.sroa.18.0.arrayidx874.sroa_idx1920 = getelementptr inbounds i8, ptr %arrayidx8741919, i64 1
  %here.sroa.18.0.copyload11761921 = load i8, ptr %here.sroa.18.0.arrayidx874.sroa_idx1920, align 1, !tbaa.struct !47
  %conv8761924 = zext i8 %here.sroa.18.0.copyload11761921 to i32
  %cmp877.not1925 = icmp ult i32 %bits.19, %conv8761924
  br i1 %cmp877.not1925, label %do.body882.preheader, label %for.end903

do.body882.preheader:                             ; preds = %if.end865
  %155 = zext i32 %bits.19 to i64
  br label %do.body882

do.body882:                                       ; preds = %do.body882.preheader, %do.end893
  %156 = phi i32 [ %154, %do.body882.preheader ], [ %158, %do.end893 ]
  %157 = phi ptr [ %153, %do.body882.preheader ], [ %159, %do.end893 ]
  %indvars.iv2065 = phi i64 [ %155, %do.body882.preheader ], [ %indvars.iv.next2066, %do.end893 ]
  %hold.201927 = phi i64 [ %hold.19, %do.body882.preheader ], [ %add899, %do.end893 ]
  %have.331926 = phi i32 [ %have.32, %do.body882.preheader ], [ %dec894, %do.end893 ]
  %cmp883 = icmp eq i32 %have.331926, 0
...
do.end893:                                        ; preds = %if.then885.do.end893_crit_edge, %do.body882
  %158 = phi i32 [ %.pre2085, %if.then885.do.end893_crit_edge ], [ %156, %do.body882 ]
  %159 = phi ptr [ %.pre2084, %if.then885.do.end893_crit_edge ], [ %157, %do.body882 ]
  %have.34 = phi i32 [ %call886, %if.then885.do.end893_crit_edge ], [ %have.331926, %do.body882 ]
  %dec894 = add i32 %have.34, -1
  %160 = load ptr, ptr %next, align 8, !tbaa !27
  %incdec.ptr895 = getelementptr inbounds i8, ptr %160, i64 1
  store ptr %incdec.ptr895, ptr %next, align 8, !tbaa !27
  %161 = load i8, ptr %160, align 1, !tbaa !5
  %conv896 = zext i8 %161 to i64
  %shl898 = shl i64 %conv896, %indvars.iv2065
  %add899 = add i64 %shl898, %hold.201927
  %indvars.iv.next2066 = add nuw nsw i64 %indvars.iv2065, 8
  %conv868 = trunc i64 %add899 to i32
  %notmask1644 = shl nsw i32 -1, %158
  %sub871 = xor i32 %notmask1644, -1
  %and872 = and i32 %sub871, %conv868
  %idxprom873 = zext i32 %and872 to i64
  %arrayidx874 = getelementptr inbounds %struct.code, ptr %159, i64 %idxprom873
  ...
  %162 = zext i8 %here.sroa.18.0.copyload1176 to i64
  %cmp877.not = icmp ult i64 %indvars.iv.next2066, %162
...
for.end903.loopexit:                              ; preds = %do.end893
  ...
  %163 = trunc i64 %indvars.iv.next2066 to i32
  br label %for.end903

for.end903:                                       ; preds = %for.end903.loopexit, %if.end865
  %164 = phi ptr [ %153, %if.end865 ], [ %159, %for.end903.loopexit ]
  ...
  %bits.20.lcssa = phi i32 [ %bits.19, %if.end865 ], [ %163, %for.end903.loopexit ]
  %arrayidx874.lcssa = phi ptr [ %arrayidx8741919, %if.end865 ], [ %arrayidx874, %for.end903.loopexit ]
  %here.sroa.18.0.copyload1176.lcssa = phi i8 [ %here.sroa.18.0.copyload11761921, %if.end865 ], [ %here.sroa.18.0.copyload1176, %for.end903.loopexit ]
  %conv876.lcssa = phi i32 [ %conv8761924, %if.end865 ], [ %conv876, %for.end903.loopexit ]
  ...
  %here.sroa.0.0.copyload1172 = load i8, ptr %arrayidx874.lcssa, align 2, !tbaa.struct !62
...
for.cond910.preheader:                            ; preds = %for.end903
  ...
  %notmask1645 = shl nsw i32 -1, %add919
  %sub921 = xor i32 %notmask1645, -1
  %conv9141936 = trunc i64 %hold.20.lcssa to i32
  %and9221937 = and i32 %conv9141936, %sub921
  %shr9251938 = lshr i32 %and9221937, %conv876.lcssa
  %add9261939 = add nuw i32 %shr9251938, %conv913
  %idxprom9271940 = zext i32 %add9261939 to i64
  %arrayidx9281941 = getelementptr inbounds %struct.code, ptr %164, i64 %idxprom9271940
  %here.sroa.18.0.arrayidx928.sroa_idx1942 = getelementptr inbounds i8, ptr %arrayidx9281941, i64 1
  %here.sroa.18.0.copyload11771943 = load i8, ptr %here.sroa.18.0.arrayidx928.sroa_idx1942, align 1, !tbaa.struct !47
  %conv9321944 = zext i8 %here.sroa.18.0.copyload11771943 to i32
  %add9331945 = add nuw nsw i32 %conv876.lcssa, %conv9321944
  %cmp934.not1946 = icmp ugt i32 %add9331945, %bits.20.lcssa
  br i1 %cmp934.not1946, label %do.body939.preheader, label %do.body961

do.body939.preheader:                             ; preds = %for.cond910.preheader
  %165 = zext i32 %bits.20.lcssa to i64
  br label %do.body939

do.body939:                                       ; preds = %do.body939.preheader, %do.end950
  %166 = phi ptr [ %164, %do.body939.preheader ], [ %167, %do.end950 ]
  %indvars.iv2068 = phi i64 [ %165, %do.body939.preheader ], [ %indvars.iv.next2069, %do.end950 ]
  %hold.211948 = phi i64 [ %hold.20.lcssa, %do.body939.preheader ], [ %add956, %do.end950 ]
  %have.351947 = phi i32 [ %have.33.lcssa, %do.body939.preheader ], [ %dec951, %do.end950 ]
  %cmp940 = icmp eq i32 %have.351947, 0
...
do.end950:                                        ; preds = %if.then942.do.end950_crit_edge, %do.body939
  %167 = phi ptr [ %.pre2086, %if.then942.do.end950_crit_edge ], [ %166, %do.body939 ]
  %have.36 = phi i32 [ %call943, %if.then942.do.end950_crit_edge ], [ %have.351947, %do.body939 ]
  %dec951 = add i32 %have.36, -1
  %168 = load ptr, ptr %next, align 8, !tbaa !27
  %incdec.ptr952 = getelementptr inbounds i8, ptr %168, i64 1
  store ptr %incdec.ptr952, ptr %next, align 8, !tbaa !27
  %169 = load i8, ptr %168, align 1, !tbaa !5
  %conv953 = zext i8 %169 to i64
  %shl955 = shl i64 %conv953, %indvars.iv2068
  %add956 = add i64 %shl955, %hold.211948
  ...
  %add926 = add nuw i32 %shr925, %conv913
  %idxprom927 = zext i32 %add926 to i64
  %arrayidx928 = getelementptr inbounds %struct.code, ptr %167, i64 %idxprom927
  ...
  %170 = zext i32 %add933 to i64
  %cmp934.not = icmp ult i64 %indvars.iv.next2069, %170
  br i1 %cmp934.not, label %do.body939, label %do.body961.loopexit

do.body961.loopexit:                              ; preds = %do.end950
  %171 = trunc i64 %indvars.iv.next2069 to i32
  br label %do.body961
...
do.body961:                                       ; preds = %do.body961.loopexit, %for.cond910.preheader
  ...
  %bits.21.lcssa = phi i32 [ %bits.20.lcssa, %for.cond910.preheader ], [ %171, %do.body961.loopexit ]
  %arrayidx928.lcssa = phi ptr [ %arrayidx9281941, %for.cond910.preheader ], [ %arrayidx928, %do.body961.loopexit ]
  %here.sroa.18.0.copyload1177.lcssa = phi i8 [ %here.sroa.18.0.copyload11771943, %for.cond910.preheader ], [ %here.sroa.18.0.copyload1177, %do.body961.loopexit ]
  %here.sroa.40.0.arrayidx928.sroa_idx = getelementptr inbounds i8, ptr %arrayidx928.lcssa, i64 2
  %here.sroa.40.0.copyload1200 = load i16, ptr %here.sroa.40.0.arrayidx928.sroa_idx, align 2, !tbaa.struct !63
  %here.sroa.0.0.copyload1173 = load i8, ptr %arrayidx928.lcssa, align 2, !tbaa.struct !62
...
while.cond1001.preheader:                         ; preds = %if.end989
  %cmp10031955 = icmp ult i32 %sub979, %and994
  br i1 %cmp10031955, label %do.body1007, label %do.end1030

do.body1007:                                      ; preds = %while.cond1001.preheader, %do.end1018
  %172 = phi i32 [ %173, %do.end1018 ], [ %and994, %while.cond1001.preheader ]
  %bits.231958 = phi i32 [ %add1025, %do.end1018 ], [ %sub979, %while.cond1001.preheader ]
  %hold.231957 = phi i64 [ %add1024, %do.end1018 ], [ %shr976, %while.cond1001.preheader ]
  %have.381956 = phi i32 [ %dec1019, %do.end1018 ], [ %have.37, %while.cond1001.preheader ]
  %cmp1008 = icmp eq i32 %have.381956, 0
...
do.end1018:                                       ; preds = %if.then1010.do.end1018_crit_edge, %do.body1007
  %173 = phi i32 [ %.pre2087, %if.then1010.do.end1018_crit_edge ], [ %172, %do.body1007 ]
  %have.39 = phi i32 [ %call1011, %if.then1010.do.end1018_crit_edge ], [ %have.381956, %do.body1007 ]
  %dec1019 = add i32 %have.39, -1
  %174 = load ptr, ptr %next, align 8, !tbaa !27
  %incdec.ptr1020 = getelementptr inbounds i8, ptr %174, i64 1
  store ptr %incdec.ptr1020, ptr %next, align 8, !tbaa !27
  %175 = load i8, ptr %174, align 1, !tbaa !5
  %conv1021 = zext i8 %175 to i64
  %sh_prom1022 = zext i32 %bits.231958 to i64
  %shl1023 = shl i64 %conv1021, %sh_prom1022
  %add1024 = add i64 %shl1023, %hold.231957
  %add1025 = add i32 %bits.231958, 8
  %cmp1003 = icmp ult i32 %add1025, %173
...
do.end1030:                                       ; preds = %do.end1030.loopexit, %while.cond1001.preheader
  %176 = phi i32 [ %conv991, %while.cond1001.preheader ], [ %.pre2088, %do.end1030.loopexit ]
  ...
  %.lcssa1732 = phi i32 [ %and994, %while.cond1001.preheader ], [ %173, %do.end1030.loopexit ]
  %conv1031 = trunc i64 %hold.23.lcssa to i32
  %notmask1646 = shl nsw i32 -1, %.lcssa1732
  %sub1034 = xor i32 %notmask1646, -1
  %and1035 = and i32 %sub1034, %conv1031
  %add1037 = add i32 %176, %and1035
...
if.end1046:                                       ; preds = %do.end1030, %if.end989
  %177 = phi i32 [ %add1037, %do.end1030 ], [ %conv991, %if.end989 ]
  ...
  %178 = load i32, ptr %wsize, align 4, !tbaa !20
  %179 = load i32, ptr %whave, align 8, !tbaa !23
  %cmp1051 = icmp ult i32 %179, %178
  %cond1056 = select i1 %cmp1051, i32 %left.0, i32 0
  %sub1057 = sub i32 %178, %cond1056
  %cmp1058 = icmp ugt i32 %177, %sub1057
...
do.body1064:                                      ; preds = %if.end1046, %do.cond1109
  ...
  %.pre2090 = load i32, ptr %wsize, align 4, !tbaa !20
  br i1 %cmp1066, label %if.then1068, label %do.end1078

if.then1068:                                      ; preds = %do.body1064
  %180 = load ptr, ptr %window, align 8, !tbaa !21
  store i32 %.pre2090, ptr %whave, align 8, !tbaa !23
  %call1072 = call i32 %out(ptr noundef %out_desc, ptr noundef %180, i32 noundef %.pre2090) #5
  %tobool1073.not = icmp eq i32 %call1072, 0
  br i1 %tobool1073.not, label %if.then1068.do.end1078_crit_edge, label %inf_leave

if.then1068.do.end1078_crit_edge:                 ; preds = %if.then1068
  %.pre2089 = load i32, ptr %wsize, align 4, !tbaa !20
  br label %do.end1078

do.end1078:                                       ; preds = %if.then1068.do.end1078_crit_edge, %do.body1064
  %181 = phi i32 [ %.pre2089, %if.then1068.do.end1078_crit_edge ], [ %.pre2090, %do.body1064 ]
  %put.5 = phi ptr [ %180, %if.then1068.do.end1078_crit_edge ], [ %put.4, %do.body1064 ]
  %left.5 = phi i32 [ %.pre2090, %if.then1068.do.end1078_crit_edge ], [ %left.4, %do.body1064 ]
  %182 = load i32, ptr %offset, align 8, !tbaa !66
  %sub1081 = sub i32 %181, %182
  %cmp1082 = icmp ult i32 %sub1081, %left.5
  ...
  %or.cond2232 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond2232, label %do.body1102.preheader, label %vector.ph

vector.ph:                                        ; preds = %do.end1078
  %n.vec = and i64 %186, 8589934560
  %ind.end = getelementptr i8, ptr %put.5, i64 %n.vec
  %.cast = trunc i64 %n.vec to i32
  %ind.end2210 = sub i32 %copy.5, %.cast
  %ind.end2212 = getelementptr i8, ptr %from.0, i64 %n.vec
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %next.gep = getelementptr i8, ptr %put.5, i64 %index
  %next.gep2215 = getelementptr i8, ptr %from.0, i64 %index
  %wide.load = load <16 x i8>, ptr %next.gep2215, align 1, !tbaa !5
  %188 = getelementptr i8, ptr %next.gep2215, i64 16
  %wide.load2217 = load <16 x i8>, ptr %188, align 1, !tbaa !5
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !5
  %189 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load2217, ptr %189, align 1, !tbaa !5
...
do.body1102.preheader:                            ; preds = %do.end1078, %middle.block
  ...
  %copy.6.ph = phi i32 [ %copy.5, %do.end1078 ], [ %ind.end2210, %middle.block ]
  %from.1.ph = phi ptr [ %from.0, %do.end1078 ], [ %ind.end2212, %middle.block ]
  %191 = add i32 %copy.6.ph, -1
  %xtraiter2292 = and i32 %copy.6.ph, 7
  %lcmp.mod2293.not = icmp eq i32 %xtraiter2292, 0
  br i1 %lcmp.mod2293.not, label %do.body1102.prol.loopexit, label %do.body1102.prol
...
do.body1102.prol:                                 ; preds = %do.body1102.preheader, %do.body1102.prol
  ...
  %prol.iter2294 = phi i32 [ %prol.iter2294.next, %do.body1102.prol ], [ 0, %do.body1102.preheader ]
  ...
  %prol.iter2294.next = add i32 %prol.iter2294, 1
  %prol.iter2294.cmp.not = icmp eq i32 %prol.iter2294.next, %xtraiter2292
  br i1 %prol.iter2294.cmp.not, label %do.body1102.prol.loopexit, label %do.body1102.prol, !llvm.loop !69

do.body1102.prol.loopexit:                        ; preds = %do.body1102.prol, %do.body1102.preheader
  %incdec.ptr1104.lcssa2250.unr = phi ptr [ undef, %do.body1102.preheader ], [ %incdec.ptr1104.prol, %do.body1102.prol ]
...
do.cond1109:                                      ; preds = %do.body1102.prol.loopexit, %do.body1102, %middle.block
  %incdec.ptr1104.lcssa = phi ptr [ %ind.end, %middle.block ], [ %incdec.ptr1104.lcssa2250.unr, %do.body1102.prol.loopexit ], [ %incdec.ptr1104.7, %do.body1102 ]
...
sw.bb1114:                                        ; preds = %for.cond
  ...
  %cmp1116 = icmp ult i32 %left.0, %203
...
sw.epilog1128:                                    ; preds = %do.cond1109, %if.then413, %if.then549, %while.end565, %if.then1060, %if.then986, %if.then808, %if.then801, %do.end790, %if.end638, %if.then612, %if.then595, %if.then576, %if.then292, %if.then217, %while.end153, %if.then97, %do.body49, %do.body
  %put.7 = phi ptr [ %122, %if.end638 ], [ %incdec.ptr793, %do.end790 ], [ %put.0, %if.then801 ], [ %put.0, %if.then808 ], [ %put.0, %if.then986 ], [ %put.0, %if.then1060 ], [ %put.0, %if.then217 ], [ %put.0, %if.then292 ], [ %put.0, %while.end565 ], [ %put.0, %if.then576 ], [ %put.0, %if.then595 ], [ %put.0, %if.then612 ], [ %put.0, %if.then97 ], [ %put.1.lcssa, %while.end153 ], [ %put.0, %do.body ], [ %put.0, %do.body49 ], [ %put.0, %if.then549 ], [ %put.0, %if.then413 ], [ %incdec.ptr1104.lcssa, %do.cond1109 ]
  %have.41 = phi i32 [ %125, %if.end638 ], [ %have.29, %do.end790 ], [ %have.29, %if.then801 ], [ %have.29, %if.then808 ], [ %have.37, %if.then986 ], [ %have.40, %if.then1060 ], [ %have.7.lcssa, %if.then217 ], [ %have.10.lcssa, %if.then292 ], [ %have.12.lcssa, %while.end565 ], [ %have.12.lcssa, %if.then576 ], [ %have.12.lcssa, %if.then595 ], [ %have.12.lcssa, %if.then612 ], [ %have.3.lcssa, %if.then97 ], [ %have.5.lcssa, %while.end153 ], [ %have.0, %do.body ], [ %have.1.lcssa, %do.body49 ], [ %have.21, %if.then549 ], [ %have.15.lcssa, %if.then413 ], [ %have.40, %do.cond1109 ]
  %left.6 = phi i32 [ %123, %if.end638 ], [ %dec794, %do.end790 ], [ %left.0, %if.then801 ], [ %left.0, %if.then808 ], [ %left.0, %if.then986 ], [ %left.0, %if.then1060 ], [ %left.0, %if.then217 ], [ %left.0, %if.then292 ], [ %left.0, %while.end565 ], [ %left.0, %if.then576 ], [ %left.0, %if.then595 ], [ %left.0, %if.then612 ], [ %left.0, %if.then97 ], [ %left.1.lcssa, %while.end153 ], [ %left.0, %do.body ], [ %left.0, %do.body49 ], [ %left.0, %if.then549 ], [ %left.0, %if.then413 ], [ %sub1101, %do.cond1109 ]
  %hold.25 = phi i64 [ %126, %if.end638 ], [ %shr763, %do.end790 ], [ %shr763, %if.then801 ], [ %shr763, %if.then808 ], [ %shr976, %if.then986 ], [ %hold.24, %if.then1060 ], [ %shr206, %if.then217 ], [ %shr265, %if.then292 ], [ %hold.6.lcssa, %while.end565 ], [ %hold.6.lcssa, %if.then576 ], [ %hold.6.lcssa, %if.then595 ], [ %hold.6.lcssa, %if.then612 ], [ %hold.2.lcssa, %if.then97 ], [ 0, %while.end153 ], [ %shr, %do.body ], [ %shr50, %do.body49 ], [ %hold.11, %if.then549 ], [ %shr404, %if.then413 ], [ %hold.24, %do.cond1109 ]
  %bits.25 = phi i32 [ %127, %if.end638 ], [ %sub766, %do.end790 ], [ %sub766, %if.then801 ], [ %sub766, %if.then808 ], [ %sub979, %if.then986 ], [ %bits.24, %if.then1060 ], [ %sub207, %if.then217 ], [ %sub266, %if.then292 ], [ %bits.6.lcssa, %while.end565 ], [ %bits.6.lcssa, %if.then576 ], [ %bits.6.lcssa, %if.then595 ], [ %bits.6.lcssa, %if.then612 ], [ %bits.2.lcssa, %if.then97 ], [ 0, %while.end153 ], [ %sub, %do.body ], [ %sub51, %do.body49 ], [ %bits.11, %if.then549 ], [ %sub407, %if.then413 ], [ %bits.24, %do.cond1109 ]
  %.pre = load i32, ptr %mode, align 8, !tbaa !24
  br label %for.cond

inf_leave.loopexit2235:                           ; preds = %if.then780, %for.cond
  %have.42.ph = phi i32 [ %have.0, %for.cond ], [ %have.29, %if.then780 ]
  %ret.0.ph = phi i32 [ -3, %for.cond ], [ -5, %if.then780 ]
  br label %inf_leave

inf_leave:                                        ; preds = %if.then1068, %if.then127, %for.cond, %inf_leave.loopexit2235, %if.then1118, %sw.bb1114, %if.then1014, %if.then946, %if.then889, %if.then833, %if.then733, %if.then673, %if.then505, %if.then453, %if.then383, %if.then328, %if.then241, %if.then169, %if.then119, %if.then76, %if.then19
  %have.42 = phi i32 [ %have.0, %sw.bb1114 ], [ 0, %if.then833 ], [ 0, %if.then1014 ], [ 0, %if.then946 ], [ 0, %if.then889 ], [ 0, %if.then733 ], [ 0, %if.then673 ], [ 0, %if.then169 ], [ 0, %if.then241 ], [ 0, %if.then383 ], [ 0, %if.then453 ], [ 0, %if.then505 ], [ 0, %if.then328 ], [ 0, %if.then76 ], [ 0, %if.then119 ], [ 0, %if.then19 ], [ %have.0, %if.then1118 ], [ %have.42.ph, %inf_leave.loopexit2235 ], [ %have.0, %for.cond ], [ %have.6, %if.then127 ], [ %have.40, %if.then1068 ]
  %ret.0 = phi i32 [ 1, %sw.bb1114 ], [ -5, %if.then833 ], [ -5, %if.then1014 ], [ -5, %if.then946 ], [ -5, %if.then889 ], [ -5, %if.then733 ], [ -5, %if.then673 ], [ -5, %if.then169 ], [ -5, %if.then241 ], [ -5, %if.then383 ], [ -5, %if.then453 ], [ -5, %if.then505 ], [ -5, %if.then328 ], [ -5, %if.then76 ], [ -5, %if.then119 ], [ -5, %if.then19 ], [ %spec.select1648, %if.then1118 ], [ %ret.0.ph, %inf_leave.loopexit2235 ], [ -2, %for.cond ], [ -5, %if.then127 ], [ -5, %if.then1068 ]
