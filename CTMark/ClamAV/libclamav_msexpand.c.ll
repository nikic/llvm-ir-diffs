; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_msexpand.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_msexpand.c"
...
while.body77:                                     ; preds = %if.end70, %if.end86
  ...
  store i8 %4, ptr %arrayidx79, align 1
...
if.end86:                                         ; preds = %while.body77
  ...
  br i1 %tobool76.not, label %for.inc, label %while.body77
