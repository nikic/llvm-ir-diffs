; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_fsg.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_fsg.c"
...
entry:
  ...
  store ptr %source, ptr %tsrc, align 8
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %tdst) #3
  store ptr %dest, ptr %tdst, align 8
...
for.cond21.preheader.us:                          ; preds = %for.cond21.preheader.us.preheader, %for.cond21.while.cond.loopexit_crit_edge.us
  %.pre = load i32, ptr %sections, align 4
...
for.body24.us:                                    ; preds = %for.cond21.preheader.us, %cleanup77.us
  ...
  %2 = load i32, ptr %arrayidx29.us, align 4
...
if.end34.us:                                      ; preds = %for.body24.us
  ...
  store i32 %2, ptr %arrayidx26.us, align 4
  %raw61.us = getelementptr inbounds %struct.cli_exe_section, ptr %sections, i64 %indvars.iv.next227, i32 2
  %3 = load <2 x i32>, ptr %raw61.us, align 4
  store i32 %1, ptr %arrayidx29.us, align 4
  %4 = load <2 x i32>, ptr %raw40.us, align 4
  store <2 x i32> %3, ptr %raw40.us, align 4
  store <2 x i32> %4, ptr %raw61.us, align 4
...
for.inc:                                          ; preds = %for.body
  ...
  store i32 %offs.0217, ptr %raw, align 4
  %10 = load ptr, ptr %tdst, align 8
  ...
  store i32 %conv13, ptr %rsz, align 4
...
if.else:                                          ; preds = %for.body88
  %.pre237 = load i32, ptr %arrayidx116.phi.trans.insert, align 4
...
if.end114:                                        ; preds = %if.else, %if.then91
  ...
  br i1 %exitcond236.not, label %for.end129, label %for.body88
