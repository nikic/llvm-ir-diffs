; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_hashtab.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_hashtab.c"
...
if.end5:                                          ; preds = %if.end
  ...
  store i64 %call, ptr %capacity6, align 8
  ...
  store i64 %div, ptr %maxfill, align 8
  br label %return
...
for.body.i:                                       ; preds = %for.body.i, %for.body.i.preheader.new
  ...
  %3 = load i8, ptr %arrayidx.i.1, align 1
  %conv.i.1 = zext i8 %3 to i64
  %add.i.1 = or i64 %shl.i.1, %conv.i.1
  %rem.i.1 = urem i64 %add.i.1, %0
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %hash.exit.loopexit.unr-lcssa.loopexit, label %for.body.i
...
do.body:                                          ; preds = %if.else9, %hash.exit
  ...
  %7 = load ptr, ptr %element.0, align 8
...
do.body.us:                                       ; preds = %do.end.us
  ...
  br i1 %tobool3.not.us, label %if.then4, label %if.else21.us.lr.ph
...
do.body1.us:                                      ; preds = %do.cond.us
  br i1 %tobool3.not.us133, label %if.then4, label %if.else21.us
...
do.cond.us:                                       ; preds = %if.else21.us
  br i1 %cmp41.not.us135, label %do.end.us, label %do.body1.us
...
do.end.us:                                        ; preds = %do.cond.us
  ...
  br i1 %cmp45.us, label %do.body.us, label %do.end46
...
for.body.i:                                       ; preds = %do.body, %for.body.i
  ...
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %hash.exit.loopexit.unr-lcssa, label %for.body.i
...
for.body.i.epil:                                  ; preds = %hash.exit.loopexit.unr-lcssa
  ...
  %sub.i.epil = add i64 %i.06.i.unr, -1
  %arrayidx.i.epil = getelementptr inbounds i8, ptr %key, i64 %sub.i.epil
  %10 = load i8, ptr %arrayidx.i.epil, align 1
...
do.body1:                                         ; preds = %do.cond, %hash.exit.loopexit
  ...
  %12 = load ptr, ptr %element.0, align 8
...
if.then29:                                        ; preds = %if.else25, %if.else21.us
  ...
  store i64 %data, ptr %data30, align 8
  br label %cleanup47
...
do.cond:                                          ; preds = %if.else21, %if.else31
  ...
  br i1 %cmp41.not, label %do.end, label %do.body1
...
do.end:                                           ; preds = %do.cond
  ...
  br i1 %cmp45, label %do.body, label %do.end46
...
cleanup.us:                                       ; preds = %if.then11.us
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %call1, ptr noundef nonnull align 8 dereferenceable(16) %arrayidx.us, i64 16, i1 false)
  %inc30.us = add i64 %used.091.us, 1
  %.pre97 = load i64, ptr %capacity, align 8
  br label %for.inc.us
...
for.inc.us:                                       ; preds = %cleanup.us, %for.body.us
  ...
  br i1 %cmp4.us, label %for.body.us, label %for.end
...
for.body.i:                                       ; preds = %for.body.i, %for.body.i.preheader.new
  ...
  %13 = load i8, ptr %arrayidx.i.1, align 1
...
for.body.i.epil:                                  ; preds = %hash.exit.loopexit.unr-lcssa
  ...
  %14 = load i8, ptr %arrayidx.i.epil, align 1
...
hash.exit:                                        ; preds = %for.body.i.epil, %hash.exit.loopexit.unr-lcssa, %if.then11
  ...
  %15 = load ptr, ptr %element.083, align 8
...
while.body:                                       ; preds = %hash.exit, %while.body
  ...
  %16 = load ptr, ptr %element.0, align 8
...
cleanup:                                          ; preds = %hash.exit, %while.end
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %element.0.lcssa100, ptr noundef nonnull align 8 dereferenceable(16) %arrayidx, i64 16, i1 false)
  %inc30 = add i64 %used.091, 1
  %.pre = load i64, ptr %capacity, align 8
  br label %for.inc
...
for.end:                                          ; preds = %for.inc, %for.inc.us, %if.end
  ...
  store i64 %used.0.lcssa, ptr %used37, align 8
...
if.end.i:                                         ; preds = %entry
  ...
  %0 = load i64, ptr %capacity.i, align 8
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.i.i.preheader.new
  ...
  %3 = load i8, ptr %arrayidx.i.i.1, align 1
  %conv.i.i.1 = zext i8 %3 to i64
  %add.i.i.1 = or i64 %shl.i.i.1, %conv.i.i.1
  %rem.i.i.1 = urem i64 %add.i.i.1, %0
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %hash.exit.i.loopexit.unr-lcssa.loopexit, label %for.body.i.i
...
for.body.i.i.epil:                                ; preds = %hash.exit.i.loopexit.unr-lcssa
  ...
  %5 = load i8, ptr %arrayidx.i.i.epil, align 1
...
do.body.i:                                        ; preds = %if.else9.i, %hash.exit.i
  ...
  %7 = load ptr, ptr %element.0.i, align 8
...
if.else9.i:                                       ; preds = %land.lhs.true.i, %if.else.i
  ...
  br i1 %cmp16.not.i, label %if.end, label %do.body.i

if.then:                                          ; preds = %land.lhs.true.i
  tail call void @free(ptr noundef nonnull %7) #12
  store ptr @DELETED_KEY, ptr %element.0.i, align 8
  %used = getelementptr inbounds %struct.hashtable, ptr %s, i64 0, i32 2
...
for.end:                                          ; preds = %if.end11, %entry
  ...
  %maxfill = getelementptr inbounds %struct.hashtable, ptr %s, i64 0, i32 3
  %7 = load i64, ptr %maxfill, align 8
