; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/zlib_gzread.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/zlib_gzread.c"
...
if.end5.i:                                        ; preds = %do.body.i
  ...
  br i1 %cmp6.i, label %do.body.i, label %if.end68
...
if.end68:                                         ; preds = %if.end5.i, %if.then16.i, %if.end60, %if.then13
  %n.3 = phi i32 [ %17, %if.end60 ], [ %spec.select130, %if.then13 ], [ %n.1, %if.then16.i ], [ %add.i117, %if.end5.i ]
...
do.cond:                                          ; preds = %if.then37, %if.end68
  ...
  br i1 %tobool77.not, label %cleanup, label %do.body
...
if.end24.i:                                       ; preds = %if.else19.i, %if.then.i
  %len.addr.1.i = phi i64 [ %sub14.i, %if.then.i ], [ %len.addr.040.i, %if.else19.i ]
  %tobool.not.i = icmp eq i64 %len.addr.1.i, 0
  br i1 %tobool.not.i, label %gz_skip.exit, label %while.body.i
...
if.end29:                                         ; preds = %do.body, %if.end24
  ...
  br i1 %15, label %do.body, label %if.end61
...
if.end5.i:                                        ; preds = %do.body.i
  ...
  br i1 %cmp6.i, label %do.body.i, label %if.end10
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %next.gep52, align 1
  %9 = getelementptr i8, ptr %next.gep52, i64 16
  %wide.load54 = load <16 x i8>, ptr %9, align 1
  store <16 x i8> %wide.load, ptr %next.gep, align 1
  %10 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load54, ptr %10, align 1
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load73 = load <8 x i8>, ptr %next.gep72, align 1
  store <8 x i8> %wide.load73, ptr %next.gep71, align 1
...
do.body.prol:                                     ; preds = %do.body.preheader, %do.body.prol
  ...
  %14 = load i8, ptr %q.0.prol, align 1
  %incdec.ptr8.prol = getelementptr inbounds i8, ptr %p.0.prol, i64 1
  store i8 %14, ptr %p.0.prol, align 1
...
do.body:                                          ; preds = %do.body.prol.loopexit, %do.body
  ...
  store i8 %17, ptr %incdec.ptr8, align 1
  ...
  store i8 %18, ptr %incdec.ptr8.1, align 1
  ...
  store i8 %19, ptr %incdec.ptr8.2, align 1
  %incdec.ptr.4 = getelementptr inbounds i8, ptr %q.0, i64 5
  %20 = load i8, ptr %incdec.ptr.3, align 1
  %incdec.ptr8.4 = getelementptr inbounds i8, ptr %p.0, i64 5
  store i8 %20, ptr %incdec.ptr8.3, align 1
  ...
  store i8 %21, ptr %incdec.ptr8.4, align 1
  ...
  store i8 %22, ptr %incdec.ptr8.5, align 1
  %incdec.ptr.7 = getelementptr inbounds i8, ptr %q.0, i64 8
  %23 = load i8, ptr %incdec.ptr.6, align 1
  %incdec.ptr8.7 = getelementptr inbounds i8, ptr %p.0, i64 8
  store i8 %23, ptr %incdec.ptr8.6, align 1
  %dec.7 = add i32 %n.0, -8
  %tobool9.not.7 = icmp eq i32 %dec.7, 0
  br i1 %tobool9.not.7, label %if.end10.loopexit, label %do.body
...
if.end5.i:                                        ; preds = %do.body.i
  ...
  br i1 %cmp6.i, label %do.body.i, label %if.end16
...
gz_load.exit:                                     ; preds = %do.end.i
  %call11.i = tail call ptr @__errno_location() #13
  %28 = load i32, ptr %call11.i, align 4
...
if.end16:                                         ; preds = %if.end5.i, %if.then16.i
  ...
  %30 = load ptr, ptr %in11, align 8
  store ptr %30, ptr %strm1, align 8
  br label %cleanup
