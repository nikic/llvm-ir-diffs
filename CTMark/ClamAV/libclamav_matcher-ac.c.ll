...
entry:
  ...
  %0 = load i8, ptr %ac_maxdepth, align 1
...
for.end:                                          ; preds = %for.cond, %for.body, %entry
  ...
  %4 = load i8, ptr %ac_mindepth, align 4
...
if.end20:                                         ; preds = %for.end
  ...
  %5 = load ptr, ptr %ac_root, align 8
...
if.then28:                                        ; preds = %for.body26
  ...
  store ptr %call, ptr %trans, align 8
...
if.end34:                                         ; preds = %if.then28, %for.body26
  ...
  %9 = load i16, ptr %arrayidx38, align 2
  %10 = and i16 %9, 255
...
if.then54:                                        ; preds = %if.end49
  ...
  store ptr %call55, ptr %trans56, align 8
...
if.else:                                          ; preds = %if.end49
  store i8 1, ptr %call46, align 8
  br label %if.end61

if.end61:                                         ; preds = %if.then54, %if.else
  %12 = load i32, ptr %ac_nodes, align 4
  %inc62 = add i32 %12, 1
  store i32 %inc62, ptr %ac_nodes, align 4
  %13 = load ptr, ptr %ac_nodetable, align 8
  ...
  %14 = load i32, ptr %ac_nodes, align 4
  %dec = add i32 %14, -1
  br i1 %tobool66.not, label %if.then67, label %if.end74

if.then67:                                        ; preds = %if.end61
  store i32 %dec, ptr %ac_nodes, align 4
  ...
  %15 = load ptr, ptr %trans69, align 8
...
if.end90:                                         ; preds = %if.end74, %if.end34
  ...
  br i1 %exitcond.not, label %for.end93.loopexit, label %for.body26
...
for.end93:                                        ; preds = %for.end93.loopexit, %if.end20
  ...
  %22 = load i32, ptr %ac_patterns, align 8
  %inc94 = add i32 %22, 1
  store i32 %inc94, ptr %ac_patterns, align 8
  %ac_pattable = getelementptr inbounds %struct.cli_matcher, ptr %root, i64 0, i32 10
  %23 = load ptr, ptr %ac_pattable, align 8
  ...
  store ptr %call98, ptr %ac_pattable, align 8
...
while.body.lr.ph:                                 ; preds = %if.end103
  %25 = load i16, ptr %length, align 8
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end226
  ...
  %26 = load i16, ptr %length110, align 8
...
land.lhs.true:                                    ; preds = %while.body
  ...
  %27 = load i16, ptr %prefix_length, align 2
  %28 = load i16, ptr %prefix_length117, align 2
  %cmp119 = icmp eq i16 %27, %28
  br i1 %cmp119, label %if.then121, label %if.end226

if.then121:                                       ; preds = %land.lhs.true
  %29 = load ptr, ptr %ph.0381, align 8
...
land.lhs.true129:                                 ; preds = %if.then121
  ...
  %32 = load ptr, ptr %prefix130, align 8
...
if.then136:                                       ; preds = %land.lhs.true129
  ...
  %33 = load i16, ptr %alt, align 8
  %tobool137.not = icmp eq i16 %33, 0
  %.pre = load i16, ptr %alt139, align 8
...
for.body156.lr.ph:                                ; preds = %if.else142.thread
  ...
  %34 = load ptr, ptr %alttable, align 8
  %35 = load ptr, ptr %alttable159, align 8
...
for.body156:                                      ; preds = %for.body156.lr.ph, %for.inc214
  ...
  %37 = load ptr, ptr %arrayidx161, align 8
  ...
  %39 = load i16, ptr %num163, align 2
...
if.then178:                                       ; preds = %if.else175
  ...
  %43 = load ptr, ptr %str179, align 8
...
for.inc214:                                       ; preds = %while.end, %if.then178
  ...
  br i1 %cmp154, label %for.body156, label %if.then221.critedge
...
if.then221.critedge:                              ; preds = %land.lhs.true138, %for.inc214
  ...
  %52 = load ptr, ptr %next_same, align 8
  %next_same222 = getelementptr inbounds %struct.cli_ac_patt, ptr %pattern, i64 0, i32 18
  store ptr %52, ptr %next_same222, align 8
  store ptr %pattern, ptr %next_same, align 8
  br label %cleanup
...
if.end226:                                        ; preds = %for.body156, %if.end168, %if.then178, %while.end, %lor.lhs.false, %while.body190, %land.lhs.true138, %if.else142.thread, %if.then121, %land.lhs.true129, %land.lhs.true, %while.body
  ...
  %ph.0 = load ptr, ptr %next227, align 8
  %tobool109.not = icmp eq ptr %ph.0, null
  br i1 %tobool109.not, label %while.end228, label %while.body

while.end228:                                     ; preds = %if.end226, %if.end103
  %next230 = getelementptr inbounds %struct.cli_ac_patt, ptr %pattern, i64 0, i32 17
  store ptr %ph.0379, ptr %next230, align 8
  store ptr %pattern, ptr %list, align 8
  br label %cleanup
...
if.end:                                           ; preds = %entry
  %ac_root = getelementptr inbounds %struct.cli_matcher, ptr %root, i64 0, i32 8
  %0 = load ptr, ptr %ac_root, align 8
...
for.body.i:                                       ; preds = %for.inc.i, %if.end3
  ...
  %1 = load ptr, ptr %trans.i, align 8
...
if.else.i:                                        ; preds = %for.body.i
  ...
  store ptr %0, ptr %fail5.i, align 8
...
if.then2.i.i:                                     ; preds = %if.end.i.i
  ...
  store ptr %call.i.i, ptr %next3.i.i, align 8
  br label %for.inc.i
...
if.else.i109.i:                                   ; preds = %while.cond.preheader.i, %while.cond.backedge.i
  ...
  %3 = load ptr, ptr %next.i110.i, align 8
  %4 = load ptr, ptr %bfs.326.i, align 8
...
while.cond.backedge.i:                            ; preds = %for.inc62.i, %while.body.i
  ...
  br i1 %tobool.not.i108.i, label %return, label %if.else.i109.i
...
for.body16.i:                                     ; preds = %for.inc62.i, %for.cond14.preheader.i
  ...
  %6 = load ptr, ptr %trans17.i, align 8
...
while.cond23.i:                                   ; preds = %for.body16.i, %while.cond23.i.backedge
  ...
  %fail.0.i = load ptr, ptr %fail.0.in.i, align 8
  %8 = load i8, ptr %fail.0.i, align 8
...
lor.rhs.i:                                        ; preds = %while.cond23.i
  ...
  %9 = load ptr, ptr %trans26.i, align 8
  %arrayidx28.i = getelementptr inbounds ptr, ptr %9, i64 %indvars.iv29.i
  %10 = load ptr, ptr %arrayidx28.i, align 8
...
while.end.i:                                      ; preds = %lor.rhs.i
  ...
  store ptr %10, ptr %fail35.i, align 8
...
while.cond39.i:                                   ; preds = %while.end.i, %while.cond39.i
  ...
  br i1 %tobool40.not.i, label %while.end43.i, label %while.cond39.i
...
while.end43.i:                                    ; preds = %while.cond39.i
  ...
  %13 = load ptr, ptr %list45.i, align 8
  store ptr %13, ptr %next.i.le, align 8
  br label %if.end51.i

if.else47.i:                                      ; preds = %while.end.i
  %list49.i = getelementptr inbounds %struct.cli_ac_node, ptr %10, i64 0, i32 2
  %14 = load ptr, ptr %list49.i, align 8
...
if.then54.i:                                      ; preds = %if.end51.i
  ...
  store i8 1, ptr %final.i, align 1
  br label %if.end55.i
...
if.end.i115.i:                                    ; preds = %if.end55.i
  ...
  store ptr null, ptr %next.i116.i, align 8
  store ptr %7, ptr %call.i113.i, align 8
...
if.then2.i118.i:                                  ; preds = %if.end.i115.i
  ...
  store ptr %call.i113.i, ptr %next3.i119.i, align 8
...
for.inc62.i:                                      ; preds = %if.then2.i118.i, %if.end.i115.i, %for.body16.i
  ...
  br i1 %exitcond32.not.i, label %while.cond.backedge.i, label %for.body16.i
...
entry:
  ...
  %ac_root = getelementptr inbounds %struct.cli_matcher, ptr %root, i64 0, i32 8
  store ptr %call, ptr %ac_root, align 8
...
if.end:                                           ; preds = %entry
  ...
  store ptr %call2, ptr %trans, align 8
  %tobool6.not = icmp eq ptr %call2, null
  br i1 %tobool6.not, label %if.then7, label %if.end9

if.then7:                                         ; preds = %if.end
  tail call void (ptr, ...) @cli_errmsg(ptr noundef nonnull @.str.7) #11
  %1 = load ptr, ptr %ac_root, align 8
  tail call void @free(ptr noundef %1) #11
  br label %return

if.end9:                                          ; preds = %if.end
  %ac_mindepth = getelementptr inbounds %struct.cli_matcher, ptr %root, i64 0, i32 6
  store i8 %mindepth, ptr %ac_mindepth, align 4
  %ac_maxdepth = getelementptr inbounds %struct.cli_matcher, ptr %root, i64 0, i32 7
  store i8 %maxdepth, ptr %ac_maxdepth, align 1
  br label %return
...
entry:
  %ac_patterns = getelementptr inbounds %struct.cli_matcher, ptr %root, i64 0, i32 13
  %0 = load i32, ptr %ac_patterns, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end8
  ...
  %1 = load ptr, ptr %ac_pattable, align 8
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %5 = load ptr, ptr %virname, align 8
...
for.body.i:                                       ; preds = %for.inc.i, %for.body.lr.ph.i
  ...
  %9 = load ptr, ptr %alttable.i, align 8
...
if.end8.i:                                        ; preds = %if.then6.i, %while.body.i
  ...
  br i1 %tobool4.not.i, label %for.inc.loopexit.i, label %while.body.i

for.inc.loopexit.i:                               ; preds = %if.end8.i
  %.pre.i = load i16, ptr %alt, align 8
  br label %for.inc.i
...
for.inc.i:                                        ; preds = %for.inc.loopexit.i, %for.body.i
  ...
  br i1 %cmp.i, label %for.body.i, label %ac_free_alt.exit

ac_free_alt.exit:                                 ; preds = %for.inc.i
  %15 = load ptr, ptr %alttable.i, align 8
...
if.end8:                                          ; preds = %ac_free_alt.exit, %if.end5
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %16 = load i32, ptr %ac_patterns, align 8
...
for.end:                                          ; preds = %if.end8, %entry
  ...
  %18 = load ptr, ptr %ac_pattable9, align 8
...
if.end13:                                         ; preds = %if.then11, %for.end
  %ac_nodes = getelementptr inbounds %struct.cli_matcher, ptr %root, i64 0, i32 12
  %19 = load i32, ptr %ac_nodes, align 4
...
for.body16:                                       ; preds = %for.body16.lr.ph, %if.end24
  ...
  %20 = load ptr, ptr %ac_nodetable, align 8
...
if.then20:                                        ; preds = %for.body16
  ...
  %.pre = load ptr, ptr %ac_nodetable, align 8
  %arrayidx27.phi.trans.insert = getelementptr inbounds ptr, ptr %.pre, i64 %indvars.iv78
  %.pre81 = load ptr, ptr %arrayidx27.phi.trans.insert, align 8
  br label %if.end24
...
if.end24:                                         ; preds = %if.then20, %for.body16
  ...
  %25 = load i32, ptr %ac_nodes, align 4
...
for.end30:                                        ; preds = %if.end24, %if.end13
  ...
  %27 = load ptr, ptr %ac_nodetable31, align 8
...
if.end35:                                         ; preds = %if.then33, %for.end30
  %ac_root = getelementptr inbounds %struct.cli_matcher, ptr %root, i64 0, i32 8
  %28 = load ptr, ptr %ac_root, align 8
...
if.then37:                                        ; preds = %if.end35
  ...
  %29 = load ptr, ptr %trans39, align 8
  tail call void @free(ptr noundef %29) #11
  %30 = load ptr, ptr %ac_root, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %2 = load ptr, ptr %alttable, align 8
...
if.end8:                                          ; preds = %if.then6, %while.body
  ...
  br i1 %tobool4.not, label %for.inc.loopexit, label %while.body

for.inc.loopexit:                                 ; preds = %if.end8
  %.pre = load i16, ptr %alt, align 8
  br label %for.inc
...
for.end:                                          ; preds = %for.inc
  ...
  %8 = load ptr, ptr %alttable9, align 8
...
if.end:                                           ; preds = %entry
  store i32 %partsigs, ptr %data, align 8
...
if.end4:                                          ; preds = %if.end
  ...
  store ptr %call, ptr %offmatrix, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %indvars.iv = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next, %for.inc ]
  %2 = load ptr, ptr %offmatrix, align 8
  %arrayidx = getelementptr inbounds ptr, ptr %2, i64 %indvars.iv
  %3 = load ptr, ptr %arrayidx, align 8
...
if.then4:                                         ; preds = %for.body
  ...
  tail call void @free(ptr noundef %4) #11
  %5 = load ptr, ptr %offmatrix, align 8
...
for.end:                                          ; preds = %for.inc
  ...
  %9 = load ptr, ptr %offmatrix12, align 8
...
while.cond:                                       ; preds = %while.cond.preheader, %while.body
  ...
  %2 = load i8, ptr %current.1, align 8
...
if.then15:                                        ; preds = %while.end
  ...
  %patt.0877 = load ptr, ptr %list, align 8
...
lor.lhs.false.i:                                  ; preds = %while.body18
  ...
  %13 = load i16, ptr %prefix_length.i, align 2
...
for.body.lr.ph.i:                                 ; preds = %if.end.i
  %15 = load ptr, ptr %patt.0882, align 8
...
for.body42.lr.ph.i:                               ; preds = %for.cond37.preheader.i
  ...
  %27 = load i8, ptr %arrayidx47.i, align 1
...
for.cond37.i:                                     ; preds = %for.body42.i
  ...
  br i1 %exitcond.not.i, label %if.end517, label %for.body42.i
...
if.then58.i:                                      ; preds = %while.body.i
  ...
  %30 = load ptr, ptr %str61.i, align 8
...
if.end70.i:                                       ; preds = %if.then58.i, %while.body.i
  ...
  br i1 %tobool53.not.i, label %if.end517, label %while.body.i
...
sw.bb76.i:                                        ; preds = %for.body.i
  ...
  %33 = load i8, ptr %arrayidx85.i, align 1
  %34 = and i8 %33, -16
...
sw.bb92.i:                                        ; preds = %for.body.i
  ...
  %37 = load i8, ptr %arrayidx101.i, align 1
  %38 = and i8 %37, 15
...
sw.epilog.i:                                      ; preds = %sw.bb92.i, %sw.bb76.i, %if.end74.i, %sw.bb.i, %for.body.i
  ...
  br i1 %40, label %for.body.i, label %for.end112.i
...
for.end112.i:                                     ; preds = %sw.epilog.i, %if.end.i
  ...
  %41 = load ptr, ptr %prefix.i, align 8
...
for.body124.i:                                    ; preds = %sw.epilog238.i, %for.body124.lr.ph.i
  ...
  %42 = load i16, ptr %arrayidx127.i, align 2
  %43 = lshr i16 %42, 8
...
sw.bb132.i:                                       ; preds = %for.body124.i
  ...
  %44 = load i8, ptr %arrayidx139.i, align 1
...
for.cond152.preheader.i:                          ; preds = %sw.bb145.i
  ...
  %49 = load i16, ptr %num154.i, align 2
...
for.cond152.i:                                    ; preds = %for.body158.i
  ...
  br i1 %exitcond401.not.i, label %if.end517, label %for.body158.i
...
for.body158.i:                                    ; preds = %for.cond152.i, %for.body158.lr.ph.i
  ...
  %52 = load i8, ptr %arrayidx161.i, align 1
...
while.body176.i:                                  ; preds = %if.end196.i, %while.cond174.preheader.i
  ...
  %53 = load i16, ptr %len177.i, align 8
...
if.then182.i:                                     ; preds = %while.body176.i
  ...
  %54 = load ptr, ptr %str185.i, align 8
...
if.end196.i:                                      ; preds = %if.then182.i, %while.body176.i
  ...
  %55 = load ptr, ptr %next197.i, align 8
  %tobool175.not.i = icmp eq ptr %55, null
  br i1 %tobool175.not.i, label %if.end517, label %while.body176.i
...
sw.bb204.i:                                       ; preds = %for.body124.i
  ...
  %57 = load i8, ptr %arrayidx213.i, align 1
  %58 = and i8 %57, -16
...
sw.bb220.i:                                       ; preds = %for.body124.i
  ...
  %61 = load i8, ptr %arrayidx229.i, align 1
  %62 = and i8 %61, 15
...
sw.epilog238.i:                                   ; preds = %sw.bb220.i, %sw.bb204.i, %if.end202.i, %sw.bb132.i, %for.body124.i
  ...
  br i1 %exitcond406.not.i, label %ac_findmatch.exit, label %for.body124.i
...
while.body24.lr.ph:                               ; preds = %ac_findmatch.exit, %if.end514
  ...
  %pt.0.ph873 = phi ptr [ %patt.0882, %ac_findmatch.exit ], [ %193, %if.end514 ]
...
while.body24:                                     ; preds = %while.body24.lr.ph, %while.cond22.backedge
  ...
  %64 = load i16, ptr %prefix_length, align 2
  ...
  %65 = load ptr, ptr %offset28, align 8
...
lor.lhs.false33:                                  ; preds = %land.lhs.true
  ...
  %68 = load i16, ptr %partno, align 2
...
lor.lhs.false42:                                  ; preds = %if.then37
  ...
  %69 = load ptr, ptr %virname45, align 8
...
while.cond22.backedge:                            ; preds = %land.lhs.true58, %lor.lhs.false65, %lor.lhs.false42, %if.then37
  ...
  %pt.0.be = load ptr, ptr %pt.0.be.in, align 8
  %tobool23.not = icmp eq ptr %pt.0.be, null
  br i1 %tobool23.not, label %if.end517, label %while.body24
...
if.end50:                                         ; preds = %lor.lhs.false42, %lor.lhs.false33, %lor.lhs.false
  ...
  %70 = load i32, ptr %sigid51, align 8
...
if.then53:                                        ; preds = %if.end50
  ...
  %71 = load i16, ptr %partno54, align 2
  %conv55 = zext i16 %71 to i64
  %cmp56.not = icmp eq i16 %71, 1
  %.pre = load ptr, ptr %offmatrix59, align 8
  %.pre968 = add i32 %70, -1
  %.pre969 = zext i32 %.pre968 to i64
  br i1 %cmp56.not, label %if.end80, label %land.lhs.true58

land.lhs.true58:                                  ; preds = %if.then53
  %arrayidx63 = getelementptr inbounds ptr, ptr %.pre, i64 %.pre969
...
if.end80:                                         ; preds = %lor.lhs.false65, %if.then53
  ...
  %partno541014 = getelementptr inbounds %struct.cli_ac_patt, ptr %pt.0863, i64 0, i32 11
  %arrayidx85 = getelementptr inbounds ptr, ptr %.pre, i64 %.pre969
  %75 = load ptr, ptr %arrayidx85, align 8
...
if.end104:                                        ; preds = %if.then87
  ...
  store ptr %call110, ptr %84, align 8
  %85 = load ptr, ptr %offmatrix59, align 8
...
if.then124:                                       ; preds = %if.end104
  ...
  %88 = load ptr, ptr %offmatrix59, align 8
  %89 = load i32, ptr %sigid511007, align 8
  %sub129 = add i32 %89, -1
  %idxprom130 = zext i32 %sub129 to i64
  %arrayidx131 = getelementptr inbounds ptr, ptr %88, i64 %idxprom130
  %90 = load ptr, ptr %arrayidx131, align 8
  call void @free(ptr noundef %90) #11
  %91 = load ptr, ptr %offmatrix59, align 8
  %92 = load i32, ptr %sigid511007, align 8
  %sub134 = add i32 %92, -1
...
if.end137:                                        ; preds = %if.end104
  ...
  %94 = load ptr, ptr %offmatrix59, align 8
  %95 = load i32, ptr %sigid511007, align 8
  %sub151 = add i32 %95, -1
  %idxprom152 = zext i32 %sub151 to i64
  %arrayidx153 = getelementptr inbounds ptr, ptr %94, i64 %idxprom152
  %96 = load ptr, ptr %arrayidx153, align 8
  %97 = load ptr, ptr %96, align 8
  store i32 0, ptr %97, align 4
  %98 = load i16, ptr %parts, align 4
...
for.body162:                                      ; preds = %for.body162, %for.body162.preheader.new
  ...
  store ptr %add.ptr, ptr %arrayidx177, align 8
  %105 = load ptr, ptr %offmatrix59, align 8
  %arrayidx182 = getelementptr inbounds ptr, ptr %105, i64 %idxprom166
  %106 = load ptr, ptr %arrayidx182, align 8
  %arrayidx184 = getelementptr inbounds ptr, ptr %106, i64 %indvars.iv
  %107 = load ptr, ptr %arrayidx184, align 8
  store i32 0, ptr %107, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %108 = load i32, ptr %sigid511007, align 8
  ...
  %109 = load ptr, ptr %arrayidx167.1, align 8
  ...
  store ptr %add.ptr.1, ptr %arrayidx177.1, align 8
  %111 = load ptr, ptr %offmatrix59, align 8
  %arrayidx182.1 = getelementptr inbounds ptr, ptr %111, i64 %idxprom166.1
  %112 = load ptr, ptr %arrayidx182.1, align 8
  %arrayidx184.1 = getelementptr inbounds ptr, ptr %112, i64 %indvars.iv.next
  %113 = load ptr, ptr %arrayidx184.1, align 8
  store i32 0, ptr %113, align 4
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %if.end186.loopexit.unr-lcssa, label %for.body162

if.end186.loopexit.unr-lcssa:                     ; preds = %for.body162, %for.body162.preheader
  %.lcssa1128.ph = phi ptr [ undef, %for.body162.preheader ], [ %111, %for.body162 ]
...
for.body162.epil:                                 ; preds = %if.end186.loopexit.unr-lcssa
  %114 = load i32, ptr %sigid511007, align 8
  ...
  %115 = load ptr, ptr %arrayidx167.epil, align 8
  ...
  store ptr %add.ptr.epil, ptr %arrayidx177.epil, align 8
  %117 = load ptr, ptr %offmatrix59, align 8
  %arrayidx182.epil = getelementptr inbounds ptr, ptr %117, i64 %idxprom166.epil
  %118 = load ptr, ptr %arrayidx182.epil, align 8
  %arrayidx184.epil = getelementptr inbounds ptr, ptr %118, i64 %indvars.iv.unr
  %119 = load ptr, ptr %arrayidx184.epil, align 8
  store i32 0, ptr %119, align 4
  br label %if.end186

if.end186:                                        ; preds = %for.body162.epil, %if.end186.loopexit.unr-lcssa, %if.end137, %if.end80
  %120 = phi ptr [ %94, %if.end137 ], [ %.pre, %if.end80 ], [ %.lcssa1128.ph, %if.end186.loopexit.unr-lcssa ], [ %117, %for.body162.epil ]
  %121 = load i32, ptr %sigid511007, align 8
  ...
  %123 = load i16, ptr %partno541014, align 2
...
for.cond197.preheader:                            ; preds = %if.end186
  ...
  %124 = load ptr, ptr %arrayidx205, align 8
  ...
  %125 = load i32, ptr %arrayidx207, align 4
...
for.body210:                                      ; preds = %for.cond197.preheader
  ...
  %126 = load i32, ptr %maxdist, align 4
...
land.lhs.true229:                                 ; preds = %for.body210
  %127 = load i32, ptr %mindist, align 8
...
for.inc249:                                       ; preds = %for.body210, %land.lhs.true229
  ...
  %128 = load i32, ptr %arrayidx207.1, align 4
...
land.lhs.true229.1:                               ; preds = %for.body210.1
  %129 = load i32, ptr %mindist, align 8
...
for.inc249.1:                                     ; preds = %land.lhs.true229.1, %for.body210.1
  ...
  %130 = load i32, ptr %arrayidx207.2, align 4
...
land.lhs.true229.2:                               ; preds = %for.body210.2
  %131 = load i32, ptr %mindist, align 8
...
for.inc249.2:                                     ; preds = %land.lhs.true229.2, %for.body210.2
  ...
  %132 = load i32, ptr %arrayidx207.3, align 4
...
land.lhs.true229.3:                               ; preds = %for.body210.3
  %133 = load i32, ptr %mindist, align 8
...
for.inc249.3:                                     ; preds = %land.lhs.true229.3, %for.body210.3
  ...
  %134 = load i32, ptr %arrayidx207.4, align 4
...
land.lhs.true229.4:                               ; preds = %for.body210.4
  %135 = load i32, ptr %mindist, align 8
...
for.inc249.4:                                     ; preds = %land.lhs.true229.4, %for.body210.4
  ...
  %136 = load i32, ptr %arrayidx207.5, align 4
...
land.lhs.true229.5:                               ; preds = %for.body210.5
  %137 = load i32, ptr %mindist, align 8
...
for.inc249.5:                                     ; preds = %land.lhs.true229.5, %for.body210.5
  ...
  %138 = load i32, ptr %arrayidx207.6, align 4
...
land.lhs.true229.6:                               ; preds = %for.body210.6
  %139 = load i32, ptr %mindist, align 8
...
for.inc249.6:                                     ; preds = %land.lhs.true229.6, %for.body210.6
  ...
  %140 = load i32, ptr %arrayidx207.7, align 4
...
land.lhs.true229.7:                               ; preds = %for.body210.7
  %141 = load i32, ptr %mindist, align 8
...
land.lhs.true260:                                 ; preds = %land.lhs.true229, %land.lhs.true229.1, %land.lhs.true229.2, %land.lhs.true229.3, %land.lhs.true229.4, %land.lhs.true229.5, %land.lhs.true229.6, %land.lhs.true229.7
  ...
  %142 = load i16, ptr %parts263, align 4
...
land.lhs.true347:                                 ; preds = %if.then343
  %152 = load ptr, ptr %ftoffset, align 8
...
land.lhs.true353:                                 ; preds = %lor.lhs.false349, %land.lhs.true347
  ...
  br i1 %or.cond894, label %land.rhs373, label %if.end401

land.rhs373:                                      ; preds = %land.lhs.true353, %for.inc398
  %154 = phi ptr [ %165, %for.inc398 ], [ %152, %land.lhs.true353 ]
  ...
  %156 = load i32, ptr %arrayidx376, align 4
  %cmp377.not = icmp eq i32 %156, -1
  %.pre963.pre965 = load i16, ptr %parts263, align 4
  br i1 %cmp377.not, label %if.end401.loopexit, label %for.body380

for.body380:                                      ; preds = %land.rhs373
  %conv382 = zext i16 %.pre963.pre965 to i64
  %sub383 = add nsw i64 %conv382, -1
  %arrayidx385 = getelementptr inbounds ptr, ptr %122, i64 %sub383
  %157 = load ptr, ptr %arrayidx385, align 8
  %arrayidx387 = getelementptr inbounds i32, ptr %157, i64 %idxprom375
  %158 = load i32, ptr %arrayidx387, align 4
  %conv388 = sext i32 %158 to i64
...
land.lhs.true.i:                                  ; preds = %for.body380
  ...
  %159 = load i16, ptr %cnt.i, align 8
  %cmp.i739 = icmp ugt i16 %159, 9
...
if.end4.i:                                        ; preds = %if.end.i740
  store i32 %conv330, ptr %call.i, align 8
  %offset6.i = getelementptr inbounds %struct.cli_matched_type, ptr %call.i, i64 0, i32 1
  store i64 %conv388, ptr %offset6.i, align 8
  %160 = load ptr, ptr %ftoffset, align 8
  br label %while.cond.i

while.cond.i:                                     ; preds = %land.rhs.i, %if.end4.i
  %tnode_last.0.i = phi ptr [ %160, %if.end4.i ], [ %161, %land.rhs.i ]
...
land.rhs.i:                                       ; preds = %while.cond.i
  ...
  %161 = load ptr, ptr %next.i741, align 8
  %tobool8.not.i = icmp eq ptr %161, null
  br i1 %tobool8.not.i, label %if.then11.i, label %while.cond.i

if.then11.i:                                      ; preds = %land.rhs.i
  %next.i741.le = getelementptr inbounds %struct.cli_matched_type, ptr %tnode_last.0.i, i64 0, i32 3
  store ptr %call.i, ptr %next.i741.le, align 8
  %.pre.i = load ptr, ptr %ftoffset, align 8
  br label %if.end13.i

if.else.i:                                        ; preds = %while.cond.i
  store ptr %call.i, ptr %ftoffset, align 8
  br label %if.end13.i

if.end13.i:                                       ; preds = %if.else.i, %if.then11.i
  %162 = phi ptr [ %call.i, %if.else.i ], [ %.pre.i, %if.then11.i ]
  %cnt14.i = getelementptr inbounds %struct.cli_matched_type, ptr %162, i64 0, i32 2
  %163 = load i16, ptr %cnt14.i, align 8
  %inc.i = add i16 %163, 1
  store i16 %inc.i, ptr %cnt14.i, align 8
  br label %for.inc398
...
if.then391:                                       ; preds = %if.end.i740
  ...
  %164 = load ptr, ptr %section, align 8
  %tobool392.not = icmp eq ptr %164, null
...
for.inc398:                                       ; preds = %if.end13.i, %land.lhs.true.i
  %165 = phi ptr [ %162, %if.end13.i ], [ %154, %land.lhs.true.i ]
  %inc399 = add nuw nsw i16 %j.2870, 1
  %exitcond952.not = icmp eq i16 %inc399, 9
  br i1 %exitcond952.not, label %for.inc398.if.end401.loopexit_crit_edge, label %land.rhs373

for.inc398.if.end401.loopexit_crit_edge:          ; preds = %for.inc398
  %.pre963.pre = load i16, ptr %parts263, align 4
  br label %if.end401.loopexit

if.end401.loopexit:                               ; preds = %land.rhs373, %for.inc398.if.end401.loopexit_crit_edge
  %.pre963 = phi i16 [ %.pre963.pre, %for.inc398.if.end401.loopexit_crit_edge ], [ %.pre963.pre965, %land.rhs373 ]
  %.pre967 = zext i16 %.pre963 to i64
  br label %if.end401

if.end401:                                        ; preds = %if.end401.loopexit, %land.lhs.true353, %lor.lhs.false349, %if.then343
  %conv404.pre-phi = phi i64 [ %.pre967, %if.end401.loopexit ], [ %conv202, %land.lhs.true353 ], [ %conv202, %lor.lhs.false349 ], [ %conv202, %if.then343 ]
  %166 = load ptr, ptr %122, align 8
  %mul407 = mul nuw nsw i64 %conv404.pre-phi, 36
  call void @llvm.memset.p0.i64(ptr align 4 %166, i8 -1, i64 %mul407, i1 false)
  %167 = load i16, ptr %parts263, align 4
  %cmp412871.not = icmp eq i16 %167, 0
  br i1 %cmp412871.not, label %if.end514, label %for.body414.preheader

for.body414.preheader:                            ; preds = %if.end401
  %wide.trip.count956 = zext i16 %167 to i64
  %xtraiter1145 = and i64 %wide.trip.count956, 7
  %168 = icmp ult i16 %167, 8
  br i1 %168, label %if.end514.loopexit.unr-lcssa, label %for.body414.preheader.new

for.body414.preheader.new:                        ; preds = %for.body414.preheader
  %unroll_iter1147 = and i64 %wide.trip.count956, 65528
...
for.body414:                                      ; preds = %for.body414, %for.body414.preheader.new
  ...
  %171 = load ptr, ptr %arrayidx416.2, align 8
  ...
  %172 = load ptr, ptr %arrayidx416.3, align 8
  ...
  %173 = load ptr, ptr %arrayidx416.4, align 8
  ...
  %174 = load ptr, ptr %arrayidx416.5, align 8
  ...
  %175 = load ptr, ptr %arrayidx416.6, align 8
  ...
  %176 = load ptr, ptr %arrayidx416.7, align 8
  store i32 0, ptr %176, align 4
  %indvars.iv.next954.7 = add nuw nsw i64 %indvars.iv953, 8
  %niter1148.next.7 = add i64 %niter1148, 8
  %niter1148.ncmp.7 = icmp eq i64 %niter1148.next.7, %unroll_iter1147
  br i1 %niter1148.ncmp.7, label %if.end514.loopexit.unr-lcssa, label %for.body414
...
if.then425:                                       ; preds = %if.else423
  ...
  %177 = load ptr, ptr %virname426, align 8
  store ptr %177, ptr %virname, align 8
  br label %if.end427

if.end427:                                        ; preds = %if.then425, %if.else423
  %section429 = getelementptr inbounds %struct.cli_target_info, ptr %info, i64 0, i32 1, i32 3
  %178 = load ptr, ptr %section429, align 8
  %tobool430.not = icmp eq ptr %178, null
...
if.else438:                                       ; preds = %if.end50
  ...
  %179 = load i16, ptr %type439, align 2
  %tobool440.not = icmp eq i16 %179, 0
...
if.then443:                                       ; preds = %if.then441
  %conv445 = zext i16 %179 to i32
  %cmp446 = icmp slt i32 %type.2.ph875, %conv445
  %cmp451 = icmp ugt i16 %179, 529
  %or.cond734 = or i1 %cmp451, %cmp446
  %cmp456 = icmp eq i16 %179, 502
...
if.then458:                                       ; preds = %if.then443
  ...
  %180 = load ptr, ptr %virname459, align 8
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.13, ptr noundef %180, i32 noundef %sub27) #11
  %181 = load i16, ptr %type439, align 2
  %conv461 = zext i16 %181 to i32
  br i1 %tobool346.not, label %if.end514, label %land.lhs.true463

land.lhs.true463:                                 ; preds = %if.then458
  %182 = load ptr, ptr %ftoffset, align 8
  %tobool464.not = icmp eq ptr %182, null
  br i1 %tobool464.not, label %land.lhs.true470, label %lor.lhs.false465

lor.lhs.false465:                                 ; preds = %land.lhs.true463
  %cnt466 = getelementptr inbounds %struct.cli_matched_type, ptr %182, i64 0, i32 2
  %183 = load i16, ptr %cnt466, align 8
  %cmp468 = icmp ult i16 %183, 10
  br i1 %cmp468, label %land.lhs.true470.thread, label %if.end514

land.lhs.true470:                                 ; preds = %land.lhs.true463
  %cmp474 = icmp ugt i16 %181, 529
  %or.cond546 = select i1 %cmp354, i1 %cmp474, i1 false
  %cmp483 = icmp eq i16 %181, 502
...
land.lhs.true470.thread:                          ; preds = %lor.lhs.false465
  %cmp474971 = icmp ugt i16 %181, 529
  %or.cond546972 = select i1 %cmp354, i1 %cmp474971, i1 false
  %cmp483973 = icmp eq i16 %181, 502
  %or.cond548974 = select i1 %or.cond544, i1 %cmp483973, i1 false
  %or.cond895975 = select i1 %or.cond546972, i1 true, i1 %or.cond548974
  br i1 %or.cond895975, label %land.lhs.true.i744, label %if.end514

land.lhs.true.i744:                               ; preds = %land.lhs.true470.thread
  %cnt.i745 = getelementptr inbounds %struct.cli_matched_type, ptr %182, i64 0, i32 2
  %184 = load i16, ptr %cnt.i745, align 8
  %cmp.i746 = icmp ugt i16 %184, 9
...
if.end4.i750:                                     ; preds = %if.end.i747
  ...
  store i32 %conv461, ptr %call.i748, align 8
  %offset6.i751 = getelementptr inbounds %struct.cli_matched_type, ptr %call.i748, i64 0, i32 1
  store i64 %conv486978, ptr %offset6.i751, align 8
  %185 = load ptr, ptr %ftoffset, align 8
  br label %while.cond.i752

while.cond.i752:                                  ; preds = %land.rhs.i755, %if.end4.i750
  %tnode_last.0.i753 = phi ptr [ %185, %if.end4.i750 ], [ %186, %land.rhs.i755 ]
...
land.rhs.i755:                                    ; preds = %while.cond.i752
  ...
  %186 = load ptr, ptr %next.i756, align 8
  %tobool8.not.i757 = icmp eq ptr %186, null
  br i1 %tobool8.not.i757, label %if.then11.i758, label %while.cond.i752
...
if.then11.i758:                                   ; preds = %land.rhs.i755
  ...
  store ptr %call.i748, ptr %next.i756.le, align 8
  %.pre.i760 = load ptr, ptr %ftoffset, align 8
  br label %if.end13.i761

if.else.i765:                                     ; preds = %while.cond.i752
  store ptr %call.i748, ptr %ftoffset, align 8
  br label %if.end13.i761

if.end13.i761:                                    ; preds = %if.else.i765, %if.then11.i758
  %187 = phi ptr [ %call.i748, %if.else.i765 ], [ %.pre.i760, %if.then11.i758 ]
  %cnt14.i762 = getelementptr inbounds %struct.cli_matched_type, ptr %187, i64 0, i32 2
  %188 = load i16, ptr %cnt14.i762, align 8
  %inc.i763 = add i16 %188, 1
  store i16 %inc.i763, ptr %cnt14.i762, align 8
  br label %if.end514

if.then489:                                       ; preds = %if.end.i747
  call void (ptr, ...) @cli_errmsg(ptr noundef nonnull @.str.25) #11
  %section491 = getelementptr inbounds %struct.cli_target_info, ptr %info, i64 0, i32 1, i32 3
  %189 = load ptr, ptr %section491, align 8
  %tobool492.not = icmp eq ptr %189, null
...
if.then503:                                       ; preds = %if.else501
  ...
  %190 = load ptr, ptr %virname504, align 8
  store ptr %190, ptr %virname, align 8
  br label %if.end505

if.end505:                                        ; preds = %if.then503, %if.else501
  %section507 = getelementptr inbounds %struct.cli_target_info, ptr %info, i64 0, i32 1, i32 3
  %191 = load ptr, ptr %section507, align 8
  %tobool508.not = icmp eq ptr %191, null
...
if.end514.loopexit.unr-lcssa:                     ; preds = %for.body414, %for.body414.preheader
  ...
  br i1 %lcmp.mod1146.not, label %if.end514, label %for.body414.epil
...
for.body414.epil:                                 ; preds = %if.end514.loopexit.unr-lcssa, %for.body414.epil
  ...
  %192 = load ptr, ptr %arrayidx416.epil, align 8
  store i32 0, ptr %192, align 4
  %indvars.iv.next954.epil = add nuw nsw i64 %indvars.iv953.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter1145
  br i1 %epil.iter.cmp.not, label %if.end514, label %for.body414.epil
...
if.end514:                                        ; preds = %if.end514.loopexit.unr-lcssa, %for.body414.epil, %land.lhs.true470.thread, %for.cond197.preheader, %for.inc249, %for.inc249.1, %for.inc249.2, %for.inc249.3, %for.inc249.4, %for.inc249.5, %for.inc249.6, %land.lhs.true229.7, %for.body210.7, %if.end401, %land.lhs.true470, %land.lhs.true.i744, %if.end13.i761, %if.then443, %if.then328, %lor.lhs.false465, %if.then458, %if.then441, %if.then299, %if.then267, %if.then326
  ...
  %193 = load ptr, ptr %next_same515, align 8
  %tobool23.not862 = icmp eq ptr %193, null
  br i1 %tobool23.not862, label %if.end517, label %while.body24.lr.ph
...
if.end517:                                        ; preds = %sw.bb92.i, %sw.bb76.i, %sw.bb.i, %for.cond37.preheader.i, %sw.bb220.i, %sw.bb204.i, %sw.bb132.i, %for.cond152.preheader.i, %if.end514, %for.cond37.i, %if.end70.i, %for.cond152.i, %if.end196.i, %while.cond22.backedge, %cleanup.sink.split.i, %while.body18, %lor.lhs.false.i
  ...
  %patt.0 = load ptr, ptr %next, align 8
  %tobool17.not = icmp eq ptr %patt.0, null
  br i1 %tobool17.not, label %for.inc520, label %while.body18
...
for.inc520:                                       ; preds = %if.end517, %if.then15, %while.end
  ...
  br i1 %exitcond962.not, label %for.end522, label %while.cond.preheader
...
for.end522:                                       ; preds = %for.inc520
  ...
  %.pre964 = load ptr, ptr %section524.phi.trans.insert, align 8
  %tobool525.not = icmp eq ptr %.pre964, null
  br i1 %tobool525.not, label %if.end529, label %if.then526

if.then526:                                       ; preds = %for.end522
  call void @free(ptr noundef nonnull %.pre964) #11
  br label %if.end529
...
entry:
  ...
  %ac_mindepth = getelementptr inbounds %struct.cli_matcher, ptr %root, i64 0, i32 6
  %0 = load i8, ptr %ac_mindepth, align 4
...
while.body:                                       ; preds = %while.cond.preheader, %for.end139
  ...
  store i8 0, ptr %call25925, align 1
...
if.end40:                                         ; preds = %if.end35
  %1 = load i16, ptr %alt, align 8
  %inc = add i16 %1, 1
  store i16 %inc, ptr %alt, align 8
  %2 = load ptr, ptr %alttable, align 8
  ...
  %3 = load i16, ptr %alt, align 8
  br i1 %tobool44.not, label %if.then45, label %if.end47

if.then45:                                        ; preds = %if.end40
  %dec = add i16 %3, -1
  store i16 %dec, ptr %alt, align 8
...
if.end47:                                         ; preds = %if.end40
  ...
  store ptr %call43, ptr %alttable, align 8
...
if.then60:                                        ; preds = %for.body
  %5 = load i16, ptr %num, align 2
  %inc61 = add i16 %5, 1
  store i16 %inc61, ptr %num, align 2
  br label %for.inc
...
if.then79:                                        ; preds = %if.else
  ...
  store ptr %call82, ptr %str, align 8
...
if.then79.if.end87_crit_edge:                     ; preds = %if.then79
  %.pre = load i16, ptr %num64, align 2
  br label %if.end87
...
while.cond113:                                    ; preds = %if.else110, %while.cond113
  ...
  br i1 %tobool114.not, label %while.end, label %while.cond113
...
while.end:                                        ; preds = %while.cond113
  ...
  store ptr %call117, ptr %next.le, align 8
...
if.end122:                                        ; preds = %while.end
  ...
  store ptr %call100, ptr %str124, align 8
  ...
  store i16 %conv127, ptr %len, align 8
  br label %if.end136

if.else129:                                       ; preds = %if.else110
  store ptr %call100, ptr %str107, align 8
  ...
  store i16 %conv133, ptr %len134, align 8
  br label %if.end136

if.end136:                                        ; preds = %if.end122, %if.else129, %if.then106
  tail call void @free(ptr noundef %call96) #11
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %13 = load i16, ptr %num64, align 2
  %14 = zext i16 %13 to i64
  %cmp92.not = icmp ult i64 %indvars.iv.next, %14
  br i1 %cmp92.not, label %for.body94, label %for.end139
...
for.end139:                                       ; preds = %if.end136, %if.end87
  ...
  br i1 %tobool26.not, label %if.end147, label %while.body
...
for.body.i:                                       ; preds = %if.then152, %for.inc.i
  ...
  %18 = load ptr, ptr %alttable, align 8
...
for.end.i:                                        ; preds = %for.inc.i
  %24 = load ptr, ptr %alttable, align 8
  tail call void @free(ptr noundef %24) #11
  br label %cleanup445.sink.split
...
if.end159:                                        ; preds = %if.end147, %if.end6
  ...
  %25 = load i16, ptr %alt160, align 8
  ...
  store ptr %call163, ptr %call2, align 8
  %cmp164 = icmp eq ptr %call163, null
  %26 = load i16, ptr %alt160, align 8
...
if.then169:                                       ; preds = %if.then166
  ...
  %27 = load i16, ptr %alt160, align 8
...
for.body.i668:                                    ; preds = %for.inc.i682, %for.body.lr.ph.i666
  ...
  %29 = load ptr, ptr %alttable.i667, align 8
  %arrayidx.i670 = getelementptr inbounds ptr, ptr %29, i64 %indvars.iv.i669
  %30 = load ptr, ptr %arrayidx.i670, align 8
...
if.end8.i678:                                     ; preds = %if.then6.i677, %while.body.i672
  ...
  br i1 %tobool4.not.i679, label %for.inc.loopexit.i680, label %while.body.i672

for.inc.loopexit.i680:                            ; preds = %if.end8.i678
  %.pre.i681 = load i16, ptr %alt160, align 8
...
for.inc.i682:                                     ; preds = %for.inc.loopexit.i680, %for.body.i668
  ...
  br i1 %cmp.i684, label %for.body.i668, label %for.end.i685

for.end.i685:                                     ; preds = %for.inc.i682
  %35 = load ptr, ptr %alttable.i667, align 8
...
for.body196:                                      ; preds = %land.rhs
  ...
  %38 = load i16, ptr %arrayidx199, align 2
...
if.end203:                                        ; preds = %for.body196
  ...
  br i1 %exitcond861.not, label %for.end215, label %land.rhs
...
if.then220:                                       ; preds = %for.body196, %if.end185, %for.end215
  %39 = load i8, ptr %ac_mindepth, align 4
...
for.body249:                                      ; preds = %for.body249.lr.ph, %for.inc294
  ...
  %44 = load i16, ptr %arrayidx252, align 2
...
land.lhs.true278:                                 ; preds = %if.else257
  ...
  %45 = load i16, ptr %arrayidx281, align 2
...
lor.lhs.false284:                                 ; preds = %land.lhs.true278
  ...
  %46 = load i16, ptr %arrayidx289, align 2
...
for.inc294:                                       ; preds = %if.else257, %lor.lhs.false284
  ...
  br i1 %or.cond776, label %for.body249, label %for.end296
...
land.lhs.true302:                                 ; preds = %for.end296
  ...
  %49 = load i16, ptr %arrayidx305, align 2
...
lor.lhs.false308:                                 ; preds = %land.lhs.true302
  ...
  %50 = load i16, ptr %arrayidx313, align 2
...
for.inc318:                                       ; preds = %for.end296, %lor.lhs.false308
  ...
  br i1 %exitcond869.not, label %for.end320, label %for.cond234.preheader
...
if.then326:                                       ; preds = %for.end320
  ...
  %51 = load i16, ptr %alt160, align 8
...
for.body.i692:                                    ; preds = %for.inc.i706, %for.body.lr.ph.i690
  ...
  %53 = load ptr, ptr %alttable.i691, align 8
  %arrayidx.i694 = getelementptr inbounds ptr, ptr %53, i64 %indvars.iv.i693
  %54 = load ptr, ptr %arrayidx.i694, align 8
...
if.end8.i702:                                     ; preds = %if.then6.i701, %while.body.i696
  ...
  br i1 %tobool4.not.i703, label %for.inc.loopexit.i704, label %while.body.i696

for.inc.loopexit.i704:                            ; preds = %if.end8.i702
  %.pre.i705 = load i16, ptr %alt160, align 8
...
for.inc.i706:                                     ; preds = %for.inc.loopexit.i704, %for.body.i692
  ...
  br i1 %cmp.i708, label %for.body.i692, label %for.end.i709

for.end.i709:                                     ; preds = %for.inc.i706
  %59 = load ptr, ptr %alttable.i691, align 8
...
for.body347:                                      ; preds = %for.inc358.1, %for.body347.lr.ph.new
  ...
  %63 = load i16, ptr %arrayidx350, align 2
  %64 = and i16 %63, -256
  %cmp353 = icmp eq i16 %64, 512
  br i1 %cmp353, label %if.then355, label %for.inc358

if.then355:                                       ; preds = %for.body347
  %65 = load i16, ptr %alt_pattern, align 2
  %inc356 = add i16 %65, 1
  store i16 %inc356, ptr %alt_pattern, align 2
  br label %for.inc358
...
for.inc358.1:                                     ; preds = %if.then355.1, %for.inc358
  ...
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %if.end361.loopexit.unr-lcssa, label %for.body347
...
for.body347.epil:                                 ; preds = %if.end361.loopexit.unr-lcssa
  ...
  %69 = load i16, ptr %arrayidx350.epil, align 2
  %70 = and i16 %69, -256
...
if.then355.epil:                                  ; preds = %for.body347.epil
  %71 = load i16, ptr %alt_pattern, align 2
  %inc356.epil = add i16 %71, 1
  store i16 %inc356.epil, ptr %alt_pattern, align 2
  br label %if.end361
...
if.then383:                                       ; preds = %if.end381
  ...
  %75 = load ptr, ptr %prefix384, align 8
...
for.body.i716:                                    ; preds = %for.inc.i730, %for.body.lr.ph.i714
  ...
  %79 = load ptr, ptr %alttable.i715, align 8
  %arrayidx.i718 = getelementptr inbounds ptr, ptr %79, i64 %indvars.iv.i717
  %80 = load ptr, ptr %arrayidx.i718, align 8
...
if.end8.i726:                                     ; preds = %if.then6.i725, %while.body.i720
  ...
  br i1 %tobool4.not.i727, label %for.inc.loopexit.i728, label %while.body.i720

for.inc.loopexit.i728:                            ; preds = %if.end8.i726
  %.pre.i729 = load i16, ptr %alt160, align 8
...
for.inc.i730:                                     ; preds = %for.inc.loopexit.i728, %for.body.i716
  ...
  br i1 %cmp.i732, label %for.body.i716, label %for.end.i733

for.end.i733:                                     ; preds = %for.inc.i730
  %85 = load ptr, ptr %alttable.i715, align 8
...
if.end391:                                        ; preds = %if.end381
  ...
  store ptr %call395, ptr %virname396, align 8
...
if.then399:                                       ; preds = %if.end391
  ...
  %86 = load ptr, ptr %prefix400, align 8
...
for.body.i740:                                    ; preds = %for.inc.i754, %for.body.lr.ph.i738
  ...
  %90 = load ptr, ptr %alttable.i739, align 8
  %arrayidx.i742 = getelementptr inbounds ptr, ptr %90, i64 %indvars.iv.i741
  %91 = load ptr, ptr %arrayidx.i742, align 8
...
if.end8.i750:                                     ; preds = %if.then6.i749, %while.body.i744
  ...
  br i1 %tobool4.not.i751, label %for.inc.loopexit.i752, label %while.body.i744

for.inc.loopexit.i752:                            ; preds = %if.end8.i750
  %.pre.i753 = load i16, ptr %alt160, align 8
...
for.inc.i754:                                     ; preds = %for.inc.loopexit.i752, %for.body.i740
  ...
  br i1 %cmp.i756, label %for.body.i740, label %for.end.i757

for.end.i757:                                     ; preds = %for.inc.i754
  %96 = load ptr, ptr %alttable.i739, align 8
...
if.then412:                                       ; preds = %if.end407
  ...
  store ptr %call413, ptr %offset414, align 8
...
if.then417:                                       ; preds = %if.then412
  ...
  %97 = load ptr, ptr %prefix418, align 8
...
if.end424:                                        ; preds = %if.else422, %if.then420
  ...
  %99 = load ptr, ptr %virname396, align 8
  tail call void @free(ptr noundef %99) #11
  br label %cleanup445.sink.split

if.end427:                                        ; preds = %if.then412, %if.end407
  %call428 = tail call i32 @cli_ac_addpatt(ptr noundef nonnull %root, ptr noundef nonnull %call2)
...
if.then430:                                       ; preds = %if.end427
  ...
  %100 = load ptr, ptr %prefix431, align 8
...
entry:
  store i8 %mindepth, ptr @cli_ac_mindepth, align 1
  store i8 %maxdepth, ptr @cli_ac_maxdepth, align 1
  ret void
}
