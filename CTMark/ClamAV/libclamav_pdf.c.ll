; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_pdf.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_pdf.c"
...
for.body:                                         ; preds = %if.end22, %for.inc
  ...
  %bcmp731 = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(5) %q.0.ptr.ptr777, ptr noundef nonnull dereferenceable(5) @.str.3, i64 5)
  %cmp27 = icmp eq i32 %bcmp731, 0
  br i1 %cmp27, label %if.end37, label %for.inc

for.inc:                                          ; preds = %for.body
  %q.0.add = add nsw i64 %q.0.idx776, -1
  %cmp25 = icmp sgt i64 %q.0.idx776, 7
  br i1 %cmp25, label %for.body, label %if.then31
...
for.body41:                                       ; preds = %if.end37, %for.inc46
  ...
  %bcmp732 = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(7) %trailerstart.0.ptr.ptr781, ptr noundef nonnull dereferenceable(7) @.str.4, i64 7)
  %cmp43 = icmp eq i32 %bcmp732, 0
...
if.end18.i:                                       ; preds = %if.end13.i
  ...
  %call7.i = tail call ptr @memchr(ptr noundef nonnull %hay.1.i, i32 noundef 69, i64 noundef %n.1.i) #16
  %cmp8.not.i = icmp eq ptr %call7.i, null
  br i1 %cmp8.not.i, label %for.cond58.preheader, label %while.body.i
...
for.body60:                                       ; preds = %for.cond58.preheader, %for.inc74
  %xrefstart.0.idx787 = phi i64 [ %xrefstart.0.add, %for.inc74 ], [ %trailerstart.0.idx.lcssa, %for.cond58.preheader ]
  %xrefstart.0.ptr788.ptr = getelementptr inbounds i8, ptr %p.0, i64 %xrefstart.0.idx787
  %bcmp733 = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(4) %xrefstart.0.ptr788.ptr, ptr noundef nonnull dereferenceable(4) @.str.7, i64 4)
  %cmp62 = icmp eq i32 %bcmp733, 0
...
if.then63:                                        ; preds = %for.body60
  ...
  %1 = load i8, ptr %arrayidx64, align 1
...
for.inc74:                                        ; preds = %if.then63, %for.body60
  %xrefstart.0.add = add nsw i64 %xrefstart.0.idx787, -1
  %cmp59 = icmp sgt i64 %xrefstart.0.idx787, 7
  br i1 %cmp59, label %for.body60, label %if.then79
...
land.rhs.lr.ph:                                   ; preds = %if.then63, %if.then63
  %xrefstart.0.ptr770.ptr810 = getelementptr inbounds i8, ptr %p.0, i64 %xrefstart.0.idx787
  %call86811 = tail call ptr @tableCreate() #15
  %limits87 = getelementptr inbounds %struct.cli_ctx, ptr %ctx, i64 0, i32 4
  %2 = load ptr, ptr %limits87, align 8
...
if.end98:                                         ; preds = %while.body
  %bcmp734 = call i32 @bcmp(ptr noundef nonnull dereferenceable(4) %call92, ptr noundef nonnull dereferenceable(4) @.str.7, i64 4)
  %cmp100 = icmp eq i32 %bcmp734, 0
...
if.end103:                                        ; preds = %if.end98
  ...
  %bcmp735 = call i32 @bcmp(ptr noundef nonnull dereferenceable(6) %call92, ptr noundef nonnull dereferenceable(6) @.str.8, i64 6)
  %cmp109 = icmp eq i32 %bcmp735, 0
  br i1 %cmp109, label %cleanup467, label %if.end112

if.end112:                                        ; preds = %if.end103
  %call113 = tail call ptr @__ctype_b_loc() #17
  %3 = load ptr, ptr %call113, align 8
  %4 = load i8, ptr %call92, align 1
  %idxprom = sext i8 %4 to i64
  %arrayidx115 = getelementptr inbounds i16, ptr %3, i64 %idxprom
  %5 = load i16, ptr %arrayidx115, align 2
  %6 = and i16 %5, 2048
...
lor.lhs.false140:                                 ; preds = %if.end132
  %bcmp736 = call i32 @bcmp(ptr noundef nonnull dereferenceable(3) %call137, ptr noundef nonnull dereferenceable(3) @.str.11, i64 3)
  %cmp142.not = icmp eq i32 %bcmp736, 0
...
if.end155:                                        ; preds = %if.end145
  ...
  br i1 %cmp166, label %cleanup467, label %while.cond170.preheader
...
if.then182:                                       ; preds = %if.then177
  ...
  %11 = load ptr, ptr %call113, align 8
...
if.then261:                                       ; preds = %if.else257
  ...
  %15 = load ptr, ptr %call113, align 8
...
if.end293:                                        ; preds = %if.else282, %if.else252, %if.end250, %while.end274, %if.then280, %while.body173
  ...
  br i1 %cmp298, label %while.end302, label %while.cond170
...
if.then304:                                       ; preds = %while.end302
  ...
  br i1 %tobool305.not, label %if.then306, label %cleanup467
...
if.then311:                                       ; preds = %if.end308
  ...
  br i1 %tobool312.not, label %if.then313, label %cleanup467
...
if.end326:                                        ; preds = %if.end315
  ...
  %sext737 = shl i64 %sub331, 32
  %conv332 = ashr exact i64 %sext737, 32
...
if.then351:                                       ; preds = %if.end344
  ...
  %19 = load i32, ptr %call353, align 4
...
if.end355:                                        ; preds = %if.end344
  ...
  %20 = load i8, ptr %incdec.ptr356, align 1
...
land.lhs.true368:                                 ; preds = %if.else366
  ...
  %21 = load i8, ptr %incdec.ptr369, align 1
...
if.end383:                                        ; preds = %if.end376
  ...
  %sext738 = shl i64 %sub.ptr.sub386, 32
  %conv388 = ashr exact i64 %sext738, 32
...
land.lhs.true458:                                 ; preds = %if.end455
  %22 = load i32, ptr %maxfiles, align 4
  %23 = add i32 %22, -1
...
if.end18:                                         ; preds = %if.end13
  ...
  %n.1 = add i64 %sub, %dec
  %call7 = tail call ptr @memchr(ptr noundef nonnull %hay.1, i32 noundef %conv, i64 noundef %n.1) #16
...
while.body:                                       ; preds = %entry, %sw.epilog
  ...
  %0 = load i8, ptr %ptr.addr.028, align 1
  %conv = sext i8 %0 to i32
...
if.end.i:                                         ; preds = %while.body.i
  ...
  br i1 %memchr22.not.i, label %while.body.i, label %while.body9.i.preheader
...
if.end14.i:                                       ; preds = %while.body9.i
  ...
  %8 = load i8, ptr %incdec.ptr15.i, align 1
  %9 = zext i8 %8 to i16
  ...
  br i1 %memchr25.not.i, label %if.end, label %while.body9.i
...
if.end:                                           ; preds = %while.body
  ...
  br i1 %memchr22.not, label %while.body, label %while.body9.preheader
...
if.end14:                                         ; preds = %while.body9
  ...
  br i1 %memchr25.not, label %return, label %while.body9
...
if.end18.i:                                       ; preds = %if.end13.i
  ...
  %dec.i = sext i1 %cmp19.i to i64
  %n.1.i = add i64 %sub.i, %dec.i
  %call7.i = tail call ptr @memchr(ptr noundef nonnull %hay.1.i, i32 noundef 126, i64 noundef %n.1.i) #16
  %cmp8.not.i = icmp eq ptr %call7.i, null
  br i1 %cmp8.not.i, label %if.then, label %while.body.i
...
if.end:                                           ; preds = %if.end13.i, %entry, %if.then, %cli_pmemstr.exit
  ...
  %cmp1185 = icmp sgt i64 %len, 0
  br i1 %cmp1185, label %while.body, label %cleanup95

while.body:                                       ; preds = %if.end, %cleanup92
  %ret.0191 = phi i32 [ %ret.4, %cleanup92 ], [ 0, %if.end ]
  %quintet.0190 = phi i32 [ %quintet.4, %cleanup92 ], [ 0, %if.end ]
  %sum.0189 = phi i32 [ %sum.6, %cleanup92 ], [ 0, %if.end ]
  %ptr.0188 = phi ptr [ %incdec.ptr, %cleanup92 ], [ %buf, %if.end ]
  %output.addr.0187 = phi ptr [ %output.addr.5, %cleanup92 ], [ %output, %if.end ]
  %len.addr.0186 = phi i64 [ %dec, %cleanup92 ], [ %len, %if.end ]
  %dec = add nsw i64 %len.addr.0186, -1
  %incdec.ptr = getelementptr inbounds i8, ptr %ptr.0188, i64 1
  %0 = load i8, ptr %ptr.0188, align 1
  %conv = sext i8 %0 to i32
...
if.then14:                                        ; preds = %if.end8
  %mul = mul i32 %sum.0189, 85
  %add = add i32 %2, %mul
  %inc = add nsw i32 %quintet.0190, 1
...
if.then17:                                        ; preds = %if.then14
  ...
  %incdec.ptr19 = getelementptr inbounds i8, ptr %output.addr.0187, i64 1
  store i8 %conv18, ptr %output.addr.0187, align 1
  %shr20 = lshr i32 %add, 16
  %conv21 = trunc i32 %shr20 to i8
  %incdec.ptr22 = getelementptr inbounds i8, ptr %output.addr.0187, i64 2
  store i8 %conv21, ptr %incdec.ptr19, align 1
  %shr23 = lshr i32 %add, 8
  %conv25 = trunc i32 %shr23 to i8
  %incdec.ptr26 = getelementptr inbounds i8, ptr %output.addr.0187, i64 3
  store i8 %conv25, ptr %incdec.ptr22, align 1
  %conv28 = trunc i32 %add to i8
  %incdec.ptr29 = getelementptr inbounds i8, ptr %output.addr.0187, i64 4
  store i8 %conv28, ptr %incdec.ptr26, align 1
  %add30 = add nsw i32 %ret.0191, 4
  br label %cleanup92
...
if.then34:                                        ; preds = %if.else
  %tobool35.not = icmp eq i32 %quintet.0190, 0
...
if.end37:                                         ; preds = %if.then34
  %incdec.ptr41 = getelementptr inbounds i8, ptr %output.addr.0187, i64 4
  %add42 = add nsw i32 %ret.0191, 4
  store i32 0, ptr %output.addr.0187, align 1
  br label %cleanup92

if.then46:                                        ; preds = %if.else
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.57, i32 noundef %quintet.0190) #15
  switch i32 %quintet.0190, label %for.cond.preheader [
    i32 0, label %cleanup95
    i32 1, label %cleanup.thread
  ]

for.cond.preheader:                               ; preds = %if.then46
  %cmp53192 = icmp slt i32 %quintet.0190, 5
  br i1 %cmp53192, label %for.body.preheader, label %for.end

for.body.preheader:                               ; preds = %for.cond.preheader
  %3 = sub i32 5, %quintet.0190
  %min.iters.check = icmp ult i32 %3, 8
  br i1 %min.iters.check, label %for.body.preheader289, label %vector.ph

vector.ph:                                        ; preds = %for.body.preheader
  %n.vec = and i32 %3, -8
  %ind.end = add i32 %quintet.0190, %n.vec
  %4 = insertelement <4 x i32> <i32 poison, i32 1, i32 1, i32 1>, i32 %sum.0189, i64 0
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i32 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %vec.phi = phi <4 x i32> [ %4, %vector.ph ], [ %5, %vector.body ]
  %vec.phi256 = phi <4 x i32> [ <i32 1, i32 1, i32 1, i32 1>, %vector.ph ], [ %6, %vector.body ]
  %5 = mul <4 x i32> %vec.phi, <i32 85, i32 85, i32 85, i32 85>
  %6 = mul <4 x i32> %vec.phi256, <i32 85, i32 85, i32 85, i32 85>
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.end, label %for.body.preheader289

for.body.preheader289:                            ; preds = %for.body.preheader, %middle.block
  %i.0194.ph = phi i32 [ %quintet.0190, %for.body.preheader ], [ %ind.end, %middle.block ]
  %sum.1193.ph = phi i32 [ %sum.0189, %for.body.preheader ], [ %8, %middle.block ]
  br label %for.body
...
for.body:                                         ; preds = %for.body.preheader289, %for.body
  %i.0194 = phi i32 [ %inc56, %for.body ], [ %i.0194.ph, %for.body.preheader289 ]
  %sum.1193 = phi i32 [ %mul55, %for.body ], [ %sum.1193.ph, %for.body.preheader289 ]
  %mul55 = mul i32 %sum.1193, 85
  %inc56 = add i32 %i.0194, 1
  %exitcond.not = icmp eq i32 %inc56, 5
  br i1 %exitcond.not, label %for.end, label %for.body

for.end:                                          ; preds = %for.body, %middle.block, %for.cond.preheader
  %sum.1.lcssa = phi i32 [ %sum.0189, %for.cond.preheader ], [ %8, %middle.block ], [ %mul55, %for.body ]
  %cmp57 = icmp sgt i32 %quintet.0190, 1
  %sub60 = shl i32 %quintet.0190, 3
  %mul61 = add i32 %sub60, -16
  %shr62 = lshr i32 16777215, %mul61
  %add63 = select i1 %cmp57, i32 %shr62, i32 0
  %sum.2 = add i32 %sum.1.lcssa, %add63
  %add65 = add nsw i32 %ret.0191, %quintet.0190
  br i1 %cmp57, label %iter.check, label %cleanup95

iter.check:                                       ; preds = %for.end
  %9 = add i32 %quintet.0190, -2
  %10 = add i32 %quintet.0190, -1
  %11 = zext i32 %10 to i64
  %min.iters.check259 = icmp ult i32 %quintet.0190, 9
  br i1 %min.iters.check259, label %for.body70.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check261 = icmp ult i32 %quintet.0190, 17
  br i1 %min.iters.check261, label %vec.epilog.ph, label %vector.ph262

vector.ph262:                                     ; preds = %vector.main.loop.iter.check
  %n.vec264 = and i64 %11, 4294967280
  %broadcast.splatinsert = insertelement <16 x i32> poison, i32 %sum.2, i64 0
  %broadcast.splat = shufflevector <16 x i32> %broadcast.splatinsert, <16 x i32> poison, <16 x i32> zeroinitializer
  %ind.end269 = trunc i64 %n.vec264 to i32
  br label %vector.body266

vector.body266:                                   ; preds = %vector.body266, %vector.ph262
  %index267 = phi i64 [ 0, %vector.ph262 ], [ %index.next268, %vector.body266 ]
  %vec.ind = phi <16 x i32> [ <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>, %vector.ph262 ], [ %vec.ind.next, %vector.body266 ]
  %next.gep = getelementptr i8, ptr %output.addr.0187, i64 %index267
  ...
  store <16 x i8> %15, ptr %next.gep, align 1
  %index.next268 = add nuw i64 %index267, 16
  ...
  %16 = icmp eq i64 %index.next268, %n.vec264
  br i1 %16, label %middle.block257, label %vector.body266

middle.block257:                                  ; preds = %vector.body266
  %cmp.n265 = icmp eq i64 %n.vec264, %11
  br i1 %cmp.n265, label %cleanup95, label %vec.epilog.iter.check

vec.epilog.iter.check:                            ; preds = %middle.block257
  %ind.end279 = getelementptr i8, ptr %output.addr.0187, i64 %n.vec264
  %ind.end276 = trunc i64 %n.vec264 to i32
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %bc.resume.val270 = phi i32 [ %ind.end269, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %vec.epilog.resume.val = phi i64 [ %n.vec264, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %n.vec274 = and i64 %11, 4294967288
  %ind.end275 = trunc i64 %n.vec274 to i32
  %ind.end278 = getelementptr i8, ptr %output.addr.0187, i64 %n.vec274
  %.splatinsert = insertelement <8 x i32> poison, i32 %bc.resume.val270, i64 0
  ...
  %broadcast.splatinsert286 = insertelement <8 x i32> poison, i32 %sum.2, i64 0
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index282 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next288, %vec.epilog.vector.body ]
  %vec.ind283 = phi <8 x i32> [ %induction, %vec.epilog.ph ], [ %vec.ind.next284, %vec.epilog.vector.body ]
  %next.gep285 = getelementptr i8, ptr %output.addr.0187, i64 %index282
  %17 = shl nsw <8 x i32> %vec.ind283, <i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3>
  %18 = sub nsw <8 x i32> <i32 24, i32 24, i32 24, i32 24, i32 24, i32 24, i32 24, i32 24>, %17
  %19 = lshr <8 x i32> %broadcast.splat287, %18
  %20 = trunc <8 x i32> %19 to <8 x i8>
  store <8 x i8> %20, ptr %next.gep285, align 1
  %index.next288 = add nuw i64 %index282, 8
  %vec.ind.next284 = add <8 x i32> %vec.ind283, <i32 8, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8>
  %21 = icmp eq i64 %index.next288, %n.vec274
  br i1 %21, label %vec.epilog.middle.block, label %vec.epilog.vector.body

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n281 = icmp eq i64 %n.vec274, %11
  br i1 %cmp.n281, label %cleanup95, label %for.body70.preheader

for.body70.preheader:                             ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %i.1198.ph = phi i32 [ 0, %iter.check ], [ %ind.end276, %vec.epilog.iter.check ], [ %ind.end275, %vec.epilog.middle.block ]
  %output.addr.1197.ph = phi ptr [ %output.addr.0187, %iter.check ], [ %ind.end279, %vec.epilog.iter.check ], [ %ind.end278, %vec.epilog.middle.block ]
  br label %for.body70

for.body70:                                       ; preds = %for.body70.preheader, %for.body70
  %i.1198 = phi i32 [ %inc78, %for.body70 ], [ %i.1198.ph, %for.body70.preheader ]
  %output.addr.1197 = phi ptr [ %incdec.ptr76, %for.body70 ], [ %output.addr.1197.ph, %for.body70.preheader ]
  %mul71 = shl nsw i32 %i.1198, 3
  %sub72 = sub nsw i32 24, %mul71
  %shr73 = lshr i32 %sum.2, %sub72
  %conv75 = trunc i32 %shr73 to i8
  %incdec.ptr76 = getelementptr inbounds i8, ptr %output.addr.1197, i64 1
  store i8 %conv75, ptr %output.addr.1197, align 1
  %inc78 = add nuw nsw i32 %i.1198, 1
  %exitcond217.not = icmp eq i32 %i.1198, %9
  br i1 %exitcond217.not, label %cleanup95, label %for.body70

if.else81:                                        ; preds = %if.else
  %call82 = tail call ptr @__ctype_b_loc() #17
  %22 = load ptr, ptr %call82, align 8
...
cleanup92:                                        ; preds = %if.then17, %if.then14, %if.else81, %if.end37
  %output.addr.5 = phi ptr [ %incdec.ptr29, %if.then17 ], [ %output.addr.0187, %if.then14 ], [ %incdec.ptr41, %if.end37 ], [ %output.addr.0187, %if.else81 ]
  %sum.6 = phi i32 [ 0, %if.then17 ], [ %add, %if.then14 ], [ %sum.0189, %if.end37 ], [ %sum.0189, %if.else81 ]
  %quintet.4 = phi i32 [ 0, %if.then17 ], [ %inc, %if.then14 ], [ 0, %if.end37 ], [ %quintet.0190, %if.else81 ]
  %ret.4 = phi i32 [ %add30, %if.then17 ], [ %ret.0191, %if.then14 ], [ %add42, %if.end37 ], [ %ret.0191, %if.else81 ]
  %cmp1 = icmp ugt i64 %len.addr.0186, 1
  br i1 %cmp1, label %while.body, label %cleanup95

cleanup95:                                        ; preds = %cleanup92, %for.body70, %middle.block257, %vec.epilog.middle.block, %if.then46, %cleanup.thread, %if.then86, %if.then36, %for.end, %if.end
  %retval.4 = phi i32 [ %ret.0191, %if.then46 ], [ 0, %if.end ], [ %add65, %for.end ], [ -1, %if.then36 ], [ -1, %if.then86 ], [ -1, %cleanup.thread ], [ %add65, %vec.epilog.middle.block ], [ %add65, %middle.block257 ], [ %add65, %for.body70 ], [ %ret.4, %cleanup92 ]
  ret i32 %retval.4
}
...
if.end:                                           ; preds = %entry
  ...
  store ptr %buf, ptr %stream, align 8
  ...
  store ptr %output, ptr %next_out, align 8
...
land.lhs.true:                                    ; preds = %if.then10
  ...
  %3 = load i64, ptr %maxfilesize, align 8
...
if.end53:                                         ; preds = %if.then43, %while.end
  ...
  %11 = load ptr, ptr %limits56, align 8
...
cond.true:                                        ; preds = %if.end53
  ...
  %12 = load i32, ptr %maxratio, align 4
  br label %cond.end
...
cond.end:                                         ; preds = %if.end53, %cond.true
  ...
  %13 = load ptr, ptr %limits56, align 8
...
land.lhs.true62:                                  ; preds = %cond.end
  ...
  %14 = load i32, ptr %maxratio64, align 4
...
land.lhs.true66:                                  ; preds = %land.lhs.true62
  ...
  %16 = load i64, ptr %total_in, align 8
...
if.then75:                                        ; preds = %land.lhs.true66
  ...
  %17 = load i32, ptr %options77, align 8
