; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_untar.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_untar.c"
...
entry:
  ...
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str, ptr noundef nonnull %cond, i32 noundef %desc) #10
...
land.lhs.true24:                                  ; preds = %if.end22
  %1 = load i32, ptr %maxfiles, align 4
  %2 = add i32 %1, -1
...
if.end46:                                         ; preds = %if.then34, %if.end32
  %3 = load i8, ptr %arrayidx47, align 4
...
if.end92:                                         ; preds = %if.end80
  ...
  store i8 0, ptr %arrayidx96, align 4
...
if.then121:                                       ; preds = %if.end108
  ...
  %9 = load i32, ptr %call123, align 4
...
cleanup182.loopexit:                              ; preds = %if.then132, %if.then121, %if.then64, %if.then43, %if.then30, %if.then15
  %retval.1.ph.ph = phi i32 [ -123, %if.then15 ], [ 0, %if.then30 ], [ -124, %if.then43 ], [ -124, %if.then64 ], [ -112, %if.then121 ], [ -112, %if.then132 ]
  call void @llvm.lifetime.end.p0(i64 13, ptr nonnull %osize) #10
  call void @llvm.lifetime.end.p0(i64 101, ptr nonnull %name) #10
  call void @llvm.lifetime.end.p0(i64 7, ptr nonnull %magic) #10
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %block) #10
