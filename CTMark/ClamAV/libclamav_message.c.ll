; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_message.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_message.c"
...
entry:
  ...
  %0 = load ptr, ptr %mimeSubtype, align 8
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %1 = load ptr, ptr %mimeDispositionType, align 8
...
if.end5:                                          ; preds = %if.then3, %if.end
  ...
  %2 = load ptr, ptr %mimeArguments, align 8
...
for.cond.preheader:                               ; preds = %if.end5
  ...
  %3 = load i32, ptr %numberOfArguments, align 8
  %cmp37 = icmp sgt i32 %3, 0
  br i1 %cmp37, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond.preheader, %for.body
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body ], [ 0, %for.cond.preheader ]
  %4 = load ptr, ptr %mimeArguments, align 8
  %arrayidx = getelementptr inbounds ptr, ptr %4, i64 %indvars.iv
  %5 = load ptr, ptr %arrayidx, align 8
  tail call void @free(ptr noundef %5) #18
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %6 = load i32, ptr %numberOfArguments, align 8
  %7 = sext i32 %6 to i64
  %cmp = icmp slt i64 %indvars.iv.next, %7
  br i1 %cmp, label %for.body, label %for.end.loopexit

for.end.loopexit:                                 ; preds = %for.body
  %.pre = load ptr, ptr %mimeArguments, align 8
  br label %for.end
...
if.end10:                                         ; preds = %for.end, %if.end5
  ...
  %9 = load ptr, ptr %body_first, align 8
...
if.end14:                                         ; preds = %if.then12, %if.end10
  ...
  %10 = load ptr, ptr %encodingTypes, align 8
...
while.cond:                                       ; preds = %while.body, %if.end
  ...
  %1 = load i8, ptr %type.addr.0, align 1
...
while.end:                                        ; preds = %while.cond
  %4 = load ptr, ptr @messageSetMimeType.mime_table, align 8
  %cmp7 = icmp eq ptr %4, null
  br i1 %cmp7, label %if.then9, label %if.end23

if.then9:                                         ; preds = %while.end
  %call10 = tail call ptr @tableCreate() #18
  store ptr %call10, ptr @messageSetMimeType.mime_table, align 8
...
for.cond:                                         ; preds = %for.body.preheader
  %5 = load ptr, ptr @messageSetMimeType.mime_table, align 8
...
for.cond.1:                                       ; preds = %for.cond
  %6 = load ptr, ptr @messageSetMimeType.mime_table, align 8
...
for.cond.2:                                       ; preds = %for.cond.1
  %7 = load ptr, ptr @messageSetMimeType.mime_table, align 8
...
for.cond.3:                                       ; preds = %for.cond.2
  %8 = load ptr, ptr @messageSetMimeType.mime_table, align 8
...
for.cond.4:                                       ; preds = %for.cond.3
  %9 = load ptr, ptr @messageSetMimeType.mime_table, align 8
...
for.cond.5:                                       ; preds = %for.cond.4
  %10 = load ptr, ptr @messageSetMimeType.mime_table, align 8
...
for.cond.6:                                       ; preds = %for.cond.5
  %.pre = load ptr, ptr @messageSetMimeType.mime_table, align 8
  br label %if.end23

if.then20:                                        ; preds = %for.cond.5, %for.cond.4, %for.cond.3, %for.cond.2, %for.cond.1, %for.cond, %for.body.preheader
  %11 = load ptr, ptr @messageSetMimeType.mime_table, align 8
...
if.then27:                                        ; preds = %if.end23
  store i32 %call24, ptr %mess, align 8
  br label %cleanup

if.end28:                                         ; preds = %if.end23
  %13 = load i32, ptr %mess, align 8
...
if.end65:                                         ; preds = %if.else63, %if.then61
  ...
  store i32 %storemerge, ptr %mess, align 8
  br label %cleanup
...
lor.lhs.false17:                                  ; preds = %if.end.i
  ...
  br i1 %cmp.i131, label %if.then20, label %if.end.i132

if.end.i132:                                      ; preds = %lor.lhs.false17
  %call1.i133 = tail call ptr @cli_strdup(ptr noundef nonnull %call5) #18
  store ptr %call1.i133, ptr %call.i130, align 8
  %cmp2.i134 = icmp eq ptr %call1.i133, null
  br i1 %cmp2.i134, label %if.then20, label %push.exit138

push.exit138:                                     ; preds = %if.end.i132
  %next.i136 = getelementptr inbounds %struct.pstr_list, ptr %call.i130, i64 0, i32 1
  store ptr %call.i, ptr %next.i136, align 8
  br label %while.body

if.then20:                                        ; preds = %if.end.i132, %lor.lhs.false17, %if.end.i, %if.end14
  tail call void @free(ptr noundef nonnull %call1) #18
  tail call void @free(ptr noundef nonnull %call5) #18
  br label %cleanup

while.body:                                       ; preds = %push.exit138, %if.end85
  %score.0229 = phi i32 [ 0, %push.exit138 ], [ %score.1, %if.end85 ]
  %rs2.0228 = phi ptr [ null, %push.exit138 ], [ %rs2.1211, %if.end85 ]
  %rs1.0227 = phi ptr [ null, %push.exit138 ], [ %rs1.1210, %if.end85 ]
  %top.2226 = phi ptr [ %call.i130, %push.exit138 ], [ %top.10, %if.end85 ]
  %0 = load ptr, ptr %top.2226, align 8
  %call.i139 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %ls2, ptr noundef nonnull dereferenceable(1) %0) #18
  %next.i140 = getelementptr inbounds %struct.pstr_list, ptr %top.2226, i64 0, i32 1
  %1 = load ptr, ptr %next.i140, align 8
  %2 = load ptr, ptr %top.2226, align 8
  call void @free(ptr noundef %2) #18
  call void @free(ptr noundef nonnull %top.2226) #18
  %cmp.not.i142 = icmp eq ptr %1, null
  br i1 %cmp.not.i142, label %pop.exit147, label %if.then.i143

if.then.i143:                                     ; preds = %while.body
  %3 = load ptr, ptr %1, align 8
  %call.i144 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %ls1, ptr noundef nonnull dereferenceable(1) %3) #18
  %next.i145 = getelementptr inbounds %struct.pstr_list, ptr %1, i64 0, i32 1
  %4 = load ptr, ptr %next.i145, align 8
  %5 = load ptr, ptr %1, align 8
  call void @free(ptr noundef %5) #18
  call void @free(ptr noundef nonnull %1) #18
  br label %pop.exit147

pop.exit147:                                      ; preds = %while.body, %if.then.i143
  %top.4 = phi ptr [ null, %while.body ], [ %4, %if.then.i143 ]
  %call.i148 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %ls1) #20
  %cmp105.i = icmp sgt i64 %call.i148, 0
  br i1 %cmp105.i, label %while.cond.preheader.preheader.i, label %if.end85
...
while.cond.preheader.i:                           ; preds = %while.end.i, %while.cond.preheader.preheader.i
  %maxchars.0114.i = phi i32 [ %maxchars.1.lcssa.i, %while.end.i ], [ 0, %while.cond.preheader.preheader.i ]
  %some_similarity.0113.i = phi i8 [ %some_similarity.1.lcssa.i, %while.end.i ], [ 0, %while.cond.preheader.preheader.i ]
  %maxs1.0112.i = phi ptr [ %maxs1.1.lcssa.i, %while.end.i ], [ null, %while.cond.preheader.preheader.i ]
  %maxs2.0111.i = phi ptr [ %maxs2.1.lcssa.i, %while.end.i ], [ null, %while.cond.preheader.preheader.i ]
  %maxe1.0110.i = phi ptr [ %maxe1.1.lcssa.i, %while.end.i ], [ null, %while.cond.preheader.preheader.i ]
  %maxe2.0109.i = phi ptr [ %maxe2.1.lcssa.i, %while.end.i ], [ null, %while.cond.preheader.preheader.i ]
  %end2.0108.i = phi ptr [ %end2.1.lcssa.i, %while.end.i ], [ %add.ptr2.i, %while.cond.preheader.preheader.i ]
  %end1.0107.i = phi ptr [ %end1.1.lcssa.i, %while.end.i ], [ %add.ptr.i, %while.cond.preheader.preheader.i ]
  %start1.0106.i = phi ptr [ %incdec.ptr50.i, %while.end.i ], [ %ls1, %while.cond.preheader.preheader.i ]
  %cmp487.i = icmp ugt ptr %end2.0108.i, %ls2
  br i1 %cmp487.i, label %while.body.lr.ph.i, label %while.end.i
...
while.body.i:                                     ; preds = %if.end49.i, %while.body.lr.ph.i
  %maxchars.197.i = phi i32 [ %maxchars.0114.i, %while.body.lr.ph.i ], [ %maxchars.2.i, %if.end49.i ]
  %some_similarity.196.i = phi i8 [ %some_similarity.0113.i, %while.body.lr.ph.i ], [ %some_similarity.2.i, %if.end49.i ]
  %s1.095.i = phi ptr [ %start1.0106.i, %while.body.lr.ph.i ], [ %s1.3.i, %if.end49.i ]
  %s2.094.i = phi ptr [ %ls2, %while.body.lr.ph.i ], [ %s2.3.i, %if.end49.i ]
  %maxs1.193.i = phi ptr [ %maxs1.0112.i, %while.body.lr.ph.i ], [ %maxs1.2.i, %if.end49.i ]
  %maxs2.192.i = phi ptr [ %maxs2.0111.i, %while.body.lr.ph.i ], [ %maxs2.2.i, %if.end49.i ]
  %maxe1.191.i = phi ptr [ %maxe1.0110.i, %while.body.lr.ph.i ], [ %maxe1.2.i, %if.end49.i ]
  %maxe2.190.i = phi ptr [ %maxe2.0109.i, %while.body.lr.ph.i ], [ %maxe2.2.i, %if.end49.i ]
  %end2.189.i = phi ptr [ %end2.0108.i, %while.body.lr.ph.i ], [ %end2.2.i, %if.end49.i ]
  %end1.188.i = phi ptr [ %end1.0107.i, %while.body.lr.ph.i ], [ %end1.2.i, %if.end49.i ]
  %7 = load i8, ptr %s1.095.i, align 1
  %idxprom.i = sext i8 %7 to i64
  %arrayidx.i = getelementptr inbounds i32, ptr %6, i64 %idxprom.i
  %8 = load i32, ptr %arrayidx.i, align 4
  %9 = load i8, ptr %s2.094.i, align 1
...
do.body.i:                                        ; preds = %while.body.i, %if.else.i
  %s2.1.i = phi ptr [ %incdec.ptr20.i, %if.else.i ], [ %s2.094.i, %while.body.i ]
  %s1.1.i = phi ptr [ %incdec.ptr.i, %if.else.i ], [ %s1.095.i, %while.body.i ]
  %common.0.i = phi i32 [ %inc.i, %if.else.i ], [ 0, %while.body.i ]
  %cmp15.i = icmp eq ptr %s1.1.i, %end1.188.i
  %cmp17.i = icmp eq ptr %s2.1.i, %end2.189.i
...
if.else.i:                                        ; preds = %do.body.i
  ...
  %13 = load i8, ptr %incdec.ptr20.i, align 1
  ...
  br i1 %cmp33.i, label %do.body.i, label %do.end.i
...
do.end.i:                                         ; preds = %if.else.i, %do.body.i
  ...
  %cmp35.i = icmp ugt i32 %common.1.i, %maxchars.197.i
  br i1 %cmp35.i, label %if.then37.i, label %if.else42.i

if.then37.i:                                      ; preds = %do.end.i
  %sub.i = sub i32 %common.1.i, %maxchars.197.i
  %idx.ext.i = zext i32 %sub.i to i64
  %idx.neg.i = sub nsw i64 0, %idx.ext.i
  %add.ptr38.i = getelementptr inbounds i8, ptr %end1.188.i, i64 %idx.neg.i
  %add.ptr41.i = getelementptr inbounds i8, ptr %end2.189.i, i64 %idx.neg.i
  br label %if.end49.i
...
if.else47.i:                                      ; preds = %while.body.i
  %incdec.ptr48.i = getelementptr inbounds i8, ptr %s2.094.i, i64 1
  br label %if.end49.i

if.end49.i:                                       ; preds = %if.else47.i, %if.else42.i, %if.then37.i
  %end1.2.i = phi ptr [ %add.ptr38.i, %if.then37.i ], [ %end1.188.i, %if.else42.i ], [ %end1.188.i, %if.else47.i ]
  %end2.2.i = phi ptr [ %add.ptr41.i, %if.then37.i ], [ %end2.189.i, %if.else42.i ], [ %end2.189.i, %if.else47.i ]
  %maxe2.2.i = phi ptr [ %s2.2.i, %if.then37.i ], [ %maxe2.190.i, %if.else42.i ], [ %maxe2.190.i, %if.else47.i ]
  %maxe1.2.i = phi ptr [ %s1.2.i, %if.then37.i ], [ %maxe1.191.i, %if.else42.i ], [ %maxe1.191.i, %if.else47.i ]
  %maxs2.2.i = phi ptr [ %s2.094.i, %if.then37.i ], [ %maxs2.192.i, %if.else42.i ], [ %maxs2.192.i, %if.else47.i ]
  %maxs1.2.i = phi ptr [ %s1.095.i, %if.then37.i ], [ %maxs1.193.i, %if.else42.i ], [ %maxs1.193.i, %if.else47.i ]
  %s2.3.i = phi ptr [ %s2.2.i, %if.then37.i ], [ %s2.2.i, %if.else42.i ], [ %incdec.ptr48.i, %if.else47.i ]
  %s1.3.i = phi ptr [ %s1.2.i, %if.then37.i ], [ %add.ptr45.i, %if.else42.i ], [ %s1.095.i, %if.else47.i ]
  %some_similarity.2.i = phi i8 [ 1, %if.then37.i ], [ 1, %if.else42.i ], [ %some_similarity.196.i, %if.else47.i ]
  %maxchars.2.i = phi i32 [ %common.1.i, %if.then37.i ], [ %maxchars.197.i, %if.else42.i ], [ %maxchars.197.i, %if.else47.i ]
  %cmp3.i = icmp ult ptr %s1.3.i, %end1.2.i
  %cmp4.i = icmp ult ptr %s2.3.i, %end2.2.i
  %15 = select i1 %cmp3.i, i1 %cmp4.i, i1 false
  br i1 %15, label %while.body.i, label %while.end.i

while.end.i:                                      ; preds = %if.end49.i, %while.cond.preheader.i
  %end1.1.lcssa.i = phi ptr [ %end1.0107.i, %while.cond.preheader.i ], [ %end1.2.i, %if.end49.i ]
  %end2.1.lcssa.i = phi ptr [ %end2.0108.i, %while.cond.preheader.i ], [ %end2.2.i, %if.end49.i ]
  %maxe2.1.lcssa.i = phi ptr [ %maxe2.0109.i, %while.cond.preheader.i ], [ %maxe2.2.i, %if.end49.i ]
  %maxe1.1.lcssa.i = phi ptr [ %maxe1.0110.i, %while.cond.preheader.i ], [ %maxe1.2.i, %if.end49.i ]
  %maxs2.1.lcssa.i = phi ptr [ %maxs2.0111.i, %while.cond.preheader.i ], [ %maxs2.2.i, %if.end49.i ]
  %maxs1.1.lcssa.i = phi ptr [ %maxs1.0112.i, %while.cond.preheader.i ], [ %maxs1.2.i, %if.end49.i ]
  %some_similarity.1.lcssa.i = phi i8 [ %some_similarity.0113.i, %while.cond.preheader.i ], [ %some_similarity.2.i, %if.end49.i ]
  %maxchars.1.lcssa.i = phi i32 [ %maxchars.0114.i, %while.cond.preheader.i ], [ %maxchars.2.i, %if.end49.i ]
  %incdec.ptr50.i = getelementptr inbounds i8, ptr %start1.0106.i, i64 1
...
for.end.i:                                        ; preds = %while.end.i
  ...
  %17 = icmp eq i8 %16, 0
  br i1 %17, label %compare.exit, label %if.then53.i

if.then53.i:                                      ; preds = %for.end.i
  store i8 0, ptr %maxs1.1.lcssa.i, align 1
  store i8 0, ptr %maxs2.1.lcssa.i, align 1
  br label %compare.exit

compare.exit:                                     ; preds = %for.end.i, %if.then53.i
  %rs1.1 = phi ptr [ %rs1.0227, %for.end.i ], [ %maxe1.1.lcssa.i, %if.then53.i ]
  %rs2.1 = phi ptr [ %rs2.0228, %for.end.i ], [ %maxe2.1.lcssa.i, %if.then53.i ]
  %cmp29.not = icmp eq i32 %maxchars.1.lcssa.i, 0
  br i1 %cmp29.not, label %if.end85, label %if.then31

if.then31:                                        ; preds = %compare.exit
  %add33 = add i32 %maxchars.1.lcssa.i, %score.0229
...
if.then48:                                        ; preds = %lor.lhs.false42, %if.then31
  ...
  br i1 %cmp.i152, label %if.then58, label %if.end.i153

if.end.i153:                                      ; preds = %if.then48
  %call1.i154 = call ptr @cli_strdup(ptr noundef nonnull %ls1) #18
  store ptr %call1.i154, ptr %call.i151, align 8
  %cmp2.i155 = icmp eq ptr %call1.i154, null
  br i1 %cmp2.i155, label %if.then58, label %lor.lhs.false53

lor.lhs.false53:                                  ; preds = %if.end.i153
  %next.i157 = getelementptr inbounds %struct.pstr_list, ptr %call.i151, i64 0, i32 1
  store ptr %top.4, ptr %next.i157, align 8
  %call.i160 = call ptr @cli_malloc(i64 noundef 16) #18
  %cmp.i161 = icmp eq ptr %call.i160, null
  br i1 %cmp.i161, label %if.then58, label %if.end.i162

if.end.i162:                                      ; preds = %lor.lhs.false53
  %call1.i163 = call ptr @cli_strdup(ptr noundef nonnull %ls2) #18
  store ptr %call1.i163, ptr %call.i160, align 8
  %cmp2.i164 = icmp eq ptr %call1.i163, null
  br i1 %cmp2.i164, label %if.then58, label %push.exit168

push.exit168:                                     ; preds = %if.end.i162
  %next.i166 = getelementptr inbounds %struct.pstr_list, ptr %call.i160, i64 0, i32 1
  store ptr %call.i151, ptr %next.i166, align 8
  br label %if.end60

if.then58:                                        ; preds = %if.end.i162, %lor.lhs.false53, %if.end.i153, %if.then48
...
if.then74:                                        ; preds = %lor.lhs.false68, %if.end60
  ...
  br i1 %cmp.i170, label %if.then82, label %if.end.i171

if.end.i171:                                      ; preds = %if.then74
  %call1.i172 = call ptr @cli_strdup(ptr noundef %rs1.1) #18
  store ptr %call1.i172, ptr %call.i169, align 8
  %cmp2.i173 = icmp eq ptr %call1.i172, null
  br i1 %cmp2.i173, label %if.then82, label %lor.lhs.false78

lor.lhs.false78:                                  ; preds = %if.end.i171
  %next.i175 = getelementptr inbounds %struct.pstr_list, ptr %call.i169, i64 0, i32 1
  store ptr %top.7, ptr %next.i175, align 8
  %call.i178 = call ptr @cli_malloc(i64 noundef 16) #18
  %cmp.i179 = icmp eq ptr %call.i178, null
  br i1 %cmp.i179, label %if.then82, label %if.end.i180

if.end.i180:                                      ; preds = %lor.lhs.false78
  %call1.i181 = call ptr @cli_strdup(ptr noundef %rs2.1) #18
  store ptr %call1.i181, ptr %call.i178, align 8
  %cmp2.i182 = icmp eq ptr %call1.i181, null
  br i1 %cmp2.i182, label %if.then82, label %push.exit186

push.exit186:                                     ; preds = %if.end.i180
  %next.i184 = getelementptr inbounds %struct.pstr_list, ptr %call.i178, i64 0, i32 1
  store ptr %call.i169, ptr %next.i184, align 8
  br label %if.end85

if.then82:                                        ; preds = %if.end.i180, %lor.lhs.false78, %if.end.i171, %if.then74
  call void @free(ptr noundef %call1) #18
  call void @free(ptr noundef %call5) #18
  br label %cleanup

if.end85:                                         ; preds = %pop.exit147, %push.exit186, %lor.lhs.false68, %compare.exit
  %rs2.1211 = phi ptr [ %rs2.1, %compare.exit ], [ %rs2.1, %push.exit186 ], [ %rs2.1, %lor.lhs.false68 ], [ %rs2.0228, %pop.exit147 ]
  %rs1.1210 = phi ptr [ %rs1.1, %compare.exit ], [ %rs1.1, %push.exit186 ], [ %rs1.1, %lor.lhs.false68 ], [ %rs1.0227, %pop.exit147 ]
  %top.10 = phi ptr [ %top.4, %compare.exit ], [ %call.i178, %push.exit186 ], [ %top.7, %lor.lhs.false68 ], [ %top.4, %pop.exit147 ]
  %score.1 = phi i32 [ %score.0229, %compare.exit ], [ %add33, %push.exit186 ], [ %add33, %lor.lhs.false68 ], [ %score.0229, %pop.exit147 ]
...
cond.true:                                        ; preds = %while.end
  ...
  %18 = trunc i64 %div to i32
  br label %cleanup

cleanup:                                          ; preds = %cond.true, %while.end, %if.end, %entry, %if.then82, %if.then58, %if.then20, %if.then13, %if.then7
  %retval.0 = phi i32 [ -2, %if.then7 ], [ -5, %if.then13 ], [ -2, %if.then20 ], [ -2, %if.then58 ], [ -2, %if.then82 ], [ 100, %entry ], [ -2, %if.end ], [ %18, %cond.true ], [ 0, %while.end ]
...
if.end3:                                          ; preds = %if.then1, %if.end
  %call = tail call ptr @cli_strdup(ptr noundef nonnull %subtype.addr.0) #18
  store ptr %call, ptr %mimeSubtype, align 8
  ret void
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local nonnull ptr @messageGetMimeSubtype(ptr nocapture noundef readonly %m) local_unnamed_addr #7 {
entry:
  %mimeSubtype = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 3
  %0 = load ptr, ptr %mimeSubtype, align 8
  %tobool.not = icmp eq ptr %0, null
...
entry:
  %mimeDispositionType = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 6
  %0 = load ptr, ptr %mimeDispositionType, align 8
  %tobool.not = icmp eq ptr %0, null
  br i1 %tobool.not, label %if.end, label %if.then
...
while.cond.preheader:                             ; preds = %if.end
  %1 = load i8, ptr %disptype, align 1
...
if.then2:                                         ; preds = %if.end
  store ptr null, ptr %mimeDispositionType, align 8
  br label %if.end20
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local nonnull ptr @messageGetDispositionType(ptr nocapture noundef readonly %m) local_unnamed_addr #7 {
entry:
  %mimeDispositionType = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 6
  %0 = load ptr, ptr %mimeDispositionType, align 8
  %tobool.not = icmp eq ptr %0, null
...
while.cond:                                       ; preds = %while.cond, %while.cond.preheader
  ...
  %1 = load i8, ptr %arg.addr.0, align 1
  %idxprom = sext i8 %1 to i64
  %arrayidx = getelementptr inbounds i16, ptr %0, i64 %idxprom
  %2 = load i16, ptr %arrayidx, align 2
  %3 = and i16 %2, 8192
...
for.inc:                                          ; preds = %if.else
  ...
  br i1 %exitcond.not, label %if.then30, label %for.body
...
if.then30:                                        ; preds = %for.inc, %for.end
  ...
  store i32 %inc32, ptr %numberOfArguments, align 8
  %mimeArguments33 = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 5
  %8 = load ptr, ptr %mimeArguments33, align 8
...
cleanup.thread:                                   ; preds = %if.then30
  %9 = load i32, ptr %numberOfArguments, align 8
  %dec = add nsw i32 %9, -1
  store i32 %dec, ptr %numberOfArguments, align 8
  br label %cleanup63

cleanup:                                          ; preds = %if.then30
  store ptr %call36, ptr %mimeArguments33, align 8
  br label %if.end43
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %next.gep125, align 1
  %15 = getelementptr i8, ptr %next.gep125, i64 16
  %wide.load127 = load <16 x i8>, ptr %15, align 1
  store <16 x i8> %wide.load, ptr %next.gep, align 1
  %16 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load127, ptr %16, align 1
...
while.body.i.prol:                                ; preds = %while.body.i.preheader128, %while.body.i.prol
  ...
  %21 = load i8, ptr %in.addr.0153.i.prol, align 1
  %incdec.ptr17.i.prol = getelementptr inbounds i8, ptr %out.0154.i.prol, i64 1
  store i8 %21, ptr %out.0154.i.prol, align 1
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  %23 = load i8, ptr %in.addr.0153.i, align 1
  %incdec.ptr17.i = getelementptr inbounds i8, ptr %out.0154.i, i64 1
  store i8 %23, ptr %out.0154.i, align 1
  ...
  store i8 %24, ptr %incdec.ptr17.i, align 1
  ...
  store i8 %25, ptr %incdec.ptr17.i.1, align 1
...
while.end.i:                                      ; preds = %while.body.i.prol.loopexit, %while.body.i, %middle.block, %while.cond.preheader.i
  ...
  store i8 61, ptr %out.0.lcssa.i, align 1
...
while.cond19.i:                                   ; preds = %while.cond19.i, %while.end.i
  ...
  %31 = load i8, ptr %ptr.1.i, align 1
  %cmp21.not.i = icmp eq i8 %31, 61
  br i1 %cmp21.not.i, label %while.cond25.preheader.i, label %while.cond19.i
...
while.cond25.i:                                   ; preds = %sw.epilog.i, %while.cond25.preheader.i
  ...
  %32 = load i8, ptr %ptr.2.i, align 1
...
if.then42.i:                                      ; preds = %sw.bb38.i
  ...
  %33 = load i8, ptr %incdec.ptr43.i, align 1
...
hex.exit.i:                                       ; preds = %if.end26.i.i, %if.then21.i.i, %if.then9.i.i, %if.then.i.i
  ...
  %39 = load i8, ptr %incdec.ptr53.i, align 1
...
if.then61.i:                                      ; preds = %hex.exit.i, %hex.exit.i
  ...
  store i8 %retval.0.i.i, ptr %out.1.i, align 1
  br label %sw.epilogthread-pre-split.i
...
if.end63.i:                                       ; preds = %hex.exit.i
  ...
  %41 = load i16, ptr %arrayidx.i132.i, align 2
  %42 = and i16 %41, 2048
  %tobool.not.i133.i = icmp eq i16 %42, 0
  br i1 %tobool.not.i133.i, label %if.end.i137.i, label %if.then.i134.i

if.then.i134.i:                                   ; preds = %if.end63.i
  %sub.i135.i = add i8 %39, -48
  br label %hex.exit146.i

if.end.i137.i:                                    ; preds = %if.end63.i
  %43 = add i8 %39, -65
  %or.cond.i138.i = icmp ult i8 %43, 6
  br i1 %or.cond.i138.i, label %if.then9.i144.i, label %if.end13.i139.i

if.then9.i144.i:                                  ; preds = %if.end.i137.i
  %add.i145.i = add nsw i8 %39, -55
  br label %hex.exit146.i

if.end13.i139.i:                                  ; preds = %if.end.i137.i
  %44 = add i8 %39, -97
  %or.cond28.i140.i = icmp ult i8 %44, 6
  br i1 %or.cond28.i140.i, label %if.then21.i142.i, label %if.end26.i141.i

if.then21.i142.i:                                 ; preds = %if.end13.i139.i
  %add24.i143.i = add nsw i8 %39, -87
  br label %hex.exit146.i

if.end26.i141.i:                                  ; preds = %if.end13.i139.i
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.97, i32 noundef %conv.i130.i) #18
  br label %hex.exit146.i

hex.exit146.i:                                    ; preds = %if.end26.i141.i, %if.then21.i142.i, %if.then9.i144.i, %if.then.i134.i
  %retval.0.i136.i = phi i8 [ %sub.i135.i, %if.then.i134.i ], [ %add.i145.i, %if.then9.i144.i ], [ %add24.i143.i, %if.then21.i142.i ], [ 61, %if.end26.i141.i ]
  %add69.i = add i8 %retval.0.i136.i, %shl.i
  %incdec.ptr71.i = getelementptr inbounds i8, ptr %out.1.i, i64 1
  store i8 %add69.i, ptr %out.1.i, align 1
  br label %sw.epilogthread-pre-split.i

if.else72.i:                                      ; preds = %sw.bb38.i
  %incdec.ptr73.i = getelementptr inbounds i8, ptr %out.1.i, i64 1
  store i8 %32, ptr %out.1.i, align 1
  br label %sw.epilogthread-pre-split.i
...
sw.epilogthread-pre-split.i:                      ; preds = %if.else72.i, %hex.exit146.i, %if.then61.i, %sw.bb32.i, %sw.bb.i
  ...
  %.pr.i = load i8, ptr %ptr.4.ph.i, align 1
...
sw.epilog.i:                                      ; preds = %sw.epilogthread-pre-split.i, %if.then42.i, %if.then42.i, %while.body26.i
  ...
  br i1 %cmp77.i, label %while.end81.i, label %while.cond25.i
...
if.then84.i:                                      ; preds = %while.end81.i
  ...
  tail call void (ptr, ...) @cli_warnmsg(ptr noundef nonnull @.str.113, ptr noundef nonnull %in.addr.0.lcssa.i) #18
  %call85.i = tail call ptr @cli_strdup(ptr noundef nonnull @.str.8) #18
  br label %rfc2231.exit

if.end86.i:                                       ; preds = %while.end81.i
  store i8 0, ptr %out.4.i, align 1
...
while.cond16:                                     ; preds = %while.cond16.preheader, %while.cond16
  ...
  %5 = load i8, ptr %string.1, align 1
  ...
  br i1 %or.cond190, label %if.end34, label %while.cond16
...
if.end56:                                         ; preds = %if.else, %if.then54
  ...
  %call57 = tail call fastcc i32 @usefulArg(ptr noundef nonnull %call39)
...
while.cond88.preheader:                           ; preds = %if.else82
  %8 = load i8, ptr %incdec.ptr29, align 1
...
land.rhs92:                                       ; preds = %while.cond88.preheader, %while.body101
  ...
  %10 = load i16, ptr %arrayidx96, align 2
  %11 = and i16 %10, 8192
...
while.body101:                                    ; preds = %land.rhs92
  ...
  %12 = load i8, ptr %incdec.ptr102, align 1
  %cmp90.not = icmp eq i8 %12, 0
  br i1 %cmp90.not, label %while.end103, label %land.rhs92
...
entry:
  ...
  %numberOfArguments = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 4
  %0 = load i32, ptr %numberOfArguments, align 8
  %cmp77 = icmp sgt i32 %0, 0
  br i1 %cmp77, label %lor.lhs.false.lr.ph, label %cleanup46

lor.lhs.false.lr.ph:                              ; preds = %entry
  %1 = getelementptr i8, ptr %m, i64 40
  %m.val70 = load ptr, ptr %1, align 8
...
for.inc:                                          ; preds = %lor.lhs.false, %if.end
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %cleanup46, label %lor.lhs.false
...
lor.lhs.false.i:                                  ; preds = %for.inc.i, %lor.lhs.false.lr.ph.i
  ...
  %3 = load i8, ptr %spec.select.i.i, align 1
...
if.then16.i:                                      ; preds = %while.end.i
  ...
  %.pr.pre = load i32, ptr %numberOfArguments.i, align 8
  br label %lor.rhs

for.inc.i:                                        ; preds = %if.end.i, %lor.lhs.false.i
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %lor.rhs, label %lor.lhs.false.i

lor.rhs:                                          ; preds = %for.inc.i, %if.then16.i
  %.pr = phi i32 [ %.pr.pre, %if.then16.i ], [ %0, %for.inc.i ]
  %cmp43.i6 = icmp sgt i32 %.pr, 0
  br i1 %cmp43.i6, label %lor.lhs.false.lr.ph.i8, label %lor.end

lor.lhs.false.lr.ph.i8:                           ; preds = %lor.rhs
  %m.val36.i9 = load ptr, ptr %1, align 8
  %wide.trip.count.i10 = zext i32 %.pr to i64
  br label %lor.lhs.false.i11

lor.lhs.false.i11:                                ; preds = %for.inc.i20, %lor.lhs.false.lr.ph.i8
  %indvars.iv.i12 = phi i64 [ 0, %lor.lhs.false.lr.ph.i8 ], [ %indvars.iv.next.i21, %for.inc.i20 ]
  %arrayidx.i.i13 = getelementptr inbounds ptr, ptr %m.val36.i9, i64 %indvars.iv.i12
  %8 = load ptr, ptr %arrayidx.i.i13, align 8
  %tobool.not.i.i14 = icmp eq ptr %8, null
  %spec.select.i.i15 = select i1 %tobool.not.i.i14, ptr @.str.8, ptr %8
  %9 = load i8, ptr %spec.select.i.i15, align 1
  %cmp3.i16 = icmp eq i8 %9, 0
  br i1 %cmp3.i16, label %for.inc.i20, label %if.end.i17

if.end.i17:                                       ; preds = %lor.lhs.false.i11
  %call5.i18 = tail call i32 @strncasecmp(ptr noundef nonnull %spec.select.i.i15, ptr noundef nonnull @.str.23, i64 noundef 4) #20
  %cmp6.i19 = icmp eq i32 %call5.i18, 0
  br i1 %cmp6.i19, label %if.then8.i23, label %for.inc.i20

if.then8.i23:                                     ; preds = %if.end.i17
  %arrayidx.i24 = getelementptr inbounds i8, ptr %spec.select.i.i15, i64 4
  %call9.i25 = tail call ptr @__ctype_b_loc() #19
  %10 = load ptr, ptr %call9.i25, align 8
  br label %while.cond.i26

while.cond.i26:                                   ; preds = %while.cond.i26, %if.then8.i23
  %ptr.0.i27 = phi ptr [ %arrayidx.i24, %if.then8.i23 ], [ %incdec.ptr.i31, %while.cond.i26 ]
  %11 = load i8, ptr %ptr.0.i27, align 1
  %idxprom.i28 = sext i8 %11 to i64
  %arrayidx11.i29 = getelementptr inbounds i16, ptr %10, i64 %idxprom.i28
  %12 = load i16, ptr %arrayidx11.i29, align 2
  %13 = and i16 %12, 8192
  %tobool.not.i30 = icmp eq i16 %13, 0
  %incdec.ptr.i31 = getelementptr inbounds i8, ptr %ptr.0.i27, i64 1
  br i1 %tobool.not.i30, label %while.end.i32, label %while.cond.i26

while.end.i32:                                    ; preds = %while.cond.i26
  %cmp14.not.i33 = icmp eq i8 %11, 61
  br i1 %cmp14.not.i33, label %lor.end, label %if.then16.i34

if.then16.i34:                                    ; preds = %while.end.i32
  tail call void (ptr, ...) @cli_warnmsg(ptr noundef nonnull @.str.57, ptr noundef nonnull @.str.23, ptr noundef nonnull %spec.select.i.i15) #18
  br label %lor.end

for.inc.i20:                                      ; preds = %if.end.i17, %lor.lhs.false.i11
  %indvars.iv.next.i21 = add nuw nsw i64 %indvars.iv.i12, 1
  %exitcond.not.i22 = icmp eq i64 %indvars.iv.next.i21, %wide.trip.count.i10
  br i1 %exitcond.not.i22, label %lor.end, label %lor.lhs.false.i11

lor.end:                                          ; preds = %for.inc.i20, %if.then16.i34, %while.end.i32, %lor.rhs, %entry, %while.end.i
  %lor.ext = phi i32 [ 1, %while.end.i ], [ 1, %while.end.i32 ], [ 0, %if.then16.i34 ], [ 0, %lor.rhs ], [ 0, %entry ], [ 0, %for.inc.i20 ]
  ret i32 %lor.ext
}
...
while.cond:                                       ; preds = %while.cond, %entry
  ...
  %1 = load i8, ptr %enctype.addr.0, align 1
  %idxprom = sext i8 %1 to i64
  %arrayidx = getelementptr inbounds i16, ptr %0, i64 %idxprom
  %2 = load i16, ptr %arrayidx, align 2
  %3 = and i16 %2, 1
...
for.body:                                         ; preds = %for.cond.preheader, %for.inc85
  %4 = phi ptr [ @.str.58, %for.cond.preheader ], [ %16, %for.inc85 ]
  %e.0160 = phi ptr [ @encoding_map, %for.cond.preheader ], [ %incdec.ptr86, %for.inc85 ]
  %highestSimil.0159 = phi i32 [ 0, %for.cond.preheader ], [ %highestSimil.2.ph, %for.inc85 ]
  %closest.0158 = phi ptr [ null, %for.cond.preheader ], [ %closest.2.ph, %for.inc85 ]
  %5 = load ptr, ptr %call10, align 8
  %6 = load i8, ptr %call5166, align 1
...
for.cond43.preheader:                             ; preds = %if.end37
  %10 = load i32, ptr %numberOfEncTypes, align 8
  %cmp44161 = icmp sgt i32 %10, 0
  %.pre = load ptr, ptr %encodingTypes, align 8
  br i1 %cmp44161, label %for.body46.lr.ph, label %if.end59

for.body46.lr.ph:                                 ; preds = %for.cond43.preheader
  %type49 = getelementptr inbounds %struct.encoding_map, ptr %e.0160, i64 0, i32 1
  %11 = load i32, ptr %type49, align 8
...
if.end59:                                         ; preds = %for.cond43, %for.cond43.preheader
  ...
  %call63 = tail call ptr @cli_realloc(ptr noundef %.pre, i64 noundef %mul) #18
  %cmp64 = icmp eq ptr %call63, null
  br i1 %cmp64, label %if.end97, label %if.end67

if.end67:                                         ; preds = %if.end59
  store ptr %call63, ptr %encodingTypes, align 8
  %type69 = getelementptr inbounds %struct.encoding_map, ptr %e.0160, i64 0, i32 1
  %13 = load i32, ptr %type69, align 8
  %14 = load i32, ptr %numberOfEncTypes, align 8
  %inc72 = add nsw i32 %14, 1
  store i32 %inc72, ptr %numberOfEncTypes, align 8
  %idxprom73 = sext i32 %14 to i64
  %arrayidx74 = getelementptr inbounds i32, ptr %call63, i64 %idxprom73
  store i32 %13, ptr %arrayidx74, align 4
  %15 = load i32, ptr %numberOfEncTypes, align 8
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.31, i32 noundef %15, ptr noundef nonnull %call5166) #18
  br label %if.end97

if.else:                                          ; preds = %if.end37
  %cmp77 = icmp sgt i32 %call39, %highestSimil.0159
  %spec.select = select i1 %cmp77, ptr %4, ptr %closest.0158
  %spec.select150 = tail call i32 @llvm.smax.i32(i32 %call39, i32 %highestSimil.0159)
  br label %for.inc85

for.inc85:                                        ; preds = %if.else, %for.body, %if.end31
  %closest.2.ph = phi ptr [ %closest.0158, %if.end31 ], [ %closest.0158, %for.body ], [ %spec.select, %if.else ]
  %highestSimil.2.ph = phi i32 [ %highestSimil.0159, %if.end31 ], [ %highestSimil.0159, %for.body ], [ %spec.select150, %if.else ]
  %incdec.ptr86 = getelementptr inbounds %struct.encoding_map, ptr %e.0160, i64 1
  %16 = load ptr, ptr %incdec.ptr86, align 8
  %tobool9.not = icmp eq ptr %16, null
  br i1 %tobool9.not, label %if.then91.loopexit, label %for.body

if.then91.loopexit:                               ; preds = %for.inc85
  %cmp92 = icmp sgt i32 %highestSimil.2.ph, 49
  br i1 %cmp92, label %if.then94, label %if.else95

if.then94:                                        ; preds = %if.then91.loopexit
...
if.else95:                                        ; preds = %if.then91.loopexit
...
if.end97:                                         ; preds = %if.then58, %if.end67, %if.end59, %if.then94, %if.else95
  ...
  br i1 %cmp6.not, label %while.end98, label %for.cond.preheader
...
entry:
  %numberOfEncTypes = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 2
  %0 = load i32, ptr %numberOfEncTypes, align 8
  %cmp = icmp eq i32 %0, 0
  br i1 %cmp, label %return, label %if.end

if.end:                                           ; preds = %entry
  %encodingTypes = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 1
  %1 = load ptr, ptr %encodingTypes, align 8
...
entry:
  %body_first = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 7
  %0 = load ptr, ptr %body_first, align 8
  %cmp = icmp eq ptr %0, null
  %call = tail call ptr @cli_malloc(i64 noundef 16) #18
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  store ptr %call, ptr %body_first, align 8
...
if.end10:                                         ; preds = %if.end
  ...
  store ptr null, ptr %t_next12, align 8
...
land.lhs.true.if.else18_crit_edge:                ; preds = %land.lhs.true
  %.pre = load ptr, ptr %body_last7, align 8
  br label %if.else18

if.then15:                                        ; preds = %land.lhs.true
  %call16 = tail call ptr @lineLink(ptr noundef nonnull %line) #18
  %2 = load ptr, ptr %body_last7, align 8
  store ptr %call16, ptr %2, align 8
...
entry:
  %body_last = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 8
  %0 = load ptr, ptr %body_last, align 8
...
if.end39.sink.split:                              ; preds = %land.lhs.true31, %land.lhs.true23, %land.lhs.true12, %land.lhs.true3
  ...
  %6 = load ptr, ptr %body_last, align 8
  store ptr %6, ptr %bounce.sink, align 8
  br label %if.end39
...
for.cond.preheader:                               ; preds = %if.then
  %or.cond152 = icmp sgt i8 %0, 0
  br i1 %or.cond152, label %lor.lhs.false.lr.ph, label %if.end15
...
for.cond:                                         ; preds = %lor.lhs.false
  %incdec.ptr = getelementptr inbounds i8, ptr %p.0153, i64 1
  %2 = load i8, ptr %incdec.ptr, align 1
  %.fr = freeze i8 %2
  %or.cond = icmp sgt i8 %.fr, 0
  br i1 %or.cond, label %lor.lhs.false, label %for.end.loopexit

lor.lhs.false:                                    ; preds = %lor.lhs.false.lr.ph, %for.cond
  %3 = phi i8 [ %0, %lor.lhs.false.lr.ph ], [ %.fr, %for.cond ]
  %p.0153 = phi ptr [ %data, %lor.lhs.false.lr.ph ], [ %incdec.ptr, %for.cond ]
...
for.end.loopexit:                                 ; preds = %for.cond
  %6 = icmp eq i8 %.fr, 0
  br i1 %6, label %if.end15.thread, label %if.end15

if.end15:                                         ; preds = %lor.lhs.false, %for.cond.preheader, %for.end.loopexit, %if.then, %entry
  %data.addr.1 = phi ptr [ null, %entry ], [ null, %if.then ], [ %data, %for.cond.preheader ], [ %data, %for.end.loopexit ], [ %data, %lor.lhs.false ]
  %body_first = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 7
  %7 = load ptr, ptr %body_first, align 8
  %cmp16 = icmp eq ptr %7, null
  br i1 %cmp16, label %if.then18, label %if.else21

if.end15.thread:                                  ; preds = %for.end.loopexit
  %body_first158 = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 7
  %8 = load ptr, ptr %body_first158, align 8
  %cmp16159 = icmp eq ptr %8, null
  br i1 %cmp16159, label %if.then18, label %if.end33

if.then18:                                        ; preds = %if.end15.thread, %if.end15
  %body_first163 = phi ptr [ %body_first158, %if.end15.thread ], [ %body_first, %if.end15 ]
  %data.addr.1162 = phi ptr [ @.str.36, %if.end15.thread ], [ %data.addr.1, %if.end15 ]
  %call19 = tail call ptr @cli_malloc(i64 noundef 16) #18
  store ptr %call19, ptr %body_first163, align 8
  %body_last = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 8
  store ptr %call19, ptr %body_last, align 8
  br label %if.end70
...
land.lhs.true:                                    ; preds = %if.else21
  ...
  %9 = load ptr, ptr %body_last24, align 8
...
if.end33:                                         ; preds = %if.end15.thread, %if.then27, %land.lhs.true, %if.else21
  %cmp22167 = phi i1 [ true, %if.then27 ], [ true, %land.lhs.true ], [ false, %if.else21 ], [ false, %if.end15.thread ]
  %data.addr.1161166 = phi ptr [ null, %if.then27 ], [ null, %land.lhs.true ], [ %data.addr.1, %if.else21 ], [ @.str.36, %if.end15.thread ]
  %call34 = tail call ptr @cli_malloc(i64 noundef 16) #18
  %body_last35 = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 8
  %12 = load ptr, ptr %body_last35, align 8
  %t_next = getelementptr inbounds %struct.text, ptr %12, i64 0, i32 1
  store ptr %call34, ptr %t_next, align 8
...
if.then40:                                        ; preds = %if.end33
  ...
  %13 = load ptr, ptr %body_last35, align 8
  %t_next43 = getelementptr inbounds %struct.text, ptr %13, i64 0, i32 1
  store ptr %call41, ptr %t_next43, align 8
...
if.end50:                                         ; preds = %if.then40, %if.end33
  ...
  br i1 %cmp22167, label %if.end66, label %land.lhs.true52
...
land.lhs.true56:                                  ; preds = %land.lhs.true52
  ...
  %call60 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %data.addr.1161166, ptr noundef nonnull dereferenceable(1) %call59) #20
  %cmp61 = icmp eq i32 %call60, 0
  %.pre = load ptr, ptr %body_last35, align 8
...
if.end66:                                         ; preds = %if.then63, %land.lhs.true56, %land.lhs.true52, %if.end50
  %17 = phi ptr [ %.pre, %if.then63 ], [ %.pre, %land.lhs.true56 ], [ %14, %land.lhs.true52 ], [ %14, %if.end50 ]
  %repeat.0 = phi ptr [ %16, %if.then63 ], [ null, %land.lhs.true56 ], [ null, %land.lhs.true52 ], [ null, %if.end50 ]
  %t_next68 = getelementptr inbounds %struct.text, ptr %17, i64 0, i32 1
  %18 = load ptr, ptr %t_next68, align 8
  store ptr %18, ptr %body_last35, align 8
  br label %if.end70

if.end70:                                         ; preds = %if.end66, %if.then18
  %data.addr.1160 = phi ptr [ %data.addr.1162, %if.then18 ], [ %data.addr.1161166, %if.end66 ]
  %19 = phi ptr [ %call19, %if.then18 ], [ %18, %if.end66 ]
  %repeat.1 = phi ptr [ null, %if.then18 ], [ %repeat.0, %if.end66 ]
  %body_last71 = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 8
  %cmp72 = icmp eq ptr %19, null
...
if.end75:                                         ; preds = %if.end70
  %t_next77 = getelementptr inbounds %struct.text, ptr %19, i64 0, i32 1
  store ptr null, ptr %t_next77, align 8
  %tobool78.not = icmp eq ptr %data.addr.1160, null
  br i1 %tobool78.not, label %if.else108, label %land.lhs.true79

land.lhs.true79:                                  ; preds = %if.end75
  %20 = load i8, ptr %data.addr.1160, align 1
...
if.then84:                                        ; preds = %if.then82
  ...
  %21 = load ptr, ptr %body_last71, align 8
  store ptr %call85, ptr %21, align 8
  br label %cleanup

if.else88:                                        ; preds = %if.then82
  %call89 = tail call ptr @lineCreate(ptr noundef nonnull %data.addr.1160) #18
  %22 = load ptr, ptr %body_last71, align 8
  store ptr %call89, ptr %22, align 8
  %cmp94 = icmp eq ptr %call89, null
  br i1 %cmp94, label %if.then96, label %if.end106

if.then96:                                        ; preds = %if.else88
  tail call fastcc void @messageDedup(ptr noundef nonnull %m)
  %call97 = tail call ptr @lineCreate(ptr noundef nonnull %data.addr.1160) #18
  %23 = load ptr, ptr %body_last71, align 8
  store ptr %call97, ptr %23, align 8
...
entry:
  ...
  %t1.0142 = load ptr, ptr %body_first2, align 8
  %tobool3.not143 = icmp eq ptr %t1.0142, null
  br i1 %tobool3.not143, label %for.end77, label %if.end.lr.ph
...
if.end:                                           ; preds = %if.end.lr.ph, %for.inc75
  %t1.0145 = phi ptr [ %t1.0142, %if.end.lr.ph ], [ %t1.0, %for.inc75 ]
  %saved.0144 = phi i64 [ 0, %if.end.lr.ph ], [ %saved.6.ph, %for.inc75 ]
  %0 = load ptr, ptr %t1.0145, align 8
...
if.end14:                                         ; preds = %if.end10
  %2 = load ptr, ptr %encoding, align 8
  %cmp15 = icmp eq ptr %t1.0145, %2
  br i1 %cmp15, label %for.inc75, label %if.end18

if.end18:                                         ; preds = %if.end14
  %3 = load ptr, ptr %bounce, align 8
  %cmp19 = icmp eq ptr %t1.0145, %3
  br i1 %cmp19, label %for.inc75, label %if.end22

if.end22:                                         ; preds = %if.end18
  %4 = load ptr, ptr %binhex, align 8
  %cmp23 = icmp eq ptr %t1.0145, %4
  br i1 %cmp23, label %for.inc75, label %if.end26

if.end26:                                         ; preds = %if.end22
  %5 = load ptr, ptr %yenc, align 8
  %cmp27 = icmp eq ptr %t1.0145, %5
  br i1 %cmp27, label %for.inc75, label %for.cond31.preheader

for.cond31.preheader:                             ; preds = %if.end26
  %t2.0.in135 = getelementptr inbounds %struct.text, ptr %t1.0145, i64 0, i32 1
  %t2.0136 = load ptr, ptr %t2.0.in135, align 8
  %tobool32.not137 = icmp eq ptr %t2.0136, null
  br i1 %tobool32.not137, label %for.inc75, label %for.body33

for.body33:                                       ; preds = %for.cond31.preheader, %for.inc
  %t2.0140 = phi ptr [ %t2.0, %for.inc ], [ %t2.0136, %for.cond31.preheader ]
  %saved.1139 = phi i64 [ %saved.4.ph, %for.inc ], [ %saved.0144, %for.cond31.preheader ]
  %r1.0138 = phi i32 [ %r1.2.ph, %for.inc ], [ %conv, %for.cond31.preheader ]
  %6 = load ptr, ptr %t2.0140, align 8
...
if.then51:                                        ; preds = %if.then47
  ...
  %add = add i64 %saved.1139, 1
  %add53 = add i64 %add, %call52
  br label %if.end54

if.end54:                                         ; preds = %if.then51, %if.then47
  %saved.2 = phi i64 [ %add53, %if.then51 ], [ %saved.1139, %if.then47 ]
  %call55 = tail call ptr @lineLink(ptr noundef nonnull %0) #18
  store ptr %call55, ptr %t2.0140, align 8
  %cmp58 = icmp eq ptr %call55, null
  br i1 %cmp58, label %cleanup69.thread130, label %if.end61

cleanup69.thread130:                              ; preds = %if.end54
  tail call void (ptr, ...) @cli_errmsg(ptr noundef nonnull @.str.106) #18
  br label %cleanup79

if.end61:                                         ; preds = %if.end54
  %inc = add i32 %r1.0138, 1
  %cmp62 = icmp eq i32 %inc, 255
  br i1 %cmp62, label %for.inc75, label %for.inc

for.inc:                                          ; preds = %for.body33, %if.end38, %if.end43, %if.end61
  %r1.2.ph = phi i32 [ %inc, %if.end61 ], [ %r1.0138, %if.end43 ], [ %r1.0138, %if.end38 ], [ %r1.0138, %for.body33 ]
  %saved.4.ph = phi i64 [ %saved.2, %if.end61 ], [ %saved.1139, %if.end43 ], [ %saved.1139, %if.end38 ], [ %saved.1139, %for.body33 ]
  %t2.0.in = getelementptr inbounds %struct.text, ptr %t2.0140, i64 0, i32 1
  %t2.0 = load ptr, ptr %t2.0.in, align 8
  %tobool32.not = icmp eq ptr %t2.0, null
  br i1 %tobool32.not, label %for.inc75, label %for.body33

for.inc75:                                        ; preds = %if.end61, %for.inc, %for.cond31.preheader, %if.end, %if.end6, %if.end10, %if.end14, %if.end18, %if.end22, %if.end26
  %saved.6.ph = phi i64 [ %saved.0144, %if.end26 ], [ %saved.0144, %if.end22 ], [ %saved.0144, %if.end18 ], [ %saved.0144, %if.end14 ], [ %saved.0144, %if.end10 ], [ %saved.0144, %if.end6 ], [ %saved.0144, %if.end ], [ %saved.0144, %for.cond31.preheader ], [ %saved.2, %if.end61 ], [ %saved.4.ph, %for.inc ]
  %t_next76 = getelementptr inbounds %struct.text, ptr %t1.0145, i64 0, i32 1
  %t1.0 = load ptr, ptr %t_next76, align 8
  %tobool3.not = icmp eq ptr %t1.0, null
  %cmp = icmp ugt i64 %saved.6.ph, 99999
  %or.cond = select i1 %tobool3.not, i1 true, i1 %cmp
  br i1 %or.cond, label %for.end77, label %if.end
...
for.end77:                                        ; preds = %for.inc75, %entry
  ...
  store ptr %t1.0.lcssa, ptr %dedupedThisFar, align 8
  br label %cleanup79

cleanup79:                                        ; preds = %cleanup69.thread130, %for.end77
  ret void
}
...
if.then:                                          ; preds = %entry
  ...
  %1 = load ptr, ptr %body_first, align 8
  %cmp.i = icmp eq ptr %1, null
  %call.i = tail call ptr @cli_malloc(i64 noundef 16) #18
  br i1 %cmp.i, label %if.then.i, label %if.else.i

if.then.i:                                        ; preds = %if.then
  store ptr %call.i, ptr %body_first, align 8
...
if.end10.i:                                       ; preds = %if.end.i
  ...
  store ptr null, ptr %t_next12.i, align 8
...
land.lhs.true.if.else18_crit_edge.i:              ; preds = %land.lhs.true.i
  %.pre.i = load ptr, ptr %body_last7.i, align 8
  br label %if.else18.i

if.then15.i:                                      ; preds = %land.lhs.true.i
  %call16.i = tail call ptr @lineLink(ptr noundef nonnull %call) #18
  %3 = load ptr, ptr %body_last7.i, align 8
  store ptr %call16.i, ptr %3, align 8
  tail call fastcc void @messageIsEncoding(ptr noundef nonnull %m)
  br label %cleanup
...
if.end:                                           ; preds = %entry
  ...
  store ptr %call3, ptr %body_first, align 8
  %cmp6 = icmp eq ptr %call3, null
  br i1 %cmp6, label %if.then7, label %if.end9

if.then7:                                         ; preds = %if.end
  store ptr %0, ptr %body_first, align 8
  br label %cleanup

if.end9:                                          ; preds = %if.end
  %t_next = getelementptr inbounds %struct.text, ptr %call3, i64 0, i32 1
  store ptr %0, ptr %t_next, align 8
  %tobool.not = icmp eq ptr %data, null
  %cond = select i1 %tobool.not, ptr @.str.8, ptr %data
  %call11 = tail call ptr @lineCreate(ptr noundef nonnull %cond) #18
  %5 = load ptr, ptr %body_first, align 8
...
for.end:                                          ; preds = %for.cond
  ...
  %4 = load ptr, ptr %body_last, align 8
  %body_last11 = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 8
  store ptr %4, ptr %body_last11, align 8
...
if.end47:                                         ; preds = %cleanup24, %if.else36, %if.else, %if.then42
  ...
  %13 = load ptr, ptr %t_next4998, align 8
...
while.body:                                       ; preds = %if.end47, %if.end58
  ...
  store ptr %14, ptr %body_last48, align 8
  %15 = load ptr, ptr %14, align 8
...
if.then57:                                        ; preds = %while.body
  tail call fastcc void @messageIsEncoding(ptr noundef nonnull %m)
  %.pre = load ptr, ptr %body_last48, align 8
  br label %if.end58
...
if.end58:                                         ; preds = %if.then57, %while.body
  ...
  %17 = load ptr, ptr %t_next49, align 8
  %tobool50.not = icmp eq ptr %17, null
  br i1 %tobool50.not, label %cleanup59, label %while.body
...
entry:
  ...
  %0 = load i32, ptr %base64chars, align 4
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.40, i32 noundef %0) #18
  %1 = load i32, ptr %base64chars, align 4
  %tobool.not = icmp eq i32 %1, 0
  br i1 %tobool.not, label %return, label %if.then

if.then:                                          ; preds = %entry
  %call = tail call fastcc ptr @decode(ptr noundef nonnull %m, ptr noundef null, ptr noundef %buf, ptr noundef nonnull @base64, i1 noundef zeroext false)
  store i32 0, ptr %base64chars, align 4
  br label %return
...
; Function Attrs: nounwind uwtable
define internal fastcc ptr @decode(ptr nocapture noundef %m, ptr noundef readonly %in, ptr noundef writeonly %out, ptr nocapture noundef readonly %decoder, i1 noundef zeroext %isFast) unnamed_addr #0 {
entry:
  %base64chars = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 13
  %0 = load i32, ptr %base64chars, align 4
...
sw.epilog.thread:                                 ; preds = %sw.bb1, %entry
  ...
  %3 = load i8, ptr %base64_1, align 8
  br label %if.else
...
while.cond.preheader:                             ; preds = %sw.epilog
  ...
  %tobool3.not402 = icmp eq i8 %4, 0
  br i1 %tobool3.not402, label %cleanup229, label %while.body

while.body:                                       ; preds = %while.cond.preheader, %while.body
  %5 = phi i8 [ %10, %while.body ], [ %4, %while.cond.preheader ]
  %out.addr.0404 = phi ptr [ %incdec.ptr27, %while.body ], [ %out, %while.cond.preheader ]
  %in.addr.0403 = phi ptr [ %incdec.ptr11, %while.body ], [ %in, %while.cond.preheader ]
  %incdec.ptr = getelementptr inbounds i8, ptr %in.addr.0403, i64 1
  %call = tail call zeroext i8 %decoder(i8 noundef signext %5) #18
  %incdec.ptr4 = getelementptr inbounds i8, ptr %in.addr.0403, i64 2
  %6 = load i8, ptr %incdec.ptr, align 1
  %call5 = tail call zeroext i8 %decoder(i8 noundef signext %6) #18
  %incdec.ptr6 = getelementptr inbounds i8, ptr %in.addr.0403, i64 3
  %7 = load i8, ptr %incdec.ptr4, align 1
  %call7 = tail call zeroext i8 %decoder(i8 noundef signext %7) #18
  %shl = shl i8 %call, 2
  %shr = lshr i8 %call5, 4
  %and = and i8 %shr, 3
  %or = or i8 %and, %shl
  %incdec.ptr10 = getelementptr inbounds i8, ptr %out.addr.0404, i64 1
  store i8 %or, ptr %out.addr.0404, align 1
  %incdec.ptr11 = getelementptr inbounds i8, ptr %in.addr.0403, i64 4
  %8 = load i8, ptr %incdec.ptr6, align 1
  %call12 = tail call zeroext i8 %decoder(i8 noundef signext %8) #18
  %shl14 = shl i8 %call5, 4
  %shr16 = lshr i8 %call7, 2
  %and17 = and i8 %shr16, 15
  %or18 = or i8 %and17, %shl14
  %incdec.ptr20 = getelementptr inbounds i8, ptr %out.addr.0404, i64 2
  store i8 %or18, ptr %incdec.ptr10, align 1
  %shl22 = shl i8 %call7, 6
  %9 = and i8 %call12, 63
  %or25 = or i8 %9, %shl22
  %incdec.ptr27 = getelementptr inbounds i8, ptr %out.addr.0404, i64 3
  store i8 %or25, ptr %incdec.ptr20, align 1
  %10 = load i8, ptr %incdec.ptr11, align 1
  %tobool3.not = icmp eq i8 %10, 0
  br i1 %tobool3.not, label %cleanup229, label %while.body

if.else:                                          ; preds = %sw.epilog.thread, %sw.epilog
  %cb3.2338 = phi i8 [ %cb3.1, %sw.epilog.thread ], [ 0, %sw.epilog ]
  %cb2.1337 = phi i8 [ %cb2.0, %sw.epilog.thread ], [ 0, %sw.epilog ]
  %cb1.0336 = phi i8 [ %3, %sw.epilog.thread ], [ 0, %sw.epilog ]
...
while.cond140.preheader:                          ; preds = %if.else
  ...
  %tobool141.not399 = icmp eq i8 %11, 0
  br i1 %tobool141.not399, label %cleanup229, label %while.body142
...
if.end:                                           ; preds = %if.then29
  ...
  %12 = load ptr, ptr %call35, align 8
  %conv36 = zext i8 %cb1.0336 to i32
  %idxprom = zext i8 %cb1.0336 to i64
  ...
  %conv42 = zext i8 %cb2.1337 to i32
  %idxprom43 = zext i8 %cb2.1337 to i64
  %arrayidx44 = getelementptr inbounds i16, ptr %12, i64 %idxprom43
  %15 = load i16, ptr %arrayidx44, align 2
  %16 = and i16 %15, 8
  %tobool47.not = icmp eq i16 %16, 0
  %cond52 = select i1 %tobool47.not, i32 64, i32 %conv42
  %conv54 = zext i8 %cb3.2338 to i32
  %idxprom55 = zext i8 %cb3.2338 to i64
  %arrayidx56 = getelementptr inbounds i16, ptr %12, i64 %idxprom55
  ...
  %19 = load i32, ptr %base64chars, align 4
  %dec = add nsw i32 %19, -1
  store i32 %dec, ptr %base64chars, align 4
  %tobool67.not = icmp eq i32 %dec, 0
  br i1 %tobool67.not, label %sw.bb132, label %if.then68

if.then68:                                        ; preds = %if.end
  %dec70 = add nsw i32 %19, -2
  store i32 %dec70, ptr %base64chars, align 4
  %tobool72.not = icmp eq i32 %dec70, 0
  br i1 %tobool72.not, label %if.else76, label %sw.bb83

if.else76:                                        ; preds = %if.then68
  %tobool77.not = icmp eq i8 %cb2.1337, 0
  br i1 %tobool77.not, label %sw.bb132, label %sw.bb113

sw.bb83:                                          ; preds = %if.then68
  %dec75 = add nsw i32 %19, -3
  store i32 %dec75, ptr %base64chars, align 4
  %shl85 = shl i8 %cb1.0336, 2
  %shr87 = lshr i8 %cb2.1337, 4
  %and88 = and i8 %shr87, 3
  %or89 = or i8 %shl85, %and88
  %incdec.ptr91 = getelementptr inbounds i8, ptr %out, i64 1
  store i8 %or89, ptr %out, align 1
  %shl93 = shl i8 %cb2.1337, 4
  %shr95 = lshr i8 %cb3.2338, 2
  %and96 = and i8 %shr95, 15
  %or97 = or i8 %shl93, %and96
  %incdec.ptr99 = getelementptr inbounds i8, ptr %out, i64 2
  store i8 %or97, ptr %incdec.ptr91, align 1
  %tobool103.not = icmp eq i8 %cb3.2338, 0
  br i1 %tobool103.not, label %cleanup229, label %if.then104

if.then104:                                       ; preds = %sw.bb83
  %shl106 = shl i8 %cb3.2338, 6
  %incdec.ptr111 = getelementptr inbounds i8, ptr %out, i64 3
  store i8 %shl106, ptr %incdec.ptr99, align 1
  br label %cleanup229

sw.bb113:                                         ; preds = %if.else76
  %shl115 = shl i8 %cb1.0336, 2
  %shr117 = lshr i8 %cb2.1337, 4
  %and118 = and i8 %shr117, 3
  %or119 = or i8 %shl115, %and118
  %incdec.ptr121 = getelementptr inbounds i8, ptr %out, i64 1
  store i8 %or119, ptr %out, align 1
  %20 = and i32 %conv42, 15
  %tobool125.not = icmp eq i32 %20, 0
  br i1 %tobool125.not, label %cleanup229, label %if.then126

if.then126:                                       ; preds = %sw.bb113
  %shl123 = shl i8 %cb2.1337, 4
  %incdec.ptr130 = getelementptr inbounds i8, ptr %out, i64 2
  store i8 %shl123, ptr %incdec.ptr121, align 1
  br label %cleanup229

sw.bb132:                                         ; preds = %if.else76, %if.end
  %shl134 = shl i8 %cb1.0336, 2
  %incdec.ptr136 = getelementptr inbounds i8, ptr %out, i64 1
  store i8 %shl134, ptr %out, align 1
  br label %cleanup229

while.body142:                                    ; preds = %while.cond140.preheader, %cleanup224
  %21 = phi i8 [ %29, %cleanup224 ], [ %11, %while.cond140.preheader ]
  %out.addr.3401 = phi ptr [ %incdec.ptr214, %cleanup224 ], [ %out, %while.cond140.preheader ]
  %in.addr.1400 = phi ptr [ %incdec.ptr186, %cleanup224 ], [ %in, %while.cond140.preheader ]
  %22 = load i32, ptr %base64chars, align 4
  %tobool145.not = icmp eq i32 %22, 0
  br i1 %tobool145.not, label %if.else149, label %if.then146

if.then146:                                       ; preds = %while.body142
  %dec148 = add nsw i32 %22, -1
  store i32 %dec148, ptr %base64chars, align 4
  br label %if.end152

if.else149:                                       ; preds = %while.body142
  %incdec.ptr150 = getelementptr inbounds i8, ptr %in.addr.1400, i64 1
  %call151 = tail call zeroext i8 %decoder(i8 noundef signext %21) #18
  br label %if.end152

if.end152:                                        ; preds = %if.else149, %if.then146
  %in.addr.2 = phi ptr [ %in.addr.1400, %if.then146 ], [ %incdec.ptr150, %if.else149 ]
  %b1.0 = phi i8 [ %cb1.0336, %if.then146 ], [ %call151, %if.else149 ]
  %23 = load i8, ptr %in.addr.2, align 1
  %cmp154 = icmp eq i8 %23, 0
  br i1 %cmp154, label %cleanup224.thread, label %if.else157

if.else157:                                       ; preds = %if.end152
  %24 = load i32, ptr %base64chars, align 4
  %tobool159.not = icmp eq i32 %24, 0
  br i1 %tobool159.not, label %if.else163, label %if.then160

if.then160:                                       ; preds = %if.else157
  %dec162 = add nsw i32 %24, -1
  store i32 %dec162, ptr %base64chars, align 4
  br label %if.end166

if.else163:                                       ; preds = %if.else157
  %incdec.ptr164 = getelementptr inbounds i8, ptr %in.addr.2, i64 1
  %call165 = tail call zeroext i8 %decoder(i8 noundef signext %23) #18
  br label %if.end166

if.end166:                                        ; preds = %if.else163, %if.then160
  %in.addr.3 = phi ptr [ %in.addr.2, %if.then160 ], [ %incdec.ptr164, %if.else163 ]
  %b2.1 = phi i8 [ %cb2.1337, %if.then160 ], [ %call165, %if.else163 ]
  %25 = load i8, ptr %in.addr.3, align 1
  %cmp168 = icmp eq i8 %25, 0
  br i1 %cmp168, label %sw.bb217, label %if.else171

if.else171:                                       ; preds = %if.end166
  %26 = load i32, ptr %base64chars, align 4
  %tobool173.not = icmp eq i32 %26, 0
  br i1 %tobool173.not, label %if.else177, label %if.then174

if.then174:                                       ; preds = %if.else171
  %dec176 = add nsw i32 %26, -1
  store i32 %dec176, ptr %base64chars, align 4
  br label %if.end180

if.else177:                                       ; preds = %if.else171
  %incdec.ptr178 = getelementptr inbounds i8, ptr %in.addr.3, i64 1
  %call179 = tail call zeroext i8 %decoder(i8 noundef signext %25) #18
  br label %if.end180

if.end180:                                        ; preds = %if.else177, %if.then174
  %in.addr.4 = phi ptr [ %in.addr.3, %if.then174 ], [ %incdec.ptr178, %if.else177 ]
  %b3.2 = phi i8 [ %cb3.2338, %if.then174 ], [ %call179, %if.else177 ]
  %27 = load i8, ptr %in.addr.4, align 1
  %cmp182 = icmp eq i8 %27, 0
...
sw.bb215:                                         ; preds = %if.end180
  ...
  store i8 %b3.2, ptr %base64_3216, align 2
  br label %sw.bb217

sw.bb217:                                         ; preds = %if.end166, %sw.bb215
  %nbytes143.0372 = phi i32 [ 3, %sw.bb215 ], [ 2, %if.end166 ]
  %base64_2218 = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 11
  store i8 %b2.1, ptr %base64_2218, align 1
  br label %cleanup224.thread

cleanup224.thread:                                ; preds = %if.end152, %sw.bb217
  %nbytes143.0371 = phi i32 [ %nbytes143.0372, %sw.bb217 ], [ 1, %if.end152 ]
  %base64_1220 = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 10
  store i8 %b1.0, ptr %base64_1220, align 8
  store i32 %nbytes143.0371, ptr %base64chars, align 4
  br label %cleanup229

cleanup224:                                       ; preds = %if.end180
  %incdec.ptr186 = getelementptr inbounds i8, ptr %in.addr.4, i64 1
  %call187 = tail call zeroext i8 %decoder(i8 noundef signext %27) #18
  %shl193 = shl i8 %b1.0, 2
  %shr195 = lshr i8 %b2.1, 4
  %and196 = and i8 %shr195, 3
  %or197 = or i8 %and196, %shl193
  %incdec.ptr199 = getelementptr inbounds i8, ptr %out.addr.3401, i64 1
  store i8 %or197, ptr %out.addr.3401, align 1
  %shl201 = shl i8 %b2.1, 4
  %shr203 = lshr i8 %b3.2, 2
  %and204 = and i8 %shr203, 15
  %or205 = or i8 %and204, %shl201
  %incdec.ptr207 = getelementptr inbounds i8, ptr %out.addr.3401, i64 2
  store i8 %or205, ptr %incdec.ptr199, align 1
  %shl209 = shl i8 %b3.2, 6
  %28 = and i8 %call187, 63
  %or212 = or i8 %28, %shl209
  %incdec.ptr214 = getelementptr inbounds i8, ptr %out.addr.3401, i64 3
  store i8 %or212, ptr %incdec.ptr207, align 1
  %29 = load i8, ptr %incdec.ptr186, align 1
  %tobool141.not = icmp eq i8 %29, 0
  br i1 %tobool141.not, label %cleanup229, label %while.body142

cleanup229:                                       ; preds = %cleanup224, %while.body, %while.cond140.preheader, %while.cond.preheader, %if.then29, %sw.bb113, %if.then126, %if.then104, %sw.bb83, %sw.bb132, %cleanup224.thread
  %retval.1 = phi ptr [ %out.addr.3401, %cleanup224.thread ], [ %incdec.ptr136, %sw.bb132 ], [ %incdec.ptr99, %sw.bb83 ], [ %incdec.ptr111, %if.then104 ], [ %incdec.ptr130, %if.then126 ], [ %incdec.ptr121, %sw.bb113 ], [ %out, %if.then29 ], [ %out, %while.cond.preheader ], [ %out, %while.cond140.preheader ], [ %incdec.ptr27, %while.body ], [ %incdec.ptr214, %cleanup224 ]
  ret ptr %retval.1
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define internal zeroext i8 @base64(i8 noundef signext %c) #12 {
entry:
  %idxprom = zext i8 %c to i64
  %arrayidx = getelementptr inbounds [256 x i8], ptr @base64Table, i64 0, i64 %idxprom
  %0 = load i8, ptr %arrayidx, align 1
  %cmp = icmp eq i8 %0, -1
  %. = select i1 %cmp, i8 63, i8 %0
  ret i8 %.
}
...
entry:
  ...
  %0 = load ptr, ptr %body_first.i.i, align 8
  %cmp.i = icmp eq ptr %0, null
  br i1 %cmp.i, label %messageExport.specialized.2.exit, label %if.end.i

if.end.i:                                         ; preds = %entry
  %call1.i = tail call ptr @fileblobCreate() #18
  %cmp2.i = icmp eq ptr %call1.i, null
  br i1 %cmp2.i, label %messageExport.specialized.2.exit, label %if.end4.i

if.end4.i:                                        ; preds = %if.end.i
  %numberOfEncTypes.i = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 2
  %1 = load i32, ptr %numberOfEncTypes.i, align 8
  ...
  %2 = load ptr, ptr %binhex.i.i, align 8
...
while.cond.i:                                     ; preds = %land.rhs.i, %if.then7.i
  ...
  %3 = load ptr, ptr %t_next.i, align 8
...
land.rhs.i:                                       ; preds = %while.cond.i
  ...
  br i1 %cmp10.i, label %while.cond.i, label %while.end.i

while.end.i:                                      ; preds = %land.rhs.i, %while.cond.i
  %5 = load i32, ptr %numberOfEncTypes.i, align 8
...
land.lhs.true.i:                                  ; preds = %while.end.i
  ...
  %6 = load ptr, ptr %encodingTypes.i, align 8
...
if.then16.i:                                      ; preds = %cond.end.i
  ...
  br label %messageExport.specialized.2.exit
...
if.end21.i:                                       ; preds = %if.end17.i
  ...
  %8 = load i8, ptr %call18.i, align 1
...
if.end31.i:                                       ; preds = %if.then26.i
  ...
  %cmp3299.i = icmp ugt i64 %call22.i, 1
  br i1 %cmp3299.i, label %for.body.i, label %cleanup103.i

for.body.i:                                       ; preds = %if.end31.i, %for.inc.i
  %bytenumber.0102.i = phi i32 [ %bytenumber.2.ph.i, %for.inc.i ], [ 0, %if.end31.i ]
  %newlen.0101.i = phi i64 [ %newlen.2.ph.i, %for.inc.i ], [ 0, %if.end31.i ]
  %l.0100.i = phi i64 [ %inc102.i, %for.inc.i ], [ 1, %if.end31.i ]
  %arrayidx34.i = getelementptr inbounds i8, ptr %call27.i, i64 %l.0100.i
...
if.end63.i:                                       ; preds = %lor.lhs.false55.i
  switch i32 %bytenumber.0102.i, label %for.inc.i [
    i32 0, label %sw.bb.i
...
sw.bb.i:                                          ; preds = %if.end63.i
  %shl.i = shl i8 %10, 2
  %arrayidx68.i = getelementptr inbounds i8, ptr %call18.i, i64 %newlen.0101.i
  store i8 %shl.i, ptr %arrayidx68.i, align 1
  br label %for.inc.i

sw.bb69.i:                                        ; preds = %if.end63.i
  %shr.i = lshr i8 %10, 4
  %and71.i = and i8 %shr.i, 3
  %inc.i = add i64 %newlen.0101.i, 1
  %arrayidx72.i = getelementptr inbounds i8, ptr %call18.i, i64 %newlen.0101.i
  %11 = load i8, ptr %arrayidx72.i, align 1
  %or.i = or i8 %11, %and71.i
  store i8 %or.i, ptr %arrayidx72.i, align 1
  %shl76.i = shl i8 %10, 4
  %arrayidx79.i = getelementptr inbounds i8, ptr %call18.i, i64 %inc.i
  store i8 %shl76.i, ptr %arrayidx79.i, align 1
  br label %for.inc.i

sw.bb80.i:                                        ; preds = %if.end63.i
  %shr82.i = lshr i8 %10, 2
  %and83.i = and i8 %shr82.i, 15
  %inc84.i = add i64 %newlen.0101.i, 1
  %arrayidx85.i = getelementptr inbounds i8, ptr %call18.i, i64 %newlen.0101.i
  %12 = load i8, ptr %arrayidx85.i, align 1
  %or87.i = or i8 %12, %and83.i
  store i8 %or87.i, ptr %arrayidx85.i, align 1
  %shl90.i = shl i8 %10, 6
  %arrayidx93.i = getelementptr inbounds i8, ptr %call18.i, i64 %inc84.i
  store i8 %shl90.i, ptr %arrayidx93.i, align 1
  br label %for.inc.i

sw.bb94.i:                                        ; preds = %if.end63.i
  %and96.i = and i8 %10, 63
  %inc97.i = add i64 %newlen.0101.i, 1
  %arrayidx98.i = getelementptr inbounds i8, ptr %call18.i, i64 %newlen.0101.i
  %13 = load i8, ptr %arrayidx98.i, align 1
  %or100.i = or i8 %13, %and96.i
  store i8 %or100.i, ptr %arrayidx98.i, align 1
  br label %for.inc.i

for.inc.i:                                        ; preds = %sw.bb94.i, %sw.bb80.i, %sw.bb69.i, %sw.bb.i, %if.end63.i, %for.body.i, %for.body.i
  %newlen.2.ph.i = phi i64 [ %newlen.0101.i, %sw.bb.i ], [ %inc.i, %sw.bb69.i ], [ %inc84.i, %sw.bb80.i ], [ %inc97.i, %sw.bb94.i ], [ %newlen.0101.i, %if.end63.i ], [ %newlen.0101.i, %for.body.i ], [ %newlen.0101.i, %for.body.i ]
  %bytenumber.2.ph.i = phi i32 [ 1, %sw.bb.i ], [ 2, %sw.bb69.i ], [ 3, %sw.bb80.i ], [ 0, %sw.bb94.i ], [ %bytenumber.0102.i, %if.end63.i ], [ %bytenumber.0102.i, %for.body.i ], [ %bytenumber.0102.i, %for.body.i ]
  %inc102.i = add nuw i64 %l.0100.i, 1
  %exitcond.not.i = icmp eq i64 %inc102.i, %call22.i
  br i1 %exitcond.not.i, label %cleanup103.i, label %for.body.i

cleanup103.i:                                     ; preds = %for.inc.i, %for.body.i, %if.then60.i, %if.end31.i
  %newlen.097.i = phi i64 [ %newlen.0101.i, %if.then60.i ], [ 0, %if.end31.i ], [ %newlen.0101.i, %for.body.i ], [ %newlen.2.ph.i, %for.inc.i ]
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.75, i64 noundef %newlen.097.i) #18
...
if.end106.i:                                      ; preds = %if.else.i, %cleanup103.i
  %newlen.5.i = phi i64 [ %newlen.097.i, %cleanup103.i ], [ %call22.i, %if.else.i ]
...
for.cond114.preheader.i:                          ; preds = %if.then108.i
  %cmp115106.not.i = icmp eq i64 %newlen.5.i, 0
  br i1 %cmp115106.not.i, label %cleanup152.i, label %for.body117.lr.ph.i
...
if.else136.i:                                     ; preds = %if.then128.i
  ...
  %cmp140104.not.i = icmp eq i8 %16, 1
  br i1 %cmp140104.not.i, label %if.end146.i, label %while.body142.preheader.i
...
while.body142.i:                                  ; preds = %while.body142.i, %while.body142.preheader.i
  %count.0105.i = phi i32 [ %dec.i, %while.body142.i ], [ %conv131.i, %while.body142.preheader.i ]
  %dec.i = add nsw i32 %count.0105.i, -1
  %call143.i = call i32 @blobAddData(ptr noundef nonnull %call109.i, ptr noundef nonnull %c118.i, i64 noundef 1) #18
  %cmp140.i = icmp ugt i32 %count.0105.i, 2
  br i1 %cmp140.i, label %while.body142.i, label %if.end146.i

if.end146.i:                                      ; preds = %while.body142.i, %if.else136.i, %if.then134.i, %land.lhs.true123.i, %for.body117.i
  %l.2.i = phi i64 [ %l.1107.i, %land.lhs.true123.i ], [ %l.1107.i, %for.body117.i ], [ %add129.i, %if.then134.i ], [ %add129.i, %if.else136.i ], [ %add129.i, %while.body142.i ]
  ...
  br i1 %cmp115.i, label %for.body117.i, label %cleanup152.i
...
if.end160.i:                                      ; preds = %if.end156.i
  %17 = load i8, ptr %data.1.i, align 1
...
if.end186.i:                                      ; preds = %if.then184.i, %if.end174.i
  ...
  %18 = load i8, ptr %arrayidx195.i, align 1
  ...
  %19 = load i8, ptr %arrayidx202.i, align 1
  ...
  %20 = load i8, ptr %arrayidx210.i, align 1
  ...
  %21 = load i8, ptr %arrayidx218.i, align 1
  ...
  %22 = load i8, ptr %arrayidx226.i, align 1
  ...
  %23 = load i8, ptr %arrayidx233.i, align 1
  ...
  %24 = load i8, ptr %arrayidx241.i, align 1
  ...
  %25 = load i8, ptr %arrayidx249.i, align 1
...
if.end269.i:                                      ; preds = %if.then267.i, %land.lhs.true265.i
  ...
  call void @fileblobAddData(ptr noundef nonnull %call1.i, ptr noundef nonnull %arrayidx271.i, i64 noundef %dataforklen.0.i) #18
  call void @blobDestroy(ptr noundef nonnull %tmp.1.i) #18
...
if.then273.i:                                     ; preds = %if.end269.i
  store ptr null, ptr %binhex.i.i, align 8
  br label %if.end274.i

if.end274.i:                                      ; preds = %if.then273.i, %if.end269.i
  %27 = load i32, ptr %numberOfEncTypes.i, align 8
...
land.lhs.true282.i:                               ; preds = %if.end274.i
  ...
  %28 = load ptr, ptr %encodingTypes283.i, align 8
...
if.end302.i:                                      ; preds = %if.end4.i
  %.pr.pre.i = load i32, ptr %numberOfEncTypes.i, align 8
  %cmp304.i = icmp eq i32 %.pr.pre.i, 0
...
land.lhs.true319.i:                               ; preds = %if.else315.i, %if.then306.i
  ...
  %30 = load i8, ptr %filename.0.ph.i, align 1
...
if.then341.i:                                     ; preds = %land.lhs.true338.i
  ...
  %.pre.i = load i32, ptr %numberOfEncTypes.i, align 8
  br label %if.end343.i

if.end343.i:                                      ; preds = %if.then341.i, %land.lhs.true338.i
  %35 = phi i32 [ %.pre.i, %if.then341.i ], [ %33, %land.lhs.true338.i ]
  %cmp346112.i = icmp sgt i32 %35, 0
  br i1 %cmp346112.i, label %for.body348.lr.ph.i, label %messageExport.specialized.2.exit
...
for.body348.i:                                    ; preds = %for.inc541.i, %for.body348.lr.ph.i
  ...
  %ret.0117.i = phi ptr [ %call1.i, %for.body348.lr.ph.i ], [ %ret.23256.i, %for.inc541.i ]
  %36 = load ptr, ptr %encodingTypes349.i, align 8
  %arrayidx351.i = getelementptr inbounds i32, ptr %36, i64 %indvars.iv.i
  %37 = load i32, ptr %arrayidx351.i, align 4
...
if.end363.i:                                      ; preds = %if.then354.i
  call void @fileblobDestroy(ptr noundef %ret.0117.i) #18
...
land.lhs.true369.i:                               ; preds = %if.end363.i, %if.end363.thread.i
  %ret.230.i = phi ptr [ %ret.0117.i, %if.end363.thread.i ], [ %call355.i, %if.end363.i ]
  %39 = load ptr, ptr %yenc.i.i, align 8
...
land.lhs.true389.i:                               ; preds = %if.then379.i
  ...
  %41 = load i8, ptr %call381.i, align 1
  %tobool391.not.i = icmp eq i8 %41, 0
  %spec.select556.i = select i1 %tobool391.not.i, ptr @.str.87, ptr %call381.i
  call void @fileblobSetFilename(ptr noundef %ret.230.i, ptr noundef %dir, ptr noundef nonnull %spec.select556.i) #18
...
if.end398.critedge.i:                             ; preds = %if.then379.i, %if.then372.i
  call void @fileblobSetFilename(ptr noundef %ret.230.i, ptr noundef %dir, ptr noundef nonnull @.str.87) #18
  br label %if.end427.thread.i
...
if.end427.thread.i:                               ; preds = %if.end398.critedge.i, %land.lhs.true389.i
  ...
  %42 = load ptr, ptr %t_next399.i, align 8
  store ptr null, ptr %yenc.i.i, align 8
...
if.then403.i:                                     ; preds = %if.else400.i
  ...
  %43 = load ptr, ptr %encodingTypes349.i, align 8
  %arrayidx406.i = getelementptr inbounds i32, ptr %43, i64 %indvars.iv.i
  store i32 0, ptr %arrayidx406.i, align 4
...
messageGetFilename.exit.i:                        ; preds = %if.end407.i
  ...
  br i1 %cmp409.i, label %if.end427.thread59.i, label %if.else412.i
...
if.end427.thread59.i:                             ; preds = %messageGetFilename.exit.i
  ...
  %44 = load ptr, ptr %body_first.i.i, align 8
  br label %if.end430.i

if.then429.i:                                     ; preds = %if.then415.i, %if.else412.i
  %45 = load i8, ptr %retval.0.i42.i, align 1
  %tobool421.not.i = icmp eq i8 %45, 0
  %spec.select557.i = select i1 %tobool421.not.i, ptr @.str.87, ptr %retval.0.i42.i
  call void @fileblobSetFilename(ptr noundef %ret.231.i, ptr noundef %dir, ptr noundef nonnull %spec.select557.i) #18
  %46 = load ptr, ptr %body_first.i.i, align 8
  call void @free(ptr noundef nonnull %retval.0.i42.i) #18
  br label %if.end430.i

if.end430.i:                                      ; preds = %if.then429.i, %if.end427.thread59.i, %if.end427.thread.i
  %t_line.158.i = phi ptr [ %42, %if.end427.thread.i ], [ %46, %if.then429.i ], [ %44, %if.end427.thread59.i ]
  %enctype.157.i = phi i32 [ 6, %if.end427.thread.i ], [ %enctype.0.i, %if.then429.i ], [ %enctype.0.i, %if.end427.thread59.i ]
  %ret.23256.i = phi ptr [ %ret.230.i, %if.end427.thread.i ], [ %ret.231.i, %if.then429.i ], [ %ret.231.i, %if.end427.thread59.i ]
...
if.then433.i:                                     ; preds = %if.end430.i
  ...
  call void @fileblobDestroy(ptr noundef %ret.23256.i) #18
  br label %messageExport.specialized.2.exit
...
do.body.us.i:                                     ; preds = %if.end434.i, %do.cond.us.i
  ...
  %47 = load ptr, ptr %t_line.2.us.i, align 8
...
lor.lhs.false139.i:                               ; preds = %cond.end469.us.i, %if.then473.us.i
  ...
  %48 = load i8, ptr %call450.us.i, align 1
  %cmp141.i = icmp eq i8 %48, 0
  br i1 %cmp141.i, label %if.end485.us.i.thread, label %if.end144.i
...
if.end144.i:                                      ; preds = %lor.lhs.false139.i
  ...
  br i1 %cmp146.i, label %if.end485.us.i.thread, label %while.cond150.i

while.cond150.i:                                  ; preds = %if.end144.i, %if.end175.i
  %49 = phi i8 [ %.pr.i, %if.end175.i ], [ %48, %if.end144.i ]
...
if.then156.i:                                     ; preds = %while.cond150.i
  ...
  %50 = load i8, ptr %incdec.ptr157.i, align 1
  %cmp159.i = icmp eq i8 %50, 0
  br i1 %cmp159.i, label %if.end485.us.i, label %if.end162.i
...
if.end175.i:                                      ; preds = %if.else168.i, %if.end162.i
  ...
  store i8 %storemerge.i, ptr %buf.addr.6.i, align 1
  %.pr.i = load i8, ptr %line.addr.5.i, align 1
  br label %while.cond150.i

if.end485.us.i.thread:                            ; preds = %lor.lhs.false139.i, %if.end144.i
  store i8 0, ptr %data448.0.us.i, align 1
  br label %if.end493.us.i

if.end485.us.i:                                   ; preds = %if.then156.i, %while.cond150.i
  store i8 0, ptr %buf.addr.6.i, align 1
  %cmp486.not.us.i = icmp eq ptr %buf.addr.6.i, %data448.0.us.i
  br i1 %cmp486.not.us.i, label %if.end493.us.i, label %if.then488.us.i

if.then488.us.i:                                  ; preds = %if.end485.us.i
  ...
  call void @fileblobAddData(ptr noundef %ret.23256.i, ptr noundef %data448.0.us.i, i64 noundef %sub.ptr.sub.us.i) #18
  %add492.us.i = add i64 %sub.ptr.sub.us.i, %size.0.us.i
  br label %if.end493.us.i

if.end493.us.i:                                   ; preds = %if.end485.us.i.thread, %if.then488.us.i, %if.end485.us.i
  %size.1.us.i = phi i64 [ %add492.us.i, %if.then488.us.i ], [ %size.0.us.i, %if.end485.us.i ], [ %size.0.us.i, %if.end485.us.i.thread ]
...
land.lhs.true501.us.i:                            ; preds = %if.end497.us.i
  %53 = load i32, ptr %numberOfEncTypes.i, align 8
...
if.then506.us.i:                                  ; preds = %land.lhs.true501.us.i
  %55 = load ptr, ptr %t_line.2.us.i, align 8
  %call508.us.i = call ptr @lineUnlink(ptr noundef %55) #18
  store ptr null, ptr %t_line.2.us.i, align 8
...
do.cond.us.i:                                     ; preds = %if.then506.us.i, %land.lhs.true501.us.i, %if.end497.us.i, %do.body.us.i
  ...
  %56 = load ptr, ptr %t_next519.us.i, align 8
  %cmp520.not.us.i = icmp eq ptr %56, null
  br i1 %cmp520.not.us.i, label %do.end.i, label %do.body.us.i

if.then437.i:                                     ; preds = %if.end434.i
  %57 = load i32, ptr %numberOfEncTypes.i, align 8
  %sub439.i = add nsw i32 %57, -1
  %58 = zext i32 %sub439.i to i64
  %cmp440.i = icmp eq i64 %indvars.iv.i, %58
  br i1 %cmp440.i, label %for.end543.i, label %if.end444.i

if.end444.i:                                      ; preds = %if.then437.i
  %call445.i = call ptr @textToFileblob(ptr noundef nonnull %t_line.158.i, ptr noundef %ret.23256.i, i32 noundef 0) #18
...
do.body.i:                                        ; preds = %if.end434.i, %do.cond.i
  ...
  call void @llvm.lifetime.start.p0(i64 1024, ptr nonnull %smallbuf.i) #18
  %59 = load ptr, ptr %t_line.2.i, align 8
...
if.end476.i:                                      ; preds = %if.then473.i, %cond.end469.i, %do.body.i
  ...
  %call477.i = call ptr @decodeLine(ptr noundef %m, i32 noundef %enctype.157.fr.i, ptr noundef %call450.i, ptr noundef %data448.0.i, i64 noundef %datasize.0.i)
...
if.then488.i:                                     ; preds = %if.end485.i
  ...
  call void @fileblobAddData(ptr noundef %ret.23256.i, ptr noundef %data448.0.i, i64 noundef %sub.ptr.sub.i) #18
...
land.lhs.true501.i:                               ; preds = %if.end497.i
  %60 = load i32, ptr %numberOfEncTypes.i, align 8
...
if.then506.i:                                     ; preds = %land.lhs.true501.i
  %62 = load ptr, ptr %t_line.2.i, align 8
  %call508.i = call ptr @lineUnlink(ptr noundef %62) #18
  store ptr null, ptr %t_line.2.i, align 8
  br label %do.cond.i

cleanup511.i:                                     ; preds = %if.end457.us.i, %if.then483.i, %if.then480.i
  %size.090.i = phi i64 [ %size.0.i, %if.then480.i ], [ %size.0.i, %if.then483.i ], [ %size.0.us.i, %if.end457.us.i ]
  call void @llvm.lifetime.end.p0(i64 1024, ptr nonnull %smallbuf.i) #18
  br label %do.end.i
...
do.cond.i:                                        ; preds = %if.then506.i, %land.lhs.true501.i, %if.end497.i
  ...
  %63 = load ptr, ptr %t_next519.i, align 8
  %cmp520.not.i = icmp eq ptr %63, null
  br i1 %cmp520.not.i, label %do.end.i, label %do.body.i

do.end.i:                                         ; preds = %do.cond.us.i, %do.cond.i, %cleanup511.i
  %size.275.i = phi i64 [ %size.090.i, %cleanup511.i ], [ %size.1.i, %do.cond.i ], [ %size.2.ph.us.i, %do.cond.us.i ]
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.95, i64 noundef %size.275.i, i32 noundef %enctype.157.fr.i) #18
  %64 = load i32, ptr %base64chars.i, align 4
...
if.then523.i:                                     ; preds = %do.end.i
  ...
  %65 = load i32, ptr %base64chars.i, align 4
  %tobool.not.i5.i = icmp eq i32 %65, 0
  br i1 %tobool.not.i5.i, label %if.end535.i, label %base64Flush.exit.i

base64Flush.exit.i:                               ; preds = %if.then523.i
  %call.i6.i = call fastcc ptr @decode(ptr noundef nonnull %m, ptr noundef null, ptr noundef nonnull %data524.i, ptr noundef nonnull @base64, i1 noundef zeroext false)
  store i32 0, ptr %base64chars.i, align 4
  %tobool528.not.i = icmp eq ptr %call.i6.i, null
  br i1 %tobool528.not.i, label %if.end535.i, label %if.then529.i

if.then529.i:                                     ; preds = %base64Flush.exit.i
  %sub.ptr.lhs.cast532.i = ptrtoint ptr %call.i6.i to i64
  %sub.ptr.sub534.i = sub i64 %sub.ptr.lhs.cast532.i, %sub.ptr.rhs.cast533.i
  call void @fileblobAddData(ptr noundef %ret.23256.i, ptr noundef nonnull %data524.i, i64 noundef %sub.ptr.sub534.i) #18
...
for.inc541.i:                                     ; preds = %if.end535.i, %do.end.i, %if.end444.i
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %66 = load i32, ptr %numberOfEncTypes.i, align 8
  %67 = sext i32 %66 to i64
  %cmp346.i = icmp slt i64 %indvars.iv.next.i, %67
  br i1 %cmp346.i, label %for.body348.i, label %messageExport.specialized.2.exit

for.end543.i:                                     ; preds = %if.then437.i
  %call443.i = call ptr @textToFileblob(ptr noundef nonnull %t_line.158.i, ptr noundef %ret.23256.i, i32 noundef %destroy) #18
  br label %messageExport.specialized.2.exit

messageExport.specialized.2.exit:                 ; preds = %for.inc541.i, %entry, %if.end.i, %if.then16.i, %if.then20.i, %cleanup103.thread.i, %cleanup152.thread.i, %if.then159.i, %if.then165.i, %if.then173.i, %if.then287.i, %if.then332.i, %if.end343.i, %cleanup360.thread.i, %if.then433.i, %for.end543.i
  %retval.10.i = phi ptr [ %call334.i, %if.then332.i ], [ null, %entry ], [ null, %if.end.i ], [ %ret.23256.i, %for.end543.i ], [ null, %cleanup152.thread.i ], [ null, %cleanup103.thread.i ], [ %call1.i, %if.then287.i ], [ null, %if.then173.i ], [ null, %if.then165.i ], [ null, %if.then159.i ], [ null, %if.then20.i ], [ null, %if.then16.i ], [ %ret.0117.i, %cleanup360.thread.i ], [ null, %if.then433.i ], [ %call1.i, %if.end343.i ], [ %ret.23256.i, %for.inc541.i ]
  %tobool.not = icmp eq i32 %destroy, 0
  br i1 %tobool.not, label %if.end, label %land.lhs.true

land.lhs.true:                                    ; preds = %messageExport.specialized.2.exit
  %68 = load ptr, ptr %body_first.i.i, align 8
...
if.end:                                           ; preds = %if.then, %land.lhs.true, %messageExport.specialized.2.exit
  ret ptr %retval.10.i
}
...
entry:
  ...
  %0 = load ptr, ptr %body_first.i.i, align 8
  %cmp.i = icmp eq ptr %0, null
  br i1 %cmp.i, label %messageExport.specialized.1.exit, label %if.end.i

if.end.i:                                         ; preds = %entry
  %call1.i = tail call ptr @blobCreate() #18
  %cmp2.i = icmp eq ptr %call1.i, null
  br i1 %cmp2.i, label %messageExport.specialized.1.exit, label %if.end4.i
...
if.then16.i:                                      ; preds = %cond.end.i
  ...
  br label %messageExport.specialized.1.exit
...
if.end269.i:                                      ; preds = %if.then262.i, %if.end186.i
  %dataforklen.0.i = phi i64 [ %sub259.i, %if.then262.i ], [ %or221.i, %if.end186.i ]
  %arrayidx271.i = getelementptr inbounds i8, ptr %data.1.i, i64 %conv258.i
  call void @blobAddData(ptr noundef nonnull %call1.i, ptr noundef nonnull %arrayidx271.i, i64 noundef %dataforklen.0.i) #18
  call void @blobDestroy(ptr noundef nonnull %tmp.1.i) #18
  %tobool272.not.i = icmp eq i32 %destroy, 0
  br i1 %tobool272.not.i, label %if.end274.i, label %if.then273.i
...
if.end274.i:                                      ; preds = %if.then273.i, %if.end269.i
  %26 = load i32, ptr %numberOfEncTypes.i, align 8
...
land.lhs.true282.i:                               ; preds = %if.end274.i
  %encodingTypes283.i = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 1
  %27 = load ptr, ptr %encodingTypes283.i, align 8
...
land.lhs.true319.i:                               ; preds = %if.else315.i, %if.then306.i
  %filename.0.ph.i = phi ptr [ %call307.i, %if.then306.i ], [ %call311.i, %if.else315.i ]
  %29 = load i8, ptr %filename.0.ph.i, align 1
...
if.end328.i:                                      ; preds = %if.end328.critedge.i, %land.lhs.true319.i
  %30 = load i32, ptr %numberOfEncTypes.i, align 8
  %cmp330.i = icmp eq i32 %30, 0
  br i1 %cmp330.i, label %if.then332.i, label %if.end343.i

if.then332.i:                                     ; preds = %if.end328.i
  %31 = load ptr, ptr %body_first.i.i, align 8
...
if.end343.i:                                      ; preds = %if.end328.i, %if.end302.i, %if.end274.i
  %32 = phi i32 [ %26, %if.end274.i ], [ %.pr.pre.i, %if.end302.i ], [ %30, %if.end328.i ]
  %cmp346112.i = icmp sgt i32 %32, 0
  br i1 %cmp346112.i, label %for.body348.lr.ph.i, label %messageExport.specialized.1.exit

for.body348.lr.ph.i:                              ; preds = %if.end343.i, %land.lhs.true282.i
  %encodingTypes349.i = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 1
  %yenc.i.i = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 17
  %tobool500.i = icmp ne i32 %destroy, 0
  %base64chars.i = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 13
...
for.body348.i:                                    ; preds = %for.inc541.i, %for.body348.lr.ph.i
  %indvars.iv.i = phi i64 [ 0, %for.body348.lr.ph.i ], [ %indvars.iv.next.i, %for.inc541.i ]
  %ret.0117.i = phi ptr [ %call1.i, %for.body348.lr.ph.i ], [ %ret.23256.i, %for.inc541.i ]
  %33 = load ptr, ptr %encodingTypes349.i, align 8
  %arrayidx351.i = getelementptr inbounds i32, ptr %33, i64 %indvars.iv.i
  %34 = load i32, ptr %arrayidx351.i, align 4
  %cmp352.not.i = icmp eq i64 %indvars.iv.i, 0
  br i1 %cmp352.not.i, label %if.end363.thread.i, label %if.then354.i
...
if.end363.i:                                      ; preds = %if.then354.i
  call void @blobDestroy(ptr noundef %ret.0117.i) #18
...
land.lhs.true369.i:                               ; preds = %if.end363.i, %if.end363.thread.i
  %ret.230.i = phi ptr [ %ret.0117.i, %if.end363.thread.i ], [ %call355.i, %if.end363.i ]
  %36 = load ptr, ptr %yenc.i.i, align 8
...
land.lhs.true389.i:                               ; preds = %if.then379.i
  ...
  %call385.i = call i64 @strstrip(ptr noundef nonnull %call381.i) #18
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.91, ptr noundef nonnull %call381.i) #18
  %38 = load i8, ptr %call381.i, align 1
  %tobool391.not.i = icmp eq i8 %38, 0
  %spec.select556.i = select i1 %tobool391.not.i, ptr @.str.87, ptr %call381.i
  call void @blobSetFilename(ptr noundef %ret.230.i, ptr noundef null, ptr noundef nonnull %spec.select556.i) #18
  call void @free(ptr noundef nonnull %call381.i) #18
  br label %if.end427.thread.i

if.end398.critedge.i:                             ; preds = %if.then379.i, %if.then372.i
  call void @blobSetFilename(ptr noundef %ret.230.i, ptr noundef null, ptr noundef nonnull @.str.87) #18
  br label %if.end427.thread.i

if.end427.thread.i:                               ; preds = %if.end398.critedge.i, %land.lhs.true389.i
  %t_next399.i = getelementptr inbounds %struct.text, ptr %36, i64 0, i32 1
  %39 = load ptr, ptr %t_next399.i, align 8
  store ptr null, ptr %yenc.i.i, align 8
  br label %if.end430.i
...
if.then403.i:                                     ; preds = %if.else400.i
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.92) #18
  %40 = load ptr, ptr %encodingTypes349.i, align 8
...
if.end427.thread59.i:                             ; preds = %messageGetFilename.exit.i
  ...
  %41 = load ptr, ptr %body_first.i.i, align 8
  br label %if.end430.i

if.then429.i:                                     ; preds = %if.then415.i, %if.else412.i
  %42 = load i8, ptr %retval.0.i42.i, align 1
  %tobool421.not.i = icmp eq i8 %42, 0
  %spec.select557.i = select i1 %tobool421.not.i, ptr @.str.87, ptr %retval.0.i42.i
  call void @blobSetFilename(ptr noundef %ret.231.i, ptr noundef null, ptr noundef nonnull %spec.select557.i) #18
  %43 = load ptr, ptr %body_first.i.i, align 8
  call void @free(ptr noundef nonnull %retval.0.i42.i) #18
  br label %if.end430.i

if.end430.i:                                      ; preds = %if.then429.i, %if.end427.thread59.i, %if.end427.thread.i
  %t_line.158.i = phi ptr [ %39, %if.end427.thread.i ], [ %43, %if.then429.i ], [ %41, %if.end427.thread59.i ]
  %enctype.157.i = phi i32 [ 6, %if.end427.thread.i ], [ %enctype.0.i, %if.then429.i ], [ %enctype.0.i, %if.end427.thread59.i ]
  %ret.23256.i = phi ptr [ %ret.230.i, %if.end427.thread.i ], [ %ret.231.i, %if.then429.i ], [ %ret.231.i, %if.end427.thread59.i ]
  %enctype.157.fr.i = freeze i32 %enctype.157.i
  %cmp431.i = icmp eq ptr %t_line.158.i, null
...
if.then433.i:                                     ; preds = %if.end430.i
  call void (ptr, ...) @cli_warnmsg(ptr noundef nonnull @.str.94) #18
  call void @blobDestroy(ptr noundef %ret.23256.i) #18
  br label %messageExport.specialized.1.exit
...
do.body.us.i:                                     ; preds = %if.end434.i, %do.cond.us.i
  ...
  call void @llvm.lifetime.start.p0(i64 1024, ptr nonnull %smallbuf.i) #18
  %44 = load ptr, ptr %t_line.2.us.i, align 8
...
lor.lhs.false139.i:                               ; preds = %cond.end469.us.i, %if.then473.us.i
  %data448.0.us.i = phi ptr [ %call474.us.i, %if.then473.us.i ], [ %smallbuf.i, %cond.end469.us.i ]
  %bigbuf.0.us.i = phi ptr [ %call474.us.i, %if.then473.us.i ], [ null, %cond.end469.us.i ]
  %45 = load i8, ptr %call450.us.i, align 1
...
while.cond150.i:                                  ; preds = %if.end144.i, %if.end175.i
  %46 = phi i8 [ %.pr.i, %if.end175.i ], [ %45, %if.end144.i ]
  %buf.addr.6.i = phi ptr [ %buf.addr.7.i, %if.end175.i ], [ %data448.0.us.i, %if.end144.i ]
  %line.addr.4.i = phi ptr [ %line.addr.5.i, %if.end175.i ], [ %call450.us.i, %if.end144.i ]
...
if.then156.i:                                     ; preds = %while.cond150.i
  %incdec.ptr157.i = getelementptr inbounds i8, ptr %line.addr.4.i, i64 1
  %47 = load i8, ptr %incdec.ptr157.i, align 1
...
if.then488.us.i:                                  ; preds = %if.end485.us.i
  ...
  %sub.ptr.rhs.cast.us.i = ptrtoint ptr %data448.0.us.i to i64
  %sub.ptr.sub.us.i = sub i64 %sub.ptr.lhs.cast.us.i, %sub.ptr.rhs.cast.us.i
  call void @blobAddData(ptr noundef %ret.23256.i, ptr noundef %data448.0.us.i, i64 noundef %sub.ptr.sub.us.i) #18
  %add492.us.i = add i64 %sub.ptr.sub.us.i, %size.0.us.i
  br label %if.end493.us.i
...
land.lhs.true501.us.i:                            ; preds = %if.end497.us.i
  %50 = load i32, ptr %numberOfEncTypes.i, align 8
...
if.then506.us.i:                                  ; preds = %land.lhs.true501.us.i
  %52 = load ptr, ptr %t_line.2.us.i, align 8
...
do.cond.us.i:                                     ; preds = %if.then506.us.i, %land.lhs.true501.us.i, %if.end497.us.i, %do.body.us.i
  ...
  call void @llvm.lifetime.end.p0(i64 1024, ptr nonnull %smallbuf.i) #18
  %t_next519.us.i = getelementptr inbounds %struct.text, ptr %t_line.2.us.i, i64 0, i32 1
  %53 = load ptr, ptr %t_next519.us.i, align 8
  %cmp520.not.us.i = icmp eq ptr %53, null
  br i1 %cmp520.not.us.i, label %do.end.i, label %do.body.us.i

if.then437.i:                                     ; preds = %if.end434.i
  %54 = load i32, ptr %numberOfEncTypes.i, align 8
...
if.end444.i:                                      ; preds = %if.then437.i
  %call445.i = call ptr @textToBlob(ptr noundef nonnull %t_line.158.i, ptr noundef %ret.23256.i, i32 noundef 0) #18
  br label %for.inc541.i
...
do.body.i:                                        ; preds = %if.end434.i, %do.cond.i
  ...
  call void @llvm.lifetime.start.p0(i64 1024, ptr nonnull %smallbuf.i) #18
  %56 = load ptr, ptr %t_line.2.i, align 8
...
if.then488.i:                                     ; preds = %if.end485.i
  ...
  %sub.ptr.rhs.cast.i = ptrtoint ptr %data448.0.i to i64
  %sub.ptr.sub.i = sub i64 %sub.ptr.lhs.cast.i, %sub.ptr.rhs.cast.i
  call void @blobAddData(ptr noundef %ret.23256.i, ptr noundef %data448.0.i, i64 noundef %sub.ptr.sub.i) #18
  %add492.i = add i64 %sub.ptr.sub.i, %size.0.i
  br label %if.end493.i
...
do.cond.i:                                        ; preds = %if.then506.i, %land.lhs.true501.i, %if.end497.i
  call void @llvm.lifetime.end.p0(i64 1024, ptr nonnull %smallbuf.i) #18
  %t_next519.i = getelementptr inbounds %struct.text, ptr %t_line.2.i, i64 0, i32 1
  %60 = load ptr, ptr %t_next519.i, align 8
...
do.end.i:                                         ; preds = %do.cond.us.i, %do.cond.i, %cleanup511.i
  %size.275.i = phi i64 [ %size.090.i, %cleanup511.i ], [ %size.1.i, %do.cond.i ], [ %size.2.ph.us.i, %do.cond.us.i ]
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.95, i64 noundef %size.275.i, i32 noundef %enctype.157.fr.i) #18
  %61 = load i32, ptr %base64chars.i, align 4
...
if.then523.i:                                     ; preds = %do.end.i
  ...
  %62 = load i32, ptr %base64chars.i, align 4
...
if.then529.i:                                     ; preds = %base64Flush.exit.i
  %sub.ptr.lhs.cast532.i = ptrtoint ptr %call.i6.i to i64
  %sub.ptr.sub534.i = sub i64 %sub.ptr.lhs.cast532.i, %sub.ptr.rhs.cast533.i
  call void @blobAddData(ptr noundef %ret.23256.i, ptr noundef nonnull %data524.i, i64 noundef %sub.ptr.sub534.i) #18
  br label %if.end535.i
...
for.inc541.i:                                     ; preds = %if.end535.i, %do.end.i, %if.end444.i
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %63 = load i32, ptr %numberOfEncTypes.i, align 8
  %64 = sext i32 %63 to i64
  %cmp346.i = icmp slt i64 %indvars.iv.next.i, %64
  br i1 %cmp346.i, label %for.body348.i, label %messageExport.specialized.1.exit

for.end543.i:                                     ; preds = %if.then437.i
  %call443.i = call ptr @textToBlob(ptr noundef nonnull %t_line.158.i, ptr noundef %ret.23256.i, i32 noundef %destroy) #18
  br label %messageExport.specialized.1.exit

messageExport.specialized.1.exit:                 ; preds = %for.inc541.i, %entry, %if.end.i, %if.then16.i, %if.then20.i, %cleanup103.thread.i, %cleanup152.thread.i, %if.then159.i, %if.then165.i, %if.then173.i, %if.then287.i, %if.then332.i, %if.end343.i, %cleanup360.thread.i, %if.then433.i, %for.end543.i
  %retval.10.i = phi ptr [ %call334.i, %if.then332.i ], [ null, %entry ], [ null, %if.end.i ], [ %ret.23256.i, %for.end543.i ], [ null, %cleanup152.thread.i ], [ null, %cleanup103.thread.i ], [ %call1.i, %if.then287.i ], [ null, %if.then173.i ], [ null, %if.then165.i ], [ null, %if.then159.i ], [ null, %if.then20.i ], [ null, %if.then16.i ], [ %ret.0117.i, %cleanup360.thread.i ], [ null, %if.then433.i ], [ %call1.i, %if.end343.i ], [ %ret.23256.i, %for.inc541.i ]
  %tobool.not = icmp eq i32 %destroy, 0
  br i1 %tobool.not, label %if.end, label %land.lhs.true

land.lhs.true:                                    ; preds = %messageExport.specialized.1.exit
  %65 = load ptr, ptr %body_first.i.i, align 8
...
if.end:                                           ; preds = %if.then, %land.lhs.true, %messageExport.specialized.1.exit
  ret ptr %retval.10.i
}
...
for.body30.lr.ph:                                 ; preds = %for.cond27.preheader
  ...
  %body_first.i278 = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 7
...
if.then:                                          ; preds = %entry
  ...
  %t_line.0321 = load ptr, ptr %body_first.i, align 8
...
if.else:                                          ; preds = %for.body
  ...
  store ptr %call3, ptr %t_next, align 8
  br label %if.end
...
if.end11:                                         ; preds = %if.end
  %1 = load ptr, ptr %t_line.0325, align 8
...
for.inc:                                          ; preds = %if.end11, %if.then14
  %storemerge277 = phi ptr [ %call16, %if.then14 ], [ null, %if.end11 ]
  store ptr %storemerge277, ptr %call3, align 8
  %t_next21 = getelementptr inbounds %struct.text, ptr %t_line.0325, i64 0, i32 1
  %t_line.0 = load ptr, ptr %t_next21, align 8
  %tobool.not = icmp eq ptr %t_line.0, null
  br i1 %tobool.not, label %if.then23, label %for.body

if.then23:                                        ; preds = %for.inc
  %t_next24 = getelementptr inbounds %struct.text, ptr %call3, i64 0, i32 1
  store ptr null, ptr %t_next24, align 8
  br label %cleanup191
...
for.body30:                                       ; preds = %for.body30.lr.ph, %for.inc185
  ...
  %2 = load ptr, ptr %encodingTypes, align 8
...
sw.bb:                                            ; preds = %for.body30, %for.body30, %for.body30
  %t_line.1300 = load ptr, ptr %body_first.i278, align 8
...
if.else38:                                        ; preds = %for.body34
  ...
  store ptr %call37, ptr %t_next40, align 8
  br label %if.end42
...
if.end49:                                         ; preds = %if.end42
  %5 = load ptr, ptr %t_line.1304, align 8
...
for.inc59:                                        ; preds = %if.end49, %if.then52
  ...
  store ptr %storemerge, ptr %call37, align 8
  %t_next60 = getelementptr inbounds %struct.text, ptr %t_line.1304, i64 0, i32 1
  %t_line.1 = load ptr, ptr %t_next60, align 8
  %tobool33.not = icmp eq ptr %t_line.1, null
  br i1 %tobool33.not, label %for.inc185, label %for.body34
...
if.then72:                                        ; preds = %if.then70
  ...
  store ptr null, ptr %t_next73, align 8
  call void @textDestroy(ptr noundef nonnull %first.2317) #18
  br label %cleanup191
...
land.lhs.true:                                    ; preds = %sw.default
  %7 = load ptr, ptr %binhex.i, align 8
...
if.end81:                                         ; preds = %if.then80, %land.lhs.true, %sw.default
  %t_line.2306 = load ptr, ptr %body_first.i278, align 8
...
for.body85:                                       ; preds = %for.body85.lr.ph, %for.inc148
  ...
  %8 = load ptr, ptr %t_line.2310, align 8
...
if.else101:                                       ; preds = %if.end97
  ...
  store ptr %call100, ptr %t_next103, align 8
  br label %if.end105
...
if.then126:                                       ; preds = %land.lhs.true120
  %10 = load ptr, ptr %t_line.2310, align 8
...
if.end135:                                        ; preds = %if.end108, %if.end108, %if.then126, %if.else130
  ...
  store ptr %call128.sink, ptr %call100, align 8
...
for.inc148:                                       ; preds = %if.end135, %if.then140, %for.body85
  ...
  %t_line.2 = load ptr, ptr %t_next149, align 8
  %tobool84.not = icmp eq ptr %t_line.2, null
  br i1 %tobool84.not, label %for.end150, label %for.body85
...
for.end150:                                       ; preds = %for.inc148, %if.end81, %cleanup.thread
  ...
  %11 = load i32, ptr %base64chars, align 4
...
if.then152:                                       ; preds = %for.end150
  ...
  %call156 = call fastcc ptr @decode(ptr noundef nonnull %m, ptr noundef null, ptr noundef nonnull %data153, ptr noundef nonnull @base64, i1 noundef zeroext false)
...
if.else167:                                       ; preds = %if.then162
  ...
  store ptr %call166, ptr %t_next169, align 8
  br label %if.end171
...
if.then174:                                       ; preds = %if.end171
  ...
  store ptr %call176, ptr %call166, align 8
  br label %if.end179
...
for.inc185:                                       ; preds = %for.inc59, %sw.bb, %if.end179, %for.end150
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %13 = load i32, ptr %numberOfEncTypes, align 8
  %14 = sext i32 %13 to i64
  %cmp29 = icmp slt i64 %indvars.iv.next, %14
  br i1 %cmp29, label %for.body30, label %for.end186
...
if.then188:                                       ; preds = %for.end186
  ...
  store ptr null, ptr %t_next189, align 8
  br label %cleanup191
...
while.cond.preheader:                             ; preds = %sw.bb2
  %tobool5.not474 = icmp eq i64 %buflen, 0
  br i1 %tobool5.not474, label %if.then49, label %land.rhs
...
land.rhs:                                         ; preds = %while.cond.preheader, %if.end46
  %line.addr.0477 = phi ptr [ %incdec.ptr47, %if.end46 ], [ %line, %while.cond.preheader ]
  %buf.addr.1476 = phi ptr [ %buf.addr.3, %if.end46 ], [ %buf, %while.cond.preheader ]
  %buflen.addr.0475 = phi i64 [ %dec, %if.end46 ], [ %buflen, %while.cond.preheader ]
  %0 = load i8, ptr %line.addr.0477, align 1
...
if.then10:                                        ; preds = %land.rhs
  %incdec.ptr11 = getelementptr inbounds i8, ptr %line.addr.0477, i64 1
...
hex.exit:                                         ; preds = %if.then.i, %if.then9.i, %if.then21.i, %if.end26.i
  ...
  %incdec.ptr21 = getelementptr inbounds i8, ptr %line.addr.0477, i64 2
...
if.then29:                                        ; preds = %hex.exit, %hex.exit
  %incdec.ptr30 = getelementptr inbounds i8, ptr %buf.addr.1476, i64 1
  store i8 %retval.0.i, ptr %buf.addr.1476, align 1
  br label %if.then49
...
if.then35:                                        ; preds = %if.end31
  ...
  %conv.i255 = sext i8 %7 to i32
  %idxprom.i256 = sext i8 %7 to i64
  %arrayidx.i257 = getelementptr inbounds i16, ptr %8, i64 %idxprom.i256
  %9 = load i16, ptr %arrayidx.i257, align 2
  %10 = and i16 %9, 2048
  %tobool.not.i258 = icmp eq i16 %10, 0
  br i1 %tobool.not.i258, label %if.end.i262, label %if.then.i259

if.then.i259:                                     ; preds = %if.then35
  %sub.i260 = add i8 %7, -48
  br label %hex.exit271

if.end.i262:                                      ; preds = %if.then35
  %11 = add i8 %7, -65
  %or.cond.i263 = icmp ult i8 %11, 6
  br i1 %or.cond.i263, label %if.then9.i269, label %if.end13.i264

if.then9.i269:                                    ; preds = %if.end.i262
  %add.i270 = add nsw i8 %7, -55
  br label %hex.exit271

if.end13.i264:                                    ; preds = %if.end.i262
  %12 = add i8 %7, -97
  %or.cond28.i265 = icmp ult i8 %12, 6
  br i1 %or.cond28.i265, label %if.then21.i267, label %if.end26.i266

if.then21.i267:                                   ; preds = %if.end13.i264
  %add24.i268 = add nsw i8 %7, -87
  br label %hex.exit271

if.end26.i266:                                    ; preds = %if.end13.i264
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.97, i32 noundef %conv.i255) #18
  br label %hex.exit271

hex.exit271:                                      ; preds = %if.then.i259, %if.then9.i269, %if.then21.i267, %if.end26.i266
  %retval.0.i261 = phi i8 [ %sub.i260, %if.then.i259 ], [ %add.i270, %if.then9.i269 ], [ %add24.i268, %if.then21.i267 ], [ 61, %if.end26.i266 ]
  %add = add i8 %retval.0.i261, %shl
  br label %if.end46

if.end46:                                         ; preds = %land.rhs, %if.end31, %hex.exit271
  %storemerge445 = phi i8 [ %add, %hex.exit271 ], [ 61, %if.end31 ], [ %0, %land.rhs ]
  %line.addr.3 = phi ptr [ %incdec.ptr21, %hex.exit271 ], [ %line.addr.0477, %if.end31 ], [ %line.addr.0477, %land.rhs ]
  %buf.addr.3 = getelementptr inbounds i8, ptr %buf.addr.1476, i64 1
  store i8 %storemerge445, ptr %buf.addr.1476, align 1
  %incdec.ptr47 = getelementptr inbounds i8, ptr %line.addr.3, i64 1
  %dec = add i64 %buflen.addr.0475, -1
  %tobool5.not = icmp eq i64 %dec, 0
  br i1 %tobool5.not, label %if.then49, label %land.rhs

if.then49:                                        ; preds = %land.rhs, %if.end46, %while.cond.preheader, %if.then29
  %buf.addr.4 = phi ptr [ %incdec.ptr30, %if.then29 ], [ %buf, %while.cond.preheader ], [ %buf.addr.1476, %land.rhs ], [ %buf.addr.3, %if.end46 ]
  %incdec.ptr50 = getelementptr inbounds i8, ptr %buf.addr.4, i64 1
  store i8 10, ptr %buf.addr.4, align 1
  br label %sw.epilog
...
if.then72:                                        ; preds = %if.end69
  store i8 0, ptr %call70, align 1
  br label %if.end73

if.end73:                                         ; preds = %if.then72, %if.end69
  %13 = load i8, ptr %copy.0, align 1
...
for.body.i:                                       ; preds = %if.end73, %for.inc12.i
  ...
  %idxprom.i272 = zext i8 %.pr.i to i64
  %arrayidx.i273 = getelementptr inbounds [256 x i8], ptr @base64Table, i64 0, i64 %idxprom.i272
  %14 = load i8, ptr %arrayidx.i273, align 1
...
for.body8.i:                                      ; preds = %for.body.i, %for.body8.i
  ...
  store i8 %15, ptr %p1.024.i, align 1
  %cmp6.not.i = icmp eq i8 %15, 0
  br i1 %cmp6.not.i, label %for.end.i, label %for.body8.i
...
for.inc12.i:                                      ; preds = %for.end.i, %for.body.i
  ...
  %16 = load i8, ptr %incdec.ptr13.i, align 1
  %tobool.not.i274 = icmp eq i8 %16, 0
  br i1 %tobool.not.i274, label %sanitiseBase64.exit, label %for.body.i
...
land.end80:                                       ; preds = %land.rhs76, %sanitiseBase64.exit
  ...
  %base64chars.i = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 13
  %18 = load i32, ptr %base64chars.i, align 4
...
sw.bb.i:                                          ; preds = %land.end80
  ...
  %19 = load i8, ptr %base64_3.i, align 2
  br label %sw.bb1.i
...
sw.bb1.i:                                         ; preds = %sw.bb.i, %land.end80
  ...
  %20 = load i8, ptr %base64_2.i, align 1
...
sw.epilog.thread.i:                               ; preds = %sw.bb1.i, %land.end80
  ...
  %21 = load i8, ptr %base64_1.i, align 8
  %.pre = load i8, ptr %copy.0, align 1
  br label %if.else.i

sw.epilog.i:                                      ; preds = %land.end80
  %.pre507 = load i8, ptr %copy.0, align 1
  br i1 %17, label %while.cond.preheader.i, label %if.else.i

while.cond.preheader.i:                           ; preds = %sw.epilog.i
  %tobool3.not402.i = icmp eq i8 %.pre507, 0
  br i1 %tobool3.not402.i, label %decode.exit, label %while.body.i

while.body.i:                                     ; preds = %while.cond.preheader.i, %while.body.i
  %22 = phi i8 [ %31, %while.body.i ], [ %.pre507, %while.cond.preheader.i ]
  %out.addr.0404.i = phi ptr [ %incdec.ptr27.i, %while.body.i ], [ %buf, %while.cond.preheader.i ]
  %in.addr.0403.i = phi ptr [ %incdec.ptr11.i276, %while.body.i ], [ %copy.0, %while.cond.preheader.i ]
  %incdec.ptr.i = getelementptr inbounds i8, ptr %in.addr.0403.i, i64 1
  %idxprom.i415 = zext i8 %22 to i64
  %arrayidx.i416 = getelementptr inbounds [256 x i8], ptr @base64Table, i64 0, i64 %idxprom.i415
  %23 = load i8, ptr %arrayidx.i416, align 1
  %incdec.ptr4.i = getelementptr inbounds i8, ptr %in.addr.0403.i, i64 2
  %24 = load i8, ptr %incdec.ptr.i, align 1
  %idxprom.i411 = zext i8 %24 to i64
  %arrayidx.i412 = getelementptr inbounds [256 x i8], ptr @base64Table, i64 0, i64 %idxprom.i411
  %25 = load i8, ptr %arrayidx.i412, align 1
  %cmp.i413 = icmp eq i8 %25, -1
  %..i414 = select i1 %cmp.i413, i8 63, i8 %25
  %incdec.ptr6.i = getelementptr inbounds i8, ptr %in.addr.0403.i, i64 3
  %26 = load i8, ptr %incdec.ptr4.i, align 1
  %idxprom.i407 = zext i8 %26 to i64
  %arrayidx.i408 = getelementptr inbounds [256 x i8], ptr @base64Table, i64 0, i64 %idxprom.i407
  %27 = load i8, ptr %arrayidx.i408, align 1
  %cmp.i409 = icmp eq i8 %27, -1
  %..i410 = select i1 %cmp.i409, i8 63, i8 %27
  %shl.i = shl i8 %23, 2
  %shr.i = lshr i8 %..i414, 4
  %and.i = and i8 %shr.i, 3
  %or.i = or i8 %and.i, %shl.i
  %incdec.ptr10.i = getelementptr inbounds i8, ptr %out.addr.0404.i, i64 1
  store i8 %or.i, ptr %out.addr.0404.i, align 1
  %incdec.ptr11.i276 = getelementptr inbounds i8, ptr %in.addr.0403.i, i64 4
  %28 = load i8, ptr %incdec.ptr6.i, align 1
  %idxprom.i403 = zext i8 %28 to i64
  %arrayidx.i404 = getelementptr inbounds [256 x i8], ptr @base64Table, i64 0, i64 %idxprom.i403
  %29 = load i8, ptr %arrayidx.i404, align 1
  %shl14.i = shl i8 %..i414, 4
  %shr16.i = lshr i8 %..i410, 2
  %and17.i = and i8 %shr16.i, 15
  %or18.i = or i8 %and17.i, %shl14.i
  %incdec.ptr20.i = getelementptr inbounds i8, ptr %out.addr.0404.i, i64 2
  store i8 %or18.i, ptr %incdec.ptr10.i, align 1
  %shl22.i = shl i8 %..i410, 6
  %30 = and i8 %29, 63
  %or25.i = or i8 %30, %shl22.i
  %incdec.ptr27.i = getelementptr inbounds i8, ptr %out.addr.0404.i, i64 3
  store i8 %or25.i, ptr %incdec.ptr20.i, align 1
  %31 = load i8, ptr %incdec.ptr11.i276, align 1
  %tobool3.not.i = icmp eq i8 %31, 0
  br i1 %tobool3.not.i, label %decode.exit, label %while.body.i

if.else.i:                                        ; preds = %sw.epilog.i, %sw.epilog.thread.i
  %32 = phi i8 [ %.pre, %sw.epilog.thread.i ], [ %.pre507, %sw.epilog.i ]
  %cb3.2338.i = phi i8 [ %cb3.1.i, %sw.epilog.thread.i ], [ 0, %sw.epilog.i ]
  %cb2.1337.i = phi i8 [ %cb2.0.i, %sw.epilog.thread.i ], [ 0, %sw.epilog.i ]
  %cb1.0336.i = phi i8 [ %21, %sw.epilog.thread.i ], [ 0, %sw.epilog.i ]
  %tobool141.not399.i = icmp eq i8 %32, 0
  br i1 %tobool141.not399.i, label %decode.exit, label %while.body142.i

while.body142.i:                                  ; preds = %if.else.i, %cleanup224.i
  %33 = phi i8 [ %47, %cleanup224.i ], [ %32, %if.else.i ]
  %out.addr.3401.i = phi ptr [ %incdec.ptr214.i, %cleanup224.i ], [ %buf, %if.else.i ]
  %in.addr.1400.i = phi ptr [ %incdec.ptr186.i, %cleanup224.i ], [ %copy.0, %if.else.i ]
  %34 = load i32, ptr %base64chars.i, align 4
  %tobool145.not.i = icmp eq i32 %34, 0
  br i1 %tobool145.not.i, label %if.end152.i.thread, label %if.end152.i

if.end152.i:                                      ; preds = %while.body142.i
  %dec148.i = add nsw i32 %34, -1
  store i32 %dec148.i, ptr %base64chars.i, align 4
  %35 = load i8, ptr %in.addr.1400.i, align 1
  %cmp154.i = icmp eq i8 %35, 0
  br i1 %cmp154.i, label %cleanup224.thread.i, label %if.else157.i

if.end152.i.thread:                               ; preds = %while.body142.i
  %incdec.ptr150.i = getelementptr inbounds i8, ptr %in.addr.1400.i, i64 1
  %idxprom.i399 = zext i8 %33 to i64
  %arrayidx.i400 = getelementptr inbounds [256 x i8], ptr @base64Table, i64 0, i64 %idxprom.i399
  %36 = load i8, ptr %arrayidx.i400, align 1
  %cmp.i401 = icmp eq i8 %36, -1
  %..i402 = select i1 %cmp.i401, i8 63, i8 %36
  %37 = load i8, ptr %incdec.ptr150.i, align 1
  %cmp154.i510 = icmp eq i8 %37, 0
  br i1 %cmp154.i510, label %cleanup224.thread.i, label %if.end166.i.thread

if.else157.i:                                     ; preds = %if.end152.i
  %tobool159.not.i = icmp eq i32 %dec148.i, 0
  br i1 %tobool159.not.i, label %if.end166.i.thread, label %if.end166.i

if.end166.i:                                      ; preds = %if.else157.i
  %dec162.i = add nsw i32 %34, -2
  store i32 %dec162.i, ptr %base64chars.i, align 4
  %38 = load i8, ptr %in.addr.1400.i, align 1
  %cmp168.i = icmp eq i8 %38, 0
  br i1 %cmp168.i, label %sw.bb217.i, label %if.else171.i

if.end166.i.thread:                               ; preds = %if.else157.i, %if.end152.i.thread
  %in.addr.2.i511520 = phi ptr [ %in.addr.1400.i, %if.else157.i ], [ %incdec.ptr150.i, %if.end152.i.thread ]
  %b1.0.i512519 = phi i8 [ %cb1.0336.i, %if.else157.i ], [ %..i402, %if.end152.i.thread ]
  %39 = phi i8 [ %35, %if.else157.i ], [ %37, %if.end152.i.thread ]
  %incdec.ptr164.i = getelementptr inbounds i8, ptr %in.addr.2.i511520, i64 1
  %idxprom.i395 = zext i8 %39 to i64
  %arrayidx.i396 = getelementptr inbounds [256 x i8], ptr @base64Table, i64 0, i64 %idxprom.i395
  %40 = load i8, ptr %arrayidx.i396, align 1
  %cmp.i397 = icmp eq i8 %40, -1
  %..i398 = select i1 %cmp.i397, i8 63, i8 %40
  %41 = load i8, ptr %incdec.ptr164.i, align 1
  %cmp168.i524 = icmp eq i8 %41, 0
  br i1 %cmp168.i524, label %sw.bb217.i, label %if.else177.i
...
if.then174.i:                                     ; preds = %if.else171.i
  %dec176.i = add nsw i32 %34, -3
  store i32 %dec176.i, ptr %base64chars.i, align 4
  br label %if.end180.i

if.else177.i:                                     ; preds = %if.end166.i.thread, %if.else171.i
  %b1.0.i512518525540 = phi i8 [ %cb1.0336.i, %if.else171.i ], [ %b1.0.i512519, %if.end166.i.thread ]
  %in.addr.3.i528538 = phi ptr [ %in.addr.1400.i, %if.else171.i ], [ %incdec.ptr164.i, %if.end166.i.thread ]
  %b2.1.i529537 = phi i8 [ %cb2.1337.i, %if.else171.i ], [ %..i398, %if.end166.i.thread ]
  %42 = phi i8 [ %38, %if.else171.i ], [ %41, %if.end166.i.thread ]
  %incdec.ptr178.i = getelementptr inbounds i8, ptr %in.addr.3.i528538, i64 1
  %idxprom.i391 = zext i8 %42 to i64
  %arrayidx.i392 = getelementptr inbounds [256 x i8], ptr @base64Table, i64 0, i64 %idxprom.i391
  %43 = load i8, ptr %arrayidx.i392, align 1
  %cmp.i393 = icmp eq i8 %43, -1
  %..i394 = select i1 %cmp.i393, i8 63, i8 %43
  br label %if.end180.i

if.end180.i:                                      ; preds = %if.else177.i, %if.then174.i
  %b1.0.i512518525539 = phi i8 [ %cb1.0336.i, %if.then174.i ], [ %b1.0.i512518525540, %if.else177.i ]
  %b2.1.i529536 = phi i8 [ %cb2.1337.i, %if.then174.i ], [ %b2.1.i529537, %if.else177.i ]
  %in.addr.4.i = phi ptr [ %in.addr.1400.i, %if.then174.i ], [ %incdec.ptr178.i, %if.else177.i ]
  %b3.2.i = phi i8 [ %cb3.2338.i, %if.then174.i ], [ %..i394, %if.else177.i ]
  %44 = load i8, ptr %in.addr.4.i, align 1
  %cmp182.i = icmp eq i8 %44, 0
...
sw.bb215.i:                                       ; preds = %if.end180.i
  ...
  store i8 %b3.2.i, ptr %base64_3216.i, align 2
  br label %sw.bb217.i

sw.bb217.i:                                       ; preds = %if.end166.i, %if.end166.i.thread, %sw.bb215.i
  %b2.1.i530 = phi i8 [ %b2.1.i529536, %sw.bb215.i ], [ %cb2.1337.i, %if.end166.i ], [ %..i398, %if.end166.i.thread ]
  %b1.0.i512518526 = phi i8 [ %b1.0.i512518525539, %sw.bb215.i ], [ %cb1.0336.i, %if.end166.i ], [ %b1.0.i512519, %if.end166.i.thread ]
  %nbytes143.0372.i = phi i32 [ 3, %sw.bb215.i ], [ 2, %if.end166.i.thread ], [ 2, %if.end166.i ]
  %base64_2218.i = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 11
  store i8 %b2.1.i530, ptr %base64_2218.i, align 1
  br label %cleanup224.thread.i

cleanup224.thread.i:                              ; preds = %if.end152.i, %if.end152.i.thread, %sw.bb217.i
  %b1.0.i513 = phi i8 [ %b1.0.i512518526, %sw.bb217.i ], [ %cb1.0336.i, %if.end152.i ], [ %..i402, %if.end152.i.thread ]
  %nbytes143.0371.i = phi i32 [ %nbytes143.0372.i, %sw.bb217.i ], [ 1, %if.end152.i.thread ], [ 1, %if.end152.i ]
  %base64_1220.i = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 10
  store i8 %b1.0.i513, ptr %base64_1220.i, align 8
  store i32 %nbytes143.0371.i, ptr %base64chars.i, align 4
  br label %decode.exit

cleanup224.i:                                     ; preds = %if.end180.i
  %incdec.ptr186.i = getelementptr inbounds i8, ptr %in.addr.4.i, i64 1
  %idxprom.i388 = zext i8 %44 to i64
  %arrayidx.i389 = getelementptr inbounds [256 x i8], ptr @base64Table, i64 0, i64 %idxprom.i388
  %45 = load i8, ptr %arrayidx.i389, align 1
  %shl193.i = shl i8 %b1.0.i512518525539, 2
  %shr195.i = lshr i8 %b2.1.i529536, 4
  %and196.i = and i8 %shr195.i, 3
  %or197.i = or i8 %and196.i, %shl193.i
  %incdec.ptr199.i = getelementptr inbounds i8, ptr %out.addr.3401.i, i64 1
  store i8 %or197.i, ptr %out.addr.3401.i, align 1
  %shl201.i = shl i8 %b2.1.i529536, 4
  %shr203.i = lshr i8 %b3.2.i, 2
  %and204.i = and i8 %shr203.i, 15
  %or205.i = or i8 %and204.i, %shl201.i
  %incdec.ptr207.i = getelementptr inbounds i8, ptr %out.addr.3401.i, i64 2
  store i8 %or205.i, ptr %incdec.ptr199.i, align 1
  %shl209.i = shl i8 %b3.2.i, 6
  %46 = and i8 %45, 63
  %or212.i = or i8 %46, %shl209.i
  %incdec.ptr214.i = getelementptr inbounds i8, ptr %out.addr.3401.i, i64 3
  store i8 %or212.i, ptr %incdec.ptr207.i, align 1
  %47 = load i8, ptr %incdec.ptr186.i, align 1
  %tobool141.not.i = icmp eq i8 %47, 0
  br i1 %tobool141.not.i, label %decode.exit, label %while.body142.i

decode.exit:                                      ; preds = %cleanup224.i, %while.body.i, %while.cond.preheader.i, %if.else.i, %cleanup224.thread.i
  %retval.1.i = phi ptr [ %out.addr.3401.i, %cleanup224.thread.i ], [ %buf, %while.cond.preheader.i ], [ %buf, %if.else.i ], [ %incdec.ptr27.i, %while.body.i ], [ %incdec.ptr214.i, %cleanup224.i ]
  %cmp83.not = icmp eq ptr %copy.0, %base64buf
  br i1 %cmp83.not, label %sw.epilog, label %if.then85

if.then85:                                        ; preds = %decode.exit
  call void @free(ptr noundef nonnull %copy.0) #18
  br label %sw.epilog

sw.bb87:                                          ; preds = %entry
  br i1 %tobool.not, label %sw.epilog, label %lor.lhs.false90

lor.lhs.false90:                                  ; preds = %sw.bb87
  %48 = load i8, ptr %line, align 1
  %cmp92 = icmp eq i8 %48, 0
...
if.end100:                                        ; preds = %if.end95
  %cmp.not.i = icmp eq i8 %48, 98
  %49 = and i8 %48, 63
  %cmp107 = icmp eq i8 %49, 32
  %or.cond444 = or i1 %cmp.not.i, %cmp107
  br i1 %or.cond444, label %sw.epilog, label %if.end110

if.end110:                                        ; preds = %if.end100
  %incdec.ptr111 = getelementptr inbounds i8, ptr %line, i64 1
  %sub.i282 = add i8 %48, -32
  %conv113 = zext i8 %sub.i282 to i64
  %50 = add i8 %48, -95
  %or.cond = icmp ult i8 %50, -62
...
if.end121:                                        ; preds = %if.end110
  ...
  %or.cond253 = or i1 %cmp123, %cmp126
  br i1 %or.cond253, label %if.then128, label %if.else129
...
if.else129:                                       ; preds = %if.end121
  %base64chars.i283 = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 13
  %51 = load i32, ptr %base64chars.i283, align 4
  switch i32 %51, label %sw.epilog.i359 [
    i32 3, label %sw.bb.i357
    i32 2, label %sw.bb1.i354
    i32 1, label %sw.epilog.thread.i284
  ]

sw.bb.i357:                                       ; preds = %if.else129
  %base64_3.i358 = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 12
  %52 = load i8, ptr %base64_3.i358, align 2
  br label %sw.bb1.i354

sw.bb1.i354:                                      ; preds = %sw.bb.i357, %if.else129
  %cb3.0.i355 = phi i8 [ 0, %if.else129 ], [ %52, %sw.bb.i357 ]
  %base64_2.i356 = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 11
  %53 = load i8, ptr %base64_2.i356, align 1
  br label %sw.epilog.thread.i284

sw.epilog.thread.i284:                            ; preds = %sw.bb1.i354, %if.else129
  %cb2.0.i285 = phi i8 [ 0, %if.else129 ], [ %53, %sw.bb1.i354 ]
  %cb3.1.i286 = phi i8 [ 0, %if.else129 ], [ %cb3.0.i355, %sw.bb1.i354 ]
  %base64_1.i287 = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 10
  %54 = load i8, ptr %base64_1.i287, align 8
  br label %if.else.i288

sw.epilog.i359:                                   ; preds = %if.else129
  %and130 = and i64 %call122, 3
  %cmp131 = icmp eq i64 %and130, 0
  br i1 %cmp131, label %while.cond.preheader.i360, label %if.else.i288

while.cond.preheader.i360:                        ; preds = %sw.epilog.i359
  %55 = load i8, ptr %incdec.ptr111, align 1
  %tobool3.not402.i361 = icmp eq i8 %55, 0
  br i1 %tobool3.not402.i361, label %decode.exit387, label %while.body.i362

while.body.i362:                                  ; preds = %while.cond.preheader.i360, %while.body.i362
  %56 = phi i8 [ %62, %while.body.i362 ], [ %55, %while.cond.preheader.i360 ]
  %out.addr.0404.i363 = phi ptr [ %incdec.ptr27.i385, %while.body.i362 ], [ %buf, %while.cond.preheader.i360 ]
  %in.addr.0403.i364 = phi ptr [ %incdec.ptr11.i376, %while.body.i362 ], [ %incdec.ptr111, %while.cond.preheader.i360 ]
  %incdec.ptr.i365 = getelementptr inbounds i8, ptr %in.addr.0403.i364, i64 1
  %incdec.ptr4.i367 = getelementptr inbounds i8, ptr %in.addr.0403.i364, i64 2
  %57 = load i8, ptr %incdec.ptr.i365, align 1
  %sub.i425 = add i8 %57, 32
  %incdec.ptr6.i369 = getelementptr inbounds i8, ptr %in.addr.0403.i364, i64 3
  %58 = load i8, ptr %incdec.ptr4.i367, align 1
  %sub.i424 = add i8 %58, 32
  %sub.i426 = shl i8 %56, 2
  %shr.i372 = lshr i8 %sub.i425, 4
  %and.i373 = and i8 %shr.i372, 3
  %59 = or i8 %and.i373, %sub.i426
  %or.i374 = xor i8 %59, -128
  %incdec.ptr10.i375 = getelementptr inbounds i8, ptr %out.addr.0404.i363, i64 1
  store i8 %or.i374, ptr %out.addr.0404.i363, align 1
  %incdec.ptr11.i376 = getelementptr inbounds i8, ptr %in.addr.0403.i364, i64 4
  %60 = load i8, ptr %incdec.ptr6.i369, align 1
  %sub.i423 = add i8 %60, 32
  %shl14.i378 = shl i8 %57, 4
  %shr16.i379 = lshr i8 %sub.i424, 2
  %and17.i380 = and i8 %shr16.i379, 15
  %or18.i381 = or i8 %and17.i380, %shl14.i378
  %incdec.ptr20.i382 = getelementptr inbounds i8, ptr %out.addr.0404.i363, i64 2
  store i8 %or18.i381, ptr %incdec.ptr10.i375, align 1
  %shl22.i383 = shl i8 %58, 6
  %61 = and i8 %sub.i423, 63
  %or25.i384 = or i8 %61, %shl22.i383
  %incdec.ptr27.i385 = getelementptr inbounds i8, ptr %out.addr.0404.i363, i64 3
  store i8 %or25.i384, ptr %incdec.ptr20.i382, align 1
  %62 = load i8, ptr %incdec.ptr11.i376, align 1
  %tobool3.not.i386 = icmp eq i8 %62, 0
  br i1 %tobool3.not.i386, label %decode.exit387, label %while.body.i362

if.else.i288:                                     ; preds = %sw.epilog.i359, %sw.epilog.thread.i284
  %cb3.2338.i289 = phi i8 [ %cb3.1.i286, %sw.epilog.thread.i284 ], [ 0, %sw.epilog.i359 ]
  %cb2.1337.i290 = phi i8 [ %cb2.0.i285, %sw.epilog.thread.i284 ], [ 0, %sw.epilog.i359 ]
  %cb1.0336.i291 = phi i8 [ %54, %sw.epilog.thread.i284 ], [ 0, %sw.epilog.i359 ]
  %63 = load i8, ptr %incdec.ptr111, align 1
  %tobool141.not399.i292 = icmp eq i8 %63, 0
  br i1 %tobool141.not399.i292, label %decode.exit387, label %while.body142.i293

while.body142.i293:                               ; preds = %if.else.i288, %cleanup224.i319
  %64 = phi i8 [ %74, %cleanup224.i319 ], [ %63, %if.else.i288 ]
  %out.addr.3401.i294 = phi ptr [ %incdec.ptr214.i334, %cleanup224.i319 ], [ %buf, %if.else.i288 ]
  %in.addr.1400.i295 = phi ptr [ %incdec.ptr186.i320, %cleanup224.i319 ], [ %incdec.ptr111, %if.else.i288 ]
  %65 = load i32, ptr %base64chars.i283, align 4
  %tobool145.not.i296 = icmp eq i32 %65, 0
  br i1 %tobool145.not.i296, label %if.end152.i299.thread, label %if.end152.i299

if.end152.i299:                                   ; preds = %while.body142.i293
  %dec148.i298 = add nsw i32 %65, -1
  store i32 %dec148.i298, ptr %base64chars.i283, align 4
  %66 = load i8, ptr %in.addr.1400.i295, align 1
  %cmp154.i302 = icmp eq i8 %66, 0
  br i1 %cmp154.i302, label %cleanup224.thread.i342, label %if.else157.i303

if.end152.i299.thread:                            ; preds = %while.body142.i293
  %incdec.ptr150.i352 = getelementptr inbounds i8, ptr %in.addr.1400.i295, i64 1
  %sub.i422 = add i8 %64, -32
  %67 = load i8, ptr %incdec.ptr150.i352, align 1
  %cmp154.i302543 = icmp eq i8 %67, 0
  br i1 %cmp154.i302543, label %cleanup224.thread.i342, label %if.end166.i307.thread

if.else157.i303:                                  ; preds = %if.end152.i299
  %tobool159.not.i304 = icmp eq i32 %dec148.i298, 0
  br i1 %tobool159.not.i304, label %if.end166.i307.thread, label %if.end166.i307

if.end166.i307:                                   ; preds = %if.else157.i303
  %dec162.i306 = add nsw i32 %65, -2
  store i32 %dec162.i306, ptr %base64chars.i283, align 4
  %68 = load i8, ptr %in.addr.1400.i295, align 1
  %cmp168.i310 = icmp eq i8 %68, 0
  br i1 %cmp168.i310, label %sw.bb217.i339, label %if.else171.i311

if.end166.i307.thread:                            ; preds = %if.else157.i303, %if.end152.i299.thread
  %in.addr.2.i300544553 = phi ptr [ %in.addr.1400.i295, %if.else157.i303 ], [ %incdec.ptr150.i352, %if.end152.i299.thread ]
  %b1.0.i301545552 = phi i8 [ %cb1.0336.i291, %if.else157.i303 ], [ %sub.i422, %if.end152.i299.thread ]
  %69 = phi i8 [ %66, %if.else157.i303 ], [ %67, %if.end152.i299.thread ]
  %incdec.ptr164.i349 = getelementptr inbounds i8, ptr %in.addr.2.i300544553, i64 1
  %sub.i421 = add i8 %69, -32
  %70 = load i8, ptr %incdec.ptr164.i349, align 1
  %cmp168.i310557 = icmp eq i8 %70, 0
  br i1 %cmp168.i310557, label %sw.bb217.i339, label %if.else177.i345

if.else171.i311:                                  ; preds = %if.end166.i307
  %tobool173.not.i312 = icmp eq i32 %dec162.i306, 0
  br i1 %tobool173.not.i312, label %if.else177.i345, label %if.then174.i313

if.then174.i313:                                  ; preds = %if.else171.i311
  %dec176.i314 = add nsw i32 %65, -3
  store i32 %dec176.i314, ptr %base64chars.i283, align 4
  br label %if.end180.i315

if.else177.i345:                                  ; preds = %if.end166.i307.thread, %if.else171.i311
  %b1.0.i301545551558573 = phi i8 [ %cb1.0336.i291, %if.else171.i311 ], [ %b1.0.i301545552, %if.end166.i307.thread ]
  %in.addr.3.i308561571 = phi ptr [ %in.addr.1400.i295, %if.else171.i311 ], [ %incdec.ptr164.i349, %if.end166.i307.thread ]
  %b2.1.i309562570 = phi i8 [ %cb2.1337.i290, %if.else171.i311 ], [ %sub.i421, %if.end166.i307.thread ]
  %71 = phi i8 [ %68, %if.else171.i311 ], [ %70, %if.end166.i307.thread ]
  %incdec.ptr178.i346 = getelementptr inbounds i8, ptr %in.addr.3.i308561571, i64 1
  %sub.i420 = add i8 %71, -32
  br label %if.end180.i315

if.end180.i315:                                   ; preds = %if.else177.i345, %if.then174.i313
  %b1.0.i301545551558572 = phi i8 [ %cb1.0336.i291, %if.then174.i313 ], [ %b1.0.i301545551558573, %if.else177.i345 ]
  %b2.1.i309562569 = phi i8 [ %cb2.1337.i290, %if.then174.i313 ], [ %b2.1.i309562570, %if.else177.i345 ]
  %in.addr.4.i316 = phi ptr [ %in.addr.1400.i295, %if.then174.i313 ], [ %incdec.ptr178.i346, %if.else177.i345 ]
  %b3.2.i317 = phi i8 [ %cb3.2338.i289, %if.then174.i313 ], [ %sub.i420, %if.else177.i345 ]
  %72 = load i8, ptr %in.addr.4.i316, align 1
  %cmp182.i318 = icmp eq i8 %72, 0
  br i1 %cmp182.i318, label %sw.bb215.i337, label %cleanup224.i319

sw.bb215.i337:                                    ; preds = %if.end180.i315
  %base64_3216.i338 = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 12
  store i8 %b3.2.i317, ptr %base64_3216.i338, align 2
  br label %sw.bb217.i339

sw.bb217.i339:                                    ; preds = %if.end166.i307, %if.end166.i307.thread, %sw.bb215.i337
  %b2.1.i309563 = phi i8 [ %b2.1.i309562569, %sw.bb215.i337 ], [ %cb2.1337.i290, %if.end166.i307 ], [ %sub.i421, %if.end166.i307.thread ]
  %b1.0.i301545551559 = phi i8 [ %b1.0.i301545551558572, %sw.bb215.i337 ], [ %cb1.0336.i291, %if.end166.i307 ], [ %b1.0.i301545552, %if.end166.i307.thread ]
  %base64_2218.i341 = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 11
  store i8 %b2.1.i309563, ptr %base64_2218.i341, align 1
  br label %cleanup224.thread.i342

cleanup224.thread.i342:                           ; preds = %if.end152.i299, %if.end152.i299.thread, %sw.bb217.i339
  %b1.0.i301546 = phi i8 [ %b1.0.i301545551559, %sw.bb217.i339 ], [ %cb1.0336.i291, %if.end152.i299 ], [ %sub.i422, %if.end152.i299.thread ]
  %base64_1220.i344 = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 10
  store i8 %b1.0.i301546, ptr %base64_1220.i344, align 8
  br label %decode.exit387

cleanup224.i319:                                  ; preds = %if.end180.i315
  %incdec.ptr186.i320 = getelementptr inbounds i8, ptr %in.addr.4.i316, i64 1
  %sub.i419 = add i8 %72, 32
  %shl193.i322 = shl i8 %b1.0.i301545551558572, 2
  %shr195.i323 = lshr i8 %b2.1.i309562569, 4
  %and196.i324 = and i8 %shr195.i323, 3
  %or197.i325 = or i8 %and196.i324, %shl193.i322
  %incdec.ptr199.i326 = getelementptr inbounds i8, ptr %out.addr.3401.i294, i64 1
  store i8 %or197.i325, ptr %out.addr.3401.i294, align 1
  %shl201.i327 = shl i8 %b2.1.i309562569, 4
  %shr203.i328 = lshr i8 %b3.2.i317, 2
  %and204.i329 = and i8 %shr203.i328, 15
  %or205.i330 = or i8 %and204.i329, %shl201.i327
  %incdec.ptr207.i331 = getelementptr inbounds i8, ptr %out.addr.3401.i294, i64 2
  store i8 %or205.i330, ptr %incdec.ptr199.i326, align 1
  %shl209.i332 = shl i8 %b3.2.i317, 6
  %73 = and i8 %sub.i419, 63
  %or212.i333 = or i8 %73, %shl209.i332
  %incdec.ptr214.i334 = getelementptr inbounds i8, ptr %out.addr.3401.i294, i64 3
  store i8 %or212.i333, ptr %incdec.ptr207.i331, align 1
  %74 = load i8, ptr %incdec.ptr186.i320, align 1
  %tobool141.not.i335 = icmp eq i8 %74, 0
  br i1 %tobool141.not.i335, label %decode.exit387, label %while.body142.i293

decode.exit387:                                   ; preds = %cleanup224.i319, %while.body.i362, %while.cond.preheader.i360, %if.else.i288, %cleanup224.thread.i342
  %arrayidx134 = getelementptr inbounds i8, ptr %buf, i64 %conv113
  br label %if.end135

if.end135:                                        ; preds = %decode.exit387, %if.then128
  %buf.addr.5 = phi ptr [ %buf, %if.then128 ], [ %arrayidx134, %decode.exit387 ]
  %base64chars = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 13
  store i32 0, ptr %base64chars, align 4
  br label %sw.epilog

sw.bb136:                                         ; preds = %entry
  br i1 %tobool.not, label %sw.epilog, label %lor.lhs.false139

lor.lhs.false139:                                 ; preds = %sw.bb136
  %75 = load i8, ptr %line, align 1
  %cmp141 = icmp eq i8 %75, 0
...
if.then156:                                       ; preds = %while.cond150
  ...
  %77 = load i8, ptr %incdec.ptr157, align 1
  %cmp159 = icmp eq i8 %77, 0
...
if.end175:                                        ; preds = %if.else168, %if.end162
  %storemerge = phi i8 [ %79, %if.else168 ], [ %78, %if.end162 ]
  ...
  store i8 %storemerge, ptr %buf.addr.6, align 1
  %.pr = load i8, ptr %line.addr.5, align 1
  br label %while.cond150

sw.epilog:                                        ; preds = %if.then10, %if.then10, %while.cond150, %if.then156, %if.end100, %if.end144, %sw.bb136, %lor.lhs.false139, %if.end110, %if.end95, %sw.bb87, %lor.lhs.false90, %decode.exit, %if.then85, %if.else63, %sw.bb52, %if.then49, %if.end135, %if.then3
  %buf.addr.8 = phi ptr [ %incdec.ptr, %if.then3 ], [ %incdec.ptr50, %if.then49 ], [ %buf, %sw.bb52 ], [ %retval.1.i, %if.then85 ], [ %retval.1.i, %decode.exit ], [ %buf, %if.else63 ], [ %buf, %sw.bb87 ], [ %buf, %lor.lhs.false90 ], [ %buf, %if.end95 ], [ %buf, %if.end110 ], [ %buf.addr.5, %if.end135 ], [ %buf, %sw.bb136 ], [ %buf, %lor.lhs.false139 ], [ %buf, %if.end144 ], [ %buf, %if.end100 ], [ %buf.addr.6, %if.then156 ], [ %buf.addr.6, %while.cond150 ], [ %buf.addr.1476, %if.then10 ], [ %buf.addr.1476, %if.then10 ]
  store i8 0, ptr %buf.addr.8, align 1
  br label %cleanup177
...
define dso_local void @messageClearMarkers(ptr nocapture noundef writeonly %m) local_unnamed_addr #13 {
entry:
  %bounce = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 15
  %encoding = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 18
...
define dso_local i32 @isuuencodebegin(ptr nocapture noundef readonly %line) local_unnamed_addr #14 {
entry:
...
land.lhs.true23:                                  ; preds = %land.lhs.true14
  ...
  %9 = load i16, ptr %arrayidx28, align 2
  %10 = and i16 %9, 2048
...
define dso_local void @messageSetCTX(ptr nocapture noundef writeonly %m, ptr noundef %ctx) local_unnamed_addr #15 {
entry:
...
attributes #13 = { mustprogress nofree nosync nounwind willreturn memory(argmem: write) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
