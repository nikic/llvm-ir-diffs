...
if.end.i132:                                      ; preds = %lor.lhs.false17
  ...
  store ptr %call1.i133, ptr %call.i130, align 8, !tbaa !24
...
push.exit138:                                     ; preds = %if.end.i132
  ...
  store ptr %call.i, ptr %next.i136, align 8, !tbaa !26
  br label %while.body
...
while.body:                                       ; preds = %push.exit138, %if.end85
  ...
  %0 = load ptr, ptr %top.2226, align 8, !tbaa !24
  ...
  %2 = load ptr, ptr %top.2226, align 8, !tbaa !24
...
if.then.i143:                                     ; preds = %while.body
  ...
  %4 = load ptr, ptr %next.i145, align 8, !tbaa !26
...
while.body.i:                                     ; preds = %if.end49.i, %while.body.lr.ph.i
  ...
  %7 = load i8, ptr %s1.095.i, align 1, !tbaa !20
  ...
  %9 = load i8, ptr %s2.094.i, align 1, !tbaa !20
...
if.end.i153:                                      ; preds = %if.then48
  ...
  store ptr %call1.i154, ptr %call.i151, align 8, !tbaa !24
...
lor.lhs.false53:                                  ; preds = %if.end.i153
  ...
  store ptr %top.4, ptr %next.i157, align 8, !tbaa !26
...
if.end.i162:                                      ; preds = %lor.lhs.false53
  ...
  store ptr %call1.i163, ptr %call.i160, align 8, !tbaa !24
...
push.exit168:                                     ; preds = %if.end.i162
  ...
  store ptr %call.i151, ptr %next.i166, align 8, !tbaa !26
  br label %if.end60
...
if.end.i171:                                      ; preds = %if.then74
  ...
  store ptr %call1.i172, ptr %call.i169, align 8, !tbaa !24
...
lor.lhs.false78:                                  ; preds = %if.end.i171
  ...
  store ptr %top.7, ptr %next.i175, align 8, !tbaa !26
...
if.end.i180:                                      ; preds = %lor.lhs.false78
  ...
  store ptr %call1.i181, ptr %call.i178, align 8, !tbaa !24
...
push.exit186:                                     ; preds = %if.end.i180
  ...
  store ptr %call.i169, ptr %next.i184, align 8, !tbaa !26
  br label %if.end85
...
for.inc:                                          ; preds = %lor.lhs.false, %if.end
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %cleanup46, label %lor.lhs.false, !llvm.loop !47
...
for.inc.i:                                        ; preds = %if.end.i, %lor.lhs.false.i
  ...
  br i1 %exitcond.not.i, label %lor.rhs, label %lor.lhs.false.i, !llvm.loop !49
...
lor.lhs.false.lr.ph.i8:                           ; preds = %lor.rhs
  %m.val36.i9 = load ptr, ptr %1, align 8, !tbaa !13
...
if.then8.i23:                                     ; preds = %if.end.i17
  ...
  %10 = load ptr, ptr %call9.i25, align 8, !tbaa !15
...
for.inc.i20:                                      ; preds = %if.end.i17, %lor.lhs.false.i11
  ...
  br i1 %exitcond.not.i22, label %lor.end, label %lor.lhs.false.i11, !llvm.loop !49
...
for.cond43.preheader:                             ; preds = %if.end37
  ...
  %.pre = load ptr, ptr %encodingTypes, align 8, !tbaa !19
...
for.body46.lr.ph:                                 ; preds = %for.cond43.preheader
  ...
  %11 = load i32, ptr %type49, align 8, !tbaa !52
...
for.body46:                                       ; preds = %for.body46.lr.ph, %for.cond43
  ...
  %12 = load i32, ptr %arrayidx48, align 4, !tbaa !20
...
if.end67:                                         ; preds = %if.end59
  ...
  %13 = load i32, ptr %type69, align 8, !tbaa !52
  %14 = load i32, ptr %numberOfEncTypes, align 8, !tbaa !51
  ...
  store i32 %13, ptr %arrayidx74, align 4, !tbaa !20
...
for.inc85:                                        ; preds = %if.else, %for.body, %if.end31
  ...
  %16 = load ptr, ptr %incdec.ptr86, align 8, !tbaa !55
  %tobool9.not = icmp eq ptr %16, null
  br i1 %tobool9.not, label %if.then91.loopexit, label %for.body, !llvm.loop !56
...
for.cond:                                         ; preds = %lor.lhs.false
  ...
  br i1 %or.cond, label %lor.lhs.false, label %for.end.loopexit, !llvm.loop !66
...
if.end15.thread:                                  ; preds = %for.end.loopexit
  ...
  %8 = load ptr, ptr %body_first158, align 8, !tbaa !18
...
if.then18:                                        ; preds = %if.end15.thread, %if.end15
  ...
  store ptr %call19, ptr %body_first163, align 8, !tbaa !18
  %body_last = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 8
...
land.lhs.true56:                                  ; preds = %land.lhs.true52
  ...
  %.pre = load ptr, ptr %body_last35, align 8, !tbaa !58
  br i1 %cmp61, label %if.then63, label %if.end66

if.then63:                                        ; preds = %land.lhs.true56
  %16 = load ptr, ptr %.pre, align 8, !tbaa !61
  br label %if.end66
...
if.end66:                                         ; preds = %if.then63, %land.lhs.true56, %land.lhs.true52, %if.end50
  ...
  %18 = load ptr, ptr %t_next68, align 8, !tbaa !59
  store ptr %18, ptr %body_last35, align 8, !tbaa !58
  br label %if.end70
...
land.lhs.true79:                                  ; preds = %if.end75
  %20 = load i8, ptr %data.addr.1160, align 1, !tbaa !20
...
if.then84:                                        ; preds = %if.then82
  ...
  %21 = load ptr, ptr %body_last71, align 8, !tbaa !58
  store ptr %call85, ptr %21, align 8, !tbaa !61
  br label %cleanup
...
if.else88:                                        ; preds = %if.then82
  ...
  store ptr %call89, ptr %22, align 8, !tbaa !61
...
if.then96:                                        ; preds = %if.else88
  ...
  store ptr %call97, ptr %23, align 8, !tbaa !61
...
sw.epilog.thread:                                 ; preds = %sw.bb1, %entry
  ...
  %3 = load i8, ptr %base64_1, align 8, !tbaa !75
  br label %if.else
...
while.body:                                       ; preds = %while.cond.preheader, %while.body
  ...
  %call = tail call zeroext i8 %decoder(i8 noundef signext %5) #18, !callees !76
  %incdec.ptr4 = getelementptr inbounds i8, ptr %in.addr.0403, i64 2
  %6 = load i8, ptr %incdec.ptr, align 1, !tbaa !20
  %call5 = tail call zeroext i8 %decoder(i8 noundef signext %6) #18, !callees !76
  %incdec.ptr6 = getelementptr inbounds i8, ptr %in.addr.0403, i64 3
  %7 = load i8, ptr %incdec.ptr4, align 1, !tbaa !20
  %call7 = tail call zeroext i8 %decoder(i8 noundef signext %7) #18, !callees !76
  %shl = shl i8 %call, 2
  %shr = lshr i8 %call5, 4
  %and = and i8 %shr, 3
  %or = or i8 %and, %shl
  %incdec.ptr10 = getelementptr inbounds i8, ptr %out.addr.0404, i64 1
  store i8 %or, ptr %out.addr.0404, align 1, !tbaa !20
  %incdec.ptr11 = getelementptr inbounds i8, ptr %in.addr.0403, i64 4
  %8 = load i8, ptr %incdec.ptr6, align 1, !tbaa !20
  %call12 = tail call zeroext i8 %decoder(i8 noundef signext %8) #18, !callees !76
  ...
  %10 = load i8, ptr %incdec.ptr11, align 1, !tbaa !20
  %tobool3.not = icmp eq i8 %10, 0
  br i1 %tobool3.not, label %cleanup229, label %while.body, !llvm.loop !77

if.else:                                          ; preds = %sw.epilog.thread, %sw.epilog
  %cb3.2337 = phi i8 [ %cb3.1, %sw.epilog.thread ], [ 0, %sw.epilog ]
  %cb2.1336 = phi i8 [ %cb2.0, %sw.epilog.thread ], [ 0, %sw.epilog ]
  %cb1.0335 = phi i8 [ %3, %sw.epilog.thread ], [ 0, %sw.epilog ]
  %cmp = icmp eq ptr %in, null
  br i1 %cmp, label %if.then29, label %while.cond140.preheader

while.cond140.preheader:                          ; preds = %if.else
  %11 = load i8, ptr %in, align 1, !tbaa !20
...
if.end:                                           ; preds = %if.then29
  ...
  %12 = load ptr, ptr %call35, align 8, !tbaa !15
  %conv36 = zext i8 %cb1.0335 to i32
  %idxprom = zext i8 %cb1.0335 to i64
  %arrayidx = getelementptr inbounds i16, ptr %12, i64 %idxprom
  %13 = load i16, ptr %arrayidx, align 2, !tbaa !21
  %14 = and i16 %13, 8
  %tobool39.not = icmp eq i16 %14, 0
  %cond = select i1 %tobool39.not, i32 64, i32 %conv36
  %conv42 = zext i8 %cb2.1336 to i32
  %idxprom43 = zext i8 %cb2.1336 to i64
  %arrayidx44 = getelementptr inbounds i16, ptr %12, i64 %idxprom43
  %15 = load i16, ptr %arrayidx44, align 2, !tbaa !21
  %16 = and i16 %15, 8
  %tobool47.not = icmp eq i16 %16, 0
  %cond52 = select i1 %tobool47.not, i32 64, i32 %conv42
  %conv54 = zext i8 %cb3.2337 to i32
  %idxprom55 = zext i8 %cb3.2337 to i64
  %arrayidx56 = getelementptr inbounds i16, ptr %12, i64 %idxprom55
  %17 = load i16, ptr %arrayidx56, align 2, !tbaa !21
  %18 = and i16 %17, 8
  ...
  %19 = load i32, ptr %base64chars, align 4, !tbaa !72
...
if.else76:                                        ; preds = %if.then68
  %tobool77.not = icmp eq i8 %cb2.1336, 0
...
sw.bb83:                                          ; preds = %if.then68
  ...
  %shl85 = shl i8 %cb1.0335, 2
  %shr87 = lshr i8 %cb2.1336, 4
  ...
  %shl93 = shl i8 %cb2.1336, 4
  %shr95 = lshr i8 %cb3.2337, 2
...
sw.bb113:                                         ; preds = %if.else76
  %shl115 = shl i8 %cb1.0335, 2
  %shr117 = lshr i8 %cb2.1336, 4
...
while.body142:                                    ; preds = %while.cond140.preheader, %cleanup224
  ...
  %22 = load i32, ptr %base64chars, align 4, !tbaa !72
...
if.else149:                                       ; preds = %while.body142
  ...
  %call151 = tail call zeroext i8 %decoder(i8 noundef signext %21) #18, !callees !76
  br label %if.end152

if.end152:                                        ; preds = %if.else149, %if.then146
  %in.addr.2 = phi ptr [ %in.addr.1400, %if.then146 ], [ %incdec.ptr150, %if.else149 ]
  %b1.0 = phi i8 [ %cb1.0335, %if.then146 ], [ %call151, %if.else149 ]
  %23 = load i8, ptr %in.addr.2, align 1, !tbaa !20
  %cmp154 = icmp eq i8 %23, 0
  br i1 %cmp154, label %cleanup224.thread, label %if.else157

if.else157:                                       ; preds = %if.end152
  %24 = load i32, ptr %base64chars, align 4, !tbaa !72
...
if.else163:                                       ; preds = %if.else157
  ...
  %call165 = tail call zeroext i8 %decoder(i8 noundef signext %23) #18, !callees !76
  br label %if.end166

if.end166:                                        ; preds = %if.else163, %if.then160
  %in.addr.3 = phi ptr [ %in.addr.2, %if.then160 ], [ %incdec.ptr164, %if.else163 ]
  %b2.1 = phi i8 [ %cb2.1336, %if.then160 ], [ %call165, %if.else163 ]
  %25 = load i8, ptr %in.addr.3, align 1, !tbaa !20
  %cmp168 = icmp eq i8 %25, 0
  br i1 %cmp168, label %sw.bb217, label %if.else171

if.else171:                                       ; preds = %if.end166
  %26 = load i32, ptr %base64chars, align 4, !tbaa !72
...
if.else177:                                       ; preds = %if.else171
  ...
  %call179 = tail call zeroext i8 %decoder(i8 noundef signext %25) #18, !callees !76
  br label %if.end180

if.end180:                                        ; preds = %if.else177, %if.then174
  %in.addr.4 = phi ptr [ %in.addr.3, %if.then174 ], [ %incdec.ptr178, %if.else177 ]
  %b3.2 = phi i8 [ %cb3.2337, %if.then174 ], [ %call179, %if.else177 ]
  %27 = load i8, ptr %in.addr.4, align 1, !tbaa !20
...
sw.bb215:                                         ; preds = %if.end180
  ...
  store i8 %b3.2, ptr %base64_3216, align 2, !tbaa !73
  br label %sw.bb217
...
sw.bb217:                                         ; preds = %if.end166, %sw.bb215
  ...
  store i8 %b2.1, ptr %base64_2218, align 1, !tbaa !74
...
cleanup224.thread:                                ; preds = %if.end152, %sw.bb217
  ...
  store i8 %b1.0, ptr %base64_1220, align 8, !tbaa !75
  store i32 %nbytes143.0371, ptr %base64chars, align 4, !tbaa !72
  br label %cleanup229

cleanup224:                                       ; preds = %if.end180
  %incdec.ptr186 = getelementptr inbounds i8, ptr %in.addr.4, i64 1
  %call187 = tail call zeroext i8 %decoder(i8 noundef signext %27) #18, !callees !76
  ...
  store i8 %or197, ptr %out.addr.3401, align 1, !tbaa !20
  ...
  %29 = load i8, ptr %incdec.ptr186, align 1, !tbaa !20
  %tobool141.not = icmp eq i8 %29, 0
  br i1 %tobool141.not, label %cleanup229, label %while.body142

cleanup229:                                       ; preds = %cleanup224, %while.body, %while.cond140.preheader, %while.cond.preheader, %sw.bb113, %if.then126, %if.then104, %sw.bb83, %sw.bb132, %cleanup224.thread, %if.then29
  %retval.1 = phi ptr [ %out, %if.then29 ], [ %out.addr.3401, %cleanup224.thread ], [ %incdec.ptr99, %sw.bb83 ], [ %incdec.ptr111, %if.then104 ], [ %incdec.ptr121, %sw.bb113 ], [ %incdec.ptr130, %if.then126 ], [ %incdec.ptr136, %sw.bb132 ], [ %out, %while.cond.preheader ], [ %out, %while.cond140.preheader ], [ %incdec.ptr27, %while.body ], [ %incdec.ptr214, %cleanup224 ]
  ret ptr %retval.1
}
...
land.rhs.i:                                       ; preds = %while.cond.i
  ...
  br i1 %cmp10.i, label %while.cond.i, label %while.end.i, !llvm.loop !78
...
for.inc.i:                                        ; preds = %sw.bb94.i, %sw.bb80.i, %sw.bb69.i, %sw.bb.i, %if.end63.i, %for.body.i, %for.body.i
  ...
  br i1 %exitcond.not.i, label %cleanup103.i, label %for.body.i, !llvm.loop !79
...
while.body142.i:                                  ; preds = %while.body142.i, %while.body142.preheader.i
  ...
  br i1 %cmp140.i, label %while.body142.i, label %if.end146.i, !llvm.loop !80
...
if.end146.i:                                      ; preds = %while.body142.i, %if.else136.i, %if.then134.i, %land.lhs.true123.i, %for.body117.i
  ...
  br i1 %cmp115.i, label %for.body117.i, label %cleanup152.i, !llvm.loop !81
...
land.lhs.true265.i:                               ; preds = %if.then262.i, %if.end186.i
  ...
  %26 = load ptr, ptr %ctx.i, align 8, !tbaa !82
...
if.end269.i:                                      ; preds = %if.then267.i, %land.lhs.true265.i
  ...
  call void @fileblobAddData(ptr noundef nonnull %call1.i, ptr noundef nonnull %arrayidx271.i, i64 noundef %dataforklen.0.i) #18, !callees !83
  call void @blobDestroy(ptr noundef nonnull %tmp.1.i) #18
...
if.end302.i:                                      ; preds = %if.end4.i
  %.pr.pre.i = load i32, ptr %numberOfEncTypes.i, align 8, !tbaa !51
...
land.lhs.true338.i:                               ; preds = %if.end328.i, %if.end302.i, %land.lhs.true282.i, %if.end274.i
  ...
  %34 = load ptr, ptr %ctx339.i, align 8, !tbaa !82
...
if.then429.i:                                     ; preds = %if.then415.i, %if.else412.i
  %45 = load i8, ptr %retval.0.i42.i, align 1, !tbaa !20
...
if.end175.i:                                      ; preds = %if.else168.i, %if.end162.i
  ...
  %.pr.i = load i8, ptr %line.addr.5.i, align 1, !tbaa !20
  br label %while.cond150.i, !llvm.loop !84
...
if.then488.us.i:                                  ; preds = %if.end485.us.i
  ...
  call void @fileblobAddData(ptr noundef %ret.23256.i, ptr noundef %data448.0.us.i, i64 noundef %sub.ptr.sub.us.i) #18, !callees !83
...
do.cond.us.i:                                     ; preds = %if.then506.us.i, %land.lhs.true501.us.i, %if.end497.us.i, %do.body.us.i
  ...
  br i1 %cmp520.not.us.i, label %do.end.i, label %do.body.us.i, !llvm.loop !85
...
if.then488.i:                                     ; preds = %if.end485.i
  ...
  call void @fileblobAddData(ptr noundef %ret.23256.i, ptr noundef %data448.0.i, i64 noundef %sub.ptr.sub.i) #18, !callees !83
...
do.cond.i:                                        ; preds = %if.then506.i, %land.lhs.true501.i, %if.end497.i
  ...
  br i1 %cmp520.not.i, label %do.end.i, label %do.body.i, !llvm.loop !85
...
if.then529.i:                                     ; preds = %base64Flush.exit.i
  ...
  call void @fileblobAddData(ptr noundef %ret.23256.i, ptr noundef nonnull %data524.i, i64 noundef %sub.ptr.sub534.i) #18, !callees !83
...
for.inc541.i:                                     ; preds = %if.end535.i, %do.end.i, %if.end444.i
  ...
  br i1 %cmp346.i, label %for.body348.i, label %messageExport.specialized.2.exit, !llvm.loop !86

messageExport.specialized.2.exit:                 ; preds = %for.inc541.i, %entry, %if.end.i, %if.then16.i, %if.then20.i, %cleanup103.thread.i, %cleanup152.thread.i, %if.then159.i, %if.then165.i, %if.then173.i, %if.then287.i, %if.then332.i, %if.end343.i, %cleanup360.thread.i, %if.then433.i, %cleanup537.i
  %retval.10.i = phi ptr [ %call334.i, %if.then332.i ], [ null, %entry ], [ null, %if.end.i ], [ %ret.23256.i, %cleanup537.i ], [ null, %cleanup152.thread.i ], [ null, %cleanup103.thread.i ], [ %call1.i, %if.then287.i ], [ null, %if.then173.i ], [ null, %if.then165.i ], [ null, %if.then159.i ], [ null, %if.then20.i ], [ null, %if.then16.i ], [ %ret.0117.i, %cleanup360.thread.i ], [ null, %if.then433.i ], [ %call1.i, %if.end343.i ], [ %ret.23256.i, %for.inc541.i ]
...
if.end269.i:                                      ; preds = %if.then262.i, %if.end186.i
  %dataforklen.0.i = phi i64 [ %sub259.i, %if.then262.i ], [ %or221.i, %if.end186.i ]
  %arrayidx271.i = getelementptr inbounds i8, ptr %data.1.i, i64 %conv258.i
  call void @blobAddData(ptr noundef nonnull %call1.i, ptr noundef nonnull %arrayidx271.i, i64 noundef %dataforklen.0.i) #18, !callees !87
  call void @blobDestroy(ptr noundef nonnull %tmp.1.i) #18
  %tobool272.not.i = icmp eq i32 %destroy, 0
  br i1 %tobool272.not.i, label %if.end274.i, label %if.then273.i
...
if.then429.i:                                     ; preds = %if.then415.i, %if.else412.i
  %42 = load i8, ptr %retval.0.i42.i, align 1, !tbaa !20
...
if.then488.us.i:                                  ; preds = %if.end485.us.i
  ...
  %sub.ptr.rhs.cast.us.i = ptrtoint ptr %data448.0.us.i to i64
  %sub.ptr.sub.us.i = sub i64 %sub.ptr.lhs.cast.us.i, %sub.ptr.rhs.cast.us.i
  call void @blobAddData(ptr noundef %ret.23256.i, ptr noundef %data448.0.us.i, i64 noundef %sub.ptr.sub.us.i) #18, !callees !87
  %add492.us.i = add i64 %sub.ptr.sub.us.i, %size.0.us.i
  br label %if.end493.us.i
...
if.then488.i:                                     ; preds = %if.end485.i
  ...
  %sub.ptr.rhs.cast.i = ptrtoint ptr %data448.0.i to i64
  %sub.ptr.sub.i = sub i64 %sub.ptr.lhs.cast.i, %sub.ptr.rhs.cast.i
  call void @blobAddData(ptr noundef %ret.23256.i, ptr noundef %data448.0.i, i64 noundef %sub.ptr.sub.i) #18, !callees !87
  %add492.i = add i64 %sub.ptr.sub.i, %size.0.i
  br label %if.end493.i
...
if.then529.i:                                     ; preds = %base64Flush.exit.i
  %sub.ptr.lhs.cast532.i = ptrtoint ptr %call.i6.i to i64
  %sub.ptr.sub534.i = sub i64 %sub.ptr.lhs.cast532.i, %sub.ptr.rhs.cast533.i
  call void @blobAddData(ptr noundef %ret.23256.i, ptr noundef nonnull %data524.i, i64 noundef %sub.ptr.sub534.i) #18, !callees !87
  br label %if.end535.i
...
for.inc541.i:                                     ; preds = %if.end535.i, %do.end.i, %if.end444.i
  ...
  br i1 %cmp346.i, label %for.body348.i, label %messageExport.specialized.1.exit, !llvm.loop !86

messageExport.specialized.1.exit:                 ; preds = %for.inc541.i, %entry, %if.end.i, %if.then16.i, %if.then20.i, %cleanup103.thread.i, %cleanup152.thread.i, %if.then159.i, %if.then165.i, %if.then173.i, %if.then287.i, %if.then332.i, %if.end343.i, %cleanup360.thread.i, %if.then433.i, %cleanup537.i
  %retval.10.i = phi ptr [ %call334.i, %if.then332.i ], [ null, %entry ], [ null, %if.end.i ], [ %ret.23256.i, %cleanup537.i ], [ null, %cleanup152.thread.i ], [ null, %cleanup103.thread.i ], [ %call1.i, %if.then287.i ], [ null, %if.then173.i ], [ null, %if.then165.i ], [ null, %if.then159.i ], [ null, %if.then20.i ], [ null, %if.then16.i ], [ %ret.0117.i, %cleanup360.thread.i ], [ null, %if.then433.i ], [ %call1.i, %if.end343.i ], [ %ret.23256.i, %for.inc541.i ]
  %tobool.not = icmp eq i32 %destroy, 0
  br i1 %tobool.not, label %if.end, label %land.lhs.true
...
for.inc:                                          ; preds = %if.end11, %if.then14
  ...
  store ptr %storemerge277, ptr %call3, align 8, !tbaa !61
  ...
  br i1 %tobool.not, label %if.then23, label %for.body, !llvm.loop !88
...
sw.bb:                                            ; preds = %for.body30, %for.body30, %for.body30
  %t_line.1300 = load ptr, ptr %body_first.i278, align 8, !tbaa !15
...
for.inc59:                                        ; preds = %if.end49, %if.then52
  ...
  br i1 %tobool33.not, label %for.inc185, label %for.body34, !llvm.loop !89
...
if.end81:                                         ; preds = %if.then80, %land.lhs.true, %sw.default
  %t_line.2306 = load ptr, ptr %body_first.i278, align 8, !tbaa !15
...
for.inc148:                                       ; preds = %if.end135, %if.then140, %for.body85
  ...
  br i1 %tobool84.not, label %for.end150, label %for.body85, !llvm.loop !90
...
for.inc185:                                       ; preds = %for.inc59, %sw.bb, %if.end179, %for.end150
  ...
  br i1 %cmp29, label %for.body30, label %for.end186, !llvm.loop !91
...
land.rhs:                                         ; preds = %while.cond.preheader, %if.end46
  ...
  %0 = load i8, ptr %line.addr.0477, align 1, !tbaa !20
...
if.then29:                                        ; preds = %hex.exit, %hex.exit
  ...
  store i8 %retval.0.i, ptr %buf.addr.1476, align 1, !tbaa !20
  br label %if.then49
...
if.then35:                                        ; preds = %if.end31
  ...
  %9 = load i16, ptr %arrayidx.i257, align 2, !tbaa !21
  %10 = and i16 %9, 2048
...
for.body.i:                                       ; preds = %if.end73, %for.inc12.i
  ...
  %14 = load i8, ptr %arrayidx.i273, align 1, !tbaa !20
...
for.body8.i:                                      ; preds = %for.body.i, %for.body8.i
  ...
  br i1 %cmp6.not.i, label %for.end.i, label %for.body8.i, !llvm.loop !93
...
for.inc12.i:                                      ; preds = %for.end.i, %for.body.i
  ...
  br i1 %tobool.not.i274, label %sanitiseBase64.exit, label %for.body.i, !llvm.loop !94
...
sw.bb.i:                                          ; preds = %land.end80
  ...
  %19 = load i8, ptr %base64_3.i, align 2, !tbaa !73
  br label %sw.bb1.i
...
sw.bb1.i:                                         ; preds = %sw.bb.i, %land.end80
  ...
  %20 = load i8, ptr %base64_2.i, align 1, !tbaa !74
...
sw.epilog.thread.i:                               ; preds = %sw.bb1.i, %land.end80
  ...
  %21 = load i8, ptr %base64_1.i, align 8, !tbaa !75
  %.pre = load i8, ptr %copy.0, align 1, !tbaa !20
  br label %if.else.i

sw.epilog.i:                                      ; preds = %land.end80
  %.pre507 = load i8, ptr %copy.0, align 1, !tbaa !20
...
while.body.i:                                     ; preds = %while.cond.preheader.i, %while.body.i
  ...
  %23 = load i8, ptr %arrayidx.i416, align 1, !tbaa !20
  ...
  %25 = load i8, ptr %arrayidx.i412, align 1, !tbaa !20
  ...
  %31 = load i8, ptr %incdec.ptr11.i276, align 1, !tbaa !20
  %tobool3.not.i = icmp eq i8 %31, 0
  br i1 %tobool3.not.i, label %decode.exit, label %while.body.i, !llvm.loop !77

if.else.i:                                        ; preds = %sw.epilog.i, %sw.epilog.thread.i
  %32 = phi i8 [ %.pre, %sw.epilog.thread.i ], [ %.pre507, %sw.epilog.i ]
  %cb3.2337.i = phi i8 [ %cb3.1.i, %sw.epilog.thread.i ], [ 0, %sw.epilog.i ]
  %cb2.1336.i = phi i8 [ %cb2.0.i, %sw.epilog.thread.i ], [ 0, %sw.epilog.i ]
  %cb1.0335.i = phi i8 [ %21, %sw.epilog.thread.i ], [ 0, %sw.epilog.i ]
...
while.body142.i:                                  ; preds = %if.else.i, %cleanup224.i
  ...
  %34 = load i32, ptr %base64chars.i, align 4, !tbaa !72
...
if.end152.i:                                      ; preds = %while.body142.i
  ...
  %35 = load i8, ptr %in.addr.1400.i, align 1, !tbaa !20
...
if.end152.i.thread:                               ; preds = %while.body142.i
  ...
  %36 = load i8, ptr %arrayidx.i400, align 1, !tbaa !20
  %cmp.i401 = icmp eq i8 %36, -1
  %..i402 = select i1 %cmp.i401, i8 63, i8 %36
  %37 = load i8, ptr %incdec.ptr150.i, align 1, !tbaa !20
...
if.end166.i:                                      ; preds = %if.else157.i
  ...
  %38 = load i8, ptr %in.addr.1400.i, align 1, !tbaa !20
...
if.end166.i.thread:                               ; preds = %if.else157.i, %if.end152.i.thread
  ...
  %b1.0.i512519 = phi i8 [ %cb1.0335.i, %if.else157.i ], [ %..i402, %if.end152.i.thread ]
  ...
  %40 = load i8, ptr %arrayidx.i396, align 1, !tbaa !20
  %cmp.i397 = icmp eq i8 %40, -1
  %..i398 = select i1 %cmp.i397, i8 63, i8 %40
  %41 = load i8, ptr %incdec.ptr164.i, align 1, !tbaa !20
...
if.else177.i:                                     ; preds = %if.end166.i.thread, %if.else171.i
  %b1.0.i512518525540 = phi i8 [ %cb1.0335.i, %if.else171.i ], [ %b1.0.i512519, %if.end166.i.thread ]
  %in.addr.3.i528538 = phi ptr [ %in.addr.1400.i, %if.else171.i ], [ %incdec.ptr164.i, %if.end166.i.thread ]
  %b2.1.i529537 = phi i8 [ %cb2.1336.i, %if.else171.i ], [ %..i398, %if.end166.i.thread ]
  ...
  %43 = load i8, ptr %arrayidx.i392, align 1, !tbaa !20
  %cmp.i393 = icmp eq i8 %43, -1
  %..i394 = select i1 %cmp.i393, i8 63, i8 %43
  br label %if.end180.i

if.end180.i:                                      ; preds = %if.else177.i, %if.then174.i
  %b1.0.i512518525539 = phi i8 [ %cb1.0335.i, %if.then174.i ], [ %b1.0.i512518525540, %if.else177.i ]
  %b2.1.i529536 = phi i8 [ %cb2.1336.i, %if.then174.i ], [ %b2.1.i529537, %if.else177.i ]
  %in.addr.4.i = phi ptr [ %in.addr.1400.i, %if.then174.i ], [ %incdec.ptr178.i, %if.else177.i ]
  %b3.2.i = phi i8 [ %cb3.2337.i, %if.then174.i ], [ %..i394, %if.else177.i ]
  %44 = load i8, ptr %in.addr.4.i, align 1, !tbaa !20
...
sw.bb215.i:                                       ; preds = %if.end180.i
  ...
  store i8 %b3.2.i, ptr %base64_3216.i, align 2, !tbaa !73
  br label %sw.bb217.i

sw.bb217.i:                                       ; preds = %if.end166.i, %if.end166.i.thread, %sw.bb215.i
  %b2.1.i530 = phi i8 [ %b2.1.i529536, %sw.bb215.i ], [ %cb2.1336.i, %if.end166.i ], [ %..i398, %if.end166.i.thread ]
  %b1.0.i512518526 = phi i8 [ %b1.0.i512518525539, %sw.bb215.i ], [ %cb1.0335.i, %if.end166.i ], [ %b1.0.i512519, %if.end166.i.thread ]
  ...
  store i8 %b2.1.i530, ptr %base64_2218.i, align 1, !tbaa !74
  br label %cleanup224.thread.i

cleanup224.thread.i:                              ; preds = %if.end152.i, %if.end152.i.thread, %sw.bb217.i
  %b1.0.i513 = phi i8 [ %b1.0.i512518526, %sw.bb217.i ], [ %cb1.0335.i, %if.end152.i ], [ %..i402, %if.end152.i.thread ]
  ...
  store i8 %b1.0.i513, ptr %base64_1220.i, align 8, !tbaa !75
  store i32 %nbytes143.0371.i, ptr %base64chars.i, align 4, !tbaa !72
...
cleanup224.i:                                     ; preds = %if.end180.i
  ...
  %45 = load i8, ptr %arrayidx.i389, align 1, !tbaa !20
  ...
  store i8 %or197.i, ptr %out.addr.3401.i, align 1, !tbaa !20
  ...
  %47 = load i8, ptr %incdec.ptr186.i, align 1, !tbaa !20
...
lor.lhs.false90:                                  ; preds = %sw.bb87
  %48 = load i8, ptr %line, align 1, !tbaa !20
...
if.else129:                                       ; preds = %if.end121
  ...
  %51 = load i32, ptr %base64chars.i283, align 4, !tbaa !72
...
sw.bb.i357:                                       ; preds = %if.else129
  ...
  %52 = load i8, ptr %base64_3.i358, align 2, !tbaa !73
...
sw.bb1.i354:                                      ; preds = %sw.bb.i357, %if.else129
  ...
  %53 = load i8, ptr %base64_2.i356, align 1, !tbaa !74
...
sw.epilog.thread.i284:                            ; preds = %sw.bb1.i354, %if.else129
  ...
  %54 = load i8, ptr %base64_1.i287, align 8, !tbaa !75
...
while.cond.preheader.i360:                        ; preds = %sw.epilog.i359
  %55 = load i8, ptr %incdec.ptr111, align 1, !tbaa !20
...
while.body.i362:                                  ; preds = %while.cond.preheader.i360, %while.body.i362
  ...
  %57 = load i8, ptr %incdec.ptr.i365, align 1, !tbaa !20
  %sub.i425 = add i8 %57, 32
  %incdec.ptr6.i369 = getelementptr inbounds i8, ptr %in.addr.0403.i364, i64 3
  %58 = load i8, ptr %incdec.ptr4.i367, align 1, !tbaa !20
  ...
  store i8 %or.i374, ptr %out.addr.0404.i363, align 1, !tbaa !20
  %incdec.ptr11.i376 = getelementptr inbounds i8, ptr %in.addr.0403.i364, i64 4
  %60 = load i8, ptr %incdec.ptr6.i369, align 1, !tbaa !20
  ...
  store i8 %or18.i381, ptr %incdec.ptr10.i375, align 1, !tbaa !20
  ...
  store i8 %or25.i384, ptr %incdec.ptr20.i382, align 1, !tbaa !20
  %62 = load i8, ptr %incdec.ptr11.i376, align 1, !tbaa !20
  %tobool3.not.i386 = icmp eq i8 %62, 0
  br i1 %tobool3.not.i386, label %decode.exit387, label %while.body.i362, !llvm.loop !77

if.else.i288:                                     ; preds = %sw.epilog.i359, %sw.epilog.thread.i284
  %cb3.2337.i289 = phi i8 [ %cb3.1.i286, %sw.epilog.thread.i284 ], [ 0, %sw.epilog.i359 ]
  %cb2.1336.i290 = phi i8 [ %cb2.0.i285, %sw.epilog.thread.i284 ], [ 0, %sw.epilog.i359 ]
  %cb1.0335.i291 = phi i8 [ %54, %sw.epilog.thread.i284 ], [ 0, %sw.epilog.i359 ]
  %63 = load i8, ptr %incdec.ptr111, align 1, !tbaa !20
...
while.body142.i293:                               ; preds = %if.else.i288, %cleanup224.i319
  ...
  %65 = load i32, ptr %base64chars.i283, align 4, !tbaa !72
...
if.end152.i299:                                   ; preds = %while.body142.i293
  ...
  store i32 %dec148.i298, ptr %base64chars.i283, align 4, !tbaa !72
  %66 = load i8, ptr %in.addr.1400.i295, align 1, !tbaa !20
...
if.end152.i299.thread:                            ; preds = %while.body142.i293
  ...
  %67 = load i8, ptr %incdec.ptr150.i352, align 1, !tbaa !20
...
if.end166.i307:                                   ; preds = %if.else157.i303
  ...
  store i32 %dec162.i306, ptr %base64chars.i283, align 4, !tbaa !72
  %68 = load i8, ptr %in.addr.1400.i295, align 1, !tbaa !20
...
if.end166.i307.thread:                            ; preds = %if.else157.i303, %if.end152.i299.thread
  ...
  %b1.0.i301545552 = phi i8 [ %cb1.0335.i291, %if.else157.i303 ], [ %sub.i422, %if.end152.i299.thread ]
  ...
  %70 = load i8, ptr %incdec.ptr164.i349, align 1, !tbaa !20
...
if.then174.i313:                                  ; preds = %if.else171.i311
  ...
  store i32 %dec176.i314, ptr %base64chars.i283, align 4, !tbaa !72
  br label %if.end180.i315

if.else177.i345:                                  ; preds = %if.end166.i307.thread, %if.else171.i311
  %b1.0.i301545551558573 = phi i8 [ %cb1.0335.i291, %if.else171.i311 ], [ %b1.0.i301545552, %if.end166.i307.thread ]
  %in.addr.3.i308561571 = phi ptr [ %in.addr.1400.i295, %if.else171.i311 ], [ %incdec.ptr164.i349, %if.end166.i307.thread ]
  %b2.1.i309562570 = phi i8 [ %cb2.1336.i290, %if.else171.i311 ], [ %sub.i421, %if.end166.i307.thread ]
...
if.end180.i315:                                   ; preds = %if.else177.i345, %if.then174.i313
  %b1.0.i301545551558572 = phi i8 [ %cb1.0335.i291, %if.then174.i313 ], [ %b1.0.i301545551558573, %if.else177.i345 ]
  %b2.1.i309562569 = phi i8 [ %cb2.1336.i290, %if.then174.i313 ], [ %b2.1.i309562570, %if.else177.i345 ]
  %in.addr.4.i316 = phi ptr [ %in.addr.1400.i295, %if.then174.i313 ], [ %incdec.ptr178.i346, %if.else177.i345 ]
  %b3.2.i317 = phi i8 [ %cb3.2337.i289, %if.then174.i313 ], [ %sub.i420, %if.else177.i345 ]
  %72 = load i8, ptr %in.addr.4.i316, align 1, !tbaa !20
...
sw.bb215.i337:                                    ; preds = %if.end180.i315
  ...
  store i8 %b3.2.i317, ptr %base64_3216.i338, align 2, !tbaa !73
  br label %sw.bb217.i339

sw.bb217.i339:                                    ; preds = %if.end166.i307, %if.end166.i307.thread, %sw.bb215.i337
  %b2.1.i309563 = phi i8 [ %b2.1.i309562569, %sw.bb215.i337 ], [ %cb2.1336.i290, %if.end166.i307 ], [ %sub.i421, %if.end166.i307.thread ]
  %b1.0.i301545551559 = phi i8 [ %b1.0.i301545551558572, %sw.bb215.i337 ], [ %cb1.0335.i291, %if.end166.i307 ], [ %b1.0.i301545552, %if.end166.i307.thread ]
  %base64_2218.i341 = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 11
  store i8 %b2.1.i309563, ptr %base64_2218.i341, align 1, !tbaa !74
  br label %cleanup224.thread.i342

cleanup224.thread.i342:                           ; preds = %if.end152.i299, %if.end152.i299.thread, %sw.bb217.i339
  %b1.0.i301546 = phi i8 [ %b1.0.i301545551559, %sw.bb217.i339 ], [ %cb1.0335.i291, %if.end152.i299 ], [ %sub.i422, %if.end152.i299.thread ]
  %base64_1220.i344 = getelementptr inbounds %struct.message, ptr %m, i64 0, i32 10
  store i8 %b1.0.i301546, ptr %base64_1220.i344, align 8, !tbaa !75
...
cleanup224.i319:                                  ; preds = %if.end180.i315
  ...
  store i8 %or197.i325, ptr %out.addr.3401.i294, align 1, !tbaa !20
  ...
  store i8 %or205.i330, ptr %incdec.ptr199.i326, align 1, !tbaa !20
  ...
  store i8 %or212.i333, ptr %incdec.ptr207.i331, align 1, !tbaa !20
  %74 = load i8, ptr %incdec.ptr186.i320, align 1, !tbaa !20
...
lor.lhs.false139:                                 ; preds = %sw.bb136
  %75 = load i8, ptr %line, align 1, !tbaa !20
...
if.then156:                                       ; preds = %while.cond150
  ...
  %77 = load i8, ptr %incdec.ptr157, align 1, !tbaa !20
...
if.end175:                                        ; preds = %if.else168, %if.end162
  ...
  br label %while.cond150, !llvm.loop !84
...
entry:
  ...
  store ptr %ctx, ptr %ctx1, align 8, !tbaa !82
  ret void
}
