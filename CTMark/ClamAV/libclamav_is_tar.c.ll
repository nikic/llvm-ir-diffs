; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_is_tar.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_is_tar.c"
...
while.body.i:                                     ; preds = %if.end
  ...
  %5 = load i16, ptr %arrayidx.1.i, align 2
  %6 = and i16 %5, 8192
...
land.rhs.i:                                       ; preds = %if.end, %while.body.i, %while.body.1.i, %while.body.2.i, %while.body.3.i, %while.body.4.i, %while.body.5.i, %while.body.6.i
  ...
  %25 = load i8, ptr %where.addr.151.i.ph, align 1
  %26 = and i8 %25, -8
...
land.lhs.true.i:                                  ; preds = %land.rhs.i.7, %land.rhs.i.6, %land.rhs.i.5, %land.rhs.i.4, %land.rhs.i.3, %land.rhs.i.2, %land.rhs.i.1, %land.rhs.i
  ...
  br i1 %tobool22.not.i, label %vector.ph, label %land.lhs.true23.i
...
land.lhs.true23.i:                                ; preds = %land.lhs.true.i
  ...
  %41 = load i16, ptr %arrayidx27.i, align 2
  %42 = and i16 %41, 8192
  %tobool30.not.i = icmp eq i16 %42, 0
  %spec.select.i = select i1 %tobool30.not.i, i32 -1, i32 %value.052.i.lcssa
  br label %vector.ph

vector.ph:                                        ; preds = %while.body14.i, %while.body14.i.1, %while.body14.i.2, %while.body14.i.3, %while.body14.i.4, %while.body14.i.5, %while.body14.i.6, %while.body14.i.7, %land.lhs.true23.i, %land.lhs.true.i, %while.body.6.i
  %retval.0.i = phi i32 [ %value.052.i.lcssa, %land.lhs.true.i ], [ %spec.select.i, %land.lhs.true23.i ], [ -1, %while.body.6.i ], [ %sub.i, %while.body14.i ], [ %or.i.1, %while.body14.i.1 ], [ %or.i.2, %while.body14.i.2 ], [ %or.i.3, %while.body14.i.3 ], [ %or.i.4, %while.body14.i.4 ], [ %or.i.5, %while.body14.i.5 ], [ %or.i.6, %while.body14.i.6 ], [ %or.i.7, %while.body14.i.7 ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load59 = load <4 x i8>, ptr %43, align 1
  ...
  %wide.load.1 = load <4 x i8>, ptr %next.gep.1, align 1
  %48 = getelementptr i8, ptr %next.gep.1, i64 4
  %wide.load59.1 = load <4 x i8>, ptr %48, align 1
...
middle.block:                                     ; preds = %vector.body
  ...
  %55 = load <4 x i8>, ptr %arrayidx.3, align 1
  ...
  %58 = load i8, ptr %arrayidx.5, align 1
