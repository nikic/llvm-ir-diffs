; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_unzip.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_unzip.c"
...
if.end6.i:                                        ; preds = %if.then3.i, %if.end.i
  ...
  %2 = load ptr, ptr %buf32k.i, align 8
...
cleanup.sink.split:                               ; preds = %if.end21, %zip_dir_close.exit, %if.then7, %if.then
  ...
  store i32 %.sink, ptr %errcode_p, align 4
  br label %cleanup
...
for.body.i:                                       ; preds = %for.inc96.i, %for.body.lr.ph.i
  ...
  %3 = load i8, ptr %tail.0176.i, align 1
...
if.end86.i:                                       ; preds = %if.end79.i
  %4 = load i32, ptr %dirent.i, align 4
...
if.end86.1.i:                                     ; preds = %if.end79.1.i
  %5 = load i32, ptr %dirent.i, align 4
...
for.inc96.i:                                      ; preds = %if.end86.1.i, %for.inc.i, %if.then60.i, %land.lhs.true40.i, %for.body.i
  ...
  br i1 %cmp33.not.i, label %while.cond.loopexit.i, label %for.body.i
...
if.end4.i:                                        ; preds = %if.end.i
  ...
  %cmp6.i21 = icmp ugt i32 %trailer.sroa.539.3, %conv5.i
...
if.end9.i:                                        ; preds = %if.end4.i
  ...
  br i1 %tobool12.not.i, label %__zip_parse_root_directory.exit, label %for.cond.preheader.i
...
for.body.i23:                                     ; preds = %if.end113.i, %for.cond.preheader.i
  %hdr.0266.i = phi ptr [ %call11.i, %for.cond.preheader.i ], [ %add.ptr125.i, %if.end113.i ]
  %p_reclen.0265.i = phi ptr [ null, %for.cond.preheader.i ], [ %d_reclen.i, %if.end113.i ]
  %entries.0264.i = phi i16 [ %trailer.sroa.4.3, %for.cond.preheader.i ], [ %dec.i, %if.end113.i ]
  %offset.0263.i = phi i32 [ 0, %for.cond.preheader.i ], [ %conv108.i, %if.end113.i ]
  %add18.i = add i32 %conv1.i.pre-phi, %offset.0263.i
  ...
  br i1 %cmp21.i, label %if.then23.i34, label %if.end24.i24

if.then23.i34:                                    ; preds = %for.body.i23
  call void @free(ptr noundef %call11.i) #11
  call void (ptr, ...) @cli_errmsg(ptr noundef nonnull @.str.23, i32 noundef %6) #11
  br label %__zip_parse_root_directory.exit

if.end24.i24:                                     ; preds = %for.body.i23
  %call25.i25 = call i32 @cli_readn(i32 noundef %6, ptr noundef nonnull %dirent.i18, i32 noundef 46) #11
  %cmp27.i26 = icmp slt i32 %call25.i25, 46
  br i1 %cmp27.i26, label %if.then29.i33, label %if.end35.i

if.then29.i33:                                    ; preds = %if.end24.i24
  %cmp32.not.i = icmp eq i16 %entries.0264.i, %trailer.sroa.4.3
  br i1 %cmp32.not.i, label %if.else.i, label %for.end.i

if.else.i:                                        ; preds = %if.then29.i33
  call void @free(ptr noundef %call11.i) #11
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.24, i64 noundef 46) #11
  br label %__zip_parse_root_directory.exit

if.end35.i:                                       ; preds = %if.end24.i24
  %conv36.i = zext i32 %offset.0263.i to i64
...
if.end43.i:                                       ; preds = %if.end35.i
  %8 = load i16, ptr %z_extras.i, align 1
  %9 = load i16, ptr %z_comment.i22, align 1
  %10 = load i16, ptr %z_namlen.i, align 1
...
if.end49.i:                                       ; preds = %if.end43.i
  %11 = load i16, ptr %z_flags.i, align 1
  %12 = load i32, ptr %z_crc32.i, align 1
  %d_crc32.i = getelementptr inbounds %struct.__zip_dir_hdr, ptr %hdr.0266.i, i64 0, i32 2
  store i32 %12, ptr %d_crc32.i, align 4
  %13 = load i32, ptr %z_csize.i, align 1
  %d_csize.i = getelementptr inbounds %struct.__zip_dir_hdr, ptr %hdr.0266.i, i64 0, i32 1
  store i32 %13, ptr %d_csize.i, align 4
  %14 = load i32, ptr %z_usize.i, align 1
  store i32 %14, ptr %hdr.0266.i, align 4
  %15 = load i32, ptr %z_off.i, align 1
  %conv52.i = add i32 %15, %shift.2171.lcssa184.i
  %d_off.i = getelementptr inbounds %struct.__zip_dir_hdr, ptr %hdr.0266.i, i64 0, i32 3
  store i32 %conv52.i, ptr %d_off.i, align 4
  %16 = load i16, ptr %z_compr.i, align 1
  %d_compr.i = getelementptr inbounds %struct.__zip_dir_hdr, ptr %hdr.0266.i, i64 0, i32 6
  store i16 %16, ptr %d_compr.i, align 4
  %tobool54.not.i = icmp eq i16 %16, 0
  %cmp57.not.i = icmp eq i32 %13, %14
  br i1 %tobool54.not.i, label %land.lhs.true.i32, label %land.lhs.true64.i

land.lhs.true.i32:                                ; preds = %if.end49.i
...
if.end75.sink.split.i:                            ; preds = %land.lhs.true64.i, %land.lhs.true.i32
  %.str.29.sink.i = phi ptr [ @.str.27, %land.lhs.true.i32 ], [ @.str.29, %land.lhs.true64.i ]
  %.str.30.sink.i = phi ptr [ @.str.28, %land.lhs.true.i32 ], [ @.str.30, %land.lhs.true64.i ]
  %.sink.i = phi i16 [ 8, %land.lhs.true.i32 ], [ 0, %land.lhs.true64.i ]
  ...
  %d_bf70.i = getelementptr inbounds %struct.__zip_dir_hdr, ptr %hdr.0266.i, i64 0, i32 7
  store i16 %.sink.i, ptr %d_bf70.i, align 2
  br label %if.end75.i

if.end75.i:                                       ; preds = %if.end75.sink.split.i, %land.lhs.true64.i, %land.lhs.true.i32
  %bfcnt.0.i = phi i64 [ 0, %land.lhs.true64.i ], [ 0, %land.lhs.true.i32 ], [ 1, %if.end75.sink.split.i ]
  %arrayidx78.i = getelementptr inbounds %struct.__zip_dir_hdr, ptr %hdr.0266.i, i64 0, i32 7, i64 %bfcnt.0.i
  store i16 -1, ptr %arrayidx78.i, align 2
  %d_flags.i = getelementptr inbounds %struct.__zip_dir_hdr, ptr %hdr.0266.i, i64 0, i32 8
  store i16 %11, ptr %d_flags.i, align 2
...
if.end88.i:                                       ; preds = %if.end75.i
  %d_name.i = getelementptr inbounds %struct.__zip_dir_hdr, ptr %hdr.0266.i, i64 0, i32 9
...
if.end96.i:                                       ; preds = %if.end88.i
  %arrayidx99.i = getelementptr inbounds %struct.__zip_dir_hdr, ptr %hdr.0266.i, i64 0, i32 9, i64 %conv81.i
  store i8 0, ptr %arrayidx99.i, align 1
  %d_namlen.i = getelementptr inbounds %struct.__zip_dir_hdr, ptr %hdr.0266.i, i64 0, i32 5
  store i16 %10, ptr %d_namlen.i, align 2
  ...
  %conv108.i = add i32 %offset.0263.i, %17
  %cmp109.i = icmp ugt i32 %conv108.i, %trailer.sroa.539.3
  br i1 %cmp109.i, label %for.end.sink.split.i, label %if.end113.i

if.end113.i:                                      ; preds = %if.end96.i
  %add.ptr.i28 = getelementptr inbounds i8, ptr %hdr.0266.i, i64 32
  %add.ptr115.i = getelementptr inbounds i8, ptr %add.ptr.i28, i64 %conv81.i
  ...
  %sub.ptr.lhs.cast.i29 = ptrtoint ptr %add.ptr119.i to i64
  %sub.ptr.rhs.cast.i30 = ptrtoint ptr %hdr.0266.i to i64
  %sub.ptr.sub.i31 = sub i64 %sub.ptr.lhs.cast.i29, %sub.ptr.rhs.cast.i30
  %conv120.i = trunc i64 %sub.ptr.sub.i31 to i16
  %d_reclen.i = getelementptr inbounds %struct.__zip_dir_hdr, ptr %hdr.0266.i, i64 0, i32 4
  store i16 %conv120.i, ptr %d_reclen.i, align 4
  %conv123.i = and i64 %sub.ptr.sub.i31, 65535
  %add.ptr125.i = getelementptr inbounds i8, ptr %hdr.0266.i, i64 %conv123.i
  %dec.i = add i16 %entries.0264.i, -1
  %cmp16.not.i = icmp eq i16 %dec.i, 0
  br i1 %cmp16.not.i, label %if.then127.i, label %for.body.i23
...
for.end.sink.split.i:                             ; preds = %if.end96.i, %if.end88.i, %if.end75.i, %if.end43.i, %if.end35.i
  ...
  %conv15.le.i = zext i16 %entries.0264.i to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull %.str.33.sink.i, i32 noundef %conv15.le.i) #11
  br label %for.end.i

for.end.i:                                        ; preds = %for.end.sink.split.i, %if.then29.i33
  %entries.1.i = phi i32 [ 0, %if.then29.i33 ], [ -124, %for.end.sink.split.i ]
  %tobool126.not.i = icmp eq ptr %p_reclen.0265.i, null
  br i1 %tobool126.not.i, label %if.else131.i, label %if.then127.i

if.then127.i:                                     ; preds = %if.end113.i, %for.end.i
  %entries.1285.i = phi i32 [ %entries.1.i, %for.end.i ], [ 0, %if.end113.i ]
  %p_reclen.0247284.i = phi ptr [ %p_reclen.0265.i, %for.end.i ], [ %d_reclen.i, %if.end113.i ]
  store i16 0, ptr %p_reclen.0247284.i, align 2
  store ptr %call11.i, ptr %hdr0, align 8
  br label %__zip_parse_root_directory.exit
...
__zip_parse_root_directory.exit:                  ; preds = %if.then.i, %if.then3.i, %if.then8.i, %if.end9.i, %if.then23.i34, %if.else.i, %if.then127.i, %if.else131.i
  %retval.0.i27 = phi i32 [ -123, %if.then.i ], [ -124, %if.then8.i ], [ -123, %if.then23.i34 ], [ -123, %if.else.i ], [ -124, %if.then3.i ], [ -114, %if.end9.i ], [ %entries.1285.i, %if.then127.i ], [ %entries.1.i, %if.else131.i ]
...
cleanup:                                          ; preds = %__zip_find_disk_trailer.exit.thread, %__zip_parse_root_directory.exit, %if.then
  %retval.0 = phi i32 [ -123, %if.then ], [ %retval.0.i27, %__zip_parse_root_directory.exit ], [ %retval.0.i.ph, %__zip_find_disk_trailer.exit.thread ]
...
if.else91.us:                                     ; preds = %while.cond.preheader.split.us, %if.end94.us
  ...
  %2 = load i16, ptr %d_reclen.us, align 4
...
if.then2:                                         ; preds = %if.end
  ...
  store i32 -111, ptr %errcode, align 4
  br label %cleanup
...
if.then9:                                         ; preds = %land.lhs.true, %if.end94.us, %while.cond.preheader.split.us
  ...
  %4 = load i16, ptr %d_compr, align 4
...
sw.bb10:                                          ; preds = %if.then9, %if.then9, %if.then9, %if.then9, %if.then9, %if.then9, %if.then9, %if.then9, %if.then9, %if.then9
  ...
  store i32 -125, ptr %errcode13, align 4
  br label %cleanup
...
sw.default:                                       ; preds = %if.then9
  ...
  store i32 -124, ptr %errcode16, align 4
  br label %cleanup
...
if.then26:                                        ; preds = %if.else
  ...
  store i32 -114, ptr %errcode27, align 4
  br label %cleanup

if.end29:                                         ; preds = %if.else, %if.then19
  %fp.0 = phi ptr [ %5, %if.then19 ], [ %call24, %if.else ]
  store ptr %dir, ptr %fp.0, align 8
  %buf32k = getelementptr inbounds %struct.__zip_dir, ptr %dir, i64 0, i32 2, i32 1
  %6 = load ptr, ptr %buf32k, align 8
...
if.then33:                                        ; preds = %if.end29
  ...
  store ptr %6, ptr %buf32k36, align 8
  store ptr null, ptr %buf32k, align 8
  br label %if.end48
...
if.else39:                                        ; preds = %if.end29
  ...
  store ptr %call40, ptr %buf32k41, align 8
...
if.then44:                                        ; preds = %if.else39
  ...
  store i32 -114, ptr %errcode45, align 4
  %call46 = tail call i32 @zip_file_close(ptr noundef nonnull %fp.0)
  br label %cleanup
...
if.end48:                                         ; preds = %if.else39, %if.then33
  ...
  %8 = load i32, ptr %d_off50, align 4
...
if.then55:                                        ; preds = %if.end48
  ...
  store i32 -123, ptr %errcode57, align 4
  %call58 = tail call i32 @zip_file_close(ptr noundef nonnull %fp.0)
  br label %cleanup

if.end59:                                         ; preds = %if.end48
  %buf32k60 = getelementptr inbounds %struct.__zip_file, ptr %fp.0, i64 0, i32 7
  %10 = load ptr, ptr %buf32k60, align 8
...
if.then77:                                        ; preds = %if.end69
  ...
  store i32 -123, ptr %errcode79, align 4
  %call80 = tail call i32 @zip_file_close(ptr noundef nonnull %fp.0)
  br label %cleanup

if.end81:                                         ; preds = %if.end69
  %usize = getelementptr inbounds %struct.__zip_file, ptr %fp.0, i64 0, i32 5
  %16 = load <2 x i32>, ptr %.us-phi, align 4
  %17 = zext <2 x i32> %16 to <2 x i64>
  store <2 x i64> %17, ptr %usize, align 8
  ...
  store ptr %d_bf, ptr %bf, align 8
  %call85 = tail call fastcc i32 @__zip_inflate_init(ptr noundef nonnull %fp.0, ptr noundef nonnull %.us-phi)
...
if.then87:                                        ; preds = %if.end81
  ...
  store i32 -123, ptr %errcode88, align 4
  %call89 = tail call i32 @zip_file_close(ptr noundef nonnull %fp.0)
  br label %cleanup

if.else91:                                        ; preds = %land.lhs.true, %while.cond
  %d_reclen = getelementptr inbounds %struct.__zip_dir_hdr, ptr %hdr.0, i64 0, i32 4
  %18 = load i16, ptr %d_reclen, align 4
...
while.end:                                        ; preds = %if.else91, %if.else91.us
  ...
  store i32 -115, ptr %errcode98, align 4
  br label %cleanup
...
if.end:                                           ; preds = %lor.lhs.false
  %restlen = getelementptr inbounds %struct.__zip_file, ptr %fp, i64 0, i32 3
  %1 = load i64, ptr %restlen, align 8
...
if.then13:                                        ; preds = %sw.bb
  %4 = load i64, ptr %restlen, align 8
  %sub = sub i64 %4, %conv10
  store i64 %sub, ptr %restlen, align 8
  br label %cleanup101
...
if.then17:                                        ; preds = %if.else
  ...
  store i32 -123, ptr %errcode, align 4
  br label %cleanup101
...
do.body:                                          ; preds = %land.rhs, %sw.bb20
  %5 = load i64, ptr %crestlen, align 8
...
cleanup.thread:                                   ; preds = %if.then28
  %9 = load i64, ptr %crestlen, align 8
  %sub47 = sub i64 %9, %conv40
  store i64 %sub47, ptr %crestlen, align 8
  store i32 %call39, ptr %avail_in, align 8
  %10 = load ptr, ptr %buf32k, align 8
  store ptr %10, ptr %d_stream, align 8
  br label %if.end54

cleanup:                                          ; preds = %if.then28
  %errcode44 = getelementptr inbounds %struct.__zip_dir, ptr %0, i64 0, i32 1
  store i32 -123, ptr %errcode44, align 4
...
if.end84.thread:                                  ; preds = %if.end54
  store i64 0, ptr %restlen, align 8
  br label %do.end

if.else71:                                        ; preds = %if.end54
  %12 = load i16, ptr %method, align 8
...
sw.default:                                       ; preds = %if.end8
  ...
  store i32 -104, ptr %errcode100, align 4
  br label %cleanup101
