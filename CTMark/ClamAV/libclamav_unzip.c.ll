...
if.end49.i:                                       ; preds = %if.end43.i
  ...
  store i32 %14, ptr %hdr.0266.i, align 4, !tbaa !38
...
if.end113.i:                                      ; preds = %if.end96.i
  ...
  br i1 %cmp16.not.i, label %if.then127.i, label %for.body.i23, !llvm.loop !47
...
if.then127.i:                                     ; preds = %if.end113.i, %for.end.i
  ...
  store i16 0, ptr %p_reclen.0247284.i, align 2, !tbaa !43
