; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/shared_cfgparser.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/shared_cfgparser.c"
...
entry:
  ...
  store ptr null, ptr %copt, align 8
  %0 = load ptr, ptr @cfg_options, align 16
...
if.end:                                           ; preds = %entry, %for.cond
  ...
  %3 = load ptr, ptr %strarg, align 16
...
cond.end:                                         ; preds = %if.end, %cond.true
  ...
  %4 = load i32, ptr %numarg, align 4
  %multiple = getelementptr inbounds [86 x %struct.cfgoption], ptr @cfg_options, i64 0, i64 %indvars.iv, i32 4
  %5 = load i16, ptr %multiple, align 8
  %call5 = call fastcc i32 @regcfg(ptr noundef nonnull %copt, ptr noundef nonnull %2, ptr noundef %cond, i32 noundef %4, i16 noundef signext %5)
...
if.then34:                                        ; preds = %if.end30
  ...
  %13 = load ptr, ptr @cfg_options, align 16
...
if.then46:                                        ; preds = %if.then42
  ...
  %15 = load i16, ptr %argtype, align 8
...
if.end55:                                         ; preds = %sw.bb
  ...
  %18 = load i16, ptr %multiple56, align 8
  %call57 = call fastcc i32 @regcfg(ptr noundef nonnull %copt, ptr noundef %call32, ptr noundef nonnull %arg.0582, i32 noundef -1, i16 noundef signext %18)
...
lor.lhs.false:                                    ; preds = %land.lhs.true, %if.then79
  ...
  %24 = load i16, ptr %multiple82, align 8
  %call83 = call fastcc i32 @regcfg(ptr noundef nonnull %copt, ptr noundef %call32, ptr noundef nonnull %call75, i32 noundef -1, i16 noundef signext %24)
...
if.end96:                                         ; preds = %if.then94, %if.then92
  ...
  call void @free(ptr noundef %call32) #17
  %29 = load ptr, ptr %copt, align 8
  call void @freecfg(ptr noundef %29)
  br label %cleanup287

if.end98:                                         ; preds = %sw.bb90
  %30 = load i8, ptr %arg.0582, align 1
...
if.then111:                                       ; preds = %if.then106
  ...
  %31 = load i8, ptr %arrayidx112, align 1
...
if.then116:                                       ; preds = %if.then111
  store i8 0, ptr %call114, align 1
...
lor.lhs.false126:                                 ; preds = %if.then116, %if.end98
  ...
  %34 = load i16, ptr %multiple127, align 8
  %call128 = call fastcc i32 @regcfg(ptr noundef nonnull %copt, ptr noundef %call32, ptr noundef nonnull %arg.1.ph, i32 noundef -1, i16 noundef signext %34)
...
if.end146:                                        ; preds = %lor.lhs.false137
  ...
  %40 = load i16, ptr %multiple148, align 8
  %call149 = call fastcc i32 @regcfg(ptr noundef nonnull %copt, ptr noundef %call32, ptr noundef null, i32 noundef %conv.i, i16 noundef signext %40)
...
if.end211:                                        ; preds = %if.end190, %if.end209
  ...
  %53 = load i16, ptr %multiple212, align 8
  %call213 = call fastcc i32 @regcfg(ptr noundef nonnull %copt, ptr noundef %call32, ptr noundef null, i32 noundef %calc.4, i16 noundef signext %53)
...
if.end255:                                        ; preds = %if.else238, %lor.lhs.false241, %lor.lhs.false244, %if.end228, %lor.lhs.false231, %lor.lhs.false234
  ...
  %61 = load i16, ptr %multiple256, align 8
  %call257 = call fastcc i32 @regcfg(ptr noundef nonnull %copt, ptr noundef %call32, ptr noundef null, i32 noundef %val.0, i16 noundef signext %61)
...
for.inc274:                                       ; preds = %if.end155, %if.end55, %lor.lhs.false, %lor.lhs.false126, %if.end211, %if.end255, %if.then42
  ...
  %67 = load ptr, ptr %arrayidx39, align 16
...
cond.true:                                        ; preds = %entry
  ...
  store i16 0, ptr %enabled, align 4
  ...
  store i16 %multiple, ptr %multiple4, align 2
  %tobool5.not = icmp eq ptr %strarg, null
  br i1 %tobool5.not, label %if.end10, label %if.then6

if.then6:                                         ; preds = %cond.true
  store i16 1, ptr %enabled, align 4
  br label %if.end10
...
if.end10:                                         ; preds = %cond.true, %if.then6
  ...
  store i32 %numarg, ptr %numarg11, align 8
  %2 = add i32 %numarg, -1
...
while.body.i:                                     ; preds = %if.end15, %if.end.i
  ...
  %5 = load ptr, ptr %copt.addr.010.i, align 8
...
if.then21:                                        ; preds = %if.then18
  ...
  %8 = load i16, ptr %enabled22, align 4
...
if.then32:                                        ; preds = %if.else29
  ...
  %.pre121 = load i32, ptr %numarg11, align 8
  %.pre122 = load i16, ptr %enabled, align 4
  %.pre123 = load ptr, ptr %call, align 8
  br label %if.end34
...
if.end34:                                         ; preds = %if.then32, %if.else29
  ...
  store ptr %14, ptr %strarg30, align 8
  %numarg38 = getelementptr inbounds %struct.cfgstruct, ptr %copt.addr.010.i, i64 0, i32 2
  store i32 %13, ptr %numarg38, align 8
  store i16 %12, ptr %enabled22, align 4
...
if.else47:                                        ; preds = %if.then18
  ...
  %15 = load ptr, ptr %strarg48, align 8
...
if.then50:                                        ; preds = %if.else47
  ...
  %.pre125 = load i32, ptr %numarg11, align 8
  %.pre126 = load i16, ptr %enabled, align 4
  %.pre127 = load ptr, ptr %call, align 8
  br label %if.end52
...
if.else64:                                        ; preds = %if.end.i, %if.end15
  ...
  store ptr %call, ptr %copt, align 8
  br label %cleanup
...
while.body:                                       ; preds = %entry, %if.end17
  ...
  %0 = load ptr, ptr %nextarg, align 8
...
if.else:                                          ; preds = %while.body3
  ...
  %5 = load ptr, ptr %nextarg7, align 8
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %arg.1 = phi ptr [ %4, %if.then ], [ %5, %if.else ]
  %tobool2.not = icmp eq ptr %arg.1, null
  br i1 %tobool2.not, label %while.end, label %while.body3

while.end:                                        ; preds = %if.end, %while.body
  %6 = load ptr, ptr %copt.addr.037, align 8
...
if.end12:                                         ; preds = %if.then10, %while.end
  ...
  %7 = load ptr, ptr %strarg13, align 8
...
if.end17:                                         ; preds = %if.then15, %if.end12
  ...
  br i1 %tobool.not, label %while.end18, label %while.body
...
while.body:                                       ; preds = %entry, %if.end
  ...
  %0 = load ptr, ptr %copt.addr.010, align 8
