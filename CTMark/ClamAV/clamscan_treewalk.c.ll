; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/clamscan_treewalk.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/clamscan_treewalk.c"
...
if.end:                                           ; preds = %while.body
  ...
  br i1 %tobool2.not, label %if.end6, label %while.body
...
if.end18:                                         ; preds = %while.body14
  ...
  br i1 %tobool12.not, label %if.then22, label %while.body14

if.then22:                                        ; preds = %if.end18, %if.then9
  %0 = load i16, ptr @printinfected, align 2
...
if.end37:                                         ; preds = %if.end34
  %1 = load i32, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 1), align 4
  %inc = add i32 %1, 1
  store i32 %inc, ptr getelementptr inbounds (%struct.s_info, ptr @info, i64 0, i32 1), align 4
...
while.body45:                                     ; preds = %while.body45.lr.ph, %if.end93
  ...
  %2 = load i64, ptr %call43154, align 8
...
if.then74:                                        ; preds = %if.then66
  %call75 = call i32 @treewalk(ptr noundef %call60, ptr noundef %engine, ptr noundef %user, ptr noundef %opt, ptr noundef %limits, i32 noundef %options, i32 noundef %inc38)
...
if.end93:                                         ; preds = %if.then47, %land.lhs.true, %if.end91, %while.body45
  ...
  br i1 %tobool44.not, label %if.end100.loopexit, label %while.body45
...
if.end100.loopexit:                               ; preds = %if.end93
  %6 = icmp ne i32 %scanret.2, 0
  %7 = zext i1 %6 to i32
  br label %if.end100

if.end100:                                        ; preds = %if.end100.loopexit, %while.cond42.preheader
  %scanret.0.lcssa = phi i32 [ 0, %while.cond42.preheader ], [ %7, %if.end100.loopexit ]
...
cleanup:                                          ; preds = %while.body, %if.end100, %if.else95, %if.then97, %if.end34, %if.then22, %if.then24
  %retval.0 = phi i32 [ 0, %if.then24 ], [ 0, %if.then22 ], [ 0, %if.end34 ], [ 53, %if.then97 ], [ 53, %if.else95 ], [ %scanret.0.lcssa, %if.end100 ], [ 0, %while.body ]
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end39
  ...
  %0 = load i64, ptr %call169, align 8
...
if.then28:                                        ; preds = %if.then22
  ...
  %call30 = tail call i32 @fixperms(ptr noundef %call16)
  br label %if.end37
...
if.end39:                                         ; preds = %if.then3, %land.lhs.true, %if.end37, %while.body
  ...
  br i1 %tobool.not, label %if.end45, label %while.body
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end33
  ...
  %0 = load i64, ptr %call159, align 8
  %tobool2.not = icmp eq i64 %0, 0
...
if.then28:                                        ; preds = %if.then22
  %call29 = tail call i32 @du(ptr noundef %call16, ptr noundef nonnull %n)
  br label %if.end31
...
if.else:                                          ; preds = %if.then22
  ...
  %add30 = add i64 %4, %div
  store i64 %add30, ptr %space, align 8
  br label %if.end31
...
if.end33:                                         ; preds = %if.then3, %land.lhs.true, %if.end31, %while.body
  %call1 = tail call ptr @readdir(ptr noundef nonnull %call) #10
  %tobool.not = icmp eq ptr %call1, null
  br i1 %tobool.not, label %if.end39, label %while.body
