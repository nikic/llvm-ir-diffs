; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/zlib_uncompr.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/zlib_uncompr.c"
...
if.then5:                                         ; preds = %do.body
  %cond92 = call i64 @llvm.umin.i64(i64 %left.1, i64 4294967295)
  %cond = trunc i64 %cond92 to i32
  store i32 %cond, ptr %avail_out, align 8
  %sub = sub i64 %left.1, %cond92
  br label %if.end10
...
if.then14:                                        ; preds = %if.end10
  %cond2193 = call i64 @llvm.umin.i64(i64 %len.0, i64 4294967295)
  %cond21 = trunc i64 %cond2193 to i32
  store i32 %cond21, ptr %avail_in, align 8
  %sub25 = sub i64 %len.0, %cond2193
  br label %if.end26
...
if.end26:                                         ; preds = %if.then14, %if.end10
  ...
  br i1 %cmp28, label %do.bodythread-pre-split, label %do.end
