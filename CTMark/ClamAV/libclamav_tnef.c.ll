; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_tnef.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_tnef.c"
...
land.lhs.true14.i:                                ; preds = %land.lhs.true7.i
  ...
  br i1 %cmp17.not.i.not, label %if.then.i, label %if.end.i121
...
if.end.i121:                                      ; preds = %land.lhs.true14.i
...
tnef_message.exit.thread:                         ; preds = %if.end.i121, %if.then.i
  call void @llvm.lifetime.end.p0(i64 2, ptr nonnull %i16.i) #8
  br label %if.then44

tnef_message.exit:                                ; preds = %if.end.i121
...
sw.bb46:                                          ; preds = %if.end34
  ...
  switch i16 %conv16.i, label %sw.default.i [
    i16 -32752, label %if.end.i134
    i16 -32753, label %sw.bb26.i
  ]

if.end.i134:                                      ; preds = %sw.bb46
  %add.i135 = add nuw nsw i32 %4, 1
  %conv4.i136 = zext i32 %add.i135 to i64
  %call5.i137 = call ptr @cli_malloc(i64 noundef %conv4.i136) #8
  %cmp6.i = icmp eq ptr %call5.i137, null
  br i1 %cmp6.i, label %tnef_attachment.exit.thread, label %if.end9.i

if.end9.i:                                        ; preds = %if.end.i134
  %conv10.i = zext i32 %4 to i64
  %call11.i = call i64 @fread(ptr noundef nonnull %call5.i137, i64 noundef 1, i64 noundef %conv10.i, ptr noundef nonnull %call3)
  %cmp13.not.i = icmp eq i64 %call11.i, %conv10.i
  br i1 %cmp13.not.i, label %if.end16.i, label %if.then15.i

if.then15.i:                                      ; preds = %if.end9.i
  call void @free(ptr noundef nonnull %call5.i137) #8
  br label %tnef_attachment.exit.thread

if.end16.i:                                       ; preds = %if.end9.i
  %arrayidx.i = getelementptr inbounds i8, ptr %call5.i137, i64 %conv10.i
  store i8 0, ptr %arrayidx.i, align 1
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.19, ptr noundef nonnull %call5.i137) #8
...
if.end25.i:                                       ; preds = %if.then19.i, %if.end16.i
  ...
  call void @fileblobSetFilename(ptr noundef nonnull %fb.1, ptr noundef %dir, ptr noundef nonnull %call5.i137) #8
  call void @free(ptr noundef nonnull %call5.i137) #8
  br label %sw.epilog.i128

sw.bb26.i:                                        ; preds = %sw.bb46
  %cmp27.i126 = icmp eq ptr %fb.0256, null
  br i1 %cmp27.i126, label %if.then29.i, label %if.end35.i
...
for.body.i:                                       ; preds = %if.end35.i, %for.inc.i
  ...
  store i32 %call36.i, ptr %c.i, align 4
...
for.inc.i:                                        ; preds = %for.body.i
  %call41.i = call i32 @fileblobAddData(ptr noundef nonnull %fb.2, ptr noundef nonnull %c.i, i64 noundef 1) #8
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %c.i) #8
  %dec.i = add i32 %todo.0129.i, -1
  %tobool.not.i127 = icmp eq i32 %dec.i, 0
  br i1 %tobool.not.i127, label %sw.epilog.i128, label %for.body.i
...
sw.epilog.i128:                                   ; preds = %for.inc.i, %sw.default.i, %cleanup.i, %if.end25.i
...
land.lhs.true49.i:                                ; preds = %sw.epilog.i128
...
if.then67.i:                                      ; preds = %land.lhs.true56.i, %land.lhs.true49.i, %sw.epilog.i128
...
tnef_attachment.exit.thread:                      ; preds = %if.end.i134, %if.then29.i, %if.end68.i, %if.then67.i, %if.then15.i, %if.then23.i
  %fb.4.ph = phi ptr [ %fb.0256, %if.then15.i ], [ null, %if.then23.i ], [ %fb.3, %if.then67.i ], [ %fb.3, %if.end68.i ], [ null, %if.then29.i ], [ %fb.0256, %if.end.i134 ]
...
cleanup:                                          ; preds = %tnef_message.exit, %tnef_attachment.exit, %sw.epilog
  ...
  br i1 %cmp.not.i, label %if.end.i, label %sw.bb
