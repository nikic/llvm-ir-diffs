; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_cab.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_cab.c"
...
entry:
  ...
  %0 = load ptr, ptr %folders, align 8
...
while.body:                                       ; preds = %entry, %while.body
  ...
  store ptr %3, ptr %folders, align 8
  tail call void @free(ptr noundef nonnull %2) #11
  %4 = load ptr, ptr %folders, align 8
...
if.end55:                                         ; preds = %if.else42, %if.then49
  ...
  store i16 %12, ptr %flags69, align 8
  %13 = and i16 %12, 4
...
if.then89:                                        ; preds = %if.then83
  %17 = load i16, ptr %reshdr, align 2
...
if.end94:                                         ; preds = %if.end79, %if.then83, %if.end55
  ...
  %18 = load i16, ptr %flags69, align 8
  %19 = and i16 %18, 1
...
if.end103:                                        ; preds = %if.then99
  %call104 = call fastcc i32 @cab_chkname(ptr noundef %call100)
...
if.end112:                                        ; preds = %if.end108
  %call113 = call fastcc i32 @cab_chkname(ptr noundef %call109)
...
if.end117:                                        ; preds = %if.end112, %if.else116
  ...
  %.pre = load i16, ptr %flags69, align 8
  br label %if.end118
...
if.end127:                                        ; preds = %if.then123
  %call128 = call fastcc i32 @cab_chkname(ptr noundef %call124)
...
if.end136:                                        ; preds = %if.end132
  %call137 = call fastcc i32 @cab_chkname(ptr noundef %call133)
...
if.end169.us:                                     ; preds = %if.end156.us
  ...
  store ptr %cab, ptr %cab170.us, align 8
  %27 = load i32, ptr %folder_hdr, align 4
  ...
  store i64 %add172.us, ptr %offset173.us, align 8
  ...
  store ptr %call166.us, ptr %folders.sink, align 8
...
for.inc.us:                                       ; preds = %if.end169.us
  ...
  %34 = load i16, ptr %nfolders, align 4
  %conv148.us = zext i16 %34 to i32
  %cmp149.us = icmp ult i32 %inc200.us, %conv148.us
  br i1 %cmp149.us, label %for.body.us, label %for.cond201.preheader
...
for.cond201.preheader:                            ; preds = %for.inc, %for.inc.us, %for.cond.preheader
  ...
  %35 = load i16, ptr %nfiles, align 2
...
if.end169:                                        ; preds = %if.end165
  ...
  store ptr %cab, ptr %cab170, align 8
  %36 = load i32, ptr %folder_hdr, align 4
  ...
  store ptr %call166, ptr %next.sink, align 8
...
for.inc:                                          ; preds = %if.end169
  ...
  %43 = load i16, ptr %nfolders, align 4
  %conv148 = zext i16 %43 to i32
  %cmp149 = icmp ult i32 %inc200, %conv148
  br i1 %cmp149, label %for.body, label %for.cond201.preheader
...
if.end220:                                        ; preds = %if.end216
  ...
  store ptr %cab, ptr %cab221, align 8
  %fd222 = getelementptr inbounds %struct.cab_file, ptr %call217, i64 0, i32 5
  store i32 %fd, ptr %fd222, align 4
  %44 = load i32, ptr %file_hdr, align 4
  store i32 %44, ptr %call217, align 8
  %45 = load i32, ptr %uoffFolderStart, align 4
  %conv224 = zext i32 %45 to i64
  %offset225 = getelementptr inbounds %struct.cab_file, ptr %call217, i64 0, i32 2
  store i64 %conv224, ptr %offset225, align 8
  %46 = load i16, ptr %attribs, align 2
  %attribs226 = getelementptr inbounds %struct.cab_file, ptr %call217, i64 0, i32 1
  store i16 %46, ptr %attribs226, align 4
  %47 = load i16, ptr %iFolder, align 4
  ...
  store ptr %call227, ptr %name, align 8
...
if.end230:                                        ; preds = %if.end220
  ...
  %50 = load i64, ptr %offset225, align 8
...
if.then241:                                       ; preds = %if.end230
  ...
  %.pre555 = load i16, ptr %attribs226, align 4
  br label %if.end242
...
if.then247:                                       ; preds = %if.end242
  ...
  %.pre556 = load i16, ptr %attribs226, align 4
  br label %if.end248
...
if.then253:                                       ; preds = %if.end248
  ...
  %.pre557 = load i16, ptr %attribs226, align 4
  br label %if.end254
...
if.then259:                                       ; preds = %if.end254
  ...
  %.pre558 = load i16, ptr %attribs226, align 4
  br label %if.end260
...
if.then265:                                       ; preds = %if.end260
  ...
  %.pre559 = load i16, ptr %attribs226, align 4
  br label %if.end266
...
if.then276:                                       ; preds = %if.end272
  %64 = load i16, ptr %nfolders, align 4
...
if.end290:                                        ; preds = %if.then276
  ...
  %storemerge512 = load ptr, ptr %folders291, align 8
  store ptr %storemerge512, ptr %folder292, align 8
...
while.body:                                       ; preds = %if.end290, %while.body
  ...
  %storemerge = load ptr, ptr %next298, align 8
  store ptr %storemerge, ptr %folder292, align 8
  ...
  br i1 %or.cond482, label %while.end, label %while.body
...
for.inc314:                                       ; preds = %if.then310, %if.else311, %if.else306, %if.end287
  ...
  %70 = load i16, ptr %nfiles, align 2
  %conv203 = zext i16 %70 to i32
  %cmp204 = icmp ult i32 %inc315, %conv203
  br i1 %cmp204, label %for.body206, label %cleanup
...
if.end:                                           ; preds = %entry
  ...
  %cmp2.not35 = icmp sgt i32 %conv, 0
  br i1 %cmp2.not35, label %for.body.preheader, label %cleanup
...
cleanup:                                          ; preds = %for.cond, %if.end15, %if.end8, %if.end, %entry
  %.sink = phi i32 [ -123, %entry ], [ -124, %if.end ], [ -123, %if.end8 ], [ %., %if.end15 ], [ -124, %for.cond ]
  %retval.0 = phi ptr [ null, %entry ], [ null, %if.end ], [ null, %if.end8 ], [ %call17, %if.end15 ], [ null, %for.cond ]
  store i32 %.sink, ptr %ret, align 4
...
if.end:                                           ; preds = %entry
  ...
  %0 = load ptr, ptr %folder2, align 8
...
if.end15:                                         ; preds = %if.end10
  ...
  store i32 %call16, ptr %ofd, align 8
...
if.then28:                                        ; preds = %sw.bb
  ...
  %call31 = tail call fastcc i32 @cab_unstore(ptr noundef nonnull %file, i32 noundef %conv30, i8 noundef zeroext 0)
  br label %if.end32

if.end32:                                         ; preds = %if.then28, %sw.bb
  %10 = load i32, ptr %file, align 8
  %call33 = tail call fastcc i32 @cab_unstore(ptr noundef nonnull %file, i32 noundef %10, i8 noundef zeroext 1)
  br label %sw.epilog

sw.bb34:                                          ; preds = %if.end22
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.47) #11
  %11 = load i32, ptr %fd, align 4
  %12 = load i32, ptr %ofd, align 8
...
if.end46:                                         ; preds = %sw.bb34
  ...
  %15 = load i64, ptr %offset47, align 8
...
if.then62:                                        ; preds = %if.then50
  ...
  store ptr %call68, ptr %stream70, align 8
...
if.end84:                                         ; preds = %if.then50, %if.end78, %if.end46
  ...
  %29 = load ptr, ptr %stream91, align 8
...
sw.bb92:                                          ; preds = %if.end22
  ...
  %31 = load i32, ptr %ofd, align 8
  %32 = load ptr, ptr %folder2, align 8
  ...
  store ptr %call99, ptr %stream101, align 8
...
if.end109:                                        ; preds = %sw.bb92
  ...
  %38 = load i64, ptr %offset110, align 8
...
if.then113:                                       ; preds = %if.end109
  ...
  store i8 0, ptr %wflag116, align 8
...
if.end124:                                        ; preds = %if.then113, %if.end109
  ...
  %44 = load ptr, ptr %stream131, align 8
...
sw.bb132:                                         ; preds = %if.end22
  ...
  %46 = load i32, ptr %ofd, align 8
  %47 = load ptr, ptr %folder2, align 8
  ...
  store ptr %call140, ptr %stream142, align 8
...
if.end150:                                        ; preds = %sw.bb132
  ...
  %53 = load i64, ptr %offset151, align 8
...
if.then154:                                       ; preds = %if.end150
  ...
  store i8 0, ptr %wflag157, align 8
...
if.then167:                                       ; preds = %if.then154
  ...
  %58 = load i32, ptr %ofd, align 8
  %59 = load ptr, ptr %folder2, align 8
  ...
  store ptr %call178, ptr %stream180, align 8
...
if.end194:                                        ; preds = %if.then154, %if.end188, %if.end150
  ...
  %71 = load ptr, ptr %stream201, align 8
...
entry:
  ...
  %conv1123 = and i32 %bytes, 65535
  %cmp.not124 = icmp eq i16 %conv, 0
  br i1 %cmp.not124, label %while.end, label %while.body.lr.ph
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end78
  %conv1127 = phi i32 [ %conv1123, %while.body.lr.ph ], [ %conv1, %if.end78 ]
  %todo.0126 = phi i16 [ %conv, %while.body.lr.ph ], [ %todo.1, %if.end78 ]
  %buffer.addr.0125 = phi ptr [ %buffer, %while.body.lr.ph ], [ %buffer.addr.1, %if.end78 ]
...
if.then:                                          ; preds = %while.body
  ...
  %cmp7 = icmp ugt i32 %conv5, %conv1127
  %spec.select = select i1 %cmp7, i16 %todo.0126, i16 %conv4
  %conv12 = zext i16 %spec.select to i64
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %buffer.addr.0125, ptr align 1 %2, i64 %conv12, i1 false)
  %4 = load ptr, ptr %state, align 8
  %5 = load ptr, ptr %4, align 8
  %add.ptr = getelementptr inbounds i8, ptr %5, i64 %conv12
  store ptr %add.ptr, ptr %4, align 8
  %add.ptr18 = getelementptr inbounds i8, ptr %buffer.addr.0125, i64 %conv12
  %sub = sub i16 %todo.0126, %spec.select
  br label %if.end78

if.else:                                          ; preds = %while.body
  %blknum = getelementptr inbounds %struct.cab_state, ptr %0, i64 0, i32 6
  %6 = load i16, ptr %blknum, align 8
  %inc = add i16 %6, 1
  store i16 %inc, ptr %blknum, align 8
  %7 = load ptr, ptr %folder, align 8
  %nblocks = getelementptr inbounds %struct.cab_folder, ptr %7, i64 0, i32 1
  %8 = load i16, ptr %nblocks, align 2
  %cmp25.not = icmp ult i16 %6, %8
  br i1 %cmp25.not, label %if.end28, label %if.then27

if.then27:                                        ; preds = %if.else
  store i32 -124, ptr %error31, align 8
  br label %while.end

if.end28:                                         ; preds = %if.else
  %9 = load i32, ptr %fd, align 4
  %10 = load ptr, ptr %cab, align 8
  %resdata = getelementptr inbounds %struct.cab_archive, ptr %10, i64 0, i32 5
  %11 = load i8, ptr %resdata, align 4
  ...
  br i1 %cmp.not.i, label %if.end.i, label %cab_read_block.exit.thread
...
land.lhs.true.i:                                  ; preds = %if.end.i
  ...
  br i1 %cmp5.i, label %cab_read_block.exit.thread, label %if.end8.i

if.end8.i:                                        ; preds = %land.lhs.true.i, %if.end.i
  %12 = load i16, ptr %cbData.i, align 4
  %blklen.i = getelementptr inbounds %struct.cab_state, ptr %0, i64 0, i32 3
  store i16 %12, ptr %blklen.i, align 8
  %cmp11.i = icmp ugt i16 %12, -26624
  br i1 %cmp11.i, label %cab_read_block.exit.thread, label %if.end14.i

if.end14.i:                                       ; preds = %if.end8.i
  %13 = load i16, ptr %cbUncomp.i, align 2
  %outlen.i = getelementptr inbounds %struct.cab_state, ptr %0, i64 0, i32 4
  store i16 %13, ptr %outlen.i, align 2
  %cmp17.i = icmp ugt i16 %13, -32768
  br i1 %cmp17.i, label %cab_read_block.exit.thread, label %if.end20.i

if.end20.i:                                       ; preds = %if.end14.i
  %block.i = getelementptr inbounds %struct.cab_state, ptr %0, i64 0, i32 2
  %conv22.i = zext i16 %12 to i32
  %call23.i = call i32 @cli_readn(i32 noundef %9, ptr noundef nonnull %block.i, i32 noundef %conv22.i) #11
  %14 = load i16, ptr %blklen.i, align 8
  %conv25.i = zext i16 %14 to i32
  %cmp26.not.i = icmp eq i32 %call23.i, %conv25.i
  br i1 %cmp26.not.i, label %if.end35, label %cab_read_block.exit.thread

cab_read_block.exit.thread:                       ; preds = %if.end20.i, %if.end14.i, %if.end8.i, %land.lhs.true.i, %if.end28
  %.str.57.sink = phi ptr [ @.str.57, %if.end28 ], [ @.str.58, %land.lhs.true.i ], [ @.str.59, %if.end8.i ], [ @.str.60, %if.end14.i ], [ @.str.61, %if.end20.i ]
  %retval.0.i.ph = phi i32 [ -123, %if.end28 ], [ -123, %land.lhs.true.i ], [ -124, %if.end8.i ], [ -124, %if.end14.i ], [ -123, %if.end20.i ]
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull %.str.57.sink) #11
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %block_hdr.i) #11
  store i32 %retval.0.i.ph, ptr %error31, align 8
  br label %cleanup

if.end35:                                         ; preds = %if.end20.i
  store ptr %block.i, ptr %0, align 8
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %block_hdr.i) #11
  store i32 0, ptr %error31, align 8
  %15 = load ptr, ptr %folder, align 8
...
if.then59:                                        ; preds = %if.then52
  ...
  %27 = load i16, ptr %outlen, align 2
...
if.else69:                                        ; preds = %if.end43
  ...
  %28 = load i16, ptr %outlen71, align 2
...
if.end78:                                         ; preds = %if.then59, %if.then52, %if.then75, %if.else69, %if.then
  %buffer.addr.1 = phi ptr [ %add.ptr18, %if.then ], [ %buffer.addr.0125, %if.then59 ], [ %buffer.addr.0125, %if.then52 ], [ %buffer.addr.0125, %if.then75 ], [ %buffer.addr.0125, %if.else69 ]
  %todo.1 = phi i16 [ %sub, %if.then ], [ %todo.0126, %if.then59 ], [ %todo.0126, %if.then52 ], [ %todo.0126, %if.then75 ], [ %todo.0126, %if.else69 ]
  %conv1 = zext i16 %todo.1 to i32
  %cmp.not = icmp eq i16 %todo.1, 0
  br i1 %cmp.not, label %while.end, label %while.body

while.end:                                        ; preds = %if.end78, %entry, %if.then27
  %conv1122 = phi i32 [ %conv1127, %if.then27 ], [ %conv1123, %entry ], [ 0, %if.end78 ]
  %sub80 = sub nsw i32 %bytes, %conv1122
  br label %cleanup

cleanup:                                          ; preds = %cab_read_block.exit.thread, %while.end
  %retval.0 = phi i32 [ %sub80, %while.end ], [ -1, %cab_read_block.exit.thread ]
  ret i32 %retval.0
}
