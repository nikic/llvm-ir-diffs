...
if.end777:                                        ; preds = %land.lhs.true762
  ...
  %37 = load i8, ptr %add.ptr794, align 1, !tbaa !5
...
if.end804:                                        ; preds = %if.end777
  ...
  %38 = load i8, ptr %add.ptr790, align 1, !tbaa !5
...
vector.body2284:                                  ; preds = %vector.body2284, %vector.ph2274
  ...
  br i1 %53, label %middle.block2271, label %vector.body2284, !llvm.loop !13
...
vector.body2305:                                  ; preds = %vector.body2305, %for.body989.preheader
  ...
  br i1 %69, label %middle.block2293, label %vector.body2305, !llvm.loop !17
...
for.body989:                                      ; preds = %middle.block2293, %for.body989
  ...
  br i1 %exitcond2227.not, label %land.lhs.true999, label %for.body989, !llvm.loop !18
...
vector.body2265:                                  ; preds = %vector.body2265, %for.body1191.preheader
  ...
  br i1 %75, label %middle.block2254, label %vector.body2265, !llvm.loop !19
...
for.body1191:                                     ; preds = %middle.block2254, %for.body1191
  ...
  br i1 %exitcond2225.not, label %for.end1195, label %for.body1191, !llvm.loop !20
...
if.end1260:                                       ; preds = %land.lhs.true1249
  %76 = load i8, ptr %alvalue.5, align 1, !tbaa !5
...
if.end1293.us.us:                                 ; preds = %land.lhs.true1274.us.us
  %77 = load i8, ptr %add.ptr1271.us.us2201, align 1, !tbaa !5
  %78 = and i8 %77, -2
...
if.end1293:                                       ; preds = %land.lhs.true1274
  %79 = load i8, ptr %add.ptr1271, align 1, !tbaa !5
  %80 = and i8 %79, -2
...
do.body:                                          ; preds = %entry, %do.cond454
  ...
  %loc_eax.promoted706 = load i32, ptr %loc_eax, align 4, !tbaa !28
...
if.then48:                                        ; preds = %if.end45
  ...
  store ptr %gep710, ptr %loc_edx, align 8, !tbaa !34
...
for.body289:                                      ; preds = %land.lhs.true263, %for.body289
  ...
  store i8 %30, ptr %loc_edi.1705, align 1, !tbaa !5
