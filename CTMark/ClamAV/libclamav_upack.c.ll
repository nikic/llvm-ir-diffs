; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_upack.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_upack.c"
...
entry:
  %dest2270 = ptrtoint ptr %dest to i64
...
land.lhs.true16:                                  ; preds = %if.end
  ...
  %cmp20.not.not = icmp ugt ptr %add.ptr17, %add.ptr19
  br i1 %cmp20.not.not, label %cleanup1376, label %if.end27

if.end27:                                         ; preds = %land.lhs.true16
  %add.ptr7.val2122 = load i32, ptr %add.ptr7, align 1
  %sub31 = sub i32 %add.ptr7.val2122, %vma
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str, i32 noundef %ep, i32 noundef %sub31, i32 noundef %add.ptr7.val2122) #4
...
lor.lhs.false:                                    ; preds = %if.then36
  ...
  %2 = load i8, ptr %arrayidx68, align 1
...
if.end73:                                         ; preds = %lor.lhs.false
  ...
  %3 = load i8, ptr %add.ptr76, align 1
  ...
  %or.cond2204 = select i1 %cmp90.not, i1 %cmp96.not, i1 false
  br i1 %or.cond2204, label %lor.lhs.false102, label %cleanup1376

lor.lhs.false102:                                 ; preds = %if.end73
  %4 = load i8, ptr %add.ptr83, align 1
...
if.end107:                                        ; preds = %lor.lhs.false102
  ...
  %conv1082066 = zext i8 %5 to i64
  %add110 = add nuw nsw i64 %conv1082066, 11
...
lor.lhs.false140:                                 ; preds = %land.lhs.true118
  ...
  %6 = load i8, ptr %arrayidx143, align 1
...
if.end159:                                        ; preds = %if.end148, %if.end107
  ...
  %or.cond2205 = select i1 %cmp166.not, i1 %cmp172.not, i1 false
  br i1 %or.cond2205, label %lor.lhs.false178, label %cleanup1376

lor.lhs.false178:                                 ; preds = %if.end159
  %7 = load i8, ptr %alvalue.0, align 1
...
if.end183:                                        ; preds = %lor.lhs.false178
  ...
  %8 = load i8, ptr %incdec.ptr184, align 1
  %conv1852067 = zext i8 %8 to i32
...
land.lhs.true200:                                 ; preds = %if.end183
  ...
  %or.cond2076 = and i1 %cmp206.not, %cmp212
  br i1 %or.cond2076, label %lor.lhs.false214, label %cleanup1376

lor.lhs.false214:                                 ; preds = %land.lhs.true200
  %9 = load i8, ptr %add.ptr202, align 1
...
if.then228:                                       ; preds = %if.end221
  ...
  %10 = load i8, ptr %add.ptr231, align 1
...
if.end245:                                        ; preds = %if.else237, %if.then228
  ...
  %or.cond2206 = select i1 %cmp256.not, i1 %cmp263.not, i1 false
  br i1 %or.cond2206, label %lor.lhs.false270, label %if.then275

lor.lhs.false270:                                 ; preds = %if.end245
  %add.ptr248 = getelementptr inbounds i8, ptr %add.ptr247, i64 43
  %14 = load i8, ptr %add.ptr255, align 1
...
if.then275:                                       ; preds = %lor.lhs.false270, %if.end245
  ...
  %or.cond2207 = select i1 %cmp286.not, i1 %cmp293.not, i1 false
  br i1 %or.cond2207, label %lor.lhs.false300, label %cleanup1376

lor.lhs.false300:                                 ; preds = %if.then275
  %add.ptr278 = getelementptr inbounds i8, ptr %add.ptr247, i64 46
  %15 = load i8, ptr %add.ptr285, align 1
...
if.end312:                                        ; preds = %lor.lhs.false300, %lor.lhs.false270
  ...
  %16 = load i8, ptr %alvalue.1, align 1
  %conv3132068 = zext i8 %16 to i64
  %add315 = add nuw nsw i64 %conv3132068, 1
...
land.lhs.true331:                                 ; preds = %if.end312
  ...
  %or.cond2079 = and i1 %cmp337.not, %cmp343
  br i1 %or.cond2079, label %lor.lhs.false345, label %cleanup1376

lor.lhs.false345:                                 ; preds = %land.lhs.true331
  %17 = load i8, ptr %add.ptr333, align 1
...
if.end352:                                        ; preds = %lor.lhs.false345
  ...
  %spec.select = getelementptr inbounds i8, ptr %add.ptr362, i64 %spec.select.idx
...
land.lhs.true380:                                 ; preds = %if.end352
  ...
  %or.cond2080 = and i1 %cmp388.not, %cmp396
  br i1 %or.cond2080, label %lor.lhs.false398, label %cleanup1376

lor.lhs.false398:                                 ; preds = %land.lhs.true380
  %18 = load i8, ptr %add.ptr377, align 1
...
lor.lhs.false406:                                 ; preds = %lor.lhs.false398
  ...
  %19 = load i8, ptr %add.ptr411, align 1
...
if.end416:                                        ; preds = %lor.lhs.false406
  ...
  %20 = load i8, ptr %add.ptr421, align 1
  %conv4222069 = zext i8 %20 to i32
  %mul = shl nuw nsw i32 %conv1852067, 8
  %21 = add i8 %20, -9
...
if.end430:                                        ; preds = %if.end416
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.2, i32 noundef %conv4222069, i32 noundef %mul) #4
...
land.lhs.true439:                                 ; preds = %if.end430
  ...
  %or.cond2208 = select i1 %cmp441.not, i1 %cmp448.not, i1 false
  br i1 %or.cond2208, label %lor.lhs.false455, label %cleanup1376

lor.lhs.false455:                                 ; preds = %land.lhs.true439
  %22 = load i8, ptr %add.ptr440, align 1
...
lor.lhs.false460:                                 ; preds = %lor.lhs.false455
  ...
  %23 = load i8, ptr %add.ptr461, align 1
...
if.end466:                                        ; preds = %lor.lhs.false460
  ...
  %add.ptr467.val2121 = load i32, ptr %add.ptr467, align 1
  %cmp469 = icmp ult i32 %add.ptr467.val2121, %base
  %cmp474 = icmp ugt i32 %add.ptr467.val2121, %vma
  %or.cond2155 = or i1 %cmp469, %cmp474
  br i1 %or.cond2155, label %cleanup1376, label %land.lhs.true528
...
land.lhs.true494:                                 ; preds = %if.end430
  ...
  %or.cond2209 = select i1 %cmp496.not, i1 %cmp503.not, i1 false
  br i1 %or.cond2209, label %lor.lhs.false510, label %cleanup1376

lor.lhs.false510:                                 ; preds = %land.lhs.true494
  %24 = load i8, ptr %add.ptr495, align 1
...
land.lhs.true550:                                 ; preds = %land.lhs.true541
  %cmp555 = icmp ule ptr %add.ptr545, %dest
  %cmp561 = icmp ult i32 %dsize, 192
  %or.cond1411.not2238 = or i1 %cmp561, %cmp555
  %add.ptr567 = getelementptr inbounds i8, ptr %loc_esi.12126, i64 192
  %cmp570.not.not = icmp ugt ptr %add.ptr567, %add.ptr19
  %or.cond = select i1 %or.cond1411.not2238, i1 true, i1 %cmp570.not.not
  br i1 %or.cond, label %cleanup1376, label %for.body.preheader

for.body.preheader:                               ; preds = %land.lhs.true550
...
land.lhs.true586:                                 ; preds = %lor.lhs.false510
  ...
  %or.cond2210 = select i1 %or.cond2085.not, i1 %cmp606.not, i1 false
  %cmp619 = icmp ugt i32 %dsize, 211
  %or.cond2211 = and i1 %or.cond2210, %cmp619
  br i1 %or.cond2211, label %land.lhs.true624, label %cleanup1376
...
land.lhs.true624:                                 ; preds = %land.lhs.true586
  ...
  %cmp628.not.not = icmp ugt ptr %add.ptr625, %add.ptr19
  br i1 %cmp628.not.not, label %cleanup1376, label %for.body639.preheader
...
if.end646:                                        ; preds = %for.body639.preheader, %for.body.preheader
  ...
  %cmp6662176.not = icmp eq i8 %8, 0
  br i1 %cmp6662176.not, label %for.end672, label %for.body668.preheader
...
for.body668.preheader:                            ; preds = %if.end646
  ...
  %umax2249 = tail call i64 @llvm.umax.i64(i64 %26, i64 1)
  %n.vec = and i64 %umax2249, 65280
  %ind.end = trunc i64 %n.vec to i32
  %27 = shl nuw nsw i64 %n.vec, 2
  %ind.end2250 = getelementptr i8, ptr %add.ptr663.3, i64 %27
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %for.body668.preheader
  %index = phi i64 [ 0, %for.body668.preheader ], [ %index.next, %vector.body ]
  %28 = shl i64 %index, 2
...
middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %umax2249, %n.vec
  br i1 %cmp.n, label %for.end672, label %for.body668

for.body668:                                      ; preds = %middle.block, %for.body668
  %j.32178 = phi i32 [ %inc670, %for.body668 ], [ %ind.end, %middle.block ]
  %loc_edi.62177 = phi ptr [ %add.ptr671, %for.body668 ], [ %ind.end2250, %middle.block ]
  store i32 1024, ptr %loc_edi.62177, align 1
  %inc670 = add nuw nsw i32 %j.32178, 1
  %add.ptr671 = getelementptr inbounds i8, ptr %loc_edi.62177, i64 4
  %exitcond.not = icmp eq i32 %inc670, %umax
  br i1 %exitcond.not, label %for.end672, label %for.body668
...
cleanup:                                          ; preds = %for.end672, %if.then698
  ...
  %call709 = tail call i32 @unupack399(ptr noundef %dest, i32 noundef %dsize, i32 noundef 0, ptr noundef nonnull %loc_edi.4, i32 noundef 0, ptr noundef %loc_edi.7, ptr noundef %end_edi.0, i32 noundef %conv4222069, ptr noundef %add.ptr654)
...
land.lhs.true725:                                 ; preds = %if.else716
  ...
  %32 = load i8, ptr %arrayidx726, align 1
...
land.lhs.true730:                                 ; preds = %land.lhs.true725
  ...
  %33 = load i8, ptr %arrayidx731, align 1
...
if.end741:                                        ; preds = %land.lhs.true730
  ...
  %34 = load i8, ptr %arrayidx736, align 1
  %cmp738 = icmp eq i8 %34, -8
  br i1 %cmp738, label %if.end748, label %if.else746
...
if.end748:                                        ; preds = %if.end741, %if.else746
  ...
  %or.cond2089 = select i1 %cmp749.not, i1 true, i1 %cmp757.not
  %cmp760.not = icmp ult ptr %add.ptr720, %dest
  %or.cond2090 = select i1 %or.cond2089, i1 true, i1 %cmp760.not
  br i1 %or.cond2090, label %cleanup1376, label %land.lhs.true762
...
land.lhs.true762:                                 ; preds = %if.end748
  ...
  %or.cond2091 = and i1 %cmp768.not, %cmp774
  br i1 %or.cond2091, label %if.end777, label %cleanup1376
...
if.end777:                                        ; preds = %land.lhs.true762
  ...
  %36 = add i32 %35, 4
  %conv787 = add i32 %36, %ep_jmp_offs.0
  ...
  %37 = load i8, ptr %add.ptr794, align 1
  %conv7952065 = zext i8 %37 to i32
  %sub797 = sub nsw i32 8, %conv7952065
  %cmp798 = icmp ult i32 %sub797, 2
  %cmp801 = icmp ugt i8 %37, 8
...
if.end804:                                        ; preds = %if.end777
  ...
  %38 = load i8, ptr %add.ptr790, align 1
  %conv7912064 = zext i8 %38 to i32
  %mul805 = shl nuw nsw i32 %conv7912064, 8
...
land.lhs.true828:                                 ; preds = %if.end815
  ...
  %or.cond2092 = and i1 %cmp832.not, %cmp836
  br i1 %or.cond2092, label %if.end839, label %cleanup1376

if.end839:                                        ; preds = %land.lhs.true828
  %add.ptr819.val2119 = load i32, ptr %add.ptr819, align 1
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.6, ptr noundef nonnull %add.ptr819, ptr noundef nonnull %dest, i32 noundef %add.ptr819.val2119, i32 noundef %base) #4
  ...
  %add.ptr851.val2118 = load i32, ptr %add.ptr851, align 1
  %idx.ext853 = sext i32 %add.ptr851.val2118 to i64
  %add.ptr854 = getelementptr i8, ptr %dest, i64 %idx.ext853
  %add.ptr857 = getelementptr i8, ptr %add.ptr854, i64 %idx.neg845
  %sub860 = sub i32 %add.ptr851.val2118, %base
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.8, i32 noundef %add.ptr851.val2118, i32 noundef %sub860) #4
...
if.end866:                                        ; preds = %if.end839
  ...
  %or.cond2093 = select i1 %cmp872, i1 true, i1 %cmp876.not
  %cmp879.not = icmp ult ptr %add.ptr829, %dest
  %or.cond2094 = or i1 %cmp879.not, %or.cond2093
  br i1 %or.cond2094, label %cleanup1376, label %land.lhs.true881
...
land.lhs.true881:                                 ; preds = %if.end866
  ...
  %or.cond2095 = and i1 %cmp887.not, %cmp893
  br i1 %or.cond2095, label %land.lhs.true898, label %cleanup1376

land.lhs.true898:                                 ; preds = %land.lhs.true881
  %add899 = add nuw i32 %add.ptr861.val, %mul805
  %mul900 = shl i32 %add899, 2
  %39 = add i32 %mul900, -1
  %or.cond2096 = icmp uge i32 %39, %dsize
  %cmp909.not = icmp ult ptr %add.ptr857, %dest
  %or.cond2097 = or i1 %or.cond2096, %cmp909.not
  br i1 %or.cond2097, label %cleanup1376, label %land.lhs.true911
...
land.lhs.true911:                                 ; preds = %land.lhs.true898
  ...
  %or.cond2098 = and i1 %cmp918.not, %cmp925
  br i1 %or.cond2098, label %for.body931.preheader, label %cleanup1376

for.body931.preheader:                            ; preds = %land.lhs.true911
  %40 = zext i32 %add.ptr861.val to i64
  %min.iters.check2273 = icmp ult i32 %add.ptr861.val, 20
  br i1 %min.iters.check2273, label %for.body931.preheader2321, label %vector.memcheck

vector.memcheck:                                  ; preds = %for.body931.preheader
  %41 = add i64 %dest2270, %idx.ext853
  %42 = sub i64 %41, %idx.ext844
  %43 = add i64 %dest2270, %idx.ext719
  %44 = add i64 %43, %idx.ext717
  %45 = add i64 %44, 16
  %.neg = sub i64 %idx.ext817, %45
  %46 = add i64 %.neg, %42
  %diff.check = icmp ult i64 %46, 32
  br i1 %diff.check, label %for.body931.preheader2321, label %vector.ph2274

vector.ph2274:                                    ; preds = %vector.memcheck
  %n.vec2276 = and i64 %40, 4294967288
  %.cast = trunc i64 %n.vec2276 to i32
  %ind.end2277 = sub i32 %add.ptr861.val, %.cast
  %47 = shl nuw nsw i64 %n.vec2276, 2
  %ind.end2279 = getelementptr i8, ptr %add.ptr857, i64 %47
  %48 = shl nuw nsw i64 %n.vec2276, 2
  %ind.end2281 = getelementptr i8, ptr %add.ptr829, i64 %48
  br label %vector.body2284

vector.body2284:                                  ; preds = %vector.body2284, %vector.ph2274
  %index2285 = phi i64 [ 0, %vector.ph2274 ], [ %index.next2291, %vector.body2284 ]
  %49 = shl i64 %index2285, 2
  %next.gep2286 = getelementptr i8, ptr %add.ptr857, i64 %49
  %50 = shl i64 %index2285, 2
  %next.gep2288 = getelementptr i8, ptr %add.ptr829, i64 %50
  %wide.load = load <4 x i32>, ptr %next.gep2288, align 1
  %51 = getelementptr i32, ptr %next.gep2288, i64 4
  %wide.load2290 = load <4 x i32>, ptr %51, align 1
  store <4 x i32> %wide.load, ptr %next.gep2286, align 1
  %52 = getelementptr i32, ptr %next.gep2286, i64 4
  store <4 x i32> %wide.load2290, ptr %52, align 1
  %index.next2291 = add nuw i64 %index2285, 8
  %53 = icmp eq i64 %index.next2291, %n.vec2276
  br i1 %53, label %middle.block2271, label %vector.body2284

middle.block2271:                                 ; preds = %vector.body2284
  %cmp.n2283 = icmp eq i64 %n.vec2276, %40
  br i1 %cmp.n2283, label %land.lhs.true945, label %for.body931.preheader2321

for.body931.preheader2321:                        ; preds = %vector.memcheck, %for.body931.preheader, %middle.block2271
  %j.42187.ph = phi i32 [ %add.ptr861.val, %vector.memcheck ], [ %add.ptr861.val, %for.body931.preheader ], [ %ind.end2277, %middle.block2271 ]
  %loc_edi.92186.ph = phi ptr [ %add.ptr857, %vector.memcheck ], [ %add.ptr857, %for.body931.preheader ], [ %ind.end2279, %middle.block2271 ]
  %loc_esi.52185.ph = phi ptr [ %add.ptr829, %vector.memcheck ], [ %add.ptr829, %for.body931.preheader ], [ %ind.end2281, %middle.block2271 ]
  %54 = add nsw i32 %j.42187.ph, -1
  %xtraiter = and i32 %j.42187.ph, 7
...
for.body931.prol:                                 ; preds = %for.body931.preheader2321, %for.body931.prol
  %j.42187.prol = phi i32 [ %dec.prol, %for.body931.prol ], [ %j.42187.ph, %for.body931.preheader2321 ]
  %loc_edi.92186.prol = phi ptr [ %add.ptr934.prol, %for.body931.prol ], [ %loc_edi.92186.ph, %for.body931.preheader2321 ]
  %loc_esi.52185.prol = phi ptr [ %add.ptr935.prol, %for.body931.prol ], [ %loc_esi.52185.ph, %for.body931.preheader2321 ]
  %prol.iter = phi i32 [ %prol.iter.next, %for.body931.prol ], [ 0, %for.body931.preheader2321 ]
  %dec.prol = add nsw i32 %j.42187.prol, -1
  %loc_esi.5.val.prol = load i32, ptr %loc_esi.52185.prol, align 1
  store i32 %loc_esi.5.val.prol, ptr %loc_edi.92186.prol, align 1
  %add.ptr934.prol = getelementptr inbounds i8, ptr %loc_edi.92186.prol, i64 4
  %add.ptr935.prol = getelementptr inbounds i8, ptr %loc_esi.52185.prol, i64 4
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body931.prol.loopexit, label %for.body931.prol
...
for.body931.prol.loopexit:                        ; preds = %for.body931.prol, %for.body931.preheader2321
  ...
  %j.42187.unr = phi i32 [ %j.42187.ph, %for.body931.preheader2321 ], [ %dec.prol, %for.body931.prol ]
  %loc_edi.92186.unr = phi ptr [ %loc_edi.92186.ph, %for.body931.preheader2321 ], [ %add.ptr934.prol, %for.body931.prol ]
  %loc_esi.52185.unr = phi ptr [ %loc_esi.52185.ph, %for.body931.preheader2321 ], [ %add.ptr935.prol, %for.body931.prol ]
  %55 = icmp ult i32 %54, 7
  br i1 %55, label %land.lhs.true945, label %for.body931

for.body931:                                      ; preds = %for.body931.prol.loopexit, %for.body931
  %j.42187 = phi i32 [ %dec.7, %for.body931 ], [ %j.42187.unr, %for.body931.prol.loopexit ]
  %loc_edi.92186 = phi ptr [ %add.ptr934.7, %for.body931 ], [ %loc_edi.92186.unr, %for.body931.prol.loopexit ]
  %loc_esi.52185 = phi ptr [ %add.ptr935.7, %for.body931 ], [ %loc_esi.52185.unr, %for.body931.prol.loopexit ]
  %loc_esi.5.val = load i32, ptr %loc_esi.52185, align 1
  store i32 %loc_esi.5.val, ptr %loc_edi.92186, align 1
  %add.ptr934 = getelementptr inbounds i8, ptr %loc_edi.92186, i64 4
  %add.ptr935 = getelementptr inbounds i8, ptr %loc_esi.52185, i64 4
  %loc_esi.5.val.1 = load i32, ptr %add.ptr935, align 1
  store i32 %loc_esi.5.val.1, ptr %add.ptr934, align 1
  %add.ptr934.1 = getelementptr inbounds i8, ptr %loc_edi.92186, i64 8
  %add.ptr935.1 = getelementptr inbounds i8, ptr %loc_esi.52185, i64 8
  %loc_esi.5.val.2 = load i32, ptr %add.ptr935.1, align 1
  store i32 %loc_esi.5.val.2, ptr %add.ptr934.1, align 1
  %add.ptr934.2 = getelementptr inbounds i8, ptr %loc_edi.92186, i64 12
  %add.ptr935.2 = getelementptr inbounds i8, ptr %loc_esi.52185, i64 12
  %loc_esi.5.val.3 = load i32, ptr %add.ptr935.2, align 1
  store i32 %loc_esi.5.val.3, ptr %add.ptr934.2, align 1
  %add.ptr934.3 = getelementptr inbounds i8, ptr %loc_edi.92186, i64 16
  %add.ptr935.3 = getelementptr inbounds i8, ptr %loc_esi.52185, i64 16
  %loc_esi.5.val.4 = load i32, ptr %add.ptr935.3, align 1
  store i32 %loc_esi.5.val.4, ptr %add.ptr934.3, align 1
  %add.ptr934.4 = getelementptr inbounds i8, ptr %loc_edi.92186, i64 20
  %add.ptr935.4 = getelementptr inbounds i8, ptr %loc_esi.52185, i64 20
  %loc_esi.5.val.5 = load i32, ptr %add.ptr935.4, align 1
  store i32 %loc_esi.5.val.5, ptr %add.ptr934.4, align 1
  %add.ptr934.5 = getelementptr inbounds i8, ptr %loc_edi.92186, i64 24
  %add.ptr935.5 = getelementptr inbounds i8, ptr %loc_esi.52185, i64 24
  %loc_esi.5.val.6 = load i32, ptr %add.ptr935.5, align 1
  store i32 %loc_esi.5.val.6, ptr %add.ptr934.5, align 1
  %add.ptr934.6 = getelementptr inbounds i8, ptr %loc_edi.92186, i64 28
  %add.ptr935.6 = getelementptr inbounds i8, ptr %loc_esi.52185, i64 28
  %dec.7 = add nsw i32 %j.42187, -8
  %loc_esi.5.val.7 = load i32, ptr %add.ptr935.6, align 1
  store i32 %loc_esi.5.val.7, ptr %add.ptr934.6, align 1
  %add.ptr934.7 = getelementptr inbounds i8, ptr %loc_edi.92186, i64 32
  %add.ptr935.7 = getelementptr inbounds i8, ptr %loc_esi.52185, i64 32
  %tobool930.not.7 = icmp eq i32 %dec.7, 0
  br i1 %tobool930.not.7, label %land.lhs.true945, label %for.body931

land.lhs.true945:                                 ; preds = %for.body931.prol.loopexit, %for.body931, %middle.block2271
  %add.ptr934.lcssa = phi ptr [ %ind.end2279, %middle.block2271 ], [ %add.ptr934.lcssa2322.unr, %for.body931.prol.loopexit ], [ %add.ptr934.7, %for.body931 ]
  ...
  %or.cond2099 = and i1 %cmp949.not, %cmp953
  br i1 %or.cond2099, label %if.end956, label %cleanup1376
...
if.end956:                                        ; preds = %land.lhs.true945
  ...
  %56 = add nuw nsw i64 %idx.ext959, 4
  %57 = add i32 %add.ptr857.val, -1
  %58 = zext i32 %57 to i64
  %59 = mul i64 %56, %58
  %60 = add i64 %59, %idx.ext853
  %61 = add i64 %60, %idx.ext959
  %62 = add i64 %61, 4
  %63 = sub i64 %62, %idx.ext844
  %add.ptr958 = getelementptr inbounds i8, ptr %add.ptr857, i64 4
  %scevgep = getelementptr i8, ptr %dest, i64 %63
  ...
  %or.cond2212 = select i1 %cmp970.not, i1 %cmp976.not, i1 false
  br i1 %or.cond2212, label %if.end983, label %cleanup1376

if.end983:                                        ; preds = %if.end956
  %add.ptr961.val = load i32, ptr %add.ptr961.le, align 1
  %cmp9872189.not = icmp eq i8 %38, 0
  br i1 %cmp9872189.not, label %land.lhs.true999, label %for.body989.preheader

for.body989.preheader:                            ; preds = %if.end983
  %umax2226 = tail call i32 @llvm.umax.i32(i32 %mul805, i32 1)
  %64 = zext i8 %38 to i64
  %65 = shl nuw nsw i64 %64, 8
  %umax2292 = tail call i64 @llvm.umax.i64(i64 %65, i64 1)
  %n.vec2298 = and i64 %umax2292, 65280
  %ind.end2300 = trunc i64 %n.vec2298 to i32
  %66 = shl nuw nsw i64 %n.vec2298, 2
  %ind.end2302 = getelementptr i8, ptr %add.ptr934.lcssa, i64 %66
  %broadcast.splatinsert = insertelement <4 x i32> poison, i32 %add.ptr961.val, i64 0
  %broadcast.splat = shufflevector <4 x i32> %broadcast.splatinsert, <4 x i32> poison, <4 x i32> zeroinitializer
  br label %vector.body2305

vector.body2305:                                  ; preds = %vector.body2305, %for.body989.preheader
  %index2306 = phi i64 [ 0, %for.body989.preheader ], [ %index.next2309, %vector.body2305 ]
  %67 = shl i64 %index2306, 2
  %next.gep2307 = getelementptr i8, ptr %add.ptr934.lcssa, i64 %67
  store <4 x i32> %broadcast.splat, ptr %next.gep2307, align 1
  %68 = getelementptr i32, ptr %next.gep2307, i64 4
  store <4 x i32> %broadcast.splat, ptr %68, align 1
  %index.next2309 = add nuw i64 %index2306, 8
  %69 = icmp eq i64 %index.next2309, %n.vec2298
  br i1 %69, label %middle.block2293, label %vector.body2305

middle.block2293:                                 ; preds = %vector.body2305
  %cmp.n2304 = icmp eq i64 %umax2292, %n.vec2298
  br i1 %cmp.n2304, label %land.lhs.true999, label %for.body989

for.body989:                                      ; preds = %middle.block2293, %for.body989
  %j.52191 = phi i32 [ %inc991, %for.body989 ], [ %ind.end2300, %middle.block2293 ]
  %loc_edi.102190 = phi ptr [ %add.ptr992, %for.body989 ], [ %ind.end2302, %middle.block2293 ]
  store i32 %add.ptr961.val, ptr %loc_edi.102190, align 1
  %inc991 = add nuw nsw i32 %j.52191, 1
  %add.ptr992 = getelementptr inbounds i8, ptr %loc_edi.102190, i64 4
  %exitcond2227.not = icmp eq i32 %inc991, %umax2226
  br i1 %exitcond2227.not, label %land.lhs.true999, label %for.body989

land.lhs.true999:                                 ; preds = %for.body989, %middle.block2293, %if.end983
  ...
  br i1 %cmp1008.not.not, label %cleanup1376, label %land.lhs.true1036

land.lhs.true1036:                                ; preds = %land.lhs.true999
...
land.lhs.true1054:                                ; preds = %land.lhs.true1036
...
land.lhs.true1058:                                ; preds = %land.lhs.true1054
  ...
  %or.cond2103.not2156 = or i1 %cmp1063.not, %cmp1068
  %add.ptr1077 = getelementptr inbounds i8, ptr %add.ptr857, i64 72
  %cmp1078.not = icmp ult ptr %add.ptr1077, %dest
  %or.cond2104 = select i1 %or.cond2103.not2156, i1 true, i1 %cmp1078.not
  br i1 %or.cond2104, label %cleanup1376, label %land.lhs.true1080
...
land.lhs.true1080:                                ; preds = %land.lhs.true1058
  ...
  %or.cond2105 = and i1 %cmp1085.not, %cmp1090
  br i1 %or.cond2105, label %for.cond1094.preheader, label %cleanup1376
...
if.then1128:                                      ; preds = %if.else1125
  ...
  %add1148 = shl nuw nsw i32 %conv7912064, 10
  %mul1149 = or i32 %add1148, 24
  %cmp1155.not = icmp ugt i32 %mul1149, %dsize
  %cmp1158.not = icmp ult ptr %add.ptr1144, %dest
  %or.cond2106 = select i1 %cmp1155.not, i1 true, i1 %cmp1158.not
  br i1 %or.cond2106, label %cleanup1376, label %land.lhs.true1160
...
land.lhs.true1160:                                ; preds = %if.then1128
  ...
  %or.cond2107 = and i1 %cmp1167.not, %cmp1174
  br i1 %or.cond2107, label %if.end1177, label %cleanup1376
...
if.end1177:                                       ; preds = %land.lhs.true1160
  ...
  %cmp11892181.not = icmp eq i8 %38, 0
  br i1 %cmp11892181.not, label %for.end1195, label %for.body1191.preheader

for.body1191.preheader:                           ; preds = %if.end1177
  %add.ptr1186.3 = getelementptr inbounds i8, ptr %add.ptr1135, i64 28
  %umax2224 = tail call i32 @llvm.umax.i32(i32 %mul805, i32 1)
  %70 = zext i8 %38 to i64
  %71 = shl nuw nsw i64 %70, 8
  %umax2253 = tail call i64 @llvm.umax.i64(i64 %71, i64 1)
  %n.vec2259 = and i64 %umax2253, 65280
  %ind.end2260 = trunc i64 %n.vec2259 to i32
  %72 = shl nuw nsw i64 %n.vec2259, 2
  %ind.end2262 = getelementptr i8, ptr %add.ptr1186.3, i64 %72
  br label %vector.body2265

vector.body2265:                                  ; preds = %vector.body2265, %for.body1191.preheader
  %index2266 = phi i64 [ 0, %for.body1191.preheader ], [ %index.next2269, %vector.body2265 ]
  %73 = shl i64 %index2266, 2
  %next.gep2267 = getelementptr i8, ptr %add.ptr1186.3, i64 %73
  store <4 x i32> <i32 1024, i32 1024, i32 1024, i32 1024>, ptr %next.gep2267, align 1
  %74 = getelementptr i32, ptr %next.gep2267, i64 4
  store <4 x i32> <i32 1024, i32 1024, i32 1024, i32 1024>, ptr %74, align 1
  %index.next2269 = add nuw i64 %index2266, 8
  %75 = icmp eq i64 %index.next2269, %n.vec2259
  br i1 %75, label %middle.block2254, label %vector.body2265

middle.block2254:                                 ; preds = %vector.body2265
  %cmp.n2264 = icmp eq i64 %umax2253, %n.vec2259
  br i1 %cmp.n2264, label %for.end1195, label %for.body1191

for.body1191:                                     ; preds = %middle.block2254, %for.body1191
  %j.82183 = phi i32 [ %inc1193, %for.body1191 ], [ %ind.end2260, %middle.block2254 ]
  %loc_edi.122182 = phi ptr [ %add.ptr1194, %for.body1191 ], [ %ind.end2262, %middle.block2254 ]
  store i32 1024, ptr %loc_edi.122182, align 1
  %inc1193 = add nuw nsw i32 %j.82183, 1
  %add.ptr1194 = getelementptr inbounds i8, ptr %loc_edi.122182, i64 4
  %exitcond2225.not = icmp eq i32 %inc1193, %umax2224
  br i1 %exitcond2225.not, label %for.end1195, label %for.body1191

for.end1195:                                      ; preds = %for.body1191, %middle.block2254, %if.end1177
...
if.end1240:                                       ; preds = %if.end1240.sink.split, %if.else1223, %cleanup
  ...
  %or.cond2108 = select i1 %cmp1244.not, i1 true, i1 %cmp1247.not
  br i1 %or.cond2108, label %if.then1259, label %land.lhs.true1249
...
if.end1260:                                       ; preds = %land.lhs.true1249
  %76 = load i8, ptr %alvalue.5, align 1
  %conv12612070 = zext i8 %76 to i32
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.14, i32 noundef %save3.4, i32 noundef %conv12612070) #4
  %tobool1263.not2194 = icmp eq i32 %save3.4, 0
  br i1 %tobool1263.not2194, label %while.end, label %while.cond.outer.split.lr.ph
...
while.cond.outer.split.lr.ph.split.us.split:      ; preds = %while.cond.outer.split.lr.ph
  %cmp1272.not.us.us2199 = icmp ult ptr %loc_edi.15, %dest
  br i1 %cmp1272.not.us.us2199, label %if.then1288, label %land.lhs.true1274.us.us

land.lhs.true1274.us.us:                          ; preds = %while.cond.outer.split.lr.ph.split.us.split, %if.else1358.split.us.us
  %add.ptr1271.us.us2201 = phi ptr [ %add.ptr1271.us.us, %if.else1358.split.us.us ], [ %loc_edi.15, %while.cond.outer.split.lr.ph.split.us.split ]
  %loc_ecx.2.ph2196.us2200 = phi i32 [ %inc1359.us, %if.else1358.split.us.us ], [ 0, %while.cond.outer.split.lr.ph.split.us.split ]
  %add.ptr1277.us.us = getelementptr inbounds i8, ptr %add.ptr1271.us.us2201, i64 1
...
while.cond.outer.split:                           ; preds = %while.cond.outer.split.lr.ph, %if.end1360
  %loc_ecx.2.ph2196 = phi i32 [ %loc_ecx.4, %if.end1360 ], [ 0, %while.cond.outer.split.lr.ph ]
  %save3.5.ph2195 = phi i32 [ %save3.7, %if.end1360 ], [ %save3.4, %while.cond.outer.split.lr.ph ]
  br label %while.cond

while.cond:                                       ; preds = %while.cond.outer.split, %if.end1329
  %loc_ecx.2 = phi i32 [ %inc1309, %if.end1329 ], [ %loc_ecx.2.ph2196, %while.cond.outer.split ]
...
if.then1288:                                      ; preds = %while.cond, %land.lhs.true1274, %if.else1358.split.us.us, %land.lhs.true1274.us.us, %while.cond.outer.split.lr.ph.split.us.split
  %.us-phi = phi ptr [ %loc_edi.15, %while.cond.outer.split.lr.ph.split.us.split ], [ %add.ptr1271.us.us2201, %land.lhs.true1274.us.us ], [ %add.ptr1271.us.us, %if.else1358.split.us.us ], [ %add.ptr1271, %land.lhs.true1274 ], [ %add.ptr1271, %while.cond ]
...
if.end1293:                                       ; preds = %land.lhs.true1274
  %79 = load i8, ptr %add.ptr1271, align 1
  %80 = and i8 %79, -2
  %switch = icmp eq i8 %80, -24
...
if.end1329:                                       ; preds = %if.then1305
  ...
  %add.ptr1277.val2116 = load i32, ptr %add.ptr1277, align 1
  %81 = trunc i32 %add.ptr1277.val2116 to i8
  %cmp1332.not = icmp eq i8 %76, %81
  br i1 %cmp1332.not, label %cleanup1355.thread2151, label %while.cond

cleanup1355.thread2151:                           ; preds = %if.end1329
  %shr = lshr i32 %add.ptr1277.val2116, 24
  %and1340 = lshr i32 %add.ptr1277.val2116, 8
  %shr1341 = and i32 %and1340, 65280
  %or = or i32 %shr, %shr1341
  %and1344 = shl i32 %add.ptr1277.val2116, 8
  ...
  %dec1354 = add i32 %save3.5.ph2195, -1
  br label %if.end1360
...
if.end1360:                                       ; preds = %cleanup1355.thread2151, %if.else1358.split
  %save3.7 = phi i32 [ %save3.5.ph2195, %if.else1358.split ], [ %dec1354, %cleanup1355.thread2151 ]
  %loc_ecx.4 = phi i32 [ %inc1359, %if.else1358.split ], [ %add1353, %cleanup1355.thread2151 ]
  %tobool1263.not = icmp eq i32 %save3.7, 0
  br i1 %tobool1263.not, label %while.end, label %while.cond.outer.split
...
while.end:                                        ; preds = %if.end1360, %if.end1260
  ...
  store i32 %va, ptr %section, align 4
...
cleanup1376:                                      ; preds = %if.end1212, %if.then1128, %land.lhs.true1160, %land.lhs.true1036, %land.lhs.true1054, %land.lhs.true1058, %land.lhs.true1080, %land.lhs.true999, %if.end956, %land.lhs.true945, %if.end866, %land.lhs.true881, %land.lhs.true898, %land.lhs.true911, %if.end815, %land.lhs.true828, %if.end748, %land.lhs.true762, %if.then814, %if.then865, %if.then803, %land.lhs.true586, %land.lhs.true624, %land.lhs.true528, %land.lhs.true541, %land.lhs.true550, %land.lhs.true494, %lor.lhs.false510, %if.end466, %land.lhs.true439, %lor.lhs.false455, %lor.lhs.false460, %if.end352, %land.lhs.true380, %lor.lhs.false398, %lor.lhs.false406, %if.end312, %land.lhs.true331, %lor.lhs.false345, %if.then275, %lor.lhs.false300, %if.end183, %land.lhs.true200, %lor.lhs.false214, %if.end159, %lor.lhs.false178, %land.lhs.true118, %lor.lhs.false140, %if.end73, %lor.lhs.false102, %if.then36, %lor.lhs.false, %if.end, %land.lhs.true16, %if.then429, %cleanup1355.thread, %while.end, %cleanup, %if.then1374, %if.then1288, %if.then1259
  %retval.6 = phi i32 [ -1, %if.then1288 ], [ 0, %if.then1374 ], [ -1, %if.then1259 ], [ -1, %cleanup ], [ 1, %while.end ], [ -1, %cleanup1355.thread ], [ -1, %if.then429 ], [ -1, %land.lhs.true16 ], [ -1, %if.end ], [ -1, %lor.lhs.false ], [ -1, %if.then36 ], [ -1, %lor.lhs.false102 ], [ -1, %if.end73 ], [ -1, %lor.lhs.false140 ], [ -1, %land.lhs.true118 ], [ -1, %lor.lhs.false178 ], [ -1, %if.end159 ], [ -1, %lor.lhs.false214 ], [ -1, %land.lhs.true200 ], [ -1, %if.end183 ], [ -1, %lor.lhs.false300 ], [ -1, %if.then275 ], [ -1, %lor.lhs.false345 ], [ -1, %land.lhs.true331 ], [ -1, %if.end312 ], [ -1, %lor.lhs.false406 ], [ -1, %lor.lhs.false398 ], [ -1, %land.lhs.true380 ], [ -1, %if.end352 ], [ -1, %lor.lhs.false460 ], [ -1, %lor.lhs.false455 ], [ -1, %land.lhs.true439 ], [ -1, %if.end466 ], [ -1, %lor.lhs.false510 ], [ -1, %land.lhs.true494 ], [ -1, %land.lhs.true550 ], [ -1, %land.lhs.true541 ], [ -1, %land.lhs.true528 ], [ -1, %land.lhs.true624 ], [ -1, %land.lhs.true586 ], [ -1, %if.then803 ], [ -1, %if.then865 ], [ -1, %if.then814 ], [ -1, %land.lhs.true762 ], [ -1, %if.end748 ], [ -1, %land.lhs.true828 ], [ -1, %if.end815 ], [ -1, %land.lhs.true911 ], [ -1, %land.lhs.true898 ], [ -1, %land.lhs.true881 ], [ -1, %if.end866 ], [ -1, %land.lhs.true945 ], [ -1, %if.end956 ], [ -1, %land.lhs.true999 ], [ -1, %land.lhs.true1080 ], [ -1, %land.lhs.true1058 ], [ -1, %land.lhs.true1054 ], [ -1, %land.lhs.true1036 ], [ -1, %land.lhs.true1160 ], [ -1, %if.then1128 ], [ -1, %if.end1212 ]
...
entry:
  ...
  %invariant.gep709 = getelementptr inbounds i8, ptr %init_ebx, i64 376
...
if.then24:                                        ; preds = %if.then
  %2 = load i32, ptr %loc_eax, align 4
  %dec = add i32 %2, -1
  store i32 %dec, ptr %loc_eax, align 4
  store ptr %add.ptr29, ptr %loc_edx, align 8
...
if.end:                                           ; preds = %if.then24
  ...
  store i32 64, ptr %loc_ecx, align 4
  %shl37 = shl nuw nsw i32 %spec.select, 6
  store i32 %shl37, ptr %loc_eax, align 4
...
if.end45:                                         ; preds = %if.end
  %4 = load i32, ptr %loc_eax, align 4
  %and46 = and i32 %4, 252
...
if.then48:                                        ; preds = %if.end45
  ...
  %gep710 = getelementptr inbounds i8, ptr %invariant.gep709, i64 %idx.ext55
  store ptr %gep710, ptr %loc_edx, align 8
  %and58 = and i32 %dec51, 254
  %cmp59 = icmp ugt i32 %and58, 5
...
if.then60:                                        ; preds = %if.then48
  ...
  store i32 %or65, ptr %loc_ecx, align 4
  store i32 0, ptr %loc_eax, align 4
  br i1 %cmp68, label %do.body66.preheader, label %cleanup458

do.body66.preheader:                              ; preds = %if.then60
  %p2.promoted = load i32, ptr %p2, align 4
  %p1.promoted = load i32, ptr %p1, align 8
  %p.promoted = load ptr, ptr %p, align 8
  br label %do.body66

do.body66:                                        ; preds = %do.body66.preheader, %do.cond
  %dec118698 = phi i32 [ %dec118, %do.cond ], [ %or65, %do.body66.preheader ]
  %inc104696 = phi i32 [ %6, %do.cond ], [ 0, %do.body66.preheader ]
  %5 = phi i32 [ %8, %do.cond ], [ %p2.promoted, %do.body66.preheader ]
  %shl115694 = phi i32 [ %shl115695, %do.cond ], [ %p1.promoted, %do.body66.preheader ]
  %incdec.ptr693 = phi ptr [ %incdec.ptr692, %do.cond ], [ %p.promoted, %do.body66.preheader ]
  %cmp71.not = icmp uge ptr %incdec.ptr693, %bs
  %add.ptr74 = getelementptr inbounds i8, ptr %incdec.ptr693, i64 4
...
if.end83:                                         ; preds = %do.body66
  %.val = load i32, ptr %incdec.ptr693, align 1
  %or94 = call i32 @llvm.bswap.i32(i32 %.val)
  %shr96 = lshr i32 %shl115694, 1
  store i32 %shr96, ptr %p1, align 8
  %sub98 = sub i32 %or94, %5
  %shl99 = shl i32 %inc104696, 1
  store i32 %shl99, ptr %loc_eax, align 4
...
if.then102:                                       ; preds = %if.end83
  ...
  store i32 %inc104, ptr %loc_eax, align 4
  %add106 = add i32 %5, %shr96
  store i32 %add106, ptr %p2, align 4
  br label %if.end107

if.end107:                                        ; preds = %if.then102, %if.end83
  %6 = phi i32 [ %inc104, %if.then102 ], [ %shl99, %if.end83 ]
  %7 = phi i32 [ %add106, %if.then102 ], [ %5, %if.end83 ]
  %cmp110 = icmp ult i32 %shl115694, 33554432
  br i1 %cmp110, label %if.then111, label %do.cond

if.then111:                                       ; preds = %if.end107
  %shl113 = shl i32 %7, 8
  store i32 %shl113, ptr %p2, align 4
  %shl115 = shl nuw i32 %shr96, 8
  store i32 %shl115, ptr %p1, align 8
  %incdec.ptr = getelementptr inbounds i8, ptr %incdec.ptr693, i64 1
  store ptr %incdec.ptr, ptr %p, align 8
  br label %do.cond

do.cond:                                          ; preds = %if.then111, %if.end107
  %8 = phi i32 [ %shl113, %if.then111 ], [ %7, %if.end107 ]
  %shl115695 = phi i32 [ %shl115, %if.then111 ], [ %shr96, %if.end107 ]
  %incdec.ptr692 = phi ptr [ %incdec.ptr, %if.then111 ], [ %incdec.ptr693, %if.end107 ]
  %dec118 = add i32 %dec118698, -1
  store i32 %dec118, ptr %loc_ecx, align 4
  %tobool119.not = icmp eq i32 %dec118, 0
  br i1 %tobool119.not, label %do.end, label %do.body66

do.end:                                           ; preds = %do.cond
  %shl122 = shl i32 %6, 4
  %add123 = add i32 %shl122, %shl53
  store ptr %add.ptr124, ptr %loc_edx, align 8
  br label %if.end125

if.end125:                                        ; preds = %do.end, %if.then48
  %9 = phi ptr [ %add.ptr124, %do.end ], [ %gep710, %if.then48 ]
  ...
  store i32 %shl127, ptr %loc_ecx, align 4
  store i32 %10, ptr %loc_eax, align 4
...
if.end131:                                        ; preds = %if.end125
  %11 = load i32, ptr %loc_eax, align 4
...
do.body133.prol:                                  ; preds = %if.end131, %do.body133.prol
  %dec139702.prol = phi i32 [ %dec139.prol, %do.body133.prol ], [ %10, %if.end131 ]
  %shr137700.prol = phi i32 [ %shr137.prol, %do.body133.prol ], [ %11, %if.end131 ]
  ...
  %and135.prol = and i32 %shr137700.prol, 1
  %add136.prol = or i32 %and135.prol, %add134.prol
  %shr137.prol = lshr i32 %shr137700.prol, 1
  %dec139.prol = add i32 %dec139702.prol, -1
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %do.body133.prol.loopexit, label %do.body133.prol
...
do.body133.prol.loopexit:                         ; preds = %do.body133.prol, %if.end131
  ...
  %dec139702.unr = phi i32 [ %10, %if.end131 ], [ %dec139.prol, %do.body133.prol ]
  %shr137700.unr = phi i32 [ %11, %if.end131 ], [ %shr137.prol, %do.body133.prol ]
...
do.body133:                                       ; preds = %do.body133.prol.loopexit, %do.body133
  %dec139702 = phi i32 [ %dec139.3, %do.body133 ], [ %dec139702.unr, %do.body133.prol.loopexit ]
  %shr137700 = phi i32 [ %shr137.3, %do.body133 ], [ %shr137700.unr, %do.body133.prol.loopexit ]
  %temp_ebp.0 = phi i32 [ %add136.3, %do.body133 ], [ %temp_ebp.0.unr, %do.body133.prol.loopexit ]
  %14 = shl i32 %temp_ebp.0, 3
  %and135 = shl i32 %shr137700, 2
  %15 = and i32 %and135, 4
  %add134.1 = or i32 %14, %15
  %and135.1 = and i32 %shr137700, 2
  %add136.1 = or i32 %and135.1, %add134.1
  %shr137.1 = lshr i32 %shr137700, 2
  %and135.2 = and i32 %shr137.1, 1
  %add136.2 = or i32 %and135.2, %add136.1
  %shr137.2 = lshr i32 %shr137700, 3
  %add134.3 = shl i32 %add136.2, 1
  %and135.3 = and i32 %shr137.2, 1
  %add136.3 = or i32 %and135.3, %add134.3
  %shr137.3 = lshr i32 %shr137700, 4
  %dec139.3 = add i32 %dec139702, -4
  %tobool140.not.3 = icmp eq i32 %dec139.3, 0
  br i1 %tobool140.not.3, label %do.end141, label %do.body133
...
do.end141:                                        ; preds = %do.body133, %do.body133.prol.loopexit
  ...
  store i32 %shr137.lcssa, ptr %loc_eax, align 4
...
if.else:                                          ; preds = %if.then
  %16 = load i32, ptr %loc_ecx, align 4
  %17 = load ptr, ptr %loc_edx, align 8
  %idx.ext145 = zext i32 %16 to i64
  %add.ptr146 = getelementptr inbounds i8, ptr %17, i64 %idx.ext145
  store ptr %add.ptr146, ptr %loc_edx, align 8
...
if.then149:                                       ; preds = %if.else
  %18 = load ptr, ptr %loc_edx, align 8
  %add.ptr150 = getelementptr inbounds i8, ptr %18, i64 96
  store ptr %add.ptr150, ptr %loc_edx, align 8
...
if.then153:                                       ; preds = %if.then149
  %19 = load i32, ptr %loc_ecx, align 4
  %20 = load ptr, ptr %loc_edx, align 8
  %idx.ext154 = zext i32 %19 to i64
  %add.ptr155 = getelementptr inbounds i8, ptr %20, i64 %idx.ext154
  store ptr %add.ptr155, ptr %loc_edx, align 8
  ...
  %spec.select725 = select i1 %tobool161.not, i32 %state.sroa.20.0, i32 %state.sroa.15.0
  %spec.select726 = select i1 %tobool161.not, i32 %state.sroa.15.0, i32 %state.sroa.20.0
  br label %if.end215

if.else170:                                       ; preds = %if.else
  %21 = load i32, ptr %loc_ecx, align 4
  %22 = load ptr, ptr %loc_edx, align 8
  %idx.ext171 = zext i32 %21 to i64
  %add.ptr172 = getelementptr inbounds i8, ptr %22, i64 %idx.ext171
  store ptr %add.ptr172, ptr %loc_edx, align 8
...
if.else176:                                       ; preds = %if.else170
  %23 = load i32, ptr %loc_eax, align 4
  %or177 = or i32 %23, 1
  store i32 %or177, ptr %loc_eax, align 4
  ...
  %24 = load i32, ptr %loc_ecx, align 4
  %and181 = and i32 %24, -256
  %or182 = or i32 %and181, 128
  store i32 %or182, ptr %loc_ecx, align 4
...
land.lhs.true188:                                 ; preds = %if.else176
  ...
  %or.cond667.not685 = or i1 %cmp192.not, %cmp195
  %cmp200.not = icmp ult ptr %loc_edi.0, %bs
  %or.cond668 = or i1 %cmp200.not, %or.cond667.not685
  br i1 %or.cond668, label %cleanup458, label %land.lhs.true201

land.lhs.true201:                                 ; preds = %land.lhs.true188
  %add.ptr202 = getelementptr inbounds i8, ptr %loc_edi.0, i64 1
  %cmp205.not.not = icmp ugt ptr %add.ptr202, %add.ptr191
  br i1 %cmp205.not.not, label %cleanup458, label %if.end210

if.end210:                                        ; preds = %land.lhs.true201
  %25 = load i8, ptr %add.ptr180, align 1
  store i8 %25, ptr %loc_edi.0, align 1
  br label %do.cond454
...
if.end215:                                        ; preds = %if.then153, %if.then149, %if.else170
  ...
  %state.sroa.20.1 = phi i32 [ %state.sroa.20.0, %if.else170 ], [ %state.sroa.20.0, %if.then149 ], [ %spec.select725, %if.then153 ]
  %loc_ebp.2 = phi i32 [ %state.sroa.4.0, %if.else170 ], [ %state.sroa.8.0, %if.then149 ], [ %spec.select726, %if.then153 ]
  %26 = load i32, ptr %loc_eax, align 4
  store ptr %add.ptr216, ptr %loc_edx, align 8
...
if.end221:                                        ; preds = %if.end215
  %27 = load i32, ptr %loc_ecx, align 4
  store i32 %27, ptr %loc_eax, align 4
...
if.end222:                                        ; preds = %if.end221, %if.end143
  ...
  store i32 %29, ptr %loc_ecx, align 4
  %cmp226 = icmp eq i32 %29, 0
  %or.cond480.not686 = select i1 %cmp185.not, i1 true, i1 %cmp226
  %cmp229.not = icmp ugt i32 %29, %bl
  %or.cond670 = select i1 %or.cond480.not686, i1 true, i1 %cmp229.not
...
land.lhs.true234:                                 ; preds = %if.end222
  ...
  %or.cond687 = select i1 %cmp239.not, i1 %or.cond673.not, i1 false
  br i1 %or.cond687, label %land.lhs.true257, label %cleanup458
...
for.body289:                                      ; preds = %land.lhs.true263, %for.body289
  %loc_edi.1705 = phi ptr [ %incdec.ptr295, %for.body289 ], [ %loc_edi.0, %land.lhs.true263 ]
  %i.1704 = phi i32 [ %inc294, %for.body289 ], [ 0, %land.lhs.true263 ]
  %add.ptr292 = getelementptr inbounds i8, ptr %loc_edi.1705, i64 %idx.neg259
  %30 = load i8, ptr %add.ptr292, align 1
  store i8 %30, ptr %loc_edi.1705, align 1
  %inc294 = add nuw i32 %i.1704, 1
  %incdec.ptr295 = getelementptr inbounds i8, ptr %loc_edi.1705, i64 1
  %31 = load i32, ptr %loc_ecx, align 4
  %cmp287 = icmp ult i32 %inc294, %31
  br i1 %cmp287, label %for.body289, label %for.end296

for.end296:                                       ; preds = %for.body289
  %.pre = load i32, ptr %loc_eax, align 4
  %and297 = and i32 %.pre, -256
  %add.ptr300 = getelementptr inbounds i8, ptr %incdec.ptr295, i64 %idx.neg259
  %32 = load i8, ptr %add.ptr300, align 1
  %conv301 = zext i8 %32 to i32
  %or302 = or i32 %and297, %conv301
  store i32 %or302, ptr %loc_eax, align 4
  br label %if.end430

do.body304:                                       ; preds = %do.body, %do.body304
  %or314707 = phi i32 [ %or314, %do.body304 ], [ %loc_eax.promoted706, %do.body ]
  %and305 = and i32 %or314707, 255
  %cmp307 = icmp ugt i32 %and305, 2
  %sub310 = add nsw i32 %and305, -3
  %loc_al.0 = select i1 %cmp307, i32 %sub310, i32 0
  %and313 = and i32 %or314707, -256
  %or314 = or i32 %loc_al.0, %and313
  %cmp316 = icmp ugt i32 %loc_al.0, 6
  br i1 %cmp316, label %do.body304, label %do.end318

do.end318:                                        ; preds = %do.body304
  store i32 %or314, ptr %loc_eax, align 4
...
if.then326:                                       ; preds = %do.end318
  ...
  %33 = load i8, ptr %add.ptr327, align 1
...
if.end331:                                        ; preds = %do.end318, %if.then326
  ...
  store i32 %or337, ptr %loc_eax, align 4
  %34 = load i32, ptr %loc_ecx, align 4
...
if.then399:                                       ; preds = %if.then388
  ...
  store i32 %or404, ptr %loc_eax, align 4
...
if.else421:                                       ; preds = %if.end331
  store i32 256, ptr %loc_ecx, align 4
...
if.end430:                                        ; preds = %do.body366, %if.then399, %if.else421, %for.end296
  ...
  store i32 %storemerge, ptr %loc_ecx, align 4
  %cmp437.not = icmp ult ptr %loc_edi.2, %bs
  %or.cond678 = or i1 %cmp185.not, %cmp437.not
  br i1 %or.cond678, label %cleanup458, label %land.lhs.true439

land.lhs.true439:                                 ; preds = %if.end430
  %add.ptr440 = getelementptr inbounds i8, ptr %loc_edi.2, i64 1
  %cmp443.not.not = icmp ugt ptr %add.ptr440, %add.ptr191
  br i1 %cmp443.not.not, label %cleanup458, label %if.end450

if.end450:                                        ; preds = %land.lhs.true439
  %38 = load i32, ptr %loc_eax, align 4
  %conv452 = trunc i32 %38 to i8
  store i8 %conv452, ptr %loc_edi.2, align 1
  br label %do.cond454
...
do.cond454:                                       ; preds = %if.end450, %if.end210
  ...
  %loc_edi.3 = phi ptr [ %add.ptr440, %if.end450 ], [ %add.ptr202, %if.end210 ]
  %cmp455 = icmp ult ptr %loc_edi.3, %end_edi
  br i1 %cmp455, label %do.body, label %cleanup458

cleanup458:                                       ; preds = %if.then399, %if.then339, %land.lhs.true354, %do.cond454, %if.end430, %land.lhs.true439, %if.else421, %if.end222, %land.lhs.true234, %land.lhs.true257, %land.lhs.true263, %if.end215, %if.else176, %land.lhs.true188, %land.lhs.true201, %if.end125, %if.end, %if.then24, %if.then60, %do.body66
  %retval.13 = phi i32 [ -1, %do.body66 ], [ -1, %if.then60 ], [ -1, %if.then399 ], [ -1, %if.then339 ], [ -1, %land.lhs.true354 ], [ 1, %do.cond454 ], [ -1, %if.end430 ], [ -1, %land.lhs.true439 ], [ -1, %if.else421 ], [ -1, %if.end222 ], [ -1, %land.lhs.true234 ], [ -1, %land.lhs.true257 ], [ -1, %land.lhs.true263 ], [ -1, %if.end215 ], [ -1, %if.else176 ], [ -1, %land.lhs.true188 ], [ -1, %land.lhs.true201 ], [ -1, %if.end125 ], [ -1, %if.end ], [ -1, %if.then24 ]
