; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/zlib_adler32.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/zlib_adler32.c"
...
while.body.prol:                                  ; preds = %while.body.preheader, %while.body.prol
  ...
  %3 = load i8, ptr %buf.addr.0386.prol, align 1
  ...
  br i1 %prol.iter420.cmp.not, label %while.body.prol.loopexit, label %while.body.prol
...
while.body:                                       ; preds = %while.body.prol.loopexit, %while.body
  ...
  %5 = load i8, ptr %buf.addr.0386, align 1
  ...
  %8 = load i8, ptr %incdec.ptr.2, align 1
...
do.body:                                          ; preds = %do.body, %while.body33
  ...
  %9 = load i8, ptr %buf.addr.2, align 1
  ...
  %22 = load i8, ptr %arrayidx87, align 1
  ...
  br i1 %tobool100.not, label %do.end, label %do.body
...
while.body180.prol:                               ; preds = %while.body180.preheader, %while.body180.prol
  ...
  %25 = load i8, ptr %buf.addr.4379.prol, align 1
  %conv182.prol = zext i8 %25 to i64
  %add183.prol = add i64 %adler.addr.6378.prol, %conv182.prol
  %add184.prol = add i64 %add183.prol, %sum2.5381.prol
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %while.body180.prol.loopexit, label %while.body180.prol
...
while.body180.prol.loopexit:                      ; preds = %while.body180.prol, %while.body180.preheader
  ...
  %26 = icmp ult i64 %len.addr.3380.ph, 4
  br i1 %26, label %while.end185, label %while.body180
...
while.body109:                                    ; preds = %while.body109.preheader, %while.body109
  ...
  %27 = load i8, ptr %buf.addr.3370, align 1
  %conv112 = zext i8 %27 to i64
  ...
  %28 = load i8, ptr %arrayidx115, align 1
  %conv116 = zext i8 %28 to i64
  %add117 = add i64 %add113, %conv116
  %add118 = add i64 %add114, %add117
  %arrayidx119 = getelementptr inbounds i8, ptr %buf.addr.3370, i64 2
  %29 = load i8, ptr %arrayidx119, align 1
  %conv120 = zext i8 %29 to i64
...
while.body180:                                    ; preds = %while.body180.prol.loopexit, %while.body180
  ...
  %43 = load i8, ptr %buf.addr.4379, align 1
  %conv182 = zext i8 %43 to i64
  ...
  %44 = load i8, ptr %incdec.ptr181, align 1
  %conv182.1 = zext i8 %44 to i64
  ...
  %45 = load i8, ptr %incdec.ptr181.1, align 1
  %conv182.2 = zext i8 %45 to i64
  ...
  %46 = load i8, ptr %incdec.ptr181.2, align 1
  %conv182.3 = zext i8 %46 to i64
  %add183.3 = add i64 %add183.2, %conv182.3
  %add184.3 = add i64 %add183.3, %add184.2
  %tobool179.not.3 = icmp eq i64 %dec178.3, 0
  br i1 %tobool179.not.3, label %while.end185, label %while.body180
