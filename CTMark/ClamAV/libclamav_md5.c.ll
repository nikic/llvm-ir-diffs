; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_md5.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_md5.c"
...
entry:
  ...
  store <4 x i32> <i32 0, i32 0, i32 1732584193, i32 -271733879>, ptr %ctx, align 4
  ret void
}
...
entry:
  ...
  store i32 %conv1, ptr %ctx, align 4
  ...
  %conv7 = add i32 %4, %5
  store i32 %conv7, ptr %hi4, align 4
  %and8 = and i32 %0, 63
...
do.body:                                          ; preds = %do.body, %entry
  ...
  %12 = load i32, ptr %arrayidx97, align 4
  ...
  %13 = load i32, ptr %arrayidx109, align 4
  ...
  %15 = load i32, ptr %arrayidx133, align 4
  ...
  %16 = load i32, ptr %arrayidx145, align 4
  ...
  %19 = load i32, ptr %arrayidx181, align 4
...
do.end:                                           ; preds = %do.body
  store i32 %add749, ptr %a1, align 4
  store i32 %add750, ptr %b2, align 4
  store i32 %add751, ptr %c3, align 4
  store i32 %add752, ptr %d4, align 4
  ret ptr %add.ptr
}
...
if.end:                                           ; preds = %if.then, %entry
  ...
  store i8 %conv27, ptr %arrayidx29, align 4
  %shr31 = lshr i32 %2, 8
  ...
  store i8 %conv37, ptr %arrayidx39, align 2
  %shr41 = lshr i32 %2, 24
