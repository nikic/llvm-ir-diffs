; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_ole2_extract.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_ole2_extract.c"
...
entry:
  ...
  store ptr null, ptr %m_area, align 8
...
if.end:                                           ; preds = %if.then
  ...
  store ptr %call6, ptr %m_area, align 8
...
if.end16:                                         ; preds = %entry
  %.pr = load ptr, ptr %m_area, align 8
...
if.end56:                                         ; preds = %if.end42
  %2 = load i16, ptr %log2_big_block_size, align 2
...
if.end62:                                         ; preds = %if.end56
  %3 = load i32, ptr %log2_small_block_size, align 8
...
if.end67:                                         ; preds = %if.end62
  %4 = load i32, ptr %sbat_cutoff, align 8
...
if.end72:                                         ; preds = %if.end67
  ...
  %9 = load i8, ptr %arrayidx.2.i, align 2
  ...
  %11 = load i8, ptr %arrayidx.4.i, align 4
  ...
  %12 = load i8, ptr %arrayidx.5.i, align 1
  ...
  %13 = load i8, ptr %arrayidx.6.i, align 2
  ...
  %15 = load i8, ptr %arrayidx6.i, align 8
  ...
  %16 = load i8, ptr %arrayidx6.1.i, align 1
  ...
  %17 = load i8, ptr %arrayidx6.2.i, align 2
  ...
  %18 = load i8, ptr %arrayidx6.3.i, align 1
  ...
  %19 = load i8, ptr %arrayidx6.4.i, align 4
  ...
  %20 = load i8, ptr %arrayidx6.5.i, align 1
  ...
  %21 = load i8, ptr %arrayidx6.6.i, align 2
  ...
  %22 = load i8, ptr %arrayidx6.7.i, align 1
  ...
  %23 = load i8, ptr %arrayidx6.8.i, align 8
  ...
  %24 = load i8, ptr %arrayidx6.9.i, align 1
  ...
  %25 = load i8, ptr %arrayidx6.10.i, align 2
  ...
  %26 = load i8, ptr %arrayidx6.11.i, align 1
  ...
  %27 = load i8, ptr %arrayidx6.12.i, align 4
  ...
  %28 = load i8, ptr %arrayidx6.13.i, align 1
  ...
  %29 = load i8, ptr %arrayidx6.14.i, align 2
  ...
  %30 = load i8, ptr %arrayidx6.15.i, align 1
  ...
  %31 = load i16, ptr %minor_version.i, align 8
  ...
  %32 = load i16, ptr %dll_version.i, align 2
  ...
  %36 = load i32, ptr %bat_count.i, align 4
  ...
  %37 = load i32, ptr %prop_start.i, align 8
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.19, i32 noundef %37) #12
  %38 = load i32, ptr %sbat_cutoff, align 8
  ...
  %39 = load i32, ptr %sbat_start.i, align 4
  ...
  %40 = load i32, ptr %sbat_block_count.i, align 8
  ...
  %41 = load i32, ptr %xbat_start.i, align 4
  ...
  %42 = load i32, ptr %xbat_count.i, align 8
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.24, i32 noundef %42) #12
  %43 = load i32, ptr %max_block_no, align 8
...
abort:                                            ; preds = %if.end72, %if.then71, %if.then66, %if.then61
  %44 = load ptr, ptr %m_area, align 8
...
cleanup.sink.split.sink.split:                    ; preds = %abort, %if.then46
  ...
  %45 = load i64, ptr %m_length83, align 8
...
cleanup.sink.split:                               ; preds = %cleanup.sink.split.sink.split, %abort, %if.then46
  ...
  %46 = load ptr, ptr %bitset, align 8
...
entry:
  ...
  %0 = load i32, ptr %prop_start, align 8
  %cmp = icmp slt i32 %prop_index, 0
  br i1 %cmp, label %cleanup, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %entry
  %max_block_no = getelementptr inbounds %struct.ole2_header_tag, ptr %hdr, i64 0, i32 21
  %1 = load i32, ptr %max_block_no, align 8
...
lor.lhs.false4:                                   ; preds = %lor.lhs.false
  %2 = load i32, ptr %file_count, align 4
...
land.lhs.true:                                    ; preds = %if.end
  ...
  %3 = load i32, ptr %maxfiles, align 4
...
for.cond:                                         ; preds = %for.body
  ...
  br i1 %exitcond.not, label %if.end.i, label %for.body
...
if.end.i:                                         ; preds = %for.cond, %for.end
  ...
  %5 = load i16, ptr %log2_big_block_size.i, align 2
  ...
  %6 = load ptr, ptr %m_area.i, align 8
...
if.end8.i:                                        ; preds = %if.then4.i
  %7 = load i16, ptr %log2_big_block_size.i, align 2
  ...
  %8 = load i16, ptr %log2_big_block_size.i, align 2
...
if.end33:                                         ; preds = %if.end29
  ...
  %bitset = getelementptr inbounds %struct.ole2_header_tag, ptr %hdr, i64 0, i32 20
  %11 = load ptr, ptr %bitset, align 8
...
if.end95:                                         ; preds = %if.end33
  %12 = load ptr, ptr %bitset, align 8
...
if.end115:                                        ; preds = %lor.lhs.false111
  %16 = load i32, ptr %start_block, align 4
  %sbat_root_start = getelementptr inbounds %struct.ole2_header_tag, ptr %hdr, i64 0, i32 17
  store i32 %16, ptr %sbat_root_start, align 8
...
sw.bb130:                                         ; preds = %if.end101
  ...
  %inc131 = add i32 %20, 1
  store i32 %inc131, ptr %file_count, align 4
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end149
  ...
  %7 = load i32, ptr %max_block_no, align 8
...
if.end66:                                         ; preds = %if.end60
  ...
  %9 = load i32, ptr %sbat_cutoff, align 8
  %cmp70 = icmp ult i32 %8, %9
  br i1 %cmp70, label %if.then72, label %if.end.i

if.then72:                                        ; preds = %if.end66
  %10 = load i32, ptr %sbat_root_start.i, align 8
...
if.end.i.i:                                       ; preds = %while.end.i, %if.end3.i
  ...
  %11 = load i16, ptr %log2_big_block_size, align 2
  ...
  %12 = load ptr, ptr %m_area.i, align 8
...
if.end8.i.i:                                      ; preds = %if.then4.i.i
  %13 = load i16, ptr %log2_big_block_size, align 2
  ...
  %14 = load i16, ptr %log2_big_block_size, align 2
...
lor.lhs.false.i.i:                                ; preds = %if.else.i.i
  %15 = load i64, ptr %m_length.i, align 8
...
if.end91:                                         ; preds = %if.end77
  ...
  %16 = load i32, ptr %sbat_start.i, align 4
  %cmp117.not.i = icmp ult i32 %current_block.0306, 128
  br i1 %cmp117.not.i, label %while.end.i258, label %while.body.preheader.i253

while.body.preheader.i253:                        ; preds = %if.end91
  %div14.i = lshr i32 %current_block.0306, 7
  br label %while.body.i254

while.body.i254:                                  ; preds = %while.body.i254, %while.body.preheader.i253
  %current_bat_block.019.i = phi i32 [ %call.i255, %while.body.i254 ], [ %16, %while.body.preheader.i253 ]
  %iter.018.i = phi i32 [ %dec.i256, %while.body.i254 ], [ %div14.i, %while.body.preheader.i253 ]
  %call.i255 = call fastcc i32 @ole2_get_next_block_number(i32 noundef %fd, ptr noundef %hdr, i32 noundef %current_bat_block.019.i)
  %dec.i256 = add nsw i32 %iter.018.i, -1
  %cmp1.i257 = icmp ugt i32 %iter.018.i, 1
  br i1 %cmp1.i257, label %while.body.i254, label %while.end.i258

while.end.i258:                                   ; preds = %while.body.i254, %if.end91
  %current_bat_block.0.lcssa.i = phi i32 [ %16, %if.end91 ], [ %call.i255, %while.body.i254 ]
  %cmp.i.i259 = icmp slt i32 %current_bat_block.0.lcssa.i, 0
  br i1 %cmp.i.i259, label %ole2_get_next_sbat_block.exit, label %if.end.i.i260

if.end.i.i260:                                    ; preds = %while.end.i258
  %17 = load i16, ptr %log2_big_block_size, align 2
  %conv.i.i262 = zext i16 %17 to i32
  %shl.i.i263 = shl i32 %current_bat_block.0.lcssa.i, %conv.i.i262
  %add.i.i264 = add nsw i32 %shl.i.i263, 512
  %conv1.i.i265 = sext i32 %add.i.i264 to i64
  %18 = load ptr, ptr %m_area.i, align 8
  %cmp2.i.i267 = icmp eq ptr %18, null
  br i1 %cmp2.i.i267, label %if.then4.i.i279, label %if.else.i.i268

if.then4.i.i279:                                  ; preds = %if.end.i.i260
  %call.i.i280 = call i64 @lseek(i32 noundef %fd, i64 noundef %conv1.i.i265, i32 noundef 0) #12
  %cmp5.not.i.i281 = icmp eq i64 %call.i.i280, %conv1.i.i265
  br i1 %cmp5.not.i.i281, label %if.end8.i.i282, label %ole2_get_next_sbat_block.exit

if.end8.i.i282:                                   ; preds = %if.then4.i.i279
  %19 = load i16, ptr %log2_big_block_size, align 2
  %conv10.i.i283 = zext i16 %19 to i32
  %shl11.i.i284 = shl nuw i32 1, %conv10.i.i283
  %call12.i.i285 = call i32 @cli_readn(i32 noundef %fd, ptr noundef nonnull %sbat.i, i32 noundef %shl11.i.i284) #12
  %20 = load i16, ptr %log2_big_block_size, align 2
  %conv14.i.i286 = zext i16 %20 to i32
  %shl15.i.i287 = shl nuw i32 1, %conv14.i.i286
  %cmp16.not.i.i288 = icmp eq i32 %call12.i.i285, %shl15.i.i287
  br i1 %cmp16.not.i.i288, label %if.end4.i, label %ole2_get_next_sbat_block.exit

if.else.i.i268:                                   ; preds = %if.end.i.i260
  %shl22.i.i269 = shl nuw i32 1, %conv.i.i262
  %conv23.i.i270 = sext i32 %shl22.i.i269 to i64
  %add24.i.i271 = add nsw i64 %conv1.i.i265, %conv23.i.i270
  %cmp25.i.i272 = icmp slt i64 %add24.i.i271, 1
  br i1 %cmp25.i.i272, label %ole2_get_next_sbat_block.exit, label %lor.lhs.false.i.i273

lor.lhs.false.i.i273:                             ; preds = %if.else.i.i268
  %21 = load i64, ptr %m_length.i, align 8
  %cmp27.i.i275 = icmp sgt i64 %add24.i.i271, %21
  br i1 %cmp27.i.i275, label %ole2_get_next_sbat_block.exit, label %if.end30.i.i276

if.end30.i.i276:                                  ; preds = %lor.lhs.false.i.i273
  %add.ptr.i.i277 = getelementptr inbounds i8, ptr %18, i64 %conv1.i.i265
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(1) %sbat.i, ptr noundef nonnull align 1 dereferenceable(1) %add.ptr.i.i277, i64 %conv23.i.i270, i1 false)
  br label %if.end4.i

if.end4.i:                                        ; preds = %if.end30.i.i276, %if.end8.i.i282
...
ole2_get_next_sbat_block.exit:                    ; preds = %while.end.i258, %if.then4.i.i279, %if.end8.i.i282, %if.else.i.i268, %lor.lhs.false.i.i273, %if.end4.i
  %retval.0.i278 = phi i32 [ %22, %if.end4.i ], [ -1, %while.end.i258 ], [ -1, %if.then4.i.i279 ], [ -1, %if.end8.i.i282 ], [ -1, %lor.lhs.false.i.i273 ], [ -1, %if.else.i.i268 ]
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %sbat.i) #12
  br label %if.end149

if.end.i:                                         ; preds = %if.end66
  %23 = load i16, ptr %log2_big_block_size, align 2
  %conv.i = zext i16 %23 to i32
  %shl.i = shl i32 %current_block.0306, %conv.i
  %add.i = add nsw i32 %shl.i, 512
  %conv1.i = sext i32 %add.i to i64
  %24 = load ptr, ptr %m_area.i, align 8
  %cmp2.i = icmp eq ptr %24, null
  br i1 %cmp2.i, label %if.then4.i, label %if.else.i

if.then4.i:                                       ; preds = %if.end.i
  %call.i290 = call i64 @lseek(i32 noundef %fd, i64 noundef %conv1.i, i32 noundef 0) #12
  %cmp5.not.i = icmp eq i64 %call.i290, %conv1.i
  br i1 %cmp5.not.i, label %if.end8.i, label %if.then102

if.end8.i:                                        ; preds = %if.then4.i
  %25 = load i16, ptr %log2_big_block_size, align 2
  %conv10.i = zext i16 %25 to i32
  %shl11.i = shl nuw i32 1, %conv10.i
  %call12.i = call i32 @cli_readn(i32 noundef %fd, ptr noundef nonnull %call36, i32 noundef %shl11.i) #12
  %26 = load i16, ptr %log2_big_block_size, align 2
...
lor.lhs.false.i:                                  ; preds = %if.else.i
  %27 = load i64, ptr %m_length.i, align 8
...
if.end30.i:                                       ; preds = %lor.lhs.false.i
  ...
  %.pre = load i16, ptr %log2_big_block_size, align 2
...
if.end104:                                        ; preds = %if.end30.i, %if.end8.i
  ...
  %28 = load i16, ptr %log2_big_block_size, align 2
...
if.end134:                                        ; preds = %if.end104
  ...
  %29 = load i16, ptr %log2_big_block_size, align 2
...
if.end149:                                        ; preds = %if.end134, %ole2_get_next_sbat_block.exit
  ...
  %current_block.1 = phi i32 [ %retval.0.i278, %ole2_get_next_sbat_block.exit ], [ %call135, %if.end134 ]
...
if.then2:                                         ; preds = %if.end
  ...
  %xbat_start.i = getelementptr inbounds %struct.ole2_header_tag, ptr %hdr, i64 0, i32 14
  %0 = load i32, ptr %xbat_start.i, align 4
...
if.end.i.i:                                       ; preds = %if.then2
  ...
  %1 = load i16, ptr %log2_big_block_size.i.i, align 2
  ...
  %2 = load ptr, ptr %m_area.i.i, align 8
...
if.end8.i.i:                                      ; preds = %if.then4.i.i
  %3 = load i16, ptr %log2_big_block_size.i.i, align 2
  ...
  %4 = load i16, ptr %log2_big_block_size.i.i, align 2
...
lor.lhs.false.i.i:                                ; preds = %if.else.i.i
  ...
  %5 = load i64, ptr %m_length.i.i, align 8
...
while.body.lr.ph.i:                               ; preds = %ole2_read_block.exit.i
  ...
  %m_length.i48.i = getelementptr inbounds %struct.ole2_header_tag, ptr %hdr, i64 0, i32 19
  br label %while.body.i
...
while.body.i:                                     ; preds = %if.end10.i, %while.body.lr.ph.i
  ...
  br i1 %cmp.i33.i, label %ole2_get_next_xbat_block.exit, label %if.end.i34.i

if.end.i34.i:                                     ; preds = %while.body.i
  %conv.i36.i = zext i16 %7 to i32
  %shl.i37.i = shl i32 %8, %conv.i36.i
  %add.i38.i = add nsw i32 %shl.i37.i, 512
  %conv1.i39.i = sext i32 %add.i38.i to i64
  %9 = load ptr, ptr %m_area.i.i, align 8
  %cmp2.i41.i = icmp eq ptr %9, null
  br i1 %cmp2.i41.i, label %if.then4.i54.i, label %if.else.i42.i

if.then4.i54.i:                                   ; preds = %if.end.i34.i
  %call.i55.i = call i64 @lseek(i32 noundef %fd, i64 noundef %conv1.i39.i, i32 noundef 0) #12
  %cmp5.not.i56.i = icmp eq i64 %call.i55.i, %conv1.i39.i
  br i1 %cmp5.not.i56.i, label %if.end8.i57.i, label %ole2_get_next_xbat_block.exit

if.end8.i57.i:                                    ; preds = %if.then4.i54.i
  %10 = load i16, ptr %log2_big_block_size.i.i, align 2
  %conv10.i58.i = zext i16 %10 to i32
  %shl11.i59.i = shl nuw i32 1, %conv10.i58.i
  %call12.i60.i = call i32 @cli_readn(i32 noundef %fd, ptr noundef nonnull %xbat.i, i32 noundef %shl11.i59.i) #12
  %11 = load i16, ptr %log2_big_block_size.i.i, align 2
  %conv14.i61.i = zext i16 %11 to i32
  %shl15.i62.i = shl nuw i32 1, %conv14.i61.i
  %cmp16.not.i63.i = icmp eq i32 %call12.i60.i, %shl15.i62.i
  br i1 %cmp16.not.i63.i, label %if.end10.i, label %ole2_get_next_xbat_block.exit

if.else.i42.i:                                    ; preds = %if.end.i34.i
  %shl22.i43.i = shl nuw i32 1, %conv.i36.i
  %conv23.i44.i = sext i32 %shl22.i43.i to i64
  %add24.i45.i = add nsw i64 %conv1.i39.i, %conv23.i44.i
  %cmp25.i46.i = icmp slt i64 %add24.i45.i, 1
  br i1 %cmp25.i46.i, label %ole2_get_next_xbat_block.exit, label %lor.lhs.false.i47.i

lor.lhs.false.i47.i:                              ; preds = %if.else.i42.i
  %12 = load i64, ptr %m_length.i48.i, align 8
  %cmp27.i49.i = icmp sgt i64 %add24.i45.i, %12
  br i1 %cmp27.i49.i, label %ole2_get_next_xbat_block.exit, label %if.end30.i50.i

if.end30.i50.i:                                   ; preds = %lor.lhs.false.i47.i
  %add.ptr.i51.i = getelementptr inbounds i8, ptr %9, i64 %conv1.i39.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(1) %xbat.i, ptr noundef nonnull align 1 dereferenceable(1) %add.ptr.i51.i, i64 %conv23.i44.i, i1 false)
  br label %if.end10.i

if.end10.i:                                       ; preds = %if.end30.i50.i, %if.end8.i57.i
  %13 = phi i16 [ %7, %if.end30.i50.i ], [ %11, %if.end8.i57.i ]
...
while.end.i:                                      ; preds = %if.end10.i, %ole2_read_block.exit.i
  ...
  br i1 %cmp.i65.i, label %ole2_get_next_xbat_block.exit, label %if.end.i66.i

if.end.i66.i:                                     ; preds = %while.end.i
  %conv.i68.i = zext i16 %14 to i32
  %shl.i69.i = shl i32 %15, %conv.i68.i
  %add.i70.i = add nsw i32 %shl.i69.i, 512
  %conv1.i71.i = sext i32 %add.i70.i to i64
  %16 = load ptr, ptr %m_area.i.i, align 8
  %cmp2.i73.i = icmp eq ptr %16, null
  br i1 %cmp2.i73.i, label %if.then4.i86.i, label %if.else.i74.i

if.then4.i86.i:                                   ; preds = %if.end.i66.i
  %call.i87.i = call i64 @lseek(i32 noundef %fd, i64 noundef %conv1.i71.i, i32 noundef 0) #12
  %cmp5.not.i88.i = icmp eq i64 %call.i87.i, %conv1.i71.i
  br i1 %cmp5.not.i88.i, label %if.end8.i89.i, label %ole2_get_next_xbat_block.exit

if.end8.i89.i:                                    ; preds = %if.then4.i86.i
  %17 = load i16, ptr %log2_big_block_size.i.i, align 2
  %conv10.i90.i = zext i16 %17 to i32
  %shl11.i91.i = shl nuw i32 1, %conv10.i90.i
  %call12.i92.i = call i32 @cli_readn(i32 noundef %fd, ptr noundef nonnull %bat.i, i32 noundef %shl11.i91.i) #12
  %18 = load i16, ptr %log2_big_block_size.i.i, align 2
  %conv14.i93.i = zext i16 %18 to i32
  %shl15.i94.i = shl nuw i32 1, %conv14.i93.i
  %cmp16.not.i95.i = icmp eq i32 %call12.i92.i, %shl15.i94.i
  br i1 %cmp16.not.i95.i, label %if.end15.i, label %ole2_get_next_xbat_block.exit

if.else.i74.i:                                    ; preds = %if.end.i66.i
  %shl22.i75.i = shl nuw i32 1, %conv.i68.i
  %conv23.i76.i = sext i32 %shl22.i75.i to i64
  %add24.i77.i = add nsw i64 %conv1.i71.i, %conv23.i76.i
  %cmp25.i78.i = icmp slt i64 %add24.i77.i, 1
  br i1 %cmp25.i78.i, label %ole2_get_next_xbat_block.exit, label %lor.lhs.false.i79.i

lor.lhs.false.i79.i:                              ; preds = %if.else.i74.i
  %m_length.i80.i = getelementptr inbounds %struct.ole2_header_tag, ptr %hdr, i64 0, i32 19
  %19 = load i64, ptr %m_length.i80.i, align 8
  %cmp27.i81.i = icmp sgt i64 %add24.i77.i, %19
  br i1 %cmp27.i81.i, label %ole2_get_next_xbat_block.exit, label %if.end30.i82.i

if.end30.i82.i:                                   ; preds = %lor.lhs.false.i79.i
  %add.ptr.i83.i = getelementptr inbounds i8, ptr %16, i64 %conv1.i71.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(1) %bat.i, ptr noundef nonnull align 1 dereferenceable(1) %add.ptr.i83.i, i64 %conv23.i76.i, i1 false)
  br label %if.end15.i

if.end15.i:                                       ; preds = %if.end30.i82.i, %if.end8.i89.i
...
ole2_get_next_xbat_block.exit:                    ; preds = %while.body.i, %if.then4.i54.i, %if.end8.i57.i, %if.else.i42.i, %lor.lhs.false.i47.i, %if.then2, %if.then4.i.i, %if.end8.i.i, %if.else.i.i, %lor.lhs.false.i.i, %while.end.i, %if.then4.i86.i, %if.end8.i89.i, %if.else.i74.i, %lor.lhs.false.i79.i, %if.end15.i
  %retval.0.i = phi i32 [ %20, %if.end15.i ], [ -1, %if.then2 ], [ -1, %if.then4.i.i ], [ -1, %if.end8.i.i ], [ -1, %lor.lhs.false.i.i ], [ -1, %if.else.i.i ], [ -1, %while.end.i ], [ -1, %if.then4.i86.i ], [ -1, %if.end8.i89.i ], [ -1, %lor.lhs.false.i79.i ], [ -1, %if.else.i74.i ], [ -1, %lor.lhs.false.i47.i ], [ -1, %if.else.i42.i ], [ -1, %if.end8.i57.i ], [ -1, %if.then4.i54.i ], [ -1, %while.body.i ]
...
if.else:                                          ; preds = %if.end
  ...
  %bat_count.i = getelementptr inbounds %struct.ole2_header_tag, ptr %hdr, i64 0, i32 8
  %21 = load i32, ptr %bat_count.i, align 4
...
if.end3.i:                                        ; preds = %if.else
  ...
  br i1 %cmp.i.i13, label %ole2_get_next_bat_block.exit, label %if.end.i.i14

if.end.i.i14:                                     ; preds = %if.end3.i
  %log2_big_block_size.i.i15 = getelementptr inbounds %struct.ole2_header_tag, ptr %hdr, i64 0, i32 5
  %23 = load i16, ptr %log2_big_block_size.i.i15, align 2
  %conv.i.i16 = zext i16 %23 to i32
  %shl.i.i17 = shl i32 %22, %conv.i.i16
  %add.i.i18 = add nsw i32 %shl.i.i17, 512
  %conv1.i.i19 = sext i32 %add.i.i18 to i64
  %m_area.i.i20 = getelementptr inbounds %struct.ole2_header_tag, ptr %hdr, i64 0, i32 18
  %24 = load ptr, ptr %m_area.i.i20, align 8
  %cmp2.i.i21 = icmp eq ptr %24, null
  br i1 %cmp2.i.i21, label %if.then4.i.i34, label %if.else.i.i22

if.then4.i.i34:                                   ; preds = %if.end.i.i14
  %call.i.i35 = tail call i64 @lseek(i32 noundef %fd, i64 noundef %conv1.i.i19, i32 noundef 0) #12
  %cmp5.not.i.i36 = icmp eq i64 %call.i.i35, %conv1.i.i19
  br i1 %cmp5.not.i.i36, label %if.end8.i.i37, label %ole2_get_next_bat_block.exit

if.end8.i.i37:                                    ; preds = %if.then4.i.i34
  %25 = load i16, ptr %log2_big_block_size.i.i15, align 2
  %conv10.i.i38 = zext i16 %25 to i32
  %shl11.i.i39 = shl nuw i32 1, %conv10.i.i38
  %call12.i.i40 = call i32 @cli_readn(i32 noundef %fd, ptr noundef nonnull %bat.i10, i32 noundef %shl11.i.i39) #12
  %26 = load i16, ptr %log2_big_block_size.i.i15, align 2
  %conv14.i.i41 = zext i16 %26 to i32
  %shl15.i.i42 = shl nuw i32 1, %conv14.i.i41
  %cmp16.not.i.i43 = icmp eq i32 %call12.i.i40, %shl15.i.i42
  br i1 %cmp16.not.i.i43, label %if.end5.i, label %ole2_get_next_bat_block.exit

if.else.i.i22:                                    ; preds = %if.end.i.i14
  %shl22.i.i23 = shl nuw i32 1, %conv.i.i16
  %conv23.i.i24 = sext i32 %shl22.i.i23 to i64
  %add24.i.i25 = add nsw i64 %conv1.i.i19, %conv23.i.i24
  %cmp25.i.i26 = icmp slt i64 %add24.i.i25, 1
  br i1 %cmp25.i.i26, label %ole2_get_next_bat_block.exit, label %lor.lhs.false.i.i27

lor.lhs.false.i.i27:                              ; preds = %if.else.i.i22
  %m_length.i.i28 = getelementptr inbounds %struct.ole2_header_tag, ptr %hdr, i64 0, i32 19
  %27 = load i64, ptr %m_length.i.i28, align 8
  %cmp27.i.i29 = icmp sgt i64 %add24.i.i25, %27
  br i1 %cmp27.i.i29, label %ole2_get_next_bat_block.exit, label %if.end30.i.i30

if.end30.i.i30:                                   ; preds = %lor.lhs.false.i.i27
  %add.ptr.i.i31 = getelementptr inbounds i8, ptr %24, i64 %conv1.i.i19
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(1) %bat.i10, ptr noundef nonnull align 1 dereferenceable(1) %add.ptr.i.i31, i64 %conv23.i.i24, i1 false)
  br label %if.end5.i

if.end5.i:                                        ; preds = %if.end30.i.i30, %if.end8.i.i37
  %sub.i32 = and i32 %current_block, 127
  %idxprom6.i = zext i32 %sub.i32 to i64
  %arrayidx7.i = getelementptr inbounds [128 x i32], ptr %bat.i10, i64 0, i64 %idxprom6.i
  %28 = load i32, ptr %arrayidx7.i, align 4
  br label %ole2_get_next_bat_block.exit

ole2_get_next_bat_block.exit:                     ; preds = %if.then2.i, %if.end3.i, %if.then4.i.i34, %if.end8.i.i37, %if.else.i.i22, %lor.lhs.false.i.i27, %if.end5.i
  %retval.0.i33 = phi i32 [ -10, %if.then2.i ], [ %28, %if.end5.i ], [ -1, %if.end3.i ], [ -1, %if.then4.i.i34 ], [ -1, %if.end8.i.i37 ], [ -1, %lor.lhs.false.i.i27 ], [ -1, %if.else.i.i22 ]
...
return:                                           ; preds = %entry, %ole2_get_next_bat_block.exit, %ole2_get_next_xbat_block.exit
  %retval.0 = phi i32 [ %retval.0.i, %ole2_get_next_xbat_block.exit ], [ %retval.0.i33, %ole2_get_next_bat_block.exit ], [ -1, %entry ]
  ret i32 %retval.0
}
...
entry:
  ...
  %0 = load i16, ptr %name_size, align 1
...
sw.epilog:                                        ; preds = %sw.default, %sw.bb8, %sw.bb7, %sw.bb
  ...
  %4 = load i32, ptr %user_flags, align 1
...
if.then39:                                        ; preds = %if.else
  ...
  store i8 95, ptr %arrayidx42, align 1
  %6 = load i8, ptr %arrayidx, align 1
  %add = add i8 %6, 48
  br label %if.end101

if.else50:                                        ; preds = %for.body, %if.else
  %conv53166 = zext i8 %2 to i16
  %conv54 = shl nuw i16 %conv53166, 8
  ...
  store i8 95, ptr %arrayidx62, align 1
  ...
  store i8 %add65, ptr %arrayidx69, align 1
  %9 = lshr i8 %8, 4
  ...
  store i8 97, ptr %arrayidx92, align 1
  br label %if.end101
...
if.end101:                                        ; preds = %if.else50, %if.then39
  ...
  store i8 %.sink, ptr %arrayidx100, align 1
  br label %for.inc
...
for.inc:                                          ; preds = %land.lhs.true, %if.end101
  ...
  store i8 %.sink177, ptr %arrayidx27, align 1
