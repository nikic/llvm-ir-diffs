...
while.body.i254:                                  ; preds = %while.body.i254, %while.body.preheader.i253
  ...
  br i1 %cmp1.i257, label %while.body.i254, label %while.end.i258, !llvm.loop !49
...
lor.lhs.false.i47.i:                              ; preds = %if.else.i42.i
  %12 = load i64, ptr %m_length.i48.i, align 8, !tbaa !17
...
lor.lhs.false.i79.i:                              ; preds = %if.else.i74.i
  ...
  %19 = load i64, ptr %m_length.i80.i, align 8, !tbaa !17
...
if.end.i.i14:                                     ; preds = %if.end3.i
  ...
  %23 = load i16, ptr %log2_big_block_size.i.i15, align 2, !tbaa !20
  ...
  %24 = load ptr, ptr %m_area.i.i20, align 8, !tbaa !9
...
if.end8.i.i37:                                    ; preds = %if.then4.i.i34
  %25 = load i16, ptr %log2_big_block_size.i.i15, align 2, !tbaa !20
  ...
  %26 = load i16, ptr %log2_big_block_size.i.i15, align 2, !tbaa !20
...
lor.lhs.false.i.i27:                              ; preds = %if.else.i.i22
  ...
  %27 = load i64, ptr %m_length.i.i28, align 8, !tbaa !17
