...
entry:
  ...
  %1 = load ptr, ptr %phishcheck, align 8
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %2 = load i32, ptr %is_disabled, align 8
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  %3 = load i32, ptr %found_possibly_unwanted, align 4
...
if.then6:                                         ; preds = %for.body
  ...
  store i16 512, ptr %always_check_flags, align 2
  ...
  store i16 0, ptr %link_type, align 4
...
if.then27:                                        ; preds = %if.then6
  %11 = or i16 %conv, 512
  store i16 %11, ptr %flags, align 8
  br label %if.end32
...
13:                                               ; preds = %if.end32
  ...
  store i16 %simplifycfg.merge, ptr %always_check_flags, align 2
  br label %15
...
15:                                               ; preds = %if.end32, %13
  ...
  store i32 %cond.i, ptr %urls, align 8
  %cond2.i = select i1 %tobool.not.i, ptr %17, ptr @empty_string
  store ptr %cond2.i, ptr %data3.i, align 8
  ...
  store i32 %cond.i160, ptr %displayLink, align 8
  %cond2.i161 = select i1 %tobool.not.i159, ptr %call56, ptr @empty_string
  store ptr %cond2.i161, ptr %data3.i162, align 8
  store ptr null, ptr %ref.i163, align 8
  store i32 0, ptr %pre_fixup, align 8
  store ptr @empty_string, ptr %data3.i164, align 8
  store ptr null, ptr %ref.i165, align 8
...
if.end65:                                         ; preds = %15
  store i32 -1, ptr %urls, align 8
  store i32 -1, ptr %displayLink, align 8
  ...
  %.pr = load ptr, ptr %data3.i, align 8
  br i1 %tobool73.not, label %if.end83, label %if.then74

if.then74:                                        ; preds = %if.end65
  %24 = load ptr, ptr %data3.i162, align 8
  store ptr %24, ptr %data3.i, align 8
  store ptr %.pr, ptr %data3.i162, align 8
  br label %if.end83
...
if.then.i.i:                                      ; preds = %if.end10.i
  ...
  %33 = load ptr, ptr %data3.i162, align 8
  %tobool3.not.i.i = icmp eq ptr %33, null
  %urls.val.pre.i = load ptr, ptr %data3.i, align 8
...
if.end22.i:                                       ; preds = %if.end18.i
  %34 = load ptr, ptr %data3.i162, align 8
...
lor.lhs.false.i:                                  ; preds = %isURL.exit.i
  %35 = load ptr, ptr %data3.i, align 8
...
if.then40.i:                                      ; preds = %isRealURL.exit.i, %lor.lhs.false.i, %isURL.exit.i, %if.end22.i
  %36 = load ptr, ptr %data3.i162, align 8
...
land.lhs.true46.i:                                ; preds = %if.end43.i
  %39 = load ptr, ptr %data3.i, align 8
  %40 = load ptr, ptr %data3.i162, align 8
...
if.then54.i:                                      ; preds = %land.lhs.true46.i
  store i32 8, ptr %phishy.i, align 4
  br label %if.end55.i

if.end55.i:                                       ; preds = %if.then54.i, %land.lhs.true46.i, %if.end43.i
  store i32 0, ptr %host_url.i, align 8
  store ptr @empty_string, ptr %data3.i.i.i, align 8
  store ptr null, ptr %ref.i.i.i, align 8
  store i32 0, ptr %displayLink.i298.i, align 8
  store ptr @empty_string, ptr %data3.i3.i.i, align 8
  store ptr null, ptr %ref.i4.i.i, align 8
  store i32 0, ptr %pre_fixup.i299.i, align 8
  store ptr @empty_string, ptr %data3.i5.i.i, align 8
  store ptr null, ptr %ref.i6.i.i, align 8
...
for.cond.i.i.i:                                   ; preds = %if.end55.i, %if.then.i.i.i
  ...
  %41 = load i32, ptr %str.addr.0.i.i.i, align 8
  %dec.i.i.i = add nsw i32 %41, -1
  store i32 %dec.i.i.i, ptr %str.addr.0.i.i.i, align 8
...
if.then.i.i.i:                                    ; preds = %for.cond.i.i.i
  ...
  %42 = load ptr, ptr %ref.i.i302.i, align 8
...
for.cond.i3.i.i:                                  ; preds = %for.cond.i3.i.i.preheader, %if.then.i7.i.i
  ...
  %44 = load i32, ptr %str.addr.0.i4.i.i, align 8
  %dec.i5.i.i = add nsw i32 %44, -1
  store i32 %dec.i5.i.i, ptr %str.addr.0.i4.i.i, align 8
...
if.then.i7.i.i:                                   ; preds = %for.cond.i3.i.i
  ...
  %45 = load ptr, ptr %ref.i8.i.i, align 8
...
if.else.i10.i.i:                                  ; preds = %if.then.i7.i.i
  ...
  %46 = load ptr, ptr %data.i11.i.i, align 8
...
for.cond.i15.i.i:                                 ; preds = %for.cond.i15.i.i.preheader, %if.then.i19.i.i
  ...
  %47 = load i32, ptr %str.addr.0.i16.i.i, align 8
  %dec.i17.i.i = add nsw i32 %47, -1
  store i32 %dec.i17.i.i, ptr %str.addr.0.i16.i.i, align 8
...
if.then.i19.i.i:                                  ; preds = %for.cond.i15.i.i
  ...
  %48 = load ptr, ptr %ref.i20.i.i, align 8
...
if.else.i22.i.i:                                  ; preds = %if.then.i19.i.i
  ...
  %49 = load ptr, ptr %data.i23.i.i, align 8
...
if.then71.i:                                      ; preds = %if.then68.i
  %53 = load ptr, ptr %data3.i3.i.i, align 8
  %54 = load ptr, ptr %data3.i.i.i, align 8
...
if.then79.i:                                      ; preds = %if.then71.i
  %or80.i = or i32 %52, 8
  store i32 %or80.i, ptr %phishy.i, align 4
  br label %if.end84.i

if.end84.i:                                       ; preds = %if.then79.i, %if.then71.i, %if.then68.i, %if.end63.i
  %55 = load i16, ptr %link_type, align 4
  %56 = and i16 %55, 1
  %tobool87.not.i = icmp ne i16 %56, 0
  %.pre.i = load i16, ptr %flags, align 8
...
land.lhs.true99.i:                                ; preds = %if.end94.i
  %59 = load i32, ptr %phishy.i, align 4
...
if.then102.i:                                     ; preds = %land.lhs.true99.i
  %60 = load i16, ptr %always_check_flags, align 2
  %and106279.i = and i16 %60, %.pre.i
  store i16 %and106279.i, ptr %flags, align 8
...
if.end112.if.end130_crit_edge.i:                  ; preds = %if.end112.i
  %.pre349.i = load ptr, ptr %data3.i162, align 8
  br label %if.end130.i

if.then117.i:                                     ; preds = %if.end112.i
  %63 = load ptr, ptr %data3.i, align 8
...
if.end123.i:                                      ; preds = %if.then117.i
  %64 = load ptr, ptr %data3.i162, align 8
  %call126.i = call fastcc i32 @isEncoded(ptr noundef %64)
...
land.lhs.true146.i:                               ; preds = %isSSL.exit.i
  %68 = load ptr, ptr %data3.i, align 8
...
land.lhs.true175.i:                               ; preds = %if.end170.i
  %71 = load i32, ptr %phishy.i, align 4
...
if.end179.i:                                      ; preds = %land.lhs.true175.i, %if.end170.i
  %host_url.val.i = load ptr, ptr %data3.i.i.i, align 8
  %host_url.val280.i = load ptr, ptr %data3.i3.i.i, align 8
...
if.then188.i:                                     ; preds = %if.end183.i
  %73 = load ptr, ptr %data3.i, align 8
  %74 = load ptr, ptr %data3.i162, align 8
...
if.then201.i:                                     ; preds = %if.end196.i
  ...
  store i32 0, ptr %domain_url.i, align 8
  store ptr @empty_string, ptr %data3.i.i321.i, align 8
  store ptr null, ptr %ref.i.i322.i, align 8
  store i32 0, ptr %displayLink.i323.i, align 8
  store ptr @empty_string, ptr %data3.i3.i324.i, align 8
  store ptr null, ptr %ref.i4.i325.i, align 8
  store i32 0, ptr %pre_fixup.i326.i, align 8
  store ptr @empty_string, ptr %data3.i5.i327.i, align 8
  store ptr null, ptr %ref.i6.i328.i, align 8
  call fastcc void @url_get_domain(ptr noundef %27, ptr noundef nonnull %host_url.i, ptr noundef nonnull %domain_url.i)
  %75 = load ptr, ptr %data3.i.i321.i, align 8
  %76 = load ptr, ptr %data3.i3.i324.i, align 8
...
if.end210.i:                                      ; preds = %cleanup.i, %if.end196.i
  call fastcc void @free_if_needed(ptr noundef nonnull %host_url.i)
  %.pre350.i = load i16, ptr %flags, align 8
...
if.end211.i:                                      ; preds = %if.end210.i, %if.end183.i
  ...
  %.pre351.i = load i32, ptr %phishy.i, align 4
...
phishingCheck.exit:                               ; preds = %if.end83, %if.end.i, %if.end.i.i, %if.end18.i, %if.then40.i, %free_if_needed.exit.i, %if.end84.i, %if.then110.i, %if.then122.i, %if.then128.i, %if.then135.i, %if.then151.i, %if.then169.i, %if.then178.i, %if.then182.i, %if.then195.i, %cleanup.thread.i, %if.end211.i, %if.end220.i
  ...
  %79 = load i32, ptr %is_disabled, align 8
...
for.cond.i.i:                                     ; preds = %phishingCheck.exit, %if.then.i.i170
  ...
  %80 = load i32, ptr %str.addr.0.i.i, align 8
  %dec.i.i = add nsw i32 %80, -1
  store i32 %dec.i.i, ptr %str.addr.0.i.i, align 8
...
if.then.i.i170:                                   ; preds = %for.cond.i.i
  ...
  %81 = load ptr, ptr %ref.i.i, align 8
...
if.else.i.i:                                      ; preds = %if.then.i.i170
  ...
  %82 = load ptr, ptr %data.i.i, align 8
...
for.cond.i3.i:                                    ; preds = %for.cond.i3.i.preheader, %if.then.i7.i
  ...
  %83 = load i32, ptr %str.addr.0.i4.i, align 8
  %dec.i5.i = add nsw i32 %83, -1
  store i32 %dec.i5.i, ptr %str.addr.0.i4.i, align 8
...
if.then.i7.i:                                     ; preds = %for.cond.i3.i
  ...
  %84 = load ptr, ptr %ref.i8.i, align 8
...
if.else.i10.i:                                    ; preds = %if.then.i7.i
  ...
  %85 = load ptr, ptr %data.i11.i, align 8
...
for.cond.i15.i:                                   ; preds = %for.cond.i15.i.preheader, %if.then.i19.i
  ...
  %86 = load i32, ptr %str.addr.0.i16.i, align 8
  %dec.i17.i = add nsw i32 %86, -1
  store i32 %dec.i17.i, ptr %str.addr.0.i16.i, align 8
...
if.then.i19.i:                                    ; preds = %for.cond.i15.i
  ...
  %87 = load ptr, ptr %ref.i20.i, align 8
...
if.else.i22.i:                                    ; preds = %if.then.i19.i
  ...
  %88 = load ptr, ptr %data.i23.i, align 8
...
phishing_ret_toString.exit.thread182:             ; preds = %free_if_needed.exit
  ...
  store i32 1, ptr %found_possibly_unwanted, align 4
...
phishing_ret_toString.exit.thread184:             ; preds = %free_if_needed.exit
  ...
  store ptr @.str.5, ptr %92, align 8
  store i32 1, ptr %found_possibly_unwanted, align 4
...
phishing_ret_toString.exit.thread186:             ; preds = %free_if_needed.exit
  ...
  store ptr @.str.6, ptr %98, align 8
  store i32 1, ptr %found_possibly_unwanted, align 4
...
phishing_ret_toString.exit.thread180:             ; preds = %free_if_needed.exit
  ...
  store ptr @.str.3, ptr %101, align 8
  store i32 1, ptr %found_possibly_unwanted, align 4
...
sw.default:                                       ; preds = %phishing_ret_toString.exit, %phishing_ret_toString.exit.thread178
  ...
  store ptr @.str.8, ptr %105, align 8
  store i32 1, ptr %found_possibly_unwanted, align 4
...
if.else:                                          ; preds = %for.body
  %108 = load ptr, ptr %tag, align 8
  %arrayidx112 = getelementptr inbounds ptr, ptr %108, i64 %indvars.iv
  %109 = load ptr, ptr %arrayidx112, align 8
...
for.inc:                                          ; preds = %cleanup, %if.then115, %if.else
  ...
  %110 = load i32, ptr %hrefs, align 8
  %111 = sext i32 %110 to i64
  %cmp = icmp slt i64 %indvars.iv.next, %111
  br i1 %cmp, label %for.body, label %cleanup118
...
for.cond.i:                                       ; preds = %if.then.i, %entry
  ...
  %0 = load i32, ptr %str.addr.0.i, align 8
  %dec.i = add nsw i32 %0, -1
  store i32 %dec.i, ptr %str.addr.0.i, align 8
...
for.cond.i3:                                      ; preds = %if.then.i7, %string_free.exit
  ...
  %3 = load i32, ptr %str.addr.0.i4, align 8
  %dec.i5 = add nsw i32 %3, -1
  store i32 %dec.i5, ptr %str.addr.0.i4, align 8
...
if.else.i10:                                      ; preds = %if.then.i7
  ...
  %5 = load ptr, ptr %data.i11, align 8
...
for.cond.i15:                                     ; preds = %if.then.i19, %string_free.exit14
  ...
  %6 = load i32, ptr %str.addr.0.i16, align 8
  %dec.i17 = add nsw i32 %6, -1
  store i32 %dec.i17, ptr %str.addr.0.i16, align 8
...
if.then.i19:                                      ; preds = %for.cond.i15
  ...
  %7 = load ptr, ptr %ref.i20, align 8
...
if.then15:                                        ; preds = %if.end12
  ...
  store ptr null, ptr %phishcheck, align 8
  br label %cleanup
...
if.end54:                                         ; preds = %if.end45
  ...
  store i32 0, ptr %is_disabled55, align 8
...
land.lhs.true:                                    ; preds = %entry
  ...
  %1 = load i32, ptr %is_disabled, align 8
...
for.cond:                                         ; preds = %if.then, %entry
  ...
  %0 = load i32, ptr %str.addr.0, align 8
  %dec = add nsw i32 %0, -1
  store i32 %dec, ptr %str.addr.0, align 8
...
if.then.i.i:                                      ; preds = %for.cond.i.i
  %ref.i.i = getelementptr inbounds %struct.string, ptr %str.addr.0.i.i, i64 0, i32 1
  %5 = load ptr, ptr %ref.i.i, align 8
...
string_free.exit.i:                               ; preds = %for.cond.i.i, %if.then6.i.i, %if.else.i.i
  ...
  store ptr @empty_string, ptr %data.i, align 8
...
for.cond.i.i90:                                   ; preds = %if.then.i.i97, %if.end.i
  ...
  %7 = load i32, ptr %str.addr.0.i.i91, align 8
  %dec.i.i92 = add nsw i32 %7, -1
  store i32 %dec.i.i92, ptr %str.addr.0.i.i91, align 8
...
if.then.i.i97:                                    ; preds = %for.cond.i.i90
  ...
  %8 = load ptr, ptr %ref.i.i98, align 8
...
if.else.i.i100:                                   ; preds = %if.then.i.i97
  ...
  %9 = load ptr, ptr %data.i.i101, align 8
...
string_assign_dup.exit.thread:                    ; preds = %for.cond.i.i90, %if.else.i.i100, %if.then6.i.i103
  ...
  store ptr %call.i, ptr %data.i95, align 8
  store i32 1, ptr %cond, align 8
  %ref.i96 = getelementptr inbounds %struct.string, ptr %cond, i64 0, i32 1
  store ptr null, ptr %ref.i96, align 8
  br label %if.end17
...
if.then20:                                        ; preds = %if.end17
  ...
  store i64 %sub.ptr.sub, ptr %host_start, align 8
  ...
  store i64 %sub.ptr.sub23, ptr %host_end, align 8
  br label %if.end25
...
if.end29:                                         ; preds = %if.end25
  %12 = load i32, ptr %phishy, align 4
  %and = and i32 %12, 4
...
for.cond.i:                                       ; preds = %if.end32, %if.then.i
  ...
  %13 = load i32, ptr %str.addr.0.i, align 8
...
land.lhs.true.if.end44_crit_edge:                 ; preds = %land.lhs.true
  %.pre115.pre = load ptr, ptr %data18, align 8
  br label %if.end44
...
land.lhs.true46:                                  ; preds = %if.end44
  %18 = load i8, ptr %.pre115, align 1
  %cmp = icmp eq i8 %18, 0
  br i1 %cmp, label %cleanup, label %if.end51

if.end51:                                         ; preds = %land.lhs.true46, %if.end44
  %call53 = tail call fastcc i32 @isNumeric(ptr noundef %.pre115)
  %tobool54.not = icmp eq i32 %call53, 0
  br i1 %tobool54.not, label %cleanup, label %if.then55

if.then55:                                        ; preds = %if.end51
  %19 = load i32, ptr %phishy, align 4
  %or = or i32 %19, 2
  store i32 %or, ptr %phishy, align 4
  br label %cleanup
...
do.cond:                                          ; preds = %do.body
  ...
  br i1 %tobool2.not, label %do.end, label %do.body
...
entry:
  ...
  store i16 %0, ptr %flags3, align 8
  ret void
}
...
for.body.i:                                       ; preds = %entry, %for.body.i
  ...
  store i8 %spec.select.i, ptr %begin.addr.011.i, align 1
  %incdec.ptr.i = getelementptr inbounds i8, ptr %begin.addr.011.i, i64 1
  %5 = load i8, ptr %incdec.ptr.i, align 1
  %tobool.not.i = icmp eq i8 %5, 0
  br i1 %tobool.not.i, label %clear_msb.exit, label %for.body.i
...
while.cond:                                       ; preds = %while.cond, %clear_msb.exit
  ...
  %7 = load i8, ptr %incdec.ptr299, align 1
...
while.end:                                        ; preds = %while.cond
  store ptr %incdec.ptr299, ptr %begin, align 8
...
for.cond.i.i:                                     ; preds = %if.then, %if.then.i.i
  ...
  %10 = load i32, ptr %str.addr.0.i.i, align 8
...
if.then.i.i:                                      ; preds = %for.cond.i.i
  %ref.i.i = getelementptr inbounds %struct.string, ptr %str.addr.0.i.i, i64 0, i32 1
  %11 = load ptr, ptr %ref.i.i, align 8
...
string_free.exit.i:                               ; preds = %for.cond.i.i, %if.then6.i.i, %if.else.i.i
  store ptr @empty_string, ptr %data, align 8
  store i32 -1, ptr %URL, align 8
...
for.cond.i.i115:                                  ; preds = %string_assign_null.exit, %if.then.i.i122
  ...
  %13 = load i32, ptr %str.addr.0.i.i116, align 8
  %dec.i.i117 = add nsw i32 %13, -1
  store i32 %dec.i.i117, ptr %str.addr.0.i.i116, align 8
...
if.then.i.i122:                                   ; preds = %for.cond.i.i115
  ...
  %14 = load ptr, ptr %ref.i.i123, align 8
...
if.else.i.i125:                                   ; preds = %if.then.i.i122
  ...
  %15 = load ptr, ptr %data.i.i126, align 8
...
string_free.exit.i119:                            ; preds = %for.cond.i.i115, %if.then6.i.i128, %if.else.i.i125
  ...
  store ptr @empty_string, ptr %data.i120, align 8
  store i32 -1, ptr %pre_URL, align 8
  %ref.i121 = getelementptr inbounds %struct.string, ptr %pre_URL, i64 0, i32 1
  store ptr null, ptr %ref.i121, align 8
  br label %cleanup89
...
for.cond.i.i131:                                  ; preds = %if.then7, %if.then.i.i138
  ...
  %16 = load i32, ptr %str.addr.0.i.i132, align 8
  %dec.i.i133 = add nsw i32 %16, -1
  store i32 %dec.i.i133, ptr %str.addr.0.i.i132, align 8
...
if.then.i.i138:                                   ; preds = %for.cond.i.i131
  ...
  %17 = load ptr, ptr %ref.i.i139, align 8
...
if.else.i.i141:                                   ; preds = %if.then.i.i138
  ...
  %18 = load ptr, ptr %data.i.i142, align 8
...
string_free.exit.i135:                            ; preds = %for.cond.i.i131, %if.then6.i.i144, %if.else.i.i141
  ...
  store ptr null, ptr %ref.i137, align 8
...
for.cond.i.i147:                                  ; preds = %string_assign_null.exit145, %if.then.i.i154
  ...
  %19 = load i32, ptr %str.addr.0.i.i148, align 8
  %dec.i.i149 = add nsw i32 %19, -1
  store i32 %dec.i.i149, ptr %str.addr.0.i.i148, align 8
...
if.then.i.i154:                                   ; preds = %for.cond.i.i147
  ...
  %20 = load ptr, ptr %ref.i.i155, align 8
...
if.else.i.i157:                                   ; preds = %if.then.i.i154
  ...
  %21 = load ptr, ptr %data.i.i158, align 8
...
string_free.exit.i151:                            ; preds = %for.cond.i.i147, %if.then6.i.i160, %if.else.i.i157
  ...
  store ptr @empty_string, ptr %data.i152, align 8
  store i32 -1, ptr %pre_URL, align 8
  %ref.i153 = getelementptr inbounds %struct.string, ptr %pre_URL, i64 0, i32 1
  store ptr null, ptr %ref.i153, align 8
  br label %cleanup89
...
while.cond9:                                      ; preds = %if.end, %while.cond9
  ...
  %22 = load i8, ptr %incdec.ptr18300, align 1
  ...
  br i1 %tobool16.not, label %while.end19, label %while.cond9

while.end19:                                      ; preds = %while.cond9
  store ptr %incdec.ptr18300, ptr %end, align 8
...
for.cond.i.i163:                                  ; preds = %if.then27, %if.then.i.i170
  ...
  %25 = load i32, ptr %str.addr.0.i.i164, align 8
  %dec.i.i165 = add nsw i32 %25, -1
  store i32 %dec.i.i165, ptr %str.addr.0.i.i164, align 8
...
if.then.i.i170:                                   ; preds = %for.cond.i.i163
  ...
  %26 = load ptr, ptr %ref.i.i171, align 8
...
if.else.i.i173:                                   ; preds = %if.then.i.i170
  ...
  %27 = load ptr, ptr %data.i.i174, align 8
...
string_free.exit.i167:                            ; preds = %for.cond.i.i163, %if.then6.i.i176, %if.else.i.i173
  ...
  store ptr null, ptr %ref.i169, align 8
...
for.cond.i.i179:                                  ; preds = %string_assign_null.exit177, %if.then.i.i186
  ...
  %28 = load i32, ptr %str.addr.0.i.i180, align 8
  %dec.i.i181 = add nsw i32 %28, -1
  store i32 %dec.i.i181, ptr %str.addr.0.i.i180, align 8
...
if.then.i.i186:                                   ; preds = %for.cond.i.i179
  ...
  %29 = load ptr, ptr %ref.i.i187, align 8
...
if.else.i.i189:                                   ; preds = %if.then.i.i186
  ...
  %30 = load ptr, ptr %data.i.i190, align 8
...
string_free.exit.i183:                            ; preds = %for.cond.i.i179, %if.then6.i.i192, %if.else.i.i189
  ...
  store ptr @empty_string, ptr %data.i184, align 8
  store i32 -1, ptr %pre_URL, align 8
  %ref.i185 = getelementptr inbounds %struct.string, ptr %pre_URL, i64 0, i32 1
  store ptr null, ptr %ref.i185, align 8
  br label %cleanup89
...
vector.body:                                      ; preds = %pred.store.continue105, %vector.ph
  ...
  %wide.load43 = load <16 x i8>, ptr %38, align 1
...
pred.store.if:                                    ; preds = %vector.body
  store i8 47, ptr %next.gep, align 1
...
pred.store.if44:                                  ; preds = %pred.store.continue
  ...
  store i8 47, ptr %next.gep12, align 1
...
pred.store.if46:                                  ; preds = %pred.store.continue45
  ...
  store i8 47, ptr %next.gep13, align 1
...
pred.store.if48:                                  ; preds = %pred.store.continue47
  ...
  store i8 47, ptr %next.gep14, align 1
...
pred.store.if50:                                  ; preds = %pred.store.continue49
  ...
  store i8 47, ptr %next.gep15, align 1
...
pred.store.if52:                                  ; preds = %pred.store.continue51
  ...
  store i8 47, ptr %next.gep16, align 1
...
pred.store.if54:                                  ; preds = %pred.store.continue53
  ...
  store i8 47, ptr %next.gep17, align 1
...
pred.store.if56:                                  ; preds = %pred.store.continue55
  ...
  store i8 47, ptr %next.gep18, align 1
...
pred.store.if58:                                  ; preds = %pred.store.continue57
  ...
  store i8 47, ptr %next.gep19, align 1
...
pred.store.if60:                                  ; preds = %pred.store.continue59
  ...
  store i8 47, ptr %next.gep20, align 1
...
pred.store.if62:                                  ; preds = %pred.store.continue61
  ...
  store i8 47, ptr %next.gep21, align 1
...
pred.store.if64:                                  ; preds = %pred.store.continue63
  ...
  store i8 47, ptr %next.gep22, align 1
...
pred.store.if66:                                  ; preds = %pred.store.continue65
  ...
  store i8 47, ptr %next.gep23, align 1
...
pred.store.if68:                                  ; preds = %pred.store.continue67
  ...
  store i8 47, ptr %next.gep24, align 1
...
pred.store.if70:                                  ; preds = %pred.store.continue69
  ...
  store i8 47, ptr %next.gep25, align 1
...
pred.store.if72:                                  ; preds = %pred.store.continue71
  ...
  store i8 47, ptr %next.gep26, align 1
...
pred.store.if74:                                  ; preds = %pred.store.continue73
  ...
  store i8 47, ptr %next.gep27, align 1
...
pred.store.if76:                                  ; preds = %pred.store.continue75
  ...
  store i8 47, ptr %next.gep28, align 1
...
pred.store.if78:                                  ; preds = %pred.store.continue77
  ...
  store i8 47, ptr %next.gep29, align 1
...
pred.store.if80:                                  ; preds = %pred.store.continue79
  ...
  store i8 47, ptr %next.gep30, align 1
...
pred.store.if82:                                  ; preds = %pred.store.continue81
  ...
  store i8 47, ptr %next.gep31, align 1
...
pred.store.if84:                                  ; preds = %pred.store.continue83
  ...
  store i8 47, ptr %next.gep32, align 1
...
pred.store.if86:                                  ; preds = %pred.store.continue85
  ...
  store i8 47, ptr %next.gep33, align 1
...
pred.store.if88:                                  ; preds = %pred.store.continue87
  ...
  store i8 47, ptr %next.gep34, align 1
...
pred.store.if90:                                  ; preds = %pred.store.continue89
  ...
  store i8 47, ptr %next.gep35, align 1
...
pred.store.if92:                                  ; preds = %pred.store.continue91
  ...
  store i8 47, ptr %next.gep36, align 1
...
pred.store.if94:                                  ; preds = %pred.store.continue93
  ...
  store i8 47, ptr %next.gep37, align 1
...
pred.store.if96:                                  ; preds = %pred.store.continue95
  ...
  store i8 47, ptr %next.gep38, align 1
...
pred.store.if98:                                  ; preds = %pred.store.continue97
  ...
  store i8 47, ptr %next.gep39, align 1
...
pred.store.if100:                                 ; preds = %pred.store.continue99
  ...
  store i8 47, ptr %next.gep40, align 1
...
pred.store.if102:                                 ; preds = %pred.store.continue101
  ...
  store i8 47, ptr %next.gep41, align 1
...
pred.store.if104:                                 ; preds = %pred.store.continue103
  ...
  store i8 47, ptr %next.gep42, align 1
...
pred.store.continue105:                           ; preds = %pred.store.if104, %pred.store.continue103
  ...
  br i1 %104, label %middle.block, label %vector.body
...
vec.epilog.vector.body:                           ; preds = %pred.store.continue137, %vec.epilog.ph
  ...
  %wide.load121 = load <8 x i8>, ptr %next.gep113, align 1
...
pred.store.if122:                                 ; preds = %vec.epilog.vector.body
  store i8 47, ptr %next.gep113, align 1
...
pred.store.if124:                                 ; preds = %pred.store.continue123
  ...
  store i8 47, ptr %next.gep114, align 1
...
pred.store.if126:                                 ; preds = %pred.store.continue125
  ...
  store i8 47, ptr %next.gep115, align 1
...
pred.store.if128:                                 ; preds = %pred.store.continue127
  ...
  store i8 47, ptr %next.gep116, align 1
...
pred.store.if130:                                 ; preds = %pred.store.continue129
  ...
  store i8 47, ptr %next.gep117, align 1
...
pred.store.if132:                                 ; preds = %pred.store.continue131
  ...
  store i8 47, ptr %next.gep118, align 1
...
pred.store.if134:                                 ; preds = %pred.store.continue133
  ...
  store i8 47, ptr %next.gep119, align 1
...
pred.store.if136:                                 ; preds = %pred.store.continue135
  ...
  store i8 47, ptr %next.gep120, align 1
...
pred.store.continue137:                           ; preds = %pred.store.if136, %pred.store.continue135
  ...
  br i1 %121, label %vec.epilog.middle.block, label %vec.epilog.vector.body
...
for.inc.i:                                        ; preds = %if.then.i, %for.body.i194
  ...
  br i1 %cmp.not.i, label %iter.check145, label %for.body.i194
...
vector.body152:                                   ; preds = %pred.store.continue251, %vector.ph148
  ...
  %wide.load186 = load <16 x i8>, ptr %next.gep154, align 1
  %130 = getelementptr i8, ptr %next.gep154, i64 16
  %wide.load187 = load <16 x i8>, ptr %130, align 1
...
pred.store.if188:                                 ; preds = %vector.body152
  store i8 32, ptr %next.gep154, align 1
...
pred.store.if190:                                 ; preds = %pred.store.continue189
  ...
  store i8 32, ptr %next.gep155, align 1
...
pred.store.if192:                                 ; preds = %pred.store.continue191
  ...
  store i8 32, ptr %next.gep156, align 1
...
pred.store.if194:                                 ; preds = %pred.store.continue193
  ...
  store i8 32, ptr %next.gep157, align 1
...
pred.store.if196:                                 ; preds = %pred.store.continue195
  ...
  store i8 32, ptr %next.gep158, align 1
...
pred.store.if198:                                 ; preds = %pred.store.continue197
  ...
  store i8 32, ptr %next.gep159, align 1
...
pred.store.if200:                                 ; preds = %pred.store.continue199
  ...
  store i8 32, ptr %next.gep160, align 1
...
pred.store.if202:                                 ; preds = %pred.store.continue201
  ...
  store i8 32, ptr %next.gep161, align 1
...
pred.store.if204:                                 ; preds = %pred.store.continue203
  ...
  store i8 32, ptr %next.gep162, align 1
...
pred.store.if220:                                 ; preds = %pred.store.continue219
  ...
  store i8 32, ptr %next.gep170, align 1
...
pred.store.if222:                                 ; preds = %pred.store.continue221
  ...
  store i8 32, ptr %next.gep171, align 1
...
pred.store.if224:                                 ; preds = %pred.store.continue223
  ...
  store i8 32, ptr %next.gep172, align 1
...
pred.store.if226:                                 ; preds = %pred.store.continue225
  ...
  store i8 32, ptr %next.gep173, align 1
...
pred.store.if228:                                 ; preds = %pred.store.continue227
  ...
  store i8 32, ptr %next.gep174, align 1
...
pred.store.if230:                                 ; preds = %pred.store.continue229
  ...
  store i8 32, ptr %next.gep175, align 1
...
pred.store.if232:                                 ; preds = %pred.store.continue231
  ...
  store i8 32, ptr %next.gep176, align 1
...
pred.store.if234:                                 ; preds = %pred.store.continue233
  ...
  store i8 32, ptr %next.gep177, align 1
...
pred.store.if236:                                 ; preds = %pred.store.continue235
  ...
  store i8 32, ptr %next.gep178, align 1
...
pred.store.if238:                                 ; preds = %pred.store.continue237
  ...
  store i8 32, ptr %next.gep179, align 1
...
pred.store.if240:                                 ; preds = %pred.store.continue239
  ...
  store i8 32, ptr %next.gep180, align 1
...
pred.store.if242:                                 ; preds = %pred.store.continue241
  ...
  store i8 32, ptr %next.gep181, align 1
...
pred.store.if244:                                 ; preds = %pred.store.continue243
  ...
  store i8 32, ptr %next.gep182, align 1
...
pred.store.if246:                                 ; preds = %pred.store.continue245
  ...
  store i8 32, ptr %next.gep183, align 1
...
pred.store.if248:                                 ; preds = %pred.store.continue247
  ...
  store i8 32, ptr %next.gep184, align 1
...
pred.store.if250:                                 ; preds = %pred.store.continue249
  ...
  store i8 32, ptr %next.gep185, align 1
...
pred.store.continue251:                           ; preds = %pred.store.if250, %pred.store.continue249
  ...
  br i1 %196, label %middle.block142, label %vector.body152
...
vec.epilog.vector.body268:                        ; preds = %pred.store.continue294, %vec.epilog.ph258
  ...
  %wide.load278 = load <8 x i8>, ptr %next.gep270, align 1
...
pred.store.if279:                                 ; preds = %vec.epilog.vector.body268
  store i8 32, ptr %next.gep270, align 1
...
pred.store.if281:                                 ; preds = %pred.store.continue280
  ...
  store i8 32, ptr %next.gep271, align 1
...
pred.store.if283:                                 ; preds = %pred.store.continue282
  ...
  store i8 32, ptr %next.gep272, align 1
...
pred.store.if285:                                 ; preds = %pred.store.continue284
  ...
  store i8 32, ptr %next.gep273, align 1
...
pred.store.if287:                                 ; preds = %pred.store.continue286
  ...
  store i8 32, ptr %next.gep274, align 1
...
pred.store.if289:                                 ; preds = %pred.store.continue288
  ...
  store i8 32, ptr %next.gep275, align 1
...
pred.store.if291:                                 ; preds = %pred.store.continue290
  ...
  store i8 32, ptr %next.gep276, align 1
...
pred.store.if293:                                 ; preds = %pred.store.continue292
  ...
  store i8 32, ptr %next.gep277, align 1
...
pred.store.continue294:                           ; preds = %pred.store.if293, %pred.store.continue292
  ...
  br i1 %213, label %vec.epilog.middle.block255, label %vec.epilog.vector.body268
...
for.inc.i202:                                     ; preds = %if.then.i205, %for.body.i198
  ...
  br i1 %cmp.not.i204, label %iter.check302, label %for.body.i198
...
vector.body309:                                   ; preds = %pred.store.continue408, %vector.ph305
  ...
  %wide.load343 = load <16 x i8>, ptr %next.gep311, align 1
  %222 = getelementptr i8, ptr %next.gep311, i64 16
  %wide.load344 = load <16 x i8>, ptr %222, align 1
...
pred.store.if345:                                 ; preds = %vector.body309
  store i8 32, ptr %next.gep311, align 1
...
pred.store.if347:                                 ; preds = %pred.store.continue346
  ...
  store i8 32, ptr %next.gep312, align 1
...
pred.store.if349:                                 ; preds = %pred.store.continue348
  ...
  store i8 32, ptr %next.gep313, align 1
...
pred.store.if351:                                 ; preds = %pred.store.continue350
  ...
  store i8 32, ptr %next.gep314, align 1
...
pred.store.if353:                                 ; preds = %pred.store.continue352
  ...
  store i8 32, ptr %next.gep315, align 1
...
pred.store.if355:                                 ; preds = %pred.store.continue354
  ...
  store i8 32, ptr %next.gep316, align 1
...
pred.store.if357:                                 ; preds = %pred.store.continue356
  ...
  store i8 32, ptr %next.gep317, align 1
...
pred.store.if359:                                 ; preds = %pred.store.continue358
  ...
  store i8 32, ptr %next.gep318, align 1
...
pred.store.if361:                                 ; preds = %pred.store.continue360
  ...
  store i8 32, ptr %next.gep319, align 1
...
pred.store.if363:                                 ; preds = %pred.store.continue362
  ...
  store i8 32, ptr %next.gep320, align 1
...
pred.store.if365:                                 ; preds = %pred.store.continue364
  ...
  store i8 32, ptr %next.gep321, align 1
...
pred.store.if367:                                 ; preds = %pred.store.continue366
  ...
  store i8 32, ptr %next.gep322, align 1
...
pred.store.if369:                                 ; preds = %pred.store.continue368
  ...
  store i8 32, ptr %next.gep323, align 1
...
pred.store.if371:                                 ; preds = %pred.store.continue370
  ...
  store i8 32, ptr %next.gep324, align 1
...
pred.store.if373:                                 ; preds = %pred.store.continue372
  ...
  store i8 32, ptr %next.gep325, align 1
...
pred.store.if375:                                 ; preds = %pred.store.continue374
  ...
  store i8 32, ptr %next.gep326, align 1
...
pred.store.if377:                                 ; preds = %pred.store.continue376
  ...
  store i8 32, ptr %next.gep327, align 1
...
pred.store.if379:                                 ; preds = %pred.store.continue378
  ...
  store i8 32, ptr %next.gep328, align 1
...
pred.store.if381:                                 ; preds = %pred.store.continue380
  ...
  store i8 32, ptr %next.gep329, align 1
...
pred.store.if383:                                 ; preds = %pred.store.continue382
  ...
  store i8 32, ptr %next.gep330, align 1
...
pred.store.if385:                                 ; preds = %pred.store.continue384
  ...
  store i8 32, ptr %next.gep331, align 1
...
pred.store.if387:                                 ; preds = %pred.store.continue386
  ...
  store i8 32, ptr %next.gep332, align 1
...
pred.store.if389:                                 ; preds = %pred.store.continue388
  ...
  store i8 32, ptr %next.gep333, align 1
...
pred.store.if391:                                 ; preds = %pred.store.continue390
  ...
  store i8 32, ptr %next.gep334, align 1
...
pred.store.if393:                                 ; preds = %pred.store.continue392
  ...
  store i8 32, ptr %next.gep335, align 1
...
pred.store.if395:                                 ; preds = %pred.store.continue394
  ...
  store i8 32, ptr %next.gep336, align 1
...
pred.store.if397:                                 ; preds = %pred.store.continue396
  ...
  store i8 32, ptr %next.gep337, align 1
...
pred.store.if399:                                 ; preds = %pred.store.continue398
  ...
  store i8 32, ptr %next.gep338, align 1
...
pred.store.if401:                                 ; preds = %pred.store.continue400
  ...
  store i8 32, ptr %next.gep339, align 1
...
pred.store.if403:                                 ; preds = %pred.store.continue402
  ...
  store i8 32, ptr %next.gep340, align 1
...
pred.store.if405:                                 ; preds = %pred.store.continue404
  ...
  store i8 32, ptr %next.gep341, align 1
...
pred.store.if407:                                 ; preds = %pred.store.continue406
  ...
  store i8 32, ptr %next.gep342, align 1
...
pred.store.continue408:                           ; preds = %pred.store.if407, %pred.store.continue406
  ...
  br i1 %288, label %middle.block299, label %vector.body309
...
vec.epilog.vector.body425:                        ; preds = %pred.store.continue451, %vec.epilog.ph415
  ...
  %wide.load435 = load <8 x i8>, ptr %next.gep427, align 1
...
pred.store.if436:                                 ; preds = %vec.epilog.vector.body425
  store i8 32, ptr %next.gep427, align 1
...
pred.store.if438:                                 ; preds = %pred.store.continue437
  ...
  store i8 32, ptr %next.gep428, align 1
...
pred.store.if440:                                 ; preds = %pred.store.continue439
  ...
  store i8 32, ptr %next.gep429, align 1
...
pred.store.if442:                                 ; preds = %pred.store.continue441
  ...
  store i8 32, ptr %next.gep430, align 1
...
pred.store.if444:                                 ; preds = %pred.store.continue443
  ...
  store i8 32, ptr %next.gep431, align 1
...
pred.store.if446:                                 ; preds = %pred.store.continue445
  ...
  store i8 32, ptr %next.gep432, align 1
...
pred.store.if448:                                 ; preds = %pred.store.continue447
  ...
  store i8 32, ptr %next.gep433, align 1
...
pred.store.if450:                                 ; preds = %pred.store.continue449
  ...
  store i8 32, ptr %next.gep434, align 1
...
pred.store.continue451:                           ; preds = %pred.store.if450, %pred.store.continue449
  ...
  br i1 %305, label %vec.epilog.middle.block412, label %vec.epilog.vector.body425
...
for.inc.i213:                                     ; preds = %if.then.i216, %for.body.i209
  ...
  br i1 %cmp.not.i215, label %iter.check459, label %for.body.i209
...
vector.body466:                                   ; preds = %pred.store.continue565, %vector.ph462
  ...
  %wide.load500 = load <16 x i8>, ptr %next.gep468, align 1
  %314 = getelementptr i8, ptr %next.gep468, i64 16
  %wide.load501 = load <16 x i8>, ptr %314, align 1
...
pred.store.if502:                                 ; preds = %vector.body466
  store i8 32, ptr %next.gep468, align 1
...
pred.store.if504:                                 ; preds = %pred.store.continue503
  ...
  store i8 32, ptr %next.gep469, align 1
...
pred.store.if506:                                 ; preds = %pred.store.continue505
  ...
  store i8 32, ptr %next.gep470, align 1
...
pred.store.if508:                                 ; preds = %pred.store.continue507
  ...
  store i8 32, ptr %next.gep471, align 1
...
pred.store.if510:                                 ; preds = %pred.store.continue509
  ...
  store i8 32, ptr %next.gep472, align 1
...
pred.store.if512:                                 ; preds = %pred.store.continue511
  ...
  store i8 32, ptr %next.gep473, align 1
...
pred.store.if514:                                 ; preds = %pred.store.continue513
  ...
  store i8 32, ptr %next.gep474, align 1
...
pred.store.if516:                                 ; preds = %pred.store.continue515
  ...
  store i8 32, ptr %next.gep475, align 1
...
pred.store.if518:                                 ; preds = %pred.store.continue517
  ...
  store i8 32, ptr %next.gep476, align 1
...
pred.store.if520:                                 ; preds = %pred.store.continue519
  ...
  store i8 32, ptr %next.gep477, align 1
...
pred.store.if522:                                 ; preds = %pred.store.continue521
  ...
  store i8 32, ptr %next.gep478, align 1
...
pred.store.if524:                                 ; preds = %pred.store.continue523
  ...
  store i8 32, ptr %next.gep479, align 1
...
pred.store.if526:                                 ; preds = %pred.store.continue525
  ...
  store i8 32, ptr %next.gep480, align 1
...
pred.store.if528:                                 ; preds = %pred.store.continue527
  ...
  store i8 32, ptr %next.gep481, align 1
...
pred.store.if530:                                 ; preds = %pred.store.continue529
  ...
  store i8 32, ptr %next.gep482, align 1
...
pred.store.if532:                                 ; preds = %pred.store.continue531
  ...
  store i8 32, ptr %next.gep483, align 1
...
pred.store.if534:                                 ; preds = %pred.store.continue533
  ...
  store i8 32, ptr %next.gep484, align 1
...
pred.store.if536:                                 ; preds = %pred.store.continue535
  ...
  store i8 32, ptr %next.gep485, align 1
...
pred.store.if538:                                 ; preds = %pred.store.continue537
  ...
  store i8 32, ptr %next.gep486, align 1
...
pred.store.if540:                                 ; preds = %pred.store.continue539
  ...
  store i8 32, ptr %next.gep487, align 1
...
pred.store.if542:                                 ; preds = %pred.store.continue541
  ...
  store i8 32, ptr %next.gep488, align 1
...
pred.store.if544:                                 ; preds = %pred.store.continue543
  ...
  store i8 32, ptr %next.gep489, align 1
...
pred.store.if546:                                 ; preds = %pred.store.continue545
  ...
  store i8 32, ptr %next.gep490, align 1
...
pred.store.if548:                                 ; preds = %pred.store.continue547
  ...
  store i8 32, ptr %next.gep491, align 1
...
pred.store.if550:                                 ; preds = %pred.store.continue549
  ...
  store i8 32, ptr %next.gep492, align 1
...
pred.store.if552:                                 ; preds = %pred.store.continue551
  ...
  store i8 32, ptr %next.gep493, align 1
...
pred.store.if554:                                 ; preds = %pred.store.continue553
  ...
  store i8 32, ptr %next.gep494, align 1
...
pred.store.if556:                                 ; preds = %pred.store.continue555
  ...
  store i8 32, ptr %next.gep495, align 1
...
pred.store.if558:                                 ; preds = %pred.store.continue557
  ...
  store i8 32, ptr %next.gep496, align 1
...
pred.store.if560:                                 ; preds = %pred.store.continue559
  ...
  store i8 32, ptr %next.gep497, align 1
...
pred.store.if562:                                 ; preds = %pred.store.continue561
  ...
  store i8 32, ptr %next.gep498, align 1
...
pred.store.if564:                                 ; preds = %pred.store.continue563
  ...
  store i8 32, ptr %next.gep499, align 1
...
pred.store.continue565:                           ; preds = %pred.store.if564, %pred.store.continue563
  ...
  br i1 %380, label %middle.block456, label %vector.body466
...
vec.epilog.vector.body582:                        ; preds = %pred.store.continue608, %vec.epilog.ph572
  ...
  %wide.load592 = load <8 x i8>, ptr %next.gep584, align 1
...
pred.store.if593:                                 ; preds = %vec.epilog.vector.body582
  store i8 32, ptr %next.gep584, align 1
...
pred.store.if595:                                 ; preds = %pred.store.continue594
  ...
  store i8 32, ptr %next.gep585, align 1
...
pred.store.if597:                                 ; preds = %pred.store.continue596
  ...
  store i8 32, ptr %next.gep586, align 1
...
pred.store.if599:                                 ; preds = %pred.store.continue598
  ...
  store i8 32, ptr %next.gep587, align 1
...
pred.store.if601:                                 ; preds = %pred.store.continue600
  ...
  store i8 32, ptr %next.gep588, align 1
...
pred.store.if603:                                 ; preds = %pred.store.continue602
  ...
  store i8 32, ptr %next.gep589, align 1
...
pred.store.if605:                                 ; preds = %pred.store.continue604
  ...
  store i8 32, ptr %next.gep590, align 1
...
pred.store.if607:                                 ; preds = %pred.store.continue606
  ...
  store i8 32, ptr %next.gep591, align 1
...
pred.store.continue608:                           ; preds = %pred.store.if607, %pred.store.continue606
  ...
  br i1 %397, label %vec.epilog.middle.block569, label %vec.epilog.vector.body582
...
for.inc.i224:                                     ; preds = %if.then.i227, %for.body.i220
  ...
  br i1 %cmp.not.i226, label %iter.check616, label %for.body.i220
...
vector.body623:                                   ; preds = %pred.store.continue722, %vector.ph619
  ...
  %wide.load657 = load <16 x i8>, ptr %next.gep625, align 1
  %406 = getelementptr i8, ptr %next.gep625, i64 16
  %wide.load658 = load <16 x i8>, ptr %406, align 1
...
pred.store.if659:                                 ; preds = %vector.body623
  store i8 32, ptr %next.gep625, align 1
...
pred.store.if661:                                 ; preds = %pred.store.continue660
  ...
  store i8 32, ptr %next.gep626, align 1
...
pred.store.if663:                                 ; preds = %pred.store.continue662
  ...
  store i8 32, ptr %next.gep627, align 1
...
pred.store.if665:                                 ; preds = %pred.store.continue664
  ...
  store i8 32, ptr %next.gep628, align 1
...
pred.store.if667:                                 ; preds = %pred.store.continue666
  ...
  store i8 32, ptr %next.gep629, align 1
...
pred.store.if669:                                 ; preds = %pred.store.continue668
  ...
  store i8 32, ptr %next.gep630, align 1
...
pred.store.if671:                                 ; preds = %pred.store.continue670
  ...
  store i8 32, ptr %next.gep631, align 1
...
pred.store.if673:                                 ; preds = %pred.store.continue672
  ...
  store i8 32, ptr %next.gep632, align 1
...
pred.store.if675:                                 ; preds = %pred.store.continue674
  ...
  store i8 32, ptr %next.gep633, align 1
...
pred.store.if677:                                 ; preds = %pred.store.continue676
  ...
  store i8 32, ptr %next.gep634, align 1
...
pred.store.if679:                                 ; preds = %pred.store.continue678
  ...
  store i8 32, ptr %next.gep635, align 1
...
pred.store.if681:                                 ; preds = %pred.store.continue680
  ...
  store i8 32, ptr %next.gep636, align 1
...
pred.store.if683:                                 ; preds = %pred.store.continue682
  ...
  store i8 32, ptr %next.gep637, align 1
...
pred.store.if685:                                 ; preds = %pred.store.continue684
  ...
  store i8 32, ptr %next.gep638, align 1
...
pred.store.if687:                                 ; preds = %pred.store.continue686
  ...
  store i8 32, ptr %next.gep639, align 1
...
pred.store.if689:                                 ; preds = %pred.store.continue688
  ...
  store i8 32, ptr %next.gep640, align 1
...
pred.store.if691:                                 ; preds = %pred.store.continue690
  ...
  store i8 32, ptr %next.gep641, align 1
...
pred.store.if693:                                 ; preds = %pred.store.continue692
  ...
  store i8 32, ptr %next.gep642, align 1
...
pred.store.if695:                                 ; preds = %pred.store.continue694
  ...
  store i8 32, ptr %next.gep643, align 1
...
pred.store.if697:                                 ; preds = %pred.store.continue696
  ...
  store i8 32, ptr %next.gep644, align 1
...
pred.store.if699:                                 ; preds = %pred.store.continue698
  ...
  store i8 32, ptr %next.gep645, align 1
...
pred.store.if701:                                 ; preds = %pred.store.continue700
  ...
  store i8 32, ptr %next.gep646, align 1
...
pred.store.if703:                                 ; preds = %pred.store.continue702
  ...
  store i8 32, ptr %next.gep647, align 1
...
pred.store.if705:                                 ; preds = %pred.store.continue704
  ...
  store i8 32, ptr %next.gep648, align 1
...
pred.store.if707:                                 ; preds = %pred.store.continue706
  ...
  store i8 32, ptr %next.gep649, align 1
...
pred.store.if709:                                 ; preds = %pred.store.continue708
  ...
  store i8 32, ptr %next.gep650, align 1
...
pred.store.if711:                                 ; preds = %pred.store.continue710
  ...
  store i8 32, ptr %next.gep651, align 1
...
pred.store.if713:                                 ; preds = %pred.store.continue712
  ...
  store i8 32, ptr %next.gep652, align 1
...
pred.store.if715:                                 ; preds = %pred.store.continue714
  ...
  store i8 32, ptr %next.gep653, align 1
...
pred.store.if717:                                 ; preds = %pred.store.continue716
  ...
  store i8 32, ptr %next.gep654, align 1
...
pred.store.if719:                                 ; preds = %pred.store.continue718
  ...
  store i8 32, ptr %next.gep655, align 1
...
pred.store.if721:                                 ; preds = %pred.store.continue720
  ...
  store i8 32, ptr %next.gep656, align 1
...
pred.store.continue722:                           ; preds = %pred.store.if721, %pred.store.continue720
  ...
  br i1 %472, label %middle.block613, label %vector.body623
...
vec.epilog.vector.body739:                        ; preds = %pred.store.continue765, %vec.epilog.ph729
  ...
  %wide.load749 = load <8 x i8>, ptr %next.gep741, align 1
...
pred.store.if750:                                 ; preds = %vec.epilog.vector.body739
  store i8 32, ptr %next.gep741, align 1
...
pred.store.if752:                                 ; preds = %pred.store.continue751
  ...
  store i8 32, ptr %next.gep742, align 1
...
pred.store.if754:                                 ; preds = %pred.store.continue753
  ...
  store i8 32, ptr %next.gep743, align 1
...
pred.store.if756:                                 ; preds = %pred.store.continue755
  ...
  store i8 32, ptr %next.gep744, align 1
...
pred.store.if758:                                 ; preds = %pred.store.continue757
  ...
  store i8 32, ptr %next.gep745, align 1
...
pred.store.if760:                                 ; preds = %pred.store.continue759
  ...
  store i8 32, ptr %next.gep746, align 1
...
pred.store.if762:                                 ; preds = %pred.store.continue761
  ...
  store i8 32, ptr %next.gep747, align 1
...
pred.store.if764:                                 ; preds = %pred.store.continue763
  ...
  store i8 32, ptr %next.gep748, align 1
...
pred.store.continue765:                           ; preds = %pred.store.if764, %pred.store.continue763
  ...
  br i1 %489, label %vec.epilog.middle.block726, label %vec.epilog.vector.body739
...
for.inc.i235:                                     ; preds = %if.then.i238, %for.body.i231
  ...
  br i1 %cmp.not.i237, label %str_replace.exit239, label %for.body.i231
...
str_replace.exit239:                              ; preds = %for.inc.i235, %middle.block613, %vec.epilog.middle.block726, %if.else
  ...
  %491 = load ptr, ptr %begin, align 8
...
land.rhs:                                         ; preds = %while.cond29
  ...
  %492 = load i8, ptr %arrayidx31, align 1
  %cmp33 = icmp eq i8 %492, 47
  br i1 %cmp33, label %while.cond29, label %if.end42
...
for.body.i241.prol:                               ; preds = %for.body.lr.ph.i240, %for.body.i241.prol
  ...
  %493 = load ptr, ptr %call.i, align 8
  %494 = load i8, ptr %str.addr.07.i.prol, align 1
  %idxprom.i.prol = sext i8 %494 to i64
  %arrayidx.i.prol = getelementptr inbounds i32, ptr %493, i64 %idxprom.i.prol
  %495 = load i32, ptr %arrayidx.i.prol, align 4
  %conv1.i.prol = trunc i32 %495 to i8
  store i8 %conv1.i.prol, ptr %str.addr.07.i.prol, align 1
  ...
  br i1 %prol.iter.cmp.not, label %for.body.i241.prol.loopexit, label %for.body.i241.prol
...
for.body.i241:                                    ; preds = %for.body.i241.prol.loopexit, %for.body.i241
  ...
  br i1 %tobool.not.i243.3, label %str_make_lowercase.exit.loopexit, label %for.body.i241

str_make_lowercase.exit.loopexit:                 ; preds = %for.body.i241, %for.body.i241.prol.loopexit
  %.pre = load ptr, ptr %begin, align 8
...
if.then6.i:                                       ; preds = %if.end3.i
  ...
  %512 = load i8, ptr %add.ptr.i, align 1
...
cond.false.i.i:                                   ; preds = %if.then6.i
  ...
  %514 = load i16, ptr %arrayidx7.i.i, align 2
  ...
  %515 = load i16, ptr %arrayidx11.i.i, align 2
...
while.cond14.preheader.i:                         ; preds = %if.end10.i, %while.end.i
  ...
  %sbegin.1.promoted.i = load i8, ptr %sbegin.176.i, align 1
  br label %land.rhs.i
...
while.body22.i:                                   ; preds = %land.rhs.i
  %516 = load i8, ptr %add.ptr24.i, align 1
  %cmp.i54.i = icmp eq i8 %516, 48
  %517 = load i8, ptr %arrayidx2.i55.i, align 1
...
cond.false.i58.i:                                 ; preds = %while.body22.i
  ...
  %518 = load i16, ptr %arrayidx7.i60.i, align 2
  ...
  %519 = load i16, ptr %arrayidx11.i64.i, align 2
...
hex2int.exit68.i:                                 ; preds = %cond.false.i58.i, %while.body22.i
  ...
  store i8 %cond.i67.i, ptr %sbegin.176.i, align 1
  ...
  br i1 %cmp16.i, label %land.rhs.i, label %while.end.i
...
while.cond47.preheader:                           ; preds = %str_hex_to_char.exit
  %begin.promoted301 = load ptr, ptr %begin, align 8
...
if.then45:                                        ; preds = %str_hex_to_char.exit
  ...
  %.pre322 = load ptr, ptr %begin, align 8
  %.pre323 = load ptr, ptr %end, align 8
  br label %if.end71
...
land.rhs50:                                       ; preds = %while.cond47.preheader, %while.body56
  ...
  %520 = load i8, ptr %incdec.ptr57302304, align 1
...
while.body56:                                     ; preds = %land.rhs50
  ...
  br i1 %cmp48.not, label %while.end58, label %land.rhs50
...
while.end58:                                      ; preds = %land.rhs50, %while.body56, %while.cond47.preheader
  ...
  store ptr %incdec.ptr57302.lcssa, ptr %begin, align 8
...
land.rhs62:                                       ; preds = %while.end58, %while.body68
  ...
  %521 = load i8, ptr %incdec.ptr69309311, align 1
...
while.body68:                                     ; preds = %land.rhs62
  ...
  br i1 %cmp60.not, label %if.end71.loopexit, label %land.rhs62
...
if.end71.loopexit:                                ; preds = %land.rhs62, %while.body68, %while.end58
  ...
  store ptr %incdec.ptr69309.lcssa, ptr %end, align 8
  br label %if.end71
...
for.cond.i.i253:                                  ; preds = %if.then.i.i260, %if.end.i251
  ...
  %524 = load i32, ptr %str.addr.0.i.i254, align 8
  %dec.i.i255 = add nsw i32 %524, -1
  store i32 %dec.i.i255, ptr %str.addr.0.i.i254, align 8
...
if.then.i.i260:                                   ; preds = %for.cond.i.i253
  ...
  %525 = load ptr, ptr %ref.i.i261, align 8
...
if.else.i.i263:                                   ; preds = %if.then.i.i260
  ...
  %526 = load ptr, ptr %data.i.i264, align 8
...
for.cond.i.i268:                                  ; preds = %if.then76, %if.then.i.i276
  ...
  %527 = load i32, ptr %str.addr.0.i.i269, align 8
  %dec.i.i270 = add nsw i32 %527, -1
  store i32 %dec.i.i270, ptr %str.addr.0.i.i269, align 8
  %tobool.not.i.i271 = icmp eq i32 %dec.i.i270, 0
  br i1 %tobool.not.i.i271, label %if.then.i.i276, label %string_free.exit.i272

if.then.i.i276:                                   ; preds = %for.cond.i.i268
  %ref.i.i277 = getelementptr inbounds %struct.string, ptr %str.addr.0.i.i269, i64 0, i32 1
  %528 = load ptr, ptr %ref.i.i277, align 8
...
if.else.i.i279:                                   ; preds = %if.then.i.i276
  ...
  %529 = load ptr, ptr %data.i.i280, align 8
  %tobool5.not.i.i281 = icmp eq ptr %529, null
  br i1 %tobool5.not.i.i281, label %string_free.exit.i272, label %if.then6.i.i282

if.then6.i.i282:                                  ; preds = %if.else.i.i279
  tail call void @free(ptr noundef nonnull %529) #14
  br label %string_free.exit.i272

string_free.exit.i272:                            ; preds = %for.cond.i.i268, %if.then6.i.i282, %if.else.i.i279
  store ptr @empty_string, ptr %data, align 8
  store i32 -1, ptr %URL, align 8
  %ref.i274 = getelementptr inbounds %struct.string, ptr %URL, i64 0, i32 1
  store ptr null, ptr %ref.i274, align 8
  br label %cleanup89
...
if.end77:                                         ; preds = %for.cond.i.i253, %if.else.i.i263, %if.then6.i.i266
  ...
  store ptr %call.i249, ptr %data.i258, align 8
  store i32 1, ptr %cond, align 8
  %ref.i259 = getelementptr inbounds %struct.string, ptr %cond, i64 0, i32 1
  store ptr null, ptr %ref.i259, align 8
...
if.then79:                                        ; preds = %if.end77
  ...
  %530 = load ptr, ptr %begin, align 8
  %531 = load ptr, ptr %end, align 8
  %add.ptr80 = getelementptr inbounds i8, ptr %531, i64 1
  %call81 = tail call fastcc i32 @string_assign_dup(ptr noundef %URL, ptr noundef %530, ptr noundef nonnull %add.ptr80)
  br label %cleanup89

cleanup89:                                        ; preds = %if.then79, %string_free.exit.i272, %if.then76, %string_assign_null.exit177, %string_free.exit.i183, %if.end77, %string_free.exit.i151, %string_assign_null.exit145, %string_free.exit.i119, %string_assign_null.exit
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %end) #14
...
while.body20:                                     ; preds = %land.rhs16
  ...
  br i1 %cmp15, label %land.rhs16, label %if.end26
...
if.end26:                                         ; preds = %while.body20, %land.rhs16, %if.then11, %while.end
  ...
  store ptr %sbegin.0.lcssa, ptr %begin, align 8
...
while.body39:                                     ; preds = %land.rhs34
  ...
  br i1 %cmp33.not, label %while.end46, label %land.rhs34
...
entry:
  ...
  %0 = load ptr, ptr %begin, align 8
  store ptr %0, ptr %sbegin, align 8
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %send) #14
  %1 = load ptr, ptr %end, align 8
  store ptr %1, ptr %send, align 8
...
while.cond:                                       ; preds = %while.cond, %if.end
  ...
  %4 = load i8, ptr %incdec.ptr32, align 1
...
while.cond8:                                      ; preds = %while.cond, %while.cond8
  ...
  br i1 %11, label %while.cond8, label %while.end23

while.end23:                                      ; preds = %while.cond8
  store ptr %incdec.ptr32, ptr %begin, align 8
...
if.then:                                          ; preds = %entry
  store ptr null, ptr %hend, align 8
  store ptr null, ptr %hstart, align 8
  br label %cleanup71
...
if.end60.thread:                                  ; preds = %if.end26
  %3 = load i32, ptr %phishy, align 4
  %or58 = or i32 %3, 4
  store i32 %or58, ptr %phishy, align 4
  br label %if.then62
...
if.end70:                                         ; preds = %if.end49, %if.then62, %if.end60
  ...
  store ptr %start.5151, ptr %hstart, align 8
  store ptr %end.2, ptr %hend, align 8
  br label %cleanup71
...
for.cond.i.i:                                     ; preds = %if.then.i.i, %if.then
  ...
  %1 = load i32, ptr %str.addr.0.i.i, align 8
...
if.then.i.i:                                      ; preds = %for.cond.i.i
  %ref.i.i = getelementptr inbounds %struct.string, ptr %str.addr.0.i.i, i64 0, i32 1
  %2 = load ptr, ptr %ref.i.i, align 8
...
string_assign.exit:                               ; preds = %for.cond.i.i, %if.else.i.i, %if.then6.i.i
  %4 = load i32, ptr %host, align 8
  %inc.i = add nsw i32 %4, 1
  store i32 %inc.i, ptr %host, align 8
...
for.inc.i:                                        ; preds = %land.rhs.i
  ...
  br i1 %cmp1.not.i, label %if.then10, label %land.rhs.i
...
for.cond.i.i64:                                   ; preds = %if.then.i.i72, %if.then10
  ...
  %9 = load i32, ptr %str.addr.0.i.i65, align 8
  %dec.i.i66 = add nsw i32 %9, -1
  store i32 %dec.i.i66, ptr %str.addr.0.i.i65, align 8
...
if.then.i.i72:                                    ; preds = %for.cond.i.i64
  ...
  %10 = load ptr, ptr %ref.i.i73, align 8
...
if.else.i.i75:                                    ; preds = %if.then.i.i72
  ...
  %11 = load ptr, ptr %data.i.i76, align 8
...
string_assign.exit79:                             ; preds = %for.cond.i.i64, %if.else.i.i75, %if.then6.i.i78
  %12 = load i32, ptr %host, align 8
  %inc.i68 = add nsw i32 %12, 1
  store i32 %inc.i68, ptr %host, align 8
...
for.cond.i.i82:                                   ; preds = %isTLD.exit, %if.then.i.i88
  ...
  %15 = load i32, ptr %str.addr.0.i.i83, align 8
  %dec.i.i84 = add nsw i32 %15, -1
  store i32 %dec.i.i84, ptr %str.addr.0.i.i83, align 8
...
if.then.i.i88:                                    ; preds = %for.cond.i.i82
  ...
  %16 = load ptr, ptr %ref.i.i89, align 8
...
if.else.i.i91:                                    ; preds = %if.then.i.i88
  ...
  %17 = load ptr, ptr %data.i.i92, align 8
...
string_assign_ref.exit:                           ; preds = %for.cond.i.i82, %if.else.i.i91, %if.then6.i.i94
  %18 = load i32, ptr %host, align 8
  %inc.i86 = add nsw i32 %18, 1
  store i32 %inc.i86, ptr %host, align 8
  br label %cleanup35
...
land.rhs.i100:                                    ; preds = %for.inc.i103, %land.rhs.preheader.i98
  ...
  %21 = load i8, ptr %p.015.i101, align 1
...
for.inc.i103:                                     ; preds = %land.rhs.i100
  ...
  br i1 %cmp1.not.i105, label %for.cond.i.i108.preheader, label %land.rhs.i100
...
for.cond.i.i108:                                  ; preds = %for.cond.i.i108.preheader, %if.then.i.i116
  ...
  %22 = load i32, ptr %str.addr.0.i.i109, align 8
  %dec.i.i110 = add nsw i32 %22, -1
  store i32 %dec.i.i110, ptr %str.addr.0.i.i109, align 8
...
if.then.i.i116:                                   ; preds = %for.cond.i.i108
  ...
  %23 = load ptr, ptr %ref.i.i117, align 8
...
if.else.i.i119:                                   ; preds = %if.then.i.i116
  ...
  %24 = load ptr, ptr %data.i.i120, align 8
...
string_assign.exit123:                            ; preds = %for.cond.i.i108, %if.else.i.i119, %if.then6.i.i122
  ...
  %26 = load i32, ptr %host, align 8
  %inc.i112 = add nsw i32 %26, 1
  store i32 %inc.i112, ptr %host, align 8
  br label %cleanup35
...
for.cond.i.i124:                                  ; preds = %if.then.i.i131, %if.end33
  ...
  %27 = load i32, ptr %str.addr.0.i.i125, align 8
  %dec.i.i126 = add nsw i32 %27, -1
  store i32 %dec.i.i126, ptr %str.addr.0.i.i125, align 8
...
if.then.i.i131:                                   ; preds = %for.cond.i.i124
  ...
  %28 = load ptr, ptr %ref.i.i132, align 8
...
if.else.i.i134:                                   ; preds = %if.then.i.i131
  ...
  %29 = load ptr, ptr %data.i.i135, align 8
...
string_assign_ref.exit138:                        ; preds = %for.cond.i.i124, %if.else.i.i134, %if.then6.i.i137
  %30 = load i32, ptr %host, align 8
  %inc.i128 = add nsw i32 %30, 1
  store i32 %inc.i128, ptr %host, align 8
  br label %cleanup35
...
cleanup35:                                        ; preds = %string_assign_ref.exit, %string_assign.exit79, %string_assign_ref.exit138, %string_assign.exit123, %string_assign.exit
  ...
  store ptr %add.ptr13.sink, ptr %data1.i87, align 8
  store i32 1, ptr %dest, align 8
  %ref3.i = getelementptr inbounds %struct.string, ptr %dest, i64 0, i32 1
  store ptr %host, ptr %ref3.i, align 8
  ret void
}
