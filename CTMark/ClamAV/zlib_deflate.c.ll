...
if.end67:                                         ; preds = %lor.lhs.false61
  ...
  %7 = load ptr, ptr %opaque73, align 8
...
if.end77:                                         ; preds = %if.end67
  ...
  store i32 %wrap.0, ptr %wrap79, align 8
  ...
  store i32 %spec.store.select154, ptr %w_bits, align 4
  ...
  store i32 %sub82, ptr %w_mask, align 8
  ...
  %10 = load ptr, ptr %opaque73, align 8
  ...
  store ptr %call93, ptr %window, align 8
  %11 = load ptr, ptr %zalloc, align 8
  %12 = load ptr, ptr %opaque73, align 8
  ...
  store ptr %call97, ptr %prev, align 8
  %14 = load ptr, ptr %zalloc, align 8
  %15 = load ptr, ptr %opaque73, align 8
  ...
  store i32 %shl103, ptr %lit_bufsize, align 8
  %17 = load ptr, ptr %zalloc, align 8
  %18 = load ptr, ptr %opaque73, align 8
  ...
  store ptr %call107, ptr %pending_buf, align 8
...
if.then4:                                         ; preds = %if.end
  ...
  %.pre65.pre67.pre69.pre = load ptr, ptr %zfree.i, align 8
  br label %if.end7
...
if.then10:                                        ; preds = %if.end7
  ...
  %.pre62 = load ptr, ptr %state.i, align 8
  %.pre65.pre67.pre = load ptr, ptr %zfree.i, align 8
  br label %if.end15
...
if.then18:                                        ; preds = %if.end15
  ...
  %.pre63 = load ptr, ptr %state.i, align 8
  %.pre65.pre = load ptr, ptr %zfree.i, align 8
  br label %if.end23
...
if.then26:                                        ; preds = %if.end23
  ...
  %.pre64 = load ptr, ptr %zfree.i, align 8
  %.pre66 = load ptr, ptr %state.i, align 8
  br label %if.end31
...
if.then:                                          ; preds = %entry
  ...
  %5 = load i16, ptr %max_lazy.i, align 2
  ...
  %6 = load i16, ptr %arrayidx11.i, align 16
  ...
  %7 = load i16, ptr %nice_length.i, align 4
  ...
  %8 = load i16, ptr %max_chain.i, align 2
...
lor.lhs.false6.thread:                            ; preds = %if.end
  ...
  %7 = load i32, ptr %lookahead143, align 4
...
if.end14.thread:                                  ; preds = %lor.lhs.false6
  ...
  %10 = load i32, ptr %w_size152, align 8
...
if.end27:                                         ; preds = %if.end14.thread, %if.end23, %if.end14
  ...
  %16 = load i32, ptr %lookahead145147155, align 4
...
while.body:                                       ; preds = %while.body.lr.ph, %do.end
  ...
  %18 = load i32, ptr %strstart33, align 4
  %sub35 = add i32 %17, -2
  %19 = load i32, ptr %hash_shift, align 8
  %20 = load ptr, ptr %window, align 8
  %21 = load i32, ptr %hash_mask, align 4
  %22 = load ptr, ptr %head41, align 8
  %23 = load ptr, ptr %prev, align 8
  %24 = load i32, ptr %w_mask, align 8
  %ins_h.promoted = load i32, ptr %ins_h, align 8
  br label %do.body
...
do.body:                                          ; preds = %do.body, %while.body
  ...
  store i16 %26, ptr %arrayidx47, align 2
  %conv48 = trunc i32 %str.0 to i16
  store i16 %conv48, ptr %arrayidx44, align 2
  %inc = add i32 %str.0, 1
  %dec = add i32 %n.0, -1
  %tobool53.not = icmp eq i32 %dec, 0
  br i1 %tobool53.not, label %do.end, label %do.body

do.end:                                           ; preds = %do.body
  store i32 %inc, ptr %strstart33, align 4
  store i32 2, ptr %lookahead145147155, align 4
  tail call fastcc void @fill_window(ptr noundef nonnull %2)
  %27 = load i32, ptr %lookahead145147155, align 4
...
while.end:                                        ; preds = %do.end, %if.end27
  ...
  store i32 %14, ptr %avail_in, align 8
...
vector.body245:                                   ; preds = %vector.body245, %vector.ph236
  ...
  %wide.load248 = load <8 x i16>, ptr %gep, align 2
  ...
  store <8 x i16> %reverse252, ptr %gep, align 2
  %index.next253 = add nuw i64 %index246, 8
  %23 = icmp eq i64 %index.next253, %n.vec238
  br i1 %23, label %middle.block233, label %vector.body245
...
do.body.i:                                        ; preds = %do.body.i.preheader, %do.body.i
  ...
  %24 = load i16, ptr %incdec.ptr.i, align 2
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <8 x i16>, ptr %gep255, align 2
  ...
  store <8 x i16> %reverse232, ptr %gep255, align 2
...
do.body5.i:                                       ; preds = %do.body5.i.preheader, %do.body5.i
  ...
  %35 = load i16, ptr %incdec.ptr6.i, align 2
  ...
  br i1 %tobool18.not.i, label %slide_hash.exit, label %do.body5.i
...
if.end3.i:                                        ; preds = %if.end20
  ...
  %44 = load i32, ptr %wrap.i, align 8
...
if.then7.i:                                       ; preds = %if.end3.i
  ...
  %45 = load i64, ptr %adler.i, align 8
...
if.then13.i:                                      ; preds = %if.end3.i
  ...
  %46 = load i64, ptr %adler14.i, align 8
...
read_buf.exit:                                    ; preds = %if.end20, %if.end18.i
  ...
  store i32 %add30, ptr %lookahead, align 4
  %50 = load i32, ptr %insert, align 4
...
if.then35:                                        ; preds = %read_buf.exit
  ...
  store i32 %conv40, ptr %ins_h, align 8
...
land.rhs:                                         ; preds = %do.cond
  ...
  %65 = load i32, ptr %avail_in86, align 8
  %cmp87.not = icmp eq i32 %65, 0
  br i1 %cmp87.not, label %do.end, label %do.body
...
if.then118:                                       ; preds = %if.else
  ...
  %72 = load i64, ptr %high_water, align 8
...
if.end141.sink.split:                             ; preds = %if.then118, %if.then101
  ...
  store i64 %add112.sink, ptr %high_water, align 8
  br label %if.end141
...
if.end4:                                          ; preds = %if.then1, %if.end
  ...
  store i32 %cond9, ptr %status.i, align 8
...
cond.end16:                                       ; preds = %cond.false14, %cond.true12
  ...
  %adler = getelementptr inbounds %struct.z_stream_s, ptr %strm, i64 0, i32 12
  store i64 %cond17, ptr %adler, align 8
...
if.then6:                                         ; preds = %if.end3
  ...
  %6 = load i32, ptr %bi_valid, align 4
...
do.body:                                          ; preds = %do.body.preheader, %do.body
  ...
  %conv11 = or i16 %8, %9
  store i16 %conv11, ptr %bi_buf, align 8
  ...
  br i1 %tobool14.not, label %cleanup, label %do.body
...
land.lhs.true:                                    ; preds = %lor.lhs.false15, %if.end10
  ...
  %10 = load i64, ptr %high_water, align 8
...
if.end29:                                         ; preds = %cleanup, %land.lhs.true, %lor.lhs.false15
  %12 = load i32, ptr %level11, align 4
...
land.lhs.true35:                                  ; preds = %if.then32
  ...
  %13 = load i32, ptr %matches, align 8
...
if.then40:                                        ; preds = %land.lhs.true35
  ...
  %.pre = load ptr, ptr %head44.phi.trans.insert, align 8
  %hash_size45.phi.trans.insert = getelementptr inbounds %struct.internal_state, ptr %2, i64 0, i32 19
  %.pre108 = load i32, ptr %hash_size45.phi.trans.insert, align 4
...
if.end48:                                         ; preds = %land.lhs.true35, %if.end43, %if.then32
  ...
  store i32 %conv61, ptr %max_chain_length, align 4
  br label %if.end62
...
if.end6.i:                                        ; preds = %if.then19
  ...
  %20 = load i64, ptr %total_out.i, align 8
  %add.i = add i64 %20, %conv7.i
  store i64 %add.i, ptr %total_out.i, align 8
  %21 = load i32, ptr %avail_out, align 8
  ...
  store i64 %sub16.i, ptr %pending, align 8
...
if.then20.i:                                      ; preds = %if.end6.i
  ...
  %23 = load ptr, ptr %pending_buf.i, align 8
  store ptr %23, ptr %pending_out.i, align 8
...
if.then36:                                        ; preds = %land.lhs.true27
  %26 = load ptr, ptr getelementptr inbounds ([10 x ptr], ptr @z_errmsg, i64 0, i64 7), align 8
  %msg37 = getelementptr inbounds %struct.z_stream_s, ptr %strm, i64 0, i32 6
  store ptr %26, ptr %msg37, align 8
  br label %cleanup805
...
if.then78:                                        ; preds = %if.end68
  %adler = getelementptr inbounds %struct.z_stream_s, ptr %strm, i64 0, i32 12
  %41 = load i64, ptr %adler, align 8
  %shr = lshr i64 %41, 16
  %shr.i11681277 = lshr i64 %41, 24
  %conv.i1169 = trunc i64 %shr.i11681277 to i8
  %42 = load ptr, ptr %pending_buf.i1166, align 8
  %43 = load i64, ptr %pending, align 8
  %inc.i1172 = add i64 %43, 1
  store i64 %inc.i1172, ptr %pending, align 8
  %arrayidx.i1173 = getelementptr inbounds i8, ptr %42, i64 %43
  store i8 %conv.i1169, ptr %arrayidx.i1173, align 1
  %conv1.i1174 = trunc i64 %shr to i8
  %44 = load ptr, ptr %pending_buf.i1166, align 8
  %45 = load i64, ptr %pending, align 8
  %inc4.i1175 = add i64 %45, 1
  store i64 %inc4.i1175, ptr %pending, align 8
  %arrayidx5.i1176 = getelementptr inbounds i8, ptr %44, i64 %45
  store i8 %conv1.i1174, ptr %arrayidx5.i1176, align 1
  %46 = load i64, ptr %adler, align 8
  %47 = trunc i64 %46 to i8
  %shr.i11771278 = lshr i64 %46, 8
  %conv.i1178 = trunc i64 %shr.i11771278 to i8
  %48 = load ptr, ptr %pending_buf.i1166, align 8
  %49 = load i64, ptr %pending, align 8
  %inc.i1181 = add i64 %49, 1
  store i64 %inc.i1181, ptr %pending, align 8
  %arrayidx.i1182 = getelementptr inbounds i8, ptr %48, i64 %49
  store i8 %conv.i1178, ptr %arrayidx.i1182, align 1
  %50 = load ptr, ptr %pending_buf.i1166, align 8
  %51 = load i64, ptr %pending, align 8
  %inc4.i1184 = add i64 %51, 1
  store i64 %inc4.i1184, ptr %pending, align 8
  %arrayidx5.i1185 = getelementptr inbounds i8, ptr %50, i64 %51
  store i8 %47, ptr %arrayidx5.i1185, align 1
  br label %if.end81
...
if.end81:                                         ; preds = %if.then78, %if.end68
  ...
  store i64 %call82, ptr %adler83, align 8
...
if.end81.if.end92thread-pre-split_crit_edge:      ; preds = %if.end81
  %.pr1268.pre = load i32, ptr %status.i, align 8
  br label %if.end92
...
if.then96:                                        ; preds = %if.end92
  ...
  store i64 %call97, ptr %adler98, align 8
  %pending_buf = getelementptr inbounds %struct.internal_state, ptr %2, i64 0, i32 2
...
if.then110:                                       ; preds = %if.then96
  ...
  %inc113 = add i64 %62, 1
  store i64 %inc113, ptr %pending, align 8
  ...
  %inc117 = add i64 %64, 1
  store i64 %inc117, ptr %pending, align 8
  ...
  %inc121 = add i64 %66, 1
  store i64 %inc121, ptr %pending, align 8
  ...
  %inc125 = add i64 %68, 1
  store i64 %inc125, ptr %pending, align 8
  ...
  %inc129 = add i64 %70, 1
  store i64 %inc129, ptr %pending, align 8
  ...
  %71 = load i32, ptr %level131, align 4
...
cond.false:                                       ; preds = %if.then110
  ...
  %72 = load i32, ptr %strategy134, align 8
...
cond.end.if.end283_crit_edge:                     ; preds = %cond.end
  %.pr1269.pre = load i32, ptr %status.i, align 8
  br label %if.end283
...
if.else158:                                       ; preds = %if.then96
  ...
  %inc184 = add i64 %84, 1
  store i64 %inc184, ptr %pending, align 8
  %arrayidx185 = getelementptr inbounds i8, ptr %83, i64 %84
  store i8 %add180, ptr %arrayidx185, align 1
  ...
  %98 = load i64, ptr %time212, align 8
...
cond.false224:                                    ; preds = %if.else158
  ...
  %102 = load i32, ptr %strategy225, align 8
...
cond.end234:                                      ; preds = %if.else158, %cond.false224
  ...
  store i64 %inc239, ptr %pending, align 8
  %arrayidx240 = getelementptr inbounds i8, ptr %103, i64 %104
  store i8 %cond235, ptr %arrayidx240, align 1
...
if.then252:                                       ; preds = %cond.end234
  ...
  store i64 %inc267, ptr %pending, align 8
  %arrayidx268 = getelementptr inbounds i8, ptr %116, i64 %117
  store i8 %conv264, ptr %arrayidx268, align 1
  %.pre1295 = load ptr, ptr %gzhead, align 8
  br label %if.end269
...
if.then273:                                       ; preds = %if.end269
  ...
  store i64 %call278, ptr %adler98, align 8
...
while.body.lr.ph:                                 ; preds = %if.then292
  ...
  %130 = load ptr, ptr %pending_buf310, align 8
  ...
  store i64 %131, ptr %pending, align 8
  %132 = load ptr, ptr %gzhead288, align 8
  %hcrc320.peel = getelementptr inbounds %struct.gz_header_s, ptr %132, i64 0, i32 11
  %133 = load i32, ptr %hcrc320.peel, align 4
...
if.then326.peel:                                  ; preds = %while.body.lr.ph
  %134 = load i64, ptr %adler327, align 8
  %135 = load ptr, ptr %pending_buf310, align 8
  ...
  store i64 %call333.peel, ptr %adler327, align 8
  br label %do.end.peel

do.end.peel:                                      ; preds = %if.then326.peel, %while.body.lr.ph
  %136 = load i64, ptr %gzindex298, align 8
  %add338.peel = add i64 %136, %conv316.peel
  store i64 %add338.peel, ptr %gzindex298, align 8
  %137 = load ptr, ptr %state.i, align 8
  ...
  %138 = load i64, ptr %pending.i1187.peel, align 8
...
if.end6.i1192.peel:                               ; preds = %do.end.peel
  ...
  store ptr %add.ptr.i1196.peel, ptr %next_out, align 8
  %143 = load ptr, ptr %pending_out.i1194.peel, align 8
  %add.ptr11.i1197.peel = getelementptr inbounds i8, ptr %143, i64 %conv7.i1195.peel
  store ptr %add.ptr11.i1197.peel, ptr %pending_out.i1194.peel, align 8
  %144 = load i64, ptr %total_out.i1198, align 8
  %add.i1199.peel = add i64 %144, %conv7.i1195.peel
  store i64 %add.i1199.peel, ptr %total_out.i1198, align 8
  %145 = load i32, ptr %avail_out, align 8
  %sub.i1200.peel = sub i32 %145, %spec.select.i1190.peel
  store i32 %sub.i1200.peel, ptr %avail_out, align 8
  %146 = load i64, ptr %pending.i1187.peel, align 8
  %sub16.i1201.peel = sub i64 %146, %conv7.i1195.peel
  store i64 %sub16.i1201.peel, ptr %pending.i1187.peel, align 8
...
if.then20.i1203.peel:                             ; preds = %if.end6.i1192.peel
  ...
  %147 = load ptr, ptr %pending_buf.i1204.peel, align 8
  store ptr %147, ptr %pending_out.i1194.peel, align 8
...
flush_pending.exit1205.peel:                      ; preds = %if.then20.i1203.peel, %if.end6.i1192.peel, %do.end.peel
  %148 = load i64, ptr %pending, align 8
...
while.cond.peel:                                  ; preds = %flush_pending.exit1205.peel
  ...
  %149 = load i64, ptr %pending_buf_size, align 8
...
while.cond:                                       ; preds = %flush_pending.exit1205
  ...
  %150 = load i64, ptr %pending_buf_size, align 8
  %cmp304.not = icmp ult i64 %150, %conv302
  br i1 %cmp304.not, label %while.body, label %while.end.loopexit
...
while.body:                                       ; preds = %while.cond.peel, %while.cond
  ...
  %152 = load ptr, ptr %pending_buf310, align 8
  %153 = load ptr, ptr %gzhead288, align 8
  %extra313 = getelementptr inbounds %struct.gz_header_s, ptr %153, i64 0, i32 4
  %154 = load ptr, ptr %extra313, align 8
  %155 = load i64, ptr %gzindex298, align 8
  ...
  %156 = load i64, ptr %pending_buf_size, align 8
  store i64 %156, ptr %pending, align 8
  %157 = load ptr, ptr %gzhead288, align 8
  %hcrc320 = getelementptr inbounds %struct.gz_header_s, ptr %157, i64 0, i32 11
  %158 = load i32, ptr %hcrc320, align 4
...
if.then326:                                       ; preds = %while.body
  %159 = load i64, ptr %adler327, align 8
  %160 = load ptr, ptr %pending_buf310, align 8
  %conv332 = trunc i64 %156 to i32
  %call333 = tail call i64 @crc32(i64 noundef %159, ptr noundef %160, i32 noundef %conv332) #11
  store i64 %call333, ptr %adler327, align 8
  br label %do.end

do.end:                                           ; preds = %if.then326, %while.body
  %161 = load i64, ptr %gzindex298, align 8
  %add338 = add i64 %161, %conv316
  store i64 %add338, ptr %gzindex298, align 8
  ...
  %163 = load i64, ptr %pending.i1187, align 8
  %conv.i1188 = trunc i64 %163 to i32
  %164 = load i32, ptr %avail_out, align 8
...
if.end6.i1192:                                    ; preds = %do.end
  ...
  %167 = load ptr, ptr %next_out, align 8
  %add.ptr.i1196 = getelementptr inbounds i8, ptr %167, i64 %conv7.i1195
  store ptr %add.ptr.i1196, ptr %next_out, align 8
  %168 = load ptr, ptr %pending_out.i1194, align 8
  %add.ptr11.i1197 = getelementptr inbounds i8, ptr %168, i64 %conv7.i1195
  store ptr %add.ptr11.i1197, ptr %pending_out.i1194, align 8
  %169 = load i64, ptr %total_out.i1198, align 8
  %add.i1199 = add i64 %169, %conv7.i1195
  store i64 %add.i1199, ptr %total_out.i1198, align 8
  %170 = load i32, ptr %avail_out, align 8
  %sub.i1200 = sub i32 %170, %spec.select.i1190
  store i32 %sub.i1200, ptr %avail_out, align 8
  %171 = load i64, ptr %pending.i1187, align 8
  %sub16.i1201 = sub i64 %171, %conv7.i1195
  store i64 %sub16.i1201, ptr %pending.i1187, align 8
...
if.then20.i1203:                                  ; preds = %if.end6.i1192
  ...
  %172 = load ptr, ptr %pending_buf.i1204, align 8
  store ptr %172, ptr %pending_out.i1194, align 8
  br label %flush_pending.exit1205

flush_pending.exit1205:                           ; preds = %do.end, %if.end6.i1192, %if.then20.i1203
  %173 = load i64, ptr %pending, align 8
...
while.end.loopexit:                               ; preds = %while.cond, %while.cond.peel
  ...
  %.pre1297 = load ptr, ptr %gzhead288, align 8
  %extra353.phi.trans.insert = getelementptr inbounds %struct.gz_header_s, ptr %.pre1297, i64 0, i32 4
  %.pre1298 = load ptr, ptr %extra353.phi.trans.insert, align 8
  %.pre1299 = load i64, ptr %gzindex298, align 8
  br label %while.end
...
while.end:                                        ; preds = %while.end.loopexit, %if.then292
  ...
  %176 = load ptr, ptr %pending_buf349, align 8
  ...
  %177 = load i64, ptr %pending, align 8
  %add359 = add i64 %177, %conv302.lcssa
  store i64 %add359, ptr %pending, align 8
  %178 = load ptr, ptr %gzhead288, align 8
  %hcrc362 = getelementptr inbounds %struct.gz_header_s, ptr %178, i64 0, i32 11
  %179 = load i32, ptr %hcrc362, align 4
...
if.then368:                                       ; preds = %while.end
  ...
  %180 = load i64, ptr %adler369, align 8
  %181 = load ptr, ptr %pending_buf349, align 8
  ...
  store i64 %call375, ptr %adler369, align 8
  br label %cleanup381

cleanup381:                                       ; preds = %while.end, %if.then368
  store i64 0, ptr %gzindex298, align 8
...
do.body399:                                       ; preds = %if.end431, %if.then396
  ...
  %185 = load i64, ptr %pending, align 8
  %186 = load i64, ptr %pending_buf_size401, align 8
  %cmp402 = icmp eq i64 %185, %186
  %.pre1301 = load ptr, ptr %gzhead392, align 8
...
do.body405:                                       ; preds = %do.body399
  ...
  %187 = load i32, ptr %hcrc407, align 4
...
if.then413:                                       ; preds = %do.body405
  %188 = load i64, ptr %adler414, align 8
  %189 = load ptr, ptr %pending_buf415, align 8
  ...
  store i64 %call420, ptr %adler414, align 8
  br label %do.end424

do.end424:                                        ; preds = %if.then413, %do.body405
  %190 = load ptr, ptr %state.i, align 8
  ...
  %191 = load i64, ptr %pending.i1207, align 8
...
if.end6.i1212:                                    ; preds = %do.end424
  ...
  %195 = load ptr, ptr %next_out, align 8
  %add.ptr.i1216 = getelementptr inbounds i8, ptr %195, i64 %conv7.i1215
  store ptr %add.ptr.i1216, ptr %next_out, align 8
  %196 = load ptr, ptr %pending_out.i1214, align 8
  %add.ptr11.i1217 = getelementptr inbounds i8, ptr %196, i64 %conv7.i1215
  store ptr %add.ptr11.i1217, ptr %pending_out.i1214, align 8
  %197 = load i64, ptr %total_out.i1218, align 8
  %add.i1219 = add i64 %197, %conv7.i1215
  store i64 %add.i1219, ptr %total_out.i1218, align 8
  %198 = load i32, ptr %avail_out, align 8
  %sub.i1220 = sub i32 %198, %spec.select.i1210
  store i32 %sub.i1220, ptr %avail_out, align 8
  %199 = load i64, ptr %pending.i1207, align 8
  %sub16.i1221 = sub i64 %199, %conv7.i1215
  store i64 %sub16.i1221, ptr %pending.i1207, align 8
...
if.then20.i1223:                                  ; preds = %if.end6.i1212
  ...
  %200 = load ptr, ptr %pending_buf.i1224, align 8
  store ptr %200, ptr %pending_out.i1214, align 8
  br label %flush_pending.exit1225

flush_pending.exit1225:                           ; preds = %do.end424, %if.end6.i1212, %if.then20.i1223
  %201 = load i64, ptr %pending, align 8
...
flush_pending.exit1225.if.end431_crit_edge:       ; preds = %flush_pending.exit1225
  %.pre1300 = load ptr, ptr %gzhead392, align 8
  br label %if.end431
...
if.end431:                                        ; preds = %flush_pending.exit1225.if.end431_crit_edge, %do.body399
  ...
  %204 = load ptr, ptr %name433, align 8
  %205 = load i64, ptr %gzindex434, align 8
  %inc435 = add i64 %205, 1
  store i64 %inc435, ptr %gzindex434, align 8
  %arrayidx436 = getelementptr inbounds i8, ptr %204, i64 %205
  %206 = load i8, ptr %arrayidx436, align 1
  %207 = load ptr, ptr %pending_buf415, align 8
  %inc441 = add i64 %202, 1
  store i64 %inc441, ptr %pending, align 8
  %arrayidx442 = getelementptr inbounds i8, ptr %207, i64 %202
  store i8 %206, ptr %arrayidx442, align 1
  %cmp444.not = icmp eq i8 %206, 0
  br i1 %cmp444.not, label %do.body447, label %do.body399

do.body447:                                       ; preds = %if.end431
  %208 = load ptr, ptr %gzhead392, align 8
  %hcrc449 = getelementptr inbounds %struct.gz_header_s, ptr %208, i64 0, i32 11
  %209 = load i32, ptr %hcrc449, align 4
...
if.then455:                                       ; preds = %land.lhs.true451
  ...
  store i64 %call462, ptr %adler414, align 8
  br label %do.end466

do.end466:                                        ; preds = %if.then455, %land.lhs.true451, %do.body447
  store i64 0, ptr %gzindex434, align 8
...
do.body487:                                       ; preds = %if.end519, %if.then483
  ...
  %216 = load i64, ptr %pending, align 8
  %217 = load i64, ptr %pending_buf_size489, align 8
  %cmp490 = icmp eq i64 %216, %217
  %.pre1303 = load ptr, ptr %gzhead479, align 8
...
do.body493:                                       ; preds = %do.body487
  ...
  %218 = load i32, ptr %hcrc495, align 4
...
if.then501:                                       ; preds = %do.body493
  %219 = load i64, ptr %adler502, align 8
  %220 = load ptr, ptr %pending_buf503, align 8
  ...
  store i64 %call508, ptr %adler502, align 8
  br label %do.end512
...
do.end512:                                        ; preds = %if.then501, %do.body493
  ...
  %222 = load i64, ptr %pending.i1227, align 8
...
if.end6.i1232:                                    ; preds = %do.end512
  ...
  %225 = load ptr, ptr %pending_out.i1234, align 8
  ...
  store ptr %add.ptr.i1236, ptr %next_out, align 8
  %227 = load ptr, ptr %pending_out.i1234, align 8
  %add.ptr11.i1237 = getelementptr inbounds i8, ptr %227, i64 %conv7.i1235
  store ptr %add.ptr11.i1237, ptr %pending_out.i1234, align 8
  %228 = load i64, ptr %total_out.i1238, align 8
  %add.i1239 = add i64 %228, %conv7.i1235
  store i64 %add.i1239, ptr %total_out.i1238, align 8
  %229 = load i32, ptr %avail_out, align 8
  %sub.i1240 = sub i32 %229, %spec.select.i1230
  store i32 %sub.i1240, ptr %avail_out, align 8
  %230 = load i64, ptr %pending.i1227, align 8
  %sub16.i1241 = sub i64 %230, %conv7.i1235
  store i64 %sub16.i1241, ptr %pending.i1227, align 8
...
if.then20.i1243:                                  ; preds = %if.end6.i1232
  ...
  %231 = load ptr, ptr %pending_buf.i1244, align 8
  store ptr %231, ptr %pending_out.i1234, align 8
  br label %flush_pending.exit1245

flush_pending.exit1245:                           ; preds = %do.end512, %if.end6.i1232, %if.then20.i1243
  %232 = load i64, ptr %pending, align 8
...
flush_pending.exit1245.if.end519_crit_edge:       ; preds = %flush_pending.exit1245
  %.pre1302 = load ptr, ptr %gzhead479, align 8
  br label %if.end519
...
if.end519:                                        ; preds = %flush_pending.exit1245.if.end519_crit_edge, %do.body487
  ...
  %235 = load ptr, ptr %comment521, align 8
  %236 = load i64, ptr %gzindex522, align 8
  %inc523 = add i64 %236, 1
  store i64 %inc523, ptr %gzindex522, align 8
  %arrayidx524 = getelementptr inbounds i8, ptr %235, i64 %236
  %237 = load i8, ptr %arrayidx524, align 1
  %238 = load ptr, ptr %pending_buf503, align 8
  %inc529 = add i64 %233, 1
  store i64 %inc529, ptr %pending, align 8
  %arrayidx530 = getelementptr inbounds i8, ptr %238, i64 %233
  store i8 %237, ptr %arrayidx530, align 1
  %cmp532.not = icmp eq i8 %237, 0
  br i1 %cmp532.not, label %do.body535, label %do.body487

do.body535:                                       ; preds = %if.end519
  %239 = load ptr, ptr %gzhead479, align 8
  %hcrc537 = getelementptr inbounds %struct.gz_header_s, ptr %239, i64 0, i32 11
  %240 = load i32, ptr %hcrc537, align 4
...
if.then543:                                       ; preds = %land.lhs.true539
  ...
  store i64 %call550, ptr %adler502, align 8
...
lor.lhs.false612:                                 ; preds = %land.lhs.true42, %if.end608
  %lookahead = getelementptr inbounds %struct.internal_state, ptr %2, i64 0, i32 29
  %256 = load i32, ptr %lookahead, align 4
...
land.lhs.true618:                                 ; preds = %lor.lhs.false615
  %257 = load i32, ptr %status.i, align 8
...
if.then622:                                       ; preds = %land.lhs.true618, %lor.lhs.false612, %if.end608
  ...
  %258 = load i32, ptr %level623, align 4
...
cond.false628:                                    ; preds = %if.then622
  ...
  %259 = load i32, ptr %strategy629, align 8
...
if.then663:                                       ; preds = %if.end657
  %263 = load i32, ptr %avail_out, align 8
...
if.then683:                                       ; preds = %if.then680
  ...
  %266 = load i32, ptr %lookahead692, align 4
...
if.then695:                                       ; preds = %if.then683
  ...
  store i32 0, ptr %strstart696, align 4
  %block_start = getelementptr inbounds %struct.internal_state, ptr %2, i64 0, i32 23
  store i64 0, ptr %block_start, align 8
  %insert = getelementptr inbounds %struct.internal_state, ptr %2, i64 0, i32 55
  store i32 0, ptr %insert, align 4
...
if.end700:                                        ; preds = %if.then673, %if.then683, %if.then695, %if.then680, %if.then676
  tail call fastcc void @flush_pending(ptr noundef nonnull %strm)
  %267 = load i32, ptr %avail_out, align 8
...
if.end719:                                        ; preds = %if.end715
  ...
  %269 = load i64, ptr %adler724, align 8
...
if.else785:                                       ; preds = %if.end719
  ...
  %293 = load ptr, ptr %pending_buf.i1248, align 8
  %294 = load i64, ptr %pending, align 8
  %inc.i1250 = add i64 %294, 1
  store i64 %inc.i1250, ptr %pending, align 8
  %arrayidx.i1251 = getelementptr inbounds i8, ptr %293, i64 %294
  store i8 %conv.i1247, ptr %arrayidx.i1251, align 1
  %conv1.i1252 = trunc i64 %shr787 to i8
  %295 = load ptr, ptr %pending_buf.i1248, align 8
  %296 = load i64, ptr %pending, align 8
  %inc4.i1253 = add i64 %296, 1
  store i64 %inc4.i1253, ptr %pending, align 8
  %arrayidx5.i1254 = getelementptr inbounds i8, ptr %295, i64 %296
  store i8 %conv1.i1252, ptr %arrayidx5.i1254, align 1
  %297 = load i64, ptr %adler724, align 8
  %298 = trunc i64 %297 to i8
  %shr.i12551280 = lshr i64 %297, 8
  %conv.i1256 = trunc i64 %shr.i12551280 to i8
  %299 = load ptr, ptr %pending_buf.i1248, align 8
  %300 = load i64, ptr %pending, align 8
  %inc.i1259 = add i64 %300, 1
  store i64 %inc.i1259, ptr %pending, align 8
  %arrayidx.i1260 = getelementptr inbounds i8, ptr %299, i64 %300
  store i8 %conv.i1256, ptr %arrayidx.i1260, align 1
  %301 = load ptr, ptr %pending_buf.i1248, align 8
  %302 = load i64, ptr %pending, align 8
  %inc4.i1262 = add i64 %302, 1
  store i64 %inc4.i1262, ptr %pending, align 8
  %arrayidx5.i1263 = getelementptr inbounds i8, ptr %301, i64 %302
  store i8 %298, ptr %arrayidx5.i1263, align 1
  br label %if.end792

if.end792:                                        ; preds = %if.else785, %if.then723
  tail call fastcc void @flush_pending(ptr noundef nonnull %strm)
  %303 = load i32, ptr %wrap, align 8
  %cmp794 = icmp sgt i32 %303, 0
  br i1 %cmp794, label %if.then796, label %if.end800

if.then796:                                       ; preds = %if.end792
  %sub798 = sub nsw i32 0, %303
  store i32 %sub798, ptr %wrap, align 8
  br label %if.end800

if.end800:                                        ; preds = %if.then796, %if.end792
  %304 = load i64, ptr %pending, align 8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <8 x i16> %reverse38, ptr %gep, align 2
  %index.next = add nuw i64 %index, 8
...
vector.body51:                                    ; preds = %vector.body51, %vector.ph42
  ...
  %wide.load54 = load <8 x i16>, ptr %gep61, align 2
  ...
  store <8 x i16> %reverse58, ptr %gep61, align 2
  %index.next59 = add nuw i64 %index52, 8
  %22 = icmp eq i64 %index.next59, %n.vec44
  br i1 %22, label %middle.block39, label %vector.body51
...
do.body5:                                         ; preds = %do.body5.preheader, %do.body5
  ...
  %23 = load i16, ptr %incdec.ptr6, align 2
  ...
  br i1 %tobool18.not, label %do.end19, label %do.body5
...
do.body:                                          ; preds = %if.end21, %do.body
  ...
  br i1 %tobool26.not, label %if.end27, label %do.body
...
do.body32:                                        ; preds = %if.end27, %do.body32
  ...
  br i1 %tobool36.not, label %if.end38, label %do.body32
...
if.then79:                                        ; preds = %flush_pending.exit
  ...
  %32 = load ptr, ptr %next_out, align 8
  %33 = load ptr, ptr %window, align 8
  %34 = load i64, ptr %block_start, align 8
  ...
  %36 = load ptr, ptr %next_out88, align 8
  ...
  %37 = load i32, ptr %avail_out91, align 8
...
if.end3.i:                                        ; preds = %if.then102
  ...
  store i32 %sub.i574, ptr %avail_in.i, align 8
...
if.then7.i:                                       ; preds = %if.end3.i
  ...
  %46 = load i64, ptr %adler.i, align 8
...
if.then13.i:                                      ; preds = %if.end3.i
  ...
  %47 = load i64, ptr %adler14.i, align 8
...
read_buf.exit:                                    ; preds = %if.then102, %if.end18.i
  ...
  %52 = load i32, ptr %avail_out111, align 8
  ...
  %53 = load i64, ptr %total_out115, align 8
  %add116 = add i64 %53, %idx.ext108
  store i64 %add116, ptr %total_out115, align 8
  br label %do.cond

do.cond:                                          ; preds = %if.end100, %read_buf.exit
  br i1 %spec.select619, label %do.cond.do.end_crit_edge, label %do.body

do.cond.do.end_crit_edge:                         ; preds = %do.cond
  %.pre622 = load ptr, ptr %s, align 8
  br label %do.end
...
do.end:                                           ; preds = %land.lhs.true, %do.body, %do.cond.do.end_crit_edge
  ...
  %55 = load i32, ptr %avail_in121, align 8
  %sub122 = sub i32 %3, %55
...
do.end.if.end191_crit_edge:                       ; preds = %do.end
  %.pre624 = load i32, ptr %strstart, align 4
...
if.then128:                                       ; preds = %if.then124
  ...
  %59 = load i32, ptr %w_size, align 8
  store i32 %59, ptr %strstart, align 4
  br label %if.end174

if.else:                                          ; preds = %if.then124
  %window_size = getelementptr inbounds %struct.internal_state, ptr %s, i64 0, i32 15
  %60 = load i64, ptr %window_size, align 8
...
if.then144:                                       ; preds = %if.else
  ...
  store i32 %sub147, ptr %strstart, align 4
...
if.end161:                                        ; preds = %if.then144, %if.then158, %if.else
  ...
  store i32 %add173, ptr %strstart, align 4
  %.pre623 = load i32, ptr %w_size, align 8
  br label %if.end174
...
if.end221:                                        ; preds = %if.end203, %if.end203, %land.lhs.true214, %land.lhs.true209
  ...
  %77 = load i64, ptr %window_size222, align 8
...
if.then238:                                       ; preds = %land.lhs.true232
  ...
  store i64 %sub242, ptr %block_start, align 8
  %sub245 = sub i32 %72, %82
  store i32 %sub245, ptr %strstart, align 4
  %83 = load ptr, ptr %window, align 8
  ...
  %84 = load i32, ptr %matches253, align 8
...
if.then256:                                       ; preds = %if.then238
  ...
  store i32 %inc258, ptr %matches253, align 8
  br label %if.end259

if.end259:                                        ; preds = %if.then256, %if.then238
  %85 = load i32, ptr %w_size, align 8
  %add261 = add i32 %85, %conv227
  %.pre625 = load ptr, ptr %s, align 8
  %avail_in264.phi.trans.insert = getelementptr inbounds %struct.z_stream_s, ptr %.pre625, i64 0, i32 1
  %.pre626 = load i32, ptr %avail_in264.phi.trans.insert, align 8
  %.pre627.pre = load i32, ptr %strstart, align 4
  br label %if.end262
...
if.end3.i582:                                     ; preds = %if.end262
  ...
  store i32 %sub.i583, ptr %avail_in264, align 8
...
if.then287:                                       ; preds = %if.end281
  store i64 %conv284, ptr %high_water, align 8
  br label %if.end291

if.end291:                                        ; preds = %if.then287, %if.end281
  %99 = load i32, ptr %bi_valid, align 4
  %add293 = add nsw i32 %99, 42
  %shr294 = ashr i32 %add293, 3
  %100 = load i64, ptr %pending_buf_size, align 8
  ...
  %101 = load i32, ptr %w_size, align 8
  %cond315 = tail call i32 @llvm.umin.i32(i32 %101, i32 %spec.select571)
  %102 = load i64, ptr %block_start, align 8
...
land.lhs.true331:                                 ; preds = %lor.lhs.false323
  ...
  %105 = load i32, ptr %avail_in333, align 8
...
land.lhs.true348:                                 ; preds = %if.then339
  ...
  %107 = load i32, ptr %avail_in350, align 8
...
if.end6.i604:                                     ; preds = %land.end356
  ...
  %117 = load ptr, ptr %next_out.i605, align 8
  %add.ptr.i608 = getelementptr inbounds i8, ptr %117, i64 %conv7.i607
  store ptr %add.ptr.i608, ptr %next_out.i605, align 8
  %118 = load ptr, ptr %pending_out.i606, align 8
  %add.ptr11.i609 = getelementptr inbounds i8, ptr %118, i64 %conv7.i607
  store ptr %add.ptr11.i609, ptr %pending_out.i606, align 8
  %total_out.i610 = getelementptr inbounds %struct.z_stream_s, ptr %111, i64 0, i32 5
  %119 = load i64, ptr %total_out.i610, align 8
  %add.i611 = add i64 %119, %conv7.i607
  store i64 %add.i611, ptr %total_out.i610, align 8
  %120 = load i32, ptr %avail_out.i601, align 8
  %sub.i612 = sub i32 %120, %spec.select.i602
  store i32 %sub.i612, ptr %avail_out.i601, align 8
  %121 = load i64, ptr %pending.i599, align 8
  %sub16.i613 = sub i64 %121, %conv7.i607
  store i64 %sub16.i613, ptr %pending.i599, align 8
...
if.then20.i615:                                   ; preds = %if.end6.i604
  ...
  %122 = load ptr, ptr %pending_buf.i616, align 8
  store ptr %122, ptr %pending_out.i606, align 8
...
cond.end:                                         ; preds = %if.then21, %cond.true
  ...
  store i64 %conv34, ptr %block_start, align 8
...
if.end6.i:                                        ; preds = %cond.end
  ...
  store ptr %add.ptr.i, ptr %next_out.i, align 8
  %23 = load ptr, ptr %pending_out.i, align 8
  ...
  %24 = load i64, ptr %total_out.i, align 8
...
if.then20.i:                                      ; preds = %if.end6.i
  ...
  %27 = load ptr, ptr %pending_buf.i, align 8
  store ptr %27, ptr %pending_out.i, align 8
  br label %flush_pending.exit
...
flush_pending.exit:                               ; preds = %cond.end, %if.end6.i, %if.then20.i
  ...
  %29 = load i32, ptr %avail_out, align 8
...
if.then20.i169:                                   ; preds = %if.end6.i158
  ...
  %45 = load ptr, ptr %pending_buf.i170, align 8
  store ptr %45, ptr %pending_out.i160, align 8
...
if.end6.i178:                                     ; preds = %cond.end85
  ...
  %59 = load ptr, ptr %next_out.i179, align 8
  %add.ptr.i182 = getelementptr inbounds i8, ptr %59, i64 %conv7.i181
  store ptr %add.ptr.i182, ptr %next_out.i179, align 8
  %60 = load ptr, ptr %pending_out.i180, align 8
  %add.ptr11.i183 = getelementptr inbounds i8, ptr %60, i64 %conv7.i181
  store ptr %add.ptr11.i183, ptr %pending_out.i180, align 8
  %total_out.i184 = getelementptr inbounds %struct.z_stream_s, ptr %53, i64 0, i32 5
  %61 = load i64, ptr %total_out.i184, align 8
  %add.i185 = add i64 %61, %conv7.i181
  store i64 %add.i185, ptr %total_out.i184, align 8
  %62 = load i32, ptr %avail_out.i175, align 8
  %sub.i186 = sub i32 %62, %spec.select.i176
  store i32 %sub.i186, ptr %avail_out.i175, align 8
  %63 = load i64, ptr %pending.i173, align 8
  %sub16.i187 = sub i64 %63, %conv7.i181
  store i64 %sub16.i187, ptr %pending.i173, align 8
...
if.then20.i189:                                   ; preds = %if.end6.i178
  ...
  %64 = load ptr, ptr %pending_buf.i190, align 8
  store ptr %64, ptr %pending_out.i180, align 8
...
flush_pending.exit191:                            ; preds = %cond.end85, %if.end6.i178, %if.then20.i189
  ...
  %66 = load i32, ptr %avail_out96, align 8
...
if.end9.thread:                                   ; preds = %for.cond
  store i32 0, ptr %match_length398, align 8
  %.pre434 = load i32, ptr %strstart, align 4
...
if.end9:                                          ; preds = %if.end
  ...
  %.pre435 = load i32, ptr %strstart, align 4
...
land.lhs.true70:                                  ; preds = %land.lhs.true65
  ...
  br i1 %or.cond357, label %do.body, label %if.end88.split.loop.exit
...
if.end88:                                         ; preds = %if.end88.split.loop.exit450, %if.end88.split.loop.exit448, %if.end88.split.loop.exit446, %if.end88.split.loop.exit444, %if.end88.split.loop.exit442, %if.end88.split.loop.exit440, %if.end88.split.loop.exit438, %if.end88.split.loop.exit
  ...
  %.pre433 = load i32, ptr %last_lit137, align 4
...
if.end159.sink.split:                             ; preds = %if.then14, %land.lhs.true20, %land.lhs.true25, %land.lhs.true12, %if.end9
  ...
  %.pre433437 = load i32, ptr %last_lit137, align 4
  br label %if.end159
...
if.end159:                                        ; preds = %if.end159.sink.split, %if.end88
  ...
  %32 = load i8, ptr %arrayidx135, align 1
  %33 = load ptr, ptr %d_buf136, align 8
  ...
  %34 = load ptr, ptr %l_buf140, align 8
  %inc142 = add i32 %29, 1
  ...
  %35 = load i16, ptr %arrayidx147, align 4
  %inc149 = add i16 %35, 1
  store i16 %inc149, ptr %arrayidx147, align 4
  %36 = load i32, ptr %last_lit137, align 4
  %37 = load i32, ptr %lit_bufsize151, align 8
  %sub152 = add i32 %37, -1
  %cmp153 = icmp eq i32 %36, %sub152
  %38 = load i32, ptr %lookahead, align 4
  %dec156 = add i32 %38, -1
...
if.then160:                                       ; preds = %if.then92, %if.end159
  ...
  %41 = load i64, ptr %block_start, align 8
...
cond.end170:                                      ; preds = %if.then160, %cond.true163
  ...
  store i64 %conv177, ptr %block_start, align 8
...
if.end6.i:                                        ; preds = %cond.end170
  ...
  store ptr %add.ptr.i, ptr %next_out.i, align 8
  %51 = load ptr, ptr %pending_out.i, align 8
  ...
  %52 = load i64, ptr %total_out.i, align 8
...
if.then20.i:                                      ; preds = %if.end6.i
  ...
  %55 = load ptr, ptr %pending_buf.i, align 8
  store ptr %55, ptr %pending_out.i, align 8
  br label %flush_pending.exit
...
flush_pending.exit:                               ; preds = %cond.end170, %if.end6.i, %if.then20.i
  ...
  %57 = load i32, ptr %avail_out, align 8
...
if.then187:                                       ; preds = %for.end
  %58 = load i64, ptr %block_start, align 8
...
cond.end198:                                      ; preds = %if.then187, %cond.true191
  ...
  store i64 %conv205, ptr %block_start, align 8
  %62 = load ptr, ptr %s, align 8
  %state.i358 = getelementptr inbounds %struct.z_stream_s, ptr %62, i64 0, i32 7
  %63 = load ptr, ptr %state.i358, align 8
...
if.end6.i364:                                     ; preds = %cond.end198
  ...
  %68 = load ptr, ptr %next_out.i365, align 8
  %add.ptr.i368 = getelementptr inbounds i8, ptr %68, i64 %conv7.i367
  store ptr %add.ptr.i368, ptr %next_out.i365, align 8
  %69 = load ptr, ptr %pending_out.i366, align 8
  %add.ptr11.i369 = getelementptr inbounds i8, ptr %69, i64 %conv7.i367
  store ptr %add.ptr11.i369, ptr %pending_out.i366, align 8
  %total_out.i370 = getelementptr inbounds %struct.z_stream_s, ptr %62, i64 0, i32 5
  %70 = load i64, ptr %total_out.i370, align 8
  %add.i371 = add i64 %70, %conv7.i367
  store i64 %add.i371, ptr %total_out.i370, align 8
  %71 = load i32, ptr %avail_out.i361, align 8
  %sub.i372 = sub i32 %71, %spec.select.i362
  store i32 %sub.i372, ptr %avail_out.i361, align 8
  %72 = load i64, ptr %pending.i359, align 8
  %sub16.i373 = sub i64 %72, %conv7.i367
  store i64 %sub16.i373, ptr %pending.i359, align 8
...
if.then20.i375:                                   ; preds = %if.end6.i364
  ...
  %73 = load ptr, ptr %pending_buf.i376, align 8
  store ptr %73, ptr %pending_out.i366, align 8
...
cond.true221:                                     ; preds = %if.then217
  %78 = load ptr, ptr %window, align 8
...
if.end6.i384:                                     ; preds = %cond.end228
  ...
  %87 = load ptr, ptr %next_out.i385, align 8
  %add.ptr.i388 = getelementptr inbounds i8, ptr %87, i64 %conv7.i387
  store ptr %add.ptr.i388, ptr %next_out.i385, align 8
  %88 = load ptr, ptr %pending_out.i386, align 8
  %add.ptr11.i389 = getelementptr inbounds i8, ptr %88, i64 %conv7.i387
  store ptr %add.ptr11.i389, ptr %pending_out.i386, align 8
  %total_out.i390 = getelementptr inbounds %struct.z_stream_s, ptr %81, i64 0, i32 5
  %89 = load i64, ptr %total_out.i390, align 8
  %add.i391 = add i64 %89, %conv7.i387
  store i64 %add.i391, ptr %total_out.i390, align 8
  %90 = load i32, ptr %avail_out.i381, align 8
  %sub.i392 = sub i32 %90, %spec.select.i382
  store i32 %sub.i392, ptr %avail_out.i381, align 8
  %91 = load i64, ptr %pending.i379, align 8
  %sub16.i393 = sub i64 %91, %conv7.i387
  store i64 %sub16.i393, ptr %pending.i379, align 8
...
if.then20.i395:                                   ; preds = %if.end6.i384
  ...
  %92 = load ptr, ptr %pending_buf.i396, align 8
  store ptr %92, ptr %pending_out.i386, align 8
...
flush_pending.exit397:                            ; preds = %cond.end228, %if.end6.i384, %if.then20.i395
  ...
  %94 = load i32, ptr %avail_out239, align 8
...
if.end32:                                         ; preds = %lor.lhs.false24
  ...
  store ptr %add.ptr56, ptr %d_buf, align 8
  ...
  store ptr %add.ptr61, ptr %l_buf, align 8
...
if.end28:                                         ; preds = %for.cond, %if.end9
  ...
  store i16 %conv23, ptr %arrayidx16, align 2
...
if.then41:                                        ; preds = %if.end37
  ...
  %conv44 = add i8 %14, -3
  %15 = load i32, ptr %strstart, align 4
  %16 = load i32, ptr %match_start, align 8
  %sub46 = sub i32 %15, %16
  %conv47 = trunc i32 %sub46 to i16
  %17 = load ptr, ptr %d_buf160, align 8
  %18 = load i32, ptr %last_lit161, align 4
  %idxprom48 = zext i32 %18 to i64
  %arrayidx49 = getelementptr inbounds i16, ptr %17, i64 %idxprom48
  store i16 %conv47, ptr %arrayidx49, align 2
  %19 = load ptr, ptr %l_buf164, align 8
  %inc = add i32 %18, 1
  store i32 %inc, ptr %last_lit161, align 4
  %arrayidx52 = getelementptr inbounds i8, ptr %19, i64 %idxprom48
  store i8 %conv44, ptr %arrayidx52, align 1
  ...
  %21 = load i16, ptr %arrayidx59, align 4
  %inc60 = add i16 %21, 1
  store i16 %inc60, ptr %arrayidx59, align 4
  ...
  %23 = load i16, ptr %arrayidx73, align 4
  %inc75 = add i16 %23, 1
  store i16 %inc75, ptr %arrayidx73, align 4
  %24 = load i32, ptr %last_lit161, align 4
  %25 = load i32, ptr %lit_bufsize175, align 8
  %sub77 = add i32 %25, -1
  %cmp78 = icmp eq i32 %24, %sub77
  %26 = load i32, ptr %match_length, align 8
  %27 = load i32, ptr %lookahead, align 4
  %sub82 = sub i32 %27, %26
  store i32 %sub82, ptr %lookahead, align 4
  %28 = load i32, ptr %max_lazy_match, align 8
...
if.then90:                                        ; preds = %if.then41
  %dec92 = add i32 %26, -1
  store i32 %dec92, ptr %match_length, align 8
  %29 = load i32, ptr %hash_shift, align 8
  %30 = load ptr, ptr %window, align 8
  %31 = load i32, ptr %hash_mask, align 4
  %32 = load ptr, ptr %head, align 8
  %33 = load ptr, ptr %prev, align 8
  %34 = load i32, ptr %w_mask, align 8
  %strstart45.promoted = load i32, ptr %strstart, align 4
  %ins_h95.promoted = load i32, ptr %ins_h, align 8
  br label %do.body
...
do.body:                                          ; preds = %do.body, %if.then90
  ...
  store i32 %and106, ptr %ins_h, align 8
  ...
  store i16 %38, ptr %arrayidx117, align 2
  %conv120 = trunc i32 %inc94 to i16
  store i16 %conv120, ptr %arrayidx111, align 2
  %dec126 = add i32 %35, -1
  store i32 %dec126, ptr %match_length, align 8
  %cmp127.not = icmp eq i32 %dec126, 0
  br i1 %cmp127.not, label %do.end, label %do.body

do.end:                                           ; preds = %do.body
  %inc130 = add i32 %36, 2
  store i32 %inc130, ptr %strstart, align 4
  br i1 %cmp78, label %if.then184, label %for.cond.backedge

if.else:                                          ; preds = %if.then41
  %39 = load i32, ptr %strstart, align 4
  %add133 = add i32 %39, %26
  store i32 %add133, ptr %strstart, align 4
  store i32 0, ptr %match_length, align 8
  %40 = load ptr, ptr %window, align 8
  %idxprom137 = zext i32 %add133 to i64
  %arrayidx138 = getelementptr inbounds i8, ptr %40, i64 %idxprom137
  %41 = load i8, ptr %arrayidx138, align 1
  %conv139 = zext i8 %41 to i32
  store i32 %conv139, ptr %ins_h, align 8
...
if.end183:                                        ; preds = %if.end37
  ...
  %47 = load i8, ptr %arrayidx159, align 1
  %48 = load ptr, ptr %d_buf160, align 8
  %49 = load i32, ptr %last_lit161, align 4
  ...
  %50 = load ptr, ptr %l_buf164, align 8
  %inc166 = add i32 %49, 1
  store i32 %inc166, ptr %last_lit161, align 4
  %arrayidx168 = getelementptr inbounds i8, ptr %50, i64 %idxprom162
  store i8 %47, ptr %arrayidx168, align 1
  %idxprom170 = zext i8 %47 to i64
  %arrayidx171 = getelementptr inbounds %struct.internal_state, ptr %s, i64 0, i32 37, i64 %idxprom170
  %51 = load i16, ptr %arrayidx171, align 4
  %inc173 = add i16 %51, 1
  store i16 %inc173, ptr %arrayidx171, align 4
  %52 = load i32, ptr %last_lit161, align 4
  %53 = load i32, ptr %lit_bufsize175, align 8
  %sub176 = add i32 %53, -1
  %cmp177 = icmp eq i32 %52, %sub176
  %54 = load i32, ptr %lookahead, align 4
  %dec180 = add i32 %54, -1
  store i32 %dec180, ptr %lookahead, align 4
  %55 = load i32, ptr %strstart, align 4
  %inc182 = add i32 %55, 1
  store i32 %inc182, ptr %strstart, align 4
...
if.end6.i:                                        ; preds = %cond.end194
  ...
  %68 = load i64, ptr %total_out.i, align 8
  %add.i = add i64 %68, %conv7.i
  store i64 %add.i, ptr %total_out.i, align 8
  %69 = load i32, ptr %avail_out.i, align 8
...
if.then20.i:                                      ; preds = %if.end6.i
  ...
  %71 = load ptr, ptr %pending_buf.i, align 8
  store ptr %71, ptr %pending_out.i, align 8
  br label %flush_pending.exit
...
flush_pending.exit:                               ; preds = %cond.end194, %if.end6.i, %if.then20.i
  ...
  %73 = load i32, ptr %avail_out, align 8
...
if.then219:                                       ; preds = %for.end
  %75 = load i64, ptr %block_start, align 8
...
if.end6.i413:                                     ; preds = %cond.end230
  ...
  %84 = load ptr, ptr %next_out.i414, align 8
  %add.ptr.i417 = getelementptr inbounds i8, ptr %84, i64 %conv7.i416
  store ptr %add.ptr.i417, ptr %next_out.i414, align 8
  %85 = load ptr, ptr %pending_out.i415, align 8
  %add.ptr11.i418 = getelementptr inbounds i8, ptr %85, i64 %conv7.i416
  store ptr %add.ptr11.i418, ptr %pending_out.i415, align 8
  %total_out.i419 = getelementptr inbounds %struct.z_stream_s, ptr %78, i64 0, i32 5
  %86 = load i64, ptr %total_out.i419, align 8
  %add.i420 = add i64 %86, %conv7.i416
  store i64 %add.i420, ptr %total_out.i419, align 8
  %87 = load i32, ptr %avail_out.i410, align 8
  %sub.i421 = sub i32 %87, %spec.select.i411
  store i32 %sub.i421, ptr %avail_out.i410, align 8
  %88 = load i64, ptr %pending.i408, align 8
  %sub16.i422 = sub i64 %88, %conv7.i416
  store i64 %sub16.i422, ptr %pending.i408, align 8
...
if.then20.i424:                                   ; preds = %if.end6.i413
  ...
  %89 = load ptr, ptr %pending_buf.i425, align 8
  store ptr %89, ptr %pending_out.i415, align 8
...
if.end6.i433:                                     ; preds = %cond.end260
  ...
  %102 = load ptr, ptr %next_out.i434, align 8
  %add.ptr.i437 = getelementptr inbounds i8, ptr %102, i64 %conv7.i436
  store ptr %add.ptr.i437, ptr %next_out.i434, align 8
  %103 = load ptr, ptr %pending_out.i435, align 8
  %add.ptr11.i438 = getelementptr inbounds i8, ptr %103, i64 %conv7.i436
  store ptr %add.ptr11.i438, ptr %pending_out.i435, align 8
  %total_out.i439 = getelementptr inbounds %struct.z_stream_s, ptr %96, i64 0, i32 5
  %104 = load i64, ptr %total_out.i439, align 8
  %add.i440 = add i64 %104, %conv7.i436
  store i64 %add.i440, ptr %total_out.i439, align 8
  %105 = load i32, ptr %avail_out.i430, align 8
  %sub.i441 = sub i32 %105, %spec.select.i431
  store i32 %sub.i441, ptr %avail_out.i430, align 8
  %106 = load i64, ptr %pending.i428, align 8
  %sub16.i442 = sub i64 %106, %conv7.i436
  store i64 %sub16.i442, ptr %pending.i428, align 8
...
if.then20.i444:                                   ; preds = %if.end6.i433
  ...
  %107 = load ptr, ptr %pending_buf.i445, align 8
  store ptr %107, ptr %pending_out.i435, align 8
...
flush_pending.exit446:                            ; preds = %cond.end260, %if.end6.i433, %if.then20.i444
  ...
  %109 = load i32, ptr %avail_out271, align 8
...
for.cond.if.end28_crit_edge:                      ; preds = %for.cond
  %.pre = load i32, ptr %match_length579, align 8
  %.pre588 = load i32, ptr %match_start581, align 8
  br label %if.end28
...
if.end9:                                          ; preds = %if.end
  %cmp11 = icmp ugt i32 %1, 2
  %.pre587 = load i32, ptr %match_length579, align 8
  %.pre589 = load i32, ptr %match_start581, align 8
  br i1 %cmp11, label %if.end28, label %if.end28.thread

if.end28.thread:                                  ; preds = %if.end9
  store i32 %.pre587, ptr %prev_length580, align 8
  store i32 %.pre589, ptr %prev_match582, align 4
  store i32 2, ptr %match_length579, align 8
  br label %if.end61
...
if.end28:                                         ; preds = %for.cond.if.end28_crit_edge, %if.end9
  ...
  store i16 %conv23, ptr %arrayidx16, align 2
  store i32 %3, ptr %prev_length580, align 8
  store i32 %2, ptr %prev_match582, align 4
  store i32 2, ptr %match_length579, align 8
  %cmp30.not = icmp eq i16 %11, 0
  br i1 %cmp30.not, label %if.end61, label %land.lhs.true32

land.lhs.true32:                                  ; preds = %if.end28
  %14 = load i32, ptr %max_lazy_match, align 8
...
land.lhs.true52:                                  ; preds = %lor.lhs.false
  ...
  %18 = load i32, ptr %match_start581, align 8
  %sub55 = sub i32 %17, %18
...
if.end61thread-pre-split:                         ; preds = %land.lhs.true32, %land.lhs.true36, %if.then58, %land.lhs.true52, %lor.lhs.false, %if.then41
  ...
  %.pr = load i32, ptr %prev_length580, align 8
  br label %if.end61
...
if.then70:                                        ; preds = %if.end61
  ...
  %22 = load i32, ptr %lookahead, align 4
  %add73 = add i32 %21, -3
  %sub74 = add i32 %add73, %22
  %23 = trunc i32 %19 to i8
  %conv77 = add i8 %23, -3
  %24 = load i32, ptr %prev_match582, align 4
  %25 = xor i32 %24, -1
  %sub81 = add i32 %21, %25
  %conv82 = trunc i32 %sub81 to i16
  %26 = load ptr, ptr %d_buf, align 8
  %27 = load i32, ptr %last_lit, align 4
  %idxprom83 = zext i32 %27 to i64
  %arrayidx84 = getelementptr inbounds i16, ptr %26, i64 %idxprom83
  store i16 %conv82, ptr %arrayidx84, align 2
  %28 = load ptr, ptr %l_buf, align 8
  %inc = add i32 %27, 1
  store i32 %inc, ptr %last_lit, align 4
  %arrayidx87 = getelementptr inbounds i8, ptr %28, i64 %idxprom83
  store i8 %conv77, ptr %arrayidx87, align 1
  ...
  %30 = load i16, ptr %arrayidx94, align 4
  %inc95 = add i16 %30, 1
  store i16 %inc95, ptr %arrayidx94, align 4
  ...
  %32 = load i16, ptr %arrayidx108, align 4
  %inc110 = add i16 %32, 1
  store i16 %inc110, ptr %arrayidx108, align 4
  %33 = load i32, ptr %last_lit, align 4
  %34 = load i32, ptr %lit_bufsize, align 8
  %sub112 = add i32 %34, -1
  %35 = load i32, ptr %prev_length580, align 8
  %36 = load i32, ptr %lookahead, align 4
  %reass.sub = sub i32 %36, %35
  %sub118 = add i32 %reass.sub, 1
  store i32 %sub118, ptr %lookahead, align 4
  %sub120 = add i32 %35, -2
  store i32 %sub120, ptr %prev_length580, align 8
  %strstart71.promoted = load i32, ptr %strstart, align 4
  br label %do.body
...
do.end:                                           ; preds = %do.cond
  ...
  store i32 2, ptr %match_length579, align 8
  %inc163 = add i32 %38, 2
  store i32 %inc163, ptr %strstart, align 4
...
cond.end174:                                      ; preds = %if.then164, %cond.true167
  ...
  store i64 %conv181, ptr %block_start, align 8
...
if.end6.i:                                        ; preds = %cond.end174
  ...
  %59 = load i64, ptr %total_out.i, align 8
  %add.i = add i64 %59, %conv7.i
  store i64 %add.i, ptr %total_out.i, align 8
  %60 = load i32, ptr %avail_out.i, align 8
  %sub.i = sub i32 %60, %spec.select.i
  store i32 %sub.i, ptr %avail_out.i, align 8
  %61 = load i64, ptr %pending.i, align 8
...
if.then20.i:                                      ; preds = %if.end6.i
  ...
  %62 = load ptr, ptr %pending_buf.i, align 8
  store ptr %62, ptr %pending_out.i, align 8
  br label %flush_pending.exit
...
if.then191:                                       ; preds = %if.else
  ...
  %68 = load i8, ptr %arrayidx196, align 1
  %69 = load ptr, ptr %d_buf, align 8
  ...
  %71 = load ptr, ptr %l_buf, align 8
  %inc203 = add i32 %70, 1
  store i32 %inc203, ptr %last_lit, align 4
  %arrayidx205 = getelementptr inbounds i8, ptr %71, i64 %idxprom199
  store i8 %68, ptr %arrayidx205, align 1
  %idxprom207 = zext i8 %68 to i64
  %arrayidx208 = getelementptr inbounds %struct.internal_state, ptr %s, i64 0, i32 37, i64 %idxprom207
  %72 = load i16, ptr %arrayidx208, align 4
  %inc210 = add i16 %72, 1
  store i16 %inc210, ptr %arrayidx208, align 4
  %73 = load i32, ptr %last_lit, align 4
  %74 = load i32, ptr %lit_bufsize, align 8
  %sub213 = add i32 %74, -1
...
cond.end228:                                      ; preds = %if.then217, %cond.true221
  ...
  %80 = load ptr, ptr %state.i517, align 8
...
if.end6.i523:                                     ; preds = %cond.end228
  ...
  %85 = load ptr, ptr %next_out.i524, align 8
  %add.ptr.i527 = getelementptr inbounds i8, ptr %85, i64 %conv7.i526
  store ptr %add.ptr.i527, ptr %next_out.i524, align 8
  %86 = load ptr, ptr %pending_out.i525, align 8
  %add.ptr11.i528 = getelementptr inbounds i8, ptr %86, i64 %conv7.i526
  store ptr %add.ptr11.i528, ptr %pending_out.i525, align 8
  %total_out.i529 = getelementptr inbounds %struct.z_stream_s, ptr %79, i64 0, i32 5
  %87 = load i64, ptr %total_out.i529, align 8
  %add.i530 = add i64 %87, %conv7.i526
  store i64 %add.i530, ptr %total_out.i529, align 8
  %88 = load i32, ptr %avail_out.i520, align 8
  %sub.i531 = sub i32 %88, %spec.select.i521
  store i32 %sub.i531, ptr %avail_out.i520, align 8
  %89 = load i64, ptr %pending.i518, align 8
  %sub16.i532 = sub i64 %89, %conv7.i526
  store i64 %sub16.i532, ptr %pending.i518, align 8
...
if.else249:                                       ; preds = %if.else
  ...
  %95 = load i32, ptr %strstart, align 4
  %inc252 = add i32 %95, 1
  store i32 %inc252, ptr %strstart, align 4
  %96 = load i32, ptr %lookahead, align 4
  %dec254 = add i32 %96, -1
  store i32 %dec254, ptr %lookahead, align 4
  br label %for.cond.backedge

for.end:                                          ; preds = %if.end
  %97 = load i32, ptr %match_available, align 8
...
if.then259:                                       ; preds = %for.end
  ...
  %100 = load i8, ptr %arrayidx265, align 1
  %101 = load ptr, ptr %d_buf, align 8
...
if.then297:                                       ; preds = %if.end286
  %106 = load i64, ptr %block_start, align 8
...
if.end6.i543:                                     ; preds = %cond.end308
  ...
  %115 = load ptr, ptr %next_out.i544, align 8
  %add.ptr.i547 = getelementptr inbounds i8, ptr %115, i64 %conv7.i546
  store ptr %add.ptr.i547, ptr %next_out.i544, align 8
  %116 = load ptr, ptr %pending_out.i545, align 8
  %add.ptr11.i548 = getelementptr inbounds i8, ptr %116, i64 %conv7.i546
  store ptr %add.ptr11.i548, ptr %pending_out.i545, align 8
  %total_out.i549 = getelementptr inbounds %struct.z_stream_s, ptr %109, i64 0, i32 5
  %117 = load i64, ptr %total_out.i549, align 8
  %add.i550 = add i64 %117, %conv7.i546
  store i64 %add.i550, ptr %total_out.i549, align 8
  %118 = load i32, ptr %avail_out.i540, align 8
  %sub.i551 = sub i32 %118, %spec.select.i541
  store i32 %sub.i551, ptr %avail_out.i540, align 8
  %119 = load i64, ptr %pending.i538, align 8
  %sub16.i552 = sub i64 %119, %conv7.i546
  store i64 %sub16.i552, ptr %pending.i538, align 8
...
if.then20.i554:                                   ; preds = %if.end6.i543
  ...
  %120 = load ptr, ptr %pending_buf.i555, align 8
  store ptr %120, ptr %pending_out.i545, align 8
...
if.end6.i563:                                     ; preds = %cond.end338
  ...
  %133 = load ptr, ptr %next_out.i564, align 8
  %add.ptr.i567 = getelementptr inbounds i8, ptr %133, i64 %conv7.i566
  store ptr %add.ptr.i567, ptr %next_out.i564, align 8
  %134 = load ptr, ptr %pending_out.i565, align 8
  %add.ptr11.i568 = getelementptr inbounds i8, ptr %134, i64 %conv7.i566
  store ptr %add.ptr11.i568, ptr %pending_out.i565, align 8
  %total_out.i569 = getelementptr inbounds %struct.z_stream_s, ptr %127, i64 0, i32 5
  %135 = load i64, ptr %total_out.i569, align 8
  %add.i570 = add i64 %135, %conv7.i566
  store i64 %add.i570, ptr %total_out.i569, align 8
  %136 = load i32, ptr %avail_out.i560, align 8
  %sub.i571 = sub i32 %136, %spec.select.i561
  store i32 %sub.i571, ptr %avail_out.i560, align 8
  %137 = load i64, ptr %pending.i558, align 8
  %sub16.i572 = sub i64 %137, %conv7.i566
  store i64 %sub16.i572, ptr %pending.i558, align 8
...
if.then20.i574:                                   ; preds = %if.end6.i563
  ...
  %138 = load ptr, ptr %pending_buf.i575, align 8
  store ptr %138, ptr %pending_out.i565, align 8
...
flush_pending.exit576:                            ; preds = %cond.end338, %if.end6.i563, %if.then20.i574
  ...
  %140 = load i32, ptr %avail_out349, align 8
...
land.lhs.true100:                                 ; preds = %land.lhs.true93
  ...
  %32 = load i8, ptr %incdec.ptr101.ptr, align 1
  ...
  br i1 %or.cond, label %do.body52, label %do.end.split.loop.exit260
...
do.cond125:                                       ; preds = %do.end, %if.end118, %do.body, %lor.lhs.false, %lor.lhs.false37, %lor.lhs.false42
  ...
  br i1 %or.cond220, label %do.end135, label %do.body
