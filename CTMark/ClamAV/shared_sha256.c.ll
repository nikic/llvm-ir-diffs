; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/shared_sha256.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/shared_sha256.c"
...
define dso_local void @sha256_update(ptr nocapture noundef %ctx, ptr nocapture noundef readonly %buffer, i32 noundef %length) local_unnamed_addr #2 {
entry:
  %index = getelementptr inbounds %struct.sha256_ctx, ptr %ctx, i64 0, i32 4
...
define internal fastcc void @sha256_block(ptr nocapture noundef %ctx, ptr nocapture noundef readonly %block) unnamed_addr #4 {
entry:
  %data = alloca [16 x i32], align 16
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %data) #8
  %count_low = getelementptr inbounds %struct.sha256_ctx, ptr %ctx, i64 0, i32 1
  %0 = load i32, ptr %count_low, align 4
  %inc = add i32 %0, 1
  store i32 %inc, ptr %count_low, align 4
  %tobool.not = icmp eq i32 %inc, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %count_high = getelementptr inbounds %struct.sha256_ctx, ptr %ctx, i64 0, i32 2
  %1 = load i32, ptr %count_high, align 4
  %inc1 = add i32 %1, 1
  store i32 %inc1, ptr %count_high, align 4
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %2 = load i8, ptr %block, align 1
  ...
  store i32 %or12, ptr %data, align 16
  ...
  %12 = load i8, ptr %add.ptr6.1, align 1
  ...
  %18 = load i8, ptr %add.ptr6.2, align 1
  ...
  %24 = load i8, ptr %add.ptr6.3, align 1
  ...
  %30 = load i8, ptr %add.ptr6.4, align 1
  ...
  %36 = load i8, ptr %add.ptr6.5, align 1
  ...
  %42 = load i8, ptr %add.ptr6.6, align 1
  ...
  %48 = load i8, ptr %add.ptr6.7, align 1
  ...
  %54 = load i8, ptr %add.ptr6.8, align 1
  ...
  %60 = load i8, ptr %add.ptr6.9, align 1
  ...
  %66 = load i8, ptr %add.ptr6.10, align 1
  ...
  %67 = load i8, ptr %add.ptr10.10, align 1
  ...
  %72 = load i8, ptr %add.ptr6.11, align 1
  ...
  %73 = load i8, ptr %add.ptr10.11, align 1
  ...
  %78 = load i8, ptr %add.ptr6.12, align 1
  ...
  %79 = load i8, ptr %add.ptr10.12, align 1
  ...
  %84 = load i8, ptr %add.ptr6.13, align 1
  ...
  %85 = load i8, ptr %add.ptr10.13, align 1
  ...
  %90 = load i8, ptr %add.ptr6.14, align 1
  ...
  %91 = load i8, ptr %add.ptr10.14, align 1
  ...
  %96 = load i8, ptr %add.ptr6.15, align 1
  ...
  %97 = load i8, ptr %add.ptr10.15, align 1
  ...
  store i32 %or12.15, ptr %arrayidx.15, align 4
...
for.body:                                         ; preds = %entry
  ...
  br i1 %tobool.not, label %for.end, label %for.body.1
...
for.body.1:                                       ; preds = %for.body
  ...
  br i1 %tobool.not.1, label %for.end, label %for.body.2
...
for.body.2:                                       ; preds = %for.body.1
  ...
  br i1 %tobool.not.2, label %for.end, label %for.body.3
...
for.body6:                                        ; preds = %for.body6.preheader, %for.body6
  ...
  %3 = load i8, ptr %add.ptr13, align 1
  ...
  store i32 %or32, ptr %arrayidx34, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.end37, label %for.body6
...
for.body63.preheader:                             ; preds = %for.end, %for.cond60.preheader
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep, i8 0, i64 %12, i1 false)
  br label %if.end
...
do.body351.lr.ph:                                 ; preds = %do.body
  ...
  %arrayidx371.promoted = load i32, ptr %arrayidx371, align 4
  %arrayidx385.promoted = load i32, ptr %arrayidx385, align 4
  %arrayidx387.promoted = load i32, ptr %arrayidx387, align 4
  %data.promoted = load i32, ptr %data, align 4
  %arrayidx446.promoted = load i32, ptr %arrayidx446, align 4
  %arrayidx460.promoted = load i32, ptr %arrayidx460, align 4
  %arrayidx462.promoted = load i32, ptr %arrayidx462, align 4
  %arrayidx535.promoted = load i32, ptr %arrayidx535, align 4
  %arrayidx537.promoted = load i32, ptr %arrayidx537, align 4
  %arrayidx610.promoted = load i32, ptr %arrayidx610, align 4
  %arrayidx612.promoted = load i32, ptr %arrayidx612, align 4
  %arrayidx685.promoted = load i32, ptr %arrayidx685, align 4
  %arrayidx687.promoted = load i32, ptr %arrayidx687, align 4
  %arrayidx762.promoted = load i32, ptr %arrayidx762, align 4
  %arrayidx837.promoted = load i32, ptr %arrayidx837, align 4
  %arrayidx912.promoted = load i32, ptr %arrayidx912, align 4
  br label %do.body351
...
do.body:                                          ; preds = %entry, %do.body
  ...
  %8 = load i32, ptr %k.02393, align 4
  %9 = load i32, ptr %d.02392, align 4
  ...
  %12 = load i32, ptr %arrayidx102, align 4
  ...
  %14 = load i32, ptr %arrayidx145, align 4
  ...
  %16 = load i32, ptr %arrayidx188, align 4
  %arrayidx190 = getelementptr inbounds i32, ptr %d.02392, i64 4
  %17 = load i32, ptr %arrayidx190, align 4
  ...
  %18 = load i32, ptr %arrayidx231, align 4
  %arrayidx233 = getelementptr inbounds i32, ptr %d.02392, i64 5
  %19 = load i32, ptr %arrayidx233, align 4
  ...
  %20 = load i32, ptr %arrayidx274, align 4
  %arrayidx276 = getelementptr inbounds i32, ptr %d.02392, i64 6
  %21 = load i32, ptr %arrayidx276, align 4
  ...
  %22 = load i32, ptr %arrayidx317, align 4
  %arrayidx319 = getelementptr inbounds i32, ptr %d.02392, i64 7
  %23 = load i32, ptr %arrayidx319, align 4
  ...
  br i1 %cmp, label %do.body, label %do.body351.lr.ph
...
do.body351:                                       ; preds = %do.body351.lr.ph, %do.body351
  ...
  %25 = load i32, ptr %k.12404, align 4
  ...
  store i32 %add403, ptr %data, align 4
  ...
  %26 = load i32, ptr %arrayidx444, align 4
  ...
  store i32 %add478, ptr %arrayidx387, align 4
  ...
  %27 = load i32, ptr %arrayidx519, align 4
  ...
  store i32 %add553, ptr %arrayidx462, align 4
  ...
  %28 = load i32, ptr %arrayidx594, align 4
  ...
  store i32 %add628, ptr %arrayidx537, align 4
  ...
  %29 = load i32, ptr %arrayidx669, align 4
  ...
  store i32 %add703, ptr %arrayidx612, align 4
  ...
  %30 = load i32, ptr %arrayidx744, align 4
  ...
  store i32 %add778, ptr %arrayidx687, align 4
  ...
  %31 = load i32, ptr %arrayidx819, align 4
  ...
  store i32 %add853, ptr %arrayidx762, align 4
  ...
  %32 = load i32, ptr %arrayidx894, align 4
  ...
  store i32 %add928, ptr %arrayidx837, align 4
  ...
  %33 = load i32, ptr %arrayidx969, align 4
  ...
  store i32 %add1003, ptr %arrayidx912, align 4
  ...
  %34 = load i32, ptr %arrayidx1044, align 4
  ...
  store i32 %add1078, ptr %arrayidx385, align 4
  ...
  %35 = load i32, ptr %arrayidx1119, align 4
  ...
  store i32 %add1153, ptr %arrayidx460, align 4
  ...
  %36 = load i32, ptr %arrayidx1194, align 4
  ...
  store i32 %add1228, ptr %arrayidx535, align 4
  ...
  %37 = load i32, ptr %arrayidx1269, align 4
  ...
  store i32 %add1303, ptr %arrayidx610, align 4
  ...
  %38 = load i32, ptr %arrayidx1344, align 4
  ...
  store i32 %add1528, ptr %arrayidx446, align 4
  ...
  br i1 %cmp348, label %do.body351, label %for.end1556

for.end1556:                                      ; preds = %do.body351
  %41 = load <4 x i32>, ptr %state, align 4
  ...
  store <4 x i32> %46, ptr %state, align 4
  %47 = load <4 x i32>, ptr %arrayidx4, align 4
  ...
  store <4 x i32> %52, ptr %arrayidx4, align 4
  ret void
}
...
for.body.preheader:                               ; preds = %entry
  ...
  store i8 %conv.1, ptr %incdec.ptr20, align 1
  ...
  store i8 %conv6.1, ptr %incdec.ptr.1, align 1
  ...
  store i8 %conv.2, ptr %incdec.ptr20.1, align 1
  ...
  store i8 %conv6.2, ptr %incdec.ptr.2, align 1
  ...
  store i8 %conv.3, ptr %incdec.ptr20.2, align 1
  ...
  store i8 %conv6.3, ptr %incdec.ptr.3, align 1
  ...
  store i8 %conv.4, ptr %incdec.ptr20.3, align 1
  ...
  store i8 %conv6.4, ptr %incdec.ptr.4, align 1
  ...
  store i8 %conv.5, ptr %incdec.ptr20.4, align 1
  ...
  store i8 %conv.6, ptr %incdec.ptr20.5, align 1
  ...
  store i8 %conv6.6, ptr %incdec.ptr.6, align 1
  ...
  store i8 %conv13.6, ptr %incdec.ptr7.6, align 1
  %27 = load i32, ptr %arrayidx.6, align 4
  %conv19.6 = trunc i32 %27 to i8
  %incdec.ptr20.6 = getelementptr inbounds i8, ptr %s, i64 28
  store i8 %conv19.6, ptr %incdec.ptr14.6, align 1
  ...
  store i8 %conv.7, ptr %incdec.ptr20.6, align 1
