; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_rebuildpe.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_rebuildpe.c"
...
entry:
  ...
  %1 = load i32, ptr %sections, align 4
  %2 = and i32 %add3, 7
...
if.then50:                                        ; preds = %if.end46
  ...
  store i16 %conv58, ptr %NumberOfSections, align 2
  %AddressOfEntryPoint = getelementptr inbounds i8, ptr %call, i64 248
  store i32 %ep, ptr %AddressOfEntryPoint, align 4
  %ImageBase = getelementptr inbounds i8, ptr %call, i64 260
  store i32 %base, ptr %ImageBase, align 4
  %SizeOfHeaders = getelementptr inbounds i8, ptr %call, i64 292
  store i32 %rawbase.0, ptr %SizeOfHeaders, align 4
...
if.then67:                                        ; preds = %if.then50
  ...
  %50 = load i32, ptr %sections, align 4
  ...
  %51 = load i32, ptr %sections, align 4
  %sub77 = sub i32 %51, %mul56
  %rem82 = and i32 %51, 4095
  %cmp83.not = icmp eq i32 %rem82, 0
  %add85245 = select i1 %cmp83.not, i32 0, i32 4096
  %div78244246 = add i32 %sub77, %add85245
  %mul86 = and i32 %div78244246, -4096
...
for.body92:                                       ; preds = %for.body92.preheader, %for.body92
  ...
  %55 = load i32, ptr %rsz105, align 4
  ...
  %58 = load i32, ptr %rsz105, align 4
  %rem124 = and i32 %58, 511
  %cmp125.not = icmp eq i32 %rem124, 0
  %add127248 = select i1 %cmp125.not, i32 0, i32 512
  %div120247249 = add i32 %add127248, %58
  %mul128 = and i32 %div120247249, -512
  %add129 = add i32 %mul128, %rawbase.1260
  %add.ptr130 = getelementptr inbounds i8, ptr %curpe.1261, i64 40
  %59 = load i32, ptr %vsz, align 4
  %rem138 = and i32 %59, 4095
  %cmp139.not = icmp eq i32 %rem138, 0
  %add141251 = select i1 %cmp139.not, i32 0, i32 4096
  %div134250252 = add i32 %add141251, %59
  %mul142 = and i32 %div134250252, -4096
  %add143 = add i32 %mul142, %datasize.2262
  %exitcond271.not = icmp eq i64 %indvars.iv.next268, %wide.trip.count270
  br i1 %exitcond271.not, label %for.end146, label %for.body92
...
for.end146:                                       ; preds = %for.body92, %if.end88
  ...
  store i32 %datasize.2.lcssa, ptr %SizeOfImage, align 4
