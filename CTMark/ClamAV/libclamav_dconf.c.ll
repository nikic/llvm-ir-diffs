; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_dconf.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_dconf.c"
...
for.inc.sink.split:                               ; preds = %if.else99, %if.then88, %if.then71, %if.then54, %if.then37, %if.then20, %if.then7
  ...
  %8 = load i32, ptr %bflag, align 8
  %9 = load i32, ptr %call.sink158, align 4
  %or = or i32 %9, %8
  store i32 %or, ptr %call.sink158, align 4
  br label %for.inc
...
for.body:                                         ; preds = %entry, %for.inc
  ...
  %0 = phi ptr [ @.str, %entry ], [ %20, %for.inc ]
...
if.then:                                          ; preds = %for.body
  ...
  %.pre242 = load i32, ptr %dconf, align 4
  br i1 %tobool5.not, label %if.then6, label %if.end

if.then6:                                         ; preds = %if.then
  %tobool8.not = icmp eq i32 %.pre242, 0
  ...
  %.pre241 = load i32, ptr %dconf, align 4
  br label %if.end

if.end:                                           ; preds = %if.then6, %if.then
  %1 = phi i32 [ %.pre241, %if.then6 ], [ %.pre242, %if.then ]
...
if.then11:                                        ; preds = %if.end
  ...
  %bflag = getelementptr inbounds [44 x %struct.dconf_module], ptr @modules, i64 0, i64 %indvars.iv, i32 2
  %3 = load i32, ptr %bflag, align 8
  %and = and i32 %3, %1
  %tobool17.not = icmp eq i32 %and, 0
  %cond18 = select i1 %tobool17.not, ptr @.str.13, ptr @.str.10
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.12, ptr noundef %2, ptr noundef nonnull %cond18) #9
  br label %for.inc
...
if.then39:                                        ; preds = %if.else33
  ...
  %.pre240 = load i32, ptr %archive, align 4
  br i1 %tobool40.not, label %if.then41, label %if.end44

if.then41:                                        ; preds = %if.then39
  %tobool42.not = icmp eq i32 %.pre240, 0
  ...
  %.pre239 = load i32, ptr %archive, align 4
  br label %if.end44

if.end44:                                         ; preds = %if.then41, %if.then39
  %5 = phi i32 [ %.pre239, %if.then41 ], [ %.pre240, %if.then39 ]
...
if.then47:                                        ; preds = %if.end44
  ...
  %6 = load ptr, ptr %sname50, align 8
  %bflag54 = getelementptr inbounds [44 x %struct.dconf_module], ptr @modules, i64 0, i64 %indvars.iv, i32 2
  %7 = load i32, ptr %bflag54, align 8
  %and55 = and i32 %7, %5
  %tobool56.not = icmp eq i32 %and55, 0
  %cond57 = select i1 %tobool56.not, ptr @.str.13, ptr @.str.10
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.12, ptr noundef %6, ptr noundef nonnull %cond57) #9
  br label %for.inc
...
if.then66:                                        ; preds = %if.else60
  ...
  %.pre238 = load i32, ptr %doc69, align 4
  br i1 %tobool67.not, label %if.then68, label %if.end72

if.then68:                                        ; preds = %if.then66
  %tobool70.not = icmp eq i32 %.pre238, 0
  ...
  %.pre237 = load i32, ptr %doc69, align 4
  br label %if.end72

if.end72:                                         ; preds = %if.then68, %if.then66
  %8 = phi i32 [ %.pre237, %if.then68 ], [ %.pre238, %if.then66 ]
  %tobool74.not = icmp eq i32 %8, 0
...
if.then75:                                        ; preds = %if.end72
  ...
  %9 = load ptr, ptr %sname78, align 8
  %bflag82 = getelementptr inbounds [44 x %struct.dconf_module], ptr @modules, i64 0, i64 %indvars.iv, i32 2
  %10 = load i32, ptr %bflag82, align 8
  %and83 = and i32 %10, %8
  %tobool84.not = icmp eq i32 %and83, 0
  %cond85 = select i1 %tobool84.not, ptr @.str.13, ptr @.str.10
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.12, ptr noundef %9, ptr noundef nonnull %cond85) #9
  br label %for.inc
...
if.then94:                                        ; preds = %if.else88
  ...
  %.pre236 = load i32, ptr %mail97, align 4
  br i1 %tobool95.not, label %if.then96, label %if.end100

if.then96:                                        ; preds = %if.then94
  %tobool98.not = icmp eq i32 %.pre236, 0
  ...
  %.pre235 = load i32, ptr %mail97, align 4
  br label %if.end100

if.end100:                                        ; preds = %if.then96, %if.then94
  %11 = phi i32 [ %.pre235, %if.then96 ], [ %.pre236, %if.then94 ]
...
if.then103:                                       ; preds = %if.end100
  ...
  %12 = load ptr, ptr %sname106, align 8
  %bflag110 = getelementptr inbounds [44 x %struct.dconf_module], ptr @modules, i64 0, i64 %indvars.iv, i32 2
  %13 = load i32, ptr %bflag110, align 8
  %and111 = and i32 %13, %11
  %tobool112.not = icmp eq i32 %and111, 0
  %cond113 = select i1 %tobool112.not, ptr @.str.13, ptr @.str.10
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.12, ptr noundef %12, ptr noundef nonnull %cond113) #9
  br label %for.inc
...
if.then124:                                       ; preds = %if.then122
  ...
  %.pre233 = load i32, ptr %other125, align 4
  br label %if.end128

if.end128:                                        ; preds = %if.then124, %if.then122
  %14 = phi i32 [ %.pre233, %if.then124 ], [ %.pre234, %if.then122 ]
  %tobool130.not = icmp eq i32 %14, 0
...
if.then131:                                       ; preds = %if.end128
  ...
  %15 = load ptr, ptr %sname134, align 8
  %bflag138 = getelementptr inbounds [44 x %struct.dconf_module], ptr @modules, i64 0, i64 %indvars.iv, i32 2
  %16 = load i32, ptr %bflag138, align 8
  %and139 = and i32 %16, %14
  %tobool140.not = icmp eq i32 %and139, 0
  %cond141 = select i1 %tobool140.not, ptr @.str.13, ptr @.str.10
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.12, ptr noundef %15, ptr noundef nonnull %cond141) #9
  br label %for.inc
...
if.then152:                                       ; preds = %if.then150
  ...
  %.pre = load i32, ptr %phishing153, align 4
  br label %if.end156

if.end156:                                        ; preds = %if.then152, %if.then150
  %17 = phi i32 [ %.pre, %if.then152 ], [ %.pre232, %if.then150 ]
  %tobool158.not = icmp eq i32 %17, 0
...
if.then159:                                       ; preds = %if.end156
  ...
  %18 = load ptr, ptr %sname162, align 8
  %bflag166 = getelementptr inbounds [44 x %struct.dconf_module], ptr @modules, i64 0, i64 %indvars.iv, i32 2
  %19 = load i32, ptr %bflag166, align 8
  %and167 = and i32 %19, %17
  %tobool168.not = icmp eq i32 %and167, 0
  %cond169 = select i1 %tobool168.not, ptr @.str.13, ptr @.str.10
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.12, ptr noundef %18, ptr noundef nonnull %cond169) #9
  br label %for.inc
...
if.then46:                                        ; preds = %if.then41
  ...
  store i32 %4, ptr %archive, align 4
  br label %if.end49
...
if.then110:                                       ; preds = %if.then105
  ...
  store i32 %8, ptr %phishing, align 4
  br label %if.end113
...
if.end113:                                        ; preds = %if.then110, %land.lhs.true101, %if.end97
  ...
  br i1 %tobool3.not, label %cleanup, label %while.body
