...
if.then:                                          ; preds = %for.body
  ...
  %.pre242 = load i32, ptr %dconf, align 4, !tbaa !15
...
if.then6:                                         ; preds = %if.then
  ...
  %.pre241 = load i32, ptr %dconf, align 4, !tbaa !15
  br label %if.end
...
if.then11:                                        ; preds = %if.end
  ...
  %2 = load ptr, ptr %sname, align 8, !tbaa !17
  %bflag = getelementptr inbounds [44 x %struct.dconf_module], ptr @modules, i64 0, i64 %indvars.iv, i32 2
  %3 = load i32, ptr %bflag, align 8, !tbaa !5
  %and = and i32 %3, %1
...
if.then28:                                        ; preds = %if.then26
  %4 = load i32, ptr %elf29, align 4, !tbaa !18
...
if.then39:                                        ; preds = %if.else33
  ...
  %.pre240 = load i32, ptr %archive, align 4, !tbaa !19
...
if.then41:                                        ; preds = %if.then39
  ...
  %.pre239 = load i32, ptr %archive, align 4, !tbaa !19
  br label %if.end44
...
if.then66:                                        ; preds = %if.else60
  ...
  %.pre238 = load i32, ptr %doc69, align 4, !tbaa !20
...
if.then68:                                        ; preds = %if.then66
  ...
  %.pre237 = load i32, ptr %doc69, align 4, !tbaa !20
  br label %if.end72
...
if.then94:                                        ; preds = %if.else88
  ...
  %.pre236 = load i32, ptr %mail97, align 4, !tbaa !21
...
if.then96:                                        ; preds = %if.then94
  ...
  %.pre235 = load i32, ptr %mail97, align 4, !tbaa !21
  br label %if.end100
...
if.then122:                                       ; preds = %if.else116
  ...
  %.pre234 = load i32, ptr %other125, align 4, !tbaa !22
...
if.then124:                                       ; preds = %if.then122
  ...
  %.pre233 = load i32, ptr %other125, align 4, !tbaa !22
  br label %if.end128
...
if.then150:                                       ; preds = %if.else144
  ...
  %.pre232 = load i32, ptr %phishing153, align 4, !tbaa !23
...
if.then152:                                       ; preds = %if.then150
  ...
  %.pre = load i32, ptr %phishing153, align 4, !tbaa !23
  br label %if.end156
...
for.inc:                                          ; preds = %if.then11, %if.then47, %if.then103, %if.else144, %if.then159, %if.then131, %if.then75, %if.then26, %if.then28, %if.end156, %if.end128, %if.end100, %if.end72, %if.end44, %if.end
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx = getelementptr inbounds [44 x %struct.dconf_module], ptr @modules, i64 0, i64 %indvars.iv.next
  %20 = load ptr, ptr %arrayidx, align 8, !tbaa !12
  %exitcond = icmp eq i64 %indvars.iv.next, 43
