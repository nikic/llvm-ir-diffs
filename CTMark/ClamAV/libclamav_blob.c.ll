; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_blob.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_blob.c"
...
while.cond.i:                                     ; preds = %if.end, %if.end.i
  ...
  %1 = load i8, ptr %name.addr.0.i, align 1
...
if.then.i:                                        ; preds = %while.cond.i
  store i8 95, ptr %name.addr.0.i, align 1
  br label %if.end.i
...
if.then:                                          ; preds = %while.cond
  store i8 95, ptr %name.addr.0, align 1
  br label %if.end
...
if.end26.thread:                                  ; preds = %if.then12
  ...
  store i64 %add23, ptr %size9, align 8
  store ptr %call17, ptr %data4, align 8
  br label %if.then29
...
if.then29:                                        ; preds = %if.else, %if.end26.thread, %if.end26
  ...
  %7 = load i64, ptr %len31, align 8
  %add33 = add nsw i64 %7, %len
  store i64 %add33, ptr %len31, align 8
  br label %return
...
if.end21:                                         ; preds = %cleanup.thread, %if.then4, %if.end
  store i32 1, ptr %isClosed, align 8
  br label %return
...
if.end:                                           ; preds = %entry
  ...
  %1 = load i64, ptr %len.i20, align 8
...
if.end.i:                                         ; preds = %if.end4
  ...
  %data.i25 = getelementptr inbounds %struct.blob, ptr %b2, i64 0, i32 1
  %3 = load ptr, ptr %data.i25, align 8
  %call11 = tail call i32 @memcmp(ptr noundef %2, ptr noundef %3, i64 noundef %0) #15
  br label %cleanup

cleanup:                                          ; preds = %if.end4, %if.end, %entry, %if.end.i
  %retval.0 = phi i32 [ %call11, %if.end.i ], [ 0, %entry ], [ 1, %if.end ], [ 0, %if.end4 ]
  ret i32 %retval.0
}
...
if.then15:                                        ; preds = %if.else
  %5 = load i64, ptr %size12, align 8
  %add17 = add nsw i64 %5, %len
  store i64 %add17, ptr %size12, align 8
...
if.end:                                           ; preds = %entry
  %call = tail call i32 @fileblobScan(ptr noundef %fb)
...
if.then24:                                        ; preds = %if.then18
  ...
  %8 = load ptr, ptr %fullname25, align 8
...
if.end36:                                         ; preds = %if.else, %if.else32, %if.then24, %if.end13
  ...
  %11 = load ptr, ptr %fullname37, align 8
...
if.end.i:                                         ; preds = %if.then.i, %if.end
  ...
  store ptr %call.i, ptr %b, align 8
...
while.cond.i.i:                                   ; preds = %if.end.i, %if.end.i.i
  ...
  %2 = load i8, ptr %name.addr.0.i.i, align 1
...
if.then.i.i:                                      ; preds = %while.cond.i.i
  store i8 95, ptr %name.addr.0.i.i, align 1
  br label %if.end.i.i
...
blobSetFilename.exit.loopexit:                    ; preds = %while.cond.i.i
  %b.val.pre = load ptr, ptr %b, align 8
...
if.end18.if.then21_crit_edge:                     ; preds = %if.end18
  %.pre = load i32, ptr %call9, align 4
  br label %if.then21
...
if.end59:                                         ; preds = %if.then43, %if.then50, %if.end40
  ...
  store ptr %call61, ptr %fullname62, align 8
  br label %cleanup
...
if.then20:                                        ; preds = %if.end14
  ...
  %5 = load ptr, ptr %scanned, align 8
...
if.then22:                                        ; preds = %if.then20
  ...
  %.pre83 = load i64, ptr %bytes_scanned15, align 8
  br label %if.end24

if.end24:                                         ; preds = %if.then22, %if.then20
  %7 = phi i64 [ %.pre83, %if.then22 ], [ %.pre, %if.then20 ]
  %add26 = add i64 %7, %len
  store i64 %add26, ptr %bytes_scanned15, align 8
...
if.end26.thread.i:                                ; preds = %if.then12.i
  %19 = load i64, ptr %size9.i, align 8
  %add23.i = add nsw i64 %19, %mul15.i
  store i64 %add23.i, ptr %size9.i, align 8
  store ptr %call17.i, ptr %data4.i, align 8
...
if.end26.i:                                       ; preds = %if.end3.i
  ...
  store ptr %call.i, ptr %data4.i, align 8
...
if.then29.i:                                      ; preds = %if.end26.i, %if.end26.thread.i, %if.else.i
  ...
  %21 = load i64, ptr %len31.i, align 8
  ...
  %22 = load i64, ptr %len31.i, align 8
  %add33.i = add nsw i64 %22, %len
  store i64 %add33.i, ptr %len31.i, align 8
  br label %return
