; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_nsis_nulsft.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_nsis_nulsft.c"
...
@.str.16 = private unnamed_addr constant [101 x i8] c"NSIS: out of memory at /home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_nsis_nulsft.c:236\0A\00", align 1
@.str.17 = private unnamed_addr constant [108 x i8] c"NSIS: cannot read %u bytes at /home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_nsis_nulsft.c:241\0A\00", align 1
@.str.18 = private unnamed_addr constant [112 x i8] c"NSIS: cannot write output file at /home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_nsis_nulsft.c:248\0A\00", align 1
@.str.19 = private unnamed_addr constant [112 x i8] c"NSIS: decompressor init failed at /home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_nsis_nulsft.c:255\0A\00", align 1
@.str.20 = private unnamed_addr constant [112 x i8] c"NSIS: cannot write output file at /home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_nsis_nulsft.c:270\0A\00", align 1
@.str.21 = private unnamed_addr constant [112 x i8] c"NSIS: xs looping, breaking out at /home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_nsis_nulsft.c:286\0A\00", align 1
@.str.22 = private unnamed_addr constant [98 x i8] c"NSIS: bad stream at /home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_nsis_nulsft.c:293\0A\00", align 1
@.str.23 = private unnamed_addr constant [112 x i8] c"NSIS: cannot write output file at /home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_nsis_nulsft.c:300\0A\00", align 1
...
@.str.26 = private unnamed_addr constant [108 x i8] c"NSIS: cannot read %u bytes at /home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_nsis_nulsft.c:324\0A\00", align 1
@.str.27 = private unnamed_addr constant [112 x i8] c"NSIS: xs looping, breaking out at /home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_nsis_nulsft.c:344\0A\00", align 1
@.str.28 = private unnamed_addr constant [98 x i8] c"NSIS: bad stream at /home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_nsis_nulsft.c:351\0A\00", align 1
...
@.str.30 = private unnamed_addr constant [112 x i8] c"NSIS: xs looping, breaking out at /home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_nsis_nulsft.c:378\0A\00", align 1
@.str.31 = private unnamed_addr constant [98 x i8] c"NSIS: bad stream at /home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_nsis_nulsft.c:391\0A\00", align 1
...
if.end:                                           ; preds = %land.lhs.true3, %land.lhs.true, %entry
  ...
  store i32 %desc, ptr %nsist, align 8
  %off = getelementptr inbounds %struct.nsis_st, ptr %nsist, i64 0, i32 2
  store i64 %offset, ptr %off, align 8
...
if.end20:                                         ; preds = %if.then18, %if.end16
  ...
  %4 = load i32, ptr %arec21, align 4
  %inc = add i32 %4, 1
  store i32 %inc, ptr %arec21, align 4
...
if.end.i.i:                                       ; preds = %lor.lhs.false4.i.i
  ...
  store i32 %add.ptr.val.i.i, ptr %hsz.i.i, align 4
  %add.ptr11.val.i.i = load i32, ptr %add.ptr11.i.i, align 8
  store i32 %add.ptr11.val.i.i, ptr %asz.i.i, align 8
  ...
  %12 = load i32, ptr %asz.i.i, align 8
...
if.then34.i.i:                                    ; preds = %if.else.i.i
  ...
  %.pre.i.i = load i32, ptr %asz.i.i, align 8
  br label %if.end36.i.i
...
if.end36.i.i:                                     ; preds = %if.then34.i.i, %if.else.i.i, %if.then21.i.i
  ...
  store i32 %sub38.i.i, ptr %asz.i.i, align 8
...
if.end58.peel.i.i:                                ; preds = %for.body.lr.ph.i.i
  ...
  store i8 %retval.0.i.peel.i.i, ptr %comp.i.i, align 8
...
if.end69.peel.i.i:                                ; preds = %if.then60.peel.i.i
  %18 = load i8, ptr %add.ptr45.i.i, align 4
  %cmp.i186.peel.i.i = icmp eq i8 %18, 49
  %b.val.i188.peel.i.i = load i32, ptr %add.ptr45.i.i, align 4
  %and.i189.peel.i.i = and i32 %b.val.i188.peel.i.i, 2147483647
  %cmp2.i190.peel.i.i = icmp eq i32 %and.i189.peel.i.i, 93
  %..i191.peel.i.i = select i1 %cmp2.i190.peel.i.i, i64 2, i64 3
  %retval.0.i192.peel.i.i = select i1 %cmp.i186.peel.i.i, i64 1, i64 %..i191.peel.i.i
  %arrayidx.peel.i.i = getelementptr inbounds [4 x i8], ptr %comps.i.i, i64 0, i64 %retval.0.i192.peel.i.i
  %19 = load i8, ptr %arrayidx.peel.i.i, align 1
  %inc73.peel.i.i = add i8 %19, 1
  store i8 %inc73.peel.i.i, ptr %arrayidx.peel.i.i, align 1
...
if.end75.peel.i.i:                                ; preds = %if.end69.peel.i.i, %if.end58.peel.i.i
  ...
  %20 = load i32, ptr %asz.i.i, align 8
...
for.inc.peel.i.i:                                 ; preds = %if.end82.peel.i.i
  %22 = load i32, ptr %asz.i.i, align 8
...
if.end69.i.i:                                     ; preds = %if.then60.i.i
  ...
  %25 = load i8, ptr %add.ptr45.i.i, align 4
  %cmp.i186.i.i = icmp eq i8 %25, 49
  %b.val.i188.i.i = load i32, ptr %add.ptr45.i.i, align 4
  %and.i189.i.i = and i32 %b.val.i188.i.i, 2147483647
  %cmp2.i190.i.i = icmp eq i32 %and.i189.i.i, 93
  %..i191.i.i = select i1 %cmp2.i190.i.i, i64 2, i64 3
  %retval.0.i192.i.i = select i1 %cmp.i186.i.i, i64 1, i64 %..i191.i.i
  ...
  store i8 %inc73.i.i, ptr %arrayidx.i.i, align 1
...
if.end75.i.i:                                     ; preds = %if.end69.i.i, %if.end58.i.i
  ...
  %27 = load i32, ptr %asz.i.i, align 8
  %cmp79.i.i = icmp ugt i32 %add77.i.i, %27
  br i1 %cmp79.i.i, label %cleanup.i.loopexit.i, label %if.end82.i.i

if.end82.i.i:                                     ; preds = %if.end75.i.i
  %28 = load i32, ptr %nsist, align 8
...
cleanup.i.loopexit.i:                             ; preds = %if.end75.i.i
  %29 = icmp ugt i32 %i.0206.i.i, 1
  br label %cleanup.i.i

cleanup.i.i:                                      ; preds = %cleanup.i.loopexit.i, %if.end75.peel.i.i
  %i.0206.lcssa207.i.i = phi i1 [ false, %if.end75.peel.i.i ], [ %29, %cleanup.i.loopexit.i ]
  store i8 1, ptr %solid.i.i, align 1
  br label %for.end.i.i

for.inc.i.i:                                      ; preds = %if.end82.i.i
  %inc90.i.i = add nuw nsw i32 %i.0206.i.i, 1
  %30 = load i32, ptr %asz.i.i, align 8
...
for.end.i.i:                                      ; preds = %for.inc.i.i, %cleanup.i.i
  %i.0202.i.i = phi i1 [ %i.0206.lcssa207.i.i, %cleanup.i.i ], [ true, %for.inc.i.i ]
  %or.cond.i.i = select i1 %cmp19.i.i, i1 %i.0202.i.i, i1 false
...
if.end97.i.i:                                     ; preds = %if.then95.i.i, %for.end.if.end97_crit_edge.i.i
  ...
  %33 = load i8, ptr %solid.i.i, align 1
...
if.then103.i.i:                                   ; preds = %if.end97.i.i
  %34 = load i8, ptr %arrayidx104.i.i, align 1
  %conv105.i.i = zext i8 %34 to i32
  %35 = load i8, ptr %arrayidx106.i.i, align 2
  %conv107.i.i = zext i8 %35 to i32
  %36 = load i8, ptr %arrayidx108.i.i, align 1
  ...
  store i8 %cond130.i.i, ptr %comp.i.i, align 8
  br label %if.end133.i.i

if.end133.i.i:                                    ; preds = %if.then103.i.i, %if.end97.i.i
  %37 = load i32, ptr %nsist, align 8
...
if.end43:                                         ; preds = %if.else40, %if.then37
  ...
  %46 = load i32, ptr %ofd, align 4
  %call45 = call i32 @close(i32 noundef %46) #9
  %47 = load i8, ptr @cli_leavetemps_flag, align 1
...
do.end.thread:                                    ; preds = %if.else, %do.cond, %do.end.thread.loopexit105, %do.end.thread92
  %48 = phi i32 [ 1, %do.end.thread92 ], [ %ret.1.fr, %do.end.thread.loopexit105 ], [ 0, %do.cond ], [ 0, %if.else ]
  %freecomp.i.i = getelementptr inbounds %struct.nsis_st, ptr %nsist, i64 0, i32 14
  %49 = load i8, ptr %freecomp.i.i, align 2
  %tobool.not.i.i = icmp eq i8 %49, 0
  br i1 %tobool.not.i.i, label %nsis_shutdown.exit.i, label %if.end.i.i82

if.end.i.i82:                                     ; preds = %do.end.thread
  %50 = load i8, ptr %comp.i.i, align 8
  switch i8 %50, label %sw.epilog.i.i [
    i8 1, label %sw.bb.i.i
    i8 2, label %sw.bb1.i.i
  ]

sw.bb.i.i:                                        ; preds = %if.end.i.i82
  %bz.i.i = getelementptr inbounds %struct.nsis_st, ptr %nsist, i64 0, i32 8
  %call.i.i85 = call i32 @nsis_BZ2_bzDecompressEnd(ptr noundef nonnull %bz.i.i) #9
  br label %sw.epilog.i.i

sw.bb1.i.i:                                       ; preds = %if.end.i.i82
  %lz.i.i = getelementptr inbounds %struct.nsis_st, ptr %nsist, i64 0, i32 9
  call void @lzmaShutdown(ptr noundef nonnull %lz.i.i) #9
  br label %sw.epilog.i.i

sw.epilog.i.i:                                    ; preds = %sw.bb1.i.i, %sw.bb.i.i, %if.end.i.i82
  store i8 0, ptr %freecomp.i.i, align 2
  br label %nsis_shutdown.exit.i

nsis_shutdown.exit.i:                             ; preds = %sw.epilog.i.i, %do.end.thread
  %51 = load i8, ptr %solid.i.i, align 1
...
land.lhs.true.i:                                  ; preds = %nsis_shutdown.exit.i
  ...
  %52 = load ptr, ptr %freeme.i, align 8
...
if.end61:                                         ; preds = %if.then58, %cli_nsis_free.exit
  ...
  %56 = load i32, ptr %arec21, align 4
  %dec = add i32 %56, -1
  store i32 %dec, ptr %arec21, align 4
  br label %cleanup
...
land.lhs.true:                                    ; preds = %if.end
  ...
  %2 = load i32, ptr %maxfiles, align 4
...
if.end19:                                         ; preds = %if.else, %if.then13
  %6 = load i32, ptr %fno11, align 8
  %inc = add i32 %6, 1
  store i32 %inc, ptr %fno11, align 8
  ...
  store i32 %call23, ptr %ofd, align 4
...
if.then49:                                        ; preds = %if.end44
  ...
  %13 = load i32, ptr %ofd, align 4
  %call51 = call i32 @close(i32 noundef %13) #9
  br label %cleanup388

if.end52:                                         ; preds = %if.end44
  %sub54 = sub i32 %sub, %and
  store i32 %sub54, ptr %asz, align 8
  %14 = load ptr, ptr %limits, align 8
...
if.end77:                                         ; preds = %if.end52.if.end77_crit_edge, %land.lhs.true57
  %conv78.pre-phi = phi i64 [ %.pre550, %if.end52.if.end77_crit_edge ], [ %conv, %land.lhs.true57 ]
...
while.body:                                       ; preds = %while.cond
  ...
  store i32 %conv126, ptr %size, align 4
...
if.end139:                                        ; preds = %if.then128
  store ptr %obuf, ptr %next_out, align 8
  store i32 8192, ptr %avail_out, align 8
  %33 = load ptr, ptr %limits, align 8
...
if.else200:                                       ; preds = %if.end28
  ...
  %41 = load ptr, ptr %freeme, align 8
...
return.sink.split.i:                              ; preds = %sw.bb4.i, %sw.bb2.i, %sw.bb.i
  ...
  store i8 %.sink.i, ptr %freecomp.i, align 2
  br label %if.end209
...
if.end218:                                        ; preds = %if.end209
  ...
  %47 = load i32, ptr %asz210, align 8
  ...
  %48 = load i32, ptr %asz210, align 8
...
if.end232:                                        ; preds = %if.end218
  ...
  store ptr %50, ptr %next_in235, align 8
  store i32 %48, ptr %nsis234, align 8
  br label %if.end239
...
if.end247:                                        ; preds = %if.end239
  ...
  store ptr %obuf, ptr %next_out250, align 8
  %avail_out252 = getelementptr inbounds %struct.nsis_st, ptr %n, i64 0, i32 7, i32 2
  store i32 4, ptr %avail_out252, align 8
...
while.body257:                                    ; preds = %if.end247
  %53 = load ptr, ptr %next_out250, align 8
...
while.body257.1:                                  ; preds = %if.end267
  %54 = load ptr, ptr %next_out250, align 8
...
while.body257.2:                                  ; preds = %if.end267.1
  %55 = load ptr, ptr %next_out250, align 8
...
while.body257.3:                                  ; preds = %if.end267.2
  %56 = load ptr, ptr %next_out250, align 8
...
while.body257.4:                                  ; preds = %if.end267.3
  %57 = load ptr, ptr %next_out250, align 8
...
while.body257.5:                                  ; preds = %if.end267.4
  %58 = load ptr, ptr %next_out250, align 8
...
while.body257.6:                                  ; preds = %if.end267.5
  %59 = load ptr, ptr %next_out250, align 8
...
while.body257.7:                                  ; preds = %if.end267.6
  %60 = load ptr, ptr %next_out250, align 8
...
while.body257.8:                                  ; preds = %if.end267.7
  %61 = load ptr, ptr %next_out250, align 8
...
while.body257.9:                                  ; preds = %if.end267.8
  %62 = load ptr, ptr %next_out250, align 8
...
while.body257.10:                                 ; preds = %if.end267.9
  %63 = load ptr, ptr %next_out250, align 8
...
while.body257.11:                                 ; preds = %if.end267.10
  %64 = load ptr, ptr %next_out250, align 8
...
while.body257.12:                                 ; preds = %if.end267.11
  %65 = load ptr, ptr %next_out250, align 8
...
while.body257.13:                                 ; preds = %if.end267.12
  %66 = load ptr, ptr %next_out250, align 8
...
while.body257.14:                                 ; preds = %if.end267.13
  %67 = load ptr, ptr %next_out250, align 8
...
while.body257.15:                                 ; preds = %if.end267.14
  %68 = load ptr, ptr %next_out250, align 8
...
while.body257.16:                                 ; preds = %if.end267.15
  %69 = load ptr, ptr %next_out250, align 8
...
while.body257.17:                                 ; preds = %if.end267.16
  %70 = load ptr, ptr %next_out250, align 8
...
while.body257.18:                                 ; preds = %if.end267.17
  %71 = load ptr, ptr %next_out250, align 8
...
while.body257.19:                                 ; preds = %if.end267.18
  %72 = load ptr, ptr %next_out250, align 8
...
while.body257.20:                                 ; preds = %if.end267.19
  %73 = load ptr, ptr %next_out250, align 8
...
if.end279:                                        ; preds = %while.body257.20, %while.body257.19, %while.body257.18, %while.body257.17, %while.body257.16, %while.body257.15, %while.body257.14, %while.body257.13, %while.body257.12, %while.body257.11, %while.body257.10, %while.body257.9, %while.body257.8, %while.body257.7, %while.body257.6, %while.body257.5, %while.body257.4, %while.body257.3, %while.body257.2, %while.body257.1, %while.body257
  ...
  store i32 %obuf.val, ptr %size, align 4
  %75 = load ptr, ptr %limits, align 8
...
land.lhs.true284:                                 ; preds = %if.end279
  ...
  %76 = load i64, ptr %maxfilesize286, align 8
...
if.end299:                                        ; preds = %land.lhs.true284, %if.end279
  ...
  store i32 %cond, ptr %avail_out252, align 8
  %tobool308.not545 = icmp eq i32 %obuf.val, 0
  br i1 %tobool308.not545, label %cleanup388, label %land.rhs

land.rhs:                                         ; preds = %if.end299, %cleanup
  %loops.3546 = phi i32 [ %loops.5, %cleanup ], [ 0, %if.end299 ]
...
while.body312:                                    ; preds = %land.rhs
  %78 = load ptr, ptr %next_out250, align 8
...
if.end332:                                        ; preds = %if.then321
  ...
  store i32 %sub333, ptr %size, align 4
  store ptr %obuf, ptr %next_out250, align 8
  %cond342 = call i32 @llvm.umin.i32(i32 %sub333, i32 8192)
  store i32 %cond342, ptr %avail_out252, align 8
  br label %cleanup

if.else345:                                       ; preds = %while.body312
  %inc346 = add i32 %loops.3546, 1
...
if.else345.cleanup_crit_edge:                     ; preds = %if.else345
  %.pre549 = load i32, ptr %size, align 4
  br label %cleanup
...
cleanup:                                          ; preds = %if.else345.cleanup_crit_edge, %if.end332
  %82 = phi i32 [ %sub333, %if.end332 ], [ %.pre549, %if.else345.cleanup_crit_edge ]
  %loops.5 = phi i32 [ %loops.3546, %if.end332 ], [ %inc346, %if.else345.cleanup_crit_edge ]
...
if.then355:                                       ; preds = %land.rhs, %while.end352.thread
  %83 = load i32, ptr %ofd, align 4
  %84 = load ptr, ptr %next_out250, align 8
  ...
  %85 = load ptr, ptr %next_out250, align 8
...
sw.bb4:                                           ; preds = %entry
  ...
  store i32 8, ptr %blocks, align 8
  ...
  store ptr %window, ptr %read, align 8
...
return.sink.split:                                ; preds = %sw.bb, %sw.bb4, %sw.bb2
  ...
  store i8 %.sink, ptr %freecomp, align 2
  br label %return
...
sw.epilog104.sink.split:                          ; preds = %sw.bb, %sw.bb30, %sw.bb67
  ...
  %13 = load i32, ptr %avail_in70.sink, align 8
  store i32 %13, ptr %nsis68.sink, align 8
  %14 = load ptr, ptr %z.sink, align 8
  store ptr %14, ptr %next_in72.sink, align 8
  %15 = load i32, ptr %avail_out78.sink, align 8
  store i32 %15, ptr %avail_out76.sink, align 8
  %16 = load ptr, ptr %next_out82.sink, align 8
  store ptr %16, ptr %next_out80.sink, align 8
...
entry:
  %freecomp = getelementptr inbounds %struct.nsis_st, ptr %n, i64 0, i32 14
  %0 = load i8, ptr %freecomp, align 2
  %tobool.not = icmp eq i8 %0, 0
  br i1 %tobool.not, label %return, label %if.end

if.end:                                           ; preds = %entry
  %comp = getelementptr inbounds %struct.nsis_st, ptr %n, i64 0, i32 12
  %1 = load i8, ptr %comp, align 8
...
sw.epilog:                                        ; preds = %if.end, %sw.bb1, %sw.bb
  store i8 0, ptr %freecomp, align 2
  br label %return
