...
if.then.i:                                        ; preds = %if.end85
  %bi_buf.i = getelementptr inbounds %struct.internal_state, ptr %s, i64 0, i32 56
  %pending_buf.i = getelementptr inbounds %struct.internal_state, ptr %s, i64 0, i32 2
  %18 = load ptr, ptr %pending_buf.i, align 8, !tbaa !25
  %pending.i = getelementptr inbounds %struct.internal_state, ptr %s, i64 0, i32 5
  %19 = load i64, ptr %pending.i, align 8, !tbaa !26
  %inc.i = add i64 %19, 1
  store i64 %inc.i, ptr %pending.i, align 8, !tbaa !26
  %arrayidx.i = getelementptr inbounds i8, ptr %18, i64 %19
  store i8 %conv1.i, ptr %arrayidx.i, align 1, !tbaa !21
  %20 = load i16, ptr %bi_buf.i, align 8, !tbaa !19
  %21 = lshr i16 %20, 8
  %conv4.i = trunc i16 %21 to i8
  %22 = load ptr, ptr %pending_buf.i, align 8, !tbaa !25
  %23 = load i64, ptr %pending.i, align 8, !tbaa !26
  %inc7.i = add i64 %23, 1
  store i64 %inc7.i, ptr %pending.i, align 8, !tbaa !26
...
if.then14.i:                                      ; preds = %if.else.i
  %bi_buf15.i = getelementptr inbounds %struct.internal_state, ptr %s, i64 0, i32 56
  %pending_buf17.i = getelementptr inbounds %struct.internal_state, ptr %s, i64 0, i32 2
  %24 = load ptr, ptr %pending_buf17.i, align 8, !tbaa !25
  %pending18.i = getelementptr inbounds %struct.internal_state, ptr %s, i64 0, i32 5
  %25 = load i64, ptr %pending18.i, align 8, !tbaa !26
  %inc19.i = add i64 %25, 1
  store i64 %inc19.i, ptr %pending18.i, align 8, !tbaa !26
  %arrayidx20.i = getelementptr inbounds i8, ptr %24, i64 %25
  store i8 %conv1.i, ptr %arrayidx20.i, align 1, !tbaa !21
  %26 = load i16, ptr %bi_buf15.i, align 8, !tbaa !19
  %27 = lshr i16 %26, 8
  store i16 %27, ptr %bi_buf15.i, align 8, !tbaa !19
  %28 = load i32, ptr %bi_valid, align 4, !tbaa !20
...
for.body.i39.i:                                   ; preds = %for.inc.i70.i, %for.body.lr.ph.i30.i
  ...
  %44 = load i16, ptr %dl9.i47.i, align 2, !tbaa !21
  %conv10.i48.i = zext i16 %44 to i32
...
if.then18.i82.i:                                  ; preds = %if.else.i53.i
  ...
  %45 = load i16, ptr %arrayidx20.i84.i, align 4, !tbaa !21
  %46 = trunc i32 %inc.i49.i to i16
  %conv23.i85.i = add i16 %45, %46
  store i16 %conv23.i85.i, ptr %arrayidx20.i84.i, align 4, !tbaa !21
...
if.then30.i59.i:                                  ; preds = %if.then27.i57.i
  ...
  %47 = load i16, ptr %arrayidx33.i61.i, align 4, !tbaa !21
  %inc35.i62.i = add i16 %47, 1
  store i16 %inc35.i62.i, ptr %arrayidx33.i61.i, align 4, !tbaa !21
  br label %if.end36.i63.i

if.end36.i63.i:                                   ; preds = %if.then30.i59.i, %if.then27.i57.i
  %48 = load i16, ptr %arrayidx38.i35.i, align 4, !tbaa !21
  %inc40.i64.i = add i16 %48, 1
  store i16 %inc40.i64.i, ptr %arrayidx38.i35.i, align 4, !tbaa !21
  br label %if.end57.i65.i
...
if.then44.i80.i:                                  ; preds = %if.else41.i76.i
  %49 = load i16, ptr %arrayidx46.i37.i, align 4, !tbaa !21
  %inc48.i81.i = add i16 %49, 1
  store i16 %inc48.i81.i, ptr %arrayidx46.i37.i, align 4, !tbaa !21
  br label %if.end57.i65.i

if.else49.i78.i:                                  ; preds = %if.else41.i76.i
  %50 = load i16, ptr %arrayidx51.i36.i, align 4, !tbaa !21
  %inc53.i79.i = add i16 %50, 1
  store i16 %inc53.i79.i, ptr %arrayidx51.i36.i, align 4, !tbaa !21
  br label %if.end57.i65.i

if.end57.i65.i:                                   ; preds = %if.else49.i78.i, %if.then44.i80.i, %if.end36.i63.i, %if.then18.i82.i
  %cmp58.i66.i = icmp eq i16 %44, 0
...
for.inc.i70.i:                                    ; preds = %if.else61.i67.i, %if.end57.i65.i, %for.body.i39.i
  ...
  br i1 %exitcond.not.i75.i, label %scan_tree.exit86.i, label %for.body.i39.i, !llvm.loop !33
...
if.then18:                                        ; preds = %if.end14
  ...
  br label %for.body.i211.preheader
...
if.then.i:                                        ; preds = %if.end119
  ...
  %inc.i = add i64 %98, 1
  store i64 %inc.i, ptr %pending.i, align 8, !tbaa !26
  %arrayidx.i210 = getelementptr inbounds i8, ptr %97, i64 %98
  store i8 %conv8.i, ptr %arrayidx.i210, align 1, !tbaa !21
...
for.body.i:                                       ; preds = %if.end209.i, %for.body.lr.ph.i
  ...
  %indvars.iv.i206 = phi i64 [ 0, %for.body.lr.ph.i ], [ %indvars.iv.next.i208, %if.end209.i ]
  %cmp151.i = icmp sgt i32 %127, 13
  %arrayidx155.i = getelementptr inbounds [19 x i8], ptr @bl_order, i64 0, i64 %indvars.iv.i206
  %128 = load i8, ptr %arrayidx155.i, align 1, !tbaa !21
  %idxprom156.i = zext i8 %128 to i64
  %dl.i207 = getelementptr inbounds %struct.internal_state, ptr %s, i64 0, i32 39, i64 %idxprom156.i, i32 1
  %129 = load i16, ptr %dl.i207, align 2, !tbaa !21
...
if.end209.i:                                      ; preds = %if.else193.i, %if.then153.i
  ...
  br i1 %exitcond.not.i209, label %send_all_trees.exit, label %for.body.i, !llvm.loop !38

send_all_trees.exit:                              ; preds = %if.end209.i
  %dyn_ltree.i204 = getelementptr inbounds %struct.internal_state, ptr %s, i64 0, i32 37
  tail call fastcc void @send_tree(ptr noundef nonnull %s, ptr noundef nonnull %dyn_ltree.i204, i32 noundef %94)
  %dyn_dtree.i205 = getelementptr inbounds %struct.internal_state, ptr %s, i64 0, i32 38
  tail call fastcc void @send_tree(ptr noundef nonnull %s, ptr noundef nonnull %dyn_dtree.i205, i32 noundef %95)
  tail call fastcc void @compress_block(ptr noundef nonnull %s, ptr noundef nonnull %dyn_ltree.i204, ptr noundef nonnull %dyn_dtree.i205)
  br label %for.body.i211.preheader

for.body.i211.preheader:                          ; preds = %if.end63, %send_all_trees.exit, %if.then18
  br label %for.body.i211

for.body.i211:                                    ; preds = %for.body.i211, %for.body.i211.preheader
  %indvars.iv.i212 = phi i64 [ 0, %for.body.i211.preheader ], [ %indvars.iv.next.i214.1, %for.body.i211 ]
  %arrayidx.i213 = getelementptr inbounds %struct.internal_state, ptr %s, i64 0, i32 37, i64 %indvars.iv.i212
  store i16 0, ptr %arrayidx.i213, align 4, !tbaa !21
  %indvars.iv.next.i214 = or i64 %indvars.iv.i212, 1
  %arrayidx.i213.1 = getelementptr inbounds %struct.internal_state, ptr %s, i64 0, i32 37, i64 %indvars.iv.next.i214
  store i16 0, ptr %arrayidx.i213.1, align 4, !tbaa !21
  %indvars.iv.next.i214.1 = add nuw nsw i64 %indvars.iv.i212, 2
  %exitcond.not.i215.1 = icmp eq i64 %indvars.iv.next.i214.1, 286
  br i1 %exitcond.not.i215.1, label %init_block.exit, label %for.body.i211, !llvm.loop !22

init_block.exit:                                  ; preds = %for.body.i211
...
if.then.i220:                                     ; preds = %if.then129
  %bi_buf.i221 = getelementptr inbounds %struct.internal_state, ptr %s, i64 0, i32 56
  %140 = load i16, ptr %bi_buf.i221, align 8, !tbaa !19
  %conv1.i = trunc i16 %140 to i8
  %pending_buf.i222 = getelementptr inbounds %struct.internal_state, ptr %s, i64 0, i32 2
  %141 = load ptr, ptr %pending_buf.i222, align 8, !tbaa !25
  %pending.i223 = getelementptr inbounds %struct.internal_state, ptr %s, i64 0, i32 5
  %142 = load i64, ptr %pending.i223, align 8, !tbaa !26
  %inc.i224 = add i64 %142, 1
  store i64 %inc.i224, ptr %pending.i223, align 8, !tbaa !26
  %arrayidx.i225 = getelementptr inbounds i8, ptr %141, i64 %142
  store i8 %conv1.i, ptr %arrayidx.i225, align 1, !tbaa !21
  %143 = load i16, ptr %bi_buf.i221, align 8, !tbaa !19
  %144 = lshr i16 %143, 8
  %conv4.i = trunc i16 %144 to i8
  %145 = load ptr, ptr %pending_buf.i222, align 8, !tbaa !25
  %146 = load i64, ptr %pending.i223, align 8, !tbaa !26
  %inc7.i = add i64 %146, 1
  store i64 %inc7.i, ptr %pending.i223, align 8, !tbaa !26
  %arrayidx8.i = getelementptr inbounds i8, ptr %145, i64 %146
  store i8 %conv4.i, ptr %arrayidx8.i, align 1, !tbaa !21
  br label %bi_windup.exit

if.else.i219:                                     ; preds = %if.then129
  %cmp10.i = icmp sgt i32 %139, 0
  br i1 %cmp10.i, label %if.then12.i, label %bi_windup.exit

if.then12.i:                                      ; preds = %if.else.i219
...
bi_windup.exit:                                   ; preds = %if.then.i220, %if.else.i219, %if.then12.i
  %bi_buf20.i = getelementptr inbounds %struct.internal_state, ptr %s, i64 0, i32 56
  store i16 0, ptr %bi_buf20.i, align 8, !tbaa !19
...
land.lhs.true78.i234:                             ; preds = %lor.lhs.false64.i224
  ...
  %46 = load i8, ptr %arrayidx88.i235, align 1, !tbaa !21
...
if.end93.i226:                                    ; preds = %land.lhs.true78.i234, %lor.lhs.false64.i224
  ...
  store i32 %43, ptr %arrayidx99.i228, align 4, !tbaa !46
  %j.0.i229 = shl i32 %j.1.i219, 1
  %47 = load i32, ptr %heap_len, align 4, !tbaa !44
  %cmp.not.i230 = icmp sgt i32 %j.0.i229, %47
  br i1 %cmp.not.i230, label %pqdownheap.exit255, label %while.body.i211, !llvm.loop !50
...
pqdownheap.exit255:                               ; preds = %if.end.i217, %land.lhs.true78.i234, %if.end93.i226, %do.body
  ...
  store i32 %34, ptr %arrayidx103.i233, align 4, !tbaa !46
...
land.lhs.true78.i286:                             ; preds = %lor.lhs.false64.i276
  ...
  %68 = load i8, ptr %arrayidx88.i287, align 1, !tbaa !21
...
if.end93.i278:                                    ; preds = %land.lhs.true78.i286, %lor.lhs.false64.i276
  ...
  store i32 %65, ptr %arrayidx99.i280, align 4, !tbaa !46
  %j.0.i281 = shl i32 %j.1.i271, 1
  %69 = load i32, ptr %heap_len, align 4, !tbaa !44
  %cmp.not.i282 = icmp sgt i32 %j.0.i281, %69
  br i1 %cmp.not.i282, label %pqdownheap.exit307, label %while.body.i263, !llvm.loop !50
...
pqdownheap.exit307:                               ; preds = %if.end.i269, %land.lhs.true78.i286, %if.end93.i278, %pqdownheap.exit255
  ...
  store i32 %55, ptr %arrayidx103.i285, align 4, !tbaa !46
...
if.end126:                                        ; preds = %if.else111, %if.then69
  ...
  store i32 %storemerge, ptr %bi_valid65, align 4, !tbaa !20
...
do.cond.sink.split:                               ; preds = %if.then275, %if.else311, %if.then12, %if.else
  ...
  store i32 %storemerge552.sink, ptr %bi_valid65, align 4, !tbaa !20
  br label %do.cond
...
if.end388:                                        ; preds = %if.else376, %if.then337
  ...
  store i32 %storemerge553, ptr %bi_valid333, align 4, !tbaa !20
  ret void
}
...
if.else70:                                        ; preds = %if.else
  ...
  %15 = load i32, ptr %bi_valid83, align 4, !tbaa !20
...
if.then76:                                        ; preds = %if.then73
  ...
  %16 = load i16, ptr %dl81, align 2, !tbaa !21
...
if.end207:                                        ; preds = %if.else194, %if.then154
  ...
  store i32 %storemerge722, ptr %bi_valid83, align 4, !tbaa !20
...
if.then276:                                       ; preds = %if.then266
  ...
  %53 = load ptr, ptr %pending_buf106, align 8, !tbaa !25
  %54 = load i64, ptr %pending107, align 8, !tbaa !26
  %inc296 = add i64 %54, 1
  ...
  %55 = load i16, ptr %bi_buf136, align 8, !tbaa !19
  %56 = lshr i16 %55, 8
  %conv301 = trunc i16 %56 to i8
  %57 = load ptr, ptr %pending_buf106, align 8, !tbaa !25
  %58 = load i64, ptr %pending107, align 8, !tbaa !26
  %inc304 = add i64 %58, 1
  ...
  %59 = load i32, ptr %bi_valid83, align 4, !tbaa !20
...
if.then335:                                       ; preds = %if.end329
  ...
  %62 = load ptr, ptr %pending_buf106, align 8, !tbaa !25
  %63 = load i64, ptr %pending107, align 8, !tbaa !26
  %inc352 = add i64 %63, 1
  ...
  %64 = load i16, ptr %bi_buf136, align 8, !tbaa !19
  %65 = lshr i16 %64, 8
  %conv357 = trunc i16 %65 to i8
  %66 = load ptr, ptr %pending_buf106, align 8, !tbaa !25
  %67 = load i64, ptr %pending107, align 8, !tbaa !26
  %inc360 = add i64 %67, 1
  ...
  %68 = load i32, ptr %bi_valid83, align 4, !tbaa !20
...
if.then395:                                       ; preds = %if.else385
  ...
  %73 = load ptr, ptr %pending_buf106, align 8, !tbaa !25
  %74 = load i64, ptr %pending107, align 8, !tbaa !26
  %inc415 = add i64 %74, 1
  ...
  %75 = load i16, ptr %bi_buf136, align 8, !tbaa !19
  %76 = lshr i16 %75, 8
  %conv420 = trunc i16 %76 to i8
  %77 = load ptr, ptr %pending_buf106, align 8, !tbaa !25
  %78 = load i64, ptr %pending107, align 8, !tbaa !26
  %inc423 = add i64 %78, 1
  ...
  %79 = load i32, ptr %bi_valid83, align 4, !tbaa !20
...
if.then454:                                       ; preds = %if.end448
  ...
  %82 = load ptr, ptr %pending_buf106, align 8, !tbaa !25
  %83 = load i64, ptr %pending107, align 8, !tbaa !26
  %inc471 = add i64 %83, 1
  ...
  %84 = load i16, ptr %bi_buf136, align 8, !tbaa !19
  %85 = lshr i16 %84, 8
  %conv476 = trunc i16 %85 to i8
  %86 = load ptr, ptr %pending_buf106, align 8, !tbaa !25
  %87 = load i64, ptr %pending107, align 8, !tbaa !26
  %inc479 = add i64 %87, 1
  ...
  %88 = load i32, ptr %bi_valid83, align 4, !tbaa !20
