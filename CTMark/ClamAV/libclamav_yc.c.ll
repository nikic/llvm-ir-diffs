; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_yc.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_yc.c"
...
entry:
  ...
  %1 = load i16, ptr %SizeOfOptionalHeader, align 4
  ...
  %call = tail call fastcc i32 @yc_poly_emulator(ptr noundef nonnull %add.ptr6, ptr noundef nonnull %add.ptr9, i32 noundef 2967)
...
if.end51:                                         ; preds = %lor.lhs.false
  ...
  %13 = load i32, ptr %ursz62, align 4
  %call63 = tail call fastcc i32 @yc_poly_emulator(ptr noundef nonnull %add.ptr54, ptr noundef %add.ptr59, i32 noundef %13)
...
for.end:                                          ; preds = %for.inc, %if.end
  ...
  store i16 %conv67, ptr %NumberOfSections, align 2
...
sw.bb30:                                          ; preds = %for.body5
  ...
  %4 = load i8, ptr %arrayidx34, align 1
...
for.end:                                          ; preds = %for.inc
  ...
  store i8 %al.1, ptr %arrayidx, align 1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
