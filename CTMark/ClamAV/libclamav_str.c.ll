...
if.end3.i153:                                     ; preds = %if.end.i146
  ...
  %.pn.i155 = load ptr, ptr %call9.i154, align 8, !tbaa !8
  %__res.0.in.i156 = getelementptr inbounds i32, ptr %.pn.i155, i64 %idxprom.i148
  %__res.0.i157 = load i32, ptr %__res.0.in.i156, align 4, !tbaa !12
...
if.end3.i172:                                     ; preds = %if.end.i165
  ...
  %.pn.i174 = load ptr, ptr %call9.i173, align 8, !tbaa !8
  %__res.0.in.i175 = getelementptr inbounds i32, ptr %.pn.i174, i64 %idxprom.i167
  %__res.0.i176 = load i32, ptr %__res.0.in.i175, align 4, !tbaa !12
...
if.end.i184:                                      ; preds = %if.then78
  ...
  %18 = load i16, ptr %arrayidx.i187, align 2, !tbaa !10
  %19 = and i16 %18, 2048
...
if.end3.i191:                                     ; preds = %if.end.i184
  ...
  %.pn.i193 = load ptr, ptr %call9.i192, align 8, !tbaa !8
  %__res.0.in.i194 = getelementptr inbounds i32, ptr %.pn.i193, i64 %idxprom.i186
  %__res.0.i195 = load i32, ptr %__res.0.in.i194, align 4, !tbaa !12
...
if.end.i56:                                       ; preds = %if.then14
  ...
  %8 = load i16, ptr %arrayidx.i59, align 2, !tbaa !10
  %9 = and i16 %8, 2048
...
if.end3.i63:                                      ; preds = %if.end.i56
  ...
  %.pn.i65 = load ptr, ptr %call9.i64, align 8, !tbaa !8
  %__res.0.in.i66 = getelementptr inbounds i32, ptr %.pn.i65, i64 %idxprom.i58
  %__res.0.i67 = load i32, ptr %__res.0.in.i66, align 4, !tbaa !12
