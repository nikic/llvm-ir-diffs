; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_str.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_str.c"
...
if.else.thread:                                   ; preds = %land.lhs.true
  ...
  %2 = load i8, ptr %arrayidx22230, align 1
...
if.end3.i:                                        ; preds = %if.end.i
  ...
  %.pn.i = load ptr, ptr %call9.i, align 8
  %__res.0.in.i = getelementptr inbounds i32, ptr %.pn.i, i64 %idxprom.i
  %__res.0.i = load i32, ptr %__res.0.in.i, align 4
...
if.then46:                                        ; preds = %if.else.thread, %if.else40
  ...
  br i1 %cmp.i144, label %if.end.i146, label %if.else56

if.end.i146:                                      ; preds = %if.then46
  %call.i147 = tail call ptr @__ctype_b_loc() #15
  %9 = load ptr, ptr %call.i147, align 8
  %idxprom.i148 = zext i32 %conv23233239 to i64
  %arrayidx.i149 = getelementptr inbounds i16, ptr %9, i64 %idxprom.i148
  %10 = load i16, ptr %arrayidx.i149, align 2
  %11 = and i16 %10, 2048
  %tobool.not.i150 = icmp eq i16 %11, 0
  br i1 %tobool.not.i150, label %if.end3.i153, label %cli_hex2int.exit162

if.end3.i153:                                     ; preds = %if.end.i146
  %call9.i154 = tail call ptr @__ctype_tolower_loc() #15
  %.pn.i155 = load ptr, ptr %call9.i154, align 8
  %__res.0.in.i156 = getelementptr inbounds i32, ptr %.pn.i155, i64 %idxprom.i148
  %__res.0.i157 = load i32, ptr %__res.0.in.i156, align 4
  %12 = add i32 %__res.0.i157, -97
  %or.cond21.i158 = icmp ult i32 %12, 6
  br i1 %or.cond21.i158, label %cli_hex2int.exit162.thread209, label %if.end20.i159

cli_hex2int.exit162.thread209:                    ; preds = %if.end3.i153
  %sub19.i161 = add nsw i32 %__res.0.i157, -87
  br label %if.then54

if.end20.i159:                                    ; preds = %if.end3.i153
  tail call void (ptr, ...) @cli_errmsg(ptr noundef nonnull @.str.5, i32 noundef %__res.0.i157) #14
  br label %if.else56

cli_hex2int.exit162:                              ; preds = %if.end.i146
  %sub.i152 = add nsw i32 %conv23233239, -48
...
if.then54:                                        ; preds = %cli_hex2int.exit162.thread209, %cli_hex2int.exit162
  %retval.0.i145212 = phi i32 [ %sub19.i161, %cli_hex2int.exit162.thread209 ], [ %sub.i152, %cli_hex2int.exit162 ]
  %13 = trunc i32 %retval.0.i145212 to i16
  %conv60 = or i16 %13, 1024
  br label %if.end99

if.else56:                                        ; preds = %if.then46, %cli_hex2int.exit162, %if.end20.i159
  tail call void @free(ptr noundef %call3) #14
  br label %cleanup

if.else71:                                        ; preds = %if.else40
  %cmp.i163 = icmp sgt i8 %0, -1
  br i1 %cmp.i163, label %if.end.i165, label %if.else94

if.end.i165:                                      ; preds = %if.else71
  %call.i166 = tail call ptr @__ctype_b_loc() #15
  %14 = load ptr, ptr %call.i166, align 8
  %idxprom.i167 = zext i32 %conv43 to i64
  %arrayidx.i168 = getelementptr inbounds i16, ptr %14, i64 %idxprom.i167
  %15 = load i16, ptr %arrayidx.i168, align 2
  %16 = and i16 %15, 2048
  %tobool.not.i169 = icmp eq i16 %16, 0
  br i1 %tobool.not.i169, label %if.end3.i172, label %cli_hex2int.exit181

if.end3.i172:                                     ; preds = %if.end.i165
  %call9.i173 = tail call ptr @__ctype_tolower_loc() #15
  %.pn.i174 = load ptr, ptr %call9.i173, align 8
  %__res.0.in.i175 = getelementptr inbounds i32, ptr %.pn.i174, i64 %idxprom.i167
  %__res.0.i176 = load i32, ptr %__res.0.in.i175, align 4
  %17 = add i32 %__res.0.i176, -97
  %or.cond21.i177 = icmp ult i32 %17, 6
  br i1 %or.cond21.i177, label %cli_hex2int.exit181.thread215, label %if.end20.i178

cli_hex2int.exit181.thread215:                    ; preds = %if.end3.i172
  %sub19.i180 = add nsw i32 %__res.0.i176, -87
  br label %if.then78

if.end20.i178:                                    ; preds = %if.end3.i172
  tail call void (ptr, ...) @cli_errmsg(ptr noundef nonnull @.str.5, i32 noundef %__res.0.i176) #14
  br label %if.else94

cli_hex2int.exit181:                              ; preds = %if.end.i165
  %sub.i171 = add nsw i32 %conv43, -48
...
if.then78:                                        ; preds = %cli_hex2int.exit181.thread215, %cli_hex2int.exit181
  %retval.0.i164218 = phi i32 [ %sub19.i180, %cli_hex2int.exit181.thread215 ], [ %sub.i171, %cli_hex2int.exit181 ]
  %cmp.i182 = icmp sgt i8 %1, -1
  br i1 %cmp.i182, label %if.end.i184, label %if.else92

if.end.i184:                                      ; preds = %if.then78
  %idxprom.i186 = zext i32 %conv23 to i64
  %arrayidx.i187 = getelementptr inbounds i16, ptr %14, i64 %idxprom.i186
  %18 = load i16, ptr %arrayidx.i187, align 2
  %19 = and i16 %18, 2048
  %tobool.not.i188 = icmp eq i16 %19, 0
  br i1 %tobool.not.i188, label %if.end3.i191, label %cli_hex2int.exit200

if.end3.i191:                                     ; preds = %if.end.i184
  %call9.i192 = tail call ptr @__ctype_tolower_loc() #15
  %.pn.i193 = load ptr, ptr %call9.i192, align 8
  %__res.0.in.i194 = getelementptr inbounds i32, ptr %.pn.i193, i64 %idxprom.i186
  %__res.0.i195 = load i32, ptr %__res.0.in.i194, align 4
  %20 = add i32 %__res.0.i195, -97
  %or.cond21.i196 = icmp ult i32 %20, 6
  br i1 %or.cond21.i196, label %cli_hex2int.exit200.thread221, label %if.end20.i197

cli_hex2int.exit200.thread221:                    ; preds = %if.end3.i191
  %sub19.i199 = add nsw i32 %__res.0.i195, -87
  br label %if.then87

if.end20.i197:                                    ; preds = %if.end3.i191
  tail call void (ptr, ...) @cli_errmsg(ptr noundef nonnull @.str.5, i32 noundef %__res.0.i195) #14
  br label %if.else92

cli_hex2int.exit200:                              ; preds = %if.end.i184
  %sub.i190 = add nsw i32 %conv23, -48
...
if.then87:                                        ; preds = %cli_hex2int.exit200.thread221, %cli_hex2int.exit200
  %retval.0.i183224 = phi i32 [ %sub19.i199, %cli_hex2int.exit200.thread221 ], [ %sub.i190, %cli_hex2int.exit200 ]
  %conv88 = shl nuw nsw i32 %retval.0.i164218, 4
  %add90 = add nuw nsw i32 %retval.0.i183224, %conv88
  %conv91 = trunc i32 %add90 to i16
  br label %if.end99

if.else92:                                        ; preds = %if.then78, %cli_hex2int.exit200, %if.end20.i197
  tail call void @free(ptr noundef %call3) #14
  br label %cleanup

if.else94:                                        ; preds = %if.else71, %cli_hex2int.exit181, %if.end20.i178
  tail call void @free(ptr noundef %call3) #14
  br label %cleanup
...
if.end99:                                         ; preds = %if.else40, %land.lhs.true, %if.then33, %if.then87, %if.then54
  ...
  store i16 %val.0, ptr %ptr.0226, align 2
...
if.then14:                                        ; preds = %cli_hex2int.exit.thread, %cli_hex2int.exit
  ...
  br i1 %cmp.i54, label %if.end.i56, label %if.else

if.end.i56:                                       ; preds = %if.then14
  %idxprom.i58 = zext i32 %conv18 to i64
  %arrayidx.i59 = getelementptr inbounds i16, ptr %2, i64 %idxprom.i58
  %8 = load i16, ptr %arrayidx.i59, align 2
  %9 = and i16 %8, 2048
  %tobool.not.i60 = icmp eq i16 %9, 0
  br i1 %tobool.not.i60, label %if.end3.i63, label %if.then2.i61

if.then2.i61:                                     ; preds = %if.end.i56
  %sub.i62 = add nsw i32 %conv18, -48
  br label %cli_hex2int.exit72

if.end3.i63:                                      ; preds = %if.end.i56
  %call9.i64 = tail call ptr @__ctype_tolower_loc() #15
  %.pn.i65 = load ptr, ptr %call9.i64, align 8
  %__res.0.in.i66 = getelementptr inbounds i32, ptr %.pn.i65, i64 %idxprom.i58
  %__res.0.i67 = load i32, ptr %__res.0.in.i66, align 4
  %10 = add i32 %__res.0.i67, -97
  %or.cond21.i68 = icmp ult i32 %10, 6
  br i1 %or.cond21.i68, label %if.then18.i70, label %if.end20.i69

if.then18.i70:                                    ; preds = %if.end3.i63
  %sub19.i71 = add nsw i32 %__res.0.i67, -87
  br label %cli_hex2int.exit72

if.end20.i69:                                     ; preds = %if.end3.i63
  tail call void (ptr, ...) @cli_errmsg(ptr noundef nonnull @.str.5, i32 noundef %__res.0.i67) #14
  br label %if.else

cli_hex2int.exit72:                               ; preds = %if.then2.i61, %if.then18.i70
  %retval.0.i55 = phi i32 [ %sub.i62, %if.then2.i61 ], [ %sub19.i71, %if.then18.i70 ]
  %11 = and i32 %retval.0.i55, 128
  %cmp22 = icmp eq i32 %11, 0
  br i1 %cmp22, label %if.then24, label %if.else

if.then24:                                        ; preds = %cli_hex2int.exit72
  %12 = shl nuw nsw i32 %retval.0.i85, 4
  %add27 = add nsw i32 %retval.0.i55, %12
  %conv28 = trunc i32 %add27 to i8
  %incdec.ptr = getelementptr inbounds i8, ptr %ptr.079, i64 1
  store i8 %conv28, ptr %ptr.079, align 1
  %indvars.iv.next = add nuw i64 %indvars.iv, 2
  %13 = trunc i64 %indvars.iv.next to i32
  %cmp6 = icmp slt i32 %13, %conv
  br i1 %cmp6, label %for.body, label %cleanup

if.else:                                          ; preds = %if.then14, %cli_hex2int.exit72, %if.end20.i69
  tail call void @free(ptr noundef %call3) #14
  br label %cleanup
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <16 x i8> %10, ptr %9, align 1
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.vec56 = load <16 x i8>, ptr %gep61, align 1
  ...
  store <8 x i8> %15, ptr %14, align 1
  %index.next59 = add nuw i64 %index54, 8
  %16 = icmp eq i64 %index.next59, %n.vec50
  br i1 %16, label %vec.epilog.middle.block, label %vec.epilog.vector.body
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  ...
  store i8 %shl.1, ptr %arrayidx12.1, align 1
  %arrayidx14.1 = getelementptr inbounds i8, ptr %str, i64 %indvars.iv.next41
  %30 = load i8, ptr %arrayidx14.1, align 1
  %add19.1 = add i8 %30, %shl.1
  store i8 %add19.1, ptr %arrayidx12.1, align 1
  %indvars.iv.next41.1 = add nuw nsw i64 %indvars.iv40, 4
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1, %wide.trip.count
  br i1 %exitcond.not.1, label %cleanup, label %for.body
...
while.body:                                       ; preds = %land.rhs, %land.rhs
  ...
  br i1 %cmp5, label %land.rhs, label %cleanup
...
land.rhs10:                                       ; preds = %while.cond
  ...
  br i1 %tobool16.not, label %for.inc.loopexit, label %while.cond
...
for.inc37:                                        ; preds = %for.body29
  ...
  br i1 %tobool28.not, label %for.end39, label %for.body29
...
for.end39:                                        ; preds = %for.inc37, %for.end39.split.loop.exit109
  ...
  %cmp40 = icmp eq i32 %i.0.lcssa, %j.0.lcssa.ph
...
for.inc39:                                        ; preds = %for.body31
  ...
  br i1 %tobool30.not, label %for.end41, label %for.body31
...
for.end41:                                        ; preds = %for.inc39, %for.end41.split.loop.exit100
  ...
  %cmp42 = icmp eq i32 %i.0.lcssa, %j.0.lcssa.ph
...
if.end20:                                         ; preds = %if.end15
  ...
  %call8 = tail call ptr @memchr(ptr noundef nonnull %hay.1, i32 noundef %conv6, i64 noundef %conv7) #13
  %cmp9.not = icmp eq ptr %call8, null
  br i1 %cmp9.not, label %cleanup, label %while.body
...
while.cond:                                       ; preds = %entry, %while.cond
  ...
  %0 = load i8, ptr %source.addr.0, align 1
  %incdec.ptr2 = getelementptr inbounds i8, ptr %dest.addr.0, i64 1
  store i8 %0, ptr %dest.addr.0, align 1
...
for.body:                                         ; preds = %for.body.lr.ph, %if.then
  ...
  store ptr %buffer.addr.015, ptr %arrayidx, align 8
...
while.body.preheader:                             ; preds = %while.cond.preheader
  ...
  %5 = sub i64 %3, %4
  tail call void @llvm.memset.p0.i64(ptr align 8 %scevgep, i8 0, i64 %5, i1 false)
  br label %cleanup
...
attributes #6 = { nofree nounwind memory(argmem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
