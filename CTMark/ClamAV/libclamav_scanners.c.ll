...
land.lhs.true375:                                 ; preds = %land.lhs.true371.thread638, %land.lhs.true371
  ...
  %95 = load ptr, ptr %dconf376, align 8, !tbaa !31
  %archive377 = getelementptr inbounds %struct.cli_dconf, ptr %95, i64 0, i32 2
  %96 = load i32, ptr %archive377, align 4, !tbaa !32
  %and378 = and i32 %96, 2
...
land.lhs.true392:                                 ; preds = %if.end386
  %97 = load ptr, ptr %engine, align 8, !tbaa !18
  %sdb394 = getelementptr inbounds %struct.cl_engine, ptr %97, i64 0, i32 1
  %98 = load i16, ptr %sdb394, align 4, !tbaa !29
...
if.end402:                                        ; preds = %if.then396, %land.lhs.true392, %if.end386
  ...
  %99 = load i32, ptr %arec403, align 4, !tbaa !27
  %inc404 = add i32 %99, 1
...
sw.bb406:                                         ; preds = %if.end402
  %100 = load i32, ptr %options, align 8, !tbaa !21
...
land.lhs.true410:                                 ; preds = %sw.bb406
  ...
  %101 = load ptr, ptr %dconf411, align 8, !tbaa !31
...
sw.epilog417:                                     ; preds = %if.end402, %sw.bb406, %land.lhs.true410, %if.then413
  ...
  %103 = load i32, ptr %arec403, align 4, !tbaa !27
...
do.body:                                          ; preds = %do.body.preheader, %do.cond
  ...
  %22 = load i32, ptr %encrypted45, align 4, !tbaa !61
...
if.end49:                                         ; preds = %do.body
  ...
  %23 = load i32, ptr %crc32, align 4, !tbaa !63
...
if.end57:                                         ; preds = %if.end49
  %24 = load i32, ptr %mdata.0, align 8, !tbaa !64
...
if.end66:                                         ; preds = %if.end57
  ...
  %25 = load i32, ptr %size67, align 4, !tbaa !65
...
if.end76:                                         ; preds = %if.end66
  ...
  %26 = load i32, ptr %method, align 8, !tbaa !66
...
if.end88:                                         ; preds = %if.end76
  ...
  %28 = load i32, ptr %fileno, align 8, !tbaa !67
...
if.end102:                                        ; preds = %land.lhs.true97, %if.end95
  ...
  %31 = load ptr, ptr %filename, align 8, !tbaa !69
...
do.cond:                                          ; preds = %if.end88, %if.end76, %if.end66, %if.end57, %if.end49, %land.lhs.true104, %land.lhs.true97, %do.body
  ...
  %32 = load ptr, ptr %next, align 8, !tbaa !70
...
if.then114:                                       ; preds = %if.end102, %land.lhs.true104
  ...
  %33 = load ptr, ptr %virname115, align 8, !tbaa !72
  %34 = load ptr, ptr %ctx, align 8, !tbaa !22
...
if.end117:                                        ; preds = %do.cond, %if.end42
  ...
  %35 = load i8, ptr %arrayidx, align 1, !tbaa !73
...
if.end125:                                        ; preds = %if.end117
  %36 = load i32, ptr %d_csize, align 4, !tbaa !56
...
if.then128:                                       ; preds = %if.end125
  ...
  %37 = load ptr, ptr %ctx, align 8, !tbaa !22
  store ptr @.str.34, ptr %37, align 8, !tbaa !23
  br label %while.end308

if.end130:                                        ; preds = %if.end125
  %38 = load ptr, ptr %limits, align 8, !tbaa !24
...
land.lhs.true133:                                 ; preds = %if.end130
  ...
  %39 = load i32, ptr %maxratio135, align 4, !tbaa !59
...
if.then146:                                       ; preds = %land.lhs.true138
  %40 = load ptr, ptr %ctx, align 8, !tbaa !22
  store ptr @.str.40, ptr %40, align 8, !tbaa !23
  br label %while.end308
...
if.then150:                                       ; preds = %if.end148.thread, %if.end148
  %41 = load i32, ptr %options185, align 8, !tbaa !21
  %and151 = and i32 %41, 8
...
if.then180:                                       ; preds = %if.end167
  ...
  %44 = load i32, ptr %options185, align 8, !tbaa !21
...
if.then188:                                       ; preds = %if.then180
  %45 = load ptr, ptr %ctx, align 8, !tbaa !22
  store ptr @.str.44, ptr %45, align 8, !tbaa !23
  br label %while.end308

if.end191:                                        ; preds = %if.end167
  %maxfiles = getelementptr inbounds %struct.cl_limits, ptr %38, i64 0, i32 1
  %46 = load i32, ptr %maxfiles, align 4, !tbaa !76
...
if.then199:                                       ; preds = %if.end191
  ...
  %47 = load i32, ptr %options185, align 8, !tbaa !21
...
if.then205:                                       ; preds = %if.then199
  %48 = load ptr, ptr %ctx, align 8, !tbaa !22
  store ptr @.str.46, ptr %48, align 8, !tbaa !23
  br label %while.end308

if.end209:                                        ; preds = %if.end148.thread, %if.end191
  %49 = load i32, ptr %d_off, align 4, !tbaa !55
...
if.then215:                                       ; preds = %if.end209
  %50 = load i32, ptr %errcode, align 4, !tbaa !77
...
if.else222:                                       ; preds = %if.then215
  %51 = load ptr, ptr %d_name, align 8, !tbaa !53
...
while.body236:                                    ; preds = %while.cond231
  ...
  %52 = load i32, ptr %fd, align 4, !tbaa !40
...
if.then244:                                       ; preds = %while.cond231, %if.then241
  ...
  %53 = load i32, ptr %st_size, align 8, !tbaa !57
...
if.then249:                                       ; preds = %if.then244
  ...
  %54 = load ptr, ptr %bf, align 8, !tbaa !81
...
if.then263:                                       ; preds = %if.then244
  %56 = load ptr, ptr %tmpname, align 8, !tbaa !23
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.51, ptr noundef %56) #9
  %57 = load i32, ptr %fd, align 4, !tbaa !40
...
if.end268:                                        ; preds = %if.then263
  %58 = load i32, ptr %fd, align 4, !tbaa !40
...
if.then273:                                       ; preds = %if.end268
  %60 = load ptr, ptr %ctx, align 8, !tbaa !22
...
while.end308:                                     ; preds = %while.cond.outer, %if.end304, %while.cond.backedge, %if.then10, %if.end304.thread, %if.then199, %if.then162, %if.then153, %if.else222, %if.then205, %if.then188, %if.then146, %if.then128, %if.then114, %if.then39, %if.then17
  ...
  %68 = load i32, ptr %fd, align 4, !tbaa !40
