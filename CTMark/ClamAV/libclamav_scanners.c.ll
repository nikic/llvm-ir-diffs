; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_scanners.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/libclamav_scanners.c"
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end50
  ...
  %0 = load i64, ptr %call182, align 8
...
if.then31:                                        ; preds = %if.then25
  %call32 = tail call i32 @cli_scandir(ptr noundef nonnull %call16, ptr noundef %ctx)
...
if.end48:                                         ; preds = %if.then25, %if.then40, %if.then31, %cli_scanfile.exit, %if.end
  tail call void @free(ptr noundef nonnull %call16) #9
  br label %if.end50
...
if.end50:                                         ; preds = %if.then3, %land.lhs.true, %if.end48, %while.body
  ...
  br i1 %tobool.not, label %if.end52, label %while.body
...
cond.end.thread596:                               ; preds = %if.end45
  ...
  %12 = load i32, ptr %arec67598, align 4
  %inc68599 = add i32 %12, 1
  store i32 %inc68599, ptr %arec67598, align 4
...
cond.end.thread:                                  ; preds = %if.end63
  ...
  %15 = load i32, ptr %mrec66, align 8
  %inc = add i32 %15, 1
  store i32 %inc, ptr %mrec66, align 8
...
cond.end:                                         ; preds = %if.end63
  ...
  %17 = load i32, ptr %arec67, align 4
  %inc68 = add i32 %17, 1
  store i32 %inc68, ptr %arec67, align 4
...
land.lhs.true371.thread:                          ; preds = %sw.bb69
  store i32 %17, ptr %arec67, align 4
  br label %if.end386

land.lhs.true73:                                  ; preds = %sw.bb69
  %dconf = getelementptr inbounds %struct.cli_ctx, ptr %ctx, i64 0, i32 9
  %19 = load ptr, ptr %dconf, align 8
  %archive = getelementptr inbounds %struct.cli_dconf, ptr %19, i64 0, i32 2
  %20 = load i32, ptr %archive, align 4
  %and74 = and i32 %20, 2
  %tobool75.not = icmp eq i32 %and74, 0
  br i1 %tobool75.not, label %land.lhs.true371.thread638, label %land.lhs.true371

land.lhs.true371.thread638:                       ; preds = %land.lhs.true73
  store i32 %17, ptr %arec67, align 4
...
sw.bb110:                                         ; preds = %cond.end
  %28 = load i32, ptr %options, align 8
  %and112 = and i32 %28, 1
...
sw.bb145:                                         ; preds = %cond.end
  %37 = load i32, ptr %options, align 8
...
if.then173:                                       ; preds = %land.lhs.true169
  ...
  %.pre633 = load i32, ptr %mrec66, align 8
  %44 = add i32 %.pre633, -1
  br label %cond.end367.thread

sw.bb176:                                         ; preds = %cond.end
  %45 = load i32, ptr %options, align 8
  %and178 = and i32 %45, 2
...
sw.bb207:                                         ; preds = %cond.end
  %53 = load i32, ptr %options, align 8
  %and209 = and i32 %53, 1
...
if.then216:                                       ; preds = %land.lhs.true211
  %call217 = tail call fastcc i32 @cli_scanmschm(i32 noundef %desc, ptr noundef nonnull %ctx)
  br label %cond.end367.thread626
...
sw.bb243:                                         ; preds = %cond.end
  %62 = load i32, ptr %options, align 8
  %and245 = and i32 %62, 1
...
if.then272:                                       ; preds = %sw.bb267
  %call273 = tail call fastcc i32 @cli_scanscrenc(i32 noundef %desc, ptr noundef nonnull %ctx)
  br label %cond.end367.thread626
...
if.then.i:                                        ; preds = %if.then284
  store ptr @.str.123, ptr %73, align 8
  br label %cond.end367.thread626

sw.bb288:                                         ; preds = %cond.end
  %74 = load i32, ptr %options, align 8
...
if.then297:                                       ; preds = %land.lhs.true292
  ...
  br i1 %cmp.i587, label %if.then.i589, label %cond.end367.thread626

if.then.i589:                                     ; preds = %if.then297
  store ptr @.str.124, ptr %77, align 8
  br label %cond.end367.thread626

sw.bb301:                                         ; preds = %cond.end
  %78 = load i32, ptr %options, align 8
...
sw.bb321:                                         ; preds = %cond.end
  %83 = load i32, ptr %options, align 8
...
land.lhs.true347:                                 ; preds = %cond.end.thread596
  ...
  %89 = load i32, ptr %st_mode, align 8
...
cond.end367.thread626:                            ; preds = %if.then.i589, %if.then297, %if.then.i, %if.then284, %sw.bb, %sw.bb79, %land.lhs.true83, %if.then88, %sw.bb91, %land.lhs.true95, %if.then100, %sw.bb103, %if.then107, %sw.bb110, %land.lhs.true114, %if.then119, %sw.bb122, %land.lhs.true126, %if.then131, %sw.bb134, %land.lhs.true138, %if.then142, %sw.bb145, %land.lhs.true149, %if.then154, %sw.bb157, %if.then162, %sw.bb176, %land.lhs.true180, %if.then185, %sw.bb188, %if.then192, %sw.bb195, %land.lhs.true199, %if.then204, %sw.bb207, %land.lhs.true211, %if.then216, %sw.bb219, %land.lhs.true223, %if.then228, %sw.bb231, %land.lhs.true235, %if.then240, %sw.bb243, %land.lhs.true247, %if.then252, %sw.bb255, %land.lhs.true259, %if.then264, %sw.bb267, %if.then272, %sw.bb275, %land.lhs.true279, %sw.bb288, %land.lhs.true292, %sw.bb301, %land.lhs.true305, %if.then310, %sw.bb313, %if.then318, %sw.bb321, %land.lhs.true325, %if.then328, %sw.bb331, %land.lhs.true335, %if.then340, %sw.bb357
  ...
  %92 = load i32, ptr %arec365629, align 4
  %dec366630 = add i32 %92, -1
  store i32 %dec366630, ptr %arec365629, align 4
  br label %if.end386
...
land.lhs.true371:                                 ; preds = %land.lhs.true73
  ...
  %.pre = load i32, ptr %arec67, align 4
  %.pre632 = load i32, ptr %options, align 8
  %.pre634 = and i32 %.pre632, 1
  %93 = add i32 %.pre, -1
  %94 = icmp eq i32 %.pre634, 0
  store i32 %93, ptr %arec67, align 4
  br i1 %94, label %if.end386, label %land.lhs.true375

land.lhs.true375:                                 ; preds = %land.lhs.true371.thread638, %land.lhs.true371
  %ret.1.ph642 = phi i32 [ %ret.0, %land.lhs.true371.thread638 ], [ %call77, %land.lhs.true371 ]
  %dconf376 = getelementptr inbounds %struct.cli_ctx, ptr %ctx, i64 0, i32 9
  %95 = load ptr, ptr %dconf376, align 8
  %archive377 = getelementptr inbounds %struct.cli_dconf, ptr %95, i64 0, i32 2
  %96 = load i32, ptr %archive377, align 4
  %and378 = and i32 %96, 2
...
if.end386:                                        ; preds = %land.lhs.true371.thread, %cond.end367.thread626, %cond.end367.thread620, %cond.end367.thread, %if.then384, %land.lhs.true375, %land.lhs.true371
  %ret.1603619 = phi i32 [ %ret.1.ph642, %if.then384 ], [ %ret.1.ph642, %land.lhs.true375 ], [ %call77, %land.lhs.true371 ], [ %ret.1613, %cond.end367.thread ], [ %ret.0, %cond.end367.thread620 ], [ %ret.1.ph.ph, %cond.end367.thread626 ], [ %ret.0, %land.lhs.true371.thread ]
...
if.end402:                                        ; preds = %if.then396, %land.lhs.true392, %if.end386
  ...
  %99 = load i32, ptr %arec403, align 4
  %inc404 = add i32 %99, 1
  store i32 %inc404, ptr %arec403, align 4
...
sw.bb406:                                         ; preds = %if.end402
  %100 = load i32, ptr %options, align 8
...
land.lhs.true410:                                 ; preds = %sw.bb406
  ...
  %101 = load ptr, ptr %dconf411, align 8
...
sw.epilog417:                                     ; preds = %if.end402, %sw.bb406, %land.lhs.true410, %if.then413
  ...
  %103 = load i32, ptr %arec403, align 4
  %dec419 = add i32 %103, -1
  store i32 %dec419, ptr %arec403, align 4
...
entry:
  ...
  store ptr null, ptr %ftoffset, align 8
...
if.then17:                                        ; preds = %land.lhs.true, %land.lhs.true
  store i32 -559038737, ptr %lastzip, align 4
  %fpt.0358 = load ptr, ptr %ftoffset, align 8
...
while.cond:                                       ; preds = %while.body, %sw.bb20, %land.lhs.true24, %land.lhs.true27, %sw.bb34, %land.lhs.true41, %sw.bb52, %land.lhs.true59, %sw.bb70, %land.lhs.true77, %land.lhs.true82, %sw.bb93, %land.lhs.true100, %sw.bb111, %land.lhs.true115, %land.lhs.true118, %if.then121, %sw.default141, %sw.epilog143
  ...
  %fpt.0 = load ptr, ptr %next, align 8
  %tobool18.not = icmp eq ptr %fpt.0, null
  br i1 %tobool18.not, label %if.end151, label %while.body
...
while.body:                                       ; preds = %while.body.lr.ph, %while.cond
  ...
  %0 = load i32, ptr %fpt.0361, align 8
...
sw.bb20:                                          ; preds = %while.body
  %1 = load i32, ptr %options112, align 8
  %and = and i32 %1, 1
...
sw.bb34:                                          ; preds = %while.body
  %6 = load i32, ptr %options112, align 8
  %and36 = and i32 %6, 1
...
land.lhs.true82:                                  ; preds = %land.lhs.true77
  ...
  %19 = load i64, ptr %offset83, align 8
...
if.then86:                                        ; preds = %land.lhs.true82
  ...
  %20 = load i64, ptr %offset83, align 8
...
sw.bb93:                                          ; preds = %while.body
  %21 = load i32, ptr %options112, align 8
  %and95 = and i32 %21, 1
...
land.lhs.true118:                                 ; preds = %land.lhs.true115
  ...
  %29 = load i64, ptr %offset119, align 8
...
if.then121:                                       ; preds = %land.lhs.true118
  ...
  %30 = load i64, ptr %offset119, align 8
  store i64 %30, ptr %offset125, align 8
...
if.then131:                                       ; preds = %if.then121
  ...
  %31 = load ptr, ptr %section, align 8
...
sw.epilog143.thread:                              ; preds = %if.then131, %if.then133
  %32 = load i64, ptr %offset119, align 8
...
cond.end.thread.thread379:                        ; preds = %if.end151.thread369
  ...
  %33 = load i32, ptr %arec381, align 4
...
cond.end.thread374:                               ; preds = %if.end151.thread369
  ...
  %34 = load i32, ptr %mrec376, align 8
...
sw.bb158:                                         ; preds = %if.then157
  ...
  %41 = load i32, ptr %options159, align 8
...
if.then183:                                       ; preds = %land.lhs.true179
  ...
  %.pre364 = load i32, ptr %mrec, align 8
  %48 = add i32 %.pre364, -1
  br label %cond.true191
...
cond.true191:                                     ; preds = %cond.end.thread374, %cond.end, %cond.end.thread345, %sw.bb172, %land.lhs.true179, %if.then183
  ...
  store i32 %dec, ptr %mrec192, align 8
  br label %if.end198
...
cond.false193:                                    ; preds = %cond.end.thread.thread379, %if.then157, %sw.bb158, %land.lhs.true165, %if.then169, %cond.end.thread, %cond.end.thread.thread
  ...
  store i32 %dec195, ptr %arec194, align 4
  br label %if.end198
...
if.end198:                                        ; preds = %cond.true191, %cond.false193, %if.end2
  ...
  %49 = load ptr, ptr %ftoffset, align 8
...
while.body201:                                    ; preds = %if.end198, %while.body201
  ...
  %51 = load ptr, ptr %next202, align 8
  store ptr %51, ptr %ftoffset, align 8
  call void @free(ptr noundef nonnull %50) #9
  %52 = load ptr, ptr %ftoffset, align 8
  %tobool200.not = icmp eq ptr %52, null
  br i1 %tobool200.not, label %while.end203, label %while.body201
...
if.then10:                                        ; preds = %while.body
  %1 = load i32, ptr %sfx_check, align 4
  %2 = load i32, ptr %d_crc32, align 8
  %cmp11 = icmp eq i32 %1, %2
  br i1 %cmp11, label %while.end308, label %if.else

if.else:                                          ; preds = %if.then10
  store i32 %2, ptr %sfx_check, align 4
  br label %if.end15
...
if.end18:                                         ; preds = %if.end15
  %5 = load i16, ptr %d_flags, align 4
  %6 = and i16 %5, 8257
  %cmp19 = icmp ne i16 %6, 0
  %conv20 = zext i1 %cmp19 to i32
  %7 = load i32, ptr %d_crc32, align 8
  %8 = load i32, ptr %d_off, align 4
  %9 = load i32, ptr %d_csize, align 4
  %10 = load i32, ptr %st_size, align 8
  %11 = load i16, ptr %zdirent, align 8
...
cond.end:                                         ; preds = %if.end18, %cond.true
  ...
  %12 = load ptr, ptr %limits, align 8
...
cond.true29:                                      ; preds = %cond.end
  ...
  %13 = load i32, ptr %maxratio, align 4
  br label %cond.end32
...
if.end42:                                         ; preds = %cond.end32
  ...
  %18 = load ptr, ptr %zip_mlist, align 8
  %tobool43.not = icmp eq ptr %18, null
  %.pre = load ptr, ptr %d_name, align 8
  br i1 %tobool43.not, label %if.end117, label %do.body.preheader
...
do.body:                                          ; preds = %do.body.preheader, %do.cond
  %mdata.0 = phi ptr [ %32, %do.cond ], [ %18, %do.body.preheader ]
  %encrypted45 = getelementptr inbounds %struct.cli_meta_node, ptr %mdata.0, i64 0, i32 5
  %22 = load i32, ptr %encrypted45, align 4
  %cmp46.not = icmp eq i32 %22, %conv20
...
if.end66:                                         ; preds = %if.end57
  ...
  %25 = load i32, ptr %size67, align 4
  %cmp68 = icmp slt i32 %25, 0
  %cmp73.not = icmp eq i32 %25, %14
...
if.end76:                                         ; preds = %if.end66
  ...
  %26 = load i32, ptr %method, align 8
  %cmp77 = icmp slt i32 %26, 0
  %27 = trunc i32 %26 to i16
  %cmp85.not = icmp eq i16 %21, %27
...
if.end88:                                         ; preds = %if.end76
  ...
  %28 = load i32, ptr %fileno, align 8
  %tobool89.not = icmp eq i32 %28, 0
  %cmp92.not = icmp eq i32 %28, %inc
...
if.end102:                                        ; preds = %land.lhs.true97, %if.end95
  ...
  %tobool103.not = icmp eq ptr %31, null
  br i1 %tobool103.not, label %if.then114, label %land.lhs.true104

land.lhs.true104:                                 ; preds = %if.end102
  %call107 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %.pre, ptr noundef nonnull dereferenceable(1) %31) #10
...
do.cond:                                          ; preds = %if.end88, %if.end76, %if.end66, %if.end57, %if.end49, %land.lhs.true104, %land.lhs.true97, %do.body
  ...
  %tobool111.not = icmp eq ptr %32, null
  br i1 %tobool111.not, label %if.end117, label %do.body
...
if.then114:                                       ; preds = %if.end102, %land.lhs.true104
  ...
  %33 = load ptr, ptr %virname115, align 8
  %34 = load ptr, ptr %ctx, align 8
  store ptr %33, ptr %34, align 8
  br label %while.end308

if.end117:                                        ; preds = %do.cond, %if.end42
  %call120 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %.pre) #10
  %sub = add i64 %call120, -1
  %arrayidx = getelementptr inbounds i8, ptr %.pre, i64 %sub
  %35 = load i8, ptr %arrayidx, align 1
  %cmp122 = icmp eq i8 %35, 47
...
while.cond.backedge:                              ; preds = %if.then124, %if.then36, %if.then150, %if.then180
  ...
  br i1 %tobool7.not, label %while.end308, label %while.body

if.end125:                                        ; preds = %if.end117
  %36 = load i32, ptr %d_csize, align 4
...
if.end130:                                        ; preds = %if.end125
  %38 = load ptr, ptr %limits, align 8
  %tobool132.not = icmp eq ptr %38, null
  br i1 %tobool132.not, label %if.end148.thread, label %land.lhs.true133

land.lhs.true133:                                 ; preds = %if.end130
  %maxratio135 = getelementptr inbounds %struct.cl_limits, ptr %38, i64 0, i32 3
  %39 = load i32, ptr %maxratio135, align 4
  %cmp136.not = icmp eq i32 %39, 0
  br i1 %cmp136.not, label %if.end148, label %land.lhs.true138

land.lhs.true138:                                 ; preds = %land.lhs.true133
  %div141 = udiv i32 %14, %36
  %cmp144.not = icmp ult i32 %div141, %39
...
if.end167:                                        ; preds = %if.end148
  %maxfilesize = getelementptr inbounds %struct.cl_limits, ptr %38, i64 0, i32 5
  %43 = load i64, ptr %maxfilesize, align 8
  %tobool172.not = icmp ne i64 %43, 0
  %conv175 = zext i32 %14 to i64
  %cmp178 = icmp ult i64 %43, %conv175
  %or.cond452 = and i1 %tobool172.not, %cmp178
  br i1 %or.cond452, label %if.then180, label %if.end191

if.then180:                                       ; preds = %if.end167
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.43, ptr noundef nonnull %.pre, i32 noundef %14, i64 noundef %43) #9
  %44 = load i32, ptr %options185, align 8
  %and186 = and i32 %44, 256
...
if.end191:                                        ; preds = %if.end167
  %maxfiles = getelementptr inbounds %struct.cl_limits, ptr %38, i64 0, i32 1
  %46 = load i32, ptr %maxfiles, align 4
  %tobool193.not = icmp ne i32 %46, 0
  %cmp197 = icmp ugt i32 %inc, %46
  %or.cond444 = and i1 %tobool193.not, %cmp197
  br i1 %or.cond444, label %if.then199, label %if.end209

if.then199:                                       ; preds = %if.end191
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.45, i32 noundef %46) #9
  %47 = load i32, ptr %options185, align 8
  %and203 = and i32 %47, 256
...
if.end209:                                        ; preds = %if.end148.thread, %if.end191
  %49 = load i32, ptr %d_off, align 4
  %call212 = call ptr @zip_file_open(ptr noundef nonnull %call, ptr noundef nonnull %.pre, i32 noundef %49) #9
...
if.then215:                                       ; preds = %if.end209
  %50 = load i32, ptr %errcode, align 4
  %cmp216 = icmp eq i32 %50, -125
...
if.else222:                                       ; preds = %if.then215
  %51 = load ptr, ptr %d_name, align 8
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.48, ptr noundef %51) #9
  br label %while.end308

while.cond231.preheader:                          ; preds = %while.cond231.preheader.lr.ph, %if.end288
  %success.0525 = phi i8 [ 0, %while.cond231.preheader.lr.ph ], [ %success.1448, %if.end288 ]
...
while.body236:                                    ; preds = %while.cond231
  ...
  %call238 = call i32 @cli_writen(i32 noundef %52, ptr noundef nonnull %call2, i32 noundef %conv233) #9
  %cmp239.not = icmp eq i32 %call238, %conv233
  br i1 %cmp239.not, label %while.cond231, label %if.then241
...
if.then244:                                       ; preds = %while.cond231, %if.then241
  ...
  %53 = load i32, ptr %st_size, align 8
  %conv246 = zext i32 %53 to i64
...
if.then249:                                       ; preds = %if.then244
  ...
  %54 = load ptr, ptr %bf, align 8
  %55 = load i16, ptr %54, align 2
  %cmp254 = icmp eq i16 %55, -1
  br i1 %cmp254, label %while.end296, label %if.end276

if.then263:                                       ; preds = %if.then244
  %56 = load ptr, ptr %tmpname, align 8
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.51, ptr noundef %56) #9
  %57 = load i32, ptr %fd, align 4
  %call264 = call i32 @fsync(i32 noundef %57) #9
...
if.end268:                                        ; preds = %if.then263
  ...
  %call269 = call i64 @lseek(i32 noundef %58, i64 noundef 0, i32 noundef 0) #9
  %59 = load i32, ptr %fd, align 4
  %call270 = call i32 @cli_magic_scandesc(i32 noundef %59, ptr noundef %ctx)
...
if.then273:                                       ; preds = %if.end268
  ...
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.53, ptr noundef %61) #9
  br label %while.end296

if.end276:                                        ; preds = %if.then249, %if.end268
  %success.1448 = phi i8 [ 1, %if.end268 ], [ %success.0525, %if.then249 ]
  %ret.2 = phi i32 [ %call270, %if.end268 ], [ %ret.1, %if.then249 ]
  %62 = load i32, ptr %fd, align 4
  %call277 = call i32 @close(i32 noundef %62) #9
  %63 = load i8, ptr @cli_leavetemps_flag, align 1
  %tobool278.not = icmp eq i8 %63, 0
  br i1 %tobool278.not, label %if.then279, label %if.end281

if.then279:                                       ; preds = %if.end276
  %64 = load ptr, ptr %tmpname, align 8
  %call280 = call i32 @unlink(ptr noundef %64) #9
  br label %if.end281

if.end281:                                        ; preds = %if.then279, %if.end276
  %65 = load ptr, ptr %tmpname, align 8
  call void @free(ptr noundef %65) #9
  store i32 -1, ptr %fd, align 4
  %66 = load ptr, ptr %bf, align 8
  %idxprom = zext i32 %bfcnt.0524 to i64
  %arrayidx283 = getelementptr inbounds i16, ptr %66, i64 %idxprom
  %67 = load i16, ptr %arrayidx283, align 2
  %cmp285 = icmp eq i16 %67, -1
  br i1 %cmp285, label %while.end296, label %if.end288

if.end288:                                        ; preds = %if.end281
  store i16 %67, ptr %method292, align 8
  %conv294 = zext i16 %67 to i32
...
while.end296:                                     ; preds = %if.end288, %if.end281, %if.then249, %while.cond225.preheader, %if.then273, %if.then267
  ...
  %success.2 = phi i8 [ 1, %if.then267 ], [ 1, %if.then273 ], [ 0, %while.cond225.preheader ], [ %success.1448, %if.end288 ], [ %success.1448, %if.end281 ], [ %success.0525, %if.then249 ]
...
if.end304:                                        ; preds = %while.end296
  ...
  br i1 %tobool305.not, label %while.cond.outer, label %while.end308
...
while.end308:                                     ; preds = %while.cond.outer, %if.end304, %while.cond.backedge, %if.then10, %if.end304.thread, %if.then199, %if.then162, %if.then153, %if.else222, %if.then205, %if.then188, %if.then146, %if.then128, %if.then114, %if.then39, %if.then17
  ...
  %cmp310.not = icmp eq i32 %68, -1
  br i1 %cmp310.not, label %if.end318, label %if.then312

if.then312:                                       ; preds = %while.end308
  %call313 = call i32 @close(i32 noundef %68) #9
  %69 = load i8, ptr @cli_leavetemps_flag, align 1
  %tobool314.not = icmp eq i8 %69, 0
  br i1 %tobool314.not, label %if.then315, label %if.end317

if.then315:                                       ; preds = %if.then312
  %70 = load ptr, ptr %tmpname, align 8
  %call316 = call i32 @unlink(ptr noundef %70) #9
  br label %if.end317

if.end317:                                        ; preds = %if.then315, %if.then312
  %71 = load ptr, ptr %tmpname, align 8
...
if.then8:                                         ; preds = %if.end5
  ...
  %1 = load i8, ptr @cli_leavetemps_flag, align 1
...
if.then19:                                        ; preds = %while.body
  ...
  %5 = load i64, ptr %maxfilesize, align 8
...
if.then27:                                        ; preds = %if.then19
  ...
  br i1 %tobool30.not, label %while.end, label %if.then31
...
if.then52:                                        ; preds = %if.then31
  ...
  %call53 = call i32 @unlink(ptr noundef %17) #9
  br label %if.end54
...
if.then59:                                        ; preds = %while.end
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.64, i32 noundef %16) #9
  %19 = load i32, ptr %fd, align 4
  %call60 = call i32 @close(i32 noundef %19) #9
  %20 = load i8, ptr @cli_leavetemps_flag, align 1
...
if.end65:                                         ; preds = %while.end
  %call66 = call i64 @lseek(i32 noundef %16, i64 noundef 0, i32 noundef 0) #9
...
if.then70:                                        ; preds = %if.end65
  ...
  %27 = load i8, ptr @cli_leavetemps_flag, align 1
...
if.end77:                                         ; preds = %if.end65
  ...
  %31 = load i8, ptr @cli_leavetemps_flag, align 1
...
if.end82:                                         ; preds = %if.then80, %if.end77
  %33 = load ptr, ptr %tmpname, align 8
...
if.end17:                                         ; preds = %do.body
  %1 = load ptr, ptr %limits.i, align 8
...
if.end15.i:                                       ; preds = %land.lhs.true.i, %if.then.i
  ...
  %7 = load i32, ptr %maxratio.i, align 4
...
land.lhs.true18.i:                                ; preds = %if.end15.i
  %8 = load i32, ptr %orig_size.i, align 4
...
do.end:                                           ; preds = %do.body, %do.cond, %if.then50.i, %if.then14.i, %if.then32
  ...
  %21 = load i8, ptr @cli_leavetemps_flag, align 1
...
land.lhs.true20:                                  ; preds = %land.lhs.true6, %land.lhs.true
  ...
  %7 = load i32, ptr %maxfiles, align 4
...
if.end37:                                         ; preds = %for.body, %land.lhs.true20
  ...
  %10 = load ptr, ptr %name39, align 8
  %11 = load i32, ptr %file.092, align 8
...
if.then19:                                        ; preds = %if.end16
  %2 = load i8, ptr @cli_leavetemps_flag, align 1
...
if.then40:                                        ; preds = %if.end36
  %3 = load i8, ptr @cli_leavetemps_flag, align 1
...
if.end73:                                         ; preds = %if.then68, %if.end66
  ...
  %5 = load i8, ptr @cli_leavetemps_flag, align 1
...
entry:
  %mrec = getelementptr inbounds %struct.cli_ctx, ptr %ctx, i64 0, i32 7
  %0 = load i32, ptr %mrec, align 8
  %arec = getelementptr inbounds %struct.cli_ctx, ptr %ctx, i64 0, i32 6
  %1 = load i32, ptr %arec, align 4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load111 = load <16 x i8>, ptr %4, align 1
  ...
  store <16 x i8> %5, ptr %7, align 1
  %8 = getelementptr inbounds i8, ptr %7, i64 16
  store <16 x i8> %6, ptr %8, align 1
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load116 = load <8 x i8>, ptr %10, align 1
...
for.body.prol:                                    ; preds = %for.body.preheader, %for.body.prol
  ...
  %16 = load i8, ptr %arrayidx.prol, align 1
  %17 = xor i8 %16, -1
  %arrayidx29.prol = getelementptr inbounds i8, ptr %call6, i64 %indvars.iv.prol
  store i8 %17, ptr %arrayidx29.prol, align 1
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  ...
  store i8 %22, ptr %arrayidx29.1, align 1
  ...
  store i8 %24, ptr %arrayidx29.2, align 1
  ...
  store i8 %26, ptr %arrayidx29.3, align 1
...
if.end54:                                         ; preds = %if.then53, %if.end48
  ...
  %29 = load i8, ptr @cli_leavetemps_flag, align 1
...
entry:
  ...
  store ptr %engine, ptr %engine1, align 8
  store ptr %virname, ptr %ctx, align 8
  %limits3 = getelementptr inbounds %struct.cli_ctx, ptr %ctx, i64 0, i32 4
  store ptr %limits, ptr %limits3, align 8
  %scanned4 = getelementptr inbounds %struct.cli_ctx, ptr %ctx, i64 0, i32 1
  store ptr %scanned, ptr %scanned4, align 8
  ...
  store ptr %1, ptr %dconf6, align 8
...
land.lhs.true:                                    ; preds = %while.body
  ...
  %1 = load i64, ptr %maxfilesize, align 8
...
if.end20:                                         ; preds = %land.lhs.true, %while.body
  ...
  br i1 %cmp23.not, label %while.cond, label %if.then25
...
if.then46:                                        ; preds = %if.end41
  ...
  %6 = load i8, ptr @cli_leavetemps_flag, align 1
...
if.end52:                                         ; preds = %if.end41
  ...
  %7 = load i8, ptr @cli_leavetemps_flag, align 1
...
if.else:                                          ; preds = %if.end15
  %13 = load ptr, ptr %scanned, align 8
  %tobool28.not = icmp eq ptr %13, null
  %.pre = load i32, ptr %data_len, align 4
...
if.then29:                                        ; preds = %if.else
  ...
  store i64 %add31, ptr %13, align 8
  br label %if.end32
...
for.body43:                                       ; preds = %for.body43.lr.ph, %for.body43
  ...
  %20 = load ptr, ptr %name44, align 8
...
for.cond70.preheader:                             ; preds = %if.else66
  %28 = load i32, ptr %call67, align 8
...
if.end86:                                         ; preds = %for.body74
  %32 = load ptr, ptr %dir75, align 8
  %33 = load ptr, ptr %name77, align 8
  %arrayidx90 = getelementptr inbounds ptr, ptr %33, i64 %indvars.iv434
  %34 = load ptr, ptr %arrayidx90, align 8
...
if.end96:                                         ; preds = %if.end86
  ...
  %42 = load ptr, ptr %length, align 8
  %arrayidx107 = getelementptr inbounds i32, ptr %42, i64 %indvars.iv434
  %43 = load i32, ptr %arrayidx107, align 4
...
if.end121:                                        ; preds = %if.end96
  %44 = load ptr, ptr %offset110, align 8
  ...
  %47 = load i8, ptr %arrayidx118, align 1
...
if.then124:                                       ; preds = %if.end121.thread, %if.end121
  %48 = load ptr, ptr %name77, align 8
...
if.else128:                                       ; preds = %if.end121
  %50 = load ptr, ptr %scanned129, align 8
  %tobool130.not = icmp eq ptr %50, null
  %.pre440 = load ptr, ptr %length, align 8
  %arrayidx142.phi.trans.insert = getelementptr inbounds i32, ptr %.pre440, i64 %indvars.iv434
  %.pre441 = load i32, ptr %arrayidx142.phi.trans.insert, align 4
...
if.then131:                                       ; preds = %if.else128
  ...
  store i64 %add138, ptr %50, align 8
  br label %if.end139

if.end139:                                        ; preds = %if.else128, %if.then131
  %52 = load ptr, ptr %ctx, align 8
  %53 = load ptr, ptr %engine144, align 8
...
for.inc151:                                       ; preds = %if.then124, %if.end149
  ...
  br i1 %cmp72, label %for.body74, label %for.end153
...
for.end153thread-pre-split:                       ; preds = %for.body74, %for.end153thread-pre-split.sink.split
  ...
  %.pr445 = load i32, ptr %call67, align 8
  br label %for.end153
...
for.body158:                                      ; preds = %for.body158.lr.ph, %for.body158
  ...
  %57 = load ptr, ptr %name159, align 8
  ...
  %59 = load i32, ptr %call67, align 8
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end249
  ...
  %66 = load i64, ptr %call205423, align 8
...
if.then232:                                       ; preds = %if.end225
  %67 = load i32, ptr %st_mode, align 8
...
if.end249:                                        ; preds = %if.then208, %land.lhs.true, %if.end247, %while.body
  ...
  br i1 %tobool206.not, label %if.end251, label %while.body
