; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/shared_output.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/shared_output.c"
...
entry:
  %0 = load ptr, ptr @logg_fd, align 8
  %tobool.not = icmp eq ptr %0, null
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %call = tail call i32 @fclose(ptr noundef nonnull %0)
  store ptr null, ptr @logg_fd, align 8
  br label %if.end
...
if.else:                                          ; preds = %if.then4
  %4 = load i16, ptr @logg_lock, align 2
...
if.then11:                                        ; preds = %if.else
  ...
  store i16 1, ptr %fl, align 8
  %5 = load ptr, ptr @logg_fd, align 8
...
if.then23:                                        ; preds = %if.then20
  ...
  %9 = load i32, ptr @logg_size, align 4
...
if.then44:                                        ; preds = %land.lhs.true
  ...
  %17 = load ptr, ptr @logg_fd, align 8
...
if.then57:                                        ; preds = %if.end52
  %19 = load ptr, ptr @logg_fd, align 8
  %20 = call i64 @fwrite(ptr nonnull @.str.5, i64 7, i64 1, ptr %19)
  %21 = load ptr, ptr @logg_fd, align 8
...
if.then65:                                        ; preds = %if.end52
  %22 = load ptr, ptr @logg_fd, align 8
  %23 = call i64 @fwrite(ptr nonnull @.str.6, i64 9, i64 1, ptr %22)
  %24 = load ptr, ptr @logg_fd, align 8
...
if.then85:                                        ; preds = %if.end52
  %27 = load ptr, ptr @logg_fd, align 8
...
if.else89:                                        ; preds = %if.end52
  %28 = load ptr, ptr @logg_fd, align 8
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %args) #14
  call void @llvm.lifetime.start.p0(i64 512, ptr nonnull %buff) #14
  %0 = load i16, ptr @mprintf_disabled, align 2
...
if.then5:                                         ; preds = %if.end
  %3 = load i16, ptr @mprintf_stdout, align 2
...
if.then15:                                        ; preds = %if.end
  %5 = load i16, ptr @mprintf_stdout, align 2
...
if.else21:                                        ; preds = %if.end
  %7 = load i16, ptr @mprintf_quiet, align 2
...
if.then28:                                        ; preds = %if.then23
  %8 = load i16, ptr @mprintf_stdout, align 2
...
if.then39:                                        ; preds = %if.then23
  %10 = load i16, ptr @mprintf_verbose, align 2
