; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/zlib_inflate.c'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/ClamAV/zlib_inflate.c"
...
inflateStateCheck.exit:                           ; preds = %lor.lhs.false6.i
  ...
  %5 = add i32 %4, -16180
  %or.cond.i = icmp ult i32 %5, 32
  br i1 %or.cond.i, label %if.end.i8, label %cleanup

if.end.i8:                                        ; preds = %inflateStateCheck.exit
...
lor.lhs.false.i.i.thread:                         ; preds = %if.end11, %land.lhs.true13
  ...
  store i32 %wrap.0, ptr %wrap1946, align 8
  %wbits2047 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 10
  store i32 %windowBits.addr.0, ptr %wbits2047, align 8
...
inflateStateCheck.exit.i:                         ; preds = %lor.lhs.false6.i.i
  ...
  %13 = load i32, ptr %mode.i.i, align 8
  %14 = add i32 %13, -16180
  %or.cond.i.i = icmp ult i32 %14, 32
  br i1 %or.cond.i.i, label %if.end.i8.i, label %cleanup

if.end.i8.i:                                      ; preds = %inflateStateCheck.exit.i
  ...
  %15 = load i32, ptr %wrap.i.i, align 8
...
if.end5.i.i:                                      ; preds = %if.then3.i.i, %if.end.i8.i
...
if.then13.i:                                      ; preds = %if.end10.i
  store ptr @zcalloc, ptr %zalloc.i, align 8
...
if.then18.i:                                      ; preds = %if.end15.i
  store ptr @zcfree, ptr %zfree.i, align 8
  br label %if.end20.i
...
if.end26.i:                                       ; preds = %if.end20.i
  ...
  store ptr %strm, ptr %call.i, align 8
...
if.then32.i:                                      ; preds = %if.end26.i
  %5 = load ptr, ptr %zfree.i, align 8
  %6 = load ptr, ptr %opaque22.i, align 8
...
if.end9:                                          ; preds = %lor.lhs.false
  ...
  %9 = load i64, ptr %hold14, align 8
  %add15 = add i64 %9, %conv13
  store i64 %add15, ptr %hold14, align 8
  store i32 %add, ptr %bits6, align 8
  br label %cleanup
...
for.cond:                                         ; preds = %sw.epilog1881, %do.body
  ...
  %put.04802 = ptrtoint ptr %put.0 to i64
...
do.body852.preheader:                             ; preds = %while.cond848.preheader
  ...
  br i1 %cmp853, label %do.body1882.loopexit3671, label %if.end856

while.cond634.preheader:                          ; preds = %for.cond
  %cmp6353584 = icmp ult i32 %bits.0, 32
  br i1 %cmp6353584, label %do.body638.preheader, label %do.end654

do.body638.preheader:                             ; preds = %while.cond634.preheader
  %17 = zext i32 %bits.0 to i64
  %cmp639 = icmp eq i32 %have.0, 0
  br i1 %cmp639, label %do.body1882.loopexit3662, label %if.end642

while.cond117.preheader:                          ; preds = %for.cond
  %cmp1183601 = icmp ult i32 %bits.0, 16
  br i1 %cmp1183601, label %do.body121.preheader, label %do.end137

do.body121.preheader:                             ; preds = %while.cond117.preheader
  %18 = zext i32 %bits.0 to i64
  %cmp122 = icmp eq i32 %have.0, 0
  br i1 %cmp122, label %do.body1882.loopexit3661, label %if.end125

sw.bb:                                            ; preds = %for.cond
  %19 = load i32, ptr %wrap1747, align 8
  %cmp15 = icmp eq i32 %19, 0
  br i1 %cmp15, label %if.then16, label %while.cond.preheader

while.cond.preheader:                             ; preds = %sw.bb
  %cmp203643 = icmp ult i32 %bits.0, 16
  br i1 %cmp203643, label %do.body21.preheader, label %do.end29

do.body21.preheader:                              ; preds = %while.cond.preheader
  %20 = zext i32 %bits.0 to i64
  %cmp22 = icmp eq i32 %have.0, 0
  br i1 %cmp22, label %do.body1882.loopexit3656, label %if.end24
...
if.end24:                                         ; preds = %do.body21.preheader
  ...
  %21 = load i8, ptr %next.0, align 1
  %conv = zext i8 %21 to i64
  %shl = shl nuw nsw i64 %conv, %20
  %add = add i64 %shl, %hold.0
  %indvars.iv.next4066 = add nuw nsw i64 %20, 8
  %cmp20 = icmp ult i32 %bits.0, 8
  br i1 %cmp20, label %do.body21.1, label %do.end29.loopexit

do.body21.1:                                      ; preds = %if.end24
  %cmp22.1 = icmp eq i32 %dec, 0
  br i1 %cmp22.1, label %do.body1882.loopexit3656, label %if.end24.1
...
if.end24.1:                                       ; preds = %do.body21.1
  ...
  %shl.1 = shl nuw nsw i64 %conv.1, %indvars.iv.next4066
  %add.1 = add i64 %shl.1, %add
  %indvars.iv.next4066.1 = add nuw nsw i64 %20, 16
...
do.end29.loopexit:                                ; preds = %if.end24.1, %if.end24
  ...
  %indvars.iv.next4066.lcssa = phi i64 [ %indvars.iv.next4066, %if.end24 ], [ %indvars.iv.next4066.1, %if.end24.1 ]
  %23 = trunc i64 %indvars.iv.next4066.lcssa to i32
  br label %do.end29
...
if.then72:                                        ; preds = %lor.lhs.false64, %if.end60
  store ptr @.str.1, ptr %msg1827, align 8
...
if.then79:                                        ; preds = %if.end74
  store ptr @.str.2, ptr %msg1827, align 8
  store i32 16209, ptr %mode.i, align 8
  br label %sw.epilog1881
...
if.end95:                                         ; preds = %if.then93, %do.body83
  ...
  %or.cond4471 = select i1 %cmp96, i1 true, i1 %cmp100
  br i1 %or.cond4471, label %if.then102, label %if.end105

if.then102:                                       ; preds = %if.end95
  store ptr @.str.3, ptr %msg1827, align 8
  store i32 16209, ptr %mode.i, align 8
  br label %sw.epilog1881

if.end105:                                        ; preds = %if.end95
  %shl106 = shl nuw nsw i32 256, %and88
  store i32 %shl106, ptr %dmax, align 4
  %call107 = call i64 @adler32(i64 noundef 0, ptr noundef null, i32 noundef 0) #10
  store i64 %call107, ptr %check1786, align 8
  store i64 %call107, ptr %adler1800, align 8
...
if.end125:                                        ; preds = %do.body121.preheader
  ...
  %29 = load i8, ptr %next.0, align 1
  %conv128 = zext i8 %29 to i64
  %shl130 = shl nuw nsw i64 %conv128, %18
  %add131 = add i64 %shl130, %hold.0
  %indvars.iv.next4045 = add nuw nsw i64 %18, 8
  %cmp118 = icmp ult i32 %bits.0, 8
  br i1 %cmp118, label %do.body121.1, label %do.end137.loopexit

do.body121.1:                                     ; preds = %if.end125
  %cmp122.1 = icmp eq i32 %dec126, 0
  br i1 %cmp122.1, label %do.body1882.loopexit3661, label %if.end125.1
...
if.end125.1:                                      ; preds = %do.body121.1
  ...
  %shl130.1 = shl nuw nsw i64 %conv128.1, %indvars.iv.next4045
  %add131.1 = add i64 %shl130.1, %add131
  %indvars.iv.next4045.1 = add nuw nsw i64 %18, 16
...
do.end137.loopexit:                               ; preds = %if.end125.1, %if.end125
  ...
  %indvars.iv.next4045.lcssa = phi i64 [ %indvars.iv.next4045, %if.end125 ], [ %indvars.iv.next4045.1, %if.end125.1 ]
  %31 = trunc i64 %indvars.iv.next4045.lcssa to i32
  br label %do.end137
...
do.end137:                                        ; preds = %do.end137.loopexit, %while.cond117.preheader
  ...
  store i32 %conv138, ptr %flags1783, align 8
...
if.then151:                                       ; preds = %if.end147
  store ptr @.str.4, ptr %msg1827, align 8
  store i32 16209, ptr %mode.i, align 8
  br label %sw.epilog1881

if.end154:                                        ; preds = %if.end147
  %32 = load ptr, ptr %head155, align 8
...
if.then158:                                       ; preds = %if.end154
  ...
  store i32 %conv161, ptr %32, align 8
  br label %if.end163
...
land.lhs.true167:                                 ; preds = %if.end163
  %34 = load i32, ptr %wrap1747, align 8
  %and169 = and i32 %34, 4
...
do.body190:                                       ; preds = %for.cond
  %cmp1923610 = icmp ult i32 %bits.0, 32
  br i1 %cmp1923610, label %do.body195.preheader, label %do.end211

do.body195.preheader:                             ; preds = %do.body190.thread, %do.body190
  %bits.34088 = phi i32 [ 0, %do.body190.thread ], [ %bits.0, %do.body190 ]
  %hold.34087 = phi i64 [ 0, %do.body190.thread ], [ %hold.0, %do.body190 ]
  %have.34086 = phi i32 [ %have.2.lcssa, %do.body190.thread ], [ %have.0, %do.body190 ]
  %next.34085 = phi ptr [ %next.2.lcssa, %do.body190.thread ], [ %next.0, %do.body190 ]
  %36 = zext i32 %bits.34088 to i64
  %cmp196 = icmp eq i32 %have.34086, 0
  br i1 %cmp196, label %do.body1882.loopexit3660, label %if.end199

if.end199:                                        ; preds = %do.body195.preheader
  %dec200 = add i32 %have.34086, -1
  %incdec.ptr201 = getelementptr inbounds i8, ptr %next.34085, i64 1
  %37 = load i8, ptr %next.34085, align 1
  %conv202 = zext i8 %37 to i64
  %shl204 = shl nuw nsw i64 %conv202, %36
  %add205 = add i64 %shl204, %hold.34087
  %indvars.iv.next4048 = add nuw nsw i64 %36, 8
  %cmp192 = icmp ult i32 %bits.34088, 24
  br i1 %cmp192, label %do.body195.1, label %do.end211

do.body195.1:                                     ; preds = %if.end199
  %cmp196.1 = icmp eq i32 %dec200, 0
  br i1 %cmp196.1, label %do.body1882.loopexit3660, label %if.end199.1

if.end199.1:                                      ; preds = %do.body195.1
  %dec200.1 = add i32 %have.34086, -2
  %incdec.ptr201.1 = getelementptr inbounds i8, ptr %next.34085, i64 2
  %38 = load i8, ptr %incdec.ptr201, align 1
  %conv202.1 = zext i8 %38 to i64
  %shl204.1 = shl nuw nsw i64 %conv202.1, %indvars.iv.next4048
  %add205.1 = add i64 %shl204.1, %add205
  %indvars.iv.next4048.1 = add nuw nsw i64 %36, 16
  %cmp192.1 = icmp ult i32 %bits.34088, 16
  br i1 %cmp192.1, label %do.body195.2, label %do.end211

do.body195.2:                                     ; preds = %if.end199.1
  %cmp196.2 = icmp eq i32 %dec200.1, 0
  br i1 %cmp196.2, label %do.body1882.loopexit3660, label %if.end199.2

if.end199.2:                                      ; preds = %do.body195.2
  %dec200.2 = add i32 %have.34086, -3
  %incdec.ptr201.2 = getelementptr inbounds i8, ptr %next.34085, i64 3
  %39 = load i8, ptr %incdec.ptr201.1, align 1
  %conv202.2 = zext i8 %39 to i64
  %shl204.2 = shl nuw nsw i64 %conv202.2, %indvars.iv.next4048.1
  %add205.2 = add i64 %shl204.2, %add205.1
  %indvars.iv.next4048.2 = add nuw nsw i64 %36, 24
  %cmp192.2 = icmp ult i32 %bits.34088, 8
  br i1 %cmp192.2, label %do.body195.3, label %do.end211

do.body195.3:                                     ; preds = %if.end199.2
  %cmp196.3 = icmp eq i32 %dec200.2, 0
  br i1 %cmp196.3, label %do.body1882.loopexit3660, label %if.end199.3

if.end199.3:                                      ; preds = %do.body195.3
  %dec200.3 = add i32 %have.34086, -4
  %incdec.ptr201.3 = getelementptr inbounds i8, ptr %next.34085, i64 4
  %40 = load i8, ptr %incdec.ptr201.2, align 1
  %conv202.3 = zext i8 %40 to i64
  %shl204.3 = shl nuw nsw i64 %conv202.3, %indvars.iv.next4048.2
...
do.end211:                                        ; preds = %if.end199, %if.end199.1, %if.end199.2, %if.end199.3, %do.body190
  ...
  %41 = load ptr, ptr %head155, align 8
...
if.end217:                                        ; preds = %if.then215, %do.end211
  %42 = load i32, ptr %flags1783, align 8
...
land.lhs.true221:                                 ; preds = %if.end217
  %43 = load i32, ptr %wrap1747, align 8
  %and223 = and i32 %43, 4
...
do.body250:                                       ; preds = %for.cond
  %cmp2523618 = icmp ult i32 %bits.0, 16
  br i1 %cmp2523618, label %do.body255.preheader, label %do.end271

do.body255.preheader:                             ; preds = %do.body250.thread, %do.body250
  %bits.54097 = phi i32 [ 0, %do.body250.thread ], [ %bits.0, %do.body250 ]
  %hold.54096 = phi i64 [ 0, %do.body250.thread ], [ %hold.0, %do.body250 ]
  %have.54095 = phi i32 [ %have.4.lcssa, %do.body250.thread ], [ %have.0, %do.body250 ]
  %next.54094 = phi ptr [ %next.4.lcssa, %do.body250.thread ], [ %next.0, %do.body250 ]
  %45 = zext i32 %bits.54097 to i64
  %cmp256 = icmp eq i32 %have.54095, 0
  br i1 %cmp256, label %do.body1882.loopexit3659, label %if.end259

if.end259:                                        ; preds = %do.body255.preheader
  %dec260 = add i32 %have.54095, -1
  %incdec.ptr261 = getelementptr inbounds i8, ptr %next.54094, i64 1
  %46 = load i8, ptr %next.54094, align 1
  %conv262 = zext i8 %46 to i64
  %shl264 = shl nuw nsw i64 %conv262, %45
  %add265 = add i64 %shl264, %hold.54096
  %indvars.iv.next4051 = add nuw nsw i64 %45, 8
  %cmp252 = icmp ult i32 %bits.54097, 8
  br i1 %cmp252, label %do.body255.1, label %do.end271

do.body255.1:                                     ; preds = %if.end259
  %cmp256.1 = icmp eq i32 %dec260, 0
  br i1 %cmp256.1, label %do.body1882.loopexit3659, label %if.end259.1

if.end259.1:                                      ; preds = %do.body255.1
  %dec260.1 = add i32 %have.54095, -2
  %incdec.ptr261.1 = getelementptr inbounds i8, ptr %next.54094, i64 2
  %47 = load i8, ptr %incdec.ptr261, align 1
  %conv262.1 = zext i8 %47 to i64
  %shl264.1 = shl nuw nsw i64 %conv262.1, %indvars.iv.next4051
...
do.end271:                                        ; preds = %if.end259, %if.end259.1, %do.body250
  ...
  %48 = load ptr, ptr %head155, align 8
...
if.then275:                                       ; preds = %do.end271
  ...
  store i32 %conv277, ptr %xflags, align 8
  ...
  store i32 %conv280, ptr %os, align 4
  br label %if.end282

if.end282:                                        ; preds = %if.then275, %do.end271
  %50 = load i32, ptr %flags1783, align 8
...
land.lhs.true286:                                 ; preds = %if.end282
  %51 = load i32, ptr %wrap1747, align 8
  %and288 = and i32 %51, 4
...
sw.bb308.thread:                                  ; preds = %do.body291, %land.lhs.true286, %if.end282
  ...
  %54 = load i32, ptr %flags1783, align 8
  %and3104102 = and i32 %54, 1024
  %tobool311.not4103 = icmp eq i32 %and3104102, 0
  br i1 %tobool311.not4103, label %if.else, label %do.body318.preheader

while.cond314.preheader:                          ; preds = %sw.bb308
  %cmp3153626 = icmp ult i32 %bits.0, 16
  br i1 %cmp3153626, label %do.body318.preheader, label %do.end334

do.body318.preheader:                             ; preds = %sw.bb308.thread, %while.cond314.preheader
  %next.741054120 = phi ptr [ %next.0, %while.cond314.preheader ], [ %next.6.lcssa, %sw.bb308.thread ]
  %have.741074119 = phi i32 [ %have.0, %while.cond314.preheader ], [ %have.6.lcssa, %sw.bb308.thread ]
  %hold.741094118 = phi i64 [ %hold.0, %while.cond314.preheader ], [ 0, %sw.bb308.thread ]
  %bits.741114117 = phi i32 [ %bits.0, %while.cond314.preheader ], [ 0, %sw.bb308.thread ]
  %55 = phi i32 [ %53, %while.cond314.preheader ], [ %54, %sw.bb308.thread ]
  %56 = zext i32 %bits.741114117 to i64
  %cmp319 = icmp eq i32 %have.741074119, 0
  br i1 %cmp319, label %do.body1882.loopexit3658, label %if.end322

if.end322:                                        ; preds = %do.body318.preheader
  %dec323 = add i32 %have.741074119, -1
  %incdec.ptr324 = getelementptr inbounds i8, ptr %next.741054120, i64 1
  %57 = load i8, ptr %next.741054120, align 1
  %conv325 = zext i8 %57 to i64
  %shl327 = shl nuw nsw i64 %conv325, %56
  %add328 = add i64 %shl327, %hold.741094118
  %indvars.iv.next4054 = add nuw nsw i64 %56, 8
  %cmp315 = icmp ult i32 %bits.741114117, 8
  br i1 %cmp315, label %do.body318.1, label %do.end334

do.body318.1:                                     ; preds = %if.end322
  %cmp319.1 = icmp eq i32 %dec323, 0
  br i1 %cmp319.1, label %do.body1882.loopexit3658, label %if.end322.1

if.end322.1:                                      ; preds = %do.body318.1
  %dec323.1 = add i32 %have.741074119, -2
  %incdec.ptr324.1 = getelementptr inbounds i8, ptr %next.741054120, i64 2
  %58 = load i8, ptr %incdec.ptr324, align 1
  %conv325.1 = zext i8 %58 to i64
  %shl327.1 = shl nuw nsw i64 %conv325.1, %indvars.iv.next4054
...
do.end334:                                        ; preds = %if.end322, %if.end322.1, %while.cond314.preheader
  ...
  store i32 %conv335, ptr %length1741, align 4
  %60 = load ptr, ptr %head155, align 8
...
if.then339:                                       ; preds = %do.end334
  ...
  store i32 %conv335, ptr %extra_len, align 8
  br label %if.end342
...
land.lhs.true346:                                 ; preds = %if.end342
  %61 = load i32, ptr %wrap1747, align 8
  %and348 = and i32 %61, 4
...
do.body351:                                       ; preds = %land.lhs.true346
  ...
  store i8 %conv352, ptr %hbuf, align 1
  %shr354 = lshr i64 %hold.8.lcssa, 8
  %conv355 = trunc i64 %shr354 to i8
  store i8 %conv355, ptr %arrayidx177, align 1
  %62 = load i64, ptr %check1786, align 8
  %call359 = call i64 @crc32(i64 noundef %62, ptr noundef nonnull %hbuf, i32 noundef 2) #10
  store i64 %call359, ptr %check1786, align 8
  br label %if.end373

if.else:                                          ; preds = %sw.bb308.thread, %sw.bb308
  %bits.74110 = phi i32 [ 0, %sw.bb308.thread ], [ %bits.0, %sw.bb308 ]
  %hold.74108 = phi i64 [ 0, %sw.bb308.thread ], [ %hold.0, %sw.bb308 ]
  %have.74106 = phi i32 [ %have.6.lcssa, %sw.bb308.thread ], [ %have.0, %sw.bb308 ]
  %next.74104 = phi ptr [ %next.6.lcssa, %sw.bb308.thread ], [ %next.0, %sw.bb308 ]
  %63 = load ptr, ptr %head155, align 8
...
if.end373:                                        ; preds = %do.body351, %land.lhs.true346, %if.end342, %if.else, %if.then370
  %next.9 = phi ptr [ %next.74104, %if.then370 ], [ %next.74104, %if.else ], [ %next.8.lcssa, %if.end342 ], [ %next.8.lcssa, %land.lhs.true346 ], [ %next.8.lcssa, %do.body351 ]
  %have.9 = phi i32 [ %have.74106, %if.then370 ], [ %have.74106, %if.else ], [ %have.8.lcssa, %if.end342 ], [ %have.8.lcssa, %land.lhs.true346 ], [ %have.8.lcssa, %do.body351 ]
  %hold.9 = phi i64 [ %hold.74108, %if.then370 ], [ %hold.74108, %if.else ], [ 0, %if.end342 ], [ 0, %land.lhs.true346 ], [ 0, %do.body351 ]
  %bits.9 = phi i32 [ %bits.74110, %if.then370 ], [ %bits.74110, %if.else ], [ 0, %if.end342 ], [ 0, %land.lhs.true346 ], [ 0, %do.body351 ]
...
sw.bb375:                                         ; preds = %for.cond, %if.end373
  ...
  %64 = load i32, ptr %flags1783, align 8
...
if.then379:                                       ; preds = %sw.bb375
  %65 = load i32, ptr %length1741, align 4
...
if.then386:                                       ; preds = %if.then379
  %66 = load ptr, ptr %head155, align 8
...
land.lhs.true390:                                 ; preds = %if.then386
  ...
  %67 = load ptr, ptr %extra392, align 8
...
if.then395:                                       ; preds = %land.lhs.true390
  ...
  %68 = load i32, ptr %extra_len397, align 8
  ...
  %69 = load i32, ptr %extra_max, align 4
  ...
  %.pre4078 = load i32, ptr %flags1783, align 8
  br label %if.end411

if.end411:                                        ; preds = %if.then395, %land.lhs.true390, %if.then386
  %70 = phi i32 [ %.pre4078, %if.then395 ], [ %64, %land.lhs.true390 ], [ %64, %if.then386 ]
...
if.end423:                                        ; preds = %if.then419, %land.lhs.true415, %if.end411
  ...
  %73 = load i32, ptr %length1741, align 4
  %sub428 = sub i32 %73, %spec.select
  store i32 %sub428, ptr %length1741, align 4
  br label %if.end429
...
if.end429:                                        ; preds = %if.end423, %if.then379
  ...
  br i1 %tobool431.not, label %if.end434, label %do.body1882
...
if.end434:                                        ; preds = %if.end429, %sw.bb375
  ...
  store i32 0, ptr %length1741, align 4
...
sw.bb437:                                         ; preds = %for.cond, %if.end434
  ...
  %75 = load i32, ptr %flags1783, align 8
...
if.then441:                                       ; preds = %sw.bb437
  ...
  br i1 %cmp442, label %do.body1882, label %do.body446.preheader
...
do.body446:                                       ; preds = %do.body446.preheader, %do.cond470
  %indvars.iv4056 = phi i64 [ 0, %do.body446.preheader ], [ %indvars.iv.next4057, %do.cond470 ]
  %indvars.iv.next4057 = add nuw nsw i64 %indvars.iv4056, 1
  %arrayidx447 = getelementptr inbounds i8, ptr %next.13, i64 %indvars.iv4056
  %77 = load i8, ptr %arrayidx447, align 1
  %78 = load ptr, ptr %head155, align 8
...
if.then497:                                       ; preds = %if.else493
  ...
  store ptr null, ptr %name499, align 8
  br label %if.end501
...
sw.bb504:                                         ; preds = %for.cond, %if.end501
  ...
  %88 = load i32, ptr %flags1783, align 8
...
if.then508:                                       ; preds = %sw.bb504
  ...
  br i1 %cmp509, label %do.body1882, label %do.body513.preheader
...
do.body513:                                       ; preds = %do.body513.preheader, %do.cond539
  %indvars.iv4059 = phi i64 [ 0, %do.body513.preheader ], [ %indvars.iv.next4060, %do.cond539 ]
  %indvars.iv.next4060 = add nuw nsw i64 %indvars.iv4059, 1
  %arrayidx516 = getelementptr inbounds i8, ptr %next.15, i64 %indvars.iv4059
  %90 = load i8, ptr %arrayidx516, align 1
  %91 = load ptr, ptr %head155, align 8
...
land.lhs.true521:                                 ; preds = %do.body513
  ...
  %92 = load ptr, ptr %comment, align 8
...
if.then568:                                       ; preds = %if.else564
  ...
  store ptr null, ptr %comment570, align 8
  br label %if.end572
...
sw.bb574:                                         ; preds = %for.cond, %if.end572
  ...
  %101 = load i32, ptr %flags1783, align 8
...
do.end600.loopexit:                               ; preds = %if.end588.1, %if.end588
  ...
  %indvars.iv.next4063.lcssa = phi i64 [ %indvars.iv.next4063, %if.end588 ], [ %indvars.iv.next4063.1, %if.end588.1 ]
  %105 = trunc i64 %indvars.iv.next4063.lcssa to i32
  br label %do.end600
...
do.end600:                                        ; preds = %do.end600.loopexit, %while.cond580.preheader
  ...
  %106 = load i32, ptr %wrap1747, align 8
...
land.lhs.true604:                                 ; preds = %do.end600
  %107 = load i64, ptr %check1786, align 8
...
if.then609:                                       ; preds = %land.lhs.true604
  store ptr @.str.5, ptr %msg1827, align 8
  store i32 16209, ptr %mode.i, align 8
  br label %sw.epilog1881
...
if.end616:                                        ; preds = %land.lhs.true604, %do.end600, %sw.bb574
  ...
  %108 = load ptr, ptr %head155, align 8
...
do.end654:                                        ; preds = %if.end642, %if.end642.1, %if.end642.2, %if.end642.3, %while.cond634.preheader
  ...
  store i64 %add665, ptr %check1786, align 8
  store i64 %add665, ptr %adler1800, align 8
...
sw.bb672:                                         ; preds = %for.cond, %do.end654
  ...
  %113 = load i32, ptr %havedict, align 4
...
if.end685:                                        ; preds = %sw.bb672
  ...
  store i64 %call686, ptr %check1786, align 8
  store i64 %call686, ptr %adler1800, align 8
  store i32 16191, ptr %mode.i, align 8
  br label %sw.bb690
...
sw.bb690:                                         ; preds = %for.cond, %if.end685
  ...
  br i1 %or.cond2003, label %do.body1882, label %sw.bb698
...
sw.bb698:                                         ; preds = %sw.bb690, %for.cond
  ...
  %114 = load i32, ptr %last699, align 4
...
while.cond713.preheader:                          ; preds = %sw.bb698
  %cmp7143592 = icmp ult i32 %bits.19, 3
  br i1 %cmp7143592, label %do.body717, label %do.end733
...
if.end721:                                        ; preds = %do.body717
  ...
  %115 = load i8, ptr %next.23, align 1
...
do.end733:                                        ; preds = %if.end721, %while.cond713.preheader
  ...
  store i32 %and735, ptr %last699, align 4
...
sw.bb759:                                         ; preds = %do.end733
  store ptr @.str.6, ptr %msg1827, align 8
  br label %do.body762.sink.split
...
do.end797.loopexit:                               ; preds = %if.end785.3, %if.end785.2, %if.end785.1, %if.end785
  ...
  %indvars.iv.next4040.lcssa = phi i64 [ %indvars.iv.next4040, %if.end785 ], [ %indvars.iv.next4040.1, %if.end785.1 ], [ %indvars.iv.next4040.2, %if.end785.2 ], [ %indvars.iv.next4040.3, %if.end785.3 ]
  %123 = trunc i64 %indvars.iv.next4040.lcssa to i32
  br label %do.end797
...
if.then802:                                       ; preds = %do.end797
  store ptr @.str.7, ptr %msg1827, align 8
  store i32 16209, ptr %mode.i, align 8
  br label %sw.epilog1881
...
if.end805:                                        ; preds = %do.end797
  ...
  store i32 %and807, ptr %length1741, align 4
  store i32 16194, ptr %mode.i, align 8
  br i1 %cmp1269, label %do.body1882, label %sw.bb817
...
sw.bb819:                                         ; preds = %for.cond, %sw.bb817
  ...
  %124 = load i32, ptr %length1741, align 4
...
if.then822:                                       ; preds = %sw.bb819
  ...
  br i1 %cmp831, label %do.body1882, label %if.end834
...
if.end834:                                        ; preds = %if.then822
  ...
  %125 = load i32, ptr %length1741, align 4
  %sub843 = sub i32 %125, %copy.4
  store i32 %sub843, ptr %length1741, align 4
  br label %sw.epilog1881
...
do.end868.loopexit:                               ; preds = %if.end856.1, %if.end856
  ...
  %indvars.iv.next4000.lcssa = phi i64 [ %indvars.iv.next4000, %if.end856 ], [ %indvars.iv.next4000.1, %if.end856.1 ]
  %128 = trunc i64 %indvars.iv.next4000.lcssa to i32
  br label %do.end868
...
do.end868:                                        ; preds = %do.end868.loopexit, %while.cond848.preheader
  ...
  %or.cond2921 = or i1 %cmp894, %cmp898
  br i1 %or.cond2921, label %if.then900, label %sw.bb906.thread

if.then900:                                       ; preds = %do.end868
  store ptr @.str.8, ptr %msg1827, align 8
  store i32 16209, ptr %mode.i, align 8
  br label %sw.epilog1881

sw.bb906.thread:                                  ; preds = %do.end868
  store i32 0, ptr %have904, align 4
  store i32 16197, ptr %mode.i, align 8
  br label %while.cond914.preheader.preheader

sw.bb906:                                         ; preds = %for.cond
  %.pre4070 = load i32, ptr %ncode, align 8
  %have908.promoted.pre = load i32, ptr %have904, align 4
  %cmp9103394 = icmp ult i32 %have908.promoted.pre, %.pre4070
...
while.cond914.preheader.preheader:                ; preds = %sw.bb906.thread, %sw.bb906
  %bits.254131 = phi i32 [ %sub890, %sw.bb906.thread ], [ %bits.0, %sw.bb906 ]
  %hold.254130 = phi i64 [ %shr889, %sw.bb906.thread ], [ %hold.0, %sw.bb906 ]
  %have.294129 = phi i32 [ %have.28.lcssa, %sw.bb906.thread ], [ %have.0, %sw.bb906 ]
  %next.294128 = phi ptr [ %next.28.lcssa, %sw.bb906.thread ], [ %next.0, %sw.bb906 ]
  %131 = phi i32 [ %add887, %sw.bb906.thread ], [ %.pre4070, %sw.bb906 ]
  %have908.promoted4127 = phi i32 [ 0, %sw.bb906.thread ], [ %have908.promoted.pre, %sw.bb906 ]
  %132 = zext i32 %have908.promoted4127 to i64
...
while.cond914.preheader:                          ; preds = %while.cond914.preheader.preheader, %do.end934
  %indvars.iv4002 = phi i64 [ %132, %while.cond914.preheader.preheader ], [ %indvars.iv.next4003, %do.end934 ]
  %bits.263399 = phi i32 [ %bits.254131, %while.cond914.preheader.preheader ], [ %sub946, %do.end934 ]
  %hold.263398 = phi i64 [ %hold.254130, %while.cond914.preheader.preheader ], [ %shr945, %do.end934 ]
  %have.303397 = phi i32 [ %have.294129, %while.cond914.preheader.preheader ], [ %have.31.lcssa, %do.end934 ]
  %next.303396 = phi ptr [ %next.294128, %while.cond914.preheader.preheader ], [ %next.31.lcssa, %do.end934 ]
...
if.end922:                                        ; preds = %do.body918
  ...
  %134 = load i8, ptr %next.303396, align 1
...
do.end934:                                        ; preds = %if.end922, %while.cond914.preheader
  ...
  %135 = trunc i64 %indvars.iv.next4003 to i32
  store i32 %135, ptr %have904, align 4
  %arrayidx941 = getelementptr inbounds [19 x i16], ptr @inflate.order, i64 0, i64 %indvars.iv4002
  %136 = load i16, ptr %arrayidx941, align 2
  %idxprom942 = zext i16 %136 to i64
  %arrayidx943 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %idxprom942
  store i16 %and936, ptr %arrayidx943, align 2
  %shr945 = lshr i64 %hold.27.lcssa, 3
  %sub946 = add i32 %bits.27.lcssa, -3
  %exitcond.not = icmp eq i64 %indvars.iv.next4003, %wide.trip.count
  br i1 %exitcond.not, label %while.cond950.preheader, label %while.cond914.preheader

while.body954:                                    ; preds = %while.body954.preheader, %while.body954
  %indvars.iv4005 = phi i64 [ %133, %while.body954.preheader ], [ %indvars.iv.next4006, %while.body954 ]
  %indvars.iv.next4006 = add nuw nsw i64 %indvars.iv4005, 1
  %arrayidx959 = getelementptr inbounds [19 x i16], ptr @inflate.order, i64 0, i64 %indvars.iv4005
  %137 = load i16, ptr %arrayidx959, align 2
  %idxprom960 = zext i16 %137 to i64
  %arrayidx961 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %idxprom960
  store i16 0, ptr %arrayidx961, align 2
  %138 = and i64 %indvars.iv.next4006, 4294967295
  %exitcond4008.not = icmp eq i64 %138, 19
  br i1 %exitcond4008.not, label %while.cond950.while.end962_crit_edge, label %while.body954

while.cond950.while.end962_crit_edge:             ; preds = %while.body954
  store i32 19, ptr %have904, align 4
  br label %while.end962

while.end962:                                     ; preds = %while.cond950.while.end962_crit_edge, %while.cond950.preheader
  store ptr %codes, ptr %next964, align 8
  store ptr %codes, ptr %lencode, align 8
...
if.then973:                                       ; preds = %while.end962
  store ptr @.str.9, ptr %msg1827, align 8
  store i32 16209, ptr %mode.i, align 8
  br label %sw.epilog1881
...
sw.bb979:                                         ; preds = %for.cond.sw.bb979_crit_edge, %if.end976
  ...
  %139 = load i32, ptr %nlen, align 4
  %140 = load i32, ptr %ndist, align 8
...
for.cond988.preheader.lr.ph:                      ; preds = %sw.bb979
  %141 = load ptr, ptr %lencode, align 8
  %142 = load i32, ptr %lenbits, align 8
  %notmask = shl nsw i32 -1, %142
  %sub993 = xor i32 %notmask, -1
...
for.cond988.preheader:                            ; preds = %for.cond988.preheader.lr.ph, %if.end1216
  ...
  %conv9903408 = trunc i64 %hold.293464 to i32
  %and9943409 = and i32 %sub993, %conv9903408
  %idxprom9953410 = zext i32 %and9943409 to i64
  %here.sroa.18.0.arrayidx996.sroa_idx3412 = getelementptr inbounds %struct.code, ptr %141, i64 %idxprom9953410, i32 1
  %here.sroa.18.0.copyload3413 = load i8, ptr %here.sroa.18.0.arrayidx996.sroa_idx3412, align 1
  %conv9983414 = zext i8 %here.sroa.18.0.copyload3413 to i32
  %cmp999.not3415 = icmp ult i32 %bits.293465, %conv9983414
  br i1 %cmp999.not3415, label %do.body1003.preheader, label %for.end
...
do.body1003:                                      ; preds = %do.body1003.preheader, %if.end1007
  %indvars.iv4009 = phi i64 [ %143, %do.body1003.preheader ], [ %indvars.iv.next4010, %if.end1007 ]
  %hold.303418 = phi i64 [ %hold.293464, %do.body1003.preheader ], [ %add1013, %if.end1007 ]
  %have.343417 = phi i32 [ %have.333463, %do.body1003.preheader ], [ %dec1008, %if.end1007 ]
  %next.343416 = phi ptr [ %next.333462, %do.body1003.preheader ], [ %incdec.ptr1009, %if.end1007 ]
  %cmp1004 = icmp eq i32 %have.343417, 0
  br i1 %cmp1004, label %do.body1882.loopexit4132, label %if.end1007

if.end1007:                                       ; preds = %do.body1003
  %dec1008 = add i32 %have.343417, -1
  %incdec.ptr1009 = getelementptr inbounds i8, ptr %next.343416, i64 1
  %144 = load i8, ptr %next.343416, align 1
  %conv1010 = zext i8 %144 to i64
  %shl1012 = shl i64 %conv1010, %indvars.iv4009
  %add1013 = add i64 %shl1012, %hold.303418
  %indvars.iv.next4010 = add nuw nsw i64 %indvars.iv4009, 8
  ...
  %here.sroa.18.0.copyload = load i8, ptr %here.sroa.18.0.arrayidx996.sroa_idx, align 1
  %145 = zext i8 %here.sroa.18.0.copyload to i64
  %cmp999.not = icmp ult i64 %indvars.iv.next4010, %145
...
for.end.loopexit:                                 ; preds = %if.end1007
  ...
  %146 = trunc i64 %indvars.iv.next4010 to i32
  br label %for.end

for.end:                                          ; preds = %for.end.loopexit, %for.cond988.preheader
  %147 = phi i64 [ %idxprom9953410, %for.cond988.preheader ], [ %idxprom995, %for.end.loopexit ]
  %conv998.lcssa3407 = phi i32 [ %conv9983414, %for.cond988.preheader ], [ %conv998, %for.end.loopexit ]
  %next.34.lcssa = phi ptr [ %next.333462, %for.cond988.preheader ], [ %incdec.ptr1009, %for.end.loopexit ]
  %have.34.lcssa = phi i32 [ %have.333463, %for.cond988.preheader ], [ %dec1008, %for.end.loopexit ]
  %hold.30.lcssa = phi i64 [ %hold.293464, %for.cond988.preheader ], [ %add1013, %for.end.loopexit ]
  %bits.30.lcssa = phi i32 [ %bits.293465, %for.cond988.preheader ], [ %146, %for.end.loopexit ]
  %here.sroa.18.0.copyload.lcssa = phi i8 [ %here.sroa.18.0.copyload3413, %for.cond988.preheader ], [ %here.sroa.18.0.copyload, %for.end.loopexit ]
  %here.sroa.42.0.arrayidx996.sroa_idx.le = getelementptr inbounds %struct.code, ptr %141, i64 %147, i32 2
  %here.sroa.42.0.copyload.le = load i16, ptr %here.sroa.42.0.arrayidx996.sroa_idx.le, align 2
...
do.body1021:                                      ; preds = %for.end
  ...
  %sub1028 = sub i32 %bits.30.lcssa, %conv998.lcssa3407
  %inc1034 = add i32 %.lcssa345534583461, 1
  store i32 %inc1034, ptr %have904, align 4
  ...
  store i16 %here.sroa.42.0.copyload.le, ptr %arrayidx1036, align 2
  br label %if.end1216
...
while.cond1106.preheader:                         ; preds = %if.else1037
  %add1109 = add nuw nsw i32 %conv998.lcssa3407, 3
...
while.cond1044.preheader:                         ; preds = %if.else1037
  %add1047 = add nuw nsw i32 %conv998.lcssa3407, 2
...
while.cond1150.preheader:                         ; preds = %if.else1037
  %add1153 = add nuw nsw i32 %conv998.lcssa3407, 7
...
do.body1051:                                      ; preds = %do.body1051.preheader, %if.end1055
  %indvars.iv4015 = phi i64 [ %150, %do.body1051.preheader ], [ %indvars.iv.next4016, %if.end1055 ]
  ...
  br i1 %cmp1052, label %do.body1882.loopexit3653, label %if.end1055

if.end1055:                                       ; preds = %do.body1051
  %dec1056 = add i32 %have.353439, -1
  %incdec.ptr1057 = getelementptr inbounds i8, ptr %next.353438, i64 1
  %154 = load i8, ptr %next.353438, align 1
  %conv1058 = zext i8 %154 to i64
  %shl1060 = shl i64 %conv1058, %indvars.iv4015
  %add1061 = add i64 %shl1060, %hold.313440
  %indvars.iv.next4016 = add nuw nsw i64 %indvars.iv4015, 8
  %cmp1048 = icmp ult i64 %indvars.iv.next4016, %151
  br i1 %cmp1048, label %do.body1051, label %do.body1068.loopexit

do.body1068.loopexit:                             ; preds = %if.end1055
  %155 = trunc i64 %indvars.iv.next4016 to i32
...
if.end1084:                                       ; preds = %do.body1068
  ...
  %156 = load i16, ptr %arrayidx1089, align 2
...
do.body1113:                                      ; preds = %do.body1113.preheader, %if.end1117
  %indvars.iv4012 = phi i64 [ %148, %do.body1113.preheader ], [ %indvars.iv.next4013, %if.end1117 ]
  ...
  br i1 %cmp1114, label %do.body1882.loopexit3654, label %if.end1117

if.end1117:                                       ; preds = %do.body1113
  %dec1118 = add i32 %have.363430, -1
  %incdec.ptr1119 = getelementptr inbounds i8, ptr %next.363429, i64 1
  %157 = load i8, ptr %next.363429, align 1
  %conv1120 = zext i8 %157 to i64
  %shl1122 = shl i64 %conv1120, %indvars.iv4012
  %add1123 = add i64 %shl1122, %hold.323431
  %indvars.iv.next4013 = add nuw nsw i64 %indvars.iv4012, 8
  %cmp1110 = icmp ult i64 %indvars.iv.next4013, %149
  br i1 %cmp1110, label %do.body1113, label %do.body1130.loopexit

do.body1130.loopexit:                             ; preds = %if.end1117
  %158 = trunc i64 %indvars.iv.next4013 to i32
...
do.body1130:                                      ; preds = %do.body1130.loopexit, %while.cond1106.preheader
  ...
  %reass.sub = sub i32 %bits.32.lcssa, %conv998.lcssa3407
  %sub1145 = add i32 %reass.sub, -3
  br label %if.end1193

do.body1157:                                      ; preds = %do.body1157.preheader, %if.end1161
  %indvars.iv4018 = phi i64 [ %152, %do.body1157.preheader ], [ %indvars.iv.next4019, %if.end1161 ]
...
if.end1161:                                       ; preds = %do.body1157
  ...
  %159 = load i8, ptr %next.373447, align 1
  %conv1164 = zext i8 %159 to i64
  %shl1166 = shl i64 %conv1164, %indvars.iv4018
  %add1167 = add i64 %shl1166, %hold.333449
  %indvars.iv.next4019 = add nuw nsw i64 %indvars.iv4018, 8
  %cmp1154 = icmp ult i64 %indvars.iv.next4019, %153
  br i1 %cmp1154, label %do.body1157, label %do.body1174.loopexit

do.body1174.loopexit:                             ; preds = %if.end1161
  %160 = trunc i64 %indvars.iv.next4019 to i32
...
do.body1174:                                      ; preds = %do.body1174.loopexit, %while.cond1150.preheader
  ...
  %reass.sub3652 = sub i32 %bits.33.lcssa, %conv998.lcssa3407
  %sub1189 = add i32 %reass.sub3652, -7
  br label %if.end1193
...
while.body1208.preheader:                         ; preds = %if.end1193
  %min.iters.check4814 = icmp ult i32 %copy.5, 16
  br i1 %min.iters.check4814, label %while.body1208.preheader4827, label %vector.scevcheck
...
vector.scevcheck:                                 ; preds = %while.body1208.preheader
  ...
  br i1 %163, label %while.body1208.preheader4827, label %vector.ph4815

vector.ph4815:                                    ; preds = %vector.scevcheck
  %n.vec4817 = and i32 %copy.5, -16
  %ind.end4818 = and i32 %copy.5, 15
  %ind.end4820 = add i32 %.lcssa345534583461, %n.vec4817
  ...
  store <8 x i16> %broadcast.splat, ptr %165, align 2
  %166 = getelementptr inbounds i16, ptr %165, i64 8
  store <8 x i16> %broadcast.splat, ptr %166, align 2
  %167 = icmp eq i32 %n.vec4817, 16
  br i1 %167, label %middle.block4812, label %vector.body4823.1

vector.body4823.1:                                ; preds = %vector.ph4815
  ...
  store <8 x i16> %broadcast.splat, ptr %169, align 2
  %170 = getelementptr inbounds i16, ptr %169, i64 8
  store <8 x i16> %broadcast.splat, ptr %170, align 2
  %171 = icmp eq i32 %n.vec4817, 32
  br i1 %171, label %middle.block4812, label %vector.body4823.2

vector.body4823.2:                                ; preds = %vector.body4823.1
  ...
  store <8 x i16> %broadcast.splat, ptr %173, align 2
  %174 = getelementptr inbounds i16, ptr %173, i64 8
  store <8 x i16> %broadcast.splat, ptr %174, align 2
  %175 = icmp eq i32 %n.vec4817, 48
  br i1 %175, label %middle.block4812, label %vector.body4823.3

vector.body4823.3:                                ; preds = %vector.body4823.2
  ...
  store <8 x i16> %broadcast.splat, ptr %177, align 2
  %178 = getelementptr inbounds i16, ptr %177, i64 8
  store <8 x i16> %broadcast.splat, ptr %178, align 2
  %179 = icmp eq i32 %n.vec4817, 64
  br i1 %179, label %middle.block4812, label %vector.body4823.4

vector.body4823.4:                                ; preds = %vector.body4823.3
  ...
  store <8 x i16> %broadcast.splat, ptr %181, align 2
  %182 = getelementptr inbounds i16, ptr %181, i64 8
  store <8 x i16> %broadcast.splat, ptr %182, align 2
  %183 = icmp eq i32 %n.vec4817, 80
  br i1 %183, label %middle.block4812, label %vector.body4823.5

vector.body4823.5:                                ; preds = %vector.body4823.4
  ...
  store <8 x i16> %broadcast.splat, ptr %185, align 2
  %186 = getelementptr inbounds i16, ptr %185, i64 8
  store <8 x i16> %broadcast.splat, ptr %186, align 2
  %187 = icmp eq i32 %n.vec4817, 96
  br i1 %187, label %middle.block4812, label %vector.body4823.6

vector.body4823.6:                                ; preds = %vector.body4823.5
  ...
  store <8 x i16> %broadcast.splat, ptr %189, align 2
  %190 = getelementptr inbounds i16, ptr %189, i64 8
  store <8 x i16> %broadcast.splat, ptr %190, align 2
  %191 = icmp eq i32 %n.vec4817, 112
  br i1 %191, label %middle.block4812, label %vector.body4823.7

vector.body4823.7:                                ; preds = %vector.body4823.6
  ...
  store <8 x i16> %broadcast.splat, ptr %193, align 2
  %194 = getelementptr inbounds i16, ptr %193, i64 8
  store <8 x i16> %broadcast.splat, ptr %194, align 2
  br label %middle.block4812

middle.block4812:                                 ; preds = %vector.body4823.7, %vector.body4823.6, %vector.body4823.5, %vector.body4823.4, %vector.body4823.3, %vector.body4823.2, %vector.body4823.1, %vector.ph4815
  %cmp.n4822 = icmp eq i32 %copy.5, %n.vec4817
  br i1 %cmp.n4822, label %if.end1216.loopexit, label %while.body1208.preheader4827

while.body1208.preheader4827:                     ; preds = %vector.scevcheck, %while.body1208.preheader, %middle.block4812
  %copy.63456.ph = phi i32 [ %copy.5, %vector.scevcheck ], [ %copy.5, %while.body1208.preheader ], [ %ind.end4818, %middle.block4812 ]
  %.ph = phi i32 [ %.lcssa345534583461, %vector.scevcheck ], [ %.lcssa345534583461, %while.body1208.preheader ], [ %ind.end4820, %middle.block4812 ]
...
while.body1208.prol:                              ; preds = %while.body1208.preheader4827, %while.body1208.prol
  %copy.63456.prol = phi i32 [ %dec1206.prol, %while.body1208.prol ], [ %copy.63456.ph, %while.body1208.preheader4827 ]
  %196 = phi i32 [ %inc1212.prol, %while.body1208.prol ], [ %.ph, %while.body1208.preheader4827 ]
  %prol.iter = phi i32 [ %prol.iter.next, %while.body1208.prol ], [ 0, %while.body1208.preheader4827 ]
  ...
  store i16 %len.0, ptr %arrayidx1214.prol, align 2
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %while.body1208.prol.loopexit, label %while.body1208.prol

while.body1208.prol.loopexit:                     ; preds = %while.body1208.prol, %while.body1208.preheader4827
  %inc1212.lcssa4853.unr = phi i32 [ undef, %while.body1208.preheader4827 ], [ %inc1212.prol, %while.body1208.prol ]
  %copy.63456.unr = phi i32 [ %copy.63456.ph, %while.body1208.preheader4827 ], [ %dec1206.prol, %while.body1208.prol ]
  %.unr = phi i32 [ %.ph, %while.body1208.preheader4827 ], [ %inc1212.prol, %while.body1208.prol ]
...
while.body1208:                                   ; preds = %while.body1208.prol.loopexit, %while.body1208
  ...
  store i16 %len.0, ptr %arrayidx1214, align 2
  ...
  store i16 %len.0, ptr %arrayidx1214.1, align 2
  ...
  store i16 %len.0, ptr %arrayidx1214.2, align 2
  ...
  store i16 %len.0, ptr %arrayidx1214.3, align 2
  %tobool1207.not.3 = icmp eq i32 %dec1206.3, 0
  br i1 %tobool1207.not.3, label %if.end1216.loopexit, label %while.body1208

if.end1216.loopexit:                              ; preds = %while.body1208.prol.loopexit, %while.body1208, %middle.block4812
  %inc1212.lcssa = phi i32 [ %ind.end4820, %middle.block4812 ], [ %inc1212.lcssa4853.unr, %while.body1208.prol.loopexit ], [ %inc1212.3, %while.body1208 ]
  store i32 %inc1212.lcssa, ptr %have904, align 4
  br label %if.end1216
...
if.end1216:                                       ; preds = %if.end1216.loopexit, %do.body1021
  ...
  br i1 %cmp985, label %for.cond988.preheader, label %if.end1222
...
if.then1247:                                      ; preds = %if.end1231
  store ptr @.str.12, ptr %msg1827, align 8
  store i32 16209, ptr %mode.i, align 8
  br label %sw.epilog1881

if.end1250:                                       ; preds = %if.end1231
  %200 = load ptr, ptr %next964, align 8
  store ptr %200, ptr %distcode, align 8
  store i32 6, ptr %distbits, align 4
  %201 = load i32, ptr %nlen, align 4
  %idx.ext1255 = zext i32 %201 to i64
  %add.ptr1256 = getelementptr inbounds i16, ptr %lens966, i64 %idx.ext1255
  %202 = load i32, ptr %ndist, align 8
...
if.then1264:                                      ; preds = %if.end1250
  store ptr @.str.13, ptr %msg1827, align 8
  store i32 16209, ptr %mode.i, align 8
  br label %sw.epilog1881

if.end1267:                                       ; preds = %if.end1250
  store i32 16199, ptr %mode.i, align 8
  br i1 %cmp1269, label %do.body1882, label %sw.bb1273
...
do.body1282:                                      ; preds = %sw.bb1275
  ...
  %203 = load ptr, ptr %next_out, align 8
  %204 = load i32, ptr %avail_out, align 8
  %205 = load ptr, ptr %strm, align 8
  %206 = load i32, ptr %avail_in11, align 8
  %207 = load i64, ptr %hold12, align 8
  %208 = load i32, ptr %bits13, align 8
  %209 = load i32, ptr %mode.i, align 8
  %cmp1301 = icmp eq i32 %209, 16191
  br i1 %cmp1301, label %if.then1303, label %sw.epilog1881

if.then1303:                                      ; preds = %do.body1282
  store i32 -1, ptr %back1306, align 4
  br label %sw.epilog1881

if.end1305:                                       ; preds = %sw.bb1275
  store i32 0, ptr %back1306, align 4
  %210 = load ptr, ptr %lencode, align 8
  %211 = load i32, ptr %lenbits, align 8
  %notmask2893 = shl nsw i32 -1, %211
  %sub1312 = xor i32 %notmask2893, -1
  %conv13093472 = trunc i64 %hold.38 to i32
  %and13133473 = and i32 %sub1312, %conv13093472
  %idxprom13143474 = zext i32 %and13133473 to i64
  %arrayidx13153475 = getelementptr inbounds %struct.code, ptr %210, i64 %idxprom13143474
  %here.sroa.18.0.arrayidx1315.sroa_idx3476 = getelementptr inbounds i8, ptr %arrayidx13153475, i64 1
  %here.sroa.18.0.copyload20583477 = load i8, ptr %here.sroa.18.0.arrayidx1315.sroa_idx3476, align 1
  %conv13173478 = zext i8 %here.sroa.18.0.copyload20583477 to i32
  %cmp1318.not3479 = icmp ult i32 %bits.38, %conv13173478
  br i1 %cmp1318.not3479, label %do.body1322.preheader, label %for.end1336
...
do.body1322:                                      ; preds = %do.body1322.preheader, %if.end1326
  %indvars.iv4021 = phi i64 [ %212, %do.body1322.preheader ], [ %indvars.iv.next4022, %if.end1326 ]
  %hold.393482 = phi i64 [ %hold.38, %do.body1322.preheader ], [ %add1332, %if.end1326 ]
  %have.433481 = phi i32 [ %have.42, %do.body1322.preheader ], [ %dec1327, %if.end1326 ]
  %next.433480 = phi ptr [ %next.42, %do.body1322.preheader ], [ %incdec.ptr1328, %if.end1326 ]
  %cmp1323 = icmp eq i32 %have.433481, 0
  br i1 %cmp1323, label %do.body1882.loopexit4138, label %if.end1326

if.end1326:                                       ; preds = %do.body1322
  %dec1327 = add i32 %have.433481, -1
  %incdec.ptr1328 = getelementptr inbounds i8, ptr %next.433480, i64 1
  %213 = load i8, ptr %next.433480, align 1
  %conv1329 = zext i8 %213 to i64
  %shl1331 = shl i64 %conv1329, %indvars.iv4021
  %add1332 = add i64 %shl1331, %hold.393482
  %indvars.iv.next4022 = add nuw nsw i64 %indvars.iv4021, 8
  ...
  %here.sroa.18.0.copyload2058 = load i8, ptr %here.sroa.18.0.arrayidx1315.sroa_idx, align 1
  %214 = zext i8 %here.sroa.18.0.copyload2058 to i64
  %cmp1318.not = icmp ult i64 %indvars.iv.next4022, %214
...
for.end1336.loopexit:                             ; preds = %if.end1326
  ...
  %215 = trunc i64 %indvars.iv.next4022 to i32
  br label %for.end1336

for.end1336:                                      ; preds = %for.end1336.loopexit, %if.end1305
  %arrayidx1315.lcssa3471 = phi ptr [ %arrayidx13153475, %if.end1305 ], [ %arrayidx1315, %for.end1336.loopexit ]
  ...
  %here.sroa.18.0.copyload2058.lcssa = phi i8 [ %here.sroa.18.0.copyload20583477, %if.end1305 ], [ %here.sroa.18.0.copyload2058, %for.end1336.loopexit ]
  %conv1317.lcssa = phi i32 [ %conv13173478, %if.end1305 ], [ %conv1317, %for.end1336.loopexit ]
  %here.sroa.42.0.arrayidx1315.sroa_idx.le = getelementptr inbounds i8, ptr %arrayidx1315.lcssa3471, i64 2
  %here.sroa.42.0.copyload2083.le = load i16, ptr %here.sroa.42.0.arrayidx1315.sroa_idx.le, align 2
  %here.sroa.0.0.copyload2054 = load i8, ptr %arrayidx1315.lcssa3471, align 2
...
for.cond1346.preheader:                           ; preds = %for.end1336
  ...
  %notmask2894 = shl nsw i32 -1, %add1355
  %sub1357 = xor i32 %notmask2894, -1
  %conv13503493 = trunc i64 %hold.39.lcssa to i32
  %and13583494 = and i32 %conv13503493, %sub1357
  %shr13613495 = lshr i32 %and13583494, %conv1317.lcssa
  %add13623496 = add nuw i32 %shr13613495, %conv1349
  %idxprom13633497 = zext i32 %add13623496 to i64
  %arrayidx13643498 = getelementptr inbounds %struct.code, ptr %210, i64 %idxprom13633497
  %here.sroa.18.0.arrayidx1364.sroa_idx3499 = getelementptr inbounds i8, ptr %arrayidx13643498, i64 1
  %here.sroa.18.0.copyload20593500 = load i8, ptr %here.sroa.18.0.arrayidx1364.sroa_idx3499, align 1
  %conv13683501 = zext i8 %here.sroa.18.0.copyload20593500 to i32
  %add13693502 = add nuw nsw i32 %conv1317.lcssa, %conv13683501
  %cmp1370.not3503 = icmp ugt i32 %add13693502, %bits.39.lcssa
  br i1 %cmp1370.not3503, label %do.body1374.preheader, label %do.body1389
...
do.body1374:                                      ; preds = %do.body1374.preheader, %if.end1378
  %indvars.iv4025 = phi i64 [ %217, %do.body1374.preheader ], [ %indvars.iv.next4026, %if.end1378 ]
  %hold.403506 = phi i64 [ %hold.39.lcssa, %do.body1374.preheader ], [ %add1384, %if.end1378 ]
  %have.443505 = phi i32 [ %have.43.lcssa, %do.body1374.preheader ], [ %dec1379, %if.end1378 ]
  %next.443504 = phi ptr [ %next.43.lcssa, %do.body1374.preheader ], [ %incdec.ptr1380, %if.end1378 ]
  %cmp1375 = icmp eq i32 %have.443505, 0
  br i1 %cmp1375, label %do.body1882.loopexit4137, label %if.end1378

if.end1378:                                       ; preds = %do.body1374
  %dec1379 = add i32 %have.443505, -1
  %incdec.ptr1380 = getelementptr inbounds i8, ptr %next.443504, i64 1
  %218 = load i8, ptr %next.443504, align 1
  %conv1381 = zext i8 %218 to i64
  %shl1383 = shl i64 %conv1381, %indvars.iv4025
  %add1384 = add i64 %shl1383, %hold.403506
  %indvars.iv.next4026 = add nuw nsw i64 %indvars.iv4025, 8
  %conv1350 = trunc i64 %add1384 to i32
  %and1358 = and i32 %conv1350, %sub1357
  %shr1361 = lshr i32 %and1358, %conv1317.lcssa
  %add1362 = add nuw i32 %shr1361, %conv1349
  ...
  %here.sroa.18.0.copyload2059 = load i8, ptr %here.sroa.18.0.arrayidx1364.sroa_idx, align 1
...
do.body1389:                                      ; preds = %do.body1389.loopexit, %for.cond1346.preheader
  ...
  %arrayidx1364.lcssa = phi ptr [ %arrayidx13643498, %for.cond1346.preheader ], [ %arrayidx1364, %do.body1389.loopexit ]
  %here.sroa.18.0.copyload2059.lcssa = phi i8 [ %here.sroa.18.0.copyload20593500, %for.cond1346.preheader ], [ %here.sroa.18.0.copyload2059, %do.body1389.loopexit ]
  %here.sroa.42.0.arrayidx1364.sroa_idx = getelementptr inbounds i8, ptr %arrayidx1364.lcssa, i64 2
  %here.sroa.42.0.copyload2084 = load i16, ptr %here.sroa.42.0.arrayidx1364.sroa_idx, align 2
  %here.sroa.0.0.copyload2055 = load i8, ptr %arrayidx1364.lcssa, align 2
...
do.body1404:                                      ; preds = %for.end1336, %do.body1389
  ...
  %here.sroa.0.0 = phi i8 [ %here.sroa.0.0.copyload2055, %do.body1389 ], [ %here.sroa.0.0.copyload2054, %for.end1336 ]
  ...
  store i32 %add1417, ptr %back1306, align 4
  %conv1419 = zext i16 %here.sroa.42.0 to i32
  store i32 %conv1419, ptr %length1741, align 4
...
sw.bb1449.if.end1494_crit_edge:                   ; preds = %sw.bb1449
  %.pre4075 = load i32, ptr %length1741, align 4
  br label %if.end1494

while.cond1454.preheader:                         ; preds = %sw.bb1449
  %cmp14563514 = icmp ult i32 %bits.42, %222
  br i1 %cmp14563514, label %do.body1459, label %do.end1475

do.body1459:                                      ; preds = %while.cond1454.preheader, %if.end1463
  %bits.433518 = phi i32 [ %add1470, %if.end1463 ], [ %bits.42, %while.cond1454.preheader ]
  %hold.433517 = phi i64 [ %add1469, %if.end1463 ], [ %hold.42, %while.cond1454.preheader ]
  %have.473516 = phi i32 [ %dec1464, %if.end1463 ], [ %have.46, %while.cond1454.preheader ]
  %next.473515 = phi ptr [ %incdec.ptr1465, %if.end1463 ], [ %next.46, %while.cond1454.preheader ]
  %cmp1460 = icmp eq i32 %have.473516, 0
  br i1 %cmp1460, label %do.body1882.loopexit4136, label %if.end1463

if.end1463:                                       ; preds = %do.body1459
  %dec1464 = add i32 %have.473516, -1
  %incdec.ptr1465 = getelementptr inbounds i8, ptr %next.473515, i64 1
  %223 = load i8, ptr %next.473515, align 1
  %conv1466 = zext i8 %223 to i64
  %sh_prom1467 = zext i32 %bits.433518 to i64
  %shl1468 = shl i64 %conv1466, %sh_prom1467
  %add1469 = add i64 %shl1468, %hold.433517
  %add1470 = add i32 %bits.433518, 8
  %cmp1456 = icmp ult i32 %add1470, %222
  br i1 %cmp1456, label %do.body1459, label %do.end1475
...
do.end1475:                                       ; preds = %if.end1463, %while.cond1454.preheader
  ...
  %224 = load i32, ptr %length1741, align 4
  %add1482 = add i32 %224, %and1480
  store i32 %add1482, ptr %length1741, align 4
  %sh_prom1485 = zext i32 %222 to i64
  %shr1486 = lshr i64 %hold.43.lcssa, %sh_prom1485
  %sub1488 = sub i32 %bits.43.lcssa, %222
  %225 = load i32, ptr %back1306, align 4
  %add1493 = add i32 %225, %222
  store i32 %add1493, ptr %back1306, align 4
  br label %if.end1494

if.end1494:                                       ; preds = %sw.bb1449.if.end1494_crit_edge, %do.end1475
  %226 = phi i32 [ %add1482, %do.end1475 ], [ %.pre4075, %sw.bb1449.if.end1494_crit_edge ]
...
sw.bb1497:                                        ; preds = %for.cond, %if.end1494
  ...
  %227 = load ptr, ptr %distcode, align 8
  %228 = load i32, ptr %distbits, align 4
  %notmask2896 = shl nsw i32 -1, %228
  %sub1503 = xor i32 %notmask2896, -1
  %conv15003524 = trunc i64 %hold.45 to i32
  %and15043525 = and i32 %sub1503, %conv15003524
  %idxprom15053526 = zext i32 %and15043525 to i64
  %arrayidx15063527 = getelementptr inbounds %struct.code, ptr %227, i64 %idxprom15053526
  %here.sroa.18.0.arrayidx1506.sroa_idx3528 = getelementptr inbounds i8, ptr %arrayidx15063527, i64 1
  %here.sroa.18.0.copyload20603529 = load i8, ptr %here.sroa.18.0.arrayidx1506.sroa_idx3528, align 1
  %conv15083530 = zext i8 %here.sroa.18.0.copyload20603529 to i32
  %cmp1509.not3531 = icmp ult i32 %bits.45, %conv15083530
  br i1 %cmp1509.not3531, label %do.body1513.preheader, label %for.end1527
...
do.body1513:                                      ; preds = %do.body1513.preheader, %if.end1517
  %indvars.iv4030 = phi i64 [ %229, %do.body1513.preheader ], [ %indvars.iv.next4031, %if.end1517 ]
  %hold.463534 = phi i64 [ %hold.45, %do.body1513.preheader ], [ %add1523, %if.end1517 ]
  %have.503533 = phi i32 [ %have.49, %do.body1513.preheader ], [ %dec1518, %if.end1517 ]
  %next.503532 = phi ptr [ %next.49, %do.body1513.preheader ], [ %incdec.ptr1519, %if.end1517 ]
  %cmp1514 = icmp eq i32 %have.503533, 0
  br i1 %cmp1514, label %do.body1882.loopexit4135, label %if.end1517

if.end1517:                                       ; preds = %do.body1513
  %dec1518 = add i32 %have.503533, -1
  %incdec.ptr1519 = getelementptr inbounds i8, ptr %next.503532, i64 1
  %230 = load i8, ptr %next.503532, align 1
  %conv1520 = zext i8 %230 to i64
  %shl1522 = shl i64 %conv1520, %indvars.iv4030
  %add1523 = add i64 %shl1522, %hold.463534
  %indvars.iv.next4031 = add nuw nsw i64 %indvars.iv4030, 8
  ...
  %here.sroa.18.0.copyload2060 = load i8, ptr %here.sroa.18.0.arrayidx1506.sroa_idx, align 1
  %231 = zext i8 %here.sroa.18.0.copyload2060 to i64
  %cmp1509.not = icmp ult i64 %indvars.iv.next4031, %231
...
for.end1527.loopexit:                             ; preds = %if.end1517
  ...
  %232 = trunc i64 %indvars.iv.next4031 to i32
  br label %for.end1527

for.end1527:                                      ; preds = %for.end1527.loopexit, %sw.bb1497
  %arrayidx1506.lcssa3523 = phi ptr [ %arrayidx15063527, %sw.bb1497 ], [ %arrayidx1506, %for.end1527.loopexit ]
  ...
  %here.sroa.18.0.copyload2060.lcssa = phi i8 [ %here.sroa.18.0.copyload20603529, %sw.bb1497 ], [ %here.sroa.18.0.copyload2060, %for.end1527.loopexit ]
  %conv1508.lcssa = phi i32 [ %conv15083530, %sw.bb1497 ], [ %conv1508, %for.end1527.loopexit ]
  %here.sroa.42.0.arrayidx1506.sroa_idx.le = getelementptr inbounds i8, ptr %arrayidx1506.lcssa3523, i64 2
  %here.sroa.42.0.copyload2085.le = load i16, ptr %here.sroa.42.0.arrayidx1506.sroa_idx.le, align 2
  %here.sroa.0.0.copyload2056 = load i8, ptr %arrayidx1506.lcssa3523, align 2
...
for.end1527.do.body1592_crit_edge:                ; preds = %for.end1527
  %.pre4076 = load i32, ptr %back1306, align 4
...
for.cond1534.preheader:                           ; preds = %for.end1527
  ...
  %notmask2897 = shl nsw i32 -1, %add1543
  %sub1545 = xor i32 %notmask2897, -1
  %conv15383545 = trunc i64 %hold.46.lcssa to i32
  %and15463546 = and i32 %conv15383545, %sub1545
  %shr15493547 = lshr i32 %and15463546, %conv1508.lcssa
  %add15503548 = add nuw i32 %shr15493547, %conv1537
  %idxprom15513549 = zext i32 %add15503548 to i64
  %arrayidx15523550 = getelementptr inbounds %struct.code, ptr %227, i64 %idxprom15513549
  %here.sroa.18.0.arrayidx1552.sroa_idx3551 = getelementptr inbounds i8, ptr %arrayidx15523550, i64 1
  %here.sroa.18.0.copyload20613552 = load i8, ptr %here.sroa.18.0.arrayidx1552.sroa_idx3551, align 1
  %conv15563553 = zext i8 %here.sroa.18.0.copyload20613552 to i32
  %add15573554 = add nuw nsw i32 %conv1508.lcssa, %conv15563553
  %cmp1558.not3555 = icmp ugt i32 %add15573554, %bits.46.lcssa
  br i1 %cmp1558.not3555, label %do.body1562.preheader, label %do.body1577
...
do.body1562:                                      ; preds = %do.body1562.preheader, %if.end1566
  %indvars.iv4034 = phi i64 [ %233, %do.body1562.preheader ], [ %indvars.iv.next4035, %if.end1566 ]
  %hold.473558 = phi i64 [ %hold.46.lcssa, %do.body1562.preheader ], [ %add1572, %if.end1566 ]
  %have.513557 = phi i32 [ %have.50.lcssa, %do.body1562.preheader ], [ %dec1567, %if.end1566 ]
  %next.513556 = phi ptr [ %next.50.lcssa, %do.body1562.preheader ], [ %incdec.ptr1568, %if.end1566 ]
  %cmp1563 = icmp eq i32 %have.513557, 0
  br i1 %cmp1563, label %do.body1882.loopexit4134, label %if.end1566

if.end1566:                                       ; preds = %do.body1562
  %dec1567 = add i32 %have.513557, -1
  %incdec.ptr1568 = getelementptr inbounds i8, ptr %next.513556, i64 1
  %234 = load i8, ptr %next.513556, align 1
  %conv1569 = zext i8 %234 to i64
  %shl1571 = shl i64 %conv1569, %indvars.iv4034
  %add1572 = add i64 %shl1571, %hold.473558
  %indvars.iv.next4035 = add nuw nsw i64 %indvars.iv4034, 8
  %conv1538 = trunc i64 %add1572 to i32
  %and1546 = and i32 %conv1538, %sub1545
  %shr1549 = lshr i32 %and1546, %conv1508.lcssa
  %add1550 = add nuw i32 %shr1549, %conv1537
  ...
  %here.sroa.18.0.copyload2061 = load i8, ptr %here.sroa.18.0.arrayidx1552.sroa_idx, align 1
...
do.body1577:                                      ; preds = %do.body1577.loopexit, %for.cond1534.preheader
  ...
  %arrayidx1552.lcssa = phi ptr [ %arrayidx15523550, %for.cond1534.preheader ], [ %arrayidx1552, %do.body1577.loopexit ]
  %here.sroa.18.0.copyload2061.lcssa = phi i8 [ %here.sroa.18.0.copyload20613552, %for.cond1534.preheader ], [ %here.sroa.18.0.copyload2061, %do.body1577.loopexit ]
  %here.sroa.42.0.arrayidx1552.sroa_idx = getelementptr inbounds i8, ptr %arrayidx1552.lcssa, i64 2
  %here.sroa.42.0.copyload2086 = load i16, ptr %here.sroa.42.0.arrayidx1552.sroa_idx, align 2
  %here.sroa.0.0.copyload2057 = load i8, ptr %arrayidx1552.lcssa, align 2
  ...
  %237 = load i32, ptr %back1306, align 4
  %add1590 = add nsw i32 %237, %conv1508.lcssa
  br label %do.body1592

do.body1592:                                      ; preds = %for.end1527.do.body1592_crit_edge, %do.body1577
  %238 = phi i32 [ %add1590, %do.body1577 ], [ %.pre4076, %for.end1527.do.body1592_crit_edge ]
  ...
  store i32 %add1605, ptr %back1306, align 4
...
while.cond1626.preheader:                         ; preds = %sw.bb1621
  %cmp16283566 = icmp ult i32 %bits.49, %239
  br i1 %cmp16283566, label %do.body1631, label %do.end1647

do.body1631:                                      ; preds = %while.cond1626.preheader, %if.end1635
  %bits.503570 = phi i32 [ %add1642, %if.end1635 ], [ %bits.49, %while.cond1626.preheader ]
  %hold.503569 = phi i64 [ %add1641, %if.end1635 ], [ %hold.49, %while.cond1626.preheader ]
  %have.543568 = phi i32 [ %dec1636, %if.end1635 ], [ %have.53, %while.cond1626.preheader ]
  %next.543567 = phi ptr [ %incdec.ptr1637, %if.end1635 ], [ %next.53, %while.cond1626.preheader ]
  %cmp1632 = icmp eq i32 %have.543568, 0
  br i1 %cmp1632, label %do.body1882.loopexit4133, label %if.end1635

if.end1635:                                       ; preds = %do.body1631
  %dec1636 = add i32 %have.543568, -1
  %incdec.ptr1637 = getelementptr inbounds i8, ptr %next.543567, i64 1
  %240 = load i8, ptr %next.543567, align 1
  %conv1638 = zext i8 %240 to i64
  %sh_prom1639 = zext i32 %bits.503570 to i64
  %shl1640 = shl i64 %conv1638, %sh_prom1639
  %add1641 = add i64 %shl1640, %hold.503569
  %add1642 = add i32 %bits.503570, 8
  %cmp1628 = icmp ult i32 %add1642, %239
  br i1 %cmp1628, label %do.body1631, label %do.end1647
...
do.end1647:                                       ; preds = %if.end1635, %while.cond1626.preheader
  ...
  %notmask2898 = shl nsw i32 -1, %239
  %sub1651 = xor i32 %notmask2898, -1
  %and1652 = and i32 %conv1648, %sub1651
  %241 = load i32, ptr %offset, align 8
  %add1654 = add i32 %241, %and1652
  store i32 %add1654, ptr %offset, align 8
  %sh_prom1657 = zext i32 %239 to i64
  %shr1658 = lshr i64 %hold.50.lcssa, %sh_prom1657
  %sub1660 = sub i32 %bits.50.lcssa, %239
  %242 = load i32, ptr %back1306, align 4
  %add1665 = add i32 %242, %239
  store i32 %add1665, ptr %back1306, align 4
  br label %if.end1666
...
sw.bb1668:                                        ; preds = %for.cond, %if.end1666
  ...
  br i1 %cmp1669, label %do.body1882, label %if.end1672

if.end1672:                                       ; preds = %sw.bb1668
  %sub1673 = sub i32 %out.0, %left.0
  %243 = load i32, ptr %offset, align 8
...
if.then1691:                                      ; preds = %if.end1688
  ...
  %247 = load i32, ptr %wsize, align 4
...
if.end1703:                                       ; preds = %if.else1697, %if.then1691
  ...
  %.sink4472 = load ptr, ptr %window1698, align 8
  %idx.ext1701 = zext i32 %sub1700.sink to i64
  %add.ptr1702 = getelementptr inbounds i8, ptr %.sink4472, i64 %idx.ext1701
  %248 = load i32, ptr %length1741, align 4
...
if.else1710:                                      ; preds = %if.end1672
  ...
  %249 = load i32, ptr %length1741, align 4
  br label %if.end1715
...
if.end1715:                                       ; preds = %if.end1703, %if.else1710
  ...
  store i32 %sub1722, ptr %length1741, align 4
  %251 = add i32 %spec.select2906, -1
  %252 = zext i32 %251 to i64
  %253 = add nuw nsw i64 %252, 1
  %min.iters.check = icmp ult i32 %251, 31
  %from.14803 = ptrtoint ptr %from.1 to i64
  %254 = sub i64 %put.04802, %from.14803
  %diff.check = icmp ult i64 %254, 32
  %or.cond4826 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond4826, label %do.body1723.preheader, label %vector.ph

vector.ph:                                        ; preds = %if.end1715
  %n.vec = and i64 %253, 8589934560
  %ind.end = getelementptr i8, ptr %put.0, i64 %n.vec
  %.cast = trunc i64 %n.vec to i32
  %ind.end4804 = sub i32 %spec.select2906, %.cast
  %ind.end4806 = getelementptr i8, ptr %from.1, i64 %n.vec
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %next.gep = getelementptr i8, ptr %put.0, i64 %index
  %next.gep4809 = getelementptr i8, ptr %from.1, i64 %index
  %wide.load = load <16 x i8>, ptr %next.gep4809, align 1
  %255 = getelementptr i8, ptr %next.gep4809, i64 16
  %wide.load4811 = load <16 x i8>, ptr %255, align 1
  store <16 x i8> %wide.load, ptr %next.gep, align 1
  %256 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load4811, ptr %256, align 1
  %index.next = add nuw i64 %index, 32
  %257 = icmp eq i64 %index.next, %n.vec
  br i1 %257, label %middle.block, label %vector.body
...
do.body1723.preheader:                            ; preds = %if.end1715, %middle.block
  ...
  %copy.10.ph = phi i32 [ %spec.select2906, %if.end1715 ], [ %ind.end4804, %middle.block ]
  %from.2.ph = phi ptr [ %from.1, %if.end1715 ], [ %ind.end4806, %middle.block ]
  %258 = add i32 %copy.10.ph, -1
  %xtraiter5158 = and i32 %copy.10.ph, 7
  %lcmp.mod5159.not = icmp eq i32 %xtraiter5158, 0
  br i1 %lcmp.mod5159.not, label %do.body1723.prol.loopexit, label %do.body1723.prol
...
do.body1723.prol:                                 ; preds = %do.body1723.preheader, %do.body1723.prol
  ...
  %prol.iter5160 = phi i32 [ %prol.iter5160.next, %do.body1723.prol ], [ 0, %do.body1723.preheader ]
  %incdec.ptr1724.prol = getelementptr inbounds i8, ptr %from.2.prol, i64 1
  %259 = load i8, ptr %from.2.prol, align 1
  %incdec.ptr1725.prol = getelementptr inbounds i8, ptr %put.1.prol, i64 1
  store i8 %259, ptr %put.1.prol, align 1
  %dec1727.prol = add i32 %copy.10.prol, -1
  %prol.iter5160.next = add i32 %prol.iter5160, 1
  %prol.iter5160.cmp.not = icmp eq i32 %prol.iter5160.next, %xtraiter5158
  br i1 %prol.iter5160.cmp.not, label %do.body1723.prol.loopexit, label %do.body1723.prol

do.body1723.prol.loopexit:                        ; preds = %do.body1723.prol, %do.body1723.preheader
  %incdec.ptr1725.lcssa4884.unr = phi ptr [ undef, %do.body1723.preheader ], [ %incdec.ptr1725.prol, %do.body1723.prol ]
...
do.end1771:                                       ; preds = %do.end1771.loopexit, %while.cond1751.preheader
  ...
  %278 = load i64, ptr %total_out, align 8
  %add1774 = add i64 %278, %conv1773
  store i64 %add1774, ptr %total_out, align 8
  %279 = load i64, ptr %total, align 8
  %add1776 = add i64 %279, %conv1773
  store i64 %add1776, ptr %total, align 8
...
if.then1782:                                      ; preds = %do.end1771
  %280 = load i32, ptr %flags1783, align 8
  %tobool1784.not = icmp eq i32 %280, 0
  %281 = load i64, ptr %check1786, align 8
...
cond.end1797:                                     ; preds = %cond.false1791, %cond.true1785
  ...
  store i64 %cond1798, ptr %check1786, align 8
  store i64 %cond1798, ptr %adler1800, align 8
  %.pre4068 = load i32, ptr %wrap1747, align 8
  %.pre4079 = and i32 %.pre4068, 4
  br label %if.end1801

if.end1801:                                       ; preds = %cond.end1797, %do.end1771
  %and1803.pre-phi = phi i32 [ %.pre4079, %cond.end1797 ], [ %and1778, %do.end1771 ]
  %282 = phi i32 [ %.pre4068, %cond.end1797 ], [ %271, %do.end1771 ]
...
land.lhs.true1805:                                ; preds = %if.end1801
  %283 = load i32, ptr %flags1783, align 8
  ...
  %284 = load i64, ptr %check1786, align 8
...
if.then1826:                                      ; preds = %land.lhs.true1805
  store ptr @.str.17, ptr %msg1827, align 8
  store i32 16209, ptr %mode.i, align 8
  br label %sw.epilog1881
...
sw.bb1835:                                        ; preds = %for.cond.sw.bb1835_crit_edge, %if.end1833
  %286 = phi i32 [ %.pre4069, %for.cond.sw.bb1835_crit_edge ], [ %285, %if.end1833 ]
...
land.lhs.true1838:                                ; preds = %sw.bb1835
  %287 = load i32, ptr %flags1783, align 8
...
do.body1847.preheader:                            ; preds = %while.cond1843.preheader
  ...
  br i1 %cmp1848, label %do.body1882.loopexit3672, label %if.end1851
...
do.end1863.loopexit:                              ; preds = %if.end1851.3, %if.end1851.2, %if.end1851.1, %if.end1851
  ...
  %indvars.iv.next3997.lcssa = phi i64 [ %indvars.iv.next3997, %if.end1851 ], [ %indvars.iv.next3997.1, %if.end1851.1 ], [ %indvars.iv.next3997.2, %if.end1851.2 ], [ %indvars.iv.next3997.3, %if.end1851.3 ]
  %293 = trunc i64 %indvars.iv.next3997.lcssa to i32
  br label %do.end1863
...
do.end1863:                                       ; preds = %do.end1863.loopexit, %while.cond1843.preheader
  ...
  %294 = load i64, ptr %total, align 8
...
if.then1868:                                      ; preds = %do.end1863
  store ptr @.str.18, ptr %msg1827, align 8
  store i32 16209, ptr %mode.i, align 8
  br label %sw.epilog1881
...
do.body1882.loopexit:                             ; preds = %do.body1157
  %295 = trunc i64 %indvars.iv4018 to i32
  br label %do.body1882

do.body1882.loopexit3653:                         ; preds = %do.body1051
  %296 = trunc i64 %indvars.iv4015 to i32
  br label %do.body1882

do.body1882.loopexit3654:                         ; preds = %do.body1113
  %297 = trunc i64 %indvars.iv4012 to i32
  br label %do.body1882

do.body1882.loopexit3656:                         ; preds = %do.body21.1, %do.body21.preheader
  %indvars.iv4065.lcssa = phi i64 [ %20, %do.body21.preheader ], [ %indvars.iv.next4066, %do.body21.1 ]
  %hold.13646.lcssa = phi i64 [ %hold.0, %do.body21.preheader ], [ %add, %do.body21.1 ]
  %next.13644.lcssa = phi ptr [ %next.0, %do.body21.preheader ], [ %incdec.ptr, %do.body21.1 ]
  %298 = trunc i64 %indvars.iv4065.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3657:                         ; preds = %do.body584.1, %do.body584.preheader
  %indvars.iv4062.lcssa = phi i64 [ %102, %do.body584.preheader ], [ %indvars.iv.next4063, %do.body584.1 ]
  %hold.143637.lcssa = phi i64 [ %hold.13, %do.body584.preheader ], [ %add594, %do.body584.1 ]
  %next.183635.lcssa = phi ptr [ %next.17, %do.body584.preheader ], [ %incdec.ptr590, %do.body584.1 ]
  %299 = trunc i64 %indvars.iv4062.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3658:                         ; preds = %do.body318.1, %do.body318.preheader
  %indvars.iv4053.lcssa = phi i64 [ %56, %do.body318.preheader ], [ %indvars.iv.next4054, %do.body318.1 ]
  %hold.83629.lcssa = phi i64 [ %hold.741094118, %do.body318.preheader ], [ %add328, %do.body318.1 ]
  %next.83627.lcssa = phi ptr [ %next.741054120, %do.body318.preheader ], [ %incdec.ptr324, %do.body318.1 ]
  %300 = trunc i64 %indvars.iv4053.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3659:                         ; preds = %do.body255.1, %do.body255.preheader
  %indvars.iv4050.lcssa = phi i64 [ %45, %do.body255.preheader ], [ %indvars.iv.next4051, %do.body255.1 ]
  %hold.63621.lcssa = phi i64 [ %hold.54096, %do.body255.preheader ], [ %add265, %do.body255.1 ]
  %next.63619.lcssa = phi ptr [ %next.54094, %do.body255.preheader ], [ %incdec.ptr261, %do.body255.1 ]
  %301 = trunc i64 %indvars.iv4050.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3660:                         ; preds = %do.body195.3, %do.body195.2, %do.body195.1, %do.body195.preheader
  %indvars.iv4047.lcssa = phi i64 [ %36, %do.body195.preheader ], [ %indvars.iv.next4048, %do.body195.1 ], [ %indvars.iv.next4048.1, %do.body195.2 ], [ %indvars.iv.next4048.2, %do.body195.3 ]
  %hold.43613.lcssa = phi i64 [ %hold.34087, %do.body195.preheader ], [ %add205, %do.body195.1 ], [ %add205.1, %do.body195.2 ], [ %add205.2, %do.body195.3 ]
  %next.43611.lcssa = phi ptr [ %next.34085, %do.body195.preheader ], [ %incdec.ptr201, %do.body195.1 ], [ %incdec.ptr201.1, %do.body195.2 ], [ %incdec.ptr201.2, %do.body195.3 ]
  %302 = trunc i64 %indvars.iv4047.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3661:                         ; preds = %do.body121.1, %do.body121.preheader
  %indvars.iv4044.lcssa = phi i64 [ %18, %do.body121.preheader ], [ %indvars.iv.next4045, %do.body121.1 ]
  %hold.23604.lcssa = phi i64 [ %hold.0, %do.body121.preheader ], [ %add131, %do.body121.1 ]
  %next.23602.lcssa = phi ptr [ %next.0, %do.body121.preheader ], [ %incdec.ptr127, %do.body121.1 ]
  %303 = trunc i64 %indvars.iv4044.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3662:                         ; preds = %do.body638.3, %do.body638.2, %do.body638.1, %do.body638.preheader
  %indvars.iv4041.lcssa = phi i64 [ %17, %do.body638.preheader ], [ %indvars.iv.next4042, %do.body638.1 ], [ %indvars.iv.next4042.1, %do.body638.2 ], [ %indvars.iv.next4042.2, %do.body638.3 ]
  %hold.163587.lcssa = phi i64 [ %hold.0, %do.body638.preheader ], [ %add648, %do.body638.1 ], [ %add648.1, %do.body638.2 ], [ %add648.2, %do.body638.3 ]
  %next.203585.lcssa = phi ptr [ %next.0, %do.body638.preheader ], [ %incdec.ptr644, %do.body638.1 ], [ %incdec.ptr644.1, %do.body638.2 ], [ %incdec.ptr644.2, %do.body638.3 ]
  %304 = trunc i64 %indvars.iv4041.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3663:                         ; preds = %do.body781.3, %do.body781.2, %do.body781.1, %do.body781.preheader
  %indvars.iv4039.lcssa = phi i64 [ %118, %do.body781.preheader ], [ %indvars.iv.next4040, %do.body781.1 ], [ %indvars.iv.next4040.1, %do.body781.2 ], [ %indvars.iv.next4040.2, %do.body781.3 ]
  %hold.213578.lcssa = phi i64 [ %shr771, %do.body781.preheader ], [ %add791, %do.body781.1 ], [ %add791.1, %do.body781.2 ], [ %add791.2, %do.body781.3 ]
  %next.253576.lcssa = phi ptr [ %next.0, %do.body781.preheader ], [ %incdec.ptr787, %do.body781.1 ], [ %incdec.ptr787.1, %do.body781.2 ], [ %incdec.ptr787.2, %do.body781.3 ]
  %305 = trunc i64 %indvars.iv4039.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3671:                         ; preds = %do.body852.1, %do.body852.preheader
  %indvars.iv3999.lcssa = phi i64 [ %16, %do.body852.preheader ], [ %indvars.iv.next4000, %do.body852.1 ]
  %hold.243378.lcssa = phi i64 [ %hold.0, %do.body852.preheader ], [ %add862, %do.body852.1 ]
  %next.283376.lcssa = phi ptr [ %next.0, %do.body852.preheader ], [ %incdec.ptr858, %do.body852.1 ]
  %306 = trunc i64 %indvars.iv3999.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3672:                         ; preds = %do.body1847.3, %do.body1847.2, %do.body1847.1, %do.body1847.preheader
  %indvars.iv3996.lcssa = phi i64 [ %288, %do.body1847.preheader ], [ %indvars.iv.next3997, %do.body1847.1 ], [ %indvars.iv.next3997.1, %do.body1847.2 ], [ %indvars.iv.next3997.2, %do.body1847.3 ]
  %hold.563369.lcssa = phi i64 [ %hold.55, %do.body1847.preheader ], [ %add1857, %do.body1847.1 ], [ %add1857.1, %do.body1847.2 ], [ %add1857.2, %do.body1847.3 ]
  %next.603367.lcssa = phi ptr [ %next.59, %do.body1847.preheader ], [ %incdec.ptr1853, %do.body1847.1 ], [ %incdec.ptr1853.1, %do.body1847.2 ], [ %incdec.ptr1853.2, %do.body1847.3 ]
  %307 = trunc i64 %indvars.iv3996.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3673:                         ; preds = %do.body1755.3, %do.body1755.2, %do.body1755.1, %do.body1755.preheader
  ...
  %hold.533361.lcssa = phi i64 [ %hold.0, %do.body1755.preheader ], [ %add1765, %do.body1755.1 ], [ %add1765.1, %do.body1755.2 ], [ %add1765.2, %do.body1755.3 ]
  %next.573359.lcssa = phi ptr [ %next.0, %do.body1755.preheader ], [ %incdec.ptr1761, %do.body1755.1 ], [ %incdec.ptr1761.1, %do.body1755.2 ], [ %incdec.ptr1761.2, %do.body1755.3 ]
  %308 = trunc i64 %indvars.iv.lcssa to i32
  br label %do.body1882

do.body1882.loopexit4132:                         ; preds = %do.body1003
  %309 = zext i32 %have.333463 to i64
  %310 = shl i32 %have.333463, 3
  %311 = add i32 %310, %bits.293465
  %scevgep.le = getelementptr i8, ptr %next.333462, i64 %309
  br label %do.body1882

do.body1882.loopexit4133:                         ; preds = %do.body1631
  %312 = shl i32 %have.53, 3
  %313 = add i32 %bits.49, %312
  %314 = zext i32 %have.53 to i64
  %scevgep4038.le = getelementptr i8, ptr %next.53, i64 %314
  br label %do.body1882

do.body1882.loopexit4134:                         ; preds = %do.body1562
  %315 = zext i32 %have.50.lcssa to i64
  %316 = shl i32 %have.50.lcssa, 3
  %317 = add i32 %316, %bits.46.lcssa
  %scevgep4036.le = getelementptr i8, ptr %next.50.lcssa, i64 %315
  br label %do.body1882

do.body1882.loopexit4135:                         ; preds = %do.body1513
  %318 = zext i32 %have.49 to i64
  %319 = shl i32 %have.49, 3
  %320 = add i32 %319, %bits.45
  %scevgep4032.le = getelementptr i8, ptr %next.49, i64 %318
  br label %do.body1882

do.body1882.loopexit4136:                         ; preds = %do.body1459
  %321 = shl i32 %have.46, 3
  %322 = add i32 %bits.42, %321
  %323 = zext i32 %have.46 to i64
  %scevgep4029.le = getelementptr i8, ptr %next.46, i64 %323
  br label %do.body1882

do.body1882.loopexit4137:                         ; preds = %do.body1374
  %324 = zext i32 %have.43.lcssa to i64
  %325 = shl i32 %have.43.lcssa, 3
  %326 = add i32 %325, %bits.39.lcssa
  %scevgep4027.le = getelementptr i8, ptr %next.43.lcssa, i64 %324
  br label %do.body1882

do.body1882.loopexit4138:                         ; preds = %do.body1322
  %327 = zext i32 %have.42 to i64
  %328 = shl i32 %have.42, 3
  %329 = add i32 %328, %bits.38
  %scevgep4023.le = getelementptr i8, ptr %next.42, i64 %327
  br label %do.body1882

do.body1882.loopexit4829:                         ; preds = %for.cond
  br label %do.body1882

do.body1882:                                      ; preds = %if.end429, %if.then441, %if.end486, %if.then508, %if.end557, %sw.bb690, %if.end805, %if.then822, %if.end1267, %sw.bb1668, %sw.bb1736, %do.body717, %do.body918, %for.cond, %do.body1882.loopexit4829, %do.body1882.loopexit4138, %do.body1882.loopexit4137, %do.body1882.loopexit4136, %do.body1882.loopexit4135, %do.body1882.loopexit4134, %do.body1882.loopexit4133, %do.body1882.loopexit4132, %do.body1882.loopexit3673, %do.body1882.loopexit3672, %do.body1882.loopexit3671, %do.body1882.loopexit3663, %do.body1882.loopexit3662, %do.body1882.loopexit3661, %do.body1882.loopexit3660, %do.body1882.loopexit3659, %do.body1882.loopexit3658, %do.body1882.loopexit3657, %do.body1882.loopexit3656, %do.body1882.loopexit3654, %do.body1882.loopexit3653, %do.body1882.loopexit, %if.end1875, %do.body751
  %left.03906 = phi i32 [ %left.0, %do.body751 ], [ %left.0, %if.end1875 ], [ %left.0, %do.body1882.loopexit ], [ %left.0, %do.body1882.loopexit3653 ], [ %left.0, %do.body1882.loopexit3654 ], [ %left.0, %do.body1882.loopexit3656 ], [ %left.0, %do.body1882.loopexit3657 ], [ %left.0, %do.body1882.loopexit3658 ], [ %left.0, %do.body1882.loopexit3659 ], [ %left.0, %do.body1882.loopexit3660 ], [ %left.0, %do.body1882.loopexit3661 ], [ %left.0, %do.body1882.loopexit3662 ], [ %left.0, %do.body1882.loopexit3663 ], [ %left.0, %do.body1882.loopexit3671 ], [ %left.0, %do.body1882.loopexit3672 ], [ %left.0, %do.body1882.loopexit3673 ], [ %left.0, %do.body1882.loopexit4132 ], [ %left.0, %do.body1882.loopexit4133 ], [ %left.0, %do.body1882.loopexit4134 ], [ %left.0, %do.body1882.loopexit4135 ], [ %left.0, %do.body1882.loopexit4136 ], [ %left.0, %do.body1882.loopexit4137 ], [ %left.0, %do.body1882.loopexit4138 ], [ %left.0, %for.cond ], [ %left.0, %do.body918 ], [ %left.0, %if.end429 ], [ %left.0, %if.then441 ], [ %left.0, %if.end486 ], [ %left.0, %if.then508 ], [ %left.0, %if.end557 ], [ %left.0, %sw.bb690 ], [ %left.0, %if.end805 ], [ %left.0, %if.then822 ], [ %left.0, %if.end1267 ], [ 0, %sw.bb1668 ], [ 0, %sw.bb1736 ], [ %left.0, %do.body717 ], [ %left.0, %do.body1882.loopexit4829 ]
  %next.64 = phi ptr [ %next.24.lcssa, %do.body751 ], [ %next.61, %if.end1875 ], [ %next.373447, %do.body1882.loopexit ], [ %next.353438, %do.body1882.loopexit3653 ], [ %next.363429, %do.body1882.loopexit3654 ], [ %next.13644.lcssa, %do.body1882.loopexit3656 ], [ %next.183635.lcssa, %do.body1882.loopexit3657 ], [ %next.83627.lcssa, %do.body1882.loopexit3658 ], [ %next.63619.lcssa, %do.body1882.loopexit3659 ], [ %next.43611.lcssa, %do.body1882.loopexit3660 ], [ %next.23602.lcssa, %do.body1882.loopexit3661 ], [ %next.203585.lcssa, %do.body1882.loopexit3662 ], [ %next.253576.lcssa, %do.body1882.loopexit3663 ], [ %next.283376.lcssa, %do.body1882.loopexit3671 ], [ %next.603367.lcssa, %do.body1882.loopexit3672 ], [ %next.573359.lcssa, %do.body1882.loopexit3673 ], [ %scevgep.le, %do.body1882.loopexit4132 ], [ %scevgep4038.le, %do.body1882.loopexit4133 ], [ %scevgep4036.le, %do.body1882.loopexit4134 ], [ %scevgep4032.le, %do.body1882.loopexit4135 ], [ %scevgep4029.le, %do.body1882.loopexit4136 ], [ %scevgep4027.le, %do.body1882.loopexit4137 ], [ %scevgep4023.le, %do.body1882.loopexit4138 ], [ %next.0, %for.cond ], [ %next.303396, %do.body918 ], [ %next.11, %if.end429 ], [ %next.13, %if.then441 ], [ %add.ptr489, %if.end486 ], [ %next.15, %if.then508 ], [ %add.ptr560, %if.end557 ], [ %next.22, %sw.bb690 ], [ %next.25.lcssa, %if.end805 ], [ %next.27, %if.then822 ], [ %next.33.lcssa, %if.end1267 ], [ %next.56, %sw.bb1668 ], [ %next.0, %sw.bb1736 ], [ %next.23, %do.body717 ], [ %next.0, %do.body1882.loopexit4829 ]
  %have.64 = phi i32 [ %have.24.lcssa, %do.body751 ], [ %have.61, %if.end1875 ], [ 0, %do.body1882.loopexit ], [ 0, %do.body1882.loopexit3653 ], [ 0, %do.body1882.loopexit3654 ], [ 0, %do.body1882.loopexit3656 ], [ 0, %do.body1882.loopexit3657 ], [ 0, %do.body1882.loopexit3658 ], [ 0, %do.body1882.loopexit3659 ], [ 0, %do.body1882.loopexit3660 ], [ 0, %do.body1882.loopexit3661 ], [ 0, %do.body1882.loopexit3662 ], [ 0, %do.body1882.loopexit3663 ], [ 0, %do.body1882.loopexit3671 ], [ 0, %do.body1882.loopexit3672 ], [ 0, %do.body1882.loopexit3673 ], [ 0, %do.body1882.loopexit4132 ], [ 0, %do.body1882.loopexit4133 ], [ 0, %do.body1882.loopexit4134 ], [ 0, %do.body1882.loopexit4135 ], [ 0, %do.body1882.loopexit4136 ], [ 0, %do.body1882.loopexit4137 ], [ 0, %do.body1882.loopexit4138 ], [ %have.0, %for.cond ], [ 0, %do.body918 ], [ %have.11, %if.end429 ], [ 0, %if.then441 ], [ %sub487, %if.end486 ], [ 0, %if.then508 ], [ %sub558, %if.end557 ], [ %have.22, %sw.bb690 ], [ %have.25.lcssa, %if.end805 ], [ %have.27, %if.then822 ], [ %have.33.lcssa, %if.end1267 ], [ %have.56, %sw.bb1668 ], [ %have.0, %sw.bb1736 ], [ 0, %do.body717 ], [ %have.0, %do.body1882.loopexit4829 ]
  %hold.60 = phi i64 [ %shr752, %do.body751 ], [ %hold.57, %if.end1875 ], [ %hold.333449, %do.body1882.loopexit ], [ %hold.313440, %do.body1882.loopexit3653 ], [ %hold.323431, %do.body1882.loopexit3654 ], [ %hold.13646.lcssa, %do.body1882.loopexit3656 ], [ %hold.143637.lcssa, %do.body1882.loopexit3657 ], [ %hold.83629.lcssa, %do.body1882.loopexit3658 ], [ %hold.63621.lcssa, %do.body1882.loopexit3659 ], [ %hold.43613.lcssa, %do.body1882.loopexit3660 ], [ %hold.23604.lcssa, %do.body1882.loopexit3661 ], [ %hold.163587.lcssa, %do.body1882.loopexit3662 ], [ %hold.213578.lcssa, %do.body1882.loopexit3663 ], [ %hold.243378.lcssa, %do.body1882.loopexit3671 ], [ %hold.563369.lcssa, %do.body1882.loopexit3672 ], [ %hold.533361.lcssa, %do.body1882.loopexit3673 ], [ %hold.303418, %do.body1882.loopexit4132 ], [ %hold.503569, %do.body1882.loopexit4133 ], [ %hold.473558, %do.body1882.loopexit4134 ], [ %hold.463534, %do.body1882.loopexit4135 ], [ %hold.433517, %do.body1882.loopexit4136 ], [ %hold.403506, %do.body1882.loopexit4137 ], [ %hold.393482, %do.body1882.loopexit4138 ], [ %hold.0, %for.cond ], [ %hold.263398, %do.body918 ], [ %hold.10, %if.end429 ], [ %hold.11, %if.then441 ], [ %hold.11, %if.end486 ], [ %hold.12, %if.then508 ], [ %hold.12, %if.end557 ], [ %hold.18, %sw.bb690 ], [ 0, %if.end805 ], [ %hold.23, %if.then822 ], [ %hold.29.lcssa, %if.end1267 ], [ %hold.52, %sw.bb1668 ], [ %hold.0, %sw.bb1736 ], [ %hold.19, %do.body717 ], [ %hold.0, %do.body1882.loopexit4829 ]
  %bits.60 = phi i32 [ %sub753, %do.body751 ], [ %bits.57, %if.end1875 ], [ %295, %do.body1882.loopexit ], [ %296, %do.body1882.loopexit3653 ], [ %297, %do.body1882.loopexit3654 ], [ %298, %do.body1882.loopexit3656 ], [ %299, %do.body1882.loopexit3657 ], [ %300, %do.body1882.loopexit3658 ], [ %301, %do.body1882.loopexit3659 ], [ %302, %do.body1882.loopexit3660 ], [ %303, %do.body1882.loopexit3661 ], [ %304, %do.body1882.loopexit3662 ], [ %305, %do.body1882.loopexit3663 ], [ %306, %do.body1882.loopexit3671 ], [ %307, %do.body1882.loopexit3672 ], [ %308, %do.body1882.loopexit3673 ], [ %311, %do.body1882.loopexit4132 ], [ %313, %do.body1882.loopexit4133 ], [ %317, %do.body1882.loopexit4134 ], [ %320, %do.body1882.loopexit4135 ], [ %322, %do.body1882.loopexit4136 ], [ %326, %do.body1882.loopexit4137 ], [ %329, %do.body1882.loopexit4138 ], [ %bits.0, %for.cond ], [ %bits.263399, %do.body918 ], [ %bits.10, %if.end429 ], [ %bits.11, %if.then441 ], [ %bits.11, %if.end486 ], [ %bits.12, %if.then508 ], [ %bits.12, %if.end557 ], [ %bits.18, %sw.bb690 ], [ 0, %if.end805 ], [ %bits.23, %if.then822 ], [ %bits.29.lcssa, %if.end1267 ], [ %bits.52, %sw.bb1668 ], [ %bits.0, %sw.bb1736 ], [ %bits.19, %do.body717 ], [ %bits.0, %do.body1882.loopexit4829 ]
  %out.5 = phi i32 [ %out.0, %do.body751 ], [ %out.2, %if.end1875 ], [ %out.0, %do.body1882.loopexit ], [ %out.0, %do.body1882.loopexit3653 ], [ %out.0, %do.body1882.loopexit3654 ], [ %out.0, %do.body1882.loopexit3656 ], [ %out.0, %do.body1882.loopexit3657 ], [ %out.0, %do.body1882.loopexit3658 ], [ %out.0, %do.body1882.loopexit3659 ], [ %out.0, %do.body1882.loopexit3660 ], [ %out.0, %do.body1882.loopexit3661 ], [ %out.0, %do.body1882.loopexit3662 ], [ %out.0, %do.body1882.loopexit3663 ], [ %out.0, %do.body1882.loopexit3671 ], [ %out.2, %do.body1882.loopexit3672 ], [ %out.0, %do.body1882.loopexit3673 ], [ %out.0, %do.body1882.loopexit4132 ], [ %out.0, %do.body1882.loopexit4133 ], [ %out.0, %do.body1882.loopexit4134 ], [ %out.0, %do.body1882.loopexit4135 ], [ %out.0, %do.body1882.loopexit4136 ], [ %out.0, %do.body1882.loopexit4137 ], [ %out.0, %do.body1882.loopexit4138 ], [ %out.0, %for.cond ], [ %out.0, %do.body918 ], [ %out.0, %do.body717 ], [ %out.0, %sw.bb1736 ], [ %out.0, %sw.bb1668 ], [ %out.0, %if.end1267 ], [ %out.0, %if.then822 ], [ %out.0, %if.end805 ], [ %out.0, %sw.bb690 ], [ %out.0, %if.end557 ], [ %out.0, %if.then508 ], [ %out.0, %if.end486 ], [ %out.0, %if.then441 ], [ %out.0, %if.end429 ], [ %out.0, %do.body1882.loopexit4829 ]
  %ret.9 = phi i32 [ %ret.0, %do.body751 ], [ 1, %if.end1875 ], [ %ret.1, %do.body1882.loopexit ], [ %ret.1, %do.body1882.loopexit3653 ], [ %ret.1, %do.body1882.loopexit3654 ], [ %ret.0, %do.body1882.loopexit3656 ], [ %ret.0, %do.body1882.loopexit3657 ], [ %ret.0, %do.body1882.loopexit3658 ], [ %ret.0, %do.body1882.loopexit3659 ], [ %ret.0, %do.body1882.loopexit3660 ], [ %ret.0, %do.body1882.loopexit3661 ], [ %ret.0, %do.body1882.loopexit3662 ], [ %ret.0, %do.body1882.loopexit3663 ], [ %ret.0, %do.body1882.loopexit3671 ], [ %ret.0, %do.body1882.loopexit3672 ], [ %ret.0, %do.body1882.loopexit3673 ], [ %ret.1, %do.body1882.loopexit4132 ], [ %ret.6, %do.body1882.loopexit4133 ], [ %ret.5, %do.body1882.loopexit4134 ], [ %ret.5, %do.body1882.loopexit4135 ], [ %ret.4, %do.body1882.loopexit4136 ], [ %ret.3, %do.body1882.loopexit4137 ], [ %ret.3, %do.body1882.loopexit4138 ], [ -3, %for.cond ], [ %ret.0, %do.body918 ], [ %ret.0, %if.end429 ], [ %ret.0, %if.then441 ], [ %ret.0, %if.end486 ], [ %ret.0, %if.then508 ], [ %ret.0, %if.end557 ], [ %ret.0, %sw.bb690 ], [ %ret.0, %if.end805 ], [ %ret.0, %if.then822 ], [ 0, %if.end1267 ], [ %ret.7, %sw.bb1668 ], [ %ret.0, %sw.bb1736 ], [ %ret.0, %do.body717 ], [ 1, %do.body1882.loopexit4829 ]
  store ptr %put.0, ptr %next_out, align 8
  store i32 %left.03906, ptr %avail_out, align 8
  ...
  %330 = load i32, ptr %wsize, align 4
...
if.then1908:                                      ; preds = %land.lhs.true1901, %do.body1882
  %sub1911 = sub i32 %out.5, %left.03906
  %332 = load ptr, ptr %state4.i, align 8
  %window.i = getelementptr inbounds %struct.inflate_state, ptr %332, i64 0, i32 14
  %333 = load ptr, ptr %window.i, align 8
  %cmp.i2907 = icmp eq ptr %333, null
  br i1 %cmp.i2907, label %if.then.i, label %if.end6.i

if.then.i:                                        ; preds = %if.then1908
  %334 = load ptr, ptr %zalloc.i, align 8
  %opaque.i = getelementptr inbounds %struct.z_stream_s, ptr %strm, i64 0, i32 10
  %335 = load ptr, ptr %opaque.i, align 8
  %wbits.i = getelementptr inbounds %struct.inflate_state, ptr %332, i64 0, i32 10
  %336 = load i32, ptr %wbits.i, align 8
...
if.end6.i:                                        ; preds = %if.then.i, %if.then1908
  ...
  %338 = load i32, ptr %wsize.i, align 4
...
if.then8.i:                                       ; preds = %if.end6.i
  ...
  %339 = load i32, ptr %wbits9.i, align 8
...
if.then37.i:                                      ; preds = %if.else.i
  ...
  %343 = load ptr, ptr %window.i, align 8
  ...
  %344 = load i32, ptr %wsize.i, align 4
  %whave45.i = getelementptr inbounds %struct.inflate_state, ptr %332, i64 0, i32 12
  store i32 %344, ptr %whave45.i, align 8
  br label %if.end1917

if.else46.i:                                      ; preds = %if.else.i
  %345 = load i32, ptr %wnext23.i, align 4
  %add.i = add i32 %345, %spec.select.i2909
  %346 = load i32, ptr %wsize.i, align 4
...
if.end1917:                                       ; preds = %if.then15.i, %if.else46.i, %if.then59.i, %if.then37.i, %land.lhs.true1901, %land.lhs.true1897, %lor.lhs.false1893
  %348 = load i32, ptr %avail_in11, align 8
  %sub1919 = sub i32 %11, %348
  %349 = load i32, ptr %avail_out, align 8
  %sub1921 = sub i32 %out.5, %349
  %conv1922 = zext i32 %sub1919 to i64
  %total_in = getelementptr inbounds %struct.z_stream_s, ptr %strm, i64 0, i32 2
  %350 = load i64, ptr %total_in, align 8
  %add1923 = add i64 %350, %conv1922
  store i64 %add1923, ptr %total_in, align 8
  %conv1924 = zext i32 %sub1921 to i64
  %351 = load i64, ptr %total_out, align 8
  %add1926 = add i64 %351, %conv1924
  store i64 %add1926, ptr %total_out, align 8
  %352 = load i64, ptr %total, align 8
  %add1929 = add i64 %352, %conv1924
  store i64 %add1929, ptr %total, align 8
  %353 = load i32, ptr %wrap1747, align 8
...
if.then1935:                                      ; preds = %if.end1917
  %354 = load i32, ptr %flags1783, align 8
  %tobool1937.not = icmp eq i32 %354, 0
  %355 = load i64, ptr %check1786, align 8
  %356 = load ptr, ptr %next_out, align 8
...
cond.end1952:                                     ; preds = %cond.false1945, %cond.true1938
  ...
  store i64 %cond1953, ptr %check1786, align 8
  store i64 %cond1953, ptr %adler1800, align 8
  br label %if.end1956

if.end1956:                                       ; preds = %cond.end1952, %if.end1917
  %357 = load i32, ptr %bits13, align 8
  %358 = load i32, ptr %last699, align 4
  %tobool1959.not = icmp eq i32 %358, 0
  %cond1960 = select i1 %tobool1959.not, i32 0, i32 64
  %add1961 = add nsw i32 %cond1960, %357
  %359 = load i32, ptr %mode.i, align 8
  ...
  store i32 %add1974, ptr %data_type, align 8
...
if.then2:                                         ; preds = %if.end
  ...
  %.pre19 = load ptr, ptr %state4.i, align 8
  br label %if.end4
...
if.end4.if.end20_crit_edge:                       ; preds = %if.end4
  ...
  %.pre108 = load i32, ptr %have21.phi.trans.insert, align 4
  br label %if.end20
...
while.body.preheader.new:                         ; preds = %while.body.preheader
  %unroll_iter = and i32 %12, 1073741820
  br label %while.body
...
while.body:                                       ; preds = %while.body, %while.body.preheader.new
  ...
  br i1 %niter.ncmp.3, label %while.end.unr-lcssa, label %while.body
...
while.body.epil:                                  ; preds = %while.end.unr-lcssa, %while.body.epil
  ...
  store i8 %conv.epil, ptr %arrayidx.epil, align 1
  %shr.epil = lshr i64 %shr106.epil, 8
  %epil.iter.next = add i32 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %while.end, label %while.body.epil
...
while.end:                                        ; preds = %while.body.epil, %while.end.unr-lcssa
  ...
  store i64 %shr.lcssa, ptr %hold, align 8
  store i32 0, ptr %bits8, align 8
...
while.body.i:                                     ; preds = %while.body.i, %while.body.preheader.i
  ...
  br i1 %17, label %while.body.i, label %syncsearch.exit
...
syncsearch.exit:                                  ; preds = %while.body.i, %while.end.thread, %while.end
  ...
  store i32 %got.0.lcssa.i, ptr %have112, align 4
...
if.end20:                                         ; preds = %if.end4.if.end20_crit_edge, %syncsearch.exit
  ...
  br i1 %21, label %while.body.preheader.i80, label %syncsearch.exit98

while.body.preheader.i80:                         ; preds = %if.end20
  %22 = zext i32 %19 to i64
  br label %while.body.i81

while.body.i81:                                   ; preds = %while.body.i81, %while.body.preheader.i80
  %indvars.iv.i82 = phi i64 [ 0, %while.body.preheader.i80 ], [ %indvars.iv.next.i94, %while.body.i81 ]
  %got.024.i83 = phi i32 [ %18, %while.body.preheader.i80 ], [ %got.1.i93, %while.body.i81 ]
  %arrayidx.i84 = getelementptr inbounds i8, ptr %20, i64 %indvars.iv.i82
  %23 = load i8, ptr %arrayidx.i84, align 1
  %conv.i85 = zext i8 %23 to i32
  %cmp2.i86 = icmp ult i32 %got.024.i83, 2
  %cond.i87 = select i1 %cmp2.i86, i32 0, i32 255
  %cmp4.i88 = icmp eq i32 %cond.i87, %conv.i85
  %inc.i89 = add nuw nsw i32 %got.024.i83, 1
  %tobool.not.i90 = icmp eq i8 %23, 0
  %sub.i91 = sub nuw nsw i32 4, %got.024.i83
  %spec.select.i92 = select i1 %tobool.not.i90, i32 %sub.i91, i32 0
  %got.1.i93 = select i1 %cmp4.i88, i32 %inc.i89, i32 %spec.select.i92
  %indvars.iv.next.i94 = add nuw nsw i64 %indvars.iv.i82, 1
  %cmp.i95 = icmp ult i64 %indvars.iv.next.i94, %22
  %cmp1.i96 = icmp ult i32 %got.1.i93, 4
  %24 = select i1 %cmp.i95, i1 %cmp1.i96, i1 false
  br i1 %24, label %while.body.i81, label %while.end.loopexit.i97

while.end.loopexit.i97:                           ; preds = %while.body.i81
  %25 = trunc i64 %indvars.iv.next.i94 to i32
  br label %syncsearch.exit98

syncsearch.exit98:                                ; preds = %if.end20, %while.end.loopexit.i97
  %got.0.lcssa.i78 = phi i32 [ %18, %if.end20 ], [ %got.1.i93, %while.end.loopexit.i97 ]
  %next.0.lcssa.i79 = phi i32 [ 0, %if.end20 ], [ %25, %while.end.loopexit.i97 ]
  store i32 %got.0.lcssa.i78, ptr %have21, align 4
  %26 = load i32, ptr %avail_in, align 8
  %sub25 = sub i32 %26, %next.0.lcssa.i79
  store i32 %sub25, ptr %avail_in, align 8
  %idx.ext = zext i32 %next.0.lcssa.i79 to i64
  ...
  %cmp29.not = icmp eq i32 %got.0.lcssa.i78, 4
  br i1 %cmp29.not, label %if.end.i8.i, label %cleanup

if.end.i8.i:                                      ; preds = %syncsearch.exit98
  %total_out = getelementptr inbounds %struct.z_stream_s, ptr %strm, i64 0, i32 5
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %total_out, i8 0, i64 16, i1 false)
  %29 = load i32, ptr %wrap.i.i, align 8
...
inflateReset.exit:                                ; preds = %if.end.i8.i, %if.then3.i.i
  ...
  store i32 -1, ptr %back.i.i, align 4
  store i64 %add, ptr %total_in, align 8
  store i64 %28, ptr %total_out, align 8
  store i32 16191, ptr %mode.i, align 8
  br label %cleanup
...
if.end:                                           ; preds = %inflateStateCheck.exit
  ...
  store i32 %or.sink, ptr %wrap4, align 8
  br label %cleanup
