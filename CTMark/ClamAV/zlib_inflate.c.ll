...
for.cond:                                         ; preds = %sw.epilog1881, %do.body
  ...
  %put.04464 = ptrtoint ptr %put.0 to i64
...
for.cond.sw.bb1621_crit_edge:                     ; preds = %for.cond
  %.pre3966 = load i32, ptr %extra1447, align 4, !tbaa !45
  br label %sw.bb1621

for.cond.sw.bb1449_crit_edge:                     ; preds = %for.cond
  %.pre3963 = load i32, ptr %extra1447, align 4, !tbaa !45
  br label %sw.bb1449

for.cond.sw.bb979_crit_edge:                      ; preds = %for.cond
  %have981.promoted3457.pre = load i32, ptr %have904, align 4, !tbaa !46
  br label %sw.bb979

for.cond.sw.bb1835_crit_edge:                     ; preds = %for.cond
  %.pre3958 = load i32, ptr %wrap1747, align 8, !tbaa !19
  br label %sw.bb1835
...
if.end24:                                         ; preds = %do.body21.preheader
  ...
  %indvars.iv.next3955 = add nuw nsw i64 %20, 8
...
if.end24.1:                                       ; preds = %do.body21.1
  ...
  %shl.1 = shl nuw nsw i64 %conv.1, %indvars.iv.next3955
  %add.1 = add i64 %shl.1, %add
  %indvars.iv.next3955.1 = add nuw nsw i64 %20, 16
...
do.end29.loopexit:                                ; preds = %if.end24.1, %if.end24
  ...
  %indvars.iv.next3955.lcssa = phi i64 [ %indvars.iv.next3955, %if.end24 ], [ %indvars.iv.next3955.1, %if.end24.1 ]
  %23 = trunc i64 %indvars.iv.next3955.lcssa to i32
  br label %do.end29
...
if.end95:                                         ; preds = %if.then93, %do.body83
  ...
  %or.cond4244 = select i1 %cmp96, i1 true, i1 %cmp100
  br i1 %or.cond4244, label %if.then102, label %if.end105
...
if.end125:                                        ; preds = %do.body121.preheader
  ...
  %indvars.iv.next3934 = add nuw nsw i64 %18, 8
...
if.end125.1:                                      ; preds = %do.body121.1
  ...
  %shl130.1 = shl nuw nsw i64 %conv128.1, %indvars.iv.next3934
  %add131.1 = add i64 %shl130.1, %add131
  %indvars.iv.next3934.1 = add nuw nsw i64 %18, 16
...
do.end137.loopexit:                               ; preds = %if.end125.1, %if.end125
  ...
  %indvars.iv.next3934.lcssa = phi i64 [ %indvars.iv.next3934, %if.end125 ], [ %indvars.iv.next3934.1, %if.end125.1 ]
  %31 = trunc i64 %indvars.iv.next3934.lcssa to i32
  br label %do.end137
...
do.body195.preheader:                             ; preds = %do.body190.thread, %do.body190
  %bits.33977 = phi i32 [ 0, %do.body190.thread ], [ %bits.0, %do.body190 ]
  %hold.33976 = phi i64 [ 0, %do.body190.thread ], [ %hold.0, %do.body190 ]
  %have.33975 = phi i32 [ %have.2.lcssa, %do.body190.thread ], [ %have.0, %do.body190 ]
  %next.33974 = phi ptr [ %next.2.lcssa, %do.body190.thread ], [ %next.0, %do.body190 ]
  %36 = zext i32 %bits.33977 to i64
  %cmp196 = icmp eq i32 %have.33975, 0
  br i1 %cmp196, label %do.body1882.loopexit3660, label %if.end199

if.end199:                                        ; preds = %do.body195.preheader
  %dec200 = add i32 %have.33975, -1
  %incdec.ptr201 = getelementptr inbounds i8, ptr %next.33974, i64 1
  %37 = load i8, ptr %next.33974, align 1, !tbaa !38
  %conv202 = zext i8 %37 to i64
  %shl204 = shl nuw nsw i64 %conv202, %36
  %add205 = add i64 %shl204, %hold.33976
  %indvars.iv.next3937 = add nuw nsw i64 %36, 8
  %cmp192 = icmp ult i32 %bits.33977, 24
...
if.end199.1:                                      ; preds = %do.body195.1
  %dec200.1 = add i32 %have.33975, -2
  %incdec.ptr201.1 = getelementptr inbounds i8, ptr %next.33974, i64 2
  %38 = load i8, ptr %incdec.ptr201, align 1, !tbaa !38
  %conv202.1 = zext i8 %38 to i64
  %shl204.1 = shl nuw nsw i64 %conv202.1, %indvars.iv.next3937
  %add205.1 = add i64 %shl204.1, %add205
  %indvars.iv.next3937.1 = add nuw nsw i64 %36, 16
  %cmp192.1 = icmp ult i32 %bits.33977, 16
...
if.end199.2:                                      ; preds = %do.body195.2
  %dec200.2 = add i32 %have.33975, -3
  %incdec.ptr201.2 = getelementptr inbounds i8, ptr %next.33974, i64 3
  %39 = load i8, ptr %incdec.ptr201.1, align 1, !tbaa !38
  %conv202.2 = zext i8 %39 to i64
  %shl204.2 = shl nuw nsw i64 %conv202.2, %indvars.iv.next3937.1
  %add205.2 = add i64 %shl204.2, %add205.1
  %indvars.iv.next3937.2 = add nuw nsw i64 %36, 24
  %cmp192.2 = icmp ult i32 %bits.33977, 8
...
if.end199.3:                                      ; preds = %do.body195.3
  %dec200.3 = add i32 %have.33975, -4
  %incdec.ptr201.3 = getelementptr inbounds i8, ptr %next.33974, i64 4
  %40 = load i8, ptr %incdec.ptr201.2, align 1, !tbaa !38
  %conv202.3 = zext i8 %40 to i64
  %shl204.3 = shl nuw nsw i64 %conv202.3, %indvars.iv.next3937.2
...
do.body255.preheader:                             ; preds = %do.body250.thread, %do.body250
  %bits.53986 = phi i32 [ 0, %do.body250.thread ], [ %bits.0, %do.body250 ]
  %hold.53985 = phi i64 [ 0, %do.body250.thread ], [ %hold.0, %do.body250 ]
  %have.53984 = phi i32 [ %have.4.lcssa, %do.body250.thread ], [ %have.0, %do.body250 ]
  %next.53983 = phi ptr [ %next.4.lcssa, %do.body250.thread ], [ %next.0, %do.body250 ]
  %45 = zext i32 %bits.53986 to i64
  %cmp256 = icmp eq i32 %have.53984, 0
  br i1 %cmp256, label %do.body1882.loopexit3659, label %if.end259

if.end259:                                        ; preds = %do.body255.preheader
  %dec260 = add i32 %have.53984, -1
  %incdec.ptr261 = getelementptr inbounds i8, ptr %next.53983, i64 1
  %46 = load i8, ptr %next.53983, align 1, !tbaa !38
  %conv262 = zext i8 %46 to i64
  %shl264 = shl nuw nsw i64 %conv262, %45
  %add265 = add i64 %shl264, %hold.53985
  %indvars.iv.next3940 = add nuw nsw i64 %45, 8
  %cmp252 = icmp ult i32 %bits.53986, 8
...
if.end259.1:                                      ; preds = %do.body255.1
  %dec260.1 = add i32 %have.53984, -2
  %incdec.ptr261.1 = getelementptr inbounds i8, ptr %next.53983, i64 2
  %47 = load i8, ptr %incdec.ptr261, align 1, !tbaa !38
  %conv262.1 = zext i8 %47 to i64
  %shl264.1 = shl nuw nsw i64 %conv262.1, %indvars.iv.next3940
...
sw.bb308.thread:                                  ; preds = %do.body291, %land.lhs.true286, %if.end282
  ...
  %and3103991 = and i32 %54, 1024
  %tobool311.not3992 = icmp eq i32 %and3103991, 0
  br i1 %tobool311.not3992, label %if.else, label %do.body318.preheader
...
do.body318.preheader:                             ; preds = %sw.bb308.thread, %while.cond314.preheader
  %next.739944009 = phi ptr [ %next.0, %while.cond314.preheader ], [ %next.6.lcssa, %sw.bb308.thread ]
  %have.739964008 = phi i32 [ %have.0, %while.cond314.preheader ], [ %have.6.lcssa, %sw.bb308.thread ]
  %hold.739984007 = phi i64 [ %hold.0, %while.cond314.preheader ], [ 0, %sw.bb308.thread ]
  %bits.740004006 = phi i32 [ %bits.0, %while.cond314.preheader ], [ 0, %sw.bb308.thread ]
  %55 = phi i32 [ %53, %while.cond314.preheader ], [ %54, %sw.bb308.thread ]
  %56 = zext i32 %bits.740004006 to i64
  %cmp319 = icmp eq i32 %have.739964008, 0
  br i1 %cmp319, label %do.body1882.loopexit3658, label %if.end322

if.end322:                                        ; preds = %do.body318.preheader
  %dec323 = add i32 %have.739964008, -1
  %incdec.ptr324 = getelementptr inbounds i8, ptr %next.739944009, i64 1
  %57 = load i8, ptr %next.739944009, align 1, !tbaa !38
  %conv325 = zext i8 %57 to i64
  %shl327 = shl nuw nsw i64 %conv325, %56
  %add328 = add i64 %shl327, %hold.739984007
  %indvars.iv.next3943 = add nuw nsw i64 %56, 8
  %cmp315 = icmp ult i32 %bits.740004006, 8
...
if.end322.1:                                      ; preds = %do.body318.1
  %dec323.1 = add i32 %have.739964008, -2
  %incdec.ptr324.1 = getelementptr inbounds i8, ptr %next.739944009, i64 2
  %58 = load i8, ptr %incdec.ptr324, align 1, !tbaa !38
  %conv325.1 = zext i8 %58 to i64
  %shl327.1 = shl nuw nsw i64 %conv325.1, %indvars.iv.next3943
...
if.else:                                          ; preds = %sw.bb308.thread, %sw.bb308
  %bits.73999 = phi i32 [ 0, %sw.bb308.thread ], [ %bits.0, %sw.bb308 ]
  %hold.73997 = phi i64 [ 0, %sw.bb308.thread ], [ %hold.0, %sw.bb308 ]
  %have.73995 = phi i32 [ %have.6.lcssa, %sw.bb308.thread ], [ %have.0, %sw.bb308 ]
  %next.73993 = phi ptr [ %next.6.lcssa, %sw.bb308.thread ], [ %next.0, %sw.bb308 ]
...
if.end373:                                        ; preds = %do.body351, %land.lhs.true346, %if.end342, %if.else, %if.then370
  %next.9 = phi ptr [ %next.73993, %if.then370 ], [ %next.73993, %if.else ], [ %next.8.lcssa, %if.end342 ], [ %next.8.lcssa, %land.lhs.true346 ], [ %next.8.lcssa, %do.body351 ]
  %have.9 = phi i32 [ %have.73995, %if.then370 ], [ %have.73995, %if.else ], [ %have.8.lcssa, %if.end342 ], [ %have.8.lcssa, %land.lhs.true346 ], [ %have.8.lcssa, %do.body351 ]
  %hold.9 = phi i64 [ %hold.73997, %if.then370 ], [ %hold.73997, %if.else ], [ 0, %if.end342 ], [ 0, %land.lhs.true346 ], [ 0, %do.body351 ]
  %bits.9 = phi i32 [ %bits.73999, %if.then370 ], [ %bits.73999, %if.else ], [ 0, %if.end342 ], [ 0, %land.lhs.true346 ], [ 0, %do.body351 ]
...
if.then395:                                       ; preds = %land.lhs.true390
  ...
  %.pre3967 = load i32, ptr %flags1783, align 8, !tbaa !50
  br label %if.end411

if.end411:                                        ; preds = %if.then395, %land.lhs.true390, %if.then386
  %70 = phi i32 [ %.pre3967, %if.then395 ], [ %64, %land.lhs.true390 ], [ %64, %if.then386 ]
...
do.body446:                                       ; preds = %do.body446.preheader, %do.cond470
  %indvars.iv3945 = phi i64 [ 0, %do.body446.preheader ], [ %indvars.iv.next3946, %do.cond470 ]
  %indvars.iv.next3946 = add nuw nsw i64 %indvars.iv3945, 1
  %arrayidx447 = getelementptr inbounds i8, ptr %next.13, i64 %indvars.iv3945
...
do.cond470:                                       ; preds = %do.body446, %land.lhs.true452, %land.lhs.true456, %if.then461
  ...
  %cmp472 = icmp ult i64 %indvars.iv.next3946, %76
...
do.end474:                                        ; preds = %do.cond470
  %83 = trunc i64 %indvars.iv.next3946 to i32
...
if.end486:                                        ; preds = %if.then482, %land.lhs.true478, %do.end474
  ...
  %idx.ext488 = and i64 %indvars.iv.next3946, 4294967295
...
do.body513:                                       ; preds = %do.body513.preheader, %do.cond539
  %indvars.iv3948 = phi i64 [ 0, %do.body513.preheader ], [ %indvars.iv.next3949, %do.cond539 ]
  %indvars.iv.next3949 = add nuw nsw i64 %indvars.iv3948, 1
  %arrayidx516 = getelementptr inbounds i8, ptr %next.15, i64 %indvars.iv3948
...
do.cond539:                                       ; preds = %do.body513, %land.lhs.true521, %land.lhs.true525, %if.then530
  ...
  %cmp542 = icmp ult i64 %indvars.iv.next3949, %89
...
do.end545:                                        ; preds = %do.cond539
  %96 = trunc i64 %indvars.iv.next3949 to i32
...
if.end557:                                        ; preds = %if.then553, %land.lhs.true549, %do.end545
  ...
  %idx.ext559 = and i64 %indvars.iv.next3949, 4294967295
...
if.end588:                                        ; preds = %do.body584.preheader
  ...
  %indvars.iv.next3952 = add nuw nsw i64 %102, 8
...
if.end588.1:                                      ; preds = %do.body584.1
  ...
  %shl593.1 = shl nuw nsw i64 %conv591.1, %indvars.iv.next3952
  %add594.1 = add i64 %shl593.1, %add594
  %indvars.iv.next3952.1 = add nuw nsw i64 %102, 16
...
do.end600.loopexit:                               ; preds = %if.end588.1, %if.end588
  ...
  %indvars.iv.next3952.lcssa = phi i64 [ %indvars.iv.next3952, %if.end588 ], [ %indvars.iv.next3952.1, %if.end588.1 ]
  %105 = trunc i64 %indvars.iv.next3952.lcssa to i32
  br label %do.end600
...
if.end642:                                        ; preds = %do.body638.preheader
  ...
  %indvars.iv.next3931 = add nuw nsw i64 %17, 8
...
if.end642.1:                                      ; preds = %do.body638.1
  ...
  %shl647.1 = shl nuw nsw i64 %conv645.1, %indvars.iv.next3931
  %add648.1 = add i64 %shl647.1, %add648
  %indvars.iv.next3931.1 = add nuw nsw i64 %17, 16
...
if.end642.2:                                      ; preds = %do.body638.2
  ...
  %shl647.2 = shl nuw nsw i64 %conv645.2, %indvars.iv.next3931.1
  %add648.2 = add i64 %shl647.2, %add648.1
  %indvars.iv.next3931.2 = add nuw nsw i64 %17, 24
...
if.end642.3:                                      ; preds = %do.body638.3
  ...
  %shl647.3 = shl nuw nsw i64 %conv645.3, %indvars.iv.next3931.2
...
if.end785:                                        ; preds = %do.body781.preheader
  ...
  %indvars.iv.next3929 = add nuw nsw i64 %118, 8
...
if.end785.1:                                      ; preds = %do.body781.1
  ...
  %shl790.1 = shl nuw nsw i64 %conv788.1, %indvars.iv.next3929
  %add791.1 = add i64 %shl790.1, %add791
  %indvars.iv.next3929.1 = add nuw nsw i64 %118, 16
...
if.end785.2:                                      ; preds = %do.body781.2
  ...
  %shl790.2 = shl nuw nsw i64 %conv788.2, %indvars.iv.next3929.1
  %add791.2 = add i64 %shl790.2, %add791.1
  %indvars.iv.next3929.2 = add nuw nsw i64 %118, 24
...
if.end785.3:                                      ; preds = %do.body781.3
  ...
  %shl790.3 = shl nuw nsw i64 %conv788.3, %indvars.iv.next3929.2
  %add791.3 = add i64 %shl790.3, %add791.2
  %indvars.iv.next3929.3 = add nuw nsw i64 %118, 32
...
do.end797.loopexit:                               ; preds = %if.end785.3, %if.end785.2, %if.end785.1, %if.end785
  ...
  %indvars.iv.next3929.lcssa = phi i64 [ %indvars.iv.next3929, %if.end785 ], [ %indvars.iv.next3929.1, %if.end785.1 ], [ %indvars.iv.next3929.2, %if.end785.2 ], [ %indvars.iv.next3929.3, %if.end785.3 ]
  %123 = trunc i64 %indvars.iv.next3929.lcssa to i32
  br label %do.end797
...
do.end797:                                        ; preds = %do.end797.loopexit, %do.body768
  ...
  %124 = xor i64 %shr799, %and798
  %cmp800.not = icmp eq i64 %124, 65535
...
sw.bb819:                                         ; preds = %for.cond, %sw.bb817
  ...
  %tobool821.not = icmp eq i32 %125, 0
  br i1 %tobool821.not, label %if.end844, label %if.then822

if.then822:                                       ; preds = %sw.bb819
  %spec.select2903 = call i32 @llvm.umin.i32(i32 %125, i32 %have.27)
...
if.end834:                                        ; preds = %if.then822
  ...
  %126 = load i32, ptr %length1741, align 4, !tbaa !61
  %sub843 = sub i32 %126, %copy.4
...
if.end856:                                        ; preds = %do.body852.preheader
  ...
  %127 = load i8, ptr %next.0, align 1, !tbaa !38
  %conv859 = zext i8 %127 to i64
  %shl861 = shl nuw nsw i64 %conv859, %16
  %add862 = add i64 %shl861, %hold.0
  %indvars.iv.next3889 = add nuw nsw i64 %16, 8
...
if.end856.1:                                      ; preds = %do.body852.1
  ...
  %128 = load i8, ptr %incdec.ptr858, align 1, !tbaa !38
  %conv859.1 = zext i8 %128 to i64
  %shl861.1 = shl nuw nsw i64 %conv859.1, %indvars.iv.next3889
  %add862.1 = add i64 %shl861.1, %add862
  %indvars.iv.next3889.1 = add nuw nsw i64 %16, 16
...
do.end868.loopexit:                               ; preds = %if.end856.1, %if.end856
  ...
  %indvars.iv.next3889.lcssa = phi i64 [ %indvars.iv.next3889, %if.end856 ], [ %indvars.iv.next3889.1, %if.end856.1 ]
  %129 = trunc i64 %indvars.iv.next3889.lcssa to i32
  br label %do.end868
...
do.end868:                                        ; preds = %do.end868.loopexit, %while.cond848.preheader
  ...
  %bits.24.lcssa = phi i32 [ %bits.0, %while.cond848.preheader ], [ %129, %do.end868.loopexit ]
  ...
  %130 = lshr i32 %conv869, 5
  %and878 = and i32 %130, 31
  %add879 = add nuw nsw i32 %and878, 1
  store i32 %add879, ptr %ndist, align 8, !tbaa !79
  %131 = lshr i32 %conv869, 10
  %and886 = and i32 %131, 15
...
sw.bb906:                                         ; preds = %for.cond
  %.pre3959 = load i32, ptr %ncode, align 8, !tbaa !80
  %have908.promoted.pre = load i32, ptr %have904, align 4, !tbaa !46
  %cmp9103394 = icmp ult i32 %have908.promoted.pre, %.pre3959
...
while.cond914.preheader.preheader:                ; preds = %sw.bb906.thread, %sw.bb906
  %bits.254020 = phi i32 [ %sub890, %sw.bb906.thread ], [ %bits.0, %sw.bb906 ]
  %hold.254019 = phi i64 [ %shr889, %sw.bb906.thread ], [ %hold.0, %sw.bb906 ]
  %have.294018 = phi i32 [ %have.28.lcssa, %sw.bb906.thread ], [ %have.0, %sw.bb906 ]
  %next.294017 = phi ptr [ %next.28.lcssa, %sw.bb906.thread ], [ %next.0, %sw.bb906 ]
  %132 = phi i32 [ %add887, %sw.bb906.thread ], [ %.pre3959, %sw.bb906 ]
  %have908.promoted4016 = phi i32 [ 0, %sw.bb906.thread ], [ %have908.promoted.pre, %sw.bb906 ]
  %133 = zext i32 %have908.promoted4016 to i64
...
while.cond950.preheader:                          ; preds = %do.end934, %sw.bb906
  ...
  %.lcssa = phi i32 [ %have908.promoted.pre, %sw.bb906 ], [ %132, %do.end934 ]
...
while.body954.preheader:                          ; preds = %while.cond950.preheader
  %134 = zext i32 %.lcssa to i64
  br label %while.body954

while.cond914.preheader:                          ; preds = %while.cond914.preheader.preheader, %do.end934
  %indvars.iv3891 = phi i64 [ %133, %while.cond914.preheader.preheader ], [ %indvars.iv.next3892, %do.end934 ]
  %bits.263399 = phi i32 [ %bits.254020, %while.cond914.preheader.preheader ], [ %sub946, %do.end934 ]
  %hold.263398 = phi i64 [ %hold.254019, %while.cond914.preheader.preheader ], [ %shr945, %do.end934 ]
  %have.303397 = phi i32 [ %have.294018, %while.cond914.preheader.preheader ], [ %have.31.lcssa, %do.end934 ]
  %next.303396 = phi ptr [ %next.294017, %while.cond914.preheader.preheader ], [ %next.31.lcssa, %do.end934 ]
...
if.end922:                                        ; preds = %do.body918
  ...
  %135 = load i8, ptr %next.303396, align 1, !tbaa !38
  %conv925 = zext i8 %135 to i64
...
do.end934:                                        ; preds = %if.end922, %while.cond914.preheader
  ...
  %136 = trunc i64 %indvars.iv.next3892 to i32
  store i32 %136, ptr %have904, align 4, !tbaa !46
  %arrayidx941 = getelementptr inbounds [19 x i16], ptr @inflate.order, i64 0, i64 %indvars.iv3891
  %137 = load i16, ptr %arrayidx941, align 2, !tbaa !81
  %idxprom942 = zext i16 %137 to i64
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next3892, %wide.trip.count
...
while.body954:                                    ; preds = %while.body954.preheader, %while.body954
  %indvars.iv3894 = phi i64 [ %134, %while.body954.preheader ], [ %indvars.iv.next3895, %while.body954 ]
  %indvars.iv.next3895 = add nuw nsw i64 %indvars.iv3894, 1
  %arrayidx959 = getelementptr inbounds [19 x i16], ptr @inflate.order, i64 0, i64 %indvars.iv3894
  %138 = load i16, ptr %arrayidx959, align 2, !tbaa !81
  %idxprom960 = zext i16 %138 to i64
  ...
  %139 = and i64 %indvars.iv.next3895, 4294967295
  %exitcond3897.not = icmp eq i64 %139, 19
  br i1 %exitcond3897.not, label %while.cond950.while.end962_crit_edge, label %while.body954, !llvm.loop !84
...
sw.bb979:                                         ; preds = %for.cond.sw.bb979_crit_edge, %if.end976
  ...
  %140 = load i32, ptr %nlen, align 4, !tbaa !78
  %141 = load i32, ptr %ndist, align 8, !tbaa !79
  %add984 = add i32 %141, %140
...
for.cond988.preheader.lr.ph:                      ; preds = %sw.bb979
  %142 = load ptr, ptr %lencode, align 8, !tbaa !29
  %143 = load i32, ptr %lenbits, align 8, !tbaa !74
  %notmask = shl nsw i32 -1, %143
...
for.cond988.preheader:                            ; preds = %for.cond988.preheader.lr.ph, %if.end1216
  ...
  %here.sroa.18.0.arrayidx996.sroa_idx3412 = getelementptr inbounds %struct.code, ptr %142, i64 %idxprom9953410, i32 1
  %here.sroa.18.0.copyload3413 = load i8, ptr %here.sroa.18.0.arrayidx996.sroa_idx3412, align 1, !tbaa.struct !85
...
do.body1003.preheader:                            ; preds = %for.cond988.preheader
  %144 = zext i32 %bits.293465 to i64
  br label %do.body1003

do.body1003:                                      ; preds = %do.body1003.preheader, %if.end1007
  %indvars.iv3898 = phi i64 [ %144, %do.body1003.preheader ], [ %indvars.iv.next3899, %if.end1007 ]
  ...
  br i1 %cmp1004, label %do.body1882.loopexit4021, label %if.end1007

if.end1007:                                       ; preds = %do.body1003
  %dec1008 = add i32 %have.343417, -1
  %incdec.ptr1009 = getelementptr inbounds i8, ptr %next.343416, i64 1
  %145 = load i8, ptr %next.343416, align 1, !tbaa !38
  %conv1010 = zext i8 %145 to i64
  %shl1012 = shl i64 %conv1010, %indvars.iv3898
  %add1013 = add i64 %shl1012, %hold.303418
  %indvars.iv.next3899 = add nuw nsw i64 %indvars.iv3898, 8
  %conv990 = trunc i64 %add1013 to i32
  %and994 = and i32 %sub993, %conv990
  %idxprom995 = zext i32 %and994 to i64
  %here.sroa.18.0.arrayidx996.sroa_idx = getelementptr inbounds %struct.code, ptr %142, i64 %idxprom995, i32 1
  %here.sroa.18.0.copyload = load i8, ptr %here.sroa.18.0.arrayidx996.sroa_idx, align 1, !tbaa.struct !85
  %146 = zext i8 %here.sroa.18.0.copyload to i64
  %cmp999.not = icmp ult i64 %indvars.iv.next3899, %146
...
for.end.loopexit:                                 ; preds = %if.end1007
  ...
  %147 = trunc i64 %indvars.iv.next3899 to i32
  br label %for.end

for.end:                                          ; preds = %for.end.loopexit, %for.cond988.preheader
  %148 = phi i64 [ %idxprom9953410, %for.cond988.preheader ], [ %idxprom995, %for.end.loopexit ]
  ...
  %bits.30.lcssa = phi i32 [ %bits.293465, %for.cond988.preheader ], [ %147, %for.end.loopexit ]
  ...
  %here.sroa.42.0.arrayidx996.sroa_idx.le = getelementptr inbounds %struct.code, ptr %142, i64 %148, i32 2
...
do.body1113.preheader:                            ; preds = %while.cond1106.preheader
  %149 = zext i32 %bits.30.lcssa to i64
  %150 = zext i32 %add1109 to i64
...
do.body1051.preheader:                            ; preds = %while.cond1044.preheader
  %151 = zext i32 %bits.30.lcssa to i64
  %152 = zext i32 %add1047 to i64
...
do.body1157.preheader:                            ; preds = %while.cond1150.preheader
  %153 = zext i32 %bits.30.lcssa to i64
  %154 = zext i32 %add1153 to i64
  br label %do.body1157

do.body1051:                                      ; preds = %do.body1051.preheader, %if.end1055
  %indvars.iv3904 = phi i64 [ %151, %do.body1051.preheader ], [ %indvars.iv.next3905, %if.end1055 ]
...
if.end1055:                                       ; preds = %do.body1051
  ...
  %155 = load i8, ptr %next.353438, align 1, !tbaa !38
  %conv1058 = zext i8 %155 to i64
  %shl1060 = shl i64 %conv1058, %indvars.iv3904
  %add1061 = add i64 %shl1060, %hold.313440
  %indvars.iv.next3905 = add nuw nsw i64 %indvars.iv3904, 8
  %cmp1048 = icmp ult i64 %indvars.iv.next3905, %152
  br i1 %cmp1048, label %do.body1051, label %do.body1068.loopexit, !llvm.loop !87

do.body1068.loopexit:                             ; preds = %if.end1055
  %156 = trunc i64 %indvars.iv.next3905 to i32
...
do.body1068:                                      ; preds = %do.body1068.loopexit, %while.cond1044.preheader
  ...
  %bits.31.lcssa = phi i32 [ %bits.30.lcssa, %while.cond1044.preheader ], [ %156, %do.body1068.loopexit ]
...
if.end1084:                                       ; preds = %do.body1068
  ...
  %157 = load i16, ptr %arrayidx1089, align 2, !tbaa !81
...
do.body1113:                                      ; preds = %do.body1113.preheader, %if.end1117
  %indvars.iv3901 = phi i64 [ %149, %do.body1113.preheader ], [ %indvars.iv.next3902, %if.end1117 ]
...
if.end1117:                                       ; preds = %do.body1113
  ...
  %158 = load i8, ptr %next.363429, align 1, !tbaa !38
  %conv1120 = zext i8 %158 to i64
  %shl1122 = shl i64 %conv1120, %indvars.iv3901
  %add1123 = add i64 %shl1122, %hold.323431
  %indvars.iv.next3902 = add nuw nsw i64 %indvars.iv3901, 8
  %cmp1110 = icmp ult i64 %indvars.iv.next3902, %150
  br i1 %cmp1110, label %do.body1113, label %do.body1130.loopexit, !llvm.loop !88

do.body1130.loopexit:                             ; preds = %if.end1117
  %159 = trunc i64 %indvars.iv.next3902 to i32
...
do.body1130:                                      ; preds = %do.body1130.loopexit, %while.cond1106.preheader
  ...
  %bits.32.lcssa = phi i32 [ %bits.30.lcssa, %while.cond1106.preheader ], [ %159, %do.body1130.loopexit ]
...
do.body1157:                                      ; preds = %do.body1157.preheader, %if.end1161
  %indvars.iv3907 = phi i64 [ %153, %do.body1157.preheader ], [ %indvars.iv.next3908, %if.end1161 ]
...
if.end1161:                                       ; preds = %do.body1157
  ...
  %160 = load i8, ptr %next.373447, align 1, !tbaa !38
  %conv1164 = zext i8 %160 to i64
  %shl1166 = shl i64 %conv1164, %indvars.iv3907
  %add1167 = add i64 %shl1166, %hold.333449
  %indvars.iv.next3908 = add nuw nsw i64 %indvars.iv3907, 8
  %cmp1154 = icmp ult i64 %indvars.iv.next3908, %154
  br i1 %cmp1154, label %do.body1157, label %do.body1174.loopexit, !llvm.loop !89

do.body1174.loopexit:                             ; preds = %if.end1161
  %161 = trunc i64 %indvars.iv.next3908 to i32
...
do.body1174:                                      ; preds = %do.body1174.loopexit, %while.cond1150.preheader
  ...
  %bits.33.lcssa = phi i32 [ %bits.30.lcssa, %while.cond1150.preheader ], [ %161, %do.body1174.loopexit ]
...
if.end1193:                                       ; preds = %do.body1130, %do.body1174, %if.end1084
  ...
  %len.0 = phi i16 [ %157, %if.end1084 ], [ 0, %do.body1130 ], [ 0, %do.body1174 ]
...
while.body1208.preheader:                         ; preds = %if.end1193
  %min.iters.check4476 = icmp ult i32 %copy.5, 16
  br i1 %min.iters.check4476, label %while.body1208.preheader4489, label %vector.scevcheck

vector.scevcheck:                                 ; preds = %while.body1208.preheader
  %162 = add nsw i32 %copy.5, -1
  %163 = xor i32 %.lcssa345534583461, -1
  %164 = icmp ugt i32 %162, %163
  br i1 %164, label %while.body1208.preheader4489, label %vector.ph4477

vector.ph4477:                                    ; preds = %vector.scevcheck
  %n.vec4479 = and i32 %copy.5, -16
  %ind.end4480 = and i32 %copy.5, 15
  %ind.end4482 = add i32 %.lcssa345534583461, %n.vec4479
  ...
  %165 = zext i32 %.lcssa345534583461 to i64
  %166 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %165
  store <8 x i16> %broadcast.splat, ptr %166, align 2, !tbaa !81
  %167 = getelementptr inbounds i16, ptr %166, i64 8
  store <8 x i16> %broadcast.splat, ptr %167, align 2, !tbaa !81
  %168 = icmp eq i32 %n.vec4479, 16
  br i1 %168, label %middle.block4474, label %vector.body4485.1, !llvm.loop !90

vector.body4485.1:                                ; preds = %vector.ph4477
  %offset.idx.1 = add i32 %.lcssa345534583461, 16
  %169 = zext i32 %offset.idx.1 to i64
  %170 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %169
  store <8 x i16> %broadcast.splat, ptr %170, align 2, !tbaa !81
  %171 = getelementptr inbounds i16, ptr %170, i64 8
  store <8 x i16> %broadcast.splat, ptr %171, align 2, !tbaa !81
  %172 = icmp eq i32 %n.vec4479, 32
  br i1 %172, label %middle.block4474, label %vector.body4485.2, !llvm.loop !90

vector.body4485.2:                                ; preds = %vector.body4485.1
  %offset.idx.2 = add i32 %.lcssa345534583461, 32
  %173 = zext i32 %offset.idx.2 to i64
  %174 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %173
  store <8 x i16> %broadcast.splat, ptr %174, align 2, !tbaa !81
  %175 = getelementptr inbounds i16, ptr %174, i64 8
  store <8 x i16> %broadcast.splat, ptr %175, align 2, !tbaa !81
  %176 = icmp eq i32 %n.vec4479, 48
  br i1 %176, label %middle.block4474, label %vector.body4485.3, !llvm.loop !90

vector.body4485.3:                                ; preds = %vector.body4485.2
  %offset.idx.3 = add i32 %.lcssa345534583461, 48
  %177 = zext i32 %offset.idx.3 to i64
  %178 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %177
  store <8 x i16> %broadcast.splat, ptr %178, align 2, !tbaa !81
  %179 = getelementptr inbounds i16, ptr %178, i64 8
  store <8 x i16> %broadcast.splat, ptr %179, align 2, !tbaa !81
  %180 = icmp eq i32 %n.vec4479, 64
  br i1 %180, label %middle.block4474, label %vector.body4485.4, !llvm.loop !90

vector.body4485.4:                                ; preds = %vector.body4485.3
  %offset.idx.4 = add i32 %.lcssa345534583461, 64
  %181 = zext i32 %offset.idx.4 to i64
  %182 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %181
  store <8 x i16> %broadcast.splat, ptr %182, align 2, !tbaa !81
  %183 = getelementptr inbounds i16, ptr %182, i64 8
  store <8 x i16> %broadcast.splat, ptr %183, align 2, !tbaa !81
  %184 = icmp eq i32 %n.vec4479, 80
  br i1 %184, label %middle.block4474, label %vector.body4485.5, !llvm.loop !90

vector.body4485.5:                                ; preds = %vector.body4485.4
  %offset.idx.5 = add i32 %.lcssa345534583461, 80
  %185 = zext i32 %offset.idx.5 to i64
  %186 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %185
  store <8 x i16> %broadcast.splat, ptr %186, align 2, !tbaa !81
  %187 = getelementptr inbounds i16, ptr %186, i64 8
  store <8 x i16> %broadcast.splat, ptr %187, align 2, !tbaa !81
  %188 = icmp eq i32 %n.vec4479, 96
  br i1 %188, label %middle.block4474, label %vector.body4485.6, !llvm.loop !90

vector.body4485.6:                                ; preds = %vector.body4485.5
  %offset.idx.6 = add i32 %.lcssa345534583461, 96
  %189 = zext i32 %offset.idx.6 to i64
  %190 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %189
  store <8 x i16> %broadcast.splat, ptr %190, align 2, !tbaa !81
  %191 = getelementptr inbounds i16, ptr %190, i64 8
  store <8 x i16> %broadcast.splat, ptr %191, align 2, !tbaa !81
  %192 = icmp eq i32 %n.vec4479, 112
  br i1 %192, label %middle.block4474, label %vector.body4485.7, !llvm.loop !90

vector.body4485.7:                                ; preds = %vector.body4485.6
  %offset.idx.7 = add i32 %.lcssa345534583461, 112
  %193 = zext i32 %offset.idx.7 to i64
  %194 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %193
  store <8 x i16> %broadcast.splat, ptr %194, align 2, !tbaa !81
  %195 = getelementptr inbounds i16, ptr %194, i64 8
  store <8 x i16> %broadcast.splat, ptr %195, align 2, !tbaa !81
  br label %middle.block4474

middle.block4474:                                 ; preds = %vector.body4485.7, %vector.body4485.6, %vector.body4485.5, %vector.body4485.4, %vector.body4485.3, %vector.body4485.2, %vector.body4485.1, %vector.ph4477
  %cmp.n4484 = icmp eq i32 %copy.5, %n.vec4479
  br i1 %cmp.n4484, label %if.end1216.loopexit, label %while.body1208.preheader4489

while.body1208.preheader4489:                     ; preds = %vector.scevcheck, %while.body1208.preheader, %middle.block4474
  %copy.63456.ph = phi i32 [ %copy.5, %vector.scevcheck ], [ %copy.5, %while.body1208.preheader ], [ %ind.end4480, %middle.block4474 ]
  %.ph = phi i32 [ %.lcssa345534583461, %vector.scevcheck ], [ %.lcssa345534583461, %while.body1208.preheader ], [ %ind.end4482, %middle.block4474 ]
  %196 = add nsw i32 %copy.63456.ph, -1
...
while.body1208.prol:                              ; preds = %while.body1208.preheader4489, %while.body1208.prol
  %copy.63456.prol = phi i32 [ %dec1206.prol, %while.body1208.prol ], [ %copy.63456.ph, %while.body1208.preheader4489 ]
  %197 = phi i32 [ %inc1212.prol, %while.body1208.prol ], [ %.ph, %while.body1208.preheader4489 ]
  ...
  %inc1212.prol = add i32 %197, 1
  %idxprom1213.prol = zext i32 %197 to i64
...
while.body1208.prol.loopexit:                     ; preds = %while.body1208.prol, %while.body1208.preheader4489
  ...
  %copy.63456.unr = phi i32 [ %copy.63456.ph, %while.body1208.preheader4489 ], [ %dec1206.prol, %while.body1208.prol ]
  %.unr = phi i32 [ %.ph, %while.body1208.preheader4489 ], [ %inc1212.prol, %while.body1208.prol ]
  %198 = icmp ult i32 %196, 3
  br i1 %198, label %if.end1216.loopexit, label %while.body1208
...
while.body1208:                                   ; preds = %while.body1208.prol.loopexit, %while.body1208
  ...
  %199 = phi i32 [ %inc1212.3, %while.body1208 ], [ %.unr, %while.body1208.prol.loopexit ]
  %inc1212 = add i32 %199, 1
  %idxprom1213 = zext i32 %199 to i64
...
if.end1216.loopexit:                              ; preds = %while.body1208.prol.loopexit, %while.body1208, %middle.block4474
  %inc1212.lcssa = phi i32 [ %ind.end4482, %middle.block4474 ], [ %inc1212.lcssa4515.unr, %while.body1208.prol.loopexit ], [ %inc1212.3, %while.body1208 ]
...
if.end1222:                                       ; preds = %if.end1216, %sw.bb979
  ...
  %200 = load i16, ptr %arrayidx1224, align 8, !tbaa !81
  %cmp1226 = icmp eq i16 %200, 0
...
if.end1231:                                       ; preds = %if.end1222
  ...
  store ptr %codes, ptr %lencode, align 8, !tbaa !29
  store i32 9, ptr %lenbits, align 8, !tbaa !74
  %call1245 = call i32 @inflate_table(i32 noundef 1, ptr noundef nonnull %lens966, i32 noundef %140, ptr noundef nonnull %next964, ptr noundef nonnull %lenbits, ptr noundef nonnull %work) #10
...
if.end1250:                                       ; preds = %if.end1231
  %201 = load ptr, ptr %next964, align 8, !tbaa !27
  store ptr %201, ptr %distcode, align 8, !tbaa !28
  store i32 6, ptr %distbits, align 4, !tbaa !75
  %202 = load i32, ptr %nlen, align 4, !tbaa !78
  %idx.ext1255 = zext i32 %202 to i64
  %add.ptr1256 = getelementptr inbounds i16, ptr %lens966, i64 %idx.ext1255
  %203 = load i32, ptr %ndist, align 8, !tbaa !79
  %call1262 = call i32 @inflate_table(i32 noundef 2, ptr noundef nonnull %add.ptr1256, i32 noundef %203, ptr noundef nonnull %next964, ptr noundef nonnull %distbits, ptr noundef nonnull %work) #10
...
do.body1282:                                      ; preds = %sw.bb1275
  ...
  %204 = load ptr, ptr %next_out, align 8, !tbaa !41
  %205 = load i32, ptr %avail_out, align 8, !tbaa !44
  %206 = load ptr, ptr %strm, align 8, !tbaa !42
  %207 = load i32, ptr %avail_in11, align 8, !tbaa !43
  %208 = load i64, ptr %hold12, align 8, !tbaa !25
  %209 = load i32, ptr %bits13, align 8, !tbaa !26
  %210 = load i32, ptr %mode.i, align 8, !tbaa !16
  %cmp1301 = icmp eq i32 %210, 16191
...
if.end1305:                                       ; preds = %sw.bb1275
  ...
  %211 = load ptr, ptr %lencode, align 8, !tbaa !29
  %212 = load i32, ptr %lenbits, align 8, !tbaa !74
  %notmask2893 = shl nsw i32 -1, %212
  ...
  %arrayidx13153475 = getelementptr inbounds %struct.code, ptr %211, i64 %idxprom13143474
  %here.sroa.18.0.arrayidx1315.sroa_idx3476 = getelementptr inbounds i8, ptr %arrayidx13153475, i64 1
  %here.sroa.18.0.copyload20583477 = load i8, ptr %here.sroa.18.0.arrayidx1315.sroa_idx3476, align 1, !tbaa.struct !85
...
do.body1322.preheader:                            ; preds = %if.end1305
  %213 = zext i32 %bits.38 to i64
  br label %do.body1322

do.body1322:                                      ; preds = %do.body1322.preheader, %if.end1326
  %indvars.iv3910 = phi i64 [ %213, %do.body1322.preheader ], [ %indvars.iv.next3911, %if.end1326 ]
  ...
  br i1 %cmp1323, label %do.body1882.loopexit4027, label %if.end1326

if.end1326:                                       ; preds = %do.body1322
  %dec1327 = add i32 %have.433481, -1
  %incdec.ptr1328 = getelementptr inbounds i8, ptr %next.433480, i64 1
  %214 = load i8, ptr %next.433480, align 1, !tbaa !38
  %conv1329 = zext i8 %214 to i64
  %shl1331 = shl i64 %conv1329, %indvars.iv3910
  ...
  %arrayidx1315 = getelementptr inbounds %struct.code, ptr %211, i64 %idxprom1314
  ...
  %215 = zext i8 %here.sroa.18.0.copyload2058 to i64
  %cmp1318.not = icmp ult i64 %indvars.iv.next3911, %215
...
for.end1336.loopexit:                             ; preds = %if.end1326
  ...
  %216 = trunc i64 %indvars.iv.next3911 to i32
...
for.end1336:                                      ; preds = %for.end1336.loopexit, %if.end1305
  ...
  %bits.39.lcssa = phi i32 [ %bits.38, %if.end1305 ], [ %216, %for.end1336.loopexit ]
  ...
  %here.sroa.0.0.copyload2054 = load i8, ptr %arrayidx1315.lcssa3471, align 2, !tbaa.struct !97
  %217 = add i8 %here.sroa.0.0.copyload2054, -1
  %or.cond2904 = icmp ult i8 %217, 15
...
for.cond1346.preheader:                           ; preds = %for.end1336
  ...
  %arrayidx13643498 = getelementptr inbounds %struct.code, ptr %211, i64 %idxprom13633497
  %here.sroa.18.0.arrayidx1364.sroa_idx3499 = getelementptr inbounds i8, ptr %arrayidx13643498, i64 1
  %here.sroa.18.0.copyload20593500 = load i8, ptr %here.sroa.18.0.arrayidx1364.sroa_idx3499, align 1, !tbaa.struct !85
...
do.body1374.preheader:                            ; preds = %for.cond1346.preheader
  %218 = zext i32 %bits.39.lcssa to i64
  br label %do.body1374

do.body1374:                                      ; preds = %do.body1374.preheader, %if.end1378
  %indvars.iv3914 = phi i64 [ %218, %do.body1374.preheader ], [ %indvars.iv.next3915, %if.end1378 ]
  ...
  br i1 %cmp1375, label %do.body1882.loopexit4026, label %if.end1378

if.end1378:                                       ; preds = %do.body1374
  %dec1379 = add i32 %have.443505, -1
  %incdec.ptr1380 = getelementptr inbounds i8, ptr %next.443504, i64 1
  %219 = load i8, ptr %next.443504, align 1, !tbaa !38
  %conv1381 = zext i8 %219 to i64
  %shl1383 = shl i64 %conv1381, %indvars.iv3914
  %add1384 = add i64 %shl1383, %hold.403506
  %indvars.iv.next3915 = add nuw nsw i64 %indvars.iv3914, 8
  ...
  %arrayidx1364 = getelementptr inbounds %struct.code, ptr %211, i64 %idxprom1363
  ...
  %220 = zext i32 %add1369 to i64
  %cmp1370.not = icmp ult i64 %indvars.iv.next3915, %220
  br i1 %cmp1370.not, label %do.body1374, label %do.body1389.loopexit

do.body1389.loopexit:                             ; preds = %if.end1378
  %221 = trunc i64 %indvars.iv.next3915 to i32
...
do.body1389:                                      ; preds = %do.body1389.loopexit, %for.cond1346.preheader
  ...
  %bits.40.lcssa = phi i32 [ %bits.39.lcssa, %for.cond1346.preheader ], [ %221, %do.body1389.loopexit ]
...
do.body1404:                                      ; preds = %for.end1336, %do.body1389
  %222 = phi i32 [ %conv1317.lcssa, %do.body1389 ], [ 0, %for.end1336 ]
  ...
  %add1417 = add nuw nsw i32 %222, %conv1406
...
sw.bb1449:                                        ; preds = %for.cond.sw.bb1449_crit_edge, %if.end1443
  %223 = phi i32 [ %.pre3963, %for.cond.sw.bb1449_crit_edge ], [ %and1446, %if.end1443 ]
  ...
  %tobool1451.not = icmp eq i32 %223, 0
...
sw.bb1449.if.end1494_crit_edge:                   ; preds = %sw.bb1449
  %.pre3964 = load i32, ptr %length1741, align 4, !tbaa !61
  br label %if.end1494

while.cond1454.preheader:                         ; preds = %sw.bb1449
  %cmp14563514 = icmp ult i32 %bits.42, %223
...
do.body1459:                                      ; preds = %while.cond1454.preheader, %if.end1463
  ...
  br i1 %cmp1460, label %do.body1882.loopexit4025, label %if.end1463

if.end1463:                                       ; preds = %do.body1459
  %dec1464 = add i32 %have.473516, -1
  %incdec.ptr1465 = getelementptr inbounds i8, ptr %next.473515, i64 1
  %224 = load i8, ptr %next.473515, align 1, !tbaa !38
  %conv1466 = zext i8 %224 to i64
  ...
  %cmp1456 = icmp ult i32 %add1470, %223
...
do.end1475:                                       ; preds = %if.end1463, %while.cond1454.preheader
  ...
  %notmask2895 = shl nsw i32 -1, %223
  %sub1479 = xor i32 %notmask2895, -1
  %and1480 = and i32 %conv1476, %sub1479
  %225 = load i32, ptr %length1741, align 4, !tbaa !61
  %add1482 = add i32 %225, %and1480
  store i32 %add1482, ptr %length1741, align 4, !tbaa !61
  %sh_prom1485 = zext i32 %223 to i64
  %shr1486 = lshr i64 %hold.43.lcssa, %sh_prom1485
  %sub1488 = sub i32 %bits.43.lcssa, %223
  %226 = load i32, ptr %back1306, align 4, !tbaa !31
  %add1493 = add i32 %226, %223
  store i32 %add1493, ptr %back1306, align 4, !tbaa !31
  br label %if.end1494

if.end1494:                                       ; preds = %sw.bb1449.if.end1494_crit_edge, %do.end1475
  %227 = phi i32 [ %add1482, %do.end1475 ], [ %.pre3964, %sw.bb1449.if.end1494_crit_edge ]
  ...
  store i32 %227, ptr %was, align 8, !tbaa !99
...
sw.bb1497:                                        ; preds = %for.cond, %if.end1494
  ...
  %228 = load ptr, ptr %distcode, align 8, !tbaa !28
  %229 = load i32, ptr %distbits, align 4, !tbaa !75
  %notmask2896 = shl nsw i32 -1, %229
  ...
  %arrayidx15063527 = getelementptr inbounds %struct.code, ptr %228, i64 %idxprom15053526
  %here.sroa.18.0.arrayidx1506.sroa_idx3528 = getelementptr inbounds i8, ptr %arrayidx15063527, i64 1
  %here.sroa.18.0.copyload20603529 = load i8, ptr %here.sroa.18.0.arrayidx1506.sroa_idx3528, align 1, !tbaa.struct !85
...
do.body1513.preheader:                            ; preds = %sw.bb1497
  %230 = zext i32 %bits.45 to i64
  br label %do.body1513

do.body1513:                                      ; preds = %do.body1513.preheader, %if.end1517
  %indvars.iv3919 = phi i64 [ %230, %do.body1513.preheader ], [ %indvars.iv.next3920, %if.end1517 ]
  ...
  br i1 %cmp1514, label %do.body1882.loopexit4024, label %if.end1517

if.end1517:                                       ; preds = %do.body1513
  %dec1518 = add i32 %have.503533, -1
  %incdec.ptr1519 = getelementptr inbounds i8, ptr %next.503532, i64 1
  %231 = load i8, ptr %next.503532, align 1, !tbaa !38
  %conv1520 = zext i8 %231 to i64
  %shl1522 = shl i64 %conv1520, %indvars.iv3919
  ...
  %arrayidx1506 = getelementptr inbounds %struct.code, ptr %228, i64 %idxprom1505
  ...
  %232 = zext i8 %here.sroa.18.0.copyload2060 to i64
  %cmp1509.not = icmp ult i64 %indvars.iv.next3920, %232
...
for.end1527.loopexit:                             ; preds = %if.end1517
  ...
  %233 = trunc i64 %indvars.iv.next3920 to i32
...
for.end1527:                                      ; preds = %for.end1527.loopexit, %sw.bb1497
  ...
  %bits.46.lcssa = phi i32 [ %bits.45, %sw.bb1497 ], [ %233, %for.end1527.loopexit ]
  ...
  %here.sroa.0.0.copyload2056 = load i8, ptr %arrayidx1506.lcssa3523, align 2, !tbaa.struct !97
...
for.end1527.do.body1592_crit_edge:                ; preds = %for.end1527
  %.pre3965 = load i32, ptr %back1306, align 4, !tbaa !31
...
for.cond1534.preheader:                           ; preds = %for.end1527
  ...
  %arrayidx15523550 = getelementptr inbounds %struct.code, ptr %228, i64 %idxprom15513549
  %here.sroa.18.0.arrayidx1552.sroa_idx3551 = getelementptr inbounds i8, ptr %arrayidx15523550, i64 1
  %here.sroa.18.0.copyload20613552 = load i8, ptr %here.sroa.18.0.arrayidx1552.sroa_idx3551, align 1, !tbaa.struct !85
...
do.body1562.preheader:                            ; preds = %for.cond1534.preheader
  %234 = zext i32 %bits.46.lcssa to i64
  br label %do.body1562

do.body1562:                                      ; preds = %do.body1562.preheader, %if.end1566
  %indvars.iv3923 = phi i64 [ %234, %do.body1562.preheader ], [ %indvars.iv.next3924, %if.end1566 ]
  ...
  br i1 %cmp1563, label %do.body1882.loopexit4023, label %if.end1566

if.end1566:                                       ; preds = %do.body1562
  %dec1567 = add i32 %have.513557, -1
  %incdec.ptr1568 = getelementptr inbounds i8, ptr %next.513556, i64 1
  %235 = load i8, ptr %next.513556, align 1, !tbaa !38
  %conv1569 = zext i8 %235 to i64
  %shl1571 = shl i64 %conv1569, %indvars.iv3923
  %add1572 = add i64 %shl1571, %hold.473558
  %indvars.iv.next3924 = add nuw nsw i64 %indvars.iv3923, 8
  ...
  %arrayidx1552 = getelementptr inbounds %struct.code, ptr %228, i64 %idxprom1551
  ...
  %236 = zext i32 %add1557 to i64
  %cmp1558.not = icmp ult i64 %indvars.iv.next3924, %236
  br i1 %cmp1558.not, label %do.body1562, label %do.body1577.loopexit

do.body1577.loopexit:                             ; preds = %if.end1566
  %237 = trunc i64 %indvars.iv.next3924 to i32
...
do.body1577:                                      ; preds = %do.body1577.loopexit, %for.cond1534.preheader
  ...
  %bits.47.lcssa = phi i32 [ %bits.46.lcssa, %for.cond1534.preheader ], [ %237, %do.body1577.loopexit ]
  ...
  %238 = load i32, ptr %back1306, align 4, !tbaa !31
  %add1590 = add nsw i32 %238, %conv1508.lcssa
  br label %do.body1592

do.body1592:                                      ; preds = %for.end1527.do.body1592_crit_edge, %do.body1577
  %239 = phi i32 [ %add1590, %do.body1577 ], [ %.pre3965, %for.end1527.do.body1592_crit_edge ]
  ...
  %add1605 = add nsw i32 %239, %conv1594
...
sw.bb1621:                                        ; preds = %for.cond.sw.bb1621_crit_edge, %if.end1613
  %240 = phi i32 [ %.pre3966, %for.cond.sw.bb1621_crit_edge ], [ %and1618, %if.end1613 ]
...
do.body1631:                                      ; preds = %while.cond1626.preheader, %if.end1635
  ...
  br i1 %cmp1632, label %do.body1882.loopexit4022, label %if.end1635

if.end1635:                                       ; preds = %do.body1631
  %dec1636 = add i32 %have.543568, -1
  %incdec.ptr1637 = getelementptr inbounds i8, ptr %next.543567, i64 1
  %241 = load i8, ptr %next.543567, align 1, !tbaa !38
  %conv1638 = zext i8 %241 to i64
  ...
  %cmp1628 = icmp ult i32 %add1642, %240
...
do.end1647:                                       ; preds = %if.end1635, %while.cond1626.preheader
  ...
  %notmask2898 = shl nsw i32 -1, %240
  %sub1651 = xor i32 %notmask2898, -1
  %and1652 = and i32 %conv1648, %sub1651
  %242 = load i32, ptr %offset, align 8, !tbaa !100
  %add1654 = add i32 %242, %and1652
  store i32 %add1654, ptr %offset, align 8, !tbaa !100
  %sh_prom1657 = zext i32 %240 to i64
  %shr1658 = lshr i64 %hold.50.lcssa, %sh_prom1657
  %sub1660 = sub i32 %bits.50.lcssa, %240
  %243 = load i32, ptr %back1306, align 4, !tbaa !31
  %add1665 = add i32 %243, %240
...
if.end1672:                                       ; preds = %sw.bb1668
  ...
  %244 = load i32, ptr %offset, align 8, !tbaa !100
  %cmp1675 = icmp ugt i32 %244, %sub1673
  br i1 %cmp1675, label %if.then1677, label %if.else1710

if.then1677:                                      ; preds = %if.end1672
  %sub1679 = sub i32 %244, %sub1673
  %245 = load i32, ptr %whave, align 8, !tbaa !33
  %cmp1680 = icmp ugt i32 %sub1679, %245
  br i1 %cmp1680, label %if.then1682, label %if.end1688

if.then1682:                                      ; preds = %if.then1677
  %246 = load i32, ptr %sane, align 8, !tbaa !30
  %tobool1683.not = icmp eq i32 %246, 0
...
if.end1688:                                       ; preds = %if.then1682, %if.then1677
  %247 = load i32, ptr %wnext, align 4, !tbaa !34
  %cmp1689 = icmp ugt i32 %sub1679, %247
  br i1 %cmp1689, label %if.then1691, label %if.else1697

if.then1691:                                      ; preds = %if.end1688
  %sub1693 = sub i32 %sub1679, %247
  %248 = load i32, ptr %wsize, align 4, !tbaa !32
  %sub1694 = sub i32 %248, %sub1693
  br label %if.end1703

if.else1697:                                      ; preds = %if.end1688
  %sub1700 = sub i32 %247, %sub1679
  br label %if.end1703
...
if.end1703:                                       ; preds = %if.else1697, %if.then1691
  ...
  %.sink4245 = load ptr, ptr %window1698, align 8, !tbaa !35
  %idx.ext1701 = zext i32 %sub1700.sink to i64
  %add.ptr1702 = getelementptr inbounds i8, ptr %.sink4245, i64 %idx.ext1701
  %249 = load i32, ptr %length1741, align 4, !tbaa !61
  %spec.select2905 = call i32 @llvm.umin.i32(i32 %copy.7, i32 %249)
  br label %if.end1715

if.else1710:                                      ; preds = %if.end1672
  %idx.ext1712 = zext i32 %244 to i64
  %idx.neg = sub nsw i64 0, %idx.ext1712
  %add.ptr1713 = getelementptr inbounds i8, ptr %put.0, i64 %idx.neg
  %250 = load i32, ptr %length1741, align 4, !tbaa !61
  br label %if.end1715

if.end1715:                                       ; preds = %if.end1703, %if.else1710
  %251 = phi i32 [ %250, %if.else1710 ], [ %249, %if.end1703 ]
  %copy.8 = phi i32 [ %250, %if.else1710 ], [ %spec.select2905, %if.end1703 ]
  ...
  %sub1722 = sub i32 %251, %spec.select2906
  store i32 %sub1722, ptr %length1741, align 4, !tbaa !61
  %252 = add i32 %spec.select2906, -1
  %253 = zext i32 %252 to i64
  %254 = add nuw nsw i64 %253, 1
  %min.iters.check = icmp ult i32 %252, 31
  %from.14465 = ptrtoint ptr %from.1 to i64
  %255 = sub i64 %put.04464, %from.14465
  %diff.check = icmp ult i64 %255, 32
...
vector.ph:                                        ; preds = %if.end1715
  %n.vec = and i64 %254, 8589934560
  %ind.end = getelementptr i8, ptr %put.0, i64 %n.vec
  %.cast = trunc i64 %n.vec to i32
  %ind.end4466 = sub i32 %spec.select2906, %.cast
  %ind.end4468 = getelementptr i8, ptr %from.1, i64 %n.vec
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %next.gep = getelementptr i8, ptr %put.0, i64 %index
  %next.gep4471 = getelementptr i8, ptr %from.1, i64 %index
  %wide.load = load <16 x i8>, ptr %next.gep4471, align 1, !tbaa !38
  %256 = getelementptr i8, ptr %next.gep4471, i64 16
  %wide.load4473 = load <16 x i8>, ptr %256, align 1, !tbaa !38
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !38
  %257 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load4473, ptr %257, align 1, !tbaa !38
  %index.next = add nuw i64 %index, 32
  %258 = icmp eq i64 %index.next, %n.vec
  br i1 %258, label %middle.block, label %vector.body, !llvm.loop !102

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %254, %n.vec
...
do.body1723.preheader:                            ; preds = %if.end1715, %middle.block
  ...
  %copy.10.ph = phi i32 [ %spec.select2906, %if.end1715 ], [ %ind.end4466, %middle.block ]
  %from.2.ph = phi ptr [ %from.1, %if.end1715 ], [ %ind.end4468, %middle.block ]
  %259 = add i32 %copy.10.ph, -1
...
do.body1723.prol:                                 ; preds = %do.body1723.preheader, %do.body1723.prol
  ...
  %260 = load i8, ptr %from.2.prol, align 1, !tbaa !38
  %incdec.ptr1725.prol = getelementptr inbounds i8, ptr %put.1.prol, i64 1
  store i8 %260, ptr %put.1.prol, align 1, !tbaa !38
...
do.body1723.prol.loopexit:                        ; preds = %do.body1723.prol, %do.body1723.preheader
  ...
  br i1 %261, label %do.end1729, label %do.body1723
...
if.end1740:                                       ; preds = %sw.bb1736
  %271 = load i32, ptr %length1741, align 4, !tbaa !61
  %conv1742 = trunc i32 %271 to i8
...
sw.bb1746:                                        ; preds = %for.cond
  %272 = load i32, ptr %wrap1747, align 8, !tbaa !19
  %tobool1748.not = icmp eq i32 %272, 0
...
if.end1759:                                       ; preds = %do.body1755.preheader
  ...
  %274 = load i8, ptr %next.0, align 1, !tbaa !38
  %conv1762 = zext i8 %274 to i64
  %shl1764 = shl nuw nsw i64 %conv1762, %273
  %add1765 = add i64 %shl1764, %hold.0
  %indvars.iv.next = add nuw nsw i64 %273, 8
...
if.end1759.1:                                     ; preds = %do.body1755.1
  ...
  %275 = load i8, ptr %incdec.ptr1761, align 1, !tbaa !38
  %conv1762.1 = zext i8 %275 to i64
  %shl1764.1 = shl nuw nsw i64 %conv1762.1, %indvars.iv.next
  %add1765.1 = add i64 %shl1764.1, %add1765
  %indvars.iv.next.1 = add nuw nsw i64 %273, 16
...
if.end1759.2:                                     ; preds = %do.body1755.2
  ...
  %276 = load i8, ptr %incdec.ptr1761.1, align 1, !tbaa !38
  %conv1762.2 = zext i8 %276 to i64
  %shl1764.2 = shl nuw nsw i64 %conv1762.2, %indvars.iv.next.1
  %add1765.2 = add i64 %shl1764.2, %add1765.1
  %indvars.iv.next.2 = add nuw nsw i64 %273, 24
...
if.end1759.3:                                     ; preds = %do.body1755.3
  ...
  %277 = load i8, ptr %incdec.ptr1761.2, align 1, !tbaa !38
  %conv1762.3 = zext i8 %277 to i64
  %shl1764.3 = shl nuw nsw i64 %conv1762.3, %indvars.iv.next.2
  %add1765.3 = add i64 %shl1764.3, %add1765.2
  %indvars.iv.next.3 = add nuw nsw i64 %273, 32
...
do.end1771.loopexit:                              ; preds = %if.end1759.3, %if.end1759.2, %if.end1759.1, %if.end1759
  ...
  %278 = trunc i64 %indvars.iv.next.lcssa to i32
  br label %do.end1771
...
do.end1771:                                       ; preds = %do.end1771.loopexit, %while.cond1751.preheader
  ...
  %bits.53.lcssa = phi i32 [ %bits.0, %while.cond1751.preheader ], [ %278, %do.end1771.loopexit ]
  %sub1772 = sub i32 %out.0, %left.0
  %conv1773 = zext i32 %sub1772 to i64
  %279 = load i64, ptr %total_out, align 8, !tbaa !106
  %add1774 = add i64 %279, %conv1773
  store i64 %add1774, ptr %total_out, align 8, !tbaa !106
  %280 = load i64, ptr %total, align 8, !tbaa !17
  %add1776 = add i64 %280, %conv1773
  store i64 %add1776, ptr %total, align 8, !tbaa !17
  %and1778 = and i32 %272, 4
...
if.then1782:                                      ; preds = %do.end1771
  %281 = load i32, ptr %flags1783, align 8, !tbaa !50
  %tobool1784.not = icmp eq i32 %281, 0
  %282 = load i64, ptr %check1786, align 8, !tbaa !49
...
cond.true1785:                                    ; preds = %if.then1782
  %call1790 = call i64 @crc32(i64 noundef %282, ptr noundef %add.ptr1795, i32 noundef %sub1772) #10
  br label %cond.end1797

cond.false1791:                                   ; preds = %if.then1782
  %call1796 = call i64 @adler32(i64 noundef %282, ptr noundef %add.ptr1795, i32 noundef %sub1772) #10
  br label %cond.end1797
...
cond.end1797:                                     ; preds = %cond.false1791, %cond.true1785
  ...
  %.pre3957 = load i32, ptr %wrap1747, align 8, !tbaa !19
  %.pre3968 = and i32 %.pre3957, 4
  br label %if.end1801

if.end1801:                                       ; preds = %cond.end1797, %do.end1771
  %and1803.pre-phi = phi i32 [ %.pre3968, %cond.end1797 ], [ %and1778, %do.end1771 ]
  %283 = phi i32 [ %.pre3957, %cond.end1797 ], [ %272, %do.end1771 ]
...
land.lhs.true1805:                                ; preds = %if.end1801
  %284 = load i32, ptr %flags1783, align 8, !tbaa !50
  %tobool1807.not = icmp eq i32 %284, 0
  ...
  %285 = load i64, ptr %check1786, align 8, !tbaa !49
  %cmp1824.not = icmp eq i64 %cond1822, %285
...
if.end1833:                                       ; preds = %land.lhs.true1805, %if.end1801, %sw.bb1746
  %286 = phi i32 [ 0, %sw.bb1746 ], [ %283, %if.end1801 ], [ %283, %land.lhs.true1805 ]
...
sw.bb1835:                                        ; preds = %for.cond.sw.bb1835_crit_edge, %if.end1833
  %287 = phi i32 [ %.pre3958, %for.cond.sw.bb1835_crit_edge ], [ %286, %if.end1833 ]
  ...
  %tobool1837.not = icmp eq i32 %287, 0
  br i1 %tobool1837.not, label %if.end1875, label %land.lhs.true1838

land.lhs.true1838:                                ; preds = %sw.bb1835
  %288 = load i32, ptr %flags1783, align 8, !tbaa !50
  %tobool1840.not = icmp eq i32 %288, 0
...
if.end1851:                                       ; preds = %do.body1847.preheader
  ...
  %290 = load i8, ptr %next.59, align 1, !tbaa !38
  %conv1854 = zext i8 %290 to i64
  %shl1856 = shl nuw nsw i64 %conv1854, %289
  %add1857 = add i64 %shl1856, %hold.55
  %indvars.iv.next3886 = add nuw nsw i64 %289, 8
...
if.end1851.1:                                     ; preds = %do.body1847.1
  ...
  %291 = load i8, ptr %incdec.ptr1853, align 1, !tbaa !38
  %conv1854.1 = zext i8 %291 to i64
  %shl1856.1 = shl nuw nsw i64 %conv1854.1, %indvars.iv.next3886
  %add1857.1 = add i64 %shl1856.1, %add1857
  %indvars.iv.next3886.1 = add nuw nsw i64 %289, 16
...
if.end1851.2:                                     ; preds = %do.body1847.2
  ...
  %292 = load i8, ptr %incdec.ptr1853.1, align 1, !tbaa !38
  %conv1854.2 = zext i8 %292 to i64
  %shl1856.2 = shl nuw nsw i64 %conv1854.2, %indvars.iv.next3886.1
  %add1857.2 = add i64 %shl1856.2, %add1857.1
  %indvars.iv.next3886.2 = add nuw nsw i64 %289, 24
...
if.end1851.3:                                     ; preds = %do.body1847.3
  ...
  %293 = load i8, ptr %incdec.ptr1853.2, align 1, !tbaa !38
  %conv1854.3 = zext i8 %293 to i64
  %shl1856.3 = shl nuw nsw i64 %conv1854.3, %indvars.iv.next3886.2
  %add1857.3 = add i64 %shl1856.3, %add1857.2
  %indvars.iv.next3886.3 = add nuw nsw i64 %289, 32
...
do.end1863.loopexit:                              ; preds = %if.end1851.3, %if.end1851.2, %if.end1851.1, %if.end1851
  ...
  %indvars.iv.next3886.lcssa = phi i64 [ %indvars.iv.next3886, %if.end1851 ], [ %indvars.iv.next3886.1, %if.end1851.1 ], [ %indvars.iv.next3886.2, %if.end1851.2 ], [ %indvars.iv.next3886.3, %if.end1851.3 ]
  %294 = trunc i64 %indvars.iv.next3886.lcssa to i32
  br label %do.end1863
...
do.end1863:                                       ; preds = %do.end1863.loopexit, %while.cond1843.preheader
  ...
  %bits.56.lcssa = phi i32 [ %bits.55, %while.cond1843.preheader ], [ %294, %do.end1863.loopexit ]
  %295 = load i64, ptr %total, align 8, !tbaa !17
  %and1865 = and i64 %295, 4294967295
...
sw.epilog1881:                                    ; preds = %if.then1081, %if.then1201, %do.end1729, %if.then1733, %do.body1282, %if.then1303, %if.then1868, %if.then1826, %if.end1740, %if.then1684, %if.then1610, %if.then1440, %if.then1432, %if.then1425, %if.then1264, %if.then1247, %if.then1228, %if.then973, %if.then900, %if.end844, %if.end834, %if.then802, %do.body762, %do.body702, %if.end627, %if.then609, %if.then151, %if.then144, %if.end105, %if.then102, %if.then79, %if.then72, %if.end40, %if.then16
  %next.63 = phi ptr [ %next.60.lcssa, %if.then1868 ], [ %next.57.lcssa, %if.then1826 ], [ %next.0, %if.end1740 ], [ %next.56, %if.then1684 ], [ %next.56, %if.then1733 ], [ %next.56, %do.end1729 ], [ %next.52, %if.then1610 ], [ %206, %if.then1303 ], [ %206, %do.body1282 ], [ %next.45, %if.then1425 ], [ %next.45, %if.then1432 ], [ %next.45, %if.then1440 ], [ %next.33.lcssa, %if.then1228 ], [ %next.33.lcssa, %if.then1247 ], [ %next.33.lcssa, %if.then1264 ], [ %next.30.lcssa, %if.then973 ], [ %next.28.lcssa, %if.then900 ], [ %add.ptr838, %if.end834 ], [ %next.27, %if.end844 ], [ %next.25.lcssa, %if.then802 ], [ %next.23, %do.body702 ], [ %next.24.lcssa, %do.body762 ], [ %next.18.lcssa, %if.then609 ], [ %next.19, %if.end627 ], [ %next.2.lcssa, %if.then144 ], [ %next.2.lcssa, %if.then151 ], [ %next.0, %if.then16 ], [ %next.1.lcssa, %if.end40 ], [ %next.1.lcssa, %if.then72 ], [ %next.1.lcssa, %if.then79 ], [ %next.1.lcssa, %if.then102 ], [ %next.1.lcssa, %if.end105 ], [ %next.38, %if.then1201 ], [ %next.35.lcssa, %if.then1081 ]
  %put.2 = phi ptr [ %put.0, %if.then1868 ], [ %put.0, %if.then1826 ], [ %incdec.ptr1743, %if.end1740 ], [ %put.0, %if.then1684 ], [ %incdec.ptr1725.lcssa, %if.then1733 ], [ %incdec.ptr1725.lcssa, %do.end1729 ], [ %put.0, %if.then1610 ], [ %204, %if.then1303 ], [ %204, %do.body1282 ], [ %put.0, %if.then1425 ], [ %put.0, %if.then1432 ], [ %put.0, %if.then1440 ], [ %put.0, %if.then1228 ], [ %put.0, %if.then1247 ], [ %put.0, %if.then1264 ], [ %put.0, %if.then973 ], [ %put.0, %if.then900 ], [ %add.ptr841, %if.end834 ], [ %put.0, %if.end844 ], [ %put.0, %if.then802 ], [ %put.0, %do.body702 ], [ %put.0, %do.body762 ], [ %put.0, %if.then609 ], [ %put.0, %if.end627 ], [ %put.0, %if.then144 ], [ %put.0, %if.then151 ], [ %put.0, %if.then16 ], [ %put.0, %if.end40 ], [ %put.0, %if.then72 ], [ %put.0, %if.then79 ], [ %put.0, %if.then102 ], [ %put.0, %if.end105 ], [ %put.0, %if.then1201 ], [ %put.0, %if.then1081 ]
  %have.63 = phi i32 [ %have.60.lcssa, %if.then1868 ], [ %have.57.lcssa, %if.then1826 ], [ %have.0, %if.end1740 ], [ %have.56, %if.then1684 ], [ %have.56, %if.then1733 ], [ %have.56, %do.end1729 ], [ %have.52, %if.then1610 ], [ %207, %if.then1303 ], [ %207, %do.body1282 ], [ %have.45, %if.then1425 ], [ %have.45, %if.then1432 ], [ %have.45, %if.then1440 ], [ %have.33.lcssa, %if.then1228 ], [ %have.33.lcssa, %if.then1247 ], [ %have.33.lcssa, %if.then1264 ], [ %have.30.lcssa, %if.then973 ], [ %have.28.lcssa, %if.then900 ], [ %sub836, %if.end834 ], [ %have.27, %if.end844 ], [ %have.25.lcssa, %if.then802 ], [ %have.23, %do.body702 ], [ %have.24.lcssa, %do.body762 ], [ %have.18.lcssa, %if.then609 ], [ %have.19, %if.end627 ], [ %have.2.lcssa, %if.then144 ], [ %have.2.lcssa, %if.then151 ], [ %have.0, %if.then16 ], [ %have.1.lcssa, %if.end40 ], [ %have.1.lcssa, %if.then72 ], [ %have.1.lcssa, %if.then79 ], [ %have.1.lcssa, %if.then102 ], [ %have.1.lcssa, %if.end105 ], [ %have.38, %if.then1201 ], [ %have.35.lcssa, %if.then1081 ]
  %left.1 = phi i32 [ %left.0, %if.then1868 ], [ %left.0, %if.then1826 ], [ %dec1744, %if.end1740 ], [ %left.0, %if.then1684 ], [ %sub1720, %if.then1733 ], [ %sub1720, %do.end1729 ], [ %left.0, %if.then1610 ], [ %205, %if.then1303 ], [ %205, %do.body1282 ], [ %left.0, %if.then1425 ], [ %left.0, %if.then1432 ], [ %left.0, %if.then1440 ], [ %left.0, %if.then1228 ], [ %left.0, %if.then1247 ], [ %left.0, %if.then1264 ], [ %left.0, %if.then973 ], [ %left.0, %if.then900 ], [ %sub839, %if.end834 ], [ %left.0, %if.end844 ], [ %left.0, %if.then802 ], [ %left.0, %do.body702 ], [ %left.0, %do.body762 ], [ %left.0, %if.then609 ], [ %left.0, %if.end627 ], [ %left.0, %if.then144 ], [ %left.0, %if.then151 ], [ %left.0, %if.then16 ], [ %left.0, %if.end40 ], [ %left.0, %if.then72 ], [ %left.0, %if.then79 ], [ %left.0, %if.then102 ], [ %left.0, %if.end105 ], [ %left.0, %if.then1201 ], [ %left.0, %if.then1081 ]
  %hold.59 = phi i64 [ %hold.56.lcssa, %if.then1868 ], [ %hold.53.lcssa, %if.then1826 ], [ %hold.0, %if.end1740 ], [ %hold.52, %if.then1684 ], [ %hold.52, %if.then1733 ], [ %hold.52, %do.end1729 ], [ %shr1596, %if.then1610 ], [ %208, %if.then1303 ], [ %208, %do.body1282 ], [ %shr1408, %if.then1425 ], [ %shr1408, %if.then1432 ], [ %shr1408, %if.then1440 ], [ %hold.29.lcssa, %if.then1228 ], [ %hold.29.lcssa, %if.then1247 ], [ %hold.29.lcssa, %if.then1264 ], [ %hold.26.lcssa, %if.then973 ], [ %shr889, %if.then900 ], [ %hold.23, %if.end834 ], [ %hold.23, %if.end844 ], [ %hold.21.lcssa, %if.then802 ], [ %shr705, %do.body702 ], [ %shr763, %do.body762 ], [ %hold.14.lcssa, %if.then609 ], [ %hold.15, %if.end627 ], [ %hold.2.lcssa, %if.then144 ], [ %hold.2.lcssa, %if.then151 ], [ %hold.0, %if.then16 ], [ 0, %if.end40 ], [ %hold.1.lcssa, %if.then72 ], [ %hold.1.lcssa, %if.then79 ], [ %shr84, %if.then102 ], [ 0, %if.end105 ], [ %hold.34, %if.then1201 ], [ %shr1072, %if.then1081 ]
  %bits.59 = phi i32 [ %bits.56.lcssa, %if.then1868 ], [ %bits.53.lcssa, %if.then1826 ], [ %bits.0, %if.end1740 ], [ %bits.52, %if.then1684 ], [ %bits.52, %if.then1733 ], [ %bits.52, %do.end1729 ], [ %sub1599, %if.then1610 ], [ %209, %if.then1303 ], [ %209, %do.body1282 ], [ %sub1411, %if.then1425 ], [ %sub1411, %if.then1432 ], [ %sub1411, %if.then1440 ], [ %bits.29.lcssa, %if.then1228 ], [ %bits.29.lcssa, %if.then1247 ], [ %bits.29.lcssa, %if.then1264 ], [ %bits.26.lcssa, %if.then973 ], [ %sub890, %if.then900 ], [ %bits.23, %if.end834 ], [ %bits.23, %if.end844 ], [ %bits.21.lcssa, %if.then802 ], [ %sub707, %do.body702 ], [ %sub764, %do.body762 ], [ %bits.14.lcssa, %if.then609 ], [ %bits.15, %if.end627 ], [ %bits.2.lcssa, %if.then144 ], [ %bits.2.lcssa, %if.then151 ], [ %bits.0, %if.then16 ], [ 0, %if.end40 ], [ %bits.1.lcssa, %if.then72 ], [ %bits.1.lcssa, %if.then79 ], [ %sub, %if.then102 ], [ 0, %if.end105 ], [ %bits.34, %if.then1201 ], [ %sub1075, %if.then1081 ]
...
do.body1882.loopexit:                             ; preds = %do.body1157
  %296 = trunc i64 %indvars.iv3907 to i32
  br label %do.body1882

do.body1882.loopexit3653:                         ; preds = %do.body1051
  %297 = trunc i64 %indvars.iv3904 to i32
  br label %do.body1882

do.body1882.loopexit3654:                         ; preds = %do.body1113
  %298 = trunc i64 %indvars.iv3901 to i32
  br label %do.body1882

do.body1882.loopexit3656:                         ; preds = %do.body21.1, %do.body21.preheader
  %indvars.iv3954.lcssa = phi i64 [ %20, %do.body21.preheader ], [ %indvars.iv.next3955, %do.body21.1 ]
  ...
  %299 = trunc i64 %indvars.iv3954.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3657:                         ; preds = %do.body584.1, %do.body584.preheader
  %indvars.iv3951.lcssa = phi i64 [ %102, %do.body584.preheader ], [ %indvars.iv.next3952, %do.body584.1 ]
  ...
  %300 = trunc i64 %indvars.iv3951.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3658:                         ; preds = %do.body318.1, %do.body318.preheader
  %indvars.iv3942.lcssa = phi i64 [ %56, %do.body318.preheader ], [ %indvars.iv.next3943, %do.body318.1 ]
  %hold.83629.lcssa = phi i64 [ %hold.739984007, %do.body318.preheader ], [ %add328, %do.body318.1 ]
  %next.83627.lcssa = phi ptr [ %next.739944009, %do.body318.preheader ], [ %incdec.ptr324, %do.body318.1 ]
  %301 = trunc i64 %indvars.iv3942.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3659:                         ; preds = %do.body255.1, %do.body255.preheader
  %indvars.iv3939.lcssa = phi i64 [ %45, %do.body255.preheader ], [ %indvars.iv.next3940, %do.body255.1 ]
  %hold.63621.lcssa = phi i64 [ %hold.53985, %do.body255.preheader ], [ %add265, %do.body255.1 ]
  %next.63619.lcssa = phi ptr [ %next.53983, %do.body255.preheader ], [ %incdec.ptr261, %do.body255.1 ]
  %302 = trunc i64 %indvars.iv3939.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3660:                         ; preds = %do.body195.3, %do.body195.2, %do.body195.1, %do.body195.preheader
  %indvars.iv3936.lcssa = phi i64 [ %36, %do.body195.preheader ], [ %indvars.iv.next3937, %do.body195.1 ], [ %indvars.iv.next3937.1, %do.body195.2 ], [ %indvars.iv.next3937.2, %do.body195.3 ]
  %hold.43613.lcssa = phi i64 [ %hold.33976, %do.body195.preheader ], [ %add205, %do.body195.1 ], [ %add205.1, %do.body195.2 ], [ %add205.2, %do.body195.3 ]
  %next.43611.lcssa = phi ptr [ %next.33974, %do.body195.preheader ], [ %incdec.ptr201, %do.body195.1 ], [ %incdec.ptr201.1, %do.body195.2 ], [ %incdec.ptr201.2, %do.body195.3 ]
  %303 = trunc i64 %indvars.iv3936.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3661:                         ; preds = %do.body121.1, %do.body121.preheader
  %indvars.iv3933.lcssa = phi i64 [ %18, %do.body121.preheader ], [ %indvars.iv.next3934, %do.body121.1 ]
  ...
  %304 = trunc i64 %indvars.iv3933.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3662:                         ; preds = %do.body638.3, %do.body638.2, %do.body638.1, %do.body638.preheader
  %indvars.iv3930.lcssa = phi i64 [ %17, %do.body638.preheader ], [ %indvars.iv.next3931, %do.body638.1 ], [ %indvars.iv.next3931.1, %do.body638.2 ], [ %indvars.iv.next3931.2, %do.body638.3 ]
  ...
  %305 = trunc i64 %indvars.iv3930.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3663:                         ; preds = %do.body781.3, %do.body781.2, %do.body781.1, %do.body781.preheader
  %indvars.iv3928.lcssa = phi i64 [ %118, %do.body781.preheader ], [ %indvars.iv.next3929, %do.body781.1 ], [ %indvars.iv.next3929.1, %do.body781.2 ], [ %indvars.iv.next3929.2, %do.body781.3 ]
  ...
  %306 = trunc i64 %indvars.iv3928.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3671:                         ; preds = %do.body852.1, %do.body852.preheader
  %indvars.iv3888.lcssa = phi i64 [ %16, %do.body852.preheader ], [ %indvars.iv.next3889, %do.body852.1 ]
  ...
  %307 = trunc i64 %indvars.iv3888.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3672:                         ; preds = %do.body1847.3, %do.body1847.2, %do.body1847.1, %do.body1847.preheader
  %indvars.iv3885.lcssa = phi i64 [ %289, %do.body1847.preheader ], [ %indvars.iv.next3886, %do.body1847.1 ], [ %indvars.iv.next3886.1, %do.body1847.2 ], [ %indvars.iv.next3886.2, %do.body1847.3 ]
  ...
  %308 = trunc i64 %indvars.iv3885.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3673:                         ; preds = %do.body1755.3, %do.body1755.2, %do.body1755.1, %do.body1755.preheader
  %indvars.iv.lcssa = phi i64 [ %273, %do.body1755.preheader ], [ %indvars.iv.next, %do.body1755.1 ], [ %indvars.iv.next.1, %do.body1755.2 ], [ %indvars.iv.next.2, %do.body1755.3 ]
  ...
  %309 = trunc i64 %indvars.iv.lcssa to i32
  br label %do.body1882

do.body1882.loopexit4021:                         ; preds = %do.body1003
  %310 = zext i32 %have.333463 to i64
  %311 = shl i32 %have.333463, 3
  %312 = add i32 %311, %bits.293465
  %scevgep.le = getelementptr i8, ptr %next.333462, i64 %310
  br label %do.body1882

do.body1882.loopexit4022:                         ; preds = %do.body1631
  %313 = shl i32 %have.53, 3
  %314 = add i32 %bits.49, %313
  %315 = zext i32 %have.53 to i64
  %scevgep3927.le = getelementptr i8, ptr %next.53, i64 %315
  br label %do.body1882

do.body1882.loopexit4023:                         ; preds = %do.body1562
  %316 = zext i32 %have.50.lcssa to i64
  %317 = shl i32 %have.50.lcssa, 3
  %318 = add i32 %317, %bits.46.lcssa
  %scevgep3925.le = getelementptr i8, ptr %next.50.lcssa, i64 %316
  br label %do.body1882

do.body1882.loopexit4024:                         ; preds = %do.body1513
  %319 = zext i32 %have.49 to i64
  %320 = shl i32 %have.49, 3
  %321 = add i32 %320, %bits.45
  %scevgep3921.le = getelementptr i8, ptr %next.49, i64 %319
  br label %do.body1882

do.body1882.loopexit4025:                         ; preds = %do.body1459
  %322 = shl i32 %have.46, 3
  %323 = add i32 %bits.42, %322
  %324 = zext i32 %have.46 to i64
  %scevgep3918.le = getelementptr i8, ptr %next.46, i64 %324
  br label %do.body1882

do.body1882.loopexit4026:                         ; preds = %do.body1374
  %325 = zext i32 %have.43.lcssa to i64
  %326 = shl i32 %have.43.lcssa, 3
  %327 = add i32 %326, %bits.39.lcssa
  %scevgep3916.le = getelementptr i8, ptr %next.43.lcssa, i64 %325
  br label %do.body1882

do.body1882.loopexit4027:                         ; preds = %do.body1322
  %328 = zext i32 %have.42 to i64
  %329 = shl i32 %have.42, 3
  %330 = add i32 %329, %bits.38
  %scevgep3912.le = getelementptr i8, ptr %next.42, i64 %328
  br label %do.body1882
...
do.body1882.loopexit4491:                         ; preds = %sw.bb1736, %sw.bb1668, %if.end1267, %if.then822, %if.end805, %sw.bb690, %if.end557, %if.then508, %if.end486, %if.then441, %if.end429, %for.cond
  %left.03853.ph = phi i32 [ 0, %sw.bb1736 ], [ 0, %sw.bb1668 ], [ %left.0, %if.end1267 ], [ %left.0, %if.then822 ], [ %left.0, %if.end805 ], [ %left.0, %sw.bb690 ], [ %left.0, %if.end557 ], [ %left.0, %if.then508 ], [ %left.0, %if.end486 ], [ %left.0, %if.then441 ], [ %left.0, %if.end429 ], [ %left.0, %for.cond ]
...
if.then1908:                                      ; preds = %land.lhs.true1901, %do.body1882
  %sub1911 = sub i32 %out.5, %left.03853
  %333 = load ptr, ptr %state4.i, align 8, !tbaa !13
  %window.i = getelementptr inbounds %struct.inflate_state, ptr %333, i64 0, i32 14
  %334 = load ptr, ptr %window.i, align 8, !tbaa !35
  %cmp.i2907 = icmp eq ptr %334, null
  br i1 %cmp.i2907, label %if.then.i, label %if.end6.i

if.then.i:                                        ; preds = %if.then1908
  %335 = load ptr, ptr %zalloc.i, align 8, !tbaa !5
  %opaque.i = getelementptr inbounds %struct.z_stream_s, ptr %strm, i64 0, i32 10
  %336 = load ptr, ptr %opaque.i, align 8, !tbaa !37
  %wbits.i = getelementptr inbounds %struct.inflate_state, ptr %333, i64 0, i32 10
  %337 = load i32, ptr %wbits.i, align 8, !tbaa !36
  %shl.i = shl nuw i32 1, %337
  %call.i = call ptr %335(ptr noundef %336, i32 noundef %shl.i, i32 noundef 1) #10
...
if.end6.i:                                        ; preds = %if.then.i, %if.then1908
  %338 = phi ptr [ %call.i, %if.then.i ], [ %334, %if.then1908 ]
  %wsize.i = getelementptr inbounds %struct.inflate_state, ptr %333, i64 0, i32 11
  %339 = load i32, ptr %wsize.i, align 4, !tbaa !32
  %cmp7.i = icmp eq i32 %339, 0
  br i1 %cmp7.i, label %if.then8.i, label %if.end12.i

if.then8.i:                                       ; preds = %if.end6.i
  %wbits9.i = getelementptr inbounds %struct.inflate_state, ptr %333, i64 0, i32 10
  %340 = load i32, ptr %wbits9.i, align 8, !tbaa !36
  %shl10.i = shl nuw i32 1, %340
  store i32 %shl10.i, ptr %wsize.i, align 4, !tbaa !32
  %wnext.i = getelementptr inbounds %struct.inflate_state, ptr %333, i64 0, i32 13
  store i32 0, ptr %wnext.i, align 4, !tbaa !34
  %whave.i = getelementptr inbounds %struct.inflate_state, ptr %333, i64 0, i32 12
  store i32 0, ptr %whave.i, align 8, !tbaa !33
  br label %if.end12.i

if.end12.i:                                       ; preds = %if.then8.i, %if.end6.i
  %341 = phi i32 [ %shl10.i, %if.then8.i ], [ %339, %if.end6.i ]
  %cmp14.not.i = icmp ugt i32 %341, %sub1911
  br i1 %cmp14.not.i, label %if.else.i, label %if.then15.i

if.then15.i:                                      ; preds = %if.end12.i
  %idx.ext.i = zext i32 %341 to i64
  %idx.neg.i = sub nsw i64 0, %idx.ext.i
  %add.ptr.i = getelementptr inbounds i8, ptr %put.0, i64 %idx.neg.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %338, ptr noundef nonnull align 1 dereferenceable(1) %add.ptr.i, i64 %idx.ext.i, i1 false)
  %wnext19.i = getelementptr inbounds %struct.inflate_state, ptr %333, i64 0, i32 13
  store i32 0, ptr %wnext19.i, align 4, !tbaa !34
  %342 = load i32, ptr %wsize.i, align 4, !tbaa !32
  %whave21.i = getelementptr inbounds %struct.inflate_state, ptr %333, i64 0, i32 12
  store i32 %342, ptr %whave21.i, align 8, !tbaa !33
  br label %if.end1917

if.else.i:                                        ; preds = %if.end12.i
  %wnext23.i = getelementptr inbounds %struct.inflate_state, ptr %333, i64 0, i32 13
  %343 = load i32, ptr %wnext23.i, align 4, !tbaa !34
  %sub.i = sub i32 %341, %343
  %spec.select.i2909 = call i32 @llvm.umin.i32(i32 %sub.i, i32 %sub1911)
  %idx.ext30.i = zext i32 %343 to i64
  %add.ptr31.i = getelementptr inbounds i8, ptr %338, i64 %idx.ext30.i
...
if.then37.i:                                      ; preds = %if.else.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %344, ptr align 1 %add.ptr41.i, i64 %idx.ext39.i, i1 false)
  store i32 %sub36.i, ptr %wnext23.i, align 4, !tbaa !34
  %345 = load i32, ptr %wsize.i, align 4, !tbaa !32
  %whave45.i = getelementptr inbounds %struct.inflate_state, ptr %333, i64 0, i32 12
  store i32 %345, ptr %whave45.i, align 8, !tbaa !33
  br label %if.end1917

if.else46.i:                                      ; preds = %if.else.i
  %346 = load i32, ptr %wnext23.i, align 4, !tbaa !34
  %add.i = add i32 %346, %spec.select.i2909
  %347 = load i32, ptr %wsize.i, align 4, !tbaa !32
  %cmp50.i = icmp eq i32 %add.i, %347
  %spec.store.select.i = select i1 %cmp50.i, i32 0, i32 %add.i
  store i32 %spec.store.select.i, ptr %wnext23.i, align 4
  %whave55.i = getelementptr inbounds %struct.inflate_state, ptr %333, i64 0, i32 12
  %348 = load i32, ptr %whave55.i, align 8, !tbaa !33
  %cmp57.i = icmp ult i32 %348, %347
  br i1 %cmp57.i, label %if.then59.i, label %if.end1917

if.then59.i:                                      ; preds = %if.else46.i
  %add61.i = add i32 %348, %spec.select.i2909
...
if.end1917:                                       ; preds = %if.then15.i, %if.else46.i, %if.then59.i, %if.then37.i, %land.lhs.true1901, %land.lhs.true1897, %lor.lhs.false1893
  %349 = load i32, ptr %avail_in11, align 8, !tbaa !43
  %sub1919 = sub i32 %11, %349
  %350 = load i32, ptr %avail_out, align 8, !tbaa !44
  %sub1921 = sub i32 %out.5, %350
  %conv1922 = zext i32 %sub1919 to i64
  %total_in = getelementptr inbounds %struct.z_stream_s, ptr %strm, i64 0, i32 2
  %351 = load i64, ptr %total_in, align 8, !tbaa !18
  %add1923 = add i64 %351, %conv1922
  store i64 %add1923, ptr %total_in, align 8, !tbaa !18
  %conv1924 = zext i32 %sub1921 to i64
  %352 = load i64, ptr %total_out, align 8, !tbaa !106
  %add1926 = add i64 %352, %conv1924
  store i64 %add1926, ptr %total_out, align 8, !tbaa !106
  %353 = load i64, ptr %total, align 8, !tbaa !17
  %add1929 = add i64 %353, %conv1924
  store i64 %add1929, ptr %total, align 8, !tbaa !17
  %354 = load i32, ptr %wrap1747, align 8, !tbaa !19
  %and1931 = and i32 %354, 4
  %tobool1932 = icmp ne i32 %and1931, 0
  %tobool1934 = icmp ne i32 %out.5, %350
...
if.then1935:                                      ; preds = %if.end1917
  %355 = load i32, ptr %flags1783, align 8, !tbaa !50
  %tobool1937.not = icmp eq i32 %355, 0
  %356 = load i64, ptr %check1786, align 8, !tbaa !49
  %357 = load ptr, ptr %next_out, align 8, !tbaa !41
  %idx.neg1949 = sub nsw i64 0, %conv1924
  %add.ptr1950 = getelementptr inbounds i8, ptr %357, i64 %idx.neg1949
  br i1 %tobool1937.not, label %cond.false1945, label %cond.true1938

cond.true1938:                                    ; preds = %if.then1935
  %call1944 = call i64 @crc32(i64 noundef %356, ptr noundef %add.ptr1950, i32 noundef %sub1921) #10
  br label %cond.end1952

cond.false1945:                                   ; preds = %if.then1935
  %call1951 = call i64 @adler32(i64 noundef %356, ptr noundef %add.ptr1950, i32 noundef %sub1921) #10
  br label %cond.end1952
...
if.end1956:                                       ; preds = %cond.end1952, %if.end1917
  %358 = load i32, ptr %bits13, align 8, !tbaa !26
  %359 = load i32, ptr %last699, align 4, !tbaa !21
  %tobool1959.not = icmp eq i32 %359, 0
  %cond1960 = select i1 %tobool1959.not, i32 0, i32 64
  %add1961 = add nsw i32 %cond1960, %358
  %360 = load i32, ptr %mode.i, align 8, !tbaa !16
  %cmp1963 = icmp eq i32 %360, 16191
  %cond1965 = select i1 %cmp1963, i32 128, i32 0
  %add1966 = add nsw i32 %add1961, %cond1965
  %cmp1968 = icmp eq i32 %360, 16199
  %cmp1971 = icmp eq i32 %360, 16194
  %361 = or i1 %cmp1968, %cmp1971
  %cond1973 = select i1 %361, i32 256, i32 0
  ...
  %cmp1975 = icmp eq i32 %11, %349
  %cmp1978 = icmp eq i32 %out.5, %350
...
if.end4.if.end20_crit_edge:                       ; preds = %if.end4
  ...
  %.pre108 = load i32, ptr %have21.phi.trans.insert, align 4, !tbaa !109
  br label %if.end20
...
syncsearch.exit:                                  ; preds = %while.body.i, %while.end.thread, %while.end
  ...
  store i32 %got.0.lcssa.i, ptr %have112, align 4, !tbaa !109
...
while.body.i81:                                   ; preds = %while.body.i81, %while.body.preheader.i80
  ...
  %23 = load i8, ptr %arrayidx.i84, align 1, !tbaa !38
  ...
  br i1 %24, label %while.body.i81, label %while.end.loopexit.i97, !llvm.loop !112
...
syncsearch.exit98:                                ; preds = %if.end20, %while.end.loopexit.i97
  ...
  store i32 %got.0.lcssa.i78, ptr %have21, align 4, !tbaa !109
