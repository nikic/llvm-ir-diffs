; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/kimwitu++/gen.cc'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/kimwitu++/gen.cc"
...
@.str.1 = private unnamed_addr constant [59 x i8] c"/home/npopov/repos/llvm-test-suite/CTMark/kimwitu++/gen.cc\00", align 1

; Function Attrs: mustprogress uwtable
define dso_local noundef i32 @_ZN2kc15f_selofoperatorEPNS_7impl_IDE(ptr noundef %oid) local_unnamed_addr #0 {
entry:
  %kc_fe_selvar_1.0216 = load ptr, ptr @Thephylumdeclarations, align 8
  %vtable217 = load ptr, ptr %kc_fe_selvar_1.0216, align 8
...
if.then:                                          ; preds = %land.lhs.true
  %5 = load ptr, ptr %productionblock_1, align 8
  %alternatives_1 = getelementptr inbounds %"class.kc::impl_productionblock_ListAlternatives", ptr %5, i64 0, i32 1
  %kc_fe_selvar_114.0207 = load ptr, ptr %alternatives_1, align 8
  %vtable16208 = load ptr, ptr %kc_fe_selvar_114.0207, align 8
...
while.body20:                                     ; preds = %if.then, %if.end29
  ...
  %7 = load ptr, ptr %alternative_1, align 8
...
if.end29:                                         ; preds = %while.body20, %if.then25
  ...
  %kc_fe_selvar_114.0 = load ptr, ptr %alternatives_130, align 8
  %vtable16 = load ptr, ptr %kc_fe_selvar_114.0, align 8
  ...
  br i1 %cmp19, label %while.body20, label %cleanup124

if.else31:                                        ; preds = %land.lhs.true, %while.body
  %vtable32 = load ptr, ptr %1, align 8
...
land.lhs.true36:                                  ; preds = %if.else31
  ...
  %12 = load ptr, ptr %productionblock_138, align 8
...
if.then43:                                        ; preds = %land.lhs.true36
  %14 = load ptr, ptr %productionblock_138, align 8
  %alternatives_148 = getelementptr inbounds %"class.kc::impl_productionblock_NonlistAlternatives", ptr %14, i64 0, i32 1
  %kc_fe_selvar_149.0198 = load ptr, ptr %alternatives_148, align 8
  %vtable51199 = load ptr, ptr %kc_fe_selvar_149.0198, align 8
...
while.body55:                                     ; preds = %if.then43, %if.end71
  ...
  %16 = load ptr, ptr %alternative_157, align 8
...
if.then62:                                        ; preds = %while.body55
  ...
  %18 = load ptr, ptr %ID_165, align 8
...
if.end71:                                         ; preds = %while.body55, %if.then62
  ...
  %kc_fe_selvar_149.0 = load ptr, ptr %alternatives_172, align 8
  %vtable51 = load ptr, ptr %kc_fe_selvar_149.0, align 8
  ...
  br i1 %cmp54, label %while.body55, label %cleanup124

if.else74:                                        ; preds = %land.lhs.true36, %if.else31
  %vtable75 = load ptr, ptr %1, align 8
...
land.lhs.true79:                                  ; preds = %if.else74
  ...
  %21 = load ptr, ptr %productionblock_181, align 8
...
if.then86:                                        ; preds = %land.lhs.true79
  %23 = load ptr, ptr %productionblock_181, align 8
  %alternatives_191 = getelementptr inbounds %"class.kc::impl_productionblock_PredefinedAlternatives", ptr %23, i64 0, i32 1
  %kc_fe_selvar_192.0190 = load ptr, ptr %alternatives_191, align 8
  %vtable94191 = load ptr, ptr %kc_fe_selvar_192.0190, align 8
...
while.body98:                                     ; preds = %if.then86, %if.end114
  ...
  %25 = load ptr, ptr %alternative_1100, align 8
  %vtable101 = load ptr, ptr %25, align 8
...
if.then105:                                       ; preds = %while.body98
  ...
  %27 = load ptr, ptr %ID_1108, align 8
...
if.end114:                                        ; preds = %while.body98, %if.then105
  ...
  %kc_fe_selvar_192.0 = load ptr, ptr %alternatives_1115, align 8
  %vtable94 = load ptr, ptr %kc_fe_selvar_192.0, align 8
  ...
  br i1 %cmp97, label %while.body98, label %cleanup124
...
cleanup124:                                       ; preds = %if.end114, %if.end71, %if.end29, %if.then86, %if.then43, %if.then
  ...
  br i1 %cmp.not, label %while.body, label %cleanup128.thread.loopexit

cleanup128.thread.loopexit:                       ; preds = %cleanup124
  %30 = add i32 %kc_end.8.ph, 1
  %31 = sub i32 %30, %kc_i.11.ph
...
cleanup128.thread:                                ; preds = %entry, %cleanup128.thread.loopexit, %32
  %33 = phi i32 [ 0, %32 ], [ %31, %cleanup128.thread.loopexit ], [ 1, %entry ]
  ret i32 %33
}
...
while.body:                                       ; preds = %entry, %if.end
  ...
  %vtable = load ptr, ptr %kc_p.013, align 8
...
if.then:                                          ; preds = %while.body
  %vtable2 = load ptr, ptr %kc_p.013, align 8
...
if.end:                                           ; preds = %if.then, %while.body
  %vtable5 = load ptr, ptr %kc_p.013, align 8
