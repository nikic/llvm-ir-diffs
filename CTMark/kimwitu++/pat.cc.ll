; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/kimwitu++/pat.cc'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/kimwitu++/pat.cc"
...
@.str.1 = private unnamed_addr constant [59 x i8] c"/home/npopov/repos/llvm-test-suite/CTMark/kimwitu++/pat.cc\00", align 1
...
entry:
  %vtable = load ptr, ptr %a_patternchains, align 8
...
if.else:                                          ; preds = %entry
  %vtable6 = load ptr, ptr %a_patternchains, align 8
...
entry:
  %vtable = load ptr, ptr %a_patternchain, align 8
  %0 = load ptr, ptr %vtable, align 8
...
if.else:                                          ; preds = %entry
  %vtable4 = load ptr, ptr %a_patternchain, align 8
...
if.else:                                          ; preds = %entry
  %vtable7 = load ptr, ptr %a_patternchain, align 8
...
entry:
  %vtable = load ptr, ptr %a_patternchainitem, align 8
  %0 = load ptr, ptr %vtable, align 8
...
if.else:                                          ; preds = %entry
  %vtable7 = load ptr, ptr %a_patternchainitem, align 8
  %3 = load ptr, ptr %vtable7, align 8
...
if.else16:                                        ; preds = %if.else
  %vtable17 = load ptr, ptr %a_patternchainitem, align 8
...
if.then21:                                        ; preds = %if.else16
  ...
  %7 = load ptr, ptr %outmostpattern_1, align 8
...
entry:
  %vtable = load ptr, ptr %a_outmostpattern, align 8
  %0 = load ptr, ptr %vtable, align 8
...
if.then:                                          ; preds = %entry
  ...
  %1 = load ptr, ptr %Cexpression_1, align 8
  ...
  %2 = load <2 x ptr>, ptr %file.i, align 8
  store <2 x ptr> %2, ptr %file2.i, align 8
  ...
  store i32 %3, ptr %line3.i, align 8
...
if.else:                                          ; preds = %entry
  %vtable6 = load ptr, ptr %a_outmostpattern, align 8
...
if.then10:                                        ; preds = %if.else
  ...
  %5 = load ptr, ptr %Cexpression_113, align 8
...
if.else18:                                        ; preds = %if.else
  %vtable19 = load ptr, ptr %a_outmostpattern, align 8
...
if.then23:                                        ; preds = %if.else18
  ...
  %10 = load ptr, ptr %outmostpattern_1, align 8
...
if.else35:                                        ; preds = %if.else18
  %vtable36 = load ptr, ptr %a_outmostpattern, align 8
...
if.else54:                                        ; preds = %if.else35
  %vtable55 = load ptr, ptr %a_outmostpattern, align 8
...
cleanup.cont116:                                  ; preds = %if.then10, %_ZN2kcL12syn_patternsEPNS_13impl_patternsEPNS_9impl_pathE.exit, %if.then23, %if.then, %if.then78, %if.else93, %if.then88
  %condition.1.ph = phi ptr [ %23, %if.then88 ], [ %23, %if.else93 ], [ %23, %if.then78 ], [ %16, %_ZN2kcL12syn_patternsEPNS_13impl_patternsEPNS_9impl_pathE.exit ], [ %call26, %if.then23 ], [ %5, %if.then10 ], [ %1, %if.then ]
  %result.3.ph = phi ptr [ %call92, %if.then88 ], [ %call100, %if.else93 ], [ %call82, %if.then78 ], [ %call53, %_ZN2kcL12syn_patternsEPNS_13impl_patternsEPNS_9impl_pathE.exit ], [ %call34, %if.then23 ], [ %call17, %if.then10 ], [ %call5, %if.then ]
  %vtable117 = load ptr, ptr %condition.1.ph, align 8
...
cleanup124:                                       ; preds = %if.else108, %if.else102, %cleanup.cont116, %if.then120
  %retval.3 = phi ptr [ %result.3.ph, %if.then120 ], [ %result.3.ph, %cleanup.cont116 ], [ null, %if.else102 ], [ null, %if.else108 ]
  ret ptr %retval.3
}
...
entry:
  %vtable = load ptr, ptr %a_outmostpatterns, align 8
  %0 = load ptr, ptr %vtable, align 8
...
if.else:                                          ; preds = %entry
  %vtable6 = load ptr, ptr %a_outmostpatterns, align 8
...
entry:
  ...
  %0 = load <2 x ptr>, ptr %file, align 8
  store <2 x ptr> %0, ptr %file2, align 8
...
entry:
  %0 = load ptr, ptr @Thebindingidmarks, align 8
...
while.body:                                       ; preds = %while.cond.preheader, %while.body
  ...
  %2 = load ptr, ptr %bindingidmark_1, align 8
  ...
  %3 = load ptr, ptr %bindingidmarks_1, align 8
...
entry:
  %vtable = load ptr, ptr %a_patternreps, align 8
  %0 = load ptr, ptr %vtable, align 8
...
if.then:                                          ; preds = %entry
  ...
  %1 = load ptr, ptr %patternrepresentation_1, align 8
  %patternrepresentations_1 = getelementptr inbounds %"class.kc::impl_patternrepresentations", ptr %a_patternreps, i64 0, i32 2
  %2 = load ptr, ptr %patternrepresentations_1, align 8
  %3 = load ptr, ptr @Thebindingidmarks, align 8
...
while.cond.preheader.i:                           ; preds = %if.then
  %vtable3.i = load ptr, ptr %3, align 8
...
while.body.i:                                     ; preds = %while.cond.preheader.i, %while.body.i
  ...
  br i1 %cmp.i, label %while.body.i, label %_ZN2kc21v_resetbindingidmarksEv.exit
...
if.else:                                          ; preds = %entry
  %vtable6 = load ptr, ptr %a_patternreps, align 8
...
entry:
  %vtable = load ptr, ptr %a_patternrep, align 8
  %0 = load ptr, ptr %vtable, align 8
...
_ZN2kc17f_bindingidmarkedEPNS_7impl_IDE.exit.i:   ; preds = %if.then.i
  ...
  %6 = load ptr, ptr %uniqID_1.i.i, align 8
  ...
  %7 = load i8, ptr %marked.i.i, align 8
...
if.then4.i:                                       ; preds = %_ZN2kc17f_bindingidmarkedEPNS_7impl_IDE.exit.i, %_ZN2kc17f_bindingidmarkedEPNS_7impl_IDE.exit.thread.i
  %vtable.i33.i = load ptr, ptr %4, align 8
  ...
  br i1 %cmp.i35.i, label %if.then.i37.i, label %if.else.i36.i

if.then.i37.i:                                    ; preds = %if.then4.i
  %uniqID_1.i38.i = getelementptr inbounds %"class.kc::impl_ID_Id", ptr %4, i64 0, i32 1
  %9 = load ptr, ptr %uniqID_1.i38.i, align 8
  %call3.i39.i = tail call noundef ptr @_ZN2kc13BindingIdMarkEPNS_11impl_uniqIDE(ptr noundef %9)
  %marked.i40.i = getelementptr inbounds %"class.kc::impl_bindingidmark", ptr %call3.i39.i, i64 0, i32 1
  store i8 1, ptr %marked.i40.i, align 8
  br label %_ZN2kc15v_markbindingidEPNS_7impl_IDE.exit.i

if.else.i36.i:                                    ; preds = %if.then4.i
  tail call void @_ZN2kc21kc_no_default_in_withEPKciS1_(ptr noundef nonnull @.str.7, i32 noundef 451, ptr noundef nonnull @.str.1)
  br label %_ZN2kc15v_markbindingidEPNS_7impl_IDE.exit.i

_ZN2kc15v_markbindingidEPNS_7impl_IDE.exit.i:     ; preds = %if.else.i36.i, %if.then.i37.i
...
if.else7.i:                                       ; preds = %if.then
  %vtable8.i = load ptr, ptr %1, align 8
...
if.then12.i:                                      ; preds = %if.else7.i
  ...
  %11 = load ptr, ptr %ID_115.i, align 8
  %vtable.i41.i = load ptr, ptr %11, align 8
...
_ZN2kc17f_bindingidmarkedEPNS_7impl_IDE.exit51.i: ; preds = %if.then12.i
  %uniqID_1.i47.i = getelementptr inbounds %"class.kc::impl_ID_Id", ptr %11, i64 0, i32 1
  %13 = load ptr, ptr %uniqID_1.i47.i, align 8
  %call3.i48.i = tail call noundef ptr @_ZN2kc13BindingIdMarkEPNS_11impl_uniqIDE(ptr noundef %13)
  %marked.i49.i = getelementptr inbounds %"class.kc::impl_bindingidmark", ptr %call3.i48.i, i64 0, i32 1
  %14 = load i8, ptr %marked.i49.i, align 8
  %tobool.i50.not.i = icmp eq i8 %14, 0
  br i1 %tobool.i50.not.i, label %if.then17.i, label %if.else19.i
...
if.then17.i:                                      ; preds = %_ZN2kc17f_bindingidmarkedEPNS_7impl_IDE.exit51.i, %_ZN2kc17f_bindingidmarkedEPNS_7impl_IDE.exit51.thread.i
  %vtable.i52.i = load ptr, ptr %11, align 8
  ...
  br i1 %cmp.i54.i, label %if.then.i56.i, label %if.else.i55.i

if.then.i56.i:                                    ; preds = %if.then17.i
  %uniqID_1.i57.i = getelementptr inbounds %"class.kc::impl_ID_Id", ptr %11, i64 0, i32 1
  %16 = load ptr, ptr %uniqID_1.i57.i, align 8
  %call3.i58.i = tail call noundef ptr @_ZN2kc13BindingIdMarkEPNS_11impl_uniqIDE(ptr noundef %16)
  %marked.i59.i = getelementptr inbounds %"class.kc::impl_bindingidmark", ptr %call3.i58.i, i64 0, i32 1
  store i8 1, ptr %marked.i59.i, align 8
...
_ZN2kc15v_markbindingidEPNS_7impl_IDE.exit60.i:   ; preds = %if.else.i55.i, %if.then.i56.i
...
if.else:                                          ; preds = %entry
  %vtable5 = load ptr, ptr %a_patternrep, align 8
...
entry:
  %vtable33 = load ptr, ptr %a_patternreps, align 8
...
while.cond7.preheader:                            ; preds = %if.then
  %vtable829 = load ptr, ptr %rc, align 8
...
while.cond.preheader.i.i:                         ; preds = %while.body12
  %vtable3.i.i = load ptr, ptr %4, align 8
...
while.body.i.i:                                   ; preds = %while.cond.preheader.i.i, %while.body.i.i
  ...
  br i1 %cmp.i.i, label %while.body.i.i, label %_ZN2kc21v_resetbindingidmarksEv.exit.i
...
_ZN2kc21v_resetbindingidmarksEv.exit.i:           ; preds = %while.body.i.i, %while.cond.preheader.i.i, %while.body12
  ...
  %9 = load ptr, ptr @Thebindingidmarks, align 8
  %tobool.not.i1.i = icmp eq ptr %9, null
  br i1 %tobool.not.i1.i, label %_ZN2kcL14f_get_bindingsEPNS_26impl_patternrepresentationE.exit, label %while.cond.preheader.i2.i

while.cond.preheader.i2.i:                        ; preds = %_ZN2kc21v_resetbindingidmarksEv.exit.i
  %vtable3.i3.i = load ptr, ptr %9, align 8
  %10 = load ptr, ptr %vtable3.i3.i, align 8
  %call4.i4.i = tail call noundef i32 %10(ptr noundef nonnull align 8 dereferenceable(24) %9)
  %cmp5.i5.i = icmp eq i32 %call4.i4.i, 337
  br i1 %cmp5.i5.i, label %while.body.i6.i, label %_ZN2kcL14f_get_bindingsEPNS_26impl_patternrepresentationE.exit

while.body.i6.i:                                  ; preds = %while.cond.preheader.i2.i, %while.body.i6.i
  %kc_fe_selvar_1.06.i7.i = phi ptr [ %12, %while.body.i6.i ], [ %9, %while.cond.preheader.i2.i ]
  %bindingidmark_1.i8.i = getelementptr inbounds %"class.kc::impl_bindingidmarks", ptr %kc_fe_selvar_1.06.i7.i, i64 0, i32 1
  %11 = load ptr, ptr %bindingidmark_1.i8.i, align 8
  %marked.i9.i = getelementptr inbounds %"class.kc::impl_bindingidmark", ptr %11, i64 0, i32 1
  store i8 0, ptr %marked.i9.i, align 8
  %bindingidmarks_1.i10.i = getelementptr inbounds %"class.kc::impl_bindingidmarks", ptr %kc_fe_selvar_1.06.i7.i, i64 0, i32 2
  %12 = load ptr, ptr %bindingidmarks_1.i10.i, align 8
  %vtable.i11.i = load ptr, ptr %12, align 8
  %13 = load ptr, ptr %vtable.i11.i, align 8
  %call.i12.i = tail call noundef i32 %13(ptr noundef nonnull align 8 dereferenceable(24) %12)
  %cmp.i13.i = icmp eq i32 %call.i12.i, 337
  br i1 %cmp.i13.i, label %while.body.i6.i, label %_ZN2kcL14f_get_bindingsEPNS_26impl_patternrepresentationE.exit

_ZN2kcL14f_get_bindingsEPNS_26impl_patternrepresentationE.exit: ; preds = %while.body.i6.i, %_ZN2kc21v_resetbindingidmarksEv.exit.i, %while.cond.preheader.i2.i
  ...
  %14 = load ptr, ptr %rewriteinfo, align 8
  ...
  br i1 %cmp11, label %while.body12, label %if.end18
...
if.end18:                                         ; preds = %_ZN2kcL14f_get_bindingsEPNS_26impl_patternrepresentationE.exit, %while.cond7.preheader, %if.then, %while.body
  ...
  %17 = load ptr, ptr %patternrepresentations_1, align 8
...
entry:
  %vtable = load ptr, ptr %old_rules, align 8
  %0 = load ptr, ptr %vtable, align 8
...
land.lhs.true.i:                                  ; preds = %if.then
  %vtable3.i = load ptr, ptr %new_rule, align 8
  %4 = load ptr, ptr %vtable3.i, align 8
...
if.else8:                                         ; preds = %entry
  %vtable9 = load ptr, ptr %old_rules, align 8
...
entry:
  %vtable38 = load ptr, ptr %a_patternrep, align 8
...
if.else20:                                        ; preds = %tailrecurse.backedge, %entry
  ...
  %vtable21 = load ptr, ptr %a_patternrep.tr.lcssa, align 8
...
entry:
  ...
  %vtable50 = load ptr, ptr %a_patternreps, align 8
...
while.body.i.i:                                   ; preds = %while.cond.preheader.i.i, %while.body.i.i
  ...
  %bindingidmark_1.i.i = getelementptr inbounds %"class.kc::impl_bindingidmarks", ptr %kc_fe_selvar_1.06.i.i, i64 0, i32 1
  %5 = load ptr, ptr %bindingidmark_1.i.i, align 8
  %marked.i.i = getelementptr inbounds %"class.kc::impl_bindingidmark", ptr %5, i64 0, i32 1
  store i8 0, ptr %marked.i.i, align 8
  %bindingidmarks_1.i.i = getelementptr inbounds %"class.kc::impl_bindingidmarks", ptr %kc_fe_selvar_1.06.i.i, i64 0, i32 2
  %6 = load ptr, ptr %bindingidmarks_1.i.i, align 8
...
_ZN2kc21v_resetbindingidmarksEv.exit.i:           ; preds = %while.body.i.i, %while.cond.preheader.i.i, %if.then
  ...
  %8 = load ptr, ptr @Thebindingidmarks, align 8
  %tobool.not.i1.i = icmp eq ptr %8, null
  br i1 %tobool.not.i1.i, label %_ZN2kcL14f_get_bindingsEPNS_26impl_patternrepresentationE.exit, label %while.cond.preheader.i2.i

while.cond.preheader.i2.i:                        ; preds = %_ZN2kc21v_resetbindingidmarksEv.exit.i
  %vtable3.i3.i = load ptr, ptr %8, align 8
  %9 = load ptr, ptr %vtable3.i3.i, align 8
  %call4.i4.i = tail call noundef i32 %9(ptr noundef nonnull align 8 dereferenceable(24) %8)
  %cmp5.i5.i = icmp eq i32 %call4.i4.i, 337
  br i1 %cmp5.i5.i, label %while.body.i6.i, label %_ZN2kcL14f_get_bindingsEPNS_26impl_patternrepresentationE.exit

while.body.i6.i:                                  ; preds = %while.cond.preheader.i2.i, %while.body.i6.i
  %kc_fe_selvar_1.06.i7.i = phi ptr [ %11, %while.body.i6.i ], [ %8, %while.cond.preheader.i2.i ]
  %bindingidmark_1.i8.i = getelementptr inbounds %"class.kc::impl_bindingidmarks", ptr %kc_fe_selvar_1.06.i7.i, i64 0, i32 1
  %10 = load ptr, ptr %bindingidmark_1.i8.i, align 8
  %marked.i9.i = getelementptr inbounds %"class.kc::impl_bindingidmark", ptr %10, i64 0, i32 1
  store i8 0, ptr %marked.i9.i, align 8
  %bindingidmarks_1.i10.i = getelementptr inbounds %"class.kc::impl_bindingidmarks", ptr %kc_fe_selvar_1.06.i7.i, i64 0, i32 2
  %11 = load ptr, ptr %bindingidmarks_1.i10.i, align 8
  %vtable.i11.i = load ptr, ptr %11, align 8
  %12 = load ptr, ptr %vtable.i11.i, align 8
  %call.i12.i = tail call noundef i32 %12(ptr noundef nonnull align 8 dereferenceable(24) %11)
  %cmp.i13.i = icmp eq i32 %call.i12.i, 337
  br i1 %cmp.i13.i, label %while.body.i6.i, label %_ZN2kcL14f_get_bindingsEPNS_26impl_patternrepresentationE.exit
...
cleanup21:                                        ; preds = %_ZN2kcL14f_get_bindingsEPNS_26impl_patternrepresentationE.exit, %if.else
  ...
  %14 = load ptr, ptr %patternrepresentations_1, align 8
  ...
  br i1 %cmp.not, label %while.body, label %cleanup24
...
entry:
  %vtable = load ptr, ptr %old_cases, align 8
  %0 = load ptr, ptr %vtable, align 8
...
land.lhs.true.i:                                  ; preds = %if.then
  %vtable3.i = load ptr, ptr %new_case, align 8
  %4 = load ptr, ptr %vtable3.i, align 8
...
if.else8:                                         ; preds = %entry
  %vtable9 = load ptr, ptr %old_cases, align 8
  %7 = load ptr, ptr %vtable9, align 8
...
while.cond7.preheader:                            ; preds = %if.then
  %vtable829 = load ptr, ptr %uc, align 8
  %2 = load ptr, ptr %vtable829, align 8
...
while.body12:                                     ; preds = %while.body12.lr.ph, %_ZN2kcL14f_get_bindingsEPNS_26impl_patternrepresentationE.exit
  ...
  %3 = load ptr, ptr %unparseclause_1, align 8
  %call13 = tail call fastcc noundef ptr @_ZN2kcL16f_get_predicatesEPNS_26impl_patternrepresentationE(ptr noundef %1)
  %4 = load ptr, ptr @Thebindingidmarks, align 8
  %tobool.not.i.i = icmp eq ptr %4, null
  br i1 %tobool.not.i.i, label %_ZN2kc21v_resetbindingidmarksEv.exit.i, label %while.cond.preheader.i.i
...
_ZN2kcL14f_get_bindingsEPNS_26impl_patternrepresentationE.exit: ; preds = %while.body.i6.i, %_ZN2kc21v_resetbindingidmarksEv.exit.i, %while.cond.preheader.i2.i
  ...
  %14 = load ptr, ptr %unparseinfo, align 8
...
entry:
  %vtable = load ptr, ptr %old_decls, align 8
  %0 = load ptr, ptr %vtable, align 8
...
land.lhs.true.i:                                  ; preds = %if.then
  %vtable3.i = load ptr, ptr %new_decl, align 8
  %4 = load ptr, ptr %vtable3.i, align 8
...
if.else8:                                         ; preds = %entry
  %vtable9 = load ptr, ptr %old_decls, align 8
  %7 = load ptr, ptr %vtable9, align 8
...
entry:
  %vtable = load ptr, ptr %a_withcaseinfo1, align 8
  %0 = load ptr, ptr %vtable, align 8
...
land.lhs.true:                                    ; preds = %entry
  %vtable3 = load ptr, ptr %a_withcaseinfo2, align 8
  %1 = load ptr, ptr %vtable3, align 8
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %3 = load ptr, ptr %patternrepresentation_19, align 8
...
entry:
  %vtable82 = load ptr, ptr %pr1, align 8
...
land.rhs:                                         ; preds = %entry, %cleanup24
  ...
  %vtable1 = load ptr, ptr %kc_fe_selvar_2.085, align 8
...
while.body:                                       ; preds = %land.rhs
  ...
  %2 = load ptr, ptr %elem_patternrepresentation_1, align 8
  ...
  %3 = load ptr, ptr %elem_patternrepresentation_15, align 8
...
if.else19.i:                                      ; preds = %land.lhs.true12.i, %if.else.i
  %vtable20.i = load ptr, ptr %2, align 8
...
if.else31.i:                                      ; preds = %land.lhs.true24.i, %if.else19.i
  %vtable32.i = load ptr, ptr %2, align 8
...
land.lhs.true36.i:                                ; preds = %if.else31.i
  %vtable37.i = load ptr, ptr %3, align 8
...
if.else43.i:                                      ; preds = %land.lhs.true36.i, %if.else31.i
  %vtable44.i = load ptr, ptr %2, align 8
...
land.lhs.true48.i:                                ; preds = %if.else43.i
  %vtable49.i = load ptr, ptr %3, align 8
...
if.else55.i:                                      ; preds = %land.lhs.true48.i, %if.else43.i
  %vtable56.i = load ptr, ptr %2, align 8
...
land.lhs.true60.i:                                ; preds = %if.else55.i
  %vtable61.i = load ptr, ptr %3, align 8
...
if.else67.i:                                      ; preds = %land.lhs.true60.i, %if.else55.i
  %vtable68.i = load ptr, ptr %2, align 8
...
land.lhs.true72.i:                                ; preds = %if.else67.i
  %vtable73.i = load ptr, ptr %3, align 8
...
if.else79.i:                                      ; preds = %land.lhs.true72.i, %if.else67.i
  %vtable80.i = load ptr, ptr %2, align 8
...
land.lhs.true84.i:                                ; preds = %if.else79.i
  %vtable85.i = load ptr, ptr %3, align 8
...
if.else91.i:                                      ; preds = %land.lhs.true84.i, %if.else79.i
  %vtable92.i = load ptr, ptr %2, align 8
...
land.lhs.true96.i:                                ; preds = %if.else91.i
  %vtable97.i = load ptr, ptr %3, align 8
...
if.else106.i:                                     ; preds = %land.lhs.true96.i, %if.else91.i
  %vtable107.i = load ptr, ptr %2, align 8
...
land.lhs.true111.i:                               ; preds = %if.else106.i
  %vtable112.i = load ptr, ptr %3, align 8
...
if.else124.i:                                     ; preds = %land.lhs.true111.i, %if.else106.i
  %vtable125.i = load ptr, ptr %2, align 8
...
land.lhs.true129.i:                               ; preds = %if.else124.i
  %vtable130.i = load ptr, ptr %3, align 8
...
if.else142.i:                                     ; preds = %land.lhs.true129.i, %if.else124.i
  %vtable143.i = load ptr, ptr %2, align 8
...
land.lhs.true147.i:                               ; preds = %if.else142.i
  %vtable148.i = load ptr, ptr %3, align 8
...
if.else160.i:                                     ; preds = %land.lhs.true147.i, %if.else142.i
  %vtable161.i = load ptr, ptr %2, align 8
...
land.lhs.true165.i:                               ; preds = %if.else160.i
  %vtable166.i = load ptr, ptr %3, align 8
...
if.else178.i:                                     ; preds = %land.lhs.true165.i, %if.else160.i
  %vtable179.i = load ptr, ptr %2, align 8
...
land.lhs.true183.i:                               ; preds = %if.else178.i
  %vtable184.i = load ptr, ptr %3, align 8
...
if.else196.i:                                     ; preds = %land.lhs.true183.i, %if.else178.i
  %vtable197.i = load ptr, ptr %2, align 8
...
land.lhs.true201.i:                               ; preds = %if.else196.i
  %vtable202.i = load ptr, ptr %3, align 8
...
if.else214.i:                                     ; preds = %land.lhs.true201.i, %if.else196.i
  %vtable215.i = load ptr, ptr %2, align 8
...
land.lhs.true219.i:                               ; preds = %if.else214.i
  %vtable220.i = load ptr, ptr %3, align 8
...
if.else232.i:                                     ; preds = %land.lhs.true219.i, %if.else214.i
  %vtable233.i = load ptr, ptr %2, align 8
...
land.lhs.true237.i:                               ; preds = %if.else232.i
  %vtable238.i = load ptr, ptr %3, align 8
...
if.else250.i:                                     ; preds = %land.lhs.true237.i, %if.else232.i
  %vtable251.i = load ptr, ptr %2, align 8
...
land.lhs.true255.i:                               ; preds = %if.else250.i
  %vtable256.i = load ptr, ptr %3, align 8
...
if.else268.i:                                     ; preds = %land.lhs.true255.i, %if.else250.i
  %vtable269.i = load ptr, ptr %2, align 8
...
land.lhs.true273.i:                               ; preds = %if.else268.i
  %vtable274.i = load ptr, ptr %3, align 8
...
if.else286.i:                                     ; preds = %land.lhs.true273.i, %if.else268.i
  %vtable287.i = load ptr, ptr %2, align 8
...
land.lhs.true291.i:                               ; preds = %if.else286.i
  %vtable292.i = load ptr, ptr %3, align 8
...
if.else304.i:                                     ; preds = %land.lhs.true291.i, %if.else286.i
  %vtable305.i = load ptr, ptr %2, align 8
...
land.lhs.true309.i:                               ; preds = %if.else304.i
  %vtable310.i = load ptr, ptr %3, align 8
...
if.else319.i:                                     ; preds = %land.lhs.true309.i, %if.else304.i
  %vtable320.i = load ptr, ptr %2, align 8
...
land.lhs.true324.i:                               ; preds = %if.else319.i
  %vtable325.i = load ptr, ptr %3, align 8
...
if.else331.i:                                     ; preds = %land.lhs.true324.i, %if.else319.i
  %vtable332.i = load ptr, ptr %2, align 8
...
land.lhs.true336.i:                               ; preds = %if.else331.i
  %vtable337.i = load ptr, ptr %3, align 8
...
if.else343.i:                                     ; preds = %land.lhs.true336.i, %if.else331.i
  %vtable344.i = load ptr, ptr %2, align 8
...
if.else350.i:                                     ; preds = %if.else343.i
  %vtable351.i = load ptr, ptr %2, align 8
...
if.else357.i:                                     ; preds = %if.else350.i
  %vtable358.i = load ptr, ptr %2, align 8
...
if.else364.i:                                     ; preds = %if.else357.i
  %vtable365.i = load ptr, ptr %2, align 8
...
if.else371.i:                                     ; preds = %if.else364.i
  %vtable372.i = load ptr, ptr %2, align 8
...
if.else378.i:                                     ; preds = %if.else371.i
  %vtable379.i = load ptr, ptr %3, align 8
...
if.else385.i:                                     ; preds = %if.else378.i
  %vtable386.i = load ptr, ptr %3, align 8
...
if.else392.i:                                     ; preds = %if.else385.i
  %vtable393.i = load ptr, ptr %3, align 8
...
if.else399.i:                                     ; preds = %if.else392.i
  %vtable400.i = load ptr, ptr %3, align 8
...
if.else406.i:                                     ; preds = %if.else399.i
  %vtable407.i = load ptr, ptr %3, align 8
...
_ZN2kcL32equal_elem_patternrepresentationEPNS_31impl_elem_patternrepresentationES1_.exit: ; preds = %if.then.i, %if.then17.i, %if.then29.i, %if.then41.i, %if.then53.i, %if.then65.i, %if.then77.i, %if.then89.i, %if.then101.i, %if.then116.i, %if.then134.i, %if.then152.i, %if.then170.i, %if.then188.i, %if.then206.i, %if.then224.i, %if.then242.i, %if.then260.i, %if.then278.i, %if.then296.i, %if.then314.i, %if.then329.i, %if.then341.i, %if.then348.i, %if.then355.i, %if.then362.i, %if.then369.i, %if.then376.i, %if.then383.i, %if.then390.i, %if.then397.i, %if.then404.i, %if.then411.i, %if.else413.i
  ...
  %vtable8 = load ptr, ptr %retval.0.i, align 8
...
cleanup:                                          ; preds = %_ZN2kcL32equal_elem_patternrepresentationEPNS_31impl_elem_patternrepresentationES1_.exit
  %vtable12 = load ptr, ptr %retval.0.i, align 8
...
cleanup24:                                        ; preds = %cleanup
  ...
  %88 = load ptr, ptr %patternrepresentation_1, align 8
  %patternrepresentation_123 = getelementptr inbounds %"class.kc::impl_patternrepresentation", ptr %kc_fe_selvar_2.085, i64 0, i32 2
  %89 = load ptr, ptr %patternrepresentation_123, align 8
  %vtable = load ptr, ptr %88, align 8
...
while.end:                                        ; preds = %land.rhs, %cleanup24, %entry
  ...
  %vtable31 = load ptr, ptr %kc_fe_selvar_1.0.lcssa, align 8
...
land.lhs.true:                                    ; preds = %while.end
  %vtable35 = load ptr, ptr %kc_fe_selvar_2.0.lcssa, align 8
...
if.else40:                                        ; preds = %land.lhs.true, %while.end
  %vtable41 = load ptr, ptr %kc_fe_selvar_1.0.lcssa, align 8
...
if.else46:                                        ; preds = %if.else40
  %vtable47 = load ptr, ptr %kc_fe_selvar_2.0.lcssa, align 8
...
entry:
  %vtable = load ptr, ptr %rri, align 8
  %0 = load ptr, ptr %vtable, align 8
...
_ZN2kc27warn_drop_identical_patternEPNS_26impl_patternrepresentationE.exit: ; preds = %if.then
  ...
  %3 = load ptr, ptr %elem_patternrepresentation_1.i, align 8
...
entry:
  %vtable = load ptr, ptr %pr, align 8
  %0 = load ptr, ptr %vtable, align 8
...
entry:
  %vtable = load ptr, ptr %wci, align 8
  %0 = load ptr, ptr %vtable, align 8
...
entry:
  %vtable = load ptr, ptr %udi, align 8
  %0 = load ptr, ptr %vtable, align 8
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %vtable22 = load ptr, ptr %rri, align 8
...
while.body:                                       ; preds = %if.end, %if.end13
  ...
  %3 = load ptr, ptr %rewriteruleinfo_1, align 8
...
if.then10:                                        ; preds = %while.body
  ...
  %5 = load ptr, ptr %patternrepresentation_1, align 8
...
while.end:                                        ; preds = %if.end13, %if.end
  ...
  %vtable.i = load ptr, ptr %prs.0.lcssa, align 8
...
lor.lhs.false.i:                                  ; preds = %while.end
  ...
  %9 = load ptr, ptr %patternrepresentations_1.i, align 8
  %vtable1.i = load ptr, ptr %9, align 8
...
while.cond.preheader.i:                           ; preds = %lor.lhs.false.i
  %11 = load ptr, ptr %patternrepresentations_1.i, align 8
  %vtable533.i = load ptr, ptr %11, align 8
...
while.cond9.preheader.i:                          ; preds = %while.cond.preheader.i, %while.end.i
  ...
  %kc_fe_selvar_1.027.i = load ptr, ptr %patternrepresentations_1437.i, align 8
  %vtable1028.i = load ptr, ptr %kc_fe_selvar_1.027.i, align 8
...
while.body13.i:                                   ; preds = %while.body13.i, %while.body13.lr.ph.i
  ...
  %14 = load ptr, ptr %patternrepresentation_1.i, align 8
  %15 = load ptr, ptr %patternrepresentation_114.i, align 8
  ...
  %kc_fe_selvar_1.0.i = load ptr, ptr %patternrepresentations_115.i, align 8
  %vtable10.i = load ptr, ptr %kc_fe_selvar_1.0.i, align 8
...
while.end.i:                                      ; preds = %while.body13.i, %while.cond9.preheader.i
  ...
  br i1 %call7.i, label %_ZN2kc14check_patternsEPNS_27impl_patternrepresentationsE.exit, label %while.cond9.preheader.i
...
entry:
  %vtable = load ptr, ptr %prs, align 8
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %1 = load ptr, ptr %patternrepresentations_1, align 8
...
while.cond.preheader:                             ; preds = %lor.lhs.false
  %3 = load ptr, ptr %patternrepresentations_1, align 8
  %vtable533 = load ptr, ptr %3, align 8
...
while.cond9.preheader:                            ; preds = %while.cond.preheader, %while.end
  ...
  %kc_fe_selvar_1.027 = load ptr, ptr %patternrepresentations_1437, align 8
  %vtable1028 = load ptr, ptr %kc_fe_selvar_1.027, align 8
...
while.body13:                                     ; preds = %while.body13.lr.ph, %while.body13
  ...
  %6 = load ptr, ptr %patternrepresentation_1, align 8
  %7 = load ptr, ptr %patternrepresentation_114, align 8
  ...
  %kc_fe_selvar_1.0 = load ptr, ptr %patternrepresentations_115, align 8
...
while.end:                                        ; preds = %while.body13, %while.cond9.preheader
  ...
  br i1 %call7, label %return, label %while.cond9.preheader
...
entry:
  ...
  %vtable17 = load ptr, ptr %wcs, align 8
...
if.then:                                          ; preds = %while.body
  ...
  %3 = load ptr, ptr %patternrepresentation_1, align 8
...
if.end:                                           ; preds = %while.body, %if.then
  ...
  %4 = load ptr, ptr %withcasesinfo_1, align 8
...
while.end:                                        ; preds = %if.end, %entry
  ...
  %vtable8 = load ptr, ptr %prs.0.lcssa, align 8
...
lor.lhs.false.i:                                  ; preds = %while.end
  ...
  %8 = load ptr, ptr %patternrepresentations_1.i, align 8
  %vtable1.i = load ptr, ptr %8, align 8
  %vfn2.i = getelementptr inbounds ptr, ptr %vtable1.i, i64 11
...
while.cond.preheader.i:                           ; preds = %lor.lhs.false.i
  %10 = load ptr, ptr %patternrepresentations_1.i, align 8
  %vtable533.i = load ptr, ptr %10, align 8
  %vfn634.i = getelementptr inbounds ptr, ptr %vtable533.i, i64 11
...
while.body13.i:                                   ; preds = %while.body13.i, %while.body13.lr.ph.i
  %kc_fe_selvar_1.031.i = phi ptr [ %kc_fe_selvar_1.027.i, %while.body13.lr.ph.i ], [ %kc_fe_selvar_1.0.i, %while.body13.i ]
  %patternrepresentation_1.i = getelementptr inbounds %"class.kc::impl_patternrepresentations", ptr %kc_fe_selvar_1.031.i, i64 0, i32 1
  %13 = load ptr, ptr %patternrepresentation_1.i, align 8
  %14 = load ptr, ptr %patternrepresentation_114.i, align 8
...
while.end.i:                                      ; preds = %while.body13.i, %while.cond9.preheader.i
  %16 = load ptr, ptr %patternrepresentations_1437.i, align 8
  %patternrepresentations_14.i = getelementptr inbounds %"class.kc::impl_patternrepresentations", ptr %16, i64 0, i32 2
  %17 = load ptr, ptr %patternrepresentations_14.i, align 8
  %vtable5.i = load ptr, ptr %17, align 8
  %vfn6.i = getelementptr inbounds ptr, ptr %vtable5.i, i64 11
...
if.end:                                           ; preds = %if.then, %entry
  %call4 = tail call noundef ptr @_ZN2kc25NilpatternrepresentationsEv()
  %vtable22 = load ptr, ptr %udi, align 8
  %2 = load ptr, ptr %vtable22, align 8
...
while.body:                                       ; preds = %if.end, %if.end13
  ...
  %3 = load ptr, ptr %unparsedeclinfo_1, align 8
  %vtable6 = load ptr, ptr %3, align 8
  %4 = load ptr, ptr %vtable6, align 8
  %call8 = tail call noundef i32 %4(ptr noundef nonnull align 8 dereferenceable(8) %3)
...
lor.rhs:                                          ; preds = %entry, %if.end593
  ...
  %vtable4 = load ptr, ptr %i2.01006, align 8
...
while.body:                                       ; preds = %lor.rhs
  ...
  %6 = load ptr, ptr %elem_patternrepresentation_1.i876, align 8
...
if.then:                                          ; preds = %while.body
  ...
  %7 = load ptr, ptr %patternrepresentation_1.i, align 8
  %patternrepresentation_1.i879 = getelementptr inbounds %"class.kc::impl_patternrepresentation", ptr %i2.01006, i64 0, i32 2
  %8 = load ptr, ptr %patternrepresentation_1.i879, align 8
  br label %if.end593

if.else:                                          ; preds = %while.body
  %9 = load ptr, ptr %elem_patternrepresentation_1.i877, align 8
...
if.then25:                                        ; preds = %land.lhs.true
  %12 = load i8, ptr getelementptr inbounds (%struct.cmdline_options, ptr @g_options, i64 0, i32 3), align 1
...
if.then26:                                        ; preds = %if.then25
  ...
  %16 = load ptr, ptr %elem_patternrepresentation_1.i876, align 8
  ...
  %17 = load ptr, ptr %file30, align 8
...
if.else35:                                        ; preds = %land.lhs.true, %if.else
  %vtable36 = load ptr, ptr %6, align 8
...
land.lhs.true40:                                  ; preds = %if.else35
  %vtable41 = load ptr, ptr %9, align 8
...
if.then45:                                        ; preds = %land.lhs.true40
  %23 = load i8, ptr getelementptr inbounds (%struct.cmdline_options, ptr @g_options, i64 0, i32 3), align 1
...
if.else60:                                        ; preds = %land.lhs.true40, %if.else35
  %vtable61 = load ptr, ptr %6, align 8
...
land.lhs.true65:                                  ; preds = %if.else60
  %vtable66 = load ptr, ptr %9, align 8
...
if.then80:                                        ; preds = %if.then70
  %37 = load ptr, ptr %elem_patternrepresentation_1.i877, align 8
  ...
  %38 = load ptr, ptr %patternrepresentation_1.i887, align 8
  br label %if.end593

if.else84:                                        ; preds = %if.then70
  %vtable85 = load ptr, ptr %call74, align 8
...
if.then89:                                        ; preds = %if.else84
  %40 = load ptr, ptr %elem_patternrepresentation_1.i876, align 8
  ...
  %41 = load ptr, ptr %patternrepresentation_1.i889, align 8
  br label %if.end593

if.else93:                                        ; preds = %if.else84
  %vtable94 = load ptr, ptr %call74, align 8
...
if.else107:                                       ; preds = %land.lhs.true65, %if.else60
  %vtable108 = load ptr, ptr %6, align 8
...
land.lhs.true112:                                 ; preds = %if.else107
  %vtable113 = load ptr, ptr %9, align 8
...
if.then131:                                       ; preds = %if.then117
  %48 = load ptr, ptr %elem_patternrepresentation_1.i877, align 8
  ...
  %49 = load ptr, ptr %patternrepresentation_1.i891, align 8
  br label %if.end593

if.else135:                                       ; preds = %if.then117
  %vtable136 = load ptr, ptr %call125, align 8
...
if.then140:                                       ; preds = %if.else135
  %51 = load ptr, ptr %elem_patternrepresentation_1.i876, align 8
  ...
  %52 = load ptr, ptr %patternrepresentation_1.i893, align 8
  br label %if.end593

if.else144:                                       ; preds = %if.else135
  %vtable145 = load ptr, ptr %call125, align 8
...
if.else161:                                       ; preds = %land.lhs.true112, %if.else107
  %vtable162 = load ptr, ptr %6, align 8
...
land.lhs.true166:                                 ; preds = %if.else161
  %vtable167 = load ptr, ptr %9, align 8
...
if.then185:                                       ; preds = %if.then171
  %59 = load ptr, ptr %elem_patternrepresentation_1.i877, align 8
  ...
  %60 = load ptr, ptr %patternrepresentation_1.i895, align 8
  br label %if.end593

if.else189:                                       ; preds = %if.then171
  %vtable190 = load ptr, ptr %call179, align 8
...
if.then194:                                       ; preds = %if.else189
  %62 = load ptr, ptr %elem_patternrepresentation_1.i876, align 8
  ...
  %63 = load ptr, ptr %patternrepresentation_1.i897, align 8
  br label %if.end593

if.else198:                                       ; preds = %if.else189
  %vtable199 = load ptr, ptr %call179, align 8
...
if.else215:                                       ; preds = %land.lhs.true166, %if.else161
  %vtable216 = load ptr, ptr %6, align 8
...
land.lhs.true220:                                 ; preds = %if.else215
  %vtable221 = load ptr, ptr %9, align 8
...
if.then239:                                       ; preds = %if.then225
  %70 = load ptr, ptr %elem_patternrepresentation_1.i877, align 8
  ...
  %71 = load ptr, ptr %patternrepresentation_1.i899, align 8
  br label %if.end593

if.else243:                                       ; preds = %if.then225
  %vtable244 = load ptr, ptr %call233, align 8
...
if.then248:                                       ; preds = %if.else243
  %73 = load ptr, ptr %elem_patternrepresentation_1.i876, align 8
  ...
  %74 = load ptr, ptr %patternrepresentation_1.i901, align 8
  br label %if.end593

if.else252:                                       ; preds = %if.else243
  %vtable253 = load ptr, ptr %call233, align 8
...
if.else269:                                       ; preds = %land.lhs.true220, %if.else215
  %vtable270 = load ptr, ptr %6, align 8
...
land.lhs.true274:                                 ; preds = %if.else269
  %vtable275 = load ptr, ptr %9, align 8
...
if.then293:                                       ; preds = %if.then279
  %81 = load ptr, ptr %elem_patternrepresentation_1.i877, align 8
  ...
  %82 = load ptr, ptr %patternrepresentation_1.i903, align 8
  br label %if.end593

if.else297:                                       ; preds = %if.then279
  %vtable298 = load ptr, ptr %call287, align 8
...
if.then302:                                       ; preds = %if.else297
  %84 = load ptr, ptr %elem_patternrepresentation_1.i876, align 8
  ...
  %85 = load ptr, ptr %patternrepresentation_1.i905, align 8
  br label %if.end593

if.else306:                                       ; preds = %if.else297
  %vtable307 = load ptr, ptr %call287, align 8
...
if.else323:                                       ; preds = %land.lhs.true274, %if.else269
  %vtable324 = load ptr, ptr %6, align 8
...
land.lhs.true328:                                 ; preds = %if.else323
  %vtable329 = load ptr, ptr %9, align 8
...
if.then347:                                       ; preds = %if.then333
  %92 = load ptr, ptr %elem_patternrepresentation_1.i877, align 8
  ...
  %93 = load ptr, ptr %patternrepresentation_1.i907, align 8
  br label %if.end593

if.else351:                                       ; preds = %if.then333
  %vtable352 = load ptr, ptr %call341, align 8
...
if.then356:                                       ; preds = %if.else351
  %95 = load ptr, ptr %elem_patternrepresentation_1.i876, align 8
  ...
  %96 = load ptr, ptr %patternrepresentation_1.i909, align 8
  br label %if.end593

if.else360:                                       ; preds = %if.else351
  %vtable361 = load ptr, ptr %call341, align 8
...
if.else377:                                       ; preds = %land.lhs.true328, %if.else323
  %vtable378 = load ptr, ptr %6, align 8
...
land.lhs.true382:                                 ; preds = %if.else377
  %vtable383 = load ptr, ptr %9, align 8
...
if.then401:                                       ; preds = %if.then387
  %103 = load ptr, ptr %elem_patternrepresentation_1.i877, align 8
  ...
  %104 = load ptr, ptr %patternrepresentation_1.i911, align 8
  br label %if.end593

if.else405:                                       ; preds = %if.then387
  %vtable406 = load ptr, ptr %call395, align 8
...
if.then410:                                       ; preds = %if.else405
  %106 = load ptr, ptr %elem_patternrepresentation_1.i876, align 8
  ...
  %107 = load ptr, ptr %patternrepresentation_1.i913, align 8
  br label %if.end593

if.else414:                                       ; preds = %if.else405
  %vtable415 = load ptr, ptr %call395, align 8
...
if.else431:                                       ; preds = %land.lhs.true382, %if.else377
  %vtable432 = load ptr, ptr %6, align 8
...
land.lhs.true436:                                 ; preds = %if.else431
  %vtable437 = load ptr, ptr %9, align 8
...
if.then455:                                       ; preds = %if.then441
  %114 = load ptr, ptr %elem_patternrepresentation_1.i877, align 8
  ...
  %115 = load ptr, ptr %patternrepresentation_1.i915, align 8
  br label %if.end593

if.else459:                                       ; preds = %if.then441
  %vtable460 = load ptr, ptr %call449, align 8
...
if.then464:                                       ; preds = %if.else459
  %117 = load ptr, ptr %elem_patternrepresentation_1.i876, align 8
  ...
  %118 = load ptr, ptr %patternrepresentation_1.i917, align 8
  br label %if.end593

if.else468:                                       ; preds = %if.else459
  %vtable469 = load ptr, ptr %call449, align 8
...
if.else485:                                       ; preds = %land.lhs.true436, %if.else431
  %vtable486 = load ptr, ptr %6, align 8
...
land.lhs.true490:                                 ; preds = %if.else485
  %vtable491 = load ptr, ptr %9, align 8
...
if.then509:                                       ; preds = %if.then495
  %125 = load ptr, ptr %elem_patternrepresentation_1.i877, align 8
  ...
  %126 = load ptr, ptr %patternrepresentation_1.i919, align 8
  br label %if.end593

if.else513:                                       ; preds = %if.then495
  %vtable514 = load ptr, ptr %call503, align 8
...
if.then518:                                       ; preds = %if.else513
  %128 = load ptr, ptr %elem_patternrepresentation_1.i876, align 8
  ...
  %129 = load ptr, ptr %patternrepresentation_1.i921, align 8
  br label %if.end593

if.else522:                                       ; preds = %if.else513
  %vtable523 = load ptr, ptr %call503, align 8
...
if.else539:                                       ; preds = %land.lhs.true490, %if.else485
  %vtable540 = load ptr, ptr %6, align 8
...
if.else545:                                       ; preds = %if.else539
  %vtable546 = load ptr, ptr %6, align 8
...
if.else551:                                       ; preds = %if.else545
  %vtable552 = load ptr, ptr %9, align 8
...
if.else557:                                       ; preds = %if.else551
  %vtable558 = load ptr, ptr %9, align 8
  ...
  %135 = load i8, ptr getelementptr inbounds (%struct.cmdline_options, ptr @g_options, i64 0, i32 3), align 1
...
while.end:                                        ; preds = %lor.rhs, %if.end593, %entry
  ...
  %vtable594 = load ptr, ptr %i1.0.lcssa, align 8
...
land.lhs.true597:                                 ; preds = %while.end
  %vtable598 = load ptr, ptr %i2.0.lcssa, align 8
...
if.then601:                                       ; preds = %land.lhs.true597, %while.end
  %vtable602 = load ptr, ptr %i1.0.lcssa, align 8
...
if.then614:                                       ; preds = %if.end610
  %150 = load i8, ptr getelementptr inbounds (%struct.cmdline_options, ptr @g_options, i64 0, i32 28), align 1
...
while.cond631.preheader:                          ; preds = %if.else626
  %vtable6321017 = load ptr, ptr %other_patterns, align 8
...
while.body636:                                    ; preds = %while.cond631.preheader, %while.body636
  ...
  %157 = load ptr, ptr %patternrepresentation_1, align 8
  ...
  %158 = load ptr, ptr %patternrepresentations_1, align 8
  %vtable632 = load ptr, ptr %158, align 8
  ...
  br i1 %cmp635, label %while.body636, label %while.end641.loopexit
...
while.end641:                                     ; preds = %while.end641.loopexit, %while.cond631.preheader
  ...
  %162 = load i8, ptr getelementptr inbounds (%struct.cmdline_options, ptr @g_options, i64 0, i32 29), align 2
...
entry:
  ...
  %0 = load ptr, ptr %patternrepresentation_1, align 8
  ret ptr %0
}
...
entry:
  ...
  %0 = load ptr, ptr %elem_patternrepresentation_1, align 8
  ret ptr %0
}
...
entry:
  ...
  %vtable4118 = load ptr, ptr %call, align 8
...
land.rhs:                                         ; preds = %entry, %if.end22
  ...
  %vtable7 = load ptr, ptr %kc_fe_selvar_2.0121, align 8
  %3 = load ptr, ptr %vtable7, align 8
...
if.then:                                          ; preds = %while.body
  ...
  %5 = load ptr, ptr %integer_111, align 8
  ...
  %8 = load i32, ptr %value12, align 8
...
while.end.loopexit:                               ; preds = %if.end22, %land.rhs
  %kc_fe_selvar_2.0.lcssa.ph = phi ptr [ %kc_fe_selvar_2.0121, %land.rhs ], [ %10, %if.end22 ]
  %kc_fe_selvar_1.0.lcssa.ph = phi ptr [ %kc_fe_selvar_1.0122, %land.rhs ], [ %9, %if.end22 ]
  %breakforeach.0.lcssa.ph = phi i8 [ %breakforeach.0123, %land.rhs ], [ %breakforeach.1, %if.end22 ]
  %ret.0.lcssa.ph = phi ptr [ %ret.0124, %land.rhs ], [ %ret.1, %if.end22 ]
  %12 = and i8 %breakforeach.0.lcssa.ph, 1
  %13 = icmp eq i8 %12, 0
  br label %while.end

while.end:                                        ; preds = %while.end.loopexit, %entry
  %kc_fe_selvar_2.0.lcssa = phi ptr [ %call3, %entry ], [ %kc_fe_selvar_2.0.lcssa.ph, %while.end.loopexit ]
  %kc_fe_selvar_1.0.lcssa = phi ptr [ %call, %entry ], [ %kc_fe_selvar_1.0.lcssa.ph, %while.end.loopexit ]
  %breakforeach.0.lcssa = phi i1 [ true, %entry ], [ %13, %while.end.loopexit ]
  %ret.0.lcssa = phi ptr [ undef, %entry ], [ %ret.0.lcssa.ph, %while.end.loopexit ]
  %vtable26 = load ptr, ptr %kc_fe_selvar_1.0.lcssa, align 8
  %14 = load ptr, ptr %vtable26, align 8
  %call28 = tail call noundef i32 %14(ptr noundef nonnull align 8 dereferenceable(40) %kc_fe_selvar_1.0.lcssa)
  %cmp29 = icmp eq i32 %call28, 211
  br i1 %cmp29, label %land.lhs.true, label %if.else37

land.lhs.true:                                    ; preds = %while.end
  %vtable30 = load ptr, ptr %kc_fe_selvar_2.0.lcssa, align 8
  %15 = load ptr, ptr %vtable30, align 8
  %call32 = tail call noundef i32 %15(ptr noundef nonnull align 8 dereferenceable(40) %kc_fe_selvar_2.0.lcssa)
  %cmp33 = icmp eq i32 %call32, 212
  br i1 %cmp33, label %if.then34, label %if.else37

if.then34:                                        ; preds = %land.lhs.true
  br i1 %breakforeach.0.lcssa, label %cond.false, label %cleanup.cont83
...
if.else37:                                        ; preds = %land.lhs.true, %while.end
  %vtable38 = load ptr, ptr %kc_fe_selvar_1.0.lcssa, align 8
  %16 = load ptr, ptr %vtable38, align 8
  %call40 = tail call noundef i32 %16(ptr noundef nonnull align 8 dereferenceable(40) %kc_fe_selvar_1.0.lcssa)
  %cmp41 = icmp eq i32 %call40, 212
  br i1 %cmp41, label %land.lhs.true42, label %if.else54

land.lhs.true42:                                  ; preds = %if.else37
  %vtable43 = load ptr, ptr %kc_fe_selvar_2.0.lcssa, align 8
  %17 = load ptr, ptr %vtable43, align 8
  %call45 = tail call noundef i32 %17(ptr noundef nonnull align 8 dereferenceable(40) %kc_fe_selvar_2.0.lcssa)
  %cmp46 = icmp eq i32 %call45, 211
  br i1 %cmp46, label %if.then47, label %if.else54

if.then47:                                        ; preds = %land.lhs.true42
  br i1 %breakforeach.0.lcssa, label %cond.false50, label %cleanup.cont83
...
if.else54:                                        ; preds = %land.lhs.true42, %if.else37
  %vtable55 = load ptr, ptr %kc_fe_selvar_1.0.lcssa, align 8
...
land.lhs.true59:                                  ; preds = %if.else54
  %vtable60 = load ptr, ptr %kc_fe_selvar_2.0.lcssa, align 8
...
if.then64:                                        ; preds = %land.lhs.true59
  br i1 %breakforeach.0.lcssa, label %cond.false67, label %cleanup.cont83
...
entry:
  %vtable = load ptr, ptr %a_patterns, align 8
  %0 = load ptr, ptr %vtable, align 8
...
if.else:                                          ; preds = %entry
  %vtable7 = load ptr, ptr %a_patterns, align 8
  %3 = load ptr, ptr %vtable7, align 8
...
entry:
  %vtable = load ptr, ptr %a_pattern, align 8
  %0 = load ptr, ptr %vtable, align 8
...
if.else:                                          ; preds = %entry
  %vtable6 = load ptr, ptr %a_pattern, align 8
...
if.then10:                                        ; preds = %if.else
  ...
  %3 = load ptr, ptr %CexpressionDQ_1, align 8
...
if.else15:                                        ; preds = %if.else
  %vtable16 = load ptr, ptr %a_pattern, align 8
...
if.else22:                                        ; preds = %if.else15
  %vtable23 = load ptr, ptr %a_pattern, align 8
...
if.then27:                                        ; preds = %if.else22
  ...
  %7 = load ptr, ptr %pattern_1, align 8
...
if.else35:                                        ; preds = %if.else22
  %vtable36 = load ptr, ptr %a_pattern, align 8
...
if.else50:                                        ; preds = %if.else35
  %vtable51 = load ptr, ptr %a_pattern, align 8
...
if.then55:                                        ; preds = %if.else50
  ...
  %14 = load ptr, ptr %ID_158, align 8
...
entry:
  %vtable = load ptr, ptr %a_patternrep_elem, align 8
  %0 = load ptr, ptr %vtable, align 8
...
if.else:                                          ; preds = %entry
  %vtable8 = load ptr, ptr %a_patternrep_elem, align 8
...
entry:
  %vtable120131145 = load ptr, ptr %a_patternrep, align 8
...
if.then7:                                         ; preds = %if.then
  ...
  %6 = load ptr, ptr %patternrepresentation_111, align 8
...
if.then13:                                        ; preds = %if.then7
  ...
  %vtable120131 = load ptr, ptr %2, align 8
...
if.else24:                                        ; preds = %if.then
  %vtable25 = load ptr, ptr %1, align 8
...
if.then37:                                        ; preds = %if.then29
  ...
  %vtable120 = load ptr, ptr %2, align 8
...
if.else51:                                        ; preds = %if.then13, %if.then37, %tailrecurse.backedge, %entry
  ...
  %vtable52 = load ptr, ptr %a_patternrep.tr.lcssa, align 8
...
if.else60:                                        ; preds = %if.then56
  ...
  store ptr %14, ptr %file62, align 8
  ...
  store i32 %15, ptr %line63, align 8
...
entry:
  %vtable103 = load ptr, ptr %a_patternrep, align 8
...
if.then10:                                        ; preds = %_ZN2kc17f_bindingidmarkedEPNS_7impl_IDE.exit, %_ZN2kc17f_bindingidmarkedEPNS_7impl_IDE.exit.thread
  ...
  br i1 %cmp.i60, label %if.then.i62, label %if.else.i61

if.then.i62:                                      ; preds = %if.then10
  %uniqID_1.i63 = getelementptr inbounds %"class.kc::impl_ID_Id", ptr %4, i64 0, i32 1
  %10 = load ptr, ptr %uniqID_1.i63, align 8
  %call3.i64 = tail call noundef ptr @_ZN2kc13BindingIdMarkEPNS_11impl_uniqIDE(ptr noundef %10)
  %marked.i65 = getelementptr inbounds %"class.kc::impl_bindingidmark", ptr %call3.i64, i64 0, i32 1
  store i8 1, ptr %marked.i65, align 8
  br label %_ZN2kc15v_markbindingidEPNS_7impl_IDE.exit

if.else.i61:                                      ; preds = %if.then10
  tail call void @_ZN2kc21kc_no_default_in_withEPKciS1_(ptr noundef nonnull @.str.7, i32 noundef 451, ptr noundef nonnull @.str.1)
  br label %_ZN2kc15v_markbindingidEPNS_7impl_IDE.exit
...
_ZN2kc15v_markbindingidEPNS_7impl_IDE.exit:       ; preds = %if.then.i62, %if.else.i61
...
if.then19:                                        ; preds = %if.else14
  ...
  %12 = load ptr, ptr %ID_122, align 8
  %vtable.i66 = load ptr, ptr %12, align 8
...
_ZN2kc17f_bindingidmarkedEPNS_7impl_IDE.exit76:   ; preds = %if.then19
  %uniqID_1.i72 = getelementptr inbounds %"class.kc::impl_ID_Id", ptr %12, i64 0, i32 1
  %14 = load ptr, ptr %uniqID_1.i72, align 8
  %call3.i73 = tail call noundef ptr @_ZN2kc13BindingIdMarkEPNS_11impl_uniqIDE(ptr noundef %14)
  %marked.i74 = getelementptr inbounds %"class.kc::impl_bindingidmark", ptr %call3.i73, i64 0, i32 1
  %15 = load i8, ptr %marked.i74, align 8
  %tobool.i75.not = icmp eq i8 %15, 0
  br i1 %tobool.i75.not, label %if.then24, label %tailrecurse.backedge

if.then24:                                        ; preds = %_ZN2kc17f_bindingidmarkedEPNS_7impl_IDE.exit76, %_ZN2kc17f_bindingidmarkedEPNS_7impl_IDE.exit76.thread
  %vtable.i77 = load ptr, ptr %12, align 8
  ...
  br i1 %cmp.i79, label %if.then.i81, label %if.else.i80

if.then.i81:                                      ; preds = %if.then24
  %uniqID_1.i82 = getelementptr inbounds %"class.kc::impl_ID_Id", ptr %12, i64 0, i32 1
  %17 = load ptr, ptr %uniqID_1.i82, align 8
  %call3.i83 = tail call noundef ptr @_ZN2kc13BindingIdMarkEPNS_11impl_uniqIDE(ptr noundef %17)
  %marked.i84 = getelementptr inbounds %"class.kc::impl_bindingidmark", ptr %call3.i83, i64 0, i32 1
  store i8 1, ptr %marked.i84, align 8
...
_ZN2kc15v_markbindingidEPNS_7impl_IDE.exit85:     ; preds = %if.then.i81, %if.else.i80
...
if.else35:                                        ; preds = %tailrecurse.backedge, %entry
  %a_patternrep.tr.lcssa = phi ptr [ %a_patternrep, %entry ], [ %2, %tailrecurse.backedge ]
  %vtable36 = load ptr, ptr %a_patternrep.tr.lcssa, align 8
...
entry:
  %vtable101 = load ptr, ptr %a_paths1, align 8
...
land.rhs:                                         ; preds = %entry, %cleanup26
  ...
  %vtable1 = load ptr, ptr %kc_fe_selvar_2.0104, align 8
  %1 = load ptr, ptr %vtable1, align 8
...
cleanup26:                                        ; preds = %if.else
  ...
  %7 = load ptr, ptr %paths_125, align 8
  %vtable = load ptr, ptr %6, align 8
  %8 = load ptr, ptr %vtable, align 8
...
while.end:                                        ; preds = %land.rhs, %cleanup26, %entry
  ...
  %vtable33 = load ptr, ptr %kc_fe_selvar_1.0.lcssa, align 8
...
land.lhs.true:                                    ; preds = %while.end
  %vtable37 = load ptr, ptr %kc_fe_selvar_2.0.lcssa, align 8
...
if.else43:                                        ; preds = %land.lhs.true, %while.end
  %vtable44 = load ptr, ptr %kc_fe_selvar_1.0.lcssa, align 8
...
land.lhs.true48:                                  ; preds = %if.else43
  %vtable49 = load ptr, ptr %kc_fe_selvar_2.0.lcssa, align 8
...
if.else55:                                        ; preds = %land.lhs.true48, %if.else43
  %vtable56 = load ptr, ptr %kc_fe_selvar_1.0.lcssa, align 8
...
land.lhs.true60:                                  ; preds = %if.else55
  %vtable61 = load ptr, ptr %kc_fe_selvar_2.0.lcssa, align 8
...
cleanup72:                                        ; preds = %if.then, %if.then17, %if.then41, %if.then53, %if.then65, %if.else67
  %retval.3 = phi ptr [ %call42, %if.then41 ], [ %call54, %if.then53 ], [ %call66, %if.then65 ], [ null, %if.else67 ], [ %call18, %if.then17 ], [ %call12, %if.then ]
  ret ptr %retval.3
}
