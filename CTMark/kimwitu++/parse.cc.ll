; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/kimwitu++/parse.cc'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/kimwitu++/parse.cc"
...
@.str.6 = private unnamed_addr constant [61 x i8] c"/home/npopov/repos/llvm-test-suite/CTMark/kimwitu++/parse.cc\00", align 1
...
entry:
  %vtable = load ptr, ptr %pd, align 8
...
if.then46:                                        ; preds = %land.lhs.true40
  %14 = load ptr, ptr %ID_144, align 8
...
if.else52:                                        ; preds = %land.lhs.true40, %land.lhs.true, %if.then21
  %vtable53 = load ptr, ptr %2, align 8
...
land.lhs.true57:                                  ; preds = %if.else52
  %vtable58 = load ptr, ptr %7, align 8
...
if.else77:                                        ; preds = %land.lhs.true62, %land.lhs.true57, %if.else52
  %vtable78 = load ptr, ptr %2, align 8
...
land.lhs.true82:                                  ; preds = %if.else77
  %vtable83 = load ptr, ptr %7, align 8
...
if.else97:                                        ; preds = %land.lhs.true87, %land.lhs.true82, %if.else77
  %vtable98 = load ptr, ptr %2, align 8
...
land.lhs.true102:                                 ; preds = %if.else97
  %vtable103 = load ptr, ptr %7, align 8
...
if.else117:                                       ; preds = %land.lhs.true107, %land.lhs.true102, %if.else97
  %vtable118 = load ptr, ptr %2, align 8
...
if.else123:                                       ; preds = %if.else117
  %vtable124 = load ptr, ptr %7, align 8
...
if.end141:                                        ; preds = %land.lhs.true107, %land.lhs.true87, %if.then68, %if.then128, %if.else130, %if.else117, %if.then46
  %vtable146 = load ptr, ptr %3, align 8
...
land.lhs.true150:                                 ; preds = %if.end141
  %vtable151 = load ptr, ptr %8, align 8
...
land.lhs.true166:                                 ; preds = %if.else161
  %vtable167 = load ptr, ptr %8, align 8
...
if.then171:                                       ; preds = %land.lhs.true166
  store ptr %3, ptr %productionblock_127, align 8
  br label %cleanup.cont

if.else173:                                       ; preds = %land.lhs.true166, %if.else161
  %vtable174 = load ptr, ptr %3, align 8
...
land.lhs.true178:                                 ; preds = %if.else173
  %vtable179 = load ptr, ptr %8, align 8
...
if.else185:                                       ; preds = %land.lhs.true178, %if.else173
  %vtable186 = load ptr, ptr %3, align 8
...
land.lhs.true190:                                 ; preds = %if.else185
  %vtable191 = load ptr, ptr %8, align 8
...
if.else197:                                       ; preds = %land.lhs.true190, %if.else185
  %vtable198 = load ptr, ptr %3, align 8
...
land.lhs.true202:                                 ; preds = %if.else197
  %vtable203 = load ptr, ptr %8, align 8
...
if.else208:                                       ; preds = %land.lhs.true202, %if.else197
  %vtable209 = load ptr, ptr %3, align 8
...
if.else219:                                       ; preds = %if.else208
  %vtable220 = load ptr, ptr %3, align 8
...
if.else230:                                       ; preds = %if.else219
  %vtable231 = load ptr, ptr %3, align 8
...
if.else241:                                       ; preds = %if.else230
  %vtable242 = load ptr, ptr %3, align 8
...
cleanup.cont:                                     ; preds = %if.then171, %if.then195, %if.then213, %if.then235, %if.else241, %if.then224, %land.lhs.true202, %if.then183, %if.then155
  %vtable262 = load ptr, ptr %4, align 8
...
land.lhs.true266:                                 ; preds = %cleanup.cont
  %vtable267 = load ptr, ptr %9, align 8
...
60:                                               ; preds = %land.lhs.true266
  ...
  store ptr %call280, ptr %Ccode_option_129, align 8
  br label %cleanup305
...
if.else22:                                        ; preds = %if.else
  %vtable23 = load ptr, ptr %2, align 8
...
if.else33:                                        ; preds = %if.else22
  %vtable34 = load ptr, ptr %2, align 8
...
if.else44:                                        ; preds = %if.else33
  %vtable45 = load ptr, ptr %2, align 8
...
if.else55:                                        ; preds = %if.else44
  %vtable56 = load ptr, ptr %2, align 8
...
if.else66:                                        ; preds = %if.else55
  %vtable67 = load ptr, ptr %2, align 8
...
if.else88:                                        ; preds = %if.else77
  %vtable89 = load ptr, ptr %2, align 8
...
if.else99:                                        ; preds = %if.else88
  %vtable100 = load ptr, ptr %2, align 8
...
if.then104:                                       ; preds = %if.else99
  ...
  %31 = load ptr, ptr %phylumdeclaration_1, align 8
  br label %cleanup131

if.else106:                                       ; preds = %if.else99
  %vtable107 = load ptr, ptr %2, align 8
...
entry:
  ...
  %vtable.i = load ptr, ptr %listphylum, align 8
  %1 = load ptr, ptr %vtable.i, align 8
  %call1.i86 = invoke noundef i32 %1(ptr noundef nonnull align 8 dereferenceable(8) %listphylum)
          to label %call1.i.noexc unwind label %lpad3

call1.i.noexc:                                    ; preds = %entry
  %cmp.i = icmp eq i32 %call1.i86, 7
...
land.lhs.true.i:                                  ; preds = %call1.i.noexc
  ...
  %2 = load ptr, ptr %uniqID_1.i, align 8
  %vtable3.i = load ptr, ptr %2, align 8
  %3 = load ptr, ptr %vtable3.i, align 8
  %call5.i87 = invoke noundef i32 %3(ptr noundef nonnull align 8 dereferenceable(8) %2)
          to label %call5.i.noexc unwind label %lpad3

call5.i.noexc:                                    ; preds = %land.lhs.true.i
  %cmp6.i = icmp eq i32 %call5.i87, 6
...
if.then.i:                                        ; preds = %call5.i.noexc
  ...
  %5 = load ptr, ptr %casestring_1.i, align 8
...
invoke.cont4:                                     ; preds = %if.then.i, %if.else.i
  ...
  %call.i.i.i = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %retval.0.i) #13
...
if.then.i.i.i:                                    ; preds = %invoke.cont4
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.52) #14
          to label %.noexc90 unwind label %lpad3

.noexc90:                                         ; preds = %if.then.i.i.i
  unreachable

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i: ; preds = %invoke.cont4
  %call2.i.i91 = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_appendEPKcm(ptr noundef nonnull align 8 dereferenceable(32) %ref.tmp1, ptr noundef %retval.0.i, i64 noundef %call.i.i.i)
...
call2.i.i.noexc:                                  ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i
  ...
  %9 = load ptr, ptr %call2.i.i91, align 8
  %10 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %call2.i.i91, i64 0, i32 2
  %cmp.i.i1.i = icmp eq ptr %9, %10
  br i1 %cmp.i.i1.i, label %if.then.i.i89, label %if.else.i.i

if.then.i.i89:                                    ; preds = %call2.i.i.noexc
  %_M_string_length.i.i.i = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %call2.i.i91, i64 0, i32 1
...
invoke.cont5:                                     ; preds = %if.else.i.i, %if.then.i.i89
  %_M_string_length.i23.i.i = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %call2.i.i91, i64 0, i32 1
  %13 = load i64, ptr %_M_string_length.i23.i.i, align 8
  %_M_string_length.i24.i.i = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %ref.tmp, i64 0, i32 1
  store i64 %13, ptr %_M_string_length.i24.i.i, align 8
  store ptr %10, ptr %call2.i.i91, align 8
...
invoke.cont12:                                    ; preds = %invoke.cont10
  ...
  %cmp.i.i.i92 = icmp eq ptr %15, %8
  br i1 %cmp.i.i.i92, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i, label %if.then.i.i93

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i: ; preds = %invoke.cont12
  %16 = load i64, ptr %_M_string_length.i24.i.i, align 8
  %cmp3.i.i.i95 = icmp ult i64 %16, 16
  call void @llvm.assume(i1 %cmp3.i.i.i95)
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit

if.then.i.i93:                                    ; preds = %invoke.cont12
  call void @_ZdlPv(ptr noundef %15) #15
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i, %if.then.i.i93
  %17 = load ptr, ptr %ref.tmp1, align 8
  %cmp.i.i.i96 = icmp eq ptr %17, %0
...
if.then.i.i97:                                    ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit101: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i98, %if.then.i.i97
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %ref.tmp18) #13
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %ref.tmp19) #13
  %19 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %ref.tmp19, i64 0, i32 2
  store ptr %19, ptr %ref.tmp19, align 8
  store i32 1936617283, ptr %19, align 8
  %_M_string_length.i.i.i.i106 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %ref.tmp19, i64 0, i32 1
  store i64 4, ptr %_M_string_length.i.i.i.i106, align 8
  %arrayidx.i.i.i107 = getelementptr inbounds i8, ptr %ref.tmp19, i64 20
  store i8 0, ptr %arrayidx.i.i.i107, align 4
  %vtable.i114 = load ptr, ptr %listphylum, align 8
  %20 = load ptr, ptr %vtable.i114, align 8
  %call1.i126 = invoke noundef i32 %20(ptr noundef nonnull align 8 dereferenceable(8) %listphylum)
          to label %call1.i.noexc125 unwind label %lpad23

call1.i.noexc125:                                 ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit101
  %cmp.i115 = icmp eq i32 %call1.i126, 7
  br i1 %cmp.i115, label %land.lhs.true.i118, label %if.else.i116

land.lhs.true.i118:                               ; preds = %call1.i.noexc125
  %uniqID_1.i119 = getelementptr inbounds %"class.kc::impl_ID_Id", ptr %listphylum, i64 0, i32 1
  %21 = load ptr, ptr %uniqID_1.i119, align 8
  %vtable3.i120 = load ptr, ptr %21, align 8
  %22 = load ptr, ptr %vtable3.i120, align 8
  %call5.i128 = invoke noundef i32 %22(ptr noundef nonnull align 8 dereferenceable(8) %21)
          to label %call5.i.noexc127 unwind label %lpad23

call5.i.noexc127:                                 ; preds = %land.lhs.true.i118
  %cmp6.i121 = icmp eq i32 %call5.i128, 6
  br i1 %cmp6.i121, label %if.then.i122, label %if.else.i116

if.then.i122:                                     ; preds = %call5.i.noexc127
  %23 = load ptr, ptr %uniqID_1.i119, align 8
  %casestring_1.i123 = getelementptr inbounds %"class.kc::impl_uniqID_Str", ptr %23, i64 0, i32 1
  %24 = load ptr, ptr %casestring_1.i123, align 8
  %name.i124 = getelementptr inbounds %"class.kc::impl_casestring__Str", ptr %24, i64 0, i32 1
  %25 = load ptr, ptr %name.i124, align 8
  br label %invoke.cont24

if.else.i116:                                     ; preds = %call5.i.noexc127, %call1.i.noexc125
  invoke void @_ZN2kc21kc_no_default_in_withEPKciS1_(ptr noundef nonnull @.str.9, i32 noundef 246, ptr noundef nonnull @.str.6)
          to label %invoke.cont24 unwind label %lpad23

invoke.cont24:                                    ; preds = %if.then.i122, %if.else.i116
  %retval.0.i117 = phi ptr [ %25, %if.then.i122 ], [ null, %if.else.i116 ]
  call void @llvm.experimental.noalias.scope.decl(metadata !54)
  %call.i.i.i131 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %retval.0.i117) #13
  %26 = load i64, ptr %_M_string_length.i.i.i.i106, align 8
  %sub3.i.i.i133 = sub i64 4611686018427387903, %26
  %cmp.i.i.i134 = icmp ult i64 %sub3.i.i.i133, %call.i.i.i131
  br i1 %cmp.i.i.i134, label %if.then.i.i.i144, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i135

if.then.i.i.i144:                                 ; preds = %invoke.cont24
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.52) #14
          to label %.noexc145 unwind label %lpad23

.noexc145:                                        ; preds = %if.then.i.i.i144
  unreachable

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i135: ; preds = %invoke.cont24
  %call2.i.i147 = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_appendEPKcm(ptr noundef nonnull align 8 dereferenceable(32) %ref.tmp19, ptr noundef %retval.0.i117, i64 noundef %call.i.i.i131)
          to label %call2.i.i.noexc146 unwind label %lpad23

call2.i.i.noexc146:                               ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i135
  %27 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %ref.tmp18, i64 0, i32 2
  store ptr %27, ptr %ref.tmp18, align 8
  %28 = load ptr, ptr %call2.i.i147, align 8
  %29 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %call2.i.i147, i64 0, i32 2
  %cmp.i.i1.i136 = icmp eq ptr %28, %29
  br i1 %cmp.i.i1.i136, label %if.then.i.i140, label %if.else.i.i137

if.then.i.i140:                                   ; preds = %call2.i.i.noexc146
  %_M_string_length.i.i.i141 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %call2.i.i147, i64 0, i32 1
  %30 = load i64, ptr %_M_string_length.i.i.i141, align 8
  %cmp3.i.i.i142 = icmp ult i64 %30, 16
  call void @llvm.assume(i1 %cmp3.i.i.i142)
  %add.i.i143 = add nuw nsw i64 %30, 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %27, ptr noundef nonnull align 8 dereferenceable(1) %28, i64 %add.i.i143, i1 false)
  br label %invoke.cont26

if.else.i.i137:                                   ; preds = %call2.i.i.noexc146
  store ptr %28, ptr %ref.tmp18, align 8
  %31 = load i64, ptr %29, align 8
  store i64 %31, ptr %27, align 8
  br label %invoke.cont26

invoke.cont26:                                    ; preds = %if.else.i.i137, %if.then.i.i140
  %_M_string_length.i23.i.i138 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %call2.i.i147, i64 0, i32 1
  %32 = load i64, ptr %_M_string_length.i23.i.i138, align 8
  %_M_string_length.i24.i.i139 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %ref.tmp18, i64 0, i32 1
  store i64 %32, ptr %_M_string_length.i24.i.i139, align 8
  store ptr %29, ptr %call2.i.i147, align 8
  store i64 0, ptr %_M_string_length.i23.i.i138, align 8
  store i8 0, ptr %29, align 8
  %33 = load ptr, ptr %ref.tmp18, align 8
  %call30 = invoke noundef ptr @_ZN2kc12mkcasestringEPKci(ptr noundef %33, i32 noundef -1)
...
invoke.cont33:                                    ; preds = %invoke.cont31
  ...
  %cmp.i.i.i149 = icmp eq ptr %34, %27
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i151: ; preds = %invoke.cont33
  %35 = load i64, ptr %_M_string_length.i24.i.i139, align 8
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit154: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i151, %if.then.i.i150
  ...
  %cmp.i.i.i155 = icmp eq ptr %36, %19
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i157: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit154
  %37 = load i64, ptr %_M_string_length.i.i.i.i106, align 8
  %cmp3.i.i.i159 = icmp ult i64 %37, 16
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit160: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i157, %if.then.i.i156
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %ref.tmp19) #13
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %ref.tmp18) #13
  ...
  store i32 %38, ptr %line41, align 8
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i163: ; preds = %lpad7
  %45 = load i64, ptr %_M_string_length.i24.i.i, align 8
  %cmp3.i.i.i165 = icmp ult i64 %45, 16
  call void @llvm.assume(i1 %cmp3.i.i.i165)
  br label %ehcleanup

if.then.i.i162:                                   ; preds = %lpad7
  call void @_ZdlPv(ptr noundef %44) #15
  br label %ehcleanup

ehcleanup:                                        ; preds = %if.then.i.i162, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i163, %lpad3
  %.pn = phi { ptr, i32 } [ %42, %lpad3 ], [ %43, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i163 ], [ %43, %if.then.i.i162 ]
  %46 = load ptr, ptr %ref.tmp1, align 8
  %cmp.i.i.i167 = icmp eq ptr %46, %0
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i169: ; preds = %ehcleanup
  %47 = load i64, ptr %_M_string_length.i.i.i.i, align 8
  %cmp3.i.i.i171 = icmp ult i64 %47, 16
...
ehcleanup14:                                      ; preds = %if.then.i.i168, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i169
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %ref.tmp1) #13
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %ref.tmp) #13
  br label %ehcleanup58

lpad23:                                           ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i135, %if.then.i.i.i144, %if.else.i116, %land.lhs.true.i118, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit101
...
lpad28:                                           ; preds = %invoke.cont31, %invoke.cont29, %invoke.cont26
  %49 = landingpad { ptr, i32 }
          cleanup
  %50 = load ptr, ptr %ref.tmp18, align 8
  %cmp.i.i.i173 = icmp eq ptr %50, %27
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i175: ; preds = %lpad28
  %51 = load i64, ptr %_M_string_length.i24.i.i139, align 8
  %cmp3.i.i.i177 = icmp ult i64 %51, 16
  call void @llvm.assume(i1 %cmp3.i.i.i177)
  br label %ehcleanup36

if.then.i.i174:                                   ; preds = %lpad28
  call void @_ZdlPv(ptr noundef %50) #15
  br label %ehcleanup36

ehcleanup36:                                      ; preds = %if.then.i.i174, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i175, %lpad23
  %.pn81 = phi { ptr, i32 } [ %48, %lpad23 ], [ %49, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i175 ], [ %49, %if.then.i.i174 ]
  %52 = load ptr, ptr %ref.tmp19, align 8
  %cmp.i.i.i179 = icmp eq ptr %52, %19
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i181: ; preds = %ehcleanup36
  %53 = load i64, ptr %_M_string_length.i.i.i.i106, align 8
  %cmp3.i.i.i183 = icmp ult i64 %53, 16
  call void @llvm.assume(i1 %cmp3.i.i.i183)
  br label %ehcleanup37

if.then.i.i180:                                   ; preds = %ehcleanup36
  call void @_ZdlPv(ptr noundef %52) #15
  br label %ehcleanup37

ehcleanup37:                                      ; preds = %if.then.i.i180, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i181
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %ref.tmp19) #13
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %ref.tmp18) #13
  br label %ehcleanup58

ehcleanup58:                                      ; preds = %ehcleanup37, %ehcleanup14
  %.pn81.pn.pn = phi { ptr, i32 } [ %.pn81, %ehcleanup37 ], [ %.pn, %ehcleanup14 ]
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %4 = load ptr, ptr %casestring_1, align 8
...
if.then111:                                       ; preds = %if.else106
  ...
  %33 = load ptr, ptr %phylumdeclaration_1114, align 8
  br label %cleanup129

if.else115:                                       ; preds = %if.else106
  %vtable116 = load ptr, ptr %2, align 8
...
if.then:                                          ; preds = %entry
  ...
  %2 = load ptr, ptr %argsnumbers_1, align 8
...
if.else13:                                        ; preds = %entry
  %vtable14 = load ptr, ptr %a, align 8
...
while.body:                                       ; preds = %entry, %while.body
  ...
  %1 = load ptr, ptr %includefile_1, align 8
  ...
  %2 = load i32, ptr %inc_type, align 8
  ...
  %3 = load ptr, ptr %cond-lvalue.i, align 8
...
entry:
  %vtable22 = load ptr, ptr %names, align 8
...
if.end14:                                         ; preds = %if.then, %if.then8, %while.body
  ...
  %5 = load ptr, ptr %languagenames_1, align 8
  %vtable = load ptr, ptr %5, align 8
  %6 = load ptr, ptr %vtable, align 8
  %call = tail call noundef i32 %6(ptr noundef nonnull align 8 dereferenceable(24) %5)
...
entry:
  %.b1 = load i1, ptr @_ZL21language_text_nr_used, align 1
  br i1 %.b1, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %0 = load i64, ptr @_ZL16language_text_nr, align 8
  %inc = add nsw i64 %0, 1
  store i64 %inc, ptr @_ZL16language_text_nr, align 8
...
tailrecurse.i:                                    ; preds = %tailrecurse.i.backedge, %if.then
  ...
  %d.tr.i = load ptr, ptr %d.tr.i.in, align 8
  %vtable.i = load ptr, ptr %d.tr.i, align 8
  %1 = load ptr, ptr %vtable.i, align 8
...
if.else.i:                                        ; preds = %tailrecurse.i
  %vtable4.i = load ptr, ptr %d.tr.i, align 8
...
if.else13.i:                                      ; preds = %if.else.i
  %vtable14.i = load ptr, ptr %d.tr.i, align 8
...
if.else23.i:                                      ; preds = %if.else13.i
  %vtable24.i = load ptr, ptr %d.tr.i, align 8
...
if.then28.i:                                      ; preds = %if.else23.i
  ...
  %5 = load ptr, ptr %ac_declarator_1.i, align 8
...
if.else32.i:                                      ; preds = %if.else23.i
  %vtable33.i = load ptr, ptr %d.tr.i, align 8
...
_ZN2kcL19f_ID_of_direct_declEPNS_25impl_ac_direct_declaratorE.exit: ; preds = %if.else.i.i, %if.then37.i, %if.else39.i
  ...
  %vtable5 = load ptr, ptr %fnc, align 8
...
if.then9:                                         ; preds = %_ZN2kcL19f_ID_of_direct_declEPNS_25impl_ac_direct_declaratorE.exit
  ...
  %10 = load i32, ptr @_ZZN2kc21f_ID_of_fn_declaratorEPNS_18impl_ac_declaratorEPNS_12impl_fnclassEE7dtor_nr, align 4
  %inc = add nsw i32 %10, 1
  store i32 %inc, ptr @_ZZN2kc21f_ID_of_fn_declaratorEPNS_18impl_ac_declaratorEPNS_12impl_fnclassEE7dtor_nr, align 4
  %call10 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %buf, ptr noundef nonnull dereferenceable(1) @.str.25, i32 noundef %inc) #13
...
if.else:                                          ; preds = %_ZN2kcL19f_ID_of_direct_declEPNS_25impl_ac_direct_declaratorE.exit
  %vtable17 = load ptr, ptr %fnc, align 8
...
if.then21:                                        ; preds = %if.else
  call void @llvm.lifetime.start.p0(i64 30, ptr nonnull %buf22) #13
  %14 = load i32, ptr @_ZZN2kc21f_ID_of_fn_declaratorEPNS_18impl_ac_declaratorEPNS_12impl_fnclassEE7ctor_nr, align 4
  %inc24 = add nsw i32 %14, 1
  store i32 %inc24, ptr @_ZZN2kc21f_ID_of_fn_declaratorEPNS_18impl_ac_declaratorEPNS_12impl_fnclassEE7ctor_nr, align 4
  %call25 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %buf22, ptr noundef nonnull dereferenceable(1) @.str.26, i32 noundef %inc24) #13
...
if.then:                                          ; preds = %entry
  ...
  %1 = load ptr, ptr %ac_pointer_option_1, align 8
...
if.then.i:                                        ; preds = %if.then
  ...
  %3 = load ptr, ptr %ac_pointer_1.i, align 8
  %vtable5.i.i = load ptr, ptr %3, align 8
...
if.then.i.i:                                      ; preds = %if.then.i, %if.then.i.i
  ...
  %5 = load ptr, ptr %ac_pointer_1.i.i, align 8
...
cleanup:                                          ; preds = %cleanup.loopexit.i.i, %if.then.i, %if.then, %entry
  %retval.0 = phi i32 [ 0, %entry ], [ 0, %if.then ], [ 1, %if.then.i ], [ %7, %cleanup.loopexit.i.i ]
  ret i32 %retval.0
}
...
entry:
  %vtable26 = load ptr, ptr %ds, align 8
  %0 = load ptr, ptr %vtable26, align 8
  %call127 = tail call noundef i32 %0(ptr noundef nonnull align 8 dereferenceable(24) %ds)
  %cmp28 = icmp eq i32 %call127, 236
  br i1 %cmp28, label %if.then.lr.ph, label %if.else9

if.then.lr.ph:                                    ; preds = %entry
  %ac_direct_declarator_1.i = getelementptr inbounds %"class.kc::impl_ac_declarator_AcDeclarator", ptr %dec, i64 0, i32 3
  br label %if.then

if.then:                                          ; preds = %if.then.lr.ph, %cond.false
  %ds.tr29 = phi ptr [ %ds, %if.then.lr.ph ], [ %2, %cond.false ]
  %ac_declaration_specifier_1 = getelementptr inbounds %"class.kc::impl_ac_declaration_specifiers", ptr %ds.tr29, i64 0, i32 1
  %1 = load ptr, ptr %ac_declaration_specifier_1, align 8
  %ac_declaration_specifiers_1 = getelementptr inbounds %"class.kc::impl_ac_declaration_specifiers", ptr %ds.tr29, i64 0, i32 2
  %2 = load ptr, ptr %ac_declaration_specifiers_1, align 8
...
if.else:                                          ; preds = %if.then
  %vtable.i = load ptr, ptr %dec, align 8
  %3 = load ptr, ptr %vtable.i, align 8
  %call1.i = tail call noundef i32 %3(ptr noundef nonnull align 8 dereferenceable(8) %dec)
  %cmp.i = icmp eq i32 %call1.i, 254
  br i1 %cmp.i, label %land.lhs.true.i, label %cond.false

land.lhs.true.i:                                  ; preds = %if.else
  %4 = load ptr, ptr %ac_direct_declarator_1.i, align 8
  %vtable3.i = load ptr, ptr %4, align 8
  ...
  br i1 %cmp6.i, label %land.lhs.true7.i, label %cond.false

land.lhs.true7.i:                                 ; preds = %land.lhs.true.i
  %6 = load ptr, ptr %ac_direct_declarator_1.i, align 8
  ...
  %7 = load ptr, ptr %ac_class_qualifier_list_1.i, align 8
  %vtable11.i = load ptr, ptr %7, align 8
  ...
  br i1 %cmp14.i, label %cond.true, label %cond.false

cond.true:                                        ; preds = %land.lhs.true7.i
  %call6 = tail call noundef ptr @_ZN2kc8MemberFnEv()
  br label %cleanup17

cond.false:                                       ; preds = %land.lhs.true7.i, %land.lhs.true.i, %if.else
...
if.else9:                                         ; preds = %cond.false, %entry
  %ds.tr.lcssa = phi ptr [ %ds, %entry ], [ %2, %cond.false ]
  %vtable10 = load ptr, ptr %ds.tr.lcssa, align 8
...
entry:
  %vtable = load ptr, ptr %ds, align 8
  %0 = load ptr, ptr %vtable, align 8
...
if.else:                                          ; preds = %entry
  %vtable2 = load ptr, ptr %ds, align 8
...
if.else7:                                         ; preds = %if.else
  %vtable8 = load ptr, ptr %ds, align 8
...
if.then12:                                        ; preds = %if.else7
  ...
  %3 = load ptr, ptr %ac_storage_class_specifier_1, align 8
...
if.else7.i:                                       ; preds = %if.else.i
  %vtable8.i = load ptr, ptr %3, align 8
...
if.else13.i:                                      ; preds = %if.else7.i
  %vtable14.i = load ptr, ptr %3, align 8
...
if.else19.i:                                      ; preds = %if.else13.i
  %vtable20.i = load ptr, ptr %3, align 8
...
tailrecurse:                                      ; preds = %if.then, %entry
  ...
  %vtable = load ptr, ptr %ds.tr, align 8
  %0 = load ptr, ptr %vtable, align 8
...
if.else7:                                         ; preds = %tailrecurse
  %vtable8 = load ptr, ptr %ds.tr, align 8
...
if.else:                                          ; preds = %tailrecurse
  %vtable2 = load ptr, ptr %ds.tr, align 8
  %1 = load ptr, ptr %vtable2, align 8
...
if.then6:                                         ; preds = %if.else
  %ac_declaration_specifier_1 = getelementptr inbounds %"class.kc::impl_ac_declaration_specifiers", ptr %ds.tr, i64 0, i32 1
  %2 = load ptr, ptr %ac_declaration_specifier_1, align 8
  %ac_declaration_specifiers_1 = getelementptr inbounds %"class.kc::impl_ac_declaration_specifiers", ptr %ds.tr, i64 0, i32 2
  %3 = load ptr, ptr %ac_declaration_specifiers_1, align 8
...
entry:
  %vtable22 = load ptr, ptr %d, align 8
  %0 = load ptr, ptr %vtable22, align 8
...
if.then.i:                                        ; preds = %if.then
  ...
  %4 = load ptr, ptr %ac_type_specifier_1.i, align 8
...
_ZN2kcL32f_ID_of_ac_declaration_specifierEPNS_29impl_ac_declaration_specifierE.exit: ; preds = %if.then.i
  ...
  %8 = load ptr, ptr %ID_1.i.i, align 8
  %tobool.not = icmp eq ptr %8, null
  br i1 %tobool.not, label %if.else, label %cleanup14

if.else:                                          ; preds = %if.else.i.i, %if.else9.i, %if.else.i, %if.else15.i, %_ZN2kcL32f_ID_of_ac_declaration_specifierEPNS_29impl_ac_declaration_specifierE.exit
  %vtable = load ptr, ptr %2, align 8
  %9 = load ptr, ptr %vtable, align 8
  %call1 = tail call noundef i32 %9(ptr noundef nonnull align 8 dereferenceable(24) %2)
  %cmp = icmp eq i32 %call1, 236
...
if.else7:                                         ; preds = %if.else, %entry
  ...
  %vtable8 = load ptr, ptr %d.tr.lcssa, align 8
...
if.else:                                          ; preds = %entry
  %vtable2 = load ptr, ptr %a_patternchain, align 8
  %1 = load ptr, ptr %vtable2, align 8
...
if.else:                                          ; preds = %entry
  %vtable2 = load ptr, ptr %a_patternchains, align 8
  %1 = load ptr, ptr %vtable2, align 8
...
if.then6:                                         ; preds = %if.else
  ...
  %3 = load ptr, ptr %patternchains_1, align 8
...
if.end34:                                         ; preds = %if.else22, %if.then12, %if.else29, %if.else16, %if.else32, %entry
  ret void
}
...
entry:
  %0 = load i32, ptr @_ZZN2kc23pf_gen_foreachwith_varsEPNS_19impl_idCexpressionsEE16nrof_foreach_occ, align 4
  %inc = add nsw i32 %0, 1
  store i32 %inc, ptr @_ZZN2kc23pf_gen_foreachwith_varsEPNS_19impl_idCexpressionsEE16nrof_foreach_occ, align 4
...
if.then:                                          ; preds = %land.lhs.true
  ...
  call void @llvm.lifetime.start.p0(i64 8192, ptr nonnull %tmp) #13
  %.str.40..str.41 = select i1 %listvars, ptr @.str.40, ptr @.str.41
  %call14 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %tmp, ptr noundef nonnull dereferenceable(1) %.str.40..str.41, i32 noundef %occ, i32 noundef %nr) #13
...
cond.end:                                         ; preds = %if.then, %cond.false
  ...
  %9 = load ptr, ptr %file22, align 8
  %file29 = getelementptr inbounds %"class.kc::impl_withexpressions", ptr %call27, i64 0, i32 3
  store ptr %9, ptr %file29, align 8
  %10 = load i32, ptr %line23, align 8
  %line31 = getelementptr inbounds %"class.kc::impl_withexpressions", ptr %call27, i64 0, i32 2
  store i32 %10, ptr %line31, align 8
  call void @llvm.lifetime.end.p0(i64 8192, ptr nonnull %tmp) #13
  br label %cleanup

if.else32:                                        ; preds = %land.lhs.true, %entry
  %vtable33 = load ptr, ptr %a_idCexpressions, align 8
...
entry:
  %0 = load i32, ptr @_ZZN2kc27pf_gen_foreachwith_listvarsEPNS_19impl_idCexpressionsEE16nrof_foreach_occ, align 4
  %inc = add nsw i32 %0, 1
  store i32 %inc, ptr @_ZZN2kc27pf_gen_foreachwith_listvarsEPNS_19impl_idCexpressionsEE16nrof_foreach_occ, align 4
  %call = tail call noundef i32 @_ZNK2kc18impl_abstract_list6lengthEv(ptr noundef nonnull align 8 dereferenceable(8) %a_idCexpressions)
...
entry:
  %vtable = load ptr, ptr %qh_list, align 8
  %0 = load ptr, ptr %vtable, align 8
...
land.lhs.true6:                                   ; preds = %land.lhs.true
  ...
  %4 = load ptr, ptr %ac_operator_name_1, align 8
...
if.else:                                          ; preds = %land.lhs.true6, %land.lhs.true, %entry
  %vtable24 = load ptr, ptr %qh_list, align 8
...
if.then34:                                        ; preds = %land.lhs.true28
  %15 = load ptr, ptr %ac_direct_declarator_129, align 8
  ...
  %17 = load ptr, ptr %ac_class_qualifier_help_list_1, align 8
...
if.else39:                                        ; preds = %land.lhs.true28, %if.else
  %vtable40 = load ptr, ptr %qh_list, align 8
...
if.then:                                          ; preds = %entry
  ...
  %1 = load ptr, ptr %ac_direct_declarator_1, align 8
  %ac_class_qualifier_help_list_1 = getelementptr inbounds %"class.kc::impl_ac_class_qualifier_help_list", ptr %qh_list, i64 0, i32 2
  %2 = load ptr, ptr %ac_class_qualifier_help_list_1, align 8
...
if.then11:                                        ; preds = %if.then
  ...
  store ptr %5, ptr %file14, align 8
  ...
  store i32 %6, ptr %line15, align 8
  br label %cleanup17
