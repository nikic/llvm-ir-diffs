; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/kimwitu++/kimwy.cc'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/kimwitu++/kimwy.cc"
...
for.body.i.i.i:                                   ; preds = %if.then.i.i, %for.body.i.i.i
  ...
  br i1 %cmp.i.i.i, label %for.body.i.i.i, label %_ZNSt11_Deque_baseIPN2kc20impl_withexpressionsESaIS2_EE16_M_destroy_nodesEPPS2_S6_.exit.loopexit.i.i
...
for.body.i.i.i:                                   ; preds = %if.then.i.i, %for.body.i.i.i
  ...
  %incdec.ptr.i.i.i = getelementptr inbounds ptr, ptr %__n.05.i.i.i, i64 1
  %cmp.i.i.i = icmp ult ptr %__n.05.i.i.i, %2
  br i1 %cmp.i.i.i, label %for.body.i.i.i, label %_ZNSt11_Deque_baseIPN2kc19impl_idCexpressionsESaIS2_EE16_M_destroy_nodesEPPS2_S6_.exit.loopexit.i.i
...
for.body.i.i.i:                                   ; preds = %if.then.i.i, %for.body.i.i.i
  ...
  %incdec.ptr.i.i.i = getelementptr inbounds ptr, ptr %__n.05.i.i.i, i64 1
  %cmp.i.i.i = icmp ult ptr %__n.05.i.i.i, %2
  br i1 %cmp.i.i.i, label %for.body.i.i.i, label %_ZNSt11_Deque_baseIPN2kc13impl_filelineESaIS2_EE16_M_destroy_nodesEPPS2_S6_.exit.loopexit.i.i
...
for.body.i.i.i:                                   ; preds = %if.then.i.i, %for.body.i.i.i
  ...
  %incdec.ptr.i.i.i = getelementptr inbounds ptr, ptr %__n.05.i.i.i, i64 1
  %cmp.i.i.i = icmp ult ptr %__n.05.i.i.i, %2
  br i1 %cmp.i.i.i, label %for.body.i.i.i, label %_ZNSt11_Deque_baseIiSaIiEE16_M_destroy_nodesEPPiS3_.exit.loopexit.i.i
...
do.end:                                           ; preds = %if.then, %entry
  ...
  store i16 0, ptr %yyssa, align 16
  br label %do.body5
...
if.then7:                                         ; preds = %do.body5
  ...
  %call8 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %4, ptr noundef nonnull @.str.4, i32 noundef %yystate.13085) #18
  br label %yybackup

yybackup:                                         ; preds = %do.body5, %if.then7
  %idxprom = sext i32 %yystate.13085 to i64
...
do.end24:                                         ; preds = %if.then20, %do.body18
  ...
  store i32 %call25, ptr @yychar, align 4
  br label %if.end26
...
if.then28:                                        ; preds = %if.end26
  ...
  %11 = load i32, ptr @yydebug, align 4
...
cond.end:                                         ; preds = %if.else, %cond.true
  ...
  %15 = load i32, ptr @yydebug, align 4
...
if.end58:                                         ; preds = %lor.lhs.false52
  ...
  %21 = load i16, ptr %arrayidx60, align 2
...
do.body73:                                        ; preds = %if.end69
  %23 = load i32, ptr @yydebug, align 4
...
do.end81:                                         ; preds = %if.then75, %do.body73
  %26 = load i32, ptr @yychar, align 4
...
yydefault:                                        ; preds = %if.end48, %lor.lhs.false52, %yybackup
  ...
  %28 = load i16, ptr %arrayidx90, align 2
...
yyreduce:                                         ; preds = %yydefault, %if.end68
  ...
  %29 = load i8, ptr %arrayidx96, align 1
  ...
  %yyval.sroa.0.0.copyload = load ptr, ptr %arrayidx100, align 8
  %30 = load i32, ptr @yydebug, align 4
...
if.then103:                                       ; preds = %yyreduce
  ...
  %31 = load i16, ptr %arrayidx.i2687, align 2
...
for.body.i:                                       ; preds = %if.then103, %for.body.i
  ...
  %38 = load i16, ptr %arrayidx5.i, align 2
  %cmp.i2688 = icmp sgt i16 %38, -1
  br i1 %cmp.i2688, label %for.body.i, label %_ZL15yy_reduce_printi.exit
...
sw.bb131:                                         ; preds = %do.end106
  ...
  store ptr %call133, ptr @Thephylumdeclarations, align 8
  br label %sw.epilog

sw.bb134:                                         ; preds = %do.end106
  %53 = load ptr, ptr %yyvsp.13080, align 8
  %54 = load ptr, ptr @Therwdeclarations, align 8
  ...
  store ptr %call136, ptr @Therwdeclarations, align 8
  br label %sw.epilog

sw.bb137:                                         ; preds = %do.end106
  %55 = load ptr, ptr %yyvsp.13080, align 8
  %56 = load ptr, ptr @Thefndeclarations, align 8
  ...
  store ptr %call139, ptr @Thefndeclarations, align 8
  br label %sw.epilog

sw.bb141:                                         ; preds = %do.end106
  %57 = load ptr, ptr %yyvsp.13080, align 8
  %58 = load ptr, ptr @Theunparsedeclarations, align 8
  ...
  store ptr %call143, ptr @Theunparsedeclarations, align 8
  br label %sw.epilog

sw.bb147:                                         ; preds = %do.end106
  %59 = load ptr, ptr %yyvsp.13080, align 8
  %60 = load ptr, ptr @Thelanguages, align 8
  %call149 = call noundef ptr @_ZN2kc19merge_languagenamesEPNS_18impl_languagenamesES1_(ptr noundef %59, ptr noundef %60)
  store ptr %call149, ptr @Thelanguages, align 8
  br label %sw.epilog

sw.bb150:                                         ; preds = %do.end106
  %61 = load ptr, ptr %yyvsp.13080, align 8
  %62 = load ptr, ptr @Thebaseclasses, align 8
...
sw.bb157:                                         ; preds = %do.end106
  %65 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb167:                                         ; preds = %do.end106
  ...
  %72 = load ptr, ptr %arrayidx171, align 8
  ...
  %73 = load ptr, ptr @_ZN12_GLOBAL__N_19pl_phylumE, align 8
...
sw.bb176:                                         ; preds = %do.end106
  ...
  %74 = load ptr, ptr %arrayidx177, align 8
...
sw.bb192:                                         ; preds = %do.end106
  %78 = load ptr, ptr @_ZN12_GLOBAL__N_19pl_phylumE, align 8
  %79 = load ptr, ptr %yyvsp.13080, align 8
  %call194 = call noundef ptr @_ZN2kc20makeListAlternativesEPNS_7impl_IDES1_(ptr noundef %78, ptr noundef %79)
  %80 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb218:                                         ; preds = %do.end106
  store i32 0, ptr @pg_no_of_arguments, align 4
  br label %sw.epilog

sw.bb219:                                         ; preds = %do.end106
  %89 = load i32, ptr @pg_no_of_arguments, align 4
  %90 = load ptr, ptr @Theargsnumbers, align 8
  %call220 = call noundef ptr @_ZN2kc21insert_in_argsnumbersEiPNS_16impl_argsnumbersE(i32 noundef %89, ptr noundef %90)
  store ptr %call220, ptr @Theargsnumbers, align 8
  br label %sw.epilog
...
sw.bb221:                                         ; preds = %do.end106
  ...
  %92 = load ptr, ptr %arrayidx223, align 8
  %call224 = call noundef ptr @_ZN2kc11AlternativeEPNS_7impl_IDEPNS_14impl_argumentsE(ptr noundef %91, ptr noundef %92)
  %93 = load ptr, ptr %arrayidx222, align 8
  %94 = load ptr, ptr @_ZN12_GLOBAL__N_19pl_phylumE, align 8
...
sw.bb227:                                         ; preds = %do.end106
  ...
  %95 = load ptr, ptr %arrayidx228, align 8
...
sw.bb233:                                         ; preds = %do.end106
  %96 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb248:                                         ; preds = %do.end106
  ...
  %104 = load ptr, ptr %arrayidx249, align 8
...
sw.bb258:                                         ; preds = %do.end106
  %106 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb262:                                         ; preds = %do.end106
  ...
  %108 = load ptr, ptr %arrayidx263, align 8
  ...
  %110 = load ptr, ptr %arrayidx265, align 8
...
sw.bb270:                                         ; preds = %do.end106
  call void @_Z9do_NORMALv()
  %111 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb298:                                         ; preds = %do.end106
  ...
  %122 = load ptr, ptr %arrayidx299, align 8
...
sw.bb301:                                         ; preds = %do.end106
  ...
  %123 = load ptr, ptr %arrayidx302, align 8
...
sw.bb304:                                         ; preds = %do.end106
  ...
  %124 = load ptr, ptr %arrayidx305, align 8
...
sw.bb307:                                         ; preds = %do.end106
  ...
  %125 = load ptr, ptr %arrayidx308, align 8
...
sw.bb353:                                         ; preds = %do.end106
  %137 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb364:                                         ; preds = %do.end106
  %140 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb369:                                         ; preds = %do.end106
  %141 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb383:                                         ; preds = %do.end106
  %146 = load ptr, ptr %yyvsp.13080, align 8
  %call385 = call noundef ptr @_ZN2kc13WECexpressionEPNS_16impl_CexpressionE(ptr noundef %146)
  %147 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %148 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 1), align 8
  %cmp.i.i.i = icmp eq ptr %147, %148
  br i1 %cmp.i.i.i, label %if.then.i.i.i2691, label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit
...
_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit: ; preds = %sw.bb383
  ...
  %149 = load ptr, ptr %incdec.ptr.i.i.i, align 8
  %file388 = getelementptr inbounds %"class.kc::impl_fileline", ptr %149, i64 0, i32 1
  %150 = load ptr, ptr %file388, align 8
  %file389 = getelementptr inbounds %"class.kc::impl_withexpression", ptr %call385, i64 0, i32 3
  store ptr %150, ptr %file389, align 8
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2694

if.then.i.i.i2691:                                ; preds = %sw.bb383
  %151 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 3), align 8
  %add.ptr.i.i.i = getelementptr inbounds ptr, ptr %151, i64 -1
  %152 = load ptr, ptr %add.ptr.i.i.i, align 8
  %incdec.ptr.i.i.i3005 = getelementptr inbounds ptr, ptr %152, i64 63
  %153 = load ptr, ptr %incdec.ptr.i.i.i3005, align 8
  %file3883006 = getelementptr inbounds %"class.kc::impl_fileline", ptr %153, i64 0, i32 1
  %154 = load ptr, ptr %file3883006, align 8
  %file3893007 = getelementptr inbounds %"class.kc::impl_withexpression", ptr %call385, i64 0, i32 3
  store ptr %154, ptr %file3893007, align 8
  %155 = load ptr, ptr %add.ptr.i.i.i, align 8
  %add.ptr.i.i.i.i2693 = getelementptr inbounds ptr, ptr %155, i64 64
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2694

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2694: ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit, %if.then.i.i.i2691
  %156 = phi ptr [ %add.ptr.i.i.i.i2693, %if.then.i.i.i2691 ], [ %147, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit ]
  %incdec.ptr.i.i.i2690 = getelementptr inbounds ptr, ptr %156, i64 -1
  %157 = load ptr, ptr %incdec.ptr.i.i.i2690, align 8
  %line391 = getelementptr inbounds %"class.kc::impl_fileline", ptr %157, i64 0, i32 2
  %158 = load i32, ptr %line391, align 8
  %line392 = getelementptr inbounds %"class.kc::impl_withexpression", ptr %call385, i64 0, i32 2
  store i32 %158, ptr %line392, align 8
  br label %sw.epilog

sw.bb395:                                         ; preds = %do.end106
  %159 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb399:                                         ; preds = %do.end106
  ...
  %160 = load ptr, ptr @pg_filename, align 8
  %161 = load i32, ptr @pg_lineno, align 4
  %call400 = call noundef ptr @_ZN2kc8FileLineEPNS_20impl_casestring__StrEi(ptr noundef %160, i32 noundef %161)
  store ptr %call400, ptr %ref.tmp, align 8
  %162 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %163 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 2), align 8
  %add.ptr.i.i.i2695 = getelementptr inbounds ptr, ptr %163, i64 -1
  %cmp.not.i.i.i = icmp eq ptr %162, %add.ptr.i.i.i2695
  br i1 %cmp.not.i.i.i, label %if.else.i.i.i, label %if.then.i.i.i2696

if.then.i.i.i2696:                                ; preds = %sw.bb399
  store ptr %call400, ptr %162, align 8
  %164 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %incdec.ptr.i.i.i2697 = getelementptr inbounds ptr, ptr %164, i64 1
  store ptr %incdec.ptr.i.i.i2697, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
...
_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit: ; preds = %if.then.i.i.i2696, %if.else.i.i.i
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %ref.tmp) #17
  br label %sw.epilog

sw.bb401:                                         ; preds = %do.end106
  %165 = load ptr, ptr %yyvsp.13080, align 8
  %arrayidx403 = getelementptr inbounds %union.KC_YYSTYPE, ptr %yyvsp.13080, i64 -3
  %166 = load ptr, ptr %arrayidx403, align 8
...
do.body406:                                       ; preds = %do.end106
  %167 = load ptr, ptr @_ZN12_GLOBAL__N_116pl_withvariablesE, align 8
...
do.end413:                                        ; preds = %if.else410, %if.then409
  ...
  %168 = load ptr, ptr @pg_filename, align 8
  %169 = load i32, ptr @pg_lineno, align 4
  %call415 = call noundef ptr @_ZN2kc8FileLineEPNS_20impl_casestring__StrEi(ptr noundef %168, i32 noundef %169)
  store ptr %call415, ptr %ref.tmp414, align 8
  %170 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %171 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 2), align 8
  %add.ptr.i.i.i2698 = getelementptr inbounds ptr, ptr %171, i64 -1
  %cmp.not.i.i.i2699 = icmp eq ptr %170, %add.ptr.i.i.i2698
  br i1 %cmp.not.i.i.i2699, label %if.else.i.i.i2702, label %if.then.i.i.i2700

if.then.i.i.i2700:                                ; preds = %do.end413
  store ptr %call415, ptr %170, align 8
  %172 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %incdec.ptr.i.i.i2701 = getelementptr inbounds ptr, ptr %172, i64 1
  store ptr %incdec.ptr.i.i.i2701, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
...
_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit2703: ; preds = %if.then.i.i.i2700, %if.else.i.i.i2702
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %ref.tmp414) #17
  %173 = load ptr, ptr getelementptr inbounds (%"class.std::stack", ptr @_ZN12_GLOBAL__N_121pl_withvariablesstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %174 = load ptr, ptr getelementptr inbounds (%"class.std::stack", ptr @_ZN12_GLOBAL__N_121pl_withvariablesstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 2), align 8
...
if.then.i.i:                                      ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit2703
  %175 = load ptr, ptr @_ZN12_GLOBAL__N_116pl_withvariablesE, align 8
  store ptr %175, ptr %173, align 8
  %176 = load ptr, ptr getelementptr inbounds (%"class.std::stack", ptr @_ZN12_GLOBAL__N_121pl_withvariablesstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %incdec.ptr.i.i = getelementptr inbounds ptr, ptr %176, i64 1
  store ptr %incdec.ptr.i.i, ptr getelementptr inbounds (%"class.std::stack", ptr @_ZN12_GLOBAL__N_121pl_withvariablesstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
...
_ZNSt5stackIPN2kc20impl_withexpressionsESt5dequeIS2_SaIS2_EEE4pushERKS2_.exit: ; preds = %if.then.i.i, %if.else.i.i
  ...
  store ptr %call416, ptr @_ZN12_GLOBAL__N_116pl_withvariablesE, align 8
  br label %sw.epilog
...
sw.bb418:                                         ; preds = %do.end106
  ...
  %177 = load ptr, ptr %arrayidx419, align 8
  %178 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %179 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 1), align 8
  %cmp.i.i.i2704 = icmp eq ptr %178, %179
  br i1 %cmp.i.i.i2704, label %if.then.i.i.i2712, label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2709

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2709: ; preds = %sw.bb418
  %incdec.ptr.i.i.i2705 = getelementptr inbounds ptr, ptr %178, i64 -1
  %180 = load ptr, ptr %incdec.ptr.i.i.i2705, align 8
  %file422 = getelementptr inbounds %"class.kc::impl_fileline", ptr %180, i64 0, i32 1
  %181 = load ptr, ptr %file422, align 8
  %file423 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %177, i64 0, i32 2
  store ptr %181, ptr %file423, align 8
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2715

if.then.i.i.i2712:                                ; preds = %sw.bb418
  %182 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 3), align 8
  %add.ptr.i.i.i2707 = getelementptr inbounds ptr, ptr %182, i64 -1
  %183 = load ptr, ptr %add.ptr.i.i.i2707, align 8
  %incdec.ptr.i.i.i27053008 = getelementptr inbounds ptr, ptr %183, i64 63
  %184 = load ptr, ptr %incdec.ptr.i.i.i27053008, align 8
  %file4223009 = getelementptr inbounds %"class.kc::impl_fileline", ptr %184, i64 0, i32 1
  %185 = load ptr, ptr %file4223009, align 8
  %file4233010 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %177, i64 0, i32 2
  store ptr %185, ptr %file4233010, align 8
  %186 = load ptr, ptr %add.ptr.i.i.i2707, align 8
  %add.ptr.i.i.i.i2714 = getelementptr inbounds ptr, ptr %186, i64 64
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2715

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2715: ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2709, %if.then.i.i.i2712
  %187 = phi ptr [ %add.ptr.i.i.i.i2714, %if.then.i.i.i2712 ], [ %178, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2709 ]
  %incdec.ptr.i.i.i2711 = getelementptr inbounds ptr, ptr %187, i64 -1
  %188 = load ptr, ptr %incdec.ptr.i.i.i2711, align 8
  %line425 = getelementptr inbounds %"class.kc::impl_fileline", ptr %188, i64 0, i32 2
  %189 = load i32, ptr %line425, align 8
  %line426 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %177, i64 0, i32 1
  store i32 %189, ptr %line426, align 8
  call void @_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3popEv(ptr noundef nonnull align 8 dereferenceable(80) @_ZN12_GLOBAL__N_116pl_filelinestackE)
...
do.body430:                                       ; preds = %do.end106
  %190 = load ptr, ptr @_ZN12_GLOBAL__N_116pl_withvariablesE, align 8
...
do.end437:                                        ; preds = %if.else434, %if.then433
  ...
  %191 = load ptr, ptr @pg_filename, align 8
  %192 = load i32, ptr @pg_lineno, align 4
  %call439 = call noundef ptr @_ZN2kc8FileLineEPNS_20impl_casestring__StrEi(ptr noundef %191, i32 noundef %192)
  store ptr %call439, ptr %ref.tmp438, align 8
  %193 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %194 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 2), align 8
  %add.ptr.i.i.i2716 = getelementptr inbounds ptr, ptr %194, i64 -1
  %cmp.not.i.i.i2717 = icmp eq ptr %193, %add.ptr.i.i.i2716
  br i1 %cmp.not.i.i.i2717, label %if.else.i.i.i2720, label %if.then.i.i.i2718

if.then.i.i.i2718:                                ; preds = %do.end437
  store ptr %call439, ptr %193, align 8
  %195 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %incdec.ptr.i.i.i2719 = getelementptr inbounds ptr, ptr %195, i64 1
  store ptr %incdec.ptr.i.i.i2719, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
...
_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit2721: ; preds = %if.then.i.i.i2718, %if.else.i.i.i2720
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %ref.tmp438) #17
  %196 = load ptr, ptr getelementptr inbounds (%"class.std::stack", ptr @_ZN12_GLOBAL__N_121pl_withvariablesstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %197 = load ptr, ptr getelementptr inbounds (%"class.std::stack", ptr @_ZN12_GLOBAL__N_121pl_withvariablesstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 2), align 8
  %add.ptr.i.i2722 = getelementptr inbounds ptr, ptr %197, i64 -1
  %cmp.not.i.i2723 = icmp eq ptr %196, %add.ptr.i.i2722
  br i1 %cmp.not.i.i2723, label %if.else.i.i2726, label %if.then.i.i2724

if.then.i.i2724:                                  ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit2721
  %198 = load ptr, ptr @_ZN12_GLOBAL__N_116pl_withvariablesE, align 8
  store ptr %198, ptr %196, align 8
  %199 = load ptr, ptr getelementptr inbounds (%"class.std::stack", ptr @_ZN12_GLOBAL__N_121pl_withvariablesstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %incdec.ptr.i.i2725 = getelementptr inbounds ptr, ptr %199, i64 1
  store ptr %incdec.ptr.i.i2725, ptr getelementptr inbounds (%"class.std::stack", ptr @_ZN12_GLOBAL__N_121pl_withvariablesstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
...
_ZNSt5stackIPN2kc20impl_withexpressionsESt5dequeIS2_SaIS2_EEE4pushERKS2_.exit2727: ; preds = %if.then.i.i2724, %if.else.i.i2726
  %call440 = call noundef ptr @_ZN2kc18NilwithexpressionsEv()
  store ptr %call440, ptr @_ZN12_GLOBAL__N_116pl_withvariablesE, align 8
  br label %sw.epilog
...
sw.bb442:                                         ; preds = %do.end106
  ...
  %200 = load ptr, ptr %arrayidx443, align 8
  %201 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %202 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 1), align 8
  %cmp.i.i.i2728 = icmp eq ptr %201, %202
  br i1 %cmp.i.i.i2728, label %if.then.i.i.i2736, label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2733

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2733: ; preds = %sw.bb442
  %incdec.ptr.i.i.i2729 = getelementptr inbounds ptr, ptr %201, i64 -1
  %203 = load ptr, ptr %incdec.ptr.i.i.i2729, align 8
  %file446 = getelementptr inbounds %"class.kc::impl_fileline", ptr %203, i64 0, i32 1
  %204 = load ptr, ptr %file446, align 8
  %file447 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %200, i64 0, i32 2
  store ptr %204, ptr %file447, align 8
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2739

if.then.i.i.i2736:                                ; preds = %sw.bb442
  %205 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 3), align 8
  %add.ptr.i.i.i2731 = getelementptr inbounds ptr, ptr %205, i64 -1
  %206 = load ptr, ptr %add.ptr.i.i.i2731, align 8
  %incdec.ptr.i.i.i27293011 = getelementptr inbounds ptr, ptr %206, i64 63
  %207 = load ptr, ptr %incdec.ptr.i.i.i27293011, align 8
  %file4463012 = getelementptr inbounds %"class.kc::impl_fileline", ptr %207, i64 0, i32 1
  %208 = load ptr, ptr %file4463012, align 8
  %file4473013 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %200, i64 0, i32 2
  store ptr %208, ptr %file4473013, align 8
  %209 = load ptr, ptr %add.ptr.i.i.i2731, align 8
  %add.ptr.i.i.i.i2738 = getelementptr inbounds ptr, ptr %209, i64 64
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2739

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2739: ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2733, %if.then.i.i.i2736
  %210 = phi ptr [ %add.ptr.i.i.i.i2738, %if.then.i.i.i2736 ], [ %201, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2733 ]
  %incdec.ptr.i.i.i2735 = getelementptr inbounds ptr, ptr %210, i64 -1
  %211 = load ptr, ptr %incdec.ptr.i.i.i2735, align 8
  %line449 = getelementptr inbounds %"class.kc::impl_fileline", ptr %211, i64 0, i32 2
  %212 = load i32, ptr %line449, align 8
  %line450 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %200, i64 0, i32 1
  store i32 %212, ptr %line450, align 8
  call void @_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3popEv(ptr noundef nonnull align 8 dereferenceable(80) @_ZN12_GLOBAL__N_116pl_filelinestackE)
  call void @_ZNSt5stackIPN2kc20impl_withexpressionsESt5dequeIS2_SaIS2_EEE3popEv(ptr noundef nonnull align 8 dereferenceable(80) @_ZN12_GLOBAL__N_121pl_withvariablesstackE)
  br label %sw.epilog

sw.bb453:                                         ; preds = %do.end106
  %213 = load ptr, ptr %yyvsp.13080, align 8
  %214 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %215 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 1), align 8
  %cmp.i.i.i2740 = icmp eq ptr %214, %215
  br i1 %cmp.i.i.i2740, label %if.then.i.i.i2748, label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2745

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2745: ; preds = %sw.bb453
  %incdec.ptr.i.i.i2741 = getelementptr inbounds ptr, ptr %214, i64 -1
  %216 = load ptr, ptr %incdec.ptr.i.i.i2741, align 8
  %file457 = getelementptr inbounds %"class.kc::impl_fileline", ptr %216, i64 0, i32 1
  %217 = load ptr, ptr %file457, align 8
  %file458 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %213, i64 0, i32 2
  store ptr %217, ptr %file458, align 8
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2751

if.then.i.i.i2748:                                ; preds = %sw.bb453
  %218 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 3), align 8
  %add.ptr.i.i.i2743 = getelementptr inbounds ptr, ptr %218, i64 -1
  %219 = load ptr, ptr %add.ptr.i.i.i2743, align 8
  %incdec.ptr.i.i.i27413014 = getelementptr inbounds ptr, ptr %219, i64 63
  %220 = load ptr, ptr %incdec.ptr.i.i.i27413014, align 8
  %file4573015 = getelementptr inbounds %"class.kc::impl_fileline", ptr %220, i64 0, i32 1
  %221 = load ptr, ptr %file4573015, align 8
  %file4583016 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %213, i64 0, i32 2
  store ptr %221, ptr %file4583016, align 8
  %222 = load ptr, ptr %add.ptr.i.i.i2743, align 8
  %add.ptr.i.i.i.i2750 = getelementptr inbounds ptr, ptr %222, i64 64
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2751

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2751: ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2745, %if.then.i.i.i2748
  %223 = phi ptr [ %add.ptr.i.i.i.i2750, %if.then.i.i.i2748 ], [ %214, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2745 ]
  %incdec.ptr.i.i.i2747 = getelementptr inbounds ptr, ptr %223, i64 -1
  %224 = load ptr, ptr %incdec.ptr.i.i.i2747, align 8
  %line460 = getelementptr inbounds %"class.kc::impl_fileline", ptr %224, i64 0, i32 2
  %225 = load i32, ptr %line460, align 8
  %line461 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %213, i64 0, i32 1
  store i32 %225, ptr %line461, align 8
  br label %sw.epilog

sw.bb464:                                         ; preds = %do.end106
  %226 = load ptr, ptr getelementptr inbounds (%"class.std::stack", ptr @_ZN12_GLOBAL__N_121pl_withvariablesstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %227 = load ptr, ptr getelementptr inbounds (%"class.std::stack", ptr @_ZN12_GLOBAL__N_121pl_withvariablesstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 1), align 8
  %cmp.i.i.i2752 = icmp eq ptr %226, %227
  br i1 %cmp.i.i.i2752, label %if.then.i.i.i2754, label %_ZNSt5stackIPN2kc20impl_withexpressionsESt5dequeIS2_SaIS2_EEE3topEv.exit

if.then.i.i.i2754:                                ; preds = %sw.bb464
  %228 = load ptr, ptr getelementptr inbounds (%"class.std::stack", ptr @_ZN12_GLOBAL__N_121pl_withvariablesstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 3), align 8
  %add.ptr.i.i.i2755 = getelementptr inbounds ptr, ptr %228, i64 -1
  %229 = load ptr, ptr %add.ptr.i.i.i2755, align 8
  %add.ptr.i.i.i.i2756 = getelementptr inbounds ptr, ptr %229, i64 64
  br label %_ZNSt5stackIPN2kc20impl_withexpressionsESt5dequeIS2_SaIS2_EEE3topEv.exit

_ZNSt5stackIPN2kc20impl_withexpressionsESt5dequeIS2_SaIS2_EEE3topEv.exit: ; preds = %sw.bb464, %if.then.i.i.i2754
  %230 = phi ptr [ %add.ptr.i.i.i.i2756, %if.then.i.i.i2754 ], [ %226, %sw.bb464 ]
  %incdec.ptr.i.i.i2753 = getelementptr inbounds ptr, ptr %230, i64 -1
  %231 = load ptr, ptr %incdec.ptr.i.i.i2753, align 8
  %232 = load ptr, ptr %yyvsp.13080, align 8
  ...
  %233 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %234 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 1), align 8
  %cmp.i.i.i2757 = icmp eq ptr %233, %234
  br i1 %cmp.i.i.i2757, label %if.then.i.i.i2765, label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2762
...
_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2762: ; preds = %_ZNSt5stackIPN2kc20impl_withexpressionsESt5dequeIS2_SaIS2_EEE3topEv.exit
  %incdec.ptr.i.i.i2758 = getelementptr inbounds ptr, ptr %233, i64 -1
  %235 = load ptr, ptr %incdec.ptr.i.i.i2758, align 8
  %file471 = getelementptr inbounds %"class.kc::impl_fileline", ptr %235, i64 0, i32 1
  %236 = load ptr, ptr %file471, align 8
  %file472 = getelementptr inbounds %"class.kc::impl_Ctext_elem", ptr %call468, i64 0, i32 2
  store ptr %236, ptr %file472, align 8
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2768

if.then.i.i.i2765:                                ; preds = %_ZNSt5stackIPN2kc20impl_withexpressionsESt5dequeIS2_SaIS2_EEE3topEv.exit
  %237 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 3), align 8
  %add.ptr.i.i.i2760 = getelementptr inbounds ptr, ptr %237, i64 -1
  %238 = load ptr, ptr %add.ptr.i.i.i2760, align 8
  %incdec.ptr.i.i.i27583017 = getelementptr inbounds ptr, ptr %238, i64 63
  %239 = load ptr, ptr %incdec.ptr.i.i.i27583017, align 8
  %file4713018 = getelementptr inbounds %"class.kc::impl_fileline", ptr %239, i64 0, i32 1
  %240 = load ptr, ptr %file4713018, align 8
  %file4723019 = getelementptr inbounds %"class.kc::impl_Ctext_elem", ptr %call468, i64 0, i32 2
  store ptr %240, ptr %file4723019, align 8
  %241 = load ptr, ptr %add.ptr.i.i.i2760, align 8
  %add.ptr.i.i.i.i2767 = getelementptr inbounds ptr, ptr %241, i64 64
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2768

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2768: ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2762, %if.then.i.i.i2765
  %242 = phi ptr [ %add.ptr.i.i.i.i2767, %if.then.i.i.i2765 ], [ %233, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2762 ]
  %incdec.ptr.i.i.i2764 = getelementptr inbounds ptr, ptr %242, i64 -1
  %243 = load ptr, ptr %incdec.ptr.i.i.i2764, align 8
  %line474 = getelementptr inbounds %"class.kc::impl_fileline", ptr %243, i64 0, i32 2
  %244 = load i32, ptr %line474, align 8
  %line475 = getelementptr inbounds %"class.kc::impl_Ctext_elem", ptr %call468, i64 0, i32 1
  store i32 %244, ptr %line475, align 8
  ...
  %245 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %246 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 1), align 8
  %cmp.i.i.i2769 = icmp eq ptr %245, %246
  br i1 %cmp.i.i.i2769, label %if.then.i.i.i2777, label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2774
...
_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2774: ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2768
  %incdec.ptr.i.i.i2770 = getelementptr inbounds ptr, ptr %245, i64 -1
  %247 = load ptr, ptr %incdec.ptr.i.i.i2770, align 8
  %file482 = getelementptr inbounds %"class.kc::impl_fileline", ptr %247, i64 0, i32 1
  %248 = load ptr, ptr %file482, align 8
  %file483 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %call479, i64 0, i32 2
  store ptr %248, ptr %file483, align 8
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2780

if.then.i.i.i2777:                                ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2768
  %249 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 3), align 8
  %add.ptr.i.i.i2772 = getelementptr inbounds ptr, ptr %249, i64 -1
  %250 = load ptr, ptr %add.ptr.i.i.i2772, align 8
  %incdec.ptr.i.i.i27703020 = getelementptr inbounds ptr, ptr %250, i64 63
  %251 = load ptr, ptr %incdec.ptr.i.i.i27703020, align 8
  %file4823021 = getelementptr inbounds %"class.kc::impl_fileline", ptr %251, i64 0, i32 1
  %252 = load ptr, ptr %file4823021, align 8
  %file4833022 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %call479, i64 0, i32 2
  store ptr %252, ptr %file4833022, align 8
  %253 = load ptr, ptr %add.ptr.i.i.i2772, align 8
  %add.ptr.i.i.i.i2779 = getelementptr inbounds ptr, ptr %253, i64 64
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2780

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2780: ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2774, %if.then.i.i.i2777
  %254 = phi ptr [ %add.ptr.i.i.i.i2779, %if.then.i.i.i2777 ], [ %245, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2774 ]
  %incdec.ptr.i.i.i2776 = getelementptr inbounds ptr, ptr %254, i64 -1
  %255 = load ptr, ptr %incdec.ptr.i.i.i2776, align 8
  %line485 = getelementptr inbounds %"class.kc::impl_fileline", ptr %255, i64 0, i32 2
  %256 = load i32, ptr %line485, align 8
  %line486 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %call479, i64 0, i32 1
  store i32 %256, ptr %line486, align 8
  %257 = load i32, ptr @_ZN12_GLOBAL__N_126non_default_outmostpatternE, align 4
...
if.end494:                                        ; preds = %if.then490, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2780
  store i32 0, ptr @_ZN12_GLOBAL__N_126non_default_outmostpatternE, align 4
  br label %sw.epilog
...
sw.bb497:                                         ; preds = %do.end106
  ...
  %258 = load ptr, ptr @pg_filename, align 8
  %259 = load i32, ptr @pg_lineno, align 4
  %call499 = call noundef ptr @_ZN2kc8FileLineEPNS_20impl_casestring__StrEi(ptr noundef %258, i32 noundef %259)
  store ptr %call499, ptr %ref.tmp498, align 8
  %260 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %261 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 2), align 8
  %add.ptr.i.i.i2781 = getelementptr inbounds ptr, ptr %261, i64 -1
  %cmp.not.i.i.i2782 = icmp eq ptr %260, %add.ptr.i.i.i2781
  br i1 %cmp.not.i.i.i2782, label %if.else.i.i.i2785, label %if.then.i.i.i2783

if.then.i.i.i2783:                                ; preds = %sw.bb497
  store ptr %call499, ptr %260, align 8
  %262 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %incdec.ptr.i.i.i2784 = getelementptr inbounds ptr, ptr %262, i64 1
  store ptr %incdec.ptr.i.i.i2784, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
...
_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit2786: ; preds = %if.then.i.i.i2783, %if.else.i.i.i2785
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %ref.tmp498) #17
  %263 = load ptr, ptr getelementptr inbounds (%"class.std::stack.14", ptr @_ZN12_GLOBAL__N_119pl_nooperatorsstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %264 = load ptr, ptr getelementptr inbounds (%"class.std::stack.14", ptr @_ZN12_GLOBAL__N_119pl_nooperatorsstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 2), align 8
  %add.ptr.i.i2787 = getelementptr inbounds i32, ptr %264, i64 -1
  %cmp.not.i.i2788 = icmp eq ptr %263, %add.ptr.i.i2787
  br i1 %cmp.not.i.i2788, label %if.else.i.i2791, label %if.then.i.i2789

if.then.i.i2789:                                  ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit2786
  %265 = load i32, ptr @_ZN12_GLOBAL__N_126non_default_outmostpatternE, align 4
  store i32 %265, ptr %263, align 4
  %incdec.ptr.i.i2790 = getelementptr inbounds i32, ptr %263, i64 1
  store ptr %incdec.ptr.i.i2790, ptr getelementptr inbounds (%"class.std::stack.14", ptr @_ZN12_GLOBAL__N_119pl_nooperatorsstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  br label %sw.epilog
...
sw.bb501:                                         ; preds = %do.end106
  ...
  %266 = load ptr, ptr %arrayidx502, align 8
  %267 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %268 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 1), align 8
  %cmp.i.i.i2792 = icmp eq ptr %267, %268
  br i1 %cmp.i.i.i2792, label %if.then.i.i.i2800, label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2797

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2797: ; preds = %sw.bb501
  %incdec.ptr.i.i.i2793 = getelementptr inbounds ptr, ptr %267, i64 -1
  %269 = load ptr, ptr %incdec.ptr.i.i.i2793, align 8
  %file505 = getelementptr inbounds %"class.kc::impl_fileline", ptr %269, i64 0, i32 1
  %270 = load ptr, ptr %file505, align 8
  %file506 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %266, i64 0, i32 2
  store ptr %270, ptr %file506, align 8
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2803

if.then.i.i.i2800:                                ; preds = %sw.bb501
  %271 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 3), align 8
  %add.ptr.i.i.i2795 = getelementptr inbounds ptr, ptr %271, i64 -1
  %272 = load ptr, ptr %add.ptr.i.i.i2795, align 8
  %incdec.ptr.i.i.i27933023 = getelementptr inbounds ptr, ptr %272, i64 63
  %273 = load ptr, ptr %incdec.ptr.i.i.i27933023, align 8
  %file5053024 = getelementptr inbounds %"class.kc::impl_fileline", ptr %273, i64 0, i32 1
  %274 = load ptr, ptr %file5053024, align 8
  %file5063025 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %266, i64 0, i32 2
  store ptr %274, ptr %file5063025, align 8
  %275 = load ptr, ptr %add.ptr.i.i.i2795, align 8
  %add.ptr.i.i.i.i2802 = getelementptr inbounds ptr, ptr %275, i64 64
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2803

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2803: ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2797, %if.then.i.i.i2800
  %276 = phi ptr [ %add.ptr.i.i.i.i2802, %if.then.i.i.i2800 ], [ %267, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2797 ]
  %incdec.ptr.i.i.i2799 = getelementptr inbounds ptr, ptr %276, i64 -1
  %277 = load ptr, ptr %incdec.ptr.i.i.i2799, align 8
  %line508 = getelementptr inbounds %"class.kc::impl_fileline", ptr %277, i64 0, i32 2
  %278 = load i32, ptr %line508, align 8
  %line509 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %266, i64 0, i32 1
  store i32 %278, ptr %line509, align 8
  call void @_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3popEv(ptr noundef nonnull align 8 dereferenceable(80) @_ZN12_GLOBAL__N_116pl_filelinestackE)
  %279 = load ptr, ptr getelementptr inbounds (%"class.std::stack.14", ptr @_ZN12_GLOBAL__N_119pl_nooperatorsstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %280 = load ptr, ptr getelementptr inbounds (%"class.std::stack.14", ptr @_ZN12_GLOBAL__N_119pl_nooperatorsstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 1), align 8
  %cmp.i.i.i2804 = icmp eq ptr %279, %280
  br i1 %cmp.i.i.i2804, label %if.then.i.i.i2806, label %_ZNSt5stackIiSt5dequeIiSaIiEEE3topEv.exit

if.then.i.i.i2806:                                ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2803
  %281 = load ptr, ptr getelementptr inbounds (%"class.std::stack.14", ptr @_ZN12_GLOBAL__N_119pl_nooperatorsstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 3), align 8
  %add.ptr.i.i.i2807 = getelementptr inbounds ptr, ptr %281, i64 -1
  %282 = load ptr, ptr %add.ptr.i.i.i2807, align 8
  %add.ptr.i.i.i.i2808 = getelementptr inbounds i32, ptr %282, i64 128
  br label %_ZNSt5stackIiSt5dequeIiSaIiEEE3topEv.exit

_ZNSt5stackIiSt5dequeIiSaIiEEE3topEv.exit:        ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2803, %if.then.i.i.i2806
  %283 = phi ptr [ %add.ptr.i.i.i.i2808, %if.then.i.i.i2806 ], [ %279, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2803 ]
  %incdec.ptr.i.i.i2805 = getelementptr inbounds i32, ptr %283, i64 -1
  %284 = load i32, ptr %incdec.ptr.i.i.i2805, align 4
  store i32 %284, ptr @_ZN12_GLOBAL__N_126non_default_outmostpatternE, align 4
...
sw.bb516:                                         ; preds = %do.end106
  ...
  %285 = load ptr, ptr @pg_filename, align 8
  %file519 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %call517, i64 0, i32 2
  store ptr %285, ptr %file519, align 8
  %286 = load i32, ptr @pg_lineno, align 4
  %line520 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %call517, i64 0, i32 1
  store i32 %286, ptr %line520, align 8
  br label %sw.epilog

sw.bb523:                                         ; preds = %do.end106
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %ref.tmp524) #17
  %287 = load ptr, ptr @pg_filename, align 8
  %288 = load i32, ptr @pg_lineno, align 4
  %call525 = call noundef ptr @_ZN2kc8FileLineEPNS_20impl_casestring__StrEi(ptr noundef %287, i32 noundef %288)
  store ptr %call525, ptr %ref.tmp524, align 8
  %289 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %290 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 2), align 8
  %add.ptr.i.i.i2809 = getelementptr inbounds ptr, ptr %290, i64 -1
  %cmp.not.i.i.i2810 = icmp eq ptr %289, %add.ptr.i.i.i2809
  br i1 %cmp.not.i.i.i2810, label %if.else.i.i.i2813, label %if.then.i.i.i2811

if.then.i.i.i2811:                                ; preds = %sw.bb523
  store ptr %call525, ptr %289, align 8
  %291 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %incdec.ptr.i.i.i2812 = getelementptr inbounds ptr, ptr %291, i64 1
  store ptr %incdec.ptr.i.i.i2812, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
...
_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit2814: ; preds = %if.then.i.i.i2811, %if.else.i.i.i2813
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %ref.tmp524) #17
  br label %sw.epilog

sw.bb526:                                         ; preds = %do.end106
  %292 = load ptr, ptr %yyvsp.13080, align 8
  %arrayidx528 = getelementptr inbounds %union.KC_YYSTYPE, ptr %yyvsp.13080, i64 -2
  %293 = load ptr, ptr %arrayidx528, align 8
  %call529 = call noundef ptr @_ZN2kc9ConsCtextEPNS_15impl_Ctext_elemEPNS_10impl_CtextE(ptr noundef %292, ptr noundef %293)
  %294 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %295 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 1), align 8
  %cmp.i.i.i2815 = icmp eq ptr %294, %295
  br i1 %cmp.i.i.i2815, label %if.then.i.i.i2823, label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2820

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2820: ; preds = %sw.bb526
  %incdec.ptr.i.i.i2816 = getelementptr inbounds ptr, ptr %294, i64 -1
  %296 = load ptr, ptr %incdec.ptr.i.i.i2816, align 8
  %file532 = getelementptr inbounds %"class.kc::impl_fileline", ptr %296, i64 0, i32 1
  %297 = load ptr, ptr %file532, align 8
  %298 = load ptr, ptr %yyvsp.13080, align 8
  %file534 = getelementptr inbounds %"class.kc::impl_Ctext_elem", ptr %298, i64 0, i32 2
  store ptr %297, ptr %file534, align 8
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2826

if.then.i.i.i2823:                                ; preds = %sw.bb526
  %299 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 3), align 8
  %add.ptr.i.i.i2818 = getelementptr inbounds ptr, ptr %299, i64 -1
  %300 = load ptr, ptr %add.ptr.i.i.i2818, align 8
  %incdec.ptr.i.i.i28163026 = getelementptr inbounds ptr, ptr %300, i64 63
  %301 = load ptr, ptr %incdec.ptr.i.i.i28163026, align 8
  %file5323027 = getelementptr inbounds %"class.kc::impl_fileline", ptr %301, i64 0, i32 1
  %302 = load ptr, ptr %file5323027, align 8
  %303 = load ptr, ptr %yyvsp.13080, align 8
  %file5343028 = getelementptr inbounds %"class.kc::impl_Ctext_elem", ptr %303, i64 0, i32 2
  store ptr %302, ptr %file5343028, align 8
  %304 = load ptr, ptr %add.ptr.i.i.i2818, align 8
  %add.ptr.i.i.i.i2825 = getelementptr inbounds ptr, ptr %304, i64 64
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2826

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2826: ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2820, %if.then.i.i.i2823
  %305 = phi ptr [ %add.ptr.i.i.i.i2825, %if.then.i.i.i2823 ], [ %294, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2820 ]
  %incdec.ptr.i.i.i2822 = getelementptr inbounds ptr, ptr %305, i64 -1
  %306 = load ptr, ptr %incdec.ptr.i.i.i2822, align 8
  %line536 = getelementptr inbounds %"class.kc::impl_fileline", ptr %306, i64 0, i32 2
  %307 = load i32, ptr %line536, align 8
  %308 = load ptr, ptr %yyvsp.13080, align 8
  %line538 = getelementptr inbounds %"class.kc::impl_Ctext_elem", ptr %308, i64 0, i32 1
  store i32 %307, ptr %line538, align 8
  call void @_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3popEv(ptr noundef nonnull align 8 dereferenceable(80) @_ZN12_GLOBAL__N_116pl_filelinestackE)
  %309 = load ptr, ptr %arrayidx528, align 8
  %file542 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %309, i64 0, i32 2
  %310 = load ptr, ptr %file542, align 8
  %file543 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %call529, i64 0, i32 2
  store ptr %310, ptr %file543, align 8
  %311 = load ptr, ptr %arrayidx528, align 8
  %line545 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %311, i64 0, i32 1
  %312 = load i32, ptr %line545, align 8
  %line546 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %call529, i64 0, i32 1
  store i32 %312, ptr %line546, align 8
  br label %sw.epilog

sw.bb547:                                         ; preds = %do.end106
  %313 = load ptr, ptr %yyvsp.13080, align 8
  %call549 = call noundef ptr @_ZN2kc9CTextLineEPNS_20impl_casestring__StrE(ptr noundef %313)
  br label %sw.epilog

sw.bb550:                                         ; preds = %do.end106
  %314 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb556:                                         ; preds = %do.end106
  %315 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb560:                                         ; preds = %do.end106
  ...
  %316 = load ptr, ptr %arrayidx561, align 8
...
sw.bb571:                                         ; preds = %do.end106
  call void @_Z4do_Cv()
  %319 = load ptr, ptr %yyvsp.13080, align 8
  br label %sw.epilog
...
sw.bb574:                                         ; preds = %do.end106
  ...
  %320 = load ptr, ptr @pg_filename, align 8
  %321 = load i32, ptr @pg_lineno, align 4
  %call576 = call noundef ptr @_ZN2kc8FileLineEPNS_20impl_casestring__StrEi(ptr noundef %320, i32 noundef %321)
  store ptr %call576, ptr %ref.tmp575, align 8
  %322 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %323 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 2), align 8
  %add.ptr.i.i.i2827 = getelementptr inbounds ptr, ptr %323, i64 -1
  %cmp.not.i.i.i2828 = icmp eq ptr %322, %add.ptr.i.i.i2827
  br i1 %cmp.not.i.i.i2828, label %if.else.i.i.i2831, label %if.then.i.i.i2829

if.then.i.i.i2829:                                ; preds = %sw.bb574
  store ptr %call576, ptr %322, align 8
  %324 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %incdec.ptr.i.i.i2830 = getelementptr inbounds ptr, ptr %324, i64 1
  store ptr %incdec.ptr.i.i.i2830, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
...
_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit2832: ; preds = %if.then.i.i.i2829, %if.else.i.i.i2831
...
sw.bb578:                                         ; preds = %do.end106
  ...
  %327 = load i32, ptr @_ZN12_GLOBAL__N_126non_default_outmostpatternE, align 4
...
sw.bb590:                                         ; preds = %do.end106
  ...
  %328 = load ptr, ptr getelementptr inbounds (%"class.std::stack.0", ptr @_ZN12_GLOBAL__N_122pl_idCexpressionsstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %329 = load ptr, ptr getelementptr inbounds (%"class.std::stack.0", ptr @_ZN12_GLOBAL__N_122pl_idCexpressionsstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 2), align 8
  %add.ptr.i.i2833 = getelementptr inbounds ptr, ptr %329, i64 -1
  %cmp.not.i.i2834 = icmp eq ptr %328, %add.ptr.i.i2833
  br i1 %cmp.not.i.i2834, label %if.else.i.i2837, label %if.then.i.i2835

if.then.i.i2835:                                  ; preds = %sw.bb590
  %330 = load ptr, ptr %arrayidx591, align 8
  store ptr %330, ptr %328, align 8
  %331 = load ptr, ptr getelementptr inbounds (%"class.std::stack.0", ptr @_ZN12_GLOBAL__N_122pl_idCexpressionsstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %incdec.ptr.i.i2836 = getelementptr inbounds ptr, ptr %331, i64 1
  store ptr %incdec.ptr.i.i2836, ptr getelementptr inbounds (%"class.std::stack.0", ptr @_ZN12_GLOBAL__N_122pl_idCexpressionsstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  br label %sw.epilog
...
sw.bb592:                                         ; preds = %do.end106
  ...
  %332 = load ptr, ptr %arrayidx593, align 8
  ...
  %vtable = load ptr, ptr %call595, align 8
  ...
  %334 = load ptr, ptr %arrayidx597, align 8
  %call598 = call noundef ptr @_ZN2kc23pf_gen_foreachwith_varsEPNS_19impl_idCexpressionsE(ptr noundef %334)
  %335 = load ptr, ptr @pg_filename, align 8
  %336 = load i32, ptr @pg_lineno, align 4
  ...
  %337 = load ptr, ptr %arrayidx600, align 8
  ...
  %338 = load ptr, ptr %arrayidx593, align 8
  ...
  %339 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %340 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 1), align 8
  %cmp.i.i.i2838 = icmp eq ptr %339, %340
  br i1 %cmp.i.i.i2838, label %if.then.i.i.i2870, label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2867

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2867: ; preds = %sw.bb592
  %incdec.ptr.i.i.i2839 = getelementptr inbounds ptr, ptr %339, i64 -1
  %341 = load ptr, ptr %incdec.ptr.i.i.i2839, align 8
  %file611 = getelementptr inbounds %"class.kc::impl_fileline", ptr %341, i64 0, i32 1
  %342 = load ptr, ptr %file611, align 8
  %file612 = getelementptr inbounds %"class.kc::impl_Ctext_elem", ptr %call606, i64 0, i32 2
  store ptr %342, ptr %file612, align 8
  %343 = load ptr, ptr %incdec.ptr.i.i.i2839, align 8
  %line614 = getelementptr inbounds %"class.kc::impl_fileline", ptr %343, i64 0, i32 2
  %344 = load i32, ptr %line614, align 8
  %file620 = getelementptr inbounds %"class.kc::impl_fileline", ptr %343, i64 0, i32 1
  %345 = load ptr, ptr %file620, align 8
  %file621 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %call607, i64 0, i32 2
  store ptr %345, ptr %file621, align 8
  %346 = load ptr, ptr %incdec.ptr.i.i.i2839, align 8
  %line623 = getelementptr inbounds %"class.kc::impl_fileline", ptr %346, i64 0, i32 2
  %347 = load i32, ptr %line623, align 8
  %file629 = getelementptr inbounds %"class.kc::impl_fileline", ptr %346, i64 0, i32 1
  %348 = load ptr, ptr %file629, align 8
  %file630 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %call608, i64 0, i32 2
  store ptr %348, ptr %file630, align 8
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2873

if.then.i.i.i2870:                                ; preds = %sw.bb592
  %349 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 3), align 8
  %add.ptr.i.i.i2841 = getelementptr inbounds ptr, ptr %349, i64 -1
  %350 = load ptr, ptr %add.ptr.i.i.i2841, align 8
  %incdec.ptr.i.i.i28393029 = getelementptr inbounds ptr, ptr %350, i64 63
  %351 = load ptr, ptr %incdec.ptr.i.i.i28393029, align 8
  %file6113030 = getelementptr inbounds %"class.kc::impl_fileline", ptr %351, i64 0, i32 1
  %352 = load ptr, ptr %file6113030, align 8
  %file6123031 = getelementptr inbounds %"class.kc::impl_Ctext_elem", ptr %call606, i64 0, i32 2
  store ptr %352, ptr %file6123031, align 8
  %353 = load ptr, ptr %add.ptr.i.i.i2841, align 8
  %incdec.ptr.i.i.i28453032 = getelementptr inbounds ptr, ptr %353, i64 63
  %354 = load ptr, ptr %incdec.ptr.i.i.i28453032, align 8
  %line6143033 = getelementptr inbounds %"class.kc::impl_fileline", ptr %354, i64 0, i32 2
  %355 = load i32, ptr %line6143033, align 8
  %file6203036 = getelementptr inbounds %"class.kc::impl_fileline", ptr %354, i64 0, i32 1
  %356 = load ptr, ptr %file6203036, align 8
  %file6213037 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %call607, i64 0, i32 2
  store ptr %356, ptr %file6213037, align 8
  %357 = load ptr, ptr %add.ptr.i.i.i2841, align 8
  %incdec.ptr.i.i.i28573038 = getelementptr inbounds ptr, ptr %357, i64 63
  %358 = load ptr, ptr %incdec.ptr.i.i.i28573038, align 8
  %line6233039 = getelementptr inbounds %"class.kc::impl_fileline", ptr %358, i64 0, i32 2
  %359 = load i32, ptr %line6233039, align 8
  %file6293042 = getelementptr inbounds %"class.kc::impl_fileline", ptr %358, i64 0, i32 1
  %360 = load ptr, ptr %file6293042, align 8
  %file6303043 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %call608, i64 0, i32 2
  store ptr %360, ptr %file6303043, align 8
  %361 = load ptr, ptr %add.ptr.i.i.i2841, align 8
  %add.ptr.i.i.i.i2872 = getelementptr inbounds ptr, ptr %361, i64 64
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2873

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2873: ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2867, %if.then.i.i.i2870
  %.sink3102 = phi i32 [ %355, %if.then.i.i.i2870 ], [ %344, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2867 ]
  %.sink = phi i32 [ %359, %if.then.i.i.i2870 ], [ %347, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2867 ]
  %362 = phi ptr [ %add.ptr.i.i.i.i2872, %if.then.i.i.i2870 ], [ %339, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2867 ]
  %363 = getelementptr inbounds %"class.kc::impl_Ctext_elem", ptr %call606, i64 0, i32 1
  store i32 %.sink3102, ptr %363, align 8
  %364 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %call607, i64 0, i32 1
  store i32 %.sink, ptr %364, align 8
  %incdec.ptr.i.i.i2869 = getelementptr inbounds ptr, ptr %362, i64 -1
  %365 = load ptr, ptr %incdec.ptr.i.i.i2869, align 8
  %line632 = getelementptr inbounds %"class.kc::impl_fileline", ptr %365, i64 0, i32 2
  %366 = load i32, ptr %line632, align 8
  %line633 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %call608, i64 0, i32 1
  store i32 %366, ptr %line633, align 8
  %367 = load ptr, ptr %arrayidx593, align 8
  %file637 = getelementptr inbounds %"class.kc::impl_patternchain", ptr %367, i64 0, i32 2
  %368 = load ptr, ptr %file637, align 8
  %line639 = getelementptr inbounds %"class.kc::impl_patternchain", ptr %367, i64 0, i32 1
  %369 = load i32, ptr %line639, align 8
  ...
  %370 = load ptr, ptr %arrayidx593, align 8
  %371 = load ptr, ptr %arrayidx597, align 8
  %372 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb647:                                         ; preds = %do.end106
  ...
  %373 = load ptr, ptr @pg_filename, align 8
  %374 = load i32, ptr @pg_lineno, align 4
  %call649 = call noundef ptr @_ZN2kc8FileLineEPNS_20impl_casestring__StrEi(ptr noundef %373, i32 noundef %374)
  store ptr %call649, ptr %ref.tmp648, align 8
  %375 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %376 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 2), align 8
  %add.ptr.i.i.i2874 = getelementptr inbounds ptr, ptr %376, i64 -1
  %cmp.not.i.i.i2875 = icmp eq ptr %375, %add.ptr.i.i.i2874
  br i1 %cmp.not.i.i.i2875, label %if.else.i.i.i2878, label %if.then.i.i.i2876

if.then.i.i.i2876:                                ; preds = %sw.bb647
  store ptr %call649, ptr %375, align 8
  %377 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %incdec.ptr.i.i.i2877 = getelementptr inbounds ptr, ptr %377, i64 1
  store ptr %incdec.ptr.i.i.i2877, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
...
_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit2879: ; preds = %if.then.i.i.i2876, %if.else.i.i.i2878
...
sw.bb651:                                         ; preds = %do.end106
  ...
  %378 = load ptr, ptr %arrayidx653, align 8
  ...
  %vtable657 = load ptr, ptr %call655, align 8
  ...
  %380 = load ptr, ptr getelementptr inbounds (%"class.std::stack.0", ptr @_ZN12_GLOBAL__N_122pl_idCexpressionsstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %381 = load ptr, ptr getelementptr inbounds (%"class.std::stack.0", ptr @_ZN12_GLOBAL__N_122pl_idCexpressionsstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 1), align 8
  %cmp.i.i.i2880 = icmp eq ptr %380, %381
  br i1 %cmp.i.i.i2880, label %if.then.i.i.i2882, label %_ZNSt5stackIPN2kc19impl_idCexpressionsESt5dequeIS2_SaIS2_EEE3topEv.exit

if.then.i.i.i2882:                                ; preds = %sw.bb651
  %382 = load ptr, ptr getelementptr inbounds (%"class.std::stack.0", ptr @_ZN12_GLOBAL__N_122pl_idCexpressionsstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 3), align 8
  %add.ptr.i.i.i2883 = getelementptr inbounds ptr, ptr %382, i64 -1
  %383 = load ptr, ptr %add.ptr.i.i.i2883, align 8
  %add.ptr.i.i.i.i2884 = getelementptr inbounds ptr, ptr %383, i64 64
  br label %_ZNSt5stackIPN2kc19impl_idCexpressionsESt5dequeIS2_SaIS2_EEE3topEv.exit

_ZNSt5stackIPN2kc19impl_idCexpressionsESt5dequeIS2_SaIS2_EEE3topEv.exit: ; preds = %sw.bb651, %if.then.i.i.i2882
  %384 = phi ptr [ %add.ptr.i.i.i.i2884, %if.then.i.i.i2882 ], [ %380, %sw.bb651 ]
  %incdec.ptr.i.i.i2881 = getelementptr inbounds ptr, ptr %384, i64 -1
  %385 = load ptr, ptr %incdec.ptr.i.i.i2881, align 8
  %call662 = call noundef ptr @_ZN2kc27pf_gen_foreachwith_listvarsEPNS_19impl_idCexpressionsE(ptr noundef %385)
  %386 = load ptr, ptr @pg_filename, align 8
  %387 = load i32, ptr @pg_lineno, align 4
  ...
  %388 = load ptr, ptr %yyvsp.13080, align 8
  ...
  %389 = load ptr, ptr %arrayidx653, align 8
  ...
  %390 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %391 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 1), align 8
  %cmp.i.i.i2885 = icmp eq ptr %390, %391
  br i1 %cmp.i.i.i2885, label %if.then.i.i.i2917, label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2914
...
_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2914: ; preds = %_ZNSt5stackIPN2kc19impl_idCexpressionsESt5dequeIS2_SaIS2_EEE3topEv.exit
  %incdec.ptr.i.i.i2886 = getelementptr inbounds ptr, ptr %390, i64 -1
  %392 = load ptr, ptr %incdec.ptr.i.i.i2886, align 8
  %file678 = getelementptr inbounds %"class.kc::impl_fileline", ptr %392, i64 0, i32 1
  %393 = load ptr, ptr %file678, align 8
  %file679 = getelementptr inbounds %"class.kc::impl_Ctext_elem", ptr %call671, i64 0, i32 2
  store ptr %393, ptr %file679, align 8
  %394 = load ptr, ptr %incdec.ptr.i.i.i2886, align 8
  %line681 = getelementptr inbounds %"class.kc::impl_fileline", ptr %394, i64 0, i32 2
  %395 = load i32, ptr %line681, align 8
  %file687 = getelementptr inbounds %"class.kc::impl_fileline", ptr %394, i64 0, i32 1
  %396 = load ptr, ptr %file687, align 8
  %file688 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %call673, i64 0, i32 2
  store ptr %396, ptr %file688, align 8
  %397 = load ptr, ptr %incdec.ptr.i.i.i2886, align 8
  %line690 = getelementptr inbounds %"class.kc::impl_fileline", ptr %397, i64 0, i32 2
  %398 = load i32, ptr %line690, align 8
  %file696 = getelementptr inbounds %"class.kc::impl_fileline", ptr %397, i64 0, i32 1
  %399 = load ptr, ptr %file696, align 8
  %file697 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %call675, i64 0, i32 2
  store ptr %399, ptr %file697, align 8
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2920

if.then.i.i.i2917:                                ; preds = %_ZNSt5stackIPN2kc19impl_idCexpressionsESt5dequeIS2_SaIS2_EEE3topEv.exit
  %400 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 3), align 8
  %add.ptr.i.i.i2888 = getelementptr inbounds ptr, ptr %400, i64 -1
  %401 = load ptr, ptr %add.ptr.i.i.i2888, align 8
  %incdec.ptr.i.i.i28863044 = getelementptr inbounds ptr, ptr %401, i64 63
  %402 = load ptr, ptr %incdec.ptr.i.i.i28863044, align 8
  %file6783045 = getelementptr inbounds %"class.kc::impl_fileline", ptr %402, i64 0, i32 1
  %403 = load ptr, ptr %file6783045, align 8
  %file6793046 = getelementptr inbounds %"class.kc::impl_Ctext_elem", ptr %call671, i64 0, i32 2
  store ptr %403, ptr %file6793046, align 8
  %404 = load ptr, ptr %add.ptr.i.i.i2888, align 8
  %incdec.ptr.i.i.i28923047 = getelementptr inbounds ptr, ptr %404, i64 63
  %405 = load ptr, ptr %incdec.ptr.i.i.i28923047, align 8
  %line6813048 = getelementptr inbounds %"class.kc::impl_fileline", ptr %405, i64 0, i32 2
  %406 = load i32, ptr %line6813048, align 8
  %file6873051 = getelementptr inbounds %"class.kc::impl_fileline", ptr %405, i64 0, i32 1
  %407 = load ptr, ptr %file6873051, align 8
  %file6883052 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %call673, i64 0, i32 2
  store ptr %407, ptr %file6883052, align 8
  %408 = load ptr, ptr %add.ptr.i.i.i2888, align 8
  %incdec.ptr.i.i.i29043053 = getelementptr inbounds ptr, ptr %408, i64 63
  %409 = load ptr, ptr %incdec.ptr.i.i.i29043053, align 8
  %line6903054 = getelementptr inbounds %"class.kc::impl_fileline", ptr %409, i64 0, i32 2
  %410 = load i32, ptr %line6903054, align 8
  %file6963057 = getelementptr inbounds %"class.kc::impl_fileline", ptr %409, i64 0, i32 1
  %411 = load ptr, ptr %file6963057, align 8
  %file6973058 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %call675, i64 0, i32 2
  store ptr %411, ptr %file6973058, align 8
  %412 = load ptr, ptr %add.ptr.i.i.i2888, align 8
  %add.ptr.i.i.i.i2919 = getelementptr inbounds ptr, ptr %412, i64 64
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2920

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2920: ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2914, %if.then.i.i.i2917
  %.sink3104 = phi i32 [ %406, %if.then.i.i.i2917 ], [ %395, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2914 ]
  %.sink3103 = phi i32 [ %410, %if.then.i.i.i2917 ], [ %398, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2914 ]
  %413 = phi ptr [ %add.ptr.i.i.i.i2919, %if.then.i.i.i2917 ], [ %390, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2914 ]
  %414 = getelementptr inbounds %"class.kc::impl_Ctext_elem", ptr %call671, i64 0, i32 1
  store i32 %.sink3104, ptr %414, align 8
  %415 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %call673, i64 0, i32 1
  store i32 %.sink3103, ptr %415, align 8
  %incdec.ptr.i.i.i2916 = getelementptr inbounds ptr, ptr %413, i64 -1
  %416 = load ptr, ptr %incdec.ptr.i.i.i2916, align 8
  %line699 = getelementptr inbounds %"class.kc::impl_fileline", ptr %416, i64 0, i32 2
  %417 = load i32, ptr %line699, align 8
  %line700 = getelementptr inbounds %"class.kc::impl_Ctext", ptr %call675, i64 0, i32 1
  store i32 %417, ptr %line700, align 8
  %418 = load ptr, ptr %arrayidx653, align 8
  %file704 = getelementptr inbounds %"class.kc::impl_patternchain", ptr %418, i64 0, i32 2
  %419 = load ptr, ptr %file704, align 8
  %line706 = getelementptr inbounds %"class.kc::impl_patternchain", ptr %418, i64 0, i32 1
  %420 = load i32, ptr %line706, align 8
  ...
  %421 = load ptr, ptr %arrayidx653, align 8
  %422 = load ptr, ptr getelementptr inbounds (%"class.std::stack.0", ptr @_ZN12_GLOBAL__N_122pl_idCexpressionsstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %423 = load ptr, ptr getelementptr inbounds (%"class.std::stack.0", ptr @_ZN12_GLOBAL__N_122pl_idCexpressionsstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 1), align 8
  %cmp.i.i.i2921 = icmp eq ptr %422, %423
  br i1 %cmp.i.i.i2921, label %if.then.i.i.i2923, label %_ZNSt5stackIPN2kc19impl_idCexpressionsESt5dequeIS2_SaIS2_EEE3topEv.exit2926

if.then.i.i.i2923:                                ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2920
  %424 = load ptr, ptr getelementptr inbounds (%"class.std::stack.0", ptr @_ZN12_GLOBAL__N_122pl_idCexpressionsstackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 3), align 8
  %add.ptr.i.i.i2924 = getelementptr inbounds ptr, ptr %424, i64 -1
  %425 = load ptr, ptr %add.ptr.i.i.i2924, align 8
  %add.ptr.i.i.i.i2925 = getelementptr inbounds ptr, ptr %425, i64 64
  br label %_ZNSt5stackIPN2kc19impl_idCexpressionsESt5dequeIS2_SaIS2_EEE3topEv.exit2926

_ZNSt5stackIPN2kc19impl_idCexpressionsESt5dequeIS2_SaIS2_EEE3topEv.exit2926: ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2920, %if.then.i.i.i2923
  %426 = phi ptr [ %add.ptr.i.i.i.i2925, %if.then.i.i.i2923 ], [ %422, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2920 ]
  %incdec.ptr.i.i.i2922 = getelementptr inbounds ptr, ptr %426, i64 -1
  %427 = load ptr, ptr %incdec.ptr.i.i.i2922, align 8
  ...
  %428 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %429 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 1), align 8
  %cmp.i.i.i2927 = icmp eq ptr %428, %429
  br i1 %cmp.i.i.i2927, label %if.then.i.i.i2935, label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2932
...
_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2932: ; preds = %_ZNSt5stackIPN2kc19impl_idCexpressionsESt5dequeIS2_SaIS2_EEE3topEv.exit2926
  %incdec.ptr.i.i.i2928 = getelementptr inbounds ptr, ptr %428, i64 -1
  %430 = load ptr, ptr %incdec.ptr.i.i.i2928, align 8
  %file713 = getelementptr inbounds %"class.kc::impl_fileline", ptr %430, i64 0, i32 1
  %431 = load ptr, ptr %file713, align 8
  %file714 = getelementptr inbounds %"class.kc::impl_foreach_after", ptr %call710, i64 0, i32 2
  store ptr %431, ptr %file714, align 8
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2938

if.then.i.i.i2935:                                ; preds = %_ZNSt5stackIPN2kc19impl_idCexpressionsESt5dequeIS2_SaIS2_EEE3topEv.exit2926
  %432 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 3), align 8
  %add.ptr.i.i.i2930 = getelementptr inbounds ptr, ptr %432, i64 -1
  %433 = load ptr, ptr %add.ptr.i.i.i2930, align 8
  %incdec.ptr.i.i.i29283059 = getelementptr inbounds ptr, ptr %433, i64 63
  %434 = load ptr, ptr %incdec.ptr.i.i.i29283059, align 8
  %file7133060 = getelementptr inbounds %"class.kc::impl_fileline", ptr %434, i64 0, i32 1
  %435 = load ptr, ptr %file7133060, align 8
  %file7143061 = getelementptr inbounds %"class.kc::impl_foreach_after", ptr %call710, i64 0, i32 2
  store ptr %435, ptr %file7143061, align 8
  %436 = load ptr, ptr %add.ptr.i.i.i2930, align 8
  %add.ptr.i.i.i.i2937 = getelementptr inbounds ptr, ptr %436, i64 64
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2938

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2938: ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2932, %if.then.i.i.i2935
  %437 = phi ptr [ %add.ptr.i.i.i.i2937, %if.then.i.i.i2935 ], [ %428, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2932 ]
  %incdec.ptr.i.i.i2934 = getelementptr inbounds ptr, ptr %437, i64 -1
  %438 = load ptr, ptr %incdec.ptr.i.i.i2934, align 8
  %line716 = getelementptr inbounds %"class.kc::impl_fileline", ptr %438, i64 0, i32 2
  %439 = load i32, ptr %line716, align 8
  %line717 = getelementptr inbounds %"class.kc::impl_foreach_after", ptr %call710, i64 0, i32 1
  store i32 %439, ptr %line717, align 8
  call void @_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3popEv(ptr noundef nonnull align 8 dereferenceable(80) @_ZN12_GLOBAL__N_116pl_filelinestackE)
  br label %sw.epilog
...
sw.bb722:                                         ; preds = %do.end106
  %440 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb726:                                         ; preds = %do.end106
  ...
  %441 = load ptr, ptr @pg_filename, align 8
  %442 = load i32, ptr @pg_lineno, align 4
  %call728 = call noundef ptr @_ZN2kc8FileLineEPNS_20impl_casestring__StrEi(ptr noundef %441, i32 noundef %442)
  store ptr %call728, ptr %ref.tmp727, align 8
  %443 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %444 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 2), align 8
  %add.ptr.i.i.i2939 = getelementptr inbounds ptr, ptr %444, i64 -1
  %cmp.not.i.i.i2940 = icmp eq ptr %443, %add.ptr.i.i.i2939
  br i1 %cmp.not.i.i.i2940, label %if.else.i.i.i2943, label %if.then.i.i.i2941

if.then.i.i.i2941:                                ; preds = %sw.bb726
  store ptr %call728, ptr %443, align 8
  %445 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %incdec.ptr.i.i.i2942 = getelementptr inbounds ptr, ptr %445, i64 1
  store ptr %incdec.ptr.i.i.i2942, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
...
_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit2944: ; preds = %if.then.i.i.i2941, %if.else.i.i.i2943
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %ref.tmp727) #17
  br label %sw.epilog

sw.bb729:                                         ; preds = %do.end106
  %446 = load ptr, ptr %yyvsp.13080, align 8
  ...
  %447 = load ptr, ptr %arrayidx732, align 8
  ...
  %448 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %449 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 1), align 8
  %cmp.i.i.i2945 = icmp eq ptr %448, %449
  br i1 %cmp.i.i.i2945, label %if.then.i.i.i2953, label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2950

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2950: ; preds = %sw.bb729
  %incdec.ptr.i.i.i2946 = getelementptr inbounds ptr, ptr %448, i64 -1
  %450 = load ptr, ptr %incdec.ptr.i.i.i2946, align 8
  %file735 = getelementptr inbounds %"class.kc::impl_fileline", ptr %450, i64 0, i32 1
  %451 = load ptr, ptr %file735, align 8
  %file736 = getelementptr inbounds %"class.kc::impl_includedeclaration", ptr %call731, i64 0, i32 2
  store ptr %451, ptr %file736, align 8
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2956

if.then.i.i.i2953:                                ; preds = %sw.bb729
  %452 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 3), align 8
  %add.ptr.i.i.i2948 = getelementptr inbounds ptr, ptr %452, i64 -1
  %453 = load ptr, ptr %add.ptr.i.i.i2948, align 8
  %incdec.ptr.i.i.i29463062 = getelementptr inbounds ptr, ptr %453, i64 63
  %454 = load ptr, ptr %incdec.ptr.i.i.i29463062, align 8
  %file7353063 = getelementptr inbounds %"class.kc::impl_fileline", ptr %454, i64 0, i32 1
  %455 = load ptr, ptr %file7353063, align 8
  %file7363064 = getelementptr inbounds %"class.kc::impl_includedeclaration", ptr %call731, i64 0, i32 2
  store ptr %455, ptr %file7363064, align 8
  %456 = load ptr, ptr %add.ptr.i.i.i2948, align 8
  %add.ptr.i.i.i.i2955 = getelementptr inbounds ptr, ptr %456, i64 64
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2956

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2956: ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2950, %if.then.i.i.i2953
  %457 = phi ptr [ %add.ptr.i.i.i.i2955, %if.then.i.i.i2953 ], [ %448, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2950 ]
  %incdec.ptr.i.i.i2952 = getelementptr inbounds ptr, ptr %457, i64 -1
  %458 = load ptr, ptr %incdec.ptr.i.i.i2952, align 8
  %line738 = getelementptr inbounds %"class.kc::impl_fileline", ptr %458, i64 0, i32 2
  %459 = load i32, ptr %line738, align 8
  %line739 = getelementptr inbounds %"class.kc::impl_includedeclaration", ptr %call731, i64 0, i32 1
  store i32 %459, ptr %line739, align 8
  call void @_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3popEv(ptr noundef nonnull align 8 dereferenceable(80) @_ZN12_GLOBAL__N_116pl_filelinestackE)
  br label %sw.epilog
...
sw.bb750:                                         ; preds = %do.end106
  %460 = load ptr, ptr %yyvsp.13080, align 8
  br label %sw.epilog

sw.bb752:                                         ; preds = %do.end106
  %461 = load ptr, ptr %yyvsp.13080, align 8
  ...
  %462 = load i32, ptr %inc_type, align 8
...
if.else763:                                       ; preds = %sw.bb752
  ...
  %463 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb770:                                         ; preds = %do.end106
  %464 = load ptr, ptr %yyvsp.13080, align 8
  ...
  %465 = load i32, ptr %inc_type774, align 8
...
if.then779:                                       ; preds = %sw.bb770
  ...
  %466 = load ptr, ptr %arrayidx780, align 8
...
if.else782:                                       ; preds = %sw.bb770
  ...
  %467 = load ptr, ptr %yyvsp.13080, align 8
  ...
  %468 = load ptr, ptr %arrayidx787, align 8
  br label %sw.epilog

sw.bb789:                                         ; preds = %do.end106
  %469 = load i32, ptr @_ZN12_GLOBAL__N_126non_default_outmostpatternE, align 4
...
sw.bb800:                                         ; preds = %do.end106
  %472 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb808:                                         ; preds = %do.end106
  ...
  %475 = load ptr, ptr %arrayidx809, align 8
...
if.then812:                                       ; preds = %sw.bb808
  ...
  %476 = load ptr, ptr %arrayidx809, align 8
  ...
  %477 = load ptr, ptr %arrayidx818, align 8
...
sw.bb825:                                         ; preds = %do.end106
  %480 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb833:                                         ; preds = %do.end106
  %483 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb841:                                         ; preds = %do.end106
  ...
  %486 = load ptr, ptr @pg_filename, align 8
  %487 = load i32, ptr @pg_lineno, align 4
  %call843 = call noundef ptr @_ZN2kc8FileLineEPNS_20impl_casestring__StrEi(ptr noundef %486, i32 noundef %487)
  store ptr %call843, ptr %ref.tmp842, align 8
  %488 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %489 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 2), align 8
  %add.ptr.i.i.i2957 = getelementptr inbounds ptr, ptr %489, i64 -1
  %cmp.not.i.i.i2958 = icmp eq ptr %488, %add.ptr.i.i.i2957
  br i1 %cmp.not.i.i.i2958, label %if.else.i.i.i2961, label %if.then.i.i.i2959

if.then.i.i.i2959:                                ; preds = %sw.bb841
  store ptr %call843, ptr %488, align 8
  %490 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %incdec.ptr.i.i.i2960 = getelementptr inbounds ptr, ptr %490, i64 1
  store ptr %incdec.ptr.i.i.i2960, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
...
_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit2962: ; preds = %if.then.i.i.i2959, %if.else.i.i.i2961
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %ref.tmp842) #17
  br label %sw.epilog

sw.bb844:                                         ; preds = %do.end106
  %491 = load ptr, ptr %yyvsp.13080, align 8
  %492 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3), align 8
  %493 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 1), align 8
  %cmp.i.i.i2963 = icmp eq ptr %492, %493
  br i1 %cmp.i.i.i2963, label %if.then.i.i.i2971, label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2968

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2968: ; preds = %sw.bb844
  %incdec.ptr.i.i.i2964 = getelementptr inbounds ptr, ptr %492, i64 -1
  %494 = load ptr, ptr %incdec.ptr.i.i.i2964, align 8
  %file848 = getelementptr inbounds %"class.kc::impl_fileline", ptr %494, i64 0, i32 1
  %495 = load ptr, ptr %file848, align 8
  %file849 = getelementptr inbounds %"class.kc::impl_patternchainitem", ptr %491, i64 0, i32 2
  store ptr %495, ptr %file849, align 8
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2974

if.then.i.i.i2971:                                ; preds = %sw.bb844
  %496 = load ptr, ptr getelementptr inbounds (%"class.std::stack.7", ptr @_ZN12_GLOBAL__N_116pl_filelinestackE, i64 0, i32 0, i32 0, i32 0, i32 0, i32 3, i32 3), align 8
  %add.ptr.i.i.i2966 = getelementptr inbounds ptr, ptr %496, i64 -1
  %497 = load ptr, ptr %add.ptr.i.i.i2966, align 8
  %incdec.ptr.i.i.i29643065 = getelementptr inbounds ptr, ptr %497, i64 63
  %498 = load ptr, ptr %incdec.ptr.i.i.i29643065, align 8
  %file8483066 = getelementptr inbounds %"class.kc::impl_fileline", ptr %498, i64 0, i32 1
  %499 = load ptr, ptr %file8483066, align 8
  %file8493067 = getelementptr inbounds %"class.kc::impl_patternchainitem", ptr %491, i64 0, i32 2
  store ptr %499, ptr %file8493067, align 8
  %500 = load ptr, ptr %add.ptr.i.i.i2966, align 8
  %add.ptr.i.i.i.i2973 = getelementptr inbounds ptr, ptr %500, i64 64
  br label %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2974

_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2974: ; preds = %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2968, %if.then.i.i.i2971
  %501 = phi ptr [ %add.ptr.i.i.i.i2973, %if.then.i.i.i2971 ], [ %492, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2968 ]
  %incdec.ptr.i.i.i2970 = getelementptr inbounds ptr, ptr %501, i64 -1
  %502 = load ptr, ptr %incdec.ptr.i.i.i2970, align 8
  %line851 = getelementptr inbounds %"class.kc::impl_fileline", ptr %502, i64 0, i32 2
  %503 = load i32, ptr %line851, align 8
  %line852 = getelementptr inbounds %"class.kc::impl_patternchainitem", ptr %491, i64 0, i32 1
  store i32 %503, ptr %line852, align 8
  call void @_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3popEv(ptr noundef nonnull align 8 dereferenceable(80) @_ZN12_GLOBAL__N_116pl_filelinestackE)
  br label %sw.epilog

sw.bb855:                                         ; preds = %do.end106
  %504 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb861:                                         ; preds = %do.end106
  ...
  store ptr %call866, ptr @_ZN12_GLOBAL__N_116pl_withvariablesE, align 8
  br label %sw.epilog

sw.bb867:                                         ; preds = %do.end106
  %509 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb918:                                         ; preds = %do.end106
  ...
  %535 = load ptr, ptr %arrayidx919, align 8
  br label %sw.epilog

sw.bb920:                                         ; preds = %do.end106
  %536 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb931:                                         ; preds = %do.end106
  ...
  %539 = load ptr, ptr %arrayidx932, align 8
  %540 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb944:                                         ; preds = %do.end106
  %543 = load ptr, ptr %yyvsp.13080, align 8
  br label %sw.epilog

sw.bb946:                                         ; preds = %do.end106
  %544 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1020:                                        ; preds = %do.end106
  %585 = load ptr, ptr %yyvsp.13080, align 8
  br label %sw.epilog

sw.bb1022:                                        ; preds = %do.end106
  %586 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1040:                                        ; preds = %do.end106
  %593 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1048:                                        ; preds = %do.end106
  ...
  %596 = load ptr, ptr %arrayidx1049, align 8
  %vtable1050 = load ptr, ptr %596, align 8
  ...
  %598 = load ptr, ptr @pg_filename, align 8
  %599 = load i32, ptr @pg_lineno, align 4
  ...
  %600 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1056:                                        ; preds = %do.end106
  %601 = load i32, ptr @_ZN12_GLOBAL__N_126non_default_outmostpatternE, align 4
...
sw.bb1063:                                        ; preds = %do.end106
  ...
  %602 = load ptr, ptr %arrayidx1064, align 8
  %arrayidx1065 = getelementptr inbounds %union.KC_YYSTYPE, ptr %yyvsp.13080, i64 -1
  %603 = load ptr, ptr %arrayidx1065, align 8
...
sw.bb1067:                                        ; preds = %do.end106
  ...
  %604 = load ptr, ptr %arrayidx1068, align 8
...
sw.bb1071:                                        ; preds = %do.end106
  %605 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1079:                                        ; preds = %do.end106
  ...
  %608 = load ptr, ptr %arrayidx1080, align 8
...
if.then1083:                                      ; preds = %sw.bb1079
  ...
  %609 = load ptr, ptr %arrayidx1080, align 8
...
if.else1091:                                      ; preds = %sw.bb1079
  %610 = load ptr, ptr %arrayidx1080, align 8
  br label %if.end1095

if.end1095:                                       ; preds = %if.else1091, %if.then1083
  %.sink3126 = phi ptr [ %610, %if.else1091 ], [ %call1088, %if.then1083 ]
  %arrayidx1093 = getelementptr inbounds %union.KC_YYSTYPE, ptr %yyvsp.13080, i64 -1
  %611 = load ptr, ptr %arrayidx1093, align 8
  %call1094 = call noundef ptr @_ZN2kc13UnparseClauseEPNS_14impl_viewnamesEPNS_17impl_unparseitemsE(ptr noundef %.sink3126, ptr noundef %611)
...
sw.bb1096:                                        ; preds = %do.end106
  ...
  %612 = load ptr, ptr %arrayidx1097, align 8
...
sw.bb1100:                                        ; preds = %do.end106
  ...
  %613 = load ptr, ptr %arrayidx1102, align 8
...
sw.bb1126:                                        ; preds = %do.end106
  ...
  %618 = load ptr, ptr %arrayidx1127, align 8
  %arrayidx1128 = getelementptr inbounds %union.KC_YYSTYPE, ptr %yyvsp.13080, i64 -3
  %619 = load ptr, ptr %arrayidx1128, align 8
  %620 = load ptr, ptr %yyvsp.13080, align 8
  ...
  store i32 %conv1132, ptr %text_nr, align 8
  %621 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1138:                                        ; preds = %do.end106
  ...
  %622 = load ptr, ptr %arrayidx1139, align 8
  %arrayidx1140 = getelementptr inbounds %union.KC_YYSTYPE, ptr %yyvsp.13080, i64 -1
  %623 = load ptr, ptr %arrayidx1140, align 8
  %624 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1143:                                        ; preds = %do.end106
  ...
  %625 = load ptr, ptr %arrayidx1144, align 8
  %626 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1147:                                        ; preds = %do.end106
  ...
  %627 = load ptr, ptr %arrayidx1148, align 8
  %arrayidx1149 = getelementptr inbounds %union.KC_YYSTYPE, ptr %yyvsp.13080, i64 -1
  %628 = load ptr, ptr %arrayidx1149, align 8
...
sw.bb1164:                                        ; preds = %do.end106
  ...
  %634 = load ptr, ptr %arrayidx1165, align 8
  %635 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1168:                                        ; preds = %do.end106
  ...
  %636 = load ptr, ptr %arrayidx1169, align 8
  %637 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1172:                                        ; preds = %do.end106
  ...
  %638 = load ptr, ptr %arrayidx1173, align 8
  %639 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1176:                                        ; preds = %do.end106
  %640 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1184:                                        ; preds = %do.end106
  %643 = load ptr, ptr %yyvsp.13080, align 8
  br label %sw.epilog
...
sw.bb1192:                                        ; preds = %do.end106
  %644 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1197:                                        ; preds = %do.end106
  ...
  %645 = load ptr, ptr %arrayidx1198, align 8
  store i8 1, ptr @pg_uviewshavebeendefined, align 1
  br label %sw.epilog
...
sw.bb1201:                                        ; preds = %do.end106
  %646 = load ptr, ptr %yyvsp.13080, align 8
  ...
  %647 = load ptr, ptr %yyvsp.13080, align 8
  call void @_ZN2kc19v_add_to_uviewnamesEPNS_7impl_IDE(ptr noundef %647)
  %648 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1208:                                        ; preds = %do.end106
  ...
  %649 = load ptr, ptr %arrayidx1209, align 8
  ...
  %650 = load ptr, ptr %arrayidx1209, align 8
  call void @_ZN2kc23v_add_to_uviewnames_extEPNS_7impl_IDE(ptr noundef %650)
  %651 = load ptr, ptr %arrayidx1209, align 8
...
sw.bb1251:                                        ; preds = %do.end106
  %671 = load ptr, ptr %yyvsp.13080, align 8
  ...
  %672 = load ptr, ptr %yyvsp.13080, align 8
  call void @_ZN2kc19v_add_to_rviewnamesEPNS_7impl_IDE(ptr noundef %672)
  %673 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1258:                                        ; preds = %do.end106
  ...
  %674 = load ptr, ptr %arrayidx1259, align 8
  ...
  %675 = load ptr, ptr %arrayidx1259, align 8
  call void @_ZN2kc23v_add_to_rviewnames_extEPNS_7impl_IDE(ptr noundef %675)
  %676 = load ptr, ptr %arrayidx1259, align 8
...
sw.bb1301:                                        ; preds = %do.end106
  %696 = load ptr, ptr %yyvsp.13080, align 8
  ...
  %697 = load ptr, ptr %yyvsp.13080, align 8
  ...
  %698 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1309:                                        ; preds = %do.end106
  ...
  %701 = load ptr, ptr %yyvsp.13080, align 8
  ...
  %702 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1317:                                        ; preds = %do.end106
  ...
  %705 = load ptr, ptr %yyvsp.13080, align 8
  ...
  %706 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1329:                                        ; preds = %do.end106
  ...
  %712 = load ptr, ptr %arrayidx1331, align 8
  ...
  %713 = load ptr, ptr %arrayidx1330, align 8
  %714 = load ptr, ptr %arrayidx1331, align 8
  %call1337 = call noundef ptr @_ZN2kc22Nilac_declaration_listEv()
  %call1338 = call noundef ptr @_ZN2kc12AcNoBaseInitEv()
  %715 = load ptr, ptr %yyvsp.13080, align 8
  ...
  store ptr %call1341, ptr @_ZN12_GLOBAL__N_116pl_withvariablesE, align 8
...
sw.bb1344:                                        ; preds = %do.end106
  ...
  %718 = load ptr, ptr %arrayidx1350, align 8
  %arrayidx1351 = getelementptr inbounds %union.KC_YYSTYPE, ptr %yyvsp.13080, i64 -4
  %719 = load ptr, ptr %arrayidx1351, align 8
  ...
  %720 = load ptr, ptr %arrayidx1355, align 8
  ...
  %721 = load ptr, ptr %arrayidx1351, align 8
  ...
  %722 = load ptr, ptr %yyvsp.13080, align 8
  ...
  store ptr %call1365, ptr @_ZN12_GLOBAL__N_116pl_withvariablesE, align 8
...
sw.bb1369:                                        ; preds = %do.end106
  ...
  %725 = load ptr, ptr %arrayidx1376, align 8
  ...
  %726 = load ptr, ptr %arrayidx1378, align 8
  ...
  %727 = load ptr, ptr %arrayidx1386, align 8
  %728 = load ptr, ptr %yyvsp.13080, align 8
  ...
  store ptr %call1389, ptr @_ZN12_GLOBAL__N_116pl_withvariablesE, align 8
...
sw.bb1393:                                        ; preds = %do.end106
  ...
  %731 = load ptr, ptr %arrayidx1400, align 8
  ...
  store ptr %call1414, ptr @_ZN12_GLOBAL__N_116pl_withvariablesE, align 8
...
sw.bb1428:                                        ; preds = %do.end106
  ...
  store i8 1, ptr %is_attr1436, align 8
  %748 = load ptr, ptr @pg_filename, align 8
  %file1437 = getelementptr inbounds %"class.kc::impl_fndeclaration", ptr %call1435, i64 0, i32 4
  store ptr %748, ptr %file1437, align 8
  %749 = load i32, ptr @pg_lineno, align 4
  %last_line1438 = getelementptr inbounds %"class.kc::impl_fndeclaration", ptr %call1435, i64 0, i32 2
  store i32 %749, ptr %last_line1438, align 8
  br label %sw.epilog
...
sw.bb1452:                                        ; preds = %do.end106
  ...
  %754 = load ptr, ptr %arrayidx1453, align 8
  %arrayidx1454 = getelementptr inbounds %union.KC_YYSTYPE, ptr %yyvsp.13080, i64 -1
  %755 = load ptr, ptr %arrayidx1454, align 8
...
sw.bb1458:                                        ; preds = %do.end106
  %756 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1463:                                        ; preds = %do.end106
  %757 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1466:                                        ; preds = %do.end106
  ...
  %758 = load ptr, ptr %arrayidx1467, align 8
...
sw.bb1469:                                        ; preds = %do.end106
  %759 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1474:                                        ; preds = %do.end106
  %760 = load ptr, ptr %yyvsp.13080, align 8
  ...
  %761 = load ptr, ptr %arrayidx1477, align 8
...
sw.bb1482:                                        ; preds = %do.end106
  %762 = load ptr, ptr %yyvsp.13080, align 8
  ...
  %763 = load ptr, ptr %arrayidx1485, align 8
...
sw.bb1490:                                        ; preds = %do.end106
  %764 = load ptr, ptr %yyvsp.13080, align 8
  ...
  %765 = load ptr, ptr %arrayidx1493, align 8
  ...
  %766 = load ptr, ptr %arrayidx1495, align 8
...
sw.bb1501:                                        ; preds = %do.end106
  %767 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1506:                                        ; preds = %do.end106
  %768 = load ptr, ptr %yyvsp.13080, align 8
  ...
  %769 = load ptr, ptr %arrayidx1509, align 8
...
sw.bb1514:                                        ; preds = %do.end106
  %770 = load ptr, ptr %yyvsp.13080, align 8
  ...
  %771 = load ptr, ptr %arrayidx1517, align 8
...
sw.bb1522:                                        ; preds = %do.end106
  %772 = load ptr, ptr %yyvsp.13080, align 8
  ...
  %773 = load ptr, ptr %arrayidx1525, align 8
  ...
  %774 = load ptr, ptr %arrayidx1527, align 8
...
sw.bb1554:                                        ; preds = %do.end106
  %775 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1563:                                        ; preds = %do.end106
  ...
  %776 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1568:                                        ; preds = %do.end106
  ...
  %777 = load ptr, ptr %arrayidx1569, align 8
  ...
  %778 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1574:                                        ; preds = %do.end106
  ...
  %779 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1579:                                        ; preds = %do.end106
  ...
  %780 = load ptr, ptr %arrayidx1580, align 8
  ...
  %781 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1585:                                        ; preds = %do.end106
  ...
  %782 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1590:                                        ; preds = %do.end106
  ...
  %783 = load ptr, ptr %arrayidx1591, align 8
  ...
  %784 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1596:                                        ; preds = %do.end106
  ...
  %785 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1601:                                        ; preds = %do.end106
  ...
  %786 = load ptr, ptr %arrayidx1602, align 8
  ...
  %787 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1607:                                        ; preds = %do.end106
  ...
  %788 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1612:                                        ; preds = %do.end106
  ...
  %789 = load ptr, ptr %arrayidx1613, align 8
  ...
  %790 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1618:                                        ; preds = %do.end106
  ...
  %791 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1623:                                        ; preds = %do.end106
  ...
  %792 = load ptr, ptr %arrayidx1624, align 8
  ...
  %793 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1629:                                        ; preds = %do.end106
  ...
  %794 = load ptr, ptr %arrayidx1630, align 8
  ...
  %795 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1635:                                        ; preds = %do.end106
  ...
  %796 = load ptr, ptr %arrayidx1636, align 8
  ...
  %797 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1641:                                        ; preds = %do.end106
  %798 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1644:                                        ; preds = %do.end106
  ...
  %799 = load ptr, ptr %arrayidx1645, align 8
...
sw.bb1647:                                        ; preds = %do.end106
  ...
  %800 = load ptr, ptr %arrayidx1648, align 8
  %arrayidx1649 = getelementptr inbounds %union.KC_YYSTYPE, ptr %yyvsp.13080, i64 -1
  %801 = load ptr, ptr %arrayidx1649, align 8
...
sw.bb1651:                                        ; preds = %do.end106
  ...
  %802 = load ptr, ptr %arrayidx1652, align 8
  %arrayidx1653 = getelementptr inbounds %union.KC_YYSTYPE, ptr %yyvsp.13080, i64 -1
  %803 = load ptr, ptr %arrayidx1653, align 8
...
sw.bb1655:                                        ; preds = %do.end106
  ...
  %804 = load ptr, ptr %arrayidx1656, align 8
  %arrayidx1657 = getelementptr inbounds %union.KC_YYSTYPE, ptr %yyvsp.13080, i64 -1
  %805 = load ptr, ptr %arrayidx1657, align 8
  %806 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1662:                                        ; preds = %do.end106
  ...
  %807 = load ptr, ptr %arrayidx1663, align 8
  %arrayidx1664 = getelementptr inbounds %union.KC_YYSTYPE, ptr %yyvsp.13080, i64 -3
  %808 = load ptr, ptr %arrayidx1664, align 8
...
sw.bb1666:                                        ; preds = %do.end106
  ...
  %810 = load ptr, ptr %decl1667, align 8
  %arrayidx1670 = getelementptr inbounds %union.KC_YYSTYPE, ptr %yyvsp.13080, i64 -2
  %811 = load ptr, ptr %arrayidx1670, align 8
  %812 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1673:                                        ; preds = %do.end106
  ...
  %814 = load ptr, ptr %decl1674, align 8
  ...
  %815 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1682:                                        ; preds = %do.end106
  %816 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1709:                                        ; preds = %do.end106
  %823 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1712:                                        ; preds = %do.end106
  ...
  %824 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1716:                                        ; preds = %do.end106
  ...
  %825 = load ptr, ptr %arrayidx1717, align 8
  %826 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1720:                                        ; preds = %do.end106
  %827 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1734:                                        ; preds = %do.end106
  %830 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1737:                                        ; preds = %do.end106
  ...
  %831 = load ptr, ptr %arrayidx1738, align 8
...
sw.bb1751:                                        ; preds = %do.end106
  ...
  %836 = load ptr, ptr %arrayidx1752, align 8
  %arrayidx1753 = getelementptr inbounds %union.KC_YYSTYPE, ptr %yyvsp.13080, i64 -1
  %837 = load ptr, ptr %arrayidx1753, align 8
  %838 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1756:                                        ; preds = %do.end106
  ...
  %839 = load ptr, ptr %arrayidx1757, align 8
  %arrayidx1758 = getelementptr inbounds %union.KC_YYSTYPE, ptr %yyvsp.13080, i64 -1
  %840 = load ptr, ptr %arrayidx1758, align 8
  %841 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1761:                                        ; preds = %do.end106
  %842 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1764:                                        ; preds = %do.end106
  ...
  %843 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1773:                                        ; preds = %do.end106
  ...
  %846 = load ptr, ptr %arrayidx1774, align 8
...
sw.bb1776:                                        ; preds = %do.end106
  ...
  %847 = load ptr, ptr %arrayidx1777, align 8
  ...
  %848 = load ptr, ptr %arrayidx1779, align 8
...
sw.bb1781:                                        ; preds = %do.end106
  ...
  %849 = load ptr, ptr %arrayidx1783, align 8
...
sw.bb1785:                                        ; preds = %do.end106
  ...
  %850 = load ptr, ptr %arrayidx1786, align 8
  ...
  %851 = load ptr, ptr %arrayidx1788, align 8
...
sw.bb1790:                                        ; preds = %do.end106
  ...
  %852 = load ptr, ptr %arrayidx1792, align 8
...
sw.bb1794:                                        ; preds = %do.end106
  %853 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1803:                                        ; preds = %do.end106
  ...
  store ptr %call1807, ptr @_ZN12_GLOBAL__N_116pl_withvariablesE, align 8
  br label %sw.epilog

sw.bb1808:                                        ; preds = %do.end106
  %858 = load ptr, ptr %yyvsp.13080, align 8
  br label %sw.epilog
...
sw.bb1818:                                        ; preds = %do.end106
  %861 = load ptr, ptr %yyvsp.13080, align 8
...
sw.bb1836:                                        ; preds = %do.end106
  ...
  %868 = load ptr, ptr %arrayidx1837, align 8
  store i8 1, ptr @pg_languageshavebeendefined, align 1
  br label %sw.epilog
...
sw.bb1840:                                        ; preds = %do.end106
  %869 = load ptr, ptr %yyvsp.13080, align 8
...
sw.epilog:                                        ; preds = %if.else.i.i2837, %if.then.i.i2835, %if.else.i.i2791, %if.then.i.i2789, %if.then779, %if.else782, %if.then760, %if.else763, %sw.bb1126, %if.then1136, %if.then812, %if.else820, %do.end106, %sw.bb1854, %sw.bb1852, %sw.bb1848, %sw.bb1844, %sw.bb1840, %sw.bb1838, %sw.bb1836, %sw.bb1832, %sw.bb1830, %sw.bb1828, %sw.bb1826, %sw.bb1822, %sw.bb1818, %sw.bb1816, %sw.bb1813, %sw.bb1811, %sw.bb1810, %sw.bb1808, %sw.bb1803, %sw.bb1801, %sw.bb1798, %sw.bb1797, %sw.bb1794, %sw.bb1790, %sw.bb1785, %sw.bb1781, %sw.bb1776, %sw.bb1773, %sw.bb1768, %sw.bb1764, %sw.bb1761, %sw.bb1756, %sw.bb1751, %sw.bb1747, %sw.bb1743, %sw.bb1740, %sw.bb1737, %sw.bb1734, %sw.bb1731, %sw.bb1728, %sw.bb1724, %sw.bb1720, %sw.bb1716, %sw.bb1712, %sw.bb1709, %sw.bb1706, %sw.bb1704, %sw.bb1702, %sw.bb1693, %sw.bb1690, %sw.bb1686, %sw.bb1682, %sw.bb1673, %sw.bb1666, %sw.bb1662, %sw.bb1660, %sw.bb1655, %sw.bb1651, %sw.bb1647, %sw.bb1644, %sw.bb1641, %sw.bb1635, %sw.bb1629, %sw.bb1623, %sw.bb1618, %sw.bb1612, %sw.bb1607, %sw.bb1601, %sw.bb1596, %sw.bb1590, %sw.bb1585, %sw.bb1579, %sw.bb1574, %sw.bb1568, %sw.bb1563, %sw.bb1561, %sw.bb1559, %sw.bb1557, %sw.bb1554, %sw.bb1549, %sw.bb1547, %sw.bb1545, %sw.bb1543, %sw.bb1541, %sw.bb1539, %sw.bb1537, %sw.bb1535, %sw.bb1533, %sw.bb1522, %sw.bb1514, %sw.bb1506, %sw.bb1501, %sw.bb1490, %sw.bb1482, %sw.bb1474, %sw.bb1469, %sw.bb1466, %sw.bb1463, %sw.bb1461, %sw.bb1458, %sw.bb1456, %sw.bb1452, %sw.bb1448, %sw.bb1444, %sw.bb1441, %sw.bb1439, %sw.bb1428, %sw.bb1418, %sw.bb1393, %sw.bb1369, %sw.bb1344, %sw.bb1329, %sw.bb1327, %sw.bb1325, %sw.bb1317, %sw.bb1309, %sw.bb1301, %sw.bb1299, %sw.bb1297, %sw.bb1295, %sw.bb1293, %sw.bb1286, %sw.bb1279, %sw.bb1272, %sw.bb1265, %sw.bb1258, %sw.bb1251, %sw.bb1249, %sw.bb1247, %sw.bb1245, %sw.bb1243, %sw.bb1236, %sw.bb1229, %sw.bb1222, %sw.bb1215, %sw.bb1208, %sw.bb1201, %sw.bb1199, %sw.bb1197, %sw.bb1195, %sw.bb1192, %sw.bb1190, %sw.bb1186, %sw.bb1184, %sw.bb1180, %sw.bb1176, %sw.bb1172, %sw.bb1168, %sw.bb1164, %sw.bb1161, %sw.bb1158, %sw.bb1153, %sw.bb1152, %sw.bb1151, %sw.bb1147, %sw.bb1143, %sw.bb1138, %sw.bb1125, %sw.bb1124, %sw.bb1120, %sw.bb1118, %sw.bb1114, %sw.bb1112, %sw.bb1108, %sw.bb1104, %sw.bb1100, %sw.bb1096, %if.end1095, %sw.bb1075, %sw.bb1071, %sw.bb1067, %sw.bb1063, %if.end1062, %sw.bb1048, %sw.bb1044, %sw.bb1040, %sw.bb1036, %sw.bb1034, %sw.bb1032, %sw.bb1030, %sw.bb1026, %sw.bb1022, %sw.bb1020, %sw.bb1018, %sw.bb1013, %sw.bb1008, %sw.bb1007, %sw.bb1002, %sw.bb1001, %sw.bb995, %sw.bb989, %sw.bb982, %sw.bb975, %sw.bb969, %sw.bb964, %sw.bb960, %sw.bb958, %sw.bb956, %sw.bb954, %sw.bb950, %sw.bb946, %sw.bb944, %sw.bb942, %sw.bb939, %sw.bb936, %sw.bb935, %sw.bb931, %sw.bb929, %sw.bb927, %sw.bb923, %sw.bb920, %sw.bb918, %sw.bb917, %sw.bb916, %sw.bb914, %sw.bb909, %sw.bb904, %sw.bb898, %sw.bb891, %sw.bb885, %sw.bb881, %sw.bb879, %sw.bb877, %sw.bb875, %sw.bb871, %sw.bb867, %sw.bb861, %sw.bb858, %sw.bb855, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2974, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit2962, %sw.bb837, %sw.bb833, %sw.bb829, %sw.bb825, %sw.bb804, %sw.bb800, %sw.bb796, %if.end795, %sw.bb750, %sw.bb745, %sw.bb742, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2956, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit2944, %sw.bb722, %sw.bb720, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2938, %sw.bb650, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit2879, %sw.bb645, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2873, %sw.bb589, %if.end588, %sw.bb577, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit2832, %sw.bb573, %sw.bb571, %sw.bb570, %sw.bb567, %sw.bb564, %sw.bb563, %sw.bb560, %sw.bb559, %sw.bb556, %sw.bb553, %sw.bb550, %sw.bb547, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2826, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit2814, %sw.bb516, %_ZNSt5stackIiSt5dequeIiSaIiEEE3topEv.exit, %sw.bb500, %sw.bb495, %if.end494, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2751, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2739, %sw.bb441, %_ZNSt5stackIPN2kc20impl_withexpressionsESt5dequeIS2_SaIS2_EEE4pushERKS2_.exit2727, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2715, %sw.bb417, %_ZNSt5stackIPN2kc20impl_withexpressionsESt5dequeIS2_SaIS2_EEE4pushERKS2_.exit, %sw.bb401, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit, %sw.bb395, %_ZNSt5stackIPN2kc13impl_filelineESt5dequeIS2_SaIS2_EEE3topEv.exit2694, %sw.bb379, %sw.bb378, %sw.bb377, %sw.bb373, %sw.bb369, %sw.bb367, %sw.bb364, %sw.bb360, %sw.bb358, %sw.bb356, %sw.bb353, %sw.bb349, %sw.bb347, %sw.bb344, %sw.bb342, %sw.bb332, %sw.bb325, %sw.bb319, %sw.bb316, %sw.bb313, %sw.bb310, %sw.bb307, %sw.bb304, %sw.bb301, %sw.bb298, %sw.bb296, %sw.bb293, %sw.bb290, %sw.bb280, %sw.bb273, %sw.bb270, %sw.bb269, %sw.bb267, %sw.bb262, %sw.bb258, %sw.bb256, %sw.bb252, %sw.bb248, %sw.bb244, %sw.bb237, %sw.bb233, %sw.bb231, %sw.bb227, %sw.bb221, %sw.bb219, %sw.bb218, %sw.bb214, %sw.bb212, %sw.bb210, %sw.bb206, %sw.bb202, %sw.bb199, %sw.bb192, %sw.bb190, %sw.bb188, %sw.bb186, %sw.bb181, %sw.bb176, %sw.bb174, %sw.bb167, %sw.bb165, %sw.bb161, %sw.bb157, %sw.bb153, %sw.bb150, %sw.bb147, %sw.bb141, %sw.bb137, %sw.bb134, %sw.bb131, %sw.bb129, %sw.bb121, %sw.bb112, %sw.bb
  ...
  %876 = load i32, ptr @yydebug, align 4
...
if.then1862:                                      ; preds = %sw.epilog
  ...
  br i1 %cmp.not5.i, label %_ZL14yy_stack_printPsS_.exit, label %for.body.i2975

for.body.i2975:                                   ; preds = %if.then1862, %for.body.i2975
  %bottom.addr.06.i = phi ptr [ %incdec.ptr.i, %for.body.i2975 ], [ %yyssa, %if.then1862 ]
  %879 = load ptr, ptr @stderr, align 8
  %880 = load i16, ptr %bottom.addr.06.i, align 2
  %conv.i2976 = sext i16 %880 to i32
  %call1.i = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %879, ptr noundef nonnull @.str.258, i32 noundef %conv.i2976) #18
  %incdec.ptr.i = getelementptr inbounds i16, ptr %bottom.addr.06.i, i64 1
  %cmp.not.i = icmp ugt ptr %incdec.ptr.i, %add.ptr1859.ptr
  br i1 %cmp.not.i, label %_ZL14yy_stack_printPsS_.exit, label %for.body.i2975

_ZL14yy_stack_printPsS_.exit:                     ; preds = %for.body.i2975, %if.then1862
...
do.end1865:                                       ; preds = %_ZL14yy_stack_printPsS_.exit, %sw.epilog
  ...
  store ptr %yyval.sroa.0.3, ptr %incdec.ptr1866, align 8
  %arrayidx1868 = getelementptr inbounds [378 x i8], ptr @_ZL4yyr1, i64 0, i64 %idxprom95
  %882 = load i8, ptr %arrayidx1868, align 1
  ...
  %883 = load i16, ptr %arrayidx1872, align 2
  %conv1873 = sext i16 %883 to i32
  %884 = load i16, ptr %add.ptr1859.ptr, align 2
...
land.lhs.true1878:                                ; preds = %do.end1865
  ...
  %885 = load i16, ptr %arrayidx1880, align 2
...
if.then1884:                                      ; preds = %land.lhs.true1878
  ...
  %886 = load i16, ptr %arrayidx1886, align 2
...
if.else1888:                                      ; preds = %land.lhs.true1878, %do.end1865
  ...
  %887 = load i16, ptr %arrayidx1891, align 2
...
if.then1895:                                      ; preds = %yyerrlab
  %888 = load i32, ptr @yynerrs, align 4
  %inc1896 = add nsw i32 %888, 1
  store i32 %inc1896, ptr @yynerrs, align 4
  call void @_Z9yyerror_1PKci(ptr noundef nonnull @.str.20, i32 noundef %yystate.13085)
  unreachable

if.then1899:                                      ; preds = %yyerrlab
  %889 = load i32, ptr @yychar, align 4
...
while.cond.preheader:                             ; preds = %if.then1899
  ...
  %yyssp.23086 = getelementptr inbounds i16, ptr %yyssp.1.ptr.le, i64 -1
  %cmp19043087 = icmp uge ptr %yyssa, %yyssp.23086
  %890 = load i32, ptr @yydebug, align 4
  %891 = icmp eq i32 %890, 0
  %or.cond3129 = select i1 %cmp19043087, i1 true, i1 %891
  br i1 %or.cond3129, label %cleanup, label %do.body1905

do.body1905:                                      ; preds = %while.cond.preheader, %do.end1915
  %892 = phi i32 [ %899, %do.end1915 ], [ 1, %while.cond.preheader ]
  %yyssp.23088 = phi ptr [ %yyssp.2, %do.end1915 ], [ %yyssp.23086, %while.cond.preheader ]
...
if.then1907:                                      ; preds = %do.body1905
  ...
  %897 = load ptr, ptr %arrayidx.i2980, align 8
  ...
  %fputc2683 = call i32 @fputc(i32 10, ptr %898)
  %.pre = load i32, ptr @yydebug, align 4
  br label %do.end1915

do.end1915:                                       ; preds = %if.then1907, %do.body1905
  %899 = phi i32 [ %.pre, %if.then1907 ], [ 0, %do.body1905 ]
  %yyssp.2 = getelementptr inbounds i16, ptr %yyssp.23088, i64 -1
  %cmp1904 = icmp ult ptr %yyssa, %yyssp.2
  br i1 %cmp1904, label %do.body1905, label %cleanup

do.body1922:                                      ; preds = %if.then1899
  %900 = load i32, ptr @yydebug, align 4
...
if.then1924:                                      ; preds = %do.body1922
  ...
  %903 = load ptr, ptr %arrayidx.i2986, align 8
...
for.cond:                                         ; preds = %for.cond.preheader, %do.end1979
  %905 = phi i16 [ %.pre3106, %do.end1979 ], [ %5, %for.cond.preheader ]
  %yyvsp.3 = phi ptr [ %incdec.ptr19713112, %do.end1979 ], [ %yyvsp.13080, %for.cond.preheader ]
  %yyssp.3.idx = phi i64 [ %yyssp.3.add3113, %do.end1979 ], [ %yyssp.1.idx3082, %for.cond.preheader ]
...
land.lhs.true1940:                                ; preds = %for.cond
  ...
  %906 = load i16, ptr %arrayidx1942, align 2
...
if.then1945:                                      ; preds = %land.lhs.true1940
  ...
  %907 = load i16, ptr %arrayidx1947, align 2
...
do.body1957:                                      ; preds = %if.end1953
  %908 = load i32, ptr @yydebug, align 4
...
do.end1967.thread:                                ; preds = %do.body1957
  %yyssp.3.add3109 = add nsw i64 %yyssp.3.idx, -1
  %incdec.ptr1972.ptr3110 = getelementptr inbounds i16, ptr %yyssa, i64 %yyssp.3.add3109
  %909 = load i16, ptr %incdec.ptr1972.ptr3110, align 2
  br label %do.end1979
...
do.end1967:                                       ; preds = %do.body1957
  ...
  %914 = load ptr, ptr %arrayidx.i2992, align 8
  ...
  %fputc2682 = call i32 @fputc(i32 10, ptr %915)
  %.pre3107 = load i32, ptr @yydebug, align 4
  %yyssp.3.add = add nsw i64 %yyssp.3.idx, -1
  %incdec.ptr1972.ptr = getelementptr inbounds i16, ptr %yyssa, i64 %yyssp.3.add
  %916 = load i16, ptr %incdec.ptr1972.ptr, align 2
  %tobool1975.not = icmp eq i32 %.pre3107, 0
...
if.then1976:                                      ; preds = %do.end1967
  ...
  br i1 %cmp.not5.i2996, label %_ZL14yy_stack_printPsS_.exit3004, label %for.body.i2997

for.body.i2997:                                   ; preds = %if.then1976, %for.body.i2997
  %bottom.addr.06.i2998 = phi ptr [ %incdec.ptr.i3001, %for.body.i2997 ], [ %yyssa, %if.then1976 ]
  %919 = load ptr, ptr @stderr, align 8
  %920 = load i16, ptr %bottom.addr.06.i2998, align 2
  %conv.i2999 = sext i16 %920 to i32
  %call1.i3000 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %919, ptr noundef nonnull @.str.258, i32 noundef %conv.i2999) #18
  %incdec.ptr.i3001 = getelementptr inbounds i16, ptr %bottom.addr.06.i2998, i64 1
  %cmp.not.i3002 = icmp ugt ptr %incdec.ptr.i3001, %incdec.ptr1972.ptr
  br i1 %cmp.not.i3002, label %_ZL14yy_stack_printPsS_.exit3004, label %for.body.i2997

_ZL14yy_stack_printPsS_.exit3004:                 ; preds = %for.body.i2997, %if.then1976
...
do.end1979:                                       ; preds = %do.end1967.thread, %_ZL14yy_stack_printPsS_.exit3004, %do.end1967
  ...
  %yyssp.3.add3113 = phi i64 [ %yyssp.3.add3109, %do.end1967.thread ], [ %yyssp.3.add, %_ZL14yy_stack_printPsS_.exit3004 ], [ %yyssp.3.add, %do.end1967 ]
  %incdec.ptr19713112 = getelementptr inbounds %union.KC_YYSTYPE, ptr %yyvsp.3, i64 -1
  ...
  %.pre3106 = load i16, ptr %arrayidx1932.phi.trans.insert, align 2
  br label %for.cond
...
do.body1983:                                      ; preds = %for.end
  %923 = load i32, ptr @yydebug, align 4
...
entry:
  ...
  %1 = load ptr, ptr %_M_first.i, align 8
...
entry:
  ...
  %idxprom362 = sext i32 %0 to i64
  %arrayidx463 = getelementptr inbounds [1288 x [2 x i32]], ptr @_ZL11error_rules, i64 0, i64 %idxprom362
  %1 = load i32, ptr %arrayidx463, align 8
  %cmp.not64 = icmp eq i32 %1, 0
  br i1 %cmp.not64, label %for.end42, label %for.body

for.body:                                         ; preds = %entry, %if.end38
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %if.end38 ], [ %idxprom362, %entry ]
  ...
  %arrayidx13 = getelementptr inbounds [1288 x [2 x i32]], ptr @_ZL11error_rules, i64 0, i64 %indvars.iv68, i64 1
  ...
  %idxprom2258 = zext i16 %3 to i64
  %arrayidx2359 = getelementptr inbounds [1137 x i16], ptr @_ZL5yyrhs, i64 0, i64 %idxprom2258
  %8 = load i16, ptr %arrayidx2359, align 2
  %cmp25.not60 = icmp eq i16 %8, -1
  br i1 %cmp25.not60, label %for.end, label %for.body26.preheader
...
if.end:                                           ; preds = %if.then, %for.body26
  ...
  br i1 %cmp25.not, label %for.end.loopexit, label %for.body26
...
if.end38:                                         ; preds = %if.then36, %for.end
  ...
  %arrayidx4 = getelementptr inbounds [1288 x [2 x i32]], ptr @_ZL11error_rules, i64 0, i64 %indvars.iv.next69
  %22 = load i32, ptr %arrayidx4, align 8
...
if.end47:                                         ; preds = %if.then45, %for.end42
  ...
  store i32 22, ptr %exception, align 16
...
invoke.cont.i:                                    ; preds = %for.body.i
  ...
  br i1 %cmp.i49, label %for.body.i, label %try.cont
...
for.body.i.i:                                     ; preds = %lpad.i, %for.body.i.i
  ...
  br i1 %cmp.i.i, label %for.body.i.i, label %_ZNSt11_Deque_baseIPN2kc20impl_withexpressionsESaIS2_EE16_M_destroy_nodesEPPS2_S6_.exit.i
...
try.cont:                                         ; preds = %invoke.cont.i
  ...
  store ptr %add.ptr27, ptr %_M_node.i51, align 8
  ...
  store ptr %13, ptr %_M_first.i52, align 8
  ...
  store ptr %add.ptr.i53, ptr %_M_last.i54, align 8
...
for.body.i.i:                                     ; preds = %lpad.i, %for.body.i.i
  ...
  %incdec.ptr.i.i = getelementptr inbounds ptr, ptr %__n.05.i.i, i64 1
  %cmp.i.i = icmp ult ptr %incdec.ptr.i.i, %__cur.013.i
  br i1 %cmp.i.i, label %for.body.i.i, label %_ZNSt11_Deque_baseIPN2kc19impl_idCexpressionsESaIS2_EE16_M_destroy_nodesEPPS2_S6_.exit.i
...
for.body.i.i:                                     ; preds = %lpad.i, %for.body.i.i
  ...
  %incdec.ptr.i.i = getelementptr inbounds ptr, ptr %__n.05.i.i, i64 1
  %cmp.i.i = icmp ult ptr %incdec.ptr.i.i, %__cur.013.i
  br i1 %cmp.i.i, label %for.body.i.i, label %_ZNSt11_Deque_baseIPN2kc13impl_filelineESaIS2_EE16_M_destroy_nodesEPPS2_S6_.exit.i
...
if.then:                                          ; preds = %entry
  ...
  %cmp.i.i.i.i.i = icmp sgt i64 %sub.ptr.sub.i.i.i.i.i, 8
...
if.else.i.i.i.i.i:                                ; preds = %if.then14
  %cmp1.i.i.i.i.i = icmp eq i64 %sub.ptr.sub.i.i.i.i.i, 8
  br i1 %cmp1.i.i.i.i.i, label %if.then2.i.i.i.i.i, label %if.end65

if.then2.i.i.i.i.i:                               ; preds = %if.else.i.i.i.i.i
  %4 = load ptr, ptr %1, align 8
  store ptr %4, ptr %add.ptr9, align 8
  br label %if.end65

if.else:                                          ; preds = %if.then
  br i1 %cmp.i.i.i.i.i, label %if.then.i.i.i.i.i97, label %if.else.i.i.i.i.i94

if.then.i.i.i.i.i97:                              ; preds = %if.else
  %add.ptr29 = getelementptr inbounds ptr, ptr %add.ptr9, i64 %add
  %sub.ptr.div.i.i.i.i.i92 = lshr exact i64 %sub.ptr.sub.i.i.i.i.i, 3
  %idx.neg.i.i.i.i.i = sub nsw i64 0, %sub.ptr.div.i.i.i.i.i92
  %add.ptr.i.i.i.i.i98 = getelementptr inbounds ptr, ptr %add.ptr29, i64 %idx.neg.i.i.i.i.i
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %add.ptr.i.i.i.i.i98, ptr align 8 %1, i64 %sub.ptr.sub.i.i.i.i.i, i1 false)
  br label %if.end65

if.else.i.i.i.i.i94:                              ; preds = %if.else
  %cmp1.i.i.i.i.i95 = icmp eq i64 %sub.ptr.sub.i.i.i.i.i, 8
  br i1 %cmp1.i.i.i.i.i95, label %if.then2.i.i.i.i.i96, label %if.end65

if.then2.i.i.i.i.i96:                             ; preds = %if.else.i.i.i.i.i94
  %add.ptr3.i.i.i.i.i = getelementptr inbounds ptr, ptr %add.ptr9, i64 %sub.ptr.div
  %5 = load ptr, ptr %1, align 8
  store ptr %5, ptr %add.ptr3.i.i.i.i.i, align 8
  br label %if.end65
...
if.else31:                                        ; preds = %entry
  ...
  br i1 %cmp.i.i.i, label %if.then.i.i.i, label %_ZNSt11_Deque_baseIPN2kc13impl_filelineESaIS2_EE15_M_allocate_mapEm.exit
...
_ZNSt11_Deque_baseIPN2kc13impl_filelineESaIS2_EE15_M_allocate_mapEm.exit: ; preds = %if.else31
  ...
  %sub.ptr.lhs.cast.i.i.i.i.i99 = ptrtoint ptr %add.ptr55 to i64
  %sub.ptr.sub.i.i.i.i.i101 = sub i64 %sub.ptr.lhs.cast.i.i.i.i.i99, %sub.ptr.rhs.cast
  %cmp.i.i.i.i.i102 = icmp sgt i64 %sub.ptr.sub.i.i.i.i.i101, 8
  br i1 %cmp.i.i.i.i.i102, label %if.then.i.i.i.i.i108, label %if.else.i.i.i.i.i103

if.then.i.i.i.i.i108:                             ; preds = %_ZNSt11_Deque_baseIPN2kc13impl_filelineESaIS2_EE15_M_allocate_mapEm.exit
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %add.ptr48, ptr align 8 %1, i64 %sub.ptr.sub.i.i.i.i.i101, i1 false)
  br label %_ZSt4copyIPPPN2kc13impl_filelineES4_ET0_T_S6_S5_.exit109

if.else.i.i.i.i.i103:                             ; preds = %_ZNSt11_Deque_baseIPN2kc13impl_filelineESaIS2_EE15_M_allocate_mapEm.exit
  %cmp1.i.i.i.i.i104 = icmp eq i64 %sub.ptr.sub.i.i.i.i.i101, 8
  br i1 %cmp1.i.i.i.i.i104, label %if.then2.i.i.i.i.i107, label %_ZSt4copyIPPPN2kc13impl_filelineES4_ET0_T_S6_S5_.exit109

if.then2.i.i.i.i.i107:                            ; preds = %if.else.i.i.i.i.i103
  %6 = load ptr, ptr %1, align 8
  store ptr %6, ptr %add.ptr48, align 8
  br label %_ZSt4copyIPPPN2kc13impl_filelineES4_ET0_T_S6_S5_.exit109

_ZSt4copyIPPPN2kc13impl_filelineES4_ET0_T_S6_S5_.exit109: ; preds = %if.then.i.i.i.i.i108, %if.else.i.i.i.i.i103, %if.then2.i.i.i.i.i107
  %7 = load ptr, ptr %this, align 8
...
if.end65:                                         ; preds = %if.then2.i.i.i.i.i96, %if.else.i.i.i.i.i94, %if.then.i.i.i.i.i97, %if.then2.i.i.i.i.i, %if.else.i.i.i.i.i, %if.then.i.i.i.i.i, %_ZSt4copyIPPPN2kc13impl_filelineES4_ET0_T_S6_S5_.exit109
  %__new_nstart.0 = phi ptr [ %add.ptr48, %_ZSt4copyIPPPN2kc13impl_filelineES4_ET0_T_S6_S5_.exit109 ], [ %add.ptr9, %if.then.i.i.i.i.i ], [ %add.ptr9, %if.else.i.i.i.i.i ], [ %add.ptr9, %if.then2.i.i.i.i.i ], [ %add.ptr9, %if.then.i.i.i.i.i97 ], [ %add.ptr9, %if.else.i.i.i.i.i94 ], [ %add.ptr9, %if.then2.i.i.i.i.i96 ]
  store ptr %__new_nstart.0, ptr %_M_node3, align 8
  %8 = load ptr, ptr %__new_nstart.0, align 8
  %_M_first.i = getelementptr inbounds %"struct.std::_Deque_base<kc::impl_fileline *, std::allocator<kc::impl_fileline *>>::_Deque_impl_data", ptr %this, i64 0, i32 2, i32 1
  store ptr %8, ptr %_M_first.i, align 8
  %add.ptr.i = getelementptr inbounds ptr, ptr %8, i64 64
  %_M_last.i = getelementptr inbounds %"struct.std::_Deque_base<kc::impl_fileline *, std::allocator<kc::impl_fileline *>>::_Deque_impl_data", ptr %this, i64 0, i32 2, i32 2
  store ptr %add.ptr.i, ptr %_M_last.i, align 8
  %add.ptr70 = getelementptr inbounds ptr, ptr %__new_nstart.0, i64 %add
  %add.ptr71 = getelementptr inbounds ptr, ptr %add.ptr70, i64 -1
  store ptr %add.ptr71, ptr %_M_node, align 8
  %9 = load ptr, ptr %add.ptr71, align 8
  %_M_first.i111 = getelementptr inbounds %"struct.std::_Deque_base<kc::impl_fileline *, std::allocator<kc::impl_fileline *>>::_Deque_impl_data", ptr %this, i64 0, i32 3, i32 1
  store ptr %9, ptr %_M_first.i111, align 8
  %add.ptr.i112 = getelementptr inbounds ptr, ptr %9, i64 64
  %_M_last.i113 = getelementptr inbounds %"struct.std::_Deque_base<kc::impl_fileline *, std::allocator<kc::impl_fileline *>>::_Deque_impl_data", ptr %this, i64 0, i32 3, i32 2
  store ptr %add.ptr.i112, ptr %_M_last.i113, align 8
  ret void
}
...
if.else31:                                        ; preds = %entry
  ...
  %add38 = add i64 %add37, %.sroa.speculated
  %cmp.i.i.i = icmp ugt i64 %add38, 1152921504606846975
  br i1 %cmp.i.i.i, label %if.then.i.i.i, label %_ZNSt11_Deque_baseIPN2kc20impl_withexpressionsESaIS2_EE15_M_allocate_mapEm.exit
...
if.then.i.i.i.i.i108:                             ; preds = %_ZNSt11_Deque_baseIPN2kc20impl_withexpressionsESaIS2_EE15_M_allocate_mapEm.exit
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %add.ptr48, ptr align 8 %1, i64 %sub.ptr.sub.i.i.i.i.i101, i1 false)
  br label %_ZSt4copyIPPPN2kc20impl_withexpressionsES4_ET0_T_S6_S5_.exit109

if.else.i.i.i.i.i103:                             ; preds = %_ZNSt11_Deque_baseIPN2kc20impl_withexpressionsESaIS2_EE15_M_allocate_mapEm.exit
  %cmp1.i.i.i.i.i104 = icmp eq i64 %sub.ptr.sub.i.i.i.i.i101, 8
  br i1 %cmp1.i.i.i.i.i104, label %if.then2.i.i.i.i.i107, label %_ZSt4copyIPPPN2kc20impl_withexpressionsES4_ET0_T_S6_S5_.exit109
...
_ZSt4copyIPPPN2kc20impl_withexpressionsES4_ET0_T_S6_S5_.exit109: ; preds = %if.then.i.i.i.i.i108, %if.else.i.i.i.i.i103, %if.then2.i.i.i.i.i107
  %7 = load ptr, ptr %this, align 8
  tail call void @_ZdlPv(ptr noundef %7) #16
  store ptr %call5.i.i4.i, ptr %this, align 8
  store i64 %add38, ptr %_M_map_size, align 8
...
if.end65:                                         ; preds = %if.then2.i.i.i.i.i96, %if.else.i.i.i.i.i94, %if.then.i.i.i.i.i97, %if.then2.i.i.i.i.i, %if.else.i.i.i.i.i, %if.then.i.i.i.i.i, %_ZSt4copyIPPPN2kc20impl_withexpressionsES4_ET0_T_S6_S5_.exit109
  %__new_nstart.0 = phi ptr [ %add.ptr48, %_ZSt4copyIPPPN2kc20impl_withexpressionsES4_ET0_T_S6_S5_.exit109 ], [ %add.ptr9, %if.then.i.i.i.i.i ], [ %add.ptr9, %if.else.i.i.i.i.i ], [ %add.ptr9, %if.then2.i.i.i.i.i ], [ %add.ptr9, %if.then.i.i.i.i.i97 ], [ %add.ptr9, %if.else.i.i.i.i.i94 ], [ %add.ptr9, %if.then2.i.i.i.i.i96 ]
  store ptr %__new_nstart.0, ptr %_M_node3, align 8
  %8 = load ptr, ptr %__new_nstart.0, align 8
  %_M_first.i = getelementptr inbounds %"struct.std::_Deque_base<kc::impl_withexpressions *, std::allocator<kc::impl_withexpressions *>>::_Deque_impl_data", ptr %this, i64 0, i32 2, i32 1
  store ptr %8, ptr %_M_first.i, align 8
  ...
  store ptr %add.ptr71, ptr %_M_node, align 8
  %9 = load ptr, ptr %add.ptr71, align 8
  %_M_first.i111 = getelementptr inbounds %"struct.std::_Deque_base<kc::impl_withexpressions *, std::allocator<kc::impl_withexpressions *>>::_Deque_impl_data", ptr %this, i64 0, i32 3, i32 1
  store ptr %9, ptr %_M_first.i111, align 8
  %add.ptr.i112 = getelementptr inbounds ptr, ptr %9, i64 64
  %_M_last.i113 = getelementptr inbounds %"struct.std::_Deque_base<kc::impl_withexpressions *, std::allocator<kc::impl_withexpressions *>>::_Deque_impl_data", ptr %this, i64 0, i32 3, i32 2
  store ptr %add.ptr.i112, ptr %_M_last.i113, align 8
  ret void
}
...
if.then.i.i.i.i.i108:                             ; preds = %_ZNSt11_Deque_baseIiSaIiEE15_M_allocate_mapEm.exit
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %add.ptr48, ptr align 8 %1, i64 %sub.ptr.sub.i.i.i.i.i101, i1 false)
  br label %_ZSt4copyIPPiS1_ET0_T_S3_S2_.exit109

if.else.i.i.i.i.i103:                             ; preds = %_ZNSt11_Deque_baseIiSaIiEE15_M_allocate_mapEm.exit
  %cmp1.i.i.i.i.i104 = icmp eq i64 %sub.ptr.sub.i.i.i.i.i101, 8
  br i1 %cmp1.i.i.i.i.i104, label %if.then2.i.i.i.i.i107, label %_ZSt4copyIPPiS1_ET0_T_S3_S2_.exit109
...
_ZSt4copyIPPiS1_ET0_T_S3_S2_.exit109:             ; preds = %if.then.i.i.i.i.i108, %if.else.i.i.i.i.i103, %if.then2.i.i.i.i.i107
  %7 = load ptr, ptr %this, align 8
  tail call void @_ZdlPv(ptr noundef %7) #16
  store ptr %call5.i.i4.i, ptr %this, align 8
  store i64 %add38, ptr %_M_map_size, align 8
...
if.end65:                                         ; preds = %if.then2.i.i.i.i.i96, %if.else.i.i.i.i.i94, %if.then.i.i.i.i.i97, %if.then2.i.i.i.i.i, %if.else.i.i.i.i.i, %if.then.i.i.i.i.i, %_ZSt4copyIPPiS1_ET0_T_S3_S2_.exit109
  %__new_nstart.0 = phi ptr [ %add.ptr48, %_ZSt4copyIPPiS1_ET0_T_S3_S2_.exit109 ], [ %add.ptr9, %if.then.i.i.i.i.i ], [ %add.ptr9, %if.else.i.i.i.i.i ], [ %add.ptr9, %if.then2.i.i.i.i.i ], [ %add.ptr9, %if.then.i.i.i.i.i97 ], [ %add.ptr9, %if.else.i.i.i.i.i94 ], [ %add.ptr9, %if.then2.i.i.i.i.i96 ]
  store ptr %__new_nstart.0, ptr %_M_node3, align 8
  %8 = load ptr, ptr %__new_nstart.0, align 8
  %_M_first.i = getelementptr inbounds %"struct.std::_Deque_base<int, std::allocator<int>>::_Deque_impl_data", ptr %this, i64 0, i32 2, i32 1
  store ptr %8, ptr %_M_first.i, align 8
  %add.ptr.i = getelementptr inbounds i32, ptr %8, i64 128
  %_M_last.i = getelementptr inbounds %"struct.std::_Deque_base<int, std::allocator<int>>::_Deque_impl_data", ptr %this, i64 0, i32 2, i32 2
  store ptr %add.ptr.i, ptr %_M_last.i, align 8
  %add.ptr70 = getelementptr inbounds ptr, ptr %__new_nstart.0, i64 %add
  %add.ptr71 = getelementptr inbounds ptr, ptr %add.ptr70, i64 -1
  store ptr %add.ptr71, ptr %_M_node, align 8
  %9 = load ptr, ptr %add.ptr71, align 8
  %_M_first.i111 = getelementptr inbounds %"struct.std::_Deque_base<int, std::allocator<int>>::_Deque_impl_data", ptr %this, i64 0, i32 3, i32 1
  store ptr %9, ptr %_M_first.i111, align 8
  %add.ptr.i112 = getelementptr inbounds i32, ptr %9, i64 128
  %_M_last.i113 = getelementptr inbounds %"struct.std::_Deque_base<int, std::allocator<int>>::_Deque_impl_data", ptr %this, i64 0, i32 3, i32 2
  store ptr %add.ptr.i112, ptr %_M_last.i113, align 8
  ret void
}
...
if.else31:                                        ; preds = %entry
  ...
  %add38 = add i64 %add37, %.sroa.speculated
  %cmp.i.i.i = icmp ugt i64 %add38, 1152921504606846975
  br i1 %cmp.i.i.i, label %if.then.i.i.i, label %_ZNSt11_Deque_baseIPN2kc19impl_idCexpressionsESaIS2_EE15_M_allocate_mapEm.exit
...
if.then.i.i.i.i.i108:                             ; preds = %_ZNSt11_Deque_baseIPN2kc19impl_idCexpressionsESaIS2_EE15_M_allocate_mapEm.exit
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %add.ptr48, ptr align 8 %1, i64 %sub.ptr.sub.i.i.i.i.i101, i1 false)
  br label %_ZSt4copyIPPPN2kc19impl_idCexpressionsES4_ET0_T_S6_S5_.exit109

if.else.i.i.i.i.i103:                             ; preds = %_ZNSt11_Deque_baseIPN2kc19impl_idCexpressionsESaIS2_EE15_M_allocate_mapEm.exit
  %cmp1.i.i.i.i.i104 = icmp eq i64 %sub.ptr.sub.i.i.i.i.i101, 8
  br i1 %cmp1.i.i.i.i.i104, label %if.then2.i.i.i.i.i107, label %_ZSt4copyIPPPN2kc19impl_idCexpressionsES4_ET0_T_S6_S5_.exit109
...
_ZSt4copyIPPPN2kc19impl_idCexpressionsES4_ET0_T_S6_S5_.exit109: ; preds = %if.then.i.i.i.i.i108, %if.else.i.i.i.i.i103, %if.then2.i.i.i.i.i107
  %7 = load ptr, ptr %this, align 8
  tail call void @_ZdlPv(ptr noundef %7) #16
  store ptr %call5.i.i4.i, ptr %this, align 8
  store i64 %add38, ptr %_M_map_size, align 8
...
if.end65:                                         ; preds = %if.then2.i.i.i.i.i96, %if.else.i.i.i.i.i94, %if.then.i.i.i.i.i97, %if.then2.i.i.i.i.i, %if.else.i.i.i.i.i, %if.then.i.i.i.i.i, %_ZSt4copyIPPPN2kc19impl_idCexpressionsES4_ET0_T_S6_S5_.exit109
  %__new_nstart.0 = phi ptr [ %add.ptr48, %_ZSt4copyIPPPN2kc19impl_idCexpressionsES4_ET0_T_S6_S5_.exit109 ], [ %add.ptr9, %if.then.i.i.i.i.i ], [ %add.ptr9, %if.else.i.i.i.i.i ], [ %add.ptr9, %if.then2.i.i.i.i.i ], [ %add.ptr9, %if.then.i.i.i.i.i97 ], [ %add.ptr9, %if.else.i.i.i.i.i94 ], [ %add.ptr9, %if.then2.i.i.i.i.i96 ]
  store ptr %__new_nstart.0, ptr %_M_node3, align 8
  %8 = load ptr, ptr %__new_nstart.0, align 8
  %_M_first.i = getelementptr inbounds %"struct.std::_Deque_base<kc::impl_idCexpressions *, std::allocator<kc::impl_idCexpressions *>>::_Deque_impl_data", ptr %this, i64 0, i32 2, i32 1
  store ptr %8, ptr %_M_first.i, align 8
  ...
  store ptr %add.ptr71, ptr %_M_node, align 8
  %9 = load ptr, ptr %add.ptr71, align 8
  %_M_first.i111 = getelementptr inbounds %"struct.std::_Deque_base<kc::impl_idCexpressions *, std::allocator<kc::impl_idCexpressions *>>::_Deque_impl_data", ptr %this, i64 0, i32 3, i32 1
  store ptr %9, ptr %_M_first.i111, align 8
  %add.ptr.i112 = getelementptr inbounds ptr, ptr %9, i64 64
  %_M_last.i113 = getelementptr inbounds %"struct.std::_Deque_base<kc::impl_idCexpressions *, std::allocator<kc::impl_idCexpressions *>>::_Deque_impl_data", ptr %this, i64 0, i32 3, i32 2
  store ptr %add.ptr.i112, ptr %_M_last.i113, align 8
  ret void
}
