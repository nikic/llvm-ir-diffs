; ModuleID = '/home/npopov/repos/llvm-test-suite/CTMark/kimwitu++/error.cc'
source_filename = "/home/npopov/repos/llvm-test-suite/CTMark/kimwitu++/error.cc"
...
entry:
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV14kc_filePrinter, i64 0, inrange i32 0, i64 2), ptr %this, align 8
...
entry:
  %inPreProStmt = getelementptr inbounds %class.kc_filePrinter, ptr %this, i64 0, i32 20
  %0 = load i8, ptr %inPreProStmt, align 1
...
if.then:                                          ; preds = %entry
  ...
  %call = tail call i32 @isspace(i32 noundef %conv) #20
...
if.else:                                          ; preds = %entry
  %keyword = getelementptr inbounds %class.kc_filePrinter, ptr %this, i64 0, i32 18
  %2 = load ptr, ptr %keyword, align 8
...
if.then8:                                         ; preds = %if.then6
  store i8 1, ptr %inPreProStmt, align 1
  br label %if.end61

if.then21:                                        ; preds = %if.then6, %if.then6, %if.then6, %if.then6
  store ptr %s, ptr %keyword, align 8
  br label %if.end61

if.else25:                                        ; preds = %if.else
  %conv26 = sext i8 %3 to i32
  %call27 = tail call i32 @isalnum(i32 noundef %conv26) #20
...
land.lhs.true34:                                  ; preds = %if.then31
  %call36 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %2, ptr noundef nonnull dereferenceable(3) @.str, i64 noundef 2) #20
  %cmp37 = icmp eq i32 %call36, 0
  br i1 %cmp37, label %if.then56, label %land.lhs.true46

land.lhs.true40:                                  ; preds = %if.then31
  %call42 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %2, ptr noundef nonnull dereferenceable(5) @.str.4, i64 noundef 4) #20
  %cmp43 = icmp eq i32 %call42, 0
  br i1 %cmp43, label %if.then56, label %if.end57

land.lhs.true46:                                  ; preds = %land.lhs.true34
  %call48 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %2, ptr noundef nonnull dereferenceable(3) @.str.5, i64 noundef 2) #20
  %cmp49 = icmp eq i32 %call48, 0
  br i1 %cmp49, label %if.then56, label %if.end57

land.lhs.true52:                                  ; preds = %if.then31
  %call54 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %2, ptr noundef nonnull dereferenceable(6) @.str.6, i64 noundef 5) #20
...
sw.bb2:                                           ; preds = %entry
  ...
  %add = add nsw i32 %3, 1
  store i32 %add, ptr %lineno, align 8
  %4 = load i8, ptr getelementptr inbounds (%struct.cmdline_options, ptr @g_options, i64 0, i32 17), align 2
  %tobool.not = icmp eq i8 %4, 0
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %sw.bb2
  %5 = load ptr, ptr %file, align 8
  %6 = load ptr, ptr @pg_line, align 8
  %add7 = add nsw i32 %3, 2
  %7 = load ptr, ptr getelementptr inbounds (%struct.cmdline_options, ptr @g_options, i64 0, i32 26), align 8
  %filename = getelementptr inbounds %class.kc_filePrinter, ptr %this, i64 0, i32 4
...
if.then26:                                        ; preds = %if.then24
  ...
  %20 = load ptr, ptr %file52, align 8
  %21 = tail call i64 @fwrite(ptr nonnull @.str.10, i64 25, i64 1, ptr %20)
  %22 = load i32, ptr %lineno17, align 8
  %add32 = add nsw i32 %22, 1
  store i32 %add32, ptr %lineno17, align 8
...
if.end41.sink.split:                              ; preds = %if.else, %if.then26
  ...
  store i8 %.sink, ptr %doit, align 4
  br label %if.end41
...
if.end41:                                         ; preds = %if.end41.sink.split, %if.else, %if.else, %if.then22
  ...
  store i32 %add43, ptr %no_of_printed_string_chars23, align 8
  br label %if.end56

if.else45:                                        ; preds = %sw.default20
  %24 = load i32, ptr @_ZN2kc13view_filenameE, align 4
...
if.end96.thread:                                  ; preds = %if.then87
  store i8 0, ptr %inComment, align 2
...
if.end112.thread:                                 ; preds = %if.then107
  store i8 0, ptr %inCppComment, align 1
...
if.then135:                                       ; preds = %sw.bb132
  %43 = load i32, ptr %indent, align 8
  %dec = add nsw i32 %43, -1
  store i32 %dec, ptr %indent, align 8
  store i8 0, ptr %indentKeyword, align 8
...
if.then142:                                       ; preds = %sw.bb139
  %44 = load i32, ptr %indent, align 8
  %dec144 = add nsw i32 %44, -1
  store i32 %dec144, ptr %indent, align 8
  store i8 0, ptr %indentKeyword, align 8
  br label %sw.bb147
...
sw.bb148:                                         ; preds = %if.end130
  %45 = load i32, ptr %indent, align 8
  %inc150 = add nsw i32 %45, 1
  store i32 %inc150, ptr %indent, align 8
  br label %if.end329

sw.bb151:                                         ; preds = %if.end130, %if.end130
  %46 = load i32, ptr %indent, align 8
...
if.then154:                                       ; preds = %sw.bb151
  ...
  store i32 %dec156, ptr %indent, align 8
  br label %default_case

sw.bb158:                                         ; preds = %if.end130
  %47 = load i32, ptr %indent, align 8
...
if.then161:                                       ; preds = %sw.bb158
  ...
  store i32 %dec163, ptr %indent, align 8
  br label %if.end329
...
sw.bb167:                                         ; preds = %if.end130, %if.end130
  %48 = load i8, ptr %lastChar68, align 1
  %conv169 = sext i8 %48 to i32
  %cmp170 = icmp eq i8 %48, 8
  %49 = load i8, ptr %beginOfLine, align 1
...
if.end174:                                        ; preds = %sw.bb167
  %call177 = tail call i32 @isspace(i32 noundef %conv169) #20
  %tobool178.not = icmp eq i32 %call177, 0
  br i1 %tobool178.not, label %if.end180, label %if.end329

if.end180:                                        ; preds = %if.end174
  %call183 = tail call i32 @isalnum(i32 noundef %conv169) #20
...
if.then205:                                       ; preds = %switch.early.test404, %switch.early.test404, %switch.early.test404, %switch.early.test404, %switch.early.test404, %if.end180
  ...
  %50 = load i8, ptr %add.ptr206, align 1
  %conv207 = sext i8 %50 to i32
  %call208 = tail call i32 @isalnum(i32 noundef %conv207) #20
...
if.end223:                                        ; preds = %switch.early.test405
  store i8 1, ptr %spacePending, align 4
  br label %if.end329
...
default_case:                                     ; preds = %switch.early.test405, %switch.early.test405, %switch.early.test405, %if.then205, %if.end130, %sw.bb167, %sw.bb151, %if.then154, %sw.bb132, %if.then135, %sw.bb147
  ...
  %51 = load i8, ptr %lastChar68, align 1
  %.fr = freeze i8 %51
...
if.then235:                                       ; preds = %switch.early.test
  %52 = load i32, ptr %indent, align 8
  %53 = load i32, ptr @_ZN14kc_filePrinter12indent_levelE, align 4
...
if.end329:                                        ; preds = %switch.early.test404, %sw.bb148, %sw.bb165, %if.end318, %if.then161, %sw.bb158, %if.end174, %if.end223, %if.end80, %if.end112, %if.end112, %if.end112, %sw.default115, %sw.default99, %if.end96, %if.end96, %if.end96, %if.end64
  ...
  store i32 %storemerge, ptr %bs_cnt, align 4
  %65 = load i8, ptr %incdec.ptr428, align 1
...
if.end:                                           ; preds = %if.then, %entry
  ...
  store i8 0, ptr %inString, align 8
  %inComment = getelementptr inbounds %class.kc_filePrinter, ptr %this, i64 0, i32 13
...
entry:
  ...
  %0 = load i64, ptr getelementptr inbounds (%struct.cmdline_options, ptr @g_options, i64 0, i32 25, i32 1), align 8
  %tobool.not = icmp eq i64 %0, 0
  br i1 %tobool.not, label %if.else, label %if.then

if.then:                                          ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %v) #21
  ...
  store ptr %1, ptr %msg.i, align 8
  %2 = load ptr, ptr getelementptr inbounds (%struct.cmdline_options, ptr @g_options, i64 0, i32 25), align 8
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %__dnew.i.i.i) #21
  store i64 %0, ptr %__dnew.i.i.i, align 8
...
if.end.i.i.i.thread:                              ; preds = %if.then
  ...
  store ptr %call2.i12.i.i, ptr %msg.i, align 8
...
_ZN2kc23view_error_format_classD2Ev.exit:         ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i, %if.then.i.i.i4
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %v) #21
  br label %if.end
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i8: ; preds = %lpad
  ...
  br label %_ZN2kc23view_error_format_classD2Ev.exit11

if.then.i.i.i7:                                   ; preds = %lpad
  call void @_ZdlPv(ptr noundef %11) #19
  br label %_ZN2kc23view_error_format_classD2Ev.exit11

_ZN2kc23view_error_format_classD2Ev.exit11:       ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i8, %if.then.i.i.i7
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %v) #21
  resume { ptr, i32 } %10
...
entry:
  ...
  %fputs = tail call i32 @fputs(ptr %s, ptr %1) #22
...
entry:
  ...
  %0 = load ptr, ptr %filename.i, align 8
  %1 = getelementptr inbounds %class.kc_filePrinter, ptr %this, i64 0, i32 4, i32 2
  %cmp.i.i.i.i = icmp eq ptr %0, %1
  br i1 %cmp.i.i.i.i, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i, label %if.then.i.i.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i: ; preds = %entry
  %_M_string_length.i.i.i.i = getelementptr inbounds %class.kc_filePrinter, ptr %this, i64 0, i32 4, i32 1
...
_ZN14kc_filePrinterD2Ev.exit:                     ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i, %if.then.i.i.i
...
entry:
  %0 = load ptr, ptr @stdout, align 8
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV14kc_filePrinter, i64 0, inrange i32 0, i64 2), ptr @v_stdout_printer, align 8
  store ptr %0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_stdout_printer, i64 0, i32 1), align 8
  store ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_stdout_printer, i64 0, i32 4, i32 2), ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_stdout_printer, i64 0, i32 4), align 8
  store i64 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_stdout_printer, i64 0, i32 4, i32 1), align 8
  store i8 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_stdout_printer, i64 0, i32 4, i32 2), align 8
  store i32 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_stdout_printer, i64 0, i32 2), align 8
  store i32 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_stdout_printer, i64 0, i32 5), align 8
  store i8 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_stdout_printer, i64 0, i32 6), align 4
  store i8 10, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_stdout_printer, i64 0, i32 7), align 1
  store ptr null, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_stdout_printer, i64 0, i32 18), align 8
  store i8 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_stdout_printer, i64 0, i32 19), align 8
  store i8 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_stdout_printer, i64 0, i32 20), align 1
  ...
  %1 = tail call i32 @__cxa_atexit(ptr nonnull @_ZN14kc_filePrinterD2Ev, ptr nonnull @v_stdout_printer, ptr nonnull @__dso_handle) #21
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV14kc_filePrinter, i64 0, inrange i32 0, i64 2), ptr @v_hfile_printer, align 8
  store ptr null, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_hfile_printer, i64 0, i32 1), align 8
  store ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_hfile_printer, i64 0, i32 4, i32 2), ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_hfile_printer, i64 0, i32 4), align 8
  store i64 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_hfile_printer, i64 0, i32 4, i32 1), align 8
  store i8 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_hfile_printer, i64 0, i32 4, i32 2), align 8
  store i32 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_hfile_printer, i64 0, i32 2), align 8
  store i32 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_hfile_printer, i64 0, i32 5), align 8
  store i8 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_hfile_printer, i64 0, i32 6), align 4
  store i8 10, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_hfile_printer, i64 0, i32 7), align 1
  store ptr null, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_hfile_printer, i64 0, i32 18), align 8
  store i8 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_hfile_printer, i64 0, i32 19), align 8
  store i8 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_hfile_printer, i64 0, i32 20), align 1
  ...
  %2 = tail call i32 @__cxa_atexit(ptr nonnull @_ZN14kc_filePrinterD2Ev, ptr nonnull @v_hfile_printer, ptr nonnull @__dso_handle) #21
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV14kc_filePrinter, i64 0, inrange i32 0, i64 2), ptr @v_ccfile_printer, align 8
  store ptr null, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_ccfile_printer, i64 0, i32 1), align 8
  store ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_ccfile_printer, i64 0, i32 4, i32 2), ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_ccfile_printer, i64 0, i32 4), align 8
  store i64 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_ccfile_printer, i64 0, i32 4, i32 1), align 8
  store i8 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_ccfile_printer, i64 0, i32 4, i32 2), align 8
  store i32 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_ccfile_printer, i64 0, i32 2), align 8
  store i32 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_ccfile_printer, i64 0, i32 5), align 8
  store i8 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_ccfile_printer, i64 0, i32 6), align 4
  store i8 10, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_ccfile_printer, i64 0, i32 7), align 1
  store ptr null, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_ccfile_printer, i64 0, i32 18), align 8
  store i8 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_ccfile_printer, i64 0, i32 19), align 8
  store i8 0, ptr getelementptr inbounds (%class.kc_filePrinter, ptr @v_ccfile_printer, i64 0, i32 20), align 1
  ...
  %3 = tail call i32 @__cxa_atexit(ptr nonnull @_ZN14kc_filePrinterD2Ev, ptr nonnull @v_ccfile_printer, ptr nonnull @__dso_handle) #21
  ret void
}
...
attributes #4 = { mustprogress nofree nounwind willreturn memory(read, argmem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
